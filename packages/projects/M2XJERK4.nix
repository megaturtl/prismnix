...
let
    versions = (let
        ...
        _mrEHqOv7 = {
            "id" = "mrEHqOv7";
            "file" = "sign-paper.jar";
            "hash" = "sha512-mRhfjRU5nUdpxCaULYBifo/PSX+0POiRK60n6Lpkqn/L2Q7GQ+9sazeAFShyi2fpAKd2GmrFENDjaZjGireSzg==";
        };
    in {
        "cIYG6dpR" = _cIYG6dpR;
        "ilpEIQT0" = _ilpEIQT0;
        ...
        "gL8ms2RI" = _gL8ms2RI;
        "mrEHqOv7" = _mrEHqOv7;
        "paper-1.20" = _mrEHqOv7;
        "paper-1.20.1" = _mrEHqOv7;
        "paper-1.20.2" = _mrEHqOv7;
        "paper-1.20.3" = _mrEHqOv7;
        "paper-1.20.4" = _mrEHqOv7;
        "paper-1.20.5" = _mrEHqOv7;
        "paper-1.20.6" = _mrEHqOv7;
        "paper-1.21" = _mrEHqOv7;
        "paper-1.21.1" = _mrEHqOv7;
        "paper-1.21.2" = _mrEHqOv7;
        "paper-1.21.3" = _mrEHqOv7;
        "paper-1.21.4" = _mrEHqOv7;
        "paper-1.21.5" = _mrEHqOv7;
        "paper-1.21.6" = _mrEHqOv7;
        "paper-1.21.7" = _mrEHqOv7;
        "paper-1.21.8" = _mrEHqOv7;
        "paper-1.21.9" = _mrEHqOv7;
        "paper-1.21.10" = _mrEHqOv7;
        "paper-1.21.11" = _mrEHqOv7;
        "paper-26.1" = _mrEHqOv7;
        "paper-26.1.1" = _mrEHqOv7;
        "paper-26.1.2" = _mrEHqOv7;
        "paper-26.2" = _mrEHqOv7;
        "paper-26.3" = _mrEHqOv7;
        "purpur-1.20" = _mrEHqOv7;
        "purpur-1.20.1" = _mrEHqOv7;
        "purpur-1.20.2" = _mrEHqOv7;
        "purpur-1.20.3" = _mrEHqOv7;
        "purpur-1.20.4" = _mrEHqOv7;
        "purpur-1.20.5" = _mrEHqOv7;
        "purpur-1.20.6" = _mrEHqOv7;
        "purpur-1.21" = _mrEHqOv7;
        "purpur-1.21.1" = _mrEHqOv7;
        "purpur-1.21.2" = _mrEHqOv7;
        "purpur-1.21.3" = _mrEHqOv7;
        "purpur-1.21.4" = _mrEHqOv7;
        "purpur-1.21.5" = _mrEHqOv7;
        "purpur-1.21.6" = _mrEHqOv7;
        "purpur-1.21.7" = _mrEHqOv7;
        "purpur-1.21.8" = _mrEHqOv7;
        "purpur-1.21.9" = _mrEHqOv7;
        "purpur-1.21.10" = _mrEHqOv7;
        "purpur-1.21.11" = _mrEHqOv7;
        "purpur-26.1" = _mrEHqOv7;
        "purpur-26.1.1" = _mrEHqOv7;
        "purpur-26.1.2" = _mrEHqOv7;
        "purpur-26.2" = _mrEHqOv7;
        "purpur-26.3" = _mrEHqOv7;
        "pkg-0.0.1-dev.4d09a0b" = _ApmhYz5e;
        "pkg-0.0.1-dev.991fcb9" = _PJoPGfiB;
        "pkg-0.0.1-dev.1d799ce" = _huqJDTrz;
        "pkg-0.0.1-dev.830ef8b" = _57FvuzdT;
        "pkg-0.0.2-dev.793dc4b" = _RcJMSYXy;
        "pkg-0.0.2-dev.8c50141" = _jiFzmpuX;
        "pkg-0.0.2-dev.595b136" = _KBulaPR2;
        "pkg-0.0.2-dev.c78a65f" = _WCemcvaf;
        "pkg-0.0.2-dev.df42c95" = _orJAxbwI;
        "pkg-0.0.2-dev.3bc1dac" = _gARldhiW;
        "pkg-0.0.2-dev.ed20888" = _pMN6l6NK;
        "pkg-0.0.2-dev.9d755b8" = _hGeHBkGf;
        "pkg-0.0.2-dev.dbe10e5" = _QKXCTgG0;
        "pkg-0.0.2-dev.64aa1b7" = _q9K7HmKt;
        "pkg-0.0.2" = _MqCgYE81;
        "pkg-0.0.3" = _6QThCMM1;
        "pkg-0.0.4" = _gL8ms2RI;
        "pkg-0.0.5" = _mrEHqOv7;
