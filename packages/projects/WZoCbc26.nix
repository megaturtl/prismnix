...
let
    ...
    in {
        ...
        "pkg-0.0.1-fabric" = _TYy2T53k;
        "pkg-0.0.1-forge" = _G7Dv4FfI;
        "pkg-0.0.2-forge" = _9bSOLs9e;
        "pkg-0.0.2-fabric" = _Y0lbPThD;
        "pkg-0.0.3-fabric" = _4WBTr51f;
        "pkg-0.0.3-forge" = _GzgpyD2n;
        "pkg-0.0.4-fabric" = _yi7XQq9p;
        "pkg-0.0.4-forge" = _J4U5ZIsU;
        "pkg-0.0.5-fabric" = _Urz0tiO9;
        "pkg-0.0.5-forge" = _JQmbVode;
        "pkg-0.0.6-forge" = _xwDOH383;
        "pkg-0.0.6-fabric" = _wuoVM0u0;
        "pkg-0.0.8-fabric" = _Qmp92c7U;
        "pkg-0.0.8-forge" = _ctbe38m8;
        "pkg-0.0.9-fabric" = _L0eDFmhl;
        "pkg-0.0.9-forge" = _DFPxq6KQ;
        "pkg-0.0.10-forge" = _c2AuLiBB;
        "pkg-0.0.10-fabric" = _N5RVdCNY;
        "pkg-0.0.12-fabric" = _WEVmYjH8;
        "pkg-0.0.12-forge" = _7dOTocUe;
        "pkg-0.0.13-fabric" = _dcX1pWs7;
        "pkg-0.0.13-forge" = _nJwyOWHe;
        "pkg-0.0.14-fabric" = _F0h9ML6p;
        "pkg-0.0.14-forge" = _3DlvuJhq;
        "pkg-0.0.15-fabric" = _xGS23D4e;
        "pkg-0.0.15-forge" = _c8jY4cXG;
        "pkg-0.0.16-forge" = _giIcUl6Q;
        "pkg-0.0.16-fabric" = _y9mb5hv7;
        "pkg-0.0.16-neoforge" = _SbSg0bUq;
        "pkg-0.0.18-fabric" = _rFijEPQw;
        "default" = _rFijEPQw;
    });
