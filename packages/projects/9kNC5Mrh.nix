...
let
    versions = (let
        ...
        _XsnVihQ8 = {
            "id" = "XsnVihQ8";
            "file" = "BuildPaste_Fabric-26.2v3.0.2-3.0.2.jar";
            "hash" = "sha512-3vkrOhTTCIgqgzwvmS21aCyeBXWxTMXGzeyHTlx4f3yNQm+RUygmA9slOLhOVxg8plpIdTlzCIHaACSHTlbJoQ==";
        };
        _LqvH5V8x = {
            "id" = "LqvH5V8x";
    ...
    in {
        ...
        "pkg-1.11.0" = _vIsKcY7V;
        "pkg-1.5.0" = _vuIE6EVW;
        "pkg-1.9.10" = _AF754qFd;
        "pkg-1.7.3" = _r6rN7pWk;
        "pkg-1.6.4" = _4h4wTpWP;
        "pkg-1.4.0" = _I69RAMob;
        "pkg-1.1" = _YfFJ8zHK;
        "pkg-1.9.1" = _JpL7vdq7;
        "pkg-1.11.1" = _OO6toB0p;
        "pkg-1.11.4" = _71wrhsaw;
        "pkg-1.11.5" = _OhjSfxza;
        "pkg-2.0.1" = _Pch4s8p8;
        "pkg-1.6.1" = _vV1gyno3;
        "pkg-1.6.2" = _dgxCZTXi;
        "pkg-2.0.3" = _WBOknzO9;
        "pkg-1.6.5" = _hlnr29Z8;
        "pkg-2.0.4" = _5XlQ7p8Y;
        "pkg-1.6.4.1" = _Cl2pJkNW;
        "pkg-1.8.3.1" = _yqaVCbgC;
        "pkg-1.9.5.1" = _4KYbGeej;
        "pkg-1.9.11.1" = _6FD0bq63;
        "pkg-1.11.5.1" = _ysdaKpyu;
        "pkg-1.1.1" = _3dq00zKd;
        "pkg-1.4.1" = _JTWXxpfy;
        "pkg-1.5.1.1" = _vgT2XBmN;
        "pkg-1.6.6" = _AaU5lbEz;
        "pkg-1.7.0" = _XGXvTRtH;
        "pkg-2.1.1" = _LgsB03os;
        "pkg-1.7.1" = _h0bSBs71;
