...
let
    ...
    in {
        ...
        "pkg-1.0.1+1.19.2" = _OGMMkP6L;
        "pkg-1.0.2" = _XVtjQuiL;
        "pkg-1.0.2+1.19.2" = _L7Kcd2OC;
        "pkg-1.1.0" = _TTTlCzoW;
        "pkg-1.2.0" = _dRhhv178;
        "pkg-1.3.0" = _xpcARx9G;
        "pkg-1.3.2" = _Gh82iXam;
        "pkg-1.3.3" = _7auGAyI0;
        "pkg-1.3.5" = _VWwhqePo;
        "pkg-1.3.5+1.20.1" = _swy9RbTN;
        "pkg-1.3.5+1.19.4" = _dTnvfIjj;
        "pkg-1.3.6+1.20.1" = _sF2E0Rlo;
        "pkg-1.3.7+1.20.1" = _MlH70513;
        "pkg-1.3.7+1.20.5" = _QHKzP1OP;
        "pkg-1.3.8+1.20.1" = _7Wg923Xf;
        "pkg-1.3.9+1.20.1" = _SGmfdrZ1;
        "pkg-1.4.0+1.21.4" = _xybR5MvP;
        "pkg-1.3.8+1.21.1" = _4vqbtJFv;
        "pkg-1.3.9+1.21.1" = _terh3YnD;
        "pkg-1.4.0+1.21.1" = _xYvnC5g9;
        "pkg-1.5.0+1.21.5" = _kQfduNV1;
        "pkg-1.5.1+1.21.6" = _wfe2HMNI;
        "pkg-1.4.1+1.21.1" = _FX1mVRky;
        "pkg-1.5.1+26.1" = _fOEGIdAP;
        "pkg-1.4.2+1.21.1" = _3SZzPOJe;
