...
let
    ...
    in {
        ...
        "pkg-1.15.0" = _ePzzvV1b;
        "pkg-1.15.1" = _ewQpHc8q;
        "pkg-1.15.2" = _54qjYmTd;
        "pkg-1.15.2+1.19.4" = _Oiy7wUe3;
        "pkg-1.15.3+1.19.2" = _GlNFICBW;
        "pkg-1.15.3+1.19.3" = _zFAxMHkW;
        "pkg-1.16.0+1.20.2" = _1szJCpO0;
        "pkg-1.17.0+1.20.4" = _rQt5jR0L;
        "pkg-1.17.1+1.20.4" = _YbSs9tOG;
        "pkg-1.15.6+1.20.1" = _9xYCRuvv;
        "pkg-1.16.1+1.20.2" = _I346Euw7;
        "pkg-1.18.0+1.20.5" = _MDK4h8JF;
        "pkg-1.19.0+1.21" = _B15xNulD;
        "pkg-1.19.1+1.21" = _UTkVrMp1;
        "pkg-1.19.2+1.21" = _HhOltC3X;
        "pkg-1.19.3+1.21.3" = _MYZAw3XX;
        "pkg-1.20.0+1.21.3" = _wX2e6wCg;
        "pkg-1.20.0+1.21" = _JKC6tjWU;
        "pkg-1.20.1+1.21.3" = _gjf5PPdc;
        "pkg-1.20.2+1.21.3" = _AyrAHKGG;
        "pkg-1.20.3+1.21.4" = _QYleS4qr;
        "pkg-1.20.3+1.21.3" = _ZztHyNkz;
        "pkg-1.20.1+1.21" = _p1Djg4Hs;
        "pkg-1.20.4+1.21.4" = _F2eXASWD;
        "pkg-1.20.5+1.21.4" = _Z5tyhudT;
        "pkg-1.20.5+1.21.5" = _eb2S83Vp;
        "pkg-1.21.0+1.21.7" = _EaoXn2x8;
        "pkg-1.21.0+1.21.5" = _nN1qj4XC;
        "pkg-1.21.0+1.21.4" = _pnV0ZWAM;
        "pkg-1.21.0+1.21.3" = _ZLUmxMkd;
        "pkg-1.21.0+1.21" = _C6d2v7d7;
        "pkg-1.21.1+1.21.7" = _kZwstJC0;
        "pkg-1.21.1+1.21.5" = _lI7UGAen;
        "pkg-1.21.1+1.21.4" = _1woHEcgL;
        "pkg-1.21.1+1.21.3" = _2EUKpgZJ;
        "pkg-1.21.1+1.21" = _LqiO7ltE;
        "pkg-1.21.1+1.21.10" = _QiT4PBI0;
        "pkg-1.21.2+1.21.10" = _9aAaiF4E;
        "pkg-1.21.3+1.21.10" = _Whmcy98t;
        "pkg-1.21.4-beta.1+1.21.11" = _e37KAsPE;
        "pkg-1.21.4+1.21.11" = _PbdHkan6;
