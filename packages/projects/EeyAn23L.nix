...
let
    versions = (let
        ...
        _j3hwR5aN = {
            "id" = "j3hwR5aN";
            "file" = "FancyNpcs-2.11.0+371.jar";
            "hash" = "sha512-fUcFDSNa4Xk3jRJN6szWZ154tMGiebfLDespqePiTXaRv8Hn0SbsqCZxBKG/FSmZB7YKEQnDC5b9+67HY2s66g==";
        };
        _rTPgRFzP = {
            "id" = "rTPgRFzP";
            "file" = "FancyNpcs-2.11.0+372.jar";
            "hash" = "sha512-rd83JpfkgI4qNPfbY5gO4mcLQSlcCUP3CJe2j9p2tOY71QtzsYAaLbFqbkXAr30ZreUxO8x+sSGcUnCKQgVf1A==";
        };
    in {
        "VylZZyrf" = _VylZZyrf;
        "pTsoaWlr" = _pTsoaWlr;
        ...
        "paper-1.21.6" = _rTPgRFzP;
        "paper-1.21.7" = _rTPgRFzP;
        "paper-1.21.8" = _rTPgRFzP;
        "paper-1.21.9" = _rTPgRFzP;
        "paper-1.21.10" = _rTPgRFzP;
        ...
        "folia-1.21.6" = _rTPgRFzP;
        "folia-1.21.7" = _rTPgRFzP;
        "folia-1.21.8" = _rTPgRFzP;
        "folia-1.21.9" = _rTPgRFzP;
        "folia-1.21.10" = _rTPgRFzP;
        ...
        "folia-1.21.11" = _rTPgRFzP;
        "folia-26.1.1" = _32nYYklA;
        "folia-26.1.2" = _rTPgRFzP;
        "folia-26.2-rc-2" = _KScxKvb6;
        "folia-26.2" = _rTPgRFzP;
        "pkg-1.0.5" = _VylZZyrf;
        "pkg-1.0.6" = _pTsoaWlr;
        "pkg-1.0.7" = _wkt9KGbK;
        "pkg-1.0.8" = _ksTeHCiB;
        ...
        "pkg-2.0.0" = _cXqpaUSj;
        "pkg-2.0.1" = _ymiAggfi;
        "pkg-2.0.2.1" = _pIe2nb0e;
        "pkg-2.0.3" = _GeKIuMsF;
        "pkg-2.0.4" = _U9aptHdz;
        "pkg-2.0.5" = _i0rup5hZ;
        "pkg-2.0.6" = _5kr6QY3c;
        "pkg-2.0.6.1" = _WbX8eYoN;
        "pkg-2.0.7" = _jdTEUHUr;
        "pkg-2.0.8" = _oNwvSnGH;
        "pkg-2.0.9" = _Dmfq3eoF;
        "pkg-2.0.10" = _BXdpy3fk;
        "pkg-2.0.11" = _sYEKh2Lh;
        "pkg-2.1.0-SNAPSHOT.160" = _wDyVDvcq;
        "pkg-2.1.0-SNAPSHOT.162" = _TDX4c5Rj;
        "pkg-2.1.0-SNAPSHOT.163" = _PfFuGfYb;
        "pkg-2.1.0" = _TNkpkzhF;
        "pkg-2.2.0" = _O1ERHxtE;
        "pkg-2.2.0.170" = _1PE6nCPT;
        "pkg-2.2.0.172" = _Zg8CUTWs;
        "pkg-2.2.0.173" = _2Y5s8RYr;
        "pkg-2.2.0.174" = _6VqWK903;
        "pkg-2.2.0.175" = _D86ySRYo;
        "pkg-2.2.0.176" = _Im3gRVm6;
        "pkg-2.2.0.177" = _9DLDkyz7;
        "pkg-2.2.0.178" = _xlyUdo80;
        "pkg-2.2.0.179" = _6FQgl1QK;
        "pkg-2.2.0.180" = _MeeXuSXR;
        "pkg-2.2.0.181" = _T4pZ2NxK;
        "pkg-2.2.0.182" = _lefVBOwe;
        "pkg-2.2.1" = _crQzYukH;
        "pkg-2.2.1.183" = _TOZAvXXb;
        "pkg-2.2.1.184" = _Vj33KZxR;
        "pkg-2.2.1-DEV.185" = _3vC07uPF;
        "pkg-2.2.2" = _qx3gzG0p;
        "pkg-2.2.2.186" = _3lxU0djb;
        "pkg-2.2.2.187" = _KyhcUBrI;
        "pkg-2.2.2.188" = _sOFGjIPU;
        "pkg-2.2.2.189" = _MaJ7HbYm;
        "pkg-2.2.2.191" = _bEKilkBo;
        "pkg-2.2.2.193" = _LbJGgESn;
        "pkg-2.2.2.194" = _VXVixkue;
        "pkg-2.2.2.195" = _b32lQLKI;
        "pkg-2.2.2.196" = _1hVgAtEK;
        "pkg-2.2.2.197" = _eOBmJBfk;
        "pkg-2.2.2.198" = _QLd8j1eR;
        "pkg-2.2.2.199" = _b065Wj54;
        "pkg-2.2.2.200" = _vcdnWQJz;
        "pkg-2.2.2.201" = _xX77tdpN;
        "pkg-2.2.2.202" = _WHom7znN;
        "pkg-2.2.2.203" = _vP822mfN;
        "pkg-2.2.2.204" = _UBXiIWJi;
        "pkg-2.3.0" = _mXFBwy32;
        "pkg-2.3.0.205" = _E7hOyqvq;
        "pkg-2.3.0.206" = _lWlln5Og;
        "pkg-2.3.0.207" = _3NVO4NaC;
        "pkg-2.3.0.208" = _UMjs3UOj;
        "pkg-2.3.0.209" = _MdrcLBLU;
        "pkg-2.3.0.210" = _95Kk4jHL;
        "pkg-2.3.0.211" = _lcCOKJvt;
        "pkg-2.3.0.212" = _r67yheiq;
        "pkg-2.3.0.213" = _L6Hi7t2y;
        "pkg-2.3.0.214" = _E3wPEsna;
        "pkg-2.3.1" = _ba1Gi4bW;
        "pkg-2.3.1.215" = _tEIS9MqC;
        "pkg-2.3.1.216" = _UnQiRe3B;
        "pkg-2.3.1.217" = _heTXshTJ;
        "pkg-2.3.1.218" = _tsAdr5Sl;
        "pkg-2.4.0" = _Bpu8cb2s;
        "pkg-2.4.0.220" = _IV1iaHij;
        "pkg-2.4.0.221" = _C5iefjj5;
        "pkg-2.4.0.222" = _R7LWFE69;
        "pkg-2.4.0.223" = _1zcmCYP9;
        "pkg-2.4.0.224" = _QX21IGyb;
        "pkg-2.4.0.225" = _H9swyLTt;
        "pkg-2.4.0.226" = _UiqGiO7u;
        "pkg-2.4.0.227" = _jpPcJ99l;
        "pkg-2.4.1" = _DHpHfsmD;
        "pkg-2.4.1.228" = _e2v5GKUG;
        "pkg-2.4.1.229" = _eIuMda0p;
        "pkg-2.4.1.230" = _iA2fwvnQ;
        "pkg-2.4.1.231" = _OOHk3VQB;
        "pkg-2.4.1.232" = _WXBmFr3v;
        "pkg-2.4.1.233" = _SVrX1w6Y;
        "pkg-2.4.1.234" = _Qnql1oaa;
        "pkg-2.4.2" = _WMwZ5R8O;
        "pkg-2.4.2.237" = _K9TziilA;
        "pkg-2.4.2.238" = _Bh4b3rqY;
        "pkg-2.4.2.239" = _EgsY8EL3;
        "pkg-2.4.2.240" = _w93bDPaB;
        "pkg-2.4.2.241" = _WjzUgyb5;
        "pkg-2.4.2.242" = _EJstj1sz;
        "pkg-2.4.2.243" = _j7UEXYLt;
        "pkg-2.4.2.244" = _kVn0S3Eq;
        "pkg-2.4.2.245" = _C3NhIsFi;
        "pkg-2.4.3" = _PQEeSktw;
        "pkg-2.4.3.246" = _IYVdohC5;
        "pkg-2.4.3.247" = _fXjrE7Fg;
        "pkg-2.4.3.248" = _Ajssem7n;
        "pkg-2.4.4" = _NalSpLg6;
        "pkg-2.4.4.249" = _HTqV1liV;
        "pkg-2.4.4.252" = _HjCIhHC4;
        "pkg-2.4.4.253" = _XEIPaepp;
        "pkg-2.4.4.254" = _nj4WqMmE;
        "pkg-2.4.4.255" = _VySTAV70;
        "pkg-2.4.4.256" = _72FdRnW9;
        "pkg-2.4.4.257" = _dBRneTfK;
        "pkg-2.4.4.258" = _9D2Nzsmd;
        "pkg-2.4.4.259" = _73gsSNe0;
        "pkg-2.4.4.260" = _w8tKCalk;
        "pkg-2.5.0" = _Zhcyw48Q;
        "pkg-2.5.0.261" = _GjvgKqqf;
        "pkg-2.5.0.262" = _NJvMkgkQ;
        "pkg-2.5.0.263" = _94pDRrZ4;
        "pkg-2.5.0.264" = _4TdiL8of;
        "pkg-2.5.1" = _YOzKhwZI;
        "pkg-2.5.1.265" = _3r7rinDc;
        "pkg-2.5.1.266" = _rciXnR5l;
        "pkg-2.5.1.267" = _yexucRnL;
        "pkg-2.5.1.268" = _4M2WyByT;
        "pkg-2.5.1.269" = _VjiwM3Y5;
        "pkg-2.5.1.270" = _xYKVSjFQ;
        "pkg-2.5.1.271" = _xS8Bz3u2;
        "pkg-2.5.2" = _7xfV86kn;
        "pkg-2.5.2.272" = _Cgm5AfbR;
        "pkg-2.5.2.273" = _USkLxqA8;
        "pkg-2.5.2.274" = _7m4CgLGY;
        "pkg-2.5.2.275" = _Zn5HipO2;
        "pkg-2.6.0" = _Cn9mEqZq;
        "pkg-2.6.0.275" = _AYUIzI0M;
        "pkg-2.6.0.276" = _lUic26re;
        "pkg-2.6.0.277" = _7TDMH2Xn;
        "pkg-2.6.0.278" = _3wYQYzjp;
        "pkg-2.6.0.279" = _ak1tPUtF;
        "pkg-2.6.0.280" = _WHns6Gmr;
        "pkg-2.6.0.281" = _ppUgQ0SS;
        "pkg-2.6.0.282" = _3YaGvRaI;
        "pkg-2.6.0.283" = _mEbn8JME;
        "pkg-2.6.0.284" = _ugXwYI8F;
        "pkg-2.7.0" = _6NzXscMK;
        "pkg-2.7.0.285" = _eSNhiGgJ;
        "pkg-2.7.0.286" = _wvoUz249;
        "pkg-2.7.0.287" = _EJk3uUaZ;
        "pkg-2.7.0.288" = _zOqsWb0Z;
        "pkg-2.7.0.289" = _HRpMyE47;
        "pkg-2.7.1" = _nOVLlzKF;
        "pkg-2.7.1.290" = _p9Dndb8v;
        "pkg-2.7.1.291" = _VMZvJWH7;
        "pkg-2.7.1.292" = _maVumbgt;
        "pkg-2.7.1.293" = _EN2yVFGo;
        "pkg-2.7.1.294" = _1ONOEJKP;
        "pkg-2.7.1.295" = _P6ZSfl6y;
        "pkg-2.7.1.296" = _nffrg6a4;
        "pkg-2.7.1.297" = _cxomp9ok;
        "pkg-2.7.1.298" = _FWTzI4iz;
        "pkg-2.7.1.299" = _N7kkwwAL;
        "pkg-2.7.1.300" = _FngtQl1R;
        "pkg-2.8.0" = _DZkbDxol;
        "pkg-2.8.0.301" = _HyQkwJFq;
        "pkg-2.8.0.302" = _LIi9sd9P;
        "pkg-2.8.0.303" = _DgDmtgJg;
        "pkg-2.8.0.304" = _JT777Dsf;
        "pkg-2.8.0.305" = _Ml1EKf9C;
        "pkg-2.8.0.306" = _lqda86J3;
        "pkg-2.8.0.307" = _XNhtnQOM;
        "pkg-2.8.0.308" = _a8wPRaQC;
        "pkg-2.8.0.309" = _70uc0OEG;
        "pkg-2.8.0.310" = _mTDOjkr8;
        "pkg-2.8.0.311" = _7qEDYRhT;
        "pkg-2.8.0.312" = _kR1aAVVP;
        "pkg-2.8.1" = _Bq73ZE8e;
        "pkg-2.8.1.313" = _RpZQZcTg;
        "pkg-2.8.1.314" = _zVyi3ixJ;
        "pkg-2.8.1.315" = _cC1ixDM0;
        "pkg-2.8.1.316" = _mSxgO4VT;
        "pkg-2.8.1.317" = _QJo4Kory;
        "pkg-2.8.1.318" = _Is99BEiD;
        "pkg-2.8.1.319" = _ujeAnyRT;
        "pkg-2.8.1.320" = _2Svd7b4W;
        "pkg-2.8.1.321" = _FaqqPghn;
        "pkg-2.9.0" = _pqPHT6wS;
        "pkg-2.9.0.322" = _vVCKW0J4;
        "pkg-2.9.0.323" = _sYp9Yp7d;
        "pkg-2.9.0.324" = _gP2IsHn5;
        "pkg-2.9.0.325" = _yfMxR0KE;
        "pkg-2.9.0.326" = _9tOstiN9;
        "pkg-2.9.0.327" = _H4S2Cm9w;
        "pkg-2.9.0.328" = _UiQ2Lhic;
        "pkg-2.9.0.329" = _V8HlNNse;
        "pkg-2.9.0.330" = _nnlllmBu;
        "pkg-2.9.1" = _ZCrVQ3rv;
        "pkg-2.9.1.331" = _oINmIh3q;
        "pkg-2.9.1.332" = _o86123Gn;
        "pkg-2.9.1.333" = _fUdOVBbR;
        "pkg-2.9.2" = _aBqGwA1m;
        "pkg-2.9.2.334" = _D7B3xeTy;
        "pkg-2.9.2.335" = _lIqYvWIo;
        "pkg-2.9.2.336" = _Q0JXEszN;
        "pkg-2.9.2.337" = _PqmnoBwQ;
        "pkg-2.9.2.338" = _8AIsBJk2;
        "pkg-2.9.2.340" = _d0sH6Fbo;
        "pkg-2.9.2.341" = _4aBwydHd;
        "pkg-2.9.2.342" = _xNsrEsFn;
        "pkg-2.9.2.343" = _GLCtaSrD;
        "pkg-2.9.2.344" = _GbmZGsMO;
        "pkg-2.9.2.345" = _FAm50eq1;
        "pkg-2.9.2.346" = _gA2E6T6a;
        "pkg-2.9.2.347" = _JxufPSYi;
        "pkg-2.9.2.348" = _Sf7RqEte;
        "pkg-2.9.2.349" = _AGNkXPUb;
        "pkg-Wednesday" = _mMu2Oank;
        "pkg-2.9.2.350" = _XONvk67g;
        "pkg-2.9.2.351" = _32nYYklA;
        "pkg-2.9.2.352" = _72iBXLuH;
        "pkg-2.9.2.353" = _fgTluiNj;
        "pkg-2.9.2.354" = _jLXqRDKU;
        "pkg-2.10.0" = _9dy6tkBa;
        "pkg-2.10.0.355" = _Z8wI1rfa;
        "pkg-2.10.0.356" = _cXe6A61e;
        "pkg-2.10.0.357" = _zOMrRGhZ;
        "pkg-2.10.0.358" = _Yl9vYVTb;
        "pkg-2.10.0.359" = _gljZrXLF;
        "pkg-2.10.0-java21" = _3Jzu0EP2;
        "pkg-2.10.0+2-java21" = _ZCtHLJUc;
        "pkg-2.10.0.361" = _8acsjxH5;
        "pkg-2.10.0.362" = _wYIVl1vf;
        "pkg-2.10.0.363" = _N44P0IgS;
        "pkg-2.10.0.364" = _x9i0iR7o;
        "pkg-2.10.1-java21" = _axfBJcKs;
        "pkg-2.10.1" = _x31qn7aH;
        "pkg-2.10.1.365" = _W4PnJVEV;
        "pkg-2.10.1.366" = _NifbtgTN;
        "pkg-2.10.1-java21+2" = _kzwcmR9P;
        "pkg-2.10.1.367" = _kqQxQEzD;
        "pkg-2.10.1.368" = _KScxKvb6;
        "pkg-2.11.0" = _zM6uZoPe;
        "pkg-2.11.0+369" = _m6wsmrHP;
        "pkg-2.11.0+370" = _sEt3BDRu;
        "pkg-2.11.0+371" = _j3hwR5aN;
