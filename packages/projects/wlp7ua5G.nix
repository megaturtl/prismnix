...
let
    ...
    in {
        ...
        "pkg-1.0.0+mc1.21.10-fabric" = _caZN13PO;
        "pkg-1.1.0+mc1.21.10-neoforge" = _9C0Ih4vQ;
        "pkg-1.1.0+mc1.21.11-neoforge" = _3zo0VjYO;
        "pkg-1.1.0+mc1.21.11-fabric" = _6nj0huJl;
        "pkg-1.1.0+mc1.21.10-fabric" = _uWe23jpP;
        "pkg-1.1.1+mc1.21.10-fabric" = _JoJpuUHl;
        "pkg-1.1.1+mc1.21.11-fabric" = _oXC5AMFY;
        "pkg-1.1.1+mc1.21.11-neoforge" = _208ylGYD;
        "pkg-1.1.1+mc1.21.10-neoforge" = _pEhb2JUP;
        "pkg-1.2.0+mc1.21.10-neoforge" = _IvoIj6ks;
        "pkg-1.2.0+mc1.21.10-fabric" = _CpIcR3lc;
        "pkg-1.2.1+mc1.21.10-neoforge" = _ZROe33gq;
        "pkg-1.2.1+mc1.21.10-fabric" = _k6CwbGNb;
        "pkg-1.1.1+mc26.1-snapshot-7-fabric" = _sxVqbi2y;
        "pkg-1.1.1+mc26.1-snapshot-7-neoforge" = _D3jCxumB;
        "pkg-1.2.0+mc1.21.11-neoforge" = _sZwGiGtn;
        "pkg-1.3.0+mc1.21.10-neoforge" = _b4DupIH4;
        "pkg-1.2.0+mc1.21.11-fabric" = _i0dSXUY1;
        "pkg-1.3.0+mc1.21.10-fabric" = _ynTCVwq0;
        "pkg-1.2.0+mc26.1-fabric" = _PAxS8xeA;
        "pkg-1.2.0+mc26.1-neoforge" = _H5YNjcly;
        "pkg-26.1.2.0" = _VsMSXIfz;
        "pkg-26.1.2.1" = _fW2bAiQH;
        "pkg-26.2.0" = _ZmaZ3glm;
        "pkg-26.2.0.1" = _rVDuVXgy;
        "pkg-26.1.2.2" = _OAnsk5Gg;
        "pkg-26.1.2.3" = _4GQtPNSf;
