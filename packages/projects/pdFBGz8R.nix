...
let
    versions = (let
        ...
        _37ahNUHU = {
            "id" = "37ahNUHU";
            "file" = "Gentler Rain Sounds 1.3.zip";
            "hash" = "sha512-pUQuSG5S6Xw3jNomMD4b3izKpDz3GuubmhXlRlTjJt38OQkQ4sn5UGjmb/lRQuAYIte2IWdMBYWrmOdctjVGLQ==";
        };
    in {
        "E26BhtJu" = _E26BhtJu;
        "vantBm84" = _vantBm84;
        ...
        "minecraft-1.18" = _37ahNUHU;
        "minecraft-1.18.1" = _37ahNUHU;
        "minecraft-1.18.2" = _37ahNUHU;
        "minecraft-1.19" = _37ahNUHU;
        "minecraft-1.19.1" = _37ahNUHU;
        "minecraft-1.19.2" = _37ahNUHU;
        "minecraft-1.19.3" = _37ahNUHU;
        "minecraft-1.19.4" = _37ahNUHU;
        "minecraft-1.20" = _37ahNUHU;
        "minecraft-1.20.1" = _37ahNUHU;
        "minecraft-1.20.2" = _37ahNUHU;
        "minecraft-1.20.3" = _37ahNUHU;
        "minecraft-1.20.4" = _37ahNUHU;
        "minecraft-1.20.5" = _37ahNUHU;
        "minecraft-1.20.6" = _37ahNUHU;
        "minecraft-1.21" = _37ahNUHU;
        "minecraft-1.21.1" = _37ahNUHU;
        "minecraft-1.21.2" = _37ahNUHU;
        "minecraft-1.21.3" = _37ahNUHU;
        "minecraft-1.21.4" = _37ahNUHU;
        "minecraft-1.21.5" = _37ahNUHU;
        "minecraft-1.21.6" = _37ahNUHU;
        "minecraft-1.21.7" = _37ahNUHU;
        "minecraft-1.21.8" = _37ahNUHU;
        "minecraft-1.21.9" = _37ahNUHU;
        "minecraft-1.21.10" = _37ahNUHU;
        "minecraft-1.21.11" = _37ahNUHU;
        "minecraft-26.1" = _37ahNUHU;
        "minecraft-26.1.1" = _37ahNUHU;
        "minecraft-26.1.2" = _37ahNUHU;
        "minecraft-26.2" = _37ahNUHU;
        "minecraft-26.3-pre-2" = _Br4DgX7i;
        "minecraft-26.3" = _37ahNUHU;
        "pkg-1.0" = _E26BhtJu;
        "pkg-1.1" = _vantBm84;
        "pkg-1.2" = _Br4DgX7i;
        "pkg-1.3" = _37ahNUHU;
