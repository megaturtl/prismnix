...
let
    ...
    in {
        ...
        "pkg-1.5.8" = _H6rB6F7X;
        "pkg-1.5.9" = _pmGe6xTq;
        "pkg-1.5.10" = _Ay7JURxa;
        "pkg-1.5.11" = _UajErY3a;
        "pkg-1.6.0" = _LlWcfGz0;
        "pkg-1.6.1" = _giolaJOq;
        "pkg-1.7.0" = _qDEGHdtu;
        "pkg-1.8.1+1.21.1" = _Yc6EP9RZ;
        "pkg-1.9.0+1.21.1" = _I0K6SWsz;
        "pkg-1.9.1+1.21.1" = _KfRJT7dN;
        "pkg-1.9.2+1.21.1" = _eVMdqtvW;
        "pkg-1.9.3+1.21.1" = _ZSyzMaYg;
        "pkg-1.9.4+1.21.1" = _XTRyJPPJ;
        "pkg-1.9.5+1.21.1" = _TY38YuUM;
        "pkg-1.10.0+1.21.1" = _oBsrEdNI;
        "pkg-1.10.1+1.21.1" = _29xqIWX4;
        "pkg-1.10.2+1.21.1" = _Jxq0rdYJ;
        "pkg-1.10.3+1.21.1" = _XUGwqX3Y;
        "pkg-1.10.4+1.21.1" = _In1CMZKd;
        "pkg-1.10.5+1.21.1" = _xqsJrnwk;
        "pkg-1.10.6+1.21.1" = _HmJXgBfm;
        "pkg-1.10.7+1.21.1" = _bKvSEhyo;
        "pkg-1.10.8+1.21.1" = _GFDNXIaC;
        "pkg-1.10.9+1.21.1" = _FqaN2ghD;
        "pkg-1.10.10+1.21.1" = _DgIn5gGv;
        "pkg-1.10.11+1.21.1" = _OoF1BUYd;
        "pkg-1.11.0+1.21.1" = _5BwnbmWu;
        "pkg-1.11.1+1.21.1" = _tfHmDUDd;
        "pkg-1.11.2+1.21.1" = _903OFjcp;
        "pkg-1.11.3+1.21.1" = _RaS1NbUp;
