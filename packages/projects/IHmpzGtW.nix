...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _ttpw9CI3;
        "pkg-1.0.9" = _oZF7xGtg;
        "pkg-1.0.10" = _7S16Avus;
        "pkg-1.0.11" = _pZsdElAe;
        "pkg-1.0.12" = _y1YbYxww;
        "pkg-1.0.13" = _zqORGsyO;
        "pkg-1.0.14" = _76r1IJ3Z;
        "pkg-1.0.15" = _GYDSoVex;
        "pkg-1.0.16" = _buQuwzqC;
        "pkg-1.0.17" = _z54eFzKj;
        "pkg-1.0.18" = _XZuZzNSE;
