...
let
    versions = (let
        ...
        _unwZ4Vu5 = {
            "id" = "unwZ4Vu5";
            "file" = "elytra_phantom-1.0.1-mc26.3.zip";
            "hash" = "sha512-4TozXUzh2h7yHQWSsxUd0EdgPdwYwV7GeKbqj2mXb2xX6PJcsGir+CaaRM73boTMTRAgzorCKBwroKGzRzi4xw==";
        };
    in {
        "NdOMWojm" = _NdOMWojm;
        "mACTxakd" = _mACTxakd;
