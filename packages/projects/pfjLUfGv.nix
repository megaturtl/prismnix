...
let
    versions = (let
        ...
        _n4HwegBU = {
            "id" = "n4HwegBU";
            "file" = "Botania-1.20.1-456-FABRIC.jar";
            "hash" = "sha512-LhieW3qe2kLBrl8aIYrC8QtDSzENnkcXbiucuvDCKRZqVrK4x2arU64fpuh9Rk94yYoA/gb3FfjitkV3j7uKRA==";
        };
        _npY4sRWF = {
            "id" = "npY4sRWF";
            "file" = "Botania-1.20.1-456-FORGE.jar";
            "hash" = "sha512-Q7guPhAbzS8UQb5eHPFsRjHkl8fNUKvYvch3ASgeUSZzpCDOwW4FKabtaTaqLVRTmOn+Oe2ajz0NJmAflAMn+g==";
        };
    in {
        "mwSLII0N" = _mwSLII0N;
        "2P9x6c71" = _2P9x6c71;
        ...
        "fabric-1.20.1" = _n4HwegBU;
        "quilt-1.18.2" = _I1sdolxI;
        "quilt-1.19.2" = _rY2B5H93;
        "quilt-1.20.1" = _n4HwegBU;
        ...
        "forge-1.20.1" = _npY4sRWF;
        "forge-1.6.4" = _ZpspnX2M;
        "pkg-1.18.2-432-fabric" = _mwSLII0N;
        "pkg-1.18.2-432-forge" = _2P9x6c71;
        "pkg-1.15-388-forge" = _qxd8PXZm;
        "pkg-1.11-379-forge" = _XoXz4jGl;
        "pkg-1.10-364.4-forge" = _QYXVsA5d;
        "pkg-1.9-345-forge" = _Z0zssckA;
        "pkg-1.9-341-forge" = _KQgw4Ofr;
        "pkg-1.8-249-forge" = _Vez9CKSz;
        "pkg-1.18.2-433-forge" = _POoLUSdd;
        "pkg-1.18.2-433-fabric" = _p3uKh2pZ;
        "pkg-1.18.2-434-forge" = _tlZFnGvX;
        "pkg-1.18.2-434-fabric" = _sCqXAdcM;
        "pkg-1.18.2-435-forge" = _157MUwKP;
        "pkg-1.18.2-435-fabric" = _I1sdolxI;
        "pkg-1.16.5-420.3-forge" = _r2awMhqz;
        "pkg-1.19.2-436-fabric" = _4zEqysVf;
        "pkg-1.19.2-436-forge" = _k3odjPPO;
        "pkg-1.19.2-437-fabric" = _PxWspyO7;
        "pkg-1.19.2-437-forge" = _A7dLvqQz;
        "pkg-1.19.2-438-forge" = _MyuQ1tHQ;
        "pkg-1.19.2-438-fabric" = _OD7qkY6n;
        "pkg-1.19.2-439-forge" = _YKSFC2o4;
        "pkg-1.19.2-439-fabric" = _3LPMxFVf;
        "pkg-1.19.2-440-forge" = _ruMuBKgi;
        "pkg-1.19.2-440-fabric" = _T1wWMXnl;
        "pkg-1.20.1-441-fabric" = _XiOSfzIW;
        "pkg-1.20.1-441-forge" = _s2BpxY5Q;
        "pkg-1.20.1-442-fabric" = _Z88fkVtD;
        "pkg-1.20.1-442-forge" = _fsiPITPT;
        "pkg-1.20.1-443-fabric" = _s3EM29A3;
        "pkg-1.20.1-443-forge" = _SAIOMqxv;
        "pkg-1.20.1-444-fabric" = _Qw2uFPdO;
        "pkg-1.20.1-444-forge" = _cUfbpz6u;
        "pkg-1.20.1-445-fabric" = _2vyR6kP9;
        "pkg-1.20.1-445-forge" = _U5dEkBtT;
        "pkg-1.6.4-beta-16-forge" = _ZpspnX2M;
        "pkg-1.20.1-446-fabric" = _8kglDuQk;
        "pkg-1.20.1-446-forge" = _QXK1IBLc;
        "pkg-1.19.2-440.2-forge" = _aTGY8zMJ;
        "pkg-1.19.2-440.2-fabric" = _rY2B5H93;
        "pkg-1.20.1-447-fabric" = _kzY0l6pf;
        "pkg-1.20.1-447-forge" = _ucCteATJ;
        "pkg-1.20.1-448-fabric" = _t7kGxx07;
        "pkg-1.20.1-448-forge" = _19mwqT4M;
        "pkg-1.20.1-449-fabric" = _apFUEllP;
        "pkg-1.20.1-449-forge" = _DdqBOK1K;
        "pkg-1.20.1-450-fabric" = _X2tY0LhB;
        "pkg-1.20.1-450-forge" = _cuN4HNDd;
        "pkg-1.20.1-451-fabric" = _ZbFDx99K;
        "pkg-1.20.1-451-forge" = _BID0lWKw;
        "pkg-1.20.1-452-fabric" = _Knbh8J87;
        "pkg-1.20.1-452-forge" = _P68oSOdv;
        "pkg-1.20.1-453-fabric" = _CEQN4Awy;
        ...
        "pkg-1.20.1-456-fabric" = _n4HwegBU;
        "pkg-1.20.1-456-forge" = _npY4sRWF;
        "default" = _npY4sRWF;
    });
