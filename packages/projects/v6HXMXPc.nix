...
let
    ...
    in {
        ...
        "pkg-0.1.3" = _gUgRZKrS;
        "pkg-0.2.0" = _nP1WhX9V;
        "pkg-0.3.0-1.21.4" = _a0BbMSt4;
        "pkg-0.3.1-1.21.4" = _oQf4pc07;
        "pkg-0.3.1-1.21.1" = _rYkMLinL;
        "pkg-0.3.2-1.21.4" = _EJddROcM;
        "pkg-0.3.2-1.21.1" = _5FfS68sz;
        "pkg-0.4.0-1.21.4" = _l0BDIASI;
        "pkg-0.4.0-1.21.1" = _psL4zezt;
        "pkg-0.4.0-1.21.5" = _2JLrUvEO;
        "pkg-0.5.0-1.21.6" = _T7rLjYR8;
        "pkg-0.5.0-1.21.5" = _oVV1mYUv;
        "pkg-0.5.0-1.21.1" = _tNXl6s5H;
        "pkg-0.5.0-1.21.7" = _EgnVcjZB;
        "pkg-0.5.0-1.21.8" = _NDnbygC5;
        "pkg-0.5.0-1.21.9" = _kC6mXtCZ;
        "pkg-0.6.0-1.21.9" = _j9OB5FdT;
        "pkg-0.6.0-1.21.1" = _sHeB5sgw;
        "pkg-0.6.0-1.21.11" = _4W21M0du;
        "pkg-0.6.1-1.21.1" = _RkyTkkgh;
