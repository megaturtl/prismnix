...
let
    ...
    in {
        ...
        "pkg-0.3.2" = _aEX5C0EM;
        "pkg-0.3.3" = _1Svjv1JS;
        "pkg-0.3.3-v6.0.6" = _KeoqHgKM;
        "pkg-0.3.4" = _J492UPK6;
        "pkg-0.3.5" = _xt1UOGhv;
        "pkg-0.3.5-v6.0.6" = _MC7IJoac;
        "pkg-0.4.0" = _lb2KmkOz;
        "pkg-0.4.1" = _SeWKNVol;
        "pkg-0.4.1-v6.0.6" = _XMI7Vo3u;
        "pkg-0.4.2-v6.0.6" = _xhB8WGLB;
        "pkg-0.4.2" = _zoF952Wf;
        "pkg-0.5.0-beta" = _qtXwgAlO;
        "pkg-0.5.1" = _9EwdEOtd;
        "pkg-0.5.2" = _g7XHyLo1;
        "pkg-0.5.3" = _FLQANdy2;
        "pkg-0.5.3.1" = _wcAhRNKN;
        "pkg-0.5.4" = _bli22EIb;
