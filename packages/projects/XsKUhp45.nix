...
let
    versions = (let
        ...
        _ERyiu5Nw = {
            "id" = "ERyiu5Nw";
            "file" = "packtest-2.6.2.jar";
            "hash" = "sha512-A1UIwW7gdN1Oc8x/aXiQm5n7T24Y3cZzqFxADlmCLR0JNmrIwR7EicspeVU3wKrVkK1MI/ypknCQoaO+gZK5Aw==";
        };
        _5pthhuxY = {
            "id" = "5pthhuxY";
    ...
    in {
        ...
        "pkg-1.0.0-beta4" = _brjYdX84;
        "pkg-1.0.0-beta5" = _Ii7QZqXk;
        "pkg-1.0.0" = _sfLHmwHb;
        "pkg-1.1.0" = _EuWytyid;
        "pkg-1.2.0" = _J5eHUwSK;
        "pkg-1.3.0" = _Gq3rUEy6;
        "pkg-1.4.0" = _OgyamroT;
        "pkg-1.5.0" = _oBrK6ulR;
        "pkg-1.6.0-beta1" = _2XWs8vDt;
        "pkg-1.6.0-beta2" = _d7EzkPVT;
        "pkg-1.6.0-beta3" = _Ex2W3is5;
        "pkg-1.6.0" = _18smpIeE;
        "pkg-1.7.0-beta1" = _27gitJum;
        "pkg-1.7.0-beta2" = _fVUtPudl;
        "pkg-1.7.0-beta3" = _SKa65CnA;
        "pkg-1.7.0-beta4" = _2U1hEi7E;
        "pkg-1.7.0" = _UnZw9eUD;
        "pkg-1.8.0-beta2" = _7q5w3rtO;
        "pkg-1.8.0-beta3" = _sQSunYHv;
        "pkg-1.8.0" = _x9txtivi;
        "pkg-1.9.0-beta1" = _IE7ohvmX;
        "pkg-1.9.0" = _wjOUK14F;
        "pkg-1.10.0-beta1" = _owHaqexZ;
        "pkg-1.10.0" = _5JfUJE9n;
        "pkg-2.0.0-beta1" = _yJiy4jNB;
        "pkg-2.0.0" = _ZHHuCCGB;
        "pkg-2.1.0" = _Swh7th09;
        "pkg-2.1.1" = _rBlPTToB;
        "pkg-2.2.0-beta1" = _qj80bXRz;
        "pkg-2.2.0" = _PAYctH3X;
        "pkg-2.3.0-beta1" = _11yGLsYO;
        "pkg-2.3.0" = _J67ns1BC;
        "pkg-2.4.0-beta1" = _DeUn7drI;
        "pkg-2.4.0-beta2" = _GN6fvTsW;
        "pkg-2.4.0" = _g8Sp1z0q;
