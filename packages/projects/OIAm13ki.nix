...
let
    ...
    in {
        ...
        "pkg-21.5.1" = _t24lQhR2;
        "pkg-21.5.9" = _DqWajp2z;
        "pkg-21.5.16" = _sHtQO5Pt;
        "pkg-21.5.17" = _fndxbuoo;
        "pkg-21.5.18" = _9sAO9xs1;
        "pkg-21.6.0" = _iW6xkQAo;
        "pkg-21.7.0" = _JIMnSQKg;
        "pkg-21.7.1" = _vl7X5KOw;
        "pkg-21.6.3" = _ejwWKwjp;
        "pkg-21.7.6" = _RQ6B9JHU;
        "pkg-21.7.8" = _KvR1Vvdd;
        "pkg-21.10.0" = _Fxt4QlaG;
        "pkg-21.10.3" = _oqc5jfxt;
        "pkg-21.10.4" = _sAEIwmTy;
        "pkg-21.11.0" = _89Pdg415;
        "pkg-21.10.5" = _dhVHGd47;
        "pkg-21.11.1" = _BUvKvluW;
        "pkg-26.1.0" = _qnejO5Ut;
