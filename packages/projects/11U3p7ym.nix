...
let
    versions = (let
        ...
        _KszXVtcy = {
            "id" = "KszXVtcy";
            "file" = "nemos-backpacks-26.3-2.1.jar";
            "hash" = "sha512-e4rL/rl73ZuRBgFWrtilvMbp2oeP9FEpHHjNV7XbbzDt74ZxuVPSaGuKHqln6WA5J673V9n2PAHp5vDvj5MR2Q==";
        };
    in {
        "CCsyvy5B" = _CCsyvy5B;
        "6mCx5Kwm" = _6mCx5Kwm;
        ...
        "fabric-26.3" = _KszXVtcy;
        "neoforge-1.21.10" = _Lfx1ATA9;
        "neoforge-1.21.5" = _FQy52Kt5;
        "neoforge-1.21.11" = _mXQgxVAB;
        "pkg-1.21.8-1.0" = _CCsyvy5B;
        "pkg-1.21.4-1.0" = _6mCx5Kwm;
        "pkg-1.21.5-1.0" = _LRvOBKA8;
        "pkg-1.21.4-1.0.1" = _Ya6kilJI;
        "pkg-1.21.5-1.0.1" = _RVH4Airi;
        "pkg-1.21.8-1.0.1" = _YeVA5YNO;
        "pkg-1.21.4-1.0.2" = _MjJh10w2;
        "pkg-1.21.5-1.0.2" = _ZpTBLPxg;
        "pkg-1.21.8-1.0.2" = _UFJ2RRV4;
        "pkg-1.21.8-1.1" = _ZU4HkMwB;
        "pkg-1.21.8-1.1.1" = _C9f8hwTt;
        "pkg-1.21.9-1.1.1" = _PmZ5EKdi;
        "pkg-1.21.4-1.0.2.1" = _PI4nRVJc;
        "pkg-1.21.10-1.1.1" = _n7wx0W61;
        "pkg-1.21.10-1.2" = _vCUAQq0T;
        "pkg-1.21.5-1.2" = _YADmvNCn;
        "pkg-1.21.10-1.2.1" = _ST9vgVuG;
        "pkg-1.21.10-1.2.1.1" = _dWM2QTz2;
        "pkg-1.21.5-1.2.2" = _m2Uz3dWA;
        "pkg-1.21.10-1.2.2" = _cP4ePtuU;
        "pkg-1.21.5-1.2.3" = _90p9eqhr;
        "pkg-1.21.10-1.2.3" = _T7bNVwpn;
        "pkg-1.21.5-1.2.4" = _uOENMwRX;
        "pkg-1.21.10-1.2.4" = _jw7arS3f;
        "pkg-1.21.5-1.2.5" = _FQy52Kt5;
        "pkg-1.21.10-1.2.5" = _Lfx1ATA9;
        "pkg-1.21.11-1.2.5" = _mXQgxVAB;
        "pkg-26.1-2.0" = _W6NGGenT;
        "pkg-26.2-2.0" = _kbJsZocv;
        "pkg-26.2-2.1" = _VY2vRPgu;
        "pkg-26.3-2.1" = _KszXVtcy;
        "default" = _KszXVtcy;
    });
