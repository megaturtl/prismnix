...
let
    ...
    in {
        ...
        "pkg-1.5.0" = _ogPAc4qa;
        "pkg-1.5.1" = _40Ir0NjF;
        "pkg-1.18.2-1.3.1" = _naex0A0q;
        "pkg-1.19.2-1.4.2" = _IVJgC0uJ;
        "pkg-1.20.1-1.5.2" = _YuItLUhP;
        "pkg-1.20.1-1.5.3" = _kBgxcd6U;
        "pkg-1.20.1-1.6.0" = _mzpSchy2;
        "pkg-1.20.1-1.6.1" = _i6bY1hAB;
        "pkg-1.20.1-1.7.0" = _FmBbUM77;
        "pkg-1.20.1-1.7.1" = _tYuXlFDQ;
        "pkg-1.20.1-1.7.2" = _UnGknuEo;
        "pkg-1.20.6-2.0.0-beta-1" = _USZ0BJsr;
        "pkg-1.20.1-1.7.3" = _5GmrHZhl;
        "pkg-1.20.6-2.0.0-beta-2" = _eT34WRdr;
        "pkg-1.21-2.0.0-beta1" = _rcpdUYFN;
        "pkg-1.21-2.0.0-beta2" = _CqbSgjX8;
        "pkg-1.20.1-1.7.4" = _bN5t2b91;
        "pkg-1.21-2.0.0-beta3" = _Tgswuzat;
        "pkg-1.20.1-1.7.5" = _L4OsFAXL;
        "pkg-1.21-2.0.0-beta4" = _F1Rl0yr3;
        "pkg-1.21-2.0.0" = _CsCZAEBs;
        "pkg-1.21.0-2.0.1" = _ImtWaU8z;
        "pkg-1.21.0-2.1.0" = _glCPtDaA;
        "pkg-1.20.1-1.7.6" = _Zh1qka3e;
        "pkg-1.20.1-1.7.7" = _uzBClNC2;
        "pkg-1.21.1-2.1.1" = _M0JHjQWG;
        "pkg-1.20.1-1.7.8" = _F0BJJPF5;
        "pkg-1.20.1-1.7.9" = _nGXMjrON;
        "pkg-1.21.1-2.1.2" = _fiWIpVh6;
        "pkg-1.21.1-2.1.3" = _yXHyPe6i;
        "pkg-1.21.1-2.1.4" = _f1Gvq5IS;
        "pkg-1.21.1-2.1.5" = _tVXMDcz0;
        "pkg-1.21.1-2.1.6" = _KHEsFOb3;
        "pkg-1.21.1-2.1.7" = _JQgUGM72;
        "pkg-1.21.1-2.1.8" = _rc7HuMVp;
        "pkg-1.21.1-2.2.0" = _gtbU6S8z;
        "pkg-1.21.1-2.2.1" = _pVauQ27l;
        "pkg-1.21.1-2.2.2" = _K7o0xfX2;
        "pkg-1.21.1-2.2.3" = _vCWJPTWv;
        "pkg-1.21.1-2.3.0" = _vQHEuLTv;
        "pkg-1.21.1-2.3.1" = _IADrOCsE;
        "pkg-1.21.1-2.3.2" = _qdbhUYkB;
        "pkg-1.21.5-3.0.0-beta1" = _BWzgjJxu;
        "pkg-1.21.5-3.0.0-beta2" = _SZOCGjUD;
        "pkg-1.21.5-3.0.0-beta3" = _zaR2eJH0;
        "pkg-1.21.6-3.0.0-beta4" = _Z7Ae6iDA;
        "pkg-1.21.6-3.0.0-beta5" = _ZXie3ATx;
        "pkg-1.21.6-3.0.0-beta6" = _2mMkHVEA;
        "pkg-1.21.6-3.0.0-beta7" = _AP5iUVar;
        "pkg-1.21.6-3.0.0-beta8" = _1O9ZhclX;
        "pkg-1.21.7-3.0.0" = _Tzh6CoFs;
        "pkg-1.21.7-3.1.0" = _LLLCAcc0;
        "pkg-1.21.1-2.4.0" = _AnPnokNX;
        "pkg-1.21.7-3.1.1" = _OEEKuzSH;
        "pkg-1.21.1-2.4.1" = _cWVxjDxZ;
        "pkg-1.21.7-3.1.2" = _wyC8Ia8b;
        "pkg-1.21.8-3.1.3" = _cmQLZ5cW;
        "pkg-1.21.8-3.2.0" = _MKrjA5pt;
        "pkg-1.21.1-2.5.0" = _RH6wdbio;
        "pkg-1.21.8-3.2.1" = _sE84Tgh5;
        "pkg-1.21.8-3.2.2" = _i6HnRx90;
        "pkg-1.21.1-2.5.1" = _99fMuYE8;
        "pkg-1.21.8-3.3.0" = _Nh1eMtpu;
        "pkg-1.21.1-2.6.0" = _gEuAlaNF;
        "pkg-1.21.8-3.3.1" = _nQpmCf02;
        "pkg-1.21.1-2.6.1" = _Rgyz06zX;
        "pkg-1.21.8-3.4.0" = _ODvcR7c0;
        "pkg-1.21.8-3.4.1" = _V5Z4iYUu;
        "pkg-1.21.1-2.7.0" = _z7cYg2nA;
        "pkg-1.21.1-2.8.0" = _WOVQRkmU;
        "pkg-1.21.8-3.5.0" = _kazEqIR7;
        "pkg-1.21.1-2.8.1" = _D1DrfQNq;
        "pkg-1.21.9-3.5.0-alpha1" = _GH9YHXVm;
        "pkg-1.21.10-3.5.0-beta1" = _7xGRLGVd;
        "pkg-21.10.3.5.0" = _uj7nfpq9;
        "pkg-21.10.3.5.1" = _IGi7S2fp;
        "pkg-1.21.1-2.8.2" = _O2sOg6FM;
        "pkg-21.10.3.6.0" = _9HwKu8bv;
        "pkg-21.11.3.6.0-beta1" = _xBAyZxM3;
        "pkg-21.11.3.6.0-beta2" = _AJ8x7vAD;
        "pkg-21.11.3.6.0" = _v2CHB1UA;
        "pkg-21.11.3.6.1" = _S2sQVapR;
        "pkg-1.21.1-2.8.3" = _FUnU7NJ5;
        "pkg-21.11.3.7.0" = _bZaCbBkN;
        "pkg-21.11.3.7.1" = _Z83DOQDP;
        "pkg-26.1.0.0-alpha1" = _8yVPrMuU;
        "pkg-1.21.1-2.8.4" = _vnuMf4Oj;
        "pkg-26.1.0.0" = _gFTXfldq;
