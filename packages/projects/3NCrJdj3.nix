...
let
    versions = (let
        ...
        _wkYPEPfq = {
            "id" = "wkYPEPfq";
            "file" = "RebornCore-6.2.0.jar";
            "hash" = "sha512-orkUvxtNasu0Sco6xKwFMRoUMaccVdyaToFq4WKouW0ZewxbmzLuScggWCJ6cVSdjcvQ4JiXp7y61A09yrXN/A==";
        };
    in {
        "moy1eZEk" = _moy1eZEk;
        "CpyQUIHf" = _CpyQUIHf;
        ...
        "fabric-26.3" = _wkYPEPfq;
        "pkg-1.0.0.8+universal" = _moy1eZEk;
        "pkg-1.8.8+1" = _ibAZfUN6;
        "pkg-1.1.0.15+universal" = _qT4S90dp;
        "pkg-1.8.9+1" = _TtKMXnC5;
        "pkg-1.9+2" = _DikpiLJy;
        "pkg-1.9.4+2" = _hwGuTlL8;
        "pkg-1.10+2" = _ZWbDLZf8;
        "pkg-1.10.2+2" = _viusTZg6;
        "pkg-1.11+2" = _XrwJKHZG;
        "pkg-1.11.2+2" = _6PXmk70G;
        "pkg-2.13.0.12+universal" = _3ECkCEP6;
        "pkg-2.13.1.104+universal" = _DLXp7O9u;
        "pkg-2.13.1.105+universal" = _8ZLAcOI5;
        "pkg-2.13.1.24+universal" = _FR3v4HIX;
        "pkg-2.13.2.111+universal" = _3vGUanaJ;
        "pkg-2.13.2.114+universal" = _A8B6e4WS;
        "pkg-2.13.1.25+universal" = _3DOsYakV;
        "pkg-2.13.3.34+universal" = _DwAfpx3x;
        "pkg-2.13.3.119+universal" = _t1ESmKlm;
        "pkg-2.13.4.128+universal" = _OXkSL21R;
        "pkg-2.13.4.37+universal" = _QiEIcKlE;
        "pkg-2.13.5.42+universal" = _55gPkmdq;
        "pkg-2.13.5.134+universal" = _kct62ekW;
        "pkg-2.13.5.136+universal" = _DMQYqbtt;
        "pkg-2.13.6.52+universal" = _7p5Ko8cd;
        "pkg-2.14.0.80+universal" = _87eoV7Lf;
        "pkg-2.14.0.81+universal" = _TYJ2iSa6;
        "pkg-2.14.1.92+universal" = _Q2U6O2IX;
        "pkg-2.14.2.94+universal" = _nIwxlw4x;
        "pkg-2.16.0.106+universal" = _tvtl8bcc;
        "pkg-2.13.6.140+universal" = _VmITK7R2;
        "pkg-2.16.0.112+universal" = _GtfI2ylj;
        "pkg-2.13.6.142+universal" = _TvYJSNUR;
        "pkg-2.16.1.114+universal" = _hoh2zc36;
        "pkg-2.16.1.115+universal" = _hGTioBin;
        "pkg-3.0.1.7+universal" = _moyy2PiT;
        "pkg-3.0.2.28+universal" = _uODPJnkE;
        "pkg-3.0.3.32+universal" = _LGuL049O;
        "pkg-3.0.4.44+universal" = _YSzyfFwT;
        "pkg-3.0.5.46+universal" = _my3cvUEa;
        "pkg-3.1.0.52+universal" = _UZcDxRi6;
        "pkg-3.1.0.55+universal" = _AAu572gi;
        "pkg-3.2.0.74+universal" = _EPt9wFNK;
        "pkg-3.2.1.77+universal" = _snvXOI5o;
        "pkg-3.2.2.80+universal" = _lbgxr85j;
        "pkg-3.2.3.83+universal" = _D4ChSDYK;
        "pkg-3.2.4.86+universal" = _zAceAz1u;
        "pkg-3.2.5.88+universal" = _qeDwDQVd;
        "pkg-3.2.6.91+universal" = _U6PbsQYu;
        "pkg-3.2.7.95+universal" = _u9q6JkKZ;
        "pkg-3.2.8.98+universal" = _NBPATYk6;
        "pkg-3.3.0.99+universal" = _q8aiBYXz;
        "pkg-3.4.0.104+universal" = _kOVXn7Bu;
        "pkg-3.4.1.110+universal" = _gPlW9Z48;
        "pkg-3.4.2.112+universal" = _buMF3sh3;
        "pkg-3.4.3.114+universal" = _SLMgm6cf;
        "pkg-3.4.4.120+universal" = _tnIZoqtn;
        "pkg-3.4.5.124+universal" = _L56R5q88;
        "pkg-3.4.6.131+universal" = _Kls0kqS8;
        "pkg-3.4.7.136+universal" = _F2xuko2G;
        "pkg-3.4.8.138+universal" = _aU1NmJ25;
        "pkg-3.4.9.143+universal" = _m1HX60Hd;
        "pkg-3.4.10.146+universal" = _mE9HY8IW;
        "pkg-3.4.10.147+universal" = _HQZOH6cZ;
        "pkg-3.4.11.153+universal" = _ll3iDoce;
        "pkg-3.4.12.155+universal" = _piNwBiLj;
        "pkg-3.5.0.162+universal" = _awy95OuT;
        "pkg-3.5.1.166+universal" = _c5a0PZqw;
        "pkg-3.5.2.171+universal" = _6vxGR5DI;
        "pkg-3.5.3.174+universal" = _KkqnRnkF;
        "pkg-3.5.4.176+universal" = _rlHliHQt;
        "pkg-3.6.0.181+universal" = _XzLTuu0N;
        "pkg-3.6.1.183+universal" = _iMSwvd9j;
        "pkg-3.6.2.187+universal" = _xGt2RlSR;
        "pkg-3.6.4.194+universal" = _RodC87x8;
        "pkg-3.6.5.197+universal" = _PC4HnySN;
        "pkg-3.6.6.208+universal" = _fHq9vu7s;
        "pkg-3.6.7.210+universal" = _peJyQCoE;
        "pkg-3.6.8.214+universal" = _WYuXESET;
        "pkg-3.6.9.216+universal" = _LHV7mFto;
        "pkg-3.6.10.218+universal" = _es3u3y9B;
        "pkg-3.6.11.220+universal" = _yeTDG0HD;
        "pkg-3.6.12.223+universal" = _vsKwu69l;
        "pkg-3.6.13.225+universal" = _NhCdrFns;
        "pkg-3.6.14.229+universal" = _QbRnnPQo;
        "pkg-3.7.0.234+universal" = _Hulp5vYF;
        "pkg-3.7.1.243+universal" = _h96kk9mn;
        "pkg-3.7.2.245+universal" = _7GRKBO6A;
        "pkg-3.7.3.247+universal" = _DeXAToI4;
        "pkg-3.7.4.251+universal" = _qgMbnF78;
        "pkg-3.7.5.259+universal" = _PxHGWTtL;
        "pkg-3.8.0.264+universal" = _xWPxeSfb;
        "pkg-3.8.1.271+universal" = _UFl35frd;
        "pkg-3.8.2.277+universal" = _RZOIgAqQ;
        "pkg-3.8.3.279+universal" = _hhNPBWKP;
        "pkg-3.8.4.288+universal" = _BCpbehVD;
        "pkg-3.8.5.290+universal" = _TMV8rut7;
        "pkg-3.8.6.293+universal" = _ne2ntz0r;
        "pkg-3.8.7.295+universal" = _tpVFJXGi;
        "pkg-3.8.8.298+universal" = _4JeKB4Qd;
        "pkg-3.8.9.300+universal" = _HQmcBYQv;
        "pkg-3.9.0.315+universal" = _h4dhsulm;
        "pkg-3.9.1.318+universal" = _zw7jY3JQ;
        "pkg-3.9.2.319+universal" = _4ethGPxW;
        "pkg-3.9.3.324+universal" = _75mPpmxt;
        "pkg-3.10.0.332+universal" = _qljtdGIc;
        "pkg-3.10.1.335+universal" = _wN9rHnv0;
        "pkg-3.10.2.337+universal" = _gzjvWOSH;
        "pkg-3.10.3.346+universal" = _JUKGjyqX;
        "pkg-3.10.4.348+universal" = _1DAj2ysx;
        "pkg-3.10.5.350+universal" = _dEW9rHVF;
        "pkg-3.10.6.355+universal" = _GgLaRK1A;
        "pkg-3.11.0.373+universal" = _JFoY4RuB;
        "pkg-3.12.0.378+universal" = _qI6MAfXA;
        "pkg-3.12.1.385+universal" = _4JK9XLpN;
        "pkg-3.13.0.400+universal" = _X8IkRL0e;
        "pkg-3.13.1.402+universal" = _iDAYyC97;
        "pkg-3.13.2.411+universal" = _N9quu7s7;
        "pkg-3.13.3.416+universal" = _C0kqVMuo;
        "pkg-3.13.4.419+universal" = _iPvNYh43;
        "pkg-3.13.5.421+universal" = _2MTfyxuz;
        "pkg-3.13.6.424+universal" = _fNV1YcvI;
        "pkg-3.13.7.428+universal" = _aI4kwSRd;
        "pkg-1.12.2+3" = _9QJTQQ6n;
        "pkg-4.7.3" = _SNJQrImt;
        "pkg-4.2.10" = _gMTi6Rev;
        "pkg-5.0.4+beta" = _oxM3GcHx;
        "pkg-5.0.5+beta" = _yUXnwY7D;
        "pkg-5.0.6+beta" = _5aMhrwq5;
        "pkg-5.0.7+beta" = _qjrh1Crb;
        "pkg-5.0.8+beta" = _jny0CCkP;
        "pkg-5.0.9+beta" = _u4ljabhr;
        "pkg-5.0.10+beta" = _XcPeJH8S;
        "pkg-5.0.11+beta" = _frPYQSdq;
        "pkg-5.1.0+beta" = _5ASW2nOp;
        "pkg-5.1.0" = _chaStrbt;
        "pkg-5.2.0+beta" = _MFgQdsCB;
        "pkg-5.2.0" = _7DIroq6Z;
        "pkg-5.3.0" = _K1Nuai9P;
        "pkg-5.3.1" = _3Jupw5Qm;
        "pkg-5.3.2" = _jr2OF642;
        ...
        "pkg-5.9.0" = _gnigyi1M;
        "pkg-5.9.1" = _udMdLA9Z;
        "pkg-5.10.0" = _3sSDiuHR;
        "pkg-5.10.1" = _VTtALg0i;
        "pkg-5.10.2" = _UWpMoYxo;
        "pkg-5.10.3" = _GoT86XMX;
        "pkg-5.10.4" = _g00DcPYw;
        "pkg-5.11.0" = _VXVE7pWi;
        "pkg-5.11.1" = _cbeFMbOb;
        "pkg-5.11.2" = _xAnrgyH6;
        "pkg-5.11.3" = _pbbgMBag;
        "pkg-5.11.4" = _IhY9zdgH;
        "pkg-5.11.5" = _FlCgQGBT;
        "pkg-5.11.6" = _7cIkLls9;
        "pkg-5.11.7" = _iO7TID2T;
        "pkg-5.11.8" = _7Yz70yXl;
        "pkg-5.11.9" = _JeUP11Dt;
        "pkg-5.11.10" = _9YLLekgJ;
        "pkg-5.11.11" = _82MyTvy4;
        "pkg-5.11.12" = _pqcyzATO;
        "pkg-5.11.13" = _ugiDJdz3;
        "pkg-5.12.0" = _3M9dlTpF;
        "pkg-5.12.1" = _WKmIHK3S;
        "pkg-5.12.2" = _412mXjq4;
        "pkg-5.12.3" = _a0oQIrBN;
        "pkg-5.12.4" = _7zCZFc2d;
        "pkg-5.12.5" = _EPCIxZrb;
        "pkg-5.11.14" = _8yzNhQnh;
        "pkg-5.8.8" = _vcSvfea4;
        "pkg-5.11.15" = _Q60zwyt5;
        "pkg-5.13.0" = _LB4NR5JS;
        "pkg-5.8.9" = _43TSZrO7;
        "pkg-5.11.16" = _r6Nw2txP;
        "pkg-5.12.6" = _q1DBQX0b;
        "pkg-5.13.1" = _Y9fNtjoQ;
        "pkg-5.11.17" = _OiDDhgXs;
        "pkg-5.8.10" = _rd71nNHa;
        "pkg-5.13.2" = _7GyUF1fh;
        "pkg-5.12.7" = _btIeB2S6;
        "pkg-5.8.11" = _79O7pxfC;
        "pkg-5.8.12" = _ykTKhU9j;
        "pkg-5.13.3" = _VZd9RElO;
        "pkg-5.12.8" = _Aihqk7Yq;
        "pkg-5.11.18" = _xcSLTOes;
        "pkg-5.8.13" = _IGLVOaKo;
        "pkg-5.11.19" = _QtkC5plA;
        "pkg-5.12.9" = _vpoUfM7s;
        "pkg-5.13.4" = _n1g9FzPv;
        "pkg-5.14.0" = _uTafN3M1;
        "pkg-5.14.1" = _ofX0McPf;
        "pkg-5.14.2" = _71mVb6AQ;
        "pkg-5.8.14" = _izaJJWdM;
        "pkg-5.15.0" = _XBwd3R4o;
        "pkg-5.15.1" = _NEVoKDZI;
        "pkg-5.8.15" = _sWpmIISP;
        "pkg-6.0.0" = _Se6WIErc;
        "pkg-6.0.1" = _QNCrljWb;
        "pkg-6.0.2" = _mJSceox8;
        "pkg-6.0.3" = _fy5Oss8Z;
