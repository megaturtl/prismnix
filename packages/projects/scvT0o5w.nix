...
let
    versions = (let
        ...
        _Cvg4lumI = {
            "id" = "Cvg4lumI";
            "file" = "ohmega-1.5.21-fabric-mc26.1.2.jar";
            "hash" = "sha512-dFous7U+tZViAZltR0b2cJL6jFZfhd99yN1f9bok1yGcirmmPnZduYa+CVWO6SVoCK3fYC1RRrgwgCKmAjI+eQ==";
        };
        _nIIkChwv = {
            "id" = "nIIkChwv";
            "file" = "ohmega-1.5.21-forge-mc26.1.2.jar";
            "hash" = "sha512-GYi5hzFfcW5DESYOqMsAjHKZTjBFATfWJGJdrRswznR3yLGc6zyL3ak1aj0B8Rrs/MzIyJyQSL8UzDYe6yEYRA==";
        };
        _wkIfycvx = {
            "id" = "wkIfycvx";
            "file" = "ohmega-1.5.21-neoforge-mc26.1.2.jar";
            "hash" = "sha512-nI+qqHBVwChwtZYv2AFFGKEajRXazcgy9C11cRJ44a9zGW2xgrgo/NDz8WnrpJO50nt0vyllLY79yPb/jz1JGw==";
        };
        _2anNeU16 = {
            "id" = "2anNeU16";
            "file" = "ohmega-1.5.21-forge-mc26.2.jar";
            "hash" = "sha512-y7PD4CK4dgKRRz9VC4uzoZWLxJswAerNu8AFy58weu4CkfB16YOqzfzpGrwS8/7WbAln8fhp8KN4UvLQNMdrDw==";
        };
        _nv1tMjFB = {
            "id" = "nv1tMjFB";
            "file" = "ohmega-1.5.21-neoforge-mc26.2.jar";
            "hash" = "sha512-GPeS7aShixOfl1G8MpD5YWYUZjWb9tzkX/3JpN6/cJXgl0aAd9vPjzUEBDn3aMWXnyFGBhkHGwVO+GMblzAY7w==";
        };
        _ah9VN2aV = {
            "id" = "ah9VN2aV";
            "file" = "ohmega-1.5.21-fabric-mc26.2.jar";
            "hash" = "sha512-guo/3k9S1eEESSm1uqPu4QRyNqhE9oAglKCNUheZGjlpgLEewN0ulittLWxoy2QzQ0EGa6rterjdZlkM1Of7dg==";
        };
        _H9i3Zeo3 = {
            "id" = "H9i3Zeo3";
            "file" = "ohmega-1.5.21-fabric+1.21.11.jar";
            "hash" = "sha512-lk7w4d+ddVPrpnTRGHNUcbSpcloogimsKKdZPGNFwAD+yxD25FWjixn2gJzf8/FrXxSMmKygdW2slEysOVf4NA==";
        };
        _mmmo4MK6 = {
            "id" = "mmmo4MK6";
            "file" = "ohmega-1.5.21-forge+1.21.11.jar";
            "hash" = "sha512-M2PA3mQhAIGHMuebF9BNObl5iqszJ8FmTFqV2fd73bV1x1uEXUqw1x9v1akoOTjDq4iPn4i32XWCGnENArUT4w==";
        };
        _rXRxKHeK = {
            "id" = "rXRxKHeK";
            "file" = "ohmega-1.5.21-neoforge+1.21.11.jar";
            "hash" = "sha512-lst17eGVTd6op13YnKIanqlTIp19uWA6X8WptUHk8PMT+VkjdQNdCSrns/GQXNfbRz5m7AitTk99XpxzGKncJA==";
        };
        _JcybVQx5 = {
            "id" = "JcybVQx5";
            "file" = "ohmega-1.5.21-fabric+1.21.1.jar";
            "hash" = "sha512-RbZQRWGDQQiSWmu7y9yEn45RckKJUv8YX8VpRJLmdfafR1y1ViGslpp+DwKkRJMGz5Sp50fIYkaeTzpQoA4euA==";
        };
        _DfAh0xAU = {
            "id" = "DfAh0xAU";
            "file" = "ohmega-1.5.21-forge+1.21.1.jar";
            "hash" = "sha512-V5UUkIzFb/Pks4Ek/co7+G4j48dlsot4vh9vQcGDXEJpnyJR6hxj5CwmecUIL2oXldCRk+ZOzwjySKBZZRLY7g==";
        };
        _bn7CAY4A = {
            "id" = "bn7CAY4A";
            "file" = "ohmega-1.5.21-neoforge+1.21.1.jar";
            "hash" = "sha512-N1xxHr4kya825Z4h9//ERNU9bahaVAKl2gKFpYDH2H/r6SwFgx+U2td9RE6nEPAknCmUryW2x19RRfwN2LPi7g==";
        };
        _yMTLTDbo = {
            "id" = "yMTLTDbo";
            "file" = "ohmega-fabric-1.6.0-beta.19-mc26.2.jar";
            "hash" = "sha512-oGb2NnFSnvStyQDZl/w5yBmTIjQeyl6OmOF75lMuAZyYAfpc6HOXZbVGY5161MhgLB4S3G2DWJASG5PSjmYj0Q==";
        };
        _46Nl5z3M = {
            "id" = "46Nl5z3M";
            "file" = "ohmega-forge-1.6.0-beta.19-mc26.2.jar";
            "hash" = "sha512-YmZejWH5mnA0jYHBni+7KN1DFSM5XJ+KrPxnd6PDoF6/gPFKjCLDswsgpfpipe8O4mFKCJ9EVAH0VbpSKQiL1A==";
        };
        _qoNexXyk = {
            "id" = "qoNexXyk";
            "file" = "ohmega-neoforge-1.6.0-beta.19-mc26.2.jar";
            "hash" = "sha512-nybEem4HIxiaxjopkQQ39Vcs547+rVjADOS8NtcPgb0kHmpnhl+QbDZhu6NQNE20apubMqOGoH9TXWtQYkPN2w==";
        };
        _S23rLuKN = {
            "id" = "S23rLuKN";
            "file" = "ohmega-1.5.21-fabric-mc26.3.jar";
            "hash" = "sha512-Jwzhmkz4X2ARszaMgrePDYOmy5na9Bcy1Cz+2VHfxaNIuRBJ3UmvK2ULOpO9/+LFOiLrSrg8c3+iTT7F/lOJfg==";
        };
        _ClXNshd9 = {
            "id" = "ClXNshd9";
    ...
    in {
        ...
        "forge-1.21.11" = _mmmo4MK6;
        "forge-26.1" = _nIIkChwv;
        ...
        "pkg-1.1.0+mc1.20.2" = _EPq3bJE4;
        "pkg-1.1.0+mc1.20-1.20.1" = _HNsRVYfn;
        "pkg-1.1.0+mc1.19.4" = _HWhJlvJ8;
        "pkg-1.1.0+mc1.19.3" = _8KFxkZLz;
        "pkg-1.1.0+mc1.19-1.19.2" = _6nAyf43e;
        "pkg-1.1.0+mc1.18.2" = _rO3Mkqpa;
        "pkg-1.1.0+mc1.18-1.18.1" = _xaLkCuVT;
        "pkg-1.1.0+mc1.21-1.21.1" = _MMt1XyYr;
        "pkg-1.2.0" = _CS1pHfrr;
        "pkg-1.2.1" = _oTz0auYZ;
        "pkg-1.2.2" = _WqiTxja2;
        "pkg-1.3.0" = _eo4EH3I5;
        ...
        "pkg-1.5.8" = _fkbhZ8ot;
        "pkg-1.5.9" = _ArbW5PFD;
        "pkg-1.5.10" = _u6c9mn0v;
        "pkg-1.5.11" = _JHxsSQu1;
        "pkg-1.5.12" = _BjlqONQQ;
        "pkg-1.5.14" = _TK3JFoG9;
        "pkg-1.5.13" = _1jCLjdG6;
        "pkg-1.5.15" = _ttSySh7k;
        "pkg-1.5.16" = _6I1kxzys;
        "pkg-1.5.17" = _292z7Yul;
        "pkg-1.6.0-beta.1" = _2CY8vZGo;
        "pkg-1.6.0-beta.2" = _mAXm0r5j;
        "pkg-1.6.0-beta.3" = _I1xC59u2;
        "pkg-1.5.18" = _ygpeBpyo;
        "pkg-1.6.0-beta.4" = _nBwVUctN;
        "pkg-1.6.0-beta.5" = _LPdwj1En;
        "pkg-1.6.0-beta.6" = _Y0SsocYd;
        "pkg-1.5.19" = _byJ9xe2O;
        "pkg-1.6.0-beta.7" = _kbbqC0G4;
        "pkg-1.6.0-beta.8" = _sL8s7b5Z;
        "pkg-1.6.0-beta.9" = _P8H4NS2A;
        "pkg-1.6.0-beta.10" = _w31yUBdZ;
        "pkg-1.6.0-beta.11" = _u6bm6fjl;
        "pkg-1.6.0-beta.12" = _TfECy5v5;
        "pkg-1.6.0-beta.13" = _twxn3bas;
        "pkg-1.6.0-beta.14" = _tvM0SoEB;
        "pkg-1.6.0-beta.15" = _jOx9zBuZ;
        "pkg-1.6.0-beta.16" = _U0uatjYR;
        "pkg-1.6.0-beta.17" = _yLzdRJ29;
        "pkg-1.5.20" = _tyM35wwO;
