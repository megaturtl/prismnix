...
let
    versions = (let
        ...
        _gdjWjyXv = {
            "id" = "gdjWjyXv";
            "file" = "skyblocker-6.9.0+26.1.2.jar";
            "hash" = "sha512-+U+MQ4xmFebQOA5EGmOSYcu1EHsrrJgglb/C0FRioa+/yM5EtCnXYjZyrFaFjGd6w2zFhPj7PO8BFgz6Cxt9Qw==";
        };
        _ggRjlSWs = {
            "id" = "ggRjlSWs";
            "file" = "skyblocker-6.9.0+26.2.jar";
            "hash" = "sha512-oCr4vz6w1dCJu0WoAK80/4cxrwbLpQJSSHAIJ8GYWp2RCz46ecG1IRLvWSErC/9gmJM3Ohq8upBtIR/yppqmZg==";
        };
        _CRU7bWnn = {
            "id" = "CRU7bWnn";
            "file" = "skyblocker-6.9.1+26.1.2.jar";
            "hash" = "sha512-1Wj5oZ3IUqqaVOVPy8v0s6RLJs6KvkQBb2aX62rphofsA1Tcf+2kOy3rROWfzB5FD7v6uMNbF0spLFUBa5uAJg==";
        };
        _2FoKIvZt = {
            "id" = "2FoKIvZt";
            "file" = "skyblocker-6.9.1+26.2.jar";
            "hash" = "sha512-VHeaVZUx74Cnqv+7G0dWjuja9MZKY7qzAhpqSQEXbKKob+NLj3gCkF08GKXFGzHEiDs04QXsF+AuaXSK+PNgLA==";
        };
        _29HQfrbr = {
            "id" = "29HQfrbr";
            "file" = "skyblocker-6.9.2+26.1.2.jar";
            "hash" = "sha512-rhQJHSM8PY7t2kIIjIjc/1diJHOpSkDedbT1d6tecbKgLpfo6nBu3zQ8HlJGko0Il+MyyIN2crN8IHS5aBRV2Q==";
        };
        _ggTtIz7v = {
            "id" = "ggTtIz7v";
            "file" = "skyblocker-6.9.2+26.2.jar";
            "hash" = "sha512-blElbqmbpvlHKu1JCZeJYFowJk2QS/LtxTmcv0ocRdBqlsdlmDayOI4SsikJ2x5qShfn65sy81T/EAm4c61c2w==";
        };
        _WeHbDxEO = {
            "id" = "WeHbDxEO";
            "file" = "skyblocker-6.10.0+26.1.2.jar";
            "hash" = "sha512-OSkYvfGKg3ht7LIAdRh54ofYy2F7qzL0IFGEtFnT2IiM9l0XmZYR3yfhTLBqYTxpjcExrJQv4w9gq0aq+edMfw==";
        };
        _C9ZW1qql = {
            "id" = "C9ZW1qql";
            "file" = "skyblocker-6.10.0+26.2.jar";
            "hash" = "sha512-7c5wacNJBMOYLP7ufM4lDJgnGKJAkyDeOaZa5Q97GPxW3NoweTmybTKypmW2h2L1nMY5xsb6n1L1RDCksIdnmw==";
        };
        _uK3BeGGt = {
            "id" = "uK3BeGGt";
            "file" = "skyblocker-6.10.1+26.1.2.jar";
            "hash" = "sha512-QbyCAyBk55JztIj+ywZEQatyIi0Tm65aBPEApZ1+8cJRON6nVs1DelaWboUt48V6KeTPC40TPEdqSE+3VfQrXw==";
        };
        _x3Ncv7Sc = {
            "id" = "x3Ncv7Sc";
            "file" = "skyblocker-6.10.1+26.2.jar";
            "hash" = "sha512-Q7LXirDtr9+BJ0KbZ/UQBYXH5Romwx3+6bIC43aPlFWI8gylqLY6jyLwpx02aRl39IPCm74suKNkeQShC8MfCQ==";
        };
        _KbYW1eox = {
            "id" = "KbYW1eox";
            "file" = "skyblocker-6.10.2+26.1.2.jar";
            "hash" = "sha512-lHcv7fjaaJuZpu//zcZdIiOJ6EPwu69MAWccXLiqeHVZfUpT3JUE4Sob5zwp9M32xxL87cXw0ldt7UdCp1jEeQ==";
        };
        _WYJ6NdRL = {
            "id" = "WYJ6NdRL";
    ...
    in {
        ...
        "pkg-v1.1.0+1.17.1" = _4CWhQXcz;
        "pkg-v1.2.0+1.17.1" = _FwK84XRX;
        "pkg-v1.2.1+1.17.1" = _N2U1IKCn;
        "pkg-v1.2.2+1.17.1" = _gfMTcyuK;
        "pkg-v1.3.0+1.17.1" = _XikfUOvt;
        "pkg-v1.4.0+1.17.1" = _5mWAvISx;
        "pkg-v1.4.1+1.17.1" = _7bpmLRgE;
        "pkg-v1.4.2+1.17.1" = _Ro4b7WFs;
        "pkg-v1.4.2+1.18" = _FCey7Px4;
        "pkg-v1.4.3+1.17.1" = _eQMAwWf2;
        "pkg-v1.4.3+1.18" = _fdRowbrA;
        "pkg-v1.5.0+1.18.x" = _15KgcZWs;
        "pkg-v1.6.0+1.18.x" = _ICqH6jD5;
        "pkg-v1.6.1+1.18.x" = _5ZxgC3U6;
        "pkg-v1.6.2+1.18.x" = _ApPSNhUB;
        "pkg-v1.6.2+1.17.x" = _6dlKTu6h;
        "pkg-v1.6.3+1.18.x" = _OdUfg8qC;
        "pkg-v1.7.0+1.18.x" = _XFIwuIJH;
        "pkg-v1.7.0+1.17.x" = _GzpYTRn2;
        "pkg-v1.8.0+1.18.x" = _mx0RJ13z;
        "pkg-v1.8.0+1.17.x" = _BlheRPfQ;
        "pkg-v1.8.0+1.19.x" = _nQJeXqx3;
        "pkg-v1.8.1+1.17.x" = _Tve0PR7d;
        "pkg-v1.8.1+1.18.x" = _igdQFr0I;
        "pkg-v1.8.1+1.19.x" = _wb5VYuXE;
        "pkg-v1.8.2+1.19.x" = _KzSmHqdu;
        "pkg-1.9.0+1.19.4" = _u9gdsGIi;
        "pkg-v1.10.0+1.19.4" = _9xrfHFzQ;
        "pkg-v1.10.0+1.20-beta" = _Zl59vaVk;
        "pkg-1.11.0-beta+1.20" = _noAugeFH;
        "pkg-v1.11.0+1.20.1" = _H988fHkT;
        "pkg-v1.11.1+1.20.1" = _69vvllyM;
        "pkg-v1.12.0+1.20.1" = _OwqjRrbO;
        "pkg-v1.13.0+1.20.1" = _STG2Jikm;
        "pkg-v1.14.0+1.20.1" = _6bmmwRpZ;
        "pkg-1.14.0+1.20.2" = _yZnIy9dq;
        "pkg-1.14.1+1.20.1" = _SWDiimVB;
        "pkg-v1.15.0+1.20.2" = _4NiBEVg7;
        "pkg-v1.16.0+1.20.2" = _VdRL9ajN;
        "pkg-v1.16.0+1.20.4" = _Wa84opTT;
        "pkg-v1.17.0+1.20.4" = _bKu6Hdms;
        "pkg-v1.18.0+1.20.4" = _KJDNckVH;
        "pkg-v1.18.1+1.20.4" = _QUhd3Mtv;
        "pkg-v1.19.0-beta.1+1.20.4" = _bKxD0P5M;
        "pkg-v1.19.0+1.20.4" = _4FZXq2qQ;
        "pkg-v1.19.1+1.20.4" = _WkEd5Yt7;
        "pkg-v1.20.0-beta.1+1.20.4" = _QNRB44Ic;
        "pkg-v1.20.0+1.20.4" = _tMghQC7H;
        "pkg-v1.20.1+1.20.4" = _IZoQ9LZ8;
        "pkg-v1.20.2+1.20.4" = _WxOxVmzV;
        "pkg-v1.20.3-beta.1+1.20.6" = _xh5PMJRY;
        "pkg-v1.20.3-beta.2+1.20.6" = _TqBeM5rX;
        "pkg-v1.21.0-beta.1+1.20.6" = _SL3n1kkB;
        "pkg-v1.21.0+1.20.6" = _xGHPspDD;
        "pkg-v1.21.0+1.21" = _7IrSEJ5F;
        "pkg-v1.21.1+1.21" = _AfQAcwhH;
        "pkg-v1.21.1+1.20.6" = _5qcYXB6f;
        "pkg-v1.22.0+1.21.1" = _telp6UH5;
        "pkg-v1.21.2+1.20.6" = _CZ5xY5Uj;
        "pkg-v1.22.1+1.21.1" = _FedpHUbb;
        "pkg-v1.22.2+1.21.1" = _Qb7DwYqv;
        "pkg-v1.23.0-beta.1+1.21.1" = _TvlcpAPE;
        "pkg-v1.23.0-beta.1+1.21.3" = _cU5DgUAN;
        "pkg-v1.23.0-beta.3+1.21.4" = _fwpA32Nl;
        "pkg-v5.0.0+1.21.4" = _5Du8qlRA;
        "pkg-v5.1.1+1.21.4" = _A734ZSxl;
        "pkg-v5.1.2+1.21.4" = _kluI6ckx;
        "pkg-v5.2.0+1.21.5" = _MkkAlotI;
        "pkg-v5.3.0-beta.1+1.21.5" = _snkLsV3Z;
        "pkg-v5.3.0+1.21.5" = _vYm3txZS;
        "pkg-v5.4.0+1.21.5" = _hmAg0S2o;
        "pkg-v5.5.0+1.21.5" = _k88ct755;
        "pkg-v5.6.0+1.21.5" = _SJrUeqti;
        "pkg-v5.7.0+1.21.8" = _2FBzFNrh;
        "pkg-v5.8.0+1.21.8" = _ojOvcUWe;
        "pkg-v5.6.1+1.21.5" = _UNtTAtzC;
        "pkg-v5.9.0-beta.1+1.21.8" = _TuwUXCQ0;
        "pkg-v5.9.0+1.21.8" = _3Pg48g99;
        "pkg-v5.9.0+1.21.10" = _rP7BAXrC;
        "pkg-v5.9.1+1.21.8" = _WVf01X32;
        "pkg-v5.9.1+1.21.10" = _hiVruBoH;
        "pkg-v5.10.0+1.21.8" = _7pEcYFqd;
        "pkg-v5.10.0+1.21.10" = _op1SmdH0;
        "pkg-v5.11.0+1.21.8" = _2FKg5ePt;
        "pkg-v5.11.0+1.21.10" = _DWSiuS0T;
        "pkg-v6.0.0-beta.1+1.21.10" = _vY8BL1Or;
        "pkg-v6.0.0-beta.1+1.21.11" = _sOZZHDZB;
        "pkg-v6.0.0-beta.2+1.21.10" = _lB9Cu1qr;
        "pkg-v6.0.0-beta.2+1.21.11" = _Q4wrpDJ2;
        "pkg-v6.0.0+1.21.10" = _wlkohZJG;
        "pkg-v6.0.0+1.21.11" = _u8QEcWWj;
        "pkg-v6.0.1+1.21.10" = _XMCsSrb9;
        "pkg-v6.0.1+1.21.11" = _ubJHgDpc;
        "pkg-v6.0.2+1.21.10" = _3chhIuwd;
        "pkg-v6.0.2+1.21.11" = _dKJkKrFQ;
        "pkg-v6.0.3+1.21.10" = _w6CVK1Tc;
        "pkg-v6.0.3+1.21.11" = _iqoV3Hp1;
        "pkg-v6.1.0+1.21.10" = _CryO8goQ;
        "pkg-v6.1.0+1.21.11" = _VOnsDcms;
        "pkg-v6.1.1+1.21.10" = _NSu0Cv9W;
        "pkg-v6.1.1+1.21.11" = _Cnxw6rmL;
        "pkg-v6.2.0+1.21.10" = _SFUNlSpi;
        "pkg-v6.2.0+1.21.11" = _E6eA8eXs;
        "pkg-v6.2.0+26.1" = _W3s0YKQI;
        "pkg-v6.3.0+1.21.11" = _bXdpmba0;
        "pkg-v6.3.0+26.1.1" = _7yGqahdZ;
        "pkg-v6.4.0+1.21.11" = _MKoFTAfF;
        "pkg-v6.4.0+26.1.2" = _bFvp9GLl;
        "pkg-v6.4.1+1.21.11" = _ifkfQ5sx;
        "pkg-v6.4.1+26.1.2" = _1ogCsJtb;
        "pkg-v6.5.0+1.21.11" = _HQckI1XL;
        "pkg-v6.5.0+26.1.2" = _dLQkYzV0;
        "pkg-v6.5.1+1.21.11" = _4cy8mojf;
        "pkg-v6.5.1+26.1.2" = _15dvwUko;
        "pkg-v6.5.2+1.21.11" = _7MTtY24j;
        "pkg-v6.5.2+26.1.2" = _2nA3nhnm;
        "pkg-v6.5.3+26.1.2" = _7OtCaJGB;
        "pkg-v6.5.3-alpha.1+26.2" = _ywMPG7TL;
        "pkg-v6.5.3-alpha.2+26.2" = _WqzGQ7KM;
        "pkg-v6.6.0+26.1.2" = _fWLQ4vHh;
        "pkg-v6.6.0+26.2" = _PwRyrygz;
        "pkg-v6.7.0-beta.1+26.1.2" = _n5H2yDJu;
        "pkg-v6.7.0-beta.1+26.2" = _UK0BOlwX;
        "pkg-v6.7.0+26.1.2" = _F12eJYBF;
        "pkg-v6.7.0+26.2" = _4T5HslQo;
        "pkg-v6.8.0+26.1.2" = _LPLM5t9S;
        "pkg-v6.8.0+26.2" = _gBqdWqc8;
        "pkg-v6.8.1+26.1.2" = _44n9Rx8c;
        "pkg-v6.8.1+26.2" = _HspVRqW2;
        "pkg-v6.8.2+26.1.2" = _Mxwml9Jp;
        "pkg-v6.8.2+26.2" = _YH19kC6T;
        "pkg-v6.9.0+26.1.2" = _gdjWjyXv;
        "pkg-v6.9.0+26.2" = _ggRjlSWs;
        "pkg-v6.9.1+26.1.2" = _CRU7bWnn;
        "pkg-v6.9.1+26.2" = _2FoKIvZt;
        "pkg-v6.9.2+26.1.2" = _29HQfrbr;
        "pkg-v6.9.2+26.2" = _ggTtIz7v;
        "pkg-v6.10.0+26.1.2" = _WeHbDxEO;
        "pkg-v6.10.0+26.2" = _C9ZW1qql;
        "pkg-v6.10.1+26.1.2" = _uK3BeGGt;
