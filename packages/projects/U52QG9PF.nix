...
let
    versions = (let
        ...
        _9lYHFixq = {
            "id" = "9lYHFixq";
            "file" = "B - Simply Cozy 1.9.35.jar";
            "hash" = "sha512-lW1j7ycL/LJiX3Er2hLfq6jbPFn40luaFWtenrn9NKko66K/gV4L0vW2ONTMEKW/+bGR1fiZ15qi2i/Qjcp+gQ==";
        };
        _gEtxU6wp = {
            "id" = "gEtxU6wp";
            "file" = "B - Simply Cozy 1.9.36.jar";
            "hash" = "sha512-8e2S0avP5CgQlG6LwWdugIPmmDH5BwdQHdHfv4WaZrsakST9Kka0rhvQ3EgLuSgFvQRn7pBg7YKYwxN9ctq/Iw==";
        };
        _jlAwQohM = {
            "id" = "jlAwQohM";
            "file" = "B - Simply Cozy 1.9.37.jar";
            "hash" = "sha512-gXH04Oi3PSCwbe/vpq04XzZWZ2H5rO9QXT5ouImX6BROYVQHX7TA141UgJuCVMECitsLtvzPXBTg/MYLd4f6eA==";
        };
        _sZ4iQ2G8 = {
            "id" = "sZ4iQ2G8";
            "file" = "B - Simply Cozy 1.9.38.jar";
            "hash" = "sha512-qG+mN/tol/ZWDRgbosX16UrOypoEqDxkA1caCAo3bZHW+JVpoLG+j7fe7RY1QFYEi3kvMErZTLHvIVtslkiEsw==";
        };
        _cdDV5SDM = {
            "id" = "cdDV5SDM";
            "file" = "A - Simply Cozy 1.9.39.jar";
            "hash" = "sha512-wU837RhxQgyS5stxR+/E/gBx+BrE2bqa7HWYPaqfoLck7QAlqc4kEfMCv8TBjYojH/474SVFbJ6qpTJrmtHIlA==";
        };
        _cYd1Grby = {
            "id" = "cYd1Grby";
    ...
    in {
        ...
        "pkg-1.2.8" = _6VJxujHG;
        "pkg-1.2.9" = _ULK9Q3Ia;
        "pkg-1.2.10" = _crwAuocR;
        "pkg-1.2.11" = _cFInGtKR;
        "pkg-1.3.0" = _JpNtRMmz;
        "pkg-1.3.1" = _YSLwckFm;
        "pkg-1.3.2" = _UI7qDcdZ;
        "pkg-1.3.3" = _nEp3e2Hl;
        ...
        "pkg-1.3.8" = _HdC5dZXL;
        "pkg-1.3.9" = _MzTYFTna;
        "pkg-1.3.10" = _cLpModtH;
        "pkg-1.3.11" = _mWw9CvL2;
        "pkg-1.3.12" = _9c2cLIqy;
        "pkg-1.3.13" = _lpbtebW6;
        "pkg-1.3.14" = _1ZpQojGF;
        "pkg-1.3.15" = _qZer4yFB;
        "pkg-1.3.17" = _AjfOGo0e;
        "pkg-1.3.18" = _FqzXHHF7;
        "pkg-1.3.19" = _nde4OSrC;
        "pkg-1.3.20" = _2QKX5dZL;
        "pkg-1.3.21" = _ojOgd0Uv;
        "pkg-1.3.22" = _XhBWLuKe;
        "pkg-1.3.23" = _kQltXvSj;
        "pkg-1.3.24" = _i4exeq3U;
        "pkg-1.3.25" = _8D2OgRP1;
        "pkg-1.3.26" = _atm76GJi;
        "pkg-1.3.27" = _es85VxD0;
        "pkg-1.3.28" = _WNgYhOT4;
        "pkg-1.3.29" = _z5NfAAWb;
        "pkg-1.3.30" = _lQm2kjuY;
        "pkg-1.3.31" = _Iabw9yeJ;
        "pkg-1.3.32" = _4ntlTfec;
        "pkg-1.3.33" = _8ktpEe1z;
        "pkg-1.3.34" = _LpyUG3Rh;
        "pkg-1.3.35" = _Gq5UN8JN;
        "pkg-1.3.36" = _ze9oDZZj;
        "pkg-1.4.0" = _e5Mcvuud;
        "pkg-1.4.1" = _vvu80hP7;
        "pkg-1.4.2" = _cjWy5QBe;
        "pkg-1.4.3" = _XO8JBdxB;
        ...
        "pkg-1.4.8" = _p6ZS0cXN;
        "pkg-1.4.9" = _KHPCaxKi;
        "pkg-1.4.10" = _I5KCVSDr;
        "pkg-1.4.11" = _dZKNoUY9;
        "pkg-1.4.12" = _N0XjcPVc;
        "pkg-1.4.13" = _wKmrY9pf;
        "pkg-1.4.14" = _4flEK80T;
        "pkg-1.4.15" = _E2HMK37v;
        "pkg-1.4.16" = _vjNBI6c3;
        "pkg-1.4.17" = _jLZtbGgU;
        "pkg-1.4.18" = _79xFUtGD;
        "pkg-1.5.0" = _qLJBxm0L;
        "pkg-1.5.1" = _KbsxurOh;
        "pkg-1.5.2" = _rGBA0kbD;
        "pkg-1.5.3" = _48Kmfncl;
        ...
        "pkg-1.6.8" = _sG92NBxY;
        "pkg-1.6.9" = _6CfGuVgn;
        "pkg-1.6.10" = _zhIGR2zG;
        "pkg-1.6.11" = _N02z9aJd;
        "pkg-1.6.12" = _hPqPF4rP;
        "pkg-1.6.13" = _pcyDv92o;
        "pkg-1.6.14" = _FZ13UzOp;
        "pkg-1.6.15" = _KZsDtfU7;
        "pkg-1.6.16" = _F0DtJscx;
        "pkg-1.6.17" = _7XNnoFUR;
        "pkg-1.7.0" = _u7ZwAmBN;
        "pkg-1.7.1" = _nj0OaelC;
        "pkg-1.7.2" = _bnUHbbDD;
        "pkg-1.7.3" = _TVUufTFA;
        ...
        "pkg-1.8.8" = _yaOWHxq9;
        "pkg-1.8.9" = _MYfZo1XG;
        "pkg-1.8.10" = _UJRb6xWl;
        "pkg-1.8.11" = _DijJBodO;
        "pkg-1.8.12" = _Z8xOTeMR;
        "pkg-1.8.13" = _gdJDNrJH;
        "pkg-1.8.14" = _XCG891rz;
        "pkg-1.8.15" = _B7FqS8dL;
        "pkg-1.8.16" = _dOfZ8WAS;
        "pkg-1.8.17" = _clxxaig6;
        "pkg-1.8.18" = _m7X4pwHF;
        "pkg-1.8.19" = _1RO0s5Ld;
        "pkg-1.8.20" = _cUHi6GZe;
        "pkg-1.8.21" = _I8acRWJP;
        "pkg-1.8.22" = _oXDxUDmK;
        "pkg-1.8.23" = _Ee4sroTB;
        "pkg-1.8.24" = _7uLaRrYP;
        "pkg-1.8.25" = _x5lHzujv;
        "pkg-1.8.26" = _XPPcfqPk;
        "pkg-1.9.0" = _E9V2j4Py;
        "pkg-1.9.1" = _cYk9alAF;
        "pkg-1.9.2" = _ObakYRPo;
        "pkg-1.9.3" = _7JbdO5BR;
        ...
        "pkg-1.9.8" = _nt5FM6cN;
        "pkg-1.9.9" = _6P3funYz;
        "pkg-1.9.10" = _uFDYqgz2;
        "pkg-1.9.11" = _AV8a9E7V;
        "pkg-1.9.12" = _8by4jPmI;
        "pkg-1.9.13" = _FrE2BgHc;
        "pkg-1.9.14" = _OHoRuFmy;
        "pkg-1.9.15" = _TFwDz5MW;
        "pkg-1.9.16" = _OXrPMPfY;
        ...
        "pkg-1.9.35" = _9lYHFixq;
        "pkg-1.9.36" = _gEtxU6wp;
        "pkg-1.9.37" = _jlAwQohM;
