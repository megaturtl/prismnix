...
let
    ...
    in {
        ...
        "pkg-0.5.3-alpha" = _fbISpr69;
        "pkg-0.5.4-alpha" = _CFBBlRDq;
        "pkg-0.6.0-alpha" = _xok94Fen;
        "pkg-0.7.0-alpha" = _A0c8QgZ3;
        "pkg-0.7.1-alpha" = _P0MA9jK2;
        "pkg-0.7.2-alpha" = _zqx3otHr;
        "pkg-0.7.3-alpha" = _AwOSVoqp;
        "pkg-0.7.4-alpha" = _ZUeUWKpe;
        "pkg-0.8.0-alpha" = _JoLQ6225;
        "pkg-0.8.1-alpha" = _kbBurOQS;
        "pkg-0.8.2-alpha" = _CNWPEbbw;
        "pkg-0.8.3-alpha" = _ccSIoSYh;
        "pkg-0.8.4-alpha" = _QPAdFe4W;
        "pkg-0.9.0-alpha" = _rcIzP71e;
        "pkg-0.9.1-alpha" = _EKrmFmHT;
        "pkg-0.9.2-alpha" = _soWq7qDQ;
        "pkg-0.9.3-alpha" = _1A0bUXGw;
        "pkg-0.10.0-alpha" = _vOWQILBz;
        "pkg-0.10.1-alpha" = _Y4zOZ6GI;
        "pkg-0.10.2-alpha" = _1vczNGv4;
        "pkg-0.10.3-alpha" = _vYVc8YUL;
        "pkg-0.10.4-alpha" = _QgMCHwAM;
        "pkg-0.11.0-alpha" = _v5qOxyIC;
        "pkg-0.11.1-alpha" = _EYMetCl8;
        "pkg-0.12.0-beta" = _PLPPU3AH;
        "pkg-0.13.0-beta" = _obRcUl63;
        "pkg-0.12.1-beta" = _gGIuPbYE;
        "pkg-0.13.1-beta" = _lI6tzTLn;
        "pkg-0.13.2-beta" = _YgklKNT7;
        "pkg-0.13.3-beta" = _XW9Bh0fd;
        "pkg-0.13.4-beta" = _KIN9BGiI;
        "pkg-0.13.5-beta" = _88AB4eNv;
        "pkg-0.13.6-beta" = _e9y1yb7Q;
        "pkg-0.13.7-beta" = _kvJrqssO;
        "pkg-0.13.8-beta" = _PQeSAUfd;
        "pkg-0.13.9-beta" = _MK0cseik;
        "pkg-0.13.10-beta" = _xhsHepPw;
        "pkg-0.13.11-beta" = _ZdQVmnPi;
        "pkg-0.13.12-beta" = _5X511tKj;
        "pkg-0.13.13-beta" = _OTA7j3NS;
        "pkg-0.13.14-beta" = _xx7488a1;
        "pkg-0.13.15-beta" = _9IdDbzBH;
        "pkg-0.13.16-beta" = _geGNiCrW;
        "pkg-0.14.0-beta" = _9Or2s9l7;
        "pkg-0.14.1-beta" = _DMvTAV9k;
        "pkg-0.14.2-beta" = _pBUERwzb;
        "pkg-0.14.3-beta" = _1WeW11vf;
        "pkg-0.15.0-beta" = _wE274muB;
        "pkg-0.15.1-beta" = _NtCCGmg3;
        "pkg-0.16.0-beta" = _gcuFb5cB;
        "pkg-0.16.1-beta" = _FRWVZOmG;
        "pkg-0.16.2-beta" = _hG6fwPe2;
        "pkg-0.16.3-beta" = _aq2kCHwR;
        "pkg-0.16.4-beta" = _U2M56SeG;
        "pkg-0.16.5-beta" = _DmIv7WKY;
        "pkg-0.16.6-beta" = _hUoLvBHy;
        "pkg-0.16.7-beta" = _s7e9Tgyv;
        "pkg-0.16.8-beta" = _t63Vus03;
        "pkg-0.16.9-beta" = _PZBs0l9F;
        "pkg-0.16.10-beta" = _eW5qWWkA;
        "pkg-0.16.11-beta" = _iHU7fhkc;
        "pkg-0.17.0-beta" = _A2oaXGmI;
        "pkg-0.17.1-beta" = _ssGAXdeG;
        "pkg-0.17.2-beta" = _lYlTTvtU;
        "pkg-0.17.3-beta" = _LR9K1bTq;
        "pkg-0.17.4-beta" = _6WnjrnPQ;
        "pkg-0.17.5-beta" = _KTsw1FOW;
        "pkg-0.17.6-beta" = _bsUShmbG;
