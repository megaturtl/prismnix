...
let
    versions = (let
        ...
        _VNWhzp9g = {
            "id" = "VNWhzp9g";
            "file" = "carpet-igny-addition-v1.14.0-mc1.20.4.jar";
            "hash" = "sha512-9e0t24KRFelwX895Bm66XaE7PPoRe1y+y446d9s2tQeiPfF/hPBnpCD6H4/ORGAhQdDTcTzZysgTtsLOs8peWg==";
        };
        _7nKjLJvv = {
            "id" = "7nKjLJvv";
            "file" = "carpet-igny-addition-v1.14.0-mc1.21.4.jar";
            "hash" = "sha512-9Ra/eLmhEn/roKNdddaDA04puqg2WiwxaSbRN1qFfnSnNg17wz3sqCfvhHhl6DJzPmsuhNf0u01xw90mRmuf7g==";
        };
        _WQoIh89v = {
            "id" = "WQoIh89v";
            "file" = "carpet-igny-addition-v1.14.0-mc1.21.5.jar";
            "hash" = "sha512-BCpT4o9qC4xbO3zNSBPLz+uWj0FjU7v0ORn+JOL7jQaCvf0s1cv5RbY6ec9rsl00K0IWzy6FPeWa/HgeUa2EyQ==";
        };
        _WHDCGZve = {
            "id" = "WHDCGZve";
            "file" = "carpet-igny-addition-v1.14.0-mc1.20.1.jar";
            "hash" = "sha512-2sOArTeB1g4vHrDEEN09n3AK/7NZ/zVzMLmunoh4nHTJKr0S/0hxAvQUWMZT7ypl7OSu1OsFnQRoQopHaljDkg==";
        };
        _yHYPElQL = {
            "id" = "yHYPElQL";
            "file" = "carpet-igny-addition-v1.14.0-mc1.21.10.jar";
            "hash" = "sha512-0ElQRjZNA7U/yVZuNlWEHGYW1mVs4jaT+8ELP2AOqDZ/KX0uz10y1ZHBu/wdeMeBV4D6qAX7048md5wuMX4sJg==";
        };
        _9BxdxHeS = {
            "id" = "9BxdxHeS";
            "file" = "carpet-igny-addition-v1.14.0-mc1.19.4.jar";
            "hash" = "sha512-i+VyMSEfV7kvTxbOLldKbLFxZt9MOtQFEqoylE1SUpl8yKS2C1+qzx6QzeGAV27IxHOiHQijqQnbEG29so3ueA==";
        };
        _4aV0S0GZ = {
            "id" = "4aV0S0GZ";
            "file" = "carpet-igny-addition-v1.14.0-mc1.21.8.jar";
            "hash" = "sha512-kA7NssKxV4woCaoOpcUmczWIQQ5cmDU4phgSgQVxOkvSg9RuZFZ9l1YOt6cqgrxnyrG6RopndYl6Li4sFDtocA==";
        };
        _RkhmykD9 = {
            "id" = "RkhmykD9";
            "file" = "carpet-igny-addition-v1.14.0-mc1.20.2.jar";
            "hash" = "sha512-pwvp6GPGDHSiDCJKyU+5JPOoQVHhnN/m2c7fwPxVLsl56bRze+SvS42nCLlBRVh+C6HWG4RQ07CwnWQxP0ahPQ==";
        };
        _70J4avlI = {
            "id" = "70J4avlI";
            "file" = "carpet-igny-addition-v1.14.0-mc1.21.11.jar";
            "hash" = "sha512-PMCEuS610C4DLW14FCDH1cfJw/DsiRyoXhNefAfx6OgLj7oEE423LQtG8ceFWiuQXehKC8EOHA1YqH51PEARfQ==";
        };
        _b6TromBP = {
            "id" = "b6TromBP";
            "file" = "carpet-igny-addition-v1.14.0-mc1.21.10.jar";
        ...
        _MH4P5SWi = {
            "id" = "MH4P5SWi";
            "file" = "carpet-igny-addition-v1.14.0-mc1.21.1.jar";
            "hash" = "sha512-UHlthP+WZy7jZLvbKzXzM742eG6JaeAVYhngS1xE1MWreyYtZ4D564T2CxNDjcWUXLOzGxgsCJmYMdN8UPhFRw==";
        };
        _lD2QZflK = {
            "id" = "lD2QZflK";
            "file" = "carpet-igny-addition-v1.14.0-mc26.2.jar";
            "hash" = "sha512-dhRGJAEXjuEyO9KAOzHd/6pv0QlO9w+lOafcXMGrFO464VdZ9ffx0kL18kxX7JjG3Q1WH2jkUBXFvAl6Sj6ZVw==";
        };
        _aLVUa7Ol = {
            "id" = "aLVUa7Ol";
            "file" = "carpet-igny-addition-v1.14.0-mc1.21.8.jar";
        ...
        _aYZ3kaJm = {
            "id" = "aYZ3kaJm";
            "file" = "carpet-igny-addition-v1.14.0-mc26.1.2.jar";
            "hash" = "sha512-c92T8AtIfi1SPx67wsldcrL50SQggHp0McPKXUFu2FhALkaegXrwZD3+AIDU4boGPpN9C+jQ1WfDowAjs8ic+A==";
        };
        _3JRvfiHp = {
            "id" = "3JRvfiHp";
            "file" = "carpet-igny-addition-v1.14.0-mc1.19.4.jar";
        ...
        _UgAsCz1v = {
            "id" = "UgAsCz1v";
            "file" = "carpet-igny-addition-v1.14.0-mc1.20.6.jar";
            "hash" = "sha512-j5ezkBBDjsQ4XdaUaHV7ayrFR3muPClgnstsXICEV7SFU8EIjkjviF2RF/3WY1qz4ufrMYzZyBhwclK3p61waw==";
        };
        _CwLmsXFN = {
            "id" = "CwLmsXFN";
            "file" = "carpet-igny-addition-v1.14.0-mc1.20.2.jar";
        ...
        _Do0EGrq7 = {
            "id" = "Do0EGrq7";
            "file" = "carpet-igny-addition-v1.14.0-mc1.21.3.jar";
            "hash" = "sha512-EoHdGO6/lo9pN++Ov4QVKeGD3+YQQ7Gmcwpj3UWDrwIphYw6aYsa5SByoMgNJE2GUFQVwd2TsWV9QQC9O8GQXA==";
        };
        _e5rt6KES = {
            "id" = "e5rt6KES";
            "file" = "carpet-igny-addition-v1.14.0-mc1.20.4.jar";
        ...
        _ZuMjJCl9 = {
            "id" = "ZuMjJCl9";
            "file" = "carpet-igny-addition-v1.14.1-mc1.21.11.jar";
            "hash" = "sha512-R04EKLS44GdSfk5ZLU4oGHYGYx8oxs/R1w5hCpatAmhgBAlwPdW7AKKDegoRaVhg+1pbkG48q22r128leWq0dw==";
        };
        _ZxJcPAeP = {
            "id" = "ZxJcPAeP";
            "file" = "carpet-igny-addition-v1.14.1-mc1.21.3.jar";
            "hash" = "sha512-Mc2+Zc3RDHege6eta5MviCGYSjcyGOW4FhBqA3nX6xA6t2bX2EPDMq7yDnqhetfRjf7iV2EtYSMqtVn8jE2wdQ==";
        };
        _qPEbrAY5 = {
            "id" = "qPEbrAY5";
            "file" = "carpet-igny-addition-v1.14.1-mc1.20.4.jar";
            "hash" = "sha512-Kda2/vN6vUlZxcmxfivbyro9vD1qZUDJtb+nbMalyk3fbBJZzwEuA25Aa30juarl0A3ITM9wJeu4+nqDVOyWEg==";
        };
        _mTtCjoyt = {
            "id" = "mTtCjoyt";
            "file" = "carpet-igny-addition-v1.14.1-mc1.20.2.jar";
            "hash" = "sha512-MH/TasxrECEZI0V5293GopLas5E8+0RPktbEihGimwVZN45vj9LGa0Jr9cvn1mCiZ6xuzwpHgAbs8RtM5rdg9g==";
        };
        _n1568DIr = {
            "id" = "n1568DIr";
            "file" = "carpet-igny-addition-v1.14.1-mc1.21.10.jar";
            "hash" = "sha512-Td96Z2dI5z+29hxo0GOfzeAFzA6+xbbf6VZj95sw13LqQ/4obtAiqub1dwbc9PUBGZPZ3BUHZALhGL3ebc58Ng==";
        };
        _oxTUUNMa = {
            "id" = "oxTUUNMa";
            "file" = "carpet-igny-addition-v1.14.1-mc26.1.2.jar";
            "hash" = "sha512-msN8HJzN7/YwvzMeHXggkWM+FCefzbxl+8rYe/z7JBXo4pzXOKYjqncGNfWxcO/jDyseVwbwRrZkKxF8jcvt7w==";
        };
        _dwQVxvVK = {
            "id" = "dwQVxvVK";
            "file" = "carpet-igny-addition-v1.14.1-mc1.20.1.jar";
            "hash" = "sha512-k156TdrELJCZXU0C9w8pEmRavg06gklILXVBlMTkfS4tay/98pIqBlVZHTUi1NtN3HKW5bYY++lcrIHTU1NQEQ==";
        };
        _CgMfZaP9 = {
            "id" = "CgMfZaP9";
            "file" = "carpet-igny-addition-v1.14.1-mc1.19.4.jar";
            "hash" = "sha512-KyyN4wnoqG4VK6LygocUcqQZG8gwPdQXlShsEYe/uf4ji1Julv+rt6iFh3oAH3eBdrNxpJO+VhusTi9l53xeOw==";
        };
        _mXyYqjaC = {
            "id" = "mXyYqjaC";
            "file" = "carpet-igny-addition-v1.14.1-mc1.21.8.jar";
            "hash" = "sha512-sdLh7gIAVcFElaxXDG2Q+8cz2XpS6X8C2FyFg6i+63VFv3ADOKg7YHL03gYX3eBzCrImjFKBZcnPAU1UwhF0IQ==";
        };
        _ChLVyvpO = {
            "id" = "ChLVyvpO";
            "file" = "carpet-igny-addition-v1.14.1-mc26.2.jar";
            "hash" = "sha512-5eRIqGSIsf2L51NIlG+jqx6BX+gK0OoGuovSR2kNHyK7JEYsERpzHwxkCwpCO9+DM+koy7m6QJY4A8YqV2Uirw==";
        };
        _4xRpEuXk = {
            "id" = "4xRpEuXk";
            "file" = "carpet-igny-addition-v1.14.1-mc1.21.5.jar";
            "hash" = "sha512-mnihkD2j4EF2d2h5CBGhFmnLbNJ8gXsaVBft2EmWvYM7Xugxp7BZhEI9QjO8nrkq96K+z/qrLEinkBNUHTlxtw==";
        };
        _HDj6XhCc = {
            "id" = "HDj6XhCc";
            "file" = "carpet-igny-addition-v1.14.1-mc1.21.4.jar";
            "hash" = "sha512-7o8OlQPNkCpKxNbrlc2TlM2j31L7ldO/mlaKdNrGCM9zivwqz8REKUu6hCY8KY+pM/JMz6/1EIMVbia2i6LTeA==";
        };
        _JG7wcdes = {
            "id" = "JG7wcdes";
            "file" = "carpet-igny-addition-v1.14.1-mc1.21.1.jar";
            "hash" = "sha512-JupZ5kPjC0+Cm9MYBOETQEbOOI/H1GX0PtBe1A5dLdXFplXG1aOSrl3EpWzC62edA0W7jEYlSav3LrGXpM0pqA==";
        };
        _Nt6zyjWG = {
            "id" = "Nt6zyjWG";
            "file" = "carpet-igny-addition-v1.14.1-mc1.20.6.jar";
            "hash" = "sha512-nFb3tBuyirmOfKW3lUIYBgQ2q5qcH2Np/KIKDl+NiMU3uMKDKekCj90JetZGOisdmPRxnSGyvcLD6N53Dmae+A==";
        };
        _Ir6qOl2Z = {
            "id" = "Ir6qOl2Z";
            "file" = "carpet-igny-addition-v1.15.0-mc1.21.4.jar";
            "hash" = "sha512-SfNuhQTviPZbJ6B4yCIptcOErDxLtfKtq6QuY1N7oLuXNebKV3KykTcgdcOcOh5tqf5bmLko5hFv3zpXgv4R2g==";
        };
        _BrWMFLj6 = {
            "id" = "BrWMFLj6";
            "file" = "carpet-igny-addition-v1.15.0-mc1.20.1.jar";
            "hash" = "sha512-cttZbHxCNlloxH0qfMwpiFZ2wfm7giAU77arG6o4y3X9gTTndJWbYdw2MGL2Z9Epa5iMTXxT9/GxNg25M/XqdA==";
        };
        _cSs6LXsi = {
            "id" = "cSs6LXsi";
            "file" = "carpet-igny-addition-v1.15.0-mc1.20.6.jar";
            "hash" = "sha512-6GdDQSekfmJB7gOV+6PteccIzvmg3GU8bghlVD/XYV1zd/1TOUKtZuijrLV62y57/tqNtHS3XmB33kMhLi92HQ==";
        };
        _1P8Hp5jf = {
            "id" = "1P8Hp5jf";
            "file" = "carpet-igny-addition-v1.15.0-mc1.20.4.jar";
            "hash" = "sha512-ZRV6xOvYUF2P2WFUFI7eKfi50mosZ2aBnNfbyuOfpG1wPSvNBpQ5AlB8twf4chwMJ1b520u/5xcLpDNlgi0Fww==";
        };
        _hi0eIBTo = {
            "id" = "hi0eIBTo";
            "file" = "carpet-igny-addition-v1.15.0-mc1.19.4.jar";
            "hash" = "sha512-JuAa7jYIF3Cj9vILCmlTD3J2K8Q/7Vai3l2HtESZ2JA7IL7lJWnzkPyztLCOjzPESvK7VkAogo5EY6ylXcSexQ==";
        };
        _OpaEZx7C = {
            "id" = "OpaEZx7C";
            "file" = "carpet-igny-addition-v1.15.0-mc1.20.2.jar";
            "hash" = "sha512-Bb2sq/ZGwknbUibAvzJgqcnLazaPtONJuEaGaWc3IpoB/P+/AUcmeLpqeCafYPZn3+VEmLm5y04FSfKwEghKnw==";
        };
        _3LvFvBKf = {
            "id" = "3LvFvBKf";
            "file" = "carpet-igny-addition-v1.15.0-mc1.21.5.jar";
            "hash" = "sha512-Kp9+qrcdi0uaM/VBevcBsm0R8VKCjvcujM5VFMCAr/zPYuCKFygkDKM9d7G3puKlKRufuB38RZHmgzN6SybVPw==";
        };
        _1q4Yz9Zh = {
            "id" = "1q4Yz9Zh";
            "file" = "carpet-igny-addition-v1.15.0-mc1.21.1.jar";
            "hash" = "sha512-BzHET+3DJUAIZ+XKBPl2sIojDk2hivkqG1n9sOUyHDa20aEL99LmXQoa9hzZT8CauDN0sIcH73db1ZQdElFl6g==";
        };
        _pEckAwoS = {
            "id" = "pEckAwoS";
            "file" = "carpet-igny-addition-v1.15.0-mc26.3-snapshot-6.jar";
            "hash" = "sha512-Nzx155QEfcO41ppGCrTdGFSR4bXFAkcdTH8R9oWd3xuikYy/1QBBXqoJGY0Tf2W81qC5JOZFjEG4tAurm45/FA==";
        };
        _EzwdMYDA = {
            "id" = "EzwdMYDA";
            "file" = "carpet-igny-addition-v1.15.0-mc1.21.8.jar";
            "hash" = "sha512-+rMjKyxVFrw0nwh8ve6YAc+itYNB8qdIncO8tK0D58rklRW5zNo3UERRRkNwUSwLVqEHW5rXb78kafWivd3O7Q==";
        };
        _XpJEyfdZ = {
            "id" = "XpJEyfdZ";
            "file" = "carpet-igny-addition-v1.15.0-mc26.2.jar";
            "hash" = "sha512-afcAoUbJ+gMXHwH3pF1u7gIX/3AoQNSYjHzm+Mdib9DLPNN9xjgsWYj1lgwZK0i2DPoDc5ayWs64/c4ceHsKwQ==";
        };
        _LwuiD2uE = {
            "id" = "LwuiD2uE";
            "file" = "carpet-igny-addition-v1.15.0-mc1.21.10.jar";
            "hash" = "sha512-RMU3Dd/SykSMSOi+nDQe3gLlqOCmHAKu41IgiQ2sGMzDVZgDWV6NjLVkn4hRWbx7yJXpyDEet5w6+WJG3vB/WA==";
        };
        _Sme74iyK = {
            "id" = "Sme74iyK";
            "file" = "carpet-igny-addition-v1.15.0-mc26.1.2.jar";
            "hash" = "sha512-MArLUCM/Iyfbdkl3gadc12O0lOCHhegSXLw7gt56+woSKUNhOPkpjl7Be/ejs/JaVBOK76/h1mIqRj7JAKqLAg==";
        };
        _3k4bJZtB = {
            "id" = "3k4bJZtB";
            "file" = "carpet-igny-addition-v1.15.0-mc1.21.11.jar";
            "hash" = "sha512-FniUTUg1Od6Vh+hfViFhpdW6syLu9X9/VfEvBClCuWSJNRWaC6lWmgn3/COnleXVtJ3k9CuF1w9UWXmQJUjraA==";
        };
        _HpzEC1Cz = {
            "id" = "HpzEC1Cz";
            "file" = "carpet-igny-addition-v1.15.0-mc1.21.3.jar";
            "hash" = "sha512-JgciuRXEecOtWs0S7Qn9qJxbkfvQC2XMPNRx7enxdPEFNcnPLo9FvGmQFcXx245y2zkP7MGIeWy1CUSguRu9tQ==";
        };
        _5En4bZdi = {
            "id" = "5En4bZdi";
            "file" = "carpet-igny-addition-v1.16.0-mc1.21.11.jar";
            "hash" = "sha512-kq5A8OEA4zQNq2Y6+vqqeT/C2Nfg7hAuS3r9sHP46vdNVyNtaiHNW2IrSTbbaU6vReYItWTYq9rwx91BlxurwA==";
        };
        _zuE5ZU1j = {
            "id" = "zuE5ZU1j";
            "file" = "carpet-igny-addition-v1.16.0-mc1.20.6.jar";
            "hash" = "sha512-dx/n9v1jZYhommNRL7X4Yl1n99J5tu14W/ZNpY6Z/69mmNsOJBq+8hPcwrYy30jKNBkBefl6cM7Z4inPo9Fr3Q==";
        };
        _M87e5c54 = {
            "id" = "M87e5c54";
            "file" = "carpet-igny-addition-v1.16.0-mc1.19.4.jar";
            "hash" = "sha512-wnvsUCQ+KpFRaLPJDRj5I7/Y0k5c7OhmYPXGs9sugqwMrsQTgX7J3CXIPdJRP5UNOCqslmtbNRTZnvNmFpfksw==";
        };
        _HjMYxJI8 = {
            "id" = "HjMYxJI8";
            "file" = "carpet-igny-addition-v1.16.0-mc1.21.8.jar";
            "hash" = "sha512-JRvqHPhiRYKTN7kWDC7LRFlnggllj+m8ocp90Dw8pODqkbGJOOgxOJUXVfYjn5PNLWIjJbLgLGxYLNXwf61+vQ==";
        };
        _D2Q9Mrx0 = {
            "id" = "D2Q9Mrx0";
            "file" = "carpet-igny-addition-v1.16.0-mc1.21.10.jar";
            "hash" = "sha512-ggeSc2RQ0xFCX7GuXkFaev64g5e03B9ZnKIkqSYln3X3b/QoOAFJiwx7ezSYZqH5bZU3Umwjh686kewHmF6SJA==";
        };
        _HVVBqE18 = {
            "id" = "HVVBqE18";
            "file" = "carpet-igny-addition-v1.16.0-mc1.20.2.jar";
            "hash" = "sha512-rog/7wPzn5gS6gQp4LafD98lFSrrw9vOnJf4oBCWkA8829dYy4s6wh3flX7I7wPdyrjjSeaRb4osGVRSzOy69Q==";
        };
        _KWaJXHQz = {
            "id" = "KWaJXHQz";
            "file" = "carpet-igny-addition-v1.16.0-mc1.21.5.jar";
            "hash" = "sha512-tHqrCPg3NEzAFCezr7A4cQQukshGIUYpzLkgeVIhIo11QoMtBDp+tUtphObpTjxnUPGjebGC/GA+yVjb0aW5Eg==";
        };
        _84odOIy6 = {
            "id" = "84odOIy6";
            "file" = "carpet-igny-addition-v1.16.0-mc26.3-snapshot-9.jar";
            "hash" = "sha512-aHycxwKW6EratBYQs/1JwD8N7sXCP+YxCFS4MzHvyn1HtFA2LyRY5EuweK1IDZ0EuIB56qeeY6msgavq09uq1A==";
        };
        _TjGzJ5oF = {
            "id" = "TjGzJ5oF";
            "file" = "carpet-igny-addition-v1.16.0-mc26.2.jar";
            "hash" = "sha512-pqmjGdkNb7gRcRFU4nURW2bVbf69pU7OvPFrEtUgX1foPPC4YN0plIRc2u4qKg+l38Yw303y/L6MhlPYfCJdbg==";
        };
        _fgOJVNyB = {
            "id" = "fgOJVNyB";
            "file" = "carpet-igny-addition-v1.16.0-mc1.20.4.jar";
            "hash" = "sha512-Ae6fP5iOUPZvY718qrBoIXkJQHFK+oMEmfLzd5SuH3RD/+ryCsYxHXq/+UnPvItyoFwAK1/FTtXzoyOLF2aO1Q==";
        };
        _QDWRcRYr = {
            "id" = "QDWRcRYr";
            "file" = "carpet-igny-addition-v1.16.0-mc1.21.1.jar";
            "hash" = "sha512-UKdoCfz+jQN7B3Qx9K1ppAxTS7XcFkHoHSATZ61rYvT5NLZiiYfvodQ8DOMU6Whm1rx9m65RZyBZcf5iJI5yfw==";
        };
        _XWLZF5oB = {
            "id" = "XWLZF5oB";
            "file" = "carpet-igny-addition-v1.16.0-mc1.21.3.jar";
            "hash" = "sha512-zoQh62QwUZJpBC/5Oq7cs/iB2eDtCNPv/ztjfhd7snd29ZVfBqFkzg/HEW0s6IfMWsNMbgWXxbLKf4bpbZjZGA==";
        };
        _pVuSaQAU = {
            "id" = "pVuSaQAU";
            "file" = "carpet-igny-addition-v1.16.0-mc1.21.4.jar";
            "hash" = "sha512-+RVVwf9cUEFRS8arukWY8Vs9Zma6JPI5X+8+no+dK83IoEc3TYyjYLqHRVnzKaeHeRiPtrpWujQj8AGOLfGt4w==";
        };
        _HefpKs5a = {
            "id" = "HefpKs5a";
            "file" = "carpet-igny-addition-v1.16.0-mc1.20.1.jar";
            "hash" = "sha512-nEbSd5tD+L0i2p5kTfXjH4ZmS+SjMkwXYeDdeBRq3gJtaGbtkBWgWxjYB5PVnXperBU+Ls8lfy8C84txXSJBxQ==";
        };
        _TCG9DMiv = {
            "id" = "TCG9DMiv";
            "file" = "carpet-igny-addition-v1.16.0-mc26.1.2.jar";
            "hash" = "sha512-+40UihCB5d4Eu+jv6Yd5PdwiMcO8Z4xqZWLKN8i4+JmEj5koAPyJwitpPu/tyct1N4D/A1V1N0/o1p54yljs7w==";
        };
        _qM73KBpL = {
            "id" = "qM73KBpL";
            "file" = "carpet-igny-addition-v1.17.0-mc1.21.10.jar";
            "hash" = "sha512-KF5hpFSrAOzhUIPEtBAgUg8tMRJDS7QP9EHv2/GxHUHcN6PrAEGmMIpqQ3c60JVEH79hxrSNl/8P3CktSvapNg==";
        };
        _QtbdpIAt = {
            "id" = "QtbdpIAt";
            "file" = "carpet-igny-addition-v1.17.0-mc1.20.6.jar";
            "hash" = "sha512-sckssD47Vcve7QC4ckIks4Rrpoi1I01VowaBkG7wLr71KokeL9mU1OA2X2wBxrKLdkKByx8f6fNeKq1E+fQ5ew==";
        };
        _2vCRWAx5 = {
            "id" = "2vCRWAx5";
            "file" = "carpet-igny-addition-v1.17.0-mc26.3-snapshot-9.jar";
            "hash" = "sha512-usnhb1NjgkSsZiwuodxRG8+oMmCIuEImulGmmx6dXV1VPbkk+110z1HYhe39/jNbetPW1n6GM/Dbxi2mpiK3Jw==";
        };
        _iXgQgJxl = {
            "id" = "iXgQgJxl";
            "file" = "carpet-igny-addition-v1.17.0-mc1.21.5.jar";
            "hash" = "sha512-3DoCzCImKG9pJSlY0UsPQkUiiOtbJ6QTa/X6uVMgt0DesG/4duXN1/WN+eeBTDaEGLnTYd9Xp0cXGMSG2oXxXg==";
        };
        _Od3Wr84P = {
            "id" = "Od3Wr84P";
            "file" = "carpet-igny-addition-v1.17.0-mc1.20.4.jar";
            "hash" = "sha512-NJm/RZkMGPbBAArr8pdIi2nhzaQKRU6eEYs19TxtOGrLGaicjDulpHu85tvgzUoVVbs+zpL1VkcU/QEMmy1T7Q==";
        };
        _PCnJd7uL = {
            "id" = "PCnJd7uL";
            "file" = "carpet-igny-addition-v1.17.0-mc1.21.1.jar";
            "hash" = "sha512-qfyOOW0XpuB4a/ADqWhBgqGf2UfS4ywpN/NwS8b6mll2Fh3IpdiA8bsoPXg2CvtASOuYjEHBhDbWqLlo1vJMlw==";
        };
        _rBYpAMDr = {
            "id" = "rBYpAMDr";
            "file" = "carpet-igny-addition-v1.17.0-mc26.2.jar";
            "hash" = "sha512-53tjaafFRUprF5S8uHViTYbWDoXj7j07hhlj9ISY6cfYhmEL1PkWqYZJHWQrddxMuhwsTsPKymMCadlkJhl4jQ==";
        };
        _nan3zBNJ = {
            "id" = "nan3zBNJ";
            "file" = "carpet-igny-addition-v1.17.0-mc26.1.2.jar";
            "hash" = "sha512-7Y8OGWorCcX4AJWtpYC3wGtXtoXu/3ZEz9coaaKuffyLQ1TKFkqHyD3xvR5tNL4NnKoLcVDsXzuvO606tVugdQ==";
        };
        _FClOqOEp = {
            "id" = "FClOqOEp";
            "file" = "carpet-igny-addition-v1.17.0-mc1.20.2.jar";
            "hash" = "sha512-l1ueWhveHDWZmXb+ddO8a7lTsgBdAwh3RBMYGjloYlO2UAgSxG24qWp5HrZ0oE68LVdg1sdkSGcZ20QJnaoD/w==";
        };
        _4yRI1R2x = {
            "id" = "4yRI1R2x";
            "file" = "carpet-igny-addition-v1.17.0-mc1.21.3.jar";
            "hash" = "sha512-mPbAIYqQJwCeX98ORkqdP/+L32zyCctiNSmZep/58FOygzC2EVlDJJcZMLSXlYIjl+ehpg4i3zk9vqW4jVSn+Q==";
        };
        _rRrLqpf0 = {
            "id" = "rRrLqpf0";
            "file" = "carpet-igny-addition-v1.17.0-mc1.21.4.jar";
            "hash" = "sha512-pEwQMOcoLvog+ykfwl5/d5N74lf0gTWYXETjCEb/u4Pz8KMY6R75Phq+dKuzEu7Z0cfns+AgqkVnCjNcofjv2A==";
        };
        _iPu6nvpN = {
            "id" = "iPu6nvpN";
            "file" = "carpet-igny-addition-v1.17.0-mc1.21.8.jar";
            "hash" = "sha512-jJIHPnf36e3P8tgV+dT4gy6gD0tc/Vzu79V60uJMMCjiofnQjaNh6rmQWT+L9nqukf29Upe/+7UFb63GYFDOQw==";
        };
        _NZm0F13I = {
            "id" = "NZm0F13I";
            "file" = "carpet-igny-addition-v1.17.0-mc1.19.4.jar";
            "hash" = "sha512-TWMgdZ+2aGRfpq3uo95OTWG6lOO18oGs5Qb1rRMzaUPU4htaajjQJURwhiz9xMtIMpDV6Vsgs8xfxNnU7gCWGQ==";
        };
        _EkubeF1I = {
            "id" = "EkubeF1I";
            "file" = "carpet-igny-addition-v1.17.0-mc1.20.1.jar";
            "hash" = "sha512-iLGklMb9Ne9SsdwDJOFxX8/g8y3vQsC0TDIhV1lFcOmpdRnp4N/PSE0TsK1hoiwqyqXxh2HRU94cTHjym/YqqA==";
        };
        _5FWn1v3L = {
            "id" = "5FWn1v3L";
            "file" = "carpet-igny-addition-v1.17.0-mc1.21.11.jar";
            "hash" = "sha512-HChljbcTj4FfMzwwmndhd1EEaP3EUQynkeSxXyhMii4XyFgjsuh5atWVmJhU9avi7P43PtuK5LgimjHTQctzwA==";
        };
        _EvSHCyB3 = {
            "id" = "EvSHCyB3";
            "file" = "carpet-igny-addition-v1.17.1-mc1.20.4.jar";
            "hash" = "sha512-kQbPZAvEHGI2BY2EpXSQhLvQTGszyakRN9hjhbywYSvogzYb7BqLZSCqIjYcr38IQitJeXaM1qYsQGjy6K3jRQ==";
        };
        _Zv4rY8Bu = {
            "id" = "Zv4rY8Bu";
            "file" = "carpet-igny-addition-v1.17.1-mc1.20.6.jar";
            "hash" = "sha512-FAVYhYyvJMNPUSPivRj/e7amSZkRko9XYCID3rzAWKXtZczLiPeMoQm2bBLbao7KCwTXvK5CSMrM4TA3BelEIA==";
        };
        _gtbabdf2 = {
            "id" = "gtbabdf2";
            "file" = "carpet-igny-addition-v1.17.1-mc1.20.2.jar";
            "hash" = "sha512-cbbNCdsOYkeXw4hEO+QaK0EnP9APO9EWDV6XDQhEtSCVU7qDYNV4AaIiuoUHv/s1SDsVvfHY78AYcRhn+IbsFA==";
        };
        _cQbAFRoG = {
            "id" = "cQbAFRoG";
            "file" = "carpet-igny-addition-v1.17.1-mc1.21.8.jar";
            "hash" = "sha512-cRJxI/wdOCMwVIVJWZzyGfPOVpQ3vhtk4IZ3cZyrTI50VhrXp/Mux7Qd4FQ3U8vk83ZceY2zKppLE08WgVUEtw==";
        };
        _DOh3zuzt = {
            "id" = "DOh3zuzt";
            "file" = "carpet-igny-addition-v1.17.1-mc1.21.5.jar";
            "hash" = "sha512-NujM3aTGzXn2NtfXLkVTb58LzhQH7sY8LAmNmdKA3rY/DIg1YiFLAUtXQf0G4Ne8H3F0r2iDSqpedQWr9Pzi7g==";
        };
        _nDAfakLx = {
            "id" = "nDAfakLx";
            "file" = "carpet-igny-addition-v1.17.1-mc1.21.3.jar";
            "hash" = "sha512-nOtbgiEk6rYNBuYNEGbYIPCCYIJeADC4oMSARo+XiOyiAKDWrgOk7HQdxNuRrKAUhBZU1fXdTkloug3xD9mr8w==";
        };
        _sHllPvXu = {
            "id" = "sHllPvXu";
            "file" = "carpet-igny-addition-v1.17.1-mc1.19.4.jar";
            "hash" = "sha512-zz6Q+qv0EPA/M4363G0r5K/EG8JvzsCFzXi5w2NXThjy3uPIj3x7dDjsauZjxcEsqXYm9309JSPhHBK+DQyM0A==";
        };
        _QhqNumpI = {
            "id" = "QhqNumpI";
            "file" = "carpet-igny-addition-v1.17.1-mc1.20.1.jar";
            "hash" = "sha512-3+AZcRmEkxKLMDYieMm/cR3GHKrZrDhomHix7qdtpinsr5iDaO8l7/WOC8EVauxKjCkZduqCPcWvLBMTLXFy/A==";
        };
        _88pZ4TXr = {
            "id" = "88pZ4TXr";
            "file" = "carpet-igny-addition-v1.17.1-mc26.2.jar";
            "hash" = "sha512-O4pzKrkoJUOk2Nlhlki0kVk1Hspr97jxfGksCoU3rJ9piL072wrQZwxFItTPzZRTzHJQpEDm9axl+/ewwJ96Tg==";
        };
        _PBidEG57 = {
            "id" = "PBidEG57";
            "file" = "carpet-igny-addition-v1.17.1-mc26.3-snapshot-9.jar";
            "hash" = "sha512-pPgBtfvfEAEmO0C6x1h6DLSHOul+djShyMZW77sVGUyMjDtfCtanVM+YpymAKn+j+nmDDyjFCzDTkyWiOWEP5g==";
        };
        _JBQKAWKu = {
            "id" = "JBQKAWKu";
            "file" = "carpet-igny-addition-v1.17.1-mc1.21.1.jar";
            "hash" = "sha512-ZFRcRAzhnxyUwQZOP3SyxIm2mQKQ/43VzQBcpmG4Mc+5pwmpdUBqSRwz4URH5TM9WxYRl4k0UgJN6Nbo7M3www==";
        };
        _HNzLVevw = {
            "id" = "HNzLVevw";
            "file" = "carpet-igny-addition-v1.17.1-mc1.21.4.jar";
            "hash" = "sha512-3zfYsTi98EKQ/yeqoVSgd1hVWD28G8jWODRgkEMCHtNVDT3/XQe8CvC7YGfVanZAgYoi5ghcSvk5hRZPMXD8sA==";
        };
        _HJghCsNe = {
            "id" = "HJghCsNe";
            "file" = "carpet-igny-addition-v1.17.1-mc1.21.10.jar";
            "hash" = "sha512-sp0TVtNljtpmU1YDRXaqGt9pYs89yjZX9OsFkZU51FBk6P2srcH8leoSMYeDGHAff2gOOMHCJMVJZXxIjYt6Ww==";
        };
        _CvwBmzyO = {
            "id" = "CvwBmzyO";
            "file" = "carpet-igny-addition-v1.17.1-mc1.21.11.jar";
            "hash" = "sha512-opjdaYU2b5acI/AzAyOFcL0kbEDbfmcVTh1i2Rv5rHDTNcpxIHDoDovhjSwgw+pnTonpbuo380Kkk4TyfYBWbA==";
        };
        _J0RNE2Q5 = {
            "id" = "J0RNE2Q5";
    ...
    in {
        ...
        "pkg-v0.0.2-SNAPSHOT-mc1.21.5" = _xpTdl3k9;
        "pkg-v0.0.2-SNAPSHOT-mc1.21.8" = _qOyNrE6G;
        "pkg-v0.0.2-SNAPSHOT-mc1.21.10" = _AkrQdRwa;
        "pkg-v0.0.3-SNAPSHOT-mc1.21.1" = _EEPZKjuV;
        "pkg-v0.0.3-SNAPSHOT-mc1.21.3" = _xsozJgiU;
        "pkg-v0.0.3-SNAPSHOT-mc1.21.4" = _Xk6N5W2K;
        "pkg-v0.0.3-SNAPSHOT-mc1.21.5" = _zhcw92Cm;
        "pkg-v0.0.3-SNAPSHOT-mc1.21.8" = _85SLC7qW;
        "pkg-v0.0.3-SNAPSHOT-mc1.21.10" = _xjOX0YxP;
        "pkg-v0.0.4-SNAPSHOT-mc1.21.1" = _ta1fHpis;
        "pkg-v0.0.4-SNAPSHOT-mc1.21.3" = _rrppZugO;
        "pkg-v0.0.4-SNAPSHOT-mc1.21.4" = _yrsqq3BE;
        "pkg-v0.0.4-SNAPSHOT-mc1.21.5" = _SOgHB1sP;
        "pkg-v0.0.4-SNAPSHOT-mc1.21.8" = _eJiotmug;
        "pkg-v0.0.4-SNAPSHOT-mc1.21.10" = _ogs0LnZE;
        "pkg-v1.0-mc1.21.3" = _dpyHh9KC;
        "pkg-v1.0-mc1.21.1" = _mFRuJCs9;
        "pkg-v1.0-mc1.21.5" = _FaEZoju6;
        "pkg-v1.0-mc1.21.10" = _ZKs4PU1T;
        "pkg-v1.0-mc1.21.4" = _OCWqpmPs;
        "pkg-v1.0-mc1.21.8" = _WlZz9EKW;
        "pkg-v1.0.1-mc1.21.8" = _s0QtIoLE;
        "pkg-v1.0.1-mc1.21.1" = _SdKlsXBa;
        "pkg-v1.0.1-mc1.21.5" = _M75JvLHU;
        "pkg-v1.0.1-mc1.21.3" = _1g5N6imd;
        "pkg-v1.0.1-mc1.21.10" = _ib93hgUg;
        "pkg-v1.0.1-mc1.21.4" = _4c5rVXfv;
        "pkg-v1.1-mc1.21.3" = _JZc1ANqL;
        "pkg-v1.1-mc1.21.11" = _xgPBVARE;
        "pkg-v1.1-mc1.21.4" = _ZenhNITc;
        "pkg-v1.1-mc1.21.5" = _3IeqZYVr;
        "pkg-v1.1-mc1.21.10" = _WDmO8lbt;
        "pkg-v1.1-mc1.21.1" = _b1KZir9N;
        "pkg-v1.1-mc1.21.8" = _wdi55lXM;
        "pkg-v1.2-mc1.19.4" = _uMVU5fzW;
        "pkg-v1.2-mc1.20.2" = _snGa4PFh;
        "pkg-v1.2-mc1.21.10" = _t3tX5InB;
        "pkg-v1.2-mc1.21.11" = _YPYuqvB0;
        "pkg-v1.2-mc1.20.1" = _GovsN3Wy;
        "pkg-v1.2-mc1.21.8" = _xyM4fZv4;
        "pkg-v1.2-mc1.20.4" = _29p1XlBB;
        "pkg-v1.2-mc1.21.1" = _72wP4ju5;
        "pkg-v1.2-mc1.21.3" = _xXr2OgU1;
        "pkg-v1.2-mc1.21.4" = _V0dLOKjx;
        "pkg-v1.2-mc1.20.6" = _VA4nxwIx;
        "pkg-v1.2-mc1.21.5" = _kJjXVbBh;
        "pkg-v1.2.1-mc1.21.1" = _lYuWMFqk;
        "pkg-v1.2.1-mc1.21.8" = _xHxQaezX;
        "pkg-v1.2.1-mc26.1-snapshot-1" = _s1ZdX0N7;
        "pkg-v1.2.1-mc1.21.11" = _oUXe8sHG;
        "pkg-v1.2.1-mc1.19.4" = _pEmpzARi;
        "pkg-v1.2.1-mc1.21.5" = _VmDtgdw5;
        "pkg-v1.2.1-mc1.20.2" = _qLH9alrd;
        "pkg-v1.2.1-mc1.21.4" = _OHfZX2BJ;
        "pkg-v1.2.1-mc1.20.1" = _q0A7QZjL;
        "pkg-v1.2.1-mc1.21.3" = _V89jC14s;
        "pkg-v1.2.1-mc1.20.6" = _ganXQkQf;
        "pkg-v1.2.1-mc1.20.4" = _f1ROTf3r;
        "pkg-v1.2.1-mc1.21.10" = _ASvn1LmB;
        "pkg-v1.3-mc1.20.2" = _UQUCntxO;
        "pkg-v1.3-mc1.21.3" = _s1EFsfB4;
        "pkg-v1.3-mc1.21.8" = _2NqVYl0x;
        "pkg-v1.3-mc1.21.11" = _BHWxLJ1j;
        "pkg-v1.3-mc1.21.5" = _HXOoMkPJ;
        "pkg-v1.3-mc26.1-snapshot-1" = _2cuYZZRq;
        "pkg-v1.3-mc1.19.4" = _g5DlbnHI;
        "pkg-v1.3-mc1.20.6" = _qZzcCCEE;
        "pkg-v1.3-mc1.20.4" = _RkBN64zR;
        "pkg-v1.3-mc1.20.1" = _Wk3U0vAe;
        "pkg-v1.3-mc1.21.4" = _zYTB9pm7;
        "pkg-v1.3-mc1.21.1" = _WAezjMOW;
        "pkg-v1.3-mc1.21.10" = _5OqOKDvj;
        "pkg-v1.3.1-mc26.1-snapshot-1" = _W9QThL2I;
        "pkg-v1.3.1-mc1.21.5" = _zk0U70J0;
        "pkg-v1.3.1-mc1.21.8" = _R5U5ZwHA;
        "pkg-v1.3.1-mc1.20.2" = _vwKIqqZd;
        "pkg-v1.3.1-mc1.19.4" = _WlcJcBuV;
        "pkg-v1.3.1-mc1.21.3" = _T7ZZ34Lt;
        "pkg-v1.3.1-mc1.20.6" = _IZCC2Ucx;
        "pkg-v1.3.1-mc1.21.11" = _NRuP2RKo;
        "pkg-v1.3.1-mc1.20.4" = _xqeEXx4F;
        "pkg-v1.3.1-mc1.21.4" = _QZMPdtSg;
        "pkg-v1.3.1-mc1.20.1" = _reYFKaM7;
        "pkg-v1.3.1-mc1.21.1" = _ukNElkZ6;
        "pkg-v1.3.1-mc1.21.10" = _NjvcQROd;
        "pkg-v1.3.2-mc1.21.5" = _hQijrKNv;
        "pkg-v1.3.2-mc1.20.6" = _e2vkfBIn;
        "pkg-v1.3.2-mc1.20.2" = _UkCrHqHm;
        "pkg-v1.3.2-mc1.21.3" = _A2MHEQni;
        "pkg-v1.3.2-mc1.21.11" = _ti31fnv1;
        "pkg-v1.3.2-mc1.21.1" = _SbnEdiTQ;
        "pkg-v1.3.2-mc1.21.8" = _paDVXYbK;
        "pkg-v1.3.2-mc1.21.4" = _TCU7p4LI;
        "pkg-v1.3.2-mc1.19.4" = _2N6T4CU0;
        "pkg-v1.3.2-mc1.20.1" = _yYRFLKM4;
        "pkg-v1.3.2-mc26.1-snapshot-2" = _q2az9o9X;
        "pkg-v1.3.2-mc1.21.10" = _1duPGZpn;
        "pkg-v1.3.2-mc1.20.4" = _IgtktyuM;
        "pkg-v1.3.3-mc1.21.10" = _5eALEe4Q;
        "pkg-v1.3.3-mc1.20.6" = _kTVcMuSx;
        "pkg-v1.3.3-mc26.1-snapshot-2" = _UMW3ZnOm;
        "pkg-v1.3.3-mc1.20.4" = _6XJoiY9n;
        "pkg-v1.3.3-mc1.21.8" = _r9wEzZVI;
        "pkg-v1.3.3-mc1.20.2" = _DgW4sFx3;
        "pkg-v1.3.3-mc1.21.4" = _kdaAsFG6;
        "pkg-v1.3.3-mc1.19.4" = _GndumAtZ;
        "pkg-v1.3.3-mc1.20.1" = _vS5OTNgR;
        "pkg-v1.3.3-mc1.21.5" = _oPOm18N6;
        "pkg-v1.3.3-mc1.21.1" = _ImwLjmIo;
        "pkg-v1.3.3-mc1.21.11" = _Lt0Jwcfm;
        "pkg-v1.3.3-mc1.21.3" = _VkfwVrdv;
        "pkg-v1.3.4-mc1.20.1" = _eOW4Acse;
        "pkg-v1.3.4-mc1.21.5" = _xe8KyyRF;
        "pkg-v1.3.4-mc26.1-snapshot-3" = _rIyKE3B6;
        "pkg-v1.3.4-mc1.20.6" = _W9M9B3Qt;
        "pkg-v1.3.4-mc1.21.3" = _RvLRHHfD;
        "pkg-v1.3.4-mc1.21.10" = _Ru4RGPsS;
        "pkg-v1.3.4-mc1.21.8" = _UE5wrMnJ;
        "pkg-v1.3.4-mc1.21.1" = _DijkMbA5;
        "pkg-v1.3.4-mc1.21.11" = _ZxEUDbIO;
        "pkg-v1.3.4-mc1.21.4" = _ug91CrQ4;
        "pkg-v1.3.4-mc1.20.4" = _l5BQpcuv;
        "pkg-v1.3.4-mc1.19.4" = _7Fd5bCGx;
        "pkg-v1.3.4-mc1.20.2" = _9vvWOuKQ;
        "pkg-v1.4-mc1.19.4" = _YiOoajfi;
        "pkg-v1.4-mc1.21.4" = _oWqxcZX3;
        "pkg-v1.4-mc1.20.2" = _87iLjVSA;
        "pkg-v1.4-mc1.21.3" = _XM9QIj0k;
        "pkg-v1.4-mc1.21.10" = _LdF0YnSl;
        "pkg-v1.4-mc1.21.11" = _bErCtUHZ;
        "pkg-v1.4-mc1.21.8" = _ygIrromj;
        "pkg-v1.4-mc1.20.1" = _Bn9NR7Qh;
        "pkg-v1.4-mc26.1-snapshot-6" = _OOf8849F;
        "pkg-v1.4-mc1.20.6" = _LZQ3vXby;
        "pkg-v1.4-mc1.21.5" = _58eSTdiq;
        "pkg-v1.4-mc1.21.1" = _RaLPOGXN;
        "pkg-v1.4-mc1.20.4" = _l8sjH6FY;
        "pkg-v1.4.1-mc1.21.8" = _9FXv2TRO;
        "pkg-v1.4.1-mc1.20.6" = _d39hGYUm;
        "pkg-v1.4.1-mc1.19.4" = _RnUF35Ht;
        "pkg-v1.4.1-mc26.1-snapshot-6" = _95gRt0lb;
        "pkg-v1.4.1-mc1.21.10" = _2NsftH8u;
        "pkg-v1.4.1-mc1.20.2" = _y5itMhhC;
        "pkg-v1.4.1-mc1.21.11" = _glYQp1UU;
        "pkg-v1.4.1-mc1.20.4" = _edcGsbI3;
        "pkg-v1.4.1-mc1.21.4" = _yO3lJNNN;
        "pkg-v1.4.1-mc1.21.5" = _MGTpNgqJ;
        "pkg-v1.4.1-mc1.20.1" = _4i8WmSS1;
        "pkg-v1.4.1-mc1.21.1" = _BbvMTfkw;
        "pkg-v1.4.1-mc1.21.3" = _UZ61kuQj;
        "pkg-v1.4.2-mc1.21.11" = _ssaYsQWr;
        "pkg-v1.4.2-mc1.20.2" = _McuCOvNP;
        "pkg-v1.4.2-mc1.21.5" = _WPVTrwFd;
        "pkg-v1.4.2-mc1.19.4" = _yv2xZiCX;
        "pkg-v1.4.2-mc1.20.6" = _gngi1cs5;
        "pkg-v1.4.2-mc1.20.4" = _DQxMkKBi;
        "pkg-v1.4.2-mc26.1-snapshot-6" = _tC43uDMI;
        "pkg-v1.4.2-mc1.21.3" = _6ACBZx1C;
        "pkg-v1.4.2-mc1.21.1" = _D8qEYFmx;
        "pkg-v1.4.2-mc1.21.8" = _OKTZjvuh;
        "pkg-v1.4.2-mc1.20.1" = _hmbARhXA;
        "pkg-v1.4.2-mc1.21.10" = _HKLVG4Zq;
        "pkg-v1.4.2-mc1.21.4" = _Q66B2yDW;
        "pkg-v1.5-mc1.20.6" = _MrdhuWhH;
        "pkg-v1.5-mc1.21.4" = _XIS0h1II;
        "pkg-v1.5-mc1.21.1" = _aJOhDCnI;
        "pkg-v1.5-mc1.21.10" = _85f6Q2t0;
        "pkg-v1.5-mc1.21.11" = _dOgf3Voj;
        "pkg-v1.5-mc1.21.3" = _z84wyj8V;
        "pkg-v1.5-mc1.21.5" = _BDd91Vg3;
        "pkg-v1.5-mc26.1-snapshot-10" = _6S8Iq66Q;
        "pkg-v1.5-mc1.20.1" = _N0EO32sy;
        "pkg-v1.5-mc1.21.8" = _qmhpnLWH;
        "pkg-v1.5-mc1.20.2" = _oGbWLJBz;
        "pkg-v1.5-mc1.20.4" = _CXKp9qHt;
        "pkg-v1.5-mc1.19.4" = _z7kvzvCW;
        "pkg-v1.5.1-mc1.20.6" = _FAIjgy2V;
        "pkg-v1.5.1-mc1.21.3" = _6QsmSiPZ;
        "pkg-v1.5.1-mc1.21.10" = _ZicY5j6n;
        "pkg-v1.5.1-mc1.19.4" = _eqgX6Qxc;
        "pkg-v1.5.1-mc1.20.1" = _ZUSLFYUj;
        "pkg-v1.5.1-mc1.21.5" = _8ZOsZean;
        "pkg-v1.5.1-mc1.21.8" = _Z7EUf76N;
        "pkg-v1.5.1-mc1.20.4" = _2Zygi0mB;
        "pkg-v1.5.1-mc1.21.11" = _lMzzNoWM;
        "pkg-v1.5.1-mc26.1-snapshot-10" = _EueMCyxs;
        "pkg-v1.5.1-mc1.21.1" = _VxhExecM;
        "pkg-v1.5.1-mc1.21.4" = _Q0gbQf5v;
        "pkg-v1.5.1-mc1.20.2" = _usPTSNN4;
        "pkg-v1.6-mc1.19.4" = _dRMXT8E1;
        "pkg-v1.6-mc1.20.4" = _zSmwLfGZ;
        "pkg-v1.6-mc1.20.2" = _e21hX5x7;
        "pkg-v1.6-mc1.21.11" = _A32PNAcc;
        "pkg-v1.6-mc1.21.8" = _6FA9r3oy;
        "pkg-v1.6-mc1.21.4" = _bsQ2UDht;
        "pkg-v1.6-mc1.20.1" = _wMKQsr00;
        "pkg-v1.6-mc1.21.10" = _IbHtPzBp;
        "pkg-v1.6-mc1.21.1" = _8O1q03NX;
        "pkg-v1.6-mc1.21.3" = _WDOXhHfj;
        "pkg-v1.6-mc26.1-snapshot-11" = _o1TcKxD7;
        "pkg-v1.6-mc1.21.5" = _8aLOzjZf;
        "pkg-v1.6-mc1.20.6" = _XYHwfcZ7;
        "pkg-v1.7-mc1.21.11" = _BSDDRZ3r;
        "pkg-v1.7-mc1.21.1" = _9FAVDjPL;
        "pkg-v1.7-mc1.21.10" = _VKTp62Fu;
        "pkg-v1.7-mc1.19.4" = _nQVxmG3j;
        "pkg-v1.7-mc1.21.4" = _rkrwhlSh;
        "pkg-v1.7-mc1.20.2" = _EyFbfC0z;
        "pkg-v1.7-mc1.20.4" = _rBMJBlmd;
        "pkg-v1.7-mc1.21.5" = _2lvxkFjr;
        "pkg-v1.7-mc1.21.8" = _yMQgTSFG;
        "pkg-v1.7-mc1.20.6" = _NiMpjZki;
        "pkg-v1.7-mc26.1-rc-2" = _mnlKs5e3;
        "pkg-v1.7-mc1.21.3" = _cKjBSJs6;
        "pkg-v1.7-mc1.20.1" = _WjUxEY6H;
        "pkg-v1.7.1-mc1.20.2" = _gzNpxCUU;
        "pkg-v1.7.1-mc1.20.6" = _jPiR4aBF;
        "pkg-v1.7.1-mc1.21.3" = _agu7u2My;
        "pkg-v1.7.1-mc1.19.4" = _vHeitkDQ;
        "pkg-v1.7.1-mc1.21.5" = _Tjue09pQ;
        "pkg-v1.7.1-mc1.20.1" = _rY8uCREy;
        "pkg-v1.7.1-mc26.1-rc-2" = _z1OMuava;
        "pkg-v1.7.1-mc1.21.4" = _3JUyAkkk;
        "pkg-v1.7.1-mc1.21.1" = _cXdlIz5K;
        "pkg-v1.7.1-mc1.21.8" = _UfQWsUkZ;
        "pkg-v1.7.1-mc1.21.11" = _PD1dyuH8;
        "pkg-v1.7.1-mc1.20.4" = _O7phVnSj;
        "pkg-v1.7.1-mc1.21.10" = _bLIKGPcQ;
        "pkg-v1.7.2-mc1.21.10" = _QDnJuQe2;
        "pkg-v1.7.2-mc1.21.1" = _6676BD8m;
        "pkg-v1.7.2-mc1.20.2" = _5gl0KMN3;
        "pkg-v1.7.2-mc1.21.11" = _V3EJXNml;
        "pkg-v1.7.2-mc1.21.3" = _2wbUJaSR;
        "pkg-v1.7.2-mc1.21.8" = _5ANnNk5d;
        "pkg-v1.7.2-mc1.19.4" = _z20CeyZl;
        "pkg-v1.7.2-mc1.20.4" = _JIvWH7vo;
        "pkg-v1.7.2-mc1.21.5" = _psHPFya3;
        "pkg-v1.7.2-mc1.20.1" = _muGrHnGx;
        "pkg-v1.7.2-mc1.21.4" = _vEABnZRW;
        "pkg-v1.7.2-mc1.20.6" = _TZQzyY1X;
        "pkg-v1.7.2-mc26.1" = _RIhuW5dj;
        "pkg-v1.8-mc1.21.4" = _YdZPclqb;
        "pkg-v1.8-mc1.20.4" = _da8os9Yi;
        "pkg-v1.8-mc1.21.10" = _brbjQgLJ;
        "pkg-v1.8-mc1.21.5" = _KUJzolyd;
        "pkg-v1.8-mc1.20.1" = _tECUAmgL;
        "pkg-v1.8-mc1.20.6" = _lsc4WJUD;
        "pkg-v1.8-mc1.21.8" = _97b95WQm;
        "pkg-v1.8-mc26.1.1" = _5GodneJQ;
        "pkg-v1.8-mc1.21.11" = _Ujhy6Nlb;
        "pkg-v1.8-mc1.21.3" = _ZYW5VAsD;
        "pkg-v1.8-mc1.20.2" = _X1o0sTu9;
        "pkg-v1.8-mc1.19.4" = _832kkTsD;
        "pkg-v1.8-mc1.21.1" = _6t6r7pOb;
        "pkg-v1.8.1-mc1.21.11" = _ynXMgcQ6;
        "pkg-v1.8.1-mc1.21.1" = _4eSWlb6d;
        "pkg-v1.8.1-mc1.21.4" = _kUHcmE5J;
        "pkg-v1.8.1-mc1.21.5" = _3Hw1AHEx;
        "pkg-v1.8.1-mc1.19.4" = _abPnKyAM;
        "pkg-v1.8.1-mc1.21.10" = _1ZLRFIpR;
        "pkg-v1.8.1-mc26.1.1" = _31T9xsat;
        "pkg-v1.8.1-mc1.20.2" = _RYAriXdp;
        "pkg-v1.8.1-mc1.21.3" = _U6n1geRJ;
        "pkg-v1.8.1-mc1.20.4" = _reOyCcBi;
        "pkg-v1.8.1-mc1.20.6" = _ejylI8BK;
        "pkg-v1.8.1-mc1.21.8" = _siQw9QQs;
        "pkg-v1.8.1-mc1.20.1" = _4K0qPjxu;
        "pkg-v1.8.2-mc26.1.1" = _xUXSjstk;
        "pkg-v1.8.2-mc1.20.2" = _gCOxgTne;
        "pkg-v1.8.2-mc1.21.8" = _eSWxRh0U;
        "pkg-v1.8.2-mc1.21.11" = _rVehw9jR;
        "pkg-v1.8.2-mc1.21.4" = _RbEeIphn;
        "pkg-v1.8.2-mc1.20.6" = _Sh8kAeKr;
        "pkg-v1.8.2-mc1.20.4" = _uK6p1VsC;
        "pkg-v1.8.2-mc1.21.1" = _hy7Ue49W;
        "pkg-v1.8.2-mc1.21.10" = _xLakUPNt;
        "pkg-v1.8.2-mc1.20.1" = _R5Uv9XNN;
        "pkg-v1.8.2-mc1.21.3" = _KwqPa5hv;
        "pkg-v1.8.2-mc1.19.4" = _JFaWKTEi;
        "pkg-v1.8.2-mc1.21.5" = _RAhmRwf9;
        "pkg-v1.8.3-mc1.21.11" = _6meQ0K3V;
        "pkg-v1.8.3-mc1.21.8" = _DYmDHDQ3;
        "pkg-v1.8.3-mc26.1.2" = _1CXUAY36;
        "pkg-v1.8.3-mc1.21.4" = _n3mXMiLS;
        "pkg-v1.8.3-mc26.2-snapshot-1" = _Bcv76UM2;
        "pkg-v1.8.3-mc1.20.6" = _NdkLghCA;
        "pkg-v1.8.3-mc1.21.1" = _vLxzM9yr;
        "pkg-v1.8.3-mc1.21.10" = _2GBjXDQn;
        "pkg-v1.8.3-mc1.19.4" = _xS7Ikc0v;
        "pkg-v1.8.3-mc1.21.3" = _jmEuA6Ks;
        "pkg-v1.8.3-mc1.21.5" = _owx8w3Pw;
        "pkg-v1.8.3-mc1.20.1" = _gDSoWvHN;
        "pkg-v1.8.3-mc1.20.2" = _2qR6dVkM;
        "pkg-v1.8.3-mc1.20.4" = _Y8zcT2FZ;
        "pkg-v1.8.4-mc1.19.4" = _ivS1NGfy;
        "pkg-v1.8.4-mc26.2-snapshot-2" = _CPdw0o25;
        "pkg-v1.8.4-mc1.20.1" = _qiV7kCja;
        "pkg-v1.8.4-mc1.21.3" = _l34rUfkp;
        "pkg-v1.8.4-mc26.1.2" = _q6Rusgbz;
        "pkg-v1.8.4-mc1.21.11" = _Ctef1hdz;
        "pkg-v1.8.4-mc1.21.1" = _EvxVEgfV;
        "pkg-v1.8.4-mc1.21.8" = _F5PTnxgK;
        "pkg-v1.8.4-mc1.20.4" = _7hQpDXE6;
        "pkg-v1.8.4-mc1.20.6" = _pfT8sOzE;
        "pkg-v1.8.4-mc1.21.5" = _4Mi2GTal;
        "pkg-v1.8.4-mc1.21.4" = _jOQlmMKQ;
        "pkg-v1.8.4-mc1.21.10" = _SX57iOAS;
        "pkg-v1.8.4-mc1.20.2" = _DHcxudfD;
        "pkg-v1.9-mc1.20.2" = _7b22UU9A;
        "pkg-v1.9-mc1.21.5" = _fZGkiz34;
        "pkg-v1.9-mc26.2-snapshot-4" = _t9Ii875k;
        "pkg-v1.9-mc1.20.6" = _nVehZgNI;
        "pkg-v1.9-mc1.21.3" = _l7s7vuA2;
        "pkg-v1.9-mc1.20.1" = _jBvbFm1E;
        "pkg-v1.9-mc1.19.4" = _88KR75zC;
        "pkg-v1.9-mc1.20.4" = _dttrPGXJ;
        "pkg-v1.9-mc1.21.10" = _MmZfa0Yu;
        "pkg-v1.9-mc26.1.2" = _cQE7ToYk;
        "pkg-v1.9-mc1.21.8" = _HPFUrlna;
        "pkg-v1.9-mc1.21.1" = _KHWaHYlP;
        "pkg-v1.9-mc1.21.4" = _7DfeJ3UE;
        "pkg-v1.9-mc1.21.11" = _EbqRwHEp;
        "pkg-v1.9.1-mc26.1.2" = _forSvS0D;
        "pkg-v1.9.1-mc1.20.1" = _Zy9jOku8;
        "pkg-v1.9.1-mc1.21.4" = _C19wC1X4;
        "pkg-v1.9.1-mc1.19.4" = _r5W1VR0u;
        "pkg-v1.9.1-mc1.21.8" = _3a3qkAQO;
        "pkg-v1.9.1-mc1.20.6" = _lcufvcSP;
        "pkg-v1.9.1-mc1.21.11" = _3hQiKQsw;
        "pkg-v1.9.1-mc1.21.1" = _kqobT7k2;
        "pkg-v1.9.1-mc1.20.4" = _f7kiOT6G;
        "pkg-v1.9.1-mc1.20.2" = _gqu7hGMy;
        "pkg-v1.9.1-mc1.21.5" = _qwJfPTpb;
        "pkg-v1.9.1-mc26.2-snapshot-4" = _8VQDjy5s;
        "pkg-v1.9.1-mc1.21.3" = _sBys0TTM;
        "pkg-v1.9.1-mc1.21.10" = _oXzxo3af;
        "pkg-v1.10.0-mc1.21.1" = _wyv6cEt7;
        "pkg-v1.10.0-mc26.1.2" = _sLkOJgqL;
        "pkg-v1.10.0-mc1.21.3" = _HNtidfRr;
        "pkg-v1.10.0-mc1.21.8" = _YimOWNhD;
        "pkg-v1.10.0-mc1.21.11" = _gLTQ9H6K;
        "pkg-v1.10.0-mc1.21.10" = _MUw6fF3O;
        "pkg-v1.10.0-mc1.21.5" = _xBHq7Rbu;
        "pkg-v1.10.0-mc1.20.4" = _QiOvL4Sg;
        "pkg-v1.10.0-mc1.21.4" = _txTAPJA1;
        "pkg-v1.10.0-mc26.2-snapshot-4" = _bmNQh1Y2;
        "pkg-v1.10.0-mc1.20.1" = _Vw0hwhuP;
        "pkg-v1.10.0-mc1.20.2" = _swZt6dYy;
        "pkg-v1.10.0-mc1.20.6" = _G15G4Ftr;
        "pkg-v1.10.0-mc1.19.4" = _ILnLvFez;
        "pkg-v1.10.1-mc1.20.2" = _JPIUk7WI;
        "pkg-v1.10.1-mc1.21.8" = _BKXXJRO9;
        "pkg-v1.10.1-mc1.20.4" = _GMKYBXkG;
        "pkg-v1.10.1-mc1.21.3" = _hKfIiGXa;
        "pkg-v1.10.1-mc1.20.1" = _oIeNJXLE;
        "pkg-v1.10.1-mc26.2-snapshot-8" = _fliC8HNF;
        "pkg-v1.10.1-mc1.21.11" = _UFhAUUxl;
        "pkg-v1.11.0-mc26.1.2" = _h3o3JjAw;
        "pkg-v1.11.0-mc1.21.10" = _7lYQfkdw;
        "pkg-v1.11.0-mc26.2-pre-2" = _jy3ZDqn4;
        "pkg-v1.11.0-mc1.20.4" = _K7U6iDFl;
        "pkg-v1.11.0-mc1.21.1" = _RquVmJxG;
        "pkg-v1.11.0-mc1.20.6" = _O6ySZwAd;
        "pkg-v1.11.0-mc1.21.3" = _QuMSdMTn;
        "pkg-v1.11.0-mc1.21.4" = _f3dGsGRD;
        "pkg-v1.11.0-mc1.21.5" = _6FYYJPqU;
        "pkg-v1.11.0-mc1.20.1" = _m5xmkA7o;
        "pkg-v1.11.0-mc1.19.4" = _AiJyIMyE;
        "pkg-v1.11.0-mc1.20.2" = _evNNmuhf;
        "pkg-v1.11.0-mc1.21.11" = _KU8kPSGe;
        "pkg-v1.11.0-mc1.21.8" = _PwkZljWH;
        "pkg-v1.11.1-mc1.21.8" = _Bw5EqvR9;
        "pkg-v1.11.1-mc1.20.6" = _bq6xjCYl;
        "pkg-v1.11.1-mc1.19.4" = _Wbg8aOIO;
        "pkg-v1.11.1-mc1.21.1" = _1JW6bnxl;
        "pkg-v1.11.1-mc26.1.2" = _1N5pKVss;
        "pkg-v1.11.1-mc26.2-pre-2" = _Bv0HN8u4;
        "pkg-v1.11.1-mc1.21.3" = _toulV4Jj;
        "pkg-v1.11.1-mc1.20.1" = _RARgGijl;
        "pkg-v1.11.1-mc1.20.4" = _FW3Kv7Zk;
        "pkg-v1.11.1-mc1.21.5" = _BJgufk2t;
        "pkg-v1.11.1-mc1.21.10" = _xlCgvb17;
        "pkg-v1.11.1-mc1.21.11" = _Q7fH5mHA;
        "pkg-v1.11.1-mc1.20.2" = _q8wVCGQo;
        "pkg-v1.11.1-mc1.21.4" = _yy6YVaCG;
        "pkg-v1.11.2-mc1.21.1" = _gqFpdqFp;
        "pkg-v1.11.2-mc26.1.2" = _LpZITwRr;
        "pkg-v1.11.2-mc1.21.10" = _SITNLekX;
        "pkg-v1.11.2-mc1.21.11" = _HI35EGgV;
        "pkg-v1.11.2-mc1.20.4" = _TrnEDze7;
        "pkg-v1.11.2-mc1.21.5" = _gdxztSqT;
        "pkg-v1.11.2-mc1.21.8" = _WSAqNwXL;
        "pkg-v1.11.2-mc1.20.6" = _hOFBo817;
        "pkg-v1.11.2-mc1.20.2" = _N7U1izr0;
        "pkg-v1.11.2-mc26.2-pre-2" = _D4cfygnF;
        "pkg-v1.11.2-mc1.21.3" = _HptKKiYE;
        "pkg-v1.11.2-mc1.20.1" = _WRQqnoYK;
        "pkg-v1.11.2-mc1.19.4" = _25StAwb4;
        "pkg-v1.11.2-mc1.21.4" = _LijK7uyS;
        "pkg-v1.11.3-mc1.21.8" = _1AgEJmXL;
        "pkg-v1.11.3-mc1.21.4" = _qGccKFj7;
        "pkg-v1.11.3-mc1.21.3" = _3meyOWAV;
        "pkg-v1.11.3-mc1.20.1" = _6gDATP6Q;
        "pkg-v1.11.3-mc26.1.2" = _9xREaSVG;
        "pkg-v1.11.3-mc1.21.5" = _rEFaSVz0;
        "pkg-v1.11.3-mc1.20.2" = _rYJzJcQn;
        "pkg-v1.11.3-mc1.21.11" = _sE6KO842;
        "pkg-v1.11.3-mc1.21.10" = _zjgLCO31;
        "pkg-v1.11.3-mc1.20.4" = _ECbkEHTR;
        "pkg-v1.11.3-mc26.2-pre-2" = _WE0NqJaT;
        "pkg-v1.11.3-mc1.19.4" = _oJ5ncXPp;
        "pkg-v1.11.3-mc1.20.6" = _TvuLyzB8;
        "pkg-v1.11.3-mc1.21.1" = _qhKfGMjH;
        "pkg-v1.11.4-mc1.21.10" = _AwDlxjVC;
        "pkg-v1.11.4-mc1.21.11" = _gxvUtMFe;
        "pkg-v1.11.4-mc1.20.6" = _VQP0Y37A;
        "pkg-v1.11.4-mc26.2-pre-2" = _6bffbj0n;
        "pkg-v1.11.4-mc1.19.4" = _ipFrmdYs;
        "pkg-v1.11.4-mc1.21.1" = _S4Uennjd;
        "pkg-v1.11.4-mc26.1.2" = _xyfkeDKZ;
        "pkg-v1.11.4-mc1.20.2" = _U5SyZtaT;
        "pkg-v1.11.4-mc1.20.1" = _cKjAauwb;
        "pkg-v1.11.4-mc1.21.4" = _FkpwiOZl;
        "pkg-v1.11.4-mc1.21.3" = _9qUEchkw;
        "pkg-v1.11.4-mc1.21.5" = _KqK8oAbF;
        "pkg-v1.11.4-mc1.21.8" = _ccWyws3Q;
        "pkg-v1.11.4-mc1.20.4" = _kR1tw9re;
        "pkg-v1.12.0-mc26.1.2" = _KhBGLJW1;
        "pkg-v1.12.0-mc1.20.4" = _csdI5xRf;
        "pkg-v1.12.0-mc1.21.8" = _ENRbPIyf;
        "pkg-v1.12.0-mc1.19.4" = _OMy29ljN;
        "pkg-v1.12.0-mc1.20.6" = _w3VBLA8N;
        "pkg-v1.12.0-mc1.21.10" = _92rLZ997;
        "pkg-v1.12.0-mc1.21.3" = _WJmJCKBK;
        "pkg-v1.12.0-mc1.21.11" = _m7Ze4NDX;
        "pkg-v1.12.0-mc1.21.1" = _VqgwQ654;
        "pkg-v1.12.0-mc1.20.1" = _vU3cpb9t;
        "pkg-v1.12.0-mc1.21.4" = _PXDP1JoP;
        "pkg-v1.12.0-mc26.2" = _Znft06EI;
        "pkg-v1.12.0-mc1.20.2" = _gDwknv3d;
        "pkg-v1.12.0-mc1.21.5" = _DCjQy81J;
        "pkg-v1.12.0-mc26.3-snapshot-2" = _BvMSBVkh;
        "pkg-v1.12.1-mc1.21.3" = _cguto2sB;
        "pkg-v1.12.1-mc1.20.4" = _YdbrF7Qc;
        "pkg-v1.12.1-mc1.20.2" = _V5F5iTRb;
        "pkg-v1.12.1-mc26.2" = _wkCoWNsl;
        "pkg-v1.12.1-mc26.1.2" = _ofTe6CW5;
        "pkg-v1.12.1-mc1.20.1" = _2ZQyZD2f;
        "pkg-v1.12.1-mc1.21.5" = _SQUpcW2G;
        "pkg-v1.12.1-mc1.21.1" = _4RG1YyH1;
        "pkg-v1.12.1-mc1.21.10" = _ReFU5Yhl;
        "pkg-v1.12.1-mc26.3-snapshot-2" = _7Wlyo2WH;
        "pkg-v1.12.1-mc1.19.4" = _GT1o3eQv;
        "pkg-v1.12.1-mc1.21.11" = _skkJpj18;
        "pkg-v1.12.1-mc1.21.4" = _wS7X1xfq;
        "pkg-v1.12.1-mc1.21.8" = _wI7qZv4x;
        "pkg-v1.12.1-mc1.20.6" = _QjUNMCT4;
        "pkg-v1.12.2-mc26.1.2" = _v6hJkYUs;
        "pkg-v1.12.2-mc1.20.4" = _dBaLFr4o;
        "pkg-v1.12.2-mc26.3-snapshot-2" = _Dy71vqMp;
        "pkg-v1.12.2-mc1.21.1" = _kdxJPqnF;
        "pkg-v1.12.2-mc1.21.4" = _IVOvpxBe;
        "pkg-v1.12.2-mc1.21.10" = _buu59nJx;
        "pkg-v1.12.2-mc1.21.5" = _KHLJescD;
        "pkg-v1.12.2-mc1.19.4" = _Ya49ROqf;
        "pkg-v1.12.2-mc1.21.8" = _z08sTdVF;
        "pkg-v1.12.2-mc1.20.2" = _Vd5OhGwH;
        "pkg-v1.12.2-mc1.20.1" = _N87w2aWp;
        "pkg-v1.12.2-mc1.20.6" = _5ORJh7ME;
        "pkg-v1.12.2-mc1.21.3" = _htzG0OCP;
        "pkg-v1.12.2-mc1.21.11" = _C63O2TU9;
        "pkg-v1.12.2-mc26.2" = _xhuq05sv;
        "pkg-v1.13.0-mc1.20.6" = _2kHzecvT;
        "pkg-v1.13.0-mc26.2" = _pziSGRXe;
        "pkg-v1.13.0-mc1.20.2" = _cH1pZtyf;
        "pkg-v1.13.0-mc1.19.4" = _AmTLWvvt;
        "pkg-v1.14.0-mc1.20.4" = _e5rt6KES;
        "pkg-v1.14.0-mc1.21.4" = _zJQ9EaBl;
        "pkg-v1.14.0-mc1.21.5" = _HNPMQlmt;
        "pkg-v1.14.0-mc1.20.1" = _maLeEyJt;
        "pkg-v1.14.0-mc1.21.10" = _b6TromBP;
        "pkg-v1.14.0-mc1.19.4" = _3JRvfiHp;
        "pkg-v1.14.0-mc1.21.8" = _aLVUa7Ol;
        "pkg-v1.14.0-mc1.20.2" = _CwLmsXFN;
        "pkg-v1.14.0-mc1.21.11" = _70J4avlI;
        "pkg-v1.14.0-mc1.21.1" = _MH4P5SWi;
        "pkg-v1.14.0-mc26.2" = _lD2QZflK;
        "pkg-v1.14.0-mc26.1.2" = _aYZ3kaJm;
        "pkg-v1.14.0-mc1.20.6" = _UgAsCz1v;
        "pkg-v1.14.0-mc1.21.3" = _Do0EGrq7;
        "pkg-v1.14.1-mc1.21.11" = _ZuMjJCl9;
        "pkg-v1.14.1-mc1.21.3" = _ZxJcPAeP;
        "pkg-v1.14.1-mc1.20.4" = _qPEbrAY5;
        "pkg-v1.14.1-mc1.20.2" = _mTtCjoyt;
        "pkg-v1.14.1-mc1.21.10" = _n1568DIr;
        "pkg-v1.14.1-mc26.1.2" = _oxTUUNMa;
        "pkg-v1.14.1-mc1.20.1" = _dwQVxvVK;
        "pkg-v1.14.1-mc1.19.4" = _CgMfZaP9;
        "pkg-v1.14.1-mc1.21.8" = _mXyYqjaC;
        "pkg-v1.14.1-mc26.2" = _ChLVyvpO;
        "pkg-v1.14.1-mc1.21.5" = _4xRpEuXk;
        "pkg-v1.14.1-mc1.21.4" = _HDj6XhCc;
        "pkg-v1.14.1-mc1.21.1" = _JG7wcdes;
        "pkg-v1.14.1-mc1.20.6" = _Nt6zyjWG;
        "pkg-v1.15.0-mc1.21.4" = _Ir6qOl2Z;
        "pkg-v1.15.0-mc1.20.1" = _BrWMFLj6;
        "pkg-v1.15.0-mc1.20.6" = _cSs6LXsi;
        "pkg-v1.15.0-mc1.20.4" = _1P8Hp5jf;
        "pkg-v1.15.0-mc1.19.4" = _hi0eIBTo;
        "pkg-v1.15.0-mc1.20.2" = _OpaEZx7C;
        "pkg-v1.15.0-mc1.21.5" = _3LvFvBKf;
        "pkg-v1.15.0-mc1.21.1" = _1q4Yz9Zh;
        "pkg-v1.15.0-mc26.3-snapshot-6" = _pEckAwoS;
        "pkg-v1.15.0-mc1.21.8" = _EzwdMYDA;
        "pkg-v1.15.0-mc26.2" = _XpJEyfdZ;
        "pkg-v1.15.0-mc1.21.10" = _LwuiD2uE;
        "pkg-v1.15.0-mc26.1.2" = _Sme74iyK;
        "pkg-v1.15.0-mc1.21.11" = _3k4bJZtB;
        "pkg-v1.15.0-mc1.21.3" = _HpzEC1Cz;
        "pkg-v1.16.0-mc1.21.11" = _5En4bZdi;
        "pkg-v1.16.0-mc1.20.6" = _zuE5ZU1j;
        "pkg-v1.16.0-mc1.19.4" = _M87e5c54;
        "pkg-v1.16.0-mc1.21.8" = _HjMYxJI8;
        "pkg-v1.16.0-mc1.21.10" = _D2Q9Mrx0;
        "pkg-v1.16.0-mc1.20.2" = _HVVBqE18;
        "pkg-v1.16.0-mc1.21.5" = _KWaJXHQz;
        "pkg-v1.16.0-mc26.3-snapshot-9" = _84odOIy6;
        "pkg-v1.16.0-mc26.2" = _TjGzJ5oF;
        "pkg-v1.16.0-mc1.20.4" = _fgOJVNyB;
        "pkg-v1.16.0-mc1.21.1" = _QDWRcRYr;
        "pkg-v1.16.0-mc1.21.3" = _XWLZF5oB;
        "pkg-v1.16.0-mc1.21.4" = _pVuSaQAU;
        "pkg-v1.16.0-mc1.20.1" = _HefpKs5a;
        "pkg-v1.16.0-mc26.1.2" = _TCG9DMiv;
        "pkg-v1.17.0-mc1.21.10" = _qM73KBpL;
        "pkg-v1.17.0-mc1.20.6" = _QtbdpIAt;
        "pkg-v1.17.0-mc26.3-snapshot-9" = _2vCRWAx5;
        "pkg-v1.17.0-mc1.21.5" = _iXgQgJxl;
        "pkg-v1.17.0-mc1.20.4" = _Od3Wr84P;
        "pkg-v1.17.0-mc1.21.1" = _PCnJd7uL;
        "pkg-v1.17.0-mc26.2" = _rBYpAMDr;
        "pkg-v1.17.0-mc26.1.2" = _nan3zBNJ;
        "pkg-v1.17.0-mc1.20.2" = _FClOqOEp;
        "pkg-v1.17.0-mc1.21.3" = _4yRI1R2x;
        "pkg-v1.17.0-mc1.21.4" = _rRrLqpf0;
        "pkg-v1.17.0-mc1.21.8" = _iPu6nvpN;
        "pkg-v1.17.0-mc1.19.4" = _NZm0F13I;
        "pkg-v1.17.0-mc1.20.1" = _EkubeF1I;
        "pkg-v1.17.0-mc1.21.11" = _5FWn1v3L;
        "pkg-v1.17.1-mc1.20.4" = _EvSHCyB3;
        "pkg-v1.17.1-mc1.20.6" = _Zv4rY8Bu;
        "pkg-v1.17.1-mc1.20.2" = _gtbabdf2;
        "pkg-v1.17.1-mc1.21.8" = _cQbAFRoG;
        "pkg-v1.17.1-mc1.21.5" = _DOh3zuzt;
        "pkg-v1.17.1-mc1.21.3" = _nDAfakLx;
        "pkg-v1.17.1-mc1.19.4" = _sHllPvXu;
        "pkg-v1.17.1-mc1.20.1" = _QhqNumpI;
        "pkg-v1.17.1-mc26.2" = _88pZ4TXr;
        "pkg-v1.17.1-mc26.3-snapshot-9" = _PBidEG57;
        "pkg-v1.17.1-mc1.21.1" = _JBQKAWKu;
        "pkg-v1.17.1-mc1.21.4" = _HNzLVevw;
