...
let
    ...
    in {
        ...
        "pkg-1.11-R3" = _edmGoLQ8;
        "pkg-1.12-R4" = _HKGddWKG;
        "pkg-1.13-R4" = _d3BK3X2N;
        "pkg-1.14-R4" = _JJ9PpKr5;
        "pkg-1.15-R7" = _TdFidhJw;
        "pkg-1.16-R16" = _G42Pl5Wl;
        "pkg-1.17-R9" = _D2lt7mSl;
        "pkg-1.18-R4" = _cYcvavSQ;
        "pkg-1.19-R1" = _UEnmUF3L;
        "pkg-1.19.3-R2" = _wUZEYWvD;
        "pkg-1.19.4-R1" = _y5CESItl;
        "pkg-1.19.4-R2" = _xHQgdRXt;
        "pkg-MC1.20-R1_DEV230610-1" = _AfMaw25l;
        "pkg-MC1.20-R1_ALPHA1" = _ko7oZSYH;
        "pkg-MC1.20-R1_BETA1" = _hFFqL7wp;
        "pkg-MC1.20-R1_BETA2" = _nJx3MGF4;
        "pkg-MC1.20-R1_RC1" = _UxTNI9U8;
        "pkg-MC1.20-R1_RC2" = _Ioiko6aX;
        "pkg-MC1.20-R1" = _e9AxePbZ;
        "pkg-MC1.20-R2" = _It5zPkv5;
        "pkg-MC1.20-R3_BETA1" = _cArfOV8Z;
        "pkg-MC1.21-R1_BETA1" = _XBwSWcer;
