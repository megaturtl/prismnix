...
let
    versions = (let
        ...
        _5cl07EVK = {
            "id" = "5cl07EVK";
            "file" = "seasonhud-fabric-1.16.5-2.0.9.jar";
            "hash" = "sha512-pX5RyfmCOYRUuVZMulACFRpMHzD6MFGkQaPH7Btgtk32Dr+6G/1PTyWhwIPfG6KflhQOWlteZC0h1Lx0YJzbeA==";
        };
        _zWKr5MBp = {
            "id" = "zWKr5MBp";
            "file" = "seasonhud-fabric-1.18.2-2.0.9.jar";
            "hash" = "sha512-gFz/HH9/nCW5LxnFUsD+jfLcHJxpQT4lSMh2bozbTleC+GfVTTn9gngIQ6wvEG2THST2r0zFrRxiiWd3oCQXYw==";
        };
        _Rp06lxdW = {
            "id" = "Rp06lxdW";
            "file" = "seasonhud-fabric-1.19.2-2.0.9.jar";
            "hash" = "sha512-Xz1OAZFtROiaeU5v5xUcfe2X+Q7VGaQe4wmDyuQAkPfPFllRtiaS2g8NmZJIbOu0dt3RDdk8xv3TW6J20fwkGg==";
        };
        _gy3Yep5K = {
            "id" = "gy3Yep5K";
            "file" = "seasonhud-fabric-1.20.1-2.0.9.jar";
            "hash" = "sha512-qs/MFIMXwpfzb1yvT09V3wNT3SkJven/RjPOB2JlySpdKU6YdeuAJlW5vngqJvulJ1glaKXnVMommTD0C2w3CQ==";
        };
        _gIBUoXmx = {
            "id" = "gIBUoXmx";
            "file" = "seasonhud-fabric-1.21.1-2.0.9.jar";
            "hash" = "sha512-9vWO026xjDEp4cPdeVBRB0jNU14lV9lhSLliLohdd87P6/kcEatIHug3v7QjAsiXLUkoqJlFtntiQrMbjkgMGw==";
        };
        _IvuyTcFw = {
            "id" = "IvuyTcFw";
            "file" = "seasonhud-fabric-26.1.2-2.0.9.jar";
            "hash" = "sha512-QEjZ0cLKxnwBAloVgWNVxH09dGcop9MF6LTiydCsY6ggJgRZr1Rsl5u47FIOQ2P2cW8jyjXc1kirWgdCcdmIQg==";
        };
        _WRXvRFZj = {
            "id" = "WRXvRFZj";
            "file" = "seasonhud-fabric-26.2-2.0.9.jar";
            "hash" = "sha512-qI+8sJM7xYuuEWCtbtzTXeuXKvMSYZhpz62visnU2Pm16UuRi42xZSO8zzoa5zvNWdc6eEWqws5MefQAc+PP2Q==";
        };
        _xuBSKpxi = {
            "id" = "xuBSKpxi";
            "file" = "seasonhud-fabric-1.16.5-2.0.10.jar";
            "hash" = "sha512-uWkU94GLSYRbl3x+lQH2JnyjWm4aFXqwHj/x6PCOreXJaK+BKVClDl7Hsjaif/AS2Bw8P4b/2HdcJ61mwRlZ9A==";
        };
        _eFZemFis = {
            "id" = "eFZemFis";
            "file" = "seasonhud-fabric-1.18.2-2.0.10.jar";
            "hash" = "sha512-RVMyaarYKUK5AWBZpJGCWPKFQkKWP/l98ykKS7f8494WAgIVfRnJMU6BWS12+etO3U8pW2ZW5ehgb59YRZyuxg==";
        };
        _ezmPd1mS = {
            "id" = "ezmPd1mS";
            "file" = "seasonhud-fabric-1.19.2-2.0.10.jar";
            "hash" = "sha512-NMuReoOgHYFs7QzGKJsJvLhByGh5jocvEuYESjc6KQ315XA8aaMfhKHrs3dwK0tSDe1gwi7CmjoUTl5CnSjUtw==";
        };
        _hAxCCLfa = {
            "id" = "hAxCCLfa";
            "file" = "seasonhud-fabric-1.20.1-2.0.10.jar";
            "hash" = "sha512-UpjI2fgQLp75u47+1RBIX14Dfjkm0BQ7rVO5X6BRvLCKt6v1GRqh0bpjC4arre3SHDWIwuimBUKaIRYg7x7RDQ==";
        };
        _Nb3re6ER = {
            "id" = "Nb3re6ER";
            "file" = "seasonhud-fabric-1.21.1-2.0.10.jar";
            "hash" = "sha512-7Zd6+A8EV3C/UXln43PJO2dNuYWMlVz2hDpiTmrVyzfFKmYGoZLYy/DCeONeHQW4KhSXBs+fff0F3DrhXXL+7A==";
        };
        _HpY9q5jf = {
            "id" = "HpY9q5jf";
            "file" = "seasonhud-fabric-26.1.2-2.0.10.jar";
            "hash" = "sha512-iXO47fU02BAdwCb2TDkUznyXoUTV7bGd/BSmhdcy9ykYVJuE5Yp7eMJKWA1G4PDunju2Qj3F3hwXxbCXe3Qx9A==";
        };
        _zyGn2zMx = {
            "id" = "zyGn2zMx";
    ...
    in {
        ...
        "fabric-1.20.1" = _hAxCCLfa;
        "fabric-1.20.2" = _ipreEN8x;
        "fabric-1.18.2" = _eFZemFis;
        "fabric-1.19.3" = _ezmPd1mS;
        "fabric-1.20.4" = _KyAHi4LY;
        "fabric-1.20.3" = _ipreEN8x;
        "fabric-1.20.5" = _1uHocy6f;
        "fabric-1.20.6" = _1uHocy6f;
        "fabric-1.21" = _Nb3re6ER;
        "fabric-1.16.5" = _xuBSKpxi;
        "fabric-1.21.1" = _Nb3re6ER;
        ...
        "pkg-1.19.4-1.5.0" = _Ul7jsFn0;
        "pkg-1.19.4-1.5.1" = _rVTUdXCX;
        "pkg-1.19.2-1.5.1" = _rKGEXUa7;
        "pkg-fabric-1.20.1-1.5.1" = _Qxs60KhK;
        "pkg-1.19.2-1.5.2" = _jF1wfJtD;
        "pkg-1.19.4-1.5.2" = _WUT3Ewkq;
        "pkg-fabric-1.20.1-1.5.2" = _jRPJV9eJ;
        "pkg-1.19.2-1.5.3" = _NajDURDw;
        "pkg-1.19.4-1.5.3" = _jncnshwB;
        "pkg-fabric-1.20.1-1.5.3" = _bQjORbnD;
        "pkg-1.19.2-1.5.4" = _OJmRj8n0;
        "pkg-1.19.4-1.5.4" = _K6wF3JnJ;
        "pkg-fabric-1.20.1-1.5.4" = _J37VNdNM;
        "pkg-1.19.2-1.5.5" = _4CiTmFwQ;
        "pkg-1.19.4-1.5.5" = _YB8kCOJA;
        "pkg-fabric-1.20.1-1.5.5" = _M9sVefZa;
        "pkg-1.19.4-1.5.6" = _ZltE5Mcj;
        "pkg-1.19.2-1.5.6" = _pqC8USTD;
        "pkg-fabric-1.20.1-1.5.6" = _vHMsJOw4;
        "pkg-1.20.1-1.5.7" = _F8DOnIw2;
        "pkg-1.19.2-1.5.8" = _SnxUsR5R;
        "pkg-1.19.4-1.5.8" = _2WHTxMdD;
        "pkg-1.20.1-1.5.8" = _1YqaOUwD;
        "pkg-1.19.2-1.5.9" = _vYrNNcx4;
        "pkg-1.19.4-1.5.9" = _XxBrSVWK;
        "pkg-1.20.1-1.5.9" = _nTfBYmZ4;
        "pkg-1.20.2-1.5.9" = _nL5mFGfY;
        "pkg-1.19.2-1.5.10" = _71O1cucb;
        "pkg-1.19.4-1.5.10" = _7khIDapI;
        "pkg-1.20.1-1.5.10" = _Llc1VfXa;
        "pkg-1.20.2-1.5.10" = _K4LM9ODC;
        "pkg-1.19.2-1.5.11" = _nXWQ7juh;
        "pkg-1.19.4-1.5.11" = _kqNie3O7;
        "pkg-1.20.1-1.5.11" = _Rnd544so;
        "pkg-1.20.2-1.5.11" = _3CJ3WFa8;
        "pkg-1.19.2-1.5.12" = _dcVIb5s1;
        "pkg-1.19.4-1.5.12" = _wnAiVhX1;
        "pkg-1.20.1-1.5.12" = _ve7pHKwe;
        "pkg-1.20.2-1.5.12" = _Bo8L8yzS;
        "pkg-1.19.2-1.5.13" = _TV7cxYMy;
        "pkg-1.19.4-1.5.13" = _fXUpZz4C;
        "pkg-1.20.1-1.5.13" = _xX8BVZuH;
        "pkg-1.20.2-1.5.13" = _MIrPF286;
        "pkg-1.19.2-1.6.0" = _b5wIzASR;
        "pkg-1.19.4-1.6.0" = _nbopHAed;
        "pkg-1.20.1-1.6.0" = _2ZIbe0To;
        "pkg-1.20.2-1.6.0" = _kP7ucJMC;
        "pkg-1.19.2-1.6.1" = _Qu6Ceyv0;
        "pkg-1.19.4-1.6.1" = _1Og0uQO3;
        "pkg-1.20.1-1.6.1" = _LPONg3z1;
        "pkg-1.20.2-1.6.1" = _zSvjgES7;
        "pkg-1.19.2-1.6.2" = _FnhwFA5j;
        "pkg-1.19.4-1.6.2" = _2G5fSIoQ;
        "pkg-1.20.1-1.6.2" = _REZLUHL8;
        "pkg-1.20.2-1.6.2" = _FD2EIov6;
        "pkg-1.18.2-1.6.3" = _Keen1p49;
        "pkg-1.19.2-1.6.3" = _yuL2LOVc;
        "pkg-1.20.1-1.6.3" = _QeCcrJB0;
        "pkg-1.20.2-1.6.3" = _mKXavJdd;
        "pkg-1.18.2-1.6.4" = _ISwtIruC;
        "pkg-1.19.2-1.6.4" = _1IBMWkO2;
        "pkg-1.20.1-1.6.4" = _jPkIVCiI;
        "pkg-1.20.2-1.6.4" = _gtlcVW5k;
        "pkg-1.18.2-1.7.0" = _HiG5MdUv;
        "pkg-1.20.1-1.7.0" = _dAGOcmpR;
        "pkg-1.20.2-1.7.0" = _IMerEpkh;
        "pkg-1.19.2-1.7.0" = _eGVL2Jux;
        "pkg-1.18.2-1.7.1" = _95LHSbmh;
        "pkg-1.19.2-1.7.1" = _4W7kEkc2;
        "pkg-1.20.1-1.7.1" = _Dra7ye9G;
        "pkg-1.20.2-1.7.1" = _tYrcBLA2;
        "pkg-1.18.2-1.7.2" = _IAHPRxRt;
        "pkg-1.19.2-1.7.2" = _X1QSoUTq;
        "pkg-1.20.1-1.7.2" = _O0X37Y1v;
        "pkg-1.20.2-1.7.2" = _9u1JLxOt;
        "pkg-1.18.2-1.7.3" = _iwVC2uAk;
        "pkg-1.19.2-1.7.3" = _qjXYFDgv;
        "pkg-1.20.1-1.7.3" = _5pgRy3kx;
        "pkg-1.20.2-1.7.3" = _ZkkTbtdI;
        "pkg-1.18.2-1.7.4" = _Xn9o2fQt;
        "pkg-1.19.2-1.7.4" = _T8sDm6lO;
        "pkg-1.20.1-1.7.4" = _Gq3SHGqh;
        "pkg-1.20.2-1.7.4" = _r4cOo1lt;
        "pkg-1.18.2-1.7.5" = _lMHkZA1G;
        "pkg-1.19.2-1.7.5" = _7Zl59fPV;
        "pkg-1.20.1-1.7.5" = _i48gZPJr;
        "pkg-1.20.2-1.7.5" = _csLU2Jjd;
        "pkg-1.18.2-1.7.6" = _xsiHaXlz;
        "pkg-1.19.2-1.7.6" = _9mnIJEA1;
        "pkg-1.20.1-1.7.6" = _natLm4x6;
        "pkg-1.20.2-1.7.6" = _ivPA3lPo;
        "pkg-1.18.2-1.7.7" = _jSoCPHFA;
        "pkg-1.19.2-1.7.7" = _XyFjXzkd;
        "pkg-1.20.1-1.7.7" = _JzEQLX55;
        "pkg-1.20.2-1.7.7" = _X37gdaDW;
        "pkg-1.18.2-1.7.8" = _lk1v9nwj;
        "pkg-1.19.2-1.7.8" = _d3KOhESd;
        "pkg-1.20.1-1.7.8" = _oMFmKwYF;
        "pkg-1.20.2-1.7.8" = _xXU73O5v;
        "pkg-1.18.2-1.7.9" = _YVTW566M;
        "pkg-1.19.2-1.7.9" = _3YYO9Wow;
        "pkg-1.20.1-1.7.9" = _AgELHJry;
        "pkg-1.20.2-1.7.9" = _xH7qZfEM;
        "pkg-1.18.2-1.7.10" = _LLeTCIJF;
        "pkg-1.19.2-1.7.10" = _Y911udP3;
        "pkg-1.20.1-1.7.10" = _vaxAmgXE;
        "pkg-1.20.2-1.7.10" = _EECRxLoK;
        "pkg-1.20.4-1.7.10" = _80vMtLwi;
        "pkg-1.18.2-1.7.11" = _YHsnpB5H;
        "pkg-1.19.2-1.7.11" = _8uX0q5l8;
        "pkg-1.20.1-1.7.11" = _Riz2MNYQ;
        "pkg-1.20.2-1.7.11" = _yv7Jr1Wp;
        "pkg-1.20.4-1.7.11" = _xllVPp5y;
        "pkg-1.18.2-1.7.12" = _vf0PRNwo;
        "pkg-1.19.2-1.7.12" = _DqX7Bz3R;
        "pkg-1.20.1-1.7.12" = _B9HBfhR0;
        "pkg-1.20.2-1.7.12" = _MD7sXrhW;
        "pkg-1.20.4-1.7.12" = _SBjcTMGE;
        "pkg-1.18.2-1.7.13" = _yOMp11Cr;
        "pkg-1.19.2-1.7.13" = _6DbHjiZZ;
        "pkg-1.20.1-1.7.13" = _t9ARKIHn;
        "pkg-1.20.2-1.7.13" = _wcDWjWKT;
        "pkg-1.20.4-1.7.13" = _IJXiUraD;
        "pkg-1.18.2-1.7.14" = _XNmNRopj;
        "pkg-1.19.2-1.7.14" = _lGmzwo5L;
        "pkg-1.20.1-1.7.14" = _aFZceadW;
        "pkg-1.20.2-1.7.14" = _6OyoWb6V;
        "pkg-1.20.4-1.7.14" = _uflFMUC5;
        "pkg-1.18.2-1.7.15" = _ztdVk4H9;
        "pkg-1.19.2-1.7.15" = _ajRrKNWz;
        "pkg-1.20.1-1.7.15" = _p3CJQq2e;
        "pkg-1.20.2-1.7.15" = _tgIvYPA7;
        "pkg-1.20.4-1.7.15" = _UJu2zYoY;
        "pkg-1.18.2-1.7.16" = _So6CsNik;
        "pkg-1.19.2-1.7.16" = _CTBj0Enm;
        "pkg-1.20.1-1.7.16" = _Cooj0g9G;
        "pkg-1.20.2-1.7.16" = _C4PX6VXx;
        "pkg-1.20.4-1.7.16" = _ypyrywh0;
        "pkg-1.18.2-1.7.17" = _UOYB5Msw;
        "pkg-1.19.2-1.7.17" = _hjfDaQtU;
        "pkg-1.20.1-1.7.17" = _lmWSVNPG;
        "pkg-1.20.4-1.7.17" = _RRjIvgZr;
        "pkg-1.20.2-1.7.17" = _ocSjHlYO;
        "pkg-1.18.2-1.7.18" = _1cMohzsO;
        "pkg-1.19.2-1.7.18" = _l7tNNiAn;
        "pkg-1.20.1-1.7.18" = _GqOgQXeh;
        "pkg-1.20.2-1.7.18" = _aEPX074W;
        "pkg-1.20.4-1.7.18" = _yjb85sf9;
        "pkg-1.18.2-1.7.19" = _w9QAtrBS;
        "pkg-1.19.2-1.7.19" = _oyoeh9x0;
        "pkg-1.20.1-1.7.19" = _nqBQIQl4;
        "pkg-1.20.2-1.7.19" = _3u4jbuWi;
        "pkg-1.20.4-1.7.19" = _LII1TNWr;
        "pkg-1.20.6-1.7.19" = _K9KMxHWu;
        "pkg-1.18.2-1.8.0" = _qsAHRwoY;
        "pkg-1.19.2-1.8.0" = _p4CMRue2;
        "pkg-1.20.1-1.8.0" = _hyks8Kms;
        "pkg-1.20.2-1.8.0" = _Oz7sXSgS;
        "pkg-1.20.4-1.8.0" = _lDRwTWvz;
        "pkg-1.20.6-1.8.0" = _rkNpPpQb;
        "pkg-1.18.2-1.8.1" = _pQecK4R8;
        "pkg-1.19.2-1.8.1" = _gOAue1vs;
        "pkg-1.20.1-1.8.1" = _nVcsC8vc;
        "pkg-1.20.2-1.8.1" = _LrXrVYtN;
        "pkg-1.20.6-1.8.1" = _jEgcoDl3;
        "pkg-1.18.2-1.8.2" = _y8tWNUN6;
        "pkg-1.19.2-1.8.2" = _hb4kraQW;
        "pkg-1.20.1-1.8.2" = _kNHPN2v9;
        "pkg-1.20.2-1.8.2" = _w13XO35l;
        "pkg-1.20.4-1.8.2" = _CQq82Zy8;
        "pkg-1.20.6-1.8.2" = _Uy6ONRsD;
        "pkg-1.18.2-1.8.3" = _C12J4NBO;
        "pkg-1.19.2-1.8.3" = _YLOkaE39;
        "pkg-1.20.1-1.8.3" = _ACc2ZvUd;
        "pkg-1.20.2-1.8.3" = _G2ViJINE;
        "pkg-1.20.4-1.8.3" = _XA3YAWHR;
        "pkg-1.20.6-1.8.3" = _kBeirmhO;
        "pkg-1.18.2-1.8.4" = _tTIHG482;
        "pkg-1.19.2-1.8.4" = _r68NkYmV;
        "pkg-1.20.1-1.8.4" = _fKlyIoT4;
        "pkg-1.20.4-1.8.4" = _ZFkBRDlq;
        "pkg-1.20.2-1.8.4" = _Zt8CIOAL;
        "pkg-1.20.6-1.8.4" = _aPYdL3EY;
        "pkg-1.21-1.8.4" = _5giFdFSi;
        "pkg-1.18.2-1.8.5" = _z0zErokn;
        "pkg-1.19.2-1.8.5" = _zK92X07G;
        "pkg-1.20.1-1.8.5" = _sGMhKy4l;
        "pkg-1.20.2-1.8.5" = _yOya8cWB;
        "pkg-1.20.4-1.8.5" = _3IJRagL5;
        "pkg-1.20.6-1.8.5" = _QHFCP2Fk;
        "pkg-1.21-1.8.5" = _GwEMmBUF;
        "pkg-1.18.2-1.8.6" = _Nqnthaaq;
        "pkg-1.19.2-1.8.6" = _BBrNNvZe;
        "pkg-1.20.1-1.8.6" = _hAU59adQ;
        "pkg-1.20.2-1.8.6" = _XO7DWxPE;
        "pkg-1.20.4-1.8.6" = _h55AG76v;
        "pkg-1.20.6-1.8.6" = _74PB6zts;
        "pkg-1.21-1.8.6" = _yCv2WtF3;
        "pkg-1.18.2-1.8.7" = _ES3WT19x;
        "pkg-1.19.2-1.8.7" = _vNxXGNbp;
        "pkg-1.20.1-1.8.7" = _pmNfea68;
        "pkg-1.20.2-1.8.7" = _ESHZZigt;
        "pkg-1.20.4-1.8.7" = _ZHEvTwi4;
        "pkg-1.20.6-1.8.7" = _kP1qUEIl;
        "pkg-1.21-1.8.7" = _o5oHwU2J;
        "pkg-1.18.2-1.8.8" = _ioYovqLO;
        "pkg-1.19.2-1.8.8" = _bCKrlGdH;
        "pkg-1.20.1-1.8.8" = _9gXICJXi;
        "pkg-1.20.2-1.8.8" = _U3IahHAL;
        "pkg-1.20.4-1.8.8" = _GubxVpX8;
        "pkg-1.20.6-1.8.8" = _ucPmCKc4;
        "pkg-1.21-1.8.8" = _Dak30FZG;
        "pkg-1.18.2-1.8.9" = _mViGrqp3;
        "pkg-1.19.2-1.8.9" = _jWGN1o8V;
        "pkg-1.20.1-1.8.9" = _FlOmXw0L;
        "pkg-1.20.2-1.8.9" = _kROi2E2f;
        "pkg-1.20.4-1.8.9" = _akLKFaHZ;
        "pkg-1.20.6-1.8.9" = _GuyAZDwi;
        "pkg-1.21-1.8.9" = _nXn8vSWh;
        "pkg-1.18.2-1.9.0" = _8FwWRE1c;
        "pkg-1.19.2-1.9.0" = _SiWs9wf2;
        "pkg-1.20.1-1.9.0" = _LrUKphAQ;
        "pkg-1.20.2-1.9.0" = _MuQjyzhH;
        "pkg-1.20.4-1.9.0" = _UMgVaYKo;
        "pkg-1.20.6-1.9.0" = _KyUx5mhz;
        "pkg-1.21-1.9.0" = _JoebHhVg;
        "pkg-1.18.2-1.9.1" = _GuAjCr0L;
        "pkg-1.19.2-1.9.1" = _HP6jy8Xg;
        "pkg-1.20.1-1.9.1" = _4Yn638Ub;
        "pkg-1.20.2-1.9.1" = _psxofF4S;
        "pkg-1.20.4-1.9.1" = _KTvfQ7g7;
        "pkg-1.20.6-1.9.1" = _fHpieMWZ;
        "pkg-1.21-1.9.1" = _MvFUaeFI;
        "pkg-1.18.2-1.9.2" = _TewIuwJp;
        "pkg-1.19.2-1.9.2" = _2v6jptLL;
        "pkg-1.20.2-1.9.2" = _Cz17xIQT;
        "pkg-1.20.4-1.9.2" = _Y8cG3XpE;
        "pkg-1.20.6-1.9.2" = _eYTlF7lW;
        "pkg-1.21-1.9.2" = _GD32Rlqn;
        "pkg-1.20.1-1.9.2" = _3sfYkhyE;
        "pkg-1.18.2-1.9.3" = _O5ui63s0;
        "pkg-1.19.2-1.9.3" = _LPaXZHw2;
        "pkg-1.20.1-1.9.3" = _AagCVSzt;
        "pkg-1.20.2-1.9.3" = _128lbDId;
        "pkg-1.20.4-1.9.3" = _OeDJYAun;
        "pkg-1.20.6-1.9.3" = _8m4uhXWp;
        "pkg-1.21-1.9.3" = _1rHgs30D;
        "pkg-1.18.2-1.9.4" = _CMKy7Pie;
        "pkg-1.19.2-1.9.4" = _M94lcdSY;
        "pkg-1.20.1-1.9.4" = _LjhmtSOk;
        "pkg-1.20.2-1.9.4" = _Y1pdOahC;
        "pkg-1.20.4-1.9.4" = _613qhVpS;
        "pkg-1.20.6-1.9.4" = _unhHG1JT;
        "pkg-1.21-1.9.4" = _WPdq7zzK;
        "pkg-1.18.2-1.9.5" = _dndV4P2w;
        "pkg-1.19.2-1.9.5" = _P66A4vVi;
        "pkg-1.20.1-1.9.5" = _f7qSQ59x;
        "pkg-1.20.2-1.9.5" = _1NZVP7rC;
        "pkg-1.20.4-1.9.5" = _QkRO1eip;
        "pkg-1.20.6-1.9.5" = _2WNdUQ5u;
        "pkg-1.21-1.9.5" = _gcmrOC7c;
        "pkg-1.18.2-1.9.6" = _osa6J5ag;
        "pkg-1.19.2-1.9.6" = _OoJ6Q9bG;
        "pkg-1.20.1-1.9.6" = _wkfWQUBY;
        "pkg-1.20.2-1.9.6" = _ivss8nfE;
        "pkg-1.20.4-1.9.6" = _70By7yYj;
        "pkg-1.20.6-1.9.6" = _Svtcjn0M;
        "pkg-1.21-1.9.6" = _61nlikS8;
        "pkg-1.18.2-1.9.7" = _Ipi7mQgl;
        "pkg-1.19.2-1.9.7" = _ctsv7BYG;
        "pkg-1.20.1-1.9.7" = _SAKz4Afh;
        "pkg-1.20.2-1.9.7" = _BpwU9nLu;
        "pkg-1.20.4-1.9.7" = _m7nB11cA;
        "pkg-1.20.6-1.9.7" = _NHPvrP1r;
        "pkg-1.21-1.9.7" = _b8tegalb;
        "pkg-1.18.2-1.9.8" = _CUDigluQ;
        "pkg-1.19.2-1.9.8" = _GKFu28hA;
        "pkg-1.20.1-1.9.8" = _7FtW9NIl;
        "pkg-1.20.2-1.9.8" = _ipreEN8x;
        "pkg-1.20.4-1.9.8" = _KyAHi4LY;
        "pkg-1.20.6-1.9.8" = _1uHocy6f;
        "pkg-1.21-1.9.8" = _YqEy8xIL;
        "pkg-1.16.5-1.10.0" = _KxkDNAPc;
        "pkg-1.18.2-1.10.0" = _TpYu0DG0;
        "pkg-1.19.2-1.10.0" = _atL7xJdO;
        "pkg-1.20.1-1.10.0" = _p60CzJ6Q;
        "pkg-1.21.1-1.10.0" = _aW01wzEH;
        "pkg-1.16.5-1.10.1" = _3yjV4ju7;
        "pkg-1.18.2-1.10.1" = _15nXPtZ3;
        "pkg-1.19.2-1.10.1" = _Z482BacA;
        "pkg-1.20.1-1.10.1" = _KFyfC8Up;
        "pkg-1.21.1-1.10.1" = _pT5NdPaV;
        "pkg-1.16.5-1.10.2" = _lreL2bjr;
        "pkg-1.18.2-1.10.2" = _5UQXR9Ob;
        "pkg-1.19.2-1.10.2" = _BeZufQIe;
        "pkg-1.20.1-1.10.2" = _3KtFNJN1;
        "pkg-1.21.1-1.10.2" = _npncKmON;
        "pkg-1.16.5-1.10.3" = _CH1Pes6o;
        "pkg-1.18.2-1.10.3" = _icxsI6I3;
        "pkg-1.19.2-1.10.3" = _QgmJ9cao;
        "pkg-1.20.1-1.10.3" = _fp6wv0KM;
        "pkg-1.21.1-1.10.3" = _oZF7Aun5;
        "pkg-1.16.5-1.10.4" = _tcwheB0I;
        "pkg-1.18.2-1.10.4" = _z2mK88Li;
        "pkg-1.19.2-1.10.4" = _CDEFv8cf;
        "pkg-1.20.1-1.10.4" = _UqX6dLgO;
        "pkg-1.21.1-1.10.4" = _DhJRldSw;
        "pkg-1.16.5-1.10.6" = _5LNOiA7S;
        "pkg-1.18.2-1.10.6" = _JtiVkloF;
        "pkg-1.19.2-1.10.6" = _7rYsL1uS;
        "pkg-1.20.1-1.10.6" = _DwC4dcfE;
        "pkg-1.21.1-1.10.6" = _T92fxFwH;
        "pkg-1.18.2-1.10.7" = _RJ13pgVK;
        "pkg-1.16.5-1.10.7" = _ZWWsXZsy;
        "pkg-1.19.2-1.10.7" = _G5Y0bq42;
        "pkg-1.20.1-1.10.7" = _SE3tmlmm;
        "pkg-1.21.1-1.10.7" = _UgmZGsx2;
        "pkg-1.16.5-1.10.8" = _cmmfpZew;
        "pkg-1.18.2-1.10.8" = _zcF43qhp;
        "pkg-1.19.2-1.10.8" = _AEYusGeJ;
        "pkg-1.20.1-1.10.8" = _u5Cz1UKY;
        "pkg-1.21.1-1.10.8" = _Dsfo11Kl;
        "pkg-1.16.5-1.10.9" = _70tn6wYn;
        "pkg-1.18.2-1.10.9" = _UF1iQEve;
        "pkg-1.19.2-1.10.9" = _auu7mevJ;
        "pkg-1.20.1-1.10.9" = _mkGjYKXb;
        "pkg-1.21.1-1.10.9" = _FmPbgv1T;
        "pkg-1.16.5-1.11.0" = _HB7YUCvh;
        "pkg-1.18.2-1.11.0" = _NbNvdKkT;
        "pkg-1.19.2-1.11.0" = _afv3rMzT;
        "pkg-1.20.1-1.11.0" = _CoN5UbdS;
        "pkg-1.21.1-1.11.0" = _XLaX9sLH;
        "pkg-1.16.5-1.11.1" = _Gk7RfLJD;
        "pkg-1.18.2-1.11.1" = _gYzzgBz9;
        "pkg-1.19.2-1.11.1" = _viK6RVi3;
        "pkg-1.20.1-1.11.1" = _wPnDKGwG;
        "pkg-1.21.1-1.11.1" = _N7NJoH40;
        "pkg-1.16.5-1.11.2" = _i6BHMYAX;
        "pkg-1.18.2-1.11.2" = _IHQM1eK7;
        "pkg-1.19.2-1.11.2" = _Pgv2Fv9O;
        "pkg-1.20.1-1.11.2" = _siqKC1YI;
        "pkg-1.21.1-1.11.2" = _t6jEfEJA;
        "pkg-1.16.5-1.11.3" = _EVRfxjnb;
        "pkg-1.18.2-1.11.3" = _CFUkeSLN;
        "pkg-1.19.2-1.11.3" = _VG2X70dQ;
        "pkg-1.20.1-1.11.3" = _lq9GLNRK;
        "pkg-1.21.1-1.11.3" = _BxDRPZKc;
        "pkg-1.16.5-1.11.4" = _rNfDxzYb;
        "pkg-1.18.2-1.11.4" = _bSlkSCxp;
        "pkg-1.19.2-1.11.4" = _AVCUgOMv;
        "pkg-1.20.1-1.11.4" = _nEHdt9AP;
        "pkg-1.21.1-1.11.4" = _KLnQaIP9;
        "pkg-1.16.5-1.11.5" = _WdvAYKG7;
        "pkg-1.18.2-1.11.5" = _reIUJDtV;
        "pkg-1.19.2-1.11.5" = _qXqbuvCB;
        "pkg-1.20.1-1.11.5" = _sEp0s1oE;
        "pkg-1.21.1-1.11.5" = _9DUGzoOM;
        "pkg-1.16.5-1.11.6" = _rNIIdjdP;
        "pkg-1.18.2-1.11.6" = _p378ZB6Y;
        "pkg-1.19.2-1.11.6" = _yRYjOcNz;
        "pkg-1.20.1-1.11.6" = _Y9YADXQ8;
        "pkg-1.21.4-1.11.6" = _Zlh88xlG;
        "pkg-1.16.5-1.11.7" = _PGg1rVZ0;
        "pkg-1.18.2-1.11.7" = _9cUBuY98;
        "pkg-1.19.2-1.11.7" = _K8sFuPd1;
        "pkg-1.20.1-1.11.7" = _k6DeIy0y;
        "pkg-1.21.4-1.11.7" = _TlcxlQuC;
        "pkg-1.16.5-1.12.0" = _oXu88FnT;
        "pkg-1.18.2-1.12.0" = _IamXPzA3;
        "pkg-1.19.2-1.12.0" = _SW3ZVffu;
        "pkg-1.20.1-1.12.0" = _er1t1i7l;
        "pkg-1.21.4-1.12.0" = _1LkRE9pw;
        "pkg-1.16.5-1.12.1" = _bJtUJMdd;
        "pkg-1.18.2-1.12.1" = _bT1LBoGy;
        "pkg-1.19.2-1.12.1" = _xqEu7Gh4;
        "pkg-1.20.1-1.12.1" = _dCXkT1rh;
        "pkg-1.21.4-1.12.1" = _veqjM3sb;
        "pkg-1.16.5-1.12.2" = _4DbLuQX2;
        "pkg-1.18.2-1.12.2" = _S4V6wsaD;
        "pkg-1.19.2-1.12.2" = _u5gLJLI7;
        "pkg-1.20.1-1.12.2" = _3iAL1JTw;
        "pkg-1.21.4-1.12.2" = _3yscD9vF;
        "pkg-1.16.5-1.12.3" = _dLr2GVGc;
        "pkg-1.18.2-1.12.3" = _Ir7T5jjS;
        "pkg-1.19.2-1.12.3" = _B23KhzPz;
        "pkg-1.20.1-1.12.3" = _Ijdd27v2;
        "pkg-1.21.4-1.12.3" = _sZgrbYNa;
        "pkg-1.16.5-1.12.4" = _1riqzC5C;
        "pkg-1.18.2-1.12.4" = _VPUd7Y4z;
        "pkg-1.19.2-1.12.4" = _jiSki7Uy;
        "pkg-1.20.1-1.12.4" = _Xx3nJYCe;
        "pkg-1.21.4-1.12.4" = _vQI7PzXr;
        "pkg-1.16.5-1.12.5" = _fgtjYxag;
        "pkg-1.18.2-1.12.5" = _SDu1sj4E;
        "pkg-1.19.2-1.12.5" = _OQMInC9a;
        "pkg-1.20.1-1.12.5" = _KppjKhel;
        "pkg-1.21.4-1.12.5" = _BwoZsTLx;
        "pkg-1.16.5-1.12.6" = _NrhBGyJY;
        "pkg-1.18.2-1.12.6" = _r2NURkaT;
        "pkg-1.19.2-1.12.6" = _5oRDtMHT;
        "pkg-1.20.1-1.12.6" = _ejIErOTM;
        "pkg-1.21.4-1.12.6" = _deEnGwNZ;
        "pkg-1.16.5-1.12.7" = _Tn1JmI0W;
        "pkg-1.18.2-1.12.7" = _q3HH75lZ;
        "pkg-1.19.2-1.12.7" = _q1fvcNiC;
        "pkg-1.20.1-1.12.7" = _WOJyo3tD;
        "pkg-1.21.4-1.12.7" = _xBKu34Ri;
        "pkg-1.16.5-1.13.0" = _MgbJHVQQ;
        "pkg-1.18.2-1.13.0" = _7TaNosmo;
        "pkg-1.19.2-1.13.0" = _WXzhWi2Q;
        "pkg-1.20.1-1.13.0" = _uKkxHqXM;
        "pkg-1.21.4-1.13.0" = _fohOEwpP;
        "pkg-1.16.5-1.13.1" = _kg3BZDxd;
        "pkg-1.18.2-1.13.1" = _QPEemiYe;
        "pkg-1.19.2-1.13.1" = _Td5QDOLX;
        "pkg-1.20.1-1.13.1" = _HbQkVJOQ;
        "pkg-1.21.4-1.13.1" = _Rl3ip5Db;
        "pkg-1.16.5-1.13.2" = _bLSZQCkm;
        "pkg-1.18.2-1.13.2" = _XO5IEMp8;
        "pkg-1.19.2-1.13.2" = _CuvaQptN;
        "pkg-1.20.1-1.13.2" = _x3OnLVtZ;
        "pkg-1.21.4-1.13.2" = _CUUQMfkD;
        "pkg-1.16.5-1.13.3" = _UWKAP02S;
        "pkg-1.18.2-1.13.3" = _oEvLxlzd;
        "pkg-1.19.2-1.13.3" = _JJj4SAVA;
        "pkg-1.20.1-1.13.3" = _tejmmDLt;
        "pkg-1.21.1-1.13.3" = _o1iDCBmx;
        "pkg-1.21.5-1.13.3" = _I4gSIvwk;
        "pkg-1.16.5-1.13.4" = _qh3eVgzr;
        "pkg-1.18.2-1.13.4" = _AFsKLQX2;
        "pkg-1.19.2-1.13.4" = _wD8IuztG;
        "pkg-1.20.1-1.13.4" = _ocfZKvcu;
        "pkg-1.21.1-1.13.4" = _PoILfchN;
        "pkg-1.21.5-1.13.4" = _IwxPKjZR;
        "pkg-1.16.5-1.13.5" = _xzKBux8V;
        "pkg-1.18.2-1.13.5" = _z7wfEquc;
        "pkg-1.19.2-1.13.5" = _q5QItTIQ;
        "pkg-1.20.1-1.13.5" = _F1y1YmE0;
        "pkg-1.21.1-1.13.5" = _Y9hSD7iK;
        "pkg-1.21.5-1.13.5" = _ZCl0do4J;
        "pkg-1.21.6-1.13.5" = _Oqa9WksS;
        "pkg-1.16.5-1.13.6" = _B6yy1MXl;
        "pkg-1.18.2-1.13.6" = _4mCjMMbW;
        "pkg-1.19.2-1.13.6" = _BfcKXrsh;
        "pkg-1.20.1-1.13.6" = _KDjEp2Fk;
        "pkg-1.21.1-1.13.6" = _4pDH9Hqz;
        "pkg-1.21.5-1.13.6" = _KyeLeTdV;
        "pkg-1.21.8-1.13.6" = _izU9cbox;
        "pkg-1.16.5-1.13.7" = _4E1oHL8s;
        "pkg-1.18.2-1.13.7" = _kA1SNNe0;
        "pkg-1.19.2-1.13.7" = _45OdFDQM;
        "pkg-1.20.1-1.13.7" = _CK0A0D75;
        "pkg-1.21.1-1.13.7" = _6PV2nqj7;
        "pkg-1.21.5-1.13.7" = _KEWXRUKw;
        "pkg-1.21.8-1.13.7" = _PCytXitI;
        "pkg-1.16.5-1.13.8" = _BHEsDl5L;
        "pkg-1.18.2-1.13.8" = _svNi2Zuz;
        "pkg-1.19.2-1.13.8" = _ls4FquLW;
        "pkg-1.20.1-1.13.8" = _18BUYFEz;
        "pkg-1.21.1-1.13.8" = _UsflNeE2;
        "pkg-1.21.5-1.13.8" = _lgH4XvUZ;
        "pkg-1.21.8-1.13.8" = _PRAsR4Ri;
        "pkg-1.16.5-1.13.9" = _jxZRLgmW;
        "pkg-1.18.2-1.13.9" = _w6fc5YMq;
        "pkg-1.19.2-1.13.9" = _VoRcBFiv;
        "pkg-1.20.1-1.13.9" = _Bce1HCk3;
        "pkg-1.21.1-1.13.9" = _4njyQYmr;
        "pkg-1.21.5-1.13.9" = _fFvrjPDC;
        "pkg-1.21.8-1.13.9" = _rfR31hOX;
        "pkg-1.16.5-1.13.10" = _41Vkyhay;
        "pkg-1.18.2-1.13.10" = _J0vT2Wpf;
        "pkg-1.19.2-1.13.10" = _1ZcmMphF;
        "pkg-1.20.1-1.13.10" = _CWYmwm7A;
        "pkg-1.21.1-1.13.10" = _3Ujop4ka;
        "pkg-1.21.5-1.13.10" = _yQWMj4Au;
        "pkg-1.21.8-1.13.10" = _yD2rH5D8;
        "pkg-1.16.5-1.13.11" = _JlRxQs7y;
        "pkg-1.18.2-1.13.11" = _an8BHmMX;
        "pkg-1.19.2-1.13.11" = _SCAoUNUt;
        "pkg-1.20.1-1.13.11" = _2OZRgrts;
        "pkg-1.21.1-1.13.11" = _rILBw2Vw;
        "pkg-1.21.5-1.13.11" = _D84a0rtV;
        "pkg-1.21.8-1.13.11" = _mdRVYkDl;
        "pkg-1.21.10-1.13.11" = _oxLPkJKz;
        "pkg-1.16.5-1.13.12" = _8wk8cSZv;
        "pkg-1.18.2-1.13.12" = _iuptoPw9;
        "pkg-1.19.2-1.13.12" = _dCSEwOwA;
        "pkg-1.20.1-1.13.12" = _ib12VQAN;
        "pkg-1.21.1-1.13.12" = _b8L28s1s;
        "pkg-1.21.5-1.13.12" = _X3uwtMtR;
        "pkg-1.21.8-1.13.12" = _RpPBrdbK;
        "pkg-1.21.10-1.13.12" = _UQu4KqUj;
        "pkg-1.16.5-1.13.13" = _i41Pnp6k;
        "pkg-1.18.2-1.13.13" = _iM0mQG4v;
        "pkg-1.19.2-1.13.13" = _JrzT3Rnm;
        "pkg-1.20.1-1.13.13" = _atejUt89;
        "pkg-1.21.1-1.13.13" = _fYLmpXK9;
        "pkg-1.21.5-1.13.13" = _xrKOqQRu;
        "pkg-1.21.8-1.13.13" = _2uiSFLzv;
        "pkg-1.21.10-1.13.13" = _6TWnZet9;
        "pkg-1.16.5-1.13.14" = _uQfrKDY5;
        "pkg-1.18.2-1.13.14" = _AUaO6qJ5;
        "pkg-1.19.2-1.13.14" = _kWZndK27;
        "pkg-1.20.1-1.13.14" = _eHX7N9WJ;
        "pkg-1.21.1-1.13.14" = _AA7RVXti;
        "pkg-1.21.5-1.13.14" = _2W5Erjrp;
        "pkg-1.21.8-1.13.14" = _D1NRVbjI;
        "pkg-1.21.10-1.13.14" = _bLsAq0JH;
        "pkg-1.16.5-1.13.15" = _lAeJm4ei;
        "pkg-1.18.2-1.13.15" = _ATC2PJIl;
        "pkg-1.19.2-1.13.15" = _1XuXNsdc;
        "pkg-1.20.1-1.13.15" = _eEfolX4b;
        "pkg-1.21.1-1.13.15" = _Rw1qf2pO;
        "pkg-1.21.5-1.13.15" = _DZZy2VCp;
        "pkg-1.21.8-1.13.15" = _MnVYCnIs;
        "pkg-1.21.10-1.13.15" = _Wn3EYqSp;
        "pkg-1.16.5-1.13.16" = _KggKZj8u;
        "pkg-1.18.2-1.13.16" = _Z8bBA5Fo;
        "pkg-1.19.2-1.13.16" = _fhrGYfIS;
        "pkg-1.20.1-1.13.16" = _fUfM5w9T;
        "pkg-1.21.1-1.13.16" = _TkeNBZGx;
        "pkg-1.21.5-1.13.16" = _FL97wtE7;
        "pkg-1.21.8-1.13.16" = _j4TI8qX0;
        "pkg-1.21.10-1.13.16" = _hg7OVBqZ;
        "pkg-1.16.5-1.13.17" = _LFnsbvMw;
        "pkg-1.18.2-1.13.17" = _NXJxfgMb;
        "pkg-1.19.2-1.13.17" = _AqhvG0Hh;
        "pkg-1.20.1-1.13.17" = _3xidTx8y;
        "pkg-1.21.1-1.13.17" = _AAgiHvuj;
        "pkg-1.21.5-1.13.17" = _Zv5LZquV;
        "pkg-1.21.8-1.13.17" = _arnlwLw8;
        "pkg-1.21.10-1.13.17" = _ElywguOv;
        "pkg-1.16.5-2.0.0" = _u3QS1yln;
        "pkg-1.18.2-2.0.0" = _ZxjVSoIv;
        "pkg-1.19.2-2.0.0" = _HbUsYMpe;
        "pkg-1.20.1-2.0.0" = _cs1oAFWI;
        "pkg-1.21.1-2.0.0" = _6oej4hwL;
        "pkg-1.21.5-2.0.0" = _W4eKBWTB;
        "pkg-1.21.8-2.0.0" = _xuh5Hygi;
        "pkg-1.21.10-2.0.0" = _9Oe5nmma;
        "pkg-1.21.11-2.0.0" = _upMa2trr;
        "pkg-1.16.5-2.0.1" = _HKiFBom3;
        "pkg-1.18.2-2.0.1" = _YQO7nJ2P;
        "pkg-1.19.2-2.0.1" = _LiaHUy3M;
        "pkg-1.20.1-2.0.1" = _g5qRmiE5;
        "pkg-1.21.1-2.0.1" = _fLO4a5EI;
        "pkg-1.21.5-2.0.1" = _2dg4GmoO;
        "pkg-1.21.8-2.0.1" = _3ilMBa71;
        "pkg-1.21.10-2.0.1" = _oYmsHJzT;
        "pkg-1.21.11-2.0.1" = _r6mDUykf;
        "pkg-1.16.5-2.0.2" = _67L8n98d;
        "pkg-1.18.2-2.0.2" = _ecAs7E6s;
        "pkg-1.19.2-2.0.2" = _q0GddUNN;
        "pkg-1.20.1-2.0.2" = _wZvFtwhi;
        "pkg-1.21.1-2.0.2" = _6gzUKCIG;
        "pkg-1.21.5-2.0.2" = _KjG69kOt;
        "pkg-1.21.8-2.0.2" = _j1Ia3ANi;
        "pkg-1.21.10-2.0.2" = _fl34H7KA;
        "pkg-1.21.11-2.0.2" = _6MiTFBmf;
        "pkg-1.16.5-2.0.3" = _QoE3EAfw;
        "pkg-1.18.2-2.0.3" = _erhmPRaN;
        "pkg-1.19.2-2.0.3" = _2WGRdMtH;
        "pkg-1.20.1-2.0.3" = _lM1gainx;
        "pkg-1.21.1-2.0.3" = _CNbipN8g;
        "pkg-1.21.5-2.0.3" = _QfPx4opi;
        "pkg-1.21.8-2.0.3" = _QmgofKN3;
        "pkg-1.21.10-2.0.3" = _9nAiM0Ju;
        "pkg-1.21.11-2.0.3" = _PGIE3jbJ;
        "pkg-1.16.5-2.0.4" = _AWk844JE;
        "pkg-1.18.2-2.0.4" = _2rFWnGbo;
        "pkg-1.19.2-2.0.4" = _hqGktaaN;
        "pkg-1.20.1-2.0.4" = _dlkqrzWv;
        "pkg-1.21.1-2.0.4" = _Q0crdjUM;
        "pkg-1.21.5-2.0.4" = _bRqZMODX;
        "pkg-1.21.8-2.0.4" = _Surx9yp7;
        "pkg-1.21.10-2.0.4" = _jgskYFPz;
        "pkg-1.21.11-2.0.4" = _LhMnwLLb;
        "pkg-26.1.2-2.0.4" = _CvNVH68r;
        "pkg-1.16.5-2.0.5" = _20IxboAo;
        "pkg-1.18.2-2.0.5" = _3FEPQCEa;
        "pkg-1.19.2-2.0.5" = _ItO7agW6;
        "pkg-1.20.1-2.0.5" = _Qbi4xFlq;
        "pkg-1.21.1-2.0.5" = _IGyXLMQc;
        "pkg-26.1.2-2.0.5" = _9QI1te5V;
        "pkg-1.16.5-2.0.6" = _MVUYaDnZ;
        "pkg-1.18.2-2.0.6" = _h6nqhLBG;
        "pkg-1.19.2-2.0.6" = _LLijmZiZ;
        "pkg-1.20.1-2.0.6" = _CTtL1Pkz;
        "pkg-1.21.1-2.0.6" = _Zi4BtdLS;
        "pkg-26.1.2-2.0.6" = _KsKhb0Pm;
        "pkg-26.2-2.0.6" = _Shaxuu59;
        "pkg-1.16.5-2.0.7" = _FBL2yzyQ;
        "pkg-1.18.2-2.0.7" = _2ddQ8PqE;
        "pkg-1.19.2-2.0.7" = _tuxyTEAV;
        "pkg-1.20.1-2.0.7" = _gPhr5qav;
        "pkg-1.21.1-2.0.7" = _xaAzYZLq;
        "pkg-26.1.2-2.0.7" = _RwqEEuMy;
        "pkg-26.2-2.0.7" = _cixxAGzt;
        "pkg-1.16.5-2.0.8" = _Bh1iujpP;
        "pkg-1.18.2-2.0.8" = _La4Kw6Tg;
        "pkg-1.19.2-2.0.8" = _Fbqbi3Ui;
        "pkg-1.20.1-2.0.8" = _ueFJFeHx;
        "pkg-1.21.1-2.0.8" = _WF5EUDiB;
        "pkg-26.1.2-2.0.8" = _oskyStuA;
        "pkg-26.2-2.0.8" = _JyxCRQwH;
        "pkg-1.16.5-2.0.9" = _5cl07EVK;
        "pkg-1.18.2-2.0.9" = _zWKr5MBp;
        "pkg-1.19.2-2.0.9" = _Rp06lxdW;
        "pkg-1.20.1-2.0.9" = _gy3Yep5K;
        "pkg-1.21.1-2.0.9" = _gIBUoXmx;
        "pkg-26.1.2-2.0.9" = _IvuyTcFw;
        "pkg-26.2-2.0.9" = _WRXvRFZj;
        "pkg-1.16.5-2.0.10" = _xuBSKpxi;
        "pkg-1.18.2-2.0.10" = _eFZemFis;
        "pkg-1.19.2-2.0.10" = _ezmPd1mS;
        "pkg-1.20.1-2.0.10" = _hAxCCLfa;
