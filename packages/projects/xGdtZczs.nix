...
let
    versions = (let
        ...
        _NTeStfxi = {
            "id" = "NTeStfxi";
            "file" = "polymer-bundled-0.17.4+26.2.jar";
            "hash" = "sha512-u/GY8f8pdSfnlnXsPvrF/pwHO9ZlO5nPzhOI0OukfIr3fljNRIG47Q+lN4Kk1j1sP4ouySNvSAwXNxla88yN/w==";
        };
        _561YnR5f = {
            "id" = "561YnR5f";
            "file" = "polymer-bundled-0.17.5+26.2.jar";
            "hash" = "sha512-vPcpIvukpqlM3OEMVQGOYWgxvp14A0Xd0BDg3jXGqn4eWGOsevu5c4UUs6TqRwJ3ljHEZeGcOQx1S5QWh7Qryw==";
        };
        _QBYrHLvh = {
            "id" = "QBYrHLvh";
    ...
    in {
        ...
        "pkg-0.2.0-beta.6+1.18" = _oZvr0rK9;
        "pkg-0.2.0-beta.7+1.18" = _FrSH2B1s;
        "pkg-0.2.0-beta.8+1.18" = _XpDuDx0f;
        "pkg-0.2.0-beta.9+1.18.1" = _GBbaznyq;
        "pkg-0.2.0-beta.10+1.18.1" = _C1dPrXQA;
        "pkg-0.2.0-beta.11+1.18.1" = _WUor3v4O;
        "pkg-0.2.0-beta.12+1.18.1" = _HaoOpHSX;
        "pkg-0.2.0-beta.13+1.18.1" = _hu0zARvk;
        "pkg-0.2.0-beta.14+1.18.1" = _9vDMtbHi;
        "pkg-0.2.0-beta.15+1.18.1" = _K3geYlnr;
        "pkg-0.2.0-beta.16+1.18.1" = _Fan0MWdz;
        "pkg-0.2.0-beta.17+1.18.1" = _iLZvlj1S;
        "pkg-0.2.0-beta.18+1.18.1" = _nhjAKGcM;
        "pkg-0.2.0-beta.19+1.18.1" = _vYlHQfC8;
        "pkg-0.2.0-beta.20+1.18.1" = _tndaxVZB;
        "pkg-0.2.0-beta.21+1.18.1" = _EruNUr5L;
        "pkg-0.2.0-beta.22+1.18.1" = _TdIket6m;
        "pkg-0.2.0-beta.23+1.18.1" = _c0reUUfa;
        "pkg-0.2.0-beta.24+1.18.1" = _ajxbkwQ1;
        "pkg-0.2.0-beta.25+1.18.1" = _KDxn3vbY;
        "pkg-0.2.0-beta.26+1.18.1" = _jWkdx7IT;
        "pkg-0.2.0-beta.27+1.18.1" = _bQxRi3F8;
        "pkg-0.2.0-beta.27+1.18.2-rc1" = _erEsoJCX;
        "pkg-0.2.0-beta.28+1.18.2" = _s5BBJ6l8;
        "pkg-0.2.0-beta.29+1.18.2" = _ErGyH4qP;
        "pkg-0.2.0-beta.30+1.18.2" = _BhmfulNB;
        "pkg-0.2.0-beta.31+1.18.2" = _WUJTw557;
        "pkg-0.2.0-beta.32+1.18.2" = _PVARsPMp;
        "pkg-0.2.0-beta.33+1.18.2" = _HlI5Bqki;
        "pkg-0.2.0-beta.34+1.18.2" = _B2kwoL62;
        "pkg-0.2.0-beta.35+1.18.2" = _iqXEAUBO;
        "pkg-0.2.0-beta.36+1.18.2" = _meXEsHJi;
        "pkg-0.2.0-beta.37+1.18.2" = _nPGaPE2M;
        "pkg-0.2.0-beta.38+1.18.2" = _Es63TdW5;
        "pkg-0.2.0-beta.39+1.18.2" = _1bl2Yu9g;
        "pkg-0.2.0-beta.40+1.18.2" = _G04x1nFO;
        "pkg-0.2.0-pre.1+1.18.2" = _Kmj1TS5t;
        "pkg-0.2.0-pre.2+1.18.2" = _9bZhSPAS;
        "pkg-0.2.0-pre.3+1.18.2" = _vp5gjZH6;
        "pkg-0.2.0-pre.4+1.18.2" = _ZUGAL97o;
        "pkg-0.2.0-pre.5+1.18.2" = _AqSF6m0o;
        "pkg-0.2.0-pre.6+1.18.2" = _rBPm4qLu;
        "pkg-0.2.0-pre.6+1.19-pre4" = _hhzAeI1p;
        "pkg-0.2.0-rc.1+1.18.2" = _Mxz2zHQo;
        "pkg-0.2.0-rc.2+1.18.2" = _QoWehZDT;
        "pkg-0.2.0-rc.2+1.19-pre5" = _FI9rJDPa;
        "pkg-0.2.0-rc.3+1.18.2" = _mNnLLZvs;
        "pkg-0.2.0-rc.4+1.18.2" = _YyKIATrQ;
        "pkg-0.2.0-rc.4+1.19-rc2" = _ozBIvwLC;
        "pkg-0.2.0+1.19" = _d8VyIFO1;
        "pkg-0.2.1+1.19" = _EZptqfoH;
        "pkg-0.2.2+1.19" = _qoH0OrfZ;
        "pkg-0.2.0-rc.4.1+1.18.2" = _pNSCjrQS;
        "pkg-0.2.0-rc.4.2+1.18.2" = _OA0h4dWa;
        "pkg-0.2.3+1.19" = _4CVwYHhV;
        "pkg-0.2.4+1.19" = _wlmd7Vof;
        "pkg-0.2.5+1.19" = _ICzZJHS1;
        "pkg-0.2.6+1.19" = _WlQ8SYeR;
        "pkg-0.2.7+1.19" = _DHoi4iiG;
        "pkg-0.2.8+1.19" = _MPh1KpAZ;
        "pkg-0.2.9+1.19" = _NYTFITJ7;
        "pkg-0.2.10+1.19" = _rHRNdkpz;
        "pkg-0.2.10+1.19.1" = _7LF7kphW;
        "pkg-0.2.0-rc.4.3+1.18.2" = _wG1dyHVL;
        "pkg-0.2.11+1.19.2" = _EauhQ4jp;
        "pkg-0.2.12+1.19.2" = _jywje19T;
        "pkg-0.2.0-rc.4.4+1.18.2" = _gCIMkMie;
        "pkg-0.2.13+1.19.2" = _wd3ze2FF;
        "pkg-0.2.14+1.19.2" = _K0PFGYig;
        "pkg-0.2.15+1.19.2" = _ItjRfeJP;
        "pkg-0.2.16+1.19.2" = _7bD9b3pu;
        "pkg-0.2.17+1.19.2" = _lD83PMgP;
        "pkg-0.2.18+1.19.2" = _uZEwXh4D;
        "pkg-0.2.19+1.19.2" = _NKUP87vt;
        "pkg-0.2.0-rc.4.5+1.18.2" = _jRt5sgHl;
        "pkg-0.2.20+1.19.2" = _hg90NWWl;
        "pkg-0.3.0-rc.1+1.19.3-rc1" = _diU10vWW;
        "pkg-0.2.21+1.19.2" = _dji8LSW5;
        "pkg-0.3.0-rc.2+1.19.3-rc3" = _WNen3VYG;
        "pkg-0.3.0-rc.3+1.19.3" = _A1pDNqpI;
        "pkg-0.3.0-rc.4+1.19.3" = _AH1y9bUS;
        "pkg-0.3.0+1.19.3" = _oePk1Nhd;
        "pkg-0.2.22+1.19.2" = _LlBIiNeY;
        "pkg-0.3.1+1.19.3" = _zOmaTwCl;
        "pkg-0.3.2+1.19.3" = _qkps1zvp;
        "pkg-0.3.3+1.19.3" = _5I570DNh;
        "pkg-0.2.23+1.19.2" = _LdnQAYL1;
        "pkg-0.3.4+1.19.3" = _PrIlPGux;
        "pkg-0.3.5+1.19.3" = _UPB1nQ83;
        "pkg-0.3.6+1.19.3" = _UWIaHtLZ;
        "pkg-0.2.24+1.19.2" = _4zx5LSya;
        "pkg-0.3.7+1.19.3" = _xQ79v0Nh;
        "pkg-0.2.0-rc.4.6+1.18.2" = _GPELPshN;
        "pkg-0.2.0-rc.4.7+1.18.2" = _WpRARMr0;
        "pkg-0.2.0-rc.4.8+1.18.2" = _tXOgXoX3;
        "pkg-0.2.25+1.19.2" = _QcMLV0CE;
        "pkg-0.3.8+1.19.3" = _D6DD3WV1;
        "pkg-0.3.9+1.19.3" = _dQwkcptf;
        "pkg-0.3.10+1.19.3" = _JQ5Hj4jj;
        "pkg-0.3.11+1.19.3" = _wYjNT7zE;
        "pkg-0.3.12+1.19.3" = _72EaL8GS;
        "pkg-0.3.13+1.19.3" = _u1eEBsW3;
        "pkg-0.4.0-beta.1+1.19.4-pre3" = _In7FCQS5;
        "pkg-0.4.0-beta.2+1.19.4-pre3" = _CqIOljZm;
        "pkg-0.4.0-beta.3+1.19.4-pre3" = _tG327o0Q;
        "pkg-0.4.0-beta.4+1.19.4-pre4" = _qMsBuULQ;
        "pkg-0.4.0-pre.1+1.19.4-rc1" = _zWXQ2ugA;
        "pkg-0.4.0-pre.2+1.19.4-rc2" = _kL1Y0Jzq;
        "pkg-0.4.0-pre.3+1.19.4-rc2" = _ZrPWoWwu;
        "pkg-0.4.0+1.19.4" = _TdaNf5Be;
        "pkg-0.4.1+1.19.4" = _Sd6QVdO3;
        "pkg-0.4.2+1.19.4" = _Zwns3pdo;
        "pkg-0.4.3+1.19.4" = _vqsGxnEz;
        "pkg-0.4.4+1.19.4" = _FhCEOizX;
        "pkg-0.4.5+1.19.4" = _CvGhkZu9;
        "pkg-0.4.6+1.19.4" = _LSJS7QEN;
        "pkg-0.4.7+1.19.4" = _VraJ1qRh;
        "pkg-0.2.26+1.19.2" = _gE85ZBKg;
        "pkg-0.4.8+1.19.4" = _urynm4Uk;
        "pkg-0.2.27+1.19.2" = _H3RlSRaF;
        "pkg-0.4.9+1.19.4" = _iTZr1ADT;
        "pkg-0.2.28+1.19.2" = _dxCqgrBp;
        "pkg-0.4.10+1.19.4" = _lu06fwPF;
        "pkg-0.4.11+1.19.4" = _ncbwZwT1;
        "pkg-0.5.0-rc.1+1.20-rc1" = _Yi7ROjbu;
        "pkg-0.5.0-rc.2+1.20-rc1" = _mZyPGybH;
        "pkg-0.5.0-rc.3+1.20" = _zOvqjP78;
        "pkg-0.5.0+1.20" = _d0UzsyDy;
        "pkg-0.5.1+1.20.1" = _HjAQTZXI;
        "pkg-0.5.2+1.20.1" = _PefjlluM;
        "pkg-0.5.3+1.20.1" = _WhphZXxD;
        "pkg-0.5.4+1.20.1" = _C1JVaatO;
        "pkg-0.5.5+1.20.1" = _g9qSvgcj;
        "pkg-0.5.6+1.20.1" = _7S2ow8xk;
        "pkg-0.5.7+1.20.1" = _494VrtRV;
        "pkg-0.5.8+1.20.1" = _hEPQmQBy;
        "pkg-0.5.9+1.20.1" = _bkZuB2tr;
        "pkg-0.5.10+1.20.1" = _8gZaLZld;
        "pkg-0.5.11+1.20.1" = _1vSiJUPh;
        "pkg-0.5.12+1.20.1" = _kEZbQbSk;
        "pkg-0.5.13+1.20.1" = _9e77sElf;
        "pkg-0.5.14+1.20.1" = _4yknppiu;
        "pkg-0.5.15+1.20.1" = _Z7RmlY2c;
        "pkg-0.6.0-rc.1+1.20.2-rc2" = _NbjI4iC9;
        "pkg-0.6.0-rc.2+1.20.2-rc2" = _bVgFUv2q;
        "pkg-0.6.0-rc.3+1.20.2-rc2" = _6aYxyXpW;
        "pkg-0.6.0+1.20.2" = _qAqs7npE;
        "pkg-0.6.1+1.20.2" = _JUTI8w2W;
        "pkg-0.5.16+1.20.1" = _UuGT7mRB;
        "pkg-0.6.2+1.20.2" = _V4yjd5GI;
        "pkg-0.5.17+1.20.1" = _tk56C1Zc;
        "pkg-0.5.18+1.20.1" = _4jz2h6HJ;
        "pkg-0.6.3+1.20.2" = _n96aAheO;
        "pkg-0.7.0+1.20.3-rc1" = _NMBzspwp;
        "pkg-0.7.1+1.20.4" = _tqruYIl8;
        "pkg-0.7.2+1.20.4" = _D9CF9ker;
        "pkg-0.5.19+1.20.1" = _3ii2xU3x;
        "pkg-0.7.3+1.20.4" = _hhzHDyuZ;
        "pkg-0.7.4+1.20.4" = _xM1nxdPh;
        "pkg-0.7.5+1.20.4" = _hrEg2iri;
        "pkg-0.7.6+1.20.4" = _q6smILYe;
        "pkg-0.7.7+1.20.4" = _Kk7rWLSf;
        "pkg-0.8.0-beta.1+1.20.5-rc1" = _8IZZFKLD;
        "pkg-0.8.0-beta.2+1.20.5-rc2" = _QOdVlngJ;
        "pkg-0.8.0-beta.3+1.20.5-rc2" = _l3HHKfO2;
        "pkg-0.8.0-beta.4+1.20.5-rc2" = _iKrwgWqG;
        "pkg-0.8.0-beta.5+1.20.5-rc3" = _oG20wc9D;
        "pkg-0.8.0-beta.6+1.20.5" = _IeEK9r2T;
        "pkg-0.8.0-beta.7+1.20.5" = _EFJSarLi;
        "pkg-0.7.8+1.20.4" = _7TQHL6TE;
        "pkg-0.8.0-beta.8+1.20.6" = _OFUCJSsB;
        "pkg-0.8.0-pre.1+1.20.6" = _GSVej8V7;
        "pkg-0.7.9+1.20.4" = _XiN3ScAO;
        "pkg-0.5.20+1.20.1" = _UB9Kcuk5;
        "pkg-0.8.0+1.20.6" = _8hZNBBSh;
        "pkg-0.8.1+1.20.6" = _1qSMjfdj;
        "pkg-0.8.2+1.20.6" = _oLcBMG4X;
        "pkg-0.9.0-pre.1+1.21-pre3" = _4XMp9p8N;
        "pkg-0.8.3+1.20.6" = _ARHcF6r1;
        "pkg-0.9.0-pre.2+1.21-pre4" = _noi8ZEZe;
        "pkg-0.9.0+1.21-rc1" = _Plc80q9D;
        "pkg-0.8.4+1.20.6" = _JkYEl78u;
        "pkg-0.9.1+1.21" = _yMqMuVI8;
        "pkg-0.9.2+1.21" = _giGFb3g7;
        "pkg-0.8.5+1.20.6" = _uDMshlUQ;
        "pkg-0.9.3+1.21" = _4LRaNBrK;
        "pkg-0.9.4+1.21" = _Bbj5Ts5L;
        "pkg-0.9.5+1.21" = _lsU6z5fJ;
        "pkg-0.9.6+1.21" = _mU29nhmb;
        "pkg-0.9.7+1.21" = _fxRH7wMB;
        "pkg-0.9.8+1.21" = _TSwN6LlP;
        "pkg-0.7.10+1.20.4" = _Z24yQu2R;
        "pkg-0.9.9+1.21" = _p33F2gAj;
        "pkg-0.9.10+1.21.1" = _Qt9CW5JI;
        "pkg-0.9.11+1.21.1" = _TwyJySb5;
        "pkg-0.9.12+1.21.1" = _Y6MReiyV;
        "pkg-0.9.13+1.21.1" = _KCa0po6I;
        "pkg-0.9.14+1.21.1" = _UyBFGf8G;
        "pkg-0.9.15+1.21.1" = _whyh7PCx;
        "pkg-0.9.16+1.21.1" = _JNR0UeBQ;
        "pkg-0.9.17+1.21.1" = _vMlWh7fL;
        "pkg-0.10.0-rc.1+1.21.2-rc2" = _w9xXQhRJ;
        "pkg-0.10.0+1.21.2" = _30aUar5p;
        "pkg-0.10.1+1.21.3" = _iqJAmJvy;
        "pkg-0.9.18+1.21.1" = _t55Wk2zK;
        "pkg-0.10.2+1.21.3" = _a56gjnCk;
        "pkg-0.11.0+1.21.4-rc1" = _JHnXCHue;
        "pkg-0.11.1+1.21.4" = _w0RPx5l0;
        "pkg-0.11.2+1.21.4" = _poViL105;
        "pkg-0.11.3+1.21.4" = _aek1vsQ6;
        "pkg-0.11.4+1.21.4" = _O0WRTnsC;
        "pkg-0.11.5+1.21.4" = _dxn8AWsc;
        "pkg-0.11.6+1.21.4" = _8Wkclv3h;
        "pkg-0.11.7+1.21.4" = _1Ekz1oyy;
        "pkg-0.11.8+1.21.4" = _71wYlThU;
        "pkg-0.12.0+1.21.5-rc1" = _fQX0hnDe;
        "pkg-0.12.1+1.21.5-rc2" = _TNMbG1dz;
        "pkg-0.12.2+1.21.5" = _rAXU9iZ3;
        "pkg-0.12.3+1.21.5" = _oG7chIN8;
        "pkg-0.12.4+1.21.5" = _hJ7RjAL6;
        "pkg-0.12.5+1.21.5" = _eEQao9vK;
        "pkg-0.12.6+1.21.5" = _dqiMdAQo;
        "pkg-0.13.0-pre.1+1.21.6-pre2" = _q2NyUkpp;
        "pkg-0.13.0+1.21.6" = _BbPphLjv;
        "pkg-0.13.1+1.21.6" = _QgRJlxm5;
        "pkg-0.13.2+1.21.6" = _ULYeLdpw;
        "pkg-0.13.3+1.21.6" = _hOQKjcpq;
        "pkg-0.13.4+1.21.7" = _YWXh0Bbd;
        "pkg-0.13.5+1.21.7" = _aEyeHwjm;
        "pkg-0.13.6+1.21.7" = _kNDC3Dwc;
        "pkg-0.13.7+1.21.8" = _ccfozNX2;
        "pkg-0.13.8+1.21.8" = _anBkEafd;
        "pkg-0.13.9+1.21.8" = _6nwJH5Ti;
        "pkg-0.13.10+1.21.8" = _XZhBAL2Z;
        "pkg-0.13.11+1.21.8" = _6cqgmDx1;
        "pkg-0.13.12+1.21.8" = _Z1L6ak64;
        "pkg-0.13.13+1.21.8" = _Low85MxT;
        "pkg-0.14.0-beta.1+1.21.9-pre1" = _VPVJp63t;
        "pkg-0.14.0-rc.1+1.21.9-rc1" = _InnfuNQi;
        "pkg-0.14.0-rc.2+1.21.9-rc1" = _BNVXe91Q;
        "pkg-0.14.0+1.21.9" = _u5NU392J;
        "pkg-0.14.1+1.21.9" = _TG8jCNCp;
        "pkg-0.14.2+1.21.9" = _tSaACbbf;
        "pkg-0.14.3+1.21.10" = _Wqqx3agK;
        "pkg-0.15.0-beta.1+1.21.11-pre3" = _aJ1VEGdx;
        "pkg-0.15.0-beta.2+1.21.11-pre4" = _w35ttZQ8;
        "pkg-0.15.0-beta.3+1.21.11-pre5" = _Z7neaHCq;
        "pkg-0.15.0-beta.4+1.21.11-rc2" = _utKxLpme;
        "pkg-0.14.4+1.21.10" = _1ok02iew;
        "pkg-0.15.0+1.21.11" = _pxEFwGFX;
        "pkg-0.15.1+1.21.11" = _YVtP5HFl;
        "pkg-0.9.19+1.21.1" = _xqZ9fctS;
        "pkg-0.15.2+1.21.11" = _wugBT1fU;
        "pkg-0.16.0-pre.1+26.1-rc-2" = _v7d9M1KR;
        "pkg-0.16.0-pre.2+26.1-rc-2" = _GFKTHpJk;
        "pkg-0.16.0-pre.3+26.1" = _wZwko27P;
        "pkg-0.16.0-pre.4+26.1" = _AzNuo65F;
        "pkg-0.16.0+26.1.1" = _qyEX777c;
        "pkg-0.16.1+26.1.1" = _CTtd2Nb1;
        "pkg-0.16.2+26.1.1" = _LWqeh4vm;
        "pkg-0.16.3+26.1.2" = _Z1B30S8b;
        "pkg-0.16.4+26.1.2" = _BkYLqhON;
        "pkg-0.16.5+26.1.2" = _tqJUyql2;
        "pkg-0.17.0+26.2-rc-2" = _TbzTxpbP;
        "pkg-0.17.1+26.2" = _Tnd1PthN;
        "pkg-0.17.2+26.2" = _N2pBHJRZ;
        "pkg-0.17.3+26.2" = _w0N4I45x;
