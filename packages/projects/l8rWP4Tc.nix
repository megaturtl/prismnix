...
let
    ...
    in {
        ...
        "pkg-1.0.5" = _47QY19b3;
        "pkg-1.0.6" = _bd26RNdz;
        "pkg-1.02.6" = _SfnY1CYn;
        "pkg-1.01.7" = _tZOxTPV5;
        "pkg-1.02.7" = _YcAKCzQZ;
        "pkg-1.03.7" = _qESZlivi;
        "pkg-1.04.7" = _XqD9jx9F;
        "pkg-1.05.7" = _nUCpgWji;
        "pkg-1.06.7" = _RUFAbIet;
        "pkg-1.07.7" = _esP7vXLt;
        "pkg-1.08.7" = _NnZzlW2l;
        "pkg-1.09.7" = _B15uihrc;
        "pkg-1.10.7" = _Y5oNE2bq;
        "pkg-1.11.7" = _ZlHdPJSR;
        "pkg-1.00.7" = _hRgFl0ig;
        "pkg-12.02.7" = _J4aIkgQh;
        "pkg-7.10.7" = _cmkqzBYv;
        "pkg-00.90.8" = _UJVIkuL3;
        "pkg-00.91.8" = _nIwCKTbI;
        "pkg-00.92.8" = _u60sxM7N;
        "pkg-00.93.8" = _mywymvd6;
        "pkg-00.94.8" = _cjvTrYB0;
        "pkg-00.95.8" = _kZmLZPTp;
        "pkg-00.96.8" = _ccl6SrAN;
        "pkg-1.00.8" = _ryoTmCwj;
        "pkg-1.01.8" = _5oEjQDnu;
        "pkg-1.02.8" = _vJdqOCwT;
        "pkg-1.03.8" = _EcG0ITXA;
        "pkg-1.04.8" = _hSl78pWd;
        "pkg-1.05.8" = _p7f4erY5;
        "pkg-1.06.8" = _6DaYZcuw;
        "pkg-1.07.8" = _SVtKe92O;
        "pkg-1.08.8" = _iUSOjFOF;
        "pkg-1.09.8" = _XJMvRkO0;
        "pkg-1.10.8" = _JcV6G0UF;
        "pkg-1.11.8" = _y3SOOd9l;
        "pkg-21.6.8" = _ckrfNB2h;
        "pkg-0.65.8" = _v1Y7hr5i;
        "pkg-0.72.8" = _ck3cFuxq;
        "pkg-00.80.8" = _FXQRSDST;
        "pkg-00.81.8" = _sBdI0FgY;
        "pkg-00.82.8" = _85zB0bi3;
        "pkg-00.83.8" = _39eYtu9O;
        "pkg-00.84.8" = _v2HkDqXW;
        "pkg-12.02.8" = _NiYxn3sB;
        "pkg-21.8.8" = _yivc4pmE;
        "pkg-20.6.8" = _D65YcJQG;
        "pkg-20.1.8-Forge" = _sUy3DXAe;
        "pkg-20.5.8" = _qXbhulmh;
        "pkg-7.10.9" = _lFGCabe8;
        "pkg-12.02.9" = _kMnBNl3r;
        "pkg-0.65.9" = _efg6yj7r;
        "pkg-0.72.9" = _EzzzfOHV;
        "pkg-00.80.9" = _dneIDrBZ;
        "pkg-00.81.9" = _PowXUZ4Y;
        "pkg-00.82.9" = _5PO6c0U0;
        "pkg-00.83.9" = _CU2VPp4x;
        "pkg-00.84.9" = _MDweWkyo;
        "pkg-00.90.9" = _BOATKtmR;
        "pkg-00.91.9" = _84RT1MnJ;
        "pkg-00.92.9" = _d4zkJDa9;
        "pkg-00.93.9" = _HzvJVx0c;
        "pkg-00.94.9" = _EijKURez;
        "pkg-00.95.9" = _JDaUdQdg;
        "pkg-00.96.9" = _YjYGpcxV;
        "pkg-20.5.9" = _mc2ufBfi;
        "pkg-20.6.9" = _JtxAaQZE;
        "pkg-20.1.9" = _uASYDic6;
        "pkg-21.8.9" = _EzGQprqk;
        "pkg-1.00.9" = _lpIHOD8r;
        "pkg-1.01.9" = _8IgdsljI;
        "pkg-1.02.9" = _oAUVQ9Ag;
        "pkg-1.03.9" = _KTvDTnsv;
        "pkg-1.04.9" = _W2cgDDQ3;
        "pkg-1.05.9" = _onDOISgh;
        "pkg-1.06.9" = _IYToxhfh;
        "pkg-1.07.9" = _W7PBntcz;
        "pkg-1.08.9" = _oAibxm6C;
        "pkg-1.09.9" = _oyIk6Uqd;
        "pkg-1.10.9" = _NEZO9Z6t;
        "pkg-21.10.9" = _EyfcCjnq;
        "pkg-1.11.9" = _qMlKx3gV;
        "pkg-21.11.9" = _hXdynxkK;
        "pkg-0.65.10" = _nRPtSF4L;
        "pkg-0.72.10" = _12GjJ8ky;
        "pkg-00.80.10" = _HsAzRTlx;
        "pkg-00.81.10" = _dZdyLhdc;
        "pkg-00.82.10" = _XbS8Ewte;
        "pkg-00.83.10" = _nuiAc2BQ;
        "pkg-00.84.10" = _tThXH109;
        "pkg-00.90.10" = _R0D0Dj5B;
        "pkg-00.91.10" = _Jy1tIxVn;
        "pkg-00.92.10" = _spNCrb4R;
        "pkg-00.93.10" = _dURgRAIl;
        "pkg-00.94.10" = _7v6vjlGu;
        "pkg-00.95.10" = _WuzZqiY6;
        "pkg-00.96.10" = _V1vdjh1L;
        "pkg-1.00.10" = _ud61iq63;
        "pkg-1.01.10" = _p2inNior;
        "pkg-1.02.10" = _wZsHYpwy;
        "pkg-1.03.10" = _NTtcZ0Sx;
        "pkg-1.04.10" = _1xWpHJvB;
        "pkg-1.05.10" = _q6aCVxBx;
        "pkg-1.06.10" = _qupBJfGF;
        "pkg-1.07.10" = _XXXpOM3B;
        "pkg-1.08.10" = _ohkK0Ywe;
        "pkg-1.09.10" = _MPlrTmvX;
        "pkg-1.10.10" = _w2ekRgEP;
        "pkg-1.11.10" = _dN2uh6Yw;
        "pkg-20.5.10" = _DXEf6I3f;
        "pkg-20.6.10" = _y6PtrKVn;
        "pkg-21.8.10" = _bsUPkcRL;
        "pkg-21.10.10" = _Uv4tkMnf;
        "pkg-21.11.10" = _2IWcwX6m;
        "pkg-20.1.10" = _HfH0hvfy;
        "pkg-19.2.10" = _dgW7qVu2;
        "pkg-1.12.10" = _aHaI7jdS;
