...
let
    ...
    in {
        ...
        "pkg-2.3.8" = _FZ4X6Xri;
        "pkg-2.3.9" = _BukjKjVm;
        "pkg-2.3.10" = _j6FqQSD1;
        "pkg-2.3.11" = _YEHXM8xT;
        "pkg-2.4.0" = _lJ4ErPeH;
        "pkg-2.4.2" = _pWxyjuW1;
        "pkg-2.4.3" = _cHf4M00v;
        "pkg-2.4.4" = _UOTjcI9f;
        ...
        "pkg-2.8.2" = _zkp7pQH2;
        "pkg-2.9.0" = _h84Dat6H;
        "pkg-2.10.0" = _XDAjZ1aq;
        "pkg-2.10.2" = _mkv3MGNB;
        "pkg-2.11.0" = _wn4MS9tB;
        "pkg-2.11" = _cba2Z5Fh;
        "pkg-2.12.0" = _OdGHoKvt;
        "pkg-2.10.3" = _mXY4SkHn;
        "pkg-2.11.2" = _BBFr1o5z;
        "pkg-2.12.1" = _JjVcKmMk;
        "pkg-2.12.2" = _GODh2kTx;
        "pkg-2.12.3" = _AlmkhSwg;
        "pkg-2.12.4" = _UWjJ24EY;
        "pkg-2.12.5" = _QJgjBXRW;
        "pkg-3.0.0" = _HJbJPNgF;
        "pkg-2.12.6" = _1PT9Gvgm;
        "pkg-2.12.7" = _saPUb5sQ;
        "pkg-2.12.8" = _RjQTlgPH;
        "pkg-3.0.1" = _qGENohBm;
        "pkg-3.0.2" = _w20ZUEf3;
        "pkg-3.0.3" = _U6TsmNdC;
        "pkg-3.0.4" = _M0XsIP4z;
