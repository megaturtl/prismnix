...
let
    versions = (let
        ...
        _vzgZJJDX = {
            "id" = "vzgZJJDX";
            "file" = "itemalchemy-1.3.4.jar";
            "hash" = "sha512-6D5HscD8H1UdkGWFf/qPgtJLBDGlU17yrVa9tI9FjmTJd8i8JQi7aZKQmJeJX1hkpkS5c8IJIsTcujwliYHMxg==";
        };
        _W4ArNX8x = {
            "id" = "W4ArNX8x";
            "file" = "itemalchemy-1.3.5.jar";
            "hash" = "sha512-hGdmGFSN2RHaY8N94/pESSN1KHyHsS0e0gpd8QkRKxjThvyUd4Mx9NvCim4Av9vR6fmg3pNqxhFQTTgTErnwIg==";
        };
        _go3rwli0 = {
            "id" = "go3rwli0";
            "file" = "itemalchemy-1.3.6.jar";
            "hash" = "sha512-J5fn9Fgq3tSeXCvGBUd9RaKX888pM0Baf42iU9rT9P8lCb2bLYOcfD3slLw06dAJ0C5hov+qBURUBtHRSGwL5g==";
        };
        _JlD7upBi = {
            "id" = "JlD7upBi";
            "file" = "itemalchemy-1.3.7.jar";
            "hash" = "sha512-WoGFwYfySqAfPV9NZDvvV6EsmYUX7ELRAG49F1TJY7MY9FpPSWPzS64+7ovCXGGz6W0X7PzaZB35XJmdFLj6oQ==";
        };
        _iwUk5P2b = {
            "id" = "iwUk5P2b";
            "file" = "itemalchemy-1.3.8.jar";
            "hash" = "sha512-tioHWRXmiceWuUVxysVhNX3hS/9KxfOKFXmlEj8eDvO0icykNyrOy3iB8uXbRVM5TMw1T1aTl8o/P/+78JU5Cw==";
        };
        _Jx0ozTv7 = {
            "id" = "Jx0ozTv7";
            "file" = "itemalchemy-1.3.9.jar";
            "hash" = "sha512-NjTaHfZIrYB43JnQc9Z16+AajbxRbq/lTgvCPT6VcaFhZMH6LbsIJVVwE8gG19WF3AmaMhVTe2tHrUXfZMM+uQ==";
        };
    in {
        "LVVtgxcy" = _LVVtgxcy;
        "YCwKwCaA" = _YCwKwCaA;
        ...
        "iwUk5P2b" = _iwUk5P2b;
        "Jx0ozTv7" = _Jx0ozTv7;
        "fabric-1.18.2" = _Jx0ozTv7;
        "fabric-1.19" = _Jx0ozTv7;
        "fabric-1.19.1" = _Jx0ozTv7;
        "fabric-1.19.2" = _Jx0ozTv7;
        "fabric-1.18" = _Jx0ozTv7;
        "fabric-1.18.1" = _Jx0ozTv7;
        "fabric-1.19.3" = _bok0qThw;
        "fabric-1.17" = _YPhfO6Ov;
        "fabric-1.17.1" = _YPhfO6Ov;
        "fabric-1.19.4" = _bok0qThw;
        "fabric-1.20" = _Jx0ozTv7;
        "fabric-1.20.1" = _Jx0ozTv7;
        "fabric-1.20.2" = _bok0qThw;
        "fabric-1.20.3" = _Jx0ozTv7;
        "fabric-1.20.4" = _Jx0ozTv7;
        "fabric-1.20.6" = _ulKWWAZd;
        "fabric-1.21" = _Jx0ozTv7;
        "fabric-1.21.1" = _Jx0ozTv7;
        "fabric-1.21.2" = _Jx0ozTv7;
        "fabric-1.21.3" = _JlD7upBi;
        "fabric-1.21.4" = _Jx0ozTv7;
        "fabric-1.21.5" = _JlD7upBi;
        "fabric-1.21.6" = _JlD7upBi;
        "fabric-1.21.7" = _JlD7upBi;
        "fabric-1.21.8" = _JlD7upBi;
        "fabric-1.21.9" = _Jx0ozTv7;
        "fabric-1.21.10" = _Jx0ozTv7;
        "fabric-1.21.11" = _Jx0ozTv7;
        "fabric-26.1" = _Jx0ozTv7;
        "fabric-26.1.1" = _Jx0ozTv7;
        "fabric-26.1.2" = _Jx0ozTv7;
        "fabric-26.2" = _Jx0ozTv7;
        "pkg-0.0.5" = _LVVtgxcy;
        "pkg-0.1.0" = _YCwKwCaA;
        "pkg-0.1.1" = _7Ph8Umd5;
        "pkg-0.1.2" = _p0avjh9N;
