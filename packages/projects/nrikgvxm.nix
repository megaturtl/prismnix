...
let
    versions = (let
        ...
        _stLXL2rf = {
            "id" = "stLXL2rf";
            "file" = "particlerain-4.0.0-beta.11+1.20.1-fabric.jar";
            "hash" = "sha512-LTcSz4mlnQgQAGUgpnQkU9H/ZbgtQo61sYfgW9Yz+opWc+Z6E7iYaU0AlNnfkpoWL19Yd7HPYBFGYEe9Q5KmOg==";
        };
        _sgOkgOxv = {
            "id" = "sgOkgOxv";
            "file" = "particlerain-4.0.0-beta.11+26.1-fabric.jar";
            "hash" = "sha512-uxjmFpEhw6fVQwNDSiUNHSJrGvL77PvkczvIY5oNEY0OEilqocsuVNtWUpaaFHdwDGOZ3+GxSqxwkQe1Yae4nA==";
        };
        _7LBHIjGq = {
            "id" = "7LBHIjGq";
            "file" = "particlerain-4.0.0-beta.11+1.21.11-fabric.jar";
            "hash" = "sha512-71u1bXPzAQ/IJ0hBLrYm2Wm476kgjzA/jWvOAY3DdNu8Buh9/pCwti14WQowG1HWS5U4b+Xfo91o2Gx68pRSHQ==";
        };
        _tp0kvCrO = {
            "id" = "tp0kvCrO";
            "file" = "particlerain-4.0.0-beta.11+1.21.1-fabric.jar";
            "hash" = "sha512-vauuYX1gkLWDxwncPyc0m4YrUdI3CNt8vgQV9gUu1FEiq1fqDTR4f83MaLTbRXMlCDcSQajXf1yHM12nGRIyvw==";
        };
        _oPqk9oQ8 = {
            "id" = "oPqk9oQ8";
            "file" = "particlerain-4.0.0-beta.11+26.2-fabric.jar";
            "hash" = "sha512-KQNdB5W9XDf2gTU8QFQ0H1aQZTebmFkFW7fkyk70JZXGpYo2AP681Smkr0a7r2iZhdTzyhUOtP58llwPbGgQfw==";
        };
        _5xdIOAkr = {
            "id" = "5xdIOAkr";
            "file" = "particlerain-4.0.0-beta.11+1.21.9-fabric.jar";
            "hash" = "sha512-loGZ2Vkya1RfpgwA/OedpFa8AH5B/pctyEQQRjRLw7jX3ltOb4WMFflE0UuoYqzbFOQj7DmXvtc2Qnp7KAWmMg==";
        };
        _8QKds2Nf = {
            "id" = "8QKds2Nf";
            "file" = "particlerain-4.0.0-beta.11+1.20.1-forge.jar";
            "hash" = "sha512-B9q8CyQZc3PoRRYLSw1uBzfOYJRgoNyCvUXjbbBVhYk8ex+5WSfpojxAjVeBu7oY3tbdHBPJJ26en87zG0DMJg==";
        };
        _k32OBTlL = {
            "id" = "k32OBTlL";
    ...
    in {
        ...
        "pkg-v2.0.5" = _KcdkYSQo;
        "pkg-v2.0.6" = _mk48bnKc;
        "pkg-v2.0.7" = _8VGNnkMc;
        "pkg-v2.0.8" = _soqqh6x4;
        "pkg-2.1.0" = _7AaI3XuM;
        "pkg-2.1.1" = _W0zsxgKR;
        "pkg-2.1.2" = _UQKVXNOt;
        "pkg-2.1.3" = _M2HbUmHi;
        "pkg-2.1.4" = _LJMP1DZf;
        "pkg-2.1.5-backport" = _Z5dxPW8C;
        "pkg-3.0.0" = _KPSBPWXv;
        "pkg-3.0.1" = _He1DHjNA;
        "pkg-V3.0.2" = _Ktbv9jUL;
        "pkg-3.0.3" = _ImBtVgHk;
        "pkg-3.0.4" = _ELbfjYzE;
        "pkg-3.0.5-1.20" = _qjs7z4oe;
        "pkg-3.0.5" = _SApJHIsL;
        "pkg-3.0.6" = _bYlwWGuq;
        "pkg-3.0.6-1.21.2" = _339KfQQg;
        "pkg-3.0.6-1.20" = _lwOTe5KX;
        "pkg-3.0.7" = _3Vf1pVuS;
        "pkg-3.0.8" = _9RQDEBUJ;
        "pkg-3.1.0" = _U9aTnXXf;
        "pkg-3.2.0" = _I7lzBjrj;
        ...
        "pkg-3.3.5" = _zU0KyNqy;
        "pkg-3.3.6" = _xvreDfAp;
        "pkg-4-alpha.2+1.20.1-fabric" = _DmbGdlpU;
        "pkg-4-alpha.2+1.21.6-fabric" = _4pnDyRUf;
        "pkg-4-alpha.2+1.21.5-fabric" = _PF5Kbvzd;
        "pkg-4-alpha.2+1.21.1-fabric" = _jQWbeVLd;
        "pkg-4-alpha.2+1.21.4-fabric" = _e2Yn4vp2;
        "pkg-4-alpha.2+1.21.1-neoforge" = _mhruDX1E;
        "pkg-4-alpha.2+1.21.4-neoforge" = _mQjfScDM;
        "pkg-4-alpha.2+1.20.1-forge" = _UsNoYJDT;
        "pkg-4-alpha.2+1.21.5-neoforge" = _5fhuFfS7;
        "pkg-4-alpha.2+1.21.6-neoforge" = _sQDAGE6J;
        "pkg-v4-alpha.3+1.21.6-fabric" = _Bux7BdAb;
        "pkg-v4-alpha.3+1.21.4-fabric" = _zGLKfTB2;
        "pkg-v4-alpha.3+1.21.1-fabric" = _1X9QxTCk;
        "pkg-v4-alpha.3+1.21.5-fabric" = _xXsILcdJ;
        "pkg-v4-alpha.3+1.20.1-fabric" = _BOR3r76X;
        "pkg-v4-alpha.3+1.21.4-neoforge" = _8HhvbDGu;
        "pkg-v4-alpha.3+1.21.1-neoforge" = _tVjgbLg5;
        "pkg-v4-alpha.3+1.21.5-neoforge" = _VIwOgRWj;
        "pkg-v4-alpha.3+1.21.6-neoforge" = _S1YXoJEZ;
        "pkg-v4-alpha.3+1.20.1-forge" = _5GKT9zMT;
        "pkg-v4-beta.1+1.20.1-fabric" = _ofJ6Mt4N;
        "pkg-v4-beta.1+1.21.4-fabric" = _gzXJrY4A;
        "pkg-v4-beta.1+1.21.6-fabric" = _Zsoifl92;
        "pkg-v4-beta.1+1.21.5-fabric" = _HgmQxuRE;
        "pkg-v4-beta.1+1.21.1-fabric" = _LV651mab;
        "pkg-v4-beta.1+1.21.1-neoforge" = _5n3tVt2M;
        "pkg-v4-beta.1+1.21.5-neoforge" = _4Q5Nuk3J;
        "pkg-v4-beta.1+1.21.6-neoforge" = _4gA0KRqJ;
        "pkg-v4-beta.1+1.21.4-neoforge" = _ay9e9lxt;
        "pkg-v4-beta.1+1.20.1-forge" = _rEQRStq5;
        "pkg-v4-beta.2+1.21.6-fabric" = _YM8FexDc;
        "pkg-v4-beta.2+1.21.5-fabric" = _I43g5KTN;
        "pkg-v4-beta.2+1.21.1-fabric" = _16oSWtZM;
        "pkg-v4-beta.2+1.21.4-fabric" = _14SBzLeY;
        "pkg-v4-beta.2+1.20.1-fabric" = _pQkdl3xK;
        "pkg-v4-beta.2+1.21.4-neoforge" = _AOH1ICM6;
        "pkg-v4-beta.2+1.21.1-neoforge" = _LkDrkOSW;
        "pkg-v4-beta.2+1.21.6-neoforge" = _YQqznhsW;
        "pkg-v4-beta.2+1.21.5-neoforge" = _VgKDAh6G;
        "pkg-v4-beta.2+1.20.1-forge" = _UVdSzAjC;
        "pkg-v4-beta.3+1.21.9-fabric" = _T7ZsTurO;
        "pkg-v4-beta.3+1.21.6-fabric" = _szt5YL1u;
        "pkg-v4-beta.3+1.21.5-fabric" = _YGre6KDm;
        "pkg-v4-beta.3+1.21.1-fabric" = _dnj8eTAw;
        "pkg-v4-beta.3+1.20.1-fabric" = _cGaEo5dv;
        "pkg-v4-beta.3+1.21.4-fabric" = _NzMAN55Q;
        "pkg-v4-beta.3+1.21.6-neoforge" = _D1c330Jr;
        "pkg-v4-beta.3+1.21.5-neoforge" = _fVDQvVdl;
        "pkg-v4-beta.3+1.21.1-neoforge" = _Uf3Px9g6;
        "pkg-v4-beta.3+1.21.4-neoforge" = _SsuthDbW;
        "pkg-v4-beta.3+1.20.1-forge" = _aFwRYRIm;
        "pkg-v4-beta.4+1.21.4-fabric" = _RS6o16HF;
        "pkg-v4-beta.4+1.21.9-fabric" = _e1L2XR8s;
        "pkg-v4-beta.4+1.21.6-fabric" = _FKknb8UQ;
        "pkg-v4-beta.4+1.20.1-fabric" = _yXJPOEqp;
        "pkg-v4-beta.4+1.21.1-fabric" = _BH4d5cKl;
        "pkg-v4-beta.4+1.21.11-fabric" = _wTAcV6TD;
        "pkg-v4-beta.4+1.21.5-fabric" = _r4mAt87A;
        "pkg-v4-beta.4+1.21.4-neoforge" = _SKDEmCaD;
        "pkg-v4-beta.4+1.21.1-neoforge" = _B15BENYO;
        "pkg-v4-beta.4+1.21.5-neoforge" = _d0NeV583;
        "pkg-v4-beta.4+1.21.6-neoforge" = _pUNKnKso;
        "pkg-v4-beta.5+1.21.11-fabric" = _8kdLx5yJ;
        "pkg-v4-beta.5+1.21.5-fabric" = _F7Tp2OMN;
        "pkg-v4-beta.5+1.20.1-fabric" = _VDLJj4NA;
        "pkg-v4-beta.5+1.21.1-fabric" = _UrZSj6yQ;
        "pkg-v4-beta.5+1.21.9-fabric" = _CfVqj6qx;
        "pkg-v4-beta.5+1.21.4-fabric" = _gTRjRRX0;
        "pkg-v4-beta.5+1.21.6-fabric" = _W7zsypqm;
        "pkg-v4-beta.5+1.21.1-neoforge" = _b2Zkt9Q2;
        "pkg-v4-beta.5+1.21.4-neoforge" = _FEWQdOb2;
        "pkg-v4-beta.5+1.21.5-neoforge" = _oEJatfAt;
        "pkg-v4-beta.5+1.21.6-neoforge" = _eTPStSLa;
        "pkg-v4-beta.5+1.20.1-forge" = _DoKcxpR8;
        "pkg-v4-beta.6+1.21.11-fabric" = _N6rZWjVk;
        "pkg-v4-beta.6+1.20.1-fabric" = _xrgcdsyD;
        "pkg-v4-beta.6+1.21.4-fabric" = _TOdxOsSX;
        "pkg-v4-beta.6+1.21.9-fabric" = _tcL5O4zL;
        "pkg-v4-beta.6+1.21.6-fabric" = _9mVeY11W;
        "pkg-v4-beta.6+1.21.1-fabric" = _Vq1Dt2H5;
        "pkg-v4-beta.6+1.21.5-fabric" = _UbrQcLI4;
        "pkg-v4-beta.6+1.21.4-neoforge" = _rchlbch7;
        "pkg-v4-beta.6+1.21.1-neoforge" = _IroEdHb4;
        "pkg-v4-beta.6+1.21.5-neoforge" = _7uSSoP0Z;
        "pkg-v4-beta.6+1.21.6-neoforge" = _UKXpSwUu;
        "pkg-v4-beta.6+1.20.1-forge" = _DdUWmVDI;
        "pkg-v4-beta.7+1.21.5-fabric" = _CI0eyoQQ;
        "pkg-v4-beta.7+1.21.1-fabric" = _xdXAUXtv;
        "pkg-v4-beta.7+1.20.1-fabric" = _9aVNyHv0;
        "pkg-v4-beta.7+1.21.11-fabric" = _NNyYKfAy;
        "pkg-v4-beta.7+1.21.4-fabric" = _NrGbz2Rc;
        "pkg-v4-beta.7+26.1-fabric" = _xwptclXn;
        "pkg-v4-beta.7+1.21.9-fabric" = _hDUevN45;
        "pkg-v4-beta.7+1.21.6-fabric" = _kf7TLOle;
        "pkg-v4-beta.7+1.21.5-neoforge" = _20Wx07lq;
        "pkg-v4-beta.7+1.21.6-neoforge" = _3tMxtvEU;
        "pkg-v4-beta.7+1.21.4-neoforge" = _RX5XL0dm;
        "pkg-v4-beta.7+1.20.1-forge" = _GiPSZfbG;
        "pkg-v4-beta.7+1.21.1-neoforge" = _zo7mfCFR;
        "pkg-v4-beta.8+1.21.11-fabric" = _pCWIHve8;
        "pkg-v4-beta.8+1.20.1-fabric" = _SnQA2LFh;
        "pkg-v4-beta.8+26.1-fabric" = _7LmfzP5X;
        "pkg-v4-beta.8+1.21.1-fabric" = _KOGYxxig;
        "pkg-v4-beta.8+1.21.9-fabric" = _wkk4UHFC;
        "pkg-v4-beta.8+1.21.1-neoforge" = _F8VbK5pu;
        "pkg-v4-beta.8+1.20.1-forge" = _ftqsRgdY;
        "pkg-v4-beta.9+1.21.11-fabric" = _HDPId4fr;
        "pkg-v4-beta.9+26.1-fabric" = _zdqUZYnk;
        "pkg-v4-beta.9+1.20.1-fabric" = _wK6MEaOR;
        "pkg-v4-beta.9+1.21.9-fabric" = _2VCwDjcS;
        "pkg-v4-beta.9+1.21.1-fabric" = _k34MIxqO;
        "pkg-v4-beta.9+1.21.1-neoforge" = _AqUoRBvS;
        "pkg-v4-beta.9+1.20.1-forge" = _JcbS10c5;
        "pkg-v4-beta.10+1.21.9-fabric" = _hV0zmwD7;
        "pkg-v4-beta.10+1.21.1-fabric" = _ddaOLHgq;
        "pkg-v4-beta.10+1.20.1-fabric" = _dwnj5IL9;
        "pkg-v4-beta.10+1.21.11-fabric" = _GqrSVERU;
        "pkg-v4-beta.10+26.1-fabric" = _s4RPlVYL;
        "pkg-v4-beta.10+1.21.1-neoforge" = _CJeVXIae;
        "pkg-v4-beta.10+1.20.1-forge" = _t4FtGT1K;
        "pkg-v4-beta.11+1.20.1-fabric" = _stLXL2rf;
        "pkg-v4-beta.11+26.1-fabric" = _sgOkgOxv;
        "pkg-v4-beta.11+1.21.11-fabric" = _7LBHIjGq;
        "pkg-v4-beta.11+1.21.1-fabric" = _tp0kvCrO;
        "pkg-v4-beta.11+26.2-fabric" = _oPqk9oQ8;
