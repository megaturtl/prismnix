...
let
    ...
    in {
        ...
        "neoforge-26.3-snapshot-1" = _zh7ntWRf;
        "neoforge-26.3-snapshot-2" = _zh7ntWRf;
        "neoforge-26.3-snapshot-3" = _zh7ntWRf;
        "neoforge-26.3-snapshot-4" = _zh7ntWRf;
        "neoforge-26.3-snapshot-5" = _zh7ntWRf;
        "neoforge-26.3-snapshot-6" = _zh7ntWRf;
        "neoforge-26.3-snapshot-7" = _zh7ntWRf;
        "neoforge-26.3-snapshot-8" = _zh7ntWRf;
        "neoforge-26.3-snapshot-9" = _zh7ntWRf;
        "neoforge-26.3-snapshot-10" = _zh7ntWRf;
        "neoforge-26.3-pre-1" = _zh7ntWRf;
        "neoforge-26.3-pre-2" = _zh7ntWRf;
        ...
        "fabric-26.3-snapshot-1" = _CKG37Wp7;
        "fabric-26.3-snapshot-2" = _CKG37Wp7;
        "fabric-26.3-snapshot-3" = _CKG37Wp7;
        "fabric-26.3-snapshot-4" = _CKG37Wp7;
        "fabric-26.3-snapshot-5" = _CKG37Wp7;
        "fabric-26.3-snapshot-6" = _CKG37Wp7;
        "fabric-26.3-snapshot-7" = _CKG37Wp7;
        "fabric-26.3-snapshot-8" = _CKG37Wp7;
        "fabric-26.3-snapshot-9" = _CKG37Wp7;
        "fabric-26.3-snapshot-10" = _CKG37Wp7;
        "fabric-26.3-pre-1" = _CKG37Wp7;
        "fabric-26.3-pre-2" = _CKG37Wp7;
        "pkg-1.0.0" = _Q31EL0xH;
        "pkg-1.0.1" = _YHbjbRf4;
        "pkg-1.1.0" = _C1mCxRn1;
        "pkg-2.0.0" = _DLPIaw9l;
