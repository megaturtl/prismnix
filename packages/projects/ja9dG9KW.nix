...
let
    ...
    in {
        ...
        "pkg-0.3.0+mc26.1" = _PEcUWTSR;
        "pkg-0.3.1+mc1.21.11" = _tj4FyAaH;
        "pkg-0.3.1+mc1.21.9" = _kYFGupLk;
        "pkg-0.3.1+mc26.1" = _B06RMcSI;
        "pkg-0.3.2+mc1.21.11" = _PFCXVRXD;
        "pkg-0.3.2+mc1.21.9" = _OVhmhMvJ;
        "pkg-0.3.2+mc26.1" = _kH7DWCDe;
        "pkg-0.3.3+mc1.21.11" = _yi892r60;
        "pkg-0.3.3+mc1.21.9" = _8Ug3LBsg;
        "pkg-0.3.3+mc26.1" = _wcip6ZoA;
        "pkg-0.3.4+mc1.21.11" = _ud0NfwTs;
        "pkg-0.3.4+mc1.21.9" = _kS4YJPen;
        "pkg-0.3.4+mc26.1" = _SZ9rbQOz;
        "pkg-0.3.5+mc1.21.11" = _tI6zBzYa;
        "pkg-0.3.5+mc1.21.9" = _uyXvrGvz;
        "pkg-0.3.5+mc26.1" = _t0Rb4R9j;
        "pkg-0.4.0-beta.1+mc1.21.11" = _AqSabVy6;
        "pkg-0.4.0-beta.1+mc1.21.9" = _a6o6RLfB;
        "pkg-0.4.0-beta.1+mc26.1" = _opJ2MTMF;
        "pkg-0.4.1-beta.1+mc1.21.11" = _Xd55hWG0;
        "pkg-0.4.1-beta.1+mc1.21.9" = _E5u1gWKz;
        "pkg-0.4.1-beta.1+mc26.1" = _107lV94E;
        "pkg-0.5.0-beta.1+mc1.21.11" = _dmoDbJ6J;
