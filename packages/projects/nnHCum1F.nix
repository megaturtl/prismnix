...
let
    ...
    in {
        ...
        "pkg-1.2.0+1.21" = _Bvbx3BJm;
        "pkg-1.3.0-alpha+1.20.6" = _XWUAC2dC;
        "pkg-1.3.1+1.20.6" = _js61ZbcZ;
        "pkg-1.3.1+1.21.1" = _47laNo6E;
        "pkg-1.3.1+1.21.3" = _JW5QsCRT;
        "pkg-1.3.3+1.21" = _UmgfD1vC;
        "pkg-1.3.4-alpha+1.21" = _Pm0L2mVS;
        "pkg-1.3.4+1.20" = _EdMnLVl3;
        "pkg-1.3.4+1.21" = _8TIz9LLX;
        "pkg-1.3.4+1.20.x" = _fOUUTZ46;
        "pkg-1.4.1+1.20.x" = _Hfiug4lW;
        "pkg-1.4.1+1.21.2" = _QLSEIQbv;
        "pkg-1.4.1+1.21" = _vah8JzE6;
        "pkg-1.4.1-alpha+1.21.6" = _4OtpPXU0;
        "pkg-1.4.2+1.20.1" = _Lvuwx6y4;
        "pkg-1.5.2+1.21.6" = _aF5vjrYL;
        "pkg-1.4.1+1.21.5" = _BN1FtabG;
