...
let
    ...
    in {
        ...
        "pkg-1.19.2" = _gQtyoVwq;
        "pkg-1.19" = _jdjw5YZW;
        "pkg-1.18" = _bNFBN35h;
        "pkg-1.17" = _bLFyud6T;
        "pkg-1.16.3" = _nYeR3qXR;
        "pkg-1.16.1.1" = _BXiTAorU;
        "pkg-1.16.1" = _WOgWtale;
        "pkg-1.15.2.0" = _egAC4d1n;
        "pkg-1.12.2.5" = _wXOz44n0;
        "pkg-1.14.4.2" = _6NUCoChg;
        "pkg-1.14.4.1" = _nm9BcaDP;
        "pkg-1.14.4.0" = _OVTpceg5;
        "pkg-1.12.2.4" = _nQW0sAyR;
        "pkg-1.12.2.3" = _3YA3hEqj;
        "pkg-1.12.2.2" = _AZUR50KZ;
        "pkg-1.12.2.1" = _vx2dWz9r;
        "pkg-1.12.2.0" = _9mD5iJXc;
        "pkg-1.20.0" = _OaIhyW40;
        "pkg-1.20.2.0" = _A4PK4coB;
        "pkg-2.0.0" = _XLOkhHPN;
        "pkg-2.0.1" = _mcVbAoId;
        "pkg-2.0.2" = _1pm9Wf9Z;
