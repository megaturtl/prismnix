...
let
    ...
    in {
        ...
        "pkg-3.0.0.21" = _MEuJsyBu;
        "pkg-3.0.0.31" = _b4Gi4O5g;
        "pkg-3.0.0.45" = _qa6qANML;
        "pkg-3.0.0.48" = _3bQjgKk0;
        "pkg-3.0.0.24" = _HQBnhQpM;
        "pkg-3.0.0.26" = _VZRvVOD3;
        "pkg-3.0.1.68" = _B7uwRPZ2;
        "pkg-3.0.1.71" = _d0J5blNb;
        "pkg-3.0.1.81" = _6IRHoC21;
        "pkg-3.0.1.83" = _ZAieqiWB;
        "pkg-3.0.1.86" = _34YBgycL;
        "pkg-3.0.1.88" = _lPLhq6Q8;
        "pkg-3.0.1.97" = _4faVbcd1;
        "pkg-3.0.1.103" = _ioUXeCYz;
        "pkg-3.0.1.108" = _3jMy03sd;
        "pkg-2.0.1" = _GbSGbzSB;
        "pkg-3.0.2.68" = _BVtp5gTn;
        "pkg-3.0.2.71" = _RELmU7Z4;
        "pkg-3.0.2.81" = _7c5GXHdV;
        "pkg-3.0.2.83" = _RXBKNJZS;
        "pkg-3.0.2.86" = _umbHso1n;
        "pkg-3.0.2.88" = _cjvd7VZC;
        "pkg-3.0.2.97" = _uoL3FQcb;
        "pkg-3.0.2.103" = _xAo2Ts3O;
        "pkg-3.0.2.108" = _5Nyc3pyN;
        "pkg-3.5.0-beta" = _6VrfeDXO;
        "pkg-3.5.1-beta" = _sflUikbo;
