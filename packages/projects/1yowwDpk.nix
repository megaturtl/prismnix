...
let
    versions = (let
        ...
        _v6i1KBiV = {
            "id" = "v6i1KBiV";
            "file" = "CustomDiscs-2.7.0.jar";
            "hash" = "sha512-bki8kGi/wK/9b0/qsOb+asQenEy7G6Ly6hywbOIobnyoSkj4Whj5OPyoNymkWKp104HCLIprNQxiMVEtN8WO0Q==";
        };
    in {
        "kCcRB7Vh" = _kCcRB7Vh;
        "gnfwMZ9y" = _gnfwMZ9y;
        ...
        "folia-1.21.6" = _v6i1KBiV;
        "folia-1.21.7" = _v6i1KBiV;
        "folia-1.21.8" = _v6i1KBiV;
        "folia-1.21.9" = _v6i1KBiV;
        "folia-1.21.10" = _v6i1KBiV;
        "folia-1.21.11" = _v6i1KBiV;
        "folia-26.1" = _v6i1KBiV;
        "folia-26.1.1" = _v6i1KBiV;
        "folia-26.1.2" = _v6i1KBiV;
        "folia-26.2" = _v6i1KBiV;
        ...
        "paper-1.21.6" = _v6i1KBiV;
        "paper-1.21.7" = _v6i1KBiV;
        "paper-1.21.8" = _v6i1KBiV;
        "paper-1.21.9" = _v6i1KBiV;
        "paper-1.21.10" = _v6i1KBiV;
        "paper-1.21.11" = _v6i1KBiV;
        "paper-26.1" = _v6i1KBiV;
        "paper-26.1.1" = _v6i1KBiV;
        "paper-26.1.2" = _v6i1KBiV;
        "paper-26.2" = _v6i1KBiV;
        ...
        "purpur-1.21.6" = _v6i1KBiV;
        "purpur-1.21.7" = _v6i1KBiV;
        "purpur-1.21.8" = _v6i1KBiV;
        "purpur-1.21.9" = _v6i1KBiV;
        "purpur-1.21.10" = _v6i1KBiV;
        "purpur-1.21.11" = _v6i1KBiV;
        "purpur-26.1" = _v6i1KBiV;
        "purpur-26.1.1" = _v6i1KBiV;
        "purpur-26.1.2" = _v6i1KBiV;
        "purpur-26.2" = _v6i1KBiV;
        ...
        "pkg-2.1.8" = _4pQ7RTxY;
        "pkg-2.1.9" = _FJqlrDZW;
        "pkg-2.1.10" = _HZRC0QCR;
        "pkg-2.1.11" = _78FgwGRz;
        "pkg-2.1.12" = _Fzxq01Hs;
        "pkg-2.2.0" = _WSNw4MFv;
        "pkg-2.3.0" = _z6FjLVv1;
        "pkg-2.4.0" = _FaVH0dRU;
        "pkg-2.4.1" = _vH5ywhsi;
