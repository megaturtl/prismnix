...
let
    ...
    in {
        ...
        "pkg-1.2.0+1.21.5" = _ujBGFyaF;
        "pkg-1.0.2+1.20.1" = _4mIq0ti1;
        "pkg-1.1.1+1.21.1" = _jxlNtONH;
        "pkg-1.2.1+1.21.5" = _Itm6qh3V;
        "pkg-1.0.3+1.20.1" = _5kc1fP8X;
        "pkg-1.1.2+1.21.1" = _BJDPqscu;
        "pkg-1.2.2+1.21.5" = _RSooMlW2;
        "pkg-1.3.0+1.21.8" = _wtXmwZVk;
        "pkg-1.0.4+1.20.1" = _thlkX5KZ;
        "pkg-1.1.3+1.21.1" = _q520KBrU;
        "pkg-1.2.3+1.21.5" = _ST18nG5n;
        "pkg-1.3.1+1.21.8" = _LMX5juAf;
        "pkg-1.1.4+1.21.1" = _rDGqpB59;
        "pkg-1.2.4+1.21.5" = _eMLgEFS0;
        "pkg-1.3.2+1.21.8" = _lQ8M7iKM;
        "pkg-1.0.5+1.20.1" = _2sS38HSx;
        "pkg-1.1.5+1.21.1" = _YX4bFLTI;
        "pkg-1.2.5+1.21.5" = _dlRifejK;
        "pkg-1.3.3+1.21.8" = _OVl4ik2r;
        "pkg-1.0.6+1.20.1" = _C6OboeOa;
        "pkg-1.1.6+1.21.1" = _FynXSNAS;
        "pkg-1.2.6+1.21.5" = _EJpkxOQf;
        "pkg-1.3.4+1.21.8" = _rH4bmL3m;
        "pkg-1.2.7+1.21.5" = _izdenXtU;
        "pkg-1.1.7+1.21.1" = _qTUfKUYw;
        "pkg-1.2.8+1.21.5" = _eMoKPxOM;
        "pkg-1.3.5+1.21.8" = _A41PfjGl;
        "pkg-1.4.0+1.21.9" = _YkacnwQU;
        "pkg-1.4.0+1.21.10" = _lfjgL4u5;
