...
let
    versions = (let
        ...
        _gNtjiVyH = {
            "id" = "gNtjiVyH";
            "file" = "XK redstone display 26.3.0.zip";
            "hash" = "sha512-7NhCAa1tcgdtsFxZttKyD2LhSaBaF9NgmLYEO+4yEmzSOpUKSsvBdnjcsfK5EL9TLDTf14tXcaX1KhU7l59UBg==";
        };
    in {
        "XG1uL7gb" = _XG1uL7gb;
        "h20zVsYL" = _h20zVsYL;
        ...
        "minecraft-1.20.3" = _gNtjiVyH;
        "minecraft-1.20.4" = _gNtjiVyH;
        "minecraft-1.20.5" = _gNtjiVyH;
        "minecraft-1.20.6" = _gNtjiVyH;
        "minecraft-1.21" = _gNtjiVyH;
        "minecraft-1.21.1" = _gNtjiVyH;
        "minecraft-1.21.2" = _gNtjiVyH;
        "minecraft-1.21.3" = _gNtjiVyH;
        "minecraft-1.21.4" = _gNtjiVyH;
        "minecraft-1.21.5-pre1" = _HU2SjnfC;
        "minecraft-1.21.5-pre2" = _HU2SjnfC;
        "minecraft-1.21.5" = _gNtjiVyH;
        "minecraft-1.21.6" = _gNtjiVyH;
        "minecraft-1.21.7" = _gNtjiVyH;
        "minecraft-1.21.8" = _gNtjiVyH;
        "minecraft-1.21.9" = _gNtjiVyH;
        "minecraft-1.21.10" = _gNtjiVyH;
        "minecraft-1.21.11" = _gNtjiVyH;
        "minecraft-26.1" = _gNtjiVyH;
        "minecraft-26.1.1" = _gNtjiVyH;
        "minecraft-26.1.2" = _gNtjiVyH;
        "minecraft-26.2" = _gNtjiVyH;
        "minecraft-26.3-snapshot-1" = _gNtjiVyH;
        "minecraft-26.3-snapshot-2" = _gNtjiVyH;
        "minecraft-26.3-snapshot-3" = _gNtjiVyH;
        "minecraft-26.3-snapshot-4" = _gNtjiVyH;
        "minecraft-26.3-snapshot-5" = _gNtjiVyH;
        "minecraft-26.3-snapshot-6" = _gNtjiVyH;
        "minecraft-26.3-snapshot-7" = _gNtjiVyH;
        "minecraft-26.3-snapshot-8" = _gNtjiVyH;
        "minecraft-26.3-snapshot-9" = _gNtjiVyH;
        "minecraft-26.3-snapshot-10" = _gNtjiVyH;
        "pkg-3.0" = _rKm2F2Hf;
        "pkg-3.1" = _kxThqx5g;
        "pkg-3.2" = _q1I1TESL;
        "pkg-3.3" = _qVmM4omg;
        ...
        "pkg-3.6" = _HU2SjnfC;
        "pkg-v26.0" = _Nom2gvDL;
        "pkg-v26.0.1" = _JLIeAMSy;
        "pkg-26.1.5" = _PczRKsKy;
        "pkg-26.3.0" = _gNtjiVyH;
        "default" = _gNtjiVyH;
    });
