...
let
    ...
    in {
        ...
        "pkg-1.3.0" = _SiCWL2Nc;
        "pkg-1.3.1" = _yDxbbwQp;
        "pkg-1.3.1+1.18" = _4dyoLLuu;
        "pkg-1.3.1+1.18.2" = _LjduZHIa;
        "pkg-1.3.2+1.18.2" = _tGALmMq1;
        "pkg-1.3.3+1.19-rc2" = _VRgaEGZo;
        "pkg-1.3.4+1.19.1" = _xS3rNhRJ;
        "pkg-2.0.0-beta.1+1.19.2" = _V2EDLXSk;
        "pkg-2.0.0-beta.2+1.19.2" = _yTXQr8xi;
        "pkg-2.0.0-beta.3+1.19.2" = _SrjZOVY2;
        "pkg-2.0.0-beta.4+1.19.2" = _s5C1tLXG;
        "pkg-2.0.0+1.19.2" = _hq66rp1V;
        "pkg-2.1.0+1.19.3-rc1" = _Ls1seC6m;
        "pkg-2.0.0-legacy+1.18.2" = _mctK04mp;
        "pkg-2.1.0+1.19.4-rc2" = _fZzVAguT;
        "pkg-2.1.1+1.20-rc1" = _i2MmbgPj;
        "pkg-2.0.1+1.19.2" = _xlfGl98v;
        "pkg-2.1.2+1.20.1" = _Y5FxlBx7;
        "pkg-2.2.0+1.20.2-rc2" = _G5aywGwR;
        "pkg-2.3.0+1.20.3-rc1" = _GwsOPBYy;
        "pkg-2.4.0+1.20.5-rc3" = _o2qzOYfA;
        "pkg-2.1.3+1.20.1" = _Dau5rJnL;
        "pkg-2.4.1+1.20.6" = _4uzy8Fqa;
        "pkg-2.5.0+1.21-rc1" = _lp2JxZ4N;
        "pkg-2.5.1+1.21.1" = _b83teBdW;
        "pkg-2.6.0+1.21.2-rc1" = _ydEKVfE3;
        "pkg-2.7.0+1.21.4-rc1" = _EPNBOZZ7;
        "pkg-2.5.2+1.21.1" = _ZzePnCo3;
        "pkg-2.8.0+1.21.5-rc1" = _62aDXxe8;
        "pkg-2.9.0+1.21.6" = _VXUPjv4p;
        "pkg-2.10.0+1.21.9-pre4" = _2SDNXDXK;
        "pkg-2.11.0+1.21.11-pre3" = _5X4DRc0u;
        "pkg-2.11.1+1.21.11" = _RzBDTvOT;
