...
let
    ...
    in {
        ...
        "pkg-1.3.2" = _M32flrEg;
        "pkg-1.3.5" = _p3GZlKoG;
        "pkg-1.19.2-2-1.5.0-server" = _XCLEVwq7;
        "pkg-1.19.2-2-1.5.1" = _PWmsD6on;
        "pkg-1.19.2-2-1.5.8" = _dFKFTiAu;
        "pkg-1.19.2-2-1.6.0" = _59oHlUQa;
        "pkg-1.19.2-2-1.6.5" = _EEwck1gG;
        "pkg-1.20-3-1.0.2" = _VhpPLfgB;
        "pkg-1.20.1-3-1.1.5" = _TngB6iwx;
        "pkg-1.20.1-3-1.2.0" = _lA5Y2uSJ;
        "pkg-1.20.1-3-1.2.7" = _GmmgVSbL;
        "pkg-1.19.2-4-1.0.0" = _FNSJTvhF;
        "pkg-1.20.1-3-1.2.8" = _1D80y6iZ;
        "pkg-1.20.1-3-1.3.0" = _2E1d6gjO;
        "pkg-1.19.4-5-1.0.0" = _4x3AqhFA;
        "pkg-1.19.2-4-1.0.5" = _JuLxigzP;
        "pkg-1.20.1-3-1.4.0" = _XGfM7pg2;
        "pkg-1.20.1-3-1.4.5" = _QHWFJxcO;
        "pkg-1.19.2-4-1.1.5" = _75F34adq;
        "pkg-1.20.1-3-1.5.0" = _CjwBTjnb;
        "pkg-1.20.1-3-1.6.0" = _tXZoGaHN;
        "pkg-1.20.1-3-1.6.6" = _VVNc8OqQ;
        "pkg-1.20.1-3-1.7.0" = _oCBqLFkM;
        "pkg-1.19.2-4-1.2.5" = _u4vrBWup;
        "pkg-1.20.1-3-1.7.5" = _F3EcoAjH;
        "pkg-1.20.1-3-1.8.0" = _aR9exMBh;
        "pkg-1.19.2-4-1.3.0" = _9LK0uOd1;
        "pkg-1.19.2-4-1.3.1" = _sB5jjJ31;
        "pkg-1.19.2-4-1.3.2" = _Azmc8lo5;
        "pkg-1.20.1-3-1.9.5" = _GCtSbX1W;
        "pkg-1.19.2-4-1.3.7" = _J6sMMU9S;
        "pkg-1.20.1-3-2.0.0" = _dPWHzJ6R;
        "pkg-1.19.2-4-1.4.0" = _qW0KmN3I;
        "pkg-1.20.1-3-2.0.5" = _lIQ2lbav;
        "pkg-1.20.1-3-2.0.6" = _oMVfZBEX;
        "pkg-1.20.1-3-2.0.7" = _TSIZjdGc;
        "pkg-1.20.1-3-2.1.5" = _NbPgv08z;
        "pkg-1.20.1-3-2.2.0" = _O2mty5OM;
        "pkg-1.20.1-3-2.2.7" = _PwOOGhGn;
        "pkg-1.20.1-3-2.3.0" = _vzsI4MTa;
        "pkg-1.20.1-3-2.3.5" = _krp5YKqC;
        "pkg-1.20.1-3-2.3.8" = _KD321a44;
        "pkg-1.20.1-3-2.4.0" = _DKxIvVd3;
        "pkg-1.20.1-3-2.5.0" = _27rGOgOz;
        "pkg-1.19.2-4-1.4.5" = _vqpDBRtS;
        "pkg-1.20.1-3-2.5.5" = _OlhC1paL;
        "pkg-1.0.0-Neo" = _ixBzbMZE;
        "pkg-1.0.5-Neo" = _Zg9uRrLY;
        "pkg-1.1.0-Neo" = _lIWvGZWX;
        "pkg-1.1.1-Neo" = _iRjoqZA0;
        "pkg-1.20.1-4-1.0.0" = _RxShcp3p;
        "pkg-1.20.1-4-1.1.0" = _VfgNGTZz;
        "pkg-1.20.1-4-1.1.5" = _FwxYZ0PN;
        "pkg-1.20.1-4-1.2.0" = _j1hojhvn;
        "pkg-1.20.1-4-1.3.1" = _mzSAKy5M;
        "pkg-1.20.1-4-1.3.7" = _igRN13z3;
        "pkg-1.20.1-4-1.5.0" = _wlxACKnp;
        "pkg-1.20.1-4-1.5.5" = _a9ipE128;
        "pkg-1.20.1-4-1.6.5" = _Lgt3B7gd;
        "pkg-1.20.1-4-1.7.5" = _HqJ038LQ;
        "pkg-1.20.1-4-1.7.7" = _R0t718PS;
        "pkg-1.20.1-4-1.8.0" = _yWyHV1wm;
        "pkg-1.20.1-4-1.8.3" = _EdvWcqqQ;
        "pkg-1.20.1-4-1.9.0" = _SjHl1GGM;
        "pkg-1.20.1-4-1.9.2" = _WT449Oq2;
        "pkg-1.20.1-4-1.9.5" = _PxLbICvf;
        "pkg-1.20.1-4-1.9.8" = _kW1zHxK6;
        "pkg-1.20.1-4-2.0.0" = _E5aBGR8P;
        "pkg-1.20.1-4-2.0.5" = _ZvHqfnVZ;
        "pkg-1.1.0.1" = _LX1XbxjL;
        "pkg-1.1.1.1" = _8QtDBqx5;
        "pkg-1.1.1.2" = _6jebHKPy;
        "pkg-1.1.1.5" = _rFCegNLS;
        "pkg-1.1.1.6" = _RaATgFAA;
        "pkg-1.1.2.1" = _XllZP4tm;
        "pkg-1.1.2.3" = _GuhrSBto;
        "pkg-1.1.2.4" = _7sHeobuV;
        "pkg-1.1.2.5" = _IeC8589K;
        "pkg-1.1.2.6" = _Bn304VJp;
        "pkg-1.1.2.7" = _E2qq8xNT;
        "pkg-1.1.2.8" = _w6SZv5Lh;
        "pkg-1.1.3.0" = _zReeFMDi;
        "pkg-1.1.3.1" = _M47kyxmG;
        "pkg-1.1.3.5" = _uwczdGRt;
        "pkg-1.1.4.0" = _gcFOFlm2;
        "pkg-1.1.4.2" = _fuD8GJz3;
        "pkg-1.1.4.8" = _s2Ffevw4;
        "pkg-1.1.5.6" = _BDC0lcqr;
        "pkg-1.0.0.0-neoforge" = _oNeuvs93;
        "pkg-1.1.5.7" = _laBWULHt;
        "pkg-1.1.6.5" = _TILO6NEG;
        "pkg-1.1.6.7" = _qg4TnO1x;
        "pkg-1.0.0.5" = _mqzYzAZX;
        "pkg-1.0.1.1" = _rzqAXUeL;
        "pkg-1.1.7.2" = _s7FwiuWa;
        "pkg-1.1.7.5" = _hEpW62du;
        "pkg-1.1.8.1" = _VC48NS6u;
        "pkg-1.0.1.5-neoforge" = _NxBjsxri;
        "pkg-1.0.1.6-neoforge" = _j8cajw1s;
        "pkg-1.0.2.2-neoforge" = _8wWBggGU;
        "pkg-1.1.8.5" = _xveAiPqW;
        "pkg-1.1.9.1" = _k1xFJTqR;
        "pkg-1.0.2.5-neoforge" = _tY4PQa3m;
        "pkg-1.0.2.7-neoforge" = _52lJyUX6;
        "pkg-1.0.3.0-neoforge" = _QbVGWTUJ;
        "pkg-1.0.3.7-neoforge" = _WRzcCJp6;
        "pkg-1.0.4.0-neoforge" = _VV4TUOJV;
        "pkg-1.0.4.3-neoforge" = _k85tDq16;
        "pkg-1.0.4.5-neoforge" = _LOQXh9GI;
        "pkg-1.0.5.0-neoforge" = _p3FaQfCE;
        "pkg-1.0.5.1-neoforge" = _VZoEFrDd;
        "pkg-1.0.5.7-neoforge" = _YBEKbtCJ;
        "pkg-1.0.5.8-neoforge" = _XgfXDLRY;
        "pkg-1.1.9.2" = _7HjAR9Gy;
        "pkg-1.1.9.3" = _InU0YTo1;
        "pkg-1.1.9.4" = _OQ1zMO5Q;
        "pkg-1.0.6.5-neoforge" = _AZJrPv4J;
        "pkg-1.0.6.6-neoforge" = _y9PJ6MuX;
        "pkg-1.0.7.0-neoforge" = _R1jMp8WD;
        "pkg-1.0.7.5-neoforge" = _GlHaw4tv;
        "pkg-1.0.8.9-neoforge" = _zRTHF3vo;
        "pkg-1.0.9.2-neoforge" = _GjPPJ3M5;
        "pkg-1.0.9.5-neoforge" = _kL3xVdyq;
        "pkg-1.0.9.8-neoforge" = _znl8VWL6;
        "pkg-1.1.0.0-neoforge" = _sI62MZyS;
        "pkg-1.1.0.1-neoforge" = _YRzHrcJs;
        "pkg-1.1.9.5" = _Hq90AI4K;
        "pkg-1.1.1.0-neoforge" = _L0VVX9XK;
        "pkg-1.1.1.2-neoforge" = _oq0RkTP6;
        "pkg-1.1.1.3-neoforge" = _2uqLxb9K;
        "pkg-1.2.0.0" = _aTcwfGkk;
        "pkg-1.2.0.2" = _FZNiQ2S4;
        "pkg-1.1.1.5-neoforge" = _cdeqpYhD;
        "pkg-1.2.0.3" = _kzjEJsoR;
        "pkg-1.2.0.5" = _dcWc8zUT;
        "pkg-1.1.1.8-neoforge" = _Se0a0CVb;
        "pkg-1.2.0.6" = _LKwrsvB9;
        "pkg-1.1.2.0-neoforge" = _v5qeRhmE;
        "pkg-1.1.2.5-neoforge" = _yHoxijYw;
        "pkg-1.1.2.7-neoforge" = _e52X1gw3;
        "pkg-1.1.2.8-neoforge" = _TPYnyLVP;
        "pkg-1.1.2.9-neoforge" = _rN4kgsGl;
        "pkg-1.2.0.7" = _OtyVizye;
        "pkg-1.2.0.9" = _Ha4JLPeZ;
        "pkg-1.1.3.2-neoforge" = _OaVnFcD0;
        "pkg-1.2.1.5" = _hA1ZwGXB;
        "pkg-1.1.3.6-neoforge" = _zjxV5oKI;
        "pkg-1.2.2.0" = _rsrDza1K;
        "pkg-1.1.3.8-neoforge" = _L0QoNvLu;
        "pkg-1.1.4.2-neoforge" = _Ow1ijJ5m;
        "pkg-1.1.4.3-neoforge" = _cX9A4SPX;
        "pkg-1.2.2.1" = _n91Vjdww;
        "pkg-1.18.2-1.0.0.0" = _kyhF7vkj;
        "pkg-1.18.2-1.0.0.2" = _f1ZXiX0T;
        "pkg-1.2.2.7" = _U1L7tBn4;
        "pkg-1.1.4.5-neoforge" = _LFKw0OSl;
        "pkg-1.2.2.9" = _t1NwunEG;
        "pkg-1.1.4.8-neoforge" = _nbsWdeo0;
        "pkg-1.1.5.2-neoforge" = _mlCSsDbc;
        "pkg-1.1.5.3-neoforge" = _NAPPKwbJ;
        "pkg-1.1.5.5-neoforge" = _sjOXVYDc;
        "pkg-1.1.5.7-neoforge" = _GYB1mCol;
        "pkg-1.2.3.5" = _qjN7GPmC;
        "pkg-1.1.5.8-neoforge" = _DEMdImPT;
        "pkg-1.1.8.0-neoforge" = _vMarl8XY;
        "pkg-1.1.8.1-neoforge" = _HAFDzgqB;
        "pkg-1.1.8.5-neoforge" = _zmvOMs4U;
        "pkg-1.1.8.6-neoforge" = _rpqOnuD1;
        "pkg-1.2.5.0" = _FYlVekGZ;
        "pkg-1.2.5.7" = _4gXgN09Z;
        "pkg-1.1.8.8-neoforge" = _TZButtAb;
        "pkg-1.2.5.8" = _Qz2QRTes;
        "pkg-1.1.9.0-neoforge" = _FwA91l3J;
        "pkg-1.1.9.1-neoforge" = _xvQytoz9;
        "pkg-1.1.9.2-neoforge" = _O6NuY4vX;
        "pkg-1.1.9.3-neoforge" = _kmI92ewu;
        "pkg-1.2.5.9" = _5DE6WFHw;
        "pkg-1.1.9.4-neoforge" = _dglvup53;
        "pkg-1.2.6.1" = _M7eFDGmC;
        "pkg-1.2.6.3" = _ptdh5sGL;
        "pkg-1.2.7.0" = _Tl8MhcYX;
        "pkg-1.1.9.7-neoforge" = _uanYVhoO;
        "pkg-1.2.7.3" = _lazBT2EB;
        "pkg-1.2.7.6" = _Mtitdo8q;
        "pkg-1.2.8.5" = _ddofyuoq;
        "pkg-1.2.8.8" = _YEsN2WUK;
        "pkg-1.2.9.0" = _7T7F7ge6;
        "pkg-1.2.9.8" = _DtRwgmKK;
        "pkg-1.3.0.1" = _cQQ2ll7b;
        "pkg-1.3.0.6" = _FzmpviOS;
        "pkg-1.3.0.7" = _bPy69iql;
        "pkg-1.3.1.0" = _7fwFB4aU;
        "pkg-1.3.1.2" = _LVrFc299;
        "pkg-1.3.1.6" = _f5iDpky5;
        "pkg-1.3.1.7" = _vWY7Zjkq;
        "pkg-1.3.1.8" = _JxHmb8Gp;
        "pkg-1.2.0.5-neoforge" = _AqckW3mD;
        "pkg-1.2.0.6-neoforge" = _94KZOVTb;
        "pkg-1.2.0.8-neoforge" = _iooXieBt;
        "pkg-1.3.1.9" = _9plmWbpK;
        "pkg-1.3.2.0" = _zU8WjOnr;
        "pkg-1.3.2.1" = _Nz3I8Rg3;
        "pkg-1.2.1.0-neoforge" = _ZYbdjfvp;
        "pkg-1.2.1.2-neoforge" = _4zF8XR5J;
        "pkg-1.3.2.5" = _HxB5OgHE;
        "pkg-1.2.1.5-neoforge" = _wKuKeDYa;
        "pkg-1.3.3.0" = _lUHPLtZ9;
        "pkg-1.2.2.3-neoforge" = _kGySw1Yf;
        "pkg-1.3.3.2" = _xGGRDcIh;
        "pkg-1.3.3.5" = _BTYVOsmg;
        "pkg-1.2.2.5-neoforge" = _6JsIPJiK;
        "pkg-1.3.3.7" = _zqPilmBV;
        "pkg-1.2.3.0-neoforge" = _kj4uNJ6j;
        "pkg-1.2.3.5-neoforge" = _h9MA8YOw;
        "pkg-1.3.4.0" = _5Zsy4uGY;
        "pkg-1.2.3.6-neoforge" = _oXRanqba;
        "pkg-1.3.4.1" = _4Fc9phXu;
        "pkg-1.3.4.7" = _TlgasKXl;
        "pkg-1.2.4.0-neoforge" = _f7ZSv0WI;
        "pkg-1.3.4.9" = _Na1oru2l;
        "pkg-1.2.4.5-neoforge" = _oPBIGCNQ;
        "pkg-1.3.5.3" = _5ttnUpNM;
        "pkg-1.2.4.7-neoforge" = _iR7fNit3;
        "pkg-1.2.5.1-neoforge" = _H8e6zwdQ;
        "pkg-1.3.5.4" = _pzbxxU1O;
        "pkg-1.2.6.1-neoforge" = _ibj5KRTA;
        "pkg-1.2.6.2-neoforge" = _ZTqujGIY;
        "pkg-1.2.6.6-neoforge" = _wuqOnn1T;
        "pkg-1.2.7.1-neoforge" = _PN6ljnaR;
        "pkg-1.2.7.2-neoforge" = _TNiEYQEO;
        "pkg-1.3.5.5" = _TgUF1cAu;
        "pkg-1.3.5.6" = _vo0rsGwe;
        "pkg-1.2.7.5-neoforge" = _eUdyUHmR;
        "pkg-1.3.5.9" = _guPytGz0;
        "pkg-1.2.7.8-neoforge" = _13Yn1e87;
        "pkg-1.2.8.2-neoforge" = _cpx0Ee3V;
        "pkg-1.2.8.5-neoforge" = _lhP98tZu;
        "pkg-1.3.6.0" = _BYiMZAQQ;
        "pkg-1.3.6.7" = _H0LJKEs2;
        "pkg-1.3.7.0" = _Qi9O3Bz5;
        "pkg-1.2.9.0-neoforge" = _2UbrPUWm;
        "pkg-1.3.7.3" = _Psr2uGlA;
        "pkg-1.3.8.5" = _sWIMcRwd;
        "pkg-1.3.8.6" = _PJAk8bdy;
        "pkg-1.3.9.0" = _UfWRFopB;
        "pkg-1.3.0.5-neoforge" = _PVJmce9P;
        "pkg-1.3.0.8-neoforge" = _p52ZbPU3;
        "pkg-1.3.1.0-neoforge" = _OKe0M3K2;
        "pkg-1.3.9.2" = _MSbRJD98;
        "pkg-1.3.9.5" = _1ubbzPjm;
        "pkg-1.3.1.2-neoforge" = _WOTs1b1r;
        "pkg-1.3.9.6" = _uSWKHs1p;
        "pkg-1.4.0.0" = _AX6Tyqgn;
        "pkg-1.3.1.5-neoforge" = _nYsCaF2d;
        "pkg-1.4.0.6" = _jrU5kdHn;
        "pkg-1.4.1.0" = _ydP5rd12;
        "pkg-1.3.1.6-neoforge" = _1mh9Z6Lp;
        "pkg-1.4.1.5" = _dXEY0O63;
        "pkg-1.3.1.8-neoforge" = _23aPiY8q;
        "pkg-1.4.1.7" = _4Z4pKRrm;
        "pkg-1.4.1.8" = _2IQWMEkO;
        "pkg-1.4.2.0" = _ngBPoeLx;
        "pkg-1.4.2.2" = _hWzzPJgT;
        "pkg-1.4.2.4" = _PjlkCD2c;
        "pkg-1.4.2.9" = _DoN0uqOZ;
        "pkg-1.4.3.0" = _KZXIxIPW;
        "pkg-1.4.3.7" = _X6ylyEwD;
        "pkg-1.4.3.9" = _A7tRHzDb;
        "pkg-1.3.4.5-neoforge" = _AGvYwjET;
        "pkg-1.3.4.6-neoforge" = _BEJrpu4e;
        "pkg-1.3.5.0-neoforge" = _VBKx5rjf;
        "pkg-1.3.5.5-neoforge" = _gcwGUPiG;
        "pkg-1.3.6.0-neoforge" = _47Od980X;
        "pkg-1.4.4.7" = _tEMceI1U;
        "pkg-1.4.4.9" = _Sgvn6OQz;
        "pkg-1.4.5.0" = _erPxcYsg;
        "pkg-1.3.6.3-neoforge" = _o1F0X3ZY;
        "pkg-1.4.5.3" = _HapfFS66;
        "pkg-1.4.5.4" = _JwUAR0V8;
        "pkg-1.3.6.4-neoforge" = _r1eGt67q;
        "pkg-1.4.5.5" = _BhbvLnJL;
        "pkg-1.4.6.0-fusion" = _H2pf2fxw;
        "pkg-1.4.6.4-fusion" = _UW42p9Qo;
        "pkg-1.4.6.6-fusion" = _8Z2TM6Ef;
        "pkg-1.4.7.2-fusion" = _FcEFvQsu;
        "pkg-1.4.7.3-fusion" = _zra9ZHkX;
        "pkg-1.4.7.5-fusion" = _BFN2lUeP;
        "pkg-1.4.7.6-fusion" = _CUHqUvGt;
        "pkg-1.4.7.7-fusion" = _kgyNvt1s;
        "pkg-1.4.8.0-fusion" = _HqWCJ2SF;
        "pkg-1.4.8.5-fusion" = _R1pUEwHi;
        "pkg-1.4.8.8-fusion" = _q0jbn23T;
        "pkg-1.4.9.0-fusion" = _Hhz1pdkZ;
        "pkg-1.3.7.6-neoforge" = _4TPWWRRc;
        "pkg-1.3.7.8-neoforge" = _WCQUh4wr;
        "pkg-1.4.0.0-neoforge-splice" = _cTjIwRGn;
        "pkg-1.4.9.3-fusion" = _pR00DYmk;
        "pkg-1.4.9.5-fusion" = _dWV611Uo;
        "pkg-1.5.0.0-fusion" = _yXQD2IIM;
        "pkg-1.5.0.6-fusion" = _aslEe4cR;
        "pkg-1.5.1.0-fusion" = _EqLuSbRK;
        "pkg-1.5.1.6-fusion" = _D2F7bw0p;
        "pkg-1.5.2.0-fusion" = _Q7CiMd68;
        "pkg-1.5.2.1-fusion" = _k00grP5m;
        "pkg-1.5.3.0-fusion" = _SafNJXU5;
        "pkg-1.5.3.7-fusion" = _smKPLe7z;
        "pkg-1.5.4.7-fusion" = _X4edNW4Y;
        "pkg-1.5.5.3-fusion" = _8Hvy0Sgb;
        "pkg-1.5.6.4-fusion" = _nDscnW6f;
        "pkg-1.5.7.5-fusion" = _3akjlG25;
