...
let
    versions = (let
        ...
        _ba0nrLZ7 = {
            "id" = "ba0nrLZ7";
            "file" = "MyPet-3.14.3-SNAPSHOT-b4.jar";
            "hash" = "sha512-au+LaEtXpRGbaBkD/uaLcBr/l0wabHdOVMX4Lxe4cm8I3BZkvGxQtvFoLsxeGrZ4Hs2xCmY2cEU9dRBtWveiEQ==";
        };
        _mkMAIOff = {
            "id" = "mkMAIOff";
            "file" = "MyPet-3.14.3.jar";
            "hash" = "sha512-TR8Gg+7EKpLo5niN16tJrpF7PSQi9G+LRs68jr+CsQc9kaF96Eg9lES6fm0i334s9RAJllq1EUCxCjACtV5vIw==";
        };
    in {
        "Xa0VrBSy" = _Xa0VrBSy;
        "cdJIFgwv" = _cdJIFgwv;
        ...
        "ba0nrLZ7" = _ba0nrLZ7;
        "mkMAIOff" = _mkMAIOff;
        "paper-1.8.8" = _mkMAIOff;
        "paper-1.12.2" = _mkMAIOff;
        "paper-1.16.5" = _mkMAIOff;
        "paper-1.17" = _Xa0VrBSy;
        "paper-1.17.1" = _mkMAIOff;
        "paper-1.18" = _Xa0VrBSy;
        "paper-1.18.1" = _Xa0VrBSy;
        "paper-1.18.2" = _mkMAIOff;
        "paper-1.19" = _mkMAIOff;
        "paper-1.19.1" = _mkMAIOff;
        "paper-1.19.2" = _mkMAIOff;
        "paper-1.19.3" = _mkMAIOff;
        "paper-1.19.4" = _mkMAIOff;
        "paper-1.20" = _mkMAIOff;
        "paper-1.20.1" = _mkMAIOff;
        "paper-1.20.2" = _mkMAIOff;
        "paper-1.20.3" = _mkMAIOff;
        "paper-1.20.4" = _mkMAIOff;
        "paper-1.20.5" = _mkMAIOff;
        "paper-1.20.6" = _mkMAIOff;
        "paper-1.21" = _mkMAIOff;
        "paper-1.21.1" = _mkMAIOff;
        "paper-1.21.2" = _mkMAIOff;
        "paper-1.21.3" = _mkMAIOff;
        "paper-1.21.4" = _mkMAIOff;
        "paper-1.21.5" = _mkMAIOff;
        "paper-1.21.6" = _mkMAIOff;
        "paper-1.21.7" = _mkMAIOff;
        "paper-1.21.8" = _mkMAIOff;
        "paper-1.21.9" = _mkMAIOff;
        "paper-1.21.10" = _mkMAIOff;
        "paper-1.21.11" = _mkMAIOff;
        "paper-26.1" = _mkMAIOff;
        "paper-26.1.1" = _mkMAIOff;
        "paper-26.1.2" = _mkMAIOff;
        "paper-26.2" = _mkMAIOff;
        "spigot-1.8.8" = _mkMAIOff;
        "spigot-1.12.2" = _mkMAIOff;
        "spigot-1.16.5" = _mkMAIOff;
        "spigot-1.17" = _Xa0VrBSy;
        "spigot-1.17.1" = _mkMAIOff;
        "spigot-1.18" = _Xa0VrBSy;
        "spigot-1.18.1" = _Xa0VrBSy;
        "spigot-1.18.2" = _mkMAIOff;
        "spigot-1.19" = _mkMAIOff;
        "spigot-1.19.1" = _mkMAIOff;
        "spigot-1.19.2" = _mkMAIOff;
        "spigot-1.19.3" = _mkMAIOff;
        "spigot-1.19.4" = _mkMAIOff;
        "spigot-1.20" = _mkMAIOff;
        "spigot-1.20.1" = _mkMAIOff;
        "spigot-1.20.2" = _mkMAIOff;
        "spigot-1.20.3" = _mkMAIOff;
        "spigot-1.20.4" = _mkMAIOff;
        "spigot-1.20.5" = _mkMAIOff;
        "spigot-1.20.6" = _mkMAIOff;
        "spigot-1.21" = _mkMAIOff;
        "spigot-1.21.1" = _mkMAIOff;
        "spigot-1.21.2" = _mkMAIOff;
        "spigot-1.21.3" = _mkMAIOff;
        "spigot-1.21.4" = _mkMAIOff;
        "spigot-1.21.5" = _mkMAIOff;
        "spigot-1.21.6" = _mkMAIOff;
        "spigot-1.21.7" = _mkMAIOff;
        "spigot-1.21.8" = _mkMAIOff;
        "spigot-1.21.9" = _mkMAIOff;
        "spigot-1.21.10" = _mkMAIOff;
        "spigot-1.21.11" = _mkMAIOff;
        "spigot-26.1" = _mkMAIOff;
        "spigot-26.1.1" = _mkMAIOff;
        "spigot-26.1.2" = _mkMAIOff;
        "spigot-26.2" = _mkMAIOff;
        "pkg-3.13.6" = _Xa0VrBSy;
        "pkg-3.14.0" = _cdJIFgwv;
        "pkg-3.14.1-SNAPSHOT-b1" = _JHCmeHU6;
        "pkg-3.14.1-SNAPSHOT-b2" = _kAWHrSDM;
        "pkg-3.14.1-SNAPSHOT-b3" = _PKUSd7QB;
        "pkg-3.14.1-SNAPSHOT-b4" = _pGvf6z17;
        "pkg-3.14.1-SNAPSHOT-b5" = _xGodLhn2;
        "pkg-3.14.1-SNAPSHOT-b6" = _JHmc0eDJ;
        "pkg-3.14.1-SNAPSHOT-b7" = _6N9XAawF;
        "pkg-3.14.1-SNAPSHOT-b8" = _sib0eZ7Y;
        "pkg-3.14.1-SNAPSHOT-b9" = _WUitVMG5;
        "pkg-3.14.1-SNAPSHOT-b10" = _fL6YnEDn;
        "pkg-3.14.1-SNAPSHOT-b11" = _UFjSbvfi;
        "pkg-3.14.1-SNAPSHOT-b12" = _5NKyyWUm;
        "pkg-3.14.1-SNAPSHOT-b13" = _hK8KXtUN;
        "pkg-3.14.1-SNAPSHOT-b14" = _Rtleiplu;
        "pkg-3.14.1" = _MK02kn43;
        "pkg-3.14.2-SNAPSHOT-b1" = _XoskLFyY;
        "pkg-3.14.2-SNAPSHOT-b2" = _hzpVYMRv;
        "pkg-3.14.2-SNAPSHOT-b3" = _7p7ELZSt;
        "pkg-3.14.2-SNAPSHOT-b4" = _9nWE3sY6;
        "pkg-3.14.2-SNAPSHOT-b5" = _xVeAtMBd;
        "pkg-3.14.2-SNAPSHOT-b6" = _fy2G2sd5;
        "pkg-3.14.2" = _1d959oMJ;
        "pkg-3.14.3-SNAPSHOT-b1" = _a20PtuJT;
        "pkg-3.14.3-SNAPSHOT-b2" = _O40S6moy;
        "pkg-3.14.3-SNAPSHOT-b3" = _mYJmlPOw;
        "pkg-3.14.3-SNAPSHOT-b4" = _ba0nrLZ7;
        "pkg-3.14.3" = _mkMAIOff;
        "default" = _mkMAIOff;
    });
