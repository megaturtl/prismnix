...
let
    ...
    in {
        ...
        "pkg-1.3-fabric-1.1.2" = _ziOa4ru7;
        "pkg-1.3-fabric-1.2.0" = _lb3AaDrZ;
        "pkg-1.3-fabric-1.3.0" = _8FOuBwRg;
        "pkg-1.3-fabric-1.4.0" = _UN1BTDSJ;
        "pkg-1.4-fabric-1.0.0" = _kSUa1iwj;
        "pkg-1.4-fabric-1.0.1" = _7FRjqUmk;
        "pkg-1.4-fabric-1.1.0" = _5FWCmi7f;
        "pkg-1.4-forge-1.0.0" = _Ef4qXzuu;
        "pkg-1.4-forge-1.0.1" = _q3b8l9yG;
        "pkg-1.4-fabric-1.2.0" = _s6xwimto;
        "pkg-1.4-fabric-1.2.1" = _QOrsNOnz;
        "pkg-1.4-fabric-1.3.0" = _YHrElOK2;
        "pkg-1.4-forge-1.1.0" = _F6INAe9k;
        "pkg-1.5-fabric-1.0.0" = _97Znaz4Q;
        "pkg-1.5-forge-1.0.0" = _r3ufDRrH;
        "pkg-1.5-forge-1.0.1" = _j5lT6Yao;
        "pkg-1.5-forge-1.1.0" = _nlrCpXs2;
        "pkg-1.5-fabric-1.1.0" = _F6QKWUhA;
        "pkg-1.5-forge-1.1.1" = _LpuJ9wga;
        "pkg-1.5-fabric-1.1.1" = _2ocZIaUR;
        "pkg-1.5-fabric-1.2.0" = _oD6RgLBN;
        "pkg-1.5-forge-1.2.0" = _Wwus4QWy;
        "pkg-1.5-fabric-1.2.1" = _G8PCV0Ha;
        "pkg-1.6-fabric-1.0.0" = _7Vq83ds8;
        "pkg-1.6-neoforge-1.0.0" = _NpvtT1ra;
        "pkg-1.6-fabric-1.1.0" = _zzR2uTx8;
        "pkg-1.6-fabric-1.2.0" = _u1a18J5t;
        "pkg-1.6-fabric-1.2.1" = _UogJKitG;
        "pkg-1.6-neoforge-1.0.1" = _7rBopY5X;
        "pkg-1.6-fabric-1.2.2" = _1U0FFY18;
        "pkg-1.6-fabric-1.3.0" = _8jMpR2AH;
        "pkg-1.6-neoforge-1.3.0" = _ViUdH8yv;
        "pkg-1.6-fabric-1.3.1" = _tPESEBzC;
        "pkg-1.6-neoforge-1.3.1" = _bKXtuUDE;
        "pkg-1.6-fabric-1.3.2" = _q3QXGPAg;
        "pkg-1.6-neoforge-1.3.2" = _F4CKpaTy;
        "pkg-1.6-fabric-1.3.3" = _AkGglpJn;
        "pkg-1.6-neoforge-1.3.3" = _xsB4yqds;
        "pkg-1.6-fabric-1.3.4" = _NzhX0230;
        "pkg-1.6-neoforge-1.3.4" = _Cr5rOY7v;
        "pkg-1.6-fabric-1.3.5" = _QdTuWWkk;
        "pkg-1.6-neoforge-1.3.5" = _EzpE1DAb;
        "pkg-1.6-neoforge-1.3.6" = _UwbvOm9I;
        "pkg-1.6-neoforge-1.3.7" = _VenIdGNB;
        "pkg-1.6-fabric-1.3.8" = _QWYPqICC;
        "pkg-1.6-neoforge-1.3.8" = _sHjtH8Cz;
        "pkg-1.6-neoforge-1.3.9" = _DIuOcjGy;
        "pkg-1.7.0-fabric-2.0.0" = _2TSUDzQS;
        "pkg-1.7.0-neoforge-2.0.0" = _2mD6GCNU;
        "pkg-1.7.0-fabric-2.0.1" = _UkYqSlXr;
        "pkg-1.7.0-neoforge-2.0.1" = _CL6gDUFK;
        "pkg-1.7.1-fabric-2.1.0" = _oer4cguU;
        "pkg-1.7.1-neoforge-2.1.0" = _i18y2R6E;
        "pkg-1.7.1-fabric-2.2.0" = _Uq0NIqFG;
        "pkg-1.7.1-neoforge-2.2.0" = _TUxXZkGe;
        "pkg-1.7.1-fabric-2.2.1" = _uc3SbDVr;
        "pkg-1.7.1-neoforge-2.2.1" = _KBokjZm4;
        "pkg-1.7.1-fabric-2.2.2" = _45lZSWQg;
        "pkg-1.7.1-neoforge-2.2.2" = _PZUb8WEN;
        "pkg-1.7.2-fabric-2.3.0" = _NSjpJCt1;
