...
let
    ...
    in {
        ...
        "pkg-0.2.3" = _GnZJjDWh;
        "pkg-0.2.4" = _6RSkJaOg;
        "pkg-v0.2.6" = _E1ZLVILS;
        "pkg-v0.2.7" = _At5tZYRz;
        "pkg-0.3.0" = _LO4PnHKM;
        "pkg-v0.3.1" = _vXRAAnoQ;
        "pkg-v0.3.2" = _JPFiT6v6;
        "pkg-v0.3.3" = _6L4Pmj1S;
        "pkg-v0.3.4" = _vtPNUtyH;
        "pkg-v0.4.0" = _AWPHhrsb;
        "pkg-v0.4.1" = _lUZ4EOfR;
        "pkg-v0.5.0" = _7T091xD4;
        "pkg-v0.6.0" = _h56NpUOt;
        "pkg-v0.6.2" = _LuPi9WeJ;
        "pkg-v0.7.0" = _eIsUdv2p;
        "pkg-v0.8.0" = _EGl07Mkt;
        "pkg-v0.8.1" = _pPSZ4q12;
        "pkg-v0.8.2" = _sw1INR3X;
        "pkg-v0.8.3" = _EifFJQs7;
        "pkg-v0.8.4" = _5nElsH71;
        "pkg-v0.8.5" = _XPjbFMnw;
        "pkg-v0.8.6" = _OdVu5U7T;
        "pkg-v0.8.7" = _6nhe6xj7;
        "pkg-v0.8.8" = _on2PG2Zj;
        "pkg-v0.8.9" = _mz82CY89;
        "pkg-v0.8.10" = _OPU8Xq3i;
        "pkg-v0.9.0" = _AvYB9jQv;
        "pkg-v0.9.1" = _D9LTquGO;
        "pkg-v0.10.0" = _XlDcIjjH;
        "pkg-v0.10.1" = _uAZHpQgY;
        "pkg-v0.10.2" = _gwWz0wRo;
        "pkg-v0.11.0" = _nIQGsoHk;
        "pkg-v0.11.1" = _eIbTZzPl;
        "pkg-v1.0.0" = _8vtaPzDM;
        "pkg-v1.0.1" = _KaccYlDE;
        "pkg-v1.1.0" = _8XZurSCC;
        "pkg-v1.1.1" = _V6Oz98LF;
        "pkg-v1.1.2" = _Rh1CB4Bs;
        "pkg-v1.1.3" = _1TM5hkxO;
        "pkg-v1.2.0" = _IIzu2VHs;
        "pkg-v1.2.1" = _q3MdlCKB;
        "pkg-v1.2.2" = _avKYaWEO;
        "pkg-v1.2.3" = _bzO8Bou1;
        "pkg-v1.3.0" = _yEaAAc6J;
        "pkg-v1.3.1" = _AnVeyw6A;
        "pkg-v1.3.2" = _PEkLgHz8;
        "pkg-v1.3.3" = _vCXR0pC8;
        "pkg-v1.3.4" = _Y6NLyYB7;
        "pkg-v1.3.5" = _mF04IHyS;
        "pkg-v1.3.6" = _V2Vi6m1m;
        "pkg-v1.3.7" = _nndWMIVu;
        "pkg-v1.3.9" = _gtoffehu;
        "pkg-v1.3.10" = _JMfPcRxw;
        "pkg-v2.0.0" = _1dzyNlRl;
        "pkg-v1.3.11" = _2aK6QhLB;
        "pkg-v1.4.0" = _l0TOlCnh;
        "pkg-v2.0.1" = _wZmxo765;
        "pkg-v2.0.2" = _9m2FlmYD;
        "pkg-v1.4.1" = _CGxg4fya;
        "pkg-v2.0.3" = _N07nE8RJ;
        "pkg-v1.4.2" = _U1KpdDhI;
        "pkg-v2.0.4" = _xS3PEMpZ;
        "pkg-v2.0.5" = _CKFGubBX;
        "pkg-v1.4.3" = _F6rD46G5;
        "pkg-v2.0.6" = _vx3gxNjk;
        "pkg-v2.1.0" = _T8TaYr5o;
        "pkg-v2.1.1" = _M1OnGzkH;
