...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.21.3-beta.2" = _eIDDjE9U;
        "pkg-1.0.0+1.21-beta.3" = _Ws2cSxCC;
        "pkg-1.0.0+1.21.3-beta.3" = _AFBVobTj;
        "pkg-1.0.0+1.21.4-beta.3" = _RkIJA93f;
        "pkg-1.0.0-beta.4+1.21" = _hE3V6ba4;
        "pkg-1.0.0-beta.4+1.21.3" = _h6XcLvBS;
        "pkg-1.0.0-beta.4+1.21.4" = _lz062Oem;
        "pkg-1.0.0+1.21" = _sKnPKY7z;
        "pkg-1.0.0+1.21.3" = _KcCFiHQs;
        "pkg-1.0.0+1.21.4" = _z3Ka5l3P;
        "pkg-1.0.1+1.21" = _EupOFmsC;
        "pkg-1.0.1+1.21.3" = _eAt50Ohb;
        "pkg-1.0.1+1.21.4" = _occJmrUT;
        "pkg-1.0.2+1.21" = _1C87c6A7;
        "pkg-1.0.2+1.21.3" = _3VtDGiYe;
        "pkg-1.0.2+1.21.4" = _1qxn6Lh0;
        "pkg-1.1.0+1.21.1" = _5LYTXVde;
        "pkg-1.1.0+1.21.3" = _VSzLiTFU;
        "pkg-1.1.0+1.21.4" = _AUqGS5Lq;
        "pkg-1.1.1+1.21.1" = _sw6cZo0y;
        "pkg-1.1.1+1.21.3" = _xq85Y4ud;
        "pkg-1.1.1+1.21.4" = _4Qt60rMm;
        "pkg-1.1.1+1.21.9" = _JsAPGLcb;
        "pkg-1.1.1+1.21.11" = _TmRmqywx;
        "pkg-2.0.0+26.1" = _yRhI7l4H;
