...
let
    ...
    in {
        ...
        "pkg-1.6-MC1.8.9" = _sRjO11Hw;
        "pkg-1.10.2b" = _ta0AS99B;
        "pkg-1.9.4a" = _ZMAICb41;
        "pkg-1.11.2a" = _dFBQNTqa;
        "pkg-1.12a" = _Cs6cw8zw;
        "pkg-1.12.2a" = _rZL1NsmK;
        "pkg-1-16-1" = _QpYGNYe2;
        "pkg-1.15.2" = _G4njhe2x;
        "pkg-1.16.5-Forge" = _ffMmPwVk;
        "pkg-1.16.5-Fabric" = _1n7KBLyY;
        "pkg-1.17.1-Forge" = _5OEMqFvv;
        "pkg-1.17.1-Fabric" = _jlhdpqTD;
        "pkg-1.18.1-Forge" = _cUpTPPdQ;
        "pkg-1.18.1-Fabric" = _5aVAbPFT;
        "pkg-1.18.2-Forge" = _kRWvnBjR;
        "pkg-1.18.2-Fabric" = _skudKY6B;
        "pkg-1.19-Quilt" = _4Hz0M0jE;
        "pkg-1.19-Forge" = _8Kz4Glt9;
        "pkg-1.19-Fabric" = _1muHlwgB;
        "pkg-1.19.2-Quilt" = _XTrhQTx3;
        "pkg-1.19.2-Forge" = _aX0pGdMZ;
        "pkg-1.19.2-Fabric" = _r7DkPLkW;
        "pkg-1.19.4-Quilt" = _E4X3guEo;
        "pkg-1.19.4-Forge" = _HonPc6fV;
        "pkg-1.19.4-Fabric" = _QVVy1nwP;
        "pkg-1.20-Quilt" = _rjiH7MNv;
        "pkg-1.20-Forge" = _3PEwIAxS;
        "pkg-1.20-Fabric" = _SQ8rPFUH;
        "pkg-1.20.2-NeoForge" = _q7UOfRdd;
        "pkg-1.20.2-Forge" = _8HGgSwcd;
        "pkg-1.20.2-Fabric" = _MlKW3MCQ;
        "pkg-1.20.4-NeoForge" = _8Knoqwu0;
        "pkg-1.20.4-Forge" = _zF1tRMr3;
        "pkg-1.20.4-Fabric" = _j072HtHj;
        "pkg-1.20.5-NeoForge" = _Aa8GEcNt;
        "pkg-1.20.5-Fabric" = _o2GzfQoO;
        "pkg-1.20.6-Fabric" = _KdgFX9q6;
        "pkg-1.20.6-NeoForge" = _Ln7llN7Q;
        "pkg-1.21-Fabric" = _shNsG8hT;
        "pkg-1.21-NeoForge" = _c0ig5IA3;
        "pkg-1.21.2-Fabric" = _OVSIYVxz;
        "pkg-1.21.2-NeoForge" = _PWFPbLCo;
        "pkg-1.21.4-Fabric" = _fT6ARSnY;
        "pkg-1.21.4-NeoForge" = _cOdojRI1;
        "pkg-1.21.5-Fabric" = _zZWUmc3q;
        "pkg-1.21.5-NeoForge" = _6sYk7MLu;
        "pkg-1.21.6-Fabric" = _DinlRkOt;
        "pkg-1.21.6-NeoForge" = _670Rdp0q;
        "pkg-1.21.9-Fabric" = _wMPgdVxN;
        "pkg-1.21.9-NeoForge" = _HXIzlvP5;
        "pkg-1.21.10-Fabric" = _3Hvbx1oU;
        "pkg-1.21.10-NeoForge" = _rKcQec33;
        "pkg-1.21.11-Fabric" = _FSxIU9iV;
        "pkg-1.21.11-NeoForge" = _qDqZoAvl;
        "pkg-26.1-Fabric" = _O1EfG2fC;
