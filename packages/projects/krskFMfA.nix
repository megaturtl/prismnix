...
let
    versions = (let
        ...
        _V5n3AoVN = {
            "id" = "V5n3AoVN";
            "file" = "spelunkery-1.21.1-0.4.4-fabric.jar";
            "hash" = "sha512-OQzrh4oNTx5dh+iqj91JmMfKnuTdkHUO4WRu+t0Wm9z3LY60q8AsFlMJXSIjzkBrva0GYsD654v3D0JO3h2g3A==";
        };
        _rFDQXIT4 = {
            "id" = "rFDQXIT4";
            "file" = "spelunkery-1.21.1-0.4.4-neoforge.jar";
            "hash" = "sha512-RZwyGeUUtBz2XlEt8vPwODBTyNrq4IcKhpKjFIcJJOKYwPUg2TNAh3hD1/Uh5mhuIZAwIXlYK+OJVusYUW1tGw==";
        };
    in {
        "ZeQLOtGu" = _ZeQLOtGu;
        "RCkHRBlr" = _RCkHRBlr;
        ...
        "fabric-1.21.1" = _V5n3AoVN;
        "forge-1.19.2" = _v6sHcul7;
        "forge-1.20.1" = _jW8j0zdc;
        "quilt-1.19.2" = _VeOeiwmb;
        "quilt-1.20.1" = _j8FDXfMx;
        "neoforge-1.21.1" = _rFDQXIT4;
        "pkg-1.19.2-0.1.0" = _RCkHRBlr;
        "pkg-1.19.2-0.1.1" = _rVj1MdCt;
        "pkg-1.19.2-0.1.2" = _Hgf0xETx;
        "pkg-1.19.2-0.1.3" = _CGZCqkza;
        "pkg-1.19.2-0.1.4" = _RKgrCDGK;
        "pkg-1.19.2-0.1.5" = _FwwJPsMC;
        "pkg-1.19.2-0.1.6" = _DXTLpO30;
        "pkg-1.19.2-0.1.7" = _6cHRlzX8;
        "pkg-1.19.2-0.1.8" = _pUxLhL0j;
        "pkg-1.19.2-0.1.9" = _Ziwf6qRF;
        "pkg-1.19.2-0.1.10" = _3UnXAgta;
        "pkg-1.19.2-0.1.11" = _JrDzSmVG;
        "pkg-1.19.2-0.1.12" = _bHrTBGiW;
        "pkg-1.19.2-0.1.13" = _xeXuwX7i;
        "pkg-1.19.2-0.2.0" = _ECC8gyAL;
        "pkg-1.19.2-0.2.1" = _3s9uQ9hY;
        "pkg-1.19.2-0.2.2" = _i9rves56;
        "pkg-1.19.2-0.2.3" = _qHyIQt6F;
        "pkg-1.20.1-0.3.0" = _CkrzT8CI;
        "pkg-1.19.2-0.2.4" = _RGvtYAg9;
        "pkg-1.19.2-0.2.5" = _fMmj3DTz;
        "pkg-1.20.1-0.3.1" = _JUbm8COT;
        "pkg-1.19.2-0.2.6" = _v6sHcul7;
        "pkg-1.20.1-0.3.2" = _1G0TUXto;
        "pkg-1.20.1-0.3.3" = _OrR10T3u;
        "pkg-1.20.1-0.3.4" = _HUCZ7gFC;
        "pkg-1.20.1-0.3.5" = _jkZktG9C;
        "pkg-1.20.1-0.3.6" = _hjyPiY5n;
        "pkg-1.20.1-0.3.7" = _C7DNi3wX;
        "pkg-1.20.1-0.3.8" = _XAkFhPrC;
        "pkg-1.20.1-0.3.9" = _xOE7BTO0;
        "pkg-1.20.1-0.3.10" = _yRYQHobI;
        "pkg-1.20.1-0.3.11" = _xPDsPaCb;
        "pkg-1.20.1-0.3.12" = _ntQ6y942;
        "pkg-1.20.1-0.3.13" = _uPfxW6wx;
        "pkg-1.20.1-0.3.14" = _zEhnCbW9;
        "pkg-1.20.1-0.3.15" = _Pae622FR;
        "pkg-1.20.1-0.3.16" = _jW8j0zdc;
        "pkg-1.21.1-0.4.0" = _eY89dJuj;
        "pkg-1.21.1-0.4.1" = _zesprGoi;
        "pkg-1.21.1-0.4.2" = _JDWVpaoI;
        "pkg-1.21.1-0.4.3" = _oLqPJYV9;
        "pkg-1.21.1-0.4.4" = _rFDQXIT4;
        "default" = _rFDQXIT4;
    });
