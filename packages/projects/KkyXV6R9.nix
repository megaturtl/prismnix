...
let
    versions = (let
        ...
        _ZAkIElkq = {
            "id" = "ZAkIElkq";
            "file" = "wings-1.19.2-1.0.4.jar";
            "hash" = "sha512-Dd88BcHE/YfezLfvM8LRvt/5VlrWw9A/KT/W1xOTFMni9RQCVtMzpFcZUFyqFXXO7DpPGAPcabgpNluWCmaAUw==";
        };
        _ENeyd0yJ = {
            "id" = "ENeyd0yJ";
            "file" = "wings-1.19.4-1.0.4.jar";
            "hash" = "sha512-boT8/chIrPShhoADSlPqOjemFpzlun6weFcVJ91Fmcca9wjfCUtiXv1HQeqnGpgpxxIDtuxQP3jc/4OiJjD3Hg==";
        };
        _GRgtyLCb = {
            "id" = "GRgtyLCb";
            "file" = "wings-1.19.4-1.0.5.jar";
            "hash" = "sha512-eR8Y5UWJ97JSv4KXAH6sOHY2VSDyn8b11W1JL8Lr2S3YD4TdTDXYxzcKO9qvNJKovSmHktFNaZ8HjfmVEaG55Q==";
        };
        _LQhftGDG = {
            "id" = "LQhftGDG";
            "file" = "wings-1.18.2-1.0.7.jar";
            "hash" = "sha512-XxCxIOWg2X0h9HeHzZZLrMD4z9ePBB8IPimrKeIgK1FMyOclq0UuU1Qcc6C99hqmcKgQdu7L9dJr2jEKn8XFww==";
        };
        _YrcqCrh7 = {
            "id" = "YrcqCrh7";
            "file" = "wings-1.19.2-1.0.6.jar";
            "hash" = "sha512-Ol2lSWOt7TC/1qnbMAdBhUIDc/5YDEQLFesNMXXmt41/Cits4KTtFi5RwFzLvbn2JMvM81U5KBd8u4m12HVL1g==";
        };
        _1rKZh7aC = {
            "id" = "1rKZh7aC";
            "file" = "wings-26.2-NeoForge-1.1.10.jar";
            "hash" = "sha512-YmBrKViw9f73QOP8UkQJ6iOsNRonQKn3XACgGNUu9evp/AL9Q0av8bXlsTJqUaFdm95hDOEpAYkZaxyB6jEExg==";
        };
        _R8VetV9s = {
            "id" = "R8VetV9s";
            "file" = "wings-26.2-Fabric-1.1.10.jar";
            "hash" = "sha512-aPoMuPI2GbLQaP4NuYdb/nfFt3iHOArMi3erZtunRFHnqX3CRRS2seyQsyz1Sn36Y03BHzHZ4UdVVrOFWhUfGg==";
        };
        _j8Jbb7h0 = {
            "id" = "j8Jbb7h0";
            "file" = "wings-26.2-NeoForge-1.1.11.jar";
            "hash" = "sha512-X036gS1cSRjVC6ZYPFNtH7jf5JRFnz5Bw5YRQS+dCWpHVCN91Ni7W3P32UN6hvAM1ilxGT+K+4SOz7jEa+aBPg==";
        };
        _OpFCn9Ez = {
            "id" = "OpFCn9Ez";
            "file" = "wings-26.2-Fabric-1.1.11.jar";
            "hash" = "sha512-IGc86Qf4q6b2mG+HrvYVHE1u0CuoMIz95YsdTWXA7oZAcxI3ETIq+8mJ2Iufq4yS5ReLo3p0Gf8Vrd3Ppp6GFw==";
        };
        _MQtQIp3n = {
            "id" = "MQtQIp3n";
            "file" = "wings-26.3-rc-2-Fabric-1.1.11.jar";
            "hash" = "sha512-AYwWaDIsCZlUc+c4cbVpH536nABkFxjqPP7JjODcW2gkRPlIogSwKxK3TLge1kv/idhE3szTATZqMeP9itwvVA==";
        };
        _OJf6XMjh = {
            "id" = "OJf6XMjh";
            "file" = "wings-26.3-NeoForge-1.1.11.jar";
            "hash" = "sha512-/O9af/Hx7fB3kTKlJ8Z+AW4Ow3b5llvhuAH8f4a6xko7pDW1rYZXDgUUUvrtdYV8tzXdpHJf+wcUhAI77rpQNg==";
        };
        _zWv12QEo = {
            "id" = "zWv12QEo";
            "file" = "wings-26.3-Fabric-1.1.11.jar";
            "hash" = "sha512-Q7er4Ehex41Y39BKCpxfHZ3foJ0nUJL3eM2O2h/nvJ3NzKQZZAXioEQGaBWUsuu2sNMHSk8uNPHm4SmLAahhlA==";
        };
    in {
        "uMHDrZ6u" = _uMHDrZ6u;
        "Esw1S8W9" = _Esw1S8W9;
        ...
        "neoforge-26.2" = _j8Jbb7h0;
        "neoforge-26.3" = _OJf6XMjh;
        "forge-1.21.4" = _hFzhwTop;
        "forge-1.20" = _WzAD23kT;
        "forge-1.19.4" = _GRgtyLCb;
        "forge-1.19.2" = _YrcqCrh7;
        "forge-1.20.1" = _Tr4Sneol;
        "forge-1.18.2" = _LQhftGDG;
        "fabric-26.1.2" = _rM16KJ7Y;
        "fabric-26.2" = _OpFCn9Ez;
        "fabric-26.3-rc-2" = _MQtQIp3n;
        "fabric-26.3" = _zWv12QEo;
        "pkg-1.0.2" = _Esw1S8W9;
        "pkg-1.0.1" = _Pbi1xPlz;
        "pkg-1.0.3" = _hFzhwTop;
        "pkg-1.0.4" = _ENeyd0yJ;
        "pkg-1.0.5" = _GRgtyLCb;
        "pkg-1.0.6" = _YrcqCrh7;
        "pkg-1.0.5.1" = _w1JkdDHZ;
        "pkg-1.0.7" = _LQhftGDG;
        "pkg-1.0.8" = _e1ieziKY;
        "pkg-1.0.9" = _ao2tvFLN;
        "pkg-1.0.10" = _s9uyLTs3;
        "pkg-1.0.11" = _3ppagIzE;
        "pkg-1.0.12" = _Tr4Sneol;
        "pkg-1.0.13" = _3WieWGCz;
        "pkg-1.0.14" = _lTvt8My1;
        "pkg-1.0.15" = _KMXQsajS;
        "pkg-1.0.16" = _oTTu1F1u;
        "pkg-1.0.17" = _d2n4HtPT;
        "pkg-1.0.18" = _trLwhF9D;
        "pkg-1.1.0" = _PNwJfOEv;
        "pkg-1.1.1" = _ecQhQ1wC;
        "pkg-1.1.2" = _bAWz54Q3;
        "pkg-1.1.3" = _7hRXtq7v;
        ...
        "pkg-1.1.8" = _XxW7qhf4;
        "pkg-1.1.9" = _2siCiTpr;
        "pkg-1.1.10" = _R8VetV9s;
        "pkg-1.1.11" = _zWv12QEo;
        "default" = _zWv12QEo;
    });
