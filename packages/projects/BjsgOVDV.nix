...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _LivNaeNe;
        "pkg-1.0.1+mod" = _Kk3VaZL8;
        "pkg-1.0.2" = _2nnvnf5l;
        "pkg-1.0.2+mod" = _GgQjNTQi;
        "pkg-1.0.2.1" = _INQNf2w5;
        "pkg-1.0.2.1+mod" = _uzXmCH8n;
        "pkg-1.0.2.2" = _5tT2PbT6;
        "pkg-1.0.2.2+mod" = _lUaIGh2L;
        "pkg-1.0.3" = _XwmNbtVC;
        "pkg-1.0.3+mod" = _6NoJLslK;
        "pkg-1.0.4" = _d1Ox7rdq;
        "pkg-1.0.4+mod" = _5K1HnGQL;
        "pkg-1.1" = _GM41BYZq;
