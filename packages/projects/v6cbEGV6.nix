...
let
    ...
    in {
        ...
        "pkg-1.2" = _MrdHJz0n;
        "pkg-1.3" = _YqB5UBjI;
        "pkg-1.3-mod" = _MpFG7MGH;
        "pkg-1.3.1" = _4DKZ4OoK;
        "pkg-1.3.1+mod" = _XzEcRecx;
        "pkg-1.3.2" = _5zJNcCiT;
        "pkg-1.3.2+mod" = _Gdiok3ay;
        "pkg-1.4.0" = _TcdUF2o6;
        "pkg-1.4.0+mod" = _d4ewnypk;
        "pkg-1.4.1" = _8Kb4rixB;
        "pkg-1.4.1+mod" = _thN4tpk1;
        "pkg-1.5.0" = _mHIlw1BD;
        "pkg-1.5.0+mod" = _xsoHWKtC;
        "pkg-1.5.1" = _Hf5mCl0S;
        "pkg-1.5.1+mod" = _tm7LTkUb;
        "pkg-1.5.2" = _S9MTlwfs;
        "pkg-1.5.2+mod" = _s4GybCnq;
        "pkg-1.5.3" = _uqlTH9mN;
        "pkg-1.5.3+mod" = _6PHr5Chg;
        "pkg-1.5.4" = _P7K9YOti;
        "pkg-1.5.4+mod" = _Vo7KD4yj;
        "pkg-1.5.5" = _tSdO7Tv8;
        "pkg-1.5.5+mod" = _XV7UkGja;
        "pkg-1.5.6" = _kpxTVCXZ;
        "pkg-1.5.6+mod" = _p6bHSu88;
        "pkg-1.5.7" = _Lk08DTgC;
        "pkg-1.5.7+mod" = _j6Yt7W7P;
        "pkg-1.6.0" = _aOVdEhLF;
        "pkg-1.6.0+mod" = _BfsiPmiq;
        "pkg-1.6.1" = _SABoXCKq;
        "pkg-1.6.1+mod" = _sREKP8YO;
        "pkg-1.6.2" = _9VQdLMMH;
        "pkg-1.6.2+mod" = _1jelP8t0;
        "pkg-1.6.3" = _eDECP900;
        "pkg-1.6.3+mod" = _jP0ZM9OJ;
        "pkg-1.7.0" = _IfQgjLWh;
        "pkg-1.7.0+mod" = _9NwBTk8t;
        "pkg-1.7.1" = _LhN0qNoZ;
        "pkg-1.7.1+mod" = _WCgYYizp;
        "pkg-1.7.2" = _dqNzjWoO;
        "pkg-1.7.2+mod" = _7BeGr55z;
        "pkg-1.7.3" = _30ygxLfj;
        "pkg-1.7.3+mod" = _J6qPbef4;
        "pkg-1.7.4" = _57GETSRR;
        "pkg-1.7.4+mod" = _abdPd9YG;
        "pkg-1.7.5" = _smoMZVUR;
        "pkg-1.7.5+mod" = _mfqfvxFe;
        "pkg-1.8.0" = _9BehcnSM;
