...
let
    ...
    in {
        ...
        "pkg-1.17.1-2.15-fabric" = _7F7mEY80;
        "pkg-1.18-2.16-forge" = _Q3YILuAe;
        "pkg-1.18-2.16-fabric" = _EGSuwm1J;
        "pkg-1.18-2.22-forge" = _q0CGibTg;
        "pkg-1.16.5-2.22-fabric" = _ILp7UQip;
        "pkg-1.18-2.22-fabric" = _475fj6e8;
        "pkg-1.19-2.22-forge" = _NanXuqPE;
        "pkg-1.19-2.22-fabric" = _pmMCbsN3;
        "pkg-1.19-2.23-forge" = _Un7oJEL8;
        "pkg-b1.7.3-2.7.2-modloader" = _kyT0ersE;
        "pkg-1.19.3-2.24-forge" = _Aax1dmTi;
        "pkg-1.19.3-2.24-fabric" = _5EvmIoqj;
        "pkg-1.19.4-2.24-forge" = _dXBVA16v;
        "pkg-1.19.4-2.24-fabric" = _sjDYaHEo;
        "pkg-1.20-2.25-forge" = _stb5nE30;
        "pkg-1.20-2.25-fabric" = _m0Dd8Cjy;
        "pkg-1.20.2-2.25-forge" = _jBovYAZR;
        "pkg-1.20.4-2.25-neoforge" = _LABx1dmK;
        "pkg-1.20-2.26-fabric" = _mjuG4AYd;
        "pkg-1.20.2-2.26-forge" = _LG14xw1O;
        "pkg-1.20.4-2.26-neoforge" = _7nm8NrSL;
        "pkg-1.20.6-2.26-neoforge" = _1n3YehcE;
        "pkg-1.20.6-2.26-fabric" = _nWbxhour;
        "pkg-1.20.1-2.25.1-forge" = _7JVXOe3K;
        "pkg-1.20.6-2.26-forge" = _GUHZDxpy;
        "pkg-1.21-2.26-forge" = _9IcJV4UJ;
        "pkg-1.21-2.26-neoforge" = _dUVBjrNs;
        "pkg-1.21-2.26-fabric" = _ylmBQ38A;
        "pkg-1.21-2.26.1-neoforge" = _9I21YYxf;
        "pkg-1.21.3-2.26.1-forge" = _m9eRNw3Y;
        "pkg-1.21.3-2.26.1-neoforge" = _pctLmzqC;
        "pkg-1.21.3-2.26.1-fabric" = _DVOFYTew;
        "pkg-1.21.3-2.27-fabric" = _m8rwZENW;
        "pkg-1.21.5-2.28-neoforge" = _zMkO66pV;
        "pkg-1.21.6-2.28-neoforge" = _bjlKDjG5;
        "pkg-1.21.6-2.28-fabric" = _K0YD3bG1;
        "pkg-1.21.6-2.28-forge" = _KWKhYd0F;
        "pkg-1.21.9-2.29-neoforge" = _zseJP3V3;
        "pkg-1.21.9-2.29-forge" = _3LIRnkXu;
        "pkg-1.21.9-2.29-fabric" = _ULOi34Uh;
        "pkg-1.21.11-2.30-neoforge" = _bSiQNj2W;
        "pkg-1.21.11-2.30-forge" = _u3ZGmKjT;
        "pkg-1.21.11-2.30-fabric" = _i1duwnJl;
        "pkg-26.1-2.31-forge" = _aVJiOMeh;
        "pkg-26.1-2.31-neoforge" = _Vd1fgVcT;
        "pkg-26.1-2.31-fabric" = _EBIKCzuP;
