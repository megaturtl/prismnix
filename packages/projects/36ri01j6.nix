...
let
    versions = (let
        ...
        _na6m8LKl = {
            "id" = "na6m8LKl";
            "file" = "Assorted Allays x FA - V.12.0.zip";
            "hash" = "sha512-nVKJbG6dsGcXr+ktFdsz2g3GMxexeg6zu3ohcdR9rzG5jMczIk1tXAvasoa56UjPJ1cXeCb2En20iwV4YJUfDQ==";
        };
    in {
        "jFuxUzkr" = _jFuxUzkr;
        "xJb7ed5x" = _xJb7ed5x;
        ...
        "minecraft-1.20.1" = _na6m8LKl;
        "minecraft-1.20.2" = _na6m8LKl;
        "minecraft-1.20.3" = _na6m8LKl;
        "minecraft-1.20.4" = _na6m8LKl;
        "minecraft-1.20.5" = _na6m8LKl;
        "minecraft-1.20.6" = _na6m8LKl;
        "minecraft-1.21" = _na6m8LKl;
        "minecraft-1.21.1" = _na6m8LKl;
        "minecraft-1.21.2" = _na6m8LKl;
        "minecraft-1.21.3" = _na6m8LKl;
        "minecraft-1.21.4" = _na6m8LKl;
        "minecraft-1.21.5" = _na6m8LKl;
        "minecraft-1.21.6" = _na6m8LKl;
        "minecraft-1.21.7" = _na6m8LKl;
        "minecraft-1.21.8" = _na6m8LKl;
        "minecraft-1.21.9" = _na6m8LKl;
        "minecraft-1.21.10" = _na6m8LKl;
        "minecraft-1.21.11" = _na6m8LKl;
        "minecraft-26.1" = _na6m8LKl;
        "minecraft-26.1.1" = _na6m8LKl;
        "minecraft-26.1.2" = _na6m8LKl;
        "minecraft-26.2" = _na6m8LKl;
        "pkg-5.1" = _jFuxUzkr;
        "pkg-5.1.1" = _xJb7ed5x;
        "pkg-6.0" = _eaCtlvWz;
        "pkg-7.0" = _1AwGqg7M;
