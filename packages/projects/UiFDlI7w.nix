...
let
    ...
    in {
        ...
        "pkg-56" = _oG9BBgoN;
        "pkg-57" = _BXcyuAot;
        "pkg-1.19.2-2.1.8" = _WRi9p0zV;
        "pkg-1.19.2-2.1.9" = _XPjg0cnv;
        "pkg-1.19.2-2.1.10" = _5T3tzDb0;
        "pkg-1.19.4-2.1.11" = _4YXylYGD;
        "pkg-1.20-2.2.0" = _Zf1L57NG;
        "pkg-1.20-2.2.1" = _nZQGdEtB;
        "pkg-1.20-2.2.2" = _NPNhEvEc;
        "pkg-1.20-2.2.3" = _3vR7InB6;
        "pkg-1.19.2-2.1.11" = _4I3zHqZu;
        "pkg-1.20-2.2.4" = _92h9vZlv;
        "pkg-1.19.2-2.1.12" = _eT5mTAw9;
        "pkg-1.19.2-2.1.13" = _W4diY5j4;
        "pkg-1.20-2.2.5" = _d8zsCtRl;
        "pkg-1.20-2.2.6" = _5EBfzxfW;
        "pkg-1.20.4-2.3.0" = _gUMscGnY;
        "pkg-1.20.4-2.3.1" = _Dfk1U496;
        "pkg-1.20-3.0.0" = _PRP4FXVR;
        "pkg-1.19.2-2.2.0" = _EptG6SjX;
        "pkg-1.20-3.0.3" = _57gIh6BF;
        "pkg-1.20-3.0.4" = _Jy76F2z5;
        "pkg-1.20-3.0.5" = _oYfJMF2m;
        "pkg-1.20-3.0.6" = _VItD3Q0A;
        "pkg-1.20.4-2.3.2" = _4PwNOhcG;
        "pkg-1.20.4-2.3.4" = _7ceNjqvF;
        "pkg-1.19.2-2.2.2" = _Hafq3c5d;
        "pkg-1.20-3.0.8" = _sOHY9etv;
        "pkg-1.20-3.0.9" = _xdyKuomv;
        "pkg-neoforge_1.21.1-2.3.4" = _7jIJ4EIC;
        "pkg-fabric_1.21.1-2.3.4" = _3pqoouKP;
        "pkg-neoforge_1.21.1-3.0.10" = _73ahrEsp;
        "pkg-fabric_1.21.1-3.0.10" = _o4kPqokE;
        "pkg-1.20-3.0.10" = _yGrKC4Ka;
        "pkg-fabric_1.21.1-3.0.11" = _3yq87zXe;
        "pkg-neoforge_1.21.1-3.0.11" = _PgO0cG7h;
        "pkg-neoforge_1.21.1-3.0.12" = _xrSuNjLs;
        "pkg-fabric_1.21.1-3.0.12" = _B2qYHaE6;
        "pkg-fabric_1.21.1-3.0.13" = _vbIQEpGW;
        "pkg-neoforge_1.21.1-3.0.13" = _taREqYns;
        "pkg-neoforge_1.21.1-3.0.15" = _EevqxtKR;
        "pkg-fabric_1.21.1-3.0.15" = _pyvbeMNW;
        "pkg-neoforge_1.21.1-3.0.16" = _D0DtyG9G;
        "pkg-fabric_1.21.1-3.0.16" = _FrSxVkJG;
        "pkg-neoforge_1.21.1-3.0.17" = _4s2VowWc;
        "pkg-fabric_1.21.1-3.0.17" = _rfyuhde7;
        "pkg-neoforge_1.21.1-3.0.18" = _q9H7jqDP;
        "pkg-fabric_1.21.1-3.0.18" = _B6YKNhGR;
        "pkg-1.21.1-3.1.1-neoforge" = _KiBs8HOi;
        "pkg-1.21.1-3.1.1-fabric" = _4oUbuPb3;
        "pkg-1.21.1-3.1.2-fabric" = _VUcJll76;
        "pkg-1.21.1-3.1.2-neoforge" = _1BcR4dDg;
        "pkg-1.21.1-3.1.4-fabric" = _VOsIx7Sx;
        "pkg-1.21.1-3.1.4-neoforge" = _Dfz6xp7W;
        "pkg-1.21.1-3.1.5" = _fG7FRkLR;
        "pkg-1.21.1-3.1.7" = _zgR3Xhb5;
