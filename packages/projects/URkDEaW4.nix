...
let
    versions = (let
        ...
        _Q4waoIdV = {
            "id" = "Q4waoIdV";
            "file" = "blastingraw-1.18.2-fabric-4.jar";
            "hash" = "sha512-vGA+SAyYyHrAuEwNQ/utbMALMnRUKAX3qSm0vqiiMmzYkfgeOU93lL7VQb3jEAtcbHGYI9l/vhu4kn1Lm/yXsA==";
        };
        _sNtD2n1J = {
            "id" = "sNtD2n1J";
            "file" = "blastingraw-1.18.2-forge-4.jar";
            "hash" = "sha512-ukYAeILnvlq6CgVOCTgCGcYJm+NiBuggWS70Bb0POBTtl5GFcJwmiWqo51la2/6OjVuX80BjiJtQPe6txAbvJA==";
        };
        _ahv7SGPn = {
            "id" = "ahv7SGPn";
            "file" = "blastingraw-1.19.2-fabric-4.jar";
            "hash" = "sha512-ZPfklXaymMzHL6vbmU4LqX7yYstbFpwfUv6D7aPW7cb+GNh8HFGcAXCP0P88Ej2AROX2ae9dwK28XD6+qtAeGg==";
        };
        _YAzOPNwj = {
            "id" = "YAzOPNwj";
            "file" = "blastingraw-1.19.2-forge-4.jar";
            "hash" = "sha512-R0t5K9H17C+3Pb893244+u0eogE02iuOgbJh2efYdJR0mudy1hu7NbiqeBh985X61GPXlkLBNPl9so1MVrujTA==";
        };
        _XXnI2BgY = {
            "id" = "XXnI2BgY";
            "file" = "blastingraw-1.20.1-fabric-4.jar";
            "hash" = "sha512-hFW/Dn29K1oCIU7OjOydLS4E7PhsiLnxY5EMBDxtP+wUr3kv7pWkCygFJ4IYB9s3bOXUPOs78gEV4unxTl4JjQ==";
        };
        _lxFWiSPM = {
            "id" = "lxFWiSPM";
            "file" = "blastingraw-1.20.1-forge-4.jar";
            "hash" = "sha512-ioSwofajjjz4QCZOcZW7ThyXwaFhAWcjk9dDM1cGWs4emYfT2jpWLa3xR47Jh7AH7EnUkwDHcw9077QAxwi8/g==";
        };
        _NJo2fIoK = {
            "id" = "NJo2fIoK";
            "file" = "blastingraw-1.21.1-fabric-4.jar";
            "hash" = "sha512-NOEaw9M22sjyzTVjIrvzZlPGkLvqPcEmnLWHH+kPMo/JJX/lfsxclEay04nRz4v14cRKZNocnA80pEAO5MAxVg==";
        };
        _IsGA7NRg = {
            "id" = "IsGA7NRg";
            "file" = "blastingraw-1.21.1-forge-4.jar";
            "hash" = "sha512-82yMLVDPNFcIX8kgB5QrhiW7EpCNgkqOzkCjP/72trFHZYb+8cXjPVwtOGTz9vaR6aF+gTvcwkKnUrzex8NbxQ==";
        };
        _966ENAQ8 = {
            "id" = "966ENAQ8";
            "file" = "blastingraw-1.21.1-neoforge-4.jar";
            "hash" = "sha512-mf5GDju+Wl7slty9jt/W96JYJ6C4js4R+bGzuGSwBFiImzx8CaPr9s/aqpDN5QU5WkK0P5mSh1lgbp46KTuyfg==";
        };
        _nOYSn6vB = {
            "id" = "nOYSn6vB";
            "file" = "blastingraw-26.1.2-fabric-4.jar";
            "hash" = "sha512-LlBWvIaxLeGk5V/lpDSHDRWmfILT73NyP1hXOP+scGqB1PQrUtsQNjjDPLC+PZL0ghqWMJFDMqZv918O970Xgg==";
        };
        _U7AreLiR = {
            "id" = "U7AreLiR";
            "file" = "blastingraw-26.1.2-forge-4.jar";
            "hash" = "sha512-8BJiBU9GBcHJ/QU2k/sZ0YjzHdYOMsfjdVmucxqCcqz7NpCb1dL9529rP3qM/OimOtspFQ5E8AUJIf3qBTl85g==";
        };
        _2h4gSCph = {
            "id" = "2h4gSCph";
            "file" = "blastingraw-26.1.2-neoforge-4.jar";
            "hash" = "sha512-ck9J1mlfSQaxQ0yyZMzRQlTBQ1MEBe6KKXw/y2AoSGN9zDArLhvyhEvD6jKRAzfU1f/CQ36MVbMmtV0n3DE04A==";
        };
        _5GWQiLdb = {
            "id" = "5GWQiLdb";
            "file" = "blastingraw-26.2-fabric-4.jar";
            "hash" = "sha512-H2wG2Ea85m1RCDvYFL1X+JpZTLvFJz7Eia5LKRTfSi3s+vF+dMto52yFDPFfc8NQuOmDzG2oUtfUFHD8CwoEQA==";
        };
        _vdgwpU6D = {
            "id" = "vdgwpU6D";
            "file" = "blastingraw-26.2-forge-4.jar";
            "hash" = "sha512-3Tv6C7J4rOcUw+mT75Nb3ztY4K7fVliaKI5L54MwIBFT0kPvxjYFDulkTMUPFyN8TMBMZnctq2IfuYJBqqhe4g==";
        };
        _Ue4lEPxh = {
            "id" = "Ue4lEPxh";
            "file" = "blastingraw-26.2-neoforge-4.jar";
            "hash" = "sha512-OBKpDSC4mbf5QjvGvwfsM/ZszGyEqxheBk+tyd9Cx/k6qpis1x/8BsZSRaANjojQUqssCw25q9d2FcZTtz68uw==";
        };
    in {
        "qmvN8Fig" = _qmvN8Fig;
        "lHRC2J9n" = _lHRC2J9n;
        ...
        "fabric-26.1" = _nOYSn6vB;
        "fabric-26.1.1" = _nOYSn6vB;
        "fabric-26.1.2" = _nOYSn6vB;
        "fabric-26.2" = _5GWQiLdb;
        "quilt-1.18.2" = _Q4waoIdV;
        "quilt-1.19" = _ahv7SGPn;
        "quilt-1.19.1" = _ahv7SGPn;
        "quilt-1.19.2" = _ahv7SGPn;
        "quilt-1.19.3" = _VJQajD9n;
        "quilt-1.19.4" = _gBeKJwqK;
        "quilt-1.20" = _XXnI2BgY;
        "quilt-1.20.1" = _XXnI2BgY;
        "quilt-1.18.1" = _Q4waoIdV;
        "quilt-1.20.2" = _D4dATsTI;
        "quilt-1.20.3" = _ogIDzPHE;
        "quilt-1.20.4" = _ogIDzPHE;
        "quilt-1.20.5" = _WDj7rZop;
        "quilt-1.20.6" = _WDj7rZop;
        "quilt-1.21" = _NJo2fIoK;
        "quilt-1.21.1" = _NJo2fIoK;
        "quilt-1.21.2" = _gC42HnQK;
        "quilt-1.21.3" = _gC42HnQK;
        "quilt-1.21.4" = _s1gvBb0c;
        "quilt-1.18" = _Q4waoIdV;
        ...
        "quilt-26.1" = _nOYSn6vB;
        "quilt-26.1.1" = _nOYSn6vB;
        "quilt-26.1.2" = _nOYSn6vB;
        "quilt-26.2" = _5GWQiLdb;
        "forge-1.18.2" = _sNtD2n1J;
        "forge-1.19" = _YAzOPNwj;
        "forge-1.19.1" = _YAzOPNwj;
        "forge-1.19.2" = _YAzOPNwj;
        "forge-1.19.3" = _ooQjoSAX;
        "forge-1.19.4" = _yqUj0OIn;
        "forge-1.20" = _lxFWiSPM;
        "forge-1.20.1" = _lxFWiSPM;
        "forge-1.20.2" = _qkoOe9N9;
        "forge-1.18.1" = _sNtD2n1J;
        "forge-1.20.3" = _wgmRtnMu;
        "forge-1.20.4" = _wgmRtnMu;
        "forge-1.20.6" = _RSQ3iOtp;
        "forge-1.21" = _IsGA7NRg;
        "forge-1.21.1" = _IsGA7NRg;
        "forge-1.21.3" = _UW1qKjNR;
        "forge-1.21.4" = _Vr2BKUyc;
        "forge-1.18" = _sNtD2n1J;
        ...
        "forge-26.1" = _U7AreLiR;
        "forge-26.1.1" = _U7AreLiR;
        "forge-26.1.2" = _U7AreLiR;
        "forge-26.2" = _vdgwpU6D;
        "neoforge-1.20.2" = _wp3akmKG;
        "neoforge-1.20.4" = _6MR2ljRJ;
        "neoforge-1.20.6" = _ouIN8PTv;
        "neoforge-1.20.5" = _ouIN8PTv;
        "neoforge-1.21" = _966ENAQ8;
        "neoforge-1.21.1" = _966ENAQ8;
        "neoforge-1.21.2" = _ke5KkRzA;
        "neoforge-1.21.3" = _ke5KkRzA;
        "neoforge-1.21.4" = _6Tt8Ehht;
        "neoforge-1.20" = _lxFWiSPM;
        "neoforge-1.20.1" = _lxFWiSPM;
        ...
        "neoforge-26.1" = _2h4gSCph;
        "neoforge-26.1.1" = _2h4gSCph;
        "neoforge-26.1.2" = _2h4gSCph;
        "neoforge-26.2" = _Ue4lEPxh;
        "pkg-1.18.2-0-fabric" = _qmvN8Fig;
        "pkg-1.18.2-0-forge" = _lHRC2J9n;
        "pkg-1.19-0-fabric" = _WkDlDA8g;
        "pkg-1.19-0-forge" = _NljMEWlt;
        "pkg-1.19.1-0-fabric" = _dE7NYBA4;
        "pkg-1.19.1-0-forge" = _9lsKHx5n;
        "pkg-1.19.2-0-fabric" = _vSHNwxeI;
        "pkg-1.19.2-0-forge" = _tuFEzZKx;
        "pkg-1.19.3-0-fabric" = _VVoNO8zT;
        "pkg-1.19.3-0-forge" = _EjzHBhWV;
        "pkg-1.19.4-0-fabric" = _XIh6T43W;
        "pkg-1.19.4-0-forge" = _jX3BC3vA;
        "pkg-1.20-0-fabric" = _8FansQhK;
        "pkg-1.20-0-forge" = _YyqymBUh;
        "pkg-1.20.1-0-fabric" = _TQOl80RT;
        "pkg-1.20.1-0-forge" = _xyTMUQBH;
        "pkg-1.20.2-0-forge" = _3DpTcnt4;
        "pkg-1.18.1-1-fabric" = _gUjsMuUQ;
        "pkg-1.18.1-1-forge" = _WEBbfk2e;
        "pkg-1.18.2-fabric" = _cp95fBP2;
        "pkg-1.18.2-1-forge" = _nLkAvoFz;
        "pkg-1.19-fabric" = _AgBPAOsr;
        "pkg-1.19-1-forge" = _t9wiJKqx;
        "pkg-1.19.1-fabric" = _4HMWbCng;
        "pkg-1.19.1-1-forge" = _c7CjSnLZ;
        "pkg-1.19.2-fabric" = _mYcvp7IC;
        "pkg-1.19.2-1-forge" = _fo5Iobs7;
        "pkg-1.19.3-fabric" = _sISR6HMA;
        "pkg-1.19.3-1-forge" = _IR1sFKEj;
        "pkg-1.19.4-fabric" = _w599I9L5;
        "pkg-1.19.4-1-forge" = _RmfSd6p4;
        "pkg-1.20-1-forge" = _K7j3U5TP;
        "pkg-1.20-fabric" = _iuq3G1tz;
        "pkg-1.20.1-1-fabric" = _NhXkRNQS;
        "pkg-1.20.1-1-forge" = _wJj8WU4b;
        "pkg-1.20.2-1-fabric" = _N0zywzAv;
        "pkg-1.20.2-1-forge" = _8ge2H921;
        "pkg-1.20.3-1-fabric" = _mHNMTu0Z;
        "pkg-1.20.3-1-forge" = _rYilVTVD;
        "pkg-1.20.4-1-forge" = _AT0OQhRl;
        "pkg-1.20.4-1-fabric" = _69sYG1j1;
        "pkg-1.20.2-1-neoforge" = _ZvNg8ywv;
        "pkg-1.20.4-0-neoforge" = _5d0VnmpH;
        "pkg-1.20.5-1-fabric" = _hzLlJKYZ;
        "pkg-1.20.6-1-fabric" = _znACvLtR;
        "pkg-1.20.6-0-neoforge" = _nCpYRRCo;
        "pkg-1.20.5-1-neoforge" = _6KqJ9O1L;
        "pkg-1.20.6-1-forge" = _CNuzCsPi;
        "pkg-1.18.1-2-fabric" = _cr9OE911;
        "pkg-1.18.2-2-fabric" = _LKQTKMRq;
        "pkg-1.19-2-fabric" = _w0bzYE5K;
        "pkg-1.21-2-fabric" = _S8JT9saB;
        "pkg-1.19.1-2-fabric" = _FbZE1Sso;
        "pkg-1.19.2-2-fabric" = _hSmlRieh;
        "pkg-1.19.3-2-fabric" = _VJQajD9n;
        "pkg-1.19.4-2-fabric" = _mkOdU531;
        "pkg-1.20-2-fabric" = _cHAr4ybf;
        "pkg-1.20.1-2-fabric" = _urVOP67z;
        "pkg-1.20.2-2-fabric" = _kZv6lnFl;
        "pkg-1.20.3-2-fabric" = _KtyWzuge;
        "pkg-1.20.4-2-fabric" = _GhkiLOP2;
        "pkg-1.20.5-2-fabric" = _E1Pu8aCc;
        "pkg-1.20.6-2-fabric" = _7ILCANgL;
        "pkg-1.20.2-2-neoforge" = _wp3akmKG;
        "pkg-1.20.6-1-neoforge" = _pM9g05Od;
        "pkg-1.20.4-1-neoforge" = _6MR2ljRJ;
        "pkg-1.18.1-2-forge" = _vs4rHI74;
        "pkg-1.18.2-2-forge" = _OzCk7NIN;
        "pkg-1.19-2-forge" = _EnoTQ5r0;
        "pkg-1.19.1-2-forge" = _rAMn9Ytu;
        "pkg-1.19.2-2-forge" = _qLf31WaV;
        "pkg-1.19.3-2-forge" = _ooQjoSAX;
        "pkg-1.19.4-2-forge" = _E4V7TyUt;
        "pkg-1.20-2-forge" = _sPgIBnYB;
        "pkg-1.20.1-2-forge" = _kUlkUCfJ;
        "pkg-1.20.2-2-forge" = _T6MdnPwd;
        "pkg-1.20.4-2-forge" = _Wx4AALFC;
        "pkg-1.20.3-2-forge" = _Y4EM48fA;
        "pkg-1.20.6-2-forge" = _PXtFnWtj;
        "pkg-1.21-2-forge" = _S7iEVdFY;
        "pkg-1.21-1-neoforge" = _Bc3I9etH;
        "pkg-1.20.5-1.1-neoforge" = _bL0gjfIn;
        "pkg-1.20.6-1.1-neoforge" = _QcdRR7ZM;
        "pkg-1.21-1.1-neoforge" = _x5dMPMTS;
        "pkg-1.21.1-1.1-neoforge" = _CyyNOezV;
        "pkg-1.21.1-2-fabric" = _F7jHpYPa;
        "pkg-1.21.1-2-forge" = _WZOmaVc7;
        "pkg-1.21.2-2-fabric" = _7ZSSGhqk;
        "pkg-1.21.3-2-forge" = _gzUsrmjw;
        "pkg-1.21.3-1.1-neoforge" = _u3cNj9Mo;
        "pkg-1.21.4-2-fabric" = _RrraMHkn;
        "pkg-1.21.4-1.1-neoforge" = _cBRmAQ9i;
        "pkg-1.21.4-2-forge" = _5UQbRjJM;
        "pkg-1.18.2-fabric-3" = _gbICI4wy;
        "pkg-1.18.2-forge-3" = _mnzYMiV5;
        "pkg-1.19.2-fabric-3" = _s7gi5xxy;
        "pkg-1.19.2-forge-3" = _QUpLuRzv;
        "pkg-1.19.4-fabric-3" = _gBeKJwqK;
        "pkg-1.19.4-forge-3" = _g4zyFFqy;
        "pkg-1.20.1-fabric-3" = _HnFn0X2D;
        "pkg-1.20.1-forge-3" = _sB2lhsPH;
        "pkg-1.20.2-fabric-3" = _D4dATsTI;
        "pkg-1.20.2-forge-3" = _LjiKOS69;
        "pkg-1.20.4-fabric-3" = _ogIDzPHE;
        "pkg-1.20.4-forge-3" = _f8bvG0rb;
        "pkg-1.20.6-fabric-3" = _WDj7rZop;
        "pkg-1.20.6-forge-3" = _ohIBVK5W;
        "pkg-1.20.6-neoforge-3" = _hdrTUDek;
        "pkg-1.21.1-fabric-3" = _348icCeq;
        "pkg-1.21.1-forge-3" = _oDBdLh7A;
        "pkg-1.21.1-neoforge-3" = _1yG7Bosr;
        "pkg-1.21.3-fabric-3" = _gC42HnQK;
        "pkg-1.21.3-forge-3" = _UpudSSlb;
        "pkg-1.21.3-neoforge-3" = _hjdimkTv;
        "pkg-1.21.4-fabric-3" = _s1gvBb0c;
        "pkg-1.21.4-forge-3" = _IlSo5rYI;
        "pkg-1.21.4-neoforge-3" = _Kuq5VGFE;
        "pkg-1.18.2-fabric-3.1" = _cmzngIIl;
        "pkg-1.18.2-forge-3.1" = _rThGjqBY;
        "pkg-1.19.2-forge-3.1" = _XorVAOGt;
        "pkg-1.19.4-forge-3.1" = _yqUj0OIn;
        "pkg-1.20.1-forge-3.1" = _yHKo8CWt;
        "pkg-1.20.2-forge-3.1" = _qkoOe9N9;
        "pkg-1.20.4-forge-3.1" = _wgmRtnMu;
        "pkg-1.20.6-forge-3.1" = _RSQ3iOtp;
        "pkg-1.20.6-neoforge-3.1" = _ouIN8PTv;
        "pkg-1.21.1-forge-3.1" = _iXNmsRdG;
        "pkg-1.21.1-neoforge-3.1" = _JqOUs4sJ;
        "pkg-1.21.3-forge-3.1" = _UW1qKjNR;
        "pkg-1.21.3-neoforge-3.1" = _ke5KkRzA;
        "pkg-1.21.4-forge-3.1" = _Vr2BKUyc;
        "pkg-1.21.4-neoforge-3.1" = _6Tt8Ehht;
        "pkg-1.21.5-fabric-3.1" = _9Xftdxlf;
        "pkg-1.21.5-forge-3.1" = _hNCvU9DD;
        "pkg-1.21.5-neoforge-3.1" = _T6nXpoK5;
        "pkg-1.21.6-fabric-3.1" = _9cnmrc97;
        "pkg-1.21.6-forge-3.1" = _Vxqio0YR;
        "pkg-1.21.6-neoforge-3.1" = _H6WKdwSz;
        "pkg-1.21.7-fabric-3.1" = _4LIp8Pqh;
        "pkg-1.21.7-forge-3.1" = _CW8nGZ2i;
        "pkg-1.21.7-neoforge-3.1" = _Dl2U40Lz;
        "pkg-1.21.7-fabric-3.2" = _yIxp2TQQ;
        "pkg-1.21.7-forge-3.2" = _vUSOxQF2;
        "pkg-1.21.7-neoforge-3.2" = _CtBiBfb7;
        "pkg-1.21.8-fabric-3.2" = _AWJozItc;
        "pkg-1.21.8-forge-3.2" = _T71gzMbB;
        "pkg-1.21.8-neoforge-3.2" = _iBLvyiFH;
        "pkg-1.21.9-fabric-3.2" = _4N8jLtLT;
        "pkg-1.21.9-forge-3.2" = _jwWDAxMp;
        "pkg-1.21.9-neoforge-3.2" = _drBnXKCJ;
        "pkg-1.21.10-fabric-3.2" = _yL4A0JtT;
        "pkg-1.21.10-forge-3.2" = _tyx7TDu0;
        "pkg-1.21.10-neoforge-3.2" = _zhwp0dko;
        "pkg-1.21.11-fabric-3.2" = _LVuFigXN;
        "pkg-1.21.11-forge-3.2" = _zJyLpsaT;
        "pkg-1.21.11-neoforge-3.2" = _WIs8tpb4;
        "pkg-26.1.1-fabric-3.2" = _RpRCKp0e;
        "pkg-26.1.1-forge-3.2" = _m8sXlclG;
        "pkg-26.1.1-neoforge-3.2" = _HpwYWNER;
        "pkg-26.1.2-fabric-3.2" = _BolEcIrq;
        "pkg-26.1.2-forge-3.2" = _6x6nfpI7;
        "pkg-26.1.2-neoforge-3.2" = _j4Pc4obj;
        "pkg-1.18.2-fabric-4" = _Q4waoIdV;
        "pkg-1.18.2-forge-4" = _sNtD2n1J;
        "pkg-1.19.2-fabric-4" = _ahv7SGPn;
        "pkg-1.19.2-forge-4" = _YAzOPNwj;
        "pkg-1.20.1-fabric-4" = _XXnI2BgY;
        "pkg-1.20.1-forge-4" = _lxFWiSPM;
        "pkg-1.21.1-fabric-4" = _NJo2fIoK;
        "pkg-1.21.1-forge-4" = _IsGA7NRg;
        "pkg-1.21.1-neoforge-4" = _966ENAQ8;
        "pkg-26.1.2-fabric-4" = _nOYSn6vB;
        "pkg-26.1.2-forge-4" = _U7AreLiR;
        "pkg-26.1.2-neoforge-4" = _2h4gSCph;
        "pkg-26.2-fabric-4" = _5GWQiLdb;
        "pkg-26.2-forge-4" = _vdgwpU6D;
        "pkg-26.2-neoforge-4" = _Ue4lEPxh;
        "default" = _Ue4lEPxh;
    });
