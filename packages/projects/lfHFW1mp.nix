...
let
    versions = (let
        ...
        _NEuFyZwX = {
            "id" = "NEuFyZwX";
            "file" = "journeymap-forge-1.12.2-6.0.0.jar";
            "hash" = "sha512-6X0ZaAq9jOTzi6MdCOi/4Phw2X+sxXlrh5VdB35c+ZvqW7QAE+6iuKuvZ3h5omCY9IpA492XNS6+OxliUnwO/w==";
        };
        _cmyJmFx9 = {
            "id" = "cmyJmFx9";
            "file" = "journeymap-fabric-26.1.2-6.0.3.jar";
            "hash" = "sha512-j61MWy72j2e1lsVSmAfXw8hNVWFQje9Cx3Sxhyr2wyedwdFTSuhXkw2IntwaVIKijs5Q3FIgGVAmit0n3dAv0w==";
        };
        _Be26Ad7m = {
            "id" = "Be26Ad7m";
            "file" = "journeymap-fabric-26.2-6.0.3.jar";
            "hash" = "sha512-30F9DMJxsHptqjgFUA1/f0IJEdy3s+othENyHoVPdoxOjHlRTn/wiDa4A5PC4zjsPcCL/fTfzSKPK5O2P6RAng==";
        };
        _SiF6Rv1W = {
            "id" = "SiF6Rv1W";
            "file" = "journeymap-forge-26.1.2-6.0.3.jar";
            "hash" = "sha512-oMMytIVUqIr+nmdNrYDS2/RkUWBRjBYUt7T5Fzk3SgDx5p9ff6Pz8eYAYJNGZ/wx7ifrZOAkbwR0Shb37nlZGg==";
        };
        _zZZVo6JD = {
            "id" = "zZZVo6JD";
            "file" = "journeymap-forge-26.2-6.0.3.jar";
            "hash" = "sha512-TvSqE/DvXZXMBU0VXP5L7REZmpJe1ZVlE+TBgsTucnGu/DFGGVB4v+vCafftrkKNNGAMY/hzz00R5aVyW+EHFg==";
        };
        _Z39imYpL = {
            "id" = "Z39imYpL";
            "file" = "journeymap-neoforge-26.1.2-6.0.3.jar";
            "hash" = "sha512-Wfc3UAAmNwt1erMTu0jECXaMmD0ygO8rzsMcrraJkgAwXz/RYrsA/UmhFSoj9KQFa4bB+6xR5acL026Lx0VuWA==";
        };
        _W27AkEGm = {
            "id" = "W27AkEGm";
            "file" = "journeymap-neoforge-26.2-6.0.3.jar";
            "hash" = "sha512-RB0fgEtOZ1uKExBIaCQA0FSQLTlwQfvdo5q5O6cX2hN0HyrhvzwAVXixzEQ1Zti8EXIZrUL/z/dd0C85vzcgIw==";
        };
        _avhCwDqc = {
            "id" = "avhCwDqc";
            "file" = "journeymap-paper-26.1.2-6.0.3.jar";
            "hash" = "sha512-Nn+Nk+C1GCa0b2KpTxPpdpRh2O2hX3dSkAjlmFwaXy6wLFxhsKgQoU+mgp24Ul9Bovmd1jrRNMH3hR54xVzQNQ==";
        };
        _mq5sQR8o = {
            "id" = "mq5sQR8o";
            "file" = "journeymap-paper-26.2-6.0.3.jar";
            "hash" = "sha512-bEd97FPLpGfB5WjYs1HIhiZoDHDRczC8yvXnDVmCPAxgpRCl2mKkFnIt9LtqttgzBOM/GEOpYC5Yvy7uQqV01Q==";
        };
        _tGKMq7hr = {
            "id" = "tGKMq7hr";
            "file" = "journeymap-fabric-1.21.1-6.0.3.jar";
            "hash" = "sha512-BSyXJc595MgXVNHn8vlkKrsT5A2mS1PyzhIWA8Sx01hUUM3EL9k8m1Iw2tn1X84EqwPAQtv4XRcklMN9QnqcUQ==";
        };
        _qrbXF9cA = {
            "id" = "qrbXF9cA";
            "file" = "journeymap-forge-1.21.1-6.0.3.jar";
            "hash" = "sha512-nq4IAMhibl6oFzYLEYjsLRe/uduDJ+Lac3QXuCaujLwOsvOsm4gtx9HSWxpAmUS+DWjH30xiuUoCy/CIpYoVhQ==";
        };
        _WEOAmpDC = {
            "id" = "WEOAmpDC";
            "file" = "journeymap-neoforge-1.21.1-6.0.3.jar";
            "hash" = "sha512-w+X26CGDG/kzadkdn3pzG4t5fJhEpiu0AnPp9uh78SKhGb0kHxaGHvfiA9Kcu0DnOvHXzwfj+gEImyWoz4c4FA==";
        };
        _WskpJ10s = {
            "id" = "WskpJ10s";
            "file" = "journeymap-fabric-1.16.5-6.0.0.jar";
            "hash" = "sha512-/NavSMsQNMVW6EwOaFjy19onk4GUdfe2N8ZA1uUNZW+F2P4bseSZclRbhWkfNjnHaN4qeomdCZcbDAnwP9JsyA==";
        };
        _d4n4NCgN = {
            "id" = "d4n4NCgN";
            "file" = "journeymap-forge-1.16.5-6.0.0.jar";
            "hash" = "sha512-PQSQm+JzeXfC8n6ltbh+hHhfD6ldFGkmw6iITNw6NK2xsz4iFGYzdCqEamLiFQxfD84ZHozQgdLJvlttXse+EA==";
        };
        _lxSoN7kO = {
            "id" = "lxSoN7kO";
            "file" = "journeymap-fabric-1.20.1-6.0.0.jar";
            "hash" = "sha512-kh7OcY3JrfVxnqEILdb4nM2BOs+avJd3z6sQfNa1un/NhHBFHtAyZQ9kBFEb2C9UIltT5ev68VPcwL1QGvcX3g==";
        };
        _9xIDlHWu = {
            "id" = "9xIDlHWu";
            "file" = "journeymap-forge-1.20.1-6.0.0.jar";
            "hash" = "sha512-iWxB2dQTnD92C/Fks7rY079axmRCFWVgeKEW1yqxOKQW33u1K4sQzwQWh1jLwI0ByPju4Ny+wa6tqY+kpXqwZQ==";
        };
        _bgfysrBe = {
            "id" = "bgfysrBe";
            "file" = "journeymap-forge-1.7.10-6.0.0.jar";
            "hash" = "sha512-s4TMcuMt2gyl+WeE8pte+fEInnAS3OersEfQ8EQVEM6vnY5jsCFosHeq24F3XZAAEWnFRBmkw2dm5gtqbbYGrw==";
        };
        _jqnEurcR = {
            "id" = "jqnEurcR";
            "file" = "journeymap-forge-1.12.2-6.0.1.jar";
            "hash" = "sha512-wPYwD7JRL3uBZpMtCibVPAcBvLW//EM2TEajecB3JtayQUcJosN2rlRdk9F2gbj4CnTB8bBVAdIztBUQi0/sJw==";
        };
        _syuoOEqF = {
            "id" = "syuoOEqF";
            "file" = "journeymap-forge-1.12.2-6.0.2.jar";
            "hash" = "sha512-u1743VsM0LJLOiwwJABEXy+y6iZxp0NXGlz0uaaNpJfjRDTJ4hMPrYQer91TbAlCBuobsxQrMAlibI8l/HjkNQ==";
        };
        _v6EIBVUQ = {
            "id" = "v6EIBVUQ";
            "file" = "journeymap-fabric-26.1.2-6.0.4.jar";
            "hash" = "sha512-FSYkLUxFQZYSodK7Nb9rMs95vshvSPXa4xy+8+SHgKs3w7F7Jcx99Z12iyLl1xdurhXh5qw+rVI7JVuYY5kang==";
        };
        _eJ3VxnPm = {
            "id" = "eJ3VxnPm";
            "file" = "journeymap-forge-26.1.2-6.0.4.jar";
            "hash" = "sha512-bDxOsvMhNtJXxzoyoTUXBlHHTGZDL5pI5JpVxbPoSIsSeOnsQqshPlQV/2nastVmy7T7QWj2V/1d2I0xvcxFVA==";
        };
        _MYF1fYGU = {
            "id" = "MYF1fYGU";
            "file" = "journeymap-neoforge-26.1.2-6.0.4.jar";
            "hash" = "sha512-GnYNV+hOHuKPHMvZ27l2dbKFzCxJC5Q63OIvHbvzPByMZoNZBmEo5ddH/imaU/hDY/W7pA7H/fy44X6T++pV4g==";
        };
        _9gm3cYQF = {
            "id" = "9gm3cYQF";
            "file" = "journeymap-paper-26.1.2-6.0.4.jar";
            "hash" = "sha512-TdCVtcf9Ekds2dxeA/8s/lJJS4UBiwgKD9S8uc+NiFkAlBn3twxf3N2uX+7sj8GZFEdeY246M3ja/GZDir9LAg==";
        };
        _uugpK0Hl = {
            "id" = "uugpK0Hl";
            "file" = "journeymap-fabric-26.2-6.0.4.jar";
            "hash" = "sha512-V5MiOZHBybfgr1N/U9JjJ2U87lVTWpOrmgtLB2qOFoMTjIBqze485Rotz5RELwbK6co0WprHSBAYVdB7xx9OoA==";
        };
        _cUAXiyKr = {
            "id" = "cUAXiyKr";
            "file" = "journeymap-forge-26.2-6.0.4.jar";
            "hash" = "sha512-5FG454AM5iAumqteRWqYFDMki5rloVdE+1p5KF9nibUbgaR675B855KKg1tsAZwiurodz13SqVpywVSrmA7cHQ==";
        };
        _m1NSCXoV = {
            "id" = "m1NSCXoV";
            "file" = "journeymap-neoforge-26.2-6.0.4.jar";
            "hash" = "sha512-X0AcOiyEebWPNZXP6HXakmXTbZIpDihZBTFk4SFvf6WSnB28lV7yzLpLoO8Il3SNC+g2R4f+KFMnYZm3N1mrVw==";
        };
        _Kl9AFXm8 = {
            "id" = "Kl9AFXm8";
            "file" = "journeymap-paper-26.2-6.0.4.jar";
            "hash" = "sha512-sdfL91vZH82qTSB0uiWidZqvSN/ZRT1WiyyYN5pfG6/W8rxocaNxExM3ujxgp0oXfsTJ90GvAxxbw1OrkQEKJQ==";
        };
        _lWx9W99B = {
            "id" = "lWx9W99B";
            "file" = "journeymap-forge-1.12.2-6.0.3.jar";
            "hash" = "sha512-hf8r369neHXscu1aCaHC7anb/L6oUJN3nVQyJuWCFD6SL2Hi6txBXV7dJ9z+yOOfiUoI0qE2KWR13eGlm4k5KQ==";
        };
        _uLzdDes0 = {
            "id" = "uLzdDes0";
            "file" = "journeymap-fabric-1.21.1-6.0.4.jar";
            "hash" = "sha512-9htEMdsl6q4R44f1lo7pj75LmxV2/R1CEDB0kWM4jz5e8hXH63vgKz3sNg14PUSxERmPu+7e5nlGy5OGDEehBQ==";
        };
        _ocUzqyr8 = {
            "id" = "ocUzqyr8";
            "file" = "journeymap-forge-1.21.1-6.0.4.jar";
            "hash" = "sha512-UtQHw7gl2P1tnJGsWYe82MToNiSydtPuSlIvi7n13F4KfQoms0tXhK6D0HnbfWNo22fnF+vKRDlvELWW1bxIuQ==";
        };
        _BWZbAAhc = {
            "id" = "BWZbAAhc";
            "file" = "journeymap-neoforge-1.21.1-6.0.4.jar";
            "hash" = "sha512-HkRy98V/SaXAeXEJdFwdqa6YAGRmlrDWTj+zRl0TT1H1jkP5JNwcwvRPHjGiKszG2kZWqCbDsygDI2TVKDcSEQ==";
        };
        _3QrQsPgT = {
            "id" = "3QrQsPgT";
            "file" = "journeymap-fabric-1.20.1-6.0.1.jar";
            "hash" = "sha512-hiJW5PtrDhLd5XWK924MjxWxHHToUEgZcJ7vxMSTcM6wqE5Y3/A0gFiWnpqPws/q83a409c+nXGSZr05D1G9lw==";
        };
        _T7k6KTVz = {
            "id" = "T7k6KTVz";
            "file" = "journeymap-forge-1.20.1-6.0.1.jar";
            "hash" = "sha512-IcInv5UjkunKnWDJECARvhspUasVKuvVp3RWQMMimlTlPCrphpxWHKIV0F7KP7NJgoYZ9qwhfetIGoJccZl0MQ==";
        };
        _cxw6VoUX = {
            "id" = "cxw6VoUX";
            "file" = "journeymap-forge-1.7.10-6.0.1.jar";
            "hash" = "sha512-A65HLNzhLqkqMe0H26hpP8ioMRwUbDWPbU5uw/+J1GxDgpDv+m1rdOmaac32P6YvxQLxAjWEWX9lkIOHcArVkQ==";
        };
        _2pFlZknr = {
            "id" = "2pFlZknr";
            "file" = "journeymap-fabric-1.16.5-6.0.1.jar";
            "hash" = "sha512-TTyhwcWvPdB7Nq0rIrzdAnbC92+ngjiDMh7Isp4jpioEEXg1UkWDJXRDHF8bYD43qkxjqrpgNS//lj+oO95SBw==";
        };
        _eqp2P3wZ = {
            "id" = "eqp2P3wZ";
            "file" = "journeymap-forge-1.16.5-6.0.1.jar";
            "hash" = "sha512-FD/z+PLlQk95y8aXFWmZmbLLTyeqRn9WmLYqv8Li5jPba6IRXLcN54+gbwUWcOE8g6D4VokazqYQ/n2/4PK1AQ==";
        };
        _MTFGRxSI = {
            "id" = "MTFGRxSI";
            "file" = "journeymap-fabric-1.16.5-6.0.2.jar";
            "hash" = "sha512-1MK1OWcJOMpflmDQnjHPzMG5qu3Dg3lRspaucTzdxWTpKhemh5Jch0TkY9cqhdaHY2kz5HM9au/Mw+v8Or6a7g==";
        };
        _6GNciFBx = {
            "id" = "6GNciFBx";
            "file" = "journeymap-forge-1.16.5-6.0.2.jar";
            "hash" = "sha512-8MHLA7Nx0W1a7axY/zyHzSrSQWQ8Jx7DNR3HlKxyR06UPdVYL+qhgMG6p+hq/HWu+NnPiT1ru1JM6PpP1rICWA==";
        };
        _eisqBbU5 = {
            "id" = "eisqBbU5";
            "file" = "journeymap-fabric-1.16.5-6.0.3.jar";
            "hash" = "sha512-Cb26erHNmYtoO007G37Jsnh20f5NT2RIO2tDJJMt00evmHiY9TeDd2l4U04aVxrw+TwuuocOVIXniCNGBJKo9w==";
        };
        _yoAO8hPk = {
            "id" = "yoAO8hPk";
            "file" = "journeymap-forge-1.16.5-6.0.3.jar";
            "hash" = "sha512-9S0GOGkUt1fDCaHzAyzKOuTm7iP1CaK0ne+3WaiFCaE6hlxIeciy6V+rJnbes7TqDL1pg8nfEsEfXxW6N+ic2Q==";
        };
        _wRmNfEpC = {
            "id" = "wRmNfEpC";
            "file" = "journeymap-forge-1.12.2-6.0.4.jar";
            "hash" = "sha512-5+Zz1ZtPFVgi0RFCL9Mlw87xg2YawV+ltgLYVOxH/fQRoRhRNLDAseDnY3ndoAOz6houzGHnKq4fsq3zyZBvaQ==";
        };
        _1v6TlbvA = {
            "id" = "1v6TlbvA";
            "file" = "journeymap-forge-1.7.10-6.0.2.jar";
            "hash" = "sha512-W975HcogtTf/H+LoTG3+d92qgVF2Uy2Cm7U6AfKsR37KHrT878TfrPqNkzEJ2QRVexiNtGeoIKIvxAReyQ/8CA==";
        };
        _IOiuj94c = {
            "id" = "IOiuj94c";
            "file" = "journeymap-fabric-1.21.1-6.0.5.jar";
            "hash" = "sha512-KGHoemdoZGNglpTmTk9m+IwTr7vWwCzfMfJCuY8xyaEsmTVFt/KA0jUvAgqNar1UlBFjcVkdgG1jhQwhx+KtoQ==";
        };
        _K7Gj8uwA = {
            "id" = "K7Gj8uwA";
            "file" = "journeymap-forge-1.21.1-6.0.5.jar";
            "hash" = "sha512-5g/ezW6eaQcFK6AAwJJsmr6zO1BYVmg7RCgeljZvWReT6SSfW0NPy0BYQl0sr8/3ObNEu+vBv8dPEbrBES5+sw==";
        };
        _35TPQTuf = {
            "id" = "35TPQTuf";
            "file" = "journeymap-neoforge-1.21.1-6.0.5.jar";
            "hash" = "sha512-LO85BK95iLinBge0Px7TfreThhHOfECTG6KdkRpHCX0IblFIvuwNPjZBzMzxMAhZ4++P1u8cFp2G3lnqp/3UmA==";
        };
        _q88VtXCp = {
            "id" = "q88VtXCp";
            "file" = "journeymap-fabric-26.1.2-6.0.5.jar";
            "hash" = "sha512-spgbajHhaRQeldoz+ppu6suefizSBep5/L6wjR7DL/ICJeU0rGT2uxDl6TQcADmwfFT96/oGn//gg9kksWlHgg==";
        };
        _SC4nRnUs = {
            "id" = "SC4nRnUs";
            "file" = "journeymap-forge-26.1.2-6.0.5.jar";
            "hash" = "sha512-NG30yZWUH0UxQZiwGRg891BskAcuaMHXZt84SYFr9njPqRiK8mOrTuNSRGSapOcJYrfUwG82K7IiQmDe53DOXA==";
        };
        _oYa0EjTI = {
            "id" = "oYa0EjTI";
            "file" = "journeymap-neoforge-26.1.2-6.0.5.jar";
            "hash" = "sha512-y/PJQmfO3eDje16DoYywDgGxgRkMQ3cXrlkSm0mJFhmuCZENPIdCK/LUO6dFB9bZcvdxW1Ypt10XD+g6jD11XA==";
        };
        _RCMbqsI7 = {
            "id" = "RCMbqsI7";
            "file" = "journeymap-paper-26.1.2-6.0.5.jar";
            "hash" = "sha512-6+4VGZfVVTWz87lpzloJ55AkibnhJLVL7Ywt0YrkhvdjIfd0OR0/W3BxZdNZs3VraibiHrPxMEn1+Se+sbTaOQ==";
        };
        _HDly3jmH = {
            "id" = "HDly3jmH";
            "file" = "journeymap-fabric-26.2-6.0.5.jar";
            "hash" = "sha512-8q+RYkIc69sEgFyjULzvSZIlikvuSSp7SAZxGie1IZ5ywJu980yP3YiQrXh+WBtQ1Q3gDOBVgCOgzGl4etyfOA==";
        };
        _ZzyRn3Gm = {
            "id" = "ZzyRn3Gm";
            "file" = "journeymap-forge-26.2-6.0.5.jar";
            "hash" = "sha512-H9wRzRspiQCW4CmlUPCpBy6Yp6Z6FX/N2aJ2VjuUjYuXZ0soXasWSgFGkxTipWvwANnP9XXeMjbD8xZq+BFImg==";
        };
        _amV3hJiO = {
            "id" = "amV3hJiO";
            "file" = "journeymap-neoforge-26.2-6.0.5.jar";
            "hash" = "sha512-+7r0MedDAcrlrg8r1AeN+SA50Bf29CSPW7Pw0u51oIfHEXcnX/Q5HSH4SvksLSlmyDfcCmSTpWdOaf20ny/EAw==";
        };
        _fIZYuDvF = {
            "id" = "fIZYuDvF";
            "file" = "journeymap-paper-26.2-6.0.5.jar";
            "hash" = "sha512-Z+VmOjfb8U/qOv88ydJd8JKnhfM3rWsFh7vwNYuI1jG66ZuoYYjSSdh4jGZ0yYp1A8JF4XcXUB0GOCcMnsdCrA==";
        };
        _hk3YW8ZE = {
            "id" = "hk3YW8ZE";
            "file" = "journeymap-fabric-1.20.1-6.0.2.jar";
            "hash" = "sha512-2ZaANZhShYw98kXinIO3hA1dPR++Uz49eMK0TD2KbveTiGLlN2jY/uAUs+ZabMfH6PzBD3hmtmSCerabte+3/A==";
        };
        _2J6Wc3JR = {
            "id" = "2J6Wc3JR";
            "file" = "journeymap-forge-1.20.1-6.0.2.jar";
            "hash" = "sha512-l+JQTzyon+I+wSwP21XYrNrhzz0mm9mQY4d9e21oRp3osSRxEQmcbopccOyxzZ3CM4kg3gKhZdMGObchgO4wMQ==";
        };
        _faEm4E9P = {
            "id" = "faEm4E9P";
            "file" = "journeymap-fabric-1.16.5-6.0.4.jar";
            "hash" = "sha512-nITFSCLiJXnyuVAGuF0NdKHYknrFPkLt9f91imcBxA23MWEN285BRZO+2XoaeMNAmlgExEiOBMa0mXQ7IkGJ5A==";
        };
        _MxbgbIjg = {
            "id" = "MxbgbIjg";
            "file" = "journeymap-forge-1.16.5-6.0.4.jar";
            "hash" = "sha512-3+5E6u+B9INPt8QxMVwwlb/S5/yokCSkSnkC83eatl3925CRtfsHA8qJfJwTR3BMAcgxmOKk9yM7TfWfrRLoGg==";
        };
        _6PMMvhSm = {
            "id" = "6PMMvhSm";
            "file" = "journeymap-forge-1.12.2-6.0.5.jar";
            "hash" = "sha512-jrtfmNyaPaERH36I9wZ92IiQmuRBg1M+BZk6QbudR75F1ihYvaZrswFz8350bVkUcVYpFxev3QSgfOwe1K3qkQ==";
        };
        _9c5DPuqL = {
            "id" = "9c5DPuqL";
            "file" = "journeymap-forge-1.7.10-6.0.3.jar";
            "hash" = "sha512-WyVTIgt7C+WQl4TKp8ljtaeqZCbbQ1puPHb9twQMBp01aR5qgXySBbYXOhekhrGW8aXXfl0AZBTOQ6is4itvLQ==";
        };
        _24Ydvogd = {
            "id" = "24Ydvogd";
            "file" = "journeymap-fabric-26.2-6.0.6.jar";
            "hash" = "sha512-HWzI4e1n/XFB7dQzGWJrHaNdsLlRJi74Wj4YR/qX4afnk1eJNA2fFVAb4y+yi+4SC8mjMf9G4RupwePqCGSpMg==";
        };
        _N1AkxnEC = {
            "id" = "N1AkxnEC";
            "file" = "journeymap-forge-26.2-6.0.6.jar";
            "hash" = "sha512-K6B1OkxzyHTcD7Z8XkANcJm4iVzCt2nFCNt8dqGyq1Vswqh+ed5+C1RqGrB+3NnYjONuHRebVBh3myP6iSa8FQ==";
        };
        _amccmQzA = {
            "id" = "amccmQzA";
            "file" = "journeymap-neoforge-26.2-6.0.6.jar";
            "hash" = "sha512-YEXDTYJrF6Bi0RBZvS8pMfwh/vqvRmFT8Dx59EOvy1ePSA8C5SPHkAtL0yk6Wubl5H79vNIss4OHp6GeuodsiQ==";
        };
        _kjfEII1a = {
            "id" = "kjfEII1a";
            "file" = "journeymap-paper-26.2-6.0.6.jar";
            "hash" = "sha512-+urdvKYoZCWEFKbz6vveql299GEP7YoqU16QwfCi4ZN1Gsl7HBONAHRJKNfPtgff+lIAe/QdUgFGLy0nzXXfcQ==";
        };
        _NnmofI4P = {
            "id" = "NnmofI4P";
            "file" = "journeymap-fabric-26.1.2-6.0.6.jar";
            "hash" = "sha512-x/jQeACToK5caVuVdP+uuQpESbY+tnvTqm7aPe92Pv4xQ/HjD/odnz/3hcTwqB7f7/8Re34N4LQgLIuweinCOQ==";
        };
        _w7yMNgg7 = {
            "id" = "w7yMNgg7";
            "file" = "journeymap-forge-26.1.2-6.0.6.jar";
            "hash" = "sha512-Y6Ws0TNNQ28F9HRIqO5k24X+6UcAW/BAE8TrNOI+xK0734u09NFlHEDB0gTuhvbhgtcsoC8Pnsl6VSvcfbSLYA==";
        };
        _toPpKPvu = {
            "id" = "toPpKPvu";
            "file" = "journeymap-neoforge-26.1.2-6.0.6.jar";
            "hash" = "sha512-4BW/bKNXHcRoomc04IcgSnBmBd5EFQ2pnKufH+ebfrG65SdosqOWODEyPCa52NZqe3Q3C7+p3Pz5UpBlp5n8rg==";
        };
        _8G9LbFs8 = {
            "id" = "8G9LbFs8";
            "file" = "journeymap-paper-26.1.2-6.0.6.jar";
            "hash" = "sha512-lnAD+jRbXetQQbecMwV6hp2CT2Su7qtg/Bw7HO+8yQ9NYu5IuoIG78SQ4kNlmIpaS7w9ouoCTosVMPxc5eeqKQ==";
        };
        _fXJGoRQ5 = {
            "id" = "fXJGoRQ5";
            "file" = "journeymap-fabric-1.20.1-6.0.3.jar";
            "hash" = "sha512-kDf0jVXb8NU/n6C6IHIYc/9oDT2fonBT5n4wxpueLLyoZgh+E09BJ7yj8rU0ugVRpj+Gd9AvvkbHwqDMiybGJg==";
        };
        _NuBYW5y3 = {
            "id" = "NuBYW5y3";
            "file" = "journeymap-forge-1.20.1-6.0.3.jar";
            "hash" = "sha512-UYmAuGnVXia0i8pmPOUeevH5l3+jhncrQefbPBArpyahTHAVOY/ClwaoJOXgtxsyaZguS0Vt1hXeShQGsk6dXg==";
        };
        _rJpcMLFb = {
            "id" = "rJpcMLFb";
            "file" = "journeymap-fabric-1.21.1-6.0.6.jar";
            "hash" = "sha512-J9tOx0eKgI1l3D8CjZsDwpicf6AWEHI4yWZtF1gQIiAZRpFFfpEq/92a+GJ7cjQVeBq+jwlxkIPILcSZwjIIYA==";
        };
        _5d0EmSTR = {
            "id" = "5d0EmSTR";
            "file" = "journeymap-forge-1.21.1-6.0.6.jar";
            "hash" = "sha512-8rdc5UwZd19M/xoUNUHgxFGoxh/sAya/YWeArEWKGrZ+U0Tbw2cjOut99fJGy9xXKynM5lDs3vjxv5KB0sIVdg==";
        };
        _3xPNjfk3 = {
            "id" = "3xPNjfk3";
            "file" = "journeymap-neoforge-1.21.1-6.0.6.jar";
            "hash" = "sha512-T1T7D1f+tOJYLaH6z4mpZoa2ZRIL3ObiyQvmxMRHLWfDtxq+DweX6vRT0uymDxTo5eH4MaSOPYJdto8ni2XOTA==";
        };
        _gyKM5oOd = {
            "id" = "gyKM5oOd";
            "file" = "journeymap-fabric-1.16.5-6.0.5.jar";
            "hash" = "sha512-KdsLE0ZLbNS2LpX3r4DyNLqBBRfx7/sJtlgr2Uv9BcGPJTZrofz6GmGWpvqqirEvb4l5CZX/VcqGB5Wg7Jb2bQ==";
        };
        _sHXvsd6t = {
            "id" = "sHXvsd6t";
            "file" = "journeymap-forge-1.16.5-6.0.5.jar";
            "hash" = "sha512-+vaaIBn0fUcscepKPIDhkObfNEa4hZCVNV2hA5dQhfhGDpIocVXqJIwiiVwTvA4+zrlFxF7lEeBr8M4xXCK8LQ==";
        };
        _rUIgvSqg = {
            "id" = "rUIgvSqg";
            "file" = "journeymap-forge-1.12.2-6.0.6.jar";
            "hash" = "sha512-0Nqe6WgWHaFi9VWaeMr07GaFtw3ZHvRV0KPgqGxZfSIsRokSHe6ID+8UY6EE6Ztg08uE/tjrgqhfNracF4W6kQ==";
        };
        _ZaCd1d6o = {
            "id" = "ZaCd1d6o";
            "file" = "journeymap-fabric-1.16.5-6.0.6.jar";
            "hash" = "sha512-W17lX2K+Cq13p6DwdZRfZJH8X7OQTDZ7+g2J+AZ2AoxWHzwBgn8Za0c7c98765LzLvksAxm5YyTVt6o48hbdsQ==";
        };
        _2u3HZFeH = {
            "id" = "2u3HZFeH";
            "file" = "journeymap-forge-1.16.5-6.0.6.jar";
            "hash" = "sha512-GclUybIqKdkpx6TqeKLq2EDLfW1kiNVbcpPdLcczUPrxluweRJjfKvGdMPe4PI/jL+YZQVNmEhPcviZbMODsxw==";
        };
        _RLCDwXKG = {
            "id" = "RLCDwXKG";
            "file" = "journeymap-forge-1.7.10-6.0.4.jar";
            "hash" = "sha512-jwoNQlCdmUhK+9T42Au/Zklxwfy0nVMilRLTRSNR4CQlf6HU71dGu+lUnqczHNWT23nAttzpcVSz3ikadgjzUw==";
        };
        _yC2TZbEJ = {
            "id" = "yC2TZbEJ";
            "file" = "journeymap-fabric-26.2-6.0.7.jar";
            "hash" = "sha512-5nElacqXr3YZbUbdfzDK/8wU5Hv8VewpWbL8vx/JoGET9PlAu4xw0NEWKddP13OvJ4aIfNlQAJAjWI8lhVQFzA==";
        };
        _DULz7GjE = {
            "id" = "DULz7GjE";
            "file" = "journeymap-forge-26.2-6.0.7.jar";
            "hash" = "sha512-bd2wh3ds/RGm9VgbzI4SpYcGbQ5VVZILe1o/qNrWtcfd9mZ5SYCCS6UaiMgNibtk9IDLlewhYyeYNzM2D3MNkw==";
        };
        _Z4HOwlL0 = {
            "id" = "Z4HOwlL0";
            "file" = "journeymap-neoforge-26.2-6.0.7.jar";
            "hash" = "sha512-Kx2q176Nd6goaP95yCxKRMJpq64JmDc/YlKLxrLZlioK5/r4Qzxvfs7pX4UOrwuzlv3fZYuk09IGn80X16OVJw==";
        };
        _QvoFswMi = {
            "id" = "QvoFswMi";
            "file" = "journeymap-paper-26.2-6.0.7.jar";
            "hash" = "sha512-RwCqCyFfo302TqqCxymhNXv51HONV2h1FKHudCAXZqJOjaiBh9r5chJXxw22eqcogudvRHaqgx2J1dSBu3iajg==";
        };
        _R1escxHM = {
            "id" = "R1escxHM";
            "file" = "journeymap-fabric-1.21.1-6.0.7.jar";
            "hash" = "sha512-QzX9BT6FIM8qmFYSFJoK8HWqa1Oyqt/ffoAg6R7yUmJXuOyrQ7Z3itQCifclHYa2Oc2+TSwwJ0UL41hLfUAaOQ==";
        };
        _xiMok6KJ = {
            "id" = "xiMok6KJ";
            "file" = "journeymap-forge-1.21.1-6.0.7.jar";
            "hash" = "sha512-RpSV+6q+aMjzQzz8PmSM130I905Y1hrFjyPmv8ed929gE0IUl/q5b6NI1/MqrbbX+GJ2h145dxJ2QmPuBEYMHw==";
        };
        _IAVJBO0C = {
            "id" = "IAVJBO0C";
            "file" = "journeymap-neoforge-1.21.1-6.0.7.jar";
            "hash" = "sha512-XnnsWq8GMpUT6bRTfY75Gp2RqzCR+kdd9LoVu9WQcZLBAPeHCucF38MfPqfoK46YFz/8BN2pwpLuqoFr0zB2+g==";
        };
        _3vFadXiU = {
            "id" = "3vFadXiU";
            "file" = "journeymap-fabric-1.20.1-6.0.4.jar";
            "hash" = "sha512-BW+vR1757xKQVz3rJQBmTEGAwpJ2aLPe0Ty74Q5dmE9/D56Z8thMPDSNWWjtAbilklhxP84gt5NqZBjatsasgg==";
        };
        _8Le0UypF = {
            "id" = "8Le0UypF";
            "file" = "journeymap-forge-1.20.1-6.0.4.jar";
            "hash" = "sha512-0I9iiIJacV8ivOqhLbvSl0vKUJU4ZkB0ZXBb2aeXG6wEpCQLHZZo9JFcn1GGK3BndMxUmeZ3f67OXJgwm3I4ig==";
        };
        _QLraArkB = {
            "id" = "QLraArkB";
            "file" = "journeymap-fabric-26.1.2-6.0.7.jar";
            "hash" = "sha512-8YERQ9g/NbajPiTgaMwTjTECmXwgT7AaSSeTL1DYhnJAd0zycPuhkCVEGiTrrD+8crFPao1rIlKpzAgTmoyOQQ==";
        };
        _M7e8rAn6 = {
            "id" = "M7e8rAn6";
            "file" = "journeymap-forge-26.1.2-6.0.7.jar";
            "hash" = "sha512-sCm7ZXsIKDsH+a3Hhs3YYnNZAjGtMhmEhz6gL0Iag7taY1B/rxT0A18fY4WbXCu29pBWK3J50oB4A10NFOnl0A==";
        };
        _hV7MEbm1 = {
            "id" = "hV7MEbm1";
            "file" = "journeymap-neoforge-26.1.2-6.0.7.jar";
            "hash" = "sha512-eVwnc7bn6M3nzLHQVfoyU+CSpmaxsM5rKVld57RmFiOtkUWckbh1Q/cdj9B714z3S9fkBIffBrSY1mqt9aSUMw==";
        };
        _3soDuwiO = {
            "id" = "3soDuwiO";
            "file" = "journeymap-paper-26.1.2-6.0.7.jar";
            "hash" = "sha512-6+Glxpk8MLq+KxM9/985RjzW6wGWklIxs5Z9zT/YFDdRZ/uAW2zHtkHCmHiSq7dY3eyjyNYXy8FxysfdbC5/bA==";
        };
        _7PVXRMLQ = {
            "id" = "7PVXRMLQ";
            "file" = "journeymap-forge-1.12.2-6.0.7.jar";
            "hash" = "sha512-MpJ7tuI5sM+v4hh9Z19dT+IcsF//I1z7gNzhdYio55+xurznQ6L3HscrrO1wBMsBHRgw/YBIzGy7A14P4oCplA==";
        };
        _UN07VY1P = {
            "id" = "UN07VY1P";
            "file" = "journeymap-forge-1.7.10-6.0.5.jar";
            "hash" = "sha512-z/PzQL/VpC/G9kL4XQS77keCi1KDTumxbPchP7XGTJFzPVZTcES6AuE05UwduAKFsYPX5d+9TeI0vabHGdcOlg==";
        };
        _B2Utv4xN = {
            "id" = "B2Utv4xN";
            "file" = "journeymap-fabric-1.21.1-6.0.8.jar";
            "hash" = "sha512-j1j6vxJbzP2sRdzpiyIwUXSNEHDgBz4tAvXzk06VWF7zl9IpxG1Bi65m08fT0HVI+g0gB4B1hUoW9/zdhGzbDg==";
        };
        _iHS9uHxd = {
            "id" = "iHS9uHxd";
            "file" = "journeymap-fabric-1.16.5-6.0.7.jar";
            "hash" = "sha512-SchwZYhU3+SUvvVvQiG31p/Ck8Fg7wPAGwCnRs/ckZWH+I0+yor1CIttZuebK9npG+PRNkWZNU/e0e1u/D54Cw==";
        };
        _H8ryb5Vh = {
            "id" = "H8ryb5Vh";
            "file" = "journeymap-fabric-26.1.2-6.0.8.jar";
            "hash" = "sha512-ajAdUcdS79LM1c8dSBgzXLVfNgK8vlk8cfHRexCKs7lg4pSUiYyP0P2loAWq7C336/PbBkjQgFFpuOgJMb1mKw==";
        };
        _mK8YOeiR = {
            "id" = "mK8YOeiR";
            "file" = "journeymap-fabric-1.20.1-6.0.5.jar";
            "hash" = "sha512-oxteypdRLkZImfZzBxQ44CxusqH61/Gz77B3XbuVotgX44mRi8O1ql5kA1GccHlQag/wPEW85C83/Fz+wiuGlg==";
        };
        _JXXQItXy = {
            "id" = "JXXQItXy";
            "file" = "journeymap-fabric-1.16.5-6.0.7.jar";
            "hash" = "sha512-HpnfYVOWUQQQhbuZFSSTEFMbJ8oIGXmKpp8yVNMyY32FAkNt5lMbtrQ7p+wbxZct+vBdUXmeUtL+TXz/M/23rg==";
        };
        _79rFi4E1 = {
            "id" = "79rFi4E1";
            "file" = "journeymap-forge-1.16.5-6.0.7.jar";
            "hash" = "sha512-7q7jR6QO2YhCdWGSUmR6F76ZWwT0EMRCBjiXYhng1jmvqyK/Hue3WzRRqb7GkcDOBsj+RTGtXaMxizO9j5dWpQ==";
        };
        _4wIu8h4i = {
            "id" = "4wIu8h4i";
            "file" = "journeymap-fabric-26.1.2-6.0.8.jar";
            "hash" = "sha512-nikBTgmOzhGkNtY3XFpaquFkUIRRPtcDJb8LFBE/DphJwsSh6/n/TUwhfb622jogQFb7Uab7lCww1XPFrZqQ2A==";
        };
        _JmYxahiA = {
            "id" = "JmYxahiA";
            "file" = "journeymap-fabric-1.20.1-6.0.5.jar";
            "hash" = "sha512-8jdh4zV7jIjBljvW5BZwU0QBZrA3uB26HTfuaFw6Yt/COVsYOEpoXCAAl/OhtI0Ye36CZR2iavAqf7M4Jm7dZw==";
        };
        _KFCkLTXo = {
            "id" = "KFCkLTXo";
            "file" = "journeymap-forge-26.1.2-6.0.8.jar";
            "hash" = "sha512-odBxlG9IDcLqPcy0DfDNj9d3f5+a680kCA5VMNO2W4SsuvSM+oV+1oLukG8F+sVQzsUY6v2yG1IVNRDqT7SwkA==";
        };
        _3pOseiLA = {
            "id" = "3pOseiLA";
            "file" = "journeymap-forge-1.20.1-6.0.5.jar";
            "hash" = "sha512-ruIDMyqStWMFzK/Kuqqk+qFdwsdDuJwP084BSyKpcLjcYXJPYo5a5T35hAjgVTylpqXV8gzgPxceq8PRMvKMVg==";
        };
        _Ae7IjxZ5 = {
            "id" = "Ae7IjxZ5";
            "file" = "journeymap-neoforge-26.1.2-6.0.8.jar";
            "hash" = "sha512-lMm+XJF8L3pHksjhl1GDv68A55MvfdgYKd/mVqX363xD9oUKTD/DuyFvg9EnYJI80zsvbkd9u+9tPsAX7vF7Rw==";
        };
        _SYFNVEtZ = {
            "id" = "SYFNVEtZ";
            "file" = "journeymap-paper-26.1.2-6.0.8.jar";
            "hash" = "sha512-PXy2V0nwKGtp7Nnyf1+5OZfM9nOxwWPvo5QYWamAJks0p5dPvdVF4FAiGwD8qe+FPoGUHx5T0bsdZOyPalazTA==";
        };
        _qmuZAgdA = {
            "id" = "qmuZAgdA";
            "file" = "journeymap-fabric-1.21.1-6.0.8.jar";
            "hash" = "sha512-EeNZdKTBh0K3mszUrwZ10FA7J97XI/bP5Mrc6djqq9dYRsjc7Q57h6HjFdw2NUe8Q9ND1nbyyDUpMYYjUt2ICQ==";
        };
        _kLWSgzKN = {
            "id" = "kLWSgzKN";
            "file" = "journeymap-forge-1.21.1-6.0.8.jar";
            "hash" = "sha512-GhetDnjMv6h96AkpcNq+46L8F0kBr2om9pZTF/SxGDNYSj+XmQasVoNZWiffqcBstfaQhey9flpKqiFg014lCg==";
        };
        _F1lEUGxf = {
            "id" = "F1lEUGxf";
            "file" = "journeymap-neoforge-1.21.1-6.0.8.jar";
            "hash" = "sha512-AIXXRmT2Xn1iEkzhUmyOHb5Z8NGVp92m2lWkiK8knIxwiri7dqqCSn1rhIZbSy4I8JsQWg1Q99UiEZg0UIufWQ==";
        };
        _SQsKHZAV = {
            "id" = "SQsKHZAV";
            "file" = "journeymap-fabric-26.2-6.0.8.jar";
            "hash" = "sha512-es4DsbFSyrfBZzG6XVciyn+7YK4gjrYWS/KmODbv8fb6X110fDZBYKrJ0ajNVJX+iG2iGXKtSCxlhV9VD4yliw==";
        };
        _NOgezEhx = {
            "id" = "NOgezEhx";
            "file" = "journeymap-forge-26.2-6.0.8.jar";
            "hash" = "sha512-5ppxCjrUiyh3xyTzzsug5PzeShROGDCYbBc8KGxNHKktnoaBCnsceEdqlfiOIhSolWfFEymwkh5w3XWYi/+7qQ==";
        };
        _BvreZ8yd = {
            "id" = "BvreZ8yd";
            "file" = "journeymap-neoforge-26.2-6.0.8.jar";
            "hash" = "sha512-NiaLuasUBqWQhY3VGTCce0VU/nR4tpJbDEoZC986X4GjxQ3vyALDfBiT4nugVyf453y26TPl1if1uEP+ipYBDQ==";
        };
        _U0WXujcV = {
            "id" = "U0WXujcV";
            "file" = "journeymap-paper-26.2-6.0.8.jar";
            "hash" = "sha512-ayrHKp83PYlkGioAAk9YVE5rCoewV2htUWB+IGwWt9Gi9B4KwNgvfnkR/nhl5kNd6CNssYPdfYgwDcclXfW8vg==";
        };
        _jmujAJzr = {
            "id" = "jmujAJzr";
            "file" = "journeymap-1.7.10-5.2.21-unlimited.jar";
            "hash" = "sha512-31QJ37OznkII6A0ANKc2xyFFiFYlaG49Eo3HQNG9Jk6hPjQH52qaGWth74AFgIrjAtrqdSDmqQ1ne28N2S2WPw==";
        };
        _pQmw6aS6 = {
            "id" = "pQmw6aS6";
            "file" = "journeymap-1.7.10-5.2.23-unlimited.jar";
            "hash" = "sha512-TRhrZoRnTQbjWq7pSYAmPGqy7ghevKhKcsysnnWmW7zS7UZgPg14vKxr8WMjTBjHx55tSnhZTeZzUeYypi9+1Q==";
        };
        _WBAzKaRz = {
            "id" = "WBAzKaRz";
            "file" = "journeymap-forge-1.7.10-6.0.6.jar";
            "hash" = "sha512-SXCgDBIwnWFvttnyLbVl/NwYFIIcqMkJw+tBRJBfbqIu/P72Jcs4QM6zokLfO1TTDK1e6gRAMFEEMfMQjpao3A==";
        };
        _C3E0jQji = {
            "id" = "C3E0jQji";
            "file" = "journeymap-forge-1.12.2-6.0.8.jar";
            "hash" = "sha512-qD/xvFizmczFp4jbKbsxZdOTpDC+1WvghAeIun6BrfAr+m1biU+NngmPtoHpxIM8KS9UFqA+Yu1LeYnmlq0QMA==";
        };
        _9cXz7rtH = {
            "id" = "9cXz7rtH";
            "file" = "journeymap-fabric-26.3-6.0.8.jar";
            "hash" = "sha512-66AA+RKpVcNDYC3bkPZKMfObk9JdqsiW2QTmBefles3OHsV3Z29LlF8OGzEJ2wWjuoXkg+1smbqsUkCjfiBJLQ==";
        };
        _bq1KhaSc = {
            "id" = "bq1KhaSc";
            "file" = "journeymap-neoforge-26.3-6.0.8.jar";
            "hash" = "sha512-D55GfloBfKSHE8DweQRmGYSw3rNgOeaohZ0RiNpT2wyNXfrVR8a5ZD5bthEdbosaY+cJ5YtV9UNiSm0U1Rj3xQ==";
        };
        _MN0gsJm8 = {
            "id" = "MN0gsJm8";
    ...
    in {
        ...
        "pkg-1.18.2-5.8.5+forge" = _KAQLcivR;
        "pkg-1.18.2-5.8.5-fabric" = _uX9LXMFe;
        "pkg-1.19-5.8.5alpha1-forge" = _JpsG0Jrv;
        "pkg-1.19-5.8.5rc1-fabric" = _4ziiKbKa;
        "pkg-1.19-5.8.5rc1-forge" = _IcA6VPUq;
        "pkg-1.16.5-5.8.5p4" = _gXAkQFNP;
        "pkg-1.19-5.8.5rc2-fabric" = _13mFdp57;
        "pkg-1.19-5.8.5rc2-forge" = _DFQ3VDvW;
        "pkg-1.16.5-5.8.5p5" = _UBMFwIyd;
        "pkg-1.19-5.8.5rc3-forge" = _zPbsE4oC;
        "pkg-1.19-5.8.5rc4-forge" = _ik6ojVqk;
        "pkg-1.19-5.8.5rc5-forge" = _szlMtbxI;
        "pkg-1.19-5.8.5-forge" = _G7kCdKzy;
        "pkg-1.19-5.8.5-fabric" = _pdMy4OAK;
        "pkg-1.18.2-5.9.0beta1-forge" = _LHlJkX4B;
        "pkg-1.18.2-5.9.0beta1-fabric" = _H6DUqxht;
        "pkg-1.19.1-5.9.0beta1-forge" = _R9on6yOw;
        "pkg-1.19.1-5.9.0beta1-fabric" = _nDlaZxw5;
        "pkg-1.19.1-5.9.0beta2-fabric" = _GWk9Bj6f;
        "pkg-1.18.2-5.9.0beta2-forge" = _keozjf6v;
        "pkg-1.19.1-5.9.0beta2-forge" = _xlotG9gg;
        "pkg-1.12.2-5.7.1" = _5jK8N4Cg;
        "pkg-1.7.10-5.1.4p2" = _mqrwQlrn;
        "pkg-1.16.5-5.8.5p6" = _jtGquuti;
        "pkg-1.18.2-5.9.0beta3-fabric" = _MzLwFKCS;
        "pkg-1.19.2-5.9.0beta3-fabric" = _9m6WzQnE;
        "pkg-1.18.2-5.9.0beta3-forge" = _KjaokHNE;
        "pkg-1.19.2-5.9.0beta3-forge" = _Wzg9qEjW;
        "pkg-1.18.2-5.9.0beta4-fabric" = _ejVU8N8b;
        "pkg-1.19.3-5.9.0beta4-fabric" = _yoIOPm7k;
        "pkg-1.18.2-5.9.0beta4-forge" = _w9Uh3aph;
        "pkg-1.19.3-5.9.0beta4-forge" = _fuhj7GqY;
        "pkg-1.19.2-5.9.0beta4-fabric" = _7XhSTlz0;
        "pkg-1.19.2-5.9.0beta4-forge" = _nExChkdd;
        "pkg-1.18.2-5.9.0beta5-forge" = _dBlcfa77;
        "pkg-1.18.2-5.9.0beta5-fabric" = _o4mmMYSw;
        "pkg-1.19.2-5.9.0beta5-fabric" = _EImrtJqg;
        "pkg-1.19.2-5.9.0beta5-forge" = _mM8fk53O;
        "pkg-1.19.3-5.9.0beta5-fabric" = _HEJihg90;
        "pkg-1.19.3-5.9.0beta5-forge" = _zKW7EEYV;
        "pkg-1.18.2-5.9.0-fabric" = _ilFJlP9I;
        "pkg-1.18.2-5.9.0-forge" = _rME0vnQt;
        "pkg-1.19.2-5.9.0-fabric" = _GTUFlpvk;
        "pkg-1.19.2-5.9.0-forge" = _LQPWEtnJ;
        "pkg-1.19.3-5.9.0-forge" = _cLZ9MwUB;
        "pkg-1.18.2-5.9.1-fabric" = _qRxg2bql;
        "pkg-1.18.2-5.9.1-forge" = _rwZx2Dcy;
        "pkg-1.19.2-5.9.1-fabric" = _JJKtfAVh;
        "pkg-1.19.2-5.9.1-forge" = _HcCPm90p;
        "pkg-1.19.3-5.9.1-fabric" = _LsPczWha;
        "pkg-1.19.3-5.9.1-forge" = _5wZLoSLc;
        "pkg-1.18.2-5.9.2-fabric" = _nVTkpIc9;
        "pkg-1.18.2-5.9.2-forge" = _K7omILae;
        "pkg-1.19.2-5.9.2-fabric" = _oczkXzWd;
        "pkg-1.19.2-5.9.2-forge" = _LRZMDd3R;
        "pkg-1.19.3-5.9.2-fabric" = _ltytblyW;
        "pkg-1.19.3-5.9.2-forge" = _H8xFn0p3;
        "pkg-1.18.2-5.9.3-fabric" = _oMYGzlC4;
        "pkg-1.18.2-5.9.3-forge" = _mGIRq0UV;
        "pkg-1.19.2-5.9.3-fabric" = _MC2AwUAt;
        "pkg-1.19.2-5.9.3-forge" = _5ECQX0PW;
        "pkg-1.19.3-5.9.3-fabric" = _Gxu68kGX;
        "pkg-1.19.3-5.9.3-forge" = _YrV0LH17;
        "pkg-5.1.4" = _NsSmhAXd;
        "pkg-1.18.2-5.9.4-forge" = _SDjLCqZs;
        "pkg-1.18.2-5.9.4-fabric" = _gXA1NuJj;
        "pkg-1.19.2-5.9.4-forge" = _b5LyaDOA;
        "pkg-1.19.2-5.9.4-fabric" = _2ZUSc8bG;
        "pkg-1.19.3-5.9.4-forge" = _AYiYQoQY;
        "pkg-1.19.3-5.9.4-fabric" = _rkD3NWbF;
        "pkg-1.19.4-5.9.4beta1-fabric" = _p6KaY8uz;
        "pkg-1.19.4-5.9.4beta1-forge" = _tDnyb0Nx;
        "pkg-1.19.4-5.9.4beta2-fabric" = _Hwb4D5Lw;
        "pkg-1.19.4-5.9.4beta2-forge" = _QWCMRITK;
        "pkg-1.7.10-5.1.4p5" = _KC0EP3lf;
        "pkg-1.18.2-5.9.5-fabric" = _y2SnWYdW;
        "pkg-1.18.2-5.9.5-forge" = _f8kBTZuA;
        "pkg-1.19.2-5.9.5-fabric" = _WSsgoyGz;
        "pkg-1.19.3-5.9.5-fabric" = _ZcbvvRqt;
        "pkg-1.19.4-5.9.5-fabric" = _158xhA1m;
        "pkg-1.19.2-5.9.5-forge" = _yxIdQZei;
        "pkg-1.19.3-5.9.5-forge" = _jMmsok9F;
        "pkg-1.7.10-5.1.4p6" = _TaXRbmP2;
        "pkg-1.19.4-5.9.6-fabric" = _Xz3TrK7v;
        "pkg-1.19.4-5.9.6-forge" = _skrCb1R3;
        "pkg-1.19.3-5.9.6-forge" = _TBbzBsjQ;
        "pkg-1.19.2-5.9.6-forge" = _e7EEP9z8;
        "pkg-1.19.3-5.9.6-fabric" = _4z1RrV1J;
        "pkg-1.18.2-5.9.6-forge" = _ow57eQ3Z;
        "pkg-1.19.2-5.9.6-fabric" = _bS62WrRv;
        "pkg-1.18.2-5.9.6-fabric" = _amljQDPj;
        "pkg-1.18.2-5.9.7-fabric" = _5JbcGXLn;
        "pkg-1.19.2-5.9.7-fabric" = _s1jUUTEX;
        "pkg-1.19.4-5.9.7-fabric" = _nnIECFJt;
        "pkg-1.19.3-5.9.7-fabric" = _oyoPuJpF;
        "pkg-1.18.2-5.9.7-forge" = _2G6aMzKY;
        "pkg-1.19.2-5.9.7-forge" = _WEHaD7ed;
        "pkg-1.19.4-5.9.7-forge" = _SwfH3aCe;
        "pkg-1.19.3-5.9.7-forge" = _MhpdJNp8;
        "pkg-1.20-5.9.7-fabric" = _4jzP8ilG;
        "pkg-1.20-5.9.7-forge" = _P9yhXdCh;
        "pkg-1.20-5.9.8-fabric" = _yuRPSckt;
        "pkg-1.20-5.9.8-forge" = _ouWjawqz;
        "pkg-1.20.1-5.9.9-fabric" = _fHCYp1rV;
        "pkg-1.20.1-5.9.9-forge" = _GD4YS8kB;
        "pkg-1.20.1-5.9.10-forge" = _RS2ZHnzb;
        "pkg-1.20.1-5.9.10-fabric" = _mQisuQcc;
        "pkg-1.20.1-5.9.11-fabric" = _4Yh5ovrB;
        "pkg-1.20.1-5.9.11-forge" = _kPSDAhiS;
        "pkg-1.20.1-5.9.12-fabric" = _NXNhbImz;
        "pkg-1.20.1-5.9.12-forge" = _GQa77Rhe;
        "pkg-1.20.1-5.9.13-fabric" = _PdZ5zz9j;
        "pkg-1.20.1-5.9.13-forge" = _klneqMBB;
        "pkg-1.20.1-5.9.13-neoforge" = _hxGIwgVC;
        "pkg-1.20.1-5.9.14-fabric" = _Rxbcodfl;
        "pkg-1.20.1-5.9.14-forge" = _kPaG07i8;
        "pkg-1.20.1-5.9.14-neoforge" = _evGC0P8O;
        "pkg-1.20.2-5.9.14-forge" = _4f5rmETm;
        "pkg-1.20.2-5.9.14-fabric" = _IokV1x9j;
        "pkg-1.20.2-5.9.15-forge" = _6XffPRbA;
        "pkg-1.20.1-5.9.15-neoforge" = _mWwTjcPF;
        "pkg-1.20.1-5.9.15-forge" = _dxUbE87b;
        "pkg-1.20.1-5.9.15-fabric" = _IGl8mdYv;
        "pkg-1.20.2-5.9.15-fabric" = _O5jKsqSz;
        "pkg-1.20.2-5.9.15-neoforge" = _KhkMdfhu;
        "pkg-1.20.2-5.9.16-fabric" = _nBLN2VRe;
        "pkg-1.20.1-5.9.16-fabric" = _2eKDkUc0;
        "pkg-1.20.2-5.9.16-forge" = _MK2fis6e;
        "pkg-1.20.2-5.9.16-neoforge" = _4RyM4q7h;
        "pkg-1.20.1-5.9.16-neoforge" = _t9CI69uV;
        "pkg-1.20.1-5.9.16-forge" = _hjBCWFpC;
        "pkg-1.20.1-5.9.17-forge" = _qJgUPIOP;
        "pkg-1.20.1-5.9.17-fabric" = _pOuPUHOZ;
        "pkg-1.20.2-5.9.17-forge" = _UaSjpi9W;
        "pkg-1.20.2-5.9.17-neoforge" = _Qm9GpF5t;
        "pkg-1.20.1-5.9.17-neoforge" = _XDTYHjp7;
        "pkg-1.20.2-5.9.17-fabric" = _nd4rvQpC;
        "pkg-1.20.2-5.9.18-fabric" = _7zt8duBI;
        "pkg-1.20.2-5.9.18-forge" = _P9GgQSrA;
        "pkg-1.20.1-5.9.18-fabric" = _jEeKb7lx;
        "pkg-1.20.1-5.9.18-forge" = _xJKLyD5q;
        "pkg-1.20.1-5.9.18-neoforge" = _gQvJhjQf;
        "pkg-1.20.2-5.9.18-neoforge" = _INaGBri8;
        "pkg-1.20.3-5.9.18-neoforge" = _bJlyaBeH;
        "pkg-1.20.3-5.9.18-fabric" = _LtHPNy9e;
        "pkg-1.20.3-5.9.18-forge" = _fDVIY8Gz;
        "pkg-1.20.4-5.9.18-fabric" = _ls5dkLZt;
        "pkg-1.20.4-5.9.18-forge" = _z4Jk667U;
        "pkg-1.20.4-5.9.18-neoforge" = _7mAmifgu;
        "pkg-1.20.4-5.9.19-fabric" = _BAlkc48I;
        "pkg-1.20.4-5.9.19-neoforge" = _ZdHOJSDN;
        "pkg-1.20.4-5.9.19-forge" = _WTApOomW;
        "pkg-1.20.4-5.9.20-fabric" = _W8xWV5EK;
        "pkg-1.20.4-5.9.20-forge" = _XAZUNM2z;
        "pkg-1.20.4-5.9.20-neoforge" = _AJa1SrK6;
        "pkg-1.20.4-5.9.20p1-neoforge" = _JSt0IXnF;
        "pkg-1.20.4-5.9.21-fabric" = _FhLtiA0W;
        "pkg-1.20.2-5.9.18p1-fabric" = _4LLuLAvv;
        "pkg-1.20.1-5.9.18p1-fabric" = _3Msidurl;
        "pkg-1.20.2-5.9.18p1-forge" = _ohZ3kGvy;
        "pkg-1.20.1-5.9.18p1-forge" = _lq4eyMNQ;
        "pkg-1.20.4-5.9.21-forge" = _TW4rTxV0;
        "pkg-1.20.4-5.9.21-neoforge" = _DMifyCt4;
        "pkg-1.20.2-5.9.18p1-neoforge" = _k8646oZu;
        "pkg-1.19.4-5.9.7p1-forge" = _8SU0ucP3;
        "pkg-1.18.2-5.9.7p1-forge" = _yQUMTpA8;
        "pkg-1.19.4-5.9.7p1-fabric" = _UQl2x93i;
        "pkg-1.18.2-5.9.7p1-fabric" = _rUGdMFbM;
        "pkg-1.16.5-5.8.5p7" = _krK4RIBr;
        "pkg-1.7.10-5.1.4p8" = _cnB3g0uk;
        "pkg-1.19.2-5.9.7p1-fabric" = _V5K96XeM;
        "pkg-1.12.2-5.7.1p3" = _pRRSLHVt;
        "pkg-5.2.0" = _cv6yeWxQ;
        "pkg-5.2.1" = _AZUtCrfo;
        "pkg-5.2.2" = _fFkOeiCd;
        "pkg-5.2.3" = _CyfmpiP0;
        "pkg-1.20.4-5.9.22-fabric" = _1MNS1ujG;
        "pkg-1.20.4-5.9.22-neoforge" = _Iyl059lx;
        "pkg-1.20.4-5.9.22-forge" = _tyV3Cq2g;
        "pkg-1.18.2-5.9.8-fabric" = _WY3WPcG7;
        "pkg-1.18.2-5.9.8-forge" = _Q3tpDCFf;
        "pkg-1.19.2-5.9.8-fabric" = _3ZtAeGzV;
        "pkg-1.19.4-5.9.8-fabric" = _zOJBlMy3;
        "pkg-1.19.2-5.9.8-forge" = _aSblGSXj;
        "pkg-1.19.4-5.9.8-forge" = _syjw6N8M;
        "pkg-1.20.1-5.9.19-fabric" = _Cf04JjuW;
        "pkg-1.20.2-5.9.19-fabric" = _VvomLGlF;
        "pkg-1.20.1-5.9.19-forge" = _oZGyQpzk;
        "pkg-1.20.2-5.9.19-forge" = _W8lhg4et;
        "pkg-1.20.4-5.9.23-fabric" = _Ghpdf6EF;
        "pkg-1.20.4-5.9.23-forge" = _MFUzASti;
        "pkg-1.20.2-5.9.19-neoforge" = _3zgeY5y8;
        "pkg-1.20.4-5.9.23-neoforge" = _kdV5D3y0;
        "pkg-1.20.1-5.9.20-fabric" = _TcnA8zRy;
        "pkg-1.20.2-5.9.20-fabric" = _F4yYV9eR;
        "pkg-1.20.4-5.9.24-fabric" = _YzYzLujr;
        "pkg-1.20.4-5.9.24-forge" = _F1GoAqAc;
        "pkg-1.20.2-5.9.20-forge" = _2e5VcKmY;
        "pkg-1.20.1-5.9.20-forge" = _KVokx2uA;
        "pkg-1.20.4-5.9.24-neoforge" = _wjyK2Qwr;
        "pkg-1.20.2-5.9.20-neoforge" = _Lf8RFlj7;
        "pkg-1.20.4-5.9.25-fabric" = _zLVOgx9Y;
        "pkg-1.20.4-5.9.25-neoforge" = _6uJP1S0W;
        "pkg-1.20.2-5.9.21-neoforge" = _GFtBlRJO;
        "pkg-1.20.2-5.9.21-fabric" = _b3qzVPrZ;
        "pkg-1.20.1-5.9.21-fabric" = _eV9YeX53;
        "pkg-1.20.4-5.9.25-forge" = _pT7E4nG1;
        "pkg-1.20.2-5.9.21-forge" = _5NQ2fgcz;
        "pkg-1.20.1-5.9.21-forge" = _JgCv9B6Y;
        "pkg-1.20.5-5.9.24-fabric" = _ZqvlaH9E;
        "pkg-1.20.5-5.9.25-neoforge" = _RE1wxUO6;
        "pkg-1.20.5-5.9.25-fabric" = _uEeJHKKb;
        "pkg-1.20.5-5.9.26-fabric" = _6Me7NBzE;
        "pkg-1.20.5-5.9.27-fabric" = _OfPdzJZu;
        "pkg-1.20.5-5.9.28-fabric" = _BU4OkNZT;
        "pkg-1.20.5-5.9.26-neoforge" = _FzAoGAog;
        "pkg-1.20.5-5.9.27-neoforge" = _ERbdwrcR;
        "pkg-1.20.5-5.9.29-fabric" = _whEIr1ZR;
        "pkg-1.20.6-5.9.25-forge" = _4lYHYUJy;
        "pkg-1.20.6-5.9.29-fabric" = _e1bO05Bi;
        "pkg-1.20.6-5.9.27-neoforge" = _A4u1Mpit;
        "pkg-1.20.6-5.9.30-fabric" = _7No8hIGj;
        "pkg-1.20.6-5.9.31-fabric" = _pGndT2Bq;
        "pkg-1.20.6-5.9.26-forge" = _FgUCSL6i;
        "pkg-1.20.6-5.9.32-fabric" = _Ar2ZAW7e;
        "pkg-1.20.6-5.9.28-neoforge" = _YOLQudBJ;
        "pkg-1.20.6-5.9.27-forge" = _doRkMSfT;
        "pkg-1.20.1-5.9.22-fabric" = _CcoEu2DH;
        "pkg-1.20.4-5.9.26-fabric" = _nOf7RFUE;
        "pkg-1.20.6-5.9.33-fabric" = _bnbmYabb;
        "pkg-1.20.4-5.9.26-forge" = _6YLb2Gx2;
        "pkg-1.20.1-5.9.22-forge" = _6gOdvp77;
        "pkg-1.20.6-5.9.28-forge" = _9lxEgsm5;
        "pkg-1.20.6-5.9.29-neoforge" = _VsMoKAEf;
        "pkg-1.20.4-5.9.26-neoforge" = _xXdyf5R6;
        "pkg-1.20.2-5.9.22-neoforge" = _TQTOYE9d;
        "pkg-1.20.4-5.9.27-forge" = _lW2T4ecA;
        "pkg-1.20.1-5.9.23-forge" = _NuCCufCG;
        "pkg-1.20.6-5.9.29-forge" = _N7ElZ2S5;
        "pkg-1.20.6-5.9.30-neoforge" = _GINfmtZ6;
        "pkg-1.20.4-5.9.27-fabric" = _ESS7Q5uB;
        "pkg-1.20.1-5.9.23-fabric" = _M3a6VV4h;
        "pkg-1.20.6-5.9.34-fabric" = _DeY28YhS;
        "pkg-1.20.4-5.9.27-neoforge" = _V64Lmh3v;
        "pkg-1.20.4-5.9.28-neoforge" = _VItUL86H;
        "pkg-1.20.6-5.9.35-fabric" = _Z3rSg4NJ;
        "pkg-1.20.4-5.9.28-fabric" = _mMICqfH9;
        "pkg-1.20.6-5.9.31-neoforge" = _kU6m5HOy;
        "pkg-1.20.4-5.9.28-forge" = _gIYdnbbK;
        "pkg-1.20.6-5.9.30-forge" = _gi5n5Kzq;
        "pkg-1.21-6.0.0-beta.1+fabric" = _epfWVzaW;
        "pkg-1.21-6.0.0-beta.1+forge" = _bX5W7NQu;
        "pkg-1.21-6.0.0-beta.1+neoforge" = _1pUuohdZ;
        "pkg-1.21-6.0.0-beta.2+forge" = _xzXwHHy1;
        "pkg-1.21-6.0.0-beta.2+fabric" = _Dso9Sj46;
        "pkg-1.21-6.0.0-beta.2+neoforge" = _qGlPjdy3;
        "pkg-1.21-6.0.0-beta.3+fabric" = _r7qkF3FS;
        "pkg-1.21-6.0.0-beta.3+forge" = _EfwFU2gd;
        "pkg-1.21-6.0.0-beta.3+neoforge" = _TwDR1XNu;
        "pkg-1.21-6.0.0-beta.4+forge" = _cNEPOm5m;
        "pkg-1.21-6.0.0-beta.4+fabric" = _7kW5MmNP;
        "pkg-1.21-6.0.0-beta.4+neoforge" = _ZQEfdiqf;
        "pkg-1.21-6.0.0-beta.5+fabric" = _o8MVvrzi;
        "pkg-1.21-6.0.0-beta.5+forge" = _IaEGIZvw;
        "pkg-1.21-6.0.0-beta.5+neoforge" = _AaoJPz3A;
        "pkg-1.21-6.0.0-beta.6+fabric" = _JROEJDeS;
        "pkg-1.21-6.0.0-beta.6+forge" = _gtC8kiQu;
        "pkg-1.21-6.0.0-beta.6+neoforge" = _E63fGvSF;
        "pkg-1.21-6.0.0-beta.7+forge" = _l1DGHyj3;
        "pkg-1.21-6.0.0-beta.7+fabric" = _uskZS6co;
        "pkg-1.21-6.0.0-beta.7+neoforge" = _Omv2Q7FF;
        "pkg-1.21-6.0.0-beta.8+forge" = _wpVg9s0u;
        "pkg-1.21-6.0.0-beta.8+fabric" = _HyUXAWnK;
        "pkg-1.21-6.0.0-beta.8+neoforge" = _k4fSrEIy;
        "pkg-1.20.1-5.9.24-forge" = _25LX0Ee0;
        "pkg-1.20.6-5.10.0-forge" = _AjGGVtPi;
        "pkg-1.20.4-5.10.0-forge" = _6ffSmhXk;
        "pkg-1.20.1-5.10.0-fabric" = _mxOjBxQk;
        "pkg-1.20.4-5.10.0-fabric" = _bV9yidYJ;
        "pkg-1.20.6-5.10.0-fabric" = _rr1tmE2X;
        "pkg-1.20.4-5.10.0-neoforge" = _9nnNCz4Y;
        "pkg-1.20.6-5.10.0-neoforge" = _oXkcgpwF;
        "pkg-1.20.1-5.10.0-forge" = _eq6KmH8a;
        "pkg-1.21-6.0.0-beta.9+fabric" = _DtG9dtD9;
        "pkg-1.21-6.0.0-beta.9+forge" = _tsZz94hm;
        "pkg-1.21-6.0.0-beta.9+neoforge" = _Gx2qODjJ;
        "pkg-1.21-6.0.0-beta.10+forge" = _e9izXzvE;
        "pkg-1.21-6.0.0-beta.10+fabric" = _9mFcvqbn;
        "pkg-1.21-6.0.0-beta.10+neoforge" = _SJsiG9Ir;
        "pkg-1.21-6.0.0-beta.11+fabric" = _kwWq914O;
        "pkg-1.21-6.0.0-beta.11+forge" = _e7OuLyXJ;
        "pkg-1.21-6.0.0-beta.11+neoforge" = _MhGNDy2f;
        "pkg-1.21-6.0.0-beta.12+forge" = _QmqLPEA1;
        "pkg-1.21-6.0.0-beta.12+fabric" = _JsiN2kAn;
        "pkg-1.21-6.0.0-beta.12+neoforge" = _lOo7t6yv;
        "pkg-1.21-6.0.0-beta.13+fabric" = _fWAkacWQ;
        "pkg-1.21-6.0.0-beta.13+forge" = _39wmgnEU;
        "pkg-1.21-6.0.0-beta.13+neoforge" = _XqT2GpoO;
        "pkg-1.21-6.0.0-beta.14+fabric" = _yr705AZv;
        "pkg-1.21-6.0.0-beta.14+forge" = _te4Z2jEU;
        "pkg-1.21-6.0.0-beta.14+neoforge" = _XQ3UPSv8;
        "pkg-1.21-6.0.0-beta.15+fabric" = _z0o5OxFZ;
        "pkg-1.21-6.0.0-beta.15+forge" = _ax5grtiY;
        "pkg-1.21-6.0.0-beta.15+neoforge" = _zVlEHB1z;
        "pkg-1.21-6.0.0-beta.16+fabric" = _UG9lajVV;
        "pkg-1.21-6.0.0-beta.16+forge" = _oQo8dWc7;
        "pkg-1.21-6.0.0-beta.16+neoforge" = _qXMW3oST;
        "pkg-1.21-6.0.0-beta.17+fabric" = _xMkEPAoV;
        "pkg-1.21-6.0.0-beta.17+forge" = _xwicE5UH;
        "pkg-1.21-6.0.0-beta.17+neoforge" = _UYLkzTDD;
        "pkg-5.2.4" = _5msNQX8y;
        "pkg-5.2.5" = _jPs0YHtG;
        "pkg-1.20.1-5.10.1-fabric" = _OLBYX5jG;
        "pkg-1.20.1-5.10.1-forge" = _eg9ijttU;
        "pkg-1.21-6.0.0-beta.18+forge" = _VwoQW8xY;
        "pkg-1.21-6.0.0-beta.18+fabric" = _YTHpmWl7;
        "pkg-1.21-6.0.0-beta.18+neoforge" = _ZEaAcmse;
        "pkg-1.16.5-5.8.6" = _xwP89rOv;
        "pkg-1.21-6.0.0-beta.19+forge" = _ttEACz03;
        "pkg-1.21-6.0.0-beta.19+fabric" = _CbTd4ZJy;
        "pkg-1.21-6.0.0-beta.19+neoforge" = _6VqqKRy6;
        "pkg-1.21-6.0.0-beta.20+forge" = _WszCUKmI;
        "pkg-1.21-6.0.0-beta.20+fabric" = _7vcXYdsz;
        "pkg-1.21-6.0.0-beta.20+neoforge" = _IUfAT2nr;
        "pkg-1.21-6.0.0-beta.21+forge" = _5nN797AN;
        "pkg-1.21-6.0.0-beta.21+fabric" = _HXImdjdz;
        "pkg-1.21-6.0.0-beta.21+neoforge" = _KX1qvq4a;
        "pkg-1.21-6.0.0-beta.22+forge" = _hHZu4GRC;
        "pkg-1.21-6.0.0-beta.22+fabric" = _Pi94xjNk;
        "pkg-1.21-6.0.0-beta.22+neoforge" = _lw5mFT1q;
        "pkg-1.20.1-5.10.2-fabric" = _nDJqHKvq;
        "pkg-1.20.1-5.10.2-forge" = _umkCqDao;
        "pkg-1.21-6.0.0-beta.23+fabric" = _AMl69D1f;
        "pkg-1.21-6.0.0-beta.23+forge" = _Y1Uvn9H0;
        "pkg-1.21-6.0.0-beta.23+neoforge" = _ELLkZlE6;
        "pkg-1.21-6.0.0-beta.24+fabric" = _RNTCl4M9;
        "pkg-1.21-6.0.0-beta.24+forge" = _K6VUoFWu;
        "pkg-1.21-6.0.0-beta.24+neoforge" = _kOPZxRz6;
        "pkg-1.21-6.0.0-beta.25+forge" = _nr4XzHrN;
        "pkg-1.21-6.0.0-beta.25+fabric" = _g88bVnJS;
        "pkg-1.21-6.0.0-beta.25+neoforge" = _NRoZU38G;
        "pkg-5.2.6" = _tgBOmyRI;
        "pkg-5.2.7" = _KqLhJIvo;
        "pkg-1.21-6.0.0-beta.26+fabric" = _NzxyPTzR;
        "pkg-1.21-6.0.0-beta.26+forge" = _k0ks0YaD;
        "pkg-1.21-6.0.0-beta.26+neoforge" = _3DZHPwan;
        "pkg-1.21-6.0.0-beta.27+fabric" = _VQ3Tn9v9;
        "pkg-1.21-6.0.0-beta.27+forge" = _XETntn2E;
        "pkg-1.21-6.0.0-beta.27+neoforge" = _CZ1JwxMf;
        "pkg-1.20.1-5.10.3-fabric" = _ThfZM7jC;
        "pkg-1.20.1-5.10.3-forge" = _r7FWVNCs;
        "pkg-1.21.1-6.0.0-beta.28+fabric" = _CCrivBGb;
        "pkg-1.21.1-6.0.0-beta.28+forge" = _JAMTRRJC;
        "pkg-1.21.1-6.0.0-beta.28+neoforge" = _wRBvrJPG;
        "pkg-1.21.3-6.0.0-beta.28+forge" = _3HZr0ASB;
        "pkg-1.21.3-6.0.0-beta.28+fabric" = _t2LmIVQ7;
        "pkg-1.21.3-6.0.0-beta.28+neoforge" = _2PpplYOO;
        "pkg-1.21.3-6.0.0-beta.29+forge" = _bidosoua;
        "pkg-1.21.3-6.0.0-beta.29+fabric" = _JfjtbNcI;
        "pkg-1.21.3-6.0.0-beta.29+neoforge" = _eXFO10zw;
        "pkg-1.21.1-6.0.0-beta.29+fabric" = _HzA6bgh5;
        "pkg-1.21.1-6.0.0-beta.29+forge" = _GuoNSQpO;
        "pkg-1.21.1-6.0.0-beta.29+neoforge" = _SICTh4y0;
        "pkg-1.21.1-6.0.0-beta.30+fabric" = _TbwK8TQ6;
        "pkg-1.21.1-6.0.0-beta.30+forge" = _Asl48lkZ;
        "pkg-1.21.1-6.0.0-beta.30+neoforge" = _DM7I13sW;
        "pkg-1.21.3-6.0.0-beta.30+forge" = _CXMYdgt2;
        "pkg-1.21.3-6.0.0-beta.30+fabric" = _nlBt1d3c;
        "pkg-1.21.3-6.0.0-beta.30+neoforge" = _PcJTqc3w;
        "pkg-1.21.1-6.0.0-beta.31+fabric" = _YDGhskHs;
        "pkg-1.21.1-6.0.0-beta.31+forge" = _dpImOS6X;
        "pkg-1.21.1-6.0.0-beta.31+neoforge" = _H5Y4KoD8;
        "pkg-1.21.3-6.0.0-beta.31+forge" = _SbmPRWrS;
        "pkg-1.21.3-6.0.0-beta.31+fabric" = _692cmxUp;
        "pkg-1.21.3-6.0.0-beta.31+neoforge" = _HCZzY35J;
        "pkg-1.21.4-6.0.0-beta.31+forge" = _Rr5vt8v7;
        "pkg-1.21.4-6.0.0-beta.31+fabric" = _ZHlLOvg8;
        "pkg-1.21.4-6.0.0-beta.31+neoforge" = _Kv3yLMEN;
        "pkg-1.21.1-6.0.0-beta.32+fabric" = _uQaxFMy7;
        "pkg-1.21.1-6.0.0-beta.32+forge" = _VIkoHeXV;
        "pkg-1.21.1-6.0.0-beta.32+neoforge" = _IDctQZb0;
        "pkg-1.21.4-6.0.0-beta.32+forge" = _D5QvTAkp;
        "pkg-1.21.4-6.0.0-beta.32+fabric" = _6YDcPKep;
        "pkg-1.21.4-6.0.0-beta.32+neoforge" = _G9ka0GQK;
        "pkg-1.21.1-6.0.0-beta.33+fabric" = _2VYtNfRz;
        "pkg-1.21.4-6.0.0-beta.33+forge" = _bVlxz5Mg;
        "pkg-1.21.1-6.0.0-beta.33+forge" = _suuPfdli;
        "pkg-1.21.4-6.0.0-beta.33+fabric" = _Jw52YTRb;
        "pkg-1.21.4-6.0.0-beta.33+neoforge" = _rvBtdpV8;
        "pkg-1.21.1-6.0.0-beta.33+neoforge" = _wyNoUFgY;
        "pkg-1.21.1-6.0.0-beta.34+fabric" = _cv0JguCL;
        "pkg-1.21.1-6.0.0-beta.34+forge" = _Ua2hFrmd;
        "pkg-1.21.1-6.0.0-beta.34+neoforge" = _zuCkQO5t;
        "pkg-1.21.4-6.0.0-beta.34+forge" = _xkN4plBx;
        "pkg-1.21.4-6.0.0-beta.34+fabric" = _tPqjrnW5;
        "pkg-1.21.4-6.0.0-beta.34+neoforge" = _BWu8hlNG;
        "pkg-5.2.8" = _NAabJ9OV;
        "pkg-1.21.4-6.0.0-beta.35+forge" = _iYXmH400;
        "pkg-1.21.4-6.0.0-beta.35+fabric" = _yibmlrjo;
        "pkg-1.21.4-6.0.0-beta.35+neoforge" = _MDDk2BUS;
        "pkg-1.21.1-6.0.0-beta.35+fabric" = _Xq0RBbKZ;
        "pkg-1.21.1-6.0.0-beta.35+forge" = _EIeSs3Qf;
        "pkg-1.21.1-6.0.0-beta.35+neoforge" = _p0eSd6sb;
        "pkg-1.21.1-6.0.0-beta.36+fabric" = _67yLAhoL;
        "pkg-1.21.1-6.0.0-beta.36+forge" = _frZhpzQB;
        "pkg-1.21.1-6.0.0-beta.36+neoforge" = _w5eQ3DFV;
        "pkg-1.21.4-6.0.0-beta.36+forge" = _SbSsm56t;
        "pkg-1.21.4-6.0.0-beta.36+fabric" = _HaeAocTz;
        "pkg-1.21.4-6.0.0-beta.36+neoforge" = _5N21Kwyi;
        "pkg-1.21.1-6.0.0-beta.37+fabric" = _VgrCCuhR;
        "pkg-1.21.1-6.0.0-beta.37+forge" = _Th1KjkSF;
        "pkg-1.21.1-6.0.0-beta.37+neoforge" = _R3KrS9Wx;
        "pkg-1.21.4-6.0.0-beta.37+forge" = _o7SSmSHe;
        "pkg-1.21.4-6.0.0-beta.37+fabric" = _sNcdybtA;
        "pkg-1.21.4-6.0.0-beta.37+neoforge" = _3AwbiZTa;
        "pkg-1.21.1-6.0.0-beta.38+fabric" = _3T43Fdy4;
        "pkg-1.21.1-6.0.0-beta.38+forge" = _lRiTeXwe;
        "pkg-1.21.1-6.0.0-beta.38+neoforge" = _n6o0R1gO;
        "pkg-1.21.4-6.0.0-beta.38+forge" = _PFxhFBSo;
        "pkg-1.21.4-6.0.0-beta.38+fabric" = _rjnTUbSe;
        "pkg-1.21.4-6.0.0-beta.38+neoforge" = _vCCycklc;
        "pkg-1.21.1-6.0.0-beta.39+fabric" = _1PMjJYg5;
        "pkg-1.21.1-6.0.0-beta.39+forge" = _fhgGxSe0;
        "pkg-1.21.1-6.0.0-beta.39+neoforge" = _l4QWQftp;
        "pkg-1.21.4-6.0.0-beta.39+forge" = _WDqzor0J;
        "pkg-1.21.4-6.0.0-beta.39+fabric" = _xFibBhft;
        "pkg-1.21.4-6.0.0-beta.39+neoforge" = _xAPpjlqY;
        "pkg-1.21.1-6.0.0-beta.40+fabric" = _DWcel7l9;
        "pkg-1.21.1-6.0.0-beta.40+forge" = _ZQ28kRCl;
        "pkg-1.21.1-6.0.0-beta.40+neoforge" = _Qu7X4Z4b;
        "pkg-1.21.4-6.0.0-beta.40+forge" = _TWeSw5UE;
        "pkg-1.21.4-6.0.0-beta.40+fabric" = _ETp89cpc;
        "pkg-1.21.4-6.0.0-beta.40+neoforge" = _rNTbp9SQ;
        "pkg-1.21.1-6.0.0-beta.41+fabric" = _zGmc3Q2K;
        "pkg-1.21.1-6.0.0-beta.41+forge" = _GrMDNiXa;
        "pkg-1.21.1-6.0.0-beta.41+neoforge" = _iKv46Bze;
        "pkg-1.21.4-6.0.0-beta.41+forge" = _Upd25Eju;
        "pkg-1.21.4-6.0.0-beta.41+fabric" = _j6l01HRl;
        "pkg-1.21.4-6.0.0-beta.41+neoforge" = _aULVURMp;
        "pkg-1.21.5-6.0.0-beta.41+fabric" = _HTnILqs4;
        "pkg-1.21.5-6.0.0-beta.41+neoforge" = _kREZqJVS;
        "pkg-1.21.5-6.0.0-beta.42+neoforge" = _IUor0uEA;
        "pkg-1.21.5-6.0.0-beta.42+fabric" = _nIoW9seW;
        "pkg-1.21.1-6.0.0-beta.42+fabric" = _matQIted;
        "pkg-1.21.1-6.0.0-beta.42+forge" = _UVLNWqHW;
        "pkg-1.21.1-6.0.0-beta.42+neoforge" = _Y7fx24BE;
        "pkg-1.21.4-6.0.0-beta.42+forge" = _QWkOc3H6;
        "pkg-1.21.4-6.0.0-beta.42+fabric" = _MTwPTPF7;
        "pkg-1.21.4-6.0.0-beta.42+neoforge" = _64KVPmF1;
        "pkg-1.21.1-6.0.0-beta.43+forge" = _11d82Wh4;
        "pkg-1.21.1-6.0.0-beta.43+fabric" = _ryhgyPo5;
        "pkg-1.21.1-6.0.0-beta.43+neoforge" = _EydYCX2q;
        "pkg-1.21.4-6.0.0-beta.43+forge" = _9xw4Tf4w;
        "pkg-1.21.4-6.0.0-beta.43+fabric" = _OaRcjlZc;
        "pkg-1.21.4-6.0.0-beta.43+neoforge" = _h6S7dpTK;
        "pkg-1.21.5-6.0.0-beta.43+forge" = _fhhIWmZM;
        "pkg-1.21.5-6.0.0-beta.43+fabric" = _SqO7bu9L;
        "pkg-1.21.5-6.0.0-beta.43+neoforge" = _3DUwAJDg;
        "pkg-1.21.1-6.0.0-beta.44+fabric" = _1IixJjcn;
        "pkg-1.21.1-6.0.0-beta.44+forge" = _bdz2ccj1;
        "pkg-1.21.1-6.0.0-beta.44+neoforge" = _P4wOwxaT;
        "pkg-1.21.4-6.0.0-beta.44+forge" = _kVNKt3h4;
        "pkg-1.21.4-6.0.0-beta.44+fabric" = _11kHuBXL;
        "pkg-1.21.4-6.0.0-beta.44+neoforge" = _F4Z6HPkR;
        "pkg-1.21.5-6.0.0-beta.44+forge" = _CCMGNJbp;
        "pkg-1.21.5-6.0.0-beta.44+fabric" = _PSO0qQXe;
        "pkg-1.21.5-6.0.0-beta.44+neoforge" = _ADz4pbjA;
        "pkg-craftmine-6.0.0-beta.44+fabric" = _c1ug2Wt3;
        "pkg-1.21.1-6.0.0-beta.45+forge" = _w2bAxLjb;
        "pkg-1.21.1-6.0.0-beta.45+fabric" = _cT2e34Ea;
        "pkg-1.21.1-6.0.0-beta.45+neoforge" = _3ZAmRYtn;
        "pkg-1.21.4-6.0.0-beta.45+forge" = _b4RdzB7X;
        "pkg-1.21.4-6.0.0-beta.45+fabric" = _wMXdNCQK;
        "pkg-1.21.5-6.0.0-beta.45+forge" = _JIWRxv9X;
        "pkg-1.21.4-6.0.0-beta.45+neoforge" = _owoqmMOA;
        "pkg-1.21.5-6.0.0-beta.45+fabric" = _VjWa5Hjt;
        "pkg-1.21.5-6.0.0-beta.45+neoforge" = _3BaZ1EkD;
        "pkg-1.21.1-6.0.0-beta.46+forge" = _L8CyHGvv;
        "pkg-1.21.1-6.0.0-beta.46+fabric" = _2gC29MbT;
        "pkg-1.21.1-6.0.0-beta.46+neoforge" = _EMdtxXeV;
        "pkg-1.21.4-6.0.0-beta.46+forge" = _sq4AlmGJ;
        "pkg-1.21.4-6.0.0-beta.46+fabric" = _yA85KVIm;
        "pkg-1.21.4-6.0.0-beta.46+neoforge" = _oHgK820s;
        "pkg-1.21.5-6.0.0-beta.46+forge" = _m8fKtPgR;
        "pkg-1.21.5-6.0.0-beta.46+fabric" = _WN8iNwlo;
        "pkg-1.21.5-6.0.0-beta.46+neoforge" = _gnhwQWUi;
        "pkg-5.2.9" = _acGN457p;
        "pkg-1.21.4-6.0.0-beta.47+forge" = _4wIHTF1a;
        "pkg-1.21.4-6.0.0-beta.47+fabric" = _bjbTbat1;
        "pkg-1.21.4-6.0.0-beta.47+neoforge" = _HC1cUgpI;
        "pkg-1.21.5-6.0.0-beta.47+forge" = _gdVcbt8I;
        "pkg-1.21.1-6.0.0-beta.47+forge" = _tQh7JZl9;
        "pkg-1.21.5-6.0.0-beta.47+fabric" = _MgSGAXZG;
        "pkg-1.21.1-6.0.0-beta.47+fabric" = _oBV1MaLz;
        "pkg-1.21.5-6.0.0-beta.47+neoforge" = _H4WKQ5uv;
        "pkg-1.21.1-6.0.0-beta.47+neoforge" = _sKqKyezs;
        "pkg-1.21.5-6.0.0-beta.48+forge" = _biNuXekL;
        "pkg-1.21.5-6.0.0-beta.48+fabric" = _AumD7kE8;
        "pkg-1.21.5-6.0.0-beta.48+neoforge" = _IgpYi9vk;
        "pkg-1.21.1-6.0.0-beta.48+forge" = _Lht9CIec;
        "pkg-1.21.1-6.0.0-beta.48+fabric" = _mIJDF4p4;
        "pkg-1.21.1-6.0.0-beta.48+neoforge" = _qv3qT6AO;
        "pkg-1.21.1-6.0.0-beta.49+forge" = _5XMB7mQV;
        "pkg-1.21.1-6.0.0-beta.49+fabric" = _btlTS94S;
        "pkg-1.21.1-6.0.0-beta.49+neoforge" = _tSe2TntB;
        "pkg-1.21.5-6.0.0-beta.49+forge" = _BSeYTlJq;
        "pkg-1.21.5-6.0.0-beta.49+fabric" = _vgIDxS0e;
        "pkg-1.21.5-6.0.0-beta.49+neoforge" = _9EwEH5jQ;
        "pkg-1.21.1-6.0.0-beta.50+forge" = _iWpleNVv;
        "pkg-1.21.1-6.0.0-beta.50+fabric" = _djv2aw2J;
        "pkg-1.21.1-6.0.0-beta.50+neoforge" = _uZp1IkkO;
        "pkg-1.21.5-6.0.0-beta.50+forge" = _Xm4qytcG;
        "pkg-1.21.5-6.0.0-beta.50+fabric" = _l1PjWpPJ;
        "pkg-1.21.5-6.0.0-beta.50+neoforge" = _42xt6fG2;
        "pkg-1.21.6-6.0.0-beta.50+neoforge" = _OcFoa5m3;
        "pkg-1.21.6-6.0.0-beta.50+fabric" = _teoO2f5i;
        "pkg-1.21.1-6.0.0-beta.51+forge" = _L50RROyJ;
        "pkg-1.21.5-6.0.0-beta.51+forge" = _zUHSDMuI;
        "pkg-1.21.5-6.0.0-beta.51+fabric" = _jqfLNjhS;
        "pkg-1.21.5-6.0.0-beta.51+neoforge" = _yyJbLIql;
        "pkg-1.21.1-6.0.0-beta.51+fabric" = _PONlm5hk;
        "pkg-1.21.6-6.0.0-beta.51+forge" = _gN5lbV17;
        "pkg-1.21.6-6.0.0-beta.51+fabric" = _Tsarzl9P;
        "pkg-1.21.1-6.0.0-beta.51+neoforge" = _pGVfGqAU;
        "pkg-1.21.6-6.0.0-beta.51+neoforge" = _WxaValcc;
        "pkg-1.21.6-6.0.0-beta.52+forge" = _FywMo6mG;
        "pkg-1.21.6-6.0.0-beta.52+fabric" = _D2VG2zPf;
        "pkg-1.21.5-6.0.0-beta.52+forge" = _9hQ8qduI;
        "pkg-1.21.5-6.0.0-beta.52+fabric" = _rV52D5m0;
        "pkg-1.21.6-6.0.0-beta.52+neoforge" = _lsxGXenW;
        "pkg-1.21.5-6.0.0-beta.52+neoforge" = _HSajmA5j;
        "pkg-1.21.1-6.0.0-beta.52+forge" = _QmE0pYFa;
        "pkg-1.21.1-6.0.0-beta.52+fabric" = _WvOAHk8e;
        "pkg-1.21.1-6.0.0-beta.52+neoforge" = _vyOPsWNv;
        "pkg-5.2.10" = _MO9cf9Ur;
        "pkg-1.21.7-6.0.0-beta.52+forge" = _FVl6xJUX;
        "pkg-1.21.7-6.0.0-beta.52+fabric" = _xDS1Jejv;
        "pkg-1.21.7-6.0.0-beta.52+neoforge" = _YK0LuCEa;
        "pkg-1.21.7-6.0.0-beta.53+forge" = _MSBfI5YS;
        "pkg-1.21.7-6.0.0-beta.53+fabric" = _lXRXvV4n;
        "pkg-1.21.7-6.0.0-beta.53+neoforge" = _VVA2aoYJ;
        "pkg-1.21.8-6.0.0-beta.52+forge" = _IsP3EBh4;
        "pkg-1.21.8-6.0.0-beta.52+fabric" = _vuRfR12O;
        "pkg-1.21.8-6.0.0-beta.52+neoforge" = _AIw9M7s1;
        "pkg-1.21.9-6.0.0-beta.52+neoforge" = _5y4bV6fo;
        "pkg-1.21.9-6.0.0-beta.52+fabric" = _NjgS22OU;
        "pkg-1.21.9-6.0.0-beta.53+forge" = _Mia47n56;
        "pkg-1.21.9-6.0.0-beta.53+fabric" = _FxkPeHeI;
        "pkg-1.21.9-6.0.0-beta.53+neoforge" = _NIljnFWX;
        "pkg-1.21.10-6.0.0-beta.52+forge" = _aFsB3nMJ;
        "pkg-1.21.10-6.0.0-beta.52+fabric" = _TYlVzBhI;
        "pkg-1.21.10-6.0.0-beta.52+neoforge" = _nblpcC9n;
        "pkg-1.21.10-6.0.0-beta.53+forge" = _kSIeG45y;
        "pkg-1.21.10-6.0.0-beta.53+fabric" = _ZVnVNvom;
        "pkg-1.21.10-6.0.0-beta.53+neoforge" = _LCocnwNX;
        "pkg-1.21.10-6.0.0-beta.54+forge" = _zkhiX9FE;
        "pkg-1.21.10-6.0.0-beta.54+fabric" = _66NSZBxq;
        "pkg-1.21.10-6.0.0-beta.54+neoforge" = _7leclCZ7;
        "pkg-1.21.11-6.0.0-beta.52+neoforge" = _OxeCASy0;
        "pkg-1.21.11-6.0.0-beta.52+fabric" = _9zquTFw1;
        "pkg-1.21.11-6.0.0-beta.53+neoforge" = _LU6sozZq;
        "pkg-1.21.11-6.0.0-beta.53+fabric" = _t3uYUEB5;
        "pkg-1.21.1-6.0.0-beta.53+forge" = _oDlTqqFj;
        "pkg-1.21.1-6.0.0-beta.53+fabric" = _owJ2GUiN;
        "pkg-1.21.1-6.0.0-beta.53+neoforge" = _3AZpZoxN;
        "pkg-1.21.11-6.0.0-beta.53+forge" = _HFZc4iiI;
        "pkg-1.21.11-6.0.0-beta.54+forge" = _s8CUsld3;
        "pkg-1.21.11-6.0.0-beta.54+fabric" = _SaQABb8q;
        "pkg-1.21.11-6.0.0-beta.54+neoforge" = _GGq1K3JY;
        "pkg-1.21.11-6.0.0-beta.55+forge" = _nyFrs9hl;
        "pkg-1.21.11-6.0.0-beta.55+fabric" = _X3DCfJx0;
        "pkg-1.21.11-6.0.0-beta.55+neoforge" = _jzDbyg0V;
        "pkg-1.21.10-6.0.0-beta.55+forge" = _AryIRlQB;
        "pkg-1.21.10-6.0.0-beta.55+fabric" = _K1m5OFRZ;
        "pkg-1.21.10-6.0.0-beta.55+neoforge" = _hRmvJPQf;
        "pkg-1.21.1-6.0.0-beta.54+forge" = _ookMkjDX;
        "pkg-1.21.1-6.0.0-beta.54+fabric" = _QAb9ZNiz;
        "pkg-1.21.1-6.0.0-beta.54+neoforge" = _eFMHVijM;
        "pkg-1.21.11-6.0.0-beta.56+forge" = _jVj8MhD4;
        "pkg-1.21.11-6.0.0-beta.56+fabric" = _OSpjUIEM;
        "pkg-1.21.11-6.0.0-beta.56+neoforge" = _gT3ov9Gl;
        "pkg-1.21.10-6.0.0-beta.56+forge" = _uz8I0H0r;
        "pkg-1.21.10-6.0.0-beta.56+fabric" = _jRhHewrc;
        "pkg-1.21.10-6.0.0-beta.56+neoforge" = _IqTWimOi;
        "pkg-1.21.10-6.0.0-beta.57+forge" = _xrGE1Jb4;
        "pkg-1.21.10-6.0.0-beta.57+fabric" = _ds3lzpyo;
        "pkg-1.21.10-6.0.0-beta.57+neoforge" = _RFwLTHTG;
        "pkg-1.21.10-6.0.0-beta.58+forge" = _I0uuh5AM;
        "pkg-1.21.10-6.0.0-beta.58+fabric" = _q7s86gFk;
        "pkg-1.21.10-6.0.0-beta.58+neoforge" = _3QAEEUt8;
        "pkg-1.21.1-6.0.0-beta.55+forge" = _mslnSKQI;
        "pkg-1.21.1-6.0.0-beta.55+fabric" = _adD1RQ1k;
        "pkg-1.21.1-6.0.0-beta.55+neoforge" = _pYCESymm;
        "pkg-1.21.11-6.0.0-beta.57+forge" = _3NX5UlXj;
        "pkg-1.21.11-6.0.0-beta.57+fabric" = _i1vwHtvO;
        "pkg-1.21.11-6.0.0-beta.57+neoforge" = _AyuzNR9J;
        "pkg-1.21.1-6.0.0-beta.56+forge" = _XqbmDHoR;
        "pkg-1.21.1-6.0.0-beta.56+fabric" = _BoGPY3Lg;
        "pkg-1.21.1-6.0.0-beta.56+neoforge" = _rUGIhJpD;
        "pkg-1.21.11-6.0.0-beta.58+fabric" = _6vu2HyQi;
        "pkg-1.21.11-6.0.0-beta.58+forge" = _azthZE1Q;
        "pkg-1.21.11-6.0.0-beta.58+neoforge" = _RNWliVdX;
        "pkg-1.21.11-6.0.0-beta.59+forge" = _V3qyhjgM;
        "pkg-1.21.11-6.0.0-beta.59+fabric" = _hUw6Nqrd;
        "pkg-1.21.11-6.0.0-beta.59+neoforge" = _NJljROqK;
        "pkg-1.21.1-6.0.0-beta.57+forge" = _ZvUJ996I;
        "pkg-1.21.1-6.0.0-beta.57+fabric" = _7BqD0v1r;
        "pkg-1.21.1-6.0.0-beta.57+neoforge" = _yDBzIDgF;
        "pkg-1.21.1-6.0.0-beta.58+forge" = _ZNOTJGbc;
        "pkg-1.21.1-6.0.0-beta.58+fabric" = _KQfraQMZ;
        "pkg-1.21.1-6.0.0-beta.58+neoforge" = _QpQf6MQJ;
        "pkg-1.21.11-6.0.0-beta.60+forge" = _oAzyJe00;
        "pkg-1.21.11-6.0.0-beta.60+fabric" = _ymQzLi5T;
        "pkg-1.21.11-6.0.0-beta.60+neoforge" = _XNZnBPeV;
        "pkg-26.1-6.0.0-beta.60+forge" = _JyufglCW;
        "pkg-26.1-6.0.0-beta.60+fabric" = _pHQ632Xe;
        "pkg-26.1-6.0.0-beta.60+neoforge" = _cNwAaIzw;
        "pkg-26.1-6.0.0-beta.61+forge" = _2u5ZgrKc;
        "pkg-26.1-6.0.0-beta.61+fabric" = _NBC0fqO6;
        "pkg-26.1-6.0.0-beta.61+neoforge" = _UR7an5Z3;
        "pkg-1.21.1-6.0.0-beta.59+forge" = _fZmeVTRn;
        "pkg-1.21.1-6.0.0-beta.59+fabric" = _2TUrvo27;
        "pkg-1.21.1-6.0.0-beta.59+neoforge" = _IaUQgm2T;
        "pkg-1.21.11-6.0.0-beta.61+forge" = _gCwg3ILQ;
        "pkg-1.21.11-6.0.0-beta.61+fabric" = _gAdQATR2;
        "pkg-1.21.11-6.0.0-beta.61+neoforge" = _SAmiAIhA;
        "pkg-26.1-6.0.0-beta.62+forge" = _wLPNO11z;
        "pkg-26.1-6.0.0-beta.62+neoforge" = _YZf39MHN;
        "pkg-26.1-6.0.0-beta.62+fabric" = _lu53SXvk;
        "pkg-26.1-6.0.0-beta.63+forge" = _7AK67d2w;
        "pkg-26.1-6.0.0-beta.63+neoforge" = _OTiDfym0;
        "pkg-26.1-6.0.0-beta.63+fabric" = _CYUrytGf;
        "pkg-1.21.11-6.0.0-beta.62+forge" = _XbQt08zk;
        "pkg-1.21.11-6.0.0-beta.62+fabric" = _8Wd7GWgj;
        "pkg-1.21.11-6.0.0-beta.62+neoforge" = _iHiu1SFN;
        "pkg-1.21.1-6.0.0-beta.60+forge" = _aM8zqNgD;
        "pkg-1.21.1-6.0.0-beta.60+fabric" = _7borUjfH;
        "pkg-1.21.1-6.0.0-beta.60+neoforge" = _nu4oHXle;
        "pkg-1.21.11-6.0.0-beta.63+forge" = _Yco5S2h8;
        "pkg-1.21.11-6.0.0-beta.63+fabric" = _ajOMv0sc;
        "pkg-1.21.11-6.0.0-beta.63+neoforge" = _Y7MbqmCF;
        "pkg-26.1-6.0.0-beta.64+forge" = _tE2KUTqq;
        "pkg-26.1-6.0.0-beta.64+neoforge" = _9xPBJVEP;
        "pkg-26.1-6.0.0-beta.64+fabric" = _1lcmIgq5;
        "pkg-26.1-6.0.0-beta.65+fabric" = _9nbAPqIR;
        "pkg-26.1-6.0.0-beta.65+forge" = _G8u2JsJp;
        "pkg-26.1-6.0.0-beta.65+neoforge" = _TheYMGh0;
        "pkg-1.21.1-6.0.0-beta.61+forge" = _7Icdw0pn;
        "pkg-1.21.1-6.0.0-beta.61+fabric" = _2O0cV677;
        "pkg-1.21.1-6.0.0-beta.61+neoforge" = _9DzP2bVB;
        "pkg-1.21.11-6.0.0-beta.64+forge" = _5tBop2Ty;
        "pkg-1.21.11-6.0.0-beta.64+fabric" = _hutjSOHn;
        "pkg-1.21.11-6.0.0-beta.64+neoforge" = _tJcT1DBB;
        "pkg-1.21.1-6.0.0-beta.62+forge" = _Vr1NkRax;
        "pkg-1.21.1-6.0.0-beta.62+fabric" = _nJpABNHT;
        "pkg-1.21.1-6.0.0-beta.62+neoforge" = _BtLjrFeO;
        "pkg-26.1-6.0.0-beta.66+fabric" = _s1Lon8Gq;
        "pkg-26.1-6.0.0-beta.66+forge" = _FJwiTf8q;
        "pkg-26.1-6.0.0-beta.66+neoforge" = _VanoukzP;
        "pkg-1.21.1-6.0.0-beta.63+forge" = _KSpuymWa;
        "pkg-1.21.1-6.0.0-beta.63+fabric" = _6prIj17q;
        "pkg-1.21.1-6.0.0-beta.63+neoforge" = _kVC1rF8K;
        "pkg-1.21.11-6.0.0-beta.65+forge" = _F7SRRmWX;
        "pkg-1.21.11-6.0.0-beta.65+fabric" = _9K1qdFqz;
        "pkg-1.21.11-6.0.0-beta.65+neoforge" = _IqrJL7IP;
        "pkg-5.2.11" = _WPloo93i;
        "pkg-26.1-6.0.0-beta.67+fabric" = _tHO89MsT;
        "pkg-26.1-6.0.0-beta.67+forge" = _I32DRaiJ;
        "pkg-26.1-6.0.0-beta.67+neoforge" = _5YEj4JLa;
        "pkg-5.2.12" = _VVkz40lP;
        "pkg-1.21.1-6.0.0-beta.64+forge" = _S1h2I8m9;
        "pkg-1.21.1-6.0.0-beta.64+fabric" = _dhscdTv5;
        "pkg-1.21.1-6.0.0-beta.64+neoforge" = _cYlR4bJh;
        "pkg-1.21.11-6.0.0-beta.66+forge" = _jdeJYqm8;
        "pkg-1.21.11-6.0.0-beta.66+fabric" = _VfmeGxWV;
        "pkg-1.21.11-6.0.0-beta.66+neoforge" = _suQsfA1D;
        "pkg-26.1.2-6.0.0-beta.68+fabric" = _cAuF6i4V;
        "pkg-26.1.2-6.0.0-beta.68+forge" = _NrH6qOo6;
        "pkg-26.1.2-6.0.0-beta.68+neoforge" = _VBBFsOnx;
        "pkg-1.21.1-6.0.0-beta.65+forge" = _68adQvn0;
        "pkg-1.21.1-6.0.0-beta.65+fabric" = _dVUDpB6x;
        "pkg-1.21.1-6.0.0-beta.65+neoforge" = _NGxV13VB;
        "pkg-26.1.2-6.0.0-beta.69+fabric" = _jvScp1J4;
        "pkg-26.1.2-6.0.0-beta.69+forge" = _DSN8IVnC;
        "pkg-26.1.2-6.0.0-beta.69+neoforge" = _BEpC7hZh;
        "pkg-1.21.11-6.0.0-beta.67+forge" = _4gEffxQx;
        "pkg-1.21.11-6.0.0-beta.67+fabric" = _qCYRAshB;
        "pkg-1.21.11-6.0.0-beta.67+neoforge" = _lXze4buv;
        "pkg-v5.2.13" = _qbK4ogLa;
        "pkg-5.2.14" = _bHFWj9PV;
        "pkg-1.21.1-6.0.0-beta.66+fabric" = _Bi1XkdY2;
        "pkg-1.21.1-6.0.0-beta.66+forge" = _toLVxKVW;
        "pkg-1.21.1-6.0.0-beta.66+neoforge" = _E44vwUJO;
        "pkg-26.1.2-6.0.0-beta.70+fabric" = _m5NUJY9O;
        "pkg-26.1.2-6.0.0-beta.70+forge" = _yK6rpvY2;
        "pkg-26.1.2-6.0.0-beta.70+neoforge" = _V1DYeMw0;
        "pkg-1.21.11-6.0.0-beta.68+fabric" = _VX8GZXvv;
        "pkg-1.21.11-6.0.0-beta.68+forge" = _kqP6DrL0;
        "pkg-1.21.11-6.0.0-beta.68+neoforge" = _J22pYgPD;
        "pkg-5.2.15" = _J0VSRcVy;
        "pkg-26.1.2-6.0.0-beta.71+fabric" = _hP0e08cR;
        "pkg-26.1.2-6.0.0-beta.71+forge" = _dtjOGsmU;
        "pkg-26.1.2-6.0.0-beta.71+neoforge" = _P6VmJevO;
        "pkg-1.21.1-6.0.0-beta.67+fabric" = _CtbWFuQ4;
        "pkg-1.21.1-6.0.0-beta.67+forge" = _X0diAnj2;
        "pkg-1.21.1-6.0.0-beta.67+neoforge" = _uSyuU1n5;
        "pkg-1.21.11-6.0.0-beta.69+fabric" = _svYPHm6p;
        "pkg-1.21.11-6.0.0-beta.69+forge" = _mQQRVBS6;
        "pkg-1.21.11-6.0.0-beta.69+neoforge" = _Uf648XA1;
        "pkg-26.1.2-6.0.0-beta.72+fabric" = _aqUUlAph;
        "pkg-26.1.2-6.0.0-beta.72+forge" = _smbCyjWu;
        "pkg-26.1.2-6.0.0-beta.72+neoforge" = _hA0DDQx7;
        "pkg-1.21.1-6.0.0-beta.68+fabric" = _n7ZgngeV;
        "pkg-1.21.1-6.0.0-beta.68+forge" = _HXjeoC5Z;
        "pkg-1.21.1-6.0.0-beta.68+neoforge" = _lZRvDIPc;
        "pkg-1.21.11-6.0.0-beta.70+fabric" = _Ltah1D9i;
        "pkg-1.21.11-6.0.0-beta.70+forge" = _OCVyJ5ML;
        "pkg-1.21.11-6.0.0-beta.70+neoforge" = _1SgMRkSg;
        "pkg-1.21.1-6.0.0-beta.69+fabric" = _Cn6Hx2Ev;
        "pkg-1.21.1-6.0.0-beta.69+forge" = _gs1Ykzbn;
        "pkg-1.21.1-6.0.0-beta.69+neoforge" = _bEZfIT2g;
        "pkg-1.21.11-6.0.0-beta.71+fabric" = _XU0qAiS5;
        "pkg-1.21.11-6.0.0-beta.71+forge" = _Ae3oO9Su;
        "pkg-1.21.11-6.0.0-beta.71+neoforge" = _Vffx3FHK;
        "pkg-26.1.2-6.0.0-beta.73+fabric" = _r7C4ihd8;
        "pkg-26.1.2-6.0.0-beta.73+forge" = _JpuW7qlR;
        "pkg-26.1.2-6.0.0-beta.73+neoforge" = _A5M2vGDG;
        "pkg-26.1.2-6.0.0-beta.74+fabric" = _O6Qk0DU2;
        "pkg-26.1.2-6.0.0-beta.74+forge" = _HSUdTvhQ;
        "pkg-26.1.2-6.0.0-beta.74+neoforge" = _N7vGQKNz;
        "pkg-1.21.1-6.0.0-beta.70+fabric" = _JeiHFZ7q;
        "pkg-1.21.1-6.0.0-beta.70+forge" = _zanZVSXt;
        "pkg-1.21.1-6.0.0-beta.70+neoforge" = _bqzQ9J2c;
        "pkg-1.21.11-6.0.0-beta.72+fabric" = _twQyfaSd;
        "pkg-1.21.11-6.0.0-beta.72+forge" = _HPUcuZI1;
        "pkg-1.21.11-6.0.0-beta.72+neoforge" = _JhtbDTh7;
        "pkg-26.1.2-6.0.0-beta.75+fabric" = _7Et4EaTZ;
        "pkg-26.1.2-6.0.0-beta.75+forge" = _MefmGEuT;
        "pkg-26.1.2-6.0.0-beta.75+neoforge" = _XF3jnC4B;
        "pkg-1.21.1-6.0.0-beta.71+fabric" = _3IizhooS;
        "pkg-1.21.1-6.0.0-beta.71+forge" = _EcCh6tAt;
        "pkg-1.21.1-6.0.0-beta.71+neoforge" = _gNKGNwQm;
        "pkg-1.21.11-6.0.0-beta.73+fabric" = _W1B5abaF;
        "pkg-1.21.11-6.0.0-beta.73+forge" = _tsyTA8gn;
        "pkg-1.21.11-6.0.0-beta.73+neoforge" = _q24u5skj;
        "pkg-26.1.2-6.0.0-beta.76+fabric" = _lPfxB29G;
        "pkg-26.1.2-6.0.0-beta.76+forge" = _mfN0gFv1;
        "pkg-26.1.2-6.0.0-beta.76+neoforge" = _qtMmN9UH;
        "pkg-1.21.1-6.0.0-beta.72+fabric" = _1CFafeHJ;
        "pkg-1.21.1-6.0.0-beta.72+forge" = _ak4eUZJB;
        "pkg-1.21.1-6.0.0-beta.72+neoforge" = _GJK0zDM4;
        "pkg-1.21.11-6.0.0-beta.74+fabric" = _NYiWuhie;
        "pkg-1.21.11-6.0.0-beta.74+forge" = _oTpm4RbC;
        "pkg-1.21.11-6.0.0-beta.74+neoforge" = _gkL9WTgj;
        "pkg-5.2.16" = _pCqIlxr2;
        "pkg-1.21.1-6.0.0-beta.73+fabric" = _YUowSkwG;
        "pkg-1.21.1-6.0.0-beta.73+forge" = _LYtS2N7n;
        "pkg-1.21.1-6.0.0-beta.73+neoforge" = _yS4vSHRC;
        "pkg-1.21.11-6.0.0-beta.75+fabric" = _v5Hx3TW8;
        "pkg-1.21.11-6.0.0-beta.75+forge" = _RrIgkXfD;
        "pkg-1.21.11-6.0.0-beta.75+neoforge" = _CY7jTJVt;
        "pkg-26.1.2-6.0.0-beta.77+fabric" = _uYiD7poA;
        "pkg-26.1.2-6.0.0-beta.77+forge" = _E8KprOSK;
        "pkg-26.1.2-6.0.0-beta.77+neoforge" = _HpBRzi7Y;
        "pkg-26.1.2-6.0.0-beta.77+paper" = _ur3xiRFh;
        "pkg-26.1.2-6.0.0-beta.78+fabric" = _OYqTELQT;
        "pkg-26.1.2-6.0.0-beta.78+forge" = _OoxqQefc;
        "pkg-26.1.2-6.0.0-beta.78+neoforge" = _LcTL3eJN;
        "pkg-26.1.2-6.0.0-beta.78+paper" = _uDt5yWp0;
        "pkg-1.21.1-6.0.0-beta.74+fabric" = _tLLXfGm7;
        "pkg-1.21.1-6.0.0-beta.74+forge" = _voBcOlAP;
        "pkg-1.21.1-6.0.0-beta.74+neoforge" = _95hGLCsp;
        "pkg-1.21.11-6.0.0-beta.76+fabric" = _eTtbKXtf;
        "pkg-1.21.11-6.0.0-beta.76+forge" = _wIcwjkqD;
        "pkg-1.21.11-6.0.0-beta.76+neoforge" = _FUX93o7o;
        "pkg-26.1.2-6.0.0-beta.79+fabric" = _sLEaPVei;
        "pkg-26.1.2-6.0.0-beta.79+forge" = _fM9OcJ4l;
        "pkg-26.1.2-6.0.0-beta.79+neoforge" = _tDVthMs3;
        "pkg-26.1.2-6.0.0-beta.79+paper" = _O0XBlPG5;
        "pkg-1.21.1-6.0.0-beta.75+fabric" = _nRaBwlOk;
        "pkg-1.21.1-6.0.0-beta.75+forge" = _ngD0CGHo;
        "pkg-1.21.1-6.0.0-beta.75+neoforge" = _9Reyl5BJ;
        "pkg-1.21.11-6.0.0-beta.77+fabric" = _buI4ZyZ1;
        "pkg-1.21.11-6.0.0-beta.77+forge" = _agdsajwG;
        "pkg-1.21.11-6.0.0-beta.77+neoforge" = _wTarsEPz;
        "pkg-26.1.2-6.0.0-beta.80+fabric" = _PqqiCpfx;
        "pkg-26.1.2-6.0.0-beta.80+forge" = _cOUkps4z;
        "pkg-26.1.2-6.0.0-beta.80+neoforge" = _AQts06Nu;
        "pkg-26.1.2-6.0.0-beta.80+paper" = _r2IW021Q;
        "pkg-1.21.1-6.0.0-beta.76+fabric" = _dPygFnxq;
        "pkg-1.21.1-6.0.0-beta.76+forge" = _fXKbeKWu;
        "pkg-1.21.1-6.0.0-beta.76+neoforge" = _a7FdRfYf;
        "pkg-1.21.11-6.0.0-beta.78+fabric" = _iPk17ruB;
        "pkg-1.21.11-6.0.0-beta.78+forge" = _Nqxa6ZnH;
        "pkg-1.21.11-6.0.0-beta.78+neoforge" = _BLuWXGRj;
        "pkg-26.1.2-6.0.0-beta.81+fabric" = _a0uMg99X;
        "pkg-26.1.2-6.0.0-beta.81+forge" = _9Xw4FDMR;
        "pkg-26.1.2-6.0.0-beta.81+neoforge" = _1Gs8yxFY;
        "pkg-26.1.2-6.0.0-beta.81+paper" = _StiJhu0E;
        "pkg-1.21.1-6.0.0-beta.77+fabric" = _8SSHSRJf;
        "pkg-1.21.1-6.0.0-beta.77+forge" = _qdxiVpTz;
        "pkg-1.21.1-6.0.0-beta.77+neoforge" = _dnk2VOks;
        "pkg-1.21.11-6.0.0-beta.79+fabric" = _42J4OASc;
        "pkg-1.21.11-6.0.0-beta.79+forge" = _f4yMNuZE;
        "pkg-1.21.11-6.0.0-beta.79+neoforge" = _Ret83I0B;
        "pkg-v5.2.17" = _lTcFpNxW;
        "pkg-26.1.2-6.0.0-beta.82+fabric" = _y3MANWZY;
        "pkg-26.1.2-6.0.0-beta.82+forge" = _XltiERNx;
        "pkg-26.1.2-6.0.0-beta.82+neoforge" = _uxAn4xHd;
        "pkg-26.1.2-6.0.0-beta.82+paper" = _TZkz8BPU;
        "pkg-1.21.1-6.0.0-beta.78+fabric" = _zk0YF8C1;
        "pkg-1.21.1-6.0.0-beta.78+forge" = _zDH3yLlS;
        "pkg-1.21.1-6.0.0-beta.78+neoforge" = _a0k4neCF;
        "pkg-1.21.11-6.0.0-beta.80+fabric" = _PKX1yyPy;
        "pkg-1.21.11-6.0.0-beta.80+forge" = _NUnHA3T0;
        "pkg-1.21.11-6.0.0-beta.80+neoforge" = _I2xLVXs5;
        "pkg-1.21.11-6.0.0-beta.81+fabric" = _w3e0REfe;
        "pkg-1.21.11-6.0.0-beta.81+forge" = _P2Seuggy;
        "pkg-1.21.11-6.0.0-beta.81+neoforge" = _qd2loTAQ;
        "pkg-1.21.1-6.0.0-beta.79+fabric" = _5KlpcRrT;
        "pkg-26.1.2-6.0.0-beta.83+fabric" = _7dkQceAa;
        "pkg-1.21.1-6.0.0-beta.79+forge" = _QtaLrJDF;
        "pkg-26.1.2-6.0.0-beta.83+forge" = _WlMGMUew;
        "pkg-1.21.1-6.0.0-beta.79+neoforge" = _hJvkjktT;
        "pkg-26.1.2-6.0.0-beta.83+neoforge" = _A9fxnPBI;
        "pkg-26.1.2-6.0.0-beta.83+paper" = _uuvyBqZy;
        "pkg-1.21.11-6.0.0-beta.82+fabric" = _qvNvPvWv;
        "pkg-1.21.11-6.0.0-beta.82+forge" = _lyaiQ9Tb;
        "pkg-1.21.11-6.0.0-beta.82+neoforge" = _vqWcAKfh;
        "pkg-1.21.1-6.0.0-beta.80+fabric" = _7N1n5PuH;
        "pkg-1.21.1-6.0.0-beta.80+forge" = _nJZA02dF;
        "pkg-1.21.1-6.0.0-beta.80+neoforge" = _AqeqzAK9;
        "pkg-26.1.2-6.0.0-beta.84+fabric" = _FLM7hBUq;
        "pkg-26.1.2-6.0.0-beta.84+forge" = _KRVsrMcW;
        "pkg-26.1.2-6.0.0-beta.84+neoforge" = _hGMtR8EZ;
        "pkg-26.1.2-6.0.0-beta.84+paper" = _8UMgocEF;
        "pkg-1.21.11-6.0.0-beta.83+fabric" = _5ITdSZyL;
        "pkg-1.21.11-6.0.0-beta.83+forge" = _xWGYk9s0;
        "pkg-1.21.11-6.0.0-beta.83+neoforge" = _MS8QXeZh;
        "pkg-26.1.2-6.0.0-beta.85+fabric" = _jP3MlN9K;
        "pkg-26.1.2-6.0.0-beta.85+forge" = _SdZuZQGv;
        "pkg-26.1.2-6.0.0-beta.85+neoforge" = _Ulw5n2Xs;
        "pkg-26.1.2-6.0.0-beta.85+paper" = _arWiert4;
        "pkg-1.21.11-6.0.0-beta.84+fabric" = _u2RMGOiD;
        "pkg-1.21.11-6.0.0-beta.84+forge" = _H0Z4ROXT;
        "pkg-1.21.11-6.0.0-beta.84+neoforge" = _Qps6AvR4;
        "pkg-1.21.1-6.0.0-beta.81+fabric" = _5obLspwq;
        "pkg-1.21.1-6.0.0-beta.81+forge" = _BA7WcAcK;
        "pkg-1.21.1-6.0.0-beta.81+neoforge" = _Ex7ZcbHn;
        "pkg-26.1.2-6.0.0-beta.86+fabric" = _jTuTCkvq;
        "pkg-26.1.2-6.0.0-beta.86+forge" = _peVM13GQ;
        "pkg-26.1.2-6.0.0-beta.86+neoforge" = _HDo3lsC8;
        "pkg-26.1.2-6.0.0-beta.86+paper" = _Gzgjnzo2;
        "pkg-1.21.1-6.0.0-beta.82+fabric" = _fTdovVeF;
        "pkg-1.21.1-6.0.0-beta.82+forge" = _KFRwv94x;
        "pkg-1.21.1-6.0.0-beta.82+neoforge" = _1wPOSxW0;
        "pkg-1.21.11-6.0.0-beta.85+fabric" = _eMSNz4Wh;
        "pkg-1.21.11-6.0.0-beta.85+forge" = _c7wb03IR;
        "pkg-1.21.11-6.0.0-beta.85+neoforge" = _aHpbliUg;
        "pkg-26.1.2-6.0.0-beta.87+fabric" = _2sXnoLEx;
        "pkg-26.1.2-6.0.0-beta.87+forge" = _hw3RwO1r;
        "pkg-26.1.2-6.0.0-beta.87+neoforge" = _HmmfBqpd;
        "pkg-26.1.2-6.0.0-beta.87+paper" = _mLBnndGR;
        "pkg-1.21.1-6.0.0-beta.83+fabric" = _VpDprquK;
        "pkg-1.21.1-6.0.0-beta.83+forge" = _D6aOUhln;
        "pkg-1.21.1-6.0.0-beta.83+neoforge" = _s1EZERLo;
        "pkg-1.21.11-6.0.0-beta.86+fabric" = _BC1LfiLd;
        "pkg-1.21.11-6.0.0-beta.86+forge" = _oOn6gKjt;
        "pkg-1.21.11-6.0.0-beta.86+neoforge" = _MlpGqqsG;
        "pkg-5.2.17" = _PmKEPhk4;
        "pkg-26.1.2-6.0.0-beta.88+fabric" = _l4A83QFg;
        "pkg-26.1.2-6.0.0-beta.88+forge" = _HqQmvQc4;
        "pkg-26.1.2-6.0.0-beta.88+neoforge" = _7g1TK1lr;
        "pkg-26.1.2-6.0.0-beta.88+paper" = _KVMBvXdH;
        "pkg-1.21.1-6.0.0-beta.84+fabric" = _gFlMZWzX;
        "pkg-1.21.1-6.0.0-beta.84+forge" = _Tg536L94;
        "pkg-1.21.1-6.0.0-beta.84+neoforge" = _2oFtejNz;
        "pkg-1.21.11-6.0.0-beta.87+fabric" = _rKAciRHz;
        "pkg-1.21.11-6.0.0-beta.87+forge" = _NZ0WcduD;
        "pkg-1.21.11-6.0.0-beta.87+neoforge" = _zFIUivvA;
        "pkg-26.1.2-6.0.0-beta.89+fabric" = _qoepTCxE;
        "pkg-26.1.2-6.0.0-beta.89+forge" = _6TP2Utt8;
        "pkg-26.1.2-6.0.0-beta.89+neoforge" = _NUACXePC;
        "pkg-26.1.2-6.0.0-beta.89+paper" = _96LXfRwk;
        "pkg-1.21.1-6.0.0-beta.85+fabric" = _P9hqp50q;
        "pkg-1.21.1-6.0.0-beta.85+forge" = _cKJarIm5;
        "pkg-1.21.1-6.0.0-beta.85+neoforge" = _S6y2f7fD;
        "pkg-1.21.11-6.0.0-beta.88+fabric" = _snRkD2zP;
        "pkg-1.21.11-6.0.0-beta.88+forge" = _IC38Rdt6;
        "pkg-1.21.11-6.0.0-beta.88+neoforge" = _7Bdjc3pU;
        "pkg-26.2-6.0.0-beta.90+fabric" = _JtWzG1La;
        "pkg-26.2-6.0.0-beta.90+neoforge" = _mCDuM76S;
        "pkg-1.21.1-6.0.0-beta.86+fabric" = _SVKruthH;
        "pkg-1.21.1-6.0.0-beta.86+forge" = _A5RUHbaB;
        "pkg-1.21.1-6.0.0-beta.86+neoforge" = _xfyEZjJ4;
        "pkg-26.1.2-6.0.0-beta.90+fabric" = _ADi8ZhvY;
        "pkg-26.2-6.0.0-beta.91+fabric" = _fXgnBWVg;
        "pkg-26.1.2-6.0.0-beta.90+forge" = _liGTbUcK;
        "pkg-26.2-6.0.0-beta.91+forge" = _BQZFMItL;
        "pkg-26.1.2-6.0.0-beta.90+neoforge" = _3VVPqVIi;
        "pkg-26.2-6.0.0-beta.91+neoforge" = _PGGuWL9C;
        "pkg-26.1.2-6.0.0-beta.90+paper" = _mLPd0sLZ;
        "pkg-26.2-6.0.0-beta.91+paper" = _KVRbd8Vl;
        "pkg-1.21.11-6.0.0-beta.89+fabric" = _qEfCskII;
        "pkg-1.21.11-6.0.0-beta.89+forge" = _amKRPcUD;
        "pkg-1.21.11-6.0.0-beta.89+neoforge" = _G1hOHICS;
        "pkg-1.21.1-6.0.0-beta.87+fabric" = _dRXThpjs;
        "pkg-1.21.1-6.0.0-beta.87+forge" = _T5GmBZEH;
        "pkg-1.21.1-6.0.0-beta.87+neoforge" = _VsBzKki1;
        "pkg-1.21.11-6.0.0-beta.90+fabric" = _Qif8olYr;
        "pkg-1.21.11-6.0.0-beta.90+forge" = _63Ftd7Y1;
        "pkg-1.21.11-6.0.0-beta.90+neoforge" = _ZD8YcTx3;
        "pkg-26.1.2-6.0.0-beta.91+fabric" = _NjlTpWcI;
        "pkg-26.1.2-6.0.0-beta.91+forge" = _ItOfOmfL;
        "pkg-26.1.2-6.0.0-beta.91+neoforge" = _qsyo0EqU;
        "pkg-26.1.2-6.0.0-beta.91+paper" = _iaLC7RjJ;
        "pkg-26.2-6.0.0-beta.92+fabric" = _3O8PDgd0;
        "pkg-26.2-6.0.0-beta.92+forge" = _R97dC8Mz;
        "pkg-26.2-6.0.0-beta.92+neoforge" = _pCbJ3b9w;
        "pkg-26.2-6.0.0-beta.92+paper" = _bAWWKeif;
        "pkg-1.21.1-6.0.0-beta.88+fabric" = _ykEmPkG2;
        "pkg-1.21.1-6.0.0-beta.88+forge" = _ABCx7aHh;
        "pkg-1.21.1-6.0.0-beta.88+neoforge" = _RKfLrEYQ;
        "pkg-1.21.11-6.0.0-beta.91+fabric" = _Mmc2qbHk;
        "pkg-1.21.11-6.0.0-beta.91+forge" = _QZ6CX1YM;
        "pkg-1.21.11-6.0.0-beta.91+neoforge" = _L8CIuY2a;
        "pkg-5.2.18" = _ALbwrYWE;
        "pkg-26.1.2-6.0.0+fabric" = _awdgK1bN;
        "pkg-26.1.2-6.0.0+forge" = _1dtYEyYD;
        "pkg-26.1.2-6.0.0+neoforge" = _LBRrWujD;
        "pkg-26.1.2-6.0.0+paper" = _yXPpOx62;
        "pkg-26.2-6.0.0+fabric" = _DGSSf530;
        "pkg-26.2-6.0.0+forge" = _sxZgO0Yf;
        "pkg-26.2-6.0.0+neoforge" = _6XAmiEWa;
        "pkg-26.2-6.0.0+paper" = _11xZAIkx;
        "pkg-1.21.1-6.0.0+fabric" = _fDHQAvrw;
        "pkg-1.21.1-6.0.0+forge" = _nSsnlzoj;
        "pkg-1.21.1-6.0.0+neoforge" = _edtgHsxe;
        "pkg-1.21.11-6.0.0+fabric" = _6Np0S5K2;
        "pkg-1.21.11-6.0.0+forge" = _QHIeRVSX;
        "pkg-1.21.11-6.0.0+neoforge" = _74jT8gKb;
        "pkg-5.2.19" = _GC3Ohy9T;
        "pkg-1.20.1-6.0.0-beta.1+fabric" = _6xzk19Ku;
        "pkg-1.20.1-6.0.0-beta.1+forge" = _CvTfIrV2;
        "pkg-1.20.1-6.0.0-beta.2+fabric" = _yZaPt0Bj;
        "pkg-1.20.1-6.0.0-beta.2+forge" = _sODTSQMx;
        "pkg-1.16.5-6.0.0-beta.1+fabric" = _nUaF7SRq;
        "pkg-1.16.5-6.0.0-beta.1+forge" = _XoOlLLbO;
        "pkg-1.20.1-6.0.0-beta.3+fabric" = _SOEbjWqk;
        "pkg-1.20.1-6.0.0-beta.3+forge" = _Vp6xdIRh;
        "pkg-1.20.1-6.0.0-beta.4+fabric" = _3SeTyiIv;
        "pkg-1.20.1-6.0.0-beta.4+forge" = _mOC5DRbh;
        "pkg-1.16.5-6.0.0-beta.2+fabric" = _2HfiOaL7;
        "pkg-1.16.5-6.0.0-beta.2+forge" = _TzRHltUy;
        "pkg-1.12.2-6.0.0-beta.1+forge" = _bToML7KE;
        "pkg-5.2.20" = _lC2yDXH0;
        "pkg-1.7.10-6.0.0-beta.1+forge" = _xI0TdgsP;
        "pkg-1.12.2-6.0.0-beta.2+forge" = _rZsh7fow;
        "pkg-1.7.10-6.0.0-beta.2+forge" = _hsTmpwrm;
        "pkg-1.16.5-6.0.0-beta.3+fabric" = _z9SqxTR6;
        "pkg-1.16.5-6.0.0-beta.3+forge" = _ztpKc7cH;
        "pkg-1.21.1-6.0.1+fabric" = _7295GTvc;
        "pkg-1.20.1-6.0.0-beta.5+fabric" = _sq3YnfNd;
        "pkg-1.21.1-6.0.1+forge" = _i6uq8CpW;
        "pkg-1.20.1-6.0.0-beta.5+forge" = _ns4prGUX;
        "pkg-1.21.1-6.0.1+neoforge" = _plEVc4Oq;
        "pkg-26.1.2-6.0.1+fabric" = _TyIuKCai;
        "pkg-26.1.2-6.0.1+forge" = _NVSE8k9y;
        "pkg-26.1.2-6.0.1+neoforge" = _TxEeXoa0;
        "pkg-26.1.2-6.0.1+paper" = _XavHEdga;
        "pkg-26.2-6.0.1+fabric" = _abb2IyRm;
        "pkg-26.2-6.0.1+forge" = _NjEicZb0;
        "pkg-26.2-6.0.1+neoforge" = _tcmQCMB7;
        "pkg-26.2-6.0.1+paper" = _jhj3TyE0;
        "pkg-1.7.10-6.0.0-beta.3+forge" = _BOC4yOQ0;
        "pkg-1.7.10-6.0.0-beta.4+forge" = _RCSe34ZV;
        "pkg-1.12.2-6.0.0-beta.3+forge" = _tQRxnMsB;
        "pkg-1.20.1-6.0.0-beta.6+fabric" = _NbYVKakP;
        "pkg-1.20.1-6.0.0-beta.6+forge" = _t89TLGzh;
        "pkg-1.16.5-6.0.0-beta.4+fabric" = _E8C3hRap;
        "pkg-1.16.5-6.0.0-beta.4+forge" = _d7xCDNw7;
        "pkg-26.1.2-6.0.2+fabric" = _q11vX5dz;
        "pkg-26.2-6.0.2+fabric" = _gNAWSuoC;
        "pkg-26.1.2-6.0.2+forge" = _549MmYkO;
        "pkg-26.2-6.0.2+forge" = _lJ0RUiM2;
        "pkg-26.1.2-6.0.2+neoforge" = _bdZkUo3G;
        "pkg-26.1.2-6.0.2+paper" = _gxaYNblQ;
        "pkg-26.2-6.0.2+neoforge" = _8SxM1dFh;
        "pkg-26.2-6.0.2+paper" = _cE6sB6LM;
        "pkg-1.21.1-6.0.2+fabric" = _1R6MJHAk;
        "pkg-1.21.1-6.0.2+forge" = _POrUMkOD;
        "pkg-1.21.1-6.0.2+neoforge" = _GhkNvBWk;
        "pkg-1.12.2-6.0.0+forge" = _NEuFyZwX;
        "pkg-26.1.2-6.0.3+fabric" = _cmyJmFx9;
        "pkg-26.2-6.0.3+fabric" = _Be26Ad7m;
        "pkg-26.1.2-6.0.3+forge" = _SiF6Rv1W;
        "pkg-26.2-6.0.3+forge" = _zZZVo6JD;
        "pkg-26.1.2-6.0.3+neoforge" = _Z39imYpL;
        "pkg-26.2-6.0.3+neoforge" = _W27AkEGm;
        "pkg-26.1.2-6.0.3+paper" = _avhCwDqc;
        "pkg-26.2-6.0.3+paper" = _mq5sQR8o;
        "pkg-1.21.1-6.0.3+fabric" = _tGKMq7hr;
        "pkg-1.21.1-6.0.3+forge" = _qrbXF9cA;
        "pkg-1.21.1-6.0.3+neoforge" = _WEOAmpDC;
        "pkg-1.16.5-6.0.0+fabric" = _WskpJ10s;
        "pkg-1.16.5-6.0.0+forge" = _d4n4NCgN;
        "pkg-1.20.1-6.0.0+fabric" = _lxSoN7kO;
        "pkg-1.20.1-6.0.0+forge" = _9xIDlHWu;
        "pkg-1.7.10-6.0.0+forge" = _bgfysrBe;
        "pkg-1.12.2-6.0.1+forge" = _jqnEurcR;
        "pkg-1.12.2-6.0.2+forge" = _syuoOEqF;
        "pkg-26.1.2-6.0.4+fabric" = _v6EIBVUQ;
        "pkg-26.1.2-6.0.4+forge" = _eJ3VxnPm;
        "pkg-26.1.2-6.0.4+neoforge" = _MYF1fYGU;
        "pkg-26.1.2-6.0.4+paper" = _9gm3cYQF;
        "pkg-26.2-6.0.4+fabric" = _uugpK0Hl;
        "pkg-26.2-6.0.4+forge" = _cUAXiyKr;
        "pkg-26.2-6.0.4+neoforge" = _m1NSCXoV;
        "pkg-26.2-6.0.4+paper" = _Kl9AFXm8;
        "pkg-1.12.2-6.0.3+forge" = _lWx9W99B;
        "pkg-1.21.1-6.0.4+fabric" = _uLzdDes0;
        "pkg-1.21.1-6.0.4+forge" = _ocUzqyr8;
        "pkg-1.21.1-6.0.4+neoforge" = _BWZbAAhc;
        "pkg-1.20.1-6.0.1+fabric" = _3QrQsPgT;
        "pkg-1.20.1-6.0.1+forge" = _T7k6KTVz;
        "pkg-1.7.10-6.0.1+forge" = _cxw6VoUX;
        "pkg-1.16.5-6.0.1+fabric" = _2pFlZknr;
        "pkg-1.16.5-6.0.1+forge" = _eqp2P3wZ;
        "pkg-1.16.5-6.0.2+fabric" = _MTFGRxSI;
        "pkg-1.16.5-6.0.2+forge" = _6GNciFBx;
        "pkg-1.16.5-6.0.3+fabric" = _eisqBbU5;
        "pkg-1.16.5-6.0.3+forge" = _yoAO8hPk;
        "pkg-1.12.2-6.0.4+forge" = _wRmNfEpC;
        "pkg-1.7.10-6.0.2+forge" = _1v6TlbvA;
        "pkg-1.21.1-6.0.5+fabric" = _IOiuj94c;
        "pkg-1.21.1-6.0.5+forge" = _K7Gj8uwA;
        "pkg-1.21.1-6.0.5+neoforge" = _35TPQTuf;
        "pkg-26.1.2-6.0.5+fabric" = _q88VtXCp;
        "pkg-26.1.2-6.0.5+forge" = _SC4nRnUs;
        "pkg-26.1.2-6.0.5+neoforge" = _oYa0EjTI;
        "pkg-26.1.2-6.0.5+paper" = _RCMbqsI7;
        "pkg-26.2-6.0.5+fabric" = _HDly3jmH;
        "pkg-26.2-6.0.5+forge" = _ZzyRn3Gm;
        "pkg-26.2-6.0.5+neoforge" = _amV3hJiO;
        "pkg-26.2-6.0.5+paper" = _fIZYuDvF;
        "pkg-1.20.1-6.0.2+fabric" = _hk3YW8ZE;
        "pkg-1.20.1-6.0.2+forge" = _2J6Wc3JR;
        "pkg-1.16.5-6.0.4+fabric" = _faEm4E9P;
        "pkg-1.16.5-6.0.4+forge" = _MxbgbIjg;
        "pkg-1.12.2-6.0.5+forge" = _6PMMvhSm;
        "pkg-1.7.10-6.0.3+forge" = _9c5DPuqL;
        "pkg-26.2-6.0.6+fabric" = _24Ydvogd;
        "pkg-26.2-6.0.6+forge" = _N1AkxnEC;
        "pkg-26.2-6.0.6+neoforge" = _amccmQzA;
        "pkg-26.2-6.0.6+paper" = _kjfEII1a;
        "pkg-26.1.2-6.0.6+fabric" = _NnmofI4P;
        "pkg-26.1.2-6.0.6+forge" = _w7yMNgg7;
        "pkg-26.1.2-6.0.6+neoforge" = _toPpKPvu;
        "pkg-26.1.2-6.0.6+paper" = _8G9LbFs8;
        "pkg-1.20.1-6.0.3+fabric" = _fXJGoRQ5;
        "pkg-1.20.1-6.0.3+forge" = _NuBYW5y3;
        "pkg-1.21.1-6.0.6+fabric" = _rJpcMLFb;
        "pkg-1.21.1-6.0.6+forge" = _5d0EmSTR;
        "pkg-1.21.1-6.0.6+neoforge" = _3xPNjfk3;
        "pkg-1.16.5-6.0.5+fabric" = _gyKM5oOd;
        "pkg-1.16.5-6.0.5+forge" = _sHXvsd6t;
        "pkg-1.12.2-6.0.6+forge" = _rUIgvSqg;
        "pkg-1.16.5-6.0.6+fabric" = _ZaCd1d6o;
        "pkg-1.16.5-6.0.6+forge" = _2u3HZFeH;
        "pkg-1.7.10-6.0.4+forge" = _RLCDwXKG;
        "pkg-26.2-6.0.7+fabric" = _yC2TZbEJ;
        "pkg-26.2-6.0.7+forge" = _DULz7GjE;
        "pkg-26.2-6.0.7+neoforge" = _Z4HOwlL0;
        "pkg-26.2-6.0.7+paper" = _QvoFswMi;
        "pkg-1.21.1-6.0.7+fabric" = _R1escxHM;
        "pkg-1.21.1-6.0.7+forge" = _xiMok6KJ;
        "pkg-1.21.1-6.0.7+neoforge" = _IAVJBO0C;
        "pkg-1.20.1-6.0.4+fabric" = _3vFadXiU;
        "pkg-1.20.1-6.0.4+forge" = _8Le0UypF;
        "pkg-26.1.2-6.0.7+fabric" = _QLraArkB;
        "pkg-26.1.2-6.0.7+forge" = _M7e8rAn6;
        "pkg-26.1.2-6.0.7+neoforge" = _hV7MEbm1;
        "pkg-26.1.2-6.0.7+paper" = _3soDuwiO;
        "pkg-1.12.2-6.0.7+forge" = _7PVXRMLQ;
        "pkg-1.7.10-6.0.5+forge" = _UN07VY1P;
        "pkg-1.21.1-6.0.8+fabric" = _qmuZAgdA;
        "pkg-1.16.5-6.0.7+fabric" = _JXXQItXy;
        "pkg-26.1.2-6.0.8+fabric" = _4wIu8h4i;
        "pkg-1.20.1-6.0.5+fabric" = _JmYxahiA;
        "pkg-1.16.5-6.0.7+forge" = _79rFi4E1;
        "pkg-26.1.2-6.0.8+forge" = _KFCkLTXo;
        "pkg-1.20.1-6.0.5+forge" = _3pOseiLA;
        "pkg-26.1.2-6.0.8+neoforge" = _Ae7IjxZ5;
        "pkg-26.1.2-6.0.8+paper" = _SYFNVEtZ;
        "pkg-1.21.1-6.0.8+forge" = _kLWSgzKN;
        "pkg-1.21.1-6.0.8+neoforge" = _F1lEUGxf;
        "pkg-26.2-6.0.8+fabric" = _SQsKHZAV;
        "pkg-26.2-6.0.8+forge" = _NOgezEhx;
        "pkg-26.2-6.0.8+neoforge" = _BvreZ8yd;
        "pkg-26.2-6.0.8+paper" = _U0WXujcV;
        "pkg-5.2.21" = _jmujAJzr;
        "pkg-5.2.23" = _pQmw6aS6;
        "pkg-1.7.10-6.0.6+forge" = _WBAzKaRz;
        "pkg-1.12.2-6.0.8+forge" = _C3E0jQji;
