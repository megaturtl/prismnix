...
let
    ...
    in {
        ...
        "pkg-1.18.2-2.7.1+forge" = _wXTFesGW;
        "pkg-1.18.2-2.7.2+fabric" = _VPYMwdDZ;
        "pkg-1.18.2-2.7.2+forge" = _tCW7mX1B;
        "pkg-1.18.2-2.7.3+fabric" = _NMgJ2BlW;
        "pkg-1.18.2-2.7.3+forge" = _4JTbTxna;
        "pkg-1.18.2-2.7.4+fabric" = _M7zQPypE;
        "pkg-1.18.2-2.7.4+forge" = _DtITrdt2;
        "pkg-1.18.2-2.7.5+fabric" = _TwuesVHU;
        "pkg-1.18.2-2.7.5+forge" = _dc4FblBM;
        "pkg-1.19.2-2.7.5+fabric" = _mQY75nBx;
        "pkg-1.19.2-2.7.5+forge" = _43ysRHNC;
        "pkg-1.19.2-2.7.6+fabric" = _xIhBIDCV;
        "pkg-1.19.2-2.7.6+forge" = _cqtZlIPm;
        "pkg-1.18.2-2.7.7+fabric" = _QJcpcmCW;
        "pkg-1.18.2-2.7.7+forge" = _rFw5aG3j;
        "pkg-1.19.2-2.7.7+fabric" = _ImRUsMr4;
        "pkg-1.19.2-2.7.7+forge" = _T6sCwY4E;
        "pkg-1.19.2-2.7.8+fabric" = _f2PysaRK;
        "pkg-1.19.2-2.7.8+forge" = _6aIOGY3T;
        "pkg-1.19.2-2.7.9+fabric" = _dIIoIaGP;
        "pkg-1.19.2-2.7.9+forge" = _WKbyXlEH;
        "pkg-1.19.2-2.7.10+fabric" = _4iK3pEyB;
        "pkg-1.19.2-2.7.10+forge" = _pDtOjljn;
        "pkg-1.19.2-2.7.11+fabric" = _339GMBvC;
        "pkg-1.19.2-2.7.11+forge" = _ZarmSG5O;
        "pkg-1.19.2-2.8.0+fabric" = _TBtmuPUD;
        "pkg-1.19.2-2.8.0+forge" = _n50jyCjI;
        "pkg-1.19.2-2.9.0+fabric" = _7sHZinNx;
        "pkg-1.19.2-2.9.0+forge" = _ir4lOEDc;
        "pkg-1.19.2-2.9.1+fabric" = _jvKVmC1y;
        "pkg-1.19.2-2.9.1+forge" = _1BTiNfZJ;
        "pkg-1.20.1-2.10.0+fabric" = _s11oQXBD;
        "pkg-1.20.1-2.10.0+forge" = _1Utbex3o;
        "pkg-1.20.1-2.10.1+fabric" = _fMlyQgDv;
        "pkg-1.20.1-2.10.1+forge" = _o4CsupJu;
        "pkg-1.20.1-2.10.2+fabric" = _CTvG0oqw;
        "pkg-1.20.1-2.10.2+forge" = _FhBctaP5;
        "pkg-1.20.1-2.10.3+fabric" = _azVN541R;
        "pkg-1.20.1-2.10.3+forge" = _jvfh1QhA;
        "pkg-1.20.1-2.10.4+forge" = _WqJHHvUW;
        "pkg-1.20.1-2.10.4+fabric" = _4qZRB2qr;
        "pkg-1.20.1-2.11.0+forge" = _gFOZANKr;
        "pkg-1.20.1-2.11.0+fabric" = _hYqY2ME4;
        "pkg-1.20.1-2.12.0+fabric" = _4bA9z4Qr;
        "pkg-1.20.1-2.12.0+forge" = _72Tq9bfK;
        "pkg-1.21-3.0.0+neoforge" = _7TuXqSRh;
        "pkg-1.21-3.0.1+neoforge" = _R70GmPoq;
        "pkg-1.21-3.0.2+neoforge" = _felHSOYU;
        "pkg-1.21-3.0.3+neoforge" = _U774jhCf;
        "pkg-1.21-3.0.4+neoforge" = _LcmRpnnV;
        "pkg-1.21-3.1.0+neoforge" = _WhXX6qyC;
        "pkg-1.21-3.1.1+neoforge" = _tKPdpv2N;
        "pkg-1.21.1-3.1.2+neoforge" = _yxP5GD1Q;
        "pkg-1.21.1-3.2.2+neoforge" = _hUByDpdP;
        "pkg-1.21.1-3.4.0+neoforge" = _MO2OtUZQ;
        "pkg-1.20.1-2.13.0+forge" = _RjTRvo4g;
        "pkg-1.20.1-2.13.0+fabric" = _teWjqlCt;
        "pkg-1.21.1-3.4.1+neoforge" = _ye9ZNm5g;
        "pkg-1.21.1-3.4.2+neoforge" = _zbru02Sz;
        "pkg-1.21.1-3.4.3+neoforge" = _BSntam4Z;
        "pkg-1.21.1-3.5.0+neoforge" = _N8ILAE2X;
        "pkg-1.21.1-3.6.0+neoforge" = _PvHi2l0L;
        "pkg-1.21.1-3.6.1+neoforge" = _MqNlbKZc;
