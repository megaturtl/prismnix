...
let
    ...
    in {
        ...
        "pkg-1.19.3-8.0.3" = _gu7jRYFN;
        "pkg-1.19.3-8.0.4" = _mH5Enmcx;
        "pkg-1.19.3-8.0.5" = _XV1VHCIT;
        "pkg-1.19.3-8.0.6" = _TjRyPtwm;
        "pkg-1.19.3-8.0.7" = _8j3Kjt5f;
        "pkg-1.19.3-8.0.8" = _yZw97C0p;
        "pkg-1.19.2-8.0.8.1" = _egJ1V7cg;
        "pkg-1.19.2-8.0.8.2" = _o70Hb3mR;
        "pkg-1.19.3-8.0.9" = _OOtQAXbR;
        "pkg-1.20.1-9.0.0" = _LNJsChFY;
        "pkg-1.18.2-7.1.6" = _6WgHGszy;
        "pkg-1.20.1-9.0.1" = _7HoNHl0l;
        "pkg-1.20.1-9.0.2" = _jHmG0ju7;
        "pkg-1.20.1-9.0.3" = _QhCmvgcw;
        "pkg-1.20.1-9.0.4" = _HwukGn94;
        "pkg-1.20.1-9.0.5" = _16V7g1pe;
        "pkg-1.20.6-10.0.0" = _zJdoA2zY;
        "pkg-1.20.6-10.0.1" = _CJOeeRVq;
        "pkg-1.21-10.0.1" = _tnsSHb4w;
        "pkg-1.21-10.0.1-NeoForge" = _aRQrleJB;
        "pkg-1.20.6-10.0.2" = _hWSqi5hi;
        "pkg-1.21-10.0.2-Forge" = _r1sNa3Sf;
        "pkg-1.21-10.0.2-NeoForge" = _96whowlN;
        "pkg-1.20.6-10.0.3" = _XDc3VOgi;
        "pkg-1.21.1-10.0.3-Forge" = _1zma6lH0;
        "pkg-1.21.1-10.0.3-NeoForge" = _IqGyhx99;
        "pkg-1.20.6-10.0.4" = _cygwXfyg;
        "pkg-1.21.1-10.0.4-Forge" = _Hv8oqvES;
        "pkg-1.21.1-10.0.4-NeoForge" = _snCtBOcF;
        "pkg-1.21.1-10.1.0-NeoForge" = _4yN47aO4;
        "pkg-1.20.6-10.1.0-Forge" = _Xiwo70Rc;
        "pkg-1.21.1-10.1.0-Forge" = _bjXKs1LR;
        "pkg-1.21.1-10.1.0-beta-Fabric" = _vaQVKBSF;
        "pkg-1.21.1-10.1.1-NeoForge" = _Mr83PBX5;
        "pkg-1.20.6-10.1.1-Forge" = _BdLPC1Kt;
        "pkg-1.21.1-10.1.1-Forge" = _jO7R77qJ;
        "pkg-1.21.1-10.1.1-beta-Fabric" = _OHdYwUwk;
        "pkg-1.21.1-10.1.2-NeoForge" = _oCou7psZ;
        "pkg-1.20.6-10.1.2-Forge" = _EoAmMMrZ;
        "pkg-1.21.1-10.1.2-Forge" = _moyuLMll;
        "pkg-1.21.1-10.1.2-beta-Fabric" = _ftO8JL7v;
        "pkg-1.21.1-10.1.3-NeoForge" = _lLx7ZId6;
        "pkg-1.20.6-10.1.3-Forge" = _YOjw882w;
        "pkg-1.21.1-10.1.3-Forge" = _laQJklgy;
        "pkg-1.21.1-10.1.3-beta-Fabric" = _a8geOLSM;
        "pkg-1.20.1-9.0.6" = _i9u0IW8x;
        "pkg-1.20.6-10.1.4-Forge" = _fSbLgCJw;
        "pkg-1.21.1-10.1.4-Forge" = _G4Ru6pWT;
        "pkg-1.21.1-10.1.4-beta-Fabric" = _TdxkUc6E;
        "pkg-1.21.1-10.1.4-NeoForge" = _LjUqCO4Y;
        "pkg-1.20.6-10.1.5-Forge" = _kfEZXCFD;
        "pkg-1.21.1-10.1.5-Forge" = _H6EZR5Cb;
        "pkg-1.21.1-10.1.5-NeoForge" = _4QHXp8Mt;
        "pkg-1.21.1-10.1.5-beta-Fabric" = _ZXDGeD0I;
        "pkg-1.20.6-10.1.6-Forge" = _57YvXfc5;
        "pkg-1.21.1-10.1.6-beta-Fabric" = _OEeQonRV;
        "pkg-1.21.1-10.1.6-Forge" = _kfTIhEpy;
        "pkg-1.21.1-10.1.6-NeoForge" = _UN3lJ4nu;
        "pkg-1.20.6-10.1.7-Forge" = _euQgLVRa;
        "pkg-1.21.1-10.1.7-Forge" = _yOZJ0JfD;
        "pkg-1.21.1-10.1.7-beta-Fabric" = _3n6RoUic;
        "pkg-1.21.1-10.1.7-NeoForge" = _IYP2XZO3;
        "pkg-1.20.1-10.1.8-Forge" = _RMHbErNo;
        "pkg-1.20.6-10.1.8-Forge" = _XMjQGkiB;
        "pkg-1.21.1-10.1.8-Forge" = _hyP7qYo4;
        "pkg-1.21.1-10.1.8-NeoForge" = _OEMcnTWg;
        "pkg-1.21.1-10.1.8-beta-Fabric" = _vDqj9byQ;
        "pkg-1.20.1-10.1.9-Forge" = _WkvCrHvO;
        "pkg-1.21.1-10.1.9-beta-Fabric" = _pmZ3x5BE;
        "pkg-1.21.1-10.1.9-Forge" = _ZkzKaUEb;
        "pkg-1.21.1-10.1.9-NeoForge" = _5FPJbW9T;
        "pkg-1.20.1-10.1.10-Forge" = _pPYR4x71;
        "pkg-1.20.6-10.1.10-Forge" = _44bLfYC3;
        "pkg-1.21.1-10.1.10-beta-Fabric" = _hKBrCSh2;
        "pkg-1.21.1-10.1.10-Forge" = _yRgypKma;
        "pkg-1.21.1-10.1.10-NeoForge" = _yhkYsnFP;
        "pkg-1.20.1-10.1.11-Forge" = _xoZJe9Qq;
        "pkg-1.20.6-10.1.11-Forge" = _sWm5lvi2;
