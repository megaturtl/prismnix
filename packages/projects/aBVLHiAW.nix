...
let
    ...
    in {
        ...
        "pkg-3.9.1" = _jIlLLERJ;
        "pkg-3.9.2" = _wtUXKBsr;
        "pkg-3.10.0" = _jg5PUIJU;
        "pkg-3.10.1" = _hN0xPVX8;
        "pkg-3.11.0" = _f00vKkRj;
        "pkg-3.11.1" = _s6fKwsZO;
        "pkg-3.11.2" = _TQDG4gtU;
        "pkg-3.12.0" = _AbNCctdZ;
        "pkg-3.13.0" = _mumrQWIt;
        "pkg-3.14.0" = _fXbdyZgo;
        "pkg-3.14.1" = _wWYjwh9w;
        "pkg-3.14.2" = _JIy1KVhv;
        "pkg-3.15.0" = _5zE8it01;
        "pkg-3.16.0" = _TZssIGnX;
        "pkg-3.16.1" = _XiWQk1PP;
        "pkg-3.16.2" = _oUfQPROa;
        "pkg-3.18.0" = _AqyhvrLM;
        "pkg-3.18.1" = _23UXQFeH;
        "pkg-3.19.0" = _2Qtyz9eX;
