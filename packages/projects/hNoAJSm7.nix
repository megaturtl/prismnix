...
let
    versions = (let
        ...
        _YkAHhMFs = {
            "id" = "YkAHhMFs";
            "file" = "techutils-0.8.1+1.21.11.jar";
            "hash" = "sha512-HZlHP26VxFA3LKa6aXYMp86gURXeBiYdAKaVi8QgM8/i3ut/X9t8fpD9Cosl9BgTe9uLCbwLdTtMTD6x6/jM7w==";
        };
        _YJ2C2O4C = {
            "id" = "YJ2C2O4C";
            "file" = "techutils-0.8.1+26.1.jar";
            "hash" = "sha512-upksrLJ6XGNWOSTRsMl3dnTFxI+Xsn4uyS5SsZw70Mx24I+Mng7kJI6pvvmGsMci0Y8MkGRKW3iRj/a8yW0png==";
        };
        _Jua96tDa = {
            "id" = "Jua96tDa";
    ...
    in {
        ...
        "pkg-0.1.2" = _gkaF6A38;
        "pkg-0.2.0+1.19.3" = _MKzRfHPe;
        "pkg-0.3.0-beta.1+1.19.4" = _qYj3ck8G;
        "pkg-0.3.0-beta.2+1.19.4" = _gG3WULg3;
        "pkg-0.3.0-beta.3+1.19.4" = _gXbOHa7y;
        "pkg-0.3.0-beta.4+1.19.4" = _iHO0Y2Ic;
        "pkg-0.3.0-beta.4+1.19.3" = _9oLHEv8V;
        "pkg-0.4.0" = _SNqwdxlF;
        "pkg-0.4.1" = _WU6qPwEr;
        "pkg-0.5.4+1.21.1" = _EN4KVcCH;
        "pkg-0.5.3+1.21.4" = _EGmoxikU;
        "pkg-0.5.5+1.21.1" = _rgN1hB5x;
        "pkg-0.5.6+1.21.1" = _IypSZSnh;
        "pkg-0.5.5+1.21.4" = _61VBnlkP;
        "pkg-0.5.7+1.21.1" = _DuzuP0s9;
        "pkg-0.5.6+1.21.4" = _2TILxBEr;
        "pkg-0.5.0-beta.1+1.20.1" = _oNhVK5FC;
        "pkg-0.5.0+1.20.1" = _gJgjRlIJ;
        "pkg-0.5.0-beta.1+1.20.4" = _sxVjjYeQ;
        "pkg-0.5.8+1.21.1" = _XaYscmB6;
        "pkg-0.5.7+1.21.4" = _iGImlLq6;
        "pkg-0.5.0+1.21.5" = _HM0LqOQI;
        "pkg-0.6.0+1.20.1" = _GopKKGns;
        "pkg-0.6.0-beta.1+1.20.4" = _dFeBDDQw;
        "pkg-0.6.0+1.21.1" = _suAYPj4p;
        "pkg-0.6.0+1.21.4" = _eG7VMyyo;
        "pkg-0.6.0+1.21.5" = _DoM0wPXY;
        "pkg-0.6.1+1.20.1" = _YeaUE01l;
        "pkg-0.6.0-beta.2+1.20.4" = _6OS4JuEH;
        "pkg-0.6.0+1.21.7" = _dB5N5ZKL;
        "pkg-0.6.0+1.21.10" = _bQUQ9oQd;
        "pkg-0.6.1+1.21.1" = _VI57BunG;
        "pkg-0.6.1+1.21.4" = _bHqKIuOC;
        "pkg-0.6.1+1.21.5" = _8WkQKzY0;
        "pkg-0.6.1+1.21.7" = _sb9rn8AM;
        "pkg-0.6.1+1.21.10" = _EuvbXqkv;
        "pkg-0.6.1+1.21.11" = _gaN6PS8u;
        "pkg-0.6.2+1.21.1" = _fxzuXs5u;
        "pkg-0.6.2+1.21.4" = _cf2xuBOn;
        "pkg-0.6.2+1.21.5" = _7DZPhHyL;
        "pkg-0.6.2+1.21.7" = _hNg8AyM2;
        "pkg-0.6.2+1.21.10" = _He8FIzh6;
        "pkg-0.6.2+1.21.11" = _e7kFb3TF;
        "pkg-0.6.3+1.21.11" = _h1TJRawI;
        "pkg-0.7.0+26.1" = _8Qmi3Ra7;
        "pkg-0.7.0+26.2" = _iky53K6v;
        "pkg-0.6.3+1.21.1" = _Z0r4BBRx;
        "pkg-0.6.4+1.21.1" = _TeUaIrWS;
        "pkg-0.6.3+1.21.4" = _4GQVHQEN;
        "pkg-0.6.3+1.21.5" = _N9D28kFf;
        "pkg-0.6.3+1.21.8" = _MhsNm0Ga;
        "pkg-0.6.3+1.21.10" = _x3RgdYDL;
