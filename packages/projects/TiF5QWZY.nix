...
let
    versions = (let
        ...
        _ajKcHatH = {
            "id" = "ajKcHatH";
            "file" = "respackopts-26.2.2.jar";
            "hash" = "sha512-P4WsqmyRGd0k1Ywx+Q3oSOtoKPLOTygznnrGoZMI7FUNapfS7zE6EO0Zx7MciolRdFCv31wOfJHMJK/Jinh2QA==";
        };
        _Whg3OJJA = {
            "id" = "Whg3OJJA";
            "file" = "respackopts-26.3.0.jar";
            "hash" = "sha512-Ivl3vj9GKwJCPRDhNsGTlZw5H8QpsLoCB6qyRea5ZwR67WQF0ncIxtwxRDdwdv81KJjmldhjfWGf8r4+n+eRsg==";
        };
    in {
        "7JFYFPCr" = _7JFYFPCr;
        "NQTzqrfZ" = _NQTzqrfZ;
        ...
        "fabric-26.2" = _ajKcHatH;
        "fabric-26.3" = _Whg3OJJA;
        ...
        "neoforge-26.2" = _ajKcHatH;
        "neoforge-26.3" = _Whg3OJJA;
        "pkg-v1.0" = _7JFYFPCr;
        "pkg-1.0" = _NQTzqrfZ;
        "pkg-1.1" = _7BWPizYc;
        "pkg-1.1.2" = _QFZH7pdW;
        ...
        "pkg-2.9.0" = _Fv0OJ1o6;
        "pkg-2.9.1" = _Bi1BgIxq;
        "pkg-2.10.0" = _V74sa3zw;
        "pkg-2.10.1" = _cM9lZADH;
        "pkg-2.10.2" = _3qth7Amf;
        "pkg-3.0.0" = _QEIvpqRP;
        "pkg-3.1.0" = _m3FcVIrZ;
        "pkg-4.0.0" = _HLvBHUdj;
        "pkg-4.0.1" = _QYmJGKEO;
        ...
        "pkg-4.8.0" = _tyb25WQ8;
        "pkg-4.9.0" = _aTFRFQAB;
        "pkg-4.10.0" = _6StGGQrZ;
        "pkg-4.11.0" = _tnKYO6y4;
        "pkg-4.11.1" = _4ScEvGiA;
        "pkg-4.11.2+forge" = _BkUuQvkW;
        "pkg-4.11.2" = _NitEpVRe;
        "pkg-4.11.3+forge" = _78FBNXT8;
        "pkg-4.11.3" = _8zp8yqFl;
        "pkg-4.12.0" = _2Klx8xoL;
        "pkg-4.12.1" = _4MoKY1hg;
        "pkg-4.12.1+forge" = _Iz38kiC5;
        "pkg-4.12.2" = _xYTBHN8C;
        "pkg-4.12.2+forge" = _mL8aAmEr;
        "pkg-4.12.3" = _k6zgD7uA;
        "pkg-4.12.3+forge" = _sU4dM0aU;
        "pkg-4.12.4+forge" = _E6MdK8mU;
        "pkg-4.12.5" = _7B6cxG76;
        "pkg-4.12.5+forge" = _C3aIAuxT;
        "pkg-4.13.1" = _eEqQ4wwH;
        "pkg-4.13.1+forge" = _Gfrp39QP;
        "pkg-4.13.2" = _A4rBSOvU;
        "pkg-4.13.2+forge" = _yq4POSfR;
        "pkg-4.13.3" = _Oho1e6Dg;
        "pkg-4.13.3+forge" = _9A0I2dpv;
        "pkg-4.13.4" = _7X2Ic5a1;
        "pkg-4.13.4+forge" = _WrX4T08G;
        "pkg-4.13.5" = _KZhlTVrI;
        "pkg-4.13.5+forge" = _xSYxsBmG;
        "pkg-4.13.6" = _NPn3Idoe;
        "pkg-4.13.6+forge" = _UsAHFGug;
        "pkg-4.13.7" = _2FJCJCFa;
        "pkg-4.13.7+forge" = _nmrolc7R;
        "pkg-4.13.8" = _ndXmXCMp;
        "pkg-4.13.8+forge" = _wFLJWoWl;
        "pkg-4.13.9" = _KJpUWZJ7;
        "pkg-4.13.9+forge" = _HkgYvzRl;
        "pkg-4.13.10" = _cC1EQ2nF;
        "pkg-4.13.10+forge" = _A6J1sDo8;
        "pkg-4.14.0" = _77bvDS07;
        "pkg-4.14.0+forge" = _j6FoyA3b;
        "pkg-4.14.1" = _pkdr7cMc;
        "pkg-4.14.1+forge" = _T44jK8ZS;
        "pkg-4.14.0+1.21.1" = _DQMhaFFo;
        "pkg-4.14.0+1.21.1.forge" = _yWEGQ20S;
        "pkg-4.14.0+1.21.5" = _2a4Jd27B;
        "pkg-4.14.0+1.21.5.forge" = _swAiW7gK;
        "pkg-4.14.0+1.21.1.forge.1" = _O7dfR9NB;
        "pkg-4.14.0+1.21.1.forge.2" = _uMmekm9p;
        "pkg-4.14.2" = _EqcLJylQ;
        "pkg-4.14.2+forge" = _6TW0To9Y;
        "pkg-4.14.0+1.21.1.3" = _zwqbeuzE;
        "pkg-4.14.0+1.21.1.forge.3" = _d6LRqncu;
        "pkg-4.14.0+1.21.1.4" = _y5eBSMkZ;
        "pkg-4.14.0+1.21.1.forge.4" = _zVaOQTh5;
        "pkg-26.1.0" = _rvxfk9Zr;
        "pkg-26.1.2" = _dU7TVFGF;
        "pkg-4.14.3" = _r1EgjrxB;
        "pkg-4.14.3+forge" = _Hfg5KioH;
        "pkg-26.2.0" = _OzLY0sr0;
        "pkg-26.2.1" = _ka2LM4Mw;
        "pkg-26.1.3" = _uxEEozNq;
        "pkg-26.2.2" = _ajKcHatH;
        "pkg-26.3.0" = _Whg3OJJA;
        "default" = _Whg3OJJA;
    });
