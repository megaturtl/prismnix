...
let
    versions = (let
        ...
        _OVqHb2rq = {
            "id" = "OVqHb2rq";
            "file" = "EternalCombat v2.5.2-SNAPSHOT+17.jar";
            "hash" = "sha512-yMfXy1SNjmXCmbI4taudhTeflPVGeLSjJvVjDJHQgy6I+eCcXVM3xyss1cbNROGLvyy7xdmYgZnV5XqslDHw0g==";
        };
        _SSeOnzeb = {
            "id" = "SSeOnzeb";
            "file" = "EternalCombat v2.5.2-SNAPSHOT+18.jar";
            "hash" = "sha512-qJumObudcAA2EEmWhPvMFMTnud0x8oYGK4hG+D6Qt30KkirPnpJI6ZlaKaxm6gNyhs1eZijWdWrBg6BoPp4V3g==";
        };
        _xuz074Z9 = {
            "id" = "xuz074Z9";
            "file" = "EternalCombat v2.5.2-SNAPSHOT+19.jar";
            "hash" = "sha512-eYC5BuOg/9YA7y0jP7yhWTMN/ydfkt/TK8X3nx+7TzRYs0789c7D+44asq33Nu2+UtM3wFqJC13kq/wF1Ymjew==";
        };
        _VeBS7xsZ = {
            "id" = "VeBS7xsZ";
            "file" = "EternalCombat v2.5.2-SNAPSHOT+20.jar";
            "hash" = "sha512-4I28JrMY/FXqLGYlxvhh92Dnx7AlNFf5N3GDTDPJll/9yEMt3OFRPBA1TcrbuQHov4GQi9Wl5V8eABx3anPfWg==";
        };
        _VcQKzNsU = {
            "id" = "VcQKzNsU";
            "file" = "EternalCombat v2.5.2-SNAPSHOT+21.jar";
            "hash" = "sha512-EFEOzPTqbeSq70XyrlKvSdpocQCOoTrwo8Ndaxqmv5AWwiqwp3NJrIfVLtrQmqnoeMzIbDGlMMOnttFi7q/Bdw==";
        };
        _JwSMdnmp = {
            "id" = "JwSMdnmp";
            "file" = "EternalCombat v2.5.2-SNAPSHOT+22.jar";
            "hash" = "sha512-aUMuOoz1wSpI21XvvjppaA7JiWI13XPQ5XOPgR23/VnRradJxLCY642oCrdCucSvfVuVb3uw2JVwTSrBslLwkw==";
        };
        _BKo6jbG2 = {
            "id" = "BKo6jbG2";
            "file" = "EternalCombat v2.5.2-SNAPSHOT+22.jar";
        ...
        _CAj06pAC = {
            "id" = "CAj06pAC";
            "file" = "EternalCombat v2.5.2-SNAPSHOT+23.jar";
            "hash" = "sha512-2GyDGnC7tVtx3BmRJAQ/Hhs5rMO1wIxblQqHHOwhPHjm48WcXv91WSnzmdTmp9QVTlP3/gtw6dSfbtvvkCLZ9Q==";
        };
    in {
        "aB9u7xcy" = _aB9u7xcy;
        "JWUN6aEX" = _JWUN6aEX;
        ...
        "paper-1.19.3" = _CAj06pAC;
        "paper-1.19.4" = _CAj06pAC;
        "paper-1.20" = _CAj06pAC;
        "paper-1.20.1" = _CAj06pAC;
        "paper-1.20.2" = _CAj06pAC;
        "paper-1.20.3" = _bISFpZnG;
        "paper-1.20.4" = _CAj06pAC;
        "paper-1.20.5" = _CAj06pAC;
        "paper-1.20.6" = _CAj06pAC;
        "paper-1.21" = _CAj06pAC;
        "paper-1.21.1" = _CAj06pAC;
        "paper-1.21.2" = _bISFpZnG;
        "paper-1.21.3" = _CAj06pAC;
        "paper-1.21.4" = _CAj06pAC;
        "paper-1.21.5" = _CAj06pAC;
        "paper-1.21.6" = _CAj06pAC;
        "paper-1.21.7" = _CAj06pAC;
        "paper-1.21.8" = _CAj06pAC;
        "paper-1.21.9" = _CAj06pAC;
        "paper-1.21.10" = _CAj06pAC;
        "paper-1.21.11" = _CAj06pAC;
        "paper-26.1.1" = _CAj06pAC;
        "paper-26.1.2" = _CAj06pAC;
        ...
        "purpur-1.19.3" = _CAj06pAC;
        "purpur-1.19.4" = _CAj06pAC;
        "purpur-1.20" = _CAj06pAC;
        "purpur-1.20.1" = _CAj06pAC;
        "purpur-1.20.2" = _CAj06pAC;
        "purpur-1.20.3" = _bISFpZnG;
        "purpur-1.20.4" = _CAj06pAC;
        "purpur-1.20.5" = _CAj06pAC;
        "purpur-1.20.6" = _CAj06pAC;
        "purpur-1.21" = _CAj06pAC;
        "purpur-1.21.1" = _CAj06pAC;
        "purpur-1.21.2" = _bISFpZnG;
        "purpur-1.21.3" = _CAj06pAC;
        "purpur-1.21.4" = _CAj06pAC;
        "purpur-1.21.5" = _CAj06pAC;
        "purpur-1.21.6" = _CAj06pAC;
        "purpur-1.21.7" = _CAj06pAC;
        "purpur-1.21.8" = _CAj06pAC;
        "purpur-1.21.9" = _CAj06pAC;
        "purpur-1.21.10" = _CAj06pAC;
        "purpur-1.21.11" = _CAj06pAC;
        "purpur-26.1.1" = _CAj06pAC;
        "purpur-26.1.2" = _CAj06pAC;
        ...
        "folia-1.19.3" = _CAj06pAC;
        "folia-1.19.4" = _CAj06pAC;
        "folia-1.20" = _CAj06pAC;
        "folia-1.20.1" = _CAj06pAC;
        "folia-1.20.2" = _CAj06pAC;
        "folia-1.20.3" = _bISFpZnG;
        "folia-1.20.4" = _CAj06pAC;
        "folia-1.20.5" = _CAj06pAC;
        "folia-1.20.6" = _CAj06pAC;
        "folia-1.21" = _CAj06pAC;
        "folia-1.21.1" = _CAj06pAC;
        "folia-1.21.2" = _bISFpZnG;
        "folia-1.21.3" = _CAj06pAC;
        "folia-1.21.4" = _CAj06pAC;
        "folia-1.21.5" = _CAj06pAC;
        "folia-1.21.6" = _CAj06pAC;
        "folia-1.21.7" = _CAj06pAC;
        "folia-1.21.8" = _CAj06pAC;
        "folia-1.21.9" = _CAj06pAC;
        "folia-1.21.10" = _CAj06pAC;
        "folia-1.21.11" = _CAj06pAC;
        "folia-26.1.1" = _CAj06pAC;
        "folia-26.1.2" = _CAj06pAC;
        "folia-26.1" = _bISFpZnG;
        "pkg-1.0.2" = _aB9u7xcy;
        "pkg-v1.0.3" = _JWUN6aEX;
        "pkg-1.1.0" = _DmRbZSgc;
        "pkg-v1.1.1" = _sV2IXNhz;
        "pkg-1.2.0" = _zqrYaKfD;
        "pkg-1.2.1" = _MAPHHfc9;
        "pkg-1.2.2" = _UOfkmBkR;
        "pkg-1.3.0" = _qTRWdajY;
        ...
        "pkg-2.2.0" = _WKvBmtcC;
        "pkg-2.3.0" = _mPMAEHnw;
        "pkg-2.3.0-SNAPSHOT+3" = _LzQ0Yq0Q;
        "pkg-2.4.0-SNAPSHOT+13" = _kODfG0vV;
        "pkg-2.4.0-SNAPSHOT+14" = _WyPoUaF6;
        "pkg-2.4.0-SNAPSHOT+16" = _I7fr873E;
        "pkg-2.4.0-SNAPSHOT+17" = _PcSCxk3z;
        "pkg-2.4.0-SNAPSHOT+18" = _E0wqtwHO;
        "pkg-2.4.0-SNAPSHOT+19" = _sVsf6Xfy;
        "pkg-2.4.0-SNAPSHOT+20" = _uzfipekH;
        "pkg-2.4.0-SNAPSHOT+22" = _FjWb9LNx;
        "pkg-2.4.0-SNAPSHOT+21" = _FgCsNQXU;
        "pkg-2.4.0-SNAPSHOT+24" = _24LrwOQ9;
        "pkg-2.4.0-SNAPSHOT+23" = _Lh5bPbVe;
        "pkg-2.4.0-SNAPSHOT+25" = _crIuhGiu;
        "pkg-2.4.0-SNAPSHOT+26" = _4DDNPH4j;
        "pkg-2.4.0-SNAPSHOT+27" = _iqWzcs9P;
        "pkg-2.4.0-SNAPSHOT+28" = _guOFTFwP;
        "pkg-2.4.0-SNAPSHOT+29" = _sBfOIv5N;
        "pkg-2.4.0-SNAPSHOT+31" = _IlkvhbM4;
        "pkg-2.4.0-SNAPSHOT+30" = _JkevBLrQ;
        "pkg-2.4.0-SNAPSHOT+32" = _NC093fdG;
        "pkg-2.4.0-SNAPSHOT+33" = _oBMYm2xY;
        "pkg-2.4.0-SNAPSHOT+34" = _pXxGzetZ;
        "pkg-2.4.0-SNAPSHOT+36" = _F7CNUPjw;
        "pkg-2.4.0-SNAPSHOT+35" = _aHfq0fUi;
        "pkg-2.4.0-SNAPSHOT+37" = _kMxANrzP;
        "pkg-2.4.0-SNAPSHOT+38" = _gQF5HD9S;
        "pkg-2.4.0-SNAPSHOT+40" = _o1m3aHoY;
        "pkg-2.4.0-SNAPSHOT+39" = _E65YBXVX;
        "pkg-2.4.0-SNAPSHOT+41" = _PPh8Jqfb;
        "pkg-2.4.0" = _B0987lDS;
        "pkg-2.5.0-SNAPSHOT+1" = _H7EBJ8v8;
        "pkg-2.5.0-SNAPSHOT+2" = _iB2Z6TQX;
        "pkg-2.5.0-SNAPSHOT+3" = _pAbS3pzU;
        "pkg-2.4.1-SNAPSHOT+4" = _p6dWHiBH;
        "pkg-2.4.1" = _1jzkPFQH;
        "pkg-2.4.1-SNAPSHOT+1" = _52uF6A9M;
        "pkg-2.5.0-SNAPSHOT+4" = _Hc1OGkHo;
        "pkg-2.5.0-SNAPSHOT+8" = _TwBtaKIL;
        "pkg-2.5.0-SNAPSHOT+9" = _Vrv15sut;
        "pkg-2.5.0-SNAPSHOT+10" = _aVSzi2uZ;
        "pkg-2.5.0-SNAPSHOT+11" = _X4mAbJR7;
        "pkg-2.5.0-SNAPSHOT+12" = _ikMqTjzL;
        "pkg-2.5.0-SNAPSHOT+13" = _Plp1JCtl;
        "pkg-2.5.0-SNAPSHOT+14" = _BMe3ePBa;
        "pkg-2.5.0-SNAPSHOT+15" = _22xQbYIg;
        "pkg-2.5.0-SNAPSHOT+16" = _Ny7PJwb6;
        "pkg-2.5.0-SNAPSHOT+17" = _S80Xuemb;
        "pkg-2.5.0-SNAPSHOT+18" = _bVDG3XOm;
        "pkg-2.5.0-SNAPSHOT+19" = _TqjBZW2Y;
        "pkg-2.5.0-SNAPSHOT+20" = _7uOYjAYo;
        "pkg-2.5.0-SNAPSHOT+21" = _3IXMRfbk;
        "pkg-2.5.0-SNAPSHOT+22" = _fVSAqhpY;
        "pkg-2.5.0-SNAPSHOT+23" = _140UaFb1;
        "pkg-2.5.0-SNAPSHOT+24" = _PwbvGij1;
        "pkg-2.5.0-SNAPSHOT+25" = _CxFiEDb2;
        "pkg-2.5.0-SNAPSHOT+26" = _MoA1ryJc;
        "pkg-2.5.0-SNAPSHOT+27" = _NAOAkBs1;
        "pkg-2.5.0-SNAPSHOT+28" = _2HBqtG6U;
        "pkg-2.5.0-SNAPSHOT+29" = _SVMLFvJd;
        "pkg-2.5.0-SNAPSHOT+30" = _gJuMWpiA;
        "pkg-2.5.0-SNAPSHOT+32" = _eLbwmIcg;
        "pkg-2.5.0-SNAPSHOT+31" = _bAp1eeMD;
        "pkg-2.5.0-SNAPSHOT+33" = _raK0FYd2;
        "pkg-2.5.0-SNAPSHOT+34" = _vupfcBkp;
        "pkg-2.5.0-SNAPSHOT+35" = _btWCOtdj;
        "pkg-2.5.0-SNAPSHOT+36" = _b7uxO2c2;
        "pkg-2.5.0-SNAPSHOT+37" = _m4I7JyRE;
        "pkg-2.5.0-SNAPSHOT+39" = _a5tNGnCm;
        "pkg-2.5.0-SNAPSHOT+38" = _kgMnazNP;
        "pkg-2.5.0-SNAPSHOT+40" = _1ofLLCxB;
        "pkg-2.5.0-SNAPSHOT+41" = _R5CrpcGV;
        "pkg-2.5.0-SNAPSHOT+42" = _GexVo1cg;
        "pkg-2.5.0-SNAPSHOT+43" = _g5QUpoTJ;
        "pkg-2.5.0-SNAPSHOT+44" = _wJ0mWBNa;
        "pkg-2.5.0-SNAPSHOT+45" = _PKl6BvD6;
        "pkg-2.5.0-SNAPSHOT+46" = _TxQTnDkk;
        "pkg-2.5.0-SNAPSHOT+47" = _QXARJnZN;
        "pkg-2.5.0-SNAPSHOT+48" = _IbiLlJlg;
        "pkg-2.5.0-SNAPSHOT+49" = _P8lGTp2k;
        "pkg-2.5.0-SNAPSHOT+50" = _BkM34JGS;
        "pkg-2.5.0-SNAPSHOT+51" = _S12DYSMt;
        "pkg-2.5.0-SNAPSHOT+52" = _TIMJoJIF;
        "pkg-2.5.0-SNAPSHOT+53" = _wdu5mSAO;
        "pkg-2.5.0" = _udbwOayq;
        "pkg-2.5.1-SNAPSHOT+2" = _Bg17HVm8;
        "pkg-2.5.1-SNAPSHOT+3" = _lOLCOhum;
        "pkg-2.5.1-SNAPSHOT+4" = _K7Bi5lL4;
        "pkg-2.5.1-SNAPSHOT+5" = _gULbgwoy;
        "pkg-2.5.1" = _bISFpZnG;
        "pkg-2.5.2-SNAPSHOT+1" = _XSYSFeFl;
        "pkg-2.5.2-SNAPSHOT+2" = _QpjXPH68;
        "pkg-2.5.2-SNAPSHOT+3" = _ApVytDMQ;
        "pkg-2.5.2-SNAPSHOT+4" = _aIZ6l0lW;
        "pkg-2.5.2-SNAPSHOT+5" = _7BBuAyI6;
        "pkg-2.5.2-SNAPSHOT+6" = _DmQQtzWp;
        "pkg-2.5.2-SNAPSHOT+7" = _dZNio4e2;
        "pkg-2.5.2-SNAPSHOT+8" = _cHeHR3PM;
        "pkg-2.5.2-SNAPSHOT+10" = _tOMyeavw;
        "pkg-2.5.2-SNAPSHOT+9" = _r7fmQaDC;
        "pkg-2.5.2-SNAPSHOT+11" = _MSMnDn6A;
        "pkg-2.5.2-SNAPSHOT+12" = _Y6tANzOK;
        "pkg-2.5.2-SNAPSHOT+13" = _vVetFeQv;
        "pkg-2.5.2-SNAPSHOT+14" = _P4gkIPVK;
        "pkg-2.5.2-SNAPSHOT+15" = _K4NAUulm;
        "pkg-2.5.2-SNAPSHOT+16" = _OxS8Sle8;
        "pkg-2.5.2-SNAPSHOT+17" = _OVqHb2rq;
        "pkg-2.5.2-SNAPSHOT+18" = _SSeOnzeb;
        "pkg-2.5.2-SNAPSHOT+19" = _xuz074Z9;
        "pkg-2.5.2-SNAPSHOT+20" = _VeBS7xsZ;
        "pkg-2.5.2-SNAPSHOT+21" = _VcQKzNsU;
        "pkg-2.5.2-SNAPSHOT+22" = _BKo6jbG2;
        "pkg-2.5.2-SNAPSHOT+23" = _CAj06pAC;
        "default" = _CAj06pAC;
    });
