...
let
    versions = (let
        ...
        _PD8m9X7q = {
            "id" = "PD8m9X7q";
            "file" = "ModdedCoffeeGUI_Release_v1.15.2.zip";
            "hash" = "sha512-FzSxNiuOB53txDioB6yVg4YyixIjE5IQnsUCmBUC7F6CtyDIh3qpFWl0st9Fw4Scx10Brq6aL6Ed6rmRgZjSOg==";
        };
        _U4oPqOuj = {
            "id" = "U4oPqOuj";
            "file" = "ModdedCoffeeGUI_Release_v1.16.0.zip";
            "hash" = "sha512-a7Bt7vYu+oTUYXzGgvOXS+Wtcp0Hs2vViU911QY1BEOjTgEHhwsqutttCpI8cIS4Tnb+rO5J1Lub5PbkNlVuiw==";
        };
    in {
        "ogi2PYOX" = _ogi2PYOX;
        "6zzV3arP" = _6zzV3arP;
        ...
        "PD8m9X7q" = _PD8m9X7q;
        "U4oPqOuj" = _U4oPqOuj;
        "minecraft-1.12" = _U4oPqOuj;
        "minecraft-1.12.1" = _U4oPqOuj;
        "minecraft-1.12.2" = _U4oPqOuj;
        "minecraft-1.20" = _U4oPqOuj;
        "minecraft-1.20.1" = _U4oPqOuj;
        "minecraft-1.20.2" = _U4oPqOuj;
        "minecraft-1.20.3" = _U4oPqOuj;
        "minecraft-1.20.4" = _U4oPqOuj;
        "minecraft-1.20.5" = _U4oPqOuj;
        "minecraft-1.20.6" = _U4oPqOuj;
        "minecraft-1.21" = _U4oPqOuj;
        "minecraft-1.21.1" = _U4oPqOuj;
        "minecraft-1.21.2" = _U4oPqOuj;
        "minecraft-1.21.3" = _U4oPqOuj;
        "minecraft-1.21.4" = _U4oPqOuj;
        "minecraft-1.21.5" = _U4oPqOuj;
        "minecraft-1.21.6" = _U4oPqOuj;
        "minecraft-1.21.7" = _U4oPqOuj;
        "minecraft-1.21.8" = _U4oPqOuj;
        "minecraft-1.21.9" = _U4oPqOuj;
        "minecraft-1.21.10" = _U4oPqOuj;
        "minecraft-1.21.11" = _U4oPqOuj;
        "minecraft-1.21.2-pre1" = _ixO9IHmf;
        "minecraft-1.21.2-pre2" = _ixO9IHmf;
        "minecraft-1.13" = _U4oPqOuj;
        "minecraft-1.13.1" = _U4oPqOuj;
        "minecraft-1.13.2" = _U4oPqOuj;
        "minecraft-1.14" = _U4oPqOuj;
        "minecraft-1.14.1" = _U4oPqOuj;
        "minecraft-1.14.2" = _U4oPqOuj;
        "minecraft-1.14.3" = _U4oPqOuj;
        "minecraft-1.14.4" = _U4oPqOuj;
        "minecraft-1.15" = _U4oPqOuj;
        "minecraft-1.15.1" = _U4oPqOuj;
        "minecraft-1.15.2" = _U4oPqOuj;
        "minecraft-1.16" = _U4oPqOuj;
        "minecraft-1.16.1" = _U4oPqOuj;
        "minecraft-1.16.2" = _U4oPqOuj;
        "minecraft-1.16.3" = _U4oPqOuj;
        "minecraft-1.16.4" = _U4oPqOuj;
        "minecraft-1.16.5" = _U4oPqOuj;
        "minecraft-1.17" = _U4oPqOuj;
        "minecraft-1.17.1" = _U4oPqOuj;
        "minecraft-1.18" = _U4oPqOuj;
        "minecraft-1.18.1" = _U4oPqOuj;
        "minecraft-1.18.2" = _U4oPqOuj;
        "minecraft-1.19" = _U4oPqOuj;
        "minecraft-1.19.1" = _U4oPqOuj;
        "minecraft-1.19.2" = _U4oPqOuj;
        "minecraft-1.19.3" = _U4oPqOuj;
        "minecraft-1.19.4" = _U4oPqOuj;
        "minecraft-26.1" = _U4oPqOuj;
        "minecraft-26.1.1" = _U4oPqOuj;
        "minecraft-26.1.2" = _U4oPqOuj;
        "minecraft-26.2" = _U4oPqOuj;
        "pkg-1.0.0" = _ogi2PYOX;
        "pkg-1.0.1" = _6zzV3arP;
        "pkg-1.0.2" = _VfCXV14l;
        "pkg-1.0.3" = _D1PmXk2P;
        ...
        "pkg-1.15.2" = _PD8m9X7q;
        "pkg-1.16.0" = _U4oPqOuj;
        "default" = _U4oPqOuj;
    });
