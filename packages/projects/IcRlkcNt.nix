...
let
    versions = (let
        ...
        _ZRCXctKQ = {
            "id" = "ZRCXctKQ";
            "file" = "City Texture Pack.zip";
            "hash" = "sha512-vUPGy6X7NUugVE4hs7I8/2ftuOzEs/uOJI1fzymVqLV7c8xS+AwHUqorgzmtFDZdPRHkYH8ZIoU9tOBIbyIShw==";
        };
    in {
        "9agN5Ld4" = _9agN5Ld4;
        "mz7GO5r6" = _mz7GO5r6;
        ...
        "nPKe1P1i" = _nPKe1P1i;
        "ZRCXctKQ" = _ZRCXctKQ;
        "minecraft-1.20.4" = _ZRCXctKQ;
        "minecraft-1.20.5" = _ZRCXctKQ;
        "minecraft-1.20.6" = _ZRCXctKQ;
        "minecraft-1.21" = _ZRCXctKQ;
        "minecraft-1.21.1" = _ZRCXctKQ;
        "minecraft-1.21.2" = _ZRCXctKQ;
        "minecraft-1.21.3" = _ZRCXctKQ;
        "minecraft-1.20.3" = _ZRCXctKQ;
        "minecraft-1.21.4" = _ZRCXctKQ;
        "minecraft-1.21.5" = _ZRCXctKQ;
        "minecraft-1.21.6" = _ZRCXctKQ;
        "minecraft-1.21.7" = _ZRCXctKQ;
        "minecraft-1.21.8" = _ZRCXctKQ;
        "minecraft-1.21.9" = _ZRCXctKQ;
        "minecraft-1.21.10" = _ZRCXctKQ;
        "minecraft-1.21.11" = _ZRCXctKQ;
        "minecraft-1.20.2" = _ZRCXctKQ;
        "minecraft-26.1" = _ZRCXctKQ;
        "minecraft-26.1.1" = _ZRCXctKQ;
        "minecraft-26.1.2" = _ZRCXctKQ;
        "minecraft-26.2" = _ZRCXctKQ;
        "pkg-0.1.0" = _9agN5Ld4;
        "pkg-1.0.0" = _mz7GO5r6;
        "pkg-1.0.1" = _7TSak9Rz;
        "pkg-1.0.2" = _sAfkRLlN;
        ...
        "pkg-1.0.8" = _cXzDVWWj;
        "pkg-1.0.9" = _gg9OXysC;
        "pkg-1.0.10" = _7JQGtUDo;
        "pkg-1.0.11" = _F60FIlK4;
        "pkg-1.0.12" = _Q6Jhj493;
        "pkg-1.0.13" = _yODdnPw4;
        "pkg-1.0.14" = _rY5gpgRa;
        "pkg-1.0.15" = _I1UhD6DR;
        "pkg-1.0.16" = _Hr5AbtbS;
        "pkg-1.0.17" = _nPKe1P1i;
        "pkg-1.0.18" = _ZRCXctKQ;
        "default" = _ZRCXctKQ;
    });
