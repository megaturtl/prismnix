...
let
    ...
    in {
        ...
        "pkg-1.1.3" = _ki6fSsh4;
        "pkg-1.1.4" = _Ec2kjlCi;
        "pkg-2.0.0+1.21.1" = _SuESXVWB;
        "pkg-2.0.1+1.21.1" = _UT7Y7ANl;
        "pkg-2.0.2+1.21.1" = _URwPkdsk;
        "pkg-2.0.3+1.21.1" = _Wzdg3yHD;
        "pkg-1.1.4+1.20.1" = _cDsVdQar;
        "pkg-2.0.4+1.21.1" = _mW3mXZ1b;
        "pkg-2.0.5+1.21.1" = _xRxRRw6E;
        "pkg-2.0.6+1.21.1" = _mpwG7Qdo;
        "pkg-2.0.7+1.21.5" = _w0QNcY7h;
        "pkg-2.0.8+1.21.1" = _lGh8GEC3;
        "pkg-2.0.9+1.21.10" = _41uVi8WM;
        "pkg-2.0.10+1.21.10" = _pxMY1IJ1;
        "pkg-2.0.11+1.21.11" = _umk88xOI;
        "pkg-2.1.0+1.21.1" = _5brYEt41;
        "pkg-2.1.0+1.21.11" = _IpBEELKK;
        "pkg-2.2.0+26.1" = _UyUQxGwd;
        "pkg-2.3.0+26.1.x" = _u68Yt4ok;
        "pkg-2.3.1+26.1.x" = _WoPjP025;
        "pkg-2.3.2+26.1.x" = _ro2z7to0;
        "pkg-2.4.0+26.1.x" = _c5V2FI0w;
        "pkg-2.4.1+26.1.x" = _elFHQnEZ;
        "pkg-2.2.0+1.21.1" = _H7WdlWBp;
        "pkg-2.5.0+26.1.x" = _Yh4Fg2AG;
        "pkg-2.5.1+26.1.x" = _q46UPVgR;
        "pkg-2.2.1+1.21.1" = _eBtcEIAY;
        "pkg-2.3.0+1.21.1" = _sTUvmQJC;
