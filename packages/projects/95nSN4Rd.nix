...
let
    versions = (let
        ...
        _GjW1pOn6 = {
            "id" = "GjW1pOn6";
            "file" = "bagus_lib-26.2-27.3.0.jar";
            "hash" = "sha512-L8ogcNO5XIZMXnQ3J177jzbjRWjdj+K/x7SghdwiiqMg0x+EBI5rAlvqnJ1Zc+CXMJ3jmz63m4JmvmBjonGJwQ==";
        };
        _4AgdrGMw = {
            "id" = "4AgdrGMw";
            "file" = "bagus_lib-26.2-27.4.0.jar";
            "hash" = "sha512-Vv/GYpLbX8BryccPch1+Sq/BmTArV2G0YEHEFgq9HVrxxPSulSlOGVzFxiQeGWgE3qNHjPevd2/5OQ8JYJni+Q==";
        };
        _ZBBXH7kf = {
            "id" = "ZBBXH7kf";
            "file" = "bagus_lib-26.2-27.5.0.jar";
            "hash" = "sha512-4OZtr4fPgQyDFN/XGJ+H3suOSDV09EkwPlaaRzUbqsM4dVf6xy6LqhSvumsNzmyKBX0XEXKL7h/5AlxMNyeA2A==";
        };
        _FtjDZ9z9 = {
            "id" = "FtjDZ9z9";
            "file" = "bagus_lib-26.2-27.6.0.jar";
            "hash" = "sha512-sIRA1G9npn0yTv/65Stu9ONnltq2LbX4H2zD3spZIUSygfRLfieZiqYUrtkyLjopgJnWjMDoq2HeT1vG7ye0aw==";
        };
        _1o20n8gM = {
            "id" = "1o20n8gM";
            "file" = "bagus_lib-1.21.1-13.26.0.jar";
            "hash" = "sha512-0M1/8FkSf6CGrmlDirmjD+fCxuRkq2d5yTSkuWifQeOx796OEDkpcas3EuyaGMzEoKhd32Hq+RehYSd1eN0itg==";
        };
        _eOOdpCgK = {
            "id" = "eOOdpCgK";
            "file" = "bagus_lib-26.1.2-26.5.0.jar";
            "hash" = "sha512-+JYFaPJ0/3oBVrt6AEcKRU3jJPZWE+kk3k3Buv9m6AYFo8KkrMMkipQnwJcLse6MwSK1oUXze7KsaBbvt2mqYw==";
        };
        _i2gAtgcj = {
            "id" = "i2gAtgcj";
    ...
    in {
        ...
        "pkg-1.20-2.0.0" = _WA0pkhsa;
        "pkg-1.20-2.0.1" = _9e0xLP7V;
        "pkg-1.20.1-2.0.1" = _5cz26lLK;
        "pkg-1.20.1-2.1.0" = _AHzrgpM6;
        "pkg-1.20.1-2.2.0" = _9lz86bAh;
        "pkg-1.20.1-2.3.0" = _U6g9P1V3;
        "pkg-1.20.1-3.0.0" = _8hQ1BajI;
        "pkg-1.20.1-3.0.1" = _RhxQlg1b;
        "pkg-1.20.1-3.1.0" = _h04XJCJO;
        "pkg-1.20.1-3.2.0" = _IpLbYrfv;
        "pkg-1.20.1-3.2.1" = _QWI7tMBw;
        "pkg-1.20.1-3.2.2" = _In1X7Smt;
        "pkg-1.20.1-3.2.3" = _Q3ToBEyu;
        "pkg-1.20.1-3.3.0" = _Tm3VSDSZ;
        "pkg-1.20.1-3.4.0" = _FAZXCHnT;
        "pkg-1.19.2-3.4.0" = _1yvXCFlm;
        "pkg-1.19.2-3.4.1" = _U5ijPjaR;
        "pkg-1.20.1-3.4.1" = _g2NK9Lj8;
        "pkg-1.20.1-3.5.0" = _MLz0pwad;
        "pkg-1.20.1-3.5.1" = _oH7QUXgb;
        "pkg-1.20.1-3.5.2" = _VoKQ0az0;
        "pkg-1.20.1-4.0.0" = _GVlOJDPt;
        "pkg-1.18.2-3.4.1" = _k0YTmCTo;
        "pkg-1.20.2-5.0.0" = _OUFX1icz;
        "pkg-1.20.2-5.0.1" = _SPihYPP6;
        "pkg-1.20.2-5.0.2" = _pWf5GbLS;
        "pkg-1.20.2-5.1.0" = _fGwzvymy;
        "pkg-1.18.2-3.5.0" = _btFDET9M;
        "pkg-1.20.1-4.0.1" = _OO4AvylY;
        "pkg-1.20.2-5.1.1" = _w6toeQzP;
        "pkg-1.20.2-5.1.2" = _hvTR2Hi9;
        "pkg-1.20.1-4.0.2" = _pOWJah3s;
        "pkg-1.20.1-4.0.3" = _UJeUSKNu;
        "pkg-1.20.2-5.1.3" = _vFHyPlpf;
        "pkg-1.19.2-3.4.2" = _lPESm8uF;
        "pkg-1.20.2-5.1.4" = _TqXcNvf4;
        "pkg-1.20.2-6.0.0" = _N4DDahjM;
        "pkg-1.20.2-6.0.1" = _4q5vUbsU;
        "pkg-1.20.2-6.1.0" = _bQlBIWWC;
        "pkg-1.20.2-6.2.0" = _SudE3i0S;
        "pkg-1.20.2-6.3.0" = _6agn224P;
        "pkg-1.20.1-4.1.0" = _V1HSql7g;
        "pkg-1.19.2-3.5.0" = _Kyb9wYup;
        "pkg-1.18.2-3.6.0" = _bVYMZC04;
        "pkg-1.20.1-4.1.1" = _AOBYkaeL;
        "pkg-1.19.2-3.5.1" = _gZCrOhFY;
        "pkg-1.18.2-3.6.1" = _kphZTVeN;
        "pkg-1.20.2-6.4.0" = _isthXDht;
        "pkg-1.20.1-4.2.0" = _qQNBlJK9;
        "pkg-1.20.1-4.2.1" = _xPwP0iAz;
        "pkg-1.20.2-6.4.1" = _bDhOnWSJ;
        "pkg-1.20.3-7.0.0" = _4PNpeegM;
        "pkg-1.20.4-8.0.0" = _5yIX1xCA;
        "pkg-1.20.4-8.0.1" = _78MmWNAV;
        "pkg-1.20.4-8.1.0" = _ESmgjqhh;
        "pkg-1.20.4-8.1.1" = _7dvqCFT8;
        "pkg-1.20.1-4.3.0" = _US8QuRV4;
        "pkg-1.19.2-3.6.0" = _Qiw9t3HU;
        "pkg-1.20.4-8.2.0" = _WCJon8V9;
        "pkg-1.20.4-8.3.0" = _lh0a4ut1;
        "pkg-1.20.4-8.3.1" = _dmv6yNu3;
        "pkg-1.20.4-8.4.0" = _oTM2W3t5;
        "pkg-1.20.4-8.5.0" = _DoWlgQU0;
        "pkg-1.20.4-8.5.1" = _yOHiNRMD;
        "pkg-1.20.1-4.4.0" = _lO7DQFhn;
        "pkg-1.20.4-8.6.0" = _5kdcbcXl;
        "pkg-1.20.4-8.7.0" = _FQMgNOPz;
        "pkg-1.20.1-4.5.0" = _6L36OMYC;
        "pkg-1.20.1-4.5.3" = _Rdx5O7go;
        "pkg-1.20.4-8.7.3" = _oCPZEawh;
        "pkg-1.20.1-4.5.4" = _ijOIOXrc;
        "pkg-1.20.4-8.7.4" = _Gu1Z2uzS;
        "pkg-1.20.4-8.8.0" = _9I13zbQ8;
        "pkg-1.20.4-8.8.1" = _kYbZTNiy;
        "pkg-1.20.4-8.8.2" = _K4CDj1Ao;
        "pkg-1.20.1-4.6.0" = _ZbUcUgHX;
        "pkg-1.20.5-9.0.0" = _wEQLQgfc;
        "pkg-1.20.5-9.0.1" = _PFAWynwW;
        "pkg-1.20.6-10.0.0" = _zBCmWpcM;
        "pkg-1.20.6-10.0.1" = _7jTJMU7h;
        "pkg-1.20.6-10.0.2" = _qndeG2AN;
        "pkg-1.20.6-10.1.0" = _6vtyctFy;
        "pkg-1.21-11.0.0" = _fU8WqsJz;
        "pkg-1.21-11.0.1" = _6KMqXbaI;
        "pkg-1.21-11.1.0" = _NDAUqgnq;
        "pkg-1.21-11.2.0" = _acZH8NOg;
        "pkg-1.21-12.0.0" = _ncCrnVL3;
        "pkg-1.21-12.0.1" = _3yaB2Llo;
        "pkg-1.20.1-5.0.0" = _sPjhgAfJ;
        "pkg-1.21-12.1.0" = _uRWMiK66;
        "pkg-1.21-12.2.0" = _dF7DVKlh;
        "pkg-1.20.1-5.1.0" = _9nYFZJ60;
        "pkg-1.21-12.3.0" = _nwtM7LRk;
        "pkg-1.20.1-5.1.1" = _1A49w54C;
        "pkg-1.20.1-5.1.2" = _17RdzTAm;
        "pkg-1.20.1-5.2.0" = _Qa9B89Ej;
        "pkg-1.21-12.4.0" = _nTJvBrkH;
        "pkg-1.20.1-5.2.1" = _RyGovpkv;
        "pkg-1.20.1-5.2.2" = _Hacofry6;
        "pkg-1.21-12.4.1" = _gnUWpi8q;
        "pkg-1.21-12.5.0" = _dmNrdHcG;
        "pkg-1.21.1-13.0.0" = _HIdHWHMX;
        "pkg-1.21.1-13.0.1" = _QUza16zh;
        "pkg-1.20.1-5.2.3" = _ApDvKoZZ;
        "pkg-1.21.1-13.0.2" = _jPgBBMCV;
        "pkg-1.21.1-13.1.0" = _tFqqRJwj;
        "pkg-1.21.1-13.2.0" = _9n0xrKVD;
        "pkg-1.21.1-13.2.1" = _BlOkqRG5;
        "pkg-1.21.1-13.3.0" = _YBn2bvxZ;
        "pkg-1.20.1-5.3.0" = _VU7aEpro;
        "pkg-1.21.1-13.4.0" = _iDein2RP;
        "pkg-1.21.1-13.4.1" = _ybM1x16R;
        "pkg-1.21.1-13.5.0" = _Yg62m2qz;
        "pkg-1.21.2-14.0.0" = _wYp1mtQ1;
        "pkg-1.21.3-14.0.0" = _aUleO9dJ;
        "pkg-1.21.3-14.0.1" = _n86s4HRw;
        "pkg-1.21.3-14.0.2" = _3MGWep06;
        "pkg-1.21.4-15.0.0" = _MoDVww1D;
        "pkg-1.21.4-15.0.1" = _Auk1aaEF;
        "pkg-1.21.4-15.0.2" = _PwGgPfEZ;
        "pkg-1.21.4-15.0.3" = _USmbpPSH;
        "pkg-1.21.4-15.1.0" = _xUAFRL0q;
        "pkg-1.21.4-15.1.1" = _rvyeX0I4;
        "pkg-1.21.4-15.2.0" = _fel1J4iO;
        "pkg-1.21.1-13.6.0" = _UsnqBVx4;
        "pkg-1.21.4-15.3.0" = _3CUUswNK;
        "pkg-1.21.4-15.4.0" = _cJK6ZBcF;
        "pkg-1.21.1-13.7.0" = _BNGXuc9G;
        "pkg-1.21.4-15.5.0" = _YFUWW97d;
        "pkg-1.21.4-15.6.0" = _W7zRs4FT;
        "pkg-1.21.4-15.6.1" = _IR6hTDAh;
        "pkg-1.21.4-15.7.0" = _XB7Zik2X;
        "pkg-1.21.1-13.7.1" = _XJlhh50p;
        "pkg-1.21.4-15.7.1" = _heSWxDrv;
        "pkg-1.21.1-13.8.0" = _8kmdKZ8b;
        "pkg-1.21.4-15.8.0" = _1h4TfzOX;
        "pkg-1.21.1-13.8.1" = _rlfsX38Y;
        "pkg-1.21.4-15.8.1" = _oOV0wOPV;
        "pkg-1.21.4-15.9.0" = _dhx7mq3V;
        "pkg-1.21.4-15.9.1" = _mLNYXtFB;
        "pkg-1.21.4-15.9.2" = _BbHf7e38;
        "pkg-1.21.1-13.8.2" = _ma5c5DRx;
        "pkg-1.21.4-15.9.3" = _oKp5kaqx;
        "pkg-1.21.5-16.0.0" = _BfhZbzFd;
        "pkg-1.21.5-16.0.1" = _HgJ9oX7R;
        "pkg-1.21.5-16.0.2" = _1WTKUE6s;
        "pkg-1.21.1-13.9.0" = _O5eQsxE5;
        "pkg-1.21.5-16.1.0" = _VZkTCegI;
        "pkg-1.21.1-13.10.0" = _gh79xi1t;
        "pkg-1.21.5-16.2.0" = _oz9BLYqh;
        "pkg-1.21.1-13.11.0" = _h302r6bx;
        "pkg-1.21.5-16.3.0" = _tlc0R7VI;
        "pkg-1.21.1-13.12.0" = _7k5lHuDM;
        "pkg-1.21.1-13.13.0" = _OlKOhCXf;
        "pkg-1.21.5-16.4.0" = _Dl9aWsq8;
        "pkg-1.21.1-13.14.0" = _LqLzWIeR;
        "pkg-1.21.5-16.5.0" = _aHGX08bK;
        "pkg-1.21.1-13.15.0" = _e5IoYWB0;
        "pkg-1.21.5-16.6.0" = _OGwg04Nh;
        "pkg-1.21.5-16.7.0" = _ciCITxw0;
        "pkg-1.21.5-16.8.0" = _BBIkto78;
        "pkg-1.21.5-16.8.1" = _KGtqUe6V;
        "pkg-1.21.1-13.16.0" = _UgsjMsS2;
        "pkg-1.21.5-16.8.2" = _RyHWkpDT;
        "pkg-1.21.1-13.17.0" = _YaFpJQ3O;
        "pkg-1.21.5-16.9.0" = _u56Xkcmx;
        "pkg-1.21.6-17.0.0" = _zhQu6CnI;
        "pkg-1.21.6-17.0.1" = _4dum69po;
        "pkg-1.20.1-5.4.0" = _uoaNU9Ph;
        "pkg-1.21.1-13.18.0" = _cnQ0kf6B;
        "pkg-1.21.7-18.0.0" = _9Zt7VWGK;
        "pkg-1.21.7-18.0.1" = _vjX8mhQj;
        "pkg-1.21.7-18.0.2" = _2i4kFKZG;
        "pkg-1.21.7-18.0.3" = _HfrH4lCD;
        "pkg-1.21.7-18.0.4" = _expZrwDy;
        "pkg-1.21.1-13.18.1" = _japsBCPm;
        "pkg-1.21.8-19.0.0" = _lEfgnQ5G;
        "pkg-1.21.8-19.0.1" = _DPQ7Hf7T;
        "pkg-1.21.8-19.1.0" = _fLlUWLm3;
        "pkg-1.20.1-5.5.0" = _vYB5tq69;
        "pkg-1.20.1-5.6.0" = _wWY7QH4E;
        "pkg-1.20.1-5.6.1" = _EutpppUn;
        "pkg-1.21.9-20.0.0" = _BTOQdpvN;
        "pkg-1.21.10-21.0.0" = _Ea71oeYB;
        "pkg-1.21.10-21.0.1" = _4uAMn0lX;
        "pkg-1.21.10-21.0.2" = _slEgYI66;
        "pkg-1.21.10-21.1.0" = _dlWaCS6t;
        "pkg-1.21.10-21.3.0" = _UlBAskx2;
        "pkg-1.21.10-21.4.0" = _nMRfhuI5;
        "pkg-1.21.1-13.19.0" = _Uwb8apA8;
        "pkg-1.21.11-22.0.0" = _pU7wyIsj;
        "pkg-1.21.1-13.20.0" = _Rdi09WEv;
        "pkg-1.21.1-13.20.1" = _yCKbneng;
        "pkg-1.21.11-22.1.0" = _Q43Q6cJq;
        "pkg-1.21.11-22.2.0" = _ZaS3gecM;
        "pkg-1.21.11-22.3.0" = _fIPGfstI;
        "pkg-1.21.11-22.3.1" = _orwElp9v;
        "pkg-1.21.1-13.20.2" = _9iQ073UV;
        "pkg-26.1-snapshot-1-24.0.0" = _nxX5CCqK;
        "pkg-1.21.1-13.21.0" = _aClDlLMB;
        "pkg-1.21.11-22.4.0" = _KdqbK9nH;
        "pkg-26.1-snapshot-1-24.1.0" = _Bdw5AWjP;
        "pkg-1.21.11-22.5.0" = _3t3JVOx0;
        "pkg-26.1-snapshot-1-24.1.2" = _ZNU32JYV;
        "pkg-1.21.1-13.22.0" = _9qNBg9zb;
        "pkg-1.21.11-22.6.0" = _EPUX8LSh;
        "pkg-26.1-snapshot-1-24.2.0" = _jFJ9SbKq;
        "pkg-1.21.1-13.23.0" = _rkaccqf3;
        "pkg-1.21.11-22.7.0" = _7SoLETfO;
        "pkg-26.1-snapshot-1-24.3.0" = _nVR4RLFv;
        "pkg-26.1-snapshot-24.4.0" = _m3pbdKCi;
        "pkg-1.21.1-13.24.0" = _l3sy1tJT;
        "pkg-1.21.11-22.8.0" = _JKduD6kU;
        "pkg-1.21.1-13.25.0" = _zOPrbgPV;
        "pkg-1.21.11-22.9.0" = _Uo96uS2W;
        "pkg-26.1-snapshot-24.5.0" = _Mz2ionuu;
        "pkg-1.21.1-13.25.1" = _tHQKeGug;
        "pkg-26.1-snapshot-24.6.0" = _wO6ryXV6;
        "pkg-26.1-snapshot-24.7.0" = _H3vW0Ibs;
        "pkg-26.1-snapshot-24.8.0" = _RZ1DMH6T;
        "pkg-26.1-25.0.0" = _SYiZTXCU;
        "pkg-26.1.1-25.0.1" = _Po3Bt3Tv;
        "pkg-26.1.2-25.0.2" = _TC02aC8x;
        "pkg-26.1.2-26.0.0" = _ZlJQYx8c;
        "pkg-26.1.2-26.1.0" = _46MEb1LW;
        "pkg-26.1.2-26.2.0" = _whEFsWok;
        "pkg-26.2-27.0.0" = _jpy85mH8;
        "pkg-26.2-27.2.0" = _lfu9q32m;
        "pkg-26.2-27.3.0" = _GjW1pOn6;
        "pkg-26.2-27.4.0" = _4AgdrGMw;
        "pkg-26.2-27.5.0" = _ZBBXH7kf;
        "pkg-26.2-27.6.0" = _FtjDZ9z9;
