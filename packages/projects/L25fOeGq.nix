...
let
    ...
    in {
        ...
        "pkg-forge-1.7.3-1.19.0" = _VCtmIdlb;
        "pkg-fabric-1.5.4-1.18" = _2ETLFpKB;
        "pkg-fabric-1.6.3-1.19" = _ejyWRZlf;
        "pkg-forge-1.6.7-1.18.2" = _vP6i6KS9;
        "pkg-forge-1.7.4-1.19.0" = _gsnrKi46;
        "pkg-fabric-1.5.5-1.18" = _Clggjxjn;
        "pkg-fabric-1.6.4-1.19" = _8KKiTkWF;
        "pkg-fabric-1.6.5-1.19.3" = _lXb9tYl9;
        "pkg-forge-1.7.5-1.19.3" = _tnzbegAk;
        "pkg-fabric-1.6.6-1.19.4-pre3" = _LdRLZbeK;
        "pkg-fabric-1.6.6-1.19.4" = _Zs41lWH0;
        "pkg-forge-1.7.6-1.19.4" = _CWTC4Hmf;
        "pkg-fabric-2.0.0+1.20" = _7gaRuxQR;
        "pkg-forge-2.0.0+1.20" = _GVnSbFMI;
        "pkg-quilt-2.0.0+1.20" = _NlIDPNGC;
        "pkg-fabric-2.1.0+1.20" = _ftkVUi1g;
        "pkg-forge-2.1.0+1.20" = _w5WBptwm;
        "pkg-quilt-2.1.0+1.20" = _eZESWpPh;
        "pkg-fabric-2.1.1+1.20" = _QTnEhGIy;
        "pkg-forge-2.1.1+1.20" = _GPqRZhu9;
        "pkg-quilt-2.1.1+1.20" = _NvuX8t88;
        "pkg-fabric-2.2.0+1.20.2" = _7J7rrzGy;
        "pkg-forge-2.2.0+1.20.2" = _dG7AfIKm;
        "pkg-neoforge-2.2.0+1.20.2" = _2YN2oOrL;
        "pkg-fabric-2.2.0+1.20.4" = _czmVZd3q;
        "pkg-neoforge-2.2.0+1.20.4" = _UBjxirBM;
        "pkg-fabric-2.2.1+1.20.4" = _A3BwUHIU;
        "pkg-forge-2.2.1+1.20.4" = _tWpO03hb;
        "pkg-neoforge-2.2.1+1.20.4" = _6HsaBlNT;
        "pkg-forge-2.2.2+1.20.4" = _NgczCteZ;
        "pkg-neoforge-2.2.2+1.20.4" = _OYysD5W5;
        "pkg-fabric-2.2.2+1.20.4" = _d3PfZkXt;
        "pkg-forge-2.2.1+1.20.2" = _kkQ6imfh;
        "pkg-neoforge-2.2.1+1.20.2" = _LnDOkvb7;
        "pkg-fabric-2.2.1+1.20.2" = _b8VdpHWp;
        "pkg-fabric-2.1.2+1.20" = _8bgAATOd;
        "pkg-forge-2.1.2+1.20" = _s3I43o8I;
        "pkg-quilt-2.1.2+1.20" = _GWVuDW31;
        "pkg-fabric-2.2.2+1.20.6" = _PM1NJ9Yr;
        "pkg-forge-2.2.2+1.20.6" = _thabz0sz;
        "pkg-neoforge-2.2.2+1.20.6" = _Q0q6tUio;
        "pkg-fabric-2.2.3+1.20.6" = _ceKsNgUG;
        "pkg-forge-2.2.3+1.20.6" = _lqkJvbRN;
        "pkg-neoforge-2.2.3+1.20.6" = _Gosw5JmX;
        "pkg-forge-2.2.3+1.21" = _hgPqsDzq;
        "pkg-neoforge-2.2.3+1.21" = _ucF55MWc;
        "pkg-fabric-2.2.3+1.21" = _AjRxGlp1;
        "pkg-forge-2.2.4+1.20.6" = _54NARykW;
        "pkg-neoforge-2.2.4+1.20.6" = _rGd5hIMq;
        "pkg-fabric-2.2.4+1.20.6" = _aYm8HMSh;
        "pkg-forge-2.2.4+1.21" = _oBlSFqbY;
        "pkg-neoforge-2.2.4+1.21" = _GiCr08U9;
        "pkg-fabric-2.2.4+1.21" = _YC28LHB3;
        "pkg-forge-2.2.5+1.21" = _C1s0Ioul;
        "pkg-neoforge-2.2.5+1.21" = _aULmNF0y;
        "pkg-fabric-2.2.5+1.21" = _vvLivcDK;
        "pkg-fabric-2.2.6+1.21" = _ipatpZgK;
        "pkg-forge-2.2.6+1.21" = _LzTXg02W;
        "pkg-neoforge-2.2.6+1.21" = _s6cVxXiC;
        "pkg-fabric-2.2.7+1.21" = _fft7vkNI;
        "pkg-forge-2.2.7+1.21" = _tqohHeg0;
        "pkg-neoforge-2.2.7+1.21" = _O5YORQfP;
        "pkg-fabric-2.2.7+1.21.3" = _ZjQGOxzB;
        "pkg-forge-2.2.7+1.21.3" = _2hUJ09Mw;
        "pkg-neoforge-2.2.7+1.21.3" = _YK6BWZEm;
        "pkg-fabric-2.2.8+1.21.4" = _1QY1N6OB;
        "pkg-forge-2.2.8+1.21.4" = _EOH5BNdB;
        "pkg-neoforge-2.2.8+1.21.4" = _Vw3ofsPU;
        "pkg-fabric-2.2.8+1.21.3" = _ayQvGuyI;
        "pkg-forge-2.2.8+1.21.3" = _LZwp9MEJ;
        "pkg-neoforge-2.2.8+1.21.3" = _eKbaH7g7;
        "pkg-forge-2.2.8+1.21" = _noraYrTq;
        "pkg-neoforge-2.2.8+1.21" = _taWvh6Ld;
        "pkg-fabric-2.2.8+1.21" = _Zv9o7536;
        "pkg-forge-2.2.8+1.21.5" = _urRRJVGK;
        "pkg-neoforge-2.2.8+1.21.5" = _8wUAvrey;
        "pkg-fabric-2.2.8+1.21.5" = _QmbaddKF;
        "pkg-fabric-2.2.8+1.21.8" = _w7bJWjb9;
        "pkg-forge-2.2.8+1.21.8" = _kf8jOcEg;
        "pkg-neoforge-2.2.8+1.21.8" = _SdhqhKwq;
        "pkg-forge-2.2.8+1.21.10" = _l14Y8Wef;
        "pkg-neoforge-2.2.8+1.21.10" = _UvvjMSBc;
        "pkg-fabric-2.2.8+1.21.10" = _W3hlFBkl;
        "pkg-fabric-2.2.8+1.21.11" = _ytu4LaLL;
        "pkg-forge-2.2.8+1.21.11" = _RO1i53Dg;
        "pkg-neoforge-2.2.8+1.21.11" = _3U9iY9Ny;
