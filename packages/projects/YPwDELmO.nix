...
let
    ...
    in {
        ...
        "pkg-1.5.0" = _xaHLoMFs;
        "pkg-1.5.1" = _LcB3cNBb;
        "pkg-1.5.1.5" = _llBpaM6t;
        "pkg-1.5.2" = _FZHlqAgK;
        "pkg-1.5.3" = _gJ680vsF;
        "pkg-1.5.4" = _V309xmkW;
        "pkg-1.5.4.5" = _T6jboWid;
        "pkg-1.5.5" = _CSwGga4d;
        "pkg-1.5.5.5" = _uGkHFE9r;
        "pkg-1.5.6" = _UOQnI0z8;
        "pkg-1.5.6.5" = _45GSnaTA;
        "pkg-1.5.6.6" = _5x2oCgyM;
        "pkg-1.5.6.7" = _x0SFv3Rc;
        "pkg-1.5.6.8" = _MuVrheVN;
        "pkg-1.5.6.9" = _zj8PghFE;
        "pkg-1.5.7" = _BC7GHDPu;
        "pkg-1.5.8" = _vQMZZauW;
        "pkg-1.5.8.1" = _M3OGNrVA;
