...
let
    versions = (let
        ...
        _8TPOSt10 = {
            "id" = "8TPOSt10";
            "file" = "Strucutres v3.7.zip";
            "hash" = "sha512-x4SCQcBDfbcBbYhEJu0Dp2FFAmfatrAV8pWXoCbG8f139+Qif8JB115csZCyKN9uEpWbSTgLZvmCti/AetLh0w==";
        };
        _hFq9AcaJ = {
            "id" = "hFq9AcaJ";
            "file" = "Structures  v3.7.jar";
            "hash" = "sha512-+KV5y/SZghREGm4O59OSFo8l4hPIKU3sPXd6dZBzlazIqVc6VGiVd51EI/DHOndBSqdeylTrp6MyRxLh1lrqag==";
        };
        _st4ZUk1D = {
            "id" = "st4ZUk1D";
            "file" = "Structures v3.8.zip";
            "hash" = "sha512-bSJ5EGaRrATOcqkb4jKrOkTc87Q3RUivF50MuYmdtYaYR22UHeT48xqcbgKejcSJhsvHSYAVVuF73RbaEDnQUw==";
        };
        _VnkfxFe1 = {
            "id" = "VnkfxFe1";
            "file" = "Structures v3.8.jar";
            "hash" = "sha512-bohfNqwH36mB5dPQTQP3XtGh47gwe3ljNcf+4xHn/IdU3xi9WKN9hUgYQcePri1m24//sfHAlI72vdVSbkTAoA==";
        };
        _iLlH12aY = {
            "id" = "iLlH12aY";
            "file" = "Structures v3.9.zip";
            "hash" = "sha512-cLJiwqNeHEMmNZDim/kA+tLu1cPAntrZlBUpN/xvQib7hVAMOzhES/q+hZl58x3sfjBAELJgjJN4cpbhcnlc7A==";
        };
        _DTFHf4Zb = {
            "id" = "DTFHf4Zb";
            "file" = "Structures v3.9.jar";
            "hash" = "sha512-C7ovaXd7s+HKtqi/6W4fFu7M6PlwJ7+7WHPxX1f1bPg3w06vCeYYFJjfIS/JAigS2ZecjI3E6duSoFMy2UMAzg==";
        };
        _TchXy4wr = {
            "id" = "TchXy4wr";
            "file" = "Structures v4.0.zip";
            "hash" = "sha512-dWkUFdbUMpWsioZpip/VD4HTYH3+GAFu82PAlgOG3Gw5qFRtuT+aAHqyRBsFaR7skDC9IcwY+qKrsuCMRzhpAw==";
        };
        _Q2sRxf0G = {
            "id" = "Q2sRxf0G";
            "file" = "Structures v4.0.jar";
            "hash" = "sha512-yc0wcjIalR66ZaW58rfek4KaZKXq2mBUJkSQTM1QvCdKaRz8C50UJqXR33hegauEtCptY9oawIOKt9+rNONkZQ==";
        };
        _SCz44Cu7 = {
            "id" = "SCz44Cu7";
            "file" = "Structures v4.1.zip";
            "hash" = "sha512-S76mdgwDncEq9JsYJkMSt5mLyXk8CuFapSVYbxoVogx9/5LV54BoSHpfmm+4OFIHdmUK9vYkUBqHXwj/JWJzyg==";
        };
        _qzDEdU5F = {
            "id" = "qzDEdU5F";
            "file" = "Structures v4.1.jar";
            "hash" = "sha512-Oqz3xXigtyTqU++zJzYFI2yFIVtKHsj5ukuaqAZvGctc+wiqOumz7axPNe/RaZMoqzBDDdf/05BxIzdXLagZpA==";
        };
    in {
        "k9VJgiai" = _k9VJgiai;
        "M5SfwlwI" = _M5SfwlwI;
        ...
        "SCz44Cu7" = _SCz44Cu7;
        "qzDEdU5F" = _qzDEdU5F;
        "neoforge-1.21" = _qzDEdU5F;
        "neoforge-1.21.1" = _qzDEdU5F;
        "neoforge-1.21.2" = _qzDEdU5F;
        "neoforge-1.21.3" = _qzDEdU5F;
        "neoforge-1.21.4" = _qzDEdU5F;
        "neoforge-1.21.5" = _qzDEdU5F;
        "neoforge-1.21.6" = _qzDEdU5F;
        "neoforge-1.21.7" = _qzDEdU5F;
        "neoforge-1.21.8" = _qzDEdU5F;
        "neoforge-1.21.9" = _qzDEdU5F;
        "neoforge-1.21.10" = _qzDEdU5F;
        "neoforge-1.21.11" = _qzDEdU5F;
        "neoforge-1.20" = _qzDEdU5F;
        "neoforge-1.20.1" = _qzDEdU5F;
        "neoforge-1.20.2" = _qzDEdU5F;
        "neoforge-1.20.3" = _qzDEdU5F;
        "neoforge-1.20.4" = _qzDEdU5F;
        "neoforge-1.20.5" = _qzDEdU5F;
        "neoforge-1.20.6" = _qzDEdU5F;
        ...
        "neoforge-26.1" = _qzDEdU5F;
        "neoforge-26.1.1" = _qzDEdU5F;
        "neoforge-26.1.2" = _qzDEdU5F;
        ...
        "neoforge-26.2" = _qzDEdU5F;
        "neoforge-26.3-snapshot-1" = _qzDEdU5F;
        "neoforge-26.3-snapshot-2" = _qzDEdU5F;
        "neoforge-26.3-snapshot-3" = _qzDEdU5F;
        "neoforge-26.3-snapshot-4" = _qzDEdU5F;
        "neoforge-26.3-snapshot-5" = _qzDEdU5F;
        "neoforge-26.3-snapshot-6" = _qzDEdU5F;
        "neoforge-26.3-snapshot-7" = _qzDEdU5F;
        "neoforge-26.3-snapshot-8" = _qzDEdU5F;
        "neoforge-26.3-snapshot-9" = _qzDEdU5F;
        "neoforge-26.3-snapshot-10" = _qzDEdU5F;
        "neoforge-26.3-pre-1" = _qzDEdU5F;
        "neoforge-26.3-pre-2" = _qzDEdU5F;
        "neoforge-26.3-pre-3" = _qzDEdU5F;
        "neoforge-26.3-rc-1" = _qzDEdU5F;
        "neoforge-26.3-rc-2" = _qzDEdU5F;
        "neoforge-26.3-rc-3" = _qzDEdU5F;
        "neoforge-26.3" = _qzDEdU5F;
        "forge-1.21" = _qzDEdU5F;
        "forge-1.21.1" = _qzDEdU5F;
        "forge-1.21.2" = _qzDEdU5F;
        "forge-1.21.3" = _qzDEdU5F;
        "forge-1.21.4" = _qzDEdU5F;
        "forge-1.21.5" = _qzDEdU5F;
        "forge-1.21.6" = _qzDEdU5F;
        "forge-1.21.7" = _qzDEdU5F;
        "forge-1.21.8" = _qzDEdU5F;
        "forge-1.21.9" = _qzDEdU5F;
        "forge-1.21.10" = _qzDEdU5F;
        "forge-1.21.11" = _qzDEdU5F;
        "forge-1.20" = _qzDEdU5F;
        "forge-1.20.1" = _qzDEdU5F;
        "forge-1.20.2" = _qzDEdU5F;
        "forge-1.20.3" = _qzDEdU5F;
        "forge-1.20.4" = _qzDEdU5F;
        "forge-1.20.5" = _qzDEdU5F;
        "forge-1.20.6" = _qzDEdU5F;
        ...
        "forge-26.1" = _qzDEdU5F;
        "forge-26.1.1" = _qzDEdU5F;
        "forge-26.1.2" = _qzDEdU5F;
        ...
        "forge-26.2" = _qzDEdU5F;
        "forge-26.3-snapshot-1" = _qzDEdU5F;
        "forge-26.3-snapshot-2" = _qzDEdU5F;
        "forge-26.3-snapshot-3" = _qzDEdU5F;
        "forge-26.3-snapshot-4" = _qzDEdU5F;
        "forge-26.3-snapshot-5" = _qzDEdU5F;
        "forge-26.3-snapshot-6" = _qzDEdU5F;
        "forge-26.3-snapshot-7" = _qzDEdU5F;
        "forge-26.3-snapshot-8" = _qzDEdU5F;
        "forge-26.3-snapshot-9" = _qzDEdU5F;
        "forge-26.3-snapshot-10" = _qzDEdU5F;
        "forge-26.3-pre-1" = _qzDEdU5F;
        "forge-26.3-pre-2" = _qzDEdU5F;
        "forge-26.3-pre-3" = _qzDEdU5F;
        "forge-26.3-rc-1" = _qzDEdU5F;
        "forge-26.3-rc-2" = _qzDEdU5F;
        "forge-26.3-rc-3" = _qzDEdU5F;
        "forge-26.3" = _qzDEdU5F;
        "fabric-1.21" = _qzDEdU5F;
        "fabric-1.21.1" = _qzDEdU5F;
        "fabric-1.21.2" = _qzDEdU5F;
        "fabric-1.21.3" = _qzDEdU5F;
        "fabric-1.21.4" = _qzDEdU5F;
        "fabric-1.21.5" = _qzDEdU5F;
        "fabric-1.21.6" = _qzDEdU5F;
        "fabric-1.21.7" = _qzDEdU5F;
        "fabric-1.21.8" = _qzDEdU5F;
        "fabric-1.21.9" = _qzDEdU5F;
        "fabric-1.21.10" = _qzDEdU5F;
        "fabric-1.21.11" = _qzDEdU5F;
        "fabric-1.20" = _qzDEdU5F;
        "fabric-1.20.1" = _qzDEdU5F;
        "fabric-1.20.2" = _qzDEdU5F;
        "fabric-1.20.3" = _qzDEdU5F;
        "fabric-1.20.4" = _qzDEdU5F;
        "fabric-1.20.5" = _qzDEdU5F;
        "fabric-1.20.6" = _qzDEdU5F;
        ...
        "fabric-26.1" = _qzDEdU5F;
        "fabric-26.1.1" = _qzDEdU5F;
        "fabric-26.1.2" = _qzDEdU5F;
        ...
        "fabric-26.2" = _qzDEdU5F;
        "fabric-26.3-snapshot-1" = _qzDEdU5F;
        "fabric-26.3-snapshot-2" = _qzDEdU5F;
        "fabric-26.3-snapshot-3" = _qzDEdU5F;
        "fabric-26.3-snapshot-4" = _qzDEdU5F;
        "fabric-26.3-snapshot-5" = _qzDEdU5F;
        "fabric-26.3-snapshot-6" = _qzDEdU5F;
        "fabric-26.3-snapshot-7" = _qzDEdU5F;
        "fabric-26.3-snapshot-8" = _qzDEdU5F;
        "fabric-26.3-snapshot-9" = _qzDEdU5F;
        "fabric-26.3-snapshot-10" = _qzDEdU5F;
        "fabric-26.3-pre-1" = _qzDEdU5F;
        "fabric-26.3-pre-2" = _qzDEdU5F;
        "fabric-26.3-pre-3" = _qzDEdU5F;
        "fabric-26.3-rc-1" = _qzDEdU5F;
        "fabric-26.3-rc-2" = _qzDEdU5F;
        "fabric-26.3-rc-3" = _qzDEdU5F;
        "fabric-26.3" = _qzDEdU5F;
        "quilt-1.21" = _qzDEdU5F;
        "quilt-1.21.1" = _qzDEdU5F;
        "quilt-1.21.2" = _qzDEdU5F;
        "quilt-1.21.3" = _qzDEdU5F;
        "quilt-1.21.4" = _qzDEdU5F;
        "quilt-1.21.5" = _qzDEdU5F;
        "quilt-1.21.6" = _qzDEdU5F;
        "quilt-1.21.7" = _qzDEdU5F;
        "quilt-1.21.8" = _qzDEdU5F;
        "quilt-1.21.9" = _qzDEdU5F;
        "quilt-1.21.10" = _qzDEdU5F;
        "quilt-1.21.11" = _qzDEdU5F;
        "quilt-1.20" = _qzDEdU5F;
        "quilt-1.20.1" = _qzDEdU5F;
        "quilt-1.20.2" = _qzDEdU5F;
        "quilt-1.20.3" = _qzDEdU5F;
        "quilt-1.20.4" = _qzDEdU5F;
        "quilt-1.20.5" = _qzDEdU5F;
        "quilt-1.20.6" = _qzDEdU5F;
        ...
        "quilt-26.1" = _qzDEdU5F;
        "quilt-26.1.1" = _qzDEdU5F;
        "quilt-26.1.2" = _qzDEdU5F;
        ...
        "quilt-26.2" = _qzDEdU5F;
        "quilt-26.3-snapshot-1" = _qzDEdU5F;
        "quilt-26.3-snapshot-2" = _qzDEdU5F;
        "quilt-26.3-snapshot-3" = _qzDEdU5F;
        "quilt-26.3-snapshot-4" = _qzDEdU5F;
        "quilt-26.3-snapshot-5" = _qzDEdU5F;
        "quilt-26.3-snapshot-6" = _qzDEdU5F;
        "quilt-26.3-snapshot-7" = _qzDEdU5F;
        "quilt-26.3-snapshot-8" = _qzDEdU5F;
        "quilt-26.3-snapshot-9" = _qzDEdU5F;
        "quilt-26.3-snapshot-10" = _qzDEdU5F;
        "quilt-26.3-pre-1" = _qzDEdU5F;
        "quilt-26.3-pre-2" = _qzDEdU5F;
        "quilt-26.3-pre-3" = _qzDEdU5F;
        "quilt-26.3-rc-1" = _qzDEdU5F;
        "quilt-26.3-rc-2" = _qzDEdU5F;
        "quilt-26.3-rc-3" = _qzDEdU5F;
        "quilt-26.3" = _qzDEdU5F;
        ...
        "datapack-1.20" = _SCz44Cu7;
        "datapack-1.20.1-rc1" = _OkSonib0;
        "datapack-1.20.1" = _SCz44Cu7;
        ...
        "datapack-1.20.3" = _SCz44Cu7;
        "datapack-1.20.4-rc1" = _OkSonib0;
        "datapack-1.20.4" = _SCz44Cu7;
        ...
        "datapack-1.20.5" = _SCz44Cu7;
        "datapack-1.20.6-rc1" = _OkSonib0;
        "datapack-1.20.6" = _SCz44Cu7;
        ...
        "datapack-1.21" = _SCz44Cu7;
        "datapack-1.21.1-rc1" = _OkSonib0;
        "datapack-1.21.1" = _SCz44Cu7;
        ...
        "datapack-1.21.2" = _SCz44Cu7;
        "datapack-1.21.3" = _SCz44Cu7;
        ...
        "datapack-1.21.9" = _SCz44Cu7;
        "datapack-1.21.10-rc1" = _OkSonib0;
        "datapack-1.21.10" = _SCz44Cu7;
        "datapack-1.21.11-pre1" = _OkSonib0;
        "datapack-1.21.11" = _SCz44Cu7;
        ...
        "datapack-26.1" = _SCz44Cu7;
        "datapack-26.1.1" = _SCz44Cu7;
        "datapack-26.1.2" = _SCz44Cu7;
        ...
        "datapack-26.2" = _SCz44Cu7;
        "datapack-26.3-snapshot-1" = _SCz44Cu7;
        "datapack-26.3-snapshot-2" = _SCz44Cu7;
        "datapack-26.3-snapshot-3" = _SCz44Cu7;
        "datapack-26.3-snapshot-4" = _SCz44Cu7;
        "datapack-26.3-snapshot-5" = _SCz44Cu7;
        "datapack-26.3-snapshot-6" = _SCz44Cu7;
        "datapack-26.3-snapshot-7" = _SCz44Cu7;
        "datapack-26.3-snapshot-8" = _SCz44Cu7;
        "datapack-26.3-snapshot-9" = _SCz44Cu7;
        "datapack-26.3-snapshot-10" = _SCz44Cu7;
        "datapack-26.3-pre-1" = _SCz44Cu7;
        "datapack-26.3-pre-2" = _SCz44Cu7;
        "datapack-26.3-pre-3" = _SCz44Cu7;
        "pkg-1.0" = _sVCcD1gz;
        "pkg-1.1" = _1qocjZ54;
        "pkg-1.2" = _xsc201Gj;
        "pkg-1.3" = _CzalVrQh;
