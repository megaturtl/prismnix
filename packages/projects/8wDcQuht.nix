...
let
    versions = (let
        ...
        _HQOwOHl7 = {
            "id" = "HQOwOHl7";
            "file" = "greate-0.0.79.jar";
            "hash" = "sha512-Mgx/PdtDsw1bLzXzflsOkGGcjA8NkBvhN/vbAThyhod2gpFank4dEvWDEM1/lZINX4N7qAeMvZOAfiEnlIh3yg==";
        };
        _XP4rs3N3 = {
            "id" = "XP4rs3N3";
            "file" = "greate-0.0.80.jar";
            "hash" = "sha512-yUgcqpnLa9Qut+o2FuMsi5/xSVl+hKYheyvYTieOLmSxlszF5ZHjJS5zjXlLPZC668IgTMGBFN4VBCatBVRo6w==";
        };
        _xqfU594T = {
            "id" = "xqfU594T";
            "file" = "greate-0.0.81.jar";
            "hash" = "sha512-L9oy98Xgf9GY2Tl9y4cZKqU1M45VtW/mjsY0HcdyW8s9bk6aH2tdLCPbSnECXLfC64QiXEHttQ0WJSL1DByf4w==";
        };
    in {
        "kgoWbdA7" = _kgoWbdA7;
        "8eKiKMYi" = _8eKiKMYi;
        ...
        "forge-1.20.1" = _xqfU594T;
        "neoforge-1.20.1" = _xqfU594T;
        ...
        "pkg-0.0.8" = _6bmNUb47;
        "pkg-0.0.9" = _vNdVol5K;
        "pkg-0.0.10" = _x6EKseFr;
        "pkg-0.0.11" = _4RfgELjf;
        "pkg-0.0.12" = _XGtifBnp;
        "pkg-0.0.13" = _XzNOABUB;
        "pkg-0.0.14" = _HQxDsZn9;
        "pkg-0.0.15" = _zLdMsjsl;
        "pkg-0.0.16" = _7r8HCvnV;
        "pkg-0.0.17" = _btJSqVyy;
        "pkg-0.0.18" = _9B75TSsP;
        "pkg-0.0.19" = _ng2eS0x6;
        "pkg-0.0.20" = _fmHPqrMu;
        "pkg-0.0.21" = _Ao0R9oeW;
        "pkg-0.0.22" = _v5OGzUXP;
        "pkg-0.0.23" = _G7mTIBnz;
        "pkg-0.0.24" = _KMejsO2P;
        "pkg-0.0.25" = _Co3aAUK4;
        "pkg-0.0.26" = _TjgBoIV4;
        "pkg-0.0.27" = _KHdDbC8v;
        "pkg-0.0.28" = _4TQGxuOK;
        "pkg-0.0.29" = _w7WwOPDJ;
        "pkg-0.0.30" = _64i6iRir;
        "pkg-0.0.31" = _YCeKXP5l;
        "pkg-0.0.32" = _4hWpv9rP;
        "pkg-0.0.33" = _4u2D14kQ;
        "pkg-0.0.34" = _BQ1l1WOG;
        "pkg-0.0.35" = _4EbumfId;
        "pkg-0.0.36" = _zrXenKB0;
        "pkg-0.0.37" = _fjyLD7CL;
        "pkg-0.0.38" = _jfXaHhi2;
        "pkg-0.0.39" = _n0BeKXIG;
        "pkg-0.0.40" = _9CO95tcM;
        "pkg-0.0.41" = _WAq7Lqve;
        "pkg-0.0.42" = _4slCXy1S;
        "pkg-0.0.43" = _vEwLqQej;
        "pkg-0.0.44" = _VExwxpO5;
        "pkg-0.0.45" = _2DOzdz5j;
        "pkg-0.0.46" = _HCKRLApi;
        "pkg-0.0.47" = _fnWslOGV;
        "pkg-0.0.48" = _cWoAmFlf;
        "pkg-0.0.49" = _32YxVzyn;
        "pkg-0.0.50" = _WqPWraSr;
        "pkg-0.0.51" = _uOZLaa3T;
        "pkg-0.0.52" = _pTqnXrIb;
        "pkg-0.0.53" = _xv8hnoAd;
        "pkg-0.0.54" = _wqUKZ5yH;
        "pkg-0.0.55" = _brXbTuGC;
        "pkg-0.0.56" = _gTsYp44l;
        "pkg-0.0.57" = _D1FDmRDa;
        "pkg-0.0.58" = _TT9ck8vt;
        "pkg-0.0.59" = _vYPdRVCR;
        "pkg-0.0.60" = _lkpf6G04;
        "pkg-0.0.61" = _bZDj2HqJ;
        "pkg-0.0.62" = _FDjUACYa;
        "pkg-0.0.64" = _9flLlqpd;
        "pkg-0.0.65" = _xIktGJzE;
        "pkg-0.0.66" = _PKMB9cOR;
        "pkg-0.0.67" = _ZOxuan1i;
        "pkg-0.0.68" = _DvMN1dCJ;
        "pkg-0.0.69" = _Ob7cp45l;
        "pkg-0.0.70" = _Pd8BQLsK;
        "pkg-0.0.71" = _ip9Pmwzj;
        "pkg-0.0.72" = _aEBMNbQw;
        "pkg-0.0.73" = _tlsK1zih;
        "pkg-0.0.74" = _Q9JGHTPu;
        "pkg-0.0.75" = _aZjKnDVL;
        "pkg-0.0.76" = _d9Zv61Hv;
        "pkg-0.0.77" = _7HxrMkRX;
        "pkg-0.0.78" = _2klr8QsL;
        "pkg-0.0.79" = _HQOwOHl7;
        "pkg-0.0.80" = _XP4rs3N3;
        "pkg-0.0.81" = _xqfU594T;
        "default" = _xqfU594T;
    });
