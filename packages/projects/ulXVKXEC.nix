...
let
    versions = (let
        ...
        _Eqlj19Q7 = {
            "id" = "Eqlj19Q7";
            "file" = "Brush & Juice.zip";
            "hash" = "sha512-D6/md8mOzJYqK1rMJsmsRUIdYj58k0KVSz1bFqGHTMHvuMIukCottCPwfNKTh/A8IzapVOU7eo9dYVAzhlo0Vg==";
        };
        _LSCvwpFl = {
            "id" = "LSCvwpFl";
            "file" = "Brush & Juice.zip";
            "hash" = "sha512-xUREhOWllt3JQuQI0bbAZHXJMllHOedblkeSsINSAScKWpfu7qvBJ/hdl0flXJ4hZGFtA7XeHwwKwe4qxou8NQ==";
        };
    in {
        "m7CADEO4" = _m7CADEO4;
        "SXS5w8Gi" = _SXS5w8Gi;
        ...
        "Eqlj19Q7" = _Eqlj19Q7;
        "LSCvwpFl" = _LSCvwpFl;
        "minecraft-1.21" = _LSCvwpFl;
        "minecraft-1.21.1" = _LSCvwpFl;
        "minecraft-1.20.1" = _LSCvwpFl;
        "minecraft-1.20.2" = _LSCvwpFl;
        "minecraft-1.20.3" = _LSCvwpFl;
        "minecraft-1.20.4" = _LSCvwpFl;
        "minecraft-1.20.5" = _LSCvwpFl;
        "minecraft-1.20.6" = _LSCvwpFl;
        "minecraft-1.21.2" = _LSCvwpFl;
        "minecraft-1.21.3" = _LSCvwpFl;
        "minecraft-1.20" = _LSCvwpFl;
        "minecraft-1.21.4" = _LSCvwpFl;
        "minecraft-1.21.5" = _LSCvwpFl;
        "minecraft-1.21.6" = _LSCvwpFl;
        "minecraft-1.21.7" = _LSCvwpFl;
        "minecraft-1.21.8" = _LSCvwpFl;
        "minecraft-1.21.9" = _LSCvwpFl;
        "minecraft-1.21.10" = _LSCvwpFl;
        "minecraft-1.21.11" = _LSCvwpFl;
        "minecraft-23w31a" = _LSCvwpFl;
        "minecraft-23w32a" = _LSCvwpFl;
        "minecraft-23w33a" = _LSCvwpFl;
        "minecraft-23w35a" = _LSCvwpFl;
        "minecraft-1.20.2-pre1" = _LSCvwpFl;
        "minecraft-23w42a" = _LSCvwpFl;
        "minecraft-23w43a" = _LSCvwpFl;
        "minecraft-23w43b" = _LSCvwpFl;
        "minecraft-23w44a" = _LSCvwpFl;
        "minecraft-23w45a" = _LSCvwpFl;
        "minecraft-23w46a" = _LSCvwpFl;
        "minecraft-24w03a" = _LSCvwpFl;
        "minecraft-24w03b" = _LSCvwpFl;
        "minecraft-24w04a" = _LSCvwpFl;
        "minecraft-24w05a" = _LSCvwpFl;
        "minecraft-24w05b" = _LSCvwpFl;
        "minecraft-24w06a" = _LSCvwpFl;
        "minecraft-24w07a" = _LSCvwpFl;
        "minecraft-24w09a" = _LSCvwpFl;
        "minecraft-24w10a" = _LSCvwpFl;
        "minecraft-24w11a" = _LSCvwpFl;
        "minecraft-24w12a" = _LSCvwpFl;
        "minecraft-24w13a" = _LSCvwpFl;
        "minecraft-24w14potato" = _LSCvwpFl;
        "minecraft-24w14a" = _LSCvwpFl;
        "minecraft-1.20.5-pre1" = _LSCvwpFl;
        "minecraft-1.20.5-pre2" = _LSCvwpFl;
        "minecraft-1.20.5-pre3" = _LSCvwpFl;
        "minecraft-24w18a" = _LSCvwpFl;
        "minecraft-24w19a" = _LSCvwpFl;
        "minecraft-24w19b" = _LSCvwpFl;
        "minecraft-24w20a" = _LSCvwpFl;
        "minecraft-24w33a" = _LSCvwpFl;
        "minecraft-24w34a" = _LSCvwpFl;
        "minecraft-24w35a" = _LSCvwpFl;
        "minecraft-24w36a" = _LSCvwpFl;
        "minecraft-24w37a" = _LSCvwpFl;
        "minecraft-24w38a" = _LSCvwpFl;
        "minecraft-24w39a" = _LSCvwpFl;
        "minecraft-24w40a" = _LSCvwpFl;
        "minecraft-1.21.2-pre1" = _LSCvwpFl;
        "minecraft-1.21.2-pre2" = _LSCvwpFl;
        "minecraft-24w44a" = _LSCvwpFl;
        "minecraft-24w45a" = _LSCvwpFl;
        "minecraft-24w46a" = _LSCvwpFl;
        "minecraft-26.1" = _LSCvwpFl;
        "minecraft-26.1.1" = _LSCvwpFl;
        "minecraft-26.1.2" = _LSCvwpFl;
        "minecraft-26.2" = _LSCvwpFl;
        "pkg-0.1.0" = _m7CADEO4;
        "pkg-0.1.1" = _SXS5w8Gi;
        "pkg-0.1.2" = _FQGTgvoJ;
        "pkg-0.1.3" = _pPRdaRM3;
