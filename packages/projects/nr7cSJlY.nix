...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.19.2" = _3iI5bI6M;
        "pkg-0.2.0+1.19.2" = _c38e9w0v;
        "pkg-0.2.1+1.19.2" = _oplkblFX;
        "pkg-0.2.2+1.19.2" = _KGCwYi3U;
        "pkg-0.2.3+1.19.2" = _DwqdV8jL;
        "pkg-0.3.0+1.19.3" = _As9ElawT;
        "pkg-0.3.1+1.19.3" = _sk1yzHYP;
        "pkg-0.3.2+1.19.4-rc2" = _7mHw4MRd;
        "pkg-0.4.0+1.20-rc1" = _aUuq15FP;
        "pkg-0.4.1+1.20" = _aD1Sd9L6;
        "pkg-0.4.2+1.20" = _vP6JdpKC;
        "pkg-0.4.3+1.20.1" = _dd1DkGEe;
        "pkg-0.5.0+1.20.2-rc2" = _YItLjOD4;
        "pkg-0.6.0+1.20.3-rc1" = _UDKXNdMU;
        "pkg-0.7.0+1.20.5" = _ePj2SQFT;
        "pkg-0.7.1+1.20.6" = _sCX8bfI8;
        "pkg-0.8.0+1.21-rc1" = _dFY4EIfX;
        "pkg-0.9.0+1.21.2" = _fSsdD0it;
        "pkg-0.10.0+1.21.4-rc3" = _f0lS7PWn;
        "pkg-0.10.1+1.21.4" = _esH7JDyt;
        "pkg-0.10.2+1.21.4" = _VWWrTmxp;
        "pkg-0.10.3+1.21.4" = _qO1JwNnb;
        "pkg-0.8.1+1.21.1" = _5YUeDUls;
        "pkg-0.11.0+1.21.5-rc2" = _S5EEST9L;
        "pkg-0.11.1+1.21.5" = _XFrtRxXM;
        "pkg-0.12.0+1.21.6" = _LtPM2E8X;
        "pkg-0.13.0+1.21.9-rc1" = _NykLEC5c;
        "pkg-0.14.0+1.21.11-rc2" = _d5YLon6f;
        "pkg-0.15.0+26.1" = _5KrENvru;
