...
let
    ...
    in {
        ...
        "pkg-2.0.0+1.21" = _VYiHuiIm;
        "pkg-2.0.0+1.17" = _cQRYN9DW;
        "pkg-1.4.2+1.16.5" = _tkCPunc5;
        "pkg-2.0.0+1.21.3" = _ebUU2MDw;
        "pkg-2.0.1+1.18.2" = _Hbxb2edW;
        "pkg-2.0.1+1.19" = _sc3bi9J0;
        "pkg-2.0.1+1.20" = _hTNI5WoW;
        "pkg-2.0.1+1.21" = _lfUjiODq;
        "pkg-2.0.1+1.21.3" = _TNaMDY2k;
        "pkg-2.0.1+1.21.4" = _ndU4cYFO;
        "pkg-2.1.0+1.18.2" = _pQtL5lBS;
        "pkg-2.1.0+1.19" = _1gwkPg8m;
        "pkg-2.1.0+1.20" = _mdTkHAr3;
        "pkg-2.1.0+1.21" = _vyvrFB5q;
        "pkg-2.1.0+1.21.3" = _RuG2Any3;
        "pkg-2.1.0+1.21.4" = _SaLTy198;
        "pkg-2.2.0+mc1.18.2" = _CkXN5mTM;
        "pkg-2.2.0+mc1.19" = _eizABmJH;
        "pkg-2.2.0+mc1.20" = _n86T7pa8;
        "pkg-2.2.0+mc1.21.1" = _2OF1UoOd;
        "pkg-2.2.0+mc1.21.3" = _k9Wu0as7;
        "pkg-2.2.0+mc1.21.4" = _wFmaaei5;
        "pkg-2.2.0+mc1.21.6" = _BO6kbzwr;
        "pkg-2.3.0+mc1.18.2" = _3qaHfSWj;
        "pkg-2.3.0+mc1.19" = _ocvPq7Se;
        "pkg-2.3.0+mc1.20" = _sswetr1E;
        "pkg-2.3.0+mc1.21.1" = _JLwVfMlC;
        "pkg-2.3.0+mc1.21.3" = _OyXLEiOF;
        "pkg-2.3.0+mc1.21.4" = _eLxhcJ6f;
        "pkg-2.3.0+mc1.21.6" = _67Sx84Wh;
        "pkg-2.3.0+mc1.21.9" = _hV7LuNDG;
        "pkg-2.3.1+mc1.18.2" = _BXkk8pmk;
        "pkg-2.3.1+mc1.19" = _oLjVOyOA;
        "pkg-2.3.1+mc1.20" = _Xs9RsLoI;
        "pkg-2.3.1+mc1.21.1" = _Nx3BIVX6;
        "pkg-2.3.1+mc1.21.3" = _rEXWxgom;
        "pkg-2.3.1+mc1.21.6" = _sUJTdIGQ;
        "pkg-2.3.1+mc1.21.9" = _9TjioicZ;
        "pkg-2.4.0+mc1.18.2" = _zKVG67lM;
        "pkg-2.4.0+mc1.19" = _JGCDifpZ;
        "pkg-2.4.0+mc1.20" = _MTHUMOul;
        "pkg-2.4.0+mc1.21.1" = _8eugi0IN;
        "pkg-2.4.0+mc1.21.3" = _Glx3EY4u;
        "pkg-2.4.0+mc1.21.4" = _QnXO1GJe;
        "pkg-2.4.0+mc1.21.6" = _15UuLkY3;
        "pkg-2.4.0+mc1.21.9" = _Xe7ZEFoF;
        "pkg-2.5.0+mc1.21.11" = _9DfVjWgP;
        "pkg-2.5.1+mc1.18.2" = _5NyE596h;
        "pkg-2.5.1+mc1.19" = _KdvxxFJ8;
        "pkg-2.5.1+mc1.20" = _e8denjiP;
        "pkg-2.5.1+mc1.21.1" = _8caoSQgs;
        "pkg-2.5.1+mc1.21.3" = _C33PYf2M;
        "pkg-2.5.1+mc1.21.4" = _s68P6t0K;
        "pkg-2.5.1+mc1.21.6" = _pcaHOe33;
        "pkg-2.5.1+mc1.21.9" = _nf7mZ2QH;
        "pkg-2.5.1+mc1.21.11" = _zfkyeGAk;
        "pkg-2.5.2+mc1.18.2" = _KhwwNAu3;
        "pkg-2.5.2+mc1.19" = _XSmLHUbU;
        "pkg-2.5.2+mc1.20" = _YUt18rSo;
        "pkg-2.5.2+mc1.21.1" = _MjrtVgtQ;
        "pkg-2.5.2+mc1.21.3" = _oXJxf2QF;
        "pkg-2.5.2+mc1.21.4" = _X9JhYnaa;
        "pkg-2.5.2+mc1.21.6" = _7pIpeNMr;
        "pkg-2.5.2+mc1.21.9" = _RWjaqQXJ;
        "pkg-2.5.2+mc1.21.11" = _Cq8Hvuge;
        "pkg-2.5.3+mc1.20" = _Wgin1MSn;
        "pkg-2.5.3+mc1.21.1" = _u7JxgejH;
        "pkg-2.5.3+mc1.21.3" = _uq042YuF;
        "pkg-2.5.3+mc1.21.4" = _CuZDwLEv;
        "pkg-2.5.3+mc1.21.6" = _vsaGeZeQ;
        "pkg-2.5.3+mc1.21.9" = _epZS6bp5;
        "pkg-2.5.3+mc1.21.11" = _akORG5SM;
        "pkg-2.5.4+mc1.18.2" = _ltEZFRIZ;
        "pkg-2.5.4+mc1.19" = _qYuSMiTR;
        "pkg-2.5.4+mc1.20" = _grmIErDm;
        "pkg-2.5.4+mc1.21.1" = _9Ek15ae3;
        "pkg-2.5.4+mc1.21.3" = _qfRSymqw;
        "pkg-2.5.4+mc1.21.4" = _l3jeUa5Q;
        "pkg-2.5.4+mc1.21.6" = _ovX8oQku;
        "pkg-2.5.4+mc1.21.9" = _OXjLXHMU;
        "pkg-2.5.4+mc1.21.11" = _H1U2IU1c;
        "pkg-2.5.5+mc1.18.2" = _JRVvQ6Jm;
        "pkg-2.5.5+mc1.19" = _snKOS8d5;
        "pkg-2.5.5+mc1.20" = _Fp19dYPz;
        "pkg-2.5.5+mc1.21.1" = _hj1M4E18;
        "pkg-2.5.5+mc1.21.3" = _Dj27JaSM;
        "pkg-2.5.5+mc1.21.4" = _2nRSHMdv;
        "pkg-2.5.5+mc1.21.6" = _xBm1Buc3;
        "pkg-2.5.5+mc1.21.9" = _1CqH14rL;
        "pkg-2.5.5+mc1.21.11" = _iQdiYU6w;
        "pkg-2.5.6+mc26.1" = _TfnIEPxa;
        "pkg-2.5.7+mc1.20" = _1QeJFEoj;
        "pkg-2.5.7+mc1.21.1" = _TBzGfqtA;
        "pkg-2.6.0+mc1.18.2" = _RtwC2TkC;
        "pkg-2.6.0+mc1.19" = _mGiXkmjb;
        "pkg-2.6.0+mc1.20" = _zy27zTxd;
        "pkg-2.6.0+mc1.21.1" = _TRYazJDR;
        "pkg-2.6.0+mc1.21.3" = _oTLKRmdc;
        "pkg-2.6.0+mc1.21.4" = _zuzZ5hAp;
        "pkg-2.6.0+mc1.21.6" = _RFDoNvz9;
        "pkg-2.6.0+mc1.21.9" = _YhlWYzbJ;
        "pkg-2.6.0+mc1.21.11" = _awdmWHpQ;
        "pkg-2.6.0+mc26.1" = _nvfHeVcD;
        "pkg-2.6.1+mc1.18.2" = _D7XkVgxK;
        "pkg-2.6.1+mc1.19" = _KukPeVAI;
        "pkg-2.6.1+mc1.20" = _tiBpOMnz;
        "pkg-2.6.1+mc1.21.1" = _5kuEpflX;
        "pkg-2.6.1+mc1.21.3" = _PGkgsdxb;
        "pkg-2.6.1+mc1.21.4" = _rikIQIQj;
        "pkg-2.6.1+mc1.21.6" = _fZrVvNPe;
        "pkg-2.6.1+mc1.21.9" = _q6NYTM6K;
        "pkg-2.6.1+mc1.21.11" = _6vIquwkx;
        "pkg-2.6.1+mc26.1" = _kWqwAj8H;
        "pkg-2.7.0+mc1.18.2" = _7chcOLXL;
        "pkg-2.7.0+mc1.19" = _HJzgkSLm;
        "pkg-2.7.0+mc1.20" = _tJhUqqaO;
        "pkg-2.7.0+mc1.21.1" = _w54irZgP;
        "pkg-2.7.0+mc1.21.3" = _vefgDUKG;
        "pkg-2.7.0+mc1.21.4" = _myUTvBpR;
        "pkg-2.7.0+mc1.21.6" = _qx1ArsfP;
        "pkg-2.7.0+mc1.21.9" = _QF3Dnsdi;
        "pkg-2.7.0+mc1.21.11" = _VCfzD0aF;
        "pkg-2.7.0+mc26.1" = _LG9qwSyD;
        "pkg-2.7.1+mc26.2" = _OGqum8LC;
        "pkg-2.7.2+mc1.18.2" = _xMIodQId;
        "pkg-2.7.2+mc1.19" = _FbyomKlh;
        "pkg-2.7.2+mc1.20" = _E8BaBaPB;
        "pkg-2.7.2+mc1.21.1" = _HAAAMVa2;
        "pkg-2.7.2+mc1.21.3" = _gg4ktBGE;
        "pkg-2.7.2+mc1.21.4" = _Dm4ir7o1;
        "pkg-2.7.2+mc1.21.6" = _aeDTLT4j;
        "pkg-2.7.2+mc1.21.9" = _58entcwF;
