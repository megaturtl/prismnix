...
let
    versions = (let
        ...
        _kxzFvIVp = {
            "id" = "kxzFvIVp";
            "file" = "polylib-fabric-26.1.2-2.0.11.jar";
            "hash" = "sha512-sUxxWUpirBeQJKsO5NhdOySYlnvFBywkuzhgrQ8cVAJazmQB9RJeeH3w1/5cNZZXTm4rmjnhJJ3S5R40YqHicw==";
        };
        _PBpjCLyz = {
            "id" = "PBpjCLyz";
            "file" = "polylib-neoforge-26.1.2-2.0.11.jar";
            "hash" = "sha512-kSpbxaNqqCTD2mBUtGBA7Mwtr8DvZkxoGzWba1OjlKQ38YQaWXB1P3K5nDevLJO8LdSxYRLBAPCJbRYipkqEDA==";
        };
        _Y6qf1xHI = {
            "id" = "Y6qf1xHI";
            "file" = "polylib-fabric-26.2-2.0.10.jar";
            "hash" = "sha512-SpxOjWbateIL0uXuTFs0WaL4urL50KRVU61f2UCzFTrGp88R3TPc35Zz0pYyRPAmfinc45E4DJ/AgfWvKmdE1Q==";
        };
        _vRLqNVM3 = {
            "id" = "vRLqNVM3";
            "file" = "polylib-neoforge-26.2-2.0.10.jar";
            "hash" = "sha512-gpYIikErl2A0Q0p2aoDrpVkXbMVHqhWNQk0NbHzC4JmzZSIXVnqexFszyV7VvFv3VW7kazSSW0ZKu1T5dwoXZQ==";
        };
        _fE2TyO3X = {
            "id" = "fE2TyO3X";
            "file" = "polylib-neoforge-26.2-2.0.11.jar";
            "hash" = "sha512-GJJYWHwkbE6ICeE6iORQd/VvU8qwTYns642HotvX8QtH/BjpYrlueacNKZWQ5hJL9ZYXf47K7ub1Bh4qey+Eiw==";
        };
        _ogrDSeAS = {
            "id" = "ogrDSeAS";
            "file" = "polylib-fabric-26.2-2.0.11.jar";
            "hash" = "sha512-AXmJxctsby33lbw1UyoUVWl78sY6Gb8sqgDyl/4MuIC7yDPUJVZZOcs69q16ceRvrLtHYbNjovQdwB1Xmrk5eA==";
        };
        _2DPy2kbe = {
            "id" = "2DPy2kbe";
            "file" = "polylib-neoforge-26.3-2.0.12.jar";
            "hash" = "sha512-yfejLYhhMSGDY8TGWaxbYbveEZuY+z8KMsuqU1n243UovgRMSkCuGBg/Tn97Nf4SnkrgfABWibVVt0MIdFdDxg==";
        };
        _eZHvd53u = {
            "id" = "eZHvd53u";
            "file" = "polylib-fabric-26.3-2.0.12.jar";
            "hash" = "sha512-9Ih7w9E58hj4SW4dxFxUkEnY6lybqftkHjsEwfwxOU5mrSZnjnvkd1ME8d2TpO1G1KvXLT70nn2lgARGGom6PQ==";
        };
        _j1P42ghd = {
            "id" = "j1P42ghd";
            "file" = "polylib-neoforge-26.3-2.0.13.jar";
            "hash" = "sha512-MxrlZDm6pVs3Sx1q4+P0paONA8e6GpCSrTxNphXHAdXekFNadp4lzSgZWzl309U5mobP3ByHqndy6VTOikZuew==";
        };
        _EdLH2l23 = {
            "id" = "EdLH2l23";
            "file" = "polylib-fabric-26.3-2.0.13.jar";
            "hash" = "sha512-IFN4jHazsTyBTjMUyilDBcEM2TpaxveFAujGls6s/ZIUXqgaHIKydWriKwk+T5aCXybUIJlpykMPCqxBkU6WQA==";
        };
        _ZTAdPhyJ = {
            "id" = "ZTAdPhyJ";
            "file" = "polylib-neoforge-26.3-2.0.14.jar";
            "hash" = "sha512-vfIvzT0pVCTS+94DQ8KRB3PUVEiKl/fvrT+XRxfqj07RB6wvV54uxJwr/0Y1qYgJ/l1l0Yu21cSaPiDBJnS0kQ==";
        };
        _mYwmDHmO = {
            "id" = "mYwmDHmO";
    ...
    in {
        ...
        "pkg-1900.0.2-build.27" = _bZazyCsO;
        "pkg-1900.0.2-build.42" = _pJPwEYQV;
        "pkg-1900.0.2-build.73" = _AHsf7PuP;
        "pkg-1200.0.2-build.84" = _sHtQiiuF;
        "pkg-1200.0.2-build.85" = _YvdiCSRT;
        "pkg-2000.0.3-build.97" = _O9LAbM5e;
        "pkg-1900.0.3-build.100" = _VA2Tq5QL;
        "pkg-1801.0.3-build.101" = _XX9SbLqQ;
        "pkg-1801.0.3-build.109" = _lCcL0Wsh;
        "pkg-2002.0.3-build.115" = _mMkZpjc2;
        "pkg-2002.0.3-build.116" = _WuJjMRfv;
        "pkg-2004.0.3-build.117" = _WD3gMXnE;
        "pkg-2004.0.3-build.119" = _HeSi2yt9;
        "pkg-2004.0.3-build.120" = _HMx3Uy2Y;
        "pkg-2004.0.3-build.121" = _kxvQ3s49;
        "pkg-2004.0.3-build.122" = _QkWxGynP;
        "pkg-2004.0.3-build.125" = _KMQ4lESt;
        "pkg-2002.0.3-build.124" = _WfpIaOwI;
        "pkg-2000.0.3-build.123" = _bYeFKNQf;
        "pkg-2002.0.3-build.128" = _c2vpcYKA;
        "pkg-2000.0.3-build.126" = _8x7d9JGB;
        "pkg-2004.0.3-build.127" = _KU9Xx0MB;
        "pkg-2002.0.3-build.129" = _ajGan7T2;
        "pkg-2002.0.3-build.131" = _RoOUSdHz;
        "pkg-2004.0.3-build.130" = _JA7PSF1t;
        "pkg-2000.0.3-build.132" = _QxzCalTw;
        "pkg-2004.0.3-build.135" = _IAJaRoM9;
        "pkg-2002.0.3-build.134" = _nrvi50aq;
        "pkg-2000.0.3-build.133" = _PU1yIgSO;
        "pkg-2004.0.3-build.136" = _PuInidtx;
        "pkg-2002.0.3-build.137" = _2UAti4eS;
        "pkg-2004.0.3-build.138" = _BfxZidvb;
        "pkg-2004.0.3-build.139" = _eRWjkgV5;
        "pkg-2004.0.3-build.140" = _JAJ3pCrL;
        "pkg-2004.0.3-build.141" = _XQ0otMoE;
        "pkg-2002.0.3-build.142" = _NXrgvob3;
        "pkg-2000.0.3-build.143" = _boXcy1fH;
        "pkg-1900.0.3-build.144" = _EqSYDS6s;
        "pkg-2100.0.3-build.146" = _RIKOTpG9;
        "pkg-2100.0.3-build.147" = _JTC3RavJ;
        "pkg-2002.0.3-build.149" = _pQR78pJC;
        "pkg-2004.0.3-build.148" = _MMo67Sog;
        "pkg-2100.0.3-build.150" = _uVd2bxye;
        "pkg-2004.0.3-build.151" = _RMLUzVOl;
        "pkg-2100.0.3-build.152" = _fTtox1WX;
        "pkg-2100.0.3-build.153" = _Zr6AVyq0;
        "pkg-2004.0.3-build.155" = _LNiWP4JX;
        "pkg-2002.0.3-build.157" = _z3XcwYka;
        "pkg-2100.0.3-build.158" = _eRo7S6Jj;
        "pkg-2100.0.3-build.159" = _1lK0ukh4;
        "pkg-2100.0.3-build.160" = _LIHrMxOh;
        "pkg-2103.0.4-build.161" = _pAOiJXlY;
        "pkg-2104.0.4-build.163" = _PwFd461u;
        "pkg-2105.0.4.174" = _otcNfmaD;
        "pkg-2107.1.0.181" = _GKou3DwY;
        "pkg-2106.1.0.182" = _TI0sSpJB;
        "pkg-2.0.4" = _8K7Djtlk;
        "pkg-2.0.5" = _5751Kx3T;
        "pkg-2.0.6" = _RJ0zdmgR;
        "pkg-2.0.7" = _HmWCS0qy;
        "pkg-2.0.8" = _e0pj2RYE;
        "pkg-2.0.9" = _823PUhFj;
        "pkg-2.0.10" = _vRLqNVM3;
        "pkg-2.0.11" = _ogrDSeAS;
