...
let
    versions = (let
        ...
        _hoCuFSik = {
            "id" = "hoCuFSik";
            "file" = "MasaGadget-mc1.19.2-fabric-4.0.403-development.jar";
            "hash" = "sha512-fXzH33STf089jxJvFJbNQnLxX3HUyRYU2G1eJXiClsqgcvIhTUWjWf3D5IM0ltFcFXCgapx/AU04bB9eFq+Zrw==";
        };
        _IOpAgd9A = {
            "id" = "IOpAgd9A";
            "file" = "MasaGadget-mc1.21.4-fabric-4.0.403-development.jar";
            "hash" = "sha512-LuFPpB5jaUbT6kh8rTdjRVYwNTLqPQXRig8GX3E96103OQxtt10NMVcyn47BPsnN6+UkuYBoRzuMj/AaRaiNqQ==";
        };
        _E1y10Rtk = {
            "id" = "E1y10Rtk";
            "file" = "MasaGadget-mc1.19.4-fabric-4.0.403-development.jar";
            "hash" = "sha512-SxaGNJ6NzTL7Sfkf/L4ZquSyvPUpiD5InyarUhe/Ys6ahOwDN6+SIhVbDky5IlO9pAtbISvNwZOIo7hv4OF4nQ==";
        };
        _1U3DZwYM = {
            "id" = "1U3DZwYM";
            "file" = "MasaGadget-mc1.17.1-fabric-4.0.403-development.jar";
            "hash" = "sha512-PgSoEwlbTL20v5Vr731b1V55LRQ31+WuC26DSC86yVTs+rrgcidDkvQ52g24iPUFM13wIJlYL/ZhP6taZqG04g==";
        };
        _Cipl8F1d = {
            "id" = "Cipl8F1d";
            "file" = "MasaGadget-mc1.20.4-fabric-4.0.403-development.jar";
            "hash" = "sha512-wa2pawTyNogfJPFPd4dkGrs6Xg068tErBTztslu1thRIhGKOxSAg+laIqFNq7XEBAEFUuFALEHJktWvkazkr0w==";
        };
        _F9xsQPBX = {
            "id" = "F9xsQPBX";
            "file" = "MasaGadget-mc1.21.3-fabric-4.0.403-development.jar";
            "hash" = "sha512-+7JIIkNN4XF8cJJy/TP06XWdI5x1ng1no2FK2p7ysaI3dWALY/ynr3SsuQbmsPmJb6lPwhRZkgYuPmU1WCKXbg==";
        };
        _A3zdVkta = {
            "id" = "A3zdVkta";
            "file" = "MasaGadget-mc1.18.2-fabric-4.0.403-development.jar";
            "hash" = "sha512-LQwScRQlKDO/ylEad52+UAvcWuTuBHW+xgaevegtPU3Af96VoUCXp49k+MkIrPLayQOT3azALaW6w7vmWl4fww==";
        };
        _qhj6MvWO = {
            "id" = "qhj6MvWO";
            "file" = "MasaGadget-mc1.19.3-fabric-4.0.403-development.jar";
            "hash" = "sha512-MrUcD/CLRQLIF9SQSfyKesjYXvfDYruJ7FlFxxjphJvSMA4sqFnYR+n/k3mGgfxAowpctbjH86272xJpVN7FlQ==";
        };
        _duexSSBN = {
            "id" = "duexSSBN";
            "file" = "MasaGadget-mc1.15.2-fabric-4.0.403-development.jar";
            "hash" = "sha512-vpu1XQAB/KIlJENpodtAdGbXZtDlgjPz/NGAeQQkRyiPod9Zlf5FmynzDbckXfH7bFQVUYqtXmVvplwj5ZEuuA==";
        };
        _aeGzBiNq = {
            "id" = "aeGzBiNq";
            "file" = "MasaGadget-mc1.16.5-fabric-4.0.403-development.jar";
            "hash" = "sha512-jCLgAwh40Y9ZIJD5aOEzHvMLyQlbZQ7xdee4fVMWQvlJpzTZBK7sQR6eqAXN56jADYCi5ooLul3B6gwmZEA9IQ==";
        };
        _VTuhd5Zg = {
            "id" = "VTuhd5Zg";
            "file" = "MasaGadget-mc1.21.8-fabric-4.0.403-development.jar";
            "hash" = "sha512-+X+yX0k3kY72dnBLYbZIQ4ffNy0e5pts0ldQEiwMZN7zmRpNdgUGC3Xb+i9Jl/LJXSto/jtoYGd0NAkjwTDvvA==";
        };
        _6qf9QD0I = {
            "id" = "6qf9QD0I";
            "file" = "MasaGadget-mc1.21.5-fabric-4.0.403-development.jar";
            "hash" = "sha512-kqZJsvqH66uN7EclU62Uh/YLdCDtV6mb0VmpnROTRGWS03PkVBrm8+jNJVFQbC6kpma0CsyXP2Smw29UOOwpBA==";
        };
        _V1yiHngX = {
            "id" = "V1yiHngX";
            "file" = "MasaGadget-mc1.14.4-fabric-4.0.403-development.jar";
            "hash" = "sha512-WjPAtj0P2JH+kt82Gxp4kQGytjK0X0hihMLJLED/6/58PB+mAC7NsTnE9f8AeuFRayeD4DhcQvC3/h8e5wDiRQ==";
        };
        _wCj7bqRu = {
            "id" = "wCj7bqRu";
            "file" = "MasaGadget-mc1.20.1-fabric-4.0.403-development.jar";
            "hash" = "sha512-uqWi+oZuGYXYV+Tm0Ohe3bJnUMGRAxd86lvpDM/h9UUJOUNn61U1wU2DwIeq1cny26cEdUO1ATkgt9VjHkbzTA==";
        };
        _yEyiE6Iv = {
            "id" = "yEyiE6Iv";
            "file" = "MasaGadget-mc26.2-fabric-4.0.403-development.jar";
            "hash" = "sha512-7qdnpYJXZsImoPq8CdI0HofwASLJ4Y94syi0FUyE3njXW/Ia/fgMljbCnOlM4lCyAxKyCzNyi+PpYBHAETBEmw==";
        };
        _G5ZJKz0C = {
            "id" = "G5ZJKz0C";
            "file" = "MasaGadget-mc1.20.6-fabric-4.0.403-development.jar";
            "hash" = "sha512-vxvAF7KYR1AcTz++5Uxcaqe7bmnJsmFPbmmv16+hLmTREfXqJ5K8vI909pl7NGicANE8US81PkFjStCqXJ6RfA==";
        };
        _MnOdVvhB = {
            "id" = "MnOdVvhB";
            "file" = "MasaGadget-mc1.21.1-fabric-4.0.403-development.jar";
            "hash" = "sha512-ZZKp/r8VlS5e4LeXDbKG9aEVtDKXyuKZhScb2PAwM+d9a8UZdxXzZfd8sZaCN7FpzuyN7R/SG8jjdQ1D9rkHeg==";
        };
        _CnTe7hmZ = {
            "id" = "CnTe7hmZ";
            "file" = "MasaGadget-mc1.20.2-fabric-4.0.403-development.jar";
            "hash" = "sha512-WZrwvNUG6WDqIWWIDe/tIfnVzA5Ot0hKojm1liKws38MO/h2DFqpNN5+DZMSJbTuUJ69OOOE6L2uqF7o1j0s/g==";
        };
    in {
        "10D6twA1" = _10D6twA1;
        "siL1gZgQ" = _siL1gZgQ;
        ...
        "MnOdVvhB" = _MnOdVvhB;
        "CnTe7hmZ" = _CnTe7hmZ;
        "fabric-1.17.1" = _1U3DZwYM;
        "fabric-1.19.2" = _hoCuFSik;
        "fabric-1.14.4" = _V1yiHngX;
        "fabric-1.20.1" = _wCj7bqRu;
        "fabric-1.19.3" = _qhj6MvWO;
        "fabric-1.21" = _MnOdVvhB;
        "fabric-1.21.1" = _MnOdVvhB;
        "fabric-1.19.4" = _E1y10Rtk;
        "fabric-1.21.2" = _F9xsQPBX;
        "fabric-1.21.3" = _F9xsQPBX;
        "fabric-1.15.2" = _duexSSBN;
        "fabric-1.18.2" = _A3zdVkta;
        "fabric-1.20.5" = _G5ZJKz0C;
        "fabric-1.20.6" = _G5ZJKz0C;
        "fabric-1.16.5" = _aeGzBiNq;
        "fabric-1.20.2" = _CnTe7hmZ;
        "fabric-1.20.3" = _Cipl8F1d;
        "fabric-1.20.4" = _Cipl8F1d;
        "fabric-1.21.4" = _IOpAgd9A;
        "fabric-1.21.5" = _6qf9QD0I;
        "fabric-1.21.6" = _VTuhd5Zg;
        "fabric-1.21.7" = _VTuhd5Zg;
        "fabric-1.21.8" = _VTuhd5Zg;
        "fabric-26.1" = _XVPj6pOz;
        "fabric-26.1.1" = _XVPj6pOz;
        "fabric-26.1.2" = _XVPj6pOz;
        "fabric-26.2" = _yEyiE6Iv;
        "quilt-1.17.1" = _1U3DZwYM;
        "quilt-1.19.2" = _hoCuFSik;
        "quilt-1.14.4" = _V1yiHngX;
        "quilt-1.20.1" = _wCj7bqRu;
        "quilt-1.19.3" = _qhj6MvWO;
        "quilt-1.21" = _MnOdVvhB;
        "quilt-1.21.1" = _MnOdVvhB;
        "quilt-1.19.4" = _E1y10Rtk;
        "quilt-1.21.2" = _F9xsQPBX;
        "quilt-1.21.3" = _F9xsQPBX;
        "quilt-1.15.2" = _duexSSBN;
        "quilt-1.18.2" = _A3zdVkta;
        "quilt-1.20.5" = _G5ZJKz0C;
        "quilt-1.20.6" = _G5ZJKz0C;
        "quilt-1.16.5" = _aeGzBiNq;
        "quilt-1.20.2" = _CnTe7hmZ;
        "quilt-1.20.3" = _Cipl8F1d;
        "quilt-1.20.4" = _Cipl8F1d;
        "quilt-1.21.4" = _IOpAgd9A;
        "quilt-1.21.5" = _6qf9QD0I;
        "quilt-1.21.6" = _VTuhd5Zg;
        "quilt-1.21.7" = _VTuhd5Zg;
        "quilt-1.21.8" = _VTuhd5Zg;
        "quilt-26.1" = _XVPj6pOz;
        "quilt-26.1.1" = _XVPj6pOz;
        "quilt-26.1.2" = _XVPj6pOz;
        "quilt-26.2" = _yEyiE6Iv;
        ...
        "pkg-v4.0.403-mc1.19.2-fabric" = _hoCuFSik;
        "pkg-v4.0.403-mc1.21.4-fabric" = _IOpAgd9A;
        "pkg-v4.0.403-mc1.19.4-fabric" = _E1y10Rtk;
        "pkg-v4.0.403-mc1.17.1-fabric" = _1U3DZwYM;
        "pkg-v4.0.403-mc1.20.4-fabric" = _Cipl8F1d;
        "pkg-v4.0.403-mc1.21.3-fabric" = _F9xsQPBX;
        "pkg-v4.0.403-mc1.18.2-fabric" = _A3zdVkta;
        "pkg-v4.0.403-mc1.19.3-fabric" = _qhj6MvWO;
        "pkg-v4.0.403-mc1.15.2-fabric" = _duexSSBN;
        "pkg-v4.0.403-mc1.16.5-fabric" = _aeGzBiNq;
        "pkg-v4.0.403-mc1.21.8-fabric" = _VTuhd5Zg;
        "pkg-v4.0.403-mc1.21.5-fabric" = _6qf9QD0I;
        "pkg-v4.0.403-mc1.14.4-fabric" = _V1yiHngX;
        "pkg-v4.0.403-mc1.20.1-fabric" = _wCj7bqRu;
        "pkg-v4.0.403-mc26.2-fabric" = _yEyiE6Iv;
        "pkg-v4.0.403-mc1.20.6-fabric" = _G5ZJKz0C;
        "pkg-v4.0.403-mc1.21.1-fabric" = _MnOdVvhB;
        "pkg-v4.0.403-mc1.20.2-fabric" = _CnTe7hmZ;
        "default" = _CnTe7hmZ;
    });
