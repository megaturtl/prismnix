...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _AOQ5CBUt;
        "pkg-1.1.0+mod" = _Q7pNCaCl;
        "pkg-1.1.1" = _UakkOE4G;
        "pkg-1.1.1+mod" = _gp8ZmBxb;
        "pkg-1.1.2" = _nBe0IbcQ;
        "pkg-1.1.2+mod" = _NNx2PNq0;
        "pkg-1.1.3" = _qbwSmmt5;
        "pkg-1.1.3+mod" = _CabC9bTL;
        "pkg-1.1.4" = _hdHv9yF0;
        "pkg-1.1.4+mod" = _hjmfX70N;
        "pkg-1.1.5" = _ePGxSmtL;
        "pkg-1.1.5+mod" = _ppKH1AKt;
        "pkg-1.1.6" = _2QHbtih8;
        "pkg-1.1.6+mod" = _TRecYVrt;
        "pkg-1.2.0" = _wLHz9Pjk;
        "pkg-1.2.0+mod" = _G3ES8xYp;
        "pkg-1.2.1" = _MpQpzgUF;
        "pkg-1.2.1+mod" = _HwohhWy4;
        "pkg-1.2.2" = _Lq4eJgwE;
        "pkg-1.2.2+mod" = _vG6z829L;
        "pkg-1.2.3" = _9OtH8poI;
        "pkg-1.2.3+mod" = _yKSWnwyo;
        "pkg-1.2.4" = _hL0kjDut;
        "pkg-1.2.4+mod" = _XeCXp1G4;
        "pkg-1.2.5" = _cEYZbZNk;
        "pkg-1.2.5+mod" = _DCJKgRuE;
        "pkg-1.2.6" = _c5IKNtpa;
        "pkg-1.2.6+mod" = _E0tuOBpz;
        "pkg-1.2.7" = _cIEPe2bL;
        "pkg-1.2.7+mod" = _2BnmAk3j;
        "pkg-1.3.0" = _DohQOpHl;
        "pkg-1.3.0+mod" = _guBfHOaQ;
        "pkg-1.3.1" = _jAsH1wYz;
        "pkg-1.3.1+mod" = _NDUcCSWU;
        "pkg-1.3.2" = _QEt6Cq4g;
        "pkg-1.3.2+mod" = _ueKwn5CJ;
        "pkg-1.4.0" = _hstHLwXc;
        "pkg-1.4.0+mod" = _FnobJDha;
        "pkg-1.4.1" = _AmvS9rez;
        "pkg-1.4.1+mod" = _dlYCdaGd;
        "pkg-1.4.2" = _3BhWORJO;
        "pkg-1.4.2+mod" = _qZqzZZTk;
        "pkg-1.4.3" = _2QR1Lyuc;
        "pkg-1.4.3+mod" = _CtdIZ1Gc;
        "pkg-1.5.0" = _gnGAlT3U;
        "pkg-1.5.0+mod" = _j9yywYXm;
        "pkg-1.5.1" = _NTccCMGT;
