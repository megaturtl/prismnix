...
let
    versions = (let
        ...
        _Y5KRAuO6 = {
            "id" = "Y5KRAuO6";
            "file" = "MorePowerGems-2.5.5.1.jar";
            "hash" = "sha512-a0xYlM4Sf0QRhj7NSgjB3mXGnYGnaM6Ia/zqKGOQJXyIcywuGkYlt6XGuzr0ztwtG9G+yGBeimkscREshJnbZQ==";
        };
    in {
        "JMSQLOKS" = _JMSQLOKS;
        "g0uUAmxY" = _g0uUAmxY;
        ...
        "XPVwy1DP" = _XPVwy1DP;
        "Y5KRAuO6" = _Y5KRAuO6;
        "paper-1.21" = _Y5KRAuO6;
        "paper-1.21.1" = _Y5KRAuO6;
        "paper-1.21.2" = _Y5KRAuO6;
        "paper-1.21.3" = _Y5KRAuO6;
        "paper-1.21.4" = _Y5KRAuO6;
        "paper-1.21.5" = _Y5KRAuO6;
        "paper-1.21.6" = _Y5KRAuO6;
        "paper-1.21.7" = _Y5KRAuO6;
        "paper-1.21.8" = _Y5KRAuO6;
        "paper-1.21.9" = _Y5KRAuO6;
        "paper-1.21.10" = _Y5KRAuO6;
        "paper-1.21.11" = _Y5KRAuO6;
        "paper-26.1" = _Y5KRAuO6;
        "paper-26.1.1" = _Y5KRAuO6;
        "paper-26.1.2" = _Y5KRAuO6;
        "paper-26.2" = _Y5KRAuO6;
        ...
        "purpur-1.21" = _Y5KRAuO6;
        "purpur-1.21.1" = _Y5KRAuO6;
        "purpur-1.21.2" = _Y5KRAuO6;
        "purpur-1.21.3" = _Y5KRAuO6;
        "purpur-1.21.4" = _Y5KRAuO6;
        "purpur-1.21.5" = _Y5KRAuO6;
        "purpur-1.21.6" = _Y5KRAuO6;
        "purpur-1.21.7" = _Y5KRAuO6;
        "purpur-1.21.8" = _Y5KRAuO6;
        "purpur-1.21.9" = _Y5KRAuO6;
        "purpur-1.21.10" = _Y5KRAuO6;
        "purpur-1.21.11" = _Y5KRAuO6;
        "purpur-26.1" = _Y5KRAuO6;
        "purpur-26.1.1" = _Y5KRAuO6;
        "purpur-26.1.2" = _Y5KRAuO6;
        "purpur-26.2" = _Y5KRAuO6;
        ...
        "pkg-1.0" = _JMSQLOKS;
        "pkg-1.0.0.0" = _g0uUAmxY;
        "pkg-1.1.0.0" = _SOSPsxUD;
        "pkg-1.1.1.0" = _yAPui41t;
        "pkg-1.1.2.0" = _gKK0Z78P;
        "pkg-2.1.2.0" = _85JypyO2;
        "pkg-2.1.3.0" = _Muck1J7s;
        "pkg-2.1.3.1" = _k2TND94o;
        "pkg-2.1.4.0" = _3HU63FUx;
        "pkg-2.1.4.1" = _bMYaBXsH;
        "pkg-2.1.4.2" = _f29Lt5Ds;
        "pkg-2.1.4.3" = _ssHJh8w1;
        "pkg-2.5.4.3" = _nfDxWA7y;
        "pkg-2.5.5.0" = _XPVwy1DP;
        "pkg-2.5.5.1" = _Y5KRAuO6;
        "default" = _Y5KRAuO6;
    });
