...
let
    ...
    in {
        ...
        "pkg-1.16.5-0.5.4" = _BpXghhio;
        "pkg-1.19.4-0.5.4" = _FZPA3k21;
        "pkg-1.19.4-0.5.5" = _vUtO7qT3;
        "pkg-1.19.4-0.5.6" = _HSCX18eJ;
        "pkg-1.19.4-0.5.7" = _HxnULAJL;
        "pkg-1.19.4-0.5.8" = _ZQq2XlEF;
        "pkg-1.19.4-0.5.9" = _FFXqBbxj;
        "pkg-1.19.4-0.5.10" = _NySiT225;
        "pkg-1.19.4-0.5.11" = _GaPNhCZC;
        "pkg-1.19.4-0.6.0" = _jDXlcLpa;
        "pkg-1.19.4-0.6.1" = _VkLOgsg7;
        "pkg-1.19.4-0.6.2" = _zPeHFizp;
        "pkg-1.20-0.6.2" = _NPuj9hDG;
        "pkg-1.20-0.6.3" = _rxdGpzhh;
        "pkg-1.20.1-0.6.4" = _AZK6hEJI;
        "pkg-1.20.1-0.6.5" = _j0ut5hme;
        "pkg-1.19.4-0.6.5" = _bYhlX6xV;
        "pkg-1.20.1-0.7.0.B1" = _ptjECl1n;
        "pkg-1.20.1-0.7.0-BETA2" = _d3FoAjEs;
        "pkg-1.20.1-0.7.0-BETA9" = _uyZfBaow;
        "pkg-1.20.1-0.7.0" = _pAnANVoV;
        "pkg-1.20.1-0.7.1" = _IoeAQKao;
        "pkg-1.20.1-0.7.2" = _tV5hN0Qp;
        "pkg-1.20.1-0.7.3" = _dp8RXUJd;
        "pkg-1.20.1-0.7.4" = _vYlRUeUw;
        "pkg-1.20.1-0.7.5" = _w4kqgCkC;
        "pkg-1.20.1-0.7.6" = _lmv41Jtn;
        "pkg-1.20.1-0.7.7" = _WHSd8C6I;
        "pkg-1.20.1-0.7.8" = _wml1tQ1b;
        "pkg-1.20.1-0.7.9" = _vGlnYIyP;
        "pkg-1.20.1-0.7.10" = _dKvqcLCL;
        "pkg-1.20.1-0.7.11" = _lEYrtSpp;
        "pkg-1.20.1-0.7.12" = _Ph2NAnbB;
        "pkg-1.20.1-0.7.13" = _JRVvSUqp;
        "pkg-1.20.1-0.7.15" = _wImGu6U6;
        "pkg-1.20.1-0.7.16" = _q8oNCG0L;
        "pkg-1.20.1-0.7.17" = _o4lc6LC9;
        "pkg-1.20.1-0.7.18" = _AhRT7mL4;
        "pkg-1.20.1-0.7.19" = _aakcOKAt;
        "pkg-1.20.1-0.7.20" = _YNEZvc6e;
        "pkg-1.20.1-0.7.22" = _H4sdsS1N;
        "pkg-1.20.1-0.7.23" = _17mB3sVq;
        "pkg-1.20.1-0.7.24" = _JNi9lrOO;
        "pkg-1.20.1-0.8.0-PreRelease-1" = _gnuhReGK;
        "pkg-1.20.1-0.8.0-PreRelease-6" = _4tmc6DeC;
        "pkg-1.20.1-0.8.0" = _vv5AGizM;
        "pkg-1.19.4-0.8.0" = _xp9MRFBv;
        "pkg-1.19.2-0.8.0" = _ARSGLzEX;
        "pkg-1.19.4-0.8.1" = _WpRU4vN2;
        "pkg-1.19.2-0.8.1" = _vc4P1Eia;
        "pkg-1.20.1-0.8.4" = _YaKQZSrH;
        "pkg-1.20.1-0.8.6" = _hHwxUmAb;
        "pkg-1.20.1-0.8.7" = _bNkTszkF;
        "pkg-1.20.1-0.8.9" = _w8bvYE73;
        "pkg-1.20.1-0.9.0-Beta1" = _XsSGZ5zB;
        "pkg-1.20.1-0.9.0-Beta2" = _8Wq5Q8Wb;
        "pkg-1.20.1-0.9.0-Beta3" = _5uYOsJ90;
        "pkg-1.20.1-0.9.0-Beta4" = _YHNfwim7;
        "pkg-1.20.1-0.9.0-Beta5" = _lrk3DJKE;
        "pkg-1.20.1-0.9.0" = _QicMZlL6;
        "pkg-1.20.1-0.9.1" = _dTRihP3l;
        "pkg-1.20.1-0.9.2" = _My6Pd00v;
        "pkg-1.20.1-0.9.3" = _2GJJbesv;
        "pkg-1.20.1-0.9.4" = _nmW3wJoO;
        "pkg-1.20.1-0.9.6" = _4j3TyQBv;
        "pkg-1.20.1-0.9.7" = _eSFYvG1I;
        "pkg-1.20.1-0.9.8" = _lPeFqZek;
        "pkg-1.20.1-0.9.9" = _5V1cbJzn;
        "pkg-1.20.1-0.9.10" = _lBFKzEPZ;
        "pkg-1.20.1-0.9.11" = _jZL5Sb2r;
        "pkg-1.20.1-0.9.12" = _C2xssF5G;
        "pkg-1.20.1-0.9.13" = _ZH1phU9d;
        "pkg-1.20.1-0.9.14" = _I89X8sj9;
        "pkg-1.20.1-0.9.15" = _2Ix5If0W;
        "pkg-1.20.1-0.9.16" = _YGoUlSfA;
        "pkg-1.20.1-0.9.17" = _ycX9jG3m;
        "pkg-1.20.1-0.9.18" = _FMSFDfHF;
        "pkg-1.20.1-0.9.19" = _wg0mLRXg;
        "pkg-1.20.1-0.9.20" = _fyy09THp;
        "pkg-1.20.1-0.9.22" = _rimKVY6y;
        "pkg-1.20.1-0.9.23" = _hXZR0Pev;
        "pkg-1.20.1-0.9.24" = _2MoikeNU;
        "pkg-1.20.1-0.9.25" = _SwEbf8JA;
        "pkg-1.20.1-0.9.26" = _JMvKJZOl;
        "pkg-1.20.1-0.9.27" = _8mFjqTgX;
        "pkg-1.20.1-0.9.28" = _AjaDlAHb;
        "pkg-1.20.1-0.9.29" = _raoov3RP;
        "pkg-1.20.1-0.9.30" = _Klee5sxl;
        "pkg-1.20.1-0.9.31" = _TWLou8zA;
        "pkg-1.20.1-0.9.32" = _n1WSoo7G;
        "pkg-1.20.1-0.9.33" = _3tzQCO5w;
        "pkg-1.20.1-0.9.34" = _Y0nCPWKj;
        "pkg-1.20.1-0.9.35" = _EMMmoUYn;
        "pkg-1.20.1-0.9.36" = _GmgMLNmc;
        "pkg-1.20.1-0.9.37" = _5lzf2Nag;
        "pkg-1.20.1-0.9.38" = _oBw7rrTi;
        "pkg-1.20.1-0.9.39" = _yN5o8fum;
        "pkg-1.20.1-0.9.40" = _ZbrfiGJp;
        "pkg-1.20.1-0.9.41" = _hu02PwBI;
        "pkg-1.20.1-0.10.0" = _9vD5nfe8;
        "pkg-1.20.1-0.10.1" = _Eh5RdhT7;
        "pkg-1.20.1-0.10.2" = _6zYEdUYx;
        "pkg-1.20.1-0.10.3" = _MWb34wLu;
        "pkg-1.20.1-0.10.4" = _NUMWePEf;
        "pkg-1.20.1-0.10.5" = _YTE9lu8n;
        "pkg-1.20.1-0.10.6" = _3TeLn8PY;
        "pkg-1.20.1-0.10.7" = _44GMdUAG;
        "pkg-1.20.1-0.10.8" = _BiNQt4rw;
        "pkg-1.20.1-0.11.0" = _xAsJXnrp;
        "pkg-1.20.1-0.11.1" = _m2bfpvIC;
        "pkg-1.20.1-0.11.2" = _ACl8suLe;
        "pkg-1.20.1-0.11.3" = _zdclFb9J;
        "pkg-1.20.1-0.11.4" = _THtdXmZo;
        "pkg-1.20.1-0.11.5" = _F0yzq71s;
        "pkg-1.20.1-0.11.6" = _Vl0suKw7;
        "pkg-1.20.1-0.11.7" = _J3EQvF1A;
        "pkg-1.20.1-0.11.8" = _gERUD6Rm;
        "pkg-1.20.1-0.11.9" = _gCLU4MUn;
        "pkg-1.20.1-0.11.12" = _Xnfd1J0A;
        "pkg-1.20.1-0.11.13" = _cFwmP4Dq;
        "pkg-1.20.1-0.11.14" = _mhugFfvE;
        "pkg-1.20.1-0.11.15" = _zTMGgsLr;
        "pkg-1.20.1-0.12.0" = _oz2TiljO;
        "pkg-1.20.1-0.12.2" = _c0XpNY2J;
        "pkg-1.20.1-0.12.3" = _eQUbGR6o;
