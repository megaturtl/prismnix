...
let
    versions = (let
        ...
        _yvlxC2rF = {
            "id" = "yvlxC2rF";
            "file" = "fzmm-mc26.2-0.2.20.jar";
            "hash" = "sha512-g9jkgeYRf8/uSuQSvmpxZm3RgHvonWt3vdh9m6eRrKdpDnmsWSEdgTzzTmBjBE7XE4KDB0817kC2WT0NErglOQ==";
        };
    in {
        "REabq1FB" = _REabq1FB;
        "mOmLsbqA" = _mOmLsbqA;
        ...
        "fabric-26.2" = _yvlxC2rF;
        "pkg-0.1.0-BETA-2" = _REabq1FB;
        "pkg-0.1.0-BETA-3" = _mOmLsbqA;
        "pkg-0.1" = _au6MmePW;
        "pkg-0.1.1" = _PeQZArtr;
        "pkg-0.1.2" = _6uZYZ2LY;
        "pkg-0.2.0" = _TUh00Muh;
        ...
        "pkg-0.2.7" = _UPTKoai9;
        "pkg-0.2.8" = _JERrv9A6;
        "pkg-0.2.8.1" = _kYeLO2uf;
        "pkg-0.2.7.1" = _lp11y7A3;
        "pkg-0.2.6.1" = _yVPnFKdx;
        "pkg-0.2.9" = _vNuti4WD;
        "pkg-0.2.10" = _hbRgC8mj;
        "pkg-0.2.11-1.20.4" = _qYZvugOP;
        "pkg-0.2.11-1.20.5" = _F0CTR4hN;
        "pkg-0.2.12" = _yrHCh3Vb;
        "pkg-0.2.13-1.20.4" = _8IQ0nmUK;
        "pkg-0.2.13-1.20.6" = _sqWQeIGj;
        "pkg-0.2.13" = _xy6PjCNu;
        "pkg-0.2.14" = _BX4w92og;
        "pkg-0.2.14-1.20.6" = _UZSNnuO7;
        "pkg-0.2.14-1.20.4" = _Kvo08XS0;
        "pkg-0.2.15" = _NWszmVWI;
        "pkg-0.2.15-1.21.1" = _Qwqp8I2H;
        "pkg-0.2.15-1.20.5" = _NOKAgvcq;
        "pkg-0.2.15-1.20.4" = _TL9AH3sP;
        "pkg-0.2.16" = _iRY3JLDD;
        "pkg-0.2.16-1.21.3" = _JfgZAqwy;
        "pkg-0.2.16-1.21" = _FS03hUNd;
        "pkg-0.2.16-1.20.5" = _k6qDXwGF;
        "pkg-0.2.16-1.20.4" = _pSjVCKZR;
        "pkg-0.2.17" = _eJI1mLsY;
        "pkg-0.2.17-1.21.3" = _NHSfHww9;
        "pkg-0.2.17-1.21.1" = _B2AhMwcQ;
        "pkg-0.2.17-1.20.5" = _PMBQCNeA;
        "pkg-0.2.17-1.20.4" = _t1opHH3y;
        "pkg-0.2.18" = _MwhRzsij;
        "pkg-0.2.18-1.21.3" = _H4AStWA7;
        "pkg-0.2.18-1.21.1" = _1XJwgJVF;
        "pkg-0.2.18-1.20.5" = _aCU6rYK5;
        "pkg-0.2.18-1.20.4" = _tBE8ELxI;
        "pkg-0.2.19" = _ytUsfta7;
        "pkg-0.2.19-1.21.4" = _BqFyxqQl;
        "pkg-0.2.19-1.21.1" = _1jqpeM0v;
        "pkg-0.2.19-1.20.4" = _QLm5RzJt;
        "pkg-0.2.19-1.21.8" = _wEYfYS7c;
        "pkg-0.2.20" = _hlehALsB;
        "pkg-0.2.20-1.21.8" = _BEfTEpCs;
        "pkg-0.2.20-1.21.5" = _XszIgISS;
        "pkg-0.2.20-1.21.4" = _l5SAtF7o;
        "pkg-0.2.20-1.21.1" = _zMVOZ9nA;
        "pkg-0.2.20-1.20.4" = _iOjbWYq3;
        "pkg-0.2.20-1.21.11" = _VvWW6W10;
        "pkg-0.2.20-26.1.1" = _9CN4Xrlj;
        "pkg-0.2.20-26.2" = _yvlxC2rF;
        "default" = _yvlxC2rF;
    });
