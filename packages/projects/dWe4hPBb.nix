...
let
    ...
    in {
        ...
        "pkg-0.1.8" = _IMA9F4i1;
        "pkg-0.1.9" = _M7fiVtEJ;
        "pkg-0.2.0-1.20.1" = _eqiA5lxC;
        "pkg-0.2.2-1.20.1" = _QJ1QX30a;
        "pkg-0.2.3-1.20.1" = _cNNGkn1h;
        "pkg-0.2.4-1.20.1" = _DWzRcghM;
        "pkg-0.3.0-1.20.1" = _t7ouY8vc;
        "pkg-0.3.1-1.20.1" = _d4Jv8AFB;
        "pkg-0.3.2-1.20.1" = _MtsmHSp2;
        "pkg-0.3.3-1.20.1" = _T0rDaDzn;
        "pkg-0.3.4-1.20.1" = _qKPP3qVC;
        "pkg-0.4.0-1.20.1" = _KqHD2ifL;
        "pkg-0.4.1-1.20.1" = _TGljSYS5;
        "pkg-0.4.2-1.20.1" = _ApwqMkVH;
        "pkg-0.4.3-1.20.1" = _RmBBeMsc;
        "pkg-0.4.4-1.20.1" = _KrNUhTti;
        "pkg-0.4.5-1.20.1" = _zlEb9S6s;
        "pkg-0.4.6-1.20.1" = _v1UeNzNF;
        "pkg-0.4.7-1.20.1" = _YEwYadCF;
        "pkg-0.4.8-1.20.1" = _54zAFkXi;
        "pkg-0.4.9-1.20.1" = _4mKKa0y6;
        "pkg-1.0.0RC2-1.20.1" = _7ASTIG4A;
        "pkg-1.0.0RC2-1.18.2" = _M0VMkTJb;
        "pkg-1.0.0RC2-1.19.2" = _VfxGJ9gL;
        "pkg-1.0.0RC2-1.20.2" = _uRF5SaRy;
        "pkg-1.0.0RC2-1.20.3" = _gO7Bysri;
        "pkg-1.0.0RC2-1.20.4" = _Ptgc7J7U;
        "pkg-1.0.0RC2-1.20.6" = _8fgNfQsu;
        "pkg-1.0.0RC2-1.21.1" = _IxNwlxMf;
        "pkg-1.0.0RC2-1.21.3" = _eLt31sBD;
        "pkg-1.0.0RC2-1.21.4" = _BSC8rWBN;
        "pkg-1.0.0RC3-1.20.1" = _IsfJdRbO;
        "pkg-1.0.0RC2-1.21.0" = _WIfXi3a7;
        "pkg-1.0.0RC4-1.20.1" = _hlGt9Wet;
        "pkg-1.0.0RC5-1.20.1" = _sW1PtRRY;
        "pkg-1.0.0RC5-1.20.2" = _rGiJ4jKj;
        "pkg-1.0.0RC5-1.20.3" = _1xpaVuV3;
        "pkg-1.0.0RC5A-1.20.1" = _Jqiswk6t;
        "pkg-1.0.0RC5B-1.20.1" = _1q4gjayH;
        "pkg-1.0.0RC2B-1.18.2" = _tBdD9eV4;
        "pkg-1.0.0RC2B-1.19.2" = _WvzxpPm1;
        "pkg-1.0.1-1.20.1" = _4FKpOcJD;
        "pkg-1.0.2-1.20.1" = _d5oHypBT;
        "pkg-1.0.3-1.20.1" = _KwvmS9PV;
        "pkg-1.0.4-1.20.1" = _CBE6IMel;
        "pkg-1.0.5-1.20.1" = _5NAQviZK;
        "pkg-1.0.6-1.20.1" = _cCe6i3yS;
        "pkg-1.0.7-1.20.1" = _XHfPt6xr;
        "pkg-1.0.8-1.20.1-forge" = _ISsveki5;
        "pkg-1.0.9.013-1.20.1-forge" = _mPniw0J5;
        "pkg-1.1.0.014-1.20.1-forge" = _O8FFpKaA;
        "pkg-1.1.0.015-1.20.1-forge" = _kLqPiTq7;
        "pkg-1.1.0.016-1.20.1-forge" = _WID2QGW9;
        "pkg-1.1.0.017-1.20.1-forge" = _htIjVsCZ;
        "pkg-1.1.0.018-1.20.1-forge" = _vm0UDpoo;
        "pkg-1.1.0.019-1.20.1-forge" = _o2AlfgcR;
        "pkg-1.1.0.020-1.21.1-neoforge" = _a2uttm7Y;
        "pkg-1.1.0.020-1.20.1-forge" = _J25Tpt7o;
        "pkg-1.1.0.021-1.20.1-forge" = _QFIqmH1p;
        "pkg-1.1.0.022-1.20.1-forge" = _8B1DS7NA;
        "pkg-1.1.1.001-1.20.1-forge" = _uULashxZ;
        "pkg-1.1.1.002-1.20.1-forge" = _NWQbNX18;
        "pkg-1.1.1.003-1.20.1-forge" = _99M3Chfg;
