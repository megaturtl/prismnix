...
let
    ...
    in {
        ...
        "pkg-1.2.3" = _tV8klf9i;
        "pkg-1.2.4" = _KUYqWYn2;
        "pkg-1.2.5+1.21.4" = _vDMsCpHG;
        "pkg-1.2.6+1.21.5" = _1VLJMrkO;
        "pkg-1.2.7+1.21.8-HOTFIX.1" = _sP1bWEmx;
        "pkg-1.2.7+1.21.8-HOTFIX.2" = _J8Eo2iCq;
        "pkg-1.3.0+1.21.8" = _lJjLlGJM;
        "pkg-1.3.1+1.21.8" = _1xfKhbQx;
        "pkg-1.3.2+1.21.10" = _DlDRGQla;
        "pkg-1.3.3+1.21.11" = _b4ydJx0m;
        "pkg-1.3.4+1.21.11" = _l6nU5hbQ;
        "pkg-1.3.5+1.21.11" = _Ng1TcSLT;
        "pkg-1.4.0+1.21.11" = _8ObsUA8q;
        "pkg-1.4.1+1.21.11" = _c0jZwenV;
        "pkg-1.4.2+1.21.11" = _gV0PklUS;
