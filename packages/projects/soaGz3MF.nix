...
let
    versions = (let
        ...
        _jycwMbYS = {
            "id" = "jycwMbYS";
            "file" = "hide-body-parts-1.1.0-1.20.1.jar";
            "hash" = "sha512-49n1zpWt2CMxAnDIgyYsTSxTe7r5hNKZ7BSSNwmyulJYdv8YLJvEDo38gpbbtN3M46MIEQ6bKNUYqFDIJyK/XA==";
        };
    in {
        "69lE1Fkf" = _69lE1Fkf;
        "AJEvG59y" = _AJEvG59y;
