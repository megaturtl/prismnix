...
let
    versions = (let
        ...
        _2yMJPJK9 = {
            "id" = "2yMJPJK9";
            "file" = "forcemaster_rpg-neoforge-3.1.1+1.21.1.jar";
            "hash" = "sha512-Na1fU/4n4eQvpO0jwro8tCrm9SWXu2/Im4jEMG24c9poMsR4CySffxKFSnHarBMWk2hVTL1x1KEjSkfOXYq/CQ==";
        };
        _bxCnGsxg = {
            "id" = "bxCnGsxg";
    ...
    in {
        ...
        "pkg-1.1.0" = _BbyOjyJa;
        "pkg-1.1.1" = _eiGpmSFd;
        "pkg-2.0.0-1.21" = _iHVXNUQv;
        "pkg-2.0.1-1.21" = _sTrdx2op;
        "pkg-2.0.2-1.21" = _lM0xn9MI;
        "pkg-2.0.3-1.21" = _7RCmCl9q;
        "pkg-2.1.0-1.21" = _AGKqAP2N;
        "pkg-2.1.1-1.21" = _UzAfVrVi;
        "pkg-1.1.2" = _B6q87kzD;
        "pkg-2.1.3-1.21" = _VMY0uhPs;
        "pkg-1.1.3-1.20.1" = _oCR21XZK;
        "pkg-2.2.0-1.21" = _vQLAHQmT;
        "pkg-2.2.1-1.21" = _yjsSwT0d;
        "pkg-2.3.0-1.21" = _ZjGZfGuY;
        "pkg-1.2.0-1.20.1" = _ZwN7IBkC;
        "pkg-1.2.1-1.20.1" = _EwGENIIY;
        "pkg-2.4.0-1.21" = _81QnBeO1;
        "pkg-2.4.1-1.21" = _mDc3Ge8L;
        "pkg-2.4.2-1.21" = _tVOPeQ8H;
        "pkg-2.4.3-1.21" = _U2dRSw5e;
        "pkg-2.4.4-1.21" = _eZtmrqE5;
        "pkg-2.4.5-1.21" = _5axWJwTF;
        "pkg-2.4.6-1.21" = _uDvXTFh6;
        "pkg-2.4.7-1.21" = _Jyt3b1Xb;
        "pkg-1.2.2-1.20.1" = _eCM4hUmE;
        "pkg-2.4.8-1.21" = _uqwkCUkN;
        "pkg-2.4.9-1.21" = _8ZhNjEXr;
        "pkg-2.4.10-1.21" = _jSYKmkun;
        "pkg-2.4.11-1.21" = _Y0Bgu7eq;
        "pkg-2.4.12-1.21" = _R91Vr79k;
        "pkg-2.4.13-1.21" = _cztlidjU;
        "pkg-2.4.14-1.21" = _QOydS1bX;
        "pkg-2.4.15-1.21" = _vLm9X1ut;
        "pkg-2.4.16-1.21" = _frBVcfj3;
        "pkg-1.2.3-1.20.1" = _2YkmEbS1;
        "pkg-2.5.0+1.21.1-fabric" = _ET6eDegF;
        "pkg-2.5.0+1.21.1-neoforge" = _k4HABVGg;
        "pkg-2.5.1+1.21.1-neoforge" = _uFPxLxfY;
        "pkg-2.5.1+1.21.1-fabric" = _uoolyHl4;
        "pkg-1.2.4-1.20.1" = _jPFXJMn9;
        "pkg-2.5.2+1.21.1-fabric" = _mwQ2cfxO;
        "pkg-2.5.2+1.21.1-neoforge" = _GZ3BoKRz;
        "pkg-2.5.3+1.21.1-neoforge" = _pIndwUsB;
        "pkg-2.5.3+1.21.1-fabric" = _9cktt524;
        "pkg-2.5.4+1.21.1-fabric" = _kYE2Piv0;
        "pkg-2.5.4+1.21.1-neoforge" = _caYX9hKZ;
        "pkg-2.5.5+1.21.1-neoforge" = _i2fCw4QB;
        "pkg-2.5.5+1.21.1-fabric" = _ZQqjs94T;
        "pkg-2.6.0+1.21.1-fabric" = _jvOwJGuV;
