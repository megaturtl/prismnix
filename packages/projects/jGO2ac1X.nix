...
let
    versions = (let
        ...
        _iBKLNRkJ = {
            "id" = "iBKLNRkJ";
            "file" = "[1.21.x] Horde Nights v1.3.15.zip";
            "hash" = "sha512-9tclGXu5j2TdyGzEJiNONbc+6aPx1ttemdqJVlJgjRDC4t5fw40t3g5wH13WrZ5MeODViHCfKoVr2iCzIeRxNQ==";
        };
        _ZCjTMGZR = {
            "id" = "ZCjTMGZR";
            "file" = "[1.21.x] Horde Nights v1.3.15.jar";
            "hash" = "sha512-nxKrRgP+8MaiEppXssC6ZBH8fef4O820KwgW1m5c3Je7R9SNyCtfcEscyHu0dfKiujvZLdH9ZA4l4Sd9gnB8/g==";
        };
    in {
        "1qZLFlxS" = _1qZLFlxS;
        "fVLhUqv1" = _fVLhUqv1;
        ...
        "datapack-1.21" = _iBKLNRkJ;
        "datapack-1.21.1" = _iBKLNRkJ;
        "datapack-1.21.2" = _iBKLNRkJ;
        "datapack-1.21.3" = _iBKLNRkJ;
        "datapack-24w44a" = _4RHdQgDc;
        "datapack-24w45a" = _sKjWrMIC;
        "datapack-1.21.4" = _iBKLNRkJ;
        "datapack-1.21.5" = _iBKLNRkJ;
        ...
        "datapack-1.21.6" = _iBKLNRkJ;
        "datapack-1.21.7" = _iBKLNRkJ;
        "datapack-1.21.8" = _iBKLNRkJ;
        ...
        "datapack-1.21.9" = _iBKLNRkJ;
        "datapack-1.21.10" = _iBKLNRkJ;
        "datapack-1.21.11" = _iBKLNRkJ;
        ...
        "fabric-1.21" = _ZCjTMGZR;
        "fabric-1.21.1" = _ZCjTMGZR;
        "fabric-1.21.2" = _ZCjTMGZR;
        "fabric-1.21.3" = _ZCjTMGZR;
        "fabric-24w44a" = _Kr2ZCK92;
        "fabric-24w45a" = _jbg7UUvK;
        "fabric-1.21.4" = _ZCjTMGZR;
        "fabric-1.21.5" = _ZCjTMGZR;
        "fabric-25w15a" = _USiDxhy4;
        "fabric-25w16a" = _USiDxhy4;
        "fabric-25w17a" = _USiDxhy4;
        "fabric-25w18a" = _USiDxhy4;
        "fabric-25w19a" = _USiDxhy4;
        "fabric-1.21.6" = _ZCjTMGZR;
        "fabric-1.21.7" = _ZCjTMGZR;
        "fabric-1.21.8" = _ZCjTMGZR;
        "fabric-25w31a" = _pBmpjrnu;
        "fabric-25w32a" = _pBmpjrnu;
        "fabric-25w33a" = _pBmpjrnu;
        "fabric-25w34a" = _pBmpjrnu;
        "fabric-25w34b" = _pBmpjrnu;
        "fabric-1.21.9" = _ZCjTMGZR;
        "fabric-1.21.10" = _ZCjTMGZR;
        "fabric-1.21.11" = _ZCjTMGZR;
        ...
        "forge-1.21" = _ZCjTMGZR;
        "forge-1.21.1" = _ZCjTMGZR;
        "forge-1.21.2" = _ZCjTMGZR;
        "forge-1.21.3" = _ZCjTMGZR;
        "forge-24w44a" = _Kr2ZCK92;
        "forge-24w45a" = _jbg7UUvK;
        "forge-1.21.4" = _ZCjTMGZR;
        "forge-1.21.5" = _ZCjTMGZR;
        "forge-25w15a" = _USiDxhy4;
        "forge-25w16a" = _USiDxhy4;
        "forge-25w17a" = _USiDxhy4;
        "forge-25w18a" = _USiDxhy4;
        "forge-25w19a" = _USiDxhy4;
        "forge-1.21.6" = _ZCjTMGZR;
        "forge-1.21.7" = _ZCjTMGZR;
        "forge-1.21.8" = _ZCjTMGZR;
        "forge-25w31a" = _pBmpjrnu;
        "forge-25w32a" = _pBmpjrnu;
        "forge-25w33a" = _pBmpjrnu;
        "forge-25w34a" = _pBmpjrnu;
        "forge-25w34b" = _pBmpjrnu;
        "forge-1.21.9" = _ZCjTMGZR;
        "forge-1.21.10" = _ZCjTMGZR;
        "forge-1.21.11" = _ZCjTMGZR;
        ...
        "quilt-1.21" = _ZCjTMGZR;
        "quilt-1.21.1" = _ZCjTMGZR;
        "quilt-1.21.2" = _ZCjTMGZR;
        "quilt-1.21.3" = _ZCjTMGZR;
        "quilt-24w44a" = _Kr2ZCK92;
        "quilt-24w45a" = _jbg7UUvK;
        "quilt-1.21.4" = _ZCjTMGZR;
        "quilt-1.21.5" = _ZCjTMGZR;
        "quilt-25w15a" = _USiDxhy4;
        "quilt-25w16a" = _USiDxhy4;
        "quilt-25w17a" = _USiDxhy4;
        "quilt-25w18a" = _USiDxhy4;
        "quilt-25w19a" = _USiDxhy4;
        "quilt-1.21.6" = _ZCjTMGZR;
        "quilt-1.21.7" = _ZCjTMGZR;
        "quilt-1.21.8" = _ZCjTMGZR;
        "quilt-25w31a" = _pBmpjrnu;
        "quilt-25w32a" = _pBmpjrnu;
        "quilt-25w33a" = _pBmpjrnu;
        "quilt-25w34a" = _pBmpjrnu;
        "quilt-25w34b" = _pBmpjrnu;
        "quilt-1.21.9" = _ZCjTMGZR;
        "quilt-1.21.10" = _ZCjTMGZR;
        "quilt-1.21.11" = _ZCjTMGZR;
        ...
        "neoforge-1.21" = _ZCjTMGZR;
        "neoforge-1.21.1" = _ZCjTMGZR;
        "neoforge-1.21.2" = _ZCjTMGZR;
        "neoforge-1.21.3" = _ZCjTMGZR;
        "neoforge-24w44a" = _Kr2ZCK92;
        "neoforge-24w45a" = _jbg7UUvK;
        "neoforge-1.21.4" = _ZCjTMGZR;
        "neoforge-1.21.5" = _ZCjTMGZR;
        ...
        "neoforge-1.21.6" = _ZCjTMGZR;
        "neoforge-1.21.7" = _ZCjTMGZR;
        "neoforge-1.21.8" = _ZCjTMGZR;
        ...
        "neoforge-1.21.9" = _ZCjTMGZR;
        "neoforge-1.21.10" = _ZCjTMGZR;
        "neoforge-1.21.11" = _ZCjTMGZR;
        ...
        "pkg-0.3" = _utHeiQat;
        "pkg-0.3.1" = _MENAQrYT;
        "pkg-1.0.0-P-1" = _gl5aYLSh;
        "pkg-1.0.0-P-1+mod" = _D4uAaJmK;
        "pkg-1.0.0-Pr2" = _19np74Eu;
        "pkg-1.0.0-Pr2+mod" = _LrVUKEzf;
        "pkg-1.0.0-Pr2a" = _3EPlcisS;
        "pkg-1.0.0-Pr2a+mod" = _fTztC37G;
        "pkg-1.0.0-Pr2b" = _8d4mSFUw;
        "pkg-1.0.0-Pr2b+mod" = _2NWw6zIL;
        "pkg-1.0.0" = _noI384cY;
        "pkg-1.0.0+mod" = _5O2Dunpb;
        "pkg-1.0.1" = _JTd2Lr7D;
        "pkg-1.0.1+mod" = _mWSoreJ3;
        "pkg-1.0.2" = _bE88Yq6o;
        "pkg-1.0.2+mod" = _ZVud4alN;
        "pkg-1.0.3" = _zFgoqGWt;
        "pkg-1.0.3+mod" = _mpHJSdkr;
        "pkg-1.0.4" = _EPE3scg1;
        "pkg-1.0.4+mod" = _1S6OTLLu;
        "pkg-1.0.5" = _nnBI04Aa;
        "pkg-1.0.5+mod" = _EiOwqY0O;
        "pkg-1.0.6" = _6PlXVfTC;
        "pkg-1.0.6+mod" = _ulwTs1Iw;
        "pkg-1.1.0" = _bQ7DdfK0;
        "pkg-1.1.0+mod" = _E8yvCUay;
        "pkg-1.0.7" = _Hz6ts7y2;
        "pkg-1.0.7+mod" = _LdyXjbd5;
        "pkg-1.1.1" = _mvpurM8u;
        "pkg-1.1.1+mod" = _zoWLqWQ8;
        "pkg-1.0.8" = _LBUZ2rAq;
        "pkg-1.0.8+mod" = _BNl1CCmz;
        "pkg-1.1.2" = _sQh6C7IE;
        "pkg-1.1.2+mod" = _C8q2GSWX;
        "pkg-1.1.2a" = _xJmRf1ty;
        "pkg-1.1.2a+mod" = _ACCDBZet;
        "pkg-1.1.3" = _4RHdQgDc;
        "pkg-1.1.3+mod" = _Kr2ZCK92;
        "pkg-1.1.4" = _sKjWrMIC;
        "pkg-1.1.4+mod" = _jbg7UUvK;
        "pkg-1.2.0" = _9Fkye3O1;
        "pkg-1.2.0+mod" = _q4pDXpjE;
        "pkg-1.2.1" = _ChHbMu6x;
        "pkg-1.2.1+mod" = _fJA1eW2Y;
        "pkg-1.0.9" = _ks5XZVA3;
        "pkg-1.0.9+mod" = _Bip4fQ98;
        "pkg-1.0.10" = _ta87DPap;
        "pkg-1.0.10+mod" = _89Y1q4Lj;
        "pkg-1.2.2" = _qShkpciZ;
        "pkg-1.2.2+mod" = _nzkaMD2V;
        "pkg-1.0.10.1" = _wglKoaxB;
        "pkg-1.0.10.1+mod" = _Gp9OZPam;
        "pkg-1.2.2.1" = _DxvzV39G;
        "pkg-1.2.2.1+mod" = _KbULhBuB;
        "pkg-1.0.11" = _5m05fCz8;
        "pkg-1.0.11+mod" = _FOHl5Q8x;
        "pkg-1.2.3" = _AM3ol7bb;
        "pkg-1.2.3+mod" = _SqhrQisR;
        "pkg-1.3.0" = _w5X2pNmg;
        "pkg-1.0.12" = _UNXpozoz;
        "pkg-1.0.12+mod" = _5suallxF;
        "pkg-1.3.1" = _vh3oiaVP;
        "pkg-1.3.2" = _2vxQCA6N;
        "pkg-1.3.3" = _5hHbDy8o;
        "pkg-1.3.3+mod" = _hBq4NXXv;
        "pkg-1.3.4" = _dc7UMoa1;
        "pkg-1.3.4+mod" = _ksL1B2yN;
        "pkg-1.3.4.1" = _USiDxhy4;
        "pkg-1.3.5" = _RBNANRtd;
        "pkg-1.3.6" = _h4xvUyNE;
        "pkg-1.3.6+mod" = _XQafRpu3;
        "pkg-1.3.7" = _WrGlMGFH;
        "pkg-1.3.7+mod" = _X2g968J0;
        "pkg-1.3.10" = _YHaLd5Kf;
        "pkg-1.3.10+mod" = _pBmpjrnu;
        "pkg-1.3.11" = _qzVyAjmr;
        "pkg-1.3.11+mod" = _DEqwAZL1;
        "pkg-1.3.12" = _Vss7IDa1;
        "pkg-1.3.12+mod" = _Dy1RCOXC;
        "pkg-1.0.13" = _qP922TEw;
        "pkg-1.0.13+mod" = _fjRdpgXz;
        "pkg-1.3.13" = _bF7TnuLh;
        "pkg-1.3.13+mod" = _C16j2Yrb;
        "pkg-1.3.14" = _1agISTs5;
        "pkg-1.3.14+mod" = _aUhM6NdB;
        "pkg-1.3.15" = _iBKLNRkJ;
        "pkg-1.3.15+mod" = _ZCjTMGZR;
        "default" = _ZCjTMGZR;
    });
