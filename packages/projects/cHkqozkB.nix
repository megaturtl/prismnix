...
let
    ...
    in {
        ...
        "pkg-0.1.0+fabric" = _hg1Rvvm5;
        "pkg-0.1.0+forge" = _dMXabBbp;
        "pkg-1.0.0+fabric" = _bQH9IIXR;
        "pkg-1.0.0+forge" = _PZAH9MYE;
        "pkg-1.0.0+neoforge" = _WC8ZFlI2;
        "pkg-2.0.0+fabric" = _gQZ8X2We;
        "pkg-2.0.0+forge" = _PYJ4cN45;
        "pkg-2.0.0+neoforge" = _MbrBlqLk;
        "pkg-1.1.0+fabric" = _qA7QiuMi;
        "pkg-1.1.0+forge" = _qiiYMxBJ;
        "pkg-1.1.0+neoforge" = _V3Cdlahf;
        "pkg-0.2.0+fabric" = _zEsOkQtd;
        "pkg-0.2.0+forge" = _ODLTcKiU;
        "pkg-2.1.0+fabric" = _QxhqhLEc;
        "pkg-2.1.0+forge" = _pTVVh7Lb;
        "pkg-2.1.0+neoforge" = _eDX6Vb11;
        "pkg-1.2.0+fabric" = _vpCuYHCB;
        "pkg-1.2.0+forge" = _9igW33tD;
        "pkg-1.2.0+neoforge" = _IQqy5skk;
        "pkg-0.3.0+fabric" = _LA2iSvwv;
        "pkg-0.3.0+forge" = _SXD6f9Fd;
        "pkg-2.1.1+fabric" = _D6K7jFOz;
        "pkg-2.1.1+forge" = _E8Yrsqwj;
        "pkg-2.1.1+neoforge" = _JQ8ZGjNS;
        "pkg-1.2.1+fabric" = _axS147j3;
        "pkg-1.2.1+forge" = _nXS5BUlC;
        "pkg-1.2.1+neoforge" = _L0gmDj46;
        "pkg-0.3.1+fabric" = _va9sn3no;
        "pkg-0.3.1+forge" = _1NBZVjnN;
        "pkg-0.4.0+fabric" = _aZmeQAtv;
        "pkg-0.4.0+forge" = _3iJ1cZqJ;
        "pkg-0.4.1+fabric" = _r4zshlVa;
        "pkg-0.4.1+forge" = _kJD5AJ2I;
        "pkg-0.4.2+fabric" = _R36su95V;
        "pkg-0.4.2+forge" = _6M0XESNR;
        "pkg-0.4.3+fabric" = _TZB0U7Om;
        "pkg-0.4.3+forge" = _Qxf5aalO;
        "pkg-0.4.4+fabric" = _cSdajLKr;
        "pkg-0.4.4+forge" = _wffPaEoI;
        "pkg-0.4.5+fabric" = _8QAqyySd;
        "pkg-0.4.5+forge" = _OukjeLm3;
        "pkg-0.4.6+fabric" = _5ieOIT6H;
        "pkg-0.4.6+forge" = _UFwz7lV8;
        "pkg-1.2.2+fabric" = _yZgA0Bup;
        "pkg-1.2.2+forge" = _jNPysjnf;
        "pkg-1.2.2+neoforge" = _88PLjhm6;
        "pkg-1.2.3+fabric" = _TgvzpncT;
        "pkg-1.2.3+forge" = _hCQNcqAx;
        "pkg-1.2.3+neoforge" = _EjnGdUa8;
        "pkg-0.4.7+fabric" = _iDUJjv3p;
        "pkg-0.4.7+forge" = _vfGAzu90;
        "pkg-0.4.8+fabric" = _K2azyKOw;
        "pkg-0.4.8+forge" = _aj0eICRf;
        "pkg-0.4.9+fabric" = _Wzj1Ijt9;
        "pkg-0.4.9+forge" = _w9I8KTSC;
        "pkg-0.4.10+fabric" = _19Ero5LA;
        "pkg-0.4.10+forge" = _4IqFQq7n;
        "pkg-0.4.11+fabric" = _klYGB65A;
        "pkg-0.4.11+forge" = _afX1aXwF;
        "pkg-0.4.12+fabric" = _fak7WCbY;
        "pkg-0.4.12+forge" = _rusNKn9d;
        "pkg-0.4.13+fabric" = _en5RvqpG;
        "pkg-0.4.13+forge" = _425KGrQE;
        "pkg-0.4.14+fabric" = _m90CBoAd;
        "pkg-0.4.14+forge" = _SpTK1kCY;
        "pkg-0.4.15+fabric" = _75LsGp7x;
        "pkg-0.4.15+forge" = _emUtCwpB;
        "pkg-0.4.16+fabric" = _2uHGSEOe;
        "pkg-0.4.16+forge" = _gJQ7VZAB;
        "pkg-0.4.17+fabric" = _gBB6Zmgf;
        "pkg-0.4.17+forge" = _mzpSRPhi;
        "pkg-0.4.18+forge" = _24Yw5Ny0;
        "pkg-0.4.18+fabric" = _NwmkokES;
        "pkg-1.2.4+fabric" = _YYL1yF4H;
        "pkg-1.2.4+forge" = _jxzXF8fl;
        "pkg-1.2.4+neoforge" = _7i75lozq;
        "pkg-2.1.2+fabric" = _tTx8Id8m;
        "pkg-2.1.2+forge" = _jFta6DyU;
        "pkg-2.1.2+neoforge" = _qGyjKMvI;
