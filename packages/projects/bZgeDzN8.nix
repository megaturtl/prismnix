...
let
    ...
    in {
        ...
        "pkg-2.0c" = _dkQb76dW;
        "pkg-2.0c+mod" = _xXK2n2dl;
        "pkg-2.0d" = _RPPPTt19;
        "pkg-2.0d+mod" = _A42AHXCc;
        "pkg-2.0e" = _RKcXZAPf;
        "pkg-2.1a" = _LtuYECsx;
        "pkg-2.1a+mod" = _DlJ04kYc;
        "pkg-2.2.0" = _sjy5fy3J;
        "pkg-2.2.0+mod" = _7RnOFPFP;
        "pkg-2.2.1+mod" = _KVE2J5Ss;
        "pkg-3.0.0" = _gHL0uykG;
        "pkg-3.0.0+mod" = _1ESLkPRH;
        "pkg-3.0.1" = _fwWEXLX8;
        "pkg-3.0.1+mod" = _1Hr2FSvp;
        "pkg-3.0.2" = _qhghrZe2;
        "pkg-3.0.3" = _UqTu0DP2;
        "pkg-3.0.3+mod" = _kWHrVP2z;
        "pkg-3.0.4" = _8nMkQwUA;
        "pkg-3.0.5" = _PuVfhIAu;
        "pkg-3.0.5+mod" = _nQFbtXow;
        "pkg-3.0.6" = _geU1pkcj;
        "pkg-3.0.6+mod" = _U1siAvaG;
        "pkg-3.0.6.1" = _yuv7KdED;
        "pkg-3.0.6.1+mod" = _csfOSC32;
        "pkg-4.0.0" = _orYlM33e;
        "pkg-4.0.0+mod" = _p3W78g0F;
        "pkg-4.0.1" = _6Iv2OeAw;
        "pkg-4.0.1+mod" = _jgxAwgqG;
        "pkg-4.1.0" = _DKWCuULI;
        "pkg-4.1.0+mod" = _n3yTM7hq;
        "pkg-4.2.0" = _eYsceWa1;
        "pkg-4.2.0+mod" = _CQuVJRmf;
        "pkg-4.2.1+mod" = _tA02wWnq;
        "pkg-4.2.2" = _jzMlOQ9M;
        "pkg-4.2.2+mod" = _3skr9Dye;
        "pkg-4.2.3" = _mW2uSRuw;
        "pkg-4.2.3+mod" = _STdzBmp2;
        "pkg-5.0.0-alpha10" = _3ZtsWxKj;
        "pkg-5.0.0-alpha10+mod" = _2zcXjO8K;
        "pkg-5.0.0" = _kLORMoLn;
        "pkg-5.0.0+mod" = _6yHsncWP;
        "pkg-5.0.1+mod" = _hx2PYwoE;
        "pkg-5.1.0" = _9my2R14Q;
        "pkg-5.1.0+mod" = _Xcd0bznS;
        "pkg-5.1.1" = _uBJlaJC4;
        "pkg-5.1.1+mod" = _qsyTRiht;
        "pkg-5.1.2" = _MxcztnUu;
        "pkg-5.1.2+mod" = _LB79ZfRo;
        "pkg-5.1.3" = _zudQ7s97;
        "pkg-5.1.3+mod" = _QuS8aRj8;
        "pkg-5.2.0" = _1aCuB5yg;
        "pkg-5.2.0+mod" = _x9JLWa60;
        "pkg-5.3.0" = _rqHuvueH;
        "pkg-5.3.0+mod" = _QYcLm4ck;
        "pkg-5.4.0" = _fyfTO4J3;
        "pkg-5.4.0+mod" = _18FZk8SE;
        "pkg-5.4.1" = _yMqpj1wp;
        "pkg-5.4.1+mod" = _Kt3vgazn;
        "pkg-5.4.2" = _SAeyTUbo;
        "pkg-5.4.2+mod" = _7AKGkYtz;
        "pkg-5.4.3+mod" = _aeg7hKnF;
        "pkg-5.5.0" = _QJegcaSK;
        "pkg-5.5.0+mod" = _USY0c2RY;
        "pkg-5.5.1" = _2yWT63cH;
        "pkg-5.5.1+mod" = _ue6aPeZV;
        "pkg-5.5.2+mod" = _OfPZxtYK;
        "pkg-5.5.3" = _Tl7snIHb;
