...
let
    versions = (let
        ...
        _pUZ5EAhU = {
            "id" = "pUZ5EAhU";
            "file" = "myresourcepack-1.2.10+26.3.jar";
            "hash" = "sha512-5BsUlrk6YMjeGen/tGBke2397gKV1+z2Hy+YSI9FSODARcejGWnw9DaiyqHO195WlC4vdWRajqw//Mjqp9zWxw==";
        };
        _BygHxH44 = {
            "id" = "BygHxH44";
            "file" = "myresourcepack-1.2.11+26.3.jar";
            "hash" = "sha512-aZ3SxGwcVNhkIE3sXiXpTBVybMD9dYK2Xg5cEJx4V8V6lWJDVT+vO8AQFhIBF4d0uYRuM4l6LPq5VXJcwGEiEQ==";
        };
    in {
        "40E7I23Y" = _40E7I23Y;
        "iO02j24m" = _iO02j24m;
        ...
        "fabric-26.3-rc-2" = _pUZ5EAhU;
        "fabric-26.3" = _BygHxH44;
        "pkg-1.0.0+1.20.2" = _40E7I23Y;
        "pkg-1.1.0+1.20.2" = _iO02j24m;
        "pkg-1.1.0+1.20.1" = _tvTh5jfe;
        "pkg-1.1.0+1.20.3" = _vj1it8He;
        "pkg-1.1.1+1.20.1" = _1Nx1jsAb;
        "pkg-1.1.1+1.20.3" = _fkfKa0D1;
        "pkg-1.2.0+1.20.3" = _omfvt3Wf;
        "pkg-1.2.1+1.20.5" = _8piuTxgT;
        "pkg-1.2.2+1.21" = _PXsqvc02;
        "pkg-1.2.3+1.21" = _eOg0o1aR;
        "pkg-1.2.4+1.21" = _yM9JYGcQ;
        "pkg-1.2.5+1.21.2" = _QvI9Rd9o;
        "pkg-1.2.6+1.21.4" = _Ue14vJVH;
        "pkg-1.2.7+1.21.4" = _HyFzqpTo;
        "pkg-1.2.7+1.21.6" = _r7R8vGBd;
        "pkg-1.2.7+1.21.9" = _2yWxIBq7;
        "pkg-1.2.7+1.21.11" = _YFs08Jvy;
        "pkg-1.2.7+26.1" = _r3cZoICA;
        "pkg-1.2.8+26.1" = _AVxnrslz;
        "pkg-1.2.8+26.2" = _QD00kDGT;
        "pkg-1.2.9+26.1" = _gMjQm82E;
        "pkg-1.2.9+26.2" = _xD0Ra0uL;
        "pkg-1.2.10+26.1" = _BJvUmrS5;
        "pkg-1.2.10+26.2" = _qsaszV3i;
        "pkg-1.2.10+26.3" = _pUZ5EAhU;
        "pkg-1.2.11+26.3" = _BygHxH44;
        "default" = _BygHxH44;
    });
