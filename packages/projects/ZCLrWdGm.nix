...
let
    ...
    in {
        ...
        "pkg-7.681+1.19.2" = _6TgXCgP2;
        "pkg-7.790+1.20" = _nBS2aSIm;
        "pkg-7.699+1.19.2" = _OYiTUvXc;
        "pkg-8.20.770" = _ATOXHvlj;
        "pkg-8.19.693" = _9RO9dtyX;
        "pkg-9.20.908" = _WA8RpvgS;
        "pkg-9.20.911" = _VDhzi1x1;
        "pkg-9.20.913" = _TEmoGCON;
        "pkg-9.20.914" = _8E8FM9EQ;
        "pkg-9.20.927" = _HAfvzlaY;
        "pkg-9.20.929" = _sU4Hq9tC;
        "pkg-9.20.929+fixed" = _Y1SxDkKe;
        "pkg-9.20.947" = _H9DE6jyr;
        "pkg-9.20.952" = _P5owez4s;
        "pkg-9.20.978" = _3J1JfGor;
        "pkg-9.20.1026" = _aXSHKYK6;
        "pkg-9.20.1027" = _gPjJ9ftx;
        "pkg-9.20.1031" = _El2uvL9F;
