...
let
    ...
    in {
        ...
        "pkg-0.3.4+1.21.1" = _V3f49d2A;
        "pkg-0.3.5+1.21.1" = _o3zyT1n9;
        "pkg-0.3.6+1.21.1" = _S2uMDcqx;
        "pkg-0.3.7+1.21.1" = _bJ17M1YO;
        "pkg-0.3.7b+1.21.1" = _BGQ2p9aR;
        "pkg-0.3.8+1.21.1" = _kdjFGp3N;
        "pkg-0.4.0+1.21.1" = _i9tuwd4O;
        "pkg-0.4.1+1.21.1" = _lxvIko1R;
        "pkg-0.4.2+1.21.1" = _no5fwzPs;
        "pkg-0.4.3+1.21.1" = _cMBTg0ch;
        "pkg-0.4.4+1.21.1" = _hj42ubkF;
        "pkg-0.4.5+1.21.1" = _cxC4ISwn;
        "pkg-0.4.6+1.21.1" = _jz8wGPJe;
        "pkg-0.4.7+1.21.1" = _hYzmLjcm;
        "pkg-0.5.0+1.21.1" = _5S7HUXU4;
        "pkg-0.5.1+1.21.1" = _1USFKVIh;
        "pkg-0.5.2+1.21.1" = _rQorEoR6;
        "pkg-0.5.3+1.21.1" = _zD8SGyGw;
        "pkg-0.5.4+1.21.1" = _KY07UbJS;
        "pkg-0.5.5+1.21.1" = _IuFmQTjx;
        "pkg-0.6.0a+1.21.1" = _urfOKdNw;
        "pkg-0.6.1a+1.21.1" = _F5oW4PWb;
        "pkg-0.6.2a+1.21.1" = _ExLhuwuw;
        "pkg-0.6.3+1.21.1" = _5WjMNf6j;
        "pkg-0.6.4+1.21.1" = _GEw0a3Pd;
        "pkg-0.6.5+1.21.1" = _TROOhda1;
        "pkg-0.7.0+1.21.1" = _tMO1IsmK;
        "pkg-0.7.1+1.21.1" = _wRWfwLFY;
        "pkg-0.7.2+1.21.1" = _rKpBdHmC;
        "pkg-0.7.3+1.21.1" = _JFIy8f41;
        "pkg-0.7.4+1.21.1" = _FrK55J3h;
        "pkg-0.7.5+1.21.1" = _MiqPmjLr;
        "pkg-0.7.6+1.21.1" = _1fgFn6iS;
        "pkg-0.8.0+1.21.1" = _AjUGEOVG;
        "pkg-0.8.1+1.21.1" = _G8FKfn0B;
        "pkg-0.8.2+1.21.1" = _VMvcndri;
        "pkg-0.9.0+1.21.1" = _f047feXi;
        "pkg-0.9.1+1.21.1" = _VrryRBIM;
        "pkg-0.10.0+1.21.1" = _K9Tv5mpQ;
        "pkg-0.10.1+1.21.1" = _YQv0cdCX;
        "pkg-0.11.0+1.21.1" = _mh5gHUDH;
        "pkg-0.11.1+1.21.1" = _cFLiBm1c;
        "pkg-0.11.2+1.21.1" = _XousP7cW;
