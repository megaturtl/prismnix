...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.6-forge" = _LJtv9n84;
        "pkg-1.18.2-1.7-forge" = _hEzJ2yVD;
        "pkg-1.19.2-1.9-forge" = _VIZqqFmX;
        "pkg-1.16.5-2.2-fabric" = _XpxT6kVC;
        "pkg-1.18.2-2.2-fabric" = _1M2RPihI;
        "pkg-1.19.2-2.2-fabric" = _kJE6fC5q;
        "pkg-1.19.3-2.3-fabric" = _mwJ5R9DE;
        "pkg-1.19.3-1.9-forge" = _YSDE1Puo;
        "pkg-1.18.2-3.0-forge+fabric" = _W2sbFP9c;
        "pkg-1.19.2-3.0-forge+fabric" = _SE0JfntH;
        "pkg-1.19.3-3.0-forge+fabric" = _9FxI0cvr;
        "pkg-1.18.2-3.1-forge+fabric" = _jvJ4aXnh;
        "pkg-1.19.2-3.1-forge+fabric" = _vLqkSpvp;
        "pkg-1.19.3-3.1-forge+fabric" = _LZ2muZ6C;
        "pkg-1.18.2-3.2-forge+fabric" = _AkrqotgK;
        "pkg-1.19.2-3.2-forge+fabric" = _VO60r8IA;
        "pkg-1.19.3-3.2-forge+fabric" = _lXJ9ARtV;
        "pkg-1.19.4-3.2-forge+fabric" = _QkMScVWg;
        "pkg-1.20-3.2-forge+fabric" = _HjFzOavg;
        "pkg-1.20.1-3.2-forge+fabric" = _3HyAVCky;
        "pkg-1.20.2-3.2-forge+fabric" = _NY2tN2Lt;
        "pkg-1.18.2-3.3-forge+fabric" = _aOaqF8DI;
        "pkg-1.19.2-3.3-forge+fabric" = _zm91hTk0;
        "pkg-1.20.1-3.3-forge+fabric" = _zjcvfFHA;
        "pkg-1.20.2-3.3-forge+fabric" = _stkdhSfR;
        "pkg-1.20.3-3.3-fabric+forge+neo" = _i500jte1;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _xRkKGnVQ;
        "pkg-1.19.2-3.4-fabric+forge+neo" = _wR4khf2p;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _OWYApduF;
        "pkg-1.20.2-3.4-fabric+forge+neo" = _FH40veb1;
        "pkg-1.20.4-3.4-fabric+forge+neo" = _DaTZHgvR;
        "pkg-1.19.2-3.5-fabric+forge" = _MRwMqCA2;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _VckHPNBX;
        "pkg-1.20.4-3.5-fabric+forge+neo" = _ubnzDt6E;
        "pkg-1.20.5-3.5-fabric+neo" = _h4ZCEpiO;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _GLYO60zp;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _shm6zlT4;
        "pkg-1.21.0-3.6-fabric+forge+neo" = _DzsNJjTO;
        "pkg-1.20.1-3.7-fabric+forge+neo" = _VxGALM93;
        "pkg-1.20.6-3.7-fabric+forge+neo" = _oBY9dCvR;
        "pkg-1.21.0-3.7-fabric+forge+neo" = _Ndepyoen;
        "pkg-1.21.1-3.7-fabric+forge+neo" = _vnFfFbSP;
        "pkg-1.21.2-3.7-fabric+neo" = _aqrKNhan;
        "pkg-1.21.3-3.7-fabric+forge+neo" = _87rhrT4D;
        "pkg-1.21.4-3.7-fabric+forge+neo" = _KFuo0Szn;
        "pkg-1.20.1-3.8-fabric+forge+neo" = _dVSS0Gly;
        "pkg-1.21.1-3.8-fabric+forge+neo" = _g22VGbVp;
        "pkg-1.21.4-3.8-fabric+forge+neo" = _nBgGBwQi;
        "pkg-1.21.5-3.8-fabric+forge+neo" = _idJ318yY;
        "pkg-1.21.6-3.8-fabric+forge+neo" = _CCsZiyXa;
        "pkg-1.21.7-3.8-fabric+forge+neo" = _1QH3S1jh;
        "pkg-1.21.8-3.8-fabric+forge+neo" = _KrB20sJW;
        "pkg-1.21.9-3.8-fabric+forge+neo" = _k6LQiWPR;
        "pkg-1.21.10-3.8-fabric+forge+neo" = _PvUoXJNJ;
        "pkg-1.21.11-3.8-fabric+forge+neo" = _9Oayxvs3;
        "pkg-26.1.0-3.8-fabric+forge+neo" = _zZs2tsEw;
        "pkg-26.1.0-3.9-fabric+forge+neo" = _5gUSuKT0;
        "pkg-26.1.1-3.9-fabric+forge+neo" = _6UeXC5E4;
        "pkg-26.1.2-3.9-fabric+forge+neo" = _Su5SUT7G;
        "pkg-1.20.1-4.0-fabric+forge+neo" = _lvDctFv0;
        "pkg-1.21.1-4.0-fabric+forge+neo" = _yB2CSaew;
        "pkg-1.21.11-4.0-fabric+forge+neo" = _pXY9DxbB;
        "pkg-26.1.2-4.0-fabric+forge+neo" = _SArTrz9n;
