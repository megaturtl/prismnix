...
let
    versions = (let
        ...
        _f9BEZQKW = {
            "id" = "f9BEZQKW";
            "file" = "illager_expansion-1.12.0+26.3.jar";
            "hash" = "sha512-RTS9JACpF3/8nih1kQX3/Bt59pdNI4En2gYFALwVe+bVQksNRSOrTcv5p8V7M6QgKzbf3Qe6vzaOrzO5lLIC9A==";
        };
    in {
        "Mvjlcozy" = _Mvjlcozy;
        "1VSQjRCJ" = _1VSQjRCJ;
        ...
        "fabric-26.3-rc-1" = _f9BEZQKW;
        "fabric-26.3" = _f9BEZQKW;
        ...
        "pkg-1.0.0" = _Mvjlcozy;
        "pkg-1.0.0+1.19" = _1VSQjRCJ;
        "pkg-1.1.0+1.20.4" = _ybnb3ThX;
        "pkg-1.1.1+1.20.4" = _L4osRZGw;
        "pkg-1.1.2+1.20.4" = _kX4dN7dR;
        "pkg-1.2.0+1.20.6" = _WCFEcsZV;
        "pkg-1.3.0+1.21" = _YWAleW5F;
        "pkg-1.3.1+1.21" = _22BZnofJ;
        "pkg-1.3.2+1.21" = _1lmZ8V60;
        "pkg-1.4.0+1.21.3" = _xWm2DVlD;
        "pkg-1.5.0+1.21.4" = _QEfKdKOW;
        "pkg-1.5.1+1.21.4" = _t8xoozO1;
        "pkg-1.6.0+1.21.5" = _qHGZO9GF;
        "pkg-1.7.0+1.21.6" = _JkYFABDx;
        "pkg-1.7.1+1.21.8" = _sB8pnYqF;
        "pkg-1.8.0+1.21.9" = _EZ9nlqp5;
        "pkg-1.8.1+1.21.10" = _5dgGlvIR;
        "pkg-1.8.2+1.21.10" = _w5Ww0Zmn;
        "pkg-1.9.0+1.21.11" = _uTH1RPQp;
        "pkg-1.9.1+1.21.11" = _YYQYUqr3;
        "pkg-1.10.0+26.1.1" = _qk1l3DzZ;
        "pkg-1.11.0+26.2" = _MmOCtLYt;
        "pkg-1.11.1+26.2" = _LaFB1JrG;
        "pkg-1.12.0+26.3" = _f9BEZQKW;
        "default" = _f9BEZQKW;
    });
