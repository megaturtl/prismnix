...
let
    versions = (let
        ...
        _gScg51wq = {
            "id" = "gScg51wq";
            "file" = "multi-key-bindings-1.3.5+26.2.jar";
            "hash" = "sha512-1g/4pBA1eEhJXCPoagGFpxdhVF1X3vphw8Kx2H9i1iL4dnUGosJ3gsRfRzBIir0rv54GJdv98Jf8hPPPtq/JEA==";
        };
        _MLxDUD7v = {
            "id" = "MLxDUD7v";
            "file" = "multi-key-bindings-1.3.5+26.3.jar";
            "hash" = "sha512-GZ0tOkNrkmPrw+e44ilSouvKHN3lpMldhWA5Eezzt16lLI9JtJI2ibM95rLojf8Pda0BNdiXfOW759m0/pDY3A==";
        };
    in {
        "XXgctqKf" = _XXgctqKf;
        "ibRXtdjl" = _ibRXtdjl;
        ...
        "fabric-26.2" = _gScg51wq;
        "fabric-26.3" = _MLxDUD7v;
        "pkg-1.0.2+1.20" = _XXgctqKf;
        "pkg-1.0.2+1.20.1" = _ibRXtdjl;
        "pkg-1.0.2+1.20.2" = _eq4J6fe5;
        "pkg-1.0.2+1.20.3" = _Ty8AVTal;
        "pkg-1.0.2+1.20.4" = _rP34pLeY;
        "pkg-1.0.2+1.20.5" = _8W9PNDdJ;
        "pkg-1.0.2+1.20.6" = _mYdWtEOU;
        "pkg-1.0.2+1.21" = _zMrNRFCW;
        "pkg-1.0.2+1.21.1" = _2Rx3yqaE;
        "pkg-1.0.2+1.21.2" = _56lAaVSi;
        "pkg-1.0.2+1.21.3" = _M3b3hZSi;
        "pkg-1.0.2+1.21.4" = _QzUvkbK9;
        "pkg-1.0.2+1.21.5" = _f53z8cY9;
        "pkg-1.0.2+1.21.6" = _F072IVFq;
        "pkg-1.0.2+1.21.7" = _OUg54s6N;
        "pkg-1.0.2+1.21.8" = _f1czMfHR;
        "pkg-1.1.0+1.20.5" = _7IrIErEM;
        "pkg-1.1.0+1.20.6" = _kaShLjOH;
        "pkg-1.1.0+1.21" = _PAycToR1;
        "pkg-1.1.0+1.21.1" = _OUpjA9TM;
        "pkg-1.1.0+1.21.2" = _BReCiVcu;
        "pkg-1.1.0+1.21.3" = _dHWxwtFv;
        "pkg-1.1.0+1.21.4" = _pSgotOfv;
        "pkg-1.1.0+1.21.5" = _lH1Geyyd;
        "pkg-1.1.0+1.21.6" = _7MdovIfZ;
        "pkg-1.1.0+1.21.7" = _Ty9Vd3AL;
        "pkg-1.1.0+1.21.8" = _tnBx6qA9;
        "pkg-1.1.0+1.20" = _8UjWqVwo;
        "pkg-1.1.0+1.20.1" = _sljYJD6x;
        "pkg-1.1.0+1.20.2" = _K4nfiZh0;
        "pkg-1.1.0+1.20.3" = _LTuvF9PT;
        "pkg-1.1.0+1.20.4" = _oLznxWvd;
        "pkg-1.1.0+1.21.9" = _3xaM20ZL;
        "pkg-1.1.0+1.21.10" = _7gG7XWoY;
        "pkg-1.2.0+1.21.9" = _YrDFoDUF;
        "pkg-1.2.0+1.21.10" = _BelQ2RVJ;
        "pkg-1.2.0+1.21.11" = _SqkWsfbK;
        "pkg-1.2.1+1.21" = _wfcyVyyA;
        "pkg-1.2.1+1.21.1" = _FBAPMeUa;
        "pkg-1.2.1+1.21.2" = _FvT7j48D;
        "pkg-1.2.1+1.21.3" = _PFECn5aH;
        "pkg-1.2.1+1.21.4" = _SdORLcVX;
        "pkg-1.2.1+1.21.5" = _Un6V84B6;
        "pkg-1.2.1+1.21.6" = _pnuoeZGd;
        "pkg-1.2.1+1.21.7" = _cMFdxKTI;
        "pkg-1.2.1+1.21.8" = _QVdzSx9k;
        "pkg-1.2.1+1.21.9" = _ZUmyTgJZ;
        "pkg-1.2.1+1.21.10" = _VtC8KrWL;
        "pkg-1.2.1+1.21.11" = _50QA0X7R;
        "pkg-1.1.1+1.20" = _ViDO3CVB;
        "pkg-1.1.1+1.20.1" = _tCiAyFFB;
        "pkg-1.1.1+1.20.2" = _bh00ofUL;
        "pkg-1.1.1+1.20.3" = _GdHuWdIC;
        "pkg-1.1.1+1.20.4" = _VeahoPXU;
        "pkg-1.2.0+26.1" = _YvD4x0rK;
        "pkg-1.2.0+26.1.1" = _Wq9YkFpN;
        "pkg-1.2.0+26.1.2" = _4GXrfDo3;
        "pkg-1.3.1+1.21" = _6g5Wux9C;
        "pkg-1.3.1+1.21.1" = _pjzwE2B8;
        "pkg-1.3.1+1.21.2" = _Ej8Stb8K;
        "pkg-1.3.1+1.21.3" = _AjX2T2Uu;
        "pkg-1.3.1+1.21.4" = _fBBvd5xK;
        "pkg-1.3.1+1.21.5" = _yUc4wcOn;
        "pkg-1.3.1+1.21.6" = _r6Kl8cP6;
        "pkg-1.3.1+1.21.7" = _zdlSXp7P;
        "pkg-1.3.1+1.21.8" = _D0YJWc95;
        "pkg-1.3.1+1.21.9" = _lL5Cr7ah;
        "pkg-1.3.1+1.21.10" = _Yw1aiiiq;
        "pkg-1.3.1+1.21.11" = _iyoWvpk1;
        "pkg-1.3.1+26.1" = _oWK2WI4K;
        "pkg-1.3.1+26.1.1" = _EgyqCXrW;
        "pkg-1.3.1+26.1.2" = _nVFPzvPu;
        "pkg-1.3.3+1.21" = _Xza1AINc;
        "pkg-1.3.3+1.21.1" = _e0IW6nNK;
        "pkg-1.3.3+1.21.2" = _kXDaB07M;
        "pkg-1.3.3+1.21.3" = _3iGX4WMK;
        "pkg-1.3.3+1.21.4" = _ksHunUwz;
        "pkg-1.3.3+1.21.5" = _44vodEUt;
        "pkg-1.3.3+1.21.6" = _SU0C7E9Z;
        "pkg-1.3.3+1.21.7" = _TF8ek4f8;
        "pkg-1.3.3+1.21.8" = _wT0Ia8mC;
        "pkg-1.3.3+1.21.9" = _dxxlNG01;
        "pkg-1.3.3+1.21.10" = _HjeCWbTN;
        "pkg-1.3.3+1.21.11" = _2PHhgmKA;
        "pkg-1.3.3+26.1" = _7YGklV7v;
        "pkg-1.3.3+26.1.1" = _iZTG7iV3;
        "pkg-1.3.3+26.1.2" = _f5vhcQhV;
        "pkg-1.3.4+1.21" = _zmig8uzr;
        "pkg-1.3.4+1.21.1" = _dk64n6Ty;
        "pkg-1.3.4+1.21.2" = _PpynpeR2;
        "pkg-1.3.4+1.21.3" = _gcWOyrHB;
        "pkg-1.3.4+1.21.4" = _Tv9sWV5y;
        "pkg-1.3.4+1.21.5" = _pKVrfAHI;
        "pkg-1.3.4+1.21.6" = _5hPL5NAo;
        "pkg-1.3.4+1.21.7" = _qhiJlB4u;
        "pkg-1.3.4+1.21.8" = _gNepD6RD;
        "pkg-1.3.4+1.21.9" = _ahdj4sW8;
        "pkg-1.3.4+1.21.10" = _UoKvewM8;
        "pkg-1.3.4+1.21.11" = _r50pKpy4;
        "pkg-1.3.4+26.1" = _SmBvQ0gI;
        "pkg-1.3.4+26.1.1" = _njGqnhVy;
        "pkg-1.3.4+26.1.2" = _KHNrWgUm;
        "pkg-1.3.4+26.2" = _2hw5jWvm;
        "pkg-1.3.5+26.2" = _gScg51wq;
        "pkg-1.3.5+26.3" = _MLxDUD7v;
        "default" = _MLxDUD7v;
    });
