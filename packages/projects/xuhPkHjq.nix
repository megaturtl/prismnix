...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _94Aarzye;
        "pkg-1.0.2" = _3vrW2Q3s;
        "pkg-1.0.2+mod" = _mQKPsXRg;
        "pkg-1.0.3" = _uDp9933w;
        "pkg-1.0.3+mod" = _QMrT0ZUm;
        "pkg-1.0.4" = _4HG1eOoL;
        "pkg-1.0.4+mod" = _VJLTCQBE;
        "pkg-1.0.5" = _cLGp6Ugx;
        "pkg-1.0.5+mod" = _iLDA6rJZ;
        "pkg-1.0.6" = _lE7K3SIL;
        "pkg-1.0.6+mod" = _WzqMumT4;
        "pkg-1.0.7" = _dAqWf4mx;
        "pkg-1.0.7+mod" = _b51M2DZp;
        "pkg-1.0.8" = _HFm339UQ;
        "pkg-1.0.8+mod" = _3caRRiQV;
        "pkg-1.0.9" = _ryUJsg8g;
        "pkg-1.0.9+mod" = _cSTK24Pp;
        "pkg-1.0.10" = _W5gZxHV4;
        "pkg-1.0.10+mod" = _Bi4O1xSm;
        "pkg-1.0.11" = _BRFQqqde;
