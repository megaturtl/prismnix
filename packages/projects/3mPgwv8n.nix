...
let
    versions = (let
        ...
        _Yyzyv37b = {
            "id" = "Yyzyv37b";
            "file" = "capabilityproxy-26.1.2-fabric-2.2.3-225.jar";
            "hash" = "sha512-x4XGIVk05heD61+/h7DOD6MF4jrTuXk0HJ8GjVHfhVbvMvHbrQ6adCPRm1IK52IUEP9MlzqrAgmwsUkT0Arhpg==";
        };
        _lkKtmS3N = {
            "id" = "lkKtmS3N";
            "file" = "capabilityproxy-26.1.2-forge-2.2.3-225.jar";
            "hash" = "sha512-4LU4N/dHLQDpXm5Wsm1E9q6/APEaVttuvpNbKshS2aRoxz51eW9ad7i/cMMYEUmw9TZHfoD/TgPtEXZDK2720A==";
        };
        _HYVI7k9d = {
            "id" = "HYVI7k9d";
            "file" = "capabilityproxy-26.1.2-neoforge-2.2.3-225.jar";
            "hash" = "sha512-9xRTGC45eJVe/ZCa195l8d9WPuNtB6LpJW3FjnNkrhuvIJWIptD9i7NiZdejnu/lyxzH981b2/kboc+VJgK/5A==";
        };
        _x6GKjAIo = {
            "id" = "x6GKjAIo";
            "file" = "capabilityproxy-26.2-forge-2.2.3-226.jar";
            "hash" = "sha512-4kerdZQdW38OzzCu+5ZI04buDoYKqxeb8DqTa2wU3L7v8WVj3FDo01iyRNHodBvTykVMGynAYHA58f6qya3wFA==";
        };
        _5LWgdxET = {
            "id" = "5LWgdxET";
            "file" = "capabilityproxy-26.2-fabric-2.2.3-226.jar";
            "hash" = "sha512-vbFtm6gh2UG2EQ2EDiQYF4QkjwiAp6t98owY7Srz7RciFEvWLknhZnosxHcDZO4dfKFAyJJXNpS8kipntB2Lkw==";
        };
        _Hx9QPKUy = {
            "id" = "Hx9QPKUy";
            "file" = "capabilityproxy-26.2-neoforge-2.2.3-226.jar";
            "hash" = "sha512-zjAcTCFT5sReIHtAZvHgQzNgW+r2Io5la/WmrTmiRo1rueC2yYk5Ic8YZd9FUB7Y0Bv4ws9Dp/WD+trrXUWw3A==";
        };
        _xv1K3kjS = {
            "id" = "xv1K3kjS";
            "file" = "capabilityproxy-1.21.1-forge-2.2.1-227.jar";
            "hash" = "sha512-/Mq7VzyahEi/QGujYZevLHgTcDPdl49PhgF+J9amuzep2xZYcnRNkOaXtpMgYZSJztKoFtk8iM6kBCdaDv+qhA==";
        };
        _PVHTNgtH = {
            "id" = "PVHTNgtH";
            "file" = "capabilityproxy-1.21.1-fabric-2.2.1-227.jar";
            "hash" = "sha512-Je4xdFR8JkQoz+ptilqVGL3CqgMeinr6Az3hF/wN8qUfu+rZF7GnY36kElzx7+H2iEhKQRFJaiaY1FzpmWQO5w==";
        };
        _KgNjQiH9 = {
            "id" = "KgNjQiH9";
            "file" = "capabilityproxy-1.21.1-neoforge-2.2.1-227.jar";
            "hash" = "sha512-bk5NSM+gM3HkmLA0Knp7HrAk7uXbkrD0cyrSV81Km+gIE9EGQBuWgAiNlE0f2TqIGOJscvITpqhyBPXmaC+XwA==";
        };
        _niMK0vKl = {
            "id" = "niMK0vKl";
            "file" = "capabilityproxy-26.1.2-fabric-2.2.3-228.jar";
            "hash" = "sha512-GItxff5MsFudQKsGZfa511oVMUOnfWkSO2hC02mySTMJl5152UjSKpzc52ukI7dghdMsNutHegmzo9oKmct3Xw==";
        };
        _grXllaF7 = {
            "id" = "grXllaF7";
            "file" = "capabilityproxy-26.1.2-forge-2.2.3-228.jar";
            "hash" = "sha512-FznngM28sTNQp43Dag73mghgHD5k7FOgRO2Abijq6tflEN/MEjzBXpAZ1i5cjtxZq+SPwBTPX7djONR1AzCjzQ==";
        };
        _Zb11zqEW = {
            "id" = "Zb11zqEW";
            "file" = "capabilityproxy-26.1.2-neoforge-2.2.3-228.jar";
            "hash" = "sha512-/V/uOfiFDUfWN4k7MwNDQyRGF5k5hM92AGDHwDmh1p/XQuohyhUlsbNm2ckGz2TN2MdaBR1Wao7rY4OOfxtsMA==";
        };
        _ofaE1mtd = {
            "id" = "ofaE1mtd";
            "file" = "capabilityproxy-26.2-fabric-2.2.3-229.jar";
            "hash" = "sha512-LXVg3/hnL/SKEle/xJbTVdQYb7rIPIXX14FJe7p5c4WUoIdIH4MLgmHWIO+RvNUdHh9T5dDn/nKSph+CyWH5ng==";
        };
        _h99LHjCU = {
            "id" = "h99LHjCU";
            "file" = "capabilityproxy-26.2-forge-2.2.3-229.jar";
            "hash" = "sha512-ONkFqaKakU2ldtqDyL3qltuMV3f9kpDvp1V4ktMEUazs7DbPRLD+MguJ08RKIkhqZHVlQSFTG4BnmLpNmv7IaA==";
        };
        _4st0wGK9 = {
            "id" = "4st0wGK9";
    ...
    in {
        ...
        "pkg-1.19.2-2.1.11" = _3Jui88rN;
        "pkg-1.19.3-2.1.11" = _pLrO3aZO;
        "pkg-1.19.4-2.1.11" = _FzxhTO3N;
        "pkg-1.20.1-2.1.11" = _szhtAswc;
        "pkg-1.20.4-2.1.11" = _n7EuiYEZ;
        "pkg-1.21-2.1.11" = _EltDOAPJ;
        "pkg-1.21-2.1.12" = _P0UpAzIi;
        "pkg-1.21-2.1.13" = _yleCzMbR;
        "pkg-1.21.1-2.1.13" = _Jm2ifngn;
        "pkg-1.21.1-2.1.14" = _Zp5oXLxX;
        "pkg-1.21.1-2.1.14-114" = _JamM0L9H;
        "pkg-1.21.1-2.2.0-116" = _NMelWTyA;
        "pkg-1.21.1-2.2.0" = _Q3Ar4sjv;
        "pkg-1.21.1-2.2.0-117" = _SdEWPIy3;
        "pkg-1.21.1-2.2.0-118" = _IKxQJJ5x;
        "pkg-1.21.1-2.2.0-119" = _ubSU8m6d;
        "pkg-1.21.1-2.2.0-121" = _lnQk7GX2;
        "pkg-1.21.1-2.2.0-122" = _ccpYw3YU;
        "pkg-1.21.1-2.2.0-123" = _HohyexRQ;
        "pkg-1.21.1-2.2.0-124" = _FaN7Z1u2;
        "pkg-1.21.1-2.2.0-126" = _n6YeUJut;
        "pkg-1.21.1-2.2.0-128" = _tqpoK30F;
        "pkg-1.21.1-2.2.0-131" = _OIsb0nrc;
        "pkg-1.21.1-2.2.0-133" = _4q9L50rC;
        "pkg-1.21.1-2.2.0-135" = _KSFNIbVN;
        "pkg-1.21.1-2.2.0-137" = _1bVOsHni;
        "pkg-1.21.1-2.2.0-139" = _5zNVOxrC;
        "pkg-1.21.4-2.2.0-140" = _5EHNjfsR;
        "pkg-1.21.4-2.2.0-141" = _AeRKLTk5;
        "pkg-1.21.4-2.2.0-142" = _zinakA7R;
        "pkg-1.21.1-2.2.0-145" = _WnwXwBoo;
        "pkg-1.21.1-2.2.0-146" = _MISFrskg;
        "pkg-1.21.1-2.2.0-148" = _DVrSw9Yv;
        "pkg-1.21.1-2.2.0-150" = _QV8LxFRm;
        "pkg-1.21.1-2.2.0-153" = _SnxzA2aR;
        "pkg-1.21.4-2.2.0-154" = _Dska326p;
        "pkg-1.21.4-2.2.0-155" = _85JDbJ91;
        "pkg-1.21.1-2.2.0-157" = _c6Iweerl;
        "pkg-1.21.6-2.2.0-160" = _UHtQrRQP;
        "pkg-1.21.1-2.2.1" = _AgIgdduL;
        "pkg-1.21.6-2.2.0-161" = _bQE0QtL1;
        "pkg-1.21.7-2.2.0-162" = _LaZQxx8S;
        "pkg-1.21.1-2.2.1-163" = _JU7pVhlS;
        "pkg-1.21.8-2.2.0-164" = _V3AaFD2H;
        "pkg-1.21.1-2.2.1-165" = _2KkawoTr;
        "pkg-1.21.8-2.2.0-166" = _97EXcFCV;
        "pkg-1.21.1-2.2.1-167" = _LachqtbB;
        "pkg-1.21.1-2.2.1-168" = _Qh5TCe3D;
        "pkg-1.21.1-2.2.1-170" = _WYCplTAR;
        "pkg-1.21.8-2.2.0-171" = _zdp3amC8;
        "pkg-1.21.8-2.2.0-172" = _jmYzWvTL;
        "pkg-1.21.10-2.2.0-173" = _6Bzdowo1;
        "pkg-1.21.10-2.2.0-176" = _66OKtv0U;
        "pkg-1.21.1-2.2.1-175" = _fOc8Wkmp;
        "pkg-1.21.10-2.2.0-177" = _298DpNeU;
        "pkg-1.21.11-2.2.0-178" = _MyBPj1N9;
        "pkg-1.21.11-2.2.0-179" = _DjdeOcNR;
        "pkg-1.21.1-2.2.1-181" = _EmQVsZtv;
        "pkg-1.21.1-2.2.1-182" = _WhgnpXnP;
        "pkg-1.21.1-2.2.1-185" = _lgEXYX00;
        "pkg-1.21.11-2.2.0-186" = _4imZSY4P;
        "pkg-1.21.1-2.2.1-187" = _ArvJlh66;
        "pkg-1.21.1-2.2.1-189" = _od2eLfsQ;
        "pkg-1.21.11-2.2.0-190" = _DmgtySWh;
        "pkg-1.21.11-2.2.0-191" = _FlW51QtE;
        "pkg-1.21.1-2.2.1-192" = _zE35FLtw;
        "pkg-1.21.11-2.2.0-193" = _YroTOTlg;
        "pkg-1.21.11-2.2.0-194" = _Y7L7rt99;
        "pkg-26.1.1-2.2.0-195" = _iYXs6Bn9;
        "pkg-26.1.1-2.2.0-197" = _US6UOPHi;
        "pkg-26.1.1-2.2.1" = _QDnZnyDL;
        "pkg-26.1.1-2.2.2" = _SnoOwEEy;
        "pkg-26.1.1-2.2.2-203" = _PBWN9EBb;
        "pkg-26.1.1-2.2.2-204" = _4pewlEbB;
        "pkg-26.1.2-2.2.3" = _1WY6nAMW;
        "pkg-26.1.2-2.2.3-210" = _2moiA0tx;
        "pkg-26.1.2-2.2.3-212" = _5DWmBLcA;
        "pkg-26.1.2-2.2.3-213" = _97FAwSSL;
        "pkg-26.2-2.2.3-214" = _eZ3XCeSf;
        "pkg-26.2-2.2.3-215" = _Af4dixZS;
        "pkg-1.21.1-2.2.1-217" = _bThCdDN3;
        "pkg-26.2-2.2.3-219" = _l8a9S8mT;
        "pkg-26.1.2-2.2.3-218" = _npdyzfai;
        "pkg-1.21.1-2.2.1-220" = _4e0KUZWx;
        "pkg-26.1.2-2.2.3-221" = _1gqAtoJ3;
        "pkg-1.21.1-2.2.1-222" = _6a2BxOBZ;
        "pkg-26.1.2-2.2.3-223" = _ekGD35YL;
        "pkg-26.2-2.2.3-224" = _nk3Bzlmp;
        "pkg-26.1.2-2.2.3-225" = _HYVI7k9d;
        "pkg-26.2-2.2.3-226" = _Hx9QPKUy;
