...
let
    versions = (let
        ...
        _SCiokPKX = {
            "id" = "SCiokPKX";
            "file" = "Duels-Optimised-7.6.jar";
            "hash" = "sha512-A7H5k0Zv71m5D7Nv9wY04xS2M3tlIfeKO/B4RHL2dmQhOqh07FKs1KN6+4xbYAAS8h1UyA57BH1O8OIlFVfDCA==";
        };
        _mX5q2rNJ = {
            "id" = "mX5q2rNJ";
            "file" = "Duels-Optimised-8.0.jar";
            "hash" = "sha512-O8QwD8CKWQrfTY3fwrXB45OWtEWWxM7SVLT4uhdCxuQggBWKqC7iULtcv2B0K1S0hdskFfaSEyJp+rEamKJvbQ==";
        };
        _q6e41ESb = {
            "id" = "q6e41ESb";
            "file" = "Duels-Optimised-8.1.jar";
            "hash" = "sha512-Jd8bCpUDYKrhsima/I7tydew7lZJcPg97R3d5xhm2iRMt/Hd+P8aaM+ixWb37CcTxi6nOYO0FVWUDoOrpAQCmg==";
        };
        _FtNv7dQ7 = {
            "id" = "FtNv7dQ7";
            "file" = "Duels-Optimised-8.2.jar";
            "hash" = "sha512-CMLbFwGbn6EsmEM9mwezdbd0NgH6Oervfx3j1K+/JMjiZsSAFxtxMlIPXQ/NGazs55cbEyqssCm+545VK76aMg==";
        };
    in {
        "a8CNwrs5" = _a8CNwrs5;
        "8cL7SWkT" = _8cL7SWkT;
        ...
        "bukkit-1.20" = _FtNv7dQ7;
        "bukkit-1.14.1" = _8cL7SWkT;
        "bukkit-1.20.5" = _FtNv7dQ7;
        "bukkit-1.20.6" = _FtNv7dQ7;
        "bukkit-1.21" = _FtNv7dQ7;
        "bukkit-1.21.1" = _FtNv7dQ7;
        ...
        "bukkit-1.20.1" = _FtNv7dQ7;
        "bukkit-1.20.2" = _FtNv7dQ7;
        "bukkit-1.20.3" = _FtNv7dQ7;
        "bukkit-1.20.4" = _FtNv7dQ7;
        "bukkit-1.21.2" = _FtNv7dQ7;
        "bukkit-1.21.3" = _FtNv7dQ7;
        "bukkit-1.15.1" = _K3TM7b6y;
        "bukkit-1.15.2" = _K3TM7b6y;
        "bukkit-1.21.4" = _FtNv7dQ7;
        "bukkit-1.21.5" = _FtNv7dQ7;
        "bukkit-1.21.6" = _FtNv7dQ7;
        "bukkit-1.21.7" = _FtNv7dQ7;
        "bukkit-1.21.8" = _FtNv7dQ7;
        "bukkit-1.21.9" = _FtNv7dQ7;
        "bukkit-1.21.10" = _FtNv7dQ7;
        "bukkit-1.21.11" = _FtNv7dQ7;
        "bukkit-26.1" = _FtNv7dQ7;
        "bukkit-26.1.1" = _FtNv7dQ7;
        "bukkit-26.1.2" = _FtNv7dQ7;
        "bukkit-26.2" = _FtNv7dQ7;
        ...
        "paper-1.20" = _FtNv7dQ7;
        "paper-1.14.1" = _8cL7SWkT;
        "paper-1.20.5" = _FtNv7dQ7;
        "paper-1.20.6" = _FtNv7dQ7;
        "paper-1.21" = _FtNv7dQ7;
        "paper-1.21.1" = _FtNv7dQ7;
        ...
        "paper-1.20.1" = _FtNv7dQ7;
        "paper-1.20.2" = _FtNv7dQ7;
        "paper-1.20.3" = _FtNv7dQ7;
        "paper-1.20.4" = _FtNv7dQ7;
        "paper-1.21.2" = _FtNv7dQ7;
        "paper-1.21.3" = _FtNv7dQ7;
        "paper-1.15.1" = _K3TM7b6y;
        "paper-1.15.2" = _K3TM7b6y;
        "paper-1.21.4" = _FtNv7dQ7;
        "paper-1.21.5" = _FtNv7dQ7;
        "paper-1.21.6" = _FtNv7dQ7;
        "paper-1.21.7" = _FtNv7dQ7;
        "paper-1.21.8" = _FtNv7dQ7;
        "paper-1.21.9" = _FtNv7dQ7;
        "paper-1.21.10" = _FtNv7dQ7;
        "paper-1.21.11" = _FtNv7dQ7;
        "paper-26.1" = _FtNv7dQ7;
        "paper-26.1.1" = _FtNv7dQ7;
        "paper-26.1.2" = _FtNv7dQ7;
        "paper-26.2" = _FtNv7dQ7;
        ...
        "spigot-1.20" = _FtNv7dQ7;
        "spigot-1.14.1" = _8cL7SWkT;
        "spigot-1.20.5" = _FtNv7dQ7;
        "spigot-1.20.6" = _FtNv7dQ7;
        "spigot-1.21" = _FtNv7dQ7;
        "spigot-1.21.1" = _FtNv7dQ7;
        ...
        "spigot-1.20.1" = _FtNv7dQ7;
        "spigot-1.20.2" = _FtNv7dQ7;
        "spigot-1.20.3" = _FtNv7dQ7;
        "spigot-1.20.4" = _FtNv7dQ7;
        "spigot-1.21.2" = _FtNv7dQ7;
        "spigot-1.21.3" = _FtNv7dQ7;
        "spigot-1.15.1" = _K3TM7b6y;
        "spigot-1.15.2" = _K3TM7b6y;
        "spigot-1.21.4" = _FtNv7dQ7;
        "spigot-1.21.5" = _FtNv7dQ7;
        "spigot-1.21.6" = _FtNv7dQ7;
        "spigot-1.21.7" = _FtNv7dQ7;
        "spigot-1.21.8" = _FtNv7dQ7;
        "spigot-1.21.9" = _FtNv7dQ7;
        "spigot-1.21.10" = _FtNv7dQ7;
        "spigot-1.21.11" = _FtNv7dQ7;
        "spigot-26.1" = _FtNv7dQ7;
        "spigot-26.1.1" = _FtNv7dQ7;
        "spigot-26.1.2" = _FtNv7dQ7;
        "spigot-26.2" = _FtNv7dQ7;
        "purpur-1.20.5" = _FtNv7dQ7;
        "purpur-1.20.6" = _FtNv7dQ7;
        "purpur-1.21" = _FtNv7dQ7;
        "purpur-1.21.1" = _FtNv7dQ7;
        ...
        "purpur-1.20" = _FtNv7dQ7;
        "purpur-1.20.1" = _FtNv7dQ7;
        "purpur-1.20.2" = _FtNv7dQ7;
        "purpur-1.20.3" = _FtNv7dQ7;
        "purpur-1.20.4" = _FtNv7dQ7;
        "purpur-1.21.2" = _FtNv7dQ7;
        "purpur-1.21.3" = _FtNv7dQ7;
        "purpur-1.15.1" = _K3TM7b6y;
        "purpur-1.15.2" = _K3TM7b6y;
        "purpur-1.21.4" = _FtNv7dQ7;
        "purpur-1.21.5" = _FtNv7dQ7;
        "purpur-1.21.6" = _FtNv7dQ7;
        "purpur-1.21.7" = _FtNv7dQ7;
        "purpur-1.21.8" = _FtNv7dQ7;
        "purpur-1.21.9" = _FtNv7dQ7;
        "purpur-1.21.10" = _FtNv7dQ7;
        "purpur-1.21.11" = _FtNv7dQ7;
        "purpur-26.1" = _FtNv7dQ7;
        "purpur-26.1.1" = _FtNv7dQ7;
        "purpur-26.1.2" = _FtNv7dQ7;
        "purpur-26.2" = _FtNv7dQ7;
        "folia-1.20.5" = _FtNv7dQ7;
        "folia-1.20.6" = _FtNv7dQ7;
        "folia-1.21" = _FtNv7dQ7;
        "folia-1.21.1" = _FtNv7dQ7;
        ...
        "folia-1.20" = _FtNv7dQ7;
        "folia-1.20.1" = _FtNv7dQ7;
        "folia-1.20.2" = _FtNv7dQ7;
        "folia-1.20.3" = _FtNv7dQ7;
        "folia-1.20.4" = _FtNv7dQ7;
        "folia-1.21.2" = _FtNv7dQ7;
        "folia-1.21.3" = _FtNv7dQ7;
        "folia-1.15.1" = _K3TM7b6y;
        "folia-1.15.2" = _K3TM7b6y;
        "folia-1.21.4" = _FtNv7dQ7;
        "folia-1.21.5" = _FtNv7dQ7;
        "folia-1.21.6" = _FtNv7dQ7;
        "folia-1.21.7" = _FtNv7dQ7;
        "folia-1.21.8" = _FtNv7dQ7;
        "folia-1.21.9" = _FtNv7dQ7;
        "folia-1.21.10" = _FtNv7dQ7;
        "folia-1.21.11" = _FtNv7dQ7;
        "folia-26.1" = _FtNv7dQ7;
        "folia-26.1.1" = _FtNv7dQ7;
        "folia-26.1.2" = _FtNv7dQ7;
        "folia-26.2" = _FtNv7dQ7;
        "pkg-0.60-BETA" = _a8CNwrs5;
        "pkg-0.70-BETA" = _8cL7SWkT;
        "pkg-0.71-BETA" = _60BMCR4S;
        "pkg-1.00-BETA" = _I65oUI2k;
        "pkg-1.02-BETA" = _aOafDi2B;
        "pkg-1.5-BETA" = _Sl0GGf9q;
        "pkg-2.0-BETA" = _wjOLE5T1;
        "pkg-3.0-BETA" = _3tC1IDwP;
        "pkg-3.2-BETA" = _QHxBpCkF;
        "pkg-4.3-BETA" = _bBVWrJrc;
        "pkg-1.0" = _oODMUFiM;
        "pkg-1.1" = _J1o11IW0;
        "pkg-1.2" = _s2SPkuUv;
        "pkg-1.3" = _ZVqKUF08;
