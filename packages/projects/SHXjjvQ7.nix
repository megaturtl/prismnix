...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _3nJ4J0RC;
        "pkg-1.0.1+1.21.8" = _67z5MM37;
        "pkg-1.0.1+1.21.7" = _iTxiDlf3;
        "pkg-1.0.1+1.21.6" = _MJbHcFMz;
        "pkg-1.0.1+1.20.1" = _bBo5PozS;
        "pkg-1.0.2+1.20.1" = _7L4qiERf;
        "pkg-1.0.2+1.21.8" = _v2ioMyzr;
        "pkg-1.0.2+1.21.7" = _Z7YQuHLv;
        "pkg-1.0.2+1.21.6" = _BscpiMJT;
        "pkg-1.0.2+1.21.5" = _C4VoY3gO;
        "pkg-1.0.3-fix.1+1.21.5" = _YCdMkIcW;
        "pkg-1.0.3-fix.1+1.21.6" = _c0XExCXI;
        "pkg-1.0.3-fix.1+1.21.7" = _boBNojUC;
        "pkg-1.0.3-fix.1+1.21.8" = _V9enAeUz;
        "pkg-1.0.3-fix.2+1.21.5" = _aQ2OxVT8;
        "pkg-1.0.3-fix.2+1.21.6" = _ctFXJFyS;
        "pkg-1.0.3-fix.2+1.21.7" = _lcYGo7bM;
        "pkg-1.0.3-fix.2+1.21.8" = _LO9DnhWY;
        "pkg-1.0.3+1.21.5" = _b3FR5QhV;
        "pkg-1.0.3+1.21.6" = _M3uKO7e7;
        "pkg-1.0.3+1.21.7" = _iSQJejxf;
        "pkg-1.0.3+1.21.8" = _BF5OJlYI;
        "pkg-1.0.4-fix.1+1.21.5" = _osjhgncp;
        "pkg-1.0.4-fix.2+1.21.5" = _YG16MRpt;
        "pkg-1.0.4-fix.2+1.21.8" = _jbijeCAX;
        "pkg-1.0.4-fix.2+1.21.7" = _8iq7YxwC;
        "pkg-1.0.4+1.21.5" = _OptYhYZn;
        "pkg-1.0.4+1.21.6" = _OXK868tW;
        "pkg-1.0.4+1.21.7" = _MYF8TBFW;
        "pkg-1.0.4+1.21.8" = _PwoCcBT1;
        "pkg-1.0.4+1.21.4" = _BQEovxMm;
        "pkg-1.0.4+1.21.3" = _VlZBvQ3u;
        "pkg-1.0.4+1.21.2" = _voNGye0o;
        "pkg-1.0.4+1.21.1" = _xLZcWiGL;
        "pkg-1.0.4+1.20.6" = _EyOeQhab;
        "pkg-1.0.4+1.20.4" = _6goVcbXM;
        "pkg-1.0.4+1.20.3" = _88vd6Gw0;
        "pkg-1.0.4+1.20.2" = _AE2DSNBq;
        "pkg-1.0.4+1.20.1" = _ZzGOwYCG;
        "pkg-1.0.5-fix.1+1.21.5" = _i5LXJm8Q;
        "pkg-1.0.5-fix.2+1.21.5" = _BP4Ra9va;
        "pkg-1.0.5-fix.3+1.21.5" = _FQ0XoFrk;
        "pkg-1.0.5+1.21.5" = _RtaK6qEK;
        "pkg-1.0.6+1.21.5" = _Ft7r5Tes;
        "pkg-1.0.7-fix.1+1.21.5" = _JJdoWEOR;
        "pkg-1.0.8+1.21.5" = _naxIQEEf;
        "pkg-1.1.1+1.21.5" = _HFNLCHOB;
        "pkg-1.1.2+1.21.5" = _WMgKzpBw;
        "pkg-1.1.3-fix.1+1.21.5" = _AImlv8pA;
        "pkg-1.1.3+1.21.5" = _MC5xxKr4;
        "pkg-1.1.4-fix.1+1.21.5" = _rb8vLMHY;
        "pkg-1.1.4-fix.2+1.21.5" = _gKSWNgDA;
        "pkg-1.1.4+1.21.5" = _bsAj2ylx;
        "pkg-1.1.4+1.21.9" = _eDuKzoEs;
        "pkg-1.1.4+1.21.4" = _7czHl9qe;
        "pkg-1.1.4+1.21.3" = _BX773LTS;
        "pkg-1.1.4+1.21.2" = _cUky2caO;
        "pkg-1.1.4+1.21.1" = _YfHHJrs3;
        "pkg-1.1.4+1.21" = _53W0PJaN;
        "pkg-1.1.4+1.20.1" = _aXeOkO0q;
        "pkg-1.1.4+1.20.2" = _WOzVcjuE;
        "pkg-1.1.4+1.20.3" = _j6V37s7A;
        "pkg-1.1.4+1.20.4" = _IF0ntyJC;
        "pkg-1.1.4+1.20.5" = _Mq0qYtuS;
        "pkg-1.1.4+1.20.6" = _gAYcLhmh;
        "pkg-1.1.4+1.21.10" = _29RkluL6;
        "pkg-1.1.4-fix.1+1.21.10" = _RcWY87X4;
        "pkg-1.1.4-fix.2+1.21.10" = _LoeLRGwH;
        "pkg-1.1.4-fix.4+1.21.10" = _J2eCcmOA;
        "pkg-1.1.6-fix.1+1.21.10" = _gJxyXTFW;
        "pkg-1.1.6+1.21.10" = _qOHl8DB8;
        "pkg-1.1.6+1.21.5" = _Bt5lJDNY;
        "pkg-1.1.6+1.20.1" = _ZrjgA6NE;
        "pkg-1.1.6+1.20.2" = _rtZCpqfv;
        "pkg-1.1.6+1.20.6" = _1b0FQZd3;
        "pkg-1.1.7+1.20.6" = _bcQyelNV;
        "pkg-1.1.7+1.21.10" = _K6ViUeEl;
        "pkg-1.1.8+1.21.10" = _HdogxHFQ;
        "pkg-1.1.9" = _Du69GGey;
        "pkg-1.1.10-fix.1" = _4QbFGUJp;
        "pkg-1.1.10-fix.2" = _KliqwJU0;
        "pkg-1.1.10-fix.3" = _AsyBYP8s;
        "pkg-1.1.10" = _bgKxxeDL;
        "pkg-1.21.11" = _nfjwaAF4;
