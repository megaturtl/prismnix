...
let
    ...
    in {
        ...
        "pkg-48.1" = _hri8WBMB;
        "pkg-48.1+mod" = _5MqF1DnY;
        "pkg-57.1" = _H6iSfSDP;
        "pkg-57.1+mod" = _OD7AARXL;
        "pkg-61.1" = _Brk2jNlE;
        "pkg-61.1+mod" = _Jhhg2lsm;
        "pkg-71.1" = _iKcivhUZ;
        "pkg-71.1+mod" = _mpKMx84D;
        "pkg-80" = _aV70jrmW;
        "pkg-80+mod" = _alfyJD9k;
        "pkg-81" = _DYcqnmMN;
        "pkg-81+mod" = _Hx6abWRj;
        "pkg-88.0" = _cBlru7ib;
        "pkg-88.0+mod" = _7C21BJUQ;
        "pkg-94.1" = _Q03Sc5mB;
        "pkg-94.1+mod" = _VE4VwShU;
        "pkg-101.1" = _QNR52y3I;
