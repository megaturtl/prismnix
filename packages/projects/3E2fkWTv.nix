...
let
    versions = (let
        ...
        _ZoagvSiB = {
            "id" = "ZoagvSiB";
            "file" = "TradeManager-2.0.1.jar";
            "hash" = "sha512-vTVO2UYFZHKAtuh5s2ACwaArNIXHW9mj8RuTHFS+SrLnqBNCMrVbxvcROld/pteARfnzUNmh3xMc1yW6oo5Asg==";
        };
        _rDR6jfG9 = {
            "id" = "rDR6jfG9";
            "file" = "TradeManager-2.0.2.jar";
            "hash" = "sha512-ilPPYYq3vg2iF680Rqmi4McS6QKzEIg6KD2JiDl1Viw5yeIeMaH942+c6ghuMj4G9AxfUPuiiJU8vjwSKdARtQ==";
        };
    in {
        "q8frZ0eH" = _q8frZ0eH;
        "H9XAOidL" = _H9XAOidL;
        ...
        "ZoagvSiB" = _ZoagvSiB;
        "rDR6jfG9" = _rDR6jfG9;
        "paper-1.20" = _rDR6jfG9;
        "paper-1.20.1" = _rDR6jfG9;
        "paper-1.20.2" = _rDR6jfG9;
        "paper-1.20.3" = _rDR6jfG9;
        "paper-1.20.4" = _rDR6jfG9;
        "paper-1.20.5" = _rDR6jfG9;
        "paper-1.20.6" = _rDR6jfG9;
        "paper-1.21" = _rDR6jfG9;
        "paper-1.21.1" = _rDR6jfG9;
        "paper-1.21.2" = _rDR6jfG9;
        "paper-1.21.3" = _rDR6jfG9;
        "paper-1.21.4" = _rDR6jfG9;
        "paper-1.21.5" = _rDR6jfG9;
        "paper-1.21.6" = _rDR6jfG9;
        "paper-1.21.7" = _rDR6jfG9;
        "paper-1.21.8" = _rDR6jfG9;
        "paper-1.21.9" = _rDR6jfG9;
        "paper-1.21.10" = _rDR6jfG9;
        "paper-1.21.11" = _rDR6jfG9;
        "paper-26.1" = _rDR6jfG9;
        "paper-26.1.1" = _rDR6jfG9;
        "paper-26.1.2" = _rDR6jfG9;
        "paper-26.2" = _rDR6jfG9;
        "purpur-1.20" = _rDR6jfG9;
        "purpur-1.20.1" = _rDR6jfG9;
        "purpur-1.20.2" = _rDR6jfG9;
        "purpur-1.20.3" = _rDR6jfG9;
        "purpur-1.20.4" = _rDR6jfG9;
        "purpur-1.20.5" = _rDR6jfG9;
        "purpur-1.20.6" = _rDR6jfG9;
        "purpur-1.21" = _rDR6jfG9;
        "purpur-1.21.1" = _rDR6jfG9;
        "purpur-1.21.2" = _rDR6jfG9;
        "purpur-1.21.3" = _rDR6jfG9;
        "purpur-1.21.4" = _rDR6jfG9;
        "purpur-1.21.5" = _rDR6jfG9;
        "purpur-1.21.6" = _rDR6jfG9;
        "purpur-1.21.7" = _rDR6jfG9;
        "purpur-1.21.8" = _rDR6jfG9;
        "purpur-1.21.9" = _rDR6jfG9;
        "purpur-1.21.10" = _rDR6jfG9;
        "purpur-1.21.11" = _rDR6jfG9;
        "purpur-26.1" = _rDR6jfG9;
        "purpur-26.1.1" = _rDR6jfG9;
        "purpur-26.1.2" = _rDR6jfG9;
        "purpur-26.2" = _rDR6jfG9;
        "spigot-1.20" = _rDR6jfG9;
        "spigot-1.20.1" = _rDR6jfG9;
        "spigot-1.20.2" = _rDR6jfG9;
        "spigot-1.20.3" = _rDR6jfG9;
        "spigot-1.20.4" = _rDR6jfG9;
        "spigot-1.20.5" = _rDR6jfG9;
        "spigot-1.20.6" = _rDR6jfG9;
        "spigot-1.21" = _rDR6jfG9;
        "spigot-1.21.1" = _rDR6jfG9;
        "spigot-1.21.2" = _rDR6jfG9;
        "spigot-1.21.3" = _rDR6jfG9;
        "spigot-1.21.4" = _rDR6jfG9;
        "spigot-1.21.5" = _rDR6jfG9;
        "spigot-1.21.6" = _rDR6jfG9;
        "spigot-1.21.7" = _rDR6jfG9;
        "spigot-1.21.8" = _rDR6jfG9;
        "spigot-1.21.9" = _rDR6jfG9;
        "spigot-1.21.10" = _rDR6jfG9;
        "spigot-1.21.11" = _rDR6jfG9;
        "spigot-26.1" = _rDR6jfG9;
        "spigot-26.1.1" = _rDR6jfG9;
        "spigot-26.1.2" = _rDR6jfG9;
        "spigot-26.2" = _rDR6jfG9;
        "pkg-1.2.8" = _q8frZ0eH;
        "pkg-1.2.9" = _H9XAOidL;
        "pkg-1.3.0" = _WyzRCLz0;
        "pkg-1.3.1" = _uFiKFddJ;
