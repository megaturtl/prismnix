...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _II1DwVzT;
        "pkg-1.0.9" = _XCr62rod;
        "pkg-1.0.10" = _4Pie1LSs;
        "pkg-1.0.11" = _1rfpO94j;
        "pkg-1.0.12" = _F6IgAaRg;
        "pkg-1.0.13" = _C7zZfqL3;
        "pkg-1.0.14" = _Fd6xU1Dw;
        "pkg-1.0.15" = _TQyfB6mL;
        "pkg-1.0.16" = _SBf1WVhM;
        "pkg-1.0.17" = _1EsDlHHp;
