...
let
    ...
    in {
        ...
        "pkg-1.21.2-1.21.5_Fabric" = _YUZI61qX;
        "pkg-1.21-1.21.1_Fabric" = _TzIwjLHe;
        "pkg-1.20.x_1.19.x_Fabric" = _RMJeBJxi;
        "pkg-1.21.6_Fabric" = _gL5nm5LW;
        "pkg-1.21.7_Fabric" = _5trH8mq1;
        "pkg-1.21.8" = _lSP2hmUE;
        "pkg-1.21.8_Forge" = _yTwCnqAE;
        "pkg-1.21.7_Forge" = _qzp34X5o;
        "pkg-1.21.6_Forge" = _uPsjxakY;
        "pkg-1.21.5_Forge" = _o8kqSYzt;
        "pkg-1.21.2-1.21.5_NeoForge" = _2PObvCq8;
        "pkg-1.21-1.21.1_NeoForge" = _i5E2f2v3;
        "pkg-1.21.6-1.21.8_NeoForge" = _utXVl5UH;
        "pkg-1.21.9_Forge" = _2xdJTTrf;
        "pkg-1.21.9_Neoforge" = _mAMOwBxS;
        "pkg-1.21.9_Fabric" = _nGpC0qdj;
        "pkg-1.21.10_Fabric" = _ttFJlxbQ;
        "pkg-1.21.10_NeoForge" = _6rlmxAq9;
        "pkg-1.21.10_Forge" = _Bv66LimL;
        "pkg-1.21.11_Fabric" = _CjWMitqz;
        "pkg-26.1_Fabric" = _O2GX5bhN;
