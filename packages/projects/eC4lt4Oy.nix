...
let
    ...
    in {
        ...
        "pkg-2.1.8" = _wf7j6vc7;
        "pkg-2.1.9" = _isAJHyXm;
        "pkg-2.1.10" = _C66Xe1y5;
        "pkg-2.1.11" = _UnoGwwLe;
        "pkg-2.1.12" = _cVhWPgPU;
        "pkg-2.1.13" = _HHIQl0qW;
        "pkg-2.1.14" = _qISLS6Et;
        "pkg-2.1.15" = _YFJZ7KNI;
        "pkg-2.1.16" = _yk7Spvcr;
        "pkg-2.1.17" = _cIDH2rWm;
        "pkg-2.1.18" = _jNoxhKHL;
        "pkg-3.0.0-beta.1" = _DKpksycX;
        "pkg-3.0.0-beta.2" = _bEyq9U1s;
        "pkg-3.0.0-beta.3" = _AK3jcXI8;
        "pkg-3.0.0-beta.4" = _akKtK9tA;
        "pkg-3.0.0-beta.5" = _lwY998Pe;
        "pkg-3.0.0-beta.6" = _C6BlTy53;
        "pkg-3.0.0-beta.7" = _BlHM8PtY;
        "pkg-3.0.0-beta.8" = _oMml5wsr;
        "pkg-3.0.0-beta.9" = _RbjYEGyS;
        "pkg-3.0.0-beta.10" = _YY1oqEdA;
        "pkg-3.0.0-beta.11" = _OWgyenvr;
        "pkg-3.0.0" = _lax30S58;
        "pkg-3.0.1" = _CpVSnOey;
        "pkg-3.0.2" = _wpqTiJXZ;
        "pkg-3.0.3" = _iHGkS0zL;
        ...
        "pkg-3.0.8" = _Cv7zgL64;
        "pkg-3.0.9" = _Yg6xFeSd;
        "pkg-3.0.10" = _SsUOCFap;
        "pkg-3.0.11" = _VxKmRgrG;
        "pkg-3.0.12" = _K6kPm8BT;
        "pkg-3.0.13" = _SGAdl3CO;
        "pkg-3.0.14" = _CeZWywx7;
        "pkg-3.0.15" = _kUyBkCOt;
        "pkg-3.0.16" = _3w7Gmx9A;
        "pkg-3.0.17" = _mt5HzhAa;
        "pkg-3.0.18" = _4wPzY7v0;
        "pkg-3.0.19" = _B8RBCOsj;
        "pkg-3.0.20" = _GFNr8Fra;
        "pkg-3.0.21" = _xalOQ48P;
        "pkg-3.0.22" = _l2b84c1Z;
        "pkg-3.0.23" = _TVLgcBpy;
        "pkg-3.0.24" = _pu1dIkjy;
        "pkg-3.0.25" = _un5cH4gu;
        "pkg-3.0.26" = _rSikFQo0;
        "pkg-3.0.27" = _GSlT7lip;
        "pkg-3.0.28" = _IZnoigKa;
        "pkg-3.0.29" = _PffqqmiH;
