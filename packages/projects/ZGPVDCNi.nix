...
let
    versions = (let
        ...
        _ccEe3ECq = {
            "id" = "ccEe3ECq";
            "file" = "unstriplog-26.2-neoforge-26.2.0.1.jar";
            "hash" = "sha512-pxmbLGwUpCliynDsrFj/GgDQK8aSygh6MLjHmCBHEh7+WtQcpkz1qXfpmBpRnJab34BNoeQzLb22CQ24AuHVdA==";
        };
        _iMM2yxgG = {
            "id" = "iMM2yxgG";
            "file" = "unstriplog-26.2-fabric-26.2.0.1.jar";
            "hash" = "sha512-1uuZk2njKpx1qf3WZTtv5MEAtufPwaDO5ZC5lEL6ofKS+/Qp3eiSIhV8sVL/OPw8JziNoi7xSnDLKcMrdiIZfw==";
        };
        _Qp2UwXTi = {
            "id" = "Qp2UwXTi";
            "file" = "unstriplog-26.1.2-neoforge-26.1.2.1.jar";
            "hash" = "sha512-NFnZztYR/4OXrcu5cE7LpYPnGlbTnRvPlJGBEEXdeesAO9KxQ072IAj0lDWOGSBxYIvr/lXH8Xb56ZQE/0NmZw==";
        };
        _2uWOVKcY = {
            "id" = "2uWOVKcY";
            "file" = "unstriplog-26.1.2-fabric-26.1.2.1.jar";
            "hash" = "sha512-NXsoHdpLGwEtrqV+TqQeUy+H/eqaI0KYX6jP7O46GxfYcu4Ji5g/DIwuBWV/WrB7EAepHiPGmqP6c2LrqGw8qw==";
        };
        _RLrOdegE = {
            "id" = "RLrOdegE";
    ...
    in {
        ...
        "pkg-1.0.0-1.21.5-NeoForge" = _uWNhqDg4;
        "pkg-1.0.0-1.21.3-fabric" = _tL8MP8bw;
        "pkg-1.0.0-1.21.3-NeoForge" = _mbzPZnLe;
        "pkg-1.0.0-1.21.4-fabric" = _iwc94Rhg;
        "pkg-1.0.0-1.21.4-NeoForge" = _lKTO98rB;
        "pkg-1.0.1-1.21.1-fabric" = _88ZQnsPg;
        "pkg-1.0.1-1.21.1-NeoForge" = _msZQWUpZ;
        "pkg-1.0.1-1.21.3-fabric" = _3tkC5ejO;
        "pkg-1.0.1-1.21.3-NeoForge" = _g0O6LZ7m;
        "pkg-1.0.1-1.21.4-fabric" = _UAwgtWzD;
        "pkg-1.0.1-1.21.4-NeoForge" = _Xux4t1Oi;
        "pkg-1.0.1-1.21.5-fabric" = _P066pWDP;
        "pkg-1.0.1-1.21.5-NeoForge" = _JtVF8kUe;
        "pkg-1.0.2-1.21.1-fabric" = _nSAeQEXD;
        "pkg-1.0.2-1.21.1-NeoForge" = _DwvT0hD6;
        "pkg-1.0.2-1.21.3-fabric" = _iXCbbeQm;
        "pkg-1.0.2-1.21.3-NeoForge" = _BIvXeuYR;
        "pkg-1.0.2-1.21.4-fabric" = _qrhlPNSH;
        "pkg-1.0.2-1.21.4-NeoForge" = _JAU3sTD0;
        "pkg-1.0.2-1.21.5-fabric" = _ShEMYB1e;
        "pkg-1.0.2-1.21.5-NeoForge" = _GbOo10iv;
        "pkg-1.0.2-1.21.6-fabric" = _cPgsXs1c;
        "pkg-1.0.2-1.21.6-NeoForge" = _tluxgkyj;
        "pkg-1.0.2-1.21.7-fabric" = _57vcIczE;
        "pkg-1.0.2-1.21.7-NeoForge" = _wb03Eg4Z;
        "pkg-1.0.2-1.21.8-fabric" = _xEyVuGoN;
        "pkg-1.0.2-1.21.8-NeoForge" = _A0goxWNC;
        "pkg-1.0.2-1.21.9-fabric" = _zR6rypB7;
        "pkg-1.0.2-1.21.9-NeoForge" = _2uC7HeVj;
        "pkg-1.0.2-1.21.10-fabric" = _cjaPy0BT;
        "pkg-1.0.2-1.21.10-NeoForge" = _B5ywidzP;
        "pkg-1.0.3-1.21.1-fabric" = _SpTumdda;
        "pkg-1.0.3-1.21.1-NeoForge" = _Xk8Y4t6q;
        "pkg-1.0.3-1.21.10-fabric" = _iNDZTgPj;
        "pkg-1.0.3-1.21.10-NeoForge" = _vm3lpDJq;
        "pkg-1.0.3-1.21.11-NeoForge" = _NypP794Q;
        "pkg-1.0.3-1.21.11-fabric" = _JN8XdvdW;
        "pkg-1.0.3-26.1-snapshot-7-fabric" = _YJoK4ykS;
        "pkg-1.0.3+26.1-snapshot-7-neoforge" = _y1JWVEFh;
        "pkg-1.1.0-1.21.1-NeoForge" = _NWMnwRG1;
        "pkg-1.1.1-1.21.1-NeoForge" = _2VoCElUX;
        "pkg-1.1.1-1.21.1-fabric" = _k7czA4PG;
        "pkg-1.1.2-1.21.1-fabric" = _jttQtvpt;
        "pkg-1.1.0-26.1-fabric" = _yyPwTfRN;
        "pkg-1.1.1+26.1-neoforge" = _AYsJ4B94;
        "pkg-1.1.0-1.21.11-fabric" = _GbxnEjdW;
        "pkg-1.1.0-1.21.11-NeoForge" = _jgFWKiMe;
        "pkg-1.2.1" = _KETYiClr;
        "pkg-26.1.2.0" = _2ClMsqst;
        "pkg-26.2.0" = _iXImSNHs;
