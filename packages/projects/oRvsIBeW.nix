...
let
    versions = (let
        ...
        _LtF8CfYr = {
            "id" = "LtF8CfYr";
            "file" = "BetterScreenShots-1.10+1.21-1.21.1.jar";
            "hash" = "sha512-A9WaON0joxYmRg6ShL6TlA3Jt5Y/nHvdonUqWeUm7r2WXm7aaDf7uvT+37gA2aUje89igjY/wPqceueZ28HS3g==";
        };
        _vISWo1Wd = {
            "id" = "vISWo1Wd";
            "file" = "better_screenshots-1.10+1.21-1.21.1.jar";
            "hash" = "sha512-8qbfJysaNfiNdha6HEYnt7QuNLwIgis/9XhQ8HKBDizK4JRnJ/MFu58DjUqAtqthacbnhSC07i4JqN0bYS7Nhg==";
        };
        _n9gL48D7 = {
            "id" = "n9gL48D7";
            "file" = "better_screenshots-1.10+1.21-1.21.1.jar";
            "hash" = "sha512-DpJgcuu4btdf1wzBsTWnzknT5dojyrt61FO5Y+lYh61pOIA+N6eVey5m8mxE23QAaw66WITarNOk2KV2l1NCCw==";
        };
        _4v3tKD4A = {
            "id" = "4v3tKD4A";
            "file" = "BetterScreenShots-1.10+1.21.2-1.21.4.jar";
            "hash" = "sha512-fEBkxWbjwvEy/vuX59j1zFdm+rHODtgA3ymkxKIB7FW+CH03zAHwlATDnUKgcQN+r65c+8vAKBk6jaxjaONI3Q==";
        };
        _LtWefBsd = {
            "id" = "LtWefBsd";
            "file" = "better_screenshots-1.10+1.21.2-1.21.4.jar";
            "hash" = "sha512-bRXhpYUyeJUCyDYBRqjtZzFF9mQBdQ79uXBE1gJGq/35S0BLry+n4/dHehh/9G1TA3DV1aAQOoxV6KSvrjDvsA==";
        };
        _6f9zY9TV = {
            "id" = "6f9zY9TV";
            "file" = "better_screenshots-1.10+1.21.2-1.21.4.jar";
            "hash" = "sha512-fHx2Cdf2wss4jfVQZfzGsz3sV5YNeY9WdtLaEGlaJej/YwbDukFTKQDAA4FwiCYIA2lrvZ1jQzTeEG14EuLk0A==";
        };
        _uk0Kr6px = {
            "id" = "uk0Kr6px";
            "file" = "BetterScreenShots-1.10+1.21.5.jar";
            "hash" = "sha512-eob6A96wQRWaa+ZlkE5MANLrjt2w0AgobWhfvjbqdSDHO+2YqpWTZzfuItzArErdjJD1a5+Yvyy9Wi8VfFybPQ==";
        };
        _LUiT9R9b = {
            "id" = "LUiT9R9b";
            "file" = "better_screenshots-1.10+1.21.5.jar";
            "hash" = "sha512-bHhCnLkCMl6psgkKiyEMRHd9oxPE3eLP5E3CxBlRX5D7kbMIPsuYwhKMNdJbuIFKezYDEvohyY9dd5rsw/X1JQ==";
        };
        _t4ulXFRW = {
            "id" = "t4ulXFRW";
            "file" = "better_screenshots-1.10+1.21.5.jar";
            "hash" = "sha512-dbFoslN+nrI2JIHUZYLbRfOXzo6FSaBFcu4rWX9HmqalMRS8q+OFbnPMRfTu8sWUO3gus+D3md9J08A03BIxFw==";
        };
        _Pvy0Ba0q = {
            "id" = "Pvy0Ba0q";
            "file" = "BetterScreenShots-1.10+1.21.6-1.21.8.jar";
            "hash" = "sha512-lg7wWpJ3IQrMRl8NG0nAQcHYKQZihUgrt4AE/OjdcJvR5tXiI1UWbrNA1/4L9nDpSb5Dgd127pb6nHObSK5EgQ==";
        };
        _F9Io4v68 = {
            "id" = "F9Io4v68";
            "file" = "better_screenshots-1.10+1.21.6-1.21.8.jar";
            "hash" = "sha512-2bqylvaxUUrzplj1TboKCIrvab4FH+Gr0DzHY/2CSLQbhor1JsW+9bj2vsEE4Mz73vcBDqS8b6vnlR5xnyB1pg==";
        };
        _Jw3ZUcAg = {
            "id" = "Jw3ZUcAg";
            "file" = "better_screenshots-1.10+1.21.6-1.21.8.jar";
            "hash" = "sha512-lMqv2uFKkQn20Bf75lRRGijkeO/TFtF2xn0vgIkhh+2QyAGFOHko0y5SuCihpoxxtwNAp553kMLMgvGkbLOCCw==";
        };
        _EMh8Ty1R = {
            "id" = "EMh8Ty1R";
            "file" = "BetterScreenShots-1.10+1.21.9-1.21.10.jar";
            "hash" = "sha512-rU34xdZHybqesADXMPQVzqVFajOHFTOkZkxweIeXUmJSCFEK+/XFIPWSQr2pMvLMGS6LZeEfYoPiYJbpWkorgw==";
        };
        _yBuzpvsJ = {
            "id" = "yBuzpvsJ";
            "file" = "better_screenshots-1.10+1.21.9-1.21.10.jar";
            "hash" = "sha512-5OVUs3C+j30B0kBXTaGyHFU6IxFCrm4hJzH4ngB8bvQLMdmC8OLeBuQOXAf6WHqmPy6FgZVNn2eLQ3R2wyLp/Q==";
        };
        _Kk2Gjb5Y = {
            "id" = "Kk2Gjb5Y";
            "file" = "better_screenshots-1.10+1.21.9-1.21.10.jar";
            "hash" = "sha512-uT1KefVO4hXhFnPen5C+YnZCLWC47Tg8b6gReRk7vYCVWwuoIVlgMib2zGW10Ldo2a41dpC3OEVInIbtdwV6Ow==";
        };
        _ZiK0rQLw = {
            "id" = "ZiK0rQLw";
            "file" = "BetterScreenShots-1.10+1.21.11.jar";
            "hash" = "sha512-Q25HwVjiPFtsSBsb6GuU1e1Q90OchxoKrzyfvJOnQKi32MEIw8457ZG1Pk47ltZM3Y/fFxsMRC4lyKKG4/rqVQ==";
        };
        _ZtNkpTk3 = {
            "id" = "ZtNkpTk3";
            "file" = "better_screenshots-1.10+1.21.11.jar";
            "hash" = "sha512-src5mXvZw7+tV+ZCCpVdG4gWpEapXzHrFTVfZWetG6ZbxJqU0Pa11vL6U5FMtCOx8THYDGi6fEr6p3sb2CVm/A==";
        };
        _Mx4d305p = {
            "id" = "Mx4d305p";
            "file" = "better_screenshots-1.10+1.21.11.jar";
            "hash" = "sha512-qIcb6m60IXJaU48dE2TqUk3DVldyUnTatblCbp7yO+JOaPsRpAQhyla32cbmiBQJnMCTtUX62mRLO6yxPdLx0Q==";
        };
        _3ferzX7e = {
            "id" = "3ferzX7e";
            "file" = "BetterScreenShots-1.10+26.1-26.1.2.jar";
            "hash" = "sha512-dQFE0+Kd74WD6iSaVHaMM5MkUJlqFK0cZUAPO7ZkPOjENlMTGSypg81gDqoto60OceLrOGS+eeyQ3ZKt+eHmgw==";
        };
        _nkRSuyeR = {
            "id" = "nkRSuyeR";
            "file" = "better_screenshots-1.10+26.1-26.1.2.jar";
            "hash" = "sha512-tQPkdT+4gtW8Dx5FhWGcKCBCbCoXDpPyQCUdhZ1/lvSY45AwG6bwSJL7MoJmjVeIKtuQ14/ExI4xTGMGMhuvyA==";
        };
        _rKcbCXif = {
            "id" = "rKcbCXif";
            "file" = "better_screenshots-1.10+26.1-26.1.2.jar";
            "hash" = "sha512-5ApH0u+2m7bjH1tvl+roBCAzUREBrArDixap3eW6sKqNck30/dR7bdB5Nh83UcSDMmmA2srI6qbt5hjqKDnXBg==";
        };
        _F9P05qUa = {
            "id" = "F9P05qUa";
            "file" = "BetterScreenShots-1.10+26.2.jar";
            "hash" = "sha512-0VXQ0BiIBW+drmxcR49hO7lk3rYTpoyLl8qEtughBP3VlSrX2ZASHpouxI1iSdgIAfR3XWTfIh+PYhGYeebmgA==";
        };
        _K1MUChZ4 = {
            "id" = "K1MUChZ4";
            "file" = "better_screenshots-1.10+26.2.jar";
            "hash" = "sha512-aF24ShVmCoWLvfgOZrQTfNZRUlJ0uWdSzaBagWa3E3i2SLkEL8WZLEccSAziJLft8bWNXlra3JJamvg1MjYQxQ==";
        };
        _PmnTbkdS = {
            "id" = "PmnTbkdS";
            "file" = "better_screenshots-1.10+26.2.jar";
            "hash" = "sha512-kVD691NpXBsTMfrK8xztUWoxCGEUaeMnfSQo9Aot3vKW3wll8Y6YV4HKxDHFvcBLn0X9P+dx4vTGk3ITlUmTxA==";
        };
        _IWMDleoB = {
            "id" = "IWMDleoB";
            "file" = "BetterScreenShots-1.11+1.21-1.21.1.jar";
            "hash" = "sha512-RaOampn9Ci5WcOqCo5KntywrpowGtYyDJEBzyztJGvI062Vt9r2RbCpA7TQhMbQFGBvQIYEPtQd9+1QokYnyoQ==";
        };
        _XOkLxStq = {
            "id" = "XOkLxStq";
            "file" = "better_screenshots-1.11+1.21-1.21.1.jar";
            "hash" = "sha512-D4l36ZEXIR6b8eEHfjcjAj18zHrFBkeTQ00AWbPS1/36yiVG/61+k/ooeOXYCaC3X++zLt6qNQHKI1AsmYyJBw==";
        };
        _d6WPSjN5 = {
            "id" = "d6WPSjN5";
            "file" = "better_screenshots-1.11+1.21-1.21.1.jar";
            "hash" = "sha512-ZL7a+YlhyFJA3nqxpu8pm2MDgYGqhTZp03HujKDsAqfRRZ+f0qMvYNnhh/v9EwVI6ZRsGElzwLdemtPoObWgjg==";
        };
        _DNo6wVMl = {
            "id" = "DNo6wVMl";
            "file" = "BetterScreenShots-1.11+1.21.2-1.21.4.jar";
            "hash" = "sha512-2ickJB4TCDjuEf3YYPAM1SGZM//Xs/kX6q5nQ65qiUud8ZEKO+0x9AeBJ65r00vbl6gQHfNs+/wZsOn/CN02Og==";
        };
        _Y3zW4KBJ = {
            "id" = "Y3zW4KBJ";
            "file" = "better_screenshots-1.11+1.21.2-1.21.4.jar";
            "hash" = "sha512-txBFFga4F0hG+86r0Oxz822Rz3fBPJVld9WB279IsfGHBvx8zSEFwX3cNEl1iGBhEX7w7EVYVGUbtiwHB+j38w==";
        };
        _QaK2FTlq = {
            "id" = "QaK2FTlq";
            "file" = "better_screenshots-1.11+1.21.2-1.21.4.jar";
            "hash" = "sha512-Y/Fp5JxbbhRTUjhz6zkt7tsgtCq89HrR8lru1m/Q7QPa/lTgQQ4xO5evwjN0bccJc4ixs/wm+dP6qbgp0jWV0Q==";
        };
        _4kGFSd6I = {
            "id" = "4kGFSd6I";
            "file" = "BetterScreenShots-1.11+1.21.5.jar";
            "hash" = "sha512-7FYyjOEbpiVFj0+JjgcbjDBsVdqYQ1441pjOW2i257TJzjzdVb83ZWOPRqVCAHFccJuVg1U510QEXrCcVacnjg==";
        };
        _bTL4qnTu = {
            "id" = "bTL4qnTu";
            "file" = "better_screenshots-1.11+1.21.5.jar";
            "hash" = "sha512-x4jgY8bAmGNDK8fJuIzipC7Imez76mHR9wpJ8Fw07t7JLOE9kiFcPlcd6NTZ+DxyscQlu99Ized5r7EVUsLE+Q==";
        };
        _r2xCnlPR = {
            "id" = "r2xCnlPR";
            "file" = "better_screenshots-1.11+1.21.5.jar";
            "hash" = "sha512-BuwXdeOGnQGD4K+dUnc7k4sXk8bRT7UkBoVCbDnCFjV2L1RFBXIr4+YB4TzYW6jNu5NnpATfONeayi2rU4FxsA==";
        };
        _mIkhTHfN = {
            "id" = "mIkhTHfN";
            "file" = "BetterScreenShots-1.11+1.21.6-1.21.8.jar";
            "hash" = "sha512-oekSX8spdX5gexnAogt7+nZXo4yq3yn1OY2s5QAwqwH2x3ZiYdAEQe+2oQbbtRTEzpWJQKfHGGOwzXd87NnC2Q==";
        };
        _pCz2XAKL = {
            "id" = "pCz2XAKL";
            "file" = "better_screenshots-1.11+1.21.6-1.21.8.jar";
            "hash" = "sha512-eArlGFqhDQJ9Fp3srGRP2L2950ryz8m9je3qg9u2sUDQkZ3k3ZOVbFPfP5uFaqZ+BizvGf+ojsakrZAXxs7AFw==";
        };
        _4d25RjBF = {
            "id" = "4d25RjBF";
            "file" = "better_screenshots-1.11+1.21.6-1.21.8.jar";
            "hash" = "sha512-svGKakpPlfIigeTECp7rzuK2YUkzXMYdtb7bWu56YHLH7DTSkSnNTqmg7AH/Ij0VHV+3gSCo/xnI04A+YenalA==";
        };
        _ieeQMuUO = {
            "id" = "ieeQMuUO";
            "file" = "BetterScreenShots-1.11+1.21.9-1.21.10.jar";
            "hash" = "sha512-mT6LiK/vfrtWEBiqhc1D94Z8+IPRH0tsml8CbppGyilOgzHksTWd5pxwAeX0B40qoUPa2M/5S0DcgVsCLvrQ2Q==";
        };
        _KNNymH65 = {
            "id" = "KNNymH65";
            "file" = "better_screenshots-1.11+1.21.9-1.21.10.jar";
            "hash" = "sha512-YmHLDasu3pS6pQ4XSk6iOyVihzXzty5/Nkh6HUAgTeZWdy7aGtbwAHY6hdYKlIzgleXvEpmRbfTQvgR35nm+Zg==";
        };
        _wBxBLy1V = {
            "id" = "wBxBLy1V";
            "file" = "better_screenshots-1.11+1.21.9-1.21.10.jar";
            "hash" = "sha512-MBd83JnK3YKKRUQ4CN3Pg6CdPS9h4C/i4duf4PcB0T++xZv3U7VD2JpRL34bRYmYQThEdPB6UbwKoPl2EPsdNg==";
        };
        _qJrRDIp4 = {
            "id" = "qJrRDIp4";
            "file" = "BetterScreenShots-1.11+1.21.11.jar";
            "hash" = "sha512-yOZGHbb5ZN7m4uGfsFTgNVsk1xu7J+Cs+DRpNWsksKxcIII/3i70iqqsa09hSrl0zlFW4Bqb079qUoNhQW2UNA==";
        };
        _wnUgbnX0 = {
            "id" = "wnUgbnX0";
            "file" = "better_screenshots-1.11+1.21.11.jar";
            "hash" = "sha512-8LVNLgB76zOjE6kK7Wo+GTasuKCCHxiq5yvwersXvUzhg5VVW+h2mYUIJcwPIwQ8S3Hs/DWlRpwqmzQ0HXM2+Q==";
        };
        _V1jlUad4 = {
            "id" = "V1jlUad4";
            "file" = "better_screenshots-1.11+1.21.11.jar";
            "hash" = "sha512-gS7WhYrzVWkwDgMaGqDOvVnB1iTOiukdQ8SBlYtqvAZvTeQt1gZiiAvIji33DO1RclA+DuAN9pCz5vk49cEaLQ==";
        };
        _hblmy43j = {
            "id" = "hblmy43j";
            "file" = "BetterScreenShots-1.11+26.1-26.1.2.jar";
            "hash" = "sha512-o9KsYa2RMQVdoGpArvUL+KpDdmuFx2Zju+JlU5lHMHVqWBCpUWVi6e2Er12kRRMBe2+HlzfxIZ7x9ZD0hHIPLA==";
        };
        _d3bp3fpN = {
            "id" = "d3bp3fpN";
            "file" = "better_screenshots-1.11+26.1-26.1.2.jar";
            "hash" = "sha512-LdhDMAyP/lS18aSnxQn4tsk1wWIrO3N/6RyoXsufKqne9Rbl9/+673LbvPjIEQ2aPBwh+5zgIWQeSUar/m4VFQ==";
        };
        _lCQo7Pbn = {
            "id" = "lCQo7Pbn";
            "file" = "better_screenshots-1.11+26.1-26.1.2.jar";
            "hash" = "sha512-p9bKQT6OKo685GbQ+I8I4/oy9gNEhGlE6aL5J907EJNi1j3pX+M4U5bmPxDtdqRtLArtSggf0w6JejTBKWortQ==";
        };
        _c7XWijw9 = {
            "id" = "c7XWijw9";
            "file" = "BetterScreenShots-1.11+26.2.jar";
            "hash" = "sha512-E8tF5KxJdc1KhiqNElGk6gO4xzKqRGMsTuta1Upyw+VoV+XN2Q6LZPldjwabpeeOGMySvDVpNEsNkiGSTw2sxw==";
        };
        _q9QqedqW = {
            "id" = "q9QqedqW";
            "file" = "better_screenshots-1.11+26.2.jar";
            "hash" = "sha512-a1tARB2O0pWL2WMmwpT1JRnbasCwEHKk+aSgRxHqWCVsiPUNYkSK5gF0qH9sEk2t/vWHqdZXSh+cTMPNRSX2HA==";
        };
        _TpBe6QJy = {
            "id" = "TpBe6QJy";
            "file" = "better_screenshots-1.11+26.2.jar";
            "hash" = "sha512-FduEmKD4/vXGnYqLfRnrRn6GXzmGsUStedC24OU8mwlvx50MEAk9wcdlUi1JbSenDxxSk6CfWVmcjCoF/YPckg==";
        };
        _bJ97qAg3 = {
            "id" = "bJ97qAg3";
            "file" = "BetterScreenShots-1.11+26.3.jar";
            "hash" = "sha512-ihZGtZCNQnXg1ppGiEL4dMK3rU5PBexl2ZZJGFyFpRkUkZGm1tvdFVcoa4YOkRsy8l67v9D+I0Xp66XGnhWFCg==";
        };
    in {
        "VPkRzJ1b" = _VPkRzJ1b;
        "saayD0H1" = _saayD0H1;
        ...
        "TpBe6QJy" = _TpBe6QJy;
        "bJ97qAg3" = _bJ97qAg3;
        "fabric-1.21.11" = _qJrRDIp4;
        "fabric-1.21.9" = _ieeQMuUO;
        "fabric-1.21.10" = _ieeQMuUO;
        "fabric-1.21.6" = _mIkhTHfN;
        "fabric-1.21.7" = _mIkhTHfN;
        "fabric-1.21.8" = _mIkhTHfN;
        "fabric-26.1" = _hblmy43j;
        "fabric-26.1.1" = _hblmy43j;
        "fabric-26.1.2" = _hblmy43j;
        "fabric-1.21" = _IWMDleoB;
        "fabric-1.21.1" = _IWMDleoB;
        "fabric-1.21.2" = _DNo6wVMl;
        "fabric-1.21.3" = _DNo6wVMl;
        "fabric-1.21.4" = _DNo6wVMl;
        "fabric-1.21.5" = _4kGFSd6I;
        "fabric-26.2" = _c7XWijw9;
        "fabric-26.3" = _bJ97qAg3;
        "neoforge-26.1" = _d3bp3fpN;
        "neoforge-26.1.1" = _d3bp3fpN;
        "neoforge-26.1.2" = _d3bp3fpN;
        "neoforge-1.21.6" = _pCz2XAKL;
        "neoforge-1.21.7" = _pCz2XAKL;
        "neoforge-1.21.8" = _pCz2XAKL;
        "neoforge-1.21.9" = _KNNymH65;
        "neoforge-1.21.10" = _KNNymH65;
        "neoforge-1.21.11" = _wnUgbnX0;
        "neoforge-1.21" = _XOkLxStq;
        "neoforge-1.21.1" = _XOkLxStq;
        "neoforge-1.21.2" = _Y3zW4KBJ;
        "neoforge-1.21.3" = _Y3zW4KBJ;
        "neoforge-1.21.4" = _Y3zW4KBJ;
        "neoforge-1.21.5" = _bTL4qnTu;
        "neoforge-26.2" = _q9QqedqW;
        "forge-1.21" = _d6WPSjN5;
        "forge-1.21.1" = _d6WPSjN5;
        "forge-1.21.3" = _QaK2FTlq;
        "forge-1.21.4" = _QaK2FTlq;
        "forge-1.21.5" = _r2xCnlPR;
        "forge-1.21.6" = _4d25RjBF;
        "forge-1.21.7" = _4d25RjBF;
        "forge-1.21.8" = _4d25RjBF;
        "forge-1.21.9" = _wBxBLy1V;
        "forge-1.21.10" = _wBxBLy1V;
        "forge-1.21.11" = _V1jlUad4;
        "forge-26.1" = _lCQo7Pbn;
        "forge-26.1.1" = _lCQo7Pbn;
        "forge-26.1.2" = _lCQo7Pbn;
        "forge-1.21.2" = _QaK2FTlq;
        "forge-26.2" = _TpBe6QJy;
        "pkg-0.1" = _VPkRzJ1b;
        "pkg-0.2" = _saayD0H1;
        "pkg-0.3" = _jBWK0Ekh;
        "pkg-0.4" = _XYOf6sLN;
        "pkg-0.5+1.21.11" = _qCSCqJeK;
        "pkg-0.5+1.21.9-1.21.10" = _bNfNfz6N;
        "pkg-0.5+1.21.6-1.21.8" = _KARWxBbq;
        "pkg-0.6+1.21.11" = _mjH8941n;
        "pkg-0.6+1.21.9-1.21.10" = _yhIKJfln;
        "pkg-0.6+1.21.6-1.21.8" = _WCCNbGll;
        "pkg-0.7+1.21.11" = _rtnL3r7n;
        "pkg-0.7+1.21.9-1.21.10" = _cIfBc0Bg;
        "pkg-0.7+1.21.6-1.21.8" = _xZpAprnx;
        "pkg-0.7+26.1" = _MDaDDrEF;
        "pkg-0.8+26.1-26.1.1" = _wVVr5wTz;
        "pkg-0.8+1.21.11" = _DbFez5eZ;
        "pkg-0.8+1.21.9-1.21.10" = _ROv6ixpQ;
        "pkg-0.8+1.21.6-1.21.8" = _Oyt71cv0;
        "pkg-0.9+1.21.6-1.21.8" = _iY1O4bJ5;
        "pkg-0.9+1.21.9-1.21.10" = _KTUVGSNA;
        "pkg-0.9+1.21.11" = _7EEM1Nnr;
        "pkg-0.9+26.1-26.1.1" = _oqJ7AcD4;
        "pkg-0.9.1+26.1-26.1.2" = _zKNsRwlR;
        "pkg-1.1+1.21.6-1.21.8" = _eMi5KnAy;
        "pkg-1.1+1.21.9-1.21.10" = _qwXVgX3s;
        "pkg-1.1+1.21.11" = _XFinfmyY;
        "pkg-1.1+26.1-26.1.2" = _TlESeQje;
        "pkg-1.2+1.21.6-1.21.8" = _XIx9frtc;
        "pkg-1.2+1.21.9-1.21.10" = _OKaYYVyv;
        "pkg-1.2+1.21.11" = _8eBbmFXj;
        "pkg-1.2+26.1-26.1.2" = _qgVEolP2;
        "pkg-1.2-beta+26.1-26.1.2" = _q8GsP2Jz;
        "pkg-1.3+1.21.6-1.21.8" = _jpZhlg4a;
        "pkg-1.3+1.21.9-1.21.10" = _uq7VuRHH;
        "pkg-1.3+1.21.11" = _YJUt2PcK;
        "pkg-1.3+26.1-26.1.2" = _6QgUw6oo;
        "pkg-1.3.1+1.21.6-1.21.8" = _mUGRSYwW;
        "pkg-1.3.1+26.1-26.1.2" = _5c9y8tTI;
        "pkg-1.3.2+26.1-26.1.2" = _Ruu5xQWv;
        "pkg-1.3.5+1.21.6-1.21.8" = _PTWyx91y;
        "pkg-1.3.5+1.21.9-1.21.10" = _QHVKDtZO;
        "pkg-1.3.5+1.21.11" = _VB6h4Cyp;
        "pkg-1.3.5+26.1-26.1.2" = _KlBvOK0D;
        "pkg-1.3.5-beta+1.21-1.21.1" = _9Z9mIQwF;
        "pkg-1.3.5-beta+1.21.2-1.21.4" = _GubhWKvN;
        "pkg-1.3.5-beta+1.21.5" = _i2wPQVyU;
        "pkg-1.4+1.21-1.21.1" = _9bpVCkKg;
        "pkg-1.4+1.21.2-1.21.4" = _S3qa3XT2;
        "pkg-1.4+1.21.5" = _BN0hwL4V;
        "pkg-1.4+1.21.6-1.21.8" = _Rxuf1GU4;
        "pkg-1.4+1.21.9-1.21.10" = _qds8j3L6;
        "pkg-1.4+1.21.11" = _sGeoDugS;
        "pkg-1.4+26.1-26.1.2" = _BSMGpTWb;
        "pkg-1.4.1+1.21-1.21.1" = _ZAHHT7mE;
        "pkg-1.4.1+1.21.2-1.21.4" = _YgRgTyWF;
        "pkg-1.4.1+1.21.5" = _RrSsugoA;
        "pkg-1.4.1+1.21.6-1.21.8" = _ULNl4Zv3;
        "pkg-1.4.1+1.21.9-1.21.10" = _qxWzcxx3;
        "pkg-1.4.1+1.21.11" = _abuLeiIU;
        "pkg-1.4.1+26.1-26.1.2" = _60OzNpgk;
        "pkg-1.4.1+1.21.3-1.21.4" = _b3MZTGBB;
        "pkg-1.5+1.21-1.21.1" = _IXSHpV8a;
        "pkg-1.5+1.21.2-1.21.4" = _781I42Zo;
        "pkg-1.5+1.21.5" = _EvFUOXfR;
        "pkg-1.5+1.21.6-1.21.8" = _o4MadpFX;
        "pkg-1.5+1.21.9-1.21.10" = _fjLrrKJH;
        "pkg-1.5+1.21.11" = _KVpa9sJD;
        "pkg-1.5+26.1-26.1.2" = _BJCCmleM;
        "pkg-1.5.1+26.2" = _MHJzMIkW;
        "pkg-1.6+1.21-1.21.1" = _9uPJ9aVX;
        "pkg-1.6+1.21.2-1.21.4" = _wzbPa5ek;
        "pkg-1.6+1.21.3-1.21.4" = _2tTQGs3U;
        "pkg-1.6+1.21.5" = _KZqnbhXT;
        "pkg-1.6+1.21.6-1.21.8" = _oM7oiu3O;
        "pkg-1.6+1.21.9-1.21.10" = _bkHNTSLA;
        "pkg-1.6+1.21.11" = _nX24cqoo;
        "pkg-1.6+26.1-26.1.2" = _DuL7oFCz;
        "pkg-1.6+26.2" = _PglPitKq;
        "pkg-1.7+1.21-1.21.1" = _pxs8RnmZ;
        "pkg-1.7+1.21.2-1.21.4" = _zqrlXuo6;
        "pkg-1.7+1.21.5" = _XYdq8dhR;
        "pkg-1.7+1.21.6-1.21.8" = _TZhCCVEx;
        "pkg-1.7+1.21.9-1.21.10" = _dhAMUzlf;
        "pkg-1.7+1.21.11" = _UiDbyBo4;
        "pkg-1.7+26.1-26.1.2" = _HStCh1vh;
        "pkg-1.7+26.2" = _JscH5DeS;
        "pkg-1.7.1+1.21-1.21.1" = _2Ww8QE9u;
        "pkg-1.7.1+1.21.2-1.21.4" = _cgWFxgqK;
        "pkg-1.7.1+1.21.5" = _L3tSGmxN;
        "pkg-1.7.2+1.21-1.21.1" = _nxSVaFnP;
        "pkg-1.7.2+1.21.2-1.21.4" = _bG0fcHbE;
        "pkg-1.7.2+1.21.5" = _h4FjCbDo;
        "pkg-1.7.2+1.21.6-1.21.8" = _KXhDbVls;
        "pkg-1.7.2+1.21.9-1.21.10" = _oBzgxcam;
        "pkg-1.7.2+1.21.11" = _FDDg47oM;
        "pkg-1.7.2+26.1-26.1.2" = _1OqGD5m2;
        "pkg-1.7.2+26.2" = _rUrja64T;
        "pkg-1.7.3+1.21-1.21.1" = _fTc1EM3w;
        "pkg-1.7.3+1.21.2-1.21.4" = _t9sSOw84;
        "pkg-1.7.3+1.21.5" = _NAJ91D9L;
        "pkg-1.7.3+1.21.6-1.21.8" = _R4oOSSLT;
        "pkg-1.7.3+1.21.9-1.21.10" = _vGR9Q8iI;
        "pkg-1.7.3+1.21.11" = _NO0SAhuy;
        "pkg-1.7.3+26.1-26.1.2" = _auUXzkvi;
        "pkg-1.7.3+26.2" = _SQ7bZ843;
        "pkg-1.8+1.21-1.21.1" = _b2TGPLZK;
        "pkg-1.8+1.21.2-1.21.4" = _E9nkvdvJ;
        "pkg-1.8+1.21.5" = _g4FZAJmm;
        "pkg-1.8+1.21.6-1.21.8" = _5u5ZU81b;
        "pkg-1.8+1.21.9-1.21.10" = _t8EyaGMi;
        "pkg-1.8+1.21.11" = _vIuwmR57;
        "pkg-1.8+26.1-26.1.2" = _apuaGjxq;
        "pkg-1.8+26.2" = _BNnSOjzX;
        "pkg-1.9+1.21-1.21.1" = _NHwb9iC0;
        "pkg-1.9+1.21.2-1.21.4" = _Y2qjHTaH;
        "pkg-1.9+1.21.5" = _yXqPCqJl;
        "pkg-1.9+1.21.6-1.21.8" = _w3zXS2es;
        "pkg-1.9+1.21.9-1.21.10" = _7204AKu5;
        "pkg-1.9+1.21.11" = _a8074VSR;
        "pkg-1.9+26.1-26.1.2" = _OagRKGiE;
        "pkg-1.9+26.2" = _biBBEeG4;
        "pkg-1.10+1.21-1.21.1" = _n9gL48D7;
        "pkg-1.10+1.21.2-1.21.4" = _6f9zY9TV;
        "pkg-1.10+1.21.5" = _t4ulXFRW;
        "pkg-1.10+1.21.6-1.21.8" = _Jw3ZUcAg;
        "pkg-1.10+1.21.9-1.21.10" = _Kk2Gjb5Y;
        "pkg-1.10+1.21.11" = _Mx4d305p;
        "pkg-1.10+26.1-26.1.2" = _rKcbCXif;
        "pkg-1.10+26.2" = _PmnTbkdS;
        "pkg-1.11+1.21-1.21.1" = _d6WPSjN5;
        "pkg-1.11+1.21.2-1.21.4" = _QaK2FTlq;
        "pkg-1.11+1.21.5" = _r2xCnlPR;
        "pkg-1.11+1.21.6-1.21.8" = _4d25RjBF;
        "pkg-1.11+1.21.9-1.21.10" = _wBxBLy1V;
        "pkg-1.11+1.21.11" = _V1jlUad4;
        "pkg-1.11+26.1-26.1.2" = _lCQo7Pbn;
        "pkg-1.11+26.2" = _TpBe6QJy;
        "pkg-1.11+26.3" = _bJ97qAg3;
        "default" = _bJ97qAg3;
    });
