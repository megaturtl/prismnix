...
let
    ...
    in {
        ...
        "pkg-0.3.15" = _STzaGH8b;
        "pkg-0.3.17" = _KMmNxfZV;
        "pkg-0.5.10" = _QBfJcUlc;
        "pkg-0.5.11" = _J2cvlSJR;
        "pkg-0.5.12" = _vcBX9B6F;
        "pkg-0.6.0-alpha.01" = _hYs7Q3FL;
        "pkg-0.6.0-alpha.02" = _1T8ek5D2;
        "pkg-0.6.0" = _w3Oyjx05;
        "pkg-0.6.1" = _pJ2TUBe5;
        "pkg-0.7.0-alpha.01" = _xsCmq6fF;
        "pkg-0.7.0" = _pgFgbVEO;
        "pkg-0.7.1" = _nJaCrllo;
        "pkg-0.7.2" = _LYinh00h;
        "pkg-1.0.0-alpha.01" = _g0orNo56;
        "pkg-1.0.0-alpha.02" = _Wz5HOZZ0;
        "pkg-0.7.3" = _8RCo0mIS;
        "pkg-1.0.0-alpha.03" = _mJ5ZEphZ;
        "pkg-1.0.0-alpha.04" = _MOQFxOZE;
        "pkg-1.0.0-alpha.05" = _A1yWfREG;
        "pkg-1.0.0-alpha.06" = _Ep0CnTFg;
        "pkg-1.0.0" = _8JaRGLEP;
        "pkg-0.7.4" = _W9s772LY;
        "pkg-1.0.1" = _74Fr0Br4;
        "pkg-1.0.2" = _1Gr8mg4d;
        ...
        "pkg-1.0.5" = _Imjfy4Zc;
        "pkg-0.7.5" = _S7tjtpby;
        "pkg-1.1.0-alpha.01" = _Tfk1ufM1;
        "pkg-1.1.0" = _hXlyotXQ;
        "pkg-1.1.1" = _rPiUix8v;
        "pkg-1.2.0" = _voemlndH;
        "pkg-1.2.1" = _M2Fbmma9;
        "pkg-1.3.0-beta" = _UrbCm3o1;
        "pkg-1.2.2" = _XkRitrFB;
        "pkg-1.3.1" = _j47dSPkc;
        "pkg-1.3.2" = _gQ4OZTZZ;
        "pkg-1.4.0" = _vMyJTmiN;
        "pkg-1.4.1" = _88A9HnvA;
        "pkg-1.2.3" = _7Wa0X74x;
        "pkg-1.4.2-beta" = _dkCIgQuI;
        "pkg-1.5.0-beta" = _yiDK9P09;
        "pkg-1.6.0-beta" = _4TdGTZx2;
        "pkg-1.6.1-beta" = _AgAQLQUK;
        "pkg-1.6.2-beta" = _tWVUekp5;
        "pkg-1.6.3" = _LE5GGqkX;
        "pkg-1.6.4" = _XY13dUKH;
        "pkg-1.6.5" = _B7LMSeGI;
        "pkg-1.6.6" = _cvBY8N2l;
        ...
        "pkg-1.6.8" = _wDoZGczq;
        "pkg-1.6.9" = _cKgnQ9EB;
        "pkg-1.6.10" = _U9PAlcvt;
        "pkg-1.6.11" = _JFVJZ5Y3;
        "pkg-1.6.12" = _LyX6otLv;
        "pkg-1.6.13" = _ZZpNyAwp;
        "pkg-1.6.14" = _h2e8BwBL;
        "pkg-1.7.0-beta" = _5vZ0kTYP;
        "pkg-1.7.1" = _guzxC1K0;
        "pkg-1.7.2" = _LaozcdwV;
        "pkg-1.7.3" = _4aMaIuZb;
        "pkg-1.6.15" = _E3hyv2Tc;
        "pkg-1.6.16" = _Wx2YFTRo;
        "pkg-1.7.4" = _RWdXZNT1;
        "pkg-1.6.17" = _RwHiuD8l;
        "pkg-1.6.18" = _1jgLuy1O;
        "pkg-1.8.0" = _Qw2Y5gWk;
        "pkg-2.0.0-alpha" = _HBadoENo;
        "pkg-2.0.1-alpha" = _vXzUOjFF;
        "pkg-2.0.2-alpha" = _5Jos0it7;
        "pkg-2.0.3-alpha" = _PVJ6ZlPT;
        "pkg-2.0.4-alpha" = _ZYfj9vpk;
        "pkg-2.0.5-alpha" = _FHg8vKKG;
        "pkg-2.0.6-alpha" = _f5qHyUJa;
        "pkg-2.0.7-alpha" = _FVf97avi;
        "pkg-2.0.8-alpha" = _la9De3fI;
        "pkg-1.8.1" = _AWkVuOOT;
        "pkg-2.0.9-alpha" = _S8WkHizf;
        "pkg-2.0.10-alpha" = _mpSnFo6i;
        "pkg-2.0.11-alpha" = _TKqqz4S2;
        "pkg-2.0.12-alpha" = _n7DVhLa1;
        "pkg-2.0.13-alpha" = _1fphN2Zt;
        "pkg-1.8.2" = _kG5fAj8t;
        "pkg-2.0.14-alpha" = _KD6O4xgu;
        "pkg-2.0.15-alpha" = _nGvJOo39;
        "pkg-1.8.3" = _Hv9olPbj;
        "pkg-2.0.16-alpha" = _Z3KNwzqV;
        "pkg-2.0.17-alpha" = _TMYCbp0E;
        "pkg-1.8.4" = _hnSXTMX3;
        "pkg-2.0.18-alpha" = _e2H0S6ZN;
        "pkg-2.0.19" = _ymccRNls;
        "pkg-2.1.0-alpha" = _60gt0cBw;
        "pkg-2.0.20" = _KhhwRkNB;
        "pkg-1.8.5" = _cJOYK8Hb;
        "pkg-2.0.21" = _ApwJhYPr;
        "pkg-2.1.1-alpha" = _c5o9kG0J;
        "pkg-2.1.2-alpha" = _B8BFKTIE;
        "pkg-2.2.0-alpha" = _ML3KH1eZ;
        "pkg-2.2.1-alpha" = _J1LOyfr8;
        "pkg-2.2.2-alpha" = _pohqBfrl;
        "pkg-2.2.3-alpha" = _FysIh6DQ;
        "pkg-2.0.22" = _fBjzFoeE;
        "pkg-2.2.4-alpha" = _2wuFpz2G;
        "pkg-2.0.23" = _dgwWgASD;
        "pkg-2.2.5-alpha" = _pZ3WfvHL;
        "pkg-2.2.6-alpha" = _vsGke5j0;
        "pkg-2.2.7-beta" = _AZAI7zRz;
        "pkg-2.0.24" = _KtBjLXuD;
        "pkg-2.2.8-beta" = _ggGFZM80;
        "pkg-2.2.9-beta" = _UDN2nDmO;
        "pkg-2.2.10-beta" = _kW82fhBs;
        "pkg-2.2.11-beta" = _czGIklqF;
        "pkg-2.2.12-beta" = _DlWBnwNB;
        "pkg-2.2.13-beta" = _GsARBssV;
        "pkg-1.6.19" = _2WEOIbpR;
        "pkg-1.8.6" = _18Bcl0A4;
        "pkg-2.0.25" = _jMNqVC4g;
        "pkg-2.2.14-beta" = _hZyK39rq;
        "pkg-2.2.15-beta" = _Tr2tn1qe;
        "pkg-2.2.16-beta" = _ZW8DU7UK;
        "pkg-2.2.17-beta" = _V01ddgp9;
        "pkg-2.2.18-beta" = _4O3MHtnp;
        "pkg-2.2.19-beta" = _gQTQSHs1;
        "pkg-2.2.20-beta" = _3AtuUwY8;
        "pkg-2.2.21-beta" = _fkbAhPcF;
        "pkg-2.2.22" = _Mc9zuen7;
        "pkg-2.2.23" = _zV303V1p;
        "pkg-2.2.24" = _VZWMVDnv;
        "pkg-2.2.25" = _v0YscxU9;
        "pkg-2.2.26" = _ZdkUbgJm;
        "pkg-2.2.27" = _x7I9GS25;
        "pkg-2.2.29" = _EVrWAtXD;
        "pkg-2.2.30" = _bFBjBYdv;
        "pkg-2.2.31" = _u11r3DPC;
        "pkg-2.2.32" = _kWXiUvmu;
        "pkg-2.2.33" = _ydJDkg0V;
        "pkg-2.2.34" = _JobrETwu;
        "pkg-2.3.0" = _jhtR8DiH;
        "pkg-2.3.1" = _AjJUy1pk;
        "pkg-2.3.2" = _P9PASIaM;
        "pkg-2.3.3" = _LSNh1fKv;
        ...
        "pkg-2.3.8" = _UfxsOd7r;
        "pkg-2.3.9" = _s6xaAFxZ;
        "pkg-2.3.10" = _MzUma5EG;
        "pkg-2.3.11" = _wleGKkPe;
        "pkg-2.3.12" = _xyYYCtgj;
        "pkg-2.3.13" = _Spr7LRWd;
        "pkg-2.3.14" = _Z0PFxTlA;
        "pkg-2.3.15" = _nz4mk9In;
        "pkg-2.3.16" = _2V9tMTAz;
        "pkg-2.4.0" = _IuBv8k1q;
        "pkg-2.4.1" = _JgaMsKoh;
        "pkg-2.4.2" = _FZXo81n7;
        "pkg-2.4.3" = _zI1AzXFg;
