...
let
    ...
    in {
        ...
        "pkg-1.1.0+mc1.21.10" = _8ZYFTpCa;
        "pkg-1.1.0+mc26.1" = _26UMG6oG;
        "pkg-1.2.0+mc1.21.11" = _77buAuMT;
        "pkg-1.2.0+mc26.1" = _FsPiDEfY;
        "pkg-1.2.0+mc1.21.1" = _qSozTShw;
        "pkg-1.2.1+mc26.1" = _DXrVxJg1;
        "pkg-1.2.1+mc1.21.1" = _5Q6huooW;
