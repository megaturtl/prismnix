...
let
    ...
    in {
        ...
        "VmqeHeSk" = _VmqeHeSk;
        "depniuJi" = _depniuJi;
        "fabric-1.21" = _a3NWV2rt;
        "fabric-1.21.1" = _a3NWV2rt;
        "fabric-1.21.2" = _yGpKICog;
        "fabric-1.21.3" = _a3NWV2rt;
        "fabric-1.21.4" = _WyatRMkH;
        "fabric-1.21.5" = _WyatRMkH;
        "fabric-1.21.6" = _WyatRMkH;
        "fabric-1.21.7" = _WyatRMkH;
        "fabric-1.21.8" = _WyatRMkH;
        "fabric-1.21.9" = _WyatRMkH;
        "fabric-1.21.10" = _WyatRMkH;
        "fabric-1.21.11" = _WyatRMkH;
        ...
        "fabric-26.1" = _VmqeHeSk;
        "fabric-26.1.1" = _VmqeHeSk;
        "fabric-26.1.2" = _VmqeHeSk;
        "fabric-26.2" = _depniuJi;
        "quilt-1.21" = _a3NWV2rt;
        "quilt-1.21.1" = _a3NWV2rt;
        "quilt-1.21.2" = _yGpKICog;
        "quilt-1.21.3" = _a3NWV2rt;
        "quilt-1.21.4" = _WyatRMkH;
        "quilt-1.21.5" = _WyatRMkH;
        "quilt-1.21.6" = _WyatRMkH;
        "quilt-1.21.7" = _WyatRMkH;
        "quilt-1.21.8" = _WyatRMkH;
        "quilt-1.21.9" = _WyatRMkH;
        "quilt-1.21.10" = _WyatRMkH;
        "quilt-1.21.11" = _WyatRMkH;
        ...
        "quilt-26.1" = _VmqeHeSk;
        "quilt-26.1.1" = _VmqeHeSk;
        "quilt-26.1.2" = _VmqeHeSk;
        "quilt-26.2" = _depniuJi;
        "pkg-1.0.0" = _q6yuMelE;
        "pkg-1.1.0" = _F6i0xV1W;
        "pkg-1.2.0" = _P51VD0xs;
        "pkg-1.3.0" = _lo4GRpXa;
