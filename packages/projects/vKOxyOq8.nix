...
let
    ...
    in {
        ...
        "pkg-1.18.2" = _mur8jSxu;
        "pkg-1.19" = _rP4IAua1;
        "pkg-1.19.1" = _Q4x07nWN;
        "pkg-1.19.2" = _ZDDPfn0j;
        "pkg-1.19.3" = _Mtwzis6a;
        "pkg-1.19.4" = _YPPb06jI;
        "pkg-1.20" = _LjmVs8nX;
        "pkg-1.20.1" = _q75gtajF;
        "pkg-1.20.2" = _wtbUuAzM;
        "pkg-1.20.3" = _hc46FMFg;
        "pkg-1.20.4" = _UQYBzNBy;
        "pkg-1.20.5" = _kgM3QhO3;
        "pkg-1.20.6" = _iXImWrIT;
        ...
        "pkg-1.21.8" = _lq07Hiyg;
        "pkg-1.21.9" = _tTHE0Css;
        "pkg-1.21.10" = _y23cv9Jk;
        "pkg-1.21.11" = _RS562jVh;
        "pkg-26.1" = _e4Ojn8TP;
        "pkg-26.1.1" = _kEvt4bpa;
        "pkg-0.0.3+1.21.x" = _azQw6SmV;
        "pkg-0.0.3+1.20.x" = _lyeD8MrC;
        "pkg-0.0.4+1.21.x" = _Eov7pihM;
