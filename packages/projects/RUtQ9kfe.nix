...
let
    versions = (let
        ...
        _PCInV27n = {
            "id" = "PCInV27n";
            "file" = "neoorigins-2.2.22+26.1.jar";
            "hash" = "sha512-vRZeEIv0GQ6nG4hkfl4HSLZ76yysdknn/uVaCd9qZWv98CfSba4GJHGoyfb19qPrlmy1WhxggMYyeC4ryb8EYw==";
        };
        _2gAAmFUb = {
            "id" = "2gAAmFUb";
            "file" = "neoorigins-2.2.22+26.2.jar";
            "hash" = "sha512-a+jGoR/iJk6bUQ0a2w5cAM96oGraO2XaC8IiCec2GeEiWUUpAQzjHBpHLc8lV77uWHHgEJAT/tfEl+8qNaM+Aw==";
        };
        _pxylSHZV = {
            "id" = "pxylSHZV";
            "file" = "neoorigins-2.2.22+1.21.1.jar";
            "hash" = "sha512-LuUyZ5hyMpPCRgJQ4bxMTZlhMiPjWAn7prbooqI1DDnAsH9ngCdO/yYEp/EuOikKLYB1JLI1BCetWsnFqA/pfQ==";
        };
        _cl9700xM = {
            "id" = "cl9700xM";
            "file" = "neoorigins-2.2.23+26.1.jar";
            "hash" = "sha512-0WFDPK5cCAW5YTmOhE4u0l8HMck8y6jjjNxa/oooTph1yxTk5kHg1aphdHlUnzLe8J/4B9x5cnnYKTUkuFz/sw==";
        };
        _ddQZ2Q0W = {
            "id" = "ddQZ2Q0W";
            "file" = "neoorigins-2.2.23+26.2.jar";
            "hash" = "sha512-3oUblSullnX3QGBsQO294YfE/uaC9MFmKzy7szBIwUdhYPUTcLjU26ZgvETEXOAJMBdLj0YlOAIXkOzJdhuPkg==";
        };
        _RQN61lFx = {
            "id" = "RQN61lFx";
            "file" = "neoorigins-2.2.23+1.21.1.jar";
            "hash" = "sha512-ynlWbM/X9NC0GGbEWx0mBkkckR6B4cWXRHbvxwYP8JmsijV//EcA2W0K/aSPkocPpI4A0JeWL98CTzWBTNmArg==";
        };
        _CR7YsPdc = {
            "id" = "CR7YsPdc";
            "file" = "neoorigins-2.2.24+26.1.jar";
            "hash" = "sha512-Sed/blxDpACTR8lXV4FE/pOHAi2qrCPTVpKoqr7uXMXMgBJORrRwXRvB2FsUAeTAA0ysKrDwUAFgUDiOiUflGg==";
        };
        _wnfOR7VN = {
            "id" = "wnfOR7VN";
            "file" = "neoorigins-2.2.24+26.2.jar";
            "hash" = "sha512-SYrrDuOnQLWJnprqfS3vBfJJH9JC5ccB+knyd3V6dqR9kVboSa9+Ohx7iD3R7VVqtnOkUlZ6SSzuTovpLYWX8w==";
        };
        _Z0PM7kHe = {
            "id" = "Z0PM7kHe";
            "file" = "neoorigins-2.2.24+1.21.1.jar";
            "hash" = "sha512-/JB/oVDIdQyHOEMNEmzsfbsknzBpgQnMVIpsI0XzHLGwHyNdP7JUH9HeA8B9aM/o/dKMmQ4od+o3dKUIZcfUgg==";
        };
        _tVzTbKxk = {
            "id" = "tVzTbKxk";
            "file" = "neoorigins-2.2.25+26.1.jar";
            "hash" = "sha512-X6ESJebFLCZehEnrbR7V2sei93yBk6i3mGHNt5ELBPMZEb7WK+HKQEwWRv2p2mVvF7StVq4ot6bzXWgR2cpNow==";
        };
        _AfnQBp3w = {
            "id" = "AfnQBp3w";
            "file" = "neoorigins-2.2.25+26.2.jar";
            "hash" = "sha512-oyuSObWWrA5xnOEqakpg0lu4MtvvyDghr1/kfm6kSLR4wwM39FK10s96HH19VM9GJIOkwin4dlzNAvF7Ag120w==";
        };
        _ZvyE7LvD = {
            "id" = "ZvyE7LvD";
            "file" = "neoorigins-2.2.25+1.21.1.jar";
            "hash" = "sha512-7HE+7dDWCD8TJR7ena+34X4InL0s5i5tKymxHn81b+V6wLEJmy9K1HwKRGqN7iY9ZMlmrp/tKomlND3nCPuGKg==";
        };
        _qDqSq35S = {
            "id" = "qDqSq35S";
            "file" = "neoorigins-2.2.26+26.1.jar";
            "hash" = "sha512-jqPDY2trQX1MvKM6lujdeOLPZwR9PO/HZHDG52gNRPg3Lv/tGi3QptdM2QvMRW3V7rLQW0WE6PyHgWf5BWrQag==";
        };
        _ppKVgkQW = {
            "id" = "ppKVgkQW";
            "file" = "neoorigins-2.2.26+26.2.jar";
            "hash" = "sha512-+tlbyRNjN7Q9CXCG8xS5YVu5cKvvkxHW77yXHvomw52xA9wYu4deyH1+VVnqoh6Z9bxZ9yo8ESwCUK57q+4OPA==";
        };
        _Xgrnpg8v = {
            "id" = "Xgrnpg8v";
            "file" = "neoorigins-2.2.26+1.21.1.jar";
            "hash" = "sha512-9qNUIW9DXnlFz8kFW+vcHyYO7ESJNHRdaP0Md6a0Hetw7BjxBYGXxui79TpMvKc8lrw0s4xqX8gO2AP2J8MEPg==";
        };
        _PkMitbtd = {
            "id" = "PkMitbtd";
            "file" = "neoorigins-2.2.27+26.1.jar";
            "hash" = "sha512-YpRGlYVi+sr+JZXl+l5zDqb+B6SfQxfBwh6XXguGEJOpg7FKdEiJvfw6QT5tZf5lQB0GV+VpEFlF1uHpbXXmZQ==";
        };
        _YnzbFV2i = {
            "id" = "YnzbFV2i";
            "file" = "neoorigins-2.2.27+26.2.jar";
            "hash" = "sha512-tcQ7oGmto32EwVlKYIfHC1bjO9sgzaJUwzhuSb9oQTpUHegEnsYNqMeAsdeiBJb/7UY/n0j1bhUTwWS0vlbVBQ==";
        };
        _o7CeCqhv = {
            "id" = "o7CeCqhv";
    ...
    in {
        ...
        "pkg-v1.2.0+26.1.1" = _YbXe78PA;
        "pkg-v1.2.1+26.1" = _bZnPXRDY;
        "pkg-v1.2.1+26.1.1" = _bQa3xW6b;
        "pkg-v1.2.1+1.21.1" = _R4t2Ia3Z;
        "pkg-v1.2.2+1.21.1" = _eTT6ppkV;
        "pkg-v1.2.3+1.21.1" = _rO5dQMht;
        "pkg-1.2.3+26.1.X" = _IqF7yjTf;
        "pkg-v1.3.0+26.1" = _IT64TBcV;
        "pkg-v1.3.0+1.21.1" = _SP2H9uQG;
        "pkg-v1.3.2+26.1" = _luXiC8MS;
        "pkg-v1.3.2+1.21.1" = _xXl7opx1;
        "pkg-v1.3.3+26.1" = _ftiiQMR1;
        "pkg-v1.3.3+1.21.1" = _iAGH2rsM;
        "pkg-v1.4.0+26.1" = _oROCAbEJ;
        "pkg-v1.4.0+1.21.1" = _cAdSsGnd;
        "pkg-v1.4.1+1.21.1" = _AmfNhFNV;
        "pkg-v1.5.0+26.1" = _86UnCBHq;
        "pkg-v1.5.0+1.21.1" = _DQcFNF0o;
        "pkg-v1.6.0+26.1" = _P0yEknMl;
        "pkg-v1.6.0+1.21.1" = _aU9wuo6t;
        "pkg-v1.6.1+26.1" = _YDGZl061;
        "pkg-v1.6.1+1.21.1" = _6xIy1sBf;
        "pkg-v1.7.0+26.1" = _sz0BaTnB;
        "pkg-v1.7.0+1.21.1" = _kFQ991tl;
        "pkg-v1.7.1+26.1" = _UNicBjRs;
        "pkg-v1.7.1+1.21.1" = _EIRWjVnt;
        "pkg-v1.8.0+26.1" = _K2AuG98p;
        "pkg-v1.8.0+1.21.1" = _EDhdFJ85;
        "pkg-v1.9.0+26.1" = _9X40adCL;
        "pkg-v1.9.0+1.21.1" = _Zpu3gf2x;
        "pkg-v1.9.1+26.1" = _BLgG8c45;
        "pkg-v1.9.1+1.21.1" = _6x63jgu6;
        "pkg-v1.10.0+26.1" = _ObdwkbmE;
        "pkg-v1.10.0+1.21.1" = _V49jVQO7;
        "pkg-v1.10.1+26.1" = _lv7QvE6f;
        "pkg-v1.10.1+1.21.1" = _oEh6hhie;
        "pkg-v1.11.0+26.1" = _RS816y4W;
        "pkg-v1.11.0+1.21.1" = _OmgYwdAR;
        "pkg-v1.11.1+26.1" = _pPAmykW4;
        "pkg-v1.11.1+1.21.1" = _WpgjBMKC;
        "pkg-v1.11.2+26.1" = _VqrIXk4Y;
        "pkg-v1.11.2+1.21.1" = _ap5GnCz4;
        "pkg-v1.12.0+26.1" = _OTleT8kQ;
        "pkg-v1.12.0+1.21.1" = _WDu2xgc5;
        "pkg-v1.13.0+26.1" = _ejBCW5W9;
        "pkg-v1.13.0+1.21.1" = _8i66hemH;
        "pkg-v1.14.0+26.1" = _jxYypApx;
        "pkg-v1.14.0+1.21.1" = _WCoRoMkm;
        "pkg-v1.14.1+26.1" = _CsntJUzX;
        "pkg-v1.14.1+1.21.1" = _xuPT86aK;
        "pkg-v1.14.2+26.1" = _AxKvd1gr;
        "pkg-v1.14.2+1.21.1" = _UlPdyX5U;
        "pkg-v2.0.0+26.1" = _575nrmXR;
        "pkg-v2.0.0+1.21.1" = _5Cj2RI9q;
        "pkg-v2.0.1+26.1" = _L6ocDWq1;
        "pkg-v2.0.1+1.21.1" = _qZP7cqFK;
        "pkg-v2.0.2+26.1" = _rkIqfzyG;
        "pkg-v2.0.2+1.21.1" = _MxdygV4x;
        "pkg-v2.0.3+26.1" = _9ky24sZ2;
        "pkg-v2.0.3+1.21.1" = _M5ixTDOl;
        "pkg-v2.0.4+26.1" = _s98LZBsg;
        "pkg-v2.0.4+1.21.1" = _UUZ8wKcp;
        "pkg-v2.0.5+26.1" = _hpojOUfA;
        "pkg-v2.0.5+1.21.1" = _7fqzl6RX;
        "pkg-v2.0.6+26.1" = _GB8qQzLs;
        "pkg-v2.0.6+1.21.1" = _tWj39zxK;
        "pkg-v2.0.7+26.1" = _KkqS586S;
        "pkg-v2.0.7+1.21.1" = _ej3kfqk5;
        "pkg-v2.0.8+26.1" = _7QvuKiFr;
        "pkg-v2.0.8+1.21.1" = _U1BxSv32;
        "pkg-v2.0.9+26.1" = _uSVrhVIZ;
        "pkg-v2.0.9-1.21.1" = _23TY0uOm;
        "pkg-v2.0.9+1.21.1" = _u1REHP8e;
        "pkg-v2.0.11+26.1" = _M3jzihCN;
        "pkg-v2.0.11+1.21.1" = _6LwFKmRT;
        "pkg-v2.0.12+26.1" = _hHOYtoHl;
        "pkg-v2.0.12+1.21.1" = _IFgx6Knx;
        "pkg-v2.0.13+26.1" = _Jxfz61ax;
        "pkg-v2.0.13+1.21.1" = _83DM0FkP;
        "pkg-v2.0.14+26.1" = _1cQTdpCf;
        "pkg-v2.0.14+1.21.1" = _AOsDcljk;
        "pkg-v2.0.15+26.1" = _TF0BMHnI;
        "pkg-v2.0.15+1.21.1" = _g42ygqsf;
        "pkg-v2.0.18+26.1" = _kbFYEz3o;
        "pkg-v2.0.18+1.21.1" = _cgfHdl5j;
        "pkg-v2.0.19+26.1" = _b65HyHdy;
        "pkg-v2.0.19+1.21.1" = _jlsfrLJm;
        "pkg-v2.0.20+26.1" = _LGOm0e0o;
        "pkg-v2.0.20+1.21.1" = _UwJGwWNT;
        "pkg-v2.0.21+26.1" = _cxszlmLk;
        "pkg-v2.0.21+1.21.1" = _aXscjc85;
        "pkg-v2.0.22+26.1" = _wreyEzcH;
        "pkg-v2.0.22+1.21.1" = _dlusM2q5;
        "pkg-v2.0.23+26.1" = _wH0KurE1;
        "pkg-v2.0.23+1.21.1" = _wm4OsbBp;
        "pkg-v2.0.25+26.1" = _XLa2YuJ7;
        "pkg-v2.0.25+1.21.1" = _ReQMwbYK;
        "pkg-v2.0.26+26.1" = _Ly9LIv3B;
        "pkg-v2.0.26+1.21.1" = _OKtX6rqQ;
        "pkg-v2.0.27+26.1" = _HN2eI9Bk;
        "pkg-v2.0.27+1.21.1" = _s3usDfJ4;
        "pkg-v2.0.28+26.1" = _FDANkmTo;
        "pkg-v2.0.28+1.21.1" = _bQTaSfn7;
        "pkg-v2.0.29+26.1" = _FpnnDGCJ;
        "pkg-v2.0.29+1.21.1" = _N0890aog;
        "pkg-v2.0.30+26.1" = _xhlSR6Xs;
        "pkg-v2.0.30+1.21.1" = _j1Vdjorr;
        "pkg-v2.0.31+26.1" = _Db7lVGX1;
        "pkg-v2.0.31+1.21.1" = _zylREK8c;
        "pkg-v2.0.32+26.1" = _FM8hzaW3;
        "pkg-v2.0.32+1.21.1" = _8sh9l8qc;
        "pkg-v2.0.33+26.1" = _QhxClZ1O;
        "pkg-v2.0.33+1.21.1" = _B8ar2SxJ;
        "pkg-v2.0.34+26.1" = _8cMI3aiv;
        "pkg-v2.0.34+1.21.1" = _jIVpb5Qt;
        "pkg-v2.0.35+26.1" = _OSqDVCCg;
        "pkg-v2.0.35+1.21.1" = _VIsGCkyc;
        "pkg-v2.0.36+26.1" = _bKovNLwG;
        "pkg-v2.0.36+1.21.1" = _l7cHP6Fu;
        "pkg-v2.0.37+26.1" = _7qdVCFNs;
        "pkg-v2.0.37+1.21.1" = _dEmuf2ua;
        "pkg-v2.1.0+26.1" = _yQc5M3Bd;
        "pkg-v2.1.0+1.21.1" = _jsspSZSe;
        "pkg-v2.1.1+26.1" = _4QSvClkf;
        "pkg-v2.1.1+1.21.1" = _BD8D3Lpr;
        "pkg-v2.1.2+26.1" = _piaExMeu;
        "pkg-v2.1.2+1.21.1" = _IHto8d1O;
        "pkg-v2.1.3+26.1" = _DY26tD5I;
        "pkg-v2.1.3+1.21.1" = _NcG2MRiz;
        "pkg-v2.1.4+26.1" = _JlNDCtHj;
        "pkg-v2.1.4+1.21.1" = _RZ5b3s64;
        "pkg-v2.1.5+26.1" = _JvmqDksm;
        "pkg-v2.1.5+1.21.1" = _mvLkqIMG;
        "pkg-v2.2.0+26.1" = _2l3Z6v4x;
        "pkg-v2.2.0+1.21.1" = _7TbkZHRh;
        "pkg-v2.2.1+26.1" = _YY9bJAfH;
        "pkg-v2.2.1+1.21.1" = _1vAZTtNi;
        "pkg-v2.2.2+26.1" = _G9PiYK0g;
        "pkg-v2.2.2+1.21.1" = _dgUEk7Tt;
        "pkg-v2.2.3+26.1" = _1RgbwiLY;
        "pkg-v2.2.3+1.21.1" = _3FsioqqR;
        "pkg-v2.2.4+26.1" = _VjkUCO8s;
        "pkg-v2.2.4+1.21.1" = _WZw1yv21;
        "pkg-v2.2.5+26.1" = _e0vTi74b;
        "pkg-v2.2.5+26.2" = _dsgKOj1r;
        "pkg-v2.2.5+1.21.1" = _IbAhEnug;
        "pkg-v2.2.6+26.1" = _WMIpbGS3;
        "pkg-v2.2.6+26.2" = _MBKna5Im;
        "pkg-v2.2.6+1.21.1" = _59UNtEXl;
        "pkg-v2.2.7+26.1" = _te5IpPql;
        "pkg-v2.2.7+26.2" = _qpbLVshK;
        "pkg-v2.2.7+1.21.1" = _LSZiG9Nn;
        "pkg-v2.2.8+26.1" = _jO9DFGJF;
        "pkg-v2.2.8+26.2" = _Sw3rIoh8;
        "pkg-v2.2.8+1.21.1" = _5DV4bycS;
        "pkg-v2.2.9+26.1" = _guakVEva;
        "pkg-v2.2.9+26.2" = _aLEfGtpu;
        "pkg-v2.2.9+1.21.1" = _BvFdvNDQ;
        "pkg-v2.2.10+26.1" = _Y72C9aes;
        "pkg-v2.2.10+26.2" = _g7f9IBP4;
        "pkg-v2.2.10+1.21.1" = _bv6Gjx1c;
        "pkg-v2.2.11+26.1" = _742lkIPu;
        "pkg-v2.2.11+26.2" = _NkhJt87R;
        "pkg-v2.2.11+1.21.1" = _2CvGDSVu;
        "pkg-v2.2.12+26.1" = _dHRRmBfg;
        "pkg-v2.2.12+26.2" = _MuEXxeNR;
        "pkg-v2.2.12+1.21.1" = _CuIXhPFu;
        "pkg-v2.2.13+26.1" = _vITMeoRL;
        "pkg-v2.2.13+26.2" = _ApLQyvlG;
        "pkg-v2.2.13+1.21.1" = _RzVVAw0v;
        "pkg-v2.2.14+26.1" = _VTGBnnfg;
        "pkg-v2.2.14+26.2" = _Axd7Z3Bg;
        "pkg-v2.2.14+1.21.1" = _Eym4Atih;
        "pkg-v2.2.15+26.1" = _N3RrMjuE;
        "pkg-v2.2.15+26.2" = _bkYBrTmY;
        "pkg-v2.2.15+1.21.1" = _sJTIE6PG;
        "pkg-v2.2.16+26.1" = _BpqWX4S1;
        "pkg-v2.2.16+26.2" = _LVP199SK;
        "pkg-v2.2.16+1.21.1" = _v7PYPYdU;
        "pkg-v2.2.17+26.1" = _jIg6WL0X;
        "pkg-v2.2.17+26.2" = _Ebb0lLV0;
        "pkg-v2.2.17+1.21.1" = _BbI1sdbV;
        "pkg-v2.2.18+26.1" = _cAaHctmP;
        "pkg-v2.2.18+26.2" = _Qmlzawn5;
        "pkg-v2.2.18+1.21.1" = _pTar3y97;
        "pkg-v2.2.19+26.1" = _pEeG4LQI;
        "pkg-v2.2.19+26.2" = _emS4cGp0;
        "pkg-v2.2.19+1.21.1" = _a2F0tuvT;
        "pkg-v2.2.20+26.1" = _iYKNgMIx;
        "pkg-v2.2.20+26.2" = _SOEwUI9y;
        "pkg-v2.2.20+1.21.1" = _4TxWhbrk;
        "pkg-v2.2.21+26.1" = _4RQxRChu;
        "pkg-v2.2.21+26.2" = _19vVnEZ3;
        "pkg-v2.2.21+1.21.1" = _tqtCTcwO;
        "pkg-v2.2.22+26.1" = _PCInV27n;
        "pkg-v2.2.22+26.2" = _2gAAmFUb;
        "pkg-v2.2.22+1.21.1" = _pxylSHZV;
        "pkg-v2.2.23+26.1" = _cl9700xM;
        "pkg-v2.2.23+26.2" = _ddQZ2Q0W;
        "pkg-v2.2.23+1.21.1" = _RQN61lFx;
        "pkg-v2.2.24+26.1" = _CR7YsPdc;
        "pkg-v2.2.24+26.2" = _wnfOR7VN;
        "pkg-v2.2.24+1.21.1" = _Z0PM7kHe;
        "pkg-v2.2.25+26.1" = _tVzTbKxk;
        "pkg-v2.2.25+26.2" = _AfnQBp3w;
        "pkg-v2.2.25+1.21.1" = _ZvyE7LvD;
        "pkg-v2.2.26+26.1" = _qDqSq35S;
        "pkg-v2.2.26+26.2" = _ppKVgkQW;
        "pkg-v2.2.26+1.21.1" = _Xgrnpg8v;
