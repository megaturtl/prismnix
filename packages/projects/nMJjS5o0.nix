...
let
    versions = (let
        ...
        _TfpbtZIq = {
            "id" = "TfpbtZIq";
            "file" = "framed-suspicious-0.3.12+mc1.20-26.3.zip";
            "hash" = "sha512-HC3aAMmaIRmV4LpUw9TEOYTpChx3Jg45mC2ojzmKvk/LZsLcykNF49nboa5VbOvJxGTe64WphP6rT5R7IRaOXA==";
        };
    in {
        "hJl1nGkQ" = _hJl1nGkQ;
        "GhCArObc" = _GhCArObc;
        ...
        "sDVRbseK" = _sDVRbseK;
        "TfpbtZIq" = _TfpbtZIq;
        "minecraft-1.20" = _TfpbtZIq;
        "minecraft-1.20.1" = _TfpbtZIq;
        "minecraft-1.20.2" = _TfpbtZIq;
        "minecraft-1.20.3" = _TfpbtZIq;
        "minecraft-1.20.4" = _TfpbtZIq;
        "minecraft-1.20.5" = _TfpbtZIq;
        "minecraft-1.20.6" = _TfpbtZIq;
        "minecraft-1.21" = _TfpbtZIq;
        "minecraft-1.21.1" = _TfpbtZIq;
        "minecraft-1.21.2" = _TfpbtZIq;
        "minecraft-1.21.3" = _TfpbtZIq;
        "minecraft-1.21.4" = _TfpbtZIq;
        "minecraft-1.21.5" = _TfpbtZIq;
        "minecraft-1.21.6" = _TfpbtZIq;
        "minecraft-1.21.7" = _TfpbtZIq;
        "minecraft-1.21.8" = _TfpbtZIq;
        "minecraft-1.21.9" = _TfpbtZIq;
        "minecraft-1.21.10" = _TfpbtZIq;
        "minecraft-1.21.11" = _TfpbtZIq;
        "minecraft-26.1" = _TfpbtZIq;
        "minecraft-26.1.1" = _TfpbtZIq;
        "minecraft-26.1.2" = _TfpbtZIq;
        "minecraft-26.2" = _TfpbtZIq;
        "minecraft-26.3" = _TfpbtZIq;
        "pkg-0.1.0" = _hJl1nGkQ;
        "pkg-0.1.1" = _GhCArObc;
        "pkg-0.2.0" = _SMZFFUPK;
        "pkg-0.2.1" = _WxrqT33c;
        ...
        "pkg-0.3.8" = _kTR9GsVp;
        "pkg-0.3.9" = _742Z0Ds4;
        "pkg-0.3.10" = _S2CblGCN;
        "pkg-0.3.11" = _sDVRbseK;
        "pkg-0.3.12" = _TfpbtZIq;
        "default" = _TfpbtZIq;
    });
