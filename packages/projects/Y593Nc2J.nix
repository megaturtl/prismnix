...
let
    versions = (let
        ...
        _j91mxoH2 = {
            "id" = "j91mxoH2";
            "file" = "[DP] Lava Source 1.6.0.zip";
            "hash" = "sha512-GVcBVULzTb2GDWmyQckfsSgfYOqKdcM4oBV5wIF70iZnQ5z65d605h5NnYh/+CgGLVRgM43aqwnjsDNq4w+8/Q==";
        };
        _TKxtxKKD = {
            "id" = "TKxtxKKD";
            "file" = "lava-source-1.6.0.jar";
            "hash" = "sha512-T/LKKuYC2rgu9jy3Njbp3I0UvR9g0ZiPqhcrTJSpSRYKcYWG8UQghaExdCkvGlV9KGlbrpzGetkBRuZoqhS9Hg==";
        };
    in {
        "WjDeau0Q" = _WjDeau0Q;
        "L9SV0kcB" = _L9SV0kcB;
        ...
        "j91mxoH2" = _j91mxoH2;
        "TKxtxKKD" = _TKxtxKKD;
        "datapack-1.21.9" = _j91mxoH2;
        "datapack-1.21.10" = _j91mxoH2;
        "datapack-1.21.11" = _j91mxoH2;
        "datapack-26.1" = _j91mxoH2;
        "datapack-26.1.1" = _j91mxoH2;
        "datapack-26.1.2" = _j91mxoH2;
        ...
        "datapack-26.3" = _j91mxoH2;
        "fabric-1.21.9" = _TKxtxKKD;
        "fabric-1.21.10" = _TKxtxKKD;
        "fabric-1.21.11" = _TKxtxKKD;
        "fabric-26.1" = _TKxtxKKD;
        "fabric-26.1.1" = _TKxtxKKD;
        "fabric-26.1.2" = _TKxtxKKD;
        ...
        "fabric-26.3" = _TKxtxKKD;
        "forge-1.21.9" = _TKxtxKKD;
        "forge-1.21.10" = _TKxtxKKD;
        "forge-1.21.11" = _TKxtxKKD;
        "forge-26.1" = _TKxtxKKD;
        "forge-26.1.1" = _TKxtxKKD;
        "forge-26.1.2" = _TKxtxKKD;
        ...
        "forge-26.3" = _TKxtxKKD;
        "neoforge-1.21.9" = _TKxtxKKD;
        "neoforge-1.21.10" = _TKxtxKKD;
        "neoforge-1.21.11" = _TKxtxKKD;
        "neoforge-26.1" = _TKxtxKKD;
        "neoforge-26.1.1" = _TKxtxKKD;
        "neoforge-26.1.2" = _TKxtxKKD;
        ...
        "neoforge-26.3" = _TKxtxKKD;
        "quilt-1.21.9" = _TKxtxKKD;
        "quilt-1.21.10" = _TKxtxKKD;
        "quilt-1.21.11" = _TKxtxKKD;
        "quilt-26.1" = _TKxtxKKD;
        "quilt-26.1.1" = _TKxtxKKD;
        "quilt-26.1.2" = _TKxtxKKD;
