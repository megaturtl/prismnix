...
let
    versions = (let
        ...
        _k8FoUmEj = {
            "id" = "k8FoUmEj";
            "file" = "ResurrectionChest.jar";
            "hash" = "sha512-q0q7VYsZxtRVqpxScd9IU6+eo5ehfafVKtXXSjuH2yJMVmMglKCZzfPVOMEXH++c27b1/q8NPSaQNP98uiXJgA==";
        };
        _HJhdESe8 = {
            "id" = "HJhdESe8";
            "file" = "ResurrectionChest.jar";
            "hash" = "sha512-TRTNaUOQdeNDSotcaggOhIJ/DoL0dl+FmBBQ5iTa+ezvgAAhvxuOvu3ONogrA7JpECXo6kg57hHpqxlFQN+g4A==";
        };
        _iAFqwxEj = {
            "id" = "iAFqwxEj";
            "file" = "ResurrectionChest.jar";
            "hash" = "sha512-pJX2u345fa8ORxGz37ifmTdNMArhSeykhgz2quf4qKi6+4hRelkV/KmRZFrGrN+z97aIkl/uD/emZRU806wnGQ==";
        };
        _12q9hf1H = {
            "id" = "12q9hf1H";
            "file" = "ResurrectionChest.jar";
            "hash" = "sha512-rEWgln2qEHwQZq2lQf1A7/l6B4YBAEwmZDCCbUX/MjknoCMg+LQgAEvK5lR9llGqufQn1KO0dz5y7SKbbE9JPw==";
        };
        _WI9eY4iu = {
            "id" = "WI9eY4iu";
            "file" = "ResurrectionChest.jar";
            "hash" = "sha512-d8PkeVUNT+JcU7qXFT5qlyuXTiKAPUHWjfCVD+rqVHd4BhVaQBi0ak07nk5/y/d7mfvvKYqvKm9TuG8O9D0ROA==";
        };
    in {
        "s5VbqMC4" = _s5VbqMC4;
        "XOOkwejy" = _XOOkwejy;
        ...
        "paper-1.21.4" = _WI9eY4iu;
        "paper-1.21.5" = _WI9eY4iu;
        "paper-1.21.6" = _WI9eY4iu;
        "paper-1.21.7" = _WI9eY4iu;
        "paper-1.21.8" = _WI9eY4iu;
        "paper-1.21.9" = _WI9eY4iu;
        "paper-1.21.10" = _WI9eY4iu;
        "paper-1.21.11" = _WI9eY4iu;
        "paper-26.1" = _WI9eY4iu;
        "paper-26.1.1" = _WI9eY4iu;
        "paper-26.1.2" = _WI9eY4iu;
        "paper-26.2" = _WI9eY4iu;
        "paper-26.3" = _WI9eY4iu;
        ...
        "purpur-1.21.4" = _WI9eY4iu;
        "purpur-1.21.5" = _WI9eY4iu;
        "purpur-1.21.6" = _WI9eY4iu;
        "purpur-1.21.7" = _WI9eY4iu;
        "purpur-1.21.8" = _WI9eY4iu;
        "purpur-1.21.9" = _WI9eY4iu;
        "purpur-1.21.10" = _WI9eY4iu;
        "purpur-1.21.11" = _WI9eY4iu;
        "purpur-26.1" = _WI9eY4iu;
        "purpur-26.1.1" = _WI9eY4iu;
        "purpur-26.1.2" = _WI9eY4iu;
        "purpur-26.2" = _WI9eY4iu;
        "purpur-26.3" = _WI9eY4iu;
        ...
        "spigot-1.21.4" = _WI9eY4iu;
        "spigot-1.21.5" = _WI9eY4iu;
        "spigot-1.21.6" = _WI9eY4iu;
        "spigot-1.21.7" = _WI9eY4iu;
        "spigot-1.21.8" = _WI9eY4iu;
        "spigot-1.21.9" = _WI9eY4iu;
        "spigot-1.21.10" = _WI9eY4iu;
        "spigot-1.21.11" = _WI9eY4iu;
        "spigot-26.1" = _WI9eY4iu;
        "spigot-26.1.1" = _WI9eY4iu;
        "spigot-26.1.2" = _WI9eY4iu;
        "spigot-26.2" = _WI9eY4iu;
        "spigot-26.3" = _WI9eY4iu;
        "pkg-2.0.1" = _s5VbqMC4;
        "pkg-2.0.2" = _XOOkwejy;
        "pkg-2.1.0" = _ik3ufT6K;
        "pkg-2.1.1" = _yWZMMOCx;
