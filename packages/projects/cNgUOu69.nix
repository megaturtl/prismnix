...
let
    ...
    in {
        ...
        "paper-1.21.4" = _k8FoUmEj;
        "paper-1.21.5" = _k8FoUmEj;
        "paper-1.21.6" = _k8FoUmEj;
        "paper-1.21.7" = _k8FoUmEj;
        "paper-1.21.8" = _k8FoUmEj;
        "paper-1.21.9" = _k8FoUmEj;
        "paper-1.21.10" = _k8FoUmEj;
        "paper-1.21.11" = _k8FoUmEj;
        "paper-26.1" = _k8FoUmEj;
        "paper-26.1.1" = _k8FoUmEj;
        "paper-26.1.2" = _k8FoUmEj;
        "paper-26.2" = _k8FoUmEj;
        ...
        "purpur-1.21.4" = _k8FoUmEj;
        "purpur-1.21.5" = _k8FoUmEj;
        "purpur-1.21.6" = _k8FoUmEj;
        "purpur-1.21.7" = _k8FoUmEj;
        "purpur-1.21.8" = _k8FoUmEj;
        "purpur-1.21.9" = _k8FoUmEj;
        "purpur-1.21.10" = _k8FoUmEj;
        "purpur-1.21.11" = _k8FoUmEj;
        "purpur-26.1" = _k8FoUmEj;
        "purpur-26.1.1" = _k8FoUmEj;
        "purpur-26.1.2" = _k8FoUmEj;
        "purpur-26.2" = _k8FoUmEj;
        ...
        "spigot-1.21.4" = _k8FoUmEj;
        "spigot-1.21.5" = _k8FoUmEj;
        "spigot-1.21.6" = _k8FoUmEj;
        "spigot-1.21.7" = _k8FoUmEj;
        "spigot-1.21.8" = _k8FoUmEj;
        "spigot-1.21.9" = _k8FoUmEj;
        "spigot-1.21.10" = _k8FoUmEj;
        "spigot-1.21.11" = _k8FoUmEj;
        "spigot-26.1" = _k8FoUmEj;
        "spigot-26.1.1" = _k8FoUmEj;
        "spigot-26.1.2" = _k8FoUmEj;
        "spigot-26.2" = _k8FoUmEj;
        "pkg-2.0.1" = _s5VbqMC4;
        "pkg-2.0.2" = _XOOkwejy;
        "pkg-2.1.0" = _ik3ufT6K;
        "pkg-2.1.1" = _yWZMMOCx;
