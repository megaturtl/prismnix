...
let
    ...
    in {
        ...
        "pkg-1.0.2.1" = _PPDfuBtL;
        "pkg-1.0.1.2" = _MwYN6kan;
        "pkg-1.0.1.1" = _bh3PWKIu;
        "pkg-1.0.4.1" = _ic1Bb1qk;
        "pkg-1.0.4.2" = _CVzHmRJI;
        "pkg-1.1.0.1" = _W8CFZTgf;
        "pkg-1.1.0.2" = _L83YJFm2;
        "pkg-1.2.1" = _nHnEdFtx;
        "pkg-1.3.0" = _Tb6eDrEc;
        "pkg-1.0.2" = _rjuH4yWL;
        "pkg-1.0.5" = _nU9ezP7e;
        ...
        "pkg-9.0.1" = _NQwyaWBX;
        "pkg-6.2.1" = _vIF03mwU;
        "pkg-10.0.0" = _oBF88nRC;
        "pkg-11.0.0" = _GCIAi0ud;
        "pkg-10.0.1" = _PUrkUSRG;
        "pkg-6.2.2" = _3NlQftp3;
        "pkg-8.1.2" = _ojKAEzF0;
        "pkg-9.0.2" = _FtUR3t3H;
        "pkg-11.0.1" = _rUi8unC2;
        "pkg-12.0.0" = _bLHzgkSg;
        "pkg-12.1.0" = _BfqaQKPS;
        "pkg-12.2.0" = _OBXPNcgc;
        "pkg-12.3.0" = _7Bjl145c;
        "pkg-6.2.3" = _MDJfOskz;
        "pkg-13.0.0" = _skhzVp4y;
        "pkg-13.0.1" = _TbRiWhUJ;
        "pkg-13.1.0" = _nkNfOD50;
        "pkg-13.1.1" = _LIs0ANto;
        "pkg-13.2.0" = _pqoCZONH;
        "pkg-2.2.3" = _iYj6J18y;
        "pkg-14.0.0" = _aH2VlLBG;
        "pkg-14.0.1" = _1iViapQP;
        "pkg-14.0.2" = _1s42GFfC;
        "pkg-13.3.0" = _dMPdoQwm;
        "pkg-13.3.1" = _ZqUgF0kR;
        "pkg-13.3.2" = _j3CKWClI;
        "pkg-14.0.3" = _672fFA8f;
        "pkg-14.1.0" = _bqNsQ6jG;
        "pkg-15.0.0" = _SWdCs1P4;
        "pkg-6.2.4" = _UNtgorCZ;
