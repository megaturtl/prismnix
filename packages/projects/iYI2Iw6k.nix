...
let
    ...
    in {
        ...
        "pkg-v1.0.6-beta2" = _8UrdQqkt;
        "pkg-v1.0.6" = _KZFs9uAM;
        "pkg-v1.0.7" = _fpQeCMi4;
        "pkg-v1.0.8-beta" = _sJRn2Yfl;
        "pkg-v1.0.8" = _Q6FWDxLF;
        "pkg-v1.0.9-beta1" = _w7mr9VfR;
        "pkg-v1.0.9-beta2" = _c7nBfA5J;
        "pkg-v1.0.9-beta3" = _DtF1o8Sl;
        "pkg-v1.0.9-beta4" = _OJDJyoCd;
        "pkg-v1.0.9-beta5" = _um15VmMQ;
        "pkg-v1.0.9" = _pOv7wPMV;
        "pkg-2.0.0" = _jTSZ8CVV;
        "pkg-2.0.1" = _EfDlEXY1;
        "pkg-2.0.2" = _OEZaftIH;
        "pkg-2.1.0" = _m4eRoczA;
