...
let
    ...
    in {
        ...
        "pkg-Beta-0.4" = _KxplDtxm;
        "pkg-Beta-0.5" = _mfc1iqV9;
        "pkg-Beta-0.6" = _lOJ3ktvh;
        "pkg-Beta-0.7" = _M5vmLelP;
        "pkg-Beta-0.8" = _5vtLzqTa;
        "pkg-Beta-0.8.1" = _lPmtI6tw;
        "pkg-Beta-0.8.2" = _yVn2CfOL;
        "pkg-Beta-0.8.3" = _iStDGY7w;
        "pkg-Beta-0.8.4" = _PEkqnev1;
        "pkg-0.9" = _Y8DbDYn1;
        "pkg-0.9-Hotfix_1" = _ZjLim5pN;
        "pkg-0.9+1.21.9" = _wYSBLR6a;
        "pkg-0.9+1.21.10" = _JcUtnueg;
        "pkg-0.9+1.20.4" = _XXcQetIH;
        "pkg-0.9+1.21.5" = _MzApWsQs;
        "pkg-0.9+1.20.5" = _zpfgEnya;
        "pkg-0.9+1.21.7" = _kGRPtxBw;
        "pkg-0.9+1.20.1" = _GBFiEULv;
        "pkg-0.9+1.20.6" = _nTttYdmT;
        "pkg-0.9+1.21.6" = _ficwBtQZ;
        "pkg-0.9+1.19.4" = _qWVAtkQE;
        "pkg-0.9+1.20" = _l53gvNR5;
        "pkg-0.9+1.20.2" = _Ku6xAcLC;
        "pkg-0.9+1.20.3" = _emlXLwIb;
        "pkg-0.9+1.21" = _5sWNi56O;
        "pkg-0.9+1.21.3" = _Jd9meEHj;
        "pkg-0.9+1.21.8" = _dB6Y87Jl;
        "pkg-0.9+1.21.2" = _B92Ce1en;
