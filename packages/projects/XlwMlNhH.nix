...
let
    ...
    in {
        ...
        "pkg-0.5.3+forge" = _MaQIzBFc;
        "pkg-0.5.4+forge" = _rU9z8akO;
        "pkg-0.6.0+forge" = _hNLGq73Z;
        "pkg-0.6.1+forge" = _yyPW424V;
        "pkg-0.6.2+forge" = _PXS7rO9J;
        "pkg-0.6.3+forge" = _rKZSDdAE;
        "pkg-0.6.4+forge" = _OIttGnET;
        "pkg-0.6.5+forge" = _YxUVGPMm;
        "pkg-0.6.6+forge" = _a4UoYJlQ;
        "pkg-0.7.0+forge" = _r1LN8YrP;
        "pkg-0.7.1+forge" = _wuUHveb8;
        "pkg-0.7.2+forge" = _8rPN25B2;
        "pkg-0.8.0+forge" = _Ia5Qn4Yd;
        "pkg-0.8.0+fabric" = _f4Hd1CGE;
        "pkg-0.8.1+forge" = _WmtDiLkr;
        "pkg-0.8.2+forge" = _ZtuNrbl5;
        "pkg-0.8.2+fabric" = _RRMJtNPR;
        "pkg-0.8.3+fabric" = _6lPLN2Wr;
        "pkg-1.0.0+neoforge" = _8JPXgHSx;
        "pkg-1.0.1+neoforge" = _LQiCWo7y;
        "pkg-0.8.4+fabric" = _vO9VI8Fd;
        "pkg-1.0.2+neoforge" = _lPpaTgrK;
        "pkg-0.8.5+forge" = _TFngPoRn;
        "pkg-1.0.3+neoforge" = _JpBDuzmt;
        "pkg-1.0.4+neoforge" = _O1fAxr3I;
        "pkg-1.0.5+neoforge" = _2aotF5nl;
        "pkg-1.0.6+neoforge" = _SODVHNgy;
        "pkg-1.1.0+neoforge" = _G7QSZ1eu;
        "pkg-1.1.1+neoforge" = _8rVUjoF4;
        "pkg-1.1.2+neoforge" = _EpSxFhhX;
        "pkg-1.1.3+neoforge" = _BCQwUIOy;
        "pkg-1.1.4+neoforge" = _YzS3QDR5;
        "pkg-1.1.5+neoforge" = _2HKmeBn4;
        "pkg-0.9.0+forge" = _wCsqmlUX;
        "pkg-0.9.1+forge" = _ett8VrNQ;
        "pkg-0.9.2+forge" = _hIqHq91M;
        "pkg-1.1.6+neoforge" = _Ofb94ZP5;
        "pkg-0.9.3+forge" = _W17Y8pUb;
        "pkg-1.1.7+neoforge" = _EC7ysIFE;
        "pkg-0.9.4+forge" = _XhDsx1XW;
        "pkg-0.9.5+forge" = _9O1Jy6Tv;
        "pkg-0.9.6+fabric" = _xLNntIAv;
        "pkg-0.9.6+forge" = _S9PnL1Ti;
        "pkg-1.1.8+neoforge" = _dFQ374sw;
        "pkg-1.1.9+neoforge" = _iNbWfskD;
        "pkg-1.1.9+fabric" = _vWojbE7v;
        "pkg-0.9.7+forge" = _rGTL2F7e;
