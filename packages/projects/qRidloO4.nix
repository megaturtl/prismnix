...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.5-forge" = _1WHfIfWn;
        "pkg-1.18.2-1.7-forge" = _BmMOLwnT;
        "pkg-1.19.2-1.9-forge" = _8G2c97a1;
        "pkg-1.16.5-2.2-fabric" = _cKJKl9zy;
        "pkg-1.18.2-2.2-fabric" = _UpYoCYkH;
        "pkg-1.19.2-2.2-fabric" = _Drf3eppu;
        "pkg-1.19.3-2.3-fabric" = _IAjuxQKY;
        "pkg-1.19.3-1.9-forge" = _iRpZY8Bs;
        "pkg-1.18.2-3.0-forge+fabric" = _nX1USRXl;
        "pkg-1.19.2-3.0-forge+fabric" = _eqm3RJWG;
        "pkg-1.19.3-3.0-forge+fabric" = _PL9Ybjtn;
        "pkg-1.19.4-3.0-forge+fabric" = _MI0WKaBK;
        "pkg-1.20-3.0-forge+fabric" = _TX193UR5;
        "pkg-1.20.1-3.0-forge+fabric" = _enXPEnuP;
        "pkg-1.20.2-3.0-forge+fabric" = _m6ZyAVgL;
        "pkg-1.18.2-3.1-forge+fabric" = _Bor9LcH0;
        "pkg-1.19.2-3.1-forge+fabric" = _rtlEwiyo;
        "pkg-1.20.1-3.1-forge+fabric" = _rYOx8CKh;
        "pkg-1.20.2-3.1-forge+fabric" = _z2SIj6MN;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _pI4nwgXW;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _Hj2VDZOP;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _Lrk3W6WJ;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _X7kt9lkf;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _NYIHz3Z1;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _UceSt3xW;
        "pkg-1.20.5-3.2-fabric+neo" = _x40Gn14c;
        "pkg-1.20.6-3.2-fabric+forge+neo" = _dazdVMoH;
        "pkg-1.21.0-3.2-fabric+forge+neo" = _nyBt7I8W;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _eYYEIWmK;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _sRi0gOBu;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _X3LR6Hwn;
        "pkg-1.21.1-3.3-fabric+forge+neo" = _hXhqKIJh;
        "pkg-1.21.2-3.3-fabric+neo" = _m9WD6Lpb;
        "pkg-1.21.3-3.3-fabric+forge+neo" = _rV1FG8is;
        "pkg-1.21.4-3.3-fabric+forge+neo" = _ZNCQM03o;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _iuBlJsIE;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _kgKzMjwF;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _kNwrVlSQ;
        "pkg-1.21.5-3.4-fabric+forge+neo" = _MGgglh4i;
        "pkg-1.21.6-3.4-fabric+forge+neo" = _bdKCged5;
        "pkg-1.21.7-3.4-fabric+forge+neo" = _wNHbe5tH;
        "pkg-1.21.8-3.4-fabric+forge+neo" = _xUlMtm0h;
        "pkg-1.21.9-3.4-fabric+forge+neo" = _nbZs75G2;
        "pkg-1.21.10-3.4-fabric+forge+neo" = _AkD38Ffj;
        "pkg-1.21.11-3.4-fabric+forge+neo" = _utfqmx2c;
        "pkg-26.1.0-3.4-fabric+forge+neo" = _WlVt10dL;
