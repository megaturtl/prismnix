...
let
    versions = (let
        ...
        _yJUfRp6r = {
            "id" = "yJUfRp6r";
            "file" = "resource_gamma_util-forge-26.2-2.0.0.jar";
            "hash" = "sha512-zdZk/Ihak5/XjZeE4m397eXgMM9a81T0oPd8rBbnh/4IDwcX5S+ZCd+AT750coTW4bdND1ecKVDKPWk0yu7HMw==";
        };
        _qFLYSiK9 = {
            "id" = "qFLYSiK9";
            "file" = "resource_gamma_util-fabric-26.2-2.0.0.jar";
            "hash" = "sha512-bsV/52ikyIJc5p+/M2duyMnjg5mM4nEMilgLAlGLwmJbaD7E6ZI4k2ANXF+e0im+N0Djn7aBKViMHOiwe4fVVQ==";
        };
        _6rsL4N1g = {
            "id" = "6rsL4N1g";
            "file" = "resource_gamma_util-neoforge-26.2-2.0.0.jar";
            "hash" = "sha512-idrjMFSBKuA9iCIOZUCJrGxa1iPt3tNLvoUdCBOg6PnhGOkk94CVo3kENWpdF/hrTRbQxxHgJBhGTIrwSCKOOw==";
        };
        _DLwY73tu = {
            "id" = "DLwY73tu";
            "file" = "resource_gamma_util-fabric-26.3-2.0.0.jar";
            "hash" = "sha512-4XkY3Pm7TqjRv/1L/2PJUa/H48yv9HqSgoca4SjtHQy2t/MioeC2ohjjH7sO4p7kp6/7UhHejIn/aWFRh8s+Lg==";
        };
        _Wd2ocpPA = {
            "id" = "Wd2ocpPA";
            "file" = "resource_gamma_util-neoforge-26.3-2.0.0.jar";
            "hash" = "sha512-T5dXE0J+CzZ/YRV5WEjGBDVddP5wKioMW1L8anMcvKcXmDfUt0kSiJJFWhucgX9jf2Oh86Sm0G9KEnx59Grotg==";
        };
        _SAjw6sNZ = {
            "id" = "SAjw6sNZ";
            "file" = "resource_gamma_util-neoforge-26.3-2.0.1.jar";
            "hash" = "sha512-7ZemR4Y4UsqFYTs7aeKoj1lz/RTkqgVAEmI+ywHZ81PNLlXZQqLVC266vgZC06l4/RnM6St8Q9E1hS1s9v46hA==";
        };
        _5YfXsTq7 = {
            "id" = "5YfXsTq7";
    ...
    in {
        ...
        "pkg-1.1.0" = _wn9s0A6p;
        "pkg-1.2.0" = _4TmycYRr;
        "pkg-1.21.9-1.3.0" = _kLwCw2RF;
        "pkg-1.21.10-1.3.0" = _AvBHNguu;
        "pkg-1.21.11-1.3.1" = _2jp5G40e;
        "pkg-1.21.11-1.4.0" = _XeBuo8lD;
        "pkg-1.21.1-1.4.0" = _Nx6kXJFH;
        "pkg-26.1.2-1.5.0" = _f3EUadYg;
        "pkg-26.1.2-1.5.1" = _e3lI6cwc;
        "pkg-26.1.2-1.5.2" = _qphty57Y;
        "pkg-26.1.2-1.6.0" = _OJS3R0NR;
        "pkg-26.2-1.6.0" = _HO0rXQPr;
        "pkg-2.0.0" = _6rsL4N1g;
