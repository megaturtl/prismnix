...
let
    ...
    in {
        ...
        "pkg-2.0.1" = _Jnkxo1iF;
        "pkg-2.0.1+mod" = _6jYRpbET;
        "pkg-2.0.2" = _dLO6I3Nl;
        "pkg-2.0.2+mod" = _Q6eAdyTS;
        "pkg-v2.1" = _Mae0FR2O;
        "pkg-v2.1+mod" = _QS0c2TKO;
        "pkg-v2.1.2" = _xnCIjJAt;
        "pkg-v2.1.2+mod" = _gycjhGu8;
        "pkg-v2.1.3" = _ftDL6az5;
        "pkg-v2.1.3+mod" = _uTKeYJtp;
        "pkg-v2.1.4" = _DOik2Tex;
        "pkg-v2.1.4+mod" = _XU0RDl74;
        "pkg-3" = _R8dnbQxW;
        "pkg-3+mod" = _7exROg07;
        "pkg-3.0.1" = _GtkzV91q;
        "pkg-3.0.1+mod" = _JOwejnHw;
        "pkg-3.0.2" = _bFY892GN;
        "pkg-3.0.2+mod" = _YU0OIwaI;
        "pkg-3.0.3" = _HdMGscqY;
        "pkg-3.0.3+mod" = _kZX54y2P;
        "pkg-3.1.0" = _fZUvwQng;
        "pkg-3.1.1" = _cpJzZfzm;
        "pkg-3.1.1+mod" = _xwTzTss5;
        "pkg-3.0.3.f" = _J9ojWPrx;
        "pkg-3.0.3.f+mod" = _d1sY0JqV;
        "pkg-3.2" = _39mJLpd3;
        "pkg-3.2+mod" = _OMafyUuX;
        "pkg-v4" = _R36cO4pA;
        "pkg-v4+mod" = _HYerXxJh;
        "pkg-v4.1" = _iUQqUGSu;
        "pkg-v4.1+mod" = _GHO5nkWN;
        "pkg-v4.2" = _aAFAcp4I;
        "pkg-v4.2+mod" = _9LF8LPu8;
        "pkg-v4.3" = _rAD9sBYg;
        "pkg-v4.3+mod" = _PoMcAQWW;
        "pkg-4.4" = _uMi3zRio;
        "pkg-4.4+mod" = _oiBH7RGx;
        "pkg-v4.4.1" = _LEP6k4aE;
        "pkg-v4.4.1+mod" = _u89TZrMp;
        "pkg-v4.4.2" = _gdJCUNaz;
        "pkg-v4.4.2+mod" = _jf2tvTlu;
        "pkg-v4.4.3" = _9MRqbdvl;
        "pkg-v4.4.3+mod" = _5zA2ZvqW;
        "pkg-v4.4.4" = _9Dw6hgJA;
        "pkg-v4.4.4+mod" = _wH004B85;
        "pkg-v4.5" = _8o3mS993;
        "pkg-v4.5+mod" = _UurMsmE5;
        "pkg-v4.6" = _4VafOgeT;
        "pkg-v4.6+mod" = _x3n3CXS9;
        "pkg-v4.6.1" = _NRoK1knw;
        "pkg-v4.6.1+mod" = _fNvgwKBY;
        "pkg-v4.6.2" = _ET8s81rA;
        "pkg-v4.6.2+mod" = _PCXJI9NW;
        "pkg-v4.6.3" = _Gu9qNQfD;
        "pkg-v4.6.3+mod" = _yxweTHyf;
        "pkg-v4.7" = _jHLhATWl;
        "pkg-v4.7+mod" = _nmA9YXuH;
        "pkg-v4.7.1" = _pSwnvdAk;
        "pkg-v4.7.1+mod" = _Tsl2mstz;
        "pkg-v4.7.2" = _S7RExX7B;
        "pkg-v4.7.2+mod" = _9B8EPu8w;
        "pkg-v4.7.3" = _xjVWiPK3;
        "pkg-v4.7.3+mod" = _qrDH4XsF;
        "pkg-v5.0.0" = _TnTpDwVl;
        "pkg-v5.0.0+mod" = _UA8MyW6M;
        "pkg-v5.0.1" = _tm9otCBE;
        "pkg-v5.0.1+mod" = _GJWOkMh3;
        "pkg-v5.0.2" = _ezHC6NuT;
        "pkg-v5.0.2+mod" = _xJKEx8WC;
        "pkg-v5.0.3" = _JvkII6i7;
        "pkg-v5.0.3+mod" = _IqBigwGK;
        "pkg-v5.0.4" = _nf675u2v;
        "pkg-v5.0.4+mod" = _rg0jgVSI;
        "pkg-v5.1.0" = _HLvm1mCw;
        "pkg-v5.1.0+mod" = _gY1vl6WD;
        "pkg-5.2.0" = _ohqJT0pv;
