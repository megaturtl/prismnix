...
let
    versions = (let
        ...
        _GUrWiIiC = {
            "id" = "GUrWiIiC";
            "file" = "dynamic_resource_bars-fabric-0.9.6+26.1.2.jar";
            "hash" = "sha512-xW8pmdNJph0KBzC0Tglqg2hcunEoUGut2U0Rr/fOVPVDx0VCbxTPFHKczpV7sfJFnnvC+IQoXejUEpWgWgULnA==";
        };
        _3GnL1KnO = {
            "id" = "3GnL1KnO";
            "file" = "dynamic_resource_bars-neoforge-0.9.6+26.1.2.jar";
            "hash" = "sha512-qVwQJ7ZETSHzbDbOV+hLSktIwlmF/2sNQg+YgozWQfcOB95mDPg6+DJclvSmSMUr7nBcTlpx+j1oIgTukZFcJw==";
        };
    in {
        "sinK3nrG" = _sinK3nrG;
        "r3XZCB3H" = _r3XZCB3H;
        ...
        "neoforge-26.1.2" = _3GnL1KnO;
        "fabric-1.20.1" = _sjwwkjex;
        "fabric-1.21.1" = _4cV4QcaR;
        "fabric-1.20" = _sjwwkjex;
        "fabric-26.1.2" = _GUrWiIiC;
        "pkg-0.2.0" = _wNKTY6IW;
        "pkg-0.2.1" = _QH6zQVUm;
        "pkg-forge-1.20.1-0.3.0" = _Fi5dUykz;
        "pkg-fabric-1.20.1-0.3.0" = _WzNXsK4v;
        "pkg-fabric-1.21.1-0.3.0" = _GfQeV7Zg;
        "pkg-neoforge-1.21.1-0.3.0" = _gl7Yy7vA;
        "pkg-neoforge-1.21.1-0.4.0" = _qoYR1b7U;
        "pkg-forge-1.20.1-0.4.0" = _k4rXsPc7;
        "pkg-fabric-1.20.1-0.4.0" = _b5X0K4pQ;
        "pkg-fabric-1.21.1-0.4.0" = _J8KYpOML;
        "pkg-neoforge-1.21.1-0.5.0" = _jn9Xgmjl;
        "pkg-forge-1.20.1-0.5.0" = _juyqvobx;
        "pkg-fabric-1.21.1-0.5.0" = _QFQSVpO5;
        "pkg-fabric-1.20.1-0.5.0" = _OE2rvn8P;
        "pkg-forge-1.20.1-0.5.1" = _oKHwbGu7;
        "pkg-neoforge-1.21.1-0.5.1" = _Qv2pbrvp;
        "pkg-fabric-1.20.1-0.5.1" = _HqufI5e5;
        "pkg-fabric-1.21.1-0.5.1" = _MxTVJ6nr;
        "pkg-fabric-1.20.1-0.6.0" = _VAKmiGfZ;
        "pkg-forge-1.20.1-0.6.0" = _IAsrIg3y;
        "pkg-neoforge-1.21.1-0.6.0" = _EYrhTtkr;
        "pkg-fabric-1.21.1-0.6.0" = _ELHrKj5J;
        "pkg-forge-1.20.1-0.6.1" = _erAymgAS;
        "pkg-neoforge-1.21.1-0.6.1" = _MHlvBnVx;
        "pkg-fabric-1.21.1-0.6.1" = _Fynd14H7;
        "pkg-fabric-1.20.1-0.6.1" = _k0k5EBCe;
        "pkg-neoforge-1.21.1-0.6.2" = _kJVq7lNQ;
        "pkg-forge-1.20.1-0.6.2" = _GrZZ16KJ;
        "pkg-fabric-1.21.1-0.6.2" = _7h3Zk1dV;
        "pkg-fabric-1.20.1-0.6.2" = _c0Nxx21e;
        "pkg-neoforge-1.21.1-0.7.0" = _5jjZZvoJ;
        "pkg-forge-1.20.1-0.7.0" = _cAScS1z6;
        "pkg-fabric-1.20.1-0.7.0" = _JaaErJE9;
        "pkg-fabric-1.21.1-0.7.0" = _QcpNGCqe;
        "pkg-fabric-1.21.1-0.7.1" = _4cV4QcaR;
        "pkg-neoforge-1.21.1-0.7.1" = _ybV9tzsj;
        "pkg-forge-1.20.1-0.7.1" = _LCmZ3edm;
        "pkg-fabric-1.20.1-0.7.1" = _sjwwkjex;
        "pkg-0.9.1+26.1.2" = _DhqEyEUo;
        "pkg-0.9.2+26.1.2" = _sR3q1p4Q;
        "pkg-0.9.3+26.1.2" = _TanNY3rE;
        "pkg-0.9.4+26.1.2" = _sos63eLe;
        "pkg-0.9.5+26.1.2" = _MuPZ8ezI;
        "pkg-0.9.6+26.1.2" = _3GnL1KnO;
        "default" = _3GnL1KnO;
    });
