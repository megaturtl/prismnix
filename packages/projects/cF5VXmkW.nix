...
let
    ...
    in {
        ...
        "pkg-v1.2.0" = _nZoiMKCW;
        "pkg-v1.2.1" = _FLJxGVwG;
        "pkg-v1.3.0" = _hIuKUbSN;
        "pkg-v1.4.0" = _JPOOJ6I5;
        "pkg-v1.5.0" = _7Y3JBFoH;
        "pkg-v1.5.1" = _IzFSfzyH;
        "pkg-v1.5.2" = _vl100XRq;
        "pkg-v1.5.3" = _ceBYCP4P;
        "pkg-v1.6.0" = _iDkVGJTR;
        "pkg-v1.7.0" = _eLYaj0U1;
        "pkg-v1.7.1" = _nJWHmM4A;
        "pkg-v1.7.2" = _WsxFfK1h;
        "pkg-v1.7.3" = _tYU6j4Il;
        "pkg-v1.7.4" = _sMOJ7fAa;
        "pkg-v1.7.5" = _Naos32er;
        "pkg-v1.7.6" = _uk9qEanB;
        "pkg-v1.7.7" = _d5oaUT4Q;
        "pkg-v1.7.8" = _Fl3CgPwj;
        "pkg-git-3390f0b" = _IYFIFmId;
        "pkg-git-fa712ec" = _t5xPrIo6;
        "pkg-git-46ccffa" = _6j68SbYF;
        "pkg-git-0f4f739" = _hQ7gAGQg;
        "pkg-git-79421a2" = _pZSE9A5l;
        "pkg-git-b1e173d" = _htEKVpAF;
        "pkg-git-e22d3c1" = _TVXf5yII;
        "pkg-git-d594f67" = _sUV5ukEQ;
        "pkg-git-fa59fa6" = _THazKlXw;
        "pkg-git-6fe18a9" = _PZICLzCn;
        "pkg-git-2b44298" = _HlPQVBpW;
        "pkg-git-2b2dbcc" = _OAanQKb7;
        "pkg-git-cabc8bf" = _KlzlyUvq;
        "pkg-git-e63f5ee" = _j1p1w913;
        "pkg-git-be9cae6" = _NfsZE9l8;
        "pkg-git-2cf650f" = _scmXsWTT;
        "pkg-git-e5a63d1" = _zKzwelvh;
        "pkg-git-055d9ce" = _ite4VJYB;
        "pkg-git-6872046" = _QEVGGY3c;
        "pkg-git-d0dadc4" = _pkzRIPBn;
        "pkg-git-8da0bef" = _PnHKoxZV;
        "pkg-git-8d7e5f0" = _A64axKwx;
        "pkg-git-58591d9" = _cFJW39yt;
        "pkg-git-1ac8a77" = _fHEaNv1W;
        "pkg-git-044420b" = _cf7bYOZh;
        "pkg-git-ae4b73a" = _Joq39Pg5;
        "pkg-git-02b5cec" = _92XR17E5;
        "pkg-git-1536c3b" = _FfVo0Lqx;
        "pkg-git-bfb94d7" = _nvZxPu5B;
        "pkg-git-f296289" = _pfKlygE3;
        "pkg-git-f40acfa" = _uaBwbsef;
        "pkg-git-43b8ef0" = _7Dv2nVIe;
        "pkg-git-3ed2a0e" = _h0U4GDGT;
        "pkg-git-bb2b62b" = _6qHOOpAs;
        "pkg-git-20dbc5d" = _dcNdAJ2P;
        "pkg-git-53ec3f8" = _rUbLcyhA;
        "pkg-git-a2cf425" = _VqqzsmHz;
        "pkg-git-3b9d167" = _OQjYe8LO;
        "pkg-git-684dc01" = _Ww1IApA3;
        "pkg-git-bf0b43a" = _fOpx11f3;
        "pkg-git-44cf273" = _PwmZD2Mz;
        "pkg-git-4cba9d9" = _yZKSCVqI;
        "pkg-git-c5a8e63" = _NiuIaMDW;
        "pkg-git-8117912" = _ZM6rY0ON;
        "pkg-git-e7cde94" = _vsXGO0KF;
        "pkg-git-d1b6463" = _s1zbpfnX;
        "pkg-v1.7.9" = _sZN93c7P;
        "pkg-git-d503c88" = _E3kTaPNT;
        "pkg-git-dea3c6c" = _ninqxjQD;
        "pkg-git-f77eb17" = _cPxqArUJ;
        "pkg-git-516613a" = _FpGdapxa;
        "pkg-git-a3e62db" = _GS8yuZu2;
        "pkg-git-179418b" = _R1WdJ7Hq;
        "pkg-git-0f3e37f" = _MN6FJBwB;
        "pkg-git-87e2d85" = _EqB1WZxI;
        "pkg-git-ca02fd3" = _B1WhcJmV;
        "pkg-git-261770a" = _PfCDz9LW;
        "pkg-git-9a95507" = _pMAA2LvR;
        "pkg-git-78ec832" = _QUwKuHxA;
        "pkg-git-0abb8c5" = _qcYmsT8W;
        "pkg-git-50c8fc5" = _y2CYgVHJ;
        "pkg-git-f791721" = _DtDRi1yR;
        "pkg-git-92aa506" = _JhTOMSHP;
        "pkg-git-c09f2cd" = _6WKIqFPd;
        "pkg-git-648e34f" = _kaCFEENu;
        "pkg-git-9898f04" = _cYkaQUzr;
        "pkg-v1.7.10" = _MLpWFoq1;
        "pkg-git-f63b732" = _HaXlakGi;
        "pkg-git-28604f1" = _itBGvEdL;
        "pkg-git-231e54e" = _yUqGeFtd;
        "pkg-git-783b660" = _OvXjO6th;
        "pkg-v1.7.11" = _8x5s32FF;
        "pkg-git-2ae6db5" = _cHWnw6lO;
        "pkg-git-eacd069" = _v8LbvxWs;
        "pkg-git-7aff7d9" = _2d1lCtPc;
        "pkg-git-d4d84e5" = _zAV2kdoh;
        "pkg-git-3f9e3e8" = _UGIsrNQd;
        "pkg-git-edc981b" = _tnjk9eht;
        "pkg-git-a0f3272" = _qt8XOETb;
        "pkg-git-f47b613" = _Bo6CNTi7;
        "pkg-git-cdf23a3" = _lp6RRxj1;
        "pkg-git-aa12b7f" = _kgtoAMOK;
        "pkg-git-967d99a" = _CvHPrEvs;
        "pkg-git-e463a3d" = _v0XcSHoa;
        "pkg-git-25b7d68" = _U8n6ZrGb;
        "pkg-git-e6954f8" = _FMEODOFB;
        "pkg-git-a7c1d0d" = _57WkVbgA;
        "pkg-git-eda629a" = _y6CvjqWg;
        "pkg-git-52176e9" = _L9xX4kKY;
        "pkg-git-e890ac4" = _U7AVRKhP;
        "pkg-v1.8.0" = _uslM27Xz;
        "pkg-git-c246448" = _N4rjH9Z3;
        "pkg-git-139b161" = _AlxnD8sH;
        "pkg-v1.8.1" = _AZ5VpvIX;
        "pkg-git-3c9a3c4" = _C87kSQbR;
        "pkg-git-9e4bee1" = _qrVfsz85;
        "pkg-git-43dc995" = _2fAxJYTT;
        "pkg-git-704f6c5" = _3eP7opMq;
        "pkg-git-7a11a4d" = _TKg0dBPP;
        "pkg-git-fa175ac" = _Y5cICWMF;
        "pkg-git-6132239" = _cb8jyj3V;
        "pkg-git-4e4a20b" = _mpGQF60F;
        "pkg-v1.8.2" = _sXDtVai9;
        "pkg-git-62e61f7" = _uuVDQRDa;
        "pkg-git-740b030" = _kqFuBGx0;
        "pkg-git-ec8c23a" = _DmqlpuyC;
        "pkg-git-50a2908" = _3kUTFMgk;
        "pkg-git-6942f76" = _ZOGIs88g;
        "pkg-git-5c15a3b" = _bhwISwZL;
        "pkg-git-d6cd1fa" = _ACg0Mvvw;
        "pkg-git-0f28925" = _RJSx6vIa;
        "pkg-v1.8.3" = _h9gVhvqW;
        "pkg-git-1471fbd" = _IbYpshBB;
        "pkg-git-a34ad0b" = _B008YnIk;
        "pkg-v1.8.4" = _cr0WyPUj;
        "pkg-git-297ad18" = _gqGfQi62;
        "pkg-git-7d6e45f" = _F22ktMja;
        "pkg-git-ade616e" = _6BPwrSD1;
        "pkg-git-5423f3a" = _jU039yKo;
        "pkg-git-232957e" = _nyr2nD0J;
        "pkg-git-4925835" = _IxBI7fQc;
        "pkg-v1.8.5" = _XfGiTXaT;
        "pkg-git-d6e1bf7" = _dTLujCZR;
        "pkg-git-069005d" = _v3FoMGnm;
        "pkg-git-0b0b514" = _XNhdGl36;
        "pkg-git-1230490" = _D1qYVtaG;
        "pkg-git-a10c72f" = _mEqXp6u5;
        "pkg-git-03866e4" = _XqaskQox;
        "pkg-git-aceee63" = _VxTCcwNG;
        "pkg-git-6966b1c" = _1NeydZWM;
        "pkg-v1.9.0" = _O3BNbypY;
        "pkg-v1.9.1" = _C5udf7wJ;
