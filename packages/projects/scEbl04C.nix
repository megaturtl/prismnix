...
let
    versions = (let
        ...
        _KNXmK7Iy = {
            "id" = "KNXmK7Iy";
            "file" = "AuctionHouse-1.5.4.jar";
            "hash" = "sha512-Jzz1NRk+R2nvJqDaBFuWw6OnzYQVLauF0jMyDh9WUC+9mAoyoO6ogp67nRQOA9GOYtaHpPxeXHzEDC0bWZiOeA==";
        };
        _pGZS5b21 = {
            "id" = "pGZS5b21";
            "file" = "AuctionHouse-1.5.5.jar";
            "hash" = "sha512-lJpkHQDgI42NflP9zqsTQ/VeBn1+3V0RIXwAUVJigrFh5xtN+dupOK/Ey9yFYJr6RCXnq4jMkc5g3G2deuu9dg==";
        };
    in {
        "XPUXfkV8" = _XPUXfkV8;
        "SxmgD76B" = _SxmgD76B;
        ...
        "KNXmK7Iy" = _KNXmK7Iy;
        "pGZS5b21" = _pGZS5b21;
        "bukkit-1.21" = _pGZS5b21;
        "bukkit-1.21.1" = _pGZS5b21;
        "bukkit-1.21.2" = _pGZS5b21;
        "bukkit-1.21.3" = _pGZS5b21;
        "bukkit-1.21.4" = _pGZS5b21;
        "bukkit-1.21.5" = _pGZS5b21;
        "bukkit-1.21.6" = _pGZS5b21;
        "bukkit-1.21.7" = _pGZS5b21;
        "bukkit-1.21.8" = _pGZS5b21;
        "bukkit-1.21.9" = _pGZS5b21;
        "bukkit-1.21.10" = _pGZS5b21;
        "bukkit-1.21.11" = _pGZS5b21;
        "bukkit-26.1" = _pGZS5b21;
        "bukkit-26.1.1" = _pGZS5b21;
        "bukkit-26.1.2" = _pGZS5b21;
        "bukkit-26.2" = _pGZS5b21;
        "paper-1.21" = _pGZS5b21;
        "paper-1.21.1" = _pGZS5b21;
        "paper-1.21.2" = _pGZS5b21;
        "paper-1.21.3" = _pGZS5b21;
        "paper-1.21.4" = _pGZS5b21;
        "paper-1.21.5" = _pGZS5b21;
        "paper-1.21.6" = _pGZS5b21;
        "paper-1.21.7" = _pGZS5b21;
        "paper-1.21.8" = _pGZS5b21;
        "paper-1.21.9" = _pGZS5b21;
        "paper-1.21.10" = _pGZS5b21;
        "paper-1.21.11" = _pGZS5b21;
        "paper-26.1" = _pGZS5b21;
        "paper-26.1.1" = _pGZS5b21;
        "paper-26.1.2" = _pGZS5b21;
        "paper-26.2" = _pGZS5b21;
        "purpur-1.21" = _pGZS5b21;
        "purpur-1.21.1" = _pGZS5b21;
        "purpur-1.21.2" = _pGZS5b21;
        "purpur-1.21.3" = _pGZS5b21;
        "purpur-1.21.4" = _pGZS5b21;
        "purpur-1.21.5" = _pGZS5b21;
        "purpur-1.21.6" = _pGZS5b21;
        "purpur-1.21.7" = _pGZS5b21;
        "purpur-1.21.8" = _pGZS5b21;
        "purpur-1.21.9" = _pGZS5b21;
        "purpur-1.21.10" = _pGZS5b21;
        "purpur-1.21.11" = _pGZS5b21;
        "purpur-26.1" = _pGZS5b21;
        "purpur-26.1.1" = _pGZS5b21;
        "purpur-26.1.2" = _pGZS5b21;
        "purpur-26.2" = _pGZS5b21;
        "spigot-1.21" = _pGZS5b21;
        "spigot-1.21.1" = _pGZS5b21;
        "spigot-1.21.2" = _pGZS5b21;
        "spigot-1.21.3" = _pGZS5b21;
        "spigot-1.21.4" = _pGZS5b21;
        "spigot-1.21.5" = _pGZS5b21;
        "spigot-1.21.6" = _pGZS5b21;
        "spigot-1.21.7" = _pGZS5b21;
        "spigot-1.21.8" = _pGZS5b21;
        "spigot-1.21.9" = _pGZS5b21;
        "spigot-1.21.10" = _pGZS5b21;
        "spigot-1.21.11" = _pGZS5b21;
        "spigot-26.1" = _pGZS5b21;
        "spigot-26.1.1" = _pGZS5b21;
        "spigot-26.1.2" = _pGZS5b21;
        "spigot-26.2" = _pGZS5b21;
        "folia-1.21" = _pGZS5b21;
        "folia-1.21.1" = _pGZS5b21;
        "folia-1.21.2" = _pGZS5b21;
        "folia-1.21.3" = _pGZS5b21;
        "folia-1.21.4" = _pGZS5b21;
        "folia-1.21.5" = _pGZS5b21;
        "folia-1.21.6" = _pGZS5b21;
        "folia-1.21.7" = _pGZS5b21;
        "folia-1.21.8" = _pGZS5b21;
        "folia-1.21.9" = _pGZS5b21;
        "folia-1.21.10" = _pGZS5b21;
        "folia-1.21.11" = _pGZS5b21;
        "folia-26.1" = _pGZS5b21;
        "folia-26.1.1" = _pGZS5b21;
        "folia-26.1.2" = _pGZS5b21;
        "folia-26.2" = _pGZS5b21;
        "pkg-1.3.4" = _XPUXfkV8;
        "pkg-1.3.5" = _SxmgD76B;
        "pkg-1.3.6" = _sOUjX795;
        "pkg-1.3.7" = _HvscjSNn;
