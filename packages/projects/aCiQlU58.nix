...
let
    ...
    in {
        ...
        "O1jVmWPd" = _O1jVmWPd;
        "CWlO5dFu" = _CWlO5dFu;
        "fabric-1.20.1" = _RgJLWdVc;
        "fabric-1.21.1" = _GOQrFnyj;
        "fabric-1.21.11" = _kzBubwhx;
        "fabric-26.1.2" = _CWlO5dFu;
        "forge-1.20.1" = _C5tYtqhD;
        "neoforge-1.21.1" = _xbXY8ZRv;
        "neoforge-1.21.11" = _P9w8KhER;
        "neoforge-26.1.2" = _O1jVmWPd;
        "pkg-1.0.0" = _qkcGETGo;
        "pkg-1.0.1" = _nehFCEkH;
        "pkg-1.0.2" = _QPQD0SBp;
        "pkg-1.0.3" = _mj7FSMNS;
