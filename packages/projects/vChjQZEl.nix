...
let
    ...
    in {
        ...
        "pkg-0.7.0-1.20.1" = _FKLmp8bB;
        "pkg-0.7.1-1.20.1" = _R4w4k1IL;
        "pkg-0.8.0-1.20.1" = _szTE40Lu;
        "pkg-1.0.0-1.20.1" = _sN3j1auD;
        "pkg-1.0.0-1.21" = _z8OwkT97;
        "pkg-1.1.0-1.20.1" = _ByKYWWWM;
        "pkg-1.0.0-1.19.2" = _a23C0HVz;
        "pkg-2.0.0-1.20.1" = _mRGaoPLP;
        "pkg-2.0.1-1.20.1" = _dG5WHz5k;
        "pkg-2.1.1-1.20.1" = _HdFuLwqi;
        "pkg-2.0.0-1.19.2" = _9kb7LdGj;
        "pkg-2.0.0-1.21" = _d27uvWC2;
        "pkg-3.0.0-1.20.1" = _AO9JA8MO;
        "pkg-3.0.1-1.20.1" = _fnDD30dR;
        "pkg-3.1.1-1.20.1" = _dWXPoNEz;
        "pkg-3.2.1-1.20.1" = _Z0TbdnZq;
        "pkg-3.3.1-1.20.1" = _mnmShqhj;
        "pkg-4.0.0-1.20.1" = _dY4YGLkc;
        "pkg-4.0.0-1.21" = _xrztTAR8;
        "pkg-4.0.1-1.20.1" = _c40wnSuA;
        "pkg-5.0.0-1.20.1" = _A42gbtWC;
        "pkg-5.1.0-1.20.1" = _rgM4wple;
        "pkg-5.1.0-1.21" = _mrscOyZD;
        "pkg-5.2.0-1.20.1" = _FtjX51lm;
        "pkg-5.2.0-1.21" = _Vm2FMQ6r;
        "pkg-5.3.0-1.21" = _gwG5CEYW;
        "pkg-5.3.0-1.20.1" = _Yqa78qpg;
        "pkg-5.2.0-1.21-fabric" = _IbGc2ZLR;
        "pkg-5.2.0-1.21.1-fabric" = _4oKgyR3p;
        "pkg-5.2.1-1.21.1-fabric" = _ftXzag9j;
        "pkg-5.3.1-1.20.1" = _mBpnGe9v;
        "pkg-5.4.0-1.21.1" = _rwy8YNzC;
        "pkg-5.4.0-1.20.1" = _SDDCGzue;
        "pkg-5.5.0-1.21.1" = _u8M4rj3z;
