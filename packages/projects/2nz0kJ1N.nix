...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.2.0" = _aQNVyRKa;
        "pkg-NE-1.14.4-Fabric-1.3.0" = _pKk64kMm;
        "pkg-NE-1.15.2-Fabric-1.3.0" = _FYmeoimI;
        "pkg-NE-1.16.5-Fabric-1.3.0" = _c7QmS86c;
        "pkg-NE-1.17-Fabric-1.3.0" = _8M69nszg;
        "pkg-NE-1.18-Fabric-1.3.0" = _DZ0cTuuk;
        "pkg-NE-1.19-Fabric-1.3.0" = _EqAAHcbD;
        "pkg-1.14.4-Fabric-1.4.0" = _jfXd0eHw;
        "pkg-1.15.2-Fabric-1.4.0" = _BQ4ANFYM;
        "pkg-1.16.5-Fabric-1.4.0" = _PytCHUqd;
        "pkg-1.17-Fabric-1.4.0" = _seQHt6ZT;
        "pkg-1.18-Fabric-1.4.0" = _WRMyxc06;
        "pkg-1.19-Fabric-1.4.0" = _Obfl3v5k;
        "pkg-1.14.4-1.5.0" = _Ix3sxeDz;
        "pkg-1.15.2-1.5.0" = _xCzpMCb9;
        "pkg-1.16.5-1.5.0" = _Ojjksb1Z;
        "pkg-1.17.1-1.5.0" = _QSnr8WD5;
        "pkg-1.18.2-1.5.0" = _evDhpcFz;
        "pkg-1.19.4-1.5.0" = _OSDyNWsO;
        "pkg-1.20-pre7-1.5.0" = _fARkMECT;
        "pkg-1.14.4-1.6.0" = _3EtaDImE;
        "pkg-1.15.2-1.6.0" = _726OPsbK;
        "pkg-1.16.5-1.6.0" = _gBsRdM9q;
        "pkg-1.17.1-1.6.0" = _dQZHvikW;
        "pkg-1.18.2-1.6.0" = _gam0pdFK;
        "pkg-1.19.4-1.6.0" = _ZvfexMfY;
        "pkg-1.20-1.6.0" = _eOBPJzLg;
        "pkg-1.14.4-1.6.1" = _nxOFQ9nC;
        "pkg-1.15.2-1.6.1" = _clmThNUK;
        "pkg-1.16.5-1.6.1" = _CcWCbCuc;
        "pkg-1.17.1-1.6.1" = _7W68jqSC;
        "pkg-1.18.2-1.6.1" = _vahcQCwn;
        "pkg-1.19.4-1.6.1" = _XhepL7gp;
        "pkg-1.20-1.6.1" = _mLY7y5Bp;
        "pkg-1.14.4-1.6.2" = _poohM1T7;
        "pkg-1.15.2-1.6.2" = _X9oZeNvT;
        "pkg-1.16.5-1.6.2" = _M5oCJw3a;
        "pkg-1.17.1-1.6.2" = _8aHQPa5R;
        "pkg-1.18.2-1.6.2" = _nnBS8iyy;
        "pkg-1.19.4-1.6.2" = _JCg6d95w;
        "pkg-1.20-1.6.2" = _fudL9o0B;
        "pkg-1.20.1-1.6.2" = _30AE5vdV;
        "pkg-1.14.4-1.6.3" = _ZX60Ggxo;
        "pkg-1.15.2-1.6.3" = _sZKMNqsD;
        "pkg-1.16.5-1.6.3" = _Ws27LxCl;
        "pkg-1.17.1-1.6.3" = _OnXqDnY0;
        "pkg-1.18.2-1.6.3" = _Feo9Olcn;
        "pkg-1.19.4-1.6.3" = _aUpjJEFo;
        "pkg-1.20.1-1.6.3" = _AGCkUQ17;
        "pkg-1.14.4-1.6.4" = _entScScU;
        "pkg-1.15.2-1.6.4" = _mOWzs2Vc;
        "pkg-1.16.5-1.6.4" = _4DvxCUYS;
        "pkg-1.17.1-1.6.4" = _A5drdp2R;
        "pkg-1.18.2-1.6.4" = _vgtipXtH;
        "pkg-1.19.4-1.6.4" = _QNoAWvJx;
        "pkg-1.20.1-1.6.4" = _PtySH8q7;
        "pkg-1.10.2-1.6.4" = _LC6HHKiK;
        "pkg-1.11.2-1.6.4" = _AINAkDUa;
        "pkg-1.12.2-1.6.4" = _Xl02WIMn;
        "pkg-1.7.10-1.6.4" = _PXEoVP0t;
        "pkg-1.8.9-1.6.4" = _HTFJUjM0;
        "pkg-1.9.4-1.6.4" = _1skmlCBD;
        "pkg-1.10.2-1.7.0" = _5hIWfOb3;
        "pkg-1.11.2-1.7.0" = _GKnRYSJb;
        "pkg-1.12.2-1.7.0" = _YSTa1wDH;
        "pkg-1.7.10-1.7.0" = _G7OsKhl7;
        "pkg-1.8.9-1.7.0" = _qEr9Jn94;
        "pkg-1.9.4-1.7.0" = _vEnm4qcx;
        "pkg-1.14.4-1.7.0" = _om7MLS9f;
        "pkg-1.15.2-1.7.0" = _DHmk4f9i;
        "pkg-1.16.5-1.7.0" = _jKZtfUKy;
        "pkg-1.17.1-1.7.0" = _FsQ9u30b;
        "pkg-1.18.2-1.7.0" = _jsbPrdxd;
        "pkg-1.19.4-1.7.0" = _q8NaCp3q;
        "pkg-1.20.1-1.7.0" = _e8dFvMEL;
        "pkg-1.10.2-1.7.1" = _OKJwiMB3;
        "pkg-1.11.2-1.7.1" = _FPF1VDJ5;
        "pkg-1.12.2-1.7.1" = _VBy79cKo;
        "pkg-1.7.10-1.7.1" = _XiNf4JVg;
        "pkg-1.8.9-1.7.1" = _kjohIDCI;
        "pkg-1.9.4-1.7.1" = _n3eg2vSx;
        "pkg-1.14.4-1.7.1" = _BKMgKukg;
        "pkg-1.15.2-1.7.1" = _oenzWi6k;
        "pkg-1.16.5-1.7.1" = _x2D1Rltw;
        "pkg-1.17.1-1.7.1" = _WaZZ7iCK;
        "pkg-1.18.2-1.7.1" = _TB73847H;
        "pkg-1.19.4-1.7.1" = _C1BEQJss;
        "pkg-1.20.1-1.7.2" = _S4R6YYU4;
        "pkg-1.10.2-1.8.0" = _Qa9KiXCi;
        "pkg-1.11.2-1.8.0" = _y8zfMdyN;
        "pkg-1.12.2-1.8.0" = _aaDxwBNo;
        "pkg-1.7.10-1.8.0" = _wYJOtOnz;
        "pkg-1.8.9-1.8.0" = _vjDMosMG;
        "pkg-1.9.4-1.8.0" = _25oksfUC;
        "pkg-1.14.4-1.8.0" = _P0nRtaVL;
        "pkg-1.15.2-1.8.0" = _FPCw3Gmu;
        "pkg-1.16.5-1.8.0" = _MSY615xd;
        "pkg-1.17.1-1.8.0" = _MD5cUBCM;
        "pkg-1.18.2-1.8.0" = _gHM1CeaU;
        "pkg-1.19.4-1.8.0" = _smI7bglA;
        "pkg-1.20.1-1.8.0" = _QI2qtiWk;
        "pkg-1.10.2-1.8.1" = _4BkQZ5Ty;
        "pkg-1.11.2-1.8.1" = _jNMy07Dd;
        "pkg-1.12.2-1.8.1" = _lsTYHCT7;
        "pkg-1.7.10-1.8.1" = _wX16SYtH;
        "pkg-1.8.9-1.8.1" = _jyshbIsW;
        "pkg-1.9.4-1.8.1" = _g1xFVe07;
        "pkg-1.14.4-1.8.1" = _CEhexlin;
        "pkg-1.15.2-1.8.1" = _zBRs1LXa;
        "pkg-1.16.5-1.8.1" = _pbeWLPIw;
        "pkg-1.17.1-1.8.1" = _88XCPNlY;
        "pkg-1.18.2-1.8.1" = _nShI6BoX;
        "pkg-1.19.4-1.8.1" = _EOM6Kdgo;
        "pkg-1.20.1-1.8.1" = _hQPlFNv5;
        "pkg-1.14.4-1.8.2" = _PEI7bkH4;
        "pkg-1.15.2-1.8.2" = _CmHfbdDq;
        "pkg-1.16.5-1.8.2" = _fPz0zhz5;
        "pkg-1.17.1-1.8.2" = _dZm8uidB;
        "pkg-1.18.2-1.8.2" = _haQxsVXJ;
        "pkg-1.19.4-1.8.2" = _A1NHN55c;
        "pkg-1.20.1-1.8.2" = _GiB0DDvm;
        "pkg-1.10.2-1.9.0" = _ANJYElH6;
        "pkg-1.11.2-1.9.0" = _9z0OU4y5;
        "pkg-1.12.2-1.9.0" = _V2pX1eRQ;
        "pkg-1.7.10-1.9.0" = _pRdFzEca;
        "pkg-1.8.9-1.9.0" = _lJZGDjdq;
        "pkg-1.9.4-1.9.0" = _3GNt54AQ;
        "pkg-1.14.4-1.9.0" = _WR9fVPHO;
        "pkg-1.15.2-1.9.0" = _aRs5hHDi;
        "pkg-1.16.5-1.9.0" = _ujAZxMxl;
        "pkg-1.17.1-1.9.0" = _YvoHba2P;
        "pkg-1.18.2-1.9.0" = _zhEHH4zz;
        "pkg-1.19.4-1.9.0" = _lDbxD6aR;
        "pkg-1.20.1-1.9.0" = _3qgbHvhi;
        "pkg-1.20.2-rc1-1.9.0" = _7uqahFD0;
        "pkg-1.20.2-1.9.0" = _e3S1CMyh;
        "pkg-1.20.4-1.9.0" = _fsanGwF3;
        "pkg-1.20.5-1.9.0" = _BrLIkGZT;
        "pkg-1.20.6-1.9.0" = _nTAZ4bZR;
        "pkg-1.21-1.9.0" = _oYVQ6WOI;
        "pkg-1.10.2-1.9.1" = _H2oeBc60;
        "pkg-1.11.2-1.9.1" = _wHkA7dMv;
        "pkg-1.12.2-1.9.1" = _EdY2iINh;
        "pkg-1.7.10-1.9.1" = _MB6hMqNB;
        "pkg-1.8.9-1.9.1" = _ZXwcc9E9;
        "pkg-1.9.4-1.9.1" = _gLc2ZTNF;
        "pkg-1.14.4-1.9.1" = _vMWeIKmk;
        "pkg-1.15.2-1.9.1" = _n8Pja5eB;
        "pkg-1.16.5-1.9.1" = _sAeMdGt6;
        "pkg-1.17.1-1.9.1" = _K8PFZl07;
        "pkg-1.18.2-1.9.1" = _93fYQB3n;
        "pkg-1.19.4-1.9.1" = _xOa8Vxso;
        "pkg-1.20.6-1.9.1" = _ClqaUHI1;
        "pkg-1.21-1.9.1" = _cvHM7MCC;
        "pkg-1.10.2-1.9.2" = _9MB6ih8P;
        "pkg-1.11.2-1.9.2" = _UWiwnvvz;
        "pkg-1.12.2-1.9.2" = _rxqxuufU;
        "pkg-1.7.10-1.9.2" = _FfBj0vGh;
        "pkg-1.8.9-1.9.2" = _WyO29v7l;
        "pkg-1.9.4-1.9.2" = _UfbUPfj2;
        "pkg-1.14.4-1.9.2" = _ij2j32m0;
        "pkg-1.15.2-1.9.2" = _ejDHkRDZ;
        "pkg-1.16.5-1.9.2" = _83bum6Uq;
        "pkg-1.17.1-1.9.2" = _pk2EHTAA;
        "pkg-1.18.2-1.9.2" = _Tcdr9WEY;
        "pkg-1.19.4-1.9.2" = _uKe0GCWc;
        "pkg-1.20.6-1.9.2" = _NdUFQtUG;
        "pkg-1.21-1.9.2" = _XugbnU8r;
        "pkg-1.21.1-1.9.2" = _h68By8c0;
        "pkg-1.10.2-1.10.0" = _CAPnvxGl;
        "pkg-1.11.2-1.10.0" = _mmPu2dOT;
        "pkg-1.12.2-1.10.0" = _ocyJquNg;
        "pkg-1.7.10-1.10.0" = _8F5h2tKw;
        "pkg-1.8.9-1.10.0" = _QpgQXfhP;
        "pkg-1.9.4-1.10.0" = _j01rKkLg;
        "pkg-1.14.4-1.10.0" = _7Yefr8HB;
        "pkg-1.15.2-1.10.0" = _hMlgcrxd;
        "pkg-1.16.5-1.10.0" = _vsj2v4z4;
        "pkg-1.17.1-1.10.0" = _AxbNp9Ro;
        "pkg-1.18.2-1.10.0" = _PL13M12z;
        "pkg-1.19.4-1.10.0" = _7OxsoMIe;
        "pkg-1.20.6-1.10.0" = _7kEKy3ez;
        "pkg-1.21.1-1.10.0" = _HFdNcDOl;
        "pkg-1.21.3-1.10.0" = _aZyTA7ee;
        "pkg-1.10.2-1.10.1" = _P2BstTgD;
        "pkg-1.11.2-1.10.1" = _7ocQtJcX;
        "pkg-1.12.2-1.10.1" = _i9ITpyZs;
        "pkg-1.7.10-1.10.1" = _Gay2zUIx;
        "pkg-1.8.9-1.10.1" = _dPtd2Zs9;
        "pkg-1.9.4-1.10.1" = _SZ7H8Nrp;
        "pkg-1.14.4-1.10.1" = _DFAvH2B3;
        "pkg-1.15.2-1.10.1" = _pnMVdiRd;
        "pkg-1.16.5-1.10.1" = _CEYgjQP2;
        "pkg-1.17.1-1.10.1" = _nzRGVHqa;
        "pkg-1.18.2-1.10.1" = _c5Ld9qVT;
        "pkg-1.19.4-1.10.1" = _sWVF8WG2;
        "pkg-1.20.6-1.10.1" = _AxtBlvez;
        "pkg-1.21.3-1.10.1" = _GjlZLHQw;
        "pkg-1.21.4-1.10.1" = _hW4N5sLP;
        "pkg-1.21.5-1.10.1" = _OanGUxNG;
        "pkg-1.21.6-1.10.1" = _z2C6JlfJ;
        "pkg-1.21.7-1.10.1" = _Ela26XKv;
        "pkg-1.11.2-1.10.2" = _RvajeqFf;
        "pkg-1.12.2-1.10.2" = _bsF4jSHO;
        "pkg-1.20.6-1.10.2" = _KThdEn1x;
        "pkg-1.8.9-1.10.2" = _TyNKsvxU;
        "pkg-1.15.2-1.10.2" = _7DC4rTYE;
        "pkg-1.7.10-1.10.2" = _oKchel1A;
        "pkg-1.14.4-1.10.2" = _mH5joRMk;
        "pkg-1.17.1-1.10.2" = _WAcOJjEE;
        "pkg-1.16.5-1.10.2" = _YdDoTNuy;
        "pkg-1.21.7-1.10.2" = _yzqvvWx9;
        "pkg-1.10.2-1.10.2" = _Z84UTq8S;
        "pkg-1.18.2-1.10.2" = _sHiqzYM3;
        "pkg-1.9.4-1.10.2" = _tJam0hHi;
        "pkg-1.19.4-1.10.2" = _HnBOy6vZ;
        "pkg-1.21.8-1.10.2" = _4ICjXRtk;
        "pkg-1.21.9-1.10.2" = _nFa9bfcu;
        "pkg-1.21.10-1.10.2" = _zPTEu5ZA;
        "pkg-1.21.11-1.10.2" = _v6NgGWpm;
        "pkg-26.1-snapshot-9-1.10.2" = _EBM5zYnc;
        "pkg-26.1-snapshot-10-1.10.2" = _N6a2yVfq;
        "pkg-26.1-snapshot-11-1.10.2" = _MklaTL0B;
        "pkg-26.1-pre-1-1.10.2" = _6OUYL8Jf;
        "pkg-26.1-pre-2-1.10.2" = _Rpvqymfm;
        "pkg-26.1-1.10.2" = _pwzF8HNC;
        "pkg-26.1-1.10.3" = _LrnAwR4g;
        "pkg-1.14.4-1.11.0" = _uvoPUq5h;
        "pkg-1.15.2-1.11.0" = _IdyEYtVk;
        "pkg-1.17.1-1.11.0" = _hvhbNDvf;
        "pkg-1.19.4-1.11.0" = _NWQOvOGd;
        "pkg-1.21.11-1.11.0" = _d5hrRE4O;
        "pkg-1.9.4-1.11.0" = _47U3theN;
        "pkg-1.10.2-1.11.0" = _g98BvR3P;
        "pkg-1.11.2-1.11.0" = _V1wGva9y;
        "pkg-1.18.2-1.11.0" = _85i8TjVJ;
        "pkg-1.20.6-1.11.0" = _xZl42Vc7;
        "pkg-1.8.9-1.11.0" = _Y0PNxBNx;
        "pkg-26.1-1.11.0" = _VuV8jgr9;
        "pkg-1.12.2-1.11.0" = _75jsQVVb;
        "pkg-1.7.10-1.11.0" = _xsyX1yzI;
