...
let
    ...
    in {
        ...
        "pkg-0.9.2" = _bvDmKqGP;
        "pkg-0.9.3" = _fkip5mQy;
        "pkg-0.10.0" = _UAA96a3S;
        "pkg-0.11.0" = _1rDdASLb;
        "pkg-0.12.0" = _8mMzt1FR;
        "pkg-0.12.1" = _sC6IaQZg;
        "pkg-0.9.4" = _9nCwDjFA;
        "pkg-0.10.1" = _Onz53eIP;
        "pkg-0.11.1" = _jfkHDezX;
        "pkg-0.12.2" = _OUW0VdpO;
        "pkg-0.13.0" = _hMiAqcMu;
        "pkg-0.9.5" = _KKvBUnZ2;
        "pkg-0.14.0" = _oQfiBDig;
        "pkg-0.15.0" = _4dcGrgUv;
        "pkg-0.15.1" = _A7UG6Zwu;
        "pkg-0.16.0" = _Zwn2fmbB;
        "pkg-0.5.6" = _ObKMM98j;
