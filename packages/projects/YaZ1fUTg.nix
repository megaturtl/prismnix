...
let
    versions = (let
        ...
        _W9us4eEH = {
            "id" = "W9us4eEH";
            "file" = "journeymap-webmap-forge-26.2-1.0.13.jar";
            "hash" = "sha512-sGDCvx4MAJNSnYEJPyorRV5G1HBKtrJlQBiVLnAiMH0khFdhqZ0x6R4RUKQDO+6c4RGLwHVXr0BBJM0/+Jkb9A==";
        };
        _mnuK4oU1 = {
            "id" = "mnuK4oU1";
            "file" = "journeymap-webmap-fabric-26.2-1.0.13.jar";
            "hash" = "sha512-8JUo3uwf9hTXOTzK8OV3IeD3KhpYm8AWDNc+C3R93SO0UiuGCMc16RQbL2e+zwdyA+mkqm/oi072E2R4HNaFAA==";
        };
        _NGEsRulh = {
            "id" = "NGEsRulh";
            "file" = "journeymap-webmap-neoforge-26.2-1.0.13.jar";
            "hash" = "sha512-X0jgkMng3dw3jE7HEVy6gpaqidP18eCF3Dw/AlX3q0lsbEzQRktIX8Pb7rT0wsjYw1f1gMa30I9yxOA7yGRDDg==";
        };
        _y8IkoA5v = {
            "id" = "y8IkoA5v";
            "file" = "journeymap-webmap-forge-26.1.2-1.0.12.jar";
            "hash" = "sha512-PnMp4n9DpoEarWJgF0225D9sbsMH7QGcGAAthUIDqDIX2SFMNh/PfnhlRNEJjTg4JKW/nOVRCEnxBgOyqpLkwA==";
        };
        _L3h4eTTW = {
            "id" = "L3h4eTTW";
            "file" = "journeymap-webmap-fabric-26.1.2-1.0.12.jar";
            "hash" = "sha512-a1eCInkaTq4RK66oJGQcn4sbWptJbLwfCORprJl+tQgOec6GhWvkzy5vWI/sVy1NkqwGOr59x5copMXLH29cug==";
        };
        _lStjJsCY = {
            "id" = "lStjJsCY";
            "file" = "journeymap-webmap-neoforge-26.1.2-1.0.12.jar";
            "hash" = "sha512-iyWQLnXU4REkQvg7kslTvWRltU9ilCSe4UAdE6GtOT+DLXat9S8r8xh1N21UhyIJHOqaNmYh+8RxZMfvVsGn/g==";
        };
        _vf5VmlQP = {
            "id" = "vf5VmlQP";
            "file" = "journeymap-webmap-fabric-1.21.4-1.0.11.jar";
            "hash" = "sha512-XiyKheMacbYljofv3ITiRSWDAFLvmnbzREL7I612kiyLwrDUTgO3rh21aqD+CJQni8iVYYDQjBq7mmufR1Za1g==";
        };
        _BMz3MZAu = {
            "id" = "BMz3MZAu";
            "file" = "journeymap-webmap-forge-1.21.4-1.0.11.jar";
            "hash" = "sha512-xqo4cYPteYIj00O93giblPfm4KFDM/aah7AQqNoBS2C5hcsAZt1cvYbnddFsPrJSjPshHssnkzyQdIlu46sHeA==";
        };
        _Z3sPsjp0 = {
            "id" = "Z3sPsjp0";
    ...
    in {
        ...
        "forge-1.21.4" = _BMz3MZAu;
        "forge-1.21.5" = _BMz3MZAu;
        "forge-1.21.6" = _mIB7SN7F;
        "forge-1.21.7" = _mIB7SN7F;
        "forge-1.21.8" = _BMz3MZAu;
        ...
        "fabric-1.21.4" = _vf5VmlQP;
        "fabric-1.21.5" = _vf5VmlQP;
        "fabric-1.21.6" = _pCH0EoPl;
        "fabric-1.21.7" = _pCH0EoPl;
        "fabric-1.21.8" = _vf5VmlQP;
        ...
        "quilt-1.21.4" = _vf5VmlQP;
        "quilt-1.21.5" = _vf5VmlQP;
        "quilt-1.21.6" = _pCH0EoPl;
        "quilt-1.21.7" = _pCH0EoPl;
        "quilt-1.21.8" = _vf5VmlQP;
        ...
        "neoforge-1.21.4" = _Z3sPsjp0;
        "neoforge-1.21.5" = _Z3sPsjp0;
        "neoforge-1.21.6" = _cReQ0ibz;
        "neoforge-1.21.7" = _cReQ0ibz;
        "neoforge-1.21.8" = _Z3sPsjp0;
        ...
        "pkg-26.2-1.0.13-forge" = _W9us4eEH;
        "pkg-26.2-1.0.13+fabric" = _mnuK4oU1;
        "pkg-26.2-1.0.13-neoforge" = _NGEsRulh;
        "pkg-26.1.2-1.0.12-forge" = _y8IkoA5v;
        "pkg-26.1.2-1.0.12+fabric" = _L3h4eTTW;
        "pkg-26.1.2-1.0.12-neoforge" = _lStjJsCY;
