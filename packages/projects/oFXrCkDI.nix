...
let
    versions = (let
        ...
        _7Ip7zyIX = {
            "id" = "7Ip7zyIX";
            "file" = "commoncapabilities-1.21.1-neoforge-2.11.5-373.jar";
            "hash" = "sha512-bVD7j1uPug8hLKRXvjN5EOj75DQYILGh5Ou7+qCCYYZIF+r7dM4Xq8WV9b5gUUsRimZnwpBAPyam+QnTlutKEQ==";
        };
        _gtnOFF5Z = {
            "id" = "gtnOFF5Z";
            "file" = "commoncapabilities-26.1.2-neoforge-2.11.8-374.jar";
            "hash" = "sha512-i2wfjZ0WS4FCNt8CeF9WIPU/Y3jR4jjzQ5EouotO2cYp60I2WAIY0C+2TyPAEqaehczEU1HxBkyx7o0epToz0A==";
        };
        _JRpGAgAB = {
            "id" = "JRpGAgAB";
            "file" = "commoncapabilities-26.1.2-neoforge-2.11.8-377.jar";
            "hash" = "sha512-4W4dGc8JdiHIVQD1zlwcrsPeJaab5jwXpYFUxWV1FMEzzKu4wvfbwT7elVwejPInfVQehIqdRAB5Cr4NIqfuDA==";
        };
        _PcKeit3e = {
            "id" = "PcKeit3e";
            "file" = "commoncapabilities-26.2-neoforge-2.11.8-378.jar";
            "hash" = "sha512-lQDYtYX7VqnNaGfm1VOfAQTXLDEbtNdN3bHa0EhGcBWokpkwJgl1i+BC87hbrmvM6ybA8a6EDsCmQioBMpVKiA==";
        };
        _R9PufPlP = {
            "id" = "R9PufPlP";
    ...
    in {
        ...
        "pkg-1.19.2-2.8.3" = _uhsnTaAv;
        "pkg-1.19.3-2.8.3" = _1r9lxV2S;
        "pkg-1.18.2-2.9.0" = _3NCIYMcJ;
        "pkg-1.19.2-2.9.0" = _UVesU3yH;
        "pkg-1.19.3-2.9.0" = _zHgVyu21;
        "pkg-1.19.4-2.9.0" = _DFiC5kjb;
        "pkg-1.20.1-2.9.0" = _9Zr5BG0H;
        "pkg-1.18.2-2.9.1" = _1NcPejMt;
        "pkg-1.19.2-2.9.1" = _cui1KJ1a;
        "pkg-1.20.1-2.9.1" = _BTl7Q7EH;
        "pkg-1.20.4-2.9.1" = _VUKtGxmE;
        "pkg-1.21-2.9.1" = _D3A0AQsd;
        "pkg-1.19.2-2.9.2" = _a7pNMKNx;
        "pkg-1.20.1-2.9.2" = _bC7illSS;
        "pkg-1.21-2.9.2" = _AimwbX9h;
        "pkg-1.21.1-2.9.3" = _IrFVKySo;
        "pkg-1.19.2-2.9.3" = _gLDRWNLn;
        "pkg-1.20.1-2.9.3" = _Dd40mSpD;
        "pkg-1.21.1-2.9.4" = _2ER7uZZz;
        "pkg-1.20.4-2.9.2" = _z2WKyDOa;
        "pkg-1.21.1-2.9.5" = _l7yPeyAd;
        "pkg-1.21.1-2.9.6" = _BOV1zQxF;
        "pkg-1.19.2-2.9.4" = _HtvdyHBh;
        "pkg-1.20.1-2.9.4" = _VV1mGB3A;
        "pkg-1.21.1-2.9.7" = _5sGYh0KZ;
        "pkg-1.21.1-2.9.7-180" = _yIjojhal;
        "pkg-1.21.1-2.9.7-183" = _u8O0iRwv;
        "pkg-1.21.1-2.9.7-185" = _8hKlfvl4;
        "pkg-1.21.1-2.9.7-188" = _CfR0gl4C;
        "pkg-1.21.1-2.9.7-190" = _OCx40whD;
        "pkg-1.21.1-2.9.7-192" = _bE4k1Pt9;
        "pkg-1.21.4-2.9.7-194" = _gK3StgRW;
        "pkg-1.21.1-2.9.7-195" = _R7c7ds8z;
        "pkg-1.21.1-2.9.7-197" = _PgA7TZDd;
        "pkg-1.21.4-2.9.7-199" = _G67aegHh;
        "pkg-1.21.4-2.9.7-200" = _mwctzMfk;
        "pkg-1.21.1-2.9.7-201" = _RqUZ21Ae;
        "pkg-1.21.1-2.9.7-202" = _MSGg1Cky;
        "pkg-1.21.1-2.9.7-203" = _oFWljak4;
        "pkg-1.21.1-2.9.7-204" = _Ks9Yen7F;
        "pkg-1.21.1-2.9.7-205" = _rspAhadZ;
        "pkg-1.21.1-2.9.7-206" = _h699hK7I;
        "pkg-1.21.1-2.9.8" = _YiB2uq5A;
        "pkg-1.21.4-2.9.7-209" = _MVj0RtcP;
        "pkg-1.21.1-2.9.8-212" = _1F3nYTx0;
        "pkg-1.21.4-2.9.7-214" = _lIb48jYz;
        "pkg-1.19.2-2.9.5" = _gvuvbnEU;
        "pkg-1.20.1-2.9.5" = _r987wee7;
        "pkg-1.21.1-2.9.9" = _LMLYBtX7;
        "pkg-1.21.4-2.9.7-221" = _696UALa1;
        "pkg-1.21.1-2.9.9-222" = _IO7fxT8k;
        "pkg-1.21.4-2.9.7-225" = _Wss6F3YK;
        "pkg-1.20.1-2.9.6" = _ZJXsVWV8;
        "pkg-1.21.1-2.9.10" = _d2XPbFnu;
        "pkg-1.19.2-2.9.6" = _PyCG4nw7;
        "pkg-1.20.1-2.9.7" = _E75T4otR;
        "pkg-1.21.1-2.9.11" = _4zTSizdu;
        "pkg-1.21.4-2.9.7-237" = _ONmHonRx;
        "pkg-1.21.4-2.9.7-238" = _QeytZt0z;
        "pkg-1.21.6-2.9.7-239" = _Mj3lzRhF;
        "pkg-1.21.6-2.9.7-240" = _GJHDLY0V;
        "pkg-1.21.7-2.9.7-241" = _sZJnWxhd;
        "pkg-1.21.7-2.9.7-242" = _mQ7SBYJA;
        "pkg-1.21.1-2.9.11-244" = _5avLLgSs;
        "pkg-1.21.7-2.9.7-246" = _RDS44dhE;
        "pkg-1.21.7-2.9.7-247" = _vlJKHY8c;
        "pkg-1.21.7-2.9.7-248" = _ZiojoRLA;
        "pkg-1.21.1-2.9.11-249" = _7V6R9HYx;
        "pkg-1.21.1-2.9.11-250" = _ePumeeRR;
        "pkg-1.21.8-2.9.7-251" = _deW8xxCT;
        "pkg-1.21.1-2.9.11-252" = _7bT3iNF7;
        "pkg-1.21.1-2.9.11-253" = _CGctPmMi;
        "pkg-1.19.2-2.9.7" = _kCgwp7ya;
        "pkg-1.20.1-2.9.8" = _VCeEHukR;
        "pkg-1.21.1-2.9.12" = _uzBfy2VJ;
        "pkg-1.21.8-2.9.7-260" = _Kfal2EjS;
        "pkg-1.21.1-2.9.12-262" = _pzIEyZ1W;
        "pkg-1.21.1-2.9.12-263" = _kjISQ8mN;
        "pkg-1.21.1-2.10.0" = _k0AgqlOE;
        "pkg-1.21.8-2.9.7-268" = _6L1ScU7i;
        "pkg-1.20.1-2.9.10" = _2GHXyvu1;
        "pkg-1.21.1-2.10.1" = _PqoS7HQx;
        "pkg-1.21.8-2.9.7-276" = _iVeUPzOy;
        "pkg-1.21.1-2.10.1-277" = _DTO4AxMN;
        "pkg-1.21.1-2.11.0" = _dLgn18Zy;
        "pkg-1.21.8-2.9.7-280" = _j2eRSaMd;
        "pkg-1.21.1-2.11.1" = _dOXgvboF;
        "pkg-1.21.8-2.9.7-283" = _VIYzQGfV;
        "pkg-1.21.8-2.9.7-284" = _lW6dvuQP;
        "pkg-1.21.1-2.11.1-286" = _9nnMGTF7;
        "pkg-1.21.8-2.9.7-287" = _j9GfbKqr;
        "pkg-1.20.1-2.9.11" = _xyk3SeaC;
        "pkg-1.21.1-2.11.2" = _7nc53CyU;
        "pkg-1.21.8-2.9.7-295" = _MMlNDBHO;
        "pkg-1.21.1-2.11.2-296" = _EzHVo7gn;
        "pkg-1.21.8-2.9.7-297" = _XolmPciK;
        "pkg-1.21.10-2.9.7-298" = _WWMCJLY0;
        "pkg-1.21.10-2.9.7-299" = _Kf3nFL5n;
        "pkg-1.21.10-2.9.7-300" = _QXNZxTKo;
        "pkg-1.21.10-2.9.7-301" = _KXRNleRP;
        "pkg-1.21.11-2.9.7-303" = _8TmQEVLN;
        "pkg-1.21.1-2.11.3" = _P75t9bZb;
        "pkg-1.21.11-2.9.7-306" = _actTUXp8;
        "pkg-1.21.11-2.9.7-307" = _KjCHR6zQ;
        "pkg-1.21.1-2.11.3-315" = _nRdYT4Ey;
        "pkg-1.21.1-2.11.3-316" = _RH4iqnvg;
        "pkg-1.21.1-2.11.3-319" = _EHayh2rN;
        "pkg-1.21.11-2.9.7-320" = _CBHuMJ5P;
        "pkg-1.21.1-2.11.3-321" = _riJdll8c;
        "pkg-1.21.1-2.11.3-322" = _vz7UtwQa;
        "pkg-1.21.1-2.11.3-324" = _tLaYpeh9;
        "pkg-1.21.11-2.9.7-325" = _tbJPYA08;
        "pkg-1.21.1-2.11.3-326" = _3paJA1um;
        "pkg-1.21.11-2.9.7-327" = _pLdI5BWn;
        "pkg-1.21.1-2.11.4" = _xo2tSIkk;
        "pkg-1.21.11-2.9.7-330" = _Oj4Ppnix;
        "pkg-1.21.11-2.9.7-331" = _FUjBfgN2;
        "pkg-26.1.1-2.9.7-333" = _mwg7jQJF;
        "pkg-26.1.1-2.9.7-334" = _E8FGfsQ4;
        "pkg-26.1.1-2.9.7-335" = _wQHfmbLU;
        "pkg-26.1.1-2.9.7-336" = _eZ2MjW1F;
        "pkg-26.1.1-2.9.7-337" = _BeoCyCkL;
        "pkg-26.1.1-2.11.4-338" = _66SqzHdy;
        "pkg-26.1.1-2.11.4" = _fgDoWs8y;
        "pkg-26.1.2-2.11.4" = _62GUQilG;
        "pkg-26.1.2-2.11.5" = _Bp9KzdGp;
        "pkg-26.1.2-2.11.6" = _XdGZPPrp;
        "pkg-26.1.2-2.11.7" = _p0jGXLIh;
        "pkg-26.1.2-2.11.7-352" = _VhgcOz5h;
        "pkg-26.1.2-2.11.8" = _7MhV0z4z;
        "pkg-1.21.1-2.11.5" = _c50bCinZ;
        "pkg-26.2-2.11.8-360" = _wDUrztBr;
        "pkg-26.2-2.11.8-361" = _GaN5cbmw;
        ...
        "pkg-1.21.1-2.11.5-373" = _7Ip7zyIX;
        "pkg-26.1.2-2.11.8-374" = _gtnOFF5Z;
