...
let
    versions = (let
        ...
        _W3Sl70R6 = {
            "id" = "W3Sl70R6";
            "file" = "EventUtils-1.20.4-3.1.0.jar";
            "hash" = "sha512-9sDbUFlCIdrrktKs3co871PfWQkKPLPRLvubvfOJCT6NphnSNQNwz+v3jOk8eY5elMcxWDv9ucnMjiUxsME9ww==";
        };
        _9n4e2e5R = {
            "id" = "9n4e2e5R";
            "file" = "EventUtils-1.21.1-3.1.0.jar";
            "hash" = "sha512-ez7dPm7udO0lmUZ6fjOnuLIcLPmbsiFs0vADsRuOYlyfaPZkXNAaBax6zL30hbBaqnsjDI4SgdgID9BJTG4+lQ==";
        };
        _yp4oN27f = {
            "id" = "yp4oN27f";
            "file" = "EventUtils-1.21-3.1.0.jar";
            "hash" = "sha512-1db5pG/cgwkhO5ugiR+A8XPpT3komNGH9zZCHYp6Rl00qKFznyI189/jiMUbHsu2MRkUIL68jjAKPB+Oe3A9fA==";
        };
        _HEwpTTTQ = {
            "id" = "HEwpTTTQ";
            "file" = "EventUtils-1.21.11-3.1.0.jar";
            "hash" = "sha512-ID2PD8Bwvpfo1rcNn8/l1+FNcyBB2H/r8ykX39bLCN4wyfo5VfzYYXztB/kE67yTxYSfxQKEpNDBE6ylMj3dOw==";
        };
        _6JVI2y1j = {
            "id" = "6JVI2y1j";
            "file" = "EventUtils-1.21.4-3.1.0.jar";
            "hash" = "sha512-/V9PLEX2UxidIZN05QmErFQ3hFL7F+HzQ4w0QRZlG6kVsdOLRfR7AIpEaCgeNEViRqoZXYO0rzDsV3NBt2qedg==";
        };
        _wB2ZO7J4 = {
            "id" = "wB2ZO7J4";
            "file" = "EventUtils-1.21.5-3.1.0.jar";
            "hash" = "sha512-MMB3ry7zYY0SWK3naCRJNpK8HknW8YRzIpIisIgW+u/YBcQ0qdlQDXB6fhBi8GARiMx8svqe88lx/h/XF7AFUQ==";
        };
        _IgQALWHA = {
            "id" = "IgQALWHA";
            "file" = "EventUtils-1.21.6-3.1.0.jar";
            "hash" = "sha512-7Km3egaVqG2YdqfQT2Oe+QbDFskQzGzEB5okQeL15+/NXIsm3mVWkA7mQrvTbFf/wd3l4SaoXVMMlzrbO5rZSg==";
        };
        _B45TEqeo = {
            "id" = "B45TEqeo";
            "file" = "EventUtils-26.1.2-3.1.0.jar";
            "hash" = "sha512-2F7DZUvtnbWeuXyROiSn4AXGk+3gxOD857/PfJrqHrvKo9uEnE/TvmvV0Hftd0ayil5JL/QrzXGnKOPLD7EJnA==";
        };
        _NL6h49zT = {
            "id" = "NL6h49zT";
            "file" = "EventUtils-26.2-3.1.0.jar";
            "hash" = "sha512-aiynvAQpGq8qx+FGyXzpBj9EC7KGMx72rIMMC2reXJ96IEb38kT6AfqZFXt0zW8bsBJp/Toi9yFUOYc2HW6vHQ==";
        };
    in {
        "3aNiMFd6" = _3aNiMFd6;
        "PWoOFX7q" = _PWoOFX7q;
        ...
        "fabric-1.20.4" = _W3Sl70R6;
        "fabric-1.20.2" = _sl99b494;
        "fabric-1.20.1" = _64wCW3Kx;
        "fabric-1.21" = _yp4oN27f;
        "fabric-1.21.1" = _9n4e2e5R;
        "fabric-1.21.3" = _IGfFheQA;
        "fabric-1.21.2" = _9tuwMXTR;
        "fabric-1.21.4" = _6JVI2y1j;
        "fabric-1.21.5" = _wB2ZO7J4;
        "fabric-1.21.6" = _IgQALWHA;
        "fabric-1.21.11" = _HEwpTTTQ;
        "fabric-26.1.2" = _B45TEqeo;
        "fabric-26.2" = _NL6h49zT;
        ...
        "pkg-1.20.6-1.0" = _3aNiMFd6;
        "pkg-1.20.4-1.0" = _PWoOFX7q;
        "pkg-1.20.2-1.0" = _uQoysWGZ;
        "pkg-1.20.1-1.0" = _RdmoLY5i;
        "pkg-1.20.6-1.1" = _U9mM4zLI;
        "pkg-1.20.4-1.1" = _DKxS0m7t;
        "pkg-1.20.2-1.1" = _wr6TSYAY;
        "pkg-1.20.1-1.1" = _qAHPyw56;
        "pkg-1.20.6-1.2" = _ZHRVZy3C;
        "pkg-1.20.4-1.2" = _dnsQjHpA;
        "pkg-1.20.2-1.2" = _UNEoE19H;
        "pkg-1.20.1-1.2" = _lwD1sLU1;
        "pkg-1.20.6-1.3" = _dmRywS2N;
        "pkg-1.20.4-1.3" = _Cr8a4Ejp;
        "pkg-1.20.2-1.3" = _TMiE0M5W;
        "pkg-1.20.1-1.3" = _Q2OMmXB2;
        "pkg-1.21-1.4" = _QCiiCDHJ;
        "pkg-1.20.6-1.4" = _Hx6CiXu9;
        "pkg-1.20.4-1.4" = _YIIjEbzI;
        "pkg-1.20.2-1.4" = _zrnpRjJt;
        "pkg-1.20.1-1.4" = _dmCSschQ;
        "pkg-1.21-2.0.0" = _F9Q6QfHx;
        "pkg-1.20.6-2.0.0" = _I33s8dTF;
        "pkg-1.20.4-2.0.0" = _Qy4SuIGY;
        "pkg-1.20.2-2.0.0" = _dRnFXQBI;
        "pkg-1.20.1-2.0.0" = _mqeOuWIa;
        "pkg-1.21-2.0.1" = _uX6Xn1Nd;
        "pkg-1.20.6-2.0.1" = _tAulsU6w;
        "pkg-1.20.4-2.0.1" = _Zjio1wVH;
        "pkg-1.20.2-2.0.1" = _NqXzMqMO;
        "pkg-1.20.1-2.0.1" = _ETwsVIZZ;
        "pkg-1.20.2-2.0.2" = _3yK0Vmx0;
        "pkg-1.20.3-2.0.2" = _oXxWjN3Y;
        "pkg-1.21-2.0.2" = _8RsDv4EH;
        "pkg-1.20.5-2.0.2" = _pLtEBe1d;
        "pkg-1.20.1-2.0.2" = _vO7YwoLt;
        "pkg-1.20.6-2.0.2" = _uf8vwUm7;
        "pkg-1.21.1-2.0.2" = _yuwJ0v5B;
        "pkg-1.20.4-2.0.2" = _pr8eGG1l;
        "pkg-1.20.4-2.0.3" = _nlOmsQuh;
        "pkg-1.20.6-2.0.3" = _S8NkdnLE;
        "pkg-1.20.3-2.0.3" = _3kvb9W5v;
        "pkg-1.21-2.0.3" = _pdiGkJh8;
        "pkg-1.21.1-2.0.3" = _6XFfz3P6;
        "pkg-1.20.5-2.0.3" = _QOoO7JQq;
        "pkg-1.20.1-2.0.3" = _lJkKnV5m;
        "pkg-1.20.2-2.0.3" = _aGf7kJxt;
        "pkg-1.20.2-2.0.4" = _7Lcg8bL7;
        "pkg-1.20.3-2.0.4" = _ZfX3qAqh;
        "pkg-1.21.1-2.0.4" = _bLXsD1aU;
        "pkg-1.21-2.0.4" = _e4EPp0xp;
        "pkg-1.20.4-2.0.4" = _3U5EuWEV;
        "pkg-1.20.1-2.0.4" = _8Kj7jTKB;
        "pkg-1.20.6-2.0.4" = _bpzOpMl7;
        "pkg-1.20.5-2.0.4" = _1PoIANCR;
        "pkg-1.20.6-2.0.5" = _8ESBrdpa;
        "pkg-1.20.2-2.0.5" = _dPKMEhwp;
        "pkg-1.20.4-2.0.5" = _1s5epJxl;
        "pkg-1.20.3-2.0.5" = _ko7Mwi1n;
        "pkg-1.20.1-2.0.5" = _PcpsXzAV;
        "pkg-1.21.1-2.0.5" = _GD62emE5;
        "pkg-1.20.5-2.0.5" = _5lkxUINk;
        "pkg-1.21-2.0.5" = _wieiPhcc;
        "pkg-1.20.1-2.0.6" = _t7XDBqRA;
        "pkg-1.21-2.0.6" = _aDCBJeN1;
        "pkg-1.20.4-2.0.6" = _ii9TWChU;
        "pkg-1.20.2-2.0.6" = _2uzvMFQ9;
        "pkg-1.20.6-2.0.6" = _TlcLeKDe;
        "pkg-1.21.1-2.0.6" = _isYVbhHc;
        "pkg-1.20.5-2.0.6" = _Z1EBapbE;
        "pkg-1.20.3-2.0.6" = _Xjx0Tk0N;
        "pkg-1.21.3-2.0.6" = _EhsZEcLy;
        "pkg-1.20.6-2.0.7" = _GF6ZrU1U;
        "pkg-1.21.2-2.0.7" = _9tuwMXTR;
        "pkg-1.21.3-2.0.7" = _DPV0tDYm;
        "pkg-1.21.1-2.0.7" = _3iwLtmYP;
        "pkg-1.20.5-2.0.7" = _tM56DNkf;
        "pkg-1.20.3-2.0.7" = _O034tmyW;
        "pkg-1.20.4-2.0.7" = _Kf8BCAYG;
        "pkg-1.20.1-2.0.7" = _64wCW3Kx;
        "pkg-1.21-2.0.7" = _4TtFvyqu;
        "pkg-1.20.2-2.0.7" = _sl99b494;
        "pkg-1.20.4-2.1.0" = _QebaSCKu;
        "pkg-1.21.1-2.1.0" = _MUVrQMek;
        "pkg-1.21.3-2.1.0" = _vHwdMcrE;
        "pkg-1.20.6-2.1.0" = _Li3kifSP;
        "pkg-1.21-2.1.0" = _WDLan1Ed;
        "pkg-1.21.4-2.1.0" = _BY0Q54gs;
        "pkg-1.21.4-2.1.1" = _NExIoSiR;
        "pkg-1.20.6-2.1.1" = _SPoN1q5S;
        "pkg-1.20.4-2.1.1" = _4HbbxUwu;
        "pkg-1.21.3-2.1.1" = _7jpSXbdE;
        "pkg-1.21-2.1.1" = _GrvEOUqn;
        "pkg-1.21.1-2.1.1" = _wWvBzuPA;
        "pkg-1.21.3-2.1.2" = _IXSDO46d;
        "pkg-1.20.4-2.1.2" = _WI3zJ7Qy;
        "pkg-1.21-2.1.2" = _Eq8nf0zQ;
        "pkg-1.21.1-2.1.2" = _3GLBnWt3;
        "pkg-1.20.6-2.1.2" = _rewNR0aD;
        "pkg-1.21.4-2.1.2" = _4T3hCTWo;
        "pkg-1.21.1-2.2.0" = _TEivjNvX;
        "pkg-1.20.4-2.2.0" = _ISku6yRy;
        "pkg-1.21.3-2.2.0" = _IGfFheQA;
        "pkg-1.21.4-2.2.0" = _7u2unNuC;
        "pkg-1.20.6-2.2.0" = _Ern0Lj0R;
        "pkg-1.21-2.2.0" = _lAzArJGD;
        "pkg-1.21.1-2.3.0" = _rZ7Uh1y0;
        "pkg-1.20.4-2.3.0" = _XMT7cfhi;
        "pkg-1.21.4-2.3.0" = _yiISJRmw;
        ...
        "pkg-1.20.4-3.1.0" = _W3Sl70R6;
        "pkg-1.21.1-3.1.0" = _9n4e2e5R;
        "pkg-1.21-3.1.0" = _yp4oN27f;
        "pkg-1.21.11-3.1.0" = _HEwpTTTQ;
        "pkg-1.21.4-3.1.0" = _6JVI2y1j;
        "pkg-1.21.5-3.1.0" = _wB2ZO7J4;
        "pkg-1.21.6-3.1.0" = _IgQALWHA;
        "pkg-26.1.2-3.1.0" = _B45TEqeo;
        "pkg-26.2-3.1.0" = _NL6h49zT;
        "default" = _NL6h49zT;
    });
