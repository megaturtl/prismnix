...
let
    ...
    in {
        ...
        "pkg-1.1.18" = _7sMDujih;
        "pkg-1.2.0" = _6mp5KYqE;
        "pkg-1.1.19" = _CR3s1Q9E;
        "pkg-1.2.2" = _Tm7cdAK9;
        "pkg-1.2.5" = _mHc7yjij;
        "pkg-1.2.6" = _pGZM1u27;
        "pkg-1.1.20" = _WoJVEX8A;
        "pkg-1.1.21" = _TnolgSJP;
        "pkg-1.2.7" = _l33ODpNh;
        "pkg-1.1.23" = _RIdAGTWP;
        "pkg-1.3.0" = _we15ILm4;
        "pkg-1.3.1" = _zOnmzwki;
        "pkg-1.1.24" = _mxiPijSw;
        "pkg-1.3.6" = _7wv4Al4f;
        "pkg-2.0.0" = _A1zeEXXD;
        "pkg-2.0.1" = _KX0scagm;
        "pkg-2.0.2" = _DGKrjwc2;
        ...
        "pkg-2.1.8" = _S6iVht7K;
        "pkg-2.1.9" = _lmvJ0Hcp;
        "pkg-2.1.10" = _Km7wGxHM;
        "pkg-2.1.11" = _xeUwwWis;
        "pkg-2.1.12" = _yQuGcqsD;
        "pkg-2.1.13" = _5Ty6o9ND;
        "pkg-2.1.14" = _i07uoZmf;
        "pkg-2.1.15" = _lofPmr0y;
        "pkg-2.1.16" = _Qz28Npy5;
        "pkg-2.2.0" = _SVkB0vWc;
        "pkg-2.2.1" = _wXviWIDs;
        "pkg-2.2.2" = _kxLEneHh;
        "pkg-2.2.3" = _Zg1Jvqa9;
        "pkg-2.2.4" = _jiOlc39u;
        "pkg-2.1.17" = _V4IW7RSL;
        "pkg-2.1.18" = _5coQdKPg;
        "pkg-2.1.19" = _IJBIHU6K;
        "pkg-2.1.20" = _HGTwQLNx;
        "pkg-2.4.0" = _MEf5LEmw;
        "pkg-2.4.1" = _IfRjDUur;
        "pkg-2.4.2" = _WTX24M1H;
        "pkg-2.4.3" = _FbFPK02O;
        ...
        "pkg-2.4.5" = _jm9L6kBc;
        "pkg-2.4.6" = _fW68amEN;
        "pkg-2.1.21" = _81wSAkrn;
        "pkg-2.4.7" = _oRyi7tka;
        "pkg-2.1.22" = _D1moud7k;
        "pkg-2.1.23" = _YzWNEutS;
        "pkg-2.4.8" = _niLlHvaI;
        "pkg-2.4.9" = _y7uh90sp;
        "pkg-2.4.10" = _TiIWVg2u;
        "pkg-2.1.24" = _eHrhVCDK;
        "pkg-2.5.0" = _91NsF6Ir;
        "pkg-2.5.1" = _We1iSqwr;
        "pkg-2.5.2" = _RtESsg6c;
        "pkg-2.5.3" = _aohlCfb8;
        ...
        "pkg-3.0.8" = _QCSb1H9Q;
        "pkg-3.0.9" = _agK8ADLZ;
        "pkg-2.1.26" = _GVoDzGSq;
        "pkg-2.1.27" = _dwRK3K0w;
        "pkg-2.1.28" = _4u04iwUx;
        "pkg-2.1.29" = _UOdaYbhh;
        "pkg-3.0.10" = _Qq8o6KAr;
        "pkg-3.0.11" = _qhDtAMev;
        "pkg-3.3.0" = _cNrxeITc;
        "pkg-3.0.12" = _Hf91FuVF;
        "pkg-3.3.1" = _HFDOJCpf;
        "pkg-3.4.0" = _LKjjsSwT;
        "pkg-3.4.1" = _ZeU01g12;
        "pkg-3.4.2" = _sTuhbdg5;
