...
let
    ...
    in {
        ...
        "pkg-1.12.1-1.0.2" = _ppFs4T3b;
        "pkg-1.12.1-1.0.3" = _sZY3RLnK;
        "pkg-1.12.1-1.0.4" = _2NH04fqJ;
        "pkg-1.12.1-1.1.0" = _hmEZAlUk;
        "pkg-1.21.1-1.1.1" = _IBlfaCic;
        "pkg-1.21.1-1.1.2" = _7b4g0gk2;
        "pkg-1.21.1-1.1.3" = _dtjWyXGL;
        "pkg-1.21.1-1.1.3-hotfix" = _9diU16mR;
        "pkg-1.21.1-1.1.4" = _brZgfxcc;
        "pkg-1.21.1-1.1.5" = _FJDxMH4R;
        "pkg-1.21.1-1.1.6" = _tHAmeQad;
        "pkg-1.21.1-1.1.7" = _g3BKxUOs;
        "pkg-1.21.1-1.2.0" = _hU3h4ZKM;
        "pkg-1.21.1-1.2.1" = _BAkoWDli;
        "pkg-1.21.1-1.2.2" = _PACjizO2;
        "pkg-1.21.1-1.2.4" = _vkuaPLmU;
        "pkg-1.21.1-1.2.5" = _X8Wyy9bd;
        "pkg-1.21.1-1.2.6" = _9D1B2LpH;
        "pkg-1.21.1-1.3" = _H9nsuMMB;
        "pkg-1.21.1-1.3.1" = _avNh5o8c;
        "pkg-1.21.1-1.3.1.1" = _1LyNPjli;
        "pkg-1.21.1-1.3.2" = _Sk8rMEUS;
        "pkg-1.21.1-1.3.3" = _uAf5putU;
        "pkg-1.21.1-1.3.4" = _TZkHh7Sp;
        "pkg-1.21.1-1.3.5" = _DEB87xSi;
        "pkg-1.21.1-1.3.6" = _ZF3gussa;
        "pkg-1.21.1-1.4" = _IIHBONuU;
        "pkg-1.21.1-1.4.1" = _IVIVePjz;
        "pkg-1.21.1-1.4.2" = _mVfuirS9;
        "pkg-1.21.1-1.4.3" = _vgWkEqoC;
        "pkg-1.21.1-1.4.4" = _9btIGBzH;
        "pkg-1.21.1-1.4.5" = _y231dAhU;
        "pkg-1.21.1-2.0" = _BN8fWKP0;
        "pkg-1.21.1-2.0-hotfix2" = _6dhsuXDi;
        "pkg-1.21.1-2.0.1" = _mLzKMnZz;
