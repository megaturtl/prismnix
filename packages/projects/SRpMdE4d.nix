...
let
    versions = (let
        ...
        _NBqFGNNb = {
            "id" = "NBqFGNNb";
            "file" = "dungeontrain-0.811.0.jar";
            "hash" = "sha512-QqwrII2HbwTagX7Ud6zPsTzlrkKY2WTrji5i7Lws3g6+M33AroP3vFvNW0BRRQfbXGIwC7zf4H5GeLlAi9DMiA==";
        };
        _5YSKqpNi = {
            "id" = "5YSKqpNi";
            "file" = "dungeontrain-0.813.0.jar";
            "hash" = "sha512-ZO2HBJwalkNjX1o9p6SuqpwaSKthNStuCfARTv5k7UEQuHbWX6XQ0/LROelAkMMlZ75Y7mnjQHFX1sy1W+nW0g==";
        };
        _mkWVzGDi = {
            "id" = "mkWVzGDi";
            "file" = "dungeontrain-0.823.0.jar";
            "hash" = "sha512-uqb/lih+hnkLpodMiseyNX/lWzoOKbBofk9BJ/Q3Dpl1wRNPzgQVUEHYIViS6IuIOguFgsg0w6LrHWjXMLLSlA==";
        };
        _QZTnLuBY = {
            "id" = "QZTnLuBY";
            "file" = "dungeontrain-0.824.0.jar";
            "hash" = "sha512-1vlcxcoTceeXab6wP9Le4KuFca3zsP2mWFcU8HgiyJ6WrpfpxOUbHXkT0y0I6/vku9dCvF0EK7v8eCZPHgrnPw==";
        };
        _fez8iPLC = {
            "id" = "fez8iPLC";
            "file" = "dungeontrain-0.828.0.jar";
            "hash" = "sha512-l2xjIfX/0uAI0qmsqeJyDB6AvdPBzksO1WG+Dwhrr5jL/t4zTSgiiKF/WR6+fe9T2OfoiZ0CUNOmmsuexY63XA==";
        };
        _WvrDgInj = {
            "id" = "WvrDgInj";
            "file" = "dungeontrain-0.843.0.jar";
            "hash" = "sha512-YxkyamUskNZudm0ch2ZT5aCcm/O12+rNIE6LYT7YZPvA6PKg2sc+wwP4d9IdNLO49Ii7nNCJ69PWzQ1i2zKwQw==";
        };
        _d7kBt5No = {
            "id" = "d7kBt5No";
            "file" = "dungeontrain-0.849.0.jar";
            "hash" = "sha512-ex61+o1qaJYESxaMqn9VrSxsLJFxEefaRI8RmhndvhfeYJBFs//AqlOUB7WjkTMZ5B9o8fqCMsrZYi04WMCgEw==";
        };
        _JmCsWzVH = {
            "id" = "JmCsWzVH";
            "file" = "dungeontrain-0.854.0.jar";
            "hash" = "sha512-C6txns84rsqPd1nhb4dvMB7Jlqseb2UUEc52hkhScSDZQqdd/3hfxkztA/6JKYvv8gqngtjbFeSZ7h5ydsYWtg==";
        };
        _VmxqYbiY = {
            "id" = "VmxqYbiY";
            "file" = "dungeontrain-0.861.0.jar";
            "hash" = "sha512-HdSvRFA8VVXiIAfc3QUImlqKmMqNwHCghrSNhqi3qLrVWTg6U8jo8YRUnnoX0tXNoptK1MQFvXR7BrmAVWYzqA==";
        };
        _dwS0n84o = {
            "id" = "dwS0n84o";
            "file" = "dungeontrain-0.875.0.jar";
            "hash" = "sha512-WYTG0lg19MY/2xUU0YCc681MKT9qM9zEiNA8f8p9EeLtsyltwGI+0btHOhejN26xecpO9fjzPwV6cUcd45rc7g==";
        };
        _tTBRRhEa = {
            "id" = "tTBRRhEa";
            "file" = "dungeontrain-0.878.0.jar";
            "hash" = "sha512-gyigTCFGuab/3FJ9quIIos8E6vdOfRlraObh9xSWCFgiEaG65uEoiT+Sb96bJYYn93CUaguJ56dpXfaKCQKdtw==";
        };
        _Zphz9Q3q = {
            "id" = "Zphz9Q3q";
            "file" = "dungeontrain-0.884.0.jar";
            "hash" = "sha512-df/9Y5MPPHLWWkRlLw1l4fBa/YQ9Kff3V3WUHiLwoXmVnAD9PkZwn/k1Ee+Su/y4OKI/mBPY4DAsj4xEWJ8nnQ==";
        };
        _9cgO2ztD = {
            "id" = "9cgO2ztD";
            "file" = "dungeontrain-0.885.0.jar";
            "hash" = "sha512-88luIoO1pYb95vYS0n52/DhtcoXTx4VuASe4nzGobWT8wx0I/MKQ4m4UuCCnfBQp4Yu5Ocwi0dnQ3IaDGeRxFA==";
        };
        _2o4NyfWX = {
            "id" = "2o4NyfWX";
            "file" = "dungeontrain-0.887.0.jar";
            "hash" = "sha512-RpZwCBiIej3rKPpZuEk6aH2T/OE8oW/QWmhga9NXPKH6Y4EUxpg6FqG74gR46MQqdloY2MtVhFJTL+ULUcCDfA==";
        };
        _n1gSMeON = {
            "id" = "n1gSMeON";
            "file" = "dungeontrain-0.888.0.jar";
            "hash" = "sha512-AS7oJYwwiWKYv6wu9/j/vnPeo46ozGNkJ0uBXhis/LgDggYlp++3StgjbDHIGv/O0fsCCtqXnryp+/sjmMgMvw==";
        };
        _UZLN2Tz6 = {
            "id" = "UZLN2Tz6";
            "file" = "dungeontrain-0.890.0.jar";
            "hash" = "sha512-YBCu+ehIPm48xxQF7kCjo8RTbY6XxhRA/Hvx50ll94Hq6IGRYrzT87DvRwKinaj1d/zqiiOAeZnHvKXnTTj/FA==";
        };
        _xaFazwau = {
            "id" = "xaFazwau";
            "file" = "dungeontrain-0.893.0.jar";
            "hash" = "sha512-ZRt6CtPo44/UGbKowI+mBDPc0N66dvwh0E1fXDOcqAV0klf3PkCJLqKbVuehg3Wqi/y9XZ5LuOB9+K3L0xiCxA==";
        };
        _zQiubw3a = {
            "id" = "zQiubw3a";
            "file" = "dungeontrain-0.894.0.jar";
            "hash" = "sha512-62D7v9jJtbH889YC8lFP4Yr9QvfLByVQ/kr6paqfHSyR0UnSebVkuKUN8R1y54ehgcdh7VNEqhPyAkxy+p4bkQ==";
        };
        _sydYETAu = {
            "id" = "sydYETAu";
            "file" = "dungeontrain-0.895.0.jar";
            "hash" = "sha512-qkIezDaAPg1Jchnx18T+1Li0DXdYxP4Xr3ElLDDQZkOCGEkIvMOSViCc1u3XpnUIOMMMRh8ONMTyxzkibmjPDA==";
        };
        _IO3QkXiH = {
            "id" = "IO3QkXiH";
            "file" = "dungeontrain-0.898.0.jar";
            "hash" = "sha512-8sdoW7SejyRsd62vTd6KeBEek4eI/uNtvyWgMyD/AjGCeby/6ZN5trtweXEuLhyLt6fhgqDb5BvVllWAL+sRZw==";
        };
        _jKra1k73 = {
            "id" = "jKra1k73";
            "file" = "dungeontrain-0.900.0.jar";
            "hash" = "sha512-IYgAr0lKsfqoB6tisf21e5Jo8tbVT3WNTnLqYgGk5esfmc6Z9O/fFZwroe6G64MxsLuUzhiLurZ8D3pYFxDiSw==";
        };
        _PLyfnvjH = {
            "id" = "PLyfnvjH";
            "file" = "dungeontrain-0.902.0.jar";
            "hash" = "sha512-nkdEX278hnrCSfOAZ7s6g0BDlVlQ7pP+xclzwiDq1FheF/bhsqr5icMjzpyd3k119T9uoPNLdPFEsrjpa9+tGQ==";
        };
        _OrutqD3I = {
            "id" = "OrutqD3I";
    ...
    in {
        ...
        "pkg-v0.74.0" = _IjWUzKeo;
        "pkg-v0.80.0" = _FjnNkM0d;
        "pkg-v0.81.0" = _gf1Z1Nna;
        "pkg-v0.95.0" = _jszUpR98;
        "pkg-v0.96.0" = _VQKqYcwK;
        "pkg-v0.97.0" = _pZvss3BB;
        "pkg-v0.102.0" = _hnfzQYak;
        "pkg-v0.117.0" = _fh2tRR2S;
        "pkg-v0.122.0" = _zMD3vFFM;
        "pkg-v0.123.0" = _u8WMgrtX;
        "pkg-v0.124.0" = _jmTbSooC;
        "pkg-v0.126.0" = _CCGELERh;
        "pkg-v0.141.0" = _FXIje5Bo;
        "pkg-v0.144.0" = _xiJEGNVb;
        "pkg-v0.145.0" = _54nXtq1w;
        "pkg-v0.147.0" = _6VdSlrjq;
        "pkg-v0.148.0" = _gMqw4Xsj;
        "pkg-v0.149.0" = _duUEiZ0z;
        "pkg-v0.150.0" = _aMFvWoUl;
        "pkg-v0.151.0" = _whoQSfMH;
        "pkg-v0.153.0" = _wPmz6Iql;
        "pkg-v0.156.0" = _xNPDVkMy;
        "pkg-v0.157.0" = _Fxfod1xH;
        "pkg-v0.158.0" = _UftjFhZ8;
        "pkg-v0.159.0" = _crMnTO2y;
        "pkg-v0.160.0" = _1PyA8cd7;
        "pkg-v0.161.0" = _UIuCEBk3;
        "pkg-v0.162.0" = _IAyhuO15;
        "pkg-v0.163.0" = _rspgTRZe;
        "pkg-v0.164.0" = _JnJx4Pfe;
        "pkg-v0.165.0" = _eBfsaH35;
        "pkg-v0.166.0" = _uArcjtAh;
        "pkg-v0.167.0" = _ePhmOwe4;
        "pkg-v0.168.0" = _z2YLFkBX;
        "pkg-v0.172.0" = _PihVm9ET;
        "pkg-v0.173.0" = _n4POYbDQ;
        "pkg-v0.174.0" = _Gaz4EZMY;
        "pkg-v0.175.0" = _PGiWPvKL;
        "pkg-v0.176.0" = _3GbRy43l;
        "pkg-v0.177.0" = _rLq6eCa1;
        "pkg-v0.178.0" = _4OjFbfF1;
        "pkg-v0.180.0" = _QVM4X5g9;
        "pkg-v0.181.0" = _w5HCinrM;
        "pkg-v0.182.0" = _bsQr3SkL;
        "pkg-v0.183.0" = _XVsBvdVY;
        "pkg-v0.184.0" = _728Sa2SN;
        "pkg-v0.185.0" = _7RWi25sd;
        "pkg-v0.186.0" = _oCXC91ca;
        "pkg-v0.187.0" = _XSYoHPJK;
        "pkg-v0.188.0" = _l1AP8Vz5;
        "pkg-v0.189.0" = _V6WuYhoi;
        "pkg-v0.190.0" = _JWTwcemA;
        "pkg-v0.191.0" = _BeHgQEgF;
        "pkg-v0.192.0" = _Me4XIoks;
        "pkg-v0.193.0" = _74klpSTe;
        "pkg-v0.194.0" = _TbADyKy9;
        "pkg-v0.194.1" = _R9Z7DAkJ;
        "pkg-v0.194.2" = _lOd9DFO0;
        "pkg-v0.195.0" = _eZVtTqvV;
        "pkg-v0.195.1" = _LBEXmDoK;
        "pkg-v0.196.0" = _7HTX65JB;
        "pkg-v0.197.0" = _3E9jplm3;
        "pkg-v0.199.1" = _L7LDMOLm;
        "pkg-v0.201.0" = _VFgfcDlQ;
        "pkg-v0.201.1" = _6qXY4ScF;
        "pkg-v0.201.2" = _JAJGENQo;
        "pkg-v0.201.3" = _UI4KGXuz;
        "pkg-v0.201.4" = _nsrdWzbx;
        "pkg-v0.202.0" = _qo8CCncJ;
        "pkg-v0.203.0" = _upHHAqoQ;
        "pkg-v0.203.1" = _ZOg17wl1;
        "pkg-v0.203.2" = _PzMxFLlr;
        "pkg-v0.204.0" = _Y2PXPI0I;
        "pkg-v0.204.1" = _Loipvezy;
        "pkg-v0.205.0" = _1THobJGb;
        "pkg-v0.206.0" = _joeceTCs;
        "pkg-v0.206.1" = _BKiC7QSm;
        "pkg-v0.206.2" = _ErYzZkCh;
        "pkg-v0.207.0" = _DxuB2eRo;
        "pkg-v0.207.1" = _KAVyw6qP;
        "pkg-v0.208.0" = _d4K5lg4b;
        "pkg-v0.208.1" = _kjIXqxPk;
        "pkg-v0.208.2" = _L55o8mDO;
        "pkg-v0.208.3" = _sM1R3K3L;
        "pkg-v0.208.4" = _y2wEWF2s;
        "pkg-v0.208.5" = _yjyK2Pha;
        "pkg-v0.208.6" = _SNGL1ibi;
        "pkg-v0.208.7" = _qqyxBm0t;
        "pkg-v0.208.8" = _w6nHLeiP;
        "pkg-v0.209.0" = _VuHaAG62;
        "pkg-v0.209.1" = _fHZ2Z1Fv;
        "pkg-v0.211.1" = _eHhz1XkZ;
        "pkg-v0.211.2" = _Erb9BOH7;
        "pkg-v0.211.3" = _o3H1RWXP;
        "pkg-v0.211.4" = _Wvb8LiCP;
        "pkg-v0.212.0" = _pA2E04vy;
        "pkg-v0.212.1" = _VbiywGFn;
        "pkg-v0.212.2" = _HeshTZBL;
        "pkg-v0.212.3" = _Tb7etRBw;
        "pkg-v0.213.0" = _bSMja6w3;
        "pkg-v0.213.1" = _VnNc8thi;
        "pkg-v0.213.2" = _w2xO6WZ7;
        "pkg-v0.213.3" = _Ou1Mm2jH;
        "pkg-v0.213.4" = _XqGjnCNp;
        "pkg-v0.213.5" = _87eHfA05;
        "pkg-v0.213.6" = _ZwLm77r0;
        "pkg-v0.213.7" = _z4mU2rWG;
        "pkg-v0.214.0" = _QJx8kT5A;
        "pkg-v0.214.1" = _ZGmWKxuM;
        "pkg-v0.214.2" = _B8pVPv2Y;
        "pkg-v0.214.3" = _CCg97US3;
        "pkg-v0.214.4" = _t9u0dPNR;
        "pkg-v0.214.5" = _rJLiFBIz;
        "pkg-v0.214.6" = _MiGsSyI3;
        "pkg-v0.216.0" = _n03tIMTB;
        "pkg-v0.216.1" = _egljCqwF;
        "pkg-v0.217.0" = _Vifym3oj;
        "pkg-v0.217.1" = _MtmkdGdH;
        "pkg-v0.218.0" = _CkH6yCjS;
        "pkg-v0.219.0" = _zwomuVAr;
        "pkg-v0.220.0" = _7sXdBJG4;
        "pkg-v0.221.1" = _sIsIbcZg;
        "pkg-v0.223.1" = _bXJJHhbR;
        "pkg-v0.226.0" = _ZgNeXxfp;
        "pkg-v0.227.0" = _djpoXzGf;
        "pkg-v0.227.1" = _1hHAX1cs;
        "pkg-v0.228.0" = _f4PStafV;
        "pkg-v0.229.0" = _OLMEAz2X;
        "pkg-v0.230.0" = _w6UW9fDj;
        "pkg-v0.230.1" = _FyRMl62Y;
        "pkg-v0.231.0" = _LbuzAKju;
        "pkg-v0.231.1" = _up2E96c4;
        "pkg-v0.231.2" = _V3wB4aoK;
        "pkg-v0.231.3" = _VAItDTHD;
        "pkg-v0.231.4" = _RLeyMwmu;
        "pkg-v0.232.1" = _K0PrpO2n;
        "pkg-v0.233.0" = _Ir30eKAS;
        "pkg-v0.235.1" = _d0jawAwj;
        "pkg-v0.236.0" = _sbR0hLGU;
        "pkg-v0.237.0" = _ilwNDOhM;
        "pkg-v0.239.0" = _50Rdhdiz;
        "pkg-v0.239.1" = _15KujBDM;
        "pkg-v0.240.1" = _f18yYuF5;
        "pkg-v0.241.1" = _DxJUSG5o;
        "pkg-v0.242.0" = _tJM4Tp5v;
        "pkg-v0.242.1" = _Ug2QZMcn;
        "pkg-v0.243.0" = _Z4Crj6rX;
        "pkg-v0.243.1" = _y5hDK8Ew;
        "pkg-v0.243.2" = _h8z86JRC;
        "pkg-v0.243.3" = _KKRh30gN;
        "pkg-v0.243.4" = _26dgy8my;
        "pkg-v0.243.5" = _h9b9nxWK;
        "pkg-v0.244.0" = _qYPRofCm;
        "pkg-v0.245.0" = _Y2nmGy0p;
        "pkg-v0.245.1" = _IlXe9K1N;
        "pkg-v0.246.0" = _906VDfV3;
        "pkg-v0.247.0" = _IeJZwSk1;
        "pkg-v0.247.1" = _ozQKz9C6;
        "pkg-v0.248.0" = _iGLpNTdQ;
        "pkg-v0.248.1" = _esRioh0v;
        "pkg-v0.251.1" = _SJiNJHzi;
        "pkg-v0.251.2" = _7tjfVUUA;
        "pkg-v0.251.3" = _SM009PRw;
        "pkg-v0.251.4" = _EeOfYF7C;
        "pkg-v0.253.1" = _txgtTbaU;
        "pkg-v0.255.1" = _A3Sfpirw;
        "pkg-v0.256.0" = _rVDZa2C4;
        "pkg-v0.258.0" = _vcNmfsGN;
        "pkg-v0.258.1" = _E2nZ7Wzg;
        "pkg-v0.259.0" = _vMNgu3dX;
        "pkg-v0.259.1" = _QM2uthcD;
        "pkg-v0.261.1" = _pUHya21H;
        "pkg-v0.261.2" = _5h9tz66m;
        "pkg-v0.261.3" = _hMtVnGIV;
        "pkg-v0.261.4" = _7TSP5gLX;
        "pkg-v0.261.5" = _EYRKLkqh;
        "pkg-v0.261.6" = _cH4b3h6d;
        "pkg-v0.261.7" = _g6WJRN6h;
        "pkg-v0.261.8" = _g8aw5XFR;
        "pkg-v0.261.9" = _lgZOcung;
        "pkg-v0.261.10" = _CHX06G5A;
        "pkg-v0.261.11" = _f7G9htOB;
        "pkg-v0.261.12" = _Kh3cRk9O;
        "pkg-v0.261.13" = _zyBqD45z;
        "pkg-v0.261.14" = _4xBs9Mpp;
        "pkg-v0.261.15" = _EU2XuTB4;
        "pkg-v0.261.16" = _rmzJV9rF;
        "pkg-v0.261.17" = _eoSMac8U;
        "pkg-v0.261.18" = _rNAbeZZa;
        "pkg-v0.261.19" = _TJ1H8vRu;
        "pkg-v0.261.20" = _kT1LEeQx;
        "pkg-v0.261.21" = _m8PAhfG5;
        "pkg-v0.261.22" = _TzvQD6cc;
        "pkg-v0.261.23" = _MZCToQj2;
        "pkg-v0.261.24" = _TAV2h6Uk;
        "pkg-v0.261.25" = _W4uXAtRz;
        "pkg-v0.261.26" = _RYHAWoAw;
        "pkg-v0.261.27" = _95oAFeQ7;
        "pkg-v0.261.28" = _vvXfSrpg;
        "pkg-v0.261.29" = _kFgu9Itp;
        "pkg-v0.261.30" = _9aHFhYuf;
        "pkg-v0.261.31" = _IItIO1Vw;
        "pkg-v0.261.32" = _WUSRjDHV;
        "pkg-v0.261.33" = _RdMDlNU4;
        "pkg-v0.261.34" = _CkXGkysx;
        "pkg-v0.261.35" = _judjbPzZ;
        "pkg-v0.261.36" = _AAlyNzPN;
        "pkg-v0.261.37" = _4OBQ7G1N;
        "pkg-v0.261.38" = _9BqUC9Lr;
        "pkg-v0.262.0" = _VRB2uZIP;
        "pkg-v0.263.0" = _s0vmXpdT;
        "pkg-v0.263.1" = _hewEY9bX;
        "pkg-v0.264.1" = _93V8VuRp;
        "pkg-v0.265.1" = _3xatliiE;
        "pkg-v0.265.2" = _I9xp3Fg8;
        "pkg-v0.267.0" = _oKet837G;
        "pkg-v0.268.0" = _KKfkxOG4;
        "pkg-v0.269.0" = _ShdfAwRL;
        "pkg-v0.270.0" = _sqcjdVOS;
        "pkg-v0.276.0" = _V8IQvAMp;
        "pkg-v0.281.0" = _cV50qKTe;
        "pkg-v0.282.0" = _MCqsLjkN;
        "pkg-v0.283.0" = _m6vB5O5N;
        "pkg-v0.283.1" = _ixFLcqqv;
        "pkg-v0.284.0" = _45qQYn61;
        "pkg-v0.284.1" = _sLibInMH;
        "pkg-v0.285.0" = _tlefVtTO;
        "pkg-v0.286.0" = _IdoicNiJ;
        "pkg-v0.288.0" = _L9bHRd8n;
        "pkg-v0.289.0" = _EjtTNQAV;
        "pkg-v0.290.0" = _tiVhSCfO;
        "pkg-v0.292.0" = _a0uSUsWc;
        "pkg-v0.293.0" = _n04pFQfy;
        "pkg-v0.294.0" = _LB2eV75g;
        "pkg-v0.294.1" = _amhSkvr2;
        "pkg-v0.295.1" = _LXL3odLG;
        "pkg-v0.298.0" = _4qBW1wK6;
        "pkg-v0.299.0" = _ZzaHn769;
        "pkg-v0.301.0" = _nNxwqBif;
        "pkg-v0.302.0" = _qxDbTEGb;
        "pkg-v0.303.0" = _B74Hz7EN;
        "pkg-v0.304.0" = _9mZO4hZY;
        "pkg-v0.305.0" = _JYEtoJpS;
        "pkg-v0.306.0" = _p2CQhaN4;
        "pkg-v0.307.0" = _2opIc8RC;
        "pkg-v0.308.0" = _rBVTLuX4;
        "pkg-v0.309.0" = _SesMKEVi;
        "pkg-v0.310.0" = _G5E04zLK;
        "pkg-v0.311.0" = _i8j5Cyld;
        "pkg-v0.312.0" = _tkfFLWme;
        "pkg-v0.313.0" = _3XSUJbIy;
        "pkg-v0.314.0" = _QsIxDvxo;
        "pkg-v0.315.0" = _Y3t9jo6d;
        "pkg-v0.316.0" = _qHGT7pxB;
        "pkg-v0.317.0" = _1hQYMnJQ;
        "pkg-v0.318.0" = _mKFFUiOK;
        "pkg-v0.319.0" = _AsjgTN3C;
        "pkg-v0.320.0" = _OyKPzPu2;
        "pkg-v0.321.0" = _nLoghl9C;
        "pkg-v0.322.0" = _gSCczLmI;
        "pkg-v0.323.0" = _oBZoVcjn;
        "pkg-v0.324.0" = _UiE6Lsz0;
        "pkg-v0.325.0" = _NrGRkRSQ;
        "pkg-v0.325.1" = _oORVCW8f;
        "pkg-v0.327.0" = _u6s0psHP;
        "pkg-v0.328.0" = _uGtM3s7j;
        "pkg-v0.328.1" = _j0dSEfnT;
        "pkg-v0.329.0" = _XICE8TAg;
        "pkg-v0.330.0" = _lrO90lCB;
        "pkg-v0.331.0" = _gTTIRT3v;
        "pkg-v0.331.1" = _tPDHRbii;
        "pkg-v0.332.0" = _yHORr8KP;
        "pkg-v0.333.0" = _bK6ZVEpn;
        "pkg-v0.334.0" = _ewyPFWeE;
        "pkg-v0.335.0" = _gNuR3XpC;
        "pkg-v0.336.0" = _YA4VBadb;
        "pkg-v0.337.0" = _m4nrXgu0;
        "pkg-v0.338.0" = _ueRX0qDz;
        "pkg-v0.339.0" = _v7dkAQNz;
        "pkg-v0.340.0" = _90KBJmOp;
        "pkg-v0.341.0" = _ozybH6hp;
        "pkg-v0.341.1" = _r63Jsx3O;
        "pkg-v0.342.0" = _bx4l2Gqv;
        "pkg-v0.342.1" = _rddRQeAm;
        "pkg-v0.343.1" = _JxPQAMkM;
        "pkg-v0.343.2" = _LjWsAvmi;
        "pkg-v0.343.3" = _PJGkXoDI;
        "pkg-v0.344.0" = _MOBxsAnr;
        "pkg-v0.344.1" = _SIhGUgau;
        "pkg-v0.344.2" = _qkxj2GRd;
        "pkg-v0.345.0" = _f4VG7gvo;
        "pkg-v0.345.1" = _4rZNjW4W;
        "pkg-v0.345.2" = _J2wmy7tZ;
        "pkg-v0.346.0" = _FEdQBuIt;
        "pkg-v0.346.1" = _39xw6sM0;
        "pkg-v0.348.0" = _TuHr0USu;
        "pkg-v0.348.1" = _UroNPdgU;
        "pkg-v0.349.0" = _uIRcH84R;
        "pkg-v0.349.1" = _2wg9B7ia;
        "pkg-v0.350.0" = _qoYgIppN;
        "pkg-v0.350.1" = _DoL2Nf4e;
        "pkg-v0.350.2" = _3ybf5MuM;
        "pkg-v0.351.0" = _lHhBNPtV;
        "pkg-v0.351.1" = _jOfV3ZsB;
        "pkg-v0.352.0" = _V2CyvxWZ;
        "pkg-v0.352.1" = _ASrpYXVI;
        "pkg-v0.353.0" = _szP9kRKE;
        "pkg-v0.353.1" = _wcaJvsFF;
        "pkg-v0.354.0" = _Gqb3bwpI;
        "pkg-v0.355.0" = _MfwYihwU;
        "pkg-v0.356.0" = _oliiTjot;
        "pkg-v0.357.0" = _iq3zvrTP;
        "pkg-v0.358.0" = _7kq3EBsB;
        "pkg-v0.359.0" = _7WHFaaXW;
        "pkg-v0.360.0" = _D6HKXxHv;
        "pkg-v0.361.0" = _618yJEaT;
        "pkg-v0.362.0" = _uPwvVypy;
        "pkg-v0.363.0" = _sZ2ic2Qz;
        "pkg-v0.363.1" = _wWiedeMT;
        "pkg-v0.363.2" = _GVxRPzkv;
        "pkg-v0.363.3" = _cA0lAJ91;
        "pkg-v0.363.4" = _me1nCCKy;
        "pkg-v0.363.5" = _t4QDhnpb;
        "pkg-v0.363.6" = _9mZB8KnU;
        "pkg-v0.363.7" = _7qna8KNm;
        "pkg-v0.363.8" = _mx83VTsD;
        "pkg-v0.363.9" = _FhwXjUUS;
        "pkg-v0.363.10" = _7XtiB0VY;
        "pkg-v0.363.11" = _5BwjxKZp;
        "pkg-v0.363.12" = _g3dxArSd;
        "pkg-v0.364.1" = _wLZiQJY1;
        "pkg-v0.365.0" = _gNYpW8wR;
        "pkg-v0.366.0" = _pAwshxLx;
        "pkg-v0.367.0" = _x1xHUi3k;
        "pkg-v0.368.0" = _sYmRaswI;
        "pkg-v0.369.0" = _dUo4P84J;
        "pkg-v0.370.0" = _8Jy8VPjq;
        "pkg-v0.371.0" = _hJC6JoCT;
        "pkg-v0.372.0" = _zor5vHPR;
        "pkg-v0.373.0" = _3ZGWDVob;
        "pkg-v0.374.0" = _hHOO1iPA;
        "pkg-v0.375.0" = _3l8Th108;
        "pkg-v0.376.0" = _99nEbWAU;
        "pkg-v0.377.0" = _hpiAbgt6;
        "pkg-v0.378.0" = _1p1LED0x;
        "pkg-v0.379.0" = _UpEC8nSJ;
        "pkg-v0.380.0" = _OoCRBpnf;
        "pkg-v0.381.0" = _X7eD1Hek;
        "pkg-v0.382.0" = _tCXBreuo;
        "pkg-v0.382.1" = _aXYHSTY3;
        "pkg-v0.383.0" = _Nf0wSYPm;
        "pkg-v0.383.1" = _DOKmBJKK;
        "pkg-v0.384.0" = _Ws78J0iU;
        "pkg-v0.384.1" = _HHxKqYQD;
        "pkg-v0.384.2" = _YtttS45p;
        "pkg-v0.384.3" = _Dkd5gyu6;
        "pkg-v0.384.4" = _TPDldOZh;
        "pkg-v0.384.5" = _FzTTXH43;
        "pkg-v0.384.6" = _YK5mnEiO;
        "pkg-v0.384.7" = _mRPmDlgj;
        "pkg-v0.384.8" = _olmzIv4T;
        "pkg-v0.384.9" = _A4Y2UTou;
        "pkg-v0.384.10" = _Yx8UzGjZ;
        "pkg-v0.384.11" = _nD3lhQID;
        "pkg-v0.384.12" = _h28VYnkn;
        "pkg-v0.384.13" = _TrcjScj3;
        "pkg-v0.384.14" = _9mVosgYf;
        "pkg-v0.384.15" = _7VC2z2Dg;
        "pkg-v0.384.16" = _1RaCzA5g;
        "pkg-v0.384.17" = _V1BW4gSi;
        "pkg-v0.384.18" = _9GbXvKJo;
        "pkg-v0.384.19" = _Uqx8ELOL;
        "pkg-v0.384.20" = _tMInQxsg;
        "pkg-v0.384.21" = _36iD7doB;
        "pkg-v0.384.22" = _JxKaHN9u;
        "pkg-v0.384.23" = _PJn8kT0W;
        "pkg-v0.384.24" = _67780v7s;
        "pkg-v0.384.25" = _OckL4RHC;
        "pkg-v0.384.26" = _s4wO1zAi;
        "pkg-v0.384.27" = _Nfc9sG0H;
        "pkg-v0.384.28" = _AdJekRe5;
        "pkg-v0.384.29" = _cQ6JwSOz;
        "pkg-v0.384.30" = _mNkIHULg;
        "pkg-v0.384.31" = _3AUGKHwp;
        "pkg-v0.384.32" = _XiOW357n;
        "pkg-v0.384.33" = _7Qjr3hfy;
        "pkg-v0.384.34" = _DBZeTOLm;
        "pkg-v0.384.35" = _DOrMDV5Y;
        "pkg-v0.384.36" = _XX1ryPw9;
        "pkg-v0.384.37" = _i66HXAP4;
        "pkg-v0.384.38" = _oxQUPw7l;
        "pkg-v0.384.39" = _JKfTlPOs;
        "pkg-v0.385.0" = _Sqqd3WNz;
        "pkg-v0.385.1" = _YrHOxun0;
        "pkg-v0.385.2" = _WE59GEzU;
        "pkg-v0.385.3" = _Ha9AEd8W;
        "pkg-v0.385.4" = _flnM6eWX;
        "pkg-v0.385.5" = _Hpq6kijD;
        "pkg-v0.385.6" = _kbclfhZw;
        "pkg-v0.385.7" = _9Zz5xbBf;
        "pkg-v0.385.8" = _YVUmacJM;
        "pkg-v0.385.9" = _sHDeXzSx;
        "pkg-v0.385.10" = _RkUhykoF;
        "pkg-v0.386.0" = _GCAJf471;
        "pkg-v0.386.1" = _14MZlxik;
        "pkg-v0.386.2" = _VFPpdQwA;
        "pkg-v0.386.3" = _YfTkGn3N;
        "pkg-v0.387.1" = _LwIAHqAh;
        "pkg-v0.388.0" = _FSVgd5VX;
        "pkg-v0.388.1" = _cXONpehL;
        "pkg-v0.390.0" = _Dz8agTYJ;
        "pkg-v0.391.0" = _hlYNRnm8;
        "pkg-v0.392.0" = _SkUMjMrx;
        "pkg-v0.393.0" = _xTRdE4Mu;
        "pkg-v0.394.0" = _al4jzXB3;
        "pkg-v0.395.0" = _g0INZ0Vz;
        "pkg-v0.397.0" = _JGqCOsMm;
        "pkg-v0.398.0" = _dUPoeYkl;
        "pkg-v0.399.0" = _OH7pdOrH;
        "pkg-v0.399.1" = _QQYLvUi3;
        "pkg-v0.400.0" = _3mcitqvI;
        "pkg-v0.401.0" = _UgtnXy2r;
        "pkg-v0.402.0" = _cEUl9LpH;
        "pkg-v0.404.0" = _OuFsXMAE;
        "pkg-v0.405.0" = _NKCy6glF;
        "pkg-v0.407.0" = _jj5wz3D5;
        "pkg-v0.409.0" = _9QIzvZzH;
        "pkg-v0.410.0" = _MAFpXhrb;
        "pkg-v0.411.0" = _TyFxLQMv;
        "pkg-v0.412.0" = _umybjmpl;
        "pkg-v0.413.0" = _ZJOImako;
        "pkg-v0.414.0" = _owfxJNqS;
        "pkg-v0.415.0" = _HxA6C9ef;
        "pkg-v0.416.0" = _nOjYzrPU;
        "pkg-v0.418.0" = _NRPmxZL4;
        "pkg-v0.419.0" = _vOwdugmt;
        "pkg-v0.422.0" = _Up98NIxT;
        "pkg-v0.423.0" = _Y69upQ3Z;
        "pkg-v0.424.0" = _SzsgiUNH;
        "pkg-v0.425.0" = _YNrEqnLc;
        "pkg-v0.425.1" = _cNTPLLtJ;
        "pkg-v0.426.1" = _DcpOD0sQ;
        "pkg-v0.426.2" = _KMbSs0MM;
        "pkg-v0.426.3" = _ayY5mY4M;
        "pkg-v0.426.4" = _Nv5eEcj7;
        "pkg-v0.426.5" = _8JOvunHE;
        "pkg-v0.426.6" = _TNWEMb4T;
        "pkg-v0.426.7" = _dRf2UZcj;
        "pkg-v0.426.8" = _mRrGcr2I;
        "pkg-v0.426.9" = _xylMJZ92;
        "pkg-v0.427.0" = _QJNUXjG3;
        "pkg-v0.427.1" = _ycDXWBIt;
        "pkg-v0.427.2" = _neUgb7Cs;
        "pkg-v0.427.3" = _ZfwogxOI;
        "pkg-v0.427.4" = _f9a1aJfG;
        "pkg-v0.427.5" = _9LZShZmV;
        "pkg-v0.428.0" = _AZ7Hm29G;
        "pkg-v0.428.1" = _IFzEh2Zd;
        "pkg-v0.429.0" = _fnJ5TluF;
        "pkg-v0.430.0" = _emmeI8SV;
        "pkg-v0.430.1" = _GMAkpqAx;
        "pkg-v0.431.1" = _USHlQAUm;
        "pkg-v0.431.2" = _RYhCGNNY;
        "pkg-v0.431.3" = _vF3e5DKj;
        "pkg-v0.431.4" = _hHMbosYE;
        "pkg-v0.432.0" = _2ZCql5jw;
        "pkg-v0.432.1" = _FWm5hmx6;
        "pkg-v0.433.0" = _rDtntmUC;
        "pkg-v0.433.1" = _wFMiVI46;
        "pkg-v0.436.1" = _keFewJYw;
        "pkg-v0.436.2" = _XlTDR8PL;
        "pkg-v0.437.1" = _9pk6W9iJ;
        "pkg-v0.438.1" = _SNwhKJn2;
        "pkg-v0.439.1" = _lPRX5j6t;
        "pkg-v0.442.1" = _ddHNIjCq;
        "pkg-v0.442.2" = _kzfOPAxI;
        "pkg-v0.442.3" = _rCw68J3k;
        "pkg-v0.442.4" = _fhRMbJvi;
        "pkg-v0.443.0" = _POvDIdZw;
        "pkg-v0.444.1" = _kLqo5HpV;
        "pkg-v0.445.0" = _2TWXrj3I;
        "pkg-v0.445.1" = _48AP2Gz0;
        "pkg-v0.447.0" = _jZXxJ9JN;
        "pkg-v0.448.0" = _cQHMs4Yy;
        "pkg-v0.450.0" = _EQyZHmdL;
        "pkg-v0.451.0" = _uVBPDkwG;
        "pkg-v0.452.0" = _LjK1NkAN;
        "pkg-v0.454.0" = _yFzo4OfK;
        "pkg-v0.458.0" = _V7UMfcib;
        "pkg-v0.460.0" = _r8IFDMlA;
        "pkg-v0.462.0" = _scVwBVhA;
        "pkg-v0.464.0" = _OAyhCq9T;
        "pkg-v0.467.0" = _R0RNMV3u;
        "pkg-v0.468.0" = _UaZUQmZL;
        "pkg-v0.470.0" = _rk4uutLu;
        "pkg-v0.471.0" = _z0XKehvc;
        "pkg-v0.472.0" = _qdRGPjDH;
        "pkg-v0.473.0" = _IJAUrBSJ;
        "pkg-v0.475.0" = _iC4vyGTd;
        "pkg-v0.478.0" = _BQlN2OXR;
        "pkg-v0.479.0" = _tALxCcSO;
        "pkg-v0.480.0" = _MIuOMIat;
        "pkg-v0.481.0" = _EXv1kMLI;
        "pkg-v0.483.0" = _XSSWWzfd;
        "pkg-v0.485.0" = _ydsk3YtR;
        "pkg-v0.486.0" = _8PdSAdbY;
        "pkg-v0.487.0" = _3rCnEs1z;
        "pkg-v0.488.0" = _deX6ohxV;
        "pkg-v0.492.0" = _j2Qe4cex;
        "pkg-v0.494.0" = _QcrHIY4j;
        "pkg-v0.496.0" = _1feVboNe;
        "pkg-v0.497.0" = _CDSKgb1c;
        "pkg-v0.499.0" = _mePmUQ7D;
        "pkg-v0.504.0" = _puYo0IV6;
        "pkg-v0.506.0" = _IjbDNiyA;
        ...
        "pkg-v0.811.0" = _NBqFGNNb;
        "pkg-v0.813.0" = _5YSKqpNi;
        "pkg-v0.823.0" = _mkWVzGDi;
        "pkg-v0.824.0" = _QZTnLuBY;
        "pkg-v0.828.0" = _fez8iPLC;
        "pkg-v0.843.0" = _WvrDgInj;
        "pkg-v0.849.0" = _d7kBt5No;
        "pkg-v0.854.0" = _JmCsWzVH;
        "pkg-v0.861.0" = _VmxqYbiY;
        "pkg-v0.875.0" = _dwS0n84o;
        "pkg-v0.878.0" = _tTBRRhEa;
        "pkg-v0.884.0" = _Zphz9Q3q;
        "pkg-v0.885.0" = _9cgO2ztD;
        "pkg-v0.887.0" = _2o4NyfWX;
        "pkg-v0.888.0" = _n1gSMeON;
        "pkg-v0.890.0" = _UZLN2Tz6;
        "pkg-v0.893.0" = _xaFazwau;
        "pkg-v0.894.0" = _zQiubw3a;
        "pkg-v0.895.0" = _sydYETAu;
        "pkg-v0.898.0" = _IO3QkXiH;
