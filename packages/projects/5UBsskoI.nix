...
let
    versions = (let
        ...
        _nemAlwi4 = {
            "id" = "nemAlwi4";
            "file" = "craftable-items-1.8.0.jar";
            "hash" = "sha512-O66XATyQ5jjfc2CzFHgKFFJ+D9C0wIOwNf99mlif2buUS6/JL/Fs6T5OTJHwN63X+GJ+zORKisaOzI8rSrNt1Q==";
        };
    in {
        "qnkAs2kQ" = _qnkAs2kQ;
        "aaCA3kGY" = _aaCA3kGY;
        ...
        "fabric-1.21.6" = _nemAlwi4;
        "fabric-1.21.7" = _nemAlwi4;
        "fabric-1.21.8" = _nemAlwi4;
        "fabric-1.21.9" = _nemAlwi4;
        "fabric-1.21.10" = _nemAlwi4;
        "fabric-1.21.11" = _nemAlwi4;
        "fabric-26.1" = _nemAlwi4;
        "fabric-26.1.1" = _nemAlwi4;
        "fabric-26.1.2" = _nemAlwi4;
        "fabric-26.2" = _nemAlwi4;
        ...
        "forge-1.21.6" = _nemAlwi4;
        "forge-1.21.7" = _nemAlwi4;
        "forge-1.21.8" = _nemAlwi4;
        "forge-1.21.9" = _nemAlwi4;
        "forge-1.21.10" = _nemAlwi4;
        "forge-1.21.11" = _nemAlwi4;
        "forge-26.1" = _nemAlwi4;
        "forge-26.1.1" = _nemAlwi4;
        "forge-26.1.2" = _nemAlwi4;
        "forge-26.2" = _nemAlwi4;
        ...
        "neoforge-1.21.6" = _nemAlwi4;
        "neoforge-1.21.7" = _nemAlwi4;
        "neoforge-1.21.8" = _nemAlwi4;
        "neoforge-1.21.9" = _nemAlwi4;
        "neoforge-1.21.10" = _nemAlwi4;
        "neoforge-1.21.11" = _nemAlwi4;
        "neoforge-26.1" = _nemAlwi4;
        "neoforge-26.1.1" = _nemAlwi4;
        "neoforge-26.1.2" = _nemAlwi4;
        "neoforge-26.2" = _nemAlwi4;
        ...
        "quilt-1.21.6" = _nemAlwi4;
        "quilt-1.21.7" = _nemAlwi4;
        "quilt-1.21.8" = _nemAlwi4;
        "quilt-1.21.9" = _nemAlwi4;
        "quilt-1.21.10" = _nemAlwi4;
        "quilt-1.21.11" = _nemAlwi4;
        "quilt-26.1" = _nemAlwi4;
        "quilt-26.1.1" = _nemAlwi4;
        "quilt-26.1.2" = _nemAlwi4;
        "quilt-26.2" = _nemAlwi4;
        "pkg-0.6.0" = _qnkAs2kQ;
        "pkg-0.7.0" = _aaCA3kGY;
        "pkg-0.8.0" = _8RZjoaYD;
        "pkg-0.9.0" = _XQxOHxqh;
