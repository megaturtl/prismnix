...
let
    versions = (let
        ...
        _ZGQT4uGO = {
            "id" = "ZGQT4uGO";
            "file" = "PACP_Base_Release.zip";
            "hash" = "sha512-dIHd5VEnyiQY2oi+zwVCieVuDPlxAECJilPbqubDy0a/q0/AiW6hYfqLnEB55+f+XdPVrK3E+VrH51qy2SclzA==";
        };
        _CV0qSGv0 = {
            "id" = "CV0qSGv0";
            "file" = "PACP_Base_Release.zip";
            "hash" = "sha512-5r39G93UauhM0TRYq97dNNpcEOPRMjKBWK7GJLS+aEsNKywfl0MVkaqkChxLZC8dLRUL1QI1yRRSGnnEVq47og==";
        };
    in {
        "XSnNO8DK" = _XSnNO8DK;
        "bfzPgpdm" = _bfzPgpdm;
        ...
        "ZGQT4uGO" = _ZGQT4uGO;
        "CV0qSGv0" = _CV0qSGv0;
        "minecraft-1.20.1" = _CV0qSGv0;
        "minecraft-1.20.2" = _CV0qSGv0;
        "minecraft-1.20.3" = _CV0qSGv0;
        "minecraft-1.20.4" = _CV0qSGv0;
        "minecraft-1.20.5" = _CV0qSGv0;
        "minecraft-1.20" = _CV0qSGv0;
        "minecraft-1.20.6" = _CV0qSGv0;
        "minecraft-1.21" = _CV0qSGv0;
        "minecraft-1.21.1" = _CV0qSGv0;
        "minecraft-1.21.2" = _CV0qSGv0;
        "minecraft-1.21.3" = _CV0qSGv0;
        "minecraft-1.21.4" = _CV0qSGv0;
        "minecraft-1.21.5" = _CV0qSGv0;
        "minecraft-1.21.6" = _CV0qSGv0;
        "minecraft-1.21.7" = _CV0qSGv0;
        "minecraft-1.21.8" = _CV0qSGv0;
        "minecraft-1.21.9" = _CV0qSGv0;
        "minecraft-1.21.10" = _CV0qSGv0;
        "minecraft-1.21.11" = _CV0qSGv0;
        "minecraft-26.1" = _CV0qSGv0;
        "minecraft-26.1.1" = _CV0qSGv0;
        "minecraft-26.1.2" = _CV0qSGv0;
        "minecraft-26.2" = _CV0qSGv0;
        "minecraft-26.3" = _CV0qSGv0;
        "pkg-1.7.10-03" = _XSnNO8DK;
        "pkg-1.7.10-04" = _XkcrjObQ;
        "pkg-1.8.0-pre1" = _FEhdjUaO;
        "pkg-1.7.10-04-02" = _MKb3rS1j;
        "pkg-1.8-pre2" = _tKe9gUev;
        "pkg-1.8.0-beta1" = _g5Br4RcS;
        "pkg-1.8-beta1" = _ea0TG6zM;
        "pkg-1.8-beta2" = _gTV9ygw0;
        "pkg-1.8-beta3" = _eeO5iL33;
        "pkg-1.8.0" = _QMyQ4jAU;
        "pkg-1.8.1" = _kYa7DRpG;
        "pkg-1.8.2" = _hjVR7gMY;
        "pkg-1.8.2.1" = _hrDN5J3P;
        "pkg-1.8.2.2" = _VnDD4UC6;
        "pkg-1.9.0" = _ZjTvxu8R;
        "pkg-1.9.0c" = _8Xg4mEF4;
        "pkg-1.9.0_01" = _6Td0ZIJX;
        "pkg-1.9.0_01c" = _2QfTXdVX;
        "pkg-2.0-preview" = _RenAE59O;
        "pkg-2.0c-preview" = _ke1WQCkH;
        "pkg-2.0-pre2" = _ociRWqS6;
        "pkg-2.0c_pre2" = _77LagWGg;
        "pkg-2.0c-Pre3" = _HuQQei8V;
        "pkg-2.0-pre3" = _i4u50ij5;
        "pkg-2.0s" = _j40jkCH6;
        "pkg-2.0c" = _7SI2U7mn;
        "pkg-2.0.1s" = _frtQysmf;
        "pkg-2.0.1c" = _V0iyJYOo;
        "pkg-2.0.2_02c" = _a6lUA8ZT;
        "pkg-2.0.2_02" = _8HENBlcy;
        "pkg-2.0.3c" = _ue4kBr2t;
        "pkg-2.0.3s" = _Uo9hCaOx;
        "pkg-2.0.4c" = _3OGw69Xh;
        "pkg-2.0.4s" = _yUcEGM4r;
        "pkg-2.0.5c" = _sViWl2Ck;
        "pkg-2.0.5s" = _T6Hk8938;
        "pkg-2.1a_20250228" = _ak8GW8Xp;
        "pkg-2.1c" = _WE2iodXx;
        "pkg-2.1s" = _RBA2zVLL;
        "pkg-2.1_01c" = _dfD9163L;
        "pkg-2.1_01s" = _nBv1fMpH;
        "pkg-2.1_02c" = _TN8bHnoW;
        "pkg-2.1_02s" = _5DneprcY;
        "pkg-2.1.1c" = _zjfpmh9c;
        "pkg-2.1.1s" = _guAYa5LY;
        "pkg-2.1.2" = _d3LZw63Q;
        "pkg-2.1.2_01" = _VFSEaJeu;
        "pkg-2.1.2_02" = _8VLZ6fJm;
        "pkg-2.1.2_03" = _xQkIeEbt;
        "pkg-2.2.0" = _dZrHQKnf;
        "pkg-2.2_01" = _wS7UzKpd;
        "pkg-2.2_02" = _LAUYJHte;
        "pkg-2.2_03" = _9MeKUUix;
        "pkg-2.3.0" = _iovIu9Jo;
        "pkg-2.3_01" = _rIyLdYze;
        "pkg-2.3_02" = _hDU6iM2v;
        "pkg-2.4" = _MmNyu6nP;
        "pkg-2.4_01" = _WBVhgaQB;
        "pkg-2.5.0" = _ZaSBOuds;
        "pkg-2.5.0_01" = _EmryD5kf;
        "pkg-2.5.1" = _3Ffyj49O;
        "pkg-2.5.2" = _adrLezCz;
        "pkg-2.5.2_01" = _RbdTpSkI;
        "pkg-2.5.2_02" = _aDRJthSc;
        "pkg-2.5.2_03" = _ZGQT4uGO;
        "pkg-2.5.3" = _CV0qSGv0;
        "default" = _CV0qSGv0;
    });
