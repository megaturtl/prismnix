...
let
    ...
    in {
        ...
        "aDRJthSc" = _aDRJthSc;
        "ZGQT4uGO" = _ZGQT4uGO;
        "minecraft-1.20.1" = _ZGQT4uGO;
        "minecraft-1.20.2" = _ZGQT4uGO;
        "minecraft-1.20.3" = _ZGQT4uGO;
        "minecraft-1.20.4" = _ZGQT4uGO;
        "minecraft-1.20.5" = _ZGQT4uGO;
        "minecraft-1.20" = _ZGQT4uGO;
        "minecraft-1.20.6" = _ZGQT4uGO;
        "minecraft-1.21" = _ZGQT4uGO;
        "minecraft-1.21.1" = _ZGQT4uGO;
        "minecraft-1.21.2" = _ZGQT4uGO;
        "minecraft-1.21.3" = _ZGQT4uGO;
        "minecraft-1.21.4" = _ZGQT4uGO;
        "minecraft-1.21.5" = _ZGQT4uGO;
        "minecraft-1.21.6" = _ZGQT4uGO;
        "minecraft-1.21.7" = _ZGQT4uGO;
        "minecraft-1.21.8" = _ZGQT4uGO;
        "minecraft-1.21.9" = _ZGQT4uGO;
        "minecraft-1.21.10" = _ZGQT4uGO;
        "minecraft-1.21.11" = _ZGQT4uGO;
        "minecraft-26.1" = _ZGQT4uGO;
        "minecraft-26.1.1" = _ZGQT4uGO;
        "minecraft-26.1.2" = _ZGQT4uGO;
        "minecraft-26.2" = _ZGQT4uGO;
