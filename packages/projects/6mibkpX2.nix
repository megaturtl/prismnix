...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.21.6" = _oE6jmAlH;
        "pkg-1.0.0+1.21.9" = _2f6XHbAM;
        "pkg-1.1.0+1.21.9" = _6nai0VeC;
        "pkg-1.1.0+1.21.6" = _RD7BYR71;
        "pkg-1.1.0+1.21.5" = _fgQFohj1;
        "pkg-1.1.0+1.21.2" = _CVNYJtG8;
        "pkg-1.1.0+1.21" = _PAkvqlNV;
        "pkg-1.1.0+1.20.5" = _oGrQETZR;
        "pkg-1.1.0+1.20" = _7EKniEem;
        "pkg-1.1.1-fabric-1.19" = _voL7KvAj;
        "pkg-1.1.1-fabric-1.21.4" = _8GgiJzhc;
        "pkg-1.1.1-fabric-1.20.6" = _zZbJfwOS;
        "pkg-1.1.1-fabric-1.18" = _6taeGQSr;
        "pkg-1.1.1-fabric-1.17" = _MmV87AVT;
        "pkg-1.1.1-fabric-1.21.11" = _7dQ2DemQ;
        "pkg-1.1.1-fabric-1.20.4" = _oL4b9nzQ;
        "pkg-1.1.1-fabric-1.20.1" = _uEGWLCA4;
        "pkg-1.1.2-fabric-1.21.8" = _BqlIunjZ;
        "pkg-1.1.2-fabric-1.21.1" = _BAuhPvd9;
        "pkg-1.1.2-fabric-1.21.5" = _J9czYtBd;
        "pkg-1.1.2-fabric-1.21.11" = _D5svBNPF;
        "pkg-1.1.2-fabric-1.18" = _tg9yMbkB;
        "pkg-1.1.2-fabric-1.21.4" = _i3EaSRfi;
        "pkg-1.1.2-fabric-1.19" = _fOgBIRAn;
        "pkg-1.1.2-fabric-1.20.1" = _sKhs0zV3;
