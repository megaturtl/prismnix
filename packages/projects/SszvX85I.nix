...
let
    versions = (let
        ...
        _UYEZUZMS = {
            "id" = "UYEZUZMS";
            "file" = "mega_showdown-neoforge-1.9.4+1.7.3+1.21.1-beta.jar";
            "hash" = "sha512-kZgWIvgcwq2R54dIgYdBk6reYAuXtrqEJyNbbZWE8hQWVQJ+I9Cd4rwEkxc29dg3pJ0NkuyAzNqc5mCgwhemgg==";
        };
        _nslwf5V0 = {
            "id" = "nslwf5V0";
            "file" = "mega_showdown-fabric-1.9.4+1.7.3+1.21.1-beta.jar";
            "hash" = "sha512-I83woBgDanHAbgZU6TJctTEWA4mTm18o9NmKBTq1xbclvPTWiBG94j5clz9EUTdp4+3TqnGtDC5rDPqE2b3SDA==";
        };
        _lLikG45V = {
            "id" = "lLikG45V";
            "file" = "mega_showdown-neoforge-1.9.4+1.7.3+1.21.1.jar";
            "hash" = "sha512-usb4k8y0cqTYdwy6Ye0A0lnIYPGL8rcG8DYAJXA12jLIBTx6aa3m06iZj1yrTFK5eLcEycq213Up5K3pAcB1tQ==";
        };
        _hKHLHUjJ = {
            "id" = "hKHLHUjJ";
            "file" = "mega_showdown-fabric-1.9.4+1.7.3+1.21.1.jar";
            "hash" = "sha512-Ou2H/OElN8c+9PnWVqx76qg+lV178scKwd2N3ZDCh+O4rlNEreRfhrTbSob6Wma4Xa4Qxc9gBHbwOh5O7FQWSA==";
        };
        _oGDgZpN3 = {
            "id" = "oGDgZpN3";
            "file" = "mega_showdown-fabric-1.9.5+1.7.3+1.21.1.jar";
            "hash" = "sha512-m/7Mt0bZoanAPDyd7lUOJJ3v1JP2hKPMX60B0XPFFhZhMwopZ8qTn9FURIDmueNSzkfDwbhdk7Tc9U/dq5Jnhg==";
        };
        _IRPTcfIt = {
            "id" = "IRPTcfIt";
            "file" = "mega_showdown-neoforge-1.9.5+1.7.3+1.21.1.jar";
            "hash" = "sha512-9llC8gm0CY4af4aub68tgt5k9obrovrAJtCGknZEYeb6vPqSTq7cwjY8cHT63BdUtXlSApnCHRTCjFDkekyvOA==";
        };
        _TKtlMDd6 = {
            "id" = "TKtlMDd6";
            "file" = "mega_showdown-neoforge-1.9.6+1.7.3+1.21.1.jar";
            "hash" = "sha512-zciI7bulJBV4G9uEHRxdwWubV7aBL8ISZ3iEk6nMmO+AtsTRhfiiLR3i3tsiSMMbHcGcYZZ5s0P/zO40sFAtNw==";
        };
        _zPVVW05O = {
            "id" = "zPVVW05O";
            "file" = "mega_showdown-fabric-1.9.6+1.7.3+1.21.1.jar";
            "hash" = "sha512-Un/95bmEYmr9BgF28XzCcdB/zorahoCKxskMp7rPWwtZRSkWFieGFt1tP/TFozmCOuW2GZk1euOL+59Ac/RNVw==";
        };
        _9aL4tB97 = {
            "id" = "9aL4tB97";
            "file" = "mega_showdown-neoforge-1.9.7+1.7.3+1.21.1.jar";
            "hash" = "sha512-0APptFbgc5g2rbJ4u5nA4YWNn6SbZpE64dnAtQpbRAU9jS1r+iAESCtV3DXTboyQForKpEoknfrEcJKBK3xfxQ==";
        };
        _VDHRz0YS = {
            "id" = "VDHRz0YS";
            "file" = "mega_showdown-fabric-1.9.7+1.7.3+1.21.1.jar";
            "hash" = "sha512-6byzLA9cZeVonn7eu7zS4haVqiOhNr2RnYpjBJtZKCdlQByRYufkIf+XQqq7vR6N5l8oNI6eXdfFjVCMBmvPAQ==";
        };
        _pim39JbN = {
            "id" = "pim39JbN";
            "file" = "mega_showdown-fabric-1.9.8+1.7.3+1.21.1.jar";
            "hash" = "sha512-f2gEyPy3byTjf5u5jV7jOFVtkzEQwZJNXdtg41yv3rOTazKG52aYJhIZQjhNi0t7whW8p1CVe+1B19Cs/0arCQ==";
        };
        _WnV3bFxN = {
            "id" = "WnV3bFxN";
            "file" = "mega_showdown-neoforge-1.9.8+1.7.3+1.21.1.jar";
            "hash" = "sha512-xbDbXo2oCoG0e4L3nQoL5w+hv1nf6ZD06YGZMD2q+1JpKxjSJ34PZ+FUYFX038K0riwO/hybTjczengeISFTQg==";
        };
        _13b1fBn2 = {
            "id" = "13b1fBn2";
            "file" = "mega_showdown-fabric-1.9.9+1.7.3+1.21.1.jar";
            "hash" = "sha512-1E0TguQvRX8KMfHcERnHSVLv0n6cwkdXhy+jl/OQ0TY1yL/l9CNrnKfS6P4F6LvI9Q/hPm7b526K3cUXWY+JoQ==";
        };
        _FQVvOOcv = {
            "id" = "FQVvOOcv";
            "file" = "mega_showdown-neoforge-1.9.9+1.7.3+1.21.1.jar";
            "hash" = "sha512-lSKFpWUYiMYYUruj0e6sNJQPdASnKkxex7SQEb3YfspLc8WrLLSWrRFzd/VYRUFxXDIwriIeL287b2F5J/Xjqg==";
        };
        _jkKKeTX2 = {
            "id" = "jkKKeTX2";
            "file" = "mega_showdown-fabric-1.0+1.8+1.21.1-beta.jar";
            "hash" = "sha512-FchHtjDnhvLiBGbkuwVwKVh5QkZcx5PC63bRwsbyJInMOjRFIc6M5uaYkGALtggZOq7gitftVmdlCVltpO7UuQ==";
        };
        _vQ0WD6tl = {
            "id" = "vQ0WD6tl";
            "file" = "mega_showdown-neoforge-1.0+1.8+1.21.1-beta.jar";
            "hash" = "sha512-ylNQYy59EDvErZWRrIFwnSqTff6qEmGMQ7vzKsU5Pl/o+eSy6fmNDUfYlztd+xgRKY6a95dkVZ4CJXkXApQjfg==";
        };
        _PGkVYcc9 = {
            "id" = "PGkVYcc9";
            "file" = "mega_showdown-neoforge-1.0+1.8+1.21.1-beta2.jar";
            "hash" = "sha512-b4zjiaiwUIZ0IZ90JeF1l9ggTyNHEMTCJxO3n31+zEMDCRIAEkyaPS/gwdTBA2eTqZh+Qo/FYxR8xdDqZEsOLQ==";
        };
        _gI4z1gxU = {
            "id" = "gI4z1gxU";
            "file" = "mega_showdown-fabric-1.0+1.8+1.21.1-beta2.jar";
            "hash" = "sha512-N6IIjN/SYZ2MMV73rqNdTup4lLIXj47lEy5qN5VyDQpfOD+Jo19LnAeaJP6vPBEB5zWQd+qCmk8ICWFs0z46Mw==";
        };
        _5PtOeQNO = {
            "id" = "5PtOeQNO";
            "file" = "mega_showdown-neoforge-1.0+1.8+1.21.1-release.jar";
            "hash" = "sha512-g+zqL9SJyjcmfI2YyKnmzriJY4KaxtykUjSj/mKoRJdpyaet4DTWvOYaZeCg1Kj32PNK94KAppGGspqJsWL5vg==";
        };
        _eT4kBnCd = {
            "id" = "eT4kBnCd";
            "file" = "mega_showdown-fabric-1.0+1.8+1.21.1-release.jar";
            "hash" = "sha512-WBeRcFAO+xPDGzxMrfcc8bb18X5lw2pvRHeTEstkri0tRUTOUGqF57IC8d5yt1CFv3mvBKjWNeGIrNPdjreYEA==";
        };
        _xwR6G7pT = {
            "id" = "xwR6G7pT";
            "file" = "mega_showdown-neoforge-1.0+1.8+1.21.1-release-hotfix.jar";
            "hash" = "sha512-XSEqqp7D/HGwPmf0cQMRKsEbD8ZJS9lggPf0wikJiF7dPNn/AkPSOTrL5fPI4mngXZ6DvSL/CV8DBCMiLmX03Q==";
        };
        _we79kHpG = {
            "id" = "we79kHpG";
            "file" = "mega_showdown-fabric-1.0+1.8+1.21.1-release-hotfix.jar";
            "hash" = "sha512-Vc7mkF3kCsKlrJ+rL8VQLI+rd8YpQTStpRVIGidXuDVKeeA6u8cXY4cK/uHUQFgeO6BrkS8a691M1DLQJVVxTw==";
        };
        _1SmGI7K1 = {
            "id" = "1SmGI7K1";
            "file" = "mega_showdown-neoforge-1.0.1+1.8+1.21.1-release.jar";
            "hash" = "sha512-UrkV8eD9d1fbZpHJGD1vX/YAqZFhaZS2zowC/HV0wMWYCZbMnY3E+TQqRAePJnl3zu+0o8HQn3/I4xtGpHMgmA==";
        };
        _5lCKWgzS = {
            "id" = "5lCKWgzS";
            "file" = "mega_showdown-fabric-1.0.1+1.8+1.21.1-release.jar";
            "hash" = "sha512-qBc+/uDPLbDZ6qRd3OQSkIb/DWDQIFinE/09MxVQRuxEYu21dDqC64jeqYNCGIHfWqHOq1Sw61KyHowl7zzfDw==";
        };
        _TACsHsKC = {
            "id" = "TACsHsKC";
            "file" = "mega_showdown-fabric-1.0.2+1.8+1.21.1-release.jar";
            "hash" = "sha512-fjFh9J2jejdj3pyWcfWgT7GkW4OJjN5Jg2Htql12N6LXAkyYuFnRWCsR3+IT2kjjDSteR3WhkUBdJJKQiZK8eQ==";
        };
        _gKBD3cFm = {
            "id" = "gKBD3cFm";
            "file" = "mega_showdown-neoforge-1.0.2+1.8+1.21.1-release.jar";
            "hash" = "sha512-+UFxkCdxI8AHeLQ4wCLPFgbCUeJW8gidemw3tDU45AovwKWhljA/qXf4QjjnGwuVLdF3AAgLBeUSbWDBk/TPEg==";
        };
        _7rZtaKKs = {
            "id" = "7rZtaKKs";
            "file" = "mega_showdown-neoforge-1.1.0+1.8+1.21.1-release.jar";
            "hash" = "sha512-sVYMz6ZAL3C22vHvSuZdOhtoaOZEMppMzCf/piJxZbOnXEWZAoBskNy7ueygCIl/xdqIrAtCdPEPiF/F9WMO+Q==";
        };
        _3GWQ1CgZ = {
            "id" = "3GWQ1CgZ";
            "file" = "mega_showdown-fabric-1.1.0+1.8+1.21.1-release.jar";
            "hash" = "sha512-M2jLEXF7+jm4GYoVdNRSqcMSheyeWvwD/YoMFKNumi5huVziIYRwKu1SQd8UxofDwpZzRVY3p6GVv7h0pVCiAQ==";
        };
        _6vY4bzUW = {
            "id" = "6vY4bzUW";
            "file" = "mega_showdown-neoforge-1.1.1+1.8+1.21.1-release.jar";
            "hash" = "sha512-T9jyAKsyz9y6Lu4BUGkqdUpRS1cb4H069fxYTYNwGrqrxgbRiX4Q6bgyjYTSCmz85kQ6C4eOAmWnYGWTSBY+bA==";
        };
        _XyDOdRJO = {
            "id" = "XyDOdRJO";
            "file" = "mega_showdown-fabric-1.1.1+1.8+1.21.1-release.jar";
            "hash" = "sha512-zvLdKHaZ0CTTcX0+anCwlvAP2PWTQl5Kpee/8VsF/W2hLiz7a+mjRFkXSOpML8mpNoMU1r6bMScDJCG1UXHR9Q==";
        };
        _OqWDIPCw = {
            "id" = "OqWDIPCw";
            "file" = "mega_showdown-neoforge-1.1.2+1.8+1.21.1-release.jar";
            "hash" = "sha512-8DVpTwfZePzitBxTqrUrid0wuPhd5tN+aueJDKpQpn8BvCXEIAGiQiG9hS85oKmIMdAmGHTiFVfgLRHXb4dH+Q==";
        };
        _8IvR0RIb = {
            "id" = "8IvR0RIb";
            "file" = "mega_showdown-fabric-1.1.2+1.8+1.21.1-release.jar";
            "hash" = "sha512-sdZr6nf+O1WmgS+ilr3i4uTHLojaUZyUeN5+DA1OFEnrzrCuEF43BCfUhJijNk26+dbTsd3UrVXI1F6HroYrqg==";
        };
        _TKdAixuR = {
            "id" = "TKdAixuR";
            "file" = "mega_showdown-fabric-1.2.0+1.8.1+1.21.1-release.jar";
            "hash" = "sha512-qH7nj1AE+vS0TQtYCRRDuRwD2Dbbegri9ffykoM5TTZzBAl0Uv2o/kbWfFgzuTZ3Q1W9KTJ/DH7o5ipwvG2pMw==";
        };
        _PzUYM6Nz = {
            "id" = "PzUYM6Nz";
            "file" = "mega_showdown-neoforge-1.2.0+1.8.1+1.21.1-release.jar";
            "hash" = "sha512-W4qpRS6HiUvSIvo7RCuRGa0Y5ypmsNG50yqlnO3VVKKAg1VS5qoz6uj6PUT4I7iI2vujJ3tvvtxYdzo7KX3Wng==";
        };
    in {
        "8MhcOV9z" = _8MhcOV9z;
        "5iAMyW2K" = _5iAMyW2K;
        ...
        "TKdAixuR" = _TKdAixuR;
        "PzUYM6Nz" = _PzUYM6Nz;
        "fabric-1.21.1" = _TKdAixuR;
        "neoforge-1.21.1" = _PzUYM6Nz;
        ...
        "pkg-1.9.4+1.7.3+1.21.1-beta" = _nslwf5V0;
        "pkg-1.9.4+1.7.3+1.21.1" = _hKHLHUjJ;
        "pkg-1.9.5+1.7.3+1.21.1" = _IRPTcfIt;
        "pkg-1.9.6+1.7.3+1.21.1" = _zPVVW05O;
        "pkg-1.9.7+1.7.3+1.21.1" = _VDHRz0YS;
        "pkg-1.9.8+1.7.3+1.21.1" = _WnV3bFxN;
        "pkg-1.9.9+1.7.3+1.21.1" = _FQVvOOcv;
        "pkg-1.0+1.8+1.21.1-beta" = _vQ0WD6tl;
        "pkg-1.0+1.8+1.21.1-beta2" = _gI4z1gxU;
        "pkg-1.0+1.8+1.21.1-release" = _eT4kBnCd;
        "pkg-1.0+1.8+1.21.1-release-hotfix" = _we79kHpG;
        "pkg-1.0.1+1.8+1.21.1-release" = _5lCKWgzS;
        "pkg-1.0.2+1.8+1.21.1-release" = _gKBD3cFm;
        "pkg-1.1.0+1.8+1.21.1-release" = _3GWQ1CgZ;
        "pkg-1.1.1+1.8+1.21.1-release" = _XyDOdRJO;
        "pkg-1.1.2+1.8+1.21.1-release" = _8IvR0RIb;
        "pkg-1.2.0+1.8.1+1.21.1-release" = _PzUYM6Nz;
        "default" = _PzUYM6Nz;
    });
