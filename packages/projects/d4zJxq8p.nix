...
let
    ...
    in {
        ...
        "pkg-0.0.1-alpha.13.2" = _gUOaWLSF;
        "pkg-0.0.1-alpha.14" = _iL79NOKd;
        "pkg-0.0.1-alpha.15" = _yB3qvtxL;
        "pkg-0.0.1-alpha.15.1" = _vkafjQLi;
        "pkg-0.0.1-alpha.15.2" = _IcSpOnns;
        "pkg-0.0.1-alpha.15.3" = _JTXKEmiG;
        "pkg-0.0.1-alpha.15.4" = _QrCYsfpF;
        "pkg-0.0.1-alpha.15.5" = _z9F8mzrQ;
        "pkg-0.0.1-alpha.15.6" = _CB8NBZiy;
        "pkg-0.0.1-alpha.15.7" = _EWCTiP7B;
        "pkg-0.0.1-alpha.15.8" = _XeLhwceh;
        "pkg-0.0.1-alpha.15.9" = _KJIF8af8;
        "pkg-0.0.1-alpha.15.10" = _npKOPEKk;
        "pkg-0.0.1-alpha.16" = _YPw9MkqG;
        "pkg-0.0.1-alpha.17" = _DUt9bRee;
        "pkg-0.0.1-alpha.17.1" = _41jU11OP;
        "pkg-0.0.1-alpha.17.2" = _pr1Ptgpu;
        "pkg-0.0.1-alpha.17.3" = _hH7j0OVk;
        "pkg-0.0.1-alpha.17.4" = _gTyWOVLL;
        "pkg-0.0.1-alpha.17.5" = _1zLsAIgy;
        "pkg-0.0.1-alpha.17.6" = _mHrZ1MaU;
        "pkg-0.0.1-alpha.17.7" = _rA3dgGLH;
        "pkg-0.0.1-alpha.18" = _zmrY5aAE;
        "pkg-0.0.1-alpha.18.1" = _K0RrVgao;
        "pkg-0.0.1-alpha.18.2" = _JctU2Jqz;
        "pkg-0.0.1-alpha.18.3" = _vSGVv0ML;
        "pkg-0.0.1-alpha.18.4" = _tCb8ChGM;
        "pkg-0.0.1-alpha.18.5" = _Svsi3Mk6;
        "pkg-0.0.1-alpha.19" = _o3rQLLjr;
        "pkg-0.0.1-alpha.18.6" = _zG3lWxdO;
        "pkg-0.0.1-alpha.19.1" = _xCXMh2VJ;
        "pkg-0.0.1-alpha.19.2" = _LeRHOpqv;
        "pkg-0.0.1-alpha.19.3" = _bBA3CJxQ;
        "pkg-0.0.1-alpha.19.4" = _CmgVnusp;
        "pkg-0.0.1-alpha.19.5" = _oAeLcfwz;
        "pkg-0.0.1-alpha.19.6" = _hIAVGRLD;
        "pkg-0.0.1-alpha.19.7" = _bbKT4CZP;
        "pkg-4.1.60" = _ypXBkht9;
        "pkg-4.1.61" = _BNXRTlVz;
        "pkg-4.1.70" = _E0FpGrUT;
        "pkg-4.1.80" = _XAoiKZVt;
        "pkg-4.1.90" = _hkGrYScK;
        "pkg-4.1.100" = _RTuMk0Ii;
        "pkg-4.1.101" = _WXhs8bZD;
        "pkg-4.1.102" = _UNIl7w1y;
        "pkg-4.1.103" = _t8aFbnFv;
        "pkg-4.2.0" = _h79rzZF3;
        "pkg-4.1.110" = _OaqE5vUL;
        "pkg-5.0.0" = _iRT6yK6e;
        "pkg-4.1.111" = _JD6LOXaA;
        "pkg-5.0.1" = _FB58mffM;
        "pkg-6.0.0" = _r5QzpeT7;
        "pkg-4.1.120" = _q6JyzUiw;
        "pkg-5.0.10" = _yyzcwM70;
        "pkg-6.0.10" = _UdAE6MFS;
        "pkg-6.1.0" = _lgL9Sx5T;
        "pkg-6.1.1" = _RyUIyI5s;
        "pkg-6.1.10" = _w0d0neoq;
        "pkg-6.1.20" = _9NXiQjnS;
        "pkg-6.2.0" = _51BmUEPI;
        "pkg-6.2.1" = _sGKAHQNv;
        "pkg-6.2.2" = _yOHf6K0h;
        "pkg-6.2.3" = _2v7uczOK;
        "pkg-6.3.0" = _HKoToV5q;
        "pkg-6.3.10" = _Xf9KuB23;
        "pkg-6.3.11" = _Wui126Nk;
        "pkg-7.0.0-beta.1" = _ijuQFxXN;
        "pkg-6.4.0" = _ilBRfgub;
        "pkg-7.0.0" = _siwQivOk;
        "pkg-6.5.0" = _Rzpg5PwU;
