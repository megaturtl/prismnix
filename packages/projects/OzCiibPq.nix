...
let
    versions = (let
        ...
        _WykL4lBe = {
            "id" = "WykL4lBe";
            "file" = "PlayTimeManager-3.6.6.jar";
            "hash" = "sha512-haaY0KLkcl0ttCKl9w8j7x5yH+OVHWDYrwgZbr+pBdzxZ6csX5Sqyzh7MCe5M1tn8VaAivTMeU/UbY7gLKcT/Q==";
        };
    in {
        "I8Qo0LTJ" = _I8Qo0LTJ;
        "v0pWqXvb" = _v0pWqXvb;
        ...
        "C0SSVnbh" = _C0SSVnbh;
        "WykL4lBe" = _WykL4lBe;
        "paper-1.20" = _WykL4lBe;
        "paper-1.20.1" = _WykL4lBe;
        "paper-1.20.2" = _WykL4lBe;
        "paper-1.20.3" = _WykL4lBe;
        "paper-1.20.4" = _WykL4lBe;
        "paper-1.20.5" = _WykL4lBe;
        "paper-1.20.6" = _WykL4lBe;
        "paper-1.21" = _WykL4lBe;
        "paper-1.21.1" = _WykL4lBe;
        "paper-1.21.2" = _WykL4lBe;
        "paper-1.21.3" = _WykL4lBe;
        "paper-1.21.4" = _WykL4lBe;
        "paper-1.19" = _WykL4lBe;
        "paper-1.19.1" = _WykL4lBe;
        "paper-1.19.2" = _WykL4lBe;
        "paper-1.19.3" = _WykL4lBe;
        "paper-1.19.4" = _WykL4lBe;
        "paper-1.21.5" = _WykL4lBe;
        "paper-1.21.6" = _WykL4lBe;
        "paper-1.21.7" = _WykL4lBe;
        "paper-1.21.8" = _WykL4lBe;
        "paper-1.21.9" = _WykL4lBe;
        "paper-1.21.10" = _WykL4lBe;
        "paper-1.21.11" = _WykL4lBe;
        "paper-26.1" = _WykL4lBe;
        "paper-26.1.1" = _WykL4lBe;
        "paper-26.1.2" = _WykL4lBe;
        "paper-26.2" = _WykL4lBe;
        "purpur-1.20" = _WykL4lBe;
        "purpur-1.20.1" = _WykL4lBe;
        "purpur-1.20.2" = _WykL4lBe;
        "purpur-1.20.3" = _WykL4lBe;
        "purpur-1.20.4" = _WykL4lBe;
        "purpur-1.20.5" = _WykL4lBe;
        "purpur-1.20.6" = _WykL4lBe;
        "purpur-1.21" = _WykL4lBe;
        "purpur-1.21.1" = _WykL4lBe;
        "purpur-1.21.2" = _WykL4lBe;
        "purpur-1.21.3" = _WykL4lBe;
        "purpur-1.21.4" = _WykL4lBe;
        "purpur-1.19" = _WykL4lBe;
        "purpur-1.19.1" = _WykL4lBe;
        "purpur-1.19.2" = _WykL4lBe;
        "purpur-1.19.3" = _WykL4lBe;
        "purpur-1.19.4" = _WykL4lBe;
        "purpur-1.21.5" = _WykL4lBe;
        "purpur-1.21.6" = _WykL4lBe;
        "purpur-1.21.7" = _WykL4lBe;
        "purpur-1.21.8" = _WykL4lBe;
        "purpur-1.21.9" = _WykL4lBe;
        "purpur-1.21.10" = _WykL4lBe;
        "purpur-1.21.11" = _WykL4lBe;
        "purpur-26.1" = _WykL4lBe;
        "purpur-26.1.1" = _WykL4lBe;
        "purpur-26.1.2" = _WykL4lBe;
        "purpur-26.2" = _WykL4lBe;
        "pkg-3.3" = _I8Qo0LTJ;
        "pkg-3.3.1" = _v0pWqXvb;
        "pkg-3.3.2" = _pZKYTq9V;
        "pkg-3.4" = _MOMsxk1b;
