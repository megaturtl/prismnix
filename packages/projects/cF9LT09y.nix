...
let
    ...
    in {
        ...
        "pkg-0.1.5-1.21.7" = _Ar2mEYex;
        "pkg-0.1.5-1.21" = _fR3YtnIE;
        "pkg-0.2.0-1.21" = _FVTHjP3g;
        "pkg-0.2.0-1.21.4" = _lGiSvrkj;
        "pkg-0.2.0-1.21.7" = _DBP6dKFQ;
        "pkg-0.2.0-1.21.9" = _j1ESaUpv;
        "pkg-0.3.1-1.21.7" = _4aPYgbMD;
        "pkg-0.3.1-1.21.9" = _ddpXGPP0;
        "pkg-0.3.2-1.21.9" = _10bL1UAa;
        "pkg-0.3.3-1.21.7" = _mpOchRMT;
        "pkg-0.3.3-1.21.9" = _NjWPNu8O;
        "pkg-0.4.0-1.21.7" = _aI035RKd;
        "pkg-0.4.0-1.21.9" = _LnIpdryb;
        "pkg-0.5.0-1.21.7-neoforge" = _bD9tspKG;
        "pkg-0.5.0-1.21.7-fabric" = _4KGrgAtI;
        "pkg-0.5.0-1.21.9-neoforge" = _snkauSJa;
        "pkg-0.5.0-1.21.9-fabric" = _t6Are7ZC;
        "pkg-0.5.0-1.21.11-neoforge" = _98oyyMVK;
        "pkg-0.5.1-1.21.9-fabric" = _pWlVvrtS;
        "pkg-0.5.1-1.21.9-neoforge" = _46ic34qc;
        "pkg-0.5.1-1.21.11-neoforge" = _PFuZjb1t;
        "pkg-0.5.2-1.21.7-neoforge" = _1Tcgbwie;
        "pkg-0.5.2-1.21.9-neoforge" = _EU8nk30J;
        "pkg-0.5.2-1.21.11-neoforge" = _dyK7z7Jw;
        "pkg-0.5.2-1.21.7-fabric" = _V19mHNEB;
        "pkg-0.5.2-1.21.9-fabric" = _EeZmEUIJ;
