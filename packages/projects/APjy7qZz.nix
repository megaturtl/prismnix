...
let
    versions = (let
        ...
        _doA0HC6z = {
            "id" = "doA0HC6z";
            "file" = "vertical-slabs-2.2.0-26.3.jar";
            "hash" = "sha512-QeCwtoyQUpZf80WnsDkfTADpDlyrMV/5aRZeR21GvXiiC93lHe2pu7eJ6HmmsjIQXCtNlyNnNqFVvQjCHzxq1w==";
        };
    in {
        "CEXbd31d" = _CEXbd31d;
        "cJKGJr7E" = _cJKGJr7E;
