...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.1.1.1" = _aTxMkYxT;
        "pkg-1.19-1.2.1.0" = _XZsjIwzz;
        "pkg-1.19.3-1.3.0.0" = _g0h18dVc;
        "pkg-1.19.3-1.3.1.0" = _XKStWhqq;
        "pkg-1.19.3-1.3.2.0" = _9cX2LjMD;
        "pkg-1.19.3-1.3.2.1" = _SKGjN94K;
        "pkg-1.19.2-1.2.2.0" = _YAVJO3tU;
        "pkg-1.19.4-1.4.0.0" = _HtrxTicn;
        "pkg-1.20.1-2.0.0.0" = _D7pDphjB;
        "pkg-1.20.1-2.1.0.0" = _IdivXrIe;
        "pkg-1.20.2-2.2.0.0" = _6fqVjpgN;
        "pkg-1.20.4-3.0.0.0" = _4vdOEtFo;
        "pkg-1.20.4-3.1.0.0" = _L3cbMYY6;
        "pkg-1.20.4-3.1.1.0" = _f5n4Cxzp;
        "pkg-1.20.4-3.1.2.0" = _RpELfuJn;
        "pkg-1.20.4-3.1.2.1" = _I1yjInXs;
        "pkg-1.20.6-3.2.0.0" = _Twc4fYkX;
        "pkg-1.21-4.0.0.0" = _w2mrq4xe;
        "pkg-1.21-4.0.0.1" = _89Qay959;
        "pkg-1.21-4.1.0.0" = _KFNfxl21;
        "pkg-1.21-4.1.1.0" = _65JI0Uzv;
        "pkg-1.20.1-2.1.1.0" = _iwYSgVi3;
        "pkg-1.21.1-4.2.0.0" = _zDk5ZHcT;
        "pkg-1.21.3-4.3.0.0" = _WCsGlnLu;
        "pkg-1.21.3-4.3.0.1" = _nwKLYkT6;
        "pkg-1.21.3-4.3.0.2" = _EjRMcyyO;
        "pkg-1.21.4-4.4.0.0" = _rFTvBcvF;
        "pkg-1.21.5-4.5.0.0" = _RE9f5RMA;
        "pkg-1.21.6-4.6.0.0" = _fFqn3N1T;
        "pkg-1.21.6-4.6.1.0" = _Q7T7UCj4;
        "pkg-1.21.4-4.4.1.0" = _LtMO6kl0;
        "pkg-1.21.5-4.5.1.0" = _E5HkGfyP;
        "pkg-1.21.7-4.7.0.0" = _BrWYRKOA;
        "pkg-1.21.9-4.8.0.0" = _vp8bskUC;
        "pkg-1.21.10-4.9.0.0" = _3aNGp3cX;
        "pkg-1.21.10-4.9.1.0" = _wgcza35f;
        "pkg-1.21.11-4.10.0.0" = _baeDjMdJ;
        "pkg-26.1.1-5.0.0.0" = _fuE7Qf8l;
        "pkg-26.1.1-5.0.0.1" = _8JqETJRG;
