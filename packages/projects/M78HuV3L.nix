...
let
    versions = (let
        ...
        _YbLgt7xp = {
            "id" = "YbLgt7xp";
            "file" = "fabric-gui-imgui-26.2-1.2.0+imgui.1.92.7.1.jar";
            "hash" = "sha512-u5I+oRvFcklV01vFh/WTbShEAtFYwh0FlduvVynP0b37wxxy4M+IjcfTBWW67wiHmU8KpaUptdHrfdZUnW75rA==";
        };
        _I1ckggBb = {
            "id" = "I1ckggBb";
            "file" = "fabric-gui-imgui-26.3-1.2.0+imgui.1.92.7.1.jar";
            "hash" = "sha512-dyrjj6JwMCixp8KrrR09Mp6/7QH97QW+SyG1co8LdFr+UOzYg5S+Mk0cXTpD0PSgaDebrgyV6Jy4rh/bcX/70g==";
        };
        _ss4uxdqr = {
            "id" = "ss4uxdqr";
            "file" = "fabric-gui-imgui-1.8.9-1.2.0+imgui.1.92.7.1.jar";
            "hash" = "sha512-QxVDhjZf6wY9OXOcYMjiiY1uDixIdkYUfBg+A0NvSMLbC1CWlDigMBuYeibGtriSQ3yw6WaDB0VC+RYH6u7GdA==";
        };
        _iwC3hnyE = {
            "id" = "iwC3hnyE";
            "file" = "fabric-gui-imgui-1.9.4-1.2.0+imgui.1.92.7.1.jar";
            "hash" = "sha512-0JtaZ9ftmoZMNbbuhRJUQi31QXxvuqbWKj/DKw7sVKnnnzGaq0B54QBf+el/MnuMFXO6fzpDE7OfARXgLzP9hg==";
        };
        _y0VNaHPp = {
            "id" = "y0VNaHPp";
            "file" = "fabric-gui-imgui-1.12.2-1.2.0+imgui.1.92.7.1.jar";
            "hash" = "sha512-2UHLrp3ouzdQ6s4UWcPHwt2KJr3sLd1m4wR5pmqsJNWagkU8RMfKRNI/COpkqDHg+H9mkMA/GgR5iTXq7P9aXA==";
        };
        _wfNsEKf5 = {
            "id" = "wfNsEKf5";
            "file" = "fabric-gui-imgui-1.10.2-1.2.0+imgui.1.92.7.1.jar";
            "hash" = "sha512-cqDiL7QDAyR9fQ5F3Y8LyDEvKFcxAFkmgZj40oy8KxhkZs6tiS/sEI7kJOlBZPtnQYXyxYimuy9LJyBe5SHY9Q==";
        };
        _lHtIFJDt = {
            "id" = "lHtIFJDt";
            "file" = "fabric-gui-imgui-1.11.2-1.2.0+imgui.1.92.7.1.jar";
            "hash" = "sha512-mYJKw+zTh3vJU77A4qfjFZCh4+6voVefFQEvoc/b6svLQ47mO/qPMHRwEfKiCUBTk2N4gB+TPqFtfY9y805Zpg==";
        };
        _d8sYYHLR = {
            "id" = "d8sYYHLR";
            "file" = "fabric-gui-imgui-1.14.4-1.2.0+imgui.1.92.7.1.jar";
            "hash" = "sha512-K2D1q7OkCyR808TAIsrWt1tfOb0s+IVHtg8/8ctsIKtdmdcYnR3QlNiZU0jIpSkNqnLzmUwEQ3OTJRArDkhmpA==";
        };
        _uogjQKHe = {
            "id" = "uogjQKHe";
            "file" = "fabric-gui-imgui-1.15.2-1.2.0+imgui.1.92.7.1.jar";
            "hash" = "sha512-ooBjSyXnty586Uepv6fpVe7YxdGgg8t8UU914doj3Br9KafTUtJIl5FX6bKm9YjeAcmUMWTEOalZ3c9ogg+yhQ==";
        };
        _LgMPjJEa = {
            "id" = "LgMPjJEa";
            "file" = "fabric-gui-imgui-1.16.5-1.2.0+imgui.1.92.7.1.jar";
            "hash" = "sha512-jga3QLX5EIP+UOn010aHedgIqzxpAXbPe5htKSLrd7+eC/Wt2V2Py6ypzohzqDWol6ArvvfAOzG975gNoxv7oA==";
        };
        _1FiDJHZo = {
            "id" = "1FiDJHZo";
            "file" = "fabric-gui-imgui-1.17.1-1.2.0+imgui.1.92.7.1.jar";
            "hash" = "sha512-d7FWPfsqSeKVRkh+He+TRHwZ0J3WQSl/c0OgQ1dgVVVgmDNd7bOEy6A4YBUpFkeXJXQl4dFviJZe8bk1ZiGKQQ==";
        };
        _aTyFEyn9 = {
            "id" = "aTyFEyn9";
            "file" = "fabric-gui-imgui-1.18.2-1.2.0+imgui.1.92.7.1.jar";
            "hash" = "sha512-94pUXTL6bWVpN5CpGTZ+B1zwdEhAR/TsN6haIgS7IQR71ZF4MPioQ5R7/cdp+QSsZs/mbMCAvikRkZ1IM78T6g==";
        };
        _yQU0RPH2 = {
            "id" = "yQU0RPH2";
            "file" = "fabric-gui-imgui-1.20.6-1.2.0+imgui.1.92.7.1.jar";
            "hash" = "sha512-004mRMaPiu70cpjwQ6XDb4nswIk1czbZR4Z/tMRygpcrY+EsajajZSuDaGBJrVPp09KUGEMA08awdzRY0cFInQ==";
        };
        _ONmjVKyQ = {
            "id" = "ONmjVKyQ";
            "file" = "fabric-gui-imgui-1.19.4-1.2.0+imgui.1.92.7.1.jar";
            "hash" = "sha512-dBZbJlo5rH/LG35RyOtSNLrtvOdhDKelEXKKiUp7bATgqXm3SXka4QZ1zfuolB+1VsWgG/ietOY+sGj1sGoaNA==";
        };
        _4W9IUGA6 = {
            "id" = "4W9IUGA6";
            "file" = "fabric-gui-imgui-1.21.11-1.2.0+imgui.1.92.7.1.jar";
            "hash" = "sha512-S1F0RW0uB6fcgqHMFM2A9S+7Au+Om1V4OFU5gfnIRgRmFbN3BNQUk01WAH3tO2VQo/T8exNAHGdMkYnQt7YWcQ==";
        };
        _aJ7OXulp = {
            "id" = "aJ7OXulp";
    ...
    in {
        ...
        "fabric-1.17.1" = _1FiDJHZo;
        "fabric-1.15.2" = _uogjQKHe;
        "fabric-1.21.11" = _4W9IUGA6;
        "fabric-1.19.4" = _ONmjVKyQ;
        "fabric-1.20.6" = _yQU0RPH2;
        "fabric-1.10.2" = _wfNsEKf5;
        "fabric-1.11.2" = _lHtIFJDt;
        "fabric-1.12.2" = _y0VNaHPp;
        "fabric-1.8.9" = _ss4uxdqr;
        "fabric-1.9.4" = _iwC3hnyE;
        ...
        "pkg-1.17.1-1.0.0+imgui.1.83.3" = _ubzqAxCe;
        "pkg-1.15.2-1.0.0+imgui.1.83.3" = _gE6jq7TY;
        "pkg-1.21.11-1.0.0+imgui.1.90.0" = _1VczN5Wv;
        "pkg-1.19.4-1.0.0+imgui.1.90.0" = _uMDWVgc2;
        "pkg-1.20.6-1.0.0+imgui.1.90.0" = _4O6UsmBb;
        "pkg-1.14.4-1.0.1+imgui.1.86.12" = _VdY5yBnx;
        "pkg-1.15.2-1.0.1+imgui.1.86.12" = _iVLmE5Tm;
        "pkg-1.10.2-1.0.1+imgui.1.86.12" = _IooC9D5V;
        "pkg-1.11.2-1.0.1+imgui.1.86.12" = _5CQN1XO6;
        "pkg-1.17.1-1.0.1+imgui.1.86.12" = _zy8h2cAJ;
        "pkg-1.16.5-1.0.1+imgui.1.86.12" = _sVs9y7ZR;
        "pkg-1.12.2-1.0.1+imgui.1.86.12" = _RnrDFr2H;
        "pkg-1.18.2-1.0.1+imgui.1.86.12" = _6ftU8fCX;
        "pkg-1.20.6-1.0.1+imgui.1.90.0" = _yu51CLMz;
        "pkg-1.19.4-1.0.1+imgui.1.90.0" = _TXNWvgxx;
        "pkg-1.21.11-1.0.1+imgui.1.90.0" = _YuVtPtE6;
        "pkg-1.8.9-1.0.1+imgui.1.86.12" = _6sBTJqUU;
        "pkg-1.9.4-1.0.1+imgui.1.86.12" = _EgBGq73R;
        "pkg-26.1-1.0.1+imgui.1.90.0" = _6EglZIJB;
        "pkg-26.1-pre-1-1.0.1+imgui.1.90.0" = _TvxArLpR;
        "pkg-1.11.2-1.0.3+imgui.1.90.0" = _7T1j2bRZ;
        "pkg-1.15.2-1.0.3+imgui.1.90.0" = _1oKrI6mo;
        "pkg-1.19.4-1.0.3+imgui.1.90.0" = _rJQ5Dzm9;
        "pkg-1.17.1-1.0.3+imgui.1.90.0" = _OAfuoLq7;
        "pkg-1.20.6-1.0.3+imgui.1.90.0" = _qZIOQKOG;
        "pkg-1.21.11-1.0.3+imgui.1.90.0" = _X11r5ZR7;
        "pkg-26.1-rc-3-1.0.3+imgui.1.90.0" = _2kBK3n5Z;
        "pkg-1.18.2-1.0.3+imgui.1.90.0" = _2yWrO3Vl;
        "pkg-1.8.9-1.0.3+imgui.1.90.0" = _RL0vg97C;
        "pkg-1.16.5-1.0.3+imgui.1.90.0" = _zC2tS8NT;
        "pkg-1.10.2-1.0.3+imgui.1.90.0" = _xV7dHMiF;
        "pkg-1.14.4-1.0.3+imgui.1.90.0" = _kKFt8fIP;
        "pkg-1.12.2-1.0.3+imgui.1.90.0" = _UoEpHkFu;
        "pkg-1.9.4-1.0.3+imgui.1.90.0" = _QJZLaD5G;
        "pkg-1.12.2-1.0.4+imgui.1.90.0" = _vshTaL0u;
        "pkg-1.14.4-1.0.4+imgui.1.90.0" = _TX6oY4n0;
        "pkg-1.17.1-1.0.4+imgui.1.90.0" = _eGngVTBH;
        "pkg-1.18.2-1.0.4+imgui.1.90.0" = _gSIgG9MG;
        "pkg-1.11.2-1.0.4+imgui.1.90.0" = _EyABQQ8W;
        "pkg-1.19.4-1.0.4+imgui.1.90.0" = _FWTSpRyi;
        "pkg-1.20.6-1.0.4+imgui.1.90.0" = _aejcD4I5;
        "pkg-1.9.4-1.0.4+imgui.1.90.0" = _SNC2WJVZ;
        "pkg-26.1-1.0.4+imgui.1.90.0" = _z0f3W8qM;
        "pkg-1.21.11-1.0.4+imgui.1.90.0" = _7IEv3ege;
        "pkg-1.8.9-1.0.4+imgui.1.90.0" = _zfiU7PC2;
        "pkg-1.15.2-1.0.4+imgui.1.90.0" = _dJOhfaeV;
        "pkg-1.16.5-1.0.4+imgui.1.90.0" = _kVqp9hQs;
        "pkg-1.10.2-1.0.4+imgui.1.90.0" = _d1i0bUp0;
        "pkg-1.12.2-1.0.6+imgui.1.90.0" = _fZsPxTyE;
        "pkg-1.10.2-1.0.6+imgui.1.90.0" = _xpnGf8fH;
        "pkg-1.15.2-1.0.6+imgui.1.90.0" = _XklLxdwq;
        "pkg-1.16.5-1.0.6+imgui.1.90.0" = _kT1mXrgb;
        "pkg-1.11.2-1.0.6+imgui.1.90.0" = _oLJTUPXd;
        "pkg-1.14.4-1.0.6+imgui.1.90.0" = _vepARBBz;
        "pkg-1.17.1-1.0.6+imgui.1.90.0" = _JwDIHNse;
        "pkg-1.18.2-1.0.6+imgui.1.90.0" = _mbbqnUqz;
        "pkg-1.19.4-1.0.6+imgui.1.90.0" = _5pp9krrB;
        "pkg-1.20.6-1.0.6+imgui.1.90.0" = _n9qqKWIj;
        "pkg-1.8.9-1.0.6+imgui.1.90.0" = _2hfJ0Tfi;
        "pkg-26.1-1.0.6+imgui.1.90.0" = _zYiaeV5A;
        "pkg-1.9.4-1.0.6+imgui.1.90.0" = _V1triB2j;
        "pkg-1.12.2-1.0.7+imgui.1.90.0" = _1dGsv0at;
        "pkg-1.15.2-1.0.7+imgui.1.90.0" = _U95Tou2s;
        "pkg-1.14.4-1.0.7+imgui.1.90.0" = _6ezFYeHb;
        "pkg-1.11.2-1.0.7+imgui.1.90.0" = _CkdazRnF;
        "pkg-1.10.2-1.0.7+imgui.1.90.0" = _YXCycpUk;
        "pkg-1.16.5-1.0.7+imgui.1.90.0" = _qPC9OGui;
        "pkg-1.17.1-1.0.7+imgui.1.90.0" = _9qmUpL3R;
        "pkg-1.20.6-1.0.7+imgui.1.90.0" = _shCJ0pij;
        "pkg-1.18.2-1.0.7+imgui.1.90.0" = _bJRni7iC;
        "pkg-1.19.4-1.0.7+imgui.1.90.0" = _I7cMXcWu;
        "pkg-26.1-1.0.7+imgui.1.90.0" = _cxrRlAdI;
        "pkg-1.8.9-1.0.7+imgui.1.90.0" = _qNRhSHgv;
        "pkg-1.21.11-1.0.7+imgui.1.90.0" = _zYVc7ASR;
        "pkg-1.9.4-1.0.7+imgui.1.90.0" = _ZUSSTPd1;
        "pkg-1.19.4-1.0.7+imgui.1.92.0" = _P3GpM2ih;
        "pkg-1.14.4-1.0.7+imgui.1.92.0" = _ojVDYIyb;
        "pkg-1.12.2-1.0.7+imgui.1.92.0" = _CIRgBenk;
        "pkg-1.10.2-1.0.7+imgui.1.92.0" = _2BZK2BQ2;
        "pkg-1.20.6-1.0.7+imgui.1.92.0" = _ucouU4OR;
        "pkg-1.15.2-1.0.7+imgui.1.92.0" = _f0QI6hsU;
        "pkg-1.16.5-1.0.7+imgui.1.92.0" = _GE8cOvvv;
        "pkg-1.11.2-1.0.7+imgui.1.92.0" = _3ux1XVgx;
        "pkg-1.18.2-1.0.7+imgui.1.92.0" = _VXy2iT6k;
        "pkg-1.17.1-1.0.7+imgui.1.92.0" = _7mbTukn7;
        "pkg-1.9.4-1.0.7+imgui.1.92.0" = _rz58uCdu;
        "pkg-26.1-1.0.7+imgui.1.92.0" = _Fx8pEqa8;
        "pkg-1.21.11-1.0.7+imgui.1.92.0" = _kakBu46N;
        "pkg-1.8.9-1.0.7+imgui.1.92.0" = _DiLlAzoH;
        "pkg-26.2-1.0.7+imgui.1.92.0" = _v3ZjQu27;
        "pkg-1.19.4-1.0.8+imgui.1.92.0" = _ItthpmYF;
        "pkg-1.20.6-1.0.8+imgui.1.92.0" = _iOyw3mk3;
        "pkg-1.21.11-1.0.8+imgui.1.92.0" = _EXtnNWAL;
        "pkg-26.2-1.0.8+imgui.1.92.0" = _7zuUNygn;
        "pkg-1.10.2-1.0.11+imgui.1.92.0" = _nRuASx85;
        "pkg-1.11.2-1.0.11+imgui.1.92.0" = _lwmNvY4K;
        "pkg-1.12.2-1.0.11+imgui.1.92.0" = _VrtzfNhW;
        "pkg-1.14.4-1.0.11+imgui.1.92.0" = _XBYIWiEZ;
        "pkg-1.16.5-1.0.11+imgui.1.92.0" = _Qp2Hkpw8;
        "pkg-1.15.2-1.0.11+imgui.1.92.0" = _XaSPodo9;
        "pkg-1.17.1-1.0.11+imgui.1.92.0" = _eNptsRfS;
        "pkg-1.18.2-1.0.11+imgui.1.92.0" = _9yZ2DGwC;
        "pkg-1.19.4-1.0.11+imgui.1.92.0" = _6pkdQpkc;
        "pkg-1.20.6-1.0.11+imgui.1.92.0" = _e6TbkBcT;
        "pkg-1.21.11-1.0.11+imgui.1.92.0" = _AfFYQ2fE;
        "pkg-1.8.9-1.0.11+imgui.1.92.0" = _L4uOlqlg;
        "pkg-1.9.4-1.0.11+imgui.1.92.0" = _UKzMGNOW;
        "pkg-26.1-1.0.11+imgui.1.92.0" = _EvLr30th;
        "pkg-26.2-1.0.11+imgui.1.92.0" = _rBd6uQDZ;
        "pkg-26.2-1.1.0+imgui.1.92.0" = _4pDF3wVK;
        "pkg-26.2-1.2.0+imgui.1.92.7.1" = _YbLgt7xp;
        "pkg-26.3-1.2.0+imgui.1.92.7.1" = _I1ckggBb;
        "pkg-1.8.9-1.2.0+imgui.1.92.7.1" = _ss4uxdqr;
        "pkg-1.9.4-1.2.0+imgui.1.92.7.1" = _iwC3hnyE;
        "pkg-1.12.2-1.2.0+imgui.1.92.7.1" = _y0VNaHPp;
        "pkg-1.10.2-1.2.0+imgui.1.92.7.1" = _wfNsEKf5;
        "pkg-1.11.2-1.2.0+imgui.1.92.7.1" = _lHtIFJDt;
        "pkg-1.14.4-1.2.0+imgui.1.92.7.1" = _d8sYYHLR;
        "pkg-1.15.2-1.2.0+imgui.1.92.7.1" = _uogjQKHe;
        "pkg-1.16.5-1.2.0+imgui.1.92.7.1" = _LgMPjJEa;
        "pkg-1.17.1-1.2.0+imgui.1.92.7.1" = _1FiDJHZo;
        "pkg-1.18.2-1.2.0+imgui.1.92.7.1" = _aTyFEyn9;
        "pkg-1.20.6-1.2.0+imgui.1.92.7.1" = _yQU0RPH2;
