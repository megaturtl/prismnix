...
let
    ...
    in {
        ...
        "pkg-1.1.0-fabric-1.19" = _i03VcmE1;
        "pkg-1.1.1-forge-1.19" = _r75vdxbl;
        "pkg-1.1.1-fabric-1.19" = _O9tyRiWd;
        "pkg-1.1.1-forge-1.19.3" = _FqO6bYLE;
        "pkg-1.1.1-fabric-1.19.3" = _V8qZSaSB;
        "pkg-1.1.1-1.19.4" = _WS3KTeGu;
        "pkg-1.1.1-1.20" = _8dRUZUPx;
        "pkg-1.1.2-1.20.2" = _aPkSBw5z;
        "pkg-1.2.0" = _4W6XOp0r;
        "pkg-1.2.1" = _8ykvkxik;
        "pkg-1.2.2" = _xGR5PFgM;
        "pkg-1.2.3" = _yboML9Ye;
