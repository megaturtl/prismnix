...
let
    ...
    in {
        ...
        "pkg-1.3.3" = _SrOlbalS;
        "pkg-1.4.0" = _N7hzNrJ0;
        "pkg-2.0.0-alpha.1" = _N2vqfrQG;
        "pkg-2.0.0-beta.1" = _ETm7Rocy;
        "pkg-3.0.0-beta.1" = _zqhmnW1d;
        "pkg-2.0.0-beta.2" = _sQFzhzZR;
        "pkg-2.0.0" = _P6Ip1kVF;
        "pkg-3.0.0" = _Bbebcy6S;
        "pkg-3.0.1" = _TqTAp21U;
        "pkg-2.0.1" = _1G1dU3QN;
        ...
        "pkg-2.0.2" = _6sOe6HKi;
        "pkg-3.0.3" = _YXu2oSCB;
        "pkg-3.1.0-beta.1" = _Xp99Z2eD;
        "pkg-3.1.0-beta.2" = _nDjMgG3o;
        "pkg-3.1.0" = _Xk3tNU7P;
        "pkg-3.2.0-alpha.1" = _Ca7E9BEX;
        "pkg-3.2.0-alpha.2" = _iN1w0lzc;
        "pkg-3.2.0-alpha.3" = _UzrDWxVy;
        "pkg-3.2.0-beta.1" = _qgzobOhF;
        "pkg-3.2.0-beta.2" = _VEebnD22;
        "pkg-3.2.0" = _VWwNdGuZ;
        "pkg-4.0.0-alpha.1" = _mYehFDQV;
        "pkg-4.0.0-alpha.2" = _8aDCDYTX;
        "pkg-4.0.0-alpha.3" = _XF4t72eR;
        "pkg-4.0.0-beta.1" = _ejwee52r;
        "pkg-3.2.1" = _6oElTuD0;
        "pkg-3.0.4" = _910n1brV;
        "pkg-4.0.0-beta.2" = _MP5BwWxR;
        "pkg-4.0.0-beta.3" = _Z3Qfru5i;
        "pkg-4.0.0" = _eMtk0Nja;
        "pkg-3.0.5" = _jMFmgXqC;
        "pkg-3.2.2" = _3MmcUaAR;
        "pkg-4.0.1" = _yZSUi1Sj;
        ...
        "pkg-4.0.7" = _5pQKnV2k;
        "pkg-4.0.8" = _HCDPkEm0;
        "pkg-4.1.0-beta.1" = _VPkP7YxJ;
        "pkg-4.1.0" = _n8XufYAv;
        "pkg-3.0.7" = _CctxymNl;
        "pkg-3.2.5" = _LaBpvRIB;
        "pkg-4.0.9" = _2mBOodyG;
        "pkg-4.1.1" = _zqpi5eD7;
        "pkg-4.2.0-beta.1" = _9WSvbDKm;
        "pkg-4.0.10" = _J1toYNYJ;
        "pkg-4.1.2" = _d3JXIGc1;
        "pkg-4.2.0" = _fEVB22T8;
        "pkg-4.3.0-alpha.1" = _2fWj91Qj;
        "pkg-4.3.0-alpha.2" = _HSpU8rjE;
        "pkg-4.3.0-alpha.3" = _KYEwXOj9;
        "pkg-4.3.0-alpha.4" = _2JtKEwXS;
        "pkg-4.3.0-alpha.5" = _Ox5qg8EU;
        "pkg-4.3.0-beta.1" = _eDUhik91;
        "pkg-4.3.0" = _QLLwBxm6;
        "pkg-4.3.1" = _JSqdtx8k;
        "pkg-5.0.0-alpha.1" = _FmCrKPem;
        "pkg-5.0.0-beta.1" = _I6MsYBtu;
        "pkg-5.0.0-beta.2" = _MHELy3iO;
        "pkg-5.0.0" = _TVdizIfm;
        "pkg-5.0.1" = _7YaA4bki;
        "pkg-5.0.2" = _4kIdaOel;
        "pkg-5.1.0-beta.1" = _KSMr4VgC;
        "pkg-5.1.0" = _yDaHb4IE;
        "pkg-5.2.0-beta.1" = _fXBQFBmv;
        "pkg-5.2.0" = _Pl5x6565;
        "pkg-5.2.1-beta.1" = _cfmLvzCI;
        "pkg-5.2.1" = _InLjnneN;
        "pkg-5.3.0-beta.1" = _57K575GJ;
        "pkg-5.3.0" = _PWV61uAQ;
        "pkg-5.4.0-alpha.1" = _DLpKB6lt;
        "pkg-5.4.0" = _wKqrBEoQ;
        "pkg-5.0.3" = _v1sd5SgW;
        "pkg-5.1.1" = _tD7VkEEB;
        "pkg-5.2.2" = _zkgFs7tB;
        "pkg-5.3.1" = _Hp8PVyND;
        "pkg-5.5.0-alpha.1" = _mLrIaLcu;
        "pkg-5.0.4" = _SfC0eS36;
        "pkg-5.1.2" = _IxVyD9Bi;
        "pkg-5.2.3" = _KQE4FvW6;
        "pkg-5.3.2" = _BUPS8Due;
        "pkg-5.4.1" = _2xrK5Epz;
        "pkg-5.5.0-beta.1" = _6yjmgz2v;
        "pkg-5.5.0" = _4CZjZiUu;
        "pkg-5.6.0-alpha.1" = _6MWFK1go;
        "pkg-5.5.1" = _vhCDKfXZ;
        "pkg-5.6.0-beta.1" = _CqgIxref;
        "pkg-5.6.0" = _uipDCZCz;
