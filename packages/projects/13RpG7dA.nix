...
let
    versions = (let
        ...
        _RLSKXT7Y = {
            "id" = "RLSKXT7Y";
            "file" = "image2map-0.15.0+26.3.jar";
            "hash" = "sha512-EQUQVE7xBXeK1+/RX2dtz8+n+Ax63JAjcLTCejTt9jM9vMe3oSDm/5KP6Ym1rjhkpEBisXDpaqPpcFexdQq63Q==";
        };
    in {
        "Ce5RGgDh" = _Ce5RGgDh;
        "MFggDziY" = _MFggDziY;
        ...
        "fabric-26.3-rc-1" = _RLSKXT7Y;
        "fabric-26.3" = _RLSKXT7Y;
        ...
        "pkg-0.4.0" = _ASZkYwfK;
        "pkg-0.4.1" = _QnB7ZxI8;
        "pkg-0.4.2+1.20" = _T71Apams;
        "pkg-0.5.0+1.20.2" = _WudmzbSR;
        "pkg-0.6.0+1.20.6" = _Xq3Hv1Vg;
        "pkg-0.7.0+1.21" = _esrvoaS1;
        "pkg-0.7.1+1.21" = _IcHYiWHv;
        "pkg-0.8.0+1.21.3" = _kkdbWskW;
        "pkg-0.9.0+1.21.5" = _xKDGxPer;
        "pkg-0.10.0+1.21.6" = _HWFiTv1w;
        "pkg-0.10.1+1.21.6" = _bJYNHoyD;
        "pkg-0.11.0+1.21.9" = _1dazBIRA;
        "pkg-0.12.0+1.21.11" = _GFJiLICt;
        "pkg-0.12.1+1.21.11" = _4FM4yQRK;
        "pkg-0.13.0+26.1" = _jDVRjmOU;
        "pkg-0.13.1+26.1" = _ozCorCuJ;
        "pkg-0.14.0+26.2" = _RKJFfwTN;
        "pkg-0.15.0+26.3" = _RLSKXT7Y;
        "default" = _RLSKXT7Y;
    });
