...
let
    ...
    in {
        ...
        "pkg-1.2" = _HJHR6XlR;
        "pkg-1.2+mod" = _l0zHLAPb;
        "pkg-2.0" = _ZwhHQJkU;
        "pkg-2.0+mod" = _R0WxVog2;
        "pkg-2.1" = _TM4ne17j;
        "pkg-2.1+mod" = _6oBGQGTE;
        "pkg-2.2" = _lDxZOgXO;
        "pkg-2.2+mod" = _PazvFuTU;
        "pkg-2.3" = _8JLrkSkd;
        "pkg-2.3+mod" = _ay3qsZd7;
        "pkg-2.4" = _lOcTe6eF;
        "pkg-2.4+mod" = _Y8XSIlDs;
        "pkg-2.5" = _u2YUrhAF;
        "pkg-2.5+mod" = _DGfjEp7L;
        "pkg-3.0" = _LbZCXRIB;
        "pkg-3.0+mod" = _TBBerTNu;
        "pkg-3.1" = _uPCxKRbr;
        "pkg-3.1+mod" = _BruSswKl;
        "pkg-3.2" = _yw6wcpMN;
        "pkg-3.2+mod" = _wT7NggL7;
        "pkg-3.3" = _LXQeZEqB;
        "pkg-3.3+mod" = _XUy5zBUl;
        "pkg-3.4" = _ryezyxrN;
        "pkg-3.4+mod" = _dYfPEOWS;
        "pkg-3.5" = _a3i9Hxyi;
        "pkg-3.5+mod" = _NDxcQPCr;
        "pkg-3.6" = _jMBnvbwB;
