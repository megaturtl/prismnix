...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.20.2" = _Ck4NNAtp;
        "pkg-1.0.0+1.19.3" = _35yZnARN;
        "pkg-1.0.0+1.19.4" = _AbAKdUib;
        "pkg-1.0.1+1.18.2" = _1ehHtLr8;
        "pkg-1.0.1+1.19.2" = _6m5j365w;
        "pkg-1.0.1+1.19.3" = _fegmFbac;
        "pkg-1.0.1+1.19.4" = _sl74543K;
        "pkg-1.0.1+1.20.1" = _QMsV1RGr;
        "pkg-1.0.1+1.20.2" = _6B73MDT8;
        "pkg-1.0.1+1.20.4" = _KFbXS7lm;
        "pkg-1.0.2+1.19.2" = _kUlR2Y1B;
        "pkg-1.0.2+1.20.1" = _GcA1Yr3u;
        "pkg-1.0.2+1.20.4" = _3He8fKJR;
        "pkg-2.0.0+1.21.3" = _Z4JaSUtu;
        "pkg-2.0.0+1.20.1" = _DVfIgm1b;
        "pkg-2.0.1+1.21.3" = _hav6qKnq;
        "pkg-2.0.2+1.21.3" = _1Q5uM2K5;
        "pkg-2.0.2+1.20.1" = _Q7mK8eQL;
        "pkg-2.0.3+1.21.3" = _4I1fYbSs;
        "pkg-2.0.3+1.20.1" = _vq9OP1B7;
        "pkg-neoforge-2.1.0-1.21.6" = _f9qHvlvU;
        "pkg-2.1.0" = _NuqEDV8s;
        "pkg-neoforge-2.1.0-1.21.11" = _aTBWjMKL;
        "pkg-fabric-2.1.0-1.21.11" = _PxHTwRPi;
