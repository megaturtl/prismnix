...
let
    ...
    in {
        ...
        "pkg-1.19+1.0.1" = _yyZxABix;
        "pkg-1.20+1.0.1" = _p2Bv7Lbx;
        "pkg-1.19+1.1.0" = _w8u4gncl;
        "pkg-1.20+1.1.0" = _98HqYozS;
        "pkg-1.20+1.1.1" = _TPGWfKfQ;
        "pkg-1.20+1.1.2" = _g0rvzyyu;
        "pkg-1.20.5+1.2.0" = _yDmCW1eU;
        "pkg-1.20+1.1.3" = _MaNwCkjx;
        "pkg-1.20.5+1.2.1" = _XfXuxsCX;
        "pkg-1.20+1.1.4" = _7r3LTTSC;
        "pkg-1.20.5+1.2.2" = _rllzQMbe;
        "pkg-1.21+2.0.0" = _zaKRN6ll;
        "pkg-1.20.5+1.2.3" = _1RubQlK9;
        "pkg-1.21+2.0.1" = _Zr2EtMGZ;
        "pkg-1.20+1.2.0" = _LHyXjHK7;
        "pkg-1.21+2.1.0" = _oezuMV7P;
        "pkg-1.20.5+1.3.0" = _uSiguVGP;
        "pkg-1.20+1.2.1" = _htpC27Sy;
        "pkg-1.21+2.1.1" = _Iji5SYYO;
        "pkg-1.21.2+2.2.0" = _NOKYJEI7;
        "pkg-1.21.4+2.3.0" = _h44x5R1f;
        "pkg-1.21+2.2.0" = _gfh73K3Q;
        "pkg-1.21.2+2.3.0" = _YxnZgr5J;
        "pkg-1.21.4+2.4.0" = _uKERaSpc;
        "pkg-1.21.4+2.4.1" = _JGLIHjsC;
        "pkg-1.21.5+2.5.0" = _FM48fazP;
        "pkg-1.21.5+2.5.1" = _HHuLVqPP;
        "pkg-1.21.9+2.6.0" = _b69QIPOS;
        "pkg-1.21.10+2.6.0" = _LUwVpkAR;
        "pkg-1.21+2.3.0" = _XUS5ay37;
