...
let
    versions = (let
        ...
        _qE039OfC = {
            "id" = "qE039OfC";
            "file" = "modernwarpmenu-0.2.4+26.1.2.jar";
            "hash" = "sha512-zJWeIqs5a3vR7SmJIs5M+e6P9ZkW0wsFWh7yYPoOcqYvm3fOVbLwH+yXTkJgL9AxeO4kz9pZlv+QraLMwdCdiw==";
        };
        _S1zuZcDp = {
            "id" = "S1zuZcDp";
            "file" = "modernwarpmenu-0.2.4+26.2.jar";
            "hash" = "sha512-L3qCmkWjMbTWOs55Z8gtusSFQ2AEWbHTw/IP31jbvR77Ypb7iZyxt7x1RrB4f6HnhrFDHMGRfJvHsK7jixYIEg==";
        };
    in {
        "y5iWOKvm" = _y5iWOKvm;
        "ArS8x1y8" = _ArS8x1y8;
        ...
        "fabric-26.1.2" = _qE039OfC;
        "fabric-26.2" = _S1zuZcDp;
        "pkg-0.1.0+1.21.5" = _y5iWOKvm;
        "pkg-0.1.1+1.21.5" = _ArS8x1y8;
        "pkg-0.1.2+1.21.5" = _riUy8J6w;
        "pkg-0.1.3+1.21.5" = _2Z3eq9Zz;
        "pkg-0.1.4+1.21.5" = _oKy8OraE;
        "pkg-0.1.4+1.21.6" = _A4fd5pyf;
        "pkg-0.1.5+1.21.5" = _wBvvbUxJ;
        "pkg-0.1.5+1.21.6" = _KDnG16HQ;
        "pkg-0.1.6+1.21.8" = _OMORnOSo;
        "pkg-0.1.6+1.21.5" = _OfaNTHkL;
        "pkg-0.1.7+1.21.8" = _wG93nY0U;
        "pkg-0.1.7+1.21.5" = _4fGtP7G7;
        "pkg-0.1.8+1.21.10" = _ArQ293GZ;
        "pkg-0.1.8+1.21.8" = _RfJ2q4Y5;
        "pkg-0.1.8+1.21.5" = _q9LpwtQZ;
        "pkg-0.1.9+1.21.10" = _jGwTrNH6;
        "pkg-0.1.9+1.21.11" = _9VbNawGb;
        "pkg-0.2.0+1.21.11" = _al46awjs;
        "pkg-0.2.1+1.21.11" = _pM1wejbu;
        "pkg-0.2.2+1.21.11" = _XgWqk8ik;
        "pkg-0.2.2+26.1.2" = _WRUG9UUW;
        "pkg-0.2.3+26.1.2" = _DgfriHoh;
        "pkg-0.2.4+26.1.2" = _qE039OfC;
        "pkg-0.2.4+26.2" = _S1zuZcDp;
        "default" = _S1zuZcDp;
    });
