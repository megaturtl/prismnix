...
let
    ...
    in {
        ...
        "pkg-3.0.4" = _1GIe6ib3;
        "pkg-3.0.5" = _OoWE77Ne;
        "pkg-3.0.5.1" = _GsnRFsYp;
        "pkg-3.0.6" = _zouBKMMd;
        "pkg-3.0.7" = _UhYWAJc8;
        "pkg-3.0.7.1" = _u4AaKy2o;
        "pkg-3.0.8" = _orYLXoam;
        "pkg-3.0.9" = _KToByEzf;
        "pkg-3.1.0.1" = _NhIwNK8Y;
        "pkg-3.1.1" = _I66mX7FV;
        "pkg-3.1.2" = _DXsZU3VK;
        "pkg-3.1.4" = _YslC4k7L;
        "pkg-3.1.5" = _TE8wEtTu;
