...
let
    versions = (let
        ...
        _pMKn1cO1 = {
            "id" = "pMKn1cO1";
            "file" = "cobblemon-leaderboards-neoforge-3.0.jar";
            "hash" = "sha512-4iNcgnuo7wpi1i/GCrmBEpz2J0tFkW01uPjT5YB5EPzJ7Y9bfzAAHplHkZAXnOmtyz+ya7Zr8DW7l0mKLUcQpA==";
        };
        _bHEAkQl5 = {
            "id" = "bHEAkQl5";
            "file" = "cobblemon-leaderboards-fabric-3.0.jar";
            "hash" = "sha512-ATPcmpa5VpZJMgVG8AIFho908g7xd9cZCwW68JgTxrod3Yu6l/L3K/aNpWRxA0AnSgHuw7/J3qV4ydZ7MCE1yg==";
        };
    in {
        "tsK8cgoK" = _tsK8cgoK;
        "5NFHjf5w" = _5NFHjf5w;
        ...
        "pMKn1cO1" = _pMKn1cO1;
        "bHEAkQl5" = _bHEAkQl5;
        "neoforge-1.21.1" = _pMKn1cO1;
        "fabric-1.21.1" = _bHEAkQl5;
        "pkg-1.0" = _5NFHjf5w;
        "pkg-1.1" = _g5OcScCu;
        "pkg-1.2" = _4hI30SOC;
        "pkg-1.3" = _x2qVyZHb;
