...
let
    ...
    in {
        ...
        "pkg-1.20.4-3.1.0" = _IfqGNvxt;
        "pkg-4.0.0+1.20.6" = _9xPy90J8;
        "pkg-4.0.1+1.20.6" = _IyuF7g7g;
        "pkg-4.0.2+1.21" = _Uhakpg6v;
        "pkg-4.0.2+1.20.6" = _Iedejy59;
        "pkg-4.1.0+1.20.6" = _a9KAs0fI;
        "pkg-4.1.0+1.21" = _lOx6r06U;
        "pkg-4.2.0+1.20.6" = _t7WaNrJI;
        "pkg-4.2.0+1.21" = _ZfblhjBq;
        "pkg-4.2.1+1.21.1" = _ubNRqrcT;
        "pkg-4.2.1+1.20.6" = _gPsJBB76;
        "pkg-4.3.0+1.20.6" = _zKm02fxT;
        "pkg-4.3.0+1.21.1" = _cOFvoBiZ;
        "pkg-4.3.1+1.21.3" = _U6V6zOOs;
        "pkg-4.4.0+1.21.4" = _yAdARbZT;
        "pkg-4.4.0+1.21.1" = _475lPsnU;
        "pkg-4.4.1+1.21.4" = _ZyRetIgl;
        "pkg-4.4.1+1.21.1" = _PW8V1HBQ;
        "pkg-4.4.2+1.21.1" = _2yNpTd4X;
        "pkg-4.4.2+1.21.5" = _K292KPo7;
        "pkg-4.4.3+1.21.1" = _FQCUgiMR;
        "pkg-4.4.3+1.21.5" = _N6hheENI;
        "pkg-4.4.4+1.21.1" = _MqPWUGdr;
        "pkg-4.4.4+1.21.5" = _5oKNJ97h;
        "pkg-4.4.4+1.21.6" = _n9M263US;
        "pkg-4.4.4+1.21.7" = _4OzsSL5B;
        "pkg-4.4.4+1.21.8" = _CCTniMzo;
        "pkg-4.4.4+1.20.1" = _YSF3KFGd;
        "pkg-4.4.4+1.21.9" = _9dnrc8E4;
        "pkg-4.4.4+1.21.10" = _xzEWgadt;
        "pkg-4.5.0+1.21.11" = _EMCfxXKl;
        "pkg-5.0.0+26.1" = _E3Nu42Pt;
