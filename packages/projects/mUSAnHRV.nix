...
let
    ...
    in {
        ...
        "pkg-0.8.12-SNAPSHOT+mc26.1.2-local" = _wD6JRMxh;
        "pkg-Mercurizer-1.21.11-1.1" = _4Dn9h5gs;
        "pkg-Mercurizer-26.1-1.1" = _bvlXSXdY;
        "pkg-Mercurizer-26.1.1-1.1" = _lsXyEYvA;
        "pkg-Mercurizer-26.1.2-1.1-hotfix" = _AMsrJi7O;
        "pkg-0.8.12+mc1.21.11-1.2" = _jPkpXwOk;
        "pkg-0.8.9+mc26.1-1.2" = _UJFpmQJF;
        "pkg-0.8.9+mc26.1.1-1.2" = _N8705jiC;
        "pkg-0.8.12+mc26.1.2-1.2" = _ahsNrbvi;
        "pkg-0.9.0+mc26.2-1.0" = _lDZKMHXM;
        "pkg-0.8.12+mc1.21.11-1.3" = _NXsiFDKi;
        "pkg-0.8.9+mc26.1-1.3" = _QqJhgoQh;
        "pkg-0.8.9+mc26.1.1-1.3" = _SRRVkhFt;
        "pkg-0.8.12+mc26.1.2-1.3" = _NIR558Kr;
        "pkg-0.9.0+mc26.2-1.1" = _zh55CDnI;
        "pkg-0.8.13-beta.2+mc1.21.11-1.0" = _u8Hj2SSq;
        "pkg-0.8.9+mc26.1-1.4" = _xmppygn8;
        "pkg-0.8.9+mc26.1.1-1.4" = _7eICx334;
        "pkg-0.9.1-beta.2+mc26.1.2-1.0" = _4idhEXTf;
        "pkg-0.9.1-beta.2+mc26.2-1.0" = _MDMm5Hdn;
        "pkg-0.8.13-beta.2+mc1.21.11-1.1" = _8iHm6wJO;
        "pkg-0.8.9+mc26.1-1.5" = _3w61r8Mf;
        "pkg-0.8.9+mc26.1.1-1.5" = _hbgfZ0Rr;
        "pkg-0.9.1-beta.2+mc26.1.2-1.1" = _T5L3dkmZ;
        "pkg-0.9.1-beta.2+mc26.2-1.1" = _IyTFkI9o;
        "pkg-0.8.13+mc1.21.11-1.0" = _KDZwd9fO;
        "pkg-0.8.9+mc26.1-1.6" = _RUHZyy2s;
        "pkg-0.8.9+mc26.1.1-1.6" = _w3N8Hxfj;
        "pkg-0.9.1+mc26.1.2-1.0" = _YL3dTeJw;
        "pkg-0.9.1+mc26.2-1.0" = _hw8bOmde;
        "pkg-0.8.13+mc1.21.11-1.1" = _hVeVbeEZ;
        "pkg-0.8.9+mc26.1-1.7" = _jm43Hg69;
