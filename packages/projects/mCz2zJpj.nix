...
let
    versions = (let
        ...
        _w3I3ssj4 = {
            "id" = "w3I3ssj4";
            "file" = "item-rename-1.3.2+26.2.jar";
            "hash" = "sha512-Z0ArBloyYh0vwm0yrLk/QD3pwRzWqjyiL57HXuTU0Voqg3DB4qXdzidz1833D840e0IdoiWgYrfzMxQxsSdknQ==";
        };
    in {
        "ous9Egr5" = _ous9Egr5;
        "jvjqKciK" = _jvjqKciK;
        ...
        "quilt-26.2" = _w3I3ssj4;
        "pkg-1.0.0" = _ous9Egr5;
        "pkg-1.0.1+1.21" = _jvjqKciK;
        "pkg-1.1.0+1.19.4" = _9R0zgPHF;
        "pkg-1.1.0+1.21" = _oXZhmeUe;
        "pkg-1.1.0+1.20" = _ufI7g84G;
        "pkg-1.2.0" = _Yl4Ui3Mt;
        "pkg-1.2.0+1.21" = _tN1ybuBS;
        "pkg-1.2.0+1.21.3" = _3t9NGx5Y;
        "pkg-1.2.0+1.21.4" = _KJVZCcd6;
        "pkg-1.3.0+1.19.4" = _DnRjDNUN;
        "pkg-1.3.0+1.20.4" = _XhXrkMVH;
        "pkg-1.3.0+1.21" = _N8gojy9f;
        "pkg-1.3.0+1.21.3" = _3hRi0pLc;
        "pkg-1.3.0+1.21.4" = _o8QaYLeG;
        "pkg-1.3.0+1.21.5" = _a3EF4lYZ;
        "pkg-1.3.1+1.19.4" = _fD3FTcg9;
        "pkg-1.3.1+1.20.4" = _uUuolCWu;
        "pkg-1.3.1+1.21" = _hKiULcHG;
        "pkg-1.3.1+1.21.4" = _nGFD7jB5;
        "pkg-1.3.1+1.21.5" = _TGQNnzs8;
        "pkg-1.3.1+1.21.6" = _Icw3htr9;
        "pkg-1.3.1+1.21.10" = _7Su4JJAz;
        "pkg-1.3.1+1.21.11" = _ZdKgl5Mq;
        "pkg-1.3.2+1.21.11" = _cQqfhstK;
        "pkg-1.3.2+26.1.2" = _WhSznG4F;
        "pkg-1.3.2+26.2" = _w3I3ssj4;
        "default" = _w3I3ssj4;
    });
