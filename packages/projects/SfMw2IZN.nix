...
let
    ...
    in {
        ...
        "pkg-0.1.0-alpha" = _LXNe7fra;
        "pkg-0.1.1-alpha" = _tbibwExa;
        "pkg-0.1.2-alpha" = _2RY6RGKi;
        "pkg-0.1.3-alpha" = _lAfUt46g;
        "pkg-0.1.4-alpha" = _RcPCnsXK;
        "pkg-0.1.5-alpha" = _uDOBbg9l;
        "pkg-0.1.6-alpha" = _qO1f9KFu;
        "pkg-0.1.7-alpha" = _ioXOklz8;
        "pkg-0.1.8-alpha" = _ucgwwuUs;
        "pkg-0.1.9-alpha" = _hfGur016;
        "pkg-0.1.10-alpha" = _kpnbPBqZ;
        "pkg-0.1.11-alpha" = _PleqMW3C;
        "pkg-0.1.12-alpha" = _pyrZpIBT;
        "pkg-0.1.13-alpha" = _WQjiwSwZ;
        "pkg-0.1.14-alpha" = _esYI1xBx;
        "pkg-0.1.15-alpha" = _WJV4pTzp;
        "pkg-0.1.16-alpha" = _I9LWXtS0;
        "pkg-0.2.0-beta" = _JTkUZGqn;
        "pkg-0.2.1-beta" = _ysJnbtbv;
        "pkg-0.2.2-beta" = _LTv8XrYG;
        "pkg-0.2.3-beta" = _ETg31Z6e;
        "pkg-0.2.4-beta" = _jn5Yk9Nd;
        "pkg-0.2.5-beta" = _UO1crPGk;
        "pkg-0.2.6-beta" = _J2fuM58R;
        "pkg-0.2.7-beta" = _Di2JxVAQ;
        "pkg-0.2.8-beta" = _DJXQSa8Q;
        "pkg-0.2.9-beta" = _cl0HrTL6;
        "pkg-0.3.1" = _3L83QwKZ;
        "pkg-0.4.1-beta10-1.21-1.21.1" = _BIQFSOIx;
        "pkg-0.4.3-beta13-1.21.11" = _4x9ci9sF;
        "pkg-0.4.2-beta4-1.21.6-1.21.8" = _xQpHrkJW;
        "pkg-0.4.2-beta4-1.21.9-1.21.10" = _UyYcxWfJ;
        "pkg-0.4.3-beta13-26.1" = _vzYolYgG;
        "pkg-0.4.4-beta1-26.2" = _bdZCOuAk;
