...
let
    versions = (let
        ...
        _BQ8a0VgS = {
            "id" = "BQ8a0VgS";
            "file" = "zfastnoise-1.1.0-beta.4+26.3-snapshot-7.jar";
            "hash" = "sha512-yZAdPKkhLXchAdh8ko196aQop3NMGHHUgf2cu7fBcXiCnbW2sbI6d8EpUK6NfmhJZ5Z5cdLYvZofli7iNh75dQ==";
        };
        _73DMCY3S = {
            "id" = "73DMCY3S";
            "file" = "zfastnoise-1.0.14+1.21.jar";
            "hash" = "sha512-4ZCB5mTU/XMdmFZCJ5ri8OB3TrLafZLxRKTjSwmNKlyZDLku0flHkxKXmNdfF/4ZRQyid8ANAC2/ZzSmvakGsA==";
        };
        _9TGMeiu2 = {
            "id" = "9TGMeiu2";
            "file" = "zfastnoise-1.0.40+26.2.jar";
            "hash" = "sha512-nf8amY9nJhx7onW5I8Xl7Zf14H6FJRO3u7Zn2rSgUJlcKS7sYIyljfwxYGcml1hNQ8d5YGjzeTBG6S1s8XNgog==";
        };
        _G1CyoeHo = {
            "id" = "G1CyoeHo";
            "file" = "zfastnoise-1.1.0-beta.4+26.3-snapshot-8.jar";
            "hash" = "sha512-qvFhIQSChuAhwX8pTq6xSoFiy2BP6G8kDbGUhTDu6RU7ewBamyWZTEUTDF8rjvlp+QDuE6HN3T7Fcf7+/M7yaw==";
        };
        _qSzLplcW = {
            "id" = "qSzLplcW";
            "file" = "zfastnoise-1.1.0-beta.4+26.3-snapshot-9.jar";
            "hash" = "sha512-P7Ob3NzojFv9BxoohpukQZVqc8BJDCtDo4QeLyRD8UOa/JxLCVx55CsZ0DaroJCx2io0KznU0yIQtGb9P3hdFA==";
        };
        _qiDDXsUT = {
            "id" = "qiDDXsUT";
            "file" = "zfastnoise-1.1.0-beta.4+26.3-snapshot-10.jar";
            "hash" = "sha512-hcJwiogTwZqe5t4t0Rz2wR9jeWJuf5J9fSdHHQltSUPpyy3OhygxDFoWirRpVxpMgaOOV7rIy0eWjUjuOWqukw==";
        };
        _LKLVxFPF = {
            "id" = "LKLVxFPF";
            "file" = "zfastnoise-1.1.0-beta.4+26.3-pre-1.jar";
            "hash" = "sha512-F2QYSV2CC5cy0hZBfHubgn7AbFM9mL5tUCL6+31Hz2GbopxzjNRffPVcoHUd0ls91Gt7HJb5Mtht+Qk8OytQ+A==";
        };
        _Q6zCEV5W = {
            "id" = "Q6zCEV5W";
            "file" = "zfastnoise-1.1.0-beta.5+26.3-pre-1.jar";
            "hash" = "sha512-i53p3pSDrw1k0sfXIyIqWUVgVAZmj0p13ntDOntCO5+my7qT0bTwEaBlk5gitn/BhXIKDAladqkPyKq6pvp27w==";
        };
        _hggcKC1t = {
            "id" = "hggcKC1t";
            "file" = "zfastnoise-1.1.0-beta.5+26.2.jar";
            "hash" = "sha512-aUvEL/tXXpp7P6uhdhFoWV+Kzs9looEZSJIbn9RKIfyl4NSyxIXoANnjQ1mVzSARW08Ro693Mhz6IAb3+0FZjQ==";
        };
        _Tf5ASnSu = {
            "id" = "Tf5ASnSu";
            "file" = "zfastnoise-1.1.0-beta.5+26.3-pre-2.jar";
            "hash" = "sha512-XHbuCazbndl0dWXsEOlsnuq1CwqfHIJm4joz6L6jo+9AO0CTZQgseuOkiBh0hd+2PYo/XuyksdvcW74g5dL1sA==";
        };
        _RxI4fDfx = {
            "id" = "RxI4fDfx";
            "file" = "zfastnoise-1.1.0-beta.6+26.2.jar";
            "hash" = "sha512-Pk14xmj/Atka6/Wp9gdV8OQyDWP1P7KgpiX1WE3v5HyI+lD3G2VsvVMGYovidGbmpHrdGbDRTL3M4GmqdEliAA==";
        };
        _mrmMhJ5c = {
            "id" = "mrmMhJ5c";
            "file" = "zfastnoise-1.1.0-beta.5+26.3-pre-3.jar";
            "hash" = "sha512-+oTlH3rhMQtRcNwjjAd5tEleNe6UZoJ/hkvIRqgQ82/PfTaEwqtZaunp2jsGhYPYFt6/2Idd/OG9AtwYftRY6Q==";
        };
        _aJBCpPia = {
            "id" = "aJBCpPia";
            "file" = "zfastnoise-1.1.0-beta.5+26.3-rc-1.jar";
            "hash" = "sha512-ND2GpWdYNc3Xei4Vbav1nkryWxijUW8poZelDBunFyym1kMNAfxMmrZ+ru8P0W51m1+N2qa29A1aZwcrq8ag7A==";
        };
        _3iY5J0RR = {
            "id" = "3iY5J0RR";
            "file" = "zfastnoise-1.1.0-beta.6+26.1.jar";
            "hash" = "sha512-JosR/Ib4z+0XJs0TeXbRekHm8K+VT5+sgSoFwOhfeq0JBmSmCbf5mu+Xcfp1RN6kTZv2bxl353/7f4SVafd0qQ==";
        };
        _FSokBbok = {
            "id" = "FSokBbok";
            "file" = "zfastnoise-1.1.0-beta.5+26.3-rc-2.jar";
            "hash" = "sha512-UJ6ROW1aH6KzCoFtMQYbtnI1TwECbK+jnI02Ym3HaFh2ZsO5n8PDdvAnBMyzr9p1eoQZZO7BDhZ/dumCeiAPxQ==";
        };
        _GuhP1m4s = {
            "id" = "GuhP1m4s";
            "file" = "zfastnoise-1.1.0-beta.5+26.3-rc-3.jar";
            "hash" = "sha512-F29yq9nTDXa+eQtzMIY6vD5B8rb9B7EKp9wKA/QuWRhz6OnTq1MFO0fSOrvVT43v3BoOLmoMVfgQgcD1VdXjXQ==";
        };
        _bjeF0iDC = {
            "id" = "bjeF0iDC";
    ...
    in {
        ...
        "fabric-1.21" = _73DMCY3S;
        "fabric-1.21.2" = _73DMCY3S;
        "fabric-1.21.3" = _73DMCY3S;
        "fabric-1.21.4" = _73DMCY3S;
        "fabric-1.21.5" = _73DMCY3S;
        "fabric-1.21.6" = _73DMCY3S;
        "fabric-1.21.7" = _73DMCY3S;
        "fabric-1.21.8" = _73DMCY3S;
        ...
        "fabric-26.1" = _3iY5J0RR;
        "fabric-26.1.1-rc-1" = _3iY5J0RR;
        "fabric-26.1.1" = _3iY5J0RR;
        "fabric-26w14a" = _3iY5J0RR;
        "fabric-26.2-snapshot-1" = _3iY5J0RR;
        "fabric-26.1.2-rc-1" = _3iY5J0RR;
        "fabric-26.1.2" = _3iY5J0RR;
        ...
        "fabric-26.3-snapshot-7" = _BQ8a0VgS;
        "fabric-1.21.1-rc1" = _73DMCY3S;
        "fabric-24w33a" = _73DMCY3S;
        "fabric-24w34a" = _73DMCY3S;
        "fabric-24w35a" = _73DMCY3S;
        "fabric-24w36a" = _73DMCY3S;
        "fabric-24w37a" = _73DMCY3S;
        "fabric-24w38a" = _73DMCY3S;
        "fabric-24w39a" = _73DMCY3S;
        "fabric-24w40a" = _73DMCY3S;
        "fabric-1.21.2-pre1" = _73DMCY3S;
        "fabric-1.21.2-pre2" = _73DMCY3S;
        "fabric-1.21.2-pre3" = _73DMCY3S;
        "fabric-1.21.2-pre4" = _73DMCY3S;
        "fabric-1.21.2-pre5" = _73DMCY3S;
        "fabric-1.21.2-rc1" = _73DMCY3S;
        "fabric-1.21.2-rc2" = _73DMCY3S;
        "fabric-24w44a" = _73DMCY3S;
        "fabric-24w45a" = _73DMCY3S;
        "fabric-24w46a" = _73DMCY3S;
        "fabric-1.21.4-pre1" = _73DMCY3S;
        "fabric-1.21.4-pre2" = _73DMCY3S;
        "fabric-1.21.4-pre3" = _73DMCY3S;
        "fabric-1.21.4-rc1" = _73DMCY3S;
        "fabric-1.21.4-rc2" = _73DMCY3S;
        "fabric-1.21.4-rc3" = _73DMCY3S;
        "fabric-25w02a" = _73DMCY3S;
        "fabric-25w03a" = _73DMCY3S;
        "fabric-25w04a" = _73DMCY3S;
        "fabric-25w05a" = _73DMCY3S;
        "fabric-25w06a" = _73DMCY3S;
        "fabric-25w07a" = _73DMCY3S;
        "fabric-25w08a" = _73DMCY3S;
        "fabric-25w09a" = _73DMCY3S;
        "fabric-25w09b" = _73DMCY3S;
        "fabric-25w10a" = _73DMCY3S;
        "fabric-1.21.5-pre1" = _73DMCY3S;
        "fabric-1.21.5-pre2" = _73DMCY3S;
        "fabric-1.21.5-pre3" = _73DMCY3S;
        "fabric-1.21.5-rc1" = _73DMCY3S;
        "fabric-1.21.5-rc2" = _73DMCY3S;
        "fabric-25w14craftmine" = _73DMCY3S;
        "fabric-25w15a" = _73DMCY3S;
        "fabric-25w16a" = _73DMCY3S;
        "fabric-25w17a" = _73DMCY3S;
        "fabric-25w18a" = _73DMCY3S;
        "fabric-25w19a" = _73DMCY3S;
        "fabric-25w20a" = _73DMCY3S;
        "fabric-25w21a" = _73DMCY3S;
        "fabric-1.21.6-pre1" = _73DMCY3S;
        "fabric-1.21.6-pre2" = _73DMCY3S;
        "fabric-1.21.6-pre3" = _73DMCY3S;
        "fabric-1.21.6-pre4" = _73DMCY3S;
        "fabric-1.21.6-rc1" = _73DMCY3S;
        "fabric-1.21.7-rc1" = _73DMCY3S;
        "fabric-1.21.7-rc2" = _73DMCY3S;
        "fabric-1.21.8-rc1" = _73DMCY3S;
        "fabric-26.3-snapshot-8" = _G1CyoeHo;
        "fabric-26.3-snapshot-9" = _qSzLplcW;
        "fabric-26.3-snapshot-10" = _qiDDXsUT;
        "fabric-26.3-pre-1" = _Q6zCEV5W;
        "fabric-26.3-pre-2" = _Tf5ASnSu;
        "fabric-26.3-pre-3" = _mrmMhJ5c;
        ...
        "quilt-1.21" = _73DMCY3S;
        "quilt-1.21.2" = _73DMCY3S;
        "quilt-1.21.3" = _73DMCY3S;
        "quilt-1.21.4" = _73DMCY3S;
        "quilt-1.21.5" = _73DMCY3S;
        "quilt-1.21.6" = _73DMCY3S;
        "quilt-1.21.7" = _73DMCY3S;
        "quilt-1.21.8" = _73DMCY3S;
        ...
        "quilt-26.1" = _3iY5J0RR;
        "quilt-26.1.1-rc-1" = _3iY5J0RR;
        "quilt-26.1.1" = _3iY5J0RR;
        "quilt-26w14a" = _3iY5J0RR;
        "quilt-26.2-snapshot-1" = _3iY5J0RR;
        "quilt-26.1.2-rc-1" = _3iY5J0RR;
        "quilt-26.1.2" = _3iY5J0RR;
        ...
        "quilt-26.3-snapshot-7" = _BQ8a0VgS;
        "quilt-1.21.1-rc1" = _73DMCY3S;
        "quilt-24w33a" = _73DMCY3S;
        "quilt-24w34a" = _73DMCY3S;
        "quilt-24w35a" = _73DMCY3S;
        "quilt-24w36a" = _73DMCY3S;
        "quilt-24w37a" = _73DMCY3S;
        "quilt-24w38a" = _73DMCY3S;
        "quilt-24w39a" = _73DMCY3S;
        "quilt-24w40a" = _73DMCY3S;
        "quilt-1.21.2-pre1" = _73DMCY3S;
        "quilt-1.21.2-pre2" = _73DMCY3S;
        "quilt-1.21.2-pre3" = _73DMCY3S;
        "quilt-1.21.2-pre4" = _73DMCY3S;
        "quilt-1.21.2-pre5" = _73DMCY3S;
        "quilt-1.21.2-rc1" = _73DMCY3S;
        "quilt-1.21.2-rc2" = _73DMCY3S;
        "quilt-24w44a" = _73DMCY3S;
        "quilt-24w45a" = _73DMCY3S;
        "quilt-24w46a" = _73DMCY3S;
        "quilt-1.21.4-pre1" = _73DMCY3S;
        "quilt-1.21.4-pre2" = _73DMCY3S;
        "quilt-1.21.4-pre3" = _73DMCY3S;
        "quilt-1.21.4-rc1" = _73DMCY3S;
        "quilt-1.21.4-rc2" = _73DMCY3S;
        "quilt-1.21.4-rc3" = _73DMCY3S;
        "quilt-25w02a" = _73DMCY3S;
        "quilt-25w03a" = _73DMCY3S;
        "quilt-25w04a" = _73DMCY3S;
        "quilt-25w05a" = _73DMCY3S;
        "quilt-25w06a" = _73DMCY3S;
        "quilt-25w07a" = _73DMCY3S;
        "quilt-25w08a" = _73DMCY3S;
        "quilt-25w09a" = _73DMCY3S;
        "quilt-25w09b" = _73DMCY3S;
        "quilt-25w10a" = _73DMCY3S;
        "quilt-1.21.5-pre1" = _73DMCY3S;
        "quilt-1.21.5-pre2" = _73DMCY3S;
        "quilt-1.21.5-pre3" = _73DMCY3S;
        "quilt-1.21.5-rc1" = _73DMCY3S;
        "quilt-1.21.5-rc2" = _73DMCY3S;
        "quilt-25w14craftmine" = _73DMCY3S;
        "quilt-25w15a" = _73DMCY3S;
        "quilt-25w16a" = _73DMCY3S;
        "quilt-25w17a" = _73DMCY3S;
        "quilt-25w18a" = _73DMCY3S;
        "quilt-25w19a" = _73DMCY3S;
        "quilt-25w20a" = _73DMCY3S;
        "quilt-25w21a" = _73DMCY3S;
        "quilt-1.21.6-pre1" = _73DMCY3S;
        "quilt-1.21.6-pre2" = _73DMCY3S;
        "quilt-1.21.6-pre3" = _73DMCY3S;
        "quilt-1.21.6-pre4" = _73DMCY3S;
        "quilt-1.21.6-rc1" = _73DMCY3S;
        "quilt-1.21.7-rc1" = _73DMCY3S;
        "quilt-1.21.7-rc2" = _73DMCY3S;
        "quilt-1.21.8-rc1" = _73DMCY3S;
        "quilt-26.3-snapshot-8" = _G1CyoeHo;
        "quilt-26.3-snapshot-9" = _qSzLplcW;
        "quilt-26.3-snapshot-10" = _qiDDXsUT;
        "quilt-26.3-pre-1" = _Q6zCEV5W;
        "quilt-26.3-pre-2" = _Tf5ASnSu;
        "quilt-26.3-pre-3" = _mrmMhJ5c;
        ...
        "pkg-1.0.3+1.21.11" = _hzeo95RZ;
        "pkg-1.0.3+1.21.10" = _EwQjd7sI;
        "pkg-1.0.3+1.21.1" = _f6qoFB79;
        "pkg-1.0.4+1.21.11" = _ZhnDk8qo;
        "pkg-1.0.4+1.21.1" = _dzs0lQBc;
        "pkg-1.0.5+1.21.11" = _OCXn4yuO;
        "pkg-1.0.6+1.21.11" = _8FFP0hzh;
        "pkg-1.0.7+1.21.11" = _FYfiwiS4;
        "pkg-1.0.8+1.21.11" = _lWSoliAR;
        "pkg-1.0.8+1.21.10" = _5dV1kVdC;
        "pkg-1.0.8+1.21.1" = _QbMofEv6;
        "pkg-1.0.8+26.1-snapshot-3" = _emGFRbqV;
        "pkg-1.0.9+26.1-snapshot-5" = _3e21ciDn;
        "pkg-1.0.10+26.1-snapshot-5" = _VGOdpaZw;
        "pkg-1.0.10+1.21.11" = _pO0dTD5h;
        "pkg-1.0.11+26.1-snapshot-5" = _yxPfYGoZ;
        "pkg-1.0.12+26.1-snapshot-5" = _o6OUexGF;
        "pkg-1.0.13+26.1-snapshot-5" = _v5LXEbi9;
        "pkg-1.0.14+26.1-snapshot-5" = _G2iX510k;
        "pkg-1.0.14+26.1-snapshot-6" = _D1ZTEedq;
        "pkg-1.0.15+26.1-snapshot-6" = _ubkUulMM;
        "pkg-1.0.16+26.1-snapshot-7" = _20IaPosN;
        "pkg-1.0.10+1.21.10" = _VEYX1qYY;
        "pkg-1.0.10+1.21.9" = _AF5oYrdq;
        "pkg-1.0.10+1.21" = _FAnugRgk;
        "pkg-1.0.10+1.20" = _65MY0RWz;
        "pkg-1.0.10+1.19" = _c3kOua44;
        "pkg-1.0.16+1.21.11" = _6MZSOnd2;
        "pkg-1.0.17+26.1-snapshot-7" = _WAmUtKC0;
        "pkg-1.0.17+26.1-snapshot-8" = _iZwLvUvP;
        "pkg-1.0.17+26.1-snapshot-9" = _CoxKvNpp;
        "pkg-1.0.18+26.1-snapshot-9" = _ydmMEN2N;
        "pkg-1.0.19+26.1-snapshot-9" = _E1zbUOhd;
        "pkg-1.0.19+1.21.11" = _IuJI34GM;
        "pkg-1.0.19+1.21.9" = _gFkoaoo8;
        "pkg-1.0.11+1.21" = _qETA8Qja;
        "pkg-1.0.11+1.20" = _dKwaus8G;
        "pkg-1.0.11+1.19" = _XVMYsFmj;
        "pkg-1.0.11+1.19.4" = _ih5xzhim;
        "pkg-1.0.19+26.1-snapshot-7" = _pq2Wy9Xp;
        "pkg-1.0.19a+26.1-snapshot-7" = _TpNw7p6p;
        "pkg-1.0.20+26.1-snapshot-10" = _kJuMB1Pa;
        "pkg-1.0.21+26.1-snapshot-10" = _zg7SBgVm;
        "pkg-1.0.21+1.21.11" = _btNQ8xWb;
        "pkg-1.0.21+1.21.9" = _BhZwAX0g;
        "pkg-1.0.21+26.1-snapshot-11" = _ycfZVVsO;
        "pkg-1.0.22+26.1-snapshot-11" = _xOnYRaJr;
        "pkg-1.0.19+26.1-snapshot-10" = _PnWYLAST;
        "pkg-1.0.22+1.21.11" = _T6wORxXf;
        "pkg-1.0.22+1.21.9" = _ktXZkCKT;
        "pkg-1.0.23+26.1-snapshot-11" = _ybB6VuUk;
        "pkg-1.0.23+1.21.11" = _ei7E1qHY;
        "pkg-1.0.23+1.21.9" = _GQK1aiGd;
        "pkg-1.0.24+26.1-snapshot-11" = _Jr1QdBHr;
        "pkg-1.0.24+1.21.11" = _4QKrhxso;
        "pkg-1.0.24+1.21.9" = _QVMQLta6;
        "pkg-1.0.24+26.1-pre-1" = _LOoM46Tm;
        "pkg-1.0.24+26.1-pre-2" = _hYNCiOYp;
        "pkg-1.0.25+26.1-pre-2" = _fcxymT2o;
        "pkg-1.0.25+1.21.11" = _fP2AezPw;
        "pkg-1.0.25+1.21.9" = _JSd4LEvB;
        "pkg-1.0.25+26.1-snapshot-10" = _DKEnoZNS;
        "pkg-1.0.25+26.1-pre-3" = _Q8OIRQNU;
        "pkg-1.0.25+26.1-rc-1" = _AdMUQUKx;
        "pkg-1.0.25+26.1-rc-2" = _R2pntiuc;
        "pkg-1.0.26+26.1-rc-2" = _JUvwhj6B;
        "pkg-1.0.26+26.1-rc-3" = _g9LrGZad;
        "pkg-1.0.26+26.1" = _EeuAes8T;
        "pkg-1.0.27+26.1" = _jlFW8jqM;
        "pkg-1.0.27+1.21.11" = _d1y4JGMv;
        "pkg-1.0.27+1.21.9" = _3NdNCp5M;
        "pkg-1.0.27+26.1.1-rc-1" = _25cfaTao;
        "pkg-1.0.27+26.1.1" = _6xGB2oz5;
        "pkg-1.0.27+26w14a" = _2rl7I0Ap;
        "pkg-1.0.28+26.1.1" = _9y7qbtS6;
        "pkg-1.0.28+26.2-snapshot-1" = _r5Kdpilx;
        "pkg-1.0.28+26.1.2-rc-1" = _AT0lLWgV;
        "pkg-1.0.28+26.1.2" = _90BByK9J;
        "pkg-1.0.28+26.2-snapshot-2" = _PnJx1GCs;
        "pkg-1.0.28-ocl+26.1.2" = _RJf9DTDh;
        "pkg-1.0.29+26.2-snapshot-2" = _11nmeYDR;
        "pkg-1.0.29-ocl+26.1.2" = _sKqtVH3Z;
        "pkg-1.0.29+26.1.2" = _CLRleqhG;
        "pkg-1.0.29+1.21.11" = _iokxBbTT;
        "pkg-1.0.29+1.21.9" = _HIZTy9Pz;
        "pkg-1.0.29+26.2-snapshot-3" = _cirAg8W6;
        "pkg-1.0.29+26.1.2+neoforge" = _x9WogrY9;
        "pkg-1.0.29+26.2-snapshot-4" = _LScfRw49;
        "pkg-1.0.30+26.2-snapshot-4" = _LKURW6RT;
        "pkg-1.0.11+1.20+forge" = _Fl47JiCL;
        "pkg-1.0.11+1.21+neoforge" = _SlTizxzz;
        "pkg-1.0.11a+1.21+neoforge" = _tGdbMrnn;
        "pkg-1.0.31+26.2-snapshot-4" = _H8A4uKBE;
        "pkg-1.0.31+26.2-snapshot-5" = _a6TEaaGT;
        "pkg-1.0.31+26.2-snapshot-6" = _9338DEom;
        "pkg-1.0.31+26.2-snapshot-7" = _pBtLsaz6;
        "pkg-1.0.32+26.2-snapshot-7" = _w7OdebPW;
        "pkg-1.0.32+26.1.2" = _rhXFUl98;
        "pkg-1.0.32+1.21.11" = _G3TmGhqS;
        "pkg-1.0.32+1.21.9" = _tOFqb1vZ;
        "pkg-1.0.32b+26.1.2" = _RH18T3OU;
        "pkg-1.0.32c+26.1.2" = _Wo1nrWeb;
        "pkg-1.0.32c+1.21.11" = _1fs85W06;
        "pkg-1.0.32c+1.21.9" = _cPWrG8Qh;
        "pkg-1.0.32c+26.1.2+neoforge" = _X8XY7H96;
        "pkg-1.0.32+26.2-snapshot-8" = _JZjm1lTJ;
        "pkg-1.0.32+26.2-pre-1" = _QIpce9nC;
        "pkg-1.0.32+26.2-pre-2" = _lB7ChgJn;
        "pkg-1.0.11+1+1.21" = _e6mPQAQP;
        "pkg-1.0.33+26.2-pre-2" = _nnAm66Dy;
        "pkg-1.0.33+26.2-pre-3" = _VxemtKko;
        "pkg-1.0.34+26.2-pre-3" = _Oa2rtB6B;
        "pkg-1.0.34+26.2-pre-4" = _v7t98ZXf;
        "pkg-1.0.34+26.1.2" = _kj40Bs88;
        "pkg-1.0.11+2+1.21" = _1ODv6lK9;
        "pkg-1.0.35+26.2-pre-5" = _1jaYrOTN;
        "pkg-1.0.35+26.2-pre-6" = _FvZBxHiK;
        "pkg-1.0.35+26.2-rc-1" = _WS0TxouJ;
        "pkg-1.0.11+2+1.21.1+neoforge" = _kWzQiCnV;
        "pkg-1.0.34+26.1.2+neoforge" = _fLPDfA78;
        "pkg-1.0.35+26.2-rc-2" = _ThpzokUa;
        "pkg-1.0.35+26.2" = _iVRG7hxX;
        "pkg-1.0.35+26.2+neoforge" = _jRogqZEl;
        "pkg-1.0.36+26.2" = _zDmmeNYS;
        "pkg-1.0.36+26.1.2" = _DyQ9Lp6U;
        "pkg-1.0.36+1.21.11" = _WBTi826Z;
        "pkg-1.0.36+26.1.2+neoforge" = _g0GgOf2t;
        "pkg-1.0.36+26.2+neoforge" = _NTZe0pCy;
        "pkg-1.0.12+1.21" = _LT35FPwj;
        "pkg-1.0.12+1.21.1+neoforge" = _3kqaDLhL;
        "pkg-1.0.36+26.3-snapshot-1" = _y7wJ79RS;
        "pkg-1.0.37+26.3-snapshot-1" = _OlSylffa;
        "pkg-1.0.37+26.3-snapshot-2" = _hfRVyoFz;
        "pkg-1.0.37+26.2" = _5Mv1BDvi;
        "pkg-1.0.38+26.3-snapshot-2" = _tiBB2C4k;
        "pkg-1.0.38+26.2" = _bhZkYZz1;
        "pkg-1.0.38+26.1.2" = _xQmIpGqS;
        "pkg-1.0.38+1.21.11" = _mNN05vho;
        "pkg-1.0.38+26.3-snapshot-3" = _h2CIz5i5;
        "pkg-1.0.38+1.21.9" = _arLBn0dE;
        "pkg-1.0.13+1.21" = _tss0FueO;
        "pkg-1.0.13+1.21.1+neoforge" = _9vSFkDAr;
        "pkg-1.0.39+26.3-snapshot-3" = _PnXXLaPL;
        "pkg-1.0.39+26.2" = _GJk7sVtP;
        "pkg-1.0.39+26.1.2" = _ghmh5tiI;
        "pkg-1.0.39+1.21.11" = _3uLIzf05;
        "pkg-1.0.39+1.21.9" = _BAwtAdi1;
        "pkg-1.0.39+26.2+neoforge" = _IFhrIQ10;
        "pkg-1.0.39+26.1.2+neoforge" = _FLh3H4mj;
        "pkg-1.0.13+1.20" = _K3nDfeZE;
        "pkg-1.0.13+1.20+forge" = _WVek23EE;
        "pkg-1.0.39+26.3-snapshot-4" = _gCcSn0ud;
        "pkg-1.1.0-beta.1+26.3-snapshot-4" = _VSkniOwN;
        "pkg-1.1.0-beta.1+26.2" = _3Sh3dPdI;
        "pkg-1.1.0-beta.2+26.3-snapshot-4" = _8KDPNN7K;
        "pkg-1.1.0-beta.2+26.2" = _XKhAvLL2;
        "pkg-1.1.0-beta.2+26.3-snapshot-5" = _RLharDXA;
        "pkg-1.1.0-beta.3+26.3-snapshot-5" = _P0MESHNX;
        "pkg-1.1.0-beta.3+26.2" = _QBcjDrhr;
        "pkg-1.0.40+26.1.2" = _shxfMPzi;
        "pkg-1.0.40+1.21.11" = _Bmx6DadQ;
        "pkg-1.0.40+1.21.9" = _GN0k62Rj;
        "pkg-1.0.40+26.2+neoforge" = _bL1UyVT2;
        "pkg-1.0.40+26.1.2+neoforge" = _7iYx7Gsk;
        "pkg-1.1.0-beta.3+26.3-snapshot-6" = _Va5DiCN4;
        "pkg-1.1.0-beta.4+26.2" = _qxGN3Aeh;
        "pkg-1.1.0-beta.4+26.3-snapshot-7" = _BQ8a0VgS;
        "pkg-1.0.14+1.21" = _73DMCY3S;
        "pkg-1.0.40+26.2" = _9TGMeiu2;
        "pkg-1.1.0-beta.4+26.3-snapshot-8" = _G1CyoeHo;
        "pkg-1.1.0-beta.4+26.3-snapshot-9" = _qSzLplcW;
        "pkg-1.1.0-beta.4+26.3-snapshot-10" = _qiDDXsUT;
        "pkg-1.1.0-beta.4+26.3-pre-1" = _LKLVxFPF;
        "pkg-1.1.0-beta.5+26.3-pre-1" = _Q6zCEV5W;
        "pkg-1.1.0-beta.5+26.2" = _hggcKC1t;
        "pkg-1.1.0-beta.5+26.3-pre-2" = _Tf5ASnSu;
        "pkg-1.1.0-beta.6+26.2" = _RxI4fDfx;
        "pkg-1.1.0-beta.5+26.3-pre-3" = _mrmMhJ5c;
        "pkg-1.1.0-beta.5+26.3-rc-1" = _aJBCpPia;
        "pkg-1.1.0-beta.6+26.1" = _3iY5J0RR;
