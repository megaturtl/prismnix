...
let
    versions = (let
        ...
        _WX7l0SE2 = {
            "id" = "WX7l0SE2";
            "file" = "TriggerSit-1.0.24.jar";
            "hash" = "sha512-kcBNhtvZqiAeFnPzOg6KdwuPgG3AK5tLezXUemmfQ9kfcdJbKndYy0fNjUWIagqI8eN5XPAuZOM6/RmdFsmoyg==";
        };
    in {
        "Qv2OHruT" = _Qv2OHruT;
        "aXfr0fuV" = _aXfr0fuV;
        ...
        "pkg-1.0.8" = _PLX7yUzr;
        "pkg-1.0.9" = _xd5Hkbci;
        "pkg-1.0.10" = _vjto63Gy;
        "pkg-1.0.11" = _9cHigwmE;
        "pkg-1.0.12" = _NRBPgx2t;
        "pkg-1.0.13" = _M6vG05rO;
        "pkg-1.0.14" = _AYaloxW2;
        "pkg-1.0.15" = _PC7RFIwm;
        "pkg-1.0.16" = _Nc6IuXfG;
