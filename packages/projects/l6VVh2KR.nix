...
let
    ...
    in {
        ...
        "pkg-4+mod" = _39ImNCeQ;
        "pkg-4.1" = _H7BVcORY;
        "pkg-4.1+mod" = _aYTIjpK3;
        "pkg-5" = _nx66M9Gc;
        "pkg-4.5" = _ASdvkaHe;
        "pkg-4.5+mod" = _zr7RHOnP;
        "pkg-5+mod" = _AufnsOY2;
        "pkg-5.1" = _yxThv5qR;
        "pkg-5.1+mod" = _Ph4Mz7c8;
        "pkg-5.2" = _iXXpYb2q;
        "pkg-5.2+mod" = _vdIGdytk;
        "pkg-5.3" = _ZmNy7wLp;
        "pkg-5.3+mod" = _tDEVcUvj;
        "pkg-5.4" = _VrTgD88v;
        "pkg-5.4+mod" = _AwZERPJH;
        "pkg-6.0" = _UNMV471i;
        "pkg-6.0+mod" = _X2Tmx8PW;
        "pkg-26.1" = _L4r70hxE;
        "pkg-26.1+mod" = _NJSOEGyd;
        "pkg-6.2" = _Dwivk2WH;
