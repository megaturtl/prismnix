...
let
    ...
    in {
        ...
        "pkg-1.6.6" = _IRNykcZl;
        "pkg-1.6.7" = _gjQeaQYU;
        "pkg-1.5.10" = _lGUsZqaQ;
        "pkg-1.6.8" = _vTqzKSvI;
        "pkg-1.6.9" = _ENsRuLjz;
        "pkg-1.6.10" = _e08Xe0on;
        "pkg-1.6.11" = _NxmJlbsY;
        "pkg-1.6.12" = _1spLZoZQ;
        "pkg-1.6.13" = _reEz30VS;
        "pkg-1.7.0" = _tiu4l1Ks;
        "pkg-1.7.1" = _hTYBPp4S;
        "pkg-1.7.2" = _YzihfbLk;
        "pkg-1.7.3" = _giqmjv1V;
        ...
        "pkg-6.1.5" = _vAT49M4v;
        "pkg-6.2.1" = _Ra3gLXCl;
        "pkg-6.0.10" = _K7XGA12a;
        "pkg-6.1.6" = _1x6Was6b;
        "pkg-6.2.2" = _R68uDBAc;
        "pkg-7.0.0" = _kPRNh9cW;
        "pkg-6.0.11" = _u58C5ouW;
        "pkg-6.1.7" = _9KZKNksu;
        "pkg-6.2.3" = _TYlnS1q7;
        "pkg-7.0.1" = _jp0Zv1l9;
        "pkg-7.0.2" = _ge9vgl8u;
        "pkg-7.0.3" = _pMaM6bS4;
        "pkg-6.0.12" = _MrY2j5Wi;
        "pkg-6.1.8" = _SJXKyMpl;
        "pkg-6.2.4" = _lPXkyHvj;
        "pkg-7.0.4" = _uZvAmRRl;
        "pkg-7.0.5" = _TbKrfvdL;
        "pkg-7.0.6" = _NvC4V7ir;
        "pkg-6.0.13" = _TOQpImp2;
        "pkg-7.0.7" = _uTITK7Q3;
        "pkg-7.0.8" = _pUJkRVfx;
        "pkg-7.0.9" = _yTuKnzVy;
        "pkg-7.0.10" = _cRMgDSq5;
        "pkg-6.0.14" = _yDF1eaGP;
        "pkg-7.0.11" = _EVUuWEtb;
        "pkg-7.0.12" = _H8jzayfW;
        "pkg-8.0.0" = _zkIrrTdY;
        "pkg-8.0.1" = _nxWBINAx;
        "pkg-8.0.2" = _MJogsEIY;
        "pkg-8.0.3" = _fz2HQndq;
        "pkg-8.0.4" = _S16XMz4R;
        "pkg-8.0.5" = _B4UhSYEf;
        "pkg-7.0.13" = _9nWtRmot;
        "pkg-6.0.15" = _p16VSTnT;
        "pkg-8.0.6" = _L8u2KKQK;
        "pkg-8.0.7" = _DX8CY9my;
        "pkg-7.0.14" = _KVVbjb8d;
        "pkg-8.0.8" = _ZmAvnOib;
        "pkg-8.0.9" = _HmF2p17q;
        "pkg-8.0.10" = _MtyLRciC;
        "pkg-6.0.16" = _aZUl9qqn;
        "pkg-7.0.15" = _YWFhYUId;
        "pkg-8.0.11" = _nCleLuNR;
        "pkg-6.0.17" = _3K5fUGlj;
        "pkg-7.0.16" = _4Lw3iwfu;
        "pkg-8.0.12" = _fhABqbwG;
        "pkg-7.0.17" = _h1XgFTYy;
        "pkg-8.0.13" = _131CFMS8;
        "pkg-7.0.18" = _CtGoKNk8;
        "pkg-8.0.14" = _ZXS4a81d;
        "pkg-7.0.19" = _vLM5xvcv;
        "pkg-8.0.15" = _llKPfP4n;
        "pkg-8.0.16" = _Btq6Yt8b;
        "pkg-7.0.20" = _O3dz79wq;
        "pkg-8.0.17" = _QO9x5Wew;
        "pkg-7.0.21" = _VuHoWp7u;
        "pkg-8.0.18" = _a4H90c3L;
        "pkg-7.0.22" = _cBGUB9Lh;
        "pkg-8.0.19" = _5NMxXYeE;
        "pkg-7.0.23" = _L4VoS46I;
        "pkg-8.0.20" = _6hGQMSH6;
        "pkg-8.0.21" = _DpjotSE9;
        "pkg-8.0.22" = _D2aNs5MV;
        "pkg-8.0.23" = _FmORWJsO;
        "pkg-8.0.24" = _IvtG0ydW;
        "pkg-7.0.24" = _EEilTecF;
        "pkg-8.0.25" = _W62Kmgib;
        "pkg-8.0.26" = _AmApJwF1;
        "pkg-9.0.0" = _wD1suLQW;
        "pkg-9.0.1" = _9AaBqpJR;
        "pkg-9.0.2" = _rcV1EPuH;
        "pkg-9.0.3" = _54ahURWI;
