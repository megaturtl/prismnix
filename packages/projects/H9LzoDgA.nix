...
let
    ...
    in {
        ...
        "pkg-0.1.0-mc1.20.4" = _rk6BPaXs;
        "pkg-0.1.1-mc1.20.1" = _tLNxDvhN;
        "pkg-0.1.1-mc1.19.2" = _M7bbZ1KL;
        "pkg-0.1.1-mc1.16.5" = _B6m6393N;
        "pkg-0.1.1-mc1.18.2" = _n5OlxvGN;
        "pkg-0.1.1-mc1.17.1" = _ptUKDzmG;
        "pkg-0.1.1-mc1.21" = _QzGN54hh;
        "pkg-0.1.1-mc1.20.6" = _uUnJvW0q;
        "pkg-0.1.1-mc1.20.4" = _lPm2TyLb;
        "pkg-0.1.2-mc1.21" = _rNYZKzo0;
        "pkg-0.1.3-mc1.21.1" = _WDG4IF74;
        "pkg-0.1.4-mc1.21.1" = _oW99aVJp;
        "pkg-0.2.1-mc1.21.1" = _HHlmGHaJ;
        "pkg-0.2.1-mc1.21.3" = _5BmGNSCO;
        "pkg-0.2.1-mc1.21.4" = _QXlAjJJ6;
        "pkg-0.2.2-mc1.21.1" = _PnPBwpNm;
        "pkg-0.2.2-mc1.21.3" = _oxvu3rvi;
        "pkg-0.2.2-mc1.21.4" = _yWAAFaYm;
        "pkg-0.4.0+mc1.21.10" = _kIac72i5;
        "pkg-0.4.0+mc1.21.8" = _VogAfwt1;
        "pkg-0.4.0+mc1.21.4" = _lURb8PBq;
        "pkg-0.4.0+mc1.21.5" = _CQ9tk28k;
        "pkg-0.4.0+mc1.21.3" = _ArJIi3d2;
        "pkg-0.4.0+mc1.21.1" = _PZeCLi2l;
        "pkg-0.4.1+mc1.21.10" = _Po9af9pR;
        "pkg-0.4.0+mc1.21.11" = _Ts2WTheU;
        "pkg-0.5.0+mc26.1.2" = _gvETXjnX;
        "pkg-0.4.1+mc1.21.1" = _V61U2oNg;
        "pkg-0.4.1+mc1.21.3" = _nemIELAk;
        "pkg-0.4.1+mc1.21.4" = _ajMxqW3u;
        "pkg-0.4.1+mc1.21.5" = _k2uAxFkT;
        "pkg-0.4.1+mc1.21.8" = _Rn3J0E4L;
