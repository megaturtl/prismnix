...
let
    ...
    in {
        ...
        "pkg-1.2.0" = _jF0WN3AR;
        "pkg-1.2.0+mod" = _PSU4YJmc;
        "pkg-1.3.0" = _HVXL5YG6;
        "pkg-1.3.0+mod" = _xrSHIaJH;
        "pkg-1.4.0" = _eXFcmLKz;
        "pkg-1.4.0+mod" = _GuHkv0Ce;
        "pkg-24w35a" = _NiWJG3B7;
        "pkg-2.0.9" = _oua1QQkP;
        "pkg-2.0.9+mod" = _WRqCDMPt;
        "pkg-3.0.0" = _i4CLYDTU;
        "pkg-3.0.0+mod" = _5KNxBhpw;
        "pkg-4.1.0" = _DmSBKdSF;
        "pkg-4.1.0+mod" = _K5mFTMg1;
        "pkg-5.1.0" = _v9Cq0wCh;
        "pkg-5.1.0+mod" = _dtBTYDtC;
        "pkg-5.2.0" = _UfolK2Gh;
        "pkg-5.2.0+mod" = _6L9zJApL;
        "pkg-5.3.1" = _MEFionGO;
        "pkg-5.3.1+mod" = _SrhdsBKg;
        "pkg-5.3.2" = _38wtmGtI;
        "pkg-5.3.2+mod" = _2BuMh84s;
        "pkg-5.3.3+mod" = _lvwVpTie;
        "pkg-5.3.3" = _CBeL7wtF;
        "pkg-5.4.0" = _v2TWoqmo;
        "pkg-5.4.0+mod" = _qLVzq61p;
        "pkg-6.0.0" = _hygLtkeL;
