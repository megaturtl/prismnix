...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _iFB8izrA;
        "pkg-2.0.0" = _oG1Bf3SL;
        "pkg-2.0.0+1.21.8" = _9Rz8cHhw;
        "pkg-3.0.0+1.20.1" = _gpmB51lc;
        "pkg-3.0.0+1.21.1" = _RsqPDuRc;
        "pkg-3.0.0+1.21.2" = _DYvTpdc2;
        "pkg-3.0.0+1.21.5" = _EoL5jyOD;
        "pkg-3.0.0+1.21.10" = _U5nm5RAY;
        "pkg-3.0.1+1.20.1" = _na4yFsEl;
        "pkg-3.0.1+1.21.1" = _3MSV20T2;
        "pkg-3.0.1+1.21.4" = _2dniNIZe;
        "pkg-3.0.1+1.21.5" = _aYX0PNCA;
        "pkg-3.0.1+1.21.10" = _PVY4evsT;
        "pkg-3.0.1+1.21.11" = _bNff1Kea;
        "pkg-3.0.2+1.20.1" = _QemG59rX;
        "pkg-3.0.2+1.21.1" = _osc2odbC;
        "pkg-3.0.2+1.21.5" = _qholFF3t;
        "pkg-3.0.2+1.21.10" = _29K6RfnG;
        "pkg-3.1.0" = _8V022ar7;
        "pkg-3.1.1" = _2udtXCiv;
        "pkg-3.1.2" = _zcGKxuiN;
        "pkg-3.1.3" = _FNi4cMuo;
