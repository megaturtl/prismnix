...
let
    versions = (let
        ...
        _cRR8XGTL = {
            "id" = "cRR8XGTL";
            "file" = "perspective_api-1.4.0-beta+fabric-1.20.1.jar";
            "hash" = "sha512-G2l6/w1yLx3bO1jgVOqJpy1UwqYSQxeq49zGnLLqPPe+JtFjxh+DpopGHIl4xvKXKtDxfaBpjddpUS6z5ndJ3A==";
        };
        _R04CAGME = {
            "id" = "R04CAGME";
            "file" = "perspective_api-1.4.0-beta+forge-1.20.1.jar";
            "hash" = "sha512-kQad6ncFIyhx6SevoAqqrggZovettkdpkv8Cn5kmStvqTFWz0+bRz/RQQwv7rJDnxFSE+ZsT0zy7ySEiK4qOzw==";
        };
        _LwKH82Zr = {
            "id" = "LwKH82Zr";
            "file" = "perspective_api-1.4.0-beta+fabric-1.20.4.jar";
            "hash" = "sha512-Bn0E+vriBJkfPYq3Rqn0u5C3ek9XEXYEAZh8pnPyXuhXx6IUyZfTZYC1oc7lV/0wAkVtFazshC7W+osPpudH2g==";
        };
        _D92lHevn = {
            "id" = "D92lHevn";
            "file" = "perspective_api-1.4.0-beta+neoforge-1.20.4.jar";
            "hash" = "sha512-RVuW2IAhMmh422t/bSJfenH6pB8RB8tT6qwNPM/Dtk7Nw/n5ostdmbs2qeZCpt2EDkofd2ckLBNDbb9bKZgK/w==";
        };
        _teInDDRK = {
            "id" = "teInDDRK";
            "file" = "perspective_api-1.4.0-beta+fabric-1.20.6.jar";
            "hash" = "sha512-eqHe7sz0aYPUFiqY8BC4Z+F2K4OsWm4uMNlQ+XjtO/z+6+YP3xWZo8KAE+bV7UpoQ0wt/0HfZXLTgEGSQKcIJg==";
        };
        _EVRXRvgJ = {
            "id" = "EVRXRvgJ";
            "file" = "perspective_api-1.4.0-beta+neoforge-1.20.6.jar";
            "hash" = "sha512-WgI1sjvVMN5wWop/Qhjz6oyGZWlfaDicr0E1Y3w7ft25GvVqiIwVwkysoCWnfvJVGvwojDmIl0uhZ2IVhoIstA==";
        };
        _UPib1eYA = {
            "id" = "UPib1eYA";
            "file" = "perspective_api-1.4.0-beta+fabric-1.21.jar";
            "hash" = "sha512-oUwSX6vtuuJvOhm6fMTkl5UD41wpzz8nPQNhcWn9KHzRg0lHI2ic1vwWPd176lhzEWtTdenuKEJgv+0I8lDL3Q==";
        };
        _k0hwSc7L = {
            "id" = "k0hwSc7L";
            "file" = "perspective_api-1.4.0-beta+neoforge-1.21.jar";
            "hash" = "sha512-JJtVOmtw/7lR/LkyYs7J9R7ac9DdosnYs0FdAeDaEVFK8nEndRAtMTfHWCUG9lMdpJOy5kEMpGdavtxFpWp1Wg==";
        };
        _YzZMM8Pn = {
            "id" = "YzZMM8Pn";
            "file" = "perspective_api-1.4.0-beta+fabric-1.21.11.jar";
            "hash" = "sha512-INiWGjvTIj8och6e5grqz4Ne0KOyAAHOtsz3p7X6FUoixThSbvsWuDASyEotFU1XMhBZMf2Ilq6yX9IWJeyq9g==";
        };
        _KiD5SVmZ = {
            "id" = "KiD5SVmZ";
            "file" = "perspective_api-1.4.0-beta+neoforge-1.21.11.jar";
            "hash" = "sha512-5aE5dGtnCn9Rl0MQUhW+qrhyVXTnRv+r3jIQjFfRHS/nA+qTifcAGYYqi0Fnm/pIa6PWcd6JkILN2756+G/3Yw==";
        };
        _26vPAy6H = {
            "id" = "26vPAy6H";
            "file" = "perspective_api-1.4.0-beta+fabric-26.1.jar";
            "hash" = "sha512-LA9BgF+4VZNFiXxy6/yMcSQW2et0q77/aiiB0xGhN2WeLznrsBc515zs5VhLa3LSodMpjj1FCQG3j+B3CeUEqQ==";
        };
        _o6QX0aHA = {
            "id" = "o6QX0aHA";
            "file" = "perspective_api-1.4.0-beta+neoforge-26.1.jar";
            "hash" = "sha512-nr/P/wmy2jbG6qsxcfQxDgigoQBDiFlk9QEpCEf/lPX+BNUeuZ1blCXj9EtsfXBOvSToxEPVm5pLOdYF6cgbBQ==";
        };
        _WTdm0stv = {
            "id" = "WTdm0stv";
            "file" = "perspective_api-1.4.0-beta+fabric-26.2.jar";
            "hash" = "sha512-6I+50XHKWprkj9zrdjsgU7ty47yH1LbVk7QCvnqbJT38228vHO5Nrfx259sGV/IN+YUkyE5mvFvcasfksD1qSA==";
        };
        _3wBPqwlL = {
            "id" = "3wBPqwlL";
            "file" = "perspective_api-1.4.0-beta+neoforge-26.2.jar";
            "hash" = "sha512-qTb4HH11EV4CTE4Pr6LoO8B53IJgilO6sYGCmMR0PZtuajUApqTnYWqEPgJ9KcJc9FJH3LIpTfq25RTICGAbWw==";
        };
        _2zB28vq7 = {
            "id" = "2zB28vq7";
            "file" = "perspective_api-1.5.0-beta+fabric-1.20.1.jar";
            "hash" = "sha512-IF3VFS8F6bUGX6SCDPUQJ5bCMKpmLCuS5ErOFstqItGfvdqvx4DOhz4vAFguTVv6pLleIveToxdT1EQ1cX80qw==";
        };
        _QJaJLFdM = {
            "id" = "QJaJLFdM";
            "file" = "perspective_api-1.5.0-beta+forge-1.20.1.jar";
            "hash" = "sha512-kSS18SjuUH5YXRleN1SXKtIOqiMpB7f+KxY37F+zjmL/C6Mt+E3S6GPMkXH8eBB6PqYK62iluIO4mqYlcS5+SA==";
        };
        _hAj8dx8X = {
            "id" = "hAj8dx8X";
            "file" = "perspective_api-1.5.0-beta+fabric-1.20.4.jar";
            "hash" = "sha512-458zeEBJlMHsJsc55sof8A/V0ezAQqbUYiHOE+/0ycbHfsbEVJ/J8sUWD0ro4D+38MG1SwzLkNoqIgAvWn+QgQ==";
        };
        _wWFMv4F1 = {
            "id" = "wWFMv4F1";
            "file" = "perspective_api-1.5.0-beta+neoforge-1.20.4.jar";
            "hash" = "sha512-sQ/ymb1HB5cw8wXSyHQvuPG3GukbGa8ykXfNky62qbZN017Qt+p8b/KYT9+pe1xjXyfwpxVtBEKipNoXq+VnKw==";
        };
        _yQGoSY8B = {
            "id" = "yQGoSY8B";
            "file" = "perspective_api-1.5.0-beta+fabric-1.20.6.jar";
            "hash" = "sha512-vD2ytk+ZWQ9suNgOqh/am1o0FbEt8XTA8ACXrMZnHxsFcfAc/CuL53msDiG9wLJXHQxKT9xQtXBvqY64HJZ3pQ==";
        };
        _KIcxgNsY = {
            "id" = "KIcxgNsY";
            "file" = "perspective_api-1.5.0-beta+fabric-1.21.jar";
            "hash" = "sha512-6uC1C/bW5W6VaIOOssBnHzPqfoR87a9DmuQRtWVVzPyDkad8wjeaTVbxgD0dgSTJhHOdkLUzjvaMtRXWEin4Jw==";
        };
        _wGuCOehx = {
            "id" = "wGuCOehx";
            "file" = "perspective_api-1.5.0-beta+neoforge-1.20.6.jar";
            "hash" = "sha512-2b1XVT4vy3iw7TTkt0ZFo8V7cOu8uxI6ZPxibRe7O1uhtS1mbuKIC4r+uwUx659sUweItokiPEpYB3v0/k9PvQ==";
        };
        _qhO0B6a4 = {
            "id" = "qhO0B6a4";
            "file" = "perspective_api-1.5.0-beta+neoforge-1.21.jar";
            "hash" = "sha512-rjWZanNWl+nm+vC+2WtpvLqfIvybINEYDZsE0lbAcHqRFWnhthxRvrAzczP1tLuyFpS6cAhCDkk7rkudTyPRTA==";
        };
        _VNsRICpc = {
            "id" = "VNsRICpc";
            "file" = "perspective_api-1.5.0-beta+fabric-1.21.11.jar";
            "hash" = "sha512-GDgMyszf6M2iEPgX7fCBPSYV5VVYl1rHoeWwyh0sJeYlCrnzeY/vK9crpRegw+KyOGlV/seVJHCKiGEaNWT5Xg==";
        };
        _WlZx5pue = {
            "id" = "WlZx5pue";
            "file" = "perspective_api-1.5.0-beta+neoforge-1.21.11.jar";
            "hash" = "sha512-/H97/OTUWOSOWFxKhbM3+qm8V2LKzublUi+3VFDDGEq7/k3oZoL8ObmVm7hnZbqPDvtdnUPKGdD1tWqpY39Cww==";
        };
        _DcTNVpwT = {
            "id" = "DcTNVpwT";
            "file" = "perspective_api-1.5.0-beta+fabric-26.1.jar";
            "hash" = "sha512-TLf8GY5mXRGkWNr6qqM7ZNfaLRsz8A+ymnb7PXSN2Ms2VLgocPoNo+rYajB8+To3Uph7sSxJTcCAu4qbmpb6dA==";
        };
        _cuskoxpS = {
            "id" = "cuskoxpS";
            "file" = "perspective_api-1.5.0-beta+fabric-26.2.jar";
            "hash" = "sha512-cO//JnftpZucdQJgKXE3D7Va3j/ydRGe9QkFnS0CLe11zv03kTOLRcmnYBXh68OMbfOrpfRxeadOe1FbS6RIAA==";
        };
        _XEGEhVgp = {
            "id" = "XEGEhVgp";
            "file" = "perspective_api-1.5.0-beta+neoforge-26.1.jar";
            "hash" = "sha512-UtQcMoWzw/ET5H1wk+0J3qKYMI6md6iysiZhFCITDVw9WebCj9JrsUGGkS1Iu+cizxycR9MVhH/vxquOyuZTQQ==";
        };
        _lLv3L6CG = {
            "id" = "lLv3L6CG";
            "file" = "perspective_api-1.5.0-beta+neoforge-26.2.jar";
            "hash" = "sha512-bxpVQn+j+iefhKddmRQJa9dwfXbLvZDNyO3IaV7b+sfR0u3D8kpciIb9IIdKa8tpsUHYnoI77cgAmnsJFbcbjQ==";
        };
    in {
        "3tdE4pZL" = _3tdE4pZL;
        "eWMuhdrh" = _eWMuhdrh;
        ...
        "XEGEhVgp" = _XEGEhVgp;
        "lLv3L6CG" = _lLv3L6CG;
        "fabric-1.20.1" = _2zB28vq7;
        "fabric-1.20.4" = _hAj8dx8X;
        "fabric-1.20.6" = _yQGoSY8B;
        "fabric-1.21" = _KIcxgNsY;
        "fabric-26.1" = _DcTNVpwT;
        "fabric-1.21.11" = _VNsRICpc;
        "fabric-26.2" = _cuskoxpS;
        "fabric-26.1.1" = _DcTNVpwT;
        "fabric-26.1.2" = _DcTNVpwT;
        "fabric-1.21.1" = _KIcxgNsY;
        "forge-1.20.1" = _QJaJLFdM;
        "neoforge-1.20.4" = _wWFMv4F1;
        "neoforge-1.20.6" = _wGuCOehx;
        "neoforge-1.21" = _qhO0B6a4;
        "neoforge-26.1" = _XEGEhVgp;
        "neoforge-1.21.11" = _WlZx5pue;
        "neoforge-26.2" = _lLv3L6CG;
        "neoforge-26.1.1" = _XEGEhVgp;
        "neoforge-26.1.2" = _XEGEhVgp;
        "neoforge-1.21.1" = _qhO0B6a4;
        "pkg-0.1.0-beta+fabric-1.20.1" = _3tdE4pZL;
        "pkg-0.1.0-beta+forge-1.20.1" = _eWMuhdrh;
        "pkg-0.1.0-beta+fabric-1.20.4" = _3Y9tkMNN;
        "pkg-0.1.0-beta+neoforge-1.20.4" = _9UJGbB9g;
        "pkg-0.1.0-beta+neoforge-1.20.6" = _4WsmqhPR;
        "pkg-0.1.0-beta+fabric-1.20.6" = _h5vu3tsz;
        "pkg-0.1.0-beta+neoforge-1.21" = _y7gKtSUU;
        "pkg-0.1.0-beta+fabric-1.21" = _y9nwiJ2z;
        "pkg-0.1.0-beta+fabric-26.1" = _cRmGCQGg;
        "pkg-0.1.0-beta+neoforge-26.1" = _5N6nerNB;
        "pkg-0.1.0-beta+fabric-1.21.11" = _tEB6gy5U;
        "pkg-0.1.0-beta+neoforge-1.21.11" = _FG9QnIhp;
        "pkg-0.1.0-beta+fabric-26.2" = _QeF6o7CG;
        "pkg-0.1.0-beta+neoforge-26.2" = _kBTOULUk;
        "pkg-1.0.0-beta.1+fabric-1.20.1" = _m9SOgUSp;
        "pkg-1.0.0-beta.1+forge-1.20.1" = _6vdKo9mX;
        "pkg-1.0.0-beta.1+fabric-1.20.4" = _3stqKdRW;
        "pkg-1.0.0-beta.1+neoforge-1.20.4" = _bbIY5NgX;
        "pkg-1.0.0-beta.1+fabric-1.20.6" = _Y830KLAg;
        "pkg-1.0.0-beta.1+neoforge-1.20.6" = _grjZzAYG;
        "pkg-1.0.0-beta.1+fabric-1.21" = _n7L1W4Tn;
        "pkg-1.0.0-beta.1+neoforge-1.21" = _o1XObB1z;
        "pkg-1.0.0-beta.1+fabric-1.21.11" = _JGQ9ddbg;
        "pkg-1.0.0-beta.1+neoforge-1.21.11" = _Sb7qzysR;
        "pkg-1.0.0-beta.1+fabric-26.1" = _wIZRefhZ;
        "pkg-1.0.0-beta.1+neoforge-26.1" = _NT8kfsHz;
        "pkg-1.0.0-beta.1+fabric-26.2" = _pYeEVWLs;
        "pkg-1.0.0-beta.1+neoforge-26.2" = _U0JQgTKx;
        "pkg-1.0.0-beta.3+fabric-1.20.1" = _3HFYJDTg;
        "pkg-1.0.0-beta.3+forge-1.20.1" = _KIq7j4F9;
        "pkg-1.0.0-beta.3+fabric-1.20.4" = _1zYkK5jS;
        "pkg-1.0.0-beta.3+neoforge-1.20.4" = _T3XLqdgc;
        "pkg-1.0.0-beta.3+fabric-1.20.6" = _dCWQkqqj;
        "pkg-1.0.0-beta.3+neoforge-1.20.6" = _TeYhWz71;
        "pkg-1.0.0-beta.3+fabric-1.21" = _56lJpE1D;
        "pkg-1.0.0-beta.3+neoforge-1.21" = _KtHR8FuA;
        "pkg-1.0.0-beta.3+fabric-1.21.11" = _pjKYt4oa;
        "pkg-1.0.0-beta.3+neoforge-1.21.11" = _MavhSbxC;
        "pkg-1.0.0-beta.3+fabric-26.1" = _UBktmKoS;
        "pkg-1.0.0-beta.3+neoforge-26.1" = _ECbYddj1;
        "pkg-1.0.0-beta.3+fabric-26.2" = _cnJE3VOJ;
        "pkg-1.0.0-beta.3+neoforge-26.2" = _6RZ5n25f;
        "pkg-1.0.0-beta.4+forge-1.20.1" = _XlZ2vs1y;
        "pkg-1.0.0-beta.4+fabric-1.20.1" = _k8LRBOXr;
        "pkg-1.0.0-beta.4+fabric-1.20.4" = _St3dPpFG;
        "pkg-1.0.0-beta.4+neoforge-1.20.4" = _zbgcc43D;
        "pkg-1.0.0-beta.4+fabric-1.20.6" = _Kfq6qkA4;
        "pkg-1.0.0-beta.4+neoforge-1.20.6" = _eSG9jZNx;
        "pkg-1.0.0-beta.4+fabric-1.21" = _SsD2rEZL;
        "pkg-1.0.0-beta.4+neoforge-1.21" = _XphZJC2e;
        "pkg-1.0.0-beta.4+fabric-1.21.11" = _20xDSZ16;
        "pkg-1.0.0-beta.4+neoforge-1.21.11" = _NGLTLiw7;
        "pkg-1.0.0-beta.4+fabric-26.1" = _3z1NfRPo;
        "pkg-1.0.0-beta.4+neoforge-26.1" = _YuSFBhlg;
        "pkg-1.0.0-beta.4+fabric-26.2" = _G9sOaxH7;
        "pkg-1.0.0-beta.4+neoforge-26.2" = _3fYyQOYt;
        "pkg-1.0.0-beta.5+fabric-1.20.1" = _288wEB1f;
        "pkg-1.0.0-beta.5+forge-1.20.1" = _gj32HM67;
        "pkg-1.0.0-beta.5+fabric-1.20.4" = _dezysPSR;
        "pkg-1.0.0-beta.5+neoforge-1.20.4" = _wPxnO7eP;
        "pkg-1.0.0-beta.5+fabric-1.20.6" = _lt6w98x1;
        "pkg-1.0.0-beta.5+neoforge-1.20.6" = _bPFUSuLj;
        "pkg-1.0.0-beta.5+fabric-1.21" = _aT9BAh2L;
        "pkg-1.0.0-beta.5+neoforge-1.21" = _K5kG78ji;
        "pkg-1.0.0-beta.5+fabric-1.21.11" = _Mb5LWkD5;
        "pkg-1.0.0-beta.5+neoforge-1.21.11" = _rZw939ha;
        "pkg-1.0.0-beta.5+fabric-26.1" = _n4h05yAR;
        "pkg-1.0.0-beta.5+neoforge-26.1" = _TtvbH2ud;
        "pkg-1.0.0-beta.5+fabric-26.2" = _aQB4U3uH;
        "pkg-1.0.0-beta.5+neoforge-26.2" = _Gz2u74Kf;
        "pkg-1.0.0-beta.6+fabric-1.20.1" = _hx1mc5rN;
        "pkg-1.0.0-beta.6+forge-1.20.1" = _jvO7nzK9;
        "pkg-1.0.0-beta.6+fabric-1.20.4" = _8sk3aDlq;
        "pkg-1.0.0-beta.6+neoforge-1.20.4" = _fVuJqTem;
        "pkg-1.0.0-beta.6+fabric-1.20.6" = _jchzCTbZ;
        "pkg-1.0.0-beta.6+neoforge-1.20.6" = _YpozPiWF;
        "pkg-1.0.0-beta.6+fabric-1.21" = _1Et3Emk0;
        "pkg-1.0.0-beta.6+neoforge-1.21" = _aGPDt33c;
        "pkg-1.0.0-beta.6+fabric-1.21.11" = _i48O4mvm;
        "pkg-1.0.0-beta.6+neoforge-1.21.11" = _aDNKPLB7;
        "pkg-1.0.0-beta.6+fabric-26.1" = _Tul5EwF8;
        "pkg-1.0.0-beta.6+neoforge-26.1" = _WNwf7IbB;
        "pkg-1.0.0-beta.6+fabric-26.2" = _xVkssK83;
        "pkg-1.0.0-beta.6+neoforge-26.2" = _DhT5TOkF;
        "pkg-1.0.0-beta.7+forge-1.20.1" = _hfSGAyt6;
        "pkg-1.0.0-beta.7+fabric-1.20.1" = _YjfYHKVs;
        "pkg-1.0.0-beta.7+fabric-1.20.4" = _msakOtKS;
        "pkg-1.0.0-beta.7+neoforge-1.20.4" = _DoFlWrpf;
        "pkg-1.0.0-beta.7+fabric-1.20.6" = _Mm7GjjFO;
        "pkg-1.0.0-beta.7+neoforge-1.20.6" = _N9XBYXeR;
        "pkg-1.0.0-beta.7+fabric-1.21" = _FHNHbb0R;
        "pkg-1.0.0-beta.7+neoforge-1.21" = _bt2FnZ9f;
        "pkg-1.0.0-beta.7+fabric-1.21.11" = _5ujvGkkr;
        "pkg-1.0.0-beta.7+neoforge-1.21.11" = _Xjhv1IP9;
        "pkg-1.0.0-beta.7+fabric-26.1" = _Ho3md9iN;
        "pkg-1.0.0-beta.7+neoforge-26.1" = _ry6s8lo5;
        "pkg-1.0.0-beta.7+fabric-26.2" = _fIZAN3yX;
        "pkg-1.0.0-beta.7+neoforge-26.2" = _1WP0x9w9;
        "pkg-1.0.0-beta.8+forge-1.20.1" = _GmgDsIOM;
        "pkg-1.0.0-beta.8+fabric-1.20.1" = _B2bTxZA9;
        "pkg-1.0.0-beta.8+fabric-1.20.4" = _Omk7kjEk;
        "pkg-1.0.0-beta.8+neoforge-1.20.4" = _EYYEHtv3;
        "pkg-1.0.0-beta.8+fabric-1.20.6" = _cxzOg6Rq;
        "pkg-1.0.0-beta.8+neoforge-1.20.6" = _L4ucWqew;
        "pkg-1.0.0-beta.8+fabric-1.21" = _dHMgaIqn;
        "pkg-1.0.0-beta.8+neoforge-1.21" = _ToYmgNGk;
        "pkg-1.0.0-beta.8+fabric-1.21.11" = _lcCR0x2u;
        "pkg-1.0.0-beta.8+neoforge-1.21.11" = _bZr6iiE2;
        "pkg-1.0.0-beta.8+fabric-26.1" = _LoGiFLQ2;
        "pkg-1.0.0-beta.8+neoforge-26.1" = _g2pyT0iA;
        "pkg-1.0.0-beta.8+fabric-26.2" = _hF6LWDUZ;
        "pkg-1.0.0-beta.8+neoforge-26.2" = _YqgBRtqF;
        "pkg-1.0.0-beta.9+fabric-1.20.1" = _atLcAUOp;
        "pkg-1.0.0-beta.9+forge-1.20.1" = _6HiezAWh;
        "pkg-1.0.0-beta.9+fabric-1.20.4" = _L0RUqCwM;
        "pkg-1.0.0-beta.9+neoforge-1.20.4" = _gfnAIVJg;
        "pkg-1.0.0-beta.9+fabric-1.20.6" = _kdNcPRH2;
        "pkg-1.0.0-beta.9+neoforge-1.20.6" = _uF3sLHbA;
        "pkg-1.0.0-beta.9+fabric-1.21" = _ZxRbtpeQ;
        "pkg-1.0.0-beta.9+neoforge-1.21" = _ad4Rc5rA;
        "pkg-1.0.0-beta.9+fabric-1.21.11" = _bcuPSu96;
        "pkg-1.0.0-beta.9+neoforge-1.21.11" = _LnJVmszC;
        "pkg-1.0.0-beta.9+fabric-26.1" = _eo0j7CyE;
        "pkg-1.0.0-beta.9+neoforge-26.1" = _tCSWssVA;
        "pkg-1.0.0-beta.9+fabric-26.2" = _eZPTs22d;
        "pkg-1.0.0-beta.9+neoforge-26.2" = _K5q558Qx;
        "pkg-1.0.0-beta.10+forge-1.20.1" = _dzpuxNTB;
        "pkg-1.0.0-beta.10+fabric-1.20.1" = _wgZwV0v0;
        "pkg-1.0.0-beta.10+fabric-1.20.4" = _Qmuejl7z;
        "pkg-1.0.0-beta.10+neoforge-1.20.4" = _4Ix8nnMX;
        "pkg-1.0.0-beta.10+fabric-1.20.6" = _26mPAQ9f;
        "pkg-1.0.0-beta.10+neoforge-1.20.6" = _vdvr0Gpk;
        "pkg-1.0.0-beta.10+fabric-1.21" = _CtS7H64u;
        "pkg-1.0.0-beta.10+neoforge-1.21" = _SDDXP28D;
        "pkg-1.0.0-beta.10+fabric-1.21.11" = _PSmJBcMo;
        "pkg-1.0.0-beta.10+neoforge-1.21.11" = _bt8FExeN;
        "pkg-1.0.0-beta.10+fabric-26.1" = _xJAK5GFs;
        "pkg-1.0.0-beta.10+neoforge-26.1" = _wW2h73ic;
        "pkg-1.0.0-beta.10+fabric-26.2" = _JaupHD5R;
        "pkg-1.0.0-beta.10+neoforge-26.2" = _nKSqdEhH;
        "pkg-1.0.0-beta.11+forge-1.20.1" = _YDnFCtjZ;
        "pkg-1.0.0-beta.11+fabric-1.20.1" = _sz0DpXDB;
        "pkg-1.0.0-beta.11+fabric-1.20.4" = _5VdiFXaQ;
        "pkg-1.0.0-beta.11+neoforge-1.20.4" = _BAvEQ6wS;
        "pkg-1.0.0-beta.11+fabric-1.20.6" = _rqBuFuR8;
        "pkg-1.0.0-beta.11+neoforge-1.20.6" = _ResTekwy;
        "pkg-1.0.0-beta.11+fabric-1.21" = _QJfzkdJB;
        "pkg-1.0.0-beta.11+neoforge-1.21" = _mq6r4YeH;
        "pkg-1.0.0-beta.11+fabric-1.21.11" = _aWwlQ8ak;
        "pkg-1.0.0-beta.11+neoforge-1.21.11" = _dTz646mR;
        "pkg-1.0.0-beta.11+fabric-26.1" = _Yz7YCm7K;
        "pkg-1.0.0-beta.11+neoforge-26.1" = _FVuili2R;
        "pkg-1.0.0-beta.11+fabric-26.2" = _ppISdpZU;
        "pkg-1.0.0-beta.11+neoforge-26.2" = _2ZEVoOOR;
        "pkg-1.0.0-beta.12+forge-1.20.1" = _esXF14Bs;
        "pkg-1.0.0-beta.12+fabric-1.20.1" = _RE58JmdV;
        "pkg-1.0.0-beta.12+fabric-1.20.4" = _2yaTrn6z;
        "pkg-1.0.0-beta.12+neoforge-1.20.4" = _OzVNVpup;
        "pkg-1.0.0-beta.12+fabric-1.20.6" = _7z5ptLSK;
        "pkg-1.0.0-beta.12+neoforge-1.20.6" = _XBSpyLFB;
        "pkg-1.0.0-beta.12+fabric-1.21" = _SePKtuf2;
        "pkg-1.0.0-beta.12+neoforge-1.21" = _ghh6jbIx;
        "pkg-1.0.0-beta.12+fabric-1.21.11" = _npMxoneF;
        "pkg-1.0.0-beta.12+neoforge-1.21.11" = _PgtHiVdK;
        "pkg-1.0.0-beta.12+fabric-26.1" = _5rUCInEZ;
        "pkg-1.0.0-beta.12+neoforge-26.1" = _VCcefFOx;
        "pkg-1.0.0-beta.12+fabric-26.2" = _jIe55nsx;
        "pkg-1.0.0-beta.12+neoforge-26.2" = _vJ6dFqYI;
        "pkg-1.0.0-beta.13+fabric-1.20.1" = _etVYMib1;
        "pkg-1.0.0-beta.13+forge-1.20.1" = _CRCqyBnt;
        "pkg-1.0.0-beta.13+fabric-1.20.4" = _Nl6CBvj0;
        "pkg-1.0.0-beta.13+neoforge-1.20.4" = _Lao2bsQG;
        "pkg-1.0.0-beta.13+fabric-1.20.6" = _ZSHgyLUL;
        "pkg-1.0.0-beta.13+neoforge-1.20.6" = _xyANaTTO;
        "pkg-1.0.0-beta.13+fabric-1.21" = _qMExnHvP;
        "pkg-1.0.0-beta.13+neoforge-1.21" = _dQIdwQc8;
        "pkg-1.0.0-beta.13+fabric-1.21.11" = _1pdavLjd;
        "pkg-1.0.0-beta.13+neoforge-1.21.11" = _DoesrTlW;
        "pkg-1.0.0-beta.13+fabric-26.1" = _HP6fofz9;
        "pkg-1.0.0-beta.13+neoforge-26.1" = _mjbcC8ZS;
        "pkg-1.0.0-beta.13+fabric-26.2" = _VPAxh4BC;
        "pkg-1.0.0-beta.13+neoforge-26.2" = _dIXVsKpR;
        "pkg-1.1.0-beta+fabric-1.20.1" = _sKrYSP1x;
        "pkg-1.1.0-beta+forge-1.20.1" = _a9TxtWXg;
        "pkg-1.1.0-beta+fabric-1.20.4" = _eeX5TV6j;
        "pkg-1.1.0-beta+neoforge-1.20.4" = _EUlNhz9K;
        "pkg-1.1.0-beta+fabric-1.20.6" = _QYd9GebI;
        "pkg-1.1.0-beta+neoforge-1.20.6" = _Vy4jp8PF;
        "pkg-1.1.0-beta+fabric-1.21" = _A84PMAjS;
        "pkg-1.1.0-beta+neoforge-1.21" = _fqR9QrLt;
        "pkg-1.1.0-beta+fabric-1.21.11" = _SXBNPj4T;
        "pkg-1.1.0-beta+neoforge-1.21.11" = _yC8iYuxf;
        "pkg-1.1.0-beta+fabric-26.1" = _oCOY4G0Y;
        "pkg-1.1.0-beta+neoforge-26.1" = _8WU5cQMO;
        "pkg-1.1.0-beta+fabric-26.2" = _JmzqF4Qu;
        "pkg-1.1.0-beta+neoforge-26.2" = _LNRdpEcM;
        "pkg-1.2.0-beta+fabric-1.20.1" = _7MoX85Kb;
        "pkg-1.2.0-beta+forge-1.20.1" = _QFsaeVYg;
        "pkg-1.2.0-beta+fabric-1.20.4" = _4SFeKWUr;
        "pkg-1.2.0-beta+neoforge-1.20.4" = _Jvgyugqh;
        "pkg-1.2.0-beta+fabric-1.20.6" = _nI1ikFh4;
        "pkg-1.2.0-beta+neoforge-1.20.6" = _Rn4QaUF8;
        "pkg-1.2.0-beta+fabric-1.21" = _zdLAbeZy;
        "pkg-1.2.0-beta+neoforge-1.21" = _cbuU4TXC;
        "pkg-1.2.0-beta+fabric-1.21.11" = _7srhKWEJ;
        "pkg-1.2.0-beta+neoforge-1.21.11" = _Dm9qSyJD;
        "pkg-1.2.0-beta+fabric-26.1" = _TQcqaMOj;
        "pkg-1.2.0-beta+neoforge-26.1" = _ZUleXT2w;
        "pkg-1.2.0-beta+fabric-26.2" = _lc0SxE97;
        "pkg-1.2.0-beta+neoforge-26.2" = _eH9GU6eh;
        "pkg-1.3.0-beta+fabric-1.20.1" = _8653gVAC;
        "pkg-1.3.0-beta+forge-1.20.1" = _iQYmzV4x;
        "pkg-1.3.0-beta+fabric-1.20.4" = _6TIKPkaf;
        "pkg-1.3.0-beta+neoforge-1.20.4" = _528grWST;
        "pkg-1.3.0-beta+fabric-1.20.6" = _jH07gpWT;
        "pkg-1.3.0-beta+neoforge-1.20.6" = _nVqLliIQ;
        "pkg-1.3.0-beta+fabric-1.21" = _llH4HJXk;
        "pkg-1.3.0-beta+neoforge-1.21" = _qOoGhNvy;
        "pkg-1.3.0-beta+fabric-1.21.11" = _GulKzSZF;
        "pkg-1.3.0-beta+neoforge-1.21.11" = _sWRAf5Sd;
        "pkg-1.3.0-beta+fabric-26.1" = _rWbU459f;
        "pkg-1.3.0-beta+neoforge-26.1" = _Ek0G53Zz;
        "pkg-1.3.0-beta+fabric-26.2" = _UlQ39jLz;
        "pkg-1.3.0-beta+neoforge-26.2" = _swzp6rEc;
        "pkg-1.3.1-beta+fabric-1.20.1" = _8BwNdi5S;
        "pkg-1.3.1-beta+forge-1.20.1" = _t93dg9zO;
        "pkg-1.3.1-beta+fabric-1.20.4" = _Y0JfzEy6;
        "pkg-1.3.1-beta+neoforge-1.20.4" = _ZLAUmmSr;
        "pkg-1.3.1-beta+fabric-1.20.6" = _W94fLMBd;
        "pkg-1.3.1-beta+neoforge-1.20.6" = _JPbOEfvx;
        "pkg-1.3.1-beta+fabric-1.21" = _HmdAe7Ui;
        "pkg-1.3.1-beta+neoforge-1.21" = _IejpoEz1;
        "pkg-1.3.1-beta+fabric-1.21.11" = _cWwCma5J;
        "pkg-1.3.1-beta+neoforge-1.21.11" = _fsFgvjtb;
        "pkg-1.3.1-beta+fabric-26.1" = _3cXLrVfy;
        "pkg-1.3.1-beta+neoforge-26.1" = _KySW1eF8;
        "pkg-1.3.1-beta+fabric-26.2" = _u644STqv;
        "pkg-1.3.1-beta+neoforge-26.2" = _ylxv6Dzb;
        "pkg-1.3.2-beta+fabric-1.20.1" = _1DdxlrnE;
        "pkg-1.3.2-beta+forge-1.20.1" = _VPNRsKJj;
        "pkg-1.3.2-beta+fabric-1.20.4" = _6hf8vb73;
        "pkg-1.3.2-beta+neoforge-1.20.4" = _xvPAzwo8;
        "pkg-1.3.2-beta+fabric-1.20.6" = _Pqpvp7dr;
        "pkg-1.3.2-beta+neoforge-1.20.6" = _JhnVFkWK;
        "pkg-1.3.2-beta+fabric-1.21" = _liAbIWnm;
        "pkg-1.3.2-beta+fabric-1.21.11" = _9OZkQujw;
        "pkg-1.3.2-beta+neoforge-1.21" = _todf1hAo;
        "pkg-1.3.2-beta+neoforge-1.21.11" = _RmryXmpE;
        "pkg-1.3.2-beta+fabric-26.1" = _vgLIRjwt;
        "pkg-1.3.2-beta+neoforge-26.1" = _1DKNiceC;
        "pkg-1.3.2-beta+fabric-26.2" = _H8TUo3QH;
        "pkg-1.3.2-beta+neoforge-26.2" = _lEGpA2s7;
        "pkg-1.4.0-beta+fabric-1.20.1" = _cRR8XGTL;
        "pkg-1.4.0-beta+forge-1.20.1" = _R04CAGME;
        "pkg-1.4.0-beta+fabric-1.20.4" = _LwKH82Zr;
        "pkg-1.4.0-beta+neoforge-1.20.4" = _D92lHevn;
        "pkg-1.4.0-beta+fabric-1.20.6" = _teInDDRK;
        "pkg-1.4.0-beta+neoforge-1.20.6" = _EVRXRvgJ;
        "pkg-1.4.0-beta+fabric-1.21" = _UPib1eYA;
        "pkg-1.4.0-beta+neoforge-1.21" = _k0hwSc7L;
        "pkg-1.4.0-beta+fabric-1.21.11" = _YzZMM8Pn;
        "pkg-1.4.0-beta+neoforge-1.21.11" = _KiD5SVmZ;
        "pkg-1.4.0-beta+fabric-26.1" = _26vPAy6H;
        "pkg-1.4.0-beta+neoforge-26.1" = _o6QX0aHA;
        "pkg-1.4.0-beta+fabric-26.2" = _WTdm0stv;
        "pkg-1.4.0-beta+neoforge-26.2" = _3wBPqwlL;
        "pkg-1.5.0-beta+fabric-1.20.1" = _2zB28vq7;
        "pkg-1.5.0-beta+forge-1.20.1" = _QJaJLFdM;
        "pkg-1.5.0-beta+fabric-1.20.4" = _hAj8dx8X;
        "pkg-1.5.0-beta+neoforge-1.20.4" = _wWFMv4F1;
        "pkg-1.5.0-beta+fabric-1.20.6" = _yQGoSY8B;
        "pkg-1.5.0-beta+fabric-1.21" = _KIcxgNsY;
        "pkg-1.5.0-beta+neoforge-1.20.6" = _wGuCOehx;
        "pkg-1.5.0-beta+neoforge-1.21" = _qhO0B6a4;
        "pkg-1.5.0-beta+fabric-1.21.11" = _VNsRICpc;
        "pkg-1.5.0-beta+neoforge-1.21.11" = _WlZx5pue;
        "pkg-1.5.0-beta+fabric-26.1" = _DcTNVpwT;
        "pkg-1.5.0-beta+fabric-26.2" = _cuskoxpS;
        "pkg-1.5.0-beta+neoforge-26.1" = _XEGEhVgp;
        "pkg-1.5.0-beta+neoforge-26.2" = _lLv3L6CG;
        "default" = _lLv3L6CG;
    });
