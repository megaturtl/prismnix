...
let
    versions = (let
        ...
        _pY6GtJHh = {
            "id" = "pY6GtJHh";
            "file" = "[AFTP] 15w14a.zip";
            "hash" = "sha512-59WihWfHPuLQ4+3B4ZETfzXKiKglkdeceVEZ/1hvBMRjyhapGlu/CRw9ccRlCN4LZ3Q4l+5QtXFQVBIL0S1R+g==";
        };
        _jWRHqD3h = {
            "id" = "jWRHqD3h";
            "file" = "[AFTP] 23w13a_or_b.zip";
            "hash" = "sha512-IfvVY1dtxJA90o0qEG1Q7cgCZSc5qo7QthlVyLHCug3EZC5TMElk0tE9G5nsvVRYGdCd4HEnRhRvaKMRVwDK/w==";
        };
        _H8Sbvy8j = {
            "id" = "H8Sbvy8j";
            "file" = "[AFTP] 24w14potato.zip";
            "hash" = "sha512-VoVV6pASS8zR2iCoKsxTdyUUcII53cMXFmrzCHhqOOwDiT1HRTbm1bKkAcsJipbyqeXgAbdrTZuxwKPF2G7fGw==";
        };
        _fXpZqoT8 = {
            "id" = "fXpZqoT8";
            "file" = "[AFTP] 25w14craftmine.zip";
            "hash" = "sha512-K55ZH1IFZzZXdicU5yeAZB9Ey/+14d7rS+TUmu7hb2hTtFOHrnu6rYIMTf8Q+MJ3r+Ozkjz5EVgHv/whTnUgfw==";
        };
        _MkV0QQm5 = {
            "id" = "MkV0QQm5";
            "file" = "[AFTP] 1.RV-Pre1.zip";
            "hash" = "sha512-uL/f6xKVwadwySlooDZeCInR9tw0dkMU1g6s5XAo0tsk/EeiPEOsB9NrGs7xRhGEuPGicr8blK0aRgksBOsTtQ==";
        };
        _hlTfSksy = {
            "id" = "hlTfSksy";
            "file" = "[AFTP] 3D Shareware v1.34.zip";
            "hash" = "sha512-8KjvNXTXPUAz7ju7GdeFDwJSi4e5xVAZvo/LcB2EqWARJnJMMsnuiwYmgcW0wyqzJG15JfQkRQUnpJV+ktdSpg==";
        };
        _BHpT4Y0I = {
            "id" = "BHpT4Y0I";
            "file" = "[AFTP] 20w14infinite.zip";
            "hash" = "sha512-PuqhyqG6HV1OEop2UKymc9g5wF0cvosF9vjXKK2xJTPBt/4XQDRVQPZtj+XNg6Iq5YB7AR5MmslOCCP00b25Dg==";
        };
        _D0TtUihM = {
            "id" = "D0TtUihM";
            "file" = "[AFTP] 22w13oneblockatatime.zip";
            "hash" = "sha512-/EyKgq14kV/SDZ4+NU+Wn8KldO+X7/tn3/bq4dlQB2wE9qKuKozNCfOe04HgFqB8G4A453x+BP/BK3avqGDJmA==";
        };
        _3Vgjn9Hn = {
            "id" = "3Vgjn9Hn";
            "file" = "[AFTP] 23w13a_or_b.zip";
            "hash" = "sha512-6y35ucCmBpM5ZsChb4djBoPksuXOx7DascIGwlUPa6wRDmrmA44WAHAWnvkhQ/M6U3bhzKQTzjWY5zeLyFjeJA==";
        };
        _6bl3RkSz = {
            "id" = "6bl3RkSz";
            "file" = "[AFTP] 24w14potato.zip";
            "hash" = "sha512-Hk+KTtpwXJiSLt2c2/16y6yZji4KeCl9T/9Z2JRYNgEbM/jpvN7SMDErEWoxVZUdyOd6USj2oozeLlkHC1bObA==";
        };
        _P21PZJJf = {
            "id" = "P21PZJJf";
            "file" = "[AFTP] 25w14craftmine.zip";
            "hash" = "sha512-Mja0e3jIdIN2nzX7SuEh4FtHqYZK2LX7E1eC8TArGbmAoOyXC05Q71kb4MUlPJyYb39LxidRw67rr5GSduTS+Q==";
        };
        _rq4MtwRb = {
            "id" = "rq4MtwRb";
            "file" = "[AFTP] 26w14a.zip";
            "hash" = "sha512-4Qgjl5xmbMqXGD3tCRQ/3ZK+VC75ZmmCjMKX6bQCyOf3NmAjuSgLAgSwFZ8OnfqHld2nfFhvrG4tnYv3mhV8yA==";
        };
        _ZnJFgzX8 = {
            "id" = "ZnJFgzX8";
            "file" = "[AFTP] 1.RV-Pre1.zip";
            "hash" = "sha512-3RivxM+E+oIxsaYjqicyZ936BOH49gkH639Fd4c6tXZV1NNmXV2OpeehQqlnyZlIMoUnknEu9choN9xHU3BnJw==";
        };
        _xXOLfqvA = {
            "id" = "xXOLfqvA";
            "file" = "[AFTP] 23w13a_or_b.zip";
            "hash" = "sha512-gCKtN7em5VsG2zfIRJZJtXy4jx9G4Yv+4ZukUF1dOKakf8vgRTwlLi2xdOUjTj5wAwAV3n8zrn946hVzjg+vbA==";
        };
        _tWYcOLAW = {
            "id" = "tWYcOLAW";
            "file" = "[AFTP] 24w14potato.zip";
            "hash" = "sha512-LZySdIeVVfrutXkOMOrWUyEFtE2sVqvGOXd/i7Q4LVJ6CZpLie1LauoSvyP++S3Bv4iGUE2ik51ZboOflgbWZg==";
        };
        _GmJBsp4x = {
            "id" = "GmJBsp4x";
            "file" = "[AFTP] 25w14craftmine.zip";
            "hash" = "sha512-WmeUiiNA11Ld6zONkr0YFn1giIkl6z3Z3xFgGjADAlo2riduxGPc0yeSPF6oT0PTdWqYdk/gVW0LAQGxZ2uamg==";
        };
        _mavShDwJ = {
            "id" = "mavShDwJ";
            "file" = "[AFTP] 15w14a.zip";
            "hash" = "sha512-nMTFsSVnrZ/4IefI00nSULWjLWr3YZ8Ltl6QhXZnNdqU+yB1+Bv1h19yey3xjl71f2Vrv2eFpHDDx+tI3dW43w==";
        };
        _C8buDjAr = {
            "id" = "C8buDjAr";
            "file" = "[AFTP] 1.RV-Pre1.zip";
            "hash" = "sha512-JujfGKoR3Dv2eIPj4C8y9lJjdAQ5z4W3MNwNurm3HDeH3lW2Y8qpvyDa4i+thTEt1JgmGW/8Z6xS+FjEklfWWg==";
        };
        _MHJW7UR9 = {
            "id" = "MHJW7UR9";
            "file" = "[AFTP] 3D Shareware v1.34.zip";
            "hash" = "sha512-C1r9PBfLjjgElrQqZSK42EUYS8rZP+PnVScBOAmfnI0LyYPfrmWrhBZnnyMdy43KgBR3XGw+YY6quk3rCzk0zw==";
        };
        _pZufRbD2 = {
            "id" = "pZufRbD2";
            "file" = "[AFTP] 20w14infinite.zip";
            "hash" = "sha512-phGmaab9J7KftPnQAocUSuqpLBvwfG+ESH4SsihK/CztC81mQ1CDeq5Og/vIaXGGwMai5xTzw3mK4lk8iT86ug==";
        };
        _gNhfe7XS = {
            "id" = "gNhfe7XS";
            "file" = "[AFTP] 22w13oneblockatatime.zip";
            "hash" = "sha512-VT+fFvEsrzDwiGPakxpAUjYwP/+nndNVEatiu0M0Ww8L87xIeUoqwmm5NfukWLjmSVZiA9LMdmuUGSy6I0UKtQ==";
        };
        _utA3ayNF = {
            "id" = "utA3ayNF";
            "file" = "[AFTP] 23w13a_or_b.zip";
            "hash" = "sha512-ygufc4pG9+Nyz24K0gLYgxyDx5g3DLBI0mRFykq09GK9S4I3/2vAPrVl6V3ucogLKhyiFy/mf3GLFtlt/9+m3g==";
        };
        _6NtUseFr = {
            "id" = "6NtUseFr";
            "file" = "[AFTP] 24w14potato.zip";
            "hash" = "sha512-enmshtx24LbcYWHnshpuz4A+o9Gyg1oUWSmirOkcz9qooX2q9NNIImnY/VpXGPbIMQSmwgF5bGuidCAVmfExzg==";
        };
        _C66uruXJ = {
            "id" = "C66uruXJ";
            "file" = "[AFTP] 25w14craftmine.zip";
            "hash" = "sha512-ZLUcReZkf+YQEzlzlbVXbOq/8ZJn5wTYBxdgIH2iDcASHgpkvi97i//bN+IdlwuVORcJhLGaDpP1+QcvALhg2w==";
        };
        _V5oATLCo = {
            "id" = "V5oATLCo";
            "file" = "[AFTP] 26w14a.zip";
            "hash" = "sha512-HzAKbU/24PlzVqre1FX917m28JEuqp/JcanrRg0bUXafc6QutzofLG4RMVP0reszw7IzwChJ4r4PQ7spGYX9lw==";
        };
        _Sm0EEP8o = {
            "id" = "Sm0EEP8o";
            "file" = "[AFTP] 15w14a.zip";
            "hash" = "sha512-YjgAttJ2A/5k0qLaFnChjEFwii1jhhLEm33beVTSIqoUh+dm3kp+FPs3erKZFkoWedEuVTmibtVV3/Whu+mt+Q==";
        };
        _RWTrBDHH = {
            "id" = "RWTrBDHH";
            "file" = "[AFTP] 1.RV-Pre1.zip";
            "hash" = "sha512-QEBNPmS4Lf05kvkvUQJljftIXtPKXm7NaQcBPxh+Ljg/n+utuXg+ZmcqN4yK5tTJS30D2Yd8khotgVCB5Go8EQ==";
        };
        _y3bRLhiV = {
            "id" = "y3bRLhiV";
            "file" = "[AFTP] 3D Shareware v1.34.zip";
            "hash" = "sha512-6YCf7dOz9O6A2BTxP42UDDu3GbFqVeLmDGg98X/mRZWL/8Vt2F1fjKlaHQJjjVj9acxAyuGJVv7/sZZgOBgaTQ==";
        };
        _NeUBHOWH = {
            "id" = "NeUBHOWH";
            "file" = "[AFTP] 20w14infinite.zip";
            "hash" = "sha512-G+MJl9ywNnj35PyeS36+zepOsuULaDMZYQ4VTYLgeZ7Wuf8FJkfJj/tYSIqtaHz7kJy8D+2QisMeUTp6QE7ZeQ==";
        };
        _8c3r9Ars = {
            "id" = "8c3r9Ars";
            "file" = "[AFTP] 22w13oneblockatatime.zip";
            "hash" = "sha512-vejlHY9rdUtQSbsT9N9Os2Kyqysuk0JB8ObRBYzDtFLSXlLUykMx17RbXr1wbM0SAjO4V4ZQvnE8lvZFAiEhPg==";
        };
        _nI0kgDF0 = {
            "id" = "nI0kgDF0";
            "file" = "[AFTP] 23w13a_or_b.zip";
            "hash" = "sha512-4ig6x9glrw6uZp4mD62bmXoO3Yp+HQEqLJl4tj0Bohwss1SaTuq4S3b0SPw1sN3dOykMg+IGAIUAlomGXaxpJg==";
        };
        _DhYJKvWO = {
            "id" = "DhYJKvWO";
            "file" = "[AFTP] 24w14potato.zip";
            "hash" = "sha512-Eo6yPpkQn1zUwMaXJ7Hju6rnTt2qh+jnuSLAUFN4u3V2Y4DQHpORN2GNpxt2Lyj6hjR0v6W2YB0cChnG4ZNBkQ==";
        };
        _mpyWsJ4c = {
            "id" = "mpyWsJ4c";
            "file" = "[AFTP] 25w14craftmine.zip";
            "hash" = "sha512-tskVvwzxQ9idFmwz4s2WQBmcvaQVsIZp/OHaFGSSC1AyfRZkuQSdng+qfT8A6LAueUw2hV1CZpQmahUkwcGLuQ==";
        };
        _u15BLTO7 = {
            "id" = "u15BLTO7";
            "file" = "[AFTP] 26w14a.zip";
    ...
    in {
        ...
        "pkg-250616+24w14potato" = _Xi2Zauwg;
        "pkg-250616+22w13oneBlockAtATime" = _2TrMu4dA;
        "pkg-250616+15w14a" = _S1Diti3S;
        "pkg-250616+20w14infinite" = _9KcCAXRP;
        "pkg-250616+3D_Shareware_v1.34" = _JahTWVsM;
        "pkg-250627+1.RV-Pre1" = _BndZlLzx;
        "pkg-250627+22w13oneBlockAtATime" = _JvVWqBFk;
        "pkg-250627+15w14a" = _h1HBnf5U;
        "pkg-250627+3D_Shareware_v1.34" = _B8zuhdER;
        "pkg-250627+23w13a_or_b" = _Z6o0q7un;
        "pkg-250627+25w14craftmine" = _DUd0lHLJ;
        "pkg-250627+24w14potato" = _zbP2cbPX;
        "pkg-250627+20w14infinite" = _CVAcb5my;
        "pkg-250629+15w14a" = _aPD6g8Rv;
        "pkg-250629+20w14infinite" = _eUFKrMYl;
        "pkg-250629+22w13oneBlockAtATime" = _TdXWY5NH;
        "pkg-250629+1.RV-Pre1" = _dRpaHHk5;
        "pkg-250629+3D_Shareware_v1.34" = _9BbPjmgX;
        "pkg-250629+24w14potato" = _Faj0kpSJ;
        "pkg-250629+25w14craftmine" = _sSOTOoZz;
        "pkg-250629+23w13a_or_b" = _kDbtrCYm;
        "pkg-250706+15w14a" = _ad87kJFC;
        "pkg-250706+1.RV-Pre1" = _wwvFIqU8;
        "pkg-250706+20w14infinite" = _oqAKiwcV;
        "pkg-250706+23w13a_or_b" = _P583NWJY;
        "pkg-250706+22w13oneBlockAtATime" = _paBIDipH;
        "pkg-250706+3D_Shareware_v1.34" = _4EIm5OmS;
        "pkg-250706+25w14craftmine" = _Duq0E8qW;
        "pkg-250706+24w14potato" = _pNXRDOoP;
        "pkg-250713+3D_Shareware_v1.34" = _28Ux53vm;
        "pkg-250713+1.RV-Pre1" = _GV09G2zJ;
        "pkg-250713+22w13oneBlockAtATime" = _GPDdfLTS;
        "pkg-250713+15w14a" = _i5RuVps8;
        "pkg-250713+23w13a_or_b" = _RsXFl57q;
        "pkg-250713+24w14potato" = _nuCQ5ElZ;
        "pkg-250713+25w14craftmine" = _6zhykjZk;
        "pkg-250713+20w14infinite" = _kxfcrFBz;
        "pkg-250720+23w13a_or_b" = _4CWy9Twp;
        "pkg-250720+15w14a" = _29PlTYxx;
        "pkg-250720+20w14infinite" = _1oC0EGEa;
        "pkg-250720+1.RV-Pre1" = _H8D4fd4e;
        "pkg-250720+22w13oneBlockAtATime" = _n4s2xSYR;
        "pkg-250720+3D_Shareware_v1.34" = _hp3VkZDd;
        "pkg-250720+25w14craftmine" = _sODkSLOa;
        "pkg-250720+24w14potato" = _enF2nrw1;
        "pkg-250727+15w14a" = _kGfIefDn;
        "pkg-250727+23w13a_or_b" = _lAtghChP;
        "pkg-250727+24w14potato" = _yUMIwhL7;
        "pkg-250727+20w14infinite" = _gW3JNxWu;
        "pkg-250727+22w13oneBlockAtATime" = _PemLiJfe;
        "pkg-250727+25w14craftmine" = _xykOCwsW;
        "pkg-250727+1.RV-Pre1" = _MiJ4MPOu;
        "pkg-250727+3D_Shareware_v1.34" = _Xxd31yS9;
        "pkg-250803+15w14a" = _Ch7IK6QW;
        "pkg-250803+23w13a_or_b" = _gE7rP756;
        "pkg-250803+20w14infinite" = _MKMZLWYJ;
        "pkg-250803+25w14craftmine" = _OotNuXvb;
        "pkg-250803+24w14potato" = _oquBE2uR;
        "pkg-250803+22w13oneBlockAtATime" = _JlEaycnn;
        "pkg-250803+3D_Shareware_v1.34" = _FP3timjx;
        "pkg-250803+1.RV-Pre1" = _xAv5m4IT;
        "pkg-250810+23w13a_or_b" = _VkLM6l7z;
        "pkg-250810+24w14potato" = _NUOuEDK8;
        "pkg-250810+25w14craftmine" = _eS5O1V7X;
        "pkg-250810+15w14a" = _2B43Y9PB;
        "pkg-250810+22w13oneBlockAtATime" = _yO0wwDpl;
        "pkg-250810+1.RV-Pre1" = _BeCErWAx;
        "pkg-250810+3D_Shareware_v1.34" = _TJxxPh7l;
        "pkg-250810+20w14infinite" = _yUg4kYdk;
        "pkg-250817+22w13oneBlockAtATime" = _jnunfqhA;
        "pkg-250817+25w14craftmine" = _Z9qLWIrQ;
        "pkg-250817+1.RV-Pre1" = _OSiSb7fd;
        "pkg-250817+20w14infinite" = _bNRhFnKx;
        "pkg-250817+3D_Shareware_v1.34" = _MLkp9s2U;
        "pkg-250817+23w13a_or_b" = _ReMbw2qY;
        "pkg-250817+24w14potato" = _bhvncBv6;
        "pkg-250817+15w14a" = _C4b1FXF8;
        "pkg-250824+24w14potato" = _qExwKcEP;
        "pkg-250824+1.RV-Pre1" = _CYceDUeU;
        "pkg-250824+22w13oneBlockAtATime" = _b1Ibsfh6;
        "pkg-250824+20w14infinite" = _gZ6hIXsc;
        "pkg-250824+23w13a_or_b" = _cR6uN0g9;
        "pkg-250824+25w14craftmine" = _AZngXbIS;
        "pkg-250824+3D_Shareware_v1.34" = _Gv88zTFW;
        "pkg-250824+15w14a" = _Rc7iAVYP;
        "pkg-250831+1.RV-Pre1" = _m2jHXZys;
        "pkg-250831+15w14a" = _o7iyqYoc;
        "pkg-250831+22w13oneBlockAtATime" = _6EGOOGfc;
        "pkg-250831+24w14potato" = _gkEV2zTB;
        "pkg-250831+20w14infinite" = _e0dukPtx;
        "pkg-250831+23w13a_or_b" = _FvVJ4GCx;
        "pkg-250831+3D_Shareware_v1.34" = _1GKfSmcH;
        "pkg-250831+25w14craftmine" = _eD592TQV;
        "pkg-250907+1.RV-Pre1" = _L0iiUiT4;
        "pkg-250907+24w14potato" = _LArbwRyw;
        "pkg-250907+25w14craftmine" = _zLX5ZYkr;
        "pkg-250907+22w13oneBlockAtATime" = _4it0jRPl;
        "pkg-250907+15w14a" = _l7LkAcwg;
        "pkg-250907+23w13a_or_b" = _K9Yw1iEr;
        "pkg-250907+20w14infinite" = _wXtT8OGI;
        "pkg-250907+3D_Shareware_v1.34" = _8QGEeRMf;
        "pkg-250914+15w14a" = _KdGgrlmM;
        "pkg-250914+25w14craftmine" = _EOYFLfsa;
        "pkg-250914+20w14infinite" = _EujfmpNQ;
        "pkg-250914+3D_Shareware_v1.34" = _cBIlIhi9;
        "pkg-250914+23w13a_or_b" = _kPeidzYE;
        "pkg-250914+1.RV-Pre1" = _k2qevGHx;
        "pkg-250914+22w13oneBlockAtATime" = _8VY5v9H6;
        "pkg-250914+24w14potato" = _HZdsDHR6;
        "pkg-250921+1.RV-Pre1" = _OsHk7Jba;
        "pkg-250921+23w13a_or_b" = _ApgNA8oT;
        "pkg-250921+15w14a" = _BBFBym6g;
        "pkg-250921+24w14potato" = _6ZkcN7Oz;
        "pkg-250921+25w14craftmine" = _z9eEmu7d;
        "pkg-250921+22w13oneBlockAtATime" = _cdnfLViF;
        "pkg-250921+20w14infinite" = _y6WI5aTE;
        "pkg-250921+3D_Shareware_v1.34" = _UuVloixh;
        "pkg-250924+15w14a" = _wobLZvj5;
        "pkg-250924+1.RV-Pre1" = _S5rvMkqt;
        "pkg-250924+20w14infinite" = _dyRNa0zr;
        "pkg-250924+23w13a_or_b" = _6XQh7Gz2;
        "pkg-250924+24w14potato" = _h6sLGVES;
        "pkg-250924+25w14craftmine" = _9SqMW6du;
        "pkg-250928+15w14a" = _5f9qDenl;
        "pkg-250928+3D_Shareware_v1.34" = _kOsGdU31;
        "pkg-250928+20w14infinite" = _DWbXPP4W;
        "pkg-250928+22w13oneBlockAtATime" = _3WcI0tyL;
        "pkg-250928+23w13a_or_b" = _XJY5Ph66;
        "pkg-250928+24w14potato" = _epXsTBuO;
        "pkg-250928+25w14craftmine" = _FDwPCm5e;
        "pkg-251005+15w14a" = _Ua2JZxWi;
        "pkg-251005+1.RV-Pre1" = _TXhEhZbA;
        "pkg-251005+3D_Shareware_v1.34" = _2vC6H4Oz;
        "pkg-251005+20w14infinite" = _nQ6CBrOh;
        "pkg-251005+22w13oneBlockAtATime" = _flGyAfou;
        "pkg-251005+23w13a_or_b" = _7dTKE5PT;
        "pkg-251005+24w14potato" = _xFiOYeCT;
        "pkg-251005+25w14craftmine" = _1ZVPMUOO;
        "pkg-251012+20w14infinite" = _wgDtr2ne;
        "pkg-251012+23w13a_or_b" = _4IDzn75U;
        "pkg-251012+24w14potato" = _6t7yU69n;
        "pkg-251012+25w14craftmine" = _YcBOvwic;
        "pkg-251019+15w14a" = _ahtIUQi3;
        "pkg-251019+20w14infinite" = _NcmOsKgz;
        "pkg-251019+22w13oneBlockAtATime" = _t0U9Ne1p;
        "pkg-251019+23w13a_or_b" = _o6qyoy7d;
        "pkg-251019+25w14craftmine" = _Kna9BuDD;
        "pkg-251028+15w14a" = _yRsNbZ6m;
        "pkg-251028+3D_Shareware_v1.34" = _GOg3fJBC;
        "pkg-251028+23w13a_or_b" = _8FULyYcE;
        "pkg-251028+24w14potato" = _1UsY3niG;
        "pkg-251028+25w14craftmine" = _nLvQzJPE;
        "pkg-251102+15w14a" = _CQhfKUFL;
        "pkg-251102+3D_Shareware_v1.34" = _gyWdiovm;
        "pkg-251109+20w14infinite" = _ZrWFeUDM;
        "pkg-251109+24w14potato" = _LDODjyaH;
        "pkg-251109+25w14craftmine" = _zdaTM6JS;
        "pkg-251116+15w14a" = _ps5xHgsL;
        "pkg-251116+23w13a_or_b" = _Vm3gyk9a;
        "pkg-251123+3D_Shareware_v1.34" = _CH0MeDaY;
        "pkg-251123+20w14infinite" = _zA1xRoXa;
        "pkg-251123+22w13oneBlockAtATime" = _U9g8TgIV;
        "pkg-251123+23w13a_or_b" = _OLa8IkEM;
        "pkg-251123+24w14potato" = _UBBATz1s;
        "pkg-251123+25w14craftmine" = _gUIekpD8;
        "pkg-251130+23w13a_or_b" = _JGeNKPPe;
        "pkg-251130+24w14potato" = _pLumSXmw;
        "pkg-251130+25w14craftmine" = _cgrKLKV4;
        "pkg-251207+15w14a" = _aaFbaojL;
        "pkg-251207+1.RV-Pre1" = _VSRWt744;
        "pkg-251207+3D_Shareware_v1.34" = _w9a7cvEZ;
        "pkg-251207+20w14infinite" = _lJkF9LMB;
        "pkg-251207+23w13a_or_b" = _J7S8J7Kv;
        "pkg-251207+24w14potato" = _9ucSMfQ9;
        "pkg-251207+25w14craftmine" = _jqWeLs0J;
        "pkg-251214+15w14a" = _Fkw3hIdo;
        "pkg-251214+1.RV-Pre1" = _P9qlb3nD;
        "pkg-251214+23w13a_or_b" = _FV4b3wAg;
        "pkg-251214+24w14potato" = _mpin2JBF;
        "pkg-251214+25w14craftmine" = _oyRe7HnN;
        "pkg-251221+15w14a" = _ZBkxDE8t;
        "pkg-251221+1.RV-Pre1" = _Re2O3f4y;
        "pkg-251221+3D_Shareware_v1.34" = _a62ezQ43;
        "pkg-251221+24w14potato" = _CYL63vXm;
        "pkg-251221+25w14craftmine" = _ttA4Eq72;
        "pkg-251228+25w14craftmine" = _XwgJqST8;
        "pkg-260111+15w14a" = _QIzthgk5;
        "pkg-260111+1.RV-Pre1" = _nxaSVp3K;
        "pkg-260111+24w14potato" = _sjrgGAgp;
        "pkg-260118+15w14a" = _qnoodRbw;
        "pkg-260118+1.RV-Pre1" = _ROmlS0RG;
        "pkg-260118+23w13a_or_b" = _9EYOAWk4;
        "pkg-260118+24w14potato" = _87E9PPst;
        "pkg-260118+25w14craftmine" = _dMLJlZJq;
        "pkg-260125+3D_Shareware_v1.34" = _9iIhAON8;
        "pkg-260125+25w14craftmine" = _aRKB02h3;
        "pkg-260208+24w14potato" = _M6fliug1;
        "pkg-260215+15w14a" = _ZRyUKy8e;
        "pkg-260215+1.RV-Pre1" = _Q1kVDJWP;
        "pkg-260215+24w14potato" = _RvLys4FZ;
        "pkg-260222+1.RV-Pre1" = _i0jVLXDu;
        "pkg-260222+3D_Shareware_v1.34" = _atT9PGWQ;
        "pkg-260222+23w13a_or_b" = _fnFwsEDW;
        "pkg-260222+24w14potato" = _LlG9boao;
        "pkg-260222+25w14craftmine" = _Pp4qZasU;
        "pkg-260301+1.RV-Pre1" = _sztsOoHG;
        "pkg-260301+3D_Shareware_v1.34" = _P2BaAuzd;
        "pkg-260301+23w13a_or_b" = _M9U7rIxw;
        "pkg-260301+24w14potato" = _xXOMh200;
        "pkg-260301+25w14craftmine" = _p10uDFhs;
        "pkg-260308+3D_Shareware_v1.34" = _cFTSWhjm;
        "pkg-260308+20w14infinite" = _vUB3tfq0;
        "pkg-260308+23w13a_or_b" = _hNPFZhBI;
        "pkg-260308+24w14potato" = _2BrsfdCd;
        "pkg-260308+25w14craftmine" = _9x1bzBnB;
        "pkg-260315+1.RV-Pre1" = _w897GX1B;
        "pkg-260315+23w13a_or_b" = _IIEL3m3h;
        "pkg-260315+24w14potato" = _T5CDYDfO;
        "pkg-260315+25w14craftmine" = _K4u663Tk;
        "pkg-260322+23w13a_or_b" = _4VHZRoMn;
        "pkg-260322+24w14potato" = _9u0wnTRb;
        "pkg-260322+25w14craftmine" = _glqHVMi1;
        "pkg-260329+23w13a_or_b" = _9hyOCFHm;
        "pkg-260329+24w14potato" = _KOp93Ohy;
        "pkg-260329+25w14craftmine" = _JmY992qk;
        "pkg-260402.0+26w14a" = _AhOfrKwJ;
        "pkg-260402+15w14a" = _d9pHWUpN;
        "pkg-260402+1.RV-Pre1" = _RLWrPdVq;
        "pkg-260402+3D-Shareware-v1.34" = _2d3mZJ6g;
        "pkg-260402+20w14infinite" = _nKzY67Dn;
        "pkg-260402+22w13oneblockatatime" = _fqFmUT7Z;
        "pkg-260402+23w13a_or_b" = _Qws8REkg;
        "pkg-260402+24w14potato" = _7X868uvA;
        "pkg-260402+25w14craftmine" = _zZf2b5hy;
        "pkg-260402+26w14a" = _rFcvfCEM;
        "pkg-260403+23w13a_or_b" = _VVwWP1h0;
        "pkg-260403+25w14craftmine" = _CdSXVgEv;
        "pkg-260403+26w14a" = _xBdIHwnA;
        "pkg-260404+15w14a" = _ENY4lHqG;
        "pkg-260404+20w14infinite" = _q8PJdKNn;
        "pkg-260404+22w13oneblockatatime" = _XI7KASfp;
        "pkg-260404+23w13a_or_b" = _EkLcLJes;
        "pkg-260404+24w14potato" = _GpS2gGCG;
        "pkg-260404+25w14craftmine" = _ymPIoV2B;
        "pkg-260404+26w14a" = _VviwrcM3;
        "pkg-260405+1.RV-Pre1" = _GAs8ZKPW;
        "pkg-260405+20w14infinite" = _q4IQiqZ5;
        "pkg-260405+22w13oneblockatatime" = _m9MYT6Fq;
        "pkg-260405+23w13a_or_b" = _UMeN8Oyp;
        "pkg-260405+24w14potato" = _u3nwdMYJ;
        "pkg-260405+25w14craftmine" = _vr4l1JGP;
        "pkg-260405+26w14a" = _beiu4zkM;
        "pkg-260406+23w13a_or_b" = _l7ceBUxu;
        "pkg-260406+24w14potato" = _XnTLzmMH;
        "pkg-260406+25w14craftmine" = _ixpyJmm1;
        "pkg-260406+26w14a" = _JGC8bVeu;
        "pkg-260407+1.RV-Pre1" = _HxKDoqqy;
        "pkg-260407+20w14infinite" = _biyuc20w;
        "pkg-260407+23w13a_or_b" = _DGdT5k5u;
        "pkg-260407+24w14potato" = _TFPzYxos;
        "pkg-260407+25w14craftmine" = _uHF8vJNt;
        "pkg-260409+1.RV-Pre1" = _SdT44nwc;
        "pkg-260409+20w14infinite" = _gz1gCAXL;
        "pkg-260409+23w13a_or_b" = _Eh0aU5xU;
        "pkg-260409+24w14potato" = _pnb1K9wj;
        "pkg-260409+25w14craftmine" = _5XJEdhUL;
        "pkg-260412+3D-Shareware-v1.34" = _5021DcEP;
        "pkg-260412+20w14infinite" = _PgaYYaUV;
        "pkg-260412+23w13a_or_b" = _JFPbtgAS;
        "pkg-260412+24w14potato" = _epQ7WnUj;
        "pkg-260412+25w14craftmine" = _iUbNwj5P;
        "pkg-260412+26w14a" = _A1SMm2n0;
        "pkg-260415+20w14infinite" = _MWpnNojX;
        "pkg-260415+23w13a_or_b" = _1meMQ44y;
        "pkg-260415+24w14potato" = _MCptx569;
        "pkg-260415+25w14craftmine" = _dX1KlbM6;
        "pkg-260415+26w14a" = _96E6ZYmL;
        "pkg-260420+15w14a" = _QS0kfGS9;
        "pkg-260420+22w13oneblockatatime" = _BdAHT6ud;
        "pkg-260420+25w14craftmine" = _OzHBlMCj;
        "pkg-260425+3D-Shareware-v1.34" = _brStcplE;
        "pkg-260425+25w14craftmine" = _dsxQwNsg;
        "pkg-260430+1.RV-Pre1" = _8jh4651R;
        "pkg-260430+23w13a_or_b" = _DwQIg4XW;
        "pkg-260430+24w14potato" = _dfbavAcW;
        "pkg-260503+1.RV-Pre1" = _cx4rVLtW;
        "pkg-260503+23w13a_or_b" = _axwgIFay;
        "pkg-260503+24w14potato" = _mI7FAOxM;
        "pkg-260503+25w14craftmine" = _JoDl4c6J;
        "pkg-260503+26w14a" = _wnEb3dvG;
        "pkg-260510+15w14a" = _BmTI5jc1;
        "pkg-260510+1.RV-Pre1" = _bkdRB9O9;
        "pkg-260510+3D-Shareware-v1.34" = _PbxfLf3J;
        "pkg-260510+20w14infinite" = _UDOO83yz;
        "pkg-260510+22w13oneblockatatime" = _FKFcb2zx;
        "pkg-260510+23w13a_or_b" = _AF6pgkeC;
        "pkg-260510+24w14potato" = _3kusBrT6;
        "pkg-260510+25w14craftmine" = _FoL3cDpU;
        "pkg-260510+26w14a" = _qyQcXY7D;
        "pkg-260524+24w14potato" = _6zopqRAN;
        "pkg-260531+23w13a_or_b" = _qKA4epsI;
        "pkg-260607+15w14a" = _7RodNhFE;
        "pkg-260607+1.RV-Pre1" = _n68KUm6t;
        "pkg-260607+20w14infinite" = _Yd60A6NJ;
        "pkg-260614+25w14craftmine" = _EYYnxrLu;
        "pkg-260621+3D-Shareware-v1.34" = _gzDr4KXM;
        "pkg-260621+20w14infinite" = _Sn7kRQsi;
        "pkg-260621+22w13oneblockatatime" = _9NNhQANe;
        "pkg-260621+23w13a_or_b" = _BwCEkt4W;
        "pkg-260621+24w14potato" = _bmiawqc1;
        "pkg-260621+25w14craftmine" = _LAJgeAEf;
        "pkg-260628+15w14a" = _SQ1T49Mc;
        "pkg-260628+22w13oneblockatatime" = _Bl8RofOk;
        "pkg-260628+23w13a_or_b" = _evp5h6ma;
        "pkg-260628+24w14potato" = _WIOLZFs9;
        "pkg-260628+25w14craftmine" = _rd3AvbCr;
        "pkg-260705+15w14a" = _NNwTCFFI;
        "pkg-260705+1.RV-Pre1" = _W47uqgY0;
        "pkg-260705+3D-Shareware-v1.34" = _K1aYXeAj;
        "pkg-260705+20w14infinite" = _CUBDNjZe;
        "pkg-260705+22w13oneblockatatime" = _2YrCuOax;
        "pkg-260705+23w13a_or_b" = _6P1Z2OaU;
        "pkg-260705+24w14potato" = _FRZWh1ZN;
        "pkg-260705+25w14craftmine" = _aYwtKTOC;
        "pkg-260705+26w14a" = _Oubc22YD;
        "pkg-260712+15w14a" = _kpwLhesZ;
        "pkg-260712+1.RV-Pre1" = _KJkAflyf;
        "pkg-260712+3D-Shareware-v1.34" = _QYSf39mr;
        "pkg-260712+20w14infinite" = _YF3oXhqd;
        "pkg-260712+22w13oneblockatatime" = _Gg5kUwVo;
        "pkg-260712+23w13a_or_b" = _iE5RmZQb;
        "pkg-260712+24w14potato" = _UucovqhY;
        "pkg-260712+26w14a" = _U6CkiVIC;
        "pkg-260719+3D-Shareware-v1.34" = _fLauoBzi;
        "pkg-260719+23w13a_or_b" = _zsmbBYJw;
        "pkg-260719+25w14craftmine" = _KU7az37W;
        "pkg-260726+15w14a" = _pM5pWuCE;
        "pkg-260726+1.RV-Pre1" = _B9axB0en;
        "pkg-260726+3D-Shareware-v1.34" = _lijbc1fo;
        "pkg-260726+20w14infinite" = _CinQKiDA;
        "pkg-260726+22w13oneblockatatime" = _9OMOj4Wu;
        "pkg-260726+23w13a_or_b" = _3c89LlTK;
        "pkg-260726+24w14potato" = _KhCeclvO;
        "pkg-260726+25w14craftmine" = _r7qiLdgc;
        "pkg-260726+26w14a" = _iMUh0GsS;
        "pkg-260802+15w14a" = _pY6GtJHh;
        "pkg-260802+23w13a_or_b" = _jWRHqD3h;
        "pkg-260802+24w14potato" = _H8Sbvy8j;
        "pkg-260802+25w14craftmine" = _fXpZqoT8;
        "pkg-260809+1.RV-Pre1" = _MkV0QQm5;
        "pkg-260809+3D-Shareware-v1.34" = _hlTfSksy;
        "pkg-260809+20w14infinite" = _BHpT4Y0I;
        "pkg-260809+22w13oneblockatatime" = _D0TtUihM;
        "pkg-260809+23w13a_or_b" = _3Vgjn9Hn;
        "pkg-260809+24w14potato" = _6bl3RkSz;
        "pkg-260809+25w14craftmine" = _P21PZJJf;
        "pkg-260809+26w14a" = _rq4MtwRb;
        "pkg-260816+1.RV-Pre1" = _ZnJFgzX8;
        "pkg-260816+23w13a_or_b" = _xXOLfqvA;
        "pkg-260816+24w14potato" = _tWYcOLAW;
        "pkg-260816+25w14craftmine" = _GmJBsp4x;
        "pkg-260823+15w14a" = _mavShDwJ;
        "pkg-260823+1.RV-Pre1" = _C8buDjAr;
        "pkg-260823+3D-Shareware-v1.34" = _MHJW7UR9;
        "pkg-260823+20w14infinite" = _pZufRbD2;
        "pkg-260823+22w13oneblockatatime" = _gNhfe7XS;
        "pkg-260823+23w13a_or_b" = _utA3ayNF;
        "pkg-260823+24w14potato" = _6NtUseFr;
        "pkg-260823+25w14craftmine" = _C66uruXJ;
        "pkg-260823+26w14a" = _V5oATLCo;
        "pkg-260830+15w14a" = _Sm0EEP8o;
        "pkg-260830+1.RV-Pre1" = _RWTrBDHH;
        "pkg-260830+3D-Shareware-v1.34" = _y3bRLhiV;
        "pkg-260830+20w14infinite" = _NeUBHOWH;
        "pkg-260830+22w13oneblockatatime" = _8c3r9Ars;
        "pkg-260830+23w13a_or_b" = _nI0kgDF0;
