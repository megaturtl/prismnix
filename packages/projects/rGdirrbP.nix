...
let
    ...
    in {
        ...
        "pkg-41.1" = _X0rhWFpW;
        "pkg-41.1+mod" = _bQMOTwqb;
        "pkg-48.1" = _8eC00X2n;
        "pkg-48.1+mod" = _bRFfN3wv;
        "pkg-48.2" = _cFt2pYbg;
        "pkg-48.2+mod" = _ZsXh22ES;
        "pkg-57.1" = _rdIAPAtk;
        "pkg-57.1+mod" = _4zBKrPz5;
        "pkg-57.2+mod" = _wJRLHmDL;
        "pkg-61.1" = _8KXzsOVA;
        "pkg-61.1+mod" = _ImfA4s3G;
        "pkg-71.1" = _4lkhibWa;
        "pkg-71.1+mod" = _rTV1fWoC;
        "pkg-80" = _j1tXcuI8;
        "pkg-80+mod" = _j60tcrqp;
        "pkg-81" = _yUo19A7N;
        "pkg-81+mod" = _Hsz8VHV8;
        "pkg-88.0" = _3JGDzFfR;
        "pkg-88.0+mod" = _w1bX6uqM;
        "pkg-94.1" = _fi6833lT;
        "pkg-94.1+mod" = _qzIwMo8H;
        "pkg-101.1" = _rKwPOeZM;
