...
let
    ...
    in {
        ...
        "pkg-15.2.3" = _FP2R07jh;
        "pkg-16.1.2" = _sC0QUN4o;
        "pkg-16.4.32" = _yrHibQoO;
        "pkg-18.1.11" = _H0tTU4lg;
        "pkg-18.2.16" = _yP6lxVQH;
        "pkg-19.3.56" = _wgtyoX4K;
        "pkg-19.5.56" = _eNIhbWeI;
        "pkg-1.9.4.3" = _yxeyo53c;
        "pkg-1.2.1" = _sjiXBf0I;
        "pkg-1.9.3.9" = _WERcmhCG;
        "pkg-19.3.57" = _CUfriEhg;
        "pkg-19.5.57" = _4NH7TFuV;
        "pkg-20.0.4" = _Yc4pTSku;
        "pkg-20.0.5" = _e6fkVYvd;
        "pkg-20.1.1" = _yI28A20x;
        "pkg-20.0.6" = _scdx6pbM;
        "pkg-20.0.7" = _viMN03N7;
        "pkg-20.1.2" = _ULc2dDd5;
        "pkg-20.0.8" = _shhdSyM3;
        "pkg-20.1.3" = _i7ZqOYPT;
        "pkg-20.1.4" = _BVYl7Q4H;
        "pkg-20.1.5" = _etyZ49YD;
        "pkg-20.1.6" = _WPCovTHD;
        "pkg-20.1.8" = _iUuZjOcp;
        "pkg-20.1.9" = _w78Avpy7;
        "pkg-20.1.10" = _1KVgZHn6;
        "pkg-20.1.12" = _iSU3Dxqh;
        "pkg-19.3.59" = _3ZpZjEe0;
        "pkg-19.3.60" = _H11ikiJC;
        "pkg-2.0.6.33" = _Wi7d2bFo;
        "pkg-19.3.61" = _h1LwqhCm;
        "pkg-19.3.62" = _ei01ty2R;
        "pkg-2.0.6.37" = _5TFRWtCy;
        "pkg-19.3.63" = _NRjOhuGg;
        "pkg-20.1.13" = _YTwuaTlj;
        "pkg-19.3.64" = _oSQlMy7Z;
        "pkg-20.1.14" = _f6TFhtBs;
        "pkg-19.3.65" = _tvn9RSEW;
        "pkg-20.1.15" = _M8FO0Qyr;
        "pkg-20.1.16" = _NUED9iZ4;
        "pkg-19.3.66" = _IugAX7Tj;
        "pkg-20.1.17" = _JLseJrrx;
        "pkg-19.3.67" = _WsjvA5Ys;
        "pkg-19.3.68" = _BoPipV7y;
        "pkg-20.1.18" = _k0E3LPhA;
        "pkg-19.3.69" = _rMbsx3vX;
        "pkg-20.1.19" = _3v3RLjKm;
        "pkg-19.3.72" = _jS3eAPvP;
        "pkg-20.1.22" = _G9FL4w05;
        "pkg-19.3.73" = _zI8kYWAo;
        "pkg-20.1.23" = _RFVH3RuN;
        "pkg-12.2.38" = _zVX9u0ea;
        "pkg-12.2.39" = _PVr27b11;
        "pkg-12.2.42" = _pvJ8MIOt;
        "pkg-12.2.43" = _dtUzz4cm;
        "pkg-12.2.46" = _OBqfX3Qz;
        "pkg-19.3.74" = _mTXDHEy6;
        "pkg-20.1.24" = _6SzGkaI2;
        "pkg-16.5.50" = _JIkgf2mm;
        "pkg-20.2.2" = _NAVT180P;
        "pkg-19.3.75" = _UrmezZGp;
        "pkg-20.3.0" = _W87Htf7s;
        "pkg-20.4.0" = _uFasOQns;
        "pkg-19.3.76" = _j2DJNqC8;
        "pkg-20.1.25" = _WfKD6Uph;
        "pkg-12.2.47" = _aTbceKFO;
        "pkg-12.2.48" = _aZ7qv72r;
        "pkg-12.2.49" = _3fkHxAA1;
        "pkg-12.2.50" = _bOtolRGl;
        "pkg-20.1.26" = _vJ3giPZr;
        "pkg-20.2.26" = _YjcFx7op;
        "pkg-20.3.26" = _aOSqG6CL;
        "pkg-20.5.26" = _bkMqZu8P;
        "pkg-20.6.26" = _lRT8mDVK;
        "pkg-20.4.26.2" = _JHhUHySA;
        "pkg-20.1.28" = _nuHVgfJ4;
        "pkg-20.2.28" = _IMYqsGhV;
        "pkg-20.3.28" = _DWoxD01r;
        "pkg-20.4.28" = _PXStaj1d;
        "pkg-20.5.28" = _ATr5Gmik;
        "pkg-20.6.28" = _aKVbJ9ls;
        "pkg-19.3.81" = _iOLwyvkE;
        "pkg-20.1.29" = _mrkG631Q;
        "pkg-20.2.29" = _vqrWwRfG;
        "pkg-20.3.29" = _NYHELAGj;
        "pkg-20.4.29" = _ddjAmN5H;
        "pkg-20.5.29" = _DW5avg5k;
        "pkg-20.6.29" = _2Qml2rJQ;
        "pkg-20.6.29.2" = _Aayk55qQ;
        "pkg-20.6.30" = _SZpLghJc;
        "pkg-21.0.0" = _fwfvJWOl;
        "pkg-21.0.1" = _p4NKUBxP;
        "pkg-21.0.2" = _qxiHXPQk;
        "pkg-21.0.3" = _bHZ62yuq;
        "pkg-21.0.4" = _WT2iFodk;
        "pkg-21.0.5" = _tg5Y23rs;
        "pkg-21.0.6" = _3oBNshYG;
        "pkg-21.0.7" = _auEnFwZ5;
        "pkg-21.0.8" = _fLVGCylV;
        "pkg-19.3.82" = _QWyY0kdh;
        "pkg-20.1.30" = _4LceQ33q;
        "pkg-21.0.9" = _A9LY8670;
        "pkg-21.0.10" = _f6Mok2rw;
        "pkg-21.0.11" = _Tezkqev4;
        "pkg-21.0.12" = _B2oQThRY;
        "pkg-20.1.31" = _N6F2WXv7;
        "pkg-21.0.13" = _hKUG9eyp;
        "pkg-20.1.32" = _MNK2BJRV;
        "pkg-12.2.51" = _3GlmKrRA;
        "pkg-12.2.52" = _ikf8i2Fv;
        "pkg-12.2.53" = _Xnm3NzNp;
        "pkg-12.2.54" = _F3EaugP4;
        "pkg-12.2.55" = _pdKv3TSA;
        "pkg-12.2.56" = _kTkkPMX6;
        "pkg-20.1.33" = _wCwGFxoH;
        "pkg-21.0.14" = _9fbv71EY;
        "pkg-20.1.35" = _v0xo8QZ9;
        "pkg-20.1.36" = _XxoZwSQ0;
        "pkg-20.1.37" = _hlPbpARM;
        "pkg-20.1.38" = _tCSKLGWv;
        "pkg-20.1.39" = _wwcTKVB4;
        "pkg-20.1.41" = _7yIUi1sI;
        "pkg-20.1.43" = _y5HArGHA;
        "pkg-20.1.44" = _Cgkp4tJj;
        "pkg-20.1.45" = _S74aQ6K4;
        "pkg-20.1.46" = _8x7gk7wl;
        "pkg-20.1.47" = _DAGdkAC9;
        "pkg-20.1.48" = _9TMhzZOp;
        "pkg-21.4.1" = _oMjjszAe;
        "pkg-21.4.2" = _WcSSX3he;
        "pkg-21.4.3" = _41VUDbK5;
        "pkg-21.4.4" = _JjYPY48c;
        "pkg-21.4.5" = _jJyTCy9F;
        "pkg-20.1.50" = _4gPgzjxl;
        "pkg-12.2.58" = _ZAGKpavI;
        "pkg-12.2.59" = _JX81SJnG;
        "pkg-12.2.60" = _5K3osgic;
        "pkg-12.2.61" = _sgmNFCAI;
        "pkg-12.2.62" = _do49hYEz;
