...
let
    versions = (let
        ...
        _GCiNHFPF = {
            "id" = "GCiNHFPF";
            "file" = "moderner-beta-forge-4.1.10+1.20.1.jar";
            "hash" = "sha512-r9zAjnpPgrHwBfxvIy6T8RoOspZ8w1KHliti0qYEL/xykIrtY6D+xyZXMKXuPeWNOpuiAYuF3TOg/7ByDjRF8Q==";
        };
        _U9E9pkTV = {
            "id" = "U9E9pkTV";
            "file" = "moderner-beta-fabric-4.1.10+1.20.1.jar";
            "hash" = "sha512-9ehS35e/n4li1nORNzADMQUR2RhqGPrL0xNkshlx4mSk7MwoVYrm0rJd104Y29jw0UerB2+/rvqAuIgz9SxuJQ==";
        };
        _bBp9EtU0 = {
            "id" = "bBp9EtU0";
            "file" = "moderner-beta-fabric-4.1.10+1.21.1.jar";
            "hash" = "sha512-28Ll5mKpUs6ss9T4+3MqcNrWNVJ8uwMRP30sABfemxkmJiT8BjCEnsBLqkC2h/o6IbLWmDJDvUDfNOss40d6rw==";
        };
        _VHZeASxW = {
            "id" = "VHZeASxW";
            "file" = "moderner-beta-neoforge-4.1.10+1.21.1.jar";
            "hash" = "sha512-psLenvSopIZu81qhdH/nwDCkJ/78HplUBhuBHq79DwEaG7qBtcfdOZRBeKfGgjXZX4wryRcLYxC7pAl22PTdSw==";
        };
        _3YwYoqG2 = {
            "id" = "3YwYoqG2";
            "file" = "moderner-beta-fabric-4.1.10+1.21.6.jar";
            "hash" = "sha512-9xczHg1Qb96g+JPl8dyhmpKR069xB15lt7EGyOtHfx0J7bxKbedKOgpmUQDHJpk/XQlwLLeqImAkqlW2PQ6nFg==";
        };
        _bNaR3a1U = {
            "id" = "bNaR3a1U";
            "file" = "moderner-beta-neoforge-4.1.10+1.21.6.jar";
            "hash" = "sha512-iVV6lJaRE73jdlsR1TAFRBeNuG23Z74zuqUOezTFhU+wE72kBMM93Ef8NxfgbP4XTTnL3aLFR7bap9je5+whaQ==";
        };
        _OZam1KMf = {
            "id" = "OZam1KMf";
            "file" = "moderner-beta-fabric-4.1.10+1.21.9.jar";
            "hash" = "sha512-YapSGT6WjxRbW4vUcSyYtzWrz+D4i2z6OTLuQT6WZxSUkKsXVgTCWcP+mLEmHPNkTv7k+9DbkOfrQAxgLH1t/Q==";
        };
        _ioywILJX = {
            "id" = "ioywILJX";
            "file" = "moderner-beta-neoforge-4.1.10+1.21.9.jar";
            "hash" = "sha512-YFu4kQ65n93BKs6x2gkoWU+XsMsa9yibHsB4aFop8ztYVXXpbmAKkYdkC66c0e4y48dg66z9lFOPjf9upE8xdA==";
        };
        _MnWspXQ6 = {
            "id" = "MnWspXQ6";
            "file" = "moderner-beta-fabric-4.1.10+1.21.11.jar";
            "hash" = "sha512-a0Lut0OPcxhclmJhRR1kTpqZz7HPRmrLuFDL8klaQ0t+MLd+flQ3xtjIdND7N190bFfab6VWekbFHf+RjuVraw==";
        };
        _SlwQ9Mtr = {
            "id" = "SlwQ9Mtr";
            "file" = "moderner-beta-neoforge-4.1.10+1.21.11.jar";
            "hash" = "sha512-rEWw8daWSL0d8yYcD1VBC3zZe+7UeFJkfHfG+BbO6ddWHZ6LM2umJn0tE8BBns7sB7o793d6RY+hqFIn/FTtLQ==";
        };
        _huyDXEkt = {
            "id" = "huyDXEkt";
            "file" = "moderner-beta-fabric-4.1.10+26.1.jar";
            "hash" = "sha512-wJ0jneMA3kxkOJxUBXPMs1unJSchjZanOEBIluNK/CSl0tJrjOYL1oWfVnGOR5EHRyP5A1z//7DDDl7SAfsVHA==";
        };
        _1HbxYi8N = {
            "id" = "1HbxYi8N";
            "file" = "moderner-beta-neoforge-4.1.10+26.1.jar";
            "hash" = "sha512-O3RA5A2PAwf83tADh2xQPW8G38rt+0VLEsqeyG7nJvzqZf+KAVCj7kFebHlYnHGJMJaeny2ab+t1ZgdFtnZtkw==";
        };
        _OjLoes0w = {
            "id" = "OjLoes0w";
            "file" = "moderner-beta-forge-5.0.0-alpha.3+1.20.1.jar";
            "hash" = "sha512-GQ6VfRlFqggtDLeIxL41pneU5SY3PFU0oNyXKRUluFT/6ddfWeExE7/SIJvjghpLvGHq+rbDqLqz78UheGJXRQ==";
        };
        _sf9TvcI4 = {
            "id" = "sf9TvcI4";
            "file" = "moderner-beta-fabric-5.0.0-alpha.3+1.20.1.jar";
            "hash" = "sha512-T3N3l0uIUugdubTP2x3ZrHjJXvVFTmA2XUylF3fZUi+YdjM4nIA1/aYWs/8J6oLM+vlrdaekiVp32O+vkjEsDA==";
        };
        _yo4DjOYc = {
            "id" = "yo4DjOYc";
            "file" = "moderner-beta-fabric-5.0.0-alpha.3+1.21.1.jar";
            "hash" = "sha512-fjJ+qjTmEBE3B776z1ig/oE4m97xy080wn76t87xQ7oN+e+HTe5mkq0qixinvm2ZmZ8C50fQYM5kaZGwKRsg3Q==";
        };
        _rHx449jF = {
            "id" = "rHx449jF";
            "file" = "moderner-beta-neoforge-5.0.0-alpha.3+1.21.1.jar";
            "hash" = "sha512-L2NIrRNCFcf0ksAfVeiPQuz+fey+p4+zoXbunrv0xl9y8+JY8ysl/t+U4nBiWxDGE6sEuFVETUAnwI0uA8xNXQ==";
        };
        _4llBvwL2 = {
            "id" = "4llBvwL2";
            "file" = "moderner-beta-fabric-5.0.0-alpha.3+26.1.jar";
            "hash" = "sha512-Hpa6FGfy0A+5sjdE5Di7/P1kGSBimV93Qfa7N4cIX+AtC+Rq2X0gLeywF5uLo/UZEpTUXeYjjHraBaYckpFs5Q==";
        };
        _PiljzPxK = {
            "id" = "PiljzPxK";
            "file" = "moderner-beta-neoforge-5.0.0-alpha.3+26.1.jar";
            "hash" = "sha512-53GPjdQuCnOIasZYyVnYoNeme22FS/d1rOvRi82HvBDarpI0ox0Gt4GbBiwoAPYmPoEMGjhpjNNYDZdIjwrpaw==";
        };
        _dqmxvmmu = {
            "id" = "dqmxvmmu";
            "file" = "moderner-beta-fabric-5.0.0-alpha.3+26.2.jar";
            "hash" = "sha512-Iszy+tdLqSQOtBU2cbTBomaXmiBrHUnHpAbd/3sONJKFbP5WzCJsdEbHrFhgDCAWioTM9Q3GQINH0D3qvo3MUA==";
        };
        _D1Z2SXpB = {
            "id" = "D1Z2SXpB";
            "file" = "moderner-beta-neoforge-5.0.0-alpha.3+26.2.jar";
            "hash" = "sha512-/+FMbfGlrQiBgU5mjLc9SJhZYJYAb2fjsSqc+VH3gNBOO3DOl3A/e3ueLsDw93RDQk/FroN1z8nAaCeyUWH2ow==";
        };
        _B80hKlJR = {
            "id" = "B80hKlJR";
            "file" = "moderner-beta-fabric-5.0.0-alpha.4+1.20.1.jar";
            "hash" = "sha512-3nM+EIktBZU4OAveeoOyV6dtA7FCNHyQMH6GtQ6ixiPraZG7xx7CHopoo3TJ7m0/CAhjEd7MsV+uTq6dp8LSEA==";
        };
        _z2VZUXJE = {
            "id" = "z2VZUXJE";
            "file" = "moderner-beta-forge-5.0.0-alpha.4+1.20.1.jar";
            "hash" = "sha512-y1O7gM98HDtm5ZvwmL4M8UzyxMugx1TTWgIBbw9jjeZEbqQafa39bdsRQFJaRZKXXr6upnJ9uFMrtOn+ROgG8A==";
        };
        _Us3qRPhu = {
            "id" = "Us3qRPhu";
            "file" = "moderner-beta-fabric-5.0.0-alpha.4+1.21.1.jar";
            "hash" = "sha512-w3XJq4fsPo0Hg435u8Zac0xwOAP/rzWHnYq17mB20i0R3SCpRvxq63ASrUGt3dJF0frTiEReaefzUOaphHf9KQ==";
        };
        _iRc8orve = {
            "id" = "iRc8orve";
            "file" = "moderner-beta-neoforge-5.0.0-alpha.4+1.21.1.jar";
            "hash" = "sha512-7c3NbkMkYUZVvo02khuIPghI1eyX9zUSoGoRIYUJiD2dX2JbyBDm4j+OLDQ/ZIoIDtlohs/dIbKy6b+QVzAjAQ==";
        };
        _8BVALSLO = {
            "id" = "8BVALSLO";
            "file" = "moderner-beta-fabric-5.0.0-alpha.4+26.1.jar";
            "hash" = "sha512-qBDKLkFnRo5FGoJLYRqmdY1VRsZxPYhAaIzyPXF8SN/PdLt82pxgre/wK5/+WZz+g+ros6kEDFUBrqbF+8+gVg==";
        };
        _VAjR1h3T = {
            "id" = "VAjR1h3T";
            "file" = "moderner-beta-neoforge-5.0.0-alpha.4+26.1.jar";
            "hash" = "sha512-IVdIcx7Bwsj9XSACM2YhfpFNGqkzeLngtgjRkBIDmI0aThDmZ2fdFCn6jyAe5XWikvX6zMpaxLhoDpfy1pGUBQ==";
        };
        _q3uvUp6V = {
            "id" = "q3uvUp6V";
            "file" = "moderner-beta-fabric-5.0.0-alpha.4+26.2.jar";
            "hash" = "sha512-IpdsCFQc6U6iLLeNOYyKQ1GDtw2uuTY5Z9MBvVxbOfzaKPxKE9f8MkQefAcIS2TtH9tWWZNZGKykcZqCk8hZtg==";
        };
        _xwiDPw9k = {
            "id" = "xwiDPw9k";
            "file" = "moderner-beta-neoforge-5.0.0-alpha.4+26.2.jar";
            "hash" = "sha512-bCpdp9qtdgS17j+ZRBrqmXewMmP/v0lhX7HzaiWgtDbGlc+Ry5W9krjuPdiHlxdHUy/MyoRftlvw4WXIjTHnmA==";
        };
        _Ucgo1y8G = {
            "id" = "Ucgo1y8G";
            "file" = "moderner-beta-fabric-5.0.0-alpha.4+26.3.jar";
            "hash" = "sha512-TGrNbFt7uHM1KneKgQOtO2bl+1OjM+nG7OgwGW6BBe6pIoiwlGwtM5ujbeZG21i7I3EFZCsNBeBCAkPDKFeBQg==";
        };
        _f2GNKxO0 = {
            "id" = "f2GNKxO0";
            "file" = "moderner-beta-neoforge-5.0.0-alpha.4+26.3.jar";
            "hash" = "sha512-7wGkJY6DQEAIhpiY+fecZc9O7IsmMUE4SRMonxcSURTv/knO5fdKHAsxOKeGASyZaYvw1+hBTXT+75qWUDQG5w==";
        };
    in {
        "aH4I56fP" = _aH4I56fP;
        "twT61arB" = _twT61arB;
        ...
        "fabric-1.20.1" = _B80hKlJR;
        "fabric-1.20.5" = _b3A7PMHP;
        "fabric-1.20.6" = _RdJsn70f;
        "fabric-1.21" = _Us3qRPhu;
        "fabric-1.21.1" = _Us3qRPhu;
        "fabric-1.21.2" = _857BvBs9;
        "fabric-1.21.3" = _857BvBs9;
        "fabric-1.21.4" = _Ce0xXdTe;
        "fabric-1.21.5" = _Z0kv4ecn;
        "fabric-1.20" = _B80hKlJR;
        "fabric-1.21.6" = _3YwYoqG2;
        "fabric-1.21.7" = _3YwYoqG2;
        "fabric-1.21.8" = _3YwYoqG2;
        "fabric-1.21.9" = _OZam1KMf;
        "fabric-1.21.10" = _OZam1KMf;
        "fabric-1.21.11" = _MnWspXQ6;
        "fabric-26.1" = _8BVALSLO;
        "fabric-26.1.1" = _8BVALSLO;
        "fabric-26.1.2" = _8BVALSLO;
        "fabric-26.2" = _q3uvUp6V;
        "fabric-26.3" = _Ucgo1y8G;
        "quilt-1.20.1" = _B80hKlJR;
        "quilt-1.20.4" = _vn1jw9C4;
        "quilt-1.20.6" = _RdJsn70f;
        "quilt-1.21" = _Us3qRPhu;
        "quilt-1.21.1" = _Us3qRPhu;
        "quilt-1.21.2" = _857BvBs9;
        "quilt-1.21.3" = _857BvBs9;
        "quilt-1.21.4" = _Ce0xXdTe;
        "quilt-1.21.5" = _Z0kv4ecn;
        "quilt-1.20" = _B80hKlJR;
        "quilt-1.21.6" = _3YwYoqG2;
        "quilt-1.21.7" = _3YwYoqG2;
        "quilt-1.21.8" = _3YwYoqG2;
        "quilt-1.21.9" = _OZam1KMf;
        "quilt-1.21.10" = _OZam1KMf;
        "quilt-1.21.11" = _MnWspXQ6;
        "quilt-26.1" = _8BVALSLO;
        "quilt-26.1.1" = _8BVALSLO;
        "quilt-26.1.2" = _8BVALSLO;
        "quilt-26.2" = _q3uvUp6V;
        "quilt-26.3" = _Ucgo1y8G;
        "forge-1.20.1" = _z2VZUXJE;
        "forge-1.20.4" = _J2pCSN3B;
        "forge-1.20" = _z2VZUXJE;
        "neoforge-1.20.4" = _qNPIf7kH;
        "neoforge-1.20.6" = _5aJNbS3q;
        "neoforge-1.21" = _iRc8orve;
        "neoforge-1.21.1" = _iRc8orve;
        "neoforge-1.21.2" = _Ty2WX7yo;
        "neoforge-1.21.3" = _Ty2WX7yo;
        "neoforge-1.21.4" = _hrkBOodj;
        "neoforge-1.21.5" = _DHvTnwd2;
        "neoforge-1.21.6" = _bNaR3a1U;
        "neoforge-1.21.7" = _bNaR3a1U;
        "neoforge-1.21.8" = _bNaR3a1U;
        "neoforge-1.21.9" = _ioywILJX;
        "neoforge-1.21.10" = _ioywILJX;
        "neoforge-1.21.11" = _SlwQ9Mtr;
        "neoforge-26.1" = _VAjR1h3T;
        "neoforge-26.1.1" = _VAjR1h3T;
        "neoforge-26.1.2" = _VAjR1h3T;
        "neoforge-26.2" = _xwiDPw9k;
        "neoforge-26.3" = _f2GNKxO0;
        "pkg-6.5+er1.0+1.20.4" = _aH4I56fP;
        "pkg-6.5+er1.1+1.20.4" = _twT61arB;
        "pkg-6.5+er1.1+1.20.1" = _vXz5DFkA;
        "pkg-6.5+er1.1.1+1.20.4" = _UJt6IJw8;
        "pkg-6.5+er1.1.1+1.20.1" = _eugbkDZS;
        "pkg-6.5+er1.1.2+1.20.4" = _hSG4T1Gm;
        "pkg-6.5+er1.1.2+1.20.1" = _B18hazYm;
        "pkg-6.5+er1.2+1.20.4" = _K7nfwk6z;
        "pkg-6.5+er1.2+1.20.1" = _c9ZG2QOp;
        "pkg-6.5+er1.2.1+1.20.4" = _b9AHuRCL;
        "pkg-6.5+er1.2.1+1.20.1" = _DNh0rdUq;
        "pkg-6.5+er1.2.2+1.20.4" = _cgmL5SfV;
        "pkg-6.5+er1.2.2+1.20.1" = _w2Aral57;
        "pkg-6.5+er1.2.3+1.20.4" = _Scpu1Sox;
        "pkg-6.5+er1.2.3+1.20.1" = _uZjOqNX8;
        "pkg-6.5+er1.2.3+1.20.5" = _wL5AAdS2;
        "pkg-6.5+er1.3+1.20.6" = _S30NBaLF;
        "pkg-6.5+er1.3+1.20.4" = _UWtELFoO;
        "pkg-6.5+er1.3+1.20.1" = _LlW2hXTS;
        "pkg-6.5+er1.3.1+1.20.6" = _b3A7PMHP;
        "pkg-6.5+er1.3.1+1.20.4" = _YwjEhIT0;
        "pkg-6.5+er1.3.1+1.20.1" = _krHwk508;
        "pkg-6.5+er1.3.1+1.21" = _7HYR4PWN;
        "pkg-1.4.0+1.20.1" = _tDYKYmfH;
        "pkg-1.4.0+1.20.4" = _qNPIf7kH;
        "pkg-1.4.0+1.20.6" = _5aJNbS3q;
        "pkg-1.4.0+1.21" = _mYPBCD6P;
        "pkg-2.0.0+1.21" = _l5A5vDdk;
        "pkg-2.0.0+1.21.2" = _gAnNPYvC;
        "pkg-2.0.0+1.20.1" = _BTPVPr5v;
        "pkg-2.0.1+1.20.1" = _B9bAE59t;
        "pkg-2.0.1+1.21.2" = _vhw8u285;
        "pkg-2.0.1+1.21" = _ksoIVIju;
        "pkg-2.0.2+1.21" = _KUeXNB74;
        "pkg-2.0.2+1.20.1" = _FhLLAkjM;
        "pkg-2.0.2+1.21.2" = _mrf6Dv42;
        "pkg-2.1.0+1.21" = _gBhh6GHp;
        "pkg-2.1.0+1.21.2" = _93mcoL45;
        "pkg-2.1.0+1.20.1" = _tnG7C4R8;
        "pkg-2.1.1+1.21" = _BXCjcoIq;
        "pkg-2.1.1+1.20.1" = _9ByDdMqM;
        "pkg-2.1.1+1.21.2" = _fHbcAoFV;
        "pkg-2.1.2+1.20.1" = _uAsE9RGB;
        "pkg-2.1.2+1.21" = _U8QTRlYE;
        "pkg-2.1.2+1.21.2" = _JSRmuC04;
        "pkg-2.1.2+1.21.4" = _uqEFxxzA;
        "pkg-2.1.3+1.20.1" = _dQUCYFiS;
        "pkg-2.1.3+1.21" = _pBSfIYRK;
        "pkg-2.1.3+1.21.2" = _7RY20Xtr;
        "pkg-2.1.3+1.21.4" = _AjgHJUH7;
        "pkg-2.1.4+1.20.1" = _JXQEBotG;
        "pkg-2.1.4+1.21" = _zBs24ma9;
        "pkg-2.1.4+1.21.2" = _Ty2WX7yo;
        "pkg-2.1.4+1.21.4" = _TynJP2w9;
        "pkg-2.1.5+1.21.4" = _SvFNSFGI;
        "pkg-2.1.6+1.21.5" = _QCqzTGjB;
        "pkg-2.1.7+1.20.1" = _Z6mknAU8;
        "pkg-2.1.7+1.21" = _6WvyNads;
        "pkg-2.1.7+1.21.4" = _A9N9pJRR;
        "pkg-2.1.7+1.21.5" = _DRxWvlcn;
        "pkg-2.1.8+1.20.1" = _Q3S25HsE;
        "pkg-2.1.8+1.21" = _BBkDT97m;
        "pkg-2.1.8+1.21.4" = _7eivq7ef;
        "pkg-2.1.8+1.21.5" = _5CsPhdMe;
        "pkg-3.0.0+1.20.1" = _b5hVK0lk;
        "pkg-3.0.0+1.21.1" = _N5aMDNJd;
        "pkg-3.0.0+1.21.4" = _Z0rpP4ib;
        "pkg-3.0.0+1.21.5" = _CHmPiLlu;
        "pkg-3.0.0+1.21.6" = _8JYc5Y16;
        "pkg-3.1.0+1.20.1" = _vrgF2SnZ;
        "pkg-3.1.0+1.21.1" = _3Zd1OwsX;
        "pkg-3.1.0+1.21.4" = _GConZoEb;
        "pkg-3.1.0+1.21.5" = _rk6I9dDP;
        "pkg-3.1.0+1.21.6" = _PqkbnTYM;
        "pkg-3.1.1+1.20.1" = _N1giCnph;
        "pkg-3.1.1+1.21.1" = _I7dlLck2;
        "pkg-3.1.1+1.21.4" = _SYKDSKDK;
        "pkg-3.1.1+1.21.5" = _urBU2UD3;
        "pkg-3.1.1+1.21.6" = _elRGJwJO;
        "pkg-3.1.2+1.20.1" = _IcqyBKFx;
        "pkg-3.1.2+1.21.1" = _kEpSXrdv;
        "pkg-3.1.2+1.21.4" = _y6mP2Oxi;
        "pkg-3.1.2+1.21.5" = _hcDPgAMX;
        "pkg-3.1.2+1.21.6" = _VE8WalpP;
        "pkg-3.1.3+1.20.1" = _LixEBgAq;
        "pkg-3.1.3+1.21.1" = _fl6EV7ib;
        "pkg-3.1.3+1.21.4" = _10dJDLgM;
        "pkg-3.1.3+1.21.5" = _RKXrJo5j;
        "pkg-3.1.3+1.21.6" = _TIlCxjI1;
        "pkg-3.1.4+1.20.1" = _7iCNnDAk;
        "pkg-3.1.4+1.21.1" = _lml7GVJK;
        "pkg-3.1.4+1.21.4" = _dRa5uX8a;
        "pkg-3.1.4+1.21.5" = _SGIoeqFl;
        "pkg-3.1.4+1.21.6" = _gBa3hAJH;
        "pkg-3.2.0+1.20.1" = _fQPokOt6;
        "pkg-3.2.0+1.21.1" = _5D1Ue8M5;
        "pkg-3.2.0+1.21.4" = _ydz0rX19;
        "pkg-3.2.0+1.21.5" = _6B3ZcDdS;
        "pkg-3.2.0+1.21.6" = _sFOfOqAG;
        "pkg-3.2.0+1.21.9" = _6bR9J0b1;
        "pkg-3.2.1+1.20.1" = _5b37RP5E;
        "pkg-3.2.1+1.21.1" = _mgDHdqho;
        "pkg-3.2.1+1.21.4" = _qqTBlE3S;
        "pkg-3.2.1+1.21.5" = _9Q4wc6Qi;
        "pkg-3.2.1+1.21.6" = _z8WikN37;
        "pkg-3.2.1+1.21.9" = _39IUGNim;
        "pkg-4.0.0+1.20.1" = _taQZPvDz;
        "pkg-4.0.0+1.21.1" = _XelhU1rO;
        "pkg-4.0.0+1.21.4" = _aVKA3CqI;
        "pkg-4.0.0+1.21.5" = _yjRRauKr;
        "pkg-4.0.0+1.21.6" = _XLBa9D0H;
        "pkg-4.0.0+1.21.9" = _VAZkLy1k;
        "pkg-4.0.0+1.21.11" = _q5kcBUE1;
        "pkg-4.0.1+1.20.1" = _kX6oOUXO;
        "pkg-4.0.1+1.21.1" = _MbtWZys5;
        "pkg-4.0.1+1.21.4" = _5E6jbZ7I;
        "pkg-4.0.1+1.21.5" = _qZfvL2XL;
        "pkg-4.0.1+1.21.6" = _WsZF568z;
        "pkg-4.0.1+1.21.9" = _UQrm6vyd;
        "pkg-4.0.1+1.21.11" = _SKkhK37X;
        "pkg-4.0.2+1.20.1" = _TChqsR2O;
        "pkg-4.0.2+1.21.1" = _QoYHFpvw;
        "pkg-4.0.2+1.21.4" = _e6jgtN3I;
        "pkg-4.0.2+1.21.5" = _smSSQmlM;
        "pkg-4.0.2+1.21.6" = _xzDgKAxx;
        "pkg-4.0.2+1.21.9" = _Fm1IHoC9;
        "pkg-4.0.2+1.21.11" = _mdPKm5Ry;
        "pkg-4.0.3+1.21.4" = _FpXl6NxK;
        "pkg-4.0.3+1.21.6" = _LhZtJNyH;
        "pkg-4.0.3+1.21.5" = _SjWXB2tA;
        "pkg-4.0.3+1.21.9" = _yNV85D3E;
        "pkg-4.0.3+1.21.11" = _frMy36gj;
        "pkg-4.0.3+1.21.1" = _Ujm3tDqk;
        "pkg-4.0.3+1.20.1" = _1J2uFdd9;
        "pkg-4.0.4+1.20.1" = _YALwKzFi;
        "pkg-4.0.4+1.21.1" = _G8XO4eb5;
        "pkg-4.0.4+1.21.4" = _hrkBOodj;
        "pkg-4.0.4+1.21.5" = _DHvTnwd2;
        "pkg-4.0.4+1.21.6" = _VHOEPz0g;
        "pkg-4.0.4+1.21.9" = _rKo08ss7;
        "pkg-4.0.4+1.21.11" = _eY4BulND;
        "pkg-4.1.0+1.20.1-fabric" = _LYGctzbD;
        "pkg-4.1.0+1.20.1-forge" = _X5ruMTFX;
        "pkg-4.1.0+1.21.1-fabric" = _f8vXG4lT;
        "pkg-4.1.0+1.21.1-neoforge" = _WYxz0UBh;
        "pkg-4.1.0+1.21.6-fabric" = _9IO3vqSc;
        "pkg-4.1.0+1.21.6-neoforge" = _I64Sqtxp;
        "pkg-4.1.0+1.21.9-fabric" = _xRrkbWxo;
        "pkg-4.1.0+1.21.9-neoforge" = _CkYqPkdh;
        "pkg-4.1.0+1.21.11-fabric" = _uexl5ix9;
        "pkg-4.1.0+1.21.11-neoforge" = _QB9V7CBg;
        "pkg-4.1.1+1.20.1-fabric" = _wdZ0NtZ3;
        "pkg-4.1.1+1.20.1-forge" = _YQsltv9t;
        "pkg-4.1.1+1.21.1-fabric" = _3e6W6Cms;
        "pkg-4.1.1+1.21.1-neoforge" = _dRTTPQHk;
        "pkg-4.1.1+1.21.6-fabric" = _gvKld9Xi;
        "pkg-4.1.1+1.21.6-neoforge" = _8XNkvhIs;
        "pkg-4.1.1+1.21.9-fabric" = _qykozUtw;
        "pkg-4.1.1+1.21.9-neoforge" = _5JYW4UjX;
        "pkg-4.1.1+1.21.11-fabric" = _Az1Agb0J;
        "pkg-4.1.1+1.21.11-neoforge" = _Feb0419v;
        "pkg-4.1.1+26.1-fabric" = _wZOm7DIs;
        "pkg-4.1.1+26.1-neoforge" = _l0o2meut;
        "pkg-4.1.2+1.20.1-fabric" = _UAoH3nAe;
        "pkg-4.1.2+1.20.1-forge" = _wYlrjeDH;
        "pkg-4.1.2+1.21.1-fabric" = _2kB4qItN;
        "pkg-4.1.2+1.21.1-neoforge" = _8WlfJfMI;
        "pkg-4.1.2+1.21.6-fabric" = _AREBWeCm;
        "pkg-4.1.2+1.21.6-neoforge" = _xtPvnTMx;
        "pkg-4.1.2+1.21.9-fabric" = _gslYGb0z;
        "pkg-4.1.2+1.21.9-neoforge" = _kpW68935;
        "pkg-4.1.2+1.21.11-fabric" = _syr85yFZ;
        "pkg-4.1.2+1.21.11-neoforge" = _RtXFLxVk;
        "pkg-4.1.2+26.1-fabric" = _Eti6GsSk;
        "pkg-4.1.2+26.1-neoforge" = _pmQ5WFRs;
        "pkg-4.1.3+1.20.1-fabric" = _jjzXrBKE;
        "pkg-4.1.3+1.20.1-forge" = _YrpUgc9b;
        "pkg-4.1.3+1.21.1-fabric" = _oG4iNMqV;
        "pkg-4.1.3+1.21.1-neoforge" = _GXoTN5uD;
        "pkg-4.1.3+1.21.6-fabric" = _2b2cPE7Z;
        "pkg-4.1.3+1.21.6-neoforge" = _Vf9hCve9;
        "pkg-4.1.3+1.21.9-fabric" = _RjeEpAQA;
        "pkg-4.1.3+1.21.9-neoforge" = _YLBZH4K4;
        "pkg-4.1.3+1.21.11-fabric" = _DGFxFZRj;
        "pkg-4.1.3+1.21.11-neoforge" = _wIRXvtdR;
        "pkg-4.1.3+26.1-fabric" = _TEDqQ2dV;
        "pkg-4.1.3+26.1-neoforge" = _sEvJAjpR;
        "pkg-4.1.4+1.20.1-fabric" = _OeqY5umH;
        "pkg-4.1.4+1.20.1-forge" = _csoR87Vp;
        "pkg-4.1.4+1.21.1-fabric" = _UQbbUe0i;
        "pkg-4.1.4+1.21.1-neoforge" = _CTYn7dul;
        "pkg-4.1.4+1.21.6-fabric" = _vllzuznm;
        "pkg-4.1.4+1.21.6-neoforge" = _PtUd5bcz;
        "pkg-4.1.4+1.21.9-fabric" = _zFWr5Ki0;
        "pkg-4.1.4+1.21.9-neoforge" = _S7rqiA8Y;
        "pkg-4.1.4+1.21.11-fabric" = _Z3tSOFiQ;
        "pkg-4.1.4+1.21.11-neoforge" = _VTuuJFhc;
        "pkg-4.1.4+26.1-fabric" = _I23J0HFR;
        "pkg-4.1.4+26.1-neoforge" = _X6f03dOh;
        "pkg-4.1.5+1.20.1-fabric" = _WAM53p7q;
        "pkg-4.1.5+1.20.1-forge" = _srThTtah;
        "pkg-4.1.5+1.21.1-fabric" = _cpDUJPqY;
        "pkg-4.1.5+1.21.1-neoforge" = _J3LpGswQ;
        "pkg-4.1.5+1.21.6-fabric" = _a4rCVSbl;
        "pkg-4.1.5+1.21.6-neoforge" = _xuhQyhPk;
        "pkg-4.1.5+1.21.9-fabric" = _BLlI3nVE;
        "pkg-4.1.5+1.21.9-neoforge" = _Cg91SokN;
        "pkg-4.1.5+1.21.11-fabric" = _OjlQ0V1l;
        "pkg-4.1.5+1.21.11-neoforge" = _MlNzV01e;
        "pkg-4.1.5+26.1-fabric" = _uPyJ1mXe;
        "pkg-4.1.5+26.1-neoforge" = _NCpELRkz;
        "pkg-4.1.6+1.20.1-forge" = _DRgitdJ1;
        "pkg-4.1.6+1.20.1-fabric" = _sPyegvdo;
        "pkg-4.1.6+1.21.1-fabric" = _xgHFReeC;
        "pkg-4.1.6+1.21.1-neoforge" = _Y2ITFKVz;
        "pkg-4.1.6+1.21.6-fabric" = _rvVaPrDY;
        "pkg-4.1.6+1.21.6-neoforge" = _QuZ89evG;
        "pkg-4.1.6+1.21.9-fabric" = _fbYQqfta;
        "pkg-4.1.6+1.21.9-neoforge" = _jVXZ35o2;
        "pkg-4.1.6+1.21.11-fabric" = _tec28Tcp;
        "pkg-4.1.6+1.21.11-neoforge" = _nTSHfOGu;
        "pkg-4.1.6+26.1-fabric" = _314bfooG;
        "pkg-4.1.6+26.1-neoforge" = _AhPSimAW;
        "pkg-4.1.7+1.20.1-fabric" = _H8fGOJdM;
        "pkg-4.1.7+1.20.1-forge" = _7wePd1ME;
        "pkg-4.1.7+1.21.1-fabric" = _HK0bTMFV;
        "pkg-4.1.7+1.21.1-neoforge" = _Eboa8rf2;
        "pkg-4.1.7+1.21.6-fabric" = _lv9XQML5;
        "pkg-4.1.7+1.21.6-neoforge" = _NVvqKDAu;
        "pkg-4.1.7+1.21.9-fabric" = _oyWOscaP;
        "pkg-4.1.7+1.21.9-neoforge" = _PAzO1xWX;
        "pkg-4.1.7+1.21.11-fabric" = _RmQ3pogd;
        "pkg-4.1.7+1.21.11-neoforge" = _88uO6yfX;
        "pkg-4.1.7+26.1-fabric" = _FOycD8yD;
        "pkg-4.1.7+26.1-neoforge" = _RaGu2rfP;
        "pkg-4.1.8+1.20.1-fabric" = _QyklE9Ux;
        "pkg-4.1.8+1.20.1-forge" = _72fvnL5O;
        "pkg-4.1.8+1.21.1-fabric" = _GgJk3pit;
        "pkg-4.1.8+1.21.1-neoforge" = _yVn03XFR;
        "pkg-4.1.8+1.21.6-fabric" = _YlzhM5ef;
        "pkg-4.1.8+1.21.6-neoforge" = _tcitm0pQ;
        "pkg-4.1.8+1.21.9-fabric" = _Mzx87SBC;
        "pkg-4.1.8+1.21.9-neoforge" = _HFsaTu6d;
        "pkg-4.1.8+1.21.11-fabric" = _xYg07epE;
        "pkg-4.1.8+1.21.11-neoforge" = _nbf7l5rw;
        "pkg-4.1.8+26.1-fabric" = _gfFINiGl;
        "pkg-4.1.8+26.1-neoforge" = _QZyu9uxR;
        "pkg-5.0.0-alpha.1+1.20.1-forge" = _SiUQFQEy;
        "pkg-5.0.0-alpha.1+1.20.1-fabric" = _ejhOXqor;
        "pkg-5.0.0-alpha.1+1.21.1-fabric" = _fRFIfkq1;
        "pkg-5.0.0-alpha.1+1.21.1-neoforge" = _BeKW6EeH;
        "pkg-5.0.0-alpha.1+26.1-fabric" = _dSmUrn0n;
        "pkg-5.0.0-alpha.1+26.1-neoforge" = _su8nh71m;
        "pkg-5.0.0-alpha.1+26.2-fabric" = _hTveFCYd;
        "pkg-5.0.0-alpha.1+26.2-neoforge" = _D47ismvi;
        "pkg-4.1.9+1.20.1-forge" = _tRSvQwxH;
        "pkg-4.1.9+1.20.1-fabric" = _hsDnwQ1m;
        "pkg-4.1.9+1.21.1-fabric" = _cHB2i2Cd;
        "pkg-4.1.9+1.21.1-neoforge" = _xluI8tab;
        "pkg-4.1.9+1.21.6-fabric" = _HlMN0gg9;
        "pkg-4.1.9+1.21.6-neoforge" = _d49z6dUE;
        "pkg-4.1.9+1.21.9-fabric" = _BxPQQysQ;
        "pkg-4.1.9+1.21.9-neoforge" = _IX00IhQH;
        "pkg-4.1.9+1.21.11-fabric" = _gB9JJuiY;
        "pkg-4.1.9+1.21.11-neoforge" = _qohFaAbs;
        "pkg-4.1.9+26.1-fabric" = _GsA9Bsa2;
        "pkg-4.1.9+26.1-neoforge" = _w0pSP9iG;
        "pkg-5.0.0-alpha.2+1.20.1-fabric" = _UPWvGmlR;
        "pkg-5.0.0-alpha.2+1.20.1-forge" = _2aSTJhS3;
        "pkg-5.0.0-alpha.2+1.21.1-fabric" = _Pe6W6E6b;
        "pkg-5.0.0-alpha.2+1.21.1-neoforge" = _fSpSIKPD;
        "pkg-5.0.0-alpha.2+26.1-fabric" = _IiPlo6zR;
        "pkg-5.0.0-alpha.2+26.1-neoforge" = _A3nEOxLp;
        "pkg-5.0.0-alpha.2+26.2-fabric" = _J3Nn73Eo;
        "pkg-5.0.0-alpha.2+26.2-neoforge" = _fH8nVe3p;
        "pkg-4.1.10+1.20.1-forge" = _GCiNHFPF;
        "pkg-4.1.10+1.20.1-fabric" = _U9E9pkTV;
        "pkg-4.1.10+1.21.1-fabric" = _bBp9EtU0;
        "pkg-4.1.10+1.21.1-neoforge" = _VHZeASxW;
        "pkg-4.1.10+1.21.6-fabric" = _3YwYoqG2;
        "pkg-4.1.10+1.21.6-neoforge" = _bNaR3a1U;
        "pkg-4.1.10+1.21.9-fabric" = _OZam1KMf;
        "pkg-4.1.10+1.21.9-neoforge" = _ioywILJX;
        "pkg-4.1.10+1.21.11-fabric" = _MnWspXQ6;
        "pkg-4.1.10+1.21.11-neoforge" = _SlwQ9Mtr;
        "pkg-4.1.10+26.1-fabric" = _huyDXEkt;
        "pkg-4.1.10+26.1-neoforge" = _1HbxYi8N;
        "pkg-5.0.0-alpha.3+1.20.1-forge" = _OjLoes0w;
        "pkg-5.0.0-alpha.3+1.20.1-fabric" = _sf9TvcI4;
        "pkg-5.0.0-alpha.3+1.21.1-fabric" = _yo4DjOYc;
        "pkg-5.0.0-alpha.3+1.21.1-neoforge" = _rHx449jF;
        "pkg-5.0.0-alpha.3+26.1-fabric" = _4llBvwL2;
        "pkg-5.0.0-alpha.3+26.1-neoforge" = _PiljzPxK;
        "pkg-5.0.0-alpha.3+26.2-fabric" = _dqmxvmmu;
        "pkg-5.0.0-alpha.3+26.2-neoforge" = _D1Z2SXpB;
        "pkg-5.0.0-alpha.4+1.20.1-fabric" = _B80hKlJR;
        "pkg-5.0.0-alpha.4+1.20.1-forge" = _z2VZUXJE;
        "pkg-5.0.0-alpha.4+1.21.1-fabric" = _Us3qRPhu;
        "pkg-5.0.0-alpha.4+1.21.1-neoforge" = _iRc8orve;
        "pkg-5.0.0-alpha.4+26.1-fabric" = _8BVALSLO;
        "pkg-5.0.0-alpha.4+26.1-neoforge" = _VAjR1h3T;
        "pkg-5.0.0-alpha.4+26.2-fabric" = _q3uvUp6V;
        "pkg-5.0.0-alpha.4+26.2-neoforge" = _xwiDPw9k;
        "pkg-5.0.0-alpha.4+26.3-fabric" = _Ucgo1y8G;
        "pkg-5.0.0-alpha.4+26.3-neoforge" = _f2GNKxO0;
        "default" = _f2GNKxO0;
    });
