...
let
    versions = (let
        ...
        _TYYv9406 = {
            "id" = "TYYv9406";
            "file" = "spell_engine-neoforge-1.9.15+1.21.1.jar";
            "hash" = "sha512-bN91z40yUoAkFmcVTPgfi2ygybizpdJ5SRP3wIstkrCJu7ba11jTC9v4c41+9OYGeo/DbWxajD5k9upuDl4pFQ==";
        };
        _OIgGU2vT = {
            "id" = "OIgGU2vT";
            "file" = "spell_engine-fabric-1.9.15+1.21.1.jar";
            "hash" = "sha512-zS+ZJVXLHOYtxVsVBeKDf1eQOGUzsPLoDkjYFv2fYOXBmx3S5KAWtKjtQ7uTz1wY0jSTSr7vxayP/VlwwkB8HA==";
        };
        _sm8aXLMc = {
            "id" = "sm8aXLMc";
            "file" = "spell_engine-neoforge-1.9.16+1.21.1.jar";
            "hash" = "sha512-xnB+IfveZkSx+mdY/iNUkR/7pmuomreZhseOcJZDCsfEWt82/SxMs6On/mvlGVXzTEoG7kM3k+ANbGq3Gbrh9A==";
        };
        _AzuZrwDk = {
            "id" = "AzuZrwDk";
            "file" = "spell_engine-fabric-1.9.16+1.21.1.jar";
            "hash" = "sha512-Y1cn/rrhU+Ht1CMgST0s7RKxn3TwubIrfSyIKzGKkPt6pN2tgbC6SyItazaVrAXHgg2Fp3WEX2bXCQjURBUuHg==";
        };
        _o4Wlwal9 = {
            "id" = "o4Wlwal9";
            "file" = "spell_engine-fabric-1.10.0+1.21.1.jar";
            "hash" = "sha512-IVLjY8lB3njTOXlZVXndovThqhnILkjBSawNy7FHeYY/vBcC6C55+PgSAtwlkuBaEPGvL/MJxUP5ZNWbIOwVsw==";
        };
        _kmGmwA7J = {
            "id" = "kmGmwA7J";
            "file" = "spell_engine-neoforge-1.10.0+1.21.1.jar";
            "hash" = "sha512-gpCoeODliz9HNTx1hjhYQ2UbJFVhkALiwLOsZ11xxepC86WhuhfnAXxX6YHDivUH7aVoryy7P/7K3f27wZMn0w==";
        };
        _NrIHWvUh = {
            "id" = "NrIHWvUh";
            "file" = "spell_engine-fabric-1.10.1+1.21.1.jar";
            "hash" = "sha512-KUeliz7zhyz0X7BGle53QE5g+PdAcpj2EmtRjjEB+ppBAkTY/Is/1MRVr+8HjFiXFU2KvoUX1o+1INEjRtUsHw==";
        };
        _tsi1GmcU = {
            "id" = "tsi1GmcU";
            "file" = "spell_engine-neoforge-1.10.1+1.21.1.jar";
            "hash" = "sha512-kl8uHNvfgU6Qeacmux2SJpSTV085ZHxvJOe6rH5lCWzCr8BrL1L2JSJMbx0hxMGbbYhoT4jW3Msc5KRXel+iHg==";
        };
        _18UIA6JI = {
            "id" = "18UIA6JI";
            "file" = "spell_engine-fabric-1.10.2+1.21.1.jar";
            "hash" = "sha512-O5Ir4+9VkwlTrsCVR8pOqpCkiYOQWkveHKdFgjqwa4V4trXFO/4jB3/zL0DxCrEjUgshUq/7PGDHJAwhBoJm6g==";
        };
        _jNkZJ9wR = {
            "id" = "jNkZJ9wR";
            "file" = "spell_engine-neoforge-1.10.2+1.21.1.jar";
            "hash" = "sha512-4Hg+M1fqrHn4BxrybhzN3w6xy2NtVZ7brMOknlVyMTICBujLhjtHfyUcJhwo9sxz1fO2hmhpYgKg+qju4192Fw==";
        };
        _pszhW2WY = {
            "id" = "pszhW2WY";
            "file" = "spell_engine-neoforge-1.10.3+1.21.1.jar";
            "hash" = "sha512-6wJVUSxSnbgBYacLxluW/lPrHXhUHVskBbZcH3vK1j+0tPdx1SHHPXyKnXVRWzMtCfcRbAT77dka5RPhmU/Fcg==";
        };
        _UUJDeQ8E = {
            "id" = "UUJDeQ8E";
            "file" = "spell_engine-fabric-1.10.3+1.21.1.jar";
            "hash" = "sha512-QR5LBio8iT7YL0vPhpD8lhKXnT776t1rXf1ztIJ1xJRTWC6B6TdC2damaQvq1tz6S7h7YcdEmyMyjdGWT++Vcg==";
        };
        _jh8npjbN = {
            "id" = "jh8npjbN";
            "file" = "spell_engine-neoforge-1.10.4+1.21.1.jar";
            "hash" = "sha512-ZXht08Ud2ufDyik14U4t4sGKcpJyG5oAbaZIgICbUlOBHG8Q0RIT+8nJ+ahnyQD7RtIObIv+QycUhjvAEJN2bA==";
        };
        _ABbhKWKY = {
            "id" = "ABbhKWKY";
            "file" = "spell_engine-fabric-1.10.5+1.21.1.jar";
            "hash" = "sha512-eVFxS6aOAq8EF0MULl0CbKFA1svMap2Bj0HGdw4kKMjGFHCi3lSMhO+hjuxk5OAG1pbjay0WlwZTipJfgWdtGg==";
        };
        _VQ29MaF4 = {
            "id" = "VQ29MaF4";
            "file" = "spell_engine-neoforge-1.10.5+1.21.1.jar";
            "hash" = "sha512-GeOtqRtUZs/zQVXUOLcO14v4kRQGTKNwToRNzvPr42zYYGLyIMn/HCripk0I3oK4Ttcu9EGQVsSn+ssru4QNgw==";
        };
        _n8ACh9qS = {
            "id" = "n8ACh9qS";
            "file" = "spell_engine-fabric-1.10.5+26.1.2.jar";
            "hash" = "sha512-Wmpzj2BgybrmJ8OFYCZmmL58l/Psx247tvGBv/9Hb93zFgJ6AILaxIAfz6BJpwdefb1usXrNgSmcGekqAkSdaA==";
        };
        _zUf2CBom = {
            "id" = "zUf2CBom";
            "file" = "spell_engine-neoforge-1.10.5+26.1.2.jar";
            "hash" = "sha512-uJ+CD82nTX4F43266rQeJVo21Cnc0+o9N/Pah2zeHuLkf8SOE/1sONe8qJPoJ9osaOkVC5q4UU85EJ9A/Q2CUg==";
        };
        _GIHnkp7Z = {
            "id" = "GIHnkp7Z";
            "file" = "spell_engine-fabric-1.10.5+26.2.jar";
            "hash" = "sha512-xY/TFw+hBN8je4suYjEJMCki6PCrmg/o3y06LyCleG8hYpl6+uyoxCCLfG0AUY4tPgMQ+L9SkKe9HEqvEwlfCg==";
        };
        _hP8KzYyC = {
            "id" = "hP8KzYyC";
            "file" = "spell_engine-neoforge-1.10.5+26.2.jar";
            "hash" = "sha512-ciVoSnSO6dJSCKbsjPgs/rkVMBXJp8Y6yWv+mDZ5EHaCxZ5W0/irVCHVL/DpplxIFSrWbiHaM6qQ8JbVUDcsIw==";
        };
        _O0t93Aau = {
            "id" = "O0t93Aau";
            "file" = "spell_engine-neoforge-1.10.6+1.21.1.jar";
            "hash" = "sha512-jSveZ7efGJtRhMkDdupMHrv9JA6kLk7A3FIxoagGyettEg1FSD2XBHnG/WNfu+0DfscIXstb7670WA0bOjK2dw==";
        };
        _MAphraur = {
            "id" = "MAphraur";
            "file" = "spell_engine-fabric-1.10.6+1.21.1.jar";
            "hash" = "sha512-jtfNa5jkvoPlr/VWPgSGoVwucnvFbmE6v0y2FYLDuOPgKjoeQ5WORsJMzXkqJoytytsbHk9jYM23/eqyrwvrEQ==";
        };
        _dgzQu8iO = {
            "id" = "dgzQu8iO";
            "file" = "spell_engine-forge-1.10.5+1.20.1.jar";
            "hash" = "sha512-O7bCLBQ6mfYeOHvyGtXP1AQSKUyK7h7myJUSfTuyBEPeFXbnERAjo5LkjtwauFw3i9HlX8udIZP24H553ZUIcg==";
        };
        _lQYOatOL = {
            "id" = "lQYOatOL";
            "file" = "spell_engine-fabric-1.10.5+1.20.1.jar";
            "hash" = "sha512-kko+2wn1Hca96LXcvsHMkqKSw4TjXtZoaKWzRi7mDZLJQ468dCztO4QJ2Ymz1xYNvIwCX3BogmEdGIyaEkP3uQ==";
        };
        _dXslSEaY = {
            "id" = "dXslSEaY";
            "file" = "spell_engine-fabric-1.10.6+1.20.1.jar";
            "hash" = "sha512-5rbvqSVbapG4Ba6qCct8EAcSsQuMsBlFrUAbeO0PmRM4LrzJG7RAcyuKnK8hl0Ius7IsuLF1ocaDqaG7UuVVjg==";
        };
        _q5VkMSzl = {
            "id" = "q5VkMSzl";
    ...
    in {
        ...
        "pkg-0.9.6+1.19-fabric" = _CXcP4unv;
        "pkg-0.9.7+1.19-fabric" = _klgu6ViH;
        "pkg-0.9.8+1.19-fabric" = _X2TtLs8V;
        "pkg-0.9.9+1.19-fabric" = _htf90GdH;
        "pkg-0.9.10+1.19-fabric" = _AZShwLaW;
        "pkg-0.9.11+1.19-fabric" = _CVXnaSfs;
        "pkg-0.9.12+1.19-fabric" = _Q8cJ5uAI;
        "pkg-0.9.13+1.19-fabric" = _sjs1bgms;
        "pkg-0.9.14+1.19-fabric" = _kufaZ2Fi;
        "pkg-0.9.15+1.19-fabric" = _8uboCQ5D;
        "pkg-0.9.16+1.19-fabric" = _VW49K0aa;
        "pkg-0.9.17+1.19-fabric" = _QfqnyDqt;
        "pkg-0.9.18+1.19-fabric" = _Y4gGQTG2;
        "pkg-0.9.19+1.19-fabric" = _PhZQ7oV3;
        "pkg-0.9.20+1.19-fabric" = _eDRpv7Gq;
        "pkg-0.9.21+1.19-fabric" = _dR5zgelV;
        "pkg-0.9.22+1.19-fabric" = _z8tCOAtj;
        "pkg-0.9.23+1.19-fabric" = _GbEzmkEd;
        "pkg-0.9.24+1.19-fabric" = _Z3exwp7X;
        "pkg-0.9.25+1.19-fabric" = _7vXbmNlo;
        "pkg-0.9.26+1.20.1-fabric" = _4hnzypKn;
        "pkg-0.9.27+1.20.1-fabric" = _bypy79hn;
        "pkg-0.9.28+1.20.1-fabric" = _EM2qnzzH;
        "pkg-0.9.29+1.20.1-fabric" = _zmkGvUFy;
        "pkg-0.9.30+1.20.1-fabric" = _eqFj8Yg4;
        "pkg-0.9.31+1.20.1-fabric" = _eCu7PzVC;
        "pkg-0.9.32+1.20.1" = _uw1SoMLW;
        "pkg-0.10.0+1.20.1" = _xGmYuuPh;
        "pkg-0.11.0+1.20.1" = _HF1C2mQm;
        "pkg-0.9.26+1.19-fabric" = _Mz6VoVgb;
        "pkg-0.12.0+1.20.1" = _9lXwv07z;
        "pkg-0.12.1+1.20.1" = _zUFilmBl;
        "pkg-0.12.2+1.20.1" = _Qe7IbN4T;
        "pkg-0.12.3+1.20.1" = _T6jWApoV;
        "pkg-0.12.4+1.20.1" = _yMzYM2pb;
        "pkg-0.12.5+1.20.1" = _dGiLjDYs;
        "pkg-0.13.0+1.20.1" = _j457OKwj;
        "pkg-0.13.1+1.20.1" = _ZPFbGKwF;
        "pkg-0.13.2+1.20.1" = _UJUSQFXT;
        "pkg-0.13.3+1.20.1" = _sbx3ZGCG;
        "pkg-0.14.0+1.20.1" = _2vz75xvT;
        "pkg-0.14.1+1.20.1" = _wXntgIJi;
        "pkg-0.14.2+1.20.1" = _DB1s06bk;
        "pkg-0.14.3+1.20.1" = _IQ3VkdyH;
        "pkg-0.9.27+1.19-fabric" = _E42wF2VB;
        "pkg-0.15.0+1.20.1" = _2q6avbJi;
        "pkg-0.15.1+1.20.1" = _jCC4AQty;
        "pkg-0.15.2+1.20.1" = _IZFnIGe9;
        "pkg-0.15.3+1.20.1" = _EsN9o530;
        "pkg-0.15.4+1.20.1" = _oZJ30MzD;
        "pkg-0.15.5+1.20.1" = _YchHSzSU;
        "pkg-0.15.6+1.20.1" = _5qhQxhiU;
        "pkg-0.15.7+1.20.1" = _qkL60F6g;
        "pkg-0.15.8+1.20.1" = _eX4YqiVK;
        "pkg-0.15.9+1.20.1" = _Vp8e1nX3;
        "pkg-0.15.10+1.20.1" = _8A8srCta;
        "pkg-1.0.0+1.21.1" = _LBD56h9x;
        "pkg-1.0.1+1.21.1" = _4xHUA1ZX;
        "pkg-1.0.2+1.21.1" = _bN3a70tC;
        "pkg-1.0.3+1.21.1" = _q1eLUvbm;
        "pkg-1.0.4+1.21.1" = _jDxNSGBj;
        "pkg-1.0.5+1.21.1" = _jchQ0GaX;
        "pkg-1.1.0+1.21.1" = _VZ7YM9Hh;
        "pkg-0.15.11+1.20.1" = _G75QvvY1;
        "pkg-1.1.1+1.21.1" = _vD0MbmOr;
        "pkg-1.1.2+1.21.1" = _cyrSy7dK;
        "pkg-0.15.12+1.20.1" = _Fh2MJAAe;
        "pkg-1.2.0+1.21.1" = _MXaJZMaR;
        "pkg-1.2.1+1.21.1" = _MqeLC70e;
        "pkg-1.2.2+1.21.1" = _Su7abr6l;
        "pkg-1.3.0+1.21.1" = _LJujUBT7;
        "pkg-1.3.1+1.21.1" = _3roy4iSP;
        "pkg-1.3.2+1.21.1" = _h8NqTFtK;
        "pkg-1.4.0+1.21.1" = _7CqgUeXF;
        "pkg-1.4.1+1.21.1" = _6bRAQgMc;
        "pkg-1.4.2+1.21.1" = _ktTdKP7z;
        "pkg-1.4.3+1.21.1" = _nAwtKzJ7;
        "pkg-1.4.4+1.21.1" = _Sjtq9uTx;
        "pkg-1.4.5+1.21.1" = _MdK9Rgxz;
        "pkg-1.5.0+1.21.1" = _3cuGZVrF;
        "pkg-1.5.1+1.21.1" = _90P0u1Cv;
        "pkg-1.5.2+1.21.1" = _QXSqu8MJ;
        "pkg-1.5.3+1.21.1" = _XeWMKSG4;
        "pkg-1.5.4+1.21.1" = _M3mOkPKr;
        "pkg-1.5.5+1.21.1" = _gDJ3NFR7;
        "pkg-1.6.0+1.21.1" = _MhvaOReG;
        "pkg-1.6.1+1.21.1" = _C4m43Bzz;
        "pkg-1.6.2+1.21.1" = _sW4fMeCM;
        "pkg-1.6.3+1.21.1" = _TXR7dLF6;
        "pkg-1.6.4+1.21.1" = _wE4v2ai7;
        "pkg-1.6.5+1.21.1" = _y7RDXDkq;
        "pkg-1.6.6+1.21.1" = _n5g5fiSe;
        "pkg-1.6.7+1.21.1" = _N0ApM7hz;
        "pkg-1.6.8+1.21.1" = _1RqjWpwJ;
        "pkg-1.6.9+1.21.1" = _nMm0q4mM;
        "pkg-1.6.10+1.21.1" = _Ys6TEP1b;
        "pkg-1.6.11+1.21.1" = _noCA0IP2;
        "pkg-1.6.12+1.21.1" = _isrnWNcB;
        "pkg-1.7.0+1.21.1" = _jMneACVL;
        "pkg-1.7.1+1.21.1" = _xJd3glyQ;
        "pkg-1.7.2+1.21.1" = _jrRPbk7N;
        "pkg-1.7.3+1.21.1" = _EwaSxJ5Z;
        "pkg-1.8.0+1.21.1-neoforge" = _UDZGkUrO;
        "pkg-1.8.0+1.21.1-fabric" = _xxXE7Gsa;
        "pkg-1.8.1+1.21.1-fabric" = _aWaiWEw6;
        "pkg-1.8.1+1.21.1-neoforge" = _mFSvRIfp;
        "pkg-1.8.2+1.21.1-neoforge" = _23x6BkpK;
        "pkg-1.8.2+1.21.1-fabric" = _ApqgoDjf;
        "pkg-1.8.3+1.21.1-neoforge" = _wh2orXOd;
        "pkg-1.8.3+1.21.1-fabric" = _V32WZjy8;
        "pkg-1.8.4+1.21.1-neoforge" = _1iY9Zx5G;
        "pkg-1.8.4+1.21.1-fabric" = _HrZ7ZB4M;
        "pkg-1.8.5+1.21.1-fabric" = _utVRDLeX;
        "pkg-1.8.6+1.21.1-neoforge" = _pmiBHQE3;
        "pkg-1.8.6+1.21.1-fabric" = _JNRnWQMK;
        "pkg-1.8.7+1.21.1-fabric" = _EsEP8nu9;
        "pkg-1.8.7+1.21.1-neoforge" = _tgukEFpI;
        "pkg-1.8.8+1.21.1-neoforge" = _CaPENnBa;
        "pkg-1.8.8+1.21.1-fabric" = _vK7QZqQA;
        "pkg-1.8.9+1.21.1-fabric" = _hNCCrhL6;
        "pkg-1.8.9+1.21.1-neoforge" = _KpPt9NmF;
        "pkg-1.8.10+1.21.1-fabric" = _n6X1yWnk;
        "pkg-1.8.10+1.21.1-neoforge" = _eUHEjwrd;
        "pkg-1.8.11+1.21.1-fabric" = _5tKMzB39;
        "pkg-1.8.11+1.21.1-neoforge" = _Kzyd0eZu;
        "pkg-1.8.12+1.21.1-neoforge" = _6HJvdTXq;
        "pkg-1.8.12+1.21.1-fabric" = _94e0S5b8;
        "pkg-1.8.13+1.21.1-fabric" = _xiWqISnp;
        "pkg-1.8.13+1.21.1-neoforge" = _97PMGj45;
        "pkg-1.8.14+1.21.1-neoforge" = _mTbe040C;
        "pkg-1.8.14+1.21.1-fabric" = _x4OH78Wk;
        "pkg-1.8.15+1.21.1-fabric" = _SSjvWGxV;
        "pkg-1.8.15+1.21.1-neoforge" = _JP2SCyQm;
        "pkg-1.8.16+1.21.1-fabric" = _tZsvBD21;
        "pkg-1.8.16+1.21.1-neoforge" = _JgEwYqGp;
        "pkg-1.8.17+1.21.1-fabric" = _ZyEfnmD6;
        "pkg-1.8.17+1.21.1-neoforge" = _IQQRo9cc;
        "pkg-1.8.18+1.21.1-fabric" = _vtemdbUD;
        "pkg-1.8.18+1.21.1-neoforge" = _Fd8sFQ0m;
        "pkg-1.8.19+1.21.1-neoforge" = _VfIvtlcE;
        "pkg-1.8.19+1.21.1-fabric" = _dxnMs2Zt;
        "pkg-1.9.0+1.21.1-fabric" = _k79Dmf8Q;
        "pkg-1.9.0+1.21.1-neoforge" = _8n6d8ua3;
        "pkg-1.9.1+1.21.1-neoforge" = _kvHsaf1U;
        "pkg-1.9.2+1.21.1-fabric" = _JodChCPQ;
        "pkg-1.9.2+1.21.1-neoforge" = _CQ2XGSee;
        "pkg-1.9.3+1.21.1-fabric" = _omOx5B1k;
        "pkg-1.9.3+1.21.1-neoforge" = _Pf8GvxVj;
        "pkg-1.9.4+1.21.1-fabric" = _JILgeskh;
        "pkg-1.9.4+1.21.1-neoforge" = _5QZ8m5uL;
        "pkg-1.9.5+1.21.1-fabric" = _Pqo1NssI;
        "pkg-1.9.5+1.21.1-neoforge" = _FNyV3joC;
        "pkg-1.9.6+1.21.1-fabric" = _IEINxrEG;
        "pkg-1.9.6+1.21.1-neoforge" = _zmgWXyao;
        "pkg-1.9.7+1.21.1-neoforge" = _iQRJDwWn;
        "pkg-1.9.7+1.21.1-fabric" = _xz1EwPmH;
        "pkg-1.9.8+1.21.1-neoforge" = _rZXWJFxX;
        "pkg-1.9.8+1.21.1-fabric" = _rAoIv0BQ;
        "pkg-1.9.9+1.21.1-neoforge" = _KW2O6JbI;
        "pkg-1.9.9+1.21.1-fabric" = _RdOwCOuc;
        "pkg-1.9.10+1.21.1-fabric" = _SSfcEHB0;
        "pkg-1.9.10+1.21.1-neoforge" = _bdAWCDOT;
        "pkg-1.9.11+1.21.1-neoforge" = _AEwq41mx;
        "pkg-1.9.12+1.21.1-neoforge" = _OfN7Pj2n;
        "pkg-1.9.12+1.21.1-fabric" = _wB7cJVdp;
        "pkg-1.9.13+1.21.1-neoforge" = _dMHl5v5g;
        "pkg-1.9.13+1.21.1-fabric" = _uwVdQY27;
        "pkg-1.9.14+1.21.1-fabric" = _O12UM0D5;
        "pkg-1.9.14+1.21.1-neoforge" = _DWDFg53Y;
        "pkg-1.9.15+1.21.1-neoforge" = _TYYv9406;
        "pkg-1.9.15+1.21.1-fabric" = _OIgGU2vT;
        "pkg-1.9.16+1.21.1-neoforge" = _sm8aXLMc;
        "pkg-1.9.16+1.21.1-fabric" = _AzuZrwDk;
        "pkg-1.10.0+1.21.1-fabric" = _o4Wlwal9;
        "pkg-1.10.0+1.21.1-neoforge" = _kmGmwA7J;
        "pkg-1.10.1+1.21.1-fabric" = _NrIHWvUh;
        "pkg-1.10.1+1.21.1-neoforge" = _tsi1GmcU;
        "pkg-1.10.2+1.21.1-fabric" = _18UIA6JI;
        "pkg-1.10.2+1.21.1-neoforge" = _jNkZJ9wR;
        "pkg-1.10.3+1.21.1-neoforge" = _pszhW2WY;
        "pkg-1.10.3+1.21.1-fabric" = _UUJDeQ8E;
        "pkg-1.10.4+1.21.1-neoforge" = _jh8npjbN;
        "pkg-1.10.5+1.21.1-fabric" = _ABbhKWKY;
        "pkg-1.10.5+1.21.1-neoforge" = _VQ29MaF4;
        "pkg-1.10.5+26.1.2-fabric" = _n8ACh9qS;
        "pkg-1.10.5+26.1.2-neoforge" = _zUf2CBom;
        "pkg-1.10.5+26.2-fabric" = _GIHnkp7Z;
        "pkg-1.10.5+26.2-neoforge" = _hP8KzYyC;
        "pkg-1.10.6+1.21.1-neoforge" = _O0t93Aau;
        "pkg-1.10.6+1.21.1-fabric" = _MAphraur;
        "pkg-1.10.5+1.20.1-forge" = _dgzQu8iO;
