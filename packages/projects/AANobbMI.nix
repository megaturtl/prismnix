...
let
    versions = (let
        ...
        _Db4rYqXN = {
            "id" = "Db4rYqXN";
            "file" = "sodium-neoforge-0.9.2-alpha.4+mc26.2.jar";
            "hash" = "sha512-m2MYk6vuivAVtXgWbfohvYT3qkXhwOKj/yt/OHBRjoCJ8eEg9Aagei5cstSw07MinlFwdr/suKx6LvijzB8cHQ==";
        };
        _a9YZH3ip = {
            "id" = "a9YZH3ip";
            "file" = "sodium-fabric-0.9.2-alpha.4+mc26.2.jar";
            "hash" = "sha512-LHpUhhbmqezJoKrrPxkr91vkJPqWXnrCSOlYU1MwzO6AWQJsw7q5/EgeCQVURtaEvAfFe8gvkfuWalLXFCvkcg==";
        };
        _5FMvNu0I = {
            "id" = "5FMvNu0I";
            "file" = "sodium-fabric-0.9.2-alpha.4+mc26.1.2.jar";
            "hash" = "sha512-8LOnrfUsy8caBKCjc5ZuM49cRZltfbmSz99R3ubhkX+rWSKXL1j4W6oPrqBua5+onCIRGfmWq4tyPJHIM5b1tQ==";
        };
        _VR1WBv3l = {
            "id" = "VR1WBv3l";
            "file" = "sodium-neoforge-0.9.2-alpha.4+mc26.1.2.jar";
            "hash" = "sha512-VMwefruSUxMebdBfK2e8EqoCiWeCqDS0WwjkzBjAcvR1ZlvkMtlZ/aLuaxtg+WCCh+JDkLXEa+vBpPWF7Ukefw==";
        };
        _QV48eyCs = {
            "id" = "QV48eyCs";
            "file" = "sodium-fabric-0.8.13-beta.2+mc1.21.1.jar";
            "hash" = "sha512-G73iscEcurpHQsMh2+/2hsmnkphIaPPjKx50TpD1o+Cypg6qryiMaPtFQZaAa3Vf599GjjVHd7j1hDYFivUSVg==";
        };
        _jfHZ5pyN = {
            "id" = "jfHZ5pyN";
            "file" = "sodium-neoforge-0.8.13-beta.2+mc1.21.1.jar";
            "hash" = "sha512-bpJzhi+zOXtavqetN6ZcPNbWvLXMBmNNK2K0mZnADayJcuRgDh1bPDk20Kksz62O1NBO0GVZV5fTweVZ8gqgjA==";
        };
        _vqUoGREs = {
            "id" = "vqUoGREs";
            "file" = "sodium-fabric-0.8.14-beta.2+mc1.21.11.jar";
            "hash" = "sha512-RDMNClGqZAq9qNhsSw1t85Dp+flvXJ1OiSMOmNpPA/KASeuXI9HS2GMtxMWZaOyeqsw8+tQc6ocGLIuRIaPBgw==";
        };
        _l42iw17I = {
            "id" = "l42iw17I";
            "file" = "sodium-neoforge-0.8.14-beta.2+mc1.21.11.jar";
            "hash" = "sha512-AA1+RMzn5KxeDW4QTuKlzbEcrv2NlF5YOVaNJMtL3s30y93RpxlbAGyHVenHudd9q2kvfEZt1/DDihE+RSlazQ==";
        };
        _SMxNOGZ6 = {
            "id" = "SMxNOGZ6";
            "file" = "sodium-fabric-0.8.13+mc1.21.1.jar";
            "hash" = "sha512-hhSjdFk2mAaagKx03ozZwo85KNFoGaDg1jILU46CP35U6L4G1epanCaL6w4CBzIJ0fgxoC3t6FFYi5cjZ2gIUw==";
        };
        _uMOpc5uV = {
            "id" = "uMOpc5uV";
            "file" = "sodium-neoforge-0.8.13+mc1.21.1.jar";
            "hash" = "sha512-T1N2lq+VQR6drxV5X7X8vEmRPUiKlvqRL6jx19tAhxCZXooUYRkPPND4IXv5416VORdlkkKO1YfKLXqoRFCjkA==";
        };
        _rkdTcxoT = {
            "id" = "rkdTcxoT";
            "file" = "sodium-fabric-0.8.14+mc1.21.11.jar";
            "hash" = "sha512-BMQ/noU0uHpSxC/9UbDjRNTvktycxS2jPROvahi/dLBTgNICfx4NuYJpjQr/J0xCdBweIbMTsM117TrwBfyY2Q==";
        };
        _sC6wj32u = {
            "id" = "sC6wj32u";
            "file" = "sodium-neoforge-0.8.14+mc1.21.11.jar";
            "hash" = "sha512-FpmHSo3z2oR1+zcjBqlIaQu3bpUiGmF8c/boHXtwtvtD7Xuej+/HXFoWB+ujOsylbu03T4qLdTqDl2cLQ1mONQ==";
        };
        _Hf1Foc0b = {
            "id" = "Hf1Foc0b";
            "file" = "sodium-neoforge-0.9.2-beta.1+mc26.1.2.jar";
            "hash" = "sha512-PE4BELw7q9IwL8nbsZLSit8+alyzomtkTVbPJ2RLufAKgvv2QPd6VKsb6Nf+2eAyRivXtfEWTdcExC5rLYS6Tw==";
        };
        _l25R3slV = {
            "id" = "l25R3slV";
            "file" = "sodium-fabric-0.9.2-beta.1+mc26.1.2.jar";
            "hash" = "sha512-5DVTtIiU0nJaS1s4wNmPGfvhSa9Msk8LTwrao/cZbna4xbibeDNczXzOE9l1QzIOQaA3odFtl0RXknUkWtXpTw==";
        };
        _A0IzDzaH = {
            "id" = "A0IzDzaH";
            "file" = "sodium-fabric-0.9.2-beta.1+mc26.2.jar";
            "hash" = "sha512-AUlVs7chk9RztEabe00LS478JO3dADelyvXB1MhdxEQyjF8bZOz2NXLZr9lqFqbidrZxcw2suFeNHZve5x8/qg==";
        };
        _gQDMcWww = {
            "id" = "gQDMcWww";
            "file" = "sodium-neoforge-0.9.2-beta.1+mc26.2.jar";
            "hash" = "sha512-9FDYPw6/M+DPYAqc97Hq01L185hC6C14fpH/NNNs4W1E66zwDyLkjrqPtsdJQ0KbppUijW9M9yBi0cqnGaymkQ==";
        };
        _xJZxADzI = {
            "id" = "xJZxADzI";
            "file" = "sodium-fabric-0.9.2+mc26.2.jar";
            "hash" = "sha512-m3p6reiCRUPOKoBP3f0E439X0fkcAFdOfch+VU6xg12IgxPub3FadZm9cphAzwH9dOAq6uh7Tlo8EMNKAW5AfA==";
        };
        _DmnNKsfS = {
            "id" = "DmnNKsfS";
            "file" = "sodium-neoforge-0.9.2+mc26.2.jar";
            "hash" = "sha512-FfuUG9WKvj5XtT65HwcPAOmlF4xxjVDLrliJhuTNg0nFou9PbITMSIcyDYXsVhqiCUIUcj9QL93TrrSTyAtcOQ==";
        };
        _zg4YQ9EL = {
            "id" = "zg4YQ9EL";
            "file" = "sodium-neoforge-0.9.2+mc26.1.2.jar";
            "hash" = "sha512-iZwtiIgxxARId5VasGtTM8bhe9ibVD1PW9DhiMrKh5Fye9GOXpxf5SzBSqbkFzuLpJBUFpFBJsSNcBNTGO8QEg==";
        };
        _tZQ3jqnf = {
            "id" = "tZQ3jqnf";
            "file" = "sodium-fabric-0.9.2+mc26.1.2.jar";
            "hash" = "sha512-mjy8gRGXn7LK2nTU3ySGf0qKdgU7KNdnlvDRyRVs/JbE99iLBwcq6o2VdNRrW8Pr87TSPAnFAfAInuN2gXQ0dQ==";
        };
        _obOyy5BN = {
            "id" = "obOyy5BN";
            "file" = "sodium-fabric-0.9.2-beta.1+mc26.3r1.jar";
            "hash" = "sha512-ExnzAFeN3tmGOmchSZE6iEugzOK0rjiISweD7lkxbQYKqGKVo+4Ivtb5Mv6VZpQca7g2JLNNGW0TG6OcOubR2w==";
        };
        _3rIu1i7C = {
            "id" = "3rIu1i7C";
            "file" = "sodium-neoforge-0.9.2-beta.2+mc26.3r1.jar";
            "hash" = "sha512-NCVJQKxfuK6pOGhqe7RcE2aSKf8qfQ8jAztmA1w7XZD8UZGdmowl0ngqns7Le6edRR+A1G/ijKA1jHO1TNTvxQ==";
        };
        _FqtXxXy2 = {
            "id" = "FqtXxXy2";
            "file" = "sodium-fabric-0.9.2-beta.2+mc26.3r1.jar";
            "hash" = "sha512-YdN5OaDyEXUrwgFfTMTWFDw0QFbGovz7B3R8pXQbVpu4tOY1CI3r5OQv7zRRAUGx0zPbkt1LpXje2/xNjimJgA==";
        };
        _bAZQdGpg = {
            "id" = "bAZQdGpg";
            "file" = "sodium-fabric-0.9.2+mc26.3.jar";
            "hash" = "sha512-8/Jg8gS4zl6Hd8LHP1N5VnVexh84F7C3i15VaOiqQPFIkfFGR1B1EJdHZlx8iKRcoMqajfPGjXnFjs2qjYxLkw==";
        };
        _VHtnT9Q4 = {
            "id" = "VHtnT9Q4";
    ...
    in {
        ...
        "pkg-mc1.17.1-0.3.1" = _80jYkEVr;
        "pkg-mc1.17.1-0.3.2" = _xuWxRZPd;
        "pkg-mc1.17.1-0.3.3" = _3JJvf9Kn;
        "pkg-mc1.18-0.4.0-alpha5" = _6YGRDUVT;
        "pkg-mc1.17.1-0.3.4" = _Fz37KqRh;
        "pkg-mc1.18.1-0.4.0-alpha6" = _5JyduDNN;
        "pkg-mc1.18.2-0.4.1" = _74Y5Z8fo;
        "pkg-mc1.19-0.4.2" = _Yp8wLY1P;
        "pkg-mc1.19.2-0.4.3" = _F79MzDJD;
        "pkg-mc1.19.2-0.4.4" = _rAfhHfow;
        "pkg-mc1.19.3-0.4.5" = _mnEhtGuH;
        "pkg-mc1.19.3-0.4.6" = _Nr39FOaS;
        "pkg-mc1.19.3-0.4.7" = _ObtU68vj;
        "pkg-mc1.19.3-0.4.8" = _oYfJQ6lR;
        "pkg-mc1.19.3-0.4.9" = _idtcaIVT;
        "pkg-mc1.19.4-0.4.10" = _b4hTi3mo;
        "pkg-mc1.20-0.4.10" = _vgceLbdH;
        "pkg-mc1.20.1-0.5.0" = _hiO9bwqc;
        "pkg-mc1.20.1-0.5.1" = _OkwCNtFH;
        "pkg-mc1.20.1-0.5.2" = _6SSPmLc9;
        "pkg-mc1.20.1-0.5.3" = _4OZL6q9h;
        "pkg-mc1.20.2-0.5.3" = _bbP1qBMr;
        "pkg-mc1.20.2-0.5.4" = _lhZYeXLf;
        "pkg-mc1.20.3-0.5.4" = _zPwAvKCF;
        "pkg-mc1.20.3-0.5.5" = _InGKdfel;
        "pkg-mc1.20.2-0.5.5" = _pmgeU5yX;
        "pkg-mc1.20.1-0.5.6" = _rUXIwGKA;
        "pkg-mc1.20.3-0.5.6" = _xNJ0Mpbx;
        "pkg-mc1.20.1-0.5.7" = _umKbm1Rp;
        "pkg-mc1.20.3-0.5.7" = _Wzzjm5lQ;
        "pkg-mc1.20.1-0.5.8" = _mhZtY2lR;
        "pkg-mc1.20.4-0.5.8" = _4GyXKCLd;
        "pkg-mc1.20.5-0.5.8" = _hLV8Q8uu;
        "pkg-mc1.20.6-0.5.8" = _IZskON6d;
        "pkg-mc1.20.6-0.5.9" = _qhg37WBD;
        "pkg-mc1.21-0.5.9" = _dNHeFokL;
        "pkg-mc1.20.1-0.5.9" = _QHGZ9XSU;
        "pkg-mc1.20.1-0.5.10" = _dEpHs0Hg;
        "pkg-mc1.20.1-0.5.11" = _ygf8cVZg;
        "pkg-mc1.20.6-0.5.11" = _OwLQelEI;
        "pkg-mc1.21-0.5.11" = _RncWhTxD;
        "pkg-mc1.21-0.6.0-beta.1-neoforge" = _rcNehRIZ;
        "pkg-mc1.21-0.6.0-beta.1-fabric" = _oZOSEhyy;
        "pkg-mc1.21-0.6.0-beta.2-neoforge" = _vO5IVg3V;
        "pkg-mc1.21-0.6.0-beta.2-fabric" = _CcIWi5Av;
        "pkg-mc1.21.2-0.6.0-beta.3-fabric" = _YWD36TtF;
        "pkg-mc1.21.2-0.6.0-beta.3-neoforge" = _yExcQU0x;
        "pkg-mc1.21.1-0.6.0-beta.4-neoforge" = _r0Cvb6jf;
        "pkg-mc1.21.1-0.6.0-beta.4-fabric" = _zJZY6GYO;
        "pkg-mc1.21.3-0.6.0-beta.4-neoforge" = _bSL0wBSW;
        "pkg-mc1.21.3-0.6.0-beta.4-fabric" = _HCEjRjK4;
        "pkg-mc1.21.3-0.6.0-beta.5-neoforge" = _frbpSbY2;
        "pkg-mc1.21.3-0.6.0-beta.5-fabric" = _hBlmTLJR;
        "pkg-mc1.21.3-0.6.0-fabric" = _SzAjFUSx;
        "pkg-mc1.21.3-0.6.0-neoforge" = _7zeY2C2J;
        "pkg-mc1.21.1-0.6.0-fabric" = _b70slbHV;
        "pkg-mc1.21.1-0.6.0-neoforge" = _Ci7BTU2N;
        "pkg-mc1.21.3-0.6.1-fabric" = _gXZfuKxx;
        "pkg-mc1.21.3-0.6.1-neoforge" = _V26EsYch;
        "pkg-mc1.21.1-0.6.1-fabric" = _r9o9ggVu;
        "pkg-mc1.21.1-0.6.1-neoforge" = _uc2dogCv;
        "pkg-mc1.21.1-0.6.2-fabric" = _6b5IXmYv;
        "pkg-mc1.21.1-0.6.2-neoforge" = _2eDS46kO;
        "pkg-mc1.21.3-0.6.2-fabric" = _xy8qdzcb;
        "pkg-mc1.21.3-0.6.2-neoforge" = _KAzyah9L;
        "pkg-mc1.21.4-0.6.2-fabric" = _joBzVWtR;
        "pkg-mc1.21.4-0.6.2-neoforge" = _fOY6Lk1h;
        "pkg-mc1.21.1-0.6.3-fabric" = _Hd6ChVqe;
        "pkg-mc1.21.1-0.6.3-neoforge" = _rS9B5M5H;
        "pkg-mc1.21.3-0.6.3-fabric" = _qufJMFlM;
        "pkg-mc1.21.3-0.6.3-neoforge" = _PoLJlR6Z;
        "pkg-mc1.21.4-0.6.3-fabric" = _iPRNybGo;
        "pkg-mc1.21.4-0.6.3-neoforge" = _cQxHrxZR;
        "pkg-mc1.21.1-0.6.5-fabric" = _EoNKHoLH;
        "pkg-mc1.21.1-0.6.5-neoforge" = _zBRij2cH;
        "pkg-mc1.21.3-0.6.5-fabric" = _dsw736d2;
        "pkg-mc1.21.3-0.6.5-neoforge" = _uk3Xx4Zv;
        "pkg-mc1.21.4-0.6.5-fabric" = _aHtQZyzN;
        "pkg-mc1.21.4-0.6.5-neoforge" = _oTFUUvpt;
        "pkg-mc1.21.4-0.6.6-fabric" = _tu8qILqH;
        "pkg-mc1.21.4-0.6.6-neoforge" = _FI3Xu3s3;
        "pkg-mc1.21.1-0.6.7-fabric" = _AxSdcDcP;
        "pkg-mc1.21.1-0.6.7-neoforge" = _XurfNSst;
        "pkg-mc1.21.3-0.6.7-fabric" = _fRVuPyyt;
        "pkg-mc1.21.3-0.6.7-neoforge" = _8HOyt4KQ;
        "pkg-mc1.21.4-0.6.7-fabric" = _IIO7jQ3j;
        "pkg-mc1.21.4-0.6.7-neoforge" = _UIdko9JY;
        "pkg-mc1.21.3-0.6.8-fabric" = _LL4puCl1;
        "pkg-mc1.21.3-0.6.8-neoforge" = _X0u6q01a;
        "pkg-mc1.21.1-0.6.9-fabric" = _26nVNc41;
        "pkg-mc1.21.1-0.6.9-neoforge" = _I9RMZOOH;
        "pkg-mc1.21.3-0.6.9-fabric" = _Hp1g50Pm;
        "pkg-mc1.21.3-0.6.9-neoforge" = _FpkDJuDz;
        "pkg-mc1.21.4-0.6.9-fabric" = _QuV9hMgB;
        "pkg-mc1.21.4-0.6.9-neoforge" = _GUEd3mz0;
        "pkg-mc1.20.1-0.5.12-beta.2-fabric" = _ryOMVRuG;
        "pkg-mc1.21.4-0.6.10-fabric" = _FRXt5xaI;
        "pkg-mc1.21.4-0.6.10-neoforge" = _mTW3oi85;
        "pkg-mc1.20.1-0.5.13-fabric" = _OihdIimA;
        "pkg-mc1.21.5-0.6.11-fabric" = _JV9BubzL;
        "pkg-mc1.21.5-0.6.11-neoforge" = _jv9JbDp8;
        "pkg-mc1.21.5-0.6.12-fabric" = _fVbw1C7i;
        "pkg-mc1.21.5-0.6.12-neoforge" = _FbKAFCUM;
        "pkg-mc1.21.1-0.6.13-fabric" = _u1OEbNKx;
        "pkg-mc1.21.1-0.6.13-neoforge" = _Pb3OXVqC;
        "pkg-mc1.21.3-0.6.13-fabric" = _rLBgU2jc;
        "pkg-mc1.21.3-0.6.13-neoforge" = _M0CXIL7c;
        "pkg-mc1.21.4-0.6.13-fabric" = _c3YkZvne;
        "pkg-mc1.21.4-0.6.13-neoforge" = _XgEfENfn;
        "pkg-mc1.21.5-0.6.13-fabric" = _DA250htH;
        "pkg-mc1.21.5-0.6.13-neoforge" = _dfyNHRhw;
        "pkg-mc1.21.6-0.6.13-fabric" = _ND4ROcMQ;
        "pkg-mc1.21.6-0.6.13-neoforge" = _ihzX2Dvy;
        "pkg-mc1.21.9-0.7.0-fabric" = _AQpu5aS1;
        "pkg-mc1.21.8-0.7.0-fabric" = _24jH02Sf;
        "pkg-mc1.21.8-0.7.0-neoforge" = _1LjoeVdt;
        "pkg-mc1.21.10-0.7.2-fabric" = _VTidoe6U;
        "pkg-mc1.21.8-0.7.2-fabric" = _pJRT8Zxt;
        "pkg-mc1.21.8-0.7.2-neoforge" = _lgWRGiHv;
        "pkg-mc1.21.10-0.7.2-neoforge" = _h30oKQW3;
        "pkg-mc1.21.8-0.7.3-fabric" = _7pwil2dy;
        "pkg-mc1.21.8-0.7.3-neoforge" = _q6wdZywr;
        "pkg-mc1.21.10-0.7.3-fabric" = _sFfidWgd;
        "pkg-mc1.21.10-0.7.3-neoforge" = _PdQpfqPZ;
        "pkg-mc1.21.11-0.8.0-fabric" = _MLXdfyIk;
        "pkg-mc1.21.11-0.8.0-neoforge" = _k5Rs4Eru;
        "pkg-mc1.21.11-0.8.1-fabric" = _2IxKzI1o;
        "pkg-mc1.21.11-0.8.1-neoforge" = _z88JSh9S;
        "pkg-mc1.21.11-0.8.2-neoforge" = _8jueyeK2;
        "pkg-mc1.21.11-0.8.2-fabric" = _59wygFUQ;
        "pkg-mc1.21.11-0.8.3-neoforge" = _W5UZgZ6L;
        "pkg-mc1.21.11-0.8.3-fabric" = _3PnHeviJ;
        "pkg-mc1.21.11-0.8.4-fabric" = _1OWNgWVR;
        "pkg-mc1.21.11-0.8.4-neoforge" = _B0QEOpLx;
        "pkg-mc1.21.11-0.8.6-fabric" = _ZPWbiWXz;
        "pkg-mc1.21.11-0.8.6-neoforge" = _ZK3jHJgK;
        "pkg-mc26.1-0.8.7-fabric" = _Amr4VcZo;
        "pkg-mc1.21.11-0.8.7-fabric" = _UddlN6L4;
        "pkg-mc1.21.11-0.8.7-neoforge" = _pXyXLdlT;
        "pkg-mc26.1.1-0.8.9-fabric" = _uGvVQBnw;
        "pkg-mc26.1.1-0.8.9-neoforge" = _Fg5Mk6Y3;
        "pkg-mc26.1.2-0.8.10-neoforge" = _qyD7aF0i;
        "pkg-mc26.1.2-0.8.10-fabric" = _SIrB5bCM;
        "pkg-mc26.1.2-0.8.11-fabric" = _ff7xUQLH;
        "pkg-mc26.1.2-0.8.11-neoforge" = _QZUUceyk;
        "pkg-mc1.21.11-0.8.11-fabric" = _CL53p97Z;
        "pkg-mc1.21.11-0.8.11-neoforge" = _aUG2WqLW;
        "pkg-mc26.1.2-0.8.12-beta.1-fabric" = _yUMbbGVC;
        "pkg-mc26.1.2-0.8.12-beta.1-neoforge" = _tLByymK0;
        "pkg-mc1.21.11-0.8.12-beta.1-fabric" = _UXLJGXZx;
        "pkg-mc1.21.11-0.8.12-beta.1-neoforge" = _IG1eAHBT;
        "pkg-mc26.1.2-0.8.12-beta.2-fabric" = _s0gEbAOZ;
        "pkg-mc26.1.2-0.8.12-beta.2-neoforge" = _TDDIPBCi;
        "pkg-mc1.21.11-0.8.12-beta.2-neoforge" = _p8rn2ZbI;
        "pkg-mc1.21.11-0.8.12-beta.2-fabric" = _hjgWF0Ll;
        "pkg-mc1.21.1-0.8.12-alpha.1-neoforge" = _N36IhsfU;
        "pkg-mc1.21.1-0.8.12-alpha.1-fabric" = _Uif0LEOw;
        "pkg-mc26.1.2-0.8.12-beta.3-fabric" = _2NVD70pK;
        "pkg-mc26.1.2-0.8.12-beta.3-neoforge" = _lTkSfJmh;
        "pkg-mc1.21.1-0.8.12-alpha.2-fabric" = _Gv1UmlKg;
        "pkg-mc1.21.1-0.8.12-alpha.2-neoforge" = _hSgrV2wa;
        "pkg-mc1.21.1-0.8.12-alpha.3-fabric" = _8kVO74iE;
        "pkg-mc1.21.11-0.8.12-beta.3-fabric" = _x0XUezGL;
        "pkg-mc1.21.11-0.8.12-beta.3-neoforge" = _XSQwpkzX;
        "pkg-mc26.1.2-0.8.12-beta.4-neoforge" = _g6p4rAa4;
        "pkg-mc26.1.2-0.8.12-beta.4-fabric" = _8l4Yx5Q1;
        "pkg-mc26.1.2-0.8.12-neoforge" = _775xoFNg;
        "pkg-mc26.1.2-0.8.12-fabric" = _eRJU33Hp;
        "pkg-mc1.21.11-0.8.12-fabric" = _NFkjnzWE;
        "pkg-mc1.21.11-0.8.12-neoforge" = _ylHOo4fY;
        "pkg-mc1.21.1-0.8.12-alpha.4-neoforge" = _tVLDCyrm;
        "pkg-mc1.21.1-0.8.12-alpha.4-fabric" = _uheoPKxU;
        "pkg-mc26.2-rc-1-0.9.0-beta.1-fabric" = _kNdUCPfo;
        "pkg-mc26.2-rc-1-0.9.0-beta.2-fabric" = _Ar8m5Oi9;
        "pkg-mc26.2r1-0.9.0-beta.3-neoforge" = _tQHKoffZ;
        "pkg-mc26.2r1-0.9.0-beta.3-fabric" = _pBzGpoaN;
        "pkg-mc1.21.1-0.8.12-beta.1-neoforge" = _iw5APcWy;
        "pkg-mc1.21.1-0.8.12-beta.1-fabric" = _s7adptIg;
        "pkg-mc1.21.11-0.8.13-beta.1-neoforge" = _9LayGURz;
        "pkg-mc1.21.11-0.8.13-beta.1-fabric" = _1Zzoi12t;
        "pkg-mc26.1.2-0.9.0-beta.1-neoforge" = _I6y5LD6f;
        "pkg-mc26.1.2-0.9.0-beta.1-fabric" = _1rha2U1D;
        "pkg-mc26.2-0.9.0-neoforge" = _5dWEDeL4;
        "pkg-mc26.2-0.9.0-fabric" = _3QgJXuSK;
        "pkg-mc26.2-0.9.1-beta.2-fabric" = _wpTNXtBM;
        "pkg-mc26.2-0.9.1-beta.2-neoforge" = _9nutuIup;
        "pkg-mc26.1.2-0.9.1-beta.2-neoforge" = _B5nxF2dz;
        "pkg-mc26.1.2-0.9.1-beta.2-fabric" = _NPVnpcnt;
        "pkg-mc1.21.11-0.8.13-beta.2-neoforge" = _CTr1wDrZ;
        "pkg-mc1.21.11-0.8.13-beta.2-fabric" = _paat5Nz2;
        "pkg-mc1.21.1-0.8.12-beta.2-neoforge" = _7XOIgnrf;
        "pkg-mc1.21.1-0.8.12-beta.2-fabric" = _JjCVwmVA;
        "pkg-mc26.2-0.9.1-beta.3-fabric" = _jvfEutyx;
        "pkg-mc26.2-0.9.1-beta.3-neoforge" = _u9zPxyVL;
        "pkg-mc26.1.2-0.9.1-beta.3-fabric" = _XH7tn3tc;
        "pkg-mc26.1.2-0.9.1-beta.3-neoforge" = _FVHjuQxV;
        "pkg-mc1.21.11-0.8.13-beta.3-neoforge" = _YHaAktjP;
        "pkg-mc1.21.11-0.8.13-beta.3-fabric" = _al82slgf;
        "pkg-mc26.1.2-0.9.1-beta.4-fabric" = _3gOEYetK;
        "pkg-mc26.1.2-0.9.1-beta.4-neoforge" = _rU20oO6s;
        "pkg-mc26.2-0.9.1-beta.4-fabric" = _HWi9uk6d;
        "pkg-mc26.2-0.9.1-beta.4-neoforge" = _dcg8zoBg;
        "pkg-mc1.21.1-0.8.12-neoforge" = _S3DUMfBo;
        "pkg-mc1.21.1-0.8.12-fabric" = _KIRFiWG4;
        "pkg-mc1.21.11-0.8.13-neoforge" = _fyQ1HOA0;
        "pkg-mc1.21.11-0.8.13-fabric" = _Ny3XyYle;
        "pkg-mc26.2-0.9.1-fabric" = _2Yom1N68;
        "pkg-mc26.2-0.9.1-neoforge" = _KHPycol7;
        "pkg-mc26.1.2-0.9.1-neoforge" = _UETw0GTI;
        "pkg-mc26.1.2-0.9.1-fabric" = _vf7UgZpC;
        "pkg-mc26.2-0.9.2-alpha.1-neoforge" = _tey73iIl;
        "pkg-mc26.2-0.9.2-alpha.1-fabric" = _UWnjjQpJ;
        "pkg-mc1.21.11-0.8.14-beta.1-fabric" = _TWu15sHW;
        "pkg-mc1.21.11-0.8.14-beta.1-neoforge" = _9TOXkS1s;
        "pkg-mc1.21.1-0.8.13-beta.1-fabric" = _lYTPBqRz;
        "pkg-mc1.21.1-0.8.13-beta.1-neoforge" = _5EEI3Guz;
        "pkg-mc26.2-0.9.2-alpha.2-neoforge" = _iwperv3m;
        "pkg-mc26.2-0.9.2-alpha.2-fabric" = _7R6RLnxd;
        "pkg-mc26.1.2-0.9.2-alpha.2-neoforge" = _yGgvfqMn;
        "pkg-mc26.1.2-0.9.2-alpha.2-fabric" = _bDYxMrp3;
        "pkg-mc26.2-0.9.2-alpha.3-neoforge" = _CAZAVb0n;
        "pkg-mc26.2-0.9.2-alpha.3-fabric" = _StFfQ110;
        "pkg-mc26.1.2-0.9.2-alpha.3-neoforge" = _YZNHS9YH;
        "pkg-mc26.1.2-0.9.2-alpha.3-fabric" = _7XdPQMOk;
        "pkg-mc26.2-0.9.2-alpha.4-neoforge" = _Db4rYqXN;
        "pkg-mc26.2-0.9.2-alpha.4-fabric" = _a9YZH3ip;
        "pkg-mc26.1.2-0.9.2-alpha.4-fabric" = _5FMvNu0I;
        "pkg-mc26.1.2-0.9.2-alpha.4-neoforge" = _VR1WBv3l;
        "pkg-mc1.21.1-0.8.13-beta.2-fabric" = _QV48eyCs;
        "pkg-mc1.21.1-0.8.13-beta.2-neoforge" = _jfHZ5pyN;
        "pkg-mc1.21.11-0.8.14-beta.2-fabric" = _vqUoGREs;
        "pkg-mc1.21.11-0.8.14-beta.2-neoforge" = _l42iw17I;
        "pkg-mc1.21.1-0.8.13-fabric" = _SMxNOGZ6;
        "pkg-mc1.21.1-0.8.13-neoforge" = _uMOpc5uV;
        "pkg-mc1.21.11-0.8.14-fabric" = _rkdTcxoT;
        "pkg-mc1.21.11-0.8.14-neoforge" = _sC6wj32u;
        "pkg-mc26.1.2-0.9.2-beta.1-neoforge" = _Hf1Foc0b;
        "pkg-mc26.1.2-0.9.2-beta.1-fabric" = _l25R3slV;
        "pkg-mc26.2-0.9.2-beta.1-fabric" = _A0IzDzaH;
        "pkg-mc26.2-0.9.2-beta.1-neoforge" = _gQDMcWww;
        "pkg-mc26.2-0.9.2-fabric" = _xJZxADzI;
        "pkg-mc26.2-0.9.2-neoforge" = _DmnNKsfS;
        "pkg-mc26.1.2-0.9.2-neoforge" = _zg4YQ9EL;
        "pkg-mc26.1.2-0.9.2-fabric" = _tZQ3jqnf;
        "pkg-mc26.3r1-0.9.2-beta.1-fabric" = _obOyy5BN;
        "pkg-mc26.3r1-0.9.2-beta.2-neoforge" = _3rIu1i7C;
