...
let
    versions = (let
        ...
        _QPUZxxLh = {
            "id" = "QPUZxxLh";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21-fabric.jar";
            "hash" = "sha512-0ZlfRdxtACl6YRQmop35WhYYRbYpnnEkkDErp4N9U4ECU6C9wf/20yx22ZWLl/ebjNtaTq1lLq5kU+T35T7hPQ==";
        };
        _2kdWv8dn = {
            "id" = "2kdWv8dn";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21-neoforge.jar";
            "hash" = "sha512-bCsRg7ee3AF8bLRzmLM4/RbUxSTQFbGZMvL7T6Y1VxAhlnM9vuuDQNEg8YsCRt69M/Zw04A7uvF0RiAb8tJElw==";
        };
        _VE0qeOv5 = {
            "id" = "VE0qeOv5";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21.1-fabric.jar";
            "hash" = "sha512-Qt9/UvEYDNOmorsL/5iPIJisopLGGOToPkF6AA2t7of3JU8GqPDtW/0RLSLqJA5iOZ7+4W5xIO+IR7flEa9s2w==";
        };
        _a6VD8riH = {
            "id" = "a6VD8riH";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21.1-neoforge.jar";
            "hash" = "sha512-bCsRg7ee3AF8bLRzmLM4/RbUxSTQFbGZMvL7T6Y1VxAhlnM9vuuDQNEg8YsCRt69M/Zw04A7uvF0RiAb8tJElw==";
        };
        _UC55mgMJ = {
            "id" = "UC55mgMJ";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21.10-fabric.jar";
            "hash" = "sha512-lP7PGEGTo3WIQI6GL9C2yYCCbhaZj7UL8jZM+59B0s2n+wr7KolacVuVIH2RNfv2UQs8C94nuEpDi5uJZVquzA==";
        };
        _qyivpsCp = {
            "id" = "qyivpsCp";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21.10-neoforge.jar";
            "hash" = "sha512-L6h6VOEcg5iRMuewky6ziHA5+T7NcwNDlnejJvYAvBKD1yQ5/9m56aSoagvQCf1SgRr78yLHknSPudEToo9/WA==";
        };
        _pv4vY3eC = {
            "id" = "pv4vY3eC";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21.11-fabric.jar";
            "hash" = "sha512-fdnbUTHMKXnYhOpqPTnrxoWOEiiQUWpM5YSrBsOmLfSp1DnMdMx7YDPJqt5ueaghf/ewPtnr2MJWywFe3IVQtA==";
        };
        _jRwDdoOB = {
            "id" = "jRwDdoOB";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21.11-neoforge.jar";
            "hash" = "sha512-HdUmRBWYVgtynwc9WUzvZf8bYyGMzS+fHVNAxKRFw4mpOaK1M5JEWR9zICrKxAk7gFha9urr7k2GOEiYxYB47Q==";
        };
        _KXStfocz = {
            "id" = "KXStfocz";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21.2-fabric.jar";
            "hash" = "sha512-Zi4chm+gE4MYvZqpzHAkOCz5tU/IyvKbWHxD516Dle1t3oxHmXjlEip7cchAGUErmAfQ6pqOHub79rx2RyrRCQ==";
        };
        _p2e9lFVt = {
            "id" = "p2e9lFVt";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21.2-neoforge.jar";
            "hash" = "sha512-3eo7g4/amMwhP8l31APHSwB7uCNA+z/dLLHhlQhTFUdxlz5OiqafBO+LQRx+T0PeNLvQas6ilf1GPkfSbv+y8w==";
        };
        _RD2C2ou3 = {
            "id" = "RD2C2ou3";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21.3-fabric.jar";
            "hash" = "sha512-OfYteqT1dkDRJVN6IPVyvpAayjymRLvOM7L7Y8B01/b1vTR6IlWFKm533Fnc96CQV6jXrIIjBBz6yet7OaKFaA==";
        };
        _pUJ5FwgT = {
            "id" = "pUJ5FwgT";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21.3-neoforge.jar";
            "hash" = "sha512-3eo7g4/amMwhP8l31APHSwB7uCNA+z/dLLHhlQhTFUdxlz5OiqafBO+LQRx+T0PeNLvQas6ilf1GPkfSbv+y8w==";
        };
        _IXjau24n = {
            "id" = "IXjau24n";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21.4-fabric.jar";
            "hash" = "sha512-2hF8knZjAjTA5ihmU2REElqqZcHIiGU54tEr131SyETkiKsHN+VRvMGxUZQmS99z7qksHl5ZPRjclUJfKi01zg==";
        };
        _T9bVoupC = {
            "id" = "T9bVoupC";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21.4-neoforge.jar";
            "hash" = "sha512-3eo7g4/amMwhP8l31APHSwB7uCNA+z/dLLHhlQhTFUdxlz5OiqafBO+LQRx+T0PeNLvQas6ilf1GPkfSbv+y8w==";
        };
        _Y9x9aGSr = {
            "id" = "Y9x9aGSr";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21.5-fabric.jar";
            "hash" = "sha512-vZSbyOaEeOf7AStE3hHcxFvdWfqOo0P6SYyGwtVx+7Y+qTcMVBFqkDDcHC7/OF9UESIUyroX/aSi6/6PAw0GBA==";
        };
        _bBatHaxy = {
            "id" = "bBatHaxy";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21.5-neoforge.jar";
            "hash" = "sha512-L6h6VOEcg5iRMuewky6ziHA5+T7NcwNDlnejJvYAvBKD1yQ5/9m56aSoagvQCf1SgRr78yLHknSPudEToo9/WA==";
        };
        _laGVEBdk = {
            "id" = "laGVEBdk";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21.6-fabric.jar";
            "hash" = "sha512-1AeampzveBAcLKJrfJ4JlDM/HK6PwfTw2ih0/w+bj1bOFLowgqqkzK9qrTglVao6KNI2ebne3iWvalO9/Zy5Nw==";
        };
        _vEZBWTkJ = {
            "id" = "vEZBWTkJ";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21.6-neoforge.jar";
            "hash" = "sha512-L6h6VOEcg5iRMuewky6ziHA5+T7NcwNDlnejJvYAvBKD1yQ5/9m56aSoagvQCf1SgRr78yLHknSPudEToo9/WA==";
        };
        _gapk08a0 = {
            "id" = "gapk08a0";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21.7-fabric.jar";
            "hash" = "sha512-vPouiL1Up2oo7dXCO8oGIdE1KZwi2jJ/GBBs5V8JUaS2WcHYDzWryTOSXo6l6mpy4A0CxhYkUa08Rb19ZESOvQ==";
        };
        _Mit2bNCH = {
            "id" = "Mit2bNCH";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21.7-neoforge.jar";
            "hash" = "sha512-L6h6VOEcg5iRMuewky6ziHA5+T7NcwNDlnejJvYAvBKD1yQ5/9m56aSoagvQCf1SgRr78yLHknSPudEToo9/WA==";
        };
        _ROIJjgXo = {
            "id" = "ROIJjgXo";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21.8-fabric.jar";
            "hash" = "sha512-TpGqg2k94HQn5cMt6VyyFBTnA9evwx8JYQUzHe+DJ5bR35hoadDfL23noMUH5RpvHQ1V+uhwQeCVZnjjzE8suQ==";
        };
        _k7BOA94o = {
            "id" = "k7BOA94o";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21.8-neoforge.jar";
            "hash" = "sha512-L6h6VOEcg5iRMuewky6ziHA5+T7NcwNDlnejJvYAvBKD1yQ5/9m56aSoagvQCf1SgRr78yLHknSPudEToo9/WA==";
        };
        _IQAtJgux = {
            "id" = "IQAtJgux";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21.9-fabric.jar";
            "hash" = "sha512-lD1hGFiYhVqwXnA6Vn+haTFBFHrMNvY8Tkx6uEF3/sVf6pn73NMSvArYu4nFwtusf/kPe9poMmvel5ApCERNOg==";
        };
        _uaq8lKT8 = {
            "id" = "uaq8lKT8";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc1.21.9-neoforge.jar";
            "hash" = "sha512-L6h6VOEcg5iRMuewky6ziHA5+T7NcwNDlnejJvYAvBKD1yQ5/9m56aSoagvQCf1SgRr78yLHknSPudEToo9/WA==";
        };
        _EQIb0q6D = {
            "id" = "EQIb0q6D";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc26.1-fabric.jar";
            "hash" = "sha512-u9oupG+xJmHV1Vmo+k0GwS4N+dhTa9WDW4Ybaf3hcPqleetPOceRVXFVSLc9fJPatQEtgb1G2OOB0IoBKkQAfQ==";
        };
        _6chJyPSx = {
            "id" = "6chJyPSx";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc26.1-neoforge.jar";
            "hash" = "sha512-5sHOZl4hHbWOM4GcCyUKeRWsYyqTbrFHkpwXN1aNtCddrd28G3EUXEYuXW4bNhDvvp4kyhOZZ5ftG55S4rXqyw==";
        };
        _HKLyqKhp = {
            "id" = "HKLyqKhp";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc26.1.1-fabric.jar";
            "hash" = "sha512-p754umBVAFWw0BuyMTiijTZmJqOMWpV21sDxfFnj7ffCEP7mxPi8fHogSg3GtisegUBoeumzHcRvrR0ZC+NyKQ==";
        };
        _PPEEhkUi = {
            "id" = "PPEEhkUi";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc26.1.1-neoforge.jar";
            "hash" = "sha512-5sHOZl4hHbWOM4GcCyUKeRWsYyqTbrFHkpwXN1aNtCddrd28G3EUXEYuXW4bNhDvvp4kyhOZZ5ftG55S4rXqyw==";
        };
        _HJXBl7VK = {
            "id" = "HJXBl7VK";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc26.1.2-fabric.jar";
            "hash" = "sha512-C9eAWWLg//gbVfeHgJYbV2lekoDXDLHz0yWgeHzY10Cb9UwGhB+vBL51O3eJkg4BnmwA+PgLjCRUbY1Uq2vZLQ==";
        };
        _aik9F8IY = {
            "id" = "aik9F8IY";
            "file" = "SimpleOrbitalStrike-v1.0.8-mc26.1.2-neoforge.jar";
            "hash" = "sha512-5sHOZl4hHbWOM4GcCyUKeRWsYyqTbrFHkpwXN1aNtCddrd28G3EUXEYuXW4bNhDvvp4kyhOZZ5ftG55S4rXqyw==";
        };
        _2RX6vNHy = {
            "id" = "2RX6vNHy";
    ...
    in {
        ...
        "fabric-1.21.3" = _RD2C2ou3;
        "fabric-1.21.4" = _IXjau24n;
        "fabric-1.21.5" = _Y9x9aGSr;
        "fabric-1.21.6" = _laGVEBdk;
        "fabric-1.21.7" = _gapk08a0;
        "fabric-1.21.8" = _ROIJjgXo;
        "fabric-1.21.9" = _IQAtJgux;
        "fabric-1.21.10" = _UC55mgMJ;
        "fabric-1.21.11" = _pv4vY3eC;
        "fabric-26.1" = _EQIb0q6D;
        ...
        "neoforge-1.21" = _2kdWv8dn;
        "neoforge-1.21.1" = _a6VD8riH;
        "neoforge-1.21.2" = _p2e9lFVt;
        "neoforge-1.21.3" = _pUJ5FwgT;
        "neoforge-1.21.4" = _T9bVoupC;
        "neoforge-1.21.5" = _bBatHaxy;
        "neoforge-1.21.6" = _vEZBWTkJ;
        "neoforge-1.21.7" = _Mit2bNCH;
        "neoforge-1.21.8" = _k7BOA94o;
        "neoforge-1.21.9" = _uaq8lKT8;
        "neoforge-1.21.10" = _qyivpsCp;
        "neoforge-1.21.11" = _jRwDdoOB;
        ...
        "pkg-1.21.3-v1.0.0+fabric" = _Ztxuae3w;
        "pkg-1.21.4-v1.0.0+fabric" = _As74fcoE;
        "pkg-1.21.5-v1.0.0+fabric" = _QrR4MzoQ;
        "pkg-1.21.6-v1.0.0+fabric" = _uHra9iJ6;
        "pkg-1.21.7-v1.0.0+fabric" = _W58FRujd;
        "pkg-1.21.8-v1.0.0+fabric" = _mKcTcGGS;
        "pkg-1.21.9-v1.0.0+fabric" = _j91mIMkS;
        "pkg-1.21.10-v1.0.0+fabric" = _7LH8C6Hz;
        "pkg-1.21.11-v1.0.0+fabric" = _j5hGTOSo;
        "pkg-26.1-v1.0.0+fabric" = _g2OO0aSH;
        "pkg-26.1.1-v1.0.0+fabric" = _gR4LDKW0;
        "pkg-26.1.2-v1.0.0+fabric" = _NTvIWmUx;
        "pkg-1.21-v1.0.1+fabric" = _P9RwvSZD;
        "pkg-1.21.1-v1.0.1+fabric" = _hxWOiGPi;
        "pkg-1.21.2-v1.0.1+fabric" = _ZFWgtN98;
        "pkg-1.21.3-v1.0.1+fabric" = _hyFF0wTR;
        "pkg-1.21.4-v1.0.1+fabric" = _zJ7rPsET;
        "pkg-1.21.5-v1.0.1+fabric" = _4FuwGKml;
        "pkg-1.21.6-v1.0.1+fabric" = _NQduIGTq;
        "pkg-1.21.7-v1.0.1+fabric" = _eOVzlBjX;
        "pkg-1.21.8-v1.0.1+fabric" = _HSs2svgP;
        "pkg-26.1-v1.0.1+fabric" = _M84j6HWW;
        "pkg-26.1.1-v1.0.1+fabric" = _j2vIRu1J;
        "pkg-26.1.2-v1.0.1+fabric" = _nriSBHue;
        "pkg-1.21.9-v1.0.1+fabric" = _AtI3QBCh;
        "pkg-1.21.10-v1.0.1+fabric" = _vJlqacOa;
        "pkg-1.21.11-v1.0.1+fabric" = _uqmKSUw9;
        "pkg-1.21-v1.0.1+neoforge" = _s9QtrZAT;
        "pkg-1.21.1-v1.0.1+neoforge" = _G7wrP3wQ;
        "pkg-1.21.2-v1.0.1+neoforge" = _Ej5uJb1Q;
        "pkg-1.21.3-v1.0.1+neoforge" = _iG6HNYSo;
        "pkg-1.21.4-v1.0.1+neoforge" = _a0Kd1o8J;
        "pkg-1.21.5-v1.0.1+neoforge" = _5zzWNQmI;
        "pkg-1.21.6-v1.0.1+neoforge" = _MZVel79u;
        "pkg-1.21.7-v1.0.1+neoforge" = _dkcCCsrM;
        "pkg-1.21.8-v1.0.1+neoforge" = _QhCPg1oj;
        "pkg-1.21.9-v1.0.1+neoforge" = _mJjyJkYl;
        "pkg-1.21.10-v1.0.1+neoforge" = _RFt0UVCE;
        "pkg-1.21.11-v1.0.1+neoforge" = _oRp3hN62;
        "pkg-26.1-v1.0.1+neoforge" = _6YaRTseM;
        "pkg-26.1.1-v1.0.1+neoforge" = _G8xCnsRg;
        "pkg-26.1.2-v1.0.1+neoforge" = _mYaDCnr4;
        "pkg-1.0.2+neoforge-mc1.21" = _IvlMqPys;
        "pkg-1.0.2+neoforge-mc1.21.1" = _N8CyGijv;
        "pkg-1.0.2+neoforge-mc1.21.2" = _m74ic6wV;
        "pkg-1.0.2+neoforge-mc1.21.3" = _JeGWkUzR;
        "pkg-1.0.2+neoforge-mc1.21.4" = _EMZ7Sl9W;
        "pkg-1.0.2+neoforge-mc1.21.5" = _HQ76Jv6a;
        "pkg-1.0.2+neoforge-mc1.21.6" = _cXz5zpGm;
        "pkg-1.0.2+neoforge-mc1.21.7" = _Lo4FUBJk;
        "pkg-1.0.2+neoforge-mc1.21.8" = _NURAG9jT;
        "pkg-1.0.2+neoforge-mc1.21.9" = _EGcOCLoJ;
        "pkg-1.0.2+neoforge-mc1.21.10" = _3Syb9EDn;
        "pkg-1.0.2+neoforge-mc1.21.11" = _3ZfkPbpk;
        "pkg-1.0.2+neoforge-mc26.1" = _ZIC9DnZ7;
        "pkg-1.0.2+neoforge-mc26.1.1" = _g4kx8knC;
        "pkg-1.0.2+neoforge-mc26.1.2" = _mwQjh5wv;
        "pkg-1.0.2+fabric-mc1.21" = _Jo1DaCaD;
        "pkg-1.0.2+fabric-mc1.21.1" = _3tROT33h;
        "pkg-1.0.2+fabric-mc1.21.2" = _unQkA6pN;
        "pkg-1.0.2+fabric-mc1.21.3" = _4kk2ALH9;
        "pkg-1.0.2+fabric-mc1.21.4" = _BVgAdTeF;
        "pkg-1.0.2+fabric-mc1.21.5" = _epVf4I5c;
        "pkg-1.0.2+fabric-mc1.21.6" = _MsQnFQQD;
        "pkg-1.0.2+fabric-mc1.21.7" = _d6eePq9M;
        "pkg-1.0.2+fabric-mc1.21.8" = _aL17diLU;
        "pkg-1.0.2+fabric-mc1.21.9" = _KuuuOraa;
        "pkg-1.0.2+fabric-mc1.21.10" = _labzQfIa;
        "pkg-1.0.2+fabric-mc1.21.11" = _An0k13T1;
        "pkg-1.0.2+fabric-mc26.1" = _M5xHiZES;
        "pkg-1.0.2+fabric-mc26.1.1" = _zsZWM05s;
        "pkg-1.0.2+fabric-mc26.1.2" = _Xm9VnzZr;
        "pkg-1.0.3+fabric-mc1.21" = _jEFZuMIj;
        "pkg-1.0.3+fabric-mc1.21.1" = _p44SB710;
        "pkg-1.0.3+fabric-mc1.21.2" = _WvN1igUQ;
        "pkg-1.0.3+fabric-mc1.21.3" = _yzLYehGQ;
        "pkg-1.0.3+fabric-mc1.21.4" = _IJ0rbQPL;
        "pkg-1.0.3+fabric-mc1.21.5" = _qCQooYH7;
        "pkg-1.0.3+fabric-mc1.21.6" = _Bz4ReXU8;
        "pkg-1.0.3+fabric-mc1.21.7" = _xv31Z8k8;
        "pkg-1.0.3+fabric-mc1.21.8" = _8umXrjA1;
        "pkg-1.0.3+fabric-mc1.21.9" = _ikLTCb7F;
        "pkg-1.0.3+fabric-mc1.21.10" = _jsqo2UuK;
        "pkg-1.0.3+fabric-mc1.21.11" = _mNlnPWU9;
        "pkg-1.0.3+fabric-mc26.1" = _IPgnsNob;
        "pkg-1.0.3+fabric-mc26.1.1" = _8Af28OZf;
        "pkg-1.0.3+fabric-mc26.1.2" = _DHyWrzc3;
        "pkg-1.0.3+neoforge-mc1.21" = _k1HlfUps;
        "pkg-1.0.3+neoforge-mc1.21.1" = _RkILn1AR;
        "pkg-1.0.3+neoforge-mc1.21.2" = _UNOSa5xt;
        "pkg-1.0.3+neoforge-mc1.21.3" = _hFidmOJQ;
        "pkg-1.0.3+neoforge-mc1.21.4" = _Ann6RoU3;
        "pkg-1.0.3+neoforge-mc1.21.5" = _wO8U0twO;
        "pkg-1.0.3+neoforge-mc1.21.6" = _ELwFS8cS;
        "pkg-1.0.3+neoforge-mc1.21.7" = _ocw5OUuw;
        "pkg-1.0.3+neoforge-mc1.21.8" = _TGQuLQVr;
        "pkg-1.0.3+neoforge-mc1.21.9" = _I3iO8t0e;
        "pkg-1.0.3+neoforge-mc1.21.10" = _2kpevgMA;
        "pkg-1.0.3+neoforge-mc1.21.11" = _Z9a3UML5;
        "pkg-1.0.3+neoforge-mc26.1" = _wWQLWnim;
        "pkg-1.0.3+neoforge-mc26.1.1" = _Ig8G14sR;
        "pkg-1.0.3+neoforge-mc26.1.2" = _BPcGWGOI;
        "pkg-v1.0.4+neoforge-mc1.21.5" = _4giGub2e;
        "pkg-v1.0.4+fabric-mc1.21.5" = _Ka4ZcU3F;
        "pkg-v1.0.4+neoforge-mc1.21" = _N6syGL6I;
        "pkg-v1.0.4+neoforge-mc1.21.1" = _8vDeIexd;
        "pkg-v1.0.4+neoforge-mc1.21.2" = _NfMvjeAO;
        "pkg-v1.0.4+neoforge-mc1.21.3" = _Ho5tDRAf;
        "pkg-v1.0.4+neoforge-mc1.21.4" = _zDz2JCW9;
        "pkg-v1.0.4+neoforge-mc1.21.6" = _x12yQuMW;
        "pkg-v1.0.4+neoforge-mc1.21.7" = _LDN8Flmz;
        "pkg-v1.0.4+neoforge-mc1.21.8" = _SbCMMJx8;
        "pkg-v1.0.4+neoforge-mc1.21.9" = _ZTm0LOff;
        "pkg-v1.0.4+neoforge-mc1.21.10" = _DBgjU4ho;
        "pkg-v1.0.4+neoforge-mc1.21.11" = _4JKt0vTv;
        "pkg-v1.0.4+neoforge-mc26.1.1" = _gjK4s6Vi;
        "pkg-v1.0.4+neoforge-mc26.1.2" = _KKbw6S7V;
        "pkg-v1.0.4+fabric-mc1.21" = _yWCp1YSX;
        "pkg-v1.0.4+fabric-mc1.21.1" = _De2PO45D;
        "pkg-v1.0.4+fabric-mc1.21.2" = _39nYksV6;
        "pkg-v1.0.4+fabric-mc1.21.3" = _76u1YfyA;
        "pkg-v1.0.4+fabric-mc1.21.4" = _83YR0Kwb;
        "pkg-v1.0.4+fabric-mc1.21.6" = _zHndiVtc;
        "pkg-v1.0.4+fabric-mc1.21.7" = _foYpk12S;
        "pkg-v1.0.4+fabric-mc1.21.8" = _9NhwgOSr;
        "pkg-v1.0.4+fabric-mc1.21.9" = _UaLPoh24;
        "pkg-v1.0.4+fabric-mc1.21.10" = _jcFY53EE;
        "pkg-v1.0.4+fabric-mc1.21.11" = _7u7e0jBK;
        "pkg-v1.0.4+fabric-mc26.1" = _uKBxC7j4;
        "pkg-v1.0.4+fabric-mc26.1.1" = _OrJeIyBM;
        "pkg-v1.0.4+fabric-mc26.1.2" = _a3FSgoiv;
        "pkg-v1.0.4+neoforge-mc26.1" = _k0FIlKwg;
        "pkg-v1.0.5+neoforge-mc1.21" = _lYrpkXtN;
        "pkg-v1.0.5+neoforge-mc1.21.1" = _lr1Xavun;
        "pkg-v1.0.5+neoforge-mc1.21.2" = _80wyU49f;
        "pkg-v1.0.5+neoforge-mc1.21.3" = _93TJj1ac;
        "pkg-v1.0.5+neoforge-mc1.21.4" = _VR4NaOMq;
        "pkg-v1.0.5+neoforge-mc1.21.5" = _LEgJq1XZ;
        "pkg-v1.0.5+neoforge-mc1.21.6" = _90uFdVJ8;
        "pkg-v1.0.5+neoforge-mc1.21.7" = _VCF4ejub;
        "pkg-v1.0.5+neoforge-mc1.21.8" = _zmOicH1C;
        "pkg-v1.0.5+neoforge-mc1.21.9" = _SRRTHUeL;
        "pkg-v1.0.5+neoforge-mc1.21.10" = _tetM7vvj;
        "pkg-v1.0.5+neoforge-mc1.21.11" = _ss8WyOSv;
        "pkg-v1.0.5+neoforge-mc26.1" = _nbSdaQFQ;
        "pkg-v1.0.5+neoforge-mc26.1.1" = _cqAlswed;
        "pkg-v1.0.5+neoforge-mc26.1.2" = _1yfHifQc;
        "pkg-v1.0.5+fabric-mc1.21" = _OzPd0GqP;
        "pkg-v1.0.5+fabric-mc1.21.1" = _bN5Ee5xI;
        "pkg-v1.0.5+fabric-mc1.21.2" = _e5XlIJni;
        "pkg-v1.0.5+fabric-mc1.21.3" = _wt2VwWZd;
        "pkg-v1.0.5+fabric-mc1.21.4" = _j45raYDp;
        "pkg-v1.0.5+fabric-mc1.21.5" = _3epNknKt;
        "pkg-v1.0.5+fabric-mc1.21.6" = _DEEt6F6u;
        "pkg-v1.0.5+fabric-mc1.21.7" = _lkQMI5Zp;
        "pkg-v1.0.5+fabric-mc1.21.8" = _Tb7b3n9P;
        "pkg-v1.0.5+fabric-mc1.21.9" = _9enmAQAM;
        "pkg-v1.0.5+fabric-mc1.21.10" = _JnCVBdU5;
        "pkg-v1.0.5+fabric-mc1.21.11" = _48BgJxs4;
        "pkg-v1.0.5+fabric-mc26.1" = _3fP4NK4p;
        "pkg-v1.0.5+fabric-mc26.1.1" = _xvKVdlrt;
        "pkg-v1.0.5+fabric-mc26.1.2" = _xFHti2d0;
        "pkg-v1.0.6+neoforge-mc1.21" = _QVgEnYH2;
        "pkg-v1.0.6+neoforge-mc1.21.1" = _Kd99SDJd;
        "pkg-v1.0.6+neoforge-mc1.21.2" = _7S40Iq4l;
        "pkg-v1.0.6+neoforge-mc1.21.3" = _8hx5zyjN;
        "pkg-v1.0.6+neoforge-mc1.21.4" = _W5MQnXax;
        "pkg-v1.0.6+neoforge-mc1.21.5" = _cW04OHFo;
        "pkg-v1.0.6+neoforge-mc1.21.6" = _Tow0HtwU;
        "pkg-v1.0.6+neoforge-mc1.21.7" = _6A6NKCWr;
        "pkg-v1.0.6+neoforge-mc1.21.8" = _LbyvAAb2;
        "pkg-v1.0.6+neoforge-mc1.21.9" = _cifwLksU;
        "pkg-v1.0.6+neoforge-mc1.21.10" = _C87xxNn8;
        "pkg-v1.0.6+neoforge-mc1.21.11" = _g2PzKnoE;
        "pkg-v1.0.6+neoforge-mc26.1" = _Pn8jB0vy;
        "pkg-v1.0.6+neoforge-mc26.1.1" = _sO3FarMA;
        "pkg-v1.0.6+neoforge-mc26.1.2" = _zfZX2nQd;
        "pkg-v1.0.6+fabric-mc1.21" = _6oPYQNkJ;
        "pkg-v1.0.6+fabric-mc1.21.1" = _8ihFJs1l;
        "pkg-v1.0.6+fabric-mc1.21.2" = _3Z4CVjQ2;
        "pkg-v1.0.6+fabric-mc1.21.3" = _7razdgcM;
        "pkg-v1.0.6+fabric-mc1.21.4" = _3QbynIxg;
        "pkg-v1.0.6+fabric-mc1.21.5" = _ebvgfqWQ;
        "pkg-v1.0.6+fabric-mc1.21.6" = _LxE3Pdg1;
        "pkg-v1.0.6+fabric-mc1.21.7" = _UL5fzRAa;
        "pkg-v1.0.6+fabric-mc1.21.8" = _zWfHhC5M;
        "pkg-v1.0.6+fabric-mc1.21.9" = _dxKCETYh;
        "pkg-v1.0.6+fabric-mc1.21.10" = _XmfIIB1y;
        "pkg-v1.0.6+fabric-mc1.21.11" = _sCVViY0U;
        "pkg-v1.0.6+fabric-mc26.1" = _XVNsjFyu;
        "pkg-v1.0.6+fabric-mc26.1.1" = _J4UPoHAj;
        "pkg-v1.0.6+fabric-mc26.1.2" = _9jQoGLQZ;
        "pkg-v1.0.7+neoforge-mc1.21" = _aTWwaYMA;
        "pkg-v1.0.7+neoforge-mc1.21.1" = _VcwWvE4e;
        "pkg-v1.0.7+neoforge-mc1.21.2" = _l0yEnzL8;
        "pkg-v1.0.7+neoforge-mc1.21.3" = _Nj7bgD41;
        "pkg-v1.0.7+neoforge-mc1.21.4" = _UD9qLwGM;
        "pkg-v1.0.7+neoforge-mc1.21.5" = _zcx06vW9;
        "pkg-v1.0.7+neoforge-mc1.21.6" = _LdlBDIiO;
        "pkg-v1.0.7+neoforge-mc1.21.7" = _kSzD34Cd;
        "pkg-v1.0.7+neoforge-mc1.21.8" = _3DluNyvf;
        "pkg-v1.0.7+neoforge-mc1.21.9" = _oPsrkRla;
        "pkg-v1.0.7+neoforge-mc1.21.10" = _EeHttpKm;
        "pkg-v1.0.7+neoforge-mc1.21.11" = _YWb36GdP;
        "pkg-v1.0.7+neoforge-mc26.1" = _nVgJfWCz;
        "pkg-v1.0.7+neoforge-mc26.1.1" = _2JIn0gFr;
        "pkg-v1.0.7+neoforge-mc26.1.2" = _qanXZVLT;
        "pkg-v1.0.7+fabric-mc1.21" = _HwUvh1Xr;
        "pkg-v1.0.7+fabric-mc1.21.1" = _r1rtVIOo;
        "pkg-v1.0.7+fabric-mc1.21.2" = _9t6K4HQF;
        "pkg-v1.0.7+fabric-mc1.21.3" = _rWsOSTyj;
        "pkg-v1.0.7+fabric-mc1.21.4" = _tUeybjLG;
        "pkg-v1.0.7+fabric-mc1.21.5" = _iNIPuFmj;
        "pkg-v1.0.7+fabric-mc1.21.6" = _8Z1Z53JX;
        "pkg-v1.0.7+fabric-mc1.21.7" = _pDsEPrm4;
        "pkg-v1.0.7+fabric-mc1.21.8" = _kAWx1ZDK;
        "pkg-v1.0.7+fabric-mc1.21.9" = _ZnQIaEVd;
        "pkg-v1.0.7+fabric-mc1.21.10" = _ddwpegpY;
        "pkg-v1.0.7+fabric-mc1.21.11" = _RweX09ws;
        "pkg-v1.0.7+fabric-mc26.1" = _gzbSUJ1E;
        "pkg-v1.0.7+fabric-mc26.1.1" = _P8Alx9j6;
        "pkg-v1.0.7+fabric-mc26.1.2" = _JEXuKWVo;
        "pkg-v1.0.7+fabric-mc26.2" = _lSrqB65u;
        "pkg-1.0.8+fabric-1.21" = _QPUZxxLh;
        "pkg-1.0.8+neoforge-1.21" = _2kdWv8dn;
        "pkg-1.0.8+fabric-1.21.1" = _VE0qeOv5;
        "pkg-1.0.8+neoforge-1.21.1" = _a6VD8riH;
        "pkg-1.0.8+fabric-1.21.10" = _UC55mgMJ;
        "pkg-1.0.8+neoforge-1.21.10" = _qyivpsCp;
        "pkg-1.0.8+fabric-1.21.11" = _pv4vY3eC;
        "pkg-1.0.8+neoforge-1.21.11" = _jRwDdoOB;
        "pkg-1.0.8+fabric-1.21.2" = _KXStfocz;
        "pkg-1.0.8+neoforge-1.21.2" = _p2e9lFVt;
        "pkg-1.0.8+fabric-1.21.3" = _RD2C2ou3;
        "pkg-1.0.8+neoforge-1.21.3" = _pUJ5FwgT;
        "pkg-1.0.8+fabric-1.21.4" = _IXjau24n;
        "pkg-1.0.8+neoforge-1.21.4" = _T9bVoupC;
        "pkg-1.0.8+fabric-1.21.5" = _Y9x9aGSr;
        "pkg-1.0.8+neoforge-1.21.5" = _bBatHaxy;
        "pkg-1.0.8+fabric-1.21.6" = _laGVEBdk;
        "pkg-1.0.8+neoforge-1.21.6" = _vEZBWTkJ;
        "pkg-1.0.8+fabric-1.21.7" = _gapk08a0;
        "pkg-1.0.8+neoforge-1.21.7" = _Mit2bNCH;
        "pkg-1.0.8+fabric-1.21.8" = _ROIJjgXo;
        "pkg-1.0.8+neoforge-1.21.8" = _k7BOA94o;
        "pkg-1.0.8+fabric-1.21.9" = _IQAtJgux;
        "pkg-1.0.8+neoforge-1.21.9" = _uaq8lKT8;
        "pkg-1.0.8+fabric-26.1" = _EQIb0q6D;
        "pkg-1.0.8+neoforge-26.1" = _6chJyPSx;
        "pkg-1.0.8+fabric-26.1.1" = _HKLyqKhp;
        "pkg-1.0.8+neoforge-26.1.1" = _PPEEhkUi;
