...
let
    ...
    in {
        ...
        "pkg-forge-1.19-1.0.5" = _Vki7H9k4;
        "pkg-forge-1.19-1.0.6" = _9FyJYfi5;
        "pkg-forge-1.19.1-1.0.0" = _yBpL5DFm;
        "pkg-forge-1.19.2-1.0.0" = _PlIEGArT;
        "pkg-forge-1.19.2-1.0.1" = _GmRx7RYo;
        "pkg-forge-1.19.3-1.0.1" = _iqVfc686;
        "pkg-forge-1.19.3-1.0.2" = _KuuaH4HG;
        "pkg-forge-1.19.3-1.0.3" = _mIyUS2r4;
        "pkg-forge-1.19.4-1.0.3" = _g7YtB0R3;
        "pkg-forge-1.20-1.0.3" = _tj8XoygV;
        "pkg-forge-1.20.1-1.0.3" = _ZqehdYMc;
        "pkg-forge-1.19.2-1.0.4" = _4XxfxIiL;
        "pkg-forge-1.19.4-1.0.4" = _dyIPd0w7;
        "pkg-forge-1.20.1-1.0.4" = _nvrYdxBf;
        "pkg-forge-1.20.1-1.0.5" = _fsgVgGym;
        "pkg-forge-1.20.2-1.0.5" = _pk0OVUzl;
        "pkg-forge-1.19.2-1.0.6" = _rXTOXTHu;
        "pkg-forge-1.19.4-1.0.6" = _cwMp3zZp;
        "pkg-forge-1.20.1-1.0.6" = _9lUvGHr0;
        "pkg-forge-1.20.2-1.0.6" = _Vn9vggXW;
        "pkg-neoforge-1.20.2-1.0.6" = _yOKCj3lh;
        "pkg-neoforge-1.20.2-1.0.7" = _wNQdU0SL;
        "pkg-neoforge-1.20.3-1.0.7" = _5YydjuMR;
        "pkg-neoforge-1.20.4-1.0.7" = _M4Jq9EKt;
        "pkg-forge-1.19.2-1.0.8" = _PIxAwURM;
        "pkg-forge-1.20.1-1.0.8" = _41diddrx;
        "pkg-neoforge-1.20.4-1.0.8" = _p321vHuC;
        "pkg-neoforge-1.20.4-1.0.9" = _LlvkB5GN;
        "pkg-neoforge-1.20.5-1.0.9" = _ZU1Qb6hM;
        "pkg-neoforge-1.20.6-1.0.9" = _e1IP0NaK;
        "pkg-neoforge-1.20.6-1.0.10" = _bNdm2aHf;
        "pkg-neoforge-1.21-1.0.10" = _V3LQrvCH;
        "pkg-neoforge-1.21-1.0.11" = _S2OHmn0m;
        "pkg-forge-1.19.2-1.0.12" = _NjpaoYiA;
        "pkg-forge-1.20.1-1.0.12" = _F1MVV1Kv;
        "pkg-neoforge-1.20.6-1.0.12" = _gMZjKzxw;
        "pkg-neoforge-1.21-1.0.12" = _xS5cZVlK;
        "pkg-neoforge-1.21-1.0.13" = _10UTxXSD;
        "pkg-neoforge-1.21.1-1.0.13" = _DrH0aJDs;
        "pkg-forge-1.19.2-1.0.14" = _pvvy7VBU;
        "pkg-forge-1.20.1-1.0.14" = _gxHVd72o;
        "pkg-neoforge-1.21.1-1.0.14" = _TlNFOe1n;
        "pkg-neoforge-1.21.1-1.0.15" = _BpZtwPzO;
        "pkg-neoforge-1.21.1-1.0.16" = _ayKuuYag;
        "pkg-neoforge-1.21.1-1.0.17" = _L6gdCoaZ;
        "pkg-neoforge-1.21.1-1.0.18" = _VeXLWAUJ;
        "pkg-neoforge-1.21.2-1.0.18" = _sW4IZ827;
        "pkg-neoforge-1.21.3-1.0.18" = _3JM9tpH9;
        "pkg-forge-1.20.1-1.0.19" = _k0HGRziM;
        "pkg-neoforge-1.21.1-1.0.19" = _x9BkSijn;
        "pkg-neoforge-1.21.3-1.0.19" = _tpJwgEt7;
        "pkg-neoforge-1.21.4-1.0.19" = _ENpCJTn7;
        "pkg-neoforge-1.21.4-1.1.0" = _kP0R8izd;
        "pkg-neoforge-1.21.5-1.1.0" = _taT109UR;
        "pkg-neoforge-1.21.5-1.1.1" = _syYw4Eba;
        "pkg-neoforge-1.21.5-1.1.2" = _ncTg403S;
        "pkg-forge-1.20.1-1.0.20" = _LgjYRUxt;
        "pkg-neoforge-1.21.1-1.0.20" = _7jcUsKq0;
        "pkg-neoforge-1.21.4-1.1.3" = _X6uk2Fsq;
        "pkg-neoforge-1.21.5-1.1.3" = _7FlMxzcM;
        "pkg-neoforge-1.21.6-1.1.3" = _noytKoxQ;
        "pkg-neoforge-1.21.6-1.1.4" = _t49UWnSE;
        "pkg-neoforge-1.21.6-1.1.5" = _lPnwgruL;
        "pkg-neoforge-1.21.6-1.1.6" = _Sx9pHksu;
        "pkg-neoforge-1.21.7-1.1.6" = _FQvN5WD8;
        "pkg-neoforge-1.21.1-1.0.21" = _Etw6aqhL;
        "pkg-neoforge-1.21.4-1.1.7" = _ogiriH1A;
        "pkg-neoforge-1.21.5-1.1.7" = _gvI7rzK7;
        "pkg-neoforge-1.21.7-1.1.7" = _YGuPt1eO;
        "pkg-neoforge-1.21.7-1.1.8" = _idmPxR6f;
        "pkg-neoforge-1.21.8-1.1.8" = _m1JBNoku;
        "pkg-neoforge-1.21.9-1.1.8" = _y53sQV5z;
        "pkg-neoforge-1.21.10-1.1.8" = _jnnN1yYa;
        "pkg-neoforge-1.21.11-1.1.8" = _WiEyxqt4;
        "pkg-neoforge-1.1.8+26.1" = _gaylE0Xa;
