...
let
    versions = (let
        ...
        _uK4HyUIE = {
            "id" = "uK4HyUIE";
            "file" = "Terrastorage-1.3.0+1.20-1.20.1.jar";
            "hash" = "sha512-nbZgHppuGA0oEEL6aVpfGtub0ARGkd6WEY20IkM56SJFt5cmGFF4kL6xmbcVRgeCpPb/afkCmufXFRTQskA6sA==";
        };
        _R42I3TPH = {
            "id" = "R42I3TPH";
            "file" = "Terrastorage-1.3.0+1.20.3-1.20.4.jar";
            "hash" = "sha512-oPLYg9svhN8ZBCyqEaYY1sqliVfoHcTOrlpy6nswwOFGk5OKRkIT4JoMMMhjKIQI8/Xh8G70CTsLrRMqbr4ChA==";
        };
        _VamRYPZf = {
            "id" = "VamRYPZf";
            "file" = "Terrastorage-1.3.0+1.21-1.21.1.jar";
            "hash" = "sha512-GZ+14zZtNin9I4stzq3yyEDdDLfIM4aZERaPej/sfwRtBknyJuw7UWCBXwYNwyLlPZLiiZYSa71ajKoCSduLDg==";
        };
        _7B7lObkm = {
            "id" = "7B7lObkm";
            "file" = "Terrastorage-1.3.0+1.21.2-1.21.3.jar";
            "hash" = "sha512-pVMtPwjMfG9i3wyyagiM31382IHGacDSubNwCZNwGogQ0ZdgT3MfZJwbumfWjeDbaVU9MbN2anTXCKl0pPofAA==";
        };
        _wcbicq4l = {
            "id" = "wcbicq4l";
            "file" = "Terrastorage-1.3.0+1.21.4.jar";
            "hash" = "sha512-lvy5rXugY+uwzxrMZwHmoHTE1bdeod4f7s0Wv6F0CYIgOHzp/z78tBWei5vF49Lqg0vZNBLSFYvkvKUznN4P1g==";
        };
        _m0Dkckga = {
            "id" = "m0Dkckga";
            "file" = "Terrastorage-1.3.0+1.21.5.jar";
            "hash" = "sha512-IF6DwyzdBkm0CpEg6D8nY9INM0nQMUotzRixL564OOEkFXxcfSV87UBMD+HkBU2OqjhHi5GROW+oSdHq2CAO9A==";
        };
        _4G7hzkKE = {
            "id" = "4G7hzkKE";
            "file" = "Terrastorage-1.3.0+1.21.6-1.21.8.jar";
            "hash" = "sha512-cJKcLqSx0n2ujc+6jPcTgBynehLOvXMYZFAnq+DmcqTBdbjIRhs7r2y/wG0JJ5KN4BkqcdI70GhLfiNzwsRbxw==";
        };
        _1MachKOh = {
            "id" = "1MachKOh";
            "file" = "Terrastorage-1.3.0+1.21.9-1.21.10.jar";
            "hash" = "sha512-KC/LfcfMFDtVIAGpgEt6vYhZWq06FLH+8a+oje3V/QndsGKitxRTkqM8AlXFoSiYSrddwyiK+gDp/x1OCyGJoQ==";
        };
        _tWZ1LSoA = {
            "id" = "tWZ1LSoA";
            "file" = "Terrastorage-1.3.0+1.21.11.jar";
            "hash" = "sha512-RwWyrGaTHeF8IIy3lUfQa4LJXln0CqKIA0O5zUuRVzLoYwN05wcUfA3/iym4jNL2SM8txj/y+LGWLQmg1l/aeg==";
        };
        _9WhRiC9v = {
            "id" = "9WhRiC9v";
            "file" = "Terrastorage-1.3.0+26.1-26.1.2.jar";
            "hash" = "sha512-ytOZLondwKfnwkR4zKmVsnMm/Jycys2jIcnI9pY6/yIZG//VqXxzZTi7tMAWAOwpLddrR/Im//l/khjBIh8hJQ==";
        };
        _F4oSn42U = {
            "id" = "F4oSn42U";
    ...
    in {
        ...
        "pkg-1.3.0+1.20-1.20.1" = _uK4HyUIE;
        "pkg-1.3.0+1.20.3-1.20.4" = _R42I3TPH;
        "pkg-1.3.0+1.21-1.21.1" = _VamRYPZf;
        "pkg-1.3.0+1.21.2-1.21.3" = _7B7lObkm;
        "pkg-1.3.0+1.21.4" = _wcbicq4l;
        "pkg-1.3.0+1.21.5" = _m0Dkckga;
        "pkg-1.3.0+1.21.6-1.21.8" = _4G7hzkKE;
        "pkg-1.3.0+1.21.9-1.21.10" = _1MachKOh;
