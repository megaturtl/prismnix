...
let
    ...
    in {
        ...
        "pkg-1.1.0+1.21.1" = _wkg2YD6k;
        "pkg-1.1.1+1.21.1" = _Mc5a75fK;
        "pkg-1.1.0+1.21.1-fabric" = _qDi4fgZ9;
        "pkg-1.1.0+1.21.1-neoforge" = _lwC4urRZ;
        "pkg-1.1.2+1.21.1-neoforge" = _ydYQowF4;
        "pkg-1.2.0+1.21.1-fabric" = _PYVymkSD;
        "pkg-1.2.0+1.21.1-neoforge" = _2NCTnMOy;
        "pkg-1.2.1+1.21.1-fabric" = _nINqvQrI;
        "pkg-1.2.1+1.21.1-neoforge" = _ELCUS0U0;
        "pkg-1.2.2+1.21.1-neoforge" = _bkPU3oXA;
        "pkg-1.2.2+1.21.1-fabric" = _kC7kwZnP;
        "pkg-1.2.3+1.21.1-fabric" = _yRVKHR3V;
        "pkg-1.2.3+1.21.1-neoforge" = _uNbcPIpc;
        "pkg-1.3.0+1.21.1-neoforge" = _zmnQodt5;
        "pkg-1.3.0+1.21.1-fabric" = _jMps6YXC;
        "pkg-1.4.0+1.21.1-fabric" = _yLOE3iID;
        "pkg-1.4.0+1.21.1-neoforge" = _IZrrilPD;
        "pkg-1.4.1+1.21.1-fabric" = _z0qMRnCC;
        "pkg-1.4.1+1.21.1-neoforge" = _J1OyhWKW;
        "pkg-1.4.2+1.21.1-neoforge" = _90DTvwA2;
        "pkg-1.4.2+1.21.1-fabric" = _CkdFCGEV;
        "pkg-1.4.3+1.21.1-neoforge" = _zMMkYGVb;
        "pkg-1.4.3+1.21.1-fabric" = _A3UsLmL3;
        "pkg-1.4.4+1.21.1-neoforge" = _wwvXxexd;
        "pkg-1.4.4+1.21.1-fabric" = _ii4257Yf;
        "pkg-1.5.0+1.21.1-neoforge" = _vX0cWxyD;
        "pkg-1.5.0+1.21.1-fabric" = _rVTEoLy4;
        "pkg-1.5.1+1.21.1-fabric" = _hsypSu3y;
        "pkg-1.5.1+1.21.1-neoforge" = _vg11Xrtz;
        "pkg-1.5.2+1.21.1-neoforge" = _1wjSilmv;
