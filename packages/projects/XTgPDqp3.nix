...
let
    versions = (let
        ...
        _RKv3a0jF = {
            "id" = "RKv3a0jF";
            "file" = "MoreApples_datapack.zip";
            "hash" = "sha512-5XNkeI+OnatxUC8pSDSBfD3ZQke5SNT+1/bvSDRnnF9Juq6Fql80aboXzzwU7MrXmN1/dOszcq9O/O+N4FWfZg==";
        };
        _5GOqqd2a = {
            "id" = "5GOqqd2a";
            "file" = "MoreApples_fabric_mod.jar";
            "hash" = "sha512-8t1DDaxWNCMlNpdgeh3fb+w7dQLooRIINT13xKbxQNJ5isgvdH0XmN94nAg7lDwSejTKiMCRrmJp6aPY+nQOdw==";
        };
        _a7mEeEc2 = {
            "id" = "a7mEeEc2";
            "file" = "MoreApples_forge_mod.jar";
            "hash" = "sha512-MdwQlXcpL8JdRMIF2QqL75rMZ2OvFmWbUsw4ZB31Rj34LwaAmhwkMhAZGouiAURVEnb9k0e4QbLEWb2aXMTxjA==";
        };
        _pTzVrUdp = {
            "id" = "pTzVrUdp";
            "file" = "MoreApples_neoforge_mod.jar";
            "hash" = "sha512-6D24CbI307RCTVDTKWrFHAWqJD6HaX4+b7oluzwgKIhqqt8oLD6FD7kdWoRekNRk+HUtcCf5ilPhULBHgZQNyQ==";
        };
        _znxbD2QT = {
            "id" = "znxbD2QT";
            "file" = "MoreApples_quilt_mod.jar";
            "hash" = "sha512-DP4Nt8M01rKOqgjJhrUv16anxVpoBsd7dogsuWtnOWrHDdHW9N4mCT6Wy2xX51W2PPHI7MrJggxw1BfMyh00sA==";
        };
    in {
        "z55jnHYn" = _z55jnHYn;
        "5a7aCwCf" = _5a7aCwCf;
        ...
        "neoforge-26.3" = _pTzVrUdp;
        "pkg-1.0.0" = _z55jnHYn;
        "pkg-1.0.0+mod" = _5a7aCwCf;
        "pkg-1.1.0" = _1IA0BZT7;
        "pkg-1.1.0+mod" = _RA8grIRt;
        "pkg-1.2.0" = _ADNohSSS;
        "pkg-1.2.0+mod" = _AwZVNDOL;
        "pkg-1.2.1" = _hwIu0vlW;
        "pkg-1.2.2" = _y372N13E;
        "pkg-1.2.2+mod" = _l2ZFoJ8o;
        "pkg-1.2.1+mod" = _whWikiId;
        "pkg-1.2.3" = _vRx7MO8Q;
        "pkg-1.2.3+mod" = _1ig6M0pV;
        "pkg-1.2.4" = _8wsyAL93;
        "pkg-1.2.4+fabric" = _HYUJFshX;
        "pkg-1.2.4+forge" = _Kf3kXeLO;
        "pkg-1.2.4+neoforge" = _74aOdBLR;
        "pkg-1.2.4+quilt" = _r8dWGgna;
        "pkg-1.3.0" = _uC6ygGb5;
        "pkg-1.3.0+fabric" = _E30MrjJT;
        "pkg-1.3.0+forge" = _JO6KZAFR;
        "pkg-1.3.0+neoforge" = _ql0tgDRI;
        "pkg-1.3.0+quilt" = _X7TmtkLP;
        "pkg-1.3.1" = _XhjFwzC8;
        "pkg-1.3.1+fabric" = _aRLfnbXO;
        "pkg-1.3.1+forge" = _VVdh8SVH;
        "pkg-1.3.1+neoforge" = _93LuedJg;
        "pkg-1.3.1+quilt" = _TXalWUX9;
        "pkg-1.3.2" = _cnoB78Bz;
        "pkg-1.3.2+fabric" = _tSzuEtrc;
        "pkg-1.3.2+forge" = _Xat53crr;
        "pkg-1.3.2+neoforge" = _2WPDfPlY;
        "pkg-1.3.2+quilt" = _vYY7gVxa;
        "pkg-1.3.3" = _s3Ge5vEY;
        "pkg-1.3.3+fabric" = _NEKPKbdQ;
        "pkg-1.3.3+forge" = _ZBjbk0PB;
        "pkg-1.3.3+neoforge" = _ptjVmogF;
        "pkg-1.3.3+quilt" = _TZym5rR0;
        "pkg-1.3.4" = _RKv3a0jF;
        "pkg-1.3.4+fabric" = _5GOqqd2a;
        "pkg-1.3.4+forge" = _a7mEeEc2;
        "pkg-1.3.4+neoforge" = _pTzVrUdp;
        "pkg-1.3.4+quilt" = _znxbD2QT;
        "default" = _znxbD2QT;
    });
