...
let
    versions = (let
        ...
        _SVQOPUWS = {
            "id" = "SVQOPUWS";
            "file" = "RandomSPaWNZ-1.7.jar";
            "hash" = "sha512-SkWbYmhv3FfAHxMmWqatBj8uc8INgLmNrdsRflV1XIk3mApUnKXG9ix9EFsj0S/Zs2D5tlOs5kRQ27gBMVvSWA==";
        };
    in {
        "RI2NiILx" = _RI2NiILx;
        "VX2NtwMV" = _VX2NtwMV;
        ...
        "bukkit-1.21" = _SVQOPUWS;
        "bukkit-1.21.1" = _SVQOPUWS;
        "bukkit-1.21.2" = _SVQOPUWS;
        "bukkit-1.21.3" = _SVQOPUWS;
        "bukkit-1.21.4" = _SVQOPUWS;
        "bukkit-1.21.5" = _SVQOPUWS;
        "bukkit-1.21.6" = _SVQOPUWS;
        "bukkit-1.21.7" = _SVQOPUWS;
        "bukkit-1.21.8" = _SVQOPUWS;
        "bukkit-1.21.9" = _SVQOPUWS;
        "bukkit-1.21.10" = _SVQOPUWS;
        "bukkit-1.21.11" = _SVQOPUWS;
        "bukkit-26.1" = _SVQOPUWS;
        "bukkit-26.1.1" = _SVQOPUWS;
        "bukkit-26.1.2" = _SVQOPUWS;
        "bukkit-26.2" = _SVQOPUWS;
        "bukkit-26.3" = _SVQOPUWS;
        ...
        "paper-1.21" = _SVQOPUWS;
        "paper-1.21.1" = _SVQOPUWS;
        "paper-1.21.2" = _SVQOPUWS;
        "paper-1.21.3" = _SVQOPUWS;
        "paper-1.21.4" = _SVQOPUWS;
        "paper-1.21.5" = _SVQOPUWS;
        "paper-1.21.6" = _SVQOPUWS;
        "paper-1.21.7" = _SVQOPUWS;
        "paper-1.21.8" = _SVQOPUWS;
        "paper-1.21.9" = _SVQOPUWS;
        "paper-1.21.10" = _SVQOPUWS;
        "paper-1.21.11" = _SVQOPUWS;
        "paper-26.1" = _SVQOPUWS;
        "paper-26.1.1" = _SVQOPUWS;
        "paper-26.1.2" = _SVQOPUWS;
        "paper-26.2" = _SVQOPUWS;
        "paper-26.3" = _SVQOPUWS;
        ...
        "spigot-1.21" = _SVQOPUWS;
        "spigot-1.21.1" = _SVQOPUWS;
        "spigot-1.21.2" = _SVQOPUWS;
        "spigot-1.21.3" = _SVQOPUWS;
        "spigot-1.21.4" = _SVQOPUWS;
        "spigot-1.21.5" = _SVQOPUWS;
        "spigot-1.21.6" = _SVQOPUWS;
        "spigot-1.21.7" = _SVQOPUWS;
        "spigot-1.21.8" = _SVQOPUWS;
        "spigot-1.21.9" = _SVQOPUWS;
        "spigot-1.21.10" = _SVQOPUWS;
        "spigot-1.21.11" = _SVQOPUWS;
        "spigot-26.1" = _SVQOPUWS;
        "spigot-26.1.1" = _SVQOPUWS;
        "spigot-26.1.2" = _SVQOPUWS;
        "spigot-26.2" = _SVQOPUWS;
        "spigot-26.3" = _SVQOPUWS;
