...
let
    versions = (let
        ...
        _jei8a7Pl = {
            "id" = "jei8a7Pl";
            "file" = "Big Globe-6.1.3-MC26.1.2.jar";
            "hash" = "sha512-0nXRreFkIM4jCGAYU2eFZQLfGxw/rLjXYi4TA6+R8ysqT4ufrO63FlaXu2Rm+xgC8hCHFsggiUo8hugZR9g36w==";
        };
        _Kb11tohL = {
            "id" = "Kb11tohL";
    ...
    in {
        ...
        "pkg-3.8.0" = _vZ1JTToj;
        "pkg-3.9.0" = _9BAuAm4g;
        "pkg-3.10.0" = _EXquX1eD;
        "pkg-3.11.0" = _ur8XCnZF;
        "pkg-3.11.1" = _mNqaBaC1;
        "pkg-3.11.2" = _rnkYXHIT;
        "pkg-3.12.0" = _hjjdOPEz;
        "pkg-4.0.0" = _WX1bE2C6;
        "pkg-4.0.1" = _HcVwxBRC;
        "pkg-4.0.2" = _uLHv7aNF;
        "pkg-4.1.0" = _lWLtbLQn;
        ...
        "pkg-4.8.4" = _HUShRnjE;
        "pkg-4.9.0" = _2QNphnld;
        "pkg-4.10.0" = _UtXASKgr;
        "pkg-4.10.1" = _MMo2jDUQ;
        "pkg-4.11.0" = _7gtnoA1Y;
        "pkg-4.11.1" = _AFFozdgf;
        "pkg-4.12.0" = _W5U2IGJ8;
        "pkg-4.12.1" = _ToirPKLH;
        "pkg-5.0.0" = _bKV5Ljyf;
        "pkg-5.0.1" = _yMumPHJP;
        "pkg-5.0.2" = _4KwdSNh5;
        "pkg-5.0.3" = _9mNtZSxN;
