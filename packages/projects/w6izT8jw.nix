...
let
    versions = (let
        ...
        _50u0bDAI = {
            "id" = "50u0bDAI";
            "file" = "[1.21.5+] Passive Aggressive v2.0.zip";
            "hash" = "sha512-biVCFnpF36U1XLG8qb6isvKw26oX5P2oC5oxSZUKXUp8xb0Fha1o7XpGZSVA8pVfIbpvt/6jSQcYrT58YmEpHw==";
        };
        _BgX8AYCg = {
            "id" = "BgX8AYCg";
            "file" = "passive-aggressive-2.0.jar";
            "hash" = "sha512-vRJp1DojVhC1awEk3zJTIr+lZ3zI6P6h3lw3I18bmU2wR5KHOHBWfzMSBKQ+EEmj6WpTtZ0Zn8kwCqncDG6mlA==";
        };
    in {
        "7886M5Cv" = _7886M5Cv;
        "x15XxvLj" = _x15XxvLj;
        ...
        "fabric-1.21.5" = _BgX8AYCg;
        "fabric-1.21.6" = _BgX8AYCg;
        "fabric-1.21.7" = _BgX8AYCg;
        "fabric-1.21.8" = _BgX8AYCg;
        "fabric-1.21.9" = _BgX8AYCg;
        "fabric-1.21.10" = _BgX8AYCg;
        "fabric-1.21.11" = _BgX8AYCg;
        "fabric-26.1" = _BgX8AYCg;
        "fabric-26.1.1" = _BgX8AYCg;
        "fabric-26.1.2" = _BgX8AYCg;
        "fabric-26.2" = _BgX8AYCg;
        ...
        "forge-1.21.5" = _BgX8AYCg;
        "forge-1.21.6" = _BgX8AYCg;
        "forge-1.21.7" = _BgX8AYCg;
        "forge-1.21.8" = _BgX8AYCg;
        "forge-1.21.9" = _BgX8AYCg;
        "forge-1.21.10" = _BgX8AYCg;
        "forge-1.21.11" = _BgX8AYCg;
        "forge-26.1" = _BgX8AYCg;
        "forge-26.1.1" = _BgX8AYCg;
        "forge-26.1.2" = _BgX8AYCg;
        "forge-26.2" = _BgX8AYCg;
        ...
        "datapack-1.21.5" = _50u0bDAI;
        "datapack-1.21.6" = _50u0bDAI;
        "datapack-1.21.7" = _50u0bDAI;
        "datapack-1.21.8" = _50u0bDAI;
        "datapack-1.21.9" = _50u0bDAI;
        "datapack-1.21.10" = _50u0bDAI;
        "datapack-1.21.11" = _50u0bDAI;
        "datapack-26.1" = _50u0bDAI;
        "datapack-26.1.1" = _50u0bDAI;
        "datapack-26.1.2" = _50u0bDAI;
        "datapack-26.2" = _50u0bDAI;
        ...
        "neoforge-1.21.5" = _BgX8AYCg;
        "neoforge-1.21.6" = _BgX8AYCg;
        "neoforge-1.21.7" = _BgX8AYCg;
        "neoforge-1.21.8" = _BgX8AYCg;
        "neoforge-1.21.9" = _BgX8AYCg;
        "neoforge-1.21.10" = _BgX8AYCg;
        "neoforge-1.21.11" = _BgX8AYCg;
        "neoforge-26.1" = _BgX8AYCg;
        "neoforge-26.1.1" = _BgX8AYCg;
        "neoforge-26.1.2" = _BgX8AYCg;
        "neoforge-26.2" = _BgX8AYCg;
        "quilt-1.21.2" = _VXMFaHYJ;
        "quilt-1.21.3" = _VXMFaHYJ;
        "quilt-1.21" = _bVK70oE0;
        "quilt-1.21.1" = _bVK70oE0;
        "quilt-1.21.4" = _exs3sqLP;
        "quilt-1.21.5" = _BgX8AYCg;
        "quilt-1.21.6" = _BgX8AYCg;
        "quilt-1.21.7" = _BgX8AYCg;
        "quilt-1.21.8" = _BgX8AYCg;
        "quilt-1.21.9" = _BgX8AYCg;
        "quilt-1.21.10" = _BgX8AYCg;
        "quilt-1.21.11" = _BgX8AYCg;
        "quilt-26.1" = _BgX8AYCg;
        "quilt-26.1.1" = _BgX8AYCg;
        "quilt-26.1.2" = _BgX8AYCg;
        "quilt-26.2" = _BgX8AYCg;
        "pkg-1.0" = _7886M5Cv;
        "pkg-1.1" = _x15XxvLj;
        "pkg-1.2" = _rUWe0wGb;
        "pkg-1.3" = _5HrzJoNC;
