...
let
    versions = (let
        ...
        _FW0fhTUU = {
            "id" = "FW0fhTUU";
            "file" = "Lychee-mc26.1-NeoForge-26.0.5.jar";
            "hash" = "sha512-To/jg4NNRuxu07jLtvcmG7FbFS3wdxQiE368eTORi7iW/LkOferj2Q2g60BGTX+U5ViyOmN0wsobgIgpB3/bTg==";
        };
        _UfolszMl = {
            "id" = "UfolszMl";
            "file" = "Lychee-1.21.1-Fabric-6.5.2.jar";
            "hash" = "sha512-B2/PJ2iXE5F/+h1bVXY9MXipR/Bp7InCgUc3QFtSjlqADgTr6iFKz4xE6hSudda7M/Gl8dTZj9TD1UOSn815wA==";
        };
        _sXRCRVIq = {
            "id" = "sXRCRVIq";
            "file" = "Lychee-1.21.1-NeoForge-6.5.4.jar";
            "hash" = "sha512-l8FkNm55YycO7VKRCSsp2johmk+Cdp689QuWalfD5Nkq25iWcJnjC/5kNajFRyjC/WSv7w7m4Db8lEpiYGzTDQ==";
        };
        _6byc5OgT = {
            "id" = "6byc5OgT";
            "file" = "Lychee-mc26.1-NeoForge-26.0.6.jar";
            "hash" = "sha512-M/1nYEnYwLJab6XdTYn7k9+tDgX9hWjkyU6xYS5IJZ8dEZ4BUziAW3nzr2SjBGMNarm2ZCh6MrQ9S6A0Iek76w==";
        };
        _KhbQ8z4H = {
            "id" = "KhbQ8z4H";
            "file" = "Lychee-mc26.1-Fabric-26.0.7.jar";
            "hash" = "sha512-7s/4ayXJ9QvIsTldWyuSiLajZ26KxHkVCJsRZVaSJq/ZUU5PIiljdpCPwBW0We0iskrgblrlXbR3E3F/6KzpHw==";
        };
        _pKbOv7yi = {
            "id" = "pKbOv7yi";
            "file" = "Lychee-mc26.1-Fabric-26.0.8.jar";
            "hash" = "sha512-k2j5LrO+X/xgHXLI7Kn8lO7XvpGnNPDQxBzGavk9S66Ui1RmEck9984A+BCOj/fT3XBNocyJkf1djjuW1kAlbg==";
        };
        _E4DcgW6R = {
            "id" = "E4DcgW6R";
            "file" = "Lychee-1.21.1-NeoForge-6.6.0.jar";
            "hash" = "sha512-ecU12MwUJZYtquNMWGffPOicDf8SfcW6c9ZYmm0DL1Gre0ZIK74UPW1BIkoHibULyPxQ0tUL9bpD+jm+rpUaPQ==";
        };
        _hz16AmPv = {
            "id" = "hz16AmPv";
    ...
    in {
        ...
        "fabric-1.21.1" = _UfolszMl;
        "fabric-26.1" = _pKbOv7yi;
        "fabric-26.1.1" = _pKbOv7yi;
        "fabric-26.1.2" = _pKbOv7yi;
        ...
        "quilt-1.21.1" = _UfolszMl;
        "quilt-26.1" = _pKbOv7yi;
        "quilt-26.1.1" = _pKbOv7yi;
        ...
        "pkg-3.9.1" = _B57Zg0BP;
        "pkg-3.9.2" = _LohMFNsj;
        "pkg-3.10.0" = _JufEsAIx;
        "pkg-3.10.1" = _NlyTE2pj;
        "pkg-3.10.2" = _WxFLjkh3;
        "pkg-3.10.3" = _et2cXy0c;
        "pkg-3.11.0" = _w1AdxB47;
        "pkg-3.11.1" = _2VItTQSm;
        "pkg-3.12.0" = _iSMsNQSB;
        "pkg-3.12.1" = _A5y2DbBM;
        "pkg-3.12.2" = _wEaJrvKr;
        "pkg-3.12.3" = _pk9SekKj;
        "pkg-3.13.0" = _EH9A0fub;
        "pkg-3.13.1" = _IsTXWdvt;
        "pkg-5.0.0" = _ilNkFntz;
        "pkg-3.13.2" = _OQGDy2Hv;
        "pkg-5.0.1" = _eMayfyBs;
        "pkg-3.13.3" = _nsNZTrc3;
        "pkg-3.14.0" = _Jom2wJAL;
        "pkg-5.0.2" = _YlyBZjip;
        "pkg-3.14.1" = _YWC7LwoW;
        "pkg-5.0.3" = _walKzWGE;
        "pkg-5.0.4" = _7Odip5mF;
        "pkg-3.14.2" = _8xQ0JOCc;
        "pkg-5.0.5" = _yPBWPyu0;
        "pkg-5.0.6" = _8fyGAMNO;
        "pkg-5.0.7" = _cRSxseOl;
        "pkg-3.14.3" = _Vyuu42Jj;
        "pkg-5.1.0" = _9yFwpCip;
        "pkg-5.1.1" = _SoAK2LlZ;
        "pkg-5.1.3" = _g3V90G3X;
        "pkg-3.15.0" = _TJhRSZIn;
        "pkg-3.15.1" = _DexAO86m;
        "pkg-2.8.3" = _FDZTK6rq;
        "pkg-5.1.4" = _M62BrHxB;
        "pkg-5.1.5" = _U6AsjbMp;
        "pkg-5.1.6" = _VO3exaPH;
        ...
        "pkg-5.1.8" = _uBcb8d3R;
        "pkg-5.1.9" = _pGoqjZrn;
        "pkg-5.1.10" = _CvndaK4h;
        "pkg-5.1.11" = _22JEIieU;
        "pkg-5.1.12" = _qwaP2Vvx;
        "pkg-3.15.2" = _MsPPEFnx;
        "pkg-5.1.13" = _SYNgOSGY;
        "pkg-5.1.14" = _zCrffyJ6;
        "pkg-6.0.0+fabric" = _Qu49pI1r;
        "pkg-6.0.1+fabric" = _cIhmdbHx;
        "pkg-6.0.2+fabric" = _rTwXmgpl;
        "pkg-6.0.3+fabric" = _QMDlYcdh;
        "pkg-5.1.15+fabric" = _B9MRMo9k;
        "pkg-5.1.15+forge" = _VekisKUV;
        "pkg-3.15.3" = _MjtzWgCh;
        "pkg-3.15.4" = _8ip9XDsp;
        "pkg-6.0.4+neoforge" = _FrhrIKB8;
        "pkg-6.0.5+neoforge" = _eQaibOOA;
        "pkg-6.0.6+neoforge" = _hdFsyXnp;
        "pkg-6.0.7+neoforge" = _yC7dmQOS;
        "pkg-5.1.16+forge" = _Bp9zD26f;
        "pkg-6.0.8+neoforge" = _svkgnHRK;
        "pkg-5.1.17+forge" = _vuxBKFQX;
        "pkg-6.0.9+neoforge" = _D1T73nKO;
        "pkg-6.0.10+neoforge" = _K4ys9Tkk;
        "pkg-6.0.10+fabric" = _KaJ44FBY;
        "pkg-6.1.0+neoforge" = _MdKDNBYN;
        "pkg-5.1.18+forge" = _CGjjOmwU;
        "pkg-5.1.19+forge" = _6sgceHqB;
        "pkg-6.2.0+neoforge" = _i5mDws7h;
        "pkg-6.2.1+neoforge" = _DIMJ6PmP;
        "pkg-6.2.1+fabric" = _ENpM0hRM;
        "pkg-6.3.0+fabric" = _P0CFQHm8;
        "pkg-6.3.1+fabric" = _IJGBdUiN;
        "pkg-6.3.2+neoforge" = _qriLo2Qo;
        "pkg-6.3.2+fabric" = _Zn4NJgnl;
        "pkg-6.3.3+neoforge" = _2JTK5aMy;
        "pkg-6.3.3+fabric" = _GeoAymHs;
        "pkg-6.3.4+fabric" = _k3cX4krJ;
        "pkg-6.3.4+neoforge" = _ipwK9ZOO;
        "pkg-6.3.5+fabric" = _3XR5njvd;
        "pkg-6.3.6+fabric" = _tItAI2fr;
        "pkg-6.3.7+fabric" = _QCTRc4SH;
        "pkg-5.1.20+forge" = _moCdpCcs;
        "pkg-5.1.20+fabric" = _8RwA1xTP;
        "pkg-6.3.8+neoforge" = _XMKISkmU;
        "pkg-6.3.8+fabric" = _MYhYd2KR;
        "pkg-5.1.21+forge" = _qMbpqYHx;
        "pkg-5.1.21+fabric" = _Ks0TpFiM;
        "pkg-6.4.0+neoforge" = _IsuBpK2i;
        "pkg-6.4.0+fabric" = _NKmeWrAw;
        "pkg-6.4.1+neoforge" = _DJIsBpD0;
        "pkg-6.4.1+fabric" = _D21NTH6V;
        "pkg-6.4.2+neoforge" = _FHhk3yF0;
        "pkg-6.4.2+fabric" = _SOGPUHN7;
        "pkg-5.1.22+forge" = _UrP8jA3y;
        "pkg-5.1.22+fabric" = _xSFB0PX3;
        "pkg-6.4.3+neoforge" = _jitgiwcf;
        "pkg-6.4.3+fabric" = _shLq3ICb;
        "pkg-6.4.4+neoforge" = _ozASjvBp;
        "pkg-5.1.23+fabric" = _8vt18eRQ;
        "pkg-5.1.24+fabric" = _P0KM7CeN;
        "pkg-5.1.24+forge" = _JgM1EbHH;
        "pkg-6.5.0+neoforge" = _3lQWjtXT;
        "pkg-6.5.0+fabric" = _FNZrqPOy;
        "pkg-5.2.0+forge" = _eJeGdrjP;
        "pkg-26.0.0+fabric" = _PoZU1Mdb;
        "pkg-5.2.1+forge" = _xRmDtY9h;
        "pkg-26.0.1+fabric" = _lN6hYoWr;
        "pkg-26.0.2+fabric" = _HinhgYuu;
        "pkg-6.5.1+neoforge" = _h56o9aZX;
        "pkg-6.5.1+fabric" = _SUVtewly;
        "pkg-26.0.3+fabric" = _zVRIqhC5;
        "pkg-6.5.2+neoforge" = _yfZDzne2;
        "pkg-6.5.3+neoforge" = _vtOwvwj9;
        "pkg-26.0.4+fabric" = _JiKCXnFv;
        "pkg-26.0.4+neoforge" = _LcogmR4V;
        "pkg-26.0.5+neoforge" = _FW0fhTUU;
        "pkg-6.5.2+fabric" = _UfolszMl;
        "pkg-6.5.4+neoforge" = _sXRCRVIq;
        "pkg-26.0.6+neoforge" = _6byc5OgT;
        "pkg-26.0.7+fabric" = _KhbQ8z4H;
