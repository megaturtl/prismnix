...
let
    ...
    in {
        ...
        "pkg-1.0.4" = _h7enN31P;
        "pkg-1.0.5" = _P3NfXPBP;
        "pkg-1.0.5-26.1-snaphot4" = _VrMhZ4Ll;
        "pkg-3.0.3-26.1snapshot6" = _ls6M0KJ5;
        "pkg-1.0.5-26.1snapshot7" = _P0H6cJyQ;
        "pkg-1.0.5-26.1-snapshot-9" = _pJWpFuct;
        "pkg-1.0.5-26.1-snapshot11" = _DaJOcftf;
        "pkg-1.0.6-26.1" = _REDcMkH0;
        "pkg-1.0.5-26.1rc2" = _pIAxStoq;
        "pkg-1.0.5-26.1" = _jisRxtuR;
        "pkg-1.0.6-26.1.1-26.1.2-26.2snapshot" = _E1mLQspI;
        "pkg-1.0.5-26.2snapshot5" = _rM2Pv0GL;
        "pkg-1.0.5-26.2-snapshot7" = _B5z3Setz;
        "pkg-1.0.5-26.2-snapsho8" = _xZeH7zq2;
        "pkg-2.0.0-26.2-pre3" = _uKKKuJ9s;
        "pkg-2.0.0-26.2rc2" = _ARajCUJC;
        "pkg-2.0.0-26.2" = _zK2mI0jU;
        "pkg-2.0.0-26.3snapshot1" = _85k3WEWR;
