...
let
    versions = (let
        ...
        _JpDP2PQB = {
            "id" = "JpDP2PQB";
            "file" = "cyansethome-2.0.0-beta.1+1.19.1.jar";
            "hash" = "sha512-fIjv1eiZPmx5XNvLtiCLIB6YDuJ5dGmIJSiYwTLKzikh3UVaElNgbQCdbkRYU/BRgPFE3owNg7MO8s6j81yEJw==";
        };
        _Q9RAn2te = {
            "id" = "Q9RAn2te";
            "file" = "cyansethome-2.0.0-beta.1+1.20-1.20.1.jar";
            "hash" = "sha512-tVqvomWlM52cQEBkXoetUwNt4FFn7tLrgQXVvIVkbZ360ZjLVIWEKxd9Aq50b4jICchfFB7WejTEfR4c/0Qacw==";
        };
        _qCyNBhFR = {
            "id" = "qCyNBhFR";
            "file" = "cyansethome-2.0.0-beta.1+1.19.2.jar";
            "hash" = "sha512-IF2ITXJ4tDvWu4UTuBke/+P7rv1aH1cYYh9dzAVu4MRplREpw39TRYl2inrfAHgyKjgY3I3659BS8ZhGXdZu4A==";
        };
        _UZjQct4f = {
            "id" = "UZjQct4f";
            "file" = "cyansethome-2.0.0-beta.1+1.21-1.21.1.jar";
            "hash" = "sha512-c1FOepTOf1eVKKE+9yqJnsBEbQLcI2q+DAHdRM9LIMTzKyoVKsVTSh2k75qUnDbD9zq+gMQ3HAUVEp9RYQdMuA==";
        };
        _rCKxTyTT = {
            "id" = "rCKxTyTT";
            "file" = "cyansethome-2.0.0-beta.1+1.20.2.jar";
            "hash" = "sha512-7cQT1U9x9c44S63Ddl9uQ0imoftMpmkXnkZtUcJbSiRqi834KyRYlVMGMfiaK4KVojHnURYI35gEj6PdrPTDCQ==";
        };
        _iOKRUReX = {
            "id" = "iOKRUReX";
            "file" = "cyansethome-2.0.0-beta.1+1.20.5-1.20.6.jar";
            "hash" = "sha512-M+jZXYlIxdJ+O9Db9YGZSUMW+FGWBCTlUW+GtbQQ35nihFh+TtxCscGglZJD2wyFK77luZ39CNTzbGJaSi+EJw==";
        };
        _nZ9b3tM7 = {
            "id" = "nZ9b3tM7";
            "file" = "cyansethome-2.0.0-beta.1+1.21.11.jar";
            "hash" = "sha512-oObG66EWPv+mV3nvLY31XuNq1z0xoK3BkR2FLBYps7+IDIlx4le84Fo92NEU9wdY//Hf6PuKIS6toGUf3SEtjg==";
        };
        _UvGs59p2 = {
            "id" = "UvGs59p2";
            "file" = "cyansethome-2.0.0-beta.1+1.20.3-1.20.4.jar";
            "hash" = "sha512-nxjbmJ66AM81ngHKX/lcn4Yyliu7n0gDhVvYp/KQpejs6+Qk6ZJxFlWbddGw0P6YyvmCKOyGogn1pCwMiV94Ww==";
        };
        _cmKVR2si = {
            "id" = "cmKVR2si";
            "file" = "cyansethome-2.0.0-beta.1+1.19.4.jar";
            "hash" = "sha512-h14QpggKIiuvjI2WDcRCgNkPb/BJFonsOZ2O+ToHKHmQ4iv8GaMi9AZ5uErfWvqkdtoS2+u3Geo1aNS/PKchVw==";
        };
        _gCUi9SGt = {
            "id" = "gCUi9SGt";
            "file" = "cyansethome-2.0.0-beta.1+1.19.3.jar";
            "hash" = "sha512-2XLyYSt8N/oUUD/yCPVMOu4OZQ0ojoyqEUjyqoAz380/U+IjUW+DW8Oeow5KcemGbvWUu2b7KNUahRwgiUF9Qg==";
        };
        _EWmREZDh = {
            "id" = "EWmREZDh";
            "file" = "cyansethome-2.0.0-beta.1+1.21.2-1.21.3.jar";
            "hash" = "sha512-VPprSKzB2J11mzC06olyjHQB+5B6YPlHB4LYDwF5pVTwskoaXBCsAno/4OszPPeVur9WY6X//ikeo/S07xH48A==";
        };
        _heMQrBi1 = {
            "id" = "heMQrBi1";
            "file" = "cyansethome-2.0.0-beta.1+1.19.jar";
            "hash" = "sha512-GeHptzjVLRlsWLjbHFkpB+qr+q9H3oUslQ/eumAI67ZLA+9Avbt7lyo++dQB3t3ExEanI6hdSPgPHQ7Wx0SqfA==";
        };
        _8DUidNV8 = {
            "id" = "8DUidNV8";
            "file" = "cyansethome-2.0.0-beta.1+1.21.5.jar";
            "hash" = "sha512-Q9p2o6BKpDbJS8pPTNYmi3Pe7dmNH/Z0MSR+oaK899NHmk6CgcfSgbopUWxJikdrgmJXqJq8UjZCwhx+lSJueg==";
        };
        _EhBWYOo4 = {
            "id" = "EhBWYOo4";
            "file" = "cyansethome-2.0.0-beta.1+1.21.9-1.21.10.jar";
            "hash" = "sha512-+mBQUFOf+3leXiEHixQf6cfM24GdRmffWsk8VEsaql7NjhIYX9AVtvv4QAsbhq74gN2Kr9tdf9bvQdkT+IzA1Q==";
        };
        _sOHagC7j = {
            "id" = "sOHagC7j";
            "file" = "cyansethome-2.0.0-beta.1+1.21.6-1.21.8.jar";
            "hash" = "sha512-Si0l3CqgK9QK7WCTY6u9k9I4qZ31WZUeXgXHZIeaTqVsbN6rvmtrPgp7770RsP6r22tPHYtX88++LYlQ/8CZ5g==";
        };
        _ZjITMINw = {
            "id" = "ZjITMINw";
            "file" = "cyansethome-2.0.0-beta.1+1.21.4.jar";
            "hash" = "sha512-kqxDmcywxUUliH8RcfKoDiPSCAXL6V6LqxCUX0BwkkA14V8/9eYGn2ly2LvlIGyjPvUxenEcrQCRObE0ojkZXg==";
        };
        _aLc4DWu7 = {
            "id" = "aLc4DWu7";
            "file" = "cyansethome-2.0.0-beta.1+26.1.x.jar";
            "hash" = "sha512-sw8tiJMseQcskg3z/GUpK4A8+DEGcdEdw+09DtaemfGGKzL79TuYtZ36BlJOwWwZnMvPR//5VXEpBcmtTMYNDw==";
        };
        _ZBDhOIvK = {
            "id" = "ZBDhOIvK";
            "file" = "cyansethome-2.0.0-beta.1+26.2.x.jar";
            "hash" = "sha512-4IFjVtGWkyztv5p4RoUo6bCzyoD/Pt5fQAeKMjMeIks79E3kUicOM0I78+Z9+Im5PwZskf11Ip4NvVKNd2zXWA==";
        };
        _H9gXKnit = {
            "id" = "H9gXKnit";
            "file" = "cyansethome-2.1.0-beta.1+1.19.2.jar";
            "hash" = "sha512-IdIxBL7LNG90mztNnGGixS5xDYEgvMCIts5qicN4RJwbRk2cpVmucZA8TOrQldyO3k53Q1oYCnRc9zxHoxoUXA==";
        };
        _oLlK4raC = {
            "id" = "oLlK4raC";
            "file" = "cyansethome-2.1.0-beta.1+1.20-1.20.1.jar";
            "hash" = "sha512-zZ6odu0yx0FvMnykye7mXscKcJF1SBXm53xc6/tKPqK8MdA74EwKUA3Z4RqQyQipl/MOicityIFdob3rcmlM9g==";
        };
        _gow6C8gq = {
            "id" = "gow6C8gq";
            "file" = "cyansethome-2.1.0-beta.1+1.19.3.jar";
            "hash" = "sha512-COtwVw2Kb1D5TjOwANaquzj4on3vhwgRMJDMvbDK+C0rpbyurSoxm96tBIpSnP7/J+Zdp3wNpIKraSkiSTsG5g==";
        };
        _RzGDT8bY = {
            "id" = "RzGDT8bY";
            "file" = "cyansethome-2.1.0-beta.1+1.21-1.21.1.jar";
            "hash" = "sha512-LmXZfj1fBctszV3u8WFo0QS/+/6lFw6MRfkfIP8xnXSvRNLj5jaHQemLy0KbQCaTv6au8AhioQAGvcjUOG1rkQ==";
        };
        _2PjbWGYq = {
            "id" = "2PjbWGYq";
            "file" = "cyansethome-2.1.0-beta.1+1.20.5-1.20.6.jar";
            "hash" = "sha512-tQE/LB7zj/zbpvQhZ16xBfreui+PgpPOdlxbTsJnlwZTdDg48yYS9PJbhDy59usQKZ+DK0Dk70XCBGLuGzOYPw==";
        };
        _pPOD4BjO = {
            "id" = "pPOD4BjO";
            "file" = "cyansethome-2.1.0-beta.1+1.20.3-1.20.4.jar";
            "hash" = "sha512-qmowOwa3AiUZUHXHYX0wZq/KHZdT9m3d32PWSme/QoIcBaXwE2kqfakOsU3lGFOOIlinoFvqzBg0FwkU/IarKg==";
        };
        _G9p3U7pE = {
            "id" = "G9p3U7pE";
            "file" = "cyansethome-2.1.0-beta.1+1.19.1.jar";
            "hash" = "sha512-gAT/Uw+ESeP2/tI5rYnwqBSo+5eHpvLfmvTGZcU2GDLuW18KS2qCBRdtXizY/CuVBloUXPmJDI70/cr+7XXUtg==";
        };
        _WuTsY59X = {
            "id" = "WuTsY59X";
            "file" = "cyansethome-2.1.0-beta.1+1.19.4.jar";
            "hash" = "sha512-FNzdjn4pxnDR2Q1XUpNAoeJLNMXxG4X1Q4iWoeEzSlb3M/CI8XS0dtlGWBFf8m42U4RA6i4K2PtkHM/RMyHTpg==";
        };
        _EnLZEbQQ = {
            "id" = "EnLZEbQQ";
            "file" = "cyansethome-2.1.0-beta.1+1.20.2.jar";
            "hash" = "sha512-WVcMitWC49AHihWGQZ4QOuZnIbbU4QZErQoZgXHiVqMSCWRWFEKf6yyh4Oxjij4ziO0+r3f6aD0VWFHyIF/Ntw==";
        };
        _JWo3PbIT = {
            "id" = "JWo3PbIT";
            "file" = "cyansethome-2.1.0-beta.1+1.21.11.jar";
            "hash" = "sha512-yAbCf1YVFIm0dBJCEhYtLYnTxY4A7CslU+pkEUuzJ63icsrIkf/IqAGzE0XeaViEEHAL9WiwGV9CrFTjOeugSw==";
        };
        _LN62TjkP = {
            "id" = "LN62TjkP";
            "file" = "cyansethome-2.1.0-beta.1+1.19.jar";
            "hash" = "sha512-Pa85H3YoK7ejiwJRKqBgpWMLFdb5CxvcWMJlV8Xc/IsUQVr5rSzRgcDwuupi1N4dS+1qEb06hhMU9aj/1mvi4Q==";
        };
        _8tUcEbqs = {
            "id" = "8tUcEbqs";
            "file" = "cyansethome-2.1.0-beta.1+1.21.2-1.21.3.jar";
            "hash" = "sha512-QytIqIc3921nR53rKj7VDuivJXCXJ6oITBbgHEcHqH9QSswKRlPPQW+Kd8/PC/KD+RwWHQVCt85AmsHOM1OuIw==";
        };
        _K5Ze6wpa = {
            "id" = "K5Ze6wpa";
            "file" = "cyansethome-2.1.0-beta.1+1.21.9-1.21.10.jar";
            "hash" = "sha512-0VGxNeQ3uwoCEro5is6QAkO9NdTbsWCFYbWb2itgpse+dZnQHDzcdDNnFJJKfwZX+QG8R3l1FMK/ALtKWyNiLw==";
        };
        _hYfLg80U = {
            "id" = "hYfLg80U";
            "file" = "cyansethome-2.1.0-beta.1+1.21.6-1.21.8.jar";
            "hash" = "sha512-gdoIOtB1DJb8lUle8ure5Oqp0iDDeJIwdcsq8P53i8bmKoqG59B/pDPZ/9CsCVdEO0ZJIlxDRCn+0sQ+WfN1tA==";
        };
        _5BaSafX3 = {
            "id" = "5BaSafX3";
            "file" = "cyansethome-2.1.0-beta.1+1.21.5.jar";
            "hash" = "sha512-hQ3J4DH3w75Nk8JbxY6YkZAHwJZwFxMcEcOyZoidd8aT4W10afAXRnsPNROWBBYV0dToykbIvPCvf36R56PLQA==";
        };
        _ltnCbrDN = {
            "id" = "ltnCbrDN";
            "file" = "cyansethome-2.1.0-beta.1+1.21.4.jar";
            "hash" = "sha512-l/OIgTb70Rduddvnx6/Xs3H6AS2Bx0lxgy+3eck2PrGRpQ/ZRvaqtJnmjP3iurP5yeoUI0T1tQdPNOtRF3UkoQ==";
        };
        _mn4RDA4e = {
            "id" = "mn4RDA4e";
            "file" = "cyansethome-2.1.0-beta.1+26.2.x.jar";
            "hash" = "sha512-IMGEUVSaMfZqAe1K7HbG6wTOK/DFavtBQSFA+lQFo/9vtdPnWo6e4QO+rqE/qLwpxms7B32EWCe0S51Ltsau5g==";
        };
        _9H9J1siu = {
            "id" = "9H9J1siu";
            "file" = "cyansethome-2.1.0-beta.1+26.1.x.jar";
            "hash" = "sha512-KEiDH/9k/daq6c6le2zYQ2v6fQrE3iBdyr8wO3bxh87kDauUbTEsDq5w74t6DUJmeUz09640SV+30/oJsxTL5Q==";
        };
        _zdRvISj2 = {
            "id" = "zdRvISj2";
            "file" = "cyansethome-2.1.0-beta.2+1.19.2.jar";
            "hash" = "sha512-SNvW5dGFa8HUKawNXiMNv8W60r8LhhVsRUH/pNAsg4QLI048Le8a2OLxkw5CucdiCKXM/rwUQikZg/7h8zouRQ==";
        };
        _AHPovJbL = {
            "id" = "AHPovJbL";
            "file" = "cyansethome-2.1.0-beta.2+1.20.2.jar";
            "hash" = "sha512-m+JqZeemfMS6U6fJz6dGYBy3xN3WvLHZqg/UvRoT9KUqUxTzMWLWppskORAbX6H+T22QUBeabwb4YD+3l7aAfg==";
        };
        _4LH65Vw1 = {
            "id" = "4LH65Vw1";
            "file" = "cyansethome-2.1.0-beta.2+1.20-1.20.1.jar";
            "hash" = "sha512-dABMC31/CcepA72xN2GJhEfTkR8XFtFcf47wXpM+m2ZHKs+ellVIJ/vR2HnLBtYyzmYfKUp/KULLpKVNgR0NjQ==";
        };
        _FyufbDs2 = {
            "id" = "FyufbDs2";
            "file" = "cyansethome-2.1.0-beta.2+1.21.6-1.21.8.jar";
            "hash" = "sha512-gAhbIdgcGsNvi5cHpxvcg3UL5M7YvyAg5BzxWj/sUo4oqxYKRR2ya3P/JavDb74eH0szAF5lYcHDanj+TWWRtg==";
        };
        _WKy135VR = {
            "id" = "WKy135VR";
            "file" = "cyansethome-2.1.0-beta.2+1.21.5.jar";
            "hash" = "sha512-/1u5tvru/+5s2mWnq8+BM1H3QiU18Bgtov2YFOrmVoeF4mz/ivV0gFtoxvO0nGyryhXQTYJXM2s5DdEF/PFsqg==";
        };
        _by6GVv4r = {
            "id" = "by6GVv4r";
            "file" = "cyansethome-2.1.0-beta.2+1.19.3.jar";
            "hash" = "sha512-6rha8IW9oY5hZRLUGEks+0YOPg/upWuCjL9kVJ6a0HGuJs5/dx0MNLBQPnClu2rf/+NiriL6xlLaveuPFTb7Ew==";
        };
        _NlmmMOyz = {
            "id" = "NlmmMOyz";
            "file" = "cyansethome-2.1.0-beta.2+1.20.5-1.20.6.jar";
            "hash" = "sha512-fQ36ThB84DZZHxDebpC7oheGH4ZO7glqZKT+rcuOJb5rpFfKOFKlCacK9v0VoTfd5GuOqcbGy2b3JQe0fUocsw==";
        };
        _iKL4nSsA = {
            "id" = "iKL4nSsA";
            "file" = "cyansethome-2.1.0-beta.2+1.19.1.jar";
            "hash" = "sha512-nBPoQV+w46Abg+FqQpowPe1xUU3d6gpS9yE7OfaMICxUUUEuOrApKoxNHEoHVtl3stZ6LS2wQNE0vL55R08ZJA==";
        };
        _gxDUslXj = {
            "id" = "gxDUslXj";
            "file" = "cyansethome-2.1.0-beta.2+1.21.9-1.21.10.jar";
            "hash" = "sha512-13a+5klR+gowgkiFPSM8KWeNghqQksMQnnjTv4tqt4qHDZolH6vGxdxxnkqWYGqjF/DGZp2qgLkVUdEwHhEETA==";
        };
        _EDUD5FQP = {
            "id" = "EDUD5FQP";
            "file" = "cyansethome-2.1.0-beta.2+1.19.jar";
            "hash" = "sha512-kAR1+1p8nfJITL6Fa//+P4qCJ1MC4Eo4vqaOZYYrBMTFAwpOjkfAVazrmhkXu945/uYUwOe+6+JnPIbJoCKg3w==";
        };
        _8peC3BsA = {
            "id" = "8peC3BsA";
            "file" = "cyansethome-2.1.0-beta.2+1.19.4.jar";
            "hash" = "sha512-CEyWqQn4Zt9+7QP1RaKPq1EfMTzMGo2mbnkropZCM95PDPRz3fHS+fhNSJJQCTf2Sd4p37qUhFuBVdXNNq1TBg==";
        };
        _SVuLlqpV = {
            "id" = "SVuLlqpV";
            "file" = "cyansethome-2.1.0-beta.2+1.20.3-1.20.4.jar";
            "hash" = "sha512-m2KrE8nyoQKadOms7OGt3p/QmxWK3RAfZh40HsoY3W38yg1AzScF8X9QMjbH3MtYGKoHKgWjFYq1OTwBbnj/hg==";
        };
        _FACa9D9J = {
            "id" = "FACa9D9J";
            "file" = "cyansethome-2.1.0-beta.2+1.21.2-1.21.3.jar";
            "hash" = "sha512-qL9rZSl54Ex2ihSjrpX3voCtYJcfJk9Z+ZIqTaFs9PQW7scYJLXAJnPHBxaSCPKVNtAJgK8wz7f6JVwEG/zGww==";
        };
        _SgNdGGJn = {
            "id" = "SgNdGGJn";
            "file" = "cyansethome-2.1.0-beta.2+1.21.11.jar";
            "hash" = "sha512-if9zwTJ92C2IIV8HkX4pyrvVo6ymk3iSmesQQm8mm2AvKevPYgeldzTRmAzVyPsuUmpHyS+ipmoR482bZYAF9A==";
        };
        _PAG6iAlk = {
            "id" = "PAG6iAlk";
            "file" = "cyansethome-2.1.0-beta.2+1.21-1.21.1.jar";
            "hash" = "sha512-Q+Qxy/XH54s/4lyFPYBdaZTRU1kZqK3V6oMye4v3VXGz4O/ResCFrYNq2fx/MIsNJWTAvtFNxK+PSrLSrhH7+A==";
        };
        _hYFng7eC = {
            "id" = "hYFng7eC";
            "file" = "cyansethome-2.1.0-beta.2+1.21.4.jar";
            "hash" = "sha512-8J0YxQ7/09mJFdawvR7JgYKh05NhmkOsKlr/dJVeQNkwW6WnOF8F4DfAxTtwCAqEsi1oTMRuEh5M7QSXTZz1yg==";
        };
        _YHCwoVYB = {
            "id" = "YHCwoVYB";
            "file" = "cyansethome-2.1.0-beta.2+26.2.x.jar";
            "hash" = "sha512-253pA/A482skrf4atyJyZMvaVc6SOFyRKJ1liWl9keL0mLx62ruyN7+21cExKoBLEvWbSeLpwFbwdIqkffDsQw==";
        };
        _RFIsySOg = {
            "id" = "RFIsySOg";
    ...
    in {
        ...
        "fabric-1.19.3" = _by6GVv4r;
        "fabric-1.19.4" = _8peC3BsA;
        "fabric-1.20" = _4LH65Vw1;
        "fabric-1.20.1" = _4LH65Vw1;
        "fabric-1.20.2" = _AHPovJbL;
        "fabric-1.20.3" = _SVuLlqpV;
        "fabric-1.20.4" = _SVuLlqpV;
        "fabric-1.20.5" = _NlmmMOyz;
        "fabric-1.20.6" = _NlmmMOyz;
        "fabric-1.21" = _PAG6iAlk;
        "fabric-1.21.1" = _PAG6iAlk;
        "fabric-1.21.2" = _FACa9D9J;
        "fabric-1.21.3" = _FACa9D9J;
        "fabric-1.21.4" = _hYFng7eC;
        "fabric-1.21.5" = _WKy135VR;
        "fabric-1.21.6" = _FyufbDs2;
        "fabric-1.21.7" = _FyufbDs2;
        "fabric-1.21.8" = _FyufbDs2;
        "fabric-1.21.9" = _gxDUslXj;
        "fabric-1.21.10" = _gxDUslXj;
        "fabric-1.21.11" = _SgNdGGJn;
        "fabric-26.1" = _RFIsySOg;
        ...
        "pkg-0.0.4+1.19.3" = _qj1apxRO;
        "pkg-0.0.4+1.19.4" = _tkpRCapk;
        "pkg-0.0.5+1.19.2" = _tN73cnom;
        "pkg-0.0.5+1.19.3" = _fO7CTXwg;
        "pkg-0.0.5+1.19.4" = _T9vMwOR5;
        "pkg-0.0.6+1.19.3" = _ZaIS2qXn;
        "pkg-0.0.7+1.19.4" = _JXRMcdS9;
        "pkg-0.1.0+1.19.2" = _3fAIDnmo;
        "pkg-0.1.0+1.19.3" = _aciWyFep;
        "pkg-0.1.0+1.19.4" = _twTMIsK4;
        "pkg-0.1.1+1.19.2" = _hYjeCEpE;
        "pkg-0.1.1+1.19.4" = _KFTqEfmA;
        "pkg-0.1.2+1.19.2" = _yQ2yUub8;
        "pkg-0.1.2+1.19.4" = _QAhybJKw;
        "pkg-0.1.2+1.20.1" = _aaEicBpc;
        "pkg-0.1.3+1.19.2" = _mEcFpiCr;
        "pkg-0.1.3+1.19.4" = _RIZXNLoL;
        "pkg-0.1.3+1.20.1" = _w0jNbjd2;
        "pkg-0.1.4+1.19.2" = _Rhs2rqrR;
        "pkg-0.1.4+1.19.4" = _fLKlIPT6;
        "pkg-0.1.4+1.20.1" = _vtXeRATm;
        "pkg-0.1.5+1.20.2" = _pjAKrqIB;
        "pkg-0.1.5+1.20.1" = _lhJKRyx5;
        "pkg-0.1.5+1.19.4" = _rAf8XXhR;
        "pkg-0.1.5+1.20.3" = _jOgHIeP9;
        "pkg-0.1.5+1.20.4" = _XxXvJPNQ;
        "pkg-0.1.6+1.20.4" = _PI9HHcQo;
        "pkg-0.1.6+1.19.4" = _WIAIw50b;
        "pkg-0.1.6+1.20.2" = _VFywnmoK;
        "pkg-0.1.7+1.19.4" = _B3VvYXA1;
        "pkg-0.1.7+1.20.2" = _9nHpePkL;
        "pkg-0.1.7+1.20.4" = _3R8fB2ra;
        "pkg-0.1.7+1.20.5" = _pMDh1f5u;
        "pkg-0.1.8+1.19.4" = _6arYiaDz;
        "pkg-0.1.8+1.20.2" = _Mp3RNyPM;
        "pkg-0.1.8+1.20.4" = _BvRFCYUx;
        "pkg-0.1.8+1.20.6" = _mwt76xAu;
        "pkg-0.1.8+1.21" = _RUKiJ7bl;
        "pkg-0.1.9+1.20.6" = _cxaCl091;
        "pkg-0.1.9+1.20.2" = _FGAw8gxN;
        "pkg-0.1.9+1.20.4" = _kZm9hrix;
        "pkg-0.1.9+1.19.4" = _2MGdWu9D;
        "pkg-0.1.9+1.21" = _9dcUF3j0;
        "pkg-0.1.10+1.21" = _U9rzO1Fa;
        "pkg-0.1.10+1.20.6" = _kyJkYj7v;
        "pkg-0.1.10+1.20.4" = _qL0TYOOW;
        "pkg-0.1.10+1.20.2" = _Vir1DprX;
        "pkg-0.1.10+1.19.4" = _74eWmf50;
        "pkg-0.1.11+1.21" = _BoJiKkdG;
        "pkg-0.1.11+1.20.6" = _enYnegbw;
        "pkg-0.1.11+1.20.4" = _wY5Xc0Cx;
        "pkg-0.1.11+1.20.2" = _Ti1blgyd;
        "pkg-0.1.11+1.19.4" = _10PHSkvt;
        "pkg-0.1.12+1.21.1" = _cOduAaMF;
        "pkg-0.1.12+1.21" = _dUyopapY;
        "pkg-0.1.12+1.20.4" = _OVe1sDZp;
        "pkg-0.1.12+1.20.6" = _7H87TH7Y;
        "pkg-0.1.12+1.20.2" = _rJ5kUYRA;
        "pkg-0.1.12+1.19.4" = _K6Qkfu6Q;
        "pkg-0.1.13+1.21.1" = _6ttixGC3;
        "pkg-0.1.13+1.21" = _61ve5FVf;
        "pkg-0.1.13+1.20.6" = _aE1R1acO;
        "pkg-0.1.13+1.20.4" = _fniawpsb;
        "pkg-0.1.13+1.20.2" = _4RBwXcNP;
        "pkg-0.1.13+1.19.4" = _GE3HWXaw;
        "pkg-0.1.14+1.21.x" = _jnb7jTuO;
        "pkg-0.1.14+1.21.2" = _PqR1jW9H;
        "pkg-0.1.14+1.20.6" = _61osqY72;
        "pkg-0.1.14+1.20.4" = _qpSXvLi3;
        "pkg-0.1.14+1.20.2" = _9pDTug82;
        "pkg-0.1.14+1.20.1" = _F3xkLzbD;
        "pkg-0.1.14+1.19.4" = _rTrclUYG;
        "pkg-0.1.15+1.21.2-1.21.3" = _CaPbBPwD;
        "pkg-0.1.15+1.21.x" = _zMUXk7Wp;
        "pkg-0.1.15+1.20.6" = _Xd8bVtrS;
        "pkg-0.1.15+1.20.4" = _W07oqaNx;
        "pkg-0.1.15+1.20.2" = _6yBXysN2;
        "pkg-0.1.15+1.20.1" = _5acg0vgF;
        "pkg-0.1.15+1.19.4" = _bCnzs0i7;
        "pkg-1.0.0+1.21-1.21.1" = _dyWqCBRv;
        "pkg-1.0.0+1.21.2-1.21.3" = _5o18d8pO;
        "pkg-1.0.0+1.20.6" = _GFCc0LKH;
        "pkg-1.0.0+1.20.4" = _5lF8Vq6V;
        "pkg-1.0.0+1.20.2" = _xW2puPBL;
        "pkg-1.0.0+1.20.1" = _1X52PwTS;
        "pkg-1.0.0+1.19.4" = _U0UxyPRu;
        "pkg-1.0.0+1.21.4" = _bkU5DGDQ;
        "pkg-1.0.1+1.21.4" = _vOIy7WKF;
        "pkg-1.0.1+1.21.5" = _OtyqcKE4;
        "pkg-1.0.1+1.21-1.21.1" = _QRPLdx7T;
        "pkg-1.0.1+1.20.6" = _3w9P5t06;
        "pkg-1.0.1+1.20.4" = _8nNaxNUw;
        "pkg-1.0.1+1.21.2-1.21.3" = _MBrKz0jT;
        "pkg-1.0.1+1.20.1" = _1mhr3CC7;
        "pkg-1.0.1+1.20.2" = _M4RlCNJS;
        "pkg-1.0.1+1.19.4" = _hWudBrUM;
        "pkg-1.0.2+1.21.4" = _lGoZ3ooK;
        "pkg-1.0.2+1.21-1.21.1" = _ppEPuJa5;
        "pkg-1.0.2+1.20.1" = _r428ZzhZ;
        "pkg-1.0.2+1.21.5" = _bdPaMiJu;
        "pkg-1.0.2+1.20.6" = _KvlWLMjG;
        "pkg-1.0.2+1.20.4" = _u5HjnHSO;
        "pkg-1.0.2+1.20.2" = _CyahSr54;
        "pkg-1.0.2+1.21.2-1.21.3" = _lZLjKlnJ;
        "pkg-1.0.2+1.19.4" = _yCO5Ur0O;
        "pkg-1.1.2+1.21.4" = _J5mkZ7pF;
        "pkg-1.1.2+1.21.5" = _xU7S1yT3;
        "pkg-1.1.2+1.20.4" = _Gt34Kxli;
        "pkg-1.1.2+1.21-1.21.1" = _NJMqKn8F;
        "pkg-1.1.2+1.20.1" = _5CDGmWbX;
        "pkg-1.1.2+1.20.6" = _E1AT6hz2;
        "pkg-1.1.2+1.19.4" = _HH5whNVI;
        "pkg-1.1.2+1.20.2" = _8FfnDW9J;
        "pkg-1.1.2+1.21.2-1.21.3" = _L7UfIEGW;
        "pkg-1.1.3+1.21.5" = _PVgpFeO2;
        "pkg-1.1.3+1.21.4" = _2ZFByrjO;
        "pkg-1.1.3+1.20.6" = _hY26v0sc;
        "pkg-1.1.3+1.20.2" = _oaDGJHly;
        "pkg-1.1.3+1.21-1.21.1" = _r1WMGTvS;
        "pkg-1.1.3+1.21.2-1.21.3" = _zVqfBjMJ;
        "pkg-1.1.3+1.20.4" = _sBoHibLi;
        "pkg-1.1.3+1.20.1" = _VQnZs4kU;
        "pkg-1.1.3+1.19.4" = _bQqLWexm;
        "pkg-1.1.4+1.21-1.21.1" = _mDivpcrJ;
        "pkg-1.1.4+1.21.5" = _pckCzhiw;
        "pkg-1.1.4+1.21.4" = _9QXT9kfv;
        "pkg-1.1.4+1.20.4" = _hQ0W0D9y;
        "pkg-1.1.4+1.20.1" = _UsTl3krD;
        "pkg-1.1.4+1.20.6" = _VFdrVMxM;
        "pkg-1.1.4+1.20.2" = _EGL7pLBf;
        "pkg-1.1.4+1.21.2-1.21.3" = _tapgKstH;
        "pkg-1.1.4+1.19.4" = _xqUacQQZ;
        "pkg-1.1.5+1.21.5" = _1dYgz9R0;
        "pkg-1.1.5+1.21.2-1.21.3" = _3GRB1WOn;
        "pkg-1.1.5+1.20.4" = _9bwqoNIa;
        "pkg-1.1.5+1.21-1.21.1" = _zsnlC0b9;
        "pkg-1.1.5+1.20.2" = _94oiC5ZB;
        "pkg-1.1.5+1.21.4" = _wuxzuTVZ;
        "pkg-1.1.5+1.20.1" = _b7rA06Q3;
        "pkg-1.1.5+1.20.6" = _2m2zJPkO;
        "pkg-1.1.5+1.19.4" = _HzPdPVpR;
        "pkg-1.1.6+1.21.4" = _aCijr72F;
        "pkg-1.1.6+1.21-1.21.1" = _oUQbmKYF;
        "pkg-1.1.6+1.20.4" = _tNm8gBRn;
        "pkg-1.1.6+1.20.2" = _i5yEkq3o;
        "pkg-1.1.6+1.20.6" = _sS3zgwWM;
        "pkg-1.1.6+1.21.5" = _ojuxyoic;
        "pkg-1.1.6+1.21.2-1.21.3" = _oPFOPGVc;
        "pkg-1.1.6+1.20.1" = _RQTO2fXb;
        "pkg-1.1.6+1.19.4" = _NXuObjGK;
        "pkg-1.1.7+1.21.5" = _22FmIqld;
        "pkg-1.1.7+1.21-1.21.1" = _SIieaCaJ;
        "pkg-1.1.7+1.21.4" = _qaozaAe5;
        "pkg-1.1.7+1.20.6" = _A8kJsHU7;
        "pkg-1.1.7+1.21.2-1.21.3" = _PRiaGd4g;
        "pkg-1.1.7+1.20.2" = _x4L4afIT;
        "pkg-1.1.7+1.20.4" = _kY30b0qe;
        "pkg-1.1.7+1.20.1" = _jgtll68q;
        "pkg-1.1.7+1.19.4" = _93IsPGsc;
        "pkg-1.1.8+1.21.5" = _odgkzhcY;
        "pkg-1.1.8+1.21-1.21.1" = _QV4BFvcV;
        "pkg-1.1.8+1.20.2" = _WSdwCcUO;
        "pkg-1.1.8+1.20.4" = _S05QuEdp;
        "pkg-1.1.8+1.20.6" = _MAZ6rXf0;
        "pkg-1.1.8+1.21.4" = _qxoe974s;
        "pkg-1.1.8+1.21.2-1.21.3" = _cRmTj8lI;
        "pkg-1.1.8+1.20.1" = _ZQR3HmUq;
        "pkg-1.1.8+1.19.4" = _hFqPiAnr;
        "pkg-1.1.9+1.21-1.21.1" = _9xkO137h;
        "pkg-1.1.9+1.21.2-1.21.3" = _iTdqPqml;
        "pkg-1.1.9+1.21.4" = _UaDWQPGc;
        "pkg-1.1.9+1.21.5" = _SbebIcyD;
        "pkg-1.1.9+1.20.2" = _b9deFm2H;
        "pkg-1.1.9+1.20.6" = _dqUhmHTU;
        "pkg-1.1.9+1.20.4" = _aMnqALHi;
        "pkg-1.1.9+1.20.1" = _IG7jnsRD;
        "pkg-1.1.9+1.19.4" = _vvHsAAgg;
        "pkg-1.1.10+1.21.5" = _EelAfh1K;
        "pkg-1.1.10+1.21.4" = _HsaHaV2H;
        "pkg-1.1.10+1.21.2-1.21.3" = _EcfO0xjS;
        "pkg-1.1.10+1.20.4" = _3JwoXEEh;
        "pkg-1.1.10+1.20.6" = _3VKJjzzY;
        "pkg-1.1.10+1.21-1.21.1" = _DTg6noPk;
        "pkg-1.1.10+1.20.1" = _RKLpBShM;
        "pkg-1.1.10+1.20.2" = _bMU5P3b5;
        "pkg-1.1.10+1.19.4" = _TS4Lo6k9;
        "pkg-1.1.11+1.21.4" = _ycXF3Obh;
        "pkg-1.1.11+1.21-1.21.1" = _T3uHqAmg;
        "pkg-1.1.11+1.20.3-1.20.4" = _MKinNkTV;
        "pkg-1.1.11+1.21.5" = _74C2ebrd;
        "pkg-1.1.11+1.20.5-1.20.6" = _CaBZeRsF;
        "pkg-1.1.11+1.21.2-1.21.3" = _Rvrk34j8;
        "pkg-1.1.11+1.20-1.20.1" = _I626SyQA;
        "pkg-1.1.11+1.19.3" = _uVMD91Fy;
        "pkg-1.1.11+1.19.4" = _AAkJCkzW;
        "pkg-1.1.11+1.20.2" = _JspWe8VB;
        "pkg-1.1.11+1.19.2" = _xkI5fTeO;
        "pkg-1.1.11+1.21.6" = _405viKMi;
        "pkg-1.1.12+1.21.6-1.21.7" = _T0nUGzFQ;
        "pkg-1.1.12+1.21-1.21.1" = _53MMIwKs;
        "pkg-1.1.12+1.20.2" = _lItCYFBA;
        "pkg-1.1.12+1.20.3-1.20.4" = _QT5ZAvXK;
        "pkg-1.1.12+1.21.2-1.21.3" = _VcN3C57u;
        "pkg-1.1.12+1.21.5" = _y5BDqJ3F;
        "pkg-1.1.12+1.20.5-1.20.6" = _MiCn6PU0;
        "pkg-1.1.12+1.21.4" = _tnZQILqG;
        "pkg-1.1.12+1.19.4" = _8ldRe9cn;
        "pkg-1.1.12+1.20-1.20.1" = _JfjEUok1;
        "pkg-1.1.12+1.19.3" = _7Qg9rZhe;
        "pkg-1.1.12+1.19.2" = _XsFlKSQU;
        "pkg-1.1.12+1.21.6-1.21.8" = _LSfXH7Tc;
        "pkg-1.1.13+1.19.2" = _390GJMTq;
        "pkg-1.1.13+1.19.4" = _uZDE13eV;
        "pkg-1.1.13+1.20-1.20.1" = _NJTYc6Hy;
        "pkg-1.1.13+1.20.3-1.20.4" = _Kbq873Qn;
        "pkg-1.1.13+1.20.5-1.20.6" = _TLARQPVF;
        "pkg-1.1.13+1.19.3" = _iCnsWvrj;
        "pkg-1.1.13+1.21.2-1.21.3" = _GDWX40Mx;
        "pkg-1.1.13+1.20.2" = _XON6Udkt;
        "pkg-1.1.13+1.21.4" = _SYIc0IdY;
        "pkg-1.1.13+1.21.5" = _l57BhhlK;
        "pkg-1.1.13+1.21-1.21.1" = _lHxISYR0;
        "pkg-1.1.13+1.21.6-1.21.8" = _kKitkKoS;
        "pkg-1.1.13+1.21.9" = _QQhp3RZi;
        "pkg-1.1.14+1.21-1.21.1" = _boQZeqBv;
        "pkg-1.1.14+1.21.2-1.21.3" = _qD7XC4EO;
        "pkg-1.1.14+1.19.4" = _nDGrn4WL;
        "pkg-1.1.14+1.19.3" = _3brjbthY;
        "pkg-1.1.14+1.19.2" = _RzbSmBvo;
        "pkg-1.1.14+1.20.5-1.20.6" = _nLDKV45B;
        "pkg-1.1.14+1.20.3-1.20.4" = _XoNaEolS;
        "pkg-1.1.14+1.21.4" = _YDjKgsHZ;
        "pkg-1.1.14+1.21.5" = _fnfOeF5B;
        "pkg-1.1.14+1.21.9-1.21.10" = _R6WKDSuw;
        "pkg-1.1.14+1.20-1.20.1" = _8XeiRFYo;
        "pkg-1.1.14+1.21.6-1.21.8" = _C30D4GNK;
        "pkg-1.1.14+1.20.2" = _mIn7SuIk;
        "pkg-1.1.15+1.20.2" = _g3KV7LO7;
        "pkg-1.1.15+1.19.4" = _3mRA7rsn;
        "pkg-1.1.15+1.19.2" = _dsr9DRXT;
        "pkg-1.1.15+1.20.3-1.20.4" = _cv8Jws6H;
        "pkg-1.1.15+1.20-1.20.1" = _3Tqu6jQ5;
        "pkg-1.1.15+1.21.11" = _YDiPI2A2;
        "pkg-1.1.15+1.20.5-1.20.6" = _SYQoSunh;
        "pkg-1.1.15+1.21.5" = _9FkFc3v6;
        "pkg-1.1.15+1.21.4" = _x7Wgz1Sr;
        "pkg-1.1.15+1.21.2-1.21.3" = _9Wworwm4;
        "pkg-1.1.15+1.19.3" = _NLMrUsaH;
        "pkg-1.1.15+1.21-1.21.1" = _FfNr9oVc;
        "pkg-1.1.15+1.21.9-1.21.10" = _7WbdY8Zv;
        "pkg-1.1.15+1.21.6-1.21.8" = _MugRvWva;
        "pkg-1.1.16+1.19.2" = _tngA9he7;
        "pkg-1.1.16+1.19.3" = _Hn2I05vL;
        "pkg-1.1.16+1.19.4" = _VMHYC0NB;
        "pkg-1.1.16+1.20-1.20.1" = _v90YuDYg;
        "pkg-1.1.16+1.20.2" = _et2fhQNG;
        "pkg-1.1.16+1.20.3-1.20.4" = _OhzCvIxo;
        "pkg-1.1.16+1.20.5-1.20.6" = _k9sbcp8M;
        "pkg-1.1.16+1.21-1.21.1" = _W0V4EhZj;
        "pkg-1.1.16+1.21.11" = _mqcnT496;
        "pkg-1.1.16+1.21.2-1.21.3" = _2apItGrd;
        "pkg-1.1.16+1.21.4" = _7HwerVpb;
        "pkg-1.1.16+1.21.5" = _4wQmdZhX;
        "pkg-1.1.16+1.21.6-1.21.8" = _C4ON06q7;
        "pkg-1.1.16+1.21.9-1.21.10" = _I3CQzvwe;
        "pkg-1.1.17+1.19.3" = _ZrhHId6E;
        "pkg-1.1.17+1.21.4" = _vZZ4rEPQ;
        "pkg-1.1.17+1.20.5-1.20.6" = _ckuu6mvt;
        "pkg-1.1.17+1.20.2" = _ExIpNIhW;
        "pkg-1.1.17+1.21.9-1.21.10" = _YhXtlDW5;
        "pkg-1.1.17+1.21.6-1.21.8" = _xUAJ37hj;
        "pkg-1.1.17+1.21.2-1.21.3" = _3YK6p3il;
        "pkg-1.1.17+1.20.3-1.20.4" = _iJXL3aEj;
        "pkg-1.1.17+1.20-1.20.1" = _DqenW5fL;
        "pkg-1.1.17+1.19.2" = _RWwxRpRk;
        "pkg-1.1.17+1.21.11" = _TVSH6fPO;
        "pkg-1.1.17+1.21.5" = _Aw0xgNMp;
        "pkg-1.1.17+1.21-1.21.1" = _Gfaz4EFb;
        "pkg-1.1.17+1.19.4" = _K8BkKWYj;
        "pkg-1.1.18+1.19.3" = _Oc7feDSb;
        "pkg-1.1.18+1.20.2" = _iNJWhSIL;
        "pkg-1.1.18+1.21.4" = _xcfGDs9F;
        "pkg-1.1.18+1.20.5-1.20.6" = _xdZLq7s1;
        "pkg-1.1.18+1.20-1.20.1" = _diqfuYcq;
        "pkg-1.1.18+1.20.3-1.20.4" = _LtGua916;
        "pkg-1.1.18+1.21-1.21.1" = _i4SDjgdk;
        "pkg-1.1.18+1.19.4" = _VQUJV9Mb;
        "pkg-1.1.18+1.21.6-1.21.8" = _t4WRHDqj;
        "pkg-1.1.18+1.21.2-1.21.3" = _ZEHaiUJ1;
        "pkg-1.1.18+1.19.2" = _YgbjOv5b;
        "pkg-1.1.18+1.21.9-1.21.10" = _hPdRm32b;
        "pkg-1.1.18+1.21.11" = _OHLPhECp;
        "pkg-1.1.18+1.21.5" = _q4o1SbZe;
        "pkg-1.1.18+26.1" = _J0aOFjIS;
        "pkg-1.1.18+26.1.x" = _Stg4X2eY;
        "pkg-1.1.19+1.20-1.20.1" = _qhZZtcQ4;
        "pkg-1.1.19+1.21.11" = _HSJn9gB0;
        "pkg-1.1.19+1.19.3" = _dwRTzUHe;
        "pkg-1.1.19+1.20.5-1.20.6" = _Ve5eo3KK;
        "pkg-1.1.19+1.19.1" = _ziTaXe4J;
        "pkg-1.1.19+1.21-1.21.1" = _Tag8RBy3;
        "pkg-1.1.19+1.20.3-1.20.4" = _C27yCVhY;
        "pkg-1.1.19+1.21.2-1.21.3" = _tkO0ZG2Z;
        "pkg-1.1.19+1.20.2" = _ERNuYtPd;
        "pkg-1.1.19+1.19.4" = _WZrZ8fDJ;
        "pkg-1.1.19+1.19" = _XMLz1EpZ;
        "pkg-1.1.19+1.19.2" = _fG7QX3HZ;
        "pkg-1.1.19+1.21.9-1.21.10" = _zgV3oF5h;
        "pkg-1.1.19+1.21.4" = _BnXcsT4r;
        "pkg-1.1.19+1.21.5" = _j11PJ1Xw;
        "pkg-1.1.19+1.21.6-1.21.8" = _xph8A1XQ;
        "pkg-1.1.19+26.1.x" = _ngOPp0eX;
        "pkg-1.1.20+1.20.5-1.20.6" = _GCQmC1ya;
        "pkg-1.1.20+1.20.2" = _m9qKuYbJ;
        "pkg-1.1.20+1.19.4" = _2DovTsxi;
        "pkg-1.1.20+1.19.2" = _A7Gqfszx;
        "pkg-1.1.20+1.20.3-1.20.4" = _3W2XZHaJ;
        "pkg-1.1.20+1.20-1.20.1" = _Kqf3mzEZ;
        "pkg-1.1.20+1.19.1" = _KfBnb0EI;
        "pkg-1.1.20+1.19" = _wqVyS3DY;
        "pkg-1.1.20+1.19.3" = _i8Sd4K7w;
        "pkg-1.1.20+1.21.2-1.21.3" = _l0wV7KAD;
        "pkg-1.1.20+1.21-1.21.1" = _aMtEkqYU;
        "pkg-1.1.20+1.21.11" = _6gc8dKYn;
        "pkg-1.1.20+1.21.4" = _VYPQvU6A;
        "pkg-1.1.20+1.21.9-1.21.10" = _Tp8v1YUA;
        "pkg-1.1.20+1.21.5" = _vf6W3Ihh;
        "pkg-1.1.20+1.21.6-1.21.8" = _gLBVYeVZ;
        "pkg-1.1.20+26.1.x" = _BQAKcKXn;
        "pkg-1.1.20+26.2.x" = _dShNlM1D;
        "pkg-2.0.0-beta.1+1.19.1" = _JpDP2PQB;
        "pkg-2.0.0-beta.1+1.20-1.20.1" = _Q9RAn2te;
        "pkg-2.0.0-beta.1+1.19.2" = _qCyNBhFR;
        "pkg-2.0.0-beta.1+1.21-1.21.1" = _UZjQct4f;
        "pkg-2.0.0-beta.1+1.20.2" = _rCKxTyTT;
        "pkg-2.0.0-beta.1+1.20.5-1.20.6" = _iOKRUReX;
        "pkg-2.0.0-beta.1+1.21.11" = _nZ9b3tM7;
        "pkg-2.0.0-beta.1+1.20.3-1.20.4" = _UvGs59p2;
        "pkg-2.0.0-beta.1+1.19.4" = _cmKVR2si;
        "pkg-2.0.0-beta.1+1.19.3" = _gCUi9SGt;
        "pkg-2.0.0-beta.1+1.21.2-1.21.3" = _EWmREZDh;
        "pkg-2.0.0-beta.1+1.19" = _heMQrBi1;
        "pkg-2.0.0-beta.1+1.21.5" = _8DUidNV8;
        "pkg-2.0.0-beta.1+1.21.9-1.21.10" = _EhBWYOo4;
        "pkg-2.0.0-beta.1+1.21.6-1.21.8" = _sOHagC7j;
        "pkg-2.0.0-beta.1+1.21.4" = _ZjITMINw;
        "pkg-2.0.0-beta.1+26.1.x" = _aLc4DWu7;
        "pkg-2.0.0-beta.1+26.2.x" = _ZBDhOIvK;
        "pkg-2.1.0-beta.1+1.19.2" = _H9gXKnit;
        "pkg-2.1.0-beta.1+1.20-1.20.1" = _oLlK4raC;
        "pkg-2.1.0-beta.1+1.19.3" = _gow6C8gq;
        "pkg-2.1.0-beta.1+1.21-1.21.1" = _RzGDT8bY;
        "pkg-2.1.0-beta.1+1.20.5-1.20.6" = _2PjbWGYq;
        "pkg-2.1.0-beta.1+1.20.3-1.20.4" = _pPOD4BjO;
        "pkg-2.1.0-beta.1+1.19.1" = _G9p3U7pE;
        "pkg-2.1.0-beta.1+1.19.4" = _WuTsY59X;
        "pkg-2.1.0-beta.1+1.20.2" = _EnLZEbQQ;
        "pkg-2.1.0-beta.1+1.21.11" = _JWo3PbIT;
        "pkg-2.1.0-beta.1+1.19" = _LN62TjkP;
        "pkg-2.1.0-beta.1+1.21.2-1.21.3" = _8tUcEbqs;
        "pkg-2.1.0-beta.1+1.21.9-1.21.10" = _K5Ze6wpa;
        "pkg-2.1.0-beta.1+1.21.6-1.21.8" = _hYfLg80U;
        "pkg-2.1.0-beta.1+1.21.5" = _5BaSafX3;
        "pkg-2.1.0-beta.1+1.21.4" = _ltnCbrDN;
        "pkg-2.1.0-beta.1+26.2.x" = _mn4RDA4e;
        "pkg-2.1.0-beta.1+26.1.x" = _9H9J1siu;
        "pkg-2.1.0-beta.2+1.19.2" = _zdRvISj2;
        "pkg-2.1.0-beta.2+1.20.2" = _AHPovJbL;
        "pkg-2.1.0-beta.2+1.20-1.20.1" = _4LH65Vw1;
        "pkg-2.1.0-beta.2+1.21.6-1.21.8" = _FyufbDs2;
        "pkg-2.1.0-beta.2+1.21.5" = _WKy135VR;
        "pkg-2.1.0-beta.2+1.19.3" = _by6GVv4r;
        "pkg-2.1.0-beta.2+1.20.5-1.20.6" = _NlmmMOyz;
        "pkg-2.1.0-beta.2+1.19.1" = _iKL4nSsA;
        "pkg-2.1.0-beta.2+1.21.9-1.21.10" = _gxDUslXj;
        "pkg-2.1.0-beta.2+1.19" = _EDUD5FQP;
        "pkg-2.1.0-beta.2+1.19.4" = _8peC3BsA;
        "pkg-2.1.0-beta.2+1.20.3-1.20.4" = _SVuLlqpV;
        "pkg-2.1.0-beta.2+1.21.2-1.21.3" = _FACa9D9J;
        "pkg-2.1.0-beta.2+1.21.11" = _SgNdGGJn;
        "pkg-2.1.0-beta.2+1.21-1.21.1" = _PAG6iAlk;
