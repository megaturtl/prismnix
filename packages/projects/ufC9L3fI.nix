...
let
    versions = (let
        ...
        _ZkGL49GS = {
            "id" = "ZkGL49GS";
            "file" = "legacy-bows-1.0.23.jar";
            "hash" = "sha512-1JryJ6BJJBdn9P2Xtt9JZhIfvWo2wuWRW1ogxOYzfvMvyQKS+N6G5brDozK6+i0akvaXvJwmr75eSMXvImJ7mw==";
        };
    in {
        "7EGoKW38" = _7EGoKW38;
        "mYVJVGCy" = _mYVJVGCy;
        ...
        "pkg-1.0.8" = _nCgyBFPE;
        "pkg-1.0.9" = _I8QQAZe7;
        "pkg-1.0.10" = _Gmlf2Dvn;
        "pkg-1.0.11" = _hwy2khii;
        "pkg-1.0.12" = _D6VcyQRT;
        "pkg-1.0.13" = _DXWly65O;
        "pkg-1.0.14" = _Z0NG8TQX;
        "pkg-1.0.15" = _MQBtTvLs;
        "pkg-1.0.16" = _eovnoFUo;
        "pkg-1.0.17" = _AH0ACoUO;
        "pkg-1.0.18" = _fcbee6TW;
        "pkg-1.0.19" = _IZ77M9ou;
        "pkg-1.0.20" = _ZfqQ7RKb;
        "pkg-1.0.21" = _VQyDwSUM;
        "pkg-1.0.22" = _r4C6wqSy;
        "pkg-1.0.23" = _ZkGL49GS;
        "default" = _ZkGL49GS;
    });
