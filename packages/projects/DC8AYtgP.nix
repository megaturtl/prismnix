...
let
    ...
    in {
        ...
        "pkg-1.1.0+mc1.20.5" = _C2mFF1mv;
        "pkg-1.1.0+mc1.21.1" = _M8wZYtyh;
        "pkg-1.1.0+mc1.21.3" = _pI1qwTxB;
        "pkg-1.1.0+mc1.21.4" = _NisgNIWA;
        "pkg-1.1.0+mc1.20.6" = _ylQMy30m;
        "pkg-1.1.0+mc1.21.5" = _PNzOOqcS;
        "pkg-1.1.0+mc1.21.6" = _tCsF4aQs;
        "pkg-2.0.1+1.21.6" = _P7pFWAFE;
        "pkg-2.0.1+1.21.5" = _OazzaGAT;
        "pkg-2.0.1+1.21.4" = _gRdAPdSm;
        "pkg-2.0.1+1.21.2" = _H6MqBk8h;
        "pkg-2.1.0+1.21.6" = _cqMwMgSy;
        "pkg-2.1.0+1.21.5" = _dbAWSLns;
        "pkg-2.1.0+1.21.4" = _i2pUjKlx;
        "pkg-2.1.0+1.21.2" = _XWMTL0Zb;
        "pkg-2.2.0+1.21.2" = _CRcdIrvu;
        "pkg-2.2.0+1.21.4" = _kP6fXMDi;
        "pkg-2.2.0+1.21.5" = _SsCsBH5k;
        "pkg-2.2.0+1.21.6" = _R0jMHtVh;
        "pkg-2.2.1+1.21.5" = _rpWDM0P8;
        "pkg-2.2.1+1.21.4" = _id8MYT4y;
        "pkg-2.2.1+1.21.2" = _Ne55dR1D;
        "pkg-2.2.1+1.21.6" = _nSs9x6iK;
        "pkg-v2.3.1+1.21.4" = _uivk1Tl5;
        "pkg-v2.3.1+1.21.2" = _E5ciuqIY;
        "pkg-v2.3.1+1.21.5" = _NxKGkxNb;
        "pkg-v2.3.1+1.21.6" = _AQh4RN8t;
        "pkg-2.3.1+1.21.1" = _3POL9AdC;
        "pkg-v2.4.0+1.21.1" = _3LSkSAgd;
        "pkg-v2.4.0+1.21.2" = _hZ8D6fMo;
        "pkg-v2.4.0+1.21.6" = _Uyu2UoYf;
        "pkg-v2.4.0+1.21.5" = _gf73USdf;
        "pkg-v2.4.0+1.21.4" = _q2zcJQRW;
        "pkg-v2.4.1+1.21.1" = _wkjPBkaT;
        "pkg-v2.4.1+1.21.2" = _SpIh1yXO;
        "pkg-v2.4.1+1.21.6" = _atRE44T6;
        "pkg-v2.4.1+1.21.4" = _1P4MgWJt;
        "pkg-v2.4.1+1.21.9" = _UCjh32vp;
        "pkg-v2.4.1+1.21.5" = _p2z2JYbd;
