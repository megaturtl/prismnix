...
let
    versions = (let
        ...
        _Hy48nehK = {
            "id" = "Hy48nehK";
            "file" = "Animated-Ore-with-Frames-0.1.18+mc1.20-26.3.zip";
            "hash" = "sha512-RNA3bXYwg9c/rDdHtBfX76cR7UCGMmVNiGoJJ6SMUCPS6Lj8rDPXJPtduvby15J5nnAHku/oA+s73xq2hm8BOQ==";
        };
    in {
        "MEq7XkuJ" = _MEq7XkuJ;
        "iXHWlLBN" = _iXHWlLBN;
        ...
        "minecraft-1.20" = _Hy48nehK;
        "minecraft-1.20.1" = _Hy48nehK;
        "minecraft-1.20.2" = _Hy48nehK;
        "minecraft-1.20.3" = _Hy48nehK;
        "minecraft-1.20.4" = _Hy48nehK;
        "minecraft-1.20.5" = _Hy48nehK;
        "minecraft-1.20.6" = _Hy48nehK;
        ...
        "minecraft-1.21" = _Hy48nehK;
        "minecraft-1.21.1" = _Hy48nehK;
        "minecraft-1.21.2" = _Hy48nehK;
        "minecraft-1.21.3" = _Hy48nehK;
        "minecraft-1.21.4" = _Hy48nehK;
        "minecraft-1.21.5" = _Hy48nehK;
        "minecraft-1.21.6" = _Hy48nehK;
        "minecraft-1.21.7" = _Hy48nehK;
        "minecraft-1.21.8" = _Hy48nehK;
        "minecraft-1.21.9" = _Hy48nehK;
        "minecraft-1.21.10" = _Hy48nehK;
        "minecraft-1.21.11" = _Hy48nehK;
        "minecraft-23w31a" = _Hy48nehK;
        "minecraft-23w32a" = _Hy48nehK;
        "minecraft-23w33a" = _Hy48nehK;
        "minecraft-23w35a" = _Hy48nehK;
        "minecraft-1.20.2-pre1" = _Hy48nehK;
        "minecraft-23w42a" = _Hy48nehK;
        "minecraft-23w43a" = _Hy48nehK;
        "minecraft-23w43b" = _Hy48nehK;
        "minecraft-23w44a" = _Hy48nehK;
        "minecraft-23w45a" = _Hy48nehK;
        "minecraft-23w46a" = _Hy48nehK;
        "minecraft-24w03a" = _Hy48nehK;
        "minecraft-24w03b" = _Hy48nehK;
        "minecraft-24w04a" = _Hy48nehK;
        "minecraft-24w05a" = _Hy48nehK;
        "minecraft-24w05b" = _Hy48nehK;
        "minecraft-24w06a" = _Hy48nehK;
        "minecraft-24w07a" = _Hy48nehK;
        "minecraft-24w09a" = _Hy48nehK;
        "minecraft-24w10a" = _Hy48nehK;
        "minecraft-24w11a" = _Hy48nehK;
        "minecraft-24w12a" = _Hy48nehK;
        "minecraft-24w13a" = _Hy48nehK;
        "minecraft-24w14potato" = _Hy48nehK;
        "minecraft-24w14a" = _Hy48nehK;
        "minecraft-1.20.5-pre1" = _Hy48nehK;
        "minecraft-1.20.5-pre2" = _Hy48nehK;
        "minecraft-1.20.5-pre3" = _Hy48nehK;
        "minecraft-24w18a" = _Hy48nehK;
        "minecraft-24w19a" = _Hy48nehK;
        "minecraft-24w19b" = _Hy48nehK;
        "minecraft-24w20a" = _Hy48nehK;
        "minecraft-24w33a" = _Hy48nehK;
        "minecraft-24w34a" = _Hy48nehK;
        "minecraft-24w35a" = _Hy48nehK;
        "minecraft-24w36a" = _Hy48nehK;
        "minecraft-24w37a" = _Hy48nehK;
        "minecraft-24w38a" = _Hy48nehK;
        "minecraft-24w39a" = _Hy48nehK;
        "minecraft-24w40a" = _Hy48nehK;
        "minecraft-1.21.2-pre1" = _Hy48nehK;
        "minecraft-1.21.2-pre2" = _Hy48nehK;
        "minecraft-24w44a" = _Hy48nehK;
        "minecraft-24w45a" = _Hy48nehK;
        "minecraft-24w46a" = _Hy48nehK;
        "minecraft-26.1" = _Hy48nehK;
        "minecraft-26.1.1" = _Hy48nehK;
        "minecraft-26.1.2" = _Hy48nehK;
        "minecraft-26.2" = _Hy48nehK;
        "minecraft-26.3" = _Hy48nehK;
        "pkg-0.1.0" = _MEq7XkuJ;
        "pkg-0.1.1" = _iXHWlLBN;
        "pkg-0.1.2" = _QS8J6nSc;
        "pkg-0.1.3" = _RO31KzCe;
        ...
        "pkg-0.1.8" = _MIwlykuN;
        "pkg-0.1.9" = _FB3CNzZY;
        "pkg-0.1.10" = _j9yDLEMf;
        "pkg-0.1.11" = _PFlAlrLG;
        "pkg-0.1.12" = _kJxSFKGA;
        "pkg-0.1.13" = _wAb1YfpU;
        "pkg-0.1.14" = _XgjefZXE;
        "pkg-0.1.15" = _NkPg0c19;
        "pkg-0.1.16" = _4iSS3MJP;
        "pkg-0.1.17" = _OxBJ5ckM;
        "pkg-0.1.18" = _Hy48nehK;
        "default" = _Hy48nehK;
    });
