...
let
    ...
    in {
        ...
        "pkg-1.4.8-1.21.11" = _Z7EukmZG;
        "pkg-1.4.8-1.21.4" = _InHZB8Aw;
        "pkg-1.4.8-1.21.5" = _1FgI8q6I;
        "pkg-1.4.8-1.21.6" = _W6RWHKmz;
        "pkg-1.4.8-1.21.1" = _ltadbW9L;
        "pkg-1.7.7-1.21.11-beta" = _Snlnzgo8;
        "pkg-1.8.0-1.21.11" = _F0FkjFAc;
        "pkg-1.8.0-1.21.10-Beta" = _JdoAthDJ;
        "pkg-1.8.0-1.21.9-Beta" = _cPIzLlwv;
        "pkg-1.8.0-1.21.8-Beta" = _QIatZsaL;
        "pkg-1.8.7-release-mc1.21.11" = _2UjqLuIu;
        "pkg-1.8.7-1.21.10" = _kd3FmS70;
        "pkg-1.8.7-1.21.9" = _JYLxLsqg;
        "pkg-1.8.9-mc1.21.11" = _eprTZ3ea;
        "pkg-1.9.0-mc1.21.11" = _eWjbnj96;
        "pkg-1.9.1-mc1.21.11" = _CjvfHecF;
