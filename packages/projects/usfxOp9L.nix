...
let
    versions = (let
        ...
        _qEE3YXH2 = {
            "id" = "qEE3YXH2";
            "file" = "aaron-1.21.1-1.19.0-build.22.jar";
            "hash" = "sha512-BZbFCOeDH1IOg6QgdrHkbq6m7/Totn7kud4sZ4hWr/16TPYX8f9ELjX9MdleUK0tyCU7DDhJ2S9HN2RGeCc4Jw==";
        };
        _djeCEQxf = {
            "id" = "djeCEQxf";
            "file" = "aaron-1.21.1-1.20.0-build.28.jar";
            "hash" = "sha512-3qxfNJ25JdIEARZdDRmgq83QdheLkb+GaVyRDdcc7TsxlfUGRdlmSyupP6aSIG24WOXXOCwRUdhq/7aaskNQ+Q==";
        };
        _Md3iAL0H = {
            "id" = "Md3iAL0H";
    ...
    in {
        ...
        "pkg-1.3.0-build.70" = _NHl2TBWh;
        "pkg-1.4.0-build.98" = _VTIycfpU;
        "pkg-1.5.0-build.141" = _1fMI12SL;
        "pkg-1.5.0-build.142" = _kh5nqRaj;
        "pkg-1.5.1-build.151" = _lwiBsAgw;
        "pkg-1.5.2-build.153" = _5URUEZCm;
        "pkg-1.5.3-build.168" = _HhMEQ6AM;
        "pkg-1.6.0-build.169" = _xavcguHj;
        "pkg-1.7.0-build.251" = _yL3F839d;
        "pkg-1.8.0-build.256" = _QXUonIKK;
        "pkg-1.9.0-build.259" = _zsRqXjUY;
        "pkg-1.10.0-build.263" = _BZaWxomy;
        "pkg-1.11.0-build.269" = _rgOeoaVe;
        "pkg-1.12.0-build.274" = _wIesmX72;
        "pkg-1.13.0-build.278" = _WWSXeJoK;
        "pkg-1.14.0-build.283" = _Mh0K2HVq;
        "pkg-1.15.0-build.298" = _WZwWn50T;
        "pkg-1.16.0-build.300" = _WvIyJFqF;
        "pkg-1.17.0-build.310" = _CmyWY8Nu;
        "pkg-1.17.1-build.11" = _w6onz4rP;
        "pkg-1.17.1-build.24" = _AJH95QCV;
        "pkg-1.18.0-build.15" = _gGFzW6E1;
        "pkg-1.18.1-build.18" = _LYg9bJbK;
