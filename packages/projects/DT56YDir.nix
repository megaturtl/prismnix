...
let
    ...
    in {
        ...
        "pkg-v4.1.0-1.19.1-Fabric" = _losVr9Ku;
        "pkg-v4.1.1-1.19.1-Forge" = _zhUlJODG;
        "pkg-v4.1.1-1.19.1-Fabric" = _Z71VgyFn;
        "pkg-v4.1.2-1.19.1-Forge" = _5thu1aB3;
        "pkg-v4.1.2-1.19.1-Fabric" = _WNfBStcf;
        "pkg-v4.2.0-1.19.2-Forge" = _azlVwNBS;
        "pkg-v4.2.0-1.19.2-Fabric" = _b4OyHsy8;
        "pkg-v4.2.1-1.19.2-Fabric" = _O26xnQrT;
        "pkg-v4.2.1-1.19.2-Forge" = _26Tz7Yq6;
        "pkg-v4.2.2-1.19.2-Fabric" = _YlRvFrvp;
        "pkg-v4.2.2-1.19.2-Forge" = _3bAlB7io;
        "pkg-v4.2.3-1.19.2-Forge" = _OtdzVGEL;
        "pkg-v4.2.3-1.19.2-Fabric" = _QAUoBfgs;
        "pkg-v4.2.4-1.19.2-Fabric" = _aJSTYaWM;
        "pkg-v4.2.4-1.19.2-Forge" = _bDZAhOEY;
        "pkg-v4.2.5-1.19.2-Forge" = _p0twduHK;
        "pkg-v4.2.5-1.19.2-Fabric" = _VTaGbf6d;
        "pkg-v4.2.6-1.19.2-Fabric" = _ymXrLgDX;
        "pkg-v4.2.6-1.19.2-Forge" = _ohprMCo2;
        "pkg-v4.2.7-1.19.2-Fabric" = _UpgLyxl0;
        "pkg-v4.2.7-1.19.2-Forge" = _vne7jgAD;
        "pkg-v4.2.8-1.19.2-Forge" = _a1lGnmrs;
        "pkg-v4.2.8-1.19.2-Fabric" = _NrV6vMfh;
        "pkg-v4.2.9-1.19.2-Forge" = _u8YcS6lO;
        "pkg-v4.2.9-1.19.2-Fabric" = _l2bbr0LG;
        "pkg-v4.2.10-1.19.2-Forge" = _Y43ZXclB;
        "pkg-v4.2.10-1.19.2-Fabric" = _DkBi6RMV;
        "pkg-v4.2.11-1.19.2-Fabric" = _gr2TP36R;
        "pkg-v4.2.11-1.19.2-Forge" = _tV82IigQ;
        "pkg-v4.2.12-1.19.2-Forge" = _zgLTJA05;
        "pkg-v4.2.12-1.19.2-Fabric" = _Z7PTQPFj;
        "pkg-v4.2.13-1.19.2-Forge" = _2xPaGrQ4;
        "pkg-v4.2.13-1.19.2-Fabric" = _As6BEzpc;
        "pkg-v4.2.14-1.19.2-Forge" = _ZUukTpOg;
        "pkg-v4.2.14-1.19.2-Fabric" = _YeTZTNZ9;
        "pkg-v4.2.15-1.19.2-Forge" = _N4CkR58u;
        "pkg-v4.2.15-1.19.2-Fabric" = _JEm0IPnv;
        "pkg-v5.0.0-1.19.3-Fabric" = _JqFLBNFr;
        "pkg-v5.0.0-1.19.3-Forge" = _X8afYDno;
        "pkg-v6.0.0-1.19.4-Fabric" = _Yu06XVOg;
        "pkg-v6.0.0-1.19.4-Forge" = _5Z8JIyyR;
        "pkg-v7.0.0-1.20-Forge" = _4ZMHjc90;
        "pkg-v7.0.0-1.20-Fabric" = _uUI9TiSJ;
        "pkg-v8.0.0-1.20.1-Forge" = _3mpPAuYk;
        "pkg-v8.0.0-1.20.1-Fabric" = _zJHxVFXO;
        "pkg-v3.1.0-1.18.2-Forge" = _IqAGEWJG;
        "pkg-v3.1.0-1.18.2-Fabric" = _9KMATEbM;
        "pkg-v21.1.0-1.21.1-Fabric" = _kw9tDOt4;
        "pkg-v21.1.0-1.21.1-NeoForge" = _pb20n5du;
        "pkg-v21.1.1-1.21.1-Fabric" = _rO7yQULq;
        "pkg-v21.1.1-1.21.1-NeoForge" = _mR1uZiCq;
        "pkg-v21.1.2-1.21.1-Fabric" = _LPUj3hIB;
        "pkg-v21.1.2-1.21.1-NeoForge" = _bF0gE7VX;
        "pkg-v21.1.3-1.21.1-Fabric" = _2O1qDXjo;
        "pkg-v21.1.3-1.21.1-NeoForge" = _xrjo4njB;
        "pkg-v21.3.0-1.21.3-Fabric" = _OD5w0tUG;
        "pkg-v21.3.0-1.21.3-NeoForge" = _JbsZFdg7;
        "pkg-v21.4.0-1.21.4-Fabric" = _q78Wsah6;
        "pkg-v21.4.0-1.21.4-NeoForge" = _KvaVdaHU;
        "pkg-v21.4.1-1.21.4-Fabric" = _BwdublWv;
        "pkg-v21.4.1-1.21.4-NeoForge" = _bpVd70uv;
        "pkg-v21.1.4-1.21.1-Fabric" = _rgW1SHji;
        "pkg-v21.1.4-1.21.1-NeoForge" = _RAduAOZ4;
        "pkg-v21.4.2-1.21.4-Fabric" = _EYYu8HEY;
        "pkg-v21.4.2-1.21.4-NeoForge" = _NJ4eET3Q;
        "pkg-v21.5.0-1.21.5-Fabric" = _ugPpAcbv;
        "pkg-v21.5.0-1.21.5-NeoForge" = _fjYiCKHs;
        "pkg-v21.1.5-1.21.1-Fabric" = _843JnozM;
        "pkg-v21.1.5-1.21.1-NeoForge" = _58sx3nKX;
        "pkg-v21.5.1-1.21.5-Fabric" = _mdxjvzLy;
        "pkg-v21.5.1-1.21.5-NeoForge" = _Ow9d4VqO;
        "pkg-v21.6.0-1.21.6-Fabric" = _nY3Vl1Ad;
        "pkg-v21.6.0-1.21.6-NeoForge" = _6evgWln4;
        "pkg-v21.7.0-1.21.7-Fabric" = _avXmnhyZ;
        "pkg-v21.7.0-1.21.7-NeoForge" = _hdp5VG9y;
        "pkg-v21.8.0-1.21.8-Fabric" = _BQQN2znM;
        "pkg-v21.8.0-1.21.8-NeoForge" = _o3LtDq4k;
        "pkg-v21.1.6-1.21.1-Fabric" = _Kke2ZSg0;
        "pkg-v21.1.6-1.21.1-NeoForge" = _pllSFipO;
        "pkg-v21.8.1-1.21.8-Fabric" = _xvoO7dBK;
        "pkg-v21.8.1-1.21.8-NeoForge" = _eTM2LlAM;
        "pkg-21.9.0" = _3q0QioeR;
        "pkg-21.10.0" = _rnpu1sF7;
        "pkg-21.10.1" = _uk1VMseV;
        "pkg-21.10.2" = _UGSbkxgz;
        "pkg-21.10.3" = _t65ukt1p;
        "pkg-21.11.0" = _6VmaR26k;
        "pkg-21.11.1" = _hqiDrTkf;
        "pkg-21.11.2" = _MuPwsQLB;
