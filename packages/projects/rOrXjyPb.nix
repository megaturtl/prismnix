...
let
    ...
    in {
        ...
        "pkg-1.3+1.21" = _PbEf1FG5;
        "pkg-1.4+1.21" = _NtQH9tCs;
        "pkg-1.4+1.21.2-SNAPSHOT.1" = _sNM4NylR;
        "pkg-1.5+1.21" = _uWX4fFmd;
        "pkg-1.5+1.21.2" = _CKQr1Q6j;
        "pkg-1.5+1.21.4-SNAPSHOT.1" = _njajmMKR;
        "pkg-1.6+1.21.3" = _PMAWThKU;
        "pkg-1.6+1.21.1" = _xZUnEmSi;
        "pkg-1.7+1.21.1" = _Lh0j9Iaj;
        "pkg-1.7+1.21.3" = _1tJKdYgy;
        "pkg-1.8+1.21.3" = _pGHk9cJS;
        "pkg-1.8+1.21.1" = _dj7k0i1W;
        "pkg-1.8+1.21.4-SNAPSHOT.2" = _9G5d5KPO;
        "pkg-1.8+1.21.4-SNAPSHOT.3" = _u3KzhEnV;
        "pkg-1.9+1.21.4-SNAPSHOT.4" = _stA8rQKY;
        "pkg-1.9+1.21.4" = _2KYUIlgb;
        "pkg-1.9+1.21.5-SNAPSHOT.1" = _M56yCwOe;
        "pkg-1.9+1.21.5-SNAPSHOT.2" = _QEJtKvqU;
        "pkg-1.9+1.21.5-SNAPSHOT.3" = _ftUkOEwz;
        "pkg-1.9+1.21.5-SNAPSHOT.4" = _T3F0SCYC;
        "pkg-1.9+1.21.5-SNAPSHOT.5" = _SFldB1oY;
        "pkg-1.9+1.21.5" = _WnUf6SHe;
        "pkg-1.10+1.21.5" = _vhLWxGWo;
        "pkg-1.10+1.21.6-SNAPSHOT.1" = _Oq74mxe3;
        "pkg-1.11+1.21.5" = _ojYdtPGY;
        "pkg-1.11+1.21.6-SNAPSHOT.1" = _CKRnq94L;
        "pkg-1.11+1.21.6-SNAPSHOT.2" = _TxN3Y6h1;
        "pkg-1.11+1.21.6-SNAPSHOT.5" = _1XRS1VGU;
        "pkg-1.11+1.21.1" = _G6GN2FRZ;
        "pkg-1.11+1.21.3" = _rjID1H40;
        "pkg-1.11+1.21.4" = _PardIk4R;
        "pkg-1.11+1.21.6-SNAPSHOT.6" = _KwLU5HYF;
        "pkg-1.11+1.21.6-Pre.1" = _3HFL9M7G;
        "pkg-1.11+1.21.6-Pre.3" = _s5VPfZoS;
        "pkg-1.11+1.21.6-beta.1" = _1O60m9jE;
        "pkg-1.11+1.21.6" = _A1kzOtCj;
        "pkg-2.0+1.21.5-NeoForge" = _niKgFQK1;
        "pkg-2.0+1.21.5-Fabric" = _bZVB34g9;
        "pkg-2.0+1.21.6-Fabric" = _HnUH2VzI;
        "pkg-2.0+1.21.6-NeoForge" = _YFfm7fAN;
        "pkg-2.0+1.21.8" = _GShDEADr;
        "pkg-2.1+1.21.8" = _N93u7jcr;
        "pkg-2.1+1.21.9-pre1" = _Nby30GW6;
        "pkg-2.1+1.21.1" = _BQpbYtxl;
        "pkg-2.1+1.21.3" = _nQlwlXkw;
        "pkg-2.1+1.21.4" = _m6GJY5AA;
        "pkg-2.1+1.21.9-rc1" = _ipwtDKcB;
        "pkg-2.1+1.21.9-Beta.1" = _Rjv5Mrrs;
        "pkg-2.1+1.21.10-rc1" = _Od8FmRW1;
        "pkg-2.1+1.21.9" = _lD1YuMw4;
        "pkg-2.1+1.21.10" = _LNNdu5Tb;
        "pkg-2.2+1.21.10" = _CqHB9bGd;
        "pkg-2.2+1.21.11" = _i3xmB6Re;
        "pkg-2.2+26.1" = _hmAecKq0;
        "pkg-2.2+26.1-SNAPSHOT.2" = _YoFEPduW;
        "pkg-2.2+26.1-SNAPSHOT.4" = _Xt4OPbAa;
        "pkg-2.3+1.21.11" = _tQphSqvQ;
        "pkg-2.3+1.21.10" = _MNI7QAHS;
        "pkg-2.3+26.1-SNAPSHOT.4" = _Ic5OBINX;
        "pkg-2.3+26.1-SNAPSHOT.5" = _kwqs7kqt;
        "pkg-2.3+26.1-SNAPSHOT.6" = _jxFq9scn;
        "pkg-2.3+26.1-SNAPSHOT.9" = _1qXPPfuz;
        "pkg-2.3+26.1-pre.1" = _UouGS09M;
        "pkg-2.3+26.1-pre.2" = _3s5czG19;
        "pkg-2.3+26.1" = _3tCxQwOE;
        "pkg-2.3+26.1.2" = _izT1tIBD;
        "pkg-2.3+26.2" = _aquqq6KW;
        "pkg-2.3+26.3-snapshot-1" = _r5qMVSDC;
        "pkg-2.3+26.3-snapshot-2" = _egW5nGpA;
        "pkg-2.3+1.21.1" = _9eKKwbpc;
        "pkg-2.3+26.3-snapshot-3" = _OkZCEA9n;
        "pkg-2.4+26.2" = _zLQSZguP;
