...
let
    ...
    in {
        ...
        "pkg-2.3.8+1.16.5" = _HIybCsMc;
        "pkg-3.1.0+1.18.2" = _HYLGBwYC;
        "pkg-3.1.0+1.19" = _jJqGuDzK;
        "pkg-3.1.0+1.19-forge" = _YTHLE7p6;
        "pkg-3.1.0+1.18.2-forge" = _tOO3APoE;
        "pkg-3.1.1+1.18.2-fabric" = _7cNhz0i5;
        "pkg-3.1.1+1.18.2-forge" = _5OnwxuFO;
        "pkg-3.1.1+1.19-fabric" = _HKDGqnCy;
        "pkg-3.1.1+1.19-forge" = _GlN8pQc1;
        "pkg-3.1.2+1.19.2-fabric" = _amfXOcfe;
        "pkg-3.1.2+1.19.2-forge" = _K5aHmz7K;
        "pkg-3.1.3+1.19.2-fabric" = _K5IR07m0;
        "pkg-3.1.3+1.19.2-forge" = _RRdd4LZR;
        "pkg-3.0.6+1.17.1" = _YmTc1sqZ;
        "pkg-3.1.2+1.18.2-fabric" = _xMXGBIqi;
        "pkg-3.1.2+1.18.2-forge" = _oivEJPZU;
        "pkg-2.3.9+1.16.5" = _qkKq5Y3s;
        "pkg-3.2.0+1.19.2-fabric" = _JABCGVHi;
        "pkg-3.2.0+1.19.2-forge" = _GUtjL6iz;
        "pkg-3.1.3+1.18.2-forge" = _X9kvHjfl;
        "pkg-3.1.3+1.18.2-fabric" = _nInoI24y;
        "pkg-3.2.1+1.19.2-fabric" = _yKbQFAvi;
        "pkg-3.2.1+1.19.2-forge" = _edkd3fhm;
        "pkg-3.2.2+1.19.2-fabric" = _luwoDnlv;
        "pkg-3.2.2+1.19.2-forge" = _xA1gdRlk;
        "pkg-3.2.3+1.19.3-fabric" = _eqbglOsx;
        "pkg-3.2.3+1.19.3-forge" = _uFWYJ6pA;
        "pkg-3.2.4+1.19.3-fabric" = _qmDMHcFL;
        "pkg-3.2.4+1.19.3-forge" = _akDwcTSC;
        "pkg-3.2.5+1.19.4-fabric" = _XeZEGwBe;
        "pkg-3.2.5+1.19.4-forge" = _tJ36ak4H;
        "pkg-3.3.0+1.19.4-fabric" = _76dn1by8;
        "pkg-3.3.0+1.19.4-forge" = _Z3AaF25Y;
        "pkg-3.3.1+1.19.4-fabric" = _iWnECN0F;
        "pkg-3.3.1+1.19.4-forge" = _AzMOJSGc;
        "pkg-4.0.1+1.20-fabric" = _yYR6Uhfj;
        "pkg-4.0.2+1.20-fabric" = _ewmGUeMg;
        "pkg-4.0.2+1.20-forge" = _xeRSvMD7;
        "pkg-4.0.3+1.20-fabric" = _Ah2mQcI5;
        "pkg-4.0.3+1.20-forge" = _UTDibU6w;
        "pkg-3.4.0+1.19.4-fabric" = _ZmfCoxET;
        "pkg-3.4.0+1.19.4-forge" = _qeGD3EAf;
        "pkg-4.0.4+1.20.1-fabric" = _gVxjsEiQ;
        "pkg-4.0.4+1.20.1-forge" = _QMp2SF1u;
        "pkg-4.0.5+1.20.2-fabric" = _R21bN3KV;
        "pkg-4.0.5+1.20.2-forge" = _J16uwjc5;
        "pkg-3.4.0+1.18.2-fabric" = _j8r1ngXI;
        "pkg-3.4.0+1.18.2-forge" = _r6yvRbOC;
        "pkg-3.4.1+1.18.2-fabric" = _N1JoFNcV;
        "pkg-3.4.1+1.18.2-forge" = _UUxq5wCT;
        "pkg-3.4.1+1.19.4-fabric" = _z4k45Emw;
        "pkg-3.4.1+1.19.4-forge" = _34tMKYwY;
        "pkg-4.0.7+1.20.2-fabric" = _WXMDQsb9;
        "pkg-4.0.7+1.20.2-forge" = _oR2bV3V6;
        "pkg-3.4.2+1.19.4-fabric" = _gpK4bBce;
        "pkg-3.4.2+1.19.4-forge" = _XPeW5O4k;
        "pkg-3.4.2+1.18.2-fabric" = _IMh2PEc1;
        "pkg-3.4.2+1.18.2-forge" = _DIXNDfWe;
        "pkg-3.4.3+1.18.2-forge" = _oaTmcpMI;
        "pkg-3.4.3+1.18.2-fabric" = _BnlSAdGN;
        "pkg-3.4.3+1.19.4-fabric" = _zimHFP9X;
        "pkg-3.4.3+1.19.4-forge" = _Xq3hPnLg;
        "pkg-4.0.8+1.20.4-fabric" = _R23hymvz;
        "pkg-4.0.8+1.20.4-forge" = _mzoAkveB;
        "pkg-3.4.4+1.18.2-forge" = _Wqh1cfgc;
        "pkg-3.4.4+1.18.2-fabric" = _oK5MfPFI;
        "pkg-3.4.4+1.19.4-fabric" = _8GimyOK5;
        "pkg-3.4.4+1.19.4-forge" = _X0Px9VBU;
        "pkg-4.1.0+1.20.4-fabric" = _r6EhfuUa;
        "pkg-4.1.0+1.20.4-forge" = _4qIzTWMY;
        "pkg-4.1.0-alpha.1+1.20.6-fabric" = _LT5Ayo6i;
        "pkg-4.1.0-alpha.2+1.20.6-fabric" = _gyWwCcmu;
        "pkg-4.1.0-alpha.3+1.20.6-fabric" = _jCEJBJU3;
        "pkg-4.1.0-alpha.4+1.20.6-fabric" = _EAAU9QmO;
        "pkg-4.1.0-alpha.4+1.20.6-neoforge" = _mmgNaOOK;
        "pkg-4.1.0+1.20.6-fabric" = _awjsas26;
        "pkg-4.1.0+1.20.6-neoforge" = _Supi3Kwm;
        "pkg-4.1.1+1.20.6-fabric" = _LNexvvOy;
        "pkg-4.1.1+1.20.6-neoforge" = _LFXicTKX;
        "pkg-5.0.0+1.21-fabric" = _MbRc4uaV;
        "pkg-5.0.0+1.21-neoforge" = _36jbAWJS;
        "pkg-5.0.1+1.21-fabric" = _S7lWbchC;
        "pkg-5.0.1+1.21-neoforge" = _yy7E6BDq;
        "pkg-4.1.2+1.20.6-fabric" = _N7CEwrOP;
        "pkg-4.1.2+1.20.6-neoforge" = _FpfCw9X3;
        "pkg-4.1.3+1.20.6-fabric" = _lrEmpuxH;
        "pkg-5.0.2+1.21-fabric" = _FeeyACJe;
        "pkg-4.1.3+1.20.6-neoforge" = _NxsQ3skp;
        "pkg-5.0.2+1.21-neoforge" = _wmyPc8O8;
        "pkg-4.1.4+1.20.6-fabric" = _2BgMtRO0;
        "pkg-4.1.4+1.20.6-neoforge" = _GXua8K6B;
        "pkg-5.0.3+1.21-fabric" = _UwrKcvor;
        "pkg-5.0.3+1.21-neoforge" = _mwQdfOaG;
        "pkg-3.4.5+1.18.2-fabric" = _vst0SQOn;
        "pkg-3.4.5+1.18.2-forge" = _uJWnsQMt;
        "pkg-3.4.6+1.18.2-fabric" = _qJ3IREvK;
        "pkg-3.4.6+1.18.2-forge" = _aFE2WIi6;
        "pkg-5.0.4+1.21-fabric" = _d0SjJDnR;
        "pkg-5.0.4+1.21-neoforge" = _PNfXTL9Z;
        "pkg-3.4.5+1.19.4-fabric" = _FhvqasQq;
        "pkg-3.4.5+1.19.4-forge" = _vaplSylR;
        "pkg-4.2.0+1.20.6-fabric" = _T21GoGt8;
        "pkg-4.2.0+1.20.6-forge" = _AmmyZQwN;
        "pkg-4.2.0+1.20.6-neoforge" = _DBUvi7oX;
        "pkg-5.1.0+1.21.1-fabric" = _O0038fY0;
        "pkg-5.1.0+1.21.1-forge" = _4c1CcXsx;
        "pkg-5.1.0+1.21.1-neoforge" = _MYapChJ6;
        "pkg-5.1.1+1.21-fabric" = _QjnJzVCb;
        "pkg-5.1.1+1.21-forge" = _OUoLU0Qn;
        "pkg-5.1.1+1.21-neoforge" = _o6bo80SX;
        "pkg-5.1.1+1.21.1-fabric" = _ZEhGh0Mi;
        "pkg-5.1.1+1.21.1-forge" = _Zi1vyNFj;
        "pkg-5.1.1+1.21.1-neoforge" = _DZh5Nqom;
        "pkg-5.1.2+1.21-fabric" = _S1SXuzb2;
        "pkg-5.1.2+1.21-forge" = _bqu9WKPN;
        "pkg-4.2.1+1.20.6-fabric" = _N59VN1ZQ;
        "pkg-5.1.2+1.21-neoforge" = _7D78snBY;
        "pkg-4.2.1+1.20.6-forge" = _qJxhVsaz;
        "pkg-4.2.1+1.20.6-neoforge" = _2ooPKbER;
        "pkg-5.1.2+1.21.1-fabric" = _RK2ApgKw;
        "pkg-5.1.2+1.21.1-forge" = _u82CgsAx;
        "pkg-5.1.2+1.21.1-neoforge" = _4oxkavl4;
        "pkg-5.2.0+1.21.3-fabric" = _jNAwWToR;
        "pkg-5.2.0+1.21.3-forge" = _BgD4HtIx;
        "pkg-5.2.0+1.21.3-neoforge" = _cQWd7bnC;
        "pkg-5.2.1+1.21.3-fabric" = _PphJdojc;
        "pkg-5.2.1+1.21.3-forge" = _voA9EmUH;
        "pkg-5.2.1+1.21.3-neoforge" = _8N0RZC5x;
        "pkg-5.2.2+1.21.4-fabric" = _L4CUJgGW;
        "pkg-5.2.2+1.21.4-forge" = _DZayA3tC;
        "pkg-5.2.2+1.21.4-neoforge" = _U6EZBMci;
        "pkg-5.1.3+1.21.1-fabric" = _cd1xtIjE;
        "pkg-5.1.3+1.21.1-forge" = _t8GactqX;
        "pkg-5.1.3+1.21.1-neoforge" = _eSircrMQ;
        "pkg-5.2.2+1.21.3-fabric" = _Fjq6a8JR;
        "pkg-5.2.2+1.21.3-forge" = _q6ZtptFW;
        "pkg-5.2.2+1.21.3-neoforge" = _USlzzmd5;
        "pkg-5.2.3+1.21.4-fabric" = _fy4w1xut;
        "pkg-5.2.3+1.21.4-forge" = _YmoJueMz;
        "pkg-5.2.3+1.21.4-neoforge" = _X6lCAYF0;
        "pkg-5.2.4+1.21.4-fabric" = _idZLXMFh;
        "pkg-5.2.4+1.21.4-forge" = _XbaSTy7B;
        "pkg-5.2.4+1.21.4-neoforge" = _CnItpKOw;
        "pkg-5.2.5+1.21.5-fabric" = _4gWcEHjd;
        "pkg-5.2.5+1.21.5-forge" = _UeH3Pf2d;
        "pkg-5.2.5+1.21.5-neoforge" = _76FW9ioA;
        "pkg-5.1.6+1.21.1-fabric" = _JsQSznSp;
        "pkg-5.1.6+1.21.1-forge" = _bwMvGnfc;
        "pkg-5.1.6+1.21.1-neoforge" = _psdIbUbg;
        "pkg-5.2.6+1.21.3-fabric" = _lyWqI3Rl;
        "pkg-5.2.6+1.21.3-forge" = _Z6h4MBCh;
        "pkg-5.2.6+1.21.3-neoforge" = _zUTDhdo0;
        "pkg-5.2.6+1.21.4-fabric" = _zZfEoJB1;
        "pkg-5.2.6+1.21.4-forge" = _5h6o8uKT;
        "pkg-5.2.6+1.21.4-neoforge" = _eGROc5cK;
        "pkg-5.2.6+1.21.5-fabric" = _mMHUyoWs;
        "pkg-5.2.6+1.21.5-forge" = _EOgqvBin;
        "pkg-5.2.6+1.21.5-neoforge" = _1Q4lYVH6;
        "pkg-5.2.7+1.21.6-fabric" = _uKUntdmF;
        "pkg-5.2.7+1.21.6-forge" = _5r4f1iPp;
        "pkg-5.2.7+1.21.6-neoforge" = _UPp1sWeD;
        "pkg-5.2.8+1.21.7-fabric" = _os3K6gc6;
        "pkg-5.2.8+1.21.7-neoforge" = _6DZQrIEl;
        "pkg-5.2.8+1.21.7-forge" = _XJ1RiQAI;
        "pkg-5.2.9+1.21.9-fabric" = _OUMcMS4M;
        "pkg-5.2.9+1.21.9-neoforge" = _iKsGPZGz;
        "pkg-5.2.10+1.21.8-fabric" = _Z5qWAXvj;
        "pkg-5.2.10+1.21.8-forge" = _D1Eq1JRZ;
        "pkg-5.2.10+1.21.8-neoforge" = _a4RbAjUN;
        "pkg-5.2.10+1.21.9-fabric" = _YaftlK6O;
        "pkg-5.2.10+1.21.9-forge" = _FNZif24x;
        "pkg-5.2.10+1.21.9-neoforge" = _oPpIcDxQ;
        "pkg-5.1.7+1.21.1-fabric" = _DVcJhci5;
        "pkg-5.1.7+1.21.1-forge" = _jpRw37kz;
        "pkg-5.1.7+1.21.1-neoforge" = _NarvrcDF;
        "pkg-5.2.11+1.21.8-fabric" = _hFSSWjId;
        "pkg-5.2.11+1.21.8-forge" = _6x1NKa6m;
        "pkg-5.2.11+1.21.8-neoforge" = _tW0KCKiu;
        "pkg-5.2.11+1.21.9-fabric" = _4DMOp59l;
        "pkg-5.2.11+1.21.9-forge" = _x0IIFDZf;
        "pkg-5.2.11+1.21.9-neoforge" = _o2lU1r4q;
        "pkg-4.2.2+1.20.6-fabric" = _IcTn3mz1;
        "pkg-4.2.2+1.20.6-forge" = _NnI1Dhvj;
        "pkg-4.2.2+1.20.6-neoforge" = _sTaNGEon;
        "pkg-5.1.8+1.21.1-fabric" = _nGPvABlf;
        "pkg-5.1.8+1.21.1-forge" = _LMlD2CWK;
        "pkg-5.1.8+1.21.1-neoforge" = _EXXWm5xF;
        "pkg-5.2.12+1.21.8-fabric" = _XWxojbLp;
        "pkg-5.2.12+1.21.8-forge" = _GQMQcl7s;
        "pkg-5.2.12+1.21.8-neoforge" = _J8L51LrZ;
        "pkg-5.2.12+1.21.9-fabric" = _Pq4bDUO1;
        "pkg-5.2.12+1.21.9-forge" = _lhCjNVjH;
        "pkg-5.2.12+1.21.9-neoforge" = _1gSfFk5V;
        "pkg-5.2.13+1.21.10-fabric" = _Tu7L0xsA;
        "pkg-5.2.13+1.21.10-forge" = _J1PRL9YF;
        "pkg-5.2.13+1.21.10-neoforge" = _zWxLWTbU;
        "pkg-5.2.14+1.21.11-fabric" = _8Z4OG11C;
        "pkg-5.2.14+1.21.11-neoforge" = _Ql7PKWdc;
        "pkg-5.2.15+1.21.11-fabric" = _2lPKqJBJ;
        "pkg-5.2.15+1.21.11-forge" = _LubO1QGA;
        "pkg-5.2.15+1.21.11-neoforge" = _SuWUh5RZ;
        "pkg-5.1.9+1.21.1-fabric" = _NSrItCES;
        "pkg-5.1.9+1.21.1-forge" = _3dlXcI0n;
        "pkg-5.1.9+1.21.1-neoforge" = _IuqNIoAi;
        "pkg-5.2.16+1.21.11-fabric" = _rZovgkWT;
        "pkg-5.2.16+1.21.11-forge" = _yFmVkjkC;
        "pkg-5.2.16+1.21.11-neoforge" = _GfweYsB6;
        "pkg-5.2.17+26.1-fabric" = _3EfdBmjb;
        "pkg-5.2.17+26.1-neoforge" = _V5W7EL1K;
        "pkg-5.2.18+26.1-fabric" = _ZkGgdpPY;
        "pkg-5.2.18+26.1-neoforge" = _5mdIRt7O;
        "pkg-5.3.0+26.1.1-fabric" = _Yn66yzx3;
        "pkg-5.3.0+26.1.1-neoforge" = _wk3F1kax;
        "pkg-5.3.1+26.2-fabric" = _usQ3Kyvp;
        "pkg-5.3.1+26.2-neoforge" = _UpVdxQTS;
        "pkg-5.4.0+26.1.1-fabric" = _l7gept3U;
