...
let
    ...
    in {
        ...
        "pkg-1.1.1" = _xo1sLS9y;
        "pkg-1.2.0" = _xY02TDP5;
        "pkg-1.2.0+1.21.2" = _YIMIItLE;
        "pkg-1.2.0+1.21.3" = _AM8VRGfe;
        "pkg-1.2.0+1.21.4" = _Yv43AIOq;
        "pkg-1.2.0+1.21.5" = _Po0jWG2C;
        "pkg-1.2.1+1.21.5" = _Mf89uVHM;
        "pkg-1.2.2+1.21.5" = _JniLM35a;
        "pkg-1.2.0.1" = _Nm6W1EOJ;
        "pkg-1.2.0.1+1.21.2" = _Su6Ndqhv;
        "pkg-1.2.0.1+1.21.3" = _PD4MCTmu;
        "pkg-1.2.0.1+1.21.4" = _Up37IzNR;
        "pkg-1.2.3+1.21.5" = _Ep0KveCm;
        "pkg-1.3.0+1.21.1" = _DyGOwGa3;
        "pkg-1.3.1+1.21.1" = _beKaZXNT;
        "pkg-1.3.2+1.21.1" = _p8igbdLA;
        "pkg-1.2.4+1.21.5" = _1HGBh66G;
        "pkg-1.3.3+1.21.1" = _VhdRVjJt;
        "pkg-1.3.3+1.21.2" = _luGkjfjF;
        "pkg-1.3.3+1.21.3" = _ZnCKXCYU;
        "pkg-1.3.3+1.21.4" = _CaP988jW;
        "pkg-1.3.3+1.21.5" = _2Ov3q0Bx;
