...
let
    versions = (let
        ...
        _NyPF7e8L = {
            "id" = "NyPF7e8L";
            "file" = "pmmo-26.2.0-2.8.37.jar";
            "hash" = "sha512-ysFbkadQ7szC48niiCMDUfMCmhuqzdTfqipNL4hG25j+/khw4v5XEpot3PRDyIo5Dpmh8naETkmnEQUl1vIJ/Q==";
        };
        _t8Lo9UQk = {
            "id" = "t8Lo9UQk";
            "file" = "pmmo-26.1.2-2.8.35.jar";
            "hash" = "sha512-ChPSmxBtqpM2BtcgooO2pUANBqkKrcuHdj/FJe0GvgIrV2Bn2kfK3ud+LWXCILFke6NjHKIWvyF/SWdk+GUAdA==";
        };
        _9lu4zNd1 = {
            "id" = "9lu4zNd1";
            "file" = "pmmo-1.21.1-2.10.47.jar";
            "hash" = "sha512-xfTAAAvNuEezbf4R/Ei/sXv/Npbyvn9E8DqO0JSQw90Ghk65FDISUfZaeQWbrEvkeoAMQn6Lq16SqUk5lpPAZw==";
        };
        _2mgsNmNS = {
            "id" = "2mgsNmNS";
            "file" = "pmmo-26.2.0-2.9.38.jar";
            "hash" = "sha512-wv06X4Mz81KZtJWXhHKO12qeFl2HnoAPokUZuePKO43tYQkA0ckhTMsGnNZA/ZZvnT6dooemnXAPMpOLVC2z+Q==";
        };
        _gWvhHmPG = {
            "id" = "gWvhHmPG";
    ...
    in {
        ...
        "neoforge-1.21" = _9lu4zNd1;
        "neoforge-1.21.1" = _9lu4zNd1;
        ...
        "pkg-4.0.2" = _q3xJRoiS;
        "pkg-1.0.2" = _hQICCRVU;
        "pkg-1.19.2-2.1.0" = _izS49MV5;
        "pkg-1.19.2-2.1.1" = _tiAdeHJW;
        "pkg-1.19.2-2.1.2" = _Nvu4XUCN;
        "pkg-1.18.2-5.1.0" = _rgPYi3c5;
        "pkg-1.19-2.1.3" = _yHdH6MX8;
        "pkg-1.18.2-5.1.1" = _Vmw8xE1t;
        "pkg-1.19-2.1.4" = _yfw5MvS0;
        "pkg-1.18.2-5.1.2" = _H1D6zpZ9;
        "pkg-1.19-2.1.5" = _WuCCiptq;
        "pkg-1.18.2-5.1.3" = _DdSlZNMq;
        "pkg-1.16.5-3.67.7" = _OPZgc0oG;
        "pkg-1.19-3.0.0" = _u5jk0GH5;
        "pkg-1.18.2-6.0.0" = _1xx6CbSR;
        "pkg-1.19-3.0.1" = _UWZr1V0P;
        "pkg-1.18.2-6.0.1" = _wNtx50HK;
        "pkg-1.16.5-3.68.0" = _7ICYBAtI;
        "pkg-1.19-3.0.2" = _SKmPLlsp;
        "pkg-1.18.2-6.0.2" = _g4Q6XE0p;
        "pkg-1.19.3-0.0.1" = _UBVadE7K;
        "pkg-1.16.5-3.69.0" = _5czBhmqb;
        "pkg-1.19.2-3.0.3" = _UfbHiUnV;
        "pkg-1.19.4-0.0.1" = _baWtgQdG;
        "pkg-1.18.2-6.0.3" = _3T7IHFuI;
        "pkg-1.19.2-3.0.4" = _g9iB3bDN;
        "pkg-1.19.4-0.0.2" = _efhJ8HmB;
        "pkg-1.19.2-3.0.5" = _LWoeFXMM;
        "pkg-1.18.2-6.0.4" = _wP0FFgwD;
        "pkg-1.19.4-0.0.3" = _eP2gkCLT;
        "pkg-1.19.2-3.1.0" = _aUC4oHCW;
        "pkg-1.18.2-6.1.0" = _WsY3nemC;
        "pkg-1.19.4-0.0.4" = _z3yPyXT6;
        "pkg-1.19.2-3.1.1" = _63HYFLi5;
        "pkg-1.19.4-0.0.5" = _7yGF8JCZ;
        "pkg-1.18.2-6.1.1" = _Cvc6zdC6;
        "pkg-1.20-0.0.1" = _FhrLx7Zp;
        "pkg-1.19.4-0.0.6" = _Wxr62m9q;
        "pkg-1.19.2-3.1.2" = _XFClup9Y;
        "pkg-1.19.4-0.0.7" = _rjQdaY7Y;
        "pkg-1.19.2-3.1.3" = _RHT5g8aU;
        "pkg-1.18.2-6.1.2" = _qHuUqU1R;
        "pkg-1.19.4-0.1.8" = _lsR2pz0N;
        "pkg-1.19.2-3.2.4" = _ac1sDkne;
        "pkg-1.18.2-6.2.3" = _yWwDhUZh;
        "pkg-1.1.3" = _ITfYrEeL;
        "pkg-1.2.5" = _AHG4bc5x;
        "pkg-1.19.2-3.3.5" = _UyvhB9Rn;
        "pkg-1.2.7" = _RoXvM7U2;
        "pkg-1.19.2-3.3.6" = _zrpz4I5T;
        "pkg-1.18.2-6.2.4" = _2VUbVyjC;
        "pkg-1.18.2-6.2.5" = _9OtPOGnv;
        "pkg-1.2.9" = _gs42d9TU;
        "pkg-1.19.2-3.3.7" = _vYTy9EpD;
        "pkg-1.18.2-6.2.6" = _LPhqbcu7;
        "pkg-1.19.2-3.3.8" = _Pbd7xknU;
        "pkg-1.19.2-3.3.9" = _jlBhBxj1;
        "pkg-1.19.2-3.3.10" = _s72Ijpws;
        "pkg-1.2.11" = _f6yy6Fv8;
        "pkg-1.19.2-3.3.11" = _R3P830zV;
        "pkg-1.2.12" = _j5o8P0l1;
        "pkg-1.19.2-3.3.12" = _K8ERemrc;
        "pkg-1.20.1-1.2.15" = _LtgH8RHe;
        "pkg-1.20.1-1.2.16" = _txuGV1k3;
        "pkg-1.20.1-1.2.17" = _VDiSFGfk;
        "pkg-1.20.1-1.2.18" = _yZnuP178;
        "pkg-1.20.1-1.2.19" = _jCOsoukD;
        "pkg-1.20.1-1.2.20" = _YkFM5517;
        "pkg-1.20.1-1.3.21" = _vrB3F7yH;
        "pkg-1.18.2-6.2.7" = _BKdpzSUo;
        "pkg-1.18.2-6.2.8" = _hugp3JNP;
        "pkg-1.19.2-3.3.13" = _H0beoZTA;
        "pkg-1.20.1-1.3.22" = _Dp14F6xh;
        "pkg-1.18.2-6.2.9" = _AcZ70g1X;
        "pkg-2.3.4" = _OBWbKnag;
        "pkg-2.3.5" = _5KPnKDPD;
        "pkg-2.3.7" = _wIH5pkps;
        "pkg-1.18.2-6.2.10" = _aMM2uSfb;
        "pkg-1.19.2-3.3.15" = _orOBCawQ;
        "pkg-1.20.1-1.3.23" = _aoMYOUCd;
        "pkg-2.3.8" = _d6tbPdJE;
        "pkg-2.3.9" = _pKNUKjb4;
        "pkg-1.20.1-1.4.23" = _Xmufjx8S;
        "pkg-1.20.1-1.4.24" = _Z0jV1G7U;
        "pkg-2.4.10" = _hEabT4ST;
        "pkg-2.4.12" = _l3TVulvl;
        "pkg-1.19.2-3.3.16" = _Iig5khU8;
        "pkg-1.20.1-1.4.25" = _JLDmgraA;
        "pkg-2.4.13" = _wmX62vIQ;
        "pkg-2.4.14" = _pB2bSxrl;
        "pkg-1.20.1-1.5.26" = _sJASLlz9;
        "pkg-1.20.1-1.5.27" = _Dibma2XL;
        "pkg-1.19.2-3.4.16" = _gxvTemIN;
        "pkg-2.5.15" = _u2E2k93g;
        "pkg-1.20.1-1.5.28" = _BS3D1qIW;
        "pkg-1.19.2-3.4.17" = _e2ouMEFK;
        "pkg-1.20.1-1.5.29" = _SXV0gufC;
        "pkg-1.20.1-1.5.30" = _yyCsOIxh;
        "pkg-2.6.17" = _zT6KZ05Z;
        "pkg-2.6.18" = _6vyXMJwB;
        "pkg-2.6.19" = _JFjizwJp;
        "pkg-1.20.1-1.6.31" = _NtO9KCK3;
        "pkg-2.6.20" = _28nM5YfE;
        "pkg-1.20.1-1.6.32" = _ts8PBh34;
        "pkg-1.20.1-1.6.33" = _JQxHhe6n;
        "pkg-2.6.21" = _sDLgjhBp;
        "pkg-2.6.22" = _Qv0tKZkM;
        "pkg-2.6.23" = _g08jAPzN;
        "pkg-2.6.24" = _ofCWjXwT;
        "pkg-2.6.25" = _8pEbONFW;
        "pkg-2.6.26" = _nnRtYvFV;
        "pkg-2.6.27" = _WVZvwP3Q;
        "pkg-2.6.28" = _DOWF2Tx8;
        "pkg-2.6.29" = _1L7QTbQy;
        "pkg-1.20.1-1.6.35" = _h9oHTtO7;
        "pkg-2.6.30" = _Sz5L9AUD;
        "pkg-1.20.1-1.7.35" = _ZNmSDWFM;
        "pkg-1.20.1-1.7.36" = _LzjErpnh;
        "pkg-1.20.1-1.7.37" = _A91rH9wC;
        "pkg-2.7.31" = _JlJTB2h9;
        "pkg-2.7.32" = _CfYo3EGj;
        "pkg-1.20.1-1.7.38" = _Q9DrGvcV;
        "pkg-2.7.33" = _LQNIf8A7;
        "pkg-2.7.34" = _qVYAuknd;
        "pkg-1.20.1-1.7.39" = _vXFLkSQB;
        "pkg-2.7.35" = _grj9ONPK;
        "pkg-2.7.36" = _u2LIM3AK;
        "pkg-2.8.37" = _NyPF7e8L;
        "pkg-2.8.38" = _208t0bCX;
        "pkg-1.20.1-1.7.40" = _rUOXYys3;
        "pkg-2.8.39" = _2rAivkki;
        "pkg-2.8.40" = _uRbFiBGo;
        "pkg-2.8.41" = _eiZDkup5;
        "pkg-2.9.42" = _64pFDUAz;
        "pkg-2.10.43" = _XQalg0HU;
        "pkg-1.20.1-1.7.41" = _14MNaCAJ;
        "pkg-2.10.44" = _caXWxNtn;
        "pkg-2.10.45" = _ymuBaDwo;
        "pkg-2.10.46" = _mBJtbive;
        "pkg-2.8.36" = _n2JphGIV;
