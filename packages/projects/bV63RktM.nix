...
let
    ...
    in {
        ...
        "pkg-A1.2-B1.1_02-V1" = _cdkJ4EM4;
        "pkg-B1.7-B1.7.3-V2" = _WCJ4lQEH;
        "pkg-1.5.2-V1" = _YAtJ6I8h;
        "pkg-1.5.2-V2" = _bSoLA9f7;
        "pkg-A1.2-B1.1_02-V2" = _CHhyigJR;
        "pkg-1.8.9-A" = _2c5QAqOo;
        "pkg-A1.2-B1.1_02-V3" = _R2ZVUoPh;
        "pkg-B1.7-B1.7.3-V3" = _mDhbz10S;
        "pkg-1.5.2-V3" = _Z2YXeDZn;
        "pkg-1.8.9-V1" = _ZSUj4IBm;
        "pkg-A1.2-B1.1_02-V4" = _GHConUqP;
        "pkg-B1.7-B1.7.3-V4" = _AfzGHuwN;
        "pkg-1.5.2-V4" = _zW3aUMcq;
        "pkg-1.8.9-V2" = _wT05DlJE;
        "pkg-1.12.2-V1" = _reWaiQnu;
        "pkg-A1.2-B1.1_02-V5" = _kBRDnuYB;
        "pkg-B1.7-B1.7.3-V5" = _F659IrgG;
        "pkg-A1.2-B1.1_02-V5.1" = _cbmssRwJ;
        "pkg-B1.7-B1.7.3-V5.1" = _rpKVJkjV;
        "pkg-1.5.2-V5" = _v99s9dRq;
        "pkg-1.8.9-V3" = _U2L0DXvV;
        "pkg-1.8.9-V3.1" = _pw6vHmAa;
        "pkg-1.12.2-V2" = _rvbhjMEy;
        "pkg-1.14.4-V1" = _pJ7qyI3G;
        "pkg-1.4.7-V1" = _ZNo0dl5y;
        "pkg-A1.2-B1.1_02-V5.2" = _K1ButA7J;
        "pkg-B1.7-B1.7.3-V5.2" = _HsOIhWF9;
        "pkg-1.4.7-V2" = _jMfB2ues;
        "pkg-1.5.2-V6" = _fEALXZIr;
        "pkg-1.8.9-V4" = _L56Olhsi;
        "pkg-1.12.2-V3" = _Zc4bwRAh;
        "pkg-1.14.4-V2" = _IuRrVItZ;
