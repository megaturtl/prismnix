...
let
    ...
    in {
        ...
        "pkg-1.1.0-1.19.4" = _FmYJW3s0;
        "pkg-1.1.1-1.20" = _uTQvrkV6;
        "pkg-2.0.0-1.20+" = _zSM7Re16;
        "pkg-2.0.1-1.20.2+" = _awhQbwpe;
        "pkg-3.0.0-1.20+" = _cHE78GGk;
        "pkg-3.0.0-1.20.2" = _nL9lXznp;
        "pkg-3.0.0-1.20.3+" = _mjeApAVg;
        "pkg-3.0.1-1.20+" = _33pzAZfH;
        "pkg-3.0.1-1.20.2" = _9LQJgNyq;
        "pkg-3.0.1-1.20.3" = _wQuhXKrL;
        "pkg-3.0.1-1.21.0" = _EVnBnSsC;
        "pkg-4.0.0-1.21.0" = _haqpjupy;
        "pkg-4.0.1-1.21.2" = _3iMYhYUb;
        "pkg-4.0.2-1.21.5" = _a5ThrLDy;
        "pkg-4.0.3-1.21.6" = _nQsGZey6;
        "pkg-4.0.3-1.21.9" = _CExlUJGg;
