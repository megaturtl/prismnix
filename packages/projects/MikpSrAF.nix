...
let
    ...
    in {
        ...
        "pkg-0.1.0" = _cFlaLRr3;
        "pkg-0.1.1+1.20.2" = _sP77Z02f;
        "pkg-0.2.0+1.20.2" = _irp7cMoQ;
        "pkg-0.2.1+1.20.2" = _D6nyeaMB;
        "pkg-0.3.0+1.20.4" = _IA0BvMxz;
        "pkg-0.3.1+1.20.4" = _8HcgMY82;
        "pkg-0.3.2+1.20.4" = _TzA3qqRK;
        "pkg-0.3.3+1.20.4" = _UXMXVb9g;
        "pkg-0.3.4+1.20.4" = _Qtp9qKGS;
        "pkg-0.3.5+1.20.4" = _rDuKdq6D;
        "pkg-0.4.0-pre.1+1.20.6" = _ATY3hjvK;
        "pkg-0.4.0-pre.2+1.20.6" = _S2WbcFD5;
        "pkg-0.4.0-pre.3+1.20.6" = _28rLpJui;
        "pkg-0.4.0-pre.4+1.21" = _BUGFRrVl;
        "pkg-0.4.0-pre.5+1.21" = _6Ta3P3ds;
        "pkg-0.4.0-pre.5.1+1.21" = _CJNvgoxK;
        "pkg-0.4.0+1.21.1" = _w4s60gXx;
        "pkg-0.4.1+1.21.1" = _rImG4Zdz;
        "pkg-0.4.2+1.21.1" = _nPgi5zG2;
        "pkg-0.5.0+1.21.3" = _7uf07EQR;
        "pkg-0.5.1+1.21.3" = _NhSV2aoA;
        "pkg-0.5.2+1.21.3" = _tr6FEZ8Z;
        "pkg-0.6.0+1.21.4-rc3" = _EMNggYPp;
        "pkg-0.6.1+1.21.4" = _rBRL0hX4;
        "pkg-0.6.2+1.21.4" = _TYxCtVG3;
        "pkg-0.4.3+1.21.1" = _XsQDZRow;
        "pkg-0.7.0+1.21.5" = _5CV4jcgh;
        "pkg-0.6.3+1.21.4" = _e05OHr28;
        "pkg-0.4.4+1.21.1" = _oCaOjOQt;
        "pkg-0.4.5+1.21.1" = _EysgX1e4;
        "pkg-0.6.4+1.21.4" = _CBY6KLjd;
        "pkg-0.7.1+1.21.5" = _6TpfrCzs;
        "pkg-0.7.2+1.21.5" = _JkwF31tM;
        "pkg-0.8.0+1.21.6" = _zLbYgpVI;
        "pkg-0.8.1+1.21.8" = _zNJDINTG;
        "pkg-0.8.2+1.21.8" = _BOmi9f4J;
        "pkg-0.9.0+1.21.9-rc1" = _43tznm8Y;
        "pkg-0.9.1+1.21.10" = _VdRP2jiu;
        "pkg-0.10.0+1.21.11" = _TE4Ezu0t;
        "pkg-0.9.2+1.21.10" = _3vZmzzr3;
        "pkg-0.10.1+1.21.11" = _ognaZdvz;
        "pkg-0.10.2+1.21.11" = _OO1Q9t8E;
        "pkg-0.10.3+1.21.11" = _bryFrLWm;
        "pkg-0.10.4+1.21.11" = _E7XbHhGB;
        "pkg-0.11.0+26.1" = _8pRgfBPO;
        "pkg-0.11.1+26.1.2" = _aUM9DmNG;
