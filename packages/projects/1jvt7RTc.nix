...
let
    ...
    in {
        ...
        "pkg-1.2" = _rXsdADxQ;
        "pkg-1.3" = _RLn0b2dG;
        "pkg-1.3.1-forge-1.16" = _ESgAjN5R;
        "pkg-1.3.1-forge-1.17" = _CwiP03ao;
        "pkg-1.4-forge-1.17 " = _1TKaCivL;
        "pkg-1.4-fabric-1.17 " = _UdJVlHqu;
        "pkg-1.5-forge-1.17 " = _S5INcMUx;
        "pkg-1.5-fabric-1.17" = _89h1QII9;
        "pkg-1.5.1-forge-1.17" = _sbu4v0Nc;
        "pkg-1.5.1-fabric-1.17" = _yqjLvbku;
        "pkg-1.5.1-forge-1.16" = _phj7A70x;
        "pkg-1.5.1-fabric-1.16" = _nmmLINmE;
        "pkg-1.5.1" = _xMqyvGat;
        "pkg-1.5.2-forge-1.16" = _NNdlEAJE;
        "pkg-1.5.2-fabric-1.16" = _8GK5hcXI;
        "pkg-1.5.2-forge-1.17" = _z5DP51L5;
        "pkg-1.5.2-forge-1.18" = _fxOFZ3jE;
        "pkg-1.5.2-fabric-1.17" = _v5lX865B;
        "pkg-1.6.0-forge-1.16.5" = _oWOcc1Hu;
        "pkg-1.6.0-fabric-1.16.5" = _ucb5YYv4;
        "pkg-1.6.0-forge-1.17.1" = _JCtVPY0d;
        "pkg-1.6.0-forge-1.18.2" = _TR4T2VQx;
        "pkg-1.6.0-fabric-1.17.1" = _ydQr0dbh;
        "pkg-1.6.0-forge-1.19" = _5Q6YI5qX;
        "pkg-1.6.2-forge-1.19" = _4uuPCN5r;
        "pkg-1.6.3-forge-1.19" = _WYCQOXbQ;
        "pkg-1.6.4-forge-1.19.3" = _r2xIF6Zc;
        "pkg-1.6.4-fabric-1.19.3" = _rrZ6KwOd;
        "pkg-1.6.5-forge-1.16.5" = _7ibIolwk;
        "pkg-1.6.5-fabric-1.16.5" = _MAjQD1AI;
        "pkg-1.6.5-forge-1.17.1" = _fucnc4vn;
        "pkg-1.6.5-forge-1.18.2" = _SbenL6yq;
        "pkg-1.6.5-forge-1.19.2" = _6njzyie6;
        "pkg-1.6.5-fabric-1.17.1" = _NHtMg4u7;
        "pkg-1.6.5-forge-1.19.3" = _vTWS6Ta5;
        "pkg-1.6.5-fabric-1.19.3" = _DW0RM7G2;
        "pkg-1.7.0-forge-1.16.5" = _JRnI9Z0P;
        "pkg-1.7.0-fabric-1.16.5" = _d803xEH4;
        "pkg-1.7.0-forge-1.17.1" = _KyWp9Ikm;
        "pkg-1.7.0-forge-1.18.2" = _5YtYDtQl;
        "pkg-1.7.0-forge-1.19.2" = _2TQaJWjj;
        "pkg-1.7.0-fabric-1.17.1" = _W6RAWfiy;
        "pkg-1.7.0-forge-1.19.3" = _atnNhs1N;
        "pkg-1.7.0-fabric-1.19.3" = _uzEaiOv0;
        "pkg-1.7.1-forge-1.16.5" = _o7jxsAGy;
        "pkg-1.7.1-fabric-1.16.5" = _eIl6V7gF;
        "pkg-1.7.1-forge-1.17.1" = _er4jLtvC;
        "pkg-1.7.1-forge-1.18.2" = _XsZRhwKF;
        "pkg-1.7.1-forge-1.19.2" = _lWU6QHwH;
        "pkg-1.7.1-fabric-1.17.1" = _uOaZVop7;
        "pkg-1.7.1-forge-1.19.3" = _iCkSlbkn;
        "pkg-1.7.1-fabric-1.19.3" = _Pxrg8h3r;
        "pkg-1.7.1-forge-1.20.2" = _5adUU7lq;
        "pkg-1.7.2-forge-1.20.2" = _bodO1GXR;
        "pkg-1.7.2-fabric-1.20.2" = _BDjHRAAE;
        "pkg-1.7.3-forge-1.16.5" = _9XQIGohh;
        "pkg-1.7.3-fabric-1.16.5" = _crTj1nO5;
        "pkg-1.7.3-forge-1.17.1" = _XpELkBD6;
        "pkg-1.7.3-forge-1.18.2" = _J6PyIz6F;
        "pkg-1.7.3-fabric-1.17.1" = _B64droef;
        "pkg-1.7.3-forge-1.19.2" = _g6YtnyPC;
        "pkg-1.7.3-fabric-1.19.2" = _keKkMuHC;
        "pkg-1.7.3-forge-1.20.2" = _LKHlOj9m;
        "pkg-1.7.3-neoforge-1.20.2" = _wRWh8ynT;
        "pkg-1.7.3-fabric-1.20.2" = _dQUnRwht;
        "pkg-1.8.0-neoforge-1.20.5" = _OORCVMi7;
        "pkg-1.8.0-fabric-1.20.5" = _8XBp8aEk;
        "pkg-1.8.1-neoforge-1.20.5" = _veMqkdba;
        "pkg-1.8.1-fabric-1.20.5" = _yRcvhHZk;
        "pkg-1.9.0-neoforge-1.21" = _77Cbr095;
        "pkg-1.9.0-fabric-1.21" = _K3ac4ndv;
        "pkg-1.9.1-neoforge-1.21" = _6U7kk3XS;
        "pkg-1.9.1-fabric-1.21" = _KdxPAtZt;
        "pkg-1.9.2-neoforge-1.21" = _UVPAidip;
        "pkg-1.9.2-forge-1.21" = _4N0LybOq;
        "pkg-1.9.3-neoforge-1.21.3" = _iJgRacYj;
        "pkg-1.9.3-fabric-1.21.3" = _HsVnjewK;
        "pkg-1.9.3-forge-1.21.3" = _XwCA1nYL;
        "pkg-1.9.4-neoforge-1.21.5" = _ohY400de;
        "pkg-1.9.4-fabric-1.21.5" = _IgfXr6Py;
        "pkg-1.9.5-neoforge-1.21.11" = _uHGuKFKH;
        "pkg-1.9.5-fabric-1.21.11" = _Sm13IZEm;
        "pkg-1.10.0-neoforge-26.1" = _WLxClyUG;
        "pkg-1.10.0-fabric-26.1" = _isDJcMZw;
        "pkg-1.10.1-forge-1.21" = _jPSX9aDW;
        "pkg-1.10.1-neoforge-1.21" = _Nhw0Ntx2;
        "pkg-1.10.1-fabric-1.21" = _8v4LtOUj;
        "pkg-1.10.1-forge-1.21.3" = _KDcmf0dB;
        "pkg-1.10.1-neoforge-1.21.3" = _3gPHuyCz;
        "pkg-1.10.1-fabric-1.21.3" = _bdecxuln;
        "pkg-1.10.1-neoforge-1.21.5" = _YKxlZfF3;
        "pkg-1.10.1-fabric-1.21.5" = _BQxRHOMu;
        "pkg-1.10.1-neoforge-1.21.11" = _jibjACor;
        "pkg-1.10.1-fabric-1.21.11" = _euEhlnHt;
        "pkg-1.10.1-neoforge-26.1" = _5JLlfery;
        "pkg-1.10.1-fabric-26.1" = _IGzq2NeH;
        "pkg-1.10.2-forge-1.21" = _1HLXx58H;
        "pkg-1.10.2-neoforge-1.21" = _2bqCbUXm;
        "pkg-1.10.2-fabric-1.21" = _j9t9D4Xw;
        "pkg-1.10.2-forge-1.21.3" = _i5XhMNnF;
        "pkg-1.10.2-neoforge-1.21.3" = _sKYYmsbs;
        "pkg-1.10.2-fabric-1.21.3" = _BlWPaeBe;
        "pkg-1.10.2-neoforge-1.21.5" = _N7JAzXZx;
        "pkg-1.10.2-fabric-1.21.5" = _ls5fpbNt;
        "pkg-1.10.2-neoforge-1.21.11" = _TQgHYNMU;
        "pkg-1.10.2-fabric-1.21.11" = _vN2ZFhbj;
        "pkg-1.10.2-neoforge-26.1" = _DPTvEd2q;
        "pkg-1.10.2-fabric-26.1" = _oBhr7V5c;
        "pkg-1.10.2-forge-1.20.6" = _hb9XDdBk;
        "pkg-1.10.2-neoforge-1.20.6" = _tAfH5mrX;
        "pkg-1.10.2-fabric-1.20.6" = _HaYboGJx;
        "pkg-1.10.2-forge-1.16.5" = _d0wnbYoo;
        "pkg-1.10.2-fabric-1.16.5" = _NQp8TSMr;
        "pkg-1.10.2-forge-1.17.1" = _vzvxDe3Q;
        "pkg-1.10.2-fabric-1.17.1" = _BprFinSo;
        "pkg-1.10.2-forge-1.18.2" = _giEY5Wjf;
        "pkg-1.10.2-fabric-1.18.2" = _smOoZqRk;
        "pkg-1.10.2-forge-1.19.2" = _xe2fpCuP;
        "pkg-1.10.2-fabric-1.19.2" = _PuYUs1mq;
