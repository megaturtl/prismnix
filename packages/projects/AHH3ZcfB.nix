...
let
    versions = (let
        ...
        _qrOlHfmK = {
            "id" = "qrOlHfmK";
            "file" = "armor-indicator-12.0.0+26.3.jar";
            "hash" = "sha512-DSUjkFNclSM7bWOcTRxxBdkA0n2GgBk/jVVUyAGu1b7xEoYmYxjJuwDe5h5he837rk3wa2fR3VeMAALVIpeh7Q==";
        };
    in {
        "k2qmxrbE" = _k2qmxrbE;
        "34PrqhWk" = _34PrqhWk;
        ...
        "pkg-3.1.0" = _8RkE4WGs;
        "pkg-4.1.0" = _Bc5Aendi;
        "pkg-5.0.0+1.21.2-pre1" = _LFSL7xr1;
        "pkg-5.0.0+1.21.2" = _WtFWiuMY;
        "pkg-1.1.1+1.20" = _nzNdr5UZ;
        "pkg-2.0.1+1.20.2" = _aTBO9lVf;
        "pkg-3.0.1+1.20.5" = _l8qrflhs;
        "pkg-4.0.1+1.21" = _uzPOCyEe;
        "pkg-5.0.1+1.21.2" = _GIuFYZ6E;
        "pkg-6.0.0+1.21.5" = _wGNLVn33;
        "pkg-7.0.0+1.21.6" = _IfYrgTHn;
        "pkg-8.0.0+1.21.9" = _BQgTXc9m;
        "pkg-8.0.1+1.21.9" = _pMwv8aA4;
        "pkg-9.0.0+1.21.11" = _XLcTgGnc;
        "pkg-10.0.0+26.1" = _bhY1QhD5;
        "pkg-11.0.0-beta+26.2-rc.2" = _Dhtc9MUy;
        "pkg-11.0.0+26.2" = _SVQ6BG1A;
        "pkg-11.0.1+26.2" = _36wBlVkn;
        "pkg-12.0.0-beta+26.3" = _KHfpsLkm;
        "pkg-12.0.0+26.3" = _qrOlHfmK;
        "default" = _qrOlHfmK;
    });
