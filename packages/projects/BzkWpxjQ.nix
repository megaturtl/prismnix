...
let
    ...
    in {
        ...
        "pkg-1.0.2-1.20.2" = _nMYhaFAv;
        "pkg-1.0.2-1.20.4" = _9QPVTn5I;
        "pkg-1.0.2-1.20.6" = _fmg7C8cN;
        "pkg-1.0.2-1.21" = _jqIpQVRv;
        "pkg-1.0.2-1.21.1" = _uVoSA3Jk;
        "pkg-1.0.3-1.20.1" = _V7tN6Vg4;
        "pkg-1.0.3-1.20.2" = _TARp5sEM;
        "pkg-1.0.3-1.20.4" = _nPz6w80d;
        "pkg-1.0.3-1.20.6" = _Gi6SVJ5s;
        "pkg-1.0.3-1.21" = _A309yXv6;
        "pkg-1.0.3-1.21.1" = _a4BQ0erL;
        "pkg-1.0.3-1.20" = _AsajiKp1;
        "pkg-1.0.3-1.21.3" = _xxnuUWEW;
        "pkg-1.0.4-1.20" = _EMks9WvA;
        "pkg-1.0.4-1.20.1" = _JhF8wvST;
        "pkg-1.0.4-1.20.2" = _KxBBUH79;
        "pkg-1.0.4-1.20.4" = _VIhXPBkR;
        "pkg-1.0.4-1.20.6" = _7R2LiH5w;
        "pkg-1.0.4-1.21" = _3xhNRXJt;
        "pkg-1.0.4-1.21.1" = _mXhdNMDk;
        "pkg-1.0.4-1.21.3" = _JPlfxKhS;
        "pkg-1.0.5-1.20" = _d5Zf9FP3;
        "pkg-1.0.5-1.20.1" = _9dV45TXp;
        "pkg-1.0.5-1.20.2" = _eDqPEidX;
        "pkg-1.0.5-1.20.4" = _BhLS6MLD;
        "pkg-1.0.5-1.20.6" = _GlqEe6nX;
