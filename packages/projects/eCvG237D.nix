...
let
    versions = (let
        ...
        _Ls4iMm35 = {
            "id" = "Ls4iMm35";
            "file" = "ServerSelector-1.8.jar";
            "hash" = "sha512-UIxNPDcPy2xhayDiCbfchPpDM/qOIErPYQiPdz16w2FmxT0fdHAkiHVt0Zd2KZtHoL6JzcyFQDL03hjIIfkM+Q==";
        };
    in {
        "W6vmgtJK" = _W6vmgtJK;
        "wWmpPJZH" = _wWmpPJZH;
        ...
        "bukkit-1.21" = _Ls4iMm35;
        "bukkit-1.21.1" = _Ls4iMm35;
        "bukkit-1.21.2" = _Ls4iMm35;
        "bukkit-1.21.3" = _Ls4iMm35;
        "bukkit-1.21.4" = _Ls4iMm35;
        "bukkit-1.21.5" = _Ls4iMm35;
        "bukkit-1.21.6" = _Ls4iMm35;
        "bukkit-1.21.7" = _Ls4iMm35;
        "bukkit-1.21.8" = _Ls4iMm35;
        "bukkit-1.21.9" = _Ls4iMm35;
        "bukkit-1.21.10" = _Ls4iMm35;
        "bukkit-1.21.11" = _Ls4iMm35;
        "bukkit-26.1" = _Ls4iMm35;
        "bukkit-26.1.1" = _Ls4iMm35;
        "bukkit-26.1.2" = _Ls4iMm35;
        "bukkit-26.2" = _Ls4iMm35;
        "bukkit-26.3" = _Ls4iMm35;
        ...
        "paper-1.21" = _Ls4iMm35;
        "paper-1.21.1" = _Ls4iMm35;
        "paper-1.21.2" = _Ls4iMm35;
        "paper-1.21.3" = _Ls4iMm35;
        "paper-1.21.4" = _Ls4iMm35;
        "paper-1.21.5" = _Ls4iMm35;
        "paper-1.21.6" = _Ls4iMm35;
        "paper-1.21.7" = _Ls4iMm35;
        "paper-1.21.8" = _Ls4iMm35;
        "paper-1.21.9" = _Ls4iMm35;
        "paper-1.21.10" = _Ls4iMm35;
        "paper-1.21.11" = _Ls4iMm35;
        "paper-26.1" = _Ls4iMm35;
        "paper-26.1.1" = _Ls4iMm35;
        "paper-26.1.2" = _Ls4iMm35;
        "paper-26.2" = _Ls4iMm35;
        "paper-26.3" = _Ls4iMm35;
        ...
        "spigot-1.21" = _Ls4iMm35;
        "spigot-1.21.1" = _Ls4iMm35;
        "spigot-1.21.2" = _Ls4iMm35;
        "spigot-1.21.3" = _Ls4iMm35;
        "spigot-1.21.4" = _Ls4iMm35;
        "spigot-1.21.5" = _Ls4iMm35;
        "spigot-1.21.6" = _Ls4iMm35;
        "spigot-1.21.7" = _Ls4iMm35;
        "spigot-1.21.8" = _Ls4iMm35;
        "spigot-1.21.9" = _Ls4iMm35;
        "spigot-1.21.10" = _Ls4iMm35;
        "spigot-1.21.11" = _Ls4iMm35;
        "spigot-26.1" = _Ls4iMm35;
        "spigot-26.1.1" = _Ls4iMm35;
        "spigot-26.1.2" = _Ls4iMm35;
        "spigot-26.2" = _Ls4iMm35;
        "spigot-26.3" = _Ls4iMm35;
