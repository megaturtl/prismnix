...
let
    ...
    in {
        ...
        "pkg-2.9.14" = _u5jLLmSw;
        "pkg-1.9.10" = _XWYqAb9o;
        "pkg-1.9.10.1" = _7UExuf2p;
        "pkg-2.9.14.2" = _vZNPtQaD;
        "pkg-2.9.14.3" = _MYGFcdJe;
        "pkg-2.9.14.4" = _I48ArXsw;
        "pkg-2.9.14.5" = _a4ksvfTr;
        "pkg-3.0" = _SHpFsJAf;
        "pkg-3.0.1" = _NwtSp4zl;
        "pkg-3.1" = _VUlw3OxO;
        "pkg-3.1.1" = _BaNUnG1r;
