...
let
    versions = (let
        ...
        _wEhiLD3b = {
            "id" = "wEhiLD3b";
            "file" = "Just Colored Lighting (1.0.1).zip";
            "hash" = "sha512-+y8+OLbSGIWelNiQcz4sHwjEaw04ZazMMzAItGj8/6SUdkPnn0TiUvGWs1sycxrkkORSDTHWh/VZVMX79jpTuQ==";
        };
    in {
        "8mx5KFbw" = _8mx5KFbw;
        "R4VMjf9U" = _R4VMjf9U;
        ...
        "gnSRsj4e" = _gnSRsj4e;
        "wEhiLD3b" = _wEhiLD3b;
        "iris-1.21.4" = _wEhiLD3b;
        "iris-1.20.1" = _wEhiLD3b;
        "iris-1.20.2" = _wEhiLD3b;
        "iris-1.20.3" = _wEhiLD3b;
        "iris-1.20.4" = _wEhiLD3b;
        "iris-1.20.5" = _wEhiLD3b;
        "iris-1.20.6" = _wEhiLD3b;
        "iris-1.21" = _wEhiLD3b;
        "iris-1.21.1" = _wEhiLD3b;
        "iris-1.21.2" = _wEhiLD3b;
        "iris-1.21.3" = _wEhiLD3b;
        "iris-1.19.2" = _wEhiLD3b;
        "iris-1.19.3" = _wEhiLD3b;
        "iris-1.19.4" = _wEhiLD3b;
        "iris-1.20" = _wEhiLD3b;
        "iris-1.21.5" = _wEhiLD3b;
        "iris-1.21.6" = _wEhiLD3b;
        "iris-1.21.7" = _wEhiLD3b;
        "iris-1.19" = _wEhiLD3b;
        "iris-1.19.1" = _wEhiLD3b;
        "iris-1.21.8" = _wEhiLD3b;
        "iris-1.21.9" = _wEhiLD3b;
        "iris-1.21.10" = _wEhiLD3b;
        "iris-1.21.11" = _wEhiLD3b;
        "iris-26.1" = _wEhiLD3b;
        "iris-26.1.1" = _wEhiLD3b;
        "iris-26.1.2" = _wEhiLD3b;
        "iris-26.2" = _wEhiLD3b;
        "pkg-0.1" = _8mx5KFbw;
        "pkg-0.1.1" = _R4VMjf9U;
        "pkg-0.1.2" = _icDHiDnL;
