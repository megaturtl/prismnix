...
let
    versions = (let
        ...
        _O6vLKWmA = {
            "id" = "O6vLKWmA";
            "file" = "reliable_remover-neoforge-1.21.1-2.11.3.jar";
            "hash" = "sha512-GK9zk4o/WFK9FKJWZbJIE8+WnpCe7J3Y0Kt9/BZAU5wjIJX48uHISngqleo5PBC5mj+LpyP8b4HnWCc6XC5lsQ==";
        };
        _IH52VNlM = {
            "id" = "IH52VNlM";
            "file" = "reliable_remover-fabric-1.21.1-2.11.3.jar";
            "hash" = "sha512-+afGUYic4RqDmHRXaLPlPR36oGa9hTp8fUQDb6/nXx0ZtLdLduVfegVgwtmayHiN4sedWFpFB+57mpW0WCGylw==";
        };
        _jdPr1QIP = {
            "id" = "jdPr1QIP";
            "file" = "reliable_remover-fabric-1.20.1-2.5.0.jar";
            "hash" = "sha512-YPXe4L2Fpt/BP47wdGrMIa8oJYmtQXNoz10d2GQKDtOnsiyiNGpzLjt5Y1Z44oWFXW+Qc4IeykbFhSoJ8vam5g==";
        };
        _hPol6HPL = {
            "id" = "hPol6HPL";
            "file" = "reliable_remover-forge-1.20.1-2.5.0.jar";
            "hash" = "sha512-YWHjU+mC4EkubAMG848c41AgqFMDclY4mcUHtSEJRuEAvYsxbW0qaimYA3mW27cYh5wyuZI/lwzcsDmtG2AwUw==";
        };
        _w7ryoSnP = {
            "id" = "w7ryoSnP";
            "file" = "reliable_remover-fabric-1.20.1-3.0.0.jar";
            "hash" = "sha512-hsn5bs5RUKAuZPkb5tynfS8bJyw62A3n4b5ZJpcg9gvn9XpNESkahQigzXGgkvo5G6ckPjuyD5DhEK3RJcruug==";
        };
        _Dbg8XKbP = {
            "id" = "Dbg8XKbP";
            "file" = "reliable_remover-forge-1.20.1-3.0.0.jar";
            "hash" = "sha512-vxjvaOZPGSw5gi0zun+CtGgsacJw8iLm3YkJy6nbopHNu53c22fLtQDiurT8C2eju51qf5wsFB0V70V34tDOIw==";
        };
        _9Drs8Kd1 = {
            "id" = "9Drs8Kd1";
            "file" = "reliable_remover-fabric-26.1.2-3.3.0.jar";
            "hash" = "sha512-0ooOLguCjzAN/cmRRpMJ+LZPY8LCrKK75jcxXBAdY6mAaJu6We8zdLhkDxm1z6HNhe/jbVza5yupguo5yvv/9w==";
        };
        _8PW1Sr73 = {
            "id" = "8PW1Sr73";
            "file" = "reliable_remover-neoforge-26.1.2-3.3.0.jar";
            "hash" = "sha512-MszCLQ/T7BkdDXLbLCuFYW1bZ+sJudryjbDs+gmXeRv5jWgEZS6SWyDoMCCC7tMvqmZVr43tuKorkZlz1eorcg==";
        };
        _v8UZyo2Z = {
            "id" = "v8UZyo2Z";
            "file" = "reliable_remover-fabric-26.2-3.3.0.jar";
            "hash" = "sha512-oEkQX70g+3wSko/AmNaISP1yyysmMkLLk2SzkdE9TD8plxkYEx7nEPtfCEFtDukeJZzljA4wmLSHnEySWD+JWw==";
        };
        _IvhssMTH = {
            "id" = "IvhssMTH";
            "file" = "reliable_remover-neoforge-26.2-3.3.0.jar";
            "hash" = "sha512-hwL/2kIM2z0x5bVbLvM/4dHDPNJA79e9O/Ib7iOnhy4xspsJ5z6CWhSiyqk6jaI/fjZfvaWcpfZMGTNSB7UT0g==";
        };
        _bKMkb6mD = {
            "id" = "bKMkb6mD";
            "file" = "reliable_remover-fabric-1.21.1-2.12.0.jar";
            "hash" = "sha512-M6u0/rjL3JhlXyHb7+Ze6Dz0XW9GBFKJNoF2cxdqW6bFc5yAPKb2lQlQzqMJnzUi/MVWUDtzA8egxnpOtDD47g==";
        };
        _2q4C9kR4 = {
            "id" = "2q4C9kR4";
            "file" = "reliable_remover-neoforge-1.21.1-2.12.0.jar";
            "hash" = "sha512-J8mTemlL5XJGpYcQz6w7HHkPVA00GTYNlLuI4mbiEQjvw6oQXN+cvJ6EPtuhkPU3+z5Rge6X1ur3lQBpG+U2SQ==";
        };
        _HLlKtA6l = {
            "id" = "HLlKtA6l";
            "file" = "reliable_remover-fabric-1.21.1-2.12.1.jar";
            "hash" = "sha512-pD8BSISQjsZD7NwkxHMkKLlzSf7b2WLWNaAc27p6FhdflSPdFH/r7v8sAePC8gObjfpaZMvYS9hWPHpOSpbkMA==";
        };
        _YU1aXAsw = {
            "id" = "YU1aXAsw";
            "file" = "reliable_remover-neoforge-1.21.1-2.12.1.jar";
            "hash" = "sha512-ZqNbQXl4dyuU3A3QTOz7oZiHPLxud9Ut/cy0sP1hMIChVSO9E1nHYGeGjDPTBLEZWFGYWfv10df20/agu9DzGQ==";
        };
        _UXJLiWo4 = {
            "id" = "UXJLiWo4";
            "file" = "reliable_remover-fabric-26.2-3.3.1.jar";
            "hash" = "sha512-tDXVWDBK+nw1VtAKqa3nrXeNLKhG9SeEj6aYkD2P1leNpC286JCHiGMof7zSPt81cFeqaq5pMxO5UX7UNA9w/A==";
        };
        _PhdCFZMX = {
            "id" = "PhdCFZMX";
            "file" = "reliable_remover-neoforge-26.2-3.3.1.jar";
            "hash" = "sha512-0lubt9D5BcdRYlImONU6YpW/kD0CMthJYP71wylYs3rVxoC5WV+zSLWscjmgUY14LyHiITxdQ+owOgD2kqXk9Q==";
        };
        _GC0xlh5x = {
            "id" = "GC0xlh5x";
            "file" = "reliable_remover-fabric-26.1.2-3.3.1.jar";
            "hash" = "sha512-3mcyqRohOe5ebRh/Khx1WnYAHqZp9BmrhwPEyoX4w6eVG57jO6Womcwzum04GXsGIzEKsfbzN8kUp1wndiR7RQ==";
        };
        _Q5fVrLNp = {
            "id" = "Q5fVrLNp";
            "file" = "reliable_remover-neoforge-26.1.2-3.3.1.jar";
            "hash" = "sha512-ASItdf/pWRZ/gryFkYZeLFfqTQJQCCEgKObnl7VHtCcWcdJuknIvr98022wakd5fLFVA6a2KQjGOr+B5RkNGCg==";
        };
        _BsdUsrJI = {
            "id" = "BsdUsrJI";
            "file" = "reliable_remover-fabric-26.1.2-3.3.2.jar";
            "hash" = "sha512-oBlwITfUTpx9AQeHZ3oChuARf+d5bK766kMd2uG/8dB5Gfj0ZP4RehKfb7YZEsa8Uu0d0kBCwCv7jv/kVNOv5g==";
        };
        _YpYtL54G = {
            "id" = "YpYtL54G";
            "file" = "reliable_remover-neoforge-26.1.2-3.3.2.jar";
            "hash" = "sha512-pLTKfD7e3m9E4+TQxFm+JHS7flmC38bvsuSUxo8OBBW9c7c2iuZJJhHTzWI72bWcBuRhqtkyJovp6ExnpxYRSA==";
        };
        _4v41OY0J = {
            "id" = "4v41OY0J";
            "file" = "reliable_remover-fabric-26.2-3.3.2.jar";
            "hash" = "sha512-/zJd5OPY/TynBxS3XmdHbfaL4bfZtHeEBrD8U+xiEY4+or9MVvaMktrPYsPwvWI0bHqSlhhljxihOK/KyKhBJw==";
        };
        _GGjJfoLI = {
            "id" = "GGjJfoLI";
            "file" = "reliable_remover-neoforge-26.2-3.3.2.jar";
            "hash" = "sha512-9NxurhWQj77Zbb1HnBCenVip2Ar47XIaZB1EWxgGxZmKjyzEt0wHOiZRO50+atLudoEe25aRKHYaIw94Q8HvKg==";
        };
        _CQXxDrE9 = {
            "id" = "CQXxDrE9";
            "file" = "reliable_remover-fabric-1.20.1-3.1.0.jar";
            "hash" = "sha512-VlPiYa4CHcaLfWytbem+A3MLhuLUcsRGTeCV/SurQRrNmWphCNowiFXACi7VGIaCiWF7E5pm0vP9FjpIYa/3xQ==";
        };
        _gTZ62Sja = {
            "id" = "gTZ62Sja";
            "file" = "reliable_remover-neoforge-1.21.1-3.1.0.jar";
            "hash" = "sha512-Ya81aMBVn6vmgmdqd4Ux8ofOjrW++XbbBKYZgYi7PO5UeuvJeEdnkIa2g4lRmvdu/FBJfSDep+l5RYFxapLS8Q==";
        };
        _eFqBIjoI = {
            "id" = "eFqBIjoI";
            "file" = "reliable_remover-fabric-1.21.1-3.1.0.jar";
            "hash" = "sha512-Y2IXIq/QtVuXuaaLQ42fjF0T5B4vHLBLXPOGEu/1pct51Q3I2UdUv3ozSuLyayDBHClBIuW/pqFBdOo3Z0a20Q==";
        };
        _7DepYHsl = {
            "id" = "7DepYHsl";
            "file" = "reliable_remover-neoforge-1.21.1-3.1.1.jar";
            "hash" = "sha512-LFWAIrvQo7WVF6jc3X01D42+Mejtbg9G3DDnvs/E8o/NDJwFZTF/lg9z3fohEDATd/g4YkrpyK2ft6qppkQ+WQ==";
        };
        _8JR0XHao = {
            "id" = "8JR0XHao";
            "file" = "reliable_remover-fabric-1.21.1-3.1.1.jar";
            "hash" = "sha512-pltOvDeey7Cd+1EDanf3b1FZqhu8ZzF0KLbug25uT9aDTPTyH0VvevsZ3XXM7nJntsQkC2nysTPZm1TmNXKYaw==";
        };
        _RurRkOJy = {
            "id" = "RurRkOJy";
    ...
    in {
        ...
        "pkg-1.0.8" = _X7p3srWj;
        "pkg-1.0.9" = _ailB6Jn9;
        "pkg-1.0.10" = _ZN7cJ1iW;
        "pkg-1.0.11" = _vq8gQ3aL;
        "pkg-1.0.12" = _CpyZumLC;
        "pkg-1.0.13" = _YN83MCzN;
        "pkg-1.0.13h" = _BA5fpQJi;
        "pkg-1.1.0" = _mLB2VaqN;
        "pkg-1.1.1" = _NfvsXr1z;
        "pkg-1.1.2" = _u5KjwZRP;
        "pkg-1.1.3" = _GS0UxjoG;
        "pkg-1.1.3h" = _vxbygbkZ;
        "pkg-1.1.3i" = _f5V9mxFT;
        "pkg-1.1.4" = _bXyH3NpI;
        "pkg-1.1.5" = _3zpz5mwb;
        "pkg-1.2.0" = _GbtTEjDJ;
        "pkg-1.2.1" = _VeemIzHA;
        "pkg-1.2.1h" = _Ob1UzwKU;
        "pkg-1.2.2" = _WQNsLH9G;
        "pkg-1.2.3" = _YWDGN1yA;
        "pkg-1.2.4" = _aKetDuhC;
        "pkg-1.3.0" = _HZ6DFCol;
        ...
        "pkg-1.4.0" = _LlR3SOgH;
        "pkg-1.4.1" = _Oewkc9Lr;
        "pkg-1.5.0-fabric-1.21.1" = _qHtRr1Xo;
        "pkg-1.5.0-neoforge-1.21.1" = _hDIMBIjV;
        "pkg-1.5.0-fabric-1.20.1" = _lNfIyuQc;
        "pkg-1.5.0-forge-1.20.1" = _AYAn4tAP;
        "pkg-1.5.1-fabric-1.20.1" = _5bDqSmdv;
        "pkg-1.5.1-forge-1.20.1" = _o7AqNWt3;
        "pkg-1.5.1-neoforge-1.21.1" = _brAyIXGk;
        "pkg-1.5.1-fabric-1.21.1" = _CcbGux56;
        "pkg-1.6.0-neoforge-1.21.1" = _n0qsRbqY;
        "pkg-1.6.0-fabric-1.21.1" = _ieiZPr5n;
        "pkg-1.6.0-fabric-1.20.1" = _YCvwtDWS;
        "pkg-1.6.0-forge-1.20.1" = _AUIdifjs;
        "pkg-1.7.0-1.20.1-fabric" = _MpTPqp48;
        "pkg-1.7.0-1.20.1-forge" = _Fd0LhpLd;
        "pkg-1.7.0-1.21.1-fabric" = _TuN6bWS4;
        "pkg-1.7.0-1.21.1-neoforge" = _ZwygnifQ;
        "pkg-1.7.1-1.21.1-neoforge" = _AlAKn90Z;
        "pkg-1.7.1-1.21.1-fabric" = _4TxEwRy9;
        "pkg-1.7.1-1.20.1-fabric" = _vT3fE3qg;
        "pkg-1.7.1-1.20.1-forge" = _VIawLkuW;
        "pkg-1.7.2-1.21.1-fabric" = _DC6w9xh1;
        "pkg-1.7.2-1.21.1-neoforge" = _TNHBQruA;
        "pkg-1.7.3-1.21.1-fabric" = _8I951ugk;
        "pkg-1.7.3-1.21.1-neoforge" = _YNoEv8j8;
        "pkg-1.7.3-1.20.1-fabric" = _uRnyCPCm;
        "pkg-1.7.3-1.20.1-forge" = _SfrOzaNM;
        "pkg-1.7.4-1.21.1-neoforge" = _pbrwOWlu;
        "pkg-1.7.4-1.21.1-fabric" = _r2hOy90g;
        "pkg-1.7.5-1.21.1-fabric" = _8yUn6Ffb;
        "pkg-1.7.5-1.21.1-neoforge" = _tFJTTfir;
        "pkg-1.7.5-1.20.1-fabric" = _1LzHCiC0;
        "pkg-1.7.5-1.20.1-forge" = _D0tMEyze;
        "pkg-1.1.3-26.1-fabric" = _AiCGtNs4;
        "pkg-1.1.3-26.1-neoforge" = _trK2p7bu;
        "pkg-1.8.0-1.21.1-neoforge" = _UOESZdVe;
        "pkg-1.8.0-1.21.1-fabric" = _B165mCNe;
        "pkg-1.8.0-1.20.1-fabric" = _kmowGrn6;
        "pkg-1.8.0-1.20.1-forge" = _tcFEUnbd;
        "pkg-1.8.1-1.21.1-neoforge" = _pxvytN74;
        "pkg-1.8.1-1.20.1-forge" = _PqEIjj2M;
        "pkg-2.0.0-1.21.1-fabric" = _5LoGQE3s;
        "pkg-2.0.0-1.21.1-neoforge" = _DfB7FiDY;
        "pkg-2.0.0-1.20.1-fabric" = _pShcLUKh;
        "pkg-2.0.0-1.20.1-forge" = _60JKCxGz;
        "pkg-2.0.1-1.20.1-fabric" = _O6ktKopQ;
        "pkg-2.0.1-1.20.1-forge" = _mOO3Mfqn;
        "pkg-2.0.1-1.21.1-fabric" = _WV0z04uU;
        "pkg-2.0.1-1.21.1-neoforge" = _UfxSe2Mq;
        "pkg-2.0.2-1.21.1-neoforge" = _V4KgxAsr;
        "pkg-2.0.2-1.21.1-fabric" = _m3r2eGhe;
        "pkg-2.0.2-1.20.1-fabric" = _ngDslsDO;
        "pkg-2.0.2-1.20.1-forge" = _so5x93Wc;
        "pkg-2.0.3-1.21.1-fabric" = _feGO0t8s;
        "pkg-2.0.3-1.21.1-neoforge" = _tX8lPwTb;
        "pkg-2.0.3-1.20.1-fabric" = _Zj3nqTxB;
        "pkg-2.0.3-1.20.1-forge" = _eV4mvfyn;
        "pkg-2.0.3-26.1.2-neoforge" = _rYt7HmK2;
        "pkg-2.0.3-26.1.2-fabric" = _J75Ealtb;
        "pkg-2.1.0-1.20.1-fabric" = _wwHTXLFB;
        "pkg-2.1.0-1.20.1-forge" = _x7nKjGOb;
        "pkg-2.1.0-1.21.1-neoforge" = _yJzqJvdB;
        "pkg-2.1.0-1.21.1-fabric" = _GVHDcmgj;
        "pkg-2.1.0-26.1.2-fabric" = _LLmdEZ9v;
        "pkg-2.1.0-26.1.2-neoforge" = _h8SL7CaU;
        "pkg-2.1.1-26.1.2-fabric" = _LZMoF2gK;
        "pkg-2.1.1-26.1.2-neoforge" = _NmULQPbB;
        "pkg-2.2.0-1.20.1-forge" = _v0kg2FS8;
        "pkg-2.2.0-1.20.1-fabric" = _yZ60la4J;
        "pkg-2.2.0-1.21.1-fabric" = _Te1Irna6;
        "pkg-2.2.0-1.21.1-neoforge" = _bLOhI2U7;
        "pkg-2.2.0-26.1.2-neoforge" = _wMltflID;
        "pkg-2.2.0-26.1.2-fabric" = _OeOiUG0I;
        "pkg-2.2.1-1.20.1-fabric" = _EGE0eklW;
        "pkg-2.2.1-1.20.1-forge" = _GtnA73vX;
        "pkg-2.2.1-1.21.1-fabric" = _tP4rRbXj;
        "pkg-2.2.1-1.21.1-neoforge" = _r8f5Ucqs;
        "pkg-2.2.2-1.20.1-fabric" = _Gm5iOMeM;
        "pkg-2.2.2-1.20.1-forge" = _1zcwBgrB;
        "pkg-2.2.2-1.21.1-fabric" = _kchLV50C;
        "pkg-2.2.2-1.21.1-neoforge" = _U8FuqsPr;
        "pkg-2.2.3-1.20.1-fabric" = _O8fma7kg;
        "pkg-2.2.3-1.20.1-forge" = _sDnLNxHH;
        "pkg-2.2.3-1.21.1-fabric" = _bud04SQz;
        "pkg-2.2.3-1.21.1-neoforge" = _yuYcL1v2;
        "pkg-2.2.4-1.20.1-fabric" = _C7YTLD41;
        "pkg-2.2.4-1.20.1-forge" = _Afktgw9Z;
        "pkg-2.2.4-1.21.1-neoforge" = _eR9oK4Fo;
        "pkg-2.2.4-1.21.1-fabric" = _Sjb8so0o;
        "pkg-2.2.4-26.1.2-neoforge" = _PQVwkchC;
        "pkg-2.2.4-26.1.2-fabric" = _OUhOjTg3;
        "pkg-3.0.0-26.1.2-neoforge" = _O4UJ052t;
        "pkg-3.0.0-26.1.2-fabric" = _H26UJxqE;
        "pkg-3.0.1-26.1.2-neoforge" = _wQiHjFmV;
        "pkg-3.0.1-26.1.2-fabric" = _Nfva9Lwh;
        "pkg-2.3.0-1.20.1-fabric" = _LNCnB6So;
        "pkg-2.3.0-1.20.1-forge" = _lYkyEAA3;
        "pkg-2.3.0-1.21.1-fabric" = _g79KolnQ;
        "pkg-2.3.0-1.21.1-neoforge" = _KWQJsVBP;
        "pkg-2.3.1-1.21.1-neoforge" = _t6sIaKRk;
        "pkg-2.3.1-1.21.1-fabric" = _p5RIKGqh;
        "pkg-3.1.1-26.1.2-fabric" = _3M12DQbb;
        "pkg-3.1.1-26.1.2-neoforge" = _hG95WyjY;
        "pkg-2.3.1-1.20.1-fabric" = _aiaoSVAZ;
        "pkg-2.3.1-1.20.1-forge" = _fcL70dcv;
        "pkg-2.4.0-1.20.1-fabric" = _myrslxct;
        "pkg-2.4.0-1.20.1-forge" = _D7iC0HfM;
        "pkg-2.4.0-1.21.1-neoforge" = _DfrD08GC;
        "pkg-2.4.0-1.21.1-fabric" = _6Imac2da;
        "pkg-2.5.0-1.21.1-neoforge" = _Vb9Snnub;
        "pkg-2.5.0-1.21.1-fabric" = _o1ZJ7r8n;
        "pkg-3.2.0-26.1.2-fabric" = _JrYTV2HY;
        "pkg-3.2.0-26.1.2-neoforge" = _JY7MvZvs;
        "pkg-2.4.1-1.20.1-forge" = _V0XY0DLj;
        "pkg-2.4.1-1.20.1-fabric" = _30keqM9w;
        "pkg-2.5.1-1.21.1-neoforge" = _LhfWdCAL;
        "pkg-2.5.1-1.21.1-fabric" = _f9nyxa0l;
        "pkg-2.6.0-1.21.1-neoforge" = _HrKYgKIh;
        "pkg-2.6.0-1.21.1-fabric" = _rB3ueYuw;
        "pkg-2.7.0-1.21.1-neoforge" = _AtuD2AaE;
        "pkg-2.7.0-1.21.1-fabric" = _bEt6uwCS;
        "pkg-2.8.0-1.21.1-neoforge" = _5j7r8otZ;
        "pkg-2.8.0-1.21.1-fabric" = _zn3AFZnu;
        "pkg-2.8.1-1.21.1-neoforge" = _QuglsZcQ;
        "pkg-2.8.1-1.21.1-fabric" = _m9PJozkd;
        "pkg-2.8.2-1.21.1-neoforge" = _NtSV8AfU;
        "pkg-2.8.2-1.21.1-fabric" = _WaW35akK;
        "pkg-2.8.3-1.21.1-fabric" = _3l2PZTXf;
        "pkg-2.8.3-1.21.1-neoforge" = _StChmDuZ;
        "pkg-2.8.4-1.21.1-neoforge" = _zhANvoYj;
        "pkg-2.8.4-1.21.1-fabric" = _RIOseGaw;
        "pkg-2.8.5-1.21.1-neoforge" = _V3TQuENH;
        "pkg-2.8.5-1.21.1-fabric" = _1DkB72kY;
        "pkg-2.8.6-1.21.1-neoforge" = _r0xZbqPt;
        "pkg-2.8.6-1.21.1-fabric" = _qWlyJ58Q;
        "pkg-2.9.0-1.21.1-fabric" = _4D7lmzak;
        "pkg-2.9.0-1.21.1-neoforge" = _dK67P0eh;
        "pkg-3.2.0-26.2-fabric" = _kksqtykd;
        "pkg-3.2.0-26.2-neoforge" = _SRuwaK2W;
        "pkg-2.9.1-1.21.1-neoforge" = _gN7XC2rE;
        "pkg-2.9.1-1.21.1-fabric" = _50pkgSQk;
        "pkg-2.9.2-1.21.1-fabric" = _M99OUEEr;
        "pkg-2.9.2-1.21.1-neoforge" = _qp8J0UaO;
        "pkg-2.4.2-1.20.1-fabric" = _XRzjfuSE;
        "pkg-2.4.2-1.20.1-forge" = _6YrVKgsU;
        "pkg-2.4.3-1.20.1-fabric" = _jnjCuh2P;
        "pkg-2.4.3-1.20.1-forge" = _yoQixmKI;
        "pkg-2.9.3-1.21.1-neoforge" = _p1u0lHcY;
        "pkg-2.9.3-1.21.1-fabric" = _ob0ZueUh;
        "pkg-2.9.4-1.21.1-neoforge" = _xqw0IzqH;
        "pkg-2.9.4-1.21.1-fabric" = _oHfyQRBt;
        "pkg-2.9.5-1.21.1-neoforge" = _LYTLD86d;
        "pkg-2.9.5-1.21.1-fabric" = _oEEPKrS9;
        "pkg-2.10.0-1.21.1-neoforge" = _C9ftdJzv;
        "pkg-2.10.0-1.21.1-fabric" = _ySjTqagJ;
        "pkg-2.10.2-1.21.1-neoforge" = _aL0UQpN0;
        "pkg-2.10.2-1.21.1-fabric" = _bzbW51if;
        "pkg-2.10.3-1.21.1-neoforge" = _YtSrnQGt;
        "pkg-2.10.3-1.21.1-fabric" = _UAMskDsv;
        "pkg-2.10.4-1.21.1-neoforge" = _Wsw9MmL1;
        "pkg-2.10.4-1.21.1-fabric" = _gFrLgkPd;
        "pkg-2.10.5-1.21.1-neoforge" = _84BmP4lE;
        "pkg-2.10.5-1.21.1-fabric" = _MsaNRmMM;
        "pkg-2.10.6-1.21.1-neoforge" = _7BnxWYb2;
        "pkg-2.10.6-1.21.1-fabric" = _SIHXOcHR;
        "pkg-2.4.4-1.20.1-fabric" = _j89noaCr;
        "pkg-2.4.4-1.20.1-forge" = _g2NyUSej;
        "pkg-2.4.5-1.20.1-fabric" = _TMOLB9cH;
        "pkg-2.4.5-1.20.1-forge" = _qKbARtNw;
        "pkg-2.10.7-1.21.1-neoforge" = _b83t34Mv;
        "pkg-2.10.7-1.21.1-fabric" = _XK96976O;
        "pkg-2.4.6-1.20.1-forge" = _OgqCEIoC;
        "pkg-2.4.6-1.20.1-fabric" = _PUyA9umi;
        "pkg-2.4.7-1.20.1-forge" = _GaarFh0u;
        "pkg-2.4.7-1.20.1-fabric" = _v1s7DBJ0;
        "pkg-2.10.8-1.21.1-neoforge" = _3oC2RpJD;
        "pkg-2.10.8-1.21.1-fabric" = _7gtA44XX;
        "pkg-2.10.9-1.21.1-neoforge" = _jfNscRRj;
        "pkg-2.10.9-1.21.1-fabric" = _Xwunbqr6;
        "pkg-2.11.0-1.21.1-neoforge" = _OJ4J7q0b;
        "pkg-2.11.0-1.21.1-fabric" = _XTi7n6U2;
        "pkg-2.11.1-1.21.1-fabric" = _8iSLlUDc;
        "pkg-2.11.1-1.21.1-neoforge" = _EUYD1RRr;
        "pkg-2.11.2-1.21.1-neoforge" = _KASJMe50;
        "pkg-2.11.2-1.21.1-fabric" = _olG0Jgia;
        "pkg-2.11.3-1.21.1-neoforge" = _O6vLKWmA;
        "pkg-2.11.3-1.21.1-fabric" = _IH52VNlM;
        "pkg-2.5.0-1.20.1-fabric" = _jdPr1QIP;
        "pkg-2.5.0-1.20.1-forge" = _hPol6HPL;
        "pkg-3.0.0-1.20.1-fabric" = _w7ryoSnP;
        "pkg-3.0.0-1.20.1-forge" = _Dbg8XKbP;
        "pkg-3.3.0-26.1.2-fabric" = _9Drs8Kd1;
        "pkg-3.3.0-26.1.2-neoforge" = _8PW1Sr73;
        "pkg-3.3.0-26.2-fabric" = _v8UZyo2Z;
        "pkg-3.3.0-26.2-neoforge" = _IvhssMTH;
        "pkg-2.12.0-1.21.1-fabric" = _bKMkb6mD;
        "pkg-2.12.0-1.21.1-neoforge" = _2q4C9kR4;
        "pkg-2.12.1-1.21.1-fabric" = _HLlKtA6l;
        "pkg-2.12.1-1.21.1-neoforge" = _YU1aXAsw;
        "pkg-3.3.1-26.2-fabric" = _UXJLiWo4;
        "pkg-3.3.1-26.2-neoforge" = _PhdCFZMX;
        "pkg-3.3.1-26.1.2-fabric" = _GC0xlh5x;
        "pkg-3.3.1-26.1.2-neoforge" = _Q5fVrLNp;
        "pkg-3.3.2-26.1.2-fabric" = _BsdUsrJI;
        "pkg-3.3.2-26.1.2-neoforge" = _YpYtL54G;
        "pkg-3.3.2-26.2-fabric" = _4v41OY0J;
        "pkg-3.3.2-26.2-neoforge" = _GGjJfoLI;
        "pkg-3.1.0-1.20.1-fabric" = _CQXxDrE9;
        "pkg-3.1.0-1.21.1-neoforge" = _gTZ62Sja;
        "pkg-3.1.0-1.21.1-fabric" = _eFqBIjoI;
