...
let
    versions = (let
        ...
        _tLCRIkwt = {
            "id" = "tLCRIkwt";
            "file" = "forgified-fabric-api-0.116.15+2.3.2+1.21.1.jar";
            "hash" = "sha512-I45hO98F1UfnOGEjNec8/PDHkI4wUUzgHZnbipoHsr0MD+5+PqyOy+y/e7RGqPwGxytk5Bd8yLsgucuPbrbn5g==";
        };
        _euZUJ6Wv = {
            "id" = "euZUJ6Wv";
            "file" = "forgified-fabric-api-0.155.2+26.1.2+3.5.0.jar";
            "hash" = "sha512-sHTzz1LMIfKk0pHQxchPjOY6ASyOIds3Yzx2JI2eqeWkz7I9mcqOU+1BYBS2LKXr+74hsPZs51XMEvbigrRZVg==";
        };
        _g0MxcWXy = {
            "id" = "g0MxcWXy";
            "file" = "fabric-api-0.92.6+1.11.15+1.20.1.jar";
            "hash" = "sha512-2h5Z+nVO2yTYo7YCPvZI1kMagpep6HPRi/6GasqThPSRrxtDjCxLddv5vUuaEdr3F6jRRp6e+u0UXlxT+cvPNw==";
        };
        _ubZIpGFv = {
            "id" = "ubZIpGFv";
            "file" = "forgified-fabric-api-0.116.15+2.3.3+1.21.1.jar";
            "hash" = "sha512-DO2n4BMa15WrQG8uoppY//QxBLVq8n/p67He/HxHytPiD4piWpDsxA9iC3q6x9OAeKW+PreMHzK5d5Ra0HicdA==";
        };
        _88VeFQlT = {
            "id" = "88VeFQlT";
            "file" = "forgified-fabric-api-0.155.2+26.1.2+3.5.1.jar";
            "hash" = "sha512-8OX2oFh54r8XLWOfuu4OMgv1woLqBP4h4xBFCXzMSKlagaeK//d1mksLhU2zHfoukmtiiZBS3spKMT5JKC+0Vw==";
        };
        _BJ7ijJLd = {
            "id" = "BJ7ijJLd";
            "file" = "forgified-fabric-api-0.155.2+26.1.2+3.5.2.jar";
            "hash" = "sha512-B6x1N/nwVd+XpQjPHPMl84ItXvtO6nDP1fmcDHQ/5zTSo7zfDwRlp2GiX9V5l9Ca89mpR5oLog5jlSjF10KNIQ==";
        };
        _lVXiShxP = {
            "id" = "lVXiShxP";
            "file" = "forgified-fabric-api-0.155.2+26.1.2+3.5.3.jar";
            "hash" = "sha512-W7LOwzzzNUZU6UBXdStxdoWXcqgTNpqOoCjDu2TMyhyZ1UargATWXjONuFcf6a/lNA/vWawope7L6P0ZomA4Aw==";
        };
        _K4hHKnnI = {
            "id" = "K4hHKnnI";
            "file" = "forgified-fabric-api-0.116.15+2.3.4+1.21.1.jar";
            "hash" = "sha512-LehNuCnK6Sb3qQ2NgoEUuNjXNcojDVGMbDdy9vJbSIOLIJ9118GYuju27Fpk0SCUx7fazHavOHJjpQ6X4HwmLg==";
        };
        _NwmAx3of = {
            "id" = "NwmAx3of";
            "file" = "forgified-fabric-api-0.155.2+26.1.2+3.5.4.jar";
            "hash" = "sha512-eRzlIVBrjPPj5NQkuxzd3TMfuCUHjIMaUolYWz4CB6L9zL7RZTCbfHCsYK1sKqCZhcroPskPZulgb9JF/fhMVw==";
        };
        _D1SolqMD = {
            "id" = "D1SolqMD";
            "file" = "forgified-fabric-api-0.155.2+26.1.2+3.5.5.jar";
            "hash" = "sha512-4qLC0vYMWMJXZXrgC1cVf8eHaq8NO3SlQbcRNwkYOOLz7EmpLT8hXe7F0+aVGEvVkd2x/AnrRxQZIsGWkncvHQ==";
        };
        _V9WdDUTx = {
            "id" = "V9WdDUTx";
    ...
    in {
        ...
        "pkg-0.86.0+1.5.0+1.20.1" = _sGly1Rdo;
        "pkg-0.86.0+1.6.0+1.20.1" = _PGFCRmyV;
        "pkg-0.86.1+1.6.0+1.20.1" = _Ri84g8eX;
        "pkg-0.86.1+1.6.1+1.20.1" = _QqpyiDh3;
        "pkg-0.86.1+1.7.0+1.20.1" = _qv3A2YpL;
        "pkg-0.86.1+1.7.1+1.20.1" = _S13JUxqv;
        "pkg-0.86.1+1.7.2+1.20.1" = _6SG9khep;
        "pkg-0.86.1+1.8.0+1.20.1" = _VcKidDJZ;
        "pkg-0.86.1+1.8.1+1.20.1" = _YlahjL85;
        "pkg-0.86.1+1.8.2+1.20.1" = _A8PNwlLL;
        "pkg-0.86.1+1.8.3+1.20.1" = _YCdTpXDB;
        "pkg-0.86.1+1.8.4+1.20.1" = _3TtugPt5;
        "pkg-0.87.0+1.8.5+1.20.1" = _ckWkgWum;
        "pkg-0.87.0+1.9.1+1.20.1" = _LhzI37DT;
        "pkg-0.87.0+1.9.2+1.20.1" = _EWT0sz4G;
        "pkg-0.87.0+1.9.3+1.20.1" = _VikUQCse;
        "pkg-0.87.0+1.9.4+1.20.1" = _GXsbrT9S;
        "pkg-0.87.0+1.9.5+1.20.1" = _p4QdTfJp;
        "pkg-0.87.0+1.9.6+1.20.1" = _MjFgJuFO;
        "pkg-0.87.0+1.9.7+1.20.1" = _4gsjvgjb;
        "pkg-0.87.0+1.9.8+1.20.1" = _hza2Pxkz;
        "pkg-0.87.0+1.9.9+1.20.1" = _8Ul21COc;
        "pkg-0.88.1+1.9.10+1.20.1" = _UKf9cRzu;
        "pkg-0.88.1+1.9.11+1.20.1" = _LLJcUxlF;
        "pkg-0.88.1+1.9.12+1.20.1" = _XBKbNMW0;
        "pkg-0.88.1+1.9.13+1.20.1" = _ATHkZpTi;
        "pkg-0.88.1+1.9.14+1.20.1" = _vaAgRqsU;
        "pkg-0.88.1+1.9.15+1.20.1" = _gRhlWhje;
        "pkg-0.89.0+1.9.16+1.20.1" = _FEqdSJI1;
        "pkg-0.89.0+1.9.17+1.20.1" = _9GRsNyR6;
        "pkg-0.89.0+1.9.18+1.20.1" = _1JL8ugtS;
        "pkg-0.89.0+1.9.19+1.20.1" = _bEVmNAGL;
        "pkg-0.89.0+1.9.20+1.20.1" = _SkCa3i3J;
        "pkg-0.89.0+1.9.21+1.20.1" = _Sc7HevsV;
        "pkg-0.89.0+1.9.22+1.20.1" = _OiT1op2U;
        "pkg-0.89.0+1.9.23+1.20.1" = _qhiUNT1A;
        "pkg-0.89.0+1.9.24+1.20.1" = _vPLJkp8k;
        "pkg-0.89.0+1.9.25+1.20.1" = _bcoTpHHY;
        "pkg-0.90.0+1.9.25+1.20.1" = _MThJZev4;
        "pkg-0.90.0+1.9.26+1.20.1" = _oQftcYQR;
        "pkg-0.90.0+1.9.27+1.20.1" = _VQqVZLxu;
        "pkg-0.90.0+1.9.28+1.20.1" = _TO2BhEmw;
        "pkg-0.90.4+1.9.28+1.20.1" = _KTZtMyO5;
        "pkg-0.90.4+1.9.29+1.20.1" = _Uuh9LOe5;
        "pkg-0.90.4+1.9.30+1.20.1" = _mA9zMqdH;
        "pkg-0.90.7+1.9.30+1.20.1" = _9QsnWfRl;
        "pkg-0.90.7+1.9.32+1.20.1" = _lQX6g7sR;
        "pkg-0.90.7+1.9.33+1.20.1" = _VwsM2bqh;
        "pkg-0.90.7+1.10.0+1.20.1" = _uOV85sJq;
        "pkg-0.90.7+1.10.1+1.20.1" = _XuoLHncM;
        "pkg-0.90.7+1.10.2+1.20.1" = _oZi6BlS7;
        "pkg-0.90.7+1.10.3+1.20.1" = _S34llcH8;
        "pkg-0.91.0+1.10.4+1.20.1" = _rdpIJ7r3;
        "pkg-0.91.0+1.10.5+1.20.1" = _BO4fgdx5;
        "pkg-0.91.0+1.10.6+1.20.1" = _9euYpXCc;
        "pkg-0.91.0+1.10.7+1.20.1" = _kioCTZ1N;
        "pkg-0.91.0+1.10.8+1.20.1" = _q5kbwIvk;
        "pkg-0.92.0+1.11.1+1.20.1" = _1SWYhNrt;
        "pkg-0.92.0+1.11.2+1.20.1" = _Qg5o7JEY;
        "pkg-0.92.0+1.11.3+1.20.1" = _pWa2YXuc;
        "pkg-0.92.0+1.11.4+1.20.1" = _hubTP8ip;
        "pkg-0.92.0+1.11.5+1.20.1" = _nrJg60PH;
        "pkg-0.92.1+1.11.5+1.20.1" = _dfzS3J8n;
        "pkg-0.92.1+1.11.7+1.20.1" = _gwP6WAQb;
        "pkg-0.92.1+1.11.8+1.20.1" = _DXF7HH4f;
        "pkg-0.92.2+1.11.8+1.20.1" = _D3EZO1Kr;
        "pkg-0.100.4+2.0.0+1.21" = _40eWdJ1X;
        "pkg-0.100.6+2.0.0+1.21" = _Ch8k8D3T;
        "pkg-0.100.6+2.0.1+1.21" = _da3fCzkD;
        "pkg-0.100.6+2.0.2+1.21" = _Yzs19UrY;
        "pkg-0.100.6+2.0.3+1.21" = _NCJnp0bi;
        "pkg-0.100.6+2.0.4+1.21" = _GhYDWoPi;
        "pkg-0.100.6+2.0.5+1.21" = _3mpYn8s1;
        "pkg-0.100.7+2.0.6+1.21" = _Qd8IgKpP;
        "pkg-0.100.7+2.0.7+1.21" = _o5LuJoCp;
        "pkg-0.100.7+2.0.8+1.21" = _V7quEuiR;
        "pkg-0.101.2+2.0.9+1.21" = _vhJAJtWn;
        "pkg-0.101.2+2.0.10+1.21" = _K5REyk0w;
        "pkg-0.102.0+2.0.11+1.21.1" = _cPvIelmQ;
        "pkg-0.102.0+2.0.12+1.21.1" = _GMkGuXO4;
        "pkg-0.104.0+2.0.12+1.21.1" = _yBBRHOhD;
        "pkg-0.104.0+2.0.13+1.21.1" = _hvuIf2Ij;
        "pkg-0.104.0+2.0.14+1.21.1" = _Jfn0eaw3;
        "pkg-0.104.0+2.0.15+1.21.1" = _2bxEYAKi;
        "pkg-0.104.0+2.0.16+1.21.1" = _SEPr0dKm;
        "pkg-0.104.0+2.0.17+1.21.1" = _BL3sKxr1;
        "pkg-0.104.0+2.0.18+1.21.1" = _L7Mufn4x;
        "pkg-0.104.0+2.0.19+1.21.1" = _kgswi4BN;
        "pkg-0.107.0+2.0.20+1.21.1" = _hZWNslS6;
        "pkg-0.92.2+1.11.9+1.20.1" = _2Jm6cdbX;
        "pkg-0.107.0+2.0.21+1.21.1" = _eBuCy0Pz;
        "pkg-0.107.0+2.0.22+1.21.1" = _zBdt8WxF;
        "pkg-0.107.0+2.0.23+1.21.1" = _Fz3tHM30;
        "pkg-0.92.2+1.11.10+1.20.1" = _D6vinKOB;
        "pkg-0.92.2+1.11.11+1.20.1" = _MwQ968Sx;
        "pkg-0.107.0+2.0.24+1.21.1" = _1vqVLbUz;
        "pkg-0.92.2+1.11.12+1.20.1" = _qzoL6HjK;
        "pkg-0.107.0+2.0.25+1.21.1" = _674fIqe4;
        "pkg-0.107.0+2.0.26+1.21.1" = _bwjdatGD;
        "pkg-0.115.6+2.1.0+1.21.1" = _BOq0raqo;
        "pkg-0.115.6+2.1.1+1.21.1" = _vQbH2z4u;
        "pkg-0.92.2+1.11.13+1.20.1" = _7DLGFVwR;
        "pkg-0.92.6+1.11.14+1.20.1" = _XweDEycJ;
        "pkg-0.115.6+2.1.2+1.21.1" = _O2rCJvg7;
        "pkg-0.115.6+2.1.3+1.21.1" = _6cijwglm;
        "pkg-0.115.6+2.1.4+1.21.1" = _9uOfdsZC;
        "pkg-0.116.7+2.2.0+1.21.1" = _tIUhtT2C;
        "pkg-0.116.7+2.2.1+1.21.1" = _16ZPmtFm;
        "pkg-0.116.7+2.2.2+1.21.1" = _RctniEse;
        "pkg-0.116.7+2.2.3+1.21.1" = _xz5fFY6r;
        "pkg-0.116.7+2.2.4+1.21.1" = _7nHK7hMg;
        "pkg-0.150.0+3.0.0+26.1.2" = _eBl3EzCf;
        "pkg-0.152.1+3.0.0+26.1.2" = _6jgRGftE;
        "pkg-0.152.1+3.0.1+26.1.2" = _BvBIVF0R;
        "pkg-0.152.1+3.0.2+26.1.2" = _EFdf0tsP;
        "pkg-0.152.1+3.0.3+26.1.2" = _iR09Or4r;
        "pkg-0.152.1+3.0.4+26.1.2" = _aIrd7fsN;
        "pkg-0.152.1+3.0.5+26.1.2" = _85BBpYAz;
        "pkg-0.152.1+3.0.6+26.1.2" = _7Q0TRUy7;
        "pkg-0.152.1+3.0.7+26.1.2" = _pPdXwmuh;
        "pkg-0.154.0+3.0.8+26.1.2" = _zTL7BgiF;
        "pkg-0.154.0+3.1.0+26.1.2" = _4VuD593Y;
        "pkg-0.154.0+3.1.1+26.1.2" = _jwmLvEjU;
        "pkg-0.154.0+3.1.2+26.1.2" = _j8Amw2VU;
        "pkg-0.154.0+3.1.3+26.1.2" = _2UlAERp6;
        "pkg-0.154.0+3.2.0+26.1.2" = _1tO2A9x6;
        "pkg-0.154.0+3.2.1+26.1.2" = _OH5u5fMb;
        "pkg-0.154.0+3.2.2+26.1.2" = _r7jVSmZ9;
        "pkg-0.154.0+3.2.3+26.1.2" = _f3O3732k;
        "pkg-0.154.0+3.2.4+26.1.2" = _Mp76Hbal;
        "pkg-0.154.0+3.2.5+26.1.2" = _c6Xuu9Zb;
        "pkg-0.154.0+3.2.6+26.1.2" = _9WAynXyD;
        "pkg-0.116.13+2.2.4+1.21.1" = _eCUwdgcG;
        "pkg-0.116.13+2.2.5+1.21.1" = _YsECO6Ri;
        "pkg-0.155.0+26.1.2+3.2.6" = _d7CJkLbP;
        "pkg-0.116.13+2.3.0+1.21.1" = _ZPwOh4Do;
        "pkg-0.116.14+2.3.0+1.21.1" = _dAxle9F7;
        "pkg-0.155.0+26.1.2+3.2.7" = _QbJBo5qP;
        "pkg-0.155.0+26.1.2+3.2.8" = _hLUF2GUu;
        "pkg-0.155.0+26.1.2+3.3.0" = _pP6KSINx;
        "pkg-0.155.0+26.1.2+3.4.0" = _UNmtv3yJ;
        "pkg-0.155.0+26.1.2+3.4.1" = _nGGZ7CCt;
        "pkg-0.155.0+26.1.2+3.4.2" = _rG5Z7yD5;
        "pkg-0.155.2+26.1.2+3.4.3" = _d5CK9bi0;
        "pkg-0.155.2+26.1.2+3.4.4" = _45ZyQqXP;
        "pkg-0.116.15+2.3.1+1.21.1" = _L9bk5uA9;
        "pkg-0.116.15+2.3.2+1.21.1" = _tLCRIkwt;
        "pkg-0.155.2+26.1.2+3.5.0" = _euZUJ6Wv;
        "pkg-0.92.6+1.11.15+1.20.1" = _g0MxcWXy;
        "pkg-0.116.15+2.3.3+1.21.1" = _ubZIpGFv;
        "pkg-0.155.2+26.1.2+3.5.1" = _88VeFQlT;
        "pkg-0.155.2+26.1.2+3.5.2" = _BJ7ijJLd;
        "pkg-0.155.2+26.1.2+3.5.3" = _lVXiShxP;
        "pkg-0.116.15+2.3.4+1.21.1" = _K4hHKnnI;
