...
let
    ...
    in {
        ...
        "pkg-9.3.0" = _QCAbKolR;
        "pkg-9.4.0" = _fmWmZXGK;
        "pkg-10.0.0" = _9akT5VAK;
        "pkg-10.0.1" = _lASGkjyt;
        "pkg-11.0.0" = _dQ82sN0H;
        "pkg-8.3.0" = _eVS4daBE;
        "pkg-11.0.1" = _Qu7x0wrQ;
        "pkg-11.1.0" = _JWezFdBF;
        "pkg-8.4.0" = _LkOxAgX9;
        "pkg-11.1.1" = _w2QU0yxP;
        "pkg-8.5.0" = _RTsvom9f;
        "pkg-11.2.0" = _Ee9btGtO;
        "pkg-12.0.0" = _vkUoJsbl;
        "pkg-9.0.1" = _oAXzs0eu;
        "pkg-13.0.1" = _CbJkvFqH;
        "pkg-13.0.2" = _nYtzc7Ae;
        "pkg-14.0.0" = _fndPUyML;
        "pkg-21.4.1" = _dTQnsq0X;
        "pkg-21.4.14" = _LsT5l340;
        "pkg-21.5.0" = _2Rzjg6gY;
        "pkg-21.5.1" = _jDjI7vQ4;
        "pkg-21.5.9" = _qhO07Uwj;
        "pkg-21.6.0" = _LPAcZHXj;
        "pkg-21.7.0" = _HqwTNjnI;
        "pkg-21.10.0" = _nGI264Hy;
        "pkg-21.11.0" = _vlEZ59JE;
