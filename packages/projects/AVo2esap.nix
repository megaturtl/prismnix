...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.20.1-forge" = _pzkIKGrf;
        "pkg-1.0.0+1.18.2-fabric" = _JMxksGDS;
        "pkg-1.0.0+1.18.2-forge" = _mOf71T4V;
        "pkg-1.0.0+1.17.1-fabric" = _4ywwwnd9;
        "pkg-1.0.0+1.17.1-forge" = _KM0XAThg;
        "pkg-1.0.0+1.16.5-fabric" = _tLftgdBU;
        "pkg-1.0.0+1.16.5-forge" = _KDlOzMEW;
        "pkg-1.1.0+1.16.5-fabric" = _xda9Bwtu;
        "pkg-1.1.0+1.16.5-forge" = _pCOq3i2A;
        "pkg-1.1.0+1.17.1-fabric" = _1WwI4Z5N;
        "pkg-1.1.0+1.17.1-forge" = _W8iQ5bES;
        "pkg-1.1.0+1.18.2-fabric" = _kgHH2KTf;
        "pkg-1.1.0+1.18.2-forge" = _EV9MruRu;
        "pkg-1.1.0+1.19.2-fabric" = _cMLGlDnx;
        "pkg-1.1.0+1.19.2-forge" = _949X1ZT4;
        "pkg-1.1.0+1.20.1-fabric" = _149dbdTA;
        "pkg-1.1.0+1.20.1-forge" = _KdWVlCUM;
        "pkg-1.1.1+1.16.5-fabric" = _ZjPuNmM0;
        "pkg-1.1.1+1.16.5-forge" = _2yt2xsd1;
        "pkg-1.2.0+1.20.2-fabric" = _RQErLESZ;
        "pkg-1.2.0+1.20.2-neoforge" = _M6UikOu1;
        "pkg-1.2.1+1.20.3-fabric" = _6Xjvbk9m;
        "pkg-1.2.1+1.20.3-neoforge" = _yQrQ3xiT;
        "pkg-1.2.3+1.20.6-fabric" = _q5tWRW8w;
        "pkg-1.2.3+1.20.6-neoforge" = _XmZJO1x8;
        "pkg-1.2.3+1.20.4-fabric" = _AdWvkW1n;
        "pkg-1.2.3+1.20.4-neoforge" = _muSx4abO;
        "pkg-1.3.0+1.21-fabric" = _hckKNApe;
        "pkg-1.3.0+1.21-neoforge" = _pNHwZjEV;
        "pkg-1.4.0+1.21.3-neoforge" = _mjkBdMLt;
        "pkg-1.4.0+1.21.3-fabric" = _a08hvXfp;
        "pkg-1.4.1+1.21.5-fabric" = _11KFE6HO;
        "pkg-1.4.1+1.21.5-neoforge" = _rECVADIf;
        "pkg-1.4.1+1.21.6-fabric" = _IZIHyIj5;
        "pkg-1.4.1+1.21.6-neoforge" = _WXgs1am5;
        "pkg-1.4.1+1.21.11-fabric" = _Dvt1g4Zb;
        "pkg-1.4.1+1.21.11-neoforge" = _LNQQHiiA;
        "pkg-1.4.1+26.1-fabric" = _479njfLS;
        "pkg-1.4.1+26.1-neoforge" = _14e4mVcY;
        "pkg-1.4.2+26.1-fabric" = _O4qFUou7;
        "pkg-1.4.2+26.1-neoforge" = _N5sXnBNm;
        "pkg-1.1.1+1.20.1-fabric" = _QHihqFdt;
        "pkg-1.1.1+1.20.1-forge" = _W6FbfJdU;
        "pkg-1.3.1+1.21-fabric" = _Fu92Hgpi;
