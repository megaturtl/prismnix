...
let
    versions = (let
        ...
        _HhQAy7Xw = {
            "id" = "HhQAy7Xw";
            "file" = "FakeSeed-1.0.0.jar";
            "hash" = "sha512-0rEUdCNk+IE54/hjudFRdRrRFYG0KQQMJPul6xyeakWm20bdPlYenURTYFHdlNxqMxj5g131jnWFUxdpZqVnFw==";
        };
    in {
        "OMzBYhU0" = _OMzBYhU0;
        "s30bGk67" = _s30bGk67;
        ...
        "bukkit-1.21" = _HhQAy7Xw;
        "bukkit-1.21.1" = _HhQAy7Xw;
        "bukkit-1.21.2" = _HhQAy7Xw;
        "bukkit-1.21.3" = _HhQAy7Xw;
        "bukkit-1.21.4" = _HhQAy7Xw;
        "bukkit-1.21.5" = _HhQAy7Xw;
        "bukkit-1.21.6" = _HhQAy7Xw;
        "bukkit-1.21.7" = _HhQAy7Xw;
        "bukkit-1.21.8" = _HhQAy7Xw;
        "bukkit-1.21.9" = _HhQAy7Xw;
        "bukkit-1.21.10" = _HhQAy7Xw;
        "bukkit-1.21.11" = _HhQAy7Xw;
        "bukkit-26.1" = _HhQAy7Xw;
        "bukkit-26.1.1" = _HhQAy7Xw;
        "bukkit-26.1.2" = _HhQAy7Xw;
        "bukkit-26.2" = _HhQAy7Xw;
        "bukkit-26.3" = _HhQAy7Xw;
        ...
        "paper-1.21" = _HhQAy7Xw;
        "paper-1.21.1" = _HhQAy7Xw;
        "paper-1.21.2" = _HhQAy7Xw;
        "paper-1.21.3" = _HhQAy7Xw;
        "paper-1.21.4" = _HhQAy7Xw;
        "paper-1.21.5" = _HhQAy7Xw;
        "paper-1.21.6" = _HhQAy7Xw;
        "paper-1.21.7" = _HhQAy7Xw;
        "paper-1.21.8" = _HhQAy7Xw;
        "paper-1.21.9" = _HhQAy7Xw;
        "paper-1.21.10" = _HhQAy7Xw;
        "paper-1.21.11" = _HhQAy7Xw;
        "paper-26.1" = _HhQAy7Xw;
        "paper-26.1.1" = _HhQAy7Xw;
        "paper-26.1.2" = _HhQAy7Xw;
        "paper-26.2" = _HhQAy7Xw;
        "paper-26.3" = _HhQAy7Xw;
        ...
        "spigot-1.21" = _HhQAy7Xw;
        "spigot-1.21.1" = _HhQAy7Xw;
        "spigot-1.21.2" = _HhQAy7Xw;
        "spigot-1.21.3" = _HhQAy7Xw;
        "spigot-1.21.4" = _HhQAy7Xw;
        "spigot-1.21.5" = _HhQAy7Xw;
        "spigot-1.21.6" = _HhQAy7Xw;
        "spigot-1.21.7" = _HhQAy7Xw;
        "spigot-1.21.8" = _HhQAy7Xw;
        "spigot-1.21.9" = _HhQAy7Xw;
        "spigot-1.21.10" = _HhQAy7Xw;
        "spigot-1.21.11" = _HhQAy7Xw;
        "spigot-26.1" = _HhQAy7Xw;
        "spigot-26.1.1" = _HhQAy7Xw;
        "spigot-26.1.2" = _HhQAy7Xw;
        "spigot-26.2" = _HhQAy7Xw;
        "spigot-26.3" = _HhQAy7Xw;
        "pkg-1.0.0" = _S3IjgNVh;
