...
let
    ...
    in {
        ...
        "pkg-1.1.3+1.21" = _ygIYTd4n;
        "pkg-1.2.0+1.21" = _6Yk9GKKi;
        "pkg-1.2.0+1.21.3" = _J7azRHYI;
        "pkg-1.2.0+1.21.4" = _IDoBUR3g;
        "pkg-1.3.0+1.21.4" = _zqqosJBo;
        "pkg-1.3.0+1.21.5" = _RuKpUmsV;
        "pkg-1.3.1+1.21.5" = _9dNc7VrI;
        "pkg-1.3.1+1.21.4" = _M0nV5kfb;
        "pkg-1.4.0+1.21.5" = _4XXvcTZk;
        "pkg-1.5.0+1.21.5" = _vHf6lkmS;
        "pkg-1.5.1+1.21.5" = _4lVm5tS9;
        "pkg-1.5.1+1.21.6" = _noroBrZ9;
        "pkg-1.5.2+1.21.5" = _pkrAK0Qj;
        "pkg-1.5.2+1.21.6" = _1Xkl6oq6;
        "pkg-1.6.0+1.21.7" = _FxZyxAju;
        "pkg-1.6.0+1.21.9" = _a56qEzVb;
        "pkg-1.6.0+1.21.11" = _XlzUg9VP;
        "pkg-2.0.0+1.21.11" = _wF52y5rH;
