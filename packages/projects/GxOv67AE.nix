...
let
    ...
    in {
        ...
        "pkg-0.1.3-1.20.1" = _s7DfJ79v;
        "pkg-0.1.4-1.20.1" = _olCKcSCa;
        "pkg-0.1.5-1.20.1" = _tiTDKGq7;
        "pkg-0.1.6-1.20.1" = _kTJLwhla;
        "pkg-0.1.7-1.20.1" = _K8mnP9Bo;
        "pkg-0.1.8-1.20.1" = _kX9TsBbq;
        "pkg-0.1.9-1.20.1" = _I8Gta10x;
        "pkg-0.1.10-1.20.1" = _gt7Krzit;
        "pkg-1.0.0-1.21.1" = _kvefRTeO;
        "pkg-1.0.1-1.21.1" = _UhafPZe8;
        "pkg-1.0.2-1.21.1" = _YiiY1dtt;
        "pkg-1.0.3-1.21.1" = _RfV0Znj4;
        "pkg-1.0.4-1.21.1" = _gkTwtu3r;
        "pkg-1.0.5-1.21.1" = _s3w0Kwfw;
        "pkg-1.0.6-1.21.1" = _Vut7zv7o;
        "pkg-1.0.7-1.21.1" = _qYhDV09w;
        "pkg-1.0.8-1.21.1" = _VCOIAzpE;
        "pkg-1.0.9-1.21.1" = _FySduOad;
        "pkg-0.1.11-1.20.1" = _IouBvqgC;
        "pkg-1.0.10-1.21.1" = _zaH9Zc2U;
        "pkg-1.0.11-1.21.1" = _jb2J9JF2;
        "pkg-1.0.12-1.21.1" = _T1dO0dIT;
        "pkg-1.0.13-1.21.1" = _5lYDLl6V;
        "pkg-1.0.14-1.21.1" = _D8aXp1fP;
        "pkg-1.0.15-1.21.1" = _Wiq5bR4i;
        "pkg-1.0.16-1.21.1" = _6QbapbAU;
        "pkg-0.1.12-1.20.1" = _fBgSR5KZ;
        "pkg-1.0.17-1.21.1" = _cgIn5mi1;
        "pkg-1.0.18-1.21.1" = _K9IwlRCt;
