...
let
    ...
    in {
        ...
        "pkg-0.3.1+1.16.5" = _Ct6H3qIG;
        "pkg-0.3.1+1.18.2" = _YUbSp15o;
        "pkg-0.3.1+1.19.2" = _OaCUe8oD;
        "pkg-0.4.0+1.16.5" = _DUagJaMU;
        "pkg-0.4.0+1.18.2" = _vqT6GRBm;
        "pkg-0.4.0+1.19.2" = _djqtlkLo;
        "pkg-0.4.1+1.19.2" = _VmkTdxxl;
        "pkg-0.4.1+1.18.2" = _Dn6W7a9H;
        "pkg-0.4.1+1.16.5" = _UYP4Rqd0;
        "pkg-0.4.2+1.16.5" = _f2iC5llO;
        "pkg-0.4.2+1.18.2" = _bxmOrdzY;
        "pkg-0.4.2+1.19.2" = _kerTm0hu;
        "pkg-0.4.3+1.18.2" = _RfWv7VTf;
        "pkg-0.4.3+1.19.2" = _MKHU8i77;
        "pkg-0.4.3+1.19.3" = _8f6VHerj;
        "pkg-0.4.4+1.18.2" = _JKVa5HAR;
        "pkg-0.4.4+1.19.2" = _RYHSL6Tq;
        "pkg-0.4.4+1.19.3" = _jszhXsRv;
        "pkg-0.5.0+1.18.2" = _ZbK86c8w;
        "pkg-0.5.0+1.19.2" = _EfzpAxWj;
        "pkg-0.5.0+1.19.3" = _Xa8zGPzD;
        "pkg-0.5.1+1.18.2" = _dYLusXH3;
        "pkg-0.5.1+1.19.2" = _uXYwVV3s;
        "pkg-0.5.1+1.19.3" = _pCatGC9V;
        "pkg-0.6.0+1.19.2" = _ZfEX0OzK;
        "pkg-0.6.0+1.18.2" = _F2D9CPzZ;
        "pkg-0.6.0+1.19.3" = _A2sUAYp0;
        "pkg-0.6.0+1.19.4" = _ATGpND01;
        "pkg-0.6.1+1.18.2" = _YyUWD0de;
        "pkg-0.6.1+1.19.2" = _X0ecnRfs;
        "pkg-0.6.1+1.19.3" = _XUIOkiyd;
        "pkg-0.6.1+1.19.4" = _gdK9MhKg;
        "pkg-0.6.1+1.20" = _dywXkJT4;
        "pkg-0.6.1+1.20.1" = _LNjEcFua;
        "pkg-0.6.2+1.18.2" = _9dw49h6I;
        "pkg-0.4.3+1.16.5" = _t96rXKWy;
        "pkg-0.6.3+1.18.2" = _lNLf3iks;
        "pkg-0.6.3+1.19.3" = _EpMXRF7b;
        "pkg-0.6.3+1.19.4" = _atne7IVv;
        "pkg-0.6.3+1.19.2" = _UeEzfc2L;
        "pkg-0.6.3+1.20" = _cUPcxPZ8;
        "pkg-0.6.3+1.20.1" = _mdpQ36gL;
        "pkg-0.4.4+1.16.5" = _stOcwdwe;
        "pkg-0.6.4+1.18.2" = _sG3Wnifg;
        "pkg-0.6.5+1.19.2" = _Jcrt3Ria;
        "pkg-0.6.5+1.19.4" = _pXIYrVo1;
        "pkg-0.6.5+1.20.1" = _CrrCe8Ph;
        "pkg-0.6.6+1.19.2" = _rn2JfXu9;
        "pkg-0.6.6+1.19.4" = _OD6KRdmK;
        "pkg-0.6.6+1.20.1" = _EKRNzV3a;
        "pkg-0.6.6+1.18.2" = _pxKxgWly;
        "pkg-0.6.7+1.18.2" = _ud1QWauc;
        "pkg-0.6.7+1.19.4" = _OAv1frEB;
        "pkg-0.6.7+1.19.2" = _KD522cBS;
        "pkg-0.6.7+1.20.1" = _dZk1qbHj;
        "pkg-0.6.8+1.20.1" = _vvLA2zs9;
        "pkg-0.7.0+1.21.1" = _n5sFT6U0;
        "pkg-0.7.1+1.21.1" = _mWnqjtgT;
        "pkg-0.7.2+1.21.1" = _hosYPFYH;
        "pkg-0.7.3+1.21.1" = _TYgRWKLi;
        "pkg-0.7.4+1.21.1" = _wVfl5LeH;
        "pkg-0.6.9+1.20.1" = _CnaF81re;
        "pkg-0.7.5+1.21.1" = _LtHmyAH1;
        "pkg-0.6.10+1.20.1" = _QHkdoCL0;
        "pkg-0.7.6+1.21.1" = _cEaVxjXh;
        "pkg-0.6.11+1.20.1" = _r5DnOj44;
        "pkg-0.6.12+1.20.1" = _8yaPM6lE;
        "pkg-0.6.13+1.20.1" = _DYpJU8lA;
        "pkg-0.7.7+1.21.1" = _xmPRtQsn;
        "pkg-0.7.7+26.1.2" = _gPH1bsXc;
        "pkg-0.7.8+1.21.1" = _DeOfrXC3;
