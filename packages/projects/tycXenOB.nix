...
let
    versions = (let
        ...
        _IUF1qfEF = {
            "id" = "IUF1qfEF";
            "file" = "hdr_mod-fabric-2.4.1-26.1.jar";
            "hash" = "sha512-BNWuynpNEiwv+0BouXMmMe2rDGF+HnZJCz2alWYVfUT//8cqmBGfG/tvOOFmCVzlevRMxm+8VOyGEacHVr6MCw==";
        };
        _T36XzFRE = {
            "id" = "T36XzFRE";
            "file" = "hdr_mod-neoforge-2.4.1-26.1.jar";
            "hash" = "sha512-EASh3yW4gRZWZlFaagpillKw9v01tRWnwB/f5WlPSDQ/dZ32cR1NDDNvBNS3yyn/IeKMzK6CAyM3YorGckQb0g==";
        };
        _oKwpQgWT = {
            "id" = "oKwpQgWT";
            "file" = "hdr_mod-fabric-2.3.4-1.21.11.jar";
            "hash" = "sha512-6OBp+ytcZIr+ZOFkrbvfhcsz+wCY1bkF9J8+CfVfB5NM5RH118v9a/AETOPRszu9RWBh1gaC24OTufv1Kzu9kw==";
        };
        _hBIWUbvA = {
            "id" = "hBIWUbvA";
            "file" = "hdr_mod-neoforge-2.3.4-1.21.11.jar";
            "hash" = "sha512-0PaGBGuDgdPwiKI1jtgnqvQi/FC5hNW+C81TgEUl0d/UMHtkdTvmKXQPbuMfBaSYOp3p0smTTuRMbr9vK/5Ltg==";
        };
        _qr3Wf2nB = {
            "id" = "qr3Wf2nB";
            "file" = "hdr_mod-fabric-3.1.1-26.2.jar";
            "hash" = "sha512-L+4Cmq5xpjxgmgUPNCJcxPsb1uMcTboL3ZP1B7zzKkjQrmIqUypxKLDqtLi3SMD9rkEfN0RKjtlDEtlLQQLjuA==";
        };
        _G2ElS9G7 = {
            "id" = "G2ElS9G7";
            "file" = "hdr_mod-neoforge-3.1.1-26.2.jar";
            "hash" = "sha512-Sx0JaZewcpqTZJNdFNiMfArN8JLU0zvn7ykGylsleYYZLMIS073ah7xMou5WxXJUq1M+dRMeKxC43r7v6rgLQg==";
        };
        _mXTecCap = {
            "id" = "mXTecCap";
            "file" = "hdr_mod-neoforge-2.3.4-1.21.1.jar";
            "hash" = "sha512-xY60IpNO5oE3eS2m7BCGBMqP34ABcCSwuDq9q3vCPhkljHtyOMeSENCLI7iqtAFt36btdIj9crRUsEZkOLqldg==";
        };
        _ssUtQShj = {
            "id" = "ssUtQShj";
            "file" = "hdr_mod-fabric-2.3.4-1.21.1.jar";
            "hash" = "sha512-cy3C7PPKhGMupjoqEOVIQlljg9fJ5XX/FxmDrlGI9knaOy39zt3i2D9BBGcLTp/wzs3e1OQyvyDz0n8t5MQQtg==";
        };
        _NYpScQDb = {
            "id" = "NYpScQDb";
            "file" = "hdr_mod-fabric-2.3.4-1.21.10.jar";
            "hash" = "sha512-IGSYR9jN9ew3e2ZUracyNtkFfRthXfcG3UOmLLNqQ2nH8NVHP+EXHksyJnefby5JQXKg0OpBBmk3wYkxDrFk2g==";
        };
        _7M6oBezl = {
            "id" = "7M6oBezl";
            "file" = "hdr_mod-neoforge-2.3.4-1.21.10.jar";
            "hash" = "sha512-nDU2PXIH/4RxAGiTh0vVq33MPlL30LSQKV4r0d/ywICOZ8EmtfrQIFReCJ/K6mbxfweNiKCnTABsZkMR17oAlQ==";
        };
        _NgFhcftj = {
            "id" = "NgFhcftj";
            "file" = "hdr_mod-fabric-2.5.0-26.1.jar";
            "hash" = "sha512-fzERva+CYCHioN7aHbWL64dI3NLn/lT51MKGdxLVAbuMKHe8xx6exfd3MNdJzVmFpxepHC5b/v0heQvKWtUwSw==";
        };
        _5x02vrqg = {
            "id" = "5x02vrqg";
            "file" = "hdr_mod-neoforge-2.5.0-26.1.jar";
            "hash" = "sha512-/hxtL3BCqzXSgaElBYPC7eX87bGrReB2L/sfi/K66TGLe390GK0klUrMZ75l4wI5LlS/hoBHPKXsw4TIgEPVNQ==";
        };
        _E7fibGjf = {
            "id" = "E7fibGjf";
            "file" = "hdr_mod-fabric-2.5.0-1.21.11.jar";
            "hash" = "sha512-SYPWCvZQO/ODAjDtdxZCMHXyCgPwJyoBdVzmSs5hnfp6LyJEhdQkj6s++gUujGiny+B9jqZE0iexGhsJN22fVg==";
        };
        _7hRnfmgz = {
            "id" = "7hRnfmgz";
            "file" = "hdr_mod-neoforge-2.5.0-1.21.11.jar";
            "hash" = "sha512-gIWUGS0QFJsh0p0b+zhbBGyzmpdxVC/Be3rtPobhcwSBE4Wx+8YuJj5RD71+EPboCFJkITO5TIKDzu8Y7exGEQ==";
        };
        _fS5RFmdr = {
            "id" = "fS5RFmdr";
            "file" = "hdr_mod-fabric-3.2.0-26.2.jar";
            "hash" = "sha512-mJieP0uta5SwtO3yp9ABn6jdB8yqs5eFcOB5c4wdbhNaqfZFvv1wHjIkKKlwC8XKvjwfF1TwtuN0AbHrVqEKjw==";
        };
        _9FgVCuyC = {
            "id" = "9FgVCuyC";
            "file" = "hdr_mod-neoforge-3.2.0-26.2.jar";
            "hash" = "sha512-K5+c/Dk5DMSn+gkWr9Id+iUT7b3RzEUNk4p32Kqw4HHcG5lo/RQ6htYjrRgG6U9gwbUib7dFcE/KTIaP4P+9TA==";
        };
        _z2JmZcL7 = {
            "id" = "z2JmZcL7";
            "file" = "hdr_mod-fabric-3.2.1-26.2.jar";
            "hash" = "sha512-frC3Q7K35DN667Y2NLkQlI81OwhEzqd5tIlTgfzDLkUfAmHzBr7yonVi5qwJQsBrp0JFCZ423LJsqJ9+jhkAuQ==";
        };
        _vyEFELHK = {
            "id" = "vyEFELHK";
            "file" = "hdr_mod-neoforge-3.2.1-26.2.jar";
            "hash" = "sha512-MjdNrt8PMy/iApkNs0eCUalRyYghRbcuQmXuxNaNucMNukyux9MsnNFAakIXunTla/BVRb4gFA+SGhgF4RzQYg==";
        };
        _Luwggozh = {
            "id" = "Luwggozh";
            "file" = "hdr_mod-fabric-2.5.0-1.21.10.jar";
            "hash" = "sha512-qOdSL5vgQLnMkdz8Ch0fzURicKq6TlljJZf2I58ny7bAs+sCZG9xEv1W5Zz0C3xLgw3KYFfcJhHUXghvmuFhsA==";
        };
        _ooQ9trj8 = {
            "id" = "ooQ9trj8";
            "file" = "hdr_mod-neoforge-2.5.0-1.21.10.jar";
            "hash" = "sha512-EL9YL2S7M4jgQfQ6ejWo1Knr0U/UlxJR50giPh3/vy70jSNKZt7uCo0AprV9onWr+uzvpp3O06u9wJC31UmmIA==";
        };
        _UtYf1DRS = {
            "id" = "UtYf1DRS";
            "file" = "hdr_mod-fabric-2.5.0-1.21.1.jar";
            "hash" = "sha512-yP3EQrtKY9uVwxuxbWiT9PExQ76+Q17uxOxPTUvh+Xsu85H6HpckVxzE18hFYRyGLT3ZIMNahShyfAU326fqaA==";
        };
        _cgMB0rDC = {
            "id" = "cgMB0rDC";
            "file" = "hdr_mod-neoforge-2.5.0-1.21.1.jar";
            "hash" = "sha512-Y7F6uANEsEcNhUgDAm4JMkbfRB5D1xGv9e+7kasQXgBxLAHqSiSCbOvoB4ZlcwR17nj5ihGaHXNTBr96qARyEA==";
        };
        _1tmfLLaU = {
            "id" = "1tmfLLaU";
            "file" = "hdr_mod-forge-2.5.0-1.20.1.jar";
            "hash" = "sha512-yP42ltIF5uqcAM7YuylrmNn4hKi47X0wfeWYB+g0+DfYDDyh3Jw4mKOPoX+10IJBRjHrL9WurGxgadVa6o0QKw==";
        };
        _Kt5e9Dbd = {
            "id" = "Kt5e9Dbd";
            "file" = "hdr_mod-fabric-2.5.0-1.20.1.jar";
            "hash" = "sha512-zviZS3gOO6QQr2STWEjg69sCgrfMMFB1Wmbc9ZD5G3XKkDwaSbHjQxnDloO+VU8W/JOpTNyYrpRrW4oFW9PEKw==";
        };
        _ZUbQl4Zi = {
            "id" = "ZUbQl4Zi";
            "file" = "hdr_mod-fabric-2.5.1-26.1.jar";
            "hash" = "sha512-EwTkwD1PtUZc/+yrb3QBqy+nua0dKJo9Dwldx6dVy6NRSVc/oxHmMj9musFzOTG/HqNMgItzO6zg4kPrsNpsBA==";
        };
        _9Gv5G0eF = {
            "id" = "9Gv5G0eF";
            "file" = "hdr_mod-neoforge-2.5.1-26.1.jar";
            "hash" = "sha512-9f8f6+NjDQEGdDgwMa+hFOyqcVREmD6vfB4C9d5ZpM9xm9XcSlKlyXrdOy/lznIPxpxMV+ecuNH2mSzyNbO33w==";
        };
        _PTCAH3aX = {
            "id" = "PTCAH3aX";
            "file" = "hdr_mod-fabric-3.2.2-26.2.jar";
            "hash" = "sha512-GQaOkcxUnzfgXIHMu/sVFv/P+udYdFAEVAS7Itjrm6wy77XPtFOP9m4uB4eN7Gt3iVltEvN6YB1+v5ARb40pfw==";
        };
        _UvBOjrbz = {
            "id" = "UvBOjrbz";
            "file" = "hdr_mod-neoforge-3.2.2-26.2.jar";
            "hash" = "sha512-n9TpqW3U7pDe58/+n2FAQyExkKoyYa6U2tbSgZZAW9t1zCcFUA39X9stXdtDoYRCMpPNLx844Y4lU/Gwu1xc1A==";
        };
        _8l7QPGW7 = {
            "id" = "8l7QPGW7";
            "file" = "hdr_mod-fabric-2.5.1-1.21.11.jar";
            "hash" = "sha512-+YGBH3nJups19DfqhYFfIHM2mpjhjynOZL8ht6V//OM2ByZS58SLp0SqUhR4FtkBKCTbkvMT1eAmE+/cuzAkTQ==";
        };
        _FfmiFmDR = {
            "id" = "FfmiFmDR";
            "file" = "hdr_mod-neoforge-2.5.1-1.21.11.jar";
            "hash" = "sha512-h7sKDKs/MNp9J1+Bj4bLRKUiUjrfcyctFwSv4cJFtQgn/8OQpBkvKg1ATg/IZeVuAPGvroqc40V+ta5mOGHCFQ==";
        };
        _O5whdLii = {
            "id" = "O5whdLii";
            "file" = "hdr_mod-forge-2.5.1-1.20.1.jar";
            "hash" = "sha512-Zgmo2zWFAsl8dZ0XmodVGtlqyhL9xIHg593IpHKgCjTSmRSB0rCoP2O18sDFH2dDydHyI5dbYZfprJQSkuLFTw==";
        };
        _mpElIgaw = {
            "id" = "mpElIgaw";
            "file" = "hdr_mod-fabric-2.5.1-1.20.1.jar";
            "hash" = "sha512-kKRT24PBkgNgpYQym0jbVoycENOgXl8ogaCN9DbReL7BxDkzrVD0IQmMcdd2tjloEcBXjx/Td9k12UcKxWdr2Q==";
        };
        _8aE8BlIw = {
            "id" = "8aE8BlIw";
            "file" = "hdr_mod-fabric-2.5.1-1.21.10.jar";
            "hash" = "sha512-Y0IOzH0vg4vMgfW1tS0uSpaYy7IjQ3x7GtPLZX3Iitjstz1uWbqYDQSlHXMuPTZ1/yxEUD/NstZgLXzUJJkpsg==";
        };
        _zsZLiMQK = {
            "id" = "zsZLiMQK";
            "file" = "hdr_mod-neoforge-2.5.1-1.21.10.jar";
            "hash" = "sha512-xmpF6q3ihSeLewWSfj6Vpi4fpQ50+3fQKeDGapOY3Gi8SNQna2DK+EsIq6jC4kdLyysei5yapvkLcBKqKJgleg==";
        };
        _Tceogzn9 = {
            "id" = "Tceogzn9";
            "file" = "hdr_mod-fabric-2.5.1-1.21.1.jar";
            "hash" = "sha512-uNZilpUA7x+NfBdT0yHyjy6Szoi9zPNKUgUmfh4wTM4MRh6bTAoh4nwvoSvg9gNfyEnO1kWvfHrBpdHK8etCpg==";
        };
        _OAHoBTFu = {
            "id" = "OAHoBTFu";
    ...
    in {
        ...
        "fabric-1.21.1" = _Tceogzn9;
        "fabric-1.20" = _5eWytYuq;
        "fabric-1.20.1" = _mpElIgaw;
        ...
        "pkg-1.0.1-fabric-1.21.11" = _NLeHSlRF;
        "pkg-1.0.1-fabric-1.21.10" = _Uliq6Sx9;
        "pkg-1.0.1-neoforge-1.21.10" = _orQ70IRS;
        "pkg-1.0.0-fabric-1.21.1" = _OwiUrl51;
        "pkg-1.0.1-fabric-1.21.1" = _OFsvHBzY;
        "pkg-1.0.1-neoforge-1.21.1" = _k97Qf1xo;
        "pkg-1.0.0-fabric-1.20.1" = _hRrVFAZ2;
        "pkg-1.0.0-forge-1.20.1" = _Wk6M690I;
        "pkg-1.0.1-forge-1.20.1" = _dKy3isO8;
        "pkg-1.0.1-fabric-1.20.1" = _Rw8flqYS;
        "pkg-1.1.0-fabric-1.21.11" = _xxfScNh7;
        "pkg-1.1.0-neoforge-1.21.11" = _xxcPyA85;
        "pkg-1.1.0-fabric-1.21.10" = _3yiFBlE6;
        "pkg-1.1.0-neoforge-1.21.10" = _koFVQPC0;
        "pkg-1.1.0-fabric-1.21.1" = _gj0NjVer;
        "pkg-1.1.0-neoforge-1.21.1" = _r9x9PxPo;
        "pkg-1.1.0-fabric-1.20.1" = _cziq67ks;
        "pkg-1.1.0-forge-1.20.1" = _pDAP2M21;
        "pkg-1.1.1-fabric-1.20.1" = _W10kzK60;
        "pkg-1.1.1-fabric-1.21.1" = _W3CYN73g;
        "pkg-1.1.1-forge-1.20.1" = _6CBYOWvf;
        "pkg-1.1.1-neoforge-1.21.1" = _oV55TNB6;
        "pkg-2.0.0-fabric-1.21.11" = _daTwdhQJ;
        "pkg-2.0.0-fabric-1.21.10" = _nguUtUKp;
        "pkg-2.0.0-neoforge-1.21.10" = _Frxy4VFK;
        "pkg-2.0.0-neoforge-1.21.11" = _QiD2C7v6;
        "pkg-1.1.2-fabric-1.20.1" = _v7MRDeX1;
        "pkg-1.1.2-fabric-1.21.1" = _QvLrYYSQ;
        "pkg-2.0.1-fabric-1.21.10" = _pftPAZ96;
        "pkg-2.0.1-fabric-1.21.11" = _WHUiiMG4;
        "pkg-1.1.2-forge-1.20.1" = _zvaHYcNS;
        "pkg-1.1.2-neoforge-1.21.1" = _5E3BcORv;
        "pkg-2.0.1-neoforge-1.21.10" = _qNbLTMON;
        "pkg-2.0.1-neoforge-1.21.11" = _wnxzyVyI;
        "pkg-2.0.0-fabric-1.21.1" = _PtrpI6t3;
        "pkg-2.0.0-neoforge-1.21.1" = _pEntpI3x;
        "pkg-2.0.0-fabric-1.20.1" = _uATt1V6l;
        "pkg-2.0.0-forge-1.20.1" = _lEZ4o4bD;
        "pkg-2.0.1-forge-1.20.1" = _y20WLSpp;
        "pkg-2.1.0-fabric-1.20.1" = _gw9PFnmm;
        "pkg-2.1.0-fabric-1.21.1" = _tB4fvS4f;
        "pkg-2.1.0-fabric-1.21.10" = _pZcYUGld;
        "pkg-2.1.0-fabric-1.21.11" = _vIjs3250;
        "pkg-2.1.0-forge-1.20.1" = _aNF6SZvC;
        "pkg-2.1.0-neoforge-1.21.1" = _qrQjCoDp;
        "pkg-2.1.0-neoforge-1.21.10" = _j2M0wEVg;
        "pkg-2.1.0-neoforge-1.21.11" = _Oib8IvZp;
        "pkg-2.1.1-fabric-1.20.1" = _oTlwXoZq;
        "pkg-2.1.1-fabric-1.21.1" = _USooJaz1;
        "pkg-2.1.1-fabric-1.21.10" = _hobFLZCF;
        "pkg-2.1.1-fabric-1.21.11" = _aYw3Tu3h;
        "pkg-2.1.1-forge-1.20.1" = _rVRTC9Vh;
        "pkg-2.1.1-neoforge-1.21.1" = _EdW21eMO;
        "pkg-2.1.1-neoforge-1.21.10" = _MAzGSZKQ;
        "pkg-2.1.1-neoforge-1.21.11" = _wdTgCivc;
        "pkg-2.1.2-fabric-1.20.1" = _ioHKUUce;
        "pkg-2.1.2-fabric-1.21.1" = _MlUofYnl;
        "pkg-2.1.2-fabric-1.21.10" = _gZppck6C;
        "pkg-2.1.2-fabric-1.21.11" = _klon45Ww;
        "pkg-2.1.2-forge-1.20.1" = _cI20tcVp;
        "pkg-2.1.2-neoforge-1.21.1" = _e29gJpCJ;
        "pkg-2.1.2-neoforge-1.21.10" = _XGBKeih4;
        "pkg-2.1.2-neoforge-1.21.11" = _nvtmbfUW;
        "pkg-2.1.2-fabric-26.1" = _nAJMfCQR;
        "pkg-2.1.2-neoforge-26.1" = _ZgsOV03H;
        "pkg-2.2.0-fabric-1.20.1" = _5eWytYuq;
        "pkg-2.2.0-fabric-1.21.1" = _1ngokmra;
        "pkg-2.2.0-fabric-1.21.10" = _dEdkMD6e;
        "pkg-2.2.0-fabric-1.21.11" = _FYnMdDqU;
        "pkg-2.2.0-fabric-26.1" = _y97ufKsx;
        "pkg-2.2.0-forge-1.20.1" = _6ZvPbAKv;
        "pkg-2.2.0-neoforge-1.21.1" = _5npb9Wg2;
        "pkg-2.2.0-neoforge-1.21.10" = _NZCahwrO;
        "pkg-2.2.0-neoforge-1.21.11" = _RZb16q8E;
        "pkg-2.2.0-neoforge-26.1" = _YehWaYJR;
        "pkg-2.2.0a-neoforge-26.1" = _mDEcyLZd;
        "pkg-2.2.0a-fabric-26.1" = _wOd1Cicv;
        "pkg-2.2.1-26.1+fabric" = _iRu001hm;
        "pkg-2.2.1-26.1+neoforge" = _9aaqyDdt;
        "pkg-2.2.1-1.21.11+neoforge" = _HBc8ybRp;
        "pkg-2.2.1-1.21.11+fabric" = _kqBcbF9p;
        "pkg-2.2.1-1.21.10+neoforge" = _IYoa7mpM;
        "pkg-2.2.1-1.21.10+fabric" = _GJES5dBs;
        "pkg-2.2.1-1.20.1+forge" = _nkQmIn98;
        "pkg-2.2.1-1.20.1+fabric" = _cPSew88a;
        "pkg-2.2.1-1.21.1+fabric" = _1pc0BbYA;
        "pkg-2.2.1-1.21.1+neoforge" = _RHjRhNsv;
        "pkg-2.2.2-1.21.10+fabric" = _LCid2cg8;
        "pkg-2.2.2-1.21.10+neoforge" = _AM5PmZEm;
        "pkg-2.2.2-1.20.1+forge" = _aJ04SM02;
        "pkg-2.2.2-1.20.1+fabric" = _EzRw6AqP;
        "pkg-2.2.2-1.21.11+fabric" = _RdKc8if0;
        "pkg-2.2.2-1.21.11+neoforge" = _1nyq3xPY;
        "pkg-2.2.2-1.21.1+fabric" = _VuXaBkKs;
        "pkg-2.2.2-1.21.1+neoforge" = _Yt99HhmJ;
        "pkg-2.2.2-26.1+fabric" = _BF3glzdf;
        "pkg-2.2.2-26.1+neoforge" = _DuHWk2nf;
        "pkg-2.3.0-26.1+fabric" = _LLQBUzCA;
        "pkg-2.3.0-26.1+neoforge" = _zq7Fk4eY;
        "pkg-2.3.0-1.21.11+fabric" = _MergTqsR;
        "pkg-2.3.0-1.21.11+neoforge" = _DjvzUPQj;
        "pkg-2.3.0-1.21.1+fabric" = _pKu2jS42;
        "pkg-2.3.0-1.21.1+neoforge" = _Pudva4Na;
        "pkg-2.3.0-1.20.1+forge" = _5CbbBqiz;
        "pkg-2.3.0-1.20.1+fabric" = _P0ha6tNU;
        "pkg-2.3.0-1.21.10+fabric" = _4UybvGfY;
        "pkg-2.3.0-1.21.10+neoforge" = _38VxLiZd;
        "pkg-2.3.1-26.1+fabric" = _nhKT13HQ;
        "pkg-2.3.1-26.1+neoforge" = _ONhZetPW;
        "pkg-2.3.1-1.21.10+neoforge" = _GaW9LgO7;
        "pkg-2.3.1-1.21.10+fabric" = _7m51N7KV;
        "pkg-2.3.1-1.21.11+neoforge" = _qRuCVTzg;
        "pkg-2.3.1-1.21.11+fabric" = _1AIUidV0;
        "pkg-2.3.1-1.21.1+fabric" = _W5vMhTJd;
        "pkg-2.3.1-1.21.1+neoforge" = _BOwGTEjT;
        "pkg-2.3.1-1.20.1+forge" = _wmv6I800;
        "pkg-2.3.1-1.20.1+fabric" = _zi9hZSK6;
        "pkg-2.3.2-1.21.11+neoforge" = _xzHL69nG;
        "pkg-2.3.2-1.21.11+fabric" = _gv1WMhjH;
        "pkg-2.3.2-26.1+fabric" = _Pudom1S2;
        "pkg-2.3.2-26.1+neoforge" = _i2q15JfH;
        "pkg-2.3.2-1.21.10+fabric" = _RBNnYeQa;
        "pkg-2.3.2-1.21.10+neoforge" = _vP2QrvmB;
        "pkg-2.3.2-1.20.1+forge" = _L4mr0NFq;
        "pkg-2.3.2-1.20.1+fabric" = _36LkeaJu;
        "pkg-2.3.2-1.21.1+neoforge" = _x601nSHe;
        "pkg-2.3.2-1.21.1+fabric" = _c2XkgPFo;
        "pkg-3.0.0-alpha1-26.2+neoforge" = _y72CvEWR;
        "pkg-3.0.0-alpha1-26.2+fabric" = _lUbZe5DU;
        "pkg-3.0.0-alpha2-26.2+fabric" = _CFZkPunj;
        "pkg-3.0.0-alpha2-26.2+neoforge" = _uYsFrXYM;
        "pkg-3.0.0-beta1-26.2+fabric" = _5Fhf5GQ1;
        "pkg-3.0.0-beta1-26.2+neoforge" = _MUFE876t;
        "pkg-3.0.0-26.2+fabric" = _TyoBPomn;
        "pkg-3.0.0-26.2+neoforge" = _rNzdHMbY;
        "pkg-3.1.0-26.2" = _AfwNT309;
        "pkg-2.4.0-26.1+fabric" = _I9FK2Qqu;
        "pkg-2.4.0-26.1+neoforge" = _rMg91nw2;
        "pkg-2.3.3-1.21.11+fabric" = _xasEHsEz;
        "pkg-2.3.3-1.21.11+neoforge" = _mK7huERY;
        "pkg-2.3.3-1.21.10+fabric" = _JaQ5khlL;
        "pkg-2.3.3-1.21.10+neoforge" = _f2UxZ42r;
        "pkg-2.3.3-1.21.1+fabric" = _bmvxivag;
        "pkg-2.3.3-1.21.1+neoforge" = _Q8gxhtKA;
        "pkg-2.4.1-26.1+fabric" = _IUF1qfEF;
        "pkg-2.4.1-26.1+neoforge" = _T36XzFRE;
        "pkg-2.3.4-1.21.11+fabric" = _oKwpQgWT;
        "pkg-2.3.4-1.21.11+neoforge" = _hBIWUbvA;
        "pkg-3.1.1-26.2+fabric" = _qr3Wf2nB;
        "pkg-3.1.1-26.2+neoforge" = _G2ElS9G7;
        "pkg-2.3.4-1.21.1+neoforge" = _mXTecCap;
        "pkg-2.3.4-1.21.1+fabric" = _ssUtQShj;
        "pkg-2.3.4-1.21.10+fabric" = _NYpScQDb;
        "pkg-2.3.4-1.21.10+neoforge" = _7M6oBezl;
        "pkg-2.5.0-26.1+fabric" = _NgFhcftj;
        "pkg-2.5.0-26.1+neoforge" = _5x02vrqg;
        "pkg-2.5.0-1.21.11+fabric" = _E7fibGjf;
        "pkg-2.5.0-1.21.11+neoforge" = _7hRnfmgz;
        "pkg-3.2.0-26.2+fabric" = _fS5RFmdr;
        "pkg-3.2.0-26.2+neoforge" = _9FgVCuyC;
        "pkg-3.2.1-26.2+fabric" = _z2JmZcL7;
        "pkg-3.2.1-26.2+neoforge" = _vyEFELHK;
        "pkg-2.5.0-1.21.10+fabric" = _Luwggozh;
        "pkg-2.5.0-1.21.10+neoforge" = _ooQ9trj8;
        "pkg-2.5.0-1.21.1+fabric" = _UtYf1DRS;
        "pkg-2.5.0-1.21.1+neoforge" = _cgMB0rDC;
        "pkg-2.5.0-1.20.1+forge" = _1tmfLLaU;
        "pkg-2.5.0-1.20.1+fabric" = _Kt5e9Dbd;
        "pkg-2.5.1-26.1+fabric" = _ZUbQl4Zi;
        "pkg-2.5.1-26.1+neoforge" = _9Gv5G0eF;
        "pkg-3.2.2-26.2+fabric" = _PTCAH3aX;
        "pkg-3.2.2-26.2+neoforge" = _UvBOjrbz;
        "pkg-2.5.1-1.21.11+fabric" = _8l7QPGW7;
        "pkg-2.5.1-1.21.11+neoforge" = _FfmiFmDR;
        "pkg-2.5.1-1.20.1+forge" = _O5whdLii;
        "pkg-2.5.1-1.20.1+fabric" = _mpElIgaw;
        "pkg-2.5.1-1.21.10+fabric" = _8aE8BlIw;
