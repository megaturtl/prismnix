...
let
    versions = (let
        ...
        _YpbG0BiR = {
            "id" = "YpbG0BiR";
            "file" = "UD Refined - Lite - 1.20.2-26.x.zip";
            "hash" = "sha512-OYloDhnTMgS4cC7M45MCF4okMawdPB0ivRZR05kCMD4SXnbWdOwCdGZ/0AW0Gajzh49aOc3KUha+aZz4rRVMgw==";
        };
    in {
        "u5WINsQx" = _u5WINsQx;
        "PRuvXmtc" = _PRuvXmtc;
        ...
        "minecraft-1.20.2" = _YpbG0BiR;
        "minecraft-1.20.3" = _YpbG0BiR;
        "minecraft-1.20.4" = _YpbG0BiR;
        "minecraft-1.20.5" = _YpbG0BiR;
        "minecraft-1.20.6" = _YpbG0BiR;
        "minecraft-1.21" = _YpbG0BiR;
        "minecraft-1.21.1" = _YpbG0BiR;
        "minecraft-1.21.2" = _YpbG0BiR;
        "minecraft-1.21.3" = _YpbG0BiR;
        "minecraft-1.21.4" = _YpbG0BiR;
        "minecraft-1.21.5" = _YpbG0BiR;
        "minecraft-1.21.6" = _YpbG0BiR;
        "minecraft-1.21.7" = _YpbG0BiR;
        "minecraft-1.21.8" = _YpbG0BiR;
        "minecraft-1.21.9" = _YpbG0BiR;
        "minecraft-1.21.10" = _YpbG0BiR;
        "minecraft-1.21.11" = _YpbG0BiR;
        "minecraft-26.1" = _YpbG0BiR;
        "minecraft-26.1.1" = _YpbG0BiR;
        "minecraft-26.1.2" = _YpbG0BiR;
        "minecraft-26.2" = _YpbG0BiR;
        "minecraft-26.3" = _YpbG0BiR;
        "pkg-0.1" = _VzrukWym;
        "pkg-0.2" = _rhcGHtTR;
        "pkg-0.3" = _X5hlxh6J;
        "pkg-0.5" = _hqLdXfSh;
