...
let
    ...
    in {
        ...
        "pkg-CobbleTCG-0.9.8" = _6KDH816q;
        "pkg-CobbleTCG-1.0.0" = _qrEuNfua;
        "pkg-CobbleTCG-1.0.1" = _1GAMAnTw;
        "pkg-CobbleTCG-1.0.2-LOWRESOLUTION" = _8xsCtvWl;
        "pkg-CobbleTCG-1.0.21-HIGHRESOLUTION" = _jwRPvRNq;
        "pkg-CobbleTCG-1.0.5" = _Mr7r4eSC;
        "pkg-CobbleTCG-1.1.0" = _P2cUTwP4;
        "pkg-CobbleTCG-1.1.1" = _FUFmsjup;
        "pkg-CobbleTCG-1.2.0" = _6tIEFMqB;
        "pkg-CobbleTCG-1.3.0" = _7YZwnMFE;
        "pkg-CobbleTCG-1.3.1" = _YMs5wzUD;
        "pkg-CobbleTCG-1.3.2" = _Y6MZITNz;
        "pkg-CobbleTCG-1.3.9" = _afM9XFPC;
        "pkg-CobbleTCG-1.3.95" = _Qvv4t0ll;
        "pkg-CobbleTCG-1.3.97" = _9ET9WpiV;
        "pkg-CobbleTCG-1.4.0" = _BCi03bva;
        "pkg-CobbleTCG-1.4.1" = _o7VKSuuT;
