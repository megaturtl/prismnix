...
let
    versions = (let
        ...
        _QrKE5IdH = {
            "id" = "QrKE5IdH";
            "file" = "super_resolution-fabric-1.21..1.21.1-0.9.0-alpha.1+opengl.jar";
            "hash" = "sha512-2vSlV8evcygfl2nj1Ze9/e1dHTskb9Fc6mAhgctdrKxo3xBsW7TlHW0G9aywUhCswuI8KtFVUica3dqDVFHqyQ==";
        };
        _x2qyyTbB = {
            "id" = "x2qyyTbB";
            "file" = "super_resolution-fabric-26.1-0.9.0-alpha.1+opengl.jar";
            "hash" = "sha512-zZpGudxckwbGfIWOfhPCDRBWvizRZg2yme4+xX95tnR35/fHa3uIOQ9joUKpQQgFpBfxGoTvzyx7k/8JD5fHaw==";
        };
        _aQoqjRGI = {
            "id" = "aQoqjRGI";
            "file" = "super_resolution-fabric-26.2-0.9.0-alpha.1+opengl.jar";
            "hash" = "sha512-a5SFJZfMWdck+9yeRrCYESjotdQjG7Gx3jKW/IhSLqE/8AOcEBQFku3IGa5VKqgCTBEJbWfH2k/qqJMaFrUpTw==";
        };
        _RiWwIZgR = {
            "id" = "RiWwIZgR";
            "file" = "super_resolution-forge-1.20.1-0.9.0-alpha.1+opengl.jar";
            "hash" = "sha512-Q2jN2A7wCH1/hzVoDs8w5a47I6c/POK4e5AqKf0/93smg94Hn8b/UPIK0aJePRG+ZgBbrjeilvtqeNgD+ra/Jw==";
        };
        _axnYNnz2 = {
            "id" = "axnYNnz2";
            "file" = "super_resolution-neoforge-1.21..1.21.1-0.9.0-alpha.1+opengl.jar";
            "hash" = "sha512-WgkkRXbKRcP8WL33yBxBkNh6+QJe84+wxqxx98rDxgq205rhsBBhpYPlc0o67Tu9n+fRXpAmXIac417QoNIPZw==";
        };
        _muCFe0oI = {
            "id" = "muCFe0oI";
            "file" = "super_resolution-neoforge-26.1-0.9.0-alpha.1+opengl.jar";
            "hash" = "sha512-ur6+mOwpFoTO+18z2G1bqbEDCDQVTP9re57cWhsZxbVQvn/YbRyfhFQssqwqumhkPotqMLz4X+iX3zjJvXC3VQ==";
        };
        _FLA0QN3j = {
            "id" = "FLA0QN3j";
            "file" = "super_resolution-neoforge-26.2-0.9.0-alpha.1+opengl.jar";
            "hash" = "sha512-9Qy2qXQfMvoMDwMstBkKKNyKBIpJMQq3avvvhBi64VFAaCeB4QnAvO7N0wpMH56+4JKJyJMltbTEM/KWiJhv+w==";
        };
        _5beijdDo = {
            "id" = "5beijdDo";
            "file" = "super_resolution-fabric-1.21.11-0.9.0-alpha.1+opengl.jar";
            "hash" = "sha512-A3/ulirwezjQMy78Qw/Cife4LZw35k9E6cT/gfC1tTQDm6Mu8wGhB9oNHd5qCOd9NHtQEVIQbhZf0NOk79Kh2Q==";
        };
        _M6ZGHPZe = {
            "id" = "M6ZGHPZe";
            "file" = "super_resolution-neoforge-1.21.11-0.9.0-alpha.1+opengl.jar";
            "hash" = "sha512-IYHdGYlgWPLCpV2l8XsAJwBfx26+8J1Yegdk/QCjsqR2hA7c3Fp6iP4Iaa4/uXW6TUto/YN1+grO6KlDsbDv3Q==";
        };
        _xYoD584x = {
            "id" = "xYoD584x";
            "file" = "super_resolution-neoforge-26.2-0.9.0-alpha.2+opengl.jar";
            "hash" = "sha512-j36aE/nw6dVyqZqZ8OonYYO1+L+zUksoxtC6i/haidG6Nla6jMtm1kxjPoqkNlREaawUzA2xS4YP7O7sKf+g+A==";
        };
        _r1XRmV7H = {
            "id" = "r1XRmV7H";
            "file" = "super_resolution-fabric-1.21.11-0.9.0-alpha.2+opengl.jar";
            "hash" = "sha512-fYjIifiO6yS+QxZJuiUOI5mJdithl77FtLuB65s06C2rnad6RNl48z/luyuJmRkYczN7+kQe9BmV8v4T8YmQYA==";
        };
        _fNGtglul = {
            "id" = "fNGtglul";
            "file" = "super_resolution-neoforge-26.1-0.9.0-alpha.2+opengl.jar";
            "hash" = "sha512-j4U9Dwp61O/S4YuTCH4MBJR0BOad7GdM+NPR3B4WMKOTpHO21SZIZrYsYdvwXN/ulMzeqFZxYQPoZQ0Dyaj4vg==";
        };
        _Qy2Xmfat = {
            "id" = "Qy2Xmfat";
            "file" = "super_resolution-neoforge-1.21..1.21.1-0.9.0-alpha.2+opengl.jar";
            "hash" = "sha512-ZHkGoJBWapSPc63WOgHpIWFzrbkhgHWhjQq6tMdUIzHgqfD4+niCwBGPpzS/rSo+YDQiiY5qwx1lZqvJHV7Liw==";
        };
        _QqrL58ET = {
            "id" = "QqrL58ET";
            "file" = "super_resolution-neoforge-1.21.11-0.9.0-alpha.2+opengl.jar";
            "hash" = "sha512-dIm0wzYEJJKuBOkFYsK4ubF+d4alksIPl1jTwkYdYJ3P+uXn32SP6HjNoGIG0EbsNU2TdS4GffYWlthPTJ0gIA==";
        };
        _l6vpxXKE = {
            "id" = "l6vpxXKE";
            "file" = "super_resolution-fabric-26.2-0.9.0-alpha.2+opengl.jar";
            "hash" = "sha512-Pv1jqK7QAywnQ3o3XyP6yZ5C3ISiSXEP7rjecrBsJek4djPCHtMEpTzETUCP6yIevf5yqTr9d7QHC0oUIc1Znw==";
        };
        _vZnzy6dX = {
            "id" = "vZnzy6dX";
            "file" = "super_resolution-fabric-1.21..1.21.1-0.9.0-alpha.2+opengl.jar";
            "hash" = "sha512-kEma2ksRgTisOn2HB8LppsTALN2oWHyI8xB7/X0P5qTHfeocQDhei38eVy7u+MqfBs9fiCGuR3bMRmH6TO+l+A==";
        };
        _Bc5ACOPh = {
            "id" = "Bc5ACOPh";
            "file" = "super_resolution-fabric-26.1-0.9.0-alpha.2+opengl.jar";
            "hash" = "sha512-c0CMkNMmoKZYqclbu0JsE1aDVAFod8/KPdjh3xuiB/t9DWz8M8/0uBj6wM68gBPB7kI40Do+mrCMKyVBC5hCnA==";
        };
        _lxQycnST = {
            "id" = "lxQycnST";
            "file" = "super_resolution-forge-1.20.1-0.9.0-alpha.2+opengl.jar";
            "hash" = "sha512-Zq4GaHEJy0StMUrwdNmj1wBIvYsrKGHf2b1yuR2HopTwmBiJQNfTKmog9BP9ascbm5+ekQKvAT6VWbrT0l2krg==";
        };
        _Nydspzyq = {
            "id" = "Nydspzyq";
            "file" = "super_resolution-fabric-26.2-0.9.1-alpha.1+opengl.jar";
            "hash" = "sha512-1BQQOtKFc+6okZVFUwfa/xGb8nMFBECbHsLaFc6RH+f77pCHJunlrkP3XD2ngD5g/PeJJKMgSPk1wfUoiBrZeg==";
        };
        _h1WiF1tx = {
            "id" = "h1WiF1tx";
            "file" = "super_resolution-neoforge-1.21..1.21.1-0.9.1-alpha.1+opengl.jar";
            "hash" = "sha512-bs7SiWvHE5kukv6SVHdGPt+DI/6kwNkGtLIINYKduRqx9R2wq436tlWqPv4VSWq9NdkKsbX+eNNzUYdgTobu3Q==";
        };
        _avoLoH5M = {
            "id" = "avoLoH5M";
            "file" = "super_resolution-fabric-1.21.11-0.9.1-alpha.1+opengl.jar";
            "hash" = "sha512-RloDFLOFV2Qtk/L2OiMY9Ak2JuHgk/9DI1BF7WHKdymvAg7BTggH5ploudjrgPVWLUGVK6uwXJxq0uHXZSZ9WQ==";
        };
        _MeE6lOJf = {
            "id" = "MeE6lOJf";
            "file" = "super_resolution-forge-1.20.1-0.9.1-alpha.1+opengl.jar";
            "hash" = "sha512-CwdE86cI8z+Dw3p4WznhLAYqTWkLJ3SvPDvjOdfwazRdENoPNT1GYI92ESzCtau9OgFREn+MwXdA4/3XCZC9EA==";
        };
        _iDQmfrko = {
            "id" = "iDQmfrko";
            "file" = "super_resolution-neoforge-26.2-0.9.1-alpha.1+opengl.jar";
            "hash" = "sha512-5sIgBaMRALRMxZWFt6sddw65Y/wg5D2hrmLFh49DQcDYKomP7MpYxc3087eMhC0Jl0zSmxRYmZgLqFPe7hxsLQ==";
        };
        _JvUVAlsj = {
            "id" = "JvUVAlsj";
            "file" = "super_resolution-neoforge-26.1-0.9.1-alpha.1+opengl.jar";
            "hash" = "sha512-+7ivWtz42mNMPCnGX5Q3x5x/ISv2f6sCBjJoGm6jfeIYmhBZKqHppANKBUzmAabTho8hvSbEbHfbyuAXsMoFZg==";
        };
        _RtGM0pB1 = {
            "id" = "RtGM0pB1";
            "file" = "super_resolution-fabric-26.1-0.9.1-alpha.1+opengl.jar";
            "hash" = "sha512-wOYpY/UC47fWPuC32Ps03i4exKRQ6qSKmC0SUlvXQC1Y/A11jyAI5RphZtr43qP7CuZPbdnbqWBdI845p4XNiQ==";
        };
        _VEFb6aPS = {
            "id" = "VEFb6aPS";
            "file" = "super_resolution-fabric-1.21..1.21.1-0.9.1-alpha.1+opengl.jar";
            "hash" = "sha512-gZNoYRAtj8NqYa9R3d6FStnYq3nEC7o7lj2/d6NhZydnGGydoKniXmI1lDout43JeeWLABmiENieKXypFhTcBQ==";
        };
        _I0tGPg2o = {
            "id" = "I0tGPg2o";
            "file" = "super_resolution-neoforge-1.21.11-0.9.1-alpha.1+opengl.jar";
            "hash" = "sha512-TwR+aijkVNXl+rG+ONJt1v6wXW0m8qHPK5/AZlUbAGCcJMafR9hgRQdvlzGgfp/MgzVVbMsPhjHYcJF3zhCT+Q==";
        };
        _Qtu3Sdzz = {
            "id" = "Qtu3Sdzz";
            "file" = "super_resolution-fabric-1.21..1.21.1-0.9.1-alpha.2+opengl.jar";
            "hash" = "sha512-FiuPGsiCARHpieGTc2/0+GJFBfiZMom9EgCvYN7/cy2Mnm1GtH3RBEtbUKg0sNFPiMLQDuUfM0HQv1EVlO5imQ==";
        };
        _6S7eCYsP = {
            "id" = "6S7eCYsP";
            "file" = "super_resolution-neoforge-26.1-0.9.1-alpha.2+opengl.jar";
            "hash" = "sha512-xOIN+lo6mJ1W1RZ0VJ+yXPtgl1Q0GbiO89a6dSYkHm5DcRK+v8ZQBtGAddxHnPBddXYYzbvgRgGvlC4+Wh8Pyw==";
        };
        _nv6KkfTj = {
            "id" = "nv6KkfTj";
            "file" = "super_resolution-fabric-26.1-0.9.1-alpha.2+opengl.jar";
            "hash" = "sha512-pdjURW5jezVKlDaRbagcNXzQhg0F4/gyxkUkr2yzr0udCxIaoIVilize4P1x+dixldh/YN0F1KrQhAh7hhqtAw==";
        };
        _P95i03Ki = {
            "id" = "P95i03Ki";
            "file" = "super_resolution-fabric-1.21.11-0.9.1-alpha.2+opengl.jar";
            "hash" = "sha512-RSZaf0oApLFhVtUV2vPXKjn211HFC9wwyPo0B95oP2mpe0llB9uop+g9D+qmOMPOOQSaZxh8sEUUxOOdxW3/qg==";
        };
        _DM0JcaHW = {
            "id" = "DM0JcaHW";
            "file" = "super_resolution-neoforge-1.21.11-0.9.1-alpha.2+opengl.jar";
            "hash" = "sha512-F9WGCtKbZvuQK1mTw+sUwM5VRN61EOTIRiycmLKvuYDrf412N1dpRcWbYUdDryQ3rF+IrW/6fMe2Ikb0P4+7sQ==";
        };
        _k6zQJjC8 = {
            "id" = "k6zQJjC8";
            "file" = "super_resolution-neoforge-26.2-0.9.1-alpha.2+opengl.jar";
            "hash" = "sha512-OxXNRgzWRFGrc2D3Mzd04KEtdeaC1xG2gHxeGEKHVxv8Ne2DYke1xoV0xI8JE2epAD4yROl+oBtiSovQT2RfGQ==";
        };
        _Ecn59c0J = {
            "id" = "Ecn59c0J";
            "file" = "super_resolution-forge-1.20.1-0.9.1-alpha.2+opengl.jar";
            "hash" = "sha512-6p4QCB59gNAPORmUk1M9Vo+Fm6AKkyZ3ErMMtiIPKS11ss3j16EY9UreXssCVoITDOU9hEGZZKDeIXL0EGHMwA==";
        };
        _FBsxpy4y = {
            "id" = "FBsxpy4y";
            "file" = "super_resolution-neoforge-1.21..1.21.1-0.9.1-alpha.2+opengl.jar";
            "hash" = "sha512-6eoTjBfZ4a8R40w0kZzJHwYX9pmkpB2D9v8LoCoHAJuGfclz/3LlgVcH0Ui2VV5PCKlwIO4t0/yDo7rdboyA7w==";
        };
        _OwQ8mZAx = {
            "id" = "OwQ8mZAx";
    ...
    in {
        ...
        "pkg-1.21.4-0.7.1-alpha.1-fabric" = _qUqlcSJG;
        "pkg-1.20.1-0.7.1-alpha.1-forge" = _AIb3ht44;
        "pkg-1.21.1-0.7.1-alpha.1-neoforge" = _Gfl8GtAL;
        "pkg-1.21.4-0.7.1-alpha.1-neoforge" = _kNoJgkbs;
        "pkg-1.20.1-0.7.1-alpha.2-fabric" = _WVxt9ma2;
        "pkg-1.20.4-0.7.1-alpha.2-fabric" = _r9vBKUC1;
        "pkg-1.21.1-0.7.1-alpha.2-fabric" = _QqcQGpZR;
        "pkg-1.21.4-0.7.1-alpha.2-fabric" = _uxrYGWny;
        "pkg-1.20.1-0.7.1-alpha.2-forge" = _K8hGTxSm;
        "pkg-1.21.1-0.7.1-alpha.2-neoforge" = _1UDQcFID;
        "pkg-1.21.4-0.7.1-alpha.2-neoforge" = _jSReK7NF;
        "pkg-1.20.1-0.7.1-alpha.3-fabric" = _ayZj6g1b;
        "pkg-1.20.4-0.7.1-alpha.3-fabric" = _LiJIWQP8;
        "pkg-1.21.1-0.7.1-alpha.3-fabric" = _rSeI1yIp;
        "pkg-1.21.4-0.7.1-alpha.3-fabric" = _g3YsU3a5;
        "pkg-1.20.1-0.7.1-alpha.3-forge" = _zGIlhTfz;
        "pkg-1.21.1-0.7.1-alpha.3-neoforge" = _A1aLEqu7;
        "pkg-1.21.4-0.7.1-alpha.3-neoforge" = _I8UuLRmZ;
        "pkg-1.21.6-0.8.0-alpha.1-neoforge" = _sJGaA9zb;
        "pkg-1.21.4-0.8.0-alpha.1-neoforge" = _9U4aP1Tr;
        "pkg-1.21.4-0.8.0-alpha.1-fabric" = _y79QuVsU;
        "pkg-1.20.1-0.8.0-alpha.1-forge" = _qFrtLlI4;
        "pkg-1.21.6-0.8.0-alpha.1-fabric" = _vSdRu5XK;
        "pkg-1.21-0.8.0-alpha.1-neoforge" = _npyVtCea;
        "pkg-1.20.4-0.8.0-alpha.1-fabric" = _50w54vFw;
        "pkg-1.20.1-0.8.0-alpha.1-fabric" = _3fNj2jJh;
        "pkg-1.21.5-0.8.0-alpha.1-fabric" = _e5Epy364;
        "pkg-1.21-0.8.0-alpha.1-fabric" = _gBqCiPY3;
        "pkg-1.21.5-0.8.0-alpha.1-neoforge" = _k5Tyzl4p;
        "pkg-1.20.1-0.8.1-alpha.1-fabric" = _Q6voZ47Q;
        "pkg-1.20.4-0.8.1-alpha.1-fabric" = _j8zqSjz4;
        "pkg-1.20.6-0.8.1-alpha.1-fabric" = _xytR4lNa;
        "pkg-1.21-0.8.1-alpha.1-fabric" = _SWnjmIa6;
        "pkg-1.21.4-0.8.1-alpha.1-fabric" = _w6CUVYdK;
        "pkg-1.21.5-0.8.1-alpha.1-fabric" = _gjYv6dLH;
        "pkg-1.21.6-0.8.1-alpha.1-fabric" = _sTu6FtD5;
        "pkg-1.20.1-0.8.1-alpha.1-forge" = _5mvxYhoi;
        "pkg-1.21-0.8.1-alpha.1-neoforge" = _75duoQHG;
        "pkg-1.21.4-0.8.1-alpha.1-neoforge" = _fcVwFQ5W;
        "pkg-1.21.5-0.8.1-alpha.1-neoforge" = _iUSQXXL7;
        "pkg-1.21.6-0.8.1-alpha.1-neoforge" = _xC6k22Zk;
        "pkg-1.20.1-0.8.2-alpha.1-fabric" = _eepk3ttr;
        "pkg-1.20.4-0.8.2-alpha.1-fabric" = _HAPSljFO;
        "pkg-1.20.6-0.8.2-alpha.1-fabric" = _Hbpt3um3;
        "pkg-1.21-0.8.2-alpha.1-fabric" = _gSgLHCgt;
        "pkg-1.21.4-0.8.2-alpha.1-fabric" = _AbCXFpUs;
        "pkg-1.21.5-0.8.2-alpha.1-fabric" = _sY7r4cn2;
        "pkg-1.21.6-0.8.2-alpha.1-fabric" = _7ItJobLx;
        "pkg-1.20.1-0.8.2-alpha.1-forge" = _QvECBzJy;
        "pkg-1.21-0.8.2-alpha.1-neoforge" = _Lyj1a1Pk;
        "pkg-1.21.4-0.8.2-alpha.1-neoforge" = _EGoiHrgD;
        "pkg-1.21.5-0.8.2-alpha.1-neoforge" = _IXRpJ180;
        "pkg-1.21.6-0.8.2-alpha.1-neoforge" = _iahU8qBY;
        "pkg-1.21-0.8.3-alpha.1-fabric" = _U6nBJztL;
        "pkg-1.21.11-0.8.3-alpha.1-fabric" = _J1plOg2N;
        "pkg-1.21-0.8.3-alpha.1-neoforge" = _3Nz7UdPh;
        "pkg-1.21.11-0.8.3-alpha.1-neoforge" = _I9IUcKy8;
        "pkg-1.21-0.8.3-alpha.2+gl-fabric" = _UeRLZmFq;
        "pkg-1.21.11-0.8.3-alpha.2+gl-fabric" = _Et3pok1V;
        "pkg-1.21-0.8.3-alpha.2+gl-neo" = _n696iyl3;
        "pkg-1.21.11-0.8.3-alpha.2+gl-neo" = _sr2TLnjs;
        "pkg-1.21-0.8.3-alpha.3+gl-fabric" = _MemfHUqn;
        "pkg-1.21.11-0.8.3-alpha.3+gl-fabric" = _K0LoFJdC;
        "pkg-26.1-0.8.3-alpha.3+gl-fabric" = _TpvpkX3X;
        "pkg-1.21-0.8.3-alpha.3+gl-neo" = _M7Tfgcod;
        "pkg-1.21.11-0.8.3-alpha.3+gl-neo" = _YTVTlGdu;
        "pkg-26.1-0.8.3-alpha.3+gl-neo" = _StPQegpX;
        "pkg-1.21-0.8.3-alpha.4+gl-fabric" = _319KgsJd;
        "pkg-1.21.11-0.8.3-alpha.4+gl-fabric" = _6jDaf2Cm;
        "pkg-26.1-0.8.3-alpha.4+gl-fabric" = _bOkvprzX;
        "pkg-1.20.1-0.8.3-alpha.4+gl-forge" = _YjuJt5aN;
        "pkg-1.21-0.8.3-alpha.4+gl-neo" = _HHccMlKr;
        "pkg-1.21.11-0.8.3-alpha.4+gl-neo" = _6FMtrrca;
        "pkg-26.1-0.8.3-alpha.4+gl-neo" = _mqgWLZMw;
        "pkg-1.21-0.8.3-alpha.5+gl-fabric" = _BEvw1jHJ;
        "pkg-1.21.11-0.8.3-alpha.5+gl-fabric" = _Pv5qbxD5;
        "pkg-26.1-0.8.3-alpha.5+gl-fabric" = _pAjvVZvm;
        "pkg-26.2-0.8.3-alpha.5+gl-fabric" = _qYkoKVcU;
        "pkg-1.20.1-0.8.3-alpha.5+gl-forge" = _k1qWswfT;
        "pkg-1.21-0.8.3-alpha.5+gl-neo" = _sF8xIXbo;
        "pkg-1.21.11-0.8.3-alpha.5+gl-neo" = _uGYLiwWN;
        "pkg-26.1-0.8.3-alpha.5+gl-neo" = _x8sPfNHq;
        "pkg-26.2-0.8.3-alpha.5+gl-neo" = _t9yaDHOY;
        "pkg-1.21-0.8.3-alpha.6+gl-fabric" = _hfemWKXB;
        "pkg-1.21.11-0.8.3-alpha.6+gl-fabric" = _2tVCkEPb;
        "pkg-26.1-0.8.3-alpha.6+gl-fabric" = _47nZiWgj;
        "pkg-26.2-0.8.3-alpha.6+gl-fabric" = _psPpVVp3;
        "pkg-1.20.1-0.8.3-alpha.6+gl-forge" = _uH0UZ7Lu;
        "pkg-1.21-0.8.3-alpha.6+gl-neo" = _NTZNnRmN;
        "pkg-1.21.11-0.8.3-alpha.6+gl-neo" = _StdO3tiS;
        "pkg-26.1-0.8.3-alpha.6+gl-neo" = _4gnChTtX;
        "pkg-26.2-0.8.3-alpha.6+gl-neo" = _EQOlKjKx;
        "pkg-1.21-0.9.0-alpha.1+gl-fabric" = _QrKE5IdH;
        "pkg-26.1-0.9.0-alpha.1+gl-fabric" = _x2qyyTbB;
        "pkg-26.2-0.9.0-alpha.1+gl-fabric" = _aQoqjRGI;
        "pkg-1.20.1-0.9.0-alpha.1+gl-forge" = _RiWwIZgR;
        "pkg-1.21-0.9.0-alpha.1+gl-neo" = _axnYNnz2;
        "pkg-26.1-0.9.0-alpha.1+gl-neo" = _muCFe0oI;
        "pkg-26.2-0.9.0-alpha.1+gl-neo" = _FLA0QN3j;
        "pkg-1.21.11-0.9.0-alpha.1+gl-fabric" = _5beijdDo;
        "pkg-1.21.11-0.9.0-alpha.1+gl-neo" = _M6ZGHPZe;
        "pkg-26.2-0.9.0-alpha.2+gl-neo" = _xYoD584x;
        "pkg-1.21.11-0.9.0-alpha.2+gl-fabric" = _r1XRmV7H;
        "pkg-26.1-0.9.0-alpha.2+gl-neo" = _fNGtglul;
        "pkg-1.21-0.9.0-alpha.2+gl-neo" = _Qy2Xmfat;
        "pkg-1.21.11-0.9.0-alpha.2+gl-neo" = _QqrL58ET;
        "pkg-26.2-0.9.0-alpha.2+gl-fabric" = _l6vpxXKE;
        "pkg-1.21-0.9.0-alpha.2+gl-fabric" = _vZnzy6dX;
        "pkg-26.1-0.9.0-alpha.2+gl-fabric" = _Bc5ACOPh;
        "pkg-1.20.1-0.9.0-alpha.2+gl-forge" = _lxQycnST;
        "pkg-26.2-0.9.1-alpha.1+gl-fabric" = _Nydspzyq;
        "pkg-1.21-0.9.1-alpha.1+gl-neo" = _h1WiF1tx;
        "pkg-1.21.11-0.9.1-alpha.1+gl-fabric" = _avoLoH5M;
        "pkg-1.20.1-0.9.1-alpha.1+gl-forge" = _MeE6lOJf;
        "pkg-26.2-0.9.1-alpha.1+gl-neo" = _iDQmfrko;
        "pkg-26.1-0.9.1-alpha.1+gl-neo" = _JvUVAlsj;
        "pkg-26.1-0.9.1-alpha.1+gl-fabric" = _RtGM0pB1;
        "pkg-1.21-0.9.1-alpha.1+gl-fabric" = _VEFb6aPS;
        "pkg-1.21.11-0.9.1-alpha.1+gl-neo" = _I0tGPg2o;
        "pkg-1.21-0.9.1-alpha.2+gl-fabric" = _Qtu3Sdzz;
        "pkg-26.1-0.9.1-alpha.2+gl-neo" = _6S7eCYsP;
        "pkg-26.1-0.9.1-alpha.2+gl-fabric" = _nv6KkfTj;
        "pkg-1.21.11-0.9.1-alpha.2+gl-fabric" = _P95i03Ki;
        "pkg-1.21.11-0.9.1-alpha.2+gl-neo" = _DM0JcaHW;
        "pkg-26.2-0.9.1-alpha.2+gl-neo" = _k6zQJjC8;
