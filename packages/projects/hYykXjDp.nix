...
let
    versions = (let
        ...
        _uG7oHgw6 = {
            "id" = "uG7oHgw6";
            "file" = "fzzy_config-0.7.7+1.21+neoforge.jar";
            "hash" = "sha512-7wO0EbDhskGplS4aj9rGGXlmWVPrXygRaqwGUwlk5zeOsgp4WUpHuk2ULHTfog1VDCkgFLXejmPEK4gqM671pQ==";
        };
        _v5knfNYj = {
            "id" = "v5knfNYj";
            "file" = "fzzy_config-0.7.7+1.21.3+neoforge-sources.jar";
            "hash" = "sha512-RDaBJ3UNjL3xLMVsiz6vZbNOvp7BCVAYoTNFt4U61vO/JZtwLGXXtp67FJ23k/o8ouL3KD5kL/MXDNHUwh3tmA==";
        };
        _8f5GOHxb = {
            "id" = "8f5GOHxb";
            "file" = "fzzy_config-0.7.7+1.21.5+neoforge-sources.jar";
            "hash" = "sha512-L8wHa1UW91MePQ6F9PECiPPrlMQIb5pTb8dkzgMRdkfVXs01XLlNBO5p1I5NT7oG3yeRGEP0rryPK7GbsN3PTg==";
        };
        _vO9PZ3UJ = {
            "id" = "vO9PZ3UJ";
            "file" = "fzzy_config-0.7.7+1.21.6+neoforge-sources.jar";
            "hash" = "sha512-nGIGXMxArnkQfQvYbnB3bnFXYV9puSstynm95ULcjg0KQMSC8lTKxewJazDIAiRzf/B3EMf2L8ttusEbXkZg6Q==";
        };
        _i0cYEUec = {
            "id" = "i0cYEUec";
            "file" = "fzzy_config-0.7.7+1.21.7+neoforge-sources.jar";
            "hash" = "sha512-ImsDvkUGiauGvAZ/NhsSDKuaAUjR3vvbw88pF0LFxSd9Tt0f9S4NUdgT59qxQWmkm+meuBU/3FLBHbeumWpSvA==";
        };
        _ipijHYme = {
            "id" = "ipijHYme";
            "file" = "fzzy_config-0.7.7+1.21.9+neoforge.jar";
            "hash" = "sha512-7SG+GDAh8HusBki7Wgz/z6MRftJCj8YUkQf4gXr6NXgr1DbYmMbUFhcr7YVPF5VDr1OKh/JFGG2GtGA57uKZbg==";
        };
        _ZPP3eNin = {
            "id" = "ZPP3eNin";
            "file" = "fzzy_config-0.7.7+1.21.11+neoforge.jar";
            "hash" = "sha512-zC1gMrWg67paJEVIP3a1WetmR7CvkA3brjMKakXddh70Wuen2LwlvLKvpaZWjaDD2ckOO32B69bQfl0Hnxk4Vw==";
        };
        _HXARGQ9W = {
            "id" = "HXARGQ9W";
            "file" = "fzzy_config-0.7.7+26.1+neoforge.jar";
            "hash" = "sha512-V4DhVZz/r4JpHjJf/MvtwJJmPilOlxUfzulZE8UTxPCGl6ouYNt2YKWgebkrzbRfTdyMJsUp8J16+0j/8Sfpaw==";
        };
        _DP6iNAD6 = {
            "id" = "DP6iNAD6";
            "file" = "fzzy_config-0.7.7+26.2+neoforge.jar";
            "hash" = "sha512-/lY2pSCd1jbiD2zBmjnV7Mz+PuWHQ/X7dgY9N16JdkWiRwE+Na0kLmn/0Ummwh5V0X92jN2W8OR10PPuxYA+yg==";
        };
        _JHYH0fYB = {
            "id" = "JHYH0fYB";
            "file" = "fzzy_config-0.7.7+1.20.1.jar";
            "hash" = "sha512-O+qf9Oog9pZ4D37nez+v+08aPTqBGZ8smHoLvU8WsC4J3eHXwvkqP6RmHAhcifUWUMiyGbWEY9S0964XYU7RYQ==";
        };
        _zFccjYag = {
            "id" = "zFccjYag";
            "file" = "fzzy_config-0.7.7+1.21.jar";
            "hash" = "sha512-oZS623w6svPT3b8rKxAeoIa506SU9oatGe1VYirPrOjeZWjUB3Ah1PozFKzyydEd8Gk+ZPKjFjB7XGrogyNOUA==";
        };
        _xWTpuhvN = {
            "id" = "xWTpuhvN";
            "file" = "fzzy_config-0.7.7+1.21.3.jar";
            "hash" = "sha512-GsSnbA8d8maNruwKYNkJmdXLk92xawn83jsmpki8GOPybjr8QNXUGPDpoMp85a05qIHCGWRicZ/qf3f3UBLR2A==";
        };
        _hmoqPBFx = {
            "id" = "hmoqPBFx";
            "file" = "fzzy_config-0.7.7+1.21.5.jar";
            "hash" = "sha512-H2SkJaJ0lFORc/cdYJl4sLippS9+bZkGuC4G2Hwx0WYiY1nkhd1046Aak+SAX3/Hfx7NnH+4NaZjtKSTR1VRjA==";
        };
        _IiLyYcpl = {
            "id" = "IiLyYcpl";
            "file" = "fzzy_config-0.7.6+1.21.6.jar";
            "hash" = "sha512-l8Cgk0S4WyV4CBDYDLa61gs9qEQjlw1sHEAlDEvPXcZfR4xgsFHAT4e5SSM8mDvaNAKU0BdXqwzdf73apruOkQ==";
        };
        _zxQQiUtX = {
            "id" = "zxQQiUtX";
            "file" = "fzzy_config-0.7.7+1.21.9.jar";
            "hash" = "sha512-ssc+J31M8J5n//2hPYChYCnj2l6D6ozTwvYjugdUaZMqvda2N9uPNheLTCUXRSDeX5Q5BbN3LOY6pRG6dxbesQ==";
        };
        _5SSZmpdx = {
            "id" = "5SSZmpdx";
            "file" = "fzzy_config-0.7.7+1.21.11.jar";
            "hash" = "sha512-SDHYG5OOs3n//DVa8Z4kMWy464g9rter7c36fVqTksqTG2uTC0k/ybTkxLFmELgHmlO1YfFQcDEsaXYRdD71tA==";
        };
        _Ugxie86a = {
            "id" = "Ugxie86a";
            "file" = "fzzy_config-0.7.7+26.1.jar";
            "hash" = "sha512-xWVYB9HIDdPN2JlDX3k475h1xc9ehrriMTpeCydR7TPt62stzkqKxBeP2pBiIAgEdSS5JTNGbkSSDcpBkf5ABg==";
        };
        _tZ4vc79R = {
            "id" = "tZ4vc79R";
            "file" = "fzzy_config-0.7.7+26.2.jar";
            "hash" = "sha512-+49/g46vRp5eVFEy8mSp9s3Da7maSn4c53+ZFaKqe35jBpIQMWmmT1Xb5eXJoiTgsCapigJ8bBOoGXJ+8t3lfg==";
        };
        _53kg5uoF = {
            "id" = "53kg5uoF";
            "file" = "fzzy_config-0.7.7+1.20.1+forge.jar";
            "hash" = "sha512-0IKy/N0kETEvDOCWw15hZ8RT+FyXnEJzzJLPJGzQhV2CWGXXnUeTOhvz8cqq8XtalBXUy1is4mWCQ0hDOA48HQ==";
        };
        _RlUQZcxK = {
            "id" = "RlUQZcxK";
            "file" = "fzzy_config-0.7.7+26.3.jar";
            "hash" = "sha512-75o3npYHju8UXQlk1TrwBKqDDhJ7jkSIkedRVepwmf7qICnhyahj21KstRk4zBog5S8HtwXmdwjesCN3+ATqsA==";
        };
        _w9WUmRj2 = {
            "id" = "w9WUmRj2";
    ...
    in {
        ...
        "fabric-1.21" = _zFccjYag;
        "fabric-1.21.1" = _zFccjYag;
        "fabric-24w34a" = _hfea8TrV;
        "fabric-1.20.4" = _3egGRmcp;
        "fabric-24w40a" = _ap3BKI14;
        "fabric-1.21.2-pre4" = _KiFxIO7O;
        "fabric-1.21.2" = _xWTpuhvN;
        "fabric-1.21.3" = _xWTpuhvN;
        "fabric-1.21.4" = _xWTpuhvN;
        "fabric-1.21.5" = _hmoqPBFx;
        "fabric-1.21.6" = _IiLyYcpl;
        "fabric-1.21.7" = _IiLyYcpl;
        "fabric-1.21.8" = _IiLyYcpl;
        "fabric-1.21.9" = _zxQQiUtX;
        "fabric-1.21.10" = _zxQQiUtX;
        "fabric-1.21.11" = _5SSZmpdx;
        "fabric-26.1" = _Ugxie86a;
        ...
        "forge-1.20.1" = _53kg5uoF;
        "neoforge-1.20.1" = _53kg5uoF;
        "neoforge-1.20.4" = _QH0fLChv;
        "neoforge-1.20.5" = _sBNunYy4;
        "neoforge-1.20.6" = _sBNunYy4;
        "neoforge-1.21" = _uG7oHgw6;
        "neoforge-1.21.1" = _uG7oHgw6;
        "neoforge-1.21.2" = _v5knfNYj;
        "neoforge-1.21.3" = _v5knfNYj;
        "neoforge-1.21.4" = _v5knfNYj;
        "neoforge-1.21.5" = _8f5GOHxb;
        "neoforge-1.21.6" = _vO9PZ3UJ;
        "neoforge-1.21.7" = _i0cYEUec;
        "neoforge-1.21.8" = _i0cYEUec;
        "neoforge-1.21.9" = _ipijHYme;
        "neoforge-1.21.10" = _ipijHYme;
        "neoforge-1.21.11" = _ZPP3eNin;
        "neoforge-26.1" = _HXARGQ9W;
        ...
        "pkg-0.2.3+1.20.1" = _aCtWUdvw;
        "pkg-0.2.4+1.20.1" = _vZOkBYRD;
        "pkg-0.2.5+1.20.1" = _W1IhiFhM;
        "pkg-0.2.5+1.20.5" = _GyNU4HFW;
        "pkg-0.2.6+1.20.1" = _CK0QqHP2;
        "pkg-0.2.6+1.20.5" = _73t1tTKv;
        "pkg-0.2.7+1.20.1" = _JCFaLioJ;
        "pkg-0.2.7+1.20.5" = _6wLlZO1T;
        "pkg-0.2.8+1.20.1" = _bckWRo3W;
        "pkg-0.2.8+1.20.5" = _bUgeGNCb;
        "pkg-0.3.0+1.20.1" = _Q1hwuGaq;
        "pkg-0.3.0+1.20.5" = _AzgGCvGk;
        "pkg-0.3.1+1.20.5" = _Jy8a6jCj;
        "pkg-0.3.1+1.20.1" = _K9DrSiYs;
        "pkg-0.3.2+1.20.1" = _qH8o8GOW;
        "pkg-0.3.2+1.20.6" = _9qTvl87w;
        "pkg-0.3.2+24w20a" = _320Vd6c8;
        "pkg-0.3.3+1.20.1" = _SbAmOdEG;
        "pkg-0.3.3+1.20.6" = _MZVZ6mvs;
        "pkg-0.3.3+24w20a" = _377BYE2g;
        "pkg-0.3.3+24w21b" = _SiZDZqer;
        "pkg-0.3.4+1.20.1" = _jlmiVDHF;
        "pkg-0.3.4+1.20.6" = _VCj9XFNv;
        "pkg-0.3.4+1.21" = _KBZ1TyFN;
        "pkg-0.3.5+1.20.1" = _hgurC4IZ;
        "pkg-0.3.5+1.20.6" = _GzgeMGpo;
        "pkg-0.3.5+1.21" = _e6HT1luW;
        "pkg-0.3.6+1.20.1" = _8kszrPwu;
        "pkg-0.3.6+1.20.6" = _GiXE5IvK;
        "pkg-0.3.6+1.21" = _fF5OCrcz;
        "pkg-0.3.7+1.20.1" = _Hj0W8asN;
        "pkg-0.3.7+1.20.6" = _9x1NIeRQ;
        "pkg-0.3.7+1.21" = _alJleNMz;
        "pkg-0.3.7+24w34a" = _gT2OVqcy;
        "pkg-0.3.7+1.20.4" = _fT0urjVO;
        "pkg-0.4.0+1.20.1+forge" = _y3J2hiaz;
        "pkg-0.4.0+1.20.4+neoforge" = _pnMCKKws;
        "pkg-0.4.0+1.20.6+neoforge" = _qKlFSP4I;
        "pkg-0.4.0+1.21+neoforge" = _jHtANHBQ;
        "pkg-0.4.0+1.20.1" = _L41we8N7;
        "pkg-0.4.0+1.20.4" = _88pMbFn8;
        "pkg-0.4.0+1.20.6" = _zXdyMs6D;
        "pkg-0.4.0+1.21" = _dBqj5TsZ;
        "pkg-0.4.1+1.20.1+forge" = _algccheQ;
        "pkg-0.4.1+1.20.4+neoforge" = _8S6vm5pS;
        "pkg-0.4.1+1.20.6+neoforge" = _dkNV8jq6;
        "pkg-0.4.1+1.21+neoforge" = _ZmlxZPl9;
        "pkg-0.4.1+1.20.1" = _mvYrLhyi;
        "pkg-0.4.1+1.20.4" = _xI20lwoo;
        "pkg-0.4.1+1.20.6" = _Dwf6kzxO;
        "pkg-0.4.1+1.21" = _FMikCI29;
        "pkg-0.4.1+24w34a" = _rRH0ORWt;
        "pkg-0.4.1-fix1+1.20.1+forge" = _HHVxpHiX;
        "pkg-0.4.1-fix1+1.20.4+neoforge" = _46wEzUm7;
        "pkg-0.4.1-fix1+1.20.6+neoforge" = _XjisesBb;
        "pkg-0.4.1-fix1+1.21+neoforge" = _LBGv941w;
        "pkg-0.4.2+1.20.1+forge" = _5HIXNi6n;
        "pkg-0.4.2+1.20.4+neoforge" = _qEWxAWeu;
        "pkg-0.4.2+1.20.6+neoforge" = _xlCHnlOR;
        "pkg-0.4.2+1.21+neoforge" = _4vQliLEp;
        "pkg-0.4.2+1.20.1" = _yMonvtt3;
        "pkg-0.4.2+1.20.4" = _74ngbYJj;
        "pkg-0.4.2+1.20.6" = _E4RCxWqu;
        "pkg-0.4.2+1.21" = _Q6AQJzyi;
        "pkg-0.4.2+24w34a" = _C6WqxIM9;
        "pkg-0.4.3+1.20.1+forge" = _N15JppaX;
        "pkg-0.4.3+1.20.4+neoforge" = _fyHbaHFA;
        "pkg-0.4.3+1.20.6+neoforge" = _dZ1tsf3u;
        "pkg-0.4.3+1.21+neoforge" = _NzrIH6HE;
        "pkg-0.4.3+1.20.1" = _OQQXBY1D;
        "pkg-0.4.3+1.20.4" = _npvYAUMW;
        "pkg-0.4.3+1.20.6" = _nZJlIed0;
        "pkg-0.4.3+1.21" = _3KToifZX;
        "pkg-0.4.3+24w34a" = _fmp7h1cu;
        "pkg-0.5.0+1.20.1+forge" = _AT8bwOXr;
        "pkg-0.5.0+1.20.4+neoforge" = _u5Cs0x8y;
        "pkg-0.5.0+1.20.6+neoforge" = _AT2d18Ng;
        "pkg-0.5.0+1.21+neoforge" = _ofiyGdmv;
        "pkg-0.5.0+1.20.1" = _MgrfHpyF;
        "pkg-0.5.0+1.20.4" = _Qjuv5xna;
        "pkg-0.5.0+1.20.6" = _pXfz9XV3;
        "pkg-0.5.0+1.21" = _NqX6pScE;
        "pkg-0.5.0+24w34a" = _XRzqfRDn;
        "pkg-0.5.1+1.20.1+forge" = _H3t78a6Q;
        "pkg-0.5.1+1.20.4+neoforge" = _z276ywVf;
        "pkg-0.5.1+1.20.6+neoforge" = _bcawvehq;
        "pkg-0.5.1+1.21+neoforge" = _Q1bP2mEC;
        "pkg-0.5.1+1.20.1" = _actUFpnC;
        "pkg-0.5.1+1.20.4" = _7WMHjxF2;
        "pkg-0.5.1+1.20.6" = _nsnj6zrP;
        "pkg-0.5.1+1.21" = _3rGF3Rbt;
        "pkg-0.5.1+24w34a" = _JRqSWXWP;
        "pkg-0.5.1+24w40a" = _qJtgFRM6;
        "pkg-0.5.2+1.20.1+forge" = _HNXqa69Z;
        "pkg-0.5.2+1.20.4+neoforge" = _9VGL5H8q;
        "pkg-0.5.2+1.20.6+neoforge" = _Q6UoCVbF;
        "pkg-0.5.2+1.21+neoforge" = _1WoxDRQx;
        "pkg-0.5.2+1.20.1" = _9MIpWBOR;
        "pkg-0.5.2+1.20.4" = _du4tm2Xz;
        "pkg-0.5.2+1.20.6" = _XQCi0UI6;
        "pkg-0.5.2+1.21" = _JD2BEqzS;
        "pkg-0.5.2+24w34a" = _Qu4AsvhO;
        "pkg-0.5.2+24w40a" = _JHY2M7mc;
        "pkg-0.5.3+1.20.1+forge" = _U9Nqm3jK;
        "pkg-0.5.3+1.20.4+neoforge" = _8uR1f8zH;
        "pkg-0.5.3+1.20.6+neoforge" = _1vhqe0v7;
        "pkg-0.5.3+1.21+neoforge" = _plgW2dxx;
        "pkg-0.5.3+1.20.1" = _LWJeHGaR;
        "pkg-0.5.3+1.20.4" = _R8CSC3BB;
        "pkg-0.5.3+1.20.6" = _rU1cDB8R;
        "pkg-0.5.3+1.21" = _3E4LLZ8A;
        "pkg-0.5.3+24w34a" = _hfea8TrV;
        "pkg-0.5.3+24w40a" = _ap3BKI14;
        "pkg-0.5.4+1.20.1+forge" = _UoRMAiDF;
        "pkg-0.5.4+1.20.4+neoforge" = _ogUsvAgm;
        "pkg-0.5.4+1.20.6+neoforge" = _vONmgVwP;
        "pkg-0.5.4+1.21+neoforge" = _QteeAucz;
        "pkg-0.5.4+1.20.1" = _CK9npr4X;
        "pkg-0.5.4+1.20.4" = _SMQLo02q;
        "pkg-0.5.4+1.20.6" = _Vi1ZJzkK;
        "pkg-0.5.4+1.21" = _P0S6oJil;
        "pkg-0.5.4+1.21.2-pre4" = _PqlAEzie;
        "pkg-0.5.5+1.20.1+forge" = _QWmUEJGV;
        "pkg-0.5.5+1.20.4+neoforge" = _FFlm2mX4;
        "pkg-0.5.5+1.20.6+neoforge" = _KK3YgBAU;
        "pkg-0.5.5+1.21+neoforge" = _QnK4hh2y;
        "pkg-0.5.5+1.20.1" = _Hwf5W7WZ;
        "pkg-0.5.5+1.20.4" = _PfH6Ve7T;
        "pkg-0.5.5+1.20.6" = _gnp2qFYm;
        "pkg-0.5.5+1.21" = _bJjH9AD1;
        "pkg-0.5.5+1.21.2-pre4" = _KiFxIO7O;
        "pkg-0.5.5-fix1+1.20.1+forge" = _GZbxGWhr;
        "pkg-0.5.5+1.21.2+neoforge" = _9pqMc2sG;
        "pkg-0.5.5+1.21.2" = _pOm8qoSd;
        "pkg-0.5.5-fix1+1.21.2+neoforge" = _PmSmQM3Z;
        "pkg-0.5.5-fix1+1.21.2" = _i3GXVfqM;
        "pkg-0.5.5-fix2+1.21.2" = _iPzAUfRu;
        "pkg-0.5.6+1.20.1+forge" = _uJgdUw8o;
        "pkg-0.5.6+1.20.4+neoforge" = _qh2CsAE5;
        "pkg-0.5.6+1.20.6+neoforge" = _xFrG6Uw5;
        "pkg-0.5.6+1.21+neoforge" = _74aEky0E;
        "pkg-0.5.6+1.21.2+neoforge" = _bQ68RGIL;
        "pkg-0.5.6+1.20.1" = _8vtVGagj;
        "pkg-0.5.6+1.20.4" = _v5WLhIEs;
        "pkg-0.5.6+1.20.6" = _cyLI3VCa;
        "pkg-0.5.6+1.21" = _S6Fst9jI;
        "pkg-0.5.6+1.21.2" = _DSsiLw5k;
        "pkg-0.5.7+1.20.1+forge" = _JGCE9bhE;
        "pkg-0.5.7+1.20.4+neoforge" = _w0fklL8c;
        "pkg-0.5.7+1.20.6+neoforge" = _YM2dJKZR;
        "pkg-0.5.7+1.21+neoforge" = _OBu6FL2u;
        "pkg-0.5.7+1.21.2+neoforge" = _WWs7hHMz;
        "pkg-0.5.7+1.20.1" = _tamdAJoQ;
        "pkg-0.5.7+1.20.4" = _dTXKF0Om;
        "pkg-0.5.7+1.20.6" = _IxcaWHeI;
        "pkg-0.5.7+1.21" = _o1G02sxr;
        "pkg-0.5.7+1.21.2" = _AaySdkWZ;
        "pkg-0.5.8+1.20.1+forge" = _zesWsGFg;
        "pkg-0.5.8+1.20.4+neoforge" = _1u23MH5w;
        "pkg-0.5.8+1.20.6+neoforge" = _GfNr6Hit;
        "pkg-0.5.8+1.21+neoforge" = _wESpkMW0;
        "pkg-0.5.8+1.21.2+neoforge" = _mPCPVqal;
        "pkg-0.5.8+1.20.1" = _Jf2SIu1T;
        "pkg-0.5.8+1.20.4" = _exaX10si;
        "pkg-0.5.8+1.20.6" = _EBAaYRw5;
        "pkg-0.5.8+1.21" = _W4tSAipQ;
        "pkg-0.5.8+1.21.2" = _sFVPHUFm;
        "pkg-0.5.9+1.20.1+forge" = _nSI55mqo;
        "pkg-0.5.9+1.20.4+neoforge" = _QH0fLChv;
        "pkg-0.5.9+1.20.6+neoforge" = _sBNunYy4;
        "pkg-0.5.9+1.21+neoforge" = _53dgIsE9;
        "pkg-0.5.9+1.21.3+neoforge" = _mHlK3SAt;
        "pkg-0.5.9+1.20.1" = _rCqTwPkm;
        "pkg-0.5.9+1.20.4" = _3egGRmcp;
        "pkg-0.5.9+1.20.6" = _Ozzrjblv;
        "pkg-0.5.9+1.21" = _yO0DsLqB;
        "pkg-0.5.9+1.21.3" = _PsmtTxVa;
        "pkg-0.6.0+1.20.1+forge" = _ES0aX61C;
        "pkg-0.6.0+1.21+neoforge" = _texVoa1V;
        "pkg-0.6.0+1.21.3+neoforge" = _bVozVqxR;
        "pkg-0.6.0+1.20.1" = _uZkVazHv;
        "pkg-0.6.0+1.21" = _NqLg1hiI;
        "pkg-0.6.0+1.21.3" = _eF931QwA;
        "pkg-0.6.1+1.20.1+forge" = _Mjl1Zs1u;
        "pkg-0.6.1+1.21+neoforge" = _LTKOzfxK;
        "pkg-0.6.1+1.21.3+neoforge" = _QYkRZyjU;
        "pkg-0.6.1+1.20.1" = _TCuzmzch;
        "pkg-0.6.1+1.21" = _p6F7Yn2h;
        "pkg-0.6.1+1.21.3" = _yu1m20Ma;
        "pkg-0.6.2+1.20.1+forge" = _QOLmBnu1;
        "pkg-0.6.2+1.21+neoforge" = _P28CUCue;
        "pkg-0.6.2+1.21.3+neoforge" = _eqBZsDfq;
        "pkg-0.6.2+1.20.1" = _KBTm5T4W;
        "pkg-0.6.2+1.21" = _4svMb4gj;
        "pkg-0.6.2+1.21.3" = _FarmIz1a;
        "pkg-0.6.3+1.20.1+forge" = _UnPCA534;
        "pkg-0.6.3+1.21+neoforge" = _WOTAjeSn;
        "pkg-0.6.3+1.21.3+neoforge" = _6taNDBws;
        "pkg-0.6.3+1.20.1" = _5YpsfG82;
        "pkg-0.6.3+1.21" = _akz9ITnl;
        "pkg-0.6.3+1.21.3" = _X8P39FlX;
        "pkg-0.6.4+1.20.1+forge" = _TMe0GLXS;
        "pkg-0.6.4+1.21+neoforge" = _7wnDBiIi;
        "pkg-0.6.4+1.21.3+neoforge" = _vQxpCvxR;
        "pkg-0.6.4+1.20.1" = _BIPkBXuQ;
        "pkg-0.6.4+1.21" = _kyQfIlfn;
        "pkg-0.6.4+1.21.3" = _eDPfVciw;
        "pkg-0.6.5+1.20.1+forge" = _kgKzBI4G;
        "pkg-0.6.5+1.21+neoforge" = _dbKrw8gW;
        "pkg-0.6.5+1.21.3+neoforge" = _FDfihavZ;
        "pkg-0.6.5+1.20.1" = _kZSxVWz7;
        "pkg-0.6.5+1.21" = _GQFqFMcK;
        "pkg-0.6.5+1.21.3" = _SPYrEFkZ;
        "pkg-0.6.5-fix1+1.21.3+neoforge" = _VPXwjtcM;
        "pkg-0.6.5-fix1+1.20.1+forge" = _6FpN9Bn7;
        "pkg-0.6.6+1.20.1+forge" = _jxGTVHhs;
        "pkg-0.6.6+1.21+neoforge" = _CHv8PmHJ;
        "pkg-0.6.6+1.21.3+neoforge" = _4h2hF4Wr;
        "pkg-0.6.6+1.20.1" = _sFA0N8Af;
        "pkg-0.6.6+1.21" = _Nw1btPC1;
        "pkg-0.6.6+1.21.3" = _wb0MOCxq;
        "pkg-0.6.7+1.20.1+forge" = _B9rxFrWp;
        "pkg-0.6.7+1.21+neoforge" = _Bvj7WMlM;
        "pkg-0.6.7+1.21.3+neoforge" = _JQ2PnPS3;
        "pkg-0.6.7+1.20.1" = _QDZRepiQ;
        "pkg-0.6.7+1.21" = _xOpf98kS;
        "pkg-0.6.7+1.21.3" = _zgGUTC9d;
        "pkg-0.6.8+1.20.1+forge" = _BoyuNpEg;
        "pkg-0.6.8+1.21+neoforge" = _EvL6wbwK;
        "pkg-0.6.8+1.21.3+neoforge" = _EuqY5UCC;
        "pkg-0.6.8+1.20.1" = _ctvfKyuh;
        "pkg-0.6.8+1.21" = _mEFqrE0p;
        "pkg-0.6.8+1.21.3" = _PGkChByE;
        "pkg-0.6.8+1.21.5" = _kEAYyXh3;
        "pkg-0.6.8+1.21.5+neoforge" = _bPvEqyb6;
        "pkg-0.6.9+1.20.1+forge" = _Jp0w2D0o;
        "pkg-0.6.9+1.21+neoforge" = _q0YufUQB;
        "pkg-0.6.9+1.21.3+neoforge" = _FVwvtag9;
        "pkg-0.6.9+1.21.5+neoforge" = _crpdcpcf;
        "pkg-0.6.9+1.20.1" = _9fnoYC1X;
        "pkg-0.6.9+1.21" = _Qp7Eb0aU;
        "pkg-0.6.9+1.21.3" = _5BiY6K5F;
        "pkg-0.6.9+1.21.5" = _7MYgkKJS;
        "pkg-0.7.0+1.20.1+forge" = _XrCbTIGs;
        "pkg-0.7.0+1.21+neoforge" = _ivCvlsDg;
        "pkg-0.7.0+1.21.3+neoforge" = _ztNX3Ntz;
        "pkg-0.7.0+1.21.5+neoforge" = _tUEw8EzJ;
        "pkg-0.7.0+1.20.1" = _tbpj74o7;
        "pkg-0.7.0+1.21" = _5srYCykA;
        "pkg-0.7.0+1.21.3" = _FjYKnXCL;
        "pkg-0.7.0+1.21.5" = _yM3RWeYe;
        "pkg-0.7.0+1.21.6+neoforge" = _NwbByM6f;
        "pkg-0.7.0+1.21.6" = _saxm44XP;
        "pkg-0.7.0-fix1+1.21.6" = _EDOrQVch;
        "pkg-0.7.0-fix2+1.21.6" = _SdmnDbYd;
        "pkg-0.7.0+1.21.7+neoforge" = _gcC8XAqj;
        "pkg-0.7.1+1.20.1+forge" = _OOPrShvY;
        "pkg-0.7.1+1.21+neoforge" = _wFIc6GXf;
        "pkg-0.7.1+1.21.3+neoforge" = _1tdhkPwY;
        "pkg-0.7.1+1.21.5+neoforge" = _Xp2h5Cwy;
        "pkg-0.7.1+1.21.6+neoforge" = _8Leegid4;
        "pkg-0.7.1+1.21.7+neoforge" = _ROHewNPG;
        "pkg-0.7.1+1.20.1" = _Gtg5qfHG;
        "pkg-0.7.1+1.21" = _fz7Msfrc;
        "pkg-0.7.1+1.21.3" = _zrOLIL5n;
        "pkg-0.7.1+1.21.5" = _66ucGfmG;
        "pkg-0.7.1+1.21.6" = _EbpDDtdT;
        "pkg-0.7.2+1.20.1+forge" = _eNoSkpjw;
        "pkg-0.7.2+1.21" = _Vc90gJvJ;
        "pkg-0.7.2+1.21+neoforge" = _ZWbJxzBB;
        "pkg-0.7.2+1.21.3+neoforge" = _UMa5xKBC;
        "pkg-0.7.2+1.21.5+neoforge" = _IOc5jRxi;
        "pkg-0.7.2+1.21.6+neoforge" = _YWs000H6;
        "pkg-0.7.2+1.21.7+neoforge" = _LVAznGJs;
        "pkg-0.7.2+1.20.1" = _KVD9gGYS;
        "pkg-0.7.2+1.21.3" = _xGH1lqDY;
        "pkg-0.7.2+1.21.5" = _x8wg32qA;
        "pkg-0.7.2+1.21.6" = _d0v9rl51;
        "pkg-0.7.2+1.21.9" = _cUQoAYvm;
        "pkg-0.7.2+1.21.9+neoforge" = _1gAjnh3h;
        "pkg-0.7.3+1.20.1+forge" = _17Wzgyxp;
        "pkg-0.7.3+1.21+neoforge" = _656NUHDc;
        "pkg-0.7.3+1.21.3+neoforge" = _jK1KELOx;
        "pkg-0.7.3+1.21.5+neoforge" = _voAHa6Kc;
        "pkg-0.7.3+1.21.6+neoforge" = _PPdFYTDv;
        "pkg-0.7.3+1.21.7+neoforge" = _CNNP6EG4;
        "pkg-0.7.3+1.21.9+neoforge" = _tTm7OnDQ;
        "pkg-0.7.3+1.20.1" = _X97pZsBz;
        "pkg-0.7.3+1.21" = _4YSS4whj;
        "pkg-0.7.3+1.21.3" = _ILe8s33I;
        "pkg-0.7.3+1.21.5" = _tEwPGcuD;
        "pkg-0.7.3+1.21.6" = _Av40BFaJ;
        "pkg-0.7.3+1.21.9" = _9TnEcyGA;
        "pkg-0.7.3+1.21.11+neoforge" = _ENIst1LF;
        "pkg-0.7.3+1.21.11" = _v4FSqCzd;
        "pkg-0.7.4+1.20.1" = _zZUqe5BI;
        "pkg-0.7.4+1.21" = _RF0On3D0;
        "pkg-0.7.4+1.21.3" = _xBAuuJJU;
        "pkg-0.7.4+1.21.5" = _6fszWtRx;
        "pkg-0.7.4+1.21.6" = _kHTLI5n2;
        "pkg-0.7.4+1.21.9" = _xgXWXdVw;
        "pkg-0.7.4+1.21.11" = _wzGOAZ7Q;
        "pkg-0.7.4+1.21+neoforge" = _Mo5GSG4l;
        "pkg-0.7.4+1.20.1+forge" = _wnhd0CI1;
        "pkg-0.7.4+1.21.3+neoforge" = _7GLWtNnB;
        "pkg-0.7.4+1.21.5+neoforge" = _lvIDBREl;
        "pkg-0.7.4+1.21.6+neoforge" = _hIp5Ziel;
        "pkg-0.7.4+1.21.7+neoforge" = _J908Vb0Y;
        "pkg-0.7.4+1.21.9+neoforge" = _Q3GoLN1b;
        "pkg-0.7.4+1.21.11+neoforge" = _zg2ABxrw;
        "pkg-0.7.4-fix1+1.21.11" = _knhYQk5k;
        "pkg-0.7.4-fix1+1.21.9" = _gKiVWClo;
        "pkg-0.7.4-fix1+1.21.6" = _o2R3AXtr;
        "pkg-0.7.4-fix1+1.21.5" = _GjT63nVH;
        "pkg-0.7.4-fix1+1.21.3" = _bxfZimL2;
        "pkg-0.7.4-fix1+1.21" = _QpNZ4LVv;
        "pkg-0.7.4-fix1+1.20.1" = _E75OaTHD;
        "pkg-0.7.4-fix2+1.21.11" = _Uhk1GHQ2;
        "pkg-0.7.4-fix2+1.21.9" = _m06eJ6OT;
        "pkg-0.7.5+1.20.1+forge" = _Dt5erL4a;
        "pkg-0.7.5+1.21+neoforge" = _D9zI6UFX;
        "pkg-0.7.5+1.21.3+neoforge" = _KkdhI2OQ;
        "pkg-0.7.5+1.21.5+neoforge" = _X6tVTBr2;
        "pkg-0.7.5+1.21.6+neoforge" = _i1Umv7UW;
        "pkg-0.7.5+1.21.7+neoforge" = _hM9AaMaQ;
        "pkg-0.7.5+1.21.9+neoforge" = _Fjncw1nL;
        "pkg-0.7.5+1.21.11+neoforge" = _XnsdY5pb;
        "pkg-0.7.5+1.20.1" = _sH6Ve0Wc;
        "pkg-0.7.5+1.21" = _pSgPDEMC;
        "pkg-0.7.5+1.21.3" = _jAK8PJES;
        "pkg-0.7.5+1.21.5" = _87ZqKFUP;
        "pkg-0.7.5+1.21.6" = _EtrhS8I9;
        "pkg-0.7.5+1.21.9" = _hSYigzVm;
        "pkg-0.7.5+1.21.11" = _XSRvROPN;
        "pkg-0.7.6+1.20.1+forge" = _7MmXhjWs;
        "pkg-0.7.6+1.21+neoforge" = _MAPG6cXE;
        "pkg-0.7.6+1.21.3+neoforge" = _c4NXGhrI;
        "pkg-0.7.6+1.21.5+neoforge" = _Onm1W6n8;
        "pkg-0.7.6+1.21.6+neoforge" = _5zXiWFDN;
        "pkg-0.7.6+1.21.7+neoforge" = _C8bbSXVP;
        "pkg-0.7.6+1.21.9+neoforge" = _5ts5252h;
        "pkg-0.7.6+1.21.11+neoforge" = _5D0Rl7mi;
        "pkg-0.7.6+1.20.1" = _qkBkQTfU;
        "pkg-0.7.6+1.21" = _kOmySYD4;
        "pkg-0.7.6+1.21.3" = _KhLnDZk7;
        "pkg-0.7.6+1.21.5" = _IxnE6KKS;
        "pkg-0.7.6+1.21.6" = _IiLyYcpl;
        "pkg-0.7.6+1.21.9" = _CBSbrUlV;
        "pkg-0.7.6+1.21.11" = _nSB6xGOS;
        "pkg-0.7.6+26.1+neoforge" = _hvFMM0p9;
        "pkg-0.7.6+26.1" = _EzFtPUO0;
        "pkg-0.7.6+26.2+neoforge" = _lGlPvgBc;
        "pkg-0.7.6+26.2" = _EQSFgLYw;
        "pkg-0.7.7+1.21+neoforge" = _uG7oHgw6;
        "pkg-0.7.7+1.21.3+neoforge" = _v5knfNYj;
        "pkg-0.7.7+1.21.5+neoforge" = _8f5GOHxb;
        "pkg-0.7.7+1.21.6+neoforge" = _vO9PZ3UJ;
        "pkg-0.7.7+1.21.7+neoforge" = _i0cYEUec;
        "pkg-0.7.7+1.21.9+neoforge" = _ipijHYme;
        "pkg-0.7.7+1.21.11+neoforge" = _ZPP3eNin;
        "pkg-0.7.7+26.1+neoforge" = _HXARGQ9W;
        "pkg-0.7.7+26.2+neoforge" = _DP6iNAD6;
        "pkg-0.7.7+1.20.1" = _JHYH0fYB;
        "pkg-0.7.7+1.21" = _zFccjYag;
        "pkg-0.7.7+1.21.3" = _xWTpuhvN;
        "pkg-0.7.7+1.21.5" = _hmoqPBFx;
        "pkg-0.7.7+1.21.9" = _zxQQiUtX;
        "pkg-0.7.7+1.21.11" = _5SSZmpdx;
        "pkg-0.7.7+26.1" = _Ugxie86a;
        "pkg-0.7.7+26.2" = _tZ4vc79R;
