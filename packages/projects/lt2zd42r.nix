...
let
    ...
    in {
        ...
        "pkg-4.0.1+1.20.1-fabric" = _sUzPyUGg;
        "pkg-4.0.2+1.20.1-forge" = _Q5W95pjx;
        "pkg-4.0.2+1.20.1-fabric" = _YIEJV8vi;
        "pkg-4.0.3+1.20.1-forge" = _VqNHmxVT;
        "pkg-4.0.3+1.20.1-fabric" = _aCZhLoYs;
        "pkg-4.0.4+1.20.1-forge" = _hALV1OoL;
        "pkg-4.0.4+1.20.1-fabric" = _LcL2VJ2D;
        "pkg-4.0.5+1.20.1-forge" = _n1dAPy62;
        "pkg-4.0.5+1.20.1-fabric" = _x8Zs0JYz;
        "pkg-4.0.6+1.20.1-forge" = _dcfIaWdZ;
        "pkg-4.0.6+1.20.1-fabric" = _dbOU0PA8;
        "pkg-4.0.7+1.20.1-forge" = _ZGRecjJ8;
        "pkg-4.0.7+1.20.1-fabric" = _M8NfVHe4;
        "pkg-4.0.8+1.20.1-forge" = _40xnrIEa;
        "pkg-4.0.8+1.20.1-fabric" = _r96dp18d;
        "pkg-4.0.9+1.20.1-forge" = _Pk79cVMW;
        "pkg-4.0.9+1.20.1-fabric" = _Sdb5bNoF;
        "pkg-4.1.0+1.20.1-forge" = _zN8xssHv;
        "pkg-4.1.0+1.20.1-fabric" = _6z09vVv3;
        "pkg-4.1.1+1.20.1-forge" = _vli3rYjR;
        "pkg-4.1.1+1.20.1-fabric" = _TtwGsjAY;
        "pkg-4.1.2+1.20.1-forge" = _NHAlLd0w;
        "pkg-4.1.2+1.20.1-fabric" = _uh0Pc5jt;
        "pkg-4.1.3+1.20.1-forge" = _6XumZIhw;
        "pkg-4.1.3+1.20.1-fabric" = _ERj2jRoO;
        "pkg-4.1.4+1.20.1-forge" = _vy2SgdN2;
        "pkg-4.1.4+1.20.1-fabric" = _2tIScLxS;
        "pkg-4.1.5+1.20.1-forge" = _tnURp1lz;
        "pkg-4.1.5+1.20.1-fabric" = _rJRs7pyy;
        "pkg-4.1.6+1.20.1-forge" = _5C5rV7hy;
        "pkg-4.1.6+1.20.1-fabric" = _hx4F4ndk;
        "pkg-4.1.7+1.20.1-forge" = _Jp7e1Qhh;
        "pkg-4.1.7+1.20.1-fabric" = _C5aRCsla;
        "pkg-4.1.8+1.20.1-forge" = _vmdUkHr8;
        "pkg-4.1.8+1.20.1-fabric" = _J2yeoh9A;
        "pkg-4.1.9+1.20.1-forge" = _WQVkCpny;
        "pkg-4.1.9+1.20.1-fabric" = _A6pM2TOh;
        "pkg-4.1.10+1.20.1-forge" = _ROaV1Bgb;
        "pkg-4.1.10+1.20.1-fabric" = _xczSVPEl;
        "pkg-4.1.11+1.20.1-forge" = _ZV1aVyOy;
        "pkg-4.1.11+1.20.1-fabric" = _jfz3OPH6;
        "pkg-4.1.12+1.20.1-forge" = _Yj3CXxpI;
        "pkg-4.1.12+1.20.1-fabric" = _IdWK5IuT;
        "pkg-4.1.13+1.20.1-forge" = _yLX5w0jm;
        "pkg-4.1.13+1.20.1-fabric" = _PhmjD586;
        "pkg-4.1.14+1.20.1-forge" = _Ox7U8CWU;
        "pkg-4.1.14+1.20.1-fabric" = _zqI1Uvkr;
        "pkg-4.2.0+1.20.1-forge" = _CBrJxUpB;
        "pkg-4.2.0+1.20.1-fabric" = _iLYyINn1;
        "pkg-4.2.1+1.20.1-forge" = _JlDpGIPw;
        "pkg-4.2.1+1.20.1-fabric" = _1EZ0DoZm;
        "pkg-4.2.2+1.20.1-forge" = _aOVMG5dx;
        "pkg-4.2.2+1.20.1-fabric" = _5h9C8uBa;
        "pkg-4.2.3+1.20.1-forge" = _2NMDAdwB;
        "pkg-4.2.3+1.20.1-fabric" = _x63C4H57;
        "pkg-4.2.4+1.20.1-forge" = _idX3X8t4;
        "pkg-4.2.4+1.20.1-fabric" = _b6dR7APG;
        "pkg-4.2.5+1.20.1-forge" = _ZRo2eiNH;
        "pkg-4.2.5+1.20.1-fabric" = _fe91Mrrt;
        "pkg-4.2.6+1.20.1-forge" = _twOEupDz;
        "pkg-4.2.6+1.20.1-fabric" = _a8qFArMC;
        "pkg-4.2.7+1.20.1-forge" = _k4X4AB0W;
        "pkg-4.2.7+1.20.1-fabric" = _IAAwFC75;
        "pkg-4.2.8+1.20.1-forge" = _A79X0loP;
        "pkg-4.2.8+1.20.1-fabric" = _8ykPVlGf;
        "pkg-4.2.9+1.20.1-forge" = _6iyy2EbO;
        "pkg-4.2.9+1.20.1-fabric" = _ibuTTF4S;
        "pkg-4.3.0+1.20.1-forge" = _s6hm5Y5r;
        "pkg-4.3.0+1.20.1-fabric" = _JkWor2dc;
        "pkg-4.3.1+1.20.1-forge" = _NzRUBZ2T;
        "pkg-4.3.1+1.20.1-fabric" = _kyAwNPQL;
        "pkg-4.3.2+1.20.1-forge" = _jFSR1vb1;
        "pkg-4.3.2+1.20.1-fabric" = _RWJwFTqF;
        "pkg-4.3.3+1.20.1-forge" = _zoJtuYzX;
        "pkg-4.3.3+1.20.1-fabric" = _knh5NTV2;
        "pkg-4.4.0+1.20.1-forge" = _FV6nKyKc;
        "pkg-4.4.0+1.20.1-fabric" = _PO0QFXfH;
        "pkg-4.4.1+1.20.1-forge" = _txrAaut5;
        "pkg-4.4.1+1.20.1-fabric" = _zN8J8hP1;
        "pkg-4.4.2+1.20.1-forge" = _H7zxFJXg;
        "pkg-4.4.2+1.20.1-fabric" = _vQ1NkETx;
        "pkg-4.5.0+1.20.1-forge" = _i1BgxCPY;
        "pkg-4.5.0+1.20.1-fabric" = _Fmdnb8Zc;
        "pkg-4.5.1+1.20.1-forge" = _HDsXxGgp;
        "pkg-4.5.1+1.20.1-fabric" = _eOEEyxAb;
        "pkg-4.5.2+1.20.1-forge" = _wKdHkTOn;
        "pkg-4.5.2+1.20.1-fabric" = _H9XtNzQ4;
        "pkg-4.5.3+1.20.1-forge" = _b61hCrFw;
        "pkg-4.5.3+1.20.1-fabric" = _PwVc0nzi;
        "pkg-4.5.4+1.20.1-forge" = _39D1K3Xa;
        "pkg-4.5.4+1.20.1-fabric" = _QaCphEpp;
        "pkg-4.5.5+1.20.1-forge" = _G1vuu1OZ;
        "pkg-4.5.5+1.20.1-fabric" = _Y4L6HXg2;
        "pkg-4.5.6+1.20.1-forge" = _tQkoK6Ux;
        "pkg-4.5.6+1.20.1-fabric" = _QQZyJGUG;
        "pkg-4.5.7+1.20.1-forge" = _SnOa9EVQ;
