...
let
    versions = (let
        ...
        _KBycY63c = {
            "id" = "KBycY63c";
            "file" = "ItemsAdderAdditions-1.0.13.jar";
            "hash" = "sha512-60R423unb+r6sKwZM8qxKuyr2E46lTpwWrrZolK/PNn8EvBBjWWTZFtFft1j6dKPSr3nmG+DtD2tCGALK5X/Ng==";
        };
    in {
        "D9QFoOHR" = _D9QFoOHR;
        "d4FtgUOO" = _d4FtgUOO;
        ...
        "USsnFoLn" = _USsnFoLn;
        "KBycY63c" = _KBycY63c;
        "paper-1.20.6" = _KBycY63c;
        "paper-1.21" = _KBycY63c;
        "paper-1.21.1" = _KBycY63c;
        "paper-1.21.2" = _KBycY63c;
        "paper-1.21.3" = _KBycY63c;
        "paper-1.21.4" = _KBycY63c;
        "paper-1.21.5" = _KBycY63c;
        "paper-1.21.6" = _KBycY63c;
        "paper-1.21.7" = _KBycY63c;
        "paper-1.21.8" = _KBycY63c;
        "paper-1.21.9" = _KBycY63c;
        "paper-1.21.10" = _KBycY63c;
        "paper-1.21.11" = _KBycY63c;
        "paper-26.1" = _KBycY63c;
        "paper-26.1.1" = _KBycY63c;
        "paper-26.1.2" = _KBycY63c;
        "paper-26.2" = _KBycY63c;
        "purpur-1.20.6" = _KBycY63c;
        "purpur-1.21" = _KBycY63c;
        "purpur-1.21.1" = _KBycY63c;
        "purpur-1.21.2" = _KBycY63c;
        "purpur-1.21.3" = _KBycY63c;
        "purpur-1.21.4" = _KBycY63c;
        "purpur-1.21.5" = _KBycY63c;
        "purpur-1.21.6" = _KBycY63c;
        "purpur-1.21.7" = _KBycY63c;
        "purpur-1.21.8" = _KBycY63c;
        "purpur-1.21.9" = _KBycY63c;
        "purpur-1.21.10" = _KBycY63c;
        "purpur-1.21.11" = _KBycY63c;
        "purpur-26.1" = _KBycY63c;
        "purpur-26.1.1" = _KBycY63c;
        "purpur-26.1.2" = _KBycY63c;
        "purpur-26.2" = _KBycY63c;
        "pkg-1.0.0" = _D9QFoOHR;
        "pkg-1.0.1" = _d4FtgUOO;
        "pkg-1.0.2" = _a0pHsxcV;
        "pkg-1.0.3" = _YJBqeDGU;
        ...
        "pkg-1.0.8" = _woZtROWN;
        "pkg-1.0.9" = _vjQE4PZD;
        "pkg-1.0.10" = _qRqj4oLr;
        "pkg-1.0.11" = _zA64Ybpz;
        "pkg-1.0.12" = _USsnFoLn;
        "pkg-1.0.13" = _KBycY63c;
        "default" = _KBycY63c;
    });
