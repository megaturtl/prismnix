...
let
    ...
    in {
        ...
        "pkg-1.0-1.20" = _pNWaCU3E;
        "pkg-1.1-1.20" = _oWdf8Gwx;
        "pkg-1.1.1-1.20" = _GRJQpePZ;
        "pkg-1.2-1.20" = _wmeiGdiS;
        "pkg-1.3-1.20" = _JegaDz0q;
        "pkg-1.4-1.20" = _xTQiAT2o;
        "pkg-1.4.1-1.20" = _9zmFWQpc;
        "pkg-1.5-1.20.2" = _CWXEaUKT;
        "pkg-1.5-1.20.4" = _kjG2hd9H;
        "pkg-1.5.1-1.20.2" = _2XpaqenB;
        "pkg-1.5.1-1.20.4" = _bKNFnmNv;
        "pkg-1.5.1-1.20.5" = _eJWoy8eV;
        "pkg-1.5.1-1.21" = _fwzvGdgy;
        "pkg-1.5.2-1.20.2" = _KpTiFL7o;
        "pkg-1.5.2-1.20.4" = _39JvdmWc;
        "pkg-1.5.2-1.20.6" = _ML8Bd56B;
        "pkg-1.5.2-1.21" = _Dvil543E;
        "pkg-1.6-1.20.2" = _zFkfQzwu;
        "pkg-1.6-1.20.4" = _i4yzPI9Q;
        "pkg-1.6-1.20.6" = _kImqvLcE;
        "pkg-1.6-1.21" = _HIlDPhxH;
        "pkg-1.7-1.20.2" = _ec7RB2lq;
        "pkg-1.7-1.20.4" = _BT24h7dK;
        "pkg-1.7-1.20.6" = _qffi2WC4;
        "pkg-1.7-1.21.1" = _HXUYWh73;
        "pkg-1.7.1-1.20.2" = _zvOzyuyJ;
        "pkg-1.8-1.21.3" = _KmCjA4NU;
        "pkg-1.8-1.21.4" = _f2b31M6b;
        "pkg-1.8-1.20.2" = _pAdWen3k;
        "pkg-1.8.1-1.20.2" = _HmVmWh3Z;
        "pkg-1.8.2-1.20.2" = _tqIxNPeL;
        "pkg-1.8-1.21.1" = _pCdzASKF;
        "pkg-1.8.1-1.21.4" = _USalvDLl;
        "pkg-1.8.1-1.21.5" = _z5tZ4RwV;
        "pkg-2.0.0" = _wO9FRMqx;
        "pkg-2.1.0" = _MXx1pwiZ;
        "pkg-2.1.1" = _AV6MFr4e;
        "pkg-2.2.0" = _CLZtDzjI;
