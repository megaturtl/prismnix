...
let
    ...
    in {
        ...
        "pkg-1.0.0-alpha-earlygame4" = _JpFbG3Q5;
        "pkg-1.0.0-alpha-earlygame5" = _abS649T8;
        "pkg-1.0.0-alpha-earlygame6" = _596XMsl6;
        "pkg-1.0.0-alpha-earlygame7" = _shdabjYZ;
        "pkg-1.0.0-alpha-earlygame8" = _WYNGBc9f;
        "pkg-1.0.0-alpha-earlygame9" = _IgLferal;
        "pkg-1.0.0-alpha-earlygame10" = _XMVlhLJb;
        "pkg-1.0.0-alpha-earlygame11" = _QRCVaXnF;
        "pkg-1.0.0-alpha-earlygame12" = _Rs0rxlR5;
        "pkg-1.0.0-alpha-earlygame13" = _4VDhHoWy;
        "pkg-1.0.0-alpha-earlygame14" = _yLkD2iPK;
        "pkg-1.0.0-alpha-earlygame15" = _hPfM7H4k;
        "pkg-1.0.0-alpha-earlygame16" = _e5aEAMmw;
        "pkg-1.0.0-alpha-earlygame17" = _i3HGO3VC;
        "pkg-1.0.0-alpha-song_of_the_factory1" = _TXV0zMOC;
        "pkg-1.0.0-alpha-song_of_the_factory2" = _ruVofhX5;
        "pkg-1.0.0-alpha-song_of_the_factory3" = _FMxky5wm;
        "pkg-1.0.0-alpha-song_of_the_factory4" = _qsxF3gcB;
        "pkg-1.0.0-alpha-song_of_the_factory5" = _tZHNnNSs;
        "pkg-1.0.0-alpha-song_of_the_factory6" = _sfmw861i;
        "pkg-1.0.0-alpha-song_of_the_factory7" = _KJN7WRG1;
        "pkg-1.0.0-alpha-song_of_the_factory8" = _YV4hYAvG;
        "pkg-1.0.0-alpha-song_of_the_factory9" = _blZnzRfQ;
        "pkg-song_of_the_factory10" = _MzSfzsSK;
        "pkg-0.2.11+song-of-the-factory" = _Mxm2bhsi;
        "pkg-0.2.12+song-of-the-factory" = _U0CFP7Bc;
        "pkg-0.2.13+song-of-the-factory" = _zdJcmfCk;
        "pkg-0.3.1+tides-of-phenua" = _nYNTGSI8;
        "pkg-0.3.2+tides-of-phenua" = _CKsYQQrY;
        "pkg-0.3.3+tides-of-phenua" = _wFOGhMkl;
