...
let
    ...
    in {
        ...
        "pkg-9.3.3" = _M9xY0lf9;
        "pkg-9.4.0" = _zOfT3lCt;
        "pkg-9.5.1-1.19.2" = _PPkckYQX;
        "pkg-9.6.1-1.20.1" = _NRSdRpIz;
        "pkg-9.6.2-1.20.1" = _Br7iknHH;
        "pkg-9.6.3-1.20.1" = _bHiclvUc;
        "pkg-9.5.2-1.19.2" = _YHwlWoCZ;
        "pkg-9.7.0-1.21" = _OIpj7g0v;
        "pkg-9.7.1-1.21" = _hXjA6wqI;
        "pkg-9.7.2-1.21" = _hS6etVMF;
        "pkg-9.7.3-1.21" = _G9xZRfFj;
        "pkg-9.8.0-1.21" = _sGx9AUBF;
        "pkg-9.4.1-1.18.2" = _iN46hzoZ;
        "pkg-9.8.1-1.21.1" = _20oDt9Q4;
        "pkg-9.9.0-1.21.8" = _rGRkaGWu;
        "pkg-9.9.1-1.21.8" = _DU4im6Dy;
        "pkg-9.10.0+26.1" = _DV1Jfqt9;
        "pkg-9.10.1+26.1" = _jBtaT3wX;
