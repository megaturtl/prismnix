...
let
    ...
    in {
        ...
        "pkg-2.9.5" = _JQWxzHiT;
        "pkg-0.0.1" = _MZzBB2Tu;
        "pkg-2.10.0" = _3UFsNp9b;
        "pkg-2.10.1" = _qkbJh4bl;
        "pkg-3.0.0" = _8VpIkD5B;
        "pkg-3.0.2" = _Q4LDex1E;
        "pkg-3.0.5" = _6DTFb128;
        "pkg-3.0.6" = _Y8rSEWgC;
        ...
        "pkg-4.1.0" = _c3DNzuuQ;
        "pkg-4.1.1" = _TMOmVJBm;
        "pkg-4.0.4-BACKPORT" = _vgxMabP5;
        "pkg-4.1.2" = _3qZVBjMD;
        "pkg-4.0.5-BACKPORT" = _8sPJsNcy;
        "pkg-4.1.3" = _TfNV7Lhk;
        "pkg-4.1.4" = _zqec4a0Z;
        "pkg-4.1.5" = _Vur6oCT6;
        "pkg-4.2.0" = _94Ad3WgD;
        ...
        "pkg-4.4.9" = _YzQYJEjP;
        "pkg-4.5.0" = _6LithIYH;
        "pkg-4.4.10" = _zokPILXX;
        "pkg-4.5.1" = _M4FHfVPR;
        "pkg-4.5.2" = _D9mD8kWw;
        "pkg-4.4.11" = _8Us9jOjr;
        "pkg-4.4.12" = _ABShaLG9;
        "pkg-4.4.13" = _D3bMMycq;
        "pkg-4.5.3" = _mtUgrLYR;
        "pkg-4.5.4" = _2I093VQr;
        "pkg-4.5.5" = _qzwoPtFn;
        "pkg-4.6.0" = _B2WCktGU;
