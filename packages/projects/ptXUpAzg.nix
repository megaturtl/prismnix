...
let
    ...
    in {
        ...
        "pkg-1.5" = _mCrYBqe9;
        "pkg-1.5.1" = _uGJMK0FQ;
        "pkg-1.5.2-pre1" = _fXKqbe5i;
        "pkg-1.5.2-pre2" = _FN5esutv;
        "pkg-1.5.2-pre3" = _tyl5ke3N;
        "pkg-1.5.2" = _R9Ns62sA;
        "pkg-1.6-pre1" = _ZQMIH52J;
        "pkg-1.6-pre2" = _stdBjGTW;
        "pkg-1.6-pre3" = _YxSuPml6;
        "pkg-1.6-pre4" = _4qOPAv4P;
        "pkg-1.6-pre5" = _62jyDBZa;
        "pkg-1.6" = _S26UJht3;
        "pkg-1.6.1" = _yu5jhoUc;
        "pkg-1.6.1-pre2" = _okOn4q6L;
        "pkg-1.7-pre1" = _H7rwuzP6;
        "pkg-1.7-pre2" = _w4TpB9Rp;
        "pkg-1.7-pre3" = _Jnoyl7XX;
        "pkg-1.7-pre8" = _oZo51JcW;
        "pkg-1.7-pre9" = _I5qev5y3;
        "pkg-1.7-pre10" = _CRHyA8P6;
        "pkg-1.7-pre11" = _cQP7eheC;
        "pkg-1.7-pre12" = _GdSB1qkI;
        "pkg-1.7" = _8O2fNjjF;
        "pkg-1.7.1" = _BELPcxOZ;
        "pkg-1.7.2" = _hbfAbpHC;
        "pkg-1.7.3" = _Fqs7sPGq;
        "pkg-1.7.4" = _9tMZCC1p;
        "pkg-1.7.5-pre1" = _nekqyFhJ;
        "pkg-1.7.5-pre2" = _cPGk9UHb;
        "pkg-1.7.5-pre3" = _eyunfhoy;
        "pkg-1.7.5-pre4" = _hDMnSvth;
        "pkg-1.7.5-pre5" = _Nc53kIcw;
        "pkg-1.7.5-pre6" = _J0E5zU0G;
        "pkg-1.7.5-pre7" = _3C25TcPy;
        "pkg-1.7.5-pre8" = _70p5NcgO;
        "pkg-1.7.5" = _4AXiIsxB;
        "pkg-1.7.6" = _XFzswd83;
        "pkg-1.7.7" = _QGNlx02x;
        "pkg-1.7.8" = _CbfvUVrN;
        "pkg-1.7.9" = _jPY98z1D;
        "pkg-1.7.10-pre1" = _GLVKrg3X;
