...
let
    versions = (let
        ...
        _E0vFwbpC = {
            "id" = "E0vFwbpC";
            "file" = "xaerominimap-forge-1.12.2-26.5.0.jar";
            "hash" = "sha512-s7XwS/eGGhrGhjoxTuKODEcUhrwFAKMd6IGweXzCR7laHutaAU8yZa88CS9Z++7rfjsw+glTPLqucG4ozKolmw==";
        };
        _3ZOF9JKy = {
            "id" = "3ZOF9JKy";
            "file" = "xaerominimap-forge-1.16.5-26.5.0.jar";
            "hash" = "sha512-g5D053vpC0N2J9C+K+ubA37Ps2RYRl+CHvPXGA7sxUN7u0oAe7Nnygs7RuP8xGKKJhSv4ksduiVXJZa15A6CBA==";
        };
        _FtshtRKu = {
            "id" = "FtshtRKu";
            "file" = "xaerominimap-fabric-1.16.5-26.5.0.jar";
            "hash" = "sha512-OO3pv62/JLUWdd20lP/7ihola0my7qhrCNYacAYj63uqD0a/p26OzzXF51u7i8RBR/rEvMX5gX3lUjd9nocWlg==";
        };
        _PthCIgVG = {
            "id" = "PthCIgVG";
            "file" = "xaerominimap-fabric-1.18.2-26.5.0.jar";
            "hash" = "sha512-8nifpcxiJXimyA1kdib31CR0SvcdGQr2Q69QDRLRo0cFmz7WYciMdU5OPGTpVfUStcZeNlBWDEdQ7g6gPIlRHA==";
        };
        _Kivk3ESI = {
            "id" = "Kivk3ESI";
            "file" = "xaerominimap-forge-1.18.2-26.5.0.jar";
            "hash" = "sha512-Ka7Y3PduV6IKx+tfYl+uTeev1poa0a3O4pmgrRfRdP7R5AOrhYKRk52sB1aIPKjNfMaSCD2zpvTEXYZ+tDB+tQ==";
        };
        _F3EZ3EeI = {
            "id" = "F3EZ3EeI";
            "file" = "xaerominimap-fabric-1.19.2-26.5.0.jar";
            "hash" = "sha512-Ne6RbSadtseTQSOdpGExSHaGSj/o3IcLDCSGFERAjC8isAapTfyKPvsxAR3lWGJsjrB1CDKVUpsTxl11kKARtg==";
        };
        _VXZD4M1S = {
            "id" = "VXZD4M1S";
            "file" = "xaerominimap-forge-1.19.2-26.5.0.jar";
            "hash" = "sha512-c+BomcHI8mVBe/IUDvSnKvEce0Xt1AXgKVDrYWDKm4cUTTsyQR/3OneyMrbUDz6n0isdMO9oZA/9XH+Jgf1dTA==";
        };
        _eLoJ9IXg = {
            "id" = "eLoJ9IXg";
            "file" = "xaerominimap-fabric-1.20.1-26.5.0.jar";
            "hash" = "sha512-b9H6hpz2pVzECnsbxHi9Dg/mxd2fIFrJXG06KpBE4v9tqWM2QJae9UV8VqxayrYo31yHISHwMa/qitg1ZpEq1A==";
        };
        _Juh6inLY = {
            "id" = "Juh6inLY";
            "file" = "xaerominimap-forge-1.20.1-26.5.0.jar";
            "hash" = "sha512-kTscQosEm5sDdude3Hq0m8PfYFz4Gkwya5EkExTWTIFCDfD8lGzWvYqaE/ekW4Qte4YAjzKgzyfQ08snil5SBA==";
        };
        _A7F7BIix = {
            "id" = "A7F7BIix";
            "file" = "xaerominimap-fabric-1.20.4-26.5.0.jar";
            "hash" = "sha512-SodD78fRSco4C8Buvi/1k00qCNKMRz8dmX/uDyRDbqQp8RTtdVQPlc0DFW0GwQhGEGyvbLnEQHoo1YhbSwd6Aw==";
        };
        _tBqQhb8M = {
            "id" = "tBqQhb8M";
            "file" = "xaerominimap-neoforge-1.20.4-26.5.0.jar";
            "hash" = "sha512-yvJGw2nCELCTss7+3WTrSJ0OYmZIIhCwQq0PP9/6KR721aiK0pIpymmcGpM4XuusYbaFU2RrjTgR9QoeUaqxnQ==";
        };
        _7PZIHcHC = {
            "id" = "7PZIHcHC";
            "file" = "xaerominimap-forge-1.20.4-26.5.0.jar";
            "hash" = "sha512-wfMHAMbURG4Ly5bOSQTL3s64ryyPY7I9ZBfabUbrHpKkMXveJLbr/+7oiqSuQ+rNd32e/3r0WK1xynu1K2yIcA==";
        };
        _Q1tuMQBB = {
            "id" = "Q1tuMQBB";
            "file" = "xaerominimap-neoforge-1.21.1-26.5.0.jar";
            "hash" = "sha512-D94QZt2SKsB5bRZrob8bhDhzuNhWPaOgh3ffVLs3f/ZGYJZlDHMK0bluCuzy2JdM2HwyFl7fajD2ZThAw/mavw==";
        };
        _sqSykKFQ = {
            "id" = "sqSykKFQ";
            "file" = "xaerominimap-forge-1.21.1-26.5.0.jar";
            "hash" = "sha512-LOt9yN0L10uy5MQ88B4mCXRX5X91g3Lrn3/R+kl91gV224H4nNO9Wlp4z9es1yuk5j8JKNJd2In1uRYKznLCPg==";
        };
        _ZD6hK4GV = {
            "id" = "ZD6hK4GV";
            "file" = "xaerominimap-fabric-1.21.1-26.5.0.jar";
            "hash" = "sha512-AGTH8KlHcX6M3CL4Ps6gd9yfOMOoPWmdbV/0G9fwJwDkrZsBJjY2khD0+d/uNeObiq00BIhEgQSspFOVZC3RNg==";
        };
        _UmbZGoNN = {
            "id" = "UmbZGoNN";
            "file" = "xaerominimap-neoforge-1.21.4-26.5.0.jar";
            "hash" = "sha512-2k2bdWhsdzQv5xY/AG8RtoScC/p6Q/sXXcsgvRKUSWjDXMpraUJHXWvpskofGBIZivxO//pIeMnN4ztoxDUuwg==";
        };
        _4sK0D4vO = {
            "id" = "4sK0D4vO";
            "file" = "xaerominimap-forge-1.21.4-26.5.0.jar";
            "hash" = "sha512-wYnQt4h+LhU4QbyZOgmjUaGpJ3Cfz5+DQHHJD7q0U/U6ZeJ3aMizEYT2MA0FzZC3HH9aIqzM/7ZXZDAuhmBq2g==";
        };
        _XsKw9RY8 = {
            "id" = "XsKw9RY8";
            "file" = "xaerominimap-fabric-1.21.4-26.5.0.jar";
            "hash" = "sha512-MsudsO9KrG9jOlVg3MClrm0PTBfj2z7ZzEhWWMFkmSJuI++Z8C/9AD4Y1Ax6qggIA+tHbXe6Zub2zIKkb5md+g==";
        };
        _Xy9Qb0hB = {
            "id" = "Xy9Qb0hB";
            "file" = "xaerominimap-neoforge-1.21.5-26.5.0.jar";
            "hash" = "sha512-9nmgpjZZRRqWkLeG3ejgV0mJWsQgimUKIJrbi6KiJ4A9tBGBKp/fGcdFYOIifq4eOGwbM3gD3+XMYo/hoh6hFw==";
        };
        _aFqhp23J = {
            "id" = "aFqhp23J";
            "file" = "xaerominimap-forge-1.21.5-26.5.0.jar";
            "hash" = "sha512-nRWCXj0jH03cC5Nsb1zj4S+lET7ju4Tgqy9+jfAQtzYlIEyX+DTLsTHxnfnjrrrJsPsrIdnJYhoGgueCZ5DmPA==";
        };
        _UiyvcqIl = {
            "id" = "UiyvcqIl";
            "file" = "xaerominimap-fabric-1.21.5-26.5.0.jar";
            "hash" = "sha512-qcE4717wgdfpYWJK9K0bkeKcnBqJMr0nwsd+bHwayw8jg07DTO9HoXwv1pwTlPGItFYGO2zG2LdxP1F9a5awlw==";
        };
        _bSWbd7fk = {
            "id" = "bSWbd7fk";
            "file" = "xaerominimap-fabric-1.21.8-26.5.0.jar";
            "hash" = "sha512-IygZfvJn3U10W3R+fw18gGa5BaAAr/ozZK/wUXJJjYSKe0Ah31FNySQbute/hWiYh7vJ+vtsIWk9GPMjgKpXtw==";
        };
        _yaTqpe9r = {
            "id" = "yaTqpe9r";
            "file" = "xaerominimap-neoforge-1.21.8-26.5.0.jar";
            "hash" = "sha512-Z3hsy0yVvyyXmNyTixSwMSmBOpEFtFFIqVgIc7bam8N056GMvVgXrzQCTL5RPNGT1BkMmczZB6eshrvBzKHvtg==";
        };
        _NYWgukTR = {
            "id" = "NYWgukTR";
            "file" = "xaerominimap-forge-1.21.8-26.5.0.jar";
            "hash" = "sha512-NRuQI3YT4O62GX4mVJ6wjkA2Sd0UzLFarNwaQryw+19W4+ezhtWxAvNcBnM0I5w1LrBpErK238s8i4o3LN52Tg==";
        };
        _F8LrvYl9 = {
            "id" = "F8LrvYl9";
            "file" = "xaerominimap-fabric-1.21.10-26.5.0.jar";
            "hash" = "sha512-0G+KYLcSfCPF8C8iD0RGL2vXNrogZk//w7mc2Chm5MsevDT7rIL5/qVqZuaCc66yct3Apppj3zklC/FJiUcMFg==";
        };
        _mIptvhV0 = {
            "id" = "mIptvhV0";
            "file" = "xaerominimap-neoforge-1.21.10-26.5.0.jar";
            "hash" = "sha512-yvBC+9lQwUHsIQaPpGs8bMBz4+mWge7sYFWuW6GON9fFWMwqF4Pj6w+JFh2VjsdFxYW8DR3ydER5/u2I6oo9gA==";
        };
        _Cbfpf5vy = {
            "id" = "Cbfpf5vy";
            "file" = "xaerominimap-forge-1.21.10-26.5.0.jar";
            "hash" = "sha512-mwQIXYmhQJcVy9lxGy8FKY1iHeAzPpAWwAOEFLoTv3HJ8cGslR4ZNbJywPoRV8UZeq6dg2eZBFrYYsHDSuq37g==";
        };
        _YeE8CjjJ = {
            "id" = "YeE8CjjJ";
            "file" = "xaerominimap-neoforge-1.21.11-26.5.0.jar";
            "hash" = "sha512-vvUZ0XzyKGAnoy+8cT8MilQ3X7etL77WjSIpGpSqq69Y57hmFamoB6sDJDAnZYSjN7KEitNYwqTN7bBpHq2ung==";
        };
        _mb0ddrtW = {
            "id" = "mb0ddrtW";
            "file" = "xaerominimap-forge-1.21.11-26.5.0.jar";
            "hash" = "sha512-BYf00pfk3FycMQIkuBnp6+Y4Uy4fNa7MbaXKBSWEL5N408ql6TkZQIMw3s1+BzrTwrcZ2DAfHaxypWv7wtDxxA==";
        };
        _VNYP3B0c = {
            "id" = "VNYP3B0c";
            "file" = "xaerominimap-fabric-1.21.11-26.5.0.jar";
            "hash" = "sha512-jZ0uzNlvXERv8OiNdoDMj+4tekqRkqb9unHO/VA8XHxBkiEyBiilVXbZBDH8hsr/IVVm/z3VJQCozFcC0VWTlA==";
        };
        _kWf58HtH = {
            "id" = "kWf58HtH";
            "file" = "xaerominimap-fabric-26.1.2-26.5.0.jar";
            "hash" = "sha512-X661+tYFnX16TSyBWez45kFwDqCWUuagH8yeNJhlS6Wqd4ZI1XzdlsBNq+GqgPJplJD6yvZ/j4raCv6Gx0oA4g==";
        };
        _SOtj001J = {
            "id" = "SOtj001J";
            "file" = "xaerominimap-neoforge-26.1.2-26.5.0.jar";
            "hash" = "sha512-dIdjJ32ru3XZLudxka58Cg/xBemXjBjR6zy7sJ0pH3pzXFFPOOFtw1fwNQTU5nP8+5KIGlbu4Ej15mAdrNSBMQ==";
        };
        _nFX2qxMK = {
            "id" = "nFX2qxMK";
            "file" = "xaerominimap-forge-26.1.2-26.5.0.jar";
            "hash" = "sha512-ooKMb3yizffoiOeiMSN6EQsii3hNSlks5UIKf7lnDH02boGdxMLmxzNRO9XKuf55EJaagNIU4YrjwE5XHBVmIg==";
        };
        _ulT9Wbps = {
            "id" = "ulT9Wbps";
            "file" = "xaerominimap-neoforge-26.2-26.5.0.jar";
            "hash" = "sha512-uCHiwZFMiT9xh4Ijm7EHOrjdT8pcHNefeyL3FxVM3iC2AVSoSw+1ktfyzLfe9ioNS70ML2WUunE8viwec0zqfg==";
        };
        _QBdmsTuO = {
            "id" = "QBdmsTuO";
            "file" = "xaerominimap-forge-26.2-26.5.0.jar";
            "hash" = "sha512-NBcb+k5dP6E4BajalDMZzIlyZSFGiagGs/573uPXibMMLu0WonANneIdPY08pwC1Sbr7Mosca632eu9SQ0A+fA==";
        };
        _tBIPWIKW = {
            "id" = "tBIPWIKW";
            "file" = "xaerominimap-fabric-26.2-26.5.0.jar";
            "hash" = "sha512-sA34u0EPrhKwh4gETy8DzsNL/EUG2kGdEdNk4vIpuBTbsnLSl/vksM36wYvu7tTcjxvfyW+xE4Z4V1J+MZZQSQ==";
        };
        _Sg74174z = {
            "id" = "Sg74174z";
            "file" = "xaerominimap-forge-1.12.2-26.5.1.jar";
            "hash" = "sha512-0P2XXfqozjH6QXXtbj1XthJackbZZGv1NJgQ/DUl92q+ax252uwelD7QS+/L98AV2bmmjSE2bLXDowRoPnHvTQ==";
        };
        _DBhJiSUh = {
            "id" = "DBhJiSUh";
            "file" = "xaerominimap-forge-26.2-26.5.1.jar";
            "hash" = "sha512-/n2Pu02qmLGDZg8q118Ch1rFr3TCYI6IUeO2Yuiw3XQUK1Rv/3GHaHbFVeQWZBp7tcFHCWy5KARppj30j9jzig==";
        };
        _WnaAZsas = {
            "id" = "WnaAZsas";
            "file" = "xaerominimap-neoforge-26.2-26.5.1.jar";
            "hash" = "sha512-6Xe5ixie+Z7eiHIRxkw10n6ZRNIKiqTaSOuNIC7iiO4yAI2hPG+zsQK4STqzK0Lf1GXOZhQPhkAYOEw2CDQAAw==";
        };
        _VlMbRW2O = {
            "id" = "VlMbRW2O";
            "file" = "xaerominimap-fabric-26.2-26.5.1.jar";
            "hash" = "sha512-zu44zp99rJZ7f/QuuUDADMUFlrDZ2oQBpZtVvpBP7nA9kacuoA0OI18zx/5ddfeASsBV3pLTSwhzy8EEOhAcDQ==";
        };
        _bxZ2OjkZ = {
            "id" = "bxZ2OjkZ";
            "file" = "xaerominimap-fabric-26.3-26.5.1.jar";
            "hash" = "sha512-nTAmu+UhMvf73t9RvHL+K3lMRu8GsQKUK9SUoHgJxGZp/WxJ2G25yYMVUrX0Q+WH/14FqgIHgc8jFzQ8IN8O3A==";
        };
        _ie70HnZq = {
            "id" = "ie70HnZq";
            "file" = "xaerominimap-fabric-26.3-26.5.2.jar";
            "hash" = "sha512-9x2UBujsVRHpRLwgSlqbvZgxsECUCmuxacuN/pf062IWanoBAWtWYyKMQF21BbR08lczmhfb9JrKv6hnmIz1lA==";
        };
        _XsDeq0Yy = {
            "id" = "XsDeq0Yy";
            "file" = "xaerominimap-neoforge-26.3-26.5.2.jar";
            "hash" = "sha512-50QCisu2Y/FyoPExNHADjbV7wf0uiMdh18CL3ebc3KT8C4zHKEQSD1OZZmAUEMw6dO73GSZaCC/HK/ZKq372IA==";
        };
        _YPkAliDt = {
            "id" = "YPkAliDt";
            "file" = "xaerominimap-fabric-26.3-26.5.3.jar";
            "hash" = "sha512-ht4118auEEQdmh5/FGVqh9w8+hdIexIupb+m8yK1a/oblmYpA6NvL/Dg1XlkRHRRDERj6iHeqCI7iTHW2/ZOYQ==";
        };
        _6zzKPjLq = {
            "id" = "6zzKPjLq";
            "file" = "xaerominimap-neoforge-26.3-26.5.3.jar";
            "hash" = "sha512-uz6fSeXixQFpDAGwMd7B4WjIUAMspWoW9QNW5xBJDxbDkcPP0mezFhKDvvbRg0pQn8GAR7Ml6t63Pszxln4hug==";
        };
    in {
        "w0s3P0Nx" = _w0s3P0Nx;
        "HuGurbB3" = _HuGurbB3;
        ...
        "forge-1.12.2" = _Sg74174z;
        "forge-1.14.4" = _6xOEvCyC;
        "forge-1.15.2" = _UaLwjU5j;
        "forge-1.16.2" = _uDQ1QOPA;
        "forge-1.16.3" = _uDQ1QOPA;
        "forge-1.16.4" = _uDQ1QOPA;
        "forge-1.16.5" = _3ZOF9JKy;
        "forge-1.17.1" = _yqp93Q5R;
        "forge-1.18.2" = _Kivk3ESI;
        "forge-1.19.1" = _VXZD4M1S;
        "forge-1.19.2" = _VXZD4M1S;
        "forge-1.19.3" = _iHZmaGst;
        "forge-1.19.4" = _ht7RRiZy;
        "forge-1.20" = _Juh6inLY;
        "forge-1.20.1" = _Juh6inLY;
        "forge-1.20.2" = _6FBCq4c6;
        "forge-1.20.3" = _Hh9qQAAt;
        "forge-1.20.4" = _7PZIHcHC;
        "forge-1.20.6" = _San5ggFV;
        "forge-1.21" = _sqSykKFQ;
        "forge-1.21.1" = _sqSykKFQ;
        "forge-1.20.5" = _San5ggFV;
        "forge-1.21.3" = _Qy9fc15b;
        "forge-1.21.4" = _4sK0D4vO;
        "forge-1.21.5" = _aFqhp23J;
        "forge-1.21.7" = _pgayZX4F;
        "forge-1.21.8" = _NYWgukTR;
        "forge-1.21.9" = _AYcRkYXN;
        "forge-1.21.10" = _Cbfpf5vy;
        "forge-1.21.11" = _mb0ddrtW;
        "forge-26.1.2" = _nFX2qxMK;
        "forge-26.2" = _DBhJiSUh;
        "fabric-1.16.2" = _FR7EDSCy;
        "fabric-1.16.3" = _FR7EDSCy;
        "fabric-1.16.4" = _FR7EDSCy;
        "fabric-1.16.5" = _FtshtRKu;
        "fabric-1.17" = _VuH8AYM3;
        "fabric-1.17.1" = _VuH8AYM3;
        "fabric-1.18.2" = _PthCIgVG;
        "fabric-1.19.1" = _F3EZ3EeI;
        "fabric-1.19.2" = _F3EZ3EeI;
        "fabric-1.19.3" = _I0FJpqoN;
        "fabric-1.19.4" = _v79Kiydp;
        "fabric-1.20-rc1" = _I8fXehdE;
        "fabric-1.20" = _eLoJ9IXg;
        "fabric-1.20.1" = _eLoJ9IXg;
        "fabric-1.20.2" = _Lf9U6tF1;
        "fabric-1.20.3-rc1" = _YBgP6QdM;
        "fabric-1.20.3" = _a1aPoO3W;
        "fabric-1.20.4" = _A7F7BIix;
        "fabric-1.20.5" = _1uyLHTGv;
        "fabric-1.20.6" = _OQrZzH2e;
        "fabric-1.21" = _T78xsQuu;
        "fabric-1.21.1" = _ZD6hK4GV;
        "fabric-1.21.3" = _m4DX1JCQ;
        "fabric-1.21.4" = _XsKw9RY8;
        "fabric-1.21.5" = _UiyvcqIl;
        "fabric-1.21.6" = _8llFAxyr;
        "fabric-1.21.7" = _2hcDlo6F;
        "fabric-1.21.8" = _bSWbd7fk;
        "fabric-1.21.9" = _hztxb2W2;
        "fabric-1.21.10" = _F8LrvYl9;
        "fabric-1.21.11" = _VNYP3B0c;
        "fabric-26.1.2" = _kWf58HtH;
        "fabric-26.2" = _VlMbRW2O;
        "fabric-26.1" = _kWf58HtH;
        "fabric-26.1.1" = _kWf58HtH;
        "fabric-26.3-rc-2" = _bxZ2OjkZ;
        "fabric-26.3-rc-3" = _bxZ2OjkZ;
        "fabric-26.3" = _YPkAliDt;
        "quilt-1.16.2" = _FR7EDSCy;
        "quilt-1.16.3" = _FR7EDSCy;
        "quilt-1.16.4" = _FR7EDSCy;
        "quilt-1.16.5" = _FtshtRKu;
        "quilt-1.17" = _VuH8AYM3;
        "quilt-1.17.1" = _VuH8AYM3;
        "quilt-1.18.2" = _PthCIgVG;
        "quilt-1.19.1" = _F3EZ3EeI;
        "quilt-1.19.2" = _F3EZ3EeI;
        "quilt-1.19.3" = _I0FJpqoN;
        "quilt-1.19.4" = _v79Kiydp;
        "quilt-1.20-rc1" = _I8fXehdE;
        "quilt-1.20" = _eLoJ9IXg;
        "quilt-1.20.1" = _eLoJ9IXg;
        "quilt-1.20.2" = _Lf9U6tF1;
        "quilt-1.20.3-rc1" = _YBgP6QdM;
        "quilt-1.20.3" = _a1aPoO3W;
        "quilt-1.20.4" = _A7F7BIix;
        "quilt-1.20.5" = _1uyLHTGv;
        "quilt-1.20.6" = _OQrZzH2e;
        "quilt-1.21" = _T78xsQuu;
        "quilt-1.21.1" = _ZD6hK4GV;
        "quilt-1.21.3" = _m4DX1JCQ;
        "quilt-1.21.4" = _XsKw9RY8;
        "quilt-1.21.5" = _UiyvcqIl;
        "quilt-1.21.6" = _8llFAxyr;
        "quilt-1.21.7" = _2hcDlo6F;
        "quilt-1.21.8" = _bSWbd7fk;
        "quilt-1.21.9" = _hztxb2W2;
        "quilt-1.21.10" = _F8LrvYl9;
        "quilt-1.21.11" = _VNYP3B0c;
        "quilt-26.1.2" = _kWf58HtH;
        "quilt-26.2" = _VlMbRW2O;
        "quilt-26.1" = _kWf58HtH;
        "quilt-26.1.1" = _kWf58HtH;
        "quilt-26.3-rc-2" = _bxZ2OjkZ;
        "quilt-26.3-rc-3" = _bxZ2OjkZ;
        "quilt-26.3" = _YPkAliDt;
        "neoforge-1.20.2" = _IPcufQGG;
        "neoforge-1.20.4" = _tBqQhb8M;
        "neoforge-1.20.3" = _9SZyYgeA;
        "neoforge-1.20.5" = _lygDaDx8;
        "neoforge-1.20.6" = _hmzfphdb;
        "neoforge-1.21" = _Q1tuMQBB;
        "neoforge-1.21.1" = _Q1tuMQBB;
        "neoforge-1.21.3" = _UVf8b2jK;
        "neoforge-1.21.4" = _UmbZGoNN;
        "neoforge-1.21.5" = _Xy9Qb0hB;
        "neoforge-1.21.6" = _N261LQYk;
        "neoforge-1.21.7" = _JWQzpqe6;
        "neoforge-1.21.8" = _yaTqpe9r;
        "neoforge-1.21.9" = _wsGTIFOq;
        "neoforge-1.21.10" = _mIptvhV0;
        "neoforge-1.21.11" = _YeE8CjjJ;
        "neoforge-26.1.2" = _SOtj001J;
        "neoforge-26.2" = _WnaAZsas;
        "neoforge-26.3" = _6zzKPjLq;
        "pkg-21.10.31_Forge_1.7.10" = _w0s3P0Nx;
        "pkg-21.10.31_Forge_1.8.9" = _HuGurbB3;
        "pkg-23.4.0_Forge_1.12" = _ppMU6Z2I;
        "pkg-23.3.3_Forge_1.14.4" = _SNmmqZ9B;
        "pkg-23.3.3_Forge_1.15.2" = _wE8jIGuh;
        "pkg-23.4.0_Fabric_1.16.5" = _lC4hcOVE;
        "pkg-23.4.0_Forge_1.16.5" = _6L5cMZ7K;
        "pkg-23.4.0_Fabric_1.17.1" = _iQUItHJR;
        "pkg-23.4.0_Forge_1.17.1" = _tRGwafW7;
        "pkg-23.4.0_Fabric_1.18.2" = _J6KCYRdU;
        "pkg-23.4.0_Forge_1.18.2" = _Nt4iodmn;
        "pkg-23.4.0_Fabric_1.19.1" = _FojbYoas;
        "pkg-23.4.0_Forge_1.19.1" = _9zye2qw4;
        "pkg-23.4.0_Fabric_1.19.3" = _avJ1VxJU;
        "pkg-23.4.0_Forge_1.19.3" = _s1rhJMTE;
        "pkg-23.4.0_Fabric_1.19.4" = _vrnch5iH;
        "pkg-23.4.0_Forge_1.19.4" = _PAMrhxeC;
        "pkg-21.10.33_Forge_1.7.10" = _cNhlRiJY;
        "pkg-21.10.33_Forge_1.8.9" = _uNO68A27;
        "pkg-23.4.1_Forge_1.12" = _I664qbcT;
        "pkg-23.3.4_Forge_1.14.4" = _yrLYxo0u;
        "pkg-23.3.4_Forge_1.15.2" = _nWIJL7XJ;
        "pkg-23.4.1_Fabric_1.16.5" = _1x0ILsMp;
        "pkg-23.4.1_Forge_1.16.5" = _DRBTqWWE;
        "pkg-23.4.1_Fabric_1.17.1" = _2gZQVfXc;
        "pkg-23.4.1_Forge_1.17.1" = _35H5aTCN;
        "pkg-23.4.1_Fabric_1.18.2" = _bGXg9vXe;
        "pkg-23.4.1_Forge_1.18.2" = _4COs5reF;
        "pkg-23.4.1_Fabric_1.19.1" = _4BuZ2uQi;
        "pkg-23.4.1_Forge_1.19.1" = _OFJPST0Q;
        "pkg-23.4.1_Fabric_1.19.3" = _r1kfKLex;
        "pkg-23.4.1_Forge_1.19.3" = _WH47LcDi;
        "pkg-23.4.1_Fabric_1.19.4" = _wA5lTfMy;
        "pkg-23.4.1_Forge_1.19.4" = _xJzUbNoJ;
        "pkg-23.4.2_Forge_1.12" = _2Xp2lrxP;
        "pkg-23.3.5_Forge_1.14.4" = _F7ZxANQI;
        "pkg-23.3.5_Forge_1.15.2" = _RcafQ7Hm;
        "pkg-23.4.2_Fabric_1.16.5" = _5pbtWSsW;
        "pkg-23.4.2_Forge_1.16.5" = _p2jt44Nx;
        "pkg-23.4.2_Fabric_1.17.1" = _IawL7pJb;
        "pkg-23.4.2_Forge_1.17.1" = _rf2B3xu0;
        "pkg-23.4.2_Fabric_1.18.2" = _tqv1PQZK;
        "pkg-23.4.2_Forge_1.18.2" = _PUnRwXus;
        "pkg-23.4.2_Fabric_1.19.1" = _2Xt8KsYf;
        "pkg-23.4.2_Forge_1.19.1" = _DT38adQd;
        "pkg-23.4.2_Fabric_1.19.3" = _cme3p1dr;
        "pkg-23.4.2_Forge_1.19.3" = _OFJFnVZT;
        "pkg-23.4.2_Fabric_1.19.4" = _2BTN3DDS;
        "pkg-23.4.2_Forge_1.19.4" = _VStrXzaa;
        "pkg-23.4.3_Fabric_1.16.5" = _r3BpxmG2;
        "pkg-23.4.3_Forge_1.16.5" = _gSD7DNhQ;
        "pkg-23.4.3_Fabric_1.17.1" = _vgcVyWHv;
        "pkg-23.4.3_Forge_1.17.1" = _mdPiXUS4;
        "pkg-23.4.3_Fabric_1.18.2" = _6X8lqJyo;
        "pkg-23.4.3_Forge_1.18.2" = _H4mYaGQp;
        "pkg-23.4.3_Fabric_1.19.1" = _X7nLQ7Vm;
        "pkg-23.4.3_Forge_1.19.1" = _86aZhRJ3;
        "pkg-23.4.3_Fabric_1.19.3" = _Ch6QAiVR;
        "pkg-23.4.3_Forge_1.19.3" = _a0QkQMyN;
        "pkg-23.4.3_Fabric_1.19.4" = _5GPcMgHh;
        "pkg-23.4.3_Forge_1.19.4" = _ieTNfGnv;
        "pkg-23.4.4_Forge_1.12" = _egu9I4vr;
        "pkg-23.3.6_Forge_1.15.2" = _CHTHmLXn;
        "pkg-23.4.4_Fabric_1.16.5" = _bAL4VcAg;
        "pkg-23.4.4_Forge_1.16.5" = _wTJUalwO;
        "pkg-23.4.4_Fabric_1.17.1" = _KwzRNV0o;
        "pkg-23.4.4_Forge_1.17.1" = _JuD8yGgV;
        "pkg-23.4.4_Fabric_1.18.2" = _lli7W8KF;
        "pkg-23.4.4_Forge_1.18.2" = _eJ0U2ijV;
        "pkg-23.4.4_Fabric_1.19.1" = _XEps1Upt;
        "pkg-23.4.4_Forge_1.19.1" = _lFb1C2ui;
        "pkg-23.4.4_Fabric_1.19.3" = _EJBTntJm;
        "pkg-23.4.4_Forge_1.19.3" = _8muNL0Eh;
        "pkg-23.4.4_Fabric_1.19.4" = _1iUK4vVw;
        "pkg-23.4.4_Forge_1.19.4" = _yy1WVYt7;
        "pkg-23.4.4_Fabric_1.20" = _I8fXehdE;
        "pkg-23.4.4_Forge_1.20" = _ETOFR9KA;
        "pkg-21.10.34_Forge_1.7.10" = _1He0X0cq;
        "pkg-21.10.34_Forge_1.8.9" = _I4vGxgUB;
        "pkg-23.5.0_Forge_1.12" = _R5gkCslm;
        "pkg-23.3.7_Forge_1.14.4" = _f8q94zoX;
        "pkg-23.3.7_Forge_1.15.2" = _E44kO4Xa;
        "pkg-23.5.0_Fabric_1.16.5" = _dRt8YraU;
        "pkg-23.5.0_Forge_1.16.5" = _3jmomVhT;
        "pkg-23.5.0_Fabric_1.17.1" = _ldf3azl1;
        "pkg-23.5.0_Forge_1.17.1" = _V5hZALQK;
        "pkg-23.5.0_Fabric_1.18.2" = _4lEWVPp0;
        "pkg-23.5.0_Forge_1.18.2" = _rp2rMxJo;
        "pkg-23.5.0_Fabric_1.19.1" = _H5ELiTaK;
        "pkg-23.5.0_Forge_1.19.1" = _LnGnN6Wm;
        "pkg-23.5.0_Fabric_1.19.3" = _2smSuVIC;
        "pkg-23.5.0_Forge_1.19.3" = _azeMJ1nM;
        "pkg-23.5.0_Fabric_1.19.4" = _iRhAjU2h;
        "pkg-23.5.0_Forge_1.19.4" = _2e46Lw1V;
        "pkg-23.5.0_Fabric_1.20" = _46F7j3df;
        "pkg-23.5.0_Forge_1.20" = _MEbqZZxa;
        "pkg-21.10.35_Forge_1.7.10" = _qGhznNXo;
        "pkg-21.10.35_Forge_1.8.9" = _YF6eFmhz;
        "pkg-23.6.0_Forge_1.12" = _Raw6uF1V;
        "pkg-23.3.8_Forge_1.14.4" = _diZGjEgD;
        "pkg-23.3.8_Forge_1.15.2" = _WoTkTZa5;
        "pkg-23.6.0_Fabric_1.16.5" = _AG8u4P63;
        "pkg-23.6.0_Forge_1.16.5" = _DOuiRwGe;
        "pkg-23.6.0_Fabric_1.17.1" = _4XS19D9K;
        "pkg-23.6.0_Forge_1.17.1" = _l7pg6bKQ;
        "pkg-23.6.0_Fabric_1.18.2" = _M2P91buq;
        "pkg-23.6.0_Forge_1.18.2" = _dz3fTToz;
        "pkg-23.6.0_Fabric_1.19.1" = _LKcX5Que;
        "pkg-23.6.0_Forge_1.19.1" = _8dkr2uqW;
        "pkg-23.6.0_Fabric_1.19.3" = _Y6EQTA41;
        "pkg-23.6.0_Forge_1.19.3" = _ZmtSgdIA;
        "pkg-23.6.0_Fabric_1.19.4" = _pv0bLIS8;
        "pkg-23.6.0_Forge_1.19.4" = _kwIKobDl;
        "pkg-23.6.0_Fabric_1.20" = _2aWIxg96;
        "pkg-23.6.0_Forge_1.20" = _7KbZF7xU;
        "pkg-21.10.36_Forge_1.7.10" = _aCayHbYL;
        "pkg-21.10.36_Forge_1.8.9" = _CZrrD2vf;
        "pkg-23.6.1_Forge_1.12" = _NIltAf6R;
        "pkg-23.3.9_Forge_1.14.4" = _CZCW5zom;
        "pkg-23.3.9_Forge_1.15.2" = _vgQK87ti;
        "pkg-23.6.1_Fabric_1.16.5" = _mMUiMak0;
        "pkg-23.6.1_Forge_1.16.5" = _JYAeUegn;
        "pkg-23.6.1_Fabric_1.17.1" = _fpSneDSW;
        "pkg-23.6.1_Forge_1.17.1" = _UZgjnzyW;
        "pkg-23.6.1_Fabric_1.18.2" = _nhS6BPLW;
        "pkg-23.6.1_Forge_1.18.2" = _XoheiGPr;
        "pkg-23.6.1_Fabric_1.19.1" = _7GBpgdcp;
        "pkg-23.6.1_Forge_1.19.1" = _QklpOPx8;
        "pkg-23.6.1_Fabric_1.19.3" = _k6hvQZGk;
        "pkg-23.6.1_Forge_1.19.3" = _5KksSxbC;
        "pkg-23.6.1_Fabric_1.19.4" = _qAFan3b8;
        "pkg-23.6.1_Forge_1.19.4" = _9PQASEAD;
        "pkg-23.6.1_Fabric_1.20" = _1DxAMjCv;
        "pkg-23.6.1_Forge_1.20" = _EdIwMhwf;
        "pkg-21.10.37_Forge_1.7.10" = _LuOoX5b5;
        "pkg-21.10.37_Forge_1.8.9" = _9vbdtcnn;
        "pkg-23.6.2_Forge_1.12" = _KLeKPSCh;
        "pkg-23.3.10_Forge_1.14.4" = _vMFtYCEm;
        "pkg-23.3.10_Forge_1.15.2" = _TqQhSjej;
        "pkg-23.6.2_Fabric_1.16.5" = _DKslEExY;
        "pkg-23.6.2_Forge_1.16.5" = _CVGBi4C4;
        "pkg-23.6.2_Fabric_1.17.1" = _EXBvAXXM;
        "pkg-23.6.2_Forge_1.17.1" = _qGikrMjV;
        "pkg-23.6.2_Fabric_1.18.2" = _Jwydpps9;
        "pkg-23.6.2_Forge_1.18.2" = _yFuICfIq;
        "pkg-23.6.2_Fabric_1.19.1" = _CHk4H0Bw;
        "pkg-23.6.2_Forge_1.19.1" = _EytiG0aH;
        "pkg-23.6.2_Fabric_1.19.3" = _nQa4eu8m;
        "pkg-23.6.2_Forge_1.19.3" = _yl9LzW11;
        "pkg-23.6.2_Fabric_1.19.4" = _QkupKzGm;
        "pkg-23.6.2_Forge_1.19.4" = _SsdxxNbE;
        "pkg-23.6.2_Fabric_1.20" = _c0ZBWCnU;
        "pkg-23.6.2_Forge_1.20" = _rn68Zxxt;
        "pkg-21.10.38_Forge_1.7.10" = _J4KB9Suy;
        "pkg-21.10.38_Forge_1.8.9" = _o9iEPpKI;
        "pkg-23.6.3_Forge_1.12" = _P2UKqqd2;
        "pkg-23.3.11_Forge_1.14.4" = _esECrPVt;
        "pkg-23.3.11_Forge_1.15.2" = _oRdEqadv;
        "pkg-23.6.3_Fabric_1.16.5" = _4cvJrYme;
        "pkg-23.6.3_Forge_1.16.5" = _yKrSoQTt;
        "pkg-23.6.3_Fabric_1.17.1" = _Ie68N63H;
        "pkg-23.6.3_Forge_1.17.1" = _gLEgj2uV;
        "pkg-23.6.3_Fabric_1.18.2" = _644M8I6I;
        "pkg-23.6.3_Forge_1.18.2" = _PPs1kSo7;
        "pkg-23.6.3_Fabric_1.19.1" = _Bt2DgBPL;
        "pkg-23.6.3_Forge_1.19.1" = _Z2BuSrd0;
        "pkg-23.6.3_Fabric_1.19.3" = _mvZkcCUb;
        "pkg-23.6.3_Forge_1.19.3" = _ueOtwpPw;
        "pkg-23.6.3_Fabric_1.19.4" = _lRxWUH4F;
        "pkg-23.6.3_Forge_1.19.4" = _dCIiF7eS;
        "pkg-23.6.3_Fabric_1.20" = _vm3OXacK;
        "pkg-23.6.3_Forge_1.20" = _x97XdhEs;
        "pkg-23.7.0_Forge_1.12" = _NGfHdh11;
        "pkg-23.7.0_Fabric_1.16.5" = _r0ifUzPT;
        "pkg-23.7.0_Forge_1.16.5" = _NTlgkgDO;
        "pkg-23.7.0_Fabric_1.17.1" = _qpZABZB9;
        "pkg-23.7.0_Forge_1.17.1" = _CrO6o2Gq;
        "pkg-23.7.0_Fabric_1.18.2" = _6nZxo7pH;
        "pkg-23.7.0_Forge_1.18.2" = _kZlaB1qq;
        "pkg-23.7.0_Fabric_1.19.1" = _Tp2vkR4G;
        "pkg-23.7.0_Forge_1.19.1" = _lpFAQyvg;
        "pkg-23.7.0_Fabric_1.19.3" = _hSI8GBsH;
        "pkg-23.7.0_Forge_1.19.3" = _hc8VPxDG;
        "pkg-23.7.0_Fabric_1.19.4" = _ydk6E03s;
        "pkg-23.7.0_Forge_1.19.4" = _u8l9S1fp;
        "pkg-23.7.0_Fabric_1.20" = _AmT4OYf4;
        "pkg-23.7.0_Forge_1.20" = _A7IHy1G0;
        "pkg-23.8.0_Forge_1.12" = _6ZIEdzSQ;
        "pkg-23.8.0_Forge_1.16.5" = _3hSJkWEr;
        "pkg-23.8.0_Fabric_1.16.5" = _7NZfxwRb;
        "pkg-23.8.0_Fabric_1.17.1" = _ezD5IzmS;
        "pkg-23.8.0_Forge_1.17.1" = _TF00occI;
        "pkg-23.8.0_Fabric_1.18.2" = _7mx0aK7e;
        "pkg-23.8.0_Forge_1.18.2" = _HEGX7Lg2;
        "pkg-23.8.0_Fabric_1.19.1" = _bSNv6PnW;
        "pkg-23.8.0_Forge_1.19.1" = _8P0dTQAF;
        "pkg-23.8.0_Fabric_1.19.3" = _smx9Eynx;
        "pkg-23.8.0_Forge_1.19.3" = _NeHIOK7r;
        "pkg-23.8.0_Fabric_1.19.4" = _VPlixW52;
        "pkg-23.8.0_Forge_1.19.4" = _uDyNs1Rr;
        "pkg-23.8.0_Fabric_1.20" = _VLWE8oE9;
        "pkg-23.8.0_Forge_1.20" = _S4W2r6uR;
        "pkg-23.8.1_Fabric_1.20" = _KINy3pYV;
        "pkg-23.8.1_Forge_1.20" = _3z7K7JQE;
        "pkg-23.8.1_Fabric_1.20.2" = _rtDIk66P;
        "pkg-23.8.2_Fabric_1.16.5" = _ILxXvII1;
        "pkg-23.8.2_Forge_1.16.5" = _DJ4hdETP;
        "pkg-23.8.2_Fabric_1.17.1" = _MVife7I0;
        "pkg-23.8.2_Forge_1.17.1" = _KIsPEFnz;
        "pkg-23.8.2_Fabric_1.18.2" = _wZnIKkhI;
        "pkg-23.8.2_Forge_1.18.2" = _ZNyDeTuJ;
        "pkg-23.8.2_Fabric_1.19.1" = _fN0KKPHy;
        "pkg-23.8.2_Forge_1.19.1" = _hcfNyGnJ;
        "pkg-23.8.2_Fabric_1.19.3" = _sxmTEQGI;
        "pkg-23.8.2_Forge_1.19.3" = _XVz9D1gr;
        "pkg-23.8.2_Fabric_1.19.4" = _ytsMBpyZ;
        "pkg-23.8.2_Forge_1.19.4" = _3HsB1GGt;
        "pkg-23.8.2_Fabric_1.20" = _iztrg4XH;
        "pkg-23.8.2_Forge_1.20" = _ULgQMMkf;
        "pkg-23.8.2_Fabric_1.20.2" = _7v8Wi6tb;
        "pkg-23.8.2_Forge_1.20.2" = _MWEMQfOX;
        "pkg-21.10.39_Forge_1.7.10" = _AVJcC2bL;
        "pkg-21.10.39_Forge_1.8.9" = _QrF8T5cQ;
        "pkg-23.8.3_Forge_1.12" = _nsKU3j5C;
        "pkg-23.3.12_Forge_1.14.4" = _cUKMHnBo;
        "pkg-23.3.12_Forge_1.15.2" = _esCEe3tL;
        "pkg-23.8.3_Forge_1.16.5" = _UbBxgVDj;
        "pkg-23.8.3_Fabric_1.16.5" = _o7s7vL8t;
        "pkg-23.8.3_Forge_1.17.1" = _WVRSa7j1;
        "pkg-23.8.3_Fabric_1.17.1" = _Szgz2P5P;
        "pkg-23.8.3_Forge_1.18.2" = _s9D0ddkM;
        "pkg-23.8.3_Fabric_1.18.2" = _NDhL08bf;
        "pkg-23.8.3_Forge_1.19.1" = _DZRJmAkj;
        "pkg-23.8.3_Fabric_1.19.1" = _QRPuTPr2;
        "pkg-23.8.3_Forge_1.19.3" = _uzFgjSf0;
        "pkg-23.8.3_Fabric_1.19.3" = _nIClWGv7;
        "pkg-23.8.3_Forge_1.19.4" = _5rdC6ZoX;
        "pkg-23.8.3_Fabric_1.19.4" = _P5sqtKJ1;
        "pkg-23.8.3_Forge_1.20" = _JVEQUwgq;
        "pkg-23.8.3_Fabric_1.20" = _WdswP5tt;
        "pkg-23.8.3_Forge_1.20.2" = _ZOXH5ibr;
        "pkg-23.8.3_Fabric_1.20.2" = _FQAIGl4y;
        "pkg-23.8.4_Forge_1.12" = _8pCH7zn4;
        "pkg-23.8.4_Forge_1.16.5" = _MhY87xwS;
        "pkg-23.8.4_Fabric_1.16.5" = _fTBtQrJL;
        "pkg-23.8.4_Forge_1.17.1" = _GuT4Xl1k;
        "pkg-23.8.4_Fabric_1.17.1" = _ERh1PYbl;
        "pkg-23.8.4_Forge_1.18.2" = _3fv1dVQx;
        "pkg-23.8.4_Fabric_1.18.2" = _xKJ0TybH;
        "pkg-23.8.4_Forge_1.19.1" = _Icr9Uso2;
        "pkg-23.8.4_Fabric_1.19.1" = _kjc0zgWU;
        "pkg-23.8.4_Forge_1.19.3" = _clNQKySD;
        "pkg-23.8.4_Fabric_1.19.3" = _uLqExVAM;
        "pkg-23.8.4_Forge_1.19.4" = _fKz7XN1r;
        "pkg-23.8.4_Fabric_1.19.4" = _RZ1qbd4C;
        "pkg-23.8.4_Forge_1.20" = _3kHivc7l;
        "pkg-23.8.4_Fabric_1.20" = _3l0ZI6yD;
        "pkg-23.8.4_Forge_1.20.2" = _2PhDVr0e;
        "pkg-23.8.4_Fabric_1.20.2" = _c30OIq97;
        "pkg-21.10.40_Forge_1.7.10" = _LvI0X86N;
        "pkg-21.10.40_Forge_1.8.9" = _CJ72pbRS;
        "pkg-23.9.0_Forge_1.12" = _fxo4zoHS;
        "pkg-23.3.13_Forge_1.14.4" = _eVPUDXdi;
        "pkg-23.3.13_Forge_1.15.2" = _hCSi4gjp;
        "pkg-23.9.0_Forge_1.16.5" = _cC6hpPL6;
        "pkg-23.9.0_Fabric_1.16.5" = _evziehFm;
        "pkg-23.9.0_Forge_1.17.1" = _1qgtbEJO;
        "pkg-23.9.0_Fabric_1.17.1" = _yfdwFDVK;
        "pkg-23.9.0_Forge_1.18.2" = _FOH92M4F;
        "pkg-23.9.0_Fabric_1.18.2" = _MyHLjsuc;
        "pkg-23.9.0_Forge_1.19.1" = _9AC4TDHp;
        "pkg-23.9.0_Fabric_1.19.1" = _CJuCOwm3;
        "pkg-23.9.0_Forge_1.19.3" = _kbOfhmEZ;
        "pkg-23.9.0_Fabric_1.19.3" = _pLsaj6mq;
        "pkg-23.9.0_Forge_1.19.4" = _5VUm1m7Z;
        "pkg-23.9.0_Fabric_1.19.4" = _yTnUZnVR;
        "pkg-23.9.0_Forge_1.20" = _ZxOS5iG1;
        "pkg-23.9.0_Fabric_1.20" = _MmSg9jMk;
        "pkg-23.9.0_Forge_1.20.2" = _Gw4WZ925;
        "pkg-23.9.0_Fabric_1.20.2" = _XxkAfYob;
        "pkg-23.9.1_Forge_1.12" = _a8Yq1Qug;
        "pkg-23.9.1_Forge_1.16.5" = _CqPkya2x;
        "pkg-23.9.1_Fabric_1.16.5" = _cLnTLfUI;
        "pkg-23.9.1_Forge_1.17.1" = _wNvez3V6;
        "pkg-23.9.1_Fabric_1.17.1" = _2z34HtcM;
        "pkg-23.9.1_Forge_1.18.2" = _YAHcKp6Q;
        "pkg-23.9.1_Fabric_1.18.2" = _JaqM6Gvz;
        "pkg-23.9.1_Forge_1.19.1" = _nZqZ0aCE;
        "pkg-23.9.1_Fabric_1.19.1" = _Uzhe96qB;
        "pkg-23.9.1_Forge_1.19.3" = _9CiT3jAu;
        "pkg-23.9.1_Fabric_1.19.3" = _L66gdxl9;
        "pkg-23.9.1_Forge_1.19.4" = _ZlHF5Qac;
        "pkg-23.9.1_Fabric_1.19.4" = _U68R0rFS;
        "pkg-23.9.1_Forge_1.20" = _fppiXBZ2;
        "pkg-23.9.1_Fabric_1.20" = _xFUEtVth;
        "pkg-23.9.1_Forge_1.20.2" = _SBQ262QA;
        "pkg-23.9.1_Fabric_1.20.2" = _UdrmzjRD;
        "pkg-23.9.1_Fabric_1.20.3" = _YBgP6QdM;
        "pkg-23.9.2_Forge_1.19.1" = _iuJPe4ni;
        "pkg-23.9.2_Fabric_1.19.1" = _m350JutC;
        "pkg-23.9.2_Forge_1.19.3" = _MGpPp9kH;
        "pkg-23.9.2_Fabric_1.19.3" = _S5ek5ggz;
        "pkg-23.9.2_Forge_1.19.4" = _KPtgbRwi;
        "pkg-23.9.2_Fabric_1.19.4" = _TxAPiOgr;
        "pkg-23.9.2_Forge_1.20" = _Rn67Fnw2;
        "pkg-23.9.2_Fabric_1.20" = _fo6Bqntn;
        "pkg-23.9.2_Forge_1.20.2" = _lnnUcQiF;
        "pkg-23.9.2_Fabric_1.20.2" = _W5b2EPKb;
        "pkg-23.9.2_Fabric_1.20.3" = _Zp26yPOc;
        "pkg-23.9.3_Forge_1.16.5" = _ZGaMVApJ;
        "pkg-23.9.3_Fabric_1.16.5" = _WC4MSxy8;
        "pkg-23.9.3_Forge_1.17.1" = _bNmU7aeV;
        "pkg-23.9.3_Fabric_1.17.1" = _2du1bm0c;
        "pkg-23.9.3_Forge_1.18.2" = _gyxRW7KS;
        "pkg-23.9.3_Fabric_1.18.2" = _Nt0HqWYv;
        "pkg-23.9.3_Forge_1.19.1" = _CfDmt6eX;
        "pkg-23.9.3_Fabric_1.19.1" = _e5VWn5iQ;
        "pkg-23.9.3_Forge_1.19.3" = _iHZmaGst;
        "pkg-23.9.3_Fabric_1.19.3" = _I0FJpqoN;
        "pkg-23.9.3_Forge_1.19.4" = _NswKWD6B;
        "pkg-23.9.3_Fabric_1.19.4" = _zgNWv1OW;
        "pkg-23.9.3_Forge_1.20" = _gHdFelqh;
        "pkg-23.9.3_Fabric_1.20" = _KSDcShTK;
        "pkg-23.9.3_Forge_1.20.2" = _2xJx9zro;
        "pkg-23.9.3_Fabric_1.20.2" = _S0r8i1Ol;
        "pkg-23.9.3_Fabric_1.20.3" = _lmSSKSg8;
        "pkg-23.9.4_Forge_1.16.5" = _305nWW56;
        "pkg-23.9.4_Fabric_1.16.5" = _fRg7YyPu;
        "pkg-23.9.4_Forge_1.17.1" = _xAyz6xnV;
        "pkg-23.9.4_Fabric_1.17.1" = _2xUOEAxL;
        "pkg-23.9.4_Forge_1.20.4" = _2g3xC5Yk;
        "pkg-23.9.4_Fabric_1.20.4" = _aeLjQWMH;
        "pkg-23.9.5_Forge_1.20.4" = _MxA7DpAu;
        "pkg-23.9.5_Fabric_1.20.4" = _SoNCC1sA;
        "pkg-23.9.6_Forge_1.20.4" = _A0qsMhQD;
        "pkg-23.9.6_Fabric_1.20.4" = _PfhJ0nzQ;
        "pkg-21.10.41_Forge_1.7.10" = _cx33FoE0;
        "pkg-21.10.41_Forge_1.8.9" = _ajhC0UFK;
        "pkg-23.9.7_Forge_1.12" = _Nvg8NDSW;
        "pkg-23.3.14_Forge_1.14.4" = _6xOEvCyC;
        "pkg-23.3.14_Forge_1.15.2" = _UaLwjU5j;
        "pkg-23.9.7_Forge_1.16.5" = _OA7E6a9p;
        "pkg-23.9.7_Fabric_1.16.5" = _KlbD3D3B;
        "pkg-23.9.7_Forge_1.17.1" = _yqp93Q5R;
        "pkg-23.9.7_Fabric_1.17.1" = _VuH8AYM3;
        "pkg-23.9.7_Forge_1.18.2" = _NlaKBveu;
        "pkg-23.9.7_Fabric_1.18.2" = _CWHPcpYC;
        "pkg-23.9.7_Forge_1.19.1" = _4GQMv7sQ;
        "pkg-23.9.7_Fabric_1.19.1" = _dMqrko5J;
        "pkg-23.9.7_Forge_1.20" = _osXhdua5;
        "pkg-23.9.7_Fabric_1.20" = _rbY8QUIj;
        "pkg-23.9.7_Forge_1.20.2" = _UduGhgss;
        "pkg-23.9.7_Fabric_1.20.2" = _4hUSZ0XT;
        "pkg-23.9.7_Forge_1.20.4" = _TdsFTQCP;
        "pkg-23.9.7_Fabric_1.20.4" = _LLE04weG;
        "pkg-24.0.0_NeoForge_1.20.2" = _wyaDomyx;
        "pkg-24.0.0_NeoForge_1.20.4" = _grUAeQmH;
        "pkg-24.0.1_Forge_1.12" = _rrL6at63;
        "pkg-24.0.1_Forge_1.16.5" = _4BLJQ8Cw;
        "pkg-24.0.1_Fabric_1.16.5" = _F0QClxK7;
        "pkg-24.0.1_Forge_1.18.2" = _vMQZ4GyL;
        "pkg-24.0.1_Forge_1.19.1" = _CbKSFbgX;
        "pkg-24.0.1_Forge_1.19.4" = _8Upb0VqF;
        "pkg-24.0.1_Forge_1.20" = _9qSU7GXL;
        "pkg-24.0.1_Forge_1.20.2" = _tqZP0sAt;
        "pkg-24.0.1_NeoForge_1.20.2" = _cgS07Jhf;
        "pkg-24.0.1_Forge_1.20.4" = _6vRoV7rt;
        "pkg-24.0.1_NeoForge_1.20.4" = _AGBnAu6b;
        "pkg-24.0.0_Fabric_1.20.4" = _qwbkbzoh;
        "pkg-24.0.1_Fabric_1.18.2" = _XNk8u9Xv;
        "pkg-24.0.1_Fabric_1.19.1" = _6nrVJMjJ;
        "pkg-24.0.1_Fabric_1.19.4" = _DZKCme41;
        "pkg-24.0.1_Fabric_1.20" = _VkhLOjfb;
        "pkg-24.0.1_Fabric_1.20.2" = _hnrAEMVF;
        "pkg-24.0.1_Fabric_1.20.4" = _2sFvKLMq;
        "pkg-24.0.2_Fabric_1.16.5" = _HR0G2gSQ;
        "pkg-24.0.2_Fabric_1.18.2" = _6phDIoxa;
        "pkg-24.0.2_Fabric_1.19.1" = _xgO8iEoo;
        "pkg-24.0.2_Fabric_1.19.4" = _rnKIUx0M;
        "pkg-24.0.2_Fabric_1.20" = _W0vNiSUN;
        "pkg-24.0.2_Fabric_1.20.2" = _hLzKOgZG;
        "pkg-24.0.2_Fabric_1.20.4" = _Gwys2mC6;
        "pkg-24.0.3_Forge_1.18.2" = _KxhgYv70;
        "pkg-24.0.3_Fabric_1.18.2" = _P0Lox3gc;
        "pkg-24.0.3_Forge_1.19.1" = _uYw01UUg;
        "pkg-24.0.3_Fabric_1.19.1" = _TgVPhHX1;
        "pkg-24.0.3_Forge_1.19.4" = _XGqIm613;
        "pkg-24.0.3_Fabric_1.19.4" = _pnRuTtkM;
        "pkg-24.0.3_Forge_1.20" = _voIrfIDP;
        "pkg-24.0.3_Fabric_1.20" = _wzrBVYUb;
        "pkg-24.0.3_Forge_1.20.2" = _cFc2AoCv;
        "pkg-24.0.3_NeoForge_1.20.2" = _ydJkpNr9;
        "pkg-24.0.3_Fabric_1.20.2" = _ESCev80x;
        "pkg-24.0.3_Forge_1.20.4" = _tEO0i9AC;
        "pkg-24.0.3_NeoForge_1.20.4" = _I8PESUAB;
        "pkg-24.0.3_Fabric_1.20.4" = _N5jBKzC0;
        "pkg-24.1.0_Forge_1.12" = _ERJt9Vyj;
        "pkg-24.1.0_Forge_1.16.5" = _o5yk7ekg;
        "pkg-24.1.0_Fabric_1.16.5" = _RF88GIOq;
        "pkg-24.1.0_Forge_1.18.2" = _I2SqxBuz;
        "pkg-24.1.0_Fabric_1.18.2" = _yvQWOsPM;
        "pkg-24.1.0_Forge_1.19.1" = _pdo3FqBZ;
        "pkg-24.1.0_Fabric_1.19.1" = _oYc9KpLE;
        "pkg-24.1.0_Forge_1.19.4" = _RRQpdsRM;
        "pkg-24.1.0_Fabric_1.19.4" = _O0Nj9jLg;
        "pkg-24.1.0_Forge_1.20" = _GYaaSuBx;
        "pkg-24.1.0_Fabric_1.20" = _6kK8jWA8;
        "pkg-24.1.0_Forge_1.20.2" = _ltsi0X3A;
        "pkg-24.1.0_Fabric_1.20.2" = _W4cxDNb2;
        "pkg-24.1.0_NeoForge_1.20.2" = _uDqhLKbH;
        "pkg-24.1.0_Forge_1.20.4" = _RXKv1vKp;
        "pkg-24.1.0_NeoForge_1.20.4" = _RNq1NrjQ;
        "pkg-24.1.0_Fabric_1.20.4" = _gtz0RXPQ;
        "pkg-24.1.1_Forge_1.12" = _pzvtRv7A;
        "pkg-24.1.1_Forge_1.16.5" = _ys8sIlN4;
        "pkg-24.1.1_Fabric_1.16.5" = _j59kRx58;
        "pkg-24.1.1_Forge_1.18.2" = _Cl6CKBcF;
        "pkg-24.1.1_Fabric_1.18.2" = _NNLpWIl6;
        "pkg-24.1.1_Forge_1.19.1" = _n2MgcQOn;
        "pkg-24.1.1_Fabric_1.19.1" = _sPZxEpDf;
        "pkg-24.1.1_Forge_1.19.4" = _6dJeamaz;
        "pkg-24.1.1_Fabric_1.19.4" = _SQZr10BS;
        "pkg-24.1.1_Forge_1.20" = _dxsBIRkW;
        "pkg-24.1.1_Fabric_1.20" = _C2jbx7JG;
        "pkg-24.1.1_Forge_1.20.2" = _encv7xNt;
        "pkg-24.1.1_NeoForge_1.20.2" = _oCrCco57;
        "pkg-24.1.1_Fabric_1.20.2" = _8xtEYb9r;
        "pkg-24.1.1_Forge_1.20.4" = _Hh9qQAAt;
        "pkg-24.1.1_NeoForge_1.20.4" = _9SZyYgeA;
        "pkg-24.1.1_Fabric_1.20.4" = _a1aPoO3W;
        "pkg-24.1.2_NeoForge_1.20.5" = _AE2guKuD;
        "pkg-24.1.2_Fabric_1.20.5" = _H5U9OIBR;
        "pkg-24.1.3_NeoForge_1.20.5" = _grjC2cUV;
        "pkg-24.1.3_Fabric_1.20.5" = _YtAGhx5I;
        "pkg-24.1.4_Forge_1.20.6" = _EmtRNLL4;
        "pkg-24.1.4_Fabric_1.20.6" = _3nguWW3k;
        "pkg-24.1.4_NeoForge_1.20.6" = _4B2YTORj;
        "pkg-24.2.0_Forge_1.12" = _quthv9KV;
        "pkg-24.2.0_Forge_1.16.5" = _CXxfovCE;
        "pkg-24.2.0_Fabric_1.16.5" = _AZoazJZ9;
        "pkg-24.2.0_Forge_1.18.2" = _RQjoN86f;
        "pkg-24.2.0_Fabric_1.18.2" = _terogn4c;
        "pkg-24.2.0_Forge_1.19.1" = _5b9ZhxJB;
        "pkg-24.2.0_Fabric_1.19.1" = _73eENOzt;
        "pkg-24.2.0_Forge_1.19.4" = _Sc6Vb5o3;
        "pkg-24.2.0_Fabric_1.19.4" = _LsUG4Ee3;
        "pkg-24.2.0_Forge_1.20" = _zst4834Y;
        "pkg-24.2.0_Fabric_1.20" = _WQEX096d;
        "pkg-24.2.0_Forge_1.20.2" = _vGHr0KR9;
        "pkg-24.2.0_NeoForge_1.20.2" = _BSzbgv5g;
        "pkg-24.2.0_Fabric_1.20.2" = _1PbPiCss;
        "pkg-24.2.0_Forge_1.20.4" = _IDSgysLe;
        "pkg-24.2.0_NeoForge_1.20.4" = _HQSFfCfA;
        "pkg-24.2.0_Fabric_1.20.4" = _ebLQ6HBv;
        "pkg-24.2.0_Forge_1.20.6" = _e1SKPr5a;
        "pkg-24.2.0_NeoForge_1.20.6" = _lygDaDx8;
        "pkg-24.2.0_Fabric_1.20.6" = _pfjda4sr;
        "pkg-24.2.1_Forge_1.16.5" = _z3OgNpRJ;
        "pkg-24.2.1_Forge_1.21" = _qcuUYSKu;
        "pkg-24.2.1_NeoForge_1.21" = _cDXVTAcY;
        "pkg-24.2.1_Fabric_1.21" = _enRPivaa;
        "pkg-24.2.2_NeoForge_1.21" = _LF6xSpse;
        "pkg-21.10.42_Forge_1.7.10" = _Pn08OjqA;
        "pkg-24.3.0_Forge_1.12" = _9Vq5g0vG;
        "pkg-24.3.0_Forge_1.16.5" = _lT6QMy80;
        "pkg-24.3.0_Fabric_1.16.5" = _oYT7DtW9;
        "pkg-24.3.0_Forge_1.18.2" = _CD86N4Hl;
        "pkg-24.3.0_Fabric_1.18.2" = _X0z2Z7bS;
        "pkg-24.3.0_Forge_1.19.1" = _pyBg1lK8;
        "pkg-24.3.0_Fabric_1.19.1" = _phc7vSzw;
        "pkg-24.3.0_Forge_1.19.4" = _wbxVWyKh;
        "pkg-24.3.0_Fabric_1.19.4" = _Si92LGwO;
        "pkg-24.3.0_Forge_1.20" = _K1SUEjn1;
        "pkg-24.3.0_Fabric_1.20" = _JbZC5U0M;
        "pkg-24.3.0_Forge_1.20.2" = _wYhEe9zX;
        "pkg-24.3.0_NeoForge_1.20.2" = _CvVSmY7s;
        "pkg-24.3.0_Fabric_1.20.2" = _9SrWjE4U;
        "pkg-24.3.0_Forge_1.20.4" = _qSDCOk0h;
        "pkg-24.3.0_NeoForge_1.20.4" = _WcoTEWrk;
        "pkg-24.3.0_Fabric_1.20.4" = _l1hUo07J;
        "pkg-24.3.0_Forge_1.20.6" = _IGvEsMDu;
        "pkg-24.3.0_NeoForge_1.20.6" = _lJKT1YPP;
        "pkg-24.3.0_Fabric_1.20.6" = _KHdIy8SA;
        "pkg-24.3.0_Forge_1.21" = _o4vtqX1N;
        "pkg-24.3.0_NeoForge_1.21" = _N1CeJanx;
        "pkg-24.3.0_Fabric_1.21" = _X2u4L3vW;
        "pkg-24.4.0_Forge_1.12" = _2YPdH6tF;
        "pkg-24.4.0_Forge_1.16.5" = _rBMvNMgt;
        "pkg-24.4.0_Fabric_1.16.5" = _SQFhAYBG;
        "pkg-24.4.0_Forge_1.18.2" = _uLx1pQ1n;
        "pkg-24.4.0_Fabric_1.18.2" = _47WqIkSb;
        "pkg-24.4.0_Forge_1.19.1" = _EPlvSOK2;
        "pkg-24.4.0_Fabric_1.19.1" = _hudAelfB;
        "pkg-24.4.0_Forge_1.19.4" = _V2EIrih5;
        "pkg-24.4.0_Fabric_1.19.4" = _L61GnThq;
        "pkg-24.4.0_Forge_1.20" = _dvP335Jb;
        "pkg-24.4.0_Fabric_1.20" = _2ZxbhVIC;
        "pkg-24.4.0_Forge_1.20.2" = _hlM48nut;
        "pkg-24.4.0_NeoForge_1.20.2" = _Zi8hFKLH;
        "pkg-24.4.0_Fabric_1.20.2" = _e0XCxUPE;
        "pkg-24.4.0_Forge_1.20.4" = _vAquXdvj;
        "pkg-24.4.0_NeoForge_1.20.4" = _VcfSPmn6;
        "pkg-24.4.0_Fabric_1.20.4" = _6s49UWda;
        "pkg-24.4.0_Forge_1.20.6" = _O9itTBNw;
        "pkg-24.4.0_NeoForge_1.20.6" = _apWVMSBa;
        "pkg-24.4.0_Fabric_1.20.6" = _LKI7nxyO;
        "pkg-24.4.0_Forge_1.21" = _aVT9ELGL;
        "pkg-24.4.0_NeoForge_1.21" = _93XFg5yC;
        "pkg-24.4.0_Fabric_1.21" = _3rShEpTe;
        "pkg-24.4.1_Forge_1.12" = _qfyzTBae;
        "pkg-21.10.43_Forge_1.7.10" = _lQFvXgUu;
        "pkg-24.5.0_Forge_1.12" = _hLiUMNlU;
        "pkg-24.5.0_Forge_1.16.5" = _KDmeZR3Y;
        "pkg-24.5.0_Fabric_1.16.5" = _JlXIcjEz;
        "pkg-24.5.0_Forge_1.18.2" = _EgJ3lWTi;
        "pkg-24.5.0_Fabric_1.18.2" = _YTOu6gdF;
        "pkg-24.5.0_Forge_1.19.1" = _xUDlN5ho;
        "pkg-24.5.0_Fabric_1.19.1" = _dkt5yvMv;
        "pkg-24.5.0_Forge_1.19.4" = _teDo4NZm;
        "pkg-24.5.0_Fabric_1.19.4" = _bXnTtpms;
        "pkg-24.5.0_Forge_1.20" = _R5ch4BWG;
        "pkg-24.5.0_Fabric_1.20" = _Ap78IE0v;
        "pkg-24.5.0_Forge_1.20.2" = _40xB36ws;
        "pkg-24.5.0_NeoForge_1.20.2" = _DSPZ41cz;
        "pkg-24.5.0_Fabric_1.20.2" = _goETvPX1;
        "pkg-24.5.0_Forge_1.20.4" = _Vh8qzfv2;
        "pkg-24.5.0_NeoForge_1.20.4" = _VCOHG33u;
        "pkg-24.5.0_Fabric_1.20.4" = _sla4rYz7;
        "pkg-24.5.0_Forge_1.20.6" = _jB2jUGPb;
        "pkg-24.5.0_NeoForge_1.20.6" = _iTdWIaKv;
        "pkg-24.5.0_Fabric_1.20.6" = _TArjPfg7;
        "pkg-24.5.0_Forge_1.21" = _TihFAuhc;
        "pkg-24.5.0_NeoForge_1.21" = _LI24TIad;
        "pkg-24.5.0_Fabric_1.21" = _ronrQ1g2;
        "pkg-24.5.1_Forge_1.18.2" = _DcFi3IUa;
        "pkg-24.5.1_Fabric_1.18.2" = _ZAcLKIAX;
        "pkg-24.6.1_Forge_1.12" = _R95L0YWe;
        "pkg-24.6.1_Forge_1.16.5" = _uDQ1QOPA;
        "pkg-24.6.1_Fabric_1.16.5" = _O9t3Scfw;
        "pkg-24.6.1_Forge_1.18.2" = _1i56Grru;
        "pkg-24.6.1_Fabric_1.18.2" = _xA2vPHvn;
        "pkg-24.6.1_Forge_1.19.1" = _wodQhgoD;
        "pkg-24.6.1_Fabric_1.19.1" = _iM75NCJr;
        "pkg-24.6.1_Forge_1.19.4" = _m5dV8fLV;
        "pkg-24.6.1_Fabric_1.19.4" = _taL20JAk;
        "pkg-24.6.1_Forge_1.20" = _C3YstOIl;
        "pkg-24.6.1_Fabric_1.20" = _jouP2Oob;
        "pkg-24.6.1_Forge_1.20.2" = _PrEaSLkN;
        "pkg-24.6.1_NeoForge_1.20.2" = _uLpPq8Vj;
        "pkg-24.6.1_Fabric_1.20.2" = _QwAgbWQ2;
        "pkg-24.6.1_Forge_1.20.4" = _kwRhaHB0;
        "pkg-24.6.1_NeoForge_1.20.4" = _EBFUDAU2;
        "pkg-24.6.1_Fabric_1.20.4" = _Z8KAWFKG;
        "pkg-24.6.1_Forge_1.20.6" = _2haKVEdn;
        "pkg-24.6.1_NeoForge_1.20.6" = _N92PE3ae;
        "pkg-24.6.1_Fabric_1.20.6" = _K8IXFPsM;
        "pkg-24.6.1_Forge_1.21" = _GbcwZsl7;
        "pkg-24.6.1_NeoForge_1.21" = _C6O2bJXs;
        "pkg-24.6.1_Fabric_1.21" = _C6gFqr7V;
        "pkg-24.6.2_Forge_1.21.3" = _BnUZUpr5;
        "pkg-24.6.2_NeoForge_1.21.3" = _kgWKDrqS;
        "pkg-24.6.2_Fabric_1.21.3" = _Xin6IcCV;
        "pkg-24.6.2_NeoForge_1.21.4" = _sCTl8qju;
        "pkg-24.6.2_Fabric_1.21.4" = _cHos0KJK;
        "pkg-24.6.2_Forge_1.21.4" = _hOcBhs2Q;
        "pkg-21.10.44_Forge_1.7.10" = _EeB36MIM;
        "pkg-24.7.1_Forge_1.12" = _7vjZ15jK;
        "pkg-24.7.1_Forge_1.16.5" = _fbM7j0hs;
        "pkg-24.7.1_Fabric_1.16.5" = _ER7RBTv7;
        "pkg-24.7.1_Forge_1.18.2" = _tlfwLCW4;
        "pkg-24.7.1_Fabric_1.18.2" = _7PxnMiG1;
        "pkg-24.7.1_Forge_1.19.1" = _OZycn2OQ;
        "pkg-24.7.1_Fabric_1.19.1" = _dfDVpOfV;
        "pkg-24.7.1_Forge_1.19.4" = _5J2rfKP4;
        "pkg-24.7.1_Fabric_1.19.4" = _DXh0pVpv;
        "pkg-24.7.1_Forge_1.20" = _sr50tbXn;
        "pkg-24.7.1_Fabric_1.20" = _UsAehJcE;
        "pkg-24.7.1_Forge_1.20.2" = _9zi8m8fA;
        "pkg-24.7.1_NeoForge_1.20.2" = _MXKIEm4R;
        "pkg-24.7.1_Fabric_1.20.2" = _bWNaUysm;
        "pkg-24.7.1_Forge_1.20.4" = _BvVkZUZw;
        "pkg-24.7.1_NeoForge_1.20.4" = _vqk0i7Gz;
        "pkg-24.7.1_Fabric_1.20.4" = _r6BqELKT;
        "pkg-24.7.1_Forge_1.20.6" = _uqCdXuoK;
        "pkg-24.7.1_NeoForge_1.20.6" = _r5Wgr24m;
        "pkg-24.7.1_Fabric_1.20.6" = _Ry1kZJKU;
        "pkg-24.7.1_Forge_1.21" = _xPwk8hFl;
        "pkg-24.7.1_NeoForge_1.21" = _JWwiRAqV;
        "pkg-24.7.1_Fabric_1.21" = _Hyd81hdy;
        "pkg-24.7.1_Forge_1.21.3" = _85iRO79d;
        "pkg-24.7.1_NeoForge_1.21.3" = _ayrOok7W;
        "pkg-24.7.1_Fabric_1.21.3" = _YMViFM5s;
        "pkg-24.7.1_Forge_1.21.4" = _kEtmBSdW;
        "pkg-24.7.1_NeoForge_1.21.4" = _VZwQPuYH;
        "pkg-24.7.1_Fabric_1.21.4" = _pGS4L9Gk;
        "pkg-25.0.0_Forge_1.12" = _j3o4UMaI;
        "pkg-25.0.0_Forge_1.16.5" = _ljb4RG1n;
        "pkg-25.0.0_Fabric_1.16.5" = _vYFnnjDf;
        "pkg-25.0.0_Forge_1.18.2" = _ifROEiio;
        "pkg-25.0.0_Fabric_1.18.2" = _VppnHG8M;
        "pkg-25.0.0_Forge_1.19.1" = _RZPaaHUs;
        "pkg-25.0.0_Fabric_1.19.1" = _sWUuDOmD;
        "pkg-25.0.0_Forge_1.19.4" = _9jRzG920;
        "pkg-25.0.0_Fabric_1.19.4" = _gkoEVKNy;
        "pkg-25.0.0_Forge_1.20" = _c3BiB41R;
        "pkg-25.0.0_Fabric_1.20" = _FjbEr0Vb;
        "pkg-25.0.0_Forge_1.20.2" = _w37gO1GV;
        "pkg-25.0.0_NeoForge_1.20.2" = _dg93aufV;
        "pkg-25.0.0_Fabric_1.20.2" = _zqEvVKXB;
        "pkg-25.0.0_Forge_1.20.4" = _UvUd9dk1;
        "pkg-25.0.0_NeoForge_1.20.4" = _62yHOPkp;
        "pkg-25.0.0_Fabric_1.20.4" = _X8nnub63;
        "pkg-25.0.0_Forge_1.20.6" = _bIk4iobN;
        "pkg-25.0.0_NeoForge_1.20.6" = _z0CsLbof;
        "pkg-25.0.0_Fabric_1.20.6" = _2Sgv2ppA;
        "pkg-25.0.0_Forge_1.21" = _80TYfBoi;
        "pkg-25.0.0_NeoForge_1.21" = _lXE3GSmk;
        "pkg-25.0.0_Fabric_1.21" = _OlQ3SNJL;
        "pkg-25.0.0_Forge_1.21.3" = _lECzKOxx;
        "pkg-25.0.0_NeoForge_1.21.3" = _Zw1sYts8;
        "pkg-25.0.0_Fabric_1.21.3" = _qbUCsgtx;
        "pkg-25.0.0_Forge_1.21.4" = _y3QYkRHI;
        "pkg-25.0.0_NeoForge_1.21.4" = _uyw0mhCj;
        "pkg-25.0.0_Fabric_1.21.4" = _C0M9nBPn;
        "pkg-25.0.1_Forge_1.21.4" = _BYuCZQjS;
        "pkg-25.0.1_NeoForge_1.21.4" = _l6MJjaI3;
        "pkg-25.0.1_Fabric_1.21.4" = _uSoyLnlq;
        "pkg-25.1.0_Forge_1.12" = _fSSROMkn;
        "pkg-25.1.0_Forge_1.16.5" = _GwPdVBkZ;
        "pkg-25.1.0_Fabric_1.16.5" = _3LsUfZfl;
        "pkg-25.1.0_Forge_1.18.2" = _VGNp491t;
        "pkg-25.1.0_Fabric_1.18.2" = _ERa2mzLF;
        "pkg-25.1.0_Forge_1.19.1" = _X8xdYaee;
        "pkg-25.1.0_Fabric_1.19.1" = _LB7pz2Vh;
        "pkg-25.1.0_Forge_1.20" = _lzOsKpew;
        "pkg-25.1.0_Fabric_1.20" = _sDUGXv1w;
        "pkg-25.1.0_Forge_1.20.2" = _vmDgMVyb;
        "pkg-25.1.0_NeoForge_1.20.2" = _XxumVxmL;
        "pkg-25.1.0_Fabric_1.20.2" = _vzxE0X0L;
        "pkg-25.1.0_Forge_1.20.4" = _hRQr8dyS;
        "pkg-25.1.0_NeoForge_1.20.4" = _dWYcnjKk;
        "pkg-25.1.0_Fabric_1.20.4" = _kh4kRMCh;
        "pkg-25.1.0_Forge_1.20.6" = _pj2lD7Wc;
        "pkg-25.1.0_NeoForge_1.20.6" = _6LYiZ9Uy;
        "pkg-25.1.0_Fabric_1.20.6" = _BgSo8Nzu;
        "pkg-25.1.0_Forge_1.21" = _fs15o9N9;
        "pkg-25.1.0_NeoForge_1.21" = _Cnb0U7h3;
        "pkg-25.1.0_Fabric_1.21" = _2Go558kv;
        "pkg-25.1.0_Forge_1.21.3" = _eQyM05We;
        "pkg-25.1.0_NeoForge_1.21.3" = _ADp3oSKf;
        "pkg-25.1.0_Fabric_1.21.3" = _yIxg4FxZ;
        "pkg-25.1.0_Forge_1.21.4" = _AEAW5qGr;
        "pkg-25.1.0_NeoForge_1.21.4" = _iEBxNrOD;
        "pkg-25.1.0_Fabric_1.21.4" = _8JzrUlHh;
        "pkg-25.2.0_Fabric_1.16.5" = _dVrBtIff;
        "pkg-25.2.0_Forge_1.18.2" = _LYDApssH;
        "pkg-25.2.0_Fabric_1.18.2" = _zXJzpC68;
        "pkg-25.2.0_Forge_1.19.1" = _UsDgKxc2;
        "pkg-25.2.0_Fabric_1.19.1" = _VwnVfthn;
        "pkg-25.2.0_Forge_1.19.4" = _zfP4Fwh5;
        "pkg-25.2.0_Fabric_1.19.4" = _FAzQp3Fd;
        "pkg-25.2.0_Forge_1.20" = _uhCZlwOM;
        "pkg-25.2.0_Fabric_1.20" = _AoeGnA9Z;
        "pkg-25.2.0_Forge_1.20.2" = _5yFRcnp4;
        "pkg-25.2.0_NeoForge_1.20.2" = _S3AAldzx;
        "pkg-25.2.0_Fabric_1.20.2" = _q3RWq4Qe;
        "pkg-25.2.0_Forge_1.20.4" = _w9kNV6Gw;
        "pkg-25.2.0_NeoForge_1.20.4" = _bLAN6PW8;
        "pkg-25.2.0_Fabric_1.20.4" = _jRO3YUbh;
        "pkg-25.2.0_Forge_1.20.6" = _npXZqLZf;
        "pkg-25.2.0_NeoForge_1.20.6" = _dJpSPghK;
        "pkg-25.2.0_Fabric_1.20.6" = _1uyLHTGv;
        "pkg-25.2.0_Forge_1.21" = _NjMveGUo;
        "pkg-25.2.0_NeoForge_1.21" = _DHYXuO0J;
        "pkg-25.2.0_Fabric_1.21" = _tYp62ZlC;
        "pkg-25.2.0_Forge_1.21.3" = _7OOMQnPW;
        "pkg-25.2.0_NeoForge_1.21.3" = _GM2FjkGw;
        "pkg-25.2.0_Fabric_1.21.3" = _PcbSja7b;
        "pkg-25.2.0_Forge_1.21.4" = _UEoKveA4;
        "pkg-25.2.0_NeoForge_1.21.4" = _se44ujZ0;
        "pkg-25.2.0_Fabric_1.21.4" = _tYtr1STe;
        "pkg-25.2.0_Forge_1.12" = _ZPCinVG8;
        "pkg-25.2.0_Forge_1.16.5" = _oNT3gcym;
        "pkg-25.2.0_Forge_1.21.5" = _O0Trg0tM;
        "pkg-25.2.0_NeoForge_1.21.5" = _7w1tz20X;
        "pkg-25.2.0_Fabric_1.21.5" = _UV9Vstfl;
        "pkg-25.2.2_Forge_1.21.5" = _xUPEZ4bs;
        "pkg-25.2.2_NeoForge_1.21.5" = _5AJbyEmH;
        "pkg-25.2.2_Fabric_1.21.5" = _GubK4q6Y;
        "pkg-25.2.3_Forge_1.21.5" = _1TXCTS2e;
        "pkg-25.2.3_NeoForge_1.21.5" = _SMFMUbsU;
        "pkg-25.2.3_Fabric_1.21.5" = _DMGP3mY2;
        "pkg-25.2.4_Forge_1.21.5" = _YG4GcIrU;
        "pkg-25.2.4_NeoForge_1.21.5" = _ZOgamZhn;
        "pkg-25.2.4_Fabric_1.21.5" = _taxQZJep;
        "pkg-25.2.5_Forge_1.21.5" = _y8aSrUox;
        "pkg-25.2.5_NeoForge_1.21.5" = _BthXcnbB;
        "pkg-25.2.5_Fabric_1.21.5" = _U2IMRhfP;
        "pkg-25.2.6_Forge_1.12" = _MMEY7C23;
        "pkg-25.2.6_Forge_1.16.5" = _dmEqrBOn;
        "pkg-25.2.6_Fabric_1.16.5" = _2gaNIrFs;
        "pkg-25.2.6_Forge_1.18.2" = _zDowGauw;
        "pkg-25.2.6_Fabric_1.18.2" = _o9wiELUL;
        "pkg-25.2.6_Forge_1.19.1" = _rCBwdCZO;
        "pkg-25.2.6_Fabric_1.19.1" = _WLng5j2e;
        "pkg-25.2.6_Forge_1.19.4" = _MGMYjRZx;
        "pkg-25.2.6_Fabric_1.19.4" = _Kn14AOPD;
        "pkg-25.2.6_Forge_1.20" = _k73HMiDN;
        "pkg-25.2.6_Fabric_1.20" = _ePRxT2Wj;
        "pkg-25.2.6_Forge_1.20.2" = _f6wokhke;
        "pkg-25.2.6_NeoForge_1.20.2" = _olFHgSZN;
        "pkg-25.2.6_Fabric_1.20.2" = _ULRv2ifJ;
        "pkg-25.2.6_Forge_1.20.4" = _f9Gag7sO;
        "pkg-25.2.6_NeoForge_1.20.4" = _HFXOaUFZ;
        "pkg-25.2.6_Fabric_1.20.4" = _Lk8ea6Kk;
        "pkg-25.2.6_Forge_1.20.6" = _YJH2hldL;
        "pkg-25.2.6_NeoForge_1.20.6" = _MPaB4CXr;
        "pkg-25.2.6_Fabric_1.20.6" = _sxowZbjV;
        "pkg-25.2.6_Forge_1.21" = _369eDeH9;
        "pkg-25.2.6_NeoForge_1.21" = _jSwPt0Wh;
        "pkg-25.2.6_Fabric_1.21" = _BKURGnp1;
        "pkg-25.2.6_Forge_1.21.3" = _JFp0qTiu;
        "pkg-25.2.6_NeoForge_1.21.3" = _cYpaMayr;
        "pkg-25.2.6_Fabric_1.21.3" = _oPvhaPHm;
        "pkg-25.2.6_Forge_1.21.4" = _t99vhehn;
        "pkg-25.2.6_NeoForge_1.21.4" = _VTUj9UOm;
        "pkg-25.2.6_Fabric_1.21.4" = _X3qHEaqt;
        "pkg-25.2.6_Forge_1.21.5" = _iHZ1AXQr;
        "pkg-25.2.6_NeoForge_1.21.5" = _BwNgdOz7;
        "pkg-25.2.6_Fabric_1.21.5" = _su6YdstF;
        "pkg-25.2.7_Forge_1.21.4" = _7PnROMj2;
        "pkg-25.2.7_NeoForge_1.21.4" = _QZ8nH7QZ;
        "pkg-25.2.7_Fabric_1.21.4" = _UdJlXCWy;
        "pkg-25.2.7_Forge_1.21.5" = _sJojsU2y;
        "pkg-25.2.7_NeoForge_1.21.5" = _TUXEAYE8;
        "pkg-25.2.7_Fabric_1.21.5" = _7qxGLo8w;
        "pkg-25.2.7_NeoForge_1.21.6" = _275B88q5;
        "pkg-25.2.7_Fabric_1.21.6" = _8llFAxyr;
        "pkg-25.2.8_NeoForge_1.21.6" = _N261LQYk;
        "pkg-25.2.9_NeoForge_1.21.7" = _aGgctHet;
        "pkg-25.2.9_Forge_1.21.7" = _QHPkOOyG;
        "pkg-25.2.9_Fabric_1.21.7" = _1TDmx88l;
        "pkg-25.2.10_Forge_1.21.7" = _pgayZX4F;
        "pkg-25.2.10_NeoForge_1.21.7" = _JWQzpqe6;
        "pkg-25.2.10_Fabric_1.21.7" = _2hcDlo6F;
        "pkg-25.2.10_Forge_1.12" = _UC24CBCh;
        "pkg-25.2.10_Forge_1.16.5" = _Dal2nCv4;
        "pkg-25.2.10_Fabric_1.16.5" = _dNvdBlnN;
        "pkg-25.2.10_Forge_1.18.2" = _ojrdKFF5;
        "pkg-25.2.10_Fabric_1.18.2" = _Y3Rv6MDV;
        "pkg-25.2.10_Forge_1.19.1" = _zq6O4Uhp;
        "pkg-25.2.10_Fabric_1.19.1" = _waNzK13H;
        "pkg-25.2.10_Forge_1.19.4" = _ht7RRiZy;
        "pkg-25.2.10_Fabric_1.19.4" = _v79Kiydp;
        "pkg-25.2.10_Forge_1.20" = _VfhlV9am;
        "pkg-25.2.10_Fabric_1.20" = _1Knv1cKY;
        "pkg-25.2.10_NeoForge_1.20.2" = _IPcufQGG;
        "pkg-25.2.10_Forge_1.20.2" = _6FBCq4c6;
        "pkg-25.2.10_Fabric_1.20.2" = _Lf9U6tF1;
        "pkg-25.2.10_NeoForge_1.20.4" = _NlCCoMLB;
        "pkg-25.2.10_Fabric_1.20.4" = _5uFCcRjg;
        "pkg-25.2.10_Forge_1.20.4" = _ofMgYIUf;
        "pkg-25.2.10_NeoForge_1.20.6" = _hmzfphdb;
        "pkg-25.2.10_Forge_1.20.6" = _RY2TSLTq;
        "pkg-25.2.10_Fabric_1.20.6" = _OQrZzH2e;
        "pkg-25.2.10_NeoForge_1.21" = _DyuxZXfy;
        "pkg-25.2.10_Forge_1.21" = _X3gyGmJb;
        "pkg-25.2.10_Fabric_1.21" = _IaH8q5hM;
        "pkg-25.2.10_NeoForge_1.21.3" = _jvDr1xsF;
        "pkg-25.2.10_Forge_1.21.3" = _7UNloTTJ;
        "pkg-25.2.10_Fabric_1.21.3" = _QEVhbyQM;
        "pkg-25.2.10_NeoForge_1.21.4" = _zqaoRYUF;
        "pkg-25.2.10_Forge_1.21.4" = _JB1PZMDb;
        "pkg-25.2.10_Fabric_1.21.4" = _TFfNbUts;
        "pkg-25.2.10_NeoForge_1.21.5" = _IGkY7VSi;
        "pkg-25.2.10_Forge_1.21.5" = _pHCTsXzC;
        "pkg-25.2.10_Fabric_1.21.5" = _IOtamBGG;
        "pkg-25.2.11_Forge_1.21.8" = _bq4S670U;
        "pkg-25.2.11_NeoForge_1.21.8" = _NFdYjAzq;
        "pkg-25.2.11_Fabric_1.21.8" = _O4idDQvA;
        "pkg-25.2.12_Forge_1.21.8" = _IDZw5JCQ;
        "pkg-25.2.12_NeoForge_1.21.8" = _yms1eZ76;
        "pkg-25.2.12_Fabric_1.21.8" = _StqWcPqA;
        "pkg-25.2.12_Forge_1.20.6" = _San5ggFV;
        "pkg-25.2.13_Fabric_1.21.9" = _nKxcS5ke;
        "pkg-25.2.14_NeoForge_1.21.9" = _ywIsFrc2;
        "pkg-25.2.14_Fabric_1.21.9" = _NDNq9HeR;
        "pkg-25.2.14_Forge_1.21.9" = _d6bmDEHd;
        "pkg-25.2.15_Forge_1.21.5" = _lvLqUpBq;
        "pkg-25.2.15_NeoForge_1.21.5" = _swDZzYtL;
        "pkg-25.2.15_Fabric_1.21.5" = _g03asoTc;
        "pkg-25.2.15_Forge_1.21.8" = _UujdOOqG;
        "pkg-25.2.15_NeoForge_1.21.8" = _8JUQUdok;
        "pkg-25.2.15_Fabric_1.21.8" = _mU5XaQKN;
        "pkg-25.2.15_Forge_1.21.9" = _AYcRkYXN;
        "pkg-25.2.15_NeoForge_1.21.9" = _wsGTIFOq;
        "pkg-25.2.15_Fabric_1.21.9" = _hztxb2W2;
        "pkg-25.2.16_Fabric_1.21.8" = _dEIlpdij;
        "pkg-25.3.0_NeoForge_1.21.11" = _Uwr5Y70p;
        "pkg-25.3.0_Fabric_1.21.11" = _bLjxUZnS;
        "pkg-25.3.1_NeoForge_1.21.11" = _gZ5JNmVM;
        "pkg-25.3.1_Fabric_1.21.11" = _y2qYTOLn;
        "pkg-25.3.2_Forge_1.12" = _2ph0fxQP;
        "pkg-25.3.2_Forge_1.16.5" = _eSRrcJF6;
        "pkg-25.3.2_Fabric_1.16.5" = _OHbVbkBu;
        "pkg-25.3.2_Forge_1.18.2" = _LBiUxQwy;
        "pkg-25.3.2_Fabric_1.18.2" = _uOxUKoRM;
        "pkg-25.3.2_Forge_1.19.1" = _P8BoHnhx;
        "pkg-25.3.2_Fabric_1.19.1" = _qSgYmsyz;
        "pkg-25.3.2_Forge_1.20" = _33Ak0hoU;
        "pkg-25.3.2_Fabric_1.20" = _jcQ3zpWh;
        "pkg-25.3.2_NeoForge_1.20.4" = _qJUbl49M;
        "pkg-25.3.2_Forge_1.20.4" = _1wNpLuh7;
        "pkg-25.3.2_Fabric_1.20.4" = _DYeyYMjV;
        "pkg-25.3.2_NeoForge_1.21" = _iTA5fl45;
        "pkg-25.3.2_Forge_1.21" = _nVjx8BAd;
        "pkg-25.3.2_Fabric_1.21" = _T78xsQuu;
        "pkg-25.3.2_NeoForge_1.21.3" = _63tCp6uJ;
        "pkg-25.3.2_Forge_1.21.3" = _GnbbSf21;
        "pkg-25.3.2_Fabric_1.21.3" = _r7SCa3gf;
        "pkg-25.3.2_NeoForge_1.21.4" = _9Ma6G8JQ;
        "pkg-25.3.2_Forge_1.21.4" = _CsyJ74wf;
        "pkg-25.3.2_Fabric_1.21.4" = _ca1kpdhu;
        "pkg-25.3.2_NeoForge_1.21.5" = _3CzOaAme;
        "pkg-25.3.2_Forge_1.21.5" = _I6HuS7lf;
        "pkg-25.3.2_Fabric_1.21.5" = _QeuKUG15;
        "pkg-25.3.2_NeoForge_1.21.8" = _VGTcMDCz;
        "pkg-25.3.2_Forge_1.21.8" = _s7j8i8Sp;
        "pkg-25.3.2_Fabric_1.21.8" = _dj4C4U07;
        "pkg-25.3.2_NeoForge_1.21.10" = _FejhBrwS;
        "pkg-25.3.2_Forge_1.21.10" = _fO9DH6I9;
        "pkg-25.3.2_Fabric_1.21.10" = _oMUCIZ9n;
        "pkg-25.3.2_NeoForge_1.21.11" = _BCbGZhrl;
        "pkg-25.3.2_Fabric_1.21.11" = _62EynHPJ;
        "pkg-forge-1.12.2-25.3.5" = _2TSNHsFY;
        "pkg-forge-1.16.5-25.3.5" = _86N8TCUz;
        "pkg-fabric-1.16.5-25.3.5" = _gahUsA6a;
        "pkg-forge-1.18.2-25.3.5" = _El0mU8LX;
        "pkg-fabric-1.18.2-25.3.5" = _woio8AMS;
        "pkg-forge-1.19.2-25.3.5" = _eoV8DGuv;
        "pkg-fabric-1.19.2-25.3.5" = _F0jrcYdR;
        "pkg-forge-1.20.1-25.3.5" = _8SbF22u3;
        "pkg-fabric-1.20.1-25.3.5" = _6MQBeVDz;
        "pkg-neoforge-1.20.4-25.3.5" = _i6Y3D5H4;
        "pkg-forge-1.20.4-25.3.5" = _VTAajBLO;
        "pkg-fabric-1.20.4-25.3.5" = _gbzsZ8oZ;
        "pkg-neoforge-1.21.1-25.3.5" = _puXrtfcK;
        "pkg-forge-1.21.1-25.3.5" = _QGvLgTlG;
        "pkg-fabric-1.21.1-25.3.5" = _Vqkdzsyt;
        "pkg-neoforge-1.21.3-25.3.5" = _UVf8b2jK;
        "pkg-forge-1.21.3-25.3.5" = _Qy9fc15b;
        "pkg-fabric-1.21.3-25.3.5" = _m4DX1JCQ;
        "pkg-neoforge-1.21.4-25.3.5" = _s37EITz6;
        "pkg-forge-1.21.4-25.3.5" = _iihVwr0b;
        "pkg-fabric-1.21.4-25.3.5" = _t6pzXfZa;
        "pkg-neoforge-1.21.5-25.3.5" = _aP6hJg4U;
        "pkg-forge-1.21.5-25.3.5" = _m6yIjufg;
        "pkg-fabric-1.21.5-25.3.5" = _taFSM8PW;
        "pkg-neoforge-1.21.8-25.3.5" = _tOWZiqbL;
        "pkg-forge-1.21.8-25.3.5" = _hDj8CLKi;
        "pkg-fabric-1.21.8-25.3.5" = _ETFJtOY2;
        "pkg-neoforge-1.21.10-25.3.5" = _Le27tQsm;
        "pkg-forge-1.21.10-25.3.5" = _ilO6Eta8;
        "pkg-fabric-1.21.10-25.3.5" = _mqs9c3ae;
        "pkg-neoforge-1.21.11-25.3.5" = _cCXiiGID;
        "pkg-fabric-1.21.11-25.3.5" = _ImVKd3Zp;
        "pkg-neoforge-1.21.4-25.3.6" = _RARF2lwg;
        "pkg-forge-1.12.2-25.3.8" = _sj6MMHMb;
        "pkg-forge-1.16.5-25.3.8" = _1jmlkymM;
        "pkg-forge-1.18.2-25.3.7" = _kKSl3Xkb;
        "pkg-fabric-1.18.2-25.3.7" = _ypA1fB25;
        "pkg-forge-1.19.2-25.3.7" = _suejh48l;
        "pkg-fabric-1.19.2-25.3.7" = _Pr7u15HG;
        "pkg-forge-1.20.1-25.3.7" = _oJfy1fNM;
        "pkg-fabric-1.20.1-25.3.7" = _UJOJu5Vz;
        "pkg-neoforge-1.20.4-25.3.7" = _NtPOKpqx;
        "pkg-forge-1.20.4-25.3.7" = _DbNfyY5Q;
        "pkg-fabric-1.20.4-25.3.7" = _tKiqFJtQ;
        "pkg-neoforge-1.21.1-25.3.7" = _MQMsfPNl;
        "pkg-forge-1.21.1-25.3.7" = _F2fBBTEz;
        "pkg-fabric-1.21.1-25.3.7" = _j42cEChK;
        "pkg-neoforge-1.21.4-25.3.7" = _3n1GFDUw;
        "pkg-forge-1.21.4-25.3.7" = _3AbyBvpk;
        "pkg-fabric-1.21.4-25.3.7" = _oLC4QNU9;
        "pkg-neoforge-1.21.5-25.3.7" = _w9j4MZm1;
        "pkg-forge-1.21.5-25.3.7" = _ad6DFTEU;
        "pkg-fabric-1.21.5-25.3.7" = _oxvDACU7;
        "pkg-neoforge-1.21.8-25.3.7" = _CnhQuYlG;
        "pkg-forge-1.21.8-25.3.7" = _YA6Efz8q;
        "pkg-fabric-1.21.8-25.3.7" = _jTezCwjw;
        "pkg-neoforge-1.21.10-25.3.7" = _wHmsiUmy;
        "pkg-forge-1.21.10-25.3.7" = _slt8E8n3;
        "pkg-fabric-1.21.10-25.3.7" = _maMhGQTa;
        "pkg-neoforge-1.21.11-25.3.7" = _Mo3WtPy5;
        "pkg-forge-1.21.11-25.3.7" = _Z1lgL3fX;
        "pkg-fabric-1.21.11-25.3.7" = _GtzpTIYm;
        "pkg-forge-1.12.2-25.3.9" = _ndLTOsLw;
        "pkg-forge-1.16.5-25.3.9" = _ihLtiudf;
        "pkg-fabric-1.16.5-25.3.9" = _Sj0gjgxV;
        "pkg-forge-1.18.2-25.3.9" = _NXjsWoit;
        "pkg-fabric-1.18.2-25.3.9" = _e7kFI3Ki;
        "pkg-forge-1.19.2-25.3.9" = _Wy7UXEZb;
        "pkg-fabric-1.19.2-25.3.9" = _q53Wo7s4;
        "pkg-forge-1.20.1-25.3.9" = _iKFd6gwm;
        "pkg-fabric-1.20.1-25.3.9" = _rcRP4SQh;
        "pkg-neoforge-1.20.4-25.3.9" = _xAOvqHwd;
        "pkg-forge-1.20.4-25.3.9" = _uh7K03Gw;
        "pkg-fabric-1.20.4-25.3.9" = _kHilLfkO;
        "pkg-neoforge-1.21.1-25.3.9" = _7KUAY3Iw;
        "pkg-forge-1.21.1-25.3.9" = _ONmDn2Tl;
        "pkg-fabric-1.21.1-25.3.9" = _kPQFDgFG;
        "pkg-neoforge-1.21.4-25.3.9" = _wRnBCvTV;
        "pkg-forge-1.21.4-25.3.9" = _sthPxOOC;
        "pkg-fabric-1.21.4-25.3.9" = _CVCUIPgE;
        "pkg-neoforge-1.21.5-25.3.9" = _oacOTBW4;
        "pkg-forge-1.21.5-25.3.9" = _oQQ7cMmd;
        "pkg-fabric-1.21.5-25.3.9" = _5RtHvfrB;
        "pkg-neoforge-1.21.8-25.3.9" = _elBvVi4v;
        "pkg-forge-1.21.8-25.3.9" = _K9gEJO6Y;
        "pkg-fabric-1.21.8-25.3.9" = _G2u6PsdP;
        "pkg-neoforge-1.21.10-25.3.9" = _gnpN5V2v;
        "pkg-forge-1.21.10-25.3.9" = _pLXFgrEQ;
        "pkg-fabric-1.21.10-25.3.9" = _G8CFwR66;
        "pkg-neoforge-1.21.11-25.3.9" = _3JDONvHI;
        "pkg-forge-1.21.11-25.3.9" = _lz2OMpEx;
        "pkg-fabric-1.21.11-25.3.9" = _FVddJATL;
        "pkg-forge-1.12.2-25.3.10" = _tCDDoOJ4;
        "pkg-forge-1.16.5-25.3.10" = _Wfo74Q4B;
        "pkg-fabric-1.16.5-25.3.10" = _693ys8rx;
        "pkg-forge-1.18.2-25.3.10" = _qKIR4fL7;
        "pkg-fabric-1.18.2-25.3.10" = _43mrwXuK;
        "pkg-forge-1.19.2-25.3.10" = _dp3BhGn8;
        "pkg-fabric-1.19.2-25.3.10" = _Gx6yn9HQ;
        "pkg-forge-1.20.1-25.3.10" = _iMXAV165;
        "pkg-fabric-1.20.1-25.3.10" = _7wlcmhtN;
        "pkg-neoforge-1.20.4-25.3.10" = _WycTxNLb;
        "pkg-forge-1.20.4-25.3.10" = _u2vITwrb;
        "pkg-fabric-1.20.4-25.3.10" = _D1pE0bd4;
        "pkg-neoforge-1.21.1-25.3.10" = _CatMvRfN;
        "pkg-forge-1.21.1-25.3.10" = _JItSZSRo;
        "pkg-fabric-1.21.1-25.3.10" = _9kt7Yxig;
        "pkg-neoforge-1.21.4-25.3.10" = _vB1ZT7yz;
        "pkg-forge-1.21.4-25.3.10" = _rtgN72Hx;
        "pkg-fabric-1.21.4-25.3.10" = _Or6HdYae;
        "pkg-neoforge-1.21.5-25.3.10" = _j9yDuKgF;
        "pkg-forge-1.21.5-25.3.10" = _IS2e344u;
        "pkg-fabric-1.21.5-25.3.10" = _3hDGLYrW;
        "pkg-neoforge-1.21.8-25.3.10" = _BIqznmWD;
        "pkg-forge-1.21.8-25.3.10" = _K5rQ7T3x;
        "pkg-fabric-1.21.8-25.3.10" = _fZaO8piK;
        "pkg-neoforge-1.21.10-25.3.10" = _TrSOU6Vl;
        "pkg-forge-1.21.10-25.3.10" = _aPpOzRxw;
        "pkg-fabric-1.21.10-25.3.10" = _KMM4KDVq;
        "pkg-neoforge-1.21.11-25.3.10" = _bpJO2mDR;
        "pkg-forge-1.21.11-25.3.10" = _pDfHf9mF;
        "pkg-fabric-1.21.11-25.3.10" = _avSqR3vF;
        "pkg-neoforge-26.1.2-25.3.10" = _om8B3Atj;
        "pkg-fabric-26.1.2-25.3.10" = _SDmysKVu;
        "pkg-neoforge-26.1.2-25.3.11" = _uFCpuOvP;
        "pkg-fabric-26.1.2-25.3.11" = _nhb2seHH;
        "pkg-forge-1.12.2-25.3.12" = _BkMNHizy;
        "pkg-forge-1.16.5-25.3.12" = _1eqmIP0P;
        "pkg-fabric-1.16.5-25.3.12" = _4MpfrS5K;
        "pkg-forge-1.18.2-25.3.12" = _tivU9cnd;
        "pkg-fabric-1.18.2-25.3.12" = _ZdpJqUgj;
        "pkg-forge-1.19.2-25.3.12" = _5rUUpdjH;
        "pkg-fabric-1.19.2-25.3.12" = _an8CV5ge;
        "pkg-forge-1.20.1-25.3.12" = _PmyN0QwQ;
        "pkg-fabric-1.20.1-25.3.12" = _IAvIWG18;
        "pkg-forge-1.20.4-25.3.12" = _rLQhjTzp;
        "pkg-fabric-1.20.4-25.3.12" = _CeK13KWY;
        "pkg-neoforge-1.20.4-25.3.12" = _4CSMFtML;
        "pkg-forge-1.21.1-25.3.12" = _JBbaF2jw;
        "pkg-fabric-1.21.1-25.3.12" = _Y6UMYlPY;
        "pkg-neoforge-1.21.1-25.3.12" = _ThKA6Y5O;
        "pkg-forge-1.21.4-25.3.12" = _94hrsXUC;
        "pkg-fabric-1.21.4-25.3.12" = _vekG4NBq;
        "pkg-neoforge-1.21.4-25.3.12" = _WNbxGOAE;
        "pkg-forge-1.21.5-25.3.12" = _HsR6nVkk;
        "pkg-fabric-1.21.5-25.3.12" = _wazIuE6Y;
        "pkg-neoforge-1.21.5-25.3.12" = _EXpZk6iR;
        "pkg-forge-1.21.8-25.3.12" = _EF8TS0SI;
        "pkg-fabric-1.21.8-25.3.12" = _yZMYsVAi;
        "pkg-neoforge-1.21.8-25.3.12" = _penaD4YX;
        "pkg-forge-1.21.10-25.3.12" = _zqY8MHXu;
        "pkg-fabric-1.21.10-25.3.12" = _bbIwh53q;
        "pkg-neoforge-1.21.10-25.3.12" = _sWkpb1JY;
        "pkg-forge-1.21.11-25.3.12" = _fdGS3YRH;
        "pkg-fabric-1.21.11-25.3.12" = _q5DQinHS;
        "pkg-neoforge-1.21.11-25.3.12" = _nDIsD13g;
        "pkg-fabric-26.1.2-25.3.12" = _iaLJOmHg;
        "pkg-neoforge-26.1.2-25.3.12" = _xRJQlxdX;
        "pkg-forge-1.12.2-25.3.13" = _48coZVIV;
        "pkg-forge-1.16.5-25.3.13" = _SzzjQ7UM;
        "pkg-forge-1.18.2-25.3.13" = _U75aGU5P;
        "pkg-forge-1.19.2-25.3.13" = _fDLqg252;
        "pkg-forge-1.20.1-25.3.13" = _FiaNp94m;
        "pkg-forge-1.20.4-25.3.13" = _LGUaHNiF;
        "pkg-neoforge-1.20.4-25.3.13" = _W0Izjwl2;
        "pkg-forge-1.21.1-25.3.13" = _ub3haes5;
        "pkg-neoforge-1.21.1-25.3.13" = _CklXEjmp;
        "pkg-forge-1.21.4-25.3.13" = _kEl8jZ3Y;
        "pkg-neoforge-1.21.4-25.3.13" = _UA1AOZaj;
        "pkg-fabric-26.1.2-25.3.14" = _65OfA4xM;
        "pkg-neoforge-26.1.2-25.3.14" = _JllyNANF;
        "pkg-forge-1.12.2-26.1.0" = _jW9u4yg8;
        "pkg-forge-1.16.5-26.1.0" = _jl4nVkqy;
        "pkg-fabric-1.16.5-26.1.0" = _FR7EDSCy;
        "pkg-forge-1.18.2-26.1.0" = _zeiqmJjO;
        "pkg-fabric-1.18.2-26.1.0" = _MnI1p20m;
        "pkg-forge-1.19.2-26.1.0" = _t0qPvgpA;
        "pkg-fabric-1.19.2-26.1.0" = _C1GPYXF0;
        "pkg-forge-1.20.1-26.1.0" = _LHQz9XA1;
        "pkg-fabric-1.20.1-26.1.0" = _ctcLIczk;
        "pkg-forge-1.20.4-26.1.0" = _P9yHCoiG;
        "pkg-fabric-1.20.4-26.1.0" = _T4y8mSDl;
        "pkg-neoforge-1.20.4-26.1.0" = _pqrbfC2W;
        "pkg-forge-1.21.1-26.1.0" = _b3DWRYgW;
        "pkg-fabric-1.21.1-26.1.0" = _UlRSujUV;
        "pkg-neoforge-1.21.1-26.1.0" = _w8HSmbC3;
        "pkg-forge-1.21.4-26.1.0" = _5itCCz1J;
        "pkg-fabric-1.21.4-26.1.0" = _oW2LTmmK;
        "pkg-neoforge-1.21.4-26.1.0" = _S6AgYWqW;
        "pkg-forge-1.21.5-26.1.0" = _BqYNQT64;
        "pkg-fabric-1.21.5-26.1.0" = _rlydb5f5;
        "pkg-neoforge-1.21.5-26.1.0" = _UAkG7RWi;
        "pkg-forge-1.21.8-26.1.0" = _8LsKBdQb;
        "pkg-fabric-1.21.8-26.1.0" = _qkAppprN;
        "pkg-neoforge-1.21.8-26.1.0" = _3028kfKv;
        "pkg-forge-1.21.10-26.1.0" = _yU32MRpI;
        "pkg-fabric-1.21.10-26.1.0" = _W5kLAKWb;
        "pkg-neoforge-1.21.10-26.1.0" = _720zrJoS;
        "pkg-forge-1.21.11-26.1.0" = _kN8Hawhh;
        "pkg-fabric-1.21.11-26.1.0" = _Gv2gIQEn;
        "pkg-neoforge-1.21.11-26.1.0" = _ErpY15Mo;
        "pkg-fabric-26.1.2-26.1.0" = _QmIPBKnL;
        "pkg-neoforge-26.1.2-26.1.0" = _QaHTqfK2;
        "pkg-fabric-26.2-26.1.0" = _jqP3U3NE;
        "pkg-neoforge-26.2-26.1.0" = _3Sj7zDQn;
        "pkg-fabric-26.2-26.1.1" = _ULDPmqZp;
        "pkg-neoforge-26.2-26.1.1" = _KOo42M4J;
        "pkg-fabric-26.2-26.1.2" = _3ivnwPzm;
        "pkg-neoforge-26.2-26.1.2" = _garNYXHq;
        "pkg-fabric-26.1.2-26.1.3" = _XgipMybJ;
        "pkg-fabric-26.2-26.1.3" = _e1D3Ei69;
        "pkg-forge-1.21.4-26.1.4" = _FFKHSupD;
        "pkg-fabric-1.21.4-26.1.4" = _BZqNlEYr;
        "pkg-neoforge-1.21.4-26.1.4" = _jm47ccZz;
        "pkg-forge-1.21.5-26.1.4" = _sOgQqUNQ;
        "pkg-fabric-1.21.5-26.1.4" = _7CYn8p3p;
        "pkg-neoforge-1.21.5-26.1.4" = _VXZLP2Ej;
        "pkg-forge-1.21.8-26.1.4" = _uxZEPimm;
        "pkg-fabric-1.21.8-26.1.4" = _aKjeW0tQ;
        "pkg-neoforge-1.21.8-26.1.4" = _G2ERCd3X;
        "pkg-forge-1.21.10-26.1.4" = _oLBEfeAV;
        "pkg-fabric-1.21.10-26.1.4" = _nOC5YfLm;
        "pkg-neoforge-1.21.10-26.1.4" = _fb3TL8by;
        "pkg-forge-1.21.11-26.1.4" = _PMmJLQqp;
        "pkg-fabric-1.21.11-26.1.4" = _rLF2AwoN;
        "pkg-neoforge-1.21.11-26.1.4" = _4lGK71xk;
        "pkg-fabric-26.1.2-26.1.4" = _vu0dsJu9;
        "pkg-neoforge-26.1.2-26.1.4" = _94HWGPMH;
        "pkg-neoforge-26.2-26.1.3" = _InMgCReh;
        "pkg-fabric-26.1.2-26.1.5" = _rEqKdOfN;
        "pkg-forge-1.12.2-26.2.0" = _oBYC0IWq;
        "pkg-forge-1.16.5-26.2.0" = _mHFL3OPO;
        "pkg-fabric-1.16.5-26.2.0" = _har5kCyV;
        "pkg-forge-1.18.2-26.2.0" = _EYqwjOYE;
        "pkg-fabric-1.18.2-26.2.0" = _siK5Zs8I;
        "pkg-fabric-1.19.2-26.2.0" = _7wlG7p9m;
        "pkg-forge-1.19.2-26.2.0" = _DWjC3nPv;
        "pkg-fabric-1.20.1-26.2.0" = _qiNlZLVo;
        "pkg-forge-1.20.1-26.2.0" = _nqVwHuEZ;
        "pkg-fabric-1.20.4-26.2.0" = _xi6ChrKv;
        "pkg-forge-1.20.4-26.2.0" = _IO6VTFig;
        "pkg-neoforge-1.20.4-26.2.0" = _oR9np42z;
        "pkg-forge-1.21.1-26.2.0" = _dUkNnKl0;
        "pkg-fabric-1.21.1-26.2.0" = _JVCvGnhe;
        "pkg-neoforge-1.21.1-26.2.0" = _UC6z31zK;
        "pkg-forge-1.21.4-26.2.0" = _fgt5tvzb;
        "pkg-fabric-1.21.4-26.2.0" = _nbm9WikB;
        "pkg-neoforge-1.21.4-26.2.0" = _ELEVWF9D;
        "pkg-forge-1.21.5-26.2.0" = _hXEjscph;
        "pkg-fabric-1.21.5-26.2.0" = _KG0d2XzQ;
        "pkg-neoforge-1.21.5-26.2.0" = _PnKqptZe;
        "pkg-forge-1.21.8-26.2.0" = _YjodsdYL;
        "pkg-fabric-1.21.8-26.2.0" = _PWFv2xYW;
        "pkg-neoforge-1.21.8-26.2.0" = _Kw9HBhTj;
        "pkg-forge-1.21.10-26.2.0" = _HiYb3Lj8;
        "pkg-fabric-1.21.10-26.2.0" = _2Lkl1cnY;
        "pkg-neoforge-1.21.10-26.2.0" = _bLDMIbeR;
        "pkg-forge-1.21.11-26.2.0" = _39Ik2P20;
        "pkg-fabric-1.21.11-26.2.0" = _z6442Xnl;
        "pkg-neoforge-1.21.11-26.2.0" = _dOtmP194;
        "pkg-fabric-26.1.2-26.2.0" = _hEhY9fD7;
        "pkg-neoforge-26.1.2-26.2.0" = _MH5Dm1Vm;
        "pkg-fabric-26.2-26.2.0" = _qH1mI57E;
        "pkg-neoforge-26.2-26.2.0" = _dZ3k1Wc7;
        "pkg-neoforge-1.20.4-26.2.1" = _lbWDSw4J;
        "pkg-neoforge-1.21.1-26.2.1" = _BveBfpvr;
        "pkg-neoforge-1.21.4-26.2.1" = _bkcL65tW;
        "pkg-forge-1.12.2-26.3.0" = _lJCBS8wa;
        "pkg-forge-1.16.5-26.3.0" = _GHVDP11n;
        "pkg-fabric-1.16.5-26.3.0" = _iIkbWK3Z;
        "pkg-fabric-1.18.2-26.3.0" = _VdLQ0C1k;
        "pkg-forge-1.18.2-26.3.0" = _GigA6DNZ;
        "pkg-fabric-1.19.2-26.3.0" = _rp9iTqKY;
        "pkg-forge-1.19.2-26.3.0" = _lL5mEC1x;
        "pkg-fabric-1.20.1-26.3.0" = _hfFxVmrW;
        "pkg-forge-1.20.1-26.3.0" = _8s5PDDTU;
        "pkg-forge-1.20.4-26.3.0" = _ARaeirn1;
        "pkg-fabric-1.20.4-26.3.0" = _lNoVbIJM;
        "pkg-neoforge-1.20.4-26.3.0" = _BUhOEB6P;
        "pkg-forge-1.21.1-26.3.0" = _mQXYBXgl;
        "pkg-fabric-1.21.1-26.3.0" = _fPArBs97;
        "pkg-neoforge-1.21.1-26.3.0" = _BaRqMqWN;
        "pkg-forge-1.21.4-26.3.0" = _N4V6FRVs;
        "pkg-neoforge-1.21.4-26.3.0" = _70wiQO4d;
        "pkg-forge-1.21.5-26.3.0" = _aF9n5pvG;
        "pkg-neoforge-1.21.5-26.3.0" = _aKAN1mlu;
        "pkg-forge-1.21.8-26.3.0" = _keO26IeV;
        "pkg-neoforge-1.21.8-26.3.0" = _630LQ4xX;
        "pkg-forge-1.21.10-26.3.0" = _BEb1svQ4;
        "pkg-neoforge-1.21.10-26.3.0" = _2uS2gjLS;
        "pkg-forge-1.21.11-26.3.0" = _MysbwrEh;
        "pkg-neoforge-1.21.11-26.3.0" = _3zwSEF1O;
        "pkg-forge-26.1.2-26.3.0" = _3rQ1XB9k;
        "pkg-neoforge-26.1.2-26.3.0" = _mWtteaHm;
        "pkg-forge-26.2-26.3.0" = _ykzHC4aj;
        "pkg-neoforge-26.2-26.3.0" = _n8tnRCmi;
        "pkg-fabric-1.21.4-26.3.0" = _N6W6FASQ;
        "pkg-fabric-1.21.5-26.3.0" = _QWoeiEG8;
        "pkg-fabric-1.21.8-26.3.0" = _9ZSUIDrx;
        "pkg-fabric-1.21.10-26.3.0" = _4J1OTOFo;
        "pkg-fabric-1.21.11-26.3.0" = _1H9Rbq1Q;
        "pkg-fabric-26.1.2-26.3.0" = _X6D5ZxcG;
        "pkg-fabric-26.2-26.3.0" = _d1F2ppTa;
        "pkg-forge-26.1.2-26.4.0" = _DLna7DYz;
        "pkg-fabric-26.1.2-26.4.0" = _DtyHvV2n;
        "pkg-neoforge-26.1.2-26.4.0" = _rGEmlI7y;
        "pkg-forge-26.2-26.4.0" = _OkAm7sHe;
        "pkg-fabric-26.2-26.4.0" = _hwYpUNmh;
        "pkg-neoforge-26.2-26.4.0" = _aoTXYEJ8;
        "pkg-forge-1.12.2-26.4.0" = _VXCfblxn;
        "pkg-forge-1.16.5-26.4.0" = _bggvBYv8;
        "pkg-fabric-1.16.5-26.4.0" = _Qzs6jiKL;
        "pkg-fabric-1.18.2-26.4.0" = _6OCSSnjs;
        "pkg-forge-1.18.2-26.4.0" = _pRC67ksY;
        "pkg-forge-1.12.2-26.4.1" = _27Ny2ITz;
        "pkg-forge-1.12.2-26.4.2" = _D32zHEev;
        "pkg-forge-1.16.5-26.4.2" = _GhXYXuFH;
        "pkg-fabric-1.16.5-26.4.2" = _rfPs05WB;
        "pkg-forge-1.18.2-26.4.2" = _bpEZ8gqB;
        "pkg-fabric-1.18.2-26.4.2" = _ZElF3vb2;
        "pkg-forge-1.19.2-26.4.2" = _NdDo96fS;
        "pkg-fabric-1.19.2-26.4.2" = _HgX0mHL4;
        "pkg-forge-1.20.1-26.4.2" = _A1JacFsh;
        "pkg-fabric-1.20.1-26.4.2" = _VqmyLcPM;
        "pkg-forge-1.20.4-26.4.2" = _CXTAzhTD;
        "pkg-fabric-1.20.4-26.4.2" = _Ut88hbEQ;
        "pkg-neoforge-1.20.4-26.4.2" = _lzVTXMZa;
        "pkg-forge-1.21.1-26.4.2" = _LDxpymBP;
        "pkg-fabric-1.21.1-26.4.2" = _Tx54V6kI;
        "pkg-neoforge-1.21.1-26.4.2" = _JXvcT1hp;
        "pkg-forge-1.21.4-26.4.2" = _JEnWvthN;
        "pkg-fabric-1.21.4-26.4.2" = _HdVzouMD;
        "pkg-neoforge-1.21.4-26.4.2" = _TTVuBFGc;
        "pkg-forge-1.21.5-26.4.2" = _NTMxjuNI;
        "pkg-fabric-1.21.5-26.4.2" = _rnFJt6gZ;
        "pkg-neoforge-1.21.5-26.4.2" = _nP5OAu0d;
        "pkg-forge-1.21.8-26.4.2" = _oOeVi5F9;
        "pkg-fabric-1.21.8-26.4.2" = _qcQIILFO;
        "pkg-neoforge-1.21.8-26.4.2" = _6wkzgSPn;
        "pkg-forge-1.21.10-26.4.2" = _cFAqsQv0;
        "pkg-fabric-1.21.10-26.4.2" = _mB3zUj6T;
        "pkg-neoforge-1.21.10-26.4.2" = _uYt4Zlvn;
        "pkg-forge-1.21.11-26.4.2" = _y1T96Kx4;
        "pkg-fabric-1.21.11-26.4.2" = _8MdqDp18;
        "pkg-neoforge-1.21.11-26.4.2" = _ijlOlFLF;
        "pkg-forge-26.1.2-26.4.2" = _loTarZUU;
        "pkg-fabric-26.1.2-26.4.2" = _fklv23QW;
        "pkg-neoforge-26.1.2-26.4.2" = _j8fQFbeU;
        "pkg-forge-26.2-26.4.2" = _qrBo647h;
        "pkg-fabric-26.2-26.4.2" = _W7vHFz3T;
        "pkg-neoforge-26.2-26.4.2" = _IqOn6XCo;
        "pkg-forge-26.2-26.4.3" = _M2VgyuOZ;
        "pkg-forge-26.1.2-26.4.3" = _JfOFsbci;
        "pkg-forge-1.12.2-26.5.0" = _E0vFwbpC;
        "pkg-forge-1.16.5-26.5.0" = _3ZOF9JKy;
        "pkg-fabric-1.16.5-26.5.0" = _FtshtRKu;
        "pkg-fabric-1.18.2-26.5.0" = _PthCIgVG;
        "pkg-forge-1.18.2-26.5.0" = _Kivk3ESI;
        "pkg-fabric-1.19.2-26.5.0" = _F3EZ3EeI;
        "pkg-forge-1.19.2-26.5.0" = _VXZD4M1S;
        "pkg-fabric-1.20.1-26.5.0" = _eLoJ9IXg;
        "pkg-forge-1.20.1-26.5.0" = _Juh6inLY;
        "pkg-fabric-1.20.4-26.5.0" = _A7F7BIix;
        "pkg-neoforge-1.20.4-26.5.0" = _tBqQhb8M;
        "pkg-forge-1.20.4-26.5.0" = _7PZIHcHC;
        "pkg-neoforge-1.21.1-26.5.0" = _Q1tuMQBB;
        "pkg-forge-1.21.1-26.5.0" = _sqSykKFQ;
        "pkg-fabric-1.21.1-26.5.0" = _ZD6hK4GV;
        "pkg-neoforge-1.21.4-26.5.0" = _UmbZGoNN;
        "pkg-forge-1.21.4-26.5.0" = _4sK0D4vO;
        "pkg-fabric-1.21.4-26.5.0" = _XsKw9RY8;
        "pkg-neoforge-1.21.5-26.5.0" = _Xy9Qb0hB;
        "pkg-forge-1.21.5-26.5.0" = _aFqhp23J;
        "pkg-fabric-1.21.5-26.5.0" = _UiyvcqIl;
        "pkg-fabric-1.21.8-26.5.0" = _bSWbd7fk;
        "pkg-neoforge-1.21.8-26.5.0" = _yaTqpe9r;
        "pkg-forge-1.21.8-26.5.0" = _NYWgukTR;
        "pkg-fabric-1.21.10-26.5.0" = _F8LrvYl9;
        "pkg-neoforge-1.21.10-26.5.0" = _mIptvhV0;
        "pkg-forge-1.21.10-26.5.0" = _Cbfpf5vy;
        "pkg-neoforge-1.21.11-26.5.0" = _YeE8CjjJ;
        "pkg-forge-1.21.11-26.5.0" = _mb0ddrtW;
        "pkg-fabric-1.21.11-26.5.0" = _VNYP3B0c;
        "pkg-fabric-26.1.2-26.5.0" = _kWf58HtH;
        "pkg-neoforge-26.1.2-26.5.0" = _SOtj001J;
        "pkg-forge-26.1.2-26.5.0" = _nFX2qxMK;
        "pkg-neoforge-26.2-26.5.0" = _ulT9Wbps;
        "pkg-forge-26.2-26.5.0" = _QBdmsTuO;
        "pkg-fabric-26.2-26.5.0" = _tBIPWIKW;
        "pkg-forge-1.12.2-26.5.1" = _Sg74174z;
        "pkg-forge-26.2-26.5.1" = _DBhJiSUh;
        "pkg-neoforge-26.2-26.5.1" = _WnaAZsas;
        "pkg-fabric-26.2-26.5.1" = _VlMbRW2O;
        "pkg-fabric-26.3-26.5.1" = _bxZ2OjkZ;
        "pkg-fabric-26.3-26.5.2" = _ie70HnZq;
        "pkg-neoforge-26.3-26.5.2" = _XsDeq0Yy;
        "pkg-fabric-26.3-26.5.3" = _YPkAliDt;
        "pkg-neoforge-26.3-26.5.3" = _6zzKPjLq;
        "default" = _6zzKPjLq;
    });
