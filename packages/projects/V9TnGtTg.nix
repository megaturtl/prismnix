...
let
    ...
    in {
        ...
        "pkg-21.5.1" = _QdcKkPWT;
        "pkg-21.5.9" = _3bOPjbgH;
        "pkg-21.5.16" = _pWIwmssS;
        "pkg-21.5.17" = _pll2FegA;
        "pkg-21.5.18" = _uoJ2RhjQ;
        "pkg-21.6.0" = _sBBvpSsM;
        "pkg-21.7.0" = _jYKGYVBC;
        "pkg-21.7.1" = _Cb1NkFLp;
        "pkg-21.6.3" = _I5KxAuqe;
        "pkg-21.7.6" = _TDhyiU4A;
        "pkg-21.7.8" = _4XLnBXZj;
        "pkg-21.10.0" = _LBC2Z5tJ;
        "pkg-21.10.4" = _TN4jyHj4;
        "pkg-21.11.0" = _ZrXpjuDh;
        "pkg-21.10.5" = _Tlyy9jmJ;
        "pkg-21.11.1" = _azRY9Vzd;
        "pkg-26.1.0" = _o4jtc8p5;
