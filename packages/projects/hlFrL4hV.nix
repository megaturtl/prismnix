...
let
    versions = (let
        ...
        _RI5rqZ0l = {
            "id" = "RI5rqZ0l";
            "file" = "Soft-Memory-v1.16.zip";
            "hash" = "sha512-I3IwfnfhZ2yKd5LUEYe/Q0aS0eeTJb9+j9BmQdczlqv4LNjlbnwVZImwcb3JrBt1IB955WEDFqcw00mEVhUyDA==";
        };
        _HRbfw1g0 = {
            "id" = "HRbfw1g0";
            "file" = "Soft-Memory-v1.17.zip";
            "hash" = "sha512-wwA6KHPa69eE61RlK5msNrFo8FEf5W8074UNKGUwIFMhan447fuStllulvTj1vEK9RlrB2GIvvsyinQPlxKt+g==";
        };
    in {
        "SYnbXSSA" = _SYnbXSSA;
        "aCPAOoPQ" = _aCPAOoPQ;
        ...
        "HRbfw1g0" = _HRbfw1g0;
        "iris-1.20" = _HRbfw1g0;
        "iris-1.20.1" = _HRbfw1g0;
        "iris-1.20.2" = _HRbfw1g0;
        "iris-1.20.3" = _HRbfw1g0;
        "iris-1.20.4" = _HRbfw1g0;
        "iris-1.20.5" = _HRbfw1g0;
        "iris-1.20.6" = _HRbfw1g0;
        "iris-1.21" = _HRbfw1g0;
        "iris-1.21.1" = _HRbfw1g0;
        "iris-1.21.2" = _HRbfw1g0;
        "iris-1.21.3" = _HRbfw1g0;
        "iris-1.21.4" = _HRbfw1g0;
        "iris-1.21.5" = _HRbfw1g0;
        "iris-1.21.6" = _HRbfw1g0;
        "iris-1.21.7" = _HRbfw1g0;
        "iris-1.21.8" = _HRbfw1g0;
        "iris-1.21.9" = _HRbfw1g0;
        "iris-1.21.10" = _HRbfw1g0;
        "iris-1.21.11" = _HRbfw1g0;
        "iris-26.1" = _HRbfw1g0;
        "iris-26.1.1" = _HRbfw1g0;
        "iris-26.1.2" = _HRbfw1g0;
        "iris-26.2" = _HRbfw1g0;
        "iris-1.16" = _HRbfw1g0;
        "iris-1.16.1" = _HRbfw1g0;
        "iris-1.16.2" = _HRbfw1g0;
        "iris-1.16.3" = _HRbfw1g0;
        "iris-1.16.4" = _HRbfw1g0;
        "iris-1.16.5" = _HRbfw1g0;
        "iris-1.17" = _HRbfw1g0;
        "iris-1.17.1" = _HRbfw1g0;
        "iris-1.18" = _HRbfw1g0;
        "iris-1.18.1" = _HRbfw1g0;
        "iris-1.18.2" = _HRbfw1g0;
        "iris-1.19" = _HRbfw1g0;
        "iris-1.19.1" = _HRbfw1g0;
        "iris-1.19.2" = _HRbfw1g0;
        "iris-1.19.3" = _HRbfw1g0;
        "iris-1.19.4" = _HRbfw1g0;
        "optifine-1.20" = _HRbfw1g0;
        "optifine-1.20.1" = _HRbfw1g0;
        "optifine-1.20.2" = _HRbfw1g0;
        "optifine-1.20.3" = _HRbfw1g0;
        "optifine-1.20.4" = _HRbfw1g0;
        "optifine-1.20.5" = _HRbfw1g0;
        "optifine-1.20.6" = _HRbfw1g0;
        "optifine-1.21" = _HRbfw1g0;
        "optifine-1.21.1" = _HRbfw1g0;
        "optifine-1.21.2" = _HRbfw1g0;
        "optifine-1.21.3" = _HRbfw1g0;
        "optifine-1.21.4" = _HRbfw1g0;
        "optifine-1.21.5" = _HRbfw1g0;
        "optifine-1.21.6" = _HRbfw1g0;
        "optifine-1.21.7" = _HRbfw1g0;
        "optifine-1.21.8" = _HRbfw1g0;
        "optifine-1.21.9" = _HRbfw1g0;
        "optifine-1.21.10" = _HRbfw1g0;
        "optifine-1.21.11" = _HRbfw1g0;
        "optifine-26.1" = _HRbfw1g0;
        "optifine-26.1.1" = _HRbfw1g0;
        "optifine-26.1.2" = _HRbfw1g0;
        "optifine-26.2" = _HRbfw1g0;
        "optifine-1.16" = _HRbfw1g0;
        "optifine-1.16.1" = _HRbfw1g0;
        "optifine-1.16.2" = _HRbfw1g0;
        "optifine-1.16.3" = _HRbfw1g0;
        "optifine-1.16.4" = _HRbfw1g0;
        "optifine-1.16.5" = _HRbfw1g0;
        "optifine-1.17" = _HRbfw1g0;
        "optifine-1.17.1" = _HRbfw1g0;
        "optifine-1.18" = _HRbfw1g0;
        "optifine-1.18.1" = _HRbfw1g0;
        "optifine-1.18.2" = _HRbfw1g0;
        "optifine-1.19" = _HRbfw1g0;
        "optifine-1.19.1" = _HRbfw1g0;
        "optifine-1.19.2" = _HRbfw1g0;
        "optifine-1.19.3" = _HRbfw1g0;
        "optifine-1.19.4" = _HRbfw1g0;
        "pkg-1.0" = _SYnbXSSA;
        "pkg-1.1" = _aCPAOoPQ;
        "pkg-1.2" = _X4CcvjZy;
        "pkg-1.3" = _h7vvpG1q;
