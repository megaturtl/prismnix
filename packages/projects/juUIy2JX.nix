...
let
    versions = (let
        ...
        _JnCm6n4H = {
            "id" = "JnCm6n4H";
            "file" = "blockblocker-1.7.10-1.4.3.jar";
            "hash" = "sha512-uVWoJK+z6DznP6OSCMQ13vacZuAYJ1Wq32eGlwB3ghoBplwRXHTGoShqz6oU/hOsXTy4nj9FavE7VyFwOIiltQ==";
        };
    in {
        "xts6b8Vi" = _xts6b8Vi;
        "PbeUf1fx" = _PbeUf1fx;
        ...
        "pkg-1.8.2" = _uxlaRV5P;
        "pkg-1.9.0" = _htEFL4Gu;
        "pkg-1.10.0" = _mXDi5nW2;
        "pkg-1.11.0" = _NQpuufhj;
        "pkg-1.12.0" = _cDFtXtSm;
        "pkg-1.13.0" = _RbRzym3q;
        "pkg-1.4.3" = _JnCm6n4H;
        "default" = _JnCm6n4H;
    });
