...
let
    versions = (let
        ...
        _oK3uQZ2Y = {
            "id" = "oK3uQZ2Y";
            "file" = "Noble v1.9.7.zip";
            "hash" = "sha512-oFq63aSqP+4Ckzm+dU9BJ488M8N5MfJ4pa3mFT8ioXqCZLAKcZy+NQhC5q3khRaUtHQ68wUdIZZ89GC8LntaUw==";
        };
        _bnDts6hc = {
            "id" = "bnDts6hc";
            "file" = "Noble v1.9.8.zip";
            "hash" = "sha512-1XcebUg4ftHJG/bVN4CMxMLRdqi+fhKJvQnaoWiaKXO/uJ0c+DyYcJGJIjYcd4LnEX+ntnstvVIsvrnj+V0nyA==";
        };
        _LVmYSHp2 = {
            "id" = "LVmYSHp2";
            "file" = "Noble v1.9.8 hotfix.zip";
            "hash" = "sha512-OEJhInCHSA4TbuXJEOIxGBmUUQsvhcYz2nWpdXZsNVRTxVFrXQoDAVHr92RVcZUw4PtZVE9gDWQ5X/W5MoBFvA==";
        };
    in {
        "gZUHoSfQ" = _gZUHoSfQ;
        "tWjoX3sJ" = _tWjoX3sJ;
        ...
        "LVmYSHp2" = _LVmYSHp2;
        "iris-1.16" = _LVmYSHp2;
        "iris-1.16.1" = _LVmYSHp2;
        "iris-1.16.2" = _LVmYSHp2;
        "iris-1.16.3" = _LVmYSHp2;
        "iris-1.16.4" = _LVmYSHp2;
        "iris-1.16.5" = _LVmYSHp2;
        "iris-1.17" = _LVmYSHp2;
        "iris-1.17.1" = _LVmYSHp2;
        "iris-1.18" = _LVmYSHp2;
        "iris-1.18.1" = _LVmYSHp2;
        "iris-1.18.2" = _LVmYSHp2;
        "iris-1.19" = _LVmYSHp2;
        "iris-1.19.1" = _LVmYSHp2;
        "iris-1.19.2" = _LVmYSHp2;
        "iris-1.19.3" = _LVmYSHp2;
        "iris-1.19.4" = _LVmYSHp2;
        "iris-1.20" = _LVmYSHp2;
        "iris-1.20.1" = _LVmYSHp2;
        "iris-1.20.2" = _LVmYSHp2;
        "iris-1.20.3" = _LVmYSHp2;
        "iris-1.20.4" = _LVmYSHp2;
        "iris-1.20.5" = _LVmYSHp2;
        "iris-1.20.6" = _LVmYSHp2;
        "iris-1.21" = _LVmYSHp2;
        "iris-1.21.1" = _LVmYSHp2;
        "iris-1.21.2" = _LVmYSHp2;
        "iris-1.21.3" = _LVmYSHp2;
        "iris-1.21.4" = _LVmYSHp2;
        "iris-1.21.5" = _LVmYSHp2;
        "iris-1.21.6" = _LVmYSHp2;
        "iris-1.21.7" = _LVmYSHp2;
        "iris-1.21.8" = _LVmYSHp2;
        "iris-1.21.9" = _LVmYSHp2;
        "iris-1.21.10" = _LVmYSHp2;
        "iris-1.21.11" = _LVmYSHp2;
        "iris-26.1" = _LVmYSHp2;
        "iris-26.1.1" = _LVmYSHp2;
        "iris-26.1.2" = _LVmYSHp2;
        "iris-26.2" = _LVmYSHp2;
        "optifine-1.16" = _LVmYSHp2;
        "optifine-1.16.1" = _LVmYSHp2;
        "optifine-1.16.2" = _LVmYSHp2;
        "optifine-1.16.3" = _LVmYSHp2;
        "optifine-1.16.4" = _LVmYSHp2;
        "optifine-1.16.5" = _LVmYSHp2;
        "optifine-1.17" = _LVmYSHp2;
        "optifine-1.17.1" = _LVmYSHp2;
        "optifine-1.18" = _LVmYSHp2;
        "optifine-1.18.1" = _LVmYSHp2;
        "optifine-1.18.2" = _LVmYSHp2;
        "optifine-1.19" = _LVmYSHp2;
        "optifine-1.19.1" = _LVmYSHp2;
        "optifine-1.19.2" = _LVmYSHp2;
        "optifine-1.19.3" = _LVmYSHp2;
        "optifine-1.19.4" = _LVmYSHp2;
        "optifine-1.20" = _LVmYSHp2;
        "optifine-1.20.1" = _LVmYSHp2;
        "optifine-1.20.2" = _LVmYSHp2;
        "optifine-1.20.3" = _LVmYSHp2;
        "optifine-1.20.4" = _LVmYSHp2;
        "optifine-1.20.5" = _LVmYSHp2;
        "optifine-1.20.6" = _LVmYSHp2;
        "optifine-1.21" = _LVmYSHp2;
        "optifine-1.21.1" = _LVmYSHp2;
        "optifine-1.21.2" = _LVmYSHp2;
        "optifine-1.21.3" = _LVmYSHp2;
        "optifine-1.21.4" = _LVmYSHp2;
        "optifine-1.21.5" = _LVmYSHp2;
        "optifine-1.21.6" = _LVmYSHp2;
        "optifine-1.21.7" = _LVmYSHp2;
        "optifine-1.21.8" = _LVmYSHp2;
        "optifine-1.21.9" = _LVmYSHp2;
        "optifine-1.21.10" = _LVmYSHp2;
        "optifine-1.21.11" = _LVmYSHp2;
        "optifine-26.1" = _LVmYSHp2;
        "optifine-26.1.1" = _LVmYSHp2;
        "optifine-26.1.2" = _LVmYSHp2;
        "optifine-26.2" = _LVmYSHp2;
        "pkg-1.0.4" = _gZUHoSfQ;
        "pkg-1.0.5" = _tWjoX3sJ;
        "pkg-1.0.6" = _4HuKeFL8;
        "pkg-1.0.7" = _N2yitfkX;
