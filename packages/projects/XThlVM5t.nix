...
let
    versions = (let
        ...
        _DS6ZHjAw = {
            "id" = "DS6ZHjAw";
            "file" = "fc_v3.jar";
            "hash" = "sha512-rd0JM63Gq4/aDffAiudwNbmpOoh3bbmxaY/rpCkAYsbSt0hYwFeJymKlFm91ogdtgaAiMM2bEXgsWCoS8l3bbg==";
        };
    in {
        "x3EbaP7C" = _x3EbaP7C;
        "Y1DjoOm7" = _Y1DjoOm7;
        ...
        "fabric-26.2" = _DS6ZHjAw;
        "fabric-26.3-snapshot-1" = _DS6ZHjAw;
        "fabric-26.3-snapshot-2" = _DS6ZHjAw;
        "fabric-26.3-snapshot-3" = _DS6ZHjAw;
        "fabric-26.3-snapshot-4" = _DS6ZHjAw;
        "fabric-26.3-snapshot-5" = _DS6ZHjAw;
        "fabric-26.3-snapshot-6" = _DS6ZHjAw;
        "fabric-26.3-snapshot-7" = _DS6ZHjAw;
        "fabric-26.3-snapshot-8" = _DS6ZHjAw;
        "fabric-26.3-snapshot-9" = _DS6ZHjAw;
        "fabric-26.3-snapshot-10" = _DS6ZHjAw;
        "fabric-26.3-pre-1" = _DS6ZHjAw;
        "fabric-26.3-pre-2" = _DS6ZHjAw;
        "fabric-26.3-pre-3" = _DS6ZHjAw;
        "fabric-26.3-rc-1" = _DS6ZHjAw;
        "fabric-26.3-rc-2" = _DS6ZHjAw;
        "fabric-26.3-rc-3" = _DS6ZHjAw;
        "fabric-26.3" = _DS6ZHjAw;
        ...
        "quilt-26.2" = _DS6ZHjAw;
        "quilt-26.3-snapshot-1" = _DS6ZHjAw;
        "quilt-26.3-snapshot-2" = _DS6ZHjAw;
        "quilt-26.3-snapshot-3" = _DS6ZHjAw;
        "quilt-26.3-snapshot-4" = _DS6ZHjAw;
        "quilt-26.3-snapshot-5" = _DS6ZHjAw;
        "quilt-26.3-snapshot-6" = _DS6ZHjAw;
        "quilt-26.3-snapshot-7" = _DS6ZHjAw;
        "quilt-26.3-snapshot-8" = _DS6ZHjAw;
        "quilt-26.3-snapshot-9" = _DS6ZHjAw;
        "quilt-26.3-snapshot-10" = _DS6ZHjAw;
        "quilt-26.3-pre-1" = _DS6ZHjAw;
        "quilt-26.3-pre-2" = _DS6ZHjAw;
        "quilt-26.3-pre-3" = _DS6ZHjAw;
        "quilt-26.3-rc-1" = _DS6ZHjAw;
        "quilt-26.3-rc-2" = _DS6ZHjAw;
        "quilt-26.3-rc-3" = _DS6ZHjAw;
        "quilt-26.3" = _DS6ZHjAw;
        "pkg-1.0.0" = _x3EbaP7C;
        "pkg-2" = _Y1DjoOm7;
        "pkg-1.0.3" = _JcnrpArG;
        "pkg-3" = _AiqL51kA;
        ...
        "pkg-1" = _Y7a48wG5;
        "pkg-26.2" = _gBl2xPuJ;
        "pkg-26.2_fix" = _1LB09vc4;
        "pkg-26.2_2" = _DS6ZHjAw;
        "default" = _DS6ZHjAw;
    });
