...
let
    ...
    in {
        ...
        "pkg-3.5.1" = _MacSMl0V;
        "pkg-0.6.7" = _2cKKuqNq;
        "pkg-1.0.12" = _A9Eik4Ie;
        "pkg-1.4.6" = _rJt930YF;
        "pkg-1.11.4" = _RPfIJYsS;
        "pkg-2.6.36" = _7KW59Orf;
        "pkg-2.7.10" = _uaHFpxje;
        "pkg-2.10.17" = _jGMP2YJZ;
        "pkg-3.2.6" = _ezjY1zWy;
        "pkg-3.5.2" = _UG6qDhny;
        "pkg-3.5.3" = _Z6h0bZ2L;
        "pkg-3.5.4" = _6HCIvZLn;
        ...
        "pkg-4.0.8" = _Aoj1KZ63;
        "pkg-4.0.9" = _YJ66q86o;
        "pkg-4.0.10" = _XkmJusnk;
        "pkg-4.0.11" = _k9nMyq7k;
        "pkg-4.0.12" = _qHfhQ1ME;
        "pkg-4.0.13" = _pZU5i6Gj;
        "pkg-4.0.14" = _92GvkfhK;
        "pkg-4.0.15" = _R0xY2fam;
        "pkg-4.0.16" = _kskuHEPz;
        "pkg-4.0.17" = _9ixT4kTA;
        "pkg-4.0.18" = _mnAAoXt0;
        "pkg-4.0.19" = _20on1lC2;
        "pkg-4.0.20" = _plGtVYM9;
        "pkg-4.0.21" = _LAPWO2cv;
        "pkg-4.0.22" = _QCj05y6w;
        "pkg-4.0.23" = _R19LfYhN;
        "pkg-4.0.24" = _rDYDPFgC;
        "pkg-4.0.25" = _5QBZXkgM;
        "pkg-4.0.26" = _pmykfQzb;
        "pkg-4.0.27" = _KiCYTX36;
        "pkg-4.0.27.1" = _U8kuubQl;
        "pkg-4.0.28" = _MPlGgm6w;
        "pkg-3.6.7" = _2Chvw4VA;
        "pkg-4.0.28.1" = _E9XOZA3G;
        "pkg-4.0.29" = _GBr5HE1T;
        "pkg-4.0.30" = _hdAjBFOy;
        "pkg-4.1.0" = _yVFlgqh2;
        "pkg-4.1.1" = _rROdy7b1;
        "pkg-4.1.2" = _DqonLmu1;
        "pkg-4.1.0.1" = _x409ZDB1;
        "pkg-4.1.0.2" = _HZ1A86DB;
        "pkg-4.1.3.1" = _lW9ieUhR;
        "pkg-4.1.4" = _tWOe94ZI;
        "pkg-4.1.5" = _jNYWml2K;
        "pkg-4.1.3" = _k02JqA6e;
        "pkg-4.1.6" = _7LBkCbM8;
        "pkg-4.1.6.1" = _LNwmc5Rt;
        "pkg-4.1.7" = _7slcZyF0;
        "pkg-4.1.8" = _C1Pw9jL2;
        "pkg-4.1.9" = _rY8TEclw;
        "pkg-4.1.10" = _XwtlKy30;
        "pkg-4.1.10.1" = _pfdWqD3i;
        "pkg-4.2.0" = _EQUMeyyF;
        "pkg-4.2.1" = _oxncNKk9;
