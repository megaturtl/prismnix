...
let
    versions = (let
        ...
        _bPcwg4B0 = {
            "id" = "bPcwg4B0";
            "file" = "Realistic Mobs - 7.0.zip";
            "hash" = "sha512-C+XtVor255fRjGPR+ZSR4/xmQKK6oFM0AbBwHbAg9UeB76BgVOyNfYfi9K/jHelJJTJlGxZ9nauCDrSZJHV5kw==";
        };
    in {
        "A6g8wTuM" = _A6g8wTuM;
        "FMIPVu7b" = _FMIPVu7b;
        ...
        "oNHxBmz1" = _oNHxBmz1;
        "bPcwg4B0" = _bPcwg4B0;
        "minecraft-1.20.1" = _bPcwg4B0;
        "minecraft-1.21" = _bPcwg4B0;
        "minecraft-1.21.1" = _bPcwg4B0;
        "minecraft-1.16.5" = _bPcwg4B0;
        "minecraft-1.18.2" = _bPcwg4B0;
        "minecraft-1.19.2" = _bPcwg4B0;
        "minecraft-1.20.4" = _bPcwg4B0;
        "minecraft-1.21.4" = _bPcwg4B0;
        "minecraft-1.21.5" = _bPcwg4B0;
        "minecraft-1.21.6" = _bPcwg4B0;
        "minecraft-1.21.7" = _bPcwg4B0;
        "minecraft-1.21.8" = _bPcwg4B0;
        "minecraft-1.21.9" = _bPcwg4B0;
        "minecraft-1.21.10" = _bPcwg4B0;
        "minecraft-1.16" = _bPcwg4B0;
        "minecraft-1.16.1" = _bPcwg4B0;
        "minecraft-1.16.2" = _bPcwg4B0;
        "minecraft-1.16.3" = _bPcwg4B0;
        "minecraft-1.16.4" = _bPcwg4B0;
        "minecraft-1.18" = _bPcwg4B0;
        "minecraft-1.18.1" = _bPcwg4B0;
        "minecraft-1.19" = _bPcwg4B0;
        "minecraft-1.19.1" = _bPcwg4B0;
        "minecraft-1.19.3" = _bPcwg4B0;
        "minecraft-1.19.4" = _bPcwg4B0;
        "minecraft-1.20" = _bPcwg4B0;
        "minecraft-1.20.2" = _bPcwg4B0;
        "minecraft-1.20.3" = _bPcwg4B0;
        "minecraft-1.20.5" = _bPcwg4B0;
        "minecraft-1.20.6" = _bPcwg4B0;
        "minecraft-1.21.2" = _bPcwg4B0;
        "minecraft-1.21.3" = _bPcwg4B0;
        "minecraft-1.21.11" = _bPcwg4B0;
        "minecraft-1.17" = _bPcwg4B0;
        "minecraft-1.17.1" = _bPcwg4B0;
        "minecraft-26.1" = _bPcwg4B0;
        "minecraft-26.1.1" = _bPcwg4B0;
        "minecraft-26.1.2" = _bPcwg4B0;
        "minecraft-26.2" = _bPcwg4B0;
        "minecraft-26.3" = _bPcwg4B0;
        "pkg-1.0.0" = _FMIPVu7b;
        "pkg-2.0.0" = _W2UKHyut;
        "pkg-3.0.0" = _Fd5O6Pxs;
        "pkg-4.0.0" = _YHGw7onQ;
