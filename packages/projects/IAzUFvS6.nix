...
let
    versions = (let
        ...
        _zqgEpDHN = {
            "id" = "zqgEpDHN";
            "file" = "fwa+26.2-1.2.37.jar";
            "hash" = "sha512-RwaAXaQYbDdm/RUgHkPLZc8gzvwizNlBnE6ilFcV/Yv83VmXUWUYzyOZqUwezffU8BfVndGD/SOvCGf5BHSoQw==";
        };
        _8VpXx1Mx = {
            "id" = "8VpXx1Mx";
            "file" = "fwa+26.1.2-1.2.37.jar";
            "hash" = "sha512-AiA0VKqO0eQYGbcaXqz6exgnRaE6nmHVaY+ulYjd37w/ggOgidSKasDSc/C+SpyHS1NvfEUASTllUZtHg1kojw==";
        };
        _j29TZhA7 = {
            "id" = "j29TZhA7";
            "file" = "fwa+1.21.11-1.2.37.jar";
            "hash" = "sha512-p45ccy58EkrHMYcg8cejZzXOQAaqoSQuVxtj4wLXwnsLMGhyllMbqYt/pfFNv4+wcuakuVBPuBvSMXLVniRp0A==";
        };
        _N79lNbxg = {
            "id" = "N79lNbxg";
            "file" = "fwa+26.1.2-neoforge-1.2.37.jar";
            "hash" = "sha512-01vVHYkxEPSv3GonrcPe+JI38k8bqfJcdKfnzbBiEpxbaFn8EQenmYHNTrAgr7qjPr7c844wYkaMp5qVWVLYGQ==";
        };
        _hHPQ7quH = {
            "id" = "hHPQ7quH";
            "file" = "fwa+26.2-1.2.38.jar";
            "hash" = "sha512-l+EvXnRGWjyMNLN6APHV4Xmi/kZuCA1pOE9F7ER6pqrfCj9BeNTzyn4lU/1KlvGXVZrKSosggtngIhn+KWiMpA==";
        };
        _HEzgitzG = {
            "id" = "HEzgitzG";
            "file" = "fwa+26.1.2-1.2.38.jar";
            "hash" = "sha512-p6eExeWwN1Tr2CqfLmmncAkzdce/EGJP/JPFUZlppedeqoWCScFpIEg9XsLVqTxBGpdytKD0XXja+/Zb0xaqFQ==";
        };
        _SFhXzxWQ = {
            "id" = "SFhXzxWQ";
            "file" = "fwa+26.1.2-neoforge-1.2.38.jar";
            "hash" = "sha512-vJCb+4fGt1HbCR69b7du+i0MaseezDTW4mEAAnxxJ32FIdtK2xPs1T2UdMQcrOEaGyiasnLfp9oR4mZ154GSHg==";
        };
        _UcSTMRPU = {
            "id" = "UcSTMRPU";
            "file" = "fwa+26.2-1.2.38-patch.1.jar";
            "hash" = "sha512-qgEMd34AUxhQu8mMGZUtECIuYISh14dVvU2Mn8Fowh1Lu6gqMLsywPxfvFFEGzZefnQb2/ysdtf91WDAmbnVgQ==";
        };
        _vdNn7E7r = {
            "id" = "vdNn7E7r";
            "file" = "fwa+26.1.2-1.2.38-patch.1.jar";
            "hash" = "sha512-0U08xcvec3EOfA14vFhdqk9b69/sRe5lPVb+euk7JZUdOJPAJhHf7DO9a7tbSFGvKmQ125nhtNIZ0RouMTqsVQ==";
        };
        _Ttsqv09f = {
            "id" = "Ttsqv09f";
            "file" = "fwa+26.1.2-neoforge-1.2.38-patch.1.jar";
            "hash" = "sha512-AWVMXJ3LQZyuG7zdh23y5zkIJVz9q7tG2UCzb1e+0tZexxsKL76i7T1NDIdbdlNj/c3wSMlIW74RVATAnGJkhA==";
        };
        _rgOFJApw = {
            "id" = "rgOFJApw";
            "file" = "fwa+26.2-1.2.38-patch.2.jar";
            "hash" = "sha512-JFo6xx6zoz7lvD2TVwNqpM76h5uj2fMHLVSo7d3ZzwyF4POYSHzMFmss8RtTkkpYpuQrfGivVdFH1s780nbnEQ==";
        };
        _b7dcvcUT = {
            "id" = "b7dcvcUT";
            "file" = "fwa+26.1.2-1.2.38-patch.2.jar";
            "hash" = "sha512-BX0eokwJse/rjA0298swFc/BSoEpwHTE6GHAFiM9MkAe2zc2B0OveGX63F/Etc7v/KKHMCFoSfQYeqWchRcDrA==";
        };
        _3tDuuwTu = {
            "id" = "3tDuuwTu";
            "file" = "fwa+26.1.2-neoforge-1.2.38-patch.2.jar";
            "hash" = "sha512-/jPMM7+wbZNP1LdxJD9+6CCvkxlB2AoIHBcJxJWedJapkrK5CAN7fW4pZvTxID6MPQ9TnSSGJdBGOh9y36bHTQ==";
        };
        _wwgpuhME = {
            "id" = "wwgpuhME";
            "file" = "fwa+1.21.11-1.2.38-patch.2.jar";
            "hash" = "sha512-/SQuT4h8V9O9A1/8k9B6SOkd6G/Oh84GmKl4SX9ASfS65NsPdwdgUohgyIo2G8zkSBKmi/NMgx65rp01sO3/4A==";
        };
        _56h6sbKt = {
            "id" = "56h6sbKt";
            "file" = "fwa+26.2-1.2.39.jar";
            "hash" = "sha512-PclhwhnHfs+ouzd2QVSOdKmjjgwAl45QdJhDR+VdMSdi7RuTGlV++Km671Vmd84zAFT+dK8KkbFf3kvXlGCb4Q==";
        };
        _Hdhitpvj = {
            "id" = "Hdhitpvj";
            "file" = "fwa+26.2-1.2.39-patch.1.jar";
            "hash" = "sha512-2SLn2qC5D7Dqh59vB/miLOg4IyJTdBuBXticvBruOctztmPLclntlZPjjuWemSp8JY0HbClaBhvuh8lwecKWkw==";
        };
        _xyZlTCTk = {
            "id" = "xyZlTCTk";
            "file" = "fwa+26.1.2-1.2.39-patch.1.jar";
            "hash" = "sha512-K43ZJACF3Em8PWOAk6rLElhwadWrqWcbG31Ygy3QeSRa+nkI5/atH9bdCtrSSpTcuxjFYx3RmqRCXD1vLLWR2g==";
        };
        _hqq3x8Rz = {
            "id" = "hqq3x8Rz";
            "file" = "fwa+26.3-rc-3-1.2.39-patch.1.jar";
            "hash" = "sha512-buN9KBMscgeZp/GTU/z3Di/YfUq2hcTEBJjp0lky4aOUFfJ9qegmqYBqRXLGSt7ZMGkScThPc+qC1wCy8hSSzg==";
        };
        _o16tHNup = {
            "id" = "o16tHNup";
            "file" = "fwa+26.3-rc-3-1.2.39-patch.1.jar";
    ...
    in {
        ...
        "neoforge-26.1" = _3tDuuwTu;
        "neoforge-26.1.1" = _3tDuuwTu;
        "neoforge-26.1.2" = _3tDuuwTu;
        ...
        "pkg-1.0.8" = _Co6XqL2Q;
        "pkg-1.0.9" = _Xk90PBKd;
        "pkg-1.0.10" = _98UkTACS;
        "pkg-1.0.11" = _l6YldTQg;
        "pkg-1.0.12" = _xbVGWr8M;
        "pkg-1.0.13" = _i813iQdQ;
        "pkg-1.0.14" = _ze1iNHSJ;
        "pkg-1.0.15" = _KPdGzBvt;
        "pkg-1.1.0" = _dVlxdIJG;
        "pkg-1.1.1" = _MCdZAOkN;
        "pkg-1.1.2" = _XCHdEYZf;
        "pkg-1.1.3" = _M5Slj8h2;
        "pkg-1.1.4" = _jZHZ7UeU;
        "pkg-1.1.5" = _N3JuaL02;
        "pkg-1.1.6-beta" = _xSftaojC;
        "pkg-1.1.6" = _Db4Q47Bq;
        "pkg-1.1.7" = _N3nJR7XR;
        "pkg-1.1.8" = _t3Lgeh70;
        "pkg-1.1.8-beta" = _Q6AaOKRS;
        "pkg-1.1.9" = _7odczmfs;
        "pkg-1.1.10" = _Skxytfcj;
        "pkg-1.1.11-beta" = _tCb0rCYd;
        "pkg-1.1.10-beta.2" = _rU8P6DG0;
        "pkg-1.1.10-beta.3" = _bNLFMEki;
        "pkg-1.1.10-beta.4" = _VsvBrOUD;
        "pkg-1.1.11" = _xyhvEqzp;
        "pkg-1.1.12" = _SntjE3Op;
        "pkg-1.1.12-beta" = _HzfRf7Bf;
        "pkg-1.1.12-1" = _OYjlUK1E;
        "pkg-1.1.13" = _dPYboTJm;
        "pkg-1.1.14" = _4J3hdUeJ;
        "pkg-1.1.15" = _ZVOnUuvi;
        "pkg-1.1.15-beta" = _lR1ukBl1;
        "pkg-1.1.16-beta" = _pXrYUNrl;
        "pkg-1.1.16" = _4PhoZLjA;
        "pkg-1.1.17-beta" = _iYGbzD87;
        "pkg-1.1.17" = _yGEb1emA;
        "pkg-1.1.18" = _YPZcwno9;
        "pkg-1.2.0" = _qfmOY8Ul;
        "pkg-1.2.1" = _XC61d3We;
        "pkg-1.2.2" = _vdX6yLrC;
        "pkg-1.2.3" = _4DvHw7uR;
        ...
        "pkg-1.2.8" = _PtfS8wiu;
        "pkg-1.2.9" = _FVsUlnNY;
        "pkg-1.2.10" = _Ay0TQvBG;
        "pkg-1.2.10-hotfix.1" = _ozwkHaHx;
        "pkg-1.2.11" = _z412x1gI;
        "pkg-1.2.12" = _1wdhUGcH;
        "pkg-1.2.13" = _27t8CEVK;
        "pkg-1.2.14" = _96vhEXaO;
        "pkg-1.2.15" = _V1p5gFi5;
        "pkg-1.2.15.1" = _qnkXEWrF;
        "pkg-1.2.16" = _6zvixTKe;
        "pkg-1.2.17" = _BC2DCdqZ;
        "pkg-1.2.18" = _roR4A9C3;
        "pkg-1.2.18-hotfix.1" = _QI439efX;
        "pkg-1.2.18-hotifx.1" = _6auSCEN5;
        "pkg-1.2.19" = _dzKOIJGT;
        "pkg-1.2.20" = _qkC5r8WR;
        "pkg-1.2.21" = _MIDzfzJy;
        "pkg-1.2.22" = _dts1CBSp;
        "pkg-1.2.23" = _sciNjZiX;
        "pkg-1.2.24" = _kN5lJs1y;
        "pkg-1.2.25" = _tnozo0k7;
        "pkg-1.2.26" = _XO1SlI2m;
        "pkg-1.2.27" = _f0n8JoLS;
        "pkg-1.2.28" = _tO9pn19v;
        "pkg-1.2.29" = _anulNBcN;
        "pkg-1.2.30" = _aER43xba;
        "pkg-1.2.31" = _79A6vRlK;
        "pkg-1.2.32" = _qct9mgVk;
        "pkg-1.2.33" = _sXzPVN5M;
        "pkg-1.2.34" = _mIaxWd5b;
        "pkg-1.2.35" = _Ic6JGw9C;
        "pkg-1.2.36" = _BPpHtyTw;
        "pkg-1.2.37" = _N79lNbxg;
        "pkg-1.2.38" = _SFhXzxWQ;
        "pkg-1.2.38-patch.1" = _Ttsqv09f;
