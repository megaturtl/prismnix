...
let
    versions = (let
        ...
        _uc9eyvPJ = {
            "id" = "uc9eyvPJ";
            "file" = "ucutils-3.2.0.jar";
            "hash" = "sha512-MRffS1bd8wiXFbOmtm4S/Hb3lTVNp4Ny97WxSezrTG+bCeXiEZ6CNWZtb2KOTm/W3IEMVIVysvwU91/yK/BniA==";
        };
        _I7SxaZQw = {
            "id" = "I7SxaZQw";
            "file" = "ucutils-3.3.0.jar";
            "hash" = "sha512-wzORZ9a0RaWpo+BKtEBAnE1pYQ2DBSmWjNzFVTjHC5gG22g3vuaqg8HvCL+JWnRZq0xiiQXRZRbLehq0+de9kQ==";
        };
    in {
        "onkD0TJt" = _onkD0TJt;
        "FrMIaP9i" = _FrMIaP9i;
        ...
        "pkg-2.7.1" = _LZYxKV5h;
        "pkg-2.8.0" = _gdHe5Wk4;
        "pkg-3.0.0-pre.1" = _EOFTqLVL;
        "pkg-3.0.0-pre.2" = _bdbzLgDU;
        "pkg-3.0.0" = _SnYTqaee;
        "pkg-3.0.1" = _RDHkKX0A;
        "pkg-3.1.0" = _K51MU7U6;
        "pkg-3.2.0" = _uc9eyvPJ;
