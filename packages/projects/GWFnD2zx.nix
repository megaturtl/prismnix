...
let
    versions = (let
        ...
        _ZyZUASTt = {
            "id" = "ZyZUASTt";
            "file" = "Armor-Stand-Arms-v2.6.0.zip";
            "hash" = "sha512-hLSjPJWXAOm8fVkChQxpjVp4mUWdJ5UFLGOaxol8i9Mo+2uK23Qjv2s5q+epazccfdK0ajhzLfjJX8g9BHfICg==";
        };
        _JdnQP3tr = {
            "id" = "JdnQP3tr";
            "file" = "armor-stand-arms-v2.6.0.jar";
            "hash" = "sha512-NX4zOnug8NTFyYChQC6g0nx2jlOdO07PQ6cbfYCiKUt7dKF5UGU5NbupPP1Ecu1CecZYetBcVuy+ZqV7EhmzTQ==";
        };
        _p27TnOf0 = {
            "id" = "p27TnOf0";
            "file" = "Armor-Stand-Arms-v2.7.0.zip";
            "hash" = "sha512-4wckp5cWSg5VAPcl6r+uCdWp544MNFJZKch8TMoc73z5nLsn8rn9d9/mfL/dekpyitUGmfrDEtWKd/zxnhAmAg==";
        };
        _WymZne8t = {
            "id" = "WymZne8t";
    ...
    in {
        ...
        "datapack-1.21.6" = _ZyZUASTt;
        "datapack-1.21.7" = _ZyZUASTt;
        "datapack-1.21.8" = _ZyZUASTt;
        "datapack-1.21.9" = _ZyZUASTt;
        "datapack-1.21.10" = _ZyZUASTt;
        "datapack-1.21.11" = _ZyZUASTt;
        "datapack-26.1" = _ZyZUASTt;
        ...
        "fabric-1.21.6" = _JdnQP3tr;
        "fabric-1.21.7" = _JdnQP3tr;
        "fabric-1.21.8" = _JdnQP3tr;
        "fabric-1.21.9" = _JdnQP3tr;
        "fabric-1.21.10" = _JdnQP3tr;
        "fabric-1.21.11" = _JdnQP3tr;
        "fabric-26.1" = _JdnQP3tr;
        ...
        "forge-1.21.6" = _JdnQP3tr;
        "forge-1.21.7" = _JdnQP3tr;
        "forge-1.21.8" = _JdnQP3tr;
        "forge-1.21.9" = _JdnQP3tr;
        "forge-1.21.10" = _JdnQP3tr;
        "forge-1.21.11" = _JdnQP3tr;
        "forge-26.1" = _JdnQP3tr;
        ...
        "quilt-1.21.6" = _JdnQP3tr;
        "quilt-1.21.7" = _JdnQP3tr;
        "quilt-1.21.8" = _JdnQP3tr;
        "quilt-1.21.9" = _JdnQP3tr;
        "quilt-1.21.10" = _JdnQP3tr;
        "quilt-1.21.11" = _JdnQP3tr;
        "quilt-26.1" = _JdnQP3tr;
        ...
        "neoforge-1.21.6" = _JdnQP3tr;
        "neoforge-1.21.7" = _JdnQP3tr;
        "neoforge-1.21.8" = _JdnQP3tr;
        "neoforge-1.21.9" = _JdnQP3tr;
        "neoforge-1.21.10" = _JdnQP3tr;
        "neoforge-1.21.11" = _JdnQP3tr;
        "neoforge-26.1" = _JdnQP3tr;
        ...
        "pkg-v.2.0.0+mod" = _eM8xdeio;
        "pkg-v.2.1.0" = _YBSyNJIL;
        "pkg-v.2.1.0+mod" = _8MgFmZ1e;
        "pkg-v.1.1.0" = _LGdbzoz6;
        "pkg-v.1.1.0+mod" = _xp3NLiyF;
        "pkg-v.2.2.0" = _OFsah8OI;
        "pkg-v.2.2.0+mod" = _8D69iXCE;
        "pkg-v.1.2.0" = _JXRqWP0l;
        "pkg-v.1.3.0" = _TaJI9ErY;
        "pkg-v.1.3.0+mod" = _5Z8eviLA;
        "pkg-v.2.3.0" = _AyR7YXa9;
        "pkg-v.2.3.0+mod" = _zwCaGnna;
        "pkg-v.2.4.0" = _1p27Sqbw;
        "pkg-v.2.4.0+mod" = _pkbG4wpr;
        "pkg-v.1.4.0" = _xlAEdFWG;
        "pkg-v.1.4.0+mod" = _pJBg0bSy;
        "pkg-v.1.2.0+mod" = _IwGBWBWZ;
        "pkg-v.2.5.0" = _akCgcjZk;
        "pkg-v.2.5.0+mod" = _qTMFSkvO;
        "pkg-v.2.5.1" = _e5Ibqu8U;
        "pkg-v.2.5.1+mod" = _OITCVITw;
        "pkg-v2.5.1" = _TQXv35wz;
        "pkg-v2.5.1+mod" = _Jl0rEMbH;
        "pkg-v2.5.2" = _4fQo6DgZ;
        "pkg-v2.5.2+mod" = _vfDsjDOR;
        "pkg-v2.5.3" = _Vi3mZg1S;
        "pkg-v2.5.3+mod" = _IzSBQUgQ;
        "pkg-v2.5.4" = _RCryqzEq;
        "pkg-v2.5.4+mod" = _eN72TfxM;
        "pkg-v2.5.4-mc1.21.6+" = _OWgirOY1;
        "pkg-v2.5.4-mc1.21.6++mod" = _nZQKxOYJ;
        "pkg-v2.5.5" = _DVWzt6oj;
        "pkg-v2.5.5+mod" = _SWdYvX7u;
        "pkg-v2.5.6" = _2zmYWnsd;
        "pkg-v2.5.6+mod" = _XC362YZI;
        "pkg-v2.5.7" = _eAXkTZDV;
        "pkg-v2.5.7+mod" = _t0Eqyt58;
        "pkg-v2.5.7.0" = _fycA97xA;
        "pkg-v2.5.7.0+mod" = _FL0WFZWD;
        "pkg-v2.5.7.1" = _Evte1NVW;
        "pkg-v2.5.7.1+mod" = _FdSSL6Rb;
        "pkg-v2.5.7.2" = _g6BfpFbW;
        "pkg-v2.5.7.2+mod" = _mQbwtjmm;
        "pkg-v2.5.8" = _vtdihqfs;
        "pkg-v2.5.8+mod" = _WrG6cEyS;
        "pkg-v2.6.0" = _ZyZUASTt;
