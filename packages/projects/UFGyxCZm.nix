...
let
    ...
    in {
        ...
        "pkg-1.0.4-ALPHA-4" = _lAGM3QMP;
        "pkg-1.0.4-ALPHA-4.1" = _QYXGj9cL;
        "pkg-1.0.4-BETA-4.2" = _RvuynMp4;
        "pkg-1.0.4-BETA-4.3" = _j6G4SIUH;
        "pkg-1.0.4-ALPHA-6" = _ksQOV9kV;
        "pkg-1.0.4-ALPHA-6.1" = _RReIi9lH;
        "pkg-1.0.4-BETA-7" = _AUAjlvcV;
        "pkg-1.0.4-pre" = _EftJ1DhK;
        "pkg-1.0.4-pre-3" = _oWhU4cLg;
        "pkg-1.0.4-pre-4" = _k5097UWG;
        "pkg-1.0.4-pre-5" = _y0vFUr7m;
        "pkg-1.0.4-pre-5.1" = _V8kqh7wH;
        "pkg-1.0.4-pre-6" = _2unrhiPo;
        "pkg-1.0.4-pre-6.1" = _Hi8hnooH;
        "pkg-1.0.4-pre-6.2" = _3EZWcig2;
        "pkg-1.0.4-pre-7" = _QRbWlYCE;
        "pkg-1.0.4-pre-8" = _ObngRTsr;
        "pkg-1.0.4-pre-9" = _gazaTHox;
        "pkg-1.0.4-pre-9.1" = _lAhZBW2D;
        "pkg-1.0.4" = _Wx4IuTpr;
        "pkg-1.0.4-fix-1" = _mGPhuBY7;
        "pkg-1.0.4-fix-2" = _29jC3kk1;
        "pkg-1.0.4-fix-3" = _54y7fPyT;
        "pkg-1.0.4-fix-4" = _zltwfUXs;
        "pkg-1.0.4-fix-5" = _f8if9e7P;
        "pkg-1.0.5-ALPHA-1" = _qcBVL4E3;
        "pkg-1.0.5-ALPHA-1.1" = _a1xlbAGz;
        "pkg-1.0.5-ALPHA-1.2" = _n7bgFAoZ;
        "pkg-1.0.5-ALPHA-2" = _uGN2zBf4;
        "pkg-1.0.5-ALPHA-3" = _P358oENL;
        "pkg-1.0.5-ALPHA-3.1" = _1AXGQbvi;
        "pkg-1.0.5-ALPHA-2.1" = _fhvweItd;
        "pkg-1.0.5-ALPHA-3.2" = _o0oZimsW;
        "pkg-1.0.5-ALPHA-2.2" = _nXknBWsp;
        "pkg-1.0.5-BETA-4" = _WfK0zVmE;
        "pkg-1.0.5-BETA-4.1" = _jaBPNdJD;
        "pkg-1.0.5-BETA-4.2" = _VEJx5FFV;
        "pkg-1.0.5-ALPHA-5" = _N3RkDnas;
        "pkg-1.0.5-ALPHA-5.1" = _XmftHOtQ;
        "pkg-1.0.5-ALPHA-6" = _l0riBqHp;
        "pkg-1.0.5-BETA-6.1" = _b3jiJbZS;
        "pkg-1.0.5-BETA-6.2" = _ZAzhp8OE;
        "pkg-1.0.5-BETA-6.3" = _FxKHS1n7;
        "pkg-1.0.5-BETA-6.4" = _nn2eb69b;
        "pkg-1.0.5-BETA-6.5" = _jV1Q1kP4;
        "pkg-1.0.5-BETA-7" = _IvTF2KFX;
        "pkg-1.0.5-BETA-7.1" = _jmYRMAAe;
        "pkg-1.0.5-ALPHA-8" = _QUdrjJYt;
        "pkg-1.0.5-ALPHA-8.1" = _bY58iwbG;
        "pkg-1.0.5-ALPHA-8.2" = _JAxersKZ;
        "pkg-1.0.5-ALPHA-8.3" = _hAeDgoYA;
        "pkg-1.0.5-ALPHA-8.4" = _EDqGq7s6;
        "pkg-1.0.5-BETA-8.5" = _3MdQtvpd;
        "pkg-1.0.5-BETA-9" = _eReffDs8;
        "pkg-1.0.5-BETA-9.1" = _CO0L529u;
        "pkg-1.0.5-ALPHA-10" = _8BMtz8PL;
        "pkg-1.0.5-ALPHA-11" = _thzbne3E;
        "pkg-1.0.5-ALPHA-11.1" = _aa96cjL6;
