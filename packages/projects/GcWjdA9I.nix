...
let
    ...
    in {
        ...
        "pkg-0.8.4" = _eJs5BPcy;
        "pkg-0.8.5" = _glNpS49Q;
        "pkg-0.9.0-dev.1" = _nzayf0vT;
        "pkg-0.9.0-dev.2" = _WkYufsBv;
        "pkg-0.9.0-dev.3" = _65EmNeSo;
        "pkg-0.9.0-dev.4" = _oLSTbZXM;
        "pkg-0.9.0" = _SZbR4R54;
        "pkg-0.9.1" = _8tPQJhzV;
        "pkg-0.9.2" = _jwGlbCV3;
        "pkg-0.9.3" = _SK74oJ3F;
        "pkg-0.9.4" = _xoL5eTJX;
        "pkg-0.10.0-dev.1" = _jzx8nfNF;
        "pkg-0.10.0-dev.2" = _c4s7Zbz0;
        "pkg-0.10.0-dev.3" = _VBJVQr5k;
        "pkg-0.10.0-dev.4" = _fpvuC4rF;
        "pkg-0.10.0-dev.5" = _j62IqVv1;
        "pkg-0.10.0-dev.6" = _xl3PIS2V;
        "pkg-0.10.0-dev.7" = _GNZ1QcVs;
        "pkg-0.10.0-dev.8" = _PanSzHVC;
        "pkg-0.10.0-dev.9" = _CnyXjyOO;
        "pkg-0.10.0-dev.10" = _3LX4TUEJ;
        "pkg-0.10.0-dev.11" = _re5ZP4ae;
        "pkg-0.10.0-dev.12" = _X8dJ9Bm8;
        "pkg-0.9.5" = _dR5rKVuL;
        "pkg-0.10.0-dev.13" = _eRgu51VW;
        "pkg-0.10.0-dev.14" = _AzlkNP6K;
        "pkg-0.10.0-dev.15" = _c7Fc4I7I;
        "pkg-0.9.6" = _Est0iV5r;
        "pkg-0.10.0-dev.16" = _pQ04F8DK;
        "pkg-0.10.0-dev.17" = _M7H0THrh;
        "pkg-0.10.0-dev.18" = _g4mrp8Tw;
        "pkg-0.10.0-dev.19" = _MZ6YndxD;
        "pkg-0.10.0-dev.20" = _CDu87Ijx;
        "pkg-0.10.0-dev.21.pre1" = _Q0t4XYBi;
        "pkg-0.10.0-dev.21.pre2" = _ofNjwck3;
        "pkg-0.10.0-dev.21" = _f02CW9Kn;
        "pkg-0.10.0-dev.22" = _aJFx8KWb;
        "pkg-0.10.0-dev.20+alpha.1" = _PnnSBGlW;
        "pkg-0.10.0-dev.19+alpha.1" = _JirOpckS;
        "pkg-0.10.0-dev.23" = _jBH9KX9D;
        "pkg-0.10.0-dev.20+beta.2" = _4sESRgiU;
        "pkg-0.10.0-dev.20+beta.3" = _flsBPpIL;
        "pkg-0.10.0-dev.20+beta.1" = _LXxCKsbO;
        "pkg-0.10.0-dev.19+alpha.2" = _SdX6LDeV;
        "pkg-0.10.0-dev.24+pre.1" = _SjGToM73;
        "pkg-0.10.0-dev.20+arne.2" = _ROauLEoP;
        "pkg-0.10.0-dev.24" = _Afp8AWEJ;
        "pkg-0.10.0-dev.19+arne.1" = _lUVomngZ;
        "pkg-0.10.0-dev.25" = _KfknnBMq;
        "pkg-0.10.0-dev.26" = _LhSZt6EF;
        "pkg-0.10.0-dev.20+arne.6" = _5ZOdZvFB;
        "pkg-0.10.0-dev.27" = _mpWdNRn1;
        "pkg-0.10.0-dev.20+arne.1" = _RB9rCbDS;
        "pkg-0.10.0-dev.21+arne.1" = _zKgKuVqX;
        "pkg-0.10.0-dev.21+beta.1" = _2nS83Qf7;
        "pkg-0.10.0-dev.28" = _ONcFAEMd;
        "pkg-0.10.0-dev.21+arne.2" = _2lJvqczS;
        "pkg-0.10.0-dev.29" = _iQzeIzoA;
        "pkg-0.10.0-dev.21+arne.3" = _BYZbkbtD;
        "pkg-0.10.0-dev.21+beta.2" = _N37PPlGv;
        "pkg-0.10.0-dev.30" = _YVnURsNX;
        "pkg-0.10.0-dev.21+arne.4" = _dBwOdoCw;
        "pkg-0.10.0-dev.21+arne.5" = _IQkidUS4;
        "pkg-0.10.0-dev.23.nomixin" = _6PDV12GO;
        "pkg-0.10.0-dev.21+arne.6" = _Uxcq4Jeh;
        "pkg-0.10.0-dev.21+arne.7" = _5AHE21Q9;
        "pkg-0.10.0-dev.22+beta.1" = _xENxlGYG;
        "pkg-0.10.0-dev.22+beta.2" = _WuABs62s;
        "pkg-0.10.0-dev.31" = _IjPDJthB;
        "pkg-0.10.0-dev.21+arne.8" = _Lav6afIY;
        "pkg-0.11.0-pre.1" = _C5EHWwTF;
        "pkg-0.11.0" = _IY24B9AK;
        "pkg-0.11.1" = _gxgIbzfz;
        "pkg-0.11.3" = _PbcpAEvc;
        "pkg-0.11.4" = _O2DJgzRi;
        "pkg-0.11.5" = _o0AtO0eq;
        "pkg-0.11.6" = _Frx9MtJc;
        "pkg-0.11.7" = _ym1OdFaV;
        "pkg-0.11.8" = _Bg19XPU7;
        "pkg-0.12.0" = _QXOpZ38S;
        "pkg-0.12.1-nopotionhudshift.1" = _HXSuzGfa;
        "pkg-0.12.1" = _V21ryIsV;
        "pkg-0.50.0" = _Tcv1nnVY;
        "pkg-0.50.1" = _ForaIThv;
        "pkg-0.51.0" = _xVVI2sNr;
        "pkg-0.51.1" = _AJhIEGVJ;
        "pkg-0.52.0" = _dQTgVbDe;
        "pkg-0.52.1" = _WHsimdn0;
        "pkg-0.13.0" = _M3rtbAPE;
        "pkg-0.53.0" = _AxTFzVcz;
        "pkg-0.54.0" = _3zGlToR7;
        "pkg-0.14.0" = _HXBBAweZ;
        "pkg-0.14.1-pre.1" = _vEQ2PjZV;
        "pkg-0.15.2" = _HQXz1vnM;
        "pkg-0.15.3" = _k7Vm0Wka;
        "pkg-0.15.4" = _jYVl3riT;
        "pkg-0.16.0" = _GnPJLycX;
        "pkg-0.16.1" = _OEchuJwf;
        "pkg-0.16.2" = _qOW15k2e;
        "pkg-0.16.3" = _V7yLDtJV;
        "pkg-0.17.0" = _wzI0QkCv;
        "pkg-0.18.0-beta.1" = _YUdoXvUT;
        "pkg-0.18.0" = _66WY7ZfT;
        "pkg-0.60.0-alpha.2" = _ZeB749FP;
        "pkg-0.18.1" = _kZJWQDi6;
        "pkg-0.18.3" = _YYfmFXPZ;
        "pkg-0.18.4-alpha.1" = _Ga4mIrD4;
        "pkg-0.19.0" = _QMD2DLj9;
        "pkg-0.60.1" = _H4hYRBvS;
        "pkg-0.20.0" = _yUa5ib7g;
        "pkg-0.20.1" = _4HqQ3ANl;
        "pkg-0.20.2" = _oExLoQk8;
        "pkg-0.21.0" = _CQI1MTlR;
        "pkg-0.21.1" = _HImqbizS;
        "pkg-0.21.2" = _TMIwi2Ws;
        "pkg-0.22.0" = _RVoqDrZJ;
        "pkg-0.21.3" = _fVqmxrpX;
        "pkg-0.21.4" = _Gz4O8EpV;
        "pkg-0.22.2" = _GBA3Tz2i;
        "pkg-0.21.5" = _k4FBa5Bu;
        "pkg-0.22.3" = _em3JWRUe;
        "pkg-0.23.0" = _KsUV4RUr;
        "pkg-0.21.6" = _f8wE52F5;
        "pkg-0.22.4" = _tcM53z78;
        "pkg-0.23.1" = _bWdPm0zw;
        "pkg-0.21.7" = _XZhYc5PW;
        "pkg-0.22.5" = _SBKEjPSG;
        "pkg-0.23.2" = _QPyPfEg3;
        "pkg-0.60.2" = _c5hvGuGn;
        "pkg-0.24.0" = _tYWlnbso;
        "pkg-0.21.8" = _dhYkRfSJ;
        "pkg-0.22.6" = _MmlUfq9s;
        "pkg-0.23.3" = _MZcHwIU7;
        "pkg-0.24.1" = _CcD4izog;
        "pkg-0.21.9" = _xTezyq2N;
        "pkg-0.22.7" = _F0kdxPzY;
        "pkg-0.23.4" = _kILcOIL5;
        "pkg-0.24.2" = _8HYCNKEB;
        "pkg-0.25.0" = _SbIommhX;
        "pkg-0.25.1" = _EcW3wuWQ;
        "pkg-0.12.3-alpha.1" = _MQW8YqA0;
        "pkg-0.25.2" = _265JKiJU;
        "pkg-0.25.3" = _UKdeUKBs;
        "pkg-0.25.4" = _USRMpjDG;
        "pkg-0.25.5" = _iS29zBBc;
        "pkg-0.26.0" = _6Aoj3UUG;
        "pkg-0.26.1" = _WptyNGJP;
        "pkg-0.26.2" = _rGx2FOox;
        "pkg-0.26.3" = _4K7Z6tDa;
        "pkg-0.25.6" = _Q32TToMO;
        "pkg-0.26.4" = _ssrRTz1W;
        "pkg-0.26.5" = _cccqKScv;
        "pkg-0.26.6" = _Uddakc3M;
        "pkg-0.27.0" = _LkQKaBeJ;
        "pkg-0.27.1" = _b68bfE0I;
        "pkg-0.26.7" = _PdAcB2av;
        "pkg-0.19.2" = _WOM5o7Zn;
        "pkg-0.27.2" = _zghuOVRx;
        "pkg-0.21.10" = _C99LEy6r;
        "pkg-0.22.8" = _YyAlxssn;
        "pkg-0.23.5" = _ifi4uRpL;
        "pkg-0.24.3" = _YrRUsIk9;
        "pkg-0.25.7" = _2kC79eY3;
        "pkg-0.26.8" = _VwmyInJJ;
        "pkg-0.27.3" = _oVx90M7U;
        "pkg-0.27.4" = _DGdkosfd;
        "pkg-0.27.5" = _jsdKvp3x;
        "pkg-0.27.6" = _4KeJMj6s;
        "pkg-0.27.7" = _5Ywu5uMw;
        "pkg-0.28.0" = _Bh1w5UpU;
        "pkg-0.28.1" = _Tdh5MxoX;
        "pkg-0.28.2" = _alF0apkB;
        "pkg-0.27.8" = _APEEwSfs;
        "pkg-0.27.9" = _UW6wRWbH;
        "pkg-0.28.3" = _7lAncM04;
        "pkg-0.27.10" = _33xvZKWh;
        "pkg-0.28.4" = _JRqAFP28;
        "pkg-0.27.11" = _Ic5sDhyu;
        "pkg-0.28.5" = _4ynmIgdW;
        "pkg-0.27.12" = _m5frsnWf;
        "pkg-0.28.6" = _pvxtUnf1;
        "pkg-0.29.0" = _cQrrLPtk;
        "pkg-0.27.13" = _zETtEctb;
        "pkg-0.28.7" = _a5Ad9ulA;
        "pkg-0.29.1" = _jASomSor;
        "pkg-0.27.14" = _wX1BkeL3;
        "pkg-0.28.8" = _CtQZ4f1P;
        "pkg-0.29.2" = _52cWF5Da;
        "pkg-0.27.15" = _ZcQ4QNNZ;
