...
let
    versions = (let
        ...
        _w4ReEpuG = {
            "id" = "w4ReEpuG";
            "file" = "Better-Leaves-9.6.zip";
            "hash" = "sha512-eT2srKTCAGVuiHUZXkKXXstiivEU4TqtIFk2i1HPRfACgPhgdTaOmt9JLoR3GKnVk730gWZOEM8aqWKNKlGo1g==";
        };
    in {
        "PZcMlF3o" = _PZcMlF3o;
        "xzMkHZJp" = _xzMkHZJp;
        ...
        "minecraft-1.20" = _w4ReEpuG;
        "minecraft-1.20.1" = _w4ReEpuG;
        "minecraft-1.20.2" = _w4ReEpuG;
        "minecraft-1.20.3" = _w4ReEpuG;
        "minecraft-1.20.4" = _w4ReEpuG;
        "minecraft-1.20.5" = _w4ReEpuG;
        "minecraft-1.20.6" = _w4ReEpuG;
        "minecraft-1.21" = _w4ReEpuG;
        "minecraft-1.21.1" = _w4ReEpuG;
        "minecraft-1.21.2" = _w4ReEpuG;
        "minecraft-1.21.3" = _w4ReEpuG;
        "minecraft-1.21.4" = _w4ReEpuG;
        "minecraft-1.21.5" = _w4ReEpuG;
        "minecraft-1.21.6" = _w4ReEpuG;
        "minecraft-1.21.7" = _w4ReEpuG;
        "minecraft-1.21.8" = _w4ReEpuG;
        "minecraft-1.21.9" = _w4ReEpuG;
        "minecraft-1.21.10" = _w4ReEpuG;
        "minecraft-1.21.11" = _w4ReEpuG;
        "minecraft-26.1" = _w4ReEpuG;
        "minecraft-26.1.1" = _w4ReEpuG;
        "minecraft-26.1.2" = _w4ReEpuG;
        "minecraft-26.2" = _w4ReEpuG;
        "pkg-7.1" = _PZcMlF3o;
        "pkg-7.2" = _xzMkHZJp;
        "pkg-8.0" = _ZO0ogwsP;
        "pkg-8.1" = _hRnbmxwC;
