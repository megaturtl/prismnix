...
let
    ...
    in {
        ...
        "pkg-1.19" = _C4Tm50oZ;
        "pkg-1.20" = _6LOaQ65c;
        "pkg-1.20.2" = _ZJL9JPhn;
        "pkg-1.20.4" = _mAsufBSM;
        "pkg-1.20.5" = _lhbDOZfG;
        "pkg-1.21" = _sJq3tQ96;
        "pkg-1.21.3" = _FODYiQLq;
        "pkg-1.21.5" = _he82oNj9;
        "pkg-1.21.6" = _DqAcjma5;
        "pkg-1.21.8" = _26oJWS3u;
        "pkg-1.21.9" = _QsU9VvI0;
