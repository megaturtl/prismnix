...
let
    versions = (let
        ...
        _WjjBqWsb = {
            "id" = "WjjBqWsb";
            "file" = "integratedrest-26.1.2-neoforge-1.1.15-208.jar";
            "hash" = "sha512-Mll1D2vBHmusU/3c50D7jjTUhuuk0E+OK2PxIL1KYXjnF9OZPzGDTMxzsROlJRJBLFW0vRuQXGQKCej3MNdorA==";
        };
        _iBkfn8HS = {
            "id" = "iBkfn8HS";
            "file" = "integratedrest-26.2-neoforge-1.1.15-209.jar";
            "hash" = "sha512-ur08KsGo8InH8l+wnTx50jPXcmFzTmg+WsavN9zewaZ3JcYivBpSo7wqfnNsxebHf4KNSrsMOny6D7208brcjA==";
        };
        _kECCIMcm = {
            "id" = "kECCIMcm";
            "file" = "integratedrest-1.21.1-neoforge-1.1.15-210.jar";
            "hash" = "sha512-NlU0v2Pr/MUJKrrrHC1sq0nZEF6egR9zOfkawmZas35n31J7G6OtJIBjiKFlJ1XntoLjh0aQhgmeCQ5VXuAy7g==";
        };
        _Gr5UxjKN = {
            "id" = "Gr5UxjKN";
            "file" = "integratedrest-26.1.2-neoforge-1.1.15-211.jar";
            "hash" = "sha512-6AZohfjyS2z4OoPyp2q7wBnuI8O2i4VIBez9g9WAQwTyoOHorHv3+qj9eaBPEy0HwSYvVUMJQU/ESIQguOyl0Q==";
        };
        _CnDNDQEo = {
            "id" = "CnDNDQEo";
    ...
    in {
        ...
        "pkg-1.19.2-1.1.6" = _i9j5L8bl;
        "pkg-1.19.2-1.1.7" = _g9xKwaPW;
        "pkg-1.19.2-1.1.8" = _obbumnms;
        "pkg-1.19.3-1.1.8" = _uyzShlm8;
        "pkg-1.19.2-1.1.9" = _BAyaHQfQ;
        "pkg-1.18.2-1.1.6" = _4D35R7tr;
        "pkg-1.19.4-1.1.8" = _PY3pX8IM;
        "pkg-1.19.4-1.1.9" = _Ey5yFdOc;
        "pkg-1.19.4-1.1.10" = _UgjjJ7HY;
        "pkg-1.20.1-1.1.10" = _66fZk5e6;
        "pkg-1.20.1-1.1.11" = _1UwsOcuo;
        "pkg-1.19.2-1.1.10" = _E1UdKHZk;
        "pkg-1.20.4-1.1.10" = _xBroEKz5;
        "pkg-1.20.4-1.1.11" = _XX1F7QXb;
        "pkg-1.20.4-1.1.12" = _TmwabvPN;
        "pkg-1.21-1.1.12" = _FurTiFNC;
        "pkg-1.21.1-1.1.12-125" = _abFc3OkG;
        "pkg-1.21.1-1.1.12-128" = _lzxxqwH1;
        "pkg-1.21.1-1.1.12-129" = _wWQyPOnS;
        "pkg-1.21.1-1.1.12-130" = _5FP5KQmU;
        "pkg-1.21.1-1.1.13" = _9VkQRyTx;
        "pkg-1.21.1-1.1.13-132" = _o6tLRIv0;
        "pkg-1.21.1-1.1.13-134" = _lHUfQfEO;
        "pkg-1.21.1-1.1.13-136" = _q00tTFsT;
        "pkg-1.21.1-1.1.13-138" = _CO6WFKmp;
        "pkg-1.21.4-1.1.12-140" = _3AGsr0F1;
        "pkg-1.21.4-1.1.12-141" = _IhxDOat5;
        "pkg-1.21.4-1.1.12-142" = _D18HZHRd;
        "pkg-1.21.1-1.1.14" = _dQQsEBFa;
        "pkg-1.21.4-1.1.12-145" = _ghNz5CGy;
        "pkg-1.21.1-1.1.14-148" = _ZtM57BqY;
        "pkg-1.21.4-1.1.12-149" = _vxuc3pmS;
        "pkg-1.21.4-1.1.12-150" = _ngYwYzpn;
        "pkg-1.21.1-1.1.15" = _GYJ5JU2n;
        "pkg-1.21.4-1.1.12-155" = _cUyfaqt6;
        "pkg-1.21.4-1.1.12-156" = _IoRLNd65;
        "pkg-1.21.1-1.1.15-158" = _GAVd98il;
        "pkg-1.21.1-1.1.15-160" = _H5x2i4LH;
        "pkg-1.21.1-1.1.15-161" = _Zk0gb1z2;
        "pkg-1.21.8-1.1.12-162" = _1jszMEFq;
        "pkg-1.21.1-1.1.15-163" = _N6omSsrb;
        "pkg-1.21.1-1.1.15-164" = _ydub4Zf6;
        "pkg-1.21.1-1.1.15-166" = _3X9DPqaf;
        "pkg-1.21.8-1.1.12-167" = _Ll7uIRV8;
        "pkg-1.21.8-1.1.12-168" = _dLi23ofA;
        "pkg-1.21.10-1.1.12-169" = _xoBHbhEI;
        "pkg-1.21.10-1.1.12-170" = _dpxZQQxi;
        "pkg-1.21.11-1.1.12-171" = _zPnOD50c;
        "pkg-1.21.11-1.1.12-172" = _mzCvNrRh;
        "pkg-1.21.1-1.1.15-173" = _KJsQeoWI;
        "pkg-1.21.1-1.1.15-174" = _Fsf9WGtc;
        "pkg-1.21.1-1.1.15-177" = _AdaRKMGv;
        "pkg-1.21.11-1.1.12-178" = _lR3tGCqa;
        "pkg-1.21.1-1.1.15-180" = _eI4MVAqJ;
        "pkg-1.21.1-1.1.15-181" = _q1fgNOFb;
        "pkg-1.21.11-1.1.12-182" = _2Gi68YT1;
        "pkg-1.21.1-1.1.15-184" = _QsP8cvfT;
        "pkg-1.21.11-1.1.12-185" = _XDqnCgf1;
        "pkg-1.21.11-1.1.12-186" = _TLpPXfPl;
        "pkg-1.21.11-1.1.12-187" = _loXmry5r;
        "pkg-26.1.1-1.1.12-188" = _6DlPRDVO;
        "pkg-26.1.1-1.1.12-189" = _cvp2jK8u;
        "pkg-26.1.1-1.1.15" = _hIkwwAc3;
        "pkg-26.1.1-1.1.15-194" = _w4slQbMF;
        "pkg-26.1.2-1.1.15" = _KwTziH1x;
        "pkg-26.2-1.1.15-198" = _T7XaNfGs;
        "pkg-1.21.11-1.1.12-200" = _ggxq6oL4;
        "pkg-26.1.2-1.1.15-202" = _pMQfC8DW;
        "pkg-26.2-1.1.15-203" = _6WoAPnVn;
        "pkg-1.21.1-1.1.15-205" = _yZM7eyFD;
        "pkg-26.1.2-1.1.15-206" = _8h2cyiCA;
        "pkg-26.2-1.1.15-207" = _VXnNtPkT;
        "pkg-26.1.2-1.1.15-208" = _WjjBqWsb;
        "pkg-26.2-1.1.15-209" = _iBkfn8HS;
