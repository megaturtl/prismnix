...
let
    ...
    in {
        ...
        "pkg-21.5.0" = _UxloYa6t;
        "pkg-21.5.1+fabric-1.21.5" = _pQGLLi9U;
        "pkg-21.5.1+neoforge-1.21.5" = _m8gn3WvY;
        "pkg-21.5.2+forge-1.21.5" = _qJwlDoOG;
        "pkg-21.6.1+fabric-1.21.6" = _oRgYbuPg;
        "pkg-21.6.1+neoforge-1.21.6" = _nyGqhcWp;
        "pkg-21.6.2+forge-1.21.6" = _aNQCUFpp;
        "pkg-21.7.1+forge-1.21.7" = _kFMGHwZd;
        "pkg-21.7.1+fabric-1.21.7" = _7X4LBqC0;
        "pkg-21.7.1+neoforge-1.21.7" = _am9qHdtR;
        "pkg-21.8.1+fabric-1.21.8" = _MLsLmFC1;
        "pkg-21.8.1+forge-1.21.8" = _zOqiBGth;
        "pkg-21.8.1+neoforge-1.21.8" = _9noTU3vx;
        "pkg-21.9.1+neoforge-1.21.9" = _BCMph8q8;
        "pkg-21.9.1+fabric-1.21.9" = _aT9rXBsU;
        "pkg-21.10.1+fabric-1.21.10" = _UteYtFek;
        "pkg-21.10.1+neoforge-1.21.10" = _Slwv1xfb;
        "pkg-21.10.1+forge-1.21.10" = _EUKIJ6lw;
        "pkg-21.10.2+fabric-1.21.10" = _noLoRfPa;
        "pkg-21.10.2+forge-1.21.10" = _Hh1ogeoV;
        "pkg-21.10.2+neoforge-1.21.10" = _rLaGtdco;
        "pkg-21.11.2+neoforge-1.21.11" = _BZwuSYcq;
        "pkg-21.11.2+fabric-1.21.11" = _F4h7KQtD;
        "pkg-21.11.4+forge-1.21.11" = _nxVL2nRJ;
        "pkg-26.1.0.1+fabric-26.1" = _nn398T2N;
