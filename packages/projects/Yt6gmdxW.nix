...
let
    ...
    in {
        ...
        "pkg-7.0.0" = _36RuiDRw;
        "pkg-7.0.1" = _3M8s8rKV;
        "pkg-1.19.3+0.1.0" = _DYJl3Xci;
        "pkg-1.19.3-8.0.0" = _3pVylz4j;
        "pkg-1.19.2-8.0.0" = _F8TdjDfE;
        "pkg-1.19.3-8.0.1" = _dBkvENFH;
        "pkg-1.19.3-8.0.2" = _ttVTrWKy;
        "pkg-1.19.4-9.0.0" = _2z0anITJ;
        "pkg-1.19.4-9.0.1" = _C06XuYaj;
        "pkg-1.19.4-9.0.2" = _Y0xDNtDu;
        "pkg-1.19.4-9.1.0" = _5mujbzex;
        "pkg-1.19.4-9.1.2" = _ZEcGaO42;
        "pkg-1.19.4-9.2.0" = _oaA2uMfQ;
        "pkg-1.19.4-9.3.0" = _mrpGK5BT;
        "pkg-1.19.4-9.3.1" = _bn0WO22Y;
        "pkg-1.20-10.0.0" = _leUJZi2Q;
        "pkg-1.20.1-10.0.0" = _sFETgwaZ;
        "pkg-1.20.1-10.0.1" = _wg40SlGe;
        "pkg-1.20.1-10.1.0" = _1A5Y5l2q;
        "pkg-1.20.1-10.1.1" = _2msBVVDn;
        "pkg-1.20.1-10.2.0" = _dO5I328y;
        "pkg-1.20.1-10.3.0" = _9kUFVR4P;
        "pkg-1.20.1-10.3.1" = _K2FrGr5H;
        "pkg-1.20.1-10.4.0" = _LLasJtQg;
        "pkg-1.20.1-10.5.0" = _wG2Vw4mE;
        "pkg-1.20.1-10.5.1" = _kbZ5HbV5;
        "pkg-1.20.1-11.0.1" = _grPS7WSn;
        "pkg-1.20.1-11.1.0" = _MAUabZnC;
        "pkg-1.20.1-11.1.2" = _tZeSop8o;
        "pkg-1.20.1-11.2.0" = _X7CegPXs;
        "pkg-1.20.2-12.0.0" = _Jbpc57v3;
        "pkg-1.20.2-12.0.1" = _J1FUlMx0;
        "pkg-1.20.2-12.1.0" = _ildAsuUo;
        "pkg-1.20.2-12.2.0" = _s82GU4lg;
        "pkg-1.20.3-13.0.0" = _hMg54qCv;
        "pkg-1.20.4-14.0.0" = _Xi5U7R6j;
        "pkg-1.20.4-14.1.0" = _tbPfArXF;
        "pkg-1.20.4-14.2.0" = _wiJ4r06o;
        "pkg-1.20.4-14.3.0" = _ZxrKzIYv;
        "pkg-1.20.1-11.3.0" = _gqmfTgMC;
        "pkg-1.20.4-14.4.0" = _wlT2lJPk;
        "pkg-1.20.4-14.5.0" = _UkeuDKUM;
        "pkg-1.20.1-11.4.0" = _EGj47KLc;
        "pkg-1.20.1-11.4.1" = _LGmBzm48;
        "pkg-1.20.4-14.6.0" = _w3Jfqhhx;
        "pkg-1.20.4-14.7.0" = _pNFHhETL;
        "pkg-1.20.1-11.4.2" = _aezpxnwa;
        "pkg-1.20.4-14.7.1" = _8TsXuzI5;
        "pkg-1.20.1-11.4.3" = _e8Fi6qjk;
        "pkg-1.20.1-11.4.4" = _pEh22tjo;
        "pkg-1.20.4-14.7.2" = _YHmh81HF;
        "pkg-1.20.1-11.4.5" = _DWZ5P1lq;
        "pkg-1.20.4-14.8.1" = _X1fyTi8E;
        "pkg-1.20.1-11.4.6" = _xEGlwXUm;
        "pkg-1.20.1-11.4.7" = _9HWxap24;
        "pkg-1.20.5-15.0.0" = _3YucYYRX;
        "pkg-1.20.5-15.0.1" = _sEhnysGq;
        "pkg-1.20.6-16.0.0" = _naZeDK08;
        "pkg-1.21-17.0.0" = _15sNgaHV;
        "pkg-1.21-17.0.1" = _BmyMQeh1;
        "pkg-1.21-17.1.0" = _ljXpuiht;
        "pkg-1.21-18.0.0" = _HZQf0bJc;
        "pkg-1.20.1-11.5.0" = _9q9e4aPG;
        "pkg-1.21-18.1.0" = _nbzHK8sg;
        "pkg-1.21.2-20.0.0" = _2YmmUPoc;
        "pkg-1.21.3-20.0.0" = _vfG1WklO;
        "pkg-1.21.3-20.1.0" = _J6MNFHFb;
        "pkg-1.21.3-20.2.0" = _sVVZMDBK;
        "pkg-1.21.1-19.0.1" = _Pw9qALNh;
        "pkg-1.21.3-20.3.0" = _l8rwNC6C;
        "pkg-1.21.3-20.3.1" = _hC6FVMoV;
        "pkg-1.21.3-20.3.2" = _1fvlbYmA;
        "pkg-1.21.1-19.1.0" = _BGFJV3bu;
        "pkg-1.21.3-20.3.3" = _PwKubgpu;
        "pkg-1.21.1-19.2.0" = _M8yWTwmB;
        "pkg-1.21.3-20.4.0" = _j80s36Jv;
        "pkg-1.21.1-19.2.1" = _yx9JfEjy;
        "pkg-1.21.3-20.4.1" = _7hQU07Dt;
        "pkg-1.21.1-19.2.2" = _57LrkT2O;
        "pkg-1.21.3-20.4.2" = _3kZ7OUWd;
        "pkg-1.20.1-11.6.0" = _iLDM2BKA;
        "pkg-1.21.4-21.0.0" = _BUBypYJi;
        "pkg-1.21.1-19.2.3" = _f66xtEHt;
        "pkg-1.21.4-21.0.1" = _UVzvL3LA;
        "pkg-1.20.1-11.6.1" = _Fxa8nafZ;
        "pkg-1.21.1-19.2.4" = _HvVQrXXY;
        "pkg-1.21.4-21.0.2" = _mL4zHPYH;
        "pkg-1.21.4-21.1.0" = _PoHbfIXy;
        "pkg-1.21.1-19.3.0" = _c7S7a5iM;
        "pkg-1.21.4-21.2.0" = _FpLlvcTv;
        "pkg-1.20.1-11.6.2" = _9AfrT5Qv;
        "pkg-1.20.1-11.6.3" = _KiDgo2sz;
        "pkg-1.20.1-11.6.4" = _fU6E3ZwA;
        "pkg-1.21.4-21.3.0" = _hwzr6tY3;
        "pkg-1.20.1-11.7.0" = _y5GusuPl;
        "pkg-1.21.1-19.3.1" = _hwIsSp5C;
        "pkg-1.21.5-22.0.0" = _bmCFkS5l;
        "pkg-1.21.5-22.1.0" = _kWA66kYv;
        "pkg-1.21.5-22.2.0" = _g9IKxXGV;
        "pkg-1.21.1-19.3.2" = _V4QBOfxK;
        "pkg-1.21.6-23.0.0" = _TjHFW24o;
        "pkg-1.21.6-23.0.1" = _O94RlzoZ;
        "pkg-1.21.7-24.0.0" = _hGM1u803;
        "pkg-1.21.7-24.0.1" = _4giWh32l;
        "pkg-1.21.7-24.0.3" = _m9jOcVQf;
        "pkg-1.21.8-25.0.0" = _jOLEWWRM;
        "pkg-1.21.1-19.4.0" = _9aLHwBRY;
        "pkg-1.21.8-25.1.0" = _8XVZErcu;
        "pkg-1.21.8-26.0.0" = _rN30xLMT;
        "pkg-1.21.1-19.5.0" = _os6qIKgi;
        "pkg-1.21.8-26.0.1" = _aTZiESLO;
        "pkg-1.20.1-11.8.0" = _8LEyQ0Wm;
        "pkg-1.21.1-20.0.0" = _nNSlp7Al;
        "pkg-1.21.8-26.0.2" = _vNgw4hz9;
        "pkg-1.21.8-26.0.3" = _A1mp2kGw;
        "pkg-1.21.1-20.1.0" = _bFmw7XNu;
        "pkg-1.21.8-26.1.0" = _NgqSW101;
        "pkg-1.21.8-26.2.0" = _N3Z3uRYn;
        "pkg-1.21.8-26.3.0" = _MxgKURlp;
        "pkg-1.21.9-27.0.0" = _DAi6RC3i;
        "pkg-1.21.10-28.0.0" = _vNPNxX04;
        "pkg-1.21.11-28.0.0" = _cXt0mqPN;
        "pkg-1.21.11-28.1.0" = _W8I2nCje;
        "pkg-1.21.1-20.2.0" = _BOBfJuCb;
        "pkg-1.21.11-28.3.0" = _8ogg9TTc;
        "pkg-26.1-snapshot-1-29.0.0" = _IYj7i4e8;
        "pkg-26.1-snapshot-1-29.0.1" = _ifdV3xcG;
        "pkg-26.1-snapshot-1-29.0.2" = _bbckYF9c;
        "pkg-1.21.1-20.3.0" = _gMpfelwt;
        "pkg-1.21.11-28.4.0" = _pacaH5lc;
        "pkg-1.21.1-20.4.0" = _DwbpAYer;
        "pkg-1.21.11-28.5.0" = _jKDnjYy0;
        "pkg-26.1-snapshot-1-29.1.0" = _LJ3kwVKC;
        "pkg-1.21.1-20.5.0" = _j8bzLu9z;
        "pkg-1.21.11-28.6.0" = _MUGYv771;
        "pkg-26.1-snapshot-1-29.2.0" = _Den8CSpT;
        "pkg-1.21.11-28.7.0" = _ArqMQQeP;
        "pkg-1.21.1-20.6.0" = _cRXYPRSJ;
        "pkg-1.21.11-28.8.0" = _GimYH4qB;
        "pkg-26.1-snapshot-29.3.0" = _nXQknGnH;
        "pkg-26.1-snapshot-29.4.0" = _NbukBw4H;
        "pkg-26.1-30.0.0" = _9ofAqaWC;
        "pkg-26.1.2-31.0.0" = _W77yD6dz;
        "pkg-1.21.1-20.7.0" = _Qpp4c3cy;
        "pkg-26.1.2-31.1.0" = _873ViyMC;
        "pkg-1.21.1-20.8.0" = _KfB5EMZh;
