...
let
    versions = (let
        ...
        _YnbsfIjk = {
            "id" = "YnbsfIjk";
            "file" = "skyvoid_skyblock_dirt_v2_0_12-MC_26_2.zip";
            "hash" = "sha512-lcDnyRgHGLBrnPsEH+NHQ0y9tMux8/vAreBYEzvkJS43+ZIEB/rfIz2NqyZgfRxLKWXwruEg8/3ZIRqswHDzOg==";
        };
        _A6j5pvq2 = {
            "id" = "A6j5pvq2";
            "file" = "skyblock-hardcore-2.0.12.jar";
            "hash" = "sha512-zSqbP26z/2ggDAXUKJUwCBAqdkkP0UOMHz7/GoFaaeLhf2vT+sVQh3ubcEOozYAEgR+0NMHWIhWzQqOWAY8Uwg==";
        };
    in {
        "v2COG35B" = _v2COG35B;
        "GSkJ2yLo" = _GSkJ2yLo;
        ...
        "neoforge-26.2" = _A6j5pvq2;
        "pkg-1.0.0" = _v2COG35B;
        "pkg-1.0.0+mod" = _GSkJ2yLo;
        "pkg-1.0.1" = _cWoR8as6;
        "pkg-1.0.1+mod" = _hinAQ5EN;
        "pkg-1.0.2" = _B7NgYK40;
        "pkg-1.0.2+mod" = _kLlIPelS;
        "pkg-1.1.0" = _kV2KSrSX;
        "pkg-1.1.0+mod" = _sZOM286e;
        "pkg-1.1.1" = _2sEdgxLA;
        "pkg-1.1.1+mod" = _56VyplFG;
        "pkg-2.0.0" = _qpfqYHot;
        "pkg-2.0.0+mod" = _jmUp7feo;
        "pkg-2.0.1" = _Q1i3xxzA;
        "pkg-2.0.1+mod" = _qO71UYoC;
        "pkg-2.0.2" = _bO4GChpM;
        "pkg-2.0.2+mod" = _Vv1Ixl7u;
        "pkg-2.0.3" = _TRlaaP5E;
        "pkg-2.0.3+mod" = _qm193ANY;
        "pkg-2.0.4" = _laCX62rY;
        "pkg-2.0.4+mod" = _F7BL1KR4;
        "pkg-2.0.5" = _wnsFiBy3;
        "pkg-2.0.5+mod" = _EYvLPiND;
        "pkg-2.0.6" = _qQmLVyjl;
        "pkg-2.0.6+mod" = _cIPEFqS6;
        "pkg-2.0.7" = _vV1ZXWaj;
        "pkg-2.0.7+mod" = _fRFByZSN;
        "pkg-2.0.8" = _Yn0puDks;
        "pkg-2.0.8+mod" = _jQBf2knf;
        "pkg-2.0.9" = _81hjsvt0;
        "pkg-2.0.9+mod" = _o4AhponM;
        "pkg-2.0.10" = _lwn3iQRc;
        "pkg-2.0.10+mod" = _oXS9hQgP;
        "pkg-2.0.11" = _QWfcHgBw;
        "pkg-2.0.11+mod" = _qKI1nCPv;
        "pkg-2.0.12" = _YnbsfIjk;
        "pkg-2.0.12+mod" = _A6j5pvq2;
        "default" = _A6j5pvq2;
    });
