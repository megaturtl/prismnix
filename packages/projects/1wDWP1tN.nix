...
let
    ...
    in {
        ...
        "pkg-1.6.1" = _UFYsqtaz;
        "pkg-1.5.4" = _KlCedKFK;
        "pkg-1.6.2-pre" = _CLr2kBQr;
        "pkg-1.6.3" = _xARxatMx;
        "pkg-1.6.4" = _63hIkK8s;
        "pkg-1.6.5" = _9OgaggdT;
        "pkg-1.7.0" = _OYJq6wK3;
        "pkg-1.7.1" = _ssRKCgai;
        "pkg-1.7.2-pre" = _nFlrvRJr;
        "pkg-1.7.3" = _VqSykOnj;
        "pkg-1.7.4" = _X6CArjyL;
        "pkg-1.7.5" = _lf5AbGcJ;
        "pkg-1.7.6" = _J2xdE4XJ;
        ...
        "pkg-1.8.7" = _I9QiX0yS;
        "pkg-1.8.9" = _Z0jxWKHv;
        "pkg-1.8.10" = _BFp6rHPu;
        "pkg-1.8.11" = _LhpMQViy;
        "pkg-1.8.12" = _AvcMabaL;
        "pkg-1.8.13" = _iUonzbKX;
        "pkg-1.8.14" = _7oxQKGh9;
        "pkg-1.8.15" = _XyA1eI1h;
        "pkg-1.8.16" = _2E3OECNb;
        "pkg-1.8.17" = _YMg5tbyd;
        "pkg-1.8.18" = _wKhgxrZr;
        "pkg-1.8.19" = _clku1DH2;
