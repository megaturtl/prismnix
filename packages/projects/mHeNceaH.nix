...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _764TyFMt;
        "pkg-1.1.1" = _NnXYsgki;
        "pkg-1.1.2-mc1.20.4" = _CiXz6wzx;
        "pkg-1.1.3-mc1.20.1" = _tYxvajQI;
        "pkg-1.1.3-mc1.20.4" = _gQWXqxA5;
        "pkg-1.1.4-mc1.20.1" = _r1Zsxmo9;
        "pkg-1.1.4-mc1.20.4" = _jNUgiCZe;
        "pkg-1.1.5-mc1.20.1" = _EhyWfs4E;
        "pkg-1.1.5-mc1.20.4" = _Nj3rD9cY;
        "pkg-1.1.6-mc1.20.1" = _y026Empm;
        "pkg-1.1.6-mc1.20.4" = _87vUXjW2;
        "pkg-1.1.7-mc1.20.1" = _MMwF8GfE;
        "pkg-1.1.7-mc1.20.4" = _icXrSDRG;
        "pkg-1.1.8-mc1.20.1" = _zRbSprd9;
        "pkg-1.1.8-mc1.20.4" = _H31YRrjB;
        "pkg-1.1.9-mc1.20.1" = _5XwCCIZa;
        "pkg-1.1.9-mc1.20.4" = _3JRWkdKN;
        "pkg-1.1.10-mc1.20.1" = _n7TM9ytN;
        "pkg-1.1.10-mc1.20.4" = _2hKZQ42Z;
        "pkg-1.1.11-mc1.20.1" = _BszAPWK0;
        "pkg-1.1.11-mc1.20.4" = _C3rMf9I3;
        "pkg-1.1.12-mc1.20.1" = _oRlmXxuB;
        "pkg-1.1.12-mc1.20.4" = _duzQuKng;
        "pkg-1.2.0.beta1-mc1.20.1" = _z3x2kMqf;
        "pkg-1.2.0.beta1-mc1.20.4" = _6qopKy7q;
        "pkg-1.2.0.beta2-mc1.20.1" = _aqT8lPgK;
        "pkg-1.2.0.beta2-mc1.20.4" = _1CPTuvoK;
        "pkg-1.2.0.beta3-mc1.20.1" = _RsQqsZk6;
        "pkg-1.2.0.beta3-mc1.20.4" = _IxOTthid;
        "pkg-1.2.0-beta.4+mc1.20.1" = _JcqSeMiH;
        "pkg-1.2.0-beta.4+mc1.20.4" = _fFFRhvP5;
        "pkg-1.2.0+mc1.20.1" = _YPVZrCB3;
        "pkg-1.2.0+mc1.20.4" = _ZPTPs3oj;
        "pkg-1.2.1+mc1.20.1" = _ufscdyTP;
        "pkg-1.2.1+mc1.20.4" = _hTAscDgO;
        "pkg-1.3.0-beta.1+mc1.20.1" = _GaUjUwaG;
        "pkg-1.3.0-beta.1+mc1.20.4" = _lk40KxOi;
        "pkg-1.3.0-beta.1+mc1.20.5" = _FflpmYXy;
        "pkg-1.3.0-beta.2+mc1.20.1" = _pEeJfNPq;
        "pkg-1.3.0-beta.2+mc1.20.4" = _A8xlMG78;
        "pkg-1.3.0-beta.2+mc1.20.5" = _8PF28CuF;
        "pkg-1.3.0+mc1.20.1" = _wIFB93Iv;
        "pkg-1.3.0+mc1.20.4" = _NkiUA6kX;
        "pkg-1.3.0+mc1.20.6" = _Aa2COA6c;
        "pkg-1.3.1+mc1.20.1" = _v0ketCDq;
        "pkg-1.3.1+mc1.20.4" = _vZ0oHQmx;
        "pkg-1.3.1+mc1.20.6" = _UoLP81vt;
        "pkg-1.4.0+mc1.20.1" = _3I0qGhKH;
        "pkg-1.4.0+mc1.20.4" = _u9ONoHpy;
        "pkg-1.4.0+mc1.20.6" = _rpQF5Hez;
        "pkg-1.4.1+mc1.20.1" = _NeSkEfnO;
        "pkg-1.4.1+mc1.20.4" = _P7KaRbw2;
        "pkg-1.4.1+mc1.20.6" = _5Dbb8mzE;
        "pkg-1.5.0+mc1.20.1" = _fxYhWo64;
        "pkg-1.5.0+mc1.20.4" = _LfqR9YWw;
        "pkg-1.5.0+mc1.20.6" = _hz94v90C;
        "pkg-1.5.0+mc1.21.0" = _qLPMJh0Q;
        "pkg-1.5.1+mc1.20.1" = _JiN3Z7V8;
        "pkg-1.5.1+mc1.20.4" = _dLhrwauS;
        "pkg-1.5.1+mc1.20.6" = _c7MW326J;
        "pkg-1.5.1+mc1.21.0" = _XJehO0gZ;
        "pkg-1.5.2+mc1.20.1" = _aPaqfjAX;
        "pkg-1.5.2+mc1.20.4" = _IHS7Il25;
        "pkg-1.5.2+mc1.20.6" = _26tS61N8;
        "pkg-1.5.2+mc1.21.0" = _CLcuEvw2;
        "pkg-2.0.0+mc1.20.1" = _R4jMiQkv;
        "pkg-2.0.0+mc1.20.4" = _GX1A5nAg;
        "pkg-2.0.0+mc1.20.6" = _l3kWtIvg;
        "pkg-2.0.0+mc1.21.0" = _AK76Y6ck;
        "pkg-2.0.1+mc1.20.1" = _R6EDxcJj;
        "pkg-2.0.1+mc1.20.4" = _TvOKZDCY;
        "pkg-2.0.1+mc1.20.6" = _9u0hTEkm;
        "pkg-2.0.1+mc1.21.0" = _2Rkzg3lB;
        "pkg-2.1.0+mc1.20.1" = _Yi4hLCoR;
        "pkg-2.1.0+mc1.20.4" = _LROzfILQ;
        "pkg-2.1.0+mc1.20.6" = _SP4VrJyv;
        "pkg-2.1.0+mc1.21.1" = _LsK52ltT;
        "pkg-2.1.1+mc1.20.1" = _Pb3WOpdm;
        "pkg-2.1.1+mc1.20.4" = _juj5cghQ;
        "pkg-2.1.1+mc1.20.6" = _vtZUI7HN;
        "pkg-2.1.1+mc1.21.1" = _Ek5aw7I5;
        "pkg-2.1.2+mc1.20.1" = _fmFn9JRH;
        "pkg-2.1.2+mc1.20.4" = _KHtvbRcM;
        "pkg-2.1.2+mc1.20.6" = _LmuA2mD8;
        "pkg-2.1.2+mc1.21.1" = _CDVEwjEr;
        "pkg-2.1.3+mc1.20.1" = _jrx5MmFG;
        "pkg-2.1.3+mc1.20.4" = _cqBH04G7;
        "pkg-2.1.3+mc1.20.6" = _bEEgshv0;
        "pkg-2.1.3+mc1.21.1" = _k50f2ER6;
        "pkg-2.2.0+mc1.20.1" = _Fm0TY34C;
        "pkg-2.2.0+mc1.20.4" = _TAFtzqfZ;
        "pkg-2.2.0+mc1.20.6" = _kjbPcKr4;
        "pkg-2.2.0+mc1.21.1" = _HJUQaXNc;
        "pkg-2.2.0+mc1.21.2" = _evzWMbQ3;
        "pkg-2.2.1+mc1.20.1" = _AiV6AFEl;
        "pkg-2.2.1+mc1.20.4" = _ym3owupi;
        "pkg-2.2.1+mc1.20.6" = _OM1nPDXu;
        "pkg-2.2.1+mc1.21.1" = _f6Aip4Mj;
        "pkg-2.2.1+mc1.21.2" = _swtPwM2h;
        "pkg-2.2.2+mc1.20.1" = _ng1heQyB;
        "pkg-2.2.2+mc1.20.4" = _pfp39iD8;
        "pkg-2.2.2+mc1.20.6" = _mngbgORc;
        "pkg-2.2.2+mc1.21.1" = _1tiAp4qy;
        "pkg-2.2.2+mc1.21.2" = _K51mB1UZ;
        "pkg-2.2.3+mc1.20.1" = _kNyNBmHa;
        "pkg-2.2.3+mc1.20.4" = _s3lxbHbr;
        "pkg-2.2.3+mc1.20.6" = _Mqyk724e;
        "pkg-2.2.3+mc1.21.1" = _niF1wXxP;
        "pkg-2.2.3+mc1.21.2" = _pd5gtj2u;
        "pkg-2.2.4+mc1.20.1" = _Y0ljlqCH;
        "pkg-2.2.4+mc1.20.4" = _JLKNAwmn;
        "pkg-2.2.4+mc1.20.6" = _XAQpibIg;
        "pkg-2.2.4+mc1.21.1" = _cJXN7sWK;
        "pkg-2.2.4+mc1.21.2" = _szL52k7c;
        "pkg-2.2.5+mc1.20.1" = _VBuyG5aP;
        "pkg-2.2.5+mc1.20.4" = _d5kvGToD;
        "pkg-2.2.5+mc1.20.6" = _k77hwmH3;
        "pkg-2.2.5+mc1.21.1" = _a84nQGrF;
        "pkg-2.2.5+mc1.21.2" = _R9ORUWXX;
        "pkg-2.2.6+mc1.20.1" = _QYwmo4AX;
        "pkg-2.2.6+mc1.20.4" = _f3JyZgH1;
        "pkg-2.2.6+mc1.20.6" = _TVV7RX23;
        "pkg-2.2.6+mc1.21.1" = _QHbBrLJW;
        "pkg-2.2.6+mc1.21.2" = _o6XS3q3o;
        "pkg-2.2.7+mc1.20.1" = _L1fOnM5Q;
        "pkg-2.2.7+mc1.20.4" = _JIQSewLf;
        "pkg-2.2.7+mc1.20.6" = _5GWo7K75;
        "pkg-2.2.7+mc1.21.1" = _nmHDf118;
        "pkg-2.2.7+mc1.21.2" = _AXQpJPsE;
        "pkg-2.3.0-beta.1+mc1.20.1" = _VsW0ADsb;
        "pkg-2.3.0-beta.1+mc1.20.4" = _OVSNKT02;
        "pkg-2.3.0-beta.1+mc1.20.6" = _iYUdaVuu;
        "pkg-2.3.0-beta.1+mc1.21.1" = _XPfsIxvK;
        "pkg-2.3.0-beta.1+mc1.21.3" = _4xbEGjVk;
        "pkg-2.3.0-beta.2+mc1.20.4" = _Fhu2Mb1R;
        "pkg-2.3.0-beta.2+mc1.20.1" = _5u5g88Os;
        "pkg-2.3.0-beta.2+mc1.20.6" = _85QP1mta;
        "pkg-2.3.0-beta.2+mc1.21.1" = _XXyq0IEI;
        "pkg-2.3.0-beta.2+mc1.21.3" = _jr7xGpXg;
        "pkg-2.3.0+mc1.20.4" = _XNjlHdwd;
        "pkg-2.3.0+mc1.20.1" = _yPkDgVa2;
        "pkg-2.3.0+mc1.20.6" = _Nln2qBfx;
        "pkg-2.3.0+mc1.21.1" = _Wfraib1Q;
        "pkg-2.3.0+mc1.21.3" = _Xm5iJeS8;
        "pkg-2.3.1+mc1.20.1" = _SXeCowO8;
        "pkg-2.3.1+mc1.20.4" = _uHvLjr7W;
        "pkg-2.3.1+mc1.20.6" = _owZ5r8BE;
        "pkg-2.3.1+mc1.21.1" = _ab3rLFGa;
        "pkg-2.3.1+mc1.21.4" = _ZobCvtBK;
        "pkg-2.3.1+mc1.21.3" = _gCi4t8Ls;
        "pkg-2.3.2+mc1.20.2" = _uaIRcHqG;
        "pkg-2.3.2+mc1.20.1" = _h8pcgJbV;
        "pkg-2.3.2+mc1.20.6" = _RqmdB4c2;
        "pkg-2.3.2+mc1.20.4" = _9bunNB76;
        "pkg-2.3.2+mc1.21.3" = _8uWmVFUi;
        "pkg-2.3.2+mc1.21.1" = _tnCANh18;
        "pkg-2.3.2+mc1.21.4" = _gy4SkrAU;
        "pkg-2.3.3+mc1.20.1" = _xyNwsHSU;
        "pkg-2.3.3+mc1.20.2" = _nh1w6Y8i;
        "pkg-2.3.3+mc1.20.6" = _eHstyScs;
        "pkg-2.3.3+mc1.20.4" = _B9d2Vh26;
        "pkg-2.3.3+mc1.21.1" = _IZQK0MS9;
        "pkg-2.3.3+mc1.21.3" = _7TvhoGJ6;
        "pkg-2.3.3+mc1.21.4" = _B24fvUey;
        "pkg-2.4.0-beta.1+mc1.20.2" = _cXA0ztnz;
        "pkg-2.4.0-beta.1+mc1.20.1" = _RbZjp6X9;
        "pkg-2.4.0-beta.1+mc1.20.4" = _SBbZttP1;
        "pkg-2.4.0-beta.1+mc1.20.6" = _Gu2aDxZB;
        "pkg-2.4.0-beta.1+mc1.21.3" = _kqJqpqF6;
        "pkg-2.4.0-beta.1+mc1.21.1" = _7nTy3m6s;
        "pkg-2.4.0-beta.1+mc1.21.4" = _mspphxgB;
        "pkg-2.4.0-beta.2+mc1.20.1" = _t7ZKeg8E;
        "pkg-2.4.0-beta.2+mc1.20.2" = _7LBHapMf;
        "pkg-2.4.0-beta.2+mc1.20.4" = _20LvMcJT;
        "pkg-2.4.0-beta.2+mc1.20.6" = _EsRX3ZEw;
        "pkg-2.4.0-beta.2+mc1.21.1" = _mm3DLqec;
        "pkg-2.4.0-beta.2+mc1.21.3" = _CgwwM2oF;
        "pkg-2.4.0-beta.2+mc1.21.4" = _Crh8NPMY;
        "pkg-2.4.0+mc1.20.2" = _tIjcolP1;
        "pkg-2.4.0+mc1.20.1" = _I907sbJD;
        "pkg-2.4.0+mc1.20.4" = _fDxFl6pq;
        "pkg-2.4.0+mc1.20.6" = _8aTZMyHa;
        "pkg-2.4.0+mc1.21.1" = _r57rDHQX;
        "pkg-2.4.0+mc1.21.3" = _qNHAY7ce;
        "pkg-2.4.0+mc1.21.4" = _ijd1GmEm;
        "pkg-2.5.0-beta.1+mc1.20.1" = _ZFhSFDsm;
        "pkg-2.5.0-beta.1+mc1.20.2" = _D7CEMQhl;
        "pkg-2.5.0-beta.1+mc1.20.4" = _cg0pThYO;
        "pkg-2.5.0-beta.1+mc1.20.6" = _smLdy6AA;
        "pkg-2.5.0-beta.1+mc1.21.1" = _crkLAfSe;
        "pkg-2.5.0-beta.1+mc1.21.3" = _j1nlgiPJ;
        "pkg-2.5.0-beta.1+mc1.21.4" = _rrHpcpro;
        "pkg-2.5.0-beta.2+mc1.20.1" = _OWYhQPJR;
        "pkg-2.5.0-beta.2+mc1.20.2" = _pPNNLLIl;
        "pkg-2.5.0-beta.2+mc1.20.4" = _c2DZqDcu;
        "pkg-2.5.0-beta.2+mc1.20.6" = _ZNBoH0GH;
        "pkg-2.5.0-beta.2+mc1.21.1" = _j88prESn;
        "pkg-2.5.0-beta.2+mc1.21.3" = _bbrnQDkR;
        "pkg-2.5.0-beta.2+mc1.21.4" = _8LCnXwju;
        "pkg-2.5.0-beta.3+mc1.20.1" = _6CQIhJPd;
        "pkg-2.5.0-beta.3+mc1.20.2" = _bMhcmGbL;
        "pkg-2.5.0-beta.3+mc1.20.4" = _NcTshPWG;
        "pkg-2.5.0-beta.3+mc1.20.6" = _vfi7nf72;
        "pkg-2.5.0-beta.3+mc1.21.1" = _u5qr28E4;
        "pkg-2.5.0-beta.3+mc1.21.3" = _AHs0QXux;
        "pkg-2.5.0-beta.3+mc1.21.4" = _rM5NqhZY;
        "pkg-2.5.0+mc1.20.1" = _ZmcRkdiF;
        "pkg-2.5.0+mc1.20.2" = _X3ukjwIU;
        "pkg-2.5.0+mc1.20.4" = _FzCXatQ4;
        "pkg-2.5.0+mc1.20.6" = _EzPeTaMF;
        "pkg-2.5.0+mc1.21.1" = _Fs48Tx3x;
        "pkg-2.5.0+mc1.21.3" = _LxIaYt78;
        "pkg-2.5.0+mc1.21.4" = _5zfU0qod;
        "pkg-2.5.1+mc1.20.1" = _h0J6X0Ue;
        "pkg-2.5.1+mc1.20.2" = _DkbnbPs7;
        "pkg-2.5.1+mc1.20.4" = _9pRqmTSY;
        "pkg-2.5.1+mc1.20.6" = _UXBCiBHu;
        "pkg-2.5.1+mc1.21.1" = _v7JjIwed;
        "pkg-2.5.1+mc1.21.3" = _8ydsMioa;
        "pkg-2.5.1+mc1.21.4" = _ssz1a8Et;
        "pkg-2.5.2+mc1.20.1" = _UyMnO3kj;
        "pkg-2.5.2+mc1.20.2" = _tFbQXaVH;
        "pkg-2.5.2+mc1.20.4" = _jM5TGjUS;
        "pkg-2.5.2+mc1.20.6" = _ibtfcXSj;
        "pkg-2.5.2+mc1.21.1" = _DAV2pWkm;
        "pkg-2.5.2+mc1.21.3" = _WqIELsit;
        "pkg-2.5.2+mc1.21.4" = _v22SheL0;
        "pkg-2.6.0+mc1.20.1" = _Ca8mXdRN;
        "pkg-2.6.0+mc1.20.2" = _oqLSCz6e;
        "pkg-2.6.0+mc1.20.4" = _UQsk4U9r;
        "pkg-2.6.0+mc1.20.6" = _F992sDf2;
        "pkg-2.6.0+mc1.21.1" = _fCcRhx3o;
        "pkg-2.6.0+mc1.21.3" = _5f8QFz0f;
        "pkg-2.6.0+mc1.21.4" = _spK5DJFZ;
        "pkg-2.6.0+mc1.21.5" = _JGZZwAS0;
        "pkg-2.6.1+mc1.20.1" = _RZMOaGAd;
        "pkg-2.6.1+mc1.20.2" = _ZlAxqjiv;
        "pkg-2.6.1+mc1.20.4" = _ujTAwP2h;
        "pkg-2.6.1+mc1.20.6" = _WfOcpCpK;
        "pkg-2.6.1+mc1.21.1" = _V3pu2QsR;
        "pkg-2.6.1+mc1.21.3" = _n72OZLRD;
        "pkg-2.6.1+mc1.21.4" = _SiLxNA6H;
        "pkg-2.6.1+mc1.21.5" = _Z043mus4;
        "pkg-2.6.2+mc1.20.2" = _Hp4RAyMW;
        "pkg-2.6.2+mc1.20.1" = _ZpNtvIwf;
        "pkg-2.6.2+mc1.20.6" = _ZiZqMlIh;
        "pkg-2.6.2+mc1.20.4" = _ff4rbIGN;
        "pkg-2.6.2+mc1.21.1" = _EW7NKh3J;
        "pkg-2.6.2+mc1.21.3" = _BBowoh1V;
        "pkg-2.6.2+mc1.21.4" = _arCVwVIT;
        "pkg-2.6.2+mc1.21.5" = _F5OsCVva;
        "pkg-2.6.3+mc1.20.6" = _sX8OIbpA;
        "pkg-2.6.3+mc1.21.1" = _U00dg2Vc;
        "pkg-2.6.3+mc1.21.3" = _GJOSsJ7H;
        "pkg-2.6.3+mc1.21.4" = _zcfxAR6w;
        "pkg-2.6.3+mc1.21.5" = _AgwK0RVk;
        "pkg-2.7.0+mc1.20.1" = _88qcS1J2;
        "pkg-2.7.0+mc1.20.2" = _ICrr1icV;
        "pkg-2.7.0+mc1.20.4" = _YhdbHllF;
        "pkg-2.7.0+mc1.20.6" = _4E4695X4;
        "pkg-2.7.0+mc1.21.3" = _TrL0EtRE;
        "pkg-2.7.0+mc1.21.1" = _StLC4geZ;
        "pkg-2.7.0+mc1.21.4" = _iepKG1qY;
        "pkg-2.7.0+mc1.21.5" = _VyYsBBB7;
        "pkg-2.7.0+mc1.21.6" = _uxUQZxpX;
        "pkg-2.7.1+mc1.20.2" = _9rPGshgI;
        "pkg-2.7.1+mc1.20.1" = _5xxdPjd4;
        "pkg-2.7.1+mc1.20.4" = _G0BK9dkt;
        "pkg-2.7.1+mc1.20.6" = _WWrfumI0;
        "pkg-2.7.1+mc1.21.1" = _fJHGCjvD;
        "pkg-2.7.1+mc1.21.3" = _MJ6Bu7Kq;
        "pkg-2.7.1+mc1.21.4" = _AtwbGGuk;
        "pkg-2.7.1+mc1.21.5" = _TWEXY2Z4;
        "pkg-2.7.1+mc1.21.6" = _CjrbSJZ4;
        "pkg-2.7.2+mc1.21.6" = _wtYPd2ET;
        "pkg-2.7.3+mc1.20.1" = _kHn1akTZ;
        "pkg-2.7.3+mc1.20.2" = _gwFFnXgk;
        "pkg-2.7.3+mc1.20.4" = _8Op0vOMP;
        "pkg-2.7.3+mc1.20.6" = _FCyf58Fr;
        "pkg-2.7.3+mc1.21.1" = _vM47SyoN;
        "pkg-2.7.3+mc1.21.3" = _8Hhmgawv;
        "pkg-2.7.3+mc1.21.4" = _5dkgweJt;
        "pkg-2.7.3+mc1.21.5" = _xFkCRgVd;
        "pkg-2.7.3+mc1.21.6" = _cfVwznAs;
        "pkg-2.7.4+mc1.20.2" = _r9KlW8Y0;
        "pkg-2.7.4+mc1.20.1" = _5JjUtvD6;
        "pkg-2.7.4+mc1.20.4" = _hu6HGbFP;
        "pkg-2.7.4+mc1.20.6" = _1SreCp0s;
        "pkg-2.7.4+mc1.21.1" = _Adv1QSKX;
        "pkg-2.7.4+mc1.21.3" = _K6QTMUtr;
        "pkg-2.7.4+mc1.21.4" = _4UYQ1cO2;
        "pkg-2.7.4+mc1.21.5" = _fJchcxar;
        "pkg-2.7.4+mc1.21.6" = _mvVYKfXq;
        "pkg-2.7.5+mc1.20.1" = _KEBIyN6c;
        "pkg-2.7.5+mc1.20.2" = _sa3Wj5Ry;
        "pkg-2.7.5+mc1.20.4" = _LLcCzxKU;
        "pkg-2.7.5+mc1.20.6" = _9EKtmN14;
        "pkg-2.7.5+mc1.21.1" = _FWRSx7Tz;
        "pkg-2.7.5+mc1.21.3" = _NyJcsdcL;
        "pkg-2.7.5+mc1.21.4" = _QjPTcGEv;
        "pkg-2.7.5+mc1.21.5" = _unrZxkNv;
        "pkg-2.7.5+mc1.21.7" = _Kt8OG8sg;
        "pkg-2.7.6+mc1.20.1" = _87N984L8;
        "pkg-2.7.6+mc1.20.2" = _dYxlC5Ci;
        "pkg-2.7.6+mc1.20.4" = _lkfb9YNQ;
        "pkg-2.7.6+mc1.20.6" = _gME90Fru;
        "pkg-2.7.6+mc1.21.1" = _tpnL49yw;
        "pkg-2.7.6+mc1.21.3" = _DSBXwDcS;
        "pkg-2.7.6+mc1.21.4" = _SP9TKuFK;
        "pkg-2.7.6+mc1.21.5" = _SvmtpgIM;
        "pkg-2.7.6+mc1.21.7" = _ECtZeygX;
        "pkg-2.7.7+mc1.21.7" = _UzVZtNR4;
        "pkg-2.7.8+mc1.20.2" = _PPnpuQsZ;
        "pkg-2.7.8+mc1.20.1" = _7YZvNMeI;
        "pkg-2.7.8+mc1.20.4" = _rgVW1cQW;
        "pkg-2.7.8+mc1.20.6" = _i348ws8F;
        "pkg-2.7.8+mc1.21.1" = _3PtZkexh;
        "pkg-2.7.8+mc1.21.3" = _NqDx7t23;
        "pkg-2.7.8+mc1.21.4" = _6tjy5iDr;
        "pkg-2.7.8+mc1.21.5" = _8yVaawFS;
        "pkg-2.7.8+mc1.21.7" = _NzaNW7a3;
        "pkg-2.9.0-beta.1+mc1.20.1" = _Lyb7VSw2;
        "pkg-2.9.0-beta.1+mc1.20.2" = _ttAaPVuQ;
        "pkg-2.9.0-beta.1+mc1.20.4" = _We0MCAv0;
        "pkg-2.9.0-beta.1+mc1.20.6" = _4KFkczJm;
        "pkg-2.9.0-beta.1+mc1.21.1" = _qf1NbDYS;
        "pkg-2.9.0-beta.1+mc1.21.3" = _Awn46UoG;
        "pkg-2.9.0-beta.1+mc1.21.4" = _7hDJvJjO;
        "pkg-2.9.0-beta.1+mc1.21.5" = _VE3D9pSA;
        "pkg-2.9.0-beta.1+mc1.21.7" = _INuUAIIM;
        "pkg-2.9.0-beta.1+mc1.21.9" = _BehWhg3Q;
        "pkg-2.9.0-beta.2+mc1.20.1" = _tqQRYGaW;
        "pkg-2.9.0-beta.2+mc1.20.2" = _hxBsAhIm;
        "pkg-2.9.0-beta.2+mc1.20.4" = _qNko9CYA;
        "pkg-2.9.0-beta.2+mc1.20.6" = _A9eDdyc3;
        "pkg-2.9.0-beta.2+mc1.21.1" = _q7HzkDFi;
        "pkg-2.9.0-beta.2+mc1.21.3" = _1OZhMpKE;
        "pkg-2.9.0-beta.2+mc1.21.4" = _LWsLYGNx;
        "pkg-2.9.0-beta.2+mc1.21.5" = _FoAkGkBM;
        "pkg-2.9.0-beta.2+mc1.21.7" = _NqgNBXfi;
        "pkg-2.9.0-beta.2+mc1.21.9" = _IhnjlUes;
        "pkg-2.9.0+mc1.20.1" = _YKoNgvnm;
        "pkg-2.9.0+mc1.20.2" = _BbCNrFwe;
        "pkg-2.9.0+mc1.20.4" = _9JqNEYdj;
        "pkg-2.9.0+mc1.20.6" = _AujzbiTB;
        "pkg-2.9.0+mc1.21.1" = _cVXsWdF7;
        "pkg-2.9.0+mc1.21.3" = _ctwUahxo;
        "pkg-2.9.0+mc1.21.4" = _nrwQzNBm;
        "pkg-2.9.0+mc1.21.5" = _WhtxWjY9;
        "pkg-2.9.0+mc1.21.7" = _3CZIypXx;
        "pkg-2.9.0+mc1.21.9" = _NPeq1Fhj;
        "pkg-2.9.1+mc1.20.1" = _AqQfsNN1;
        "pkg-2.9.1+mc1.20.2" = _DNT78M1z;
        "pkg-2.9.1+mc1.20.4" = _ffQEW7sB;
        "pkg-2.9.1+mc1.20.6" = _qF63M8rI;
        "pkg-2.9.1+mc1.21.1" = _hJpO1Qai;
        "pkg-2.9.1+mc1.21.3" = _WjLgYXDo;
        "pkg-2.9.1+mc1.21.4" = _C3A2ZaRq;
        "pkg-2.9.1+mc1.21.5" = _KIJylqT8;
        "pkg-2.9.1+mc1.21.7" = _qwbFSm20;
        "pkg-2.9.1+mc1.21.9" = _I2hbPJuE;
        "pkg-2.9.2+mc1.20.1" = _7bF6A5aN;
        "pkg-2.9.2+mc1.20.2" = _YVeU2tho;
        "pkg-2.9.2+mc1.20.4" = _n493YJ6F;
        "pkg-2.9.2+mc1.20.6" = _IFrFQCFN;
        "pkg-2.9.2+mc1.21.1" = _1iKsSaur;
        "pkg-2.9.2+mc1.21.3" = _k9aJwnRe;
        "pkg-2.9.2+mc1.21.4" = _CGwBfFAq;
        "pkg-2.9.2+mc1.21.5" = _T0iaOAOY;
        "pkg-2.9.2+mc1.21.7" = _fVhxTRR6;
        "pkg-2.9.2+mc1.21.9" = _VMCZaR9Y;
        "pkg-2.9.3+mc1.20.1" = _Ebz442Sv;
        "pkg-2.9.3+mc1.20.2" = _3w3WUMqw;
        "pkg-2.9.3+mc1.20.4" = _Nfn4LqrW;
        "pkg-2.9.3+mc1.20.6" = _1l726OBE;
        "pkg-2.9.3+mc1.21.1" = _x3ACBZqM;
        "pkg-2.9.3+mc1.21.3" = _Ca7qdDH4;
        "pkg-2.9.3+mc1.21.4" = _N7akyBec;
        "pkg-2.9.3+mc1.21.5" = _dxnyEgBa;
        "pkg-2.9.3+mc1.21.7" = _iviHRGwI;
        "pkg-2.9.3+mc1.21.9" = _HrqmRNDJ;
        "pkg-2.9.4+mc1.20.1" = _ArhhL6Xa;
        "pkg-2.9.4+mc1.20.2" = _HgtqQMMd;
        "pkg-2.9.4+mc1.20.4" = _ckRr6RIk;
        "pkg-2.9.4+mc1.20.6" = _OuscxhJl;
        "pkg-2.9.4+mc1.21.1" = _oRiC4jth;
        "pkg-2.9.4+mc1.21.3" = _meycT7iy;
        "pkg-2.9.4+mc1.21.4" = _K2mgJ95v;
        "pkg-2.9.4+mc1.21.5" = _qnf1p4Sm;
        "pkg-2.9.4+mc1.21.7" = _dQJ8vr3R;
        "pkg-2.9.4+mc1.21.9" = _ugSaFznb;
        "pkg-2.9.5+mc1.20.1" = _PxTi4IwC;
        "pkg-2.9.5+mc1.20.2" = _Z7KUWtRN;
        "pkg-2.9.5+mc1.20.4" = _sps3iBc4;
        "pkg-2.9.5+mc1.20.6" = _3fYcHb9F;
        "pkg-2.9.5+mc1.21.1" = _4RQmrNSr;
        "pkg-2.9.5+mc1.21.11" = _x1GQ3cIJ;
        "pkg-2.9.5+mc1.21.3" = _u3wVnvRI;
        "pkg-2.9.5+mc1.21.4" = _wTy1p7t6;
        "pkg-2.9.5+mc1.21.5" = _RyRUXtQo;
        "pkg-2.9.5+mc1.21.7" = _ILA76B7O;
        "pkg-2.9.5+mc1.21.9" = _jzJDvWxz;
        "pkg-2.9.6+mc1.20.1" = _Ue8XQRKN;
        "pkg-2.9.6+mc1.20.2" = _DxbmdIcV;
        "pkg-2.9.6+mc1.20.4" = _80auCTtt;
        "pkg-2.9.6+mc1.20.6" = _NISwEnd0;
        "pkg-2.9.6+mc1.21.1" = _GHOdbSiP;
        "pkg-2.9.6+mc1.21.11" = _fyVN7Yuw;
        "pkg-2.9.6+mc1.21.3" = _bgK5EUvE;
        "pkg-2.9.6+mc1.21.4" = _IvhrdGDY;
        "pkg-2.9.6+mc1.21.5" = _c5ocb74c;
        "pkg-2.9.6+mc1.21.7" = _gNC1OU1f;
        "pkg-2.9.6+mc1.21.9" = _aoXWGnvo;
        "pkg-2.9.7+mc1.21.11" = _Vb6yPYhc;
        "pkg-2.10.0+mc26.1" = _zbskqViB;
        "pkg-2.11.0+mc26.1" = _vLTnS1D5;
        "pkg-2.11.0+mc26.2" = _if1TSCWq;
        "pkg-2.12.0+mc26.1" = _1vTIICEP;
