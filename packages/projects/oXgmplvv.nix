...
let
    ...
    in {
        ...
        "pkg-1.18.1" = _ifJ6gU0g;
        "pkg-1.18.2" = _OpgAOL8Y;
        "pkg-1.18.3" = _skyovKwy;
        "pkg-1.18.4" = _gElalwuY;
        "pkg-1.18.7" = _fWX2u0A1;
        "pkg-1.18.8" = _m6D3Enk2;
        "pkg-1.18.10" = _UyUUqQaH;
        "pkg-1.18.12" = _uJCD7Ref;
        "pkg-1.18.15" = _3yhKadUb;
        "pkg-1.18.18" = _eSsKyx6l;
        "pkg-1.18.19" = _8aRuSY71;
        "pkg-1.18.25" = _RDxBWsOh;
        "pkg-1.18.27" = _DdylpD6x;
        "pkg-1.18.29" = _l3XF48wK;
        "pkg-1.18.32" = _kppF1yGv;
        "pkg-1.18.33" = _eojfMh5Q;
        "pkg-1.18.35" = _icoM9D5L;
        "pkg-1.18.38" = _s7FUpCNJ;
        "pkg-1.18.44" = _ygTwc22a;
        "pkg-1.18.45" = _HJOyp2ss;
        "pkg-1.18.54" = _FDedxpj1;
        "pkg-1.18.55" = _fM6jsoKi;
        "pkg-1.18.61" = _plxWdrIw;
        "pkg-1.18.62" = _ipTfL09i;
        "pkg-1.18.63" = _t76oZsgc;
        "pkg-1.18.63-beta1" = _xiOU9UEU;
        "pkg-1.18.64" = _wSwFcE7q;
