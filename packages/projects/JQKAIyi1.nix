...
let
    versions = (let
        ...
        _eqXvBGKd = {
            "id" = "eqXvBGKd";
            "file" = "essence-1.12.0-SNAPSHOT.jar";
            "hash" = "sha512-b8BiMYwyZp7k/8TjiQ+6PzjcDpiCb77ckg8o9BiXPCXkjzJiOdhHBx6RrbVcCtVZH9J3qJxHIl1OFKAGLLj9Wg==";
        };
        _LJLsCWrV = {
            "id" = "LJLsCWrV";
            "file" = "essence-1.12.0.jar";
            "hash" = "sha512-TVFqwc7yJ/38RElcRh+irLJrDYYr9ZSPFnn1D+lMB6jkrswv5Ot0w6k4/sHHWwUg+pctsvKhjhzVkWhBlQUwAQ==";
        };
    in {
        "n8qD2VGI" = _n8qD2VGI;
        "ti2PkRpm" = _ti2PkRpm;
        ...
        "paper-1.21" = _gP71NNR2;
        "paper-1.21.1" = _LJLsCWrV;
        "paper-1.21.2" = _LJLsCWrV;
        "paper-1.21.3" = _LJLsCWrV;
        "paper-1.21.4" = _LJLsCWrV;
        "paper-1.21.5" = _LJLsCWrV;
        "paper-1.21.6" = _LJLsCWrV;
        "paper-1.21.7" = _LJLsCWrV;
        "paper-1.21.8" = _LJLsCWrV;
        "paper-1.21.9" = _LJLsCWrV;
        "paper-1.21.10" = _LJLsCWrV;
        "paper-1.21.11" = _LJLsCWrV;
        "paper-26.1" = _LJLsCWrV;
        "paper-26.1.1" = _LJLsCWrV;
        "paper-26.1.2" = _LJLsCWrV;
        "paper-26.2" = _LJLsCWrV;
        "paper-26.3" = _LJLsCWrV;
        ...
        "folia-1.21" = _gP71NNR2;
        "folia-1.21.1" = _LJLsCWrV;
        "folia-1.20.3" = _ggZc4Zca;
        "folia-1.21.2" = _LJLsCWrV;
        "folia-1.21.3" = _LJLsCWrV;
        "folia-1.21.4" = _LJLsCWrV;
        "folia-1.21.5" = _LJLsCWrV;
        "folia-1.20" = _ggZc4Zca;
        "folia-1.20.1" = _ggZc4Zca;
        "folia-1.20.2" = _ggZc4Zca;
        "folia-1.21.6" = _LJLsCWrV;
        "folia-1.21.7" = _LJLsCWrV;
        "folia-1.21.8" = _LJLsCWrV;
        "folia-1.21.9" = _LJLsCWrV;
        "folia-1.21.10" = _LJLsCWrV;
        "folia-1.21.11" = _LJLsCWrV;
        "folia-26.1" = _LJLsCWrV;
        "folia-26.1.1" = _LJLsCWrV;
        "folia-26.1.2" = _LJLsCWrV;
        "folia-26.2" = _LJLsCWrV;
        "folia-26.3" = _LJLsCWrV;
        "purpur-1.20.4" = _ggZc4Zca;
        "purpur-1.20.5" = _ggZc4Zca;
        "purpur-1.20.6" = _ggZc4Zca;
        "purpur-1.21" = _gP71NNR2;
        "purpur-1.21.1" = _LJLsCWrV;
        "purpur-1.20.3" = _ggZc4Zca;
        "purpur-1.21.2" = _LJLsCWrV;
        "purpur-1.21.3" = _LJLsCWrV;
        "purpur-1.21.4" = _LJLsCWrV;
        "purpur-1.21.5" = _LJLsCWrV;
        "purpur-1.20" = _ggZc4Zca;
        "purpur-1.20.1" = _ggZc4Zca;
        "purpur-1.20.2" = _ggZc4Zca;
        "purpur-1.21.6" = _LJLsCWrV;
        "purpur-1.21.7" = _LJLsCWrV;
        "purpur-1.21.8" = _LJLsCWrV;
        "purpur-1.21.9" = _LJLsCWrV;
        "purpur-1.21.10" = _LJLsCWrV;
        "purpur-1.21.11" = _LJLsCWrV;
        "purpur-26.1" = _LJLsCWrV;
        "purpur-26.1.1" = _LJLsCWrV;
        "purpur-26.1.2" = _LJLsCWrV;
        "purpur-26.2" = _LJLsCWrV;
        "purpur-26.3" = _LJLsCWrV;
        "pkg-1.0" = _n8qD2VGI;
        "pkg-1.1.0" = _ti2PkRpm;
        "pkg-1.2.0" = _tHUzDc8s;
        "pkg-1.3.0-SNAPSHOT" = _LWlxbIVR;
        "pkg-1.3.0" = _SYytNQoO;
        "pkg-1.3.1" = _p0zME4QU;
        "pkg-1.3.2" = _HMfbU6PW;
        "pkg-1.4.0-SNAPSHOT" = _yhR5QWiI;
        "pkg-1.4.0" = _xpfngdtb;
        "pkg-1.5.0" = _zaqpYhMj;
        "pkg-1.5.1" = _EBYeek3J;
        "pkg-1.5.2" = _MfFh1kXW;
        ...
        "pkg-1.8.1" = _QJwA4E2S;
        "pkg-1.9.0" = _cGaD6Pah;
        "pkg-1.10.0-SNAPSHOT" = _j21lX8lL;
        "pkg-1.10.0" = _ggZc4Zca;
        "pkg-1.10.1-SNAPSHOT" = _LELYMFjS;
        "pkg-1.10.1" = _jCkQ4ONd;
        "pkg-1.10.2" = _dyoayqva;
        "pkg-1.11.0-SNAPSHOT" = _gP71NNR2;
        "pkg-1.11.0" = _GjMJ2rlM;
        "pkg-1.11.1" = _JBzCj9nQ;
        "pkg-1.11.2" = _FUYquPVF;
        "pkg-1.12.0-SNAPSHOT" = _eqXvBGKd;
        "pkg-1.12.0" = _LJLsCWrV;
        "default" = _LJLsCWrV;
    });
