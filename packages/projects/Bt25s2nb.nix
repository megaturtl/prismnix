...
let
    versions = (let
        ...
        _d0YeeOKd = {
            "id" = "d0YeeOKd";
            "file" = "RoseStacker-1.5.42.jar";
            "hash" = "sha512-qH/Dw9UZoYbsitVSZNxNDu6WbsRWdzQj6ckj549q1L/A4tEd/RYA5587F1j3vZtwCCfANJP4I1lZ/p/5n06/MQ==";
        };
    in {
        "olCu9PM0" = _olCu9PM0;
        "gXjr6WqV" = _gXjr6WqV;
        ...
        "Sss6ZvvC" = _Sss6ZvvC;
        "d0YeeOKd" = _d0YeeOKd;
        "paper-1.16.5" = _d0YeeOKd;
        "paper-1.17.1" = _d0YeeOKd;
        "paper-1.18.2" = _d0YeeOKd;
        "paper-1.19.4" = _d0YeeOKd;
        "paper-1.20.4" = _d0YeeOKd;
        "paper-1.20.6" = _d0YeeOKd;
        "paper-1.21" = _d0YeeOKd;
        "paper-1.21.1" = _d0YeeOKd;
        "paper-1.21.2" = _d0YeeOKd;
        "paper-1.21.3" = _d0YeeOKd;
        "paper-1.21.4" = _d0YeeOKd;
        "paper-1.21.5" = _d0YeeOKd;
        "paper-1.21.6" = _d0YeeOKd;
        "paper-1.21.7" = _d0YeeOKd;
        "paper-1.21.8" = _d0YeeOKd;
        "paper-1.21.9" = _d0YeeOKd;
        "paper-1.21.10" = _d0YeeOKd;
        "paper-1.21.11" = _d0YeeOKd;
        "paper-26.1" = _d0YeeOKd;
        "paper-26.1.1" = _d0YeeOKd;
        "paper-26.1.2" = _d0YeeOKd;
        "paper-26.2" = _d0YeeOKd;
        "spigot-1.16.5" = _d0YeeOKd;
        "spigot-1.17.1" = _d0YeeOKd;
        "spigot-1.18.2" = _d0YeeOKd;
        "spigot-1.19.4" = _d0YeeOKd;
        "spigot-1.20.4" = _d0YeeOKd;
        "spigot-1.20.6" = _d0YeeOKd;
        "spigot-1.21" = _d0YeeOKd;
        "spigot-1.21.1" = _d0YeeOKd;
        "spigot-1.21.2" = _d0YeeOKd;
        "spigot-1.21.3" = _d0YeeOKd;
        "spigot-1.21.4" = _d0YeeOKd;
        "spigot-1.21.5" = _d0YeeOKd;
        "spigot-1.21.6" = _d0YeeOKd;
        "spigot-1.21.7" = _d0YeeOKd;
        "spigot-1.21.8" = _d0YeeOKd;
        "spigot-1.21.9" = _d0YeeOKd;
        "spigot-1.21.10" = _d0YeeOKd;
        "spigot-1.21.11" = _d0YeeOKd;
        "spigot-26.1" = _d0YeeOKd;
        "spigot-26.1.1" = _d0YeeOKd;
        "spigot-26.1.2" = _d0YeeOKd;
        "spigot-26.2" = _d0YeeOKd;
        "pkg-1.5.30" = _olCu9PM0;
        "pkg-1.5.31" = _gXjr6WqV;
        "pkg-1.5.32" = _uLF3hWKt;
        "pkg-1.5.33" = _4iUUpzGi;
        "pkg-1.5.34" = _jVZmz3X8;
        "pkg-1.5.35" = _yWg2eWZB;
        "pkg-1.5.36" = _kRGnZBKo;
        "pkg-1.5.37" = _SM0MqUvq;
        "pkg-1.5.38" = _IcdTzGFo;
        "pkg-1.5.39" = _N6YdXlIJ;
        "pkg-1.5.40" = _lgWJV7B0;
        "pkg-1.5.41" = _Sss6ZvvC;
        "pkg-1.5.42" = _d0YeeOKd;
        "default" = _d0YeeOKd;
    });
