...
let
    versions = (let
        ...
        _C2x1kSj7 = {
            "id" = "C2x1kSj7";
            "file" = "ShoulderSurfing-Forge-1.20.1-5.0.10.jar";
            "hash" = "sha512-edXwiBod+fsY/tJfq0OqUeWxOcFXes3DVSbsgkRCbve2np3MsVlj5HIthDN8f7npfXNwOhz1ItQnd7G90fW2ZA==";
        };
        _O8zmlXQC = {
            "id" = "O8zmlXQC";
            "file" = "ShoulderSurfing-Fabric-1.20.1-5.0.10.jar";
            "hash" = "sha512-ICXeE1M913iqK81tw+vNea1an3xSn+vwrOdmptasNkVm6Xi6xFes9+NRGRUadsRr6w/QceepxJInaoWlvt664g==";
        };
        _uU3wk3Wt = {
            "id" = "uU3wk3Wt";
            "file" = "ShoulderSurfing-NeoForge-1.21.1-5.0.10.jar";
            "hash" = "sha512-0HOAxZyfTyBIRWaoXdsTCEiwEo6MdYGCdO7lFBnXFgNdh+KT5cm+ZoigT2mzLPdTWXIA9oAeFJJdctcvwD8WgA==";
        };
        _QYdPH8BK = {
            "id" = "QYdPH8BK";
            "file" = "ShoulderSurfing-Forge-1.21.1-5.0.10.jar";
            "hash" = "sha512-ocEgtUqEt6LaDlPCWSOIETqxEsIcjD3ZRk30bGKuJdZljtS6pkTc3DLddFdM7nLbimix34YZGlnYFb0+E4AVOQ==";
        };
        _anYPmP8X = {
            "id" = "anYPmP8X";
            "file" = "ShoulderSurfing-Fabric-1.21.1-5.0.10.jar";
            "hash" = "sha512-T78Gga5TDGzIotYgGCPGe1GSLEVzEkQrjWf3zkMh05YkT/2rw2Lc0yAe8yaWPLcf4jJgacc6bIA5J9Dv9uVFgg==";
        };
        _hhvbNiF8 = {
            "id" = "hhvbNiF8";
            "file" = "ShoulderSurfing-Forge-26.1.2-5.0.10.jar";
            "hash" = "sha512-ejinKQvn729JeKqANOXNFsKhON5EoiR89O8JlAMOgqFTfwnIldCCG8zPWQn3DH1Rm7B9jSdv8dmVsEI4v2rhIA==";
        };
        _kpNYppvf = {
            "id" = "kpNYppvf";
            "file" = "ShoulderSurfing-Fabric-26.1.2-5.0.10.jar";
            "hash" = "sha512-rqclM0Qo/Kx7dEFTJA8+xLykKF2WtleSdeK3d/9RVEJIOJi0lzH+rf6Z5Fkp/ZA8ryD9cTJ0GfWQ9Kw6djb1pg==";
        };
        _reonXl6w = {
            "id" = "reonXl6w";
            "file" = "ShoulderSurfing-NeoForge-26.1.2-5.0.10.jar";
            "hash" = "sha512-fAxaZX2ZXLV2LpfbKSMd5acDgl4w2h4Z6vn/PzTEcPn7sWXLovRq6v9ubwn3UWC8bS0IX4QO5ZimnJiplFgNqA==";
        };
        _PnwHPPor = {
            "id" = "PnwHPPor";
            "file" = "ShoulderSurfing-NeoForge-1.21.11-5.0.10.jar";
            "hash" = "sha512-ZO+LfYGLkjKHOUP6vhVv1N7Qvy+R4sjdLo/y6ERJXG2qv6OFswAHpYA7XcC0yUNliuGJk4/nPueK4pz5XdtSpQ==";
        };
        _qqIY2QVJ = {
            "id" = "qqIY2QVJ";
            "file" = "ShoulderSurfing-Forge-1.21.11-5.0.10.jar";
            "hash" = "sha512-ooVE0uEIlnVrb6hrwAVvgNN1SveywUf87xijmNZY264lztvXAOEr7m8NVLAgdoAxInekBtzyBApGq6rd6TcVwA==";
        };
        _9T2YSavE = {
            "id" = "9T2YSavE";
            "file" = "ShoulderSurfing-Fabric-1.21.11-5.0.10.jar";
            "hash" = "sha512-01eIn+K0CMgYjSpJ2eGrnKNOHJzZzhh18ttaFkxTUIxddlRJ+p5WlRmTb7LNlt6LAUOBVgrChU0nl2k0OepHDg==";
        };
        _6xtZHRcb = {
            "id" = "6xtZHRcb";
            "file" = "ShoulderSurfing-Fabric-26.2-5.0.10.jar";
            "hash" = "sha512-KQI8M26jXlF+417O5/DOJ11PP2vXwXkC/WaPMrq9s2pjf1XQgrnnnqVRkXvA/HDDavdUQjjWDh8pRA81wm8JEA==";
        };
        _9eUbSawn = {
            "id" = "9eUbSawn";
            "file" = "ShoulderSurfing-NeoForge-26.2-5.0.10.jar";
            "hash" = "sha512-n5rPOAunWSbpRKkiI6JuRLYxDr3Yw0XbdM2Dq22SIhyzVwARA5dHa+np/4YlLa8gxnSWQsYVxU3tDemnXwr/0A==";
        };
        _O0rZjp1D = {
            "id" = "O0rZjp1D";
            "file" = "ShoulderSurfing-Forge-26.2-5.0.10.jar";
            "hash" = "sha512-iXFZAY1FlWlh3o98nevsAPa1vxmmpjS2nKGsVp2/8+3czd6Xfc4QVBBrnKSrFM+kaAZC8c+gvy30HGrIfN87NA==";
        };
        _P7QoCfeQ = {
            "id" = "P7QoCfeQ";
            "file" = "ShoulderSurfing-Forge-1.20.1-5.0.11.jar";
            "hash" = "sha512-8j1AZGZzcVbz9+vtaCO4DQZwFLYfiv8NsaViTZMOOoBMCtIC3EneuDrD+dRp2giifiU39bH8mq31p6XKh8Ee4Q==";
        };
        _ovGsejgS = {
            "id" = "ovGsejgS";
            "file" = "ShoulderSurfing-Fabric-1.20.1-5.0.11.jar";
            "hash" = "sha512-oXZc68RTHStnrPhbF9EQC9liqFV+fEhGpgYQ27ZJ6VLpP/TIpqb4TxVPrtRvlbb6rS7vt+3sxSGyKhaNTjrtWQ==";
        };
        _gtUuy6S9 = {
            "id" = "gtUuy6S9";
            "file" = "ShoulderSurfing-NeoForge-1.21.1-5.0.11.jar";
            "hash" = "sha512-b75lvhMhP/4YDhcEeorIDTzKFgQ76cpbfucR3R8LTuODUT4xrBuLh60GhBK5LuevJ52gh6bST6J4JtbeCYrDew==";
        };
        _rXimvg4V = {
            "id" = "rXimvg4V";
            "file" = "ShoulderSurfing-Forge-1.21.1-5.0.11.jar";
            "hash" = "sha512-8aukzlv5BiD3AwAkRi+z7BtcOx345LocrIe6JVEkZoVLvE2686bBGydeLrI6u8WUNMXHM4BOkLKxYSJNLxMG+g==";
        };
        _u13y2lzx = {
            "id" = "u13y2lzx";
            "file" = "ShoulderSurfing-Fabric-1.21.1-5.0.11.jar";
            "hash" = "sha512-sXlglwDBg9BFiWPj7VTBh3He2rNAXl37pqVU8poh8afvzQjH40r6owiq+yxvl3HpdYDtSF6AlTKW07AFRVCUVA==";
        };
        _xF3YjhUq = {
            "id" = "xF3YjhUq";
            "file" = "ShoulderSurfing-Fabric-26.2-5.0.11.jar";
            "hash" = "sha512-WAuqw7GEUzEB9LCED7evfPvKFcdfzrpLeep5fg+VA9eOPfTXhU4RFoPpeT+q1AvFsGCeKafsq6dAZ/na1Xe2IQ==";
        };
        _f7tjIKIo = {
            "id" = "f7tjIKIo";
            "file" = "ShoulderSurfing-Forge-26.2-5.0.11.jar";
            "hash" = "sha512-4k4wDPusjmR+afE8qSHZprD/YOmmE65E+/DpgVuy3xIKIpCSKHHZzxhX0CfopbsPYj7vw/MtCrZvhHJcm20ZLA==";
        };
        _O3SwQJDX = {
            "id" = "O3SwQJDX";
            "file" = "ShoulderSurfing-NeoForge-26.2-5.0.11.jar";
            "hash" = "sha512-i23cXe56k7E2BRkxxpD7QLPnhoItVanb0ldcINj6R6x90an9TmY47ZMj6tC812ofClmSLqewgZWirfSh7Fy2hg==";
        };
        _3WsCAgIU = {
            "id" = "3WsCAgIU";
            "file" = "ShoulderSurfing-Forge-26.1.2-5.0.11.jar";
            "hash" = "sha512-2HbFqyvekRQNmHVwMgcG06rZjxqXOECCnSW8IxU94jB7LHjAWEkKLk5qaN2+vh0pxUu2H/FXClS7P7q9oqkQKA==";
        };
        _WMn2tl8b = {
            "id" = "WMn2tl8b";
            "file" = "ShoulderSurfing-NeoForge-26.1.2-5.0.11.jar";
            "hash" = "sha512-ya22+w3I29yOj07d2SUl690FFMjlZh+M8EJC+upHMPfxJ/J5SWUMlDULFX6GoQWoiRG5Nn5QzonRuLN2kFimGA==";
        };
        _cMypf8Rq = {
            "id" = "cMypf8Rq";
    ...
    in {
        ...
        "pkg-1.18.2-2.4" = _ic0uPiRB;
        "pkg-1.19.2-2.4" = _AkHpakdk;
        "pkg-1.19.4-2.4" = _tOrCQdTj;
        "pkg-1.20.1-2.4" = _aR9xfd0a;
        "pkg-1.7.10-2.4.1" = _dfgKdx9y;
        "pkg-1.12.2-2.4.1" = _ejH5twYS;
        "pkg-1.18.2-2.4.1" = _Y6b2mYlh;
        "pkg-1.19.2-2.4.1" = _2d1VLz9b;
        "pkg-1.19.4-2.4.1" = _ChJOstxj;
        "pkg-1.20.1-2.4.1" = _RI8OQmcc;
        "pkg-1.12.2-2.5" = _qmd4I8Sc;
        "pkg-1.16.5-2.5" = _R8PpY0iY;
        "pkg-1.18.2-2.5" = _Vl54H0Mm;
        "pkg-1.19.2-2.5" = _nhPj8NGu;
        "pkg-1.20.1-2.5" = _LHE2t99w;
        "pkg-1.12.2-2.5.1" = _MleYxw9G;
        "pkg-1.18.2-2.5.1" = _99lDE75T;
        "pkg-1.12.2-2.6" = _MgmGgpVp;
        "pkg-1.16.5-2.6" = _DztJzuZp;
        "pkg-1.18.2-2.6" = _fpUYTWwF;
        "pkg-1.19.2-2.6" = _Ea6o1EXD;
        "pkg-1.20.1-2.6" = _6SN7rHS8;
        "pkg-1.12.2-2.7" = _tzG2CRY1;
        "pkg-1.16.5-2.7" = _p1aQuGHu;
        "pkg-1.18.2-2.7" = _Wxjb6OCd;
        "pkg-1.19.2-2.7" = _PZzhcCx7;
        "pkg-1.20.1-2.7" = _rmI0CnNT;
        "pkg-1.12.2-2.8" = _ejFTcdGi;
        "pkg-1.16.5-2.8" = _3zsIpdFY;
        "pkg-1.18.2-2.8" = _CFSjfYIw;
        "pkg-1.19.2-2.8" = _A3B2Pngz;
        "pkg-1.20.1-2.8" = _tU76J4Vs;
        "pkg-1.12.2-2.8.1" = _qESLQp87;
        "pkg-1.16.5-2.8.1" = _wWeCyaTQ;
        "pkg-1.18.2-2.8.1" = _12LUAKM9;
        "pkg-1.19.2-2.8.1" = _X5aGROaF;
        "pkg-1.20.1-2.8.1" = _DQwLq25u;
        "pkg-1.12.2-2.8.2" = _AISOfFh9;
        "pkg-1.16.5-2.8.2" = _AMJqOlJa;
        "pkg-1.19.2-2.8.2" = _DSG7b6R3;
        "pkg-1.20.4-2.8.2" = _qEYrpqMZ;
        "pkg-1.12.2-2.9.1" = _zlmp8z4n;
        "pkg-1.16.5-2.9.1" = _Bcr74X0t;
        "pkg-1.18.2-2.9.1" = _YePRy3li;
        "pkg-1.19.2-2.9.1" = _ts25yo4O;
        "pkg-1.20.1-2.9.1" = _a4QC8ZnA;
        "pkg-1.20.4-2.9.1" = _ZQdxZuHW;
        "pkg-1.20.1-2.9.2" = _iTMTgRTo;
        "pkg-1.12.2-2.9.3" = _3eXPgxVU;
        "pkg-1.16.5-2.9.3" = _X300sRoz;
        "pkg-1.18.2-2.9.3" = _CBTWEeny;
        "pkg-1.19.2-2.9.3" = _4j7tKzlc;
        "pkg-1.20.1-2.9.3" = _kAlRJJ1T;
        "pkg-1.20.4-2.9.3" = _u2CagwF3;
        "pkg-1.16.5-2.9.4" = _rzlQ0NWI;
        "pkg-1.18.2-2.9.4" = _WNn7Kdr7;
        "pkg-1.19.2-2.9.4" = _ybWu9Z54;
        "pkg-1.20.1-2.9.4" = _DEFCwFb9;
        "pkg-1.20.4-2.9.4" = _AKpMGpg6;
        "pkg-1.16.5-2.9.5" = _D2U1dOd8;
        "pkg-1.18.2-2.9.5" = _OkFDEP7n;
        "pkg-1.19.2-2.9.5" = _UfW0xbbt;
        "pkg-1.20.1-2.9.5" = _sZ6MAkCy;
        "pkg-1.12.2-2.9.6" = _9BBcQeo4;
        "pkg-1.16.5-2.9.6" = _Vl1ArXOO;
        "pkg-1.18.2-2.9.6" = _KrkCaNAG;
        "pkg-1.19.2-2.9.6" = _NiUddQYK;
        "pkg-1.20.1-2.9.6" = _tyv6ROKM;
        "pkg-1.20.4-2.9.6" = _shZkVeco;
        "pkg-1.18.2-2.9.7" = _I99oBlDD;
        "pkg-1.19.2-2.9.7" = _DCdJF3Rg;
        "pkg-1.16.5-3.0.0" = _5qcibm3h;
        "pkg-1.18.2-3.0.0" = _9RcRrmhY;
        "pkg-1.19.2-3.0.0" = _JaNBXjVD;
        "pkg-1.20.1-3.0.0" = _2KqtB6FD;
        "pkg-1.20.4-3.0.0" = _8WGWdBwp;
        "pkg-1.16.5-3.1.0" = _CTL2KpER;
        "pkg-1.18.2-3.1.0" = _gzIuryY9;
        "pkg-1.19.2-3.1.0" = _KepcOxba;
        "pkg-1.20.1-3.1.0" = _1Y8WyNZC;
        "pkg-1.20.4-3.1.0" = _XF3Y9Bxb;
        "pkg-1.20.4-3.1.1" = _g3vvo0nk;
        "pkg-1.16.5-3.1.2" = _xnCXa6H9;
        "pkg-1.18.2-3.1.2" = _aopWXQ62;
        "pkg-1.19.2-3.1.2" = _32hqx3dQ;
        "pkg-1.20.1-3.1.2" = _Gpl3kivQ;
        "pkg-1.20.4-3.1.2" = _Sme0YFcj;
        "pkg-1.16.5-3.1.3" = _cXOvTpEp;
        "pkg-1.18.2-3.1.3" = _UHCcGCPz;
        "pkg-1.19.2-3.1.3" = _jeMB3rX5;
        "pkg-1.20.1-3.1.3" = _h3c8WZDa;
        "pkg-1.20.4-3.1.3" = _zKUQyrVP;
        "pkg-1.20.6-3.1.3-beta" = _LEpQGRJd;
        "pkg-1.20.6-3.1.3" = _kjpdoXZO;
        "pkg-1.16.5-3.2.0" = _U9324jMr;
        "pkg-1.18.2-3.2.0" = _WPzlS3mO;
        "pkg-1.19.2-3.2.0" = _C8CitxAb;
        "pkg-1.20.1-3.2.0" = _GwinOBtV;
        "pkg-1.20.6-3.2.0" = _BVHO21Sc;
        "pkg-1.16.5-4.0.0" = _z2AtPfWs;
        "pkg-1.18.2-4.0.0" = _4xzZNqIc;
        "pkg-1.19.2-4.0.0" = _u9YkZUyM;
        "pkg-1.20.1-4.0.0" = _8YBJcBpv;
        "pkg-1.20.4-4.0.0" = _ACh5dAPI;
        "pkg-1.20.6-4.0.0" = _QLMnHyN9;
        "pkg-1.16.5-4.1.0" = _GAHJ7wG2;
        "pkg-1.18.2-4.1.0" = _gLBiiC6X;
        "pkg-1.19.2-4.1.0" = _CqMQdF7T;
        "pkg-1.20.1-4.1.0" = _8X1sm5lv;
        "pkg-1.20.4-4.1.0" = _PBK1YTBA;
        "pkg-1.20.6-4.1.0" = _UtQfQC9o;
        "pkg-1.16.5-4.1.1" = _kVHHzcLv;
        "pkg-1.18.2-4.1.1" = _2Y1P9eiC;
        "pkg-1.19.2-4.1.1" = _mVQkPHnG;
        "pkg-1.20.1-4.1.1" = _3KPSSkLe;
        "pkg-1.20.4-4.1.1" = _pvVZEcqD;
        "pkg-1.20.6-4.1.1" = _peCJWCHC;
        "pkg-1.16.5-4.1.2" = _E5lbkMGX;
        "pkg-1.18.2-4.1.2" = _KdFQ738b;
        "pkg-1.19.2-4.1.2" = _Z1lfmUHI;
        "pkg-1.20.1-4.1.2" = _ML1sSuSd;
        "pkg-1.20.4-4.1.2" = _pKbnNRua;
        "pkg-1.20.6-4.1.2" = _mSHtUsYv;
        "pkg-1.21-4.1.2" = _JKcB53rv;
        "pkg-1.16.5-4.1.3" = _8fXE1dNo;
        "pkg-1.18.2-4.1.3" = _KAVs9Uq1;
        "pkg-1.19.2-4.1.3" = _c8OgSA2E;
        "pkg-1.20.1-4.1.3" = _FPoDW3eS;
        "pkg-1.20.4-4.1.3" = _cGi0I1bF;
        "pkg-1.20.6-4.1.3" = _IdRJEgfC;
        "pkg-1.21-4.1.3" = _gPUb4s7c;
        "pkg-1.16.5-4.1.4" = _TOAP8R0N;
        "pkg-1.18.2-4.1.4" = _1wY3N88o;
        "pkg-1.19.2-4.1.4" = _Ole9GxXp;
        "pkg-1.20.1-4.1.4" = _4rz2o3DV;
        "pkg-1.20.4-4.1.4" = _8xSYBZ6e;
        "pkg-1.20.6-4.1.4" = _tUi4naA4;
        "pkg-1.21-4.1.4" = _RxLz7xEx;
        "pkg-1.16.5-4.1.5" = _RLLlmnFB;
        "pkg-1.18.2-4.1.5" = _kNaVD5LD;
        "pkg-1.19.2-4.1.5" = _ZwYDkJMB;
        "pkg-1.20.1-4.1.5" = _5gnfCkCd;
        "pkg-1.20.4-4.1.5" = _X0T4xSeh;
        "pkg-1.20.6-4.1.5" = _q9S8xD2o;
        "pkg-1.21-4.1.5" = _N8Kcc5o8;
        "pkg-1.16.5-4.2.0" = _Fm4HEiRn;
        "pkg-1.18.2-4.2.0" = _g5eC4h30;
        "pkg-1.19.2-4.2.0" = _H1zMx6vy;
        "pkg-1.20.1-4.2.0" = _pnrV5sR9;
        "pkg-1.20.4-4.2.0" = _ciLicEfv;
        "pkg-1.20.6-4.2.0" = _gZq0YnpM;
        "pkg-1.21-4.2.0" = _zQlUHCnq;
        "pkg-1.18.2-4.2.1" = _DZGryIGP;
        "pkg-1.19.2-4.2.1" = _8cXtja6l;
        "pkg-1.20.1-4.2.1" = _8sZBWNpj;
        "pkg-1.20.4-4.2.1" = _bHai8bdg;
        "pkg-1.20.6-4.2.1" = _XUAintWx;
        "pkg-1.21-4.2.1" = _1j68D1ve;
        "pkg-1.16.5-4.3.0" = _rQ9DV0oS;
        "pkg-1.18.2-4.3.0" = _ay28WzKo;
        "pkg-1.19.2-4.3.0" = _n0xWIkMc;
        "pkg-1.20.1-4.3.0" = _hGSfn52z;
        "pkg-1.21-4.3.0" = _enQdfzc1;
        "pkg-1.16.5-4.3.1+fabric" = _1xyzK9sF;
        "pkg-1.16.5-4.3.1+forge" = _Ay7xyg8S;
        "pkg-1.18.2-4.3.1+forge" = _4zDzvBIS;
        "pkg-1.18.2-4.3.1+fabric" = _75s66EO2;
        "pkg-1.19.2-4.3.1+forge" = _AslYvVfD;
        "pkg-1.19.2-4.3.1+fabric" = _T2Qljzrn;
        "pkg-1.20.1-4.3.1+fabric" = _c3y6sYXv;
        "pkg-1.20.1-4.3.1+forge" = _fDwuN8qg;
        "pkg-1.21.1-4.3.1+neoforge" = _BsOscnng;
        "pkg-1.21.1-4.3.1+forge" = _NTOVRvEF;
        "pkg-1.21.1-4.3.1+fabric" = _1cNRbIgP;
        "pkg-1.16.5-4.4.0+forge" = _OP0u1qNX;
        "pkg-1.16.5-4.4.0+fabric" = _BqI0AzqT;
        "pkg-1.18.2-4.4.0+forge" = _Zsv4q7Cr;
        "pkg-1.18.2-4.4.0+fabric" = _HiVFsn0E;
        "pkg-1.19.2-4.4.0+forge" = _152HFtV6;
        "pkg-1.19.2-4.4.0+fabric" = _8mTONxzN;
        "pkg-1.20.1-4.4.0+fabric" = _132SBk1w;
        "pkg-1.20.1-4.4.0+forge" = _BcO3AKV2;
        "pkg-1.21.1-4.4.0+neoforge" = _3eIrHRXp;
        "pkg-1.21.1-4.4.0+forge" = _E41ZVcem;
        "pkg-1.21.1-4.4.0+fabric" = _TzAo0Ul2;
        "pkg-1.18.2-4.4.1+forge" = _ofePWXAQ;
        "pkg-1.18.2-4.4.1+fabric" = _571dyCA3;
        "pkg-1.19.2-4.4.1+forge" = _j2npePYj;
        "pkg-1.19.2-4.4.1+fabric" = _gZic3T3N;
        "pkg-1.20.1-4.4.1+forge" = _AeDorF6f;
        "pkg-1.20.1-4.4.1+fabric" = _ubbWImdg;
        "pkg-1.21.1-4.4.1+neoforge" = _xUQqXo6W;
        "pkg-1.21.1-4.4.1+forge" = _Du49anJM;
        "pkg-1.21.1-4.4.1+fabric" = _XDRdKlvq;
        "pkg-1.16.5-4.5.0+fabric" = _hs2ltL01;
        "pkg-1.16.5-4.5.0+forge" = _4cNlcuWZ;
        "pkg-1.18.2-4.5.0+fabric" = _LBGrklxo;
        "pkg-1.18.2-4.5.0+forge" = _KnS1hvTu;
        "pkg-1.19.2-4.5.0+fabric" = _CJOHuYMZ;
        "pkg-1.19.2-4.5.0+forge" = _982DkmVz;
        "pkg-1.20.1-4.5.0+forge" = _tTH0iTYa;
        "pkg-1.20.1-4.5.0+fabric" = _sQb90kNx;
        "pkg-1.21.1-4.5.0+forge" = _ePhYo7V2;
        "pkg-1.21.1-4.5.0+neoforge" = _MHwLukqj;
        "pkg-1.21.1-4.5.0+fabric" = _6rU5KPmb;
        "pkg-1.21.1-4.5.1+neoforge" = _FWrhtSQg;
        "pkg-1.21.1-4.5.1+forge" = _vratutHX;
        "pkg-1.21.1-4.5.1+fabric" = _MlVV2HRv;
        "pkg-1.21.3-4.5.1+neoforge" = _VlTna89g;
        "pkg-1.21.3-4.5.1+fabric" = _esZTpkom;
        "pkg-1.16.5-4.6.0+fabric" = _QQwxkQQ8;
        "pkg-1.16.5-4.6.0+forge" = _yaO6CSFW;
        "pkg-1.18.2-4.6.0+forge" = _7kltXh7W;
        "pkg-1.18.2-4.6.0+fabric" = _jowbrl7j;
        "pkg-1.19.2-4.6.0+forge" = _MmPMC0LA;
        "pkg-1.19.2-4.6.0+fabric" = _sz3Ak0qb;
        "pkg-1.20.1-4.6.0+forge" = _xHqlmlcm;
        "pkg-1.20.1-4.6.0+fabric" = _Belnu699;
        "pkg-1.21.1-4.6.0+neoforge" = _hZMk8ZTp;
        "pkg-1.21.1-4.6.0+forge" = _PsDvTIxW;
        "pkg-1.21.1-4.6.0+fabric" = _s52mvEUa;
        "pkg-1.21.3-4.6.0+neoforge" = _wBV2N4OD;
        "pkg-1.21.3-4.6.0+forge" = _ZrJxHlfg;
        "pkg-1.21.3-4.6.0+fabric" = _ynSHgxU8;
        "pkg-1.21.1-4.6.1+fabric" = _g6FHRIM6;
        "pkg-1.21.1-4.6.1+neoforge" = _zQs22VQL;
        "pkg-1.21.1-4.6.1+forge" = _njmDcoaV;
        "pkg-1.21.3-4.6.1+neoforge" = _DxGTUsQv;
        "pkg-1.21.3-4.6.1+forge" = _Ub4pwa1W;
        "pkg-1.21.3-4.6.1+fabric" = _rUtiP43z;
        "pkg-1.16.5-4.6.2+forge" = _GcrOrQDF;
        "pkg-1.16.5-4.6.2+fabric" = _hjKtyR5g;
        "pkg-1.18.2-4.6.2+forge" = _p4XMnKAw;
        "pkg-1.18.2-4.6.2+fabric" = _T3kzZV5A;
        "pkg-1.19.2-4.6.2+forge" = _nrrHk4Gr;
        "pkg-1.19.2-4.6.2+fabric" = _MdC6AdEj;
        "pkg-1.20.1-4.6.2+forge" = _Z0f03Uy0;
        "pkg-1.20.1-4.6.2+fabric" = _EpNJJL8u;
        "pkg-1.21.1-4.6.2+neoforge" = _Cfheieit;
        "pkg-1.21.1-4.6.2+forge" = _A208RhTt;
        "pkg-1.21.1-4.6.2+fabric" = _4MApnZQY;
        "pkg-1.21.3-4.6.2+neoforge" = _b6tfNv29;
        "pkg-1.21.3-4.6.2+fabric" = _z4q3gR1m;
        "pkg-1.21.3-4.6.2+forge" = _4rCGhVgW;
        "pkg-1.19.2-4.6.3+forge" = _TppXsGRx;
        "pkg-1.20.1-4.6.3+forge" = _9Z2W7cNO;
        "pkg-1.21.1-4.6.3+neoforge" = _azjIq6uX;
        "pkg-1.21.3-4.6.3+neoforge" = _3Mq7F8Wk;
        "pkg-1.21.4-4.6.3-beta+neoforge" = _AfVN91jx;
        "pkg-1.21.4-4.6.3-beta+fabric" = _obCB4F0U;
        "pkg-1.21.4-4.6.3+neoforge" = _vST4nxWc;
        "pkg-1.21.4-4.6.3+fabric" = _jtcCQXJ9;
        "pkg-1.21.4-4.6.3+forge" = _7sz7U4kt;
        "pkg-1.16.5-4.6.4+forge" = _pdVirtaB;
        "pkg-1.16.5-4.6.4+fabric" = _sdJ3vixs;
        "pkg-1.18.2-4.6.4+forge" = _lq5o2KN8;
        "pkg-1.18.2-4.6.4+fabric" = _gJIrtcIi;
        "pkg-1.19.2-4.6.4+forge" = _KspBWypu;
        "pkg-1.19.2-4.6.4+fabric" = _9WvH14Kp;
        "pkg-1.20.1-4.6.4+forge" = _fB8BFME5;
        "pkg-1.20.1-4.6.4+fabric" = _HaAWLw2z;
        "pkg-1.21.1-4.6.4+neoforge" = _med67UpG;
        "pkg-1.21.1-4.6.4+forge" = _azE7RILF;
        "pkg-1.21.1-4.6.4+fabric" = _rzwdlX4f;
        "pkg-1.21.4-4.6.4+neoforge" = _21clH2ey;
        "pkg-1.21.4-4.6.4+forge" = _AAaZvWTh;
        "pkg-1.21.4-4.6.4+fabric" = _3ICp1uOA;
        "pkg-1.21.1-4.6.5+neoforge" = _Ab4IrUzo;
        "pkg-1.21.4-4.6.5+neoforge" = _H6kH9xBq;
        "pkg-1.16.5-4.7.0+forge" = _z9eNmxeg;
        "pkg-1.16.5-4.7.0+fabric" = _JOYkKWyN;
        "pkg-1.18.2-4.7.0+forge" = _MziRYNyM;
        "pkg-1.18.2-4.7.0+fabric" = _zTk1GM9W;
        "pkg-1.19.2-4.7.0+forge" = _fffjCp3l;
        "pkg-1.19.2-4.7.0+fabric" = _gBjpzq5V;
        "pkg-1.20.1-4.7.0+forge" = _YF0jwzzu;
        "pkg-1.20.1-4.7.0+fabric" = _zo9mfZHU;
        "pkg-1.21.1-4.7.0+neoforge" = _uGgYkDnl;
        "pkg-1.21.1-4.7.0+forge" = _zjcTB2tN;
        "pkg-1.21.1-4.7.0+fabric" = _gLQQ12nu;
        "pkg-1.21.4-4.7.0+neoforge" = _PZqPkg6A;
        "pkg-1.21.4-4.7.0+forge" = _Iy0uufCV;
        "pkg-1.21.4-4.7.0+fabric" = _7VkKfVhO;
        "pkg-1.16.5-4.8.0+forge" = _Yrv1Oa2y;
        "pkg-1.16.5-4.8.0+fabric" = _qpRr4FGx;
        "pkg-1.18.2-4.8.0+forge" = _8K7FLfz0;
        "pkg-1.18.2-4.8.0+fabric" = _RtsPeK86;
        "pkg-1.19.2-4.8.0+forge" = _rEwuqoYc;
        "pkg-1.19.2-4.8.0+fabric" = _rsDpWwsg;
        "pkg-1.20.1-4.8.0+forge" = _QGHwjEp3;
        "pkg-1.21.1-4.8.0+neoforge" = _RIePVuit;
        "pkg-1.21.1-4.8.0+forge" = _tNvtELJf;
        "pkg-1.21.1-4.8.0+fabric" = _OOmXOMCE;
        "pkg-1.21.4-4.8.0+neoforge" = _xVThXbdI;
        "pkg-1.21.4-4.8.0+forge" = _kwdJa337;
        "pkg-1.21.4-4.8.0+fabric" = _NahFdhlR;
        "pkg-1.20.1-4.8.0+fabric" = _YObE4G6m;
        "pkg-1.16.5-4.9.0+forge" = _oXMFLrCD;
        "pkg-1.16.5-4.9.0+fabric" = _fKko7uEI;
        "pkg-1.18.2-4.9.0+fabric" = _VS9wbrzV;
        "pkg-1.18.2-4.9.0+forge" = _oTKhWEov;
        "pkg-1.19.2-4.9.0+forge" = _hi2Jwh2h;
        "pkg-1.19.2-4.9.0+fabric" = _jExKFmEm;
        "pkg-1.20.1-4.9.0+forge" = _QosBYdbn;
        "pkg-1.20.1-4.9.0+fabric" = _ApgA2Bv4;
        "pkg-1.21.1-4.9.0+fabric" = _qlpSVlRH;
        "pkg-1.21.1-4.9.0+neoforge" = _xTIqvLEP;
        "pkg-1.21.1-4.9.0+forge" = _xUCYHvKT;
        "pkg-1.21.4-4.9.0+neoforge" = _GVafPxTN;
        "pkg-1.21.4-4.9.0+forge" = _354VkE4t;
        "pkg-1.21.4-4.9.0+fabric" = _HgxE1eLO;
        "pkg-1.19.2-4.9.1+forge" = _EWmXXEf1;
        "pkg-1.19.2-4.9.1+fabric" = _qOA1zK2x;
        "pkg-1.20.1-4.9.1+forge" = _Nztpq2Tv;
        "pkg-1.20.1-4.9.1+fabric" = _JtjPjTat;
        "pkg-1.21.1-4.9.1+neoforge" = _Wak7dLbx;
        "pkg-1.21.1-4.9.1+forge" = _dkLFiZpA;
        "pkg-1.21.1-4.9.1+fabric" = _jxIUIK3e;
        "pkg-1.21.4-4.9.1+neoforge" = _zS1mJgYC;
        "pkg-1.21.4-4.9.1+forge" = _6qE2RLZE;
        "pkg-1.21.4-4.9.1+fabric" = _355A54Sl;
        "pkg-1.16.5-4.9.2+forge" = _Y8lOCZ7J;
        "pkg-1.16.5-4.9.2+fabric" = _9gEy3c7a;
        "pkg-1.18.2-4.9.2+forge" = _fUDbIJQp;
        "pkg-1.18.2-4.9.2+fabric" = _oO2OEbKn;
        "pkg-1.19.2-4.9.2+forge" = _34OQDV00;
        "pkg-1.19.2-4.9.2+fabric" = _Z2oEfun8;
        "pkg-1.20.1-4.9.2+forge" = _C6nRXq8V;
        "pkg-1.20.1-4.9.2+fabric" = _S34bFXcE;
        "pkg-1.21.1-4.9.2+neoforge" = _L4XEe88x;
        "pkg-1.21.1-4.9.2+forge" = _TENQP7vV;
        "pkg-1.21.1-4.9.2+fabric" = _XUFsrtpf;
        "pkg-1.21.4-4.9.2+neoforge" = _7lZqjIG7;
        "pkg-1.21.4-4.9.2+forge" = _IyYkd0eg;
        "pkg-1.21.4-4.9.2+fabric" = _srajPeSy;
        "pkg-1.16.5-4.10.0+fabric" = _p0abmezl;
        "pkg-1.16.5-4.10.0+forge" = _aBZIKQEz;
        "pkg-1.18.2-4.10.0+fabric" = _R6nPobxD;
        "pkg-1.18.2-4.10.0+forge" = _2vLBhctg;
        "pkg-1.19.2-4.10.0+fabric" = _CHLtI8mj;
        "pkg-1.19.2-4.10.0+forge" = _9Gm3YeY8;
        "pkg-1.20.1-4.10.0+fabric" = _s9tlnV50;
        "pkg-1.20.1-4.10.0+forge" = _wfM9r9nN;
        "pkg-1.21.1-4.10.0+neoforge" = _nyTI3Dq2;
        "pkg-1.21.1-4.10.0+forge" = _DTrewlyj;
        "pkg-1.21.1-4.10.0+fabric" = _GshrMm4e;
        "pkg-1.21.4-4.10.0+neoforge" = _e80EE1G2;
        "pkg-1.21.4-4.10.0+fabric" = _NopL9b5i;
        "pkg-1.21.4-4.10.0+forge" = _i6Tjp9jd;
        "pkg-1.16.5-4.10.1+forge" = _n5hjYpW9;
        "pkg-1.16.5-4.10.1+fabric" = _O0ERwDdM;
        "pkg-1.18.2-4.10.1+forge" = _X5y4gx0n;
        "pkg-1.18.2-4.10.1+fabric" = _Rk3iskxN;
        "pkg-1.19.2-4.10.1+forge" = _LD0fy3yX;
        "pkg-1.19.2-4.10.1+fabric" = _HUxTU2T0;
        "pkg-1.20.1-4.10.1+forge" = _QOTXHQs8;
        "pkg-1.20.1-4.10.1+fabric" = _Xxq8p7eg;
        "pkg-1.21.1-4.10.1+neoforge" = _dDdKcTOE;
        "pkg-1.21.1-4.10.1+forge" = _qTlVTwBj;
        "pkg-1.21.1-4.10.1+fabric" = _trGH0u4z;
        "pkg-1.21.4-4.10.1+neoforge" = _yrTPx0DA;
        "pkg-1.21.4-4.10.1+forge" = _KrjVxIMd;
        "pkg-1.21.4-4.10.1+fabric" = _RvspoRto;
        "pkg-1.16.5-4.10.2+fabric" = _mljj4WUo;
        "pkg-1.16.5-4.10.2+forge" = _ZSLczhV6;
        "pkg-1.18.2-4.10.2+fabric" = _orCU4J82;
        "pkg-1.18.2-4.10.2+forge" = _CXVMo6vE;
        "pkg-1.19.2-4.10.2+fabric" = _XLDjtdS9;
        "pkg-1.19.2-4.10.2+forge" = _7G6Z5BZy;
        "pkg-1.20.1-4.10.2+fabric" = _LBBwlVxZ;
        "pkg-1.20.1-4.10.2+forge" = _ZJZFt3DB;
        "pkg-1.21.1-4.10.2+neoforge" = _RibVYFAk;
        "pkg-1.21.1-4.10.2+fabric" = _JV5tPnoR;
        "pkg-1.21.1-4.10.2+forge" = _GFeN3Nm3;
        "pkg-1.21.4-4.10.2+fabric" = _PnF5zwWQ;
        "pkg-1.21.4-4.10.2+neoforge" = _6J3Kas0K;
        "pkg-1.21.4-4.10.2+forge" = _LjlFk1qR;
        "pkg-1.21.5-4.10.2+fabric" = _rFRmEPOd;
        "pkg-1.21.5-4.10.2+neoforge" = _DA1yPtwh;
        "pkg-1.21.5-4.10.2+forge" = _4j0vOZQZ;
        "pkg-1.21.1-4.10.3+forge" = _PrDfhx20;
        "pkg-1.21.4-4.10.3+forge" = _p5TkEdqS;
        "pkg-1.16.5-4.10.4+forge" = _d4eIxB4I;
        "pkg-1.16.5-4.10.4+fabric" = _xkbWaiG7;
        "pkg-1.18.2-4.10.4+forge" = _MssIkqg6;
        "pkg-1.18.2-4.10.4+fabric" = _YbzA27d4;
        "pkg-1.19.2-4.10.4+forge" = _q0cWVbDb;
        "pkg-1.19.2-4.10.4+fabric" = _2FPu3zl3;
        "pkg-1.20.1-4.10.4+fabric" = _A8fgV299;
        "pkg-1.20.1-4.10.4+forge" = _WwuhrtDL;
        "pkg-1.21.1-4.10.4+neoforge" = _VRThZByt;
        "pkg-1.21.1-4.10.4+forge" = _Ut0qCwFG;
        "pkg-1.21.1-4.10.4+fabric" = _KTtHZG9o;
        "pkg-1.21.4-4.10.4+neoforge" = _yn3rj5Oi;
        "pkg-1.21.4-4.10.4+forge" = _VYs1ZnT4;
        "pkg-1.21.4-4.10.4+fabric" = _OjlckY1T;
        "pkg-1.21.5-4.10.4+neoforge" = _YE2OsYhQ;
        "pkg-1.21.5-4.10.4+fabric" = _1SyEtzMV;
        "pkg-1.21.5-4.10.4+forge" = _1l2AwFmN;
        "pkg-1.16.5-4.10.5+forge" = _FHh2rtgB;
        "pkg-1.16.5-4.10.5+fabric" = _zO6mlNx6;
        "pkg-1.18.2-4.10.5+forge" = _ez9QbUur;
        "pkg-1.18.2-4.10.5+fabric" = _KV25mg2t;
        "pkg-1.19.2-4.10.5+forge" = _n32OU3D8;
        "pkg-1.19.2-4.10.5+fabric" = _Qk3Bnllk;
        "pkg-1.20.1-4.10.5+forge" = _YNjxUpcG;
        "pkg-1.20.1-4.10.5+fabric" = _J2bf1Pfg;
        "pkg-1.21.1-4.10.5+neoforge" = _RyxHLTfx;
        "pkg-1.21.1-4.10.5+forge" = _VCfSTXGZ;
        "pkg-1.21.1-4.10.5+fabric" = _fXiLbMsS;
        "pkg-1.21.4-4.10.5+neoforge" = _l5G4ewTk;
        "pkg-1.21.4-4.10.5+forge" = _hD2e9fxz;
        "pkg-1.21.4-4.10.5+fabric" = _fHB6U1Iz;
        "pkg-1.21.5-4.10.5+neoforge" = _DKEyLO9H;
        "pkg-1.21.5-4.10.5+forge" = _ZAtuVliv;
        "pkg-1.21.5-4.10.5+fabric" = _MCDpnF47;
        "pkg-1.21.5-4.11.0+neoforge" = _G1vS7XvR;
        "pkg-1.21.5-4.11.0+fabric" = _bgPyGIbX;
        "pkg-1.21.5-4.11.0+forge" = _16KGU8T3;
        "pkg-1.18.2-4.11.0+fabric" = _Ub4U8mqc;
        "pkg-1.18.2-4.11.0+forge" = _WBWcuuht;
        "pkg-1.19.2-4.11.0+fabric" = _Kj3pIjwY;
        "pkg-1.19.2-4.11.0+forge" = _GiGpBdAq;
        "pkg-1.20.1-4.11.0+fabric" = _AAWupTJT;
        "pkg-1.20.1-4.11.0+forge" = _Gtp5dJeK;
        "pkg-1.21.1-4.11.0+forge" = _y7LaKPMj;
        "pkg-1.21.1-4.11.0+fabric" = _lJn2S4iB;
        "pkg-1.21.1-4.11.0+neoforge" = _kDN6Ib3r;
        "pkg-1.21.4-4.11.0+neoforge" = _XDgk1trl;
        "pkg-1.21.4-4.11.0+fabric" = _ARhvOEIy;
        "pkg-1.21.4-4.11.0+forge" = _MLxYIjfg;
        "pkg-1.18.2-4.11.1+fabric" = _V5lskGGg;
        "pkg-1.18.2-4.11.1+forge" = _61uvMHIb;
        "pkg-1.19.2-4.11.1+fabric" = _zyT4Ubxd;
        "pkg-1.19.2-4.11.1+forge" = _Pom5PUXH;
        "pkg-1.20.1-4.11.1+fabric" = _j5MOgf1Y;
        "pkg-1.20.1-4.11.1+forge" = _u1swfA24;
        "pkg-1.18.2-4.12.0+fabric" = _8ktMPdTQ;
        "pkg-1.18.2-4.12.0+forge" = _w88lGm5T;
        "pkg-1.19.2-4.12.0+fabric" = _wFSyGGo6;
        "pkg-1.19.2-4.12.0+forge" = _J2WHikhn;
        "pkg-1.20.1-4.12.0+fabric" = _5pz72l3R;
        "pkg-1.20.1-4.12.0+forge" = _fbC1e2ja;
        "pkg-1.21.1-4.12.0+neoforge" = _5N99B1NM;
        "pkg-1.21.1-4.12.0+forge" = _mqAwmpn4;
        "pkg-1.21.1-4.12.0+fabric" = _FJsfVjvi;
        "pkg-1.21.4-4.12.0+neoforge" = _TSh7ImpJ;
        "pkg-1.21.4-4.12.0+forge" = _OTTCF3nu;
        "pkg-1.21.4-4.12.0+fabric" = _n8ilV1cO;
        "pkg-1.21.5-4.12.0+neoforge" = _KWZGbOCS;
        "pkg-1.21.5-4.12.0+forge" = _w0dRDQcf;
        "pkg-1.21.5-4.12.0+fabric" = _Q3AaI3Nz;
        "pkg-1.18.2-4.13.0+fabric" = _zxDPcYCE;
        "pkg-1.18.2-4.13.0+forge" = _ghuya4q3;
        "pkg-1.19.2-4.13.0+fabric" = _4AhjVpfl;
        "pkg-1.19.2-4.13.0+forge" = _7VpF5wap;
        "pkg-1.20.1-4.13.0+forge" = _l9IOXobl;
        "pkg-1.20.1-4.13.0+fabric" = _hthBKeQT;
        "pkg-1.21.1-4.13.0+neoforge" = _qiyWKEm5;
        "pkg-1.21.1-4.13.0+forge" = _tqQs4YMV;
        "pkg-1.21.1-4.13.0+fabric" = _ID6dGsO6;
        "pkg-1.21.5-4.13.0+neoforge" = _dlA20vbN;
        "pkg-1.21.5-4.13.0+forge" = _iCDSz59M;
        "pkg-1.21.5-4.13.0+fabric" = _iEGOLqNK;
        "pkg-1.21.6-4.13.0+neoforge" = _cpl8mqNm;
        "pkg-1.21.6-4.13.0+forge" = _V2OaLp2R;
        "pkg-1.21.6-4.13.0+fabric" = _GAStR8jj;
        "pkg-1.18.2-4.13.1+forge" = _WCzQc0mR;
        "pkg-1.18.2-4.13.1+fabric" = _kgq6gFM2;
        "pkg-1.19.2-4.13.1+fabric" = _7PH4ljGp;
        "pkg-1.19.2-4.13.1+forge" = _19mazXuD;
        "pkg-1.20.1-4.13.1+fabric" = _iAIGTSt3;
        "pkg-1.20.1-4.13.1+forge" = _8Ytbhnhu;
        "pkg-1.21.1-4.13.1+neoforge" = _w4BPifmO;
        "pkg-1.21.1-4.13.1+forge" = _irbUWSPv;
        "pkg-1.21.1-4.13.1+fabric" = _5F4hgywE;
        "pkg-1.21.5-4.13.1+forge" = _VH3a88kV;
        "pkg-1.21.5-4.13.1+fabric" = _cQLaNiXi;
        "pkg-1.21.5-4.13.1+neoforge" = _gOKZIqEf;
        "pkg-1.21.6-4.13.1+neoforge" = _ixw8QUI4;
        "pkg-1.21.6-4.13.1+forge" = _7oCQYdPW;
        "pkg-1.21.6-4.13.1+fabric" = _YZrf6xyP;
        "pkg-1.19.2-4.13.2+fabric" = _u5jDFNnx;
        "pkg-1.19.2-4.13.2+forge" = _LrPOkyxY;
        "pkg-1.18.2-4.13.2+fabric" = _1JeUeoFF;
        "pkg-1.18.2-4.13.2+forge" = _PXljqypL;
        "pkg-1.20.1-4.13.2+forge" = _dZo5GKEU;
        "pkg-1.20.1-4.13.2+fabric" = _beBlxf4Q;
        "pkg-1.21.1-4.13.2+neoforge" = _hk81xx3W;
        "pkg-1.21.1-4.13.2+forge" = _nbNKCNBV;
        "pkg-1.21.1-4.13.2+fabric" = _I5q314UI;
        "pkg-1.21.7-4.13.2+neoforge" = _nKpwafgJ;
        "pkg-1.21.7-4.13.2+forge" = _X5PYgebq;
        "pkg-1.21.7-4.13.2+fabric" = _N81xL9nS;
        "pkg-1.18.2-4.14.0+fabric" = _v27gmuZy;
        "pkg-1.18.2-4.14.0+forge" = _F9UNFoCG;
        "pkg-1.19.2-4.14.0+fabric" = _7FdLVTam;
        "pkg-1.19.2-4.14.0+forge" = _o4lTS13Y;
        "pkg-1.20.1-4.14.0+fabric" = _7B8dIqCH;
        "pkg-1.20.1-4.14.0+forge" = _y2XOxo0n;
        "pkg-1.21.1-4.14.0+neoforge" = _NLNub91X;
        "pkg-1.21.1-4.14.0+fabric" = _EIXwgAO4;
        "pkg-1.21.1-4.14.0+forge" = _R4onuV7P;
        "pkg-1.21.7-4.14.0+neoforge" = _KNEvowp1;
        "pkg-1.21.7-4.14.0+forge" = _ZfnySLpo;
        "pkg-1.21.7-4.14.0+fabric" = _ogPeFHme;
        "pkg-1.18.2-4.14.1+fabric" = _8e4mZbXD;
        "pkg-1.18.2-4.14.1+forge" = _fThlRCrG;
        "pkg-1.19.2-4.14.1+fabric" = _d7tZBxm0;
        "pkg-1.19.2-4.14.1+forge" = _7QDgDTpl;
        "pkg-1.20.1-4.14.1+forge" = _uNEGD88l;
        "pkg-1.20.1-4.14.1+fabric" = _Dzkxtqzp;
        "pkg-1.21.1-4.14.1+neoforge" = _n1O7cZsO;
        "pkg-1.21.1-4.14.1+fabric" = _PiP91rlZ;
        "pkg-1.21.1-4.14.1+forge" = _rarCi6dy;
        "pkg-1.21.8-4.14.1+neoforge" = _nmcs2fKF;
        "pkg-1.21.8-4.14.1+forge" = _dW6Jzwk0;
        "pkg-1.21.8-4.14.1+fabric" = _6DcwFcsS;
        "pkg-1.21.1-4.14.2+neoforge" = _Gsn5bIAB;
        "pkg-1.21.1-4.14.2+fabric" = _H2024JV2;
        "pkg-1.21.1-4.14.2+forge" = _XDlOWbol;
        "pkg-1.21.8-4.14.2+neoforge" = _Zb7c07et;
        "pkg-1.21.8-4.14.2+forge" = _4ZEZoDgE;
        "pkg-1.21.8-4.14.2+fabric" = _JGRCIq22;
        "pkg-1.18.2-4.14.3+fabric" = _5fO7bmu3;
        "pkg-1.18.2-4.14.3+forge" = _xNhumwhF;
        "pkg-1.19.2-4.14.3+forge" = _zt8Iixhe;
        "pkg-1.19.2-4.14.3+fabric" = _WQJ1fuRk;
        "pkg-1.20.1-4.14.3+fabric" = _2AfqXMyO;
        "pkg-1.20.1-4.14.3+forge" = _J38UPdFA;
        "pkg-1.21.1-4.14.3+neoforge" = _LPkBf5xI;
        "pkg-1.21.1-4.14.3+fabric" = _BIQQqM5R;
        "pkg-1.21.1-4.14.3+forge" = _8YKBMUvt;
        "pkg-1.21.8-4.14.3+neoforge" = _pZrW6mYl;
        "pkg-1.21.8-4.14.3+forge" = _WCrwfbOr;
        "pkg-1.21.8-4.14.3+fabric" = _zcXte1CA;
        "pkg-1.21.9-4.14.3+neoforge" = _WcBZyZNy;
        "pkg-1.21.9-4.14.3+forge" = _c9qhzPPz;
        "pkg-1.21.9-4.14.3+fabric" = _Pz7Tdb9S;
        "pkg-1.21.10-4.14.3+neoforge" = _QpTHZZq6;
        "pkg-1.21.10-4.14.3+forge" = _nyAZHieQ;
        "pkg-1.21.10-4.14.3+fabric" = _pYYN452V;
        "pkg-1.18.2-4.15.0+fabric" = _bTGWqaXb;
        "pkg-1.18.2-4.15.0+forge" = _FqnmUPoi;
        "pkg-1.19.2-4.15.0+fabric" = _Lj2855zG;
        "pkg-1.19.2-4.15.0+forge" = _1fC7NW7E;
        "pkg-1.20.1-4.15.0+fabric" = _t8vXjlAz;
        "pkg-1.20.1-4.15.0+forge" = _6okOewio;
        "pkg-1.21.1-4.15.0+neoforge" = _wQgnpoMb;
        "pkg-1.21.1-4.15.0+fabric" = _jtSuMWJY;
        "pkg-1.21.1-4.15.0+forge" = _Uo9HMve7;
        "pkg-1.21.10-4.15.0+neoforge" = _FaAISaOY;
        "pkg-1.21.10-4.15.0+forge" = _P1RyLzbA;
        "pkg-1.21.10-4.15.0+fabric" = _zx7kTt2F;
        "pkg-1.21.1-4.15.1+neoforge" = _6x5NJgJr;
        "pkg-1.21.1-4.15.1+fabric" = _wlwj8QvP;
        "pkg-1.21.1-4.15.1+forge" = _Yxwbp3W4;
        "pkg-1.21.10-4.15.1+neoforge" = _UDM5TwkW;
        "pkg-1.21.10-4.15.1+forge" = _4Si8YxKt;
        "pkg-1.21.10-4.15.1+fabric" = _JNt9s78n;
        "pkg-1.21.10-4.15.2+neoforge" = _tEakOAyQ;
        "pkg-1.21.10-4.15.2+forge" = _EGomKCXu;
        "pkg-1.21.10-4.15.2+fabric" = _8mM8oyLZ;
        "pkg-1.19.2-4.16.0+fabric" = _4d7Nmy2Z;
        "pkg-1.19.2-4.16.0+forge" = _fsF1wpiO;
        "pkg-1.20.1-4.16.0+fabric" = _2cpLhbZB;
        "pkg-1.20.1-4.16.0+forge" = _F0YaeEhe;
        "pkg-1.18.2-4.16.0+fabric" = _l2dTC7Hn;
        "pkg-1.18.2-4.16.0+forge" = _bXpXqBJ6;
        "pkg-1.21.1-4.16.0+neoforge" = _qtske3qb;
        "pkg-1.21.1-4.16.0+fabric" = _5Oj2VdqP;
        "pkg-1.21.1-4.16.0+forge" = _HZzAa7Ki;
        "pkg-1.21.10-4.16.0+neoforge" = _YMcLr5an;
        "pkg-1.21.10-4.16.0+forge" = _HR3q6twY;
        "pkg-1.21.10-4.16.0+fabric" = _Y1faR3sf;
        "pkg-1.21.1-4.16.1+neoforge" = _4FVd8rfB;
        "pkg-1.21.1-4.16.1+fabric" = _57Z0UVSh;
        "pkg-1.21.1-4.16.1+forge" = _PybsOmA6;
        "pkg-1.21.10-4.16.1+neoforge" = _FfUFwnO4;
        "pkg-1.21.10-4.16.1+forge" = _zAvmnDyV;
        "pkg-1.21.10-4.16.1+fabric" = _STOgCNp2;
        "pkg-1.18.2-4.16.2+forge" = _h5WFyXJD;
        "pkg-1.18.2-4.16.2+fabric" = _Qixjv5Uz;
        "pkg-1.19.2-4.16.2+forge" = _YwYGZBZT;
        "pkg-1.19.2-4.16.2+fabric" = _sV3WmsuS;
        "pkg-1.20.1-4.16.2+forge" = _wnRqDILe;
        "pkg-1.20.1-4.16.2+fabric" = _sIIlxse4;
        "pkg-1.21.1-4.16.2+neoforge" = _Z6J9q8kP;
        "pkg-1.21.1-4.16.2+forge" = _XF8xqJTS;
        "pkg-1.21.1-4.16.2+fabric" = _d4vI8ML7;
        "pkg-1.21.10-4.16.2+neoforge" = _dwdLnSp1;
        "pkg-1.21.10-4.16.2+forge" = _dV3iqWbq;
        "pkg-1.21.10-4.16.2+fabric" = _QVgUaCrX;
        "pkg-1.18.2-4.17.0+fabric" = _kZRuKiHB;
        "pkg-1.18.2-4.17.0+forge" = _D7wyK7CW;
        "pkg-1.19.2-4.17.0+forge" = _5rBqLs2L;
        "pkg-1.19.2-4.17.0+fabric" = _bLeQEsF3;
        "pkg-1.20.1-4.17.0+forge" = _EAmVtA50;
        "pkg-1.20.1-4.17.0+fabric" = _y1D0dTd2;
        "pkg-1.21.1-4.17.0+neoforge" = _HRtIv4kl;
        "pkg-1.21.1-4.17.0+forge" = _pphxnCmp;
        "pkg-1.21.1-4.17.0+fabric" = _jDAtw0xF;
        "pkg-1.21.10-4.17.0+neoforge" = _Ezb0hgpJ;
        "pkg-1.21.10-4.17.0+forge" = _9M7FTyzN;
        "pkg-1.21.10-4.17.0+fabric" = _lJxWmHeT;
        "pkg-1.21.1-4.17.1+neoforge" = _HCx7gtpH;
        "pkg-1.21.1-4.17.1+forge" = _68socJ9s;
        "pkg-1.21.1-4.17.1+fabric" = _QNRxJsgA;
        "pkg-1.21.10-4.17.1+neoforge" = _wXKW1cn5;
        "pkg-1.21.10-4.17.1+forge" = _Yd6Rn9Tw;
        "pkg-1.21.10-4.17.1+fabric" = _tSkbyw9X;
        "pkg-1.21.11-4.18.0+neoforge" = _mba4UfqF;
        "pkg-1.21.11-4.18.0+forge" = _6s64cDND;
        "pkg-1.21.11-4.18.0+fabric" = _2ecYYXA6;
        "pkg-1.20.1-4.18.1+forge" = _HB8m5p83;
        "pkg-1.20.1-4.18.1+fabric" = _jjkPQXTi;
        "pkg-1.21.1-4.18.1+neoforge" = _bIqOHwvH;
        "pkg-1.21.1-4.18.1+forge" = _oFbTxSII;
        "pkg-1.21.1-4.18.1+fabric" = _U8WadmvP;
        "pkg-1.18.2-4.18.1+fabric" = _N5jbpdxu;
        "pkg-1.18.2-4.18.1+forge" = _OfxvxNgn;
        "pkg-1.19.2-4.18.1+fabric" = _v3HVkeTH;
        "pkg-1.19.2-4.18.1+forge" = _uLzVL0Rk;
        "pkg-1.21.11-4.18.1+neoforge" = _wO8BjYvy;
        "pkg-1.21.11-4.18.1+fabric" = _VJZVJpGp;
        "pkg-1.21.11-4.18.1+forge" = _pqAno1sF;
        "pkg-1.18.2-4.18.2+fabric" = _xZqGqFfO;
        "pkg-1.18.2-4.18.2+forge" = _4vw2OApM;
        "pkg-1.19.2-4.18.2+forge" = _JkZqJyU8;
        "pkg-1.19.2-4.18.2+fabric" = _YckIQzTr;
        "pkg-1.20.1-4.18.2+forge" = _ALTXWFUW;
        "pkg-1.20.1-4.18.2+fabric" = _J2RWT791;
        "pkg-1.21.1-4.18.2+neoforge" = _1awEHsjv;
        "pkg-1.21.1-4.18.2+forge" = _obzsdv6I;
        "pkg-1.21.1-4.18.2+fabric" = _MO5nDwuJ;
        "pkg-1.21.11-4.18.2+fabric" = _BPrVxRd3;
        "pkg-1.21.11-4.18.2+forge" = _1UBPkfXr;
        "pkg-1.21.11-4.18.2+neoforge" = _ukoceHRY;
        "pkg-1.18.2-4.19.0+forge" = _JkN2lHX5;
        "pkg-1.19.2-4.19.0+forge" = _DInuoIac;
        "pkg-1.19.2-4.19.0+fabric" = _3alidhml;
        "pkg-1.18.2-4.19.0+fabric" = _sUXd07eF;
        "pkg-1.20.1-4.19.0+forge" = _D24T88Sx;
        "pkg-1.20.1-4.19.0+fabric" = _3UPFeLWu;
        "pkg-1.21.1-4.19.0+neoforge" = _LlG55gCj;
        "pkg-1.21.1-4.19.0+forge" = _gdYQ5o8f;
        "pkg-1.21.1-4.19.0+fabric" = _XQMIxvhV;
        "pkg-1.21.11-4.19.0+forge" = _4GTvnVl7;
        "pkg-1.21.11-4.19.0+fabric" = _N3W1gYwk;
        "pkg-1.21.11-4.19.0+neoforge" = _9Pn78f12;
        "pkg-1.21.11-4.20.0+fabric" = _ojJ4wxcJ;
        "pkg-1.21.11-4.20.0+forge" = _b50kmh2H;
        "pkg-1.21.11-4.20.0+neoforge" = _2ApQORJo;
        "pkg-1.21.11-4.21.0+forge" = _bw1KxRAe;
        "pkg-1.21.11-4.21.0+neoforge" = _gLxhmf1H;
        "pkg-1.21.11-4.21.0+fabric" = _Mk1X9Kzm;
        "pkg-1.18.2-4.21.0+fabric" = _NtAattLx;
        "pkg-1.18.2-4.21.0+forge" = _S0vVPrsx;
        "pkg-1.19.2-4.21.0+forge" = _DHdnssy8;
        "pkg-1.19.2-4.21.0+fabric" = _a4sXvKdw;
        "pkg-1.20.1-4.21.0+forge" = _dyrE1o1x;
        "pkg-1.20.1-4.21.0+fabric" = _zu0u5ILo;
        "pkg-1.21.1-4.21.0+neoforge" = _PWrxwRqT;
        "pkg-1.21.1-4.21.0+forge" = _UQHZpxif;
        "pkg-1.21.1-4.21.0+fabric" = _rTsAib7A;
        "pkg-1.20.1-4.22.0+forge" = _Uf8EZ65N;
        "pkg-1.20.1-4.22.0+fabric" = _xmUi98bl;
        "pkg-1.19.2-4.22.0+forge" = _ufucAPBi;
        "pkg-1.19.2-4.22.0+fabric" = _j8WJqHjj;
        "pkg-1.18.2-4.22.0+fabric" = _333OmP3R;
        "pkg-1.18.2-4.22.0+forge" = _Nr3Iolhh;
        "pkg-1.21.1-4.22.0+neoforge" = _4kL1z5XO;
        "pkg-1.21.1-4.22.0+fabric" = _XJw5tPaN;
        "pkg-1.21.1-4.22.0+forge" = _vojPdzRr;
        "pkg-1.21.11-4.22.0+fabric" = _VIt9lLsi;
        "pkg-1.21.11-4.22.0+forge" = _LqQoC7P1;
        "pkg-1.21.11-4.22.0+neoforge" = _SXDtEa3C;
        "pkg-1.21.11-4.22.1+forge" = _FERJzRqw;
        "pkg-1.21.11-4.22.1+neoforge" = _cHjbl50o;
        "pkg-1.21.11-4.22.1+fabric" = _oGaThJ85;
        "pkg-1.18.2-4.22.1+forge" = _xynayWha;
        "pkg-1.18.2-4.22.1+fabric" = _Jdaxlyqe;
        "pkg-1.19.2-4.22.1+forge" = _bkGZTjpA;
        "pkg-1.19.2-4.22.1+fabric" = _ldtwDhU7;
        "pkg-1.20.1-4.22.1+fabric" = _3Vj4gcEh;
        "pkg-1.20.1-4.22.1+forge" = _pwsCdsoj;
        "pkg-1.21.1-4.22.1+neoforge" = _GRCXBCdK;
        "pkg-1.21.1-4.22.1+forge" = _weVu2P7j;
        "pkg-1.21.1-4.22.1+fabric" = _45jG7kPX;
        "pkg-1.8.9-2.2.20+forge" = _Lxic55F7;
        "pkg-26.1-4.22.2+forge" = _dCxYVE5Q;
        "pkg-26.1-4.22.2+neoforge" = _1ecL1XQW;
        "pkg-26.1-4.22.2+fabric" = _lFYggGjh;
        "pkg-1.21.11-4.22.2+fabric" = _YFCAV7GK;
        "pkg-1.21.11-4.22.2+forge" = _x2suysXc;
        "pkg-26.1-4.22.3+fabric" = _P7VcuvXA;
        "pkg-26.1-4.22.3+forge" = _NLgN2Olt;
        "pkg-26.1-4.22.3+neoforge" = _jP1zu39F;
        "pkg-1.21.11-4.22.2+neoforge" = _yxdr0ePl;
        "pkg-1.20.1-4.22.3+fabric" = _4uGC5ySw;
        "pkg-1.20.1-4.22.3+forge" = _HWJNv2Cx;
        "pkg-1.21.1-4.22.3+neoforge" = _TGMmqvKB;
        "pkg-1.21.1-4.22.3+forge" = _3gVwwsNY;
        "pkg-1.21.1-4.22.3+fabric" = _EzFAYhnQ;
        "pkg-1.21.11-4.22.3+fabric" = _s4oI73di;
        "pkg-1.21.11-4.22.3+forge" = _inq182xB;
        "pkg-1.21.11-4.22.3+neoforge" = _ULxWLKUn;
        "pkg-1.21.1-4.22.4+neoforge" = _gJ9wDvJw;
        "pkg-1.21.1-4.22.4+forge" = _Krsq78CR;
        "pkg-1.21.1-4.22.4+fabric" = _8iwuMIVm;
        "pkg-26.1.1-4.22.5+forge" = _2aOLMW6r;
        "pkg-26.1.1-4.22.5+neoforge" = _fAxELoXn;
        "pkg-26.1.1-4.22.5+fabric" = _6YXm4Ttn;
        "pkg-1.21.1-4.22.5+neoforge" = _GzbD0h8v;
        "pkg-1.21.1-4.22.5+forge" = _hnbt5ogB;
        "pkg-1.21.1-4.22.5+fabric" = _i3BbejPJ;
        "pkg-1.20.1-4.22.5+fabric" = _LYeWdphG;
        "pkg-1.20.1-4.22.5+forge" = _ZXQX9GQs;
        "pkg-1.21.11-4.22.5+neoforge" = _3gO3is31;
        "pkg-1.21.11-4.22.5+forge" = _ayS9TEZI;
        "pkg-1.21.11-4.22.5+fabric" = _j3rdj1Py;
        "pkg-1.21.1-4.22.6+neoforge" = _n3preI8u;
        "pkg-1.21.1-4.22.6+forge" = _GYw7Irob;
        "pkg-1.21.1-4.22.6+fabric" = _j1s574Hn;
        "pkg-1.20.1-4.22.6+forge" = _1K45b03D;
        "pkg-1.20.1-4.22.6+fabric" = _lIk7E26A;
        "pkg-26.1.2-4.22.6+forge" = _z6kXEwnW;
        "pkg-26.1.2-4.22.6+fabric" = _SQCZzfzs;
        "pkg-26.1.2-4.22.6+neoforge" = _EetELMHy;
        "pkg-1.21.11-4.22.6+neoforge" = _fpDahlpi;
        "pkg-1.21.11-4.22.6+forge" = _Vrcz8BaW;
        "pkg-1.21.11-4.22.6+fabric" = _wjJ1S7S7;
        "pkg-1.20.1-4.22.7+forge" = _hSMX030p;
        "pkg-1.20.1-4.22.7+fabric" = _w0bTvZ5Y;
        "pkg-1.21.1-4.22.7+neoforge" = _N8sgtkZi;
        "pkg-1.21.1-4.22.7+forge" = _vCH1Yw37;
        "pkg-1.21.1-4.22.7+fabric" = _tT6Gmy3F;
        "pkg-26.1.2-4.22.7+fabric" = _QD3tQa99;
        "pkg-26.1.2-4.22.7+forge" = _kMnS0JL8;
        "pkg-26.1.2-4.22.7+neoforge" = _P1sZ1A4A;
        "pkg-1.21.11-4.22.7+fabric" = _4S4jRHvy;
        "pkg-1.21.11-4.22.7+forge" = _bLHJCwT4;
        "pkg-1.21.11-4.22.7+neoforge" = _BgLvTUKI;
        "pkg-26.1.2-4.22.8+forge" = _Gi0YIXiP;
        "pkg-26.1.2-4.22.8+fabric" = _bkNCeMCM;
        "pkg-26.1.2-4.22.8+neoforge" = _50GFCDD6;
        "pkg-1.21.1-4.22.8+neoforge" = _LWXCT8jy;
        "pkg-1.21.11-4.22.8+neoforge" = _GqEXLB4J;
        "pkg-1.21.11-4.22.8+forge" = _bYbTmzwO;
        "pkg-1.21.11-4.22.8+fabric" = _SQ9Qa4Nh;
        "pkg-1.21.1-4.22.8+fabric" = _xX2zuekI;
        "pkg-1.21.1-4.22.8+forge" = _Wras8VPH;
        "pkg-1.20.1-4.22.8+forge" = _bev1XIu4;
        "pkg-1.20.1-4.22.8+fabric" = _Nqwk4dvX;
        "pkg-1.20.1-4.22.9+forge" = _DXFF3glo;
        "pkg-1.20.1-4.22.9+fabric" = _y85RVvxs;
        "pkg-1.21.1-4.22.9+neoforge" = _pcaHotw0;
        "pkg-1.21.1-4.22.9+forge" = _gcue3WCi;
        "pkg-1.21.1-4.22.9+fabric" = _PnVyvvk8;
        "pkg-26.1.2-4.22.9+forge" = _eGy0VmeY;
        "pkg-26.1.2-4.22.9+fabric" = _ma6C8Bml;
        "pkg-26.1.2-4.22.9+neoforge" = _4ElhxdD5;
        "pkg-1.21.11-4.22.9+forge" = _V1SPyLvG;
        "pkg-1.21.11-4.22.9+neoforge" = _Oaz8jZT9;
        "pkg-1.21.11-4.22.9+fabric" = _PMRZIrmy;
        "pkg-1.20.1-4.22.10+forge" = _IE6g5yl5;
        "pkg-1.20.1-4.22.10+fabric" = _Deu7I03X;
        "pkg-26.1.2-4.22.10+fabric" = _QHG40eVI;
        "pkg-1.21.1-4.22.10+neoforge" = _dTyJ69lE;
        "pkg-26.1.2-4.22.10+forge" = _Kg5nyISY;
        "pkg-1.21.1-4.22.10+fabric" = _T9B9q5J7;
        "pkg-1.21.1-4.22.10+forge" = _gYynzqJf;
        "pkg-26.1.2-4.22.10+neoforge" = _tWFwUBIx;
        "pkg-1.21.11-4.22.10+forge" = _c0zyoBDf;
        "pkg-1.21.11-4.22.10+fabric" = _EV6itzLk;
        "pkg-1.21.11-4.22.10+neoforge" = _UiMxFtYS;
        "pkg-1.20.1-4.22.11+forge" = _IoipFutL;
        "pkg-1.20.1-4.22.11+fabric" = _z5v3awPZ;
        "pkg-26.1.2-4.22.11+forge" = _R9ZMMqmw;
        "pkg-26.1.2-4.22.11+fabric" = _c05oGyB7;
        "pkg-26.1.2-4.22.11+neoforge" = _JrxB5vx3;
        "pkg-1.21.1-4.22.11+neoforge" = _xjlsTrlL;
        "pkg-1.21.1-4.22.11+forge" = _OC5PQVxK;
        "pkg-1.21.1-4.22.11+fabric" = _CIVo0RLk;
        "pkg-1.21.11-4.22.11+forge" = _xTathZxM;
        "pkg-1.21.11-4.22.11+fabric" = _v3JSyqNo;
        "pkg-1.21.11-4.22.11+neoforge" = _OsTzX7oM;
        "pkg-1.21.1-4.22.12+neoforge" = _hIHjK7MW;
        "pkg-1.21.1-4.22.12+forge" = _DzyPZAqs;
        "pkg-1.21.1-4.22.12+fabric" = _gpBSYtcz;
        "pkg-26.1.2-4.22.12+fabric" = _akemYNox;
        "pkg-26.1.2-4.22.12+forge" = _aizt3Ls8;
        "pkg-26.1.2-4.22.12+neoforge" = _kr1XnVZJ;
        "pkg-1.20.1-4.22.12+fabric" = _XyPFHZ7g;
        "pkg-1.20.1-4.22.12+forge" = _TQk9rDdf;
        "pkg-1.21.11-4.22.12+forge" = _c5DLNoUb;
        "pkg-1.21.11-4.22.12+fabric" = _vShB7cN4;
        "pkg-1.21.11-4.22.12+neoforge" = _XfwkwR3l;
        "pkg-26.1.2-5.0.0+fabric" = _E0IGCuUi;
        "pkg-26.1.2-5.0.0+forge" = _uXknQN3N;
        "pkg-26.1.2-5.0.0+neoforge" = _R9yp92qn;
        "pkg-26.2-5.0.0+forge" = _1wjz9txU;
        "pkg-26.2-5.0.0+fabric" = _6FLgBgZW;
        "pkg-26.2-5.0.0+neoforge" = _oHoeWJeH;
        "pkg-1.20.1-5.0.0+fabric" = _8fbDc7Sf;
        "pkg-1.20.1-5.0.0+forge" = _czJ7pw1J;
        "pkg-1.21.1-5.0.0+forge" = _FOvLkHCg;
        "pkg-1.21.11-5.0.0+forge" = _vjM4jHuq;
        "pkg-1.21.11-5.0.0+fabric" = _LXuXqlJn;
        "pkg-1.21.11-5.0.0+neoforge" = _VcloWhFL;
        "pkg-1.21.1-5.0.0+fabric" = _p8EtsqKB;
        "pkg-1.21.1-5.0.0+neoforge" = _NLEHGZBB;
        "pkg-26.2-5.0.1+fabric" = _47NcahBj;
        "pkg-26.1.2-5.0.1+fabric" = _S71eiuR7;
        "pkg-26.1.2-5.0.1+forge" = _Oz6Jznsh;
        "pkg-26.1.2-5.0.1+neoforge" = _ICvdxrD6;
        "pkg-26.2-5.0.1+forge" = _LH5oq9d0;
        "pkg-26.2-5.0.1+neoforge" = _yQ8TGdLy;
        "pkg-1.21.1-5.0.1+neoforge" = _Ql9gh62k;
        "pkg-1.21.1-5.0.1+fabric" = _bh1H9mbP;
        "pkg-1.21.1-5.0.1+forge" = _XiB6hw0A;
        "pkg-1.20.1-5.0.1+fabric" = _RrVrsEqd;
        "pkg-1.20.1-5.0.1+forge" = _pQhJA9Hn;
        "pkg-1.21.11-5.0.1+forge" = _mm61hPgv;
        "pkg-1.21.11-5.0.1+fabric" = _b1aiUBp0;
        "pkg-1.21.11-5.0.1+neoforge" = _MjIbH5en;
        "pkg-26.2-5.0.2+forge" = _gRQMvMYE;
        "pkg-26.2-5.0.2+fabric" = _OMtPb1KE;
        "pkg-26.2-5.0.2+neoforge" = _LV4vd54u;
        "pkg-26.1.2-5.0.2+neoforge" = _prHf6CYV;
        "pkg-26.1.2-5.0.2+forge" = _QICx4hQq;
        "pkg-26.1.2-5.0.2+fabric" = _zOIvL8Ik;
        "pkg-1.20.1-5.0.2+forge" = _lxcbfZrX;
        "pkg-1.20.1-5.0.2+fabric" = _Y9QgEzMD;
        "pkg-1.21.1-5.0.2+forge" = _pyN478CJ;
        "pkg-1.21.1-5.0.2+fabric" = _eR3yAz0M;
        "pkg-1.21.1-5.0.2+neoforge" = _sQituBzN;
        "pkg-1.21.11-5.0.2+forge" = _MzKkYlXa;
        "pkg-1.21.11-5.0.2+fabric" = _JF1ykLdC;
        "pkg-1.21.11-5.0.2+neoforge" = _UyiebqOj;
        "pkg-26.1.2-5.0.3+fabric" = _YGQmYUYL;
        "pkg-26.1.2-5.0.3+forge" = _Xmytf17t;
        "pkg-26.1.2-5.0.3+neoforge" = _wlJS0Kps;
        "pkg-26.2-5.0.3+fabric" = _w7ipkIoe;
        "pkg-26.2-5.0.3+forge" = _asDrODna;
        "pkg-1.21.1-5.0.3+neoforge" = _REyH4cbU;
        "pkg-26.2-5.0.3+neoforge" = _SYOyScUH;
        "pkg-1.21.1-5.0.3+fabric" = _F09bSvH8;
        "pkg-1.21.1-5.0.3+forge" = _LVhLsqyD;
        "pkg-1.20.1-5.0.3+fabric" = _Ce0ik27c;
        "pkg-1.20.1-5.0.3+forge" = _UNp73heC;
        "pkg-1.21.11-5.0.3+forge" = _tFzDH0EG;
        "pkg-1.21.11-5.0.3+neoforge" = _KzWbL8fb;
        "pkg-1.21.11-5.0.3+fabric" = _pqptZKtT;
        "pkg-1.20.1-5.0.4+forge" = _3GtgLS8j;
        "pkg-1.20.1-5.0.4+fabric" = _PRzaBgU9;
        "pkg-1.21.1-5.0.4+neoforge" = _f1fOiww4;
        "pkg-1.21.1-5.0.4+forge" = _YDPpdvOS;
        "pkg-1.21.1-5.0.4+fabric" = _ydpjIi6j;
        "pkg-26.1.2-5.0.4+forge" = _2kVhLfkP;
        "pkg-26.1.2-5.0.4+fabric" = _scDuoxEd;
        "pkg-26.1.2-5.0.4+neoforge" = _FnqgJnox;
        "pkg-26.2-5.0.4+fabric" = _LF7J06u3;
        "pkg-26.2-5.0.4+forge" = _J1KDaevE;
        "pkg-26.2-5.0.4+neoforge" = _LpXeU88n;
        "pkg-1.21.11-5.0.4+forge" = _YtQFDlix;
        "pkg-1.21.11-5.0.4+neoforge" = _8n8GHX4B;
        "pkg-1.21.11-5.0.4+fabric" = _Q2o17zuF;
        "pkg-1.21.1-5.0.5+neoforge" = _9M3XJ4pj;
        "pkg-1.21.1-5.0.5+forge" = _QhebcnL8;
        "pkg-1.21.1-5.0.5+fabric" = _1dGQkDmP;
        "pkg-26.2-5.0.5+fabric" = _vSdi24Ew;
        "pkg-26.2-5.0.5+forge" = _2X4xr2F6;
        "pkg-26.2-5.0.5+neoforge" = _myvX4GKI;
        "pkg-1.20.1-5.0.5+fabric" = _IFY5sVv5;
        "pkg-1.20.1-5.0.5+forge" = _omnmD2A3;
        "pkg-26.1.2-5.0.5+fabric" = _HPzAv3YK;
        "pkg-26.1.2-5.0.5+forge" = _ygBk07Hz;
        "pkg-26.1.2-5.0.5+neoforge" = _eKH7aq39;
        "pkg-1.21.11-5.0.5+fabric" = _vVli4hKi;
        "pkg-1.21.11-5.0.5+forge" = _AsOVCJZr;
        "pkg-1.21.11-5.0.5+neoforge" = _OsFLmi6s;
        "pkg-1.21.1-5.0.6+neoforge" = _mgz2aQwt;
        "pkg-1.21.1-5.0.6+forge" = _VmkSwZ4w;
        "pkg-1.21.1-5.0.6+fabric" = _5Oxfr1lm;
        "pkg-26.2-5.0.6+fabric" = _laNe2Ap9;
        "pkg-26.2-5.0.6+forge" = _p1GHsju2;
        "pkg-26.2-5.0.6+neoforge" = _pemky6k5;
        "pkg-26.1.2-5.0.6+fabric" = _qIJtuIrb;
        "pkg-26.1.2-5.0.6+forge" = _9KVhBRvt;
        "pkg-26.1.2-5.0.6+neoforge" = _tOFgrvzb;
        "pkg-1.20.1-5.0.6+fabric" = _OJ6zu5Jc;
        "pkg-1.20.1-5.0.6+forge" = _mPTYRl51;
        "pkg-1.21.11-5.0.6+forge" = _ZiH7tB7J;
        "pkg-1.21.11-5.0.6+fabric" = _95mKg1z0;
        "pkg-1.21.11-5.0.6+neoforge" = _XczXyBAV;
        "pkg-1.20.1-5.0.7+fabric" = _58iWDW6u;
        "pkg-1.20.1-5.0.7+forge" = _OzMV8ZUD;
        "pkg-26.2-5.0.7+forge" = _sqmWg3kY;
        "pkg-26.2-5.0.7+fabric" = _q46r8WX3;
        "pkg-26.2-5.0.7+neoforge" = _nJKYJx4U;
        "pkg-1.21.1-5.0.7+neoforge" = _2AnJoniT;
        "pkg-1.21.1-5.0.7+forge" = _QdlQnOsZ;
        "pkg-1.21.1-5.0.7+fabric" = _kckBg2Ws;
        "pkg-26.1.2-5.0.7+forge" = _5BQ37Gvr;
        "pkg-26.1.2-5.0.7+neoforge" = _x1emWsIH;
        "pkg-26.1.2-5.0.7+fabric" = _T6E6j6w2;
        "pkg-1.21.11-5.0.7+fabric" = _ZFHJLPU3;
        "pkg-1.21.11-5.0.7+forge" = _4Zjehgk6;
        "pkg-1.21.11-5.0.7+neoforge" = _BL5NO1MY;
        "pkg-1.21.1-5.0.8+neoforge" = _agb9W48c;
        "pkg-1.21.1-5.0.8+forge" = _sHpvePEW;
        "pkg-1.21.1-5.0.8+fabric" = _F8zJUm12;
        "pkg-1.21.1-5.0.9+neoforge" = _aMXy4qc2;
        "pkg-1.21.1-5.0.9+forge" = _FifE9ueV;
        "pkg-1.21.1-5.0.9+fabric" = _6GqtR3tB;
        "pkg-1.20.1-5.0.10+forge" = _C2x1kSj7;
        "pkg-1.20.1-5.0.10+fabric" = _O8zmlXQC;
        "pkg-1.21.1-5.0.10+neoforge" = _uU3wk3Wt;
        "pkg-1.21.1-5.0.10+forge" = _QYdPH8BK;
        "pkg-1.21.1-5.0.10+fabric" = _anYPmP8X;
        "pkg-26.1.2-5.0.10+forge" = _hhvbNiF8;
        "pkg-26.1.2-5.0.10+fabric" = _kpNYppvf;
        "pkg-26.1.2-5.0.10+neoforge" = _reonXl6w;
        "pkg-1.21.11-5.0.10+neoforge" = _PnwHPPor;
        "pkg-1.21.11-5.0.10+forge" = _qqIY2QVJ;
        "pkg-1.21.11-5.0.10+fabric" = _9T2YSavE;
        "pkg-26.2-5.0.10+fabric" = _6xtZHRcb;
        "pkg-26.2-5.0.10+neoforge" = _9eUbSawn;
        "pkg-26.2-5.0.10+forge" = _O0rZjp1D;
        "pkg-1.20.1-5.0.11+forge" = _P7QoCfeQ;
        "pkg-1.20.1-5.0.11+fabric" = _ovGsejgS;
        "pkg-1.21.1-5.0.11+neoforge" = _gtUuy6S9;
        "pkg-1.21.1-5.0.11+forge" = _rXimvg4V;
        "pkg-1.21.1-5.0.11+fabric" = _u13y2lzx;
        "pkg-26.2-5.0.11+fabric" = _xF3YjhUq;
        "pkg-26.2-5.0.11+forge" = _f7tjIKIo;
        "pkg-26.2-5.0.11+neoforge" = _O3SwQJDX;
