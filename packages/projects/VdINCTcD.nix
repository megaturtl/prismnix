...
let
    ...
    in {
        ...
        "pkg-0.1.8" = _suZ3x4vQ;
        "pkg-0.1.9" = _FK999FtH;
        "pkg-0.1.10" = _K5VCouTT;
        "pkg-1.0.0+1.21.11" = _yCgrb7Xn;
        "pkg-1.0.0+26.1" = _ObMlwwxW;
        "pkg-1.0.1+1.21.11" = _eod6MIZX;
        "pkg-1.0.1+26.1" = _AP7Vz7nH;
        "pkg-1.0.2+1.21.11" = _uHmOmV6H;
        "pkg-1.0.2+26.1" = _Czkk5K0Q;
        "pkg-1.0.3+26.1" = _7nuUfm9K;
        "pkg-1.0.3+1.21.11" = _y8aNSRu8;
        "pkg-1.0.4+1.21.11" = _at7RtviJ;
        "pkg-1.0.4+26.1" = _L9TlOEvz;
        "pkg-1.0.5+26.1" = _PFQ4ggn0;
        "pkg-1.0.5+1.21.11" = _mw61vrNt;
        "pkg-1.0.6+1.21.11" = _XMoyUdGn;
        "pkg-1.0.6+26.1" = _GCwYAyqY;
        "pkg-1.0.7+26.1" = _1nRZYXq1;
        "pkg-1.0.7+1.21.11" = _HuX6T3TW;
        "pkg-1.1.0+26.2" = _519WaD7o;
