...
let
    ...
    in {
        ...
        "pkg-1.1" = _ypGoy7Y6;
        "pkg-1.1+mod" = _8ywaZZyU;
        "pkg-1.2" = _vxhHMDeG;
        "pkg-1.2+mod" = _jFHnG50G;
        "pkg-1.3" = _65SZxZZ9;
        "pkg-1.3+mod" = _LJPfuEzv;
        "pkg-1.4" = _8PfhpMZz;
        "pkg-1.4+mod" = _Qh4YDWnF;
        "pkg-1.5" = _gxk9h0rn;
        "pkg-1.5+mod" = _6o5FuXjG;
        "pkg-1.6" = _Cy30tIwP;
        "pkg-1.6+mod" = _vhbrCaYG;
        "pkg-1.7" = _4Paq2UJB;
        "pkg-1.7-fabric" = _EuhArw1P;
        "pkg-1.7-forge" = _2aLFsfZp;
        "pkg-1.11" = _Gv4voQtc;
        "pkg-1.11-fabric" = _mOseOMam;
        "pkg-1.11-quilt" = _ylsOaQEU;
        "pkg-1.11-forge" = _BfJHDCoM;
        "pkg-1.11-neoforge" = _KQR5hbPJ;
        "pkg-1.12" = _W3BklK4p;
        "pkg-1.12-fabric" = _cqlN6Yuq;
