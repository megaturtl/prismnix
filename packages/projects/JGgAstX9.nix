...
let
    ...
    in {
        ...
        "pkg-1.2.0" = _KTA77Yz7;
        "pkg-1.2.2-fabric-1.21.1" = _fuOdYEtq;
        "pkg-1.2.2-fabric-1.20.1" = _5AKSGcb6;
        "pkg-1.2.3-fabric-1.20.1" = _t3MN35k0;
        "pkg-1.2.5-fabric-1.20.1" = _h2m3gWQO;
        "pkg-1.2.6-fabric-1.20.1" = _mfM6Hvdw;
        "pkg-1.3.0-fabric-1.20.1" = _tDbwkg8N;
        "pkg-1.4.0-fabric-1.20.1" = _oHJCtjPM;
        "pkg-1.4.1-fabric-1.21.1" = _cyz8YMOs;
        "pkg-1.4.2-fabric-1.21.1" = _N7eIdti9;
        "pkg-1.4.2-fabric-1.20.1" = _jdN8MDa3;
        "pkg-1.4.3-fabric-1.20.1" = _LRBDhUCY;
        "pkg-1.4.3-fabric-1.21.1" = _ajiGLzzM;
        "pkg-1.4.4-fabric-1.20.1" = _NelkwDk2;
        "pkg-1.4.4-fabric-1.21.1" = _6Vg1i4jJ;
        "pkg-1.4.5-fabric-1.21.1" = _Eefd3Vpf;
        "pkg-1.4.6-fabric-1.21.1" = _JAqrDYsN;
        "pkg-1.4.6-fabric-1.20.1" = _HcQgUgWL;
        "pkg-1.4.8-fabric-1.20.1" = _CLgFjPeM;
        "pkg-1.4.8-fabric-1.21.1" = _LpTFyNID;
        "pkg-1.5.0-fabric-1.20.1" = _FepLncno;
        "pkg-1.5.1-fabric-1.20.1" = _ZlvYlJrL;
        "pkg-1.5.2-fabric-1.21.1" = _EmwUmxMm;
        "pkg-1.5.2b-fabric-1.21.1" = _W8Dz3t6f;
        "pkg-1.5.3-fabric-1.21.1" = _v6yhCRRT;
        "pkg-1.5.4-fabric-1.21.1" = _TQ1M3X9q;
        "pkg-1.5.4-fabric-1.20.1" = _ze1SgKPH;
        "pkg-1.6.0-fabric-1.20.1" = _gfbK4mHS;
        "pkg-1.7.0-fabric-1.20.1" = _uBdE88O6;
        "pkg-1.7.0-fabric-1.21.1" = _kBuqFazu;
        "pkg-1.7.0a-fabric-1.21.1" = _LaB7PUJ4;
        "pkg-1.8.0-fabric-1.20.1" = _pZezsnWU;
        "pkg-1.8.0-fabric-1.21.1" = _PwvEIRsM;
        "pkg-1.8.1-fabric-1.21.1" = _5vXZsXdZ;
        "pkg-1.8.2-fabric-1.20.1" = _DbX6V260;
        "pkg-1.8.2-fabric-1.21.1" = _yKuiXqBC;
        "pkg-1.8.3-fabric-1.21.1" = _kgll5TNz;
        "pkg-1.8.3-fabric-1.20.1" = _75SQlcXc;
        "pkg-1.8.4-fabric-1.20.1" = _6pQJNRO7;
        "pkg-1.8.4-fabric-1.21.1" = _159fsVfd;
        "pkg-1.8.5-fabric-1.20.1" = _3o8Zfx4S;
        "pkg-1.8.6-fabric-1.21.1" = _8K4jkPfg;
