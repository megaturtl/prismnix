...
let
    ...
    in {
        ...
        "pkg-1.3.0" = _8eYsmXM1;
        "pkg-1.4.0" = _QcuZgST2;
        "pkg-1.4.1-1.21.5" = _3cpxh5Dh;
        "pkg-1.4.1-1.21.8" = _IFmqybzS;
        "pkg-1.4.2-1.21.5" = _d26WfaMb;
        "pkg-1.4.2-1.21.8" = _JEeQd7jP;
        "pkg-1.4.3-1.21.5" = _FYoTwaDu;
        "pkg-1.4.3-1.21.8" = _8NmgDxjx;
        "pkg-1.4.4-1.21.5" = _bY70peCq;
        "pkg-1.4.4-1.21.8" = _2bXeIYML;
        "pkg-1.4.5-1.21.5" = _7Rfya3rv;
        "pkg-1.4.5-1.21.8" = _I7xiUr9K;
        "pkg-1.4.6-1.21.5" = _eqK65OhR;
        "pkg-1.4.6-1.21.8" = _I6NbEmDo;
        "pkg-1.5.0-1.21.5" = _XejBfkFE;
        "pkg-1.5.0-1.21.8" = _zk12zd7C;
        "pkg-1.5.0-1.21.10" = _EgcAX5f5;
        "pkg-1.6.0-1.21.5" = _917WODIJ;
        "pkg-1.6.0-1.21.8" = _f4oKz4Wl;
        "pkg-1.6.0-1.21.10" = _yf0tsi8j;
        "pkg-1.6.1-1.21.5" = _ZIDWwPnA;
        "pkg-1.6.1-1.21.8" = _ZvjGOEzg;
        "pkg-1.6.1-1.21.10" = _gqigegB4;
        "pkg-1.6.2-1.21.5" = _Ip9AzT0g;
        "pkg-1.6.2-1.21.8" = _5Ov77ATh;
        "pkg-1.6.2-1.21.10" = _GcGKTuGD;
        "pkg-1.6.3-1.21.5" = _TOHqKMLZ;
        "pkg-1.6.3-1.21.8" = _yvJShcXv;
        "pkg-1.6.3-1.21.10" = _V16bZn1K;
        "pkg-1.6.4-1.21.5" = _rRp0WoY2;
        "pkg-1.6.4-1.21.8" = _NVzdZzDH;
        "pkg-1.6.4-1.21.10" = _yLFayEAh;
        "pkg-1.6.5-1.21.5" = _pauCTPUn;
        "pkg-1.6.5-1.21.8" = _FbdR1tws;
        "pkg-1.6.5-1.21.10" = _wMLYGLo3;
        "pkg-1.6.5-1.21.11" = _bD77uQCY;
        "pkg-1.6.6-1.21.5" = _YVRxNG2y;
        "pkg-1.6.6-1.21.8" = _I3fYOtiT;
        "pkg-1.6.6-1.21.10" = _cJglZb5m;
        "pkg-1.6.6-1.21.11" = _NbupMGtg;
        "pkg-1.6.7-1.21.5" = _xFbXxTb0;
        "pkg-1.6.7-1.21.8" = _yt81kWwI;
        "pkg-1.6.7-1.21.10" = _7iYmgq8W;
        "pkg-1.6.7-1.21.11" = _2sABsyhR;
        "pkg-1.7.0-1.21.5" = _Yjrel9Dg;
        "pkg-1.7.0-1.21.8" = _qCi480bM;
        "pkg-1.7.0-1.21.10" = _4qaXkhdd;
        "pkg-1.7.0-1.21.11" = _W9hhB28T;
        "pkg-1.7.1-1.21.10" = _9TlKQxM3;
        "pkg-1.7.1-1.21.11" = _AEmL8a00;
        "pkg-1.7.2-1.21.10" = _vmmZcUrl;
        "pkg-1.7.2-1.21.11" = _2WHRIscy;
        "pkg-1.7.3-1.21.10" = _ssMlZYEp;
        "pkg-1.7.3-1.21.11" = _1iw7YEDj;
        "pkg-1.8.0" = _L2zPRvG5;
        "pkg-1.8.1" = _K48MjpDw;
        "pkg-1.8.2" = _MUcoCftQ;
        "pkg-1.8.3" = _enCfbBib;
