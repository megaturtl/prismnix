...
let
    versions = (let
        ...
        _uLV2UFIG = {
            "id" = "uLV2UFIG";
            "file" = "elytra_purple-1.0.1-mc26.3.zip";
            "hash" = "sha512-ZjhggQ2jui3YHgpGumKAEDBxP8vKWiZegJpExRzACzBFUVOnd8PAgpYiG7A0MwMfu827HNfrug0IfXbEcQpApw==";
        };
    in {
        "JJ0OI91F" = _JJ0OI91F;
        "5kMDL2GB" = _5kMDL2GB;
