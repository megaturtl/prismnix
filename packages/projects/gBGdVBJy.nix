...
let
    ...
    in {
        ...
        "pkg-1.1.2" = _raWodeSb;
        "pkg-1.1.3" = _TkpeaWEM;
        "pkg-1.1.3a" = _Omdrcn17;
        "pkg-1.1.4" = _q2lyova5;
        "pkg-1.1.4a" = _dPjdGhGW;
        "pkg-1.1.5" = _M72cJnld;
        "pkg-1.1.5a" = _A3o1TT9P;
        "pkg-1.1.6" = _KqsFb5P6;
        "pkg-1.1.7" = _DdCpl5Lq;
        "pkg-1.1.7b" = _t10lPO8L;
        "pkg-1.1.7c" = _ckOBi8Ou;
        "pkg-1.1.7d" = _wTljl54O;
        "pkg-1.1.7a" = _CNUKdjzX;
        "pkg-1.1.7e" = _OJEzJil1;
        "pkg-1.1.8" = _BE22Ls2n;
        "pkg-1.1.9" = _sB2Z8idd;
        "pkg-1.1.10" = _ptG64SYO;
        "pkg-1.2.0" = _i8UilZT7;
        "pkg-1.2.1" = _l2ntEwrK;
        "pkg-1.2.2" = _8gtnU6pd;
        "pkg-1.2.3" = _9NT9IkSs;
