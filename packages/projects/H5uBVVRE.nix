...
let
    ...
    in {
        ...
        "pkg-0.9.8" = _iSUsLzAR;
        "pkg-0.9.9" = _5bh3zzfH;
        "pkg-0.9.10" = _ggS4iQOU;
        "pkg-0.9.11" = _HIEym8mi;
        "pkg-0.9.13" = _wJmHQdHv;
        "pkg-0.9.14" = _BebfiTLc;
        "pkg-0.9.15" = _7hVwyReP;
        "pkg-0.9.16" = _O5NVy2US;
        "pkg-0.9.17" = _xWZK5COR;
        "pkg-0.9.18" = _LU6SJouG;
        "pkg-0.9.19" = _3CpNCXfs;
        "default" = _3CpNCXfs;
    });
