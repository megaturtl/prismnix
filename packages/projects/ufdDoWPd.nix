...
let
    ...
    in {
        ...
        "pkg-8.3.4" = _8hHupPeX;
        "pkg-9.2.0" = _odE9dryC;
        "pkg-10.0.0" = _NG2fAyV2;
        "pkg-10.0.1" = _UMHP8XCt;
        "pkg-11.0.0" = _yGVi4Mki;
        "pkg-6.1.4" = _D3iIYLLN;
        "pkg-11.1.0" = _sa6v3181;
        "pkg-11.1.1" = _B1JI6pby;
        "pkg-12.0.0" = _ftKkUvKO;
        "pkg-8.3.5" = _7O02Ssvf;
        "pkg-13.0.0" = _OfklYxX1;
        "pkg-13.1.0" = _cfL5Nu9k;
        "pkg-11.2.0" = _NC8lGV3m;
        "pkg-11.3.0" = _kyG6D8vz;
        "pkg-11.4.0" = _yjngTsCe;
        "pkg-11.5.0" = _wsR0QCZZ;
        "pkg-13.2.0" = _NmgZ2Jz9;
        "pkg-11.5.1" = _6Tmvh4j8;
        "pkg-13.3.0" = _Gtj8l2Up;
        "pkg-11.5.2" = _tB6mRzYK;
        "pkg-11.5.3" = _dHXtj93x;
        "pkg-11.5.4" = _oFtlSakg;
        "pkg-13.4.0" = _BCkH3kc1;
        "pkg-13.5.0" = _PtoQKBEQ;
        "pkg-8.3.6" = _yQbhR062;
        "pkg-13.5.1" = _KvsOoXuV;
        "pkg-11.5.5" = _7sImHYOJ;
        "pkg-14.0.0-alpha.0" = _91gBVx1I;
        "pkg-14.0.0-alpha.1" = _bvxrhxaR;
        "pkg-14.0.0-alpha.2" = _bhQ3uOXN;
        "pkg-11.6.0" = _rNohcrvf;
        "pkg-11.6.1" = _4ujawcN3;
        "pkg-11.6.2" = _PeDa5Y5Z;
        "pkg-14.0.0-alpha.3+fabric" = _tYgAQD0R;
        "pkg-14.0.0+fabric" = _jLkpymWb;
        "pkg-11.8.1" = _YIKBDvvg;
        "pkg-11.8.2" = _1lL360rM;
        "pkg-14.1.0+fabric" = _aKyenzvF;
        "pkg-14.1.1+fabric" = _IfCOSTjm;
        "pkg-11.8.3+forge" = _2tmcT9ub;
        "pkg-11.8.4+forge" = _mTA7KgnQ;
        "pkg-11.8.5+forge" = _2jpT7cUu;
        "pkg-11.8.6+forge" = _2Bqv8FLz;
        "pkg-14.1.2+fabric" = _YzmCNNU8;
        "pkg-11.8.8+forge" = _534wrSU5;
        "pkg-11.8.9+forge" = _uNrnnShg;
        "pkg-15.0.0+fabric" = _qqzg3ct7;
        "pkg-15.0.1+fabric" = _w2J0gwoG;
        "pkg-15.0.2+fabric" = _VM0r8zqB;
        "pkg-11.8.10+forge" = _cfAlF1N0;
        "pkg-11.8.11+forge" = _D7i9bX9a;
        "pkg-15.1.0+fabric" = _mzMc1VzM;
        "pkg-11.8.12+forge" = _LLZFCcpR;
        "pkg-11.8.13+forge" = _SDBOOyWI;
        "pkg-11.8.14+forge" = _xmCZa1a2;
        "pkg-11.6.3" = _eHo98RlA;
        "pkg-11.8.15+forge" = _u0erKlAo;
        "pkg-11.8.17+fabric" = _6k91KQQx;
        "pkg-11.8.18+fabric" = _Egcry8Dd;
        "pkg-11.8.19+fabric" = _WlxfPLdR;
        "pkg-11.8.19+forge" = _KHPmloYE;
        "pkg-11.8.20+forge" = _Zd09X9xP;
        "pkg-11.8.21+fabric" = _Hjlv8Bs2;
        "pkg-11.8.22+fabric" = _T0vKL7sT;
        "pkg-11.8.23+fabric" = _51iUE2ht;
        "pkg-11.8.24+fabric" = _G3h00JKd;
        "pkg-15.1.1+fabric" = _r8MVp0Lk;
        "pkg-15.2.1+neoforge" = _UlUhN02s;
        "pkg-11.8.26+fabric" = _lhlLIEoV;
        "pkg-15.2.2+neoforge" = _AhP0x6rX;
        "pkg-15.1.2+fabric" = _Vby6TNe4;
        "pkg-11.8.27+fabric" = _e0ANOFVW;
        "pkg-11.8.28+fabric" = _vXiIlQ0y;
        "pkg-11.8.28+forge" = _nxSd3PG9;
        "pkg-15.1.3+fabric" = _RhkbUeKS;
        "pkg-15.3.1+neoforge" = _vegHxm9d;
        "pkg-11.8.29+forge" = _A4YxIHAO;
        "pkg-15.3.2+neoforge" = _M8h5uYyf;
        "pkg-15.1.4+fabric" = _LzP2xOQB;
        "pkg-11.8.30+forge" = _SpmpxVSh;
        "pkg-15.3.3+neoforge" = _DKRu9xp6;
        "pkg-15.3.4+neoforge" = _GjElIJ7a;
        "pkg-15.3.5+neoforge" = _v22N1NhV;
        "pkg-15.4.0+neoforge" = _CD51qDur;
        "pkg-15.4.1+neoforge" = _yGy49Ijh;
        "pkg-15.4.2+neoforge" = _fTiNeCk9;
        "pkg-15.1.5+fabric" = _iAK06iqs;
        "pkg-15.5.0+neoforge" = _LYebfwDu;
        "pkg-15.5.1+neoforge" = _vM3lLRYY;
        "pkg-11.8.31+forge" = _MuVJPnGY;
        "pkg-11.8.29+fabric" = _bYC491Ev;
        "pkg-15.5.2+neoforge" = _ZvGKDVT9;
        "pkg-15.6.0+neoforge" = _UcYWPVZQ;
        "pkg-15.6.1+neoforge" = _EWWtrwik;
        "pkg-11.9.1+forge" = _BJVrmFLM;
        "pkg-11.9.2+forge" = _u7HrABzs;
        "pkg-15.6.2+neoforge" = _IP7Ou4CA;
        "pkg-15.7.0+neoforge" = _lL3hwqbE;
        "pkg-15.7.1+neoforge" = _ho7HNUkI;
        "pkg-15.7.2+neoforge" = _jc5qpXqE;
        "pkg-15.7.3+neoforge" = _B5FBsDea;
        "pkg-15.7.4+neoforge" = _xtpuH0yV;
        "pkg-15.7.5+neoforge" = _SWUocILl;
        "pkg-15.8.0+neoforge" = _P9gwSvI2;
        "pkg-15.8.1+neoforge" = _4oAxCOIk;
        "pkg-15.8.2+neoforge" = _eCzvKS7q;
        "pkg-11.10.0+forge" = _hHZTjmFa;
        "pkg-15.8.2+fabric" = _qCiN1Uwp;
        "pkg-11.10.0+fabric" = _7urEkTCP;
        "pkg-11.10.1+fabric" = _VbJH7x0u;
        "pkg-11.10.1+forge" = _wicX5vj2;
        "pkg-11.10.2+fabric" = _uSILacpp;
        "pkg-15.8.3+neoforge" = _2flHQIzv;
        "pkg-15.8.3+fabric" = _vqjdnlvF;
        "pkg-26.0.2+fabric" = _MHpjc4LZ;
        "pkg-26.0.3+fabric" = _61gzGhBu;
        "pkg-26.0.4+fabric" = _knDWKx3e;
        "pkg-26.0.5+neoforge" = _nT2SatOd;
        "pkg-26.0.6+neoforge" = _wF99VJsN;
        "pkg-26.0.7+neoforge" = _Dg5gQizK;
        "pkg-11.10.2+forge" = _n5ageHH3;
        "pkg-11.10.3+fabric" = _SjsWkzDP;
        "pkg-15.8.4+neoforge" = _Zr2eBMyy;
        "pkg-15.8.4+fabric" = _QTwmfxCj;
        "pkg-26.0.8+neoforge" = _5ZlNZC3t;
        "pkg-11.10.3+forge" = _NSxwah05;
        "pkg-26.0.9+fabric" = _5HZmFHuH;
        "pkg-26.0.9+neoforge" = _Oq3DU7Ah;
        "pkg-15.8.5+fabric" = _5pmXTdFo;
        "pkg-15.8.5+neoforge" = _7CnqjEJ7;
        "pkg-26.0.10+fabric" = _49rRkLWN;
        "pkg-26.0.11+fabric" = _SUalH113;
        "pkg-26.0.12+fabric" = _62ve3HRE;
        "pkg-26.0.13+fabric" = _xUHIpuQX;
        "pkg-26.0.14+fabric" = _5GzAeliE;
        "pkg-15.8.6+fabric" = _QpO11QJl;
        "pkg-15.8.6+neoforge" = _5ln4Ne0M;
        "pkg-15.8.7+fabric" = _os85JYJa;
        "pkg-15.8.7+neoforge" = _tfwJWC8g;
        "pkg-26.0.10+neoforge" = _2J8DKyzD;
        "pkg-26.0.11+neoforge" = _cnFEisCB;
        "pkg-26.0.12+neoforge" = _7utEflIl;
        "pkg-26.0.15+fabric" = _9Ckf0DcF;
        "pkg-26.0.16+neoforge" = _nvRbdip6;
