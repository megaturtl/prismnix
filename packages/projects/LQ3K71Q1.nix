...
let
    ...
    in {
        ...
        "pkg-3.4.2" = _c9Pa2Sap;
        "pkg-3.4.3" = _TsACcqoR;
        "pkg-3.4.3-beta.1" = _tqCNpIoc;
        "pkg-3.4.4" = _5U2bHbH6;
        "pkg-3.4.3-beta.2" = _rD3FWXH7;
        "pkg-3.4.3-neoforge.21.0.beta.1" = _zABNE034;
        "pkg-3.5.0-beta.1" = _RS3zegai;
        "pkg-3.5.0-beta.2" = _RCY49qLv;
        "pkg-3.5.0-beta.3" = _GzuwoJDO;
        "pkg-3.5.0" = _BNf9EmNl;
        "pkg-3.5.1" = _lSXJY9xl;
        "pkg-3.6.0" = _AhFXokhh;
        "pkg-3.6.1" = _SsKRtIyS;
        ...
        "pkg-3.9.5" = _tLWmjvRY;
        "pkg-3.9.6" = _aGKKe8Rh;
        "pkg-3.10.0" = _DtDo4Vzd;
        "pkg-3.10.1" = _Sde7LvTy;
        "pkg-3.11.0" = _vpwqqyHN;
        "pkg-3.11.1" = _N5IuqZRm;
        "pkg-3.11.2" = _B6GHaD4H;
        "pkg-3.11.3" = _1giTQL3U;
        "pkg-3.11.4" = _TpGBmHye;
        "pkg-3.11.5" = _2Z43WPRl;
        "pkg-3.11.6" = _P2zPZVnY;
