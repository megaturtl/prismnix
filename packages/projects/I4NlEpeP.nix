...
let
    versions = (let
        ...
        _uRhiXjSX = {
            "id" = "uRhiXjSX";
            "file" = "hearts_pink-1.1.0-mc26.3.zip";
            "hash" = "sha512-odtEeDYXAR8zp6jSYZKGkwGty1KaGET2eMb6FsG8hi4lRpoPuj1VoZOmUf8ZBubkwrf9rE2fAEnV66M4ZDcHEw==";
        };
    in {
        "jDof5Jvb" = _jDof5Jvb;
        "AFF1HjsL" = _AFF1HjsL;
