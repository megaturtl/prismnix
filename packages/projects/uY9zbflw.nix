...
let
    ...
    in {
        ...
        "pkg-1.2.0" = _DTnSZM5U;
        "pkg-1.2.1" = _RSIgZF02;
        "pkg-1.2.2-old" = _tcLXYMVB;
        "pkg-1.2.2" = _xPvCkVgI;
        "pkg-1.2.3-mc1.20" = _wmmrvZJq;
        "pkg-1.2.3-mc1.20.2" = _fV5OsvJG;
        "pkg-1.2.3-mc1.20.3" = _mVGTqB2x;
        "pkg-1.2.3-mc1.20.5" = _Vej3tvcx;
        "pkg-1.2.3-mc1.21.2" = _XwiNVNDR;
        "pkg-1.2.3-mc1.21.4" = _4PtmVcQj;
        "pkg-1.2.3-mc1.21.6" = _OhmMfRNt;
        "pkg-1.2.3-mc1.21.9" = _4zjTv9R5;
        "pkg-1.2.4-mc1.21.11" = _pZASAGUw;
        "pkg-1.2.5" = _7ivrON6l;
