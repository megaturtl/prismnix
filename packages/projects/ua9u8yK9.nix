...
let
    ...
    in {
        ...
        "pkg-48.1" = _1Y7WadWt;
        "pkg-48.1+mod" = _3QCxeXDG;
        "pkg-57.1" = _22J6LrfX;
        "pkg-57.1+mod" = _qxoWQtng;
        "pkg-61.1" = _EdIed0GQ;
        "pkg-61.1+mod" = _qHUUEoXJ;
        "pkg-71.1" = _8qKRIGST;
        "pkg-71.1+mod" = _ddPrCozd;
        "pkg-80" = _Q3D2pUtp;
        "pkg-80+mod" = _MkgUX0gC;
        "pkg-81" = _E6vcTmNh;
        "pkg-81+mod" = _oezBHx2K;
        "pkg-88.0" = _Pb7taDQL;
        "pkg-88.0+mod" = _y5ztwM3S;
        "pkg-94.1" = _V2QWxd8E;
        "pkg-94.1+mod" = _eF5sKsH4;
        "pkg-101.1" = _NCcdRv7s;
