...
let
    versions = (let
        ...
        _7bsTNh92 = {
            "id" = "7bsTNh92";
            "file" = "alloy-forgery-fabric-3.1.1+26.1.2.jar";
            "hash" = "sha512-LVGF1UKDfF1uhge6Ef+d+2xCgTp6F1XJ4mkrnGbHAZN93nE8Tkd2hYIlH7xzZ4P3sxmc1umWQLzN0mQ/psI4hQ==";
        };
    in {
        "v5mAE3vf" = _v5mAE3vf;
        "2qTKAxuh" = _2qTKAxuh;
        ...
        "pkg-2.0.5" = _VUJkXR0T;
        "pkg-2.0.6" = _KNupR8qb;
        "pkg-2.0.6+1.18" = _WAsXHXzM;
        "pkg-2.0.7+1.18" = _7tgDdEHK;
        "pkg-2.0.8+1.18" = _eqiifZcQ;
        "pkg-2.0.9+1.18" = _g55A99jV;
        "pkg-2.0.10+1.18" = _pNZY1Zxh;
        "pkg-2.0.11+1.18" = _dgKzFFqp;
        "pkg-2.0.12+1.18" = _Kjw1oaQc;
        "pkg-2.0.13+1.18" = _RnZ1rNwY;
        "pkg-2.0.14+1.19" = _64l8Gs7s;
        "pkg-2.0.15+1.19" = _eV5QnxDI;
        "pkg-2.0.16+1.19" = _X8QEAfXB;
        "pkg-2.0.16+1.18.2" = _xHvHtN9s;
        "pkg-2.0.17+1.19" = _UIMlHriM;
        "pkg-2.0.18+1.19.3" = _jLsVVCz3;
        "pkg-2.0.19+1.19" = _g9j3BFGw;
        "pkg-2.0.19+1.19.3" = _5M7CC5jy;
        "pkg-2.0.19+1.19.4" = _Iryj9UYC;
        "pkg-2.0.20+1.19" = _kZQUifqT;
        "pkg-2.0.20+1.19.4" = _f32qSRXe;
        "pkg-2.0.21+1.20" = _DivNclkz;
        "pkg-2.0.22+1.20" = _CDuKyCCF;
        "pkg-2.1.0+1.20" = _D89BTI2m;
        "pkg-2.1.1+1.20" = _EnaZWOD3;
        "pkg-2.1.1+1.19" = _q1L7hbA8;
        "pkg-2.1.2+1.20" = _j3GoCoCc;
        "pkg-2.1.2+1.20.4" = _cm7am3F7;
        "pkg-2.1.3+1.20.3" = _oBUvSX7n;
        "pkg-2.1.4+1.20.3" = _X1pKXaia;
        "pkg-2.2.0+1.21" = _i6Zj3EuN;
        "pkg-2.2.1+1.21" = _8OIstC18;
        "pkg-2.2.2+1.21" = _iOz4UvJY;
        "pkg-2.3.0+1.21" = _t40qyg4s;
        "pkg-2.3.1+1.21" = _ReIpcJ2f;
        "pkg-2.4.0+1.21" = _fMjYkEPl;
        "pkg-2.4.1+1.21" = _czJc7eUX;
        "pkg-3.0.0" = _eWjkBegZ;
        "pkg-3.0.2" = _CFUNJJ9I;
        "pkg-3.0.3" = _DcijRHb4;
        "pkg-3.0.4" = _qrJr4smJ;
