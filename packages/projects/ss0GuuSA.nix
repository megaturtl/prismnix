...
let
    ...
    in {
        ...
        "pkg-1.0.3" = _CheKilU9;
        "pkg-1.0.4" = _xiHXCKq5;
        "pkg-1.0.4_1" = _iNCzG4k9;
        "pkg-1.0.5" = _sADKDsyU;
        "pkg-1.0.6_2" = _TwLxxmFs;
        "pkg-1.0.7" = _jKBMjIVi;
        "pkg-1.0.7_1" = _Av01HHLb;
        "pkg-v1.0.7_2" = _TnM9I6um;
        "pkg-v1.0.8" = _mZMEA6gj;
        "pkg-v1.0.8_1" = _r8chxyo2;
        "pkg-v1.0.8_2" = _c5DQDVjR;
        "pkg-v1.0.8_2-fixed" = _l0Iw0zXm;
        "pkg-v1.0.8_3" = _HMbThmza;
        "pkg-v1.0.8.420260118" = _FhPusIz2;
        "pkg-v1.0.8.520260124" = _JUEu9AYo;
        "pkg-v1.0.8.620260211" = _8QNHPjJj;
        "pkg-v1.0.8.620260214" = _8eLPzbiP;
        "pkg-v1.0.8.720260222" = _jHxZbo4p;
        "pkg-v1.0.8.820260228" = _q62W3ywN;
        "pkg-v1.1.0.020260401" = _bR7D5EIC;
        "pkg-v1.1.0.120260410" = _Atracp4j;
        "pkg-v1.1.0.220260502" = _NtZX6Kk4;
        "pkg-v1.1.0.220260508" = _1WH40hPN;
        "pkg-v1.1.0.320260515" = _1sB5ND53;
