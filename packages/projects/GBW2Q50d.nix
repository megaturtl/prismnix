...
let
    versions = (let
        ...
        _MnbOSrDe = {
            "id" = "MnbOSrDe";
            "file" = "Compbuild Textures 10.1.zip";
            "hash" = "sha512-/xnTlsDpAQyZZ5YgRmCpEDNkGX3VYRW4sebRBzYcxwRRVr1hgUm67t2CRp5hzWiaDW3ophotLlWnFQOS0uWurQ==";
        };
    in {
        "7ZQPipZx" = _7ZQPipZx;
        "2nwkEbr2" = _2nwkEbr2;
        ...
        "cMURd5FV" = _cMURd5FV;
        "MnbOSrDe" = _MnbOSrDe;
        "minecraft-1.20.1" = _MnbOSrDe;
        "minecraft-1.20.2" = _MnbOSrDe;
        "minecraft-1.20.3" = _MnbOSrDe;
        "minecraft-1.20.4" = _MnbOSrDe;
        "minecraft-1.21.1" = _MnbOSrDe;
        "minecraft-1.21.4" = _MnbOSrDe;
        "minecraft-1.21.5" = _MnbOSrDe;
        "minecraft-1.21.8" = _MnbOSrDe;
        "minecraft-1.21.10" = _MnbOSrDe;
        "minecraft-1.20" = _MnbOSrDe;
        "minecraft-23w31a" = _MnbOSrDe;
        "minecraft-23w32a" = _MnbOSrDe;
        "minecraft-23w33a" = _MnbOSrDe;
        "minecraft-23w35a" = _MnbOSrDe;
        "minecraft-1.20.2-pre1" = _MnbOSrDe;
        "minecraft-23w42a" = _MnbOSrDe;
        "minecraft-23w43a" = _MnbOSrDe;
        "minecraft-23w43b" = _MnbOSrDe;
        "minecraft-23w44a" = _MnbOSrDe;
        "minecraft-23w45a" = _MnbOSrDe;
        "minecraft-23w46a" = _MnbOSrDe;
        "minecraft-24w03a" = _MnbOSrDe;
        "minecraft-24w03b" = _MnbOSrDe;
        "minecraft-24w04a" = _MnbOSrDe;
        "minecraft-24w05a" = _MnbOSrDe;
        "minecraft-24w05b" = _MnbOSrDe;
        "minecraft-24w06a" = _MnbOSrDe;
        "minecraft-24w07a" = _MnbOSrDe;
        "minecraft-24w09a" = _MnbOSrDe;
        "minecraft-24w10a" = _MnbOSrDe;
        "minecraft-24w11a" = _MnbOSrDe;
        "minecraft-24w12a" = _MnbOSrDe;
        "minecraft-24w13a" = _MnbOSrDe;
        "minecraft-24w14potato" = _MnbOSrDe;
        "minecraft-24w14a" = _MnbOSrDe;
        "minecraft-1.20.5-pre1" = _MnbOSrDe;
        "minecraft-1.20.5-pre2" = _MnbOSrDe;
        "minecraft-1.20.5-pre3" = _MnbOSrDe;
        "minecraft-1.20.5" = _MnbOSrDe;
        "minecraft-1.20.6" = _MnbOSrDe;
        "minecraft-24w18a" = _MnbOSrDe;
        "minecraft-24w19a" = _MnbOSrDe;
        "minecraft-24w19b" = _MnbOSrDe;
        "minecraft-24w20a" = _MnbOSrDe;
        "minecraft-1.21" = _MnbOSrDe;
        "minecraft-24w33a" = _MnbOSrDe;
        "minecraft-24w34a" = _MnbOSrDe;
        "minecraft-24w35a" = _MnbOSrDe;
        "minecraft-24w36a" = _MnbOSrDe;
        "minecraft-24w37a" = _MnbOSrDe;
        "minecraft-24w38a" = _MnbOSrDe;
        "minecraft-24w39a" = _MnbOSrDe;
        "minecraft-24w40a" = _MnbOSrDe;
        "minecraft-1.21.2-pre1" = _MnbOSrDe;
        "minecraft-1.21.2-pre2" = _MnbOSrDe;
        "minecraft-1.21.2" = _MnbOSrDe;
        "minecraft-1.21.3" = _MnbOSrDe;
        "minecraft-24w44a" = _MnbOSrDe;
        "minecraft-24w45a" = _MnbOSrDe;
        "minecraft-24w46a" = _MnbOSrDe;
        "minecraft-1.21.6" = _MnbOSrDe;
        "minecraft-1.21.7" = _MnbOSrDe;
        "minecraft-1.21.9" = _MnbOSrDe;
        "minecraft-1.21.11" = _MnbOSrDe;
        "pkg-6.0.2" = _7ZQPipZx;
        "pkg-6.0.3" = _2nwkEbr2;
        "pkg-6.0.4" = _dqOfTgtE;
        "pkg-6.0.4.1" = _T7Xyjcxl;
        "pkg-6.0.5" = _BCrRJ5an;
        "pkg-v6.0.5.1" = _vGM7pRfC;
        "pkg-6.0.6" = _4D9JgdzR;
        "pkg-6.0.7" = _JqWOFdAK;
        "pkg-6.0.8" = _TGauBJWq;
        "pkg-6.0.9" = _5VAsBd3x;
        "pkg-6.0.9.1" = _D0WC0e4E;
        "pkg-7.0.0" = _p1ICoPke;
        "pkg-7.0.1" = _S3wFUBXy;
        "pkg-8.0" = _9lvelCkM;
        "pkg-8.0.1" = _SanCP2m5;
        ...
        "pkg-8.0.3" = _hzRTe9XM;
        "pkg-8.0.4" = _KjpX2Qbl;
        "pkg-8.0.4.1" = _IFvLeCiI;
        "pkg-8.0.5" = _WSB36Shi;
        "pkg-8.0.6" = _WzDKDp7m;
        "pkg-8.0.6.1" = _uRQidFdz;
        "pkg-8.0.7" = _eWOcVIYS;
        "pkg-8.0.8" = _YuHidUOp;
        "pkg-9" = _rxUikZpi;
        "pkg-9.1" = _2asK2hnx;
