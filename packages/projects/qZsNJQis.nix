...
let
    versions = (let
        ...
        _gQ7g9Xqa = {
            "id" = "gQ7g9Xqa";
            "file" = "command-bungeecord.jar";
            "hash" = "sha512-baSokytdDJL6gtTyvp1lpis4/7FsRPpANiJaUChw7tNTESKA+aWxpT3wH6iKI3VJ4JAggqZc5MSfAK1Jz9tVLw==";
        };
        _jwEGfIJC = {
            "id" = "jwEGfIJC";
            "file" = "command-velocity.jar";
            "hash" = "sha512-DvYk2JiIFTmnLyl0MSs9d7WmMYPV+Uu/Q0pqB6Etqrex0E6WMcpsOiVj+YGfKB1MYo1QFxje386XWL84oG357g==";
        };
        _J42IHH67 = {
            "id" = "J42IHH67";
            "file" = "command-bungeecord.jar";
            "hash" = "sha512-h1V1GXrYqqVJtYEmrp16+EzqyuSRi61eYJhHmFK99MNx4PGY3Sv0gc0rvH0j7N8CCiI4I/D8GL9i5YVnjeJG2A==";
        };
        _WjEaTQJU = {
            "id" = "WjEaTQJU";
            "file" = "command-velocity.jar";
            "hash" = "sha512-nhg2Z4Tszo20Ve4G2V1wEMCc2ZCO8FPczhAQU9nLMp541QVqAzVTUQCIwtaC5hch8LXrVPlpgVLJLwRrsKNZFA==";
        };
    in {
        "yyKrTsiN" = _yyKrTsiN;
        "272C2g2n" = _272C2g2n;
        ...
        "J42IHH67" = _J42IHH67;
        "WjEaTQJU" = _WjEaTQJU;
        "bungeecord-1.20" = _J42IHH67;
        "bungeecord-1.20.1" = _J42IHH67;
        "bungeecord-1.20.2" = _J42IHH67;
        "bungeecord-1.20.3" = _J42IHH67;
        "bungeecord-1.20.4" = _J42IHH67;
        "bungeecord-1.20.5" = _J42IHH67;
        "bungeecord-1.20.6" = _J42IHH67;
        "bungeecord-1.21" = _J42IHH67;
        "bungeecord-1.21.1" = _J42IHH67;
        "bungeecord-1.21.2" = _J42IHH67;
        "bungeecord-1.21.3" = _J42IHH67;
        "bungeecord-1.21.4" = _J42IHH67;
        "bungeecord-1.21.5" = _J42IHH67;
        "bungeecord-1.21.6" = _J42IHH67;
        "bungeecord-1.21.7" = _J42IHH67;
        "bungeecord-1.21.8" = _J42IHH67;
        "bungeecord-1.21.9" = _J42IHH67;
        "bungeecord-1.21.10" = _J42IHH67;
        "bungeecord-1.21.11" = _J42IHH67;
        "bungeecord-26.1" = _J42IHH67;
        "bungeecord-26.1.1" = _J42IHH67;
        "bungeecord-26.1.2" = _J42IHH67;
        "bungeecord-26.2" = _J42IHH67;
        "bungeecord-26.3" = _J42IHH67;
        "velocity-1.20" = _WjEaTQJU;
        "velocity-1.20.1" = _WjEaTQJU;
        "velocity-1.20.2" = _WjEaTQJU;
        "velocity-1.20.3" = _WjEaTQJU;
        "velocity-1.20.4" = _WjEaTQJU;
        "velocity-1.20.5" = _WjEaTQJU;
        "velocity-1.20.6" = _WjEaTQJU;
        "velocity-1.21" = _WjEaTQJU;
        "velocity-1.21.1" = _WjEaTQJU;
        "velocity-1.21.2" = _WjEaTQJU;
        "velocity-1.21.3" = _WjEaTQJU;
        "velocity-1.21.4" = _WjEaTQJU;
        "velocity-1.21.5" = _WjEaTQJU;
        "velocity-1.21.6" = _WjEaTQJU;
        "velocity-1.21.7" = _WjEaTQJU;
        "velocity-1.21.8" = _WjEaTQJU;
        "velocity-1.21.9" = _WjEaTQJU;
        "velocity-1.21.10" = _WjEaTQJU;
        "velocity-1.21.11" = _WjEaTQJU;
        "velocity-26.1" = _WjEaTQJU;
        "velocity-26.1.1" = _WjEaTQJU;
        "velocity-26.1.2" = _WjEaTQJU;
        "velocity-26.2" = _WjEaTQJU;
        "velocity-26.3" = _WjEaTQJU;
        "waterfall-1.20" = _J42IHH67;
        "waterfall-1.20.1" = _J42IHH67;
        "waterfall-1.20.2" = _J42IHH67;
        "waterfall-1.20.3" = _J42IHH67;
        "waterfall-1.20.4" = _J42IHH67;
        "waterfall-1.20.5" = _J42IHH67;
        "waterfall-1.20.6" = _J42IHH67;
        "waterfall-1.21" = _J42IHH67;
        "waterfall-1.21.1" = _J42IHH67;
        "waterfall-1.21.2" = _J42IHH67;
        "waterfall-1.21.3" = _J42IHH67;
        "waterfall-1.21.4" = _J42IHH67;
        "waterfall-1.21.5" = _J42IHH67;
        "waterfall-1.21.6" = _J42IHH67;
        "waterfall-1.21.7" = _J42IHH67;
        "waterfall-1.21.8" = _J42IHH67;
        "waterfall-1.21.9" = _J42IHH67;
        "waterfall-1.21.10" = _J42IHH67;
        "waterfall-1.21.11" = _J42IHH67;
        "waterfall-26.1" = _J42IHH67;
        "waterfall-26.1.1" = _J42IHH67;
        "waterfall-26.1.2" = _J42IHH67;
        "waterfall-26.2" = _J42IHH67;
        "waterfall-26.3" = _J42IHH67;
        "pkg-0.0.1-dev.3611b25" = _272C2g2n;
        "pkg-0.0.1-dev.7a4b838" = _JGHSl1T6;
        "pkg-0.0.1-dev.135d447" = _go5WdK1v;
        "pkg-0.0.1-dev.d7e9c59" = _1Rb2obkE;
        "pkg-0.0.1-dev.12705dd" = _ImqeKbYC;
        "pkg-0.0.1-dev.0477a6a" = _salDSZzj;
        "pkg-0.0.1-dev.792f8af" = _NLnvjl6d;
        "pkg-0.0.1-dev.e2895d7" = _2Gf8enri;
        "pkg-0.0.1-dev.111c6b1" = _h3FwEzY8;
        "pkg-0.0.1-dev.eebe017" = _NjhawhOH;
        "pkg-0.0.1-dev.2f97a63" = _dDyMHfgv;
        "pkg-0.0.1-dev.397513a" = _ellNspfA;
        "pkg-0.0.2-dev.2581611" = _KwS6kYAA;
        "pkg-0.0.3-dev.e506f4c" = _Xu4Ccl6r;
        "pkg-0.0.4-dev.ca7ad2a" = _qHefqX8u;
        "pkg-0.0.5" = _IwwJ2ikr;
        "pkg-0.0.6" = _jwEGfIJC;
        "pkg-0.0.7" = _WjEaTQJU;
        "default" = _WjEaTQJU;
