...
let
    ...
    in {
        ...
        "pkg-1.0.2" = _PM3cphnL;
        "pkg-1.0.3" = _iXvjILHE;
        "pkg-1.0.4+1.17" = _9BJMqy5L;
        "pkg-1.0.4+1.16" = _5EC3IUpM;
        "pkg-1.0.5+1.17" = _BbIPVDEX;
        "pkg-1.0.6+1.18" = _F3u72XMh;
        "pkg-1.0.7-beta.1+1.19-pre3" = _cET3AVsB;
        "pkg-1.0.8+1.19" = _iYto6AS3;
        "pkg-1.1.0+1.19.2" = _mxMZAaAs;
        "pkg-2.0.0" = _P8dCLvcZ;
        "pkg-2.0.1" = _l8OMa5aj;
        "pkg-2.0.2" = _UTYbOd9d;
        "pkg-2.0.3" = _hO55JZV2;
        "pkg-2.0.4+1.19.4" = _w3khbdyj;
        "pkg-2.0.5+1.20.1" = _9T7V2RpT;
        "pkg-2.0.6+1.20.1" = _6Srz4g10;
        "pkg-2.0.7+1.20.1" = _2dDGKqew;
        "pkg-2.0.8+1.20.1" = _SgARk8e3;
        "pkg-2.1.0+1.20.2" = _BtdTg3XM;
        "pkg-2.2.0+1.20.4" = _2U3Eufs5;
        "pkg-2.2.1+1.20.6" = _O4XMP7lB;
        "pkg-2.3.0+1.21" = _7WhLxXgq;
        "pkg-2.3.1+1.21.1" = _cXYGdmuR;
        "pkg-2.3.2+1.21.3" = _Lc4o5mUO;
        "pkg-2.3.3+1.21.4" = _R4stm4g6;
        "pkg-2.3.4+1.21.5" = _BE8RJkWh;
        "pkg-2.3.5+1.21.6" = _BfdK13UH;
        "pkg-2.3.6+1.21.6" = _Ut87wuuI;
        "pkg-2.3.7+1.21.6" = _iFOPwaDy;
        "pkg-2.3.8+1.21.6" = _YF3HXRrk;
        "pkg-2.3.9+1.21.8" = _oBhv3GLA;
