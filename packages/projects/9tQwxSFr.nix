...
let
    versions = (let
        ...
        _XBLybw4C = {
            "id" = "XBLybw4C";
            "file" = "SmartSpawner-1.8.0.jar";
            "hash" = "sha512-0U8C7lyZsBc5BflWSxV7TWCg26sRFsuGNbmzyv96Si5rbOSRrw2ld5ZjfDe204nYqHlLU890NuCLUs1MGKpvdg==";
        };
        _UxDCyte8 = {
            "id" = "UxDCyte8";
            "file" = "SmartSpawner-1.8.1.jar";
            "hash" = "sha512-OONpLfjyu8svRFrAqj9zpLuz8llqt328HOQP29W5C9IopTnwZDvK0pjXpr6WHgU+0FBbjcYUaJNL6Gmd1ishtA==";
        };
    in {
        "4y2HXNWQ" = _4y2HXNWQ;
        "Pxaffatt" = _Pxaffatt;
        ...
        "paper-1.21.6" = _UxDCyte8;
        "paper-1.21.7" = _UxDCyte8;
        "paper-1.21.8" = _UxDCyte8;
        "paper-1.21.9" = _UxDCyte8;
        "paper-1.21.10" = _UxDCyte8;
        "paper-1.21.11" = _UxDCyte8;
        "paper-26.1" = _UxDCyte8;
        "paper-26.1.1" = _UxDCyte8;
        "paper-26.1.2" = _UxDCyte8;
        "paper-26.2" = _UxDCyte8;
        ...
        "purpur-1.21.6" = _UxDCyte8;
        "purpur-1.21.7" = _UxDCyte8;
        "purpur-1.21.8" = _UxDCyte8;
        "purpur-1.21.9" = _UxDCyte8;
        "purpur-1.21.10" = _UxDCyte8;
        "purpur-1.21.11" = _UxDCyte8;
        "purpur-26.1" = _UxDCyte8;
        "purpur-26.1.1" = _UxDCyte8;
        "purpur-26.1.2" = _UxDCyte8;
        "purpur-26.2" = _UxDCyte8;
        ...
        "folia-1.21.6" = _UxDCyte8;
        "folia-1.21.7" = _UxDCyte8;
        "folia-1.21.8" = _UxDCyte8;
        "folia-1.21.9" = _UxDCyte8;
        "folia-1.21.10" = _UxDCyte8;
        "folia-1.21.11" = _UxDCyte8;
        "folia-26.1" = _UxDCyte8;
        "folia-26.1.1" = _UxDCyte8;
        "folia-26.1.2" = _UxDCyte8;
        "folia-26.2" = _UxDCyte8;
        "pkg-1.1.2" = _Pxaffatt;
        "pkg-1.1.3" = _8CaUmSPI;
        "pkg-1.1.4" = _BCPnqeLz;
        "pkg-1.1.5" = _ESwwxz7D;
        ...
        "pkg-1.2.4" = _ZGso45vk;
        "pkg-1.2.5" = _dYcI7Oh5;
        "pkg-1.2.5.1" = _SLkoFD5B;
        "pkg-1.2.5.2" = _x1ZGRRiT;
        "pkg-1.2.6" = _KEylPlgd;
        "pkg-1.2.7" = _yVMRuuzt;
        "pkg-1.2.8" = _qL8nQQQH;
        "pkg-1.2.9" = _wCnOfOP6;
        ...
        "pkg-1.5.3" = _tzvZAeEV;
        "pkg-1.5.4" = _AJTBijK6;
        "pkg-1.5.4.1" = _XuGyiqD7;
        "pkg-1.5.4.2" = _9vkDry4D;
        "pkg-1.5.4.3" = _jIyxLai4;
        "pkg-1.5.5" = _4wgVHnjZ;
        "pkg-1.5.6" = _nMuAIkBY;
        "pkg-1.5.6.1" = _4nFCC6r5;
        "pkg-1.5.6.2" = _yzsGypZM;
        "pkg-1.5.7" = _92AY0APl;
        "pkg-1.5.7.1" = _3ABbjW2g;
        "pkg-1.5.8" = _QTPx8MMo;
        "pkg-1.6.1" = _NUpSnWuq;
        "pkg-1.6.2" = _Xd4gJxN2;
        "pkg-1.6.3" = _cjFlkEO6;
        ...
        "pkg-1.6.9" = _a7VtEgFt;
        "pkg-1.7.0" = _2rJiOvAY;
        "pkg-1.7.0.1" = _aDguHjo0;
        "pkg-1.7.0.2" = _fSEm08TY;
        "pkg-1.7.1" = _flDtK9XA;
        "pkg-1.7.1.1" = _nKptXmNy;
        "pkg-1.7.1.2" = _aZXwn2fW;
        "pkg-1.8.0" = _XBLybw4C;
        "pkg-1.8.1" = _UxDCyte8;
        "default" = _UxDCyte8;
    });
