...
let
    ...
    in {
        ...
        "XsDHyDlZ" = _XsDHyDlZ;
        "LPcecmX5" = _LPcecmX5;
        "neoforge-1.21" = _XsDHyDlZ;
        "neoforge-1.21.1" = _XsDHyDlZ;
        "neoforge-1.20.5" = _XsDHyDlZ;
        "neoforge-1.20.6" = _XsDHyDlZ;
        "neoforge-1.20.4" = _GYo7kfik;
        "neoforge-1.21.2" = _XsDHyDlZ;
        "neoforge-1.21.3" = _XsDHyDlZ;
        "neoforge-1.20.3" = _GYo7kfik;
        "neoforge-1.21.4" = _XsDHyDlZ;
        "neoforge-1.18.2" = _kF7CsEH5;
        "neoforge-1.19.2" = _kF7CsEH5;
        "neoforge-1.19.4" = _kF7CsEH5;
        "neoforge-1.20.1" = _kF7CsEH5;
        "neoforge-1.20.2" = _GYo7kfik;
        "neoforge-1.21.5" = _XsDHyDlZ;
        "neoforge-1.21.6-pre1" = _3IqhWmuA;
        "neoforge-1.21.6-pre2" = _3IqhWmuA;
        "neoforge-1.21.6-pre3" = _3IqhWmuA;
        "neoforge-1.21.6-pre4" = _3IqhWmuA;
        "neoforge-1.21.6" = _XsDHyDlZ;
        "neoforge-1.21.7" = _XsDHyDlZ;
        "neoforge-1.21.8" = _XsDHyDlZ;
        "neoforge-1.21.9" = _LPcecmX5;
        "neoforge-1.21.10" = _LPcecmX5;
        "neoforge-1.21.11" = _LPcecmX5;
        ...
        "neoforge-26.1" = _LPcecmX5;
        "neoforge-26.1.1-rc-1" = _euXUDxQE;
        "neoforge-26.1.1" = _LPcecmX5;
        "neoforge-26.2-snapshot-1" = _euXUDxQE;
        "neoforge-26.1.2-rc-1" = _euXUDxQE;
        "neoforge-26.1.2" = _LPcecmX5;
        "neoforge-26.2" = _LPcecmX5;
        "forge-1.20" = _voEnEG8g;
        "forge-1.20.1" = _lByeZRgt;
        "forge-1.20.2" = _lByeZRgt;
        "forge-1.19.3" = _X8hiorDS;
        "forge-1.19.4" = _lByeZRgt;
        "forge-1.19.1" = _CmN3ENVG;
        "forge-1.19.2" = _lByeZRgt;
        "forge-1.18.1" = _Fy8HeIlQ;
        "forge-1.18.2" = _lByeZRgt;
        "forge-1.16.3" = _ZE2xWjIN;
        "forge-1.16.4" = _ZE2xWjIN;
        "forge-1.16.5" = _ZE2xWjIN;
        "forge-1.20.3" = _lByeZRgt;
        "forge-1.20.4" = _lByeZRgt;
        "forge-1.17.1" = _lByeZRgt;
