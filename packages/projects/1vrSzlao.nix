...
let
    versions = (let
        ...
        _lByeZRgt = {
            "id" = "lByeZRgt";
            "file" = "KotlinLangForge-kff-compat-2.13.0-k2.4.10-2.0+forge.jar";
            "hash" = "sha512-BXhK31Xh2OJTEkudHDMriPwggurDry3MVP7jy4d/riyncMVhsRYzgo+D0yShvHZRg84/Kih6zsMSnH3ZtXZzOw==";
        };
        _GYo7kfik = {
            "id" = "GYo7kfik";
            "file" = "KotlinLangForge-2.13.0-k2.4.10-2.0+neoforge.jar";
            "hash" = "sha512-r3O5hlfF0ELuktmNQHeI9O3bpeuNh0702QQ5s7DH7CZVs7PTgXmwVISkcs+NA7sGLEXiTRHXueqdjTc0dDoRoA==";
        };
        _XsDHyDlZ = {
            "id" = "XsDHyDlZ";
            "file" = "KotlinLangForge-2.13.0-k2.4.10-3.0+neoforge.jar";
            "hash" = "sha512-HexgC4ex1qNQu/s8etRRNpKed4UdrGbvxw0hfN4q8hFbgiVg9AQ1XPqg9FRTsyyQRc3PpXtYQN7JqI+TAstCvg==";
        };
        _LPcecmX5 = {
            "id" = "LPcecmX5";
            "file" = "KotlinLangForge-2.13.0-k2.4.10-3.1+neoforge.jar";
            "hash" = "sha512-4XE2gM4egpEaBXsGzMpgW4obqrY+RudaoQjNByJlgDYlQVjiKi3U36GlnhH6a70qBNxGwoPrOMn0tdUrgIgP3Q==";
        };
        _tpWHwzsV = {
            "id" = "tpWHwzsV";
            "file" = "KotlinLangForge-kff-compat-2.13.0-k2.4.20-2.0+forge.jar";
            "hash" = "sha512-CZim0zqcMiJd2gU0HkCYJ6uM3MJHZN/rAwhvbPIzjhw8ou3P7+X2PmTiE0xoQTCGkZ8djEAsjyrPhCrEP8Qi4Q==";
        };
        _B9jdQpcx = {
            "id" = "B9jdQpcx";
            "file" = "KotlinLangForge-2.13.0-k2.4.20-2.0+neoforge.jar";
            "hash" = "sha512-/wdiI4m859D9eeV3A5gKppMqHgv3pewR8Z5qJEb6BA4O6vWvl7K1Fn72DF2NIw3HZb99MLmYjj4hldQa4agS6g==";
        };
        _dlV4uaXo = {
            "id" = "dlV4uaXo";
            "file" = "KotlinLangForge-2.13.0-k2.4.20-3.0+neoforge.jar";
            "hash" = "sha512-+iZ9xZgzijjPYDPqriNcKDGXLMGgb29iychXe3AtfcdaB8KepXJzUpCpWk4aY7YY7xXHUrKt+Y3zh9uxgeY/AQ==";
        };
        _z7VDhg1n = {
            "id" = "z7VDhg1n";
            "file" = "KotlinLangForge-2.13.0-k2.4.20-3.1+neoforge.jar";
            "hash" = "sha512-i0iHMSkU6il6lUBBHypb+ZKve16Li1aGxL6inmQlE6yiMdhrJyhExbn46P7pShdy8Ubs2oNp//kSFPiMQvPb8w==";
        };
        _PEfCBUCv = {
            "id" = "PEfCBUCv";
            "file" = "KotlinLangForge-kff-compat-2.14.0-k2.4.20-2.0+forge.jar";
            "hash" = "sha512-sISxIMBX7VwwKUpjrIt6kwhfpiOX1ipbHl8DQAaVP9dOe/OcleQOGjedq6A30mAywLFNwlhembxuWAKVSBanzQ==";
        };
        _6Fy6uJfP = {
            "id" = "6Fy6uJfP";
            "file" = "KotlinLangForge-2.14.0-k2.4.20-2.0+neoforge.jar";
            "hash" = "sha512-bcnjG2Yo3YM9f5fmuIHFSyt/lIXYVHbI5DarFw0SRwtddoqPNlRez0lNkXeUxTHp6LXzWrHHO1OivXPGPYuIng==";
        };
        _fkUvgYcW = {
            "id" = "fkUvgYcW";
            "file" = "KotlinLangForge-2.14.0-k2.4.20-3.0+neoforge.jar";
            "hash" = "sha512-50RAQF7wWgrXWPCa24jZU7MbP4Lfb/nhuGRuDbVuXNeh4RqyaUiY12rQotCPCPa5Hk9X/cFNajB1Nt+0l5UNVA==";
        };
        _6aLT01Dx = {
            "id" = "6aLT01Dx";
            "file" = "KotlinLangForge-2.14.0-k2.4.20-3.1+neoforge.jar";
            "hash" = "sha512-ClVPojKS+IVn1hGsEljqtHG12ul437IBlfuMn6Tc7/ocunr+ZZUyQgQqtDAaF0uBOcQs5ue2i+m9sT0mcjF7wQ==";
        };
        _W3vgqz9J = {
            "id" = "W3vgqz9J";
            "file" = "KotlinLangForge-kff-compat-2.14.1-k2.4.20-2.0+forge.jar";
            "hash" = "sha512-1aYefZcce4/19el+cUOwwU2WkcmACuqR2XpzXhIHh/ehLUkvPNQ+qzsMGIaawfd2/8pQHrCGulKWmJYiFy3lwg==";
        };
        _QNe5NbGK = {
            "id" = "QNe5NbGK";
            "file" = "KotlinLangForge-2.14.1-k2.4.20-2.0+neoforge.jar";
            "hash" = "sha512-rrul1jVxBDby13p5ZG9M945Ud3e1EKpHHKWeZLSIFnb9VkTuZOxigBe/3fSTrOCyQ+jYVJu8W31uLudzOAC40g==";
        };
        _SRMod41B = {
            "id" = "SRMod41B";
            "file" = "KotlinLangForge-2.14.1-k2.4.20-3.0+neoforge.jar";
            "hash" = "sha512-jW+vH6YjUp55T7BCm5b3GWWEPqGHYmLCbOz0/hfdbmQzRJj5hMykh+MIOIHw6ReiavOGK3LoWi0NWnIlEENV2g==";
        };
        _BeksFnDy = {
            "id" = "BeksFnDy";
            "file" = "KotlinLangForge-2.14.1-k2.4.20-3.1+neoforge.jar";
            "hash" = "sha512-HK2fDkxgdtgaDA3//E3FfICBOi8ddySwW8Ob2hGpR23gXn5J3rF553/7R2ANGsxujMSgJjKaLlzlxheYP2wpBA==";
        };
    in {
        "ZbfKIvnB" = _ZbfKIvnB;
        "xkTQC1PK" = _xkTQC1PK;
        ...
        "SRMod41B" = _SRMod41B;
        "BeksFnDy" = _BeksFnDy;
        "neoforge-1.21" = _SRMod41B;
        "neoforge-1.21.1" = _SRMod41B;
        "neoforge-1.20.5" = _SRMod41B;
        "neoforge-1.20.6" = _SRMod41B;
        "neoforge-1.20.4" = _QNe5NbGK;
        "neoforge-1.21.2" = _SRMod41B;
        "neoforge-1.21.3" = _SRMod41B;
        "neoforge-1.20.3" = _QNe5NbGK;
        "neoforge-1.21.4" = _SRMod41B;
        "neoforge-1.18.2" = _kF7CsEH5;
        "neoforge-1.19.2" = _kF7CsEH5;
        "neoforge-1.19.4" = _kF7CsEH5;
        "neoforge-1.20.1" = _kF7CsEH5;
        "neoforge-1.20.2" = _QNe5NbGK;
        "neoforge-1.21.5" = _SRMod41B;
        "neoforge-1.21.6-pre1" = _3IqhWmuA;
        "neoforge-1.21.6-pre2" = _3IqhWmuA;
        "neoforge-1.21.6-pre3" = _3IqhWmuA;
        "neoforge-1.21.6-pre4" = _3IqhWmuA;
        "neoforge-1.21.6" = _SRMod41B;
        "neoforge-1.21.7" = _SRMod41B;
        "neoforge-1.21.8" = _SRMod41B;
        "neoforge-1.21.9" = _BeksFnDy;
        "neoforge-1.21.10" = _BeksFnDy;
        "neoforge-1.21.11" = _BeksFnDy;
        ...
        "neoforge-26.1" = _BeksFnDy;
        "neoforge-26.1.1-rc-1" = _euXUDxQE;
        "neoforge-26.1.1" = _BeksFnDy;
        "neoforge-26.2-snapshot-1" = _euXUDxQE;
        "neoforge-26.1.2-rc-1" = _euXUDxQE;
        "neoforge-26.1.2" = _BeksFnDy;
        "neoforge-26.2" = _BeksFnDy;
        "neoforge-26.3" = _BeksFnDy;
        "forge-1.20" = _voEnEG8g;
        "forge-1.20.1" = _W3vgqz9J;
        "forge-1.20.2" = _W3vgqz9J;
        "forge-1.19.3" = _X8hiorDS;
        "forge-1.19.4" = _W3vgqz9J;
        "forge-1.19.1" = _CmN3ENVG;
        "forge-1.19.2" = _W3vgqz9J;
        "forge-1.18.1" = _Fy8HeIlQ;
        "forge-1.18.2" = _W3vgqz9J;
        "forge-1.16.3" = _ZE2xWjIN;
        "forge-1.16.4" = _ZE2xWjIN;
        "forge-1.16.5" = _ZE2xWjIN;
        "forge-1.20.3" = _W3vgqz9J;
        "forge-1.20.4" = _W3vgqz9J;
        "forge-1.17.1" = _W3vgqz9J;
        "pkg-1.0.0-k2.0.20-1.21+neoforge" = _ZbfKIvnB;
        "pkg-1.0.0-k2.0.20-1.20.6+neoforge" = _xkTQC1PK;
        "pkg-1.0.0-k2.0.20-1.20.4+neoforge" = _y18Sjx3y;
        "pkg-1.0.0-k2.0.20-1.20.1+forge" = _dhkFdxCR;
        "pkg-1.0.0-k2.0.20-1.19.4+forge" = _UlpaaKXT;
        "pkg-1.0.0-k2.0.20-1.19.2+forge" = _g0GdpHZ4;
        "pkg-1.0.0-k2.0.20-1.18.2+forge" = _R7HostZS;
        "pkg-1.0.0-k2.0.20-1.16.5+forge" = _me9huSFB;
        "pkg-1.0.0-k2.0.21-1.21+neoforge" = _i2R9V8p7;
        "pkg-1.0.0-k2.0.21-1.20.6+neoforge" = _aYOFtiGo;
        "pkg-1.0.0-k2.0.21-1.20.4+neoforge" = _rtF9PHvQ;
        "pkg-1.0.0-k2.0.21-1.20.1+forge" = _hi6NOqG1;
        "pkg-1.0.0-k2.0.21-1.19.4+forge" = _b7xeaP84;
        "pkg-1.0.0-k2.0.21-1.19.2+forge" = _hweR9spJ;
        "pkg-1.0.0-k2.0.21-1.18.2+forge" = _m8sk3pTY;
        "pkg-1.0.0-k2.0.21-1.16.5+forge" = _EO2P7vVP;
        "pkg-1.0.1-k2.0.21-1.21+neoforge" = _binVmoYO;
        "pkg-1.0.1-k2.0.21-1.20.6+neoforge" = _bc6hz4X2;
        "pkg-1.0.1-k2.0.21-1.20.4+neoforge" = _EUEVWeQL;
        "pkg-1.0.1-k2.0.21-1.20.1+forge" = _S8mZVxPU;
        "pkg-1.0.1-k2.0.21-1.19.4+forge" = _K7Yu7Cau;
        "pkg-1.0.1-k2.0.21-1.19.2+forge" = _9Jys1XDB;
        "pkg-1.0.1-k2.0.21-1.18.2+forge" = _ZX6WL5o2;
        "pkg-1.0.1-k2.0.21-1.16.5+forge" = _cMfsr8Hw;
        "pkg-1.0.2-k2.0.21-1.20.1+forge" = _ZHnkKJ8L;
        "pkg-1.0.2-k2.0.21-1.19.4+forge" = _B2Kybwo9;
        "pkg-1.0.2-k2.0.21-1.19.2+forge" = _Kj6I4SoW;
        "pkg-1.0.2-k2.0.21-1.18.2+forge" = _Bw4KcutI;
        "pkg-1.0.2-k2.0.21-1.16.5+forge" = _kKJJ8YJQ;
        "pkg-1.0.2-k2.0.21-1.21+neoforge" = _reGUqtay;
        "pkg-1.0.2-k2.0.21-1.20.6+neoforge" = _TuxUmUf8;
        "pkg-1.0.2-k2.0.21-1.20.4+neoforge" = _QqCIycuN;
        "pkg-1.0.3-k2.0.21-1.21+neoforge" = _gYbY06VO;
        "pkg-1.0.3-k2.0.21-1.20.6+neoforge" = _oyiokJOh;
        "pkg-1.0.3-k2.0.21-1.20.4+neoforge" = _VEEyvPv0;
        "pkg-1.0.3-k2.0.21-1.20.1+forge" = _YAjhyUut;
        "pkg-1.0.3-k2.0.21-1.19.4+forge" = _pJGY42dN;
        "pkg-1.0.3-k2.0.21-1.19.2+forge" = _L1X0CeOJ;
        "pkg-1.0.3-k2.0.21-1.18.2+forge" = _WpKwO7ay;
        "pkg-1.0.3-k2.0.21-1.16.5+forge" = _1w0ANaFp;
        "pkg-1.1.0-k2.0.21-1.21.2+neoforge" = _TS343ugJ;
        "pkg-1.1.0-k2.0.21-1.21+neoforge" = _Cpv6LTpu;
        "pkg-1.1.0-k2.0.21-1.20.6+neoforge" = _PF5kJqnX;
        "pkg-1.1.0-k2.0.21-1.20.4+neoforge" = _W0NYVB5p;
        "pkg-1.1.0-k2.0.21-1.20.1+forge" = _igN0e82d;
        "pkg-1.1.0-k2.0.21-1.19.4+forge" = _eEy4G6mp;
        "pkg-1.1.0-k2.0.21-1.19.2+forge" = _DPrxeIef;
        "pkg-1.1.0-k2.0.21-1.18.2+forge" = _M5yh7XOc;
        "pkg-1.1.0-k2.0.21-1.16.5+forge" = _nBUKy8Lu;
        "pkg-1.2.0-k2.0.21-1.21.3+neoforge" = _KjCtvAQx;
        "pkg-1.2.0-k2.0.21-1.21+neoforge" = _4bNfeINK;
        "pkg-1.2.0-k2.0.21-1.20.6+neoforge" = _CuDPU6eX;
        "pkg-1.2.0-k2.0.21-1.20.4+neoforge" = _vksGT4AD;
        "pkg-1.2.0-k2.0.21-1.20.1+forge" = _voEnEG8g;
        "pkg-1.2.0-k2.0.21-1.19.4+forge" = _X8hiorDS;
        "pkg-1.2.0-k2.0.21-1.19.2+forge" = _CmN3ENVG;
        "pkg-1.2.0-k2.0.21-1.18.2+forge" = _Fy8HeIlQ;
        "pkg-1.2.0-k2.0.21-1.16.5+forge" = _IpBNmFMQ;
        "pkg-2.0.0-k2.1.0-3.0+neoforge" = _exGng8gG;
        "pkg-2.0.0-k2.1.0-2.0+neoforge" = _n4SLaorQ;
        "pkg-2.0.0-k2.1.0-2.0+forge" = _nfmFqjj6;
        "pkg-2.0.0-k2.1.0-1.0+forge" = _dCq7VY9D;
        "pkg-2.1.0-k2.1.0-3.0+neoforge" = _34q0hFg9;
        "pkg-2.1.0-k2.1.0-2.0+neoforge" = _i3KNbOS5;
        "pkg-2.1.0-k2.1.0-2.0+forge" = _lzqTJGRN;
        "pkg-2.1.0-k2.1.0-1.0+forge" = _wUizO3rg;
        "pkg-2.2.0-k2.1.0-3.0+neoforge" = _OspLjlAh;
        "pkg-2.2.0-k2.1.0-2.0+neoforge" = _ybrTXDUG;
        "pkg-2.2.0-k2.1.0-2.0+forge" = _5OHYIKtP;
        "pkg-2.2.0-k2.1.0-1.0+forge" = _7J1SwvVA;
        "pkg-2.3.0-k2.1.0-3.0+neoforge" = _mVi7mWRn;
        "pkg-2.3.0-k2.1.0-2.0+neoforge" = _yAzliLds;
        "pkg-2.3.0-k2.1.0-2.0+forge" = _Y2YYGSpj;
        "pkg-2.3.0-k2.1.0-1.0+forge" = _UYq4z7Yo;
        "pkg-2.4.0-k2.1.0-3.0+neoforge" = _JWSpQbed;
        "pkg-2.4.0-k2.1.0-2.0+neoforge" = _2YRsjr8c;
        "pkg-2.4.0-k2.1.0-2.0+forge" = _y6No6JQ9;
        "pkg-2.4.0-k2.1.0-1.0+forge" = _iRCAZr47;
        "pkg-2.4.0-k2.1.10-3.0+neoforge" = _tXaX2Uig;
        "pkg-2.4.0-k2.1.10-2.0+neoforge" = _VXc0Wp5B;
        "pkg-2.4.0-k2.1.10-2.0+forge" = _9Tp9Jr6q;
        "pkg-2.4.0-k2.1.10-1.0+forge" = _NFvzW85p;
        "pkg-2.5.0-k2.1.10-3.0+neoforge" = _rXZ3X4Yf;
        "pkg-2.5.0-k2.1.10-2.0+neoforge" = _NjKaXOtK;
        "pkg-2.5.0-k2.1.10-2.0+forge" = _YkhArlte;
        "pkg-2.5.0-k2.1.10-1.0+forge" = _kHuFBDcn;
        "pkg-2.6.0-k2.1.10-3.0+neoforge" = _YzbEvVqp;
        "pkg-2.6.0-k2.1.10-2.0+neoforge" = _OYZ5zrnK;
        "pkg-2.6.0-k2.1.10-2.0+forge" = _Uqbh8aoK;
        "pkg-2.6.0-k2.1.10-1.0+forge" = _nMWpJbeo;
        "pkg-2.6.0-k2.1.20-3.0+neoforge" = _qCTWasps;
        "pkg-2.6.0-k2.1.20-2.0+neoforge" = _cqkNScX2;
        "pkg-2.6.0-k2.1.20-2.0+forge" = _nIzynUL5;
        "pkg-2.6.0-k2.1.20-1.0+forge" = _NuSEr2Yc;
        "pkg-2.7.0-k2.1.20-3.0+neoforge" = _dl4QroLu;
        "pkg-2.7.0-k2.1.20-2.0+neoforge" = _eBtLeO4g;
        "pkg-2.7.0-k2.1.20-2.0+forge" = _1rF66wL0;
        "pkg-2.7.0-k2.1.20-1.0+forge" = _YFlNAfRB;
        "pkg-2.7.1-k2.1.20-3.0+neoforge" = _DkpLbwgh;
        "pkg-2.7.1-k2.1.20-2.0+neoforge" = _HktuFLES;
        "pkg-2.7.1-k2.1.20-2.0+forge" = _IPwUcwEm;
        "pkg-2.7.1-k2.1.20-1.0+forge" = _Esiw1975;
        "pkg-2.7.1-k2.1.21-3.0+neoforge" = _3IqhWmuA;
        "pkg-2.7.1-k2.1.21-2.0+neoforge" = _xlNLM4eS;
        "pkg-2.7.1-k2.1.21-2.0+forge" = _4RmzOFEW;
        "pkg-2.7.1-k2.1.21-1.0+forge" = _ZE2xWjIN;
        "pkg-2.8.0-k2.2.0-3.0+neoforge" = _RFJTFhsa;
        "pkg-2.8.0-k2.2.0-2.0+neoforge" = _GEsNBEfv;
        "pkg-2.8.0-k2.2.0-2.0+forge" = _vDQq2Sp6;
        "pkg-2.9.0-k2.2.0-3.0+neoforge" = _zauY9MYT;
        "pkg-2.9.0-k2.2.0-2.0+neoforge" = _Zw5qcqWp;
        "pkg-2.9.0-k2.2.0-2.0+forge" = _WQJSE1ax;
        "pkg-2.10.0-k2.2.0-2.0+forge" = _p8i9mOxv;
        "pkg-2.10.0-k2.2.0-2.0+neoforge" = _hiQB6gVc;
        "pkg-2.10.0-k2.2.0-3.0+neoforge" = _pqREHiRc;
        "pkg-2.10.1-k2.2.0-2.0+forge" = _Tmw6VbtG;
        "pkg-2.10.1-k2.2.0-2.0+neoforge" = _QZo3UFB4;
        "pkg-2.10.1-k2.2.0-3.0+neoforge" = _t2sQooe4;
        "pkg-2.10.3-k2.2.0-2.0+forge" = _reEwnlv1;
        "pkg-2.10.3-k2.2.0-2.0+neoforge" = _12ZG4fjA;
        "pkg-2.10.3-k2.2.0-3.0+neoforge" = _dXb4zzJw;
        "pkg-2.10.4-k2.2.10-2.0+forge" = _1iWo4d8Y;
        "pkg-2.10.4-k2.2.10-2.0+neoforge" = _RunpWRit;
        "pkg-2.10.4-k2.2.10-3.0+neoforge" = _w6PIwYKc;
        "pkg-2.10.5-k2.2.10-2.0+forge" = _Bt3sMnD8;
        "pkg-2.10.5-k2.2.10-2.0+neoforge" = _oclZq8aX;
        "pkg-2.10.5-k2.2.10-3.0+neoforge" = _k6RAKRhG;
        "pkg-2.10.5-k2.2.20-2.0+forge" = _hWsoYIlU;
        "pkg-2.10.5-k2.2.20-2.0+neoforge" = _mZwEfDOm;
        "pkg-2.10.5-k2.2.20-3.0+neoforge" = _Ktggj2px;
        "pkg-2.10.6-k2.2.20-2.0+forge" = _UuYKrGCw;
        "pkg-2.10.6-k2.2.20-2.0+neoforge" = _XzxNXlsB;
        "pkg-2.10.6-k2.2.20-3.0+neoforge" = _wsIHkyqq;
        "pkg-2.10.6-k2.2.20-3.1+neoforge" = _Ci13M8vA;
        "pkg-2.10.6-k2.2.21-2.0+forge" = _ekZgyfby;
        "pkg-2.10.6-k2.2.21-2.0+neoforge" = _V9Kb73Bq;
        "pkg-2.10.6-k2.2.21-3.0+neoforge" = _Oe88Z2WK;
        "pkg-2.10.6-k2.2.21-3.1+neoforge" = _ZuMzvyEx;
        "pkg-2.11.0-k2.2.21-2.0+neoforge" = _gXSfDvTr;
        "pkg-2.11.0-k2.2.21-3.0+neoforge" = _Wp6Jt60Y;
        "pkg-2.11.0-k2.2.21-3.1+neoforge" = _FHLDXvzk;
        "pkg-2.11.1-k2.2.21-2.0+forge" = _k3Nva00J;
        "pkg-2.11.1-k2.2.21-2.0+neoforge" = _mHMgr7Zx;
        "pkg-2.11.1-k2.2.21-3.0+neoforge" = _4ob9LugV;
        "pkg-2.11.1-k2.2.21-3.1+neoforge" = _4E1hd5NH;
        "pkg-2.11.1-k2.3.0-2.0+forge" = _UITBsvxH;
        "pkg-2.11.1-k2.3.0-2.0+neoforge" = _50wHVivN;
        "pkg-2.11.1-k2.3.0-3.0+neoforge" = _VHPtpJKY;
        "pkg-2.11.1-k2.3.0-3.1+neoforge" = _SN5Zowdn;
        "pkg-2.11.2-k2.3.0-2.0+forge" = _tisRjEH9;
        "pkg-2.11.2-k2.3.0-2.0+neoforge" = _Dq87Un9g;
        "pkg-2.11.2-k2.3.0-3.0+neoforge" = _hWmqi7Ak;
        "pkg-2.11.2-k2.3.0-3.1+neoforge" = _DunYETUG;
        "pkg-2.11.2-k2.3.10-2.0+forge" = _OV6R8MOo;
        "pkg-2.11.2-k2.3.10-2.0+neoforge" = _fdAJI9RO;
        "pkg-2.11.2-k2.3.10-3.0+neoforge" = _iiTXYtlz;
        "pkg-2.11.2-k2.3.10-3.1+neoforge" = _tkdgkMeY;
        "pkg-2.11.2-k2.3.20-2.0+forge" = _9SG3MOkN;
        "pkg-2.11.2-k2.3.20-2.0+neoforge" = _kF7CsEH5;
        "pkg-2.11.2-k2.3.20-3.0+neoforge" = _gLbZp38a;
        "pkg-2.11.2-k2.3.20-3.1+neoforge" = _euXUDxQE;
        "pkg-2.11.2-k2.3.21-2.0+forge" = _3T4g2TsF;
        "pkg-2.11.2-k2.3.21-2.0+neoforge" = _wrci5r3I;
        "pkg-2.11.2-k2.3.21-3.0+neoforge" = _kOS8xw7G;
        "pkg-2.11.2-k2.3.21-3.1+neoforge" = _iX2ZwKrM;
        "pkg-2.12.0-k2.3.21-2.0+forge" = _RFJfxY2v;
        "pkg-2.12.0-k2.3.21-2.0+neoforge" = _TieIu5IZ;
        "pkg-2.12.0-k2.3.21-3.0+neoforge" = _Wohcx5fG;
        "pkg-2.12.0-k2.3.21-3.1+neoforge" = _tzoE5v7T;
        "pkg-2.12.1-k2.3.21-2.0+forge" = _Ith8CVth;
        "pkg-2.12.1-k2.3.21-2.0+neoforge" = _SS3SEeQ1;
        "pkg-2.12.1-k2.3.21-3.0+neoforge" = _5BAviahm;
        "pkg-2.12.1-k2.3.21-3.1+neoforge" = _848ihFCv;
        "pkg-2.12.1-k2.4.0-2.0+forge" = _j3omGIzs;
        "pkg-2.12.1-k2.4.0-2.0+neoforge" = _ZgFzSj86;
        "pkg-2.12.1-k2.4.0-3.0+neoforge" = _j7m3xyCe;
        "pkg-2.12.1-k2.4.0-3.1+neoforge" = _7D6tle9s;
        "pkg-2.12.1-k2.4.10-2.0+forge" = _mn8NuuTh;
        "pkg-2.12.1-k2.4.10-2.0+neoforge" = _DeZhMgNW;
        "pkg-2.12.1-k2.4.10-3.0+neoforge" = _r3ly70u9;
        "pkg-2.12.1-k2.4.10-3.1+neoforge" = _cNaY77kd;
        "pkg-2.12.2-k2.4.10-2.0+forge" = _SqxxiHn8;
        "pkg-2.12.2-k2.4.10-2.0+neoforge" = _tWBVmiio;
        "pkg-2.12.2-k2.4.10-3.0+neoforge" = _318K66ba;
        "pkg-2.12.2-k2.4.10-3.1+neoforge" = _rVHF8yqA;
        "pkg-2.13.0-k2.4.10-2.0+forge" = _lByeZRgt;
        "pkg-2.13.0-k2.4.10-2.0+neoforge" = _GYo7kfik;
        "pkg-2.13.0-k2.4.10-3.0+neoforge" = _XsDHyDlZ;
        "pkg-2.13.0-k2.4.10-3.1+neoforge" = _LPcecmX5;
        "pkg-2.13.0-k2.4.20-2.0+forge" = _tpWHwzsV;
        "pkg-2.13.0-k2.4.20-2.0+neoforge" = _B9jdQpcx;
        "pkg-2.13.0-k2.4.20-3.0+neoforge" = _dlV4uaXo;
        "pkg-2.13.0-k2.4.20-3.1+neoforge" = _z7VDhg1n;
        "pkg-2.14.0-k2.4.20-2.0+forge" = _PEfCBUCv;
        "pkg-2.14.0-k2.4.20-2.0+neoforge" = _6Fy6uJfP;
        "pkg-2.14.0-k2.4.20-3.0+neoforge" = _fkUvgYcW;
        "pkg-2.14.0-k2.4.20-3.1+neoforge" = _6aLT01Dx;
        "pkg-2.14.1-k2.4.20-2.0+forge" = _W3vgqz9J;
        "pkg-2.14.1-k2.4.20-2.0+neoforge" = _QNe5NbGK;
        "pkg-2.14.1-k2.4.20-3.0+neoforge" = _SRMod41B;
        "pkg-2.14.1-k2.4.20-3.1+neoforge" = _BeksFnDy;
        "default" = _BeksFnDy;
    });
