...
let
    ...
    in {
        ...
        "pkg-1.16.5-3.4-forge" = _Rqf9KpTY;
        "pkg-1.18.2-3.5-forge" = _Gc6ohMKV;
        "pkg-1.19.2-3.7-forge" = _SvsMBUOF;
        "pkg-1.16.5-4.1-fabric" = _k7VxHSwb;
        "pkg-1.18.2-4.1-fabric" = _6sPIiERu;
        "pkg-1.19.2-4.1-fabric" = _dgTYa78E;
        "pkg-1.16.5-4.1-forge" = _PsqbzYTb;
        "pkg-1.18.2-4.1-forge" = _tQ1qRWWI;
        "pkg-1.19.2-4.1-forge" = _hbaIF0Pj;
        "pkg-1.16.5-4.2-fabric" = _XNlhpyyA;
        "pkg-1.18.2-4.2-fabric" = _XmlYmNk5;
        "pkg-1.19.2-4.2-fabric" = _w0YK7fFH;
        "pkg-1.16.5-4.3-fabric" = _qjKznvob;
        "pkg-1.18.2-4.3-fabric" = _jhFb9l7T;
        "pkg-1.19.2-4.3-fabric" = _IHYyfJWr;
        "pkg-1.16.5-4.3-forge" = _zp0TD6tt;
        "pkg-1.18.2-4.3-forge" = _iknCyj4W;
        "pkg-1.19.2-4.3-forge" = _xx2gtWHo;
        "pkg-1.19.3-4.4-fabric" = _MU4lDcde;
        "pkg-1.19.3-4.3-forge" = _4rW1z9uO;
        "pkg-1.18.2-5.0-forge+fabric" = _378XTJdc;
        "pkg-1.19.2-5.0-forge+fabric" = _kaXQuyMw;
        "pkg-1.19.3-5.0-forge+fabric" = _nCOh2rWh;
        "pkg-1.18.2-5.1-forge+fabric" = _eEHzTg1l;
        "pkg-1.19.2-5.1-forge+fabric" = _anzXPYpB;
        "pkg-1.19.3-5.1-forge+fabric" = _9BJmOQuo;
        "pkg-1.18.2-5.2-forge+fabric" = _ErJGpejf;
        "pkg-1.19.2-5.2-forge+fabric" = _Ft24Xref;
        "pkg-1.19.3-5.2-forge+fabric" = _E5ZhAXPi;
        "pkg-1.19.4-5.2-forge+fabric" = _68oV9M4s;
        "pkg-1.20-5.2-forge+fabric" = _oT5pnujv;
        "pkg-1.20.1-5.2-forge+fabric" = _hkncNcp7;
        "pkg-1.20.2-5.2-forge+fabric" = _WpzWQq8v;
        "pkg-1.18.2-6.0-forge+fabric" = _1d9DQ7CT;
        "pkg-1.19.2-6.0-forge+fabric" = _nepsmXZK;
        "pkg-1.20.1-6.0-forge+fabric" = _cK5Szl8X;
        "pkg-1.20.2-6.0-forge+fabric" = _UKJZl2AN;
        "pkg-1.18.2-6.1-forge+fabric" = _AjFOBfjV;
        "pkg-1.19.2-6.1-forge+fabric" = _CIsGqDGb;
        "pkg-1.20.1-6.1-forge+fabric" = _NA2y1hrf;
        "pkg-1.20.2-6.1-forge+fabric" = _fWr26gIX;
        "pkg-1.18.2-6.2-forge+fabric" = _MBcfsIIU;
        "pkg-1.19.2-6.2-forge+fabric" = _wYDqVybt;
        "pkg-1.20.1-6.2-forge+fabric" = _VjCIsB6W;
        "pkg-1.20.2-6.2-forge+fabric" = _Mjizl7xs;
        "pkg-1.20.2-6.3-forge+fabric" = _CCgzycLo;
        "pkg-1.18.2-6.4-forge+fabric" = _nwTVuMDO;
        "pkg-1.19.2-6.4-forge+fabric" = _1oSqU3s8;
        "pkg-1.20.1-6.4-forge+fabric" = _uTs2Wekw;
        "pkg-1.20.2-6.4-forge+fabric" = _z2bUlSOm;
        "pkg-1.18.2-7.0-fabric+forge+neo" = _KokAzmEH;
        "pkg-1.19.2-7.0-fabric+forge+neo" = _h7OTNzZx;
        "pkg-1.20.1-7.0-fabric+forge+neo" = _mNXsiTno;
        "pkg-1.20.2-7.0-fabric+forge+neo" = _WqNH3R93;
        "pkg-1.19.2-7.1-fabric+forge+neo" = _fkiZqav9;
        "pkg-1.20.1-7.1-fabric+forge+neo" = _u0eZOR27;
        "pkg-1.20.2-7.1-fabric+forge+neo" = _Spjydb5T;
        "pkg-1.20.3-7.1-fabric+forge+neo" = _zqs0WbUP;
        "pkg-1.20.4-7.1-fabric+forge+neo" = _g5fhrYRC;
        "pkg-1.19.2-7.2-fabric+forge+neo" = _4K6OO5O3;
        "pkg-1.20.1-7.2-fabric+forge+neo" = _vxsZQoD9;
        "pkg-1.20.2-7.2-fabric+forge+neo" = _rCyhtroW;
        "pkg-1.20.4-7.2-fabric+forge+neo" = _jYIY4Vt4;
        "pkg-1.19.2-7.3-fabric+forge+neo" = _l7FEhHcU;
        "pkg-1.20.1-7.3-fabric+forge+neo" = _lZ8iWdzV;
        "pkg-1.20.2-7.3-fabric+forge+neo" = _QZhpUhof;
        "pkg-1.20.4-7.3-fabric+forge+neo" = _vZNox0vl;
        "pkg-1.20.5-7.3-fabric+neo" = _39hQiCbp;
        "pkg-1.20.5-7.4-fabric+neo" = _P1PEc1hs;
        "pkg-1.20.6-7.4-fabric+forge+neo" = _K79ZLEXW;
        "pkg-1.21.0-7.4-fabric+forge+neo" = _PnzSrZmt;
        "pkg-1.20.1-8.0-fabric+forge+neo" = _d3U2qZyj;
        "pkg-1.20.6-8.0-fabric+forge+neo" = _G9FpTkwq;
        "pkg-1.21.0-8.0-fabric+forge+neo" = _3Wfwymh0;
        "pkg-1.20.1-8.1-fabric+forge+neo" = _rzXhJ2pH;
        "pkg-1.20.6-8.1-fabric+forge+neo" = _pTF9kxJW;
        "pkg-1.21.0-8.1-fabric+forge+neo" = _HuNQzRv6;
        "pkg-1.21.1-8.1-fabric+forge+neo" = _WPsLTKwG;
        "pkg-1.21.2-8.1-fabric+neo" = _cRZxiq3A;
        "pkg-1.21.3-8.1-fabric+forge+neo" = _AjP5RJBn;
        "pkg-1.21.4-8.1-fabric+forge+neo" = _vlScJPLF;
        "pkg-1.20.1-8.2-fabric+forge+neo" = _hvhPwZZ6;
        "pkg-1.21.1-8.2-fabric+forge+neo" = _MTjxRIUz;
        "pkg-1.21.4-8.2-fabric+forge+neo" = _iFR8gK9F;
        "pkg-1.21.5-8.2-fabric+forge+neo" = _BDYlxqxR;
        "pkg-1.21.5-8.3-fabric+forge+neo" = _xIV4gQSx;
        "pkg-1.21.6-8.3-fabric+forge+neo" = _Lcv6Pxij;
        "pkg-1.21.7-8.3-fabric+forge+neo" = _6kh4tDDb;
        "pkg-1.21.8-8.3-fabric+forge+neo" = _zsczq7H3;
        "pkg-1.21.9-8.3-fabric+forge+neo" = _X1zmZMDV;
        "pkg-1.21.10-8.3-fabric+forge+neo" = _PlzaDKOA;
        "pkg-1.21.11-8.3-fabric+forge+neo" = _iEv02V2S;
        "pkg-26.1.0-8.3-fabric+forge+neo" = _YyTrglVt;
        "pkg-26.1.1-8.3-fabric+forge+neo" = _mYHisdVF;
        "pkg-26.1.2-8.3-fabric+forge+neo" = _k0gh5Cpy;
        "pkg-1.20.1-8.4-fabric+forge+neo" = _KN6i4wCe;
        "pkg-1.21.1-8.4-fabric+forge+neo" = _Slna29v0;
        "pkg-1.21.11-8.4-fabric+forge+neo" = _O8m9nvv4;
        "pkg-26.1.2-8.4-fabric+forge+neo" = _twRIMCkF;
        "pkg-1.20.1-8.5-fabric+forge+neo" = _2THA99E5;
        "pkg-1.21.1-8.5-fabric+forge+neo" = _2PLlKTES;
