...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.0.3" = _mlJu40bw;
        "pkg-1.21.1-1.0.3" = _XZDukQVY;
        "pkg-1.21.1-1.1.1" = _X2KvcW8A;
        "pkg-1.21.1-1.1.2" = _p3YAUeAZ;
        "pkg-1.21.1-1.2.1" = _Yo3u93tf;
        "pkg-1.19.2-2.2.0" = _DUmuom0I;
        "pkg-1.20.1-1.1.0" = _8vKuvkxV;
        "pkg-1.21.1-1.2.2" = _1OZMYCfY;
        "pkg-1.12.2-2.0.3" = _7y6WCjSG;
        "pkg-1.16.5-1.1.11" = _aaEPercp;
        "pkg-1.17.1-1.0.0" = _MSTKXcGw;
        "pkg-1.18.2-1.0.0" = _edkAdYTq;
        "pkg-1.19.3-1.1.0" = _TPVD4tWP;
        "pkg-1.21.4-1.3.0" = _uKbJdMUr;
        "pkg-1.21.5-1.4.0" = _Cdqu9mkd;
        "pkg-1.21.1-1.2.3" = _GkaMBkbR;
        "pkg-1.21.1-1.3.0" = _dr5H1jhZ;
        "pkg-1.21.1-1.3.1" = _H7Gnbs1l;
        "pkg-1.21.5-1.4.2" = _oTRubSda;
        "pkg-1.21.11-1.5.0" = _L3ewUqzL;
        "pkg-1.20.1-1.2.0" = _DHWGsQDA;
        "pkg-1.21.1-1.4.0" = _fvz21Mg1;
        "pkg-1.21.11-1.6.0" = _72djJptQ;
