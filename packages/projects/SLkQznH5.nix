...
let
    versions = (let
        ...
        _Dy7VyCbY = {
            "id" = "Dy7VyCbY";
            "file" = "TastySupplies_-_DataPack.zip";
            "hash" = "sha512-UEBBEU6+9isXYRrFvUCNyJJy8pg0pi4/oTRYasRK2q1JWhNQSii4snO0A3+p+qKWAmmlQlt6dR/yormhdvqOPQ==";
        };
        _JBTIodXJ = {
            "id" = "JBTIodXJ";
            "file" = "tasty-supplies-v0.15.0.jar";
            "hash" = "sha512-UxnM8SPDJu7+NMXsdg74RzXAqT9eqzgwBsiPQucgkHxpZP8S9oYjmTT95RFBZIofZXL07UAU8KTidMT9h7C3RA==";
        };
    in {
        "mzFoP83A" = _mzFoP83A;
        "rNwxDTFv" = _rNwxDTFv;
        ...
        "datapack-1.21.11" = _Dy7VyCbY;
        "datapack-26.1" = _Dy7VyCbY;
        "datapack-26.1.1" = _Dy7VyCbY;
        "datapack-26.1.2" = _Dy7VyCbY;
        "datapack-26.2" = _Dy7VyCbY;
        "fabric-1.21.6" = _LJbC0ONv;
        "fabric-1.21.7" = _LJbC0ONv;
        "fabric-1.21.8" = _LJbC0ONv;
        "fabric-1.21.9" = _LJbC0ONv;
        "fabric-1.21.10" = _LJbC0ONv;
        "fabric-1.21.11" = _JBTIodXJ;
        "fabric-26.1" = _JBTIodXJ;
        "fabric-26.1.1" = _JBTIodXJ;
        "fabric-26.1.2" = _JBTIodXJ;
        "fabric-26.2" = _JBTIodXJ;
        "forge-1.21.6" = _LJbC0ONv;
        "forge-1.21.7" = _LJbC0ONv;
        "forge-1.21.8" = _LJbC0ONv;
        "forge-1.21.9" = _LJbC0ONv;
        "forge-1.21.10" = _LJbC0ONv;
        "forge-1.21.11" = _JBTIodXJ;
        "forge-26.1" = _JBTIodXJ;
        "forge-26.1.1" = _JBTIodXJ;
        "forge-26.1.2" = _JBTIodXJ;
        "forge-26.2" = _JBTIodXJ;
        ...
        "neoforge-1.21.11" = _JBTIodXJ;
        "neoforge-26.1" = _JBTIodXJ;
        "neoforge-26.1.1" = _JBTIodXJ;
        "neoforge-26.1.2" = _JBTIodXJ;
        "neoforge-26.2" = _JBTIodXJ;
        "quilt-1.21.6" = _LJbC0ONv;
        "quilt-1.21.7" = _LJbC0ONv;
        "quilt-1.21.8" = _LJbC0ONv;
        "quilt-1.21.9" = _LJbC0ONv;
        "quilt-1.21.10" = _LJbC0ONv;
        "quilt-1.21.11" = _JBTIodXJ;
        "quilt-26.1" = _JBTIodXJ;
        "quilt-26.1.1" = _JBTIodXJ;
        "quilt-26.1.2" = _JBTIodXJ;
        "quilt-26.2" = _JBTIodXJ;
        ...
        "minecraft-1.21.11" = _Dy7VyCbY;
        "minecraft-26.1" = _Dy7VyCbY;
        "minecraft-26.1.1" = _Dy7VyCbY;
        "minecraft-26.1.2" = _Dy7VyCbY;
        "minecraft-26.2" = _Dy7VyCbY;
        "pkg-0.10.0" = _mzFoP83A;
        "pkg-0.10.1" = _rNwxDTFv;
        "pkg-0.11.0" = _pGAXPomH;
        "pkg-0.11.2" = _yqItpoOg;
        "pkg-0.12.0" = _o1nWeEh2;
        "pkg-0.13.0" = _wgXaZ3D7;
        "pkg-0.13.0+mod" = _aC9IEJLV;
        "pkg-0.14.0" = _RkuuhsQB;
        "pkg-0.14.0+mod" = _zFVKIGnJ;
        "pkg-0.14.1" = _TlVIYQT9;
        "pkg-0.14.1+mod" = _ARR2O5dw;
        "pkg-0.14.2" = _1GlHdJqz;
        "pkg-0.14.2+mod" = _r6rM1dY4;
        "pkg-0.15.0-beta1" = _hEQD3PPL;
        "pkg-0.15.0-beta1+mod" = _4xOJaXRm;
        "pkg-0.15.0-beta3" = _2dKBaOFf;
        "pkg-0.15.0-beta3+mod" = _LJbC0ONv;
        "pkg-v0.15.0-beta4" = _xVcnOcrW;
        "pkg-v0.15.0-beta4+mod" = _J3RY5pGl;
        "pkg-v0.15.0" = _Dy7VyCbY;
        "pkg-v0.15.0+mod" = _JBTIodXJ;
        "default" = _JBTIodXJ;
    });
