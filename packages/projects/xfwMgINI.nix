...
let
    versions = (let
        ...
        _ouHLZGp4 = {
            "id" = "ouHLZGp4";
            "file" = "WorldReset-1.7.jar";
            "hash" = "sha512-AulKUgD2WzBxMgSCqI1As5ztFZRA4CXdF1oeHBY0hJZpwg/vyLShpTk/JClok74+RCFeUYzSAJKrz2aBCwpDgw==";
        };
        _DvCv0tJb = {
            "id" = "DvCv0tJb";
            "file" = "WorldReset-1.7.jar";
            "hash" = "sha512-Off3s9GyGMO3iOHkb3mtMT3GE8ediBxsq1L0SB1Qq82lHIJTdJemSK2GFGOR1Lm6b+wx6DG9THeRokJ1jZ39Kw==";
        };
        _p7eN9WZK = {
            "id" = "p7eN9WZK";
            "file" = "WorldReset-1.8.jar";
            "hash" = "sha512-EdjTxucuqlrAgQOAMaNunEKTBMV14f4gYnpBoyGc+p6BM1WlFQgVRmzJQb7xAsIDu+5MoaPkOz4kHsDzewtMEw==";
        };
    in {
        "w55WesxI" = _w55WesxI;
        "BIh9QVfP" = _BIh9QVfP;
        ...
        "DvCv0tJb" = _DvCv0tJb;
        "p7eN9WZK" = _p7eN9WZK;
        "bukkit-1.21.1" = _p7eN9WZK;
        "bukkit-1.21.2" = _p7eN9WZK;
        "bukkit-1.21.3" = _p7eN9WZK;
        "bukkit-1.21.4" = _p7eN9WZK;
        "bukkit-1.21.5" = _p7eN9WZK;
        "bukkit-1.21.6" = _p7eN9WZK;
        "bukkit-1.21.7" = _p7eN9WZK;
        "bukkit-1.21.8" = _p7eN9WZK;
        "bukkit-1.21.9" = _p7eN9WZK;
        "bukkit-1.21.10" = _p7eN9WZK;
        "bukkit-1.21.11" = _p7eN9WZK;
        "bukkit-1.21" = _p7eN9WZK;
        "bukkit-26.1" = _p7eN9WZK;
        "bukkit-26.1.1" = _p7eN9WZK;
        "bukkit-26.1.2" = _p7eN9WZK;
        "bukkit-26.2" = _p7eN9WZK;
        "paper-1.21.1" = _p7eN9WZK;
        "paper-1.21.2" = _p7eN9WZK;
        "paper-1.21.3" = _p7eN9WZK;
        "paper-1.21.4" = _p7eN9WZK;
        "paper-1.21.5" = _p7eN9WZK;
        "paper-1.21.6" = _p7eN9WZK;
        "paper-1.21.7" = _p7eN9WZK;
        "paper-1.21.8" = _p7eN9WZK;
        "paper-1.21.9" = _p7eN9WZK;
        "paper-1.21.10" = _p7eN9WZK;
        "paper-1.21.11" = _p7eN9WZK;
        "paper-1.21" = _p7eN9WZK;
        "paper-26.1" = _p7eN9WZK;
        "paper-26.1.1" = _p7eN9WZK;
        "paper-26.1.2" = _p7eN9WZK;
        "paper-26.2" = _p7eN9WZK;
        "purpur-1.21.1" = _p7eN9WZK;
        "purpur-1.21.2" = _p7eN9WZK;
        "purpur-1.21.3" = _p7eN9WZK;
        "purpur-1.21.4" = _p7eN9WZK;
        "purpur-1.21.5" = _p7eN9WZK;
        "purpur-1.21.6" = _p7eN9WZK;
        "purpur-1.21.7" = _p7eN9WZK;
        "purpur-1.21.8" = _p7eN9WZK;
        "purpur-1.21.9" = _p7eN9WZK;
        "purpur-1.21.10" = _p7eN9WZK;
        "purpur-1.21.11" = _p7eN9WZK;
        "purpur-1.21" = _p7eN9WZK;
        "purpur-26.1" = _p7eN9WZK;
        "purpur-26.1.1" = _p7eN9WZK;
        "purpur-26.1.2" = _p7eN9WZK;
        "purpur-26.2" = _p7eN9WZK;
