...
let
    ...
    in {
        ...
        "minecraft-26.3-snapshot-1" = _eJKD3bGC;
        "minecraft-26.3-snapshot-2" = _eJKD3bGC;
        "minecraft-26.3-snapshot-3" = _eJKD3bGC;
        "minecraft-26.3-snapshot-4" = _eJKD3bGC;
        "minecraft-26.3-snapshot-5" = _eJKD3bGC;
        "minecraft-26.3-snapshot-6" = _eJKD3bGC;
        "minecraft-26.3-snapshot-7" = _eJKD3bGC;
        ...
        "pkg-Sapixcraft_16x_1.19.4r1" = _SUiav0oI;
        "pkg-1.17_r3-32x" = _ocR4AQNU;
        "pkg-1.16.5_r9-32x" = _oEtPvtNY;
        "pkg-32x_1.19.4r1" = _YdtIHbus;
        "pkg-16x_1.19.4r2" = _RrooKmXw;
        "pkg-32x_1.19.4r2" = _WNgrWwIW;
        "pkg-1.20_r1-16x" = _jCiJMgjb;
        "pkg-1.20_r2-32x" = _5AKJpN2b;
        "pkg-1.20_r2-16x" = _3YLt6Fz4;
        "pkg-r0.2-16x" = _IkyBQEe9;
        "pkg-r1-16x" = _GhKZasH7;
        "pkg-r1.2-16x" = _UOeqZPB2;
        "pkg-r1.2a-16x" = _3KIcZ4Gz;
        "pkg-r1.2a-32x" = _R1BawvPb;
        "pkg-r1.3-32x" = _EF1wKP9r;
        "pkg-r1.4-32x" = _CwPaLejs;
        "pkg-r1.4" = _s2rPIdE8;
        "pkg-r1.4a" = _meuAlMkj;
        "pkg-r1" = _wiceFnV2;
        "pkg-r1.5" = _ASOtXut8;
