...
let
    ...
    in {
        ...
        "pkg-2.1.2" = _9R1ZpcB0;
        "pkg-2.1.3" = _9yJNhCkh;
        "pkg-2.1.4-Snapshot" = _6kjSabtP;
        "pkg-2.1.4-Pre-release" = _42NgA6N5;
        "pkg-v2.1.4-pre-release-2-5" = _d0B2uHP4;
        "pkg-v2.1.4-Release-Candidate" = _42gzHVPz;
        "pkg-2.1.5" = _Lwgyh6qx;
        "pkg-v2.1.6-Snapshot" = _Pxd9TLPE;
        "pkg-v2.1.7-Snapshot" = _exXajlsy;
        "pkg-v2.1.8-Snapshot" = _bRk9KyOo;
        "pkg-v2.1.9-Pre-Release-1" = _Ml2Qy8u5;
        "pkg-2.1.10" = _kNBx7Kun;
        "pkg-v2.1.11" = _1pbp4KxZ;
        "pkg-2.1.12-Snapshot" = _XtYran2B;
        "pkg-2.1.13-Snapshot" = _PMbCmZqS;
        "pkg-2.1.14-Snapshot" = _97iJcJeB;
        "pkg-v2.1.15-Pre-Release-1-3" = _lvWhpbsh;
        "pkg-v2.1.17" = _pRKBlGks;
        "pkg-v2.1.18-snapshot" = _uHSI0gOP;
        "pkg-v2.1.19-Snapshot" = _HujNjbBj;
        "pkg-v2.1.20-Snapshot" = _bCzopn0v;
        "pkg-v2.1.21-Snapshot" = _VtV5QLwN;
        "pkg-v2.1.22-Snapshot" = _12HfG81M;
        "pkg-v2.2.22" = _CuakgHbB;
        "pkg-v2.2.23" = _qcm9gKth;
        "pkg-v2.2.24-Snapshot" = _5Lg8tpXM;
        "pkg-v2.2.25-pre-release-1-4" = _ptSlCvIN;
        "pkg-v2.2.26" = _dJHDDkWt;
        "pkg-v2.2.27-rc2" = _wCSUsPUy;
        "pkg-v2.2.28" = _pcHtNfY0;
        "pkg-V2.2.29-Snapshot" = _oSo0XzqW;
        "pkg-v2.2.30-Snapshot" = _h8rJXQGI;
        "pkg-v2.3.0-Snapshot" = _7nJ6EtrL;
        "pkg-v2.3.1-Snapshot" = _uXUw67vE;
        "pkg-v2.3.2-Snapshot" = _xB3jFPNj;
        "pkg-2.3.3" = _F9h3CmZx;
        "pkg-v2.3.4-Snapshot" = _pqYXhvLU;
        "pkg-v2.3.6-Snapshot" = _yz0okHWM;
        "pkg-v2.3.7-pr-rc" = _EKAY31Ro;
        "pkg-v2.3.7" = _mB3tckLs;
        "pkg-v2.3.8-snapshot" = _522lkmPd;
        "pkg-v2.3.9-snapshot" = _wC3QfJSN;
        "pkg-v2.3.10-snapshot3-4" = _3xlHZ0qe;
        "pkg-v2.3.11-snapshot5" = _6gkYy4g8;
        "pkg-v2.3.12-snapshot6" = _s7UgWY2E;
        "pkg-v2.3.13-snapshot7-8-9" = _kQs8z85D;
        "pkg-v2.3.14-snapshot10" = _2IsZuucS;
        "pkg-v2.3.15" = _P3jpkYcj;
        "pkg-2.3.16-pr1-3" = _97SVK0cj;
        "pkg-v2.3.17" = _sbEVg9yt;
        "pkg-v2.3.18-snapshot1-2" = _NnFPOxRj;
        "pkg-v2.3.19-snapshot3" = _K8kBATEZ;
        "pkg-v2.3.20-snapshot4-5" = _xASvBxLz;
        "pkg-v2.3.21-snapshot7" = _IrHAWyDt;
        "pkg-v2.3.22" = _yGLsrgEV;
        "pkg-v2.3.23-snapshot2" = _4s4u29uX;
