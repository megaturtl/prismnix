...
let
    ...
    in {
        ...
        "pkg-2.0.3-GTNH" = _OfneyBpR;
        "pkg-2.0.4-GTNH" = _hjIq2lyF;
        "pkg-2.0.5-GTNH" = _OKfDw0E0;
        "pkg-2.1.0-GTNH" = _78VsqXI8;
        "pkg-2.1.1-GTNH-pre" = _BDA1vyxx;
        "pkg-2.1.2-GTNH" = _DgpijDZY;
        "pkg-2.1.3-GTNH" = _KKnWZ3Lh;
        "pkg-2.1.4-GTNH" = _ryb5x4fW;
        "pkg-2.1.5-GTNH" = _e3A1Wjpb;
        "pkg-2.1.6-GTNH" = _iFVnl8lb;
        "pkg-2.1.7-GTNH" = _SxmBAax7;
        "pkg-2.1.8-GTNH" = _HYLYRjPh;
        "pkg-2.2.0-GTNH" = _8GjVk9lX;
        "pkg-2.1.9-GTNH" = _puQboZXI;
        "pkg-2.2.1-GTNH" = _CNQgROhK;
        "pkg-2.2.3-GTNH" = _hSLjW3sc;
        "pkg-2.2.4-GTNH" = _QzAk2NfP;
        "pkg-2.1.10-GTNH" = _mKwm1K7w;
        "pkg-2.2.5-GTNH" = _q4SysDKa;
        "pkg-2.2.9-GTNH" = _WNPk5hIV;
        "pkg-2.2.13-GTNH" = _lnHeZp73;
        "pkg-2.2.14-GTNH" = _Gnp4iMpf;
        "pkg-2.2.15-GTNH" = _44elfXBL;
        "pkg-2.2.16-GTNH" = _iyTytYBN;
        "pkg-2.2.17-GTNH" = _uhxYfGNp;
        "pkg-2.2.18-GTNH" = _R0I7yxir;
        "pkg-2.2.19-GTNH" = _aVqA7iS3;
        "pkg-2.2.20-GTNH" = _aSA5TSR2;
        "pkg-2.2.21-GTNH" = _vKH8NZIN;
        "pkg-2.2.22-GTNH" = _JUxHwimg;
        "pkg-2.2.23-GTNH" = _LJ2YwVGz;
