...
let
    ...
    in {
        ...
        "pkg-v1.2.1" = _Axh7a6NA;
        "pkg-v1.2.2" = _Hxk0MUkM;
        "pkg-v1.3.0" = _5IOMSm0Y;
        "pkg-v1.3.1" = _1VjqTcbd;
        "pkg-1.3.1+1.20" = _fodgx8Pi;
        "pkg-1.3.1+1.20.1" = _xFPPNZj8;
        "pkg-1.4.0+1.20.2" = _XSq7vFgE;
        "pkg-1.5.0+1.20.2" = _X2as9hZ2;
        "pkg-1.5.0+1.20.4" = _b7UTAdZR;
        "pkg-1.6.0+1.20.4" = _PxodLGYR;
        "pkg-1.6.0+1.20.6" = _7GYKOXBg;
        "pkg-1.6.0+1.21" = _rFezKzKJ;
        "pkg-1.6.1+1.21" = _DagTs8yt;
        "pkg-1.6.1+1.21.3" = _CZRZ3zdO;
        "pkg-1.6.1+1.21.1" = _8ibrggQT;
        "pkg-1.6.1+1.21.4" = _xctbXdtM;
        "pkg-1.6.2+1.21.4" = _Pu2jDHZy;
        "pkg-1.6.3+1.21.5" = _5Wg7cdpk;
        "pkg-1.6.3+1.21.6" = _L8a0E5D9;
        "pkg-1.6.4+1.21.6" = _E8R8uIJb;
        "pkg-1.6.5+1.21.7" = _bQpUWrYq;
        "pkg-1.6.6+1.21.4" = _4U2iPfCb;
        "pkg-1.6.6+1.21.8" = _2BEDoO85;
        "pkg-1.6.6+1.21.10" = _ALfu7iP3;
        "pkg-1.6.7+1.21.4" = _XjbdTcP2;
        "pkg-1.6.7+1.21.8" = _b4OZOIC6;
        "pkg-1.6.7+1.21.10" = _6nK1t0UJ;
        "pkg-1.6.7+1.21.11" = _vMOQpnf6;
        "pkg-1.6.8+1.21.4" = _kVl38sPh;
        "pkg-1.6.8+1.21.8" = _KKzmIqIx;
        "pkg-1.6.8+1.21.10" = _JzCnFdsF;
        "pkg-1.6.8+1.21.11" = _vy9oFjzG;
        "pkg-1.6.8+26.1" = _41fUVzV4;
        "pkg-1.6.8+26.1.1" = _gQih6r3L;
        "pkg-1.6.8+26.1.2" = _zIwiuZPh;
        "pkg-1.6.9+1.21.4" = _UqRBNlc9;
        "pkg-1.6.9+1.21.8" = _BQA9VMs4;
        "pkg-1.6.9+1.21.10" = _5hgVlwuk;
        "pkg-1.6.9+1.21.11" = _bMHK1b7X;
        "pkg-1.6.9+26.1" = _fsqFiv6B;
