...
let
    versions = (let
        ...
        _FpaJGgRQ = {
            "id" = "FpaJGgRQ";
            "file" = "1.13.2 Default Plus Pre-19.zip";
            "hash" = "sha512-6sLwt004nZg/knT/QK+8mJavnuVRE0NfJZrbXjIQNO6gbpq1CSIANmO3ufqsddEQqCFriMH8FdUjCDCWNdkknQ==";
        };
    in {
        "8tRIRJMY" = _8tRIRJMY;
        "4HCZVG0V" = _4HCZVG0V;
        ...
        "c6yclQof" = _c6yclQof;
        "FpaJGgRQ" = _FpaJGgRQ;
        "minecraft-1.20" = _FpaJGgRQ;
        "minecraft-1.20.1" = _FpaJGgRQ;
        "minecraft-1.20.2" = _FpaJGgRQ;
        "minecraft-1.20.3" = _FpaJGgRQ;
        "minecraft-1.20.4" = _FpaJGgRQ;
        "minecraft-1.20.5" = _FpaJGgRQ;
        "minecraft-1.20.6" = _FpaJGgRQ;
        "minecraft-1.21" = _FpaJGgRQ;
        "minecraft-1.21.1" = _FpaJGgRQ;
        "minecraft-1.21.2" = _FpaJGgRQ;
        "minecraft-1.21.3" = _FpaJGgRQ;
        "minecraft-1.21.4" = _FpaJGgRQ;
        "minecraft-1.21.5" = _FpaJGgRQ;
        "minecraft-1.21.6" = _FpaJGgRQ;
        "minecraft-1.21.7" = _FpaJGgRQ;
        "minecraft-1.21.8" = _FpaJGgRQ;
        "minecraft-1.21.9" = _FpaJGgRQ;
        "minecraft-1.21.10" = _FpaJGgRQ;
        "minecraft-1.21.11" = _FpaJGgRQ;
        ...
        "minecraft-26.1" = _FpaJGgRQ;
        "minecraft-26.1.1" = _FpaJGgRQ;
        "minecraft-26.1.2" = _FpaJGgRQ;
        "minecraft-26.2" = _FpaJGgRQ;
        "minecraft-26.3" = _FpaJGgRQ;
        "pkg-Pre-9" = _8tRIRJMY;
        "pkg-Pre-10" = _4HCZVG0V;
        "pkg-Pre-11" = _DqY66uc7;
        "pkg-Pre-12" = _dncAYNKs;
        "pkg-Pre-13" = _dpRVPmQT;
        "pkg-Pre-14" = _Hqwg1egO;
        "pkg-Pre-15" = _mAgcbxIi;
        "pkg-Pre-16" = _cS5aWOtO;
        "pkg-Pre-17" = _oxl6VFKE;
        "pkg-Pre-18" = _bg4lvLUC;
        "pkg-Pre-18Pre-M1" = _c6yclQof;
        "pkg-Pre-19" = _FpaJGgRQ;
        "default" = _FpaJGgRQ;
    });
