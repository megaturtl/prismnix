...
let
    versions = (let
        ...
        _xjviNY5b = {
            "id" = "xjviNY5b";
            "file" = "Icarus-NeoForge-4.7.7.jar";
            "hash" = "sha512-WE5mPZ5bJE2mG1bfdYW//IILiOwIZckaYY6Jbdu0poGUwPn82nEQUwWeHM1lTauSNEw8LvTFPwio9oDRaWBRww==";
        };
        _lPyL7Tpk = {
            "id" = "lPyL7Tpk";
            "file" = "Icarus-Fabric-4.7.7.jar";
            "hash" = "sha512-rJpUZkEQ0gCUfJQALtckFs2RdgEO+crWyo9rmA7dbWZdpQLngX2AOsOLOB5v8gLT6LlkPfcVkb9jdm9Fako+Jw==";
        };
        _naLi1FGB = {
            "id" = "naLi1FGB";
            "file" = "Icarus-NeoForge-4.7.8.jar";
            "hash" = "sha512-vb2gl+63kEhE7XGQTnJM06TicWJ4aF3IE90YHK16ELjB7zWbX5rjSspHu+z70+LtAUH9pkIfCUPp0WPYodDewA==";
        };
        _Ysemxv90 = {
            "id" = "Ysemxv90";
            "file" = "Icarus-Fabric-4.7.8.jar";
            "hash" = "sha512-TGTb1vg3HTfuXYLCMnFKkdqWQZhrGJx1m1BYFtr4hcEJ//4USpwYUnThmtqSx0Uh/x/RnEJyrfKe/O1iRg/5Gg==";
        };
        _RXhgOzWN = {
            "id" = "RXhgOzWN";
            "file" = "Icarus-Forge-2.14.1.jar";
            "hash" = "sha512-1ME/jNAMPS+y4bNUimR9N05MHwKkaChlD34bNcBMWAR0TEZ8yu7ZE6JCSwdZIBfqpbcd8VD5pCkneTVQtOI93A==";
        };
        _qi3ldOeT = {
            "id" = "qi3ldOeT";
            "file" = "Icarus-Fabric-2.14.1.jar";
            "hash" = "sha512-NdE+NltGEMXKvc97+kHAHFh3ajZtgLGJshSmntLS0Ej7o5cGOq/jBDW6QlBF70Hd9Ahnk59yEqmxue1nTPSYdQ==";
        };
    in {
        "EkZF8V2T" = _EkZF8V2T;
        "6OHKkFZc" = _6OHKkFZc;
        ...
        "pkg-1.15" = _nNDoBUQw;
        "pkg-1.16" = _Z2pJmMe0;
        "pkg-2.0.0+NeoForge" = _pQmJCfEX;
        "pkg-2.0.0+Quilt" = _UOzFQpTP;
        "pkg-2.0.0" = _fbyRdeYA;
        "pkg-2.0.1+NeoForge" = _Ltuz5TUR;
        "pkg-2.0.1+Quilt" = _Gdv5N0Ia;
        "pkg-2.0.1+Fabric" = _mcQZfPQO;
        "pkg-2.1.0+NeoForge" = _IcxoRz7a;
        "pkg-2.1.0+Quilt" = _f17n1cci;
        "pkg-2.1.0+Fabric" = _7j9erkAE;
        "pkg-2.1.1+NeoForge" = _zH5ASnJF;
        "pkg-2.1.1+Quilt" = _g1a7CsQ1;
        "pkg-2.1.1+Fabric" = _BIVCOf2u;
        "pkg-2.1.2+NeoForge" = _yoelRhaR;
        "pkg-2.1.2+Quilt" = _TdUa9XwI;
        "pkg-2.1.2+Fabric" = _k4jSVxtr;
        "pkg-2.1.3+NeoForge" = _zIrimUZj;
        "pkg-2.1.3+Quilt" = _BWHbLeav;
        "pkg-2.1.3+Fabric" = _S8INBrRr;
        "pkg-2.1.4+NeoForge" = _sqKBMj5n;
        "pkg-2.1.4+Quilt" = _NGCyQJlV;
        "pkg-2.1.4+Fabric" = _3At3q5Lv;
        "pkg-2.1.5+NeoForge" = _2mdKf3GR;
        "pkg-2.1.5+Quilt" = _zGNMzslv;
        "pkg-2.1.5+Fabric" = _9nTIXasv;
        "pkg-2.2.0+NeoForge" = _S975aVDS;
        "pkg-2.2.0+Quilt" = _Cwxrsn9O;
        "pkg-2.2.0+Fabric" = _LAyujInz;
        "pkg-2.3.0+NeoForge" = _v0MNpftk;
        "pkg-2.3.0+Quilt" = _tOjVxwzp;
        "pkg-2.3.0+Fabric" = _INslskuq;
        "pkg-2.4.0+NeoForge" = _9JGt5Vsj;
        "pkg-2.4.0+Quilt" = _oWfg1vhS;
        "pkg-2.4.0+Fabric" = _SuEE0qpS;
        "pkg-2.5.0+NeoForge" = _Ggm61nzM;
        "pkg-2.5.0+Quilt" = _JCjzAmmv;
        "pkg-2.5.0+Fabric" = _dUMgCZHk;
        "pkg-2.6.0+NeoForge" = _aqkoD86x;
        "pkg-2.6.0+Quilt" = _Bq5Eqs8R;
        "pkg-2.6.0+Fabric" = _kGdDnOWb;
        "pkg-2.7.0+NeoForge" = _eJNHdjvB;
        "pkg-2.7.0+Quilt" = _5HhNY3k0;
        "pkg-2.7.0+Fabric" = _EHxB1d8D;
        "pkg-2.7.1+NeoForge" = _u9MAnknN;
        "pkg-2.7.1+Quilt" = _2gPkVBzv;
        "pkg-2.7.1+Fabric" = _4Cjb2sBr;
        "pkg-2.7.2-beta.1+NeoForge" = _2bzqR2gO;
        "pkg-2.7.2-beta.1+Quilt" = _4RZ6HyFo;
        "pkg-2.7.2-beta.1+Fabric" = _c9cXnyUu;
        "pkg-2.8.0+NeoForge" = _62bSfFmF;
        "pkg-2.8.0+Quilt" = _6H2hw2Xp;
        "pkg-2.8.0+Fabric" = _SXbQEztt;
        "pkg-2.8.1+NeoForge" = _t6FT6Ds9;
        "pkg-2.8.1+Quilt" = _i8DuLVrt;
        "pkg-2.8.1+Fabric" = _5jIl1XOG;
        "pkg-2.8.2+NeoForge" = _YqN2EHV3;
        "pkg-2.8.2+Quilt" = _sRZ83dx9;
        "pkg-2.8.2+Fabric" = _Qiu3DzLL;
        "pkg-2.9.0+NeoForge" = _HVdb4C2M;
        "pkg-2.9.0+Quilt" = _Q4SZETgN;
        "pkg-2.9.0+Fabric" = _TmdneqGC;
        "pkg-2.9.1+NeoForge" = _ibRIVnvS;
        "pkg-2.9.1+Quilt" = _34m1RvQK;
        "pkg-2.9.1+Fabric" = _aIO2Oobv;
        "pkg-1.15.1+Fabric" = _yzi2t8Nr;
        "pkg-1.15.2+Fabric" = _sdzoH4WU;
        "pkg-2.9.2+NeoForge" = _5bOHJRs3;
        "pkg-2.9.2+Quilt" = _9BJTHzmN;
        "pkg-2.9.2+Fabric" = _OdZ2fpej;
        "pkg-3.0.0+NeoForge" = _u2grFfMu;
        "pkg-3.0.0+Quilt" = _6mHY62BF;
        "pkg-3.0.0+Fabric" = _WHRyxpF2;
        "pkg-4.0.0+Quilt" = _WEtSOxxz;
        "pkg-4.0.0+Fabric" = _i4GD491i;
        "pkg-4.0.0+NeoForge" = _eUjjspuA;
        "pkg-1.14.1" = _XbEouy06;
        "pkg-4.0.1+NeoForge" = _DYbKAQyd;
        "pkg-4.0.1+Quilt" = _MO4aKSrs;
        "pkg-4.0.1+Fabric" = _Et2OEdJn;
        "pkg-2.10.0+NeoForge" = _zUZTM7u3;
        "pkg-2.10.0+Quilt" = _UOFcGv1q;
        "pkg-2.10.0+Fabric" = _8d5xpfmH;
        "pkg-3.1.0+NeoForge" = _uIbKpIM4;
        "pkg-3.1.0+Quilt" = _XTLhQMel;
        "pkg-3.1.0+Fabric" = _hTbXOknd;
        "pkg-4.1.0+NeoForge" = _6tIv0K9b;
        "pkg-4.1.0+Quilt" = _KtYhlNop;
        "pkg-4.1.0+Fabric" = _F1wAg3xz;
        "pkg-4.2.0+NeoForge" = _bpXsl4vn;
        "pkg-4.2.0+Quilt" = _xRgvQFzj;
        "pkg-4.2.0+Fabric" = _KTdfdk5d;
        "pkg-2.11.0+Forge" = _3ZgF40HD;
        "pkg-2.11.0+Fabric" = _kzZ35hg0;
        "pkg-4.3.0+NeoForge" = _9oG8prIZ;
        "pkg-4.3.0+Fabric" = _uwNvXrJE;
        "pkg-4.3.1+NeoForge" = _Rw8nqqik;
        "pkg-4.3.1+Fabric" = _U9EYnfsQ;
        "pkg-2.12.0+NeoForge" = _U6yVv3Zg;
        "pkg-2.12.0+Fabric" = _wXExPVEa;
        "pkg-4.4.0+NeoForge" = _F4AI0oiM;
        "pkg-4.4.0+Fabric" = _AC39pcY3;
        "pkg-4.5.0+NeoForge" = _3vQNzwIW;
        "pkg-4.5.0+Fabric" = _40v52hjc;
        "pkg-4.5.1+NeoForge" = _Om5ZpK1r;
        "pkg-4.5.1+Fabric" = _jG5xgh4w;
        "pkg-2.13.0+NeoForge" = _SQpva2xn;
        "pkg-2.13.0+Fabric" = _TNVcMIkz;
        "pkg-4.6.0+NeoForge" = _G36DSqxE;
        "pkg-4.6.0+Fabric" = _InvGPjJX;
        "pkg-4.6.1+NeoForge" = _8djPnJwx;
        "pkg-4.6.1+Fabric" = _nWweKOTq;
        "pkg-4.6.2+NeoForge" = _arPlXFto;
        "pkg-4.6.2+Fabric" = _XjnYx13A;
        "pkg-2.13.1+NeoForge" = _7DWaK3Ah;
        "pkg-2.13.1+Fabric" = _HQlQ05g7;
        "pkg-4.6.3+NeoForge" = _mTL72Usg;
        "pkg-4.6.3+Fabric" = _A5WZhBE8;
        "pkg-4.6.4+NeoForge" = _73gOaTU5;
        "pkg-4.6.4+Fabric" = _PI9Zw4Lb;
        "pkg-2.13.2+NeoForge" = _ozZnrBG3;
        "pkg-2.13.2+Fabric" = _LIKNg34U;
        "pkg-4.7.0+NeoForge" = _68p8ymtr;
        "pkg-4.7.0+Fabric" = _cvNZHWxB;
        "pkg-4.7.1+NeoForge" = _s67nIbVE;
        "pkg-4.7.1+Fabric" = _8RMuLDkU;
        "pkg-4.7.2+NeoForge" = _JgcqVmMG;
        "pkg-4.7.2+Fabric" = _2iK8guOQ;
        "pkg-4.7.3+NeoForge" = _hrUQX2KT;
        "pkg-4.7.3+Fabric" = _vtig9gzw;
        "pkg-2.14.0+NeoForge" = _BwMrXx3p;
        "pkg-2.14.0+Fabric" = _e3J8zqN1;
        "pkg-4.7.4+NeoForge" = _UhqNzWSH;
        "pkg-4.7.4+Fabric" = _w8wEXaue;
        "pkg-4.7.5+NeoForge" = _lklOwLBi;
        "pkg-4.7.5+Fabric" = _fknU6LPr;
        "pkg-4.7.6+NeoForge" = _I7uTimBi;
        "pkg-4.7.6+Fabric" = _csx6pPBo;
        "pkg-4.7.7+NeoForge" = _xjviNY5b;
        "pkg-4.7.7+Fabric" = _lPyL7Tpk;
        "pkg-4.7.8+NeoForge" = _naLi1FGB;
        "pkg-4.7.8+Fabric" = _Ysemxv90;
        "pkg-2.14.1+NeoForge" = _RXhgOzWN;
        "pkg-2.14.1+Fabric" = _qi3ldOeT;
        "default" = _qi3ldOeT;
    });
