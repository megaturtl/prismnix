...
let
    versions = (let
        ...
        _70Iq86D9 = {
            "id" = "70Iq86D9";
            "file" = "Realistic Animals - 5.0.zip";
            "hash" = "sha512-9CEJZ10Lm/ExdgsShTiShkZVp/R2HMeMqNKiXBz4alUIM23YrCV991OFBFCox8Sa4r/DLV77s7pPUvOsxkxBYw==";
        };
    in {
        "GCoswqAO" = _GCoswqAO;
        "g1w0zz1z" = _g1w0zz1z;
        ...
        "wZAuxZtj" = _wZAuxZtj;
        "70Iq86D9" = _70Iq86D9;
        "minecraft-1.20.1" = _70Iq86D9;
        "minecraft-1.21" = _70Iq86D9;
        "minecraft-1.21.1" = _70Iq86D9;
        "minecraft-1.21.2" = _70Iq86D9;
        "minecraft-1.21.3" = _70Iq86D9;
        "minecraft-1.21.4" = _70Iq86D9;
        "minecraft-1.21.5" = _70Iq86D9;
        "minecraft-1.21.6" = _70Iq86D9;
        "minecraft-1.21.7" = _70Iq86D9;
        "minecraft-1.21.8" = _70Iq86D9;
        "minecraft-1.21.9" = _70Iq86D9;
        "minecraft-1.21.10" = _70Iq86D9;
        "minecraft-1.16" = _70Iq86D9;
        "minecraft-1.16.1" = _70Iq86D9;
        "minecraft-1.16.2" = _70Iq86D9;
        "minecraft-1.16.3" = _70Iq86D9;
        "minecraft-1.16.4" = _70Iq86D9;
        "minecraft-1.16.5" = _70Iq86D9;
        "minecraft-1.18" = _70Iq86D9;
        "minecraft-1.18.1" = _70Iq86D9;
        "minecraft-1.18.2" = _70Iq86D9;
        "minecraft-1.19" = _70Iq86D9;
        "minecraft-1.19.1" = _70Iq86D9;
        "minecraft-1.19.2" = _70Iq86D9;
        "minecraft-1.20" = _70Iq86D9;
        "minecraft-1.20.2" = _70Iq86D9;
        "minecraft-1.20.3" = _70Iq86D9;
        "minecraft-1.20.4" = _70Iq86D9;
        "minecraft-1.20.5" = _70Iq86D9;
        "minecraft-1.20.6" = _70Iq86D9;
        "minecraft-1.21.11" = _70Iq86D9;
        "minecraft-1.17" = _70Iq86D9;
        "minecraft-1.17.1" = _70Iq86D9;
        "minecraft-1.19.3" = _70Iq86D9;
        "minecraft-1.19.4" = _70Iq86D9;
        "minecraft-26.1" = _70Iq86D9;
        "minecraft-26.1.1" = _70Iq86D9;
        "minecraft-26.1.2" = _70Iq86D9;
        "minecraft-26.2" = _70Iq86D9;
        "minecraft-26.3" = _70Iq86D9;
        "pkg-1.0.0" = _g1w0zz1z;
        "pkg-2.0.0" = _eZho1DL3;
        "pkg-3.0.0" = _RWpH56EY;
        "pkg-3.1" = _1XDWwkcE;
