...
let
    versions = (let
        ...
        _hclClrSV = {
            "id" = "hclClrSV";
            "file" = "droploottables-fabric-1.8.1-1.9.1.jar";
            "hash" = "sha512-JbXyeBLoA59Jsi7llwxYwXkMyaR1WXd6JPsbaahjNsER4MhYM0+wS0HkG/l4WdTYrd79sD7joaBeuJJTsolqcg==";
        };
        _mTGWFyUU = {
            "id" = "mTGWFyUU";
    ...
    in {
        ...
        "pkg-1.5-fabric-1.2.1" = _rEqz4geA;
        "pkg-1.5-fabric-1.3.0" = _QKZXGStX;
        "pkg-1.5-fabric-1.3.1" = _xYZftVYQ;
        "pkg-1.5-fabric-1.4.0" = _Ivt8UtFS;
        "pkg-1.6-fabric-1.0.0" = _r7lXilpd;
        "pkg-1.6-fabric-1.1.0" = _aUv1oDdK;
        "pkg-1.6-fabric-1.2.0" = _rIlgjsjR;
        "pkg-1.6-fabric-1.3.0" = _TE3Qmf0f;
        "pkg-1.6-fabric-1.3.1" = _SR9Cgh5I;
        "pkg-1.6-fabric-1.4.0" = _2xDqwRO0;
        "pkg-1.6-fabric-1.4.1" = _TPq9hUyK;
        "pkg-1.7.1-fabric-1.5.0" = _uTf5Lnck;
        "pkg-1.7.1-neoforge-1.5.0" = _DbTJoKFF;
        "pkg-1.7.1-fabric-1.6.0" = _KURmq2yM;
        "pkg-1.7.1-neoforge-1.6.0" = _9iteacag;
        "pkg-1.7.1-fabric-1.6.1" = _Ce2n7SnU;
        "pkg-1.7.2-fabric-1.7.0" = _sLba33sI;
        "pkg-1.7.3-fabric-1.7.1" = _ApxxPaLf;
        "pkg-1.7.3-fabric-1.8.0" = _pxXO1o0U;
        "pkg-1.7.3-neoforge-1.8.0" = _3z0pVXOc;
        "pkg-1.7.3-fabric-1.9.0" = _sjh40fsg;
        "pkg-1.7.3-neoforge-1.9.0" = _PeNY46gY;
