...
let
    versions = (let
        ...
        _CJdn8ttg = {
            "id" = "CJdn8ttg";
            "file" = "show-me-your-skin-2.0.3+26.2.jar";
            "hash" = "sha512-FMQIHNg0cvkG+XRUCji8S9U1jtG0/UIMe4XcdIckwgJMPFuh+ESW2GH17zFkzLcnzfpfur0RhjciO5lnK1w1AQ==";
        };
    in {
        "57Xdw6wv" = _57Xdw6wv;
        "oOsRbdhj" = _oOsRbdhj;
