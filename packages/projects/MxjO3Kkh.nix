...
let
    ...
    in {
        ...
        "pkg-OKM-1.16-1.1.0" = _s55PnFbQ;
        "pkg-OKM-1.17-1.1.0" = _PRBvUGa1;
        "pkg-OKM-1.19-1.1.0" = _IXJT1Vqy;
        "pkg-OKM-1.14-1.2.0" = _nfG6bF7Y;
        "pkg-OKM-1.15-1.2.0" = _wi62xADe;
        "pkg-OKM-1.16-1.2.0" = _DPi0vAeN;
        "pkg-OKM-1.17-1.2.0" = _74WqTKDW;
        "pkg-OKM-1.18-1.2.0" = _5IVfyflw;
        "pkg-OKM-1.19-1.2.0" = _feEwQlCM;
        "pkg-1.14-1.3.1" = _iBXm6QJz;
        "pkg-1.15-1.3.1" = _FdYcbo01;
        "pkg-1.16-1.3.1" = _TGY3RIuc;
        "pkg-1.17-1.3.1" = _wlGYZz3q;
        "pkg-1.18-1.3.1" = _TWXyk0rk;
        "pkg-1.19.3-1.3.1" = _4LMQ0E01;
        "pkg-1.19.4-1.3.1" = _ZZyTsbhc;
        "pkg-1.14-1.4.0" = _9q2rnwR2;
        "pkg-1.15-1.4.0" = _J2xX4xGq;
        "pkg-1.16-1.4.0" = _8pFq4Sdf;
        "pkg-1.17-1.4.0" = _Ptq6cjNS;
        "pkg-1.18-1.4.0" = _TB28aKLj;
        "pkg-1.19.4-1.4.0" = _6qeRdIz3;
        "pkg-1.20-pre6-1.4.0" = _bOTumL5O;
        "pkg-1.14.4-1.4.1" = _ndoMVPZt;
        "pkg-1.15.2-1.4.1" = _Exuo2Kx9;
        "pkg-1.16.5-1.4.1" = _cRya4wbe;
        "pkg-1.17.1-1.4.1" = _Y5V9bARk;
        "pkg-1.18.2-1.4.1" = _S30EI8qm;
        "pkg-1.19.4-1.4.1" = _XaEAJlXc;
        "pkg-1.20-pre7-1.4.1" = _ipEywlUM;
        "pkg-1.14.4-1.5.0" = _gJh096LF;
        "pkg-1.15.2-1.5.0" = _XTfRGb1V;
        "pkg-1.16.5-1.5.0" = _jMuygHD9;
        "pkg-1.17.1-1.5.0" = _9xUH6gQa;
        "pkg-1.18.2-1.5.0" = _RPmAB8Tx;
        "pkg-1.19.4-1.5.0" = _hNuXVKJy;
        "pkg-1.20-rc1-1.5.0" = _Dxs6azHg;
        "pkg-1.14.4-1.5.1" = _N0uoNdyp;
        "pkg-1.15.2-1.5.1" = _VTV6DwlX;
        "pkg-1.16.5-1.5.1" = _sbafOg5p;
        "pkg-1.17.1-1.5.1" = _52wW2S8q;
        "pkg-1.18.2-1.5.1" = _ol3WbY1u;
        "pkg-1.19.4-1.5.1" = _aBvWrQ0w;
        "pkg-1.20-1.5.1" = _gtgXg1oc;
        "pkg-1.14.4-1.5.2" = _jvSqYdrU;
        "pkg-1.15.2-1.5.2" = _QOiftNnn;
        "pkg-1.16.5-1.5.2" = _4Jkz5rLH;
        "pkg-1.17.1-1.5.2" = _1HbzCrVK;
        "pkg-1.18.2-1.5.2" = _dC8f1aNT;
        "pkg-1.19.4-1.5.2" = _FeCf5Wc9;
        "pkg-1.20-1.5.2" = _AqivUnCI;
        "pkg-1.14.4-1.6.0" = _dsJOnSpx;
        "pkg-1.15.2-1.6.0" = _k95avTxu;
        "pkg-1.16.5-1.6.0" = _3i5Rs84y;
        "pkg-1.17.1-1.6.0" = _DBoClhv8;
        "pkg-1.18.2-1.6.0" = _3fdpbwms;
        "pkg-1.19.4-1.6.0" = _Kp3vdIhD;
        "pkg-1.20.1-1.6.0" = _BcHKsNQO;
        "pkg-1.14.4-1.6.1" = _MfWLyxp5;
        "pkg-1.15.2-1.6.1" = _wvtskpA7;
        "pkg-1.16.5-1.6.1" = _akp5n0gz;
        "pkg-1.17.1-1.6.1" = _8cl00PcB;
        "pkg-1.18.2-1.6.1" = _bHZKKLnC;
        "pkg-1.19.4-1.6.1" = _U04XbSBz;
        "pkg-1.20.1-1.6.1" = _V8BpCWPL;
        "pkg-1.14.4-1.7.0" = _CaMpgmr3;
        "pkg-1.15.2-1.7.0" = _m6x1fxUL;
        "pkg-1.16.5-1.7.0" = _25Jg56pp;
        "pkg-1.17.1-1.7.0" = _D6HLUwC2;
        "pkg-1.18.2-1.7.0" = _sRtKwMxu;
        "pkg-1.19.4-1.7.0" = _NQW4b7W8;
        "pkg-1.20.1-1.7.0" = _Cbwymkxh;
        "pkg-1.10.2-1.8.0" = _ZkYTes1F;
        "pkg-1.7.10-1.8.0" = _D1vNul8R;
        "pkg-1.12.2-1.8.0" = _A046BmTF;
        "pkg-1.14.4-1.8.0" = _X6U8zDY9;
        "pkg-1.15.2-1.8.0" = _gjOw25Tx;
        "pkg-1.16.5-1.8.0" = _43wQ1Lhj;
        "pkg-1.17.1-1.8.0" = _r6PwZjXL;
        "pkg-1.9.4-1.8.0" = _rxTzYeci;
        "pkg-1.19.4-1.8.0" = _gM4tmX1k;
        "pkg-1.11.2-1.8.0" = _216OcQnI;
        "pkg-1.8.9-1.8.0" = _JPdy6wMW;
        "pkg-1.18.2-1.8.0" = _Y7yQC5l7;
        "pkg-1.20.1-1.8.0" = _WklZNJz4;
        "pkg-1.20.2-1.8.0" = _4VKgLI1P;
        "pkg-1.10.2-1.8.1" = _9AaECIHi;
        "pkg-1.11.2-1.8.1" = _b7uu5PCx;
        "pkg-1.12.2-1.8.1" = _X2X5iXBm;
        "pkg-1.7.10-1.8.1" = _hKfwAXqu;
        "pkg-1.8.9-1.8.1" = _uZyaM1ep;
        "pkg-1.9.4-1.8.1" = _D26NBrVU;
        "pkg-1.14.4-1.8.1" = _eUdxWNjG;
        "pkg-1.15.2-1.8.1" = _TjymqgZY;
        "pkg-1.16.5-1.8.1" = _s2YzcHST;
        "pkg-1.17.1-1.8.1" = _2OyzqiQ4;
        "pkg-1.18.2-1.8.1" = _LHgVJdKZ;
        "pkg-1.19.4-1.8.1" = _ydiYxEmj;
        "pkg-1.20.3-1.8.1" = _zwix3YsT;
        "pkg-1.20.5-1.8.1" = _my6mXbaP;
        "pkg-1.20.6-1.8.1" = _XjyhD0WQ;
        "pkg-1.21-1.8.1" = _oupdE6vA;
        "pkg-1.10.2-1.9.0" = _kchhZ65M;
        "pkg-1.11.2-1.9.0" = _cdhuSab3;
        "pkg-1.12.2-1.9.0" = _zFfe0GJb;
        "pkg-1.7.10-1.9.0" = _tMAGtGGY;
        "pkg-1.8.9-1.9.0" = _ydaXF2mZ;
        "pkg-1.9.4-1.9.0" = _HtbpMGyX;
        "pkg-1.14.4-1.9.0" = _xjAu9KRB;
        "pkg-1.15.2-1.9.0" = _8SmCI8rv;
        "pkg-1.16.5-1.9.0" = _j5DGkKYH;
        "pkg-1.17.1-1.9.0" = _mk9MYIp1;
        "pkg-1.18.2-1.9.0" = _9s4cQHmi;
        "pkg-1.19.4-1.9.0" = _LuTTOzbI;
        "pkg-1.20.6-1.9.0" = _dJ8uk94R;
        "pkg-1.21-1.9.0" = _ek0Kn11e;
        "pkg-1.10.2-1.9.1" = _3tCWwPuh;
        "pkg-1.11.2-1.9.1" = _RkB9Qxc7;
        "pkg-1.12.2-1.9.1" = _3cFH3xzI;
        "pkg-1.8.9-1.9.1" = _7eqFZmfI;
        "pkg-1.9.4-1.9.1" = _qmkxeeGG;
        "pkg-1.16.5-1.9.1" = _dMwL9S3d;
        "pkg-1.17.1-1.9.1" = _4sLoxjiM;
        "pkg-1.14.4-1.9.1" = _U3bXPchv;
        "pkg-1.18.2-1.9.1" = _ocF56ZM5;
        "pkg-1.19.4-1.9.1" = _XNo2IQyF;
        "pkg-1.15.2-1.9.1" = _H1dsrnLh;
        "pkg-1.20.6-1.9.1" = _dQlT6PZ4;
        "pkg-1.21-1.9.1" = _J4dC66F0;
        "pkg-1.7.10-1.9.1" = _UNVczsVa;
        "pkg-1.21.1-1.9.1" = _GfAcG17u;
        "pkg-1.21.3-1.9.1" = _YhBXk0wD;
        "pkg-1.21.4-1.9.1" = _o2nGrGlx;
        "pkg-1.21.5-1.9.1" = _UuxKVZN6;
        "pkg-1.21.6-1.9.1" = _u7tEzEgJ;
        "pkg-1.21.7-1.9.1" = _MERW22Lt;
        "pkg-1.10.2-1.9.2" = _bSLgcVAA;
        "pkg-1.8.9-1.9.2" = _OLWBuCtz;
        "pkg-1.12.2-1.9.2" = _x0FKakCG;
        "pkg-1.11.2-1.9.2" = _NTIsWyJi;
        "pkg-1.7.10-1.9.2" = _hxGSs284;
        "pkg-1.9.4-1.9.2" = _uxJHytQ3;
        "pkg-1.15.2-1.9.2" = _YYJZC7TU;
        "pkg-1.14.4-1.9.2" = _jGu0mfDo;
        "pkg-1.20.6-1.9.2" = _veqHaDR9;
        "pkg-1.18.2-1.9.2" = _oRtBaRmO;
        "pkg-1.17.1-1.9.2" = _zNTSMH2S;
        "pkg-1.16.5-1.9.2" = _8mwDjOen;
        "pkg-1.21.7-1.9.2" = _IVghkmt8;
        "pkg-1.19.4-1.9.2" = _oMm1ufbc;
        "pkg-1.21.7-1.9.3" = _zarsLZJa;
        "pkg-1.21.8-1.9.3" = _ueEbqbAW;
        "pkg-1.21.9-1.9.3" = _zRWNQgVn;
        "pkg-1.21.10-1.9.3" = _um8ezUd0;
        "pkg-1.21.11-1.9.3" = _enBYmgO9;
        "pkg-1.10.2-1.9.4" = _dlDRq8EX;
        "pkg-1.11.2-1.9.4" = _IbEUwckC;
        "pkg-1.7.10-1.9.4" = _3EhyxmgD;
        "pkg-1.8.9-1.9.4" = _30BxIUjC;
        "pkg-1.12.2-1.9.4" = _ydyue0bs;
        "pkg-1.9.4-1.9.4" = _LENHAwkf;
        "pkg-1.14.4-1.9.4" = _NtAEUbI8;
        "pkg-1.15.2-1.9.4" = _rxlZxFDL;
        "pkg-1.16.5-1.9.4" = _xcE37NdE;
        "pkg-1.17.1-1.9.4" = _wWaxWACK;
        "pkg-1.18.2-1.9.4" = _eqY7e9mt;
        "pkg-1.19.4-1.9.4" = _64lPAxa1;
        "pkg-1.20.6-1.9.4" = _zwFUMxoW;
        "pkg-1.21.11-1.9.4" = _bXWEXqmj;
        "pkg-26.1-snapshot-9-1.9.4" = _Oc3lNLqi;
        "pkg-26.1-snapshot-10-1.9.4" = _rE2nYaGl;
        "pkg-26.1-snapshot-11-1.9.4" = _uO0nse7q;
        "pkg-26.1-pre-1-1.9.4" = _uamR2p0n;
        "pkg-26.1-pre-2-1.9.4" = _6YoGlbkp;
        "pkg-26.1-1.9.4" = _iu4kve3F;
        "pkg-1.12.2-1.10.0" = _Y6lCLd5c;
        "pkg-1.11.2-1.10.0" = _nxByhBEp;
        "pkg-1.14.4-1.10.0" = _HZAmKiNB;
        "pkg-1.15.2-1.10.0" = _bbXsQUpj;
        "pkg-1.16.5-1.10.0" = _JmmerDK7;
        "pkg-1.17.1-1.10.0" = _Fdn9LGPL;
        "pkg-1.18.2-1.10.0" = _Zm3prd8v;
        "pkg-1.19.4-1.10.0" = _LUTXo0wO;
        "pkg-1.20.6-1.10.0" = _6zrqdox2;
        "pkg-1.21.11-1.10.0" = _8P7f2GQY;
        "pkg-1.10.2-1.10.0" = _PtCAg3mH;
        "pkg-1.7.10-1.10.0" = _dz1P4NBZ;
        "pkg-1.8.9-1.10.0" = _pibNAqrr;
        "pkg-1.9.4-1.10.0" = _E9feDqXu;
        "pkg-26.1-1.10.0" = _XqJOgQrO;
        "pkg-1.10.2-1.10.1" = _siFxf0nb;
        "pkg-1.11.2-1.10.1" = _SukxkxTc;
        "pkg-1.12.2-1.10.1" = _loQUiSEb;
        "pkg-1.15.2-1.10.1" = _ldrcXHHW;
        "pkg-1.14.4-1.10.1" = _4yHteMLh;
        "pkg-1.16.5-1.10.1" = _uBhz7cWs;
        "pkg-1.18.2-1.10.1" = _YmAXruL3;
        "pkg-1.19.4-1.10.1" = _TI39k64I;
        "pkg-1.17.1-1.10.1" = _H2B2sIaV;
        "pkg-1.20.6-1.10.1" = _ZaUn0x93;
        "pkg-26.1-1.10.1" = _3rrRchv4;
        "pkg-26.2-1.10.1" = _JRDRBJs2;
        "pkg-1.7.10-1.10.1" = _YUWFpkPe;
