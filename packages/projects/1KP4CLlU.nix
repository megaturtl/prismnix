...
let
    versions = (let
        ...
        _VQc7E5Ea = {
            "id" = "VQc7E5Ea";
            "file" = "CobblemonWikiGui-fabric-2.6.0+1.21.1.jar";
            "hash" = "sha512-FCgHnSkNho2GrMUFscNPKc2WYQ3y68/0SHioYB2oLEWxLjUQpBYQfXX+eb8dbvF+7JKf4nU6w3w2jqz4+vkiEA==";
        };
        _vo24atkv = {
            "id" = "vo24atkv";
    ...
    in {
        ...
        "pkg-2.0.1" = _7t9h8c9M;
        "pkg-2.0.2" = _sHAPdzuQ;
        "pkg-2.1.1+1.21.1" = _CNIrAD9A;
        "pkg-2.2.0+1.21.1" = _fGfKpxHj;
        "pkg-2.2.1+1.21.1" = _jKK1HqWB;
        "pkg-2.3.1+1.21.1" = _IQqcXrUg;
