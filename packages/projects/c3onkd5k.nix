...
let
    versions = (let
        ...
        _BpaicOhU = {
            "id" = "BpaicOhU";
            "file" = "AsyncParticles-21.11.2.0-alpha.2+1.21.11.jar";
            "hash" = "sha512-N7Org2DbOJaY7jjb8tl0s2CJtrL7zIy1LnlG58/OVhQJDT6q1gStNB4OK/dIU2s7lwX2KASYDWtTtR7kCwNqLg==";
        };
        _OjIpzAXV = {
            "id" = "OjIpzAXV";
            "file" = "AsyncParticles-21.11.2.0-alpha.3+1.21.11.jar";
            "hash" = "sha512-mVEjv0wI4pGthTyWMMFF2IloN1P6u2sp9pxBW5XDSF4Zo8x9RcYCHUHUNDrTeT+os9b68fdKRVC/Ztm61hqtOA==";
        };
        _jN4f0mPv = {
            "id" = "jN4f0mPv";
            "file" = "AsyncParticles-26.2.2.0-beta.5+26.2.jar";
            "hash" = "sha512-b18EYrfe7hQHKjoKedUzz1HIX2HJxtj5nng3sIkpxbBlwoXE+ni+Q+OWyUouHcSJ5gmQnU9eYEQDSXiAEO8TXw==";
        };
        _cVLK8GQq = {
            "id" = "cVLK8GQq";
            "file" = "AsyncParticles-26.1.2.0-beta.5+26.1.2.jar";
            "hash" = "sha512-9I094mUV3LgeM+W/e7CpCB3XbRKw27UVMhw7yqlSVpMczFV1Mxc47ija7l/ZyvvoWCMC9UNX1GRM2YXrOo1NXg==";
        };
        _zynr9lIO = {
            "id" = "zynr9lIO";
            "file" = "AsyncParticles-21.11.2.0-beta.1+1.21.11.jar";
            "hash" = "sha512-qVBiwmzUMByIBWo14xCbn3MpvY6REmQ5ElxyX2rhikjEwY+Yopu2XZ60VTNBCm1ENz0qNhbzoNzcQn7D34r2Nw==";
        };
        _C3vI0txX = {
            "id" = "C3vI0txX";
            "file" = "AsyncParticles-21.1.4.0-alpha.1+1.21.1.jar";
            "hash" = "sha512-oNj5Ut/INoImxlvYSXnnZaNjXuFdmJx+0/XByfPSz+IpantE0mQm4N8yfFhIe6SKnbjWnYBzKatQLtcBmjhe2A==";
        };
        _Rn6KCyEA = {
            "id" = "Rn6KCyEA";
            "file" = "AsyncParticles-20.1.3.2+1.20.1.jar";
            "hash" = "sha512-PXIaQZUh8CmuIuhC6Ni2DanoDYAuLvuzu+m8cn/1aynRQqCyvOLZXSujBNQaFP4+MBZwq/sauCurXVLaG02jQA==";
        };
        _lcE6m2Tf = {
            "id" = "lcE6m2Tf";
            "file" = "AsyncParticles-21.1.3.2+1.21.1.jar";
            "hash" = "sha512-vT7MXxWv/+6ndvTUkIOBC4EGveK9WRtJ98FDocVeDuedqY5LHo3Nrt9igtcFuPs/kD6s6jF0GbDuNDoHl1YcYA==";
        };
        _7RpzrsVT = {
            "id" = "7RpzrsVT";
            "file" = "AsyncParticles-21.1.4.0-alpha.2+1.21.1.jar";
            "hash" = "sha512-WbnIW/xEkSvkqTKCdN+3BVepEbHUDbufw+JSPL/JzlxWsbdSS1256ySeZEyQf6ilBujCBGGh+M3EgaUk/9ANEA==";
        };
        _mFa4Mr1s = {
            "id" = "mFa4Mr1s";
            "file" = "AsyncParticles-21.11.2.0-beta.2+1.21.11.jar";
            "hash" = "sha512-2gExRoLvHIFLLcULVCd7meZ3xPAnMjeWD1hEagjQKyZdl6K5tDQfYGM27RKwAQTZNE8dJK2qhgTFzkbhvPpx1Q==";
        };
        _5PcaAeu8 = {
            "id" = "5PcaAeu8";
            "file" = "AsyncParticles-26.1.2.0+26.1.2.jar";
            "hash" = "sha512-XLYmvkz2n5zK+QrKuCCGr9DNAQZpq0zeK8Qge5PgXSZrpBEa9poE7E/KGWX3IAkfm+4T8CGApyw1asyTiV+3Dw==";
        };
        _HyCAqI5S = {
            "id" = "HyCAqI5S";
            "file" = "AsyncParticles-26.2.2.0+26.2.jar";
            "hash" = "sha512-Aav/6wcL6mFBV7zO666sWvoQUL3uLSMGJrfUF5Hs4+9Eo7x2CpwsLKYZNjE6qH8iPIkWy98XoXGUo9z7pnT0hw==";
        };
        _vzqR5Mv4 = {
            "id" = "vzqR5Mv4";
            "file" = "AsyncParticles-21.1.4.0-alpha.3+1.21.1.jar";
            "hash" = "sha512-8gRRWvz7CBiVRfDdVI7/rqLHhpbtwZVjdcYmA1tkQugcXzewEEw/d9OPyLyjrK7X2fzFaS+ewES8MsJW8+6hsg==";
        };
        _SnE4O1Sk = {
            "id" = "SnE4O1Sk";
            "file" = "AsyncParticles-0.26.3.2-alpha.1+26.3-snapshot-7.jar";
            "hash" = "sha512-k0Q9Ar3ITqyi/U/rMCAMuBtiZ/IHk/aWqXeLqvnUCdDdZAZPozLVzPkiz8emJzFaflEhkerv0LPKWUhKrp6W7g==";
        };
        _D1mSZAeG = {
            "id" = "D1mSZAeG";
            "file" = "AsyncParticles-21.11.2.0-beta.3+1.21.11.jar";
            "hash" = "sha512-tuscjHj0Ri6Fh3tRiHesAMSZtG8nqhdZ4JeCIevN0DkmRX/6eOeIORj1FSOgA9NV2P0N5zjLjZG631r0yG2jLA==";
        };
        _2A6ESaeL = {
            "id" = "2A6ESaeL";
            "file" = "AsyncParticles-26.2.2.1+26.2.jar";
            "hash" = "sha512-eHfcLr6JDh9oJ1/qNlXLAYCyoFietBUasJ6ogmVulY2/VucvfPOAST81t6LSSxtIitRQRGa7B2RnHEqTXM7alA==";
        };
        _ri5uXTny = {
            "id" = "ri5uXTny";
            "file" = "AsyncParticles-26.2.2.2+26.2.jar";
            "hash" = "sha512-Kra//WpislvfSqrqIifMReKMC5syCNBD3/dxJySfDLstNejaAccjXhLGUbNxd8Mzg3INXHSaLmVGhBiygRLmzA==";
        };
        _EaR2MMaZ = {
            "id" = "EaR2MMaZ";
            "file" = "AsyncParticles-26.1.2.2+26.1.2.jar";
            "hash" = "sha512-z49RaGFKHl5wCLS8FCu8/99azidguDn2FGxc3x/j3KNb8FmoI67xXTd+6SLBbjBphqYgG1gEvrWJdt0O3K9txA==";
        };
        _KGTXl2gp = {
            "id" = "KGTXl2gp";
            "file" = "AsyncParticles-21.11.2.0+1.21.11.jar";
            "hash" = "sha512-4mrjDFo0LIw37xzEOfTgWu41ccEQBgZCXJH8IBC/fBzYV2SamxO0+aZXKaAA/SykPQ2qKVjuldFeSGIaUma9bw==";
        };
        _FqzL1Oxn = {
            "id" = "FqzL1Oxn";
            "file" = "AsyncParticles-21.1.4.0-beta.1+1.21.1.jar";
            "hash" = "sha512-xw/iq26jdoJv01UVnlailNIhwDPqB7jmIBb/kPzcm3qZwWWcisKaN+DscPxCYlhcmtM7qgNXb+qepVuCAIL/Og==";
        };
        _OIgessVa = {
            "id" = "OIgessVa";
            "file" = "AsyncParticles-21.1.4.0-beta.2+1.21.1.jar";
            "hash" = "sha512-6Rl5G3mWRcpdvfY14I6q2paS2qAPHu+u+lNRKe7jwvO/7SmdCgCj+SZ+siGMvfDIHoldhd30iE/0+8YzSKknzQ==";
        };
        _TdnxG0DS = {
            "id" = "TdnxG0DS";
            "file" = "AsyncParticles-26.1.2.3+26.1.2.jar";
            "hash" = "sha512-JcOehFjtPlvW6S9dZsMMZoAt0w5LcWopROfRViKMCPcaRxuFMwsECke1AseLHprr9iE5dHFYc07jLNY6aTeDbw==";
        };
        _F3316JMF = {
            "id" = "F3316JMF";
            "file" = "AsyncParticles-26.2.2.3+26.2.jar";
            "hash" = "sha512-iZASwM3D33nKj7sOeVed5Fo9sWYdsPaKAirEEkj/ubZ0P+jfASfbF1PreaPmVOLXb52akVSzuT5T/WS2F1Ur5Q==";
        };
        _ZZ5jkIju = {
            "id" = "ZZ5jkIju";
            "file" = "AsyncParticles-21.11.2.1+1.21.11.jar";
            "hash" = "sha512-+4Zb62ktOlX1ADtL9LpXGgGD1qj2IFywq/3J4WgKudddkrLsjvxYUj+Gnj5uR+2c0ku+iGZtHIcIawefKEzDQg==";
        };
        _Ud6nJPSI = {
            "id" = "Ud6nJPSI";
            "file" = "AsyncParticles-21.1.4.0-beta.3+1.21.1.jar";
            "hash" = "sha512-GfgnfbDeiFydQBfHnn9jUHYI8HjN+vFi3b59cpNm511FvY/qHfNRb0dcVaQ0GEf4MdqeMMas1xCnhKitY6j3XA==";
        };
        _kYGjOhQZ = {
            "id" = "kYGjOhQZ";
            "file" = "AsyncParticles-26.2.2.4+26.2.jar";
            "hash" = "sha512-/xGytiPoIIEfZKsTWBaE/XN5RipIJDoV37ZuNPftd0mzZKOpSA12PA1DhqJOcL49ajRsmamzNje6Gdmr4wHsBQ==";
        };
        _L5jlJraJ = {
            "id" = "L5jlJraJ";
            "file" = "AsyncParticles-26.2.2.5+26.2.jar";
            "hash" = "sha512-JNHQVd1a8PtsnDyLbs5UfRZadUP8Mn4ARM9blQmc62yfRObDiu/djBbmGjeZVeE1w8lLIq8lMVhCa2sIP8U0Fw==";
        };
        _szr161SB = {
            "id" = "szr161SB";
            "file" = "AsyncParticles-26.2.2.6+26.2.jar";
            "hash" = "sha512-mfqz2Ce1i7dcdwEFwc7LQ2GUfjmn+/faHOVC45R05GJy+GizYDDKd4bLbtR8o0ej67+NpaFWJ2twkb1u4Y0z5g==";
        };
        _7L21YUhq = {
            "id" = "7L21YUhq";
            "file" = "AsyncParticles-26.1.2.4+26.1.2.jar";
            "hash" = "sha512-JQBhL98uJHizF/vjwhmcaC7NhA26fVMl8iqY5WjoEqLBuXcao7PfCOv5oZufoQJW5go/kQeWaW6VFSq1pqiN3g==";
        };
        _r3k62fqH = {
            "id" = "r3k62fqH";
            "file" = "AsyncParticles-21.11.2.2+1.21.11.jar";
            "hash" = "sha512-JOKj/6NXypupsoemNLQlWdyh/KzcFt3D1Hkee9nsb42RagxiXypF5A5gMH3Vt7aN93aWaTbu0czKfV1L0ixIxQ==";
        };
        _VOO9rtUe = {
            "id" = "VOO9rtUe";
            "file" = "AsyncParticles-21.1.4.0+1.21.1.jar";
            "hash" = "sha512-+70+WbqLXLy3P+9NhNNUPcuYynLucyuYm0X/ROApvN9P452d9EO4WJYxpecEkbgP2wZPho0RygTjSmOHd0llaQ==";
        };
        _QWk2QBEL = {
            "id" = "QWk2QBEL";
            "file" = "AsyncParticles-26.1.2.5+26.1.2.jar";
            "hash" = "sha512-uYpIqg6woyTqL9mOGTcsQgtTx1wd9Kxl4e3rBsg3s5oZIsxU5kiqvUQt5Gb9JnN4Ow0TyX0U4SwjuCten2PdDw==";
        };
        _uUUf6nG8 = {
            "id" = "uUUf6nG8";
            "file" = "AsyncParticles-21.11.2.3+1.21.11.jar";
            "hash" = "sha512-tFb8/uoTu3plF8Mc3O+EZaIxC8sClW/rNaQAqJbKrGuIW6pPCVU+Ija5meJ0xk2YfbC1qdq/riPL73vRN2V8XA==";
        };
        _7WzzmoU1 = {
            "id" = "7WzzmoU1";
            "file" = "AsyncParticles-21.1.4.1+1.21.1.jar";
            "hash" = "sha512-D9896rr9vLe/cBJjRrTFYuTfr8rzXtm9emkq9pysMq5J8na9oDQHGJsQ+31+f2d0EJ2EkbtjO1n1oWhjTne2aQ==";
        };
        _cZlMsidn = {
            "id" = "cZlMsidn";
            "file" = "AsyncParticles-20.1.4.0-alpha.1+1.20.1.jar";
            "hash" = "sha512-Yv0Mvqb93WS8D5CVQs6xkwLFOqo34aeqiOrVg6/wQWY+KkPojxd4fyCLTsRx3LQi/GVQ2DzhwW8jcjgwoqbeGQ==";
        };
        _bkbTg1H0 = {
            "id" = "bkbTg1H0";
            "file" = "AsyncParticles-26.2.2.7+26.2.jar";
            "hash" = "sha512-pybpvY7jZrXoqQzUbZA2Atk9MFMQrK3kqDmaT3ViM10yk0GB/AHtKAIM3Aci7+SsZHTyvyfRFRRxU31UsYXBYQ==";
        };
        _gZ3CwIND = {
            "id" = "gZ3CwIND";
            "file" = "AsyncParticles-20.1.4.0-alpha.2+1.20.1.jar";
            "hash" = "sha512-ytN7WKmi2GLdCpCcY3647JBvFLTQrL+VqvNJcYsCSdhgMF/qE+spt/qy7WM6stnx6N9xYY3NNVF0clEJfpzVrw==";
        };
        _ETOL0nJ5 = {
            "id" = "ETOL0nJ5";
            "file" = "AsyncParticles-20.1.4.0-alpha.3+1.20.1.jar";
            "hash" = "sha512-SAyZt3CDw3JBIaYULw/8zPll1kzEjyNmAX2Gv8HrmsPE342Iqby72hRfRvy2jkLC6P2GQLgPtjvU2qYc9Rm81A==";
        };
        _F4cmZuc5 = {
            "id" = "F4cmZuc5";
            "file" = "AsyncParticles-21.11.2.4+1.21.11.jar";
            "hash" = "sha512-nnqtzzg2t5TUf8MxE+ec+ku8zxkSQAgN2IX79NvLT55L3kDDqzg36ZDVP0hLNqqhQyZ6yYMB0XHxB15O7aOiEQ==";
        };
        _jzINJqac = {
            "id" = "jzINJqac";
            "file" = "AsyncParticles-20.1.4.0-alpha.4+1.20.1.jar";
            "hash" = "sha512-JXR4RlWkyycd+sb5lYrcdjCbNn/j9PEf1kOs7ZZY/vL5uNgnuMtwDdUJJqv0rpNs1OmuHPrH798Q6yIwWIaVIw==";
        };
        _nLg9cJcl = {
            "id" = "nLg9cJcl";
            "file" = "AsyncParticles-21.1.4.2+1.21.1.jar";
            "hash" = "sha512-vTfugM8ml5VmOBa3uATZpw59mHx8BRIighFExUJsyPjCEX0gvSi9aNModiyWfG4S48+oWijnu0KLlwGkXwEsSQ==";
        };
        _3aBvIJ6g = {
            "id" = "3aBvIJ6g";
            "file" = "AsyncParticles-26.1.2.6+26.1.2.jar";
            "hash" = "sha512-94pVYk71r+i/24A2o7uh2m5Pqv0t8qal45pJ3OjjBYapele9uXqrVv+D7goB9NZybpCxZgCvL7XE2MShcRbdEw==";
        };
        _O3SGLe1O = {
            "id" = "O3SGLe1O";
            "file" = "AsyncParticles-26.2.2.8+26.2.jar";
            "hash" = "sha512-GsyqLISS4RZbVxeaCQVyPNMYjwPRwBQQkZx0H8vr/IQvNOdarEO/mHSoXPHDkxrw329QITdU2uW93dfmfpzDeQ==";
        };
        _LEDbqv6s = {
            "id" = "LEDbqv6s";
            "file" = "AsyncParticles-20.1.4.0-beta.1+1.20.1.jar";
            "hash" = "sha512-FdzHipjK1S8X9p1B8VZMoXUJV+v6NmdynGgUQ6gRei9+fCpPKLvkCL7e8Af/ZyjJFFmn7ThcGpXnLNQkn4v4yg==";
        };
        _dKeyfEt6 = {
            "id" = "dKeyfEt6";
            "file" = "AsyncParticles-20.1.4.0-beta.2+1.20.1.jar";
            "hash" = "sha512-xDwedPudyUoUUHTtqOJl0J8Wwf/NLAWuvBhJTXKGhahzuTahEhqsLmqDMcDOFJ5iH27yPXF3XPH1NrRLSbw9jQ==";
        };
        _XSJqRIfd = {
            "id" = "XSJqRIfd";
            "file" = "AsyncParticles-21.1.4.3+1.21.1.jar";
            "hash" = "sha512-yVTpuBdqkckA7LAd10qGaRyso7ygoVGRHTErgy/gAUhjEQD97D1GBDp9eXXVzxOyMYmoQ8NN3UpGiUgILEqCtQ==";
        };
        _wBRFvEjL = {
            "id" = "wBRFvEjL";
            "file" = "AsyncParticles-21.11.2.5+1.21.11.jar";
            "hash" = "sha512-LGp6ZZXEP8UqucyybZNvXszVovnQC3rx2R6zkoTN4tiRpacZX4GFvr+mqTtCd9eKP2pBNdAldFHvHHymT84DKQ==";
        };
        _Vm2hdeqZ = {
            "id" = "Vm2hdeqZ";
            "file" = "AsyncParticles-26.1.2.7+26.1.2.jar";
            "hash" = "sha512-0uUdLbAOXLiHPyVKVdVttfOL31i2aZN8iGfViEZfYD1j7IlKsQDDw5e64et5RD19J9kMBvZNpvMYHR0GThIatQ==";
        };
        _HHsV3CjV = {
            "id" = "HHsV3CjV";
            "file" = "AsyncParticles-26.2.2.9+26.2.jar";
            "hash" = "sha512-fO9i14nmU6jz7Zm0pwxg44pEkEtH46/VXMUdgCU43Ow+vR0WxmLvlpjP4mc8cFXcsMhiXr5nVx3P5lDo5lMAdQ==";
        };
        _FmbchDVp = {
            "id" = "FmbchDVp";
            "file" = "AsyncParticles-0.26.3.2-alpha.3+26.3-rc-3.jar";
            "hash" = "sha512-p+2eavojh5lMD/MtMXwNV3OLEjatvTxaWvc6G+gUB7bqj1swBwJedvYdjg415K2Qpd8es+D3zCtm9yB0sv3cgg==";
        };
        _Hpz1ce2W = {
            "id" = "Hpz1ce2W";
            "file" = "AsyncParticles-26.3.2.0-alpha.1+26.3.jar";
            "hash" = "sha512-Z/bkTUfoG+HOZzP/6SnpCcPMjcb+2Z7XJILErmIGZYUHTB9chR8kOjr1hXK4uKOJFJeVY0tnyvO+y99mI3jTZA==";
        };
        _KE9oULCD = {
            "id" = "KE9oULCD";
            "file" = "AsyncParticles-21.1.4.4+1.21.1.jar";
            "hash" = "sha512-56bZqCKCmA9WeIunSViaWqY9BIQ+/7fEl691RvATGmxDsm+f5rJiVFPzN1vBpHJaYSTRo9civE5bgOFt2RYv2w==";
        };
        _56Y3sdzw = {
            "id" = "56Y3sdzw";
    ...
    in {
        ...
        "pkg-1.7.0+1.20.1-beta.2" = _rmBUK5TD;
        "pkg-1.7.0+1.20.1" = _25olDMmF;
        "pkg-1.7.2+1.20.1" = _QeKzPVr8;
        "pkg-1.7.3+1.20.1" = _K1GZWdK4;
        "pkg-1.8.0+1.20.1-beta.0" = _xUFiR3Ng;
        "pkg-1.8.0+1.21.1-beta.0" = _YmW57sfb;
        "pkg-1.8.0+1.21.1-beta.1" = _LP5Upif8;
        "pkg-1.8.0+1.20.1-beta.4" = _LxKX2ma3;
        "pkg-1.8.0+1.20.1-beta.5" = _hUHyZMOH;
        "pkg-1.8.0+1.21.1-beta.2" = _Lwzs7am4;
        "pkg-1.8.0+1.20.1-beta.6" = _elBPIUJj;
        "pkg-1.8.0+1.21.1-beta.3" = _J4kysBXM;
        "pkg-1.9.0+1.20.1-alpha.0" = _JYKp2XT9;
        "pkg-1.9.0+1.21.1-alpha.0" = _L2qVDKPM;
        "pkg-1.9.0+1.20.1-alpha.1" = _Dj3071Pe;
        "pkg-1.9.0+1.20.1-beta.0" = _wA11CH6Z;
        "pkg-1.9.0+1.20.1-beta.1" = _4U276uN1;
        "pkg-1.9.0+1.20.1-beta.3" = _ilvCynIN;
        "pkg-1.9.0+1.20.1-beta.5" = _pKd9eUnS;
        "pkg-1.9.0+1.20.1-beta.6" = _Q5FIwUyp;
        "pkg-1.10.0+1.20.1-alpha.0" = _Ab2WPVLh;
        "pkg-1.10.0+1.21.1-alpha.0" = _WZofIyh1;
        "pkg-1.10.0+1.21.1-alpha.1" = _T1KY4zKz;
        "pkg-1.10.0+1.21.1-alpha.2" = _Jtfa7Qzr;
        "pkg-1.10.0+1.21.1-alpha.3" = _yf2JaL37;
        "pkg-1.10.0+1.20.1-alpha.3" = _gl3bVA0N;
        "pkg-1.10.0+1.20.1-alpha.5" = _7USsfQf5;
        "pkg-1.10.0+1.21.1-alpha.5" = _OuDmzUC2;
        "pkg-1.11.0+1.21.4-alpha.0" = _NzSjFccS;
        "pkg-1.10.0+1.20.1-beta.0" = _ZVSShuYF;
        "pkg-1.10.0+1.21.1-beta.0" = _80dPB3NY;
        "pkg-1.11.0+1.21.4-alpha.1" = _UQ80Z4Wn;
        "pkg-1.11.1+1.21.4-alpha.0" = _H8uOH6Hh;
        "pkg-1.10.1+1.20.1-alpha.0" = _Fb6lse2U;
        "pkg-1.11.1+1.21.4-alpha.1" = _4l5A5DHc;
        "pkg-1.10.1+1.21.1-alpha.1" = _h3EAInhK;
        "pkg-1.10.1+1.20.1-alpha.1" = _Ri9J2NjN;
        "pkg-1.10.1+1.21.1-alpha.2" = _Ik4AW1lS;
        "pkg-1.10.1+1.20.1-alpha.3" = _CYP88Fx3;
        "pkg-1.10.1+1.20.1-alpha.4" = _EXZXwlmA;
        "pkg-1.10.1+1.21.1-alpha.3" = _OnJzACWG;
        "pkg-1.10.1+1.20.1-alpha.5" = _X6GiffYd;
        "pkg-1.10.1+1.21.1-alpha.4" = _4jfoWM7s;
        "pkg-1.11.1+1.21.4-alpha.3" = _cAELBsZd;
        "pkg-1.12.0+1.21.5-alpha.0" = _D6WkrxC2;
        "pkg-1.10.1+1.21.1-alpha.5" = _EnOTH0H3;
        "pkg-1.10.1+1.20.1-alpha.6" = _DJhFoLAC;
        "pkg-1.10.1+1.21.1-alpha.6" = _dGwV47Sg;
        "pkg-1.10.1+1.20.1-beta.0" = _VBX7IqP3;
        "pkg-1.10.1+1.20.1-beta.1" = _dPUWLAPK;
        "pkg-1.10.1+1.20.1-beta.3" = _WncOOgOA;
        "pkg-1.12.0+1.21.5-beta.0" = _Qo90KW3p;
        "pkg-1.10.1+1.21.1-beta.0" = _In74VlKT;
        "pkg-1.11.1+1.21.4-beta.0" = _VnZ0RxzK;
        "pkg-2.0.0-alpha.2" = _RY1wrbWj;
        "pkg-2.0.0-alpha.3" = _zOjLLzf8;
        "pkg-2.0.0-alpha.4" = _zrJfc1FX;
        "pkg-2.0.0-alpha.5" = _GashWdXP;
        "pkg-3.0.0-alpha.0" = _KmKXNNqB;
        "pkg-2.0.0-beta.1" = _xs0pllhY;
        "pkg-3.0.0-alpha.1" = _UFzR6tt9;
        "pkg-3.0.0-alpha.2" = _fOktEzSD;
        "pkg-3.0.0-alpha.3" = _10X3oGZ4;
        "pkg-2.0.0-beta.2" = _x6y292dD;
        "pkg-2.0.0-beta.4" = _J6vw3OeP;
        "pkg-3.0.0-alpha.5" = _ZbvOKmXa;
        "pkg-1.12.0+1.21.5-beta.1" = _2FdCDXhK;
        "pkg-2.0.0" = _y7dhdY89;
        "pkg-2.1.0-alpha.0" = _JFNKCb5w;
        "pkg-3.0.0-alpha.8" = _pBjRGnol;
        "pkg-2.1.0-alpha.1" = _g5cJ47ms;
        "pkg-3.1.0-alpha.0" = _iSvaW72U;
        "pkg-2.1.0-alpha.2" = _sAsBNuhH;
        "pkg-2.1.0-alpha.3" = _aVScZPC4;
        "pkg-3.1.0-alpha.1" = _nMWFPVBN;
        "pkg-2.0.1" = _CQgeGZ8p;
        "pkg-3.1.0-alpha.3" = _o1asTp1p;
        "pkg-2.1.0-alpha.5" = _RCDPNITp;
        "pkg-3.1.0-alpha.4" = _fv8xsU73;
        "pkg-2.1.0-alpha.6" = _JB9j92XN;
        "pkg-6.0.0-alpha.0" = _HNfz0uex;
        "pkg-3.1.0-alpha.5" = _mTBWSpqt;
        "pkg-2.1.0-beta.0" = _tfrnyzL4;
        "pkg-3.1.0-beta.0" = _JrhbnNI5;
        "pkg-6.0.0-alpha.1" = _vforDqQY;
        "pkg-2.1.0-beta.1" = _BnewmcrP;
        "pkg-3.1.0-beta.1" = _t4GaF7IZ;
        "pkg-6.0.0-alpha.2" = _w2BR3J4G;
        "pkg-6.0.0-alpha.3" = _qyxE251P;
        "pkg-6.0.0-beta.0" = _NYskHpT9;
        "pkg-2.1.0-beta.2" = _vxb5IEOL;
        "pkg-3.1.0-beta.2" = _eDfmlAqP;
        "pkg-6.0.0-beta.1" = _nXanvceH;
        "pkg-5.0.0-alpha.0" = _BXVqeU3F;
        "pkg-6.0.0-beta.2" = _MSKZ4MVN;
        "pkg-5.1.0-alpha.1" = _RF9yO7jQ;
        "pkg-6.1.0-alpha.1" = _oMjNCvCb;
        "pkg-5.1.0-alpha.2" = _9TR5KLDj;
        "pkg-6.1.0-alpha.2" = _4VlSFCIV;
        "pkg-5.3.0-alpha.1" = _7GcXDRUc;
        "pkg-5.3.0-alpha.2" = _c41R8DP0;
        "pkg-6.3.0-alpha.0" = _QaVUWsum;
        "pkg-2.1.0-beta.3" = _1NZ9lCVN;
        "pkg-3.1.0-beta.3" = _TNims1cf;
        "pkg-2.1.0-beta.4" = _GDHnD0Kf;
        "pkg-3.1.0-beta.4" = _roKkU7f0;
        "pkg-6.3.0-beta.0" = _L0Yw2Ggl;
        "pkg-5.3.0-beta.0" = _tyCQdUJG;
        "pkg-3.3.0-alpha.1" = _kjUJC3og;
        "pkg-2.3.0-alpha.1" = _gvitgjZ7;
        "pkg-6.3.0-beta.1" = _m5ihuBI2;
        "pkg-5.3.0-beta.1" = _IoG7QPch;
        "pkg-3.3.0-alpha.2" = _8WpejjYC;
        "pkg-2.3.0-alpha.3" = _O88HZDJk;
        "pkg-2.3.0-alpha.5" = _NOr5XBAJ;
        "pkg-2.3.0-beta.1" = _Rw8zhLsj;
        "pkg-3.3.0-beta.1" = _M7LrHYbv;
        "pkg-2.3.0-beta.2" = _EbqWmNk8;
        "pkg-3.3.0-beta.2" = _Uig5KFEC;
        "pkg-3.3.0-beta.3" = _Zt1nBAHl;
        "pkg-2.3.0-beta.3" = _dXqZ2lAe;
        "pkg-3.3.1" = _XzTclZgt;
        "pkg-2.3.1" = _tlmDwhlu;
        "pkg-3.3.2" = _hL6pWPFx;
        "pkg-2.3.2" = _bMrYtA1B;
        "pkg-5.3.0-beta.2" = _8jF3UUaI;
        "pkg-6.3.0-beta.2" = _NV7cBXlf;
        "pkg-2.3.3" = _fzBFtziy;
        "pkg-3.3.3" = _YyMbbXq2;
        "pkg-5.3.0-beta.3" = _huadcfDs;
        "pkg-6.3.0-beta.3" = _OGzW4VvP;
        "pkg-3.3.4" = _I98qnGgb;
        "pkg-2.3.4" = _CtRUEez6;
        "pkg-3.3.5" = _t30k6bNj;
        "pkg-4.3.0-alpha.1" = _oterJoU9;
        "pkg-2.3.5" = _g7qmhXhX;
        "pkg-3.3.6" = _ci2Ivfpq;
        "pkg-6.3.0-beta.4" = _dUDRAGkw;
        "pkg-2.3.6" = _A5FtUkzN;
        "pkg-2.3.8" = _gN6qVovu;
        "pkg-3.3.8" = _Duibw1xy;
        "pkg-6.3.0-beta.5" = _MofPZHfD;
        "pkg-3.3.9" = _fO2PBbXs;
        "pkg-2.3.9" = _hhkbgym1;
        "pkg-2.5.0-alpha.1" = _1xZyduVD;
        "pkg-3.3.10" = _JtgP37Nd;
        "pkg-2.3.10" = _MKOpuiee;
        "pkg-6.3.0-beta.6" = _PIJBnJod;
        "pkg-4.3.0-beta.1" = _ecAkl6hy;
        "pkg-5.3.0-beta.4" = _JxRiVJZZ;
        "pkg-0.7.0-alpha.1" = _ocstIgVp;
        "pkg-0.7.1-alpha" = _Qo0vedFK;
        "pkg-2.3.11" = _Pfs1oah7;
        "pkg-3.3.11" = _MQIPSR2v;
        "pkg-4.3.0" = _l3lpwKZl;
        "pkg-5.3.0" = _6w5WtEx2;
        "pkg-6.3.0" = _hln1vTm4;
        "pkg-2.4.0-beta.1" = _61Y0CHrM;
        "pkg-2.4.0-beta.2" = _kjrEjJCQ;
        "pkg-3.4.0-beta.1" = _EU69gnPW;
        "pkg-2.4.0-beta.3" = _bw4JNVwQ;
        "pkg-21.1.0a-alpha.1" = _LPHEes03;
        "pkg-21.1.0a-alpha.2" = _75Alisdy;
        "pkg-21.1.0a-beta.1" = _TzVHV1wo;
        "pkg-21.1.0a-beta.3" = _lXJOBA0N;
        "pkg-21.1.0a-beta.4" = _evvHCHHy;
        "pkg-0.8.0-alpha" = _vWCubM5V;
        "pkg-21.1.0a-beta.5" = _2W7KDwqH;
        "pkg-21.1.0a-beta.6" = _go3XMPJ9;
        "pkg-21.1.0b-alpha.1" = _eQxbvr3s;
        "pkg-21.1.0b-alpha.2" = _kKk6Yka7;
        "pkg-21.1.0b-alpha.3" = _DJHVmfwT;
        "pkg-20.1.0b-alpha.1" = _Q9Y0awt1;
        "pkg-21.1.0b-beta.1" = _qmJ9MXgo;
        "pkg-20.1.0b-beta.1" = _mIe0dM6e;
        "pkg-20.1.0b-beta.2" = _gLESgg50;
        "pkg-21.1.0b-beta.2" = _bEN52IuM;
        "pkg-26.1.0b-alpha.1" = _yBox8JvY;
        "pkg-26.1.0b-alpha.2" = _BTWHhpDw;
        "pkg-26.1.0b-alpha.3" = _D1K9YOx5;
        "pkg-20.1.0b-beta.3" = _8PKxrwh2;
        "pkg-21.1.0b-beta.3" = _becFuun6;
        "pkg-21.1.0b-beta.4" = _PaluzAZB;
        "pkg-20.1.0b-beta.4" = _z2b81Gt2;
        "pkg-26.1.0c-alpha.1" = _yA8MFtEw;
        "pkg-26.2.0c-alpha.1" = _FR4AORKf;
        "pkg-26.2.0c-alpha.2" = _whW1kOFY;
        "pkg-21.1.0b-beta.5" = _NnRFaCfN;
        "pkg-20.1.0b-beta.5" = _rVti7omL;
        "pkg-26.2.0c-alpha.3" = _VhA1qbV5;
        "pkg-26.1.0c-alpha.2" = _CDXdRCeA;
        "pkg-20.1.0b-beta.6" = _4NOk7ScV;
        "pkg-26.1.0c-alpha.3" = _IHCcNoKS;
        "pkg-26.2.0c-alpha.4" = _UJRx0vl8;
        "pkg-20.1.0c-beta.1" = _S60xhg4G;
        "pkg-21.1.0c-beta.1" = _3kpHm4yI;
        "pkg-20.1.1.0" = _wp4ZoGlW;
        "pkg-21.1.1.0" = _4wFS3wW1;
        "pkg-26.1.1.0-beta.1" = _qOJC1MNz;
        "pkg-26.2.1.0-beta.1" = _StQJuIdE;
        "pkg-21.1.1.1" = _5FXNjntw;
        "pkg-20.1.1.1" = _rsrHxFzg;
        "pkg-26.2.1.0-beta.2" = _tAPjIsmr;
        "pkg-26.1.1.0-beta.2" = _WSbluQgq;
        "pkg-20.1.2.0" = _V2FtZSTv;
        "pkg-21.1.2.0" = _48dIg6pb;
        "pkg-20.1.3.0-beta.1" = _nny4ykGg;
        "pkg-21.1.3.0-beta.1" = _E1zhBDRN;
        "pkg-21.1.3.0-beta.2" = _J7LOVKnh;
        "pkg-20.1.3.0-beta.2" = _PJ9Fbm2V;
        "pkg-21.1.3.0-beta.3" = _mpruWmh5;
        "pkg-20.1.3.0-beta.3" = _8ZgypwqW;
        "pkg-20.1.3.0-beta.4" = _jD4N32uE;
        "pkg-21.1.3.0-beta.4" = _tE4uuafH;
        "pkg-26.1.2.0-alpha.1" = _p4BWcfrb;
        "pkg-26.2.2.0-alpha.1" = _GfLShKuo;
        "pkg-26.1.2.0-alpha.2" = _pf4owESb;
        "pkg-26.2.2.0-alpha.2" = _K4BFVy17;
        "pkg-26.2.2.0-alpha.3" = _UsFwzzjr;
        "pkg-26.1.2.0-alpha.3" = _3V56l7rl;
        "pkg-26.1.2.0-beta.1" = _vGSJbMOL;
        "pkg-26.2.2.0-beta.1" = _w3326mCR;
        "pkg-20.1.3.0" = _wN7mN60T;
        "pkg-21.1.3.0" = _NhjwLSEy;
        "pkg-21.11.2.0-alpha.1" = _A3XOifs4;
        "pkg-20.1.3.1" = _iOn7CXsA;
        "pkg-21.1.3.1" = _z7WoNZFA;
        "pkg-26.1.2.0-beta.2" = _uUhhBzdW;
        "pkg-26.2.2.0-beta.2" = _y6gNrKg9;
        "pkg-21.11.2.0-alpha.2" = _BpaicOhU;
        "pkg-21.11.2.0-alpha.3" = _OjIpzAXV;
        "pkg-26.2.2.0-beta.5" = _jN4f0mPv;
        "pkg-26.1.2.0-beta.5" = _cVLK8GQq;
        "pkg-21.11.2.0-beta.1" = _zynr9lIO;
        "pkg-21.1.4.0-alpha.1" = _C3vI0txX;
        "pkg-20.1.3.2" = _Rn6KCyEA;
        "pkg-21.1.3.2" = _lcE6m2Tf;
        "pkg-21.1.4.0-alpha.2" = _7RpzrsVT;
        "pkg-21.11.2.0-beta.2" = _mFa4Mr1s;
        "pkg-26.1.2.0" = _5PcaAeu8;
        "pkg-26.2.2.0" = _HyCAqI5S;
        "pkg-21.1.4.0-alpha.3" = _vzqR5Mv4;
        "pkg-0.26.3.2-alpha.1" = _SnE4O1Sk;
        "pkg-21.11.2.0-beta.3" = _D1mSZAeG;
        "pkg-26.2.2.1" = _2A6ESaeL;
        "pkg-26.2.2.2" = _ri5uXTny;
        "pkg-26.1.2.2" = _EaR2MMaZ;
        "pkg-21.11.2.0" = _KGTXl2gp;
        "pkg-21.1.4.0-beta.1" = _FqzL1Oxn;
        "pkg-21.1.4.0-beta.2" = _OIgessVa;
        "pkg-26.1.2.3" = _TdnxG0DS;
        "pkg-26.2.2.3" = _F3316JMF;
        "pkg-21.11.2.1" = _ZZ5jkIju;
        "pkg-21.1.4.0-beta.3" = _Ud6nJPSI;
        "pkg-26.2.2.4" = _kYGjOhQZ;
        "pkg-26.2.2.5" = _L5jlJraJ;
        "pkg-26.2.2.6" = _szr161SB;
        "pkg-26.1.2.4" = _7L21YUhq;
        "pkg-21.11.2.2" = _r3k62fqH;
        "pkg-21.1.4.0" = _VOO9rtUe;
        "pkg-26.1.2.5" = _QWk2QBEL;
        "pkg-21.11.2.3" = _uUUf6nG8;
        "pkg-21.1.4.1" = _7WzzmoU1;
        "pkg-20.1.4.0-alpha.1" = _cZlMsidn;
        "pkg-26.2.2.7" = _bkbTg1H0;
        "pkg-20.1.4.0-alpha.2" = _gZ3CwIND;
        "pkg-20.1.4.0-alpha.3" = _ETOL0nJ5;
        "pkg-21.11.2.4" = _F4cmZuc5;
        "pkg-20.1.4.0-alpha.4" = _jzINJqac;
        "pkg-21.1.4.2" = _nLg9cJcl;
        "pkg-26.1.2.6" = _3aBvIJ6g;
        "pkg-26.2.2.8" = _O3SGLe1O;
        "pkg-20.1.4.0-beta.1" = _LEDbqv6s;
        "pkg-20.1.4.0-beta.2" = _dKeyfEt6;
        "pkg-21.1.4.3" = _XSJqRIfd;
        "pkg-21.11.2.5" = _wBRFvEjL;
        "pkg-26.1.2.7" = _Vm2hdeqZ;
        "pkg-26.2.2.9" = _HHsV3CjV;
        "pkg-0.26.3.2-alpha.3" = _FmbchDVp;
