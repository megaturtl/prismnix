...
let
    versions = (let
        ...
        _RhD1njZh = {
            "id" = "RhD1njZh";
            "file" = "cataclysm_spellbooks-1.1.14-1.21.jar";
            "hash" = "sha512-JVlTBwXVbwkr+fVCfoS88rAon3EdSGWMEj65fRSlTDORYuoBmDbaSUFtDillTCs22oI7nNPMfila/cBo7Vbwpw==";
        };
    in {
        "QXSgkvUy" = _QXSgkvUy;
        "HdkHkm9Z" = _HdkHkm9Z;
        ...
        "neoforge-1.21.1" = _RhD1njZh;
        "pkg-1.0.0" = _QXSgkvUy;
        "pkg-1.0.1" = _HdkHkm9Z;
        "pkg-1.0.2-1.19.2" = _OdL8bjjy;
        "pkg-1.0.3-1.19.2" = _jSbYQf45;
        "pkg-1.0.4-1.19.2" = _1X3Jis7F;
        "pkg-1.0.5-1.19.2" = _rhUt9qbz;
        "pkg-1.1.0-1.19.2" = _giAkng0T;
        "pkg-1.1.1-1.19.2" = _VzPAmKRx;
        "pkg-1.1.1-1.21" = _aaqz8V8o;
        "pkg-1.1.2-1.19.2" = _xlQPu1mR;
        "pkg-1.1.2-1.21" = _sTokI4uE;
        "pkg-1.1.3-1.21" = _GuMuxuJr;
        "pkg-1.1.4-1.21" = _nQeJ9H71;
        "pkg-1.1.5-1.21" = _V5lDLqJD;
        "pkg-1.1.6-1.21" = _1zBAkUuW;
        "pkg-1.1.7-1.21" = _PLWaIMgo;
        "pkg-1.2.0-1.19.2" = _YfSu1aeW;
        "pkg-1.2.0-1.20.1" = _mCv2vt8Y;
        "pkg-1.2.1-1.20.1" = _dWntCYqL;
        "pkg-1.2.2-1.20.1" = _YwXcWJqb;
        "pkg-1.2.3-1.20.1" = _SPAI0viB;
        "pkg-1.2.4-1.20.1" = _JidSQqn5;
        "pkg-1.2.5-1.20.1" = _HiL8eHk4;
        "pkg-1.2.6-1.20.1" = _xz7Z4Y22;
        "pkg-1.2.7-1.20.1" = _p3IVvh83;
        "pkg-1.1.10-1.21" = _JoPrqPsO;
        "pkg-1.2.8-1.20.1" = _RYekxlOC;
        "pkg-1.2.9-1.20.1" = _e7VE8bSy;
        "pkg-1.1.11-1.21" = _MuC8YrbF;
        "pkg-1.1.12-1.21" = _5NYz9vZy;
        "pkg-1.1.13-1.21" = _m8aMfihn;
        "pkg-1.1.14-1.21" = _RhD1njZh;
        "default" = _RhD1njZh;
    });
