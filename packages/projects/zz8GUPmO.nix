...
let
    ...
    in {
        ...
        "pkg-41.1" = _4j0wK6PN;
        "pkg-41.1+mod" = _Ek9GdOZh;
        "pkg-48.1" = _gysZIqgd;
        "pkg-48.1+mod" = _RRsnc43p;
        "pkg-48.2" = _oSmyXEGn;
        "pkg-48.2+mod" = _6dkZvgY2;
        "pkg-57.1" = _GOLQxkAo;
        "pkg-57.1+mod" = _ILpFr8hm;
        "pkg-61.1" = _Jg86xkg7;
        "pkg-61.1+mod" = _HcPZZp7O;
        "pkg-71.1" = _511AqRcT;
        "pkg-71.1+mod" = _4rgkrafr;
        "pkg-80" = _fcG27P6d;
        "pkg-80+mod" = _Ie39sy7l;
        "pkg-81" = _KcXw2t69;
        "pkg-81+mod" = _DZ7QguuJ;
        "pkg-88.0" = _3gLnzu13;
        "pkg-88.0+mod" = _3Np1oJ6l;
        "pkg-94.1" = _pIfRgLRW;
        "pkg-94.1+mod" = _DWdW7lCQ;
        "pkg-101.1" = _wZuoV3Da;
