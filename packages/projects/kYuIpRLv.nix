...
let
    versions = (let
        ...
        _IfOXfD5l = {
            "id" = "IfOXfD5l";
            "file" = "waveycapes-fabric-1.11.0-mc1.16.5.jar";
            "hash" = "sha512-8CtSQQ/B90LERLIBVALpDYq5rzl3Ka3bm1eF2YHU9UUGgOWkDMrWyc3b/+9WGiZwRYya7WCoQ3N+EyRxUdKmEg==";
        };
        _mtOzvnl2 = {
            "id" = "mtOzvnl2";
            "file" = "waveycapes-fabric-1.11.0-mc1.18.2.jar";
            "hash" = "sha512-1GbDwsG15iKfwpJI/JrzZLszSJ4i9W77E3jf9mty2HWqlSXvVldMIoBSVek0Q1P8smPMPZin+htVptQwKFoVrA==";
        };
        _AasPV7VI = {
            "id" = "AasPV7VI";
            "file" = "waveycapes-forge-1.11.0-mc1.18.2.jar";
            "hash" = "sha512-4dm/pBoNmYX4yyLzNuUh2/kJ/RVCEOhxrgbw/XXXbRl1CB51/0SMk21hfYCUUAD4k6e38wnm/sEVZOZ601dbrA==";
        };
        _59nNzYGg = {
            "id" = "59nNzYGg";
            "file" = "waveycapes-fabric-1.11.0-mc1.19.2.jar";
            "hash" = "sha512-K1VdUt2kTeHkT4ugfhxZpZJSiAHKD65Z1eMpFkr6vbV4ig8PjTf9zacLnG47bDaLNMFoD1wWKIzMZoOU6LCKZQ==";
        };
        _g3xECRUj = {
            "id" = "g3xECRUj";
            "file" = "waveycapes-forge-1.11.0-mc1.19.2.jar";
            "hash" = "sha512-Rvtn/Tx1UDnbB0RAAE7YfQTxw6xK6Po3Lo9O4wSisXxHwMCcsS5kFnDSU/lS0L+JEOGiqdbjc5a31id58xspOg==";
        };
        _EvUtbIWR = {
            "id" = "EvUtbIWR";
            "file" = "waveycapes-fabric-1.11.0-mc1.19.4.jar";
            "hash" = "sha512-y0M6AKZqTIMZAzs328zz6g2jE6qTff4YjYfWY/EbKUBHA8doaNf/+naCNbGxWuci58jlKdQ+6JCb4nSS9+4VMg==";
        };
        _FtYF35sq = {
            "id" = "FtYF35sq";
            "file" = "waveycapes-forge-1.11.0-mc1.19.4.jar";
            "hash" = "sha512-tQgBk17KoBUCRqzUBt5LQEE1cUDU2E0mzyJYl3SfNyVUafihfkSdmFtMHKo1UFJbHRzojwv9idkBnfHp+8oA9w==";
        };
        _JzpixaQ8 = {
            "id" = "JzpixaQ8";
            "file" = "waveycapes-forge-1.11.0-mc1.20.1.jar";
            "hash" = "sha512-vg+yQuonZ/VGQ6C3Fuq7i4jvOnq0Tsn22ML0E7eE0VLjOOLsjQZpobIfxfzGqzLcU4vImUCcn0VCJD54V/r9rQ==";
        };
        _MGGHLx1g = {
            "id" = "MGGHLx1g";
            "file" = "waveycapes-fabric-1.11.0-mc1.20.1.jar";
            "hash" = "sha512-YQIDKYrLNd7DEKYwLcQci9SQpzbMFyyvXd7oQt9VSSo3sdi5ZUgqr6eBR3sbFULHiP3hbyDgDhs6pisqf8DpjQ==";
        };
        _HWSJGnXj = {
            "id" = "HWSJGnXj";
            "file" = "waveycapes-fabric-1.11.0-mc1.20.2.jar";
            "hash" = "sha512-0YX0+7dXxDwfEzhrdNxgAnj6vvrFpyGlGJoFq8WFivhiQnA7Q83oSP/UmUPv8z92uS2e+mQaclSkBt63Hpdkvw==";
        };
        _uuoJaqMt = {
            "id" = "uuoJaqMt";
            "file" = "waveycapes-forge-1.11.0-mc1.20.2.jar";
            "hash" = "sha512-GmgKoErG6Su8V03j1WBRX6cN85C7xN+A4oaXb8tB3KexZsj8VQxrrSdpC6eao4bAUfNrGgnLWX9tY5h1nyZgqg==";
        };
        _6vfgmiu5 = {
            "id" = "6vfgmiu5";
            "file" = "waveycapes-neoforge-1.11.0-mc1.20.2.jar";
            "hash" = "sha512-3qOnPPKieSxAulsMOTkW6sd27pZyUDw0SobWMQL5yfXUrRrTNjIXPTorZJFhLaFUOxQHFKqe17zoQcjCuX3PcQ==";
        };
        _KOAXIsqG = {
            "id" = "KOAXIsqG";
            "file" = "waveycapes-fabric-1.11.0-mc1.20.4.jar";
            "hash" = "sha512-iXYgJKrnAirtx1D3u/rAJvYktw0yxf/Pqc9mwnOUSgJoUs93lOB1CnunF2StRjrR6v2XJG1iUBNe95r1PVSSWg==";
        };
        _x7OKYJCB = {
            "id" = "x7OKYJCB";
            "file" = "waveycapes-forge-1.11.0-mc1.20.4.jar";
            "hash" = "sha512-mKrJe3P+56aC3Xje8QscWTuygUx4PLc+e9pqj7E9jbGOrHKnskeX8kM04ocj2+6goaFFa7KmwVWGISpckVAxaA==";
        };
        _QMexfzNM = {
            "id" = "QMexfzNM";
            "file" = "waveycapes-neoforge-1.11.0-mc1.20.4.jar";
            "hash" = "sha512-QY7vuHxMUQq/g5OhqZTgje9YCIorFl0rXaxAhwGAU+dNpcwRZc6d14eEX1ppgVzDXlD2wEME+0cRqY++VZDang==";
        };
        _iw1aIAiy = {
            "id" = "iw1aIAiy";
            "file" = "waveycapes-fabric-1.11.0-mc1.20.6.jar";
            "hash" = "sha512-30Q+pUap9AFdDlwNF4Ej6CjuJ/Y19QiWcClgnRJPaltgQ+uKdH9i9Qe+Jq2bBYCht+waJTnXEGecPg6dlNKueg==";
        };
        _5ARGGDIA = {
            "id" = "5ARGGDIA";
            "file" = "waveycapes-forge-1.11.0-mc1.20.6.jar";
            "hash" = "sha512-QhSmguKvB21mvW68ChhY8W//1nxrQ8STTDENmcUjdsh7YEPa0H3h0FUZp8GidKp8KpOmO6gVFQL2Pme4UlPDSA==";
        };
        _WpEA9q8Z = {
            "id" = "WpEA9q8Z";
            "file" = "waveycapes-neoforge-1.11.0-mc1.20.6.jar";
            "hash" = "sha512-aiUPDj0N05q6lfJ0Gjom9py5wa/x0wtaeObwVpIQd7r3fk5y8sU+WSds+jFg1gksK+zxm7m2KD8TAwuTFkkgKA==";
        };
        _3ajMawmU = {
            "id" = "3ajMawmU";
            "file" = "waveycapes-fabric-1.11.0-mc1.21.1.jar";
            "hash" = "sha512-2pocQvaK89RivTcGImSibQ+3Dd0tEUn+kEwsJnMDzPZbZk1bYfcov16/ZuBLDUHDjuR5kK9LpBxBm6j4o58ezg==";
        };
        _y0cOkQFX = {
            "id" = "y0cOkQFX";
            "file" = "waveycapes-forge-1.11.0-mc1.21.1.jar";
            "hash" = "sha512-2FETrzORWmMnArZk8uRm8GDb0Cv2yZ1dscTM2wFpcb8v3HzEAXDHc8ZsFW4YXgEIV8H3GM0IAUJ9cbjJUC9WWA==";
        };
        _VuvpBNMh = {
            "id" = "VuvpBNMh";
            "file" = "waveycapes-neoforge-1.11.0-mc1.21.1.jar";
            "hash" = "sha512-v7bovx3GdZTnvprEICvIxax510GXZiX+tjDuHOmQWtJcWVBBJJv1gffKU+iOWNLxvdo/TxoGvvmdHQEb+nzv+A==";
        };
        _My0BfUqQ = {
            "id" = "My0BfUqQ";
            "file" = "waveycapes-fabric-1.11.0-mc1.21.10.jar";
            "hash" = "sha512-BOBUoOdtK0ZpPcxOMJ5boUn2ahZiAAIYRB0WY/KBGt8i24RZ9Z8mKrEZovbgX3rsKpd1gnjqkVOPE8Dt2osfaQ==";
        };
        _ThsPNluK = {
            "id" = "ThsPNluK";
            "file" = "waveycapes-forge-1.11.0-mc1.21.10.jar";
            "hash" = "sha512-C1V61BqNewV1Mnj8LNMIjGrvhrWBpEPBkDAqgNfL5kyWFmdZo8xDBtKyx3ulOxP91oQ2Dgea5diXUu3GoXn7DA==";
        };
        _TCVEMGlT = {
            "id" = "TCVEMGlT";
            "file" = "waveycapes-neoforge-1.11.0-mc1.21.10.jar";
            "hash" = "sha512-MdsQzVDJ6of9M/WaMazZpeUhqDxmhHX9L99KlKzGbbn4SuzovgcC2ndkmppU7OIwYLLaSEJQQ++gqgpSYgzgIw==";
        };
        _8988sloO = {
            "id" = "8988sloO";
            "file" = "waveycapes-fabric-1.11.0-mc1.21.11.jar";
            "hash" = "sha512-IBoa2v5CBPyZ9qqziChfoXXr5jhxefBDhQBY3u3PemRbWjn2OnuDYnSzPoQxQe0leJWkum4Y92TukQ9rf4o4eA==";
        };
        _gbNpKSia = {
            "id" = "gbNpKSia";
            "file" = "waveycapes-neoforge-1.11.0-mc1.21.11.jar";
            "hash" = "sha512-jl/+ZClL4MLtC97ug++sk26qI7ZplpRJfdBYr/ffZvgVgnD8OJaTTXEGgcTsVyE/gHlSo1Loxts4bQCMcVFLxA==";
        };
        _2MVdnJir = {
            "id" = "2MVdnJir";
            "file" = "waveycapes-fabric-1.11.0-mc1.21.3.jar";
            "hash" = "sha512-TrH7bR0HUSNIzUUeWanVV/VsAbfkERFEC4IabaOzWJRokN+Rs4O6SA6Z/HD5EUy+oXHZguHtR2hILjuwQIxISA==";
        };
        _jcoKOdpZ = {
            "id" = "jcoKOdpZ";
            "file" = "waveycapes-forge-1.11.0-mc1.21.3.jar";
            "hash" = "sha512-mgc/VG+dgVhJIcS60FBUEsyLdeY3aPypT4Er5vCYRzapXdJBER/TkAIp7+eP/Fd8YFNHP2LlGHg8iQLnsNZm2A==";
        };
        _uvanIn2C = {
            "id" = "uvanIn2C";
            "file" = "waveycapes-neoforge-1.11.0-mc1.21.3.jar";
            "hash" = "sha512-/O+ZorupkC6oQs7hfWcOSRTm+uFXhtJubufeCFwb9vguevm1LD3uxh7eflMoG7dHNqV5qR5I39dmxMRKzXfefQ==";
        };
        _MUslMv3r = {
            "id" = "MUslMv3r";
            "file" = "waveycapes-fabric-1.11.0-mc1.21.4.jar";
            "hash" = "sha512-8bQgyQT2I6K3wd0NmV+h+m5KgpURIwN9f3Z7rQR6Wj5avhZ51Wv6ihYO1H1gB4TOpjLCa3uYgrxxiVxst0duQw==";
        };
        _FQBiLl3D = {
            "id" = "FQBiLl3D";
            "file" = "waveycapes-forge-1.11.0-mc1.21.4.jar";
            "hash" = "sha512-xblWewAr/gZEcgCdfv0gmkmI46aJn6i71Io5cPYyohUxgD5MEPojDmLPx7LK40aV0apeVD8lQm35ZP7stO0mGg==";
        };
        _fJFKXrDW = {
            "id" = "fJFKXrDW";
            "file" = "waveycapes-neoforge-1.11.0-mc1.21.4.jar";
            "hash" = "sha512-VLBmkub1JQwg6CdP+6OY8jrPzXkJvNp+4r5h25O6TjLGXLsO226IcE6sxJQpkyt8OoD+4HQP0p2Nti44/X8tfA==";
        };
        _zl3L61d2 = {
            "id" = "zl3L61d2";
            "file" = "waveycapes-fabric-1.11.0-mc1.21.5.jar";
            "hash" = "sha512-nsm5+sBHAGCYJ/dhcd0929JKnsBOAGrEzilabbPu8A7wKwxC6MsPrMsZdvGkcyAFzbzPGZwc6nqaPDYFE1SmrA==";
        };
        _nHrGzJvI = {
            "id" = "nHrGzJvI";
            "file" = "waveycapes-neoforge-1.11.0-mc1.21.5.jar";
            "hash" = "sha512-kqUXSrvRSGLvI+hu4lHbURn2TsnqWe1jMyCLNzcBhhVBJBKKWVOVZY+YKqeDGIl3HJXQJpMuvc2QCgOkK25UMg==";
        };
        _jVSdIVmi = {
            "id" = "jVSdIVmi";
            "file" = "waveycapes-forge-1.11.0-mc1.21.5.jar";
            "hash" = "sha512-KS8PZzNpWiVs3JF7ZAd/C43juNyWXrugf0w2TXuwJnLy4a6atiUqkYwxzK85DoDRH/Duw+n908Evyyt+NoC60g==";
        };
        _ZqtOe8XB = {
            "id" = "ZqtOe8XB";
            "file" = "waveycapes-fabric-1.11.0-mc1.21.8.jar";
            "hash" = "sha512-ZPMRAxlKvi9mDb8lkCiHz5LSvIid0s4jsplBplluF7KheuazV75Rp+eYbUKPxbfEPKDfzkgP1VuaFyhyWidwwg==";
        };
        _Nh3eXHFI = {
            "id" = "Nh3eXHFI";
            "file" = "waveycapes-forge-1.11.0-mc1.21.8.jar";
            "hash" = "sha512-EwkYSe1MUT63trc6QUhCxgfde4oCQkyJn8gh01KV2sFQWTKsM/apsZSpFhoST5jIAikjLpNFlpcDEKihuiRDOQ==";
        };
        _8iMiVASk = {
            "id" = "8iMiVASk";
            "file" = "waveycapes-neoforge-1.11.0-mc1.21.8.jar";
            "hash" = "sha512-T2LbeEC6LmxJvNISVS4+Gn3YgOxFdIAeEVA0tzA4CBIHqmXE/La29omGnGhUdy1utdzM00Uq3j7h9cxoaoOIxQ==";
        };
        _Si31iWTP = {
            "id" = "Si31iWTP";
            "file" = "waveycapes-fabric-1.11.0-mc26.1.jar";
            "hash" = "sha512-H7OGSsjR3+cqGe47ScN1Y8eRyd5woh5/WRCNbXDB9eH7li3ffhpxU6y5cwtumVDujMzPJk/9i2nA8386PXsLxw==";
        };
        _LTikMEg9 = {
            "id" = "LTikMEg9";
            "file" = "waveycapes-neoforge-1.11.0-mc26.1.2.jar";
            "hash" = "sha512-hqY/3UoaaLEWuwHRIM45oaIvpEEyMRHNenX3JKVEjzDjtW9d9pXEofl7f5ALLlAIQjhRZCc0KjtxUNbFz/xH7w==";
        };
        _kp4qdTT3 = {
            "id" = "kp4qdTT3";
            "file" = "waveycapes-fabric-1.11.0-mc26.2.jar";
            "hash" = "sha512-Z2pM8zt8XIu2YIU6+LHf/aWy5/lo5WGhsJEZlL/SO7gZlQ5ZcUMED1eOGtXjNSZMgWoPlqaYmCgiCKca2Bm/aQ==";
        };
        _17bey25R = {
            "id" = "17bey25R";
            "file" = "waveycapes-neoforge-1.11.0-mc26.2.jar";
            "hash" = "sha512-EISLOfRMzhz3yxQ0Vc6uLcnGGCjYqEl4AEe8DOEc7Oo32/uPyDxLNjzAOI1bMD4ypBljAutuS5JpnqylRNg7yQ==";
        };
        _hotxx4Gi = {
            "id" = "hotxx4Gi";
            "file" = "waveycapes-fabric-1.11.1-mc1.16.5.jar";
            "hash" = "sha512-R/XQa7v2E50YJ4iSJKPy2jZsDelLx599tF4ggDu6HRppmCl64cP4sDefm0hmFHL/6cUjESYy9Az9VWtjyNCGEw==";
        };
        _VE0insWP = {
            "id" = "VE0insWP";
            "file" = "waveycapes-fabric-1.11.1-mc1.18.2.jar";
            "hash" = "sha512-JZDwEkLEC/D0aZu0zZKSx747nID/lTBrUdNppVS79uF8zAs2RUlLuOiB4Vy4LAkNzbWAZSbtt5Av1tAxl/lZsA==";
        };
        _Hatv3Nzm = {
            "id" = "Hatv3Nzm";
            "file" = "waveycapes-forge-1.11.1-mc1.18.2.jar";
            "hash" = "sha512-/DJzU2tLIbUIzpiym8oxOFcXsD+vw0BeqiNgwsvJ+YbVEqGhk5qgfqffCM+CBcKL4PZc9Nssq76Zej+rOsarXA==";
        };
        _SkWi8h6l = {
            "id" = "SkWi8h6l";
            "file" = "waveycapes-fabric-1.11.1-mc1.19.2.jar";
            "hash" = "sha512-FO/emwCU+Nvkeu1hVPkOALfaJ6EcahKMgAu74XP7YOwbiHqZFG91cK7XV1wF8Fn1mibDzh2+/600XHczXcvsHw==";
        };
        _7sVcBg1L = {
            "id" = "7sVcBg1L";
            "file" = "waveycapes-fabric-1.11.1-mc1.19.4.jar";
            "hash" = "sha512-wkVl0FTMY9/RaYfLE+BvK7c0uVXL462Yr9GX1HKKa/DSfPnKnQm/7T1/oXGBxm/LyAK8U3B6GH+MBEan3PbcpA==";
        };
        _cObvJxmY = {
            "id" = "cObvJxmY";
            "file" = "waveycapes-forge-1.11.1-mc1.19.2.jar";
            "hash" = "sha512-RyjPlWuxbDOrOck/r8FaHQR1tGkKFSEkFXCeZoI8QOdK7c1v2Ej8BOXUTNr9XKPjDtq56Gli75x6+TtSsLV1MQ==";
        };
        _bNHtiuA8 = {
            "id" = "bNHtiuA8";
            "file" = "waveycapes-forge-1.11.1-mc1.19.4.jar";
            "hash" = "sha512-yeTfXlT3YdeMBxjD/9WEWVxUWqa9L6Z0ie2CcX9U5qHpDElQ+GKoCIfGpsFeH+BflrVHH+5Gb/kpZMFM2uYU/Q==";
        };
        _vTV7A6gQ = {
            "id" = "vTV7A6gQ";
            "file" = "waveycapes-fabric-1.11.1-mc1.20.1.jar";
            "hash" = "sha512-Q2TBoZF6v/kzZT4+JHNu0Pw+vRoGJTuFRAO64P/39u9HtUuLIdST0/lzrFC5RvgWXngIcyna8SaPa9yhGtc2xQ==";
        };
        _YPntrhbP = {
            "id" = "YPntrhbP";
            "file" = "waveycapes-forge-1.11.1-mc1.20.1.jar";
            "hash" = "sha512-78YFUEHWBZFUtCWHbV5B2FDmDnyHvF4V8doee+UdN0eYOdPOBzP8vrmMUqWAsHMIlh53iIySrhMDOIUIv4T9Wg==";
        };
        _t4SA8xEO = {
            "id" = "t4SA8xEO";
            "file" = "waveycapes-fabric-1.11.1-mc1.20.2.jar";
            "hash" = "sha512-6gLjJ9VEAY8hFj5nyCYLtmY8rxHvehRWM3eBwTjDDHJRwAiCslZvDQJBEYU+HAWnt/8VPYiOcrUCt/Y0/jptTQ==";
        };
        _l7NyzLhB = {
            "id" = "l7NyzLhB";
            "file" = "waveycapes-forge-1.11.1-mc1.20.2.jar";
            "hash" = "sha512-vTCeXzAlch3wHRaeVPIBbrYLWTPCsvwCAwv4tKv6F8JvkqS9YcWSB74ARsLXT6g6BRcKlYmfOdLhy/zKSvFUHw==";
        };
        _efDisxu4 = {
            "id" = "efDisxu4";
            "file" = "waveycapes-neoforge-1.11.1-mc1.20.2.jar";
            "hash" = "sha512-kGUETMIhQBw9pLTMNclR8Wfq8kcgkpVr5TAA++VGdPzof55GebBH1JkTd7jlnDO2B/c3jKAUZboJE35eKDgKUw==";
        };
        _LHIwD2xY = {
            "id" = "LHIwD2xY";
            "file" = "waveycapes-fabric-1.11.1-mc1.20.4.jar";
            "hash" = "sha512-TcuZ4dBNW6AI4oMZC1p8nzEuclrVowSMwgGVya8aoWuEcrR4xnYR95k8eeGjzJZjYPHElwSJIdd52SHzLxoL1Q==";
        };
        _7ijfhemq = {
            "id" = "7ijfhemq";
            "file" = "waveycapes-forge-1.11.1-mc1.20.4.jar";
            "hash" = "sha512-U1SHjZCMr7i1jjSorIfcz1UlaUVSFHBExhAHIwqeXoj3kpO7xJm4PnQR9IzWvFDlGOH4FnSEZQ4sDG6J+Tp/Gg==";
        };
        _FKSDy1NU = {
            "id" = "FKSDy1NU";
            "file" = "waveycapes-neoforge-1.11.1-mc1.20.4.jar";
            "hash" = "sha512-4KcT1hIpEpQqp7MIc9WazT4JVschQNmqZ+leksHvvI5spSHLcLG+2QVKfdsRQJNOTMnBW1Aj4rhHLvn0BkcbHg==";
        };
        _7kOp7MY2 = {
            "id" = "7kOp7MY2";
            "file" = "waveycapes-fabric-1.11.1-mc1.20.6.jar";
            "hash" = "sha512-jKnRuypJK6bXYNp8Yf1K7jhLQDKSHwvNlg1pkXQOQPo17yvypzNCB3xZoy/o99Ju2FqmR0rEFJxcuPB0EF39UQ==";
        };
        _dAghIHmB = {
            "id" = "dAghIHmB";
            "file" = "waveycapes-forge-1.11.1-mc1.20.6.jar";
            "hash" = "sha512-5EmydgCrcbXw1M/FzyVLJup4SjxPw0kozDk2p8ta27tTjwguPagqSHCmnn/bc6OUSRn9e+mWkGg49Dw7Vf/Kbg==";
        };
        _yqAeaGJW = {
            "id" = "yqAeaGJW";
            "file" = "waveycapes-neoforge-1.11.1-mc1.20.6.jar";
            "hash" = "sha512-ivJN96K4WjYXTRaTmQc6WJPd4XAmpiH/PTsdTMpzC56XQB7tm7odlKEgD1iEBDuyGeh3tWQA+hA11d7BcJAOXA==";
        };
        _87QownBp = {
            "id" = "87QownBp";
            "file" = "waveycapes-fabric-1.11.1-mc1.21.1.jar";
            "hash" = "sha512-hGGE4tCPJlG/VWlu+8RHy8X9TJEhZCOK5r3w2nNJZGS6Sku+uJP9ESp+O+DRNTdtgDrZ18n6m0mVTlWauDSPFQ==";
        };
        _TrvxSGEq = {
            "id" = "TrvxSGEq";
            "file" = "waveycapes-forge-1.11.1-mc1.21.1.jar";
            "hash" = "sha512-U9ObpLVRycKtnQ84csJF/VyE8NYU6qWWPMX0wjl/GaSJuQGMpBxgLyuXRi6XS/77+0qzFavoC8TziA824pBdxw==";
        };
        _dcf00nIA = {
            "id" = "dcf00nIA";
            "file" = "waveycapes-neoforge-1.11.1-mc1.21.1.jar";
            "hash" = "sha512-UKVAOtyHQT3cOW6d5NyQGnl7lw/yxNhviz1my+tQ1CT3rAQ6cKvpiEhMYt/Q0J3Kvhg8m8Bls7tvsz2VZ5Welw==";
        };
        _WDE2z7Zw = {
            "id" = "WDE2z7Zw";
            "file" = "waveycapes-fabric-1.11.1-mc1.21.10.jar";
            "hash" = "sha512-rPimH8/RWtrhHF1KAgeqcpXqoF7xgVcw0OR8TXjT+0JVlOOzKPPGGc5pYd4XOGFLPrKM/9tu95+aROMviEs1Uw==";
        };
        _H7Rj4G1j = {
            "id" = "H7Rj4G1j";
            "file" = "waveycapes-forge-1.11.1-mc1.21.10.jar";
            "hash" = "sha512-dZDuTOIjqc/BLJQSXjfQZyEFFoP8cLIfrCDYDvOprKVNMUy5ggJlqtp+nKYIAmJSwHAmT9/CpEtmabQUdvCXOw==";
        };
        _C0eitSgv = {
            "id" = "C0eitSgv";
            "file" = "waveycapes-neoforge-1.11.1-mc1.21.10.jar";
            "hash" = "sha512-/+EHzNNKWHBVXfpH/9q65DnUUs12u0DaZtCtlDb1nNe8MDUDkm4pYx31FLajfXCYxMD5EUEgMLITN26exr/c7w==";
        };
        _ppmm2dBc = {
            "id" = "ppmm2dBc";
            "file" = "waveycapes-fabric-1.11.1-mc1.21.11.jar";
            "hash" = "sha512-/syt9EIL5n4F8wSMgkmTGkZ/9XUXZFCHO2/K+pN4Cmq/fLK25oOWDvetDBLFvu5uS180VLr/FP0npX4jZH4bJA==";
        };
        _jo9cXfjh = {
            "id" = "jo9cXfjh";
            "file" = "waveycapes-neoforge-1.11.1-mc1.21.11.jar";
            "hash" = "sha512-B7gZKd6M9ysV+gsKiNch0ID0gfOOPpGmYS21l7diKXsPCP9DE8wUPFSavSUGsaWoQSEhL+000H+XxedDtIJSGQ==";
        };
        _STFzKnfS = {
            "id" = "STFzKnfS";
            "file" = "waveycapes-fabric-1.11.1-mc1.21.3.jar";
            "hash" = "sha512-YgA7lIdfahY0ayNmxUDxzmibnsxEyes4awwqAqDOHyGvzVqFwdgrRCCCocc1cKSJy8DGA2c99iC/8q3b5bBw7w==";
        };
        _U4zjT5o4 = {
            "id" = "U4zjT5o4";
            "file" = "waveycapes-forge-1.11.1-mc1.21.3.jar";
            "hash" = "sha512-kmULHYpw+1p3ASU8RZAudi4DsxRzySMT2LlZBIuwRb+R1RlhBqSwuzl5dHEkc6l55EN1E8N0OpGi1ZOPIWC9pA==";
        };
        _FUD4Y8nB = {
            "id" = "FUD4Y8nB";
            "file" = "waveycapes-neoforge-1.11.1-mc1.21.3.jar";
            "hash" = "sha512-SYi/joZ98Nc+Z+ppbWeaZYcU5ynIDbqkplKkcCO7izwaLd+29ixuTr+PllN92TOoyNWn3jHRHHcm4h1/1xbRQQ==";
        };
        _wyl2gqDK = {
            "id" = "wyl2gqDK";
            "file" = "waveycapes-fabric-1.11.1-mc1.21.4.jar";
            "hash" = "sha512-5MQXJSu9dNQaW4oXsLh6GS77TuxURAB+lIS4/m31Juk9mVsWDZkjavUFHNVimN0GEfij0/sfHRmTBAYEhA3o8Q==";
        };
        _cwCYeuw7 = {
            "id" = "cwCYeuw7";
            "file" = "waveycapes-forge-1.11.1-mc1.21.4.jar";
            "hash" = "sha512-l+yFRMkS3ZYIf4ZF1lwMTsl9XUuIU0CPvpHNsb03t1FTXPVa6dVWvj1rBXr+c69xI0PfK4gE36DdY9ZzeAWaZg==";
        };
        _cdxtjfSW = {
            "id" = "cdxtjfSW";
            "file" = "waveycapes-neoforge-1.11.1-mc1.21.4.jar";
            "hash" = "sha512-6UQ0+FeU7875likx3SMzLVhh3WAHyTB64BwjGwJhlSkp+D7N5Xh6F+0FSzd9pyemOgqVipzObcQVAI+1GTstfQ==";
        };
        _oFcZKq8P = {
            "id" = "oFcZKq8P";
            "file" = "waveycapes-fabric-1.11.1-mc1.21.5.jar";
            "hash" = "sha512-ZVj1FfAyg3i9ieEE+Qa16Gs84+7WyYDWTMJantKYRWVyeAu57124pb+kNXMQtO86+df7sGAfGq79Qd8pxDoq9A==";
        };
        _u17jz0n6 = {
            "id" = "u17jz0n6";
            "file" = "waveycapes-forge-1.11.1-mc1.21.5.jar";
            "hash" = "sha512-sjHtDo6y6riH2Hs6SR4JFZPmowBp+JXwe0LoB/ac3179DOs6VbTuVFnaMVWBLDBjfChL4OhiW9uu6v19JngLVA==";
        };
        _nWvCIASB = {
            "id" = "nWvCIASB";
            "file" = "waveycapes-neoforge-1.11.1-mc1.21.5.jar";
            "hash" = "sha512-Qbnfv2942RW6ycGP9pmj8J88XxlJ+QwUoi11J7Omva97/CdoITAtMy/dXb6vCPMAoiAGf0l1B/Br6kB0oixv0w==";
        };
        _7M7mSTgX = {
            "id" = "7M7mSTgX";
            "file" = "waveycapes-fabric-1.11.1-mc1.21.8.jar";
            "hash" = "sha512-uB9QOL/mRwdqxubdowGSM9EgyKOSIocd3DUuhFTS1hmDK7msvGywpmAKxPtJKlOEN+09p80LCPXr/MW7Ckymtw==";
        };
        _5EnoGNH4 = {
            "id" = "5EnoGNH4";
            "file" = "waveycapes-forge-1.11.1-mc1.21.8.jar";
            "hash" = "sha512-rzLEa3x1/1ilmBnCcjaPFVmCsU3EwfY1alqPgMezYrARNQ7xrgNA7MUE9sKrLWbk7JEyhde2fT3s1+mjjZ49QQ==";
        };
        _f9e2ElT0 = {
            "id" = "f9e2ElT0";
            "file" = "waveycapes-neoforge-1.11.1-mc1.21.8.jar";
            "hash" = "sha512-ZUCwhLQI43gmDRD3HFBCw/JyJhMddWSO8aAzfR2RmvXH7NM+BtbNe5HMDx+5mErJ3R+PDvBDzSmfuALDhV42aA==";
        };
        _a4apVTdm = {
            "id" = "a4apVTdm";
            "file" = "waveycapes-fabric-1.11.1-mc26.1.jar";
            "hash" = "sha512-X+T6/Xnrsi5G5kSkZtebArRG7PIZT3SWjpPSJ0hJbCZL+HX6k1HxyaCkwV8edoxwRzmtwtR8ejehGVer2V8ZsA==";
        };
        _eJPljGs6 = {
            "id" = "eJPljGs6";
            "file" = "waveycapes-neoforge-1.11.1-mc26.1.2.jar";
            "hash" = "sha512-tAg67MJbo66e2+MaGiIuI0gxXJhxqvz1sxEkbLUsDwfigTOdthGdcvGWvQIeqXYkN+c2wAxRNfnkRfcNLhg9aA==";
        };
        _T1WP5jVJ = {
            "id" = "T1WP5jVJ";
            "file" = "waveycapes-fabric-1.11.1-mc26.2.jar";
            "hash" = "sha512-En2lRaq3FFQK583sVDeN1Sks0gjIxW5NvM0MKBodGZrdRElRYtasBmRRrl4iCEAXzmg0Oqk2Id3flCNNo2uCCw==";
        };
        _NnNfPUDG = {
            "id" = "NnNfPUDG";
    ...
    in {
        ...
        "pkg-1.2.0-fabric-1.16" = _MzkP52id;
        "pkg-1.2.0-forge-1.17" = _Y34BGWFT;
        "pkg-1.2.0-fabric-1.17" = _GrtcNVOU;
        "pkg-1.2.0-forge-1.18" = _T4tfHi3g;
        "pkg-1.2.0-fabric-1.18" = _I1UjX4Uv;
        "pkg-1.2.0-forge-1.19" = _gSNyFatJ;
        "pkg-1.2.0-fabric-1.19" = _QS5ZzN5z;
        "pkg-1.2.1-forge-1.19" = _d6sUXwhV;
        "pkg-1.2.1-fabric-1.19" = _QaPiuuaV;
        "pkg-1.2.2-1.19" = _dEqtGnT9;
        "pkg-1.2.2-1.19.3" = _5NuUwM8j;
        "pkg-1.3.0-1.19.3" = _iMIwbxPm;
        "pkg-1.3.0-1.19" = _XXtuhSzv;
        "pkg-1.3.0-1.18.2" = _uAlxZqLf;
        "pkg-1.3.0-1.17.1" = _UCqyRfAa;
        "pkg-1.3.0-1.16.5" = _IsabNRBg;
        "pkg-1.3.1-1.19.3" = _i0o2MYAT;
        "pkg-1.3.2-1.19.3" = _C3M3SuYd;
        "pkg-1.3.2-1.19.2" = _FBoyebR2;
        "pkg-1.3.2-1.18.2" = _8p45Wj0S;
        "pkg-1.3.2-1.17.1" = _TFj59XjT;
        "pkg-1.3.2-1.16.5" = _tMlMt1Fz;
        "pkg-1.4.0-1.19.3" = _feSBCFVH;
        "pkg-1.4.0-1.20" = _9ppedk6Z;
        "pkg-1.4.0-1.20.2" = _lLliJjeE;
        "pkg-1.4.1" = _TivmUTDC;
        "pkg-1.4.2-1.20.2" = _mh2F39jk;
        "pkg-1.4.2" = _rgTKkx8G;
        "pkg-1.4.3" = _BV8TWLcn;
        "pkg-1.4.4" = _3Ky3FTbO;
        "pkg-1.4.5" = _IjU5mRPr;
        ...
        "pkg-1.4.8" = _tz9gWDTQ;
        "pkg-1.4.9" = _xCclI9ED;
        "pkg-1.4.10" = _FnoiNbTk;
        "pkg-1.4.11" = _VpkVO7uu;
        "pkg-1.4.12" = _hpyH8AED;
        "pkg-1.4.13" = _EW3z1SO1;
        "pkg-1.5.0" = _msZrpDSe;
        "pkg-1.5.1" = _TX5raOpI;
        "pkg-1.5.2" = _au3TpWgy;
        "pkg-1.6.0" = _cu5l91VY;
        "pkg-1.6.1" = _yeZs6IQs;
        "pkg-1.6.1.1" = _iooCBPwE;
        "pkg-1.6.2" = _M3v2kfUS;
        "pkg-1.7.0" = _ANilKOrQ;
        "pkg-1.8.0" = _9TIWDiaR;
        "pkg-1.8.1" = _AAARaPoc;
        ...
        "pkg-1.9.1" = _rocOwYV6;
        "pkg-1.9.2" = _K4cdp1K2;
        "pkg-1.10.0" = _xQMgirBR;
        "pkg-1.10.1" = _EFHFMrfA;
