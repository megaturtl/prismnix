...
let
    ...
    in {
        ...
        "pkg-1.2.3" = _CqC5YcAN;
        "pkg-1.2.4" = _Y07kY6Em;
        "pkg-1.2.5.1" = _6JCahpco;
        "pkg-1.2.5" = _pEK1mNPm;
        "pkg-1.3.0" = _OpwLqJqb;
        "pkg-1.3.0.1" = _OdiPP1Id;
        "pkg-1.4.4" = _Djkj9Ko2;
        "pkg-1.5.2" = _nGs0ZjTG;
        "pkg-1.6.0" = _kOWdq9YY;
        "pkg-1.6.0.1" = _OUzJQtFh;
        "pkg-1.6.0.2" = _Je1Xnvka;
        "pkg-1.6.2" = _vASmWgOh;
        "pkg-1.6.2.1" = _sVw1gGQN;
        "pkg-1.6.3" = _7vps8UYu;
        "pkg-1.6.3.1" = _I14zWKxF;
        "pkg-1.6.5" = _Rhf1i5jy;
        "pkg-1.6.5.2" = _1D3T69aW;
        "pkg-1.7.0" = _YkZVqSaL;
        "pkg-1.7.0.1" = _SnCzv0gq;
        "pkg-1.7.1.legacy" = _d2xeEbtf;
        "pkg-1.7.1.5" = _4Qxd47j9;
        "pkg-1.8.0" = _ecueeING;
        "pkg-1.8.2" = _K94lh87G;
        "pkg-1.8.3" = _1kdMOtAU;
        "pkg-1.9.0" = _PpaWcNEr;
        "pkg-1.9.0.2" = _ggdt8SkA;
        "pkg-1.9.0.5" = _rYObfs31;
        "pkg-1.9.0.6" = _3tKrpGWO;
        "pkg-1.10.0" = _oIVnQSjd;
        "pkg-1.10.1" = _JWyFiCm0;
        "pkg-1.10.2" = _tGLWvNKQ;
