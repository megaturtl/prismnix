...
let
    ...
    in {
        ...
        "TYejAziR" = _TYejAziR;
        "KOHsa7Q4" = _KOHsa7Q4;
        "bukkit-1.20" = _KOHsa7Q4;
        "bukkit-1.20.1" = _KOHsa7Q4;
        "bukkit-1.20.2" = _KOHsa7Q4;
        "bukkit-1.20.3" = _KOHsa7Q4;
        "bukkit-1.20.4" = _KOHsa7Q4;
        "bukkit-1.20.5" = _KOHsa7Q4;
        "bukkit-1.20.6" = _KOHsa7Q4;
        ...
        "paper-1.20" = _KOHsa7Q4;
        "paper-1.20.1" = _KOHsa7Q4;
        "paper-1.20.2" = _KOHsa7Q4;
        "paper-1.20.3" = _KOHsa7Q4;
        "paper-1.20.4" = _KOHsa7Q4;
        "paper-1.20.5" = _KOHsa7Q4;
        "paper-1.20.6" = _KOHsa7Q4;
        ...
        "purpur-1.20" = _KOHsa7Q4;
        "purpur-1.20.1" = _KOHsa7Q4;
        "purpur-1.20.2" = _KOHsa7Q4;
        "purpur-1.20.3" = _KOHsa7Q4;
        "purpur-1.20.4" = _KOHsa7Q4;
        "purpur-1.20.5" = _KOHsa7Q4;
        "purpur-1.20.6" = _KOHsa7Q4;
        ...
        "spigot-1.20" = _KOHsa7Q4;
        "spigot-1.20.1" = _KOHsa7Q4;
        "spigot-1.20.2" = _KOHsa7Q4;
        "spigot-1.20.3" = _KOHsa7Q4;
        "spigot-1.20.4" = _KOHsa7Q4;
        "spigot-1.20.5" = _KOHsa7Q4;
        "spigot-1.20.6" = _KOHsa7Q4;
