...
let
    versions = (let
        ...
        _mYjh0FSZ = {
            "id" = "mYjh0FSZ";
            "file" = "dummmmmmy-1.21-2.1.1-fabric.jar";
            "hash" = "sha512-U5xmBiwOUqr9TETniEP+QXvpditjLhPEpJUZdOCSUIJsqahNfyrK4hi4GqszmGoymJHq6m+uQFlxdIqJsCCZPQ==";
        };
        _TDcs0XKH = {
            "id" = "TDcs0XKH";
    ...
    in {
        ...
        "pkg-1.18-1.5.3" = _zCPdDOOP;
        "pkg-1.7.2" = _gEbry6GM;
        "pkg-1.19.2-1.7.2" = _lTTirNtq;
        "pkg-1.19.4-1.7.3" = _HPj6DZ24;
        "pkg-1.19.4-1.7.5" = _S6QNPOFv;
        "pkg-1.19.4-1.7.6" = _PcKbqBY4;
        "pkg-1.19.4-1.7.7" = _ZganhQm7;
        "pkg-1.19.4-1.7.8" = _mQfY3H0A;
        "pkg-1.20-1.7.9" = _UvxYYzDm;
        "pkg-1.20-1.8.0" = _9nNuKVUq;
        "pkg-1.20-1.8.1" = _TFlgTQCK;
        "pkg-1.20-1.8.3" = _AAiySuI2;
        "pkg-1.20-1.8.4" = _UxWhycwZ;
        "pkg-1.20-1.8.5" = _4IxqrWac;
        "pkg-1.20-1.8.6" = _Wsi8MeIx;
        "pkg-1.20-1.8.7" = _WovXXEkH;
        "pkg-1.20-1.8.8" = _EwVfOzqs;
        "pkg-1.20-1.8.9" = _oejSEBjB;
        "pkg-1.20-1.8.10" = _8gDpcYEM;
        "pkg-1.20-1.8.11" = _GClsjyQs;
        "pkg-1.20-1.8.12" = _fkn90qf0;
        "pkg-1.20-1.8.13" = _sQU1xRdi;
        "pkg-1.20-1.8.14" = _QOOGkq3O;
        "pkg-1.20-1.8.16" = _xVBLDt8m;
        "pkg-1.20-1.8.17" = _s1thtpLn;
        "pkg-1.20-1.8.17b" = _dGifKxWx;
        "pkg-1.20-1.8.19" = _sJQnQaMg;
        "pkg-1.20-1.8.20" = _5kujqgKn;
        "pkg-1.20-1.9.0" = _QEO0CrpO;
        "pkg-fabric_1.20-1.10.0" = _IKj5wbhH;
        "pkg-neoforge_1.20-2.0.0" = _xH13cuu8;
        "pkg-fabric_1.20-2.0.0" = _TQl3sj1z;
        "pkg-neoforge_1.20-2.0.2" = _iBzF4aPL;
        "pkg-fabric_1.20-2.0.2" = _zwjdnxxq;
        "pkg-1.20-2.0.0" = _15D70qSo;
        "pkg-1.20-2.0.1" = _kDOX4QqW;
        "pkg-neoforge_1.21-2.0.3" = _gPss13UC;
        "pkg-fabric_1.21-2.0.3" = _RaClaPUJ;
        "pkg-1.20-2.0.2" = _NRqFuyt1;
        "pkg-neoforge_1.21-2.0.4" = _W4kreeaE;
        "pkg-fabric_1.21-2.0.4" = _Ku7wBUSo;
        "pkg-fabric_1.21-2.0.5" = _ehPPBLBm;
        "pkg-1.20-2.0.3" = _o2545dR2;
        "pkg-fabric_1.21-2.0.6" = _d1TKoLnB;
        "pkg-neoforge_1.21-2.0.6" = _cW10IFuy;
        "pkg-1.20-2.0.5" = _LUaKZqUd;
        "pkg-1.20-2.0.6" = _L8421Hiw;
        "pkg-fabric_1.21-2.0.7" = _CSS3KuSz;
        "pkg-neoforge_1.21-2.0.7" = _4CScWyO3;
        "pkg-1.20-2.0.7" = _bJE2Owsg;
        "pkg-neoforge_1.21-2.0.8" = _J1XcbT7Q;
        "pkg-fabric_1.21-2.0.8" = _EVM2meAw;
        "pkg-fabric_1.21-2.0.9" = _WO6cRMMs;
        "pkg-neoforge_1.21-2.0.9" = _NXooLzAf;
        "pkg-1.20-2.0.8" = _NVB5pQRZ;
        "pkg-1.20-2.0.9" = _zAahRq2q;
        "pkg-1.21-2.0.11-fabric" = _tE6suZ1B;
        "pkg-1.21-2.0.11-neoforge" = _l7knRSW7;
        "pkg-1.20-2.0.11-fabric" = _ZRy2etbK;
        "pkg-1.20-2.0.11-forge" = _MHozEq9h;
        "pkg-1.21-2.0.12-fabric" = _X5fft3Vp;
        "pkg-1.21-2.0.12-neoforge" = _nnQq1ivl;
