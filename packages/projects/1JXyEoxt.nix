...
let
    ...
    in {
        ...
        "pkg-0.1.37" = _8KTRksHw;
        "pkg-0.1.371" = _y98ILPHa;
        "pkg-0.1.4" = _vRcTimSx;
        "pkg-0.1.41" = _ws2BMQsY;
        "pkg-0.2.1" = _kDEgwBE3;
        "pkg-0.2.11" = _W1NaNyee;
        "pkg-0.2.2" = _ssNdgAm0;
        "pkg-0.2.3" = _GpqLjCuD;
        "pkg-0.2.34" = _J2Y5fUQ8;
        "pkg-0.2.6" = _PW4HOndp;
        "pkg-0.2.61" = _518202Wj;
        "pkg-0.3" = _vkYHZZPO;
        "pkg-0.3.7" = _fANs5o6w;
        "pkg-0.3.8" = _qAzNMfiq;
        "pkg-0.3.9" = _SijPYasM;
        "pkg-0.3.10" = _lCWMxzwq;
        "pkg-0.3.11" = _G7k7N5yk;
        "pkg-0.3.20" = _jrHUtLQE;
        "pkg-0.3.40" = _Kq7tepoK;
        "pkg-0.3.41" = _ubj9uWey;
        "pkg-0.3.42" = _LF1iwPWZ;
        "pkg-0.3.43" = _3EqyxU6A;
        "pkg-0.5" = _zNtPvbdm;
        "pkg-0.5.1" = _dD11KAIi;
        "pkg-0.5.10" = _2HQmb1O6;
        "pkg-0.5.11" = _lttTaM5y;
        "pkg-0.5.35" = _veJRgOk4;
        "pkg-0.5.80" = _nA7ilJGY;
        "pkg-0.5.90" = _CB2jSyjG;
        "pkg-0.5.100" = _rqYqFjFq;
        "pkg-0.5.120" = _eWZfHsOM;
        "pkg-0.5.121" = _ruS1uDZl;
        "pkg-0.5.122" = _MsjZ6nMy;
        "pkg-0.5.124" = _rBxuYmiX;
        "pkg-0.7" = _JJ3thqVq;
        "pkg-0.7.1" = _LOENfSLo;
        "pkg-0.7.2" = _hQLcLPiy;
        "pkg-0.7.3" = _xyIgF4C5;
        "pkg-0.7.4" = _vPkOt1S1;
        "pkg-0.7.5" = _7oZjYOnY;
        "pkg-0.7.12" = _6DW2GCfQ;
        "pkg-0.7.13" = _5srBUFsm;
        "pkg-0.7.33" = _vRmt2kD2;
        "pkg-0.7.34" = _3RP86DWB;
        "pkg-0.7.36" = _G5JzE90O;
        "pkg-0.7.37" = _8oUOIvQQ;
        "pkg-0.7.40" = _QGe3N2le;
        "pkg-0.7.60" = _CVo9cHLs;
        "pkg-0.7.65" = _iYPsSB7Y;
        "pkg-0.7.75" = _CtEOaCI5;
        "pkg-0.7.80" = _SASAbIeV;
        "pkg-0.7.81" = _gE6DuhM9;
        "pkg-0.7.82" = _9Pf7XSs7;
        "pkg-0.7.83" = _GYK25YZD;
        "pkg-0.7.86" = _CHDOuJEI;
        "pkg-0.8.1" = _IPeukefH;
        "pkg-0.8.2" = _EjylbRI1;
        "pkg-0.8.3" = _YAAcla7o;
        "pkg-0.8.4" = _h2Gz01dJ;
