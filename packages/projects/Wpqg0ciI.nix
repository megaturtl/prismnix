...
let
    ...
    in {
        ...
        "pkg-0.4.1" = _dxizKYdX;
        "pkg-0.4.2" = _TgennJhb;
        "pkg-0.4.2+1.18" = _qXuA8OV5;
        "pkg-0.5.0+1.18.2" = _F9lg7SYM;
        "pkg-0.5.1+1.18.2" = _cDpBStay;
        "pkg-0.5.2+1.19" = _s4GYe0wd;
        "pkg-0.5.3+1.19.1" = _gHngc74e;
        "pkg-0.5.4+1.19.2" = _hp1m397f;
        "pkg-0.6.0+1.19.3" = _p1R8M2ad;
        "pkg-0.5.5+1.19.2" = _KBJV1uiw;
        "pkg-0.5.6+1.19.2" = _yrZ9v7k3;
        "pkg-0.6.1+1.19.3" = _oCGQKtvW;
        "pkg-0.5.7+1.19.2" = _ZVuCkrmv;
        "pkg-0.6.2+1.19.3" = _DMz4viUf;
        "pkg-0.5.8+1.19.2" = _bGhpoV7B;
        "pkg-0.6.3+1.19.3" = _LFwC8Fix;
        "pkg-0.6.4+1.19.3" = _4ntT7xAA;
        "pkg-0.5.9+1.19.2" = _vs24z3eV;
        "pkg-0.7.0+1.20" = _90JY9flG;
        "pkg-0.8.0+1.20.2" = _Ia1ERLRG;
        "pkg-0.9.0+1.20.3" = _thqvLfFf;
        "pkg-0.9.1+1.20.4" = _LU6oFMzf;
        "pkg-0.7.1+1.20.1" = _G7qtTNmv;
        "pkg-0.10.0+1.20.5" = _VD2tFHRQ;
        "pkg-0.11.0+1.21" = _S37McYpL;
        "pkg-0.11.1+1.21" = _GMuDA4dz;
        "pkg-0.12.0+1.21.2" = _CMFSA8q0;
        "pkg-0.13.0+1.21.5" = _QMzZYZEr;
        "pkg-0.14.0+1.21.6" = _6e0jRMjY;
        "pkg-0.14.1+1.21.8" = _8z3JvF12;
        "pkg-0.15.0+1.21.9" = _PgAlijwU;
        "pkg-0.15.1+1.21.10" = _2zeuDg72;
        "pkg-0.16.0+1.21.11" = _qjDhLCKi;
        "pkg-0.16.1+1.21.11" = _7Q8hHqkD;
