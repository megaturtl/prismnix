...
let
    ...
    in {
        ...
        "pkg-9.0.0+forge-1.19.3" = _bcrpyaLv;
        "pkg-7.0.0+forge-1.18.2" = _FM4hVVWW;
        "pkg-7.0.0+fabric-1.18.2" = _sDA8Obnr;
        "pkg-10.0.1+forge-1.19.4" = _rbn85Q6W;
        "pkg-10.0.1+fabric-1.19.4" = _wwnWCt8u;
        "pkg-11.0.0+fabric-1.20" = _MdrVHJ3E;
        "pkg-11.0.0+forge-1.20" = _iDRWKKb2;
        "pkg-11.0.1+fabric-1.20" = _a1pSiK6X;
        "pkg-11.0.1+forge-1.20" = _BYB6xiNY;
        "pkg-12.0.0+fabric-1.20.2" = _WVVx8wYd;
        "pkg-12.0.0+forge-1.20.2" = _iIjXhTGZ;
        "pkg-12.0.0+neoforge-1.20.2" = _UwI5sQBf;
        "pkg-13.0.1+fabric-1.20.4" = _HmgMIHpD;
        "pkg-13.0.1+forge-1.20.4" = _swNUaQ8P;
        "pkg-13.0.1+neoforge-1.20.4" = _OfHwaAfn;
        "pkg-14.0.1+fabric-1.20.6" = _3jvcTfXW;
        "pkg-14.0.1+forge-1.20.6" = _IDF33AKF;
        "pkg-14.0.1+neoforge-1.20.6" = _5mEVRIh5;
        "pkg-14.0.2+fabric-1.20.6" = _iqHYLpOl;
        "pkg-14.0.2+forge-1.20.6" = _hFu4O5Zq;
        "pkg-14.0.2+neoforge-1.20.6" = _5rYQx2Ng;
        "pkg-21.0.1+fabric-1.21" = _5VBnqqWR;
        "pkg-21.0.1+forge-1.21" = _Wezu0B1d;
        "pkg-21.0.1+neoforge-1.21" = _zFHQpIIp;
        "pkg-21.0.2+fabric-1.21" = _2iGkxHfl;
        "pkg-21.0.2+forge-1.21" = _s9nq72OC;
        "pkg-21.0.2+neoforge-1.21" = _CteT9kPW;
        "pkg-21.1.1+fabric-1.21.1" = _Ig7LqDc4;
        "pkg-21.1.1+forge-1.21.1" = _Pc8qp2Sh;
        "pkg-21.1.1+neoforge-1.21.1" = _4sjpNrnC;
        "pkg-21.3.1+fabric-1.21.3" = _Vd0yp1db;
        "pkg-21.3.1+neoforge-1.21.3" = _MKRaI3sA;
        "pkg-21.1.2+fabric-1.21.1" = _Mq6QS4bU;
        "pkg-21.3.2+fabric-1.21.3" = _NgZKz7NP;
        "pkg-21.1.2+neoforge-1.21.1" = _w4oGQbta;
        "pkg-21.1.2+forge-1.21.1" = _7wdOUPav;
        "pkg-21.3.2+neoforge-1.21.3" = _Dc3K4eCW;
        "pkg-21.4.1+fabric-1.21.4" = _mEiOviZR;
        "pkg-21.4.1+neoforge-1.21.4" = _h2n1CBzB;
        "pkg-21.4.2+forge-1.21.4" = _dvgKB0Yw;
        "pkg-21.5.1+fabric-1.21.5" = _P1sMYDMM;
        "pkg-21.5.1+neoforge-1.21.5" = _mYzWesPF;
        "pkg-21.5.2+forge-1.21.5" = _USG1Yr10;
        "pkg-21.6.1+fabric-1.21.6" = _4W2mZYw5;
        "pkg-21.6.1+neoforge-1.21.6" = _wgTicfXJ;
        "pkg-21.6.2+forge-1.21.6" = _OjJ2uEzz;
        "pkg-21.7.1+fabric-1.21.7" = _L6AYkjEz;
        "pkg-21.7.1+neoforge-1.21.7" = _WsE0rmdS;
        "pkg-21.7.1+forge-1.21.7" = _dsSou7RR;
        "pkg-21.8.1+fabric-1.21.8" = _L5mWXYn8;
        "pkg-21.8.1+neoforge-1.21.8" = _pYPdfFRQ;
        "pkg-21.8.1+forge-1.21.8" = _TmNbzUv3;
        "pkg-21.9.1+neoforge-1.21.9" = _VRpQ7S95;
        "pkg-21.9.1+fabric-1.21.9" = _tbkPBJ3r;
        "pkg-21.10.1+forge-1.21.10" = _tH9vTvRi;
        "pkg-21.10.1+fabric-1.21.10" = _Ie47E9q9;
        "pkg-21.10.1+neoforge-1.21.10" = _Y4MsalXg;
        "pkg-21.11.2+fabric-1.21.11" = _yV12aw3b;
        "pkg-21.11.2+neoforge-1.21.11" = _tbACdx1P;
        "pkg-21.11.4+fabric-1.21.11" = _PKaYA3rG;
        "pkg-21.11.4+forge-1.21.11" = _dML8yj6e;
        "pkg-21.11.4+neoforge-1.21.11" = _wLZl4ynL;
        "pkg-26.1.0.1+fabric-26.1" = _LucuEBA3;
        "pkg-26.1.0.1+neoforge-26.1" = _XABCLLeb;
        "pkg-21.1.3+fabric-1.21.1" = _9HFliMyB;
        "pkg-21.1.3+neoforge-1.21.1" = _LUwXmCVo;
