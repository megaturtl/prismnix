...
let
    versions = (let
        ...
        _zZdIaENs = {
            "id" = "zZdIaENs";
            "file" = "! §3§6Small Held Items v2.0 (1.8).zip";
            "hash" = "sha512-rv1Q+XZaQDsuVBSMRP+Bxd3PkuZcu2PZP6hPmrkHusx4mUg7lp+sAXPPwHozC4pKEIDrKyxV5erb5ZMI7O4n8g==";
        };
        _FkItsNtU = {
            "id" = "FkItsNtU";
            "file" = "! §3§6Small Held Items v2.1 (1.20).zip";
            "hash" = "sha512-DqnFLpyK1eK5l8uzjBL54qqTuOFqcPcxroEL54SF1K8h8OeeRRHIVUnbrKFQS78VgSwR9BCfBM5ueGGa2y/A1Q==";
        };
        _3sFQmvjk = {
            "id" = "3sFQmvjk";
            "file" = "! §3§6Small Held Items v2.1.zip";
            "hash" = "sha512-cpfgUG1Vp4cnC2BxjTtNCGSGExFPdMcc03cd5DjV7vfmEmktlhsIrX6csUf2nNTyxkDEYk3lyg12ai0J2rDd4Q==";
        };
    in {
        "ic6QY6FP" = _ic6QY6FP;
        "D472Ee4R" = _D472Ee4R;
        ...
        "FkItsNtU" = _FkItsNtU;
        "3sFQmvjk" = _3sFQmvjk;
        "minecraft-1.20" = _FkItsNtU;
        "minecraft-1.20.1" = _FkItsNtU;
        "minecraft-1.20.2" = _FkItsNtU;
        "minecraft-1.20.3" = _FkItsNtU;
        "minecraft-1.20.4" = _FkItsNtU;
        "minecraft-1.8.9" = _zZdIaENs;
        "minecraft-24w04a" = _jXv1JnZO;
        "minecraft-1.20.5" = _FkItsNtU;
        "minecraft-1.20.6" = _FkItsNtU;
        "minecraft-1.8" = _zZdIaENs;
        "minecraft-1.8.1" = _zZdIaENs;
        "minecraft-1.8.2" = _zZdIaENs;
        "minecraft-1.8.3" = _zZdIaENs;
        "minecraft-1.8.4" = _zZdIaENs;
        "minecraft-1.8.5" = _zZdIaENs;
        "minecraft-1.8.6" = _zZdIaENs;
        "minecraft-1.8.7" = _zZdIaENs;
        "minecraft-1.8.8" = _zZdIaENs;
        ...
        "minecraft-1.21.1" = _3sFQmvjk;
        "minecraft-1.21.2" = _3sFQmvjk;
        "minecraft-1.21.3" = _3sFQmvjk;
        "minecraft-1.21.4" = _3sFQmvjk;
        "minecraft-1.21.5" = _3sFQmvjk;
        "minecraft-1.21.6" = _3sFQmvjk;
        "minecraft-1.21.7" = _3sFQmvjk;
        "minecraft-1.21.8" = _3sFQmvjk;
        "minecraft-1.21.9" = _3sFQmvjk;
        "minecraft-1.21.10" = _3sFQmvjk;
        "minecraft-1.21.11" = _3sFQmvjk;
        "minecraft-26.1" = _3sFQmvjk;
        "minecraft-26.1.1" = _3sFQmvjk;
        "minecraft-26.1.2" = _3sFQmvjk;
        "minecraft-26.2" = _3sFQmvjk;
        "minecraft-24w33a" = _3sFQmvjk;
        "minecraft-24w34a" = _3sFQmvjk;
        "minecraft-24w35a" = _3sFQmvjk;
        "minecraft-24w36a" = _3sFQmvjk;
        "minecraft-24w37a" = _3sFQmvjk;
        "minecraft-24w38a" = _3sFQmvjk;
        "minecraft-24w39a" = _3sFQmvjk;
        "minecraft-24w40a" = _3sFQmvjk;
        "minecraft-1.21.2-pre1" = _3sFQmvjk;
        "minecraft-1.21.2-pre2" = _3sFQmvjk;
        "minecraft-24w44a" = _3sFQmvjk;
        "minecraft-24w45a" = _3sFQmvjk;
        "minecraft-24w46a" = _3sFQmvjk;
        "minecraft-26.3" = _3sFQmvjk;
        "pkg-1.0" = _D472Ee4R;
        "pkg-1.1" = _ue2xzDm9;
        "pkg-1.2" = _jXv1JnZO;
        "pkg-1.3" = _Wul6ySrv;
        "pkg-1.8.9+Raised-Blocks" = _UXUR2hGf;
        "pkg-1.8.9+Smaller-Models" = _25WwTUg8;
        "pkg-1.20+Raised-Blocks" = _ZzurLJfS;
        "pkg-1.20+" = _ZH4MTu0d;
        "pkg-1.9-1.12" = _lbmJ10oQ;
        "pkg-1.5" = _z9NtQLEY;
        "pkg-1.0.1+1.8.9" = _O1XeYNkV;
        "pkg-1.6" = _7w0ErwdU;
        "pkg-1.6.1" = _UNaIvQlI;
        "pkg-1.7" = _3We3LZWC;
        "pkg-1.8" = _MKFDBZFX;
        ...
        "pkg-2.0" = _sw3YxpZa;
        "pkg-2.0.1" = _DBbcNUXp;
        "pkg-2.0+1.8" = _zZdIaENs;
        "pkg-2.1+1.20" = _FkItsNtU;
        "pkg-2.1" = _3sFQmvjk;
        "default" = _3sFQmvjk;
    });
