...
let
    versions = (let
        ...
        _JfgjDPYD = {
            "id" = "JfgjDPYD";
            "file" = "boids-2.0.0+26.3.jar";
            "hash" = "sha512-Buh0yUmUyJI8ydWKNJSmoYKFehAcNBcIzJNhsbb0EudH48pfZKWKo3eARGC8zwacR6ZY/ovsVIW9v3pzZn4KLQ==";
        };
    in {
        "7uczXO1W" = _7uczXO1W;
        "OeCnoEPH" = _OeCnoEPH;
        ...
        "fabric-26.2" = _JfgjDPYD;
        "fabric-26.3" = _JfgjDPYD;
        "pkg-1.0-SNAPSHOT" = _7uczXO1W;
        "pkg-1.0.1" = _OeCnoEPH;
        "pkg-1.0.2" = _4WKWsWgF;
        "pkg-1.1.0" = _iU8B8Wkw;
        "pkg-1.1.1" = _Csm1PGkd;
        ...
        "pkg-1.2.2" = _14pDAJuk;
        "pkg-1.2.3" = _aiZEd0aD;
        "pkg-2.0.0+1.20" = _IYbVowuU;
        "pkg-2.0.0+1.21" = _z1T8Je3v;
        "pkg-2.0.0+1.21.2" = _ZeTk3V1R;
        "pkg-2.0.1+1.20.1" = _TrWlQfv8;
        "pkg-2.0.1+1.21.2" = _Vuharezw;
        "pkg-2.0.1+1.21" = _WKjzEyfQ;
        "pkg-2.0.2+1.21" = _VIDZDUrg;
        "pkg-2.0.2+1.20.1" = _Ai3cFkVx;
        "pkg-2.0.2+1.21.9" = _vAzn6k95;
        "pkg-2.0.3+1.21" = _xd4U8QOr;
        "pkg-2.0.3+1.21.9" = _GgZv2zOy;
        "pkg-2.0.0+1.21.11" = _TUt4OEVW;
        "pkg-2.0.3+1.20.1" = _MewtMK1Z;
        "pkg-2.0.4+1.21.9" = _cRzyTDW6;
        "pkg-2.0.4+1.21" = _7Wk4e9Zz;
        "pkg-2.0.3+1.21.2" = _8tWZuSFZ;
        "pkg-2.0.1+1.21.11" = _UJvbQbAv;
        "pkg-2.0.0+26.1" = _smefztgO;
        "pkg-2.0.0+26.2" = _Bjg3IAg6;
        "pkg-2.0.0+26.3" = _JfgjDPYD;
        "default" = _JfgjDPYD;
    });
