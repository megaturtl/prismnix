...
let
    versions = (let
        ...
        _SZsNp7J6 = {
            "id" = "SZsNp7J6";
            "file" = "RandomMobSizes_datapack.zip";
            "hash" = "sha512-WF3D2kZrTzTeGs5XXPiS7uV+DlCXWrPNqqJkhzzU3aQFjBARIbdbeET0+4jlfFn/YWpbZD7stLx91WrCwoqApg==";
        };
        _VojK2xcR = {
            "id" = "VojK2xcR";
            "file" = "RandomMobSizes_fabric_mod.jar";
            "hash" = "sha512-yYfZ0vOQY+YNDXYBkwyUmpJ2Mm7s6BGw4ZKIzkgiOExmDqwBYIn7KRtMTuxlbdXgwxR0/JAlUhKYZtNXdTL+7w==";
        };
        _UQHpxPyS = {
            "id" = "UQHpxPyS";
            "file" = "RandomMobSizes_forge_mod.jar";
            "hash" = "sha512-cWdiDQZeKcDOy2uzuPTb/iTuvhZveX2noWius9aoVHpcV/Ejl8p5BgebEGbwmNyzKwVwGIzb7T08xlg5tyE54g==";
        };
        _uDHvIPFm = {
            "id" = "uDHvIPFm";
            "file" = "RandomMobSizes_neoforge_mod.jar";
            "hash" = "sha512-eaKBjfbDXqqBiOw7509IagfaO5sT2O21oXdpnR6TgD/WXWI38AW0CiNTr0U0k3kIY+yzW4y79wkKtWyow8Vhzw==";
        };
        _XTW4e9ZV = {
            "id" = "XTW4e9ZV";
            "file" = "RandomMobSizes_quilt_mod.jar";
            "hash" = "sha512-+lp1alc32DExokPy54s7I8zv7ZnUlQfwbkifZHVSU/FuNMkt54ESwlXK/7Q3bON5EE0U1AveldlR+nnaJ+eJMw==";
        };
        _riidlkuO = {
            "id" = "riidlkuO";
            "file" = "RandomMobSizes_datapack.zip";
            "hash" = "sha512-fPlWceh1f2lKtVDbeX2l2N1bnIlBWtZICzGxMAf3EzRnuvKAyd9q8QzRuoBgVGAMXxz6E2Ib+GW7NGopSQgq/w==";
        };
        _3ZjvjsHC = {
            "id" = "3ZjvjsHC";
            "file" = "RandomMobSizes_fabric_mod.jar";
            "hash" = "sha512-i5YK77EL9pnMDMas19VsPyKkh/0tng09q+YzgUQNPnrR1ehAdjYqH+PX1/BgHX5H4yyeGQI6qANOTgfvat5nXw==";
        };
        _Og3jMb0h = {
            "id" = "Og3jMb0h";
            "file" = "RandomMobSizes_forge_mod.jar";
            "hash" = "sha512-Ce+WGK1GiIQM4wTWrcb9tYHwvo0kJmKVS6Y2Zoxx0XYXQR1mVrrx5WiFvdDRRs3w3jr1zdjKL5Tuztka1eM/pA==";
        };
        _OftgyLRr = {
            "id" = "OftgyLRr";
            "file" = "RandomMobSizes_neoforge_mod.jar";
            "hash" = "sha512-dmem2sIJmnV6k8cKg33f1Z+QxM0x7M9xfL3U9H534AwsA2TTuo/pHXEFFjv0pb9JWo5n9cxeFF3Um/2VJ0e/VQ==";
        };
        _x43Sp9we = {
            "id" = "x43Sp9we";
            "file" = "RandomMobSizes_quilt_mod.jar";
            "hash" = "sha512-GNTv3UfwiHHC+DCYc9afRO4SWXG15emwrjl+OBSFCrvgXy6g+YcD6DMyPA+qKgmw4OyY3LwJXyrXsbYVKjAxIA==";
        };
    in {
        "L6qgC6il" = _L6qgC6il;
        "7tfhDKfw" = _7tfhDKfw;
        ...
        "datapack-1.21.2" = _riidlkuO;
        "datapack-1.21.3" = _riidlkuO;
        "datapack-1.21.4" = _riidlkuO;
        "datapack-1.21.5" = _riidlkuO;
        "datapack-1.21.6" = _riidlkuO;
        "datapack-1.21.7" = _riidlkuO;
        "datapack-1.21.8" = _riidlkuO;
        "datapack-1.21.9" = _riidlkuO;
        "datapack-1.21.10" = _riidlkuO;
        ...
        "datapack-1.21.11" = _riidlkuO;
        "datapack-26.1" = _riidlkuO;
        "datapack-26.1.1" = _riidlkuO;
        "datapack-26.1.2" = _riidlkuO;
        "datapack-26.2" = _riidlkuO;
        "datapack-26.3" = _riidlkuO;
        "fabric-1.20.5" = _7tfhDKfw;
        "fabric-1.20.6" = _7tfhDKfw;
        "fabric-1.21" = _te5tlQ52;
        "fabric-1.21.1" = _te5tlQ52;
        "fabric-1.21.2" = _3ZjvjsHC;
        "fabric-1.21.3" = _3ZjvjsHC;
        "fabric-1.21.4" = _3ZjvjsHC;
        "fabric-1.21.5" = _3ZjvjsHC;
        "fabric-1.21.6" = _3ZjvjsHC;
        "fabric-1.21.7" = _3ZjvjsHC;
        "fabric-1.21.8" = _3ZjvjsHC;
        "fabric-1.21.9" = _3ZjvjsHC;
        "fabric-1.21.10" = _3ZjvjsHC;
        "fabric-25w41a" = _exQCKi44;
        "fabric-25w42a" = _exQCKi44;
        "fabric-25w43a" = _exQCKi44;
        "fabric-25w44a" = _exQCKi44;
        "fabric-25w45a" = _exQCKi44;
        "fabric-1.21.11" = _3ZjvjsHC;
        "fabric-26.1" = _3ZjvjsHC;
        "fabric-26.1.1" = _3ZjvjsHC;
        "fabric-26.1.2" = _3ZjvjsHC;
        "fabric-26.2" = _3ZjvjsHC;
        "fabric-26.3" = _3ZjvjsHC;
        "forge-1.20.5" = _7tfhDKfw;
        "forge-1.20.6" = _7tfhDKfw;
        "forge-1.21" = _te5tlQ52;
        "forge-1.21.1" = _te5tlQ52;
        "forge-1.21.2" = _Og3jMb0h;
        "forge-1.21.3" = _Og3jMb0h;
        "forge-1.21.4" = _Og3jMb0h;
        "forge-1.21.5" = _Og3jMb0h;
        "forge-1.21.6" = _Og3jMb0h;
        "forge-1.21.7" = _Og3jMb0h;
        "forge-1.21.8" = _Og3jMb0h;
        "forge-1.21.9" = _Og3jMb0h;
        "forge-1.21.10" = _Og3jMb0h;
        "forge-25w41a" = _iRravL6c;
        "forge-25w42a" = _iRravL6c;
        "forge-25w43a" = _iRravL6c;
        "forge-25w44a" = _iRravL6c;
        "forge-25w45a" = _iRravL6c;
        "forge-1.21.11" = _Og3jMb0h;
        "forge-26.1" = _Og3jMb0h;
        "forge-26.1.1" = _Og3jMb0h;
        "forge-26.1.2" = _Og3jMb0h;
        "forge-26.2" = _Og3jMb0h;
        "forge-26.3" = _Og3jMb0h;
        "quilt-1.20.5" = _7tfhDKfw;
        "quilt-1.20.6" = _7tfhDKfw;
        "quilt-1.21" = _te5tlQ52;
        "quilt-1.21.1" = _te5tlQ52;
        "quilt-1.21.2" = _x43Sp9we;
        "quilt-1.21.3" = _x43Sp9we;
        "quilt-1.21.4" = _x43Sp9we;
        "quilt-1.21.5" = _x43Sp9we;
        "quilt-1.21.6" = _x43Sp9we;
        "quilt-1.21.7" = _x43Sp9we;
        "quilt-1.21.8" = _x43Sp9we;
        "quilt-1.21.9" = _x43Sp9we;
        "quilt-1.21.10" = _x43Sp9we;
        "quilt-25w41a" = _Tjzonoqx;
        "quilt-25w42a" = _Tjzonoqx;
        "quilt-25w43a" = _Tjzonoqx;
        "quilt-25w44a" = _Tjzonoqx;
        "quilt-25w45a" = _Tjzonoqx;
        "quilt-1.21.11" = _x43Sp9we;
        "quilt-26.1" = _x43Sp9we;
        "quilt-26.1.1" = _x43Sp9we;
        "quilt-26.1.2" = _x43Sp9we;
        "quilt-26.2" = _x43Sp9we;
        "quilt-26.3" = _x43Sp9we;
        "neoforge-1.21.2" = _OftgyLRr;
        "neoforge-1.21.3" = _OftgyLRr;
        "neoforge-1.21.4" = _OftgyLRr;
        "neoforge-1.21.5" = _OftgyLRr;
        "neoforge-1.21.6" = _OftgyLRr;
        "neoforge-1.21.7" = _OftgyLRr;
        "neoforge-1.21.8" = _OftgyLRr;
        "neoforge-1.21.9" = _OftgyLRr;
        "neoforge-1.21.10" = _OftgyLRr;
        ...
        "neoforge-1.21.11" = _OftgyLRr;
        "neoforge-26.1" = _OftgyLRr;
        "neoforge-26.1.1" = _OftgyLRr;
        "neoforge-26.1.2" = _OftgyLRr;
        "neoforge-26.2" = _OftgyLRr;
        "neoforge-26.3" = _OftgyLRr;
        "pkg-1.0" = _L6qgC6il;
        ...
        "pkg-1.3.6" = _SZsNp7J6;
        "pkg-1.3.6+fabric" = _VojK2xcR;
        "pkg-1.3.6+forge" = _UQHpxPyS;
        "pkg-1.3.6+neoforge" = _uDHvIPFm;
        "pkg-1.3.6+quilt" = _XTW4e9ZV;
        "pkg-1.3.7" = _riidlkuO;
        "pkg-1.3.7+fabric" = _3ZjvjsHC;
        "pkg-1.3.7+forge" = _Og3jMb0h;
        "pkg-1.3.7+neoforge" = _OftgyLRr;
        "pkg-1.3.7+quilt" = _x43Sp9we;
        "default" = _x43Sp9we;
    });
