...
let
    versions = (let
        ...
        _b8PS3VmQ = {
            "id" = "b8PS3VmQ";
            "file" = "ProgrammerArtFix-26.3.zip";
            "hash" = "sha512-x4GCN6qYzqhNMslpmSFDM45PDh1knratIarVYb7qvxfgcjNOGSEHlbs7geNos6FBBZS7734gs8tfPdbU4wsXQg==";
        };
    in {
        "7dI20tmx" = _7dI20tmx;
        "AVzwNwMG" = _AVzwNwMG;
        ...
        "minecraft-26.1" = _b8PS3VmQ;
        "minecraft-26.1.1" = _b8PS3VmQ;
        "minecraft-26.1.2" = _b8PS3VmQ;
        "minecraft-26w14a" = _7HjFPhb9;
        "minecraft-26.2" = _b8PS3VmQ;
        "minecraft-26.3" = _b8PS3VmQ;
        "pkg-1.13-rv1" = _7dI20tmx;
        "pkg-1.14-rv5" = _AVzwNwMG;
        "pkg-1.15-rv5" = _hePBtsfV;
        "pkg-1.16.2-rv4" = _NqS8p2qy;
        "pkg-1.17-rv2.1" = _a2nJfE8s;
        "pkg-1.18-rv2.1" = _Qo3lZ2rN;
        "pkg-1.19-rv1.4" = _qNyrNU2T;
        "pkg-1.19.4-rv3.1" = _R2QyKqP1;
        "pkg-1.20.0-rv1" = _mWLEtx8G;
        "pkg-1.20.0-rv1.5" = _pXCDcBq0;
        "pkg-1.20.2-beta2" = _eL6MVfog;
        "pkg-1.20.2-rv1" = _UZ24TFG8;
        "pkg-1.13-rv2" = _zLj5Ufwu;
        "pkg-1.14-rv6" = _jnYwZTMI;
        "pkg-1.15-rv6" = _pEkactMM;
        "pkg-1.16.5-rv5" = _618cnCZH;
        "pkg-1.17.x-rv3" = _OOjjaYXH;
        "pkg-1.18.x-rv3" = _XJhBNWiC;
        "pkg-1.19.2-rv1.5" = _8dMuQQk3;
        "pkg-1.19.4-rv3.5" = _Rjg69Uoh;
        "pkg-1.20.1-rv1.6" = _MkANAo3x;
        "pkg-1.20.2-rv2.1" = _Bv58QXJA;
        "pkg-1.20.2-rv3" = _BBwV4QbL;
        "pkg-april-fools-2024" = _JJXBZGF3;
        "pkg-1.20.2-rv4" = _q4KY4NkU;
        "pkg-1.20.3-1.21-v4" = _G4Hbnlni;
        "pkg-1.20.3-1.21-v5" = _ochpLRtD;
        "pkg-ore-v1" = _nTzF24EG;
        "pkg-1.21-rv1" = _7rObPovg;
        "pkg-1.20.6-rv5" = _bL0ySOd0;
        "pkg-1.21.x-rv2" = _1MM13Ya2;
        "pkg-1.20.6-rv5.1" = _NVIR9DwK;
        "pkg-1.21-rv2.1" = _MwmI3dqm;
        "pkg-1.21.x-rv2.2" = _Wc1f2XsM;
        "pkg-WinterDrop-v1" = _bgwX5qEs;
        "pkg-1.13-rv3" = _pmiCNunk;
        "pkg-1.14-rv7" = _3E7zxcjj;
        "pkg-1.15-rv7" = _4IL8tkWr;
        "pkg-1.16.5-rv6" = _ZWvUyyxz;
        "pkg-1.17-rv4" = _4aCx4GNl;
        "pkg-1.18-rv4" = _HkIxIljG;
        "pkg-1.19.2-rv2" = _Jfr5a6hT;
        "pkg-1.19.4-rv4" = _oSiigbYM;
        "pkg-1.20.1-rv2" = _UrPw7ash;
        "pkg-1.20.6-rv5.2" = _V2x0x4ub;
        "pkg-1.21-rv2.3" = _XEyJS2Qf;
        "pkg-1.20.6-rv5.3" = _Pxvak36i;
        "pkg-1.21-rv3" = _LROtaSeO;
        "pkg-1.21-rv3.1" = _HlFVhWPh;
        "pkg-1.20.1-rv3" = _YGrrO8FL;
        "pkg-1.20.6-rv5.4" = _bw5tno3X;
        "pkg-1.21-beta3.8" = _uhDL6s25;
        "pkg-1.21-rv4" = _osdy6sGa;
        "pkg-april-fools-2025" = _3wDWZT7t;
        "pkg-1.20.1-rv3.1" = _PNK9uliZ;
        "pkg-1.20.6-rv5.5" = _K2HObLBf;
        "pkg-1.21-rv4.2" = _VC00wgbA;
        "pkg-1.21-rv5" = _gO3uKxF6;
        "pkg-1.21-rv5.1" = _gvqLkaoI;
        "pkg-1.21-rv5.2" = _bbTWqb8b;
        "pkg-6.0" = _L8n8Gl5P;
        "pkg-26.1" = _ii4P15lP;
        "pkg-26.4.1" = _7HjFPhb9;
        "pkg-6.1" = _yDeICIYV;
        "pkg-26.2" = _nMUU9xyH;
        "pkg-26.3" = _b8PS3VmQ;
        "default" = _b8PS3VmQ;
