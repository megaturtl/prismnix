...
let
    ...
    in {
        ...
        "pkg-1.1.2" = _4PaXmK8r;
        "pkg-1.1.3" = _U8PFXfV0;
        "pkg-1.1.3.1" = _w1gxeF7q;
        "pkg-1.1.4.1" = _o8eQMqB8;
        "pkg-1.1.4.1a" = _5apq41oC;
        "pkg-1.1.4.2a" = _hyaukVEk;
        "pkg-1.1.4.3" = _VEy3r09y;
        "pkg-1.1.4.3a" = _2pmshlL5;
        "pkg-1.1.4.3s" = _2FIjSLDc;
        "pkg-1.1.4.4" = _duZgHBFE;
        "pkg-1.1.4.4a" = _J6m960Oz;
        "pkg-1.1.4.4b" = _reipT5vW;
        "pkg-1.1.4.5" = _FZ0NlRY9;
        "pkg-1.1.4.5a" = _T1iI9nbI;
        "pkg-1.1.4.6" = _3c41N9EX;
        "pkg-1.1.4.6a" = _1XAHKmdt;
        "pkg-1.1.4.7" = _w7t0bjQi;
        "pkg-1.1.4.7a" = _1TUd79mp;
        "pkg-1.1.4.8" = _CPnUfQzc;
