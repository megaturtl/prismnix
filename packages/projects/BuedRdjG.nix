...
let
    versions = (let
        ...
        _E0wzAReO = {
            "id" = "E0wzAReO";
            "file" = "strong-leads-1.0.0+26.3.jar";
            "hash" = "sha512-3X+tNgLFpH2nKXjScZZtw+iOjW96d6tBf4/Y4EpoRDU5/fdVMNyQ6Qjybi/0FK/7+BOeyLXeEsxVIFpA3H0t+Q==";
        };
    in {
        "qkgRi0Tu" = _qkgRi0Tu;
        "bI36kUgu" = _bI36kUgu;
