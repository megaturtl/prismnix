...
let
    versions = (let
        ...
        _l4dDediD = {
            "id" = "l4dDediD";
            "file" = "Pixel Perfection Fidelity vBP-2.0-1-2a  1.6.1-1.8.9.zip";
            "hash" = "sha512-qb50cliee6qBxFrjXnTIjN0psbXX0Htd8Inm5E1DVu1TRcv8j4+CY3TtWjCH4JvWGnE8meJjT52KefcE8d0fmQ==";
        };
        _ojtmGwWH = {
            "id" = "ojtmGwWH";
            "file" = "Pixel Perfection Fidelity vBP-2.0-1-3a  1.7.10.zip";
            "hash" = "sha512-eaY4cwkm2e5XQIniRqQw1wcnp7/iBSTJtE04XvlzqqajoiAVKjxDLNxdJCsdyNdzX2zruaqI7v0C72d8h1wixQ==";
        };
        _x4K5tiVu = {
            "id" = "x4K5tiVu";
            "file" = "Pixel Perfection Fidelity vBP-2.0-3-2a  1.11-1.12.2.zip";
            "hash" = "sha512-NK+qCNmwiHiBmmmQyBkgfz2pxg276UAXtyh5PtZ+wDDJCOPTZ2GP1YIVlnQ0mm+prDksHGPA/iPQCcHtKQlHTg==";
        };
        _5CZ3GSee = {
            "id" = "5CZ3GSee";
    ...
    in {
        ...
        "minecraft-1.6.1" = _l4dDediD;
        "minecraft-1.6.2" = _l4dDediD;
        "minecraft-1.6.4" = _l4dDediD;
        "minecraft-1.7.2" = _l4dDediD;
        "minecraft-1.7.3" = _l4dDediD;
        "minecraft-1.7.4" = _l4dDediD;
        "minecraft-1.7.5" = _l4dDediD;
        "minecraft-1.7.6" = _l4dDediD;
        "minecraft-1.7.7" = _l4dDediD;
        "minecraft-1.7.8" = _l4dDediD;
        "minecraft-1.7.9" = _l4dDediD;
        "minecraft-1.7.10" = _ojtmGwWH;
        "minecraft-1.8" = _l4dDediD;
        "minecraft-1.8.1" = _l4dDediD;
        "minecraft-1.8.2" = _l4dDediD;
        "minecraft-1.8.3" = _l4dDediD;
        "minecraft-1.8.4" = _l4dDediD;
        "minecraft-1.8.5" = _l4dDediD;
        "minecraft-1.8.6" = _l4dDediD;
        "minecraft-1.8.7" = _l4dDediD;
        "minecraft-1.8.8" = _l4dDediD;
        "minecraft-1.8.9" = _l4dDediD;
        "minecraft-1.5.1" = _6Qf1T1X4;
        "minecraft-1.5.2" = _6Qf1T1X4;
        "minecraft-1.5" = _6Qf1T1X4;
        "minecraft-1.9" = _5CZ3GSee;
        "minecraft-1.9.1" = _5CZ3GSee;
        "minecraft-1.9.2" = _5CZ3GSee;
        "minecraft-1.9.3" = _5CZ3GSee;
        "minecraft-1.9.4" = _5CZ3GSee;
        "minecraft-1.10" = _5CZ3GSee;
        "minecraft-1.10.1" = _5CZ3GSee;
        "minecraft-1.10.2" = _5CZ3GSee;
        "minecraft-1.11" = _x4K5tiVu;
        "minecraft-1.11.1" = _x4K5tiVu;
        "minecraft-1.11.2" = _x4K5tiVu;
        "minecraft-1.12" = _x4K5tiVu;
        "minecraft-1.12.1" = _x4K5tiVu;
        "minecraft-1.12.2" = _x4K5tiVu;
