...
let
    ...
    in {
        ...
        "pkg-1.1.0-1.20.1" = _441BcWnB;
        "pkg-1.1.0-1.20.2" = _mAIDhQ8e;
        "pkg-1.1.0-1.19.4" = _4yo5BU5p;
        "pkg-1.0.2-1.19.2" = _3ey2KNYL;
        "pkg-1.2.0" = _N93scnEn;
        "pkg-1.2.1" = _hxBErb0V;
        "pkg-1.2.2" = _t8TgCZ71;
        "pkg-1.3.0" = _yQeKaMlb;
        ...
        "pkg-1.3.5" = _U5KahCRT;
        "pkg-1.4.0" = _o0gjzaPC;
        "pkg-1.4.0-Sinytra" = _k8DmDKS0;
        "pkg-1.4.1" = _90s5u1nF;
        "pkg-1.4.1-Sinytra" = _aVMEt2KF;
        "pkg-1.4.2-Sinytra" = _NUF80xB3;
        "pkg-1.4.2" = _MvdOaCtA;
        "pkg-1.4.3" = _62FI7yIM;
        "pkg-1.4.3-Sinytra" = _lm0TaOx1;
        "pkg-1.4.4" = _I4rbfevS;
        "pkg-1.5.0-forge" = _EOH1EiT1;
        "pkg-1.5.0-fabric" = _xpCb3t8b;
        "pkg-1.5.1-forge" = _ocVZpUxb;
        "pkg-1.5.1-fabric" = _If0idp4G;
        "pkg-1.5.1-neoforge" = _zCGfWzcA;
        "pkg-1.5.2-fabric" = _f5WBnviO;
        "pkg-1.5.2-neoforge" = _V9FdEmtE;
        "pkg-1.5.2-forge" = _rIVZ6AkV;
        "pkg-1.5.3-forge" = _Oh9Cw2gy;
        "pkg-1.5.3-fabric" = _mCxNNhgF;
        "pkg-1.5.3-neoforge" = _gHtzPaZY;
        "pkg-1.5.4-forge" = _b1axY1AO;
        "pkg-1.5.4-fabric" = _7AoTCvsa;
        "pkg-1.5.4-neoforge" = _LfdJVCH9;
        "pkg-1.5.5-neoforge" = _1DTuj8UO;
        "pkg-1.5.5-fabric" = _6EfLaKkB;
        "pkg-1.6-forge" = _kgnI2hV5;
        "pkg-1.6-fabric" = _adTDpm3n;
        "pkg-1.6.1-fabric" = _xbJo5mhS;
        "pkg-1.6.1-forge" = _xJNBdR1b;
        "pkg-1.6.2-fabric" = _PeppH9hn;
        "pkg-1.6.2-forge" = _aBXygbpB;
        "pkg-1.6.3-forge" = _EX6crXHH;
        "pkg-1.6.3-fabric" = _kVRa2MJf;
        "pkg-1.6.4-forge" = _EEDxmjkY;
        "pkg-1.6.4-fabric" = _dtXURzIt;
        "pkg-1.6.5-forge" = _Q1VYZ7bM;
        "pkg-1.6.5-fabric" = _zgKmZOSd;
        "pkg-1.6.5-neoforge" = _49Eue9RH;
        "pkg-1.6.6-forge" = _BewenOXY;
        "pkg-1.6.6-fabric" = _2GaQPNE9;
        "pkg-1.6.6-neoforge" = _GMB0oO6v;
        "pkg-1.6.7-fabric" = _iHV6q8YP;
        "pkg-1.6.7-forge" = _yd09jm7p;
        "pkg-1.6.7-neoforge" = _o2nkL7fw;
