...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.2.0" = _tiKwY2WO;
        "pkg-1.19.2-1.2.1" = _wPDKA6Nz;
        "pkg-1.19.4-1.2.1" = _hpbscf5D;
        "pkg-1.20-1.2.1" = _u5GBJTLk;
        "pkg-1.20.1-1.2.1" = _iFMYmCSj;
        "pkg-1.0.0" = _ZmxGhabK;
        "pkg-1.2.1" = _ZUdzNL34;
        "pkg-1.0.1" = _l76XVqd0;
        "pkg-1.2.2" = _9NzDi5B0;
