...
let
    ...
    in {
        ...
        "pkg-0.1.7.7" = _hksjj0kS;
        "pkg-0.2.0.0" = _T89xmzKN;
        "pkg-0.3.3" = _unzq8qT0;
        "pkg-0.3.2.8" = _TiWDT49z;
        "pkg-0.3.4.1" = _qlh0Qx5T;
        "pkg-0.3.5" = _tbtHhwRW;
        "pkg-0.3.6" = _v3ivj2iw;
        "pkg-0.3.6.1" = _8eIsKl0z;
        "pkg-0.3.6.2" = _97JuKRc7;
        "pkg-0.3.2.9" = _CERsBY54;
        "pkg-0.3.4.2" = _D28hAwls;
        "pkg-0.3.5.1" = _uDU0cxOZ;
        "pkg-0.3.6.3" = _YmS02eyV;
        "pkg-0.3.6.4" = _3MOmusa6;
        "pkg-0.3.6.5" = _nXZ2NMkT;
        "pkg-0.3.6.6" = _AQAlcuYz;
        "pkg-0.3.6.7" = _vWLsBVZb;
        "pkg-0.3.6.8" = _jqisi8RX;
        "pkg-0.4.0" = _oawmtJGI;
        "pkg-0.4.1" = _nXuwmlfQ;
        "pkg-0.4.1.1" = _RCkVROPn;
        "pkg-0.4.0.1" = _HrS7ZDw0;
        "pkg-0.4.1.2" = _6YOSDDe6;
        "pkg-0.4.1.3" = _dFffdKo5;
        "pkg-0.4.0.2" = _HkF9DI5b;
        "pkg-0.4.0.3" = _dcojBbXl;
        "pkg-0.4.2.0" = _uoyeQ3dW;
        "pkg-0.4.0.4" = _N2iJIgd4;
        "pkg-0.4.2.1" = _F1Bn9eVn;
        "pkg-0.4.0.5" = _vpyRd7JY;
        "pkg-0.4.2.2" = _YPnyCO5n;
        "pkg-0.4.3.0" = _x4Ix3uG9;
        "pkg-0.4.4" = _ZqOTCvMl;
        "pkg-0.4.4.1" = _7fMU9Qkj;
        "pkg-0.4.4.2" = _Pdfob1bO;
        "pkg-0.4.4.3" = _gWlVCUlL;
        "pkg-0.4.4.4" = _EVTmcA4o;
        "pkg-0.4.4.5" = _k8fTS3LE;
        "pkg-0.4.5" = _qKAUEo8L;
        "pkg-0.4.6" = _SDQXCQpB;
        "pkg-0.4.7" = _qcK2rF6U;
        "pkg-0.4.8" = _Hz2QCRqC;
        "pkg-0.4.8.1" = _CCaTJ1cK;
        "pkg-0.4.8.2" = _ZJUMioJI;
        "pkg-0.4.8.3" = _nS8MB0WU;
        "pkg-0.4.8.4" = _Im5qCYih;
        "pkg-0.4.9" = _gK1jTLCO;
        "pkg-0.4.10" = _oZ19iQMK;
        "pkg-0.4.11" = _CxYw7Vfy;
        "pkg-0.4.12" = _tEvd8z6o;
        "pkg-0.4.13" = _62d2XAnU;
        "pkg-0.4.14" = _CqB9cp8m;
        "pkg-0.4.15" = _jLF7liea;
