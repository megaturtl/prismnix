...
let
    ...
    in {
        ...
        "pkg-2.6.3" = _XSWsls6P;
        "pkg-2.7.0" = _D2MmQdrr;
        "pkg-2.7.01" = _kQVxIFGJ;
        "pkg-2.7.02" = _vAvBDpy0;
        "pkg-2.7.03" = _Ge9AsZ2Q;
        "pkg-2.7.3" = _5AlZcNQW;
        "pkg-2.7.4" = _G7H2P0gN;
        "pkg-2.8" = _1JGl3LZB;
        "pkg-2.8.1" = _NmWYtoTD;
        "pkg-2.8.1a" = _dMjt3d9a;
        "pkg-2.8.2-1.16.5" = _eFCdsuN1;
        "pkg-2.8.2-1.17.1" = _vUKX4Zrn;
        "pkg-2.8.2-1.19.2" = _YqjC6DEK;
        "pkg-1.19.3-2.9.0" = _cGWROB8n;
        "pkg-2.9.0-1.16.5" = _BuaYQUDU;
        "pkg-2.9.0-1.17.1" = _sHEnZFml;
        "pkg-2.9.0-1.18.2" = _O8X3tIHO;
        "pkg-2.10.0-1.19.3" = _oj0pYkuA;
        "pkg-2.11.0" = _DITEu29W;
        "pkg-2.12.0" = _LG3irDjF;
        "pkg-2.10.0" = _Evk6DMBb;
        "pkg-2.9.1" = _FgELao1a;
        "pkg-2.9.2" = _7dWl2xVf;
        "pkg-3.0.0" = _lWzZwvRu;
        "pkg-2.11.1-1.18.2" = _zODK1Gk8;
        "pkg-3.1.0" = _XcaviOzx;
        "pkg-2.13.0+1.16.5" = _ZegLuaV9;
        "pkg-3.2.0+1.18.2" = _ZcLfgFBx;
        "pkg-3.2.0+1.19.2" = _pkPBKY7d;
        "pkg-3.2.0" = _wngNJqJm;
        "pkg-3.2.1+1.19.2" = _haGKcI45;
        "pkg-2.13.1+1.16.5" = _cX1uFKYR;
        "pkg-3.2.1+1.18.2" = _shJzMSGq;
        "pkg-3.2.2+1.19.2" = _35Fujleb;
        "pkg-3.2.1+1.19.3" = _TVaHZDXc;
        "pkg-4.0.0+1.19.4" = _2I0bG2cF;
        "pkg-3.2.2+1.18.2" = _WnmNgt22;
        "pkg-3.2.2+1.19.3" = _eUpxRnUs;
        "pkg-5.0.0" = _YzfbdXtT;
        "pkg-6.0.0" = _1YcMS4Oj;
        "pkg-7.0.0" = _bWAtACdv;
        "pkg-8.0.0" = _62djqmS3;
        ...
        "pkg-7.1.0" = _gthTWlbG;
        "pkg-7.1.1" = _vn1sqZoj;
        "pkg-10.0.0+1.21.3" = _MJ7lPuyq;
        "pkg-10.0.1+1.21.3" = _sA9nuQKR;
        "pkg-7.1.2+1.20.1" = _rz4o9GYW;
        "pkg-7.1.3+1.20.1" = _2lzyZej1;
        "pkg-7.1.4+1.20.1" = _OPy1xme4;
        "pkg-10.0.1+1.21.4" = _1hjXjZYX;
        "pkg-10.0.2+1.21.3" = _vgEvOUuq;
        "pkg-10.0.2+1.21.4" = _703pkbr4;
        "pkg-10.0.3+1.21.4" = _p77tfgXZ;
        "pkg-10.0.3+1.21.3" = _wjsnf6Gl;
        "pkg-9.3.2" = _85vOAMUa;
        "pkg-10.0.4+1.21.4" = _iNvnWUjh;
        "pkg-10.0.4+1.21.3" = _WjiUyseU;
        "pkg-9.3.3" = _f5mnj6lv;
        "pkg-10.0.4+1.21.5" = _qAjdLcPM;
        "pkg-fabric-10.0.5-1.21.5" = _RR2MokxI;
        "pkg-forge-10.0.5-1.21.5" = _VJp8XUDJ;
        "pkg-neoforge-10.0.5-1.21.5" = _jTAJPgPD;
        "pkg-forge-10.0.5-1.21.8" = _sxu4NeFy;
        "pkg-fabric-10.0.5-1.21.8" = _lV2VIYaM;
        "pkg-neoforge-10.0.5-1.21.8" = _ptDX1OBT;
        "pkg-fabric-10.0.6-1.21.8" = _5Rrk1fM7;
        "pkg-fabric-10.0.6-1.21.10" = _lFN8wZBY;
        "pkg-forge-10.0.6-1.21.10" = _Rq6L8jgI;
        "pkg-neoforge-10.0.6-1.21.10" = _Z7Xs1ISt;
        "pkg-fabric-10.0.6-1.21.11" = _hAWLmF8t;
        "pkg-forge-10.0.6-1.21.11" = _VwpeiwHU;
        "pkg-neoforge-10.0.6-1.21.11" = _B8iZKR1W;
        "pkg-fabric-10.0.7-1.21.11" = _VEohuh5e;
        "pkg-forge-10.0.7-1.21.11" = _ePVu67Zq;
        "pkg-neoforge-10.0.7-1.21.11" = _PjJmyvyw;
