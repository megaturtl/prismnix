...
let
    versions = (let
        ...
        _Bv5Afdld = {
            "id" = "Bv5Afdld";
            "file" = "GEO-v0.3.5-Forge-1.20.1.jar";
            "hash" = "sha512-QQJz+7WRnzSZRKrm3ZPhM4D3rQsj60c/EolKQvcrHVHWFlc30jCeG5+drdryaw8Mf6XgKP14vcPef78rsYO9yA==";
        };
        _A90FztWy = {
            "id" = "A90FztWy";
            "file" = "GEO-v0.3.5-NeoForge-1.21.1.jar";
            "hash" = "sha512-hvXoRPMaoa39c79BiW15OpBZvrFxOJkG+iXqTpfq36O2kBbgm9BUcXrDEEPownCv14CbOD+viHsQZsO3iHaQtg==";
        };
        _IV5xvusD = {
            "id" = "IV5xvusD";
            "file" = "GEO-v0.3.5-Fabric-1.18.2.jar";
            "hash" = "sha512-82xYkLttET1RoE//j48VOnIAIUOwyX9xYRhd/Vw69E49Lai0sZoDyvcg+zQkhVBw8j3qvk8Ee+MS99K5idbddw==";
        };
        _s0QFNNp8 = {
            "id" = "s0QFNNp8";
            "file" = "GEO-v0.3.5-Fabric-1.21.1.jar";
            "hash" = "sha512-Wibp3Q+1L6n2/Qy2qZ2/LLdzOnW67+N9f8uea6U5B5zM/NcrO+pgLnR0WH6fnJmFVYEFuSto1U8d4DbDP/WSMA==";
        };
        _Uzc3Wclw = {
            "id" = "Uzc3Wclw";
            "file" = "GEO-v0.3.5-Fabric-1.20.1.jar";
            "hash" = "sha512-LbgSiIqNktnBaMH2R8xHwHjV9UKcEfV3ad5fP8oI8W78goWk12tW5ezd9kYhYtSk4ljXHYCZxbKbU+8bDkgALg==";
        };
        _seREuxqZ = {
            "id" = "seREuxqZ";
            "file" = "GEO-v0.3.5-Forge-1.18.2.jar";
            "hash" = "sha512-MWbizfp6jiLRwktNt7FQwFaMwixZJ07hE/bkHQNj5m8PK0B3ilx1Sy8dewBR4UAGgvziXaBF8fYR8tfjsO3Mmg==";
        };
        _XZ98kKag = {
            "id" = "XZ98kKag";
            "file" = "GEO-v0.3.5-Fabric-1.19.2.jar";
            "hash" = "sha512-7Lh02K2AZpB7fM/B4bdIbbNKW7MmC4nFTLuqJI2NWAEi3mgs7WDS/exh82aLOrHL0vjK4KX8CDaM9cY0tZOhrw==";
        };
        _czoJAcN5 = {
            "id" = "czoJAcN5";
            "file" = "GEO-v0.3.5-Forge-1.19.2.jar";
            "hash" = "sha512-feEIjQ7tSpbz7/OicIEyY8XyGYIfvQiLzt1u0hldX1sKpb6wHeSnd5xEYoi19TYp5Mo/SGKu7uJgKvCctLmh5g==";
        };
        _XYprSHvm = {
            "id" = "XYprSHvm";
            "file" = "GEO-v0.4.0-mc1.19.2.jar";
            "hash" = "sha512-kBISSvd/YbctHD2i6llA66tK0C2Q05wN2JOWC4jsG9wfas7N+ktOMqojTEkiGZXks/jvJOeJgOQv1v7B16EVXA==";
        };
        _6NfseAWA = {
            "id" = "6NfseAWA";
            "file" = "GEO-v0.4.0-mc1.18.2.jar";
            "hash" = "sha512-PFn9Rglk4KTf0YcCv+65pmR21ckAcoSi/97fvDyNMOaUov75D5F/wtcCY7CoECt1iGP+uUpcyaqSbSS127X61Q==";
        };
        _RtPUSqxN = {
            "id" = "RtPUSqxN";
            "file" = "GEO-v0.4.0-mc1.21.1.jar";
            "hash" = "sha512-6v+7ko4HUi/Z+7Z5jFQwazENlRdjowuvCVwfS0h9bMnaRXS12HdAOR5Gg/ign5gM2aO9QbSks/axw/Vt8tS17g==";
        };
        _d8NhUuaH = {
            "id" = "d8NhUuaH";
            "file" = "GEO-v0.4.0-mc1.20.1.jar";
            "hash" = "sha512-H3XttdzypfWKcFNcYkwxnf5fvTRntqPygNa12oq1xytAVWWcuPE6Lc+kmWFvPbvsy3GpT8exymBa67tvVFxqFw==";
        };
        _1W8sa0sW = {
            "id" = "1W8sa0sW";
            "file" = "GEODE-v1.0.0-RP1.112.0-mc1.18-26.2.jar";
            "hash" = "sha512-fiZgrQqlA9C8ZZwZFCT8e8z6RziX7poiNmuxETmcadoZi5BKZwc7Ix9xey48FlqlzdfmDLEc+ivqefbIe18P+Q==";
        };
        _ozZZKZQp = {
            "id" = "ozZZKZQp";
            "file" = "GEODE-v1.0.1-RP1.112.0-mc1.18-26.2.jar";
            "hash" = "sha512-PemiF/PEZ2YDdbO5Qm+nVK75wqtj14xWwKUGYzhMAauvRMPkOoUmAgTi7TPHtW6ZVioaiZq6R1GCE4qNn5YCIw==";
        };
        _DrRK3lTO = {
            "id" = "DrRK3lTO";
            "file" = "GEODE-v1.0.2-RP1.113.0-mc1.18-26.2.jar";
            "hash" = "sha512-QTXTqBgBGDRx3Odni9DIRPzoOGR3Uce/mMwDpuoo6YQrqoX1c+qKaV4QXs0yoa5f7ik+SoEtETF1fnq5gMfsHQ==";
        };
    in {
        "tNU0MTFe" = _tNU0MTFe;
        "Y98cv3b0" = _Y98cv3b0;
        ...
        "ozZZKZQp" = _ozZZKZQp;
        "DrRK3lTO" = _DrRK3lTO;
        "fabric-1.18.2" = _DrRK3lTO;
        "fabric-1.19.2" = _DrRK3lTO;
        "fabric-1.20.1" = _DrRK3lTO;
        "fabric-1.21.1" = _DrRK3lTO;
        "fabric-1.18" = _DrRK3lTO;
        "fabric-1.18.1" = _DrRK3lTO;
        "fabric-1.19" = _DrRK3lTO;
        "fabric-1.19.1" = _DrRK3lTO;
        "fabric-1.19.3" = _DrRK3lTO;
        "fabric-1.19.4" = _DrRK3lTO;
        "fabric-1.20" = _DrRK3lTO;
        "fabric-1.20.2" = _DrRK3lTO;
        "fabric-1.20.3" = _DrRK3lTO;
        "fabric-1.20.4" = _DrRK3lTO;
        "fabric-1.20.5" = _DrRK3lTO;
        "fabric-1.20.6" = _DrRK3lTO;
        "fabric-1.21" = _DrRK3lTO;
        "fabric-1.21.2" = _DrRK3lTO;
        "fabric-1.21.3" = _DrRK3lTO;
        "fabric-1.21.4" = _DrRK3lTO;
        "fabric-1.21.5" = _DrRK3lTO;
        "fabric-1.21.6" = _DrRK3lTO;
        "fabric-1.21.7" = _DrRK3lTO;
        "fabric-1.21.8" = _DrRK3lTO;
        "fabric-1.21.9" = _DrRK3lTO;
        "fabric-1.21.10" = _DrRK3lTO;
        "fabric-1.21.11" = _DrRK3lTO;
        "fabric-26.1" = _DrRK3lTO;
        "fabric-26.1.1" = _DrRK3lTO;
        "fabric-26.1.2" = _DrRK3lTO;
        "fabric-26.2" = _DrRK3lTO;
        "forge-1.18.2" = _DrRK3lTO;
        "forge-1.19.2" = _DrRK3lTO;
        "forge-1.20.1" = _DrRK3lTO;
        "forge-1.18" = _DrRK3lTO;
        "forge-1.18.1" = _DrRK3lTO;
        "forge-1.19" = _DrRK3lTO;
        "forge-1.19.1" = _DrRK3lTO;
        "forge-1.19.3" = _DrRK3lTO;
        "forge-1.19.4" = _DrRK3lTO;
        "forge-1.20" = _DrRK3lTO;
        "forge-1.20.2" = _DrRK3lTO;
        "forge-1.20.3" = _DrRK3lTO;
        "forge-1.20.4" = _DrRK3lTO;
        "forge-1.20.5" = _DrRK3lTO;
        "forge-1.20.6" = _DrRK3lTO;
        "forge-1.21" = _DrRK3lTO;
        "forge-1.21.1" = _DrRK3lTO;
        "forge-1.21.2" = _DrRK3lTO;
        "forge-1.21.3" = _DrRK3lTO;
        "forge-1.21.4" = _DrRK3lTO;
        "forge-1.21.5" = _DrRK3lTO;
        "forge-1.21.6" = _DrRK3lTO;
        "forge-1.21.7" = _DrRK3lTO;
        "forge-1.21.8" = _DrRK3lTO;
        "forge-1.21.9" = _DrRK3lTO;
        "forge-1.21.10" = _DrRK3lTO;
        "forge-1.21.11" = _DrRK3lTO;
        "forge-26.1" = _DrRK3lTO;
        "forge-26.1.1" = _DrRK3lTO;
        "forge-26.1.2" = _DrRK3lTO;
        "forge-26.2" = _DrRK3lTO;
        "neoforge-1.21.1" = _DrRK3lTO;
        "neoforge-1.18" = _DrRK3lTO;
        "neoforge-1.18.1" = _DrRK3lTO;
        "neoforge-1.18.2" = _DrRK3lTO;
        "neoforge-1.19" = _DrRK3lTO;
        "neoforge-1.19.1" = _DrRK3lTO;
        "neoforge-1.19.2" = _DrRK3lTO;
        "neoforge-1.19.3" = _DrRK3lTO;
        "neoforge-1.19.4" = _DrRK3lTO;
        "neoforge-1.20" = _DrRK3lTO;
        "neoforge-1.20.1" = _DrRK3lTO;
        "neoforge-1.20.2" = _DrRK3lTO;
        "neoforge-1.20.3" = _DrRK3lTO;
        "neoforge-1.20.4" = _DrRK3lTO;
        "neoforge-1.20.5" = _DrRK3lTO;
        "neoforge-1.20.6" = _DrRK3lTO;
        "neoforge-1.21" = _DrRK3lTO;
        "neoforge-1.21.2" = _DrRK3lTO;
        "neoforge-1.21.3" = _DrRK3lTO;
        "neoforge-1.21.4" = _DrRK3lTO;
        "neoforge-1.21.5" = _DrRK3lTO;
        "neoforge-1.21.6" = _DrRK3lTO;
        "neoforge-1.21.7" = _DrRK3lTO;
        "neoforge-1.21.8" = _DrRK3lTO;
        "neoforge-1.21.9" = _DrRK3lTO;
        "neoforge-1.21.10" = _DrRK3lTO;
        "neoforge-1.21.11" = _DrRK3lTO;
        "neoforge-26.1" = _DrRK3lTO;
        "neoforge-26.1.1" = _DrRK3lTO;
        "neoforge-26.1.2" = _DrRK3lTO;
        "neoforge-26.2" = _DrRK3lTO;
        "pkg-v0.1.0-fabric-1.18.2" = _tNU0MTFe;
        "pkg-v0.1.0-forge-1.18.2" = _Y98cv3b0;
        "pkg-v0.1.0-fabric-1.19.2" = _xjn05Ruh;
        "pkg-v0.1.0-forge-1.19.2" = _HYidTHlV;
        "pkg-v0.1.0-fabric-1.20.1" = _DL1LU23r;
        "pkg-v0.1.0-forge-1.20.1" = _CVlbhQZg;
        "pkg-v0.1.0-fabric-1.21.1" = _3F5oTvzc;
        "pkg-v0.1.0-neoforge-1.21.1" = _Pw8IagIA;
        "pkg-v0.2.0-Fabric-1.18.2" = _MLOOZMQh;
        "pkg-v0.2.0-Fabric-1.19.2" = _32Xz0dCE;
        "pkg-v0.2.0-Fabric-1.20.1" = _fFjIQkzs;
        "pkg-v0.2.0-Fabric-1.21.1" = _rnucTIP8;
        "pkg-v0.2.0-Forge-1.18.2" = _roRDfiBq;
        "pkg-v0.2.0-Forge-1.19.2" = _VF4L1LSc;
        "pkg-v0.2.0-Forge-1.20.1" = _LB4bhBaq;
        "pkg-v0.2.0-NeoForge-1.21.1" = _MhNTPzKx;
        "pkg-v0.2.1-fabric-1.20.1" = _rIqygTqD;
        "pkg-v0.2.1-neoforge-1.21.1" = _YGsxmZGV;
        "pkg-v0.2.1-forge-1.19.2" = _gANZ1fU2;
        "pkg-v0.2.1-fabric-1.21.1" = _N7VXIgE8;
        "pkg-v0.2.1-fabric-1.18.2" = _DnzHynSf;
        "pkg-v0.2.1-fabric-1.19.2" = _md3cka42;
        "pkg-v0.2.1-forge-1.18.2" = _wam29f9X;
        "pkg-v0.2.1-forge-1.20.1" = _J4ikruu6;
        "pkg-0.2.2-forge-1.19.2" = _QZEVmfZM;
        "pkg-0.2.2-forge-1.18.2" = _uGe89Oqs;
        "pkg-0.2.2-fabric-1.21.1" = _2hX8gUpv;
        "pkg-0.2.2-forge-1.20.1" = _OqmwhKGT;
        "pkg-0.2.2-fabric-1.19.2" = _pSaLXlvI;
        "pkg-0.2.2-fabric-1.18.2" = _gr9RWMr8;
        "pkg-0.2.2-fabric-1.20.1" = _xY5SOx3b;
        "pkg-0.2.2-neoforge-1.21.1" = _LN6fMPFW;
        "pkg-0.3.0-forge-1.19.2" = _hWh41qYM;
        "pkg-0.3.0-fabric-1.18.2" = _PYYgJ6Pc;
        "pkg-0.3.0-neoforge-1.21.1" = _cHpli9zY;
        "pkg-0.3.0-fabric-1.21.1" = _rGWejWhu;
        "pkg-0.3.0-forge-1.18.2" = _DXiswIUv;
        "pkg-0.3.0-forge-1.20.1" = _53oRcJFv;
        "pkg-0.3.0-fabric-1.19.2" = _b6UymSYt;
        "pkg-0.3.0-fabric-1.20.1" = _Pcxnwso7;
        "pkg-0.3.1-forge-1.18.2" = _PVBTIRIF;
        "pkg-0.3.1-fabric-1.19.2" = _uxlcVucd;
        "pkg-0.3.1-forge-1.20.1" = _XIZBGUMs;
        "pkg-0.3.1-neoforge-1.21.1" = _A9tgxqY6;
        "pkg-0.3.1-forge-1.19.2" = _b1wpka3j;
        "pkg-0.3.1-fabric-1.21.1" = _A4GicOQ4;
        "pkg-0.3.1-fabric-1.18.2" = _eroqPF1H;
        "pkg-0.3.1-fabric-1.20.1" = _oJgatLDs;
        "pkg-0.3.2-neoforge-1.21.1" = _8zfUm6yX;
        "pkg-0.3.2-fabric-1.19.2" = _SFZ4gZLI;
        "pkg-0.3.2-fabric-1.21.1" = _klylmj4H;
        "pkg-0.3.2-fabric-1.18.2" = _XLGNiDz4;
        "pkg-0.3.2-forge-1.18.2" = _wRxFSeNO;
        "pkg-0.3.2-forge-1.19.2" = _N7i068aA;
        "pkg-0.3.2-fabric-1.20.1" = _AUiPgsSg;
        "pkg-0.3.2-forge-1.20.1" = _AvqbUMoM;
        "pkg-0.3.3-forge-1.19.2" = _zm7JsPi2;
        "pkg-0.3.3-neoforge-1.21.1" = _DGVvIdcX;
        "pkg-0.3.3-forge-1.20.1" = _NPYZGGNk;
        "pkg-0.3.3-fabric-1.21.1" = _DPMssu6j;
        "pkg-0.3.3-fabric-1.18.2" = _Na2SMByn;
        "pkg-0.3.3-forge-1.18.2" = _YrbaI3gD;
        "pkg-0.3.3-fabric-1.20.1" = _ytK6I1dv;
        "pkg-0.3.3-fabric-1.19.2" = _GusIFCBi;
        "pkg-0.3.4-fabric-1.19.2" = _phieQWvp;
        "pkg-0.3.4-fabric-1.20.1" = _rtEDTX8l;
        "pkg-0.3.4-forge-1.18.2" = _K4B7zpyP;
        "pkg-0.3.4-forge-1.19.2" = _tz7xzS7p;
        "pkg-0.3.4-forge-1.20.1" = _zAkNKNat;
        "pkg-0.3.4-fabric-1.21.1" = _4UfUN3b8;
        "pkg-0.3.4-fabric-1.18.2" = _h9qUGPFe;
        "pkg-0.3.4-neoforge-1.21.1" = _aIR3X9zN;
        "pkg-0.3.5-forge-1.20.1" = _Bv5Afdld;
        "pkg-0.3.5-neoforge-1.21.1" = _A90FztWy;
        "pkg-0.3.5-fabric-1.18.2" = _IV5xvusD;
        "pkg-0.3.5-fabric-1.21.1" = _s0QFNNp8;
        "pkg-0.3.5-fabric-1.20.1" = _Uzc3Wclw;
        "pkg-0.3.5-forge-1.18.2" = _seREuxqZ;
        "pkg-0.3.5-fabric-1.19.2" = _XZ98kKag;
        "pkg-0.3.5-forge-1.19.2" = _czoJAcN5;
        "pkg-0.4.0-mc1.19.2" = _XYprSHvm;
        "pkg-0.4.0-mc1.18.2" = _6NfseAWA;
        "pkg-0.4.0-mc1.21.1" = _RtPUSqxN;
        "pkg-0.4.0-mc1.20.1" = _d8NhUuaH;
        "pkg-1.0.0-rp1.112.0" = _1W8sa0sW;
        "pkg-1.0.1-rp1.112.0" = _ozZZKZQp;
        "pkg-1.0.2-rp1.113.0" = _DrRK3lTO;
        "default" = _DrRK3lTO;
    });
