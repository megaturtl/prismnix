...
let
    ...
    in {
        ...
        "pkg-1.0.2" = _2wxscjS9;
        "pkg-1.1.0" = _xGMJpxWt;
        "pkg-0.5-neoforge-1.21.1" = _WIrxJ7rf;
        "pkg-0.8" = _c24IOZl8;
        "pkg-1.2.0" = _ku0Fmiud;
        "pkg-1.0" = _YyDQ9K3c;
        "pkg-1.2" = _ObeqkRq9;
        ...
        "pkg-1.3" = _oqEMmpLi;
        "pkg-1.3.0" = _VFan1OgK;
        "pkg-1.1.1-fabric-26.1.1" = _DKKoG721;
        "pkg-1.1.1-fabric-26.1" = _OPKDIMzb;
        "pkg-1.3.1-fabric-26.2" = _PCiYIjLX;
        "pkg-1.1.1-forge-26.1" = _AtC4VhTt;
        "pkg-1.1.1-forge-26.1.1" = _rJbOYa2C;
        "pkg-0.9.1-forge-26.2" = _2P9WLedn;
        "pkg-0.8.1-neoforge-26.1" = _eohUphYo;
        "pkg-0.8.1-neoforge-26.1.1" = _BMnOowkg;
        "pkg-1.0.1-neoforge-26.2" = _OkXihRXi;
        "pkg-1.1.1-forge-1.21.11" = _KCPJMGuU;
        "pkg-1.1.1-forge-1.19.2" = _6ww3cCWO;
        "pkg-1.3.1-forge-1.19.4" = _VkjeJM1Q;
        "pkg-1.1.1-forge-1.20.1" = _TQMdg5as;
        "pkg-1.1.1-forge-1.20.4" = _cqqi7aB8;
        "pkg-1.1.1-forge-1.20.6" = _vgulOz6X;
        "pkg-1.1.1-forge-1.21" = _BRejv90g;
        "pkg-1.1.1-forge-1.21.1" = _U5E5QMA7;
        "pkg-0.7.1-neoforge-1.21.1" = _NILxgoZw;
        "pkg-1.1.1-forge-1.21.4" = _Mnu0kXrC;
        "pkg-1.1.1-forge-1.21.5" = _izswGBVW;
        "pkg-1.1.1-forge-1.21.6" = _bvSZmqGT;
        "pkg-1.1.1-forge-1.21.7" = _J6HlO4BH;
