...
let
    ...
    in {
        ...
        "pkg-1.1" = _s5NfWuPd;
        "pkg-1.1+mod" = _qz5ptGcP;
        "pkg-1.2" = _ILO1pUrB;
        "pkg-1.2+mod" = _21OwdklK;
        "pkg-2.0" = _LzajcDkv;
        "pkg-2.0+mod" = _v28YigUo;
        "pkg-2.0.1" = _a3xWUR5u;
        "pkg-2.0.1+mod" = _q0dQYfz4;
        "pkg-3.0" = _u43TkpVQ;
        "pkg-3.0+mod" = _SSeutkpW;
        "pkg-4.0-b1" = _9sHkwDUM;
        "pkg-4.0-b1+mod" = _bzv2wean;
        "pkg-4.0-b3" = _ngDiOMCD;
        "pkg-4.0-b3+mod" = _dNOiw2wM;
        "pkg-4.0-b4" = _TYgYMO4F;
        "pkg-4.0-b4+mod" = _Bg1z6PnV;
        "pkg-4.0-fix" = _e8wAGR9o;
        "pkg-4.0-fix+mod" = _lHKOC7A0;
        "pkg-4.1" = _xW2nuqa7;
        "pkg-4.1+mod" = _9PWT2L7j;
        "pkg-4.1.1" = _yue6uTly;
        "pkg-4.1.1+mod" = _XplTnDm5;
        "pkg-4.1.2" = _erqQ1mTV;
        "pkg-4.1.2+mod" = _GqQNTG0J;
        "pkg-4.1.3" = _JAgLbacg;
        "pkg-4.1.3+mod" = _o6IDlHVX;
        "pkg-4.2" = _szdifNh5;
        "pkg-4.2+mod" = _4THJiBAI;
        "pkg-5.0" = _Ry9SJDpg;
        "pkg-5.0+mod" = _gy8PXj8l;
        "pkg-5.0.1" = _bhfu7LdC;
        "pkg-5.0.1+mod" = _uWNSYsRB;
        "pkg-5.0.2" = _WbF3NjyY;
        "pkg-5.0.2+mod" = _c23UqE0O;
        "pkg-5.1" = _reMnT4k6;
