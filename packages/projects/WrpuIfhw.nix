...
let
    ...
    in {
        ...
        "pkg-forge-1.19-1.0.7" = _RIywlYlo;
        "pkg-forge-1.19-1.0.8" = _NYOrEfQj;
        "pkg-forge-1.19.1-1.0.0" = _SpHi7GwE;
        "pkg-forge-1.19.2-1.0.0" = _4kdu5eGD;
        "pkg-forge-1.19.3-1.0.0" = _VFfg0ZVA;
        "pkg-forge-1.19.3-1.0.1" = _EofTnPwf;
        "pkg-forge-1.19.3-1.0.2" = _MawVbAXd;
        "pkg-forge-1.19.4-1.0.2" = _IRBPfA3k;
        "pkg-forge-1.19.3-1.0.3" = _pYYb5oQL;
        "pkg-forge-1.19.4-1.0.3" = _rkrsdnUY;
        "pkg-forge-1.20-1.0.3" = _N5laHcl2;
        "pkg-forge-1.20.1-1.0.3" = _jQQ9lFmi;
        "pkg-forge-1.20.1-1.0.4" = _fxcnfcyt;
        "pkg-forge-1.20.1-1.0.5" = _NuOtxEPy;
        "pkg-forge-1.20.2-1.0.5" = _x6HInhfU;
        "pkg-forge-1.20.2-1.0.7" = _vcdiLVVx;
        "pkg-neoforge-1.20.2-1.0.7" = _jgXLZmnS;
        "pkg-neoforge-1.20.2-1.0.8" = _8PFd7K9p;
        "pkg-forge-1.19.2-1.0.9" = _R5oRXwTk;
        "pkg-forge-1.20.1-1.0.9" = _kVSwG79H;
        "pkg-forge-1.20.2-1.0.9" = _LKy8dc4y;
        "pkg-neoforge-1.20.2-1.0.9" = _gab2XsZY;
        "pkg-neoforge-1.20.3-1.0.9" = _CEiTfJVy;
        "pkg-neoforge-1.20.4-1.0.9" = _ZRHzf9Jp;
        "pkg-forge-1.19.2-1.0.10" = _l9iOZ1Ke;
        "pkg-forge-1.20.1-1.0.10" = _yL3olYId;
        "pkg-neoforge-1.20.4-1.0.10" = _tssLHLy4;
        "pkg-neoforge-1.20.4-1.0.11" = _ShD3qtqb;
        "pkg-forge-1.19.2-1.0.12" = _L9BPDxPe;
        "pkg-forge-1.20.1-1.0.12" = _x5gi94YI;
        "pkg-neoforge-1.20.4-1.0.12" = _YneK5PI0;
        "pkg-neoforge-1.20.5-1.0.12" = _LJPcuZ0b;
        "pkg-neoforge-1.20.6-1.0.12" = _gyRe6g1F;
        "pkg-neoforge-1.20.6-1.0.13" = _Sb7G2eMI;
        "pkg-neoforge-1.21-1.0.13" = _WPgmq1E6;
        "pkg-neoforge-1.21.1-1.0.13" = _b5Ihru8H;
        "pkg-forge-1.19.2-1.0.14" = _6RLJEwm3;
        "pkg-forge-1.20.1-1.0.14" = _1VcxMk2Q;
        "pkg-neoforge-1.21.1-1.0.14" = _ozAFQzEJ;
        "pkg-neoforge-1.21.1-1.1.0" = _5crow3WD;
        "pkg-forge-1.19.2-1.0.15" = _ICjuf9cc;
        "pkg-forge-1.20.1-1.0.15" = _nssqM66J;
        "pkg-neoforge-1.21.1-1.1.1" = _mcKNOwIQ;
        "pkg-forge-1.19.2-1.0.16" = _FT9SeEjw;
        "pkg-forge-1.20.1-1.0.16" = _VBaYJywR;
        "pkg-neoforge-1.21.1-1.1.2" = _k82jNJZz;
        "pkg-forge-1.19.2-1.0.17" = _ofDmBZke;
        "pkg-forge-1.20.1-1.0.17" = _jZpLvxa7;
        "pkg-neoforge-1.21.2-1.1.2" = _wcPefmN7;
        "pkg-neoforge-1.21.3-1.1.2" = _Y80a8mNR;
        "pkg-neoforge-1.21.4-1.1.2" = _nAW3Ju13;
        "pkg-forge-1.20.1-1.0.18" = _S8EuWNLB;
        "pkg-neoforge-1.21.1-1.1.3" = _Mok76h56;
        "pkg-neoforge-1.21.3-1.1.3" = _TXUHBZs8;
        "pkg-neoforge-1.21.4-1.1.3" = _e6AKTWNV;
        "pkg-forge-1.20.1-1.0.19" = _TlmJAOz2;
        "pkg-neoforge-1.21.1-1.1.4" = _d7baCQZw;
        "pkg-neoforge-1.21.4-1.1.4" = _MxK12znT;
        "pkg-forge-1.20.1-1.0.20" = _COpemDNs;
        "pkg-neoforge-1.21.1-1.1.5" = _IxJeLN2e;
        "pkg-neoforge-1.21.4-1.1.5" = _YGicfmyz;
        "pkg-neoforge-1.21.5-1.1.5" = _oTthtZtr;
        "pkg-neoforge-1.21.5-1.1.6" = _y34pva3m;
        "pkg-forge-1.20.1-1.0.21" = _AQNfDafD;
        "pkg-neoforge-1.21.1-1.1.7" = _DAlmCxsg;
        "pkg-neoforge-1.21.4-1.1.7" = _lTGyllRi;
        "pkg-neoforge-1.21.5-1.1.7" = _ZDrcylOr;
        "pkg-neoforge-1.21.6-1.1.7" = _T9eDRRRi;
        "pkg-neoforge-1.21.6-1.1.8" = _XaxB6AJe;
        "pkg-neoforge-1.21.6-1.1.9" = _CVQeIkrN;
        "pkg-neoforge-1.21.1-1.1.10" = _9KagdOAl;
        "pkg-neoforge-1.21.4-1.1.10" = _qPkuIUt3;
        "pkg-neoforge-1.21.5-1.1.10" = _Qwwlrh1g;
        "pkg-neoforge-1.21.6-1.1.10" = _JD7SMq8G;
        "pkg-neoforge-1.21.7-1.1.10" = _frsY1VUF;
        "pkg-neoforge-1.21.7-1.1.11" = _FPGBYFFm;
        "pkg-neoforge-1.21.8-1.1.11" = _ToY2En1S;
        "pkg-neoforge-1.21.8-1.1.12" = _j0AlZMZ6;
        "pkg-forge-1.20.1-1.0.22" = _zsjUu0Zf;
        "pkg-forge-1.20.1-1.0.23" = _7fc0hJN6;
        "pkg-neoforge-1.21.1-1.1.13" = _Zwf8nv8y;
        "pkg-neoforge-1.21.4-1.1.13" = _vAB33p3P;
        "pkg-neoforge-1.21.5-1.1.13" = _emRdfFIO;
        "pkg-neoforge-1.21.8-1.1.13" = _I10v1y0z;
        "pkg-neoforge-1.21.9-1.1.13" = _qyaWjutb;
        "pkg-neoforge-1.21.10-1.1.13" = _uDyWVAa4;
        "pkg-neoforge-1.21.10-1.1.14" = _Y5bZsXS0;
        "pkg-neoforge-1.21.10-1.1.15" = _VjFknmo5;
        "pkg-neoforge-1.21.10-1.1.16" = _4aENlzAU;
        "pkg-neoforge-1.21.11-1.1.16" = _VgCn6ZZ2;
        "pkg-neoforge-1.1.16+26.1" = _zSAkHfmI;
        "pkg-neoforge-1.1.16+26.1.1" = _JSkzYF1a;
