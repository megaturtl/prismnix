...
let
    ...
    in {
        ...
        "pkg-1.19.3-3.2.0" = _RdGVrNxS;
        "pkg-1.20.1-4.0.0" = _FrocyXHN;
        "pkg-1.20.1-4.0.1" = _izk4EHaq;
        "pkg-1.20.1-4.0.2" = _aEzrTkyG;
        "pkg-1.20.1-4.0.3" = _iBCKTyHY;
        "pkg-1.20.1-4.0.4" = _2VytoA5j;
        "pkg-1.21-5.0.0" = _XZpsxb3R;
        "pkg-1.0" = _RHTHanj1;
        "pkg-1.0.1" = _H0cPD882;
        "pkg-1.0.2" = _MYWQwIlE;
        "pkg-2.0.1" = _CygwQI8g;
        "pkg-2.0.2" = _Jc8DD1ha;
        "pkg-2.0.3" = _cat2tKYu;
        "pkg-1.21.3-5.1.0" = _MQoZkD44;
        "pkg-1.21.3-5.1.1" = _eUlONnue;
        "pkg-1.21-5.0.1" = _mc7Zn2X2;
        "pkg-1.21.3-5.1.2" = _x9VsCPY8;
        "pkg-1.21.3-5.1.3" = _PGWrGiBP;
        "pkg-1.21-5.0.2" = _T0twmWHs;
        "pkg-1.21.3-5.1.4" = _XGGRKyat;
        "pkg-1.21-5.0.3" = _9XvgRjfH;
        "pkg-1.21.3-5.1.5" = _xPIprhZM;
        "pkg-1.21-5.0.4" = _CCrwlupr;
        "pkg-21.11.0" = _djRqVbL0;
