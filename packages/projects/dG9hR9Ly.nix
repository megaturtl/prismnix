...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.0.44" = _EzqY5jbj;
        "pkg-1.20.1-1.0.46" = _DuMwBqtL;
        "pkg-1.20.1-1.0.50" = _seDrcpEt;
        "pkg-1.20.1-1.0.54" = _XiWRfNIv;
        "pkg-1.20.1-1.0.114" = _7OzsrdNl;
        "pkg-1.20.1-1.0.117" = _387K9VML;
        "pkg-1.20.1-1.0.126" = _tyvgIQ5a;
