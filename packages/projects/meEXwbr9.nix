...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _r5uRnnBq;
        "pkg-1.0.9" = _tM9knGy6;
        "pkg-1.0.10" = _muJWbx07;
        "pkg-1.0.11" = _Ve69UVut;
        "pkg-1.0.12" = _k7KH9Q2n;
        "pkg-1.0.13" = _1MHUWAn1;
        "pkg-1.0.14" = _qGDMeEZA;
        "pkg-1.0.15" = _5l4uLlHd;
        "pkg-1.0.16" = _r3fVBXlh;
        "pkg-1.0.17" = _C2M2yGfa;
        "pkg-1.0.18" = _YA2iGUl2;
        "pkg-1.0.19" = _3mgi5U3m;
        "pkg-1.0.20" = _Odv1yCtL;
        "pkg-1.0.21" = _whv0qxAV;
        "pkg-1.0.22" = _AkTjyAQI;
        "pkg-1.0.23" = _8Jnj2F3o;
        "pkg-1.0.24" = _PMUQEBbF;
        "pkg-1.0.25" = _zT0YGbvp;
        "pkg-1.0.26" = _SSAa7Qax;
