...
let
    versions = (let
        ...
        _eVPI2jY0 = {
            "id" = "eVPI2jY0";
            "file" = "hexParse-fabric-1.21.1-1.11.2.pre53.fix1.jar";
            "hash" = "sha512-63Z7GI8969wweaibdtWsU+Wf9VozsbSACnC3oaEmaGtMbC6ztT6UOOglEkMwap4gjZNl77fvJvPUaBK75rlNAg==";
        };
        _4O9Ukx0p = {
            "id" = "4O9Ukx0p";
    ...
    in {
        ...
        "pkg-1.20.1-0.5.1" = _rYCEZDEt;
        "pkg-1.19.2-0.6.0" = _wrxdcfJM;
        "pkg-1.20.1-0.6.0" = _VdyuGu3v;
        "pkg-1.19.2-0.6.1" = _fzRzwPWJ;
        "pkg-1.20.1-0.6.1" = _VvxXcyOK;
        "pkg-1.19.2-0.6.2" = _8hi8l4ng;
        "pkg-1.20.1-0.6.2" = _dIUtMNEw;
        "pkg-1.19.2-0.7.0" = _mTNFfY7k;
        "pkg-1.20.1-0.7.0" = _6jO02Kze;
        "pkg-1.19.2-0.7.1" = _gpGNikZ7;
        "pkg-1.20.1-0.7.1" = _2UKxIWqE;
        "pkg-1.19.2-0.7.2.1" = _vbeVvx12;
        "pkg-1.20.1-0.7.2.1" = _ssS0zL3T;
        "pkg-1.19.2-0.7.3" = _vU0rI3sj;
        "pkg-1.20.1-0.7.3" = _eNgUsC3F;
        "pkg-1.19.2-0.7.4" = _GRJuDCNF;
        "pkg-1.20.1-0.7.4" = _5IsO6lET;
        "pkg-1.19.2-0.7.5" = _s1YhT7re;
        "pkg-1.20.1-0.7.5" = _cBpNoagr;
        "pkg-1.19.2-0.7.6" = _e5Aa9DKV;
        "pkg-1.20.1-0.7.6" = _mi8noHp0;
        "pkg-1.19.2-0.7.7" = _tUgyU67x;
        "pkg-1.20.1-0.7.7" = _MWDVf6ez;
        "pkg-1.19.2-0.7.7.1" = _Sk16wi7b;
        "pkg-1.19.2-0.8.0" = _s9CVODgY;
        "pkg-1.20.1-0.8.0" = _3jonhYhc;
        "pkg-1.19.2-0.8.1" = _uKdUbUpr;
        "pkg-1.20.1-0.8.1" = _Xg9DlIM0;
        "pkg-1.19.2-0.8.2" = _UdKajFru;
        "pkg-1.20.1-0.8.2" = _3VVTqcZh;
        "pkg-1.19.2-0.9.0" = _lNwDD8Z8;
        "pkg-1.20.1-0.9.0" = _C2q9Ndc4;
        "pkg-1.19.2-0.9.1" = _dUW3G0Jy;
        "pkg-1.20.1-0.9.1" = _8GiGT86c;
        "pkg-1.19.2-0.9.2" = _JG546Ue2;
        "pkg-1.20.1-0.9.2" = _ZFTRH9jF;
        "pkg-1.19.2-0.9.3" = _L4Zp1eXW;
        "pkg-1.20.1-0.9.3" = _lTzD8SZO;
        "pkg-1.19.2-0.9.4" = _sXf5s0EH;
        "pkg-1.20.1-0.9.4" = _dsCGC4pz;
        "pkg-1.19.2-0.9.5" = _UcIeHV3C;
        "pkg-1.20.1-0.9.5" = _ckD4i99G;
        "pkg-1.19.2-0.9.5.1" = _5arPYVoP;
        "pkg-1.20.1-0.9.5.1" = _PClEKh5l;
        "pkg-1.19.2-0.9.6" = _WEaSrYR6;
        "pkg-1.20.1-0.9.6" = _KhTMJmSf;
        "pkg-1.19.2-0.9.7" = _9hrN2J22;
        "pkg-1.20.1-0.9.7" = _U4qSDaFs;
        "pkg-1.19.2-0.9.7.1" = _ihxWKnVK;
        "pkg-1.20.1-0.9.7.1" = _1vxE0cRu;
        "pkg-1.19.2-0.9.7.2" = _m7UKwMXS;
        "pkg-1.20.1-0.9.7.2" = _WE69Ld1m;
        "pkg-1.19.2-0.9.8" = _VpFitYl3;
        "pkg-1.20.1-0.9.8" = _FgkXECD1;
        "pkg-1.19.2-0.9.8.1" = _Wd8vZzN3;
        "pkg-1.20.1-0.9.8.1" = _LlST7YsE;
        "pkg-1.19.2-0.9.8.2" = _fcCnq8Qw;
        "pkg-1.20.1-0.9.8.2" = _eQ3rWjir;
        "pkg-1.19.2-0.10.0" = _qbv5gi0k;
        "pkg-1.20.1-0.10.0" = _pDE6acEy;
        "pkg-1.20.1-1.0.0" = _Po1IzW1r;
        "pkg-1.19.2-1.0.0" = _k0515FHM;
        "pkg-1.19.2-1.0.1" = _vTXCAq4X;
        "pkg-1.20.1-1.0.1" = _dmFzJsxD;
        "pkg-1.19.2-1.1.0" = _jm1zps7Y;
        "pkg-1.20.1-1.1.0" = _xd1Wxejx;
        "pkg-1.19.2-1.2.0" = _4MrtVuG1;
        "pkg-1.20.1-1.2.0" = _EpgWQfpN;
        "pkg-1.19.2-1.3.0" = _pDW0J58O;
        "pkg-1.20.1-1.3.0" = _rFWZUbV6;
        "pkg-1.19.2-1.3.1" = _ISutGuvh;
        "pkg-1.20.1-1.3.1" = _GwxYcW03;
        "pkg-1.20.1-1.3.2" = _A8s3h2eV;
        "pkg-1.19.2-1.4.0" = _2eqyXU8n;
        "pkg-1.20.1-1.4.0" = _ixweKpLc;
        "pkg-1.19.2-1.5.0" = _mJNBJuVg;
        "pkg-1.20.1-1.5.0" = _cVuIfplF;
        "pkg-1.20.1-1.5.1" = _XZdThm0m;
        "pkg-1.20.1-1.5.2" = _yg878RdW;
        "pkg-1.19.2-1.5.3" = _pxFMfjQ9;
        "pkg-1.20.1-1.5.3" = _MbH6Hkhh;
        "pkg-1.19.2-1.6.0" = _E1m1f7tO;
        "pkg-1.20.1-1.6.0" = _BGIwMaeL;
        "pkg-1.19.2-1.7.0" = _DMM7XhTs;
        "pkg-1.20.1-1.7.0" = _SZmh1DbK;
        "pkg-1.19.2-1.7.1" = _fXDoSPpb;
        "pkg-1.20.1-1.7.1" = _o5BwEjNL;
        "pkg-1.19.2-1.8.0" = _7jkpeX6X;
        "pkg-1.20.1-1.8.0" = _tMjBUwsg;
        "pkg-1.19.2-1.8.1" = _BBfv5dUN;
        "pkg-1.20.1-1.8.1" = _OsMQNHJG;
        "pkg-1.19.2-1.9.0" = _l7LK5Hkk;
        "pkg-1.20.1-1.9.0" = _zCbnmhNs;
        "pkg-1.19.2-1.10.0" = _fSgUjrhv;
        "pkg-1.20.1-1.10.0" = _S8f4dlGO;
        "pkg-1.19.2-1.10.1" = _cD77ysbf;
        "pkg-1.20.1-1.10.1" = _OyytPEQx;
        "pkg-1.19.2-1.10.2" = _zkWzogtN;
        "pkg-1.20.1-1.10.2" = _CXtiVZzR;
        "pkg-1.21.1-1.10.2" = _L76XQ5yv;
        "pkg-1.21.1-1.10.2.1" = _NkuYUEVY;
        "pkg-1.19.2-1.10.2.2" = _gZAx3tEq;
        "pkg-1.20.1-1.10.2.2" = _IrUSNVaF;
        "pkg-1.21.1-1.10.2.2" = _ZOScG4pa;
        "pkg-1.21.1-1.10.2.3" = _CkW2GjOM;
        "pkg-1.19.2-1.11.0" = _i7aUGdYl;
        "pkg-1.20.1-1.11.0" = _HSTH26Is;
        "pkg-1.21.1-1.11.0" = _FrIwdFC1;
        "pkg-1.19.2-1.11.1" = _jz6YEmKt;
        "pkg-1.20.1-1.11.1" = _dwJUuJsC;
