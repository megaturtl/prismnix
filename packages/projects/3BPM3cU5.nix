...
let
    ...
    in {
        ...
        "pkg-0.4.0+1.20.x" = _RORGpz12;
        "pkg-0.4.1+1.17.x" = _u5DWFAlp;
        "pkg-0.4.1+1.18.x" = _cPGIoKll;
        "pkg-0.4.1+1.19.x" = _yhlvuhX7;
        "pkg-0.4.1+1.20.x" = _TwjRXQ1M;
        "pkg-0.4.2+1.18.x" = _O0lATpUd;
        "pkg-0.4.2+1.19.x" = _Lj1xzbKK;
        "pkg-0.4.2+1.20.x" = _71JZICWJ;
        "pkg-0.4.3+1.20.x" = _hkcr86dX;
        "pkg-0.4.4+1.20.x" = _vksh7p4x;
        "pkg-0.4.4+1.20.2" = _E2ixJRqi;
        "pkg-0.4.5+1.20.2" = _ZdsWBRpa;
        "pkg-0.4.6+1.20.2" = _YqL0Ylt0;
        "pkg-0.5.0+1.20.2" = _HRpvf1ML;
        "pkg-0.5.0+1.20.3-1.20.4" = _Nf0utucP;
        "pkg-0.5.0+1.20.6" = _AB46i916;
        "pkg-0.5.1+1.21" = _AUBgTN4k;
        "pkg-0.5.1+1.20.5-1.21.x" = _gSIh69Xc;
        "pkg-0.6.0+1.20-1.20.1" = _RLJwho6X;
        "pkg-0.6.0+1.20.2-1.20.4" = _tzEw4rpv;
        "pkg-0.6.0+1.20.5-1.21.x" = _Esg4YkoO;
        "pkg-0.6.1+1.19.x" = _23xKnvkD;
        "pkg-0.6.1+1.20.2-1.20.4" = _RmJ41uim;
        "pkg-0.6.1+1.20.5-1.21.x" = _Di0QfY1U;
        "pkg-0.6.1+1.20-1.20.1" = _9TSqd2TT;
        "pkg-0.6.2+1.20-1.20.1" = _MxBj3H0e;
        "pkg-0.6.2+1.17.x" = _h8G5oTRR;
        "pkg-0.6.2+1.18.x" = _MCEPhWP9;
        "pkg-0.6.2+1.20.5-1.21.x" = _sYVsWupR;
        "pkg-0.6.2+1.20.2-1.20.4" = _NooEwNC3;
        "pkg-0.6.2+1.19.x" = _nMyJi62a;
        "pkg-0.6.3+1.17.x" = _1MaXkuTX;
        "pkg-0.6.3+1.18.x" = _i2QpFloT;
        "pkg-0.6.3+1.19.x" = _TcWvnrnK;
        "pkg-0.6.3+1.20-1.20.1" = _x4RYEuqi;
        "pkg-0.6.3+1.20.2-1.20.4" = _klEkS8It;
        "pkg-0.6.3+1.20.5-1.21.x" = _ViVvOdPf;
        "pkg-0.6.4+1.17.x" = _9pvkursB;
        "pkg-0.6.4+1.18.x" = _f3M5Pd9N;
        "pkg-0.6.4+1.19.x" = _xsibYh5J;
        "pkg-0.6.4+1.20-1.20.1" = _nAfJeWs8;
        "pkg-0.6.4+1.20.5-1.21.x" = _MSrqIs2v;
        "pkg-0.6.4+1.20.2-1.20.4" = _bctMvlwb;
        "pkg-0.6.4+1.21.6" = _yoaHAJLy;
        "pkg-0.6.5+1.21.6" = _aW24vxt6;
        "pkg-0.6.6+1.17.x" = _z8UaWZoH;
        "pkg-0.6.6+1.18.x" = _n7tWRcc6;
        "pkg-0.6.6+1.19.x" = _pUfnoQnU;
        "pkg-0.6.6+1.20-1.20.1" = _CCuleEBD;
        "pkg-0.6.6+1.20.2-1.20.4" = _X3M1lUIE;
        "pkg-0.6.6+1.20.5-1.21.5" = _akOXp16D;
        "pkg-0.6.6+1.21.6-1.21.7" = _ogYajfJc;
        "pkg-0.6.7+1.17.x" = _HmsGvw6e;
        "pkg-0.6.7+1.18.x" = _LKEnmxCF;
        "pkg-0.6.7+1.19.x" = _EYEyJNQX;
        "pkg-0.6.7+1.20-1.20.1" = _NPilM3rz;
        "pkg-0.6.7+1.20.2-1.20.4" = _8EBSoQXo;
        "pkg-0.6.7+1.20.5-1.21.5" = _ei09Qh6G;
        "pkg-0.6.7+1.21.6-1.21.7" = _Z11btqAl;
        "pkg-0.6.8+1.21.9" = _LxV5ICYR;
        "pkg-0.6.9+1.21.9-1.21.10" = _eAZALhoq;
        "pkg-0.6.10+1.21.11" = _U4yszKjl;
        "pkg-0.6.11+1.21.11" = _G7FtujXU;
        "pkg-0.7.0+1.17.x" = _I253UEBp;
        "pkg-0.7.0+1.18.x" = _Mf7R4it2;
        "pkg-0.7.0+1.19.x" = _Gbw3uZ3Y;
        "pkg-0.7.0+1.20-1.20.1" = _mpY9tvxw;
        "pkg-0.7.0+1.20.2-1.20.4" = _O3ELQb52;
        "pkg-0.7.0+1.20.5-1.21.5" = _O3EH2z8R;
        "pkg-0.7.0+1.21.11" = _2g5gq6Li;
        "pkg-0.7.0+1.21.6-1.21.8" = _cjq41tHB;
        "pkg-0.7.0+1.21.9-1.21.10" = _Tg4tRzlG;
        "pkg-0.7.1+1.17.x" = _8KIvsjKa;
        "pkg-0.7.1+1.18.x" = _lldG3BCy;
        "pkg-0.7.1+1.19.x" = _keHNJbDn;
        "pkg-0.7.1+1.20-1.20.1" = _eGJ9TwIz;
        "pkg-0.7.1+1.20.2-1.20.4" = _ZlNr7xED;
        "pkg-0.7.1+1.20.5-1.21.5" = _N9HDRRbb;
        "pkg-0.7.1+1.21.11" = _6rsF8UxN;
        "pkg-0.7.1+1.21.6-1.21.8" = _Le4glABr;
        "pkg-0.7.1+1.21.9-1.21.10" = _3Li8k4Xy;
        "pkg-0.8.0+1.17.x" = _DSjmNGN2;
        "pkg-0.8.0+1.18.x" = _TEC8okep;
        "pkg-0.8.0+1.19.x" = _V7z01azy;
        "pkg-0.8.0+1.20-1.20.1" = _ZylHREY9;
        "pkg-0.8.0+1.20.2-1.20.4" = _Q20WxO81;
        "pkg-0.8.0+1.20.5-1.21.5" = _kc4rugnM;
        "pkg-0.8.0+1.21.11" = _Xeqml8xt;
        "pkg-0.8.0+1.21.6-1.21.8" = _f1QbIUhY;
        "pkg-0.8.0+1.21.9-1.21.10" = _gAhlh8EY;
        "pkg-0.9.0+1.17.x" = _E9wu0xDj;
        "pkg-0.9.0+1.18.x" = _CN3pw5Zn;
        "pkg-0.9.0+1.19.x" = _cM1hD7V1;
        "pkg-0.9.0+1.20-1.20.1" = _DGw2YY50;
        "pkg-0.9.0+1.20.2-1.20.4" = _D0rv5aC2;
        "pkg-0.9.0+1.20.5-1.21.5" = _7XH5pjTV;
        "pkg-0.9.0+1.21.11" = _fdj6vTJt;
        "pkg-0.9.0+1.21.6-1.21.8" = _jWtYpGaN;
        "pkg-0.9.0+1.21.9-1.21.10" = _Vvs6ISjn;
        "pkg-0.10.0+1.17.x" = _Lp89pTnh;
        "pkg-0.10.0+1.18.x" = _7yGkYkDS;
        "pkg-0.10.0+1.19.x" = _x4Z3sjdR;
        "pkg-0.10.0+1.20-1.20.1" = _IYyjOi7t;
        "pkg-0.10.0+1.20.2-1.20.4" = _GaruNjQ9;
        "pkg-0.10.0+1.20.5-1.21.5" = _PHsD7o06;
        "pkg-0.10.0+1.21.11" = _rvcT6Le6;
        "pkg-0.10.0+1.21.6-1.21.8" = _B0iqoTlx;
        "pkg-0.10.0+1.21.9-1.21.10" = _Gwto7qxm;
        "pkg-0.10.1+1.17.x" = _JsYZgvrN;
        "pkg-0.10.1+1.18.x" = _EGK4AeDN;
        "pkg-0.10.1+1.19.x" = _IznqKLl9;
        "pkg-0.10.1+1.20-1.20.1" = _82HCuHOr;
        "pkg-0.10.1+1.20.2-1.20.4" = _3mWhA4gk;
        "pkg-0.10.1+1.20.5-1.21.5" = _fM6i7JvI;
        "pkg-0.10.1+1.21.11" = _T2Vp3IE0;
        "pkg-0.10.1+1.21.6-1.21.8" = _O2UJ48Ld;
        "pkg-0.10.1+1.21.9-1.21.10" = _H1XZpVNX;
        "pkg-0.10.1+26.1" = _2FtF5NTn;
        "pkg-0.10.2+1.17.x" = _8dg0XXpz;
        "pkg-0.10.2+1.18.x" = _CNahcJ5i;
        "pkg-0.10.2+1.19.x" = _8mcTBPfn;
        "pkg-0.10.2+1.20-1.20.1" = _hHqntDzb;
        "pkg-0.10.2+1.20.2-1.20.4" = _Jgy4Cb59;
        "pkg-0.10.2+1.20.5-1.21.5" = _19n9WMIE;
        "pkg-0.10.2+1.21.11" = _yGFwOGUu;
        "pkg-0.10.2+1.21.6-1.21.8" = _yBMkUjZI;
        "pkg-0.10.2+1.21.9-1.21.10" = _q0EmKIIr;
        "pkg-0.10.2+26.1.x" = _6Apkb2Bs;
        "pkg-0.11.0+1.17.x" = _VlzgExxM;
        "pkg-0.11.0+1.18.x" = _znNXvmFY;
        "pkg-0.11.0+1.19.x" = _JTfMGju7;
        "pkg-0.11.0+1.20-1.20.1" = _ma7x4kPd;
        "pkg-0.11.0+1.20.2-1.20.4" = _rxi3Yd5Q;
        "pkg-0.11.0+1.20.5-1.21.5" = _pMGQwdw7;
        "pkg-0.11.0+1.21.11" = _hIu4gS4R;
        "pkg-0.11.0+1.21.6-1.21.8" = _ASQxLJt2;
        "pkg-0.11.0+1.21.9-1.21.10" = _4bLbHXc1;
        "pkg-0.11.0+26.1.x" = _FmRpWd1u;
        "pkg-0.11.1+1.17.x" = _zVStYAx1;
        "pkg-0.11.1+1.18.x" = _8JnmtDQl;
        "pkg-0.11.1+1.19.x" = _6nPUIAZB;
        "pkg-0.11.1+1.20-1.20.1" = _X4cdFmy5;
        "pkg-0.11.1+1.20.2-1.20.4" = _RT16F4l9;
        "pkg-0.11.1+1.20.5-1.21.5" = _tIlOiJxx;
        "pkg-0.11.1+1.21.11" = _LGRr5cXT;
        "pkg-0.11.1+1.21.6-1.21.8" = _vXwDcEKn;
        "pkg-0.11.1+1.21.9-1.21.10" = _pi1HJAQx;
        "pkg-0.11.1+26.1.x" = _IhymkXo9;
        "pkg-0.12.0+1.17.x" = _KSUqdyBf;
        "pkg-0.12.0+1.18.x" = _HvASyLsO;
        "pkg-0.12.0+1.19.x" = _W5WM7DmR;
        "pkg-0.12.0+1.20-1.20.1" = _DhUT3beb;
        "pkg-0.12.0+1.20.2-1.20.4" = _3gV5U4Xp;
        "pkg-0.12.0+1.20.5-1.21.5" = _usL0nfp1;
        "pkg-0.12.0+1.21.11" = _ah1loNL8;
        "pkg-0.12.0+1.21.6-1.21.8" = _iGLg0MTZ;
        "pkg-0.12.0+1.21.9-1.21.10" = _YlYKGbwi;
        "pkg-0.12.0+26.1.x" = _2mYCTfz8;
        "pkg-0.12.0+26.2.x" = _QxGYJy8p;
        "pkg-0.13.0+1.17.x-blue" = _hkZIL3km;
        "pkg-0.13.0+1.18.x-blue" = _YHaEbg6d;
        "pkg-0.13.0+1.19.x-blue" = _7pfXVAjS;
        "pkg-0.13.0+1.20-1.20.1-blue" = _vngURXAJ;
        "pkg-0.13.0+1.20.2-1.20.4-blue" = _AxpoTqRo;
        "pkg-0.13.0+1.20.5-1.21.5-blue" = _HLglhjkS;
        "pkg-0.13.0+1.21.11-blue" = _GPfl6wWn;
        "pkg-0.13.0+1.21.6-1.21.8-blue" = _BVggL23A;
        "pkg-0.13.0+1.21.9-1.21.10-blue" = _jI3URILl;
        "pkg-0.13.0+26.1.x-blue" = _ARYltiFc;
        "pkg-0.13.0+26.2.x-blue" = _u0xZQI0I;
        "pkg-0.13.0+1.17.x" = _JaUwKwEF;
        "pkg-0.13.0+1.18.x" = _tf4llyoW;
        "pkg-0.13.0+1.19.x" = _O79jPu0R;
        "pkg-0.13.0+1.20-1.20.1" = _OaZJfeVF;
        "pkg-0.13.0+1.20.2-1.20.4" = _MBxywqaH;
        "pkg-0.13.0+1.20.5-1.21.5" = _VDS2gX4p;
        "pkg-0.13.0+1.21.11" = _OakYFzhs;
        "pkg-0.13.0+1.21.6-1.21.8" = _WEQZLwLS;
        "pkg-0.13.0+1.21.9-1.21.10" = _soX99Df6;
        "pkg-0.13.0+26.1.x" = _lXQMPDGf;
        "pkg-0.13.0+26.2.x" = _z33V1EUJ;
        "pkg-0.14.0+1.17.x-blue" = _mPYIBBaW;
        "pkg-0.14.0+1.18.x-blue" = _VrZmYYdm;
        "pkg-0.14.0+1.19.x-blue" = _uW6HOeDT;
        "pkg-0.14.0+1.20-1.20.1-blue" = _5aIJ5oDP;
        "pkg-0.14.0+1.20.2-1.20.4-blue" = _yck9qbDM;
        "pkg-0.14.0+1.20.5-1.21.5-blue" = _jprVwSJs;
        "pkg-0.14.0+1.21.11-blue" = _BvnqvjCx;
        "pkg-0.14.0+1.21.6-1.21.8-blue" = _iROBup9S;
        "pkg-0.14.0+1.21.9-1.21.10-blue" = _XwCMPpN8;
        "pkg-0.14.0+26.1.x-blue" = _7HOoUZmg;
        "pkg-0.14.0+26.2.x-blue" = _vkFyEbwu;
        "pkg-0.14.0+1.17.x" = _LswRp53q;
        "pkg-0.14.0+1.18.x" = _RGm23kj7;
        "pkg-0.14.0+1.19.x" = _k2qzNTFB;
        "pkg-0.14.0+1.20-1.20.1" = _lithexXD;
        "pkg-0.14.0+1.20.2-1.20.4" = _ZwblpZij;
        "pkg-0.14.0+1.20.5-1.21.5" = _YB6oJ0ol;
        "pkg-0.14.0+1.21.11" = _3R6et2xX;
        "pkg-0.14.0+1.21.6-1.21.8" = _6x5apFxc;
