...
let
    versions = (let
        ...
        _yP4IUf3T = {
            "id" = "yP4IUf3T";
            "file" = "bucketlib-neoforge-26.2-5.2.0.2.jar";
            "hash" = "sha512-OH68NDFZ0pPJfJnhzNeIfXEdA1DIGN6sxrhfDTav6finTOz4VB4L/D7HtXnymW/KJVNx3oB7YSB9Bqdd7yIzFQ==";
        };
        _rIjTrpMZ = {
            "id" = "rIjTrpMZ";
            "file" = "bucketlib-fabric-26.2-5.2.0.2.jar";
            "hash" = "sha512-T7sGM6w7FF5z9FTuoZAK8JQj+ZqYoJhwPS56hkSLzdRfuYETRlPB/x2vkmKWZOkJre7mFh4GxaOwWGMpjt5DSQ==";
        };
        _SLm2Zz4Z = {
            "id" = "SLm2Zz4Z";
            "file" = "bucketlib-fabric-26.1.2-5.1.0.1.jar";
            "hash" = "sha512-ZpX+V1Got8fCFnSPX9vFYxz2dBPiT8xy4sBJ34unJm3WgpgIjKVRtrAvca54BCfglgMIgjsRxw2JF6BS1wzkTg==";
        };
        _kn0qu705 = {
            "id" = "kn0qu705";
            "file" = "bucketlib-neoforge-26.1.2-5.1.0.1.jar";
            "hash" = "sha512-zG/NCV48LCfpcC9FAtW8Rj5GNOmpU+cbRAUkh5F9IWyJYo3iV1OVAr6101aGXOerEonTFEIFegrGrlS9Gv147A==";
        };
        _NhX9yXD6 = {
            "id" = "NhX9yXD6";
            "file" = "bucketlib-neoforge-1.21.4-4.3.0.5.jar";
            "hash" = "sha512-aCmz7gPV4SCpBkyEcwbQakjq7U+HIa5vNFJTOw9XUUpAXNJhHv1sgRJseyuJfJonqC9POIdnSJV0Q2wggTz04g==";
        };
        _49metcSW = {
            "id" = "49metcSW";
            "file" = "bucketlib-fabric-1.21.4-4.3.0.5.jar";
            "hash" = "sha512-hR6g+juqPPSy4tiaHsimXGBfA6yCfE50CurGIJttFCM3pDIsrLffM/XyW3xvKjfQa6FVcyylMug1s3PrnfLvvQ==";
        };
        _LW0h7rSe = {
            "id" = "LW0h7rSe";
            "file" = "bucketlib-fabric-1.21.11-4.7.2.1.jar";
            "hash" = "sha512-dXxVUfi3u4lwNj4vj47UM0VP88x+/8ixT+NIzeq6chwKOcHd4m/uHGCLyYnqyaPZTjvh7tkEqfo1EoZTbmNoiA==";
        };
        _CEKfBU32 = {
            "id" = "CEKfBU32";
            "file" = "bucketlib-neoforge-1.21.11-4.7.2.1.jar";
            "hash" = "sha512-uora3+MMZsUM7ESC1g6NTgoix5waRw4ViCsVPcIc4lBw75uRLQZUGblmU6s+B8b92wIRqXUkZ59ym9ZlVXktFA==";
        };
        _FsbR9rU0 = {
            "id" = "FsbR9rU0";
            "file" = "bucketlib-neoforge-1.21.3-4.2.5.3.jar";
            "hash" = "sha512-mrW/+1QyVwMuk4LdrrBLdCR8oq+dCyjPc3k5KIvCkkiPw8KXzPM7v3aQ0pp+MYGJSnbM1nzWxAAsNNvDBK6GfQ==";
        };
        _g5L8mGOh = {
            "id" = "g5L8mGOh";
            "file" = "bucketlib-fabric-1.21.5-4.4.0.5.jar";
            "hash" = "sha512-VXjdGv7J3OGSdxnHKVOsdDwd4tV5Z8tt/419efZNr49h7nfCXSXMhFUs+nLfo/bwJ7i8RjFEMMQZTdYyJz0UTg==";
        };
        _ehCCCem3 = {
            "id" = "ehCCCem3";
            "file" = "bucketlib-fabric-1.21.3-4.2.5.3.jar";
            "hash" = "sha512-ZNfVm52IC2UZhi3e33GTMa7akykUk2UDGIyEnsTCVFrWFSQeDDyNPARdeg6C2o2htFoJmLbbqDCiihq7vj+D7Q==";
        };
        _tpdPBQku = {
            "id" = "tpdPBQku";
            "file" = "bucketlib-neoforge-1.21.5-4.4.0.5.jar";
            "hash" = "sha512-v3HTghaLz+MysHzQCgJnxTPihdelgH9sFsxyKdrJAXOmNZ12/Lan82jDJMi6RfZnXvNOtzXQC5wL3GIpUzpMjg==";
        };
        _rsBdUMAJ = {
            "id" = "rsBdUMAJ";
            "file" = "bucketlib-neoforge-1.21.6-4.4.999.2.jar";
            "hash" = "sha512-iy54orHS0Red4btPv0ZnagEKdxqPjfM0B4PCMzOZT85j0Vu5kYsKA4c8zz4Tbr9Lb6INU2sf4vs7tdkn3bUyoA==";
        };
        _Vdo4bcqa = {
            "id" = "Vdo4bcqa";
            "file" = "bucketlib-fabric-1.21.6-4.4.999.2.jar";
            "hash" = "sha512-GfnKUqcdjOAThQ35FtnuAdLymh1iMAoz99uOslslXtz4sUy10yAlMqAbNvv0jY0H2KKRFXkOGCnF5lRMV7QAFg==";
        };
        _k8jwjF7C = {
            "id" = "k8jwjF7C";
            "file" = "bucketlib-neoforge-1.21.7-4.5.0.4.jar";
            "hash" = "sha512-ukC6pEx/ERUR58qxetQb+QuJxPoVvI/E6COk5YIyKdURKaNuaAbKFywJQL3T4BgjbbEa8OrpzeUhgF/ECnqA6g==";
        };
        _xEhW4I9o = {
            "id" = "xEhW4I9o";
            "file" = "bucketlib-fabric-1.21.7-4.5.0.4.jar";
            "hash" = "sha512-qmSZRNftC4K5BU+o8qht25adj5ATgqPTdOVeMnmT9ZAgVmb/Dzw9y6GeyB7p5ZB8F+WPSMvP4cUInxt/yN9nLg==";
        };
        _zQ30sTA3 = {
            "id" = "zQ30sTA3";
            "file" = "bucketlib-fabric-1.21.9-4.6.1.1.jar";
            "hash" = "sha512-le2cGH4Ou25ES8cBfrqJqx5gQzOQqn+/wdUxe8GeSN/wi1tDKa9AecTQ9h4V5hlXAdl29flAg1yhSkMMbUrMkg==";
        };
        _sH4euQbL = {
            "id" = "sH4euQbL";
    ...
    in {
        ...
        "neoforge-1.21.3" = _FsbR9rU0;
        "neoforge-1.21.4" = _NhX9yXD6;
        "neoforge-1.21.5" = _tpdPBQku;
        "neoforge-1.21.7" = _k8jwjF7C;
        "neoforge-1.21.8" = _k8jwjF7C;
        "neoforge-1.21.9" = _sH4euQbL;
        "neoforge-1.21.10" = _sH4euQbL;
        "neoforge-1.21.11" = _CEKfBU32;
        ...
        "fabric-1.21.3" = _ehCCCem3;
        "fabric-1.21.4" = _49metcSW;
        "fabric-1.21.5" = _g5L8mGOh;
        "fabric-1.21.7" = _xEhW4I9o;
        "fabric-1.21.8" = _xEhW4I9o;
        "fabric-1.21.9" = _zQ30sTA3;
        "fabric-1.21.10" = _zQ30sTA3;
        "fabric-1.21.11" = _LW0h7rSe;
        ...
        "quilt-1.21.3" = _ehCCCem3;
        "quilt-1.21.4" = _49metcSW;
        "quilt-1.21.5" = _g5L8mGOh;
        "quilt-1.21.7" = _xEhW4I9o;
        "quilt-1.21.8" = _xEhW4I9o;
        "quilt-1.21.9" = _zQ30sTA3;
        "quilt-1.21.10" = _zQ30sTA3;
        "quilt-1.21.11" = _LW0h7rSe;
        ...
        "pkg-1.19-1.0.3.3" = _7gwuPGu2;
        "pkg-1.19.3-1.1.0.1" = _KnR9fWt6;
        "pkg-1.19.3-1.1.1.0" = _v2vszU9j;
        "pkg-1.19.3-1.1.1.1" = _hQTqUzJg;
        "pkg-1.19.3-1.1.2.0" = _mucinuY1;
        "pkg-1.18.2-0.5.4.0" = _dEFLfFuh;
        "pkg-1.19-1.0.4.0" = _SPbNo8xi;
        "pkg-1.19.3-1.1.2.1" = _6RrFLwcg;
        "pkg-1.19-1.0.4.1" = _DSpz2gZC;
        "pkg-1.18.2-0.5.4.1" = _9ubMOP2J;
        "pkg-1.19.3-1.1.2.2" = _LMhGiZVy;
        "pkg-1.19-1.0.5.0" = _TnlY3kQm;
        "pkg-1.18.2-0.5.5.0" = _J5to1CKK;
        "pkg-1.19.3-1.2.0.0" = _Vu81h8nC;
        "pkg-1.20-2.0.0.0" = _Y6MgfEgQ;
        "pkg-1.20.1-2.1.0.0" = _CfZ3oga2;
        "pkg-1.20.1-2.2.0.0" = _blKtGcRT;
        "pkg-1.19-1.0.6.0" = _qHAlrKlo;
        "pkg-1.19.4-1.3.0.0" = _r7yHAnXu;
        "pkg-1.20.1-2.2.0.1" = _o6kYt6Sm;
        "pkg-1.20.1-2.2.0.2" = _6vUVaJLT;
        "pkg-1.20.1-2.3.0.0" = _nIyjhYVH;
        "pkg-1.20.1-2.3.0.1" = _fVluhOl8;
        "pkg-1.19-1.0.6.1" = _lrbQhTfz;
        "pkg-1.19.4-1.3.0.1" = _smuEEHXI;
        "pkg-1.20.2-2.4.0.0" = _S5oMSwci;
        "pkg-1.20.2-2.4.0.1" = _OrA60MoW;
        "pkg-1.20.1-2.3.0.2" = _hQQqmkQe;
        "pkg-1.19.2-1.0.7.0" = _rWmTBYhA;
        "pkg-1.20.2-2.4.0.2" = _dXGLyDF2;
        "pkg-1.19.4-1.3.0.2" = _2FWxQ9aj;
        "pkg-1.20.2-2.4.0.3" = _xCrH3Op2;
        "pkg-1.20.1-2.3.0.4" = _ElCGFnkC;
        "pkg-1.20.2-2.4.0.4" = _V45TNm2Q;
        "pkg-1.20.1-2.3.0.5" = _hYBZtYnn;
        "pkg-1.20.2-3.0.0.0" = _5h3V7GcV;
        "pkg-1.20.2-3.0.0.1" = _eTWW48P5;
        "pkg-1.20.2-3.0.0.2" = _dixlENqz;
        "pkg-1.20.2-3.0.0.3" = _i83Sw5oW;
        "pkg-1.20.2-3.0.0.4" = _LNdHXvH6;
        "pkg-1.20.2-3.0.0.5" = _5IJkhGQN;
        "pkg-1.20.4-3.1.0.0" = _8XyXsdj7;
        "pkg-1.20.4-3.1.0.1" = _uIzjIF8c;
        "pkg-1.20.1-2.3.1.0" = _ctCDf4T7;
        "pkg-1.20.4-3.1.1.0" = _Im9NA1as;
        "pkg-1.20.1-2.3.2.0" = _1FlQEq3G;
        "pkg-1.20.4-3.1.2.0" = _rNsUlINq;
        "pkg-1.20.4-3.1.2.1" = _PaRp0X3d;
        "pkg-1.20.1-2.3.3.0" = _8wBAAkcf;
        "pkg-1.20.4-3.1.3.0" = _MrLd9jTB;
        "pkg-1.20.1-2.3.3.1" = _aB04efjZ;
        "pkg-1.20.4-3.1.3.1" = _qdY7CpFk;
        "pkg-1.20.1-2.3.3.2" = _4g88gMqP;
        "pkg-1.20.4-3.1.3.2" = _hFzyBuI2;
        "pkg-1.19.4-1.3.1.0" = _HHqSySK2;
        "pkg-1.20.1-2.3.4.0" = _iI1act1J;
        "pkg-1.19.2-1.0.8.0" = _Fw9dn87t;
        "pkg-1.20.4-3.2.0.0" = _m7RVq7lQ;
        "pkg-1.20.4-3.2.0.1" = _bGEssHP1;
        "pkg-1.20.4-3.2.0.2" = _umeEEvel;
        "pkg-1.20.4-3.2.0.3" = _KgXE2dd8;
        "pkg-1.20.4-3.2.1.0" = _V7rLO35z;
        "pkg-1.20.6-3.3.0.0" = _mpnSjCfA;
        "pkg-1.20.6-3.3.0.1" = _XQ2nIOoP;
        "pkg-1.20.6-3.3.0.2" = _A9nNTFYa;
        "pkg-1.20.6-3.3.0.3" = _fPB9fSta;
        "pkg-1.21-4.0.0.0" = _F6EEeBBk;
        "pkg-1.21-4.0.0.1" = _kCwdRU3U;
        "pkg-1.20.6-3.3.0.4" = _q5zF7aeq;
        "pkg-1.21-4.0.0.2" = _64jyi1VD;
        "pkg-1.20.6-3.3.0.5" = _idnTmZQh;
        "pkg-1.20.4-3.2.1.1" = _nlYQjJDg;
        "pkg-1.19.2-1.0.8.1" = _3pnkU0TB;
        "pkg-1.19.4-1.3.1.1" = _TndkfPyl;
        "pkg-1.20.1-2.3.4.1" = _GNzkpuO8;
        "pkg-1.20.4-3.2.1.2" = _z2OY7cH3;
        "pkg-1.20.6-3.3.0.6" = _yaY2wWTO;
        "pkg-1.21-4.0.0.3" = _pzqeSB5V;
        "pkg-1.21-4.0.0.4" = _7NwMFOgT;
        "pkg-1.21-4.0.0.5" = _d05O3FO1;
        "pkg-1.21-4.0.0.6" = _awISyozF;
        "pkg-1.21-4.1.0.0" = _PFZIoEui;
        "pkg-1.20.6-3.3.0.7" = _ePS4vdTx;
        "pkg-1.20.4-3.2.1.3" = _W2attqZV;
        "pkg-1.21-4.1.0.1" = _hR35pifk;
        "pkg-1.20.1-2.3.4.2" = _bIRhCZoE;
        "pkg-1.20.6-3.3.0.8" = _iCzFmE5R;
        "pkg-1.20.4-3.2.1.4" = _bcNllDnd;
        "pkg-1.20.1-2.3.4.3" = _G26p37uc;
        "pkg-1.20.4-3.2.1.5" = _oI5UIGLM;
        "pkg-1.21-4.1.0.2" = _u746Yx1j;
        "pkg-1.20.6-3.3.0.9" = _aqPXX4OL;
        "pkg-1.21-4.1.0.3" = _iLTJB6kk;
        "pkg-1.20.6-3.3.0.10" = _WDdHwFqU;
        "pkg-1.21-4.1.0.4" = _XT0WOUHO;
        "pkg-1.20.6-3.3.0.11" = _bpkVYy3f;
        "pkg-1.20.4-3.2.1.6" = _AvUy7IYP;
        "pkg-1.21-4.1.1.0" = _UCd5PFGa;
        "pkg-1.20.1-2.3.5.0" = _1xIlCJIV;
        "pkg-1.20.6-3.3.1.0" = _QIurgYC1;
        "pkg-1.20.4-3.2.2.0" = _hVi8VgBc;
        "pkg-1.21-4.1.1.1" = _Dv2OWhu0;
        "pkg-1.20.6-3.3.1.1" = _Ll9hGjs0;
        "pkg-1.21-4.1.2.0" = _UuVfv4ef;
        "pkg-1.20.4-3.2.2.1" = _89NQqqXO;
        "pkg-1.20.1-2.3.5.1" = _O4Ow9WAY;
        "pkg-1.20.1-2.3.5.2" = _l02p8mIH;
        "pkg-1.21.3-4.2.0.0" = _Ws90O3Yb;
        "pkg-1.21.3-4.2.0.1" = _OSVjWiy6;
        "pkg-1.21.3-4.2.0.2" = _EtvaZk48;
        "pkg-1.21.3-4.2.0.3" = _hQApNYag;
        "pkg-1.21.3-4.2.0.4" = _TxnISBii;
        "pkg-1.20.1-2.3.5.3" = _20ZVUO2C;
        "pkg-1.20.4-3.2.2.2" = _NiqDmFyX;
        "pkg-1.20.6-3.3.1.2" = _z9vCpdJY;
        "pkg-1.21.3-4.2.0.5" = _jM3rJItl;
        "pkg-1.21-4.1.2.1" = _QAEBlINd;
        "pkg-1.21.3-4.2.0.6" = _KYVkx6Jz;
        "pkg-1.21-4.1.2.2" = _W3iTZpkx;
        "pkg-1.20.6-3.3.1.3" = _uIvocaov;
        "pkg-1.21.3-4.2.0.7" = _rNYg6Iaf;
        "pkg-1.21-4.1.2.3" = _rBjABgjW;
        "pkg-1.20.1-2.3.6.0" = _oZtq9p8S;
        "pkg-1.20.4-3.2.3.0" = _51S3fbU1;
        "pkg-1.20.6-3.3.2.0" = _rnCz9tPH;
        "pkg-1.21-4.1.3.0" = _HwFI8Fub;
        "pkg-1.21.3-4.2.1.0" = _bZ88JS9z;
        "pkg-1.20.1-2.3.7.0" = _bEavSTpp;
        "pkg-1.20.4-3.2.4.0" = _K1pkBflA;
        "pkg-1.20.4-3.2.4.1" = _lsVbKZaS;
        "pkg-1.21.3-4.2.2.0" = _QtqtujZ1;
        "pkg-1.21-4.1.4.0" = _J5MYvm16;
        "pkg-1.20.6-3.3.3.0" = _HUP2bORo;
        "pkg-1.20.1-2.3.7.1" = _mELORSmx;
        "pkg-1.21.3-4.2.2.1" = _JyX9MWof;
        "pkg-1.21-4.1.4.1" = _MaXWROaQ;
        "pkg-1.21.3-4.2.3.0" = _7M5lu9Tm;
        "pkg-1.20.4-3.2.5.0" = _E03EjD60;
        "pkg-1.20.6-3.3.4.0" = _EQJCanFo;
        "pkg-1.21-4.1.5.0" = _Z25FcCR0;
        "pkg-1.21.3-4.2.4.0" = _lkgFCDm3;
        "pkg-1.21-4.1.6.0" = _k3WNgKzp;
        "pkg-1.20.1-2.3.8.0" = _vkc1qThF;
        "pkg-1.20.4-3.2.6.0" = _fAD2LIo7;
        "pkg-1.20.6-3.3.5.0" = _Dhxvbqmj;
        "pkg-1.21-4.1.7.0" = _nqIxSyQU;
        "pkg-1.21.3-4.2.5.0" = _kuZ9aE8E;
        "pkg-1.21.4-4.3.0.0" = _128TpDxb;
        "pkg-1.21.4-4.3.0.1" = _zyPuzUlj;
        "pkg-1.21.5-4.4.0.0" = _i2WjNivk;
        "pkg-1.21.5-4.4.0.1" = _sOKyuvzf;
        "pkg-1.21.7-4.5.0.0" = _6DSeCpSU;
        "pkg-1.21.5-4.4.0.2" = _ssVkRZLY;
        "pkg-1.21.7-4.5.0.1" = _QelgwegE;
        "pkg-1.21.4-4.3.0.2" = _huS1SvrX;
        "pkg-1.21.9-4.6.0.0" = _pxbpV1DZ;
        "pkg-1.21.4-4.3.0.3" = _plteJQ7v;
        "pkg-1.21.5-4.4.0.3" = _tAErJL0t;
        "pkg-1.21.7-4.5.0.2" = _Zi6gigxy;
        "pkg-1.21.3-4.2.5.1" = _T2YpNz5B;
        "pkg-1.21-4.1.7.1" = _MK0RGSk8;
        "pkg-1.21.9-4.6.0.1" = _f1DfU4XB;
        "pkg-1.21.9-4.6.0.2" = _DW5q9g9A;
        "pkg-1.21.11-4.7.0.0" = _dBXVscRs;
        "pkg-1.21.11-4.7.0.1" = _FBab7MAK;
        "pkg-1.21.11-4.7.0.2" = _uGNUoQ4E;
        "pkg-1.21.11-4.7.0.3" = _gkIF2Ch0;
        "pkg-26.1-5.0.0.0" = _Xb6aybgk;
        "pkg-26.1-5.0.1.0" = _3fH3OxFK;
        "pkg-1.21.11-4.7.1.0" = _fjRwLW1g;
        "pkg-26.1-5.0.1.1" = _aHvjqgAT;
        "pkg-1.21.9-4.6.0.3" = _WWkLm7i3;
        "pkg-26.1-5.0.1.2" = _HSywAVHZ;
        "pkg-1.21.6-4.4.999.0" = _pjLGFO7Q;
        "pkg-1.21-4.1.7.2" = _g9gIvUuz;
        "pkg-1.21.3-4.2.5.2" = _EZIIxyke;
        "pkg-1.21.4-4.3.0.4" = _OWoMMFVp;
        "pkg-1.21.5-4.4.0.4" = _iX3a6HWf;
        "pkg-1.21.6-4.4.999.1" = _4dD6nGkV;
        "pkg-1.21.7-4.5.0.3" = _NWp1oDdv;
        "pkg-1.21.9-4.6.1.0" = _UgM54KOn;
        "pkg-1.21.11-4.7.2.0" = _u11Guth9;
        "pkg-26.1-5.0.1.3" = _OGEkcpka;
        "pkg-26.1-5.0.1.4" = _5j4UQiJ1;
        "pkg-26.1-5.0.2.0" = _mMPRCM9A;
        "pkg-26.1-5.0.2.1" = _t08wZk0y;
        "pkg-26.1-5.0.3.0" = _81bdc1fg;
        "pkg-26.1-5.0.4.0" = _8ydD7Xn9;
        "pkg-26.1-5.0.4.1" = _geaJAhj2;
        "pkg-26.1.2-5.1.0.0" = _6ApfvCGD;
        "pkg-26.2-5.2.0.0" = _QD9gEZZE;
        "pkg-26.2-5.2.0.1" = _n2zWWu2I;
        "pkg-26.2-5.2.0.2" = _rIjTrpMZ;
        "pkg-26.1.2-5.1.0.1" = _kn0qu705;
        "pkg-1.21.4-4.3.0.5" = _49metcSW;
        "pkg-1.21.11-4.7.2.1" = _CEKfBU32;
        "pkg-1.21.3-4.2.5.3" = _ehCCCem3;
        "pkg-1.21.5-4.4.0.5" = _tpdPBQku;
