...
let
    versions = (let
        ...
        _tzRSf3wy = {
            "id" = "tzRSf3wy";
            "file" = "CustomAnvil-2.0.0-dev-dff35bc.jar";
            "hash" = "sha512-SmHqL7kFu61VE2jDxWEPqvMlF3nyBHXQ9VNkeqQKXhQ/I5xJ62uISj3pvvX/n5Ybm5dZ6ZDf3lPjU9f1PWlTgQ==";
        };
        _Bn1nlUwB = {
            "id" = "Bn1nlUwB";
            "file" = "CustomAnvil-2.0.0-dev-ab47a9d.jar";
            "hash" = "sha512-HGuzbLTY9jbo9olew68So6EfAnQhNfypbqRO2icbByvgTqXDeQ/XVnYMrLzZTLrZJ0UgyxUmUpzQwsWodSGrFg==";
        };
        _uUN6wRiz = {
            "id" = "uUN6wRiz";
            "file" = "CustomAnvil-2.0.0-dev-16375af.jar";
            "hash" = "sha512-/nq3ZIl9mGMRJ58htxL7TCMyc5RRa5METmk2NTSxLiRb02SXtJNz8glAF9UYgbzLg1oKhu8ZQC3KQfpzwuZMEg==";
        };
        _e8VNYxjs = {
            "id" = "e8VNYxjs";
            "file" = "CustomAnvil-1.19.0.jar";
            "hash" = "sha512-JkAF44zxIfF7WYmoW1k2UlpT9pHFKMUPLf1LjeOhJmo7X9enLBzgji4uOqyvssrJ1AO2jnUfPYfGrvdTWUo1tA==";
        };
        _4VrfFhFv = {
            "id" = "4VrfFhFv";
            "file" = "CustomAnvil-2.0.0.jar";
            "hash" = "sha512-SSWwFh02jV/Ke7kMKVRJ1qkpkNHKbglaBpMfT3Xbvbf0NQjqmF6Qcu3HperspCb6hMM1mHPE+9olw8UfO8ZR8A==";
        };
        _cLHCxjHC = {
            "id" = "cLHCxjHC";
            "file" = "CustomAnvil-2.0.1-dev-643a5e9.jar";
            "hash" = "sha512-g8Gkpwi7n78/sctK1d+896v7Q+zDuVuGddW+fzSfygaJbwThUIoTiUqLrqMIyvNzxLZwR8wW6fXQGqEWyWZs7A==";
        };
        _7AgNc5VR = {
            "id" = "7AgNc5VR";
            "file" = "CustomAnvil-2.0.1.jar";
            "hash" = "sha512-sK9pa5WT7ueYvh8R4Kohot9GYDi+dXh4aqOmXozMqkUPScEIwsYXjOPRjckry7ASwGnmGftvTh/zUKco9COfDg==";
        };
        _QxaRLflv = {
            "id" = "QxaRLflv";
            "file" = "CustomAnvil-2.0.2-dev-64edb99.jar";
            "hash" = "sha512-pzC9NYXK0dZimAPY1DtIy7Coz5hik5JUNK5DE2VZ2jSb//vTw3Pb5UqwaRnKaPJkkqdKI9En1hrUiVE6SSZWQw==";
        };
        _D4PnO99p = {
            "id" = "D4PnO99p";
            "file" = "CustomAnvil-2.0.2-dev-4b8e71c.jar";
            "hash" = "sha512-BHgGG65xjxlkOjjvKjsKJpuW3VG8y7Rniz5CFWJLAKrwR5+G2Bdrm8E2K89Po1caNvwbARPCe1qgr6s9aCQWXQ==";
        };
        _U0aTriNL = {
            "id" = "U0aTriNL";
            "file" = "CustomAnvil-1.20.0.jar";
            "hash" = "sha512-uNkvPx7FeYSEbzrZGmXTHaj4TpUjedsdmRVA4p15E37Jr0sbWWvgXDVF5NOboPGghOn1GUu1ABVLqsFE/T+WJw==";
        };
        _DnYfb8XX = {
            "id" = "DnYfb8XX";
            "file" = "CustomAnvil-2.1.0-dev-74d2e38.jar";
            "hash" = "sha512-hDLIexOw6i6jcjJbNWUZ1UMqrwb9YEmlgcmmqoy4I3N4geTjgXbq7+o3vm3AbCveTMYukXJBfcmIb5Sg55fy5w==";
        };
        _mLIV6gh1 = {
            "id" = "mLIV6gh1";
            "file" = "CustomAnvil-2.1.0.jar";
            "hash" = "sha512-D3zdH4sh0C8Ouy38uXGsxsGObP41n4DHyOOT1JTeL30oeYD2Hz61vLn3ups+UvlveUN7zGz7SdlnvUQBSoPAUA==";
        };
        _ieK7spaJ = {
            "id" = "ieK7spaJ";
            "file" = "CustomAnvil-2.1.1-dev-6f36921.jar";
            "hash" = "sha512-Byz68X791DV/NVo9gIWDkaWCRUsvWSUUvUF6LAWhEoRzOhpVc0cm3NhviZXrbyGvDIQRjIwRVvIEpA1IsenE+w==";
        };
        _Pq3BQ30n = {
            "id" = "Pq3BQ30n";
            "file" = "CustomAnvil-2.1.1.jar";
            "hash" = "sha512-7UGJjcYei1FJEf19grhwp4nIUxGZHVnE7ZkFVMIf2ezq6YIt2O1hDeJrhTXUJrRJa25vv2OPAcjzDDlUMqUZ4g==";
        };
        _dWt8jlZe = {
            "id" = "dWt8jlZe";
            "file" = "CustomAnvil-2.1.2-dev-e8ad60f.jar";
            "hash" = "sha512-MisXUrxYUwCBb+mr2JDJUh6we3Brxa5QjmblcbBB/MoqD0yW8HiDcpEpGKDhwiWZah3ZlPUM7fZxVsZy7xAxqQ==";
        };
        _JgZ30ImG = {
            "id" = "JgZ30ImG";
            "file" = "CustomAnvil-2.1.2.jar";
            "hash" = "sha512-7Y6CIeIicSNdO/+xJB8D3jh6T34l03jeL8PGNOdf5n9D6JeT5zwTw6gzRn7DP9bEUciouYGVl3zukYSSgjPSvw==";
        };
        _hwxAOQHL = {
            "id" = "hwxAOQHL";
            "file" = "CustomAnvil-2.1.2-dev-cd19e78.jar";
            "hash" = "sha512-OTpUfHeBc1vaArha4YyuEhQd1GTO+KSf/Oce5qpnuzmAXefnXdyapn9sErlnSPuvCeVMPwJycFKE+YzElzQj8Q==";
        };
        _dMZwkyfE = {
            "id" = "dMZwkyfE";
            "file" = "CustomAnvil-2.1.2-dev-b63a58f.jar";
            "hash" = "sha512-BBuJJJc6D0G6IOpmZAeulRkO6MqkVMkIgMH/s5R4YedrITu1QOtAT/EI1SPPRtplrf4aEBfxwNI+ZDTa6A2NxQ==";
        };
        _LoH3YVlQ = {
            "id" = "LoH3YVlQ";
            "file" = "CustomAnvil-2.1.2-dev-e9a4121.jar";
            "hash" = "sha512-+/qfPt+E3ZCfTubup/pR6A3I4bCaoSc0aSJweYQER+zE+modaWmXDSyZWK3JhCX48vUhO1as2t6UcrzlrlGpIA==";
        };
    in {
        "ZMiFY6U9" = _ZMiFY6U9;
        "L6wR2VYW" = _L6wR2VYW;
        ...
        "dMZwkyfE" = _dMZwkyfE;
        "LoH3YVlQ" = _LoH3YVlQ;
        "paper-1.18" = _U0aTriNL;
        "paper-1.18.1" = _U0aTriNL;
        "paper-1.18.2" = _U0aTriNL;
        "paper-1.19" = _U0aTriNL;
        "paper-1.19.1" = _U0aTriNL;
        "paper-1.19.2" = _U0aTriNL;
        "paper-1.19.3" = _U0aTriNL;
        "paper-1.19.4" = _U0aTriNL;
        "paper-1.20" = _U0aTriNL;
        "paper-1.20.1" = _U0aTriNL;
        "paper-1.20.2" = _U0aTriNL;
        "paper-1.20.3" = _U0aTriNL;
        "paper-1.20.4" = _U0aTriNL;
        "paper-1.20.5" = _U0aTriNL;
        "paper-1.20.6" = _U0aTriNL;
        "paper-1.21" = _LoH3YVlQ;
        "paper-1.21.1" = _LoH3YVlQ;
        "paper-1.21.2" = _LoH3YVlQ;
        "paper-1.21.3" = _LoH3YVlQ;
        "paper-1.21.4" = _LoH3YVlQ;
        "paper-1.21.5" = _LoH3YVlQ;
        "paper-1.21.6" = _LoH3YVlQ;
        "paper-1.21.7" = _LoH3YVlQ;
        "paper-1.21.8" = _LoH3YVlQ;
        "paper-1.21.9" = _LoH3YVlQ;
        "paper-1.21.10" = _LoH3YVlQ;
        "paper-1.21.11" = _LoH3YVlQ;
        "paper-26.1" = _LoH3YVlQ;
        "paper-26.1.1" = _LoH3YVlQ;
        "paper-26.1.2" = _LoH3YVlQ;
        "paper-26.2" = _LoH3YVlQ;
        "spigot-1.18" = _U0aTriNL;
        "spigot-1.18.1" = _U0aTriNL;
        "spigot-1.18.2" = _U0aTriNL;
        "spigot-1.19" = _U0aTriNL;
        "spigot-1.19.1" = _U0aTriNL;
        "spigot-1.19.2" = _U0aTriNL;
        "spigot-1.19.3" = _U0aTriNL;
        "spigot-1.19.4" = _U0aTriNL;
        "spigot-1.20" = _U0aTriNL;
        "spigot-1.20.1" = _U0aTriNL;
        "spigot-1.20.2" = _U0aTriNL;
        "spigot-1.20.3" = _U0aTriNL;
        "spigot-1.20.4" = _U0aTriNL;
        "spigot-1.20.5" = _U0aTriNL;
        "spigot-1.20.6" = _U0aTriNL;
        "spigot-1.21" = _LoH3YVlQ;
        "spigot-1.21.1" = _LoH3YVlQ;
        "spigot-1.21.2" = _LoH3YVlQ;
        "spigot-1.21.3" = _LoH3YVlQ;
        "spigot-1.21.4" = _LoH3YVlQ;
        "spigot-1.21.5" = _LoH3YVlQ;
        "spigot-1.21.6" = _LoH3YVlQ;
        "spigot-1.21.7" = _LoH3YVlQ;
        "spigot-1.21.8" = _LoH3YVlQ;
        "spigot-1.21.9" = _LoH3YVlQ;
        "spigot-1.21.10" = _LoH3YVlQ;
        "spigot-1.21.11" = _LoH3YVlQ;
        "spigot-26.1" = _LoH3YVlQ;
        "spigot-26.1.1" = _LoH3YVlQ;
        "spigot-26.1.2" = _LoH3YVlQ;
        "spigot-26.2" = _LoH3YVlQ;
        "folia-1.18" = _U0aTriNL;
        "folia-1.18.1" = _U0aTriNL;
        "folia-1.18.2" = _U0aTriNL;
        "folia-1.19" = _U0aTriNL;
        "folia-1.19.1" = _U0aTriNL;
        "folia-1.19.2" = _U0aTriNL;
        "folia-1.19.3" = _U0aTriNL;
        "folia-1.19.4" = _U0aTriNL;
        "folia-1.20" = _U0aTriNL;
        "folia-1.20.1" = _U0aTriNL;
        "folia-1.20.2" = _U0aTriNL;
        "folia-1.20.3" = _U0aTriNL;
        "folia-1.20.4" = _U0aTriNL;
        "folia-1.20.5" = _U0aTriNL;
        "folia-1.20.6" = _U0aTriNL;
        "folia-1.21" = _LoH3YVlQ;
        "folia-1.21.1" = _LoH3YVlQ;
        "folia-1.21.2" = _LoH3YVlQ;
        "folia-1.21.3" = _LoH3YVlQ;
        "folia-1.21.4" = _LoH3YVlQ;
        "folia-1.21.5" = _LoH3YVlQ;
        "folia-1.21.6" = _LoH3YVlQ;
        "folia-1.21.7" = _LoH3YVlQ;
        "folia-1.21.8" = _LoH3YVlQ;
        "folia-1.21.9" = _LoH3YVlQ;
        "folia-1.21.10" = _LoH3YVlQ;
        "folia-1.21.11" = _LoH3YVlQ;
        "folia-26.1" = _LoH3YVlQ;
        "folia-26.1.1" = _LoH3YVlQ;
        "folia-26.1.2" = _LoH3YVlQ;
        "folia-26.2" = _LoH3YVlQ;
        "purpur-1.18" = _U0aTriNL;
        "purpur-1.18.1" = _U0aTriNL;
        "purpur-1.18.2" = _U0aTriNL;
        "purpur-1.19" = _U0aTriNL;
        "purpur-1.19.1" = _U0aTriNL;
        "purpur-1.19.2" = _U0aTriNL;
        "purpur-1.19.3" = _U0aTriNL;
        "purpur-1.19.4" = _U0aTriNL;
        "purpur-1.20" = _U0aTriNL;
        "purpur-1.20.1" = _U0aTriNL;
        "purpur-1.20.2" = _U0aTriNL;
        "purpur-1.20.3" = _U0aTriNL;
        "purpur-1.20.4" = _U0aTriNL;
        "purpur-1.20.5" = _U0aTriNL;
        "purpur-1.20.6" = _U0aTriNL;
        "purpur-1.21" = _LoH3YVlQ;
        "purpur-1.21.1" = _LoH3YVlQ;
        "purpur-1.21.2" = _LoH3YVlQ;
        "purpur-1.21.3" = _LoH3YVlQ;
        "purpur-1.21.4" = _LoH3YVlQ;
        "purpur-1.21.5" = _LoH3YVlQ;
        "purpur-1.21.6" = _LoH3YVlQ;
        "purpur-1.21.7" = _LoH3YVlQ;
        "purpur-1.21.8" = _LoH3YVlQ;
        "purpur-1.21.9" = _LoH3YVlQ;
        "purpur-1.21.10" = _LoH3YVlQ;
        "purpur-1.21.11" = _LoH3YVlQ;
        "purpur-26.1" = _LoH3YVlQ;
        "purpur-26.1.1" = _LoH3YVlQ;
        "purpur-26.1.2" = _LoH3YVlQ;
        "purpur-26.2" = _LoH3YVlQ;
        "pkg-1.6.0" = _ZMiFY6U9;
        "pkg-1.6.1" = _L6wR2VYW;
        "pkg-1.6.2" = _B2Y37b0Z;
        "pkg-1.6.3" = _FNXdyxWU;
        ...
        "pkg-dev-dff35bc" = _tzRSf3wy;
        "pkg-dev-ab47a9d" = _Bn1nlUwB;
        "pkg-dev-16375af" = _uUN6wRiz;
        "pkg-v1.19.0" = _e8VNYxjs;
        "pkg-v2.0.0" = _4VrfFhFv;
        "pkg-dev-643a5e9" = _cLHCxjHC;
        "pkg-v2.0.1" = _7AgNc5VR;
        "pkg-dev-64edb99" = _QxaRLflv;
        "pkg-dev-4b8e71c" = _D4PnO99p;
        "pkg-v1.20.0" = _U0aTriNL;
        "pkg-dev-74d2e38" = _DnYfb8XX;
        "pkg-v2.1.0" = _mLIV6gh1;
        "pkg-dev-6f36921" = _ieK7spaJ;
        "pkg-v2.1.1" = _Pq3BQ30n;
        "pkg-dev-e8ad60f" = _dWt8jlZe;
        "pkg-v2.1.2" = _JgZ30ImG;
        "pkg-dev-cd19e78" = _hwxAOQHL;
        "pkg-dev-b63a58f" = _dMZwkyfE;
        "pkg-dev-e9a4121" = _LoH3YVlQ;
        "default" = _LoH3YVlQ;
    });
