...
let
    versions = (let
        ...
        _EmVyByon = {
            "id" = "EmVyByon";
            "file" = "Katters Structures v2.6.zip";
            "hash" = "sha512-6SOCjZ+t+MKSEmvL5B2QqX1GfMwUL6nFKwyKufKz8tcrWhg0yPPH6IVPoYf7As0B53wskGbxeT/qDrl5XO99Yg==";
        };
        _GzzqBSTD = {
            "id" = "GzzqBSTD";
    ...
    in {
        ...
        "pkg-1.1" = _HX2xLvMb;
        "pkg-1.2" = _4wXsbxQX;
        "pkg-1.2+mod" = _NDKWm3eI;
        "pkg-1.3" = _d3MrdTD9;
        "pkg-1.3+mod" = _zl4aHrgh;
        "pkg-1.4" = _BVg74KdW;
        "pkg-1.4+mod" = _mE4bsqlZ;
        "pkg-1.5" = _WXcENiil;
        "pkg-1.5+mod" = _4Avae927;
        "pkg-1.6" = _udHMljEk;
        "pkg-1.6+mod" = _9lcqtOok;
        "pkg-1.7" = _Y7opJt4R;
        "pkg-1.7+mod" = _ilA7EizY;
        "pkg-1.8" = _32YhE6bA;
        "pkg-1.8+mod" = _Fhq2HCXz;
        "pkg-1.8.1" = _TW5PjTJK;
        "pkg-1.8.1+mod" = _dRLsdyFm;
        "pkg-1.9" = _CT9wvXBt;
        "pkg-1.9+mod" = _bqWzYglQ;
        "pkg-1.10" = _Joa9pJgI;
        "pkg-1.10+mod" = _d1chirhO;
        "pkg-2.0" = _R4wS5W6z;
        "pkg-2.0+mod" = _gWo7TuY7;
        "pkg-2.0.1" = _YmSX3289;
        "pkg-2.0.1+mod" = _jJjIDM7J;
        "pkg-2.1" = _EVitFvcX;
        "pkg-2.1+mod" = _5D49Bbzv;
        "pkg-2.1b" = _zBWBEYsC;
        "pkg-2.1b+mod" = _GdLsBSpw;
        "pkg-2.1c" = _wcMR2pFT;
        "pkg-2.1c+mod" = _EdSR8mgY;
        "pkg-2.2" = _HZJvdlh7;
        "pkg-2.2+mod" = _lqRxDHBe;
        "pkg-2.2.1" = _YrNQii3z;
        "pkg-2.2.1+mod" = _QYoBTMxW;
        "pkg-2.2.2a" = _gXvni9fS;
        "pkg-2.2.2a+mod" = _h3N73dJ3;
        "pkg-2.2.2" = _9xtpE6WF;
        "pkg-2.2.2+mod" = _fx4sMs2U;
        "pkg-2.3" = _FMlSmVpg;
        "pkg-2.3+mod" = _PYY29man;
        "pkg-2.3a" = _Qxh6MXbv;
        "pkg-2.3a+mod" = _Lfbq8spo;
        "pkg-2.3.1" = _lvYpH6SE;
        "pkg-2.3.1+mod" = _vuQTyYAp;
        "pkg-2.4" = _KPmwTD7S;
        "pkg-2.4+mod" = _awqugomg;
        "pkg-2.5" = _GyDzJkqO;
