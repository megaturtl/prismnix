...
let
    versions = (let
        ...
        _3N9GsdXB = {
            "id" = "3N9GsdXB";
            "file" = "FoOrders-3.4.jar";
            "hash" = "sha512-ggnI+J/UDZrAiti9R6f+d/O7wQs1OgCaP+H0jJGOa/xzaU38cPEmfUaiks5oCGKSlMRZ6nh4Yyg9lw3P5mVlqQ==";
        };
        _o3FTDVcl = {
            "id" = "o3FTDVcl";
            "file" = "FoOrders-3.5.jar";
            "hash" = "sha512-x+RiFRY6DWzEL6PchfdqJj8xnmsNKzryi+2xtbprsIDOQGm+g/oRJhKsTyJUjQogvkRuFSff2JJVq2C70jM1Zg==";
        };
        _XicpkuLp = {
            "id" = "XicpkuLp";
            "file" = "FoOrders-3.6.jar";
            "hash" = "sha512-9uorZ2IOfZkCthjnBu9v+PMWZaNqvRNlbG/+pb7pryZ9ZTDCX5F0y0Rqc/9TRhFBg+yJcU98uXc28OoclSRyNQ==";
        };
        _F4fGkhJw = {
            "id" = "F4fGkhJw";
            "file" = "FoOrders-3.7.jar";
            "hash" = "sha512-V9ueLtFyj/OFZnZWo9Weuil9sK75lg9PORGJWaH7ZrHunW2A+INACLrAYKPXdRJDT4f9FoXFUD3Eo+Gqb/d0dw==";
        };
        _iZesFPFf = {
            "id" = "iZesFPFf";
            "file" = "FoOrders-3.8.jar";
            "hash" = "sha512-DbNTKWDFLRaKHhKpK4+jFlH2a+5YyusbKF77/eWa/q0fSCrPlB+1jGSKokTWpWRsW1xPDwivuGKuGFAjYfZS2g==";
        };
        _C7lqv0iv = {
            "id" = "C7lqv0iv";
            "file" = "FoOrders-3.9.jar";
            "hash" = "sha512-Mk+Yx+8+hHrF8wwFAwJ2cN8Ap7vheVL4lAO7157XyPPEf3QQ2PTWlwlwHyunL4ZqUzIbJyLqJmVZs9Hf9YhAKg==";
        };
        _3M78EINL = {
            "id" = "3M78EINL";
            "file" = "FoOrders-4.1.jar";
            "hash" = "sha512-Oirv4jZPzDg1daqKMu/iAdYXvRDROL/XU5pEcMyjs+Twt5gL959HY62DA5eePkqwoaYj4F2fAnY3qWHWAxoDug==";
        };
        _gBBaePlf = {
            "id" = "gBBaePlf";
            "file" = "FoOrders-4.3.jar";
            "hash" = "sha512-0a7MOfydCTezlQGzcYM97hJ5AX5vPCtQ+AiIITxFmT/uxFc/6MvvEi9LbD1PJwZQ2na16Vu81So30W/bGtcqvw==";
        };
        _lvIbCcht = {
            "id" = "lvIbCcht";
            "file" = "FoOrders-4.4.jar";
            "hash" = "sha512-pODsr6bdhotxDrhGH/aOxgsbDCEdWrueWFMdyQ57Mt0zVdLevcBdUWtl8T+w3mkX7rUhCK0PYUoXUiu/SEAc/A==";
        };
    in {
        "T4bfbccS" = _T4bfbccS;
        "Kc0KkKGY" = _Kc0KkKGY;
        ...
        "gBBaePlf" = _gBBaePlf;
        "lvIbCcht" = _lvIbCcht;
        "paper-1.21" = _lvIbCcht;
        "paper-1.21.1" = _lvIbCcht;
        "paper-1.21.2" = _lvIbCcht;
        "paper-1.21.3" = _lvIbCcht;
        "paper-1.21.4" = _lvIbCcht;
        "paper-1.21.5" = _lvIbCcht;
        "paper-1.21.6" = _lvIbCcht;
        "paper-1.21.7" = _lvIbCcht;
        "paper-1.21.8" = _lvIbCcht;
        "paper-1.21.9" = _lvIbCcht;
        "paper-1.21.10" = _lvIbCcht;
        "paper-1.21.11" = _lvIbCcht;
        "paper-26.1" = _lvIbCcht;
        "paper-26.1.1" = _lvIbCcht;
        "paper-26.1.2" = _lvIbCcht;
        "paper-26.2" = _lvIbCcht;
        "purpur-1.21" = _lvIbCcht;
        "purpur-1.21.1" = _lvIbCcht;
        "purpur-1.21.2" = _lvIbCcht;
        "purpur-1.21.3" = _lvIbCcht;
        "purpur-1.21.4" = _lvIbCcht;
        "purpur-1.21.5" = _lvIbCcht;
        "purpur-1.21.6" = _lvIbCcht;
        "purpur-1.21.7" = _lvIbCcht;
        "purpur-1.21.8" = _lvIbCcht;
        "purpur-1.21.9" = _lvIbCcht;
        "purpur-1.21.10" = _lvIbCcht;
        "purpur-1.21.11" = _lvIbCcht;
        "purpur-26.1" = _lvIbCcht;
        "purpur-26.1.1" = _lvIbCcht;
        "purpur-26.1.2" = _lvIbCcht;
        "purpur-26.2" = _lvIbCcht;
        "spigot-1.21" = _lvIbCcht;
        "spigot-1.21.1" = _lvIbCcht;
        "spigot-1.21.2" = _lvIbCcht;
        "spigot-1.21.3" = _lvIbCcht;
        "spigot-1.21.4" = _lvIbCcht;
        "spigot-1.21.5" = _lvIbCcht;
        "spigot-1.21.6" = _lvIbCcht;
        "spigot-1.21.7" = _lvIbCcht;
        "spigot-1.21.8" = _lvIbCcht;
        "spigot-1.21.9" = _lvIbCcht;
        "spigot-1.21.10" = _lvIbCcht;
        "spigot-1.21.11" = _lvIbCcht;
        "spigot-26.1" = _lvIbCcht;
        "spigot-26.1.1" = _lvIbCcht;
        "spigot-26.1.2" = _lvIbCcht;
        "spigot-26.2" = _lvIbCcht;
        "bukkit-1.21" = _lvIbCcht;
        "bukkit-1.21.1" = _lvIbCcht;
        "bukkit-1.21.2" = _lvIbCcht;
        "bukkit-1.21.3" = _lvIbCcht;
        "bukkit-1.21.4" = _lvIbCcht;
        "bukkit-1.21.5" = _lvIbCcht;
        "bukkit-1.21.6" = _lvIbCcht;
        "bukkit-1.21.7" = _lvIbCcht;
        "bukkit-1.21.8" = _lvIbCcht;
        "bukkit-1.21.9" = _lvIbCcht;
        "bukkit-1.21.10" = _lvIbCcht;
        "bukkit-1.21.11" = _lvIbCcht;
        "bukkit-26.1" = _lvIbCcht;
        "bukkit-26.1.1" = _lvIbCcht;
        "bukkit-26.1.2" = _lvIbCcht;
        "bukkit-26.2" = _lvIbCcht;
        "pkg-1.0" = _T4bfbccS;
        "pkg-1.1" = _Kc0KkKGY;
        "pkg-1.2" = _R8sCfMTZ;
        "pkg-1.3" = _Dg5p2Uoo;
