...
let
    versions = (let
        ...
        _3TPmknBN = {
            "id" = "3TPmknBN";
            "file" = "epic-core-api-1.1.7-fix-fix.jar";
            "hash" = "sha512-p6iA6DZjZYtcHUM7ySXYxvMImE8j1842dBLi9BCgxhosYyN+dlKtonqqbm4bBOt3YpIRIpfxgtEQ9dyhLJD4CQ==";
        };
        _qHNZOyGU = {
            "id" = "qHNZOyGU";
    ...
    in {
        ...
        "pkg-1.0.4" = _XDI5NYqX;
        "pkg-1.0.5" = _HM4ThtjN;
        "pkg-1.0.5-fix" = _d8V4OeTc;
        "pkg-1.0.6" = _D4FzFqvI;
        "pkg-1.0.7" = _Q2gL3xzk;
        "pkg-1.0.7-fix" = _awcxfwlF;
        "pkg-1.0.7-fix-1" = _mMhAnxZG;
        "pkg-1.0.8" = _hQAIv20f;
        "pkg-1.0.8-fix" = _seJP6NH2;
        "pkg-1.0.9" = _XhuHtcSQ;
        "pkg-1.1.0" = _zrFC7sF6;
        "pkg-1.1.0-fix" = _1M6c7bae;
        "pkg-1.1.1" = _VMseCVRH;
        "pkg-1.1.1-fix" = _kkD6AvwS;
        "pkg-1.1.2" = _7MjbPH9a;
        "pkg-1.1.2-fix" = _5BRTeeFZ;
        "pkg-1.1.2-fix-dev" = _wWY67H8I;
        "pkg-1.1.3" = _H5HEXHmO;
        "pkg-1.1.3-fix" = _fWK8zrcC;
        "pkg-1.1.4" = _f9NI3ob9;
        "pkg-1.1.4-fix" = _YOoLlX34;
        "pkg-1.1.4-fix-fix" = _Orv4T3bC;
        "pkg-1.1.5-beta" = _eeOyMrXl;
        "pkg-1.1.5" = _ZeahG56E;
        "pkg-1.1.5-fix" = _X04Bj2l1;
        "pkg-1.1.5-fix-fix" = _qRSx7dLE;
        "pkg-1.1.6" = _ojGnKL4H;
        "pkg-1.1.6-fix" = _i4OUGMcj;
        "pkg-1.1.6-fix-fix" = _XiR93p3x;
        "pkg-1.1.7" = _HOMQJaKu;
