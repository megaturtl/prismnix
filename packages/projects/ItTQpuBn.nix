...
let
    ...
    in {
        ...
        "pkg-1.1.6" = _x8oWEzfc;
        "pkg-1.1.7" = _CW4uKgsN;
        "pkg-1.2.0-beta1" = _IASu3Idv;
        "pkg-1.2.0-beta2" = _l18ymFPh;
        "pkg-1.2.0-beta3" = _MIiASf3B;
        "pkg-1.2.0-beta4" = _H2XK8x3b;
        "pkg-1.2.0-beta5" = _WkPU3A8K;
        "pkg-1.2.0" = _gNCSgari;
        "pkg-1.2.1" = _yeKISf8w;
        "pkg-1.2.2" = _ebJJfIwy;
        "pkg-1.2.3" = _8YwG0app;
        ...
        "pkg-1.3.8" = _PEAeQvt5;
        "pkg-1.3.9" = _Q1lbsJ2W;
        "pkg-1.3.10" = _lz0Bo8SN;
        "pkg-1.3.11" = _icrtTMxy;
        "pkg-1.3.12" = _wuook8Qi;
        "pkg-1.3.13" = _6fNaXLXV;
        "pkg-1.3.14" = _Uk6F6YYH;
        "pkg-1.3.15" = _PuH4aP29;
        "pkg-1.3.16" = _3VfIWnHV;
        "pkg-1.3.17" = _NOexLJca;
        "pkg-1.3.18" = _m6YhttS0;
        "pkg-1.3.19" = _VlJCRYbw;
        "pkg-1.4.0" = _KZ9zaC1T;
        "pkg-1.4.1" = _J03EhGp2;
        "pkg-1.4.2" = _FCO2Pd2F;
        "pkg-1.4.3" = _lGeJzVYA;
        "pkg-1.4.4" = _P2DqCY88;
        "pkg-1.3.20" = _crvvPhxt;
        "pkg-1.4.5" = _tu78wVrG;
        "pkg-1.4.6" = _ToYruJXI;
        "pkg-1.4.7" = _oaQhjOTf;
        "pkg-1.4.8" = _9pNw54ZO;
        "pkg-1.4.9" = _EgGvNR7Q;
        "pkg-1.4.10" = _bfHSVpoL;
        "pkg-1.4.11" = _YLYGw8iW;
        "pkg-1.4.12" = _vRCXhXCE;
        "pkg-1.4.13" = _CGsKXaJV;
        "pkg-1.4.14" = _w1u5Vnjz;
        "pkg-1.4.15" = _Ll5CYnaz;
        "pkg-1.4.16" = _4SvdOtlR;
        "pkg-1.4.17" = _hTidMos9;
        "pkg-1.4.18" = _e3ZMPIN3;
        "pkg-1.4.19" = _i6XWZrac;
        "pkg-1.4.20" = _xNYJSdZF;
        "pkg-1.4.21" = _QUrQpg3i;
        "pkg-1.4.22" = _NwYPqauj;
        "pkg-1.3.21" = _axRzsf8R;
