...
let
    versions = (let
        ...
        _lwjZBYEm = {
            "id" = "lwjZBYEm";
            "file" = "asynclogger-2.2.2+1.8.9-ornithe.jar";
            "hash" = "sha512-LuQYNBVjQhKNGfYHCqDYUTue8kDwj2UgcOUCRTe7kNxhwZYmaxxm+IVnt7dJMDPqzFKBo3l7SVYhgXrapjwZ4Q==";
        };
        _7KLY8ACp = {
            "id" = "7KLY8ACp";
            "file" = "asynclogger-2.2.2+1.12.2-forge.jar";
            "hash" = "sha512-WIktO5omvr0AC6VMynbzmDM0u6VyGvWxs+3LpoxBawkB+IBftzcpL5YRq7neB8dNdMuHiilDqI82Gl8VTpRX8g==";
        };
        _pBxt8OQx = {
            "id" = "pBxt8OQx";
            "file" = "asynclogger-2.2.2+1.16.5-fabric.jar";
            "hash" = "sha512-aVqnWsUlpmYwzpDL0NSpGXaorNY46nX71qKkgv/xC9160KAtYVGbBKeJO+CKDht0uS3HMLv1bG/iYgVQNAkn9w==";
        };
        _Nbz4aZuf = {
            "id" = "Nbz4aZuf";
            "file" = "asynclogger-2.2.2+1.16.5-forge.jar";
            "hash" = "sha512-xpFSgHBEWEuosuhsm5vQOUnxDc/5QNy2iJUJZtvUW5wc3ufUAup1pshcQsfQY/X4rmgq4FlG8UIq47Yh3TZMQg==";
        };
        _rmwT67eb = {
            "id" = "rmwT67eb";
            "file" = "asynclogger-2.2.2+1.18.2-forge.jar";
            "hash" = "sha512-6tKZ7uiA2ZeDOSt0Hd5Nq7MKex3mfLN+yPpQPtpFBSQ4j2lGWOtYg9Usu4dJn9fmTYZm7w2kaCTGTy7Qc8KtXQ==";
        };
        _rqNKbA1G = {
            "id" = "rqNKbA1G";
            "file" = "asynclogger-2.2.2+1.19.2-forge.jar";
            "hash" = "sha512-UG4+Od2SAmf1w801XGBVDRErPjtcP7iz8bC09dGFYQdMUMp1fb9s2ZSctHBgx0tSB66ZxuxtpN8yHcI3jwzRyQ==";
        };
        _EdZUwK8s = {
            "id" = "EdZUwK8s";
            "file" = "asynclogger-2.2.2+1.20.1-fabric.jar";
            "hash" = "sha512-S2Rt6AvKtKRmL9XpiwuiveZUjShZzeZIrOLqjeEjqbAO8v5L2/rGH5o9xSDPflIvIPlV/kyyoeCiBj8r4yipOw==";
        };
        _v8ouTH1m = {
            "id" = "v8ouTH1m";
            "file" = "asynclogger-2.2.2+1.20.1-forge.jar";
            "hash" = "sha512-S64mJXUj09oIseyFz5lyyUcTg5mFr4mvj3raBRjyaKjvlb5++MIvaoWBRLd5TefTQ2CS3twMeq0CCbO103reOA==";
        };
        _yj7KaIVy = {
            "id" = "yj7KaIVy";
            "file" = "asynclogger-2.2.2+1.21.1-neoforge.jar";
            "hash" = "sha512-9tXBReq9V9DnyjDzd6yz/Re166ZyFZk+I8IhmQ/ok1s9mmSZzrAlBf0La8s0G6ASwzIdeE33pcQBCERH6bbuNA==";
        };
        _jVrQSTSp = {
            "id" = "jVrQSTSp";
            "file" = "asynclogger-2.2.2+1.21.11-fabric.jar";
            "hash" = "sha512-iN+Sbla0OutltV26xoU93l8hbTSJNVs3vfR2O3wDl95yuNMBYHdqnvLo2ztCT1x3NuYJ13q5YIhvs916KNqbyw==";
        };
        _N6vmiJQu = {
            "id" = "N6vmiJQu";
            "file" = "asynclogger-2.2.2+1.21.11-neoforge.jar";
            "hash" = "sha512-Z1+By5UViiEm6zt9NeW5PPIi1k6f4jeNroNSBSD9wMIyztgC693NKqGS9m9AqfRWWTTqM6LecugZUDuoXTin3Q==";
        };
        _Ert0LmWj = {
            "id" = "Ert0LmWj";
            "file" = "asynclogger-2.2.2+26.1.2-fabric.jar";
            "hash" = "sha512-J3WmZ7E63i4llqXeBmKr70HIN8XLMxUrMFvrWerL/mcfL8CFP1D4bBYtlv94t/n1nPS6ZU5qnTaFttc3CbBSUw==";
        };
        _YQf9QhZi = {
            "id" = "YQf9QhZi";
            "file" = "asynclogger-2.2.2+26.1.2-neoforge.jar";
            "hash" = "sha512-PF3phkCdOEj4FIs9Y4pS5gVL8QstdA1Zy4WNSBIFDaLiMiT+R+HnbzLkZSzQShBucfdWsuJ4HiToQ9aK32NiZg==";
        };
    in {
        "9RkPridF" = _9RkPridF;
        "7LyJjt08" = _7LyJjt08;
        ...
        "Ert0LmWj" = _Ert0LmWj;
        "YQf9QhZi" = _YQf9QhZi;
        "fabric-1.20.1" = _EdZUwK8s;
        "fabric-1.20.2" = _EdZUwK8s;
        "fabric-1.20.3" = _EdZUwK8s;
        "fabric-1.20.4" = _EdZUwK8s;
        "fabric-1.20.5" = _EdZUwK8s;
        "fabric-1.20.6" = _EdZUwK8s;
        "fabric-1.21" = _EdZUwK8s;
        "fabric-1.21.1" = _EdZUwK8s;
        "fabric-1.21.8" = _jVrQSTSp;
        "fabric-1.21.9" = _jVrQSTSp;
        "fabric-1.21.10" = _jVrQSTSp;
        "fabric-1.21.11" = _jVrQSTSp;
        "fabric-26.1" = _Ert0LmWj;
        "fabric-26.1.1" = _Ert0LmWj;
        "fabric-1.21.2" = _EdZUwK8s;
        "fabric-1.21.3" = _EdZUwK8s;
        "fabric-1.21.4" = _EdZUwK8s;
        "fabric-26.1.2" = _Ert0LmWj;
        "fabric-1.18" = _S4KqDN9R;
        "fabric-1.18.1" = _S4KqDN9R;
        "fabric-1.18.2" = _EdZUwK8s;
        "fabric-1.19" = _EdZUwK8s;
        "fabric-1.19.1" = _EdZUwK8s;
        "fabric-1.19.2" = _EdZUwK8s;
        "fabric-1.19.3" = _EdZUwK8s;
        "fabric-1.19.4" = _EdZUwK8s;
        "fabric-1.20" = _EdZUwK8s;
        "fabric-26.2" = _Ert0LmWj;
        "fabric-1.16.5" = _pBxt8OQx;
        ...
        "forge-1.20.1" = _v8ouTH1m;
        "forge-1.18.2" = _rmwT67eb;
        "forge-1.19.2" = _rqNKbA1G;
        "forge-1.12.2" = _7KLY8ACp;
        "forge-1.16.5" = _Nbz4aZuf;
        "neoforge-1.21" = _yj7KaIVy;
        "neoforge-1.21.1" = _yj7KaIVy;
        "neoforge-1.21.2" = _yj7KaIVy;
        "neoforge-1.21.3" = _yj7KaIVy;
        "neoforge-1.21.4" = _yj7KaIVy;
        "neoforge-1.21.5" = _yj7KaIVy;
        "neoforge-1.21.6" = _yj7KaIVy;
        "neoforge-1.21.7" = _yj7KaIVy;
        "neoforge-1.21.8" = _yj7KaIVy;
        "neoforge-1.21.10" = _N6vmiJQu;
        "neoforge-1.21.11" = _N6vmiJQu;
        "neoforge-26.1" = _YQf9QhZi;
        "neoforge-26.1.1" = _YQf9QhZi;
        "neoforge-26.1.2" = _YQf9QhZi;
        "neoforge-26.2" = _YQf9QhZi;
        "ornithe-1.0" = _lwjZBYEm;
        "ornithe-1.1" = _lwjZBYEm;
        "ornithe-1.2.1" = _lwjZBYEm;
        "ornithe-1.2.2" = _lwjZBYEm;
        "ornithe-1.2.3" = _lwjZBYEm;
        "ornithe-1.2.4" = _lwjZBYEm;
        "ornithe-1.2.5" = _lwjZBYEm;
        "ornithe-1.3.1" = _lwjZBYEm;
        "ornithe-1.3.2" = _lwjZBYEm;
        "ornithe-1.4.2" = _lwjZBYEm;
        "ornithe-1.4.4" = _lwjZBYEm;
        "ornithe-1.4.5" = _lwjZBYEm;
        "ornithe-1.4.6" = _lwjZBYEm;
        "ornithe-1.4.7" = _lwjZBYEm;
        "ornithe-1.5.1" = _lwjZBYEm;
        "ornithe-1.5.2" = _lwjZBYEm;
        "ornithe-1.6.1" = _lwjZBYEm;
        "ornithe-1.6.2" = _lwjZBYEm;
        "ornithe-1.6.4" = _lwjZBYEm;
        "ornithe-1.7.2" = _lwjZBYEm;
        "ornithe-1.7.3" = _lwjZBYEm;
        "ornithe-1.7.4" = _lwjZBYEm;
        "ornithe-1.7.5" = _lwjZBYEm;
        "ornithe-1.7.6" = _lwjZBYEm;
        "ornithe-1.7.7" = _lwjZBYEm;
        "ornithe-1.7.8" = _lwjZBYEm;
        "ornithe-1.7.9" = _lwjZBYEm;
        "ornithe-1.7.10" = _lwjZBYEm;
        "ornithe-1.8" = _lwjZBYEm;
        "ornithe-1.8.1" = _lwjZBYEm;
        "ornithe-1.8.2" = _lwjZBYEm;
        "ornithe-1.8.3" = _lwjZBYEm;
        "ornithe-1.8.4" = _lwjZBYEm;
        "ornithe-1.8.5" = _lwjZBYEm;
        "ornithe-1.8.6" = _lwjZBYEm;
        "ornithe-1.8.7" = _lwjZBYEm;
        "ornithe-1.8.8" = _lwjZBYEm;
        "ornithe-1.8.9" = _lwjZBYEm;
        "ornithe-1.9" = _lwjZBYEm;
        "ornithe-1.9.1" = _lwjZBYEm;
        "ornithe-1.9.2" = _lwjZBYEm;
        "ornithe-1.9.3" = _lwjZBYEm;
        "ornithe-1.9.4" = _lwjZBYEm;
        "ornithe-1.10" = _lwjZBYEm;
        "ornithe-1.10.1" = _lwjZBYEm;
        "ornithe-1.10.2" = _lwjZBYEm;
        "ornithe-1.11" = _lwjZBYEm;
        "ornithe-1.11.1" = _lwjZBYEm;
        "ornithe-1.11.2" = _lwjZBYEm;
        "ornithe-1.12" = _lwjZBYEm;
        "ornithe-1.12.1" = _lwjZBYEm;
        "ornithe-1.12.2" = _lwjZBYEm;
        "ornithe-1.13" = _lwjZBYEm;
        "ornithe-1.13.1" = _lwjZBYEm;
        "ornithe-1.13.2" = _lwjZBYEm;
        "ornithe-1.14" = _lwjZBYEm;
        "ornithe-1.14.1" = _lwjZBYEm;
        "ornithe-1.14.2" = _lwjZBYEm;
        "ornithe-1.14.3" = _lwjZBYEm;
        "ornithe-1.14.4" = _lwjZBYEm;
        "pkg-1.0.0+1.20.1-fabric" = _9RkPridF;
        "pkg-1.0.0+1.20.1-forge" = _7LyJjt08;
        "pkg-1.0.0+1.21.1-neoforge" = _UVRf7DyA;
        "pkg-1.0.0+1.21.11-fabric" = _cGotwPHn;
        "pkg-1.0.0+1.21.11-neoforge" = _TuAtA8Tz;
        "pkg-1.1.0+1.20.1-fabric" = _x7QC1itK;
        "pkg-1.1.0+1.20.1-forge" = _zdE6t5k2;
        "pkg-1.1.0+1.21.1-neoforge" = _bwyh974H;
        "pkg-1.1.0+1.21.11-fabric" = _dKbrD64w;
        "pkg-1.1.0+1.21.11-neoforge" = _Q2Uru74O;
        "pkg-1.1.0+26.1.1-fabric" = _iSnpqnSe;
        "pkg-1.1.0+26.1.1-neoforge" = _73vcW8q9;
        "pkg-1.1.1+1.20.1-fabric" = _Z9aWtbiy;
        "pkg-1.1.1+1.20.1-forge" = _2FuFVTWy;
        "pkg-1.1.1+1.21.1-neoforge" = _V2oaiA1M;
        "pkg-1.1.1+1.21.11-fabric" = _5RyR2YxJ;
        "pkg-1.1.1+1.21.11-neoforge" = _yBMCMiPw;
        "pkg-1.1.1+26.1.1-fabric" = _kGL85qce;
        "pkg-1.1.1+26.1.1-neoforge" = _r7xZNhhu;
        "pkg-1.1.2+1.20.1-fabric" = _lupGjisQ;
        "pkg-1.1.2+1.20.1-forge" = _ZclwHN4o;
        "pkg-1.1.2+1.21.1-neoforge" = _m1MBLSsh;
        "pkg-1.1.2+1.21.11-fabric" = _ycLDFxU2;
        "pkg-1.1.2+1.21.11-neoforge" = _Ww6kH1RN;
        "pkg-1.1.2+26.1.1-fabric" = _BM6E35Y6;
        "pkg-1.1.2+26.1.1-neoforge" = _ZUFAfRGc;
        "pkg-1.1.3+1.18.2-forge" = _f31vesI8;
        "pkg-1.1.3+1.19.2-forge" = _6qlydRbC;
        "pkg-1.1.3+1.20.1-fabric" = _nDDGSosP;
        "pkg-1.1.3+1.20.1-forge" = _fnHtIyC2;
        "pkg-1.1.3+1.21.1-neoforge" = _Gfrq3OVF;
        "pkg-1.1.3+1.21.11-fabric" = _EVdiTcv0;
        "pkg-1.1.3+1.21.11-neoforge" = _EsFumDqG;
        "pkg-1.1.3+26.1.1-fabric" = _WcK3DSQm;
        "pkg-1.1.3+26.1.1-neoforge" = _Iv3gGFuI;
        "pkg-1.1.4+1.18.2-forge" = _5aNIeF0N;
        "pkg-1.1.4+1.19.2-forge" = _tO8E8Zjm;
        "pkg-1.1.4+1.20.1-fabric" = _S4KqDN9R;
        "pkg-1.1.4+1.20.1-forge" = _oE1R9bvo;
        "pkg-1.1.4+1.21.1-neoforge" = _TtdaR17N;
        "pkg-1.1.4+1.21.11-fabric" = _gOjnKRwE;
        "pkg-1.1.4+1.21.11-neoforge" = _6XC7F8tA;
        "pkg-1.1.4+26.1.1-fabric" = _THjg0VgO;
        "pkg-1.1.4+26.1.1-neoforge" = _yg0XVOHR;
        "pkg-2.0.0+1.18.2-forge" = _ZtYdaVYm;
        "pkg-2.0.0+1.19.2-forge" = _DjRiCEoD;
        "pkg-2.0.0+1.20.1-fabric" = _86H37Kk1;
        "pkg-2.0.0+1.20.1-forge" = _3y3ccMbN;
        "pkg-2.0.0+1.21.1-neoforge" = _WXVZ8ygo;
        "pkg-2.0.0+1.21.11-fabric" = _elyyTyS0;
        "pkg-2.0.0+1.21.11-neoforge" = _8hNNSKSO;
        "pkg-2.0.0+26.1.2-fabric" = _DVKXJXfL;
        "pkg-2.0.0+26.1.2-neoforge" = _p9BfGONL;
        "pkg-2.0.1+1.18.2-forge" = _yJhvTj9d;
        "pkg-2.0.1+1.19.2-forge" = _5w9pnmnZ;
        "pkg-2.0.1+1.20.1-fabric" = _HfuHCFsT;
        "pkg-2.0.1+1.20.1-forge" = _R3kulL1W;
        "pkg-2.0.1+1.21.1-neoforge" = _sSPB1E2D;
        "pkg-2.0.1+1.21.11-fabric" = _rgmJdFj8;
        "pkg-2.0.1+1.21.11-neoforge" = _X6dX2c8V;
        "pkg-2.0.1+26.1.2-fabric" = _HTJRvzlX;
        "pkg-2.0.1+26.1.2-neoforge" = _rAEYU0Jd;
        "pkg-2.1.0+1.18.2-forge" = _rKNI2atC;
        "pkg-2.1.0+1.19.2-forge" = _vKTPXHuN;
        "pkg-2.1.0+1.20.1-fabric" = _lQkK02p4;
        "pkg-2.1.0+1.20.1-forge" = _FPi08YAP;
        "pkg-2.1.0+1.21.1-neoforge" = _oKVmaJAY;
        "pkg-2.1.0+1.21.11-fabric" = _YzpPHq0u;
        "pkg-2.1.0+1.21.11-neoforge" = _NCsftul8;
        "pkg-2.1.0+26.1.2-fabric" = _Nesh2zZw;
        "pkg-2.1.0+26.1.2-neoforge" = _RYGUyTOg;
        "pkg-2.1.1+1.18.2-forge" = _stcH7Qud;
        "pkg-2.1.1+1.19.2-forge" = _iDEwpABG;
        "pkg-2.1.1+1.20.1-fabric" = _UNdRt7zC;
        "pkg-2.1.1+1.20.1-forge" = _xjNhokJl;
        "pkg-2.1.1+1.21.1-neoforge" = _jTWBuKYG;
        "pkg-2.1.1+1.21.11-fabric" = _RuhVVzw1;
        "pkg-2.1.1+1.21.11-neoforge" = _pOslyloc;
        "pkg-2.1.1+26.1.2-fabric" = _2x8WhwAw;
        "pkg-2.1.1+26.1.2-neoforge" = _4VvjcdU7;
        "pkg-2.1.2+1.18.2-forge" = _ci8Po27J;
        "pkg-2.1.2+1.19.2-forge" = _rF7hW1uL;
        "pkg-2.1.2+1.20.1-fabric" = _hqt7sePV;
        "pkg-2.1.2+1.20.1-forge" = _ycgePK03;
        "pkg-2.1.2+1.21.1-neoforge" = _z1G2eJLX;
        "pkg-2.1.2+1.21.11-fabric" = _mLWTXnnM;
        "pkg-2.1.2+1.21.11-neoforge" = _CalXCwQm;
        "pkg-2.1.2+26.1.2-fabric" = _MCoxIcu9;
        "pkg-2.1.2+26.1.2-neoforge" = _EfxLBuAn;
        "pkg-2.2.0+1.12.2-forge" = _VUbbq4rG;
        "pkg-2.2.0+1.16.5-fabric" = _gAYNgDWb;
        "pkg-2.2.0+1.16.5-forge" = _k7eH2mPn;
        "pkg-2.2.0+1.18.2-forge" = _rXgTY4lr;
        "pkg-2.2.0+1.19.2-forge" = _kfsxk9BU;
        "pkg-2.2.0+1.20.1-fabric" = _XB2TjlGd;
        "pkg-2.2.0+1.20.1-forge" = _el0ODrI9;
        "pkg-2.2.0+1.21.1-neoforge" = _37KTxuGm;
        "pkg-2.2.0+1.21.11-fabric" = _LWjBiYWq;
        "pkg-2.2.0+1.21.11-neoforge" = _IJt7CzRK;
        "pkg-2.2.0+26.1.2-fabric" = _iXKHoD6e;
        "pkg-2.2.0+26.1.2-neoforge" = _JV4ggTWa;
        "pkg-2.2.1+1.12.2-forge" = _si86UM9h;
        "pkg-2.2.1+1.16.5-fabric" = _CrQc9DMN;
        "pkg-2.2.1+1.16.5-forge" = _tOUM9dOM;
        "pkg-2.2.1+1.18.2-forge" = _aK0lM1Ju;
        "pkg-2.2.1+1.19.2-forge" = _oxjzZ6IP;
        "pkg-2.2.1+1.20.1-fabric" = _2HCbK9wC;
        "pkg-2.2.1+1.20.1-forge" = _mT2heOVM;
        "pkg-2.2.1+1.21.1-neoforge" = _i5z8ZG27;
        "pkg-2.2.1+1.21.11-fabric" = _KgE1azbw;
        "pkg-2.2.1+1.21.11-neoforge" = _eJzJQs07;
        "pkg-2.2.1+26.1.2-fabric" = _MiNRI6LE;
        "pkg-2.2.1+26.1.2-neoforge" = _K6gY0ySV;
        "pkg-2.2.2+1.8.9-ornithe" = _lwjZBYEm;
        "pkg-2.2.2+1.12.2-forge" = _7KLY8ACp;
        "pkg-2.2.2+1.16.5-fabric" = _pBxt8OQx;
        "pkg-2.2.2+1.16.5-forge" = _Nbz4aZuf;
        "pkg-2.2.2+1.18.2-forge" = _rmwT67eb;
        "pkg-2.2.2+1.19.2-forge" = _rqNKbA1G;
        "pkg-2.2.2+1.20.1-fabric" = _EdZUwK8s;
        "pkg-2.2.2+1.20.1-forge" = _v8ouTH1m;
        "pkg-2.2.2+1.21.1-neoforge" = _yj7KaIVy;
        "pkg-2.2.2+1.21.11-fabric" = _jVrQSTSp;
        "pkg-2.2.2+1.21.11-neoforge" = _N6vmiJQu;
        "pkg-2.2.2+26.1.2-fabric" = _Ert0LmWj;
        "pkg-2.2.2+26.1.2-neoforge" = _YQf9QhZi;
        "default" = _YQf9QhZi;
    });
