...
let
    ...
    in {
        ...
        "pkg-2.5.8" = _StShykZR;
        "pkg-2.5.9" = _rEHNKSsj;
        "pkg-2.5.11" = _kdpJGb4i;
        "pkg-2.5.12" = _pil5pAHh;
        "pkg-2.5.13" = _LyjQgjzZ;
        "pkg-2.5.14" = _NFjtgZcW;
        "pkg-2.5.15" = _m7VFN54t;
        "pkg-2.5.16" = _W7bdj97q;
        "pkg-2.5.17" = _gpNeGcC1;
        "pkg-2.5.18" = _tHhmeG9s;
