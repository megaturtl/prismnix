...
let
    versions = (let
        ...
        _XIMsxT1i = {
            "id" = "XIMsxT1i";
            "file" = "Sparkweave-Fabric-0.600.0-alpha.13.jar";
            "hash" = "sha512-RvWlfNdm1Nit4fl7JdsvaJizHMdHPyyqrqeoWUAh5pcfnK6JP5StO93+6okNSSf9SEMCHENuKS+kfHyau4hyXA==";
        };
        _YtsVAwkv = {
            "id" = "YtsVAwkv";
            "file" = "Sparkweave-NeoForge-0.600.0-alpha.13.jar";
            "hash" = "sha512-KAoFtY21N5pXeTo7An2qmXW3l0zjm+A1203ihlqnT+Xw/HpXh+DevXXyqwyR5gwHAAzBwldI6lwApyvIm5bm3w==";
        };
        _kY06YhDI = {
            "id" = "kY06YhDI";
            "file" = "Sparkweave-NeoForge-0.600.0-alpha.14.jar";
            "hash" = "sha512-+LjjwlatfQd9OzOUkr/HpiQprveV+uxFl5ePFRagYE40Zlt9GQZhl0IZ/BKFz5AOKV6E+cciokx85JyOZA2qAQ==";
        };
        _zT58tRRz = {
            "id" = "zT58tRRz";
            "file" = "Sparkweave-Fabric-0.600.0-alpha.14.jar";
            "hash" = "sha512-znvWYMZKuoWIr8WotoXJJS/Wo/sfPHlwtajga6YH/9/ZQKsW25koEvHbu5nDnVjhCdbOTwNWnRu/EimvzL48GQ==";
        };
        _QclPNrnR = {
            "id" = "QclPNrnR";
            "file" = "Sparkweave-Fabric-0.600.0-alpha.15.jar";
            "hash" = "sha512-d3Kb+s2XUZAdmfR3bCWuyPc3Dvw0oNuRVpgid9qmuOAo5IwSXE1j/jHfhUMxSXT8+U0iWGAywB+EDeuKwXSVmw==";
        };
        _hTinXQAT = {
            "id" = "hTinXQAT";
            "file" = "Sparkweave-NeoForge-0.600.0-alpha.15.jar";
            "hash" = "sha512-LkM1hEclsatsClcUv74y6f0vteBkUtw/D99i2eXvXxct0QDqumCPzXUbJslsJ5T9zk1qvy1+FcMpBB6jMFXnlQ==";
        };
        _6ptl5gAZ = {
            "id" = "6ptl5gAZ";
            "file" = "Sparkweave-NeoForge-0.600.0-alpha.16.jar";
            "hash" = "sha512-NuzkefmKgegUJ0sGgNem2b8lTI8ltkEY6Q4WGzzgn5D43Z8WaTHiY0d7X0bpQXuEu8N/bDB3diGSnUNk1PQqlw==";
        };
        _sMqEiUEN = {
            "id" = "sMqEiUEN";
            "file" = "Sparkweave-Fabric-0.600.0-alpha.16.jar";
            "hash" = "sha512-6feD23l5VnxhGimwMbeRw0dIbH2vsphaZJ5Sv/6ZA5Aa4bSKZ5gQggD/k2goRAgYa2XGY1reJ4ro/MnLwRC+0g==";
        };
        _BiMWRCEq = {
            "id" = "BiMWRCEq";
            "file" = "Sparkweave-NeoForge-0.600.0-alpha.17.jar";
            "hash" = "sha512-ZqAwDk1zl/pVyyefcWn216LN1PU3tQlArQ+CS8oZCHMEujlrJnCOseSSIZ8TnOCjOk0Sh4EeFK63qh/El+CCUA==";
        };
        _Pyc49cEq = {
            "id" = "Pyc49cEq";
            "file" = "Sparkweave-Fabric-0.600.0-alpha.17.jar";
            "hash" = "sha512-EVTFKBlQW8SzzOKzNeic7MVw+rncU3kqEsSVii8QKLZ5UQ2RqM7P2Q/3rjHBm4nLtv3x1v/VefvwGVaKAilAEA==";
        };
        _zM95Ai4O = {
            "id" = "zM95Ai4O";
            "file" = "Sparkweave-Fabric-0.600.0-alpha.18.jar";
            "hash" = "sha512-95eML+wgDzp4ZLMpGyDkH6V3Pw2oyHcdwJbpwDhzto3O1VJMx0ZwTQozLXSH53n6nRyn4utLwHqKgJFL2kpt0Q==";
        };
        _YwJGMZTM = {
            "id" = "YwJGMZTM";
            "file" = "Sparkweave-NeoForge-0.600.0-alpha.18.jar";
            "hash" = "sha512-28C5M/XBNGlc2Jz7K2okeyXk2glaBb+Af1q1HtLXqWRCN2GB+C1k5RX9n1OeYFS8VrQVtnq/zt4/q5dHO2ZgzA==";
        };
    in {
        "wuBGLCqT" = _wuBGLCqT;
        "qLLV6vj3" = _qLLV6vj3;
        ...
        "pkg-0.4.0" = _B7D5vBS4;
        "pkg-0.4.1" = _8h8EkEa6;
        "pkg-0.100.0-beta.1+NeoForge" = _OVZTGSoH;
        "pkg-0.100.0-beta.1+Quilt" = _ylF8Dt2P;
        "pkg-0.100.0-beta.2+NeoForge" = _6NIyUa0n;
        "pkg-0.100.0-beta.2+Quilt" = _yKE1bRL8;
        "pkg-0.100.0-beta.3+NeoForge" = _iNo6Ifek;
        "pkg-0.100.0-beta.3+Quilt" = _BdFy1HuS;
        "pkg-0.100.0+NeoForge" = _zIhC9mfP;
        "pkg-0.100.0+Quilt" = _LPIOkAl3;
        "pkg-0.101.0+NeoForge" = _W9RvD4FM;
        "pkg-0.101.0+Quilt" = _hxEdv0O3;
        "pkg-0.102.0+NeoForge" = _U4jXj55V;
        "pkg-0.102.0+Quilt" = _SAdu9tDE;
        "pkg-0.102.1+NeoForge" = _OF1Y6pq3;
        "pkg-0.102.1+Quilt" = _PgirDAJe;
        "pkg-0.102.2+NeoForge" = _1wz5Vo6r;
        "pkg-0.102.2+Quilt" = _dIETKkU7;
        "pkg-0.103.0+NeoForge" = _ljDV5hGI;
        "pkg-0.103.0+Quilt" = _gFI49Evn;
        "pkg-0.104.0+NeoForge" = _owqqE6yz;
        "pkg-0.104.0+Quilt" = _Z7MWid7P;
        "pkg-0.105.0+NeoForge" = _kGvJvs1I;
        "pkg-0.105.0+Quilt" = _fwls5QiZ;
        "pkg-0.105.1+NeoForge" = _S16y2j2I;
        "pkg-0.105.1+Quilt" = _ICVcVnTm;
        "pkg-0.200.0+NeoForge" = _iD94hYxj;
        "pkg-0.200.0+Quilt" = _QTtRnize;
        "pkg-0.201.0+NeoForge" = _fPC01c2v;
        "pkg-0.201.0+Quilt" = _E28utIrD;
        "pkg-0.202.0+NeoForge" = _RMvCg5DB;
        "pkg-0.202.0+Quilt" = _8myVjNw9;
        "pkg-0.203.0+NeoForge" = _2BUcdbnY;
        "pkg-0.203.0+Quilt" = _KKp0J630;
        "pkg-0.204.0+Fabric" = _cOZAqKu7;
        "pkg-0.204.0+NeoForge" = _FLcfNfnd;
        "pkg-0.204.0+Quilt" = _vuaiG6hK;
        "pkg-0.300.0-beta.1+Fabric" = _F99Bdka6;
        "pkg-0.300.0-beta.2+Fabric" = _kvENgsRV;
        "pkg-0.300.0-beta.2+NeoForge" = _yUKMWeHQ;
        "pkg-0.400.0-alpha.6+Fabric" = _FBdrZaQF;
        "pkg-0.500.0-alpha.2+Fabric" = _pTtCdS1h;
        "pkg-0.500.0-alpha.2+NeoForge" = _3GOp7bQx;
        "pkg-0.500.0-alpha.2+Quilt" = _fhOv6Q6E;
        "pkg-0.501.0-alpha.1+Fabric" = _EL3PK3KN;
        "pkg-0.501.0-alpha.1+NeoForge" = _7kpSe5Wu;
        "pkg-0.501.0-alpha.1+Quilt" = _sCuOblN6;
        "pkg-0.501.0-alpha.2+Fabric" = _339lW2YB;
        "pkg-0.501.0-alpha.2+NeoForge" = _MtoRLhnC;
        "pkg-0.501.0-alpha.2+Quilt" = _NjrbmwbP;
        "pkg-0.501.0-alpha.3+Fabric" = _aD08cJ56;
        "pkg-0.501.0-alpha.3+NeoForge" = _ggAVVU8L;
        "pkg-0.501.0-alpha.3+Quilt" = _WnPuVdXU;
        "pkg-0.502.0-alpha.1+Fabric" = _I8atNmcr;
        "pkg-0.502.0-alpha.1+NeoForge" = _Q01NfjBA;
        "pkg-0.502.0-alpha.1+Quilt" = _oBBpbXas;
        "pkg-0.502.0+Fabric" = _3kPFx3As;
        "pkg-0.502.0+NeoForge" = _dh9SViqN;
        "pkg-0.502.0+Quilt" = _8KU1N2Qh;
        "pkg-0.503.0+Fabric" = _MycRWo4x;
        "pkg-0.503.0+NeoForge" = _yQ9dddXq;
        "pkg-0.503.0+Quilt" = _KQWkieef;
        "pkg-0.503.1+Fabric" = _5beQXBn3;
        "pkg-0.503.1+NeoForge" = _x0sr3js5;
        "pkg-0.503.1+Quilt" = _KAQ54rqv;
        "pkg-0.600.0-alpha.1+Fabric" = _FZWqlkEY;
        "pkg-0.600.0-alpha.1+NeoForge" = _s14nI6rQ;
        "pkg-0.504.0+Fabric" = _NMCBrsKO;
        "pkg-0.504.0+NeoForge" = _RmUThYFb;
        "pkg-0.505.0+Fabric" = _3yKVuqvL;
        "pkg-0.505.0+NeoForge" = _aJ2M9Mvw;
        "pkg-0.506.0+Fabric" = _N84CC0wq;
        "pkg-0.506.0+NeoForge" = _gXRxJLIq;
        "pkg-0.507.0+Fabric" = _a36OLOVD;
        "pkg-0.507.0+NeoForge" = _GnWeIDgu;
        "pkg-0.5.0+Fabric" = _xfYxoDPF;
        "pkg-0.6.0+Fabric" = _DQwpRTWp;
        "pkg-0.7.0+Fabric" = _WQ4aILHw;
        "pkg-0.8.0+Fabric" = _MrVwvF8H;
        "pkg-0.8.1+Fabric" = _bKsqoQ8z;
        "pkg-0.8.2+Fabric" = _aXorq9s0;
        "pkg-0.8.3+Fabric" = _7eMj9IL4;
        "pkg-0.8.4+Fabric" = _huLT1fWM;
        "pkg-0.8.5+Fabric" = _c6Tsm75O;
        "pkg-0.8.6+Fabric" = _bklFvK3R;
        "pkg-0.8.7+Fabric" = _NtXixDVt;
        "pkg-0.8.8+Fabric" = _JKx2dI3P;
        "pkg-0.507.1+Fabric" = _l9OXA4TC;
        "pkg-0.507.1+NeoForge" = _oW9ijMg7;
        "pkg-0.508.0+Fabric" = _hvyOd9Oq;
        "pkg-0.508.0" = _sZqK0P2T;
        "pkg-0.508.1+Fabric" = _fLeNlqyF;
        "pkg-0.508.1+NeoForge" = _onNXYwO1;
        "pkg-0.508.2+Fabric" = _rwx6I9Q5;
        "pkg-0.508.2+NeoForge" = _Ug7z2IMU;
        "pkg-0.508.3+Fabric" = _A9rkrlFE;
        "pkg-0.508.3+NeoForge" = _fyINZJel;
        "pkg-0.508.4+Fabric" = _ieQ0tNpb;
        "pkg-0.508.4+NeoForge" = _l1p9GY65;
        "pkg-0.509.1+NeoForge" = _e8PZPbeO;
        "pkg-0.509.1+Fabric" = _TVGGSSIF;
        "pkg-0.509.2+Fabric" = _Uf25Yt6L;
        "pkg-0.509.2+NeoForge" = _JwrYsg9W;
        "pkg-0.509.3+Fabric" = _mbfU6Y0B;
        "pkg-0.509.3+NeoForge" = _hANpRw1b;
        "pkg-0.510.0+Fabric" = _UQuUW6MR;
        "pkg-0.510.0+NeoForge" = _j8reYKe3;
        "pkg-0.600.0-alpha.2+NeoForge" = _teitdSaV;
        "pkg-0.600.0-alpha.2+Fabric" = _p2pW0LGq;
        "pkg-0.600.0-alpha.3+NeoForge" = _Ycn9rILb;
        "pkg-0.600.0-alpha.3+Fabric" = _FYNZp2e4;
        "pkg-0.600.0-alpha.4+Fabric" = _HEr5GG2g;
        "pkg-0.600.0-alpha.4+NeoForge" = _bIuHQnbc;
        "pkg-0.600.0-alpha.5+Fabric" = _Va24ifCB;
        "pkg-0.600.0-alpha.5+NeoForge" = _zxXOaSek;
        "pkg-0.600.0-alpha.6+Fabric" = _LohM7GLD;
        "pkg-0.600.0-alpha.6+NeoForge" = _P7PtviM5;
        "pkg-0.600.0-alpha.7+Fabric" = _ZotgZIrc;
        "pkg-0.600.0-alpha.7+NeoForge" = _MgJnL5u8;
        "pkg-0.600.0-alpha.8+Fabric" = _aTsuYKU8;
        "pkg-0.600.0-alpha.8+NeoForge" = _N6065N8B;
        "pkg-0.600.0-alpha.9+Fabric" = _e8KoPFiw;
        "pkg-0.600.0-alpha.9+NeoForge" = _wsMJG26C;
        "pkg-0.600.0-alpha.10+Fabric" = _jccL3Fpd;
        "pkg-0.600.0-alpha.10+NeoForge" = _sJ42cjrU;
        "pkg-0.600.0-alpha.11+Fabric" = _hXxoLVqU;
        "pkg-0.600.0-alpha.11+NeoForge" = _5Kp4qEuX;
        "pkg-0.600.0-alpha.12+Fabric" = _Xy9y8hoB;
        "pkg-0.600.0-alpha.12+NeoForge" = _NpaqWvaH;
        "pkg-0.600.0-alpha.13+Fabric" = _XIMsxT1i;
        "pkg-0.600.0-alpha.13+NeoForge" = _YtsVAwkv;
        "pkg-0.600.0-alpha.14+NeoForge" = _kY06YhDI;
        "pkg-0.600.0-alpha.14+Fabric" = _zT58tRRz;
        "pkg-0.600.0-alpha.15+Fabric" = _QclPNrnR;
        "pkg-0.600.0-alpha.15+NeoForge" = _hTinXQAT;
        "pkg-0.600.0-alpha.16+NeoForge" = _6ptl5gAZ;
        "pkg-0.600.0-alpha.16+Fabric" = _sMqEiUEN;
        "pkg-0.600.0-alpha.17+NeoForge" = _BiMWRCEq;
        "pkg-0.600.0-alpha.17+Fabric" = _Pyc49cEq;
        "pkg-0.600.0-alpha.18+Fabric" = _zM95Ai4O;
        "pkg-0.600.0-alpha.18+NeoForge" = _YwJGMZTM;
        "default" = _YwJGMZTM;
    });
