...
let
    ...
    in {
        ...
        "pkg-1.19.2-1.0-forge" = _Rbw1Min2;
        "pkg-1.18.2-1.1-fabric" = _pXAWltkI;
        "pkg-1.19.2-1.1-fabric" = _hb6QAvQn;
        "pkg-1.19.3-1.2-fabric" = _SODnqXf7;
        "pkg-1.19.3-1.0-forge" = _AgN0wsxQ;
        "pkg-1.18.2-2.0-forge+fabric" = _bJkgpb9y;
        "pkg-1.19.2-2.0-forge+fabric" = _CDG6lyfL;
        "pkg-1.19.3-2.0-forge+fabric" = _4pX0RHMg;
        "pkg-1.18.2-2.1-forge+fabric" = _Yi8HUCma;
        "pkg-1.19.2-2.1-forge+fabric" = _eetTMEdj;
        "pkg-1.19.3-2.1-forge+fabric" = _ze3iGKM8;
        "pkg-1.19.4-2.1-forge+fabric" = _p9wSBPR4;
        "pkg-1.20-2.1-forge+fabric" = _24hkpSMw;
        "pkg-1.20.1-2.1-forge+fabric" = _O96M4uGo;
        "pkg-1.20.2-2.1-forge+fabric" = _XStgEJZv;
        "pkg-1.18.2-2.2-forge+fabric" = _IHMbmFUf;
        "pkg-1.19.2-2.2-forge+fabric" = _uqGw7Q0Q;
        "pkg-1.20.1-2.2-forge+fabric" = _Goi2U9W0;
        "pkg-1.20.2-2.2-forge+fabric" = _BryzR1L3;
        "pkg-1.20.3-2.2-fabric+forge+neo" = _zATgJ8jE;
        "pkg-1.20.4-2.2-fabric+forge+neo" = _i9CWPzTX;
        "pkg-1.19.2-2.3-fabric+forge+neo" = _efuy0qup;
        "pkg-1.20.1-2.3-fabric+forge+neo" = _jjayVhsl;
        "pkg-1.20.2-2.3-fabric+forge+neo" = _hEchLNGH;
        "pkg-1.20.4-2.3-fabric+forge+neo" = _vH7a3obO;
        "pkg-1.20.5-2.3-fabric+neo" = _jaMz54JN;
        "pkg-1.20.5-2.4-fabric+neo" = _mZd2cJkV;
        "pkg-1.20.5-2.5-fabric+neo" = _eaoKS00O;
        "pkg-1.20.6-2.5-fabric+forge+neo" = _n1P4HGWx;
        "pkg-1.21.0-2.5-fabric+forge+neo" = _JTvM9Ndg;
        "pkg-1.20.1-2.6-fabric+forge+neo" = _DG8i0v55;
        "pkg-1.20.6-2.6-fabric+forge+neo" = _6xOhtDj3;
        "pkg-1.21.0-2.6-fabric+forge+neo" = _ONBrAsPG;
        "pkg-1.20.1-2.7-fabric+forge+neo" = _TUgGnsIU;
        "pkg-1.20.6-2.7-fabric+forge+neo" = _ZmtPmRNi;
        "pkg-1.21.0-2.7-fabric+forge+neo" = _9hjmYkjF;
        "pkg-1.21.1-2.7-fabric+forge+neo" = _NMdpJzch;
        "pkg-1.21.2-2.7-fabric+neo" = _ZzB6LBU2;
        "pkg-1.21.3-2.7-fabric+forge+neo" = _x4lFzzDG;
        "pkg-1.21.4-2.7-fabric+forge+neo" = _gjr4o6zg;
        "pkg-1.20.1-2.8-fabric+forge+neo" = _zQ9ENDyD;
        "pkg-1.21.1-2.8-fabric+forge+neo" = _RC1WkjSZ;
        "pkg-1.21.4-2.8-fabric+forge+neo" = _pkBbpzuQ;
        "pkg-1.21.5-2.8-fabric+forge+neo" = _W3bwB7pO;
        "pkg-1.21.6-2.8-fabric+forge+neo" = _1a5ELvCT;
        "pkg-1.21.7-2.8-fabric+forge+neo" = _arPpZK5b;
        "pkg-1.21.8-2.8-fabric+forge+neo" = _9H1Fa1yY;
        "pkg-1.20.1-2.9-fabric+forge+neo" = _ggpxUy2S;
        "pkg-1.21.1-2.9-fabric+forge+neo" = _MaAZVcmq;
        "pkg-1.21.8-2.9-fabric+forge+neo" = _f7VcTsdQ;
        "pkg-1.21.9-2.9-fabric+forge+neo" = _EtZ7bB13;
        "pkg-1.21.9-3.0-fabric+forge+neo" = _ZUEZSKYz;
        "pkg-1.21.10-3.0-fabric+forge+neo" = _ymhZQF6L;
        "pkg-1.21.11-3.0-fabric+forge+neo" = _yH0hWFs6;
        "pkg-26.1.0-3.0-fabric+forge+neo" = _uHvLhEk7;
