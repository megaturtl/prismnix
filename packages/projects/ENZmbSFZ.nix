...
let
    ...
    in {
        ...
        "pkg-1.0.3" = _OAYrMWsn;
        "pkg-1.0.4" = _nFBNCNjX;
        "pkg-1.0.5+1.19" = _2e0OBkKo;
        "pkg-1.1.0+1.19" = _3eqOHgyo;
        "pkg-1.1.1+1.19" = _Nm7ok1Hg;
        "pkg-1.2.0+1.19" = _lfxzsJpa;
        "pkg-1.2.0+1.19.3" = _epTpCL5T;
        "pkg-1.2.1+1.18" = _ymAJ3UJx;
        "pkg-1.2.1+1.19" = _LjuYrHpR;
        "pkg-1.2.1+1.19.3" = _92g6yttv;
        "pkg-2.0.0+1.19" = _9hkR7QGb;
        "pkg-2.0.0+1.19.3" = _HsPMYEeO;
        "pkg-2.0.1+1.19" = _Px9EsO80;
        "pkg-2.0.1+1.19.3" = _HRMBXEo4;
        "pkg-2.0.1+1.19.4" = _lWcXsUbx;
        "pkg-2.0.2+1.19.4" = _k6ljMDXD;
        "pkg-2.0.2+1.19" = _P9lwqkzT;
        "pkg-2.0.2+1.19.3" = _cdbouhH3;
        "pkg-2.0.3+1.19.4" = _5EHHGPcI;
        "pkg-2.0.3+1.19.3" = _fB8cjx51;
        "pkg-2.0.3+1.19" = _FYbSGPsw;
        "pkg-2.0.4+1.19" = _lXoQFzVn;
        "pkg-2.0.4+1.19.3" = _LBHhEKaH;
        "pkg-2.0.4+1.19.4" = _ciQcQG77;
        "pkg-2.0.4+1.20.1" = _DIxlZCnE;
        "pkg-2.0.5+1.20.1" = _nKHf8dsy;
        "pkg-2.0.5+1.19.4" = _AmSBNxgE;
        "pkg-2.0.5+1.19.3" = _NGindg0j;
        "pkg-2.0.5+1.19" = _HMmYxIPw;
        "pkg-2.0.5+1.20.2" = _LzGqjsdM;
        "pkg-2.0.6+1.20.1" = _CjEPl7OU;
        "pkg-2.1.0+1.20.1" = _aLVZ7ugY;
        "pkg-2.2.0+1.20.1" = _sY5aFlxt;
        "pkg-2.2.1+1.20.1" = _nnllzcQl;
        "pkg-3.0.0+1.21.1" = _1TzizPpM;
        "pkg-3.1.0+1.21.1" = _jQWswG4p;
        "pkg-3.2.0+1.21.1" = _kgQUaJB0;
        "pkg-3.2.1+1.21.1" = _Y26Fb2FL;
        "pkg-3.2.2+1.21.1" = _eeWJhZN5;
        "pkg-3.3.0+1.21.1" = _foPx4TBY;
        "pkg-3.3.1+1.21.1" = _goc5xUxu;
        "pkg-3.3.2+1.21.1" = _cfYhR8Yy;
        "pkg-3.3.3+1.21.1" = _asZ85Rcf;
        "pkg-3.3.4+1.21.1" = _4eFrCHKI;
        "pkg-3.3.5+1.21.1" = _BFIgzK26;
        "pkg-3.4.0+1.21.1" = _YkjMWcXw;
        "pkg-3.4.1+1.21.1" = _Adn3ca04;
        "pkg-3.4.2+1.21.1" = _jwWx00JX;
        "pkg-3.5.0+1.21.1" = _PKdwcWbN;
        "pkg-3.5.1+1.21.1" = _LHbQZVqo;
        "pkg-3.5.2+1.21.1" = _TFyX6WCI;
        "pkg-3.6.0+1.21.1-fabric" = _4rH1JFk6;
        "pkg-3.6.0+1.21.1-neoforge" = _PoV2wbqO;
        "pkg-3.6.1+1.21.1-fabric" = _yhiZ5WMK;
        "pkg-3.6.1+1.21.1-neoforge" = _3V8ixGPR;
        "pkg-3.6.2+1.21.1-fabric" = _hiXpMd0k;
        "pkg-3.6.2+1.21.1-neoforge" = _NLKM8zci;
        "pkg-3.6.3+1.21.1-fabric" = _BUjxUZvo;
        "pkg-3.6.3+1.21.1-neoforge" = _QvKNjdn8;
        "pkg-3.6.4+1.21.1-fabric" = _rchgQPH6;
        "pkg-3.6.4+1.21.1-neoforge" = _VZdb4vor;
        "pkg-3.6.5+1.21.1-neoforge" = _ejxyBLQV;
        "pkg-3.6.5+1.21.1-fabric" = _iPcHmSTo;
        "pkg-3.6.7+1.21.1-fabric" = _CKPhvdzN;
        "pkg-3.6.7+1.21.1-neoforge" = _NIJS207T;
        "pkg-3.6.8+1.21.1-fabric" = _2WEbyTXn;
        "pkg-3.6.8+1.21.1-neoforge" = _ExA8MD0r;
        "pkg-3.6.9+1.21.1-fabric" = _fgGbXMUn;
