...
let
    versions = (let
        ...
        _7rrEoVrD = {
            "id" = "7rrEoVrD";
            "file" = "BedrockSkins-1.21.10-2.0.0-neoforge.jar";
            "hash" = "sha512-OSVcQSHlwWfanG23Dw5OexqlvEe7+c6ur5RTisHTEIfOx8oy1rH0PW6tS+KyoELmPi27gqakTloDlg59RREkDg==";
        };
        _iYy4J5rz = {
            "id" = "iYy4J5rz";
            "file" = "BedrockSkins-1.21.10-2.0.0-fabric.jar";
            "hash" = "sha512-rre04vdkqhb5sfJvBiOvIXrJ8gAPrzduPJM66ZISjn++4bR+1kUiHOmMlh6kSDVzLwaRo6PVe6LSD4A0ke10Eg==";
        };
        _QYxjWwF0 = {
            "id" = "QYxjWwF0";
            "file" = "BedrockSkins-26.1.2-2.0.0-fabric.jar";
            "hash" = "sha512-j0WdqogvcPNjvm6XBtlWh1guaCCFcnmym2wISbGtT8zvYa5xwRwsK46QVnSgihgJ89WtQV7Jvgc91TMsyLv6WQ==";
        };
        _lUGJuUys = {
            "id" = "lUGJuUys";
            "file" = "BedrockSkins-26.2-2.0.0-fabric.jar";
            "hash" = "sha512-yo2a5daGulRzUUShOHF7u2pvwzAEycqASdi2b02zV6H/RCysVAtcn1OLNQ3AwK+cgyxpmuk33iSu8BIQG0++Ew==";
        };
        _X5eiyttP = {
            "id" = "X5eiyttP";
            "file" = "BedrockSkins-1.21.11-2.0.0-fabric.jar";
            "hash" = "sha512-bgLpB6Wyvf+6MJBHVYqzITXq+gdDw67kdGS9nw1gRkDzpTS8NjoaZ7gaSuETjKy7eN+A5it4MDSTbctZgA3Twg==";
        };
        _IHtDPsRo = {
            "id" = "IHtDPsRo";
            "file" = "BedrockSkins-1.21.11-2.0.0-neoforge.jar";
            "hash" = "sha512-+9j+5ag3hOfcHj2ZKPlMuolfxcTcFLk4DvBi0CN4rR7hdJr11LEXdbrZxVa8SaSzP0todHtGLm0eSFFZXPMNSA==";
        };
        _YzqIPBmx = {
            "id" = "YzqIPBmx";
            "file" = "BedrockSkins-1.21.9-2.0.0-neoforge.jar";
            "hash" = "sha512-6DR5mOMscJTBL52zIfEdm6bvT2tIv0ChNBhNKtz1N+ieofFGdHw1qgshxxjEhEaWQpOhHIw7VPMK5jMndhHMTg==";
        };
        _6FK1jt1h = {
            "id" = "6FK1jt1h";
            "file" = "BedrockSkins-1.21.9-2.0.0-fabric.jar";
            "hash" = "sha512-UQe/XMtxClyTFA38h0tkFEpzM6QtuXUcXHDKc0qMP0mAGgYiEMV2W+x0Wjkw6/nlZj7aFX11s9v4zAa37AjQ4w==";
        };
        _yJs2AsMf = {
            "id" = "yJs2AsMf";
            "file" = "BedrockSkins-26.1.2-2.0.0-neoforge.jar";
            "hash" = "sha512-Y3U8iCHW0ba3hXxvN649nQzW731Ye69+7EhYg/2hXX6KdxHu27mm1W+ocqyfRVcGcvWZMqyUJiYeWo4ZflPsww==";
        };
        _Kb737hc8 = {
            "id" = "Kb737hc8";
            "file" = "BedrockSkins-26.3-2.0.0-fabric.jar";
            "hash" = "sha512-CNOOAc74Gcuu+roeq/rwHRwjq7korZa7sUh1uye/VnNNhM7A7BD2i6J27qUZ+QZbPvOO4xPM1ztZDORjg9UVYQ==";
        };
        _u0gpw3im = {
            "id" = "u0gpw3im";
            "file" = "BedrockSkins-26.1.2-2.0.1-fabric.jar";
            "hash" = "sha512-DfUsc8eACdwe/ajRXPfaM+kQL1GojDrqSjstBVyI4FO4ZzzPMd4hKgwCqDH/zRyWZtqa9DQ1EgVYF5vC+T/11Q==";
        };
        _VlAU0g8A = {
            "id" = "VlAU0g8A";
            "file" = "BedrockSkins-26.3-2.0.1-fabric.jar";
            "hash" = "sha512-RcGZdEkASAyReCulcQ9oWYdz5j92NDo5IBV0VP8lzrTw0cV/fuMKP6iSHBSE2Ulw0+cxqZFyGG2fAxqY67u+/g==";
        };
        _OjJDsgLf = {
            "id" = "OjJDsgLf";
            "file" = "BedrockSkins-1.21.10-2.0.1-fabric.jar";
            "hash" = "sha512-if/8YzdZ4hVoT4A5ggScmIV7zt1WLTKm7pS5EdojXt878f71Sbi7Mb8B8XjcFImmym8Yq730o01UzDtYa2kDPg==";
        };
        _Oemmp8Ir = {
            "id" = "Oemmp8Ir";
            "file" = "BedrockSkins-1.21.11-2.0.1-fabric.jar";
            "hash" = "sha512-tK6yUsrr8w8kFztJsFwErcj9ZFPiC0IhRPL0n5Id4z/kYVh+zR2r80WNLNGixfxwhqW25IN4HGj1cyfijJSnpg==";
        };
        _1m9UjXDp = {
            "id" = "1m9UjXDp";
            "file" = "BedrockSkins-1.21.10-2.0.1-neoforge.jar";
            "hash" = "sha512-mTTBuTBo7xlMpevkVFRh6PR7GTGmcfy+3TXsJKv1OopsL7M0sA8sYTfsteroRJseesJexlCH95Fz8V5LrOJDFg==";
        };
        _sUfencRz = {
            "id" = "sUfencRz";
            "file" = "BedrockSkins-1.21.11-2.0.1-neoforge.jar";
            "hash" = "sha512-8vjjqKH742Tbj8onkm5fr5PqYEGCNrxj+1MlQfLjW0hQHROIjDjQDT4WoJzwooWXht9LFctzoH+HPYk/2aBJIw==";
        };
        _T1yHo9wo = {
            "id" = "T1yHo9wo";
            "file" = "BedrockSkins-1.21.9-2.0.1-fabric.jar";
            "hash" = "sha512-cRO1bNbfav73pUfYVt+H3d49pDR3GTCph5stAfkw5KKe+wXSE11Nav8Nv7BaxRIhUVYOx4W2aYRZsA9cWJrT1Q==";
        };
        _jVnk9x9P = {
            "id" = "jVnk9x9P";
            "file" = "BedrockSkins-1.21.9-2.0.1-neoforge.jar";
            "hash" = "sha512-9j3Pan1BKBlfDy6Q6IBoQauaLV7em7T5mivXjL5DYw7ocNBHUKTCV609PYWBP1PnERRLuSNaipfaU8jTj6c6ug==";
        };
        _DsjUAezB = {
            "id" = "DsjUAezB";
            "file" = "BedrockSkins-26.1.2-2.0.1-neoforge.jar";
            "hash" = "sha512-NSIMkBpfMbGh0UDl3MH0YIt9prFMEUOfL/YAGYvYRgsgKZrQiCqYqGxR21//cg/5plgh6PqNPde86RdYgH4B2A==";
        };
        _zsa94Sa9 = {
            "id" = "zsa94Sa9";
    ...
    in {
        ...
        "pkg-1.3.0" = _w3OJdIAv;
        "pkg-1.3.1" = _C1JyvQ7U;
        "pkg-1.21.9-1.3.2+neoforge" = _7wJbkoYe;
        "pkg-1.21.11-1.3.2+neoforge" = _z3wNl3FR;
        "pkg-1.21.10-1.3.2+fabric" = _VI3dpMKB;
        "pkg-1.21.11-1.3.2+fabric" = _siTd75eb;
        "pkg-1.21.9-1.3.2+fabric" = _3NneOUr0;
        "pkg-1.21.10-1.3.2+neoforge" = _Jb6uMSXe;
        "pkg-1.21.9-1.3.3+neoforge" = _DwBwSA5V;
        "pkg-1.21.10-1.3.3+neoforge" = _4ZwlxG8n;
        "pkg-1.21.10-1.3.3+fabric" = _nfslgj8m;
        "pkg-1.21.11-1.3.3+neoforge" = _2JdOO5kG;
        "pkg-1.21.9-1.3.3+fabric" = _kss1XRND;
        "pkg-1.21.11-1.3.3+fabric" = _PmYBblBX;
        "pkg-1.21.10-1.3.4+neoforge" = _YNStItTl;
        "pkg-1.21.11-1.3.4+neoforge" = _7FYmSYsQ;
        "pkg-1.21.9-1.3.4+neoforge" = _hCPbJbj2;
        "pkg-1.21.9-1.3.4+fabric" = _i0HbYs2c;
        "pkg-1.21.10-1.3.4+fabric" = _Pm8cYDL9;
        "pkg-1.21.11-1.3.4+fabric" = _etbsYmEF;
        "pkg-1.21.11-1.4.0+neoforge" = _IvyMCsNL;
        "pkg-1.21.10-1.4.0+neoforge" = _u15bSXn4;
        "pkg-1.21.10-1.4.0+fabric" = _gQsvABvM;
        "pkg-1.21.9-1.4.0+neoforge" = _MgcnQ2FQ;
        "pkg-1.21.11-1.4.0+fabric" = _9BeVJjJI;
        "pkg-1.21.9-1.4.0+fabric" = _jE39lLT8;
        "pkg-1.21.11-1.5.0+neoforge" = _uw3ePuAC;
        "pkg-1.21.10-1.5.0+fabric" = _bIJOAovI;
        "pkg-1.21.10-1.5.0+neoforge" = _JzI7z831;
        "pkg-1.21.11-1.5.0+fabric" = _apJih9Ai;
        "pkg-1.21.9-1.5.0+neoforge" = _hZeKz8iG;
        "pkg-1.21.9-1.5.0+fabric" = _5u5umBUq;
        "pkg-1.21.11-1.5.1+fabric" = _Gbxlq4Wh;
        "pkg-1.21.10-1.5.1+fabric" = _hEInolEZ;
        "pkg-1.21.9-1.5.1+neoforge" = _oCnu3IGS;
        "pkg-1.21.11-1.5.1+neoforge" = _LUuaT8xh;
        "pkg-1.21.10-1.5.1+neoforge" = _PHURqFzo;
        "pkg-1.21.9-1.5.1+fabric" = _tBrDEbpR;
        "pkg-1.21.11-1.5.2+fabric" = _dywZbmVK;
        "pkg-1.21.11-1.5.2+neoforge" = _d9pZ2kNv;
        "pkg-1.21.10-1.5.2+fabric" = _NJLVNbLQ;
        "pkg-1.21.9-1.5.2+fabric" = _CuoL8Mn0;
        "pkg-1.21.9-1.5.2+neoforge" = _J7NXa3Jf;
        "pkg-1.21.10-1.5.2+neoforge" = _HRz73tEQ;
        "pkg-1.21.10-1.5.3+fabric" = _lug3inGF;
        "pkg-1.21.10-1.5.3+neoforge" = _4DOF6Usw;
        "pkg-1.21.11-1.5.3+fabric" = _nDNVlo38;
        "pkg-1.21.9-1.5.3+fabric" = _WTN1IzrZ;
        "pkg-1.21.11-1.5.3+neoforge" = _V8yXoMmy;
        "pkg-1.21.9-1.5.3+neoforge" = _CSv8zGaA;
        "pkg-1.21.9-1.6.0+neoforge" = _py82vA5w;
        "pkg-1.21.11-1.6.0+neoforge" = _wLm7CW4a;
        "pkg-1.21.9-1.6.0+fabric" = _ZqIFnXAL;
        "pkg-1.21.10-1.6.0+fabric" = _cY9mvCsX;
        "pkg-1.21.11-1.6.0+fabric" = _xIWAMF6F;
        "pkg-1.21.11-1.6.1+neoforge" = _ybKnYsmb;
        "pkg-1.21.9-1.6.1+neoforge" = _4HHANX9d;
        "pkg-1.21.10-1.6.1+fabric" = _oX4uqRJF;
        "pkg-1.21.10-1.6.1+neoforge" = _KYNQHoB0;
        "pkg-1.21.9-1.6.1+fabric" = _Va8iNWb2;
        "pkg-1.21.11-1.6.1+fabric" = _MjTzCeo0;
        "pkg-1.21.11-1.6.2+neoforge" = _AZIbAvlM;
        "pkg-1.21.9-1.6.2+neoforge" = _J9SsnMzM;
        "pkg-1.21.9-1.6.2+fabric" = _iPgA6KCc;
        "pkg-1.21.11-1.6.2+fabric" = _vWuWCPJV;
        "pkg-1.21.10-1.6.2+neoforge" = _M4vKdomM;
        "pkg-1.21.10-1.6.2+fabric" = _6ZDi9pCj;
        "pkg-1.21.10-1.7.0+neoforge" = _2b2IGwEh;
        "pkg-1.21.10-1.7.0+fabric" = _nd30MhW8;
        "pkg-1.21.11-1.7.0+fabric" = _ivrG32oS;
        "pkg-1.21.11-1.7.0+neoforge" = _61eTCQ8M;
        "pkg-1.21.9-1.7.0+neoforge" = _mUhvkyhU;
        "pkg-1.21.9-1.7.0+fabric" = _33zn5sBe;
        "pkg-1.21.10-1.7.1+neoforge" = _vSTxbHiA;
        "pkg-1.21.11-1.7.1+neoforge" = _KmLZKlLh;
        "pkg-1.21.10-1.7.1+fabric" = _S1PmMvA7;
        "pkg-1.21.11-1.7.1+fabric" = _fqzeUaoU;
        "pkg-1.21.9-1.7.1+fabric" = _xFxN9196;
        "pkg-1.21.9-1.7.1+neoforge" = _IUApxSx5;
        "pkg-1.21.11-1.7.2+neoforge" = _yQe3HLy7;
        "pkg-1.21.10-1.7.2+neoforge" = _iFZ1pOJy;
        "pkg-1.21.9-1.7.2+neoforge" = _FFldW9DE;
        "pkg-1.21.11-1.7.2+fabric" = _Mbm5tFUk;
        "pkg-1.21.10-1.7.2+fabric" = _bT8tbgls;
        "pkg-1.21.9-1.7.2+fabric" = _rk732KVl;
        "pkg-26.1-1.7.2+fabric" = _aj7NRuQ0;
        "pkg-26.1-1.7.2+neoforge" = _m8F0QV7r;
        "pkg-1.21.11-1.7.3+neoforge" = _KVZ4C2Hx;
        "pkg-1.21.11-1.7.3+fabric" = _r8m6i3gY;
        "pkg-26.1-1.7.3+fabric" = _rMN7Lf99;
        "pkg-1.21.10-1.7.3+fabric" = _cyHyrgmU;
        "pkg-1.21.9-1.7.3+fabric" = _ChsZcjlx;
        "pkg-1.21.10-1.7.3+neoforge" = _KV42yHL9;
        "pkg-1.21.9-1.7.3+neoforge" = _KDWgNyJP;
        "pkg-26.1-1.7.3+neoforge" = _x822FkvD;
        "pkg-26.1.2-1.7.3+neoforge" = _3sKgFblf;
        "pkg-26.1.2-1.7.3+fabric" = _tQVTF5rK;
        "pkg-26.1.2-1.7.4+fabric" = _RTs3GqO4;
        "pkg-26.1.2-1.7.4+neoforge" = _YC7RV2jf;
        "pkg-1.21.11-1.7.4+fabric" = _7fsr6flR;
        "pkg-1.21.10-1.7.4+fabric" = _Ctqvdv0g;
        "pkg-1.21.9-1.7.4+fabric" = _EXBN50iI;
        "pkg-1.21.10-1.7.4+neoforge" = _aFdP7oeK;
        "pkg-1.21.9-1.7.4+neoforge" = _cFoT2Guj;
        "pkg-1.21.11-1.7.4+neoforge" = _tEpIhm82;
        "pkg-26.1.2-1.7.5+fabric" = _NEGMyKXR;
        "pkg-1.21.9-1.7.5+neoforge" = _e6ipeFEv;
        "pkg-1.21.9-1.7.5+fabric" = _qi8B9uY9;
        "pkg-1.21.11-1.7.5+neoforge" = _k1zivGir;
        "pkg-26.1.2-1.7.5+neoforge" = _PkcKyNob;
        "pkg-1.21.10-1.7.5+neoforge" = _YXsuXWTU;
        "pkg-1.21.11-1.7.5+fabric" = _lfUpmLRN;
        "pkg-1.21.10-1.7.5+fabric" = _NhCJBnjO;
        "pkg-1.21.10-1.8.0+neoforge" = _GRwvfFbK;
        "pkg-1.21.11-1.8.0+neoforge" = _jgbHHSuH;
        "pkg-1.21.11-1.8.0+fabric" = _cCpw0NND;
        "pkg-1.21.9-1.8.0+fabric" = _i4G9rV2d;
        "pkg-1.21.10-1.8.0+fabric" = _VHDUOtVI;
        "pkg-26.1.2-1.8.0+neoforge" = _PQG8VCVv;
        "pkg-1.21.9-1.8.0+neoforge" = _hvZ1ddms;
        "pkg-26.1.2-1.8.0+fabric" = _CzjtLy0O;
        "pkg-26.1.2-1.8.1+fabric" = _aMCn1GRT;
        "pkg-1.21.11-1.8.1+fabric" = _WM0r4v20;
        "pkg-1.21.10-1.8.1+fabric" = _DWPFYY9G;
        "pkg-1.21.9-1.8.1+fabric" = _zPhHhMrv;
        "pkg-1.21.11-1.8.2+neoforge" = _Dsf65rHD;
        "pkg-1.21.11-1.8.2+fabric" = _IDltKf0l;
        "pkg-26.1.2-1.8.2+fabric" = _mSl3Lqzl;
        "pkg-1.21.10-1.8.2+fabric" = _FC1Fcvd0;
        "pkg-26.1.2-1.8.3+neoforge" = _a9hMbuWi;
        "pkg-26.2-1.8.3+fabric" = _jmfjVgDO;
        "pkg-1.21.10-1.8.3+fabric" = _yAIrACC1;
        "pkg-1.21.11-1.8.3+neoforge" = _J3AkiOXF;
        "pkg-1.21.9-1.8.3+fabric" = _X2xxL0fe;
        "pkg-26.1.2-1.8.3+fabric" = _LNhvEtZF;
        "pkg-1.21.9-1.8.3+neoforge" = _VIH1i8DZ;
        "pkg-1.21.11-1.8.3+fabric" = _57o03vL2;
        "pkg-1.21.10-1.8.3+neoforge" = _BBKtzqeQ;
        "pkg-1.21.11-1.9+neoforge" = _O80RnbLG;
        "pkg-1.21.9-1.9+neoforge" = _XhvL8KxX;
        "pkg-26.1.2-1.9+neoforge" = _Qk1EeFpo;
        "pkg-1.21.10-1.9+neoforge" = _btOo7XMe;
        "pkg-26.2-1.9+fabric" = _F2QjmsRZ;
        "pkg-1.21.9-1.9+fabric" = _R5OCA0eh;
        "pkg-26.1.2-1.9+fabric" = _EK7XaDqi;
        "pkg-1.21.11-1.9+fabric" = _ZkuZTwYh;
        "pkg-1.21.10-1.9+fabric" = _CPhJSxoD;
        "pkg-26.1.2-1.9.1+neoforge" = _xvPFdiiX;
        "pkg-26.1.2-1.9.1+fabric" = _LTaTlyV3;
        "pkg-26.2-1.9.1+fabric" = _BuB6TYYE;
        "pkg-1.21.11-1.9.1+fabric" = _owFSsGzS;
        "pkg-1.21.9-1.9.1+fabric" = _TNHVJ0yG;
        "pkg-1.21.10-1.9.1+fabric" = _8vzJt9if;
        ...
        "pkg-1.21.10-2.0.0+neoforge" = _7rrEoVrD;
        "pkg-1.21.10-2.0.0+fabric" = _iYy4J5rz;
        "pkg-26.1.2-2.0.0+fabric" = _QYxjWwF0;
        "pkg-26.2-2.0.0+fabric" = _lUGJuUys;
        "pkg-1.21.11-2.0.0+fabric" = _X5eiyttP;
        "pkg-1.21.11-2.0.0+neoforge" = _IHtDPsRo;
        "pkg-1.21.9-2.0.0+neoforge" = _YzqIPBmx;
        "pkg-1.21.9-2.0.0+fabric" = _6FK1jt1h;
        "pkg-26.1.2-2.0.0+neoforge" = _yJs2AsMf;
        "pkg-26.3-2.0.0+fabric" = _Kb737hc8;
        "pkg-26.1.2-2.0.1+fabric" = _u0gpw3im;
        "pkg-26.3-2.0.1+fabric" = _VlAU0g8A;
        "pkg-1.21.10-2.0.1+fabric" = _OjJDsgLf;
        "pkg-1.21.11-2.0.1+fabric" = _Oemmp8Ir;
        "pkg-1.21.10-2.0.1+neoforge" = _1m9UjXDp;
        "pkg-1.21.11-2.0.1+neoforge" = _sUfencRz;
        "pkg-1.21.9-2.0.1+fabric" = _T1yHo9wo;
