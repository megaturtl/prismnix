...
let
    ...
    in {
        ...
        "pkg-13.1.1+fabric-1.19" = _iWt5AcjY;
        "pkg-13.1.2+fabric-1.19" = _Khs1RODv;
        "pkg-13.1.2+forge-1.19" = _SgIn71z9;
        "pkg-13.2.0+fabric-1.19" = _TTZwBoRA;
        "pkg-13.2.0+forge-1.19" = _JiHDEdps;
        "pkg-13.2.1+fabric-1.19" = _bgt2G9PN;
        "pkg-13.2.1+forge-1.19" = _DPmGOBiL;
        "pkg-12.1.1+forge-1.18.2" = _aeMzou3d;
        "pkg-13.2.2+forge-1.19" = _pqYM9QT2;
        "pkg-12.1.1+fabric-1.18.2" = _ZmXrw4a2;
        "pkg-13.2.2+fabric-1.19" = _fG6XdPS6;
        "pkg-13.2.3+forge-1.19.2" = _EIIPTr8R;
        "pkg-13.3.0+fabric-1.19.2" = _MHud94uQ;
        "pkg-13.3.0+forge-1.19.2" = _U79DOgDm;
        "pkg-12.2.0+fabric-1.18.2" = _IDDuWBtK;
        "pkg-12.2.0+forge-1.18.2" = _XPhxXLsP;
        "pkg-14.0.1+forge-1.19.3" = _vgf8osnr;
        "pkg-14.0.1+fabric-1.19.3" = _VGkprttw;
        "pkg-14.0.2+fabric-1.19.3" = _HL3wdUKC;
        "pkg-14.0.2+forge-1.19.3" = _x3nr3NXZ;
        "pkg-13.3.1+fabric-1.19.2" = _CAkRaaRE;
        "pkg-13.3.1+forge-1.19.2" = _UjospnIq;
        "pkg-15.0.1+fabric-1.19.4" = _9JhYGdOq;
        "pkg-15.0.1+forge-1.19.4" = _DmfJQvze;
        "pkg-15.0.2+forge-1.19.4" = _xCmfDNeV;
        "pkg-13.3.2+fabric-1.19.2" = _Hs9lqPNL;
        "pkg-13.3.2+forge-1.19.2" = _CDGeZUsi;
        "pkg-15.0.2+fabric-1.19.4" = _TqIZXjFt;
        "pkg-16.0.0+fabric-1.20" = _ZDOSMTDm;
        "pkg-16.0.0+forge-1.20" = _sA17ATuT;
        "pkg-16.0.1+fabric-1.20" = _ZvaAnN5y;
        "pkg-13.3.3+fabric-1.19.2" = _3UE5RAKk;
        "pkg-16.0.1+forge-1.20" = _yKz0conr;
        "pkg-13.3.3+forge-1.19.2" = _eLbE6TGp;
        "pkg-17.0.0+fabric-1.20.2" = _ZkNNxO0n;
        "pkg-17.0.0+forge-1.20.2" = _xMZxxx92;
        "pkg-13.3.4+forge-1.19.2" = _tj2r8UFF;
        "pkg-13.3.4+fabric-1.19.2" = _312KYNZr;
        "pkg-17.0.1+fabric-1.20.2" = _xSz0Wig5;
        "pkg-17.0.1+forge-1.20.2" = _p7nhHIVG;
        "pkg-17.0.1+neoforge-1.20.2" = _YJ4WsFrH;
        "pkg-18.0.1+fabric-1.20.4" = _VBqnFkpC;
        "pkg-18.0.1+forge-1.20.4" = _HLyyEMZp;
        "pkg-18.0.1+neoforge-1.20.4" = _uIqnWOEB;
        "pkg-18.0.2+fabric-1.20.4" = _nM0Ys3GU;
        "pkg-18.0.2+forge-1.20.4" = _Jt9hyGyV;
        "pkg-18.0.2+neoforge-1.20.4" = _A72hmjzN;
        "pkg-18.0.3+fabric-1.20.4" = _235cVi6C;
        "pkg-18.0.3+forge-1.20.4" = _JhKk5PM7;
        "pkg-18.0.3+neoforge-1.20.4" = _SpgICMae;
        "pkg-16.0.2+fabric-1.20.1" = _iM3fn4xr;
        "pkg-16.0.2+forge-1.20.1" = _sNUVtdtj;
        "pkg-16.0.3+fabric-1.20.1" = _crPuUA31;
        "pkg-16.0.3+forge-1.20.1" = _QVszaOop;
        "pkg-18.0.4+fabric-1.20.4" = _jVHObP4X;
        "pkg-18.0.4+forge-1.20.4" = _GJyXvMQe;
        "pkg-18.0.4+neoforge-1.20.4" = _KcBpPW8r;
        "pkg-18.0.5+fabric-1.20.4" = _5O99Tery;
        "pkg-18.0.5+forge-1.20.4" = _z31hOUW8;
        "pkg-18.0.5+neoforge-1.20.4" = _YP1I5HqS;
        "pkg-16.0.4+fabric-1.20.1" = _vTUoNbGE;
        "pkg-16.0.4+forge-1.20.1" = _4mQuWeNx;
        "pkg-19.0.1+1.20.6+fabric-1.20.6" = _o3I1s1Oe;
        "pkg-19.0.1+1.20.6+forge-1.20.6" = _11X0VJLz;
        "pkg-19.0.1+1.20.6+neoforge-1.20.6" = _5Jw53oxx;
        "pkg-19.0.2+fabric-1.20.6" = _QtGOeG6s;
        "pkg-19.0.2+forge-1.20.6" = _C3M1yDSR;
        "pkg-19.0.2+neoforge-1.20.6" = _1iw2Ip4J;
        "pkg-16.0.6+fabric-1.20.1" = _MZ55K4g2;
        "pkg-16.0.6+forge-1.20.1" = _MQJIESsA;
        "pkg-21.0.1+fabric-1.21" = _Ek2SMPms;
        "pkg-21.0.1+forge-1.21" = _idU2C6lf;
        "pkg-21.0.1+neoforge-1.21" = _3caKLlUs;
        "pkg-21.0.2+fabric-1.21" = _6YhK37Q1;
        "pkg-21.0.2+forge-1.21" = _ajJvU6e6;
        "pkg-21.0.2+neoforge-1.21" = _lLeRYA6F;
        "pkg-21.0.3+fabric-1.21" = _jcC56h0A;
        "pkg-21.0.3+forge-1.21" = _YM7nKlVg;
        "pkg-21.0.3+neoforge-1.21" = _KRvmjVUe;
        "pkg-18.0.7+fabric-1.20.4" = _fnRQtAMj;
        "pkg-18.0.7+forge-1.20.4" = _y02kzeJ0;
        "pkg-18.0.7+neoforge-1.20.4" = _6lR0Dy8m;
        "pkg-21.0.4+fabric-1.21" = _RTlTyWbF;
        "pkg-21.0.4+forge-1.21" = _wtKRzYNW;
        "pkg-21.0.4+neoforge-1.21" = _Ubt5KzjH;
        "pkg-21.1.1+fabric-1.21.1" = _9TScnNsW;
        "pkg-21.1.1+forge-1.21.1" = _Mqyr0g69;
        "pkg-21.1.1+neoforge-1.21.1" = _rbM8KowY;
        "pkg-18.0.8+fabric-1.20.4" = _lcmymmR5;
        "pkg-18.0.8+forge-1.20.4" = _rNC6ZPON;
        "pkg-18.0.8+neoforge-1.20.4" = _fgMHENbq;
        "pkg-21.1.2+fabric-1.21.1" = _DhC0zMao;
        "pkg-21.1.2+neoforge-1.21.1" = _epnJiURJ;
        "pkg-21.1.2+forge-1.21.1" = _L9UUoR5r;
        "pkg-16.0.9+fabric-1.20.1" = _hqrfEWHR;
        "pkg-16.0.9+forge-1.20.1" = _i9XwVFnO;
        "pkg-18.0.9+fabric-1.20.4" = _j6eQaRYQ;
        "pkg-18.0.9+forge-1.20.4" = _4DO36LW3;
        "pkg-21.1.3+fabric-1.21.1" = _sZlRBRxm;
        "pkg-18.0.9+neoforge-1.20.4" = _lwCok51k;
        "pkg-21.1.3+forge-1.21.1" = _RKHQcVSe;
        "pkg-21.1.3+neoforge-1.21.1" = _IcGE847b;
        "pkg-21.3.1+fabric-1.21.3" = _QVOmheT4;
        "pkg-21.3.1+neoforge-1.21.3" = _hXTqVFj9;
        "pkg-21.4.1+fabric-1.21.4" = _IjOkJPbd;
        "pkg-21.4.1+neoforge-1.21.4" = _d8bsOEhm;
        "pkg-21.3.2+neoforge-1.21.3" = _U3k5nqoB;
        "pkg-21.4.2+fabric-1.21.4" = _9jM3IxrZ;
        "pkg-21.4.2+neoforge-1.21.4" = _1ngpHclV;
        "pkg-21.1.4+fabric-1.21.1" = _6I7vAS2Y;
        "pkg-21.1.4+forge-1.21.1" = _rpisaY3x;
        "pkg-21.1.4+neoforge-1.21.1" = _Z1bckm6u;
        "pkg-21.4.3+fabric-1.21.4" = _mStUHp1I;
        "pkg-21.4.3+neoforge-1.21.4" = _XNfWbSz1;
        "pkg-21.4.4+fabric-1.21.4" = _RdVOysdy;
        "pkg-21.4.4+neoforge-1.21.4" = _HSpPzvWQ;
        "pkg-21.1.6+fabric-1.21.1" = _g1wU13tG;
        "pkg-21.1.6+neoforge-1.21.1" = _OzUs6cXp;
        "pkg-21.1.6+forge-1.21.1" = _AL3GqiKG;
        "pkg-21.4.5+forge-1.21.4" = _6iEYlba6;
        "pkg-21.4.6+forge-1.21.4" = _hScXEdxb;
        "pkg-16.0.10+fabric-1.20.1" = _7hCupZiN;
        "pkg-16.0.10+forge-1.20.1" = _ezlJteqn;
        "pkg-21.1.7+fabric-1.21.1" = _7mqGCS0y;
        "pkg-21.1.7+neoforge-1.21.1" = _LEIZCu7V;
        "pkg-21.1.7+forge-1.21.1" = _D4D1QO7M;
        "pkg-21.1.8+fabric-1.21.1" = _QUKY8yEA;
        "pkg-21.1.8+neoforge-1.21.1" = _IXCr91xu;
        "pkg-21.1.8+forge-1.21.1" = _6su5mPof;
        "pkg-21.1.9+fabric-1.21.1" = _xCa9gecr;
        "pkg-21.1.9+forge-1.21.1" = _cOv43ZSO;
        "pkg-21.1.9+neoforge-1.21.1" = _6O59TSCx;
        "pkg-21.4.7+fabric-1.21.4" = _TFkEYbhG;
        "pkg-21.4.7+forge-1.21.4" = _c3iIgpES;
        "pkg-21.4.7+neoforge-1.21.4" = _mJXJ5iIk;
        "pkg-16.0.11+fabric-1.20.1" = _L3ZBlCbV;
        "pkg-21.1.10+forge-1.21.1" = _tQClBxRz;
        "pkg-21.1.10+fabric-1.21.1" = _Bwq38SHi;
        "pkg-21.1.10+neoforge-1.21.1" = _iHDfeb6W;
        "pkg-16.0.11+forge-1.20.1" = _zoRddnEF;
        "pkg-21.1.11+fabric-1.21.1" = _goCVFDjs;
        "pkg-21.1.11+forge-1.21.1" = _dtMney4u;
        "pkg-21.1.11+neoforge-1.21.1" = _J999s76d;
        "pkg-16.0.12+fabric-1.20.1" = _Qbg0wYCq;
        "pkg-16.0.12+forge-1.20.1" = _zuQ5qMof;
        "pkg-21.4.8+fabric-1.21.4" = _ZkajXAiE;
        "pkg-21.4.8+forge-1.21.4" = _PiluAnt5;
        "pkg-21.4.8+neoforge-1.21.4" = _o8EWq3js;
        "pkg-21.1.12+fabric-1.21.1" = _W4QeKSnW;
        "pkg-21.1.12+forge-1.21.1" = _nwkAmLQS;
        "pkg-21.1.12+neoforge-1.21.1" = _cm966Gh4;
        "pkg-21.4.9+fabric-1.21.4" = _BsJKqktk;
        "pkg-21.4.9+forge-1.21.4" = _DyvGeVnS;
        "pkg-16.0.13+fabric-1.20.1" = _hCYweAv5;
        "pkg-21.4.9+neoforge-1.21.4" = _kla7v0wh;
        "pkg-16.0.13+forge-1.20.1" = _vpF3SAiG;
        "pkg-21.5.1+neoforge-1.21.5" = _V6hMxpLR;
        "pkg-21.5.2+forge-1.21.5" = _1MiSd6r1;
        "pkg-21.5.3+forge-1.21.5" = _buI8Tp37;
        "pkg-21.1.13+fabric-1.21.1" = _a4IoiahU;
        "pkg-21.1.13+forge-1.21.1" = _Ps3b1hio;
        "pkg-21.1.13+neoforge-1.21.1" = _WmytvZdk;
        "pkg-21.4.10+fabric-1.21.4" = _w8uRNm4s;
        "pkg-21.5.4+forge-1.21.5" = _upyuFNbL;
        "pkg-21.5.4+neoforge-1.21.5" = _cXGi2jFk;
        "pkg-21.4.10+forge-1.21.4" = _FWNqgX23;
        "pkg-21.4.10+neoforge-1.21.4" = _SaFXknJF;
        "pkg-21.5.5+fabric-1.21.5" = _QxqR8IuX;
        "pkg-21.4.11+fabric-1.21.4" = _8LKjAFV1;
        "pkg-21.4.11+neoforge-1.21.4" = _t0iHbUVX;
        "pkg-21.1.14+fabric-1.21.1" = _wJRbzj93;
        "pkg-21.1.14+neoforge-1.21.1" = _ACzw14Mo;
        "pkg-21.4.12+fabric-1.21.4" = _ilaMpMwS;
        "pkg-21.4.12+neoforge-1.21.4" = _asReJQMH;
        "pkg-21.1.15+fabric-1.21.1" = _mptcpuV9;
        "pkg-21.4.12+forge-1.21.4" = _lf3sWWrS;
        "pkg-21.1.15+forge-1.21.1" = _RnY7zMrA;
        "pkg-21.1.15+neoforge-1.21.1" = _n0RorROz;
        "pkg-21.5.6+fabric-1.21.5" = _RHbNiMYl;
        "pkg-21.5.6+forge-1.21.5" = _pQZDqn1G;
        "pkg-21.5.6+neoforge-1.21.5" = _7Cfi5t5L;
        "pkg-21.6.1+neoforge-1.21.6" = _EocJUTcP;
        "pkg-21.6.1+fabric-1.21.6" = _gciscwtF;
        "pkg-21.6.2+forge-1.21.6" = _ntenCE01;
        "pkg-21.7.1+forge-1.21.7" = _60cOaYUz;
        "pkg-21.7.1+fabric-1.21.7" = _PuQkyOSt;
        "pkg-21.7.1+neoforge-1.21.7" = _PYqWJDox;
        "pkg-21.1.16+fabric-1.21.1" = _vCuisM4b;
        "pkg-21.1.16+neoforge-1.21.1" = _ViSHFAF9;
        "pkg-21.1.16+forge-1.21.1" = _tKLGPNAd;
        "pkg-21.8.1+forge-1.21.8" = _pqm8qRNh;
        "pkg-21.8.1+neoforge-1.21.8" = _FXEIWqS9;
        "pkg-21.8.1+fabric-1.21.8" = _WhjcZi2v;
        "pkg-21.4.13+fabric-1.21.4" = _r1jRZ5xt;
        "pkg-21.8.2+fabric-1.21.8" = _XxZeD3ln;
        "pkg-21.4.13+forge-1.21.4" = _SKpwnKy4;
        "pkg-21.4.13+neoforge-1.21.4" = _T1Fgy1Mk;
        "pkg-21.8.2+forge-1.21.8" = _NdCfxWuJ;
        "pkg-21.8.2+neoforge-1.21.8" = _sxknAkQK;
        "pkg-21.5.7+fabric-1.21.5" = _gwvdba3a;
        "pkg-21.5.7+forge-1.21.5" = _Su9c7Z8I;
        "pkg-21.1.17+fabric-1.21.1" = _O6E1qlSM;
        "pkg-21.5.7+neoforge-1.21.5" = _UKQQkf7x;
        "pkg-21.1.17+neoforge-1.21.1" = _1jvI3u3e;
        "pkg-16.0.14+fabric-1.20.1" = _12iP7dHh;
        "pkg-16.0.14+forge-1.20.1" = _mYMjjpcD;
        "pkg-21.1.17+forge-1.21.1" = _H421aNPF;
        "pkg-21.8.3+fabric-1.21.8" = _az1U2pjU;
        "pkg-21.8.3+forge-1.21.8" = _nQB4317u;
        "pkg-21.8.3+neoforge-1.21.8" = _BblDnLBh;
        "pkg-21.9.1+neoforge-1.21.9" = _N7kvDORf;
        "pkg-21.9.1+fabric-1.21.9" = _3HVlOf2x;
        "pkg-21.10.1+forge-1.21.10" = _WfjtJEp5;
        "pkg-21.10.1+fabric-1.21.10" = _LuOqU8J9;
        "pkg-21.10.1+neoforge-1.21.10" = _qvODh403;
        "pkg-21.10.2+fabric-1.21.10" = _STMwFWIj;
        "pkg-21.10.2+forge-1.21.10" = _2SZULQyz;
        "pkg-21.10.2+neoforge-1.21.10" = _nRI5Xyqt;
        "pkg-21.11.1+neoforge-1.21.11" = _8e7bkJv1;
        "pkg-16.0.15+fabric-1.20.1" = _jsA2CgIO;
        "pkg-16.0.15+forge-1.20.1" = _W87tG8sG;
        "pkg-21.11.4+fabric-1.21.11" = _v8ZVfOLj;
        "pkg-21.11.4+neoforge-1.21.11" = _78UaH9QM;
        "pkg-21.11.4+forge-1.21.11" = _u8ueilUo;
        "pkg-21.1.18+fabric-1.21.1" = _7SLo8S9f;
        "pkg-21.1.18+neoforge-1.21.1" = _zyP4B8Lj;
        "pkg-21.1.18+forge-1.21.1" = _m4cymRNz;
        "pkg-21.11.5+forge-1.21.11" = _Rl5dYOpZ;
        "pkg-21.11.5+neoforge-1.21.11" = _gnS5osLW;
        "pkg-21.11.5+fabric-1.21.11" = _hHOU1qLN;
        "pkg-21.11.6+forge-1.21.11" = _xCFapP6p;
        "pkg-21.11.6+neoforge-1.21.11" = _vmS7g5mF;
        "pkg-21.11.6+fabric-1.21.11" = _5Ykn1jsb;
        "pkg-26.1.0.1+neoforge-26.1" = _SgTVv8v1;
        "pkg-21.1.19+fabric-1.21.1" = _1f3EhkLL;
        "pkg-21.1.19+forge-1.21.1" = _BsvCDzv3;
        "pkg-21.1.19+neoforge-1.21.1" = _MAn6rKUi;
        "pkg-26.1.1.2+fabric-26.1.1" = _N6xKbNE7;
        "pkg-26.1.1.2+neoforge-26.1.1" = _JwYD2kZ3;
        "pkg-21.1.20+fabric-1.21.1" = _xWU5VmSz;
        "pkg-21.1.20+neoforge-1.21.1" = _cNXZ7WiI;
        "pkg-21.1.20+forge-1.21.1" = _wLG33Gww;
        "pkg-21.1.21+forge-1.21.1" = _cAqAOkV0;
        "pkg-21.1.21+fabric-1.21.1" = _9872tHN3;
        "pkg-21.1.21+neoforge-1.21.1" = _dzMpBcgd;
        "pkg-26.1.2.1+fabric-26.1.2" = _bfvvXKNN;
        "pkg-26.1.2.1+neoforge-26.1.2" = _n1Nj1cWv;
        "pkg-21.1.22+fabric-1.21.1" = _CHDk2KYa;
        "pkg-21.1.22+neoforge-1.21.1" = _i4DoNHKZ;
        "pkg-21.1.22+forge-1.21.1" = _ftSroTUM;
        "pkg-21.1.23+fabric-1.21.1" = _Xy78iIHu;
        "pkg-21.1.23+neoforge-1.21.1" = _qbBLV6CQ;
        "pkg-21.1.23+forge-1.21.1" = _9rwZu4Jp;
        "pkg-26.1.2.2+fabric-26.1.2" = _PrwWgoG2;
        "pkg-26.1.2.2+neoforge-26.1.2" = _cuCvV0ad;
        "pkg-26.2.0.1+fabric-26.2" = _ZSR6R17k;
        "pkg-26.2.0.1+neoforge-26.2" = _rf36qNKy;
        "pkg-21.1.24+fabric-1.21.1" = _tOG59W8V;
        "pkg-21.1.24+neoforge-1.21.1" = _MQCIy6VF;
        "pkg-21.1.24+forge-1.21.1" = _rHaoVibM;
        "pkg-26.2.0.2+fabric-26.2" = _Qx75HADM;
