...
let
    versions = (let
        ...
        _aE0FdeOj = {
            "id" = "aE0FdeOj";
            "file" = "TP-Utils-2.0.0+mc26.2.jar";
            "hash" = "sha512-K/fNZKEyFji68GDzFJTvfc8YrqxdCh2F4TbRAMPKqCOmqu3ituskTUI9s0K9b2ZGmyf6jzigTtrfl+aie1inpw==";
        };
        _ch68fKQj = {
            "id" = "ch68fKQj";
            "file" = "TP-Utils-2.1.0+mc26.3.jar";
            "hash" = "sha512-URw98HNK72+GMSctLVAl5+gAfhrLipOd5YERdTWktksIsHy14jm0h7SfFcoplNzyLq9JWYWDV/UCq2YaFhiUIg==";
        };
    in {
        "BqXCXjL6" = _BqXCXjL6;
        "1n9HQuZF" = _1n9HQuZF;
        ...
        "fabric-26.1" = _aE0FdeOj;
        "fabric-26.1.1" = _aE0FdeOj;
        "fabric-26.1.2" = _aE0FdeOj;
        "fabric-26.2" = _aE0FdeOj;
        "fabric-26.3" = _ch68fKQj;
        ...
        "pkg-1.3.8" = _YXCiQxAk;
        "pkg-1.4.8" = _dGU53fJm;
        "pkg-1.1.10" = _s2WNeBtW;
        "pkg-1.2.10" = _XASKp6oD;
        "pkg-1.3.10" = _eWgFviel;
        "pkg-1.4.10" = _t36B7Z1o;
        "pkg-1.5.11" = _Fu0ehyIC;
        "pkg-1.4.12" = _vKxRkJ1K;
        "pkg-1.5.12" = _SaQXoVtF;
        "pkg-1.6.12-beta" = _wxxzds6B;
        "pkg-1.6.12-beta2" = _hUVagW3V;
        "pkg-1.6.12-beta3" = _dscmBwtl;
        "pkg-1.6.12-beta4" = _3Tik32b1;
        "pkg-1.6.12-beta5" = _nSlovJDw;
        "pkg-1.6.12-beta6" = _BOHcmN1B;
        "pkg-1.6.12" = _9bqEKsMe;
        "pkg-1.6.13" = _vFeoOuGA;
        "pkg-1.6.14-beta" = _hPTRsG6q;
        "pkg-1.6.14" = _T2kqooYx;
        "pkg-1.6.15" = _l5NRQg4w;
        "pkg-1.6.16" = _eO3UQdSS;
        "pkg-1.7.16-beta" = _PzhwU3Kc;
        "pkg-1.7.16" = _5yR0pkof;
        "pkg-1.8.16-beta" = _HloA0Zwp;
        "pkg-1.8.16" = _VzgaiT0n;
        "pkg-1.9.16" = _WRGeL7CK;
        "pkg-1.9.17" = _GVr0LDWv;
        "pkg-1.10.17" = _Q2yHWytN;
        "pkg-1.11.17" = _EkihetOW;
        "pkg-2.0.0" = _aE0FdeOj;
        "pkg-2.1.0" = _ch68fKQj;
        "default" = _ch68fKQj;
    });
