...
let
    versions = (let
        ...
        _aRHFtqoZ = {
            "id" = "aRHFtqoZ";
            "file" = "Lullaby's Mobs v1.6.1 [1.21.5-26.2].zip";
            "hash" = "sha512-qdvgj7/DYbBqTIgv0uSZv2OiGM6FKZhjhHk5inwzwSOD1Ri+NdAs9SRMfTJbpSA0rUpvHsmsjue1ASLrN559hg==";
        };
        _SUjGLSKh = {
            "id" = "SUjGLSKh";
            "file" = "lullaby-mobs-1.6.1.jar";
            "hash" = "sha512-SfXggpSruNMQmtMfpoq054AGZFdo3+xOyBZt5K0ibpt9Pe4CMXUo5nKT9hNcIyg1aC5RfvsPV4ernJW+v5Ygcg==";
        };
        _TkFPbuz5 = {
            "id" = "TkFPbuz5";
            "file" = "Lullaby's Mobs v1.7.0 [1.21.5-26.2].zip";
            "hash" = "sha512-71zR02cWQcSpoKrAaZiqgGFHSVhB6F+AA8F/7DWndWasLqkc+fTfZG1dl2Wxk2TyKF9OXoWpZiei5lF/XUaUog==";
        };
        _ZeL4vWE8 = {
            "id" = "ZeL4vWE8";
            "file" = "lullaby-mobs-1.7.0.jar";
            "hash" = "sha512-x2RxK6X6BHqCKdsdsSankGMvgqPloxZJu8g6YzMm06Tz64KL/0UXr97guM4Auh0omLnamNx7gjEuy7g7tR5JVw==";
        };
    in {
        "o0J734o1" = _o0J734o1;
        "NRzeovud" = _NRzeovud;
        ...
        "datapack-1.21.5" = _TkFPbuz5;
        "datapack-1.21.6" = _TkFPbuz5;
        "datapack-1.21.7" = _TkFPbuz5;
        "datapack-1.21.8" = _TkFPbuz5;
        "datapack-1.21.9" = _TkFPbuz5;
        "datapack-1.21.10" = _TkFPbuz5;
        "datapack-1.21.11" = _TkFPbuz5;
        "datapack-26.1" = _TkFPbuz5;
        "datapack-26.1.1" = _TkFPbuz5;
        "datapack-26.1.2" = _TkFPbuz5;
        "datapack-26.2" = _TkFPbuz5;
        "fabric-1.21.4" = _UQzV0s2f;
        "fabric-1.21.2" = _UQzV0s2f;
        "fabric-1.21.3" = _UQzV0s2f;
        "fabric-1.21.5" = _ZeL4vWE8;
        "fabric-1.21.6" = _ZeL4vWE8;
        "fabric-1.21.7" = _ZeL4vWE8;
        "fabric-1.21.8" = _ZeL4vWE8;
        "fabric-1.21.9" = _ZeL4vWE8;
        "fabric-1.21.10" = _ZeL4vWE8;
        "fabric-1.21.11" = _ZeL4vWE8;
        "fabric-26.1" = _ZeL4vWE8;
        "fabric-26.1.1" = _ZeL4vWE8;
        "fabric-26.1.2" = _ZeL4vWE8;
        "fabric-26.2" = _ZeL4vWE8;
        "forge-1.21.4" = _UQzV0s2f;
        "forge-1.21.2" = _UQzV0s2f;
        "forge-1.21.3" = _UQzV0s2f;
        "forge-1.21.5" = _ZeL4vWE8;
        "forge-1.21.6" = _ZeL4vWE8;
        "forge-1.21.7" = _ZeL4vWE8;
        "forge-1.21.8" = _ZeL4vWE8;
        "forge-1.21.9" = _ZeL4vWE8;
        "forge-1.21.10" = _ZeL4vWE8;
        "forge-1.21.11" = _ZeL4vWE8;
        "forge-26.1" = _ZeL4vWE8;
        "forge-26.1.1" = _ZeL4vWE8;
        "forge-26.1.2" = _ZeL4vWE8;
        "forge-26.2" = _ZeL4vWE8;
        "neoforge-1.21.4" = _UQzV0s2f;
        "neoforge-1.21.2" = _UQzV0s2f;
        "neoforge-1.21.3" = _UQzV0s2f;
        "neoforge-1.21.5" = _ZeL4vWE8;
        "neoforge-1.21.6" = _ZeL4vWE8;
        "neoforge-1.21.7" = _ZeL4vWE8;
        "neoforge-1.21.8" = _ZeL4vWE8;
        "neoforge-1.21.9" = _ZeL4vWE8;
        "neoforge-1.21.10" = _ZeL4vWE8;
        "neoforge-1.21.11" = _ZeL4vWE8;
        "neoforge-26.1" = _ZeL4vWE8;
        "neoforge-26.1.1" = _ZeL4vWE8;
        "neoforge-26.1.2" = _ZeL4vWE8;
        "neoforge-26.2" = _ZeL4vWE8;
        "quilt-1.21.4" = _UQzV0s2f;
        "quilt-1.21.2" = _UQzV0s2f;
        "quilt-1.21.3" = _UQzV0s2f;
        "quilt-1.21.5" = _ZeL4vWE8;
        "quilt-1.21.6" = _ZeL4vWE8;
        "quilt-1.21.7" = _ZeL4vWE8;
        "quilt-1.21.8" = _ZeL4vWE8;
        "quilt-1.21.9" = _ZeL4vWE8;
        "quilt-1.21.10" = _ZeL4vWE8;
        "quilt-1.21.11" = _ZeL4vWE8;
        "quilt-26.1" = _ZeL4vWE8;
        "quilt-26.1.1" = _ZeL4vWE8;
        "quilt-26.1.2" = _ZeL4vWE8;
        "quilt-26.2" = _ZeL4vWE8;
        "pkg-v1.0.0" = _o0J734o1;
        "pkg-v1.1.0" = _NRzeovud;
        "pkg-v1.2.0" = _rPtWDYot;
        "pkg-v1.2.1" = _JWOJfYTJ;
        "pkg-v1.2.1+mod" = _NAnQXJ8C;
        "pkg-v1.3.0" = _ZwXtLIgF;
        "pkg-v1.3.0+mod" = _xQiN8NZO;
        "pkg-v1.6.0" = _BkZGcHrb;
        "pkg-v1.6.0+mod" = _HdETsp6M;
        "pkg-1.6.1" = _aRHFtqoZ;
