...
let
    versions = (let
        ...
        _RvfqP9Zb = {
            "id" = "RvfqP9Zb";
            "file" = "MoogsTemplesReimagined-universal-1.21-2.0.4.jar";
            "hash" = "sha512-9FjkgRn21xZUjpW5axJJQG5TVH6qG2q57D8+aJmmAyNFD64pgJ/qUkRpEawqdN4Zdzb4aat2qLJLX7uCTpqBcQ==";
        };
    in {
        "ibxhnh1a" = _ibxhnh1a;
        "mjaIQ7M0" = _mjaIQ7M0;
        ...
        "fabric-1.21.5" = _RvfqP9Zb;
        "fabric-1.21.6" = _RvfqP9Zb;
        "fabric-1.21.7" = _RvfqP9Zb;
        "fabric-1.21.8" = _RvfqP9Zb;
        "fabric-1.21.9" = _RvfqP9Zb;
        "fabric-1.21.10" = _RvfqP9Zb;
        "fabric-1.21" = _RvfqP9Zb;
        "fabric-1.21.1" = _RvfqP9Zb;
        "fabric-1.21.2" = _RvfqP9Zb;
        "fabric-1.21.3" = _RvfqP9Zb;
        "fabric-1.21.4" = _RvfqP9Zb;
        "fabric-1.21.11" = _RvfqP9Zb;
        "fabric-26.1" = _RvfqP9Zb;
        "fabric-26.1.1" = _RvfqP9Zb;
        "fabric-26.1.2" = _RvfqP9Zb;
        "fabric-26.2" = _RvfqP9Zb;
        "fabric-26.3" = _RvfqP9Zb;
        ...
        "forge-1.21.5" = _RvfqP9Zb;
        "forge-1.21.6" = _RvfqP9Zb;
        "forge-1.21.7" = _RvfqP9Zb;
        "forge-1.21.8" = _RvfqP9Zb;
        "forge-1.21.9" = _RvfqP9Zb;
        "forge-1.21.10" = _RvfqP9Zb;
        "forge-1.21" = _RvfqP9Zb;
        "forge-1.21.1" = _RvfqP9Zb;
        "forge-1.21.2" = _RvfqP9Zb;
        "forge-1.21.3" = _RvfqP9Zb;
        "forge-1.21.4" = _RvfqP9Zb;
        "forge-1.21.11" = _RvfqP9Zb;
        "forge-26.1" = _RvfqP9Zb;
        "forge-26.1.1" = _RvfqP9Zb;
        "forge-26.1.2" = _RvfqP9Zb;
        "forge-26.2" = _RvfqP9Zb;
        "forge-26.3" = _RvfqP9Zb;
        ...
        "neoforge-1.21.5" = _RvfqP9Zb;
        "neoforge-1.21.6" = _RvfqP9Zb;
        "neoforge-1.21.7" = _RvfqP9Zb;
        "neoforge-1.21.8" = _RvfqP9Zb;
        "neoforge-1.21.9" = _RvfqP9Zb;
        "neoforge-1.21.10" = _RvfqP9Zb;
        "neoforge-1.21" = _RvfqP9Zb;
        "neoforge-1.21.1" = _RvfqP9Zb;
        "neoforge-1.21.2" = _RvfqP9Zb;
        "neoforge-1.21.3" = _RvfqP9Zb;
        "neoforge-1.21.4" = _RvfqP9Zb;
        "neoforge-1.21.11" = _RvfqP9Zb;
        "neoforge-26.1" = _RvfqP9Zb;
        "neoforge-26.1.1" = _RvfqP9Zb;
        "neoforge-26.1.2" = _RvfqP9Zb;
        "neoforge-26.2" = _RvfqP9Zb;
        "neoforge-26.3" = _RvfqP9Zb;
