...
let
    ...
    in {
        ...
        "db8JhmmV" = _db8JhmmV;
        "IDRaVLEy" = _IDRaVLEy;
        "fabric-1.20" = _r7k3kkNC;
        "fabric-1.20.1" = _r7k3kkNC;
        "fabric-1.18.2" = _r7k3kkNC;
        "fabric-1.19.4" = _r7k3kkNC;
        "fabric-1.20.4" = _r7k3kkNC;
        "fabric-1.20.6" = _r7k3kkNC;
        "fabric-1.21" = _r7k3kkNC;
        "fabric-1.20.2" = _r7k3kkNC;
        "fabric-1.20.3" = _r7k3kkNC;
        "fabric-1.20.5" = _r7k3kkNC;
        "fabric-1.21.1" = _r7k3kkNC;
        "fabric-1.21.2" = _r7k3kkNC;
        "fabric-1.21.3" = _r7k3kkNC;
        "fabric-1.21.4" = _r7k3kkNC;
        "fabric-1.21.5" = _r7k3kkNC;
        "fabric-1.17" = _r7k3kkNC;
        "fabric-1.17.1" = _r7k3kkNC;
        "fabric-1.18" = _r7k3kkNC;
        "fabric-1.18.1" = _r7k3kkNC;
        "fabric-1.19" = _r7k3kkNC;
        "fabric-1.19.1" = _r7k3kkNC;
        "fabric-1.19.2" = _r7k3kkNC;
        "fabric-1.19.3" = _r7k3kkNC;
        "fabric-1.21.6" = _r7k3kkNC;
        "fabric-1.21.7" = _r7k3kkNC;
        "fabric-1.21.8" = _r7k3kkNC;
        "fabric-1.21.9" = _H1HUp8v5;
        "fabric-1.21.10" = _H1HUp8v5;
        "fabric-1.21.11" = _H1HUp8v5;
        "fabric-26.1-snapshot-11" = _lzYtwTLb;
        "fabric-26.1" = _db8JhmmV;
        "fabric-26.1.1" = _db8JhmmV;
        "fabric-26.2-snapshot-1" = _5RupnXil;
        "fabric-26.1.2" = _db8JhmmV;
        "fabric-26.2-snapshot-2" = _Ae6CEh2l;
        "fabric-26.2-snapshot-3" = _Ae6CEh2l;
        "fabric-26.2" = _db8JhmmV;
        ...
        "forge-1.20" = _wyjkNzzu;
        "forge-1.20.1" = _wyjkNzzu;
        "forge-1.18.2" = _wyjkNzzu;
        "forge-1.19.4" = _wyjkNzzu;
        "forge-1.16.5" = _nq23Cx5H;
        "forge-1.20.2" = _wyjkNzzu;
        "forge-1.20.3" = _wyjkNzzu;
        "forge-1.20.4" = _wyjkNzzu;
        "forge-1.17" = _wyjkNzzu;
        "forge-1.17.1" = _wyjkNzzu;
        "forge-1.18" = _wyjkNzzu;
        "forge-1.18.1" = _wyjkNzzu;
        "forge-1.19" = _wyjkNzzu;
        "forge-1.19.1" = _wyjkNzzu;
        "forge-1.19.2" = _wyjkNzzu;
        "forge-1.19.3" = _wyjkNzzu;
        "neoforge-1.20.6" = _I1yKY90z;
        "neoforge-1.21" = _I1yKY90z;
        "neoforge-1.21.1" = _I1yKY90z;
        "neoforge-1.21.2" = _I1yKY90z;
        "neoforge-1.21.3" = _I1yKY90z;
        "neoforge-1.21.4" = _I1yKY90z;
        "neoforge-1.21.5" = _I1yKY90z;
        "neoforge-1.21.6" = _I1yKY90z;
        "neoforge-1.21.7" = _I1yKY90z;
        "neoforge-1.21.8" = _I1yKY90z;
        "neoforge-1.21.9" = _mBZzAJ00;
        "neoforge-1.21.10" = _mBZzAJ00;
        "neoforge-1.21.11" = _mBZzAJ00;
        "neoforge-26.1" = _IDRaVLEy;
        "neoforge-26.1.1" = _IDRaVLEy;
        "neoforge-26.2-snapshot-1" = _TOp0vTRK;
        "neoforge-26.1.2" = _IDRaVLEy;
        "neoforge-26.2-snapshot-2" = _H9kBCSHN;
        "neoforge-26.2-snapshot-3" = _H9kBCSHN;
        "neoforge-26.2" = _IDRaVLEy;
        "pkg-3.1.2" = _E5Z3dhh2;
