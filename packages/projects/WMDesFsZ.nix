...
let
    versions = (let
        ...
        _BO7fgnmM = {
            "id" = "BO7fgnmM";
            "file" = "IMBlocker-7.2.1-fabric-26.1+.jar";
            "hash" = "sha512-fxpbJG6zdByXfd8twR/UOcrg9OzYMgDrlralt9JsuRvljhqcgWvEGocalr4SKt1vNvaYQjIlwgrhcPR1ATcfAw==";
        };
        _JHAcp8qU = {
            "id" = "JHAcp8qU";
            "file" = "IMBlocker-7.2.1-neoforge-26.1+.jar";
            "hash" = "sha512-2em5cq22yIApMY/ST0BYfUJRFS5mPvcpq9AjhdXcAzSIheW5WoJrSk/XxSCincr5PYexQFY3VL3IL3D2i3bsXg==";
        };
        _nq23Cx5H = {
            "id" = "nq23Cx5H";
            "file" = "IMBlocker-5.6.0-forge+1.16.5.jar";
            "hash" = "sha512-f3QGrV40j2JU0zgDIlErIix6QQNMzJu431jmeb57ep/UpBRK7x+DRbmcVo3nZOwC/jQYwFmaW6R50PG+YX1BoQ==";
        };
        _wyjkNzzu = {
            "id" = "wyjkNzzu";
            "file" = "IMBlocker-5.6.0-forge+1.17-1.20.4.jar";
            "hash" = "sha512-WvIbg5ZYKPkkGy2/uHQ5z96GpPKhWdkW1uuCsUZR6K0V/ygMPtZFgkyHH4LQetzgi5cLo5xaFo7OkqBNoPOONQ==";
        };
        _r7k3kkNC = {
            "id" = "r7k3kkNC";
            "file" = "IMBlocker-5.6.0-fabric+1.17-1.21.8.jar";
            "hash" = "sha512-1iiO+hWt+bS0sAchNc9rneMGy0r0kBXanCdaHrEmMaYkbCMrCDcAKAFCOL8+WNCXObHJ0E5ARKhtHasKOJgduA==";
        };
        _I1yKY90z = {
            "id" = "I1yKY90z";
            "file" = "IMBlocker-5.6.0-neoforge+1.20.6-1.21.8.jar";
            "hash" = "sha512-eMZxbiP8fzpCI0xjDSnjWhLE4lwthCEANhOeEvPxAG6oE0e2UeOLPV/jDctALDWN1H6f7O0hUCbl+gpKe36ZWQ==";
        };
        _H1HUp8v5 = {
            "id" = "H1HUp8v5";
            "file" = "IMBlocker-6.2.0-fabric+1.21.9-1.21.11.jar";
            "hash" = "sha512-rVRDs1M20n8x2hDhiDjOZ80BtdTaRi69EpvJoteogsg5peyq8foCWJyYNYCFt/1cOjO/XT+G5t2xJ40y/6AEXw==";
        };
        _mBZzAJ00 = {
            "id" = "mBZzAJ00";
            "file" = "IMBlocker-6.2.0-neoforge+1.21.9-1.21.11.jar";
            "hash" = "sha512-uNB1lNC+AF1pZ1gwWGqN3e9ILmhDa6QIkxMfOux6qcxC9Ahgra8WYOgIrSMUscFLW+vPf442dQ9zq6+AuZVqSg==";
        };
        _db8JhmmV = {
            "id" = "db8JhmmV";
            "file" = "IMBlocker-7.3.0-fabric-26.1+.jar";
            "hash" = "sha512-O7QLfnbGE6i45lo3cht7dAtfwPlRv3/icHOy6GC5HPuVqRrbH12G9/+0PRxtzu/oEcXgyA8VvElMhEvGtA4fsA==";
        };
        _IDRaVLEy = {
            "id" = "IDRaVLEy";
            "file" = "IMBlocker-7.3.0-neoforge-26.1+.jar";
            "hash" = "sha512-LGHbeC7JCaMLRxIcR+LQRpy8VaHfjzYmWTCz1q8l9lyXrxoRQCMxnPMsysmhd9WK0OYayF+w+MAWO0pkA+ylWg==";
        };
        _pbiOmCwL = {
            "id" = "pbiOmCwL";
            "file" = "IMBlocker-6.2.1-fabric+1.21.9-1.21.11.jar";
            "hash" = "sha512-63ngMe4X+cwTyTbMlZE9qFf/w/HZ5nG3oB7fPcLoIpMGOELvuy4HVET7Ogrg74XwS4+Xe+vPr7zra39tevzGuw==";
        };
        _PlM3eTfA = {
            "id" = "PlM3eTfA";
            "file" = "IMBlocker-6.2.1-neoforge+1.21.9-1.21.11.jar";
            "hash" = "sha512-acLBwiC91WbBc+HWkT4b7NFVTKcfUla8hCgnYWRkfS7KdmNhXKkIoKeIelGY4FV/F+ZZAVuWFngt6EWkVH/hLg==";
        };
        _IimTHoq3 = {
            "id" = "IimTHoq3";
            "file" = "IMBlocker-5.6.1-forge+1.16.5.jar";
            "hash" = "sha512-snFtmnrf40lT9wqf+D8McOKdiKs0PTXXsfaBSRds8oPk3iCMwjc+l9uVSx06UKdIRbLrSIBAW4GtLHtQyTBEfg==";
        };
        _hXYtiMlY = {
            "id" = "hXYtiMlY";
            "file" = "IMBlocker-5.6.1-forge+1.17-1.20.4.jar";
            "hash" = "sha512-0hc6unrHz2/WdcVMtif8uQpxki5S8t2I1numLgE3lrgIb1ARfWypkbQMgtM4DoSxkkF9BHSkfoEkh8XjQVNCGQ==";
        };
        _J8ZeiG9x = {
            "id" = "J8ZeiG9x";
            "file" = "IMBlocker-5.6.1-fabric+1.17-1.21.8.jar";
            "hash" = "sha512-zK6C+E1B2Mb9+YuCZim4SbuNaLAxxvXJSlkGIfh3LtWuQDfSbtFVFf8RzTkmwcuYw3mUUekV1Byp7ijqMqNWxw==";
        };
        _JCFs4e8D = {
            "id" = "JCFs4e8D";
            "file" = "IMBlocker-5.6.1-neoforge+1.20.6-1.21.8.jar";
            "hash" = "sha512-H5xk1E+H0TOnUYLLRWXDQM9okUmMfQSxF7K1h0GE0oLIpiATBehpjhnmTY75pF1xSEYxwDBfbS3uGd4P1m+hSg==";
        };
        _FE6q4GBN = {
            "id" = "FE6q4GBN";
            "file" = "IMBlocker-6.2.2-fabric+1.21.9-1.21.11.jar";
            "hash" = "sha512-8G5+UszzmDB68UX890QAV6zNIN9SpXwNECafFkgXCgsL01vI+ZmBPsyoHVdWiOcYNoBiNXj/FlQQQbblQSeG4Q==";
        };
        _MmNj9XMx = {
            "id" = "MmNj9XMx";
            "file" = "IMBlocker-6.2.2-neoforge+1.21.9-1.21.11.jar";
            "hash" = "sha512-mQOeGg5x4EtUE+PrynMHY0nRrR0XZbxR6j06/VIFgt/MvjwuzH3OLoDCCh2PtWuPWhchOSl8YjOfN8h+OaGYAA==";
        };
        _ewAruo2L = {
            "id" = "ewAruo2L";
            "file" = "IMBlocker-7.3.1-fabric-26.1+.jar";
            "hash" = "sha512-/xzJcy73bUuKhuYVJrOijKLAh3/ozw3jxzYSKEGk40oAnKUHBzr7oZ2bX8VCL48MkKCZkmqxxsqTuU7GD+2Jbg==";
        };
        _Nx836GWF = {
            "id" = "Nx836GWF";
            "file" = "IMBlocker-7.3.1-neoforge-26.1+.jar";
            "hash" = "sha512-fCAadWPHSKxJnoX3QqYtj6g0m9xG/ge2ZBXMCiCgfDgbSqfUXaGw5GYbKSMXywgb64bXCCRCrUR1nzY/yWuoPw==";
        };
        _FHqjI6JX = {
            "id" = "FHqjI6JX";
            "file" = "IMBlocker-5.6.1.1-forge+1.16.5.jar";
            "hash" = "sha512-4TXG2gZDhRzSLfFa6EMsvhDIhRzIdNjo6+OXWiaY3x/HbUeq33pw5zUQwLBRzCRD3g/X5u6d8/Am0nE6BEPbSA==";
        };
    in {
        "E5Z3dhh2" = _E5Z3dhh2;
        "dPxGhD8g" = _dPxGhD8g;
        ...
        "Nx836GWF" = _Nx836GWF;
        "FHqjI6JX" = _FHqjI6JX;
        "fabric-1.20" = _J8ZeiG9x;
        "fabric-1.20.1" = _J8ZeiG9x;
        "fabric-1.18.2" = _J8ZeiG9x;
        "fabric-1.19.4" = _J8ZeiG9x;
        "fabric-1.20.4" = _J8ZeiG9x;
        "fabric-1.20.6" = _J8ZeiG9x;
        "fabric-1.21" = _J8ZeiG9x;
        "fabric-1.20.2" = _J8ZeiG9x;
        "fabric-1.20.3" = _J8ZeiG9x;
        "fabric-1.20.5" = _J8ZeiG9x;
        "fabric-1.21.1" = _J8ZeiG9x;
        "fabric-1.21.2" = _J8ZeiG9x;
        "fabric-1.21.3" = _J8ZeiG9x;
        "fabric-1.21.4" = _J8ZeiG9x;
        "fabric-1.21.5" = _J8ZeiG9x;
        "fabric-1.17" = _J8ZeiG9x;
        "fabric-1.17.1" = _J8ZeiG9x;
        "fabric-1.18" = _J8ZeiG9x;
        "fabric-1.18.1" = _J8ZeiG9x;
        "fabric-1.19" = _J8ZeiG9x;
        "fabric-1.19.1" = _J8ZeiG9x;
        "fabric-1.19.2" = _J8ZeiG9x;
        "fabric-1.19.3" = _J8ZeiG9x;
        "fabric-1.21.6" = _J8ZeiG9x;
        "fabric-1.21.7" = _J8ZeiG9x;
        "fabric-1.21.8" = _J8ZeiG9x;
        "fabric-1.21.9" = _FE6q4GBN;
        "fabric-1.21.10" = _FE6q4GBN;
        "fabric-1.21.11" = _FE6q4GBN;
        "fabric-26.1-snapshot-11" = _lzYtwTLb;
        "fabric-26.1" = _ewAruo2L;
        "fabric-26.1.1" = _ewAruo2L;
        "fabric-26.2-snapshot-1" = _5RupnXil;
        "fabric-26.1.2" = _ewAruo2L;
        "fabric-26.2-snapshot-2" = _Ae6CEh2l;
        "fabric-26.2-snapshot-3" = _Ae6CEh2l;
        "fabric-26.2" = _ewAruo2L;
        "fabric-26.3-snapshot-6" = _db8JhmmV;
        "fabric-26.3-snapshot-7" = _db8JhmmV;
        "fabric-26.3-snapshot-8" = _db8JhmmV;
        "fabric-26.3-snapshot-9" = _db8JhmmV;
        "fabric-26.3-snapshot-10" = _db8JhmmV;
        "fabric-26.3-pre-1" = _db8JhmmV;
        "fabric-26.3-snapshot-4" = _db8JhmmV;
        "fabric-26.3-snapshot-5" = _db8JhmmV;
        "fabric-26.3-pre-2" = _db8JhmmV;
        "fabric-26.3" = _ewAruo2L;
        "forge-1.20" = _hXYtiMlY;
        "forge-1.20.1" = _hXYtiMlY;
        "forge-1.18.2" = _hXYtiMlY;
        "forge-1.19.4" = _hXYtiMlY;
        "forge-1.16.5" = _FHqjI6JX;
        "forge-1.20.2" = _hXYtiMlY;
        "forge-1.20.3" = _hXYtiMlY;
        "forge-1.20.4" = _hXYtiMlY;
        "forge-1.17" = _hXYtiMlY;
        "forge-1.17.1" = _hXYtiMlY;
        "forge-1.18" = _hXYtiMlY;
        "forge-1.18.1" = _hXYtiMlY;
        "forge-1.19" = _hXYtiMlY;
        "forge-1.19.1" = _hXYtiMlY;
        "forge-1.19.2" = _hXYtiMlY;
        "forge-1.19.3" = _hXYtiMlY;
        "neoforge-1.20.6" = _JCFs4e8D;
        "neoforge-1.21" = _JCFs4e8D;
        "neoforge-1.21.1" = _JCFs4e8D;
        "neoforge-1.21.2" = _JCFs4e8D;
        "neoforge-1.21.3" = _JCFs4e8D;
        "neoforge-1.21.4" = _JCFs4e8D;
        "neoforge-1.21.5" = _JCFs4e8D;
        "neoforge-1.21.6" = _JCFs4e8D;
        "neoforge-1.21.7" = _JCFs4e8D;
        "neoforge-1.21.8" = _JCFs4e8D;
        "neoforge-1.21.9" = _MmNj9XMx;
        "neoforge-1.21.10" = _MmNj9XMx;
        "neoforge-1.21.11" = _MmNj9XMx;
        "neoforge-26.1" = _Nx836GWF;
        "neoforge-26.1.1" = _Nx836GWF;
        "neoforge-26.2-snapshot-1" = _TOp0vTRK;
        "neoforge-26.1.2" = _Nx836GWF;
        "neoforge-26.2-snapshot-2" = _H9kBCSHN;
        "neoforge-26.2-snapshot-3" = _H9kBCSHN;
        "neoforge-26.2" = _Nx836GWF;
        "pkg-3.1.2" = _E5Z3dhh2;
        "pkg-v4.0.0-alpha5-mc1.20" = _dPxGhD8g;
        "pkg-4.0.0-alpha20230701" = _TEUfTjU1;
        "pkg-4.0.0-alpha20230706" = _K6cO1Fif;
        "pkg-4.0.0-alpha20230714" = _N0CbmHlO;
        "pkg-4.0.4" = _ltIVozF9;
        "pkg-4.0.5" = _i9bOalx4;
        "pkg-3.1.2+patch4.0.5" = _KLU2dkdX;
        "pkg-4.0.9b+1.19.4" = _a0Kb0Vgl;
        "pkg-4.0.9b+1.20.4" = _MVSZCzcN;
        "pkg-4.0.9b+1.20.6" = _iNy1TlJw;
        "pkg-4.0.9b+1.21" = _tQ3YnhO7;
        "pkg-5.0.0" = _XSo6oYiJ;
        "pkg-5.0.1" = _5NQslNuv;
        "pkg-5.0.1-1.19.4" = _UljaVSlV;
        "pkg-5.0.2-1.19.4" = _tTgdJ7Yw;
        "pkg-5.0.2" = _SPkBxmxk;
        "pkg-5.1.0" = _Ydf6ucp3;
        "pkg-5.1.0.1" = _5fSauIL7;
        "pkg-5.1.1" = _gvY4yPlz;
        "pkg-5.1.2" = _tjdSxuxu;
        "pkg-5.2.0" = _h0XF1IVY;
        "pkg-5.2.1" = _5X1Q1g2u;
        ...
        "pkg-5.3.1" = _CIdH0JQr;
        "pkg-5.4.0" = _CouZoFOg;
        "pkg-5.4.0.1" = _5HsANX1d;
        "pkg-5.4.1" = _Vv4iC4YR;
        "pkg-5.4.1.1" = _BZem119r;
        "pkg-5.4.2" = _Q7qm7EAo;
        "pkg-5.4.3" = _6oemKCRE;
        "pkg-5.4.3.1" = _t2AEozEw;
        "pkg-5.4.4" = _9Uqp1wNi;
        "pkg-6.0.0" = _pzWU66mJ;
        "pkg-5.4.5" = _P0eejgIE;
        "pkg-5.4.6" = _pgUHk6AD;
        "pkg-6.0.1" = _yJ9VCXRX;
        "pkg-5.4.6.1" = _FGYhLbmY;
        "pkg-6.0.2" = _YiovKGcK;
        "pkg-6.0.3" = _j55gjy9S;
        "pkg-7.0.0-alpha.1" = _lzYtwTLb;
        "pkg-7.0.0-beta.1" = _WTgnin9e;
        "pkg-7.0.0-beta.2" = _LxViwxkG;
        "pkg-6.0.4" = _NaNVOqNC;
        "pkg-7.0.0-beta.3" = _f7DPrNRZ;
        "pkg-6.1.0" = _dH4Iejf6;
        "pkg-7.0.0" = _5RupnXil;
        "pkg-5.5.0" = _4ywy41Dt;
        "pkg-7.0.1" = _eEdOZgQa;
