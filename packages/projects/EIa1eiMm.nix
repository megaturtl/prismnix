...
let
    ...
    in {
        ...
        "pkg-3.3.1" = _jPwWqTA4;
        "pkg-3.4.0" = _WYf1O6E6;
        "pkg-4.0.0-beta.1-fabric" = _rMEUzqcb;
        "pkg-4.0.0-beta.1-neoforge" = _Ib63JKJ7;
        "pkg-3.4.1" = _jPiQnJVA;
        "pkg-4.0.0-beta.2-fabric" = _UwNo74f0;
        "pkg-4.0.0-beta.2-neoforge" = _7iZ18zuB;
        "pkg-4.0.0-fabric" = _Aymjs2iN;
        "pkg-4.0.0-neoforge" = _jDjIPlDS;
        "pkg-3.4.2" = _PD6Nlt01;
        "pkg-5.0.0-fabric" = _RkAlGPsT;
        "pkg-5.0.0-neoforge" = _2bxlhxPx;
        "pkg-5.0.1-fabric" = _yFDGAR6C;
        "pkg-5.0.1-neoforge" = _C2dMuQTP;
        "pkg-6.0.0-fabric" = _LpF3DIUM;
        "pkg-6.0.0-neoforge" = _NVyxVXZE;
        "pkg-7.0.0-fabric" = _ygm51jhU;
