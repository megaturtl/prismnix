...
let
    ...
    in {
        ...
        "pkg-1.19.3-2.4.0-beta4" = _ZK8o3a2U;
        "pkg-1.18.2-2.4.0-beta4-fabric" = _lAPu4ru4;
        "pkg-1.19.1-2.4.0-beta4-fabric" = _keUlPD9b;
        "pkg-1.19.3-2.4.0-beta4-fabric" = _wUeNaXeN;
        "pkg-1.16.5-2.4.0" = _7PVviBbd;
        "pkg-1.18.2-2.4.0" = _ldVAZvjK;
        "pkg-1.19.1-2.4.0" = _rNrzhzkT;
        "pkg-1.19.3-2.4.0" = _BCYHAcKo;
        "pkg-1.18.2-2.4.0-fabric" = _J3irl3ij;
        "pkg-1.19.1-2.4.0-fabric" = _rWohuFcn;
        "pkg-1.19.3-2.4.0-fabric" = _3HfbjXDF;
        "pkg-1.18.2-2.5.0-beta1" = _DObyPIre;
        "pkg-1.19.2-2.5.0-beta1" = _z48tbXCm;
        "pkg-1.19.3-2.5.0-beta1" = _XVIfiFok;
        "pkg-1.19.4-2.5.0-beta1" = _56meGKn6;
        "pkg-1.18.2-2.5.0-beta1-fabric" = _pUOnsh64;
        "pkg-1.19.2-2.5.0-beta1-fabric" = _sJ7MuRgW;
        "pkg-1.19.3-2.5.0-beta1-fabric" = _XqbvChxC;
        "pkg-1.19.4-2.5.0-beta1-fabric" = _FlePzaz6;
        "pkg-1.18.2-2.5.0-beta2" = _TJuGeNoQ;
        "pkg-1.19.2-2.5.0-beta2" = _ydfcCiDx;
        "pkg-1.19.3-2.5.0-beta2" = _FEzCLeFV;
        "pkg-1.19.4-2.5.0-beta2" = _QaCraj97;
        "pkg-1.18.2-2.5.0-beta2-fabric" = _Mh0ebN0p;
        "pkg-1.19.2-2.5.0-beta2-fabric" = _JePjVmE5;
        "pkg-1.19.3-2.5.0-beta2-fabric" = _b2Nqynfw;
        "pkg-1.19.4-2.5.0-beta2-fabric" = _igLBRv1Q;
        "pkg-1.18.2-2.5.0-beta3" = _YxnU5F6e;
        "pkg-1.19.2-2.5.0-beta3" = _71biCr0a;
        "pkg-1.19.3-2.5.0-beta3" = _NfAxjVJX;
        "pkg-1.19.4-2.5.0-beta3" = _1U072Zqf;
        "pkg-1.18.2-2.5.0-beta3-fabric" = _ZoXzv3se;
        "pkg-1.19.2-2.5.0-beta3-fabric" = _F1c4htAs;
        "pkg-1.19.3-2.5.0-beta3-fabric" = _CESe83zn;
        "pkg-1.19.4-2.5.0-beta3-fabric" = _pYKWYGss;
        "pkg-1.18.2-2.5.0" = _k3a5AxDo;
        "pkg-1.19.2-2.5.0" = _GZ8Cg7K8;
        "pkg-1.19.3-2.5.0" = _rlzGvA2i;
        "pkg-1.19.4-2.5.0" = _LsrZ9tMX;
        "pkg-1.18.2-2.5.0-fabric" = _xAoWAwbh;
        "pkg-1.19.2-2.5.0-fabric" = _gb25twOY;
        "pkg-1.19.3-2.5.0-fabric" = _ji6Al4Yq;
        "pkg-1.19.4-2.5.0-fabric" = _wsVtYhoZ;
        "pkg-1.20.1-2.6.0beta1-forge" = _eTqu0M7i;
        "pkg-1.20.1-2.6.0beta1" = _4WCKLbdT;
        "pkg-1.18.2-2.5.1" = _rcJQa7UF;
        "pkg-1.19.2-2.5.1" = _r3jc56vl;
        "pkg-1.19.3-2.5.1" = _lIv0hDT4;
        "pkg-1.19.4-2.5.1" = _msqGtHiO;
        "pkg-1.18.2-2.5.1-fabric" = _5TEfGssH;
        "pkg-1.19.2-2.5.1-fabric" = _RkFNddW4;
        "pkg-1.19.3-2.5.1-fabric" = _ooee9CBd;
        "pkg-1.19.4-2.5.1-fabric" = _2gnIuBPX;
        "pkg-1.20.1-2.6.0beta2-forge" = _tIxHvhf5;
        "pkg-1.20.1-2.6.0beta2-fabric" = _unH7kJP1;
        "pkg-1.20.1-2.6.0beta3-forge" = _UfswmuV6;
        "pkg-1.20.1-2.6.0beta3-fabric" = _10HsAfFC;
        "pkg-1.20.1-2.6.0-forge" = _tLRVidqu;
        "pkg-1.20.1-2.6.0-fabric" = _HFYbqJyx;
        "pkg-1.20.2-2.6.0beta1-forge" = _H5OyJUb8;
        "pkg-1.20.2-2.6.0beta1-fabric" = _S7jcwnoJ;
        "pkg-1.20.2-2.6.0beta2-forge" = _FQTmNhOd;
        "pkg-1.20.2-2.6.0beta2-fabric" = _TTsEEEFl;
        "pkg-1.20.1-2.6.0p1-forge" = _JBS1TJdd;
        "pkg-1.20.1-2.6.0p1-fabric" = _ZtkXyDPP;
        "pkg-1.20.2-2.6.0-forge" = _i5ImUDBM;
        "pkg-1.20.2-2.6.0-fabric" = _fI5mOzj9;
        "pkg-1.20.4-2.6.0beta1-forge" = _zxHmX9qr;
        "pkg-1.20.4-2.6.0beta1-fabric" = _DwWOOpmC;
        "pkg-1.20.4-2.6.0beta1-neoforge" = _m7ZzEzxr;
        "pkg-1.20.4-2.6.0-forge" = _aK7bnvJM;
        "pkg-1.20.4-2.6.0-fabric" = _SaIS5F4W;
        "pkg-1.20.4-2.6.0-neoforge" = _hSFmWzCY;
        "pkg-1.20.1-2.6.0p2-forge" = _i8mCGwZO;
        "pkg-1.20.1-2.6.0p2-fabric" = _8krtcNxi;
        "pkg-1.20.6-2.6.0beta1-forge" = _JTY4mU55;
        "pkg-1.20.6-2.6.0beta1-fabric" = _Kbg5CTVM;
        "pkg-1.20.6-2.6.0beta1-neoforge" = _juIXB8AT;
        "pkg-1.20.1-2.6.0p3-forge" = _E5FWaZWI;
        "pkg-1.20.1-2.6.0p3-fabric" = _55nta43y;
        "pkg-1.20.1-2.6.0p4-forge" = _WxMAoWX0;
        "pkg-1.20.1-2.6.0p4-fabric" = _dsKFwLG6;
        "pkg-1.21-2.6.0beta1-forge" = _FPfm7WvU;
        "pkg-1.21-2.6.0beta1-fabric" = _TG4lR5zY;
        "pkg-1.21-2.6.0beta1-neoforge" = _TtnKD9rH;
        "pkg-1.21-2.6.0beta2-forge" = _rk3kd7Cw;
        "pkg-1.21-2.6.0beta2-fabric" = _11n0MS4h;
        "pkg-1.21-2.6.0beta2-neoforge" = _wycZNzsO;
        "pkg-1.20.6-2.6.0-forge" = _RuT3I6PS;
        "pkg-1.20.6-2.6.0-fabric" = _4sUOeAQA;
        "pkg-1.20.6-2.6.0-neoforge" = _UMiBSoja;
        "pkg-1.21-2.6.0-forge" = _KOqyJhIn;
        "pkg-1.21-2.6.0-fabric" = _GSkZ3Key;
        "pkg-1.21-2.6.0-neoforge" = _NrFgUAHu;
        "pkg-1.21-2.6.0p1-forge" = _i9IPLoJ8;
        "pkg-1.21-2.6.0p1-neoforge" = _i1WBdeHQ;
        "pkg-1.20.1-2.6.0p5-forge" = _NqJF9pyM;
        "pkg-1.20.1-2.6.0p5-fabric" = _FYFy0x3E;
        "pkg-1.21-2.6.0p2-forge" = _zK3v6cw6;
        "pkg-1.21-2.6.0p2-fabric" = _eiF2nJGw;
        "pkg-1.21-2.6.0p2-neoforge" = _LsJUO0Am;
        "pkg-1.21.1-2.7.0-beta.1-forge" = _Fdrbgjm3;
        "pkg-1.21.1-2.7.0-beta.1-fabric" = _wnSf6K7V;
        "pkg-1.21.1-2.7.0-beta.1-neoforge" = _OOQOUjIa;
        "pkg-1.21.1-2.7.0-beta.3-forge" = _jhONfWBZ;
        "pkg-1.21.1-2.7.0-beta.3-fabric" = _CBXoXFRB;
        "pkg-1.21.1-2.7.0-beta.3-neoforge" = _sXF4n0RW;
        "pkg-1.21.4-2.7.0-beta.3-forge" = _iwalVtG9;
        "pkg-1.21.4-2.7.0-beta.3-fabric" = _G2aIwFE0;
        "pkg-1.21.4-2.7.0-beta.3-neoforge" = _oETYR7gj;
        "pkg-1.21.1-2.7.0-beta.5-forge" = _85ySFV6q;
        "pkg-1.21.1-2.7.0-beta.5-fabric" = _7Us7EIqr;
        "pkg-1.21.1-2.7.0-beta.5-neoforge" = _v9WQ8xun;
        "pkg-1.21.4-2.7.0-beta.5-forge" = _OCGRAfBP;
        "pkg-1.21.4-2.7.0-beta.5-fabric" = _dEndqZlM;
        "pkg-1.21.4-2.7.0-beta.5-neoforge" = _MyUoTw4V;
        "pkg-1.20.1-2.6.0p6-forge" = _7xzghvJI;
        "pkg-1.20.1-2.6.0p6-fabric" = _FpshA80V;
        "pkg-1.21.1-2.7.0-beta.6-fabric" = _5GVgOprA;
        "pkg-1.21.1-2.7.0-beta.6-forge" = _H7N6zDd4;
        "pkg-1.21.1-2.7.0-beta.6-neoforge" = _GeLVog0v;
        "pkg-1.21.4-2.7.0-beta.6-fabric" = _G0w0svt1;
        "pkg-1.21.4-2.7.0-beta.6-forge" = _62AYOolp;
        "pkg-1.21.4-2.7.0-beta.6-neoforge" = _sgUhXh7x;
        "pkg-1.21.1-2.7.0-beta.7-fabric" = _Im2dIqNv;
        "pkg-1.21.1-2.7.0-beta.7-forge" = _9J2It8IH;
        "pkg-1.21.1-2.7.0-beta.7-neoforge" = _9kpAVNoU;
        "pkg-1.21.4-2.7.0-beta.7-fabric" = _vnOTHapU;
        "pkg-1.21.4-2.7.0-beta.7-forge" = _A9v7GYlr;
        "pkg-1.21.4-2.7.0-beta.7-neoforge" = _uD76yg55;
        "pkg-1.21.5-2.7.0-beta.7-fabric" = _AzMvsaGo;
        "pkg-1.21.5-2.7.0-beta.7-forge" = _NfIgxUaV;
        "pkg-1.21.5-2.7.0-beta.7-neoforge" = _s3zMw1tX;
        "pkg-1.21.5-2.7.0-beta.8-fabric" = _RNkJTJiH;
        "pkg-1.21.5-2.7.0-beta.8-forge" = _l4S1vghO;
        "pkg-1.21.5-2.7.0-beta.8-neoforge" = _YKBraRuv;
        "pkg-1.21.4-2.7.0-beta.8-fabric" = _SnoTVyos;
        "pkg-1.21.4-2.7.0-beta.8-forge" = _WcVCVMYB;
        "pkg-1.21.4-2.7.0-beta.8-neoforge" = _a2CbNbuI;
        "pkg-1.21.1-2.7.0-beta.8-forge" = _1rfRUo9u;
        "pkg-1.21.1-2.7.0-beta.8-fabric" = _iuZ3qIeZ;
        "pkg-1.21.1-2.7.0-beta.8-neoforge" = _cTQekBJw;
        "pkg-1.21.5-2.7.0-beta.9-fabric" = _GW5kgQcL;
        "pkg-1.21.5-2.7.0-beta.9-forge" = _6FvPUB3j;
        "pkg-1.21.5-2.7.0-beta.9-neoforge" = _G7hgBYeL;
        "pkg-1.21.1-2.7.0-beta.10-forge" = _CD7SH4vs;
        "pkg-1.21.1-2.7.0-beta.10-fabric" = _F6zScPlN;
        "pkg-1.21.1-2.7.0-beta.10-neoforge" = _kkgFdURA;
        "pkg-1.21.4-2.7.0-beta.10-forge" = _f3679ZDZ;
        "pkg-1.21.4-2.7.0-beta.10-fabric" = _kDB1b0s2;
        "pkg-1.21.4-2.7.0-beta.10-neoforge" = _2Cqv4BUK;
        "pkg-1.21.5-2.7.0-beta.10-forge" = _dA3xpeAd;
        "pkg-1.21.5-2.7.0-beta.10-neoforge" = _v6T1C1fZ;
        "pkg-1.21.5-2.7.0-beta.10-fabric" = _oPsFsakr;
        "pkg-1.21.7-2.7.0-beta.10-forge" = _WIVqCuGg;
        "pkg-1.21.7-2.7.0-beta.10-neoforge" = _ADCdX4c2;
        "pkg-1.21.7-2.7.0-beta.10-fabric" = _GzmnKXZP;
        "pkg-1.21.1-2.7.0-beta.11-forge" = _5QX3j4d6;
        "pkg-1.21.1-2.7.0-beta.11-fabric" = _nw0Ql8f2;
        "pkg-1.21.1-2.7.0-beta.11-neoforge" = _GK2Cccrf;
        "pkg-1.21.4-2.7.0-beta.11-forge" = _OLlRPCoP;
        "pkg-1.21.4-2.7.0-beta.11-neoforge" = _eEwPZZR1;
        "pkg-1.21.4-2.7.0-beta.11-fabric" = _fMW3qbc2;
        "pkg-1.21.5-2.7.0-beta.11-forge" = _kaLFaXsR;
        "pkg-1.21.5-2.7.0-beta.11-neoforge" = _pyTDst7Y;
        "pkg-1.21.5-2.7.0-beta.11-fabric" = _Ks6mN8Kl;
        "pkg-1.21.7-2.7.0-beta.11-forge" = _BsyF7hfl;
        "pkg-1.21.7-2.7.0-beta.11-neoforge" = _qxvDVbEZ;
        "pkg-1.21.7-2.7.0-beta.11-fabric" = _3f95cvrt;
        "pkg-1.21.1-2.7.0-beta.12-forge" = _yrEwQtRO;
        "pkg-1.21.1-2.7.0-beta.12-fabric" = _4yx6XAVz;
        "pkg-1.21.1-2.7.0-beta.12-neoforge" = _eNqH5Bbn;
        "pkg-1.21.4-2.7.0-beta.12-forge" = _lTcUk0fG;
        "pkg-1.21.4-2.7.0-beta.12-fabric" = _2yYBNwdN;
        "pkg-1.21.4-2.7.0-beta.12-neoforge" = _EynFj0m2;
        "pkg-1.21.5-2.7.0-beta.12-forge" = _ZeEXhKQH;
        "pkg-1.21.5-2.7.0-beta.12-neoforge" = _zSPdwHeQ;
        "pkg-1.21.5-2.7.0-beta.12-fabric" = _iH3vfe8r;
        "pkg-1.21.7-2.7.0-beta.12-forge" = _wf0fT0V1;
        "pkg-1.21.7-2.7.0-beta.12-neoforge" = _4ldPPiV2;
        "pkg-1.21.7-2.7.0-beta.12-fabric" = _xl5Wn6dg;
        "pkg-1.21.1-2.7.0-beta.13-fabric" = _ZyB20Nvh;
        "pkg-1.21.1-2.7.0-beta.13-forge" = _h993esDq;
        "pkg-1.21.1-2.7.0-beta.13-neoforge" = _FqnBbPMu;
        "pkg-1.21.4-2.7.0-beta.13-fabric" = _1elGqdhk;
        "pkg-1.21.4-2.7.0-beta.13-forge" = _xrAvSDE4;
        "pkg-1.21.4-2.7.0-beta.13-neoforge" = _EvZGKy1F;
        "pkg-1.21.5-2.7.0-beta.13-fabric" = _Jqh5K9TF;
        "pkg-1.21.5-2.7.0-beta.13-forge" = _m2ndk8Ay;
        "pkg-1.21.5-2.7.0-beta.13-neoforge" = _PniZ26od;
        "pkg-1.21.7-2.7.0-beta.13-fabric" = _Sx3084nN;
        "pkg-1.21.7-2.7.0-beta.13-forge" = _JVwIuV0l;
        "pkg-1.21.7-2.7.0-beta.13-neoforge" = _4h0AfBTY;
        "pkg-1.20.1-2.6.1-forge" = _cccwbeo1;
        "pkg-1.20.1-2.6.1-fabric" = _JCH1LaNL;
        "pkg-1.21.1-2.7.0-beta.14-fabric" = _YwZW2XGQ;
        "pkg-1.21.1-2.7.0-beta.14-forge" = _zBcnRJ5B;
        "pkg-1.21.1-2.7.0-beta.14-neoforge" = _nFy4G1cP;
        "pkg-1.21.4-2.7.0-beta.14-fabric" = _Z3DjjS5W;
        "pkg-1.21.4-2.7.0-beta.14-forge" = _ydPIBDyx;
        "pkg-1.21.4-2.7.0-beta.14-neoforge" = _MCw1fel6;
        "pkg-1.21.5-2.7.0-beta.14-fabric" = _3oS1c0qa;
        "pkg-1.21.5-2.7.0-beta.14-forge" = _WEfPuGRp;
        "pkg-1.21.5-2.7.0-beta.14-neoforge" = _PnYWCPeF;
        "pkg-1.21.7-2.7.0-beta.14-fabric" = _GOC1Y6cm;
        "pkg-1.21.7-2.7.0-beta.14-forge" = _vOIPW3xA;
        "pkg-1.21.7-2.7.0-beta.14-neoforge" = _nS8vKGpM;
        "pkg-1.20.1-2.6.1p1-forge" = _XMuGMGkA;
        "pkg-1.21.8-2.7.0-beta.15-forge" = _bRRDsNcE;
        "pkg-1.20.1-2.6.1p2-forge" = _m7NBcHWQ;
        "pkg-1.20.1-2.6.1p2-fabric" = _Le2p7rNV;
        "pkg-1.21.1-2.7.0-beta.16-forge" = _6vk3RN7g;
        "pkg-1.21.1-2.7.0-beta.16-neoforge" = _Y8GgvLjj;
        "pkg-1.21.1-2.7.0-beta.16-fabric" = _SKJj5Igi;
        "pkg-1.21.4-2.7.0-beta.16-fabric" = _CeNjmT2t;
        "pkg-1.21.4-2.7.0-beta.16-forge" = _TnkYTKOV;
        "pkg-1.21.4-2.7.0-beta.16-neoforge" = _7oyBsNiL;
        "pkg-1.21.5-2.7.0-beta.16-fabric" = _ohnyuird;
        "pkg-1.21.5-2.7.0-beta.16-forge" = _qRKX6QkW;
        "pkg-1.21.5-2.7.0-beta.16-neoforge" = _wbQWS7HC;
        "pkg-1.21.7-2.7.0-beta.16-fabric" = _TPJ8N0t9;
        "pkg-1.21.7-2.7.0-beta.16-forge" = _Agb8I4xN;
        "pkg-1.21.7-2.7.0-beta.16-neoforge" = _zbocq002;
        "pkg-1.21.8-2.7.0-beta.16-fabric" = _C6fBe9vD;
        "pkg-1.21.8-2.7.0-beta.16-forge" = _UWUtLxOh;
        "pkg-1.21.8-2.7.0-beta.16-neoforge" = _xw1bEn3i;
        "pkg-1.20.1-2.6.1p3-forge" = _HRU5wf09;
        "pkg-1.20.1-2.6.1p3-fabric" = _G4jjiVTh;
        "pkg-1.21.1-2.7.0-beta.17-fabric" = _Ffx7tHaZ;
        "pkg-1.21.1-2.7.0-beta.17-forge" = _52ieTyJa;
        "pkg-1.21.1-2.7.0-beta.17-neoforge" = _HFnu1Nig;
        "pkg-1.21.4-2.7.0-beta.17-fabric" = _8RlveuJj;
        "pkg-1.21.4-2.7.0-beta.17-forge" = _J2P4eFKX;
        "pkg-1.21.4-2.7.0-beta.17-neoforge" = _vk94LDqM;
        "pkg-1.21.5-2.7.0-beta.17-fabric" = _ZgZsNVJs;
        "pkg-1.21.5-2.7.0-beta.17-forge" = _yj5YTkPO;
        "pkg-1.21.5-2.7.0-beta.17-neoforge" = _tVrJNMP1;
        "pkg-1.21.7-2.7.0-beta.17-fabric" = _tq4Z6sOP;
        "pkg-1.21.7-2.7.0-beta.17-forge" = _M1akD6JC;
        "pkg-1.21.7-2.7.0-beta.17-neoforge" = _RLKeKkES;
        "pkg-1.21.8-2.7.0-beta.17-fabric" = _OTXW2VJi;
        "pkg-1.21.8-2.7.0-beta.17-forge" = _EWB3DsWb;
        "pkg-1.21.8-2.7.0-beta.17-neoforge" = _Ohe8zOZa;
        "pkg-1.21.10-2.7.0-beta.17-forge" = _FpYwxX54;
        "pkg-1.21.10-2.7.0-beta.17-neoforge" = _4S8yodyn;
        "pkg-1.21.10-2.7.0-beta.17-fabric" = _Xz3OccvV;
        "pkg-1.21.1-2.7.0-beta.18-forge" = _Arorkh0b;
        "pkg-1.21.1-2.7.0-beta.18-fabric" = _Ud9KdwxN;
        "pkg-1.21.1-2.7.0-beta.18-neoforge" = _ISVYP2Bt;
        "pkg-1.21.4-2.7.0-beta.18-fabric" = _SftkguLI;
        "pkg-1.21.4-2.7.0-beta.18-forge" = _v0H6mDSO;
        "pkg-1.21.4-2.7.0-beta.18-neoforge" = _cw2mkLAt;
        "pkg-1.21.5-2.7.0-beta.18-fabric" = _rgpARA3V;
        "pkg-1.21.5-2.7.0-beta.18-forge" = _qPPUaWr8;
        "pkg-1.21.5-2.7.0-beta.18-neoforge" = _DnTwag9P;
        "pkg-1.21.7-2.7.0-beta.19-forge" = _nJZrljZ4;
        "pkg-1.21.7-2.7.0-beta.19-neoforge" = _iGxWuRKp;
        "pkg-1.21.7-2.7.0-beta.19-fabric" = _3uQqvdwx;
        "pkg-1.21.8-2.7.0-beta.19-fabric" = _CW9p5Yir;
        "pkg-1.21.8-2.7.0-beta.19-forge" = _LarOqeH0;
        "pkg-1.21.8-2.7.0-beta.19-neoforge" = _vmyaejET;
        "pkg-1.21.10-2.7.0-beta.19-fabric" = _k6vwhN7M;
        "pkg-1.21.10-2.7.0-beta.19-forge" = _Ta0bgMsp;
        "pkg-1.21.10-2.7.0-beta.19-neoforge" = _xR3dgHJm;
        "pkg-1.21.11-2.7.0-beta.19-fabric" = _AIX9yNzv;
        "pkg-1.21.11-2.7.0-beta.19-forge" = _gtXNwwGQ;
        "pkg-1.21.11-2.7.0-beta.19-neoforge" = _i73LosOI;
        "pkg-1.21.11-3.0.0-beta.1-fabric" = _CtDjjT2H;
        "pkg-1.21.11-3.0.0-beta.1-forge" = _tY9hZYY2;
        "pkg-1.21.11-3.0.0-beta.1-neoforge" = _Ge7a8nOH;
        "pkg-26.1-3.0.0-beta.1-forge" = _QOqqVz87;
        "pkg-26.1-3.0.0-beta.1-neoforge" = _Suf9rFGF;
        "pkg-26.1-3.0.0-beta.1-fabric" = _yqZFCt7C;
        "pkg-1.21.11-3.0.0-beta.2-fabric" = _aXSE8K5i;
        "pkg-1.21.11-3.0.0-beta.2-forge" = _dFsAvijl;
        "pkg-1.21.11-3.0.0-beta.2-neoforge" = _k8QQq1cf;
        "pkg-26.1-3.0.0-beta.2-fabric" = _G9si0lED;
        "pkg-26.1-3.0.0-beta.2-forge" = _yzFLpdkR;
        "pkg-26.1-3.0.0-beta.2-neoforge" = _A2LaJWzv;
        "pkg-1.21.11-3.0.0-beta.3-fabric" = _sLJlcUCd;
        "pkg-1.21.11-3.0.0-beta.3-forge" = _hTiW4eFa;
        "pkg-1.21.11-3.0.0-beta.3-neoforge" = _Yla0vP4r;
        "pkg-26.1-3.0.0-beta.3-fabric" = _qfoR9cIt;
        "pkg-26.1-3.0.0-beta.3-forge" = _iB1s7cuR;
        "pkg-26.1-3.0.0-beta.3-neoforge" = _Z7wPnlia;
        "pkg-1.21.11-3.0.0-beta.4-fabric" = _B94UNzSD;
        "pkg-1.21.11-3.0.0-beta.4-forge" = _R3SoxGTX;
        "pkg-1.21.11-3.0.0-beta.4-neoforge" = _zBZSxGPt;
        "pkg-26.1.2-3.0.0-beta.4-fabric" = _llYfrwiJ;
        "pkg-26.1.2-3.0.0-beta.4-forge" = _898MwDCG;
        "pkg-26.1.2-3.0.0-beta.4-neoforge" = _J81AEEId;
        "pkg-1.21.11-3.0.0-beta.5-fabric" = _gskzVz7l;
        "pkg-1.21.11-3.0.0-beta.5-forge" = _qGAelnRH;
        "pkg-1.21.11-3.0.0-beta.5-neoforge" = _Nh41ge2N;
        "pkg-26.1.2-3.0.0-beta.5-fabric" = _jSS36CvK;
        "pkg-26.1.2-3.0.0-beta.5-forge" = _OZZsUSwP;
        "pkg-26.1.2-3.0.0-beta.5-neoforge" = _GJCWCzgp;
        "pkg-1.21.11-3.0.0-beta.6-fabric" = _kpn6fqBp;
        "pkg-1.21.11-3.0.0-beta.6-forge" = _CNGlPgFz;
        "pkg-1.21.11-3.0.0-beta.6-neoforge" = _zx8yOMEO;
        "pkg-26.1.2-3.0.0-beta.6-fabric" = _K9F6lPjg;
        "pkg-26.1.2-3.0.0-beta.6-forge" = _u8GNRrSJ;
        "pkg-26.1.2-3.0.0-beta.6-neoforge" = _4i9B7iZr;
        "pkg-26.2-3.0.0-beta.6-fabric" = _a9mPejjZ;
        "pkg-26.2-3.0.0-beta.6-forge" = _qYf4OdoF;
        "pkg-26.2-3.0.0-beta.6-neoforge" = _BD5z7kSa;
        "pkg-1.21.1-3.0.0-beta.7-fabric" = _lWMD48oI;
        "pkg-1.21.1-3.0.0-beta.7-forge" = _JDZPNHHq;
        "pkg-1.21.1-3.0.0-beta.7-neoforge" = _SM3aMm1b;
        "pkg-1.21.10-3.0.0-beta.7-fabric" = _7LnXAW9d;
        "pkg-1.21.10-3.0.0-beta.7-forge" = _Z9bO86Od;
        "pkg-1.21.10-3.0.0-beta.7-neoforge" = _SS8q9dvB;
        "pkg-1.21.11-3.0.0-beta.7-fabric" = _ons6J6Sh;
        "pkg-1.21.11-3.0.0-beta.7-forge" = _aveykaJK;
        "pkg-1.21.11-3.0.0-beta.7-neoforge" = _hqOo8odr;
        "pkg-26.1.2-3.0.0-beta.7-fabric" = _og2sQO5Z;
        "pkg-26.1.2-3.0.0-beta.7-forge" = _xA7qI4q1;
        "pkg-26.1.2-3.0.0-beta.7-neoforge" = _THMwvGgb;
        "pkg-26.2-3.0.0-beta.7-fabric" = _wjhtNFR7;
        "pkg-26.2-3.0.0-beta.7-forge" = _EJsPHoDp;
        "pkg-26.2-3.0.0-beta.7-neoforge" = _tLvyE0Hi;
        "pkg-1.21.1-3.0.0-beta.8-fabric" = _eL0TZQ8a;
        "pkg-1.21.1-3.0.0-beta.8-forge" = _V5hja3jj;
        "pkg-1.21.1-3.0.0-beta.8-neoforge" = _pBl0E0Nm;
        "pkg-1.21.10-3.0.0-beta.8-fabric" = _FczboA4d;
        "pkg-1.21.10-3.0.0-beta.8-forge" = _69LhWYsE;
        "pkg-1.21.10-3.0.0-beta.8-neoforge" = _xnnB01aB;
        "pkg-1.21.11-3.0.0-beta.8-fabric" = _XloVj67t;
        "pkg-1.21.11-3.0.0-beta.8-forge" = _aZhyUvbW;
        "pkg-1.21.11-3.0.0-beta.8-neoforge" = _KRRdTriL;
        "pkg-26.1.2-3.0.0-beta.8-fabric" = _Z0cSWhKN;
        "pkg-26.1.2-3.0.0-beta.8-forge" = _xA2JVrEr;
        "pkg-26.1.2-3.0.0-beta.8-neoforge" = _Sv5U6vtT;
        "pkg-26.2-3.0.0-beta.8-fabric" = _6getXDJR;
        "pkg-26.2-3.0.0-beta.8-forge" = _leTlfBxV;
        "pkg-26.2-3.0.0-beta.8-neoforge" = _JcSxwMdd;
        "pkg-1.21.1-3.0.0-beta.9-fabric" = _jWbXWQso;
        "pkg-1.21.1-3.0.0-beta.9-forge" = _S40hz82s;
        "pkg-1.21.1-3.0.0-beta.9-neoforge" = _8GvDfcAI;
        "pkg-1.21.10-3.0.0-beta.9-fabric" = _AvEAxQoN;
        "pkg-1.21.10-3.0.0-beta.9-forge" = _ao8NOpYW;
        "pkg-1.21.10-3.0.0-beta.9-neoforge" = _Iw3JwE56;
        "pkg-1.21.11-3.0.0-beta.9-fabric" = _4Ys6u2D2;
        "pkg-1.21.11-3.0.0-beta.9-forge" = _Wm35hkHj;
        "pkg-1.21.11-3.0.0-beta.9-neoforge" = _c1D1nG9y;
        "pkg-26.1.2-3.0.0-beta.9-fabric" = _IUhC0MBw;
        "pkg-26.1.2-3.0.0-beta.9-forge" = _HhIqCInD;
        "pkg-26.1.2-3.0.0-beta.9-neoforge" = _ZJYyhHpM;
        "pkg-26.2-3.0.0-beta.9-fabric" = _TWe5jFsT;
        "pkg-26.2-3.0.0-beta.9-forge" = _Ocx04ML0;
        "pkg-26.2-3.0.0-beta.9-neoforge" = _I7OcT8aV;
        "pkg-1.20.1-3.0.0-beta.10-fabric" = _MkU1WOTK;
        "pkg-1.20.1-3.0.0-beta.10-forge" = _z1YO1pUD;
        "pkg-1.21.1-3.0.0-beta.10-fabric" = _tt1dZBif;
        "pkg-1.21.1-3.0.0-beta.10-forge" = _YRYWTVnk;
        "pkg-1.21.1-3.0.0-beta.10-neoforge" = _FXlk9fAD;
        "pkg-1.21.10-3.0.0-beta.10-fabric" = _wwF6KhIW;
        "pkg-1.21.10-3.0.0-beta.10-forge" = _De4HoVAS;
        "pkg-1.21.10-3.0.0-beta.10-neoforge" = _GQ1BGzjr;
        "pkg-1.21.11-3.0.0-beta.10-fabric" = _qHJVRa9u;
        "pkg-1.21.11-3.0.0-beta.10-forge" = _y2U6byzn;
        "pkg-1.21.11-3.0.0-beta.10-neoforge" = _u5u4EOnp;
        "pkg-26.1.2-3.0.0-beta.10-fabric" = _TXiAe5BG;
        "pkg-26.1.2-3.0.0-beta.10-forge" = _ib59SkGe;
        "pkg-26.1.2-3.0.0-beta.10-neoforge" = _32RbpoQp;
        "pkg-26.2-3.0.0-beta.10-fabric" = _30lnZjzX;
        "pkg-26.2-3.0.0-beta.10-forge" = _DpPtT5F8;
        "pkg-26.2-3.0.0-beta.10-neoforge" = _X7k1LocV;
        "pkg-1.20.1-3.0.0-beta.11-fabric" = _lMYpByuu;
        "pkg-1.20.1-3.0.0-beta.11-forge" = _kD5rPGFJ;
        "pkg-1.21.1-3.0.0-beta.11-fabric" = _gBzwc9zT;
        "pkg-1.21.1-3.0.0-beta.11-forge" = _4cqw7SLa;
        "pkg-1.21.1-3.0.0-beta.11-neoforge" = _RXFcKCb4;
        "pkg-1.21.10-3.0.0-beta.11-fabric" = _7dPvSBy1;
        "pkg-1.21.10-3.0.0-beta.11-forge" = _rG1D8CfN;
        "pkg-1.21.10-3.0.0-beta.11-neoforge" = _zE5zP6pU;
        "pkg-1.21.11-3.0.0-beta.11-fabric" = _KYG8RZtA;
        "pkg-1.21.11-3.0.0-beta.11-forge" = _B29M9PpV;
        "pkg-1.21.11-3.0.0-beta.11-neoforge" = _npsIhjYd;
        "pkg-26.1.2-3.0.0-beta.11-fabric" = _N4QFUe17;
        "pkg-26.1.2-3.0.0-beta.11-forge" = _Pj0iTrks;
        "pkg-26.1.2-3.0.0-beta.11-neoforge" = _sHfyPtAQ;
