...
let
    versions = (let
        ...
        _nByw6S3T = {
            "id" = "nByw6S3T";
            "file" = "NoShade+ 26x v.03.zip";
            "hash" = "sha512-alnnW9/MwEVEiuPbbHFBXICzUQqJK5hWUJrLKFj1rTGKJwAfKzz29rNUd4oTCagXc+ToB2D8ZZQRspRe8LmeOg==";
        };
    in {
        "aK3Ao3nx" = _aK3Ao3nx;
        "oSCfrFeL" = _oSCfrFeL;
        ...
        "minecraft-1.21" = _nByw6S3T;
        "minecraft-1.21.1" = _nByw6S3T;
        "minecraft-1.21.2" = _nByw6S3T;
        "minecraft-1.21.3" = _nByw6S3T;
        "minecraft-24w44a" = _nByw6S3T;
        "minecraft-24w45a" = _nByw6S3T;
        "minecraft-24w46a" = _nByw6S3T;
        "minecraft-1.21.4" = _nByw6S3T;
        "minecraft-1.21.5" = _nByw6S3T;
        "minecraft-1.21.6" = _nByw6S3T;
        "minecraft-1.21.7" = _nByw6S3T;
        "minecraft-1.21.8" = _nByw6S3T;
        "minecraft-1.21.9" = _nByw6S3T;
        "minecraft-1.21.10" = _nByw6S3T;
        "minecraft-1.21.11" = _nByw6S3T;
        "minecraft-24w33a" = _nByw6S3T;
        "minecraft-24w34a" = _nByw6S3T;
        "minecraft-24w35a" = _nByw6S3T;
        "minecraft-24w36a" = _nByw6S3T;
        "minecraft-24w37a" = _nByw6S3T;
        "minecraft-24w38a" = _nByw6S3T;
        "minecraft-24w39a" = _nByw6S3T;
        "minecraft-24w40a" = _nByw6S3T;
        "minecraft-1.21.2-pre1" = _nByw6S3T;
        "minecraft-1.21.2-pre2" = _nByw6S3T;
