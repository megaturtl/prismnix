...
let
    ...
    in {
        ...
        "pkg-0+mod" = _LUTGk4KL;
        "pkg-0.1" = _Y1llray4;
        "pkg-0.1+mod" = _UBZdylAx;
        "pkg-0.2" = _ZBdWV9c5;
        "pkg-0.2+mod" = _o0dEX7Pm;
        "pkg-0.3" = _14p2Eeeo;
        "pkg-0.3+mod" = _3rQ9IoYJ;
        "pkg-0.5" = _xbF3CtGS;
        "pkg-0.5+mod" = _2pspyF99;
        "pkg-0.6" = _hqbkbAX9;
        "pkg-0.6+mod" = _dappsiIf;
        "pkg-0.7" = _2tqt7WoF;
        "pkg-0.7+mod" = _SeBii6JV;
        "pkg-0.8" = _C7HnVV2J;
        "pkg-0.8+mod" = _fWV5AUzk;
        "pkg-0.9" = _88ZcBjVh;
        "pkg-0.9+mod" = _jZ6uwyz6;
        "pkg-1.0" = _BBOX3Giu;
        "pkg-1.0+mod" = _XT3irnvT;
        "pkg-1.1" = _IclKrFuj;
        "pkg-1.1+mod" = _8KeA5Hpj;
        "pkg-1.2" = _n7YsjlxY;
        "pkg-1.2+mod" = _efxLStPc;
        "pkg-1.3" = _q0kMyfcz;
        "pkg-1.3+mod" = _BmhVULlw;
        "pkg-1.4" = _YlrLDD1F;
        "pkg-1.4+mod" = _2SYi9ULu;
        "pkg-1.5" = _aGc7WQQ7;
        "pkg-1.5+mod" = _V9PXoyi3;
        "pkg-1.6" = _penn0oD8;
        "pkg-1.6+mod" = _mOewEGTL;
        "pkg-1.7" = _I7Jc7a7K;
        "pkg-1.7+mod" = _GnzJLB9i;
        "pkg-1.8" = _XokgrrOC;
        "pkg-1.8+mod" = _TNtjN81k;
        "pkg-1.9" = _HD0Xo7Du;
        "pkg-1.9+mod" = _z7g2x05C;
        "pkg-2" = _c8gbeR2x;
        "pkg-2+mod" = _KiM44Suh;
        "pkg-3" = _oNs8K1qt;
        "pkg-3+mod" = _tMZip0xs;
        "pkg-3.1" = _AtyFxMoo;
        "pkg-3.1+mod" = _IjHK8eaK;
        "pkg-3.2" = _suftpdqG;
        "pkg-3.2+mod" = _k3ZtvhyW;
        "pkg-3.3" = _DzOht3PK;
        "pkg-3.3+mod" = _EClSfcww;
        "pkg-4" = _ECGm3Q4m;
        "pkg-4+mod" = _YN39xycB;
        "pkg-4.1" = _c86p9Yub;
