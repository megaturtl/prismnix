...
let
    versions = (let
        ...
        _yH66cUHk = {
            "id" = "yH66cUHk";
            "file" = "SkniroFurniture-1.5.2-26.2-Fabric.jar";
            "hash" = "sha512-ui5feyv/7jfJzFJjzGMUBWZhqhl3pIqL5JXitRrvgJq3rtfhoXKivZ/dcdNg18DRWQfac7t4DzRyrX/qJRa7BQ==";
        };
        _nD1YxlDH = {
            "id" = "nD1YxlDH";
            "file" = "SkniroFurniture-1.5.2-26.2-Forge.jar";
            "hash" = "sha512-LOeDkGN7Xvxd0S0P7JPr2RIuJU4IfnllI5uNgj6bHbO0UH9EsdKa3l6shewCNykDJNmOYBok8y0GTtoT4O+WfQ==";
        };
        _jXQfWgcX = {
            "id" = "jXQfWgcX";
            "file" = "SkniroFurniture-1.5.2-26.2-NeoForge.jar";
            "hash" = "sha512-QKOalDQXx1G/7Jp1Iuj3JZ5TA7P4RnogeR2G0h62JxgMm+pQ4KBUTySXFrbzKGAQyXYnlEibctNkuf32jVtnnQ==";
        };
        _oeP640Gt = {
            "id" = "oeP640Gt";
            "file" = "SkniroFurniture-1.5.2-26.1.2-Forge.jar";
            "hash" = "sha512-FDyhJ/Ov4K/4wIt5FLf64s4ukxUftjWf+Y5fT2Ms3iWhXk9c5mYFp0srbWN5BAFSaE6QSWIgOMnfYHCdu1z/GA==";
        };
        _t67budCr = {
            "id" = "t67budCr";
            "file" = "SkniroFurniture-1.5.2-26.1.2-NeoForge.jar";
            "hash" = "sha512-2Tg4UnyBwaIJtmjzlfVR2kXSRS43gwN7oFI07Wkd8TYuONSWEZuOHPE6dYIL228k5gdQokG9B2wmC8Us9PHekQ==";
        };
        _DfcTsZH0 = {
            "id" = "DfcTsZH0";
            "file" = "SkniroFurniture-1.5.2-26.1.2-Fabric.jar";
            "hash" = "sha512-ZL8UtsZTnQ+nXOeRCHdEhnD9WCgsYKypeujUgDmj9yzZuk0WoB2owxFJKqlDfcb6755B06GWUQg15apuzBa3tA==";
        };
        _eO8EKLol = {
            "id" = "eO8EKLol";
            "file" = "SkniroFurniture-1.5.2-1.21.11-Forge.jar";
            "hash" = "sha512-UfJua0wZgEK43ALVZQRzjzPsGxo4VKQoLgOi+7M7b6K2KlnGih2T64p46eXuPuL6boRiLovz7ZWGlu6AZxZ7Vw==";
        };
        _QzA9pkSA = {
            "id" = "QzA9pkSA";
            "file" = "SkniroFurniture-1.5.2-1.21.11-Fabric.jar";
            "hash" = "sha512-Nog9mPI/L3RQmR2ibKKs7Vfdr4rDCZAYigT7CfhgQPr3d4LJxgRmrKP35nN8UwwKu9eZwjZFPziH1XjmpoBwHg==";
        };
        _CYSiw7Pt = {
            "id" = "CYSiw7Pt";
            "file" = "SkniroFurniture-1.5.2-1.21.11-NeoForge.jar";
            "hash" = "sha512-HVQPJj/6jW5JId6fFr9uMV2PiN5Y1hrQxJbZeC0S2NsGYgs0x4TxryM/H/zap4DE5b0fP2todJ1PmsvASK4+Bw==";
        };
        _Up6I5Il4 = {
            "id" = "Up6I5Il4";
            "file" = "SkniroFurniture-1.5.2-1.21.10-Forge.jar";
            "hash" = "sha512-b/0xbjXi+YxgsJxDokUYfI/ueX/WfqvCyVBJIgWrgs4Tc3BmuVnt5bgK+jiKCjsUyaoebQlDGm4HLwKf669mrg==";
        };
        _sr8gvlln = {
            "id" = "sr8gvlln";
            "file" = "SkniroFurniture-1.5.2-1.21.10-NeoForge.jar";
            "hash" = "sha512-86gVa16WOH/EssxFEuD0XAqyeP+AAC0euWQ5gxpthvttZnqIKAbsKq0Svw0fZosvxAeOIiv03vwS5XB36WrSnQ==";
        };
        _PklUa1FG = {
            "id" = "PklUa1FG";
            "file" = "SkniroFurniture-1.5.2-1.21.10-Fabric.jar";
            "hash" = "sha512-llPzJEsHNDeYe/UbOD0ENiGHhfFwP/SoLxldSB0wmBAKsmmi8O0DJutIbE/5wTRuieNEWJTAmD3WWxUJGwaryw==";
        };
        _XsFFMhyb = {
            "id" = "XsFFMhyb";
            "file" = "SkniroFurniture-1.5.2-1.21.8-Forge.jar";
            "hash" = "sha512-OlkGIphBHoMRCqIKkFvJsLUczgMYAiXmUx97M8YaWYMBZ6pO4OmdXZmWGmDJgENBV37fWWRdZtoi10Vha45yuQ==";
        };
        _7MGuEOmy = {
            "id" = "7MGuEOmy";
            "file" = "SkniroFurniture-1.5.2-1.21.8-Fabric.jar";
            "hash" = "sha512-5570sKrdjFSYhklSRdfwyptz0iBdH54l574jiPoDvKFrfoqfCS1PETyH3j6mFY8ncJlr3xRStM0/jiHFYq+Fww==";
        };
        _bXZP3eVU = {
            "id" = "bXZP3eVU";
            "file" = "SkniroFurniture-1.5.2-1.21.8-NeoForge.jar";
            "hash" = "sha512-Fc/DFHaoLjgeG1rdjLVluRmVzxDMVMhESQRxDWwCCe9qwZAfB1lD+cfjiM5V3KrOj3V+C65G68rDCxHDgFa+iw==";
        };
        _ElA8Ltsd = {
            "id" = "ElA8Ltsd";
            "file" = "SkniroFurniture-1.3.10-1.21.4-Forge.jar";
            "hash" = "sha512-xvoouQs6RU7M0oTAH2TcKlgM+qFf4k5RczJ/znO7tMx30ye6Fz2ItkNqtvGe7q/64tRVqrMMvvRpx8dPeXULlA==";
        };
        _3DHcQymK = {
            "id" = "3DHcQymK";
            "file" = "SkniroFurniture-1.3.10-1.21.4-NeoForge.jar";
            "hash" = "sha512-I+4W018UW3sn44xI1/uHBCKZNt4w67B8KBwu1pQOq9dC+iM0VXHQirLZdz03Ni8BMHqjyMEOwk81djHx0A0XBg==";
        };
        _A6x8CjPp = {
            "id" = "A6x8CjPp";
            "file" = "SkniroFurniture-1.3.10-1.21.4-Fabric.jar";
            "hash" = "sha512-gYtnUgdKwpuoH1RtlZNAdPjs6BttHDfWKa1a7WwNx4UGkUX1LjDfMgE9bKMfKV6oMZpXQZUeQgGzKgh13XzDZw==";
        };
        _ylKdIYgA = {
            "id" = "ylKdIYgA";
            "file" = "SkniroFurniture-1.5.2-1.20.4-Forge.jar";
            "hash" = "sha512-jz2T+4aUpPwsfhy0YhiyyxL7wk7LahcA6wyBa4D9+pbI/P3fDUIaq+TO2Jml8Gz4Q5MT7kVdBsSQeoACK/Eadw==";
        };
        _WWSlHha3 = {
            "id" = "WWSlHha3";
            "file" = "SkniroFurniture-1.5.2-1.20.4-Fabric.jar";
            "hash" = "sha512-EojlfyzXE6KaLbcZUYsV+mZNDVWZqtf4PKLVsXE63ER+t04Uy29LMGln14kLqQCf3FqEeN4+6wjs7ftDoWtAvQ==";
        };
        _zLwIG6LD = {
            "id" = "zLwIG6LD";
            "file" = "SkniroFurniture-1.5.2-1.20.1-Forge.jar";
            "hash" = "sha512-GOI4gKkg948LEy+OfErjpsqShQsYUE52yLG/EgxKgPDq+NhYoTt5ucFEOvaGD+rmZ7u6gbsH3KTbcpGbJV2FZQ==";
        };
        _kmb3Khtz = {
            "id" = "kmb3Khtz";
    ...
    in {
        ...
        "forge-1.21.4" = _ElA8Ltsd;
        "forge-1.21.1" = _XlhOUeCh;
        "forge-1.21" = _ejwyoFuF;
        "forge-1.20.4" = _ylKdIYgA;
        "forge-1.20.1" = _zLwIG6LD;
        ...
        "neoforge-1.21.8" = _bXZP3eVU;
        "neoforge-1.21.4" = _3DHcQymK;
        ...
        "fabric-1.21.8" = _7MGuEOmy;
        "fabric-1.21.4" = _A6x8CjPp;
        "fabric-1.20.4" = _WWSlHha3;
        "fabric-1.20.1" = _kmb3Khtz;
        ...
        "pkg-1.0.1-1.21.1-Fabric" = _v2HRmxCs;
        "pkg-1.0.1-1.21.1-NeoForge" = _5mN1vtKV;
        "pkg-1.0.2-1.21.7-Fabric" = _j2cSRsNh;
        "pkg-1.0.2-1.21.7-NeoForge" = _J4sP1e6e;
        "pkg-1.0.3-1.21.4-Fabric" = _wDhzDwup;
        "pkg-1.0.3-1.21.4-NeoForge" = _nUljxDpn;
        "pkg-1.0.2-1.21.7-Forge" = _SxK0sm1W;
        "pkg-1.0.3-1.21.4-Forge" = _UGMXyo7H;
        "pkg-1.0.2-1.21.1-Fabric" = _gBoc26HH;
        "pkg-1.0.2-1.21.1-NeoForge" = _KJBtnPYi;
        "pkg-1.0.2-1.21.1-Forge" = _DLqBGz8y;
        "pkg-1.0.3-1.21.7-Fabric" = _HG9kalfv;
        "pkg-1.0.3-1.21.7-NeoForge" = _GAgQ0AYJ;
        "pkg-1.0.3-1.21.7-Forge" = _o3H6LJ1K;
        "pkg-1.0.3-1.21.1-Forge" = _r8eIC28N;
        "pkg-1.0.4-1.21.4-Forge" = _BM3eXQbv;
        "pkg-1.0.3-1.21.1-NeoForge" = _QH6zm8gg;
        "pkg-1.0.3-1.21.1-Fabric" = _vhLM4guM;
        "pkg-1.0.4-1.21.4-NeoForge" = _QSAkRdmB;
        "pkg-1.0.4-1.21.4-Fabric" = _zsmTOuyb;
        "pkg-1.0.0-1.20.4-Fabric" = _RDR5Vx5o;
        "pkg-1.0.0-1.20.4-Forge" = _aHL9E1i7;
        "pkg-1.0.0-1.20.1-Forge" = _zI3vHZjh;
        "pkg-1.0.0-1.20.1-Fabric" = _PadrMjnt;
        "pkg-1.1.0-1.21.7-Fabric" = _oRYG8J9w;
        "pkg-1.1.0-1.21.7-NeoForge" = _6xRQmd9b;
        "pkg-1.1.0-1.21.7-Forge" = _AlOHUcem;
        "pkg-1.1.0-1.21.4-Forge" = _zneinrmC;
        "pkg-1.1.0-1.21.4-NeoForge" = _uR9nOv9n;
        "pkg-1.1.0-1.21.4-Fabric" = _ywOjl3bs;
        "pkg-1.1.0-1.21.1-Forge" = _BoISjhfH;
        "pkg-1.1.0-1.21.1-NeoForge" = _E028vdxm;
        "pkg-1.1.0-1.20.4-Forge" = _XxOns5Xw;
        "pkg-1.1.0-1.20.4-Fabric" = _CAfOzH1M;
        "pkg-1.1.0-1.20.1-Forge" = _NsoCZogJ;
        "pkg-1.1.0-1.20.1-Fabric" = _X3DFFwux;
        "pkg-1.1.1-1.21.7-Forge" = _WjKF2oWd;
        "pkg-1.1.1-1.21.7-NeoForge" = _6rF2jv9Y;
        "pkg-1.1.1-1.21.4-Forge" = _uaZeSTXV;
        "pkg-1.1.1-1.21.7-Fabric" = _hPg9Xckq;
        "pkg-1.1.1-1.21.4-NeoForge" = _OrmE4o1P;
        "pkg-1.1.1-1.21.4-Fabric" = _hMTjGU4R;
        "pkg-1.1.1-1.21.1-Forge" = _ejwyoFuF;
        "pkg-1.1.1-1.21.1-NeoForge" = _DCl72lGQ;
        "pkg-1.1.1-1.21.1-Fabric" = _y9OJ2Mco;
        "pkg-1.1.1-1.20.4-Forge" = _dP7mAnfj;
        "pkg-1.1.1-1.20.4-Fabric" = _qokpdIkR;
        "pkg-1.1.1-1.20.1-Forge" = _lpYBIdrd;
        "pkg-1.1.1-1.20.1-Fabric" = _x7XHbkJ6;
        "pkg-1.1.2-1.21.4-Forge" = _631kamtJ;
        "pkg-1.1.2-1.21.4-NeoForge" = _Tzmab6uN;
        "pkg-1.1.2-1.21.4-Fabric" = _eXeURUnb;
        "pkg-1.1.2-1.21.1-Forge" = _q8wx5hWm;
        "pkg-1.1.2-1.21.1-Fabric" = _yJ0nmwmh;
        "pkg-1.2.0.25w38e-1.21.7-Forge" = _WiZZEQir;
        "pkg-1.2.0.25w38e-1.21.7-NeoForge" = _Pe0ZBsM8;
        "pkg-1.2.0.25w38e-1.21.7-Fabric" = _2n3Iy54T;
        "pkg-1.1.2-1.20.4-Forge" = _ztjdloON;
        "pkg-1.1.2-1.20.4-Fabric" = _daNd4JRf;
        "pkg-1.1.2-1.20.1-Forge" = _BcCBNSZp;
        "pkg-1.1.2-1.20.1-Fabric" = _wLLQwDAL;
        "pkg-1.2.0-1.21.7-Fabric" = _1WCSMgl8;
        "pkg-1.2.0-1.21.7-NeoForge" = _McnJAUgw;
        "pkg-1.2.0-1.21.7-Forge" = _4PEUczFh;
        "pkg-1.2.0-1.21.4-Fabric" = _clX5n3ur;
        "pkg-1.2.0-1.21.4-NeoForge" = _fDCGgZCl;
        "pkg-1.2.0-1.21.4-Forge" = _3nZ4IQah;
        "pkg-1.2.0-1.21.9-Fabric" = _CFpSsZO9;
        "pkg-1.2.0-1.21.9-NeoForge" = _JLJ6drmr;
        "pkg-1.2.0-1.21.9-Forge" = _IWWaq4Ld;
        "pkg-1.2.0-1.21.1-Forge" = _UuKbklzO;
        "pkg-1.2.0-1.21.1-NeoForge" = _Dpx8vvhc;
        "pkg-1.2.0-1.21.1-Fabric" = _ex9Qbnb2;
        "pkg-1.2.0-1.20.4-Forge" = _ZD5mZwWh;
        "pkg-1.2.0-1.20.4-Fabric" = _BKOBkRPT;
        "pkg-1.2.0-1.20.1-Forge" = _AkxIWUVg;
        "pkg-1.2.0-1.20.1-Fabric" = _JwdLNpMl;
        "pkg-1.2.0-1.21.10-Fabric" = _4YWX8QuB;
        "pkg-1.2.0-1.21.10-NeoForge" = _wJmi3eNp;
        "pkg-1.2.0-1.21.10-Forge" = _yQzspnjt;
        "pkg-1.3.0-1.21.10-Forge" = _veFNBGvh;
        "pkg-1.3.0-1.21.10-NeoForge" = _5FPQmrNX;
        "pkg-1.3.0-1.21.10-Fabric" = _PvCmfs46;
        "pkg-1.3.0-1.21.8-Forge" = _MnhS5LeM;
        "pkg-1.3.0-1.21.8-NeoForge" = _EpaIsRA4;
        "pkg-1.3.0-1.21.8-Fabric" = _CUwIzood;
        "pkg-1.3.0-1.21.4-Forge" = _7GevBBAB;
        "pkg-1.3.0-1.21.4-NeoForge" = _zXl1ySN2;
        "pkg-1.3.0-1.21.4-Fabric" = _qCNgsaJV;
        "pkg-1.3.0-1.21.1-Forge" = _78UrILND;
        "pkg-1.3.0-1.21.1-NeoForge" = _rNTHy0Qw;
        "pkg-1.3.0-1.21.1-Fabric" = _iUzoBUi5;
        "pkg-1.3.0-1.20.4-Forge" = _iCUtU6Ep;
        "pkg-1.3.0-1.20.4-Fabric" = _rWkom7qv;
        "pkg-1.3.0-1.20.1-Forge" = _MG15Sy4K;
        "pkg-1.3.0-1.20.1-Fabric" = _RxGsHtH9;
        "pkg-1.3.1-1.21.10-Forge" = _PZZwALun;
        "pkg-1.3.1-1.21.10-NeoForge" = _eXRcAzPg;
        "pkg-1.3.1-1.21.10-Fabric" = _DTP30lhm;
        "pkg-1.3.1-1.21.8-Forge" = _njXSTJOT;
        "pkg-1.3.1-1.21.8-NeoForge" = _85ngEFkX;
        "pkg-1.3.1-1.21.8-Fabric" = _VOXqrgOn;
        "pkg-1.3.1-1.21.4-Forge" = _lqUQ3JVF;
        "pkg-1.3.1-1.21.4-NeoForge" = _TiMA5mQF;
        "pkg-1.3.1-1.21.4-Fabric" = _JfO6LNqt;
        "pkg-1.3.1-1.21.1-Forge" = _TaobmqhM;
        "pkg-1.3.1-1.21.1-NeoForge" = _paBfMudE;
        "pkg-1.3.1-1.21.1-Fabric" = _HGWz6YqC;
        "pkg-1.3.1-1.20.4-Forge" = _mFp96E7a;
        "pkg-1.3.1-1.20.4-Fabric" = _X0WXWa0V;
        "pkg-1.3.1-1.20.1-Forge" = _dHesVqQx;
        "pkg-1.3.1-1.20.1-Fabric" = _hSp4Hf54;
        "pkg-1.3.2-1.21.10-Forge" = _TLlMc8YT;
        "pkg-1.3.2-1.21.10-NeoForge" = _eyjquYjE;
        "pkg-1.3.2-1.21.10-Fabric" = _q9vr6EzJ;
        "pkg-1.3.2-1.21.8-Forge" = _s7Ph8I7t;
        "pkg-1.3.2-1.21.8-NeoForge" = _ggRa1W0p;
        "pkg-1.3.2-1.21.8-Fabric" = _Buwu89lW;
        "pkg-1.3.2-1.21.4-Forge" = _Y5uecbFH;
        "pkg-1.3.2-1.21.4-NeoForge" = _kfqvt6AA;
        "pkg-1.3.2-1.21.4-Fabric" = _11WowtYv;
        "pkg-1.3.2-1.21.1-Forge" = _oBs3QAX6;
        "pkg-1.3.2-1.21.1-NeoForge" = _CRdxYH9f;
        "pkg-1.3.2-1.21.1-Fabric" = _wG5MNGyp;
        "pkg-1.3.2-1.20.4-Forge" = _Hh9NPXLX;
        "pkg-1.3.2-1.20.4-Fabric" = _er0m9ZRj;
        "pkg-1.3.2-1.20.1-Forge" = _Um8eSrsT;
        "pkg-1.3.2-1.20.1-Fabric" = _QXCzUZWy;
        "pkg-1.3.3-1.21.10-Forge" = _6tX5TfVV;
        "pkg-1.3.3-1.21.10-NeoForge" = _fBMqiCvL;
        "pkg-1.3.3-1.21.10-Fabric" = _C7QikFq1;
        "pkg-1.3.3-1.21.8-Forge" = _z2fH0spV;
        "pkg-1.3.3-1.21.8-NeoForge" = _UPUKHdvT;
        "pkg-1.3.3-1.21.8-Fabric" = _ri0lsu0o;
        "pkg-1.3.3-1.21.4-Forge" = _56u0t62F;
        "pkg-1.3.3-1.21.4-NeoForge" = _o1j7GMDg;
        "pkg-1.3.3-1.21.4-Fabric" = _GNzIy6IO;
        "pkg-1.3.4-1.21.10-Fabric" = _OKsG1W7u;
        "pkg-1.3.4-1.21.10-NeoForge" = _dNH3mMvs;
        "pkg-1.3.4-1.21.10-Forge" = _YVyNwrrX;
        "pkg-1.3.5-1.21.10-Forge" = _G7itEMcK;
        "pkg-1.3.5-1.21.10-NeoForge" = _vLAcbwXh;
        "pkg-1.3.5-1.21.10-Fabric" = _MmjZ1GN3;
        "pkg-1.3.5-1.21.4-Forge" = _zCHddykm;
        "pkg-1.3.5-1.21.4-NeoForge" = _bAlbMh00;
        "pkg-1.3.5-1.21.4-Fabric" = _FV3roAqx;
        "pkg-1.3.4-1.21.1-Forge" = _MeWO2fEK;
        "pkg-1.3.4-1.21.1-NeoForge" = _NbtX7ew8;
        "pkg-1.3.4-1.21.1-Fabric" = _ezGY5UyS;
        "pkg-1.3.4-1.20.4-Forge" = _oF92Z6dJ;
        "pkg-1.3.4-1.20.4-Fabric" = _PFu6nTFO;
        "pkg-1.3.4-1.20.1-Forge" = _NNM40OPO;
        "pkg-1.3.4-1.20.1-Fabric" = _Eg07jhov;
        "pkg-1.3.5-1.21.8-Forge" = _vFWjaOYL;
        "pkg-1.3.5-1.21.8-NeoForge" = _4rS8thEw;
        "pkg-1.3.5-1.21.8-Fabric" = _7HKVSJEF;
        "pkg-1.3.7-1.21.11-NeoForge" = _9NoHNDu4;
        "pkg-1.3.7-1.21.11-Fabric" = _dkqPubTj;
        "pkg-1.3.7-1.21.11-Forge" = _Xl8COdRk;
        "pkg-1.4.0-1.21.10-Forge" = _YhF92Qc8;
        "pkg-1.4.0-1.21.10-NeoForge" = _6EtZoKjC;
        "pkg-1.4.0-1.21.10-Fabric" = _turQjZ4a;
        "pkg-1.4.0-1.21.11-Forge" = _S4ON1R0w;
        "pkg-1.4.0-1.21.11-NeoForge" = _DbKqRlkx;
        "pkg-1.4.0-1.21.11-Fabric" = _cX76k4vC;
        "pkg-1.4.0-1.21.8-Forge" = _sr2AffBu;
        "pkg-1.4.0-1.21.8-NeoForge" = _ABAeEktZ;
        "pkg-1.4.0-1.21.8-Fabric" = _RLoffJuD;
        "pkg-1.3.8-1.21.4-Forge" = _8ASX6puX;
        "pkg-1.3.8-1.21.4-NeoForge" = _5ruwDySn;
        "pkg-1.3.8-1.21.4-Fabric" = _dxXj2Awv;
        "pkg-1.4.0-1.21.1-Forge" = _jwzh9l7I;
        "pkg-1.4.0-1.21.1-NeoForge" = _Dh945UI4;
        "pkg-1.4.0-1.21.1-Fabric" = _Oy3aKfpY;
        "pkg-1.4.0-1.20.4-Forge" = _dlfjfN5j;
        "pkg-1.4.0-1.20.4-Fabric" = _CgiP0GMg;
        "pkg-1.4.0-1.20.1-Forge" = _HaPgfSYJ;
        "pkg-1.4.0-1.20.1-Fabric" = _jNEuR0eS;
        "pkg-1.4.1-1.21.10-Fabric" = _jwLQLy2H;
        "pkg-1.4.1-1.21.10-NeoForge" = _sCLHxCeb;
        "pkg-1.4.1-1.21.10-Forge" = _HZuQHuZJ;
        "pkg-1.4.1-1.21.11-NeoForge" = _ArTSyvTR;
        "pkg-1.4.1-1.21.11-Fabric" = _zgV34N6p;
        "pkg-1.4.1-1.21.11-Forge" = _ULmmoDnK;
        "pkg-1.4.1-1.20.1-Fabric" = _esh2c3tr;
        "pkg-1.4.1-1.20.1-Forge" = _jFhdEFNo;
        "pkg-1.4.1-1.20.4-Fabric" = _N06Cegjl;
        "pkg-1.4.1-1.20.4-Forge" = _FichC5Na;
        "pkg-1.3.9-1.21.4-Fabric" = _osotWjeS;
        "pkg-1.3.9-1.21.4-NeoForge" = _TbnyVlHB;
        "pkg-1.3.9-1.21.4-Forge" = _U3m2nuYw;
        "pkg-1.4.1-1.21.1-Fabric" = _pT211SAf;
        "pkg-1.4.1-1.21.1-NeoForge" = _GdyO0Y08;
        "pkg-1.4.1-1.21.1-Forge" = _uoaOOiQH;
        "pkg-1.5.0-1.21.11-Forge" = _3wZS6Nae;
        "pkg-1.5.0-1.21.11-Fabric" = _OySwoa5m;
        "pkg-1.5.0-1.21.11-NeoForge" = _1RrgONQA;
        "pkg-1.5.0-1.21.10-Forge" = _uc42Fgfa;
        "pkg-1.5.0-1.21.10-NeoForge" = _RQqu8cpO;
        "pkg-1.5.0-1.21.10-Fabric" = _n15HhGc7;
        "pkg-1.5.0-1.21.8-Forge" = _GFyS1eWh;
        "pkg-1.5.0-1.21.8-NeoForge" = _g9OF3m4E;
        "pkg-1.5.0-1.21.8-Fabric" = _exwLS4sA;
        "pkg-1.5.0-1.21.1-Forge" = _XlhOUeCh;
        "pkg-1.5.0-1.21.1-NeoForge" = _3p5JPoG1;
        "pkg-1.5.0-1.21.1-Fabric" = _dy1HiIRv;
        "pkg-1.5.0-1.20.4-Forge" = _An8UVvLd;
        "pkg-1.5.0-1.20.4-Fabric" = _yHjunwX6;
        "pkg-1.5.0-1.20.1-Forge" = _AGNU7hXf;
        "pkg-1.5.0-1.20.1-Fabric" = _a2t0I0a9;
        "pkg-1.5.0-26.1-Fabric" = _YK6IAhDB;
        "pkg-1.5.0-26.1-NeoForge" = _NsssOgnj;
        "pkg-1.5.0-26.1-Forge" = _zh3ZRpyQ;
        "pkg-1.5.1-26.1.2-NeoForge" = _zzVLcy82;
        "pkg-1.5.1-26.2-NeoForge" = _CAnuw5IX;
        "pkg-1.5.1-26.2-Forge" = _tec76UIb;
        "pkg-1.5.1-26.2-Fabric" = _6PdyVpr3;
        "pkg-1.5.2-26.2-Fabric" = _yH66cUHk;
        "pkg-1.5.2-26.2-Forge" = _nD1YxlDH;
        "pkg-1.5.2-26.2-NeoForge" = _jXQfWgcX;
        "pkg-1.5.2-26.1.2-Forge" = _oeP640Gt;
        "pkg-1.5.2-26.1.2-NeoForge" = _t67budCr;
        "pkg-1.5.2-26.1.2-Fabric" = _DfcTsZH0;
        "pkg-1.5.2-1.21.11-Forge" = _eO8EKLol;
        "pkg-1.5.2-1.21.11-Fabric" = _QzA9pkSA;
        "pkg-1.5.2-1.21.11-NeoForge" = _CYSiw7Pt;
        "pkg-1.5.2-1.21.10-Forge" = _Up6I5Il4;
        "pkg-1.5.2-1.21.10-NeoForge" = _sr8gvlln;
        "pkg-1.5.2-1.21.10-Fabric" = _PklUa1FG;
        "pkg-1.5.2-1.21.8-Forge" = _XsFFMhyb;
        "pkg-1.5.2-1.21.8-Fabric" = _7MGuEOmy;
        "pkg-1.5.2-1.21.8-NeoForge" = _bXZP3eVU;
        "pkg-1.3.10-1.21.4-Forge" = _ElA8Ltsd;
        "pkg-1.3.10-1.21.4-NeoForge" = _3DHcQymK;
        "pkg-1.3.10-1.21.4-Fabric" = _A6x8CjPp;
        "pkg-1.5.2-1.20.4-Forge" = _ylKdIYgA;
