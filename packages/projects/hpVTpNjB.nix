...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.1.1" = _y8C9fKJR;
        "pkg-1.20.1-1.2" = _T3fYWban;
        "pkg-1.19.2-1.2.1" = _vkK2Y1sP;
        "pkg-1.20.1-1.2.1" = _5y3tiKLq;
        "pkg-1.19.2-1.2.2" = _41tNIkOp;
        "pkg-1.20.1-1.2.2" = _1j0ygqp2;
        "pkg-1.19.2-1.2.3" = _1LTRATUm;
        "pkg-1.20.1-1.2.3" = _aR6szufR;
        "pkg-1.19.2-1.3.0" = _16OPvxtD;
        "pkg-1.20.1-1.3.0" = _Te4AdqOA;
        "pkg-1.19.2-1.4.0" = _8gGUAePu;
        "pkg-1.20.1-1.4.0" = _qmr5ulXI;
        "pkg-1.19.2-1.4.1" = _ZWxaaUBT;
        "pkg-1.20.1-1.4.1" = _cNJIeyPK;
        "pkg-1.19.2-1.4.2" = _wxYN7fPe;
        "pkg-1.20.1-1.4.2" = _GnNnqZnq;
        "pkg-1.19.2-1.4.3" = _s8wmZTV3;
        "pkg-1.20.1-1.4.3" = _E2KHIIPW;
        "pkg-1.19.2-1.5.0" = _M2VcZhvG;
        "pkg-1.20.1-1.5.0" = _xAqNFW3T;
        "pkg-1.19.2-1.6.0" = _G8zrFVFR;
        "pkg-1.20.1-1.6.0" = _J3wS5bXb;
        "pkg-1.19.2-1.6.1" = _pCaRCD3U;
        "pkg-1.20.1-1.6.1" = _DCxpzhZI;
        "pkg-1.19.2-1.7.0" = _gsEeFVvc;
        "pkg-1.20.1-1.7.0" = _HXK1gNvj;
        "pkg-1.19.2-1.8.0" = _FlmHrBDM;
        "pkg-1.20.1-1.8.0" = _FzeMkSCl;
        "pkg-1.19.2-1.9.0" = _kDrRYC2r;
        "pkg-1.20.1-1.9.0" = _uwg5lIs9;
        "pkg-1.19.2-1.9.1" = _QXFuwVLL;
        "pkg-1.20.1-1.9.1" = _RYtawzCi;
        "pkg-1.19.2-1.9.1.1" = _3roLsK56;
        "pkg-1.20.1-1.9.1.1" = _HnPUVmEN;
        "pkg-1.19.2-1.9.1.2" = _ZFmkhRnl;
        "pkg-1.20.1-1.9.1.2" = _L6shzmZu;
        "pkg-1.19.2-1.10.0" = _NrVODHGC;
        "pkg-1.20.1-1.10.0" = _AcB6j3AL;
        "pkg-1.19.2-1.10.1" = _rFxdngb5;
        "pkg-1.20.1-1.10.1" = _JIsldnVa;
        "pkg-1.19.2-1.11.0" = _E9il8pDU;
