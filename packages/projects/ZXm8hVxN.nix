...
let
    ...
    in {
        ...
        "pkg-0.1.4+1.18" = _RC1TGhqM;
        "pkg-0.1.5+1.18" = _w1oarWbm;
        "pkg-0.1.6+1.18" = _r7vwqo8x;
        "pkg-0.1.7+1.18" = _QYGvnawy;
        "pkg-0.1.8+1.18" = _4W6fpplJ;
        "pkg-0.1.9+1.18" = _wKRb6mLN;
        "pkg-0.1.10+1.18" = _wm7yiU9I;
        "pkg-0.2.0+1.18" = _ggyN6MCN;
        "pkg-0.2.1+1.18" = _8Cm8aqQE;
        "pkg-0.2.2+1.18" = _H7xIR63z;
        "pkg-0.2.2+1.19" = _6l3rxPS0;
        "pkg-0.2.3+1.19" = _GZccdAdg;
        "pkg-0.2.4+1.19" = _H6RNXLWB;
        "pkg-0.2.5+1.19" = _Yu0uj2X9;
        "pkg-0.2.6+1.19" = _RH84wQRG;
        "pkg-0.2.6+1.19.3" = _8DB0835h;
        "pkg-0.2.7+1.19.3" = _UVycjcX7;
        "pkg-0.2.7+1.19" = _SMzZ3vSi;
        "pkg-0.2.8+1.19" = _byjB2dk6;
        "pkg-0.2.8+1.19.3" = _TBFczeiZ;
        "pkg-0.2.9+1.19.4" = _W8o5cKwW;
        "pkg-0.2.9+1.20" = _clX6jkFF;
        "pkg-0.2.9+1.19" = _kNLvUZhD;
        "pkg-0.2.10+1.20" = _Z0DuuRF5;
        "pkg-0.2.10+1.20.2" = _mv6PRcPP;
        "pkg-0.2.11+1.20.2" = _C2xn943a;
        "pkg-0.2.10+1.19" = _AsqQMuzE;
        "pkg-0.2.12+1.20.1" = _1SyRlaCy;
        "pkg-0.2.12+1.20.2" = _nGzq3Ide;
        "pkg-0.2.13+1.20" = _nM7X2AXI;
        "pkg-0.2.13+1.20.2" = _zWxDBpdg;
        "pkg-0.2.14+1.20" = _ita3zf5N;
        "pkg-0.2.14+1.20.2" = _ceXDy4BG;
        "pkg-0.2.11+1.19" = _7IIOWmX4;
        "pkg-0.2.14+1.20.3" = _Rr3Lgu4l;
        "pkg-0.3.0+1.21" = _LF9QHHlR;
        "pkg-0.3.1+1.21" = _7zSsNraB;
        "pkg-0.3.2+1.21" = _IVK9SNFp;
        "pkg-0.2.15+1.20" = _twgNwSM3;
        "pkg-0.3.3+1.21" = _zQVM4m1B;
        "pkg-0.2.11.1+1.19" = _NrjGSIkp;
        "pkg-0.2.17+1.20" = _NGw6SF32;
