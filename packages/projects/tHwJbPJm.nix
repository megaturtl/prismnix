...
let
    ...
    in {
        ...
        "pkg-2.0.3+1.19" = _KIdEZqrE;
        "pkg-2.0.3+1.19.3" = _CHcJ4OVx;
        "pkg-2.0.3+1.20" = _3JEr2A22;
        "pkg-2.1.0+1.20" = _hsgsAqBN;
        "pkg-2.1.0+1.19.4" = _algsO4L2;
        "pkg-2.1.1+1.20" = _WfXwQ35C;
        "pkg-2.1.2+1.20.4" = _9LODeKXI;
        "pkg-2.1.3+1.20.6" = _z8rBKd8i;
        "pkg-2.1.4+1.21" = _VMPfNjsh;
        "pkg-2.1.5+1.21" = _z9QlVOyl;
        "pkg-2.1.6+1.21.3" = _l90ZSgJv;
        "pkg-2.1.7+1.21.4" = _WmiKwqsX;
        "pkg-2.1.8+1.21.3" = _JGFGsNEu;
        "pkg-2.1.9+1.21.3" = _TOVGp9T9;
        "pkg-2.1.10+1.21.3" = _RjKmqUJN;
        "pkg-2.1.11+1.21.9" = _JfHYYf09;
