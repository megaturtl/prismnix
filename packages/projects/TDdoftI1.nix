...
let
    ...
    in {
        ...
        "pkg-2.6.8" = _22TG8scr;
        "pkg-2.6.9" = _kNFLTCDT;
        "pkg-2.6.10" = _JQVgV19Y;
        "pkg-2.6.11" = _qNYpNt7q;
        "pkg-2.6.12" = _2gcvnEMc;
        "pkg-2.6.13" = _P5M4dbHO;
        "pkg-2.7.0" = _UhYmFllH;
        "pkg-2.7.1" = _z4Rybqtb;
        "pkg-3.3.1" = _PewZ9EnG;
        "pkg-3.3.2" = _vjNC9KR4;
        ...
        "pkg-3.3.5" = _7a9WKeH8;
        "pkg-3.3.6" = _EtXZ60iI;
        "pkg-3.3.6.1" = _pEqeY4lr;
        "pkg-3.3.6.2" = _oyaKmLCt;
        "pkg-4.0.0.0-beta" = _iJqFtMe9;
        "pkg-4.0.0.1-beta" = _FFFI46GL;
        "pkg-4.0.0.2-beta" = _95KIDyGL;
        "pkg-4.0.0.3-beta" = _36at0K7W;
        "pkg-4.0.0.4-beta" = _1HEUtz3A;
        "pkg-4.0.1.0-beta" = _bM3f819C;
        "pkg-3.3.6.3" = _PB1eg5NI;
        "pkg-4.1.0.0" = _538LxAV3;
        "pkg-3.3.6.4" = _HLq7xuja;
        "pkg-3.3.7.0" = _tmWZhTW4;
        "pkg-3.3.7.1" = _7SloJMw0;
        "pkg-4.1.0.1" = _VxuGZvp1;
        "pkg-4.1.0.2" = _VRrjSJZk;
        "pkg-3.3.7.3" = _JTMTbZMb;
        "pkg-4.1.1.1" = _aLmTWPSD;
        "pkg-4.1.1.2" = _q5YkL6wX;
        "pkg-4.1.2.0" = _zUwKLJir;
        "pkg-4.2.0.0" = _ce8qoJra;
        "pkg-4.2.0.1" = _WCg3JH14;
        "pkg-4.2.0.2" = _fD5U8Lkn;
        "pkg-4.2.1.0" = _uh476mZI;
        "pkg-4.2.1.1" = _GF8Qllya;
