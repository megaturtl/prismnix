...
let
    ...
    in {
        ...
        "pkg-BETA-1.4.2" = _HfqUjAjU;
        "pkg-BETA-1.4.3" = _E6a48Ots;
        "pkg-1.20-1.4.4" = _bruRbOeL;
        "pkg-1.20.1-5.0" = _xrzWBdQB;
        "pkg-1.20.1-1.5.1" = _ickiIhIF;
        "pkg-1.20.1-1.5.2" = _TmUx5mOh;
        "pkg-1.20.1-1.5.3" = _aQUJtGAL;
        "pkg-1.20.1-1.5.4" = _aOSpRCm0;
        "pkg-1.20.1-1.5.5" = _RjKyDTON;
        "pkg-1.20.1-1.6" = _3DECeeZt;
        "pkg-1.20.1-1.6.1" = _84qCXCdN;
        "pkg-1.20.1-1.6.2" = _jkzvWfXa;
        "pkg-1.20.1-1.7" = _Fxs48pVF;
        "pkg-1.20-1.20.1-1.7.1" = _MbJcSswD;
        "pkg-1.20.1-1.7.1-hotfix" = _lR5jtHd4;
        "pkg-1.20.1-1.7.2" = _SalUpSUw;
