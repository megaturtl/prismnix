...
let
    ...
    in {
        ...
        "pkg-1.7.8" = _bHz7rzT5;
        "pkg-1.7.9" = _kn0bcQWx;
        "pkg-1.7.10" = _4NY9jYga;
        "pkg-1.7.11" = _RvF9jx3m;
        "pkg-1.7.12" = _QhoWmOfE;
        "pkg-1.7.13" = _y5cp3eqN;
        "pkg-1.7.14" = _fFjQznFn;
        "pkg-1.7.15" = _aafDa4Ae;
        "pkg-1.7.16" = _chzr74Zb;
        "pkg-1.7.17" = _BZ0VTvve;
        "pkg-1.7.18" = _NAqRaxh2;
