...
let
    ...
    in {
        ...
        "pkg-6.0.1" = _tSxwjzvx;
        "pkg-8.0.0" = _swaJoa2D;
        "pkg-8.1.0+fabric" = _xLBkqCvs;
        "pkg-8.1.0+forge" = _9IWkfX7V;
        "pkg-9.0.0+fabric" = _KinZ954J;
        "pkg-9.0.1+fabric" = _cesYzmyi;
        "pkg-9.0.2+fabric" = _6oQGQHYa;
        "pkg-9.0.2+neoforge" = _OtaI5jfL;
        "pkg-9.0.3+neoforge" = _NSFmUuxQ;
