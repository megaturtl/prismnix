...
let
    versions = (let
        ...
        _Qhg472r3 = {
            "id" = "Qhg472r3";
            "file" = "探险者指南针结构汉化 v3.3.zip";
            "hash" = "sha512-H4GCQuXSnz75USrRBOgYk1ONd5RiYl6vm5vNd2J4OoXnO5Nsh1kGMQ4Kmntj0J5YJq4mN5btRoCFZr6MCW5Fzw==";
        };
    in {
        "bNBgk0Pb" = _bNBgk0Pb;
        "flehTJBZ" = _flehTJBZ;
        ...
        "jViYOYNN" = _jViYOYNN;
        "Qhg472r3" = _Qhg472r3;
        "minecraft-1.16.5" = _Qhg472r3;
        "minecraft-1.18.2" = _Qhg472r3;
        "minecraft-1.19.2" = _Qhg472r3;
        "minecraft-1.19.4" = _Qhg472r3;
        "minecraft-1.20" = _Qhg472r3;
        "minecraft-1.20.1" = _Qhg472r3;
        "minecraft-1.20.2" = _Qhg472r3;
        "minecraft-1.20.3" = _Qhg472r3;
        "minecraft-1.20.4" = _Qhg472r3;
        "minecraft-1.20.5" = _Qhg472r3;
        "minecraft-1.20.6" = _Qhg472r3;
        "minecraft-1.21" = _Qhg472r3;
        "minecraft-1.21.1" = _Qhg472r3;
        "minecraft-1.21.3" = _Qhg472r3;
        "minecraft-1.21.4" = _Qhg472r3;
        "minecraft-1.21.5" = _Qhg472r3;
        "minecraft-1.21.6" = _Qhg472r3;
        "minecraft-1.21.7" = _Qhg472r3;
        "minecraft-1.21.8" = _Qhg472r3;
        "minecraft-1.17" = _Qhg472r3;
        "minecraft-1.17.1" = _Qhg472r3;
        "minecraft-1.18" = _Qhg472r3;
        "minecraft-1.18.1" = _Qhg472r3;
        "minecraft-1.19" = _Qhg472r3;
        "minecraft-1.19.1" = _Qhg472r3;
        "minecraft-1.19.3" = _Qhg472r3;
        "minecraft-1.21.2" = _Qhg472r3;
        "pkg-v2.7" = _bNBgk0Pb;
        "pkg-v2.8" = _flehTJBZ;
        "pkg-v2.9" = _mxqslqiY;
        "pkg-v3.0" = _njBNu0gj;
        "pkg-v3.0hf" = _xyvQ7PnK;
        "pkg-v3.1" = _JBAZvpmX;
        "pkg-v3.2" = _jViYOYNN;
        "pkg-v3.3" = _Qhg472r3;
        "default" = _Qhg472r3;
