...
let
    versions = (let
        ...
        _iKVJ2j5h = {
            "id" = "iKVJ2j5h";
            "file" = "elytra_red_dragon-1.0.1-mc26.3.zip";
            "hash" = "sha512-1YWRqdS8kbWrArhB1CX6kjfLnuwq0iVDKS7HVYk2olpNQ2F9cpU4LUjfCuE1odIqsgOArUUyeHvRiG9Y+h8BcA==";
        };
    in {
        "P5CreNiY" = _P5CreNiY;
        "m6vs7FY2" = _m6vs7FY2;
