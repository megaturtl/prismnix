...
let
    versions = (let
        ...
        _CXMZOQRp = {
            "id" = "CXMZOQRp";
            "file" = "MagicLib-mc1.14.4-fabric-0.8.863-beta.jar";
            "hash" = "sha512-NjRl0cNCnc5e+il4QljCbgQLbUJ2QxdMzX9/XVWLmq/QggcjJ0lokNl3HnK7qwjF13bXD7hiq3xbgHrrrckDWQ==";
        };
        _LQBE2566 = {
            "id" = "LQBE2566";
            "file" = "MagicLib-mc1.15.2-fabric-0.8.863-beta.jar";
            "hash" = "sha512-toaQnBQGo/7FtuVnhtOM73GRqTWIE7Fa/x5l2mYHzFnRDQ1xIb00wWQXBVn44xktrtlGlxj7iF0+x8udMP9zlA==";
        };
        _axwAXlQS = {
            "id" = "axwAXlQS";
            "file" = "MagicLib-mc1.16.5-fabric-0.8.863-beta.jar";
            "hash" = "sha512-HS4woq7+oAuLXJccztAU5nRtV8Ez5kbUDYebdwODMg5K/LjI7Mb9wQ50b/nPAq3WCbFcKWBllEAbNBVkK0fopg==";
        };
        _mZu6u6c4 = {
            "id" = "mZu6u6c4";
            "file" = "MagicLib-mc1.17.1-fabric-0.8.863-beta.jar";
            "hash" = "sha512-L++x/40z6bd9CFzrTsBUJoiIlivI5RSiAnQWDnxBKw4ORpo/2DuCX1MReEzmEG9Sy667QF225x3hN1XOMA6KzA==";
        };
        _vfqASR4j = {
            "id" = "vfqASR4j";
            "file" = "MagicLib-mc1.18.2-fabric-0.8.863-beta.jar";
            "hash" = "sha512-SmJx/yY8t0dMTovcZeSte5DFyKYv1bjp4e62Z2Y42w0Rk9fdwBwImjq3KiP8++GngHS8Lb6jmAvHVxmcdzJiQQ==";
        };
        _Iz7r4s2f = {
            "id" = "Iz7r4s2f";
            "file" = "MagicLib-mc1.19.2-fabric-0.8.863-beta.jar";
            "hash" = "sha512-MHn1kJTdE2d34e2mDmE0GTCReAMpapIWKl0WWMs9rOAibPJdOM6gZI2cupK+yt4XtU/mlUEFPtUqpWFu6c3YSQ==";
        };
        _zW4dMznB = {
            "id" = "zW4dMznB";
            "file" = "MagicLib-mc1.19.3-fabric-0.8.863-beta.jar";
            "hash" = "sha512-4dv9NGwHwJMBjwHQItfYqa+z7HCQoS/riPiLH838LL9rsW5xPT9Pv30n6WGPsG4PCzt/2LGn0BISfFun5yBX9A==";
        };
        _KkHWKFsk = {
            "id" = "KkHWKFsk";
            "file" = "MagicLib-mc1.19.4-fabric-0.8.863-beta.jar";
            "hash" = "sha512-ghEMGrVTrg3WVE6yfz2EDXGPnS+B/VIzAbHXzMOB+wHvRQNx30TWjJMgNMnAXxpjmdM3WmONhXWag98/imq3Sw==";
        };
        _KzhuA7yG = {
            "id" = "KzhuA7yG";
            "file" = "MagicLib-mc1.20.4-fabric-0.8.863-beta.jar";
            "hash" = "sha512-3IVz+o4hJXCrqpcGxEmY4lDhAfqajQryLcLb2YnGnauxIrZIyvhC0gLLhmTdI6YgKpLXgVky8YlCxU06mVVMYQ==";
        };
        _dcF6621a = {
            "id" = "dcF6621a";
            "file" = "MagicLib-mc1.20.2-fabric-0.8.863-beta.jar";
            "hash" = "sha512-vX7cmQYRqTBDdWEPmB2TVcrwDS/9K4eRYUrQ/4FEGeEF1h+kRnUidIXqp56fzKnIFwsIdxYqI5ZBhC605eECdA==";
        };
        _cZD9G9lP = {
            "id" = "cZD9G9lP";
            "file" = "MagicLib-mc1.21.1-fabric-0.8.863-beta.jar";
            "hash" = "sha512-4xzcm+JDYWktuVHxFiFRN/rWkNl4zPaqUM2eXqG8EcCNLx2+BhVb+D2qboGQkWsE5NkIN3vys+esqMnGg8zPMg==";
        };
        _7bSGn8Hy = {
            "id" = "7bSGn8Hy";
            "file" = "MagicLib-mc1.20.6-fabric-0.8.863-beta.jar";
            "hash" = "sha512-HK9M4EQgGKu/UCGapxlGFLujqsg0T5SBxombIVEElg2VrUqpFmKs+QlWgZYIvOLmUGqAsXSlHkz9FhtNVRe+Jw==";
        };
        _KgZI9HCa = {
            "id" = "KgZI9HCa";
            "file" = "MagicLib-mc1.21.10-fabric-0.8.863-beta.jar";
            "hash" = "sha512-BOFyUbYG0p0coRv4b5bT3gvXZ9GxUnY+ezAQp+TRHbETW5HPDQKxS3NPU+rsR9Sb+DC/PLFw0q11Or6i/Gdv2Q==";
        };
        _2t8J9Pwa = {
            "id" = "2t8J9Pwa";
            "file" = "MagicLib-mc1.20.1-fabric-0.8.863-beta.jar";
            "hash" = "sha512-RpVZwT/PmYBqqDeQ2Cb2J5lJMI4/S2/P8FokHjeFRgAqGJ0+UYXzATeGPcvxQftNSBhawLOJD0gka/ZCR05U5w==";
        };
        _a9KIxXem = {
            "id" = "a9KIxXem";
            "file" = "MagicLib-mc1.21.3-fabric-0.8.863-beta.jar";
            "hash" = "sha512-bc6Zs6UvfuV0o4LNWBa8CYZJyt7d7bRHC4q3cMbso5lXvF3IBf3a0gyBWjLN5P9XSys5WpBdyfZprWC/Q/OA8w==";
        };
        _jT4UPNbU = {
            "id" = "jT4UPNbU";
            "file" = "MagicLib-mc1.21.10-fabric-0.8.863-beta.jar";
        ...
        _uyJUbXHm = {
            "id" = "uyJUbXHm";
            "file" = "MagicLib-mc1.21.11-fabric-0.8.863-beta.jar";
            "hash" = "sha512-BbBgtMLQpZDm30lSpULM35nYvrQbMiTr7DNKYaG3uqInjZSduBVAxKzl/naOnOcLkqdWdaqf/Cow/yEXxoqjew==";
        };
        _KHJjaTGD = {
            "id" = "KHJjaTGD";
            "file" = "MagicLib-mc1.21.5-fabric-0.8.863-beta.jar";
            "hash" = "sha512-jDsLyfi8W2L8zsre8gy6EgnzbohotgdCQLGdRYhfvaQUIRBXVmQAMVC9w3THBz8S2YKUc1yilRjvuCryIJ0yJw==";
        };
        _2kiPblBd = {
            "id" = "2kiPblBd";
            "file" = "MagicLib-mc1.21.3-fabric-0.8.863-beta.jar";
        ...
        _yho8wZvF = {
            "id" = "yho8wZvF";
            "file" = "MagicLib-mc1.21.4-fabric-0.8.863-beta.jar";
            "hash" = "sha512-SXa+pBBas7H9Z3tCd6qzBslfl7jp9zShdK5atfgPdCqdFGT5iHf3CwrWAqd57GtOWV7vT7hH9veNQzNvNeMQwQ==";
        };
        _Gcasw4wJ = {
            "id" = "Gcasw4wJ";
            "file" = "MagicLib-mc1.21.11-fabric-0.8.863-beta.jar";
        ...
        _THiCahMH = {
            "id" = "THiCahMH";
            "file" = "MagicLib-mc1.21.8-fabric-0.8.863-beta.jar";
            "hash" = "sha512-S5Ik4yTzOg2Ka3eK/mUPskC+vHjAbQZJSpEhhg41JK63LVYavZtkM4BRt0ihVxQlfzXS4YiLgfpuueRzZikbQA==";
        };
        _NxnYVhwv = {
            "id" = "NxnYVhwv";
            "file" = "MagicLib-mc1.21.3-fabric-0.8.863-beta.jar";
        ...
        _RFw4Y3pk = {
            "id" = "RFw4Y3pk";
            "file" = "MagicLib-mc1.18.2-forge-0.8.863-beta.jar";
            "hash" = "sha512-PXsqMJAgCKvWik2hP1gGwVukK/yY6LMBVTQ8HlCR3x2NkR4QNcnR5C2tGqb+hpxJ/5ka/PJtyIr0n6FWE9sWjA==";
        };
        _BzVAujWs = {
            "id" = "BzVAujWs";
            "file" = "MagicLib-mc1.17.1-forge-0.8.863-beta.jar";
            "hash" = "sha512-OnkZEptXQJqJOF33kngiI0ceDmO+barWNwMDMVxtNjRxhBjMMqklzhuyHN4eWPGaQl7z3mVTuWW9n/75OLtmaQ==";
        };
        _hGL2bG4t = {
            "id" = "hGL2bG4t";
            "file" = "MagicLib-mc1.20.1-forge-0.8.863-beta.jar";
            "hash" = "sha512-Fg+wdoBKqkvnA24rVYlcoHIIMKdMtxkVxQFslhTCPIf9iz9RIl2yRpKjJ8fS6WJLSAt9Cx+iKFgZWTOdOQ9UGg==";
        };
        _241NUYRB = {
            "id" = "241NUYRB";
            "file" = "MagicLib-mc26.1.2-fabric-0.8.863-beta.jar";
            "hash" = "sha512-PNNXO4/VZxTuE/GrRYBxmdrvnQTAd1K6F3g84Z59HfQxPT3FLwvwsJm7BoyyRvvTBdjphQVtkmsXFJ7ouPW23A==";
        };
        _WlFQTfey = {
            "id" = "WlFQTfey";
            "file" = "MagicLib-mc1.19.4-forge-0.8.863-beta.jar";
            "hash" = "sha512-eVEQ4ji5tpdXbtExhZSQ2bToEyXMhAvvuF0hgDKDcnuuXAhi71cftelvD8fqOStzyMp9XHCyV9ArAAKdXt1djQ==";
        };
        _WebZlgBx = {
            "id" = "WebZlgBx";
            "file" = "MagicLib-mc26.2-fabric-0.8.863-beta.jar";
            "hash" = "sha512-6QyZEmMOXLbdF7Ri/mCw8qsogT8EHtiJ0laRI1xAtJ0rd3PU+H1E2evlJZyDbTF2ZUt0pxRJxZ3TQyTwFX+JKA==";
        };
        _qYG0DkVN = {
            "id" = "qYG0DkVN";
            "file" = "MagicLib-mc1.20.6-neoforge-0.8.863-beta.jar";
            "hash" = "sha512-R6K658Q0osG7sJZibS1mlSMzOZ86TfQN5lDQWNKHwIpv4g3bXSwbRwI6BDry1nl6F/ZO++CZCiLYqNIUzeNPpQ==";
        };
        _13Hwhzjz = {
            "id" = "13Hwhzjz";
            "file" = "MagicLib-mc1.20.2-neoforge-0.8.863-beta.jar";
            "hash" = "sha512-ar8kY9Qfh9nfMGShQ8H+FOEnCiQrAsTWPzn5863MWY7eFWj4Du+NL2sv4iUmXzl+Fs0tx1ehaq8y3BGfRMUSog==";
        };
        _x6hJo7LV = {
            "id" = "x6hJo7LV";
            "file" = "MagicLib-mc1.21.10-neoforge-0.8.863-beta.jar";
            "hash" = "sha512-OaeVtF8bPSsU13kS+GjwnCjp32LO9SzT+t56U8W/NFa1L7uhpYBEtpDSCmS1Xqo/fiKVd1k9oiMhJWiOF28dbw==";
        };
        _pf4Ex0Fl = {
            "id" = "pf4Ex0Fl";
            "file" = "MagicLib-mc1.21.1-neoforge-0.8.863-beta.jar";
            "hash" = "sha512-OGg3EMUZckyMVIb+vR802zmy0XzZ+Lsd/Y1t3Za6vLsCSN5Nw6nzDdo4RPdk9xgeJHM6GSijXFWRZA4F6//FGQ==";
        };
        _nmc84iEI = {
            "id" = "nmc84iEI";
            "file" = "MagicLib-mc1.21.3-neoforge-0.8.863-beta.jar";
            "hash" = "sha512-4NWQ1Tdt4auOBKjhGBENdxAOU38F9YAOKT+h1e94dJAs1VKT9PU98RdEcZ3utblX4IEs9Dcds8l1bR+aA/s65w==";
        };
        _q0m24UL5 = {
            "id" = "q0m24UL5";
            "file" = "MagicLib-mc1.21.11-neoforge-0.8.863-beta.jar";
            "hash" = "sha512-8KUuc2ZCdHgFC0HxwP2to+EihEsiGXP8479HM1vvM1DjqUQxfvOcbPvww+plVJX3MPYSnWRIA5s7oHzb3eklXg==";
        };
        _ndBSEjSY = {
            "id" = "ndBSEjSY";
            "file" = "MagicLib-mc1.21.5-neoforge-0.8.863-beta.jar";
            "hash" = "sha512-EbwwniWjJfZd913oVAyeo6v8TUhUhAUEQJALn4qk6jdRACmovSKM/pEOjmzes+O2dcUhYE7PVmP3WZYgFUjkqg==";
        };
        _XCfOFFKk = {
            "id" = "XCfOFFKk";
            "file" = "MagicLib-mc1.21.8-neoforge-0.8.863-beta.jar";
            "hash" = "sha512-4Qzy10KL3JDbUrdqhF2rm0sSeWuUANc/sQKh/QSjP2KbnBQHyUsgvQhyOmWS/0kB+z+2qJCdGai2U8smezCQQg==";
        };
        _FdjbTBZM = {
            "id" = "FdjbTBZM";
            "file" = "MagicLib-mc1.21.4-neoforge-0.8.863-beta.jar";
            "hash" = "sha512-GT+nYnTheoZMHm4XknDd4Vfnc4njWv4AmcdGIqELwtHA6IqDMehHa6OcMTDpYBaZnfXOKq4CR7Ald9jK48irvQ==";
        };
        _MJXybQQD = {
            "id" = "MJXybQQD";
            "file" = "MagicLib-mc26.2-neoforge-0.8.863-beta.jar";
            "hash" = "sha512-qtjXL4DJ3U4oqhd/8dJv7EEJwcqRG0MlW3Fg/u0cwTXYyC82BXbVNtKi0c3B2U9jyeCiyLAVv864efC01RRJsQ==";
        };
        _VeVBjR9b = {
            "id" = "VeVBjR9b";
            "file" = "MagicLib-mc26.1.2-neoforge-0.8.863-beta.jar";
            "hash" = "sha512-uRZ1uwxqUaNF6XGpwbwV/Rf+2dq14Qc9SZ5PHvwJzxTWeNVcw8+iE1Keg7H5S+N/O+GuuzSZRGVOcDmRBNePfQ==";
        };
        _aUqoWKIO = {
            "id" = "aUqoWKIO";
            "file" = "MagicLib-mc1.14.4-fabric-0.8.873-beta.jar";
            "hash" = "sha512-l06thXEGqvmtPjmS4Cbytw+w+EN/2cPhCQZ9PwZVug8+LQn7sKmndgEaq08NgcYQSRFBowE51y0ARGQk5UFQMg==";
        };
        _EdahNhPO = {
            "id" = "EdahNhPO";
            "file" = "MagicLib-mc1.15.2-fabric-0.8.873-beta.jar";
            "hash" = "sha512-Cz4Vw4vnbHXJro1aztsM+PjETK9HWaZ5ao3Dvrzu0QeU8mcOyQ7xLRcV2ml6xO3r6dcn0O6ffrrKIYtFIdLo6Q==";
        };
        _SOVVJ9wq = {
            "id" = "SOVVJ9wq";
            "file" = "MagicLib-mc1.16.5-fabric-0.8.873-beta.jar";
            "hash" = "sha512-Rx3b4Gbc7zKnxozcGsliaUJzaRiQTOHt+XaLI4Sg5G7IjoX8e+wZx8k0os8nyBoSFAsFSvQOjcXz8cAM5+7LJA==";
        };
        _PFLWhzDo = {
            "id" = "PFLWhzDo";
            "file" = "MagicLib-mc1.17.1-fabric-0.8.873-beta.jar";
            "hash" = "sha512-hw0CfnF3n02hbXyTCsZhzEyK8/J9FLfpvs+DPYxbTYWCLmV43mpJdsfPsma6PxuvjtiVGiGsN5hYNlld4Mya6g==";
        };
        _4gZNGEtT = {
            "id" = "4gZNGEtT";
            "file" = "MagicLib-mc1.19.2-fabric-0.8.873-beta.jar";
            "hash" = "sha512-5aE+E5IamsgmNXWMEB/isV4reVJwe/g9W5Z4WCrtOy0MW0loaKJSB03CLOMROJl4napn/usDKMIZqmBPsQ5Rhw==";
        };
        _Forqimhj = {
            "id" = "Forqimhj";
            "file" = "MagicLib-mc1.18.2-fabric-0.8.873-beta.jar";
            "hash" = "sha512-jNzyiWdz4KbW4ot2wntZR22HNZVwPGVn5fzkGiEtO4TTZhqhLZWEcX9h3BRWrT90obra6QPbe1iuKydDsrCsOA==";
        };
        _ADn2viSA = {
            "id" = "ADn2viSA";
            "file" = "MagicLib-mc1.19.3-fabric-0.8.873-beta.jar";
            "hash" = "sha512-9zb6uTuh+XyXOxtJbsa5zlyYHkW9UkC9TkseS8cSRDHuEBjJnGvFp/hnLY/5VNXIc1tOs6fSdewmJ5lB0xSJ9Q==";
        };
        _pdymjTwd = {
            "id" = "pdymjTwd";
            "file" = "MagicLib-mc1.20.1-fabric-0.8.873-beta.jar";
            "hash" = "sha512-3Lz/0NFsn0nO/u6uClUwtaa01Df9rQCj0PbA2/MxuH4W6jcu1HTryq4wIioH84KB+1Da+9UzPKR4hz1+1JC4Qw==";
        };
        _BrKxgmED = {
            "id" = "BrKxgmED";
            "file" = "MagicLib-mc1.19.4-fabric-0.8.873-beta.jar";
            "hash" = "sha512-mUtxhRf3w05HXKUHIywan4lcU8Fdv/CftEE4UDUOsqZcq2OzvPe+HwQgf3c1BwrVcrlfvAswSVKz+eh8+vHBNw==";
        };
        _YXFTuY7N = {
            "id" = "YXFTuY7N";
            "file" = "MagicLib-mc1.20.4-fabric-0.8.873-beta.jar";
            "hash" = "sha512-pdokosKYwKvXy4SJLI7KFmzeLOKe4taO/AnOFh8U5vv9+KddxGDSO5S7WjYh3WegRmfsDeqmSWrPjhKFWyjnKw==";
        };
        _MUv7Vr7e = {
            "id" = "MUv7Vr7e";
            "file" = "MagicLib-mc1.20.2-fabric-0.8.873-beta.jar";
            "hash" = "sha512-C0wMSlMOKti1Oh8PJV59fKZladQ1tEgFpCCodl0F1KAkjI7tZKd3g5XSJ35s0M5x9uESL9uPt+vHT2BV1MfZmw==";
        };
        _CO6RpPk5 = {
            "id" = "CO6RpPk5";
            "file" = "MagicLib-mc1.20.6-fabric-0.8.873-beta.jar";
            "hash" = "sha512-kR4xxAPzXbtQTFTdgds3f5aKGmukh7TQheYU+2oi54HYDCdzh/Kl6OXtL8G7aEGzv5uPd4VAzSTCF1OxAV7yFQ==";
        };
        _CEvJIPfx = {
            "id" = "CEvJIPfx";
            "file" = "MagicLib-mc1.21.1-fabric-0.8.873-beta.jar";
            "hash" = "sha512-CK4mpGdlZkIXYFiuBqorxJa5Q0Wyu/TrxJUZc2swukGTpLBS70Pj2HjRnPt4P09AWDDdY2OKrcKkDUXcNmsR0A==";
        };
        _UmRQcsPw = {
            "id" = "UmRQcsPw";
            "file" = "MagicLib-mc1.21.10-fabric-0.8.873-beta.jar";
            "hash" = "sha512-C/sjDY3d3i7TM3echyUJQPvgIOeVjSiNWjsLzKILb5Xrt8kjzX93oEAajzLaajzrrdOBMBW7BqBXCRPh0FkLHg==";
        };
        _p3I8EZQD = {
            "id" = "p3I8EZQD";
            "file" = "MagicLib-mc1.21.3-fabric-0.8.873-beta.jar";
            "hash" = "sha512-I2RC9TzSGfwQv2tm3Sph3uiK8i3MgHF9o2dBfCl5WaUOsAiOOQ3e2bLAIu+fXPT//48bZlA5Ne0GppfKUh0/lA==";
        };
        _9ngBajGy = {
            "id" = "9ngBajGy";
            "file" = "MagicLib-mc1.21.11-fabric-0.8.873-beta.jar";
            "hash" = "sha512-uJZQqmVhyyaSEmAAcXY8XC8jFkvo9Z7yQQEv1RXGoH2hSNk6+xxm2qMVI91hYV3z/WKMW7g0Uu8f/46es79ODw==";
        };
        _cdwImLwI = {
            "id" = "cdwImLwI";
            "file" = "MagicLib-mc1.21.4-fabric-0.8.873-beta.jar";
            "hash" = "sha512-ZvOSNV+bX11ELTCecBy3f1nVMFx2JPlTQzFVb1xTw1Te3gTlYSWEYVDldMCJG5CinqERv+eOLTt1LjNJcfUrLQ==";
        };
        _sgTYgkbu = {
            "id" = "sgTYgkbu";
            "file" = "MagicLib-mc1.21.5-fabric-0.8.873-beta.jar";
            "hash" = "sha512-739oWPsDb9UuQn0PHjqiwELzi2FwORe0rat7UjIc9aW+pKVdeEPsXRMj8wSJE4GrFeFGAQNsZRj+YIm2QtgfXg==";
        };
        _Afhb67tc = {
            "id" = "Afhb67tc";
            "file" = "MagicLib-mc1.21.8-fabric-0.8.873-beta.jar";
            "hash" = "sha512-As//k38tbhATCvB7dre/Vr7lpf1x7QaPT+T+PxpkHs0kIGdRejIOKUCTkr6YhMcOIU8YYIztuyTW8NO7hS7xKg==";
        };
        _6V6TBcKU = {
            "id" = "6V6TBcKU";
            "file" = "MagicLib-mc26.1.2-fabric-0.8.873-beta.jar";
            "hash" = "sha512-JiDSid6Y7yMC0PCVCQa0O2rxg+cNot867lir1yNErTnOKDuSqbMU3q7lmDnUmSSXjz2wflGBxGA4hW1bD9VYaA==";
        };
        _soyFmVVw = {
            "id" = "soyFmVVw";
            "file" = "MagicLib-mc1.17.1-forge-0.8.873-beta.jar";
            "hash" = "sha512-ta2uZ4Rxb0aThTD86nSVIikiauYZ+Xc4R+u7/GDCNg0YXcqxUUAhz3NLdROv67mNPEbZVP/myP49i9kxQr+Jiw==";
        };
        _d0MSb304 = {
            "id" = "d0MSb304";
            "file" = "MagicLib-mc26.2-fabric-0.8.873-beta.jar";
            "hash" = "sha512-wBxedRwli0nLxmI4oxy8dG3eqBtNAQDf4vYMvD/jp8s66k3rxz7rzRMjufvwMf+PpPWx6FGH53NWW4JGGYdhNQ==";
        };
        _m6jNmcrP = {
            "id" = "m6jNmcrP";
            "file" = "MagicLib-mc1.18.2-forge-0.8.873-beta.jar";
            "hash" = "sha512-fuy4t/rRMtXl+M34NoP6ZVgRKCkMg4mb0YUtABTz8i5qpbxuovLOnOr36IPWXL62UVH6KoZGaNgrc7PLUzWMbQ==";
        };
        _gTXo4CWU = {
            "id" = "gTXo4CWU";
            "file" = "MagicLib-mc1.19.4-forge-0.8.873-beta.jar";
            "hash" = "sha512-pDZqO/MOsKI8qHie3a/IWquV1iGzVx62T7gJjjBDyMD8Cpm0qgUetiwdDxz4MlP5hZN6fhlxHwknuZ2PkIjwhg==";
        };
        _hsqlhPOY = {
            "id" = "hsqlhPOY";
            "file" = "MagicLib-mc1.20.1-forge-0.8.873-beta.jar";
            "hash" = "sha512-Wn/zbpln2cLpg5jV66IRqEQacKb8qAmWLIq3AAHAXzfO6mhRdFzhG0+yLHG1FpsTC2qvm0+kwp5QoXco9zDnrA==";
        };
        _GSY3WjDa = {
            "id" = "GSY3WjDa";
            "file" = "MagicLib-mc1.20.2-neoforge-0.8.873-beta.jar";
            "hash" = "sha512-BuY0GlRjM0iVXXwfkERmPNRYheCZu81nAyQPkFn4hw0nOZmWqSOef3+jMvkWXHfdJlicHB1H1Ghk7d6J/ZS/gQ==";
        };
        _QBYIQpwc = {
            "id" = "QBYIQpwc";
            "file" = "MagicLib-mc1.20.6-neoforge-0.8.873-beta.jar";
            "hash" = "sha512-kaUwtE6k2Mx6LHiv9DylJP+SrCA7UzFywvDWDl4ULTUhZTzUtPPn2SBp8lIzZdThKra1Ox9wHMQjAeIcoPhBqg==";
        };
        _QUNBFk3O = {
            "id" = "QUNBFk3O";
            "file" = "MagicLib-mc1.21.1-neoforge-0.8.873-beta.jar";
            "hash" = "sha512-3PDrZ6BbfqpQyofLeB3i67g+MigVS2EcTdQGsZJxzVGGVyFwNFYhdwx9NGvLF8OGVV/Beh9ijsqHusWRTqoGrQ==";
        };
        _uB2qzFCD = {
            "id" = "uB2qzFCD";
            "file" = "MagicLib-mc1.21.10-neoforge-0.8.873-beta.jar";
            "hash" = "sha512-XfDFvtnk2XkW07P4OSodiR9weenA09NY3b4ZmcQSiLDTt3UEf1ITTByDdHjAZvXxv17UILUEgV0bZm5T7YmC/A==";
        };
        _gM2flBpj = {
            "id" = "gM2flBpj";
            "file" = "MagicLib-mc1.21.3-neoforge-0.8.873-beta.jar";
            "hash" = "sha512-6z55UZ13KMUHglenqctq6MgWKjeIwxSa0s+aM430K943SnXlAX0s+m28NdeXa+n87UUclaTBYSuZ4W1R39jpdA==";
        };
        _hUxG2uUm = {
            "id" = "hUxG2uUm";
            "file" = "MagicLib-mc1.21.11-neoforge-0.8.873-beta.jar";
            "hash" = "sha512-la5L40L647drTwnrNmth8gFVS+3F75AzI4VoA2P8V77vAMlnnfWn6pOlkc+7T+DiM+DRx02a2SQRCBxynBy3gQ==";
        };
        _did5H2VD = {
            "id" = "did5H2VD";
            "file" = "MagicLib-mc1.21.4-neoforge-0.8.873-beta.jar";
            "hash" = "sha512-PKF57aYJXRGp9xaoXqvpfbP388S8s3SaBdHNNcZdI+bjJCEc2lauFi9Oq/YVXDjQUxF6uBafLU8qdHnAdmwDnw==";
        };
        _97vte51T = {
            "id" = "97vte51T";
            "file" = "MagicLib-mc1.21.5-neoforge-0.8.873-beta.jar";
            "hash" = "sha512-KjLDmjePb+D2hkgKuYDMwvqWYy636q7ixO0XcyYLg7qIdgbWEqgCM0rjLkChMB9biFqmTFi/M8mK8AlF3x/Jdg==";
        };
        _x1ikXP4V = {
            "id" = "x1ikXP4V";
            "file" = "MagicLib-mc26.1.2-neoforge-0.8.873-beta.jar";
            "hash" = "sha512-tM+jPA+giy9B+sazYdsAoDWpDUu83j8CR2qHEJiu8FPXsJOaz+mSbRT0FhPFZDwY13qzcFJKMMwaCwGzMDYIEA==";
        };
        _jl8Eq2Ap = {
            "id" = "jl8Eq2Ap";
            "file" = "MagicLib-mc26.2-neoforge-0.8.873-beta.jar";
            "hash" = "sha512-RK+b1ypXcYbBoiKiNy8nrmHRj6Ilrzd75H0vfh0X0mDMFUz028GN//VvbF2zpGDv8lzLpEP2aUqdAeWRa9CDgQ==";
        };
        _436tTgc3 = {
            "id" = "436tTgc3";
    ...
    in {
        ...
        "pkg-0.8.542+6347e63" = _jWeeaMvW;
        "pkg-0.8.547+12e0e47" = _XbXcL4Vz;
        "pkg-0.8.548+03c04ff" = _xbvM4Wdl;
        "pkg-0.8.550+fde66a1" = _ZLTfwQly;
        "pkg-0.8.552+16d035d" = _gCJnz9KE;
        "pkg-0.8.567+91fe354" = _fdDlNZ3w;
        "pkg-0.8.572+f3516cb" = _eCKpmvMi;
        "pkg-mc-1.17.1-forge-v0.8.575+d692e10" = _sfUJVH6o;
        "pkg-mc-1.19.4-forge-v0.8.575+d692e10" = _qgg0Wxp6;
        "pkg-mc-1.20.2-neoforge-v0.8.576" = _vwDLTBFf;
        "pkg-mc-1.14.4-fabric-v0.8.576" = _cTUZicQ4;
        "pkg-mc-1.15.2-fabric-v0.8.576" = _TIPNdkrd;
        "pkg-mc-1.16.5-fabric-v0.8.576" = _DKORXGNZ;
        "pkg-mc-1.20.2-fabric-v0.8.576" = _Jt8pjlcv;
        "pkg-mc-1.17.1-forge-v0.8.576" = _G05XUu5l;
        "pkg-mc-1.20.1-fabric-v0.8.576" = _IGequXaX;
        "pkg-mc-1.17.1-fabric-v0.8.576" = _u5hxRWWS;
        "pkg-mc-1.19.3-fabric-v0.8.576" = _9N1bBuWo;
        "pkg-mc-1.19.2-fabric-v0.8.576" = _KPTHHXtr;
        "pkg-mc-1.20.4-fabric-v0.8.576" = _j79c1ivx;
        "pkg-mc-1.21.0-neoforge-v0.8.576" = _LovUxEP5;
        "pkg-mc-1.19.4-forge-v0.8.576" = _dBKXfHlt;
        "pkg-mc-1.19.4-fabric-v0.8.576" = _dZtTtKYO;
        "pkg-mc-1.18.2-fabric-v0.8.576" = _denwRMLo;
        "pkg-mc-1.18.2-forge-v0.8.576" = _zIr9LpYq;
        "pkg-mc-1.20.6-fabric-v0.8.576" = _dHKtrM7A;
        "pkg-mc-1.21.0-fabric-v0.8.576" = _cQtpLkIM;
        "pkg-mc-1.20.6-neoforge-v0.8.576" = _yEfaxcPX;
        "pkg-mc-1.20.2-neoforge-v0.8.578" = _l7BQRo98;
        "pkg-mc-1.14.4-fabric-v0.8.578" = _oVsVrZbw;
        "pkg-mc-1.19.4-forge-v0.8.578" = _1FoRGFmZ;
        "pkg-mc-1.20.2-fabric-v0.8.578" = _dZ1TBlX6;
        "pkg-mc-1.19.4-fabric-v0.8.578" = _gB21DIYx;
        "pkg-mc-1.15.2-fabric-v0.8.578" = _BABizrqZ;
        "pkg-mc-1.20.6-neoforge-v0.8.578" = _3HAGF7ft;
        "pkg-mc-1.17.1-forge-v0.8.578" = _aHgu9WCS;
        "pkg-mc-1.21.0-neoforge-v0.8.578" = _LNLKHeC9;
        "pkg-mc-1.18.2-forge-v0.8.578" = _ahp2DZsp;
        "pkg-mc-1.19.2-fabric-v0.8.578" = _Np1xTPlS;
        "pkg-mc-1.18.2-fabric-v0.8.578" = _hoVTyou4;
        "pkg-mc-1.20.1-fabric-v0.8.578" = _HSZutkwv;
        "pkg-mc-1.20.4-fabric-v0.8.578" = _sEYwqUei;
        "pkg-mc-1.16.5-fabric-v0.8.578" = _q9XI1zZh;
        "pkg-mc-1.21.0-fabric-v0.8.578" = _3WpypNcu;
        "pkg-mc-1.19.3-fabric-v0.8.578" = _MZvlSLAp;
        "pkg-mc-1.17.1-fabric-v0.8.578" = _2pvYpPU2;
        "pkg-mc-1.20.6-fabric-v0.8.578" = _wo3U8oqU;
        "pkg-mc-1.18.2-fabric-v0.8.579" = _XxMXyXb9;
        "pkg-mc-1.20.2-neoforge-v0.8.579" = _tzgze5T0;
        "pkg-mc-1.16.5-fabric-v0.8.579" = _qktXR5SC;
        "pkg-mc-1.19.4-forge-v0.8.579" = _1vLv6uaV;
        "pkg-mc-1.20.1-fabric-v0.8.579" = _Z6qKkDwK;
        "pkg-mc-1.15.2-fabric-v0.8.579" = _M6GNAS0G;
        "pkg-mc-1.17.1-fabric-v0.8.579" = _wHWpanif;
        "pkg-mc-1.21.0-neoforge-v0.8.579" = _oePXLM1X;
        "pkg-mc-1.20.4-fabric-v0.8.579" = _CaoL6XoH;
        "pkg-mc-1.18.2-forge-v0.8.579" = _ECGnvTSf;
        "pkg-mc-1.19.4-fabric-v0.8.579" = _5R5v4zYd;
        "pkg-mc-1.20.6-neoforge-v0.8.579" = _3IumWXDl;
        "pkg-mc-1.20.2-fabric-v0.8.579" = _DSEKzI1B;
        "pkg-mc-1.17.1-forge-v0.8.579" = _tsYPkm1S;
        "pkg-mc-1.19.3-fabric-v0.8.579" = _qsnW7Q8D;
        "pkg-mc-1.19.2-fabric-v0.8.579" = _yM3B7w6D;
        "pkg-mc-1.21.0-fabric-v0.8.579" = _1lyzj8AY;
        "pkg-mc-1.14.4-fabric-v0.8.579" = _Y7iEcpyh;
        "pkg-mc-1.20.6-fabric-v0.8.579" = _Ko5Zk5uh;
        "pkg-mc-1.20.6-neoforge-v0.8.581" = _oXCKlYJF;
        "pkg-mc-1.20.2-neoforge-v0.8.581" = _WAa8m0ut;
        "pkg-mc-1.18.2-forge-v0.8.581" = _K9VGhdQG;
        "pkg-mc-1.17.1-forge-v0.8.581" = _SHy9eQuj;
        "pkg-mc-1.20.4-fabric-v0.8.581" = _lr0bVPOp;
        "pkg-mc-1.21.0-neoforge-v0.8.581" = _df5PaoNg;
        "pkg-mc-1.20.6-fabric-v0.8.581" = _OycgGy5u;
        "pkg-mc-1.17.1-fabric-v0.8.581" = _ctwOB3fN;
        "pkg-mc-1.19.4-forge-v0.8.581" = _PbmVGhNB;
        "pkg-mc-1.20.1-fabric-v0.8.581" = _7LDKXGXQ;
        "pkg-mc-1.20.2-fabric-v0.8.581" = _umTVrmZb;
        "pkg-mc-1.14.4-fabric-v0.8.581" = _ELL6QZwt;
        "pkg-mc-1.16.5-fabric-v0.8.581" = _JNy776OI;
        "pkg-mc-1.21.0-fabric-v0.8.581" = _5UwHnxqx;
        "pkg-mc-1.15.2-fabric-v0.8.581" = _gydm63fl;
        "pkg-mc-1.19.3-fabric-v0.8.581" = _DEDq5JvV;
        "pkg-mc-1.19.4-fabric-v0.8.581" = _Sw1Zu3LZ;
        "pkg-mc-1.18.2-fabric-v0.8.581" = _2sIuIlaz;
        "pkg-mc-1.19.2-fabric-v0.8.581" = _hY01vDw1;
        "pkg-mc-1.19.4-forge-v0.8.583" = _8qf0za2Q;
        "pkg-mc-1.15.2-fabric-v0.8.583" = _w6pWFfym;
        "pkg-mc-1.20.2-neoforge-v0.8.583" = _DhN9MmjP;
        "pkg-mc-1.17.1-forge-v0.8.583" = _WE9WvQBr;
        "pkg-mc-1.20.4-fabric-v0.8.583" = _U60KmhTT;
        "pkg-mc-1.20.6-neoforge-v0.8.583" = _QdGsjW3d;
        "pkg-mc-1.17.1-fabric-v0.8.583" = _7twJECEZ;
        "pkg-mc-1.14.4-fabric-v0.8.583" = _5GFiDuLC;
        "pkg-mc-1.19.4-fabric-v0.8.583" = _N9e6Q2CM;
        "pkg-mc-1.20.1-fabric-v0.8.583" = _dqEFZIOn;
        "pkg-mc-1.18.2-forge-v0.8.583" = _EWiy8535;
        "pkg-mc-1.21.0-fabric-v0.8.583" = _gFFt7qWy;
        "pkg-mc-1.21.0-neoforge-v0.8.583" = _HRUstIAW;
        "pkg-mc-1.20.2-fabric-v0.8.583" = _OhbMaYfh;
        "pkg-mc-1.20.6-fabric-v0.8.583" = _ZZ1VuJYt;
        "pkg-mc-1.19.3-fabric-v0.8.583" = _Nm1i2ZCB;
        "pkg-mc-1.16.5-fabric-v0.8.583" = _kTSwYMm9;
        "pkg-mc-1.18.2-fabric-v0.8.583" = _TwY6oqBP;
        "pkg-mc-1.19.2-fabric-v0.8.583" = _1SuHBVas;
        "pkg-mc-1.18.2-forge-v0.8.584" = _Ff9hpMdJ;
        "pkg-mc-1.19.4-forge-v0.8.584" = _kUoBQTn0;
        "pkg-mc-1.19.4-fabric-v0.8.584" = _qIu9QgVa;
        "pkg-mc-1.15.2-fabric-v0.8.584" = _tHRrnCbU;
        "pkg-mc-1.17.1-fabric-v0.8.584" = _AYnpdkMu;
        "pkg-mc-1.20.2-neoforge-v0.8.584" = _Nhbo1Ss9;
        "pkg-mc-1.21.0-neoforge-v0.8.584" = _drHygaT8;
        "pkg-mc-1.20.1-fabric-v0.8.584" = _aCDfqvZZ;
        "pkg-mc-1.20.6-neoforge-v0.8.584" = _IKXtutW9;
        "pkg-mc-1.17.1-forge-v0.8.584" = _uu9B8l4M;
        "pkg-mc-1.19.3-fabric-v0.8.584" = _RkO9v5Nd;
        "pkg-mc-1.16.5-fabric-v0.8.584" = _xe0tFQi7;
        "pkg-mc-1.20.6-fabric-v0.8.584" = _ckbR71ho;
        "pkg-mc-1.19.2-fabric-v0.8.584" = _xaqFpH00;
        "pkg-mc-1.21.0-fabric-v0.8.584" = _LDKIHBsZ;
        "pkg-mc-1.20.2-fabric-v0.8.584" = _wnvEI4eo;
        "pkg-mc-1.18.2-fabric-v0.8.584" = _ddKqCKnR;
        "pkg-mc-1.20.4-fabric-v0.8.584" = _P4fTKfWL;
        "pkg-mc-1.14.4-fabric-v0.8.584" = _JGFCjJ5A;
        "pkg-mc-1.20.4-fabric-v0.8.585" = _7i0Xupg5;
        "pkg-mc-1.19.4-fabric-v0.8.585" = _HZm79Rls;
        "pkg-mc-1.18.2-forge-v0.8.585" = _kxQN99uN;
        "pkg-mc-1.19.4-forge-v0.8.585" = _VZ2Yfs9G;
        "pkg-mc-1.20.6-fabric-v0.8.585" = _Cl3SCvz8;
        "pkg-mc-1.16.5-fabric-v0.8.585" = _FDxZ6Xom;
        "pkg-mc-1.20.2-neoforge-v0.8.585" = _jwlHYIWw;
        "pkg-mc-1.17.1-forge-v0.8.585" = _N0oupddU;
        "pkg-mc-1.21.0-fabric-v0.8.585" = _miTBbj6s;
        "pkg-mc-1.20.6-neoforge-v0.8.585" = _tyicROQ9;
        "pkg-mc-1.15.2-fabric-v0.8.585" = _deKwibgN;
        "pkg-mc-1.14.4-fabric-v0.8.585" = _FqW1dS75;
        "pkg-mc-1.19.2-fabric-v0.8.585" = _SckAm280;
        "pkg-mc-1.19.3-fabric-v0.8.585" = _Hrp2Tldn;
        "pkg-mc-1.21.0-neoforge-v0.8.585" = _yBaAQF8A;
        "pkg-mc-1.20.2-fabric-v0.8.585" = _CTYE0VXu;
        "pkg-mc-1.18.2-fabric-v0.8.585" = _SSDoJU7J;
        "pkg-mc-1.20.1-fabric-v0.8.585" = _7AO7lqrX;
        "pkg-mc-1.17.1-fabric-v0.8.585" = _dBR2KMih;
        "pkg-v0.8.587-mc-1.18.2-fabric" = _kPE9Grm6;
        "pkg-v0.8.587-mc-1.17.1-fabric" = _YRplVd5Y;
        "pkg-v0.8.587-mc-1.18.2-forge" = _8DM55tj4;
        "pkg-v0.8.587-mc-1.16.5-fabric" = _qPlB39Dz;
        "pkg-v0.8.587-mc-1.19.4-fabric" = _AQQ13UIS;
        "pkg-v0.8.587-mc-1.20.6-fabric" = _9cS0VAwk;
        "pkg-v0.8.587-mc-1.21.0-fabric" = _aPUu7XG3;
        "pkg-v0.8.587-mc-1.20.2-neoforge" = _8PmFcG12;
        "pkg-v0.8.587-mc-1.19.2-fabric" = _MUi35Wns;
        "pkg-v0.8.587-mc-1.19.4-forge" = _uY0wqNle;
        "pkg-v0.8.587-mc-1.20.4-fabric" = _KnZ52hhK;
        "pkg-v0.8.587-mc-1.19.3-fabric" = _hELGLAry;
        "pkg-v0.8.587-mc-1.20.6-neoforge" = _QYAcCJQb;
        "pkg-v0.8.587-mc-1.20.2-fabric" = _pulbXO1X;
        "pkg-v0.8.587-mc-1.20.1-fabric" = _DIL0bOzD;
        "pkg-v0.8.587-mc-1.14.4-fabric" = _N7jvTHTi;
        "pkg-v0.8.587-mc-1.21.0-neoforge" = _4hsrIJA1;
        "pkg-v0.8.587-mc-1.15.2-fabric" = _6j0WqPen;
        "pkg-v0.8.587-mc-1.17.1-forge" = _cZ3gGB0W;
        "pkg-v0.8.593-mc-1.19.2-fabric" = _79Lu5f7i;
        "pkg-v0.8.593-mc-1.20.2-fabric" = _jFCR9QQk;
        "pkg-v0.8.593-mc-1.17.1-fabric" = _SeSIbpJJ;
        "pkg-v0.8.593-mc-1.19.4-fabric" = _fQmauqAY;
        "pkg-v0.8.593-mc-1.19.3-fabric" = _z5qVUG2O;
        "pkg-v0.8.593-mc-1.17.1-forge" = _d9owxUsu;
        "pkg-v0.8.593-mc-1.21.0-neoforge" = _7EQoW048;
        "pkg-v0.8.593-mc-1.20.6-fabric" = _1DZETzRI;
        "pkg-v0.8.593-mc-1.19.4-forge" = _4Y0APJtv;
        "pkg-v0.8.593-mc-1.20.6-neoforge" = _Pv5koovL;
        "pkg-v0.8.593-mc-1.21.0-fabric" = _33NPfcME;
        "pkg-v0.8.593-mc-1.14.4-fabric" = _h3uDl6eY;
        "pkg-v0.8.593-mc-1.18.2-forge" = _t8nGwz2n;
        "pkg-v0.8.593-mc-1.20.2-neoforge" = _YiXVGSVy;
        "pkg-v0.8.593-mc-1.16.5-fabric" = _NUjcmrUy;
        "pkg-v0.8.593-mc-1.20.1-fabric" = _laAdOdET;
        "pkg-v0.8.593-mc-1.15.2-fabric" = _PGSrh1p9;
        "pkg-v0.8.593-mc-1.20.4-fabric" = _cPwAIULy;
        "pkg-v0.8.593-mc-1.18.2-fabric" = _qQltUGRG;
        "pkg-v0.8.596-mc-1.16.5-fabric" = _NOm1qR3H;
        "pkg-v0.8.596-mc-1.19.4-fabric" = _WwWyvJ1v;
        "pkg-v0.8.596-mc-1.19.2-fabric" = _uP9Zp1jX;
        "pkg-v0.8.596-mc-1.20.6-neoforge" = _7knhEJml;
        "pkg-v0.8.596-mc-1.20.2-fabric" = _ERL99HHP;
        "pkg-v0.8.596-mc-1.20.4-fabric" = _JxkNE4Zm;
        "pkg-v0.8.596-mc-1.20.2-neoforge" = _F2fLe0vZ;
        "pkg-v0.8.596-mc-1.14.4-fabric" = _SVvHB4vu;
        "pkg-v0.8.596-mc-1.18.2-fabric" = _3NwQwiCd;
        "pkg-v0.8.596-mc-1.19.3-fabric" = _SFgbCjdT;
        "pkg-v0.8.596-mc-1.17.1-fabric" = _CGdzwG9T;
        "pkg-v0.8.596-mc-1.20.1-fabric" = _gR2euBES;
        "pkg-v0.8.596-mc-1.21.0-fabric" = _9XuD15s0;
        "pkg-v0.8.596-mc-1.21.0-neoforge" = _ZtOa1x7q;
        "pkg-v0.8.596-mc-1.19.4-forge" = _AQ0WPbXa;
        "pkg-v0.8.596-mc-1.18.2-forge" = _JCcHboUz;
        "pkg-v0.8.596-mc-1.15.2-fabric" = _6NezOQAw;
        "pkg-v0.8.596-mc-1.17.1-forge" = _XHZmS6FC;
        "pkg-v0.8.596-mc-1.20.6-fabric" = _BbLGrt5s;
        "pkg-v0.8.597-mc-1.21.1-fabric" = _kUH1pm0i;
        "pkg-v0.8.597-mc-1.20.2-fabric" = _id2seLEt;
        "pkg-v0.8.597-mc-1.19.3-fabric" = _PanZHoZb;
        "pkg-v0.8.597-mc-1.20.4-fabric" = _3OjLpKok;
        "pkg-v0.8.597-mc-1.21.1-neoforge" = _40biFTzX;
        "pkg-v0.8.597-mc-1.20.1-fabric" = _KPBJIyYF;
        "pkg-v0.8.597-mc-1.20.6-neoforge" = _JOZ1KBGl;
        "pkg-v0.8.597-mc-1.14.4-fabric" = _XyBSl6MI;
        "pkg-v0.8.597-mc-1.20.2-neoforge" = _UayRAtuH;
        "pkg-v0.8.597-mc-1.19.4-forge" = _f2wetpLw;
        "pkg-v0.8.597-mc-1.15.2-fabric" = _3vgcp7oz;
        "pkg-v0.8.597-mc-1.17.1-fabric" = _yM4NRq6R;
        "pkg-v0.8.597-mc-1.20.6-fabric" = _g9Tllr23;
        "pkg-v0.8.597-mc-1.19.2-fabric" = _deqD8Bxr;
        "pkg-v0.8.597-mc-1.17.1-forge" = _JftWZ0OV;
        "pkg-v0.8.597-mc-1.19.4-fabric" = _U5G8zrdW;
        "pkg-v0.8.597-mc-1.18.2-fabric" = _PO5CwtvQ;
        "pkg-v0.8.597-mc-1.18.2-forge" = _PWSWHqWH;
        "pkg-v0.8.597-mc-1.16.5-fabric" = _LKuBRgvs;
        "pkg-v0.8.599-mc-1.20.1-fabric" = _dpxXspkb;
        "pkg-v0.8.599-mc-1.20.2-neoforge" = _GN4M97n7;
        "pkg-v0.8.599-mc-1.15.2-fabric" = _FmmMLvRx;
        "pkg-v0.8.599-mc-1.21.1-neoforge" = _l9z1XArX;
        "pkg-v0.8.599-mc-1.14.4-fabric" = _598CyVU6;
        "pkg-v0.8.599-mc-1.20.6-neoforge" = _3sdSCgST;
        "pkg-v0.8.599-mc-1.20.4-fabric" = _bVgeCjNZ;
        "pkg-v0.8.599-mc-1.17.1-forge" = _Apkawobm;
        "pkg-v0.8.599-mc-1.20.2-fabric" = _BsDsIHPz;
        "pkg-v0.8.599-mc-1.19.4-forge" = _BN0Z0SUs;
        "pkg-v0.8.599-mc-1.20.6-fabric" = _REQ3rnk5;
        "pkg-v0.8.599-mc-1.19.4-fabric" = _JUV1HXwO;
        "pkg-v0.8.599-mc-1.19.3-fabric" = _erfc82GA;
        "pkg-v0.8.599-mc-1.17.1-fabric" = _8XJsYhlY;
        "pkg-v0.8.599-mc-1.19.2-fabric" = _hsvU41Kw;
        "pkg-v0.8.599-mc-1.21.1-fabric" = _gFkIGIoF;
        "pkg-v0.8.599-mc-1.18.2-forge" = _3diaAlNT;
        "pkg-v0.8.599-mc-1.18.2-fabric" = _WWURmwcX;
        "pkg-v0.8.599-mc-1.16.5-fabric" = _CbfocKz7;
        "pkg-v0.8.602-mc-1.19.2-fabric" = _JD73mmrW;
        "pkg-v0.8.602-mc-1.20.2-neoforge" = _IwC64vbE;
        "pkg-v0.8.602-mc-1.20.4-fabric" = _sNuUI7i1;
        "pkg-v0.8.602-mc-1.14.4-fabric" = _FfVQQnxl;
        "pkg-v0.8.602-mc-1.18.2-fabric" = _5jpatPjW;
        "pkg-v0.8.602-mc-1.15.2-fabric" = _T34AKEmc;
        "pkg-v0.8.602-mc-1.17.1-fabric" = _j6Nh7W0p;
        "pkg-v0.8.602-mc-1.20.6-neoforge" = _kq93aLmx;
        "pkg-v0.8.602-mc-1.19.4-forge" = _hgMvKY1l;
        "pkg-v0.8.602-mc-1.18.2-forge" = _jl1GmleM;
        "pkg-v0.8.602-mc-1.20.1-fabric" = _mbemlhXG;
        "pkg-v0.8.602-mc-1.21.1-fabric" = _3qXXMpLM;
        "pkg-v0.8.602-mc-1.17.1-forge" = _YH6bvKwO;
        "pkg-v0.8.602-mc-1.20.6-fabric" = _h7QryA4R;
        "pkg-v0.8.602-mc-1.19.4-fabric" = _JCdSEZtm;
        "pkg-v0.8.602-mc-1.16.5-fabric" = _SwLWtXTY;
        "pkg-v0.8.602-mc-1.21.1-neoforge" = _DyHSh43n;
        "pkg-v0.8.602-mc-1.20.2-fabric" = _kSLDmSWK;
        "pkg-v0.8.602-mc-1.19.3-fabric" = _6wjJR85C;
        "pkg-v0.8.603-mc-1.19.3-fabric" = _XJDAjfuR;
        "pkg-v0.8.603-mc-1.20.4-fabric" = _Hz1nqKQp;
        "pkg-v0.8.603-mc-1.19.2-fabric" = _CUwyQMPu;
        "pkg-v0.8.603-mc-1.17.1-forge" = _gqI6h3PM;
        "pkg-v0.8.603-mc-1.20.6-fabric" = _GKwBSbjy;
        "pkg-v0.8.603-mc-1.20.2-neoforge" = _dABF23Rs;
        "pkg-v0.8.603-mc-1.20.1-fabric" = _mPpfXRIp;
        "pkg-v0.8.603-mc-1.17.1-fabric" = _C1aRmkZi;
        "pkg-v0.8.603-mc-1.20.2-fabric" = _DG9aTsYH;
        "pkg-v0.8.603-mc-1.19.4-fabric" = _bVMQmXaE;
        "pkg-v0.8.603-mc-1.16.5-fabric" = _Bi0TiFL4;
        "pkg-v0.8.603-mc-1.15.2-fabric" = _JOG2cojO;
        "pkg-v0.8.603-mc-1.19.4-forge" = _y81MTm7M;
        "pkg-v0.8.603-mc-1.18.2-forge" = _8uiWfKaa;
        "pkg-v0.8.603-mc-1.18.2-fabric" = _g7T6PDJ7;
        "pkg-v0.8.603-mc-1.20.6-neoforge" = _tsgMiF0e;
        "pkg-v0.8.603-mc-1.14.4-fabric" = _aUsdGbLw;
        "pkg-v0.8.603-mc-1.21.1-neoforge" = _uf1OPDMA;
        "pkg-v0.8.603-mc-1.21.1-fabric" = _5EMogflj;
        "pkg-v0.8.604-mc-1.19.3-fabric" = _PlMMFg5U;
        "pkg-v0.8.604-mc-1.16.5-fabric" = _8XicuTxg;
        "pkg-v0.8.604-mc-1.14.4-fabric" = _wxA2xadD;
        "pkg-v0.8.604-mc-1.15.2-fabric" = _rd9GFJ2U;
        "pkg-v0.8.604-mc-1.20.6-fabric" = _4PbiZP0h;
        "pkg-v0.8.604-mc-1.19.2-fabric" = _M5LtO89N;
        "pkg-v0.8.604-mc-1.20.1-fabric" = _7i4Dg8Tz;
        "pkg-v0.8.604-mc-1.21.1-fabric" = _DRTIRwv5;
        "pkg-v0.8.604-mc-1.19.4-fabric" = _ac0b2jgn;
        "pkg-v0.8.604-mc-1.18.2-fabric" = _29U2xFdL;
        "pkg-v0.8.604-mc-1.17.1-forge" = _a6cy24t2;
        "pkg-v0.8.604-mc-1.18.2-forge" = _drgInfep;
        "pkg-v0.8.604-mc-1.21.1-neoforge" = _pNYhDIkf;
        "pkg-v0.8.604-mc-1.17.1-fabric" = _g8kM7Ket;
        "pkg-v0.8.604-mc-1.20.2-neoforge" = _C7sAWYem;
        "pkg-v0.8.604-mc-1.20.2-fabric" = _86ImZd4R;
        "pkg-v0.8.604-mc-1.20.4-fabric" = _v0PcZPoq;
        "pkg-v0.8.604-mc-1.19.4-forge" = _Lv2rh8Do;
        "pkg-v0.8.604-mc-1.20.6-neoforge" = _MUyEvjnz;
        "pkg-v0.8.608-mc1.18.2-fabric" = _6LnHIKQ0;
        "pkg-v0.8.608-mc1.20.1-fabric" = _mkHpzmNL;
        "pkg-v0.8.608-mc1.19.4-fabric" = _AAeotapt;
        "pkg-v0.8.608-mc1.19.4-forge" = _7osiupC2;
        "pkg-v0.8.608-mc1.21.1-fabric" = _9fUn82ne;
        "pkg-v0.8.608-mc1.15.2-fabric" = _XBzukhKM;
        "pkg-v0.8.608-mc1.20.4-fabric" = _p0NY7ws4;
        "pkg-v0.8.608-mc1.17.1-fabric" = _7Y9yqcLe;
        "pkg-v0.8.608-mc1.16.5-fabric" = _UGqtGLRR;
        "pkg-v0.8.608-mc1.17.1-forge" = _RyYvZkDF;
        "pkg-v0.8.608-mc1.20.6-fabric" = _XkKnBOZC;
        "pkg-v0.8.608-mc1.21.1-neoforge" = _tK8AquSI;
        "pkg-v0.8.609-mc1.17.1-fabric" = _Fo64NMC9;
        "pkg-v0.8.609-mc1.18.2-forge" = _cIyisplM;
        "pkg-v0.8.609-mc1.15.2-fabric" = _oyHKtv24;
        "pkg-v0.8.609-mc1.19.3-fabric" = _6pmYwHQ2;
        "pkg-v0.8.609-mc1.20.4-fabric" = _aK9rL9H6;
        "pkg-v0.8.609-mc1.20.2-neoforge" = _6sXjWnvS;
        "pkg-v0.8.609-mc1.16.5-fabric" = _gs7ULmSt;
        "pkg-v0.8.609-mc1.19.2-fabric" = _7DUz7sFc;
        "pkg-v0.8.609-mc1.14.4-fabric" = _wPAbn6V1;
        "pkg-v0.8.609-mc1.18.2-fabric" = _Uf9kaQjq;
        "pkg-v0.8.609-mc1.20.6-neoforge" = _ai7GgqBf;
        "pkg-v0.8.609-mc1.21.1-fabric" = _YE6GSpWR;
        "pkg-v0.8.609-mc1.20.6-fabric" = _Aj9ODgKU;
        "pkg-v0.8.609-mc1.17.1-forge" = _vSCs0FKQ;
        "pkg-v0.8.609-mc1.21.1-neoforge" = _RVML698H;
        "pkg-v0.8.609-mc1.19.4-fabric" = _5pfmLGjr;
        "pkg-v0.8.609-mc1.19.4-forge" = _od9fGaV2;
        "pkg-v0.8.609-mc1.20.2-fabric" = _GFxyKsTO;
        "pkg-v0.8.609-mc1.20.1-fabric" = _nANplyMW;
        "pkg-v0.8.612-mc1.19.4-fabric" = _LjvTTblZ;
        "pkg-v0.8.612-mc1.16.5-fabric" = _O5kLa6E8;
        "pkg-v0.8.612-mc1.15.2-fabric" = _8zlOdhRg;
        "pkg-v0.8.612-mc1.19.3-fabric" = _4jbo5svZ;
        "pkg-v0.8.612-mc1.19.2-fabric" = _Vp7eksBd;
        "pkg-v0.8.612-mc1.20.4-fabric" = _m7uEs308;
        "pkg-v0.8.612-mc1.18.2-fabric" = _OKZCofBB;
        "pkg-v0.8.612-mc1.19.4-forge" = _Wrdtx1fY;
        "pkg-v0.8.612-mc1.17.1-forge" = _d5CPxxAx;
        "pkg-v0.8.612-mc1.20.6-neoforge" = _eMR0zsyj;
        "pkg-v0.8.612-mc1.18.2-forge" = _eWLHEiMm;
        "pkg-v0.8.612-mc1.20.6-fabric" = _WSYDf3Lf;
        "pkg-v0.8.612-mc1.14.4-fabric" = _3nf6BomM;
        "pkg-v0.8.612-mc1.21.1-fabric" = _z2vx1VEb;
        "pkg-v0.8.612-mc1.20.2-neoforge" = _MkiNdVPS;
        "pkg-v0.8.612-mc1.17.1-fabric" = _gVVMbPF5;
        "pkg-v0.8.612-mc1.20.2-fabric" = _Jrli8qfE;
        "pkg-v0.8.612-mc1.20.1-fabric" = _sh3YpueY;
        "pkg-v0.8.612-mc1.21.1-neoforge" = _u0HsNIKZ;
        "pkg-v0.8.615-mc1.14.4-fabric" = _KCd77aUk;
        "pkg-v0.8.615-mc1.17.1-forge" = _DRi0I5CK;
        "pkg-v0.8.615-mc1.15.2-fabric" = _KXpDsFYs;
        "pkg-v0.8.615-mc1.20.4-fabric" = _haBwFPuI;
        "pkg-v0.8.615-mc1.19.3-fabric" = _HHnzuyR8;
        "pkg-v0.8.615-mc1.18.2-fabric" = _VWAoVnio;
        "pkg-v0.8.615-mc1.17.1-fabric" = _SJTqy2h4;
        "pkg-v0.8.615-mc1.20.2-neoforge" = _R9TmlDhF;
        "pkg-v0.8.615-mc1.19.4-forge" = _9G5iG7vs;
        "pkg-v0.8.615-mc1.21.1-neoforge" = _LatAE574;
        "pkg-v0.8.615-mc1.18.2-forge" = _jUDLwAjO;
        "pkg-v0.8.615-mc1.16.5-fabric" = _f2bs53KR;
        "pkg-v0.8.615-mc1.19.2-fabric" = _axOLERga;
        "pkg-v0.8.615-mc1.20.6-neoforge" = _lBH83I3j;
        "pkg-v0.8.615-mc1.20.1-fabric" = _x6OxQtBC;
        "pkg-v0.8.615-mc1.21.1-fabric" = _Ngl6OTje;
        "pkg-v0.8.615-mc1.20.6-fabric" = _fZ6h2OBH;
        "pkg-v0.8.615-mc1.19.4-fabric" = _J5ruExiO;
        "pkg-v0.8.615-mc1.20.2-fabric" = _UnJbYOJW;
        "pkg-v0.8.619-mc1.19.3-fabric" = _NomoyD4Q;
        "pkg-v0.8.619-mc1.21.1-fabric" = _eOCrLPZU;
        "pkg-v0.8.619-mc1.19.2-fabric" = _NAmtn8Ux;
        "pkg-v0.8.619-mc1.15.2-fabric" = _jNFDrxvQ;
        "pkg-v0.8.619-mc1.14.4-fabric" = _qlhlNiBs;
        "pkg-v0.8.619-mc1.19.4-forge" = _xuzHM3SH;
        "pkg-v0.8.619-mc1.16.5-fabric" = _3Isb2BJp;
        "pkg-v0.8.619-mc1.18.2-fabric" = _7gJMC8wX;
        "pkg-v0.8.619-mc1.17.1-forge" = _res0FLlB;
        "pkg-v0.8.619-mc1.20.4-fabric" = _ph9YiYcH;
        "pkg-v0.8.619-mc1.18.2-forge" = _yAWBuvSM;
        "pkg-v0.8.619-mc1.20.2-fabric" = _BW85ts97;
        "pkg-v0.8.619-mc1.20.6-neoforge" = _Ud5mNLuV;
        "pkg-v0.8.619-mc1.21.1-neoforge" = _zGHrxSJM;
        "pkg-v0.8.619-mc1.20.2-neoforge" = _1MggfGUS;
        "pkg-v0.8.619-mc1.17.1-fabric" = _UXRdUIQo;
        "pkg-v0.8.619-mc1.20.1-fabric" = _1Uljj3vi;
        "pkg-v0.8.619-mc1.20.6-fabric" = _A8d8KI0D;
        "pkg-v0.8.619-mc1.19.4-fabric" = _lcL5bF4F;
        "pkg-v0.8.628-mc1.15.2-fabric" = _8uVJO2oL;
        "pkg-v0.8.628-mc1.19.2-fabric" = _lpdughHH;
        "pkg-v0.8.628-mc1.20.2-fabric" = _3Or95kuf;
        "pkg-v0.8.628-mc1.20.1-fabric" = _NSPWfxpK;
        "pkg-v0.8.628-mc1.20.6-fabric" = _DIo1WPKc;
        "pkg-v0.8.628-mc1.18.2-forge" = _WMVcdp7Y;
        "pkg-v0.8.628-mc1.19.4-forge" = _8RFbI817;
        "pkg-v0.8.628-mc1.19.4-fabric" = _8ZTZVMKP;
        "pkg-v0.8.628-mc1.21.1-fabric" = _FItqVkaM;
        "pkg-v0.8.628-mc1.19.3-fabric" = _7XBjUlxk;
        "pkg-v0.8.628-mc1.16.5-fabric" = _2JwZtxli;
        "pkg-v0.8.628-mc1.14.4-fabric" = _5VmYHSKH;
        "pkg-v0.8.628-mc1.17.1-fabric" = _k9qIxMHP;
        "pkg-v0.8.628-mc1.17.1-forge" = _QNCspWLh;
        "pkg-v0.8.628-mc1.20.4-fabric" = _ilCaHbJh;
        "pkg-v0.8.628-mc1.18.2-fabric" = _Sb6RB4g9;
        "pkg-v0.8.628-mc1.20.6-neoforge" = _idXinkaK;
        "pkg-v0.8.628-mc1.20.2-neoforge" = _Ts2EwxXQ;
        "pkg-v0.8.628-mc1.21.1-neoforge" = _2vbXDAyR;
        "pkg-v0.8.629-mc1.14.4-fabric" = _gwlaIhCc;
        "pkg-v0.8.629-mc1.20.2-fabric" = _mhirstAg;
        "pkg-v0.8.629-mc1.17.1-forge" = _MizdXc0h;
        "pkg-v0.8.629-mc1.18.2-forge" = _9crUBLRk;
        "pkg-v0.8.629-mc1.20.1-fabric" = _lavYMYcP;
        "pkg-v0.8.629-mc1.19.4-forge" = _8bvRsiFA;
        "pkg-v0.8.629-mc1.20.6-fabric" = _w0UVdKtS;
        "pkg-v0.8.629-mc1.18.2-fabric" = _yxhnaBE2;
        "pkg-v0.8.629-mc1.21.1-fabric" = _D08WvDNI;
        "pkg-v0.8.629-mc1.19.4-fabric" = _G0lO7NCF;
        "pkg-v0.8.629-mc1.19.2-fabric" = _8oc4IIPU;
        "pkg-v0.8.629-mc1.15.2-fabric" = _mpkr86al;
        "pkg-v0.8.629-mc1.19.3-fabric" = _SH4WbGbz;
        "pkg-v0.8.629-mc1.20.4-fabric" = _RuhaFemh;
        "pkg-v0.8.629-mc1.20.2-neoforge" = _MhWDaNBb;
        "pkg-v0.8.629-mc1.16.5-fabric" = _sfj7vMmN;
        "pkg-v0.8.629-mc1.21.1-neoforge" = _3QXsI4k3;
        "pkg-v0.8.629-mc1.20.6-neoforge" = _mOuyGsG5;
        "pkg-v0.8.629-mc1.17.1-fabric" = _ERZ0BUQm;
        "pkg-v0.8.632-mc1.16.5-fabric" = _JW7eYBDc;
        "pkg-v0.8.632-mc1.18.2-fabric" = _bMGLbLVS;
        "pkg-v0.8.632-mc1.20.1-fabric" = _4djGHbMG;
        "pkg-v0.8.632-mc1.19.4-fabric" = _3RjgDbHn;
        "pkg-v0.8.632-mc1.17.1-forge" = _wbBdhSO0;
        "pkg-v0.8.632-mc1.20.2-fabric" = _BOHhOTen;
        "pkg-v0.8.632-mc1.19.3-fabric" = _vYtBT37Z;
        "pkg-v0.8.632-mc1.20.4-fabric" = _yLUIXBys;
        "pkg-v0.8.632-mc1.20.6-fabric" = _M7fQRp4O;
        "pkg-v0.8.632-mc1.21.1-fabric" = _7DcFWRnp;
        "pkg-v0.8.632-mc1.21.1-neoforge" = _nwzP584M;
        "pkg-v0.8.632-mc1.19.4-forge" = _drvDiQFH;
        "pkg-v0.8.632-mc1.20.6-neoforge" = _ExuGq3xE;
        "pkg-v0.8.632-mc1.19.2-fabric" = _a4PEk7As;
        "pkg-v0.8.632-mc1.14.4-fabric" = _PuG4X0eV;
        "pkg-v0.8.632-mc1.17.1-fabric" = _ROluKV4P;
        "pkg-v0.8.632-mc1.15.2-fabric" = _N3Vcdg6a;
        "pkg-v0.8.632-mc1.18.2-forge" = _kAWJuxlG;
        "pkg-v0.8.632-mc1.20.2-neoforge" = _X414LwNJ;
        "pkg-v0.8.633-mc1.19.3-fabric" = _bE2HeVDM;
        "pkg-v0.8.633-mc1.19.2-fabric" = _BReTfV2f;
        "pkg-v0.8.633-mc1.20.2-fabric" = _Py5szSU8;
        "pkg-v0.8.633-mc1.19.4-fabric" = _FLgWpbYR;
        "pkg-v0.8.633-mc1.20.4-fabric" = _K6xNLjDh;
        "pkg-v0.8.633-mc1.20.6-fabric" = _j0x25Ow5;
        "pkg-v0.8.633-mc1.16.5-fabric" = _ySrTbFr1;
        "pkg-v0.8.633-mc1.15.2-fabric" = _OndMWDEz;
        "pkg-v0.8.633-mc1.21.1-neoforge" = _PqkTa6EG;
        "pkg-v0.8.633-mc1.18.2-forge" = _wZyK1ta6;
        "pkg-v0.8.633-mc1.18.2-fabric" = _6jgs5TY4;
        "pkg-v0.8.633-mc1.20.6-neoforge" = _myTi7Pgf;
        "pkg-v0.8.633-mc1.20.1-fabric" = _ZUs8HIrp;
        "pkg-v0.8.633-mc1.17.1-fabric" = _PwLujiO3;
        "pkg-v0.8.633-mc1.21.1-fabric" = _xYmDg93x;
        "pkg-v0.8.633-mc1.19.4-forge" = _6Lbr96j2;
        "pkg-v0.8.633-mc1.17.1-forge" = _YurbzQe5;
        "pkg-v0.8.633-mc1.20.2-neoforge" = _ZUzDp1Hx;
        "pkg-v0.8.633-mc1.14.4-fabric" = _1QqQTIuj;
        "pkg-v0.8.635-mc1.20.2-fabric" = _Q1s5xqsk;
        "pkg-v0.8.635-mc1.16.5-fabric" = _LsAl0wGy;
        "pkg-v0.8.635-mc1.17.1-fabric" = _91JtMkfu;
        "pkg-v0.8.635-mc1.19.2-fabric" = _6eGYfGap;
        "pkg-v0.8.635-mc1.15.2-fabric" = _KqHqNPq3;
        "pkg-v0.8.635-mc1.20.1-fabric" = _Kabefr4X;
        "pkg-v0.8.635-mc1.21.3-neoforge" = _gUOyjnSU;
        "pkg-v0.8.635-mc1.18.2-forge" = _aUg20LGT;
        "pkg-v0.8.635-mc1.21.1-neoforge" = _knwoD1zD;
        "pkg-v0.8.635-mc1.17.1-forge" = _Et5ttTB6;
        "pkg-v0.8.635-mc1.20.2-neoforge" = _AHypsBBI;
        "pkg-v0.8.635-mc1.20.6-neoforge" = _NYaoyGqH;
        "pkg-v0.8.635-mc1.18.2-fabric" = _68RJqZuT;
        "pkg-v0.8.635-mc1.14.4-fabric" = _PUGAUyt1;
        "pkg-v0.8.635-mc1.19.4-fabric" = _gOZ33ZSF;
        "pkg-v0.8.635-mc1.21.1-fabric" = _XpryCapS;
        "pkg-v0.8.635-mc1.21.3-fabric" = _uHRRJD0P;
        "pkg-v0.8.635-mc1.20.4-fabric" = _BxRD3PUn;
        "pkg-v0.8.635-mc1.20.6-fabric" = _F0ohwFRj;
        "pkg-v0.8.635-mc1.19.4-forge" = _uOwXV0It;
        "pkg-v0.8.635-mc1.19.3-fabric" = _1v5fKoSW;
        "pkg-v0.8.636-mc1.19.2-fabric" = _qLfScFbv;
        "pkg-v0.8.636-mc1.16.5-fabric" = _z0729lVr;
        "pkg-v0.8.636-mc1.20.6-fabric" = _RjOsee2O;
        "pkg-v0.8.636-mc1.17.1-forge" = _ygsAZl9V;
        "pkg-v0.8.636-mc1.21.1-fabric" = _EBeJ080H;
        "pkg-v0.8.636-mc1.21.3-neoforge" = _Bsx6tMC6;
        "pkg-v0.8.636-mc1.20.2-neoforge" = _5WDzTPzx;
        "pkg-v0.8.636-mc1.19.4-fabric" = _a0xBqFj0;
        "pkg-v0.8.636-mc1.15.2-fabric" = _ZVg3hMSJ;
        "pkg-v0.8.636-mc1.19.3-fabric" = _S6ky56jI;
        "pkg-v0.8.636-mc1.20.2-fabric" = _PKqHogv5;
        "pkg-v0.8.636-mc1.20.1-fabric" = _ciB35IFD;
        "pkg-v0.8.636-mc1.20.4-fabric" = _F6lAStgf;
        "pkg-v0.8.636-mc1.18.2-forge" = _qO05Cz3e;
        "pkg-v0.8.636-mc1.21.3-fabric" = _S568QBWK;
        "pkg-v0.8.636-mc1.20.6-neoforge" = _anhTlt7j;
        "pkg-v0.8.636-mc1.17.1-fabric" = _rrDDCP7U;
        "pkg-v0.8.636-mc1.21.1-neoforge" = _wVWyxJVQ;
        "pkg-v0.8.636-mc1.19.4-forge" = _2GWvuuE2;
        "pkg-v0.8.636-mc1.14.4-fabric" = _VMIooUiW;
        "pkg-v0.8.636-mc1.18.2-fabric" = _XgEWkgJR;
        "pkg-v0.8.637-mc1.20.4-fabric" = _C1JQtcL9;
        "pkg-v0.8.637-mc1.15.2-fabric" = _RRjhYVDc;
        "pkg-v0.8.637-mc1.14.4-fabric" = _1maffrQl;
        "pkg-v0.8.637-mc1.21.3-neoforge" = _vd7Bazr6;
        "pkg-v0.8.637-mc1.19.2-fabric" = _ZvsjwUvs;
        "pkg-v0.8.637-mc1.19.4-fabric" = _fJJaIOjG;
        "pkg-v0.8.637-mc1.21.1-fabric" = _JIm5SmhZ;
        "pkg-v0.8.637-mc1.19.4-forge" = _q6sjy2pm;
        "pkg-v0.8.637-mc1.20.2-fabric" = _qkZphvoG;
        "pkg-v0.8.637-mc1.21.1-neoforge" = _HZlCm6cL;
        "pkg-v0.8.637-mc1.18.2-fabric" = _UxPleTh4;
        "pkg-v0.8.637-mc1.20.2-neoforge" = _Dgs4fldV;
        "pkg-v0.8.637-mc1.19.3-fabric" = _PRF8te4i;
        "pkg-v0.8.637-mc1.21.3-fabric" = _dKAW4eww;
        "pkg-v0.8.637-mc1.18.2-forge" = _ZSoiDNoj;
        "pkg-v0.8.637-mc1.20.6-neoforge" = _m0IbdNBq;
        "pkg-v0.8.637-mc1.17.1-fabric" = _vCK7tr3f;
        "pkg-v0.8.637-mc1.16.5-fabric" = _mcQCeZhp;
        "pkg-v0.8.637-mc1.20.6-fabric" = _Se7BkZvW;
        "pkg-v0.8.637-mc1.17.1-forge" = _lKV1VuEk;
        "pkg-v0.8.637-mc1.20.1-fabric" = _6LTpyZ8L;
        "pkg-v0.8.640-mc1.20.6-fabric" = _cWRxIrWI;
        "pkg-v0.8.640-mc1.15.2-fabric" = _tUEZLIJz;
        "pkg-v0.8.640-mc1.21.3-fabric" = _DVhtul3V;
        "pkg-v0.8.640-mc1.20.4-fabric" = _JWjnxLdz;
        "pkg-v0.8.640-mc1.17.1-fabric" = _jAl8XcEx;
        "pkg-v0.8.640-mc1.21.1-fabric" = _PPW4MuXe;
        "pkg-v0.8.640-mc1.19.2-fabric" = _6bOIv8DU;
        "pkg-v0.8.640-mc1.14.4-fabric" = _VBHMBcZc;
        "pkg-v0.8.640-mc1.18.2-forge" = _7LfqkOeo;
        "pkg-v0.8.640-mc1.16.5-fabric" = _qEAlDLLV;
        "pkg-v0.8.640-mc1.20.1-fabric" = _1z7Bokle;
        "pkg-v0.8.640-mc1.19.4-fabric" = _rDBiv8B5;
        "pkg-v0.8.640-mc1.18.2-fabric" = _nqFa3uXT;
        "pkg-v0.8.640-mc1.21.1-neoforge" = _htPdQruK;
        "pkg-v0.8.640-mc1.19.3-fabric" = _tlvRZ3NH;
        "pkg-v0.8.640-mc1.20.2-fabric" = _UwPLoVc2;
        "pkg-v0.8.640-mc1.19.4-forge" = _750c1waH;
        "pkg-v0.8.640-mc1.20.2-neoforge" = _yo9NPTYp;
        "pkg-v0.8.640-mc1.17.1-forge" = _VZlb4pfm;
        "pkg-v0.8.640-mc1.20.6-neoforge" = _jjCm3h0Y;
        "pkg-v0.8.640-mc1.21.3-neoforge" = _L7f3iSp7;
        "pkg-v0.8.641-mc1.15.2-fabric" = _S2EiL3c3;
        "pkg-v0.8.641-mc1.17.1-fabric" = _AZPNiRRT;
        "pkg-v0.8.641-mc1.21.3-fabric" = _BLoOLgju;
        "pkg-v0.8.641-mc1.16.5-fabric" = _bsZXSR7a;
        "pkg-v0.8.641-mc1.20.2-neoforge" = _9s8I0GDD;
        "pkg-v0.8.641-mc1.19.2-fabric" = _9JzJzY60;
        "pkg-v0.8.641-mc1.20.6-neoforge" = _A2h3tIw4;
        "pkg-v0.8.641-mc1.20.6-fabric" = _sIiHY1on;
        "pkg-v0.8.641-mc1.20.2-fabric" = _mrIsUrm1;
        "pkg-v0.8.641-mc1.21.1-neoforge" = _keBXlIFa;
        "pkg-v0.8.641-mc1.14.4-fabric" = _RiPzOH3m;
        "pkg-v0.8.641-mc1.20.4-fabric" = _noBUI21f;
        "pkg-v0.8.641-mc1.19.4-fabric" = _BoHX4yh9;
        "pkg-v0.8.641-mc1.18.2-fabric" = _yonqL6j3;
        "pkg-v0.8.641-mc1.21.3-neoforge" = _eo7IGcld;
        "pkg-v0.8.641-mc1.21.1-fabric" = _7TORQmWH;
        "pkg-v0.8.641-mc1.17.1-forge" = _LfasKZyQ;
        "pkg-v0.8.641-mc1.19.4-forge" = _mQo2ZfMw;
        "pkg-v0.8.641-mc1.20.1-fabric" = _1bLkQmDL;
        "pkg-v0.8.641-mc1.19.3-fabric" = _uv6vO3IS;
        "pkg-v0.8.641-mc1.18.2-forge" = _Uo4dNrzw;
        "pkg-v0.8.643-mc1.15.2-fabric" = _SKzMexJF;
        "pkg-v0.8.643-mc1.14.4-fabric" = _82xmfCTR;
        "pkg-v0.8.643-mc1.19.4-forge" = _afoCvbUm;
        "pkg-v0.8.643-mc1.20.2-neoforge" = _WJ90UyFR;
        "pkg-v0.8.643-mc1.20.6-fabric" = _doy8paNo;
        "pkg-v0.8.643-mc1.16.5-fabric" = _ycVRtTGA;
        "pkg-v0.8.643-mc1.19.2-fabric" = _6M9xshpU;
        "pkg-v0.8.643-mc1.20.2-fabric" = _DAicffS0;
        "pkg-v0.8.643-mc1.21.1-fabric" = _ydkQq9bP;
        "pkg-v0.8.643-mc1.21.1-neoforge" = _Fdrh9qrH;
        "pkg-v0.8.643-mc1.18.2-forge" = _7XYoTZpP;
        "pkg-v0.8.643-mc1.20.6-neoforge" = _pcUWMl2U;
        "pkg-v0.8.643-mc1.17.1-fabric" = _1VRTO6Th;
        "pkg-v0.8.643-mc1.21.3-fabric" = _NCrT11iL;
        "pkg-v0.8.643-mc1.20.4-fabric" = _wTtXTZTU;
        "pkg-v0.8.643-mc1.19.4-fabric" = _Nz6oJYOV;
        "pkg-v0.8.643-mc1.18.2-fabric" = _hzrT4KwM;
        "pkg-v0.8.643-mc1.20.1-fabric" = _EhPHdeDu;
        "pkg-v0.8.643-mc1.17.1-forge" = _YohAxmri;
        "pkg-v0.8.643-mc1.21.3-neoforge" = _p984evRU;
        "pkg-v0.8.643-mc1.19.3-fabric" = _x02xpvWp;
        "pkg-v0.8.648-mc1.21.3-fabric" = _efXclKyW;
        "pkg-v0.8.648-mc1.20.2-fabric" = _XzuzrbQu;
        "pkg-v0.8.648-mc1.18.2-fabric" = _a7XzY6Ed;
        "pkg-v0.8.648-mc1.15.2-fabric" = _PV1mWyb8;
        "pkg-v0.8.648-mc1.20.4-fabric" = _w4laf39a;
        "pkg-v0.8.648-mc1.16.5-fabric" = _nQKVLJtn;
        "pkg-v0.8.648-mc1.14.4-fabric" = _KEYsb84i;
        "pkg-v0.8.648-mc1.20.2-neoforge" = _UhelVwH4;
        "pkg-v0.8.648-mc1.21.1-fabric" = _IivXDbS1;
        "pkg-v0.8.648-mc1.19.2-fabric" = _Nm3QeUPQ;
        "pkg-v0.8.648-mc1.20.1-fabric" = _7irP0oYm;
        "pkg-v0.8.648-mc1.19.4-fabric" = _jRMRz7CZ;
        "pkg-v0.8.648-mc1.18.2-forge" = _VvmlGATl;
        "pkg-v0.8.648-mc1.17.1-forge" = _Kmk2FrGA;
        "pkg-v0.8.648-mc1.21.1-neoforge" = _lvTpWrR2;
        "pkg-v0.8.648-mc1.19.4-forge" = _wYo6eaL8;
        "pkg-v0.8.648-mc1.19.3-fabric" = _EHjYE0WP;
        "pkg-v0.8.648-mc1.20.6-neoforge" = _nuT7QwHN;
        "pkg-v0.8.648-mc1.20.6-fabric" = _nYBwdCu7;
        "pkg-v0.8.648-mc1.21.3-neoforge" = _rPiS9WqY;
        "pkg-v0.8.648-mc1.17.1-fabric" = _zGiKLfUm;
        "pkg-v0.8.649-mc1.20.1-fabric" = _VDIxEyg3;
        "pkg-v0.8.649-mc1.19.2-fabric" = _vNaesTrm;
        "pkg-v0.8.649-mc1.18.2-fabric" = _nFoN0aYN;
        "pkg-v0.8.649-mc1.19.4-fabric" = _YZbxKRzq;
        "pkg-v0.8.649-mc1.21.1-fabric" = _PrTCD4fc;
        "pkg-v0.8.649-mc1.17.1-fabric" = _CgBSim8f;
        "pkg-v0.8.649-mc1.21.3-fabric" = _bayQGZHM;
        "pkg-v0.8.649-mc1.20.6-neoforge" = _xBN4UgON;
        "pkg-v0.8.649-mc1.21.1-neoforge" = _WES6MdJv;
        "pkg-v0.8.649-mc1.14.4-fabric" = _hZIqROE1;
        "pkg-v0.8.649-mc1.20.4-fabric" = _T1IhePCh;
        "pkg-v0.8.649-mc1.15.2-fabric" = _lc1ocjQq;
        "pkg-v0.8.649-mc1.21.3-neoforge" = _hNNMXq7m;
        "pkg-v0.8.649-mc1.19.4-forge" = _isiqCbdG;
        "pkg-v0.8.649-mc1.16.5-fabric" = _lFOk3yGp;
        "pkg-v0.8.649-mc1.17.1-forge" = _O1X2RnpB;
        "pkg-v0.8.649-mc1.20.6-fabric" = _T2X26wvH;
        "pkg-v0.8.649-mc1.18.2-forge" = _5He88CLA;
        "pkg-v0.8.649-mc1.20.2-fabric" = _3VwMtI1O;
        "pkg-v0.8.649-mc1.20.2-neoforge" = _904CRv0c;
        "pkg-v0.8.649-mc1.19.3-fabric" = _cKTssPYo;
        "pkg-v0.8.651-mc1.21.3-fabric" = _7jRnFI71;
        "pkg-v0.8.651-mc1.19.3-fabric" = _iG5LHAeX;
        "pkg-v0.8.651-mc1.20.6-fabric" = _eGdolVZr;
        "pkg-v0.8.651-mc1.20.4-fabric" = _rv8wT1qf;
        "pkg-v0.8.651-mc1.18.2-forge" = _8BcL2Dm9;
        "pkg-v0.8.651-mc1.20.2-fabric" = _FGeJ7nhW;
        "pkg-v0.8.651-mc1.17.1-forge" = _AIRifmku;
        "pkg-v0.8.651-mc1.21.3-neoforge" = _SEcxn5lq;
        "pkg-v0.8.651-mc1.20.2-neoforge" = _E8K3myO3;
        "pkg-v0.8.651-mc1.15.2-fabric" = _XXRzeJC1;
        "pkg-v0.8.651-mc1.21.1-neoforge" = _Pt3NgA79;
        "pkg-v0.8.651-mc1.19.4-forge" = _g8B5i3OY;
        "pkg-v0.8.651-mc1.20.6-neoforge" = _Vq9c2nUp;
        "pkg-v0.8.651-mc1.19.4-fabric" = _fMR0dBTp;
        "pkg-v0.8.651-mc1.16.5-fabric" = _q3rOgpGb;
        "pkg-v0.8.651-mc1.21.1-fabric" = _x1MCsOh8;
        "pkg-v0.8.651-mc1.19.2-fabric" = _MTSpu3RU;
        "pkg-v0.8.651-mc1.17.1-fabric" = _8MrwsVDE;
        "pkg-v0.8.651-mc1.18.2-fabric" = _mpXnoxNb;
        "pkg-v0.8.651-mc1.14.4-fabric" = _UEHCZ9aV;
        "pkg-v0.8.651-mc1.20.1-fabric" = _rR28WttD;
        "pkg-v0.8.653-mc1.15.2-fabric" = _utsrScsP;
        "pkg-v0.8.653-mc1.17.1-forge" = _Urdzt4Zb;
        "pkg-v0.8.653-mc1.18.2-fabric" = _Jrx0S88m;
        "pkg-v0.8.653-mc1.21.1-neoforge" = _KKZaEbVF;
        "pkg-v0.8.653-mc1.20.6-neoforge" = _xy9vcqiX;
        "pkg-v0.8.653-mc1.19.4-forge" = _K0RyZwQR;
        "pkg-v0.8.653-mc1.20.4-fabric" = _axCCSuhE;
        "pkg-v0.8.653-mc1.21.3-neoforge" = _yVWPAF3P;
        "pkg-v0.8.653-mc1.17.1-fabric" = _SfIDS6nV;
        "pkg-v0.8.653-mc1.20.2-fabric" = _jFppMroj;
        "pkg-v0.8.653-mc1.21.1-fabric" = _Ltazhrbm;
        "pkg-v0.8.653-mc1.19.3-fabric" = _Kubwol9k;
        "pkg-v0.8.653-mc1.16.5-fabric" = _KDDi5nCQ;
        "pkg-v0.8.653-mc1.20.2-neoforge" = _9ewT87by;
        "pkg-v0.8.653-mc1.20.6-fabric" = _5lnesQQw;
        "pkg-v0.8.653-mc1.14.4-fabric" = _iINbZZJ4;
        "pkg-v0.8.653-mc1.18.2-forge" = _iZ9lKbml;
        "pkg-v0.8.653-mc1.21.3-fabric" = _sh4JzHdF;
        "pkg-v0.8.653-mc1.19.2-fabric" = _8G6PlDYh;
        "pkg-v0.8.653-mc1.20.1-fabric" = _K2zADcv8;
        "pkg-v0.8.653-mc1.19.4-fabric" = _jSYNDEfK;
        "pkg-v0.8.654-mc1.15.2-fabric" = _cJ8mY6Yx;
        "pkg-v0.8.654-mc1.19.4-fabric" = _sRTRIwtQ;
        "pkg-v0.8.654-mc1.21.3-fabric" = _LzKvYmYc;
        "pkg-v0.8.654-mc1.21.3-neoforge" = _Db0KpVGu;
        "pkg-v0.8.654-mc1.14.4-fabric" = _xYAxVsOh;
        "pkg-v0.8.654-mc1.21.4-neoforge" = _PFfRdieb;
        "pkg-v0.8.654-mc1.17.1-fabric" = _xOFuhMlj;
        "pkg-v0.8.654-mc1.20.6-neoforge" = _PPOn95mQ;
        "pkg-v0.8.654-mc1.19.4-forge" = _8cZythIF;
        "pkg-v0.8.654-mc1.21.4-fabric" = _lK5ufuZt;
        "pkg-v0.8.654-mc1.17.1-forge" = _K34yohV6;
        "pkg-v0.8.654-mc1.18.2-fabric" = _kRymiDyd;
        "pkg-v0.8.654-mc1.16.5-fabric" = _vcDDScs2;
        "pkg-v0.8.654-mc1.20.4-fabric" = _NqCcwUvI;
        "pkg-v0.8.654-mc1.20.2-fabric" = _D9BFnCIS;
        "pkg-v0.8.654-mc1.20.1-fabric" = _jZe8ByKk;
        "pkg-v0.8.654-mc1.19.3-fabric" = _DztIKOw3;
        "pkg-v0.8.654-mc1.18.2-forge" = _6sURZ6jv;
        "pkg-v0.8.654-mc1.21.1-fabric" = _cQFL3lDW;
        "pkg-v0.8.654-mc1.20.2-neoforge" = _dfzdfUTy;
        "pkg-v0.8.654-mc1.20.6-fabric" = _R1rwR9VM;
        "pkg-v0.8.654-mc1.21.1-neoforge" = _doeqqIbF;
        "pkg-v0.8.654-mc1.19.2-fabric" = _Fg2Fd5qj;
        "pkg-v0.8.655-mc1.15.2-fabric" = _5XueMt5T;
        "pkg-v0.8.655-mc1.14.4-fabric" = _3imdCD4Z;
        "pkg-v0.8.655-mc1.21.1-fabric" = _1s31QtiN;
        "pkg-v0.8.655-mc1.20.2-neoforge" = _m1dlMtFe;
        "pkg-v0.8.655-mc1.19.4-fabric" = _f9FHnXHM;
        "pkg-v0.8.655-mc1.19.3-fabric" = _kkxBXija;
        "pkg-v0.8.655-mc1.18.2-fabric" = _w6toYYcG;
        "pkg-v0.8.655-mc1.17.1-fabric" = _5MGgPAY8;
        "pkg-v0.8.655-mc1.20.1-fabric" = _bTJJmPLu;
        "pkg-v0.8.655-mc1.17.1-forge" = _rUVymHbP;
        "pkg-v0.8.655-mc1.20.2-fabric" = _65jrRauq;
        "pkg-v0.8.655-mc1.21.1-neoforge" = _kGWWjsXk;
        "pkg-v0.8.655-mc1.19.2-fabric" = _T1bpMEJg;
        "pkg-v0.8.655-mc1.21.3-fabric" = _MlTqYaKr;
        "pkg-v0.8.655-mc1.20.4-fabric" = _lZlA8q4v;
        "pkg-v0.8.655-mc1.21.4-neoforge" = _Q7r3ESUo;
        "pkg-v0.8.655-mc1.21.4-fabric" = _gvJZx58G;
        "pkg-v0.8.655-mc1.20.6-neoforge" = _fJO6yFB2;
        "pkg-v0.8.655-mc1.19.4-forge" = _PVHjbIO3;
        "pkg-v0.8.655-mc1.16.5-fabric" = _XzBTOFDZ;
        "pkg-v0.8.655-mc1.20.6-fabric" = _pyG84z6d;
        "pkg-v0.8.655-mc1.21.3-neoforge" = _VfmWQSq3;
        "pkg-v0.8.655-mc1.18.2-forge" = _KMQXB4ho;
        "pkg-v0.8.656-mc1.19.2-fabric" = _cMLROBXc;
        "pkg-v0.8.656-mc1.20.2-fabric" = _UiNYYiSV;
        "pkg-v0.8.656-mc1.18.2-forge" = _EoOf0H5q;
        "pkg-v0.8.656-mc1.20.2-neoforge" = _9Ah12zAS;
        "pkg-v0.8.656-mc1.19.4-forge" = _c9HytOKH;
        "pkg-v0.8.656-mc1.18.2-fabric" = _V0w4h29T;
        "pkg-v0.8.656-mc1.14.4-fabric" = _35asLq4O;
        "pkg-v0.8.656-mc1.20.4-fabric" = _mE5FjS2M;
        "pkg-v0.8.656-mc1.21.4-fabric" = _gKtShfIm;
        "pkg-v0.8.656-mc1.15.2-fabric" = _YFrFtPxd;
        "pkg-v0.8.656-mc1.21.3-fabric" = _YzHPKUh6;
        "pkg-v0.8.656-mc1.20.1-fabric" = _WpUGrQUj;
        "pkg-v0.8.656-mc1.21.1-fabric" = _Eiv6H8le;
        "pkg-v0.8.656-mc1.20.6-neoforge" = _ZPRk57g1;
        "pkg-v0.8.656-mc1.19.3-fabric" = _DWKS5quR;
        "pkg-v0.8.656-mc1.17.1-forge" = _LWXX00Fh;
        "pkg-v0.8.656-mc1.16.5-fabric" = _d0T4x1h3;
        "pkg-v0.8.656-mc1.19.4-fabric" = _g20FihRy;
        "pkg-v0.8.656-mc1.21.1-neoforge" = _rGpuflzu;
        "pkg-v0.8.656-mc1.21.3-neoforge" = _vjfqvgob;
        "pkg-v0.8.656-mc1.17.1-fabric" = _5QXG8hPs;
        "pkg-v0.8.656-mc1.21.4-neoforge" = _iqB1bGuB;
        "pkg-v0.8.656-mc1.20.6-fabric" = _Suo9b23k;
        "pkg-v0.8.657-mc1.16.5-fabric" = _2LhvKHST;
        "pkg-v0.8.657-mc1.17.1-forge" = _t4dgc7ko;
        "pkg-v0.8.657-mc1.19.4-forge" = _d7t1XhLs;
        "pkg-v0.8.657-mc1.21.3-fabric" = _KMGoy0w0;
        "pkg-v0.8.657-mc1.19.2-fabric" = _Vit6Z9MX;
        "pkg-v0.8.657-mc1.17.1-fabric" = _vAgga9Ot;
        "pkg-v0.8.657-mc1.21.4-neoforge" = _VO9OnGQg;
        "pkg-v0.8.657-mc1.18.2-fabric" = _4QZc20fa;
        "pkg-v0.8.657-mc1.20.6-neoforge" = _xmbIA4ij;
        "pkg-v0.8.657-mc1.19.3-fabric" = _YKZ9wJcu;
        "pkg-v0.8.657-mc1.15.2-fabric" = _62kx87JY;
        "pkg-v0.8.657-mc1.21.4-fabric" = _QrGLVDF9;
        "pkg-v0.8.657-mc1.14.4-fabric" = _1mHFMkm6;
        "pkg-v0.8.657-mc1.20.6-fabric" = _OJrKWmuO;
        "pkg-v0.8.657-mc1.19.4-fabric" = _VEQBWRGd;
        "pkg-v0.8.657-mc1.20.1-fabric" = _ufwZ4brF;
        "pkg-v0.8.657-mc1.21.1-fabric" = _9lUQcof4;
        "pkg-v0.8.657-mc1.21.3-neoforge" = _1eAm2AW8;
        "pkg-v0.8.657-mc1.20.2-neoforge" = _duI6mTth;
        "pkg-v0.8.657-mc1.20.4-fabric" = _crT7FA1z;
        "pkg-v0.8.657-mc1.21.1-neoforge" = _pv6cgAKH;
        "pkg-v0.8.657-mc1.18.2-forge" = _e0XzcDZ8;
        "pkg-v0.8.657-mc1.20.2-fabric" = _oBlMuWTT;
        "pkg-v0.8.658-mc1.19.3-fabric" = _Dv3HY6T3;
        "pkg-v0.8.658-mc1.21.1-fabric" = _FuDfQxMI;
        "pkg-v0.8.658-mc1.16.5-fabric" = _5ZdRu2pH;
        "pkg-v0.8.658-mc1.20.2-fabric" = _gQCNwq9g;
        "pkg-v0.8.658-mc1.20.2-neoforge" = _mS4ULMnO;
        "pkg-v0.8.658-mc1.19.4-forge" = _XSn5asWn;
        "pkg-v0.8.658-mc1.21.4-fabric" = _mpA1Vwnc;
        "pkg-v0.8.658-mc1.17.1-fabric" = _I3h9nScV;
        "pkg-v0.8.658-mc1.17.1-forge" = _7Ud7nak0;
        "pkg-v0.8.658-mc1.20.6-neoforge" = _a3fUygfJ;
        "pkg-v0.8.658-mc1.21.1-neoforge" = _zIbUI1pD;
        "pkg-v0.8.658-mc1.14.4-fabric" = _gsZulX7M;
        "pkg-v0.8.658-mc1.21.4-neoforge" = _ditQZKol;
        "pkg-v0.8.658-mc1.18.2-forge" = _ylyrmHmO;
        "pkg-v0.8.658-mc1.18.2-fabric" = _V4p24qsj;
        "pkg-v0.8.658-mc1.20.6-fabric" = _3wM29I3n;
        "pkg-v0.8.658-mc1.20.4-fabric" = _1BsXDuNu;
        "pkg-v0.8.658-mc1.20.1-fabric" = _rOi4hYJc;
        "pkg-v0.8.658-mc1.19.4-fabric" = _ZlSqKjZP;
        "pkg-v0.8.658-mc1.21.3-neoforge" = _48s4vPEq;
        "pkg-v0.8.658-mc1.15.2-fabric" = _bGIpkMGY;
        "pkg-v0.8.658-mc1.19.2-fabric" = _SoNyNIFx;
        "pkg-v0.8.658-mc1.21.3-fabric" = _uW7sscZd;
        "pkg-v0.8.663-mc1.14.4-fabric" = _PSDDQXiV;
        "pkg-v0.8.663-mc1.15.2-fabric" = _GDWE3ftT;
        "pkg-v0.8.663-mc1.19.4-fabric" = _uRDJ9lC6;
        "pkg-v0.8.663-mc1.19.2-fabric" = _lL30Rx4k;
        "pkg-v0.8.663-mc1.21.1-fabric" = _L8S04nsJ;
        "pkg-v0.8.663-mc1.18.2-forge" = _qr29FPZg;
        "pkg-v0.8.663-mc1.21.3-fabric" = _ThrdbGH1;
        "pkg-v0.8.663-mc1.20.4-fabric" = _p0CnxKc1;
        "pkg-v0.8.663-mc1.17.1-fabric" = _Lz0nECOw;
        "pkg-v0.8.663-mc1.20.6-fabric" = _oxZO9k7m;
        "pkg-v0.8.663-mc1.20.2-neoforge" = _9wf4048G;
        "pkg-v0.8.663-mc1.20.1-fabric" = _JxR8ZZwM;
        "pkg-v0.8.663-mc1.21.3-neoforge" = _M7U9zbZw;
        "pkg-v0.8.663-mc1.17.1-forge" = _WB5wIJ8j;
        "pkg-v0.8.663-mc1.18.2-fabric" = _2GjogpYH;
        "pkg-v0.8.663-mc1.16.5-fabric" = _JCL0f3Lz;
        "pkg-v0.8.663-mc1.20.2-fabric" = _vFUhGJ7k;
        "pkg-v0.8.663-mc1.20.6-neoforge" = _FeSRJs9d;
        "pkg-v0.8.663-mc1.21.1-neoforge" = _wfkXFiLs;
        "pkg-v0.8.663-mc1.19.3-fabric" = _Q5EIEFs0;
        "pkg-v0.8.663-mc1.21.4-neoforge" = _OQqu1Omu;
        "pkg-v0.8.663-mc1.21.4-fabric" = _NtUJ3WDt;
        "pkg-v0.8.663-mc1.19.4-forge" = _BBLC7Tm3;
        "pkg-v0.8.664-mc1.14.4-fabric" = _9hD4TPXi;
        "pkg-v0.8.664-mc1.19.4-fabric" = _SI3czt86;
        "pkg-v0.8.664-mc1.18.2-fabric" = _lUij25A3;
        "pkg-v0.8.664-mc1.20.1-fabric" = _DcOrQgal;
        "pkg-v0.8.664-mc1.17.1-fabric" = _jbrjo6KP;
        "pkg-v0.8.664-mc1.19.2-fabric" = _gF9ItN7s;
        "pkg-v0.8.664-mc1.21.4-neoforge" = _ntC60ZHS;
        "pkg-v0.8.664-mc1.21.3-fabric" = _CbSnPvvU;
        "pkg-v0.8.664-mc1.19.3-fabric" = _KunvblPq;
        "pkg-v0.8.664-mc1.20.6-fabric" = _27Q2VwKZ;
        "pkg-v0.8.664-mc1.19.4-forge" = _H3wNthJj;
        "pkg-v0.8.664-mc1.21.1-fabric" = _z5D6QZXh;
        "pkg-v0.8.664-mc1.15.2-fabric" = _ML1hBkki;
        "pkg-v0.8.664-mc1.16.5-fabric" = _QHEnUWTf;
        "pkg-v0.8.664-mc1.20.4-fabric" = _CawrUrC5;
        "pkg-v0.8.664-mc1.21.4-fabric" = _FcyDuH6O;
        "pkg-v0.8.664-mc1.20.2-fabric" = _dNTWp2eU;
        "pkg-v0.8.664-mc1.18.2-forge" = _U7p9LLvn;
        "pkg-v0.8.664-mc1.20.6-neoforge" = _R6mu3Kbf;
        "pkg-v0.8.664-mc1.20.2-neoforge" = _7xFC3Euw;
        "pkg-v0.8.664-mc1.21.3-neoforge" = _srVfQSEg;
        "pkg-v0.8.664-mc1.17.1-forge" = _1jV9ZFmT;
        "pkg-v0.8.664-mc1.21.1-neoforge" = _ycTFx800;
        "pkg-v0.8.667-mc1.17.1-fabric" = _wC9A9ttH;
        "pkg-v0.8.667-mc1.20.2-fabric" = _6ZxpFhD9;
        "pkg-v0.8.667-mc1.21.3-fabric" = _LL98VsjH;
        "pkg-v0.8.667-mc1.21.1-fabric" = _nZh6fIIb;
        "pkg-v0.8.667-mc1.15.2-fabric" = _4DjMNjEt;
        "pkg-v0.8.667-mc1.21.3-neoforge" = _4hi42kwe;
        "pkg-v0.8.667-mc1.16.5-fabric" = _9L4yjWeP;
        "pkg-v0.8.667-mc1.21.4-neoforge" = _wzcQBEHw;
        "pkg-v0.8.667-mc1.19.2-fabric" = _9JZWxEPI;
        "pkg-v0.8.667-mc1.17.1-forge" = _YaJCCfeF;
        "pkg-v0.8.667-mc1.21.4-fabric" = _w6NM2aXr;
        "pkg-v0.8.667-mc1.18.2-forge" = _iiqpn44k;
        "pkg-v0.8.667-mc1.20.2-neoforge" = _Nzr1o4re;
        "pkg-v0.8.667-mc1.20.4-fabric" = _Y3dN6UiL;
        "pkg-v0.8.667-mc1.14.4-fabric" = _RetoaU4E;
        "pkg-v0.8.667-mc1.20.1-fabric" = _dRgpnoVg;
        "pkg-v0.8.667-mc1.20.6-fabric" = _8TxeLa7R;
        "pkg-v0.8.667-mc1.19.3-fabric" = _QXErmqt9;
        "pkg-v0.8.667-mc1.19.4-forge" = _7keM5QCf;
        "pkg-v0.8.667-mc1.19.4-fabric" = _xQzVSagD;
        "pkg-v0.8.667-mc1.21.1-neoforge" = _nVhwSKmI;
        "pkg-v0.8.667-mc1.18.2-fabric" = _FM30mFv5;
        "pkg-v0.8.667-mc1.20.6-neoforge" = _jo5sHRZo;
        "pkg-v0.8.668-mc1.18.2-forge" = _xdfgWJDy;
        "pkg-v0.8.668-mc1.20.2-fabric" = _l9sksG2w;
        "pkg-v0.8.668-mc1.21.3-neoforge" = _2HW8bIbW;
        "pkg-v0.8.668-mc1.18.2-fabric" = _hEoiq4wz;
        "pkg-v0.8.668-mc1.19.2-fabric" = _hyOKF3rY;
        "pkg-v0.8.668-mc1.14.4-fabric" = _FZ8XTZJE;
        "pkg-v0.8.668-mc1.20.6-fabric" = _NQglmhXG;
        "pkg-v0.8.668-mc1.20.1-fabric" = _bxRPmkjx;
        "pkg-v0.8.668-mc1.21.4-neoforge" = _iy0tNIcb;
        "pkg-v0.8.668-mc1.20.4-fabric" = _PfjEwqxx;
        "pkg-v0.8.668-mc1.20.2-neoforge" = _eCwim4V3;
        "pkg-v0.8.668-mc1.19.3-fabric" = _C1gNM8Nx;
        "pkg-v0.8.668-mc1.21.1-neoforge" = _dReQOlzE;
        "pkg-v0.8.668-mc1.19.4-forge" = _WaP6YuvU;
        "pkg-v0.8.668-mc1.16.5-fabric" = _gsZ9j4ZR;
        "pkg-v0.8.668-mc1.15.2-fabric" = _CfiFnXwf;
        "pkg-v0.8.668-mc1.21.4-fabric" = _Pe7LOpsy;
        "pkg-v0.8.668-mc1.21.3-fabric" = _mOSb98je;
        "pkg-v0.8.668-mc1.17.1-fabric" = _dQtkAj3m;
        "pkg-v0.8.668-mc1.17.1-forge" = _a0pJGsfb;
        "pkg-v0.8.668-mc1.20.6-neoforge" = _BzbTVsq3;
        "pkg-v0.8.668-mc1.21.1-fabric" = _Ww6LDdhv;
        "pkg-v0.8.668-mc1.19.4-fabric" = _lpgMMPqT;
        "pkg-v0.8.669-mc1.14.4-fabric" = _oW7z3xCQ;
        "pkg-v0.8.669-mc1.20.1-fabric" = _Bj8uwK3p;
        "pkg-v0.8.669-mc1.20.4-fabric" = _HVCF5Y9e;
        "pkg-v0.8.669-mc1.20.6-fabric" = _WOxmGcVg;
        "pkg-v0.8.669-mc1.16.5-fabric" = _oUETbx5t;
        "pkg-v0.8.669-mc1.19.4-fabric" = _MQIFFkL3;
        "pkg-v0.8.669-mc1.21.3-fabric" = _IQtuFVZD;
        "pkg-v0.8.669-mc1.19.4-forge" = _PAhwtDoH;
        "pkg-v0.8.669-mc1.20.2-neoforge" = _2kTqtvr4;
        "pkg-v0.8.669-mc1.21.3-neoforge" = _ujxv4yst;
        "pkg-v0.8.669-mc1.17.1-forge" = _YHe8PbS3;
        "pkg-v0.8.669-mc1.20.2-fabric" = _5CrVbNSH;
        "pkg-v0.8.669-mc1.20.6-neoforge" = _fc1qcngH;
        "pkg-v0.8.669-mc1.17.1-fabric" = _KQMFVQZD;
        "pkg-v0.8.669-mc1.18.2-fabric" = _Bt4dMJ5W;
        "pkg-v0.8.669-mc1.18.2-forge" = _s9hDgo1Y;
        "pkg-v0.8.669-mc1.21.1-neoforge" = _h2S1AC00;
        "pkg-v0.8.669-mc1.21.1-fabric" = _XePytwZq;
        "pkg-v0.8.669-mc1.19.2-fabric" = _8JUO6NQE;
        "pkg-v0.8.669-mc1.15.2-fabric" = _UqLdHBUR;
        "pkg-v0.8.669-mc1.19.3-fabric" = _Ry4706fE;
        "pkg-v0.8.669-mc1.21.4-neoforge" = _pzNANCzQ;
        "pkg-v0.8.669-mc1.21.4-fabric" = _PvSCs9z2;
        "pkg-v0.8.670-mc1.16.5-fabric" = _M1mtagLE;
        "pkg-v0.8.670-mc1.17.1-fabric" = _c10lORGU;
        "pkg-v0.8.670-mc1.19.2-fabric" = _8JYOu1p6;
        "pkg-v0.8.670-mc1.18.2-fabric" = _22I9610m;
        "pkg-v0.8.670-mc1.20.2-neoforge" = _ia5RlAqt;
        "pkg-v0.8.670-mc1.21.3-fabric" = _xFaWudKp;
        "pkg-v0.8.670-mc1.17.1-forge" = _93U0PUHH;
        "pkg-v0.8.670-mc1.20.6-neoforge" = _MUkAXKPe;
        "pkg-v0.8.670-mc1.21.4-fabric" = _X7PAqynL;
        "pkg-v0.8.670-mc1.21.4-neoforge" = _tgH6H7tn;
        "pkg-v0.8.670-mc1.19.4-fabric" = _JWneHkpE;
        "pkg-v0.8.670-mc1.21.1-neoforge" = _6fIDVRAs;
        "pkg-v0.8.670-mc1.19.3-fabric" = _pJOsB2vN;
        "pkg-v0.8.670-mc1.20.4-fabric" = _stGXMSVl;
        "pkg-v0.8.670-mc1.15.2-fabric" = _CttBU4VF;
        "pkg-v0.8.670-mc1.20.1-fabric" = _13dfPOHr;
        "pkg-v0.8.670-mc1.20.2-fabric" = _vx49FnVs;
        "pkg-v0.8.670-mc1.21.3-neoforge" = _kNAqpUAQ;
        "pkg-v0.8.670-mc1.19.4-forge" = _yl2BGzV9;
        "pkg-v0.8.675-mc1.16.5-fabric" = _FSSGxl9Q;
        "pkg-v0.8.675-mc1.19.2-fabric" = _2iPudN7A;
        "pkg-v0.8.675-mc1.18.2-fabric" = _OblH5jnU;
        "pkg-v0.8.675-mc1.20.2-fabric" = _ArAHvDKC;
        "pkg-v0.8.675-mc1.19.4-forge" = _PMWMF1fr;
        "pkg-v0.8.675-mc1.19.4-fabric" = _aNZIAV0k;
        "pkg-v0.8.675-mc1.15.2-fabric" = _rdejs1f0;
        "pkg-v0.8.675-mc1.20.6-fabric" = _PsHQz7Hb;
        "pkg-v0.8.675-mc1.17.1-fabric" = _dYhADmbM;
        "pkg-v0.8.675-mc1.20.1-fabric" = _ft0kyvPh;
        "pkg-v0.8.675-mc1.20.4-fabric" = _ZQ4PjTO0;
        "pkg-v0.8.675-mc1.19.3-fabric" = _WAuHmGei;
        "pkg-v0.8.675-mc1.21.1-fabric" = _CteF23IJ;
        "pkg-v0.8.675-mc1.17.1-forge" = _IrxmFk5Q;
        "pkg-v0.8.675-mc1.14.4-fabric" = _TZOVqA8r;
        "pkg-v0.8.675-mc1.21.3-fabric" = _adatQHNz;
        "pkg-v0.8.675-mc1.21.1-neoforge" = _cuqiIx9I;
        "pkg-v0.8.675-mc1.18.2-forge" = _obBo80aA;
        "pkg-v0.8.675-mc1.21.4-neoforge" = _jYQyyQzA;
        "pkg-v0.8.675-mc1.21.3-neoforge" = _8KpbDCKp;
        "pkg-v0.8.675-mc1.20.6-neoforge" = _jpX4Og50;
        "pkg-v0.8.675-mc1.20.2-neoforge" = _A8bKbMfC;
        "pkg-v0.8.675-mc1.21.4-fabric" = _mLndl5Jv;
        "pkg-v0.8.677-mc1.14.4-fabric" = _WrDtA412;
        "pkg-v0.8.677-mc1.18.2-fabric" = _Tbv2MYAx;
        "pkg-v0.8.677-mc1.20.1-fabric" = _nre2uxVM;
        "pkg-v0.8.677-mc1.18.2-forge" = _5wHWc5Wk;
        "pkg-v0.8.677-mc1.20.2-fabric" = _UZ9lbUvb;
        "pkg-v0.8.677-mc1.19.3-fabric" = _szqKTh24;
        "pkg-v0.8.677-mc1.19.4-forge" = _7bie0yfA;
        "pkg-v0.8.677-mc1.21.4-neoforge" = _oRyNsCra;
        "pkg-v0.8.677-mc1.20.6-fabric" = _DG9YvEut;
        "pkg-v0.8.677-mc1.16.5-fabric" = _aXkaCbXX;
        "pkg-v0.8.677-mc1.20.6-neoforge" = _xxTZbWa7;
        "pkg-v0.8.677-mc1.17.1-forge" = _u0nO7saA;
        "pkg-v0.8.677-mc1.19.2-fabric" = _n80fpnwE;
        "pkg-v0.8.677-mc1.21.1-fabric" = _AAyOwDSu;
        "pkg-v0.8.677-mc1.17.1-fabric" = _Okk4eylq;
        "pkg-v0.8.677-mc1.21.1-neoforge" = _YXCI7tdK;
        "pkg-v0.8.677-mc1.20.2-neoforge" = _IkeF9ZdW;
        "pkg-v0.8.677-mc1.15.2-fabric" = _FnE6wMEP;
        "pkg-v0.8.677-mc1.20.4-fabric" = _k0iE0pW0;
        "pkg-v0.8.677-mc1.21.3-fabric" = _3lOOk8ed;
        "pkg-v0.8.677-mc1.19.4-fabric" = _ogRBurEV;
        "pkg-v0.8.677-mc1.21.3-neoforge" = _26ZL6zst;
        "pkg-v0.8.677-mc1.21.4-fabric" = _CR7bC5DP;
        "pkg-v0.8.683-mc1.17.1-fabric" = _AfgFDlFf;
        "pkg-v0.8.683-mc1.18.2-fabric" = _xXSmQ5TI;
        "pkg-v0.8.683-mc1.21.4-fabric" = _F2kkimfO;
        "pkg-v0.8.683-mc1.14.4-fabric" = _KauNJSFR;
        "pkg-v0.8.683-mc1.16.5-fabric" = _sYooKHkN;
        "pkg-v0.8.683-mc1.21.5-fabric" = _f23DXJn4;
        "pkg-v0.8.683-mc1.21.3-fabric" = _ogKSpCJa;
        "pkg-v0.8.683-mc1.15.2-fabric" = _HsWi26U9;
        "pkg-v0.8.683-mc1.19.2-fabric" = _2pDuIQXo;
        "pkg-v0.8.683-mc1.21.4-neoforge" = _v7Xnnvlh;
        "pkg-v0.8.683-mc1.21.5-neoforge" = _bm3vGhiu;
        "pkg-v0.8.683-mc1.20.1-fabric" = _RxagsSKc;
        "pkg-v0.8.683-mc1.21.1-fabric" = _s39JNANh;
        "pkg-v0.8.683-mc1.20.2-fabric" = _xfwcwrY9;
        "pkg-v0.8.683-mc1.21.3-neoforge" = _3sCEF44U;
        "pkg-v0.8.683-mc1.20.6-neoforge" = _wSTFjfwP;
        "pkg-v0.8.683-mc1.19.4-forge" = _63LvYANJ;
        "pkg-v0.8.683-mc1.19.3-fabric" = _ABsLxtg0;
        "pkg-v0.8.683-mc1.20.4-fabric" = _QVuXwNXU;
        "pkg-v0.8.683-mc1.18.2-forge" = _cuydCb80;
        "pkg-v0.8.683-mc1.20.6-fabric" = _wgvR5FxA;
        "pkg-v0.8.683-mc1.21.1-neoforge" = _nG4Mp0L2;
        "pkg-v0.8.683-mc1.19.4-fabric" = _vlOrEPe3;
        "pkg-v0.8.683-mc1.17.1-forge" = _cyC34toD;
        "pkg-v0.8.683-mc1.20.2-neoforge" = _GSh0GUHU;
        "pkg-v0.8.684-mc1.20.1-fabric" = _TEXj1SPJ;
        "pkg-v0.8.684-mc1.18.2-fabric" = _Pdy4puYu;
        "pkg-v0.8.684-mc1.14.4-fabric" = _J3Wdg078;
        "pkg-v0.8.684-mc1.15.2-fabric" = _4xuILtjx;
        "pkg-v0.8.684-mc1.19.2-fabric" = _SzOYMvqD;
        "pkg-v0.8.684-mc1.20.6-neoforge" = _fDTrIUr2;
        "pkg-v0.8.684-mc1.20.2-fabric" = _w0HSb36n;
        "pkg-v0.8.684-mc1.17.1-forge" = _Jr7eUct1;
        "pkg-v0.8.684-mc1.20.6-fabric" = _ay4wm1wX;
        "pkg-v0.8.684-mc1.20.2-neoforge" = _Gbmx6vwR;
        "pkg-v0.8.684-mc1.18.2-forge" = _wFsF9zVz;
        "pkg-v0.8.684-mc1.21.4-fabric" = _QdKfm38o;
        "pkg-v0.8.684-mc1.21.3-fabric" = _5ApVmZvJ;
        "pkg-v0.8.684-mc1.21.1-neoforge" = _T9U5AGcF;
        "pkg-v0.8.684-mc1.21.4-neoforge" = _EMIT58gC;
        "pkg-v0.8.684-mc1.16.5-fabric" = _PX3qrLFE;
        "pkg-v0.8.684-mc1.21.1-fabric" = _Qkg07kqE;
        "pkg-v0.8.684-mc1.21.3-neoforge" = _FyAi5rgf;
        "pkg-v0.8.684-mc1.21.5-neoforge" = _ImPVthRA;
        "pkg-v0.8.684-mc1.21.5-fabric" = _mx7pwXKp;
        "pkg-v0.8.684-mc1.19.3-fabric" = _MUJp0Rvr;
        "pkg-v0.8.684-mc1.19.4-forge" = _jFvghcyT;
        "pkg-v0.8.684-mc1.17.1-fabric" = _u3CtLJlT;
        "pkg-v0.8.684-mc1.19.4-fabric" = _ThAh5CY6;
        "pkg-v0.8.684-mc1.20.4-fabric" = _m2WYfTup;
        "pkg-v0.8.685-mc1.20.4-fabric" = _FM2oy1ht;
        "pkg-v0.8.685-mc1.18.2-forge" = _1OnEFVhP;
        "pkg-v0.8.685-mc1.18.2-fabric" = _xhFdEinM;
        "pkg-v0.8.685-mc1.14.4-fabric" = _OS218FDc;
        "pkg-v0.8.685-mc1.20.2-neoforge" = _8MbwRZsI;
        "pkg-v0.8.685-mc1.15.2-fabric" = _t6yogFQP;
        "pkg-v0.8.685-mc1.19.4-forge" = _YsAJAXR6;
        "pkg-v0.8.685-mc1.21.1-fabric" = _UkPiXnWY;
        "pkg-v0.8.685-mc1.19.4-fabric" = _FbBvQC2E;
        "pkg-v0.8.685-mc1.19.2-fabric" = _mByZKvRB;
        "pkg-v0.8.685-mc1.21.3-fabric" = _tavWNkyB;
        "pkg-v0.8.685-mc1.20.2-fabric" = _dFBFMc8z;
        "pkg-v0.8.685-mc1.21.3-neoforge" = _V799KrvV;
        "pkg-v0.8.685-mc1.21.5-neoforge" = _luYy07Nt;
        "pkg-v0.8.685-mc1.20.6-neoforge" = _JpwxLDyZ;
        "pkg-v0.8.685-mc1.19.3-fabric" = _rRHlzPc6;
        "pkg-v0.8.685-mc1.20.6-fabric" = _Y5A7wk6p;
        "pkg-v0.8.685-mc1.16.5-fabric" = _9TFiJd8T;
        "pkg-v0.8.685-mc1.21.4-neoforge" = _P1fHfM9q;
        "pkg-v0.8.685-mc1.17.1-fabric" = _mL4Si8Gl;
        "pkg-v0.8.685-mc1.21.5-fabric" = _ZDzl117O;
        "pkg-v0.8.685-mc1.21.1-neoforge" = _pmGpxwfG;
        "pkg-v0.8.685-mc1.17.1-forge" = _u4R9w8As;
        "pkg-v0.8.685-mc1.20.1-fabric" = _NlaDtVgV;
        "pkg-v0.8.685-mc1.21.4-fabric" = _VqGZMkil;
        "pkg-v0.8.691-mc1.17.1-fabric" = _ePmZbWa0;
        "pkg-v0.8.691-mc1.18.2-forge" = _PcgsjXFm;
        "pkg-v0.8.691-mc1.15.2-fabric" = _RLFKFtGD;
        "pkg-v0.8.691-mc1.19.3-fabric" = _sTXXUgAl;
        "pkg-v0.8.691-mc1.19.4-fabric" = _AiBj43Ba;
        "pkg-v0.8.691-mc1.21.5-fabric" = _L9JHADll;
        "pkg-v0.8.691-mc1.21.4-fabric" = _B2dVAvc3;
        "pkg-v0.8.691-mc1.17.1-forge" = _V91DFPj3;
        "pkg-v0.8.691-mc1.18.2-fabric" = _H8e6gC2s;
        "pkg-v0.8.691-mc1.21.3-fabric" = _IYOXsSyt;
        "pkg-v0.8.691-mc1.21.4-neoforge" = _XCdPkPwC;
        "pkg-v0.8.691-mc1.20.1-fabric" = _HRs5mnMz;
        "pkg-v0.8.691-mc1.20.2-neoforge" = _Ns6KQTZh;
        "pkg-v0.8.691-mc1.20.4-fabric" = _IWIBOjoE;
        "pkg-v0.8.691-mc1.21.3-neoforge" = _4dAFWFYK;
        "pkg-v0.8.691-mc1.16.5-fabric" = _ru9PUyKn;
        "pkg-v0.8.691-mc1.21.1-fabric" = _3tvZH3ZF;
        "pkg-v0.8.691-mc1.21.1-neoforge" = _IK1KnR3h;
        "pkg-v0.8.691-mc1.21.5-neoforge" = _b8ZfyqyR;
        "pkg-v0.8.691-mc1.14.4-fabric" = _z3IbE9q9;
        "pkg-v0.8.691-mc1.19.4-forge" = _JX3sE8mA;
        "pkg-v0.8.691-mc1.19.2-fabric" = _V9iN4NXF;
        "pkg-v0.8.691-mc1.20.6-fabric" = _Bx03pX5g;
        "pkg-v0.8.691-mc1.20.6-neoforge" = _blOHDL19;
        "pkg-v0.8.691-mc1.20.2-fabric" = _ELZbxFGX;
        "pkg-v0.8.693-mc1.19.2-fabric" = _CySU4vWZ;
        "pkg-v0.8.693-mc1.21.4-fabric" = _E7BKaWcz;
        "pkg-v0.8.693-mc1.18.2-forge" = _OLc9sNRi;
        "pkg-v0.8.693-mc1.17.1-fabric" = _F1msmjkt;
        "pkg-v0.8.693-mc1.19.3-fabric" = _ZdhUBdmM;
        "pkg-v0.8.693-mc1.20.6-fabric" = _E4fA3Tvw;
        "pkg-v0.8.693-mc1.21.4-neoforge" = _xTmnEJ8H;
        "pkg-v0.8.693-mc1.17.1-forge" = _VeXoAoKG;
        "pkg-v0.8.693-mc1.21.1-neoforge" = _oqtpVnU7;
        "pkg-v0.8.693-mc1.18.2-fabric" = _x38du1uK;
        "pkg-v0.8.693-mc1.14.4-fabric" = _TBrpiisu;
        "pkg-v0.8.693-mc1.21.5-neoforge" = _xKl4MD7l;
        "pkg-v0.8.693-mc1.21.5-fabric" = _VjLnlXtj;
        "pkg-v0.8.693-mc1.16.5-fabric" = _QS7atPRr;
        "pkg-v0.8.693-mc1.20.2-fabric" = _OsmsFyPo;
        "pkg-v0.8.693-mc1.21.1-fabric" = _GU5gKZLL;
        "pkg-v0.8.693-mc1.19.4-forge" = _HQoO1h5a;
        "pkg-v0.8.693-mc1.20.6-neoforge" = _xe415QaM;
        "pkg-v0.8.693-mc1.20.2-neoforge" = _NrXvLtxS;
        "pkg-v0.8.693-mc1.20.4-fabric" = _5qtlUPew;
        "pkg-v0.8.693-mc1.21.3-neoforge" = _92D7iY1M;
        "pkg-v0.8.693-mc1.19.4-fabric" = _4IuCg5il;
        "pkg-v0.8.693-mc1.15.2-fabric" = _1IeNh0PL;
        "pkg-v0.8.693-mc1.21.3-fabric" = _PwyjcFIQ;
        "pkg-v0.8.693-mc1.20.1-fabric" = _MitKLNzr;
        "pkg-v0.8.697-mc1.20.2-fabric" = _gEDVuhXC;
        "pkg-v0.8.697-mc1.21.4-fabric" = _Rkqm1sKQ;
        "pkg-v0.8.697-mc1.21.3-neoforge" = _MOmVDyuc;
        "pkg-v0.8.697-mc1.17.1-forge" = _XaDMKpOf;
        "pkg-v0.8.697-mc1.18.2-fabric" = _ZgdlecyD;
        "pkg-v0.8.697-mc1.20.4-fabric" = _JAix8kVK;
        "pkg-v0.8.697-mc1.21.1-neoforge" = _XDsSujDL;
        "pkg-v0.8.697-mc1.20.2-neoforge" = _aHzCw2bu;
        "pkg-v0.8.697-mc1.14.4-fabric" = _fi4PXyw2;
        "pkg-v0.8.697-mc1.15.2-fabric" = _lhgHOlgR;
        "pkg-v0.8.697-mc1.19.2-fabric" = _1NNR96sK;
        "pkg-v0.8.697-mc1.17.1-fabric" = _QDF1UW2x;
        "pkg-v0.8.697-mc1.18.2-forge" = _9tK9Av3X;
        "pkg-v0.8.697-mc1.21.5-fabric" = _bldVI7Mb;
        "pkg-v0.8.697-mc1.19.3-fabric" = _Hy88l3Ne;
        "pkg-v0.8.697-mc1.21.5-neoforge" = _PM8HI0Mq;
        "pkg-v0.8.697-mc1.16.5-fabric" = _kMgmiU4X;
        "pkg-v0.8.697-mc1.20.6-fabric" = _3k6ThSPZ;
        "pkg-v0.8.697-mc1.21.4-neoforge" = _sDOne8HA;
        "pkg-v0.8.697-mc1.20.1-fabric" = _pozIxVXC;
        "pkg-v0.8.697-mc1.19.4-forge" = _WYnel7pY;
        "pkg-v0.8.697-mc1.20.6-neoforge" = _WRKGruxM;
        "pkg-v0.8.697-mc1.19.4-fabric" = _ah6nKsrw;
        "pkg-v0.8.697-mc1.21.3-fabric" = _ao5eKc4D;
        "pkg-v0.8.697-mc1.21.1-fabric" = _46Qszh47;
        "pkg-v0.8.702-mc1.17.1-fabric" = _ceB3E0WK;
        "pkg-v0.8.702-mc1.18.2-fabric" = _8oOMGWwM;
        "pkg-v0.8.702-mc1.20.1-fabric" = _6SN6jnO9;
        "pkg-v0.8.702-mc1.20.4-fabric" = _cvdS0AO5;
        "pkg-v0.8.702-mc1.21.3-neoforge" = _3VTC4KD4;
        "pkg-v0.8.702-mc1.20.6-fabric" = _HJUq6YFq;
        "pkg-v0.8.702-mc1.18.2-forge" = _Ubu7qh2j;
        "pkg-v0.8.702-mc1.20.2-neoforge" = _njKW7T6T;
        "pkg-v0.8.702-mc1.19.4-forge" = _AJcBFOD8;
        "pkg-v0.8.702-mc1.20.6-neoforge" = _MVYf7dGy;
        "pkg-v0.8.702-mc1.19.4-fabric" = _3RYRJCi9;
        "pkg-v0.8.702-mc1.20.2-fabric" = _GwqXV6Xw;
        "pkg-v0.8.702-mc1.21.4-fabric" = _558FLfYC;
        "pkg-v0.8.702-mc1.15.2-fabric" = _dkMwzVrd;
        "pkg-v0.8.702-mc1.19.3-fabric" = _Y6sHrrPh;
        "pkg-v0.8.702-mc1.21.3-fabric" = _HkDkmCEl;
        "pkg-v0.8.702-mc1.21.5-neoforge" = _MdgjJbbI;
        "pkg-v0.8.702-mc1.21.1-neoforge" = _XJssNcQO;
        "pkg-v0.8.702-mc1.16.5-fabric" = _6ZgfjV28;
        "pkg-v0.8.702-mc1.21.1-fabric" = _ztsOYOdv;
        "pkg-v0.8.702-mc1.19.2-fabric" = _qy4zrRP2;
        "pkg-v0.8.702-mc1.17.1-forge" = _CSHhD9Vv;
        "pkg-v0.8.702-mc1.21.4-neoforge" = _wRDdE2vD;
        "pkg-v0.8.702-mc1.21.5-fabric" = _kJCTb3Rl;
        "pkg-v0.8.702-mc1.14.4-fabric" = _yCd4sydu;
        "pkg-v0.8.707-mc1.20.4-fabric" = _8TsvTKSA;
        "pkg-v0.8.707-mc1.14.4-fabric" = _nLsOfHXn;
        "pkg-v0.8.707-mc1.21.4-neoforge" = _51fnXddR;
        "pkg-v0.8.707-mc1.19.4-forge" = _RcHuIGoG;
        "pkg-v0.8.707-mc1.21.1-fabric" = _FO7Yv9XI;
        "pkg-v0.8.707-mc1.17.1-forge" = _8ErcTVoH;
        "pkg-v0.8.707-mc1.20.2-fabric" = _B8rsHkoE;
        "pkg-v0.8.707-mc1.20.2-neoforge" = _ypVmJj9q;
        "pkg-v0.8.707-mc1.15.2-fabric" = _ytsyt9sB;
        "pkg-v0.8.707-mc1.20.6-neoforge" = _9I2rW2Dk;
        "pkg-v0.8.707-mc1.17.1-fabric" = _yNvDmloD;
        "pkg-v0.8.707-mc1.19.3-fabric" = _HWkjDi6a;
        "pkg-v0.8.707-mc1.20.6-fabric" = _E2TkaVWr;
        "pkg-v0.8.707-mc1.20.1-fabric" = _Kg4BvK73;
        "pkg-v0.8.707-mc1.19.4-fabric" = _t9qLfEmG;
        "pkg-v0.8.707-mc1.16.5-fabric" = _SYFVZjD0;
        "pkg-v0.8.707-mc1.18.2-fabric" = _YT0YCEdJ;
        "pkg-v0.8.707-mc1.21.5-fabric" = _hZLWZzgQ;
        "pkg-v0.8.707-mc1.19.2-fabric" = _fgetDOLt;
        "pkg-v0.8.707-mc1.18.2-forge" = _FSn4h7sT;
        "pkg-v0.8.707-mc1.21.5-neoforge" = _UEKctaii;
        "pkg-v0.8.707-mc1.21.3-neoforge" = _Nm8iJgDl;
        "pkg-v0.8.707-mc1.21.3-fabric" = _U3kYaD5s;
        "pkg-v0.8.708-mc1.21.1-fabric" = _m5t8s7Ks;
        "pkg-v0.8.708-mc1.14.4-fabric" = _CGJJ5Omo;
        "pkg-v0.8.708-mc1.19.4-fabric" = _EwNPaaXS;
        "pkg-v0.8.708-mc1.18.2-fabric" = _wcpwXZtB;
        "pkg-v0.8.708-mc1.20.4-fabric" = _Q4EtWoTw;
        "pkg-v0.8.708-mc1.15.2-fabric" = _DiO9ouri;
        "pkg-v0.8.708-mc1.20.1-fabric" = _IHizxjqo;
        "pkg-v0.8.708-mc1.16.5-fabric" = _u7PbcmRw;
        "pkg-v0.8.708-mc1.20.2-neoforge" = _UZfxr76I;
        "pkg-v0.8.708-mc1.20.2-fabric" = _6dl40veO;
        "pkg-v0.8.708-mc1.18.2-forge" = _CaKYigyq;
        "pkg-v0.8.708-mc1.21.1-neoforge" = _8JAb5yFI;
        "pkg-v0.8.708-mc1.21.5-fabric" = _IR8ZdRH2;
        "pkg-v0.8.708-mc1.21.4-neoforge" = _NvDu5ecB;
        "pkg-v0.8.708-mc1.21.3-neoforge" = _Uo4nPqfp;
        "pkg-v0.8.708-mc1.17.1-fabric" = _rqSBKgnz;
        "pkg-v0.8.708-mc1.20.6-neoforge" = _MXRUj2f7;
        "pkg-v0.8.708-mc1.17.1-forge" = _ChOsNHft;
        "pkg-v0.8.708-mc1.19.3-fabric" = _kUnjNmZv;
        "pkg-v0.8.708-mc1.19.2-fabric" = _sXxZSNID;
        "pkg-v0.8.708-mc1.21.4-fabric" = _GvHLnhPP;
        "pkg-v0.8.708-mc1.20.6-fabric" = _orry8TF6;
        "pkg-v0.8.708-mc1.19.4-forge" = _w3FXAIL3;
        "pkg-v0.8.708-mc1.21.3-fabric" = _gk0eXB4u;
        "pkg-v0.8.708-mc1.21.5-neoforge" = _aSlMy8Qq;
        "pkg-v0.8.710-mc1.17.1-forge" = _SgtRcaSE;
        "pkg-v0.8.710-mc1.15.2-fabric" = _mvc7ApXH;
        "pkg-v0.8.710-mc1.19.2-fabric" = _dbExFFRa;
        "pkg-v0.8.710-mc1.19.4-fabric" = _VVAnA6ds;
        "pkg-v0.8.710-mc1.20.4-fabric" = _NW8TcDzc;
        "pkg-v0.8.710-mc1.21.5-fabric" = _ASOUA06M;
        "pkg-v0.8.710-mc1.21.1-fabric" = _7llHoFgF;
        "pkg-v0.8.710-mc1.14.4-fabric" = _zxP1j2bW;
        "pkg-v0.8.710-mc1.20.1-fabric" = _ZAs7Dz0C;
        "pkg-v0.8.710-mc1.17.1-fabric" = _nH5v18pZ;
        "pkg-v0.8.710-mc1.19.4-forge" = _jVsZjQJk;
        "pkg-v0.8.710-mc1.21.4-neoforge" = _Z9Ymn2f9;
        "pkg-v0.8.710-mc1.21.5-neoforge" = _wtGul910;
        "pkg-v0.8.710-mc1.21.3-neoforge" = _uYq190ET;
        "pkg-v0.8.710-mc1.16.5-fabric" = _xCswLXV1;
        "pkg-v0.8.710-mc1.21.3-fabric" = _tToiLxoV;
        "pkg-v0.8.710-mc1.20.2-fabric" = _Md9XhmqK;
        "pkg-v0.8.710-mc1.19.3-fabric" = _lfGrCIBw;
        "pkg-v0.8.710-mc1.20.6-fabric" = _bGKd5yvT;
        "pkg-v0.8.711-mc1.14.4-fabric" = _lnEKSDdC;
        "pkg-v0.8.711-mc1.19.3-fabric" = _weAkVOYf;
        "pkg-v0.8.711-mc1.17.1-fabric" = _S467GstE;
        "pkg-v0.8.711-mc1.21.5-neoforge" = _26CnXJSv;
        "pkg-v0.8.711-mc1.18.2-forge" = _bEZ1yTof;
        "pkg-v0.8.711-mc1.21.3-fabric" = _6W1UbUX5;
        "pkg-v0.8.711-mc1.21.4-neoforge" = _NxhiEjcq;
        "pkg-v0.8.711-mc1.20.4-fabric" = _C4gDXI55;
        "pkg-v0.8.711-mc1.21.3-neoforge" = _n3mBmArh;
        "pkg-v0.8.711-mc1.20.6-fabric" = _5nNhFezF;
        "pkg-v0.8.711-mc1.20.2-fabric" = _S3yGr0m4;
        "pkg-v0.8.711-mc1.19.4-fabric" = _NlEIIZfn;
        "pkg-v0.8.711-mc1.18.2-fabric" = _DzHBtf7d;
        "pkg-v0.8.711-mc1.21.4-fabric" = _rT1zTj0l;
        "pkg-v0.8.711-mc1.19.4-forge" = _yW6HGMRg;
        "pkg-v0.8.711-mc1.17.1-forge" = _sNR98GPo;
        "pkg-v0.8.711-mc1.16.5-fabric" = _7ZqaYMMS;
        "pkg-v0.8.711-mc1.20.2-neoforge" = _i5EwG7yG;
        "pkg-v0.8.711-mc1.20.6-neoforge" = _PERuE68T;
        "pkg-v0.8.711-mc1.21.5-fabric" = _KgL625xm;
        "pkg-v0.8.711-mc1.21.1-neoforge" = _xIpRVA3o;
        "pkg-v0.8.711-mc1.19.2-fabric" = _hzjgPWy5;
        "pkg-v0.8.711-mc1.20.1-fabric" = _jUXuAKKO;
        "pkg-v0.8.711-mc1.15.2-fabric" = _21dW0buQ;
        "pkg-v0.8.711-mc1.21.1-fabric" = _FHiz55gu;
        "pkg-v0.8.715-mc1.21.1-neoforge" = _TGcJkWJp;
        "pkg-v0.8.715-mc1.19.4-fabric" = _ndhvGPsp;
        "pkg-v0.8.715-mc1.20.1-fabric" = _YjxWdyBZ;
        "pkg-v0.8.715-mc1.17.1-forge" = _jCwaYnJi;
        "pkg-v0.8.715-mc1.21.4-neoforge" = _J0tWLlI9;
        "pkg-v0.8.715-mc1.20.2-neoforge" = _UrjoCWLj;
        "pkg-v0.8.715-mc1.21.4-fabric" = _jGr81Tvf;
        "pkg-v0.8.715-mc1.18.2-fabric" = _oq3Gk44E;
        "pkg-v0.8.715-mc1.18.2-forge" = _jG1W60dP;
        "pkg-v0.8.715-mc1.19.3-fabric" = _K17becPY;
        "pkg-v0.8.715-mc1.14.4-fabric" = _VTsGmgHX;
        "pkg-v0.8.715-mc1.20.6-fabric" = _QhnythOT;
        "pkg-v0.8.715-mc1.16.5-fabric" = _1FeUAH1Q;
        "pkg-v0.8.715-mc1.17.1-fabric" = _ZO7ccRJ0;
        "pkg-v0.8.715-mc1.15.2-fabric" = _OCWk3JwH;
        "pkg-v0.8.715-mc1.21.7-neoforge" = _kssnfeuJ;
        "pkg-v0.8.715-mc1.21.7-fabric" = _QLJ3jBgl;
        "pkg-v0.8.715-mc1.20.4-fabric" = _zOo3ywR8;
        "pkg-v0.8.715-mc1.21.5-neoforge" = _pQuBTYoU;
        "pkg-v0.8.715-mc1.21.3-neoforge" = _x7OUXfTG;
        "pkg-v0.8.715-mc1.21.1-fabric" = _sYqYhBwB;
        "pkg-v0.8.715-mc1.19.2-fabric" = _ftXMuxQ7;
        "pkg-v0.8.715-mc1.20.2-fabric" = _d9wesXn9;
        "pkg-v0.8.715-mc1.21.3-fabric" = _QsXYQNbJ;
        "pkg-v0.8.715-mc1.20.6-neoforge" = _26NzRyvk;
        "pkg-v0.8.715-mc1.21.5-fabric" = _3r104v5w;
        "pkg-v0.8.715-mc1.19.4-forge" = _lqYl91S2;
        "pkg-v0.8.721-mc1.14.4-fabric" = _2zThTaXY;
        "pkg-v0.8.721-mc1.15.2-fabric" = _epYzKUVA;
        "pkg-v0.8.721-mc1.16.5-fabric" = _ikGjoO61;
        "pkg-v0.8.721-mc1.17.1-fabric" = _zLVv9hrE;
        "pkg-v0.8.721-mc1.18.2-fabric" = _2Azph80T;
        "pkg-v0.8.721-mc1.19.2-fabric" = _QtSVrOCE;
        "pkg-v0.8.721-mc1.19.3-fabric" = _7xW0jZYn;
        "pkg-v0.8.721-mc1.20.1-fabric" = _3aYP2raV;
        "pkg-v0.8.721-mc1.19.4-fabric" = _PDu3tuoh;
        "pkg-v0.8.721-mc1.20.2-fabric" = _3kf4qShJ;
        "pkg-v0.8.721-mc1.20.4-fabric" = _S1irpxji;
        "pkg-v0.8.721-mc1.20.6-fabric" = _4Kw0dQyh;
        "pkg-v0.8.721-mc1.21.1-fabric" = _t3IhmMIY;
        "pkg-v0.8.721-mc1.21.3-fabric" = _FOONYfit;
        "pkg-v0.8.721-mc1.21.4-fabric" = _RKyDzlqQ;
        "pkg-v0.8.721-mc1.21.5-fabric" = _ffwLKP20;
        "pkg-v0.8.721-mc1.21.7-fabric" = _VTLMkysH;
        "pkg-v0.8.721-mc1.17.1-forge" = _94UcwMrQ;
        "pkg-v0.8.721-mc1.18.2-forge" = _FNVJv3yu;
        "pkg-v0.8.721-mc1.19.4-forge" = _cuuVidP0;
        "pkg-v0.8.721-mc1.20.2-neoforge" = _ytjFEdG3;
        "pkg-v0.8.721-mc1.20.6-neoforge" = _VcqcI0uw;
        "pkg-v0.8.721-mc1.21.1-neoforge" = _3hnb21KG;
        "pkg-v0.8.721-mc1.21.3-neoforge" = _t1EuHr9l;
        "pkg-v0.8.721-mc1.21.4-neoforge" = _dBa0Nc31;
        "pkg-v0.8.721-mc1.21.5-neoforge" = _LltiK8Ne;
        "pkg-v0.8.721-mc1.21.7-neoforge" = _9PvQg8T4;
        "pkg-v0.8.722-mc1.14.4-fabric" = _zBEbodav;
        "pkg-v0.8.722-mc1.15.2-fabric" = _YVKBzmEQ;
        "pkg-v0.8.722-mc1.16.5-fabric" = _9en44Uww;
        "pkg-v0.8.722-mc1.17.1-fabric" = _IlV7KEse;
        "pkg-v0.8.722-mc1.18.2-fabric" = _HxdEdxi5;
        "pkg-v0.8.722-mc1.19.2-fabric" = _OCDpg00S;
        "pkg-v0.8.722-mc1.19.3-fabric" = _m2nAk5Yu;
        "pkg-v0.8.722-mc1.19.4-fabric" = _lMNl69MK;
        "pkg-v0.8.722-mc1.20.1-fabric" = _2zhMKIDB;
        "pkg-v0.8.722-mc1.20.2-fabric" = _vCaFdYV2;
        "pkg-v0.8.722-mc1.20.6-fabric" = _pbJHaRtZ;
        "pkg-v0.8.722-mc1.20.4-fabric" = _tNVkvrVO;
        "pkg-v0.8.722-mc1.21.3-fabric" = _dPmRmHcu;
        "pkg-v0.8.722-mc1.21.1-fabric" = _ZZt07ScD;
        "pkg-v0.8.722-mc1.21.4-fabric" = _pjfxNsbO;
        "pkg-v0.8.722-mc1.21.5-fabric" = _Bywl53vI;
        "pkg-v0.8.722-mc1.21.8-fabric" = _7YA3vN10;
        "pkg-v0.8.722-mc1.17.1-forge" = _bVz6sv7C;
        "pkg-v0.8.722-mc1.18.2-forge" = _JNLooxUS;
        "pkg-v0.8.722-mc1.19.4-forge" = _SNO8IIpN;
        "pkg-v0.8.722-mc1.20.6-neoforge" = _qCcAvxXn;
        "pkg-v0.8.722-mc1.20.2-neoforge" = _6oaWHG4v;
        "pkg-v0.8.722-mc1.21.1-neoforge" = _e7uDJQks;
        "pkg-v0.8.722-mc1.21.3-neoforge" = _EFF0BMi8;
        "pkg-v0.8.722-mc1.21.4-neoforge" = _74PsCHN1;
        "pkg-v0.8.722-mc1.21.5-neoforge" = _2WGwttGQ;
        "pkg-v0.8.722-mc1.21.8-neoforge" = _uaR4lPVd;
        "pkg-v0.8.728-mc1.14.4-fabric" = _9n5YzjIY;
        "pkg-v0.8.728-mc1.15.2-fabric" = _uZ7Z1ggK;
        "pkg-v0.8.728-mc1.16.5-fabric" = _isSTGzUX;
        "pkg-v0.8.728-mc1.17.1-fabric" = _Yfj5ITzt;
        "pkg-v0.8.728-mc1.18.2-fabric" = _TnUuF2QN;
        "pkg-v0.8.728-mc1.19.2-fabric" = _2cJmhc0X;
        "pkg-v0.8.728-mc1.19.3-fabric" = _mPP0WKeJ;
        "pkg-v0.8.728-mc1.19.4-fabric" = _TYsYjNlv;
        "pkg-v0.8.728-mc1.20.1-fabric" = _5MoxdUFr;
        "pkg-v0.8.728-mc1.20.4-fabric" = _BWlEG7W1;
        "pkg-v0.8.728-mc1.20.2-fabric" = _6tCiKFjO;
        "pkg-v0.8.728-mc1.20.6-fabric" = _E5UfdcBU;
        "pkg-v0.8.728-mc1.21.1-fabric" = _zdN8myk6;
        "pkg-v0.8.728-mc1.21.3-fabric" = _8wuSPIRP;
        "pkg-v0.8.728-mc1.21.4-fabric" = _QT6PTIHq;
        "pkg-v0.8.728-mc1.21.5-fabric" = _Q5zEgZkT;
        "pkg-v0.8.728-mc1.21.8-fabric" = _H87qaBnh;
        "pkg-v0.8.728-mc1.18.2-forge" = _U6YfEXim;
        "pkg-v0.8.728-mc1.17.1-forge" = _uhPTR0BQ;
        "pkg-v0.8.728-mc1.19.4-forge" = _G2eTxQMQ;
        "pkg-v0.8.728-mc1.20.2-neoforge" = _VMArK3au;
        "pkg-v0.8.728-mc1.20.6-neoforge" = _z15nzWO8;
        "pkg-v0.8.728-mc1.21.1-neoforge" = _DhkMx9dg;
        "pkg-v0.8.728-mc1.21.3-neoforge" = _SioICnJj;
        "pkg-v0.8.728-mc1.21.4-neoforge" = _BF6uulw3;
        "pkg-v0.8.728-mc1.21.5-neoforge" = _wfbThmnz;
        "pkg-v0.8.728-mc1.21.8-neoforge" = _LQWCEwaf;
        "pkg-v0.8.734-mc1.14.4-fabric" = _9Jz1tGUu;
        "pkg-v0.8.734-mc1.15.2-fabric" = _yX3Wljv1;
        "pkg-v0.8.734-mc1.17.1-fabric" = _bLDswsCg;
        "pkg-v0.8.734-mc1.16.5-fabric" = _q41EfBGU;
        "pkg-v0.8.734-mc1.19.2-fabric" = _L5XZuYT2;
        "pkg-v0.8.734-mc1.18.2-fabric" = _LtVgmegZ;
        "pkg-v0.8.734-mc1.19.3-fabric" = _GWSB1KIJ;
        "pkg-v0.8.734-mc1.19.4-fabric" = _wchcejjd;
        "pkg-v0.8.734-mc1.20.1-fabric" = _m44q5HaC;
        "pkg-v0.8.734-mc1.20.2-fabric" = _pNI5u8PF;
        "pkg-v0.8.734-mc1.20.4-fabric" = _yVi6EW61;
        "pkg-v0.8.734-mc1.20.6-fabric" = _tDBbyWbr;
        "pkg-v0.8.734-mc1.21.1-fabric" = _iCXotOPA;
        "pkg-v0.8.734-mc1.21.3-fabric" = _DzXz4i8I;
        "pkg-v0.8.734-mc1.21.4-fabric" = _yKCeHMTX;
        "pkg-v0.8.734-mc1.21.5-fabric" = _yRQqQbfM;
        "pkg-v0.8.734-mc1.21.8-fabric" = _rqF0XuSN;
        "pkg-v0.8.734-mc1.17.1-forge" = _BQ6XyQsY;
        "pkg-v0.8.734-mc1.18.2-forge" = _RS3goT5Y;
        "pkg-v0.8.734-mc1.19.4-forge" = _Icdi7nEF;
        "pkg-v0.8.734-mc1.20.2-neoforge" = _tc7qmB56;
        "pkg-v0.8.734-mc1.20.6-neoforge" = _KPoxZlop;
        "pkg-v0.8.734-mc1.21.1-neoforge" = _A2nyzbIv;
        "pkg-v0.8.734-mc1.21.3-neoforge" = _538LYIJ8;
        "pkg-v0.8.734-mc1.21.4-neoforge" = _Aq2T9KOD;
        "pkg-v0.8.734-mc1.21.5-neoforge" = _ugQXYT0Z;
        "pkg-v0.8.734-mc1.21.8-neoforge" = _4eFYHYjL;
        "pkg-v0.8.740-mc1.14.4-fabric" = _506bi1Ji;
        "pkg-v0.8.740-mc1.15.2-fabric" = _dt3HHm0Q;
        "pkg-v0.8.740-mc1.17.1-fabric" = _dCXhLbqp;
        "pkg-v0.8.740-mc1.16.5-fabric" = _o1O78EcC;
        "pkg-v0.8.740-mc1.19.2-fabric" = _Hq93nFpA;
        "pkg-v0.8.740-mc1.18.2-fabric" = _ztcPurrg;
        "pkg-v0.8.740-mc1.19.3-fabric" = _OYcGAQHa;
        "pkg-v0.8.740-mc1.19.4-fabric" = _xGG8Fsrk;
        "pkg-v0.8.740-mc1.20.1-fabric" = _eiXANEXL;
        "pkg-v0.8.740-mc1.20.2-fabric" = _nhwSlHrO;
        "pkg-v0.8.740-mc1.20.6-fabric" = _botwJMP3;
        "pkg-v0.8.740-mc1.20.4-fabric" = _ENRR0rIG;
        "pkg-v0.8.740-mc1.21.1-fabric" = _aLuf63mz;
        "pkg-v0.8.740-mc1.21.3-fabric" = _yqi99Nii;
        "pkg-v0.8.740-mc1.21.4-fabric" = _Ka5axkIL;
        "pkg-v0.8.740-mc1.21.5-fabric" = _dRN2rs1J;
        "pkg-v0.8.740-mc1.21.8-fabric" = _bZVgpuCa;
        "pkg-v0.8.740-mc1.17.1-forge" = _wRq7XKnM;
        "pkg-v0.8.740-mc1.18.2-forge" = _YakbmsZF;
        "pkg-v0.8.740-mc1.19.4-forge" = _3ukpd3CX;
        "pkg-v0.8.740-mc1.20.2-neoforge" = _nsis39I5;
        "pkg-v0.8.740-mc1.20.6-neoforge" = _XF9lQX6Y;
        "pkg-v0.8.740-mc1.21.1-neoforge" = _MJt1A3L8;
        "pkg-v0.8.740-mc1.21.3-neoforge" = _zyROrjb1;
        "pkg-v0.8.740-mc1.21.4-neoforge" = _Szc4uciJ;
        "pkg-v0.8.740-mc1.21.5-neoforge" = _3hKFvzmt;
        "pkg-v0.8.740-mc1.21.8-neoforge" = _eYFDh5w0;
        "pkg-v0.8.741-mc1.14.4-fabric" = _6KbIJdkf;
        "pkg-v0.8.741-mc1.15.2-fabric" = _DyDlRlWP;
        "pkg-v0.8.741-mc1.16.5-fabric" = _UKWUtz1i;
        "pkg-v0.8.741-mc1.17.1-fabric" = _1sUE13s3;
        "pkg-v0.8.741-mc1.18.2-fabric" = _Ail6xwFb;
        "pkg-v0.8.741-mc1.19.2-fabric" = _AbXcM6aC;
        "pkg-v0.8.741-mc1.19.3-fabric" = _RNUcIYo6;
        "pkg-v0.8.741-mc1.19.4-fabric" = _XkOJS1gO;
        "pkg-v0.8.741-mc1.20.1-fabric" = _kUcDB3Hr;
        "pkg-v0.8.741-mc1.20.2-fabric" = _X4yJTKzv;
        "pkg-v0.8.741-mc1.20.4-fabric" = _7zwsP6kT;
        "pkg-v0.8.741-mc1.20.6-fabric" = _n8dcfy8B;
        "pkg-v0.8.741-mc1.21.1-fabric" = _xt9U9Mpm;
        "pkg-v0.8.741-mc1.21.3-fabric" = _JkAY72du;
        "pkg-v0.8.741-mc1.21.4-fabric" = _746B9pN9;
        "pkg-v0.8.741-mc1.21.5-fabric" = _Id5YP2d1;
        "pkg-v0.8.741-mc1.21.8-fabric" = _rXPkSRKb;
        "pkg-v0.8.741-mc1.17.1-forge" = _w9nCbG5p;
        "pkg-v0.8.741-mc1.18.2-forge" = _4D7ZWEXc;
        "pkg-v0.8.741-mc1.19.4-forge" = _OAhOwNZn;
        "pkg-v0.8.741-mc1.20.2-neoforge" = _xpN9on6z;
        "pkg-v0.8.741-mc1.20.6-neoforge" = _hwKofVoc;
        "pkg-v0.8.741-mc1.21.1-neoforge" = _RQ1dYXUc;
        "pkg-v0.8.741-mc1.21.3-neoforge" = _mPQGY6h5;
        "pkg-v0.8.741-mc1.21.4-neoforge" = _kZ2ilPeQ;
        "pkg-v0.8.741-mc1.21.8-neoforge" = _zXlGqA69;
        "pkg-v0.8.741-mc1.21.5-neoforge" = _PrdF9Hzd;
        "pkg-v0.8.750-mc1.14.4-fabric" = _8nFnnrze;
        "pkg-v0.8.750-mc1.15.2-fabric" = _9DWanyWz;
        "pkg-v0.8.750-mc1.16.5-fabric" = _ar6HTGCD;
        "pkg-v0.8.750-mc1.17.1-fabric" = _T6J63kDb;
        "pkg-v0.8.750-mc1.18.2-fabric" = _gCfrJhC6;
        "pkg-v0.8.750-mc1.19.2-fabric" = _RUVeV0HM;
        "pkg-v0.8.750-mc1.19.3-fabric" = _eKAlShWu;
        "pkg-v0.8.750-mc1.19.4-fabric" = _9nAUJ393;
        "pkg-v0.8.750-mc1.20.1-fabric" = _C9dYTrQJ;
        "pkg-v0.8.750-mc1.20.2-fabric" = _ukuxhD7i;
        "pkg-v0.8.750-mc1.20.4-fabric" = _hJWc8tZi;
        "pkg-v0.8.750-mc1.20.6-fabric" = _2K2vqN4f;
        "pkg-v0.8.750-mc1.21.1-fabric" = _8g2hIGh9;
        "pkg-v0.8.750-mc1.21.3-fabric" = _jk4vHpxV;
        "pkg-v0.8.750-mc1.21.4-fabric" = _z0zMINNj;
        "pkg-v0.8.750-mc1.21.5-fabric" = _IRbOKXnf;
        "pkg-v0.8.750-mc1.17.1-forge" = _NsELI9Vg;
        "pkg-v0.8.750-mc1.21.8-fabric" = _tge6o0sn;
        "pkg-v0.8.750-mc1.18.2-forge" = _Zgv9KMRn;
        "pkg-v0.8.750-mc1.19.4-forge" = _bViJFrJj;
        "pkg-v0.8.750-mc1.20.1-forge" = _pD4XPWKE;
        "pkg-v0.8.750-mc1.20.2-neoforge" = _zmSQXtre;
        "pkg-v0.8.750-mc1.20.6-neoforge" = _g5NJsO0U;
        "pkg-v0.8.750-mc1.21.1-neoforge" = _ajMlMy9o;
        "pkg-v0.8.750-mc1.21.3-neoforge" = _8vuKkfhy;
        "pkg-v0.8.750-mc1.21.4-neoforge" = _7moZCnIc;
        "pkg-v0.8.750-mc1.21.5-neoforge" = _YdbDpP6J;
        "pkg-v0.8.750-mc1.21.8-neoforge" = _emBzVcaY;
        "pkg-v0.8.762-mc1.14.4-fabric" = _zq7CoOux;
        "pkg-v0.8.762-mc1.15.2-fabric" = _swS9iue0;
        "pkg-v0.8.762-mc1.16.5-fabric" = _dkfpLZCZ;
        "pkg-v0.8.762-mc1.17.1-fabric" = _M22Ik0l8;
        "pkg-v0.8.762-mc1.18.2-fabric" = _FjscI0st;
        "pkg-v0.8.762-mc1.19.2-fabric" = _ABZBw5UC;
        "pkg-v0.8.762-mc1.19.3-fabric" = _bt7K9bya;
        "pkg-v0.8.762-mc1.20.1-fabric" = _WeiqMGEr;
        "pkg-v0.8.762-mc1.19.4-fabric" = _8VGd0j1o;
        "pkg-v0.8.762-mc1.20.2-fabric" = _D6J204Eh;
        "pkg-v0.8.762-mc1.20.4-fabric" = _jBzLWb0p;
        "pkg-v0.8.762-mc1.20.6-fabric" = _nXiwGTBM;
        "pkg-v0.8.762-mc1.21.1-fabric" = _16uLpbDK;
        "pkg-v0.8.762-mc1.21.3-fabric" = _6HgDT7rw;
        "pkg-v0.8.762-mc1.21.4-fabric" = _wTu4Z8x8;
        "pkg-v0.8.762-mc1.21.5-fabric" = _83md1J8c;
        "pkg-v0.8.762-mc1.21.8-fabric" = _ftjshZEt;
        "pkg-v0.8.762-mc1.17.1-forge" = _k6iz7W9U;
        "pkg-v0.8.762-mc1.18.2-forge" = _9MPIkgjs;
        "pkg-v0.8.762-mc1.19.4-forge" = _tlnOIahH;
        "pkg-v0.8.762-mc1.20.1-forge" = _cpFvfis7;
        "pkg-v0.8.762-mc1.20.2-neoforge" = _JoqVvcnR;
        "pkg-v0.8.762-mc1.20.6-neoforge" = _uXDRu3N1;
        "pkg-v0.8.762-mc1.21.1-neoforge" = _hbbE20c1;
        "pkg-v0.8.762-mc1.21.3-neoforge" = _TggTO38G;
        "pkg-v0.8.762-mc1.21.4-neoforge" = _NJmw4uzL;
        "pkg-v0.8.762-mc1.21.5-neoforge" = _9t073t7y;
        "pkg-v0.8.762-mc1.21.8-neoforge" = _xJYU5H95;
        "pkg-v0.8.763-mc1.14.4-fabric" = _4ASY5N9U;
        "pkg-v0.8.763-mc1.15.2-fabric" = _qqllu2ka;
        "pkg-v0.8.763-mc1.16.5-fabric" = _vaEtHEkn;
        "pkg-v0.8.763-mc1.18.2-fabric" = _Nzdt821d;
        "pkg-v0.8.763-mc1.17.1-fabric" = _sOzJHpf1;
        "pkg-v0.8.763-mc1.19.2-fabric" = _4fUkFIsN;
        "pkg-v0.8.763-mc1.19.3-fabric" = _9LN8YOsz;
        "pkg-v0.8.763-mc1.19.4-fabric" = _15sof9n6;
        "pkg-v0.8.763-mc1.20.1-fabric" = _gYsXH8b7;
        "pkg-v0.8.763-mc1.20.2-fabric" = _f9Vks1a4;
        "pkg-v0.8.763-mc1.20.4-fabric" = _eLqsz8gg;
        "pkg-v0.8.763-mc1.20.6-fabric" = _to2ECuGm;
        "pkg-v0.8.763-mc1.21.1-fabric" = _PiOv2Nxg;
        "pkg-v0.8.763-mc1.21.3-fabric" = _c8A31lu0;
        "pkg-v0.8.763-mc1.21.4-fabric" = _UCJ3bGkR;
        "pkg-v0.8.763-mc1.21.5-fabric" = _ZQyal4QJ;
        "pkg-v0.8.763-mc1.21.8-fabric" = _SfBwzVRd;
        "pkg-v0.8.763-mc1.17.1-forge" = _gNk3st2u;
        "pkg-v0.8.763-mc1.18.2-forge" = _r5Pp7oF3;
        "pkg-v0.8.763-mc1.19.4-forge" = _5qmaeBYN;
        "pkg-v0.8.763-mc1.20.1-forge" = _CdQev6gL;
        "pkg-v0.8.763-mc1.20.2-neoforge" = _jHNnD5aE;
        "pkg-v0.8.763-mc1.20.6-neoforge" = _bEklPxWZ;
        "pkg-v0.8.763-mc1.21.1-neoforge" = _DgufGOPK;
        "pkg-v0.8.763-mc1.21.3-neoforge" = _UckZGmrN;
        "pkg-v0.8.763-mc1.21.4-neoforge" = _bNMpnHcH;
        "pkg-v0.8.763-mc1.21.5-neoforge" = _BSs1zRd7;
        "pkg-v0.8.763-mc1.21.8-neoforge" = _6LSK7X6x;
        "pkg-v0.8.766-mc1.14.4-fabric" = _5gneyegV;
        "pkg-v0.8.766-mc1.15.2-fabric" = _VbjnSq2p;
        "pkg-v0.8.766-mc1.17.1-fabric" = _H1pBMoVh;
        "pkg-v0.8.766-mc1.18.2-fabric" = _sADQvdH9;
        "pkg-v0.8.766-mc1.19.2-fabric" = _MYHWnnkr;
        "pkg-v0.8.766-mc1.16.5-fabric" = _cy5UZZV1;
        "pkg-v0.8.766-mc1.19.3-fabric" = _K3Lojf1R;
        "pkg-v0.8.766-mc1.19.4-fabric" = _PRB0TYUS;
        "pkg-v0.8.766-mc1.20.2-fabric" = _uUmR3Mon;
        "pkg-v0.8.766-mc1.21.1-fabric" = _ei9K8U76;
        "pkg-v0.8.766-mc1.20.6-fabric" = _iFXHIttk;
        "pkg-v0.8.766-mc1.20.4-fabric" = _ZeKEkCXK;
        "pkg-v0.8.766-mc1.21.3-fabric" = _jdfKavft;
        "pkg-v0.8.766-mc1.21.4-fabric" = _XvqNPbV7;
        "pkg-v0.8.766-mc1.21.8-fabric" = _U74YileO;
        "pkg-v0.8.766-mc1.19.4-forge" = _gXGaY17X;
        "pkg-v0.8.766-mc1.20.1-forge" = _XA836OSA;
        "pkg-v0.8.766-mc1.21.5-fabric" = _KwO6Fpr7;
        "pkg-v0.8.766-mc1.20.6-neoforge" = _LiFTjMqX;
        "pkg-v0.8.766-mc1.20.2-neoforge" = _zpx5GmhX;
        "pkg-v0.8.766-mc1.21.1-neoforge" = _DFl4fr7q;
        "pkg-v0.8.766-mc1.21.4-neoforge" = _wEo9F7DT;
        "pkg-v0.8.766-mc1.21.5-neoforge" = _6y2eP2mF;
        "pkg-v0.8.766-mc1.21.8-neoforge" = _FOKvMDIO;
        "pkg-v0.8.766-mc1.20.1-fabric" = _R03Cghjh;
        "pkg-v0.8.766-mc1.18.2-forge" = _lz9ZjBsN;
        "pkg-v0.8.766-mc1.17.1-forge" = _JC71vixd;
        "pkg-v0.8.766-mc1.21.3-neoforge" = _Haolrw0T;
        "pkg-v0.8.779-mc1.14.4-fabric" = _oeKnw6R2;
        "pkg-v0.8.779-mc1.15.2-fabric" = _C0O2cOlv;
        "pkg-v0.8.779-mc1.16.5-fabric" = _AnNGzLT0;
        "pkg-v0.8.779-mc1.17.1-fabric" = _vQ89SeSY;
        "pkg-v0.8.779-mc1.18.2-fabric" = _Aa4tKXRC;
        "pkg-v0.8.779-mc1.19.2-fabric" = _19WZrIJ4;
        "pkg-v0.8.779-mc1.19.3-fabric" = _yLaKcagM;
        "pkg-v0.8.779-mc1.19.4-fabric" = _vK6ZWRon;
        "pkg-v0.8.779-mc1.20.1-fabric" = _tKtVkfqD;
        "pkg-v0.8.779-mc1.20.2-fabric" = _apcpxHjz;
        "pkg-v0.8.779-mc1.20.6-fabric" = _IHBuFV7s;
        "pkg-v0.8.779-mc1.20.4-fabric" = _AUHP7r58;
        "pkg-v0.8.779-mc1.21.1-fabric" = _R50GmZs2;
        "pkg-v0.8.779-mc1.21.10-fabric" = _ddWpY2TA;
        "pkg-v0.8.779-mc1.21.3-fabric" = _ozLENyZd;
        "pkg-v0.8.779-mc1.21.4-fabric" = _r3X9SiTV;
        "pkg-v0.8.779-mc1.21.5-fabric" = _48DUHs8k;
        "pkg-v0.8.779-mc1.21.8-fabric" = _lCgKbFGE;
        "pkg-v0.8.779-mc1.17.1-forge" = _6vYOmzJ2;
        "pkg-v0.8.779-mc1.18.2-forge" = _xqUXuLrT;
        "pkg-v0.8.779-mc1.19.4-forge" = _N9vbnhgK;
        "pkg-v0.8.779-mc1.20.1-forge" = _ky9cJZGD;
        "pkg-v0.8.779-mc1.20.2-neoforge" = _CN4RAanC;
        "pkg-v0.8.779-mc1.20.6-neoforge" = _yXegU9I8;
        "pkg-v0.8.779-mc1.21.10-neoforge" = _gDlzrUuZ;
        "pkg-v0.8.779-mc1.21.1-neoforge" = _4jL3pjG2;
        "pkg-v0.8.779-mc1.21.3-neoforge" = _SiW0fVW1;
        "pkg-v0.8.779-mc1.21.4-neoforge" = _Udualu4C;
        "pkg-v0.8.779-mc1.21.5-neoforge" = _QR6KAHE3;
        "pkg-v0.8.779-mc1.21.8-neoforge" = _jh2e8S21;
        "pkg-v0.8.781-mc1.14.4-fabric" = _8aweBHkb;
        "pkg-v0.8.781-mc1.15.2-fabric" = _q7wDvmAX;
        "pkg-v0.8.781-mc1.16.5-fabric" = _xxqlujeI;
        "pkg-v0.8.781-mc1.17.1-fabric" = _l1z4cYrM;
        "pkg-v0.8.781-mc1.18.2-fabric" = _6VAjlzQ3;
        "pkg-v0.8.781-mc1.19.2-fabric" = _SZCbpbtd;
        "pkg-v0.8.781-mc1.19.3-fabric" = _6JD43Lbo;
        "pkg-v0.8.781-mc1.19.4-fabric" = _JmWFikra;
        "pkg-v0.8.781-mc1.20.1-fabric" = _M08O2mDy;
        "pkg-v0.8.781-mc1.20.2-fabric" = _OIbWt6mS;
        "pkg-v0.8.781-mc1.20.4-fabric" = _R1JJqPBX;
        "pkg-v0.8.781-mc1.20.6-fabric" = _fFwHCooe;
        "pkg-v0.8.781-mc1.21.1-fabric" = _zzgVlg95;
        "pkg-v0.8.781-mc1.21.10-fabric" = _oCHxlGNy;
        "pkg-v0.8.781-mc1.21.3-fabric" = _6UdDssqL;
        "pkg-v0.8.781-mc1.21.4-fabric" = _gJXMp71C;
        "pkg-v0.8.781-mc1.21.5-fabric" = _q5IGxQpB;
        "pkg-v0.8.781-mc1.21.8-fabric" = _rqrZTHg1;
        "pkg-v0.8.781-mc1.17.1-forge" = _GbhtE6Ud;
        "pkg-v0.8.781-mc1.18.2-forge" = _mMGtFNuv;
        "pkg-v0.8.781-mc1.19.4-forge" = _SDQGgnjp;
        "pkg-v0.8.781-mc1.20.1-forge" = _TEoZHLis;
        "pkg-v0.8.781-mc1.20.2-neoforge" = _B9rp3ASJ;
        "pkg-v0.8.781-mc1.20.6-neoforge" = _IdQczSYi;
        "pkg-v0.8.781-mc1.21.1-neoforge" = _7cxBZFf7;
        "pkg-v0.8.781-mc1.21.10-neoforge" = _f0K8SbzM;
        "pkg-v0.8.781-mc1.21.3-neoforge" = _3dYd1KW1;
        "pkg-v0.8.781-mc1.21.4-neoforge" = _V6bjbKEK;
        "pkg-v0.8.781-mc1.21.5-neoforge" = _imdTIEXw;
        "pkg-v0.8.781-mc1.21.8-neoforge" = _7oNlZPmC;
        "pkg-v0.8.797-mc1.14.4-fabric" = _vDMsppdE;
        "pkg-v0.8.797-mc1.15.2-fabric" = _WD18SU6Q;
        "pkg-v0.8.797-mc1.16.5-fabric" = _A4AhM6hO;
        "pkg-v0.8.797-mc1.17.1-fabric" = _bLJzusFY;
        "pkg-v0.8.797-mc1.18.2-fabric" = _ocYkDSNk;
        "pkg-v0.8.797-mc1.19.2-fabric" = _fdkNyC23;
        "pkg-v0.8.797-mc1.19.3-fabric" = _e2WCOVbA;
        "pkg-v0.8.797-mc1.19.4-fabric" = _DMZndvSd;
        "pkg-v0.8.797-mc1.20.1-fabric" = _QNAqdcbx;
        "pkg-v0.8.797-mc1.20.2-fabric" = _ethaVlgd;
        "pkg-v0.8.797-mc1.20.4-fabric" = _BhMc0BiK;
        "pkg-v0.8.797-mc1.20.6-fabric" = _qG7gKHEz;
        "pkg-v0.8.797-mc1.21.1-fabric" = _Po2Jh1Bb;
        "pkg-v0.8.797-mc1.21.10-fabric" = _MFeryow8;
        "pkg-v0.8.797-mc1.21.11-fabric" = _RV6UEn8W;
        "pkg-v0.8.797-mc1.21.3-fabric" = _q3qyYeDT;
        "pkg-v0.8.797-mc1.21.5-fabric" = _W1pfK1sh;
        "pkg-v0.8.797-mc1.21.4-fabric" = _wKhX5s2Z;
        "pkg-v0.8.797-mc1.21.8-fabric" = _bIDFLFzf;
        "pkg-v0.8.797-mc1.17.1-forge" = _MnoXO262;
        "pkg-v0.8.797-mc1.18.2-forge" = _V8pQIQAW;
        "pkg-v0.8.797-mc1.19.4-forge" = _uGTP0Ki1;
        "pkg-v0.8.797-mc1.20.1-forge" = _7soN3Zlv;
        "pkg-v0.8.797-mc1.20.2-neoforge" = _CcDwQ7l0;
        "pkg-v0.8.797-mc1.20.6-neoforge" = _WKn8NacB;
        "pkg-v0.8.797-mc1.21.1-neoforge" = _uQg1Bmio;
        "pkg-v0.8.797-mc1.21.10-neoforge" = _YOprfaRy;
        "pkg-v0.8.797-mc1.21.11-neoforge" = _HSrzNwSw;
        "pkg-v0.8.797-mc1.21.3-neoforge" = _5myWjxoj;
        "pkg-v0.8.797-mc1.21.4-neoforge" = _ravn0yHu;
        "pkg-v0.8.797-mc1.21.5-neoforge" = _h7cgYfvO;
        "pkg-v0.8.797-mc1.21.8-neoforge" = _riVWIEEV;
        "pkg-v0.8.801-mc1.14.4-fabric" = _EkS4r8EC;
        "pkg-v0.8.801-mc1.15.2-fabric" = _IMU3vCmO;
        "pkg-v0.8.801-mc1.16.5-fabric" = _rKBxehRx;
        "pkg-v0.8.801-mc1.17.1-fabric" = _ZW0LS1PV;
        "pkg-v0.8.801-mc1.18.2-fabric" = _dnwuJ7vA;
        "pkg-v0.8.801-mc1.19.2-fabric" = _C8HqNxaw;
        "pkg-v0.8.801-mc1.19.4-fabric" = _7U1SVSup;
        "pkg-v0.8.801-mc1.19.3-fabric" = _27oBVnXW;
        "pkg-v0.8.801-mc1.20.1-fabric" = _yvGKYPuY;
        "pkg-v0.8.801-mc1.20.2-fabric" = _JzNTiYqB;
        "pkg-v0.8.801-mc1.20.4-fabric" = _BIHbAzQ2;
        "pkg-v0.8.801-mc1.20.6-fabric" = _SYUpPhyB;
        "pkg-v0.8.801-mc1.21.1-fabric" = _gDwlplvl;
        "pkg-v0.8.801-mc1.21.10-fabric" = _DYxjB8Cb;
        "pkg-v0.8.801-mc1.21.11-fabric" = _b4yPH05t;
        "pkg-v0.8.801-mc1.21.3-fabric" = _MEzFhGJC;
        "pkg-v0.8.801-mc1.21.4-fabric" = _R38o5BmG;
        "pkg-v0.8.801-mc1.21.5-fabric" = _pYd8hkDq;
        "pkg-v0.8.801-mc1.21.8-fabric" = _Yx8kD5pY;
        "pkg-v0.8.801-mc1.17.1-forge" = _oVmf55Y2;
        "pkg-v0.8.801-mc1.18.2-forge" = _MVy8WkLQ;
        "pkg-v0.8.801-mc1.19.4-forge" = _xIF7Wx0T;
        "pkg-v0.8.801-mc1.20.1-forge" = _rjrgrD6A;
        "pkg-v0.8.801-mc1.20.2-neoforge" = _TSzD7zyw;
        "pkg-v0.8.801-mc1.20.6-neoforge" = _zXczUphv;
        "pkg-v0.8.801-mc1.21.1-neoforge" = _u63j9dnF;
        "pkg-v0.8.801-mc1.21.10-neoforge" = _KFaUfmTR;
        "pkg-v0.8.801-mc1.21.11-neoforge" = _PPg7uZir;
        "pkg-v0.8.801-mc1.21.3-neoforge" = _8jb18TT8;
        "pkg-v0.8.801-mc1.21.4-neoforge" = _wwRPkwGY;
        "pkg-v0.8.801-mc1.21.5-neoforge" = _xur4btwz;
        "pkg-v0.8.801-mc1.21.8-neoforge" = _SlKLIw1b;
        "pkg-v0.8.811-mc1.14.4-fabric" = _tAAFAZ1g;
        "pkg-v0.8.811-mc1.15.2-fabric" = _CKQp9aZj;
        "pkg-v0.8.811-mc1.16.5-fabric" = _ZNsPGnKl;
        "pkg-v0.8.811-mc1.17.1-fabric" = _cMwXUuCs;
        "pkg-v0.8.811-mc1.18.2-fabric" = _CYRWTkXX;
        "pkg-v0.8.811-mc1.19.2-fabric" = _WAPMooKY;
        "pkg-v0.8.811-mc1.19.3-fabric" = _GGEcaEyO;
        "pkg-v0.8.811-mc1.19.4-fabric" = _JKbh0HsK;
        "pkg-v0.8.811-mc1.20.1-fabric" = _GdoGtonl;
        "pkg-v0.8.811-mc1.20.4-fabric" = _yzs8LYf4;
        "pkg-v0.8.811-mc1.20.2-fabric" = _EppF4MTW;
        "pkg-v0.8.811-mc1.20.6-fabric" = _v6xXb6QT;
        "pkg-v0.8.811-mc1.21.1-fabric" = _fNPbRfDB;
        "pkg-v0.8.811-mc1.21.10-fabric" = _eje4cnCH;
        "pkg-v0.8.811-mc1.21.11-fabric" = _8fCA8Fpb;
        "pkg-v0.8.811-mc1.21.3-fabric" = _UTjdUaS0;
        "pkg-v0.8.811-mc1.21.5-fabric" = _kgthEs7p;
        "pkg-v0.8.811-mc1.21.4-fabric" = _6owHFX27;
        "pkg-v0.8.811-mc1.21.8-fabric" = _xN0QHlbr;
        "pkg-v0.8.811-mc1.17.1-forge" = _6nxfa21K;
        "pkg-v0.8.811-mc1.18.2-forge" = _UMyGWveS;
        "pkg-v0.8.811-mc1.19.4-forge" = _8vLwdlBu;
        "pkg-v0.8.811-mc1.20.1-forge" = _4XSzgqen;
        "pkg-v0.8.811-mc1.20.2-neoforge" = _woBCWPOr;
        "pkg-v0.8.811-mc1.20.6-neoforge" = _JPvxaMOx;
        "pkg-v0.8.811-mc1.21.1-neoforge" = _VXJxjB36;
        "pkg-v0.8.811-mc1.21.10-neoforge" = _6UkQsjU5;
        "pkg-v0.8.811-mc1.21.11-neoforge" = _KLGCBn4K;
        "pkg-v0.8.811-mc1.21.3-neoforge" = _HKd4uwYW;
        "pkg-v0.8.811-mc1.21.4-neoforge" = _wE6wwKwZ;
        "pkg-v0.8.811-mc1.21.5-neoforge" = _kB7j0Tdh;
        "pkg-v0.8.811-mc1.21.8-neoforge" = _D131VBIq;
        "pkg-v0.8.835-mc1.14.4-fabric" = _L73K7lJs;
        "pkg-v0.8.835-mc1.15.2-fabric" = _hxWC9sPr;
        "pkg-v0.8.835-mc1.16.5-fabric" = _kPvzeUkj;
        "pkg-v0.8.835-mc1.17.1-fabric" = _YOB0WRv3;
        "pkg-v0.8.835-mc1.18.2-fabric" = _1I730RQL;
        "pkg-v0.8.835-mc1.19.2-fabric" = _EtnbNXxV;
        "pkg-v0.8.835-mc1.19.3-fabric" = _ZvBE4TIV;
        "pkg-v0.8.835-mc1.19.4-fabric" = _oFrzUqKj;
        "pkg-v0.8.835-mc1.20.1-fabric" = _HANjUQHq;
        "pkg-v0.8.835-mc1.20.4-fabric" = _UXTyoMHA;
        "pkg-v0.8.835-mc1.20.2-fabric" = _dkeyaVp8;
        "pkg-v0.8.835-mc1.21.1-fabric" = _5ERJYbaA;
        "pkg-v0.8.835-mc1.21.10-fabric" = _8Q5aeMlA;
        "pkg-v0.8.835-mc1.20.6-fabric" = _AHWMJKqU;
        "pkg-v0.8.835-mc1.21.11-fabric" = _XRpV3BtQ;
        "pkg-v0.8.835-mc1.21.3-fabric" = _So5uszWZ;
        "pkg-v0.8.835-mc1.21.4-fabric" = _UpIN57B4;
        "pkg-v0.8.835-mc1.21.8-fabric" = _HReGFNz2;
        "pkg-v0.8.835-mc1.21.5-fabric" = _d6sRWXOp;
        "pkg-v0.8.835-mc26.1.2-fabric" = _4GyyQVe3;
        "pkg-v0.8.835-mc1.17.1-forge" = _KG6WrWe1;
        "pkg-v0.8.835-mc1.18.2-forge" = _poYgY1cJ;
        "pkg-v0.8.835-mc1.20.1-forge" = _kZ5PIiJ5;
        "pkg-v0.8.835-mc1.19.4-forge" = _r6je9ezq;
        "pkg-v0.8.835-mc1.20.2-neoforge" = _TZdtg7Ie;
        "pkg-v0.8.835-mc1.20.6-neoforge" = _x48lQTF1;
        "pkg-v0.8.835-mc1.21.1-neoforge" = _FUZZy9Fn;
        "pkg-v0.8.835-mc1.21.10-neoforge" = _Un1ddxuE;
        "pkg-v0.8.835-mc1.21.11-neoforge" = _Ui1la1H3;
        "pkg-v0.8.835-mc1.21.3-neoforge" = _c2GPp2a8;
        "pkg-v0.8.835-mc1.21.4-neoforge" = _8Gs6QVdx;
        "pkg-v0.8.835-mc1.21.5-neoforge" = _bKMiYiAE;
        "pkg-v0.8.835-mc1.21.8-neoforge" = _lpYVjki4;
        "pkg-v0.8.835-mc26.1.2-neoforge" = _mYfofs5K;
        "pkg-v0.8.838-mc1.14.4-fabric" = _6uePU1VL;
        "pkg-v0.8.838-mc1.16.5-fabric" = _iEWfYFLA;
        "pkg-v0.8.838-mc1.15.2-fabric" = _uonYj3TW;
        "pkg-v0.8.838-mc1.17.1-fabric" = _Ku4ChLjf;
        "pkg-v0.8.838-mc1.19.2-fabric" = _zgeZvmzs;
        "pkg-v0.8.838-mc1.18.2-fabric" = _Ka96WrbS;
        "pkg-v0.8.838-mc1.19.3-fabric" = _5LceBUPZ;
        "pkg-v0.8.838-mc1.20.1-fabric" = _7xwKEwHl;
        "pkg-v0.8.838-mc1.19.4-fabric" = _HtrWL9Jy;
        "pkg-v0.8.838-mc1.20.2-fabric" = _5rA245UW;
        "pkg-v0.8.838-mc1.20.4-fabric" = _iAjsIcS5;
        "pkg-v0.8.838-mc1.20.6-fabric" = _9nNg6Btf;
        "pkg-v0.8.838-mc1.21.1-fabric" = _TLpDZpqh;
        "pkg-v0.8.838-mc1.21.10-fabric" = _JG7wYirq;
        "pkg-v0.8.838-mc1.21.11-fabric" = _jVdLvKNt;
        "pkg-v0.8.838-mc1.21.3-fabric" = _V9LEuyWj;
        "pkg-v0.8.838-mc1.21.4-fabric" = _LLn1xsih;
        "pkg-v0.8.838-mc26.1.2-fabric" = _uYkjMQzV;
        "pkg-v0.8.838-mc1.21.5-fabric" = _OHswDsGA;
        "pkg-v0.8.838-mc1.18.2-forge" = _P2YAyzNh;
        "pkg-v0.8.838-mc1.21.8-fabric" = _8n4ZPrRP;
        "pkg-v0.8.838-mc1.19.4-forge" = _R3t6zsRP;
        "pkg-v0.8.838-mc1.20.1-forge" = _C4Xsb7Ms;
        "pkg-v0.8.838-mc1.20.2-neoforge" = _s1zWDEVl;
        "pkg-v0.8.838-mc1.17.1-forge" = _aEiWCnbj;
        "pkg-v0.8.838-mc1.20.6-neoforge" = _BO6w8DX5;
        "pkg-v0.8.838-mc1.21.1-neoforge" = _iKk2kWCW;
        "pkg-v0.8.838-mc1.21.10-neoforge" = _qI9U6yKL;
        "pkg-v0.8.838-mc1.21.11-neoforge" = _ZYUg1LDq;
        "pkg-v0.8.838-mc1.21.3-neoforge" = _1oqEr8Yt;
        "pkg-v0.8.838-mc1.21.4-neoforge" = _Fau5dtnL;
        "pkg-v0.8.838-mc1.21.8-neoforge" = _KCt1oJz4;
        "pkg-v0.8.838-mc1.21.5-neoforge" = _me3wdt62;
        "pkg-v0.8.838-mc26.1.2-neoforge" = _Wcs5aQUo;
        "pkg-v0.8.840-mc1.15.2-fabric" = _YGE53ZmP;
        "pkg-v0.8.840-mc1.16.5-fabric" = _lip6t2f5;
        "pkg-v0.8.840-mc1.14.4-fabric" = _9FT3howZ;
        "pkg-v0.8.840-mc1.17.1-fabric" = _wHfFxJKU;
        "pkg-v0.8.840-mc1.19.2-fabric" = _pAkK4t02;
        "pkg-v0.8.840-mc1.18.2-fabric" = _vWfjBV1a;
        "pkg-v0.8.840-mc1.19.3-fabric" = _3hWziPg2;
        "pkg-v0.8.840-mc1.19.4-fabric" = _VJvmeKBe;
        "pkg-v0.8.840-mc1.20.1-fabric" = _cmuz4Gai;
        "pkg-v0.8.840-mc1.20.4-fabric" = _FE8LHK34;
        "pkg-v0.8.840-mc1.20.2-fabric" = _oLfzd2F3;
        "pkg-v0.8.840-mc1.20.6-fabric" = _VyCT41Hr;
        "pkg-v0.8.840-mc1.21.10-fabric" = _hJ8k8OwL;
        "pkg-v0.8.840-mc1.21.1-fabric" = _q8UVHJ5T;
        "pkg-v0.8.840-mc1.21.11-fabric" = _dzNp9gAb;
        "pkg-v0.8.840-mc1.21.3-fabric" = _MrqjAHzK;
        "pkg-v0.8.840-mc1.21.4-fabric" = _83ERBEij;
        "pkg-v0.8.840-mc1.21.8-fabric" = _61D72Vay;
        "pkg-v0.8.840-mc1.21.5-fabric" = _YOZWpqqO;
        "pkg-v0.8.840-mc26.1.2-fabric" = _Y4hJc8EL;
        "pkg-v0.8.840-mc1.17.1-forge" = _hmp3ETwu;
        "pkg-v0.8.840-mc1.18.2-forge" = _VBbrgNgX;
        "pkg-v0.8.840-mc1.19.4-forge" = _KD6mKEvQ;
        "pkg-v0.8.840-mc1.20.1-forge" = _cCjBKP0z;
        "pkg-v0.8.840-mc1.20.2-neoforge" = _dQRYrfhm;
        "pkg-v0.8.840-mc1.20.6-neoforge" = _m2KdTofP;
        "pkg-v0.8.840-mc1.21.10-neoforge" = _ibpCl2Aj;
        "pkg-v0.8.840-mc1.21.1-neoforge" = _mdewcBtH;
        "pkg-v0.8.840-mc1.21.4-neoforge" = _xxlTa3HU;
        "pkg-v0.8.840-mc1.21.11-neoforge" = _c1Ks1rs9;
        "pkg-v0.8.840-mc1.21.3-neoforge" = _O38BmdZ3;
        "pkg-v0.8.840-mc1.21.5-neoforge" = _lkmgnpCC;
        "pkg-v0.8.840-mc1.21.8-neoforge" = _tsu3uvjc;
        "pkg-v0.8.840-mc26.1.2-neoforge" = _lIOjj103;
        "pkg-v0.8.852-mc1.14.4-fabric" = _PLPAHV9k;
        "pkg-v0.8.852-mc1.15.2-fabric" = _SlIYPNuZ;
        "pkg-v0.8.852-mc1.16.5-fabric" = _8RPd22Od;
        "pkg-v0.8.852-mc1.17.1-fabric" = _IomWRgrO;
        "pkg-v0.8.852-mc1.18.2-fabric" = _Dc8zYS80;
        "pkg-v0.8.852-mc1.19.2-fabric" = _kgCsBpfn;
        "pkg-v0.8.852-mc1.19.3-fabric" = _wUJfT9yi;
        "pkg-v0.8.852-mc1.19.4-fabric" = _9ROQKgn0;
        "pkg-v0.8.852-mc1.20.1-fabric" = _dGFrBllV;
        "pkg-v0.8.852-mc1.20.2-fabric" = _3OVYAb69;
        "pkg-v0.8.852-mc1.20.4-fabric" = _Z7DLt8fq;
        "pkg-v0.8.852-mc1.20.6-fabric" = _DNXPxp9P;
        "pkg-v0.8.852-mc1.21.1-fabric" = _JKjlALvT;
        "pkg-v0.8.852-mc1.21.10-fabric" = _kE2NhbMP;
        "pkg-v0.8.852-mc1.21.11-fabric" = _VV2YxkSU;
        "pkg-v0.8.852-mc1.21.3-fabric" = _XCztVrgk;
        "pkg-v0.8.852-mc1.21.4-fabric" = _E8hUfqd4;
        "pkg-v0.8.852-mc1.21.5-fabric" = _twfbp4ox;
        "pkg-v0.8.852-mc26.1.2-fabric" = _hVPUsE7d;
        "pkg-v0.8.852-mc1.21.8-fabric" = _ddXMBQYU;
        "pkg-v0.8.852-mc26.2-fabric" = _dtJGcmEH;
        "pkg-v0.8.852-mc1.17.1-forge" = _piBosim6;
        "pkg-v0.8.852-mc1.18.2-forge" = _I3SgSLRv;
        "pkg-v0.8.852-mc1.20.1-forge" = _exzwn9Kx;
        "pkg-v0.8.852-mc1.19.4-forge" = _kBYBeVVD;
        "pkg-v0.8.852-mc1.20.2-neoforge" = _viRhKxwC;
        "pkg-v0.8.852-mc1.20.6-neoforge" = _VSeoKnqF;
        "pkg-v0.8.852-mc1.21.1-neoforge" = _jFTBtLqb;
        "pkg-v0.8.852-mc1.21.10-neoforge" = _a5DxHbCM;
        "pkg-v0.8.852-mc1.21.11-neoforge" = _SwAMDQRs;
        "pkg-v0.8.852-mc1.21.3-neoforge" = _vdVl8Lea;
        "pkg-v0.8.852-mc1.21.4-neoforge" = _ASXiIc1H;
        "pkg-v0.8.852-mc1.21.5-neoforge" = _4GEMpdHC;
        "pkg-v0.8.852-mc1.21.8-neoforge" = _INUjnA0I;
        "pkg-v0.8.852-mc26.1.2-neoforge" = _1YZzc39r;
        "pkg-v0.8.852-mc26.2-neoforge" = _X1s4EQgx;
        "pkg-v0.8.855-mc1.14.4-fabric" = _HEbr9i1k;
        "pkg-v0.8.855-mc1.15.2-fabric" = _2eGxjs3M;
        "pkg-v0.8.855-mc1.16.5-fabric" = _C9sF2qHM;
        "pkg-v0.8.855-mc1.17.1-fabric" = _kdFz5qbv;
        "pkg-v0.8.855-mc1.18.2-fabric" = _h2jwXv0M;
        "pkg-v0.8.855-mc1.19.2-fabric" = _53RoGWez;
        "pkg-v0.8.855-mc1.19.3-fabric" = _drlNiwPs;
        "pkg-v0.8.855-mc1.20.1-fabric" = _a6em6hF7;
        "pkg-v0.8.855-mc1.19.4-fabric" = _ANKytMNP;
        "pkg-v0.8.855-mc1.20.2-fabric" = _pBF6k7E1;
        "pkg-v0.8.855-mc1.20.4-fabric" = _w0WdJnJr;
        "pkg-v0.8.855-mc1.21.1-fabric" = _bUwd7LaD;
        "pkg-v0.8.855-mc1.21.10-fabric" = _naCFKTkh;
        "pkg-v0.8.855-mc1.20.6-fabric" = _kgOhkhZO;
        "pkg-v0.8.855-mc1.21.11-fabric" = _8bSWPsfL;
        "pkg-v0.8.855-mc1.21.3-fabric" = _2fwkR7K5;
        "pkg-v0.8.855-mc1.21.4-fabric" = _7RKMgyx1;
        "pkg-v0.8.855-mc1.21.5-fabric" = _WAaWXZ4a;
        "pkg-v0.8.855-mc1.21.8-fabric" = _6ldUPU78;
        "pkg-v0.8.855-mc26.2-fabric" = _6NF0mo8v;
        "pkg-v0.8.855-mc26.1.2-fabric" = _2VQixSrr;
        "pkg-v0.8.855-mc1.17.1-forge" = _8GmOSrhv;
        "pkg-v0.8.855-mc1.18.2-forge" = _ZWcv7YIN;
        "pkg-v0.8.855-mc1.19.4-forge" = _BHl6qSRj;
        "pkg-v0.8.855-mc1.20.1-forge" = _cHmum8pY;
        "pkg-v0.8.855-mc1.20.2-neoforge" = _jNNe82Zk;
        "pkg-v0.8.855-mc1.21.1-neoforge" = _eHA6wFRS;
        "pkg-v0.8.855-mc1.21.10-neoforge" = _2UMlueAB;
        "pkg-v0.8.855-mc1.20.6-neoforge" = _kEXWhFof;
        "pkg-v0.8.855-mc1.21.3-neoforge" = _3yRFxK4N;
        "pkg-v0.8.855-mc1.21.4-neoforge" = _t9qf9vAN;
        "pkg-v0.8.855-mc1.21.11-neoforge" = _Q2Eo6ENl;
        "pkg-v0.8.855-mc1.21.5-neoforge" = _DTvtvLN3;
        "pkg-v0.8.855-mc1.21.8-neoforge" = _zXcx11bf;
        "pkg-v0.8.855-mc26.2-neoforge" = _ckDTmj9O;
        "pkg-v0.8.855-mc26.1.2-neoforge" = _uPKzqQyz;
        "pkg-v0.8.863-mc1.14.4-fabric" = _CXMZOQRp;
        "pkg-v0.8.863-mc1.15.2-fabric" = _LQBE2566;
        "pkg-v0.8.863-mc1.16.5-fabric" = _axwAXlQS;
        "pkg-v0.8.863-mc1.17.1-fabric" = _mZu6u6c4;
        "pkg-v0.8.863-mc1.18.2-fabric" = _vfqASR4j;
        "pkg-v0.8.863-mc1.19.2-fabric" = _Iz7r4s2f;
        "pkg-v0.8.863-mc1.19.3-fabric" = _zW4dMznB;
        "pkg-v0.8.863-mc1.19.4-fabric" = _KkHWKFsk;
        "pkg-v0.8.863-mc1.20.4-fabric" = _KzhuA7yG;
        "pkg-v0.8.863-mc1.20.2-fabric" = _dcF6621a;
        "pkg-v0.8.863-mc1.21.1-fabric" = _cZD9G9lP;
        "pkg-v0.8.863-mc1.20.6-fabric" = _7bSGn8Hy;
        "pkg-v0.8.863-mc1.21.10-fabric" = _jT4UPNbU;
        "pkg-v0.8.863-mc1.20.1-fabric" = _wFOjRs3V;
        "pkg-v0.8.863-mc1.21.3-fabric" = _NxnYVhwv;
        "pkg-v0.8.863-mc1.21.11-fabric" = _Gcasw4wJ;
        "pkg-v0.8.863-mc1.21.5-fabric" = _KHJjaTGD;
        "pkg-v0.8.863-mc1.21.4-fabric" = _yho8wZvF;
        "pkg-v0.8.863-mc1.21.8-fabric" = _THiCahMH;
        "pkg-v0.8.863-mc1.18.2-forge" = _RFw4Y3pk;
        "pkg-v0.8.863-mc1.17.1-forge" = _BzVAujWs;
        "pkg-v0.8.863-mc1.20.1-forge" = _hGL2bG4t;
        "pkg-v0.8.863-mc26.1.2-fabric" = _241NUYRB;
        "pkg-v0.8.863-mc1.19.4-forge" = _WlFQTfey;
        "pkg-v0.8.863-mc26.2-fabric" = _WebZlgBx;
        "pkg-v0.8.863-mc1.20.6-neoforge" = _qYG0DkVN;
        "pkg-v0.8.863-mc1.20.2-neoforge" = _13Hwhzjz;
        "pkg-v0.8.863-mc1.21.10-neoforge" = _x6hJo7LV;
        "pkg-v0.8.863-mc1.21.1-neoforge" = _pf4Ex0Fl;
        "pkg-v0.8.863-mc1.21.3-neoforge" = _nmc84iEI;
        "pkg-v0.8.863-mc1.21.11-neoforge" = _q0m24UL5;
        "pkg-v0.8.863-mc1.21.5-neoforge" = _ndBSEjSY;
        "pkg-v0.8.863-mc1.21.8-neoforge" = _XCfOFFKk;
        "pkg-v0.8.863-mc1.21.4-neoforge" = _FdjbTBZM;
        "pkg-v0.8.863-mc26.2-neoforge" = _MJXybQQD;
        "pkg-v0.8.863-mc26.1.2-neoforge" = _VeVBjR9b;
        "pkg-v0.8.873-mc1.14.4-fabric" = _aUqoWKIO;
        "pkg-v0.8.873-mc1.15.2-fabric" = _EdahNhPO;
        "pkg-v0.8.873-mc1.16.5-fabric" = _SOVVJ9wq;
        "pkg-v0.8.873-mc1.17.1-fabric" = _PFLWhzDo;
        "pkg-v0.8.873-mc1.19.2-fabric" = _4gZNGEtT;
        "pkg-v0.8.873-mc1.18.2-fabric" = _Forqimhj;
        "pkg-v0.8.873-mc1.19.3-fabric" = _ADn2viSA;
        "pkg-v0.8.873-mc1.20.1-fabric" = _pdymjTwd;
        "pkg-v0.8.873-mc1.19.4-fabric" = _BrKxgmED;
        "pkg-v0.8.873-mc1.20.4-fabric" = _YXFTuY7N;
        "pkg-v0.8.873-mc1.20.2-fabric" = _MUv7Vr7e;
        "pkg-v0.8.873-mc1.20.6-fabric" = _CO6RpPk5;
        "pkg-v0.8.873-mc1.21.1-fabric" = _CEvJIPfx;
        "pkg-v0.8.873-mc1.21.10-fabric" = _UmRQcsPw;
        "pkg-v0.8.873-mc1.21.3-fabric" = _p3I8EZQD;
        "pkg-v0.8.873-mc1.21.11-fabric" = _9ngBajGy;
        "pkg-v0.8.873-mc1.21.4-fabric" = _cdwImLwI;
        "pkg-v0.8.873-mc1.21.5-fabric" = _sgTYgkbu;
        "pkg-v0.8.873-mc1.21.8-fabric" = _Afhb67tc;
        "pkg-v0.8.873-mc26.1.2-fabric" = _6V6TBcKU;
        "pkg-v0.8.873-mc1.17.1-forge" = _soyFmVVw;
        "pkg-v0.8.873-mc26.2-fabric" = _d0MSb304;
        "pkg-v0.8.873-mc1.18.2-forge" = _m6jNmcrP;
        "pkg-v0.8.873-mc1.19.4-forge" = _gTXo4CWU;
        "pkg-v0.8.873-mc1.20.1-forge" = _hsqlhPOY;
        "pkg-v0.8.873-mc1.20.2-neoforge" = _GSY3WjDa;
        "pkg-v0.8.873-mc1.20.6-neoforge" = _QBYIQpwc;
        "pkg-v0.8.873-mc1.21.1-neoforge" = _QUNBFk3O;
        "pkg-v0.8.873-mc1.21.10-neoforge" = _uB2qzFCD;
        "pkg-v0.8.873-mc1.21.3-neoforge" = _gM2flBpj;
        "pkg-v0.8.873-mc1.21.11-neoforge" = _hUxG2uUm;
        "pkg-v0.8.873-mc1.21.4-neoforge" = _did5H2VD;
        "pkg-v0.8.873-mc1.21.5-neoforge" = _97vte51T;
