...
let
    versions = (let
        ...
        _XOQeZYTc = {
            "id" = "XOQeZYTc";
            "file" = "RaycastedAntiESP-0.7.1-Paper-0.10.1-RELEASE.jar";
            "hash" = "sha512-X8id0FkjQYDWp/gFLXIqu9Aihr5RPy8SmyyeXhI28QHSFBxZTwrVquTPWJzNm7nb+RjCtpw0IwIYoXKM+fT3dQ==";
        };
        _rhtqEgK7 = {
            "id" = "rhtqEgK7";
            "file" = "RaycastedAntiESP-0.7.2-Paper-0.10.2-RELEASE.jar";
            "hash" = "sha512-j3D72EDhwDHRzocemMmGfuB6tPhwcz2YhrqfYn6amYi4HcEkb75WRsFHYLAs8QivWqFPokV5hmkgJwvVyx6j7Q==";
        };
    in {
        "nKYXH0QP" = _nKYXH0QP;
        "oNYvmJQ7" = _oNYvmJQ7;
        ...
        "paper-1.21.4" = _rhtqEgK7;
        "paper-1.21.5" = _rhtqEgK7;
        "paper-1.21.6" = _rhtqEgK7;
        "paper-1.21.7" = _rhtqEgK7;
        "paper-1.21.8" = _rhtqEgK7;
        "paper-1.21.9" = _rhtqEgK7;
        "paper-1.21.10" = _rhtqEgK7;
        "paper-1.21.11" = _rhtqEgK7;
        "paper-26.1" = _rhtqEgK7;
        "paper-26.1.1" = _rhtqEgK7;
        "paper-26.1.2" = _rhtqEgK7;
        "paper-26.2" = _rhtqEgK7;
        "purpur-1.21" = _FHSgISwb;
        "purpur-1.21.1" = _FHSgISwb;
        "purpur-1.21.2" = _FHSgISwb;
        "purpur-1.21.3" = _FHSgISwb;
        "purpur-1.20.6" = _FHSgISwb;
        "purpur-1.21.4" = _rhtqEgK7;
        "purpur-1.21.5" = _rhtqEgK7;
        "purpur-1.21.6" = _rhtqEgK7;
        "purpur-1.21.7" = _rhtqEgK7;
        "purpur-1.21.8" = _rhtqEgK7;
        "purpur-1.21.9" = _rhtqEgK7;
        "purpur-1.21.10" = _rhtqEgK7;
        "purpur-1.21.11" = _rhtqEgK7;
        "purpur-26.1" = _rhtqEgK7;
        "purpur-26.1.1" = _rhtqEgK7;
        "purpur-26.1.2" = _rhtqEgK7;
        "purpur-26.2" = _rhtqEgK7;
        "bukkit-1.21" = _z79ZvzyS;
        "spigot-1.21" = _z79ZvzyS;
        "folia-1.21.4" = _rhtqEgK7;
        "folia-1.21.5" = _rhtqEgK7;
        "folia-1.21.6" = _rhtqEgK7;
        "folia-1.21.7" = _rhtqEgK7;
        "folia-1.21.8" = _rhtqEgK7;
        "folia-1.21.9" = _rhtqEgK7;
        "folia-1.21.10" = _rhtqEgK7;
        "folia-1.21.11" = _rhtqEgK7;
        "folia-26.1" = _rhtqEgK7;
        "folia-26.1.1" = _rhtqEgK7;
        "folia-26.1.2" = _rhtqEgK7;
        "folia-26.2" = _rhtqEgK7;
        "pkg-1.0.1" = _nKYXH0QP;
        "pkg-1.1.0" = _oNYvmJQ7;
        "pkg-1.2.0" = _ItOp7AxB;
        "pkg-1.2.1" = _9y0iBRId;
        ...
        "pkg-0.7.1-Paper-0.10.1" = _XOQeZYTc;
        "pkg-0.7.2-Paper-0.10.2" = _rhtqEgK7;
        "default" = _rhtqEgK7;
    });
