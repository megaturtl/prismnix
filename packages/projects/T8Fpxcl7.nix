...
let
    versions = (let
        ...
        _iGfAKeXR = {
            "id" = "iGfAKeXR";
            "file" = "toomanypaintings-26.08.16-1.19-forge.jar";
            "hash" = "sha512-4w+MsC6KWft8v3PAmi6OSqCs8zGK+VEcsXl1A+TovkyFMiggzjKjU0w0GTemC99EY204U2sU6UKVEUUC6omxUQ==";
        };
        _wlh6wjOS = {
            "id" = "wlh6wjOS";
            "file" = "toomanypaintings-26.08.16-1.20-forge.jar";
            "hash" = "sha512-6LgpiwA+NCtSbpJjyr/ijqsoJ3hc9pY6C2zqLdJGfqxYdtL1qCQM47JKzI/dNHzoCNV3vPxCSCt8C+TzhyjnUw==";
        };
        _LbeIrOJv = {
            "id" = "LbeIrOJv";
            "file" = "toomanypaintings-26.08.16-1.20.6-forge.jar";
            "hash" = "sha512-OatRqGYu7ets62u3Z31Evm9/IpulUB1yWefPDVSbOqbJq9oR6uUeUeXI44sjXahd60x3HakRTCuyq6lDG1QTxA==";
        };
        _HoYCfvc0 = {
            "id" = "HoYCfvc0";
            "file" = "toomanypaintings-26.08.16-1.21-forge.jar";
            "hash" = "sha512-1cZvPd1WnhXjlx2f5Qwv60PrSA4o/GLazndS4DfvGGJnSBmHtYQR48o5UuNXWyqtyXtmqc0vrj5UNFTNw39q5g==";
        };
        _57kyEajE = {
            "id" = "57kyEajE";
            "file" = "toomanypaintings-26.08.16-1.21.3-forge.jar";
            "hash" = "sha512-yze4A2etu9YAuieW8hhSmJsehnj5pUybHeOw5jdR61f8QF0PNg6MrzwtvrcYLVvEMBv01I2XQA3tKulCNU3yuA==";
        };
        _xR1EbTOW = {
            "id" = "xR1EbTOW";
            "file" = "toomanypaintings-26.08.16-26.1-forge.jar";
            "hash" = "sha512-PfHW+EJLRAccaqzp0eIr4TGwbDjAafTnGi1l/92uPva7uZqXDE4/Id7J1tj6Tioj7nqBeor0Y3TSaIVH2MS/iw==";
        };
        _Emm2DPMU = {
            "id" = "Emm2DPMU";
            "file" = "toomanypaintings-26.08.16-1.21-neoforge.jar";
            "hash" = "sha512-D9Q1/m/oEGWKUadLmHwzQ3ScLMpPEL6jJer9bUuLKzbn6Syv3W+N7qbEb1//hff0u5kCTS58L4yNTsHJHv5EgA==";
        };
        _YhDKRyBe = {
            "id" = "YhDKRyBe";
            "file" = "toomanypaintings-26.08.16-1.21.3-neoforge.jar";
            "hash" = "sha512-Z+UI6sTe/osIwNI4P7zXAXo7wlhwXrnc6niOwqygYUGLN5E7P/z/FnhgQHoHV9lEAk7yl/bJt3SDtRnHYEK18A==";
        };
        _GC4dyfrj = {
            "id" = "GC4dyfrj";
            "file" = "toomanypaintings-26.08.16-26.1-neoforge.jar";
            "hash" = "sha512-4YRMuwyGgjszKd1bqCtu9Jkb6DRKP6AxV7UXYh1cRJ6fYAyVqAaUpf7BPMiGVBM/oZj4jf4Baa2r95oudfRYNg==";
        };
        _sYcHfifZ = {
            "id" = "sYcHfifZ";
            "file" = "toomanypaintings-26.08.16-1.19-fabric.jar";
            "hash" = "sha512-oHdaSrfQuVOIvd2bfJhDHsJpJ5Om5vFSjpyZweKW3WYv3tT/l/mIZENJobOe3lgeoJm11xeZunMCAwH9YB4v+w==";
        };
        _72gIf0ko = {
            "id" = "72gIf0ko";
            "file" = "toomanypaintings-26.08.16-1.19.3-fabric.jar";
            "hash" = "sha512-v+WV6Kg2fIaMmaNGI0uyEh16BrZ4H14zD3ivFHbh0IyqQcHdc9oCVrhkVRDcC5AvBBsy3xg8rPGPlt5+DRBISw==";
        };
        _znmKVhkI = {
            "id" = "znmKVhkI";
            "file" = "toomanypaintings-26.08.16-1.19.4-fabric.jar";
            "hash" = "sha512-WO7+OHsJkyT0J6OGW+dKy7haNiTMFDTpojD+629LxG5p//vfvAvBmqbVyG88mz1Rkf8Bp4n1F0nvkwPwGJjf/Q==";
        };
        _MgDCl0TC = {
            "id" = "MgDCl0TC";
            "file" = "toomanypaintings-26.08.16-1.20-fabric.jar";
            "hash" = "sha512-KNXVyjSkBaev/T0Y4Bd6SSXIyvx/uUPx1GJ5lM8vk5nk/iCxYAo5Sgg90GHyovafsWp/cNxSbvXRtT3GFTjsfQ==";
        };
        _L6JMh67O = {
            "id" = "L6JMh67O";
            "file" = "toomanypaintings-26.08.16-1.20.6-fabric.jar";
            "hash" = "sha512-CH3mc+4jZGRAX5N9+n7NNK7nvjFfsdE24il/m5oKAIIjUOP4eiDHh7tlGYuPNtHEJ5zyVZTNOmwaYs3Z6L1yLQ==";
        };
        _N4d1IZLk = {
            "id" = "N4d1IZLk";
            "file" = "toomanypaintings-26.08.16-1.21-fabric.jar";
            "hash" = "sha512-WC2Hd8JN5p6E7VEVsTVXtU34rNSjKkh1r90Wbn+k1MAOkV3+BE/5ZgMvnP5jeizSEbas67nLHryDSTfIJZ94nw==";
        };
        _3NyjxQAc = {
            "id" = "3NyjxQAc";
            "file" = "toomanypaintings-26.08.16-1.21.2-fabric.jar";
            "hash" = "sha512-am6iVvkwsgUxzbn72DLDiinpXqpk9JCw0rks51fA2rcKaOXxtLgGp6hM9IQEJTxukFLARsUvawiQTIECo5EJkQ==";
        };
        _TGJKbXYq = {
            "id" = "TGJKbXYq";
    ...
    in {
        ...
        "fabric-1.20.3" = _MgDCl0TC;
        "fabric-1.20.4" = _MgDCl0TC;
        "fabric-1.19" = _sYcHfifZ;
        "fabric-1.19.1" = _sYcHfifZ;
        "fabric-1.19.2" = _sYcHfifZ;
        "fabric-1.19.3" = _72gIf0ko;
        "fabric-1.19.4" = _znmKVhkI;
        "fabric-1.20.5" = _L6JMh67O;
        "fabric-1.20.6" = _L6JMh67O;
        "fabric-1.21" = _N4d1IZLk;
        "fabric-1.21.1" = _N4d1IZLk;
        "fabric-1.21.2" = _3NyjxQAc;
        "fabric-1.21.3" = _3NyjxQAc;
        "fabric-1.21.4" = _3NyjxQAc;
        "fabric-1.21.5" = _3NyjxQAc;
        "fabric-1.21.6" = _3NyjxQAc;
        "fabric-1.21.7" = _3NyjxQAc;
        "fabric-1.21.8" = _3NyjxQAc;
        ...
        "quilt-1.20.3" = _MgDCl0TC;
        "quilt-1.20.4" = _MgDCl0TC;
        "quilt-1.19" = _sYcHfifZ;
        "quilt-1.19.1" = _sYcHfifZ;
        "quilt-1.19.2" = _sYcHfifZ;
        "quilt-1.19.3" = _72gIf0ko;
        "quilt-1.19.4" = _znmKVhkI;
        "quilt-1.20.5" = _L6JMh67O;
        "quilt-1.20.6" = _L6JMh67O;
        ...
        "forge-1.20" = _wlh6wjOS;
        "forge-1.20.1" = _wlh6wjOS;
        "forge-1.20.2" = _wlh6wjOS;
        "forge-1.20.3" = _wlh6wjOS;
        "forge-1.20.4" = _wlh6wjOS;
        "forge-1.19" = _iGfAKeXR;
        "forge-1.19.1" = _iGfAKeXR;
        "forge-1.19.2" = _iGfAKeXR;
        "forge-1.19.3" = _iGfAKeXR;
        "forge-1.19.4" = _iGfAKeXR;
        "forge-1.20.5" = _yOjDLsVm;
        "forge-1.20.6" = _LbeIrOJv;
        "forge-1.21" = _HoYCfvc0;
        "forge-1.21.1" = _HoYCfvc0;
        "forge-1.21.2" = _fswiTu7h;
        "forge-1.21.3" = _57kyEajE;
        "forge-1.21.4" = _57kyEajE;
        "forge-1.21.5" = _57kyEajE;
        "forge-1.21.6" = _57kyEajE;
        "forge-1.21.7" = _57kyEajE;
        "forge-1.21.8" = _57kyEajE;
        "forge-1.21.9" = _57kyEajE;
        "forge-1.21.10" = _57kyEajE;
        "forge-1.21.11" = _57kyEajE;
        "forge-26.1" = _xR1EbTOW;
        "forge-26.1.1" = _xR1EbTOW;
        "forge-26.1.2" = _xR1EbTOW;
        "forge-26.2" = _xR1EbTOW;
        "neoforge-1.20" = _wlh6wjOS;
        "neoforge-1.20.1" = _wlh6wjOS;
        "neoforge-1.20.2" = _wlh6wjOS;
        "neoforge-1.20.3" = _wlh6wjOS;
        "neoforge-1.20.4" = _wlh6wjOS;
        "neoforge-1.21" = _Emm2DPMU;
        "neoforge-1.21.1" = _Emm2DPMU;
        "neoforge-1.21.2" = _YhDKRyBe;
        "neoforge-1.21.3" = _YhDKRyBe;
        "neoforge-1.21.4" = _YhDKRyBe;
        "neoforge-1.21.5" = _YhDKRyBe;
        "neoforge-1.21.6" = _YhDKRyBe;
        "neoforge-1.21.7" = _YhDKRyBe;
        "neoforge-1.21.8" = _YhDKRyBe;
        "neoforge-1.21.9" = _YhDKRyBe;
        "neoforge-1.21.10" = _YhDKRyBe;
        "neoforge-1.20.6" = _LbeIrOJv;
        "neoforge-1.21.11" = _YhDKRyBe;
        "neoforge-26.1" = _GC4dyfrj;
        "neoforge-26.1.1" = _GC4dyfrj;
        "neoforge-26.1.2" = _GC4dyfrj;
        "neoforge-26.2" = _GC4dyfrj;
        ...
        "pkg-26.08.16-1.19-forge" = _iGfAKeXR;
        "pkg-26.08.16-1.20-forge" = _wlh6wjOS;
        "pkg-26.08.16-1.20.6-forge" = _LbeIrOJv;
        "pkg-26.08.16-1.21-forge" = _HoYCfvc0;
        "pkg-26.08.16-1.21.3-forge" = _57kyEajE;
        "pkg-26.08.16-26.1-forge" = _xR1EbTOW;
        "pkg-26.08.16-1.21-neoforge" = _Emm2DPMU;
        "pkg-26.08.16-1.21.3-neoforge" = _YhDKRyBe;
        "pkg-26.08.16-26.1-neoforge" = _GC4dyfrj;
        "pkg-26.08.16-1.19-fabric" = _sYcHfifZ;
        "pkg-26.08.16-1.19.3-fabric" = _72gIf0ko;
        "pkg-26.08.16-1.19.4-fabric" = _znmKVhkI;
        "pkg-26.08.16-1.20-fabric" = _MgDCl0TC;
        "pkg-26.08.16-1.20.6-fabric" = _L6JMh67O;
    ...
    fn = lib.prismnix.pkgs.mkVersionedModrinthPkgFn {
        ...
        meta = {
            license = lib.getLicenseFromSpdxIdOr "MIT" {
                ...
                shortName = "MIT";
                url = "https://github.com/axperty/toomanypaintings/blob/26.1-neoforge/LICENSE";
            };
        };
    };
in callPackage fn {}