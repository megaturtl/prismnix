...
let
    ...
    in {
        ...
        "pkg-1.1.14" = _37LZSt0m;
        "pkg-1.1.15" = _YHiMFJh8;
        "pkg-1.1.16" = _vbt23CxH;
        "pkg-1.1.17" = _HhCHn38f;
        "pkg-1.1.18" = _Q37cLHNo;
        "pkg-1.1.19" = _GPyoJNWl;
        "pkg-1.1.20" = _iif2eIg7;
        "pkg-1.2.0" = _5WBUHdK3;
        "pkg-1.2.1" = _4m20R7gS;
        "pkg-1.2.2" = _midYdKce;
        "pkg-1.3.0" = _suq5fEMU;
