...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _E7OHAOYy;
        "pkg-1.0.2" = _tAGy6gkd;
        "pkg-1.0.2h" = _YJeinsrC;
        "pkg-1.0.3" = _2nlUJACw;
        "pkg-1.1.0" = _95ehjK8W;
        "pkg-1.2.0" = _z2A1UFHW;
        "pkg-1.2.1" = _jYLgiDVu;
        "pkg-1.2.2" = _PEVla50a;
        "pkg-1.2.2h" = _UPLrlMOe;
        "pkg-1.3.0-alpha" = _fjtp4KvR;
        "pkg-1.3.0" = _iF1yeQ2i;
        "pkg-1.3.1" = _2ZOK7zdk;
        "pkg-1.3.2" = _kbfTp6go;
        "pkg-1.3.3" = _mo3ugEaP;
        "pkg-1.3.3h" = _bcDihyoW;
        "pkg-1.3.4" = _kPSpoarG;
        "pkg-1.4.0" = _safIQqu9;
        "pkg-1.4.1" = _jSTMhtHc;
        "pkg-1.4.2" = _N7vTlsYt;
        "pkg-1.5.0-alpha" = _9n7wDVE0;
        "pkg-1.5.0" = _m3lOtjzW;
        "pkg-1.6.0-alpha" = _RM8WcJoD;
        "pkg-1.6.1" = _I0vR4O2n;
        "pkg-1.6.2" = _SYeYLspx;
        "pkg-1.6.3" = _atwKBFD0;
        "pkg-1.6.4" = _eGq8FAcD;
        ...
        "pkg-1.9.1" = _YHBiENWo;
        "pkg-1.9.2" = _J8eEGxKI;
        "pkg-1.10.0" = _fRc3GO1U;
        "pkg-1.10.1" = _Xden4gD9;
        "pkg-1.10.2" = _1V0v0ZAf;
        "pkg-1.10.3" = _tMxvdZqn;
        "pkg-1.10.4" = _qv2GzQ8B;
        "pkg-1.10.5" = _dJfsYB4l;
        "pkg-1.11.0-alpha" = _qgi5ZdWA;
        "pkg-1.11.0" = _oAkoydcc;
        "pkg-1.11.1-hotfix" = _e3doJus3;
        "pkg-1.11.2" = _GHk7UG8x;
        "pkg-1.11.3" = _T5mnlWpm;
        "pkg-1.11.4" = _WLsukJ1r;
        "pkg-1.11.5" = _9VCM3NXb;
        "pkg-1.11.6" = _tGd1TU3u;
        "pkg-1.12.0" = _MOT27pNH;
        "pkg-1.13.0" = _inD4JxJj;
        "pkg-1.13" = _SGphjIqc;
        "pkg-1.13.1" = _r3alagqq;
        "pkg-1.14.0-alpha" = _sfp6uylw;
        "pkg-1.14.1" = _Mtcl2Kfl;
        "pkg-1.14.2" = _m41tGZNy;
        "pkg-1.14.3-hotfix" = _3TI1FBSa;
        "pkg-1.14.4" = _2KFglMjq;
        "pkg-1.15" = _NRIZKEO0;
        "pkg-1.15.1" = _FFPBtroT;
        "pkg-1.16.0" = _1ANW7xOp;
        "pkg-1.16.1" = _SdhoLIJq;
        "pkg-1.16.2" = _DxDDGt6L;
        "pkg-1.16.3-hotfix" = _uI9DcwMM;
        "pkg-1.17.0-alpha" = _Bby54KnP;
        "pkg-1.17.1" = _m3jTB12k;
        "pkg-1.17.2" = _QFwTUYh8;
        "pkg-1.17.3" = _xBgt9ZS9;
        "pkg-1.17.4" = _MdqFOdNi;
        "pkg-1.17.5" = _Ggyhlyvm;
        "default" = _Ggyhlyvm;
    });
