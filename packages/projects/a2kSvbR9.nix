...
let
    versions = (let
        ...
        _aIqnH116 = {
            "id" = "aIqnH116";
            "file" = "[1.20.2+]DaintyOrder2608p1.zip";
            "hash" = "sha512-XjK5Os16EW77Zz4VHw4lZOu5JE9FF33fiSrOKKsYuU5u+ukvtSn9aQb97R+sM+139V+JjHF3Y7wvLBXtRTknqA==";
        };
    in {
        "kujwpLVC" = _kujwpLVC;
        "Bzgnl4cf" = _Bzgnl4cf;
        ...
        "zFcw40Qo" = _zFcw40Qo;
        "aIqnH116" = _aIqnH116;
        "minecraft-1.20.6" = _aIqnH116;
        "minecraft-1.20" = _aIqnH116;
        "minecraft-1.20.1" = _aIqnH116;
        "minecraft-1.20.2" = _aIqnH116;
        "minecraft-1.20.3" = _aIqnH116;
        "minecraft-1.20.4" = _aIqnH116;
        "minecraft-1.20.5" = _aIqnH116;
        "minecraft-1.21" = _aIqnH116;
        "minecraft-1.21.1" = _aIqnH116;
        "minecraft-1.21.2" = _aIqnH116;
        "minecraft-1.21.3" = _aIqnH116;
        "minecraft-1.21.4" = _aIqnH116;
        "minecraft-1.21.5" = _aIqnH116;
        "minecraft-1.21.6" = _aIqnH116;
        "minecraft-1.21.7" = _aIqnH116;
        "minecraft-1.21.8" = _aIqnH116;
        "minecraft-1.21.9" = _aIqnH116;
        "minecraft-1.21.10" = _aIqnH116;
        "minecraft-1.21.11" = _aIqnH116;
        "minecraft-26.1" = _aIqnH116;
        "minecraft-26.1.1" = _aIqnH116;
        "minecraft-26.1.2" = _aIqnH116;
        "minecraft-26.2" = _aIqnH116;
        "pkg-240611" = _kujwpLVC;
        "pkg-240708" = _Bzgnl4cf;
        "pkg-240924" = _IuFTSYCj;
        "pkg-241108" = _4FBvkBM7;
        "pkg-2504" = _XPsUsInm;
        "pkg-2510p1" = _OOxxwqpP;
        "pkg-2511p3" = _3V5j2jCh;
        "pkg-2601p3" = _ljgm3cyA;
        "pkg-2603p2" = _kB0uidrH;
        "pkg-2607p1" = _w0NjlFmv;
        "pkg-2607p2" = _zFcw40Qo;
        "pkg-2608p1" = _aIqnH116;
        "default" = _aIqnH116;
    });
