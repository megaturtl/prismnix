...
let
    ...
    in {
        ...
        "pkg-0.5.1-1.21.1" = _K60mDZwb;
        "pkg-0.5.1-1.21.4" = _38MHfPNk;
        "pkg-0.5.1-1.21.6-1.21.8" = _vr685nI3;
        "pkg-0.5.2-1.21.6-1.21.8" = _KQRAs3qR;
        "pkg-0.5.2-1.21.11" = _SL2EFNN7;
        "pkg-0.5.3-1.21.6-1.21.8" = _VreO72mG;
        "pkg-0.5.3-1.21.11" = _LI5NWEaX;
        "pkg-0.5.4-1.21.6-1.21.8" = _W6nHdcrQ;
        "pkg-0.5.4-1.20.1" = _DkVgW9hd;
        "pkg-0.5.4-1.20.4" = _XSGqaALu;
        "pkg-0.5.5-1.21.6-1.21.8" = _b8h2Gmrd;
        "pkg-0.5.5-1.21.11" = _5yuqbJxj;
        "pkg-0.5.5.1-1.21.6-1.21.8" = _6qcFHMfc;
        "pkg-0.5.5.1-1.20.1" = _Zjfqunb2;
        "pkg-0.5.6-1.21.11" = _qVwREMMc;
        "pkg-0.5.7-1.21.11" = _4lM4yogN;
        "pkg-0.5.6-1.21.6-1.21.8" = _lDs1Xi5M;
        "pkg-0.6.0-1.21.11" = _EWDL9Rin;
        "pkg-0.6.0-26.1-alpha-6" = _JPHYmM0z;
        "pkg-0.6.1-26.1-snapshot-6" = _eoDPXAfM;
        "pkg-0.6.2-26.1-snapshot-1-6" = _sYv7lee1;
        "pkg-0.5.2-1.21.1" = _qWTbeevE;
        "pkg-0.6.3-26.1-snapshot-1-7" = _eC5xs9de;
        "pkg-0.6.3-26.1-snapshot-1-6" = _yv2qsvVA;
        "pkg-0.6.1-1.21.11" = _rVxvGU44;
        "pkg-0.6.2-1.21.11" = _amV1JUBz;
        "pkg-0.6.2.1-1.21.11" = _qYKo3NiR;
        "pkg-0.6.4-26.1-snapshot-1-7" = _5H3os7pO;
        "pkg-0.6.2.2-1.21.11" = _iFc54Mud;
        "pkg-0.6.2.3-1.21.11" = _gA6xuT6L;
        "pkg-0.6.2.4-1.21.11" = _IjC5Vosa;
        "pkg-0.6.2.4-26.1-snapshot-7-9" = _yfyVJCTZ;
        "pkg-0.6.2.5-1.21.11" = _CLZFcFQ4;
        "pkg-0.6.3-1.21.11" = _HACsty2H;
        "pkg-0.6.3.1-1.21.11" = _3FeVwD6P;
        "pkg-0.6.4.01-1.21.11" = _VwT8HBls;
        "pkg-0.6.4.02-1.21.11" = _fAyRYXKK;
        "pkg-0.6.4.03-1.21.11" = _ukUDCu7O;
        "pkg-0.6.4.04-1.21.11" = _SvkMWlyF;
        "pkg-0.6.4.05-1.21.11" = _e0xGTyQt;
        "pkg-0.6.4.06-1.21.11" = _FhSHPM6Q;
        "pkg-0.6.4.07-26.1-snapshot-11" = _RPRVMr48;
        "pkg-0.6.4.09-1.21.11" = _IIH2zG5y;
        "pkg-0.6.4.09-26.1-snapshot-11" = _MSgTaYIs;
        "pkg-0.6.4.10-1.21.11" = _LJTVv16V;
        "pkg-0.6.4.10-1.21.1" = _FOGJimIS;
        "pkg-0.6.5.1-1.21.11" = _z19CL5J1;
        "pkg-0.6.5.1-hotfix-1.21.6-1.21.8" = _k5MG6bt8;
        "pkg-0.6.5.2-1.21.6-1.21.8" = _vbnfQaoA;
        "pkg-0.6.5-1.21.6-1.21.8" = _9AKA3Dsx;
        "pkg-0.6.5-1.21.11" = _3YHLlcxU;
        "pkg-0.6.6-26.1" = _87ZEEdpS;
        "pkg-0.6.6.1-26.1" = _HvNrgNmn;
        "pkg-0.6.6.2-26.1" = _NLgEyzgD;
        "pkg-0.6.6.3-1.21.11" = _yWWJQuNg;
        "pkg-0.6.6.4-26.1" = _pe3WwV3n;
        "pkg-0.7.0-26.1" = _5UtKCXZD;
        "pkg-0.7.1-26.1" = _7HDiTumJ;
        "pkg-0.7.2-26.1" = _fWhyRxph;
        "pkg-0.7.2-26.2" = _rU0mKCA5;
        "pkg-0.7.4-26.1" = _8LJXH7SE;
        "pkg-0.7.5-26.1" = _1yhZ59tv;
        "pkg-0.7.5-26.2" = _JWXlSCNk;
        "pkg-0.7.5-26.2-sp-3" = _oEDK2nmO;
        "pkg-0.7.7-26.1" = _2xhp84oA;
        "pkg-0.7.7.1-26.1" = _ia3gOCnY;
        "pkg-0.7.7.2-26.1" = _ollY6LDa;
        "pkg-0.7.7.2-26.2-sp-3" = _yqJ6B465;
        "pkg-0.7.7.2-1.21.11" = _LU77vEO6;
        "pkg-0.7.7.2-1.21.6-1.21.8" = _njC0M8dl;
        "pkg-0.7.7.3-1.21.6-1.21.8" = _Q8eQkhX2;
        "pkg-0.7.7.3-1.21.11" = _FTXrHdNP;
        "pkg-0.7.7.3-26.1" = _86s6YEe4;
        "pkg-0.7.7.3-26.2-sp-3" = _uonxFxsW;
        "pkg-0.7.8-26.1" = _YaVooAp0;
        "pkg-0.7.8-26.2-sp-4" = _5KjTUehr;
        "pkg-0.7.8-1.21.11" = _C7AI9xBh;
        "pkg-0.7.8.1-26.2-sp-4" = _g3gCTQ6j;
        "pkg-0.8.0-26.1" = _ac9ylHcQ;
        "pkg-0.8.0-26.2-sp-4" = _iPZhYsVB;
        "pkg-0.8.0-26.2-sp-5" = _MVUJJAVH;
        "pkg-0.8.1-26.2-sp-5" = _76TPEk5c;
        "pkg-0.8.1-26.1" = _INuM2yqc;
        "pkg-0.8.1-1.21.11" = _LvGiBe1o;
        "pkg-0.8.2-26.2-sp-5" = _AZd9abI6;
        "pkg-0.8.2-26.1" = _iJqKK0if;
        "pkg-0.8.3-26.1" = _22zipcX4;
        "pkg-0.8.3-26.2-sp-5" = _cqzy3f8h;
        "pkg-0.8.0-1.21.4" = _J2TMdMbu;
        "pkg-0.8.0.1-1.21.4" = _vADMc9Z6;
        "pkg-0.8.0.2-1.21.4" = _DXZeOPJm;
        "pkg-0.8.4-26.2-sp-5" = _BwweAT3O;
        "pkg-0.8.5-26.2-sp-5" = _Hgrqggvt;
        "pkg-0.8.5-26.1" = _t4Q7bxxe;
        "pkg-0.8.5-1.21.11" = _a9PrVdQG;
        "pkg-0.8.5.1-26.1" = _oNyPossK;
        "pkg-0.9.0-26.1" = _S09Iteh8;
        "pkg-0.9.0-26.2-sp-5" = _LW84jXtG;
        "pkg-0.9.0-1.21.11" = _O46gueM5;
        "pkg-0.9.0-1.21.6-1.21.8" = _6LCm8iB6;
        "pkg-0.9.1-26.2-sp-5" = _ICOSnpHM;
        "pkg-0.9.2-26.2-sp-5" = _t0FH5qoh;
        "pkg-0.9.2-26.1" = _FCtBLyLC;
        "pkg-0.9.3-26.1" = _sgTfMuRa;
