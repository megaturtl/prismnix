...
let
    ...
    in {
        ...
        "pkg-2.6.1" = _z3kGZ8ga;
        "pkg-2.6.1-b31" = _J8iHQ7O2;
        "pkg-2.6.1-b32" = _AVUF1bN3;
        "pkg-2.6.1-b33" = _t8MX6sol;
        "pkg-2.6.1-b35" = _ZwXAci8d;
        "pkg-2.6.1-b37" = _GKUbbskU;
        "pkg-2.6.1-b38" = _MTQDAcqD;
        "pkg-2.6.1-b39" = _V0hhxsKI;
        "pkg-2.6.2-b42" = _UZja2n35;
        "pkg-2.6.2" = _k2iG92Ke;
        "pkg-2.6.2-b43" = _8VTIoPyk;
        "pkg-2.6.2-b44" = _rR6zedy3;
        "pkg-2.6.2-b45" = _W3ixQTLq;
        "pkg-2.6.2-b46" = _RzjbLcbD;
        "pkg-2.6.2-b47" = _STPYmOEb;
        "pkg-2.6.2-b48" = _p6q3o9wK;
        "pkg-2.6.2-b51" = _CxrLFe63;
        "pkg-2.6.3-b54" = _WXhZZwPk;
        "pkg-2.6.3" = _SOWlSaAJ;
        "pkg-2.6.3-b55" = _5OrLdvAu;
        "pkg-2.6.3-b56" = _AWitexJB;
        "pkg-2.6.3-b58" = _llw6WWAC;
        "pkg-2.6.3-b63" = _m4w9qimJ;
        "pkg-2.6.3-b65" = _QLznevNy;
        "pkg-2.6.4" = _ejuk4PB3;
        "pkg-2.6.4-b67" = _DMtpF7TA;
        "pkg-2.6.4-b68" = _tWKiQRE2;
        "pkg-2.6.4-b71" = _aoaVzZUB;
        "pkg-2.6.4-b72" = _ljEibcGZ;
        "pkg-2.6.4-b73" = _KAHGzczO;
        "pkg-2.6.4-b76" = _3MH9BX1a;
        "pkg-2.6.4-b77" = _HB5YkPh3;
        "pkg-2.6.4-b79" = _JJMgOFRx;
        "pkg-2.6.5" = _R1RJAQtI;
        "pkg-2.6.5-b81" = _QjQX9BaA;
        "pkg-2.6.5-b82" = _onXcui0T;
        "pkg-2.6.5-b83" = _1ns2nQbE;
        "pkg-2.6.5-b84" = _T0mHXcr7;
        "pkg-2.6.5-b86" = _ERRiNr6j;
        "pkg-2.6.5-b87" = _NAi1uMIR;
        "pkg-2.6.6" = _I2dWLciW;
        "pkg-2.6.6-b94" = _HAJtWVki;
        "pkg-2.6.6-b95" = _jUnsKWS4;
        "pkg-2.6.6-b96" = _rvupiyXd;
        "pkg-2.6.6-b97" = _fFsgyRmI;
        "pkg-2.6.6-b99" = _OdJ2DDWg;
        "pkg-2.6.6-b100" = _p3EtYhbI;
        "pkg-2.6.6-b101" = _TuGLKiol;
        "pkg-2.6.7-b102" = _Czrh9uJd;
        "pkg-2.6.7" = _SZaYJExZ;
        "pkg-2.6.7-b104" = _9c371U53;
        "pkg-2.6.7-b105" = _oFRHVfZm;
        "pkg-2.6.7-b106" = _VgoH4u34;
        "pkg-2.6.7-b107" = _6SJDHEOE;
        "pkg-2.6.7-b110" = _VawqbFPX;
        "pkg-2.6.8" = _XTqL267w;
        "pkg-2.6.8-formattest-b113" = _wGSZyleg;
        "pkg-2.6.8-b116" = _sY9MPORP;
        "pkg-2.6.8-b118" = _EhWTdmIw;
        "pkg-2.6.8-b119" = _ebKz7Jo5;
        "pkg-2.6.8-b120" = _HRy29TdE;
        "pkg-2.6.8-b122" = _XvnizDUI;
        "pkg-2.6.8-b124" = _TcBAMPML;
        "pkg-2.6.8-b126" = _9VocqBlL;
        "pkg-2.6.8-b127" = _hhf6CJxl;
        "pkg-2.6.8-b128" = _xlO0X5vL;
        "pkg-2.6.8-b129" = _HWcihnZD;
        "pkg-2.6.8-b130" = _c40Y5T07;
        "pkg-2.6.8-b132" = _qOM8hUqT;
        "pkg-2.7.0" = _tTwMIWHQ;
        "pkg-2.7.0-b135" = _g4Fpee8n;
        "pkg-2.7.0-b137" = _nKvOXNNm;
        "pkg-2.7.0-b138" = _eYEeyO2I;
        "pkg-2.7.0-b139" = _43htG4AW;
        "pkg-2.7.0-b140" = _3jaPTURU;
        "pkg-2.7.0-b141" = _dWjseYw8;
        "pkg-2.7.0-b142" = _wxUxQgVx;
        "pkg-2.7.0-b145" = _M4hpgT4h;
        "pkg-2.7.0-b147" = _1UBFCqpw;
        "pkg-2.7.0-b148" = _oxOsUFk2;
        "pkg-2.7.0-b149" = _94I1UrlB;
        "pkg-2.7.0-b153" = _fENfslZl;
        "pkg-2.7.0-b154" = _2GyUShzs;
        "pkg-2.7.0-b155" = _5SK8HgKF;
        "pkg-2.7.0-b156" = _9yVBaP3L;
        "pkg-2.7.0-b157" = _hrn6ZDcb;
        "pkg-2.7.0-b159" = _zjMsIMxZ;
        "pkg-2.7.0-b160" = _koFAzJfk;
        "pkg-2.7.0-b162" = _IqPiVgBM;
        "pkg-2.7.0-b163" = _bR1fGDvF;
        "pkg-2.7.0-b165" = _I79XKrQu;
        "pkg-2.7.0-b166" = _ZMjrDx6v;
        "pkg-2.7.0-b167" = _v8stltgY;
        "pkg-2.7.0-b168" = _N0AXUYkN;
        "pkg-2.7.0-b169" = _jLYuvSkn;
        "pkg-2.7.0-b172" = _UMnAMos0;
        "pkg-2.7.0-b174" = _FCxFmbBf;
        "pkg-2.7.0-b176" = _B9a4qcI5;
        "pkg-2.7.0-b178" = _sJ3hiimV;
        "pkg-2.7.0-b179" = _dZIAZcB3;
        "pkg-2.7.0-b180" = _ZecplXq1;
        "pkg-2.7.0-b181" = _xx0Rk6Tj;
        "pkg-2.8.0" = _uQMf32yW;
        "pkg-2.8.0-b184" = _P6HjBFXG;
        "pkg-2.8.0-b185" = _mqEsUkrR;
        "pkg-2.8.0-b186" = _ptMkGDuc;
        "pkg-2.8.0-b187" = _7OvhnsqB;
        "pkg-2.8.0-b188" = _komeU2t4;
        "pkg-2.8.0-b189" = _k1xPiQwg;
        "pkg-2.8.0-b190" = _EOoTRiwP;
        "pkg-2.8.0-b191" = _6hNCZCJ9;
        "pkg-2.8.0-b192" = _LD6rUQ1e;
        "pkg-2.8.0-b193" = _cXzFWJU6;
        "pkg-2.8.0-b195" = _4huYNYPo;
        "pkg-2.8.0-b197" = _H4iyttOB;
        "pkg-2.8.0-b198" = _EJ3AthLu;
        "pkg-2.8.0-b202" = _CQlOXhhn;
        "pkg-2.8.0-b203" = _2SocX0ji;
        "pkg-2.8.0-b204" = _3g5LjeOE;
        "pkg-2.8.0-b205" = _tDH1wmfV;
        "pkg-2.8.0-b206" = _907VYYNF;
        "pkg-2.8.0-b207" = _AAoHCGsR;
        "pkg-2.8.0-b209" = _rMLvolkM;
        "pkg-2.8.0-b210" = _lW4xNPb2;
        "pkg-2.8.0-b211" = _RW8UFgem;
        "pkg-2.8.0-b212" = _vI1uWQLT;
        "pkg-2.8.0-b213" = _5i8ydssL;
        "pkg-2.8.0-b214" = _o7v8l2uO;
        "pkg-2.8.0-b215" = _bC8v2rcy;
        "pkg-2.8.0-b217" = _QTmDsgBh;
        "pkg-2.8.0-b219" = _YaZHVZbc;
        "pkg-2.8.0-b221" = _bcuylENq;
        "pkg-2.8.0-b223" = _oAILj0vl;
        "pkg-2.8.0-b225" = _Xc7CXki7;
        "pkg-2.8.0-b226" = _HJTb3MNF;
        "pkg-2.9.0-b227" = _Y7VIkxVx;
        "pkg-2.9.0" = _vnRMWhm2;
        "pkg-2.9.0-b228" = _STTWWlrf;
        "pkg-2.9.0-b229" = _qrHBMdl0;
        "pkg-2.9.0-b230" = _jW0O6FDO;
        "pkg-2.9.0-b231" = _bBkatHyf;
        "pkg-2.9.0-b233" = _G8nrBBgQ;
        "pkg-2.9.0-b234" = _rkm2Q3t2;
        "pkg-2.9.0-b241" = _L7vZpjWN;
        "pkg-2.9.0-b242" = _wIVjK7t9;
        "pkg-2.9.0-b243" = _FYUeGkzl;
        "pkg-2.9.0-b245" = _hbuBQ4e1;
        "pkg-2.9.0-b246" = _QEsxTjt3;
        "pkg-2.9.0-b247" = _JFscYO7q;
        "pkg-2.9.0-b248" = _PllZYK1B;
        "pkg-2.9.0-b249" = _aWnTi7Gc;
        "pkg-2.9.0-b250" = _UlPsizMi;
        "pkg-2.9.0-b251" = _OD4m9DOM;
        "pkg-2.9.0-b252" = _v17QhsQf;
        "pkg-2.10.0-b253" = _95PWfRO4;
        "pkg-2.10.0" = _a21Ko1Gk;
        "pkg-2.10.0-b254" = _4fY62Dx4;
        "pkg-2.10.0-b255" = _XWDSaWbH;
        "pkg-2.10.0-b256" = _VEb9q7Ke;
        "pkg-2.10.0-b257" = _xpJ0TssJ;
        "pkg-2.10.1-b258" = _b67u3O83;
        "pkg-2.10.1" = _2syhBKNu;
        "pkg-2.10.1-b259" = _2v90AKWW;
        "pkg-2.10.1-b260" = _nzKYrCOE;
        "pkg-2.10.1-b261" = _ZyyaZB9B;
        "pkg-2.10.1-b262" = _FlnvamFP;
        "pkg-2.10.1-b263" = _ibv9IDU8;
        "pkg-2.10.1-b264" = _QzteXBzm;
        "pkg-2.10.1-b265" = _hF32KpBY;
        "pkg-2.10.1-b266" = _M9YbAE04;
        "pkg-2.10.1-b267" = _Hyhyyxdc;
        "pkg-2.10.1-b269" = _15KN10xl;
        "pkg-2.10.1-b270" = _SyYLMcqV;
        "pkg-2.10.1-b271" = _Cb1Zwwbe;
        "pkg-2.10.1-b272" = _HHP2F2Wa;
        "pkg-2.10.1-b273" = _rWQKcWtT;
        "pkg-2.10.1-b275" = _MSjc6mgk;
        "pkg-2.10.1-b276" = _BznHUU9m;
        "pkg-2.10.1-b277" = _cHzc3AOJ;
        "pkg-2.10.1-b279" = _sWEvpLfX;
        "pkg-2.10.1-b281" = _HV8qSvuP;
        "pkg-2.10.1-b282" = _5UxrPp8m;
        "pkg-2.10.1-b284" = _g1aByCLm;
        "pkg-2.10.1-b285" = _LdJvZCC2;
        "pkg-2.10.1-b286" = _bdgFwCEc;
        "pkg-2.10.1-b287" = _vPXdFt63;
        "pkg-2.10.1-b288" = _LzCTu1Dp;
        "pkg-2.10.1-b289" = _2iJpejmR;
        "pkg-2.10.1-b290" = _igRfyxsY;
        "pkg-2.10.1-b291" = _rPbqUzPK;
        "pkg-2.10.1-b292" = _tIakCq4J;
        "pkg-2.10.1-b293" = _KodQrhlA;
        "pkg-2.10.1-b294" = _OP4LOCiw;
        "pkg-2.10.1-b295" = _Ij8uUMPu;
        "pkg-2.10.1-b296" = _aFwkDLzb;
        "pkg-2.10.1-b297" = _fHQPtiLK;
        "pkg-2.10.1-b298" = _ygGmzf5X;
        "pkg-2.10.1-b299" = _bZjbRdc3;
        "pkg-2.10.1-b300" = _SrUQ3E8z;
        "pkg-2.10.1-b301" = _OtixAyax;
        "pkg-2.10.1-b302" = _tSfuUIi7;
        "pkg-2.10.1-b303" = _qYDOIRbY;
        "pkg-2.10.1-b304" = _ACExWwVz;
        "pkg-2.10.1-b305" = _F2FdJ5X1;
        "pkg-2.10.1-b307" = _MZnoOPFF;
        "pkg-2.10.1-b308" = _Ss2ymGHq;
        "pkg-2.10.1-b309" = _gL88x7GY;
        "pkg-2.10.1-b310" = _IIZ0tYN7;
        "pkg-2.10.1-b311" = _95ZD9s30;
        "pkg-2.10.1-b312" = _wXyoL1N2;
        "pkg-2.10.1-b313" = _4x7aKj2J;
        "pkg-2.10.1-b314" = _oYzCsJNL;
        "pkg-2.10.1-b315" = _EE7apAtL;
        "pkg-2.10.1-b316" = _ksRN00d6;
        "pkg-2.10.1-b317" = _YNjinTSn;
        "pkg-2.10.1-b318" = _mqSO3YPn;
        "pkg-2.10.1-b319" = _cYUnFvff;
        "pkg-2.10.1-b320" = _EwXm3Ds1;
        "pkg-2.10.1-b322" = _vjSC0s5D;
        "pkg-2.10.1-b323" = _KaLbIkCw;
        "pkg-2.10.1-b324" = _lU3jELWC;
        "pkg-2.10.1-b325" = _g4vHI8Xs;
        "pkg-2.10.1-b326" = _zzm1g8hJ;
        "pkg-2.11.0-b327" = _NZuGuj4j;
        "pkg-2.11.0" = _6nwpDKtA;
        "pkg-2.11.0-b328" = _F54MWhgp;
        "pkg-2.11.0-b329" = _HJ4NKXCj;
        "pkg-2.11.0-b330" = _vnwXEH9j;
        "pkg-2.11.0-b331" = _WvTcgTRo;
        "pkg-2.11.0-b332" = _VaiLGQKG;
        "pkg-2.11.0-b333" = _rA0nN8x6;
        "pkg-2.11.0-b334" = _LlYfFNtG;
        "pkg-2.11.0-b335" = _LwmuwyfE;
        "pkg-2.11.0-b336" = _MPPTtk9g;
        "pkg-2.11.0-b337" = _S7D9D1aZ;
        "pkg-2.11.0-b338" = _q9MMLgMs;
        "default" = _q9MMLgMs;
    });
