...
let
    versions = (let
        ...
        _fc1WCfDT = {
            "id" = "fc1WCfDT";
            "file" = "EffectMaster-1.5.0-beta9.jar";
            "hash" = "sha512-yIpeXXHiZTyaxLlwgoO/aWsPD9kwsWULuJ+/iinp4wW54rAyiY0aPp8zNuHF9+l9DNCwlz1BJquCCVbcM3mJww==";
        };
    in {
        "MWb0P4bh" = _MWb0P4bh;
        "5CwKybvh" = _5CwKybvh;
        ...
        "paper-1.20.5" = _fc1WCfDT;
        "paper-1.20.6" = _fc1WCfDT;
        "paper-1.21" = _fc1WCfDT;
        "paper-1.21.1" = _fc1WCfDT;
        "paper-1.21.2" = _fc1WCfDT;
        "paper-1.21.3" = _fc1WCfDT;
        "paper-1.21.4" = _fc1WCfDT;
        "paper-1.21.5" = _fc1WCfDT;
        "paper-1.21.6" = _fc1WCfDT;
        "paper-1.21.7" = _fc1WCfDT;
        "paper-1.21.8" = _fc1WCfDT;
        "paper-1.21.9" = _fc1WCfDT;
        "paper-1.21.10" = _fc1WCfDT;
        "paper-1.21.11" = _fc1WCfDT;
        "paper-26.1" = _fc1WCfDT;
        "paper-26.1.1" = _fc1WCfDT;
        "paper-26.1.2" = _fc1WCfDT;
        "paper-26.2" = _fc1WCfDT;
        ...
        "purpur-1.20.5" = _fc1WCfDT;
        "purpur-1.20.6" = _fc1WCfDT;
        "purpur-1.21" = _fc1WCfDT;
        "purpur-1.21.1" = _fc1WCfDT;
        "purpur-1.21.2" = _fc1WCfDT;
        "purpur-1.21.3" = _fc1WCfDT;
        "purpur-1.21.4" = _fc1WCfDT;
        "purpur-1.21.5" = _fc1WCfDT;
        "purpur-1.21.6" = _fc1WCfDT;
        "purpur-1.21.7" = _fc1WCfDT;
        "purpur-1.21.8" = _fc1WCfDT;
        "purpur-1.21.9" = _fc1WCfDT;
        "purpur-1.21.10" = _fc1WCfDT;
        "purpur-1.21.11" = _fc1WCfDT;
        "purpur-26.1" = _fc1WCfDT;
        "purpur-26.1.1" = _fc1WCfDT;
        "purpur-26.1.2" = _fc1WCfDT;
        "purpur-26.2" = _fc1WCfDT;
        ...
        "pkg-1.4.8" = _m5ziaozE;
        "pkg-1.4.9" = _yV3kllgN;
        "pkg-1.5.0-beta1" = _xeQrT1av;
        "pkg-1.5.0-beta2" = _J0lfjMOX;
        "pkg-1.5.0-beta3" = _ZgOdiMli;
        "pkg-1.5.0-beta4" = _bmdVleFj;
        "pkg-1.5.0-beta5" = _E9vBpdwD;
        "pkg-1.5.0-beta6" = _DU8HYRnD;
        "pkg-1.5.0-beta7" = _6ubFOv6P;
        "pkg-1.5.0-beta8" = _O9MuFYpL;
        "pkg-1.5.0-beta9" = _fc1WCfDT;
        "default" = _fc1WCfDT;
    });
