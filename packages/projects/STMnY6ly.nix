...
let
    versions = (let
        ...
        _loczVEyR = {
            "id" = "loczVEyR";
            "file" = "GUI Revision Compats.zip";
            "hash" = "sha512-EpQj+TtSrIIkAeVo9kYPPCQYigwJVLA5A4GW9qL7S+51s2hIRJt8w1gkZx/qMbS9iZ3J/8DixV9FHUCgB8BHfQ==";
        };
        _gDBQYFE0 = {
            "id" = "gDBQYFE0";
            "file" = "GUI Revision Compats.zip";
            "hash" = "sha512-syMcXqWA8gkKu7hg7Z+3w8f/9Lw7MrjeTiq+5NrjMCJJSPtSOH1UzMcq9OR0uIjhOPGgH6D9lXHiV48VSjV7xw==";
        };
    in {
        "jUd6cqCa" = _jUd6cqCa;
        "Tc3o3yjH" = _Tc3o3yjH;
        ...
        "loczVEyR" = _loczVEyR;
        "gDBQYFE0" = _gDBQYFE0;
        "minecraft-1.20.1" = _gDBQYFE0;
        "minecraft-1.20" = _gDBQYFE0;
        "minecraft-1.20.2" = _gDBQYFE0;
        "minecraft-1.20.3" = _gDBQYFE0;
        "minecraft-1.20.4" = _gDBQYFE0;
        "minecraft-1.20.5" = _gDBQYFE0;
        "minecraft-1.20.6" = _gDBQYFE0;
        "minecraft-1.21" = _gDBQYFE0;
        "minecraft-1.21.1" = _gDBQYFE0;
        "minecraft-1.21.2" = _gDBQYFE0;
        "minecraft-1.21.3" = _gDBQYFE0;
        "minecraft-1.21.4" = _gDBQYFE0;
        "minecraft-1.21.5" = _gDBQYFE0;
        "minecraft-1.21.6" = _gDBQYFE0;
        "minecraft-1.21.7" = _gDBQYFE0;
        "minecraft-1.21.8" = _gDBQYFE0;
        "minecraft-1.21.9" = _gDBQYFE0;
        "minecraft-1.21.10" = _gDBQYFE0;
        "minecraft-1.21.11" = _gDBQYFE0;
        "minecraft-23w31a" = _gDBQYFE0;
        "minecraft-23w32a" = _gDBQYFE0;
        "minecraft-23w33a" = _gDBQYFE0;
        "minecraft-23w35a" = _gDBQYFE0;
        "minecraft-1.20.2-pre1" = _gDBQYFE0;
        "minecraft-23w42a" = _gDBQYFE0;
        "minecraft-23w43a" = _gDBQYFE0;
        "minecraft-23w43b" = _gDBQYFE0;
        "minecraft-23w44a" = _gDBQYFE0;
        "minecraft-23w45a" = _gDBQYFE0;
        "minecraft-23w46a" = _gDBQYFE0;
        "minecraft-24w03a" = _gDBQYFE0;
        "minecraft-24w03b" = _gDBQYFE0;
        "minecraft-24w04a" = _gDBQYFE0;
        "minecraft-24w05a" = _gDBQYFE0;
        "minecraft-24w05b" = _gDBQYFE0;
        "minecraft-24w06a" = _gDBQYFE0;
        "minecraft-24w07a" = _gDBQYFE0;
        "minecraft-24w09a" = _gDBQYFE0;
        "minecraft-24w10a" = _gDBQYFE0;
        "minecraft-24w11a" = _gDBQYFE0;
        "minecraft-24w12a" = _gDBQYFE0;
        "minecraft-24w13a" = _gDBQYFE0;
        "minecraft-24w14potato" = _gDBQYFE0;
        "minecraft-24w14a" = _gDBQYFE0;
        "minecraft-1.20.5-pre1" = _gDBQYFE0;
        "minecraft-1.20.5-pre2" = _gDBQYFE0;
        "minecraft-1.20.5-pre3" = _gDBQYFE0;
        "minecraft-24w18a" = _gDBQYFE0;
        "minecraft-24w19a" = _gDBQYFE0;
        "minecraft-24w19b" = _gDBQYFE0;
        "minecraft-24w20a" = _gDBQYFE0;
        "minecraft-24w33a" = _gDBQYFE0;
        "minecraft-24w34a" = _gDBQYFE0;
        "minecraft-24w35a" = _gDBQYFE0;
        "minecraft-24w36a" = _gDBQYFE0;
        "minecraft-24w37a" = _gDBQYFE0;
        "minecraft-24w38a" = _gDBQYFE0;
        "minecraft-24w39a" = _gDBQYFE0;
        "minecraft-24w40a" = _gDBQYFE0;
        "minecraft-1.21.2-pre1" = _gDBQYFE0;
        "minecraft-1.21.2-pre2" = _gDBQYFE0;
        "minecraft-24w44a" = _gDBQYFE0;
        "minecraft-24w45a" = _gDBQYFE0;
        "minecraft-24w46a" = _gDBQYFE0;
        "minecraft-26.1" = _gDBQYFE0;
        "minecraft-26.1.1" = _gDBQYFE0;
        "minecraft-26.1.2" = _gDBQYFE0;
        "minecraft-26.2" = _gDBQYFE0;
