...
let
    ...
    in {
        ...
        "pkg-1.1.3.2" = _aDML2SNT;
        "pkg-1.1.3.3" = _j2aVrzym;
        "pkg-1.1.3.4" = _82RPP9Le;
        "pkg-1.1.3.5" = _EpliMwYQ;
        "pkg-1.2.0Beta" = _Fy7S2tD8;
        "pkg-1.2.0" = _ECGr0U7t;
        "pkg-1.2.0.1" = _nRUpGCNp;
        "pkg-1.3.0-alpha" = _MpEPERJB;
        "pkg-1.3.0-Beta" = _SUNY2Rkr;
        "pkg-1.3.0" = _Wv9naNJP;
        "pkg-1.3.1-beta" = _1cW59XxL;
        "pkg-1.3.1" = _rly75xOI;
        "pkg-1.3.1.1" = _pml2TbRq;
        "pkg-1.3.2" = _8ZGJBemQ;
        "pkg-1.3.2.1" = _MFQ4bHth;
        "pkg-1.4.0_beta" = _sPO9qfDE;
        "pkg-1.4.0.1" = _upqZkExv;
        "pkg-5.1.0" = _RpfmVc4G;
        "pkg-5.2.0" = _uqkAv92F;
        "pkg-6.0.0-beta.1" = _2f92tVvk;
        "pkg-6.0.0-beta.2" = _kcaVxXfI;
        "pkg-6.0.0-beta.3" = _QJXbgYMD;
        "pkg-6.0.0-beta.4" = _ReRMYcMO;
        "pkg-6.0.0-beta.5" = _lLnGIcks;
        "pkg-6.0.0" = _fRbiDPEZ;
        "pkg-6.0.1" = _3Nkeo1uX;
        "pkg-6.1.0" = _XtpsXs4n;
        "pkg-6.1.1" = _dQJV8xIV;
        "pkg-7.0.0-beta.2" = _klb3tq7l;
