...
let
    versions = (let
        ...
        _MSU52aOC = {
            "id" = "MSU52aOC";
            "file" = "easy_mob_farm-forge-1.20.1-10.12.0.jar";
            "hash" = "sha512-Mx4EXYKEGS+R3slvkbUEBuDRzZ7mL7IaxsZLPNEZy79Yv5vSZcYUFFnkyDha/Sprm6JD02cTIM06ZwFcYnQ6bg==";
        };
        _aYVxbaUz = {
            "id" = "aYVxbaUz";
            "file" = "easy_mob_farm-fabric-1.20.1-10.12.0.jar";
            "hash" = "sha512-X2R6ugLTn6x8r/MNI9gj6IAcUEhZT7uaLea0+c/WcZxjrismIrT95wkQZZjlJsvDiyiXrBPSs/rVpuSbMGsbZg==";
        };
        _vTMvI5In = {
            "id" = "vTMvI5In";
            "file" = "easy_mob_farm-forge-1.21.1-10.12.0.jar";
            "hash" = "sha512-hoAsxZVFD7rDa8TotWrW5YHGFkA7JN55QmKi8rj1nL5Og+98vvSbjreR1c0f3nAO16MyTb0pCeUzL1+kVdIfaA==";
        };
        _EUHqff16 = {
            "id" = "EUHqff16";
            "file" = "easy_mob_farm-neoforge-1.21.1-10.12.0.jar";
            "hash" = "sha512-PXAIVHkX/69UL1sn9Vvt/FA5ZibDifZlG41ZiBO7zbPPvR0ial+HPaQrEKQi8n4/qum7XGg0/g/pWbeCiZP94w==";
        };
        _j2IR7f9l = {
            "id" = "j2IR7f9l";
            "file" = "easy_mob_farm-fabric-1.21.1-10.12.0.jar";
            "hash" = "sha512-hztH86ggzbOlXg/RQ6f4gctUxgf3W19LgpYf9tHTlbO9MYHa4qswlc6muPVPl1/MzD4UiFT6ujDMm2iYVZGI7Q==";
        };
        _hIe2U8uc = {
            "id" = "hIe2U8uc";
            "file" = "easy_mob_farm-neoforge-1.21.11-10.12.0.jar";
            "hash" = "sha512-5kLyRRrxAQxNaAHFsd0H418pWQbYTf5fhPbR85AU2G98DE0K3KnfVppZfiJwM/pmXcFs/8CJ9yXuK++6YayXig==";
        };
        _mncpQwlN = {
            "id" = "mncpQwlN";
            "file" = "easy_mob_farm-fabric-1.21.11-10.12.0.jar";
            "hash" = "sha512-EMunsiCKni5ut1wjKG8uRdnWTaKTPxLRP58XQwd5nR/P4qjpb7mdy2j7765F9fRDlNjiF+xtxnvnk6zBk+pkTQ==";
        };
        _QXYiV82W = {
            "id" = "QXYiV82W";
            "file" = "easy_mob_farm-forge-1.21.11-10.12.0.jar";
            "hash" = "sha512-fPKCnKfaBl5nJQD6kCBv7ENVvGHL5PdK+sPPrHxRt6KV0lZALxHWz2LNdaVAaFvuLouVbk8sHWdGbJ547TTDlw==";
        };
        _h9kFUWmH = {
            "id" = "h9kFUWmH";
            "file" = "easy_mob_farm-neoforge-26.1.2-10.12.0.jar";
            "hash" = "sha512-SE73w11WmmaZrIkEPNZ0kpDUNTzHgz63Y5ZxiZi1hWAeFUZFzbyA6wajqT61wNrnOoEDE0L++vWsqTTpFOhcQA==";
        };
        _ozjDoYa6 = {
            "id" = "ozjDoYa6";
            "file" = "easy_mob_farm-fabric-26.1.2-10.12.0.jar";
            "hash" = "sha512-wgvrUq/Isft/IdQrcqhEYbPDiYkvUkyWwhmV1oTpsuqUE10ZhHAPZ56WZON3pJUwNfa/YoZqnTdgDr7s5rnQeg==";
        };
        _qDfXq7WE = {
            "id" = "qDfXq7WE";
            "file" = "easy_mob_farm-forge-26.1.2-10.12.0.jar";
            "hash" = "sha512-vOvw532N2f2iVghB6fzm/QVvFzFIs0jb1VrOuztR5WKU3PiiV9n0uoAmakBsrgKNDXQ6+3St0efkE8xZ5Fr5jA==";
        };
        _ktMPfJ0d = {
            "id" = "ktMPfJ0d";
            "file" = "easy_mob_farm-forge-26.2-10.12.0.jar";
            "hash" = "sha512-m9mJqt1tKobL/19wCEF80aaxOgxPjOD5Sb7eSoj9PlaqSeJmwZrVZmz5bAkqjF9TKT5aU67upbJ/4REIdv4shw==";
        };
        _YulZVlSY = {
            "id" = "YulZVlSY";
            "file" = "easy_mob_farm-neoforge-26.2-10.12.0.jar";
            "hash" = "sha512-3z+1LxRKtzU1QhRa24nAfbNL224PuT6QdIhhWUrWOcW4Swc0BHYzYYiVLPwS38IIKYPuiCAbUN34c8Ylq98u9A==";
        };
        _N0fPyxIh = {
            "id" = "N0fPyxIh";
            "file" = "easy_mob_farm-fabric-26.2-10.12.0.jar";
            "hash" = "sha512-1gGeKpKBJhrpz3jkr++HXvifIAYamgxo1YThw6EMou2QtibHC7TMyUs+Dbfxchwt1OpAHRFXrdXMm0uUWqrTig==";
        };
        _VM6h0tnM = {
            "id" = "VM6h0tnM";
            "file" = "easy_mob_farm-fabric-1.20.1-10.13.0.jar";
            "hash" = "sha512-mi97pQoHl4Nt1kMmeuHYB08l2AzHmVPkG2RIbS0S0mKhKPyLL2Y1GmyL0o0lqUKLLHGuStd8XhdgtwtJKaRLmQ==";
        };
        _K2ZFHNoL = {
            "id" = "K2ZFHNoL";
            "file" = "easy_mob_farm-forge-1.20.1-10.13.0.jar";
            "hash" = "sha512-OWrXlG1dGenyzJIKkc690q6EVjkbINM2du2qDoPub+7bWei7rNWoi/qKGNHhb5AYLE3+ExJrvI5jYJgcjtniDw==";
        };
        _2jQYNsZu = {
            "id" = "2jQYNsZu";
            "file" = "easy_mob_farm-forge-1.21.1-10.13.0.jar";
            "hash" = "sha512-J0gu34W2lsVFxza7f52rxxwReObCeVZP6R++mNwgR8RKZF/DUxsHvCd3+uTezKHml/pdKE058Eqsb0Zpp++lnQ==";
        };
        _qNtvTLD6 = {
            "id" = "qNtvTLD6";
            "file" = "easy_mob_farm-neoforge-1.21.1-10.13.0.jar";
            "hash" = "sha512-GSMCR/zunNOY9Mn9n5zKuXUKSZ39Metydne028FYeoobfjR+k7uhPzpEzr2/M0ulKU+5U5CjnlsuXNt119jdeA==";
        };
        _SXTQ11GY = {
            "id" = "SXTQ11GY";
            "file" = "easy_mob_farm-fabric-1.21.1-10.13.0.jar";
            "hash" = "sha512-ENFgPX56u3u//idh94vyS2N0NXvw+EmCtzrxR2Sv7oV3uYoqPTf64MqVmATN2b66dAgRVNIhfqZQHmIs2DWY/g==";
        };
        _GnCsl2Ru = {
            "id" = "GnCsl2Ru";
            "file" = "easy_mob_farm-neoforge-1.21.11-10.13.0.jar";
            "hash" = "sha512-pwTtMrEutCg8CKtM6M7L+GAXS6yqPg5Xc/ZnwNGrROeuAxp4Z2jJc+DRvuG+VFkd7u66u8j0D4iYXNFTj2/xoQ==";
        };
        _wgLwxd7z = {
            "id" = "wgLwxd7z";
            "file" = "easy_mob_farm-forge-1.21.11-10.13.0.jar";
            "hash" = "sha512-AuZDSERgYKxdVLRqqYilOaAjhyH0XPIHSDIt9QR/ml2r2mssKUfe7Y9Dq5cLv+ULCj5cs3dDGCQuRkKxLTIzGQ==";
        };
        _JW5wIlyE = {
            "id" = "JW5wIlyE";
            "file" = "easy_mob_farm-fabric-1.21.11-10.13.0.jar";
            "hash" = "sha512-SLcOqmfEP26ttdhmVGEVKBNf6n5sEc78aal+GRtyx8xMEp0S22EjxPeF+gvlgMhuWdNynMYyCiC8gwrnKInWZQ==";
        };
        _nwjZaeHH = {
            "id" = "nwjZaeHH";
            "file" = "easy_mob_farm-forge-26.1.2-10.13.0.jar";
            "hash" = "sha512-stvJrEEhGA6/jsHq0mclBVcN22Hc9EGqK+yWik3wKX7hptIkzqqKvZLfryiiC3KtIWafQnVwPkJyue0qJOkEPA==";
        };
        _QvGxjs7e = {
            "id" = "QvGxjs7e";
            "file" = "easy_mob_farm-neoforge-26.1.2-10.13.0.jar";
            "hash" = "sha512-SJbAdY1EY0nDOoaYP+bUhawQuAxeZH0cDsAdfy+RJejrCT8zPAdG8CdcG42wsWmKQt//V4FEd0Ecjnr2HpU04g==";
        };
        _mDnpJ1sN = {
            "id" = "mDnpJ1sN";
            "file" = "easy_mob_farm-fabric-26.1.2-10.13.0.jar";
            "hash" = "sha512-tdjBm2Yj9nicfRvLHq5SaqINkxLRJu8qqszYkgAOmWtg40kbe6nUUBSsGw87wD1CEwqmeDgpZLf+D56veRNnvw==";
        };
        _Pb6ZeGyr = {
            "id" = "Pb6ZeGyr";
            "file" = "easy_mob_farm-neoforge-26.2-10.13.0.jar";
            "hash" = "sha512-SuXRitTKro/xR2B3hQxbFjB2pnr9ljrSMFLMDrJw45RGlk/NxODosa0bSE8WgcxSiu0nxM0ra+NvG8food3bsg==";
        };
        _GD0J1fgC = {
            "id" = "GD0J1fgC";
            "file" = "easy_mob_farm-fabric-26.2-10.13.0.jar";
            "hash" = "sha512-ty8QJUXLSSabetOfgU1OdUl5UYFUuTD7xsPS+DTwhZnRd/MrmZfhC2xWHXM4ZxX5ffUNaMPVZ9eApOkcTquO1Q==";
        };
        _7vVelSWN = {
            "id" = "7vVelSWN";
    ...
    in {
        ...
        "pkg-8.9.1" = _ZyHIw4W7;
        "pkg-8.9.2" = _evx6sX9p;
        "pkg-8.10.0" = _iV8jwhRn;
        "pkg-8.10.1" = _nICziftX;
        "pkg-9.0.0" = _4eoEbtHI;
        "pkg-9.1.0" = _9DuSzME8;
        "pkg-8.11.0" = _gjwtr84F;
        "pkg-9.2.0" = _tMZv1zvc;
        "pkg-9.3.0" = _AogckI76;
        "pkg-9.4.0" = _I6J6CGx7;
        "pkg-9.5.0" = _uncgH6bP;
        ...
        "pkg-9.7.1" = _DdaLvm7I;
        "pkg-9.8.0" = _oiSeNdNs;
        "pkg-10.0.0" = _MZkMqufl;
        "pkg-10.0.1" = _VKtbpR71;
        "pkg-10.2.0" = _RSMONtx5;
        "pkg-10.2.1" = _39jMKd7g;
        "pkg-10.2.2" = _mQO8nfJU;
        "pkg-10.3.0" = _S9AuzUGg;
        "pkg-10.4.0" = _c6EdFxog;
        "pkg-10.5.0" = _hQDLYdUQ;
        "pkg-10.6.0" = _NnrF3ulA;
        "pkg-10.6.1" = _gnYS34Ff;
        "pkg-10.7.0" = _5BH0PmUR;
        "pkg-10.8.0" = _fkgJm8qI;
        "pkg-10.9.0" = _B92J0J91;
        "pkg-10.9.1" = _RbFhdE3c;
        "pkg-10.10.0" = _H4Wy5T1x;
        "pkg-10.10.1" = _4akOYQUf;
