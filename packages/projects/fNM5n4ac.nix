...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.2" = _U0ZP6Phi;
        "pkg-1.20.1-1.2" = _UWL2pbPo;
        "pkg-1.18.2-1.3" = _nO19XmQz;
        "pkg-1.20.1-1.3" = _3MYUpcbg;
        "pkg-1.18.2-1.4" = _EvwSQAKs;
        "pkg-1.20.1-1.4" = _w0qn6SA1;
        "pkg-1.18.2-1.5" = _m6AdgC6D;
        "pkg-1.20.1-1.5" = _ea2zsq4k;
        "pkg-1.18.2-1.6" = _46FRws49;
        "pkg-1.20.1-1.6" = _pWXmpubT;
        "pkg-1.20.1-1.7" = _YWj0pvXm;
        "pkg-1.20.1-1.7.1" = _6RnMYoat;
        "pkg-1.18.2-1.8" = _VysUNAbU;
        "pkg-1.20.1-1.8" = _kSn79g7f;
        "pkg-1.18.2-1.9" = _6Ze7HAHj;
        "pkg-1.20.1-1.9" = _jl8cpRfS;
        "pkg-1.20.1-2.0" = _bPN6Gm0K;
        "pkg-1.18.2-2.1" = _WIcaMNkP;
        "pkg-1.20.1-2.1" = _h8kzepMB;
        "pkg-1.18.2-2.1.1" = _963G6fbc;
        "pkg-1.20.1-2.1.1" = _leydFPZl;
        "pkg-1.20.1-2.2" = _y5fPMU4e;
        "pkg-1.20.1-2.3" = _3marbp9b;
        "pkg-2.4" = _HxNWkOPj;
        "pkg-2.4.1" = _pABQazJL;
        "pkg-2.5" = _n8nrAEHC;
        "pkg-2.6" = _73IHy5xe;
