...
let
    ...
    in {
        ...
        "pkg-1.1.9-fabric" = _3KRRxQ1o;
        "pkg-1.2.0-fabric" = _aArSbUMP;
        "pkg-1.2.1-fabric" = _JUNOySEC;
        "pkg-1.2.2-fabric" = _PwMABWY9;
        "pkg-1.2.3-fabric" = _2UA7WvqO;
        "pkg-1.2.4-fabric" = _3jnh0RdQ;
        "pkg-1.2.5-fabric" = _kMheOI5g;
        "pkg-1.2.6-fabric" = _hsPGHulD;
        "pkg-1.20.1-1.2.6-fabric" = _iCWSgd5Q;
        "pkg-1.19.2-1.2.6-fabric" = _c3w1t3fU;
        "pkg-1.18.2-1.2.6-fabric" = _aCrU3dV0;
        "pkg-1.16.5-1.2.6-fabric" = _Rm3ODn59;
        "pkg-1.2.7-fabric" = _1hu3kkV0;
        "pkg-1.20.1-1.2.7-fabric" = _QwBqRmQ3;
        "pkg-1.16.5-1.2.8-fabric" = _Knpa8WQg;
        "pkg-1.18.2-1.2.8-fabric" = _y69rRVCG;
        "pkg-1.19.2-1.2.8-fabric" = _I2coYi2o;
        "pkg-1.20.1-1.2.8-fabric" = _L2HOKlCc;
        "pkg-1.2.8-fabric" = _ocoDnbae;
        "pkg-1.16.5-1.2.8-fix.1-fabric" = _pWGFfxhr;
        "pkg-1.2.9-fabric" = _Fu0gk3Ek;
        "pkg-1.3.0-fabric" = _UJC0JTGQ;
        "pkg-1.3.1-fabric" = _8dir63JK;
        "pkg-1.3.2-fabric" = _RBq4N98v;
        "pkg-1.3.3-fabric" = _3l0bLBrD;
        "pkg-1.18.2-1.2.8-mpl3-fabric" = _AbLoenbT;
        "pkg-1.18.2-1.2.9-fabric" = _UTeGbFUZ;
        "pkg-1.3.4-fabric" = _kPsGsZkl;
        "pkg-1.20.1-1.2.9-fabric" = _MTwZb5Hh;
        "pkg-1.3.6-fabric" = _aYDrQqCi;
        "pkg-1.3.7-fabric" = _xR8HsK26;
