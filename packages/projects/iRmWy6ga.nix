...
let
    versions = (let
        ...
        _dqAZDndt = {
            "id" = "dqAZDndt";
            "file" = "pipez-neoforge-1.2.32+26.2.jar";
            "hash" = "sha512-EFcF2Wk0DPWOXz/NEtiFqrWqx78pMp8NwT91/z3b1xCSfqtWg5zrHD/M1If0rX9WgGzRzVA18K6G9kvWnKQKJA==";
        };
    in {
        "aC3cJ0fh" = _aC3cJ0fh;
        "6yc5cqZw" = _6yc5cqZw;
        ...
        "pkg-forge-1.19-1.0.6" = _kw04LbVp;
        "pkg-forge-1.19.1-1.0.0" = _SOahOqbQ;
        "pkg-forge-1.19.2-1.0.0" = _GVLDDdFo;
        "pkg-forge-1.19.2-1.0.1" = _upYAiTBs;
        "pkg-forge-1.19.3-1.0.1" = _ckGVJofr;
        "pkg-forge-1.19.3-1.0.2" = _SObtpWjU;
        "pkg-forge-1.19.3-1.0.3" = _k3iwaGkl;
        "pkg-forge-1.19.4-1.0.3" = _DwzhRar9;
        "pkg-forge-1.19.2-1.1.0" = _bTP0Gcr2;
        "pkg-forge-1.19.4-1.1.0" = _vsQE1wOP;
        "pkg-forge-1.19.4-1.1.1" = _cyEh972U;
        "pkg-forge-1.20-1.1.1" = _cIaZ9rRS;
        "pkg-forge-1.20.1-1.1.1" = _NN7UIB6w;
        "pkg-forge-1.19.2-1.1.2" = _yPOYhpoq;
        "pkg-forge-1.19.4-1.1.2" = _Za0xttH4;
        "pkg-forge-1.20.1-1.1.2" = _s0EI99bm;
        "pkg-forge-1.19.2-1.1.3" = _MAxDsge1;
        "pkg-forge-1.19.4-1.1.3" = _hfFRNG0S;
        "pkg-forge-1.20.1-1.1.3" = _feNhdtCK;
        "pkg-forge-1.20.1-1.1.4" = _aDdqwc1n;
        "pkg-forge-1.19.2-1.1.5" = _8kMppL6r;
        "pkg-forge-1.19.4-1.1.5" = _LuQ50my0;
        "pkg-forge-1.20.1-1.1.5" = _wSZAijjN;
        "pkg-forge-1.20.2-1.1.5" = _Y1scyFIP;
        "pkg-forge-1.19.2-1.2.0" = _4rehD9gy;
        "pkg-forge-1.19.4-1.2.0" = _XkJU0Iyv;
        "pkg-forge-1.20.1-1.2.0" = _du0Qap4T;
        "pkg-forge-1.20.2-1.2.0" = _RioP75Yi;
        "pkg-forge-1.19.2-1.2.1" = _SXr9Kp83;
        "pkg-forge-1.19.4-1.2.1" = _s9VOjEcE;
        "pkg-forge-1.20.1-1.2.1" = _Xmli0WbS;
        "pkg-forge-1.20.2-1.2.1" = _FeZXPOCS;
        "pkg-forge-1.19.2-1.2.2" = _pHdqF72w;
        "pkg-forge-1.19.4-1.2.2" = _YLJMscng;
        "pkg-forge-1.20.1-1.2.2" = _7CiKk8Zh;
        "pkg-forge-1.20.2-1.2.2" = _rQsanX4x;
        "pkg-neoforge-1.20.2-1.2.2" = _LDgTzWk6;
        "pkg-neoforge-1.20.2-1.2.3" = _YdixClts;
        "pkg-forge-1.19.2-1.2.4" = _NsmkdRsl;
        "pkg-forge-1.19.4-1.2.4" = _9UEmF7FJ;
        "pkg-forge-1.20.1-1.2.4" = _VR3w5OvL;
        "pkg-forge-1.20.2-1.2.4" = _hrmdRMZI;
        "pkg-neoforge-1.20.2-1.2.4" = _DAMt6cki;
        "pkg-forge-1.19.2-1.2.5" = _84dGRYVm;
        "pkg-forge-1.19.4-1.2.5" = _zXFR4f1f;
        "pkg-forge-1.20.1-1.2.5" = _8EQVMftD;
        "pkg-forge-1.20.2-1.2.5" = _nL1RM1Ar;
        "pkg-neoforge-1.20.2-1.2.5" = _bJCRVoNQ;
        "pkg-neoforge-1.20.3-1.2.5" = _VMY2KByw;
        "pkg-neoforge-1.20.4-1.2.5" = _GK9d8S87;
        "pkg-forge-1.19.2-1.2.6" = _4tOUJlen;
        "pkg-forge-1.20.1-1.2.6" = _ffhUXzN9;
        "pkg-neoforge-1.20.4-1.2.6" = _UQtWZdHU;
        "pkg-neoforge-1.20.4-1.2.7" = _YnQDfluX;
        "pkg-neoforge-1.20.5-1.2.7" = _NGaUJ4iU;
        "pkg-neoforge-1.20.6-1.2.7" = _dhszXF9x;
        "pkg-neoforge-1.20.6-1.2.8" = _4zIFJX8L;
        "pkg-neoforge-1.20.6-1.2.9" = _5idGnx1r;
        "pkg-neoforge-1.20.6-1.2.10" = _H8AYfQ4X;
        "pkg-neoforge-1.20.6-1.2.11" = _Z8kjWwq7;
        "pkg-forge-1.19.2-1.2.12" = _bU1XUBwe;
        "pkg-forge-1.20.1-1.2.12" = _mIDzTtMR;
        "pkg-neoforge-1.20.4-1.2.12" = _UaXcrZ8H;
        "pkg-neoforge-1.20.6-1.2.12" = _6vZzcGh2;
        "pkg-neoforge-1.21-1.2.12" = _t3eriDEF;
        "pkg-neoforge-1.21-1.2.13" = _t8QbCkBX;
        "pkg-neoforge-1.21-1.2.14" = _e7ig7HAE;
        "pkg-forge-1.19.2-1.2.15" = _wxPIVHTy;
        "pkg-forge-1.20.1-1.2.15" = _9WA9xFwA;
        "pkg-neoforge-1.20.4-1.2.15" = _9GwFJFGw;
        "pkg-neoforge-1.20.6-1.2.15" = _qVLYOr5N;
        "pkg-neoforge-1.21-1.2.15" = _DsIXSFUI;
        "pkg-forge-1.19.2-1.2.16" = _FJ7Gojdt;
        "pkg-forge-1.20.1-1.2.16" = _2nFDp3hh;
        "pkg-neoforge-1.21-1.2.16" = _TvaEAqEW;
        "pkg-neoforge-1.21-1.2.17" = _fdpLRnzt;
        "pkg-neoforge-1.21.1-1.2.17" = _62YqR15D;
        "pkg-neoforge-1.21.1-1.2.18" = _Tlbl4jj8;
        "pkg-neoforge-1.21.1-1.2.19" = _z20ZR1YE;
        "pkg-neoforge-1.21.2-1.2.19" = _HT31pM4p;
        "pkg-neoforge-1.21.3-1.2.19" = _Nf19Cudf;
        "pkg-neoforge-1.21.4-1.2.19" = _JYyZ3zcG;
        "pkg-neoforge-1.21.5-1.2.19" = _wFGeANEW;
        "pkg-forge-1.20.1-1.2.20" = _FCJ2JCrC;
        "pkg-neoforge-1.21.4-1.2.20" = _d5fmbENg;
        "pkg-neoforge-1.21.5-1.2.20" = _fwlkwHJ6;
        "pkg-forge-1.20.1-1.2.21" = _Nel5AmIr;
        "pkg-neoforge-1.21.4-1.2.21" = _s3jvRpiZ;
        "pkg-neoforge-1.21.5-1.2.21" = _edBaIGwj;
        "pkg-neoforge-1.21.6-1.2.22" = _MTGDflkj;
        "pkg-neoforge-1.21.6-1.2.23" = _O6Y8WB3Y;
        "pkg-neoforge-1.21.6-1.2.24" = _aqVJlTWT;
        "pkg-neoforge-1.21.7-1.2.24" = _XovS3La5;
        "pkg-neoforge-1.21.7-1.2.25" = _aX01wwsJ;
        "pkg-neoforge-1.21.8-1.2.25" = _8yHGqkWs;
        "pkg-forge-1.20.1-1.2.26" = _Mtjt7u5h;
        "pkg-neoforge-1.21.4-1.2.26" = _hrDDMSzU;
        "pkg-neoforge-1.21.8-1.2.26" = _BMC8R0nn;
        "pkg-neoforge-1.21.9-1.2.26" = _HGwov5rG;
        "pkg-neoforge-1.21.10-1.2.26" = _Y7512jgA;
        "pkg-neoforge-1.21.10-1.2.27" = _qYxnIGgt;
        "pkg-neoforge-1.21.11-1.2.27" = _I4DxqIN1;
        "pkg-neoforge-1.2.27+26.1" = _Bos8lIvQ;
        "pkg-neoforge-1.2.27+26.1.1" = _nd3ZfS1v;
        "pkg-neoforge-1.2.28+26.1.1" = _g0jPYFeb;
        "pkg-neoforge-1.21.8-1.2.29" = _FRQrXLvY;
        "pkg-neoforge-1.21.10-1.2.29" = _gKDYqz3o;
        "pkg-neoforge-1.21.11-1.2.29" = _9xfA5dVg;
        "pkg-neoforge-1.2.29+26.1.1" = _jt6l4M0v;
        "pkg-neoforge-1.2.29+26.1.2" = _sQ0NLLQN;
        "pkg-neoforge-1.2.30+26.1.2" = _WdnWFsKr;
        "pkg-neoforge-1.2.30+26.2" = _QboF7dL6;
        "pkg-neoforge-1.21.1-1.2.31" = _BPGKb8pi;
        "pkg-neoforge-1.21.11-1.2.31" = _BZhymaHs;
        "pkg-neoforge-1.2.31+26.1.2" = _1hVEeHBs;
