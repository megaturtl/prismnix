...
let
    versions = (let
        ...
        _RbVo9RcM = {
            "id" = "RbVo9RcM";
            "file" = "blastingclay-1.18.2-fabric-2.jar";
            "hash" = "sha512-wks5WyzJ/YhhwFpK8pzbhw4I8eW/3XL4/fwO+DiMSmLDPxrJSktnDsCU2FmPj2tSGw4dHlpIfWY9E2mc09Kx5Q==";
        };
        _VqoLjE39 = {
            "id" = "VqoLjE39";
            "file" = "blastingclay-1.18.2-forge-2.jar";
            "hash" = "sha512-8sMZF7cEX1064dTiV/SGk0rjwVYa6RKxzHx1OrWoQxGYLohTNYR8bI8LL3rr1dPcAESEveS1p1gQEPa3dStgJA==";
        };
        _lUpx6Gp2 = {
            "id" = "lUpx6Gp2";
            "file" = "blastingclay-1.19.2-fabric-2.jar";
            "hash" = "sha512-mhqgCJ+oclsINgVQhh+UeBoZQXB3+Zo8UfFx8onUowNpbOj9HDQx+9/6us5wpRcDvDPrjR/pYyEO8xleUe2DkA==";
        };
        _yRiszAuv = {
            "id" = "yRiszAuv";
            "file" = "blastingclay-1.19.2-forge-2.jar";
            "hash" = "sha512-IuvErm39gFBRhGQOgHsQRA5xldvkhI+a3EX6FpBy/FrM7A/CRT8Bw5nvO7Wqt5hZ5fOJcpc4JXRzr8sbn446Zw==";
        };
        _W7dNRK7j = {
            "id" = "W7dNRK7j";
            "file" = "blastingclay-1.20.1-fabric-2.jar";
            "hash" = "sha512-j55C1mb47DodERH2wOUYW2y+z+/+TgpnYg+XVmjdbT0pryBWn4DLXbrNKW0ZuN1YtiFNgNgudl2QU7kFQr526A==";
        };
        _8to58C7J = {
            "id" = "8to58C7J";
            "file" = "blastingclay-1.20.1-forge-2.jar";
            "hash" = "sha512-B/TNGIYUWTc7+5exUhGiJvlnHkwKnJSo+X3JrcrP9MTSCUR1Nx6qkA+kPu5LIV1i6WSixogAY4dxa7jTb/zyHg==";
        };
        _eTKnnGDD = {
            "id" = "eTKnnGDD";
            "file" = "blastingclay-1.21.1-fabric-2.jar";
            "hash" = "sha512-dWb2vA8SC1ts5C+K3Lyx9tXjtWJ7B18lEjHICTneBQ56hNLhkYXJ/EMb6YlHfkaW/qXbyS4Ftt7BBlm16oo9bA==";
        };
        _HdOykXMF = {
            "id" = "HdOykXMF";
            "file" = "blastingclay-1.21.1-forge-2.jar";
            "hash" = "sha512-Tw9LqmVVfeaYF9M4QW2E9ew3/xCBkBKcYfW2hboShSIsWfSY1gAOFB7aZGNjEsJzS88VyVWj8qbYRQnQjCg4Zg==";
        };
        _bPsqZ7GX = {
            "id" = "bPsqZ7GX";
            "file" = "blastingclay-1.21.1-neoforge-2.jar";
            "hash" = "sha512-1oJYuxf83o6S0Po2wVOje7I0N0rM3HakFVKwmrhKMigDcWJpsMfSGtaR4CllL5PyUcms3IgMc78JjC/326Xx+w==";
        };
        _3NzuxEoo = {
            "id" = "3NzuxEoo";
            "file" = "blastingclay-26.1.2-fabric-2.jar";
            "hash" = "sha512-meIjVnFFWO7dE5xly0sNjm3PW0dqj7vneLhEuMmXR2nw3kSx76rOiyBWuXGoASWb9z1uOXfdHlUAH2ctw0Yjwg==";
        };
        _Df8fel8j = {
            "id" = "Df8fel8j";
            "file" = "blastingclay-26.1.2-forge-2.jar";
            "hash" = "sha512-3+UeiU5rKlnPEeNaFO6hrRu+inHsWqOi6bVerMbnBhcIJ/lGj1641cIq0dr4ADUNZ5irCDmc3eo7swjfNBuILg==";
        };
        _j2j484Kd = {
            "id" = "j2j484Kd";
            "file" = "blastingclay-26.1.2-neoforge-2.jar";
            "hash" = "sha512-PeLg7nTh4PSWH5zLxp5IPhfmzxrM/OKEQjCuwsPsCstXiq9nfIXLSRNPQGIzyGVW418sJzgVEkpH0vKf5t/FfA==";
        };
        _UIddzXPG = {
            "id" = "UIddzXPG";
            "file" = "blastingclay-26.2-fabric-2.jar";
            "hash" = "sha512-H59qeJBeSdJKDjl/8dxC3APfTK0oUyev8oSDTlNRo5hweAJc45JX1+pjZp4EC1ZQsfr8dfZek7s3vwKrUHUJ3g==";
        };
        _91qrNUWd = {
            "id" = "91qrNUWd";
            "file" = "blastingclay-26.2-forge-2.jar";
            "hash" = "sha512-g1sD/KjJxUsCigofAFQ+fW0b5cVpXujDGbitN45QibyEUQc1qnEkZu1tB0o0MPXVEoS8XnBUaS2Okhix9Z3nYw==";
        };
        _wgvBOlhh = {
            "id" = "wgvBOlhh";
            "file" = "blastingclay-26.2-neoforge-2.jar";
            "hash" = "sha512-Pv5G5h1/U9k3mktic7R44pBPVJAT7/eAD03HXnMT/IICaU8ZafA7103bB3/+9IFTC3KrpF3RNy+QmzbfXrGwGA==";
        };
    in {
        "iJRm1m09" = _iJRm1m09;
        "LzRaULQN" = _LzRaULQN;
        ...
        "fabric-26.1" = _3NzuxEoo;
        "fabric-26.1.1" = _3NzuxEoo;
        "fabric-26.1.2" = _3NzuxEoo;
        "fabric-26.2" = _UIddzXPG;
        "quilt-1.18.1" = _RbVo9RcM;
        "quilt-1.18.2" = _RbVo9RcM;
        "quilt-1.19" = _lUpx6Gp2;
        "quilt-1.19.1" = _lUpx6Gp2;
        "quilt-1.19.2" = _lUpx6Gp2;
        "quilt-1.19.3" = _ponBqyNv;
        "quilt-1.19.4" = _HGtkfnoS;
        "quilt-1.20" = _W7dNRK7j;
        "quilt-1.20.3" = _OQBrEFHV;
        "quilt-1.20.5" = _J3eu1od8;
        "quilt-1.20.6" = _J3eu1od8;
        "quilt-1.21" = _eTKnnGDD;
        "quilt-1.21.1" = _eTKnnGDD;
        "quilt-1.21.2" = _PnA4OGEU;
        "quilt-1.21.3" = _PnA4OGEU;
        "quilt-1.21.4" = _asr7iNxK;
        "quilt-1.18" = _RbVo9RcM;
        "quilt-1.20.1" = _W7dNRK7j;
        ...
        "quilt-26.1" = _3NzuxEoo;
        "quilt-26.1.1" = _3NzuxEoo;
        "quilt-26.1.2" = _3NzuxEoo;
        "quilt-26.2" = _UIddzXPG;
        "forge-1.16.5" = _9C8Tbstz;
        "forge-1.18.2" = _VqoLjE39;
        "forge-1.19" = _yRiszAuv;
        "forge-1.19.1" = _yRiszAuv;
        "forge-1.19.2" = _yRiszAuv;
        "forge-1.19.3" = _1RZRDkn8;
        "forge-1.19.4" = _wy758B2o;
        "forge-1.20" = _8to58C7J;
        "forge-1.20.1" = _8to58C7J;
        "forge-1.20.2" = _qjl36gvu;
        "forge-1.20.3" = _LMSRAbNM;
        "forge-1.20.4" = _LMSRAbNM;
        "forge-1.20.6" = _LLIHq4GP;
        "forge-1.21" = _HdOykXMF;
        "forge-1.21.1" = _HdOykXMF;
        "forge-1.21.3" = _xJzCSiIp;
        "forge-1.21.4" = _cgtlqHUh;
        "forge-1.18" = _VqoLjE39;
        "forge-1.18.1" = _VqoLjE39;
        ...
        "forge-26.1" = _Df8fel8j;
        "forge-26.1.1" = _Df8fel8j;
        "forge-26.1.2" = _Df8fel8j;
        "forge-26.2" = _91qrNUWd;
        "neoforge-1.20.4" = _X59NqqOj;
        "neoforge-1.20.6" = _eViF6odw;
        "neoforge-1.21" = _bPsqZ7GX;
        "neoforge-1.21.1" = _bPsqZ7GX;
        "neoforge-1.21.2" = _nrikkDMz;
        "neoforge-1.21.3" = _nrikkDMz;
        "neoforge-1.21.4" = _g9RnZDBU;
        "neoforge-1.20" = _8to58C7J;
        "neoforge-1.20.1" = _8to58C7J;
        ...
        "neoforge-26.1" = _j2j484Kd;
        "neoforge-26.1.1" = _j2j484Kd;
        "neoforge-26.1.2" = _j2j484Kd;
        "neoforge-26.2" = _wgvBOlhh;
        ...
        "pkg-1.18.2-fabric-2" = _RbVo9RcM;
        "pkg-1.18.2-forge-2" = _VqoLjE39;
        "pkg-1.19.2-fabric-2" = _lUpx6Gp2;
        "pkg-1.19.2-forge-2" = _yRiszAuv;
        "pkg-1.20.1-fabric-2" = _W7dNRK7j;
        "pkg-1.20.1-forge-2" = _8to58C7J;
        "pkg-1.21.1-fabric-2" = _eTKnnGDD;
        "pkg-1.21.1-forge-2" = _HdOykXMF;
        "pkg-1.21.1-neoforge-2" = _bPsqZ7GX;
        "pkg-26.1.2-fabric-2" = _3NzuxEoo;
        "pkg-26.1.2-forge-2" = _Df8fel8j;
        "pkg-26.1.2-neoforge-2" = _j2j484Kd;
        "pkg-26.2-fabric-2" = _UIddzXPG;
        "pkg-26.2-forge-2" = _91qrNUWd;
        "pkg-26.2-neoforge-2" = _wgvBOlhh;
        "default" = _wgvBOlhh;
    });
