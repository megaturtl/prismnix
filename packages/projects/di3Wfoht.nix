...
let
    ...
    in {
        ...
        "pkg-v1.5" = _CDlHWjE7;
        "pkg-v1.6" = _gAjb2zPV;
        "pkg-v1.6.1" = _hFpJi4wr;
        "pkg-v1.6.2" = _kExGAyUm;
        "pkg-v1.6.3" = _U8hbzlUt;
        "pkg-v1.7" = _T8bRk1FV;
        "pkg-v1.7.1" = _nBjQuhir;
        "pkg-v1.7.1.backwards-compatible" = _5OUPEuwF;
        "pkg-v1.8" = _dFpgtf7q;
        "pkg-v1.9" = _3QvX5Agr;
        "pkg-v1.9.1" = _okfC6W8V;
        "pkg-v1.9.2" = _prjIFBX0;
        "pkg-v1.10" = _wiC4SrEp;
        "pkg-v1.10.1" = _X8NNiWih;
        "pkg-v1.11" = _C6N5tp8l;
        "pkg-v1.12" = _drYzzOY9;
        "pkg-v1.13" = _aCMisoCF;
        "pkg-v1.14" = _CP6gb9rv;
        "pkg-v1.15" = _xvP8K98u;
        "pkg-v1.15.1" = _E6ilV6hH;
        "pkg-v1.16" = _3nWCb7ZB;
        "pkg-v1.16-lite" = _EzCfh0el;
        "pkg-v1.17" = _VrjJA8p8;
        "pkg-v1.18" = _VzzeSSTe;
        "pkg-v1.19" = _bO5aoy96;
        "pkg-v1.20" = _vzp79ujA;
