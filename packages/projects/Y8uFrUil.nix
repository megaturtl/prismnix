...
let
    ...
    in {
        ...
        "pkg-0.2.0+1.18.2" = _GU9MQ4E7;
        "pkg-0.2.0+1.19" = _arVa0deQ;
        "pkg-0.2.1+1.19" = _ZNKGIHGC;
        "pkg-0.2.2+1.14.4" = _vj7kv8X4;
        "pkg-0.2.2+1.15.2" = _U3kgFRkg;
        "pkg-0.2.2+1.16.5" = _3ykBv2oR;
        "pkg-0.2.2+1.17.1" = _UanycbKY;
        "pkg-0.2.2+1.18.2" = _I5na6dOg;
        "pkg-0.2.2+1.19.2" = _oKQsfevx;
        "pkg-0.2.2+b1.7.3" = _zTYTvt0T;
        "pkg-0.3.0+1.19.2" = _PVtRfGtN;
        "pkg-0.3.0+1.18.2" = _3AiCql5N;
        "pkg-0.3.0+1.17.1" = _rNMoS3wT;
        "pkg-0.3.0+1.16.5" = _mhcAhSey;
        "pkg-0.3.0+1.15.2" = _kRD7ZW5y;
        "pkg-0.3.0+1.14.4" = _o5RU9R0b;
        "pkg-0.3.1+1.19.2" = _2FwvHsVs;
        "pkg-0.3.1+1.18.2" = _FTy23xAl;
        "pkg-0.3.1+1.16.5" = _WJ0Kz2j1;
        "pkg-0.3.1+1.17.1" = _Sn3wNKvR;
        "pkg-0.3.1+1.15.2" = _nQ5s1r2p;
        "pkg-0.3.1+1.14.4" = _WG44sNdX;
        "pkg-0.3.1+1.19.3" = _hb6SvXST;
        "pkg-0.4.0+1.19.3" = _XsZLh6g7;
        "pkg-0.4.0+1.19.2" = _FJ9RSHWc;
        "pkg-0.4.0+1.18.2" = _z7IEUbZI;
        "pkg-0.4.0+1.17.1" = _jhW4nikR;
        "pkg-0.4.0+1.16.5" = _xbfwGcDm;
        "pkg-0.4.0+1.15.2" = _95yE5AL4;
        "pkg-0.4.0+1.14.4" = _9u5DAv0V;
        "pkg-0.5.0+1.18.2" = _gGx9GZiN;
        "pkg-0.5.0+1.19.2" = _wT8wmGkm;
        "pkg-0.5.0+1.19.3" = _2U4V0PZc;
        "pkg-0.6.0+1.19.3" = _G4RQBYUU;
        "pkg-0.6.0+1.19.2" = _zmVz9MT0;
        "pkg-0.6.0+1.18.2" = _cUZNZ6ZJ;
        "pkg-0.6.1+1.19.3" = _BshYumVb;
        "pkg-0.6.1+1.19.2" = _genLDUJY;
        "pkg-0.6.1+1.18.2" = _XlsUf9hq;
        "pkg-0.6.1+1.16.5" = _UYql1arU;
        "pkg-0.6.2+1.16.5" = _Iq7zmFKG;
        "pkg-0.6.1+1.19.4" = _1BLEffJi;
        "pkg-1.0.0-alpha.1+23w17a" = _iW62WYKB;
        "pkg-1.0.0-alpha.2+1.20-pre1" = _moP1fWab;
        "pkg-0.7.0+1.20" = _5MXKgYAq;
        "pkg-1.0.0-beta.1+1.20" = _ktJWq3Uc;
        "pkg-1.0.0-beta.2+1.20" = _74qyHw6a;
        "pkg-1.0.0-beta.3+1.20.1" = _bC2BC1G8;
        "pkg-1.0.0-beta.4+1.20.2-rc2" = _E2IjZXqP;
        "pkg-1.0.0+1.20.2" = _yVgnHg2H;
        "pkg-1.0.1+1.20.2" = _4z2QUQ2f;
        "pkg-1.0.2+1.20.2" = _qnfOfBg0;
        "pkg-1.1.0+1.20.3" = _9uMkLHWi;
        "pkg-1.1.1+1.20.3" = _btWlZkx3;
        "pkg-1.1.2+1.20.4" = _1pdmPwYS;
        "pkg-1.2.0+1.20.6" = _62p3LxO3;
        "pkg-1.2.1+1.20.6" = _U9wsh3vB;
        "pkg-1.3.0+1.21" = _6gBZhBhX;
        "pkg-1.4.0+1.21" = _uOV1ub0N;
        "pkg-1.4.1+1.21" = _WIHBQHSG;
        "pkg-1.5.0+1.21.2" = _APODDi4p;
        "pkg-1.6.0+1.21.4" = _bgtLrKIN;
        "pkg-1.7.0+1.21.5" = _80isezW8;
        "pkg-1.7.1+1.21.5" = _94Pv0WcZ;
        "pkg-1.8.0+1.21.6" = _zc18lKtk;
        "pkg-1.8.1+1.21.6" = _UzvTCJyC;
        "pkg-1.8.2+1.21.6" = _AdBiSP4T;
        "pkg-1.9.0+1.21.9" = _EsXqtkdN;
        "pkg-1.10.0+1.21.11" = _94qvokzo;
        "pkg-1.10.1+1.21.11" = _wwtRF2p2;
        "pkg-2.0.0-alpha.1+26.1-snapshot-2" = _LembNerX;
        "pkg-1.10.2+1.21.11" = _t9ZJ7RPT;
        "pkg-2.0.0+26.1-fabric" = _asZKdLUQ;
        "pkg-2.0.0+26.1-neoforge" = _HDipXwe3;
        "pkg-2.1.0+26.2-fabric" = _ZNmjxBpi;
