...
let
    ...
    in {
        ...
        "6eUNEtr8" = _6eUNEtr8;
        "BwL49Vq8" = _BwL49Vq8;
        "minecraft-1.18.2" = _uqvN2ZAf;
        "minecraft-1.19" = _uqvN2ZAf;
        "minecraft-1.19.1" = _uqvN2ZAf;
        "minecraft-1.19.2" = _uqvN2ZAf;
        "minecraft-1.19.3" = _KJUI46LJ;
        "minecraft-1.19.4" = _Grw0a6hf;
        "minecraft-1.20" = _Grw0a6hf;
        "minecraft-1.20.1" = _Grw0a6hf;
        "minecraft-1.20.2" = _SQLAPuga;
        "minecraft-1.20.3" = _SQLAPuga;
        "minecraft-1.20.4" = _SQLAPuga;
        "minecraft-1.20.5" = _SQLAPuga;
        "minecraft-1.20.6" = _SQLAPuga;
        "minecraft-1.21" = _SQLAPuga;
        "minecraft-1.21.1" = _SQLAPuga;
        "minecraft-1.21.2" = _SQLAPuga;
        "minecraft-1.21.3" = _SQLAPuga;
        "minecraft-1.21.4" = _SQLAPuga;
        "minecraft-1.21.5" = _SQLAPuga;
        "minecraft-1.21.6" = _SQLAPuga;
        "minecraft-1.21.7" = _SQLAPuga;
        "minecraft-1.21.8" = _SQLAPuga;
        "minecraft-1.21.9" = _SQLAPuga;
        "minecraft-1.21.10" = _SQLAPuga;
        "minecraft-1.21.11" = _OaFUK1Lx;
        "minecraft-26.1" = _OaFUK1Lx;
        "minecraft-26.1.1" = _OaFUK1Lx;
        "minecraft-26.1.2" = _OaFUK1Lx;
