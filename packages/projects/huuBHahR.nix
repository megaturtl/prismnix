...
let
    ...
    in {
        ...
        "pkg-0.2.2-alpha" = _18Jd6jEU;
        "pkg-0.3.0-alpha" = _yDdFsLMu;
        "pkg-0.3.1-alpha" = _DrLi5HJF;
        "pkg-0.3.2-alpha" = _BdVn4MU2;
        "pkg-0.3.2.1-alpha" = _B2clZNrk;
        "pkg-0.3.3-alpha" = _KpszVXml;
        "pkg-0.4.0-alpha" = _aUjXVm3g;
        "pkg-0.4.1-alpha" = _UMOZCeFe;
        "pkg-0.4.2-alpha" = _xpQjT0zv;
        "pkg-0.4.3-alpha" = _fcQPn9dO;
        "pkg-0.4.3.1-alpha" = _qhkhYvhf;
        "pkg-0.4.3.2-alpha" = _4TPbhshi;
        "pkg-0.5.0-alpha" = _l70fEqNt;
        "pkg-0.5.1-alpha" = _DnFYs58h;
        "pkg-0.6.0-beta" = _cdm9H3lz;
        "pkg-0.6.1-beta" = _1vWpUEyY;
        "pkg-0.6.2-beta" = _B0OAtGQo;
        "pkg-0.6.2.1-beta" = _Mskb8FhW;
        "pkg-0.6.3-beta" = _OJtwgwqF;
        "pkg-0.6.4-beta" = _6KLBAZ7U;
        "pkg-0.6.5-beta" = _Ce0TKzJd;
        "pkg-0.6.5.1-beta" = _ZFLQzCBM;
        "pkg-0.6.6-beta" = _G1mth0dS;
        "pkg-0.6.7-beta" = _GPyF7Mqr;
        "pkg-0.7.0-beta" = _EsOnzDxV;
