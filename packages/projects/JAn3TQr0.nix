...
let
    ...
    in {
        ...
        "pkg-1.21.7-v1.1.0-fabric" = _se8y8IoW;
        "pkg-1.21.1-v1.1.0-fabric" = _Xb9KO4il;
        "pkg-1.21.1-v1.1.0-neoforge" = _CbEMkc8b;
        "pkg-1.21.7-v1.1.1-fabric" = _CkOlZvtc;
        "pkg-1.21.1-v1.2.0-fabric" = _hOIb5SnX;
        "pkg-1.21.1-v1.2.0-neoforge" = _bMOZgu8H;
        "pkg-1.21.7-v1.2.0-fabric" = _7UF08AIz;
        "pkg-1.21.1-v1.2.1-fabric" = _uhLHyEOr;
        "pkg-1.21.1-v1.2.1-neoforge" = _dkj8rIWO;
        "pkg-1.21.8-v1.2.1-fabric" = _Hhw0SEdI;
        "pkg-1.21.1-v1.2.2-neoforge" = _HMrlOCZw;
        "pkg-1.21.1-v1.3.0-fabric" = _R5hPD3iI;
        "pkg-1.21.1-v1.3.0-neoforge" = _Xp0Pa1fU;
        "pkg-1.21.8-v1.3.0-fabric" = _9s0P5vBD;
        "pkg-1.21.1-v1.3.1-fabric" = _Fz9kkgmN;
        "pkg-1.21.1-v1.3.1-neoforge" = _tb48IMso;
        "pkg-1.21.8-v1.3.1-fabric" = _4FCl6eaB;
        "pkg-1.21.1-v1.3.2-fabric" = _5zwmy8eD;
        "pkg-1.21.1-v1.3.2-neoforge" = _KQ10piRB;
        "pkg-1.21.8-v1.3.2-fabric" = _XwvKswvj;
        "pkg-1.21.10-v1.4.0-fabric" = _uRnywkVe;
        "pkg-1.21.1-v1.3.3-fabric" = _qJIVs4fp;
        "pkg-1.21.1-v1.3.3-neoforge" = _eFVRu6f2;
        "pkg-1.21.8-v1.3.3-fabric" = _n2kOW5ul;
        "pkg-1.21.10-v1.4.1-fabric" = _E7PGoTMM;
        "pkg-1.21.11-v1.4.1-fabric" = _qPXj6Ib6;
        "pkg-1.21.11-v1.4.2-fabric" = _QjFtCLVv;
        "pkg-1.21.1-v1.3.4-fabric" = _zEFJPsft;
        "pkg-1.21.1-v1.3.4-neoforge" = _LyR7yBHS;
        "pkg-1.21.8-v1.3.4-fabric" = _gyhHvolX;
        "pkg-1.21.10-v1.4.2-fabric" = _pNnikZYo;
        "pkg-1.21.11-v1.4.3-fabric" = _5MEqWkpx;
        "pkg-1.21.11-v1.4.4-fabric" = _ATvM6iCf;
        "pkg-1.21.11-v1.5.0-fabric" = _u0pnLoyn;
        "pkg-1.21.11-v1.5.1-fabric" = _IxcLNNsC;
        "pkg-1.21.11-v1.5.2-fabric" = _L8sV1pX3;
        "pkg-1.21.11-v1.5.3-fabric" = _ggpPzGAW;
        "pkg-1.21.11-v1.5.4-fabric" = _msCntTcq;
        "pkg-1.21.11-v1.5.5-fabric" = _FJLwveCB;
        "pkg-1.21.11-v1.5.6-fabric" = _7jZDaCRe;
        "pkg-26.1-r1.0-neoforge" = _qxHOsBht;
        "pkg-26.1-r1.0-fabric" = _g4uu0fgL;
        "pkg-26.1-r1.1-neoforge" = _SH6kdeWu;
        "pkg-26.1-r1.1-fabric" = _Yfvnztj8;
        "pkg-26.1-r1.2-neoforge" = _lt8CP1iC;
        "pkg-26.1-r1.2-fabric" = _s0ccKmTF;
        "pkg-26.1-r2.0-neoforge" = _Zbtw7lXv;
        "pkg-26.1-r2.0-fabric" = _aRZZQCga;
        "pkg-26.1-r2.1-neoforge" = _4pzQ15QS;
        "pkg-26.1-r2.1-fabric" = _wDlf9DH1;
        "pkg-26.1-r2.2-neoforge" = _hkRevose;
