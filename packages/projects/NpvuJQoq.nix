...
let
    versions = (let
        ...
        _D2klj0m6 = {
            "id" = "D2klj0m6";
            "file" = "ViaBackwards-5.12.0-SNAPSHOT.jar";
            "hash" = "sha512-zli+p4cquNVnlODPRgRdlgUJDDA2GXk9CexogfuuLcgc+ScGFFFFBYsvODxWJKlhOnoZ214rCCSTEuR3IOzwRw==";
        };
        _E12JUtXl = {
            "id" = "E12JUtXl";
            "file" = "ViaBackwards-5.12.0-SNAPSHOT.jar";
            "hash" = "sha512-wAVqk2kYQxsvmLDvY9/5MgauwVHx9dUIyy9JRVtdCUhXIATzA0SbaPG61xsVfsBBtcpzo09p7mlboXy/bMgXng==";
        };
        _qgpLZEQh = {
            "id" = "qgpLZEQh";
            "file" = "ViaBackwards-5.12.0-SNAPSHOT.jar";
            "hash" = "sha512-l8kIouznmunuFTkZwGl6r0tbD36bYtTUyAAEUvKY9vwUXL4yt1ZCEGxKoq7jKjKbbAEXU2druDQld7L9TW+kHQ==";
        };
        _ZH4SyU2c = {
            "id" = "ZH4SyU2c";
            "file" = "ViaBackwards-5.12.0-SNAPSHOT.jar";
            "hash" = "sha512-tf2HGPFp+kbAN0er4pNe9in3T+A1fhWikQU9wMy9SVNi5Nn/1f9MFsbyOrfamfHFqtH0r9wj4Wmpnpgm7agd2g==";
        };
        _dkrcQAdd = {
            "id" = "dkrcQAdd";
            "file" = "ViaBackwards-5.12.0-SNAPSHOT.jar";
            "hash" = "sha512-P/EOny2H+tThSxru1b1D0UZo5Axw1X1HRMU7xi8jE46Y9ES1+wLCYL2lHGx+7DL/wnz73Jc//nNiAVzTIf06bQ==";
        };
        _GB5LJQxR = {
            "id" = "GB5LJQxR";
            "file" = "ViaBackwards-5.12.0-SNAPSHOT.jar";
            "hash" = "sha512-B6MBmc5nhPpI/igJwk1L+hHbkasyV2Ta1lReabSHhnZl08CSd+b+onSF5POhmeK4ZtAa5zY/GWZ8VZajhTbqPA==";
        };
    in {
        "fd1x6MPo" = _fd1x6MPo;
        "5M3uPDEM" = _5M3uPDEM;
        ...
        "dkrcQAdd" = _dkrcQAdd;
        "GB5LJQxR" = _GB5LJQxR;
        "fabric-1.10" = _GB5LJQxR;
        "fabric-1.10.1" = _GB5LJQxR;
        "fabric-1.10.2" = _GB5LJQxR;
        "fabric-1.11" = _GB5LJQxR;
        "fabric-1.11.1" = _GB5LJQxR;
        "fabric-1.11.2" = _GB5LJQxR;
        "fabric-1.12" = _GB5LJQxR;
        "fabric-1.12.1" = _GB5LJQxR;
        "fabric-1.12.2" = _GB5LJQxR;
        "fabric-1.13" = _GB5LJQxR;
        "fabric-1.13.1" = _GB5LJQxR;
        "fabric-1.13.2" = _GB5LJQxR;
        "fabric-1.14" = _GB5LJQxR;
        "fabric-1.14.1" = _GB5LJQxR;
        "fabric-1.14.2" = _GB5LJQxR;
        "fabric-1.14.3" = _GB5LJQxR;
        "fabric-1.14.4" = _GB5LJQxR;
        "fabric-1.15" = _GB5LJQxR;
        "fabric-1.15.1" = _GB5LJQxR;
        "fabric-1.15.2" = _GB5LJQxR;
        "fabric-1.16" = _GB5LJQxR;
        "fabric-1.16.1" = _GB5LJQxR;
        "fabric-1.16.2" = _GB5LJQxR;
        "fabric-1.16.3" = _GB5LJQxR;
        "fabric-1.16.4" = _GB5LJQxR;
        "fabric-1.16.5" = _GB5LJQxR;
        "fabric-1.17" = _GB5LJQxR;
        "fabric-1.17.1" = _GB5LJQxR;
        "fabric-1.18" = _GB5LJQxR;
        "fabric-1.18.1" = _GB5LJQxR;
        "fabric-1.18.2" = _GB5LJQxR;
        "fabric-1.19" = _GB5LJQxR;
        "fabric-1.19.1" = _GB5LJQxR;
        "fabric-1.19.2" = _GB5LJQxR;
        "fabric-1.19.3" = _GB5LJQxR;
        "fabric-1.19.4" = _GB5LJQxR;
        "fabric-1.20" = _GB5LJQxR;
        "fabric-1.20.1" = _GB5LJQxR;
        "fabric-1.20.2" = _GB5LJQxR;
        "fabric-1.20.3" = _GB5LJQxR;
        "fabric-1.20.4" = _GB5LJQxR;
        "fabric-1.20.5" = _GB5LJQxR;
        "fabric-1.20.6" = _GB5LJQxR;
        "fabric-1.21" = _GB5LJQxR;
        "fabric-1.21.1" = _GB5LJQxR;
        "fabric-1.21.2" = _GB5LJQxR;
        "fabric-1.21.3" = _GB5LJQxR;
        "fabric-1.21.4" = _GB5LJQxR;
        "fabric-1.21.5" = _GB5LJQxR;
        "fabric-1.21.6" = _GB5LJQxR;
        "fabric-1.21.7" = _GB5LJQxR;
        "fabric-1.21.8" = _GB5LJQxR;
        "fabric-1.21.9" = _GB5LJQxR;
        "fabric-1.21.10" = _GB5LJQxR;
        "fabric-1.21.11" = _GB5LJQxR;
        "fabric-26.1" = _GB5LJQxR;
        "fabric-26.1.1" = _GB5LJQxR;
        "fabric-26.1.2" = _GB5LJQxR;
        "fabric-26.2" = _GB5LJQxR;
        ...
        "folia-1.10" = _GB5LJQxR;
        "folia-1.10.1" = _GB5LJQxR;
        "folia-1.10.2" = _GB5LJQxR;
        "folia-1.11" = _GB5LJQxR;
        "folia-1.11.1" = _GB5LJQxR;
        "folia-1.11.2" = _GB5LJQxR;
        "folia-1.12" = _GB5LJQxR;
        "folia-1.12.1" = _GB5LJQxR;
        "folia-1.12.2" = _GB5LJQxR;
        "folia-1.13" = _GB5LJQxR;
        "folia-1.13.1" = _GB5LJQxR;
        "folia-1.13.2" = _GB5LJQxR;
        "folia-1.14" = _GB5LJQxR;
        "folia-1.14.1" = _GB5LJQxR;
        "folia-1.14.2" = _GB5LJQxR;
        "folia-1.14.3" = _GB5LJQxR;
        "folia-1.14.4" = _GB5LJQxR;
        "folia-1.15" = _GB5LJQxR;
        "folia-1.15.1" = _GB5LJQxR;
        "folia-1.15.2" = _GB5LJQxR;
        "folia-1.16" = _GB5LJQxR;
        "folia-1.16.1" = _GB5LJQxR;
        "folia-1.16.2" = _GB5LJQxR;
        "folia-1.16.3" = _GB5LJQxR;
        "folia-1.16.4" = _GB5LJQxR;
        "folia-1.16.5" = _GB5LJQxR;
        "folia-1.17" = _GB5LJQxR;
        "folia-1.17.1" = _GB5LJQxR;
        "folia-1.18" = _GB5LJQxR;
        "folia-1.18.1" = _GB5LJQxR;
        "folia-1.18.2" = _GB5LJQxR;
        "folia-1.19" = _GB5LJQxR;
        "folia-1.19.1" = _GB5LJQxR;
        "folia-1.19.2" = _GB5LJQxR;
        "folia-1.19.3" = _GB5LJQxR;
        "folia-1.19.4" = _GB5LJQxR;
        "folia-1.20" = _GB5LJQxR;
        "folia-1.20.1" = _GB5LJQxR;
        "folia-1.20.2" = _GB5LJQxR;
        "folia-1.20.3" = _GB5LJQxR;
        "folia-1.20.4" = _GB5LJQxR;
        "folia-1.20.5" = _GB5LJQxR;
        "folia-1.20.6" = _GB5LJQxR;
        "folia-1.21" = _GB5LJQxR;
        "folia-1.21.1" = _GB5LJQxR;
        "folia-1.21.2" = _GB5LJQxR;
        "folia-1.21.3" = _GB5LJQxR;
        "folia-1.21.4" = _GB5LJQxR;
        "folia-1.21.5" = _GB5LJQxR;
        "folia-1.21.6" = _GB5LJQxR;
        "folia-1.21.7" = _GB5LJQxR;
        "folia-1.21.8" = _GB5LJQxR;
        "folia-1.21.9" = _GB5LJQxR;
        "folia-1.21.10" = _GB5LJQxR;
        "folia-1.21.11" = _GB5LJQxR;
        "folia-26.1" = _GB5LJQxR;
        "folia-26.1.1" = _GB5LJQxR;
        "folia-26.1.2" = _GB5LJQxR;
        "folia-26.2" = _GB5LJQxR;
        "paper-1.10" = _GB5LJQxR;
        "paper-1.10.1" = _GB5LJQxR;
        "paper-1.10.2" = _GB5LJQxR;
        "paper-1.11" = _GB5LJQxR;
        "paper-1.11.1" = _GB5LJQxR;
        "paper-1.11.2" = _GB5LJQxR;
        "paper-1.12" = _GB5LJQxR;
        "paper-1.12.1" = _GB5LJQxR;
        "paper-1.12.2" = _GB5LJQxR;
        "paper-1.13" = _GB5LJQxR;
        "paper-1.13.1" = _GB5LJQxR;
        "paper-1.13.2" = _GB5LJQxR;
        "paper-1.14" = _GB5LJQxR;
        "paper-1.14.1" = _GB5LJQxR;
        "paper-1.14.2" = _GB5LJQxR;
        "paper-1.14.3" = _GB5LJQxR;
        "paper-1.14.4" = _GB5LJQxR;
        "paper-1.15" = _GB5LJQxR;
        "paper-1.15.1" = _GB5LJQxR;
        "paper-1.15.2" = _GB5LJQxR;
        "paper-1.16" = _GB5LJQxR;
        "paper-1.16.1" = _GB5LJQxR;
        "paper-1.16.2" = _GB5LJQxR;
        "paper-1.16.3" = _GB5LJQxR;
        "paper-1.16.4" = _GB5LJQxR;
        "paper-1.16.5" = _GB5LJQxR;
        "paper-1.17" = _GB5LJQxR;
        "paper-1.17.1" = _GB5LJQxR;
        "paper-1.18" = _GB5LJQxR;
        "paper-1.18.1" = _GB5LJQxR;
        "paper-1.18.2" = _GB5LJQxR;
        "paper-1.19" = _GB5LJQxR;
        "paper-1.19.1" = _GB5LJQxR;
        "paper-1.19.2" = _GB5LJQxR;
        "paper-1.19.3" = _GB5LJQxR;
        "paper-1.19.4" = _GB5LJQxR;
        "paper-1.20" = _GB5LJQxR;
        "paper-1.20.1" = _GB5LJQxR;
        "paper-1.20.2" = _GB5LJQxR;
        "paper-1.20.3" = _GB5LJQxR;
        "paper-1.20.4" = _GB5LJQxR;
        "paper-1.20.5" = _GB5LJQxR;
        "paper-1.20.6" = _GB5LJQxR;
        "paper-1.21" = _GB5LJQxR;
        "paper-1.21.1" = _GB5LJQxR;
        "paper-1.21.2" = _GB5LJQxR;
        "paper-1.21.3" = _GB5LJQxR;
        "paper-1.21.4" = _GB5LJQxR;
        "paper-1.21.5" = _GB5LJQxR;
        "paper-1.21.6" = _GB5LJQxR;
        "paper-1.21.7" = _GB5LJQxR;
        "paper-1.21.8" = _GB5LJQxR;
        "paper-1.21.9" = _GB5LJQxR;
        "paper-1.21.10" = _GB5LJQxR;
        "paper-1.21.11" = _GB5LJQxR;
        "paper-26.1" = _GB5LJQxR;
        "paper-26.1.1" = _GB5LJQxR;
        "paper-26.1.2" = _GB5LJQxR;
        "paper-26.2" = _GB5LJQxR;
        ...
        "velocity-1.10" = _GB5LJQxR;
        "velocity-1.10.1" = _GB5LJQxR;
        "velocity-1.10.2" = _GB5LJQxR;
        "velocity-1.11" = _GB5LJQxR;
        "velocity-1.11.1" = _GB5LJQxR;
        "velocity-1.11.2" = _GB5LJQxR;
        "velocity-1.12" = _GB5LJQxR;
        "velocity-1.12.1" = _GB5LJQxR;
        "velocity-1.12.2" = _GB5LJQxR;
        "velocity-1.13" = _GB5LJQxR;
        "velocity-1.13.1" = _GB5LJQxR;
        "velocity-1.13.2" = _GB5LJQxR;
        "velocity-1.14" = _GB5LJQxR;
        "velocity-1.14.1" = _GB5LJQxR;
        "velocity-1.14.2" = _GB5LJQxR;
        "velocity-1.14.3" = _GB5LJQxR;
        "velocity-1.14.4" = _GB5LJQxR;
        "velocity-1.15" = _GB5LJQxR;
        "velocity-1.15.1" = _GB5LJQxR;
        "velocity-1.15.2" = _GB5LJQxR;
        "velocity-1.16" = _GB5LJQxR;
        "velocity-1.16.1" = _GB5LJQxR;
        "velocity-1.16.2" = _GB5LJQxR;
        "velocity-1.16.3" = _GB5LJQxR;
        "velocity-1.16.4" = _GB5LJQxR;
        "velocity-1.16.5" = _GB5LJQxR;
        "velocity-1.17" = _GB5LJQxR;
        "velocity-1.17.1" = _GB5LJQxR;
        "velocity-1.18" = _GB5LJQxR;
        "velocity-1.18.1" = _GB5LJQxR;
        "velocity-1.18.2" = _GB5LJQxR;
        "velocity-1.19" = _GB5LJQxR;
        "velocity-1.19.1" = _GB5LJQxR;
        "velocity-1.19.2" = _GB5LJQxR;
        "velocity-1.19.3" = _GB5LJQxR;
        "velocity-1.19.4" = _GB5LJQxR;
        "velocity-1.20" = _GB5LJQxR;
        "velocity-1.20.1" = _GB5LJQxR;
        "velocity-1.20.2" = _GB5LJQxR;
        "velocity-1.20.3" = _GB5LJQxR;
        "velocity-1.20.4" = _GB5LJQxR;
        "velocity-1.20.5" = _GB5LJQxR;
        "velocity-1.20.6" = _GB5LJQxR;
        "velocity-1.21" = _GB5LJQxR;
        "velocity-1.21.1" = _GB5LJQxR;
        "velocity-1.21.2" = _GB5LJQxR;
        "velocity-1.21.3" = _GB5LJQxR;
        "velocity-1.21.4" = _GB5LJQxR;
        "velocity-1.21.5" = _GB5LJQxR;
        "velocity-1.21.6" = _GB5LJQxR;
        "velocity-1.21.7" = _GB5LJQxR;
        "velocity-1.21.8" = _GB5LJQxR;
        "velocity-1.21.9" = _GB5LJQxR;
        "velocity-1.21.10" = _GB5LJQxR;
        "velocity-1.21.11" = _GB5LJQxR;
        "velocity-26.1" = _GB5LJQxR;
        "velocity-26.1.1" = _GB5LJQxR;
        "velocity-26.1.2" = _GB5LJQxR;
        "velocity-26.2" = _GB5LJQxR;
        "pkg-4.7.0" = _fd1x6MPo;
        ...
        "pkg-5.12.0-SNAPSHOT+621" = _D2klj0m6;
        "pkg-5.12.0-SNAPSHOT+622" = _E12JUtXl;
        "pkg-5.12.0-SNAPSHOT+623" = _qgpLZEQh;
        "pkg-5.12.0-SNAPSHOT+624" = _ZH4SyU2c;
        "pkg-5.12.0-SNAPSHOT+625" = _dkrcQAdd;
        "pkg-5.12.0-SNAPSHOT+626" = _GB5LJQxR;
        "default" = _GB5LJQxR;
    });
