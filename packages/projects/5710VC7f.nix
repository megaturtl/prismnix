...
let
    versions = (let
        ...
        _qTBLhhZW = {
            "id" = "qTBLhhZW";
            "file" = "polydecorations-0.13.0+26.3-rc-1.jar";
            "hash" = "sha512-eJEKWYV/X+LF4sn2GPjvNtBEg+dvO41jSbgys55/D9AjfYfZxRGf6Wb6hskfR2mEQ3arFJCPFv895Wp9+yf5Vw==";
        };
        _SMAjFmM7 = {
            "id" = "SMAjFmM7";
    ...
    in {
        ...
        "pkg-0.1.0+1.20.4" = _BqUtPSXA;
        "pkg-0.1.1+1.20.4" = _WGpMN7te;
        "pkg-0.2.0+1.20.4" = _BVMNU60Q;
        "pkg-0.2.1+1.20.4" = _77QxZdMU;
        "pkg-0.2.1b+1.20.4" = _N7Dd1Huk;
        "pkg-0.2.1c+1.20.4" = _n6uktpRt;
        "pkg-0.2.2+1.20.4" = _4NbfooMH;
        "pkg-0.3.0+1.20.6" = _93S2OniI;
        "pkg-0.3.1+1.20.6" = _oBFtL4qd;
        "pkg-0.4.0+1.21" = _zJuIQHAI;
        "pkg-0.4.1+1.21" = _Wr6mrJ2n;
        "pkg-0.4.2+1.21" = _wDSyqj4f;
        "pkg-0.4.3+1.21.1" = _Sa4Nbvrz;
        "pkg-0.4.4+1.21.1" = _9spqh9Vr;
        "pkg-0.5.0+1.21.3" = _yqKSKUUg;
        "pkg-0.6.0+1.21.4-rc3" = _dhJ5QuLH;
        "pkg-0.7.0+1.21.5-rc1" = _2kW5SoYB;
        "pkg-0.7.1+1.21.5" = _ZsXKNSIS;
        "pkg-0.4.5+1.21.1" = _R5oq1hmE;
        "pkg-0.7.2+1.21.5" = _escIFexs;
        "pkg-0.7.3+1.21.5" = _zwQZV7bL;
        "pkg-0.7.4+1.21.5" = _aOahWdc9;
        "pkg-0.8.0+1.21.6" = _YLU4JBTe;
        "pkg-0.8.1+1.21.7" = _3zlwOAMT;
        "pkg-0.8.2+1.21.7" = _7zmMSt4t;
        "pkg-0.8.3+1.21.8" = _aUCeklNP;
        "pkg-0.9.0+1.21.9-rc1" = _fksUjmcu;
        "pkg-0.9.1+1.21.9" = _3xCGSMKa;
        "pkg-0.8.4+1.21.8" = _lfzdCPy1;
        "pkg-0.9.2+1.21.10" = _BddhMjJR;
        "pkg-0.10.0+1.21.11-rc3" = _J6dEELDF;
        "pkg-0.10.1+1.21.11" = _BUcPALKk;
        "pkg-0.10.2+1.21.11" = _oFHQTmUy;
        "pkg-0.10.3+1.21.11" = _Yuvg2hUx;
