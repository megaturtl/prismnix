...
let
    ...
    in {
        ...
        "pkg-7.2.9" = _vfhU4bKl;
        "pkg-7.2.9-1" = _lI7VsAZK;
        "pkg-7.3.0" = _MZOiJZLo;
        "pkg-7.3.1" = _l1JksyIf;
        "pkg-7.3.2" = _gYsU1FLO;
        "pkg-7.3.3" = _v5vl7zjj;
        "pkg-7.3.4" = _3D3RX1EG;
        "pkg-7.3.4-1" = _KLwbI6OZ;
        "pkg-7.3.5-1" = _IAAkfHmy;
        "pkg-7.3.6" = _ZzJZYou5;
        "pkg-7.3.7" = _eAGDKyYd;
        "pkg-7.3.7(re)" = _C9BtY1Ff;
        "pkg-7.3.7-2" = _UQEjijfG;
        "pkg-7.3.8" = _3PksMsew;
        "pkg-7.3.9" = _Zs7E8Ssj;
        "pkg-7.4.0" = _botHpR3f;
        "pkg-7.4.1" = _vznyvQXD;
        "pkg-7.4.2" = _6RNZJK0H;
        "pkg-7.4.3" = _oQpYClVa;
        "pkg-7.4.3-1" = _qZTvQG6O;
        "pkg-7.4.4" = _AbuUhqgM;
        "pkg-745" = _BEHz0FRT;
        "pkg-7.4.6" = _rcMeoNr1;
        "pkg-7.4.7" = _Mbrgvw4Y;
        "pkg-7.4.7-1" = _2RBkH3hs;
        "pkg-7.4.7-2" = _3aQs6sfN;
        "pkg-7.4.7-3" = _Xj5T1srI;
        "pkg-7.4.8" = _vyRQmINZ;
        "pkg-7.4.8-1" = _cUEIxHu0;
        "pkg-7.4.8-2" = _cTUIoPFF;
        "pkg-7.4.8-3" = _3eEYMF4v;
        "pkg-7.4.9" = _c3fX0BHS;
        "pkg-7.4.9-2" = _EgjIxsSH;
        "pkg-7.4.9-3" = _ZCRsNdw4;
        "pkg-7.5.0-1" = _WC0mwMFO;
        "pkg-7.5.0-2" = _Bwt1IIqC;
        "pkg-7.5.1" = _KbW7VDew;
        "pkg-7.5.1-1" = _AQqEJTFc;
        "pkg-7.5.2" = _Bp0FURgh;
        "pkg-8.0.0" = _8QZ52vTx;
        "pkg-8.0.0-2" = _lfSA4mck;
        "pkg-8.0.0-3" = _11eCmEOE;
        "pkg-8.0.0-4" = _YlXRHV4C;
        "pkg-8.0.0-6" = _Y1uzFQti;
        "pkg-8.0.0-7" = _mhQHkyal;
