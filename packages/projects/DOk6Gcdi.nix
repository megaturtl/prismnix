...
let
    versions = (let
        ...
        _fVUQu97Q = {
            "id" = "fVUQu97Q";
            "file" = "styled-nicknames-1.14.0+26.3.jar";
            "hash" = "sha512-ZAWplQ0Ar32yV54dWzTYHoAW/eDiGa9QF8xDOTPI+UFKPXI9Gmkwb6+XYF+sB8+lAVt6/RoafJZBCIopBDYezg==";
        };
    in {
        "AxfrQLFd" = _AxfrQLFd;
        "cUpLgUQC" = _cUpLgUQC;
        ...
        "fabric-26.3-rc-1" = _fVUQu97Q;
        "fabric-26.3" = _fVUQu97Q;
        ...
        "pkg-1.0.1" = _cUpLgUQC;
        "pkg-1.0.2" = _uwuBRLx9;
        "pkg-1.0.3+1.18" = _TgbNseCI;
        "pkg-1.0.4+1.18.1" = _2efrP185;
        "pkg-1.1.0+1.19" = _QZWN4OFQ;
        "pkg-1.1.1+1.19" = _hi7O2gPP;
        "pkg-1.1.2+1.19" = _LCCWv7f2;
        "pkg-1.2.0+1.19.3" = _ZAebiU4g;
        "pkg-1.2.1+1.20" = _9k8RQJkW;
        "pkg-1.3.0+1.20.2" = _qQ3CDb00;
        "pkg-1.4.0+1.20.3" = _R7dIzguo;
        "pkg-1.5.0+1.20.5" = _RqVDWvFA;
        "pkg-1.6.0+1.21" = _U9pXTyh2;
        "pkg-1.7.0+1.21.2" = _GeyvBGqo;
        "pkg-1.8.0+1.21.5" = _HCbWj9Bk;
        "pkg-1.9.0+1.21.6" = _dTTfwiNi;
        "pkg-1.10.0+1.21.9" = _ij3pwYQ7;
        "pkg-1.11.0+1.21.11" = _QHugRtCb;
        "pkg-1.11.1+1.21.11" = _Frwre1Jb;
        "pkg-1.12.0+26.1" = _OePo5uuc;
        "pkg-1.12.1+26.1" = _bMzSafrC;
        "pkg-1.13.0+26.2" = _ET58KKxg;
        "pkg-1.14.0+26.3" = _fVUQu97Q;
        "default" = _fVUQu97Q;
    });
