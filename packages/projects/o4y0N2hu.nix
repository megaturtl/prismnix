...
let
    ...
    in {
        ...
        "pkg-1.1.0+1.18" = _Es7Qx8HL;
        "pkg-1.2.0+mc1.17.1" = _J4BAgkRR;
        "pkg-1.2.0+mc1.18.2" = _lLJ4eZs6;
        "pkg-1.2.0+mc1.19" = _f0Q3nGIB;
        "pkg-1.3.0-beta.2+mc1.19" = _BlmrTmHt;
        "pkg-1.3.0+mc1.18.2" = _lSOD2lm6;
        "pkg-1.3.0+mc1.19" = _tAzqjB92;
        "pkg-1.3.1+mc1.18.2" = _5Y9Vxlkz;
        "pkg-1.3.1+mc1.19" = _iaumjCrT;
        "pkg-1.3.2+mc1.19.2" = _yuumDOrg;
        "pkg-1.3.3+mc1.19.2" = _SVUxDc0m;
        "pkg-1.4.0-alpha.1" = _EcqRAXXU;
        "pkg-1.4.0-beta.1" = _TeNRigPZ;
        "pkg-1.4.0+b1.7.3" = _I0kjCZIP;
        "pkg-1.4.1+b1.7.3" = _vbPqR6t7;
        "pkg-1.4.0-beta.2" = _5RpinpOX;
        "pkg-1.5.0" = _mY94ZCFe;
        "pkg-1.5.1" = _cQszsnQf;
        "pkg-1.5.2" = _U0sXBECd;
        "pkg-1.5.3" = _FtRk6buF;
        "pkg-1.5.4" = _DchHBJiY;
        "pkg-1.5.5" = _vV2p2NQ0;
        "pkg-1.6.0-beta.1+mc1.20" = _EWxN6EQF;
        "pkg-1.6.0-beta.2+mc1.20" = _4v6yQqL8;
        "pkg-1.6.0+mc1.20.2" = _fhA9QMWt;
        "pkg-1.7.0+mc1.20.3" = _hvOcfdjE;
        "pkg-1.8.0+mc1.20.6" = _wFXpYDvr;
        "pkg-1.8.1+mc1.20.6" = _fOn9NMos;
        "pkg-1.9.0+mc1.21" = _kFJwovt7;
        "pkg-1.9.1+mc1.21" = _CSFEUtF2;
        "pkg-1.10.0+mc1.21.2" = _M2koFXwK;
        "pkg-1.11.0+mc1.21.9" = _u0BfweNF;
        "pkg-1.12.0+mc1.21.11" = _bacofMP2;
        "pkg-1.13.0+mc26.1-neoforge" = _KUrBN6Em;
