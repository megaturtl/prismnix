...
let
    versions = (let
        ...
        _yDprNSjg = {
            "id" = "yDprNSjg";
            "file" = "LimitedMaces-1.3.0.jar";
            "hash" = "sha512-B37V9/eVoVSRtBE9ukNXXQUql+3CxpQCEt/H018a1eS61v8ly1dhQmdjW8gVTDSiJfDOWMAzut8r9eldzfe4dw==";
        };
    in {
        "JrGT8sXk" = _JrGT8sXk;
        "UdTWvpHy" = _UdTWvpHy;
        ...
        "paper-1.21" = _yDprNSjg;
        "paper-1.21.1" = _yDprNSjg;
        "paper-1.21.2" = _yDprNSjg;
        "paper-1.21.3" = _yDprNSjg;
        "paper-1.21.4" = _yDprNSjg;
        "paper-1.21.5" = _yDprNSjg;
        "paper-1.21.6" = _yDprNSjg;
        "paper-1.21.7" = _yDprNSjg;
        "paper-1.21.8" = _yDprNSjg;
        "paper-1.21.9" = _yDprNSjg;
        "paper-1.21.10" = _yDprNSjg;
        "paper-1.21.11" = _yDprNSjg;
        "paper-26.1" = _QXmtLic4;
        "paper-26.1.1" = _QXmtLic4;
        "paper-26.1.2" = _QXmtLic4;
        "paper-26.2" = _QXmtLic4;
        "purpur-1.21" = _yDprNSjg;
        "purpur-1.21.1" = _yDprNSjg;
        "purpur-1.21.2" = _yDprNSjg;
        "purpur-1.21.3" = _yDprNSjg;
        "purpur-1.21.4" = _yDprNSjg;
        "purpur-1.21.5" = _yDprNSjg;
        "purpur-1.21.6" = _yDprNSjg;
        "purpur-1.21.7" = _yDprNSjg;
        "purpur-1.21.8" = _yDprNSjg;
        "purpur-1.21.9" = _yDprNSjg;
        "purpur-1.21.10" = _yDprNSjg;
        "purpur-1.21.11" = _yDprNSjg;
        ...
        "folia-1.21" = _yDprNSjg;
        "folia-1.21.1" = _yDprNSjg;
        "folia-1.21.2" = _yDprNSjg;
        "folia-1.21.3" = _yDprNSjg;
        "folia-1.21.4" = _yDprNSjg;
        "folia-1.21.5" = _yDprNSjg;
        "folia-1.21.6" = _yDprNSjg;
        "folia-1.21.7" = _yDprNSjg;
        "folia-1.21.8" = _yDprNSjg;
        "folia-1.21.9" = _yDprNSjg;
        "folia-1.21.10" = _yDprNSjg;
        "folia-1.21.11" = _yDprNSjg;
        "pkg-1.0" = _JrGT8sXk;
        "pkg-1.1.0" = _UdTWvpHy;
        "pkg-1.1.1" = _96aSM43w;
        "pkg-1.1.2" = _NQbrZxu2;
