...
let
    ...
    in {
        ...
        "pkg-1.19.2-0.6.3-2" = _4p8UsdfB;
        "pkg-1.20.1-0.7.0-0" = _XrUAfPNA;
        "pkg-1.20.1-0.7.0-1" = _waMD1Mi1;
        "pkg-1.20.1-0.7.0-2" = _5LTlksag;
        "pkg-1.16.5-0.3.1-0" = _4VmsPLMu;
        "pkg-1.18.2-0.5.4-0" = _jOhujNAQ;
        "pkg-1.19.2-0.6.4-0" = _VVALdYRN;
        "pkg-1.20.1-0.7.0-3" = _xRYKEyrl;
        "pkg-1.20.1-0.7.0-4" = _VBTRyrID;
        "pkg-1.21.1-0.8.0-0" = _aQ5MR737;
        "pkg-1.21.1-0.8.1-0" = _t4X2hZIL;
        "pkg-1.21.1-0.8.1-2" = _kOZ0kCgb;
        "pkg-1.20.1-0.7.1" = _B8Qmuq3B;
        "pkg-1.19.2-0.6.5-0" = _XK6vsH3l;
        "pkg-1.21.1-0.8.1-3" = _l3mkkJON;
        "pkg-1.20.1-0.7.1-1" = _BrPJdCdT;
        "pkg-1.18.2-0.5.5-0" = _Z0Ca6F1x;
        "pkg-1.19.2-0.6.5-2" = _IbwE6AJ2;
        "pkg-1.20.1-0.7.1-2" = _ZxV9ndWI;
        "pkg-1.21.1-0.8.1-4" = _ssVrg1JG;
        "pkg-1.20.1-0.7.1-3" = _z6Jk6RyA;
        "pkg-1.16.5-0.3.2-0" = _mPz4mYYD;
        "pkg-1.12.1-0.9.1" = _gWxrVLys;
        "pkg-1.16.5-0.3.3-4" = _i9umES7L;
        "pkg-1.18.2-0.5.6-4" = _gaGih56V;
        "pkg-1.19.2-0.6.6-4" = _N7eUCTHx;
        "pkg-1.20.1-0.7.2-4" = _fFBJuMhy;
        "pkg-1.21.1-0.9.2-4" = _YTMX8COR;
        "pkg-1.16.5-0.3.3-5" = _RemAgKWd;
        "pkg-1.18.2-0.5.6-5" = _I0j87Wod;
        "pkg-1.19.2-0.6.6-5" = _K2Na0xVD;
        "pkg-1.20.1-0.7.2-5" = _yHAF0oB4;
        "pkg-1.21.1-0.9.2-5" = _m4bjqz5i;
        "pkg-1.16.5-0.3.4" = _zTQw7kWz;
        "pkg-1.18.2-0.5.7" = _KyGMwcsu;
        "pkg-1.19.2-0.6.7" = _GW0KegD4;
        "pkg-1.20.1-0.7.3" = _qALmOJyV;
        "pkg-1.21.1-0.9.3" = _M4uxElUM;
        "pkg-1.16.5-0.3.5-0" = _dPX4ooeG;
        "pkg-1.18.2-0.5.8-0" = _kjusgMD3;
        "pkg-1.19.2-0.6.8-0" = _ZdFyoR2J;
        "pkg-1.20.1-0.7.4-0" = _DOUYqrIW;
        "pkg-1.21.1-0.9.4-0" = _gZq2Y0I8;
        "pkg-1.16.5-0.3.5-1" = _AsKl62nb;
        "pkg-1.18.2-0.5.8-1" = _zB2E03pt;
        "pkg-1.19.2-0.6.8-1" = _vwBudPIg;
        "pkg-1.20.1-0.7.4-1" = _L7cH9Kz4;
        "pkg-1.21.1-0.9.4-1" = _zHMY8fME;
        "pkg-1.16.5-0.3.5-2" = _sxaP4A47;
        "pkg-1.18.2-0.5.8-2" = _VeXINo7d;
        "pkg-1.19.2-0.6.8-2" = _sDDD34uG;
        "pkg-1.20.1-0.7.4-2" = _JnyCj5NS;
        "pkg-1.21.1-0.9.4-2" = _pxFIJI7T;
        "pkg-1.21.1-1.0.0-0" = _4sPMmVeB;
        "pkg-1.21.1-1.0.0-1" = _CQHIka5q;
        "pkg-1.21.1-1.0.0-2" = _1n0bqvca;
        "pkg-1.21.1-1.0.1-0" = _JQoEMosy;
        "pkg-1.20.1-1.0.1-0" = _uiULspJt;
        "pkg-1.21.1-1.0.3" = _T7I9wtoR;
        "pkg-1.21.1-1.0.4" = _vIgOKNzd;
        "pkg-1.20.1-1.0.4" = _cp5Lpac0;
        "pkg-1.21.1-1.0.5" = _q7jOKA2V;
        "pkg-1.21.1-1.0.6" = _BUMNMemv;
        "pkg-1.20.1-1.0.6" = _vUJgzL56;
        "pkg-1.21.1-1.0.7" = _slB2WiIX;
        "pkg-1.20.1-1.0.7" = _c3OZK0SN;
        "pkg-1.21.1-1.0.8" = _uXAEsRkb;
        "pkg-1.20.1-1.0.8" = _HHIqfieg;
        "pkg-1.21.1-1.0.9" = _tadixxNI;
        "pkg-1.20.1-1.0.9" = _zXPI2VMd;
        "pkg-1.21.1-1.0.10" = _Tzw8qdiL;
