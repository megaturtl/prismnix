...
let
    ...
    in {
        ...
        "pkg-1.0.0+mc1.21.9-fabric" = _t98o7Bip;
        "pkg-1.0.0+mc1.21.9-neoforge" = _1TRKDSm7;
        "pkg-1.0.0+mc1.21.9-forge" = _q9wPzlTS;
        "pkg-1.0.1+mc1.21.9-fabric" = _eUkAFSCX;
        "pkg-1.0.1+mc1.21.9-neoforge" = _sIKBag14;
        "pkg-1.0.2+mc1.21.1-fabric" = _cgIZ0c54;
        "pkg-1.0.2+mc1.21.9-fabric" = _UD0OYJa8;
        "pkg-1.0.3+mc1.20.1-forge" = _P9xaAl8r;
        "pkg-1.0.3+mc1.21.1-fabric" = _xWTIin8n;
        "pkg-1.0.3+mc1.21.1-neoforge" = _gwGhH1hi;
        "pkg-1.0.3+mc1.21.9-fabric" = _3kkEr4Sq;
        "pkg-1.0.3+mc1.21.9-forge" = _tBEmjsZK;
        "pkg-1.0.3+mc1.21.9-neoforge" = _mVSYXh2O;
        "pkg-1.0.3+mc1.21.10-fabric" = _EZd8mdeF;
        "pkg-1.0.3+mc1.21.10-neoforge" = _7UKD0zXS;
        "pkg-1.0.3+mc1.21.10-forge" = _PYOrmk9v;
        "pkg-1.1.0+mc1.20.1-forge" = _To1WlK7w;
        "pkg-1.1.0+mc1.21.1-neoforge" = _hVG9lWep;
        "pkg-1.1.0+mc1.21.10-forge" = _cQvYJo64;
        "pkg-1.1.0+mc1.21.10-neoforge" = _3oO2bVXA;
        "pkg-1.1.0+mc1.21.1-fabric" = _hw8k13Xy;
        "pkg-1.1.0+mc1.21.10-fabric" = _7h1Ldd51;
        "pkg-1.2.0+mc1.21.10-neoforge" = _DeALq4II;
        "pkg-1.2.0+mc1.21.1-neoforge" = _zRnaWb76;
        "pkg-1.2.0+mc1.20.1-forge" = _1BuUnx5X;
        "pkg-1.2.0+mc1.21.10-forge" = _gtwRXSxM;
        "pkg-1.2.0+mc1.21.10-fabric" = _Npoaryy4;
        "pkg-1.2.1+mc1.20.1-forge" = _gEiCPEVU;
        "pkg-1.2.0+mc1.21.1-fabric" = _qGs5n2xF;
        "pkg-1.2.0+mc1.21.11-fabric" = _gfHQeSbI;
        "pkg-1.2.1+mc1.21.10-fabric" = _wcDFqfz7;
        "pkg-1.2.0+mc1.21.11-forge" = _UvPY1Fy7;
        "pkg-1.2.0+mc1.21.11-neoforge" = _e6tbbncz;
        "pkg-1.3.0+mc1.21.11-neoforge" = _AEioUWEi;
        "pkg-1.3.0+mc1.21.10-neoforge" = _yinkloz9;
        "pkg-1.3.0+mc1.21.1-neoforge" = _G0EDh5D4;
        "pkg-1.3.0+mc1.21.11-forge" = _hNyddy1A;
        "pkg-1.3.0+mc1.21.10-forge" = _FV7io8qz;
        "pkg-1.3.0+mc1.21.11-fabric" = _qXXUjJYv;
        "pkg-1.3.0+mc1.21.10-fabric" = _I6UIEOQH;
        "pkg-1.3.0+mc1.20.1-forge" = _d6xdOz5S;
        "pkg-1.3.0+mc1.21.1-fabric" = _yKonjK2n;
        "pkg-1.4.0+mc1.21.1-fabric" = _pS5KkNFs;
        "pkg-1.4.1+mc1.21.1-fabric" = _6k1xLKkY;
        "pkg-1.4.2+mc1.21.1-fabric" = _Yy6EJpL4;
        "pkg-1.4.3+mc1.21.1-fabric" = _rfVw4eGc;
        "pkg-1.4.4+mc1.21.1-fabric" = _LU2IId3y;
        "pkg-1.5.0+mc1.21.1-fabric" = _XSVOomgA;
        "pkg-1.5.0+mc1.21.10-fabric" = _cfncLSGM;
        "pkg-1.5.0+mc1.21.11-fabric" = _ZdUbKLll;
        "pkg-1.5.0+mc1.21.11-neoforge" = _wgH1hTdS;
        "pkg-1.5.0+mc1.21.10-neoforge" = _P6RsVNIQ;
        "pkg-1.5.0+mc1.21.1-neoforge" = _dQSSgnIT;
        "pkg-1.5.0+mc1.20.1-forge" = _fVxXur8W;
        "pkg-1.5.0+mc1.21.11-forge" = _Om1NcwTv;
        "pkg-1.5.0+mc1.21.10-forge" = _UHKCvuDR;
        "pkg-1.5.1+mc1.20.1-forge" = _6DERWOaI;
        "pkg-1.5.0+mc26.1-snapshot-3-neoforge" = _s7PGBXmy;
        "pkg-1.5.0+mc26.1-snapshot-4-fabric" = _lK5B61vu;
        "pkg-1.5.0+mc26.1-snapshot-4-neoforge" = _Kim2AN6q;
        "pkg-1.6.0+mc1.21.11-fabric" = _vbWY61HB;
        "pkg-1.6.0+mc1.21.10-fabric" = _ju08sgMj;
        "pkg-1.6.1+mc1.21.1-fabric" = _hwhzx63Q;
        "pkg-1.6.1+mc1.21.10-fabric" = _9uwj6Pz3;
        "pkg-1.6.1+mc1.21.11-fabric" = _E5eLcJQU;
        "pkg-1.6.1+mc1.21.11-neoforge" = _ZSaVjxpL;
        "pkg-1.6.1+mc1.21.10-neoforge" = _sB2OfQlu;
        "pkg-1.6.1+mc1.21.1-neoforge" = _vR6DAz6q;
        "pkg-1.6.1+mc1.20.1-forge" = _QvwRaYEr;
        "pkg-1.6.1+mc1.21.11-forge" = _W9ic1oRC;
        "pkg-1.6.1+mc1.21.10-forge" = _yUWJvBM6;
        "pkg-1.6.1+mc26.1-snapshot-7-fabric" = _i3RfeS7d;
        "pkg-1.6.1+mc26.1-snapshot-7-neoforge" = _U4EUUs7N;
        "pkg-1.6.1+mc26.1-fabric" = _jsmOoiNf;
        "pkg-1.6.1+mc26.1-neoforge" = _E5kWlUHE;
        "pkg-1.6.2+mc1.20.1-forge" = _PyvaN2yN;
        "pkg-1.6.2+mc1.21.1-neoforge" = _wVtx1KCd;
        "pkg-1.6.2+mc1.21.10-neoforge" = _5jKEAG6X;
        "pkg-1.6.2+mc1.21.11-neoforge" = _45ka1rLN;
        "pkg-1.6.2+mc1.21.11-forge" = _rIaD0vf6;
        "pkg-1.6.2+mc1.21.10-forge" = _hho0ILr1;
        "pkg-1.6.2+mc26.1-neoforge" = _nlrD38U1;
        "pkg-1.6.3+mc26.1-fabric" = _fT0O5i9T;
        "pkg-1.6.2+mc1.21.11-fabric" = _GSSAGQYd;
        "pkg-1.6.2+mc1.21.10-fabric" = _iDojBb92;
        "pkg-1.6.2+mc1.21.1-fabric" = _TXGNum0V;
        "pkg-26.1.1.0" = _mhVzHOS5;
        "pkg-26.1.2.1" = _eVs6PTgJ;
        "pkg-1.7.0+mc1.21.1-neoforge" = _6BGsBQTu;
        "pkg-1.7.0+mc1.21.1-fabric" = _uEiBQhaD;
        "pkg-26.1.2.2" = _JTh9Hf2R;
        "pkg-26.1.2.100" = _zw2x4fO4;
        "pkg-26.1.2.110" = _lcXU69mX;
        "pkg-26.1.2.111" = _VPjIVj5W;
        "pkg-26.1.2.120" = _PRkroCM0;
        "pkg-26.1.2.121" = _Fatx3uAT;
        "pkg-26.1.2.122" = _7WGrzL75;
        "pkg-26.1.2.123" = _uKePKmdO;
        "pkg-26.1.2.124" = _9sDYqEAA;
        "pkg-26.1.2.200" = _tIOus4wg;
        "pkg-26.1.2.201" = _111jHTBc;
        "pkg-26.2.0" = _uZXcfx5g;
