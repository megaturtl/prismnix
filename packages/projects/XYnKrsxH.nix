...
let
    versions = (let
        ...
        _IvLfuKoU = {
            "id" = "IvLfuKoU";
            "file" = "InventoryParticles-3.0.0+1.20.1+fabric.jar";
            "hash" = "sha512-eNXxgG1ES8Qk6reLHTEpPp80Uj9GSAZ9ldSz5751rn6WqGn4LM23+RyOUwe9ZDfVD1BxX/BjrYB0vEQQMeYGRQ==";
        };
        _xX0n9s9n = {
            "id" = "xX0n9s9n";
            "file" = "InventoryParticles-3.0.0+1.21.1+fabric.jar";
            "hash" = "sha512-GvJiTyEpCre5JwILsmTjAeAo5IiM6J7PZgs/j4Ek4vqELexfrkqGr/pU6jiWj+3wI8znhRLiyYRZAA0kPgFR1A==";
        };
        _L1VlZDbz = {
            "id" = "L1VlZDbz";
            "file" = "InventoryParticles-3.0.0+1.21.11+fabric.jar";
            "hash" = "sha512-K7BpBlUQaCjVCnMyWedd8cGEGEpDn/YXHItC54v807dK0qJkbdxBo6qmF98xcCuqxVRNKmXl71WyqXlNjMuCEA==";
        };
        _ddxYFox8 = {
            "id" = "ddxYFox8";
            "file" = "InventoryParticles-3.0.0+26.1+fabric.jar";
            "hash" = "sha512-B2mcVgzX+3qq4qVfVemQjEI2hs3w+ILKD25F8BSRMgGQ0UzotiUWIGiENtWq1aPd0lWgXVs4DhbzkkO9plkVTw==";
        };
        _oHnynl9g = {
            "id" = "oHnynl9g";
            "file" = "InventoryParticles-3.0.0+26.2+fabric.jar";
            "hash" = "sha512-xh/Sy0mgn89xL+xOJFLLzDuFkZoUQ18YBAeCdgZG7sAF5CDq7lETigTZ1ZU+iFCpClt3nXOGstgMMq8EjMJNbg==";
        };
        _YVWIP5nv = {
            "id" = "YVWIP5nv";
            "file" = "InventoryParticles-3.0.0+1.21.1+neoforge.jar";
            "hash" = "sha512-wUtd7zJMpCMz6MI1R9EH7JEcDHvDBqVtxMH/hw5/gJfL/QwzI4vVc5eXSarz7jzhMdkSEp6oGEHMGgPkDzoJFw==";
        };
        _9r28VcjC = {
            "id" = "9r28VcjC";
            "file" = "InventoryParticles-3.0.0+1.21.11+neoforge.jar";
            "hash" = "sha512-HUGvNDSer3Z96L48nGlelq2wKxQtJnRLq53/aRyEn+2+JyZcthYGQ5xT5UzjPollgc5DLNJESydqPtFDo0wp7Q==";
        };
        _UivEepUO = {
            "id" = "UivEepUO";
            "file" = "InventoryParticles-3.0.0+26.1+neoforge.jar";
            "hash" = "sha512-irwjTm9D8lj050Hg5eApiqu4RgWZlBd2prcT5X5n3zoCsdm4on02cJE3Hnrfov/mKptw60tXaZTc78b7/dCi3w==";
        };
        _RaQWKCIP = {
            "id" = "RaQWKCIP";
            "file" = "InventoryParticles-3.0.0+26.2+neoforge.jar";
            "hash" = "sha512-hf+H8O+6RRbfemarhYBmO6qMExrBaFJWsOB+M5DJjnMrEGdxJm4QyUvfasrjiHH+7Y+vN0D9KOojA1M+erhz6w==";
        };
        _ruz2O5DP = {
            "id" = "ruz2O5DP";
            "file" = "InventoryParticles-3.0.0+1.20.1+forge.jar";
            "hash" = "sha512-nPVBXfV4VMrFNEJyMvwfUyBev7LT2scJ59My82Mig4Rf+nurZ+tYsyRRrS8Jisy0LW4nlF9NFeLvFyBxGML7cQ==";
        };
        _27gv8XUC = {
            "id" = "27gv8XUC";
            "file" = "InventoryParticles-3.1.0+1.20.1+fabric.jar";
            "hash" = "sha512-yhUCc9jdqEm+iRfFstUk6u3pP5Nl99nV/RI1nf6EoRYwI8WNi6IdcYIY2H2sfFb76SmfZfdIVF8mLQ3SL7WsyA==";
        };
        _V4VCpsNy = {
            "id" = "V4VCpsNy";
            "file" = "InventoryParticles-3.1.0+1.21.1+fabric.jar";
            "hash" = "sha512-0e/ozb9zeGEw523ylH0CN4YsRQvNd6kJadmo7pWJVqC9vYE2AFonf/p4ybCFWS3to/znsxlN4mxPALY/odtimw==";
        };
        _AmujJzdo = {
            "id" = "AmujJzdo";
            "file" = "InventoryParticles-3.1.0+1.21.11+fabric.jar";
            "hash" = "sha512-n7N5aE9PXJjhNy4JiY354CSfycN4nf05lerVBWJKIE5EqdQQmmezVE1VYpB6BWOhe47wNgYge6S6cwDAe/XY6Q==";
        };
        _z4fFnT1a = {
            "id" = "z4fFnT1a";
            "file" = "InventoryParticles-3.1.0+26.1+fabric.jar";
            "hash" = "sha512-bK5RCfC1o0XsL4N1rDlXSCeD+oe6MZPss3llRhts00eR3LYXuUlsWL77wEIZ9B9oVt3CoN3++uODPbOEkn2XsA==";
        };
        _ll9yicH2 = {
            "id" = "ll9yicH2";
            "file" = "InventoryParticles-3.1.0+26.2+fabric.jar";
            "hash" = "sha512-3D3wGsylhflAmm1ALhRzoeLr1FFUoYVDP42436w9SqhoRzG03AQV/IVGPhCNdfhcFCCgP1biShzp9r6kEaKE3A==";
        };
        _Kc7YntZN = {
            "id" = "Kc7YntZN";
            "file" = "InventoryParticles-3.1.0+1.21.1+neoforge.jar";
            "hash" = "sha512-FMqspW3o9Ti6tZ15FUzt7sWDfYoZMMDas6gzQVP5tHh0R7hXdOuziCJkngF5TdIe48iBINhBoTXeinEXCLpSSQ==";
        };
        _o82D3eHg = {
            "id" = "o82D3eHg";
            "file" = "InventoryParticles-3.1.0+1.21.11+neoforge.jar";
            "hash" = "sha512-fgmsw9rCdWrHOhoBq+/FT4EleU1UUOqnhHvwWgtd9MZhA6sc8cos3/1NI9S9FDylyJlqb9/HA0C9s70+R7XWew==";
        };
        _3oaPsl18 = {
            "id" = "3oaPsl18";
            "file" = "InventoryParticles-3.1.0+26.1+neoforge.jar";
            "hash" = "sha512-+uwiOI5Gky0bj9NM44XqHShzkw8WiQLeNIxZnhkCQy8+laie3SWtuFT+DLyNs5sAM08sKd54+vCEsZ+q+36e+Q==";
        };
        _ziZE5dmi = {
            "id" = "ziZE5dmi";
            "file" = "InventoryParticles-3.1.0+26.2+neoforge.jar";
            "hash" = "sha512-MoOUymtiViGIHbSEzPiAGLKLVgqUEO2bNJZhTleB+sgOBWdAQAYtyvrFZJgU8EclO92ufgdea0bcPVt2htF0eA==";
        };
        _okJxZefP = {
            "id" = "okJxZefP";
    ...
    in {
        ...
        "pkg-1.1.0+1.21" = _BnD6XGFp;
        "pkg-1.1.0+1.21.1" = _3fBmFDlZ;
        "pkg-1.1.0+1.20.1" = _jRbXPADh;
        "pkg-1.1.0+1.21.2" = _ZnKVmHHI;
        "pkg-1.1.0+1.21.8" = _oDj3RBUk;
        "pkg-1.1.0+1.21.3" = _XHMWVyDS;
        "pkg-1.1.0+1.21.6" = _iUkamjUy;
        "pkg-1.1.0+1.21.7" = _OhAgUzt9;
        "pkg-1.1.1+1.20.1" = _3hMR9ZUZ;
        "pkg-1.1.1+1.21" = _eC1zXKVj;
        "pkg-1.1.1+1.21.1" = _fu2RJyTT;
        "pkg-1.1.1+1.21.2" = _NhqUnScP;
        "pkg-1.1.1+1.21.3" = _MYdcMq9M;
        "pkg-1.1.1+1.21.4" = _2NJl6ovi;
        "pkg-1.1.1+1.21.5" = _PPkSovbb;
        "pkg-1.1.1+1.21.6" = _gtyvpF11;
        "pkg-1.1.1+1.21.7" = _xSt74nDF;
        "pkg-1.1.1+1.21.8" = _V2ofanOa;
        "pkg-1.2.0+1.20.1" = _Bm20dKfG;
        "pkg-1.2.0+1.21" = _kcrw0Fhh;
        "pkg-1.2.0+1.21.1" = _SrfGnbfC;
        "pkg-1.2.0+1.21.2" = _HaQmexkZ;
        "pkg-1.2.0+1.21.3" = _p9bqpoWw;
        "pkg-1.2.0+1.21.4" = _QcrnWHFN;
        "pkg-1.2.0+1.21.5" = _UTX8DQSI;
        "pkg-1.2.0+1.21.6" = _osw58FtQ;
        "pkg-1.2.0+1.21.7" = _3dToHrOF;
        "pkg-1.2.0+1.21.8" = _jUV9VPrI;
        "pkg-1.2.0+1.21.9" = _WfS6qTWQ;
        "pkg-1.2.0+1.21.10" = _X48OYhNg;
        "pkg-1.2.1+1.20.1" = _ocnqQQRB;
        "pkg-1.2.1+1.21" = _mtxVzEnI;
        "pkg-1.2.1+1.21.1" = _wZiw5q2X;
        "pkg-1.2.1+1.21.2" = _iHuWFwU6;
        "pkg-1.2.1+1.21.3" = _N6XnUWLq;
        "pkg-1.2.1+1.21.4" = _EH4gIq1g;
        "pkg-1.2.1+1.21.5" = _UAWJGsU9;
        "pkg-1.2.1+1.21.6" = _IRdkeUzB;
        "pkg-1.2.1+1.21.7" = _oZMPjtor;
        "pkg-1.2.1+1.21.8" = _mU5bq4ZP;
        "pkg-1.2.1+1.21.9" = _8EMdu6mV;
        "pkg-1.2.1+1.21.10" = _a848lBGG;
        "pkg-1.2.1+1.20.1+forge" = _wP44dThB;
        "pkg-1.2.1+1.21.1+neoforge" = _e06AZuWX;
        "pkg-1.2.1+1.21.10+neoforge" = _umuGOpo5;
        "pkg-1.2.1+1.20.1+fabric" = _pUCHOo9v;
        "pkg-1.2.1+1.21.1+fabric" = _PFOK7Oe7;
        "pkg-1.2.1+1.21.4+fabric" = _gvJ0qJCq;
        "pkg-1.2.1+1.21.5+fabric" = _7CIf6kov;
        "pkg-1.2.1+1.21.6+fabric" = _NkhqtLz1;
        "pkg-1.2.1+1.21.7+fabric" = _ePzp4TrU;
        "pkg-1.2.1+1.21.8+fabric" = _IsXWtqha;
        "pkg-1.2.1+1.21.9+fabric" = _5m9LdRci;
        "pkg-1.2.1+1.21.10+fabric" = _h0eXm8ov;
        "pkg-1.2.1+1.21.11+neoforge" = _i1vkUU2x;
        "pkg-1.2.1+1.21.11+fabric" = _fdPbGGx1;
        "pkg-1.2.2+1.20.1+fabric" = _65QhxRk2;
        "pkg-1.2.2+1.21.1+fabric" = _sUiOD9Yu;
        "pkg-1.2.2+1.21.4+fabric" = _gTAXRi2g;
        "pkg-1.2.2+1.21.5+fabric" = _bTMH6NJ6;
        "pkg-1.2.2+1.21.6+fabric" = _wGM8MvWT;
        "pkg-1.2.2+1.21.7+fabric" = _BDO99STL;
        "pkg-1.2.2+1.21.8+fabric" = _AjKbAAnz;
        "pkg-1.2.2+1.21.9+fabric" = _qt4NXHEf;
        "pkg-1.2.2+1.21.10+fabric" = _Metlzq4H;
        "pkg-1.2.2+1.21.11+fabric" = _fRZvMS8S;
        "pkg-1.2.2+1.20.1+forge" = _9Lc9BWEe;
        "pkg-1.2.2+1.21.1+neoforge" = _MIoqv5xK;
        "pkg-1.2.2+1.21.10+neoforge" = _hdulxogx;
        "pkg-1.2.2+1.21.11+neoforge" = _Rwxat4xT;
        "pkg-1.3.0+1.20.1+fabric" = _nQ1WU79F;
        "pkg-1.3.0+1.21.1+fabric" = _QBuAslkU;
        "pkg-1.3.0+1.21.4+fabric" = _TqsyvA3A;
        "pkg-1.3.0+1.21.5+fabric" = _xt27b7np;
        "pkg-1.3.0+1.21.6+fabric" = _Au2EmEhd;
        "pkg-1.3.0+1.21.7+fabric" = _RyA4ztMX;
        "pkg-1.3.0+1.21.8+fabric" = _kfgWVzEr;
        "pkg-1.3.0+1.21.9+fabric" = _WUgrgJNn;
        "pkg-1.3.0+1.21.10+fabric" = _H85lbHgt;
        "pkg-1.3.0+1.21.11+fabric" = _O5qx0CdY;
        "pkg-1.3.0+1.20.1+forge" = _miy6hnnk;
        "pkg-1.3.0+1.21.1+neoforge" = _2lQpr5En;
        "pkg-1.3.0+1.21.10+neoforge" = _XGBrMvDu;
        "pkg-1.3.0+1.21.11+neoforge" = _lCAXzbHF;
        "pkg-1.3.1+1.20.1+fabric" = _TTsJ2UE4;
        "pkg-1.3.1+1.21.1+fabric" = _93lLtEss;
        "pkg-1.3.1+1.21.4+fabric" = _NbGTRYwD;
        "pkg-1.3.1+1.21.5+fabric" = _hma5nry3;
        "pkg-1.3.1+1.21.6+fabric" = _BRcpfL50;
        "pkg-1.3.1+1.21.7+fabric" = _LWytudhQ;
        "pkg-1.3.1+1.21.8+fabric" = _wrZSco4U;
        "pkg-1.3.1+1.21.9+fabric" = _c40kUrL7;
        "pkg-1.3.1+1.21.10+fabric" = _bSVxRiGc;
        "pkg-1.3.1+1.21.11+fabric" = _h7ciDjXm;
        "pkg-1.3.1+1.20.1+forge" = _xYG5p74p;
        "pkg-1.3.1+1.21.1+neoforge" = _JdJISTuk;
        "pkg-1.3.1+1.21.10+neoforge" = _ijCxUV1F;
        "pkg-1.3.1+1.21.11+neoforge" = _b9Wg3sKO;
        "pkg-1.3.1.1+1.20.1+forge" = _77DlUO0J;
        "pkg-1.3.2+1.20.1+fabric" = _Pq8AGGrc;
        "pkg-1.3.2+1.21.1+fabric" = _rUdve7Qw;
        "pkg-1.3.2+1.21.4+fabric" = _CIZZuWk3;
        "pkg-1.3.2+1.21.5+fabric" = _9RD3TZhX;
        "pkg-1.3.2+1.21.6+fabric" = _bKQ8grp2;
        "pkg-1.3.2+1.21.7+fabric" = _Tr4cZs98;
        "pkg-1.3.2+1.21.8+fabric" = _ybeXmMXb;
        "pkg-1.3.2+1.21.9+fabric" = _OEcATskn;
        "pkg-1.3.2+1.21.10+fabric" = _qWn5b2sl;
        "pkg-1.3.2+1.21.11+fabric" = _JRAYiQO3;
        "pkg-1.3.2+1.20.1+forge" = _N2h3ZrRW;
        "pkg-1.3.2+1.21.1+neoforge" = _qFxkpJ3E;
        "pkg-1.3.2+1.21.10+neoforge" = _cqAT318G;
        "pkg-1.3.2+1.21.11+neoforge" = _FW5zCqJy;
        "pkg-1.4.0+1.20.1+fabric" = _x0eqE2Pt;
        "pkg-1.4.0+1.21.1+fabric" = _nVMVUmjO;
        "pkg-1.4.0+1.21.4+fabric" = _jnlhtLeD;
        "pkg-1.4.0+1.21.5+fabric" = _QIYGfSTe;
        "pkg-1.4.0+1.21.6+fabric" = _hInodyBy;
        "pkg-1.4.0+1.21.7+fabric" = _YHHzHYfM;
        "pkg-1.4.0+1.21.8+fabric" = _RE65cjTR;
        "pkg-1.4.0+1.21.9+fabric" = _1twseEhH;
        "pkg-1.4.0+1.21.10+fabric" = _WvkeIaqC;
        "pkg-1.4.0+1.21.11+fabric" = _IaMHyBwi;
        "pkg-1.4.0+1.20.1+forge" = _LNJz5zJn;
        "pkg-1.4.0+1.21.1+neoforge" = _wEey5BiD;
        "pkg-1.4.0+1.21.10+neoforge" = _ismBw2w1;
        "pkg-1.4.0+1.21.11+neoforge" = _W6GsZd7x;
        "pkg-1.5.0+1.21.1+neoforge" = _WvKZcWyP;
        "pkg-1.5.0+1.20.1+fabric" = _mJTcjuBm;
        "pkg-1.5.0+1.20.1+forge" = _HnPcjDe2;
        "pkg-1.5.0+1.21.10+neoforge" = _v1QTWMuN;
        "pkg-1.5.0+1.21.1+fabric" = _Y7AW04Ou;
        "pkg-1.5.0+1.21.11+neoforge" = _W4fgv4NK;
        "pkg-1.5.0+1.21.4+fabric" = _VJFFHA2V;
        "pkg-1.5.0+1.21.5+fabric" = _q79ifkYa;
        "pkg-1.5.0+1.21.8+fabric" = _7KNHUfTS;
        "pkg-1.5.0+1.21.10+fabric" = _bUgYuDno;
        "pkg-1.5.0+1.21.11+fabric" = _3lLxCn6q;
        "pkg-1.5.0+26.1+fabric" = _LAL3K5Op;
        "pkg-2.0.1+1.20.1+fabric" = _8cbD9HQS;
        "pkg-2.0.1+1.21.1+fabric" = _Uz3myuuQ;
        "pkg-2.0.1+1.21.4+fabric" = _TsAIC9I1;
        "pkg-2.0.1+1.21.5+fabric" = _BABZmNEB;
        "pkg-2.0.1+1.21.8+fabric" = _hGEMVRD8;
        "pkg-2.0.1+1.21.10+fabric" = _VI7aGfQC;
        "pkg-2.0.1+1.21.11+fabric" = _WeA3frUm;
        "pkg-2.0.1+26.1+fabric" = _1hvvuhNc;
        "pkg-2.0.1+1.21.1+neoforge" = _e66zFnoR;
        "pkg-2.0.1+1.21.10+neoforge" = _L1g8nsIp;
        "pkg-2.0.1+1.21.11+neoforge" = _rBezK5zm;
        "pkg-2.0.1+26.1+neoforge" = _4hrbyL3h;
        "pkg-2.0.1+1.20.1+forge" = _DxrUz0RD;
        "pkg-2.1.0+1.20.1+fabric" = _hN6ma0jR;
        "pkg-2.1.0+1.21.1+fabric" = _k57zOMSj;
        "pkg-2.1.0+1.21.4+fabric" = _gPdbzE9D;
        "pkg-2.1.0+1.21.5+fabric" = _Ra8K16kq;
        "pkg-2.1.0+1.21.8+fabric" = _zrYCY3ji;
        "pkg-2.1.0+1.21.10+fabric" = _PD4waR06;
        "pkg-2.1.0+1.21.11+fabric" = _dotKvqnL;
        "pkg-2.1.0+26.1+fabric" = _ZghDIGQ6;
        "pkg-2.1.0+1.21.1+neoforge" = _WghkDEe1;
        "pkg-2.1.0+1.21.10+neoforge" = _5FB8eflM;
        "pkg-2.1.0+1.21.11+neoforge" = _O1CWzPgF;
        "pkg-2.1.0+26.1+neoforge" = _NEuM70yy;
        "pkg-2.1.0+1.20.1+forge" = _vHsm36q5;
        "pkg-2.2.0+1.20.1+fabric" = _lP3tJh0i;
        "pkg-2.2.0+1.21.1+fabric" = _kTMTSOHr;
        "pkg-2.2.0+1.21.4+fabric" = _QAsupH8c;
        "pkg-2.2.0+1.21.5+fabric" = _KPb4fGP7;
        "pkg-2.2.0+1.21.8+fabric" = _TkDGJYTo;
        "pkg-2.2.0+1.21.10+fabric" = _G7Ln7gSi;
        "pkg-2.2.0+1.21.11+fabric" = _1xnzq6ll;
        "pkg-2.2.0+26.1+fabric" = _fvRnzpPE;
        "pkg-2.2.0+1.21.1+neoforge" = _EYJGMkEu;
        "pkg-2.2.0+1.21.10+neoforge" = _ugQgXo4c;
        "pkg-2.2.0+1.21.11+neoforge" = _R4Wf67iC;
        "pkg-2.2.0+26.1+neoforge" = _LrWPRxgX;
        "pkg-2.2.0+1.20.1+forge" = _uETNX3q7;
        "pkg-2.3.0+1.20.1+fabric" = _ONfEQ7R3;
        "pkg-2.3.0+1.21.1+fabric" = _lSwVwQ38;
        "pkg-2.3.0+1.21.4+fabric" = _MNaNjdmx;
        "pkg-2.3.0+1.21.5+fabric" = _EBudm2b1;
        "pkg-2.3.0+1.21.8+fabric" = _d0uSKcWc;
        "pkg-2.3.0+1.21.10+fabric" = _rsdLqtaP;
        "pkg-2.3.0+1.21.11+fabric" = _6Gb4mmpQ;
        "pkg-2.3.0+26.1+fabric" = _Wo27f7rR;
        "pkg-2.3.0+1.21.1+neoforge" = _qbUtBGFB;
        "pkg-2.3.0+1.21.10+neoforge" = _CRhnMC92;
        "pkg-2.3.0+1.21.11+neoforge" = _WfdxbJrD;
        "pkg-2.3.0+26.1+neoforge" = _e2CunjXY;
        "pkg-2.3.0+1.20.1+forge" = _w9wqolKw;
        "pkg-2.4.0+1.20.1+fabric" = _i4Se3kyb;
        "pkg-2.4.0+1.21.1+fabric" = _M6untRA4;
        "pkg-2.4.0+1.21.4+fabric" = _2QbBVZtn;
        "pkg-2.4.0+1.21.5+fabric" = _bqwEFlbb;
        "pkg-2.4.0+1.21.8+fabric" = _rKOvJYDJ;
        "pkg-2.4.0+1.21.10+fabric" = _3CYUiQ7g;
        "pkg-2.4.0+1.21.11+fabric" = _Ol4jladU;
        "pkg-2.4.0+26.1+fabric" = _nJ1RSOL7;
        "pkg-2.4.0+1.21.1+neoforge" = _oS6hyiwc;
        "pkg-2.4.0+1.21.10+neoforge" = _Ub5eVAkb;
        "pkg-2.4.0+1.21.11+neoforge" = _LL9WUR20;
        "pkg-2.4.0+26.1+neoforge" = _6R5uqNjI;
        "pkg-2.4.0+1.20.1+forge" = _MsKTxMzI;
        "pkg-2.5.0+1.20.1+forge" = _nsM0rNZu;
        "pkg-2.5.0+1.20.1+fabric" = _qDZC5dHy;
        "pkg-2.5.0+1.21.1+fabric" = _JROsUa1m;
        "pkg-2.5.0+1.21.11+fabric" = _m8402Jpb;
        "pkg-2.5.0+26.1+fabric" = _6mFtjoVY;
        "pkg-2.5.0+26.2+fabric" = _XXMbuYQV;
        "pkg-2.5.0+1.21.1+neoforge" = _r1Oom1Ln;
        "pkg-2.5.0+1.21.11+neoforge" = _cLUvSSgN;
        "pkg-2.5.0+26.1+neoforge" = _K9wlAwZN;
        "pkg-2.5.0+26.2+neoforge" = _htx3KqiY;
        "pkg-2.5.1+1.20.1+fabric" = _je4osuQw;
        "pkg-2.5.1+1.21.1+fabric" = _bhxdY8Gv;
        "pkg-2.5.1+1.21.11+fabric" = _UW1csD1Z;
        "pkg-2.5.1+26.1+fabric" = _WIymCsgW;
        "pkg-2.5.1+26.2+fabric" = _uuT4Gb7w;
        "pkg-2.5.1+1.21.1+neoforge" = _ofnmN7tD;
        "pkg-2.5.1+1.21.11+neoforge" = _hRkdFXSj;
        "pkg-2.5.1+26.1+neoforge" = _TFuhtcUC;
        "pkg-2.5.1+26.2+neoforge" = _mZQeAWyg;
        "pkg-2.5.1+1.20.1+forge" = _oNgWH7LI;
        "pkg-2.6.0+1.20.1+fabric" = _w7Nj8IuA;
        "pkg-2.6.0+1.21.1+fabric" = _GreasOxH;
        "pkg-2.6.0+1.21.11+fabric" = _8ZmlXMKl;
        "pkg-2.6.0+26.1+fabric" = _5my9sTrT;
        "pkg-2.6.0+26.2+fabric" = _MlESsFFt;
        "pkg-2.6.0+1.21.1+neoforge" = _GjoaAaKJ;
        "pkg-2.6.0+1.21.11+neoforge" = _5hBeLVBv;
        "pkg-2.6.0+26.1+neoforge" = _U1yKcMvc;
        "pkg-2.6.0+26.2+neoforge" = _exkt35A4;
        "pkg-2.6.0+1.20.1+forge" = _ffq7Zzk6;
        "pkg-3.0.0+1.20.1+fabric" = _IvLfuKoU;
        "pkg-3.0.0+1.21.1+fabric" = _xX0n9s9n;
        "pkg-3.0.0+1.21.11+fabric" = _L1VlZDbz;
        "pkg-3.0.0+26.1+fabric" = _ddxYFox8;
        "pkg-3.0.0+26.2+fabric" = _oHnynl9g;
        "pkg-3.0.0+1.21.1+neoforge" = _YVWIP5nv;
        "pkg-3.0.0+1.21.11+neoforge" = _9r28VcjC;
        "pkg-3.0.0+26.1+neoforge" = _UivEepUO;
        "pkg-3.0.0+26.2+neoforge" = _RaQWKCIP;
        "pkg-3.0.0+1.20.1+forge" = _ruz2O5DP;
        "pkg-3.1.0+1.20.1+fabric" = _27gv8XUC;
        "pkg-3.1.0+1.21.1+fabric" = _V4VCpsNy;
        "pkg-3.1.0+1.21.11+fabric" = _AmujJzdo;
        "pkg-3.1.0+26.1+fabric" = _z4fFnT1a;
        "pkg-3.1.0+26.2+fabric" = _ll9yicH2;
        "pkg-3.1.0+1.21.1+neoforge" = _Kc7YntZN;
        "pkg-3.1.0+1.21.11+neoforge" = _o82D3eHg;
