...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.7.2-forge" = _4MOHNVgN;
        "pkg-1.16.5-2.7.3-forge" = _4rA9P8gr;
        "pkg-1.16.5-2.7.4-forge" = _2aO1Ma50;
        "pkg-1.16.5-2.7.5-forge" = _TUHjqEYO;
        "pkg-1.16.5-2.7.6-forge" = _DrHZmxZv;
        "pkg-1.16.5-2.7.7-forge" = _ZABZoBjw;
        "pkg-1.16.5-2.7.8-forge" = _udFLgj9A;
        "pkg-1.16.5-2.7.9-forge" = _F99P4rcZ;
        "pkg-1.16.5-2.7.10-forge" = _M5JFXUlF;
        "pkg-1.16.5-2.7.11-forge" = _9OUDNk2r;
        "pkg-1.16.5-3.0.0-forge" = _wuWBRjcd;
        "pkg-3.0.1+1.16.5" = _cL3tdZj5;
        "pkg-3.0.2+1.16.5" = _Nwe4jiyb;
        "pkg-3.0.3+1.16.5" = _UNtoG2gp;
        "pkg-3.0.4+1.16.5" = _LTVxPHy9;
        "pkg-3.1.0+1.16.5" = _PCpW6s0p;
        "pkg-3.1.1+1.16.5" = _rP8ab3oJ;
        "pkg-3.1.2+1.16.5" = _NQBaeD1Q;
        "pkg-3.1.3+1.16.5" = _513EC8hp;
        "pkg-3.2.0+1.16.5" = _PVLNN2t5;
        "pkg-3.2.1+1.16.5" = _FWMkE0wV;
        "pkg-3.2.2+1.16.5" = _Rpn8lYGU;
        "pkg-3.2.4+1.16.5" = _f1GEa3Q3;
        "pkg-3.2.5+1.16.5" = _Y2T3dhjJ;
        "pkg-3.2.6+1.16.5" = _X1L11QKv;
        "pkg-3.2.7+1.16.5" = _JlZllr5d;
        "pkg-3.2.8+1.16.5" = _IGta8nmN;
        "pkg-3.2.9+1.16.5" = _pM5jsgGw;
        "pkg-3.3.0+1.16.5" = _LvFcFETc;
        "pkg-3.3.1+1.16.5" = _h2QuDo4A;
        "pkg-3.3.2+1.16.5" = _Y4KJRvS0;
        "pkg-3.3.3+1.16.5" = _AydWDPdj;
        "pkg-3.3.4+1.16.5" = _KUY1qkX6;
        "pkg-3.4.0+1.16.5" = _rU2CdBiZ;
        "pkg-3.4.1+1.16.5" = _8QWkg2Mt;
        "pkg-3.4.2+1.16.5" = _g9K3kNED;
        "pkg-3.4.4+1.16.5" = _rN4bpHcd;
        "pkg-3.4.5+1.16.5" = _agLoxLoL;
        "pkg-3.4.6+1.16.5" = _sc2mFBb5;
        "pkg-4.0.0+1.18" = _pJfgeL4i;
        "pkg-4.0.1+1.18" = _AkBEmgUu;
        "pkg-4.0.3+1.18" = _BBjWVFFY;
        "pkg-4.0.4+1.18" = _PBsfiOcT;
        "pkg-4.0.5+1.18" = _6N5HKQu1;
        "pkg-4.0.6+1.18.1" = _fcEHaP7b;
        "pkg-3.4.7+1.16.5" = _5E3ETVsZ;
        "pkg-4.0.7+1.18.1" = _uFVRnMvB;
        "pkg-4.0.8+1.18.1" = _pVcGDalf;
        "pkg-4.0.9+1.18.1" = _7l1k6eAk;
        "pkg-4.0.10+1.18.1" = _78EIw4um;
        "pkg-4.1.0+1.18.1" = _Na06JMtz;
        "pkg-4.2.0+1.18.1" = _78Z2mgUL;
        "pkg-4.2.1+1.18.1" = _ibSeDcYV;
        "pkg-4.2.2+1.18.1" = _tn40tlp3;
        "pkg-4.2.3+1.18.1" = _pbxgv1q7;
        "pkg-4.2.4+1.18.1" = _moppgXtD;
        "pkg-4.2.5+1.18.1" = _eMNRqRPj;
        "pkg-4.2.6+1.18.1" = _lYD63Uad;
        "pkg-4.2.7+1.18.1" = _UYXWWvub;
        "pkg-4.2.8+1.18.1" = _THWHaE6N;
        "pkg-4.2.9+1.18.1" = _e847niTy;
        "pkg-4.2.10+1.18.1" = _TU23R2zI;
        "pkg-4.2.11+1.18.1" = _ZBuBykLz;
        "pkg-5.0.0+1.18.2" = _P1yQzQ5f;
        "pkg-5.0.1+1.18.2" = _v3kW0zLy;
        "pkg-5.0.2+1.18.2" = _mgFUiAXk;
        "pkg-5.0.3+1.18.2" = _bF7mgmCM;
        "pkg-5.0.4+1.18.2" = _bau2XsXM;
        "pkg-5.1.0+1.18.2" = _DEj3c1hB;
        "pkg-5.1.1+1.18.2" = _gR2h4HNf;
        "pkg-5.1.2+1.18.2" = _BRa9dGPz;
        "pkg-5.1.3+1.18.2" = _uhNUidYw;
        "pkg-5.1.4+1.18.2" = _Wo4V7mCA;
        "pkg-5.1.6+1.18.2" = _G9AASk9o;
        "pkg-5.1.7+1.18.2" = _aMuTNtQI;
        "pkg-5.1.8+1.18.2" = _iwBRXBaA;
        "pkg-5.1.9+1.18.2" = _Kc1SBXe7;
        "pkg-5.1.10+1.18.2" = _ycQl8dQs;
        "pkg-5.1.11+1.18.2" = _C5DUlZlL;
        "pkg-5.1.12+1.18.2" = _OyVswn59;
        "pkg-5.1.13+1.18.2" = _6vwMDJL8;
        "pkg-5.1.14+1.18.2" = _erCGNfvt;
        "pkg-6.0.0+1.19" = _U7hkq9Rt;
        "pkg-6.0.1+1.19" = _i7H4Umb3;
        "pkg-6.0.2+1.19" = _vPUS02PZ;
        "pkg-6.0.3+1.19" = _C9CZ37tr;
        "pkg-6.0.5+1.19" = _QKIrnNfj;
        "pkg-6.0.6+1.19" = _8J2Nc6oV;
        "pkg-6.0.7+1.19" = _TBet759u;
        "pkg-6.0.8+1.19" = _CVGJZgx0;
        "pkg-6.0.9+1.19" = _42DxKXJo;
        "pkg-6.1.0+1.19" = _on5h7UNu;
        "pkg-6.1.1+1.19" = _lgLpyt59;
        "pkg-6.1.2+1.19" = _zpwzRipY;
        "pkg-6.1.3+1.19" = _9vO3bhKf;
        "pkg-6.1.4+1.19" = _ziWz7GGK;
        "pkg-6.2.0+1.19.2" = _YQbMCADD;
        "pkg-6.2.1+1.19.2" = _YjvKDnee;
        "pkg-6.2.2+1.19.2" = _RCdCCwmG;
        "pkg-6.3.0+1.19.2" = _hbSv7i3l;
        "pkg-6.3.1+1.19.2" = _Gohvfof3;
        "pkg-6.3.2+1.19.2" = _zxEkHQGq;
        "pkg-6.3.3+1.19.2" = _N5CZ6iXO;
        "pkg-6.3.4+1.19.2" = _FVQQ7pbs;
        "pkg-6.3.5+1.19.2" = _qB85ik2E;
        "pkg-6.3.6+1.19.2" = _fVG9I0wx;
        "pkg-6.3.7+1.19.2" = _jBEtHQmU;
        "pkg-6.3.8+1.19.2" = _Rr9QysLN;
        "pkg-6.3.9+1.19.3" = _xhLkp4zZ;
        "pkg-6.3.10+1.19.3" = _nckkZ3KF;
        "pkg-6.3.9+1.19.2" = _6nZ3bPPq;
        "pkg-6.3.11+1.19.3" = _gsN4jQzv;
        "pkg-6.3.14+1.19.3-forge" = _seyJy2Tt;
        "pkg-6.3.11+1.19.2" = _vHCWdLM6;
        "pkg-6.3.15+1.19.3-forge" = _KANGX2JC;
        "pkg-6.3.16+1.19.2" = _ctuuFU2P;
        "pkg-6.3.16+1.19.3-forge" = _Cqpt8lZE;
        "pkg-6.3.17+1.19.3-forge" = _pNj22uTU;
        "pkg-6.3.17+1.19.2" = _TQn8BMJB;
        "pkg-6.3.18+1.19.3-forge" = _aEAOApgK;
        "pkg-6.3.18+1.19.2" = _aOwWXoAe;
        "pkg-6.3.19+1.19.3-forge" = _niYgQZ5L;
        "pkg-6.3.19+1.19.4-forge" = _No91i2RW;
        "pkg-6.3.20+1.19.2" = _L7cHWRHn;
        "pkg-6.3.20+1.19.4-forge" = _Prso7QSk;
        "pkg-6.3.21+1.19.2" = _iu3mwBJa;
        "pkg-6.3.21+1.19.4-forge" = _g6V5jA4y;
        "pkg-6.3.22+1.19.4-forge" = _Lg6k338C;
        "pkg-6.3.24+1.19.2" = _IjV783aj;
        "pkg-6.3.24+1.19.4-forge" = _D2wQYBla;
        "pkg-6.3.25+1.19.4-forge" = _Rln71OXd;
        "pkg-7.0.0+1.20-forge" = _GTugr0Ui;
        "pkg-7.1.0+1.20.1-forge" = _5jMlMYD6;
        "pkg-7.1.1+1.20.1-forge" = _MhYWyWTo;
        "pkg-6.3.26+1.19.2" = _bAg6set2;
        "pkg-7.1.3+1.20.1-forge" = _UlmMAUAK;
        "pkg-7.1.4+1.20.1-forge" = _mdGQskFo;
        "pkg-7.1.5+1.20.1-forge" = _JTYpK5Ub;
        "pkg-7.1.6+1.20.1-forge" = _BWV8ahgd;
        "pkg-7.1.7+1.20.1-forge" = _MEwPgaGi;
        "pkg-6.3.27+1.19.2" = _sQkPJL6G;
        "pkg-6.3.28+1.19.2" = _BiTGI9hq;
        "pkg-7.1.10+1.20.1-forge" = _2ZiOqGH0;
        "pkg-7.1.11+1.20.1-forge" = _8ahrmXJX;
        "pkg-7.2.0+1.20.2-neoforge" = _MCoEiP6e;
        "pkg-7.2.1+1.20.2-neoforge" = _OvJpcNGY;
        "pkg-7.2.2+1.20.3-neoforge" = _qRDsqREh;
        "pkg-7.2.2+1.20.4-neoforge" = _RE6B1dyr;
        "pkg-7.2.4+1.20.4-neoforge" = _JBisRTR8;
        "pkg-7.3.0+1.20.4-neoforge" = _j8ppGl1f;
        "pkg-7.3.1+1.20.4-neoforge" = _y5vSiNXW;
        "pkg-7.1.12+1.20.1-forge" = _rHZszS3Z;
        "pkg-7.3.2+1.20.4-neoforge" = _pFwj2JAi;
        "pkg-7.1.13+1.20.1-forge" = _gYwLp8OL;
        "pkg-7.3.3+1.20.4-neoforge" = _f7ZmVLon;
        "pkg-7.1.14+1.20.1-forge" = _57Y1G1vy;
        "pkg-7.3.4+1.20.4-neoforge" = _XW0KxQeF;
        "pkg-7.1.15+1.20.1-forge" = _WdNRfZe7;
        "pkg-7.3.5+1.20.4-neoforge" = _F61uNjdU;
        "pkg-7.4.0+1.20.6-neoforge" = _OBOIv3Kp;
        "pkg-7.4.1+1.20.6-neoforge" = _7TrGwAJH;
        "pkg-7.5.0+1.21-neoforge" = _4lVy2zDE;
        "pkg-7.5.1+1.21-neoforge" = _thmjSy8f;
        "pkg-7.5.2+1.21-neoforge" = _RhhmPHsl;
        "pkg-7.5.3+1.21-neoforge" = _BcxbnEhC;
        "pkg-7.5.4+1.21-neoforge" = _Ic5ncgdq;
        "pkg-7.5.5+1.21.1-neoforge" = _sz14iOhv;
        "pkg-7.5.6+1.21.1-neoforge" = _FnZ4vooc;
        "pkg-7.5.7+1.21.1-neoforge" = _OpUM3YHj;
        "pkg-6.3.29+1.19.2" = _awUlQ9kY;
        "pkg-5.1.15+1.18.2" = _XTb37DQX;
        "pkg-7.5.8+1.21.1-neoforge" = _nP250Ag3;
        "pkg-7.5.9+1.21.1-neoforge" = _T3BXf1p7;
        "pkg-7.5.10+1.21.1-neoforge" = _ACndbqOh;
        "pkg-7.5.11+1.21.1-neoforge" = _9eDFvWme;
        "pkg-7.5.12+1.21.1-neoforge" = _uNoh02J4;
        "pkg-7.5.13+1.21.4-neoforge" = _3xiP7jCr;
        "pkg-7.5.13+1.21.1-neoforge" = _SMiBhBXu;
        "pkg-7.5.15+1.21.4-neoforge" = _n8gjLeRX;
        "pkg-7.5.16+1.21.4-neoforge" = _4QMtCKP0;
        "pkg-7.5.17+1.21.5-neoforge" = _lzcWpoX1;
        "pkg-7.1.17+1.20.1-forge" = _LOn0p5qT;
        "pkg-7.5.15+1.21.1-neoforge" = _AaZFgB9v;
        "pkg-7.5.19+1.21.5-neoforge" = _Y5O2ZubI;
        "pkg-7.5.19+1.21.6-neoforge" = _YhGfP9ST;
        "pkg-7.5.16+1.21.1-neoforge" = _y10NpZvu;
        "pkg-7.5.20+1.21.6-neoforge" = _kVfZhWuX;
        "pkg-7.5.20+1.21.7-neoforge" = _iOgcoSlh;
        "pkg-7.5.21+1.21.7-neoforge" = _oypRcbCu;
        "pkg-7.1.19+1.20.1-forge" = _VS1Ba49d;
        "pkg-7.5.17+1.21.1-neoforge" = _JZcQ5o4Z;
        "pkg-7.5.22+1.21.8-neoforge" = _Rzh6PRj0;
        "pkg-7.5.22+1.21.9-neoforge" = _86uHsyG7;
        "pkg-7.6.0+1.21.11-neoforge" = _Hkfs1Boy;
        "pkg-7.5.18+1.21.1-neoforge" = _fuRQkVgT;
        "pkg-7.6.1+1.21.11-neoforge" = _OGwbW4LO;
        "pkg-7.1.21+1.20.1-forge" = _IITp3pFu;
        "pkg-7.7.0+26.1-neoforge" = _bVRi2IHK;
        "pkg-7.5.19+1.21.1-neoforge" = _ZXEP5aLU;
        "pkg-7.1.22+1.20.1-forge" = _3sBlpdWI;
        "pkg-7.7.2+26.1-neoforge" = _CDYpVo7w;
        "pkg-7.7.3+26.1-neoforge" = _qh8SQ2Zr;
        "pkg-7.1.23+1.20.1-forge" = _e5BSsmZw;
        "pkg-7.5.20+1.21.1-neoforge" = _3S7dWUFu;
        "pkg-7.7.4+26.1-neoforge" = _zAKaM9vW;
        "pkg-7.1.24+1.20.1-forge" = _IOFBvdFx;
