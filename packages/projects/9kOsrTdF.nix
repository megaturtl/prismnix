...
let
    versions = (let
        ...
        _i5HKnPLD = {
            "id" = "i5HKnPLD";
            "file" = "Vintage 26w32a.zip";
            "hash" = "sha512-4+uD2rF2pHHGLaLVd5Nz4FJO1M1gC8enaXvKEZ8hf58tVd2ZZuBeiSORxjAsr01UZ2PnkX634J7jBUT7rWNXUA==";
        };
    in {
        "v0mDT9y3" = _v0mDT9y3;
        "6xkSshpb" = _6xkSshpb;
        ...
        "minecraft-26.1" = _i5HKnPLD;
        "minecraft-26.1.1" = _i5HKnPLD;
        "minecraft-26.1.2" = _i5HKnPLD;
        "minecraft-26.2" = _i5HKnPLD;
        "minecraft-26.2-snapshot-2" = _i5HKnPLD;
        "minecraft-26.2-snapshot-3" = _i5HKnPLD;
        "minecraft-26.2-snapshot-4" = _i5HKnPLD;
        "minecraft-26.2-snapshot-5" = _i5HKnPLD;
        "minecraft-26.2-snapshot-6" = _i5HKnPLD;
        "minecraft-26.2-snapshot-7" = _i5HKnPLD;
        "minecraft-26.2-snapshot-8" = _i5HKnPLD;
        "minecraft-26.2-pre-1" = _i5HKnPLD;
        "minecraft-26.2-pre-2" = _i5HKnPLD;
        "minecraft-26.2-pre-3" = _i5HKnPLD;
        "minecraft-26.2-pre-4" = _i5HKnPLD;
        "minecraft-26.2-pre-5" = _i5HKnPLD;
        "minecraft-26.2-pre-6" = _i5HKnPLD;
        "minecraft-26.2-rc-1" = _i5HKnPLD;
        "minecraft-26.2-rc-2" = _i5HKnPLD;
        "minecraft-26.3-snapshot-1" = _i5HKnPLD;
        "minecraft-26.3-snapshot-2" = _i5HKnPLD;
        "minecraft-26.3-snapshot-3" = _i5HKnPLD;
        "minecraft-26.3-snapshot-4" = _i5HKnPLD;
        "minecraft-26.3-snapshot-5" = _i5HKnPLD;
        "minecraft-26.3-snapshot-6" = _i5HKnPLD;
        "minecraft-26.3-snapshot-7" = _i5HKnPLD;
        "pkg-1.0" = _v0mDT9y3;
        "pkg-2.0" = _6xkSshpb;
        "pkg-2.1" = _EguIW7pM;
        "pkg-2.2" = _xxBT1o3h;
