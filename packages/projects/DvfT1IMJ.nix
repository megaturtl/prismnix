...
let
    ...
    in {
        ...
        "pkg-1.0-1.21.1" = _giJEWfwV;
        "pkg-1.0-1.20.6" = _LwRZPSpL;
        "pkg-1.0-1.20.4" = _c5nExbDb;
        "pkg-1.0-1.20.1" = _xEdv9rkq;
        "pkg-1.1-1.20.1" = _W1JZW1Xs;
        "pkg-1.1-1.20.4" = _nuN0hiVp;
        "pkg-1.1-1.20.6" = _8w4qC7WK;
        "pkg-1.1-1.21.1" = _JH2JDGtc;
        "pkg-1.2-1.20.1" = _v7kJ3CQr;
        "pkg-1.2-1.20.4" = _pcdGng1z;
        "pkg-1.2-1.20.6" = _YYPGh0Dl;
        "pkg-1.2-1.21.1" = _NwuSuOyI;
        "pkg-1.2.0.1-1.20.1" = _XDzgOujl;
        "pkg-1.2.0.1-1.20.4" = _wjHc2gq8;
        "pkg-1.2.1-1.21.1" = _aWfEfKQY;
        "pkg-1.2.1-1.21.2" = _fbP8hGqN;
        "pkg-1.2.1-1.21.3" = _5BAdpQ3l;
        "pkg-1.2.1-1.20.1" = _nPbI0QCl;
        "pkg-1.2.1-1.20.4" = _M4Qj8GF9;
        "pkg-1.2.1-1.20.6" = _HCvOUjjA;
        "pkg-1.21.4-1.3" = _WUgRt2PH;
        "pkg-1.21.4-1.3.1" = _Cuu3lO2x;
        "pkg-1.21.5-1.3.1" = _bPA1jg90;
        "pkg-1.21.7-2.0" = _OTLTQB21;
        "pkg-1.21.8-2.0" = _AkAG7wRC;
        "pkg-1.21.10-2.0" = _c1DeJJ0V;
        "pkg-1.21.10-2.1" = _XE1thdis;
        "pkg-1.21.10-2.2" = _3nIPmkN5;
        "pkg-1.21.10-2.3" = _sVLRyIPQ;
        "pkg-1.21.10-2.3.1" = _dB9XMVMk;
        "pkg-1.21.10-2.4" = _Q042gnO3;
