...
let
    versions = (let
        ...
        _D5FF5Eii = {
            "id" = "D5FF5Eii";
            "file" = "itatiers-0.3.2+1.21.9-1.21.11.jar";
            "hash" = "sha512-N5+g3OwNwR1q4w+/hIOGPoDW0V1WpbxphiYSTMMHBujBmHxuMS9d3ZSygTw6upkb3MTwlTU4RgMD5gItTwraFg==";
        };
        _eL9XwRO5 = {
            "id" = "eL9XwRO5";
            "file" = "itatiers-0.3.2+1.21.6-1.21.8.jar";
            "hash" = "sha512-QznPbdAhqDpwtzVJmacDTUr/PJc/YlIKC1BoI+0RJQDqCyO+o6K0MPbkIaf8ROvrCFR166bKmOEDETISmuylvA==";
        };
        _u3CkoVaL = {
            "id" = "u3CkoVaL";
            "file" = "itatiers-0.3.2+1.21.2-1.21.4.jar";
            "hash" = "sha512-kLQ4ej0UGCzvNOd7wGlcOn4BBCaHvSEkWfvNewfnkAoiWT4hH+kTtNRMNvhypRkklkSYH6Nvn3qOXldUqQ9d3w==";
        };
        _asGL9rMX = {
            "id" = "asGL9rMX";
    ...
    in {
        ...
        "pkg-0.1.1+1.21-1.21.1" = _LnFd4ETo;
        "pkg-0.1.2+1.21.2-1.21.4" = _pqBL9rP4;
        "pkg-0.1.2+1.21.6-1.21.8" = _TUWh7fKr;
        "pkg-0.1.2+1.21-1.21.1" = _Y5Y57yAg;
        "pkg-0.1.3+1.21-1.21.1" = _wjYhLklt;
        "pkg-0.1.3+1.21.2-1.21.4" = _Am9eyHVD;
        "pkg-0.1.3+1.21.6-1.21.8" = _XZdJgBjV;
        "pkg-0.1.4+1.21-1.21.1" = _SiLYEE9h;
        "pkg-0.1.4+1.21.2-1.21.4" = _U6ncn9tJ;
        "pkg-0.1.4+1.21.6-1.21.8" = _PDZSCapn;
        "pkg-0.1.5+1.21.6-1.21.8" = _X3wQgwav;
        "pkg-0.1.5+1.21.2-1.21.4" = _HPAk8Q5A;
        "pkg-0.1.5+1.21-1.21.1" = _gSG4G9WS;
        "pkg-0.1.5+1.21.9-1.21.11" = _SF3bubR7;
        "pkg-0.2.0+1.21.9-1.21.11" = _DGsraeke;
        "pkg-0.2.0+1.21.6-1.21.8" = _40VWxayx;
        "pkg-0.2.0+1.21.2-1.21.4" = _TSyslJWA;
        "pkg-0.2.0+1.21-1.21.1" = _TbKw8lrt;
        "pkg-0.3.1+1.21.9-1.21.11" = _scAD2cid;
        "pkg-0.3.1+1.21.6-1.21.8" = _WLRUIrn8;
        "pkg-0.3.1+1.21.2-1.21.4" = _hCicVIhL;
        "pkg-0.3.1+1.21-1.21.1" = _Ew7MvlSN;
        "pkg-0.3.2+1.21.9-1.21.11" = _D5FF5Eii;
