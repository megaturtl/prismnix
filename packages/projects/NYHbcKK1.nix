...
let
    ...
    in {
        ...
        "pkg-forge-1.19.2-1.0.0" = _792R2Hn9;
        "pkg-forge-1.19.3-1.0.0" = _yOKT3Ekh;
        "pkg-forge-1.19.4-1.0.0" = _jgUJSfAc;
        "pkg-forge-1.20.1-1.0.0" = _6Tvta0jy;
        "pkg-forge-1.20.1-1.0.1" = _V8MOpLgg;
        "pkg-forge-1.20.1-1.0.2" = _OrChXjUy;
        "pkg-forge-1.20.2-1.0.2" = _BALkGiCE;
        "pkg-neoforge-1.20.2-1.0.2" = _5NvpwZPm;
        "pkg-neoforge-1.20.3-1.0.3" = _pWU6HAm5;
        "pkg-neoforge-1.20.4-1.0.3" = _1C27fkpD;
        "pkg-forge-1.19.2-1.1.0" = _8vKpa4zo;
        "pkg-forge-1.20.1-1.1.0" = _lb86lRwc;
        "pkg-neoforge-1.20.4-1.1.0" = _UefIpuej;
        "pkg-neoforge-1.20.4-1.1.1" = _gw7WkH2Q;
        "pkg-neoforge-1.20.5-1.1.1" = _48lzJ1jb;
        "pkg-neoforge-1.20.6-1.1.1" = _S23k24e7;
        "pkg-neoforge-1.21-1.1.1" = _b2zhA1Dp;
        "pkg-forge-1.19.2-1.1.2" = _L2WioUxf;
        "pkg-forge-1.20.1-1.1.2" = _95gV403q;
        "pkg-neoforge-1.21-1.1.2" = _qJHWWkB3;
        "pkg-neoforge-1.21.1-1.1.2" = _oC58wEgs;
        "pkg-neoforge-1.21.2-1.1.2" = _5cNgdbxS;
        "pkg-neoforge-1.21.3-1.1.2" = _h4IvNylv;
        "pkg-neoforge-1.21.4-1.1.2" = _hMenpUqP;
        "pkg-neoforge-1.21.5-1.1.2" = _fGGvmuNB;
        "pkg-neoforge-1.21.6-1.1.2" = _dRZjZ3Jq;
        "pkg-neoforge-1.21.7-1.1.2" = _zz1wcrkH;
        "pkg-neoforge-1.21.7-1.1.3" = _70EUBWZB;
        "pkg-neoforge-1.21.8-1.1.3" = _BeAyTBAn;
        "pkg-neoforge-1.21.9-1.1.3" = _Uz0Tqn1w;
        "pkg-neoforge-1.21.10-1.1.3" = _seOZXBrJ;
        "pkg-neoforge-1.21.11-1.1.3" = _rVBsiugG;
        "pkg-neoforge-1.1.3+26.1" = _m3bNAw9c;
        "pkg-neoforge-1.1.3+26.1.1" = _byuFpCUC;
