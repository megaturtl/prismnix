...
let
    ...
    in {
        ...
        "pkg-3.0+1.21" = _J4SHzXG0;
        "pkg-3.0+1.20" = _1FjAeAL8;
        "pkg-1.0.0+20w14infinite" = _ofwos5q4;
        "pkg-3.0+1.19.2" = _ZInygadG;
        "pkg-3.0.1+1.20" = _jTEpqqFM;
        "pkg-3.0+1.18.2" = _L9X9nhrE;
        "pkg-3.0+1.20.4" = _CUIvHedp;
        "pkg-3.0+1.20.6" = _J0QOf9Kx;
        "pkg-3.0+24w40a" = _cCMZTwF2;
        "pkg-3.0+1.21.2" = _AbHNkNL3;
        "pkg-3.1+1.21.2" = _W0z0xh1p;
        "pkg-3.1+1.20" = _8ADVFMaO;
        "pkg-3.2+1.21" = _fLyANhlv;
        "pkg-3.2+1.21.2" = _y8GcHqv3;
        "pkg-3.2+1.20" = _5QZT4YXp;
        "pkg-3.3+1.20" = _udzwczhU;
        "pkg-3.3+1.21" = _QRrKVNIN;
        "pkg-3.3+1.21.3" = _8xiNDH0F;
        "pkg-3.4+1.19.2" = _4G2mKCkk;
        "pkg-3.4+1.20.1" = _oMEWoHUh;
        "pkg-3.4+1.21.1" = _QtvjDDAK;
        "pkg-3.4+1.21.4" = _HMYYTaUe;
        "pkg-3.4.1+1.19.2" = _u0rjojT9;
        "pkg-3.4.1+1.20.1" = _OmOUQ5p7;
        "pkg-3.5.0+1.19.2" = _r3wnIXJV;
        "pkg-3.5.0+1.20.1" = _vQC1dZnk;
        "pkg-3.5.0+1.21.1" = _PvSEBLnn;
        "pkg-3.5.0+1.21.4" = _rzbrYkwQ;
        "pkg-3.5.1+1.21.1" = _lex5IUBG;
        "pkg-3.5.1+1.21.4" = _HK0GRjry;
        "pkg-3.5.1+1.19.2" = _IjQNqmGu;
        "pkg-3.5.1+1.20.1" = _uF7HyxSR;
        "pkg-3.5.1+25w37a" = _Gpmig57p;
        "pkg-3.5.1+1.21.9" = _lB8LfScr;
        "pkg-3.5.2+1.21.9" = _yvCOTr7u;
        "pkg-3.5.3+1.21.9" = _ePEoTNGk;
        "pkg-3.6.0+1.21.10-fabric" = _g0a0ETnT;
        "pkg-3.6.0+1.21.10-neoforge" = _nNtjmr7L;
        "pkg-3.6.0+1.21.11-fabric" = _tqH5LgPI;
        "pkg-3.6.0+1.21.11-neoforge" = _dkFNokrN;
        "pkg-3.6.1+1.21.11-fabric" = _2olLUrB7;
        "pkg-3.6.1+1.21.11-neoforge" = _Rkq43bHw;
        "pkg-3.6.1+26.1-snapshot-1-fabric" = _c6XwkYoZ;
        "pkg-3.6.2+1.21.10-fabric" = _D0nwQb3l;
        "pkg-3.6.2+1.21.11-fabric" = _KwJ4yIqY;
        "pkg-3.6.2+1.21.11-neoforge" = _I2MBDUb8;
        "pkg-3.6.2+26.1-snapshot-1-fabric" = _vJAas3uR;
        "pkg-3.6.3+26.1-snapshot-1-fabric" = _tfrGFslQ;
        "pkg-3.6.3+26.1-snapshot-1-neoforge" = _ekOWGRwF;
        "pkg-3.6.4+26.1.1-fabric" = _nDlifhbb;
