...
let
    versions = (let
        ...
        _8te6YIHl = {
            "id" = "8te6YIHl";
            "file" = "NTM-CE-1.12.2-2.6.1.0.jar";
            "hash" = "sha512-HSIz8lPnaG7qjEwrGDbZZCrEKttgii0BZjvrb87IS3OdAPCbfMsQuR3N3eFa7Xpdf9r1B0HlcOb9SHaJGl3KkA==";
        };
    in {
        "WhiJnFfW" = _WhiJnFfW;
        "HXxLWE4o" = _HXxLWE4o;
