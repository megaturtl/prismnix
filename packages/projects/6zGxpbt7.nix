...
let
    ...
    in {
        ...
        "pkg-0.1.6" = _hliGeEJH;
        "pkg-0.1.7" = _PyBbeeug;
        "pkg-0.1.7.1" = _GaQI8nHQ;
        "pkg-0.1.7.2" = _GIGXnRgq;
        "pkg-0.1.8" = _fSkoQW5V;
        "pkg-0.1.9" = _H7TWcGr0;
        "pkg-0.2.0" = _WXfsJgJ8;
        "pkg-0.2.1" = _W90opQRy;
        ...
        "pkg-0.2.4" = _mRP6PhXl;
        "pkg-0.2.5" = _6gsoGms3;
        "pkg-0.1.7.3" = _EARHkdUc;
        "pkg-0.2.6" = _wjBWZJdF;
        "pkg-0.1.7.4" = _7ala9PGY;
        "pkg-0.2.7" = _fWHjVeyD;
        "pkg-0.2.8" = _cSIirJx2;
        "pkg-0.3.0" = _H9d7nPPC;
        "pkg-0.3.1" = _rLq6XDIN;
        ...
        "pkg-0.4.5" = _UNGdehA5;
        "pkg-0.5.0" = _gzh23HzQ;
        "pkg-0.5.0.1" = _r9QesLxN;
        "pkg-0.4.5.1" = _Xu2gDrZq;
        "pkg-0.5.0.2" = _PUC8CfEk;
        "pkg-0.4.5.2" = _M6APWRtx;
        "pkg-0.5.0.3" = _iucKnQ4L;
        "pkg-0.4.5.3" = _NVSVc3WJ;
        "pkg-0.4.5.4" = _d3ARLXqv;
        "pkg-0.5.0.4" = _JPYIIZRY;
        "pkg-0.5.0.5" = _o344Kiup;
        "pkg-0.4.6" = _z9uoIr0R;
        "pkg-0.4.7" = _J3hT9avW;
        "pkg-0.6.0" = _Djf2QvnI;
        "pkg-0.6.1" = _AY9Akje2;
        ...
        "pkg-0.6.2" = _JqTE4jDE;
        "pkg-0.4.9" = _2smK4hc8;
        "pkg-0.4.10" = _l0WFTSCM;
        "pkg-0.6.3" = _AXlxMsUu;
        "pkg-0.4.11" = _uvRhEge3;
        "pkg-0.6.4" = _yrrESv5c;
        "pkg-0.4.12" = _AIs854oK;
        "pkg-0.6.5" = _vVEcpN0f;
        "pkg-0.4.13" = _C7nMsSkw;
        "pkg-0.6.6" = _U1g8L1sx;
        "pkg-0.4.14" = _YODdllEq;
        "pkg-0.6.7" = _Rbqx7x2r;
        "pkg-0.4.15" = _jQNLW8QN;
        "pkg-0.1.7.5" = _IFDaYpPK;
        "pkg-0.4.16" = _Hy9s1QDF;
        "pkg-0.4.17-1.20.1" = _t6Gdi4qR;
        "pkg-0.6.8-1.21.1" = _GAuKKaaE;
        "pkg-0.6.9-1.21.1" = _lhOmZwl7;
        "pkg-1.21.1-neoforge-0.6.10" = _UubkXqBu;
        "pkg-1.21.1-neoforge-0.6.11" = _TLfGm2z4;
        "pkg-1.20.1-forge-0.4.18" = _7oJYD2Jy;
        "pkg-1.21.1-neoforge-0.6.12" = _iW0OKWqZ;
        "pkg-1.20.1-forge-0.4.19" = _7zVCsPP5;
        "pkg-1.21.1-neoforge-0.6.13" = _qIYOhS7a;
        "pkg-1.21.1-neoforge-0.6.14" = _DDUlSfb7;
        "pkg-1.21.1-neoforge-0.6.15" = _Bl4DEsb9;
        "pkg-1.20.1-forge-0.4.20" = _gVUThEjI;
        "pkg-1.21.1-neoforge-0.6.16" = _vWe0dRIC;
        "pkg-1.20.1-forge-0.4.21" = _JSoJZMWF;
        "pkg-1.20.1-forge-0.6.16" = _U3exwjHS;
        "pkg-1.21.1-neoforge-0.6.17" = _l87hi40W;
        "pkg-1.20.1-forge-0.6.17" = _olMl3Vov;
        "pkg-1.21.1-neoforge-0.6.18" = _1pAsCDQ0;
        "pkg-1.20.1-forge-0.6.18" = _Bfy9fzK6;
        "pkg-1.21.1-neoforge-0.6.19" = _jERZYLJv;
        "pkg-1.20.1-forge-0.6.19" = _AZpPz4MB;
        "pkg-1.21.1-neoforge-0.6.20" = _9uSyw0F9;
        "pkg-1.20.1-forge-0.6.20" = _BkOIAUT4;
        "pkg-1.21.1-neoforge-0.6.21" = _IRg2qR5x;
        "pkg-1.20.1-forge-0.6.21" = _bHQOGDni;
        "pkg-1.21.1-neoforge-0.6.22" = _QjikUX5x;
        "pkg-1.20.1-forge-0.6.22" = _YLcTGVVx;
        "pkg-1.21.1-neoforge-0.6.23" = _5sr7NVf5;
        "pkg-1.20.1-forge-0.6.23" = _NvSCvimu;
        "pkg-1.21.1-neoforge-0.6.24" = _SmLuXR9F;
        "pkg-1.20.1-forge-0.6.24" = _4he9FIgb;
        "pkg-1.21.11-neoforge-0.6.24-alpha" = _oEoqQPgw;
        "pkg-1.21.1-neoforge-0.6.25" = _ocFhM7yU;
        "pkg-1.20.1-forge-0.6.25" = _nHqv4tPn;
        "pkg-26.1-snapshot-6-neoforge-0.6.24" = _YRKDYG4z;
        "pkg-1.21.1-neoforge-0.6.26" = _1WeSf0Sl;
        "pkg-1.20.1-forge-0.6.26" = _JWeOCW9a;
        "pkg-1.21.1-neoforge-0.6.27" = _nZ10L3c4;
        "pkg-1.20.1-forge-0.6.27" = _6ois4oKU;
        "pkg-26.1-snapshot-6-neoforge-0.7.0" = _FXEPGa7k;
        "pkg-1.21.1-neoforge-0.7.0" = _f14LTOxe;
        "pkg-1.21.1-neoforge-0.7.1" = _6aOYxEKm;
        "pkg-1.20.1-forge-0.7.1" = _dLJiGUHb;
        "pkg-1.21.1-neoforge-0.7.2" = _DtO8PNGB;
        "pkg-0.7.3" = _KoR95VUR;
        "pkg-0.7.4-1.21.1-neoforge" = _OdrouDIt;
        "pkg-0.7.4-1.20.1-forge" = _qDC11bg4;
        "pkg-0.7.4-26.1-snapshot-6-neoforge" = _26HxLexG;
        "pkg-0.7.5-1.21.1-neoforge" = _D5AcJIMP;
        "pkg-0.7.5-1.20.1-forge" = _zwpFSgm9;
        "pkg-0.7.6-1.21.1-neoforge" = _FrfrDbrg;
        "pkg-0.7.6-1.20.1-forge" = _O0n0Zenl;
        "pkg-0.7.7-1.21.1-neoforge" = _LzPZ1vxT;
        "pkg-0.7.7-26.1-neoforge" = _1QdlCtAK;
        "pkg-0.7.8-1.21.1-neoforge" = _fOu8eS6y;
        "pkg-0.7.8-1.20.1-forge" = _ABbSoQP8;
        "pkg-0.7.8-26.1-neoforge" = _yGPyGlfb;
        "pkg-0.7.9-1.21.1-neoforge" = _kRoK7eGg;
        "pkg-0.7.9-26.1-neoforge" = _t3OObXR9;
        "pkg-0.7.9-1.20.1-forge" = _g7lPkyk1;
        "pkg-0.7.10-1.21.1-neoforge" = _dW8kfmlu;
        "pkg-0.7.10-26.1-neoforge" = _3wSUDSqr;
        "pkg-0.7.10-1.20.1-forge" = _BCM69N2d;
        "pkg-0.7.11-26.1-neoforge" = _iKS49H4S;
        "pkg-0.7.12-1.21.1-neoforge" = _Lxf3Ixgk;
        "pkg-0.7.12-26.1-neoforge" = _NXvvoAAl;
        "pkg-0.7.12-1.20.1-forge" = _vtB8Ijfn;
        "pkg-0.7.13-26.1.2-neoforge" = _pFwdTv5p;
        "pkg-0.7.14-26.1.2-neoforge" = _iPOVFRtl;
        "pkg-0.7.14-1.21.1-neoforge" = _cO7R4sPw;
        "pkg-0.7.14-1.20.1-forge" = _Z9RsIZHW;
        "pkg-0.7.15-26.1.2-neoforge" = _h9egr7LM;
        "pkg-0.7.16-1.21.1-neoforge" = _PXn1UeSy;
        "pkg-0.7.16-1.20.1-forge" = _4oU53PCA;
        "pkg-0.7.16-26.1.2-neoforge" = _hoaOj0Jw;
        "pkg-0.7.17-1.21.1-neoforge" = _ymdFr7ki;
        "pkg-0.7.17-26.1.2-neoforge" = _VLrSAgZ4;
        "pkg-0.7.17-1.20.1-forge" = _jQkixSAg;
        "pkg-0.7.18-1.20.1-forge" = _g4v3tdds;
        "pkg-0.7.19-1.21.1-neoforge" = _AOkaNOZ7;
        "pkg-0.7.19-26.1.2-neoforge" = _kb3S9msw;
        "pkg-0.7.19-1.20.1-forge" = _NoQjFKBi;
        "pkg-0.7.20-26.1.2-neoforge" = _rg3y6Nlf;
        "pkg-0.7.20-1.21.1-neoforge" = _UCaW0KMF;
        "pkg-0.7.20-1.20.1-forge" = _JClocyH4;
        "pkg-0.7.21-1.20.1-forge" = _LLUr6SLn;
        "pkg-0.7.21-26.2.0-neoforge" = _k2Dx2rl9;
        "pkg-0.7.21-26.1.2-neoforge" = _EzWzQbY9;
        "pkg-0.7.22-1.21.1-neoforge" = _Ph0ucL7Z;
        "pkg-0.7.22-1.20.1-forge" = _R4Jg1U7K;
        "pkg-0.7.23-26.2.0-neoforge" = _22q4T5Nh;
        "pkg-0.7.23-26.1.2-neoforge" = _Fok7zJOT;
        "pkg-0.7.23-1.21.1-neoforge" = _MqEy7cOz;
        "pkg-0.7.23-1.20.1-forge" = _XePWpek9;
        "pkg-0.7.24-1.21.1-neoforge" = _AlEgGAUZ;
        "pkg-0.7.24-26.1.2-neoforge" = _XdjYjNXQ;
        "pkg-0.7.24-26.2.0-neoforge" = _sydOF5ez;
        "pkg-0.7.24-1.20.1-forge" = _QFWduEWz;
        "pkg-0.7.25-26.2.0-neoforge" = _RFMaLHEj;
