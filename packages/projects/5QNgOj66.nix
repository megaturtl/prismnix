...
let
    versions = (let
        ...
        _uuvGkfXL = {
            "id" = "uuvGkfXL";
            "file" = "FancyHolograms-3.0.0-SNAPSHOT.64.jar";
            "hash" = "sha512-/MNZuvss3DFdGyy91nlIAX+atQSBWBQVZktZGYpvZcT5i3zWSXuNUiE/gM9ID01CaR0DpeHWIISRctZvA9j+Rw==";
        };
        _vHqp3rst = {
            "id" = "vHqp3rst";
    ...
    in {
        ...
        "pkg-2.0.6" = _uJcmuMjD;
        "pkg-2.1.0" = _tcXMEfYj;
        "pkg-2.2.0.80" = _5zUJjhpT;
        "pkg-2.2.0" = _XFirx6H0;
        "pkg-2.2.0.81" = _RqBkFbDJ;
        "pkg-2.3.0" = _kKJZDdMR;
        "pkg-2.3.0.82" = _b8GNkCQT;
        "pkg-2.3.0.83" = _8NLJh7Fi;
        "pkg-2.3.0.84" = _75u2PtwI;
        "pkg-2.3.0.85" = _hB6MHvPD;
        "pkg-2.3.0.87" = _q06cbCJx;
        "pkg-2.3.0.88" = _9Jt2xeu3;
        "pkg-2.3.0.89" = _WmUvmAOi;
        "pkg-2.3.0.90" = _JmPjvC4o;
        "pkg-2.3.0.91" = _3NmpJbRH;
        "pkg-2.3.0.92" = _xSkEar7Q;
        "pkg-2.3.0.93" = _zxWQKai0;
        "pkg-2.3.0.94" = _gHu7zXIu;
        "pkg-2.3.0.96" = _trWy0qim;
        "pkg-2.3.1" = _v2ENhlmB;
        "pkg-2.3.1.97" = _4bnhPtV9;
        "pkg-2.3.1.98" = _SGUWGNY0;
        "pkg-2.3.2" = _HxoMspSQ;
        "pkg-2.3.3" = _WqRYgRyE;
        "pkg-2.3.3.99" = _1bePzeOz;
        "pkg-2.3.3.100" = _Yj5iVQxf;
        "pkg-2.3.3.101" = _F6lZH2GJ;
        "pkg-2.3.3.102" = _Ctv5UF7L;
        "pkg-2.3.3.103" = _PPyMydCG;
        "pkg-2.3.3.104" = _EPBBDUuB;
        "pkg-2.3.3.105" = _bALtwhFy;
        "pkg-2.3.3.107" = _cbRsUX2Z;
        "pkg-2.3.3.108" = _7YGYQ9zt;
        "pkg-2.3.3.109" = _sjooObdI;
        "pkg-2.3.3.110" = _iRP3wA0r;
        "pkg-2.3.3.112" = _GMdhSRiV;
        "pkg-2.4.0" = _9hQyZvao;
        "pkg-2.4.0.113" = _ZsMzdFap;
        "pkg-2.4.0.114" = _p3veir41;
        "pkg-2.4.0.115" = _ckjUkP4F;
        "pkg-2.4.0.116" = _phD2LTiz;
        "pkg-2.4.0.117" = _lHFnjXr8;
        "pkg-2.4.0.118" = _1AEwjd5B;
        "pkg-2.4.0.119" = _iQcw8TCz;
        "pkg-2.4.0.120" = _mJvATYxi;
        "pkg-2.4.0.121" = _wFKOPTHO;
        "pkg-2.4.0.122" = _NkibLJLm;
        "pkg-2.4.0.123" = _r1GrIq0u;
        "pkg-2.4.1" = _ZLlQGOD5;
        "pkg-2.4.1.124" = _AfY3fbxF;
        "pkg-2.4.1.125" = _xfXasPl6;
        "pkg-2.4.1.126" = _bMRBoBQj;
        "pkg-2.4.1.127" = _dZv4NuBH;
        "pkg-2.4.1.128" = _octl6vm5;
        "pkg-2.4.2" = _MTvKQmNY;
        "pkg-2.4.2.129" = _ldwKm3Pk;
        "pkg-2.4.2.130" = _pTEW38qc;
        "pkg-2.4.2.132" = _rFLuWfOG;
        "pkg-2.4.2.133" = _ofJqg6QK;
        "pkg-2.4.2.134" = _mH3HgJVX;
        "pkg-2.4.2.135" = _gYWJ3n0K;
        "pkg-2.4.2.136" = _Id6RJ82f;
        "pkg-2.4.2.137" = _d2UC3nxD;
        "pkg-2.5.0" = _hgqS1weB;
        "pkg-2.5.0.138" = _1UiOJYBQ;
        "pkg-2.5.0.139" = _xdbPSGMG;
        "pkg-2.5.0.140" = _jt2MC0fv;
        "pkg-2.5.0.141" = _1rjZpTkn;
        "pkg-2.5.0.142" = _Bv4RYBhS;
        "pkg-2.5.0.143" = _rcRhfWYd;
        "pkg-2.6.0" = _L4Q0OPp0;
        "pkg-2.6.0.144" = _dvK52MNs;
        "pkg-2.6.0.145" = _gQPZt46c;
        "pkg-2.6.0.146" = _iJ3Nj02Z;
        "pkg-2.6.0.147" = _5Rw158Jc;
        "pkg-2.7.0" = _LoNuWb4g;
        "pkg-2.7.0.148" = _u4Q9T0wt;
        "pkg-2.7.0.149" = _poDY9vn9;
        "pkg-2.7.0.150" = _WKOvM67N;
        "pkg-2.7.0.151" = _sOFpwBCu;
        "pkg-2.7.0.152" = _NFgzy37i;
        "pkg-2.7.0.153" = _xQv0Koyl;
        "pkg-2.7.0.154" = _rThtMpu1;
        "pkg-2.7.0.155" = _w11DUpFo;
        "pkg-2.8.0" = _7UcGRCT8;
        "pkg-2.8.0.156" = _fsZWgvXR;
        "pkg-3.0.0-SNAPSHOT.7" = _p2ND8evp;
        "pkg-3.0.0-SNAPSHOT.8" = _jgcNhSgz;
        "pkg-3.0.0-SNAPSHOT.9" = _skhLwAEq;
        "pkg-2.8.0.157" = _4hFcAyhX;
        "pkg-3.0.0-SNAPSHOT.10" = _7qTgFsCg;
        "pkg-3.0.0-SNAPSHOT.11" = _QuUZUSNi;
        "pkg-2.8.0.158" = _5qxMf5AR;
        "pkg-2.8.0.159" = _sO3Io5EK;
        "pkg-2.8.0.160" = _Y6QTlqeX;
        "pkg-3.0.0-SNAPSHOT.12" = _9qTZXPUO;
        "pkg-2.8.0.161" = _N6C0BCSH;
        "pkg-3.0.0-SNAPSHOT.13" = _qOicMjtb;
        "pkg-2.8.0.162" = _lRrmd3t0;
        "pkg-3.0.0-SNAPSHOT.14" = _g9qYXBpN;
        "pkg-2.8.0.163" = _WR7LvPKu;
        "pkg-3.0.0-SNAPSHOT.15" = _Bgfv7c7b;
        "pkg-2.8.0.164" = _HM4EHO8h;
        "pkg-3.0.0-SNAPSHOT.16" = _tYqyRMqG;
        "pkg-2.8.0.165" = _hgnChumS;
        "pkg-3.0.0-SNAPSHOT.17" = _EbXBdbOY;
        "pkg-2.8.0.166" = _nF1zbzbo;
        "pkg-3.0.0-SNAPSHOT.18" = _TSuRdmrf;
        "pkg-2.8.0.167" = _WIIUQm9Y;
        "pkg-2.9.0" = _OYXu36lp;
        "pkg-3.0.0-SNAPSHOT.19" = _EfNbLrOJ;
        "pkg-2.9.0.168" = _CD0eUy17;
        "pkg-3.0.0-SNAPSHOT.20" = _7yC5k1wi;
        "pkg-2.9.0.169" = _GnZYwetm;
        "pkg-3.0.0-SNAPSHOT.21" = _t4gf6RR3;
        "pkg-2.9.0.170" = _TQN3yDIT;
        "pkg-3.0.0-SNAPSHOT.22" = _8JPzuVNO;
        "pkg-3.0.0-SNAPSHOT.23" = _iqydLH3c;
        "pkg-3.0.0-SNAPSHOT.24" = _rSwem1Ij;
        "pkg-3.0.0-SNAPSHOT.25" = _zmRwM1Pb;
        "pkg-3.0.0-SNAPSHOT.26" = _5O2ACWFH;
        "pkg-2.9.0.171" = _5VK0FCMC;
        "pkg-3.0.0-SNAPSHOT.27" = _l6kJPyuB;
        "pkg-2.9.0.172" = _U1ctzOVs;
        "pkg-3.0.0-SNAPSHOT.28" = _KrYo69ar;
        "pkg-3.0.0-SNAPSHOT.29" = _CNZnbqmC;
        "pkg-3.0.0-SNAPSHOT.30" = _p61iYngq;
        "pkg-3.0.0-SNAPSHOT.31" = _ajJJOJJ3;
        "pkg-2.9.0.173" = _vyG7OcE8;
        "pkg-2.9.1" = _GH9a5QUE;
        "pkg-3.0.0-SNAPSHOT.32" = _SIXnnCmU;
        "pkg-2.9.1.174" = _jq4YDHw5;
        "pkg-2.9.1.175" = _3o5F4uKw;
        "pkg-3.0.0-SNAPSHOT.33" = _TKnIH5pH;
        "pkg-3.0.0-SNAPSHOT.34" = _RhciZrup;
        "pkg-2.9.1.176" = _zcx4Hk61;
        "pkg-3.0.0-SNAPSHOT.35" = _K1XkF8YK;
        "pkg-2.9.1.177" = _5buUSBUf;
        "pkg-3.0.0-SNAPSHOT.36" = _8UhhCVZU;
        "pkg-2.9.1.178" = _s3AtvOlW;
        "pkg-3.0.0-SNAPSHOT.37" = _XtXtB8aK;
        "pkg-2.9.1.179" = _V7FmuR9u;
        "pkg-3.0.0-SNAPSHOT.38" = _xEkGPO4u;
        "pkg-2.9.1.180" = _ZorN1pXi;
        "pkg-3.0.0-SNAPSHOT.39" = _uO1exbrf;
        "pkg-3.0.0-SNAPSHOT.40" = _wAvNb8Oe;
        "pkg-2.9.1.181" = _VTAjVcPx;
        "pkg-3.0.0-SNAPSHOT.41" = _n92lqUdn;
        "pkg-3.0.0-SNAPSHOT.42" = _VKPdGDXr;
        "pkg-3.0.0-SNAPSHOT.43" = _KNcD0cJs;
        "pkg-3.0.0-SNAPSHOT.44" = _i02vUykp;
        "pkg-2.9.1.182" = _xfyy5Sr4;
        "pkg-2.9.1.183" = _eRmPEfbB;
        "pkg-3.0.0-SNAPSHOT.45" = _e3ro0aRK;
        "pkg-2.9.1.184" = _P6ZNklZ2;
        "pkg-3.0.0-SNAPSHOT.46" = _5MRrW7or;
        "pkg-2.9.1.185" = _YgLP07ey;
        "pkg-3.0.0-SNAPSHOT.48" = _tjYQIamz;
        "pkg-3.0.0-SNAPSHOT.49" = _5PqvrdCA;
        "pkg-3.0.0-SNAPSHOT.50" = _44JW8LUR;
        "pkg-3.0.0-SNAPSHOT.51" = _TyDrPArm;
        "pkg-Wednesday" = _4tI1duQA;
        "pkg-3.0.0-SNAPSHOT.52" = _ktW0ftUH;
        "pkg-2.9.1.186" = _ex4l3UZT;
        "pkg-2.9.1.187" = _RIwol2YR;
        "pkg-3.0.0-SNAPSHOT.53" = _iwvT7duK;
        "pkg-3.0.0-SNAPSHOT.54" = _uapc4Vse;
        "pkg-2.10.0" = _vAt0Yiv3;
        "pkg-3.0.0-SNAPSHOT.55" = _J56M8O9U;
        "pkg-3.0.0-SNAPSHOT.56" = _PBXrMHvk;
        "pkg-2.10.0-java21" = _kybb5Mwd;
        "pkg-2.10.0.188" = _YICa5riA;
        "pkg-3.0.0-SNAPSHOT.57" = _Atqjs9b0;
        "pkg-2.10.0.189" = _bv2YMXWj;
        "pkg-3.0.0-SNAPSHOT.58" = _yodll3zM;
        "pkg-2.10.0.190" = _eWgeTWhA;
        "pkg-3.0.0-SNAPSHOT.59" = _MHRSt6eK;
        "pkg-2.10.0.191" = _VGMTJ2V2;
        "pkg-2.10.1-java21" = _X1NuvCyw;
        "pkg-2.10.1" = _cnJADBRy;
        "pkg-2.10.1.192" = _wNoRrzjO;
        "pkg-2.11.0" = _VgbsP5NO;
        "pkg-3.0.0-SNAPSHOT.61" = _F9ctMZoA;
        "pkg-3.0.0-SNAPSHOT.62" = _b4ha65AW;
