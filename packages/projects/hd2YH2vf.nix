...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _oJMolMjy;
        "pkg-1.0.1+mod" = _mT4fePXg;
        "pkg-1.0.2" = _OhAsk0X8;
        "pkg-1.0.2+mod" = _SFru9skN;
        "pkg-1.0.3" = _ekSA7EKP;
        "pkg-1.0.3+mod" = _cENca19F;
        "pkg-1.0.4" = _XZzty1yx;
        "pkg-1.0.4+mod" = _dRPuKsBa;
        "pkg-1.0.5" = _jv4ADbsX;
        "pkg-1.0.5+mod" = _69FGcVZ4;
        "pkg-1.0.6" = _58vlaIw2;
        "pkg-1.0.6+mod" = _OSZf1rYt;
        "pkg-1.0.7" = _FBhCwH1n;
        "pkg-1.0.7+mod" = _pJm7pJD8;
        "pkg-1.0.8" = _3IqtrhOQ;
        "pkg-1.0.8+mod" = _M2OHrZoH;
        "pkg-1.0.9" = _tHpLecOS;
        "pkg-1.0.9+mod" = _LjO3TEdX;
        "pkg-1.0.10" = _4DQgBcTH;
        "pkg-1.0.10+mod" = _R2SqgufS;
        "pkg-1.0.11" = _wPH0nv7S;
        "pkg-1.0.11+mod" = _SIeRwtdz;
        "pkg-1.0.12" = _yDTPAbBs;
        "pkg-1.0.12+mod" = _JggNLUD0;
        "pkg-1.0.13" = _pHIfEMlY;
        "pkg-1.0.13+mod" = _jQRNZ0qG;
        "pkg-1.0.14" = _G35bEMMa;
        "pkg-1.0.14+mod" = _TBwBWgkI;
        "pkg-1.1.0" = _MUvIY3b2;
        "pkg-1.1.0+mod" = _vRFJb5V1;
        "pkg-1.1.1" = _SARF6iFa;
        "pkg-1.1.1+mod" = _upU42krk;
        "pkg-1.1.2" = _hVjABqDh;
        "pkg-1.1.2+mod" = _mtKgT5T2;
        "pkg-1.1.3" = _D8PBFhnQ;
        "pkg-1.1.3+mod" = _GpG3Wg9r;
        "pkg-1.1.4" = _GnP8S1Pj;
        "pkg-1.1.4+mod" = _ibCEJ8BG;
        "pkg-1.1.5" = _2uBK6zfP;
        "pkg-1.1.5+mod" = _7PRdmFkc;
        "pkg-1.1.6" = _1b9bprL5;
        "pkg-1.1.6+mod" = _b3GVLfLh;
        "pkg-1.1.7" = _Zt9bxnVb;
        "pkg-1.1.7+mod" = _uGIjZiMA;
        "pkg-1.1.8" = _28NSEGrL;
        "pkg-1.1.8+mod" = _OkdKSdOF;
        "pkg-v1.2.0" = _UaDUI80S;
        "pkg-v1.2.0+mod" = _jdDwV9kc;
        "pkg-v1.2.1" = _LwluUT51;
        "pkg-v1.2.1+mod" = _YBwv4ui3;
        "pkg-v1.2.0.1" = _bbzKStop;
        "pkg-v1.2.0.1+mod" = _ae1MomBu;
        "pkg-v1.2.2" = _LeArYzA8;
        "pkg-v1.2.2+mod" = _yd1AirJY;
        "pkg-v1.2.0.2" = _O8NnJIWR;
        "pkg-v1.2.0.2+mod" = _MZU2lqKO;
        "pkg-v1.2.3" = _OnNxC4x9;
        "pkg-v1.2.3+mod" = _qhM6ARzg;
        "pkg-v1.2.0.3" = _pHX2wSKV;
        "pkg-v1.2.0.3+mod" = _be3W2K1x;
        "pkg-v1.2.4" = _VHl3HscU;
        "pkg-v1.2.4+mod" = _HC3HNjSQ;
        "pkg-v1.2.0.4" = _NvzOFHvR;
        "pkg-v1.2.0.4+mod" = _9Op5BkVF;
        "pkg-v1.2.5" = _5RQEjWPD;
        "pkg-v1.2.5+mod" = _wjYxjE9W;
        "pkg-v1.2.0.5" = _BA5kIRas;
        "pkg-v1.2.0.5+mod" = _Ky2ni89k;
        "pkg-v1.2.6" = _IrWSrcGz;
        "pkg-v1.2.6+mod" = _5UOjXdMk;
        "pkg-v1.2.7" = _Yy6GYhsD;
        "pkg-v1.2.7+mod" = _lF6EDUZy;
        "pkg-v1.2.8" = _58IVHKGN;
        "pkg-v1.2.8+mod" = _Xoja7VqX;
        "pkg-v1.2.9" = _uv80SBJP;
        "pkg-v1.2.9+mod" = _4t4RhjoP;
        "pkg-v1.2.10" = _exJ4DKGi;
        "pkg-v1.2.10+mod" = _cfPDPrBM;
        "pkg-v1.2.11" = _pLSu4F2X;
        "pkg-v1.2.11+mod" = _cK9yoIqw;
        "pkg-v1.3.0" = _cAS2x2SA;
        "pkg-v1.3.0+mod" = _bW0XfPME;
        "pkg-v1.3.1" = _QDsf3WAR;
        "pkg-v1.3.1+mod" = _AWJribeg;
        "pkg-v1.3.2" = _9pTWJTCd;
        "pkg-v1.3.2+mod" = _5kWIX4vA;
        "pkg-v1.3.3" = _4WoY0k3y;
        "pkg-v1.3.3+mod" = _H19c7bob;
        "pkg-v1.3.4" = _f9RpdsdA;
        "pkg-v1.3.4+mod" = _CHvJtXXa;
        "pkg-v1.3.5" = _7Ox3p4dD;
        "pkg-v1.3.5+mod" = _xjWDfqLR;
        "pkg-v1.3.6" = _qElKMCHO;
        "pkg-v1.3.6+mod" = _Nh9UDpUC;
        "pkg-v1.3.7" = _Uy0sRPPu;
        "pkg-v1.3.7+mod" = _ljWKRcL4;
        "pkg-v1.3.8" = _JxPGFIyS;
        "pkg-v1.3.8+mod" = _ZBTaLaNl;
        "pkg-v1.3.9" = _iyH1TjRP;
        "pkg-v1.3.9+mod" = _bN88hQRE;
        "pkg-v1.3.10" = _EdmrCkv2;
        "pkg-v1.3.10+mod" = _dm8XO409;
        "pkg-v1.3.11" = _JPaO1UNv;
