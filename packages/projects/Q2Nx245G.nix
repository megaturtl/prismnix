...
let
    versions = (let
        ...
        _ofbMHkGL = {
            "id" = "ofbMHkGL";
            "file" = "Joyful Motions.zip";
            "hash" = "sha512-YZohVH41KpSJ99O8DpML8k++K/jpJSt7yZHVid+gWjfxqpFEKMwtxrNZUXIKrUjQTPGhi86CHdVP8GLsm+z7bw==";
        };
        _ULEN28MF = {
            "id" = "ULEN28MF";
            "file" = "Joyful Motions.zip";
            "hash" = "sha512-eyT5MFhLIb6H+sKd9Pk3nvE0NuQGWArwfsVpx3XkZkkfIy6LBaU1N3eEZ1miIJpfgftpXpYrB5dTTc/ps4FlSQ==";
        };
        _WWQ0lg9J = {
            "id" = "WWQ0lg9J";
            "file" = "Joyful Motions.zip";
            "hash" = "sha512-oP5xEBOBUqOnYo1HmBfZ8JZBACp1bdlW1yU8h8PPkcdIRZyge8O5bVzzL/Xqg4vLW7yvsaRigpozgd/XJD2kEg==";
        };
        _enP4AYeO = {
            "id" = "enP4AYeO";
            "file" = "Joyful Motions.zip";
            "hash" = "sha512-NiEbJKgIpQm2lrvnQLZEVjnMhZQVX31+iGjv8BMGv1tlq4dNU3TBUZUkEFm5IEeWEaVCJJDRrmAaSuk9qsz6MQ==";
        };
        _Xw8DGp4y = {
            "id" = "Xw8DGp4y";
            "file" = "Joyful Motions.zip";
            "hash" = "sha512-MUJxJtOuHPwKf8Y6RLAKJ1ZNKFzdQPpw7Hpldx3uhCTvJ7u7wS1tPDbiaefewfw6L5jjGYjNidamctgQ67sE9g==";
        };
        _vB7BpiEi = {
            "id" = "vB7BpiEi";
            "file" = "Joyful Motions.zip";
            "hash" = "sha512-lr2sn3SJyFA3bp6xnuH3dSaDVfOe06k3X9j9ZyJ2gUQK2q0cSDhsmu/5HQLX0mZ7zg2WG1WZP+17t3rbYfSdiA==";
        };
    in {
        "VmpIIfcf" = _VmpIIfcf;
        "JQIfqUZZ" = _JQIfqUZZ;
        ...
        "Xw8DGp4y" = _Xw8DGp4y;
        "vB7BpiEi" = _vB7BpiEi;
        "minecraft-1.21.2" = _vB7BpiEi;
        "minecraft-1.21.3" = _vB7BpiEi;
        "minecraft-1.21.4" = _vB7BpiEi;
        "minecraft-1.21.5" = _vB7BpiEi;
        "minecraft-1.21.6" = _vB7BpiEi;
        "minecraft-1.21.7" = _vB7BpiEi;
        "minecraft-1.21.8" = _vB7BpiEi;
        "minecraft-1.20" = _vB7BpiEi;
        "minecraft-1.20.1" = _vB7BpiEi;
        "minecraft-1.20.2" = _vB7BpiEi;
        "minecraft-1.20.3" = _vB7BpiEi;
        "minecraft-1.20.4" = _vB7BpiEi;
        "minecraft-1.20.5" = _vB7BpiEi;
        "minecraft-1.20.6" = _vB7BpiEi;
        "minecraft-1.21" = _vB7BpiEi;
        "minecraft-1.21.1" = _vB7BpiEi;
        "minecraft-1.21.9" = _vB7BpiEi;
        "minecraft-1.21.10" = _vB7BpiEi;
        "minecraft-1.21.11" = _vB7BpiEi;
        "minecraft-26.1" = _vB7BpiEi;
        "minecraft-26.1.1" = _vB7BpiEi;
        "minecraft-26.1.2" = _vB7BpiEi;
        "minecraft-26.2" = _vB7BpiEi;
        "pkg-v0.1" = _VmpIIfcf;
        "pkg-v0.2" = _JQIfqUZZ;
        "pkg-v0.3" = _CxC0JGfK;
        "pkg-v0.3x" = _iarbdTCl;
        ...
        "pkg-v0.9" = _5RTYwNw3;
        "pkg-v0.9b" = _5SKzLP6v;
        "pkg-v0.9cxJE" = _nTpzclYS;
        "pkg-v0.9c" = _nmVMmCQV;
        "pkg-v0.9dxJE" = _zlUPVy9R;
        "pkg-v0.9d" = _hqkJBIxC;
        "pkg-v1" = _el0bLwGj;
        "pkg-v1b" = _U0LBfbjK;
        "pkg-v1.1" = _AC4aFgse;
