...
let
    ...
    in {
        ...
        "ULEN28MF" = _ULEN28MF;
        "WWQ0lg9J" = _WWQ0lg9J;
        "minecraft-1.21.2" = _WWQ0lg9J;
        "minecraft-1.21.3" = _WWQ0lg9J;
        "minecraft-1.21.4" = _WWQ0lg9J;
        "minecraft-1.21.5" = _WWQ0lg9J;
        "minecraft-1.21.6" = _WWQ0lg9J;
        "minecraft-1.21.7" = _WWQ0lg9J;
        "minecraft-1.21.8" = _WWQ0lg9J;
        "minecraft-1.20" = _WWQ0lg9J;
        "minecraft-1.20.1" = _WWQ0lg9J;
        "minecraft-1.20.2" = _WWQ0lg9J;
        "minecraft-1.20.3" = _WWQ0lg9J;
        "minecraft-1.20.4" = _WWQ0lg9J;
        "minecraft-1.20.5" = _WWQ0lg9J;
        "minecraft-1.20.6" = _WWQ0lg9J;
        "minecraft-1.21" = _WWQ0lg9J;
        "minecraft-1.21.1" = _WWQ0lg9J;
        "minecraft-1.21.9" = _WWQ0lg9J;
        "minecraft-1.21.10" = _WWQ0lg9J;
        "minecraft-1.21.11" = _WWQ0lg9J;
        "minecraft-26.1" = _WWQ0lg9J;
        "minecraft-26.1.1" = _WWQ0lg9J;
        "minecraft-26.1.2" = _WWQ0lg9J;
        "minecraft-26.2" = _WWQ0lg9J;
        "pkg-v0.1" = _VmpIIfcf;
        "pkg-v0.2" = _JQIfqUZZ;
        "pkg-v0.3" = _CxC0JGfK;
        "pkg-v0.3x" = _iarbdTCl;
