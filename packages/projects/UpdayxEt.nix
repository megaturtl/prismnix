...
let
    ...
    in {
        ...
        "pkg-1.1.0+mc1.20.3" = _Rl6wnUfW;
        "pkg-1.2.0+mc1.20.6" = _Eaa9WxIQ;
        "pkg-1.3.0+mc1.21" = _hsQ4Xv9t;
        "pkg-1.4.0+mc1.21.2" = _i9RXkjJL;
        "pkg-1.5.0+mc1.21.4" = _yGw3U016;
        "pkg-1.5.1+mc1.21.4" = _1A7DVNpM;
        "pkg-1.6.0+mc1.21.5" = _UmuM0Rq8;
        "pkg-1.5.2+mc1.21.4" = _TUeJ5lit;
        "pkg-1.6.1+mc1.21.5" = _eyWfpQdN;
        "pkg-1.7.0+mc1.21.6" = _Oaf7q0qx;
        "pkg-1.7.1+mc1.21.6" = _4ID5ySh8;
        "pkg-1.7.2+mc1.21.6" = _q26FeJGv;
        "pkg-1.8.0+mc1.21.9" = _UR690BQ3;
        "pkg-1.9.0+mc1.21.11" = _DhKeq0Z2;
        "pkg-1.9.1+mc1.21.11" = _PpVOHM4k;
        "pkg-1.9.2+mc1.21.11" = _jq3TIvdv;
        "pkg-1.10.0+mc26.1-neoforge" = _J5OmkGUb;
