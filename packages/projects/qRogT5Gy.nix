...
let
    versions = (let
        ...
        _LxTt82ek = {
            "id" = "LxTt82ek";
            "file" = "cobblegen-5.4.9+26.1b1463-BETA-fabric.jar";
            "hash" = "sha512-/SshTehYh4u7WntP6g73zIoY3yqoKoY7JHNEIWEtahhtnOQpzI9Qwd5bTtqvx57LV2lhxgbObpuduR/h61IwRQ==";
        };
        _yUQHzAvB = {
            "id" = "yUQHzAvB";
            "file" = "cobblegen-5.4.9+1.16.5b1463-BETA-fabric.jar";
            "hash" = "sha512-SRlY9/JHKA6fsO20QWiyxOtF+tcYiyPgumoEyYSJ11BzzK/FXuLZddNKPThWdj6PkqIkpqLMuJ+h6cvUyqf2gQ==";
        };
        _oLhEXY8o = {
            "id" = "oLhEXY8o";
            "file" = "cobblegen-5.4.9+1.19.2b1463-BETA-fabric.jar";
            "hash" = "sha512-/U0u9B4UD223d4UZ1uK0YNq4MRPDjxZrWNMgdyAfNcrdX/JaWQagU0u8McnEDomNIHtezf5Qmx7EVF0AlTtNNA==";
        };
        _3FDSivPE = {
            "id" = "3FDSivPE";
            "file" = "cobblegen-5.4.9+1.20.2b1463-BETA-fabric.jar";
            "hash" = "sha512-HWwYYf1G5iK/LZO0qSiLrohn8JpdDsW/T0sWyBT9jySGJUAPxCUBxXk0QdnmtDLSyJ/tHsJ4W3qQZYfuj7EAyw==";
        };
        _b9siTNEd = {
            "id" = "b9siTNEd";
            "file" = "cobblegen-5.4.9+1.18.2b1463-BETA-fabric.jar";
            "hash" = "sha512-jWHb3L7kJtsx6bBxr/Y3QGBYswWnwMC2yLE8xmUjET/3Aue+giGwbvhxG5d3hwG61Sv60dFm4lVPk7qBynuwtw==";
        };
        _wUM3dCKR = {
            "id" = "wUM3dCKR";
            "file" = "cobblegen-5.4.9+26.1b1463-BETA-neoforge.jar";
            "hash" = "sha512-sxyCxzORQ9Fe2hQjIRmNtWXOpl/hmqv9LEijkVezpqfLqu77EF7nZCM80Wv0RHtKV2ijFX4xapbxdT5qBl1Cvg==";
        };
        _sq4xI8Dn = {
            "id" = "sq4xI8Dn";
            "file" = "cobblegen-5.4.9+1.19.4b1463-BETA-fabric.jar";
            "hash" = "sha512-Xk2Us0J5uMD3VtFx9WwOdDRavoayOh6gtsw53hgxuSUsLojiKkIRKdUyU2PNa8kTELWMiqQJI2eYbNYZJA0kww==";
        };
        _gA7hj0Cw = {
            "id" = "gA7hj0Cw";
            "file" = "cobblegen-5.4.9+1.20.1b1463-BETA-fabric.jar";
            "hash" = "sha512-A2pzsJbu9AyEnyfH8PTVJsWnpHD3EdJvxsB454LWK4ASOC5VI98IipM8nuf43K0q89qtuj6iOR3K+TsmJuhB6A==";
        };
        _EYl3a1P5 = {
            "id" = "EYl3a1P5";
            "file" = "cobblegen-5.4.9+1.21.5b1463-BETA-fabric.jar";
            "hash" = "sha512-H6WzChbybwhz84dC2rF0bgudGYrwE9v781+6H6N/LO+8vr7sudi/u54u7s+30B8jZA/BuC99lr8usVNScXGXyg==";
        };
        _XswvAG6N = {
            "id" = "XswvAG6N";
            "file" = "cobblegen-5.4.9+1.21.1b1463-BETA-fabric.jar";
            "hash" = "sha512-0srABYSxbTvVDyMGn3zeQjCBGC2vF9X4RSK9wIPpbakYIcfnFMZDK6Tk8nM9qSbBmjiV5lXiaBNIMbJgoCMesw==";
        };
        _F5b9FwWh = {
            "id" = "F5b9FwWh";
            "file" = "cobblegen-5.4.9+1.20.2b1463-BETA-neoforge.jar";
            "hash" = "sha512-pp6VuEJpu/TcB3S0aJJ/amSggFqjdKlh1lpiYZ2L+fNTL8RIo/uKMUcQHBp8GVQOFxwyQFKfuFk0eo5KguhlUQ==";
        };
        _hhveCHVa = {
            "id" = "hhveCHVa";
            "file" = "cobblegen-5.4.9+1.20.6b1463-BETA-fabric.jar";
            "hash" = "sha512-qSFhth1xcUJZ09azfc65W1VQ6rxbAgvWyI3qzgzFCG7neY15BCbxfmau0XeMjW2vUh9USgABGLXd5XaWt96Rwg==";
        };
        _rW2hB82Z = {
            "id" = "rW2hB82Z";
            "file" = "cobblegen-5.4.9+1.21.3b1463-BETA-fabric.jar";
            "hash" = "sha512-JZUdrIXd0TRMzkY9/ABXYrd1TjLKOYTPCvRpoyB3e/OGUOBAygkll8uSEsCT2gBpqMh471F335ZFVOWlmLgb5w==";
        };
        _7zj74mNo = {
            "id" = "7zj74mNo";
            "file" = "cobblegen-5.4.9+1.21.11b1463-BETA-neoforge.jar";
            "hash" = "sha512-eeGlv9gV+Tk/yMmCQAxv99Fu38D+rvh1m1iWJ8fS5jDfqQWdvoAe1J3KdDLiQBljGNC33+x3SDVjqUd6CvPJ0g==";
        };
        _3rZNNDP7 = {
            "id" = "3rZNNDP7";
            "file" = "cobblegen-5.4.9+1.19.4b1463-BETA-forge.jar";
            "hash" = "sha512-CVOBtwpYP6htdvn3HqScIjKzhkbxIWV2ULXe8qjO8LZaUkvK7fV/cuX714NiI0FUdcU8LXOzbgaWFnBRKMmVpw==";
        };
        _kijtvKx0 = {
            "id" = "kijtvKx0";
            "file" = "cobblegen-5.4.9+1.16.5b1463-BETA-forge.jar";
            "hash" = "sha512-bQN9YGSeb73Pat/tcLvtQGOVbBpshqSMA9DAapsKlWobKaUEZBAeX/CRaRBZHhB98NTw7pEP884oAzomiwOc+g==";
        };
        _M21R7beB = {
            "id" = "M21R7beB";
            "file" = "cobblegen-5.4.9+1.21.1b1463-BETA-neoforge.jar";
            "hash" = "sha512-DLZZKJycWeYIevtm2vPkH6Yw+sz4R0BTxzy4aDOnbm2a9wrJte2GaEkw0dNNhkHIhFD6B+Dbh6k1svuNx0fBAA==";
        };
        _Zog3iTWw = {
            "id" = "Zog3iTWw";
            "file" = "cobblegen-5.4.9+1.19.2b1463-BETA-forge.jar";
            "hash" = "sha512-0YHY7ABNXfq28pyLtD+AmLptJotzPI5yrO7mOmwWtshcu2JfO6prEm5Xx0dZSUbeX9GP/Slh1MUqGLRYuIpBeg==";
        };
        _6zvBWH30 = {
            "id" = "6zvBWH30";
            "file" = "cobblegen-5.4.9+1.21.3b1463-BETA-neoforge.jar";
            "hash" = "sha512-9263Yy3w1q8AA8fOnTu3320m3Fwovozjk/BIMeimUcVrt24ZEwstvySoWR/p3beFL+yEloY8PtIgimsWJ79Xaw==";
        };
        _L8nlmK4a = {
            "id" = "L8nlmK4a";
            "file" = "cobblegen-5.4.9+1.21.5b1463-BETA-neoforge.jar";
            "hash" = "sha512-SRMKq1GkivmHRg96rHawdznCjzRp8OsYEEn/vFZC1wvPcKbPXgnOudjL89xNOicTKizhqrDb/WvJ8xNHPF4ARw==";
        };
        _FrDN6SIV = {
            "id" = "FrDN6SIV";
            "file" = "cobblegen-5.4.9+1.21.11b1463-BETA-fabric.jar";
            "hash" = "sha512-3ErtjfaB5STrXcXOkJ3f4CRrkYc2EKfImOaIBnkbfyXHSWPsudkApTZcf7q+9o/nLwv9oLlAwq0eh8rATjNfhA==";
        };
        _7Mkm7Xo3 = {
            "id" = "7Mkm7Xo3";
            "file" = "cobblegen-5.4.9+1.20.1b1463-BETA-forge.jar";
            "hash" = "sha512-pKGyhKMpcQ5YeAbQPMVOKqoMzwLa5O3MxK5Rua/1D3q7XxaZFq0rlDQnUSl8EWvFF+chswdyQlttmNDkWv0yYw==";
        };
        _ELcMYsNi = {
            "id" = "ELcMYsNi";
            "file" = "cobblegen-5.4.9+1.20.6b1463-BETA-neoforge.jar";
            "hash" = "sha512-hvwM2YINT5n0VYX/CgJ27IHxZOQ3gmj6PSNc2D+bao1y0bL/U9bVLvUvr71OMcCVlGDQFxjh1LxF/h8vjFIuyA==";
        };
        _EJLirDbA = {
            "id" = "EJLirDbA";
            "file" = "cobblegen-5.4.9+1.20.4b1463-BETA-neoforge.jar";
            "hash" = "sha512-LeQo0MyTR7WzJtw5KlOZ+DP8dc3wJvZO8KUcCgwTd63KiBi1FkhsWgw9q8qn2AHhpuFViIlkAIUS/hd7J3GR6A==";
        };
        _xC2EvSpa = {
            "id" = "xC2EvSpa";
            "file" = "cobblegen-5.4.9+1.18.2b1463-BETA-forge.jar";
            "hash" = "sha512-c7Mb+1/2DRd3m0ayBce4fqXkVP2U9524SX/UsY8wb8OU7+DH8wK+nk24izjhxcCATIIkIRw2v6ABSTkao1guUg==";
        };
        _3kbewmGb = {
            "id" = "3kbewmGb";
            "file" = "cobblegen-5.4.10+1.19.2b1471-BETA-fabric.jar";
            "hash" = "sha512-b/yS4ZYAx6BcIkaxAlDrPIt7fPog+871Du9G2qN8fnIouxGwz1n4PkQsTnnS9w5I8nyJTaKQtwmKto+COrsoZg==";
        };
        _ioRliWZO = {
            "id" = "ioRliWZO";
            "file" = "cobblegen-5.4.10+26.1b1471-BETA-fabric.jar";
            "hash" = "sha512-hWqnrrHzMrVxNMYBsEGaf1AhO44op7aNHhlUKXf2JhRn2GdOLqXdVipafpRgnnDAlqloz8e1MTXn4pKF7RgfDw==";
        };
        _tpJc7k6V = {
            "id" = "tpJc7k6V";
            "file" = "cobblegen-5.4.10+1.16.5b1471-BETA-fabric.jar";
            "hash" = "sha512-KX9w23ZvIsaUXeaa6FSqFWhixn/n5KAKr7bhtKr6P18NGoZIJe12jQsk8Mxntr1BrucTH0YTEQutIAlJBqHrmg==";
        };
        _XApUgU46 = {
            "id" = "XApUgU46";
            "file" = "cobblegen-5.4.10+1.20.1b1471-BETA-fabric.jar";
            "hash" = "sha512-D9A9lvEa7amXMWP6yWbT8MxVHLXdcS/oN15sdv4ozcrJfZYXfxEgWH8TGyc5mGbPCKRAY4bge6Xr9AHroHGUSQ==";
        };
        _sCA828JH = {
            "id" = "sCA828JH";
            "file" = "cobblegen-5.4.10+1.20.6b1471-BETA-neoforge.jar";
            "hash" = "sha512-Ql6mVli8N9kPV7I1K4glcWRtNWSbKemhFmw6AVy/z82QTltZT+KHkASKv8dYpoNKlE0v5wWmKSutHOjPMS8WLQ==";
        };
        _RkN2XsWg = {
            "id" = "RkN2XsWg";
            "file" = "cobblegen-5.4.10+1.19.4b1471-BETA-fabric.jar";
            "hash" = "sha512-RgT41ijEIpFlgDIjlTfiI+zj0bIvOL0BvGXBO/Qz6CKyGONpucWPxpB5J2/HDso4YLNJ9Psi9DMV+G1/DMK60A==";
        };
        _qhtZg9Oc = {
            "id" = "qhtZg9Oc";
            "file" = "cobblegen-5.4.10+1.18.2b1471-BETA-fabric.jar";
            "hash" = "sha512-cIY4j22yem3nVoxMzZ+GvGgaZtOiWdMrImYGJ0h7OjyPOCijvjBpwE/ed+Q9wiXqRQHEu9y+Q49U4ja0AQ7oWw==";
        };
        _rCv7G4uA = {
            "id" = "rCv7G4uA";
            "file" = "cobblegen-5.4.10+1.18.2b1471-BETA-forge.jar";
            "hash" = "sha512-Okmx65IJsiIJ5QvyL1MtXH/xNEYxzL65qHmFaKEM43q2Z+p1Z0g8I1W9wsTfnS1gCElZAEn16vV1RoG+zxt6Og==";
        };
        _SCaH8LYy = {
            "id" = "SCaH8LYy";
            "file" = "cobblegen-5.4.10+1.20.6b1471-BETA-fabric.jar";
            "hash" = "sha512-kIL3DCTxHHhRrgvZvjLTIg5XXU3vK2o7jmIspcb/XqHSc9YXEck4TtA1pJB7sUAiH1Em/bK7rqico8ORZcGycQ==";
        };
        _fEdf6mJ2 = {
            "id" = "fEdf6mJ2";
            "file" = "cobblegen-5.4.10+1.20.1b1471-BETA-forge.jar";
            "hash" = "sha512-mEiA/ATNYZguErna2aBT7+Ys9ScACrpzWf5uRP1JR4a/11IDM/PVtBjHxcpDW6CKsYt0INwo2/svePdprS/k+w==";
        };
        _cpOh3YWc = {
            "id" = "cpOh3YWc";
            "file" = "cobblegen-5.4.10+1.16.5b1471-BETA-forge.jar";
            "hash" = "sha512-QX6Kw2jNui5MHJDGU1FjNOX/9L8KeefOP3kFkMuVoZtNdoErrBs5mnCV/2702GTkUGHKChmXv4KizRL73W/Q6A==";
        };
        _K6iYVfIU = {
            "id" = "K6iYVfIU";
            "file" = "cobblegen-5.4.10+1.21.11b1471-BETA-fabric.jar";
            "hash" = "sha512-KS3PLSSUBEPG+ZfmPRo5bBajSsq5eAjuKgZmoHS1QN0tnlln0S2S4YS2V0d7kKrW5MlnzNOX+NZhE3AT7p8f0Q==";
        };
        _MSWJsjTH = {
            "id" = "MSWJsjTH";
            "file" = "cobblegen-5.4.10+1.21.1b1471-BETA-fabric.jar";
            "hash" = "sha512-lMXnrYkWgXpwOIYDP9ACxhySs6DIVlKGZdmWHnTJot3DH8UXbMSMLV4O9IGIre9nRB4p/bE45cA0H1GA2ga8Kw==";
        };
        _ToC8s6t0 = {
            "id" = "ToC8s6t0";
            "file" = "cobblegen-5.4.10+26.1b1471-BETA-neoforge.jar";
            "hash" = "sha512-ATlF6gnV+SUPme9CNNPuB5lUtaovujzP8txwdVDhCNEdrqUHH9bjtBQih5PVUzOyGRv/yUa5vO/hoD7Bz6ApLQ==";
        };
        _35Siwv93 = {
            "id" = "35Siwv93";
            "file" = "cobblegen-5.4.10+1.21.3b1471-BETA-neoforge.jar";
            "hash" = "sha512-MHcdFRseTDHY5K6m1zZhWc4on4/VVl5QmackNK44bCddgjY+fLDFJPMNxlY4xoDUcjrePy50g/Db5gi+Illakg==";
        };
        _A1IqNHtM = {
            "id" = "A1IqNHtM";
            "file" = "cobblegen-5.4.10+1.19.2b1471-BETA-forge.jar";
            "hash" = "sha512-r3TkzyuLlDm16FODJbOg6cVKAo56ofOrXJi+eBv64A9JFQsRH+JsgKZB5kFnhnDnSBDkVQbovWaDvdSydllaLg==";
        };
        _7x2FiyvB = {
            "id" = "7x2FiyvB";
            "file" = "cobblegen-5.4.10+1.21.5b1471-BETA-neoforge.jar";
            "hash" = "sha512-R0U5VrZk5Arwy9oisIrVnD9N1Hl0naXqQ2JZbefyBeNid8QHCxv2YDC7LMCZbNEn3A7xbCj/VAF+OQZj7zRnfw==";
        };
        _pj5i0vNd = {
            "id" = "pj5i0vNd";
            "file" = "cobblegen-5.4.10+1.20.2b1471-BETA-neoforge.jar";
            "hash" = "sha512-4X+C6zaeGE+dOHM9aKWlH0nvyEqM3TQH0RwoxWpxIqdNl9miIjdz4gdlSZlvJmSDrm50Gd9ch0eZcXwZx6LRMg==";
        };
        _JQSH2DXB = {
            "id" = "JQSH2DXB";
            "file" = "cobblegen-5.4.10+1.20.2b1471-BETA-fabric.jar";
            "hash" = "sha512-HZ8gGDBoGLniiP9zRR9sxIsJolF4F9IAQXbY/vTIlgEoc2WrR82zivr/MtncYW29DCtluIXhEk8Nu0vFIPigkg==";
        };
        _Yj0SEKkk = {
            "id" = "Yj0SEKkk";
            "file" = "cobblegen-5.4.10+1.21.5b1471-BETA-fabric.jar";
            "hash" = "sha512-V7EfGfeQnW/PvxSgVreVsbYNb2TzF33QVnhe5e1095nII5qLcQDBwJNOskQkbq+GEtO2mEtiL4P7To5Wi4CtAQ==";
        };
        _1zTNL7Uh = {
            "id" = "1zTNL7Uh";
            "file" = "cobblegen-5.4.10+1.21.3b1471-BETA-fabric.jar";
            "hash" = "sha512-1j9oVEJ3x4L8X32zT76hTybnF7GTY1eDDzRtdyuZ9smsMKQifbMjp2OFnGM6g1I2sxXoOaew1WdXJkkpXoYkrQ==";
        };
        _UFIerucl = {
            "id" = "UFIerucl";
            "file" = "cobblegen-5.4.10+1.21.1b1471-BETA-neoforge.jar";
            "hash" = "sha512-F6C1J7ICEXQrpzj5eNhD3Cpbi7NTCHVvDG2db0DFRFiC6r2TYN5JxgewjjETAjW2ilMjuNyjA45JKJ1nVUN2Ig==";
        };
        _IW9jRin1 = {
            "id" = "IW9jRin1";
            "file" = "cobblegen-5.4.10+1.20.4b1471-BETA-neoforge.jar";
            "hash" = "sha512-f3X9rfQcZy3EcT+L09C58LVq5oZsEfP+fA0qrECrW30eRaAMZMVMzSedY9T99UfeUVjiX3bcHuDVunL6rYCBFQ==";
        };
        _OchERmKN = {
            "id" = "OchERmKN";
            "file" = "cobblegen-5.4.10+1.19.4b1471-BETA-forge.jar";
            "hash" = "sha512-4hQxTKNuDtYUBeD25DoswhoVx2e7Ob0KoEd5jO5FjuQjmQJtRYgZ0SoupVDQhK6TSpfec2GnfebIEyMpTUp3uw==";
        };
        _ao6WAgdz = {
            "id" = "ao6WAgdz";
            "file" = "cobblegen-5.4.11+1.20.2b5C1XBL.jar";
            "hash" = "sha512-2QVzup/WvzNLfhGjemqmvMsyYXVdGhQrAKrtLX2SXHa8NCTqz5+mmL5fGot4hK/Y1gpporXsC8bSKoioQhRdRw==";
        };
        _RXS2Uup5 = {
            "id" = "RXS2Uup5";
            "file" = "cobblegen-5.4.11+1.21.1b5C1XBL.jar";
            "hash" = "sha512-XrUk0fREvn4fNc++Y4rPOlwVOPL+pXxr2a12Q1RIeOjI8jUOHCuTmhDiOGxqBRmuhHd8RqD+XiWwFoW4Cz0gRA==";
        };
        _k5UEdbmT = {
            "id" = "k5UEdbmT";
            "file" = "cobblegen-5.4.11+1.16.5b5C1XBL.jar";
            "hash" = "sha512-Kr3Wp/IZ08oANCX11aM/PE8SZ35K9laOIJYey9dLuNBnfQ7L+0AtaC/qIN8KvRKprC7C1cv8jIoeNadUvGg8qg==";
        };
        _toC0f0Ry = {
            "id" = "toC0f0Ry";
            "file" = "cobblegen-5.4.11+1.21.3b5C1XBL.jar";
            "hash" = "sha512-/fNLXzA6r4OdZy06fZ+5nXQUuM/Q4DrUMM4sFoLRCbU6TSHPckx7fmBZStcscyzwLf+aU9qc2qR35lh71y3ccw==";
        };
        _7xy0e0zY = {
            "id" = "7xy0e0zY";
            "file" = "cobblegen-5.4.11+26.1b5C1XBN.jar";
            "hash" = "sha512-gBaRvHAh0pZj84eG90xiHhWScH4/jeGzZU0TFvtuBJAbYrMSBt/grHsVGSlnGIgOCINWmlW2RAqZPAfJQRpJWQ==";
        };
        _qPcspB3t = {
            "id" = "qPcspB3t";
            "file" = "cobblegen-5.4.11+1.19.4b5C1XBL.jar";
            "hash" = "sha512-PLmZX4Ur6u5MCwL7k9MDc4bf1UAs/prEFB7m6Fyny2Mvh9giq29Rn5VczZ8AfVrgoy3QjtQYhxUNNB7X/VSN+A==";
        };
        _KJpKZMHe = {
            "id" = "KJpKZMHe";
            "file" = "cobblegen-5.4.11+1.21.11b5C1XBL.jar";
            "hash" = "sha512-GJQy3GNbvZZKZH0JujLqACApT2gwb6FB7myOwAHYcyIUTiuexL4/HaqWSnATpyvdQP8wc+HrCW4GzsMXUKwqVQ==";
        };
        _CNTcXTtA = {
            "id" = "CNTcXTtA";
            "file" = "cobblegen-5.4.11+1.18.2b5C1XBL.jar";
            "hash" = "sha512-KdLGUR4zqNvYUWD5NrDzEzTXAYRruvQalBTSxOgXsxJBaOg+cFxRigbrKl2FArOK3X8UJTPRyyICa82MxyZkcg==";
        };
        _qDrraHze = {
            "id" = "qDrraHze";
            "file" = "cobblegen-5.4.11+1.20.6b5C1XBL.jar";
            "hash" = "sha512-s1ct4N1GNzXjwO+6B2uwawjMqO57Prj6dW0syTPcqJCV3rEdxAuOBp9VZlAa4Ow/8xZ6YhKIeE2zdUC0Dx7njw==";
        };
        _SNhcrKnh = {
            "id" = "SNhcrKnh";
            "file" = "cobblegen-5.4.11+1.21.3b5C1XBN.jar";
            "hash" = "sha512-TsqxJjUaUQUVsCAIyFGCe80PcTDajvFUBvI47AmDDS0Yx0eAX/UVjLqdL02LGy+7+e0MUJhbMHGpMV5xLqdyCw==";
        };
        _ThRSNBGh = {
            "id" = "ThRSNBGh";
            "file" = "cobblegen-5.4.11+1.18.2b5C1XBF.jar";
            "hash" = "sha512-okIvqO/ZGVJoBSve3K0Htx+mW315RTpnQfXeYfpbPo3ikTRIE7jj37Dir7ju1OjuNHRH6ft8QjR2hWQ4ylLFZQ==";
        };
        _INpmv1TC = {
            "id" = "INpmv1TC";
            "file" = "cobblegen-5.4.11+1.20.1b5C1XBF.jar";
            "hash" = "sha512-Dx9Xj4pxZV4gQ0ub5k7oLlmI6lpYDkCrlZ1B0UI5igAJdniMOKMBqK63+weSYmPLVIPfhhiqkXBdzTOTfoFD4Q==";
        };
        _43ewAqfW = {
            "id" = "43ewAqfW";
            "file" = "cobblegen-5.4.11+1.20.6b5C1XBN.jar";
            "hash" = "sha512-X2LBGfveiVEm7XPlHkadncOzuB8N/jJhqWy/qmoLFtnO39bVM7nF6z9gOtUwNsMBTftP1LCdpnnJxjZAPDjHrA==";
        };
        _OUezs7C3 = {
            "id" = "OUezs7C3";
            "file" = "cobblegen-5.4.11+1.20.2b5C1XBN.jar";
            "hash" = "sha512-mDCuMeq7+OVSVq4lXHV5XzQB99ZJNfuLCELRmiCwYsE0MginJTwf/0bOcjPRvRbBreJBfH9s7o/0+sp4N/wnqg==";
        };
        _hZaEwXtf = {
            "id" = "hZaEwXtf";
            "file" = "cobblegen-5.4.11+1.21.11b5C1XBN.jar";
            "hash" = "sha512-NheypYwOb7TV8fS4x+O3irwCv+j51FuIJI1gBwm4yCjAlv1dhyB3bvYWqcgIlvl0idONteaheqXO/1Sx6/vqCw==";
        };
        _CunWLvJe = {
            "id" = "CunWLvJe";
            "file" = "cobblegen-5.4.11+1.19.2b5C1XBL.jar";
            "hash" = "sha512-VMDsAeP/Xoh/fGe+AaxqP1oG3WmuZxtLJv9XU7Rl4tR9E303k8PgwPjUFian65jextjyjweI5Vkusn8LwPbJSg==";
        };
        _K4IinUMI = {
            "id" = "K4IinUMI";
            "file" = "cobblegen-5.4.11+1.21.1b5C1XBN.jar";
            "hash" = "sha512-d6vC0U24cH49RA7DXOeOrl6phFvvTyOdSJfAUxO/ZKwWHzeEyusqKsTXvS8OfzcZrlFur0LWH8BPNKTLTFIhUg==";
        };
        _rszaNiu4 = {
            "id" = "rszaNiu4";
            "file" = "cobblegen-5.4.11+1.21.5b5C1XBN.jar";
            "hash" = "sha512-fv2XjowzPr6QYyFx224d9ef6IGEn0ntTzflTFOipsgF528q2hZPESOqnCcPgrXBseqL1K+q4h4VjjUtKHBjo3Q==";
        };
        _5i7873rN = {
            "id" = "5i7873rN";
            "file" = "cobblegen-5.4.11+1.19.2b5C1XBF.jar";
            "hash" = "sha512-fRnXF5/a6NeOe1rzVUm2UdNPVX4VnFlukpD6LNXB4SizIZiosCm6qIBK3vC7gfp4MdKLqa2SuLxHAAkUkjh0MA==";
        };
        _t652levU = {
            "id" = "t652levU";
            "file" = "cobblegen-5.4.11+1.20.1b5C1XBL.jar";
            "hash" = "sha512-+/SFzsTusyL51uT4ZiModynlrDgqVcCNXGY3Ms37oUmgF9/itRRe7piDVyvCtIdF9yp+tsFGN4bkcGk41F5T7g==";
        };
        _iCi7lODY = {
            "id" = "iCi7lODY";
            "file" = "cobblegen-5.4.11+26.1b5C1XBL.jar";
            "hash" = "sha512-CmpgBUzsRQJGcUqOcWrCrOV0Mc1GL4zWs6LPYyyRgP5QBBuBFpF6V7peNsqnCz9wkpr0pk5MeKX4RXrbeYwrfg==";
        };
        _hwzrTNuj = {
            "id" = "hwzrTNuj";
            "file" = "cobblegen-5.4.11+1.21.5b5C1XBL.jar";
            "hash" = "sha512-dOk/Sp4qbS0jU2+S1zccmQ5ngCIdZYNk910ubTFvXxrztPHUaiKy1SHzdHdlZx0Y7zQZ0oNsE/gQaIzg4nCwqQ==";
        };
        _CRB9M46S = {
            "id" = "CRB9M46S";
            "file" = "cobblegen-5.4.11+1.19.4b5C1XBF.jar";
            "hash" = "sha512-MKzJ5adDw+VLlJnm0k1BFPHrI5G+zsUpjmaMHVeXMfs9suyykza0bR+iob7/eaQDe/P4r8bBNdFhvpiQc3DZBA==";
        };
        _23JMMLNN = {
            "id" = "23JMMLNN";
            "file" = "cobblegen-5.4.11+1.16.5b5C1XBF.jar";
            "hash" = "sha512-1KxajDVHEn7EnbQ7rsAqNh9X5OTcz6NV75uQpPyICtzmfawfyIvMcVxKKZwtnbvRKwL5Xk5x8TERKI6rMoHsCw==";
        };
        _qYGe23lx = {
            "id" = "qYGe23lx";
            "file" = "cobblegen-5.4.11+1.20.4b5C1XBN.jar";
            "hash" = "sha512-V5fmrxamcB2Ks3IhO8m6fCha+4aBmE/mC2ya+6hZKk861Eho36SEeR21m8PykSYl2MaCdLn2GLWi/iZRjDWyzw==";
        };
    in {
        "9n8fdf1Z" = _9n8fdf1Z;
        "zyhv6ZiN" = _zyhv6ZiN;
        ...
        "fabric-1.18.2" = _CNTcXTtA;
        "fabric-1.19" = _CunWLvJe;
        "fabric-1.18" = _wpdE5wNp;
        "fabric-1.19.1" = _CunWLvJe;
        "fabric-1.19.2" = _CunWLvJe;
        "fabric-1.19.3" = _qPcspB3t;
        "fabric-1.19.4" = _qPcspB3t;
        "fabric-1.20-pre1" = _Jz4BFR5W;
        "fabric-1.20-pre2" = _Jz4BFR5W;
        "fabric-1.20-pre3" = _Jz4BFR5W;
        "fabric-1.20-pre4" = _Jz4BFR5W;
        "fabric-1.20" = _t652levU;
        "fabric-1.20.1" = _t652levU;
        "fabric-1.20.2" = _ao6WAgdz;
        "fabric-1.20.3" = _ao6WAgdz;
        "fabric-1.20.4" = _ao6WAgdz;
        "fabric-1.16.5" = _k5UEdbmT;
        ...
        "fabric-1.20.5" = _qDrraHze;
        "fabric-1.20.6" = _qDrraHze;
        "fabric-1.21" = _RXS2Uup5;
        "fabric-1.21.1" = _RXS2Uup5;
        "fabric-1.21.2" = _toC0f0Ry;
        "fabric-1.21.3" = _toC0f0Ry;
        "fabric-1.21.4" = _toC0f0Ry;
        "fabric-1.21.5" = _hwzrTNuj;
        "fabric-1.21.6" = _hwzrTNuj;
        "fabric-1.21.7" = _hwzrTNuj;
        "fabric-1.21.8" = _hwzrTNuj;
        "fabric-1.21.9" = _hwzrTNuj;
        "fabric-1.21.10" = _hwzrTNuj;
        "fabric-1.21.11" = _KJpKZMHe;
        "fabric-26.1" = _iCi7lODY;
        "fabric-26.1.1" = _iCi7lODY;
        "fabric-26.1.2" = _iCi7lODY;
        "fabric-26.2" = _iCi7lODY;
        ...
        "quilt-1.18.2" = _CNTcXTtA;
        "quilt-1.19" = _CunWLvJe;
        "quilt-1.18" = _wpdE5wNp;
        "quilt-1.19.1" = _CunWLvJe;
        "quilt-1.19.2" = _CunWLvJe;
        "quilt-1.19.3" = _qPcspB3t;
        "quilt-1.19.4" = _qPcspB3t;
        "quilt-1.20-pre1" = _Jz4BFR5W;
        "quilt-1.20-pre2" = _Jz4BFR5W;
        "quilt-1.20-pre3" = _Jz4BFR5W;
        "quilt-1.20-pre4" = _Jz4BFR5W;
        "quilt-1.20" = _t652levU;
        "quilt-1.20.1" = _t652levU;
        "quilt-1.20.2" = _ao6WAgdz;
        "quilt-1.20.3" = _ao6WAgdz;
        "quilt-1.20.4" = _ao6WAgdz;
        "quilt-1.16.5" = _k5UEdbmT;
        ...
        "quilt-1.20.5" = _qDrraHze;
        "quilt-1.20.6" = _qDrraHze;
        "quilt-1.21" = _RXS2Uup5;
        "quilt-1.21.1" = _RXS2Uup5;
        "quilt-1.21.2" = _toC0f0Ry;
        "quilt-1.21.3" = _toC0f0Ry;
        "quilt-1.21.4" = _toC0f0Ry;
        "quilt-1.21.5" = _hwzrTNuj;
        "quilt-1.21.6" = _hwzrTNuj;
        "quilt-1.21.7" = _hwzrTNuj;
        "quilt-1.21.8" = _hwzrTNuj;
        "quilt-1.21.9" = _hwzrTNuj;
        "quilt-1.21.10" = _hwzrTNuj;
        "quilt-1.21.11" = _KJpKZMHe;
        "quilt-26.1" = _iCi7lODY;
        "quilt-26.1.1" = _iCi7lODY;
        "quilt-26.1.2" = _iCi7lODY;
        "quilt-26.2" = _iCi7lODY;
        "forge-1.18.2" = _ThRSNBGh;
        "forge-1.19" = _5i7873rN;
        "forge-1.19.1" = _5i7873rN;
        "forge-1.19.2" = _5i7873rN;
        "forge-1.19.3" = _CRB9M46S;
        "forge-1.19.4" = _CRB9M46S;
        "forge-1.20" = _INpmv1TC;
        "forge-1.20.1" = _INpmv1TC;
        "forge-1.20.2" = _kGkLzRtN;
        "forge-1.20.3" = _kGkLzRtN;
        "forge-1.20.4" = _kGkLzRtN;
        "forge-1.16.5" = _23JMMLNN;
        "neoforge-1.20" = _INpmv1TC;
        "neoforge-1.20.1" = _INpmv1TC;
        "neoforge-1.20.2" = _OUezs7C3;
        "neoforge-1.20.3" = _OUezs7C3;
        "neoforge-1.20.4" = _qYGe23lx;
        "neoforge-24w12a" = _LH05ZXFQ;
        "neoforge-24w13a" = _LH05ZXFQ;
        "neoforge-24w14a" = _LH05ZXFQ;
        "neoforge-1.20.5" = _43ewAqfW;
        "neoforge-1.20.6" = _43ewAqfW;
        "neoforge-1.21" = _K4IinUMI;
        "neoforge-1.21.1" = _K4IinUMI;
        "neoforge-1.21.2" = _SNhcrKnh;
        "neoforge-1.21.3" = _SNhcrKnh;
        "neoforge-1.21.4" = _SNhcrKnh;
        "neoforge-1.21.5" = _rszaNiu4;
        "neoforge-1.21.6" = _rszaNiu4;
        "neoforge-1.21.7" = _rszaNiu4;
        "neoforge-1.21.8" = _rszaNiu4;
        "neoforge-1.21.9" = _rszaNiu4;
        "neoforge-1.21.10" = _rszaNiu4;
        "neoforge-1.21.11" = _hZaEwXtf;
        "neoforge-26.1" = _7xy0e0zY;
        "neoforge-26.1.1" = _7xy0e0zY;
        "neoforge-26.1.2" = _7xy0e0zY;
        "neoforge-26.2" = _7xy0e0zY;
        "pkg-1.3" = _9n8fdf1Z;
        "pkg-1.4" = _zyhv6ZiN;
        "pkg-1.5" = _AbmmS6DN;
        "pkg-1.6" = _gny7iypY;
        "pkg-1.7" = _tlx1J8TW;
        "pkg-1.8" = _vLAGKIcJ;
        "pkg-1.9-mc1.18" = _KT5VC3oR;
        "pkg-1.9-mc1.19" = _8XHppdYZ;
        "pkg-1.10-mc1.19" = _TyY10iy7;
        "pkg-1.10-mc1.18" = _7ymtMYQ2;
        "pkg-1.11-mc1.18" = _wpdE5wNp;
        "pkg-1.11-mc1.19" = _7NmkpT44;
        "pkg-2.0" = _jHwHqO40;
        "pkg-2.1" = _RFDCisoA;
        "pkg-2.1-mc1.19.3" = _PYpFh5DY;
        "pkg-2.2-1.19.3" = _qiAQRXQr;
        "pkg-2.2" = _s2m1JFEk;
        "pkg-3.0" = _W1ESMLmR;
        "pkg-3.1+2-BETA" = _bNnEWcK7;
        "pkg-3.2+3-BETA" = _o3WAqhAV;
        "pkg-3.2.1+4-BETA" = _jIXn89xg;
        "pkg-4.0+5-ALPHA" = _o3w7M1yI;
        "pkg-4.0.1+6-ALPHA" = _LtRIMlmu;
        "pkg-4.0.2+7-ALPHA" = _4arnSZYk;
        "pkg-4.0.3+8-ALPHA" = _Os75fOdk;
        "pkg-4.0.4+9-ALPHA" = _AmuOI2Hm;
        "pkg-4.0.5+10-ALPHA" = _Mr6GZlg9;
        "pkg-4.0+11-BETA" = _UdNEMt8e;
        "pkg-4.0.1+12-BETA" = _7qVZzHaW;
        "pkg-4.0.2+13-BETA" = _IxqYZjSd;
        "pkg-4.0.3+14-BETA" = _Jz4BFR5W;
        "pkg-4.0.4+15-BETA" = _rOpYwcTt;
        "pkg-5.0.0+1.18.2b18-ALPHA" = _59Ok7YW8;
        "pkg-5.0.0+1.19.2b18-ALPHA" = _rJLIOaHq;
        "pkg-5.0.0+1.19.4b18-ALPHA" = _xnR9AXn1;
        "pkg-5.0.0+1.20.1b18-ALPHA" = _UV48uxmB;
        "pkg-5.0.1+1.18.2b19-ALPHA-fabric" = _EXYtlCMH;
        "pkg-5.0.1+1.18.2b19-ALPHA-forge" = _7BP9JYRv;
        "pkg-5.0.1+1.19.2b19-ALPHA-fabric" = _CGr9iym2;
        "pkg-5.0.1+1.19.2b19-ALPHA-forge" = _kLhWULQt;
        "pkg-5.0.1+1.19.4b19-ALPHA-fabric" = _RoGOoOYZ;
        "pkg-5.0.1+1.19.4b19-ALPHA-forge" = _g47q1c30;
        "pkg-5.0.1+1.20.1b19-ALPHA-fabric" = _qzIzxtup;
        "pkg-5.0.1+1.20.1b19-ALPHA-forge" = _fNluIG9W;
        "pkg-5.0.2+1.18.2b20-ALPHA-fabric" = _IUZC6Sxr;
        "pkg-5.0.2+1.18.2b20-ALPHA-forge" = _BskwLlmO;
        "pkg-5.0.2+1.19.2b20-ALPHA-fabric" = _crQXWMxE;
        "pkg-5.0.2+1.19.2b20-ALPHA-forge" = _7AyZllVy;
        "pkg-5.0.2+1.19.4b20-ALPHA-fabric" = _U0JHDty6;
        "pkg-5.0.2+1.19.4b20-ALPHA-forge" = _A9W6ymrb;
        "pkg-5.0.2+1.20.1b20-ALPHA-fabric" = _TzJuWxAJ;
        "pkg-5.0.2+1.20.1b20-ALPHA-forge" = _P6o9QK2c;
        "pkg-5.0.3+1.18.2b21-ALPHA-fabric" = _MaiQcICk;
        "pkg-5.0.3+1.18.2b21-ALPHA-forge" = _SyV0ZsJC;
        "pkg-5.0.3+1.19.2b21-ALPHA-fabric" = _HpfCsQ1k;
        "pkg-5.0.3+1.19.2b21-ALPHA-forge" = _3fHhqnMO;
        "pkg-5.0.3+1.19.4b21-ALPHA-fabric" = _hRWnNrw6;
        "pkg-5.0.3+1.19.4b21-ALPHA-forge" = _MFvSn8DY;
        "pkg-5.0.3+1.20.1b21-ALPHA-fabric" = _ssR8zbzj;
        "pkg-5.0.3+1.20.1b21-ALPHA-forge" = _ehc0eZyC;
        "pkg-5.0.0+1.18.2b22-BETA-fabric" = _HwSqqVnb;
        "pkg-5.0.0+1.18.2b22-BETA-forge" = _r5t5tJtZ;
        "pkg-5.0.0+1.19.2b22-BETA-fabric" = _snV4PQYp;
        "pkg-5.0.0+1.19.2b22-BETA-forge" = _D1RZQMrc;
        "pkg-5.0.0+1.19.4b22-BETA-fabric" = _dYjxpvfa;
        "pkg-5.0.0+1.19.4b22-BETA-forge" = _cfYX9eTZ;
        "pkg-5.0.0+1.20.1b22-BETA-fabric" = _YTa4Wwqb;
        "pkg-5.0.0+1.20.1b22-BETA-forge" = _51X5c4dk;
        "pkg-5.0.1+1.18.2b23-BETA-fabric" = _Ro73JWZW;
        "pkg-5.0.1+1.18.2b23-BETA-forge" = _pvymY9AX;
        "pkg-5.0.1+1.19.2b23-BETA-fabric" = _ecW1ujKw;
        "pkg-5.0.1+1.19.2b23-BETA-forge" = _NDH6emA8;
        "pkg-5.0.1+1.19.4b23-BETA-fabric" = _Qw22a5GQ;
        "pkg-5.0.1+1.19.4b23-BETA-forge" = _w8ZP92hV;
        "pkg-5.0.1+1.20.1b23-BETA-fabric" = _EC3Uszni;
        "pkg-5.0.1+1.20.1b23-BETA-forge" = _3I8oof45;
        "pkg-5.0.2+1.18.2b24-BETA-fabric" = _zKAvzw5h;
        "pkg-5.0.2+1.18.2b24-BETA-forge" = _IKEqkOHe;
        "pkg-5.0.2+1.19.2b24-BETA-fabric" = _NlFYLh0s;
        "pkg-5.0.2+1.19.2b24-BETA-forge" = _ns0i6FGF;
        "pkg-5.0.2+1.19.4b24-BETA-fabric" = _vQZCu62F;
        "pkg-5.0.2+1.19.4b24-BETA-forge" = _gajhu6km;
        "pkg-5.0.2+1.20.1b24-BETA-fabric" = _EQQSPECr;
        "pkg-5.0.2+1.20.1b24-BETA-forge" = _9yOD5SbB;
        "pkg-5.0.3+1.18.2b25-BETA-fabric" = _nfnnKm3H;
        "pkg-5.0.3+1.18.2b25-BETA-forge" = _sKmkhYHc;
        "pkg-5.0.3+1.19.2b25-BETA-fabric" = _j7V7OrVL;
        "pkg-5.0.3+1.19.2b25-BETA-forge" = _TB1lXWjm;
        "pkg-5.0.3+1.19.4b25-BETA-fabric" = _GKsya05Q;
        "pkg-5.0.3+1.19.4b25-BETA-forge" = _NHF5zHZ4;
        "pkg-5.0.3+1.20.1b25-BETA-fabric" = _LpG2GQNT;
        "pkg-5.0.3+1.20.1b25-BETA-forge" = _nOov1rGz;
        "pkg-5.1.0+1.18.2b26-BETA-fabric" = _ugHa7Fj8;
        "pkg-5.1.0+1.18.2b26-BETA-forge" = _EXIeG0Qh;
        "pkg-5.1.0+1.19.2b26-BETA-fabric" = _FRmAlFnQ;
        "pkg-5.1.0+1.19.2b26-BETA-forge" = _YPR0XZog;
        "pkg-5.1.0+1.19.4b26-BETA-fabric" = _5dW8H6VE;
        "pkg-5.1.0+1.19.4b26-BETA-forge" = _T5oqGN9P;
        "pkg-5.1.0+1.20.1b26-BETA-fabric" = _nrirDdE7;
        "pkg-5.1.0+1.20.1b26-BETA-forge" = _t9hBDcgq;
        "pkg-5.1.0+1.20.2b26-BETA-fabric" = _WJuVGqUl;
        "pkg-5.1.1+1.18.2b28-BETA-fabric" = _ho5vnMoh;
        "pkg-5.1.1+1.18.2b28-BETA-forge" = _anCIpf51;
        "pkg-5.1.1+1.19.2b28-BETA-fabric" = _rnGgRLbS;
        "pkg-5.1.1+1.19.2b28-BETA-forge" = _ceny0uST;
        "pkg-5.1.1+1.19.4b28-BETA-fabric" = _lqCx525K;
        "pkg-5.1.1+1.19.4b28-BETA-forge" = _iWI4K6dm;
        "pkg-5.1.1+1.20.1b28-BETA-fabric" = _Hv9aO8yV;
        "pkg-5.1.1+1.20.1b28-BETA-forge" = _AU1zj3Qx;
        "pkg-5.1.1+1.20.2b28-BETA-fabric" = _G80sFyX0;
        "pkg-5.1.1+1.20.2b28-BETA-forge" = _IEpm6GrO;
        "pkg-5.2.0+1.18.2b29-BETA-fabric" = _3e3sN6aL;
        "pkg-5.2.0+1.18.2b29-BETA-forge" = _e8ou0gtB;
        "pkg-5.2.0+1.19.2b29-BETA-fabric" = _AiIKdBlE;
        "pkg-5.2.0+1.19.2b29-BETA-forge" = _3rAIVnEv;
        "pkg-5.2.0+1.19.4b29-BETA-fabric" = _BG11DuQt;
        "pkg-5.2.0+1.19.4b29-BETA-forge" = _qpYFhGBi;
        "pkg-5.2.0+1.20.1b29-BETA-fabric" = _ugDD8MCq;
        "pkg-5.2.0+1.20.1b29-BETA-forge" = _yxJM0OND;
        "pkg-5.2.0+1.20.2b29-BETA-fabric" = _Ch7FOdzO;
        "pkg-5.2.0+1.20.2b29-BETA-forge" = _lRhMeoAz;
        "pkg-5.2.1+1.18.2b30-BETA-fabric" = _YLslwYq9;
        "pkg-5.2.1+1.18.2b30-BETA-forge" = _gltXSdpO;
        "pkg-5.2.1+1.19.2b30-BETA-fabric" = _GLZAnVkq;
        "pkg-5.2.1+1.19.2b30-BETA-forge" = _ZxSgeSGK;
        "pkg-5.2.1+1.19.4b30-BETA-fabric" = _UEeq39or;
        "pkg-5.2.1+1.19.4b30-BETA-forge" = _idvEjI7g;
        "pkg-5.2.1+1.20.1b30-BETA-fabric" = _MTt9DlhX;
        "pkg-5.2.1+1.20.1b30-BETA-forge" = _X2biDdfj;
        "pkg-5.2.1+1.20.2b30-BETA-fabric" = _cbyREDv9;
        "pkg-5.2.1+1.20.2b30-BETA-forge" = _NHykUq5O;
        "pkg-5.2.2+1.18.2b31-BETA-fabric" = _mx9RGouC;
        "pkg-5.2.2+1.18.2b31-BETA-forge" = _ZDBc7B7O;
        "pkg-5.2.2+1.19.2b31-BETA-fabric" = _bjnCjZNr;
        "pkg-5.2.2+1.19.2b31-BETA-forge" = _NraBOg1j;
        "pkg-5.2.2+1.19.4b31-BETA-fabric" = _sOBBoMHs;
        "pkg-5.2.2+1.19.4b31-BETA-forge" = _zz8rXiqv;
        "pkg-5.2.2+1.20.1b31-BETA-fabric" = _lTz6CxF2;
        "pkg-5.2.2+1.20.1b31-BETA-forge" = _7IfhLEur;
        "pkg-5.2.2+1.20.2b31-BETA-fabric" = _LD94fiAT;
        "pkg-5.2.2+1.20.2b31-BETA-forge" = _X2IfK2Pw;
        "pkg-5.2.3+1.18.2b32-BETA-fabric" = _HOhGbGDj;
        "pkg-5.2.3+1.18.2b32-BETA-forge" = _ymwRvUSu;
        "pkg-5.2.3+1.19.2b32-BETA-fabric" = _V6cdbU0R;
        "pkg-5.2.3+1.19.2b32-BETA-forge" = _Va7f5kRw;
        "pkg-5.2.3+1.19.4b32-BETA-fabric" = _oYNkh0y2;
        "pkg-5.2.3+1.19.4b32-BETA-forge" = _XSkqaTao;
        "pkg-5.2.3+1.20.1b32-BETA-fabric" = _KzZfoctG;
        "pkg-5.2.3+1.20.1b32-BETA-forge" = _F7ePYSwL;
        "pkg-5.2.3+1.20.2b32-BETA-fabric" = _azrjLAEB;
        "pkg-5.2.3+1.20.2b32-BETA-forge" = _ART1YHBt;
        "pkg-5.2.3+1.20.2b32-BETA-neoforge" = _nV9Px5Xv;
        "pkg-5.2.4+1.16.5b33-BETA-fabric" = _9jm5BuGd;
        "pkg-5.2.4+1.16.5b33-BETA-forge" = _HNvsy9IN;
        "pkg-5.2.4+1.18.2b33-BETA-fabric" = _IIUz8xKP;
        "pkg-5.2.4+1.18.2b33-BETA-forge" = _vY9Olzn0;
        "pkg-5.2.4+1.19.2b33-BETA-fabric" = _EGTNebe9;
        "pkg-5.2.4+1.19.2b33-BETA-forge" = _XrffMRay;
        "pkg-5.2.4+1.19.4b33-BETA-fabric" = _GSzz2tPt;
        "pkg-5.2.4+1.19.4b33-BETA-forge" = _eywISovo;
        "pkg-5.2.4+1.20.1b33-BETA-fabric" = _IQdXoQfc;
        "pkg-5.2.4+1.20.1b33-BETA-forge" = _I5mHxG2z;
        "pkg-5.2.4+1.20.2b33-BETA-fabric" = _Mrh2pkVY;
        "pkg-5.2.4+1.20.2b33-BETA-forge" = _kGkLzRtN;
        "pkg-5.2.4+1.20.2b33-BETA-neoforge" = _RO1qGwuX;
        "pkg-5.3.0+1.16.5b35-BETA-fabric" = _vM6tXzqo;
        "pkg-5.3.0+1.16.5b35-BETA-forge" = _ZPPCmGlW;
        "pkg-5.3.0+1.18.2b35-BETA-fabric" = _2DIldR0A;
        "pkg-5.3.0+1.18.2b35-BETA-forge" = _BDhChsr4;
        "pkg-5.3.0+1.19.2b35-BETA-fabric" = _eUzhhybc;
        "pkg-5.3.0+1.19.2b35-BETA-forge" = _zYoPVggJ;
        "pkg-5.3.0+1.20.1b35-BETA-fabric" = _1SurExTF;
        "pkg-5.3.0+1.20.1b35-BETA-forge" = _gMXBU7Bs;
        "pkg-5.3.0+1.20.2b35-BETA-fabric" = _TCtboHrZ;
        "pkg-5.3.0+1.20.2b35-BETA-neoforge" = _TfUxuXBO;
        "pkg-5.3.0+1.20.5b35-BETA-fabric" = _oKtjv57Q;
        "pkg-5.3.1+1.16.5b36-BETA-fabric" = _oW7lxdAh;
        "pkg-5.3.1+1.16.5b36-BETA-forge" = _DEhrdZZh;
        "pkg-5.3.1+1.18.2b36-BETA-fabric" = _DK8Hr3LN;
        "pkg-5.3.1+1.18.2b36-BETA-forge" = _l0owzqLY;
        "pkg-5.3.1+1.19.2b36-BETA-fabric" = _HXG7Zjco;
        "pkg-5.3.1+1.19.2b36-BETA-forge" = _daDpYj7R;
        "pkg-5.3.1+1.20.1b36-BETA-fabric" = _sH2b1YpJ;
        "pkg-5.3.1+1.20.1b36-BETA-forge" = _Ww1JOfbh;
        "pkg-5.3.1+1.20.2b36-BETA-fabric" = _wJjPDMuq;
        "pkg-5.3.1+1.20.2b36-BETA-neoforge" = _GTyimSMZ;
        "pkg-5.3.1+1.20.5b36-BETA-fabric" = _jnIRYarl;
        "pkg-5.3.2+1.16.5b37-BETA-fabric" = _zdgKRKYG;
        "pkg-5.3.2+1.16.5b37-BETA-forge" = _G8VU0TUY;
        "pkg-5.3.2+1.18.2b37-BETA-fabric" = _FzcDkpLG;
        "pkg-5.3.2+1.18.2b37-BETA-forge" = _fgeq2q1d;
        "pkg-5.3.2+1.19.2b37-BETA-fabric" = _PseTeebw;
        "pkg-5.3.2+1.19.2b37-BETA-forge" = _c6CAhqYg;
        "pkg-5.3.2+1.20.1b37-BETA-fabric" = _o4HOPddY;
        "pkg-5.3.2+1.20.1b37-BETA-forge" = _rdQH7hc4;
        "pkg-5.3.2+1.20.2b37-BETA-fabric" = _7ENl62Ty;
        "pkg-5.3.2+1.20.2b37-BETA-neoforge" = _LWpbgOqs;
        "pkg-5.3.2+1.20.5b37-BETA-fabric" = _iyfgrVHD;
        "pkg-5.3.3+1.16.5b38-BETA-fabric" = _nxAzAmqX;
        "pkg-5.3.3+1.16.5b38-BETA-forge" = _7mcZfmzN;
        "pkg-5.3.3+1.18.2b38-BETA-fabric" = _Vu4foZ3C;
        "pkg-5.3.3+1.18.2b38-BETA-forge" = _DydNjBGS;
        "pkg-5.3.3+1.19.2b38-BETA-fabric" = _3nyKrk0f;
        "pkg-5.3.3+1.19.2b38-BETA-forge" = _ldnN1MNw;
        "pkg-5.3.3+1.20.1b38-BETA-fabric" = _bnm6bBAC;
        "pkg-5.3.3+1.20.1b38-BETA-forge" = _HpI0aQW9;
        "pkg-5.3.3+1.20.2b38-BETA-fabric" = _DA7MUPWZ;
        "pkg-5.3.3+1.20.2b38-BETA-neoforge" = _a9tKEILI;
        "pkg-5.3.3+1.20.5b38-BETA-fabric" = _edsIkvui;
        "pkg-5.3.4+1.16.5b40-BETA-fabric" = _Hva3TTkA;
        "pkg-5.3.4+1.16.5b40-BETA-forge" = _HhqEHKgB;
        "pkg-5.3.4+1.18.2b40-BETA-fabric" = _C9lKMrAK;
        "pkg-5.3.4+1.18.2b40-BETA-forge" = _hZ9TFMnP;
        "pkg-5.3.4+1.19.2b40-BETA-fabric" = _3vTcio12;
        "pkg-5.3.4+1.19.2b40-BETA-forge" = _CvvbQzIL;
        "pkg-5.3.4+1.20.1b40-BETA-fabric" = _ZaOJHpRW;
        "pkg-5.3.4+1.20.1b40-BETA-forge" = _XA0Ia8BI;
        "pkg-5.3.4+1.20.2b40-BETA-fabric" = _CFBKm95K;
        "pkg-5.3.4+1.20.2b40-BETA-neoforge" = _MdGZ0uSS;
        "pkg-5.3.4+1.20.5b40-BETA-fabric" = _qXGFU0kp;
        "pkg-5.3.4+1.20.5b40-BETA-neoforge" = _LH05ZXFQ;
        "pkg-5.3.5+1.16.5b41-BETA-fabric" = _e4H5tiRg;
        "pkg-5.3.5+1.16.5b41-BETA-forge" = _ohtPS3S6;
        "pkg-5.3.5+1.18.2b41-BETA-fabric" = _ws1GM0rR;
        "pkg-5.3.5+1.18.2b41-BETA-forge" = _Fmdnu4Yg;
        "pkg-5.3.5+1.19.2b41-BETA-fabric" = _3km7UVDJ;
        "pkg-5.3.5+1.19.2b41-BETA-forge" = _SRwuMC8L;
        "pkg-5.3.5+1.20.1b41-BETA-fabric" = _mRARQk4L;
        "pkg-5.3.5+1.20.1b41-BETA-forge" = _n9RSHoSt;
        "pkg-5.3.5+1.20.2b41-BETA-fabric" = _rgL5hocS;
        "pkg-5.3.5+1.20.2b41-BETA-neoforge" = _71CAZWUe;
        "pkg-5.3.5+1.20.5b41-BETA-fabric" = _LnueAOeO;
        "pkg-5.3.5+1.20.5b41-BETA-neoforge" = _WjSQmbzg;
        "pkg-5.3.6+1.16.5b42-BETA-fabric" = _3O2m3Qke;
        "pkg-5.3.6+1.16.5b42-BETA-forge" = _XAFLUFZu;
        "pkg-5.3.6+1.18.2b42-BETA-fabric" = _M3a9yajW;
        "pkg-5.3.6+1.18.2b42-BETA-forge" = _j4PJChyQ;
        "pkg-5.3.6+1.19.2b42-BETA-fabric" = _hCDfGtEI;
        "pkg-5.3.6+1.19.2b42-BETA-forge" = _1kZ6l0WT;
        "pkg-5.3.6+1.20.1b42-BETA-fabric" = _C6m3gQRL;
        "pkg-5.3.6+1.20.1b42-BETA-forge" = _JymlXnZa;
        "pkg-5.3.6+1.20.2b42-BETA-fabric" = _yOTxh3vh;
        "pkg-5.3.6+1.20.2b42-BETA-neoforge" = _4KIemqk1;
        "pkg-5.3.6+1.20.5b42-BETA-fabric" = _ZQTCrwLj;
        "pkg-5.3.6+1.20.5b42-BETA-neoforge" = _y9PUmgfA;
        "pkg-5.3.7+1.16.5b43-BETA-fabric" = _gh1Jrqnd;
        "pkg-5.3.7+1.16.5b43-BETA-forge" = _s7mGWQ0M;
        "pkg-5.3.7+1.18.2b43-BETA-fabric" = _NzhgN1MU;
        "pkg-5.3.7+1.18.2b43-BETA-forge" = _mu7SpCFS;
        "pkg-5.3.7+1.19.2b43-BETA-fabric" = _A8gPQA0j;
        "pkg-5.3.7+1.19.2b43-BETA-forge" = _RRepAeAk;
        "pkg-5.3.7+1.20.1b43-BETA-fabric" = _ejuzFCb1;
        "pkg-5.3.7+1.20.1b43-BETA-forge" = _7BfMsmVy;
        "pkg-5.3.7+1.20.2b43-BETA-fabric" = _awnFsAvc;
        "pkg-5.3.7+1.20.2b43-BETA-neoforge" = _jBE6TDk5;
        "pkg-5.3.7+1.20.5b43-BETA-fabric" = _istGBFJY;
        "pkg-5.3.7+1.20.5b43-BETA-neoforge" = _Qj7SHvYK;
        "pkg-5.3.7+1.21b43-BETA-fabric" = _e3gJ5kIK;
        "pkg-5.3.7+1.21b43-BETA-neoforge" = _EkpVS72J;
        "pkg-5.3.8+1.16.5b44-BETA-fabric" = _CVFiPSy7;
        "pkg-5.3.8+1.16.5b44-BETA-forge" = _aaf1WON2;
        "pkg-5.3.8+1.18.2b44-BETA-fabric" = _L5K0G8zN;
        "pkg-5.3.8+1.18.2b44-BETA-forge" = _NRyw9tcc;
        "pkg-5.3.8+1.19.2b44-BETA-fabric" = _PJbNgGFY;
        "pkg-5.3.8+1.19.2b44-BETA-forge" = _DwFi68Z4;
        "pkg-5.3.8+1.20.1b44-BETA-fabric" = _LfHjfUtF;
        "pkg-5.3.8+1.20.1b44-BETA-forge" = _CyjGbOco;
        "pkg-5.3.8+1.20.2b44-BETA-fabric" = _z7Jw9gV3;
        "pkg-5.3.8+1.20.2b44-BETA-neoforge" = _9bDgdM0c;
        "pkg-5.3.8+1.20.5b44-BETA-fabric" = _Q4mMlS2w;
        "pkg-5.3.8+1.20.5b44-BETA-neoforge" = _jw4hvYzT;
        "pkg-5.3.8+1.21b44-BETA-fabric" = _BMVz8lxX;
        "pkg-5.3.8+1.21b44-BETA-neoforge" = _e7fwYr5e;
        "pkg-5.3.9+1.16.5b45-BETA-fabric" = _laPbOb5j;
        "pkg-5.3.9+1.16.5b45-BETA-forge" = _eESI1wmb;
        "pkg-5.3.9+1.18.2b45-BETA-fabric" = _z6arGwAm;
        "pkg-5.3.9+1.18.2b45-BETA-forge" = _5epW9OP8;
        "pkg-5.3.9+1.19.2b45-BETA-fabric" = _jeJBpkzs;
        "pkg-5.3.9+1.19.2b45-BETA-forge" = _UZAf9AMX;
        "pkg-5.3.9+1.20.1b45-BETA-fabric" = _zgMc1dRP;
        "pkg-5.3.9+1.20.1b45-BETA-forge" = _NDQP62sn;
        "pkg-5.3.9+1.20.2b45-BETA-fabric" = _gdCW4KCn;
        "pkg-5.3.9+1.20.2b45-BETA-neoforge" = _Wm8pSoAj;
        "pkg-5.3.9+1.20.5b45-BETA-fabric" = _WmYW43d9;
        "pkg-5.3.9+1.20.5b45-BETA-neoforge" = _ADipRoDy;
        "pkg-5.3.9+1.21b45-BETA-fabric" = _IH2BPVfC;
        "pkg-5.3.9+1.21b45-BETA-neoforge" = _1zSUQa6Q;
        "pkg-5.3.10+1.16.5b46-BETA-fabric" = _QZpHMcb0;
        "pkg-5.3.10+1.16.5b46-BETA-forge" = _zw03YxWB;
        "pkg-5.3.10+1.18.2b46-BETA-fabric" = _li04OkSF;
        "pkg-5.3.10+1.18.2b46-BETA-forge" = _8qSaeXPS;
        "pkg-5.3.10+1.19.2b46-BETA-fabric" = _IzKUG64c;
        "pkg-5.3.10+1.19.2b46-BETA-forge" = _8143nK1O;
        "pkg-5.3.10+1.20.1b46-BETA-fabric" = _gHyFVUVN;
        "pkg-5.3.10+1.20.1b46-BETA-forge" = _b2eKrIl7;
        "pkg-5.3.10+1.20.2b46-BETA-fabric" = _N9m5meCq;
        "pkg-5.3.10+1.20.2b46-BETA-neoforge" = _umG20Pgw;
        "pkg-5.3.10+1.20.5b46-BETA-fabric" = _TplM0lfq;
        "pkg-5.3.10+1.20.5b46-BETA-neoforge" = _lwsZ45yw;
        "pkg-5.3.10+1.21b46-BETA-fabric" = _rK2g3tdA;
        "pkg-5.3.10+1.21b46-BETA-neoforge" = _Hea09LyB;
        "pkg-5.3.11+1.16.5b47-BETA-fabric" = _pTGflL7I;
        "pkg-5.3.11+1.16.5b47-BETA-forge" = _9FJy6IEI;
        "pkg-5.3.11+1.18.2b47-BETA-fabric" = _xCaHfCkd;
        "pkg-5.3.11+1.18.2b47-BETA-forge" = _kDdui9TB;
        "pkg-5.3.11+1.19.2b47-BETA-fabric" = _hsxCBFC8;
        "pkg-5.3.11+1.19.2b47-BETA-forge" = _ZZ64UEZ9;
        "pkg-5.3.11+1.20.1b47-BETA-fabric" = _sHFHrMtT;
        "pkg-5.3.11+1.20.1b47-BETA-forge" = _KkhXeg7O;
        "pkg-5.3.11+1.20.2b47-BETA-fabric" = _3CG5lelS;
        "pkg-5.3.11+1.20.2b47-BETA-neoforge" = _bNFC65s7;
        "pkg-5.3.11+1.20.6b47-BETA-fabric" = _lP8uTANd;
        "pkg-5.3.11+1.20.6b47-BETA-neoforge" = _iqVoALBd;
        "pkg-5.3.11+1.21.1b47-BETA-fabric" = _DC0sCS0D;
        "pkg-5.3.11+1.21.1b47-BETA-neoforge" = _C4DpAZTb;
        "pkg-5.3.11+1.21.3b47-BETA-fabric" = _xiC4poOy;
        "pkg-5.3.11+1.21.3b47-BETA-neoforge" = _4PSxr8cB;
        "pkg-5.3.12+1.16.5b48-BETA-fabric" = _CT3JEaVC;
        "pkg-5.3.12+1.16.5b48-BETA-forge" = _CDHufSYg;
        "pkg-5.3.12+1.18.2b48-BETA-fabric" = _qhcKCOvr;
        "pkg-5.3.12+1.18.2b48-BETA-forge" = _Eqakp1GC;
        "pkg-5.3.12+1.19.2b48-BETA-fabric" = _W6CVHXgH;
        "pkg-5.3.12+1.19.2b48-BETA-forge" = _Fsna0uDO;
        "pkg-5.3.12+1.20.1b48-BETA-fabric" = _UZGo3TGg;
        "pkg-5.3.12+1.20.1b48-BETA-forge" = _muoZfbCr;
        "pkg-5.3.12+1.20.2b48-BETA-fabric" = _GgncEaPk;
        "pkg-5.3.12+1.20.2b48-BETA-neoforge" = _IVkU4UXh;
        "pkg-5.3.12+1.20.4b48-BETA-neoforge" = _iQAIdawZ;
        "pkg-5.3.12+1.20.6b48-BETA-fabric" = _yBKtVwnG;
        "pkg-5.3.12+1.20.6b48-BETA-neoforge" = _idYC1OT6;
        "pkg-5.3.12+1.21.1b48-BETA-fabric" = _IfA1JIEc;
        "pkg-5.3.12+1.21.1b48-BETA-neoforge" = _QtK0Ln7c;
        "pkg-5.3.12+1.21.3b48-BETA-fabric" = _596ydDSn;
        "pkg-5.3.12+1.21.3b48-BETA-neoforge" = _seQErzeV;
        "pkg-5.3.13+1.16.5b49-BETA-fabric" = _Y8ZOt1IQ;
        "pkg-5.3.13+1.16.5b49-BETA-forge" = _MCHCyWLB;
        "pkg-5.3.13+1.18.2b49-BETA-fabric" = _LpMauaAV;
        "pkg-5.3.13+1.18.2b49-BETA-forge" = _fsTk3u9V;
        "pkg-5.3.13+1.19.2b49-BETA-fabric" = _O0seVUxa;
        "pkg-5.3.13+1.19.2b49-BETA-forge" = _gCZ5mTli;
        "pkg-5.3.13+1.19.4b49-BETA-fabric" = _tDRRDUNi;
        "pkg-5.3.13+1.19.4b49-BETA-forge" = _b6xtEJjD;
        "pkg-5.3.13+1.20.1b49-BETA-fabric" = _M8WhdOBz;
        "pkg-5.3.13+1.20.1b49-BETA-forge" = _yMbbM6pd;
        "pkg-5.3.13+1.20.2b49-BETA-fabric" = _X5eN4hVe;
        "pkg-5.3.13+1.20.2b49-BETA-neoforge" = _jDyzOoqd;
        "pkg-5.3.13+1.20.4b49-BETA-neoforge" = _MpEiB6IB;
        "pkg-5.3.13+1.20.6b49-BETA-fabric" = _ijWJrlsF;
        "pkg-5.3.13+1.20.6b49-BETA-neoforge" = _s7LK8Gs9;
        "pkg-5.3.13+1.21.1b49-BETA-fabric" = _EsyrucGb;
        "pkg-5.3.13+1.21.1b49-BETA-neoforge" = _aTRLj5Nx;
        "pkg-5.3.13+1.21.3b49-BETA-fabric" = _u1HVaDoW;
        "pkg-5.3.13+1.21.3b49-BETA-neoforge" = _wwzxEHBd;
        "pkg-5.3.14+1.16.5b50-BETA-fabric" = _NrDHIIG8;
        "pkg-5.3.14+1.16.5b50-BETA-forge" = _z2tRU0bV;
        "pkg-5.3.14+1.18.2b50-BETA-fabric" = _1n1szING;
        "pkg-5.3.14+1.18.2b50-BETA-forge" = _1BchPZtd;
        "pkg-5.3.14+1.19.2b50-BETA-fabric" = _6CpcDBei;
        "pkg-5.3.14+1.19.2b50-BETA-forge" = _mGUsSPj5;
        "pkg-5.3.14+1.19.4b50-BETA-fabric" = _AD2cQnnE;
        "pkg-5.3.14+1.19.4b50-BETA-forge" = _v9orS0cz;
        "pkg-5.3.14+1.20.1b50-BETA-fabric" = _uNluPF8w;
        "pkg-5.3.14+1.20.1b50-BETA-forge" = _72t2iRqA;
        "pkg-5.3.14+1.20.2b50-BETA-fabric" = _vGXA69XB;
        "pkg-5.3.14+1.20.2b50-BETA-neoforge" = _IEc0mes0;
        "pkg-5.3.14+1.20.4b50-BETA-neoforge" = _99WZ2266;
        "pkg-5.3.14+1.20.6b50-BETA-fabric" = _7w0QC3Re;
        "pkg-5.3.14+1.20.6b50-BETA-neoforge" = _Y8FjSCiM;
        "pkg-5.3.14+1.21.1b50-BETA-fabric" = _qRjOzpsr;
        "pkg-5.3.14+1.21.1b50-BETA-neoforge" = _kmR01PME;
        "pkg-5.3.14+1.21.3b50-BETA-fabric" = _Q3F1o9l1;
        "pkg-5.3.14+1.21.3b50-BETA-neoforge" = _N9dQDsSU;
        "pkg-5.3.15+1.16.5b51-BETA-fabric" = _cxXQ4UXC;
        "pkg-5.3.15+1.16.5b51-BETA-forge" = _UoxGEARM;
        "pkg-5.3.15+1.18.2b51-BETA-fabric" = _YAM0xb6U;
        "pkg-5.3.15+1.18.2b51-BETA-forge" = _itJQXAis;
        "pkg-5.3.15+1.19.2b51-BETA-fabric" = _8WtXubgh;
        "pkg-5.3.15+1.19.2b51-BETA-forge" = _lX0UAVNm;
        "pkg-5.3.15+1.19.4b51-BETA-fabric" = _9QKgSvEB;
        "pkg-5.3.15+1.19.4b51-BETA-forge" = _uBtovtuA;
        "pkg-5.3.15+1.20.1b51-BETA-fabric" = _k4HXDL2G;
        "pkg-5.3.15+1.20.1b51-BETA-forge" = _qP0eKl4w;
        "pkg-5.3.15+1.20.2b51-BETA-fabric" = _sf8jyhjg;
        "pkg-5.3.15+1.20.2b51-BETA-neoforge" = _pBwXKgJ9;
        "pkg-5.3.15+1.20.4b51-BETA-neoforge" = _9OwJiqq7;
        "pkg-5.3.15+1.20.6b51-BETA-fabric" = _yZASFzZl;
        "pkg-5.3.15+1.20.6b51-BETA-neoforge" = _f3LiLF34;
        "pkg-5.3.15+1.21.1b51-BETA-fabric" = _zRjCFBnG;
        "pkg-5.3.15+1.21.1b51-BETA-neoforge" = _qoIG6nq9;
        "pkg-5.3.15+1.21.3b51-BETA-fabric" = _dTiOnSe3;
        "pkg-5.3.15+1.21.3b51-BETA-neoforge" = _zUtTZkHV;
        "pkg-5.3.16+1.16.5b53-BETA-fabric" = _g9dsxksh;
        "pkg-5.3.16+1.16.5b53-BETA-forge" = _22ZeT8a6;
        "pkg-5.3.16+1.18.2b53-BETA-fabric" = _cBtyCBtX;
        "pkg-5.3.16+1.18.2b53-BETA-forge" = _qTVIjAMk;
        "pkg-5.3.16+1.19.2b53-BETA-fabric" = _xexswyTB;
        "pkg-5.3.16+1.19.2b53-BETA-forge" = _aiyA8En3;
        "pkg-5.3.16+1.19.4b53-BETA-fabric" = _wKMDDf1g;
        "pkg-5.3.16+1.19.4b53-BETA-forge" = _RDIMnI3G;
        "pkg-5.3.16+1.20.1b53-BETA-fabric" = _FNMRMIoq;
        "pkg-5.3.16+1.20.1b53-BETA-forge" = _vdHK9IPo;
        "pkg-5.3.16+1.20.2b53-BETA-fabric" = _LNY17YlV;
        "pkg-5.3.16+1.20.2b53-BETA-neoforge" = _OmGlacoH;
        "pkg-5.3.16+1.20.4b53-BETA-neoforge" = _tkp5Ru42;
        "pkg-5.3.16+1.20.6b53-BETA-fabric" = _Z3YiWkxd;
        "pkg-5.3.16+1.20.6b53-BETA-neoforge" = _CyEQBbw7;
        "pkg-5.3.16+1.21.1b53-BETA-fabric" = _W4cVnyIC;
        "pkg-5.3.16+1.21.1b53-BETA-neoforge" = _Vo5xCG5Z;
        "pkg-5.3.16+1.21.3b53-BETA-fabric" = _cXWOUxvb;
        "pkg-5.3.16+1.21.3b53-BETA-neoforge" = _W33ce32r;
        "pkg-5.4.0+1.16.5b1140-BETA-fabric" = _70w823Tc;
        "pkg-5.4.0+1.16.5b1140-BETA-forge" = _YR2XcIcs;
        "pkg-5.4.0+1.20.6b1140-BETA-fabric" = _bsZ8B8QN;
        "pkg-5.4.0+1.21.5b1140-BETA-fabric" = _yOtz8oW4;
        "pkg-5.4.0+1.20.1b1140-BETA-fabric" = _6bKhmzLP;
        "pkg-5.4.0+1.20.6b1140-BETA-neoforge" = _andO35zt;
        "pkg-5.4.0+1.21.1b1140-BETA-neoforge" = _7hx8iSk7;
        "pkg-5.4.0+1.19.4b1140-BETA-fabric" = _SDcNduWR;
        "pkg-5.4.0+1.20.4b1140-BETA-neoforge" = _FokIObbe;
        "pkg-5.4.0+1.19.2b1140-BETA-forge" = _X2CGYc63;
        "pkg-5.4.0+1.21.3b1140-BETA-fabric" = _BnrnDJjE;
        "pkg-5.4.0+1.19.4b1140-BETA-forge" = _9Rdn07uu;
        "pkg-5.4.0+1.18.2b1140-BETA-fabric" = _c51tsDFB;
        "pkg-5.4.0+1.21.5b1140-BETA-neoforge" = _ppzjgnTt;
        "pkg-5.4.0+1.20.2b1140-BETA-fabric" = _uAOfqvL2;
        "pkg-5.4.0+1.21.3b1140-BETA-neoforge" = _EJYan9Si;
        "pkg-5.4.0+1.21.1b1140-BETA-fabric" = _vMtMjLpy;
        "pkg-5.4.0+1.20.1b1140-BETA-forge" = _HwjoyJwg;
        "pkg-5.4.0+1.18.2b1140-BETA-forge" = _cTZCSCFk;
        "pkg-5.4.0+1.19.2b1140-BETA-fabric" = _8q6s0gJZ;
        "pkg-5.4.0+1.20.2b1140-BETA-neoforge" = _wlLCyN1r;
        "pkg-5.4.1+1.16.5b1167-BETA-fabric" = _8JvsONui;
        "pkg-5.4.1+1.16.5b1167-BETA-forge" = _dKya6ntB;
        "pkg-5.4.1+1.20.2b1167-BETA-fabric" = _1YL2e6Ii;
        "pkg-5.4.1+1.20.6b1167-BETA-fabric" = _fm9g1cIu;
        "pkg-5.4.1+1.20.4b1167-BETA-neoforge" = _8H04GZtK;
        "pkg-5.4.1+1.21.5b1167-BETA-fabric" = _NothPpsk;
        "pkg-5.4.1+1.21.5b1167-BETA-neoforge" = _AHeIHwqw;
        "pkg-5.4.1+1.19.2b1167-BETA-forge" = _ZkdwPx6n;
        "pkg-5.4.1+1.21.1b1167-BETA-neoforge" = _aQLSYRhH;
        "pkg-5.4.1+1.21.3b1167-BETA-neoforge" = _re8sGjlz;
        "pkg-5.4.1+1.19.2b1167-BETA-fabric" = _3kurABYC;
        "pkg-5.4.1+1.19.4b1167-BETA-fabric" = _SLxKZtzP;
        "pkg-5.4.1+1.21.1b1167-BETA-fabric" = _wZhpXhMN;
        "pkg-5.4.1+1.18.2b1167-BETA-forge" = _5RHomRdr;
        "pkg-5.4.1+1.20.1b1167-BETA-forge" = _we2egPVF;
        "pkg-5.4.1+1.20.6b1167-BETA-neoforge" = _bwb2Wq79;
        "pkg-5.4.1+1.19.4b1167-BETA-forge" = _KFzc4Yuh;
        "pkg-5.4.1+1.21.3b1167-BETA-fabric" = _PGFPouEP;
        "pkg-5.4.1+1.20.2b1167-BETA-neoforge" = _qs4Za1rF;
        "pkg-5.4.1+1.20.1b1167-BETA-fabric" = _Mq9Vf9PN;
        "pkg-5.4.1+1.18.2b1167-BETA-fabric" = _xuS8vmUV;
        "pkg-5.4.2+1.16.5b1175-BETA-fabric" = _L7LGYoym;
        "pkg-5.4.2+1.16.5b1175-BETA-forge" = _7HuZRAd8;
        "pkg-5.4.2+1.21.1b1175-BETA-neoforge" = _7oAbNBGf;
        "pkg-5.4.2+1.20.6b1175-BETA-neoforge" = _dOC8EbBZ;
        "pkg-5.4.2+1.20.4b1175-BETA-neoforge" = _t7Fk0Iw1;
        "pkg-5.4.2+1.21.5b1175-BETA-neoforge" = _5J7pdYcj;
        "pkg-5.4.2+1.20.2b1175-BETA-neoforge" = _ddBJ6k8n;
        "pkg-5.4.2+1.19.4b1175-BETA-fabric" = _qs0qIl3o;
        "pkg-5.4.2+1.21.1b1175-BETA-fabric" = _LH1y04TS;
        "pkg-5.4.2+1.21.3b1175-BETA-fabric" = _301eFbQM;
        "pkg-5.4.2+1.20.2b1175-BETA-fabric" = _6aoDCOy8;
        "pkg-5.4.2+1.21.3b1175-BETA-neoforge" = _RAQFhOzZ;
        "pkg-5.4.2+1.18.2b1175-BETA-fabric" = _rj7M4oYl;
        "pkg-5.4.2+1.20.6b1175-BETA-fabric" = _4QAsPLVf;
        "pkg-5.4.2+1.20.1b1175-BETA-fabric" = _V9URgvpV;
        "pkg-5.4.2+1.18.2b1175-BETA-forge" = _p7BivvXp;
        "pkg-5.4.2+1.19.2b1175-BETA-fabric" = _C3wHafwh;
        "pkg-5.4.2+1.19.4b1175-BETA-forge" = _b7RbVZy1;
        "pkg-5.4.2+1.19.2b1175-BETA-forge" = _FBacTzkU;
        "pkg-5.4.2+1.20.1b1175-BETA-forge" = _dFt0NDQ9;
        "pkg-5.4.2+1.21.5b1175-BETA-fabric" = _cNLvHv94;
        "pkg-5.4.3+1.16.5b1182-BETA-fabric" = _9UBqy81a;
        "pkg-5.4.3+1.16.5b1182-BETA-forge" = _sWeStNJe;
        "pkg-5.4.3+1.20.2b1182-BETA-fabric" = _DxgtzJ3e;
        "pkg-5.4.3+1.20.6b1182-BETA-neoforge" = _HL7uLNKI;
        "pkg-5.4.3+1.21.1b1182-BETA-neoforge" = _Le5PJvRg;
        "pkg-5.4.3+1.18.2b1182-BETA-fabric" = _D1fsXloN;
        "pkg-5.4.3+1.20.4b1182-BETA-neoforge" = _FgAyfeAw;
        "pkg-5.4.3+1.19.2b1182-BETA-fabric" = _gee0hs3P;
        "pkg-5.4.3+1.20.1b1182-BETA-forge" = _VIpz7aN9;
        "pkg-5.4.3+1.19.4b1182-BETA-fabric" = _5YcuOK7D;
        "pkg-5.4.3+1.21.1b1182-BETA-fabric" = _K8ANyT8S;
        "pkg-5.4.3+1.20.1b1182-BETA-fabric" = _4tJQQzEN;
        "pkg-5.4.3+1.21.5b1182-BETA-neoforge" = _RGy30yEW;
        "pkg-5.4.3+1.21.3b1182-BETA-neoforge" = _hjf2FNhe;
        "pkg-5.4.3+1.18.2b1182-BETA-forge" = _kUhBM6fR;
        "pkg-5.4.3+1.19.4b1182-BETA-forge" = _6flfl23r;
        "pkg-5.4.3+1.19.2b1182-BETA-forge" = _3HJHmwqg;
        "pkg-5.4.3+1.20.6b1182-BETA-fabric" = _NJR8hRQV;
        "pkg-5.4.3+1.21.5b1182-BETA-fabric" = _FKmH37XO;
        "pkg-5.4.3+1.21.3b1182-BETA-fabric" = _iZoImFZu;
        "pkg-5.4.3+1.20.2b1182-BETA-neoforge" = _oZPTwV4u;
        "pkg-5.4.4+1.16.5b1199-BETA-fabric" = _7C7ecpDZ;
        "pkg-5.4.4+1.21.5b1199-BETA-fabric" = _A4cs7Vrd;
        "pkg-5.4.4+1.20.1b1199-BETA-fabric" = _zWMSx8YV;
        "pkg-5.4.4+1.18.2b1199-BETA-fabric" = _vaLSjNJG;
        "pkg-5.4.4+1.16.5b1199-BETA-forge" = _2voQpami;
        "pkg-5.4.4+1.19.4b1199-BETA-fabric" = _e9lfkhAF;
        "pkg-5.4.4+1.20.2b1199-BETA-fabric" = _Dh3rQQ27;
        "pkg-5.4.4+1.19.2b1199-BETA-fabric" = _JSxanQ8S;
        "pkg-5.4.4+1.20.6b1199-BETA-fabric" = _4LuL7zY5;
        "pkg-5.4.4+1.20.6b1199-BETA-neoforge" = _6ZGE2kck;
        "pkg-5.4.4+1.21.5b1199-BETA-neoforge" = _lC4wyC4a;
        "pkg-5.4.4+1.20.1b1199-BETA-forge" = _NNeZnefi;
        "pkg-5.4.4+1.18.2b1199-BETA-forge" = _ZBU5EkN2;
        "pkg-5.4.4+1.20.4b1199-BETA-neoforge" = _a2e4fqqp;
        "pkg-5.4.4+1.21.1b1199-BETA-fabric" = _Zhl7ZujV;
        "pkg-5.4.4+1.21.3b1199-BETA-fabric" = _2U12ZSFK;
        "pkg-5.4.4+1.21.3b1199-BETA-neoforge" = _II7GUDcD;
        "pkg-5.4.4+1.20.2b1199-BETA-neoforge" = _FnLyGZ6a;
        "pkg-5.4.4+1.19.4b1199-BETA-forge" = _bfIkBj4R;
        "pkg-5.4.4+1.21.1b1199-BETA-neoforge" = _l7Pem3uA;
        "pkg-5.4.4+1.19.2b1199-BETA-forge" = _xZm95kxm;
        "pkg-5.4.5+1.16.5b1206-BETA-fabric" = _pZqn33nB;
        "pkg-5.4.5+1.16.5b1206-BETA-forge" = _D20WDAuJ;
        "pkg-5.4.5+1.20.1b1206-BETA-fabric" = _2UqxQn3t;
        "pkg-5.4.5+1.21.5b1206-BETA-fabric" = _A8OPq4Ym;
        "pkg-5.4.5+1.18.2b1206-BETA-fabric" = _YUSO8Gbs;
        "pkg-5.4.5+1.20.2b1206-BETA-fabric" = _l5aKEMCQ;
        "pkg-5.4.5+1.19.4b1206-BETA-fabric" = _phqTLguY;
        "pkg-5.4.5+1.19.2b1206-BETA-fabric" = _6IT29X9b;
        "pkg-5.4.5+1.20.6b1206-BETA-fabric" = _HxIM2h8b;
        "pkg-5.4.5+1.20.6b1206-BETA-neoforge" = _eEVNwcW0;
        "pkg-5.4.5+1.20.4b1206-BETA-neoforge" = _s7Jyqkig;
        "pkg-5.4.5+1.18.2b1206-BETA-forge" = _9gdwnFkR;
        "pkg-5.4.5+1.20.1b1206-BETA-forge" = _VojzF6ZJ;
        "pkg-5.4.5+1.21.5b1206-BETA-neoforge" = _Rnn9POl0;
        "pkg-5.4.5+1.21.1b1206-BETA-neoforge" = _9mKbGCfm;
        "pkg-5.4.5+1.21.3b1206-BETA-fabric" = _mev9S60T;
        "pkg-5.4.5+1.21.3b1206-BETA-neoforge" = _ZrlbB6ps;
        "pkg-5.4.5+1.21.1b1206-BETA-fabric" = _IB0XdPg3;
        "pkg-5.4.5+1.20.2b1206-BETA-neoforge" = _jCkmTMUj;
        "pkg-5.4.5+1.19.4b1206-BETA-forge" = _FB1OVTPg;
        "pkg-5.4.5+1.19.2b1206-BETA-forge" = _2DGJNSG4;
        "pkg-5.4.6+1.21.5b1222-BETA-fabric" = _q9ZnbMef;
        "pkg-5.4.6+1.16.5b1222-BETA-fabric" = _43e8VGhB;
        "pkg-5.4.6+1.19.4b1222-BETA-fabric" = _SizVSc2H;
        "pkg-5.4.6+1.19.2b1222-BETA-fabric" = _IJzElqbD;
        "pkg-5.4.6+1.20.6b1222-BETA-neoforge" = _xS4wfWGg;
        "pkg-5.4.6+1.21.1b1222-BETA-fabric" = _2nnjjKFg;
        "pkg-5.4.6+1.21.5b1222-BETA-neoforge" = _wB9qKMDe;
        "pkg-5.4.6+1.20.2b1222-BETA-neoforge" = _gFaKOY2s;
        "pkg-5.4.6+1.20.4b1222-BETA-neoforge" = _c7fweQZq;
        "pkg-5.4.6+1.21.3b1222-BETA-fabric" = _RfktbeLl;
        "pkg-5.4.6+1.20.1b1222-BETA-forge" = _McnoszgV;
        "pkg-5.4.6+1.18.2b1222-BETA-fabric" = _KuknrajW;
        "pkg-5.4.6+1.20.2b1222-BETA-fabric" = _svzrXGJk;
        "pkg-5.4.6+1.21.1b1222-BETA-neoforge" = _FB4QjG7i;
        "pkg-5.4.6+1.20.1b1222-BETA-fabric" = _9uLz658I;
        "pkg-5.4.6+1.21.3b1222-BETA-neoforge" = _D7yAmGqJ;
        "pkg-5.4.6+1.19.4b1222-BETA-forge" = _A4FClL1Q;
        "pkg-5.4.6+1.16.5b1222-BETA-forge" = _AzXwGvBD;
        "pkg-5.4.6+1.19.2b1222-BETA-forge" = _ytEoVdxG;
        "pkg-5.4.6+1.18.2b1222-BETA-forge" = _iNQtwk10;
        "pkg-5.4.6+1.20.6b1222-BETA-fabric" = _fCMhDOW8;
        "pkg-5.4.7+1.16.5b1295-BETA-fabric" = _pk0Eel4u;
        "pkg-5.4.7+1.16.5b1295-BETA-forge" = _IQG4vGcl;
        "pkg-5.4.7+1.19.4b1295-BETA-fabric" = _kjhU79qu;
        "pkg-5.4.7+1.20.2b1295-BETA-fabric" = _YUMgujGS;
        "pkg-5.4.7+1.18.2b1295-BETA-fabric" = _iUrQfmtA;
        "pkg-5.4.7+1.20.1b1295-BETA-fabric" = _c9kAXkKu;
        "pkg-5.4.7+1.19.2b1295-BETA-fabric" = _LDHbjYEG;
        "pkg-5.4.7+1.21.5b1295-BETA-fabric" = _nMYV0OgS;
        "pkg-5.4.7+1.20.6b1295-BETA-fabric" = _DWbQoKR8;
        "pkg-5.4.7+1.21.11b1295-BETA-neoforge" = _hTHNsrpa;
        "pkg-5.4.7+1.20.4b1295-BETA-neoforge" = _p3BfHlRW;
        "pkg-5.4.7+1.18.2b1295-BETA-forge" = _LqiQHJuL;
        "pkg-5.4.7+1.21.11b1295-BETA-fabric" = _SeZvzc90;
        "pkg-5.4.7+1.20.1b1295-BETA-forge" = _oIODeUZz;
        "pkg-5.4.7+1.20.6b1295-BETA-neoforge" = _neWfZx0P;
        "pkg-5.4.7+1.21.3b1295-BETA-neoforge" = _X2lfRGWo;
        "pkg-5.4.7+1.21.1b1295-BETA-neoforge" = _IjmJBHn4;
        "pkg-5.4.7+1.21.1b1295-BETA-fabric" = _KspPPQeW;
        "pkg-5.4.7+1.21.3b1295-BETA-fabric" = _xJN4KoEz;
        "pkg-5.4.7+1.20.2b1295-BETA-neoforge" = _o9seNdAu;
        "pkg-5.4.7+1.19.4b1295-BETA-forge" = _WgCyqdka;
        "pkg-5.4.7+1.19.2b1295-BETA-forge" = _uoI8UUp2;
        "pkg-5.4.7+1.21.5b1295-BETA-neoforge" = _GsArqven;
        "pkg-5.4.8+1.18.2b1383-BETA-fabric" = _Um71E13j;
        "pkg-5.4.8+1.20.4b1383-BETA-neoforge" = _AwbcYsws;
        "pkg-5.4.8+1.19.4b1383-BETA-forge" = _lhDB1vgB;
        "pkg-5.4.8+1.21.5b1383-BETA-fabric" = _DY2Xl3OX;
        "pkg-5.4.8+1.20.6b1383-BETA-fabric" = _C6TUvcOE;
        "pkg-5.4.8+1.20.6b1383-BETA-neoforge" = _BqkotUJO;
        "pkg-5.4.8+1.20.1b1383-BETA-fabric" = _cz6FIr9E;
        "pkg-5.4.8+1.16.5b1383-BETA-fabric" = _ei5G0KTZ;
        "pkg-5.4.8+1.20.2b1383-BETA-neoforge" = _O983MBgv;
        "pkg-5.4.8+1.21.1b1383-BETA-neoforge" = _pxQoqEwj;
        "pkg-5.4.8+1.16.5b1383-BETA-forge" = _HStdkeEn;
        "pkg-5.4.8+1.21.1b1383-BETA-fabric" = _CSiEWRfC;
        "pkg-5.4.8+1.21.11b1383-BETA-neoforge" = _5yPm6oeE;
        "pkg-5.4.8+1.20.2b1383-BETA-fabric" = _5UB4YV1X;
        "pkg-5.4.8+1.19.2b1383-BETA-fabric" = _hRlMBXWN;
        "pkg-5.4.8+1.21.3b1383-BETA-fabric" = _izo8eBRX;
        "pkg-5.4.8+1.21.5b1383-BETA-neoforge" = _Qf4YYJvW;
        "pkg-5.4.8+1.21.11b1383-BETA-fabric" = _IjE7q3hp;
        "pkg-5.4.8+1.20.1b1383-BETA-forge" = _6ywA5VqS;
        "pkg-5.4.8+1.21.3b1383-BETA-neoforge" = _7YXP6WFs;
        "pkg-5.4.8+1.18.2b1383-BETA-forge" = _4dx0C70Y;
        "pkg-5.4.8+1.19.2b1383-BETA-forge" = _70PyhqSu;
        "pkg-5.4.8+1.19.4b1383-BETA-fabric" = _hvSjYDN2;
        "pkg-5.4.9+26.1b1463-BETA-fabric" = _LxTt82ek;
        "pkg-5.4.9+1.16.5b1463-BETA-fabric" = _yUQHzAvB;
        "pkg-5.4.9+1.19.2b1463-BETA-fabric" = _oLhEXY8o;
        "pkg-5.4.9+1.20.2b1463-BETA-fabric" = _3FDSivPE;
        "pkg-5.4.9+1.18.2b1463-BETA-fabric" = _b9siTNEd;
        "pkg-5.4.9+26.1b1463-BETA-neoforge" = _wUM3dCKR;
        "pkg-5.4.9+1.19.4b1463-BETA-fabric" = _sq4xI8Dn;
        "pkg-5.4.9+1.20.1b1463-BETA-fabric" = _gA7hj0Cw;
        "pkg-5.4.9+1.21.5b1463-BETA-fabric" = _EYl3a1P5;
        "pkg-5.4.9+1.21.1b1463-BETA-fabric" = _XswvAG6N;
        "pkg-5.4.9+1.20.2b1463-BETA-neoforge" = _F5b9FwWh;
        "pkg-5.4.9+1.20.6b1463-BETA-fabric" = _hhveCHVa;
        "pkg-5.4.9+1.21.3b1463-BETA-fabric" = _rW2hB82Z;
        "pkg-5.4.9+1.21.11b1463-BETA-neoforge" = _7zj74mNo;
        "pkg-5.4.9+1.19.4b1463-BETA-forge" = _3rZNNDP7;
        "pkg-5.4.9+1.16.5b1463-BETA-forge" = _kijtvKx0;
        "pkg-5.4.9+1.21.1b1463-BETA-neoforge" = _M21R7beB;
        "pkg-5.4.9+1.19.2b1463-BETA-forge" = _Zog3iTWw;
        "pkg-5.4.9+1.21.3b1463-BETA-neoforge" = _6zvBWH30;
        "pkg-5.4.9+1.21.5b1463-BETA-neoforge" = _L8nlmK4a;
        "pkg-5.4.9+1.21.11b1463-BETA-fabric" = _FrDN6SIV;
        "pkg-5.4.9+1.20.1b1463-BETA-forge" = _7Mkm7Xo3;
        "pkg-5.4.9+1.20.6b1463-BETA-neoforge" = _ELcMYsNi;
        "pkg-5.4.9+1.20.4b1463-BETA-neoforge" = _EJLirDbA;
        "pkg-5.4.9+1.18.2b1463-BETA-forge" = _xC2EvSpa;
        "pkg-5.4.10+1.19.2b1471-BETA-fabric" = _3kbewmGb;
        "pkg-5.4.10+26.1b1471-BETA-fabric" = _ioRliWZO;
        "pkg-5.4.10+1.16.5b1471-BETA-fabric" = _tpJc7k6V;
        "pkg-5.4.10+1.20.1b1471-BETA-fabric" = _XApUgU46;
        "pkg-5.4.10+1.20.6b1471-BETA-neoforge" = _sCA828JH;
        "pkg-5.4.10+1.19.4b1471-BETA-fabric" = _RkN2XsWg;
        "pkg-5.4.10+1.18.2b1471-BETA-fabric" = _qhtZg9Oc;
        "pkg-5.4.10+1.18.2b1471-BETA-forge" = _rCv7G4uA;
        "pkg-5.4.10+1.20.6b1471-BETA-fabric" = _SCaH8LYy;
        "pkg-5.4.10+1.20.1b1471-BETA-forge" = _fEdf6mJ2;
        "pkg-5.4.10+1.16.5b1471-BETA-forge" = _cpOh3YWc;
        "pkg-5.4.10+1.21.11b1471-BETA-fabric" = _K6iYVfIU;
        "pkg-5.4.10+1.21.1b1471-BETA-fabric" = _MSWJsjTH;
        "pkg-5.4.10+26.1b1471-BETA-neoforge" = _ToC8s6t0;
        "pkg-5.4.10+1.21.3b1471-BETA-neoforge" = _35Siwv93;
        "pkg-5.4.10+1.19.2b1471-BETA-forge" = _A1IqNHtM;
        "pkg-5.4.10+1.21.5b1471-BETA-neoforge" = _7x2FiyvB;
        "pkg-5.4.10+1.20.2b1471-BETA-neoforge" = _pj5i0vNd;
        "pkg-5.4.10+1.20.2b1471-BETA-fabric" = _JQSH2DXB;
        "pkg-5.4.10+1.21.5b1471-BETA-fabric" = _Yj0SEKkk;
        "pkg-5.4.10+1.21.3b1471-BETA-fabric" = _1zTNL7Uh;
        "pkg-5.4.10+1.21.1b1471-BETA-neoforge" = _UFIerucl;
        "pkg-5.4.10+1.20.4b1471-BETA-neoforge" = _IW9jRin1;
        "pkg-5.4.10+1.19.4b1471-BETA-forge" = _OchERmKN;
        "pkg-5.4.11+1.20.2b5C1XBL" = _ao6WAgdz;
        "pkg-5.4.11+1.21.1b5C1XBL" = _RXS2Uup5;
        "pkg-5.4.11+1.16.5b5C1XBL" = _k5UEdbmT;
        "pkg-5.4.11+1.21.3b5C1XBL" = _toC0f0Ry;
        "pkg-5.4.11+26.1b5C1XBN" = _7xy0e0zY;
        "pkg-5.4.11+1.19.4b5C1XBL" = _qPcspB3t;
        "pkg-5.4.11+1.21.11b5C1XBL" = _KJpKZMHe;
        "pkg-5.4.11+1.18.2b5C1XBL" = _CNTcXTtA;
        "pkg-5.4.11+1.20.6b5C1XBL" = _qDrraHze;
        "pkg-5.4.11+1.21.3b5C1XBN" = _SNhcrKnh;
        "pkg-5.4.11+1.18.2b5C1XBF" = _ThRSNBGh;
        "pkg-5.4.11+1.20.1b5C1XBF" = _INpmv1TC;
        "pkg-5.4.11+1.20.6b5C1XBN" = _43ewAqfW;
        "pkg-5.4.11+1.20.2b5C1XBN" = _OUezs7C3;
        "pkg-5.4.11+1.21.11b5C1XBN" = _hZaEwXtf;
        "pkg-5.4.11+1.19.2b5C1XBL" = _CunWLvJe;
        "pkg-5.4.11+1.21.1b5C1XBN" = _K4IinUMI;
        "pkg-5.4.11+1.21.5b5C1XBN" = _rszaNiu4;
        "pkg-5.4.11+1.19.2b5C1XBF" = _5i7873rN;
        "pkg-5.4.11+1.20.1b5C1XBL" = _t652levU;
        "pkg-5.4.11+26.1b5C1XBL" = _iCi7lODY;
        "pkg-5.4.11+1.21.5b5C1XBL" = _hwzrTNuj;
        "pkg-5.4.11+1.19.4b5C1XBF" = _CRB9M46S;
        "pkg-5.4.11+1.16.5b5C1XBF" = _23JMMLNN;
        "pkg-5.4.11+1.20.4b5C1XBN" = _qYGe23lx;
        "default" = _qYGe23lx;
    });
