...
let
    versions = (let
        ...
        _HcuNIlDv = {
            "id" = "HcuNIlDv";
            "file" = "NoRender-1.0.6,26.2.jar";
            "hash" = "sha512-4CpKaneqSbqPXm5MrlMkaD+Ji8wa2IJL646b+qlYjQFWjBeMUQJ5ut1afn96TgQPUMU/AHNFY+N2rMSIh1lThQ==";
        };
    in {
        "Pb4ga9eQ" = _Pb4ga9eQ;
        "LYrIvpVN" = _LYrIvpVN;
        ...
        "pkg-1.0.3,26.1-26.1.2" = _hA4yYiHE;
        "pkg-1.0.4,26.1-26.1.2" = _g2BvlO1B;
