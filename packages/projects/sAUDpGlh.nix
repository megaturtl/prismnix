...
let
    ...
    in {
        ...
        "pkg-0.9" = _ZjHiFUEW;
        "pkg-0.10" = _OOO9kFUx;
        "pkg-0.10.1" = _VCpjNVco;
        "pkg-0.11" = _KMAgAwkx;
        "pkg-0.11.1" = _X84gzlhp;
        "pkg-0.12" = _BohrS1p5;
        "pkg-0.12.1" = _VOo7DQPq;
        "pkg-0.13" = _CeB2EiUZ;
        "pkg-0.13.1" = _jA73tj6S;
        "pkg-0.13.2" = _5S2AcMzB;
        "pkg-0.13.3" = _xHALZfo2;
        "pkg-0.13.4" = _hujLZrr8;
        "pkg-0.13.5" = _fY1piCQe;
