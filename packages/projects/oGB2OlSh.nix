...
let
    ...
    in {
        ...
        "pkg-1.20" = _dTCixuH3;
        "pkg-1.21" = _Rp0RyqZr;
        "pkg-26.1-BETA" = _l69lSD0p;
        "pkg-26.1" = _PWTjjfgH;
        "pkg-26.1.1" = _YmKcAYKP;
        "pkg-26.1.2" = _O8ViVQLk;
        "pkg-26.2-BETA" = _JLFyteng;
        "pkg-26.1.3" = _vBBZltSD;
        "pkg-26.1.4" = _XII4iuKu;
        "pkg-26.1.5" = _HeCn7ZRu;
        "pkg-26.2-BETA-2" = _67Q6Rr7P;
        "pkg-26.1.6" = _TBTbVris;
        "pkg-26.1.7" = _W2phEoV3;
        "pkg-26.1.8" = _QvFcUyJk;
        "pkg-26.1.9" = _plLaG25Y;
        "pkg-26.2-BETA-3" = _RH425FHq;
        "pkg-26.2-BETA-4" = _v5FrYjAf;
        "pkg-26.1.10" = _FbmNQs5p;
        "pkg-26.1.11" = _hFpwwjYG;
        "pkg-26.1.12" = _EfcHPoWq;
        "pkg-26.1.13" = _guPACPdM;
        "pkg-26.1.14" = _Rd3pgy1M;
        "pkg-26.2" = _J6BeYuBQ;
        "pkg-26.2.1" = _VMJIpkK4;
        "pkg-26.3-BETA" = _MA54xK9I;
