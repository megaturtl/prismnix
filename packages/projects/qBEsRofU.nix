...
let
    ...
    in {
        ...
        "pkg-1.1" = _CcEtkcDk;
        "pkg-1.1.1" = _ZTfzFcQG;
        "pkg-1.1.1+mod" = _wbDk2Tkn;
        "pkg-v1.2" = _elzFNxID;
        "pkg-v1.1-final" = _D9rye3nk;
        "pkg-v1.0-final" = _ub58nCSs;
        "pkg-v1.0-final+mod" = _QS77OA9x;
        "pkg-v1.1-final+mod" = _UsHJBBY6;
        "pkg-v1.2+mod" = _7CLMSr9k;
        "pkg-v1.1-final-MC1.21.1" = _T7Wz4wOU;
        "pkg-v1.1-final-min" = _5dnaFReu;
        "pkg-v1.1-final-min+mod" = _YQswfRWg;
        "pkg-v1.1-final-MC1.21.1+mod" = _vNMeveUx;
        "pkg-1.3" = _JDluPV6K;
        "pkg-1.3+mod" = _7iOFmKJf;
        "pkg-1.3.1" = _WGLm5Gya;
        "pkg-1.3.1+mod" = _VnnHTi1W;
        "pkg-1.4" = _uZ9Wep46;
        "pkg-1.4+mod" = _Vk9iSuU7;
        "pkg-1.4.1" = _bNAAk57d;
        "pkg-1.4.1+mod" = _wEcREjGp;
        "pkg-1.4.2" = _FmsbGEUA;
        "pkg-1.4.2+mod" = _vDac9G2E;
        "pkg-1.4.3" = _qLhBGi0x;
        "pkg-1.4.3+mod" = _3MQTb5uQ;
        "pkg-1.4.3-MC1.21.9-1.21.10" = _oh38onms;
        "pkg-1.4.3-MC1.21.9-1.21.10+mod" = _X5W81lvR;
        "pkg-1.4.3-MC1.21-1.21.8" = _4xeipXxc;
