...
let
    ...
    in {
        ...
        "pkg-1.19-2" = _rQmWfO17;
        "pkg-1.19-3" = _OhFeQfyJ;
        "pkg-1.19-4" = _BAV7bViO;
        "pkg-1.20-1" = _OuD49djS;
        "pkg-1.20-2" = _8WwtQrS8;
        "pkg-1.20-3" = _Y46qeMbx;
        "pkg-1.20-4" = _3aII9MpT;
        "pkg-1.20.6-r1" = _7NHl2YIE;
        "pkg-1.21-r1" = _elYzduyw;
        "pkg-1.21.2-r1" = _7jyuAKiY;
        "pkg-1.21.4-r1" = _l7fQxW0Q;
        "pkg-1.21.4-r2" = _Px5SRRCH;
        "pkg-1.21.5-r1" = _abjGwrHj;
        "pkg-1.21.5-r2" = _dmh934TR;
        "pkg-1.21.6-r1" = _pmWBm7w1;
        "pkg-1.21.8-r1" = _PyW6y7wc;
        "pkg-1.21.8-r2" = _uI6T5Uic;
        "pkg-1.21.9-r1" = _3qAN5ZxU;
        "pkg-1.21.10-r1" = _BRHsWPWw;
        "pkg-1.21.11-r1" = _HD11oWyn;
        "pkg-1.21.11-r2" = _i34iUOGF;
        "pkg-26.1-r1" = _TR9mttZ8;
        "pkg-26.1-r2" = _9r0oRRh7;
        "pkg-26.1-r3" = _XyIZSNdc;
        "pkg-26.1-r4" = _Y8rGU07F;
        "pkg-26.1-r5" = _h8jLoFxh;
        "pkg-26.1-r6" = _WV3UYyGk;
