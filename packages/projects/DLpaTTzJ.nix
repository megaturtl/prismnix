...
let
    ...
    in {
        ...
        "pkg-1.10" = _xSibPdd5;
        "pkg-1.1104" = _RR2ArFeo;
        "pkg-1.1204" = _h8dxR8XT;
        "pkg-2.0006" = _yjVT8rLl;
        "pkg-2.0106" = _AQcWeO6d;
        "pkg-2.0207" = _CvJm5AcA;
        "pkg-2.0308" = _qaR5h8Ro;
        "pkg-2.0509" = _48F1dziT;
        "pkg-2.0610" = _7MEZObi6;
        "pkg-2.0710" = _MIfbC2v2;
        "pkg-2.0810" = _nl9yMU64;
        "pkg-2.0010beta" = _xHuMrtg0;
        "pkg-2.0110beta" = _bIBZdMkI;
        "pkg-2.0910" = _UIgwpiv7;
        "pkg-2.0311-beta" = _i6ripYZ8;
        "pkg-2.0411-beta" = _jEdGkeSo;
        "pkg-2.0511-beta" = _ej5je4cS;
        "pkg-2.1212" = _fKdEsS5B;
        "pkg-3.0601-forge-1.20.1" = _FCOiudAS;
        "pkg-3.0701-forge-1.20.1" = _xOuZzEp7;
        "pkg-3.0701-neoforge-1.21.1" = _exMKwhAO;
        "pkg-3.0801-forge-1.20.1" = _cGVIRRPS;
        "pkg-3.0801-neoforge-1.21.1" = _uFrV1l1K;
        "pkg-3.0902-forge-1.20.1" = _HJTQAeU5;
        "pkg-3.0902-neoforge-1.21.1" = _jsSlkRjl;
        "pkg-3.0902-forge-1.21.1" = _pXw5R5ls;
        "pkg-3.1002-forge-1.20.1" = _j5t3iNhV;
        "pkg-3.1002-neoforge-1.21.1" = _VkXyC7eC;
        "pkg-3.1102-forge-1.20.1" = _gcVTIbtc;
        "pkg-3.1102-neoforge-1.21.1" = _AeMPoVWU;
        "pkg-3.1202-forge-1.20.1" = _tWdPtul5;
        "pkg-3.1202-neoforge-1.21.1" = _LcQhRsEA;
        "pkg-3.1302-forge-1.20.1" = _rRBFs2q7;
        "pkg-3.1302-neoforge-1.21.1" = _TDiQmQl8;
        "pkg-3.1403-forge-1.20.1" = _sDjm9vD8;
        "pkg-3.1403-neoforge-1.21.1" = _Q8LMBx50;
        "pkg-3.1503-forge-1.20.1" = _HWZT2YQI;
        "pkg-3.1503-neoforge-1.21.1" = _26aH9Dpm;
        "pkg-3.1603-forge-1.20.1" = _MEGkyTvT;
        "pkg-3.1603-neoforge-1.21.1" = _Ggby7ChS;
        "pkg-3.1703-forge-1.20.1" = _AtCCdgFp;
        "pkg-3.1703-neoforge-1.21.1" = _5YMsKVpI;
        "pkg-3.1803-forge-1.20.1" = _KVhloxhj;
        "pkg-3.1803-neoforge-1.21.1" = _SmobE3Hx;
        "pkg-3.1904-forge-1.20.1" = _r3mAbOna;
        "pkg-3.1904-neoforge-1.21.1" = _JwgVJRm3;
        "pkg-3.2004-forge-1.20.1" = _IgV7JZW9;
        "pkg-3.2004-neoforge-1.21.1" = _PSnNJ1zx;
        "pkg-3.2104-forge-1.20.1" = _CWdtirSr;
        "pkg-3.2104-neoforge-1.21.1" = _PhzVPbVL;
        "pkg-3.2204-forge-1.20.1" = _CQGg7JKp;
        "pkg-3.2204-neoforge-1.21.1" = _8fCT0ZI6;
        "pkg-3.2305-forge-1.20.1" = _hBXZj50N;
        "pkg-3.2305-neoforge-1.21.1" = _6eYwMy2W;
        "pkg-3.2405-forge-1.20.1" = _Iwxh3gGp;
        "pkg-3.2405-neoforge-1.21.1" = _RrTMql5o;
        "pkg-3.2505-forge-1.20.1" = _p3HrcN3I;
        "pkg-3.2505-neoforge-1.21.1" = _5RU5oyrA;
        "pkg-3.2605-forge-1.20.1" = _9cN9CNzH;
        "pkg-3.2605-neoforge-1.21.1" = _Qm1tbZEO;
        "pkg-3.2705-forge-1.20.1" = _wrsmpcdw;
        "pkg-3.2705-neoforge-1.21.1" = _nRm9lP4W;
        "pkg-3.2805-fabric-1.20.1" = _Ljjj7f6U;
        "pkg-3.2805-forge-1.20.1" = _FUyQWAZI;
        "pkg-3.2805-neoforge-1.21.1" = _GwyjWFL0;
        "pkg-3.2906-fabric-1.20.1" = _6kWFDzYx;
        "pkg-3.2906-forge-1.20.1" = _E1omNeV6;
        "pkg-3.2906-neoforge-1.21.1" = _be61qSBd;
        "pkg-3.3006-forge-1.20.1" = _rV53Dxzq;
        "pkg-3.3006-neoforge-1.21.1" = _FtecUXWU;
        "pkg-3.3106-forge-1.20.1" = _FSscYxtU;
        "pkg-3.3106-neoforge-1.21.1" = _jVsOPUTP;
        "pkg-3.3206-forge-1.20.1" = _H1sLOopw;
        "pkg-3.3206-neoforge-1.21.1" = _PHgNKm5d;
        "pkg-3.3106-fabric-1.20.1" = _buj2WYUM;
        "pkg-3.3307-forge-1.20.1" = _gVXx7fYh;
        "pkg-3.3307-neoforge-1.21.1" = _pI6TDMY2;
        "pkg-3.3408-forge-1.20.1" = _wMtsPb5m;
        "pkg-3.3408-neoforge-1.21.1" = _tKyyHZUt;
        "pkg-3.3508-forge-1.20.1" = _NIK7tILE;
        "pkg-3.3508-neoforge-1.21.1" = _kZo4BZG7;
        "pkg-3.3608-forge-1.20.1" = _Nx9Y8Zgw;
        "pkg-3.3608-neoforge-1.21.1" = _kmc4xrtJ;
        "pkg-3.3709-forge-1.20.1" = _dQT9Men5;
        "pkg-3.3709-neoforge-1.21.1" = _KxK79nDq;
        "pkg-4.0001-forge-1.20.1" = _qojWrkTE;
        "pkg-4.0001-neoforge-1.21.1" = _VbAO48uF;
        "pkg-4.0202-forge-1.20.1" = _6MeKcKAU;
        "pkg-4.0202-neoforge-1.21.1" = _Gqh0AHwL;
        "pkg-4.0303-forge-1.20.1" = _6HjJpbPW;
        "pkg-4.0303-neoforge-1.21.1" = _H7baGuwk;
        "pkg-4.0405-forge-1.20.1" = _Ewk9ohwB;
        "pkg-4.0405-neoforge-1.21.1" = _AfhFEVlI;
        "pkg-4.0505-forge-1.20.1" = _qi7fcesY;
