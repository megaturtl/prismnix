...
let
    ...
    in {
        ...
        "pkg-0.5.3+1.20.6" = _DdVQufsV;
        "pkg-0.6.0+1.20.6" = _QfhNlMrK;
        "pkg-0.6.1+1.20.6" = _7vLzUc0J;
        "pkg-0.6.2+1.20.6" = _PJ67Pmt4;
        "pkg-0.6.3+1.20.6" = _tEN4aBWl;
        "pkg-0.6.4+1.20.6" = _stLGHg1j;
        "pkg-0.6.5+1.20.6" = _Xm9zZGRG;
        "pkg-0.7.0+1.20.6" = _HkaknfwJ;
        "pkg-0.7.1+1.20.6" = _YXQkqMDs;
        "pkg-0.7.2+1.20.6" = _QfYAF3wG;
        "pkg-0.7.3+1.20.6" = _BiLcGK60;
        "pkg-0.7.4+1.20.6" = _U8xlgpzW;
        "pkg-0.7.5+1.20.6" = _c2JYNl0O;
        "pkg-0.7.6+1.20.6" = _FgdVSlMb;
        "pkg-0.7.7+1.20.6" = _DGs9eSrG;
        "pkg-0.8.0+1.20.6" = _6NX0tttl;
        "pkg-0.8.1+1.20.6" = _Nignog01;
        "pkg-0.8.2+1.20.6" = _QOVIY4fT;
        "pkg-0.8.3+1.20.6" = _GxyfDBRk;
        "pkg-0.8.4+1.20.6" = _gBtygGP2;
        "pkg-0.9.0+1.20.6" = _uU7xHkP2;
        "pkg-0.9.1+1.20.6" = _ydLXuZoo;
        "pkg-0.9.2+1.20.6" = _BD1scln7;
        "pkg-0.9.3+1.20.6" = _HdDMwVn7;
        "pkg-0.9.4+1.20.6" = _2ATIpWNS;
        "pkg-0.9.5+1.20.6" = _itoP0agi;
        "pkg-0.10.0+1.20.6" = _LMN0sJBA;
        "pkg-0.10.1+1.21.1" = _UM9J56b2;
        "pkg-0.10.2+1.21.1" = _fHqZ8SVO;
        "pkg-0.10.3+1.21.1" = _ryHIXudB;
        "pkg-0.11.0+1.21.1" = _rTc279Wj;
        "pkg-0.11.1+1.21.1" = _ejARhwM5;
        "pkg-0.11.2+1.21.1" = _rZ9DQ2lw;
        "pkg-0.11.3+1.21.1" = _9i7X2YrJ;
        "pkg-0.12.0+1.21.4" = _SCjS5CrU;
        "pkg-0.12.1+1.21.4" = _es1NkwNg;
        "pkg-0.12.2+1.21.4" = _ZGFRk6kM;
        "pkg-0.12.3+1.21.4" = _J7dXxsJa;
        "pkg-0.12.4+1.21.4" = _eCQuFNLy;
        "pkg-0.12.5+1.21.5" = _jSOdyXnO;
        "pkg-0.13.0+1.21.5" = _ZpMVzaLI;
        "pkg-0.13.1+1.21.5" = _YB0UYiT3;
        "pkg-0.13.2+1.21.5" = _OL7M5Yf1;
        "pkg-0.14.0+1.21.5" = _lNvfEUgs;
        "pkg-0.14.1+1.21.8" = _cMsCj7Gi;
        "pkg-0.14.2+1.21.8" = _tLlZ7PWr;
        "pkg-0.14.3+1.21.8" = _AFtRoVT5;
        "pkg-0.14.4+1.21.8" = _hklIwjMv;
        "pkg-0.14.5+1.21.8" = _Ysa4c2Ya;
        "pkg-0.14.6+1.21.8" = _1ljqOyJd;
        "pkg-0.14.7+1.21.8" = _72b7Lr3f;
        "pkg-0.15.0+1.21.8" = _2FBlOD2Y;
        "pkg-0.15.1+1.21.8" = _Tc8UJMei;
        "pkg-0.15.2+1.21.8" = _q9lzCF90;
        "pkg-0.16.0+1.21.8" = _DvLUweE8;
        "pkg-0.16.1+1.21.8" = _IH2s3zu2;
        "pkg-0.16.2+1.21.8" = _H8Wl9gyn;
        "pkg-0.16.3+1.21.8" = _DtiHFpX1;
        "pkg-0.16.4+1.21.10" = _FOOZnGLM;
        "pkg-0.16.5+1.21.10" = _bfbIXQ6T;
        "pkg-0.17.0+1.21.10" = _L1JHXirW;
        "pkg-0.17.1+1.21.10" = _xx3uAtkF;
        "pkg-0.18.0+1.21.11" = _l9iKLMKP;
        "pkg-0.18.1+1.21.11" = _TcQcQLOo;
        "pkg-0.18.2+1.21.11" = _9Y8knEHj;
        "pkg-0.19.0+1.21.11" = _r5JWZDCb;
        "pkg-0.19.1+1.21.11" = _AylaMJwc;
        "pkg-0.19.2+1.21.11" = _1YTnfjTi;
        "pkg-0.20.0+1.21.11" = _vMXbUae7;
        "pkg-0.20.1+1.21.11" = _DUuikTvv;
        "pkg-0.20.2+1.21.11" = _g8JLPx5l;
        "pkg-0.20.3+1.21.11" = _GdRV7EYn;
        "pkg-0.20.4+1.21.11" = _sKjcCOcG;
        "pkg-0.20.5+1.21.11" = _mXcjxQWJ;
        "pkg-0.20.6+1.21.11" = _w8zynF4Q;
        "pkg-0.20.7+1.21.11" = _HHQDz2bn;
        "pkg-0.20.8+1.21.11" = _BzRAlRpN;
        "pkg-0.20.9+1.21.11" = _41HKQePc;
        "pkg-0.20.10+1.21.11" = _lOpcih1b;
        "pkg-0.20.11+1.21.11" = _v6XAUH3y;
        "pkg-0.20.12+1.21.11" = _dN0YM8Uh;
        "pkg-0.20.13+1.21.11" = _YZicFvyG;
