...
let
    ...
    in {
        ...
        "pkg-1.0" = _nSqMP2cn;
        "pkg-1.1" = _jRtkrMLo;
        "pkg-1.1-1.19" = _ikh04LHb;
        "pkg-1.2" = _wVm3plgd;
        "pkg-1.2-1.19" = _5QnBfRQj;
        "pkg-1.2.1-pre" = _64YlDChP;
        "pkg-1.2.1-post" = _gDhhePf7;
        "pkg-1.2.2-pre" = _H9GmQAsF;
        "pkg-1.2.2-post" = _m7yUx2AV;
        "pkg-1.2.3-post" = _8cdpYJkl;
        "pkg-1.2.3-pre" = _wyWl0F0J;
        "pkg-1.2.2" = _EPovTxg6;
        "pkg-1.2.3" = _cLRUeYOW;
        "pkg-1.2.4" = _mG9CjwpU;
        "pkg-1.2.5-b1" = _AAGRLTe3;
        "pkg-1.2.5" = _IOXYZlTy;
        "pkg-1.2.6" = _XjOAF7RF;
        "pkg-1.2.7" = _K1ImHgTM;
        "pkg-1.2.8" = _rjTIddri;
        "pkg-1.2.9" = _p2r3lEH3;
        "pkg-1.2.10" = _TTQstreX;
        "pkg-1.2.11" = _dr5OI7tF;
        "pkg-1.2.12" = _m95OLPgD;
