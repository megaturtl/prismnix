...
let
    ...
    in {
        ...
        "pkg-3.7.1" = _PPvtsUVs;
        "pkg-2.13.7" = _kpc80kKK;
        "pkg-3.13.2" = _JCFIS84F;
        "pkg-3.21.3-mc1.20.1" = _pVt63G8m;
        "pkg-3.21.4-mc1.20.1" = _WelTMcOS;
        "pkg-4.5.10" = _lHIKO2j7;
        "pkg-4.6.0" = _6JLSbinW;
        "pkg-4.7.0" = _Z6D550WD;
        "pkg-4.7.1" = _Dy7xc3Ut;
        "pkg-4.8.0" = _MsyEzFRV;
        ...
        "pkg-4.8.2" = _fwvhto3d;
        "pkg-4.9.0" = _F9C3O65K;
        "pkg-4.10.0" = _xpzHagNP;
        "pkg-4.10.1" = _1esV6J0r;
        "pkg-4.10.2" = _5iF9CNOU;
        "pkg-4.10.3" = _s3f8ETzw;
        "pkg-4.11.0" = _XNsF3fwg;
        "pkg-4.11.1" = _CvzVhsXq;
        "pkg-4.11.2" = _twIGXHFw;
        "pkg-4.11.3" = _POABA88t;
        "pkg-4.11.4" = _EGEgx11k;
        "pkg-4.11.5" = _nsTthZ2j;
        "pkg-4.11.6" = _avdbbYRT;
        "pkg-4.11.7" = _cO75Dt1S;
        "pkg-4.11.8" = _sipSBmiR;
        "pkg-4.11.9" = _QpfSHIzo;
        "pkg-4.11.10" = _eCC2pCNZ;
        "pkg-4.11.11" = _3M6jlo23;
        "pkg-4.11.12" = _3z19McD6;
        "pkg-4.11.13" = _iSgKEXfe;
        "pkg-4.11.14" = _mgBPRNYX;
        "pkg-4.11.15" = _igquvtxU;
        "pkg-4.11.16" = _XoaYvMNI;
        "pkg-4.11.17" = _AA1iFeXH;
        "pkg-4.11.18" = _yxt0PT3I;
        "pkg-4.11.19" = _llnNbEwM;
        "pkg-4.12.0" = _W5M7vQzN;
        "pkg-4.12.1" = _5B7jf7Rc;
        "pkg-4.12.2" = _vzTErHp2;
        "pkg-4.12.3" = _eMQ9Xaiy;
        "pkg-4.12.4" = _2megKAaM;
        "pkg-4.12.5" = _mRbChwfQ;
        "pkg-4.12.6" = _LRWYQze5;
        "pkg-4.12.7" = _qaKComRi;
        "pkg-4.12.9" = _NQ8NZNXC;
        "pkg-4.12.10-alpha" = _edMUo9ch;
        "pkg-4.12.11-alpha" = _MuFPrssh;
        "pkg-4.12.12-beta" = _sNeBk1un;
        "pkg-4.13.0-beta" = _XwLeQfzP;
        "pkg-4.13.1" = _fYj2XXpP;
        "pkg-4.13.2" = _xOfO2fHn;
        "pkg-4.13.3" = _XzHvRsxV;
        "pkg-4.13.4" = _CgXnxrUw;
        "pkg-4.13.5" = _KfMyx2W4;
        "pkg-4.13.6" = _CxEmrJFs;
        "pkg-4.14.0-alpha" = _tAvPcUe9;
        "pkg-4.14.1-alpha" = _79ZIUtcr;
        "pkg-4.14.2-alpha" = _t6ZkCP9e;
        "pkg-4.14.3-alpha" = _cDpeHvOB;
        "pkg-4.14.4" = _gluUDWwZ;
        "pkg-4.14.5" = _KSneBPWM;
        "pkg-4.14.6" = _GbUbUGIK;
        "pkg-4.14.7" = _CiF9jwlL;
        "pkg-4.15.0" = _CAP1j1dD;
        "pkg-4.15.1" = _XGHPYfHb;
        "pkg-4.16.0" = _YrkYZCEb;
        "pkg-4.16.1" = _yFvoTx8Q;
        "pkg-4.17.0" = _kCucaE8p;
        "pkg-4.17.1" = _WuyYFdqU;
        "pkg-4.17.4" = _jQVBL5TI;
        "pkg-4.17.5" = _s2vLfFtc;
        "pkg-4.17.6" = _u2Esb0qX;
        "pkg-4.17.7" = _OlROQnss;
        "pkg-4.17.8" = _gnOg1Kf4;
        "pkg-4.17.10" = _bMwSYjFq;
        "pkg-4.17.11" = _wAnfQas7;
        "pkg-4.17.12" = _sf3zea6j;
        "pkg-4.18.0" = _g0Z4ZTnB;
        "pkg-4.18.1" = _cuq7fB34;
        "pkg-4.18.2" = _pMjWWbAj;
        "pkg-4.18.3" = _va7ZpcTF;
        "pkg-4.18.4" = _LvjHoj7e;
        "pkg-4.18.5" = _8cVVCmKS;
        "pkg-4.18.6" = _4h6S2TjW;
        "pkg-4.19.0" = _1dGYcsTn;
        "pkg-4.19.1" = _kmcKZvya;
        "pkg-4.19.2" = _s3Shc8EG;
        "pkg-4.19.3" = _WnQuIMCY;
        "pkg-4.19.4" = _g9KPyLx2;
        "pkg-4.19.5" = _juj88xBX;
        "pkg-4.19.6" = _7ZAe8Wqw;
        "pkg-4.19.7" = _Y0W2fUC2;
        "pkg-4.19.8" = _b7YCwA1S;
        "pkg-4.19.9" = _KhgFapmT;
        "pkg-4.19.10" = _W57DT0y4;
        "pkg-4.20.0" = _jibZBmwO;
        "pkg-4.21.0" = _cVwyMqgO;
        "pkg-1.5.2" = _MCHmu8jt;
        "pkg-4.21.1" = _PwyHVgZo;
        "pkg-4.21.2" = _FjSqTYuY;
        "pkg-4.21.3" = _uIhWjPvi;
        "pkg-4.21.4" = _pC3FhmiI;
        "pkg-4.22.0" = _irs5SSOG;
        "pkg-4.22.1" = _Qklobm4b;
        "pkg-4.22.2" = _BoU9EVLy;
        "pkg-4.23.0" = _TYPK1uOO;
        "pkg-4.23.`0`" = _1571X3uE;
        "pkg-4.24.0" = _pu0wUfGs;
        "pkg-4.24.1" = _4yYknSCd;
        "pkg-4.24.2" = _Z60QuSV0;
        "pkg-4.24.3" = _5Tohoor9;
        "pkg-4.24.4" = _JjOXQjg8;
        "pkg-4.25.0" = _U083FPoO;
        "pkg-4.26.0" = _2iooHkMR;
        "pkg-4.27.0" = _14nxJhKH;
        "pkg-4.27.1" = _LXhdPGCT;
        "pkg-4.27.2" = _HGAvF0pD;
        "pkg-4.28.0" = _Pl9yU2qx;
        "pkg-4.28.2" = _kgFp7n68;
        "pkg-4.28.3" = _aoUMAvLE;
        "pkg-4.28.4" = _xgFxEyki;
        "pkg-4.28.5" = _q8LYSTKx;
        "pkg-4.28.6" = _nMxJoG6U;
        "pkg-4.29.0" = _Ex12yAEF;
        "pkg-4.29.0.1" = _vfKoW5nC;
        "pkg-4.29.0.2" = _MtynZVyP;
        "pkg-4.29.1.0" = _HBnvgzck;
        "pkg-4.29.1.1" = _Q7SMtdir;
        "pkg-4.30.0.0" = _CqHzvZJi;
        "pkg-4.30.1.0" = _6TqkeggF;
        "pkg-4.30.1.1" = _GJ8x5BsY;
        "pkg-5.3.1.0-beta" = _tA6FZw8P;
        "pkg-4.30.1.3" = _Bt3TKJNO;
        "pkg-5.3.4.0" = _twDswwQh;
        "pkg-5.4.0.1" = _8NiZVbPW;
        "pkg-5.4.1.0" = _LiuRvXhQ;
        "pkg-5.4.1.1" = _s92XGjOS;
        "pkg-5.4.1.2" = _grvVTJ5c;
        "pkg-5.4.2.0" = _eF9pOU3E;
        "pkg-5.4.2.2" = _JmCpkPVB;
        "pkg-5.4.3.0" = _q72tbJ2z;
        "pkg-5.4.3.1" = _prrk2BEJ;
        "pkg-4.30.1.4" = _VbQyyeJv;
        "pkg-5.4.4.0" = _UAubUfg7;
        "pkg-5.5.0.0-alpha" = _LDoKvsC4;
        "pkg-5.5.0.1-alpha" = _XoDaeuVv;
        "pkg-5.5.0.2-alpha" = _vYS7XvHN;
        "pkg-5.5.1.1-alpha" = _fD5Qe9Ik;
        "pkg-5.5.1.2-alpha" = _BfWr9SNs;
