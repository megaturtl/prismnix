...
let
    ...
    in {
        ...
        "pkg-5.0.0+1.20.1" = _1owTCwFi;
        "pkg-5.1+1.20.1" = _rRFkGYzl;
        "pkg-6.0+1.20.2-4" = _E3Kzexx2;
        "pkg-6.1+1.20.2-4" = _DuMsKN4c;
        "pkg-6.2+1.20.2-5" = _9BdSmcMB;
        "pkg-6.3+1.20.2" = _Ev0ASl3N;
        "pkg-6.4+1.20.2" = _4sD70eGT;
