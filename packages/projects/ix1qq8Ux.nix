...
let
    versions = (let
        ...
        _jNzJIFiU = {
            "id" = "jNzJIFiU";
            "file" = "CrashAssistant-fabric-1.6.4-1.11.12.jar";
            "hash" = "sha512-gBiV3IZ1OoOyDlQMZTUgbYggAbsjK2hVkyVPLjryKv+/WNUUyWpxQueHCvFlA95HU49uNcDZsecY5XwEe6s9Yg==";
        };
        _Mt8SSLPL = {
            "id" = "Mt8SSLPL";
            "file" = "CrashAssistant-fabric-1.7.10-1.11.12.jar";
            "hash" = "sha512-VNTNnOGycBU9FrUMDipr7T/1rkPwLMDdoICRp9E28L62dijnmhqxXNrIlBoTsCH8aHZYdMFmkJZ8bxbDvejMEQ==";
        };
        _d71LIV4C = {
            "id" = "d71LIV4C";
            "file" = "!!!CrashAssistant-forge-1.7.10-1.11.12.jar";
            "hash" = "sha512-Z3xQS3hChnlpBvKMHDZ28/MDnTZaELKk4cItLzhSgUfjg28g+3wy66Z40q4/ns9zj2lNSvzE279ykrufiO/Qaw==";
        };
        _53248Chv = {
            "id" = "53248Chv";
            "file" = "CrashAssistant-fabric-1.8.9-1.11.12.jar";
            "hash" = "sha512-PMANgwQjui1vOvaboGdm++mjrGfc/l6brac7bXp9d4tDVlkg1bOHkuEIPaiXi+QY5OwVv5gEiE3fhmRis+7/jA==";
        };
        _UqYoRK1w = {
            "id" = "UqYoRK1w";
            "file" = "!!!CrashAssistant-forge-1.8.9-1.11.12.jar";
            "hash" = "sha512-/zzwFf9QFtm14Zi6MbJbPuJ81fQwEWqrEjbYv8cgG9mjQcLn1eBAk2LVnt2OELeq0wsqPPktYKVBRNf0+TGopw==";
        };
        _C5MqzpgS = {
            "id" = "C5MqzpgS";
            "file" = "CrashAssistant-fabric-1.9.4-1.11.12.jar";
            "hash" = "sha512-HBC0U4fDyeIBPq7Mzd8u6EyZzsFHImxnBtLthX6Vywkx0kIVu9BdCSgqbmjefqr0E69yLQYdiq6oCgXl9zmvTA==";
        };
        _BmK4WLyi = {
            "id" = "BmK4WLyi";
            "file" = "!!!CrashAssistant-forge-1.9.4-1.11.12.jar";
            "hash" = "sha512-eu/gm+0oHzX1PPQfM7eugSsyxGKRyImd0Ji9OILTppuNS/RRiECiMyeejmWAjwY2NYUXhCSWQop14/5J0NjZdg==";
        };
        _3sd5Zo6j = {
            "id" = "3sd5Zo6j";
            "file" = "CrashAssistant-fabric-1.10.2-1.11.12.jar";
            "hash" = "sha512-MMkZFpyb0HPmMduZunqCmoHc9eCzEDUt2pX78vKcTNoK7MP057/1Hw6mwRd9WUGfuU1fjR09+g9xSScjeDg0qQ==";
        };
        _9emNdCFc = {
            "id" = "9emNdCFc";
            "file" = "!!!CrashAssistant-forge-1.10.2-1.11.12.jar";
            "hash" = "sha512-VH6J3T6gB89l1g0b2eyGTYivl8lY554V5iKNGKnUGXXJGM0Kdw85rqjDZlaGSmA6TqwweT1ysgD/AVExxG02bw==";
        };
        _LwZhOXwM = {
            "id" = "LwZhOXwM";
            "file" = "CrashAssistant-fabric-1.11.2-1.11.12.jar";
            "hash" = "sha512-i37TINhp15mVexobNCExRpt9psuH8XMbz8c1zlJcnQqFgFe7zGH/89VQiFyjQWZd6FHLrdj2cXw2xv0+LnFG6g==";
        };
        _Sd1l6KgL = {
            "id" = "Sd1l6KgL";
            "file" = "!!!CrashAssistant-forge-1.11.2-1.11.12.jar";
            "hash" = "sha512-qjGRWbEqoe9WQk3zNqND7++5mNCWwWcTpBfhCnl1zVHHEkjM+DaJglkUzMVV/AyZMg561ECR+ZLa40/Gu9Y7eg==";
        };
        _EOKIj3PB = {
            "id" = "EOKIj3PB";
            "file" = "CrashAssistant-fabric-1.12.2-1.11.12.jar";
            "hash" = "sha512-Zr0IStyxpnkQPuz5udb3L9WoaPQj379+obdNfP9ukfZgtPYr6Vcbw2AngXnk9ir+lM5yHwOcDkvdpTgYF2Rlpg==";
        };
        _1EzA3xZ5 = {
            "id" = "1EzA3xZ5";
            "file" = "!!!CrashAssistant-forge-1.12.2-1.11.12.jar";
            "hash" = "sha512-Tz5iRi0ccvpgWbAEZP0aK7rK4zGfSs7MDh2srlXk1fXcMZd2j1wdTBt1QFy9vzKgwX+g+/hjNHe2I08cSvtePg==";
        };
        _2dJcZNeh = {
            "id" = "2dJcZNeh";
            "file" = "CrashAssistant-fabric-1.13.2-1.11.12.jar";
            "hash" = "sha512-+uCLxWXzShgTwr3rpuJWNIYPABa0C1kxl2MT06Nllce7PASHk4dTeCx6Ij2tnmbS20AZan6k2fbmfLBLkzXZzA==";
        };
        _IrrngrSi = {
            "id" = "IrrngrSi";
            "file" = "!!!CrashAssistant-forge-1.13.2-1.11.12.jar";
            "hash" = "sha512-2sRGgY69iepgm2p8OZOs+rMib2u//4t3ctYwvflISHvIaDrrcasNqAk09M/RzRkyNDXjvu+0lnp7HPLQ0BC0dA==";
        };
        _RfvOJPSW = {
            "id" = "RfvOJPSW";
            "file" = "CrashAssistant-fabric-1.14.4-1.11.12.jar";
            "hash" = "sha512-KZqOJVIPqHS6YcBhFdIUETUK1TXDHPR31aPO/WeIhBNAA0OAYL+a0cC+YPFTbuIDEjwA51JPK+cjgqDANM7M5w==";
        };
        _CgeLTwZM = {
            "id" = "CgeLTwZM";
            "file" = "!!!CrashAssistant-forge-1.14.4-1.15.1-1.11.12.jar";
            "hash" = "sha512-oGnA2irgDhr8HAyPMlbK7MZx6kmRF5CPk6vHk8Nh6Tt7ya8CH6KZRuqXx2PMKfCOK1BY03KYuFullG3um9Uv8w==";
        };
        _Oi36yXFH = {
            "id" = "Oi36yXFH";
            "file" = "CrashAssistant-fabric-1.15.2-1.11.12.jar";
            "hash" = "sha512-udpvUfufxAPT/YiN7oMo9+3YuiseSs7qlCYOlo5QT0n5Ar6zH8tLQAgjwJAtcvzXcS7HzcANrXy7LrGm7nCC4A==";
        };
        _d5IGY6qv = {
            "id" = "d5IGY6qv";
            "file" = "!!!CrashAssistant-forge-1.15.2-1.11.12.jar";
            "hash" = "sha512-ElYQa13TeIx5etn9ABZEoXxbqv/kPHjTHRx4aIoqIR4gkKbFFtRmwb4kW+MdiTRPTvEi/hwOo0FV/lz7vxEh3w==";
        };
        _79ziowvX = {
            "id" = "79ziowvX";
            "file" = "CrashAssistant-fabric-1.16.5-1.11.12.jar";
            "hash" = "sha512-j0g90Q6qHeJQxqTXGETLpyuioVq7Yh60R+W1FWoxwfvQ6BLOf5/HWBaHxjvNc7LpW7kBk/8q2u0R8KeWPYk5jA==";
        };
        _ZIEX817u = {
            "id" = "ZIEX817u";
            "file" = "CrashAssistant-forge-1.16.1-1.16.5-1.11.12.jar";
            "hash" = "sha512-zpoM8vYhBpZAR84Owu1FMNfY7ueiUEodFDy/HXwyJh6rMjYTrE9U4y+Wg/e7qbiIBrCVpB5biBrH9wL7sZiVzA==";
        };
        _91txSnGS = {
            "id" = "91txSnGS";
            "file" = "CrashAssistant-fabric-1.17-1.18.1-1.11.12.jar";
            "hash" = "sha512-2x50sURuJCMt94aveAwhyjQ6sB6MmeA73KKNfpXPTK1faO+60yXnR74nIkhMjfQzTdpGM/1cTTk7XpF4NRjxeQ==";
        };
        _WOy7YNUx = {
            "id" = "WOy7YNUx";
            "file" = "CrashAssistant-forge-1.17.1-1.18.1-1.11.12.jar";
            "hash" = "sha512-LjEMi27WGB32yMBUktdMi2lIKcy+pEdNiaenI4rwvrinkXjunVaF7dFD9k2m9kpwDsIx4LG4LOhpMoQ957kwxQ==";
        };
        _3CFUwmxm = {
            "id" = "3CFUwmxm";
            "file" = "CrashAssistant-fabric-1.18.2-1.11.12.jar";
            "hash" = "sha512-ScIo1cIBkA95NyIGFJ8vGuSgP3x00zpGWEBOTEsx7dNR0i4IglOd08LcUcPrtWwN1EB8zKEoY4GSkGwhMDCXWg==";
        };
        _yxizJgTq = {
            "id" = "yxizJgTq";
            "file" = "CrashAssistant-forge-1.18.2-1.11.12.jar";
            "hash" = "sha512-7huPJWCsrjkETy+VISoH47QfDaStXgVywPdms/3bJ5ag1zk5dm9i/VyUL8fhG80esW5e3Xh61dFsLV263p9OQQ==";
        };
        _lUVoOA8s = {
            "id" = "lUVoOA8s";
            "file" = "CrashAssistant-fabric-1.19-1.20.1-1.11.12.jar";
            "hash" = "sha512-5juY82HzmjWk7v+4cYDRwMN08sK4HRXIXYD3Ue7XoHbW4tZFdyGNHBvgmWMLImNQv6S6A9UhRz5qjwhOGWttEw==";
        };
        _1UfKorj6 = {
            "id" = "1UfKorj6";
            "file" = "CrashAssistant-forge-1.19-1.20.1-1.11.12.jar";
            "hash" = "sha512-7B5HHOcsXpINEQ7zi6a7LSVv3KYuGk7d4XYQIbOU5AcXlDr1PmSlfjMuHSrqj8hmbYi7jKe8Yk1Sbs/EYFNfPQ==";
        };
        _AYajytbk = {
            "id" = "AYajytbk";
            "file" = "CrashAssistant-fabric-1.20.2-1.21.4-1.11.12.jar";
            "hash" = "sha512-jj5FlEhrJZIen2tLwhqYK0N6GmdKEnemjq0SciVv73wEUpgBDs8/jX9BiPZf/0Ck3gKWCR5qHulr1gO8pZ8hAQ==";
        };
        _tCnwzifD = {
            "id" = "tCnwzifD";
            "file" = "CrashAssistant-forge-1.20.2-1.11.12.jar";
            "hash" = "sha512-TPX0P5IxXYBSf2GUUtPUYq2Eidl9tg88/MFTJExHUFoBWnZpKAGrbkixIg3CMiKG/tkWPf4HpW+fKyGXkDVvGg==";
        };
        _N7gaUhB9 = {
            "id" = "N7gaUhB9";
            "file" = "CrashAssistant-forge-1.20.3-1.20.4-1.11.12.jar";
            "hash" = "sha512-0iCWphXKBB1EAggRaCnZTxSUJDHJGs8JLqpj9LKdNQdTgTcJxLj8Tzh/nHp71Cs9vP8CW4VBDYIOQsDZZDc7qA==";
        };
        _GFFTuuYJ = {
            "id" = "GFFTuuYJ";
            "file" = "CrashAssistant-neoforge-1.20.2-1.20.4-1.11.12.jar";
            "hash" = "sha512-O2JwnxgI8UPhtFfMijHAQSz7E5pPRdEpZukfvzCytYMppTl3+sCssnXXqLfn1F7rsTWRUhFsFHVYE3GbCKkYyw==";
        };
        _fHYFaeok = {
            "id" = "fHYFaeok";
            "file" = "CrashAssistant-neoforge-1.20.5-1.11.12.jar";
            "hash" = "sha512-Wavc20AYaCn7aWiJinRIAQgyP4h5uCvtPTnxDVSZWm+yhf+KrqQeseDyWFAvJKlOKZc1Dd8DndfMRmxTpnS7PA==";
        };
        _W3z9yOJP = {
            "id" = "W3z9yOJP";
            "file" = "CrashAssistant-forge-1.20.6-1.21.4-1.11.12.jar";
            "hash" = "sha512-KeqaRlSoJXfrRslX/r67kUzv/fOzlG8wdL/NiqpVpSIGJ62LQoluuCgRQaqpqbRnoSdP3e0Le6HEoDbBnBQr1g==";
        };
        _18SR4EJw = {
            "id" = "18SR4EJw";
            "file" = "CrashAssistant-neoforge-1.20.6-1.21.4-1.11.12.jar";
            "hash" = "sha512-Q9T0U+NG3wleSU6sayo629r2xnnjKriMiClNsUFOPXR8BmdUOgyb5X9Fg3UE3+6yrxX+V//fPQ8cloSC7WtoIA==";
        };
        _bBrHAtEv = {
            "id" = "bBrHAtEv";
            "file" = "CrashAssistant-forge-1.21.5-1.21.11-1.11.12.jar";
            "hash" = "sha512-Zq6mzQkUkPs/nr5HJN1hWlZda777P+NNLSGvBKspH/3lDhI8uOSK15qDHROgiNfETyTKumGID08lyaPA59wOng==";
        };
        _CceMSg6c = {
            "id" = "CceMSg6c";
            "file" = "CrashAssistant-neoforge-1.21.5-1.21.8-1.11.12.jar";
            "hash" = "sha512-Zqg+imu6bghdjZbXOfbhDZ2OgTnGGgAFPQw/zJOT27YV+xX8R7vIMzyjP3Q7c6oy5sn/R6yo5w8OqJQgksNNyQ==";
        };
        _j2E0IeRG = {
            "id" = "j2E0IeRG";
            "file" = "CrashAssistant-fabric-1.21.5-1.21.11-1.11.12.jar";
            "hash" = "sha512-B7+/aE75uwEnKzTjlPYtKdiB0ZDjlPjaZ/dtBTMfEwPD33beALiRqa5z6M8RkCBBPowKW+dlH1AH3iRpdvxN3g==";
        };
        _Y1F6sP9F = {
            "id" = "Y1F6sP9F";
            "file" = "CrashAssistant-neoforge-1.21.9-1.21.11-1.11.12.jar";
            "hash" = "sha512-g4eSpE2Vws7ZzlfGKiDAut4tUWN1bd555S/1crN1nGVh6H4/pMoB42TAac/BgQFaSVaMZgVoUkUiLi9IJU7fHg==";
        };
        _xZViEiHv = {
            "id" = "xZViEiHv";
            "file" = "CrashAssistant-forge-26.1-1.11.12.jar";
            "hash" = "sha512-U+IRwr9gpOZVtujxAxEec9NpEw+tNsyYvpXT8YEVmqF32KYbCXP3MC7ibhHeieR/uxbHef7Omq6v69d1arMMoA==";
        };
        _d6c8DAqR = {
            "id" = "d6c8DAqR";
            "file" = "CrashAssistant-fabric-26.1-1.11.12.jar";
            "hash" = "sha512-u6olkXzCG8ncp0nTyz6e65KF4ADWbOMRTAYB6fRfNH3KfiegHjI2CUNa8S54RjnjScp9tDB9uULk5/9XTDJp3w==";
        };
        _1hBMKzCk = {
            "id" = "1hBMKzCk";
            "file" = "CrashAssistant-neoforge-26.1-1.11.12.jar";
            "hash" = "sha512-QCiee3LWawTAtbgyTeR2WcSftXqA8O6pCRJTFz2CWbpWR5mKjjReA2iDOSY7KYAqHB6AlFnS7D3I6LqS1gaJQQ==";
        };
        _DkwYE3wT = {
            "id" = "DkwYE3wT";
            "file" = "CrashAssistant-forge-26.2-1.11.12.jar";
            "hash" = "sha512-vUNF7/b0RX29YubxWogw0N0fATN8lT8+cMRpl+KAgDNG1+XJO+/ZwFQuFTsH8sWxEYR2EySqnniqw0hPm2nvHw==";
        };
        _i9RTpEjU = {
            "id" = "i9RTpEjU";
            "file" = "CrashAssistant-fabric-26.2-1.11.12.jar";
            "hash" = "sha512-X+WuysB//lI7Ex3CcSgo0aXT5ZaZYjPAk7B135QPdz/1M7kOGtaPGD5GOS6WCOViD8plQlVSEyOH7SHTlNKyAg==";
        };
        _bEEQFVP1 = {
            "id" = "bEEQFVP1";
    ...
    in {
        ...
        "fabric-1.20.1" = _lUVoOA8s;
        "fabric-1.20" = _lUVoOA8s;
        "fabric-1.20.2" = _AYajytbk;
        "fabric-1.20.3" = _AYajytbk;
        "fabric-1.20.4" = _AYajytbk;
        "fabric-1.20.5" = _AYajytbk;
        "fabric-1.20.6" = _AYajytbk;
        "fabric-1.21" = _AYajytbk;
        "fabric-1.21.1" = _AYajytbk;
        "fabric-1.21.2" = _AYajytbk;
        "fabric-1.21.3" = _AYajytbk;
        "fabric-1.21.4" = _AYajytbk;
        "fabric-1.21.5" = _j2E0IeRG;
        "fabric-1.18.2" = _3CFUwmxm;
        "fabric-1.16.5" = _79ziowvX;
        ...
        "fabric-1.21.6" = _j2E0IeRG;
        "fabric-1.21.7" = _j2E0IeRG;
        "fabric-1.21.8" = _j2E0IeRG;
        "fabric-1.17" = _91txSnGS;
        "fabric-1.17.1" = _91txSnGS;
        "fabric-1.18" = _91txSnGS;
        "fabric-1.18.1" = _91txSnGS;
        "fabric-1.19" = _lUVoOA8s;
        "fabric-1.19.1" = _lUVoOA8s;
        "fabric-1.21.9" = _j2E0IeRG;
        "fabric-1.14.4" = _RfvOJPSW;
        "fabric-1.15.2" = _Oi36yXFH;
        "fabric-1.21.10" = _j2E0IeRG;
        "fabric-1.21.11" = _j2E0IeRG;
        ...
        "fabric-26.1-snapshot-11" = _d6c8DAqR;
        "fabric-26.1-pre-1" = _d6c8DAqR;
        "fabric-26.1-pre-2" = _d6c8DAqR;
        "fabric-1.7.10" = _Mt8SSLPL;
        "fabric-1.8.9" = _53248Chv;
        "fabric-1.9.4" = _C5MqzpgS;
        "fabric-1.10.2" = _3sd5Zo6j;
        "fabric-1.11.2" = _LwZhOXwM;
        "fabric-1.12.2" = _EOKIj3PB;
        "fabric-1.13.2" = _2dJcZNeh;
        "fabric-26.1-pre-3" = _d6c8DAqR;
        "fabric-26.1-rc-1" = _d6c8DAqR;
        "fabric-26.1-rc-2" = _d6c8DAqR;
        "fabric-26.1-rc-3" = _d6c8DAqR;
        "fabric-26.1" = _d6c8DAqR;
        "fabric-1.6.4" = _jNzJIFiU;
        "fabric-26.1.1-rc-1" = _FMH9oihL;
        "fabric-26.1.1" = _d6c8DAqR;
        ...
        "forge-1.20.1" = _1UfKorj6;
        "forge-1.21.1" = _W3z9yOJP;
        "forge-1.21.2" = _W3z9yOJP;
        "forge-1.21.3" = _W3z9yOJP;
        "forge-1.21.4" = _W3z9yOJP;
        "forge-1.21.5" = _bBrHAtEv;
        "forge-1.18.2" = _yxizJgTq;
        "forge-1.21" = _W3z9yOJP;
        "forge-1.16.5" = _ZIEX817u;
        "forge-1.20" = _1UfKorj6;
        "forge-1.20.2" = _tCnwzifD;
        "forge-1.20.3" = _N7gaUhB9;
        "forge-1.20.4" = _N7gaUhB9;
        "forge-1.20.6" = _W3z9yOJP;
        "forge-1.21.6" = _bBrHAtEv;
        "forge-1.21.7" = _bBrHAtEv;
        "forge-1.12.2" = _1EzA3xZ5;
        "forge-1.7.10" = _d71LIV4C;
        "forge-1.21.8" = _bBrHAtEv;
        "forge-1.16.1" = _ZIEX817u;
        "forge-1.16.2" = _ZIEX817u;
        "forge-1.16.3" = _ZIEX817u;
        "forge-1.16.4" = _ZIEX817u;
        "forge-1.17.1" = _WOy7YNUx;
        "forge-1.18" = _WOy7YNUx;
        "forge-1.18.1" = _WOy7YNUx;
        "forge-1.19" = _1UfKorj6;
        "forge-1.19.1" = _1UfKorj6;
        "forge-1.21.9" = _bBrHAtEv;
        "forge-1.8.9" = _UqYoRK1w;
        "forge-1.9.4" = _BmK4WLyi;
        "forge-1.10.2" = _9emNdCFc;
        "forge-1.11.2" = _Sd1l6KgL;
        "forge-1.13.2" = _IrrngrSi;
        "forge-1.14.4" = _CgeLTwZM;
        "forge-1.15" = _vKSDN6c7;
        "forge-1.15.1" = _vKSDN6c7;
        "forge-1.15.2" = _d5IGY6qv;
        "forge-1.21.10" = _bBrHAtEv;
        "forge-1.21.11" = _bBrHAtEv;
        "forge-26.1-snapshot-11" = _xZViEiHv;
        "forge-26.1-pre-1" = _xZViEiHv;
        "forge-26.1-pre-2" = _xZViEiHv;
        "forge-26.1-pre-3" = _xZViEiHv;
        "forge-26.1-rc-1" = _xZViEiHv;
        "forge-26.1-rc-2" = _xZViEiHv;
        "forge-26.1-rc-3" = _xZViEiHv;
        "forge-26.1" = _xZViEiHv;
        "forge-26.1.1-rc-1" = _JqGglwOR;
        "forge-26.1.1" = _xZViEiHv;
        ...
        "neoforge-1.20.1" = _1UfKorj6;
        "neoforge-1.21.1" = _18SR4EJw;
        "neoforge-1.21.2" = _18SR4EJw;
        "neoforge-1.21.3" = _18SR4EJw;
        "neoforge-1.21.4" = _18SR4EJw;
        "neoforge-1.21.5" = _CceMSg6c;
        "neoforge-1.21" = _18SR4EJw;
        "neoforge-1.20" = _1UfKorj6;
        "neoforge-1.20.2" = _GFFTuuYJ;
        "neoforge-1.20.3" = _GFFTuuYJ;
        "neoforge-1.20.4" = _GFFTuuYJ;
        "neoforge-1.20.6" = _18SR4EJw;
        "neoforge-1.21.6" = _CceMSg6c;
        "neoforge-1.21.7" = _CceMSg6c;
        "neoforge-1.21.8" = _CceMSg6c;
        "neoforge-1.19" = _1UfKorj6;
        "neoforge-1.19.1" = _1UfKorj6;
        "neoforge-1.20.5" = _fHYFaeok;
        "neoforge-1.21.9" = _Y1F6sP9F;
        "neoforge-1.21.10" = _Y1F6sP9F;
        "neoforge-1.21.11" = _Y1F6sP9F;
        ...
        "neoforge-26.1-snapshot-11" = _1hBMKzCk;
        "neoforge-26.1-pre-1" = _1hBMKzCk;
        "neoforge-26.1-pre-2" = _1hBMKzCk;
        "neoforge-26.1-pre-3" = _1hBMKzCk;
        "neoforge-26.1-rc-1" = _1hBMKzCk;
        "neoforge-26.1-rc-2" = _1hBMKzCk;
        "neoforge-26.1-rc-3" = _1hBMKzCk;
        "neoforge-26.1" = _1hBMKzCk;
        "neoforge-26.1.1-rc-1" = _GSskdGeM;
        "neoforge-26.1.1" = _1hBMKzCk;
        ...
        "quilt-1.20" = _lUVoOA8s;
        "quilt-1.20.1" = _lUVoOA8s;
        "quilt-1.20.2" = _AYajytbk;
        "quilt-1.20.3" = _AYajytbk;
        "quilt-1.20.4" = _AYajytbk;
        "quilt-1.20.5" = _AYajytbk;
        "quilt-1.20.6" = _AYajytbk;
        "quilt-1.21" = _AYajytbk;
        "quilt-1.21.1" = _AYajytbk;
        "quilt-1.21.2" = _AYajytbk;
        "quilt-1.21.3" = _AYajytbk;
        "quilt-1.21.4" = _AYajytbk;
        "quilt-1.21.5" = _j2E0IeRG;
        "quilt-1.18.2" = _3CFUwmxm;
        "quilt-1.16.5" = _79ziowvX;
        ...
        "quilt-1.21.6" = _j2E0IeRG;
        "quilt-1.21.7" = _j2E0IeRG;
        "quilt-1.21.8" = _j2E0IeRG;
        "quilt-1.17" = _91txSnGS;
        "quilt-1.17.1" = _91txSnGS;
        "quilt-1.18" = _91txSnGS;
        "quilt-1.18.1" = _91txSnGS;
        "quilt-1.19" = _lUVoOA8s;
        "quilt-1.19.1" = _lUVoOA8s;
        "quilt-1.21.9" = _j2E0IeRG;
        "quilt-1.21.10" = _j2E0IeRG;
        "quilt-1.21.11" = _j2E0IeRG;
        ...
        "quilt-26.1-snapshot-11" = _d6c8DAqR;
        "quilt-26.1-pre-1" = _d6c8DAqR;
        "quilt-26.1-pre-2" = _d6c8DAqR;
        "quilt-1.14.4" = _RfvOJPSW;
        "quilt-1.15.2" = _Oi36yXFH;
        "quilt-26.1-pre-3" = _d6c8DAqR;
        "quilt-26.1-rc-1" = _d6c8DAqR;
        "quilt-26.1-rc-2" = _d6c8DAqR;
        "quilt-26.1-rc-3" = _d6c8DAqR;
        "quilt-26.1" = _d6c8DAqR;
        "quilt-26.1.1-rc-1" = _FMH9oihL;
        "quilt-26.1.1" = _d6c8DAqR;
        ...
        "legacy-fabric-1.10.2" = _3sd5Zo6j;
        "legacy-fabric-1.11.2" = _LwZhOXwM;
        "legacy-fabric-1.12.2" = _EOKIj3PB;
        "legacy-fabric-1.13.2" = _2dJcZNeh;
        "legacy-fabric-1.6.4" = _jNzJIFiU;
        "pkg-1.0.1" = _xi5DzJ7q;
        "pkg-1.1.0" = _Jo55DCCt;
        "pkg-1.1.1" = _nXyw9gtm;
        "pkg-1.2.0a" = _9YnmbHAG;
        "pkg-1.2.1" = _C7h5FcF0;
        "pkg-1.2.2" = _qZjNCWlO;
        "pkg-1.2.3" = _iRB45vVx;
        "pkg-1.2.4" = _d2zMnzMq;
        ...
        "pkg-1.2.7" = _4RsuyyUI;
        "pkg-1.2.8" = _4x79gHoa;
        "pkg-1.2.10" = _gOhbmqGg;
        "pkg-1.2.11" = _RDGexqKK;
        "pkg-1.2.12" = _firvm6oN;
        "pkg-1.2.13" = _FgHym0WU;
        "pkg-1.2.14alpha" = _goKcQyXP;
        "pkg-1.2.14" = _WjSXTb1G;
        "pkg-1.2.15" = _izPO4k5p;
        "pkg-1.2.16" = _M6hSsVU3;
        "pkg-1.2.17" = _JJVebGWV;
        "pkg-1.2.18" = _pXeh4W5j;
        "pkg-1.2.19" = _FuhPlFbk;
        "pkg-1.2.20" = _YV2Yh3Qh;
        "pkg-1.3.0" = _2JERujAW;
        "pkg-1.3.1" = _p4S3u0Xo;
        "pkg-1.3.2" = _m5JBMOga;
        "pkg-1.3.3" = _45HWNfDy;
        ...
        "pkg-1.7.8" = _j56M6Fs3;
        "pkg-1.7.9" = _Q14b1478;
        "pkg-1.7.10" = _oEMqzAdf;
        "pkg-1.7.11" = _XCnxiC8g;
        "pkg-1.7.12" = _BonK8vr4;
        "pkg-1.7.13" = _XX6Ko59Q;
        "pkg-1.7.14" = _1ir4xpOT;
        "pkg-1.7.15" = _yF07cHXo;
        "pkg-1.7.16" = _yiVYhpP3;
        "pkg-1.7.17" = _WFTLpfZ4;
        "pkg-1.7.18" = _Qo2l6ijD;
        "pkg-1.7.19" = _CdzndHdu;
        "pkg-1.7.20" = _gmPZVCDJ;
        "pkg-1.7.21" = _AK7ZWI0k;
        "pkg-1.7.22" = _MaF6YA7m;
        "pkg-1.7.23" = _rtrM82Rk;
        "pkg-1.7.23.1" = _cifU9xtV;
        "pkg-1.7.24" = _jairVLIu;
        "pkg-1.7.25" = _ElWkgSXe;
        "pkg-1.7.26" = _qDLVtHVV;
        "pkg-1.7.27" = _IoxXzgZE;
        "pkg-1.7.28" = _UJO0a6n8;
        "pkg-1.8.0" = _dSQxGUmD;
        "pkg-1.8.1" = _HO9OgIUv;
        "pkg-1.8.2" = _aScoJpAR;
        "pkg-1.9.0" = _AkW6NSVt;
        ...
        "pkg-1.9.8" = _uxsTYZOC;
        "pkg-1.9.9" = _i5qeCnXD;
        "pkg-1.9.10" = _oDCIDLRQ;
        "pkg-1.9.11" = _sC56iwRl;
        "pkg-1.9.12" = _B8MpOFbL;
        "pkg-1.9.13" = _C05wtpBB;
        "pkg-1.9.14" = _SaqtXYxL;
        "pkg-1.9.15" = _BW33YB9k;
        "pkg-1.10.0" = _QUaT5qtH;
        "pkg-1.10.1" = _JH9KsMR0;
        "pkg-1.10.2" = _rKJZlUMb;
        "pkg-1.10.3" = _Q80bsC2B;
        "pkg-1.10.4" = _FsBWT91c;
        "pkg-1.10.5" = _MTUxibuj;
        "pkg-1.10.6" = _lh8rN4e7;
        "pkg-1.10.6.1" = _TAkZun1D;
        "pkg-1.10.6.2" = _OR1gYqHt;
        "pkg-1.10.7" = _NNrSZiaA;
        "pkg-1.10.8" = _1wMXE8v0;
        "pkg-1.10.9" = _mP9tsvdB;
        "pkg-1.10.10" = _YYqnoUVu;
        "pkg-1.10.10.1" = _p4iVl3lI;
        "pkg-1.10.11" = _bBIcCdjP;
        "pkg-1.10.12" = _4xHtHCTu;
        "pkg-1.10.13" = _QaNKFeAz;
        "pkg-1.10.14" = _XFiMOkoM;
        "pkg-1.10.15" = _7DV2P2sX;
        "pkg-1.10.16" = _SGVwB0Fo;
        "pkg-1.10.17" = _BnAMdmjo;
        "pkg-1.10.18" = _rCk2cLHc;
        "pkg-1.10.19" = _5KCFPY5K;
        "pkg-1.10.20" = _3JL7tCcu;
        "pkg-1.10.21" = _38S3iJxj;
        "pkg-1.10.22" = _OEL3jDfU;
        "pkg-1.10.23" = _2wKcNpK5;
        "pkg-1.10.24" = _Yu60vm18;
        "pkg-1.10.25" = _hGyOp1kL;
        "pkg-1.10.26" = _HXM0v8nE;
        "pkg-1.10.27" = _A9l4UNN1;
        "pkg-1.10.28" = _sLX6qGlQ;
        "pkg-1.10.29" = _mk9UB4SW;
        "pkg-1.10.30" = _1FQmkKXA;
        "pkg-1.11.0" = _iyqxMMXG;
        "pkg-1.11.1" = _meCtBqrt;
        "pkg-1.11.2" = _jwfhba6k;
        "pkg-1.11.3" = _YXrC291s;
        "pkg-1.11.4" = _CsZLjMNH;
        "pkg-1.11.5" = _REPH2zni;
        "pkg-1.11.6" = _GSskdGeM;
        "pkg-1.11.7" = _KmJa3O2X;
        "pkg-1.11.8" = _jjVsW7ir;
        "pkg-1.11.9" = _6TEBhOYb;
