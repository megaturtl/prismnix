...
let
    ...
    in {
        ...
        "pkg-2.3.8" = _RZsq6CK3;
        "pkg-2.3.9" = _FcmqTozR;
        "pkg-2.3.9.8" = _7C8moQAe;
        "pkg-2.3.9.9.3" = _e8GAYLBq;
        "pkg-2.3.9.9.4" = _4nQfaZiI;
        "pkg-1.21.4.2.4" = _6Ok86MTa;
        "pkg-1.21.1.3.2.0" = _Y6EiZq1a;
        "pkg-1.21.8.3.2.0" = _fzYNiXuy;
        "pkg-1.21.8.3.2.1" = _CVH7uxuv;
        "pkg-1.21.1.3.2.1" = _P218NnAb;
        "pkg-1.21.1.3.3.0" = _BMwDj7GE;
        "pkg-1.21.1.3.3.1" = _HJXvF0aR;
        "pkg-1.21.4.3.3.1" = _zn1kL8n4;
        "pkg-1.21.4.3.3.2" = _Zly3AWRa;
        "pkg-1.21.1.3.3.3-1beta" = _DlAZaCau;
        "pkg-1.21.1.3.3.3-2beta" = _sSJAYo9M;
        "pkg-1.21.1.3.3.3-3beta" = _p18HYSkg;
        "pkg-1.21.1.3.3.3" = _Zr8XUhd7;
