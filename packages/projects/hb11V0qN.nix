...
let
    versions = (let
        ...
        _vk4Ib5m8 = {
            "id" = "vk4Ib5m8";
            "file" = "CoolNightSky.jar";
            "hash" = "sha512-P0oQeTY8ZzIlC6kX7PRXh3lPWCA/PDYH2oQgd2Z0Db0FlqrDIcFK1xiLqLLsr7wDFnNj9zRkJAul2dqW6y1CvQ==";
        };
    in {
        "2xarSwuj" = _2xarSwuj;
        "C5fK3iIO" = _C5fK3iIO;
        ...
        "bukkit-1.20.6" = _vk4Ib5m8;
        "bukkit-1.21" = _vk4Ib5m8;
        "bukkit-1.21.1" = _vk4Ib5m8;
        "bukkit-1.21.2" = _vk4Ib5m8;
        "bukkit-1.21.3" = _vk4Ib5m8;
        "bukkit-1.21.4" = _vk4Ib5m8;
        "bukkit-1.21.5" = _vk4Ib5m8;
        "bukkit-1.21.6" = _vk4Ib5m8;
        "bukkit-1.21.7" = _vk4Ib5m8;
        "bukkit-1.21.8" = _vk4Ib5m8;
        "bukkit-1.21.9" = _vk4Ib5m8;
        "bukkit-1.21.10" = _vk4Ib5m8;
        "bukkit-1.21.11" = _vk4Ib5m8;
        "bukkit-26.1" = _vk4Ib5m8;
        "bukkit-26.1.1" = _vk4Ib5m8;
        "bukkit-26.1.2" = _vk4Ib5m8;
        "bukkit-26.2" = _vk4Ib5m8;
        ...
        "paper-1.20.6" = _vk4Ib5m8;
        "paper-1.21" = _vk4Ib5m8;
        "paper-1.21.1" = _vk4Ib5m8;
        "paper-1.21.2" = _vk4Ib5m8;
        "paper-1.21.3" = _vk4Ib5m8;
        "paper-1.21.4" = _vk4Ib5m8;
        "paper-1.21.5" = _vk4Ib5m8;
        "paper-1.21.6" = _vk4Ib5m8;
        "paper-1.21.7" = _vk4Ib5m8;
        "paper-1.21.8" = _vk4Ib5m8;
        "paper-1.21.9" = _vk4Ib5m8;
        "paper-1.21.10" = _vk4Ib5m8;
        "paper-1.21.11" = _vk4Ib5m8;
        "paper-26.1" = _vk4Ib5m8;
        "paper-26.1.1" = _vk4Ib5m8;
        "paper-26.1.2" = _vk4Ib5m8;
        "paper-26.2" = _vk4Ib5m8;
        ...
        "purpur-1.20.6" = _vk4Ib5m8;
        "purpur-1.21" = _vk4Ib5m8;
        "purpur-1.21.1" = _vk4Ib5m8;
        "purpur-1.21.2" = _vk4Ib5m8;
        "purpur-1.21.3" = _vk4Ib5m8;
        "purpur-1.21.4" = _vk4Ib5m8;
        "purpur-1.21.5" = _vk4Ib5m8;
        "purpur-1.21.6" = _vk4Ib5m8;
        "purpur-1.21.7" = _vk4Ib5m8;
        "purpur-1.21.8" = _vk4Ib5m8;
        "purpur-1.21.9" = _vk4Ib5m8;
        "purpur-1.21.10" = _vk4Ib5m8;
        "purpur-1.21.11" = _vk4Ib5m8;
        "purpur-26.1" = _vk4Ib5m8;
        "purpur-26.1.1" = _vk4Ib5m8;
        "purpur-26.1.2" = _vk4Ib5m8;
        "purpur-26.2" = _vk4Ib5m8;
        ...
        "spigot-1.20.6" = _vk4Ib5m8;
        "spigot-1.21" = _vk4Ib5m8;
        "spigot-1.21.1" = _vk4Ib5m8;
        "spigot-1.21.2" = _vk4Ib5m8;
        "spigot-1.21.3" = _vk4Ib5m8;
        "spigot-1.21.4" = _vk4Ib5m8;
        "spigot-1.21.5" = _vk4Ib5m8;
        "spigot-1.21.6" = _vk4Ib5m8;
        "spigot-1.21.7" = _vk4Ib5m8;
        "spigot-1.21.8" = _vk4Ib5m8;
        "spigot-1.21.9" = _vk4Ib5m8;
        "spigot-1.21.10" = _vk4Ib5m8;
        "spigot-1.21.11" = _vk4Ib5m8;
        "spigot-26.1" = _vk4Ib5m8;
        "spigot-26.1.1" = _vk4Ib5m8;
        "spigot-26.1.2" = _vk4Ib5m8;
        "spigot-26.2" = _vk4Ib5m8;
        ...
        "folia-1.20.6" = _vk4Ib5m8;
        "folia-1.21" = _vk4Ib5m8;
        "folia-1.21.1" = _vk4Ib5m8;
        "folia-1.21.2" = _vk4Ib5m8;
        "folia-1.21.3" = _vk4Ib5m8;
        "folia-1.21.4" = _vk4Ib5m8;
        "folia-1.21.5" = _vk4Ib5m8;
        "folia-1.21.6" = _vk4Ib5m8;
        "folia-1.21.7" = _vk4Ib5m8;
        "folia-1.21.8" = _vk4Ib5m8;
        "folia-1.21.9" = _vk4Ib5m8;
        "folia-1.21.10" = _vk4Ib5m8;
        "folia-1.21.11" = _vk4Ib5m8;
        "folia-26.1" = _vk4Ib5m8;
        "folia-26.1.1" = _vk4Ib5m8;
        "folia-26.1.2" = _vk4Ib5m8;
        "folia-26.2" = _vk4Ib5m8;
        "pkg-0.8" = _2xarSwuj;
        "pkg-0.8.3" = _C5fK3iIO;
        "pkg-0.8.7" = _47eKmX3r;
        "pkg-0.8.9" = _UeHUsJTt;
