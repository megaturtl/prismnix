...
let
    versions = (let
        ...
        _lvgavFmA = {
            "id" = "lvgavFmA";
            "file" = "Ashen_16x.zip";
            "hash" = "sha512-WyLcTOa8Id8cxGMlH5e0MrbBMuJTycF1iuLlm6HYk450efwv2go/Ta5/wvKLoZdsX/OWmxAcHpqKWmitNlODeA==";
        };
        _NJOukAZ6 = {
            "id" = "NJOukAZ6";
            "file" = "Ashen_16x.zip";
            "hash" = "sha512-En8Lw+B2Yzl+GBnf1ycKomq662NsvCTL9wQuinSm+9s99v5PSsEHNqFjSHT/7PDbCCkjz8HKXqUhjC13lurxZA==";
        };
    in {
        "K44Ty4ms" = _K44Ty4ms;
        "NWx2dY45" = _NWx2dY45;
        ...
        "minecraft-1.20" = _lvgavFmA;
        "minecraft-1.20.1" = _lvgavFmA;
        "minecraft-1.20.2" = _lvgavFmA;
        "minecraft-1.20.3" = _NJOukAZ6;
        "minecraft-1.20.4" = _NJOukAZ6;
        "minecraft-1.20.5" = _NJOukAZ6;
        "minecraft-1.20.6" = _NJOukAZ6;
        "minecraft-1.21" = _NJOukAZ6;
        "minecraft-1.21.1" = _NJOukAZ6;
        "minecraft-1.21.2" = _NJOukAZ6;
        "minecraft-1.21.3" = _NJOukAZ6;
        "minecraft-1.21.4" = _NJOukAZ6;
        "minecraft-1.21.5" = _NJOukAZ6;
        "minecraft-1.21.6" = _NJOukAZ6;
        "minecraft-1.21.7" = _NJOukAZ6;
        "minecraft-1.21.8" = _NJOukAZ6;
        "minecraft-1.21.9" = _NJOukAZ6;
        "minecraft-1.21.10" = _NJOukAZ6;
        "minecraft-1.21.11" = _NJOukAZ6;
        "minecraft-23w31a" = _lvgavFmA;
        "minecraft-23w32a" = _lvgavFmA;
        "minecraft-23w33a" = _lvgavFmA;
        "minecraft-23w35a" = _lvgavFmA;
        "minecraft-1.20.2-pre1" = _lvgavFmA;
        "minecraft-23w42a" = _lvgavFmA;
        "minecraft-23w43a" = _lvgavFmA;
        "minecraft-23w43b" = _lvgavFmA;
        "minecraft-23w44a" = _lvgavFmA;
        "minecraft-23w45a" = _lvgavFmA;
        "minecraft-23w46a" = _lvgavFmA;
        "minecraft-24w03a" = _NJOukAZ6;
        "minecraft-24w03b" = _NJOukAZ6;
        "minecraft-24w04a" = _NJOukAZ6;
        "minecraft-24w05a" = _NJOukAZ6;
        "minecraft-24w05b" = _NJOukAZ6;
        "minecraft-24w06a" = _NJOukAZ6;
        "minecraft-24w07a" = _NJOukAZ6;
        "minecraft-24w09a" = _NJOukAZ6;
        "minecraft-24w10a" = _NJOukAZ6;
        "minecraft-24w11a" = _NJOukAZ6;
        "minecraft-24w12a" = _NJOukAZ6;
        "minecraft-24w13a" = _NJOukAZ6;
        "minecraft-24w14potato" = _NJOukAZ6;
        "minecraft-24w14a" = _NJOukAZ6;
        "minecraft-1.20.5-pre1" = _NJOukAZ6;
        "minecraft-1.20.5-pre2" = _NJOukAZ6;
        "minecraft-1.20.5-pre3" = _NJOukAZ6;
        "minecraft-24w18a" = _NJOukAZ6;
        "minecraft-24w19a" = _NJOukAZ6;
        "minecraft-24w19b" = _NJOukAZ6;
        "minecraft-24w20a" = _NJOukAZ6;
        "minecraft-24w33a" = _NJOukAZ6;
        "minecraft-24w34a" = _NJOukAZ6;
        "minecraft-24w35a" = _NJOukAZ6;
        "minecraft-24w36a" = _NJOukAZ6;
        "minecraft-24w37a" = _NJOukAZ6;
        "minecraft-24w38a" = _NJOukAZ6;
        "minecraft-24w39a" = _NJOukAZ6;
        "minecraft-24w40a" = _NJOukAZ6;
        "minecraft-1.21.2-pre1" = _NJOukAZ6;
        "minecraft-1.21.2-pre2" = _NJOukAZ6;
        "minecraft-24w44a" = _NJOukAZ6;
        "minecraft-24w45a" = _NJOukAZ6;
        "minecraft-24w46a" = _NJOukAZ6;
        "minecraft-26.1" = _NJOukAZ6;
        "minecraft-26.1.1" = _NJOukAZ6;
        "minecraft-26.1.2" = _NJOukAZ6;
        "minecraft-26.2" = _NJOukAZ6;
        "minecraft-26.3" = _NJOukAZ6;
        "pkg-1.4" = _GvyWE7RI;
        "pkg-1.4.1" = _31t1fRJw;
        "pkg-1.3" = _KJRzPZYI;
        "pkg-1.4.2" = _COqBOGZM;
        ...
        "pkg-1.6" = _vRrn9ih6;
        "pkg-1.6.1" = _bT3IZlX9;
        "pkg-1.6.1b" = _i98DrOBC;
        "pkg-1.7" = _LvpEuaZ0;
        "pkg-1.7.1" = _8eu373Jz;
        "pkg-1.7.2" = _dNnan43F;
        "pkg-1.8" = _sDjsI3bC;
        "pkg-1.8.1" = _g24curuH;
        "pkg-1.8.1.1" = _rnK2ioHx;
        "pkg-1.8.2" = _R3j3wg1U;
        "pkg-1.8.3" = _Grwv3nuK;
        "pkg-1.9" = _pAOXq44A;
        "pkg-1.9.1" = _GaAr6rqr;
        "pkg-1.9.2" = _KfhdZP71;
        "pkg-1.10" = _WFCzBikG;
        "pkg-1.10.1" = _1Ff9eCe9;
        "pkg-1.10.2" = _DmoFZ8bh;
        "pkg-1.10.3" = _OO7V0PBe;
        "pkg-1.11" = _utgLboQ0;
        "pkg-1.11.1" = _bZooY5Fe;
        "pkg-1.11.2" = _JQVmUdGw;
        "pkg-1.12" = _F8qobGSQ;
        "pkg-1.12.1" = _Bki3Fiae;
        "pkg-1.13" = _b056Esqi;
        "pkg-1.13.1" = _2WbkHa6e;
        "pkg-1.13.2" = _WMQna9oK;
        "pkg-1.14" = _iowqsLaC;
        "pkg-1.14.1" = _9l7XdWVM;
        "pkg-1.15" = _t8fHbB10;
        "pkg-1.15.1" = _lXofluMq;
        "pkg-1.15.2" = _I7vWXWf5;
        "pkg-1.15.3" = _zewiXtmr;
        "pkg-1.15.4" = _WEjxuLJT;
        "pkg-1.15.5" = _5rRyDqO1;
        "pkg-1.16" = _RMq5FFOR;
        "pkg-1.16.1" = _znwxp1rV;
        "pkg-1.17" = _NJOukAZ6;
        "default" = _NJOukAZ6;
    });
