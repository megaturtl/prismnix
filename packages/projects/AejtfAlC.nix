...
let
    ...
    in {
        ...
        "pkg-1.0.2-1.20.1" = _lbMXDOoE;
        "pkg-1.0.2-1.21" = _6d3bP1BO;
        "pkg-1.0.3-1.21" = _w7OuwbSH;
        "pkg-1.0.3-1.20.1" = _XahBvavQ;
        "pkg-1.0.4-1.21" = _USzEn3fb;
        "pkg-1.0.4-1.20.1" = _q8aYZ1w4;
        "pkg-1.0.5-1.20.1" = _gW9ZTNzf;
        "pkg-1.0.5-1.21" = _MQEFXks6;
        "pkg-1.0.6-1.20.1" = _gGEx3N3N;
        "pkg-1.0.6-1.21" = _8VXUgUY4;
        "pkg-1.0.7-1.20.1" = _a3QGLcIc;
        "pkg-1.0.7-1.21" = _LxL89kG2;
        "pkg-1.0.8+1.20.1" = _PtQwHIQg;
        "pkg-1.0.8+1.21" = _eCejD2RR;
        "pkg-1.0.9+1.20.1" = _tH1MBcPo;
        "pkg-1.0.9+1.21" = _JcHbCp5g;
        "pkg-1.1.0+1.21" = _EDWrpV4O;
        "pkg-1.1.0+1.20.1" = _YHH0Feov;
        "pkg-1.1.1+1.21" = _I3U0DvGD;
        "pkg-1.1.1+1.20.1" = _U3hGNnA2;
        "pkg-1.2.0+1.20.1" = _jB5WkjAy;
        "pkg-1.2.0+1.21" = _M191JD4v;
        "pkg-1.2.1+1.20.1" = _7Ys1yRSG;
        "pkg-1.2.1+1.21" = _MPGK3RD8;
        "pkg-1.2.2+1.20.1" = _j3PTojaS;
        "pkg-1.2.2+1.21" = _qRA3AEyv;
        "pkg-1.2.3+1.20.1" = _qwV8U61R;
        "pkg-1.2.3+1.21" = _zBu2mDHR;
        "pkg-1.3.0+1.20.1" = _d2remcG5;
        "pkg-1.3.0+1.21" = _8k3dFdb7;
        "pkg-1.3.1+1.21" = _L6bRT45r;
        "pkg-1.3.1+1.20.1" = _OUshCR5H;
        "pkg-1.3.2+1.20.1" = _b3GtDWwj;
        "pkg-1.3.2+1.21" = _SRnSUqxM;
        "pkg-1.3.3+1.20.1" = _Cd3SK4i3;
        "pkg-1.3.3+1.21" = _uZG0bDMI;
        "pkg-1.3.4+1.20.1" = _okqiB9cE;
        "pkg-1.3.4+1.21" = _aZv6nXHE;
        "pkg-1.3.5+1.20.1" = _48rYyph9;
        "pkg-1.3.5+1.21" = _RD0yB8AQ;
        "pkg-1.4.0+1.20.1" = _VIatQu8f;
        "pkg-1.4.0+1.21" = _ne9jBVWC;
        "pkg-1.4.1+1.21" = _Flqlklgu;
        "pkg-1.4.2+1.20.1" = _aIwhUWl1;
        "pkg-1.4.2+1.21" = _MU4xgmZQ;
        "pkg-1.5.0+1.20.1" = _Uibexm43;
        "pkg-1.5.0+1.21" = _5ejwAekB;
        "pkg-1.5.1+1.20.1" = _rjdUy5nf;
        "pkg-1.5.1+1.21" = _hlHi0RNy;
        "pkg-1.5.2+1.20.1" = _REI5Git6;
        "pkg-1.5.2+1.21" = _ckX381GD;
        "pkg-1.6.0+1.20.1" = _9R7lr1Cz;
        "pkg-1.6.0+1.21" = _eZFvHwAw;
        "pkg-1.6.1+1.20.1" = _8Bd5LYOE;
        "pkg-1.6.1+1.21" = _sCCQCv5x;
        "pkg-1.6.2+1.20.1" = _lc2ThmRg;
        "pkg-1.6.2+1.21" = _57Q9yTlL;
        "pkg-1.7.0+1.20.1" = _XiHuObfQ;
        "pkg-1.7.0+1.21.1" = _Akvz2dq6;
        "pkg-1.7.1+1.20.1" = _pfiIXZSm;
        "pkg-1.7.1+1.21.1" = _Huq5HYEO;
        "pkg-1.8.0+1.20.1" = _ejeCJ6TF;
        "pkg-1.8.0+1.21.1" = _EVwWnH9d;
        "pkg-1.8.1+1.20.1" = _cUepjYsJ;
        "pkg-1.8.1+1.21.1" = _zdu5RfsW;
        "pkg-1.8.2+1.20.1" = _sxevD9FH;
        "pkg-1.8.2+1.21.1" = _USqtNARs;
        "pkg-1.9.0+1.20.1" = _2wfkk7tk;
        "pkg-1.9.0+1.21.1" = _l6Exqjpe;
        "pkg-1.9.1+1.20.1" = _2qS9wGmU;
        "pkg-1.9.1+1.21.1" = _MaFx2Ikp;
        "pkg-1.10+1.20.1" = _lsG6meD3;
