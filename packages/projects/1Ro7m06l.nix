...
let
    ...
    in {
        ...
        "pkg-3.2.8.7" = _U2ihcjtm;
        "pkg-1.20.1-3.8.0-4" = _wys8aWGn;
        "pkg-1.20.1-3.8.0-5" = _n963cYpD;
        "pkg-1.20.1-3.8.0-6" = _4mVKPecW;
        "pkg-1.20.1-3.8.0-7" = _BcemIwdc;
        "pkg-1.20.1-3.8.0-8" = _MyzFota2;
        "pkg-1.20.1-3.8.1-9" = _vz8UjJHy;
        "pkg-1.20.1-3.8.1-10" = _iDX5Rzxf;
        "pkg-1.20.1-3.8.1-12" = _JK64KmM0;
        "pkg-1.20.1-3.8.1-13" = _eSDZ5h8s;
        "pkg-1.20.1-3.8.14" = _vL2dZO9I;
        "pkg-1.20.1-3.8.15" = _L7coIGhh;
        "pkg-1.20.1-3.8.16" = _ZO24qZGB;
        "pkg-1.20.1-3.8.18" = _FwhHMdgZ;
        "pkg-1.20.1-3.8.19" = _h2Z8JKWo;
        "pkg-1.20.1-3.8.21" = _cQ2knouq;
        "pkg-1.20.1-3.8.22" = _sV3ZUp7t;
        "pkg-1.20.1-3.8.23" = _9d4pSie1;
        "pkg-1.20.1-3.8.24" = _1Yp6IsNj;
        "pkg-1.20.1-3.8.25" = _836GDPBz;
        "pkg-1.20.1-3.8.27" = _P19ybyjg;
        "pkg-1.20.1-3.8.28" = _NqY5UYxd;
        "pkg-1.20.1-3.8.29" = _srlH4sDN;
        "pkg-1.20.1-3.8.30" = _9FF3cOmh;
        "pkg-1.20.1-3.8.31" = _XkaZMkpU;
        "pkg-1.20.1-3.8.32" = _8krhHkrZ;
        "pkg-1.21-4.0" = _jKIicMAh;
        "pkg-1.21-4.0.7" = _rtb01Plk;
        "pkg-1.21-4.0.8" = _wTL4AKBo;
        "pkg-1.21-4.0.9" = _282UMoK3;
        "pkg-1.21-4.0.10" = _qaPIeusK;
        "pkg-1.21-4.0.12" = _IeKDJ7R3;
        "pkg-1.21-4.0.13" = _4kYBoKSZ;
        "pkg-1.21-4.0.17" = _keMzkJkh;
        "pkg-1.21-4.0.18" = _QHleWz4v;
        "pkg-1.21-4.0.19" = _elcUWbJO;
        "pkg-1.21-4.0.20" = _yvgqqM4O;
        "pkg-1.21-4.0.21" = _7fws1VBb;
        "pkg-1.21-4.0.22" = _B8GLjQ35;
        "pkg-1.21-4.0.23" = _R4cDOB6Q;
        "pkg-1.21-4.0.24" = _uJt6WmaN;
        "pkg-1.21-4.0.25" = _fDvzsFXT;
        "pkg-1.21-4.0.26" = _gtJ1PYLd;
        "pkg-1.21-4.0.27" = _vqhyp10K;
        "pkg-1.21-4.0.28" = _1HV67eVE;
        "pkg-1.21-4.0.29" = _zmWjT5eZ;
        "pkg-1.21-4.0.30" = _kBZdY1Xu;
        "pkg-1.21-4.0.32" = _8xgyJPGh;
        "pkg-1.21-4.0.33" = _sMsGNrpP;
        "pkg-1.21-4.0.34" = _Iv0p6iyx;
        "pkg-1.21-4.0.35" = _SLYnMZu6;
        "pkg-1.21-4.0.36" = _CRTowJl9;
        "pkg-1.21-4.0.37" = _cH7yPTV2;
        "pkg-1.21-4.0.39" = _95S4S8ZU;
        "pkg-1.21-4.0.40" = _XweNZVuM;
        "pkg-1.21-4.0.42" = _LmipxHTo;
        "pkg-1.20.1-3.8.34" = _VM4XivJs;
        "pkg-1.21-4.0.43" = _ENONQ5aP;
        "pkg-1.21-4.0.45" = _7AWtSmd7;
