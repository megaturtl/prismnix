...
let
    versions = (let
        ...
        _GJ7arctQ = {
            "id" = "GJ7arctQ";
            "file" = "autodrop-2.6.0-26.1+fabric.jar";
            "hash" = "sha512-WqGv8ihEUGMqx3UNeCtpsgj98xuh1sT7pRhgf9Sv3Lt9mc7LSYwFOekwAjOLfkb1napFyQ1oK9nDEXTQi1+exg==";
        };
        _C5tqtIwj = {
            "id" = "C5tqtIwj";
            "file" = "autodrop-2.6.0-26.1+neoforge.jar";
            "hash" = "sha512-qeM7EWerA0UnFE9posXKpOgpQmIcl4xMTAzrTVY5uEIwlxLrm+YNBR6w0e9p7qV/KPBfCyHIAsv6OLT9DPBi1g==";
        };
        _c8CVN5yE = {
            "id" = "c8CVN5yE";
            "file" = "autodrop-2.6.0-26.2-pre-4+fabric.jar";
            "hash" = "sha512-Tq4aTQVnq5705ljm4+7RkjCTcrqF9mfnal47RDHdfY1cs6asMf1T2yZpRjh7PQ+El1gxL9PIloNxCyWQpaaPQw==";
        };
        _deV2noql = {
            "id" = "deV2noql";
            "file" = "autodrop-2.6.0-26.2-pre-4+neoforge.jar";
            "hash" = "sha512-V6uY6e8UHWdKFwmjbpORRcx0xlfuPemzTz93LZSXWFbHCqFwNd2RV1zpS/ZILERWtr9rx+JHHW10R8iddZZmBw==";
        };
        _3y6QyHZG = {
            "id" = "3y6QyHZG";
            "file" = "autodrop-2.6.0-26.3+fabric.jar";
            "hash" = "sha512-EFKYUTq6NxCtfDg7tl1wfjmPhu3jcAHcHM4xgyWcrDXnchzg6unS/kouyIGAFXwMt77xP/W96uMaFcKG7hQY1g==";
        };
        _c1K9yhrc = {
            "id" = "c1K9yhrc";
            "file" = "autodrop-2.6.1-26.1+fabric.jar";
            "hash" = "sha512-7KwYQDXdYzEmHyQ3rAf+HqVnpOvoGNj51NZyc/wN2UuPUUBRgbQQgrzaQOjMzddH993nLv77CjdGSweKMVWoHQ==";
        };
        _I1uViqcb = {
            "id" = "I1uViqcb";
            "file" = "autodrop-2.6.1-26.1+neoforge.jar";
            "hash" = "sha512-W1kxSj4S3DNgnXWJO/MQmBbhZyMPH1k4POucQxEFbcjGHQmR73ahOyfUrQ3okUP0xEmaTo682UCBhC+OLZ56Fw==";
        };
        _mIctyTrs = {
            "id" = "mIctyTrs";
            "file" = "autodrop-2.6.1-26.2-pre-4+fabric.jar";
            "hash" = "sha512-Tas73ec7CDS0Ea20fuzdogNdN/6pOsQV3SoN7ZRnnHvumVN0JN1cXqqHXNVIW4zBms+wBpoVOfu03jiiEHWF7g==";
        };
        _7PDkbsiF = {
            "id" = "7PDkbsiF";
            "file" = "autodrop-2.6.1-26.2-pre-4+neoforge.jar";
            "hash" = "sha512-apbvDvZsDg85nLCE4QJd9xryPuMh45Zvd2UEdFjQG+yb0Z5GX1DYxj78NmUuTJ3mdt523V8tW03+/aGv0XQFrQ==";
        };
        _aCD72uEY = {
            "id" = "aCD72uEY";
            "file" = "autodrop-2.6.1-26.3+fabric.jar";
            "hash" = "sha512-RRrQDoaQ4JdvjvGs8DakMVJNc1rsuPsmX7vpv4EMdvEfQoMcIPUJOHZhEU3qSUSORqEK8Ordg+eP7K5xQcgE4w==";
        };
        _PdImqYly = {
            "id" = "PdImqYly";
            "file" = "autodrop-2.6.1-26.3+neoforge.jar";
            "hash" = "sha512-CYh5BE8SxAmA6v2n8XlNmc2wJ4eAk/ouFmtYlhy4isG7fHMYpLzxedkY7Yo2Y/f2QCjwGTeX+Y5PDaYXDqotjA==";
        };
    in {
        "9QTuQoWw" = _9QTuQoWw;
        "doNno8h5" = _doNno8h5;
        ...
        "fabric-26.1" = _c1K9yhrc;
        "fabric-26.1.1-rc-1" = _whjOIMSk;
        "fabric-26.1.1" = _c1K9yhrc;
        "fabric-26.1.2" = _c1K9yhrc;
        "fabric-26.2-pre-4" = _k6wXR8B0;
        "fabric-26.2" = _mIctyTrs;
        "fabric-26.3" = _aCD72uEY;
        ...
        "quilt-26.1" = _c1K9yhrc;
        "quilt-26.1.1-rc-1" = _whjOIMSk;
        "quilt-26.1.1" = _c1K9yhrc;
        "quilt-26.1.2" = _c1K9yhrc;
        "quilt-26.2-pre-4" = _k6wXR8B0;
        "quilt-26.2" = _mIctyTrs;
        "quilt-26.3" = _aCD72uEY;
        ...
        "neoforge-26.1" = _I1uViqcb;
        "neoforge-26.1.1-rc-1" = _VSCWnboU;
        "neoforge-26.1.1" = _I1uViqcb;
        "neoforge-26.1.2" = _I1uViqcb;
        "neoforge-26.2-pre-4" = _rJguv2yL;
        "neoforge-26.2" = _7PDkbsiF;
        "neoforge-26.3" = _PdImqYly;
        "pkg-v1.0.0" = _9QTuQoWw;
        "pkg-1.1.1" = _doNno8h5;
        "pkg-1.1.2" = _Y5ze43l6;
        "pkg-1.1.3" = _I3T7PJ86;
        "pkg-1.2.0" = _3MM1309b;
        ...
        "pkg-1.3.2" = _aCBa7x22;
        "pkg-1.3.3" = _uyPrvMSb;
        "pkg-1.3.3-1.19.2" = _8j4A5qai;
        "pkg-1.3.3-1.19.3-rc2" = _181hm4zM;
        "pkg-1.3.3-1.19.3" = _7dVSeEw5;
        "pkg-1.3.4-1.19.3" = _GskWzcAR;
        "pkg-1.4.0-1.19.3" = _KSavqU1m;
        "pkg-1.5.0-1.19.4" = _AZpsl9tQ;
        "pkg-1.5.1-1.19.4" = _YPe2PV7e;
        "pkg-1.5.2-1.19.4" = _JQNBFaXo;
        "pkg-1.5.3-1.19.4" = _fSBxHup7;
        "pkg-1.5.3-1.20" = _h9K0z4OG;
        "pkg-1.5.4-1.20" = _XAomWEL0;
        "pkg-1.6.0-1.20.1" = _CCKJe4lH;
        "pkg-1.6.0-1.20.2" = _nJpHrCfJ;
        "pkg-1.6.1-1.20.4" = _hvuvyhA9;
        "pkg-1.6.2-1.20.4" = _hdbrDU6F;
        "pkg-1.6.2-24w13a" = _GQXRaq3i;
        "pkg-1.6.2-1.20.6" = _2VDXK3SX;
        "pkg-1.6.2-1.20.1" = _wg1QSFZs;
        "pkg-1.7.0-1.21" = _91vjYap6;
        "pkg-1.7.0-1.20.4" = _5vm19htb;
        "pkg-1.7.0-1.20.1" = _WbaX7PhV;
        "pkg-1.7.1-1.21" = _Mls996zU;
        "pkg-1.7.1-1.20.6" = _ACeSyUlP;
        "pkg-1.7.1-1.20.4" = _jizjvGmm;
        "pkg-1.7.1-1.20.1" = _RDftz5oa;
        "pkg-2.0.0-beta1-1.21" = _dSQgYaz6;
        "pkg-2.0.0-beta1-1.20.6" = _vj6jBowb;
        "pkg-2.0.0-beta1-1.20.4" = _MXTvHECN;
        "pkg-2.0.0-beta2-1.21" = _u8BKia4J;
        "pkg-2.0.0-beta2-1.20.6" = _h4eeOriz;
        "pkg-2.0.0-beta2-1.20.4" = _tSg29oyE;
        "pkg-2.0.0-1.21+neoforge" = _bCFkmiqz;
        "pkg-2.0.0-1.21+fabric" = _27iR9YLc;
        "pkg-2.0.0-1.20.6+neoforge" = _z25KaBAg;
        "pkg-2.0.0-1.20.6+fabric" = _30ksAJ8S;
        "pkg-2.0.0-1.20.4+neoforge" = _YcjEvnlh;
        "pkg-2.0.0-1.20.4+fabric" = _xXqFlSwm;
        "pkg-2.0.1-1.21+neoforge" = _J0KZuIVE;
        "pkg-2.0.1-1.21+fabric" = _qZboBT6V;
        "pkg-2.0.1-1.20.6+neoforge" = _Qa0eSUgl;
        "pkg-2.0.1-1.20.6+fabric" = _y5wgy7aE;
        "pkg-2.0.1-1.20.4+neoforge" = _IIGuffZp;
        "pkg-2.0.1-1.20.4+fabric" = _yP15PKGJ;
        "pkg-2.0.2-1.21+neoforge" = _po7l2Olt;
        "pkg-2.0.2-1.21+fabric" = _hOED2wkY;
        "pkg-2.0.2-1.20.6+neoforge" = _vbgaFBT8;
        "pkg-2.0.2-1.20.6+fabric" = _pv01JVHw;
        "pkg-2.0.2-1.20.4+neoforge" = _OpffeCTx;
        "pkg-2.0.2-1.20.4+fabric" = _HEpKprht;
        "pkg-2.0.3-1.21.2-rc1+fabric" = _niumI5RK;
        "pkg-2.0.3-1.21+neoforge" = _gCacToc5;
        "pkg-2.0.3-1.21+fabric" = _fgNYJSut;
        "pkg-2.0.3-1.20.6+neoforge" = _pnyUJq7S;
        "pkg-2.0.3-1.20.6+fabric" = _H63jebGy;
        "pkg-2.0.3-1.20.4+neoforge" = _gZrNytaP;
        "pkg-2.0.3-1.20.4+fabric" = _XauTV3YJ;
        "pkg-2.0.4-1.21.2-rc1+fabric" = _BiJNEaRh;
        "pkg-2.0.4-1.21+neoforge" = _SMhFVpCt;
        "pkg-2.0.4-1.21+fabric" = _eZNbWZCy;
        "pkg-2.0.4-1.20.6+neoforge" = _jvbuQ43q;
        "pkg-2.0.4-1.20.6+fabric" = _aL81MGvv;
        "pkg-2.0.4-1.20.4+neoforge" = _wy5ggXQA;
        "pkg-2.0.4-1.20.4+fabric" = _s86WRvpd;
        "pkg-2.1.0-1.21.2+neoforge" = _dgaVmMQS;
        "pkg-2.1.0-1.21.2+fabric" = _ocySX7gV;
        "pkg-2.1.0-1.21+neoforge" = _6xcg1V04;
        "pkg-2.1.0-1.21+fabric" = _D88WQxLE;
        "pkg-2.1.0-1.20.6+neoforge" = _VbZBPFAw;
        "pkg-2.1.0-1.20.6+fabric" = _5CtIq9qv;
        "pkg-2.1.0-1.20.4+neoforge" = _DteG9g8F;
        "pkg-2.1.0-1.20.4+fabric" = _g8dxUtTo;
        "pkg-2.2.0-1.21.4-pre1+fabric" = _xu8Q7imm;
        "pkg-2.2.0-1.21.3+neoforge" = _mISv849N;
        "pkg-2.2.0-1.21.3+fabric" = _ZpZG60zE;
        "pkg-2.2.0-1.21+neoforge" = _m5a1WkXU;
        "pkg-2.2.0-1.21+fabric" = _u4AYAdLh;
        "pkg-2.2.0-1.20.6+neoforge" = _igk69vGO;
        "pkg-2.2.0-1.20.6+fabric" = _1VClPkrK;
        "pkg-2.2.0-1.20.4+neoforge" = _FFcmoYYr;
        "pkg-2.2.0-1.20.4+fabric" = _H54gxZWF;
        "pkg-2.2.1-1.21.4+neoforge" = _UgAggrCe;
        "pkg-2.2.1-1.21.4+fabric" = _RDlMr8P3;
        "pkg-2.2.1-1.21.3+neoforge" = _uP5myEuF;
        "pkg-2.2.1-1.21.3+fabric" = _7lzORv3S;
        "pkg-2.2.1-1.21+neoforge" = _dEto3UIw;
        "pkg-2.2.1-1.21+fabric" = _p4hd7SIs;
        "pkg-2.2.1-1.20.6+neoforge" = _tNCXBOhY;
        "pkg-2.2.1-1.20.6+fabric" = _mooe81Iw;
        "pkg-2.2.1-1.20.4+neoforge" = _pMTb9sCj;
        "pkg-2.2.1-1.20.4+fabric" = _FRXfo1pl;
        "pkg-2.2.2-1.21.5+neoforge" = _4g0f6cUG;
        "pkg-2.2.2-1.21.5+fabric" = _nTRuqz64;
        "pkg-2.2.2-1.21.4+neoforge" = _B6AsXPuF;
        "pkg-2.2.2-1.21.4+fabric" = _sHn6ruiJ;
        "pkg-2.2.2-1.21.3+neoforge" = _22J6urBd;
        "pkg-2.2.2-1.21.3+fabric" = _lfOW9TfJ;
        "pkg-2.2.2-1.21+neoforge" = _hrmSQ9AD;
        "pkg-2.2.2-1.21+fabric" = _gO8UEXu4;
        "pkg-2.2.2-1.20.6+neoforge" = _Nra0UNph;
        "pkg-2.2.2-1.20.6+fabric" = _vtnSsOIU;
        "pkg-2.2.2-1.20.4+neoforge" = _gk9YHyne;
        "pkg-2.2.2-1.20.4+fabric" = _RvYWJMKo;
        "pkg-2.3.0-1.21.6-pre1+fabric" = _8scmOZPN;
        "pkg-2.3.0-1.21.5+neoforge" = _tMuPZBj8;
        "pkg-2.3.0-1.21.5+fabric" = _TV7mKjf4;
        "pkg-2.3.0-1.21.4+neoforge" = _5SqARemS;
        "pkg-2.3.0-1.21.4+fabric" = _tDSS1ihl;
        "pkg-2.3.0-1.21.3+neoforge" = _MMFC75MY;
        "pkg-2.3.0-1.21.3+fabric" = _Uathp3aZ;
        "pkg-2.3.0-1.21+neoforge" = _zgwUScTt;
        "pkg-2.3.0-1.21+fabric" = _AvUFSVfr;
        "pkg-2.3.0-1.20.6+neoforge" = _yexRiou7;
        "pkg-2.3.0-1.20.6+fabric" = _ZEGcCMQ6;
        "pkg-2.4.0-1.21.6-pre1+fabric" = _1V2xfv7k;
        "pkg-2.4.0-1.21.5+neoforge" = _6zemJGrf;
        "pkg-2.4.0-1.21.5+fabric" = _EzIDL68T;
        "pkg-2.4.0-1.21.4+neoforge" = _Sr5LH1xf;
        "pkg-2.4.0-1.21.4+fabric" = _LUWHBzdW;
        "pkg-2.4.0-1.21.3+neoforge" = _6Dl1wjXv;
        "pkg-2.4.0-1.21.3+fabric" = _1s26VI9o;
        "pkg-2.4.0-1.21+neoforge" = _Ezfn4cX3;
        "pkg-2.4.0-1.21+fabric" = _ZE6NlIHl;
        "pkg-2.4.0-1.20.6+neoforge" = _LlLmaGqC;
        "pkg-2.4.0-1.20.6+fabric" = _nw9mxsc6;
        "pkg-2.5.0-1.21.6+neoforge" = _ww2SAc4c;
        "pkg-2.5.0-1.21.5+neoforge" = _GLGDazw1;
        "pkg-2.5.0-1.21.6+fabric" = _mG9uaIQl;
        "pkg-2.5.0-1.21.5+fabric" = _bmI0cl4J;
        "pkg-2.5.0-1.21.4+neoforge" = _p2n5IEyR;
        "pkg-2.5.0-1.21.4+fabric" = _7Fkr4ioQ;
        "pkg-2.5.0-1.21.3+neoforge" = _Xi3TLbRP;
        "pkg-2.5.0-1.21.3+fabric" = _vrVNwKcz;
        "pkg-2.5.0-1.21+neoforge" = _IpPhBWUw;
        "pkg-2.5.0-1.21+fabric" = _KswkASfe;
        "pkg-2.5.0-1.20.6+neoforge" = _cgdM53JO;
        "pkg-2.5.0-1.20.6+fabric" = _HwrfTDSr;
        "pkg-2.5.1-1.21.6+neoforge" = _38ShB5z2;
        "pkg-2.5.1-1.21.6+fabric" = _NwgIqIn9;
        "pkg-2.5.1-1.21.5+neoforge" = _DpO80MJx;
        "pkg-2.5.1-1.21.5+fabric" = _YXTuXXMl;
        "pkg-2.5.1-1.21.4+neoforge" = _Ad5qumVa;
        "pkg-2.5.1-1.21.4+fabric" = _eGgrjwip;
        "pkg-2.5.1-1.21.3+neoforge" = _YGXJB270;
        "pkg-2.5.1-1.21.3+fabric" = _eBd8PlcF;
        "pkg-2.5.1-1.21+neoforge" = _9O89pFkm;
        "pkg-2.5.1-1.21+fabric" = _by69Diw6;
        "pkg-2.5.1-1.20.6+neoforge" = _gyhLm3if;
        "pkg-2.5.1-1.20.6+fabric" = _qMjpx9w0;
        "pkg-2.5.2-1.20.6+fabric" = _FHBer44P;
        "pkg-2.5.2-1.20.6+neoforge" = _w9e53OJw;
        "pkg-2.5.2-1.21+fabric" = _SzUkaJ6W;
        "pkg-2.5.2-1.21+neoforge" = _1xhAru5Q;
        "pkg-2.5.2-1.21.3+fabric" = _pd6jqljQ;
        "pkg-2.5.2-1.21.3+neoforge" = _1nUTzQXA;
        "pkg-2.5.2-1.21.4+fabric" = _MUNYC08g;
        "pkg-2.5.2-1.21.4+neoforge" = _POXLwQpc;
        "pkg-2.5.2-1.21.5+fabric" = _OP1oXFbd;
        "pkg-2.5.2-1.21.5+neoforge" = _2zDamLFW;
        "pkg-2.5.2-1.21.6+fabric" = _ZrNDgaaj;
        "pkg-2.5.2-1.21.6+neoforge" = _dk5ivBlP;
        "pkg-2.5.3-1.20.6+fabric" = _ehjMiuOZ;
        "pkg-2.5.3-1.20.6+neoforge" = _fEh0XXBC;
        "pkg-2.5.3-1.21+fabric" = _ipRlxLjo;
        "pkg-2.5.3-1.21+neoforge" = _9igNdH1N;
        "pkg-2.5.3-1.21.3+fabric" = _zRtdxyEO;
        "pkg-2.5.3-1.21.3+neoforge" = _X3V83bHu;
        "pkg-2.5.3-1.21.4+fabric" = _h7YMB6dR;
        "pkg-2.5.3-1.21.4+neoforge" = _32HWV6zn;
        "pkg-2.5.3-1.21.5+fabric" = _JtWbGCmt;
        "pkg-2.5.3-1.21.5+neoforge" = _rGY46r3e;
        "pkg-2.5.3-1.21.6+fabric" = _WolO3VKX;
        "pkg-2.5.3-1.21.6+neoforge" = _foZi950z;
        "pkg-2.5.3-1.21.9+fabric" = _a5lPaFNU;
        "pkg-2.5.3-1.21.9+neoforge" = _ZA4mMvVi;
        "pkg-2.5.4-1.20.6+fabric" = _tbPePgdW;
        "pkg-2.5.4-1.20.6+neoforge" = _kFSt1dDM;
        "pkg-2.5.4-1.21+fabric" = _Cy04j9WI;
        "pkg-2.5.4-1.21+neoforge" = _zzoepeDm;
        "pkg-2.5.4-1.21.11+fabric" = _p1YO4wJ6;
        "pkg-2.5.4-1.21.11+neoforge" = _pUkGHDMy;
        "pkg-2.5.4-1.21.3+fabric" = _5BbsD31x;
        "pkg-2.5.4-1.21.3+neoforge" = _Q82Mc8XJ;
        "pkg-2.5.4-1.21.4+fabric" = _aag5Bb66;
        "pkg-2.5.4-1.21.4+neoforge" = _4Nw4y9Zr;
        "pkg-2.5.4-1.21.5+fabric" = _yExt7Ntz;
        "pkg-2.5.4-1.21.5+neoforge" = _ns8Ktu8f;
        "pkg-2.5.4-1.21.6+fabric" = _N8Eoizl6;
        "pkg-2.5.4-1.21.6+neoforge" = _7DcXM1F3;
        "pkg-2.5.4-1.21.9+fabric" = _1I4hZnm8;
        "pkg-2.5.4-1.21.9+neoforge" = _TW3CQMPS;
        "pkg-2.5.5-1.20.6+fabric" = _vqmM3r5P;
        "pkg-2.5.5-1.20.6+neoforge" = _nY0jqzTK;
        "pkg-2.5.5-1.21+fabric" = _yuMdOigy;
        "pkg-2.5.5-1.21+neoforge" = _NvsygXxj;
        "pkg-2.5.5-1.21.11+fabric" = _Ulpvo00K;
        "pkg-2.5.5-1.21.11+neoforge" = _zDSK34Az;
        "pkg-2.5.5-1.21.3+fabric" = _iWFIEtGf;
        "pkg-2.5.5-1.21.3+neoforge" = _b2apDmRk;
        "pkg-2.5.5-1.21.4+fabric" = _2BfD5Lq8;
        "pkg-2.5.5-1.21.4+neoforge" = _Rf8Igmj8;
        "pkg-2.5.5-1.21.5+fabric" = _D9zFkGCJ;
        "pkg-2.5.5-1.21.5+neoforge" = _ELgsV9F3;
        "pkg-2.5.5-1.21.6+fabric" = _7u5dgw6i;
        "pkg-2.5.5-1.21.6+neoforge" = _eF5nNmDD;
        "pkg-2.5.5-1.21.9+fabric" = _AZUu7WjJ;
        "pkg-2.5.5-1.21.9+neoforge" = _1Fo6a7BM;
        "pkg-2.5.5-26.1-pre-3+neoforge" = _VSCWnboU;
        "pkg-2.5.5-26.1-rc-2+fabric" = _whjOIMSk;
        "pkg-2.5.6-26.1+neoforge" = _oPpzKd9I;
        "pkg-2.5.6-26.2-pre-4+neoforge" = _rJguv2yL;
        "pkg-2.5.6-26.2-pre-4+fabric" = _k6wXR8B0;
        "pkg-2.5.6-26.1+fabric" = _3NWP2hsU;
        "pkg-2.6.0-26.1+fabric" = _GJ7arctQ;
        "pkg-2.6.0-26.1+neoforge" = _C5tqtIwj;
        "pkg-2.6.0-26.2-pre-4+fabric" = _c8CVN5yE;
        "pkg-2.6.0-26.2-pre-4+neoforge" = _deV2noql;
        "pkg-2.6.0-26.3+fabric" = _3y6QyHZG;
        "pkg-2.6.1-26.1+fabric" = _c1K9yhrc;
        "pkg-2.6.1-26.1+neoforge" = _I1uViqcb;
        "pkg-2.6.1-26.2-pre-4+fabric" = _mIctyTrs;
        "pkg-2.6.1-26.2-pre-4+neoforge" = _7PDkbsiF;
        "pkg-2.6.1-26.3+fabric" = _aCD72uEY;
        "pkg-2.6.1-26.3+neoforge" = _PdImqYly;
        "default" = _PdImqYly;
    });
