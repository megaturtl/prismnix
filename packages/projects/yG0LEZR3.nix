...
let
    versions = (let
        ...
        _ErhgHLSX = {
            "id" = "ErhgHLSX";
            "file" = "DeathKick_v2.jar";
            "hash" = "sha512-cbUsSsmL7pUW/JQC3YMy/HMCcF4JOmU0C0T3stn5jGXeiQifaswUZgmvW9mEunIsOduQX3juuuLG/H6SZzFUXw==";
        };
    in {
        "XnKQTKok" = _XnKQTKok;
        "HnA23tdu" = _HnA23tdu;
        ...
        "paper-26.1" = _ErhgHLSX;
        "paper-26.1.1" = _ErhgHLSX;
        "paper-26.1.2" = _ErhgHLSX;
        "paper-26.2" = _ErhgHLSX;
        ...
        "bukkit-26.1" = _ErhgHLSX;
        "bukkit-26.1.1" = _ErhgHLSX;
        "bukkit-26.1.2" = _ErhgHLSX;
        "bukkit-26.2" = _ErhgHLSX;
        ...
        "spigot-26.1" = _ErhgHLSX;
        "spigot-26.1.1" = _ErhgHLSX;
        "spigot-26.1.2" = _ErhgHLSX;
        "spigot-26.2" = _ErhgHLSX;
        "pkg-1.5" = _XnKQTKok;
        "pkg-1.8" = _HnA23tdu;
        "pkg-1.9" = _CISaxBkx;
        "pkg-2.0" = _ErhgHLSX;
