...
let
    ...
    in {
        ...
        "pkg-1.0" = _dW7l6DtQ;
        "pkg-1.0-1.20.6+" = _ZMbb5nBe;
        "pkg-1.1" = _x4YQAUY0;
        "pkg-1.1-OVERHAUL" = _nHwkGbRn;
        "pkg-1.1-OVERHAUL+1.12.2-forge" = _EMNiWwYO;
        "pkg-1.1-OVERHAUL+1.14.4-fabric" = _qqxH6sFn;
        "pkg-1.1-OVERHAUL+1.15-fabric" = _DK82zedp;
        "pkg-1.1-OVERHAUL+1.15.1-fabric" = _UiPWyRNS;
        "pkg-1.1-OVERHAUL+1.15.2-fabric" = _thxIPN4h;
        "pkg-1.1-OVERHAUL+1.16-fabric" = _1HWxOy8j;
        "pkg-1.1-OVERHAUL+1.16.1-fabric" = _fQ6LMiIk;
        "pkg-1.1-OVERHAUL+1.16.2-fabric" = _IPlJ1WWQ;
        "pkg-1.1-OVERHAUL+1.16.3-fabric" = _Lgz6vJ2N;
        "pkg-1.1-OVERHAUL+1.16.4-fabric" = _W1gIl06N;
        "pkg-1.1-OVERHAUL+1.16.5-fabric" = _G5mRyTAm;
        "pkg-1.1-OVERHAUL+1.17-fabric" = _nBJpq5K3;
        "pkg-1.1-OVERHAUL+1.17.1-fabric" = _7gzSKpL9;
        "pkg-1.1-OVERHAUL+1.17.1-forge" = _Ne9egGhu;
        "pkg-1.1-OVERHAUL+1.18-fabric" = _u89pRiPF;
        "pkg-1.1-OVERHAUL+1.18-forge" = _1eo1O9wY;
        "pkg-1.1-OVERHAUL+1.18.1-fabric" = _IOmGeglr;
        "pkg-1.1-OVERHAUL+1.18.1-forge" = _5cj9Q2Wn;
        "pkg-1.1-OVERHAUL+1.18.2-fabric" = _iI4iJ0rR;
        "pkg-1.1-OVERHAUL+1.18.2-forge" = _IXQsqbip;
        "pkg-1.1-OVERHAUL+1.19-fabric" = _FHCgmHWM;
        "pkg-1.1-OVERHAUL+1.19-forge" = _y2Y5YOpQ;
        "pkg-1.1-OVERHAUL+1.19.1-fabric" = _dz87yJUH;
        "pkg-1.1-OVERHAUL+1.19.1-forge" = _Yj0U2OcH;
        "pkg-1.1-OVERHAUL+1.19.2-fabric" = _V9kG936k;
        "pkg-1.1-OVERHAUL+1.19.2-forge" = _FztzBFJ8;
        "pkg-1.1-OVERHAUL+1.19.3-fabric" = _lcpaPGNJ;
        "pkg-1.1-OVERHAUL+1.19.3-forge" = _KrGxW4JU;
        "pkg-1.1-OVERHAUL+1.19.4-fabric" = _n26W2cXD;
        "pkg-1.1-OVERHAUL+1.19.4-forge" = _PfB9ZVFo;
        "pkg-1.1-OVERHAUL+1.20-fabric" = _6TXwp7zf;
        "pkg-1.1-OVERHAUL+1.20-forge" = _1W1OV06q;
        "pkg-1.1-OVERHAUL+1.20.2-forge" = _ckuUCNN6;
        "pkg-1.1-OVERHAUL+1.20.3-forge" = _7auQ8EY1;
        "pkg-1.1-OVERHAUL+1.20.4-forge" = _K0xAhQsQ;
        "pkg-1.1-OVERHAUL+1.21.1-forge" = _1nMOA6C0;
        "pkg-1.1-OVERHAUL+1.20.1-fabric" = _PKYRVebO;
        "pkg-1.1-OVERHAUL+1.20.1-forge" = _3i7rn6G3;
        "pkg-1.1-OVERHAUL+1.20.1-quilt" = _tRu70CR5;
        "pkg-1.1-OVERHAUL+1.20.2-fabric" = _jL5dM5Dz;
        "pkg-1.1-OVERHAUL+1.20.3-fabric" = _fZ2mQBtd;
        "pkg-1.1-OVERHAUL+1.20.4-fabric" = _GxMpZW37;
        "pkg-1.1-OVERHAUL+1.20.4-neoforge" = _roPyHAvT;
        "pkg-1.1-OVERHAUL+1.20.4-quilt" = _nhT0oA2P;
        "pkg-1.1-OVERHAUL+1.20.5-fabric" = _pi4eflAw;
        "pkg-1.1-OVERHAUL+1.20.6-fabric" = _n1qgM1Dd;
        "pkg-1.1-OVERHAUL+1.20.6-forge" = _s5bpeyJ9;
        "pkg-1.1-OVERHAUL+1.21-fabric" = _MSCNliA4;
        "pkg-1.1-OVERHAUL+1.21-forge" = _DcRjR6lx;
        "pkg-1.1-OVERHAUL+1.21.1-fabric" = _vNoRs2st;
        "pkg-1.1-OVERHAUL+1.21.1-neoforge" = _BJfBwKQn;
        "pkg-1.1-OVERHAUL+1.21.1-quilt" = _5z8ic2sZ;
        "pkg-1.1-OVERHAUL+1.21.10-fabric" = _fFfXBu8m;
        "pkg-1.1-OVERHAUL+1.21.10-forge" = _AHsIJjq2;
        "pkg-1.1-OVERHAUL+1.21.10-neoforge" = _HLGtjvPk;
        "pkg-1.1-OVERHAUL+1.21.10-quilt" = _KKp070HA;
        "pkg-1.1-OVERHAUL+1.21.11-fabric" = _H1gyiWMf;
        "pkg-1.1-OVERHAUL+1.21.11-forge" = _VjRLiRSk;
        "pkg-1.1-OVERHAUL+1.21.11-neoforge" = _WJBSEsuM;
        "pkg-1.1-OVERHAUL+1.21.11-quilt" = _HmZljzpc;
        "pkg-1.1-OVERHAUL+1.21.2-fabric" = _8QQaAw1L;
        "pkg-1.1-OVERHAUL+1.21.2-neoforge" = _zOtZuoVn;
        "pkg-1.1-OVERHAUL+1.21.2-quilt" = _qgdwpI9y;
        "pkg-1.1-OVERHAUL+1.21.3-fabric" = _tUWp1J0L;
        "pkg-1.1-OVERHAUL+1.21.3-forge" = _LqaAEftZ;
        "pkg-1.1-OVERHAUL+1.21.3-neoforge" = _ZQjEE7ZY;
        "pkg-1.1-OVERHAUL+1.21.3-quilt" = _HyHvwicy;
        "pkg-1.1-OVERHAUL+1.21.4-fabric" = _fHpGrzuk;
        "pkg-1.1-OVERHAUL+1.21.4-forge" = _WvZNceG4;
        "pkg-1.1-OVERHAUL+1.21.4-neoforge" = _OWpybIPQ;
        "pkg-1.1-OVERHAUL+1.21.4-quilt" = _L5WNXBQV;
        "pkg-1.1-OVERHAUL+1.21.5-fabric" = _OSnysk4y;
        "pkg-1.1-OVERHAUL+1.21.5-forge" = _HLYOAqln;
        "pkg-1.1-OVERHAUL+1.21.5-neoforge" = _3W0sYB1w;
        "pkg-1.1-OVERHAUL+1.21.5-quilt" = _xNc8RrI3;
        "pkg-1.1-OVERHAUL+1.21.6-fabric" = _N4vyPnR3;
        "pkg-1.1-OVERHAUL+1.21.6-forge" = _Xj0QcCkS;
        "pkg-1.1-OVERHAUL+1.21.6-neoforge" = _JcVA383R;
        "pkg-1.1-OVERHAUL+1.21.6-quilt" = _ncrw3nrr;
        "pkg-1.1-OVERHAUL+1.21.7-fabric" = _2cruDDxz;
        "pkg-1.1-OVERHAUL+1.21.7-forge" = _BS9lz1Zf;
        "pkg-1.1-OVERHAUL+1.21.7-neoforge" = _w9Ovm6M8;
        "pkg-1.1-OVERHAUL+1.21.7-quilt" = _ZE6XNNHo;
        "pkg-1.1-OVERHAUL+1.21.8-fabric" = _XNceUYwQ;
        "pkg-1.1-OVERHAUL+1.21.8-forge" = _qDK4d3JA;
        "pkg-1.1-OVERHAUL+1.21.8-neoforge" = _t3ghzTJ6;
        "pkg-1.1-OVERHAUL+1.21.8-quilt" = _f3IOKLdQ;
        "pkg-1.1-OVERHAUL+1.21.9-fabric" = _sNazDxI5;
        "pkg-1.1-OVERHAUL+1.21.9-forge" = _IbZJccKZ;
        "pkg-1.1-OVERHAUL+1.21.9-neoforge" = _YlP6Ylof;
        "pkg-1.1-OVERHAUL+1.21.9-quilt" = _MMTktQgJ;
        "pkg-1.1-OVERHAUL+26.1-fabric" = _hwvZx6H1;
        "pkg-1.1-OVERHAUL+26.1-neoforge" = _5Q45vRiB;
        "pkg-1.1-OVERHAUL+26.1-quilt" = _AlwpLFAX;
        "pkg-1.1-OVERHAUL+26.1.1-fabric" = _nox4ngGq;
        "pkg-1.1-OVERHAUL+26.1.1-forge" = _cjBHH3Q4;
        "pkg-1.1-OVERHAUL+26.1.1-neoforge" = _jBNseOXm;
        "pkg-1.1-OVERHAUL+26.1.1-quilt" = _uFCaQSww;
        "pkg-1.1-OVERHAUL+26.1.2-fabric" = _UWFVmdCr;
        "pkg-1.1-OVERHAUL+26.1.2-forge" = _jXF8EDt2;
        "pkg-1.1-OVERHAUL+26.1.2-neoforge" = _DoyEoJvH;
        "pkg-1.1-OVERHAUL+26.1.2-quilt" = _c8v801zs;
        "pkg-1.1-OVERHAUL+26.2-fabric" = _iLENV8zG;
        "pkg-1.1-OVERHAUL+26.2-forge" = _r3pKcMha;
        "pkg-1.1-OVERHAUL+26.2-neoforge" = _4bMnLQEa;
        "pkg-1.1-OVERHAUL+26.2-quilt" = _F7oP4H7k;
        "pkg-1.2-OVERHAUL+1.10-forge" = _6fXr8ABj;
        "pkg-1.2-OVERHAUL+1.10.2-forge" = _DWvtO16v;
        "pkg-1.2-OVERHAUL+1.11-forge" = _uWdU13IE;
        "pkg-1.2-OVERHAUL+1.11.2-forge" = _PmhylGUa;
        "pkg-1.2-OVERHAUL+1.12-forge" = _PYOL8k0D;
        "pkg-1.2-OVERHAUL+1.12.1-forge" = _kGKU7n61;
        "pkg-1.2-OVERHAUL+1.12.2-forge" = _ahMOzkEA;
        "pkg-1.2-OVERHAUL+1.12.2-liteloader" = _rDCKd9zl;
        "pkg-1.2-OVERHAUL+1.14.4-fabric" = _KdehQu2R;
        "pkg-1.2-OVERHAUL+1.15-fabric" = _R0h9bd2d;
        "pkg-1.2-OVERHAUL+1.15-forge" = _S7mGGjOl;
        "pkg-1.2-OVERHAUL+1.15.1-fabric" = _rTSdvsCf;
        "pkg-1.2-OVERHAUL+1.15.1-forge" = _t8b27Ghe;
        "pkg-1.2-OVERHAUL+1.15.2-fabric" = _3wYGhgzv;
        "pkg-1.2-OVERHAUL+1.15.2-forge" = _VstHOQaU;
        "pkg-1.2-OVERHAUL+1.16-fabric" = _WPZkqD25;
        "pkg-1.2-OVERHAUL+1.16.1-fabric" = _YtFyUatJ;
        "pkg-1.2-OVERHAUL+1.16.2-fabric" = _ii1jy3f2;
        "pkg-1.2-OVERHAUL+1.16.2-forge" = _E3pZy4fs;
        "pkg-1.2-OVERHAUL+1.16.3-fabric" = _6PiBqJZl;
        "pkg-1.2-OVERHAUL+1.16.3-forge" = _FOJ9bHnh;
        "pkg-1.2-OVERHAUL+1.16.4-fabric" = _iPrGnQpv;
        "pkg-1.2-OVERHAUL+1.16.4-forge" = _ngkILiMQ;
        "pkg-1.2-OVERHAUL+1.16.5-fabric" = _LrDqW24m;
        "pkg-1.2-OVERHAUL+1.16.5-forge" = _dx1b7xCy;
        "pkg-1.2-OVERHAUL+1.17-fabric" = _UnjxCj27;
        "pkg-1.2-OVERHAUL+1.17.1-fabric" = _KasvoQqr;
        "pkg-1.2-OVERHAUL+1.17.1-forge" = _5ncMIkdb;
        "pkg-1.2-OVERHAUL+1.18-fabric" = _yE0LF5sI;
        "pkg-1.2-OVERHAUL+1.18-forge" = _lR8RwpUg;
        "pkg-1.2-OVERHAUL+1.18.1-fabric" = _a9tgv8kb;
        "pkg-1.2-OVERHAUL+1.18.1-forge" = _8Z0fU9AO;
        "pkg-1.2-OVERHAUL+1.18.2-fabric" = _Rra9WnPl;
        "pkg-1.2-OVERHAUL+1.18.2-forge" = _82w9v0A4;
        "pkg-1.2-OVERHAUL+1.19-fabric" = _Oni0vKC5;
        "pkg-1.2-OVERHAUL+1.19-forge" = _yAYPKG1g;
        "pkg-1.2-OVERHAUL+1.19.1-fabric" = _muTANczK;
        "pkg-1.2-OVERHAUL+1.19.1-forge" = _Ve0822he;
        "pkg-1.2-OVERHAUL+1.19.2-fabric" = _EtJXZQc7;
        "pkg-1.2-OVERHAUL+1.19.2-forge" = _i5AxkhG2;
        "pkg-1.2-OVERHAUL+1.19.3-fabric" = _CikA8VZU;
        "pkg-1.2-OVERHAUL+1.19.3-forge" = _sYJthL0q;
        "pkg-1.2-OVERHAUL+1.19.4-fabric" = _Im3WdAH6;
        "pkg-1.2-OVERHAUL+1.19.4-forge" = _vaP3Fcar;
        "pkg-1.2-OVERHAUL+1.20-fabric" = _V2CUa0sJ;
        "pkg-1.2-OVERHAUL+1.20-forge" = _MetOP97X;
        "pkg-1.2-OVERHAUL+1.20.1-fabric" = _w0A9YT7M;
        "pkg-1.2-OVERHAUL+1.20.1-forge" = _Rcsq7AEu;
        "pkg-1.2-OVERHAUL+1.20.1-quilt" = _jakjQF8S;
        "pkg-1.2-OVERHAUL+1.20.2-fabric" = _dui8V3Zr;
        "pkg-1.2-OVERHAUL+1.20.2-forge" = _4xmijDum;
        "pkg-1.2-OVERHAUL+1.20.3-fabric" = _PME4hi2w;
        "pkg-1.2-OVERHAUL+1.20.3-forge" = _o27a7C6H;
        "pkg-1.2-OVERHAUL+1.20.4-fabric" = _zHIlAzec;
        "pkg-1.2-OVERHAUL+1.20.4-forge" = _huwW2js0;
        "pkg-1.2-OVERHAUL+1.20.4-neoforge" = _GXRDf8Ic;
        "pkg-1.2-OVERHAUL+1.20.4-quilt" = _pZpe45Fq;
        "pkg-1.2-OVERHAUL+1.20.5-fabric" = _vdO9mxeI;
        "pkg-1.2-OVERHAUL+1.20.6-fabric" = _JryI62wQ;
        "pkg-1.2-OVERHAUL+1.20.6-forge" = _6Uc5lixQ;
        "pkg-1.2-OVERHAUL+1.21-fabric" = _qVupSXsY;
        "pkg-1.2-OVERHAUL+1.21-forge" = _EFo86YBa;
        "pkg-1.2-OVERHAUL+1.21.1-fabric" = _8IVweItE;
        "pkg-1.2-OVERHAUL+1.21.1-forge" = _WsYl0LwG;
        "pkg-1.2-OVERHAUL+1.21.1-neoforge" = _BnnlX11f;
        "pkg-1.2-OVERHAUL+1.21.1-quilt" = _L7hPGhPF;
        "pkg-1.2-OVERHAUL+1.21.10-fabric" = _DII5Kt66;
        "pkg-1.2-OVERHAUL+1.21.10-forge" = _JbPEjrKF;
        "pkg-1.2-OVERHAUL+1.21.10-neoforge" = _kiMZjLfp;
        "pkg-1.2-OVERHAUL+1.21.10-quilt" = _105gXI72;
        "pkg-1.2-OVERHAUL+1.21.11-fabric" = _x8UGIyFd;
        "pkg-1.2-OVERHAUL+1.21.11-forge" = _yTCW3Lgg;
        "pkg-1.2-OVERHAUL+1.21.11-neoforge" = _nn32eVnd;
        "pkg-1.2-OVERHAUL+1.21.11-quilt" = _doGe1Tb2;
        "pkg-1.2-OVERHAUL+1.21.2-fabric" = _3ou2o0yZ;
        "pkg-1.2-OVERHAUL+1.21.2-neoforge" = _ySxk0dax;
        "pkg-1.2-OVERHAUL+1.21.2-quilt" = _A4p8L4PM;
        "pkg-1.2-OVERHAUL+1.21.3-fabric" = _HZOtTlsF;
        "pkg-1.2-OVERHAUL+1.21.3-forge" = _hVQqXatI;
        "pkg-1.2-OVERHAUL+1.21.3-neoforge" = _TME24qUp;
        "pkg-1.2-OVERHAUL+1.21.3-quilt" = _JmIuTLuM;
        "pkg-1.2-OVERHAUL+1.21.4-fabric" = _mZXgQzVe;
        "pkg-1.2-OVERHAUL+1.21.4-forge" = _TC2x9CHV;
        "pkg-1.2-OVERHAUL+1.21.4-neoforge" = _s01To6tl;
        "pkg-1.2-OVERHAUL+1.21.4-quilt" = _htywusDT;
        "pkg-1.2-OVERHAUL+1.21.5-fabric" = _KrEi38zY;
        "pkg-1.2-OVERHAUL+1.21.5-forge" = _oHEwotWg;
        "pkg-1.2-OVERHAUL+1.21.5-neoforge" = _TU6bOoTM;
        "pkg-1.2-OVERHAUL+1.21.5-quilt" = _tsgDdRmn;
        "pkg-1.2-OVERHAUL+1.21.6-fabric" = _SAQDr6Yn;
        "pkg-1.2-OVERHAUL+1.21.6-forge" = _1MXIBXK6;
        "pkg-1.2-OVERHAUL+1.21.6-neoforge" = _nUl3UdKZ;
        "pkg-1.2-OVERHAUL+1.21.6-quilt" = _g0Tgty1e;
        "pkg-1.2-OVERHAUL+1.21.7-fabric" = _kscpdNfm;
        "pkg-1.2-OVERHAUL+1.21.7-forge" = _SR9O1ktx;
        "pkg-1.2-OVERHAUL+1.21.7-neoforge" = _zwlNN24F;
        "pkg-1.2-OVERHAUL+1.21.7-quilt" = _qU34NUmV;
        "pkg-1.2-OVERHAUL+1.21.8-fabric" = _WOrUG0Uw;
        "pkg-1.2-OVERHAUL+1.21.8-forge" = _zEpi6E98;
        "pkg-1.2-OVERHAUL+1.21.8-neoforge" = _FlpMGRqB;
        "pkg-1.2-OVERHAUL+1.21.8-quilt" = _5h3tre5F;
        "pkg-1.2-OVERHAUL+1.21.9-fabric" = _ZdsSByMF;
        "pkg-1.2-OVERHAUL+1.21.9-forge" = _Xk4uU1Sd;
        "pkg-1.2-OVERHAUL+1.21.9-neoforge" = _kwN1UCGZ;
        "pkg-1.2-OVERHAUL+1.21.9-quilt" = _BmkByyMe;
        "pkg-1.2-OVERHAUL+1.8-forge" = _nTxOBmqk;
        "pkg-1.2-OVERHAUL+1.8.8-forge" = _QXHyjZJ2;
        "pkg-1.2-OVERHAUL+1.8.9-forge" = _TVbFtiXI;
        "pkg-1.2-OVERHAUL+1.9-forge" = _9Q4L8MZw;
        "pkg-1.2-OVERHAUL+1.9.4-forge" = _jJOVb5Bn;
        "pkg-1.2-OVERHAUL+26.1-fabric" = _TSpf5Tkw;
        "pkg-1.2-OVERHAUL+26.1-neoforge" = _t3kyUgs2;
        "pkg-1.2-OVERHAUL+26.1-quilt" = _lmDh6x3F;
        "pkg-1.2-OVERHAUL+26.1.1-fabric" = _c1cC07iK;
        "pkg-1.2-OVERHAUL+26.1.1-forge" = _7F2F7bYu;
        "pkg-1.2-OVERHAUL+26.1.1-neoforge" = _tNHVBCyq;
        "pkg-1.2-OVERHAUL+26.1.1-quilt" = _oy9R8Ujz;
        "pkg-1.2-OVERHAUL+26.1.2-fabric" = _Oa0JOWKS;
        "pkg-1.2-OVERHAUL+26.1.2-forge" = _JFbfxCNj;
        "pkg-1.2-OVERHAUL+26.1.2-neoforge" = _B9bL2Vr2;
        "pkg-1.2-OVERHAUL+26.1.2-quilt" = _8BIf8Qvo;
        "pkg-1.2-OVERHAUL+26.2-fabric" = _drhKBJtc;
        "pkg-1.2-OVERHAUL+26.2-forge" = _Dqxa7MNK;
        "pkg-1.2-OVERHAUL+26.2-neoforge" = _XwAEyn4O;
        "pkg-1.2-OVERHAUL+26.2-quilt" = _ANXUbGAR;
        "pkg-1.2-OVERHAUL+1.14.4-forge" = _sQF3jHxI;
        "pkg-1.2-OVERHAUL+1.4.7-legacyfabric" = _ERVpdZIj;
        "pkg-1.2-OVERHAUL+1.3.2-legacyfabric" = _mqFHrMcF;
        "pkg-1.2-OVERHAUL+1.8.9-legacyfabric" = _qfKvxuW0;
        "pkg-1.2-OVERHAUL+1.7.10-legacyfabric" = _h5PgtSB7;
        "pkg-1.2-OVERHAUL+1.5.2-legacyfabric" = _dukvIIVZ;
        "pkg-1.2-OVERHAUL+1.6.4-legacyfabric" = _6xG8YxdW;
        "pkg-1.2-OVERHAUL+1.10.2-legacyfabric" = _cQDtkBiN;
        "pkg-1.2-OVERHAUL+1.12.2-legacyfabric" = _Nwe81G7K;
        "pkg-1.2-OVERHAUL+1.13.2-legacyfabric" = _NntH12M7;
        "pkg-1.2-OVERHAUL+1.11.2-legacyfabric" = _aZ7fXAuY;
        "pkg-1.2-OVERHAUL+1.3.1-legacyfabric" = _hRDmjR1m;
        "pkg-1.2-OVERHAUL+1.4.2-legacyfabric" = _gu3VM0O5;
        "pkg-1.2-OVERHAUL+1.4.4-legacyfabric" = _M8qMMxFU;
        "pkg-1.2-OVERHAUL+1.4.5-legacyfabric" = _ZyAoG55W;
        "pkg-1.2-OVERHAUL+1.4.6-legacyfabric" = _60EHYYk8;
        "pkg-1.2-OVERHAUL+1.5.1-legacyfabric" = _rBvmKHjF;
        "pkg-1.2-OVERHAUL+1.6.1-legacyfabric" = _WmBRXQQy;
        "pkg-1.2-OVERHAUL+1.6.2-legacyfabric" = _Ir9zrtzZ;
        "pkg-1.2-OVERHAUL+1.7.2-legacyfabric" = _aPbyoZ9P;
        "pkg-1.2-OVERHAUL+1.7.3-legacyfabric" = _PtzHVEZm;
        "pkg-1.2-OVERHAUL+1.7.4-legacyfabric" = _HM1K6Wqz;
        "pkg-1.2-OVERHAUL+1.7.5-legacyfabric" = _gGoF50ZV;
        "pkg-1.2-OVERHAUL+1.7.6-legacyfabric" = _RmVojNEl;
        "pkg-1.2-OVERHAUL+1.7.7-legacyfabric" = _BeX9MfiJ;
        "pkg-1.2-OVERHAUL+1.7.8-legacyfabric" = _pzyELrzJ;
        "pkg-1.2-OVERHAUL+1.8-legacyfabric" = _tJcqvugw;
        "pkg-1.2-OVERHAUL+1.8.1-legacyfabric" = _RrY9kFQs;
        "pkg-1.2-OVERHAUL+1.8.2-legacyfabric" = _2S93I7TZ;
        "pkg-1.2-OVERHAUL+1.8.3-legacyfabric" = _vHPD4T1q;
        "pkg-1.2-OVERHAUL+1.8.4-legacyfabric" = _hqrllvtS;
        "pkg-1.2-OVERHAUL+1.8.5-legacyfabric" = _Jm98jTIa;
        "pkg-1.2-OVERHAUL+1.8.6-legacyfabric" = _i6tggUPu;
