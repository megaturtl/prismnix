...
let
    versions = (let
        ...
        _VeQrqSh7 = {
            "id" = "VeQrqSh7";
            "file" = "emberstextapi-fabric-1.21.1-3.0.4.jar";
            "hash" = "sha512-zn5F3GPUS/V/ND8VsjIgJjRdoenB8NtizToXs8WQFnC4iDtQNpgP8QsVzjZobJ089NW4x45DqMF9ZYrR4SUf8Q==";
        };
        _1ZhzA4Ka = {
            "id" = "1ZhzA4Ka";
            "file" = "emberstextapi-fabric-1.20.1-3.0.4.jar";
            "hash" = "sha512-GcDML50Y0UXExxZ8M/oZyVwxztj+sQFQ/yR9TlZdyKU0/t76FDknFnvjoMtwG1m4BGIzg2CDSZ1Ubh+j3Qj1iQ==";
        };
        _k1oNBSSj = {
            "id" = "k1oNBSSj";
            "file" = "emberstextapi-fabric-26.1-3.0.4.jar";
            "hash" = "sha512-wXVpCqa4moKYV9ZNpAPJkTPK69mvZeWhJ0SwWSg6tJyoB3TxInX4vIa5puuDw920wzyq/AReTnoniovUyQQ0Dw==";
        };
        _XGTJTFLz = {
            "id" = "XGTJTFLz";
            "file" = "emberstextapi-fabric-26.2-3.0.4.jar";
            "hash" = "sha512-mrUTzNJklPS22aj3KjWbQAYjd3NRwhaI/MNJCz58EJTrTAHblMn6k++vJ0cXZLfg4Omnc1L9uyVhDhjb0qshhw==";
        };
        _IpL9hTnI = {
            "id" = "IpL9hTnI";
            "file" = "emberstextapi-neoforge-1.21.1-3.0.4.jar";
            "hash" = "sha512-59sTWyq8QuGXyiUccmDf0P7/IRjOOj6KZWyNI1ZRrYu0lw4QtkC4531AyuH4z118dC2gUXY5Z40KvvSzIotxtA==";
        };
        _Db83p6w6 = {
            "id" = "Db83p6w6";
            "file" = "emberstextapi-neoforge-26.1-3.0.4.jar";
            "hash" = "sha512-e0wzH+RfljW2+ChqhiVAdEF0M6jnF21RYUz1eFMul7FPSEHVg9MarnZHRWnScsuIK7hd3sjGyeUW979seWTyCg==";
        };
        _1VCfp0Og = {
            "id" = "1VCfp0Og";
            "file" = "emberstextapi-neoforge-26.2-3.0.4.jar";
            "hash" = "sha512-WzeJJsPaH8qBmu39SGMmvAS4D4Nfy2K2SELDLd5fhC+4zSy7pSa2mGmWn4LUUVBM6VhW99+K+0jgzU0Cm7Bi3Q==";
        };
        _XEnMrO48 = {
            "id" = "XEnMrO48";
            "file" = "emberstextapi-forge-1.20.1-3.0.4-all.jar";
            "hash" = "sha512-421jjszjPaknWkpubtRw/J8cpGwh7DNesvfXTZxR/RItWepgOcYgghSUek4TVVmV2cXNK7JvPVJC4VuimnIGVA==";
        };
    in {
        "Zorq4JMS" = _Zorq4JMS;
        "wfrMW6Y7" = _wfrMW6Y7;
        ...
        "1VCfp0Og" = _1VCfp0Og;
        "XEnMrO48" = _XEnMrO48;
        "forge-1.20.1" = _XEnMrO48;
        "neoforge-1.21.1" = _IpL9hTnI;
        "neoforge-26.1" = _Db83p6w6;
        "neoforge-26.1.1" = _Db83p6w6;
        "neoforge-26.1.2" = _Db83p6w6;
        "neoforge-26.2" = _1VCfp0Og;
        "fabric-1.20.1" = _1ZhzA4Ka;
        "fabric-1.21.1" = _VeQrqSh7;
        "fabric-26.1" = _k1oNBSSj;
        "fabric-26.1.1" = _k1oNBSSj;
        "fabric-26.1.2" = _k1oNBSSj;
        "fabric-26.2" = _XGTJTFLz;
        "pkg-2.1.0+forge-1.20.1" = _Zorq4JMS;
        "pkg-2.1.0+neoforge-1.21.1" = _wfrMW6Y7;
        "pkg-2.1.0+fabric-1.20.1" = _Fl5RyoFP;
        "pkg-2.1.0+fabric-1.21.1" = _VN0dHAEZ;
        "pkg-2.2.0+neoforge-1.21.1" = _HSMjm39t;
        "pkg-2.2.0+fabric-1.20.1" = _OiYSwDqk;
        "pkg-2.2.0+fabric-1.21.1" = _NMSvSY0d;
        "pkg-2.2.0+forge-1.20.1" = _aMmp6iTd;
        "pkg-2.3.0+fabric-1.21.1" = _iRx5MqHr;
        "pkg-2.3.0+forge-1.20.1" = _fFpPhEtt;
        "pkg-2.3.0+neoforge-1.21.1" = _vS3DkaYQ;
        "pkg-2.3.0+fabric-1.20.1" = _UKleGmcR;
        "pkg-2.4.0+neoforge-1.21.1" = _fjYw85FK;
        "pkg-2.4.0+fabric-1.21.1" = _YjimYLsV;
        "pkg-2.4.0+forge-1.20.1" = _Jxs1I9Ay;
        "pkg-2.4.0+fabric-1.20.1" = _bq5K7jL4;
        "pkg-2.5.0+neoforge-1.21.1" = _cCQbC0bn;
        "pkg-2.5.0+fabric-1.20.1" = _LSAhCaDe;
        "pkg-2.5.0+fabric-1.21.1" = _sNWGzoDW;
        "pkg-2.5.0+forge-1.20.1" = _4qWqBgJy;
        "pkg-2.6.0+fabric-1.20.1" = _FOte3VmN;
        "pkg-2.6.0+neoforge-1.21.1" = _uR1iyLqw;
        "pkg-2.6.0+fabric-1.21.1" = _EQueYrfU;
        "pkg-2.6.0+forge-1.20.1" = _eORNUqSv;
        "pkg-2.6.1+neoforge-1.21.1" = _DBzTkgdK;
        "pkg-2.6.1+fabric-1.20.1" = _twotZiaI;
        "pkg-2.6.1+fabric-1.21.1" = _pWavWtBV;
        "pkg-2.6.1+forge-1.20.1" = _LHW0KocW;
        "pkg-2.7.0+fabric-1.21.1" = _cstGMsK0;
        "pkg-2.7.0+fabric-1.20.1" = _QxTnEVSd;
        "pkg-2.7.0+neoforge-1.21.1" = _AC27pfzz;
        "pkg-2.7.0+forge-1.20.1" = _3PwUrxFK;
        "pkg-2.7.1+neoforge-1.21.1" = _NmheKXaW;
        "pkg-2.7.1+forge-1.20.1" = _CbnyroeL;
        "pkg-2.7.1+fabric-1.20.1" = _lpS8BGkd;
        "pkg-2.7.1+fabric-1.21.1" = _7Pt0soRw;
        "pkg-2.8.0+fabric-1.20.1" = _GhY84f2x;
        "pkg-2.8.0+neoforge-1.21.1" = _oLh2VZOp;
        "pkg-2.8.0+forge-1.20.1" = _7ysxCqjN;
        "pkg-2.8.0+fabric-1.21.1" = _OEquQnIH;
        "pkg-2.8.1+neoforge-1.21.1" = _e4Xl8agA;
        "pkg-2.8.1+fabric-1.20.1" = _egU4YGy0;
        "pkg-2.8.1+forge-1.20.1" = _PhuFPgFb;
        "pkg-2.8.1+fabric-1.21.1" = _ljtQ131D;
        "pkg-2.8.2+neoforge-1.21.1" = _T00dKF3G;
        "pkg-2.8.2+forge-1.20.1" = _yvElmhD0;
        "pkg-2.8.2+fabric-1.20.1" = _MRVTgSJR;
        "pkg-2.8.2+fabric-1.21.1" = _p8Ecc60O;
        "pkg-2.9.0+forge-1.20.1" = _ekcaWcuF;
        "pkg-2.9.0+fabric-1.21.1" = _4YeHYQnU;
        "pkg-2.9.0+neoforge-1.21.1" = _M7If1SYF;
        "pkg-2.9.0+fabric-1.20.1" = _LWI2XVW5;
        "pkg-2.9.1+forge-1.20.1" = _Aa9qom9O;
        "pkg-2.9.1+fabric-1.20.1" = _LPMZRarS;
        "pkg-2.9.1+neoforge-1.21.1" = _7dq9fFmF;
        "pkg-2.9.2+neoforge-1.21.1" = _jwzz2o9d;
        "pkg-2.9.2+fabric-1.20.1" = _g5U7n3SW;
        "pkg-2.9.2+fabric-1.21.1" = _7d2xkjTz;
        "pkg-2.9.2+forge-1.20.1" = _xAuSvzck;
        "pkg-2.9.3+neoforge-1.21.1" = _Ow6eskHO;
        "pkg-2.9.3+fabric-1.21.1" = _kzRJ5WwQ;
        "pkg-2.9.3+forge-1.20.1" = _skIcM4WP;
        "pkg-2.9.3+fabric-1.20.1" = _UA2N92uW;
        "pkg-2.9.4+fabric-1.20.1" = _5KqmdE1Q;
        "pkg-2.9.4+neoforge-1.21.1" = _fW18v6zs;
        "pkg-2.9.4+fabric-1.21.1" = _tR9fADLu;
        "pkg-2.9.4+forge-1.20.1" = _NXTLenAo;
        "pkg-3.0.0-alpha.1+fabric-26.1" = _FqUR6qcF;
        "pkg-3.0.0-alpha.1+fabric-1.21.1" = _HeLHCyFW;
        "pkg-3.0.0-alpha.1+neoforge-26.1" = _jVluFOgp;
        "pkg-3.0.0-alpha.1+fabric-1.20.1" = _P9DxBE2X;
        "pkg-3.0.0-alpha.1+forge-1.20.1" = _yA0TeHlr;
        "pkg-3.0.0-alpha.1+neoforge-1.21.1" = _XojUCfC2;
        "pkg-3.0.0-alpha.2+neoforge-26.1" = _edE3DGOH;
        "pkg-3.0.0-alpha.2+fabric-1.20.1" = _PoWp3W0C;
        "pkg-3.0.0-alpha.2+fabric-26.1" = _s6TAcJHl;
        "pkg-3.0.0-alpha.2+fabric-1.21.1" = _zsEUkGKs;
        "pkg-3.0.0-alpha.2+neoforge-1.21.1" = _tdrb5h3O;
        "pkg-3.0.0-alpha.2+forge-1.20.1" = _776gYHCz;
        "pkg-3.0.0-beta.1+fabric-1.20.1" = _hhhSxDSp;
        "pkg-3.0.0-beta.1+fabric-1.21.1" = _9rM07jw2;
        "pkg-3.0.0-beta.1+fabric-26.1" = _sd9bMGcM;
        "pkg-3.0.0-beta.1+neoforge-1.21.1" = _EXlsIyPc;
        "pkg-3.0.0-beta.1+neoforge-26.1" = _As15qzAF;
        "pkg-3.0.0-beta.1+forge-1.20.1" = _CVVLd8iX;
        "pkg-3.0.0-beta.2+fabric-1.20.1" = _XS6pIEIw;
        "pkg-3.0.0-beta.2+fabric-1.21.1" = _TDX1Tv6C;
        "pkg-3.0.0-beta.2+fabric-26.1" = _VQUeKyCN;
        "pkg-3.0.0-beta.2+forge-1.20.1" = _ekbHaekq;
        "pkg-3.0.0-beta.2+neoforge-1.21.1" = _gmobP4fY;
        "pkg-3.0.0-beta.2+neoforge-26.1" = _nLIxqze2;
        "pkg-3.0.0+fabric-1.20.1" = _YcZX9uI2;
        "pkg-3.0.0+fabric-1.21.1" = _rZphaKd5;
        "pkg-3.0.0+fabric-26.1" = _ft8ZZI1b;
        "pkg-3.0.0+fabric-26.2" = _lgoJrIlp;
        "pkg-3.0.0+forge-1.20.1" = _O0NhIF5D;
        "pkg-3.0.0+neoforge-1.21.1" = _iQqohfaN;
        "pkg-3.0.0+neoforge-26.1" = _ZkPK8qkJ;
        "pkg-3.0.0+neoforge-26.2" = _AB7rY4t7;
        "pkg-3.0.1+fabric-1.21.1" = _AfeZRsD1;
        "pkg-3.0.1+fabric-26.2" = _2tsugFvc;
        "pkg-3.0.1+fabric-26.1" = _cP2mE76Q;
        "pkg-3.0.1+fabric-1.20.1" = _iNuncabH;
        "pkg-3.0.1+forge-1.20.1" = _64Wy9GCJ;
        "pkg-3.0.1+neoforge-26.2" = _Kf7tbIh9;
        "pkg-3.0.1+neoforge-26.1" = _Iwlpn9id;
        "pkg-3.0.1+neoforge-1.21.1" = _A8ELqKPG;
        "pkg-3.0.2+fabric-1.21.1" = _I5y7FxGB;
        "pkg-3.0.2+fabric-26.1" = _6pfSh93K;
        "pkg-3.0.2+fabric-1.20.1" = _LmzW19eV;
        "pkg-3.0.2+fabric-26.2" = _CEX4ERKQ;
        "pkg-3.0.2+neoforge-26.1" = _RgJy7H2C;
        ...
        "pkg-3.0.4+fabric-1.21.1" = _VeQrqSh7;
        "pkg-3.0.4+fabric-1.20.1" = _1ZhzA4Ka;
        "pkg-3.0.4+fabric-26.1" = _k1oNBSSj;
        "pkg-3.0.4+fabric-26.2" = _XGTJTFLz;
        "pkg-3.0.4+neoforge-1.21.1" = _IpL9hTnI;
        "pkg-3.0.4+neoforge-26.1" = _Db83p6w6;
        "pkg-3.0.4+neoforge-26.2" = _1VCfp0Og;
        "pkg-3.0.4+forge-1.20.1" = _XEnMrO48;
        "default" = _XEnMrO48;
    });
