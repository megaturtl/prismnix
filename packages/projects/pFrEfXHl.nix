...
let
    ...
    in {
        ...
        "pkg-1.20.2-1.0.0-forge" = _Vbx8kL9l;
        "pkg-1.21.1-1.0.0-neoforge" = _74FiXzzR;
        "pkg-1.20.1-1.0.0-fabric" = _4AjQKnvP;
        "pkg-1.20.1-1.0.1-forge" = _qL59lqRn;
        "pkg-1.21.3-1.0.0-fabric" = _KHZd6eSv;
        "pkg-1.21.3-1.0.0-neoforge" = _tJDWWDOk;
        "pkg-1.21.4-1.0.0-fabric" = _KDC6I0rH;
        "pkg-1.21.4-1.0.0-neoforge" = _MuFcPaT1;
        "pkg-1.21.5-1.0.0-fabric" = _9mQ3SRJO;
        "pkg-1.21.5-1.0.0-neoforge" = _5JbFwFto;
        "pkg-1.21.6-1.0.0-fabric" = _C7PnnAjp;
        "pkg-1.21.6-1.0.0-neoforge" = _OFvtqjag;
        "pkg-1.21.7-1.0.0-fabric" = _2S5tFatU;
        "pkg-1.21.7-1.0.0-neoforge" = _sZ4ZvhvZ;
        "pkg-1.21.8-1.0.0-fabric" = _4Il28osB;
        "pkg-1.21.8-1.0.0-neoforge" = _VSICm22b;
        "pkg-1.21.9-1.0.0-fabric" = _b10hUGxp;
        "pkg-1.21.9-1.0.0-neoforge" = _pHKj46mw;
        "pkg-1.21.10-1.0.0-fabric" = _KVPyFoT7;
        "pkg-1.21.10-1.0.0-neoforge" = _yGZwmJNy;
        "pkg-1.21.10-1.0.1-fabric" = _c4ZkjX75;
        "pkg-1.21.10-1.0.1-neoforge" = _mwjlKoJb;
        "pkg-1.21.11-1.0.1-fabric" = _MkoppD4J;
        "pkg-1.21.11-1.0.1-neoforge" = _P8sLp2P5;
        "pkg-26.1.x-1.0.1-fabric" = _m2mXjxfJ;
        "pkg-26.1.x-1.0.1-neoforge" = _yJHvqhNU;
        "pkg-3.0.0-beta.2+1.21.1-fabric" = _TOIno7Md;
        "pkg-3.0.0-beta.2+26.1.x-fabric" = _Uy7pwSuY;
        "pkg-3.0.0-beta.2+1.21.1-neoforge" = _Sl51aNxf;
        "pkg-3.0.0-beta.2+26.1.x-neoforge" = _njMSwx3v;
        "pkg-3.0.0-beta.6+1.21.1-fabric" = _dqSIzjKY;
        "pkg-3.0.0-beta.6+26.1.x-fabric" = _60WAkpxG;
        "pkg-3.0.0-beta.6+1.21.1-neoforge" = _8WVypQ3R;
