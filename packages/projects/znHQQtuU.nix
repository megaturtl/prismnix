...
let
    ...
    in {
        ...
        "pkg-1.1.7" = _uGtfTGfv;
        "pkg-1.1.8" = _oaJ0ggON;
        "pkg-1.0.0-1.20.1" = _L7EpdUNO;
        "pkg-1.0.1-1.20.1" = _eBIgviYs;
        "pkg-1.0.0-1.19.2" = _xjosQGXt;
        "pkg-1.0.1-1.19.2" = _PhumvuJR;
        "pkg-1.0.2-1.20.1" = _SufCqJ8l;
        "pkg-1.1.9" = _s9YOpSd8;
        "pkg-1.0.2-1.19.2" = _67cPRvgv;
        "pkg-1.1.10-1.20.1-fabric" = _QXK4vIaA;
        "pkg-1.2.0-1.20.1-fabric" = _NP8QgQR4;
        "pkg-1.1.0-1.20.1-forge" = _7AtLXYyt;
        "pkg-1.1.0-1.19.2-fabric" = _w6dWzSDo;
        "pkg-1.1.0-1.19.2-forge" = _hwXSXzEw;
        "pkg-1.2.1-1.20.1-fabric" = _bVjXGyks;
        "pkg-1.1.1-1.20.1-forge" = _leWyQ5il;
        "pkg-1.1.1-1.19.2-fabric" = _8iXtFDwK;
        "pkg-1.1.1-1.19.2-forge" = _lWMIFEgN;
        "pkg-1.2.2-1.20.1-fabric" = _HalNvD5e;
        "pkg-1.1.2-1.20.1-forge" = _NUWrNtCs;
        "pkg-1.1.2-1.19.2-fabric" = _59vpijIt;
        "pkg-1.1.2-1.19.2-forge" = _574IGDBd;
        "pkg-2024.06.30-1.19.2-forge" = _9LjNBLWL;
        "pkg-2024.07.16-1.20.1-forge" = _acNeJ6ZF;
        "pkg-24.7.27-1.21-neoforge" = _fSK93Tpg;
        "pkg-24.8.21-1.20.1-fabric" = _AUAWjf9r;
        "pkg-24.8.21-1.20.1-forge" = _zksZRqV7;
        "pkg-24.8.21-1.21-neoforge" = _tJXLlniv;
        "pkg-24.8.22-1.20.1-fabric" = _HlodsxEw;
        "pkg-24.8.22-1.20.1-forge" = _1kTYD6Ti;
        "pkg-24.8.22-1.21-neoforge" = _ZBaIBdfm;
        "pkg-24.8.27-1.20.1-fabric" = _dKlDxu0H;
        "pkg-24.8.27-1.20.1-forge" = _ESSMWk6i;
        "pkg-24.8.27-1.21-neoforge" = _eUhvJghS;
        "pkg-24.09.09-1.21-fabric" = _fe7mSsof;
        "pkg-24.09.10-1.19-fabric" = _Jx1eupEq;
        "pkg-24.09.10-1.19-forge" = _4x5dKZ9D;
        "pkg-24.09.10-1.20-forge" = _jR5ft1qh;
        "pkg-24.09.10-1.21-neoforge" = _HVYBzDQh;
        "pkg-24.09.10-1.20-fabric" = _Yscv1J1l;
        "pkg-24.09.10-1.21-fabric" = _zkSBt4iK;
        "pkg-24.09.16-1.19-forge" = _l8ZYp3Ah;
        "pkg-24.09.16-1.20-forge" = _YGM8kl0t;
        "pkg-24.09.16-1.19-fabric" = _hmrDLrf8;
        "pkg-24.09.16-1.20-fabric" = _eYF5eqGY;
        "pkg-24.09.16-1.21-fabric" = _QbltNHCY;
        "pkg-24.09.16-1.21-neoforge" = _3ZpXGc4M;
        "pkg-24.09.27-1.19-forge" = _vEJFxXl7;
        "pkg-24.09.27-1.20-forge" = _iTeBfeBT;
        "pkg-24.09.27-1.19-fabric" = _wTTl49a8;
        "pkg-24.09.27-1.20-fabric" = _zst5fZig;
        "pkg-24.09.27-1.21-fabric" = _Pc1Zc3Db;
        "pkg-24.09.27-1.21-neoforge" = _jF3eUvE7;
        "pkg-24.11.06-1.20-forge" = _8uvYZJuQ;
        "pkg-25.01.06-1.21-fabric" = _91FZkbdt;
        "pkg-25.01.13-1.19-forge" = _2bytntxM;
        "pkg-25.01.13-1.20-forge" = _OtiZiaTq;
        "pkg-25.01.13-1.21-neoforge" = _lHmH0uOQ;
        "pkg-25.01.13-1.19-fabric" = _I7DNP4ZK;
        "pkg-25.01.13-1.20-fabric" = _OKjrU0qy;
        "pkg-25.01.13-1.21-fabric" = _Q0nGg2Ed;
        "pkg-25.01.13a-1.21-neoforge" = _aTCpE3AT;
        "pkg-25.03.27-1.21-fabric" = _b7swAm8y;
        "pkg-25.05.14-1.21-neoforge" = _qhofM0Kb;
        "pkg-25.07.05-1.21.7-fabric" = _hMyi2vqD;
        "pkg-25.07.15-1.21.7-fabric" = _MqNG2eDm;
        "pkg-25.07.17-1.21.7-fabric" = _LmVXX2ls;
        "pkg-25.07.28-1.21.7-fabric" = _NQLcpDEA;
        "pkg-25.07.28-1.21-neoforge" = _euT8BduK;
        "pkg-25.07.28-1.20-forge" = _ctSWYdlm;
        "pkg-25.07.28-1.19-forge" = _Zidu1lX5;
        "pkg-25.07.28-1.21-fabric" = _t4YUvHQh;
        "pkg-25.07.28-1.20-fabric" = _wU4RoctO;
        "pkg-25.07.28-1.19-fabric" = _onvv8glj;
        "pkg-25.07.28a-1.21-neoforge" = _Fe9UVuq7;
        "pkg-25.07.28a-1.21.7-fabric" = _NvzpD2uF;
        "pkg-25.12.10-1.21.11-fabric" = _SO4Cat6L;
        "pkg-26.03.27+26.1-fabric" = _sewRqZzu;
        "pkg-26.04.30-1.20-forge" = _B6UHIX2x;
        "pkg-26.04.30-1.21-neoforge" = _R5Aa0HDI;
        "pkg-26.04.30-1.20-fabric" = _3KdJ9dVX;
        "pkg-26.04.30-1.21-fabric" = _sIZPOFH7;
        "pkg-26.05.02-26.1-fabric" = _dvGcO56p;
        "pkg-26.05.07-1.20-fabric" = _blAMDKGE;
        "pkg-26.05.20-1.21-neoforge" = _hMZKWhIg;
        "pkg-26.05.20-1.20-forge" = _GrLDJ8lO;
