...
let
    versions = (let
        ...
        _G8oXUuoG = {
            ...
            "hash" = "sha512-ET9nQ+5DnR9VKMI7uab+bChEjJA9Hw0JpC/YOZnmNdtWL/tlalN4n57MM/9CC+3tdygi/052MMddlrKllMLN/w==";
        };
        _Z1f7T2kE = {
            "id" = "Z1f7T2kE";
            "file" = "better-clouds-1.13.7+1.20.6-fabric.jar";
            "hash" = "sha512-P7CU1RNFUhG8sM/Tf8Ho1Vmn4U0UMjAcSiT61rU950z9v5ehFiHIGTsjFCrwY4j49BIQvGTNyNZUakvrS7TvbQ==";
        };
        _98i9IvGb = {
            "id" = "98i9IvGb";
            "file" = "better-clouds-1.13.7+1.21.1-neoforge.jar";
            "hash" = "sha512-l66B/d77QsecnugtdbCrKFMcj48fbJZDAmoVfwpdi/LOIg29vz8Y0W/RkQBxCtvA6kjuEzjZUcF1KNX306PNFA==";
        };
        _E3bc2I7R = {
            "id" = "E3bc2I7R";
            "file" = "better-clouds-1.13.7+1.21.1-fabric.jar";
            "hash" = "sha512-NCI72dqUBIS+4ddwTILZk94PNNuUmFRiOF+OyUhRL7j2Q4NGNEPnk/kI06Bo6d5FOELrM0b3uCnnqjLPVBcIeA==";
        };
        _5afQyhse = {
            "id" = "5afQyhse";
            "file" = "better-clouds-1.13.7+1.21.11-neoforge.jar";
            "hash" = "sha512-XZiZYXdIoUvjftNLn9dygA00bQNqKey6bwEhqppPu6kIyxIB/gQPhh7xFUR7Ehk5QwVWfioJJ50bqHXi/tMHzw==";
        };
        _8VdlbtmG = {
            "id" = "8VdlbtmG";
            "file" = "better-clouds-1.13.7+1.21.11-fabric.jar";
            "hash" = "sha512-D7s5FXcO6xN/12mI32Kfg/EZCpP3YHcTZ58w28N0xW49NmxSg9x9a2y7ZPO2Y72k51wsUF9G7yBOjZLPv7uiww==";
        };
        _6hLnIcGQ = {
            "id" = "6hLnIcGQ";
            "file" = "better-clouds-1.14.4+26.2-fabric.jar";
            "hash" = "sha512-gq79dsh8F4TavEaxu+A/rMO9d718+jog9uy+3rIc4XoAC7x1NqoyIOGz6GpH4bCbk+rZyVcOSrTPnHsmcrdnEQ==";
        };
        _HLg3L2FJ = {
            "id" = "HLg3L2FJ";
            "file" = "better-clouds-1.14.4+26.2-neoforge.jar";
            "hash" = "sha512-ugpSXQybFa1Hza280+Jldp5HNBZYLbFJ2qC94uM2pUvyh2O/5xPO/4biBDmP3TTrzlIAfUwKr6+t0n0tjoBqtQ==";
        };
        _RHwKtlvx = {
            "id" = "RHwKtlvx";
    ...
    in {
        ...
        "pkg-1.0.2-R" = _2P4z29Lc;
        "pkg-1.0.3-R" = _f4jg6EtK;
        "pkg-1.0.4+1.18.1-R" = _LVrQHf7k;
        "pkg-1.0.4+1.17.1-B" = _deFQ907m;
        "pkg-1.0.5+1.18.2-R" = _2EEKJCHK;
        "pkg-1.1.0+1-19-4-B" = _LsLVqOw5;
        "pkg-1.1.1+1-19-4-B" = _Yp8X8Rdg;
        "pkg-1.1.2+1-19-4-B" = _za8rP5eN;
        "pkg-1.1.3+1.19.4-B" = _okuEzg3u;
        "pkg-1.1.4+1.19.4-B" = _HyE79k5L;
        "pkg-1.2.0+1.19.4-R" = _SfH7gsIQ;
        "pkg-1.2.1+1.19.4-R" = _wqa9m9gN;
        "pkg-1.3.0+1.20.1-B" = _fz1uuHep;
        "pkg-1.2.2+1.19.4-R" = _yNhvWkcN;
        "pkg-1.3.1+1.20.1-B" = _KTSZcxuh;
        "pkg-1.3.2+1.20.1-B" = _xqfFr5ie;
        "pkg-1.2.4+1.19.4-R" = _TzGAgG5f;
        "pkg-1.2.5+1.19.4-R" = _A88Xd75h;
        "pkg-1.3.3+1.20.1-B" = _9y6NWtrx;
        "pkg-1.3.4+1.20.1-R" = _TOY019mH;
        "pkg-1.2.6+1.19.4-R" = _BrOjKW1N;
        "pkg-1.3.5+1.20.1-R" = _Nm8Nj6z3;
        "pkg-1.2.7+1.19.4-R" = _nPW4PYmO;
        "pkg-1.2.7+1.19.2-R" = _gRRJGXE1;
        "pkg-1.3.6+1.20.1-R" = _DQ40GMau;
        "pkg-1.2.8+1.19.4-R" = _A1VRleSy;
        "pkg-1.2.8+1.19.2-R" = _sntvG4ej;
        "pkg-1.2.9+1.19.2-R" = _FHnj2oLM;
        "pkg-1.2.9+1.19.4-R" = _jPb8iiwT;
        "pkg-1.3.7+1.20.1-R" = _3cedDXTS;
        "pkg-1.3.8+1.20.1-R" = _VVtZnV3W;
        "pkg-1.2.10+1.19.4-R" = _kUwz5vav;
        "pkg-1.2.10+1.19.2-R" = _IE3z1D5Y;
        "pkg-1.2.10+1.19.3-R" = _pheLLOPj;
        "pkg-1.3.9+1.20.1-R" = _tdyKh2V1;
        "pkg-1.4.0+1.20.2-R" = _jSgF639T;
        "pkg-1.2.11+1.19.3-R" = _OFJsjzwr;
        "pkg-1.2.11+1.19.4-R" = _v7Hp7IMK;
        "pkg-1.4.1+1.20.2-R" = _n2uvHOrN;
        "pkg-1.3.10+1.20.1-R" = _blCnaW7r;
        "pkg-1.2.12+1.19.4-R" = _OsJElQuv;
        "pkg-1.2.12+1.19.3-R" = _HPfuCJys;
        "pkg-1.0.5+1.17.1" = _W1j4ucem;
        "pkg-1.4.2+1.20.2-R" = _UKeiCtoO;
        "pkg-1.3.11+1.20.1-R" = _GcLFaRgv;
        "pkg-1.4.3+1.20.2-R" = _pdxFYdNa;
        "pkg-1.5.1+1.20.4-R" = _Ck4bEs2T;
        "pkg-1.5.2+1.20.4-R" = _suHyhfSe;
        "pkg-1.4.4+1.20.2-R" = _Ea8g02dw;
        "pkg-1.5.3+1.20.4-R" = _9M13OFtE;
        "pkg-1.4.5+1.20.2-R" = _8n6R7ljW;
        "pkg-1.3.12+1.20.1-R" = _Fj5Eq9W3;
        "pkg-1.5.4+1.20.4-R" = _o8JnkI68;
        "pkg-1.4.6+1.20.2-R" = _Rp2h0OB3;
        "pkg-1.3.13+1.20.1-R" = _BCETFiXz;
        "pkg-1.5.5+1.20.4-R" = _LM8VQXTn;
        "pkg-1.4.7+1.20.2-R" = _CE5GU2Zl;
        "pkg-1.3.14+1.20.1-R" = _biz2YWXe;
        "pkg-1.3.16+1.20.1-R" = _RiTQ24Gc;
        "pkg-1.4.9+1.20.2-R" = _3gnR2UbU;
        "pkg-1.5.7+1.20.4-R" = _cWjRcS0u;
        "pkg-1.5.8+1.20.4-R" = _sYfn4Q4v;
        "pkg-1.3.17+1.20.1-R" = _folOkUCd;
        "pkg-1.6.0+1.20.6-b" = _RaAiN5N9;
        "pkg-1.7.0+1.21-b" = _34vOoFqa;
        "pkg-1.6.1+1.20.6-b" = _I9jpZj5V;
        "pkg-1.5.9+1.20.4-R" = _OKDVeUiY;
        "pkg-1.3.18+1.20.1-R" = _sNiqgg9A;
        "pkg-1.7.1+1.21-r" = _2zHejFCJ;
        "pkg-1.6.2+1.20.6-r" = _fT29AgTm;
        "pkg-1.5.10+1.20.4-R" = _ncOn5tE6;
        "pkg-1.4.10+1.20.2-R" = _CVX2StqG;
        "pkg-1.3.19+1.20.1-R" = _b025S5VV;
        "pkg-1.7.2+1.21-neoforge-a" = _Dmxzf7BO;
        "pkg-1.6.3+1.20.6-neoforge-a" = _OBdYtAAe;
        "pkg-1.5.11+1.20.4-neoforge-a" = _fAiGE4R1;
        "pkg-1.6.4+1.20.6-neoforge-r" = _7zjPlHWA;
        "pkg-1.5.12+1.20.4-neoforge-r" = _lFGEbpPR;
        "pkg-1.3.21+1.20.1-fabric-r" = _KlKopjII;
        "pkg-1.7.3+1.21-neoforge-r" = _ivnztJ2y;
        "pkg-1.7.3+1.21-fabric-r" = _EJAvGRvS;
        "pkg-1.5.12+1.20.4-fabric-r" = _Fgeua3cB;
        "pkg-1.6.4+1.20.6-fabric-r" = _ePZ20gO0;
        "pkg-1.7.4+1.21-neoforge-r" = _g3R9XJtN;
        "pkg-1.6.5+1.20.6-neoforge-r" = _kBHWib9k;
        "pkg-1.5.13+1.20.4-fabric-r" = _lIngpTrb;
        "pkg-1.3.22+1.20.1-fabric-r" = _YbafyWAu;
        "pkg-1.6.5+1.20.6-fabric-r" = _HIxXYSaC;
        "pkg-1.7.4+1.21-fabric-r" = _k6qR7lZj;
        "pkg-1.5.13+1.20.4-neoforge-r" = _6bhhZdwC;
        "pkg-1.8.0+1.21.3-fabric-b" = _9TNkGrwG;
        "pkg-1.8.1+1.21.3-fabric-b" = _nOrj9xwQ;
        "pkg-1.5.14+1.20.4-neoforge-r" = _ouYETjjW;
        "pkg-1.7.5+1.21-neoforge-r" = _mt2RKAUG;
        "pkg-1.8.2+1.21.3-neoforge-r" = _x8q3lTDF;
        "pkg-1.5.14+1.20.4-fabric-r" = _YroPZCwv;
        "pkg-1.6.6+1.20.6-neoforge-r" = _SRijFy1r;
        "pkg-1.7.5+1.21-fabric-r" = _LzmuyokQ;
        "pkg-1.6.6+1.20.6-fabric-r" = _fn9WtFho;
        "pkg-1.3.23+1.20.1-fabric-r" = _w8kQWfAA;
        "pkg-1.8.2+1.21.3-fabric-r" = _J2PcDkqn;
        "pkg-1.8.2+1.21.4-fabric-r" = _E5vsFWUj;
        "pkg-1.8.2+1.21.4-neoforge-r" = _kPlrxwU1;
        "pkg-1.8.4+1.21.4-neoforge-r" = _1P7rtXgL;
        "pkg-1.7.6+1.21-neoforge-r" = _3K1lVoXz;
        "pkg-1.5.16+1.20.4-neoforge-r" = _uhLe5k9C;
        "pkg-1.8.4+1.21.3-neoforge-r" = _I6IP3Cob;
        "pkg-1.6.8+1.20.6-neoforge-r" = _NVR2M7UY;
        "pkg-1.8.4+1.21.4-fabric-r" = _voBI3IIX;
        "pkg-1.8.4+1.21.3-fabric-r" = _jU15KN9I;
        "pkg-1.6.8+1.20.6-fabric-r" = _8cgumKcQ;
        "pkg-1.7.6+1.21-fabric-r" = _WnTaUmEM;
        "pkg-1.5.16+1.20.4-fabric-r" = _o6zjUxTc;
        "pkg-1.3.25+1.20.1-fabric-r" = _qAYDvCSj;
        "pkg-1.3.26+1.20.1-forge-b" = _zO6viJPM;
        "pkg-1.8.5+1.21.4-fabric-r" = _PPxwmSxM;
        "pkg-1.7.7+1.21-fabric-r" = _5TuBWFEX;
        "pkg-1.8.5+1.21.3-fabric-r" = _5w1fSAhb;
        "pkg-1.5.17+1.20.4-fabric-r" = _WzYPgiit;
        "pkg-1.6.9+1.20.6-fabric-r" = _Ow00aEJd;
        "pkg-1.3.26+1.20.1-fabric-r" = _gjYzPn0X;
        "pkg-1.8.6+1.21.4-neoforge-r" = _PJmZUYo2;
        "pkg-1.8.6+1.21.3-neoforge-r" = _WSjXLLN4;
        "pkg-1.7.8+1.21-neoforge-r" = _5ZSh4y7U;
        "pkg-1.6.10+1.20.6-neoforge-r" = _EsfkAZN9;
        "pkg-1.5.18+1.20.4-neoforge-r" = _RBbQqryF;
        "pkg-1.5.19+1.20.4-neoforge-r" = _PRwyCNxY;
        "pkg-1.8.7+1.21.4-neoforge-r" = _G9pDmtrn;
        "pkg-1.6.11+1.20.6-neoforge-r" = _U8Jb5znu;
        "pkg-1.7.9+1.21-neoforge-r" = _XC56zLmp;
        "pkg-1.8.7+1.21.3-neoforge-r" = _joaTSGh4;
        "pkg-1.8.7+1.21.4-fabric-r" = _fJbDVlvB;
        "pkg-1.6.11+1.20.6-fabric-r" = _8TmKp9dy;
        "pkg-1.7.9+1.21-fabric-r" = _sUmK8PWH;
        "pkg-1.3.27+1.20.1-fabric-r" = _n4Zz5w9Q;
        "pkg-1.8.7+1.21.3-fabric-r" = _9lQqSb7P;
        "pkg-1.5.19+1.20.4-fabric-r" = _DbdGVDac;
        "pkg-1.3.27+1.20.1-forge-b" = _PUoRD2aD;
        "pkg-1.8.9+1.21.4-neoforge-r" = _EKFk717f;
        "pkg-1.6.13+1.20.6-neoforge-r" = _9edhuBPn;
        "pkg-1.7.11+1.21.1-fabric-r" = _mUYuroWO;
        "pkg-1.8.9+1.21.3-fabric-r" = _3cklor8r;
        "pkg-1.7.11+1.21.1-neoforge-r" = _VHQHVwni;
        "pkg-1.5.21+1.20.4-fabric-r" = _LdROPQgG;
        "pkg-1.5.21+1.20.4-neoforge-r" = _qwpwgyAK;
        "pkg-1.8.9-rc.1+1.21.5-neoforge-b" = _PdqPPbzz;
        "pkg-1.8.9+1.21.4-fabric-r" = _FZ2wP46p;
        "pkg-1.8.9-rc.1+1.21.5-fabric-b" = _jA3H72xa;
        "pkg-1.6.13+1.20.6-fabric-r" = _F9nejsZs;
        "pkg-1.8.9+1.21.3-neoforge-r" = _BtldqL8E;
        "pkg-1.3.29+1.20.1-fabric-r" = _VicjkGvI;
        "pkg-1.6.14+1.20.6-neoforge-r" = _7vQOrET4;
        "pkg-1.5.22+1.20.4-neoforge-r" = _i2CGYFWl;
        "pkg-1.9.0+1.21.5-neoforge-r" = _NfwOLfx6;
        "pkg-1.8.10+1.21.4-neoforge-r" = _pRxg9FqR;
        "pkg-1.7.12+1.21.1-neoforge-r" = _dN6jqvVQ;
        "pkg-1.8.10+1.21.3-neoforge-r" = _tTf0Uzou;
        "pkg-1.9.0+1.21.5-fabric-r" = _3Ma9hWiy;
        "pkg-1.8.10+1.21.4-fabric-r" = _KXKgr8XZ;
        "pkg-1.5.22+1.20.4-fabric-r" = _TPlkIRM3;
        "pkg-1.3.30+1.20.1-fabric-r" = _Mwn0UQ59;
        "pkg-1.7.12+1.21.1-fabric-r" = _tDU9ZYRY;
        "pkg-1.8.10+1.21.3-fabric-r" = _EKPS4Vh3;
        "pkg-1.6.14+1.20.6-fabric-r" = _maFBYvap;
        "pkg-1.9.1+1.21.5-fabric-r" = _LRz2udOD;
        "pkg-1.8.11+1.21.4-neoforge-r" = _irAKaTq3;
        "pkg-1.9.2+1.21.5-fabric-r" = _ubRKYvz0;
        "pkg-1.7.13+1.21.1-neoforge-r" = _Uz5SwDCS;
        "pkg-1.9.2+1.21.5-neoforge-r" = _3qCCxcFq;
        "pkg-1.5.23+1.20.4-fabric-r" = _NF7chL5b;
        "pkg-1.6.15+1.20.6-fabric-r" = _VcaqyXI2;
        "pkg-1.6.15+1.20.6-neoforge-r" = _POOvt4LK;
        "pkg-1.8.11+1.21.3-neoforge-r" = _FGDOLh41;
        "pkg-1.5.23+1.20.4-neoforge-r" = _oTpJ65zr;
        "pkg-1.8.11+1.21.3-fabric-r" = _eizOVCnk;
        "pkg-1.8.11+1.21.4-fabric-r" = _B4BYKFH1;
        "pkg-1.7.13+1.21.1-fabric-r" = _NEq3pK8p;
        "pkg-1.3.31+1.20.1-fabric-r" = _5yViQ7dn;
        "pkg-1.3.31+1.20.1-forge-b" = _WYW0Q0w4;
        "pkg-1.9.3+1.21.5-fabric-b" = _qK6EgFzF;
        "pkg-1.9.3+1.21.5-neoforge-b" = _WFfz3SdZ;
        "pkg-1.9.4+1.21.5-neoforge-b" = _ttIDT9pE;
        "pkg-1.8.12+1.21.3-neoforge-r" = _LM2Hbj1l;
        "pkg-1.10.0+1.21.6-neoforge-a" = _X8JOIT8j;
        "pkg-1.8.12+1.21.3-fabric-r" = _jhVa3R1m;
        "pkg-1.8.12+1.21.4-neoforge-r" = _oMnzzBMk;
        "pkg-1.6.16+1.20.6-neoforge-r" = _9ngwQJI1;
        "pkg-1.10.0+1.21.6-fabric-a" = _oTu9zIjJ;
        "pkg-1.8.12+1.21.4-fabric-r" = _FJwgnUeU;
        "pkg-1.7.14+1.21.1-neoforge-r" = _NzbGi8mq;
        "pkg-1.6.16+1.20.6-fabric-r" = _qCu48T42;
        "pkg-1.7.14+1.21.1-fabric-r" = _ooeoSAiI;
        "pkg-1.9.4+1.21.5-fabric-b" = _CU6uTVEr;
        "pkg-1.5.24+1.20.4-neoforge-r" = _pN10oz9d;
        "pkg-1.3.32+1.20.1-fabric-r" = _gzccrRVX;
        "pkg-1.3.32+1.20.1-forge-b" = _LLeJevuC;
        "pkg-1.5.24+1.20.4-fabric-r" = _dNxUBDYo;
        "pkg-1.10.1+1.21.7-fabric-a" = _L2goiJxh;
        "pkg-1.10.1+1.21.7-neoforge-a" = _803V5LDU;
        "pkg-1.3.33+1.20.1-forge-b" = _BIkcDUxE;
        "pkg-1.8.13+1.21.4-neoforge-s" = _H4NWB5V7;
        "pkg-1.9.5+1.21.5-neoforge-b" = _g1yXnmAp;
        "pkg-1.10.2+1.21.8-neoforge-a" = _xYYWEmUw;
        "pkg-1.10.2+1.21.8-fabric-a" = _QUujU5IR;
        "pkg-1.8.13+1.21.3-neoforge-s" = _vIQTPPxD;
        "pkg-1.7.15+1.21.1-neoforge-s" = _UYwaMXzU;
        "pkg-1.6.17+1.20.6-neoforge-s" = _JJFgE9IS;
        "pkg-1.8.13+1.21.4-fabric-s" = _Q1QcEkgT;
        "pkg-1.9.5+1.21.5-fabric-b" = _bnD9ZsUI;
        "pkg-1.8.13+1.21.3-fabric-s" = _bcpK8HAz;
        "pkg-1.7.15+1.21.1-fabric-s" = _W0yHjVna;
        "pkg-1.5.25+1.20.4-neoforge-s" = _j6ouUiiI;
        "pkg-1.6.17+1.20.6-fabric-s" = _SLfzRaPM;
        "pkg-1.5.25+1.20.4-fabric-s" = _7jyBR5By;
        "pkg-1.3.34+1.20.1-forge-b" = _MeTI9hCd;
        "pkg-1.3.34+1.20.1-fabric-s" = _lekMrUER;
        "pkg-1.9.6+1.21.5-neoforge-b" = _VWN4WVnc;
        "pkg-1.10.3+1.21.8-neoforge-a" = _VE2VOkq5;
        "pkg-1.8.14+1.21.4-neoforge-r" = _hetfWrtJ;
        "pkg-1.8.14+1.21.3-neoforge-r" = _JzUedX8k;
        "pkg-1.7.16+1.21.1-neoforge-r" = _hE1M3J6F;
        "pkg-1.6.18+1.20.6-neoforge-r" = _S9tu412b;
        "pkg-1.10.3+1.21.8-fabric-a" = _8lqkhbOW;
        "pkg-1.8.14+1.21.4-fabric-r" = _vrf4OEGi;
        "pkg-1.8.14+1.21.3-fabric-r" = _zlmCNCxJ;
        "pkg-1.7.16+1.21.1-fabric-r" = _ECX54Zqv;
        "pkg-1.9.6+1.21.5-fabric-b" = _ZAmOZ67W;
        "pkg-1.6.18+1.20.6-fabric-r" = _gTo0k7Eg;
        "pkg-1.5.26+1.20.4-neoforge-r" = _Q7hQSyQO;
        "pkg-1.3.35+1.20.1-fabric-r" = _aZAbUouG;
        "pkg-1.3.35+1.20.1-forge-b" = _PR8XjMLH;
        "pkg-1.5.26+1.20.4-fabric-r" = _Vrp9y20P;
        "pkg-1.9.7+1.21.5-neoforge-b" = _f1XI5VMY;
        "pkg-1.8.15+1.21.4-neoforge-r" = _VeylVhrW;
        "pkg-1.10.4+1.21.8-neoforge-a" = _KI1oCOk9;
        "pkg-1.8.15+1.21.3-neoforge-r" = _iMpdxql3;
        "pkg-1.7.17+1.21.1-neoforge-r" = _U0BTwXtf;
        "pkg-1.9.7+1.21.5-fabric-b" = _bwnJTqRm;
        "pkg-1.8.15+1.21.4-fabric-r" = _GrzyYZtx;
        "pkg-1.7.17+1.21.1-fabric-r" = _9Cbk55Pv;
        "pkg-1.8.15+1.21.3-fabric-r" = _319EZdbe;
        "pkg-1.10.4+1.21.8-fabric-a" = _zRjLdD0k;
        "pkg-1.10.5+1.21.8-fabric-a" = _55j8PLJ1;
        "pkg-1.10.5+1.21.8-neoforge-a" = _u5Ls6qzW;
        "pkg-1.5.27+1.20.4-neoforge-r" = _IpA1n0LJ;
        "pkg-1.6.19+1.20.6-neoforge-r" = _C4iBMeeG;
        "pkg-1.7.18+1.21.1-fabric-r" = _NlR3jn8Y;
        "pkg-1.6.19+1.20.6-fabric-r" = _peysUT19;
        "pkg-1.5.27+1.20.4-fabric-r" = _J5rtOxl2;
        "pkg-1.3.36+1.20.1-fabric-r" = _oZl9Trik;
        "pkg-1.8.16+1.21.3-neoforge-r" = _inxLcszc;
        "pkg-1.7.18+1.21.1-neoforge-r" = _hffdxZd5;
        "pkg-1.8.16+1.21.4-neoforge-r" = _aezxr8hg;
        "pkg-1.8.16+1.21.4-fabric-r" = _9euEVq9C;
        "pkg-1.8.16+1.21.3-fabric-r" = _6il6PtZq;
        "pkg-1.9.8+1.21.5-neoforge-b" = _gIGBIV4e;
        "pkg-1.10.6+1.21.8-neoforge-a" = _GiekwP2J;
        "pkg-1.9.8+1.21.5-fabric-b" = _7cv80lTT;
        "pkg-1.10.6+1.21.8-fabric-a" = _veYPDyHj;
        "pkg-1.11.0+1.21.9-fabric-a" = _50CUvuQg;
        "pkg-1.11.0+1.21.9-neoforge-a" = _IqYmWTRR;
        "pkg-1.5.28+1.20.4-neoforge-r" = _MzeesNiG;
        "pkg-1.3.37+1.20.1-forge-b" = _hQgUzZa4;
        "pkg-1.6.20+1.20.6-neoforge-r" = _jdeXqKLY;
        "pkg-1.6.20+1.20.6-fabric-r" = _3p3iqzRw;
        "pkg-1.7.19+1.21.1-fabric-r" = _Ta9mG3DR;
        "pkg-1.5.28+1.20.4-fabric-r" = _3Nnq7W9L;
        "pkg-1.3.37+1.20.1-fabric-r" = _q5SAbK2s;
        "pkg-1.7.19+1.21.1-neoforge-r" = _wapDaY5q;
        "pkg-1.8.17+1.21.4-neoforge-r" = _6ewIJi6O;
        "pkg-1.8.17+1.21.3-neoforge-r" = _n1jRvQMd;
        "pkg-1.8.17+1.21.3-fabric-r" = _XdcG9bZF;
        "pkg-1.8.17+1.21.4-fabric-r" = _owby9HBL;
        "pkg-1.9.9+1.21.5-neoforge-b" = _am5Yaprw;
        "pkg-1.9.9+1.21.5-fabric-b" = _YuoFL8QK;
        "pkg-1.10.7+1.21.8-fabric-a" = _xdBmH3Z5;
        "pkg-1.11.1+1.21.9-fabric-a" = _P2WbcGkt;
        "pkg-1.10.7+1.21.8-neoforge-a" = _15bBXgyQ;
        "pkg-1.11.1+1.21.9-neoforge-a" = _u9Lg7Hlz;
        "pkg-1.11.3+1.21.11-fabric-a" = _BXq5hzZ4;
        "pkg-1.11.3+1.21.11-neoforge-a" = _pZGVtV90;
        "pkg-1.12.0+26.1-fabric-a" = _qqcWu0vf;
        "pkg-1.12.0+26.1-neoforge-a" = _SYm2AfhH;
        "pkg-1.12.0+26.1-fabric-beta" = _y694nYo8;
        "pkg-1.12.0+26.1-neoforge-beta" = _F2BiYv0N;
        "pkg-1.12.0+26.1-neoforge-release" = _6614HttX;
        "pkg-1.12.0+26.1-fabric-release" = _bkU1BWd8;
        "pkg-1.12.1+26.1.2-neoforge-release" = _msuV4NdH;
        "pkg-1.12.1+26.1.2-fabric-release" = _LltUuEQL;
        "pkg-1.13.0+26.1.2-neoforge-beta" = _fefN4ey3;
        "pkg-1.13.0+26.1.2-fabric-beta" = _TDvsQjSC;
        "pkg-1.7.20+1.21.1-neoforge-alpha" = _ucwzanPQ;
        "pkg-1.13.0+26.1.2-fabric-release" = _JmgbsTLr;
        "pkg-1.13.0+26.1.2-neoforge-release" = _LGoDthMM;
        "pkg-1.13.1+26.1.2-neoforge-release" = _1F5RPcSR;
        "pkg-1.13.1+26.1.2-fabric-release" = _G5dAE9Zn;
        "pkg-1.13.2+26.1.2-neoforge-release" = _5tKHZ4OK;
        "pkg-1.13.2+26.1.2-fabric-release" = _TFMo2VRf;
        "pkg-1.13.3+26.1.2-neoforge-release" = _tUcxTsk1;
        "pkg-1.13.3+26.1.2-fabric-release" = _Vogm4XdS;
        "pkg-1.13.4+26.1.2-neoforge-release" = _la9J4YBu;
        "pkg-1.13.4+26.1.2-fabric-release" = _9XT1IMtH;
        "pkg-1.13.5+26.1.2-neoforge-release" = _inQXER7a;
        "pkg-1.13.5+26.1.2-fabric-release" = _AtCXhq73;
        "pkg-1.13.5+1.21.11-fabric-beta" = _hoBYapHc;
        "pkg-1.13.5+1.21.11-neoforge-beta" = _3AsY6inY;
        "pkg-1.13.5+1.21.1-fabric-alpha" = _rB7DiK7e;
        "pkg-1.13.5+1.21.1-neoforge-beta" = _bfurRkm7;
        "pkg-1.13.5+1.20.6-fabric-beta" = _pPX7SB9W;
        "pkg-1.13.5+1.20.6-neoforge-beta" = _rg7ZnP6U;
        "pkg-1.13.6+26.1.2-neoforge-beta" = _MZBenEyU;
        "pkg-1.13.6+26.1.2-fabric-beta" = _sDQIfUCz;
        "pkg-1.13.6+26.1.2-neoforge-release" = _nNnnD5Om;
        "pkg-1.13.6+26.1.2-fabric-release" = _Jf0v8y9Y;
        "pkg-1.14.0-alpha.1" = _isgdGGs2;
        "pkg-1.14.0-beta.1" = _RqcO4VHH;
        "pkg-1.14.0-beta.2" = _CSwpmGOC;
        "pkg-1.14.0-beta.3" = _Uvf2K7qt;
        "pkg-1.14.0" = _ZBqLwBcT;
        "pkg-1.13.5+1.21.11-fabric-release" = _rsq4a6kF;
        "pkg-1.13.5+1.21.11-neoforge-release" = _i8Z8pWwf;
        "pkg-1.13.5+1.21.1-neoforge-release" = _rj65x08X;
        "pkg-1.13.5+1.20.6-fabric-release" = _o4hRXgRr;
        "pkg-1.13.5+1.20.6-neoforge-release" = _sUoL6Aq4;
        "pkg-1.13.5+1.21.1-fabric-release" = _bFswE7LK;
        "pkg-1.13.6+1.21.11-fabric-release" = _bQ7F3Vxb;
        "pkg-1.13.6+1.21.11-neoforge-release" = _w2t0ox1B;
        "pkg-1.13.6+1.21.1-fabric-release" = _am3WxR65;
        "pkg-1.13.6+1.21.1-neoforge-release" = _XK8POrWQ;
        "pkg-1.13.6+1.20.6-fabric-release" = _VXFJkadA;
        "pkg-1.13.6+1.20.6-neoforge-release" = _7sqsuUgP;
        "pkg-1.14.1" = _EnhaqJPE;
        "pkg-1.14.2" = _GdrRQYxI;
        "pkg-1.14.3" = _QhpRLX5L;
        "pkg-1.13.7+1.20.6-neoforge-release" = _G8oXUuoG;
        "pkg-1.13.7+1.20.6-fabric-release" = _Z1f7T2kE;
        "pkg-1.13.7+1.21.1-neoforge-release" = _98i9IvGb;
        "pkg-1.13.7+1.21.1-fabric-release" = _E3bc2I7R;
        "pkg-1.13.7+1.21.11-neoforge-release" = _5afQyhse;
