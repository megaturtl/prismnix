...
let
    versions = (let
        ...
        _QzknP190 = {
            "id" = "QzknP190";
            "file" = "PeakStamina NeoForge 2.2.0+hotfix.jar";
            "hash" = "sha512-5pe0Lwxs1HHYKNjCoaMMyhxjch2PLSEUCdrzWHHY2XdQ9E4Jb3Qm/QykM7z5Y3J3TDhOBOY6ybIncs18IBNFVw==";
        };
        _lEgjAquy = {
            "id" = "lEgjAquy";
    ...
    in {
        ...
        "pkg-1.2.4" = _yS6KuO0a;
        "pkg-1.3.4" = _VocgI3t9;
        "pkg-1.5.10" = _HpkJ31RK;
        "pkg-1.5.11" = _BbPmAlf6;
        "pkg-1.6.11" = _iTk0pdwn;
        "pkg-1.6.12" = _Sf7RI16n;
        "pkg-1.7.12" = _9ZhKUZ42;
        "pkg-1.7.13" = _lZj9S7J1;
        "pkg-1.7.14" = _XF2dlHI2;
        "pkg-1.8.14" = _ytd6ethA;
        "pkg-1.8.15" = _r8T6jTAG;
        "pkg-1.8.16" = _WZn07JAp;
        "pkg-1.8.17" = _nGsvzxrz;
        "pkg-1.8.18" = _ZdTWD9p6;
        "pkg-1.9.18" = _1DCqC3SR;
        "pkg-1.9.19+hotfix" = _oB5BQVUe;
        "pkg-1.9.19" = _YOBseqxU;
        "pkg-2.0.0+hotfix2" = _7ruBGgjw;
        "pkg-2.0.0+hotfix" = _1oxfonZQ;
        "pkg-2.1.0" = _12puo4sd;
