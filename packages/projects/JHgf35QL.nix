...
let
    versions = (let
        ...
        _pqEIf8Ia = {
            "id" = "pqEIf8Ia";
            "file" = "nemos-inventory-sorting-Fabric-26.2-1.22.jar";
            "hash" = "sha512-AkE5H9Ku2OwCJrFXAKOYLbJeKpMOEdvT30EoGR99ZDxzUs4eEWHTGvPi/k/7S+f/bYnmhh0WKMWDEHID4PO+vw==";
        };
        _xZw8OX0N = {
            "id" = "xZw8OX0N";
            "file" = "nemos-inventory-sorting-NeoForge-26.2-1.22.jar";
            "hash" = "sha512-LO2r2aWZfB5z+z8qxR3xp737ztNlUmDz8+GCbXcanU3Idv3DBJQv0gSE4rsUpwjoWWwN0K4UrCB/ikOJscgy7g==";
        };
        _VslGU7ii = {
            "id" = "VslGU7ii";
            "file" = "nemos-inventory-sorting-Forge-1.20.1-1.22-all.jar";
            "hash" = "sha512-gg1i59V85DwhNSWQ9C+tt4F3MsiTjasGA49z2Tbf+iG4EcyH0ut/+Q6+jBu8mTOb1PN/6/aWgGhBuLe7UiedoQ==";
        };
        _O3WMBYZm = {
            "id" = "O3WMBYZm";
            "file" = "nemos-inventory-sorting-Fabric-26.3-1.22.jar";
            "hash" = "sha512-xG7Gdcj4LY3N0EC9ECqlZss9Hds7B7BNZgtVItLhArOpkrfuClZxEPAdY29wtTAHXnqxn/0brQTDfJinG6wZWQ==";
        };
        _cCBhkMJ7 = {
            "id" = "cCBhkMJ7";
    ...
    in {
        ...
        "pkg-1.21.3-1.0.3" = _ASvHuN06;
        "pkg-1.21.3-1.0.3.1" = _2KShGphf;
        "pkg-1.21.3-1.1" = _P95lu4Cu;
        "pkg-1.21.4-1.1" = _LRRFzzPW;
        "pkg-1.21.3-1.1.1" = _ne3uUM18;
        "pkg-1.21.4-1.1.1" = _qbhnHsFa;
        "pkg-1.21.3-1.2" = _6jnJzvjg;
        "pkg-1.21.4-1.2" = _rijrjKdR;
        "pkg-1.21.3-1.2.1" = _Prn97Nb1;
        "pkg-1.21.4-1.2.1" = _hPEZkjpe;
        "pkg-1.21.3-1.3" = _RQ4tAyeH;
        "pkg-1.21.4-1.3" = _NVHcMrHE;
        "pkg-1.21.3-1.3.1" = _ysQ3SJeF;
        "pkg-1.21.4-1.3.1" = _AdnRpTE5;
        "pkg-1.21.3-1.4" = _94RK90Nm;
        "pkg-1.21.4-1.4" = _GsfxpOUL;
        "pkg-1.21.3-1.4.1" = _h9FkDmIa;
        "pkg-1.21.4-1.4.1" = _JRKW4bYW;
        "pkg-1.21.3-1.4.2" = _5Mwx7Ml8;
        "pkg-1.21.4-1.4.2" = _qjX4djgf;
        "pkg-1.21.3-1.5" = _p6NDOJiA;
        "pkg-1.21.4-1.5" = _q8fkN4kZ;
        "pkg-1.20.1-1.5.1" = _nyRI1ziF;
        "pkg-1.21.1-1.5.1" = _uaIICT1e;
        "pkg-1.21.3-1.5.1" = _xm9ZV7jw;
        "pkg-1.21.4-1.5.1" = _SXrJsFOp;
        "pkg-1.20.1-1.6" = _ff2H91ij;
        "pkg-1.21.1-1.6" = _DslVFisW;
        "pkg-1.21.3-1.6" = _p3aytCAR;
        "pkg-1.21.4-1.6" = _4ygXzWpz;
        "pkg-1.20.1-1.7" = _pNq0Mv7A;
        "pkg-1.21.1-1.7" = _ragheOps;
        "pkg-1.21.3-1.7" = _iIWAXPgf;
        "pkg-1.21.4-1.7" = _7WBLbF28;
        "pkg-1.20.1-1.7.1" = _hH0fMdK8;
        "pkg-1.21.1-1.7.1" = _riRYQuAv;
        "pkg-1.21.3-1.7.1" = _iPZhh0Ft;
        "pkg-1.21.4-1.7.1" = _b2Stf145;
        "pkg-1.19.2-1.7.2" = _6yqwhw9J;
        "pkg-1.20.1-1.7.2" = _OjBx62TF;
        "pkg-1.21.1-1.7.2" = _69vdNPjD;
        "pkg-1.21.3-1.7.2" = _NNrmcL7f;
        "pkg-1.21.4-1.7.2" = _yxK4VEeJ;
        "pkg-1.19.2-1.8" = _1HygjCL6;
        "pkg-1.20.1-1.8" = _gt9HwOn3;
        "pkg-1.21.1-1.8" = _1RpElreO;
        "pkg-1.21.3-1.8" = _1vHiqQ1m;
        "pkg-1.21.4-1.8" = _dGd7xx1h;
        "pkg-1.19.2-1.8.1" = _VBgL3ogW;
        "pkg-1.19.4-1.8.1" = _8FC7EUSW;
        "pkg-1.20.1-1.8.1" = _mpVRK9QT;
        "pkg-1.21.1-1.8.1" = _hteKoBk9;
        "pkg-1.21.3-1.8.1" = _jiGkitPI;
        "pkg-1.21.4-1.8.1" = _F74Wde4t;
        "pkg-1.21.5-1.8.1" = _EO0v4CLY;
        "pkg-1.21.1-1.8.1.1" = _mYQa4YEf;
        "pkg-1.20.1-1.8.2" = _pOv87pwc;
        "pkg-1.21.1-1.8.2" = _UqssIwhh;
        "pkg-1.21.4-1.8.2" = _3Cr1qQlu;
        "pkg-1.21.5-1.8.2" = _9DRsTtiJ;
        "pkg-1.21.1-1.8.2.1" = _Foc0173y;
        "pkg-1.21.5-1.8.3" = _7oGdSMYJ;
        "pkg-1.21.5-1.8.4" = _8qRnOkbL;
        "pkg-1.21.5-1.9" = _8osoD4JQ;
        "pkg-1.21.5-1.10" = _5tWd4mJP;
        "pkg-1.21.5-1.10.1" = _JzMn5Wb3;
        "pkg-1.21.5-1.11" = _VcPwUMAz;
        "pkg-1.21.5-1.11.0.1" = _QNqTfnTg;
        "pkg-1.21.6-1.11.1" = _sVVjSD0u;
        "pkg-1.21.6-1.11.2" = _c1tRcgdL;
        "pkg-1.21.5-1.11.2" = _NbYCXbGy;
        "pkg-1.21.5-1.12" = _n2P9bF8p;
        "pkg-1.21.6-1.12" = _YheptWXr;
        "pkg-1.21.7-1.12.1" = _JA4CSlmR;
        "pkg-1.21.5-1.12.2" = _Q7sFnR5Z;
        "pkg-1.21.7-1.12.2" = _hBItdM4Y;
        "pkg-1.21.8-1.12.3" = _RskCc1J3;
        "pkg-1.12.3.1" = _ReJJjdnR;
        "pkg-1.21.8-1.13" = _XJcxwQo1;
        "pkg-1.20.1-1.13" = _LonavrNv;
        "pkg-1.21.9-1.13" = _QrEeUrAP;
        "pkg-1.21.8-1.14" = _bqHNOzqX;
        "pkg-1.20.1-1.14" = _PCwm95Ek;
        "pkg-1.21.9-1.14" = _SUsRGPLm;
        "pkg-1.21.9-1.14.1" = _TP6iEmpi;
        "pkg-1.21.9-1.14.2" = _Qb5NHCqf;
        "pkg-1.21.10-1.14.2" = _VN6MpfPH;
        "pkg-1.20.1-1.14.3" = _5zJTmhTN;
        "pkg-1.21.8-1.14.3" = _kVPJ7mPC;
        "pkg-1.21.10-1.14.3" = _nyu2oqCM;
        "pkg-1.20.1-1.14.4" = _Pk7FRdGk;
        "pkg-1.21.8-1.14.4" = _PYyQU76o;
        "pkg-1.21.10-1.14.4" = _AYu3Nns6;
        "pkg-1.21.10-1.14.5" = _gmBed7Yl;
        "pkg-1.20.1-1.14.5" = _K0FguJ4J;
        "pkg-1.21.10-1.14.6" = _QGiJroHR;
        "pkg-1.21.10-1.14.7" = _Uq9Qn8XQ;
        "pkg-1.21.11-1.14.8" = _RBxOeaq8;
        "pkg-26.1-1.14.8" = _Hml0Bjwq;
        "pkg-26.1.2-1.14.8" = _ZcQ5H6yh;
        "pkg-26.1.2-1.14.9" = _cFgKX0UE;
        "pkg-26.1.2-1.15" = _iqakIOOU;
        "pkg-26.1.2-1.15.1" = _JlkkwmZO;
        "pkg-26.1.2-1.16" = _KltwC23y;
        "pkg-26.1.2-1.16.1" = _K7xI3Ubi;
        "pkg-26.1.2-1.17" = _QFvnfUnN;
        "pkg-26.1.2-1.17.1" = _RBnmH9O1;
        "pkg-1.21.11-1.14.9" = _VJmSL2Rh;
        "pkg-26.1.2-1.17.2" = _qyA39y9f;
        "pkg-26.1.2-1.18" = _W1MKHHJ8;
        "pkg-26.2-1.18" = _7wbnfhrN;
        "pkg-26.2-1.19" = _yQ4jMgoN;
        "pkg-26.2-1.20" = _TS5l6qRP;
        "pkg-26.2-1.20.1" = _evsJnqOU;
