...
let
    versions = (let
        ...
        _pqxhb9D4 = {
            "id" = "pqxhb9D4";
            "file" = "elytratrims-fabric-4.9.0-beta.4+26.3-snapshot-7.jar";
            "hash" = "sha512-NJaKLhE69AZ3vJFZRC4VcWJg1cW3wZ2KSQ9HxHxIVkIgeLcn5gOyqJO1PoRhXoKlHfa34NQm6mtirQ8IrBDnJA==";
        };
        _tc75p5Sf = {
            "id" = "tc75p5Sf";
            "file" = "elytratrims-neoforge-4.9.0-beta.5+26.1.2.jar";
            "hash" = "sha512-kuRTzf85U/SRU7aD2fNjDCATUZ/+kFkhIvSQXgIvFkxkvDtLIQE+W1/zLqd4rQZgX+e0ACbHSF9eMkYJmDy7qQ==";
        };
        _s51tXs9F = {
            "id" = "s51tXs9F";
            "file" = "elytratrims-neoforge-4.9.0-beta.5+26.2.jar";
            "hash" = "sha512-Uq2Rt+wnG+OJcfvP2PmSmrV+O3+/nxbNBQAWHW/Go7wVHV8alSmiOYfBBYSYsppGvQ/8qIkEg3pHieHD0X4lxA==";
        };
        _7TDdaNA9 = {
            "id" = "7TDdaNA9";
            "file" = "elytratrims-neoforge-4.9.0-beta.6+26.1.2.jar";
            "hash" = "sha512-DVmZ82tv8WTdGMBnAm0v3PGfKz6Gc+sGRh3hRAPk2S3vJrq/OPla7wIo9ugqZP9tblY/yUNfAPFLqgK7vRvwNQ==";
        };
        _Q3zhDzV4 = {
            "id" = "Q3zhDzV4";
            "file" = "elytratrims-fabric-4.9.0-beta.6+26.1.2.jar";
            "hash" = "sha512-P/wk3dvtt0NlRgfegHuFThuXZiCEa7xY0OSyMQwBtILGPP7Bo9plNa5ZCR9fH0zkcKePkpQW88CETldcj2VGVw==";
        };
        _Q8ntxqqX = {
            "id" = "Q8ntxqqX";
            "file" = "elytratrims-neoforge-4.9.0-beta.6+26.2.jar";
            "hash" = "sha512-aHLhmncEcF8oLeWeUJcQDzbFkmjJPa4S/VoHeIP564tOqOr7F4ehnarKgJboWZrotTjYsidHJd8vsq88b3Zx2Q==";
        };
        _X4BX7O9a = {
            "id" = "X4BX7O9a";
            "file" = "elytratrims-fabric-4.9.0-beta.6+26.2.jar";
            "hash" = "sha512-Pgxqk9cnKXvdVPxRb0Ku+LGrZG0H0MtT162mgVhDURApGTHYT5EecHqore1ejUhQrsgGuVomPnxZCMwauMap3w==";
        };
        _SLm95J8w = {
            "id" = "SLm95J8w";
            "file" = "elytratrims-fabric-4.9.0-beta.6+26.3-snapshot-10.jar";
            "hash" = "sha512-K2Uj3vteH8zpRTWmv2+roXolprFxWcuT8gortTbkjWL6MJiTNBCvVyaADZwJ6i+RSKTBLFbSy2F8zrqfdQGPUg==";
        };
        _6eusU1lF = {
            "id" = "6eusU1lF";
            "file" = "elytratrims-neoforge-4.9.0+26.1.2.jar";
            "hash" = "sha512-ZAH5toV5mZ0VkACsMzZvziijvWLuujLMhWtQs3GV+6EJcE9CwXvSL9iNSjVy8PPcloQrUBn/IrsVlXKu4+3swA==";
        };
        _3xm94UbA = {
            "id" = "3xm94UbA";
            "file" = "elytratrims-fabric-4.9.0+26.1.2.jar";
            "hash" = "sha512-+kOMBWAaVv3hhKNM4KKjLyuRu2MikoaoWx2tphamF9b/JnYlXvJdZKKv2gksM64yJUbJtRJR+ZYBGFInqg2uIg==";
        };
        _iBLfMta5 = {
            "id" = "iBLfMta5";
            "file" = "elytratrims-neoforge-4.9.0+26.2.jar";
            "hash" = "sha512-8o69m3akiwWu4q6rQxxWZFn/o1i939l2HTHTgXLr6NN4TC/HzedLebgyVp22ngCjDpEw4naZQRbjXcIh+vQtyw==";
        };
        _6vl1Qyl0 = {
            "id" = "6vl1Qyl0";
            "file" = "elytratrims-fabric-4.9.0+26.2.jar";
            "hash" = "sha512-gtDHOuLJItQyydc7auTw2U3d5CaWG9tz5N5Tj6Sd90aysbjl+YxCX92K8GOsl0ibVfvc2tzfgf4khUizXqnKcA==";
        };
        _ueVTWdRi = {
            "id" = "ueVTWdRi";
            "file" = "elytratrims-neoforge-4.9.0+26.3.jar";
            "hash" = "sha512-e3nKbGD1naqlI68WlIGUXR2DMWXGe4TeBkyhaDJX2LcbySi9EAuzkrYhyhZTvigPK7W1F9UmPmYi4EjOUezf5A==";
        };
        _zox5ML8k = {
            "id" = "zox5ML8k";
    ...
    in {
        ...
        "fabric-26.3-snapshot-6" = _SLm95J8w;
        "fabric-26.3-snapshot-7" = _SLm95J8w;
        ...
        "pkg-1.1.0+1.20" = _gL8hZ6Xj;
        "pkg-1.1.1" = _5yKVxto5;
        "pkg-1.1.2" = _mwodRBWG;
        "pkg-1.1.3" = _R7A2RmNK;
        "pkg-1.1.4" = _jElDTAm0;
        "pkg-1.1.4-build.2" = _kyavYZlv;
        "pkg-1.1.5" = _uF1aFX3B;
        "pkg-1.1.6" = _MggVxdpI;
        "pkg-1.1.7" = _HJTg637z;
        "pkg-1.1.8" = _ItisH5nP;
        "pkg-1.1.9" = _z0hix6ft;
        "pkg-1.1.10-beta.1" = _wmtpMrnl;
        "pkg-1.1.10-beta.2" = _ieLJPquL;
        "pkg-1.1.10-beta.3" = _bTCDAo8N;
        "pkg-1.1.10-beta.4" = _PIcktN29;
        "pkg-1.2.0" = _RdFl4K9L;
        "pkg-1.2.1" = _ymm44PMX;
        "pkg-1.2.2" = _OnEnlw0n;
        "pkg-1.3.0" = _agclFP3W;
        ...
        "pkg-1.3.2" = _BvemApH8;
        "pkg-1.3.3" = _iNTnYl5N;
        "pkg-1.4.0+1.19.4" = _xP4Gl1b0;
        "pkg-1.4.0+1.20.2" = _vAgQHF1X;
        "pkg-1.4.1+1.19.4" = _B4PnSTQu;
        "pkg-1.4.1+1.20.2" = _laqf3DSe;
        "pkg-1.4.1+1.20" = _oNITsVCz;
        "pkg-1.4.1+23w42a" = _1iryHhRb;
        "pkg-1.4.2+1.19.4" = _ymNEFvRO;
        "pkg-1.4.2+1.20" = _QRL5y6QQ;
        "pkg-1.4.2+1.20.2" = _uKJ1JMgM;
        "pkg-1.4.2+23w45a" = _pRDQnZ3Y;
        "pkg-1.4.3+1.19.4" = _VQvpXYIw;
        "pkg-1.4.3+1.20" = _cNldVpfM;
        "pkg-1.4.3+1.20.2" = _GgqWN3lN;
        "pkg-1.4.4+1.19.4" = _NHXd6aZk;
        "pkg-1.4.4+1.20" = _eA3xjW1D;
        "pkg-1.4.4+1.20.2" = _L0nFypDE;
        "pkg-1.4.5+1.19.4" = _Cw7vQBik;
        "pkg-1.4.5+1.20" = _UftAzqfE;
        "pkg-1.4.5+1.20.2" = _5XZ3UEKw;
        "pkg-1.4.5+1.20.4" = _Ooz6Jx4o;
        "pkg-2.0.0-beta" = _fktTheEn;
        "pkg-2.0.0-beta.2" = _YCgd5pGr;
        "pkg-2.0.0-beta.3" = _NEJZCAYP;
        "pkg-2.0.0-beta.4" = _A3BCJ4tn;
        "pkg-2.0.0" = _eLitxo2m;
        "pkg-2.0.1" = _sSXZ1cV2;
        "pkg-2.0.2" = _Ouu7QmnI;
        "pkg-2.0.3" = _MPlCfC6V;
        ...
        "pkg-3.5.5" = _PEanE9Jm;
        "pkg-3.5.6" = _mAbnOT56;
        "pkg-4.0.0-alpha.1+1.21.4" = _Do3D0n2F;
        "pkg-4.0.0-alpha.3+1.21.4" = _fwYUzPXg;
        "pkg-3.5.7" = _XwcGTiTn;
        "pkg-3.5.8" = _IPqZJnhD;
        "pkg-3.5.9" = _swlgoemm;
        "pkg-4.1.0" = _WkAUkcrL;
        ...
        "pkg-4.1.2" = _fsUHkJB0;
        "pkg-4.1.3" = _LpZIBJvB;
        "pkg-4.2.0-beta" = _HkNpQuMt;
        "pkg-4.2.0-beta.2" = _sGVaxi6V;
        "pkg-4.2.0-beta.3" = _ynKla3nc;
        "pkg-4.2.0" = _Ma9LAaeD;
        "pkg-4.2.1" = _JZ7gBWl7;
        "pkg-4.3.0" = _jzJewha7;
        "pkg-4.3.1" = _Uvf1BTCS;
        ...
        "pkg-4.7.3" = _NLOF6eKu;
        "pkg-4.7.4" = _emeBmDEl;
        "pkg-3.10.0" = _MsDKblMy;
        "pkg-4.8.0" = _kDcvBzBL;
        "pkg-4.8.1-beta" = _vKukmTGm;
        "pkg-4.8.1" = _zfXuuaop;
        "pkg-4.8.2" = _tKGLQKLD;
        "pkg-4.5.8" = _GuYLHDtX;
        "pkg-4.9.0-beta.1" = _zEkswka9;
        "pkg-4.9.0-beta.2" = _iNxADtAe;
        "pkg-4.9.0-beta.3" = _ckfj5opr;
        "pkg-4.8.3" = _xe4XXryG;
        "pkg-4.9.0-beta.4" = _pqxhb9D4;
