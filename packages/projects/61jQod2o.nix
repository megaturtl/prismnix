...
let
    versions = (let
        ...
        _p1neaNn0 = {
            "id" = "p1neaNn0";
            "file" = "paleworld-2.1.4-beta.3+26.1.2-fabric.jar";
            "hash" = "sha512-CK+6dNhU+1yGSFM7hcs3dWlEE9V9qI6Au5I0ouQ5Sv2XIFrsU7HCk3vR5JYZX6Z6hsoR9ChzVkUF9sX7ErZWuw==";
        };
        _A79DbsQX = {
            "id" = "A79DbsQX";
            "file" = "paleworld-2.1.4-beta.3+26.2-fabric.jar";
            "hash" = "sha512-pb+r3vB7VwTgpD3Ga1k9U/Y4jMBk3iFXQlGmyKbGP6XCx5L5q5GDvoa15h9x62I3cu53njICPwrebylAqkV61g==";
        };
    in {
        "UfbpMLYg" = _UfbpMLYg;
        "xq7o0mHi" = _xq7o0mHi;
        ...
        "fabric-26.1.2" = _p1neaNn0;
        "fabric-26.2" = _A79DbsQX;
        ...
        "pkg-1.0.0+Alpha.1" = _UfbpMLYg;
        "pkg-1.0.0+Alpha.2" = _xq7o0mHi;
        "pkg-1.0.0+Alpha.3" = _uhHUy2bT;
        "pkg-1.0.0+Alpha.4" = _ujBuIt3Q;
        "pkg-1.0.0+Alpha.5" = _vuhkdtCl;
        "pkg-1.0.0+Alpha.6" = _OXkXeaxJ;
        "pkg-1.0.0+Alpha.7" = _UUkLemKl;
        "pkg-1.0.0+Alpha.8" = _dzWUQlMr;
        "pkg-1.0.0+Beta.1" = _V0JDT3S7;
        "pkg-1.0.0+Beta.2" = _zMN4NZvs;
        "pkg-1.0.0+Beta.3" = _ZAXLlXpq;
        "pkg-1.0.0+Beta.4" = _2z5lM44v;
        "pkg-1.0.0+RC.1" = _NWpi3uqz;
        "pkg-1.0.0+RC.2" = _RlFmG4LE;
        "pkg-1.0.0+RC.3" = _4JNcYNTZ;
        "pkg-1.0.0" = _nErqYgPA;
        "pkg-1.1.0" = _a8QtohDA;
        "pkg-1.1.1" = _LoZTDl5j;
        "pkg-1.2.0" = _tdGxOfPb;
        "pkg-1.3.0" = _Raq2S8B5;
        "pkg-1.3.1" = _yj8fV2Ip;
        "pkg-2.0.0+Alpha.1" = _AIq1eNLp;
        "pkg-2.0.0+Alpha.2" = _p0wajQq0;
        "pkg-2.0.0+Alpha.3" = _yAXIzDdf;
        "pkg-2.0.0+Alpha.4" = _qk3KcC3h;
        "pkg-2.0.0+Alpha.5" = _hQ1lIjPP;
        "pkg-2.0.0+Alpha.6" = _QxMF70bH;
        "pkg-2.0.0+Alpha.7" = _zQkVvcy3;
        "pkg-2.0.0+Alpha.8" = _97Wk3J1E;
        "pkg-2.0.0+Beta.1" = _zNLwqaRo;
        "pkg-2.0.0" = _FwTWL5gr;
        "pkg-2.0.1" = _XDrmIZ4t;
        "pkg-2.0.2hf" = _g3Aj2zNZ;
        "pkg-2.1.0+Alpha.1" = _VBz5T2Bz;
        "pkg-2.1.0+Alpha.2" = _QAEl2rVK;
        "pkg-2.1.0+Alpha.3" = _YFV43XaG;
        "pkg-2.1.0+Alpha.4" = _HCy3MA7j;
        "pkg-2.1.0+Alpha.5" = _rc43FdDU;
        "pkg-2.1.0+Alpha.6" = _JoNnM3ib;
        "pkg-2.1.0+Alpha.7" = _pD1fgh4s;
        "pkg-2.1.0+Alpha.8" = _m2NkJsGT;
        "pkg-2.1.0+Alpha.9" = _gj3xzlyn;
        "pkg-2.1.0+Alpha.10" = _SlJHu6WE;
        "pkg-2.1.0+Alpha.11" = _VDxe12Tu;
        "pkg-2.1.0+Alpha.12" = _Mx6t8hpr;
        "pkg-2.1.0+Alpha.13-fabric" = _zyCpRTLx;
        "pkg-2.1.0+Alpha.14-fabric" = _U0gjLSDC;
        "pkg-2.1.0+Alpha.15-fabric" = _bAOrgtyM;
        "pkg-2.1.0+Beta.1-fabric" = _BoQIZn2W;
        "pkg-2.1.0+rc.1-fabric" = _WgOYBkoP;
        "pkg-2.1.0-fabric" = _bZ7wTwVZ;
        "pkg-2.1.1-fabric" = _CYYLUGgK;
        "pkg-2.1.2-alpha.1+1.21.10-fabric" = _FtjMzQke;
        "pkg-2.1.2-alpha.1+1.21.6-fabric" = _GupR4dnn;
        "pkg-2.1.2-alpha.1+1.21.11-fabric" = _Kjeq5SIO;
        "pkg-2.1.2-beta.1+1.21.6-fabric" = _7qBq3ACH;
        "pkg-2.1.2-beta.1+1.21.11-fabric" = _IZ2zFgOd;
        "pkg-2.1.2-beta.1+1.21.10-fabric" = _snbMU4Do;
        "pkg-2.1.2-beta.2+1.21.10-fabric" = _KmiJMEqV;
        "pkg-2.1.2-beta.2+1.21.6-fabric" = _fun0QGzj;
        "pkg-2.1.2-beta.2+1.21.11-fabric" = _C3MZf8Q7;
        "pkg-2.1.2+1.21.11-fabric" = _swyXzsHA;
        "pkg-2.1.2+1.21.6-fabric" = _GIRKCisX;
        "pkg-2.1.2+1.21.10-fabric" = _rQTL0MGP;
        "pkg-2.1.3+1.21.6-fabric" = _tA6bCwYN;
        "pkg-2.1.3+1.21.11-fabric" = _YJLmoOFH;
        "pkg-2.1.3+1.21.10-fabric" = _IUb7eFpn;
        "pkg-2.1.3-alpha.1+26.1.2-fabric" = _Bocf1zxd;
        "pkg-2.1.4-beta.1+26.1.2-fabric" = _XsDq5c4k;
        "pkg-2.1.4-beta.2+26.1.2-fabric" = _Six41zT2;
        "pkg-2.1.4-beta.2+26.2-fabric" = _xKmMIpXw;
        "pkg-2.1.4-beta.3+26.1.2-fabric" = _p1neaNn0;
        "pkg-2.1.4-beta.3+26.2-fabric" = _A79DbsQX;
        "default" = _A79DbsQX;
    });
