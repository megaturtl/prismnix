...
let
    ...
    in {
        ...
        "pkg-1.0+1.21.1" = _eddKeFXP;
        "pkg-1.0.1+1.21.3" = _N9fdUQBg;
        "pkg-1.1+1.21.4" = _U3M7FEWR;
        "pkg-1.1+1.21.5" = _OKErDkYR;
        "pkg-1.1+1.21.6" = _jmlj6qkL;
        "pkg-1.1+1.21.7" = _B4H79usm;
        "pkg-1.1+1.21.9" = _iG1FWwfx;
