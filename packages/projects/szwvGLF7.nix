...
let
    versions = (let
        ...
        _yvVvgSGb = {
            "id" = "yvVvgSGb";
            "file" = "blastingstone-1.18.2-fabric-3.jar";
            "hash" = "sha512-IUUHdlCx4cyi/sXphH0E4Yvve7ySRjKU/CUW7toL4Fm0bnZz1miER2QJucCDDbqeMna/4EMqX8wkBjHNvUrSfw==";
        };
        _n7fUctxS = {
            "id" = "n7fUctxS";
            "file" = "blastingstone-1.18.2-forge-3.jar";
            "hash" = "sha512-WR4nxKcR0Ab+w91xyG29hJG/MBsL9sNJ9vW5v5RZqwNcXVccepIBeuB0CCg3p6kn+KLMzeQWNAJndY6yTKPu6A==";
        };
        _5dG9kQkb = {
            "id" = "5dG9kQkb";
            "file" = "blastingstone-1.19.2-fabric-3.jar";
            "hash" = "sha512-0ow2tXEN58kxkfLFX6uOdY1BLSlWyER537fDMS6RAjTHsOVBUoBhuWuEp3slv663JwvuHT92n7ur8NsNWhHGCA==";
        };
        _tTpzMfxO = {
            "id" = "tTpzMfxO";
            "file" = "blastingstone-1.19.2-forge-3.jar";
            "hash" = "sha512-C15Hy1k98tLetItKM6z7gZ8OWhuA3AiqKTlf9uCz9zD1XPGlY9hLpTob+yyUFl6S2JD1E43nAwqDG58hbyu/hA==";
        };
        _vc3X0rlh = {
            "id" = "vc3X0rlh";
            "file" = "blastingstone-1.20.1-fabric-3.jar";
            "hash" = "sha512-+91RukVjBcOrO53xNf/voMydUpguewWcLsRZI95fk0EycMUBXdttQ71gEQC21tt3YyE6cc/cfVVx8Fu+hRCV+Q==";
        };
        _7bBaIhQi = {
            "id" = "7bBaIhQi";
            "file" = "blastingstone-1.20.1-forge-3.jar";
            "hash" = "sha512-B49Z5QXGNhBccjJQFLOcLag/r3DgIWifcs47eX5iyJiO55eAU7uW5WJAvJ+n0rq261L5Rot7UzZkASAkQ8CMug==";
        };
        _ka8p2xLY = {
            "id" = "ka8p2xLY";
            "file" = "blastingstone-1.21.1-fabric-3.jar";
            "hash" = "sha512-mPHScNGh9rmJCg1MWn2p6Gqd0VOv0SBqepB/GcrHhqZ03Qi5PKPU4qQOsH7XRt/YUJlUhpCgnScAgUTSqyYR+g==";
        };
        _ffGljQDC = {
            "id" = "ffGljQDC";
            "file" = "blastingstone-1.21.1-forge-3.jar";
            "hash" = "sha512-Gy6yfMWHn44mLjZ3zAGMfsZbxJEhUJFddv1v7kxf7025Kpnm6C02A9tSwck/3DFSOq5UhmUsno0wyfFo+RnGhQ==";
        };
        _IuPqZHYv = {
            "id" = "IuPqZHYv";
            "file" = "blastingstone-1.21.1-neoforge-3.jar";
            "hash" = "sha512-UVKK8DrA/qezYyMqoCrYGwansivUX1SWVRqhXR30twk6zPOFsGrmP7hacaU1DDNB8kuUvpKT+9su3BQjJfMmow==";
        };
        _gLsQ0oPu = {
            "id" = "gLsQ0oPu";
            "file" = "blastingstone-26.1.2-fabric-3.jar";
            "hash" = "sha512-RfHWShsQs4nYU5eLTVGai9YcX+dvH/qpYSq9Tyliqt8oqITQmP9fgzK5xXFUrWWNPSLlD/eoM/HND6vXwRX+EQ==";
        };
        _L5G4xsjQ = {
            "id" = "L5G4xsjQ";
            "file" = "blastingstone-26.1.2-forge-3.jar";
            "hash" = "sha512-be9y5A1lQdkp+mGo2226CR9nXIhOye/h1fx61ebNA+uxSo+dC6c12zgy9aFQ5XydGDp7pTfOO1yJdIzGACSzMg==";
        };
        _XQFIhVUh = {
            "id" = "XQFIhVUh";
            "file" = "blastingstone-26.1.2-neoforge-3.jar";
            "hash" = "sha512-F06sCW77f1YUw3AItIMG4uDNRCyC0TBFH8kAEqzlPURt9/xlOwmuAGwGgGVVkkJvqRhd66JwRjfs0AjVHcGUmw==";
        };
        _XRUr74ar = {
            "id" = "XRUr74ar";
            "file" = "blastingstone-26.2-fabric-3.jar";
            "hash" = "sha512-mB9rjmEHfRurQSp5FUT7YJnhAbImFrZpet7z1p38rQ3tNcyn6l7zXDD17rtHC9qrMxjIYGgqyA2UUj3RqB6csQ==";
        };
        _GqdITZ2d = {
            "id" = "GqdITZ2d";
            "file" = "blastingstone-26.2-forge-3.jar";
            "hash" = "sha512-QB0QwdvzWe59YMwnk+V4BX5Mq6Jvfh1cmBfwbxJ+7RncRSZyJzN4BB1LVipNU7y2D/YhH0vMpm1BWkNlvP8h7g==";
        };
        _4Wd7ajqB = {
            "id" = "4Wd7ajqB";
            "file" = "blastingstone-26.2-neoforge-3.jar";
            "hash" = "sha512-DGUFciLQ3WsoUZzmR99d9yhtAco/l+2K0V7WcuXevs/XnmH7st0xtCrZmqjZ6BzXSfDgATnQ3+2bvjLAKrMUzw==";
        };
    in {
        "DTFqFJUA" = _DTFqFJUA;
        "GzVgF775" = _GzVgF775;
        ...
        "fabric-1.18" = _yvVvgSGb;
        "fabric-1.18.1" = _yvVvgSGb;
        "fabric-1.18.2" = _yvVvgSGb;
        "fabric-1.19" = _5dG9kQkb;
        "fabric-1.19.1" = _5dG9kQkb;
        "fabric-1.19.2" = _5dG9kQkb;
        "fabric-1.19.3" = _GzVgF775;
        "fabric-1.19.4" = _aymzj4mm;
        "fabric-1.20" = _vc3X0rlh;
        "fabric-1.20.1" = _vc3X0rlh;
        "fabric-1.20.2" = _h1iuX2vC;
        "fabric-1.20.3" = _1vUg1b6c;
        "fabric-1.20.4" = _1vUg1b6c;
        "fabric-1.20.5" = _KOsmsqeb;
        "fabric-1.20.6" = _KOsmsqeb;
        "fabric-1.21" = _ka8p2xLY;
        "fabric-1.21.1" = _ka8p2xLY;
        ...
        "fabric-26.1" = _gLsQ0oPu;
        "fabric-26.1.1" = _gLsQ0oPu;
        "fabric-26.1.2" = _gLsQ0oPu;
        "fabric-26.2" = _XRUr74ar;
        ...
        "forge-1.18" = _n7fUctxS;
        "forge-1.18.1" = _n7fUctxS;
        "forge-1.18.2" = _n7fUctxS;
        "forge-1.19" = _tTpzMfxO;
        "forge-1.19.1" = _tTpzMfxO;
        "forge-1.19.2" = _tTpzMfxO;
        "forge-1.19.3" = _GzVgF775;
        "forge-1.19.4" = _mTZBXs4a;
        "forge-1.20" = _7bBaIhQi;
        "forge-1.20.1" = _7bBaIhQi;
        "forge-1.20.2" = _eizYp4Bl;
        "forge-1.20.3" = _kzdu1y3o;
        "forge-1.20.4" = _kzdu1y3o;
        "forge-1.20.6" = _gvY8YiAw;
        "forge-1.21" = _ffGljQDC;
        "forge-1.21.1" = _ffGljQDC;
        ...
        "forge-26.1" = _L5G4xsjQ;
        "forge-26.1.1" = _L5G4xsjQ;
        "forge-26.1.2" = _L5G4xsjQ;
        "forge-26.2" = _GqdITZ2d;
        ...
        "quilt-1.18" = _yvVvgSGb;
        "quilt-1.18.1" = _yvVvgSGb;
        "quilt-1.18.2" = _yvVvgSGb;
        "quilt-1.19" = _5dG9kQkb;
        "quilt-1.19.1" = _5dG9kQkb;
        "quilt-1.19.2" = _5dG9kQkb;
        "quilt-1.19.3" = _GzVgF775;
        "quilt-1.19.4" = _aymzj4mm;
        "quilt-1.20" = _vc3X0rlh;
        "quilt-1.20.1" = _vc3X0rlh;
        "quilt-1.20.2" = _h1iuX2vC;
        "quilt-1.20.3" = _1vUg1b6c;
        "quilt-1.20.4" = _1vUg1b6c;
        "quilt-1.20.5" = _KOsmsqeb;
        "quilt-1.20.6" = _KOsmsqeb;
        "quilt-1.21" = _ka8p2xLY;
        "quilt-1.21.1" = _ka8p2xLY;
        ...
        "quilt-26.1" = _gLsQ0oPu;
        "quilt-26.1.1" = _gLsQ0oPu;
        "quilt-26.1.2" = _gLsQ0oPu;
        "quilt-26.2" = _XRUr74ar;
        "neoforge-1.20.4" = _Rdr04kjW;
        "neoforge-1.20.6" = _C92PHUGa;
        "neoforge-1.21" = _IuPqZHYv;
        "neoforge-1.21.1" = _IuPqZHYv;
        "neoforge-1.21.2" = _AKRFAd1i;
        "neoforge-1.21.3" = _AKRFAd1i;
        "neoforge-1.21.4" = _a3gNotKZ;
        "neoforge-1.20" = _7bBaIhQi;
        "neoforge-1.20.1" = _7bBaIhQi;
        ...
        "neoforge-26.1" = _XQFIhVUh;
        "neoforge-26.1.1" = _XQFIhVUh;
        "neoforge-26.1.2" = _XQFIhVUh;
        "neoforge-26.2" = _4Wd7ajqB;
        "pkg-all" = _DTFqFJUA;
        "pkg-mod" = _GzVgF775;
        ...
        "pkg-1.18.2-fabric-3" = _yvVvgSGb;
        "pkg-1.18.2-forge-3" = _n7fUctxS;
        "pkg-1.19.2-fabric-3" = _5dG9kQkb;
        "pkg-1.19.2-forge-3" = _tTpzMfxO;
        "pkg-1.20.1-fabric-3" = _vc3X0rlh;
        "pkg-1.20.1-forge-3" = _7bBaIhQi;
        "pkg-1.21.1-fabric-3" = _ka8p2xLY;
        "pkg-1.21.1-forge-3" = _ffGljQDC;
        "pkg-1.21.1-neoforge-3" = _IuPqZHYv;
        "pkg-26.1.2-fabric-3" = _gLsQ0oPu;
        "pkg-26.1.2-forge-3" = _L5G4xsjQ;
        "pkg-26.1.2-neoforge-3" = _XQFIhVUh;
        "pkg-26.2-fabric-3" = _XRUr74ar;
        "pkg-26.2-forge-3" = _GqdITZ2d;
        "pkg-26.2-neoforge-3" = _4Wd7ajqB;
        "default" = _4Wd7ajqB;
    });
