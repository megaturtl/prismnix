...
let
    ...
    in {
        ...
        "pkg-0.9.3-Forge-mc1.20.1" = _R8zPPoFD;
        "pkg-0.9.4-Forge-mc1.20.1" = _ZU9EMys4;
        "pkg-0.9.4-Fabric-mc1.20.1" = _TW8XEAht;
        "pkg-0.9.4-Forge-mc1.19.2" = _ZQ5uzgln;
        "pkg-0.9.5-Forge-mc1.20.1" = _vvXTFDKg;
        "pkg-0.9.5-Forge-mc1.19.2" = _X1WcbqxT;
        "pkg-0.9.6-Forge-mc1.19.2" = _rLGsHfcv;
        "pkg-0.9.6-Forge-mc1.20.1" = _IAZnDRlA;
        "pkg-0.9.6-Fabric-mc1.20.1" = _5128y3eK;
        "pkg-0.9.7-NeoForge-mc1.21" = _7G7rHEem;
        "pkg-0.9.7-Fabric-mc1.21" = _E2FaME5w;
        "pkg-0.9.8-Forge-mc1.19.2" = _dTNpmUBz;
        "pkg-0.9.8-Forge-mc1.20.1" = _lbWLttx0;
        "pkg-0.9.8-Fabric-mc1.20.1" = _SppftEBe;
        "pkg-0.9.8-NeoForge-mc1.21" = _uza1nAUj;
        "pkg-0.9.8-Fabric-mc1.21" = _TJ9C8Q8H;
        "pkg-0.9.9-Forge-mc1.19.2" = _a6ANHtIt;
        "pkg-0.9.9-Forge-mc1.20.1" = _jry3JtzG;
        "pkg-0.9.9-Fabric-mc1.20.1" = _X3AgXp6x;
        "pkg-0.9.9-NeoForge-mc1.21" = _YpcTbw8j;
        "pkg-0.9.9-Fabric-mc1.21" = _fa4032oh;
        "pkg-1.0.0-Forge-mc1.20.1" = _BLXbshkr;
        "pkg-1.0.1-Forge-mc1.20.1" = _fJ9UakSz;
        "pkg-1.0.2-Fabric-mc1.20.1" = _oNwUKC1J;
        "pkg-1.0.2-Forge-mc1.19.2" = _XkPArN1A;
        "pkg-1.0.2-Fabric-mc1.21" = _6uv5PxCw;
        "pkg-1.1.0-Forge-mc1.19.2" = _dCIOwKTu;
        "pkg-1.1.0-Fabric-mc1.20.1" = _DoSg0I75;
        "pkg-1.1.0-Forge-mc1.20.1" = _X7iMk8dC;
        "pkg-1.1.0-NeoForge-mc1.21" = _Scy59qXU;
        "pkg-1.1.0-Fabric-mc1.21" = _JXRYhlmd;
        "pkg-1.1.0-NeoForge-mc1.21.6" = _czVtKe54;
        "pkg-1.1.0-Fabric-mc1.21.6" = _WuQaARYS;
        "pkg-1.1.0-Fabric-mc1.21.9" = _Euyu7kSu;
        "pkg-1.1.0-NeoForge-mc1.21.9" = _cYt4plCN;
        "pkg-1.2.0-Forge-mc1.19.2" = _AeE3lkaM;
        "pkg-1.3.0-Forge-mc1.19.2" = _6vqHsUHh;
        "pkg-1.3.0-Forge-mc1.20.1" = _aqNTI2Md;
        "pkg-1.3.0-Fabric-mc1.20.1" = _lkm0kbYo;
        "pkg-1.3.1-Forge-mc1.19.2" = _LSLW2eUV;
        "pkg-1.3.1-Forge-mc1.20.1" = _BlMRgoS0;
        "pkg-1.3.1-Fabric-mc1.20.1" = _21xCwnnm;
        "pkg-1.3.1-NeoForge-mc1.21" = _h1OOHldk;
        "pkg-1.3.1-Fabric-mc1.21" = _FEy2ghHi;
        "pkg-1.3.1-Fabric-mc1.21.6" = _s90fUV7k;
        "pkg-1.3.1-NeoForge-mc1.21.6" = _Hob4lRVc;
        "pkg-1.3.1-Fabric-mc1.21.9" = _YkDfBapP;
        "pkg-1.3.1-NeoForge-mc1.21.9" = _h6tU2nqv;
        "pkg-1.3.1-NeoForge-mc1.21.4" = _hJcQnc8R;
        "pkg-1.3.2-Forge-mc1.20.1" = _4F0aj0tI;
        "pkg-1.3.2-Fabric-mc1.21" = _SbbXkFkw;
        "pkg-1.4.0-Fabric-mc1.21.6" = _zn1GmlLH;
        "pkg-1.3.1-Fabric-mc1.21.11" = _pryc8hr7;
        "pkg-1.3.1-NeoForge-mc1.21.11" = _qh2J9jv2;
        "pkg-1.3.3-NeoForge-mc1.21.9" = _zl8zJf2W;
        "pkg-1.3.3-NeoForge-mc1.21.11" = _3vuNyxDZ;
