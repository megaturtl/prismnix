...
let
    ...
    in {
        ...
        "pkg-4.0.0+1.19_forge" = _mLZW5DCr;
        "pkg-4.0.0+1.19_fabric" = _7xw00Cft;
        "pkg-4.0.1+1.19_forge" = _2jAzAxEJ;
        "pkg-4.0.2+1.19_forge" = _mOabuenB;
        "pkg-4.1.0+1.19.2_forge" = _SQQVQKnd;
        "pkg-4.1.0+1.19.2_fabric" = _JQwOqtdR;
        "pkg-4.1.1+1.19.3_forge" = _4Qnkdflc;
        "pkg-4.1.1+1.19.3_fabric" = _LGqWpBfO;
        "pkg-4.1.2+1.19.3_fabric" = _vmvAwPb8;
        "pkg-4.1.2+1.19.3_forge" = _n4fntzyl;
        "pkg-4.1.3+1.19.3_forge" = _bnWWoWTM;
        "pkg-4.1.3+1.19.3_fabric" = _FpFk5n8n;
        "pkg-4.1.4+1.19.3_forge" = _3rp9BAVV;
        "pkg-4.1.4+1.19.3_fabric" = _27o4jJF9;
        "pkg-4.2.0+1.19.3_forge" = _V7vOzgFO;
        "pkg-4.2.0+1.19.3_fabric" = _S9teU6fI;
        "pkg-4.2.0+1.19.2_fabric" = _7Rp4p7PP;
        "pkg-4.2.0+1.19.2_forge" = _dU6USrMt;
        "pkg-4.2.1+1.19.3_forge" = _r9B8DYI6;
        "pkg-4.2.1+1.19.3_fabric" = _iLx3nPL7;
        "pkg-4.2.1+1.19.2_fabric" = _b37mdgpX;
        "pkg-4.2.1+1.19.2_forge" = _SM22hpf1;
        "pkg-4.2.2+1.19.2_fabric" = _3cn6xwv4;
        "pkg-4.2.2+1.19.3_fabric" = _CPSiOx86;
        "pkg-4.2.3+1.19.4_fabric" = _3GZPt1vk;
        "pkg-4.2.2+1.19.4_forge" = _eopsMzNH;
        "pkg-4.2.3+1.19.2" = _i9HEa3aw;
        "pkg-4.2.3+1.19.4_forge" = _PYvVfJUa;
        "pkg-4.2.4+1.19.2_fabric" = _XPaYGHgl;
        "pkg-4.2.4+1.19.4_fabric" = _hTgu5iUQ;
        "pkg-4.2.4+1.20.1_forge" = _zfj5TFEF;
        "pkg-4.2.5+1.20.1_fabric" = _BjF04fHH;
        "pkg-4.2.6+1.20.1_forge" = _zok0ZoAJ;
        "pkg-4.2.6+1.20.1_fabric" = _C2A8iY4E;
        "pkg-4.2.7+1.20.1_fabric" = _te56DL5J;
        "pkg-4.3.0+1.20.2_neoforge" = _79xRp4Rg;
        "pkg-4.3.1+1.20.6_neoforge" = _rs9jUax2;
        "pkg-4.2.8+1.20.6_fabric" = _91RIvlMC;
        "pkg-4.4.0+1.21.0_neoforge" = _BsWZ1dAk;
        "pkg-4.4.0+1.21_fabric" = _LjRifZgZ;
        "pkg-4.4.1+1.21-fabric" = _gy8PDapR;
        "pkg-4.4.1+1.21-neoforge" = _FN4dncqp;
        "pkg-4.4.2+1.21.1-fabric" = _eGILIYmM;
        "pkg-4.4.2+1.21.1-neoforge" = _EYv0iXCx;
        "pkg-4.5.0+1.21.4-Fabric" = _tTAdWghr;
        "pkg-4.5.0+1.21.4-Neoforge" = _7Yu7WF7b;
        "pkg-4.4.3+1.21.1-neoforge" = _J7wACBlm;
        "pkg-4.5.1+1.21.5" = _xJvbQXN3;
        "pkg-4.5.1+1.21.6" = _D8jyeoqd;
        "pkg-4.5.2+1.21.6" = _FGTXZjLL;
        "pkg-4.5.3+1.21.9" = _Dx1R8IqC;
        "pkg-4.5.3+1.21.10" = _MBw3f2Vt;
        "pkg-4.5.3+1.21.11" = _LZt4N7MI;
        "pkg-4.5.3+26.1" = _yrAKrQiW;
