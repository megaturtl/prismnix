...
let
    ...
    in {
        ...
        "pkg-3.1.0" = _i4ZXOncI;
        "pkg-1.1.12" = _k04vdVP4;
        "pkg-1.1.13" = _3QltiwZ9;
        "pkg-1.2.0" = _ahxnI5KE;
        "pkg-3.2.0" = _YWk98t7q;
        "pkg-1.2.1" = _xOOSzn8p;
        "pkg-3.2.1" = _yDlx34u2;
        ...
        "pkg-9.0.5" = _ky1ugIA7;
        "pkg-9.0.6" = _w6bQVkBq;
        "pkg-9.0.11" = _HfFzn8xI;
        "pkg-10.0.0" = _6DiyaRxa;
        "pkg-21.4.15" = _aZKh344K;
        "pkg-21.5.0" = _WwSyQ1KZ;
        "pkg-21.5.1" = _hVlfiFbN;
        "pkg-21.5.9" = _4DVaFqky;
        "pkg-21.6.0" = _DCmRz3ut;
        "pkg-21.7.0" = _XBoiPJ7f;
        "pkg-21.7.2" = _bVKylRFI;
        "pkg-21.10.0" = _BKpL1eek;
        "pkg-21.11.0" = _DfVf83F8;
        "pkg-26.1.0" = _zHHAMbfN;
