...
let
    versions = (let
        ...
        _2fPzW7KM = {
            "id" = "2fPzW7KM";
            "file" = "CooParticlesAPI-NeoForge-1.21.1-2.5.5.3.jar";
            "hash" = "sha512-ItZOCeoR5Pdhe2Pn1UVL9zFgAE9T/1qJJXJec3j0zASuU4C9H9+8+txrla2U1JHdAm2CPz1fXvosS2wpW9Hshg==";
        };
        _wDmAuyRo = {
            "id" = "wDmAuyRo";
            "file" = "CooParticlesAPI-Fabric-1.21.1-2.5.5.3.jar";
            "hash" = "sha512-RwWkf7VhDwk7rwzQR35/W8pseq/e3c1iAUmA5w/MaVy1HyKrsIXDOT12H45dw1px6n6rMg7WQCdu6YKn7SVpWA==";
        };
    in {
        "FNL5sRCY" = _FNL5sRCY;
        "uUIT0fSX" = _uUIT0fSX;
        ...
        "2fPzW7KM" = _2fPzW7KM;
        "wDmAuyRo" = _wDmAuyRo;
        "fabric-1.21.1" = _wDmAuyRo;
        "neoforge-1.21.1" = _2fPzW7KM;
        "pkg-1.9" = _FNL5sRCY;
        "pkg-1.9.2" = _uUIT0fSX;
        "pkg-1.9.3" = _66Lv3lnI;
        "pkg-1.10.0" = _DiebDgPY;
        "pkg-1.10.1" = _GSmdQAsm;
        "pkg-1.10.2" = _Jck6eRIP;
        "pkg-1.11.0" = _sHbGXTqw;
        "pkg-1.11.1" = _vrp5i6yU;
        "pkg-2.0.0" = _U5YwBtWI;
        "pkg-2.0.1" = _4eOK6E6r;
        "pkg-2.0.2" = _J59CyHEs;
        "pkg-2.1.1" = _d2agObkH;
        "pkg-2.2.4" = _y0QZbcjT;
        "pkg-2.2.4.2" = _7f7gPHVk;
        "pkg-2.4.3" = _zsK3j4G2;
        "pkg-2.4.3.3" = _7pOvWjMW;
        "pkg-2.4.3.4" = _2ndvEtFq;
        "pkg-2.5.5.3" = _wDmAuyRo;
        "default" = _wDmAuyRo;
    });
