...
let
    versions = (let
        ...
        _mJRuVshF = {
            "id" = "mJRuVshF";
            "file" = "motionblur_v2.0.zip";
            "hash" = "sha512-gdSgc+g3IDl1NpQdRKysPVunxAAkdENAmca651cRlKK6RX0bShp+02cEU/frkTHZwsQ2mMHrO3cbeMY+GiBUlA==";
        };
    in {
        "EkpyiqN6" = _EkpyiqN6;
        "qaa9z6Cy" = _qaa9z6Cy;
        ...
        "iris-1.20" = _mJRuVshF;
        "iris-1.20.1" = _mJRuVshF;
        "iris-1.20.2" = _mJRuVshF;
        "iris-1.20.3" = _mJRuVshF;
        "iris-1.20.4" = _mJRuVshF;
        "iris-1.20.5" = _mJRuVshF;
        "iris-1.20.6" = _mJRuVshF;
        "iris-1.21" = _mJRuVshF;
        "iris-1.21.1" = _mJRuVshF;
        "iris-1.9.3" = _aIEszPi2;
        "iris-1.9.4" = _aIEszPi2;
        "iris-1.10" = _aIEszPi2;
        "iris-1.10.1" = _aIEszPi2;
        "iris-1.10.2" = _aIEszPi2;
        "iris-1.21.2" = _mJRuVshF;
        "iris-1.21.3" = _mJRuVshF;
        "iris-1.21.4" = _mJRuVshF;
        "iris-1.21.5" = _mJRuVshF;
        "iris-1.21.6" = _mJRuVshF;
        "iris-1.21.7" = _mJRuVshF;
        "iris-1.21.8" = _mJRuVshF;
        "iris-1.21.9" = _mJRuVshF;
        "iris-1.21.10" = _mJRuVshF;
        "iris-1.21.11" = _mJRuVshF;
        ...
        "optifine-1.20" = _mJRuVshF;
        "optifine-1.20.1" = _mJRuVshF;
        "optifine-1.20.2" = _mJRuVshF;
        "optifine-1.20.3" = _mJRuVshF;
        "optifine-1.20.4" = _mJRuVshF;
        "optifine-1.20.5" = _mJRuVshF;
        "optifine-1.20.6" = _mJRuVshF;
        "optifine-1.21" = _mJRuVshF;
        "optifine-1.21.1" = _mJRuVshF;
        ...
        "optifine-1.21.2" = _mJRuVshF;
        "optifine-1.21.3" = _mJRuVshF;
        "optifine-1.21.4" = _mJRuVshF;
        "optifine-1.21.5" = _mJRuVshF;
        "optifine-1.21.6" = _mJRuVshF;
        "optifine-1.21.7" = _mJRuVshF;
        "optifine-1.21.8" = _mJRuVshF;
        "optifine-1.21.9" = _mJRuVshF;
        "optifine-1.21.10" = _mJRuVshF;
        "optifine-1.21.11" = _mJRuVshF;
        "pkg-1.0" = _EkpyiqN6;
        "pkg-1.1" = _qaa9z6Cy;
        "pkg-1.2" = _aIEszPi2;
        "pkg-1.3" = _1AZzRPcK;
