...
let
    versions = (let
        ...
        _NcdHJ6V0 = {
            "id" = "NcdHJ6V0";
            "file" = "hearts_light_blue-1.1.0-mc26.3.zip";
            "hash" = "sha512-FB/491P6QORQErCHQu+MTLuAAGE709Z8HkcdjwPf5u94NThWsPErVD2o7eBbUMAaQJkGYq2WRyvNvFrTGrR84w==";
        };
    in {
        "SLwy1Si3" = _SLwy1Si3;
        "qO5CQU4M" = _qO5CQU4M;
