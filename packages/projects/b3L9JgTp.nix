...
let
    ...
    in {
        ...
        "pkg-21.1-r1.1" = _KdEdfdGj;
        "pkg-21.11-r1.2" = _1WCWMZFK;
        "pkg-21.1-r1.2" = _aKX85fUj;
        "pkg-21.11-r1.3" = _VYO8tblG;
        "pkg-21.1-r2.0" = _bi7KJNoS;
        "pkg-21.11-r2.0" = _b88l1djW;
        "pkg-21.1-r2.0.1" = _rzNsVNYD;
        "pkg-21.11-r2.0.1" = _dqHWG9hK;
        "pkg-21.1-r2.1" = _DEkoCOwi;
        "pkg-21.11-r3.0" = _DyWIc3Bg;
        "pkg-21.11-r3.1" = _BDeP2EMk;
        "pkg-21.11-r3.2" = _CcWVYxzf;
        "pkg-21.1-r2.2" = _hBPN7m4P;
        "pkg-21.11-r3.3" = _bVVs85Ae;
        "pkg-21.11-r3.4" = _hCIqurJf;
        "pkg-21.11-r3.5" = _e9TiRYzd;
        "pkg-21.11-r3.6" = _PcqC4VBz;
        "pkg-21.11-r3.7" = _SDygQWLC;
        "pkg-21.1-r2.3" = _wSBXJNQd;
        "pkg-21.11-r3.8" = _igHJT11G;
        "pkg-21.1-r3.0" = _94p9voKS;
        "pkg-21.11-r4.0" = _CUlSooyu;
        "pkg-21.1-r4.0" = _eFwlOoME;
        "pkg-21.11-r5.0" = _IiBxj3AN;
        "pkg-21.1-r4.2" = _gd2wKGKN;
        "pkg-21.11-r5.3" = _j3vIoYVd;
        "pkg-21.1-r4.3" = _APP8ewvb;
        "pkg-21.11-r5.4" = _8x3IqTTC;
        "pkg-21.11-r5.5" = _RTd7IqwL;
        "pkg-21.11-r5.5.1" = _UBVrzcAg;
        "pkg-21.11-r5.5.2" = _hTmtscxL;
        "pkg-21.11-r5.5.3" = _HyK7YQO9;
        "pkg-21.1-r4.4" = _lOO1Yo8n;
        "pkg-21.1-r4.5" = _dUmYwkFX;
        "pkg-21.11-r5.6" = _PJ2tc8kY;
        "pkg-21.1-r4.6" = _EkMrXK5U;
        "pkg-21.11-r5.7" = _Ri1WzuFA;
        "pkg-21.11-r6.0-neoforge" = _2a3C1tmV;
        "pkg-21.11-r6.0-fabric" = _kyH6q9vP;
        "pkg-21.11-r6.0.1-neoforge" = _ZNwg9zhY;
        "pkg-21.11-r6.0.1-fabric" = _9eYBTtUS;
        "pkg-21.1-r4.7" = _3uO1JbIc;
        "pkg-21.11-r6.1-neoforge" = _X1sy8bnS;
        "pkg-21.11-r6.1-fabric" = _yPmOOLPK;
        "pkg-21.1-r4.8" = _oixl2GuX;
        "pkg-21.11-r6.2-neoforge" = _AVSuhgNN;
        "pkg-21.11-r6.2-fabric" = _rr4cC4yn;
        "pkg-21.1-r4.9" = _Xxewj3rV;
        "pkg-21.11-r6.3-neoforge" = _I8JptfOM;
        "pkg-21.11-r6.3-fabric" = _sGwoz6z0;
        "pkg-21.1-r4.10" = _61qXKirn;
        "pkg-21.11-r6.4-neoforge" = _rjq604vR;
        "pkg-21.11-r6.4-fabric" = _9VdaHgD9;
        "pkg-26.1-r1.0-neoforge" = _vgsvzsmm;
        "pkg-26.1-r1.0-fabric" = _W4hvT3sx;
        "pkg-26.1-r1.1-neoforge" = _i75zvZ1H;
