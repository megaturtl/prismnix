...
let
    versions = (let
        ...
        _IBJZZbXS = {
            "id" = "IBJZZbXS";
            "file" = "skyvoid_vanilla_oneblock_v2_0_13-MC_26_2.zip";
            "hash" = "sha512-MLQmtD/xgPQ1v9Z4NOfq5CGKIdS0fiYh09rwx6J4iWjE49hYyAzVXwZ2IqaESIxChrO+q/7au2UqKlgQ2XTMIA==";
        };
        _3Jy5mels = {
            "id" = "3Jy5mels";
            "file" = "vanilla-one-block-2.0.13.jar";
            "hash" = "sha512-FsSnceRqIHczzyJkmibDWvXsSsvL9aN7CdcrOLw3zP4BdvT7QXrbgSIMWTxA0hiaCAGpoWKsyrh8Al1H9U23wQ==";
        };
    in {
        "jOj5fNoD" = _jOj5fNoD;
        "MICtRDXC" = _MICtRDXC;
        ...
        "neoforge-26.2" = _3Jy5mels;
        "pkg-1.0.5" = _jOj5fNoD;
        "pkg-1.1.0" = _MICtRDXC;
        "pkg-1.1.1" = _deJqrDQQ;
        "pkg-1.1.2" = _2dr5HJBt;
        "pkg-1.2.0" = _RNL5RouG;
        "pkg-1.2.0+mod" = _3H7Mfdtv;
        "pkg-1.2.1" = _2WYVHQbm;
        "pkg-1.2.1+mod" = _GbS9YtxC;
        "pkg-1.2.2" = _C6cVbAN7;
        "pkg-1.2.2+mod" = _qUIvxDqx;
        "pkg-1.2.3" = _SFhFG3kc;
        "pkg-1.2.3+mod" = _Ea1YPYOE;
        "pkg-1.3.0" = _psXb9FeJ;
        "pkg-1.3.0+mod" = _mIp3vbIo;
        "pkg-1.3.1" = _DZ1EfVcc;
        "pkg-1.3.1+mod" = _yLP17uWy;
        "pkg-1.3.2" = _Gmts3i3u;
        "pkg-1.3.2+mod" = _Mx2vYXiJ;
        "pkg-2.0.0" = _PwlXV6Sm;
        "pkg-2.0.0+mod" = _XzPdMoFk;
        "pkg-2.0.1" = _IK6uiLge;
        "pkg-2.0.1+mod" = _OU6Mcwn5;
        "pkg-2.0.2" = _3ah7LNJY;
        "pkg-2.0.2+mod" = _VjFw1cuB;
        "pkg-2.0.3" = _r9zXerFN;
        "pkg-2.0.3+mod" = _JUMuy3gH;
        "pkg-2.0.4" = _m5bv8cuZ;
        "pkg-2.0.4+mod" = _7pb7AyJi;
        "pkg-2.0.5" = _qvncN1Bh;
        "pkg-2.0.5+mod" = _qwor7hFJ;
        "pkg-2.0.6" = _etJYaqX9;
        "pkg-2.0.6+mod" = _NEFlhres;
        "pkg-2.0.7" = _XmvJqD5H;
        "pkg-2.0.7+mod" = _JGcYB9X4;
        "pkg-2.0.8" = _FzGnslGe;
        "pkg-2.0.8+mod" = _cwyR0x4h;
        "pkg-2.0.9" = _BBn03Tke;
        "pkg-2.0.9+mod" = _8EMWpJIx;
        "pkg-2.0.10" = _CvyM2SVR;
        "pkg-2.0.10+mod" = _Q902gaxZ;
        "pkg-2.0.11" = _RXOrXNsM;
        "pkg-2.0.11+mod" = _4lwv3lZF;
        "pkg-2.0.12" = _4SZwYAoh;
        "pkg-2.0.12+mod" = _V8BelOCR;
        "pkg-2.0.13" = _IBJZZbXS;
        "pkg-2.0.13+mod" = _3Jy5mels;
        "default" = _3Jy5mels;
    });
