...
let
    versions = (let
        ...
        _XiDYcEXb = {
            "id" = "XiDYcEXb";
            "file" = "Crystal PvP LT3 Essentials v25.2.zip";
            "hash" = "sha512-fjwr0bwVv6kxmV4+0hCKa2hVbKYOxSbtJ3H2tFoZvFbSug1KaA37VXkYQDRQXgJQ6vLcFm5pVDmnhUonGr4xsQ==";
        };
    in {
        "oAmuPZ7I" = _oAmuPZ7I;
        "NDHMkTMg" = _NDHMkTMg;
        ...
        "4KX49Rxx" = _4KX49Rxx;
        "XiDYcEXb" = _XiDYcEXb;
        "minecraft-1.18" = _XiDYcEXb;
        "minecraft-1.18.1" = _XiDYcEXb;
        "minecraft-1.18.2" = _XiDYcEXb;
        "minecraft-1.19" = _XiDYcEXb;
        "minecraft-1.19.2" = _XiDYcEXb;
        "minecraft-1.19.3" = _XiDYcEXb;
        "minecraft-1.19.4" = _XiDYcEXb;
        "minecraft-1.20" = _XiDYcEXb;
        "minecraft-1.20.1" = _XiDYcEXb;
        "minecraft-1.20.2" = _XiDYcEXb;
        "minecraft-1.20.3" = _XiDYcEXb;
        "minecraft-1.20.4" = _XiDYcEXb;
        "minecraft-1.16.5" = _XiDYcEXb;
        "minecraft-1.19.1" = _XiDYcEXb;
        "minecraft-1.16" = _6CIaTc6f;
        "minecraft-1.16.1" = _6CIaTc6f;
        "minecraft-1.16.2" = _XiDYcEXb;
        "minecraft-1.16.3" = _XiDYcEXb;
        "minecraft-1.16.4" = _XiDYcEXb;
        "minecraft-1.17" = _XiDYcEXb;
        "minecraft-1.17.1" = _XiDYcEXb;
        "minecraft-1.20.5" = _XiDYcEXb;
        "minecraft-1.20.6" = _XiDYcEXb;
        "minecraft-1.21" = _XiDYcEXb;
        "minecraft-1.21.1" = _XiDYcEXb;
        "minecraft-1.21.2" = _XiDYcEXb;
        "minecraft-1.21.3" = _XiDYcEXb;
        "minecraft-1.21.4" = _XiDYcEXb;
        "minecraft-1.21.5" = _XiDYcEXb;
        "minecraft-1.21.6" = _XiDYcEXb;
        "minecraft-1.21.7" = _XiDYcEXb;
        "minecraft-1.21.8" = _XiDYcEXb;
        "minecraft-1.21.9" = _XiDYcEXb;
        "minecraft-1.21.10" = _XiDYcEXb;
        "minecraft-24w37a" = _XiDYcEXb;
        "minecraft-1.21.11" = _XiDYcEXb;
        "minecraft-24w12a" = _XiDYcEXb;
        "minecraft-24w13a" = _XiDYcEXb;
        "minecraft-24w14potato" = _XiDYcEXb;
        "minecraft-24w14a" = _XiDYcEXb;
        "minecraft-1.20.5-pre1" = _XiDYcEXb;
        "minecraft-1.20.5-pre2" = _XiDYcEXb;
        "minecraft-1.20.5-pre3" = _XiDYcEXb;
        "minecraft-24w18a" = _XiDYcEXb;
        "minecraft-24w19a" = _XiDYcEXb;
        "minecraft-24w19b" = _XiDYcEXb;
        "minecraft-24w20a" = _XiDYcEXb;
        "minecraft-24w33a" = _XiDYcEXb;
        "minecraft-24w34a" = _XiDYcEXb;
        "minecraft-24w35a" = _XiDYcEXb;
        "minecraft-24w36a" = _XiDYcEXb;
        "minecraft-24w38a" = _XiDYcEXb;
        "minecraft-24w39a" = _XiDYcEXb;
        "minecraft-24w40a" = _XiDYcEXb;
        "minecraft-1.21.2-pre1" = _XiDYcEXb;
        "minecraft-1.21.2-pre2" = _XiDYcEXb;
        "minecraft-24w44a" = _XiDYcEXb;
        "minecraft-24w45a" = _XiDYcEXb;
        "minecraft-24w46a" = _XiDYcEXb;
        "minecraft-22w42a" = _XiDYcEXb;
        "minecraft-22w43a" = _XiDYcEXb;
        "minecraft-22w44a" = _XiDYcEXb;
        "minecraft-23w14a" = _XiDYcEXb;
        "minecraft-23w16a" = _XiDYcEXb;
        "minecraft-23w31a" = _XiDYcEXb;
        "minecraft-23w32a" = _XiDYcEXb;
        "minecraft-23w33a" = _XiDYcEXb;
        "minecraft-23w35a" = _XiDYcEXb;
        "minecraft-1.20.2-pre1" = _XiDYcEXb;
        "minecraft-23w42a" = _XiDYcEXb;
        "minecraft-23w43a" = _XiDYcEXb;
        "minecraft-23w43b" = _XiDYcEXb;
        "minecraft-23w44a" = _XiDYcEXb;
        "minecraft-23w45a" = _XiDYcEXb;
        "minecraft-23w46a" = _XiDYcEXb;
        "minecraft-24w03a" = _XiDYcEXb;
        "minecraft-24w03b" = _XiDYcEXb;
        "minecraft-24w04a" = _XiDYcEXb;
        "minecraft-24w05a" = _XiDYcEXb;
        "minecraft-24w05b" = _XiDYcEXb;
        "minecraft-24w06a" = _XiDYcEXb;
        "minecraft-24w07a" = _XiDYcEXb;
        "minecraft-24w09a" = _XiDYcEXb;
        "minecraft-24w10a" = _XiDYcEXb;
        "minecraft-24w11a" = _XiDYcEXb;
        "minecraft-26.1" = _XiDYcEXb;
        ...
        "minecraft-26.2" = _XiDYcEXb;
        "minecraft-26.3-snapshot-1" = _XiDYcEXb;
        "minecraft-26.3-snapshot-2" = _XiDYcEXb;
        "minecraft-26.3-snapshot-3" = _XiDYcEXb;
        "minecraft-26.3-snapshot-4" = _XiDYcEXb;
        "minecraft-26.3-snapshot-5" = _XiDYcEXb;
        "minecraft-26.3-snapshot-6" = _XiDYcEXb;
        "minecraft-26.3-snapshot-7" = _XiDYcEXb;
        "minecraft-26.3-snapshot-8" = _XiDYcEXb;
        "minecraft-26.3-snapshot-9" = _XiDYcEXb;
        "minecraft-26.3-snapshot-10" = _XiDYcEXb;
        "pkg-1" = _oAmuPZ7I;
        "pkg-1.18.x-1.20.x" = _NDHMkTMg;
        "pkg-2" = _JOadGUFh;
        "pkg-2.2" = _1bIWwZRl;
        "pkg-3" = _PCgPNeLE;
        "pkg-4" = _Fv2DNuOd;
