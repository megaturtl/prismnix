...
let
    versions = (let
        ...
        _I04pUVvF = {
            "id" = "I04pUVvF";
            "file" = "ZombieApocolypse999-1.2.9.jar";
            "hash" = "sha512-+vO6sAKeza1MAu9wdVYC4eRrGQ+qp2dOz98dhJhOq7WIFlpB0WS3eiVEbFshH7bFZr6Z4tZH6wIz/MlT0buAUg==";
        };
        _ptcY0GBO = {
            "id" = "ptcY0GBO";
            "file" = "ZombieApocolypse999-1.3.0.jar";
            "hash" = "sha512-dJ3CPJWkbb9yP8nxpRHv9+NaE0xWZNbX2YQYTrRtswybC4tH7RKm+UxN5x0hnU/F44KCRQeUOao3myStNaq/lQ==";
        };
    in {
        "qeqZgOh4" = _qeqZgOh4;
        "UXrUfuKV" = _UXrUfuKV;
        ...
        "I04pUVvF" = _I04pUVvF;
        "ptcY0GBO" = _ptcY0GBO;
        "bukkit-1.21.4" = _ptcY0GBO;
        "bukkit-1.21.5" = _ptcY0GBO;
        "bukkit-1.21.6" = _ptcY0GBO;
        "bukkit-1.21.7" = _ptcY0GBO;
        "bukkit-1.21.8" = _ptcY0GBO;
        "bukkit-1.21" = _ptcY0GBO;
        "bukkit-1.21.1" = _ptcY0GBO;
        "bukkit-1.21.2" = _ptcY0GBO;
        "bukkit-1.21.3" = _ptcY0GBO;
        "bukkit-1.21.9" = _ptcY0GBO;
        "bukkit-1.21.10" = _ptcY0GBO;
        "bukkit-1.21.11" = _ptcY0GBO;
        "paper-1.21.4" = _ptcY0GBO;
        "paper-1.21.5" = _ptcY0GBO;
        "paper-1.21.6" = _ptcY0GBO;
        "paper-1.21.7" = _ptcY0GBO;
        "paper-1.21.8" = _ptcY0GBO;
        "paper-1.21" = _ptcY0GBO;
        "paper-1.21.1" = _ptcY0GBO;
        "paper-1.21.2" = _ptcY0GBO;
        "paper-1.21.3" = _ptcY0GBO;
        "paper-1.21.9" = _ptcY0GBO;
        "paper-1.21.10" = _ptcY0GBO;
        "paper-1.21.11" = _ptcY0GBO;
        "purpur-1.21.4" = _ptcY0GBO;
        "purpur-1.21.5" = _ptcY0GBO;
        "purpur-1.21.6" = _ptcY0GBO;
        "purpur-1.21.7" = _ptcY0GBO;
        "purpur-1.21.8" = _ptcY0GBO;
        "purpur-1.21" = _ptcY0GBO;
        "purpur-1.21.1" = _ptcY0GBO;
        "purpur-1.21.2" = _ptcY0GBO;
        "purpur-1.21.3" = _ptcY0GBO;
        "purpur-1.21.9" = _ptcY0GBO;
        "purpur-1.21.10" = _ptcY0GBO;
        "purpur-1.21.11" = _ptcY0GBO;
        "spigot-1.21" = _ptcY0GBO;
        "spigot-1.21.1" = _ptcY0GBO;
        "spigot-1.21.2" = _ptcY0GBO;
        "spigot-1.21.3" = _ptcY0GBO;
        "spigot-1.21.4" = _ptcY0GBO;
        "spigot-1.21.5" = _ptcY0GBO;
        "spigot-1.21.6" = _ptcY0GBO;
        "spigot-1.21.7" = _ptcY0GBO;
        "spigot-1.21.8" = _ptcY0GBO;
        "spigot-1.21.9" = _ptcY0GBO;
        "spigot-1.21.10" = _ptcY0GBO;
        "spigot-1.21.11" = _ptcY0GBO;
        "pkg-V1.0.0" = _qeqZgOh4;
        "pkg-V1.0.1" = _UXrUfuKV;
        "pkg-V1.0.2" = _uwjZDWB6;
        "pkg-V1.0.3" = _WutRKSfA;
        "pkg-1.0.4" = _p3f2T8n1;
        "pkg-1.0.5" = _B3TGTjtU;
        "pkg-1.0.6" = _Rap9LbUY;
        "pkg-1.0.7" = _oTNjfnTw;
