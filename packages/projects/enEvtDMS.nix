...
let
    versions = (let
        ...
        _eCo3C39T = {
            "id" = "eCo3C39T";
            "file" = "hearts_yellow-1.1.0-mc26.3.zip";
            "hash" = "sha512-v2dRONeFumrx1Uqbz3Kh80q6/tym/FKpkysQrpGu/XZ5NY5l2VGJJUiK6HY0pG8QSZ3Qxv4rmcI5oRZmnnTXiA==";
        };
    in {
        "YmH6O0SP" = _YmH6O0SP;
        "1Hcgmrdt" = _1Hcgmrdt;
