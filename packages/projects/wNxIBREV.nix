...
let
    ...
    in {
        ...
        "pkg-v4.1.0-1.19.2-Fabric" = _xOSPnZoF;
        "pkg-v4.1.1-1.19.2-Forge" = _NgTTrxy7;
        "pkg-v4.1.1-1.19.2-Fabric" = _EgDIoWUw;
        "pkg-v4.1.2-1.19.2-Fabric" = _DrNpSo6o;
        "pkg-v4.1.2-1.19.2-Forge" = _TIjwq9Vb;
        "pkg-v5.0.0-1.19.3-Fabric" = _N2QoLPCC;
        "pkg-v5.0.0-1.19.3-Forge" = _TnuJ4AKo;
        "pkg-v6.0.0-1.19.4-Forge" = _VeSPrJmg;
        "pkg-v6.0.0-1.19.4-Fabric" = _Ub6eg9AF;
        "pkg-v7.0.0-1.20-Forge" = _qQei8Xmb;
        "pkg-v7.0.0-1.20-Fabric" = _oIDAnndc;
        "pkg-v8.0.0-1.20.1-Forge" = _SHX1g0Bg;
        "pkg-v8.0.0-1.20.1-Fabric" = _gD0WwbTm;
        "pkg-v8.0.1-1.20.1-Forge" = _giJkXtAN;
        "pkg-v8.0.1-1.20.1-Fabric" = _mqkYUele;
        "pkg-v3.3.0-1.18.2-Forge" = _qV6f8Bvr;
        "pkg-v3.3.0-1.18.2-Fabric" = _3JaM0Uad;
        "pkg-v20.4.0-1.20.4-Fabric" = _bg86m651;
        "pkg-v20.4.0-1.20.4-Forge" = _wacX9gRV;
        "pkg-v20.4.0-1.20.4-NeoForge" = _MLtyt8ay;
        "pkg-v20.4.1-1.20.4-Fabric" = _zhsKvyvK;
        "pkg-v20.4.1-1.20.4-Forge" = _AWfYSe4a;
        "pkg-v20.4.1-1.20.4-NeoForge" = _4ACjokaw;
        "pkg-v21.1.0-1.21.1-Fabric" = _g50P8KVR;
        "pkg-v21.1.0-1.21.1-NeoForge" = _L8jwPRdi;
        "pkg-v21.3.0-1.21.3-Fabric" = _FU5kd8zu;
        "pkg-v21.3.0-1.21.3-NeoForge" = _Rdt6PRVw;
        "pkg-v21.1.1-1.21.1-Fabric" = _KIvvXyhQ;
        "pkg-v21.1.1-1.21.1-NeoForge" = _xhSQ9L1I;
        "pkg-v21.4.0-1.21.4-Fabric" = _Lqz1CiTd;
        "pkg-v21.4.0-1.21.4-NeoForge" = _Gro2SwhF;
        "pkg-v21.5.0-1.21.5-Fabric" = _hq4T4i54;
        "pkg-v21.5.0-1.21.5-NeoForge" = _NiOM5hmU;
        "pkg-v21.7.0-1.21.7-Fabric" = _rnmc4cab;
        "pkg-v21.7.0-1.21.7-NeoForge" = _36oTVwh1;
        "pkg-v21.8.0-1.21.8-Fabric" = _5Gizcquf;
        "pkg-v21.8.0-1.21.8-NeoForge" = _3IFiTzYa;
        "pkg-21.9.0" = _zWfFgwxh;
        "pkg-21.10.0" = _BKuOAgpE;
        "pkg-21.11.0" = _9p8Rrdg1;
        "pkg-26.1.0" = _bex11rJ5;
