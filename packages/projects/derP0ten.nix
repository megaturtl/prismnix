...
let
    ...
    in {
        ...
        "pkg-v4.0.2-1.19.2-Forge" = _2vdN6iAh;
        "pkg-v4.0.3-1.19.2-Fabric" = _iCIpYnUw;
        "pkg-v4.0.3-1.19.2-Forge" = _YfdVjqL0;
        "pkg-v4.0.4-1.19.2-Forge" = _xXItC97v;
        "pkg-v4.0.4-1.19.2-Fabric" = _MCMM5EhT;
        "pkg-v5.0.0-1.19.3-Forge" = _PhM1rRXq;
        "pkg-v5.0.0-1.19.3-Fabric" = _M49xdlxN;
        "pkg-v4.0.5-1.19.2-Fabric" = _NirsP8WW;
        "pkg-v4.0.5-1.19.2-Forge" = _fKkGBcyp;
        "pkg-v5.0.1-1.19.3-Forge" = _XchdLX69;
        "pkg-v5.0.1-1.19.3-Fabric" = _6Er3wd2M;
        "pkg-v6.0.0-1.19.4-Forge" = _py2g1zNi;
        "pkg-v6.0.0-1.19.4-Fabric" = _hKLgWqEG;
        "pkg-v6.0.1-1.19.4-Fabric" = _ZniZrZ1k;
        "pkg-v6.0.1-1.19.4-Forge" = _OavH5GRU;
        "pkg-v3.0.0-1.18.2-Forge" = _FprAZZ4M;
        "pkg-v3.0.0-1.18.2-Fabric" = _F3egnz5X;
        "pkg-v3.0.1-1.18.2-Forge" = _H8JkL8pa;
        "pkg-v3.0.1-1.18.2-Fabric" = _3mv8HmTo;
        "pkg-v4.0.6-1.19.2-Forge" = _CkbS2PLp;
        "pkg-v4.0.6-1.19.2-Fabric" = _E6MjVWsN;
        "pkg-v6.0.2-1.19.4-Forge" = _Cot0bkQN;
        "pkg-v6.0.2-1.19.4-Fabric" = _O3GNtihs;
        "pkg-v7.0.0-1.20-Forge" = _lTrkkInS;
        "pkg-v7.0.0-1.20-Fabric" = _jxVJddUv;
        "pkg-v8.0.1-1.20.1-Forge" = _BOXbMP8y;
        "pkg-v8.0.1-1.20.1-Fabric" = _k1txQ3sx;
        "pkg-v8.0.2-1.20.1-Forge" = _55VYRSqD;
        "pkg-v8.0.2-1.20.1-Fabric" = _dB4njHbu;
        "pkg-v8.0.3-1.20.1-Forge" = _kzXTQOdD;
        "pkg-v8.0.3-1.20.1-Fabric" = _mh6ClLZz;
        "pkg-v8.0.4-1.20.1-Forge" = _GrfbD4Bv;
        "pkg-v8.0.4-1.20.1-Fabric" = _oKXlnH0n;
        "pkg-v8.0.5-1.20.1-Forge" = _pFjiwunc;
        "pkg-v8.0.5-1.20.1-Fabric" = _LDr4SOMU;
        "pkg-v8.0.6-1.20.1-Forge" = _zqm5z8Lh;
        "pkg-v8.0.6-1.20.1-Fabric" = _2y05EwXr;
        "pkg-v8.0.7-1.20.1-Forge" = _Pp3ZK1tZ;
        "pkg-v8.0.7-1.20.1-Fabric" = _GEdQkhpr;
        "pkg-v20.4.0-1.20.4-Fabric" = _xl1tuF7z;
        "pkg-v20.4.0-1.20.4-Forge" = _xmnTYpsJ;
        "pkg-v20.4.0-1.20.4-NeoForge" = _eRnKdLSh;
        "pkg-v20.4.1-1.20.4-Fabric" = _IAv83Mgr;
        "pkg-v20.4.1-1.20.4-Forge" = _qfOnBdxf;
        "pkg-v20.4.1-1.20.4-NeoForge" = _JldxXKol;
        "pkg-v21.1.0-1.21.1-Fabric" = _MpLmiqo6;
        "pkg-v21.1.0-1.21.1-NeoForge" = _xVkzu4AZ;
        "pkg-v21.3.0-1.21.3-Fabric" = _nL1J9ktC;
        "pkg-v21.3.0-1.21.3-NeoForge" = _VHKswP2B;
        "pkg-v21.4.0-1.21.4-Fabric" = _gVjV6Mq4;
        "pkg-v21.4.0-1.21.4-NeoForge" = _R9u9uVa0;
        "pkg-v21.4.1-1.21.4-Fabric" = _M4i0IBum;
        "pkg-v21.4.1-1.21.4-NeoForge" = _v5C02H65;
        "pkg-v21.3.1-1.21.3-Fabric" = _9DKWvS9o;
        "pkg-v21.3.1-1.21.3-NeoForge" = _pSDRT3P4;
        "pkg-v21.4.2-1.21.4-Fabric" = _a0llgYDn;
        "pkg-v21.4.2-1.21.4-NeoForge" = _owgFs1hK;
        "pkg-v21.5.0-1.21.5-Fabric" = _918xx7HZ;
        "pkg-v21.5.0-1.21.5-NeoForge" = _xJLOe9Un;
        "pkg-v21.5.1-1.21.5-Fabric" = _SY6U8drj;
        "pkg-v21.5.1-1.21.5-NeoForge" = _my1uNLQ0;
        "pkg-v21.7.0-1.21.7-Fabric" = _RMdReaG7;
        "pkg-v21.7.0-1.21.7-NeoForge" = _7c7pcGQH;
        "pkg-v21.8.0-1.21.8-Fabric" = _7iaXl6TX;
        "pkg-v21.8.0-1.21.8-NeoForge" = _jU77m1p4;
        "pkg-21.10.0" = _1GzAC6FT;
        "pkg-21.9.0" = _wzxjf6qz;
        "pkg-21.10.1" = _jnj7UNfn;
        "pkg-v8.0.8-1.20.1-Forge" = _CUgYzMnF;
        "pkg-v8.0.8-1.20.1-Fabric" = _W1xZlM32;
        "pkg-v21.1.1-1.21.1-Fabric" = _2Sdb5JWj;
        "pkg-v21.1.1-1.21.1-NeoForge" = _dauEcrnZ;
        "pkg-21.10.2" = _lGteoPHl;
        "pkg-21.10.3" = _SdkgF6xA;
        "pkg-21.11.0" = _9NsCwlkM;
        "pkg-21.10.4" = _NA6rpT0A;
        "pkg-21.11.1" = _B8VsgMx2;
        "pkg-21.10.5" = _tMMR9yjP;
        "pkg-21.11.2" = _dwBBy3dW;
        "pkg-26.1.0" = _EvKYUzN3;
        "pkg-26.1.1" = _1mzr7NDs;
