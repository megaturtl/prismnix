...
let
    ...
    in {
        ...
        "pkg-2.1.6" = _NvUMxKQC;
        "pkg-2.1.7" = _8qYCy2XV;
        "pkg-2.1.7hotfix1" = _PuTTyMRL;
        "pkg-2.1.8" = _izxY1YlM;
        "pkg-2.1.9" = _zm39lcAM;
        "pkg-2.1.10" = _WT2alUvd;
        "pkg-2.1.11" = _q3RgyG2c;
        "pkg-2.1.11fix" = _eJzPm0k4;
        "pkg-2.1.12" = _Pd6Y68Iu;
        "pkg-2.1.12beta" = _LPYuwDYH;
        "pkg-2.1.13" = _KZFLRNAx;
        "pkg-2.1.14" = _f1CNb9Kj;
        "pkg-2.1.14fix" = _RTKdreoY;
        "pkg-2.1.15" = _MLYtgElJ;
        "pkg-2.1.15fix" = _ipWNUhY3;
        "pkg-2.1.16" = _s6vXfW0E;
        "pkg-2.1.16fix" = _tc0lZDr2;
        "pkg-2.1.17" = _iwU9iyOv;
        "pkg-2.1.18" = _ycxSn25d;
        "pkg-2.1.18fix" = _5lSDTBDW;
        "pkg-2.1.18fix2" = _xSFfdbSq;
