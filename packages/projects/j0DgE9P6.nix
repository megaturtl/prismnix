...
let
    versions = (let
        ...
        _YzlPZUN3 = {
            "id" = "YzlPZUN3";
            "file" = "GraveLootZ-1.7.jar";
            "hash" = "sha512-5t+lUnhYPvIEH1L9bCIpEV0LdVDrEEq/S21MY/Plw73SJqoMXayYLGi364LtA+OKvdYO6kisCV0XE05lfokubA==";
        };
    in {
        "kOkEyPI5" = _kOkEyPI5;
        "AGzuysTq" = _AGzuysTq;
        ...
        "bukkit-1.21" = _YzlPZUN3;
        "bukkit-1.21.1" = _YzlPZUN3;
        "bukkit-1.21.2" = _YzlPZUN3;
        "bukkit-1.21.3" = _YzlPZUN3;
        "bukkit-1.21.4" = _YzlPZUN3;
        "bukkit-1.21.5" = _YzlPZUN3;
        "bukkit-1.21.6" = _YzlPZUN3;
        "bukkit-1.21.7" = _YzlPZUN3;
        "bukkit-1.21.8" = _YzlPZUN3;
        "bukkit-1.21.9" = _YzlPZUN3;
        "bukkit-1.21.10" = _YzlPZUN3;
        "bukkit-1.21.11" = _YzlPZUN3;
        "bukkit-26.1" = _YzlPZUN3;
        "bukkit-26.1.1" = _YzlPZUN3;
        "bukkit-26.1.2" = _YzlPZUN3;
        "bukkit-26.2" = _YzlPZUN3;
        "bukkit-26.3" = _YzlPZUN3;
        ...
        "paper-1.21" = _YzlPZUN3;
        "paper-1.21.1" = _YzlPZUN3;
        "paper-1.21.2" = _YzlPZUN3;
        "paper-1.21.3" = _YzlPZUN3;
        "paper-1.21.4" = _YzlPZUN3;
        "paper-1.21.5" = _YzlPZUN3;
        "paper-1.21.6" = _YzlPZUN3;
        "paper-1.21.7" = _YzlPZUN3;
        "paper-1.21.8" = _YzlPZUN3;
        "paper-1.21.9" = _YzlPZUN3;
        "paper-1.21.10" = _YzlPZUN3;
        "paper-1.21.11" = _YzlPZUN3;
        "paper-26.1" = _YzlPZUN3;
        "paper-26.1.1" = _YzlPZUN3;
        "paper-26.1.2" = _YzlPZUN3;
        "paper-26.2" = _YzlPZUN3;
        "paper-26.3" = _YzlPZUN3;
        ...
        "spigot-1.21" = _YzlPZUN3;
        "spigot-1.21.1" = _YzlPZUN3;
        "spigot-1.21.2" = _YzlPZUN3;
        "spigot-1.21.3" = _YzlPZUN3;
        "spigot-1.21.4" = _YzlPZUN3;
        "spigot-1.21.5" = _YzlPZUN3;
        "spigot-1.21.6" = _YzlPZUN3;
        "spigot-1.21.7" = _YzlPZUN3;
        "spigot-1.21.8" = _YzlPZUN3;
        "spigot-1.21.9" = _YzlPZUN3;
        "spigot-1.21.10" = _YzlPZUN3;
        "spigot-1.21.11" = _YzlPZUN3;
        "spigot-26.1" = _YzlPZUN3;
        "spigot-26.1.1" = _YzlPZUN3;
        "spigot-26.1.2" = _YzlPZUN3;
        "spigot-26.2" = _YzlPZUN3;
        "spigot-26.3" = _YzlPZUN3;
