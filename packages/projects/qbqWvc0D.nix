...
let
    ...
    in {
        ...
        "pkg-v4.1.0-1.19.2-Fabric" = _2L4gZOz7;
        "pkg-v4.1.1-1.19.2-Forge" = _KaCGFMig;
        "pkg-v4.1.1-1.19.2-Fabric" = _II9rnEtu;
        "pkg-v4.1.2-1.19.2-Fabric" = _xjiJ5Tt0;
        "pkg-v4.1.2-1.19.2-Forge" = _xUdz3xa4;
        "pkg-v4.1.3-1.19.2-Forge" = _Hz9E4gFF;
        "pkg-v4.1.3-1.19.2-Fabric" = _oiZt8HgU;
        "pkg-v4.1.4-1.19.2-Fabric" = _C6aK1Ypz;
        "pkg-v4.1.4-1.19.2-Forge" = _slukMOCt;
        "pkg-v4.1.5-1.19.2-Fabric" = _zblbQfhX;
        "pkg-v4.1.5-1.19.2-Forge" = _4HfYiqje;
        "pkg-v4.1.6-1.19.2-Forge" = _62b88Lva;
        "pkg-v4.1.6-1.19.2-Fabric" = _1zWrmxLa;
        "pkg-v5.0.0-1.19.3-Fabric" = _8CWAiJDX;
        "pkg-v5.0.0-1.19.3-Forge" = _hUaWHPca;
        "pkg-v6.0.0-1.19.4-Fabric" = _Bmi4wkVf;
        "pkg-v6.0.0-1.19.4-Forge" = _pMjrmHbO;
        "pkg-v7.0.0-1.20-Forge" = _YDak69jP;
        "pkg-v7.0.0-1.20-Fabric" = _3BIsMTo4;
        "pkg-v8.0.0-1.20.1-Forge" = _QegUQ4MH;
        "pkg-v8.0.0-1.20.1-Fabric" = _QoR1PXfy;
        "pkg-v8.0.1-1.20.1-Forge" = _dzSlYP8c;
        "pkg-v8.0.1-1.20.1-Fabric" = _iE2D1E83;
        "pkg-v20.4.0-1.20.4-Fabric" = _8PwK6BiN;
        "pkg-v20.4.0-1.20.4-Forge" = _V5Kz0xrl;
        "pkg-v20.4.0-1.20.4-NeoForge" = _VufFdkIX;
        "pkg-v8.0.2-1.20.1-Forge" = _VJB3Xxae;
        "pkg-v8.0.2-1.20.1-Fabric" = _sxjgmBCY;
        "pkg-v20.4.1-1.20.4-Fabric" = _5JidLWMv;
        "pkg-v20.4.1-1.20.4-Forge" = _4J6eoq11;
        "pkg-v20.4.1-1.20.4-NeoForge" = _TYGdWQ5d;
        "pkg-v20.4.2-1.20.4-Fabric" = _8OmmcZJr;
        "pkg-v20.4.2-1.20.4-Forge" = _usDYJcu9;
        "pkg-v20.4.2-1.20.4-NeoForge" = _kMY1gi2j;
        "pkg-v20.4.3-1.20.4-Fabric" = _xEyHEuK2;
        "pkg-v20.4.3-1.20.4-Forge" = _lGniOJ6k;
        "pkg-v20.4.3-1.20.4-NeoForge" = _yWsMewlt;
        "pkg-v21.0.0-1.21-Fabric" = _uOGUIUA6;
        "pkg-v21.0.0-1.21-NeoForge" = _9GZMxIkB;
        "pkg-v21.0.1-1.21-Fabric" = _bk42QkGw;
        "pkg-v21.0.1-1.21-NeoForge" = _egp0UDWf;
        "pkg-v21.0.2-1.21-Fabric" = _ufo53fpL;
        "pkg-v21.0.2-1.21-NeoForge" = _BqFmmdZo;
        "pkg-v21.0.3-1.21-Fabric" = _347qsY94;
        "pkg-v21.0.3-1.21-NeoForge" = _MvC4ZZZU;
        "pkg-v21.1.0-1.21.1-Fabric" = _adCbWhbO;
        "pkg-v21.1.0-1.21.1-NeoForge" = _OMaBVs50;
        "pkg-v21.3.0-1.21.3-Fabric" = _35foyzVS;
        "pkg-v21.3.0-1.21.3-NeoForge" = _vRotq3jq;
        "pkg-v21.3.1-1.21.3-Fabric" = _F9mLiUh9;
        "pkg-v21.3.1-1.21.3-NeoForge" = _7npTh4xF;
        "pkg-v21.4.0-1.21.4-Fabric" = _P1613VeW;
        "pkg-v21.4.0-1.21.4-NeoForge" = _TwxOgKxv;
        "pkg-v21.5.0-1.21.5-Fabric" = _hhOMitqj;
        "pkg-v21.5.0-1.21.5-NeoForge" = _uayIhT8R;
        "pkg-v21.6.0-1.21.6-Fabric" = _HHPR77DU;
        "pkg-v21.6.0-1.21.6-NeoForge" = _2zSZG4mD;
        "pkg-v21.6.1-1.21.6-Fabric" = _NCjQbWjg;
        "pkg-v21.6.1-1.21.6-NeoForge" = _wUTcX1Pf;
        "pkg-v21.1.1-1.21.1-Fabric" = _YeofSMds;
        "pkg-v21.1.1-1.21.1-NeoForge" = _I7Q4I3dl;
        "pkg-v21.7.0-1.21.7-Fabric" = _a8LULv3k;
        "pkg-v21.7.0-1.21.7-NeoForge" = _GoiJRquT;
        "pkg-v21.8.0-1.21.8-Fabric" = _FlkvaAa8;
        "pkg-v21.8.0-1.21.8-NeoForge" = _vgzOmNlr;
        "pkg-v21.8.1-1.21.8-Fabric" = _WVMDvl8d;
        "pkg-v21.8.1-1.21.8-NeoForge" = _UUbLj7Gv;
        "pkg-v21.8.2-1.21.8-Fabric" = _Cn3XoShP;
        "pkg-v21.8.2-1.21.8-NeoForge" = _LsgrDctk;
        "pkg-v21.8.3-1.21.8-Fabric" = _fWFfCSUr;
        "pkg-v21.8.3-1.21.8-NeoForge" = _3V1O0lM3;
        "pkg-v21.1.2-1.21.1-Fabric" = _n9DzkxT7;
        "pkg-v21.1.2-1.21.1-NeoForge" = _4IIOAgTS;
        "pkg-v21.8.4-1.21.8-Fabric" = _KSJCqRgN;
        "pkg-v21.8.4-1.21.8-NeoForge" = _FJDZMsTt;
        "pkg-21.9.0" = _OGjd3e5M;
        "pkg-21.10.0" = _HpMfHKGg;
        "pkg-21.11.0" = _1w6qZsIL;
