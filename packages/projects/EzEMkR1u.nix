...
let
    versions = (let
        ...
        _zrYYVH3O = {
            "id" = "zrYYVH3O";
            "file" = "Aurora-2.6.0-b215.jar";
            "hash" = "sha512-6D2T5kbQ/O9nThBDKVFKpNOJuZ9JVD7RKl6pCo5ApTrTZ1FI2eUdKV4Gyu/FvM6wFJaGtpaoB5b5nNf1pOJY+w==";
        };
    in {
        "M4NB4KHL" = _M4NB4KHL;
        "sjKyG7VW" = _sjKyG7VW;
        ...
        "pkg-1.5.8" = _3qL0Wd2U;
        "pkg-1.5.9" = _zIdLGHao;
        "pkg-1.5.10" = _xmY1GLeN;
        "pkg-1.5.11" = _v74j2mg5;
        "pkg-1.6.0" = _2IJb0lZU;
        "pkg-1.7.0" = _CzXnkEHQ;
        "pkg-1.7.2" = _Q9vPAFQy;
        "pkg-2.0.0" = _ge0kGsH6;
