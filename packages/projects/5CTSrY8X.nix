...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _ptxcOQyv;
        "pkg-1.0.0-forge" = _fpJ5PcCQ;
        "pkg-1.0.1" = _aYEk8yru;
        "pkg-1.0.0-neo" = _V54afQdx;
        "pkg-1.0.0-1.21x" = _5HTmn2Gr;
        "pkg-1.0.1-neo" = _VPmOx7d3;
        "pkg-1.0.0-1.16x-Forge" = _VfBauQfj;
        "pkg-1.0.2" = _DENVQGNf;
        "pkg-1.0.2-1.16x-forge" = _Km1tyyQ3;
        "pkg-1.0.3" = _nccnGF7N;
        "pkg-1.0.3-neo" = _nlerwS8N;
        "pkg-1.0.3-1.16x-forge" = _i0yZbFf8;
        "pkg-1.0.4" = _12I0XpZi;
        "pkg-1.0.4-1.16x" = _k3YT2628;
        "pkg-1.0.4-1.12" = _Kml7i540;
        "pkg-1.0.5" = _BMbuXZoR;
        "pkg-1.0.5-forge" = _87d73ndl;
        "pkg-1.0.5.1-forge" = _mMc55fB1;
        "pkg-1.0.5.1" = _ZoOH4tOq;
        "pkg-1.0.6-1.21.5-1.21.8" = _kEIISdEU;
        "pkg-1.1.0b-1.21.1" = _XOCy6gx0;
        "pkg-1.0.6-1.21.8-1.21.10-fabric" = _dV5wJGOp;
        "pkg-1.0.6-1.21.8-1.21.10-neo" = _4ecxuWZN;
        "pkg-1.1.0b02-1.21.1-fabric" = _sVHHcS4Y;
        "pkg-1.1.0b03-1.21.1-fabric" = _TRYABAGq;
        "pkg-1.1.0b04-1.21.1-fabric" = _H1XClgQR;
        "pkg-1.1.0b05-1.21.1-fabric" = _1bttNgr3;
        "pkg-1.1.0-1.21.1-fabric" = _OoTEkgEE;
        "pkg-1.1.1-1.20-1.20.1-fabric" = _LKcV4Zt9;
        "pkg-1.1.1-1.21-1.21.1-fabric" = _m8L3XQU9;
        "pkg-1.1.2-1.21-1.21.1-fabric" = _bJlUgkiO;
        "pkg-1.2.0-1.21-1.21.1-fabric" = _BgziEt8s;
        "pkg-1.2.1-1.21-1.21.1-fabric" = _Bw9zP4CE;
        "pkg-1.2.1-1.21.11-fabric" = _WZ54Vljr;
        "pkg-1.2.2-1.21.11-fabric" = _dzAebtGZ;
        "pkg-1.2.3-1.21.11-fabric" = _cDwvmPqt;
        "pkg-1.2.4-1.21.11-fabric" = _d4U2cAgQ;
        "pkg-1.2.5-1.21.11-fabric" = _QEx1Idx0;
        "pkg-1.3.0-1.21.11-fabric" = _S4p4vveF;
