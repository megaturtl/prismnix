...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.1.1" = _y4pb75KK;
        "pkg-1.18.2-1.1.2" = _xhwgGQkv;
        "pkg-1.18.2-1.1.4" = _FznkEjSr;
        "pkg-1.18.2-1.1.5" = _BKUJqxcO;
        "pkg-1.18.2-1.1.6" = _igXeWZbx;
        "pkg-1.18.2-1.1.7" = _RJ43wBfF;
        "pkg-1.18.2-1.1.8" = _B5Anf7od;
        "pkg-1.19-2.0.0" = _6QnMrAql;
        "pkg-1.18.2-1.1.9" = _KvAPG8oj;
        "pkg-1.19-2.0.1" = _CuisyB3f;
        "pkg-1.19-2.0.2" = _APq7Smui;
        "pkg-1.19.1-2.1.0" = _nWavn5gg;
        "pkg-1.18.2-1.1.10" = _OdeUoQy0;
        "pkg-1.19.1-2.1.1" = _IPRhE2J5;
        "pkg-1.19.1-2.1.2" = _v3DA0Mym;
        "pkg-1.18.2-1.1.11" = _VCZRXuAM;
        "pkg-1.18.2-1.1.12" = _ukJcfEvk;
        "pkg-1.19.1-2.1.3" = _j0lEB3gR;
        "pkg-1.19.1-2.1.4" = _5E2SNi4G;
        "pkg-1.19.1-2.1.5" = _7RFFTx4d;
        "pkg-1.19.1-2.1.6" = _1FSjcdte;
        "pkg-1.19.1-2.1.7" = _K5eeUwf5;
        "pkg-1.19.1-2.1.8" = _GOL0m5U8;
        "pkg-1.19.1-2.1.9" = _A7SLMprE;
        "pkg-1.19.4-2.2.0" = _9lGonbe2;
        "pkg-1.18.2-1.1.13" = _XpeCnmZO;
        "pkg-1.19.4-2.2.1" = _EHopCA9U;
        "pkg-1.19.4-2.2.2" = _UcOc3lrz;
        "pkg-1.20.1-3.1.0" = _SGtW061d;
        "pkg-1.20.1-3.1.1" = _Wdq2rVLE;
        "pkg-1.19.4-2.2.3" = _s42Zpjgw;
        "pkg-1.19.4-2.2.4" = _NYVxvgkr;
        "pkg-1.20.1-3.1.2" = _fSpsdGjF;
        "pkg-1.19.1-2.1.10" = _hsjyLlYY;
        "pkg-1.20.1-3.1.3" = _5Wg3xlFZ;
        "pkg-1.19.4-2.2.5" = _NYRu7LVr;
        "pkg-1.18.2-1.1.14" = _GdPOl85M;
        "pkg-1.20.1-3.1.4" = _KEPO6Y5V;
        "pkg-1.19.4-2.2.6" = _Dk7BR8jG;
        "pkg-1.20.1-3.1.5" = _DPyZye0l;
        "pkg-1.19.4-2.2.7" = _ATcdLvKQ;
        "pkg-1.20.1-3.1.6" = _ySfrr3vn;
        "pkg-1.21-4.0.0" = _AVnUa7Xp;
        "pkg-1.21-4.0.1" = _BfrThsce;
        "pkg-1.21-4.0.2" = _785oqW3g;
        "pkg-1.21-4.0.3" = _ULjwQyE0;
        "pkg-1.21-4.0.4" = _aOwSvc7Q;
        "pkg-1.21-4.0.5" = _IY973qFy;
        "pkg-1.19.4-2.2.8" = _SjldpSsW;
        "pkg-1.20.1-3.1.7" = _NXf7C5eK;
        "pkg-1.20.1-3.1.8" = _IicTe7Jq;
        "pkg-1.21-4.0.6" = _vQgdAjdz;
        "pkg-1.21-4.0.7" = _vOOOZDvy;
        "pkg-1.19.1-2.1.11" = _sGJaZE6e;
        "pkg-1.21-4.0.8" = _3vkhkRW7;
        "pkg-21.5.0" = _PtuOYtoG;
        "pkg-21.5.1" = _rAkU0cwa;
        "pkg-1.21-4.0.9" = _92VLc4Df;
        "pkg-1.21-4.0.10" = _LECDgk5r;
        "pkg-21.5.2" = _jpCBzOlu;
        "pkg-1.21-4.0.12" = _qEh7EW2V;
        "pkg-21.5.4" = _oVN9y3Q1;
        "pkg-1.18.2-1.1.15" = _kGlY633S;
        "pkg-21.5.5" = _yuWtLjdW;
        "pkg-1.21-4.0.13" = _8dRfdnL2;
        "pkg-1.20.1-3.1.9" = _jANOoo6U;
        "pkg-21.5.6" = _MIOG2dvW;
        "pkg-1.21-4.0.14" = _eYnMcNeX;
        "pkg-1.20.1-3.1.10" = _laGfmiXe;
        "pkg-1.19.1-2.1.12" = _cVELjkvu;
        "pkg-1.18.2-1.1.16" = _COTMLk5n;
        "pkg-1.19.4-2.2.9" = _Yc7aTtRF;
        "pkg-1.20.1-3.1.11" = _iCFKGtgN;
        "pkg-1.21-4.0.15" = _SMtgayRU;
        "pkg-21.5.7" = _Mt3M5Pe1;
        "pkg-1.18.2-1.1.17" = _u7QQUkbt;
        "pkg-1.19.4-2.2.10" = _AcNj6p6x;
        "pkg-1.20.1-3.1.12" = _HdIXTIXK;
        "pkg-1.19.1-2.1.14" = _vbTCDGjL;
        "pkg-1.21-4.0.16" = _SW1BRK4m;
        "pkg-21.5.8" = _WHvtIqtJ;
        "pkg-21.6.0" = _oMIdz9HZ;
        "pkg-21.6.1" = _G2RwGK0u;
        "pkg-1.21-4.0.17" = _u9TUrxFh;
        "pkg-1.20.1-3.1.13" = _74Irb8bB;
        "pkg-1.21-4.0.18" = _z38Wz67z;
        "pkg-21.6.2" = _8WJs71tp;
        "pkg-1.20.1-3.1.15" = _gymLacfe;
        "pkg-1.20.1-3.1.16" = _kCkJMHhj;
        "pkg-1.21-4.0.19" = _qFWoVT4U;
        "pkg-21.6.3" = _qBnd5nps;
        "pkg-1.20.1-3.1.17" = _uXiVHDyi;
        "pkg-1.21-4.0.20" = _4Kv0Uk5D;
        "pkg-21.6.4" = _bv84r9to;
        "pkg-21.9.0" = _9Wyu4Uev;
        "pkg-1.18.2-1.1.18" = _llBk56FN;
        "pkg-1.19.1-2.1.15" = _ItOMGLwj;
        "pkg-1.20.1-3.1.18" = _PUL3AObt;
        "pkg-1.21-4.0.21" = _6JQL4qSR;
        "pkg-21.9.1" = _L2mtmj4P;
        "pkg-1.19.4-2.2.11" = _liY440dZ;
        "pkg-1.21-4.0.22" = _7HoQUozj;
        "pkg-21.9.2" = _ngGIyEoK;
        "pkg-21.6.5" = _mdoiq56w;
        "pkg-1.20.1-3.1.19" = _b0VVmLcA;
        "pkg-1.21-4.0.23" = _Iy7o7XYH;
        "pkg-21.6.6" = _v5sQ4pA7;
        "pkg-21.9.3" = _Jsf1bng4;
        "pkg-1.20.1-3.1.21" = _GMeznSHn;
        "pkg-1.20.1-3.1.22" = _2sfF7k3u;
        "pkg-21.9.4" = _YAHmMW6D;
        "pkg-21.6.7" = _ANQDvj5H;
        "pkg-21.11.0" = _RuDiLRy3;
        "pkg-1.21-4.0.24" = _knGLaWzP;
        "pkg-1.20.1-3.1.23" = _ncYtFrZA;
        "pkg-1.21-4.0.25" = _4f4He5bw;
        "pkg-21.6.8" = _Wh2pUHTZ;
        "pkg-21.11.2" = _QkXDJBUZ;
        "pkg-21.9.5" = _2BYIS5cy;
        "pkg-21.6.9" = _xYV2MpKP;
        "pkg-1.21-4.0.26" = _d5VdDOXy;
        "pkg-21.9.6" = _dRSLuQud;
        "pkg-1.21-4.0.27" = _LwposAPs;
        "pkg-21.6.10" = _aT2jSd9B;
        "pkg-21.9.7" = _FxjP6YaF;
        "pkg-21.11.3" = _dFFAthgu;
        "pkg-21.11.4" = _WANum3Ad;
        "pkg-1.21-4.0.28" = _Gnrgy4Uh;
        "pkg-21.9.8" = _U7UrmNRJ;
        "pkg-21.6.11" = _P1nDhPyH;
        "pkg-1.20.1-3.1.24" = _27zw3anx;
        "pkg-1.21-4.0.29" = _RTp9wiNL;
        "pkg-21.6.12" = _MWwgNSsY;
        "pkg-21.9.9" = _mzGKldSB;
        "pkg-21.11.5" = _TXt5hYyk;
        "pkg-26.1.0" = _sZU9ppSA;
        "pkg-26.1.1" = _MODBqXCw;
        "pkg-26.1.2" = _OoDJo4wj;
        "pkg-1.21-4.0.30" = _tHyCDNNH;
        "pkg-21.11.6" = _lqiLxSLk;
        "pkg-26.1.3" = _q7PKZiRF;
        "pkg-21.6.13" = _63dZymFQ;
        "pkg-21.9.10" = _VtzPy97R;
        "pkg-26.1.4" = _EkcOgbkC;
