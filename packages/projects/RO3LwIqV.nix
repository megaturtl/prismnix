...
let
    versions = (let
        ...
        _4JtgtLV9 = {
            "id" = "4JtgtLV9";
            "file" = "Ancient Artifacts 2 Datapack V2.5.5h.zip";
            "hash" = "sha512-tbkIuSPjXy7MTHeR0zpVEqEKOTPF7fkVVrzIaCOACZv6i+/5j0Lz4aqBhnEV2/zExZPREabyvDViy+FqkTFu3Q==";
        };
        _UhvWMU8A = {
            "id" = "UhvWMU8A";
            "file" = "Ancient Artifacts 2 V2.5.5h for 1.21.6-26.2.jar";
            "hash" = "sha512-Q7wIbnRINAicW8uBRJ6eor7EwH1r8FLYQtmGoF9moEXHRShqN46r6TSaxMZ/5DG/ErEQAtJnJSjsRt+qK4+nQw==";
        };
        _SSMr9gmp = {
            "id" = "SSMr9gmp";
            "file" = "Ancient Artifacts 2 Datapack V2.5.5i.zip";
            "hash" = "sha512-HraMGYR4GYjUgL+4Pc8wuMbGDbJj/9z497ikP5TAtKAOhJRIJzRQW1Ef+HPGQhtScto0xNaUiHy6CFpd6X5Q/g==";
        };
        _gokDdafr = {
            "id" = "gokDdafr";
            "file" = "Ancient Artifacts 2 V2.5.5i for 1.21.6-26.2.jar";
            "hash" = "sha512-k4JWRsAHjHO6EtJ3wfpdj47pdNvqU5nkHw8P3x5/Fq1aka2FpfngBJT9PUz6t7vU1l1FKjW+p4hGfmFXKgt3zA==";
        };
        _HaNV5Iox = {
            "id" = "HaNV5Iox";
            "file" = "Ancient Artifacts 2 Datapack V2.5.5j.zip";
            "hash" = "sha512-6U8xQc69CEwC5PkBBEH6EEJryhGTE7ReUWVse7dapGcb79ledox6XpOoa32Jo4tPBSkbpkEQwQrOSCib7n2VAQ==";
        };
        _51E82KUf = {
            "id" = "51E82KUf";
            "file" = "Ancient Artifacts 2 V2.5.5j for 1.21.6-26.2.jar";
            "hash" = "sha512-SheCoSEaTcyhqaCN5weV0cqgOw8pLvYKBej/hfumDRTLMVINVjqXXLWJrcrOFUphruQf7cwFh1+B/naW2ZUB3w==";
        };
        _OrOfHzD0 = {
            "id" = "OrOfHzD0";
            "file" = "Ancient Artifacts 2 Datapack V2.5.5k.zip";
            "hash" = "sha512-J8AYvQv3EZ5RA3JLXPhA/k6PaGWzCdRm70B8aridqgzRWnX5R+Xrj+k70MOXu8X1wlMpJyuVUIlKKyfWjpVjjQ==";
        };
        _fXHISAtX = {
            "id" = "fXHISAtX";
            "file" = "Ancient Artifacts 2 V2.5.5k for 1.21.6-26.2.jar";
            "hash" = "sha512-m+ijXPOP7ZU7LDGGb4A2IXUEHm7eqfJU2RnT02dnKwJl0lAa14cVntSDHQX7dpptj21YqksnU98HHepVx9YB9g==";
        };
        _rhOkTkRk = {
            "id" = "rhOkTkRk";
            "file" = "Ancient Artifacts 2 Datapack V2.5.5l.zip";
            "hash" = "sha512-1yiWqR6QXi003lOTnH+x9wOzWOHRHF1nZ32AIEhwzdvdsoLOZS0hL6na9hALI7LWxN5ToOiyX8q5Ms45ucF3Ew==";
        };
        _HCOwwtds = {
            "id" = "HCOwwtds";
            "file" = "Ancient Artifacts 2 V2.5.5l for 1.21.6-26.2.jar";
            "hash" = "sha512-VvNmp24GsaRykcrHWxIkGAlYwqw+RN2D22wJq50fBd0S7oKjw8B4mqHMVLK3e6FG7oHbuU72yae1qZuoAOHA6A==";
        };
        _W4Iq3sjZ = {
            "id" = "W4Iq3sjZ";
            "file" = "Ancient Artifacts 2 Datapack V2.5.5m.zip";
            "hash" = "sha512-eGipJo5O+IjyFh9u6lc4838V3/S7l19RDupZEjjyuzpAccUYAJ7Xdzg/kWiKZRvLscFp2eF45q6QLN8lVYhKlQ==";
        };
        _yxrBjPoO = {
            "id" = "yxrBjPoO";
            "file" = "Ancient Artifacts 2 V2.5.5m for 1.21.6-26.2.jar";
            "hash" = "sha512-8xcg6p5KXetNAqKvrQcuHiPbqLWL+lkKeJmcoFIKUCB/o8qjtEXJGNV9W9+tEqd3nTlTqlb06uH3sIvaDn9qbQ==";
        };
    in {
        "MdWmN2xc" = _MdWmN2xc;
        "DqZL1e9n" = _DqZL1e9n;
        ...
        "datapack-1.21.6" = _W4Iq3sjZ;
        "datapack-1.21.7" = _W4Iq3sjZ;
        "datapack-1.21.8" = _W4Iq3sjZ;
        "datapack-1.21.9" = _W4Iq3sjZ;
        "datapack-1.21.10" = _W4Iq3sjZ;
        "datapack-1.21.11" = _W4Iq3sjZ;
        "datapack-26.1" = _W4Iq3sjZ;
        "datapack-26.1.1" = _W4Iq3sjZ;
        "datapack-26.1.2" = _W4Iq3sjZ;
        "datapack-26.2" = _W4Iq3sjZ;
        "fabric-1.21.5" = _wfwcRWXw;
        "fabric-1.21.6" = _yxrBjPoO;
        "fabric-1.21.7" = _yxrBjPoO;
        "fabric-1.21.8" = _yxrBjPoO;
        "fabric-1.21.9" = _yxrBjPoO;
        "fabric-1.21.10" = _yxrBjPoO;
        "fabric-1.21.11" = _yxrBjPoO;
        "fabric-26.1" = _yxrBjPoO;
        "fabric-26.1.1" = _yxrBjPoO;
        "fabric-26.1.2" = _yxrBjPoO;
        "fabric-26.2" = _yxrBjPoO;
        "forge-1.21.5" = _wfwcRWXw;
        "forge-1.21.6" = _yxrBjPoO;
        "forge-1.21.7" = _yxrBjPoO;
        "forge-1.21.8" = _yxrBjPoO;
        "forge-1.21.9" = _yxrBjPoO;
        "forge-1.21.10" = _yxrBjPoO;
        "forge-1.21.11" = _yxrBjPoO;
        "forge-26.1" = _yxrBjPoO;
        "forge-26.1.1" = _yxrBjPoO;
        "forge-26.1.2" = _yxrBjPoO;
        "forge-26.2" = _yxrBjPoO;
        "neoforge-1.21.5" = _wfwcRWXw;
        "neoforge-1.21.6" = _yxrBjPoO;
        "neoforge-1.21.7" = _yxrBjPoO;
        "neoforge-1.21.8" = _yxrBjPoO;
        "neoforge-1.21.9" = _yxrBjPoO;
        "neoforge-1.21.10" = _yxrBjPoO;
        "neoforge-1.21.11" = _yxrBjPoO;
        "neoforge-26.1" = _yxrBjPoO;
        "neoforge-26.1.1" = _yxrBjPoO;
        "neoforge-26.1.2" = _yxrBjPoO;
        "neoforge-26.2" = _yxrBjPoO;
        "quilt-1.21.5" = _wfwcRWXw;
        "quilt-1.21.6" = _yxrBjPoO;
        "quilt-1.21.7" = _yxrBjPoO;
        "quilt-1.21.8" = _yxrBjPoO;
        "quilt-1.21.9" = _yxrBjPoO;
        "quilt-1.21.10" = _yxrBjPoO;
        "quilt-1.21.11" = _yxrBjPoO;
        "quilt-26.1" = _yxrBjPoO;
        "quilt-26.1.1" = _yxrBjPoO;
        "quilt-26.1.2" = _yxrBjPoO;
        "quilt-26.2" = _yxrBjPoO;
        ...
        "pkg-2.5.5h" = _UhvWMU8A;
        "pkg-2.5.5i" = _gokDdafr;
        "pkg-2.5.5j" = _51E82KUf;
        "pkg-2.5.5k" = _fXHISAtX;
        "pkg-2.5.5l" = _HCOwwtds;
        "pkg-2.5.5m" = _yxrBjPoO;
        "default" = _yxrBjPoO;
    });
