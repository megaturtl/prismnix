...
let
    ...
    in {
        ...
        "pkg-1.0.2" = _vTViLQvA;
        "pkg-1.1.0" = _EJHNTdmP;
        "pkg-1.1.0-1.20.2" = _oYXfn8Ly;
        "pkg-1.1.1-1.20.1" = _GQACULh1;
        "pkg-1.1.2-1.20.1" = _F3wUE2KP;
        "pkg-1.1.3-1.20.1" = _9adkVmnH;
        "pkg-1.1.4-1.20.1" = _OzjIGnCo;
        "pkg-1.1.5-1.20.1" = _sAb4sprI;
        "pkg-1.1.6-1.20.1" = _aJLMkfsn;
        "pkg-1.1.6-1.20.4" = _wiX5tzAE;
        "pkg-1.1.7-1.20.1" = _Y42zbzPh;
        "pkg-1.1.7-1.20.4" = _GgrL5nB5;
        "pkg-1.1.8-1.20.1" = _doxWGs8G;
        "pkg-1.1.8-1.20.4" = _5z3P73R4;
        "pkg-1.1.9-1.20.1" = _8f9j7B3i;
        "pkg-1.1.9-1.20.4" = _WOKbVMrD;
        "pkg-1.2.0-1.20.1" = _LSyNevQ8;
        "pkg-1.2.0-1.20.4" = _it8EbNKx;
        "pkg-1.2.1-1.20.1" = _QNQXrdhi;
        "pkg-1.2.1-1.20.4" = _hTIcDdfR;
        "pkg-1.2.1-1.21" = _WGosJslb;
        "pkg-1.2.1-1.21.1" = _J7aQd1oy;
        "pkg-1.3.0" = _DXRg6MKv;
        "pkg-1.3.1" = _5vhgUUvQ;
        "pkg-1.3.2" = _RfmYMk5z;
        "pkg-1.3.3" = _iPMtjFcK;
        "pkg-1.21.1-1.3.4" = _rp4lPDKI;
        "pkg-1.21.4-1.3.4" = _ZIvGgf89;
        "pkg-1.21.10-1.3.4" = _fYPs6RdP;
        "pkg-1.21.11-1.3.4" = _qgFxJKTn;
        "pkg-26.1.x-1.3.4" = _WvbHAAs0;
        "pkg-1.21.11-1.3.5" = _p8DZXCvf;
        "pkg-26.1.x-1.3.5" = _XIJ32RqZ;
        "pkg-26.1.x-1.3.6" = _DS66YkQS;
        "pkg-1.21.11-1.3.6" = _UX9ljBLC;
        "pkg-1.21.4-1.3.6" = _gb3w4dQU;
        "pkg-1.21.1-1.3.6" = _Lv9CUPRA;
        "pkg-1.21.1-1.3.7" = _vNdCUsLm;
