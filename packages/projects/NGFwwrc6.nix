...
let
    versions = (let
        ...
        _rAw2YYYA = {
            "id" = "rAw2YYYA";
            "file" = "Assorted Allays - V.12.0.zip";
            "hash" = "sha512-g5inBaUq6mwx1aVrBuQIgzkgduvA0hlGwGHp6tt3ub+iv3BPp0FyBbr6MzLWh6vvtFprHRgnC6gOuYeVil1qtw==";
        };
    in {
        "U5UPSHIV" = _U5UPSHIV;
        "Pz9rlX39" = _Pz9rlX39;
        ...
        "minecraft-1.20.1" = _rAw2YYYA;
        "minecraft-1.20.2" = _rAw2YYYA;
        "minecraft-1.20.3" = _rAw2YYYA;
        "minecraft-1.20.4" = _rAw2YYYA;
        "minecraft-1.20.5" = _rAw2YYYA;
        "minecraft-1.20.6" = _rAw2YYYA;
        "minecraft-1.21" = _rAw2YYYA;
        "minecraft-1.21.1" = _rAw2YYYA;
        "minecraft-1.21.2" = _rAw2YYYA;
        "minecraft-1.21.3" = _rAw2YYYA;
        "minecraft-1.21.4" = _rAw2YYYA;
        "minecraft-1.21.5" = _rAw2YYYA;
        "minecraft-1.21.6" = _rAw2YYYA;
        "minecraft-1.21.7" = _rAw2YYYA;
        "minecraft-1.21.8" = _rAw2YYYA;
        "minecraft-1.21.9" = _rAw2YYYA;
        "minecraft-1.21.10" = _rAw2YYYA;
        "minecraft-1.21.11" = _rAw2YYYA;
        "minecraft-26.1" = _rAw2YYYA;
        "minecraft-26.1.1" = _rAw2YYYA;
        "minecraft-26.1.2" = _rAw2YYYA;
        "minecraft-26.2" = _rAw2YYYA;
        "pkg-2.0" = _U5UPSHIV;
        "pkg-3.0" = _Pz9rlX39;
        "pkg-4.0" = _XSHgIbw4;
        "pkg-5.0" = _uierCCld;
