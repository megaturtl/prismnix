...
let
    ...
    in {
        ...
        "pkg-v1.0.1" = _gana0zTK;
        "pkg-v1.1.0" = _KLDUL4Nj;
        "pkg-v1.2.0" = _X4hFw0MW;
        "pkg-v1.3.0" = _4GDkKQjD;
        "pkg-v1.3.1+1.20.4" = _lwC7uln4;
        "pkg-v1.3.1+1.20.6" = _lvq1giFT;
        "pkg-v1.3.1" = _loozFoPU;
        "pkg-v1.3.2" = _vWuyNOTG;
        "pkg-v1.3.3+1.20.4" = _CYZjlmD7;
        "pkg-v1.3.3+1.20.6" = _k8pbW9g2;
        "pkg-v1.3.3" = _SpFCxOeF;
        "pkg-v1.3.4" = _O5jCUgjL;
        "pkg-v2.0.0+1.20" = _tC8m2luF;
        "pkg-v2.0.0+1.20.5" = _OBwewaps;
        "pkg-v2.0.0+1.21" = _VDTKBv3o;
        "pkg-v2.0.0" = _Fz4Ls2Eu;
        "pkg-v2.0.1+1.20" = _XMf1cRqa;
        "pkg-v2.0.1+1.20.5" = _w20sMotK;
        "pkg-v2.0.1+1.21" = _JFHo8jH8;
        "pkg-v2.0.1" = _yati0lyi;
        "pkg-v2.0.2+1.21.5" = _3WDvgWsF;
        "pkg-v2.0.2+1.21.5-neoforge" = _iayGtb83;
        "pkg-v2.1.0+1.20.1-forge" = _15hG3BCp;
        "pkg-v2.1.0+1.20.4-fabric" = _kPJFPcjH;
        "pkg-v2.1.0+1.20.4-forge" = _cjwEHHuV;
        "pkg-v2.1.0+1.20.4-neoforge" = _dWfeHv9f;
        "pkg-v2.1.0+1.20.6-fabric" = _Lza6aO0h;
        "pkg-v2.1.0+1.20.6-neoforge" = _p3q7w1la;
        "pkg-v2.1.0+1.21.1-fabric" = _Aw3IjzlB;
        "pkg-v2.1.0+1.21.1-neoforge" = _riCXxzG2;
        "pkg-v2.1.0+1.21.2-fabric" = _E59t5YTq;
        "pkg-v2.1.0+1.21.2-neoforge" = _IAcdZjft;
        "pkg-v2.1.1+1.20.1-forge" = _u7ZJ2FpX;
        "pkg-v2.1.1+1.20.4-forge" = _mwbxO4DR;
        "pkg-v2.1.1+1.20.4-neoforge" = _3rmWPRlh;
        "pkg-v2.2.0+1.21.9-fabric" = _e6nL9FIb;
        "pkg-v2.2.0+1.21.9-neoforge" = _33kRrvGB;
        "pkg-v2.2.1+1.21.10-fabric" = _HxtkIajd;
        "pkg-v2.2.1+1.21.10-neoforge" = _M5qYN4YA;
        "pkg-v2.2.1+1.21.11-fabric" = _1uwtquJM;
        "pkg-v2.2.1+1.21.11-neoforge" = _iyCUeWvV;
        "pkg-v2.2.2+1.21.10-fabric" = _wVZgMx1h;
        "pkg-v2.2.2+1.21.10-neoforge" = _ZgJvLjCg;
        "pkg-v2.2.2+1.21.11-fabric" = _lWQIdijf;
        "pkg-v2.2.2+1.21.11-neoforge" = _rVm956Pf;
        "pkg-v2.2.2+1.21.1-fabric" = _F0bLQuFm;
        "pkg-v2.2.2+1.21.1-neoforge" = _yXZeHmn8;
        "pkg-v2.3.0+26.1-fabric" = _UKXCz4A9;
        "pkg-v2.3.0+26.1-neoforge" = _X4MLP4so;
        "pkg-v2.3.1+1.21.11-fabric" = _oLxTtbVJ;
        "pkg-v2.3.1+1.21.11-neoforge" = _Dugbc0ld;
        "pkg-v2.3.1+26.1-fabric" = _8T8BTrDm;
