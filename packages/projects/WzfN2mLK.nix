...
let
    versions = (let
        ...
        _tqQtpW6P = {
            "id" = "tqQtpW6P";
            "file" = "proxy-bungeecord.jar";
            "hash" = "sha512-+nqWolVsmWFFZLCegnMSuFK1ErfncJOZXvNrjwNe7OYATBmKdi12qFiq8YzFRh9odFV7H08y/ZvdgsPAyXGX/A==";
        };
        _8yfDPsCQ = {
            "id" = "8yfDPsCQ";
            "file" = "proxy-velocity.jar";
            "hash" = "sha512-7NKrUglh5ULLoBwkOPl+3+84n4NP3A1VEtpSXJvdpZ3qZALW1DDI1c8ZcjdILH4q89mhxm3wJ/Ey4p8KOancrQ==";
        };
        _1W7RCAMV = {
            "id" = "1W7RCAMV";
            "file" = "proxy-bungeecord.jar";
            "hash" = "sha512-bigJV61klelRlMhpHzC4f+3KfbdrPBlab7nG8g3JfK51vdYe7G3a0uB6IYSz6peZwtodWBPwKDS+IWqeEo+t1Q==";
        };
        _qC0NNwb5 = {
            "id" = "qC0NNwb5";
            "file" = "proxy-velocity.jar";
            "hash" = "sha512-f+wPVHBBi5E7Fr/f3snkboEiSdiInYbwxal7zzCR/ejwNoik4UJsc+O590IzpXo/KJ9+4gI/ZJfRW0kZL4D6zA==";
        };
        _MMgrH7KS = {
            "id" = "MMgrH7KS";
            "file" = "proxy-bungeecord.jar";
            "hash" = "sha512-FUF27HrE0SDHw20ZSDTEJNYZX3JDN5o1BmICWM6bM4Kpu6ak3mimGf1U7Fj1HuPsboVNGBR18aZHL8XejeoM6g==";
        };
        _b3HsUvEB = {
            "id" = "b3HsUvEB";
            "file" = "proxy-velocity.jar";
            "hash" = "sha512-mo6SkN9n+xMehIxHihghozszLVEZaLBjqfTV2rSiEql8e7TSDQ3fpJZ88nT5/CRirwIcFcq/W3QW8wC/0oolyg==";
        };
        _mlkmBQzT = {
            "id" = "mlkmBQzT";
            "file" = "proxy-bungeecord.jar";
            "hash" = "sha512-2xq1HXrinAQMOZAF8DvA4p5cFiCcfqO9Twk395VNaeEZtTtr1ZGn+C0YqFvDS4W8h+YblkQQJDH3V7jiXISUWw==";
        };
        _UXyq4XJ6 = {
            "id" = "UXyq4XJ6";
            "file" = "proxy-velocity.jar";
            "hash" = "sha512-cy3jwWxRd8Y8pGgjr4tJkAyeFSVMjCK3sOqy36nwolTU40YgIQpT9j7s4ln+xSfYiYVn1lsPTX7SSHO6wPLf4A==";
        };
        _BcEn3LCT = {
            "id" = "BcEn3LCT";
            "file" = "proxy-bungeecord.jar";
            "hash" = "sha512-T8InAI16HwwbzisisYFLSN99LPEFZTQsYulWvQlQW5oeRswdQyECq6yanrHGljSs61HgXu+5GrE9KL2VZEdUUQ==";
        };
        _rVZQzFV2 = {
            "id" = "rVZQzFV2";
            "file" = "proxy-velocity.jar";
            "hash" = "sha512-FAI2boewRHBf7TXTx4imXEYbSY0hnd74gIlw+JWUOWnVR+ZRTys1YyRjzM2XmNktvpbwT8rx518HPC4Wy8fiZg==";
        };
        _oszMbnVY = {
            "id" = "oszMbnVY";
            "file" = "proxy-bungeecord.jar";
            "hash" = "sha512-Ze95elOQP4PJG/lrU7ld42ACpE5M5OoHzzi0DyBo1dqRqHMM038SJMbFxablvIJEdhD2GxdajjP/xdydiejvgw==";
        };
        _MJgs0NWF = {
            "id" = "MJgs0NWF";
            "file" = "proxy-velocity.jar";
            "hash" = "sha512-8pzF6jCWk2zap1ZDS9HR+yQpVKPwHncUdmoXoRZMpFKpJ+vuWiTK06bAysdktdznHiP0VXYbOmYuDVznwaTkfg==";
        };
        _u2y5FdSd = {
            "id" = "u2y5FdSd";
            "file" = "proxy-bungeecord.jar";
            "hash" = "sha512-Ec8L3qnEtPHHbD78X3UnzO0Cia00Uw8ovn9CGvKuzqJlW3ZVoHAhakINCd4n1RRtNzJQVHQGTysJ++Tg37XkWA==";
        };
        _Ln9vBPBs = {
            "id" = "Ln9vBPBs";
            "file" = "proxy-velocity.jar";
            "hash" = "sha512-aw5l1EWK1PV/ZijYUSgtSzCsWqq+tgN/J11gj/NlrRNxpGV6UX7dPH9Z0xjmDfIb7uQG0SS/Z8je3G6ytzGZ8A==";
        };
        _CBlo4nKH = {
            "id" = "CBlo4nKH";
            "file" = "proxy-bungeecord.jar";
            "hash" = "sha512-BFPLCwM1PZ/KwT3EJx494eK0w5ESBBbExp/C8FQzIxZF7sNgtFMKVLi6ISHWCfP3CQgXZUx9Iv3j5Zealj322w==";
        };
        _IDK9kiCp = {
            "id" = "IDK9kiCp";
            "file" = "proxy-velocity.jar";
            "hash" = "sha512-fpF3DpXhVWBC50KYRUKeRMV0+/uLKCSMvqAbU9Afkd25U0zatoLibY1Lk0MJvFl3ffvjezmFMrN8I2xjPGQFaA==";
        };
        _jBQJBA8c = {
            "id" = "jBQJBA8c";
            "file" = "proxy-bungeecord.jar";
            "hash" = "sha512-VA5OeSVhbo0MSKk7ZER1fCGGD2VB9KrEC7dRnHGM8l3YBcl41Pj8W0v4F/K9THBxG+G7EqE9mBU7BCdoIUIaEw==";
        };
        _1UsfCyUo = {
            "id" = "1UsfCyUo";
            "file" = "proxy-velocity.jar";
            "hash" = "sha512-OKDtl+FnL9+DKU1w7ORvKvfb8+1qwO6IdJ7PgbuCMdlrfJZNMyqFBivSxrGpK10oNTaV3cH0Tai+FgM2Po79/w==";
        };
    in {
        "jT8jWNzd" = _jT8jWNzd;
        "n2EQB3ey" = _n2EQB3ey;
        ...
        "jBQJBA8c" = _jBQJBA8c;
        "1UsfCyUo" = _1UsfCyUo;
        "bungeecord-1.20" = _jBQJBA8c;
        "bungeecord-1.20.1" = _jBQJBA8c;
        "bungeecord-1.20.2" = _jBQJBA8c;
        "bungeecord-1.20.3" = _jBQJBA8c;
        "bungeecord-1.20.4" = _jBQJBA8c;
        "bungeecord-1.20.5" = _jBQJBA8c;
        "bungeecord-1.20.6" = _jBQJBA8c;
        "bungeecord-1.21" = _jBQJBA8c;
        "bungeecord-1.21.1" = _jBQJBA8c;
        "bungeecord-1.21.2" = _jBQJBA8c;
        "bungeecord-1.21.3" = _jBQJBA8c;
        "bungeecord-1.21.4" = _jBQJBA8c;
        "bungeecord-1.21.5" = _jBQJBA8c;
        "bungeecord-1.21.6" = _jBQJBA8c;
        "bungeecord-1.21.7" = _jBQJBA8c;
        "bungeecord-1.21.8" = _jBQJBA8c;
        "bungeecord-1.21.9" = _jBQJBA8c;
        "bungeecord-1.21.10" = _jBQJBA8c;
        "bungeecord-1.21.11" = _jBQJBA8c;
        "bungeecord-26.1" = _jBQJBA8c;
        "bungeecord-26.1.1" = _jBQJBA8c;
        "bungeecord-26.1.2" = _jBQJBA8c;
        "bungeecord-26.2" = _jBQJBA8c;
        "bungeecord-26.3" = _jBQJBA8c;
        "velocity-1.20" = _1UsfCyUo;
        "velocity-1.20.1" = _1UsfCyUo;
        "velocity-1.20.2" = _1UsfCyUo;
        "velocity-1.20.3" = _1UsfCyUo;
        "velocity-1.20.4" = _1UsfCyUo;
        "velocity-1.20.5" = _1UsfCyUo;
        "velocity-1.20.6" = _1UsfCyUo;
        "velocity-1.21" = _1UsfCyUo;
        "velocity-1.21.1" = _1UsfCyUo;
        "velocity-1.21.2" = _1UsfCyUo;
        "velocity-1.21.3" = _1UsfCyUo;
        "velocity-1.21.4" = _1UsfCyUo;
        "velocity-1.21.5" = _1UsfCyUo;
        "velocity-1.21.6" = _1UsfCyUo;
        "velocity-1.21.7" = _1UsfCyUo;
        "velocity-1.21.8" = _1UsfCyUo;
        "velocity-1.21.9" = _1UsfCyUo;
        "velocity-1.21.10" = _1UsfCyUo;
        "velocity-1.21.11" = _1UsfCyUo;
        "velocity-26.1" = _1UsfCyUo;
        "velocity-26.1.1" = _1UsfCyUo;
        "velocity-26.1.2" = _1UsfCyUo;
        "velocity-26.2" = _1UsfCyUo;
        "velocity-26.3" = _1UsfCyUo;
        "waterfall-1.20" = _jBQJBA8c;
        "waterfall-1.20.1" = _jBQJBA8c;
        "waterfall-1.20.2" = _jBQJBA8c;
        "waterfall-1.20.3" = _jBQJBA8c;
        "waterfall-1.20.4" = _jBQJBA8c;
        "waterfall-1.20.5" = _jBQJBA8c;
        "waterfall-1.20.6" = _jBQJBA8c;
        "waterfall-1.21" = _jBQJBA8c;
        "waterfall-1.21.1" = _jBQJBA8c;
        "waterfall-1.21.2" = _jBQJBA8c;
        "waterfall-1.21.3" = _jBQJBA8c;
        "waterfall-1.21.4" = _jBQJBA8c;
        "waterfall-1.21.5" = _jBQJBA8c;
        "waterfall-1.21.6" = _jBQJBA8c;
        "waterfall-1.21.7" = _jBQJBA8c;
        "waterfall-1.21.8" = _jBQJBA8c;
        "waterfall-1.21.9" = _jBQJBA8c;
        "waterfall-1.21.10" = _jBQJBA8c;
        "waterfall-1.21.11" = _jBQJBA8c;
        "waterfall-26.1" = _jBQJBA8c;
        "waterfall-26.1.1" = _jBQJBA8c;
        "waterfall-26.1.2" = _jBQJBA8c;
        "waterfall-26.2" = _jBQJBA8c;
        "waterfall-26.3" = _jBQJBA8c;
        ...
        "pkg-0.0.7-dev.28c151d" = _8yfDPsCQ;
        "pkg-0.0.8-dev.15a8dec" = _qC0NNwb5;
        "pkg-0.0.9-dev.d4e0dc9" = _b3HsUvEB;
        "pkg-0.0.9-dev.9f7c38f" = _UXyq4XJ6;
        "pkg-0.0.10-dev.8a4df76" = _rVZQzFV2;
        "pkg-0.0.11-dev.0db2d7f" = _MJgs0NWF;
        "pkg-0.0.12-dev.6ac02a8" = _Ln9vBPBs;
        "pkg-0.0.13-dev.cb0395f" = _IDK9kiCp;
        "pkg-0.0.14-dev.167486c" = _1UsfCyUo;
        "default" = _1UsfCyUo;
    });
