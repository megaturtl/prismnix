...
let
    versions = (let
        ...
        _JhbC29xY = {
            "id" = "JhbC29xY";
            "file" = "c2me-fabric-mc26.3-snapshot-7-0.4.2-alpha.0.44.jar";
            "hash" = "sha512-dEZ+8guVD1E+6ji+A+KQN3I2WJJ8azIanOPXdQu+cuS/oXCEJLNhTSsMQncmSNWxa8S7EKjU+a79FpS2SLSpzg==";
        };
        _NuRHGP5e = {
            "id" = "NuRHGP5e";
            "file" = "c2me-fabric-mc26.2-0.4.2-alpha.0.40.jar";
            "hash" = "sha512-PQId/XmUEnGqeCzqTzKhj31dm5GLHzGLTPGwFzoXP6WiSbMk0oJxWGak+C/KrL11KV5wcdXMZLL2cd0XOZ+ErQ==";
        };
        _BydoEfWC = {
            "id" = "BydoEfWC";
            "file" = "c2me-fabric-mc26.3-snapshot-8-0.4.2-alpha.0.45.jar";
            "hash" = "sha512-xJGEG6LkWR0wYTINV3cNLgwuDwdkOsGPJJBmbARoMlhoXyC8VlgGHygs4FL9tngxmlzrLymF+0GPP1tQCSfAeg==";
        };
        _sOfMfJPD = {
            "id" = "sOfMfJPD";
            "file" = "c2me-fabric-mc26.2-0.4.2-alpha.0.41.jar";
            "hash" = "sha512-ZJp+hmu/7SCZwSIoxJr7dqhQwPCHumZAx+c8wiSquSGpKq/QeX8pEZrFJjLEEpkZJNfqy5ZKjAuGT/Nj8FeYAQ==";
        };
        _2TRA2j3R = {
            "id" = "2TRA2j3R";
            "file" = "c2me-fabric-mc26.1.2-0.4.0-alpha.0.52.jar";
            "hash" = "sha512-n99w0mfR93kQcl2IINztYiN84zGf3XYX6Zxw9wVvq333jUhVcTE5X5By2Oq82uWu/kC86oOGYyAuRoZC99iedQ==";
        };
        _yvc7Nw6M = {
            "id" = "yvc7Nw6M";
            "file" = "c2me-fabric-mc1.21.11-0.4.0-alpha.0.24.jar";
            "hash" = "sha512-FHOi8efZm1zR91WOQBVl98RbcaAzmF/T7ZOlxVs2AskmKwhV32S6vSLLVEwvXv9HLnL3cIoyWjhXqZbbXv7LLg==";
        };
        _jD4KJHe0 = {
            "id" = "jD4KJHe0";
            "file" = "c2me-fabric-mc1.21.1-0.4.0-alpha.0.25.jar";
            "hash" = "sha512-US6ChTm1VABFSpaZZyFsLSJWAvUsiYTWua/TPB8XN4E+gN8t7kDaTbkODOQcmLxmzRtvLyB3Dw2bBPPquqASnQ==";
        };
        _jSMMstCy = {
            "id" = "jSMMstCy";
            "file" = "c2me-fabric-mc26.2-0.4.2-alpha.0.43.jar";
            "hash" = "sha512-ycnJur5NlOBqv3LJLkU6qjnIJjSnrmRtEEH2c+Eu/z2Z534gWmhupT0KWuFD6eHm7VlbPM/K6v5ky/tjJ+LzdQ==";
        };
        _riLBXg84 = {
            "id" = "riLBXg84";
            "file" = "c2me-fabric-mc26.1.2-0.4.0-alpha.0.54.jar";
            "hash" = "sha512-6be2YyGLc5PrsER+qLaFAQ691lCMlEGeesNM9RGhsRG9/3qrI9NhwaBSPq0iVXPDRyuEjuAKUPwJQBkxuSTn1Q==";
        };
        _7bPy44k8 = {
            "id" = "7bPy44k8";
            "file" = "c2me-fabric-mc1.21.11-0.4.0-alpha.0.25.jar";
            "hash" = "sha512-1TADTfTWTAdQq1MPBgcQEOyADVjNiwui1fLU/9q47Vc/b+3N3Snw4yDdaDqKL78/6s0qjoYllWMGmtC0cEYd7w==";
        };
        _879vA5z6 = {
            "id" = "879vA5z6";
            "file" = "c2me-fabric-mc1.21.11-0.4.0-alpha.0.26.jar";
            "hash" = "sha512-vbbOBJrnx3n5r92Ash0mbe7OLvdqKvgDP1VU0qUONzSp0ERDPAyW8Msn7nChiBuX6+14Zz7iHDqr/crVgoJT5Q==";
        };
        _gRm1ZAvc = {
            "id" = "gRm1ZAvc";
            "file" = "c2me-fabric-mc1.21.1-0.4.0-alpha.0.27.jar";
            "hash" = "sha512-js+yzF2v8x0MzzACHDGsMcqEWtfJ6qGkNvEGJ54At51ddaMl6/n5Nz7wGZhk8HPmMVprnw1aUTMskGqBxQ3Lng==";
        };
        _hVR1K2iw = {
            "id" = "hVR1K2iw";
            "file" = "c2me-fabric-mc26.3-snapshot-9-0.4.2-alpha.0.63.jar";
            "hash" = "sha512-3aEkMPWfShgzxTCYSgP5Xu6nQV5+AxGfaARVo3WyaovIkgBpSq9HCBzwR/BzVV6FvYRnlVwFT3tVPJ0hApWdog==";
        };
        _UrquBzNr = {
            "id" = "UrquBzNr";
            "file" = "c2me-fabric-mc26.3-snapshot-9-0.4.2-alpha.0.64.jar";
            "hash" = "sha512-CGHYuP5PdUzFkHx8IRKcadbtzWFJLL3+bp22UpVZx/iuPs0pi09GcRWuAOsyDyaq9LWXoTLpEsuHaTNR1J8+Cw==";
        };
        _UWShfQPB = {
            "id" = "UWShfQPB";
            "file" = "c2me-fabric-mc26.3-snapshot-10-0.4.2-alpha.0.65.jar";
            "hash" = "sha512-HANyfAQgtX0N4fagyicPtB5jPwDSJmax/Nu9WpAKAFejsjojSITZnpK+zSzbhSirKLQetVg9NolhHXmfaeL0kQ==";
        };
        _tbNgOO92 = {
            "id" = "tbNgOO92";
            "file" = "c2me-fabric-mc26.3-pre-1-0.4.2-alpha.0.67.jar";
            "hash" = "sha512-u1pnqwpLtBZCw24NBvIwtPIiwsKCFYwC1c9BxEd2oSaUD1bbrNgk49bobCF5FzdkkrQkInc9/Q96bYc0GW9s0Q==";
        };
        _4Noy265p = {
            "id" = "4Noy265p";
            "file" = "c2me-fabric-mc26.3-pre-2-0.4.2-alpha.0.68.jar";
            "hash" = "sha512-cB/gf3iujk8AgRARmSubYXmBd3thkrrxwAoHlx4xvg5azPN+fQN/SK5tVEEc5Eyk1VSmR9n6a014KWAgqO24Tg==";
        };
        _SbOM6l3U = {
            "id" = "SbOM6l3U";
            "file" = "c2me-fabric-mc26.3-pre-3-0.4.2-alpha.0.71.jar";
            "hash" = "sha512-RAPklgBbGi50OCdg6ZU+915zqTg73ogh2HJrvXX30s3aSz88dnkyva0jg/bKK+FmpAuVCXsTmNKcN/c8sg1GyQ==";
        };
        _Z7GkrZIE = {
            "id" = "Z7GkrZIE";
            "file" = "c2me-fabric-mc26.3-rc-1-0.4.2-alpha.0.73.jar";
            "hash" = "sha512-3BN4azReOqSRMVbnsrx9CAYuWpWvordDJFJN1xN0F7xwEnuPivHM6VXZ6Va18kSbA5P7NgGmEWJ71XMVYeageg==";
        };
        _iTSBdIVj = {
            "id" = "iTSBdIVj";
            "file" = "c2me-fabric-mc26.3-rc-2-0.4.2-alpha.0.74.jar";
            "hash" = "sha512-OtwprAhZQkGEftDjEUouVjlFlOxxdLvPIJ1EbNuq8KZtFk5zizcdqBpT+T8kBBPOPzEb1iOfZ0Cb8wmUcE2rxg==";
        };
        _yLWBY3b7 = {
            "id" = "yLWBY3b7";
            "file" = "c2me-fabric-mc26.3-rc-2-0.4.2-alpha.0.76.jar";
            "hash" = "sha512-SrGDDbNE0A7ZoBG+dsjC2Ak2oiRmLwjb/xIKuZI1YF7NF+Wp0r8MkkWa+fJ3PYgnzxLWBBTDkhyJw8bait+TWw==";
        };
        _V6ajCzRo = {
            "id" = "V6ajCzRo";
            "file" = "c2me-fabric-mc26.3-rc-2-0.4.2-alpha.0.81.jar";
            "hash" = "sha512-xerg/CwMKGNKtLUyHUPnTXsl3TqWLo2mW1G23LN/kUii6tZX467oI0/pRMGXGIRwmEEtCUm1J0MaIO5BzPg8oQ==";
        };
        _LmKTn6Yc = {
            "id" = "LmKTn6Yc";
            "file" = "c2me-fabric-mc26.2-0.4.2-alpha.0.52.jar";
            "hash" = "sha512-dqfFLqmyIpXBXQK+fxykto/Gc2hGXxvTz/tHzTa/O/a53ZJbygLMssfLLCbfEjVTjZjdusQ/hZhcOf0YPJ80aA==";
        };
        _2wydyF7u = {
            "id" = "2wydyF7u";
            "file" = "c2me-fabric-mc26.3-rc-3-0.4.2-alpha.0.84.jar";
            "hash" = "sha512-XMuat+bm/VXLxO1bYJBsswKj82uF13w7aF59S20wzRKZ8Tj/rxomUUHD8PvjSjloJ1yZ0NNr6x6OVNMK7UfUNA==";
        };
        _XgxQ7H1c = {
            "id" = "XgxQ7H1c";
            "file" = "c2me-fabric-mc26.3-0.4.2-alpha.0.85.jar";
            "hash" = "sha512-9mnlvhJtA9h+0tCF9qMq3g/hWVaYVtz3aX7mS3poX2zo+bfgLsAyi3ko+Dwf77oC2KGg4SETEcTsqrbwCiZMUw==";
        };
        _DIsK28i3 = {
            "id" = "DIsK28i3";
            "file" = "c2me-fabric-mc1.21.11-0.4.0-alpha.0.27.jar";
            "hash" = "sha512-g3FblNWj1vtxDDcY0A84qMdQoBZeMxWT6AACA7+prsED/oINVFod1QSJjEyfnd0i4MYtsOtaTyHYYrZg8OrTHA==";
        };
        _o1m4A4Rk = {
            "id" = "o1m4A4Rk";
            "file" = "c2me-fabric-mc26.1.2-0.4.0-alpha.0.62.jar";
            "hash" = "sha512-7l4g+KGqfGcIurDbMB1GNt/4LEVIlRCBQ8atTqbVMttWQ+PuUs/e8qw4qbchOF9utGTTOtp3YPQ8kDhePXidwA==";
        };
        _RMHYO1LJ = {
            "id" = "RMHYO1LJ";
    ...
    in {
        ...
        "fabric-26.3-snapshot-7" = _JhbC29xY;
        "fabric-26.3-snapshot-8" = _BydoEfWC;
        "fabric-26.3-snapshot-9" = _UrquBzNr;
        "fabric-26.3-snapshot-10" = _UWShfQPB;
        "fabric-26.3-pre-1" = _tbNgOO92;
        "fabric-26.3-pre-2" = _4Noy265p;
        "fabric-26.3-pre-3" = _SbOM6l3U;
        ...
        "pkg-0.2.0+alpha.5.40 21w41a" = _dKKE3zhp;
        "pkg-0.2.0+alpha.5.43 21w42a" = _NSobPr3s;
        "pkg-0.2.0+alpha.5.48 21w43a" = _pmOkpHL2;
        "pkg-0.2.0+alpha.5.54 21w44a" = _ojV9FS0t;
        "pkg-0.2.0+alpha.5.63 1.18-pre1" = _xP8CXN3T;
        "pkg-0.2.0+alpha.5.70 1.18-pre5" = _LFqvAnbE;
        "pkg-0.2.0+alpha.5.77 1.18-pre5" = _pSxkh6Qu;
        "pkg-0.2.0+alpha.5.85 1.18-rc3" = _SpaBqzHT;
        "pkg-0.2.0+alpha.5.87 1.18-rc3" = _B6ee0W8y;
        "pkg-0.2.0+alpha.5.94 1.18.1-pre1" = _u2JlHGcG;
        "pkg-0.2.0+alpha.5.96 1.18.1-pre1" = _yjCsfBzI;
        "pkg-0.2.0+alpha.5.99 1.18.1" = _G1RN9hkt;
        "pkg-0.2.0+alpha.5.103 1.18.1" = _L4GQmy36;
        "pkg-0.2.0+alpha.5.104 1.18.1" = _E3cvbFES;
        "pkg-0.2.0+alpha.5.106 1.18.1" = _pIDNlM4l;
        "pkg-0.2.0+alpha.5.110 1.18.1" = _GExDMas5;
        "pkg-0.2.0+alpha.6.0 1.18.1" = _e7NAaeNt;
        "pkg-0.2.0+alpha.6.1 1.18.1" = _UMPBDzKM;
        "pkg-0.2.0+alpha.6.24 1.18.1" = _c8VQ9yC5;
        "pkg-0.2.0+alpha.6.25 1.18.1" = _9ITewh53;
        "pkg-0.2.0+alpha.6.53+1.18.1" = _Dk2OSyZE;
        "pkg-0.2.0+alpha.6.48+22w05a" = _glmbs812;
        "pkg-0.2.0+alpha.6.50+22w06a" = _8xmNpyLJ;
        "pkg-0.2.0+alpha.6.54+1.18.1" = _5bqFdDSB;
        "pkg-0.2.0+alpha.6.54+1.18.2-pre1" = _LCwohtHy;
        "pkg-0.2.0+alpha.6.55+1.18.1" = _VVlAcu8X;
        "pkg-0.2.0+alpha.6.58+1.18.2-rc1" = _iCgRTqOy;
        "pkg-0.2.0+alpha.6.62+1.18.2" = _U7wzpemA;
        "pkg-0.2.0+alpha.7.0+1.18.2" = _5P5gJ4ws;
        "pkg-0.2.0+alpha.7.11+22w11a" = _MRi5CAUa;
        "pkg-0.2.0+alpha.7.13+22w12a" = _rhq6flAe;
        "pkg-0.2.0+alpha.7.14+22w13a" = _todB4Gz5;
        "pkg-0.2.0+alpha.7.16+22w14a" = _7hUUNuox;
        "pkg-0.2.0+alpha.7.29+22w16b" = _anltmjSp;
        "pkg-0.2.0+alpha.7.30+22w17a" = _ExoP2rex;
        "pkg-0.2.0+alpha.7.36+22w18a" = _biOCYJZd;
        "pkg-0.2.0+alpha.7.37+22w19a" = _4vuaNrle;
        "pkg-0.2.0+alpha.7.38+22w19a" = _HSbd0h1G;
        "pkg-0.2.0+alpha.7.40+22w19a" = _hrDzs4sK;
        "pkg-0.2.0+alpha.7.48+1.19-pre1" = _vv64RzIR;
        "pkg-0.2.0+alpha.7.49+1.19-pre2" = _2suDoW3A;
        "pkg-0.2.0+alpha.7.50+1.19-pre3" = _WvJYXJ5r;
        "pkg-0.2.0+alpha.7.53+1.19-rc1" = _9Bxa2twj;
        "pkg-0.2.0+alpha.7.54+1.19-rc2" = _RaaE0QZS;
        "pkg-0.2.0+alpha.7.56+1.19" = _KFecXkCR;
        "pkg-0.2.0+alpha.8.0+1.19" = _50qeuOZd;
        "pkg-0.2.0+alpha.8.5+22w24a" = _36ArTfEB;
        "pkg-0.2.0+alpha.8.2+1.19" = _yU5A8Qx5;
        "pkg-0.2.0+alpha.8.6+1.19-rc1" = _ANzj8akD;
        "pkg-0.2.0+alpha.8.10+1.19.1-pre4" = _UdhobdzY;
        "pkg-0.2.0+alpha.8.29+1.19.1-pre6" = _5ckrYyQe;
        "pkg-0.2.0+alpha.8.32+1.19.1-rc3" = _B0EsXokA;
        "pkg-0.2.0+alpha.8.33+1.19.1" = _joS4yKA6;
        "pkg-0.2.0+alpha.8.37+1.19.2" = _4JyDag4R;
        "pkg-0.2.0+alpha.7.33+1.18.2" = _m1WNVlLC;
        "pkg-0.2.0+alpha.7.34+1.18.2" = _1uj78Fog;
        "pkg-0.2.0+alpha.9.0+1.19.2" = _YaQCrYHB;
        "pkg-0.2.0+alpha.9.1+22w42a" = _JCraKtdM;
        "pkg-0.2.0+alpha.9.2+22w43a" = _RhyXTcEQ;
        "pkg-0.2.0+alpha.9.3+22w44a" = _AwoxTDW7;
        "pkg-0.2.0+alpha.9.4+22w45a" = _KWFbqqg0;
        "pkg-0.2.0+alpha.9.5+22w46a" = _hTvKpOrJ;
        "pkg-0.2.0+alpha.9.7+1.19.3-pre2" = _iEoaL6W4;
        "pkg-0.2.0+alpha.9.8+1.19.3-rc1" = _h7FDMJhe;
        "pkg-0.2.0+alpha.7.35" = _U5BK0DTf;
        "pkg-0.2.0+alpha.9.11+1.19.3" = _ofTiB5aa;
        "pkg-0.2.0+alpha.9.12+1.19.3" = _kakddk9k;
        "pkg-0.2.0+alpha.10.0+1.19.3" = _FpgVeSQK;
        "pkg-0.2.0+alpha.10.2+23w03a" = _K4IJdtZz;
        "pkg-0.2.0+alpha.7.38+1.18.2" = _b4OLEnN5;
        "pkg-0.2.0+alpha.9.5+1.19.2" = _MIL1AwdW;
        "pkg-0.2.0+alpha.10.3+23w04a" = _8R7qsoAz;
        "pkg-0.2.0+alpha.10.4+23w05a" = _jg6Fxh7l;
        "pkg-0.2.0+alpha.10.5+23w06a" = _ofhUwNKT;
        "pkg-0.2.0+alpha.10.6+23w07a" = _LcwiuiIT;
        "pkg-0.2.0+alpha.10.15+1.19.4-pre1" = _mL9RAOql;
        "pkg-0.2.0+alpha.10.16+1.19.4-pre2" = _am5H0QKm;
        "pkg-0.2.0+alpha.10.17+1.19.4-pre3" = _yjG2UYON;
        "pkg-0.2.0+alpha.9.7+1.19.2" = _tJR5QSfM;
        "pkg-0.2.0+alpha.9.8+1.19.2" = _WHwuwy0n;
        "pkg-0.2.0+alpha.10.18+1.19.4-pre4" = _lbYxbodc;
        "pkg-0.2.0+alpha.10.24+1.19.4-pre4" = _SJWk0Y6f;
        "pkg-0.2.0+alpha.10.26+1.19.4-rc2" = _I1yqocSA;
        "pkg-0.2.0+alpha.10.27+1.19.4" = _OnUjD19i;
        "pkg-0.2.0+alpha.10.28+1.19.4" = _kHF4y8Qv;
        "pkg-0.2.0+alpha.10.29+1.19.4" = _F59yqPKB;
        "pkg-0.2.0+alpha.10.30+1.19.4" = _GtUrsjth;
        "pkg-0.2.0+alpha.10.31+23w12a" = _6xnt6Mf7;
        "pkg-0.2.0+alpha.10.31+1.19.4" = _pH7xYFcg;
        "pkg-0.2.0+alpha.9.9+1.19.2" = _8rUarScX;
        "pkg-0.2.0+alpha.10.41+1.19.4" = _mbcVXjye;
        "pkg-0.2.0+alpha.10.44+23w13a" = _Tfsv99Ne;
        "pkg-0.2.0+alpha.10.45+23w13a" = _E5ZHi8t8;
        "pkg-0.2.0+alpha.10.42+1.19.4" = _43Pjw5Zm;
        "pkg-0.2.0+alpha.10.49+23w13a_or_b" = _FsgfLLf2;
        "pkg-0.2.0+alpha.10.51+23w13a_or_b" = _teZiZ7J8;
        "pkg-0.2.0+alpha.10.46+23w14a" = _gLH9G316;
        "pkg-0.2.0+alpha.10.49+1.19.4" = _b3vDiaQb;
        "pkg-0.2.0+alpha.10.50+1.19.4" = _BPP2C04n;
        "pkg-0.2.0+alpha.10.51+1.19.4" = _2LxKBERD;
        "pkg-0.2.0+alpha.10.60+23w16a" = _wsPHNk8u;
        "pkg-0.2.0+alpha.10.61+23w16a" = _H4cMvxMp;
        "pkg-0.2.0+alpha.10.62+23w17a" = _CRKhNYeR;
        "pkg-0.2.0+alpha.10.63+23w18a" = _x7MYMy4y;
        "pkg-0.2.0+alpha.10.64+1.20-pre1" = _GcCkPPqP;
        "pkg-0.2.0+alpha.10.65+1.20-pre2" = _WNCmPNnH;
        "pkg-0.2.0+alpha.10.67+1.20-pre4" = _kE6dSBb9;
        "pkg-0.2.0+alpha.10.68+1.20-pre4" = _svIfxF6U;
        "pkg-0.2.0+alpha.10.70+1.20-pre5" = _o9JS246e;
        "pkg-0.2.0+alpha.10.71+1.20-pre6" = _TPoREhh8;
        "pkg-0.2.0+alpha.10.53+1.19.4" = _QM0bHIgS;
        "pkg-0.2.0+alpha.10.54+1.19.4" = _Rp75Zg3V;
        "pkg-0.2.0+alpha.10.74+1.20-pre6" = _vOwiIckX;
        "pkg-0.2.0+alpha.10.76+1.20-pre6" = _jb1CmeTY;
        "pkg-0.2.0+alpha.10.55+1.19.4" = _aGexInhW;
        "pkg-0.2.0+alpha.10.77+1.20-pre7" = _43ydird3;
        "pkg-0.2.0+alpha.10.56+1.19.4" = _wNH05ZHf;
        "pkg-0.2.0+alpha.10.58+1.19.4" = _Pxfe5aWT;
        "pkg-0.2.0+alpha.10.83+1.20-rc1" = _Wu5yZcaS;
        "pkg-0.2.0+alpha.10.84+1.20-rc1" = _kGUYgrb2;
        "pkg-0.2.0+alpha.10.60+1.19.4" = _J6kO4r4K;
        "pkg-0.2.0+alpha.10.85+1.20" = _jjrmElas;
        "pkg-0.2.0+alpha.10.87+1.20" = _upCWtixz;
        "pkg-0.2.0+alpha.10.89+1.20.1-rc1" = _djsukR7B;
        "pkg-0.2.0+alpha.10.90+1.20.1" = _5UifZ0Q3;
        "pkg-0.2.0+alpha.10.91+1.20.1" = _t4juSkze;
        "pkg-0.2.0+alpha.10.88+1.20" = _qCeR9Rtv;
        "pkg-0.2.0+alpha.10.61+1.19.4" = _N7ZGQT2F;
        "pkg-0.2.0+alpha.9.10+1.19.2" = _5WCjzxLt;
        "pkg-0.2.0+alpha.10.93+1.20.1" = _2MsVranr;
        "pkg-0.2.0+alpha.10.94+1.20.1" = _fIRoJeNG;
        "pkg-0.2.0+alpha.10.96+1.20.1" = _iaC5daGO;
        "pkg-0.2.0+alpha.10.65+1.19.4" = _HnJvyOtR;
        "pkg-0.2.0+alpha.10.97+23w31a" = _RKHT15hh;
        "pkg-0.2.0+alpha.10.98+23w31a" = _H7mRFiai;
        "pkg-0.2.0+alpha.10.99+23w32a" = _YMkkzFrW;
        "pkg-0.2.0+alpha.10.98+1.20.1" = _zLF8pgaa;
        "pkg-0.2.0+alpha.10.101+23w32a" = _tRPtBOiR;
        "pkg-0.2.0+alpha.10.102+23w33a" = _YihNBs47;
        "pkg-0.2.0+alpha.10.103+23w35a" = _FRk7daOn;
        "pkg-0.2.0+alpha.10.100+1.20.1" = _oXqihlMj;
        "pkg-0.2.0+alpha.10.108+23w35a" = _VuQBVQFt;
        "pkg-0.2.0+alpha.10.89+1.20" = _L5rSwveR;
        "pkg-0.2.0+alpha.10.66+1.19.4" = _uZ1nQtIu;
        "pkg-0.2.0+alpha.9.11+1.19.2" = _TL8Qsm5r;
        "pkg-0.2.0+alpha.7.40+1.18.2" = _uFhRzRj9;
        "pkg-0.2.0+alpha.10.109+1.20.2-pre1" = _4zE58u8n;
        "pkg-0.2.0+alpha.10.110+1.20.2-pre2" = _4HeZGnXw;
        "pkg-0.2.0+alpha.10.111+1.20.2-pre3" = _D2jFsTZq;
        "pkg-0.2.0+alpha.10.102+1.20.1" = _9fFeZTDg;
        "pkg-0.2.0+alpha.10.105+1.20.1" = _Bz7RVshA;
        "pkg-0.2.0+alpha.10.106+1.20.1" = _rIG01joD;
        "pkg-0.2.0+alpha.10.112+1.20.2-pre4" = _KptlCSFN;
        "pkg-0.2.0+alpha.10.119+1.20.2-pre4" = _QfwKEzZ4;
        "pkg-0.2.0+alpha.10.120+1.20.2-rc1" = _YtlVr5cf;
        "pkg-0.2.0+alpha.10.107+1.20.1" = _7y1gLd3J;
        "pkg-0.2.0+alpha.10.122+1.20.2-rc2" = _4JSkFTyf;
        "pkg-0.2.0+alpha.10.108+1.20.1" = _1xGxW45v;
        "pkg-0.2.0+alpha.10.123+1.20.2" = _NKLLto7o;
        "pkg-0.2.0+alpha.10.126+1.20.2" = _ilKwGRiJ;
        "pkg-0.2.0+alpha.11.0+1.20.1" = _T5Pkyhit;
        "pkg-0.2.0+alpha.11.21+23w40a" = _Jqx0agDs;
        "pkg-0.2.0+alpha.11.23+23w41a" = _FrNL4T4x;
        "pkg-0.2.0+alpha.11.25+23w42a" = _eLutcGdb;
        "pkg-0.2.0+alpha.11.27+23w43a" = _ylU9Dbog;
        "pkg-0.2.0+alpha.11.28+23w45a" = _i8QegMT0;
        "pkg-0.2.0+alpha.11.29+1.20.3-pre1" = _6bOtNtMk;
        "pkg-0.2.0+alpha.11.31+1.20.3-pre4" = _BeDVaRrl;
        "pkg-0.2.0+alpha.11.32+1.20.3-rc1" = _mUc2slbG;
        "pkg-0.2.0+alpha.11.35+1.20.3" = _i8CQwoWH;
        "pkg-0.2.0+alpha.11.36+1.20.3" = _OcowQN8k;
        "pkg-0.2.0+alpha.11.38+1.20.4" = _o0DcaA0L;
        "pkg-0.2.0+alpha.11.39+23w51b" = _gl3Ol9Rf;
        "pkg-0.2.0+alpha.11.39+1.20.4" = _Nbvy7lxh;
        "pkg-0.2.0+alpha.11.40+1.20.4" = _OSw3GbgT;
        "pkg-0.2.0+alpha.11.40+24w03b" = _mwWVX1eI;
        "pkg-0.2.0+alpha.11.41+24w05b" = _aCHiq3JR;
        "pkg-0.2.0+alpha.11.41+1.20.4" = _VMkY1xQJ;
        "pkg-0.2.0+alpha.11.42+1.20.4" = _mXxEG1Cc;
        "pkg-0.2.0+alpha.11.46+1.20.4" = _sXSliIXJ;
        "pkg-0.2.0+alpha.11.50+1.20.4" = _7dTaskZd;
        "pkg-0.2.0+alpha.11.22+1.20.2" = _mdwisQbj;
        "pkg-0.2.0+alpha.11.3+1.20.1" = _IOsj4oCn;
        "pkg-0.2.0+alpha.11.52+1.20.4" = _FegpExsA;
        "pkg-0.2.0+alpha.11.23+1.20.2" = _Iigf1ayl;
        "pkg-0.2.0+alpha.11.4+1.20.1" = _OIsJWyHK;
        "pkg-0.2.0+alpha.11.57+24w06a" = _83cMDwyA;
        "pkg-0.2.0+alpha.11.56+1.20.4" = _YcNBclPA;
        "pkg-0.2.0+alpha.11.57+1.20.4" = _k0mGurbc;
        "pkg-0.2.0+alpha.11.24+1.20.2" = _vADXBkQ9;
        "pkg-0.2.0+alpha.11.5+1.20.1" = _QZ5cUNXs;
        "pkg-0.2.0+alpha.11.58+1.20.4" = _Zarj7hYR;
        "pkg-0.2.0+alpha.11.67+24w09a" = _ZwukJJVG;
        "pkg-0.2.0+alpha.11.68+24w09a" = _EnNkM6hM;
        "pkg-0.2.0+alpha.11.69+24w10a" = _K77J7VgJ;
        "pkg-0.2.0+alpha.11.70+24w11a" = _pEdCxWfU;
        "pkg-0.2.0+alpha.11.71+24w12a" = _7QHLk52H;
        "pkg-0.2.0+alpha.11.60+1.20.4" = _1mrrqqh8;
        "pkg-0.2.0+alpha.11.61+1.20.4" = _2wBbjBss;
        "pkg-0.2.0+alpha.11.77+24w13a" = _lbeFtqcD;
        "pkg-0.2.0+alpha.11.62+1.20.4" = _rq177mLj;
        "pkg-0.2.0+alpha.11.65+1.20.4" = _9Cu1rJ2H;
        "pkg-0.2.0+alpha.11.84+24w14a" = _eXuVIBWL;
        "pkg-0.2.0+alpha.11.85+24w14a" = _djtAKIgX;
        "pkg-0.2.0+alpha.11.86+1.20.5-pre1" = _GWtvjtVr;
        "pkg-0.2.0+alpha.11.87+1.20.5-rc2" = _Yqt8ijOx;
        "pkg-0.2.0+alpha.11.66+1.20.4" = _B4y7zUNd;
        "pkg-0.2.0+alpha.11.89+1.20.5" = _d3wUETCr;
        "pkg-0.2.0+alpha.11.90+1.20.6-rc1" = _HuIF0MCO;
        "pkg-0.2.0+alpha.11.67+1.20.4" = _xjgJS9KC;
        "pkg-0.2.0+alpha.11.92+1.20.6-rc1" = _GkUPjy4s;
        "pkg-0.2.0+alpha.11.93+1.20.6" = _OMK7p0OR;
        "pkg-0.2.0+alpha.11.94+1.20.6" = _pcisR2P7;
        "pkg-0.2.0+alpha.11.95+1.20.6" = _1jjyJyVe;
        "pkg-0.2.0+alpha.11.96+24w18a" = _hQJaqYiE;
        "pkg-0.2.0+alpha.11.97+1.21-rc1" = _Zr8unnj7;
        "pkg-0.2.0+alpha.11.98+1.21" = _CblFko5j;
        "pkg-0.2.0+alpha.11.96+1.20.6" = _Gx6fcket;
        "pkg-0.2.0+alpha.11.99+1.21" = _fwkUF7u2;
        "pkg-0.2.0+alpha.11.100+1.21" = _lciEAb0d;
        "pkg-0.2.0+alpha.11.101+1.21" = _BTWFOuYd;
        "pkg-0.2.0+alpha.11.103+1.21" = _ekKhjF7N;
        "pkg-0.2.0+alpha.11.104+1.21" = _Ovsw0sty;
        "pkg-0.2.0+alpha.11.105+1.21" = _ZPvreioj;
        "pkg-0.2.0+alpha.11.106+1.21" = _9W7QWKBL;
        "pkg-0.2.0+alpha.11.107+1.21" = _oIlNIzsC;
        "pkg-0.2.0+alpha.11.6+1.20.1" = _5uLkOcuM;
        "pkg-0.2.0+alpha.11.7+1.20.1" = _eCwvoWPb;
        "pkg-0.2.0+alpha.11.8+1.20.1" = _fiVsQlki;
        "pkg-0.2.0+alpha.11.70+1.20.4" = _qvgHNKl4;
        "pkg-0.2.0+alpha.11.98+1.20.6" = _7qCfBGUd;
        "pkg-0.2.0+alpha.11.10+1.20.1" = _meepZdLs;
        "pkg-0.3.0+alpha.0.135+1.21.1" = _FzZ4Wxhj;
        "pkg-0.3.0+alpha.0.139+1.21.1" = _Z4iKexne;
        "pkg-0.3.0+alpha.0.141+1.21.1" = _IQwVcdst;
        "pkg-0.2.0+alpha.11.13+1.20.1" = _LRL5QAZY;
        "pkg-0.2.0+alpha.11.72+1.20.4" = _1AeveXNt;
        "pkg-0.2.0+alpha.11.100+1.20.6" = _GtzkeTZ3;
        "pkg-0.2.0+alpha.11.109+1.21" = _fEWDAK3p;
        "pkg-0.3.0+alpha.0.142+1.21.1" = _eth8wAqz;
        "pkg-0.3.0+alpha.0.143+1.21.1" = _hvXG32z9;
        "pkg-0.3.0+alpha.0.146+1.21.1" = _8bl5Eo5b;
        "pkg-0.3.0+alpha.0.147+1.21.1" = _q8YTWvDX;
        "pkg-0.3.0+alpha.0.148+1.21.1" = _MkfAuS5b;
        "pkg-0.3.0+alpha.0.149+1.21.1" = _qoxbpWON;
        "pkg-0.3.0+alpha.0.150+24w33a" = _41LN8NFl;
        "pkg-0.3.0+alpha.0.151+24w34a" = _tDyQH8BK;
        "pkg-0.3.0+alpha.0.150+1.21.1" = _5CmOS3yK;
        "pkg-0.3.0+alpha.0.152+1.21.1" = _9sopMCJx;
        "pkg-0.3.0+alpha.0.152+24w35a" = _HeomHNxU;
        "pkg-0.3.0+alpha.0.153+1.21.1" = _aJkNDmjk;
        "pkg-0.3.0+alpha.0.157+24w35a" = _hYJukj2Q;
        "pkg-0.3.0+alpha.0.198+1.21.1" = _tTYZ5QNI;
        "pkg-0.3.0+alpha.0.201+1.21.1" = _aDwZHI95;
        "pkg-0.3.0+alpha.0.204+1.21.1" = _zrRZhnUj;
        "pkg-0.3.0+alpha.0.211+24w36a" = _1okuP8yY;
        "pkg-0.3.0+alpha.0.206+1.21.1" = _dnzpqH8Z;
        "pkg-0.3.0+alpha.0.212+24w37a" = _itGrJ7bm;
        "pkg-0.3.0+alpha.0.217+24w38a" = _dvh5PLVN;
        "pkg-0.3.0+alpha.0.211+1.21.1" = _S6pFYCmb;
        "pkg-0.3.0+alpha.0.212+1.21.1" = _AHlC1pea;
        "pkg-0.3.0+alpha.0.218+24w39a" = _iq9O25D8;
        "pkg-0.3.0+alpha.0.213+1.21.1" = _2Z62jhZR;
        "pkg-0.3.0+alpha.0.219+24w40a" = _Yo2wjdl4;
        "pkg-0.3.0+alpha.0.218+1.21.1" = _NQD5ggCO;
        "pkg-0.3.0+alpha.0.233+24w40a" = _FocyNiDV;
        "pkg-0.3.0+alpha.0.222+1.21.1" = _tI1AdB4l;
        "pkg-0.3.0+alpha.0.239+1.21.2-pre1" = _FnFATcqF;
        "pkg-0.3.0+alpha.0.240+1.21.2-pre3" = _KNIrhCXw;
        "pkg-0.3.0+alpha.0.245+1.21.2-pre3" = _fT18boHU;
        "pkg-0.3.0+alpha.0.246+1.21.2-pre3" = _j0sdKbD8;
        "pkg-0.3.0+alpha.0.224+1.21.1" = _WEbvIcU5;
        "pkg-0.3.0+alpha.0.290+1.21.1" = _PC6SfgkD;
        "pkg-0.3.0+alpha.0.318+1.21.2-pre3" = _MtcofaQa;
        "pkg-0.3.0+alpha.0.320+1.21.2-pre3" = _cPeWSRPy;
        "pkg-0.3.0+alpha.0.321+1.21.2-pre4" = _oKkYcWC3;
        "pkg-0.3.0+alpha.0.323+1.21.2-pre5" = _GHYBX9M7;
        "pkg-0.3.0+alpha.0.324+1.21.2-rc1" = _mK9gFSpk;
        "pkg-0.3.0+alpha.0.325+1.21.2-rc1" = _FfTmXlRU;
        "pkg-0.3.0+alpha.0.291+1.21.1" = _jrLI3FkH;
        "pkg-0.3.0+alpha.0.292+1.21.1" = _WeR1fglQ;
        "pkg-0.3.0+alpha.0.326+1.21.2-rc1" = _EwnSNKUl;
        "pkg-0.3.0+alpha.0.330+1.21.2" = _yshDT6lk;
        "pkg-0.3.0+alpha.0.332+1.21.3" = _ZSU8x5PO;
        "pkg-0.3.0+alpha.0.334+1.21.3" = _1X7c74bG;
        "pkg-0.3.0+alpha.0.335+1.21.3" = _wtSJ6Cgb;
        "pkg-0.3.0+alpha.0.293+1.21.1" = _acrwgNVF;
        "pkg-0.3.0+alpha.0.337+1.21.3" = _CKMJlewc;
        "pkg-0.3.0+alpha.0.340+24w44a" = _8sPSBDew;
        "pkg-0.3.0+alpha.0.294+1.21.1" = _SCuUPNB5;
        "pkg-0.3.0+alpha.0.341+1.21.3" = _i2sfEHTy;
        "pkg-0.3.0+alpha.0.342+1.21.3" = _EZ0MCibt;
        "pkg-0.3.0+alpha.0.295+1.21.1" = _4Dtxhzpd;
        "pkg-0.3.0+alpha.0.343+1.21.3" = _hC3KQYBV;
        "pkg-0.3.0+alpha.0.341+24w45a" = _TZleqMf5;
        "pkg-0.3.0+beta.1.0+1.21.3" = _K6Tmv0B9;
        "pkg-0.3.1+alpha.0.2+1.21.3" = _dcDDnndn;
        "pkg-0.3.1+alpha.0.6+24w45a" = _NTgs6ozs;
        "pkg-0.3.1+alpha.0.4+1.21.3" = _YnlZVxna;
        "pkg-0.3.1+alpha.0.8+1.21.3" = _66Kb0sLq;
        "pkg-0.3.1+alpha.0.9+1.21.3" = _bCrGyf5p;
        "pkg-0.3.1+alpha.0.11+1.21.3" = _FNiy6G7Q;
        "pkg-0.3.1+alpha.0.17+24w46a" = _rFqGqFgQ;
        "pkg-0.3.1+alpha.0.12+1.21.3" = _aA2eMKgN;
        "pkg-0.3.1+alpha.0.13+1.21.3" = _MYE8doX2;
        "pkg-0.3.1+alpha.0.14+1.21.3" = _9JiCiYHz;
        "pkg-0.3.1+alpha.0.15+1.21.3" = _HEPGeapR;
        "pkg-0.3.1+alpha.0.16+1.21.3" = _fp1aSfL6;
        "pkg-0.3.0+alpha.0.297+1.21.1" = _B5PB76Ch;
        "pkg-0.3.1+alpha.0.17+1.21.3" = _IyNEd9z3;
        "pkg-0.3.0+beta.2.0+1.21.3" = _tV8Sxjfg;
        "pkg-0.3.1+alpha.0.26+1.21.4-pre1" = _pb2g6SBx;
        "pkg-0.3.1+alpha.0.19+1.21.3" = _7kFghZIF;
        "pkg-0.3.0+alpha.0.298+1.21.1" = _sQFhYQqZ;
        "pkg-0.3.1+alpha.0.20+1.21.3" = _HtNe3N03;
        "pkg-0.3.0+alpha.0.299+1.21.1" = _obPw5CLg;
        "pkg-0.3.0+rc.1.0+1.21.3" = _9m3MFId6;
        "pkg-0.3.1+alpha.0.27+1.21.4-pre2" = _ehNZGw4l;
        "pkg-0.3.1+alpha.0.28+1.21.4-pre3" = _aqKiZuJw;
        "pkg-0.3.1+alpha.0.32+1.21.4-rc1" = _KmYjxAjm;
        "pkg-0.3.1+alpha.0.21+1.21.3" = _COktcPSD;
        "pkg-0.3.1+alpha.0.22+1.21.3" = _QdT2pWQE;
        "pkg-0.3.1+alpha.0.36+1.21.4-rc2" = _DAtOMBGp;
        "pkg-0.3.0+rc.2.0+1.21.3" = _O76V3RZZ;
        "pkg-0.3.1+alpha.0.23+1.21.3" = _jWZeP1qb;
        "pkg-0.3.0.0.0+1.21.3" = _heTjNANx;
        "pkg-0.3.1+alpha.0.25+1.21.3" = _uCQHRm7H;
        "pkg-0.3.1+alpha.0.41+1.21.4-rc2" = _2Dhk7M8h;
        "pkg-0.3.1+alpha.0.42+1.21.4" = _yabKkjXq;
        "pkg-0.3.1+alpha.0.43+1.21.4" = _s9nryaWL;
        "pkg-0.3.1+alpha.0.44+1.21.4" = _H4XcgfZt;
        "pkg-0.3.1+alpha.0.45+1.21.4" = _qedNnj0i;
        "pkg-0.3.1+alpha.0.28+1.21.3" = _RusGfvi3;
        "pkg-0.3.1+alpha.0.46+1.21.4" = _LDjIXg6E;
        "pkg-0.3.1+alpha.0.49+1.21.4" = _jXqVpJ4d;
        "pkg-0.3.1+alpha.0.32+1.21.3" = _Jqp3ObnZ;
        "pkg-0.3.1+alpha.0.52+1.21.4" = _R28bUFsj;
        "pkg-0.3.1+alpha.0.35+1.21.3" = _7IYFNtNn;
        "pkg-0.3.1+beta.1.0+1.21.4" = _vJXngIy2;
        "pkg-0.3.1+alpha.0.53+1.21.4" = _ib18h3uQ;
        "pkg-0.3.2+alpha.0.3+1.21.4" = _wPzjjYe2;
        "pkg-0.3.1+alpha.0.36+1.21.3" = _8uJAlubJ;
        "pkg-0.3.2+alpha.0.4+1.21.4" = _leUhj9ui;
        "pkg-0.3.1+alpha.0.37+1.21.3" = _b8NuvpXJ;
        "pkg-0.3.0+alpha.0.306+1.21.1" = _6hZhXb32;
        "pkg-0.3.2+alpha.0.7+1.21.4" = _4hwa0G5M;
        "pkg-0.3.2+alpha.0.8+1.21.4" = _oZCajqff;
        "pkg-0.3.0+alpha.0.307+1.21.1" = _4YHCEQQR;
        "pkg-0.3.2+alpha.0.9+1.21.4" = _dttNV6T7;
        "pkg-0.3.1+beta.2.0+1.21.4" = _NX51UxSt;
        "pkg-0.3.2+alpha.0.10+1.21.4" = _LGKCgsjA;
        "pkg-0.3.1+alpha.0.38+1.21.3" = _2usuGC4L;
        "pkg-0.3.0+alpha.0.308+1.21.1" = _gBHj4pcP;
        "pkg-0.3.1+rc.1.0+1.21.4" = _c8KSyi6D;
        "pkg-0.3.2+alpha.0.14+1.21.4" = _aIK5ryZo;
        "pkg-0.3.1+alpha.0.39+1.21.3" = _Gs82Xpis;
        "pkg-0.3.1.0+1.21.4" = _fBvLHC54;
        "pkg-0.3.2+alpha.0.16+1.21.4" = _pIh9Bk7f;
        "pkg-0.3.2+alpha.0.17+1.21.4" = _9SNAs1W7;
        "pkg-0.3.2+alpha.0.18+1.21.4" = _WINvcDlQ;
        "pkg-0.3.0+alpha.0.310+1.21.1" = _H5YtgA2t;
        "pkg-0.3.2+alpha.0.19+1.21.4" = _IFORiXCP;
        "pkg-0.3.1+alpha.0.40+1.21.3" = _8wnLsK1Q;
        "pkg-0.3.1.1+rc.1.0+1.21.4" = _bgaW6KWH;
        "pkg-0.3.2+alpha.0.20+1.21.4" = _reHSALRh;
        "pkg-0.3.2+alpha.0.21+1.21.4" = _wOhBkN4r;
        "pkg-0.3.1.1.0+1.21.4" = _yGX4O0YU;
        "pkg-0.3.2+alpha.0.23+25w02a" = _dArVTojw;
        "pkg-0.3.2+alpha.0.24+25w02a" = _tlDiS1m6;
        "pkg-0.3.2+alpha.0.22+1.21.4" = _wJkrDhX5;
        "pkg-0.3.2+alpha.0.24+1.21.4" = _AbZEVMk1;
        "pkg-0.3.2+alpha.0.26+1.21.4" = _KY5RHJSO;
        "pkg-0.3.0+alpha.0.311+1.21.1" = _6peRUuFI;
        "pkg-0.3.2+alpha.0.33+25w03a" = _RenermeB;
        "pkg-0.3.2+alpha.0.27+1.21.4" = _nsWo0HAz;
        "pkg-0.3.0+alpha.0.312+1.21.1" = _3iVTM3ah;
        "pkg-0.3.1+alpha.0.41+1.21.3" = _BZPWAyqz;
        "pkg-0.3.0+alpha.0.314+1.21.1" = _vV4AvU4E;
        "pkg-0.3.2+alpha.0.30+1.21.4" = _IEyMHdil;
        "pkg-0.3.2+alpha.0.34+25w04a" = _clPrTIyu;
        "pkg-0.3.2+alpha.0.31+1.21.4" = _8gYOuMUg;
        "pkg-0.2.0+alpha.11.15+1.20.1" = _jKWjDDXr;
        "pkg-0.3.2+alpha.0.33+1.21.4" = _Qgg5mpR6;
        "pkg-0.3.2+alpha.0.43+25w05a" = _x0koMrsb;
        "pkg-0.3.2+alpha.0.44+25w06a" = _ylpwNrMs;
        "pkg-0.3.2+alpha.0.34+1.21.4" = _JW44QqYT;
        "pkg-0.3.2+alpha.0.35+1.21.4" = _HQz23Jz2;
        "pkg-0.2.0+alpha.11.16+1.20.1" = _s4WOiNtz;
        "pkg-0.3.2+alpha.0.48+25w07a" = _yzt5bYTt;
        "pkg-0.3.2+alpha.0.36+1.21.4" = _pdoFnqVA;
        "pkg-0.3.2+alpha.0.37+1.21.4" = _MDuPEx6N;
        "pkg-0.3.0+alpha.0.315+1.21.1" = _JolPspyA;
        "pkg-0.3.1+alpha.0.42+1.21.3" = _l8woXfsj;
        "pkg-0.3.2+alpha.0.49+25w08a" = _zIp7HfWl;
        "pkg-0.3.2+alpha.0.39+1.21.4" = _M9IMSAGz;
        "pkg-0.3.0+alpha.0.317+1.21.1" = _HqusQu7H;
        "pkg-0.3.2+alpha.0.54+25w08a" = _Tq4stG9o;
        "pkg-0.3.1+alpha.0.44+1.21.3" = _tbi5EOUm;
        "pkg-0.3.1.2+rc.1.0+1.21.4" = _gz43iXry;
        "pkg-0.3.2+alpha.0.55+25w09a" = _bQ462rir;
        "pkg-0.3.2+alpha.0.56+25w09b" = _yQPK0Bpm;
        "pkg-0.3.2+alpha.0.57+25w10a" = _s8KGXoxb;
        "pkg-0.3.2+alpha.0.40+1.21.4" = _ltMY37rz;
        "pkg-0.3.2+alpha.0.41+1.21.4" = _lVjBKxS3;
        "pkg-0.3.2+alpha.0.61+1.21.5-pre1" = _FmYahuwt;
        "pkg-0.3.2+alpha.0.62+1.21.5-pre2" = _2Qy9RSZL;
        "pkg-0.3.2+alpha.0.63+1.21.5-pre3" = _gqhJWARy;
        "pkg-0.3.2+alpha.0.65+1.21.5-rc2" = _2UEfepRn;
        "pkg-0.3.2+alpha.0.66+1.21.5" = _stzC1jlZ;
        "pkg-0.3.2+alpha.0.67+1.21.5" = _sVe6d5NN;
        "pkg-0.3.2+alpha.0.42+1.21.4" = _qVg36ANI;
        "pkg-0.3.0+alpha.0.318+1.21.1" = _RLheAuPI;
        "pkg-0.3.2+alpha.0.43+1.21.4" = _ENpOdBYR;
        "pkg-0.3.0+alpha.0.319+1.21.1" = _ysBifeyb;
        "pkg-0.3.3+alpha.0.0+1.21.5" = _vesKLMmS;
        "pkg-0.3.1.3.0+1.21.4" = _EzvMx6b2;
        "pkg-0.3.2+beta.1.0+1.21.5" = _Wh5CxZTp;
        "pkg-0.3.3+alpha.0.1+25w14craftmine" = _iLUhaTij;
        "pkg-0.3.3+alpha.0.2+25w14craftmine" = _OFC8pud6;
        "pkg-0.3.3+alpha.0.3+25w15a" = _isrqnh5h;
        "pkg-0.3.3+alpha.0.2+1.21.5" = _hyyfxiME;
        "pkg-0.3.3+alpha.0.4+25w16a" = _3E1OJvaA;
        "pkg-0.3.3+alpha.0.3+1.21.5" = _QdSJrLil;
        "pkg-0.3.3+alpha.0.4+1.21.5" = _fndGJIxC;
        "pkg-0.3.3+alpha.0.5+1.21.5" = _BkdPeQKc;
        "pkg-0.3.3+alpha.0.6+1.21.5" = _hTX8YqWc;
        "pkg-0.3.2+rc.1.0+1.21.5" = _VEjpHAOG;
        "pkg-0.3.3+alpha.0.11+25w17a" = _osL9Qwm2;
        "pkg-0.3.2.0.0+1.21.5" = _eL3rprSq;
        "pkg-0.3.3+alpha.0.7+1.21.5" = _caCvrbWl;
        "pkg-0.3.3+alpha.0.15+25w18a" = _hOePZI6q;
        "pkg-0.3.3+alpha.0.8+1.21.5" = _x4koem5m;
        "pkg-0.3.3+beta.1.0+1.21.5" = _da4uyry4;
        "pkg-0.3.4+alpha.0.1+1.21.5" = _aEnmtg8n;
        "pkg-0.3.0+alpha.0.320+1.21.1" = _oXr69pco;
        "pkg-0.3.4+alpha.0.11+25w19a" = _aOkoEgAz;
        "pkg-0.3.4+alpha.0.12+25w20a" = _FhvG1tBY;
        "pkg-0.3.3+rc.1.0+1.21.5" = _Nl12S4hG;
        "pkg-0.3.4+alpha.0.16+1.21.5" = _w9MJjrit;
        "pkg-0.3.4+alpha.0.17+1.21.5" = _BQkZuXdt;
        "pkg-0.3.4+alpha.0.30+25w21a" = _aRwzS4Dq;
        "pkg-0.3.3.0.0+1.21.5" = _jrmtD6AF;
        "pkg-0.3.4+alpha.0.18+1.21.5" = _BbvocCcD;
        "pkg-0.3.4+alpha.0.33+1.21.6-pre1" = _KkNihGF0;
        "pkg-0.3.4+alpha.0.19+1.21.5" = _vAHpotHa;
        "pkg-0.3.4+alpha.0.20+1.21.5" = _OvXvTD3H;
        "pkg-0.3.4+alpha.0.34+1.21.6-pre2" = _i3BdJOyk;
        "pkg-0.3.4+alpha.0.35+1.21.6-pre3" = _x8RrQ1pv;
        "pkg-0.3.4+alpha.0.36+1.21.6-pre4" = _tvZw4gvo;
        "pkg-0.3.4+alpha.0.37+1.21.6-rc1" = _ZVhSZIpC;
        "pkg-0.3.4+alpha.0.38+1.21.6-rc1" = _X6RZgqAf;
        "pkg-0.3.4+alpha.0.41+1.21.6-rc1" = _rda01fdM;
        "pkg-0.3.4+alpha.0.42+1.21.6" = _y6wodInu;
        "pkg-0.3.4+alpha.0.43+1.21.7-rc1" = _COGGzfq3;
        "pkg-0.3.4+alpha.0.44+1.21.7-rc2" = _VmgN0K00;
        "pkg-0.3.4+alpha.0.45+1.21.7" = _wFLNbk9H;
        "pkg-0.3.4+alpha.0.46+1.21.7" = _XZsP4a9d;
        "pkg-0.3.2+alpha.0.44+1.21.4" = _WfGkrMP6;
        "pkg-0.3.4+beta.1.0+1.21.7" = _Erjpfj2l;
        "pkg-0.3.5+alpha.0.2+1.21.8-rc1" = _zzHGgxm5;
        "pkg-0.3.5+alpha.0.3+1.21.8" = _72AAuacG;
        "pkg-0.3.5+alpha.0.4+1.21.8" = _rcifkFPg;
        "pkg-0.3.5+alpha.0.5+1.21.8" = _K4aAxwAx;
        "pkg-0.3.4+rc.1.0+1.21.8" = _RzzXyBlx;
        "pkg-0.3.5+alpha.0.7+1.21.8" = _EF9HwabQ;
        "pkg-0.3.4.0.0+1.21.8" = _tlZRTK1v;
        "pkg-0.3.5+alpha.0.10+25w31a" = _tyoLVb48;
        "pkg-0.3.5+alpha.0.11+25w32a" = _py7irw7c;
        "pkg-0.3.5+alpha.0.13+25w33a" = _bfnWJ0Cl;
        "pkg-0.3.5+alpha.0.15+25w34b" = _dy7Un54Q;
        "pkg-0.3.5+alpha.0.8+1.21.8" = _7lwPGYpL;
        "pkg-0.3.5+alpha.0.16+25w35a" = _X0PBWO8G;
        "pkg-0.3.5+alpha.0.17+25w36a" = _WAXe93fJ;
        "pkg-0.3.5+alpha.0.18+25w36b" = _q2MuNmCz;
        "pkg-0.3.5+alpha.0.19+25w36b" = _r7oN6LfF;
        "pkg-0.3.5+alpha.0.21+25w37a" = _dL4Ap4CI;
        "pkg-0.3.5+alpha.0.23+1.21.9-pre1" = _ytZCY529;
        "pkg-0.3.5+alpha.0.24+1.21.9-pre1" = _sBzcUqTO;
        "pkg-0.3.5+alpha.0.25+1.21.9-pre1" = _5r2LRusc;
        "pkg-0.3.5+alpha.0.26+1.21.9-pre1" = _txi41Cgq;
        "pkg-0.3.5+alpha.0.27+1.21.9-pre2" = _BspKcZ41;
        "pkg-0.3.0+alpha.0.355+1.21.1" = _gfKw9l3e;
        "pkg-0.3.5+alpha.0.28+1.21.9-pre3" = _KDP4ra7q;
        "pkg-0.3.5+alpha.0.29+1.21.9-pre4" = _PryGZOxI;
        "pkg-0.3.0+alpha.0.356+1.21.1" = _YtFixzNF;
        "pkg-0.3.0+alpha.0.357+1.21.1" = _cAa1ityF;
        "pkg-0.3.5+alpha.0.31+1.21.9-pre4" = _S1A4s0if;
        "pkg-0.3.0+alpha.0.358+1.21.1" = _fuuHNvgF;
        "pkg-0.3.5+alpha.0.33+1.21.9-rc1" = _eP08jwAU;
        "pkg-0.3.5+alpha.0.38+1.21.9-rc1" = _AMX6caki;
        "pkg-0.3.5+alpha.0.41+1.21.9" = _jtwAx6nA;
        "pkg-0.3.5+alpha.0.43+1.21.9" = _9sFqnFXd;
        "pkg-0.3.5+alpha.0.44+1.21.10-rc1" = _CCOcCaia;
        "pkg-0.3.6+alpha.0.0+1.21.10" = _CfCedRZg;
        "pkg-0.3.5+beta.1.0+1.21.10" = _Bl0VOr1e;
        "pkg-0.3.6+alpha.0.1+25w41a" = _D0RfzmtI;
        "pkg-0.3.6+alpha.0.1+1.21.10" = _okQJFlOh;
        "pkg-0.3.6+alpha.0.4+25w42a" = _Rc2wTDVt;
        "pkg-0.3.5+rc.1.0+1.21.10" = _tPpclp9p;
        "pkg-0.3.6+alpha.0.2+1.21.10" = _O1woRQzy;
        "pkg-0.3.6+alpha.0.3+1.21.10" = _7P5zJ5Wy;
        "pkg-0.3.6+alpha.0.8+25w43a" = _pJg7Tr0Y;
        "pkg-0.3.5.0.0+1.21.10" = _eY3dbqLu;
        "pkg-0.3.6+alpha.0.4+1.21.10" = _ORGCZCO4;
        "pkg-0.3.6+alpha.0.5+1.21.10" = _h8mZjCBd;
        "pkg-0.3.6+alpha.0.12+25w44a" = _opiDWBbq;
        "pkg-0.3.6+alpha.0.13+25w44a" = _HAKTDjeC;
        "pkg-0.3.6+alpha.0.7+1.21.10" = _ULM34vQu;
        "pkg-0.3.6+alpha.0.8+1.21.10" = _ddi30P1J;
        "pkg-0.3.5.1+rc.1.0+1.21.10" = _G5CLVk95;
        "pkg-0.3.0+alpha.0.362+1.21.1" = _DSqOVCaF;
        "pkg-0.3.5.1.0+1.21.10" = _uNick7oj;
        "pkg-0.3.6+alpha.0.18+25w45a" = _56RsoFGC;
        "pkg-0.3.6+alpha.0.9+1.21.10" = _2EKX8Hiv;
        "pkg-0.3.6+alpha.0.19+25w46a" = _7rCOTBnp;
        "pkg-0.3.6+alpha.0.20+1.21.11-pre1" = _zJoadToz;
        "pkg-0.3.6+alpha.0.23+1.21.11-pre2" = _5qBTp6pr;
        "pkg-0.3.6+alpha.0.24+1.21.11-pre3" = _EeCMqw7Y;
        "pkg-0.3.6+alpha.0.25+1.21.11-pre3" = _KfwL7egV;
        "pkg-0.3.6+alpha.0.28+1.21.11-pre4" = _Ac5RSGuN;
        "pkg-0.3.6+alpha.0.29+1.21.11-pre5" = _2yeXsZj0;
        "pkg-0.3.6+alpha.0.30+1.21.11-rc1" = _8cs8BUIn;
        "pkg-0.3.6+alpha.0.31+1.21.11-rc2" = _pn00LzzQ;
        "pkg-0.3.6+alpha.0.32+1.21.11-rc3" = _l7imw2KN;
        "pkg-0.3.6+alpha.0.33+1.21.11-rc3" = _6wx14IFM;
        "pkg-0.3.6+alpha.0.34+1.21.11" = _dVBkxWpa;
        "pkg-0.3.6+alpha.0.36+1.21.11" = _ZKiRI66j;
        "pkg-0.3.6+alpha.0.39+1.21.11" = _BMrv2T2F;
        "pkg-0.3.6+beta.1.0+1.21.11" = _DLKF3HZk;
        "pkg-0.3.6+alpha.0.40+1.21.11" = _OeusRRlS;
        "pkg-0.3.7+alpha.0.18+26.1-snapshot-1" = _EijNKvmK;
        "pkg-0.3.7+alpha.0.1+1.21.11" = _2pOH3IxC;
        "pkg-0.3.7+alpha.0.2+1.21.11" = _cjcaa7sT;
        "pkg-0.3.7+alpha.0.3+1.21.11" = _4KgXMupv;
        "pkg-0.3.6+rc.1.0+1.21.11" = _lYSxkbzC;
        "pkg-0.3.6.0.0" = _olrVZpJd;
        "pkg-0.3.7+alpha.0.29+26.1-snapshot-1" = _b87tmLKj;
        "pkg-0.3.7+alpha.0.30+26.1-snapshot-2" = _I0bmNh2P;
        "pkg-0.3.7+alpha.0.31+26.1-snapshot-3" = _p2nzm7AO;
        "pkg-0.3.7+alpha.0.32+26.1-snapshot-4" = _zbsWr48u;
        "pkg-0.3.7+alpha.0.6+1.21.11" = _vhn7vj66;
        "pkg-0.3.7+alpha.0.7+1.21.11" = _QdLiMUjx;
        "pkg-0.3.7+alpha.0.33+26.1-snapshot-5" = _26yqamvf;
        "pkg-0.3.7+alpha.0.38+26.1-snapshot-5" = _gmQ6Zemm;
        "pkg-0.3.7+alpha.0.39+26.1-snapshot-6" = _I0M5lq36;
        "pkg-0.3.7+alpha.0.40+26.1-snapshot-6" = _tE2OUxfF;
        "pkg-0.3.7+alpha.0.41+26.1-snapshot-7" = _kbWgsyFP;
        "pkg-0.3.7+alpha.0.42+26.1-snapshot-7" = _vdA9bzZp;
        "pkg-0.3.7+alpha.0.43+26.1-snapshot-8" = _RYPCDWhx;
        "pkg-0.3.7+alpha.0.45+26.1-snapshot-9" = _QDdSdGEh;
        "pkg-0.3.7+alpha.0.8+1.21.11" = _Zk9QqGoA;
        "pkg-0.3.7+alpha.0.9+1.21.11" = _vsiqVtu6;
        "pkg-0.3.7+alpha.0.48+26.1-snap-11" = _84fCd4Va;
        "pkg-0.3.7+alpha.0.49+26.1-pre-1" = _ehn4EmRU;
        "pkg-0.3.7+alpha.0.50+26.1-pre-1" = _Z1cK3mHE;
        "pkg-0.3.7+alpha.0.51+26.1-pre-2" = _fL3OLrpW;
        "pkg-0.3.7+alpha.0.52+26.1-pre-3" = _CkjTHg2A;
        "pkg-0.3.7+alpha.0.53+26.1-rc-1" = _elkWNa2D;
        "pkg-0.3.7+alpha.0.54+26.1-rc-2" = _ErsUCQ1i;
        "pkg-0.3.7+alpha.0.55+26.1-rc-3" = _kayhF35b;
        "pkg-0.3.7+alpha.0.57+26.1-rc-3" = _XBPuWWfR;
        "pkg-0.3.7+alpha.0.59+26.1" = _LkFdYvRD;
        "pkg-0.3.7+alpha.0.61+26.1" = _tKXPZtpT;
        "pkg-0.3.7+alpha.0.62+26.1.1-rc-1" = _yNmL9G1S;
        "pkg-0.3.7+alpha.0.63+26.1.1" = _wGnmDPvI;
        "pkg-0.3.7+alpha.0.64+26w14a" = _xcdjCXkS;
        "pkg-0.3.7+alpha.0.64+26.2-snap-1" = _cW6XGd9b;
        "pkg-0.3.7+alpha.0.64+26.1.2-rc-1" = _Fykexbsm;
        "pkg-0.3.7+alpha.0.65+26.1.2" = _yrNQQ1AQ;
        "pkg-0.3.7+alpha.0.66+26.2-snap-3" = _ZWmfDZse;
        "pkg-0.3.7+alpha.0.67+26.2-snap-4" = _XEqKf1fv;
        "pkg-0.3.7+alpha.0.67+26.1.2" = _lWpNUM5l;
        "pkg-0.3.7+alpha.0.68+26.2-snap-5" = _h0G6V9wK;
        "pkg-0.3.7+alpha.0.68+26.1.2" = _utLSz8Lf;
        "pkg-0.3.0+alpha.0.363+1.21.1" = _mrXmbOac;
        "pkg-0.3.7+alpha.0.69+26.2-snap-6" = _WjMqLKD0;
        "pkg-0.3.7+alpha.0.70+26.2-snap-7" = _gzYDtPJv;
        "pkg-0.3.7+alpha.0.71+26.2-snap-7" = _xF7G2uky;
        "pkg-0.3.7+alpha.0.72+26.2-snap-8" = _rvlNii3x;
        "pkg-0.3.7+alpha.0.69+26.1.2" = _iFyIEVsG;
        "pkg-0.3.7+alpha.0.79+26.2-snap-8" = _csxzHA8D;
        "pkg-0.3.7+alpha.0.10+1.21.11" = _UeCYljaE;
        "pkg-0.3.6+alpha.0.11+1.21.10" = _b2odfQPM;
        "pkg-0.3.5+alpha.0.44+1.21.9" = _I2zfEP8w;
        "pkg-0.3.5+alpha.0.1+1.21.7" = _EdPpwpUY;
        "pkg-0.3.4+alpha.0.43+1.21.6" = _CXRGCRvw;
        "pkg-0.3.2+alpha.0.45+1.21.4" = _Ixtrpubv;
        "pkg-0.3.4+alpha.0.21+1.21.5" = _Kvzm1QIj;
        "pkg-0.3.5+alpha.0.9+1.21.8" = _EnLnlw6z;
        "pkg-0.2.0+alpha.11.18+1.20.1" = _fyt7FtgA;
        "pkg-0.3.1+alpha.0.45+1.21.3" = _qlfE3r3C;
        "pkg-0.3.0+alpha.0.364+1.21.1" = _1vHN61jT;
        "pkg-0.3.7+alpha.0.80+26.2-pre-1" = _2GYMr0J6;
        "pkg-0.3.7+alpha.0.81+26.2-pre-1" = _FdOAMnij;
        "pkg-0.3.7+alpha.0.83+26.2-pre-2" = _cCIGqL9h;
        "pkg-0.3.7+alpha.0.84+26.2-pre-3" = _AEdee5MO;
        "pkg-0.3.7+alpha.0.85+26.2-pre-4" = _gXt533fh;
        "pkg-0.4.0-alpha.0.2+26.1.2" = _ViTwuKCV;
        "pkg-0.4.0-alpha.0.4+26.1.2" = _MmyZoUyp;
        "pkg-0.4.0-alpha.0.24+26.2-pre-4" = _VQtNMk3N;
        "pkg-0.4.0-alpha.0.26+26.2-pre-5" = _N93megg5;
        "pkg-0.4.0-alpha.0.27+26.2-pre-6" = _wODIupOY;
        "pkg-0.4.0-alpha.0.28+26.2-rc-1" = _BDHcprGj;
        "pkg-0.4.0-alpha.0.29+26.2-rc-2" = _Vw4YJfRO;
        "pkg-0.4.0-alpha.0.33+26.2-rc-2" = _sM6fkHkG;
        "pkg-0.4.0-alpha.0.9+26.1.2" = _OP2HbGbP;
        "pkg-0.4.1-alpha.0.0+26.2-rc-2" = _QidT45ly;
        "pkg-0.4.1-alpha.0.2+26.2" = _bwGPFDzY;
        "pkg-0.4.1-alpha.0.3+26.2" = _FZRDakrm;
        "pkg-0.4.0-alpha.0.12+26.1.2" = _eB81jWsG;
        "pkg-0.4.0-alpha.0.13+26.1.2" = _f4MeSe4D;
        "pkg-0.4.0-alpha.0.16+26.1.2" = _U1sqPi6C;
        "pkg-0.4.1-alpha.0.7+26.2" = _qhiSzpxY;
        "pkg-0.4.1-alpha.0.9+26.2" = _YIDZSmn1;
        "pkg-0.4.0-alpha.0.17+26.1.2" = _v1RNsfu7;
        "pkg-0.4.0-alpha.0.12+1.21.11" = _1jmBwiX3;
        "pkg-0.4.0-alpha.0.9+1.21.1" = _Lwhnr5Ml;
        "pkg-0.4.0-alpha.0.20+26.1.2" = _6d5uLLGd;
        "pkg-0.4.1-alpha.0.12+26.2" = _vtBq5pNz;
        "pkg-0.4.0-alpha.0.14+1.21.11" = _9ljhLQ2q;
        "pkg-0.4.0-alpha.0.13+1.21.1" = _66BU6XQS;
        "pkg-0.4.0-beta.1.0+26.1.2" = _zzYSg63u;
        "pkg-0.4.1-beta.1.0+26.2" = _hfq4dPFH;
        "pkg-0.4.0-alpha.0.14+1.21.1" = _SWdgFXXB;
        "pkg-0.4.2-alpha.0.1+26.2" = _mvEDAhN1;
        "pkg-0.4.2-alpha.0.2+26.3-snap-1" = _ml6CXyDP;
        "pkg-0.4.0-alpha.0.22+26.1.2" = _NEhjPLVa;
        "pkg-0.4.0-alpha.0.15+1.21.11" = _OuAWvJKh;
        "pkg-0.4.0-alpha.0.15+1.21.1" = _JTQ15H0L;
        "pkg-0.4.2-alpha.0.5+26.2" = _XeUg4gqD;
        "pkg-0.4.2-alpha.0.6+26.2" = _Xiybguwo;
        "pkg-0.4.0-alpha.0.26+26.1.2" = _N7aCY6uc;
        "pkg-0.4.0-alpha.0.16+1.21.11" = _ZSGmg1qu;
        "pkg-0.4.0-alpha.0.16+1.21.1" = _W5bA0Azw;
        "pkg-0.4.2-alpha.0.8+26.2" = _XFuLpTDt;
        "pkg-0.4.0-alpha.0.28+26.1.2" = _1qBYfTmr;
        "pkg-0.4.2-alpha.0.9+26.2" = _nvOkOiyi;
        "pkg-0.4.2-alpha.0.14+26.3-snap-2" = _fpwjFY1K;
        "pkg-0.4.0-alpha.0.17+1.21.11" = _RMYh4wOW;
        "pkg-0.4.0-alpha.0.18+1.21.1" = _iFXcxwPb;
        "pkg-0.4.0-alpha.0.18+1.21.11" = _MfQIu1Y0;
        "pkg-0.4.0-alpha.0.31+26.1.2" = _h6qi8QiJ;
        "pkg-0.4.2-alpha.0.12+26.2" = _sBKVreDD;
        "pkg-0.4.0-alpha.0.19+1.21.11" = _OOPL1nCG;
        "pkg-0.4.0-alpha.0.19+1.21.1" = _GC7ouKxZ;
        "pkg-0.4.2-alpha.0.15+26.3-snap-3" = _iHjfZWs8;
        "pkg-0.4.2-alpha.0.13+26.2" = _XQMx5J57;
        "pkg-0.4.2-alpha.0.20+26.3-snap-3" = _6nowaGnT;
        "pkg-0.4.2-alpha.0.14+26.2" = _gO4NvmUk;
        "pkg-0.4.2-alpha.0.15+26.2" = _lw436cAi;
        "pkg-0.4.2-alpha.0.17+26.2" = _rm1Rgryk;
        "pkg-0.4.0-alpha.0.34+26.1.2" = _FuYKtpKR;
        "pkg-0.4.0-alpha.0.20+1.21.11" = _wMTt02ay;
        "pkg-0.4.0-alpha.0.20+1.21.1" = _bjf5f7hN;
        "pkg-0.4.2-alpha.0.18+26.2" = _ZrrJuWws;
        "pkg-0.4.0-alpha.0.35+26.1.2" = _22VT4H6y;
        "pkg-0.4.0-alpha.0.21+1.21.1" = _4kQdubQA;
        "pkg-0.4.0-alpha.0.21+1.21.11" = _XsZUV0IT;
        "pkg-0.4.2-alpha.0.28+26.3-snap-4" = _QacpBzZ2;
        "pkg-0.4.2-alpha.0.20+26.2" = _kOHKkdCS;
        "pkg-0.4.2-alpha.0.23+26.2" = _Pk9KKjAm;
        "pkg-0.4.2-alpha.0.27+26.2" = _3KTCdSd3;
        "pkg-0.4.2-alpha.0.30+26.3-snap-5" = _haoLSTpK;
        "pkg-0.4.0-alpha.0.44+26.1.2" = _P1edoXUI;
        "pkg-0.4.0-alpha.0.23+1.21.11" = _dO0K58An;
        "pkg-0.4.0-alpha.0.23+1.21.1" = _h8ey5B7D;
        "pkg-0.4.2-alpha.0.28+26.2" = _AtMwOFAC;
        "pkg-0.4.2-alpha.0.29+26.2" = _sdcwKuxX;
        "pkg-0.4.2-alpha.0.43+26.3-snap-6" = _sTFEpU5c;
        "pkg-0.4.2-alpha.0.34+26.2" = _W8Gj5vpQ;
        "pkg-0.4.2-alpha.0.35+26.2" = _HBLtzvqv;
        "pkg-0.4.2-alpha.0.44+26.3-snap-7" = _JhbC29xY;
        "pkg-0.4.2-alpha.0.40+26.2" = _NuRHGP5e;
        "pkg-0.4.2-alpha.0.45+26.3-snap-8" = _BydoEfWC;
        "pkg-0.4.2-alpha.0.41+26.2" = _sOfMfJPD;
        "pkg-0.4.0-alpha.0.52+26.1.2" = _2TRA2j3R;
        "pkg-0.4.0-alpha.0.24+1.21.11" = _yvc7Nw6M;
        "pkg-0.4.0-alpha.0.25+1.21.1" = _jD4KJHe0;
        "pkg-0.4.2-alpha.0.43+26.2" = _jSMMstCy;
        "pkg-0.4.0-alpha.0.54+26.1.2" = _riLBXg84;
        "pkg-0.4.0-alpha.0.25+1.21.11" = _7bPy44k8;
        "pkg-0.4.0-alpha.0.26+1.21.11" = _879vA5z6;
        "pkg-0.4.0-alpha.0.27+1.21.1" = _gRm1ZAvc;
        "pkg-0.4.2-alpha.0.63+26.3-snap-9" = _hVR1K2iw;
        "pkg-0.4.2-alpha.0.64+26.3-snap-9" = _UrquBzNr;
        "pkg-0.4.2-alpha.0.65+26.3-snap-10" = _UWShfQPB;
        "pkg-0.4.2-alpha.0.67+26.3-pre-1" = _tbNgOO92;
        "pkg-0.4.2-alpha.0.68+26.3-pre-2" = _4Noy265p;
        "pkg-0.4.2-alpha.0.71+26.3-pre-3" = _SbOM6l3U;
        "pkg-0.4.2-alpha.0.73+26.3-rc-1" = _Z7GkrZIE;
        "pkg-0.4.2-alpha.0.74+26.3-rc-2" = _iTSBdIVj;
        "pkg-0.4.2-alpha.0.76+26.3-rc-2" = _yLWBY3b7;
        "pkg-0.4.2-alpha.0.81+26.3-rc-2" = _V6ajCzRo;
        "pkg-0.4.2-alpha.0.52+26.2" = _LmKTn6Yc;
        "pkg-0.4.2-alpha.0.84+26.3-rc-3" = _2wydyF7u;
        "pkg-0.4.2-alpha.0.85+26.3" = _XgxQ7H1c;
