...
let
    versions = (let
        ...
        _gfLcj2H1 = {
            "id" = "gfLcj2H1";
            "file" = "GEO - v1.110.0 - Fusion.zip";
            "hash" = "sha512-arBbFAinJFHeXo1shQGfH40j4iNJyPfgJlrr/wb+P/bBfOZn0vOit4ZRgHatRUzKZxSjBj/cRbKdeGzGVwM2Mg==";
        };
        _SUqLU9Tt = {
            "id" = "SUqLU9Tt";
            "file" = "GEO - v1.111.0 - Fusion.zip";
            "hash" = "sha512-UgFaOaNo3Egc7sifkcYLDjsIKHZ+sCDl9mg5SJE8Pkhchx1YYj7pVUWgyobabJxYuyO41ois9Y08YMosvctjZQ==";
        };
        _SWgs3190 = {
            "id" = "SWgs3190";
            "file" = "GEO - v1.112.0 - Fusion.zip";
            "hash" = "sha512-ZQXm3EHSdMUiZkwDhJprXSL7WLGYqmT1sbeWzP46X80dauUXXpoXXzX1HH5r1I03cVNaR9BvkevNRvQ7IAU0BA==";
        };
        _K6dkf8Tf = {
            "id" = "K6dkf8Tf";
            "file" = "GEO - v1.113.0 - Fusion.zip";
            "hash" = "sha512-YNJvEXfwGmEwRHC/DvOBJTcIGwTlbVJrwadd9vRlOR6tVOsfluxJirUmpRBWY5zAXS4613WDrK8vr7DfwuZcfw==";
        };
    in {
        "VsSPo2wm" = _VsSPo2wm;
        "oT9P78Pa" = _oT9P78Pa;
        ...
        "minecraft-1.18" = _K6dkf8Tf;
        "minecraft-1.18.1" = _K6dkf8Tf;
        "minecraft-1.18.2" = _K6dkf8Tf;
        "minecraft-1.19" = _K6dkf8Tf;
        "minecraft-1.19.1" = _K6dkf8Tf;
        "minecraft-1.19.2" = _K6dkf8Tf;
        "minecraft-1.19.3" = _K6dkf8Tf;
        "minecraft-1.19.4" = _K6dkf8Tf;
        "minecraft-1.20" = _K6dkf8Tf;
        "minecraft-1.20.1" = _K6dkf8Tf;
        "minecraft-1.20.2" = _K6dkf8Tf;
        "minecraft-1.20.3" = _K6dkf8Tf;
        "minecraft-1.20.4" = _K6dkf8Tf;
        "minecraft-1.20.5" = _K6dkf8Tf;
        "minecraft-1.20.6" = _K6dkf8Tf;
        "minecraft-1.21" = _K6dkf8Tf;
        "minecraft-1.21.1" = _K6dkf8Tf;
        "minecraft-1.21.2" = _K6dkf8Tf;
        "minecraft-1.21.3" = _K6dkf8Tf;
        "minecraft-1.21.4" = _K6dkf8Tf;
        "minecraft-1.21.5" = _K6dkf8Tf;
        "minecraft-1.21.6" = _K6dkf8Tf;
        "minecraft-1.21.7" = _K6dkf8Tf;
        "minecraft-1.21.8" = _K6dkf8Tf;
        "minecraft-1.21.9" = _K6dkf8Tf;
        "minecraft-1.21.10" = _K6dkf8Tf;
        "minecraft-1.21.11" = _K6dkf8Tf;
        "minecraft-23w31a" = _K6dkf8Tf;
        "minecraft-23w32a" = _K6dkf8Tf;
        "minecraft-23w33a" = _K6dkf8Tf;
        "minecraft-23w35a" = _K6dkf8Tf;
        "minecraft-1.20.2-pre1" = _K6dkf8Tf;
        "minecraft-23w42a" = _K6dkf8Tf;
        "minecraft-23w43a" = _K6dkf8Tf;
        "minecraft-23w43b" = _K6dkf8Tf;
        "minecraft-23w44a" = _K6dkf8Tf;
        "minecraft-23w45a" = _K6dkf8Tf;
        "minecraft-23w46a" = _K6dkf8Tf;
        "minecraft-24w03a" = _K6dkf8Tf;
        "minecraft-24w03b" = _K6dkf8Tf;
        "minecraft-24w04a" = _K6dkf8Tf;
        "minecraft-24w05a" = _K6dkf8Tf;
        "minecraft-24w05b" = _K6dkf8Tf;
        "minecraft-24w06a" = _K6dkf8Tf;
        "minecraft-24w07a" = _K6dkf8Tf;
        "minecraft-24w09a" = _K6dkf8Tf;
        "minecraft-24w10a" = _K6dkf8Tf;
        "minecraft-24w11a" = _K6dkf8Tf;
        "minecraft-24w12a" = _K6dkf8Tf;
        "minecraft-24w13a" = _K6dkf8Tf;
        "minecraft-24w14potato" = _K6dkf8Tf;
        "minecraft-24w14a" = _K6dkf8Tf;
        "minecraft-1.20.5-pre1" = _K6dkf8Tf;
        "minecraft-1.20.5-pre2" = _K6dkf8Tf;
        "minecraft-1.20.5-pre3" = _K6dkf8Tf;
        "minecraft-24w18a" = _K6dkf8Tf;
        "minecraft-24w19a" = _K6dkf8Tf;
        "minecraft-24w19b" = _K6dkf8Tf;
        "minecraft-24w20a" = _K6dkf8Tf;
        "minecraft-24w33a" = _K6dkf8Tf;
        "minecraft-24w34a" = _K6dkf8Tf;
        "minecraft-24w35a" = _K6dkf8Tf;
        "minecraft-24w36a" = _K6dkf8Tf;
        "minecraft-24w37a" = _K6dkf8Tf;
        "minecraft-24w38a" = _K6dkf8Tf;
        "minecraft-24w39a" = _K6dkf8Tf;
        "minecraft-24w40a" = _K6dkf8Tf;
        "minecraft-1.21.2-pre1" = _K6dkf8Tf;
        "minecraft-1.21.2-pre2" = _K6dkf8Tf;
        "minecraft-24w44a" = _K6dkf8Tf;
        "minecraft-24w45a" = _K6dkf8Tf;
        "minecraft-24w46a" = _K6dkf8Tf;
        "minecraft-26.1" = _K6dkf8Tf;
        "minecraft-26.1.1" = _K6dkf8Tf;
        "minecraft-26.1.2" = _K6dkf8Tf;
        "minecraft-26.2" = _K6dkf8Tf;
        "pkg-v1.61.0" = _VsSPo2wm;
        "pkg-v1.62.0" = _oT9P78Pa;
        "pkg-v1.63.0" = _k5LweMbC;
        "pkg-v1.63.1" = _RzLseiAZ;
        "pkg-v1.63.2" = _6SchfJVY;
        "pkg-v1.64.0" = _v4OOIvp9;
        "pkg-v1.65.0" = _a9KegmjU;
        "pkg-v1.66.0" = _W58DHP9k;
        "pkg-v1.67.0" = _kuH3Uk1P;
        "pkg-v1.68.0" = _jHpP0445;
        "pkg-v1.69.0" = _ONDIHzkT;
        "pkg-v1.70.0" = _TYEnnrUk;
        "pkg-v1.71.0" = _JuQpg1aR;
        "pkg-v1.72.0" = _UDT2kxRZ;
        "pkg-v1.73.0" = _5Ueef4e2;
        "pkg-v1.74.0" = _y6UPFdmQ;
        "pkg-v1.75.0" = _QngFKS1g;
        "pkg-v1.76.0" = _zaJM38pS;
        "pkg-v1.77.0" = _tr1BTaSE;
        "pkg-v1.78.0" = _ct7sUJhL;
        "pkg-v1.79.0" = _ZgE7XQAo;
        "pkg-v1.80.0" = _qT8BY7uc;
        "pkg-v1.81.0" = _pOdwpXzG;
        "pkg-v1.82.0" = _XNZs8xXE;
        "pkg-v1.83.0" = _rTvpRYhv;
        "pkg-v1.84.0" = _E51zfNWG;
        "pkg-v1.85.0" = _RmdegkTG;
        "pkg-v1.86.0" = _K2PLp3lV;
        "pkg-v1.87.0" = _gZfYUbpt;
        "pkg-v1.87.1" = _YzlcUHLr;
        "pkg-v1.88.0" = _Sx8YlNuq;
        "pkg-v1.89.0" = _40WLit87;
        "pkg-v1.90.0" = _qyeydQan;
        "pkg-v1.91.0" = _U3A9oalI;
        "pkg-v1.92.0" = _IIanzjQb;
        "pkg-v1.93.0" = _ntOtmuXp;
        "pkg-v1.93.1" = _cBeil0DG;
        "pkg-v1.94.0" = _h02kGkQl;
        "pkg-v1.95.0" = _9wWiTwBr;
        "pkg-v1.96.0" = _9SR1B5hr;
        "pkg-v1.97.0" = _Lh3Fbveg;
        "pkg-v1.98.0" = _77qK1in1;
        "pkg-v1.99.0" = _7aSpQARP;
        "pkg-v1.99.1" = _zJFaA9c8;
        "pkg-v1.100.0" = _77r6Y3WK;
        "pkg-v1.101.0" = _eaErTiZE;
        "pkg-v1.102.0" = _Iu3zJuzZ;
        "pkg-v1.103.0" = _KgAUGbD9;
        "pkg-v1.104.0" = _hRFI70Sa;
        "pkg-v1.105.0" = _fnGcLsm8;
        "pkg-v1.106.0" = _94eLZtrh;
        "pkg-v1.107.0" = _R0oHy9Ce;
        "pkg-v1.108.0" = _ys2DiSJp;
        "pkg-v1.109.0" = _SfFlBWlN;
        "pkg-v1.110.0" = _gfLcj2H1;
        "pkg-v1.111.0" = _SUqLU9Tt;
        "pkg-v1.112.0" = _SWgs3190;
        "pkg-v1.113.0" = _K6dkf8Tf;
        "default" = _K6dkf8Tf;
    });
