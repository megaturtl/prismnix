...
let
    ...
    in {
        ...
        "pkg-2.0.0" = _kqNDtuPj;
        "pkg-2.0.1" = _2SYeeShj;
        "pkg-2.0.2+1.17" = _okiEeh6H;
        "pkg-2.0.2+1.18" = _yg4CVoxC;
        "pkg-2.1.0+1.18" = _v2HkMk7f;
        "pkg-2.1.0+1.17" = _QkeaYgHc;
        "pkg-2.1.1+1.18" = _ZzllLdjb;
        "pkg-2.1.1+1.17" = _2B1SODiq;
        "pkg-2.2.0+1.18" = _jHCuPXTd;
        "pkg-2.2.0+1.17" = _CdfPOSoS;
        "pkg-2.2.1+1.17" = _Ot7hY1Yu;
        "pkg-2.2.1" = _alyCr9Nk;
        "pkg-2.3.1+1.18" = _GCijgCUB;
        "pkg-2.3.1" = _meKuAXd9;
        "pkg-2.3.1+1.19.2-1.19.1" = _yV1SwVzK;
        "pkg-3.0.0+26.1.2-build.1" = _5yhC5C58;
        "pkg-3.0.0+1.21.11+1.15.2-build.1" = _JvuBu7PH;
        "pkg-3.0.0+1.21.11+1.14-build.1" = _CjjQUAmT;
        "pkg-3.0.0+1.21.11+1.14-build.2" = _HohOPiWf;
