...
let
    versions = (let
        ...
        _q67AqHid = {
            "id" = "q67AqHid";
            "file" = "teleport_commands-merged-26.1-v1.3.5.jar";
            "hash" = "sha512-M9gAARUpEarSx89fEFJewDmE2ZbsIY7g3f9nNsDlv5MBp1kaOy5YgoPgY97x98hdWpwTFxP6Ofu9oCXXPEuTOQ==";
        };
        _YoOeKNAU = {
            "id" = "YoOeKNAU";
            "file" = "teleport_commands-1.21.1-v1.3.5.jar";
            "hash" = "sha512-e+lcFSDgPvODlfN1L3B2MMWBwl/e3NXDgaZNJigIG7tWPaItQbK49CAOjWSysk7BJJsFKliInBKGSqY0jEFv4A==";
        };
    in {
        "L9TJQTow" = _L9TJQTow;
        "yWFvRsPu" = _yWFvRsPu;
