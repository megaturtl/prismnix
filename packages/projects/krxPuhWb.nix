...
let
    ...
    in {
        ...
        "pkg-1.9.9.2" = _viYOercC;
        "pkg-1.9.9.3" = _MxwwRdej;
        "pkg-1.9.9.4-rc" = _Zcbmp4I5;
        "pkg-2.0.0" = _hwx5apQy;
        "pkg-2.0.1" = _F7JzQzbp;
        "pkg-2.1" = _ISVUzoxI;
        "pkg-2.1.1" = _9BlpoGPC;
        ...
        "pkg-2.6.2" = _pLl39i7W;
        "pkg-2.6.3" = _IdL2TCO4;
        "pkg-1.21.10-6180c81" = _WLVU9h7H;
        "pkg-1.21.10-b9fcc29" = _DSl8rUlt;
        "pkg-1.21.10-8cd859c" = _QlnNedhp;
        "pkg-2.7.0" = _DwZYKEpr;
        "pkg-2.7.1" = _9tKkXMN0;
        "pkg-2.7.2" = _1lU5GmKA;
        "pkg-2.8.0" = _bZDi1VBM;
