...
let
    ...
    in {
        ...
        "pkg-1.1.1+1.20.6" = _TJMISEgB;
        "pkg-1.1.2+1.21" = _YQlGmEM1;
        "pkg-1.1.2+1.21.1" = _Xh1OCy7O;
        "pkg-1.1.2+1.21.3" = _BaZC3qiH;
        "pkg-1.1.2+1.21.4" = _4Y4lvdz0;
        "pkg-1.2.0+1.20.6" = _iqgaazl8;
        "pkg-1.2.0+1.21.1" = _1EYZrBNa;
        "pkg-1.2.0+1.21.4" = _Qp8fsxmH;
        "pkg-1.2.1+1.20.6" = _nZa5z2qS;
        "pkg-1.2.1+1.21.1" = _gWO41orH;
        "pkg-1.2.1+1.21.4" = _aXEY3t8o;
        "pkg-1.2.1+1.21.5" = _jz75E51O;
        "pkg-1.2.1+1.21.6" = _ym8Pl7wd;
        "pkg-1.2.1+1.21.7" = _Sz2g3b1d;
        "pkg-1.2.1+1.21.8" = _Vp8dwdNU;
        "pkg-1.3.0+1.21.1-neoforge" = _vIy8nw3x;
        "pkg-1.3.0+1.21.1-fabric" = _KvFFD08m;
        "pkg-1.3.0+1.21.4-neoforge" = _gAmGKUip;
        "pkg-1.3.0+1.21.4-fabric" = _mxTbYDl3;
        "pkg-1.3.0+1.21.5-neoforge" = _4SCy2Q1F;
        "pkg-1.3.0+1.21.5-fabric" = _RMrQEkfG;
        "pkg-1.3.0+1.21.8-neoforge" = _yuT4a37U;
        "pkg-1.3.0+1.21.8-fabric" = _XwED7Nl1;
        "pkg-1.3.0+1.21.9-neoforge" = _r9YiZIMs;
        "pkg-1.3.0+1.21.9-fabric" = _Gdy7bFtW;
        "pkg-1.3.0+1.21.10-neoforge" = _rjUY33L2;
        "pkg-1.3.0+1.21.10-fabric" = _fky9jNsf;
        "pkg-1.3.1+1.21.1-neoforge" = _iXoyaQrD;
        "pkg-1.3.1+1.21.1-fabric" = _kNq5O9ew;
        "pkg-1.3.1+1.21.4-neoforge" = _5fsOPvHu;
        "pkg-1.3.1+1.21.4-fabric" = _KOnCHmb7;
        "pkg-1.3.1+1.21.5-neoforge" = _4r7GPjQZ;
        "pkg-1.3.1+1.21.5-fabric" = _RfHo894z;
        "pkg-1.3.1+1.21.8-neoforge" = _uoqW6cJm;
        "pkg-1.3.1+1.21.8-fabric" = _jtUKYphV;
        "pkg-1.3.1+1.21.10-neoforge" = _TpQ1H5D2;
        "pkg-1.3.1+1.21.10-fabric" = _kb2mDIxP;
        "pkg-1.3.2+1.21.1-neoforge" = _PPYAC16i;
        "pkg-1.3.2+1.21.1-fabric" = _CDbAQ3RN;
        "pkg-1.3.2+1.21.4-neoforge" = _kVRlDSJG;
        "pkg-1.3.2+1.21.4-fabric" = _93rmWlgO;
        "pkg-1.3.2+1.21.5-neoforge" = _T36UIDFO;
        "pkg-1.3.2+1.21.5-fabric" = _9dO1IuZX;
        "pkg-1.3.2+1.21.8-neoforge" = _qrkM7Mlb;
        "pkg-1.3.2+1.21.8-fabric" = _tBKQI4lV;
        "pkg-1.3.2+1.21.10-neoforge" = _MLzy4Fcx;
        "pkg-1.3.2+1.21.10-fabric" = _2xMdCKiE;
        "pkg-1.3.2+1.21.11-neoforge" = _dXnC8JjC;
        "pkg-1.3.2+1.21.11-fabric" = _OeGfmjqL;
        "pkg-1.3.3+1.21.1-neoforge" = _OzA3gLQM;
        "pkg-1.3.3+1.21.1-fabric" = _VsBCpQ4s;
        "pkg-1.3.3+1.21.4-neoforge" = _bOWziF22;
        "pkg-1.3.3+1.21.4-fabric" = _hXVntQtS;
        "pkg-1.3.3+1.21.5-neoforge" = _WpnEeFiq;
        "pkg-1.3.3+1.21.5-fabric" = _W8IYSxxj;
        "pkg-1.3.3+1.21.8-neoforge" = _v4babNP0;
        "pkg-1.3.3+1.21.8-fabric" = _5EMkh3SW;
        "pkg-1.3.3+1.21.10-neoforge" = _rtmLPvRm;
        "pkg-1.3.3+1.21.10-fabric" = _2yCZ9oVV;
        "pkg-1.3.3+1.21.11-neoforge" = _XPtmuGR7;
        "pkg-1.3.3+1.21.11-fabric" = _wdoMucnx;
        "pkg-1.3.4+1.21.8-neoforge" = _DTLpuNCc;
        "pkg-1.3.4+1.21.8-fabric" = _IeXMyKrM;
        "pkg-1.3.4+1.21.10-neoforge" = _hy6NXJvO;
        "pkg-1.3.4+1.21.10-fabric" = _eB6Jpcne;
        "pkg-1.3.4+1.21.11-neoforge" = _eheyMYzo;
        "pkg-1.3.4+1.21.11-fabric" = _zPtvbHLt;
        "pkg-1.3.4+26.1-neoforge" = _vds8Q3qp;
        "pkg-1.3.4+26.1-fabric" = _icPliasi;
        "pkg-1.3.4+26.1.1-neoforge" = _ZfzoKCNR;
        "pkg-1.3.4+26.1.1-fabric" = _3MRcgiuW;
        "pkg-1.3.4+26.1.2-neoforge" = _A5Jlb51g;
