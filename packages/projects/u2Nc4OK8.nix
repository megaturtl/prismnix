...
let
    versions = (let
        ...
        _cL5m2Lfc = {
            "id" = "cL5m2Lfc";
            "file" = "bnascr-v2.0.0-datapack-1.21.X-26.1.X-26.2.zip";
            "hash" = "sha512-bZrXjNJ4lfhdC5VRGVtgReBoamgpp/J0r+7tYAI+0ypKSxnoE54tVBbdHthIY/T8zN58RxSnualoDTumAiGOPQ==";
        };
        _DUtGAUF7 = {
            "id" = "DUtGAUF7";
            "file" = "bnascr-v2.0.0-datapack-1.20.X.zip";
            "hash" = "sha512-CaRhLTzjh8Uos1FPXDPDN72+JtDnbDi1SNhRoC/mFDGCw8F41WnNXDBLT6r2RN/yrWVoaQDVC3WL40vSDzHQsw==";
        };
        _VdIfyCtT = {
            "id" = "VdIfyCtT";
            "file" = "bnascr-v2.0.0-MOD-1.21.X-26.1.X-26.2.jar";
            "hash" = "sha512-tlyPXQ7ApNXCfXkSJJJLoamvKC90sOzn3ALJdJvoyxbIv7gCdsTTYU256ICnEi0qixdnAxRrcQ9f+O4T8+drPA==";
        };
        _C7Uo5w3s = {
            "id" = "C7Uo5w3s";
            "file" = "bnascr-v2.0.0-MOD-1.20.X.jar";
            "hash" = "sha512-swWEAZI0ZSfN8c4YM0/2HS0V5mTcHw5tXQPL362NaOBPjQndraPd9wyzuG/+iVQED/2XN1DHNj+7R51C71u3Yw==";
        };
    in {
        "YFUC85s6" = _YFUC85s6;
        "N4x5mEOs" = _N4x5mEOs;
        ...
        "VdIfyCtT" = _VdIfyCtT;
        "C7Uo5w3s" = _C7Uo5w3s;
        "datapack-1.21.4" = _cL5m2Lfc;
        "datapack-1.21.1" = _cL5m2Lfc;
        "datapack-1.20.6" = _DUtGAUF7;
        "datapack-1.20.4" = _DUtGAUF7;
        "datapack-1.20.1" = _DUtGAUF7;
        "datapack-1.21.5" = _cL5m2Lfc;
        "datapack-1.21" = _cL5m2Lfc;
        "datapack-1.21.2" = _cL5m2Lfc;
        "datapack-1.21.3" = _cL5m2Lfc;
        "datapack-1.20.5" = _DUtGAUF7;
        "datapack-1.20" = _DUtGAUF7;
        "datapack-1.20.2" = _DUtGAUF7;
        "datapack-1.20.3" = _DUtGAUF7;
        "datapack-25w20a" = _cL5m2Lfc;
        "datapack-1.21.6" = _cL5m2Lfc;
        "datapack-1.21.7" = _cL5m2Lfc;
        "datapack-1.21.8" = _cL5m2Lfc;
        "datapack-1.21.9" = _cL5m2Lfc;
        "datapack-1.21.10" = _cL5m2Lfc;
        "datapack-1.21.11" = _cL5m2Lfc;
        "datapack-24w33a" = _cL5m2Lfc;
        "datapack-24w34a" = _cL5m2Lfc;
        "datapack-24w35a" = _cL5m2Lfc;
        "datapack-24w36a" = _cL5m2Lfc;
        "datapack-24w37a" = _cL5m2Lfc;
        "datapack-24w38a" = _cL5m2Lfc;
        "datapack-24w39a" = _cL5m2Lfc;
        "datapack-24w40a" = _cL5m2Lfc;
        "datapack-1.21.2-pre1" = _cL5m2Lfc;
        "datapack-1.21.2-pre2" = _cL5m2Lfc;
        "datapack-24w44a" = _cL5m2Lfc;
        "datapack-24w45a" = _cL5m2Lfc;
        "datapack-24w46a" = _cL5m2Lfc;
        "datapack-23w31a" = _DUtGAUF7;
        "datapack-23w32a" = _DUtGAUF7;
        "datapack-23w33a" = _DUtGAUF7;
        "datapack-23w35a" = _DUtGAUF7;
        "datapack-1.20.2-pre1" = _DUtGAUF7;
        "datapack-23w40a" = _DUtGAUF7;
        "datapack-23w41a" = _DUtGAUF7;
        "datapack-23w42a" = _DUtGAUF7;
        "datapack-23w43a" = _DUtGAUF7;
        "datapack-23w43b" = _DUtGAUF7;
        "datapack-23w44a" = _DUtGAUF7;
        "datapack-23w45a" = _DUtGAUF7;
        "datapack-23w46a" = _DUtGAUF7;
        "datapack-1.20.3-pre1" = _DUtGAUF7;
        "datapack-1.20.3-pre2" = _DUtGAUF7;
        "datapack-1.20.3-pre3" = _DUtGAUF7;
        "datapack-1.20.3-pre4" = _DUtGAUF7;
        "datapack-23w51a" = _DUtGAUF7;
        "datapack-23w51b" = _DUtGAUF7;
        "datapack-24w03a" = _DUtGAUF7;
        "datapack-24w03b" = _DUtGAUF7;
        "datapack-24w04a" = _DUtGAUF7;
        "datapack-24w05a" = _DUtGAUF7;
        "datapack-24w05b" = _DUtGAUF7;
        "datapack-24w06a" = _DUtGAUF7;
        "datapack-24w07a" = _DUtGAUF7;
        "datapack-24w09a" = _DUtGAUF7;
        "datapack-24w10a" = _DUtGAUF7;
        "datapack-24w11a" = _DUtGAUF7;
        "datapack-24w12a" = _DUtGAUF7;
        "datapack-24w13a" = _DUtGAUF7;
        "datapack-24w14a" = _DUtGAUF7;
        "datapack-1.20.5-pre1" = _DUtGAUF7;
        "datapack-1.20.5-pre2" = _DUtGAUF7;
        "datapack-1.20.5-pre3" = _DUtGAUF7;
        "datapack-1.20.5-pre4" = _DUtGAUF7;
        "datapack-1.20.5-rc1" = _DUtGAUF7;
        "datapack-1.20.5-rc2" = _DUtGAUF7;
        "datapack-1.20.5-rc3" = _DUtGAUF7;
        "datapack-26.1" = _cL5m2Lfc;
        "datapack-26.1.1" = _cL5m2Lfc;
        "datapack-26.1.2" = _cL5m2Lfc;
        "datapack-26.2" = _cL5m2Lfc;
        "datapack-24w18a" = _cL5m2Lfc;
        "datapack-24w19a" = _cL5m2Lfc;
        "datapack-24w19b" = _cL5m2Lfc;
        "datapack-24w20a" = _cL5m2Lfc;
        "datapack-24w21a" = _cL5m2Lfc;
        "datapack-24w21b" = _cL5m2Lfc;
        "datapack-1.21-pre1" = _cL5m2Lfc;
        "datapack-1.21-pre2" = _cL5m2Lfc;
        "datapack-1.21-pre3" = _cL5m2Lfc;
        "datapack-1.21-pre4" = _cL5m2Lfc;
        "datapack-1.21-rc1" = _cL5m2Lfc;
        "datapack-1.21.1-rc1" = _cL5m2Lfc;
        "datapack-1.21.2-pre3" = _cL5m2Lfc;
        "datapack-1.21.2-pre4" = _cL5m2Lfc;
        "datapack-1.21.2-pre5" = _cL5m2Lfc;
        "datapack-1.21.2-rc1" = _cL5m2Lfc;
        "datapack-1.21.2-rc2" = _cL5m2Lfc;
        "datapack-1.21.4-pre1" = _cL5m2Lfc;
        "datapack-1.21.4-pre2" = _cL5m2Lfc;
        "datapack-1.21.4-pre3" = _cL5m2Lfc;
        "datapack-1.21.4-rc1" = _cL5m2Lfc;
        "datapack-1.21.4-rc2" = _cL5m2Lfc;
        "datapack-1.21.4-rc3" = _cL5m2Lfc;
        "datapack-25w02a" = _cL5m2Lfc;
        "datapack-25w03a" = _cL5m2Lfc;
        "datapack-25w04a" = _cL5m2Lfc;
        "datapack-25w05a" = _cL5m2Lfc;
        "datapack-25w06a" = _cL5m2Lfc;
        "datapack-25w07a" = _cL5m2Lfc;
        "datapack-25w08a" = _cL5m2Lfc;
        "datapack-25w09a" = _cL5m2Lfc;
        "datapack-25w09b" = _cL5m2Lfc;
        "datapack-25w10a" = _cL5m2Lfc;
        "datapack-1.21.5-pre1" = _cL5m2Lfc;
        "datapack-1.21.5-pre2" = _cL5m2Lfc;
        "datapack-1.21.5-pre3" = _cL5m2Lfc;
        "datapack-1.21.5-rc1" = _cL5m2Lfc;
        "datapack-1.21.5-rc2" = _cL5m2Lfc;
        "datapack-25w14craftmine" = _cL5m2Lfc;
        "datapack-25w15a" = _cL5m2Lfc;
        "datapack-25w16a" = _cL5m2Lfc;
        "datapack-25w17a" = _cL5m2Lfc;
        "datapack-25w18a" = _cL5m2Lfc;
        "datapack-25w19a" = _cL5m2Lfc;
        "datapack-25w21a" = _cL5m2Lfc;
        "datapack-1.21.6-pre1" = _cL5m2Lfc;
        "datapack-1.21.6-pre2" = _cL5m2Lfc;
        "datapack-1.21.6-pre3" = _cL5m2Lfc;
        "datapack-1.21.6-pre4" = _cL5m2Lfc;
        "datapack-1.21.6-rc1" = _cL5m2Lfc;
        "datapack-1.21.7-rc1" = _cL5m2Lfc;
        "datapack-1.21.7-rc2" = _cL5m2Lfc;
        "datapack-1.21.8-rc1" = _cL5m2Lfc;
        "datapack-25w31a" = _cL5m2Lfc;
        "datapack-25w32a" = _cL5m2Lfc;
        "datapack-25w33a" = _cL5m2Lfc;
        "datapack-25w34a" = _cL5m2Lfc;
        "datapack-25w34b" = _cL5m2Lfc;
        "datapack-25w35a" = _cL5m2Lfc;
        "datapack-25w36a" = _cL5m2Lfc;
        "datapack-25w36b" = _cL5m2Lfc;
        "datapack-25w37a" = _cL5m2Lfc;
        "datapack-1.21.9-pre1" = _cL5m2Lfc;
        "datapack-1.21.9-pre2" = _cL5m2Lfc;
        "datapack-1.21.9-pre3" = _cL5m2Lfc;
        "datapack-1.21.9-pre4" = _cL5m2Lfc;
        "datapack-1.21.9-rc1" = _cL5m2Lfc;
        "datapack-1.21.10-rc1" = _cL5m2Lfc;
        "datapack-25w41a" = _cL5m2Lfc;
        "datapack-25w42a" = _cL5m2Lfc;
        "datapack-25w43a" = _cL5m2Lfc;
        "datapack-25w44a" = _cL5m2Lfc;
        "datapack-25w45a" = _cL5m2Lfc;
        "datapack-25w46a" = _cL5m2Lfc;
        "datapack-1.21.11-pre1" = _cL5m2Lfc;
        "datapack-1.21.11-pre2" = _cL5m2Lfc;
        "datapack-1.21.11-pre3" = _cL5m2Lfc;
        "datapack-1.21.11-pre4" = _cL5m2Lfc;
        "datapack-1.21.11-pre5" = _cL5m2Lfc;
        "datapack-1.21.11-rc1" = _cL5m2Lfc;
        "datapack-1.21.11-rc2" = _cL5m2Lfc;
        "datapack-1.21.11-rc3" = _cL5m2Lfc;
        "datapack-26.1-snapshot-1" = _cL5m2Lfc;
        "datapack-26.1-snapshot-2" = _cL5m2Lfc;
        "datapack-26.1-snapshot-3" = _cL5m2Lfc;
        "datapack-26.1-snapshot-4" = _cL5m2Lfc;
        "datapack-26.1-snapshot-5" = _cL5m2Lfc;
        "datapack-26.1-snapshot-6" = _cL5m2Lfc;
        "datapack-26.1-snapshot-7" = _cL5m2Lfc;
        "datapack-26.1-snapshot-8" = _cL5m2Lfc;
        "datapack-26.1-snapshot-9" = _cL5m2Lfc;
        "datapack-26.1-snapshot-10" = _cL5m2Lfc;
        "datapack-26.1-snapshot-11" = _cL5m2Lfc;
        "datapack-26.1-pre-1" = _cL5m2Lfc;
        "datapack-26.1-pre-2" = _cL5m2Lfc;
        "datapack-26.1-pre-3" = _cL5m2Lfc;
        "datapack-26.1-rc-1" = _cL5m2Lfc;
        "datapack-26.1-rc-2" = _cL5m2Lfc;
        "datapack-26.1-rc-3" = _cL5m2Lfc;
        "datapack-26.1.1-rc-1" = _cL5m2Lfc;
        "datapack-26w14a" = _cL5m2Lfc;
        "datapack-26.2-snapshot-1" = _cL5m2Lfc;
        "datapack-26.1.2-rc-1" = _cL5m2Lfc;
        "datapack-26.2-snapshot-2" = _cL5m2Lfc;
        "datapack-26.2-snapshot-3" = _cL5m2Lfc;
        "datapack-26.2-snapshot-4" = _cL5m2Lfc;
        "datapack-26.2-snapshot-5" = _cL5m2Lfc;
        "datapack-26.2-snapshot-6" = _cL5m2Lfc;
        "datapack-26.2-snapshot-7" = _cL5m2Lfc;
        "datapack-26.2-snapshot-8" = _cL5m2Lfc;
        "datapack-26.2-pre-1" = _cL5m2Lfc;
        "datapack-26.2-pre-2" = _cL5m2Lfc;
        "datapack-26.2-pre-3" = _cL5m2Lfc;
        "datapack-26.2-pre-4" = _cL5m2Lfc;
        "datapack-26.2-pre-5" = _cL5m2Lfc;
        "datapack-26.2-pre-6" = _cL5m2Lfc;
        "datapack-26.2-rc-1" = _cL5m2Lfc;
        "datapack-26.2-rc-2" = _cL5m2Lfc;
        "fabric-1.21.4" = _VdIfyCtT;
        "fabric-1.21.1" = _VdIfyCtT;
        "fabric-1.21.5" = _VdIfyCtT;
        "fabric-1.21" = _VdIfyCtT;
        "fabric-1.21.2" = _VdIfyCtT;
        "fabric-1.21.3" = _VdIfyCtT;
        "fabric-25w20a" = _yC3ZYESy;
        "fabric-1.21.6" = _VdIfyCtT;
        "fabric-1.21.7" = _VdIfyCtT;
        "fabric-1.21.8" = _VdIfyCtT;
        "fabric-1.21.9" = _VdIfyCtT;
        "fabric-1.21.10" = _VdIfyCtT;
        "fabric-1.21.11" = _VdIfyCtT;
        ...
        "fabric-1.20" = _C7Uo5w3s;
        "fabric-1.20.1" = _C7Uo5w3s;
        "fabric-1.20.2" = _C7Uo5w3s;
        "fabric-1.20.3" = _C7Uo5w3s;
        "fabric-1.20.4" = _C7Uo5w3s;
        "fabric-1.20.5" = _C7Uo5w3s;
        "fabric-1.20.6" = _C7Uo5w3s;
        "fabric-26.1" = _VdIfyCtT;
        "fabric-26.1.1" = _VdIfyCtT;
        "fabric-26.1.2" = _VdIfyCtT;
        "fabric-26.2" = _VdIfyCtT;
        "forge-1.21.4" = _VdIfyCtT;
        "forge-1.21.1" = _VdIfyCtT;
        "forge-1.21.5" = _VdIfyCtT;
        "forge-1.21" = _VdIfyCtT;
        "forge-1.21.2" = _VdIfyCtT;
        "forge-1.21.3" = _VdIfyCtT;
        "forge-25w20a" = _yC3ZYESy;
        "forge-1.21.6" = _VdIfyCtT;
        "forge-1.21.7" = _VdIfyCtT;
        "forge-1.21.8" = _VdIfyCtT;
        "forge-1.21.9" = _VdIfyCtT;
        "forge-1.21.10" = _VdIfyCtT;
        "forge-1.21.11" = _VdIfyCtT;
        ...
        "forge-1.20" = _C7Uo5w3s;
        "forge-1.20.1" = _C7Uo5w3s;
        "forge-1.20.2" = _C7Uo5w3s;
        "forge-1.20.3" = _C7Uo5w3s;
        "forge-1.20.4" = _C7Uo5w3s;
        "forge-1.20.5" = _C7Uo5w3s;
        "forge-1.20.6" = _C7Uo5w3s;
        "forge-26.1" = _VdIfyCtT;
        "forge-26.1.1" = _VdIfyCtT;
        "forge-26.1.2" = _VdIfyCtT;
        "forge-26.2" = _VdIfyCtT;
        "neoforge-1.21.4" = _VdIfyCtT;
        "neoforge-1.21.1" = _VdIfyCtT;
        "neoforge-1.21.5" = _VdIfyCtT;
        "neoforge-1.21" = _VdIfyCtT;
        "neoforge-1.21.2" = _VdIfyCtT;
        "neoforge-1.21.3" = _VdIfyCtT;
        "neoforge-25w20a" = _yC3ZYESy;
        "neoforge-1.21.6" = _VdIfyCtT;
        "neoforge-1.21.7" = _VdIfyCtT;
        "neoforge-1.21.8" = _VdIfyCtT;
        "neoforge-1.21.9" = _VdIfyCtT;
        "neoforge-1.21.10" = _VdIfyCtT;
        "neoforge-1.21.11" = _VdIfyCtT;
        ...
        "neoforge-1.20" = _C7Uo5w3s;
        "neoforge-1.20.1" = _C7Uo5w3s;
        "neoforge-1.20.2" = _C7Uo5w3s;
        "neoforge-1.20.3" = _C7Uo5w3s;
        "neoforge-1.20.4" = _C7Uo5w3s;
        "neoforge-1.20.5" = _C7Uo5w3s;
        "neoforge-1.20.6" = _C7Uo5w3s;
        "neoforge-26.1" = _VdIfyCtT;
        "neoforge-26.1.1" = _VdIfyCtT;
        "neoforge-26.1.2" = _VdIfyCtT;
        "neoforge-26.2" = _VdIfyCtT;
        "quilt-1.21.4" = _VdIfyCtT;
        "quilt-1.21.1" = _VdIfyCtT;
        "quilt-1.21.5" = _VdIfyCtT;
        "quilt-1.21" = _VdIfyCtT;
        "quilt-1.21.2" = _VdIfyCtT;
        "quilt-1.21.3" = _VdIfyCtT;
        "quilt-25w20a" = _yC3ZYESy;
        "quilt-1.21.6" = _VdIfyCtT;
        "quilt-1.21.7" = _VdIfyCtT;
        "quilt-1.21.8" = _VdIfyCtT;
        "quilt-1.21.9" = _VdIfyCtT;
        "quilt-1.21.10" = _VdIfyCtT;
        "quilt-1.21.11" = _VdIfyCtT;
        ...
        "quilt-1.20" = _C7Uo5w3s;
        "quilt-1.20.1" = _C7Uo5w3s;
        "quilt-1.20.2" = _C7Uo5w3s;
        "quilt-1.20.3" = _C7Uo5w3s;
        "quilt-1.20.4" = _C7Uo5w3s;
        "quilt-1.20.5" = _C7Uo5w3s;
        "quilt-1.20.6" = _C7Uo5w3s;
        "quilt-26.1" = _VdIfyCtT;
        "quilt-26.1.1" = _VdIfyCtT;
        "quilt-26.1.2" = _VdIfyCtT;
        "quilt-26.2" = _VdIfyCtT;
        "pkg-1.0.0" = _YFUC85s6;
        "pkg-1.0.0+mod" = _N4x5mEOs;
        "pkg-1.0.1" = _wjUJ5q0t;
        "pkg-1.0.1+mod" = _5BSRyZR2;
        "pkg-v1.0.2" = _jgRWnzE5;
        "pkg-v1.0.2+mod" = _jbWEofOG;
        "pkg-1.0.3" = _UlV4lLw4;
        "pkg-1.0.3+mod" = _qsU795SF;
        "pkg-1.4" = _yB1wULBv;
        "pkg-1.4+mod" = _wv1Y947Z;
        "pkg-1.5" = _RBVcdVxO;
        "pkg-1.5+mod" = _l4fCw2BU;
        "pkg-1.6" = _gWb5ROEY;
        "pkg-1.6+mod" = _2zvFJ4G3;
        "pkg-1.6.1-25w20a" = _EYNdSQgr;
        "pkg-1.6.1-25w20a+mod" = _yC3ZYESy;
        "pkg-1.7" = _9oHB8l9x;
        "pkg-1.7+mod" = _2BUelJ8y;
        "pkg-1.7.1" = _5JM0mRLM;
        "pkg-1.7.1+mod" = _eyIlOSzV;
        "pkg-1.8" = _lLL2gNSI;
        "pkg-1.8+mod" = _Z4OhtSPe;
        "pkg-v1.9.1" = _17epZCxh;
        "pkg-v1.9.1+mod" = _URFlSMbl;
        "pkg-1.10" = _jEG8huI6;
        "pkg-1.10+mod" = _4fLEaq4z;
        "pkg-1.11-release" = _UZ8noQO5;
        "pkg-1.11" = _FfIW0DUZ;
        "pkg-1.12" = _WJWybH9Q;
        "pkg-1.13" = _p9iVGMtw;
        "pkg-1.14" = _t6sttjHe;
        "pkg-1.14+mod" = _zUZFxxGR;
        "pkg-1.15" = _Vo7E4Cq6;
        "pkg-1.15-FabricQuilt" = _Ldju8Q5Y;
        "pkg-1.15-(Neo)Forge" = _G9b2Yz7U;
        "pkg-1.16" = _LOO8GrmN;
        "pkg-v1.16-(Neo)Forge-1.21.x" = _3UKJLsVE;
        "pkg-v1.16-FabricQuilt-1.21.x" = _zkbOgprs;
        "pkg-v1.16-(Neo)Forge-1.20.x" = _8jDOsRl6;
        "pkg-v1.16-FabricQuilt-1.20.x" = _QCG6CESV;
        "pkg-1.17" = _sFusHYiW;
        "pkg-v1.17-FabricQuilt-26.1" = _k36VZHLu;
        "pkg-v1.17-NeoForge-26.1" = _Safs2EDD;
        "pkg-v1.17-FabricQuilt-1.21.x" = _GRfYfuS3;
        "pkg-v1.17-NeoForge-1.21.x" = _3nmeMbBg;
        "pkg-v1.17-FabricQuilt-1.20.x" = _69RdrJq0;
        "pkg-v1.17-NeoForge-1.20.x" = _5bWfZqzi;
        "pkg-1.18" = _S2IZbWql;
        "pkg-18" = _tIc4HC9H;
        "pkg-1.19" = _JAodbBLk;
        "pkg-2.0.0" = _C7Uo5w3s;
