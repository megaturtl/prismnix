...
let
    versions = (let
        ...
        _n22XVIPz = {
            "id" = "n22XVIPz";
            "file" = "energeticsheep-26.1.2-forge-1.2.0-257.jar";
            "hash" = "sha512-bYHizwobyKJfAc73JTFUwSnZ/xd5ozjvSHB2UgSE/lbWlx8lKwlSct6IX5BhxVHXx7pxYjQbBtT7wHrX5QNuTQ==";
        };
        _351a0gcy = {
            "id" = "351a0gcy";
            "file" = "energeticsheep-26.1.2-neoforge-1.2.0-257.jar";
            "hash" = "sha512-YLMvzpgby/GAwmi4Za1Jjeh5/zf5M/ZMDlv5PmlWDRTuIWwOB2bHdEfRpntum0rXqkJSb9L2vO64hFJnvyutDw==";
        };
        _XHjI0Vr8 = {
            "id" = "XHjI0Vr8";
            "file" = "energeticsheep-26.1.2-fabric-1.2.0-257.jar";
            "hash" = "sha512-CIcPFhzB5EdU2pmB+ei5ZsINbUhM2iKEiCRUR+GqCLselFYnMZcmbLl3X+fecuafPtWsRig83lk60a3yvu0rkA==";
        };
        _coMrc89V = {
            "id" = "coMrc89V";
            "file" = "energeticsheep-26.2-forge-1.2.0-258.jar";
            "hash" = "sha512-ZKA0AV/c55c1dyjRQAO01bCi7Eahbh2Yxs/ceCX00qAJc8peHoKpVu2wmlquCqU08L1KQxfB/Wp1Vg38lyDPgA==";
        };
        _b7G5JNUa = {
            "id" = "b7G5JNUa";
            "file" = "energeticsheep-26.2-fabric-1.2.0-258.jar";
            "hash" = "sha512-HtESEsUpWm7kGgCIStUels/31/m3+NGMgxfyTbzNN7dwgBbgri1nRZHCDTIP+6x/kHPGq1q/VsNupuyu0JKjyQ==";
        };
        _tWrChk7i = {
            "id" = "tWrChk7i";
            "file" = "energeticsheep-26.2-neoforge-1.2.0-258.jar";
            "hash" = "sha512-sNth198PdkDZtwtGZ57hH8iOzGlu2eDxLeODkFAXNYxpZyIhIStHjhkUY2Joc1lM51RALsWpWK9tKZLfv9tMsQ==";
        };
        _k8WJGeCC = {
            "id" = "k8WJGeCC";
            "file" = "energeticsheep-1.21.1-forge-1.1.18-259.jar";
            "hash" = "sha512-mq+R7SLfBMPL0Pca3G/O3jVdioB+nj7pcnS2P0VlJ04/GHy9BuT9XS+bAiEH2Ktv7+U/MvRN6leBuXRB3Fk2Bw==";
        };
        _r7qtKbqk = {
            "id" = "r7qtKbqk";
            "file" = "energeticsheep-1.21.1-neoforge-1.1.18-259.jar";
            "hash" = "sha512-pbznJrFiNvfRva5XRsWXSESd9aqsMbkJqR2wZDQzEaY/Ng/7Lf0xtLT4f/mYjiS8er2mJM2q2HBaV8lwO8d5pw==";
        };
        _5n7wVVRp = {
            "id" = "5n7wVVRp";
            "file" = "energeticsheep-1.21.1-fabric-1.1.18-259.jar";
            "hash" = "sha512-ngFDLuI4PGtMhoWzwRi0epRvROTgzLV9cas9OMLp4b9wtbQPT2C202+0S4p9f6pp7B6cDiU35IzmEUwoZMp+KA==";
        };
        _SWOjfMVF = {
            "id" = "SWOjfMVF";
            "file" = "energeticsheep-26.1.2-fabric-1.2.0-260.jar";
            "hash" = "sha512-oQPMubWGdf4/C7Srgb/QJm+TKLS7cIB/mHa/WzcVLh6TS8OI9RYKeaR+WHCbwi34AzFb8tbJPIq9kTDzwRbayA==";
        };
        _OnS1zTk4 = {
            "id" = "OnS1zTk4";
            "file" = "energeticsheep-26.1.2-forge-1.2.0-260.jar";
            "hash" = "sha512-bojcsrqYaKrUGaSh+LLrH2TwRMCmgUzp5nFNdHD7LlM2dkbYu80uyfdiqPNHNunu8acTNL5yc/4bDU1F+9sgiw==";
        };
        _h8en4nY2 = {
            "id" = "h8en4nY2";
            "file" = "energeticsheep-26.1.2-neoforge-1.2.0-260.jar";
            "hash" = "sha512-fgev0XnawE1JXgLOJTz+MwW2s0irynDpehMcNxks4snP/ikPe3z/K23aHvpY6d5SpNnTWQeYA2Dffez5AtmDPg==";
        };
        _ncd2mHmd = {
            "id" = "ncd2mHmd";
            "file" = "energeticsheep-26.2-forge-1.2.0-261.jar";
            "hash" = "sha512-T3+t/imiTzrYz7YES74MZHL16dkA39vHVeaMaVjJKcjs4JwUehiWMSCfp8WSLPJ+Zmj1Nf3THEAIoMgba6PRtA==";
        };
        _WmFP0qTB = {
            "id" = "WmFP0qTB";
            "file" = "energeticsheep-26.2-fabric-1.2.0-261.jar";
            "hash" = "sha512-u9ob3oEmH+0VvlcQKRUwMSt1y1khnkdBks0QZZdZSsS9nw0Oe8IDxb+MX/FI4lBhNd9OY41PllM8Xa37psd/Tg==";
        };
        _N0fu2Ydm = {
            "id" = "N0fu2Ydm";
    ...
    in {
        ...
        "pkg-1.19.2-1.1.9" = _FtO6Whfo;
        "pkg-1.19.2-1.1.10" = _z7cJLxsE;
        "pkg-1.19.3-1.1.10" = _u8t1JC1r;
        "pkg-1.19.4-1.1.10" = _aP2NO4Ds;
        "pkg-1.20.1-1.1.10" = _xqb0EtaI;
        "pkg-1.19.2-1.1.11" = _kF6a8px6;
        "pkg-1.20.1-1.1.11" = _BXyyEKjt;
        "pkg-1.20.1-1.1.12" = _92BLkS1a;
        "pkg-1.20.1-1.1.13" = _ACufU5hu;
        "pkg-1.19.2-1.1.12" = _VAN5H3Yu;
        "pkg-1.18.2-1.1.9" = _VWmlOiw9;
        "pkg-1.19.2-1.1.13" = _VswewNaC;
        "pkg-1.20.1-1.1.14" = _pst2a8hj;
        "pkg-1.19.2-1.1.14" = _fgVphD0J;
        "pkg-1.20.4-1.1.14" = _jxpOxnol;
        "pkg-1.21-1.1.14" = _pVP2CnSY;
        "pkg-1.21-1.1.15" = _kaxcbZlz;
        "pkg-1.21.1-1.1.16" = _cVGfqdwy;
        "pkg-1.21.1-1.1.16-119" = _OiozlKku;
        "pkg-1.21.1-1.1.17-121" = _OKLg5Fup;
        "pkg-1.21.1-1.1.17" = _evMTpbBd;
        "pkg-1.21.1-1.1.17-122" = _YresmmHW;
        "pkg-1.21.1-1.1.17-123" = _s0SYGbGw;
        "pkg-1.21.1-1.1.17-124" = _cVNbD7GJ;
        "pkg-1.21.1-1.1.17-126" = _LTVAhjK0;
        "pkg-1.21.1-1.1.18-128" = _I2ocCZpr;
        "pkg-1.21.1-1.1.18" = _qD9Anezs;
        "pkg-1.21.1-1.1.18-129" = _urdsbUrE;
        "pkg-1.21.1-1.1.18-130" = _1FMieOKf;
        "pkg-1.21.1-1.1.18-131" = _AIWAJ9v1;
        "pkg-1.21.1-1.1.18-133" = _vUzRB7Cx;
        "pkg-1.21.1-1.1.18-135" = _naLDnrC1;
        "pkg-1.21.1-1.1.18-137" = _akA57VKw;
        "pkg-1.21.1-1.1.18-140" = _ov86aylE;
        "pkg-1.21.1-1.1.18-142" = _GKKE9Qqa;
        "pkg-1.21.1-1.1.18-144" = _WYcqsnCF;
        "pkg-1.21.4-1.1.18-145" = _nHqZk4Qd;
        "pkg-1.21.1-1.1.18-147" = _lm3Fge92;
        "pkg-1.21.1-1.1.18-148" = _5LikWT0v;
        "pkg-1.21.4-1.1.18-150" = _qKgX0eVA;
        "pkg-1.21.1-1.1.18-152" = _XktKPRfB;
        "pkg-1.21.4-1.1.18-154" = _VszGfckE;
        "pkg-1.21.1-1.1.18-157" = _3MMKF2MH;
        "pkg-1.21.4-1.1.18-158" = _7Nnl7Sgg;
        "pkg-1.21.4-1.1.18-159" = _i8XCux8o;
        "pkg-1.21.7-1.1.18-161" = _vMkATMzQ;
        "pkg-1.21.1-1.1.18-163" = _1ZUjXo9l;
        "pkg-1.21.1-1.1.18-165" = _pCOcQJP6;
        "pkg-1.21.1-1.1.18-166" = _JWYHXEFB;
        "pkg-1.21.8-1.1.18-167" = _Iz9vRRCt;
        "pkg-1.21.1-1.1.18-168" = _UmBculh4;
        "pkg-1.21.8-1.1.18-169" = _Nt12H0Yq;
        "pkg-1.21.1-1.1.18-170" = _DNipi6Ua;
        "pkg-1.21.1-1.1.18-171" = _Z8zGY7ko;
        "pkg-1.21.1-1.1.18-173" = _MfFUuzNf;
        "pkg-1.21.8-1.1.18-174" = _KKzr9EMi;
        "pkg-1.21.8-1.1.18-175" = _PM1BzKwK;
        "pkg-1.21.10-1.1.18-176" = _jm7uI1HU;
        "pkg-1.21.10-1.1.18-179" = _QICFI29H;
        "pkg-1.21.1-1.1.18-178" = _NNScj6Eh;
        "pkg-1.21.10-1.1.18-180" = _y7d6xEl1;
        "pkg-1.21.11-1.1.18-181" = _Xml8PzC4;
        "pkg-1.21.11-1.1.18-182" = _IcU7Swsb;
        "pkg-1.21.1-1.1.18-183" = _vewBroSc;
        "pkg-1.21.1-1.1.18-184" = _yxf8aTAN;
        "pkg-1.21.1-1.1.18-187" = _vxZaO02H;
        "pkg-1.21.11-1.1.18-188" = _iUMLjFL0;
        "pkg-1.21.1-1.1.18-189" = _9D3vGFl5;
        "pkg-1.21.1-1.1.18-191" = _wgXlhfbk;
        "pkg-1.21.11-1.1.18-192" = _QqSnfHtp;
        "pkg-1.21.11-1.1.18-193" = _Xa7qxnWo;
        "pkg-1.21.1-1.1.18-194" = _KumGa1Ew;
        "pkg-1.21.11-1.1.18-195" = _g0Urf1RN;
        "pkg-1.21.11-1.1.18-196" = _fqWCGqwB;
        "pkg-26.1.1-1.1.18-198" = _eJ3iWuLo;
        "pkg-26.1.1-1.1.18-199" = _BaTa4amq;
        "pkg-26.1.1-1.1.18-200" = _YwfSxBk8;
        "pkg-26.1.1-1.1.18" = _Ghu8lzlN;
        "pkg-26.1.1-1.1.18-222" = _1ZnEh2gW;
        "pkg-26.1.2-1.1.18" = _RKK311KR;
        "pkg-26.1.2-1.1.19" = _c86IiuRZ;
        "pkg-26.1.2-1.1.20" = _DDY0SzyO;
        "pkg-26.1.2-1.1.20-243" = _Qqpd4mXG;
        "pkg-26.1.2-1.2.0" = _rmkr5Jz6;
        "pkg-26.1.2-1.2.0-247" = _O74KTZib;
        "pkg-26.1.2-1.2.0-248" = _K5hQ1QKn;
        "pkg-26.2-1.2.0-250" = _a5aBVtWS;
        "pkg-26.2-1.2.0-251" = _A8MtHtMx;
        "pkg-1.21.1-1.1.18-253" = _dsXoDBY8;
        "pkg-26.2-1.2.0-255" = _fxM60VJx;
        "pkg-26.1.2-1.2.0-254" = _nANwRvn7;
        "pkg-26.2-1.2.0-256" = _TLVpBiUe;
        "pkg-26.1.2-1.2.0-257" = _XHjI0Vr8;
        "pkg-26.2-1.2.0-258" = _tWrChk7i;
