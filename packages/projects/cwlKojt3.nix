...
let
    ...
    in {
        ...
        "pkg-1.20.1-0.1.8" = _99ZQh9PV;
        "pkg-1.21.1-24.10.0801" = _XRkqmS7y;
        "pkg-1.21.1-24.10.1001-neo" = _Wsrq4DIU;
        "pkg-1.21.1-24.10.1700" = _RE89Icxf;
        "pkg-1.21.1-24.10.1801-neo" = _Mv9FAByy;
        "pkg-1.21.1-24.11.1200-neo" = _REoAFxZO;
        "pkg-1.21.1-24.11.2100-neo" = _PqoaJWVk;
        "pkg-1.21.1-24.12.2101-Neo" = _Zf8fLsiI;
        "pkg-1.21.4-24.12.2605-Neo" = _h4mNlpd8;
        "pkg-1.21.1-25.01.0300-Neo" = _7E00a3Ca;
        "pkg-1.21.1-25.01.0800-Neo" = _8uBSd2VF;
        "pkg-1.21.1-25.01.1900-Neo" = _bYSIJ2d8;
        "pkg-1.21.1-25.02.0301-Neo" = _ms3pgZ20;
        "pkg-1.21.1-25.02.1304-Neo" = _s3lu129e;
        "pkg-1.21.1-25.05.1300-Neo" = _wwdUfZ1r;
        "pkg-25.05.1700" = _TwS71Iby;
        "pkg-1.21.5-25.05.2402-Neo" = _zf9EhEO6;
        "pkg-1.21.5-25.05.2605-Neo" = _nYQC8mHI;
        "pkg-1.21.1-25.06.2000-Neo" = _YW43H1qq;
        "pkg-1.21.1-25.06.2900-Neo" = _9Sy5CP1J;
        "pkg-1.21.1-25.07.0501-Neo" = _ZnZ4k1Gq;
        "pkg-1.20.1-25.07.0802" = _RxSXEI2c;
        "pkg-1.21.7-25.07.1100-Neo" = _v3CejesV;
        "pkg-1.21.8-2.0.0-25071900-Neo" = _sebJV712;
        "pkg-1.21.8-2.0.0-25072101" = _5x3YUIeC;
        "pkg-1.21.1-2.0.1-25080600-Neo" = _nfLCP1lq;
        "pkg-1.21.1-2.0.1-25080801-Neo" = _BJOjtBNA;
        "pkg-1.20.1-2.0.0-25082101" = _dI7nSJ3s;
        "pkg-1.21.9-2.0.0-25100700-Neo" = _LwkIsNp6;
        "pkg-1.21.10-2.0.0-25101400-Neo" = _lQUJci03;
        "pkg-1.21.10-2.0.0-25101600-Neo" = _5s4duLYr;
        "pkg-1.21.1-2.0.1-25103000-Neo" = _4YjGpAvf;
        "pkg-1.21.10-2.0.0-25101600" = _u3vECa4c;
        "pkg-1.21.1-2.0.2-25110500-Neo" = _f0LcywCC;
        "pkg-1.21.10-2.0.0-25111900-Neo" = _t3veb31J;
        "pkg-1.21.11-2.0.2-25121700-Neo" = _ZGmNSt0d;
        "pkg-1.21.11-2.0.2-25122400" = _VF1tbSKV;
        "pkg-1.21.11-2.0.2-26020300-Neo" = _WTG3CRUX;
        "pkg-26.1.1-2.0.2-26031801-Neo" = _zbK7VadO;
        "pkg-26.1.1-2.0.2-26041003-Neo" = _ZjTAYePn;
        "pkg-26.1.1-2.0.2-26041101-Neo" = _rleKCq6G;
        "pkg-26.1.2-2.0.2-26041101-Neo" = _csKGAJRX;
        "pkg-26.1.1-2.0.2-26041301" = _OEwAS3aN;
        "pkg-26.1.1-2.0.3-26041503-Neo" = _daxGB9NS;
        "pkg-26.1.1-2.0.3-26041504-Neo" = _qemUr3Oj;
        "pkg-26.1.1-2.0.4-26060500" = _FiheC7zz;
        "pkg-26.1.1-2.0.4-26060500-Neo" = _4g3hdxqG;
        "pkg-26.1.1-2.0.4-26061200-Neo" = _8y4cdmlR;
        "pkg-26.2-2.0.4-26071701" = _hxaLntJ2;
        "pkg-1.20.1-2.0.0-26072400" = _IhTcrUjk;
        "pkg-1.21.1-2.0.2-26072400-Neo" = _HZCDyYv2;
