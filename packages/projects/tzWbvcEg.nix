...
let
    ...
    in {
        ...
        "pkg-1.8" = _a3sJrvmV;
        "pkg-1.8+mod" = _zCniGFKc;
        "pkg-1.8.1" = _vc9sqFhF;
        "pkg-1.8.1+mod" = _mxrHzqn4;
        "pkg-1.9" = _1wdJIpxp;
        "pkg-1.9+mod" = _pI6V53Jx;
        "pkg-1.10" = _sksyYxmM;
        "pkg-1.10+mod" = _ERg7JyHO;
        "pkg-2.0" = _Sib5AKmM;
        "pkg-2.0+mod" = _RRbVw6Aw;
        "pkg-2.0.1" = _DHXvcgpz;
        "pkg-2.0.1+mod" = _pBuYRQXX;
        "pkg-2.1" = _e4DXQBEF;
        "pkg-2.1+mod" = _9ckQOHbI;
        "pkg-2.1b" = _hQ3XAAxy;
        "pkg-2.1b+mod" = _E867Lsdg;
        "pkg-2.1c" = _ji6iB1po;
        "pkg-2.1c+mod" = _Ep61Gbc7;
        "pkg-2.2" = _uqKanKaO;
        "pkg-2.2+mod" = _SD8oAt1W;
        "pkg-2.2.2a" = _BYT4cSnB;
        "pkg-2.2.2a+mod" = _EqI6Xrpa;
        "pkg-2.3" = _Gm54EVLR;
        "pkg-2.3+mod" = _QNsOxHh1;
        "pkg-2.3a" = _FYa7ELgG;
        "pkg-2.3a+mod" = _MkWW62cR;
        "pkg-2.3b" = _9WnOmsiE;
        "pkg-2.3b+mod" = _zwnWjSjE;
        "pkg-2.4" = _znxGzfTH;
