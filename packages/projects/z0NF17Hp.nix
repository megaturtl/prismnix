...
let
    versions = (let
        ...
        _tmQfNeni = {
            "id" = "tmQfNeni";
            "file" = "AuraLite_ShaderPack.v1.1.3.zip";
            "hash" = "sha512-phg4Hq+3ejp6QdRUnmADQuuPRUXeKiLOqVwD0Jr6DXVMfwQmLaxBmILMRdH5HT/+hG1f+PoHOhMvgsTv/kAsWQ==";
        };
        _O5e42ZGS = {
            "id" = "O5e42ZGS";
            "file" = "AuraLite_ShaderPack.v1.1.4.zip";
            "hash" = "sha512-LtoTaG/s9Wd78x/GI4xhVlmlbqlcXxPBzNGNwt1TR/oojokL1Jc3MfXxytRPwpUN2aYtzKSyWeqC181LlyG/mg==";
        };
    in {
        "LhC8V1wx" = _LhC8V1wx;
        "YBqEKedw" = _YBqEKedw;
        ...
        "tmQfNeni" = _tmQfNeni;
        "O5e42ZGS" = _O5e42ZGS;
        "iris-1.20.1" = _O5e42ZGS;
        "iris-1.16.5" = _O5e42ZGS;
        "iris-1.21.1" = _O5e42ZGS;
        "iris-26.1.2" = _O5e42ZGS;
        "iris-1.17" = _O5e42ZGS;
        "iris-1.17.1" = _O5e42ZGS;
        "iris-1.18" = _O5e42ZGS;
        "iris-1.18.1" = _O5e42ZGS;
        "iris-1.18.2" = _O5e42ZGS;
        "iris-1.19" = _O5e42ZGS;
        "iris-1.19.1" = _O5e42ZGS;
        "iris-1.19.2" = _O5e42ZGS;
        "iris-1.19.3" = _O5e42ZGS;
        "iris-1.19.4" = _O5e42ZGS;
        "iris-1.20" = _O5e42ZGS;
        "iris-1.20.2" = _O5e42ZGS;
        "iris-1.20.3" = _O5e42ZGS;
        "iris-1.20.4" = _O5e42ZGS;
        "iris-1.20.5" = _O5e42ZGS;
        "iris-1.20.6" = _O5e42ZGS;
        "iris-1.21" = _O5e42ZGS;
        "iris-1.21.2" = _O5e42ZGS;
        "iris-1.21.3" = _O5e42ZGS;
        "iris-1.21.4" = _O5e42ZGS;
        "iris-1.21.5" = _O5e42ZGS;
        "iris-1.21.6" = _O5e42ZGS;
        "iris-1.21.7" = _O5e42ZGS;
        "iris-1.21.8" = _O5e42ZGS;
        "iris-1.21.9" = _O5e42ZGS;
        "iris-1.21.10" = _O5e42ZGS;
        "iris-1.21.11" = _O5e42ZGS;
        "iris-26.1" = _O5e42ZGS;
        "iris-26.1.1" = _O5e42ZGS;
        "iris-26.2" = _O5e42ZGS;
        "iris-1.16" = _O5e42ZGS;
        "iris-1.16.1" = _O5e42ZGS;
        "iris-1.16.2" = _O5e42ZGS;
        "iris-1.16.3" = _O5e42ZGS;
        "iris-1.16.4" = _O5e42ZGS;
        "optifine-1.20.1" = _O5e42ZGS;
        "optifine-1.16.5" = _O5e42ZGS;
        "optifine-1.21.1" = _O5e42ZGS;
        "optifine-26.1.2" = _O5e42ZGS;
        "optifine-1.17" = _O5e42ZGS;
        "optifine-1.17.1" = _O5e42ZGS;
        "optifine-1.18" = _O5e42ZGS;
        "optifine-1.18.1" = _O5e42ZGS;
        "optifine-1.18.2" = _O5e42ZGS;
        "optifine-1.19" = _O5e42ZGS;
        "optifine-1.19.1" = _O5e42ZGS;
        "optifine-1.19.2" = _O5e42ZGS;
        "optifine-1.19.3" = _O5e42ZGS;
        "optifine-1.19.4" = _O5e42ZGS;
        "optifine-1.20" = _O5e42ZGS;
        "optifine-1.20.2" = _O5e42ZGS;
        "optifine-1.20.3" = _O5e42ZGS;
        "optifine-1.20.4" = _O5e42ZGS;
        "optifine-1.20.5" = _O5e42ZGS;
        "optifine-1.20.6" = _O5e42ZGS;
        "optifine-1.21" = _O5e42ZGS;
        "optifine-1.21.2" = _O5e42ZGS;
        "optifine-1.21.3" = _O5e42ZGS;
        "optifine-1.21.4" = _O5e42ZGS;
        "optifine-1.21.5" = _O5e42ZGS;
        "optifine-1.21.6" = _O5e42ZGS;
        "optifine-1.21.7" = _O5e42ZGS;
        "optifine-1.21.8" = _O5e42ZGS;
        "optifine-1.21.9" = _O5e42ZGS;
        "optifine-1.21.10" = _O5e42ZGS;
        "optifine-1.21.11" = _O5e42ZGS;
        "optifine-26.1" = _O5e42ZGS;
        "optifine-26.1.1" = _O5e42ZGS;
        "optifine-26.2" = _O5e42ZGS;
        "optifine-1.16" = _O5e42ZGS;
        "optifine-1.16.1" = _O5e42ZGS;
        "optifine-1.16.2" = _O5e42ZGS;
        "optifine-1.16.3" = _O5e42ZGS;
        "optifine-1.16.4" = _O5e42ZGS;
        "pkg-0.1.0-beta" = _LhC8V1wx;
        "pkg-0.1.5-beta" = _YBqEKedw;
        "pkg-0.2.3-beta" = _HgWywD9m;
        "pkg-0.2.4-beta" = _tJ6RgikR;
        "pkg-0.2.5-beta" = _1uheQAYa;
        "pkg-0.2.6-beta" = _XRcte3Fr;
        "pkg-0.2.7-beta" = _LjSJVnUR;
        "pkg-0.2.8-beta" = _DeejOCsH;
        "pkg-0.2.9-beta" = _drSpXiQd;
        "pkg-0.3.0-beta" = _RrSH7nCf;
        "pkg-1.0.0" = _P9urQAi5;
        "pkg-1.0.1" = _Tts9QHy5;
        "pkg-1.0.2" = _1XLaHNbU;
        "pkg-1.0.3" = _IS3QzGHS;
