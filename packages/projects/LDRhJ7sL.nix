...
let
    ...
    in {
        ...
        "pkg-1.0.3-1.21.1" = _dHOwdVWI;
        "pkg-1.0.3-1.21.4" = _Tf4HTnwq;
        "pkg-1.0.4-1.20.1" = _L6ym2bpl;
        "pkg-1.0.4-1.21.1" = _KhpTK2h8;
        "pkg-1.0.4-1.21.4" = _t8lfDMfk;
        "pkg-1.0.5-1.21.5" = _GGNxpk3h;
        "pkg-1.0.6-1.21.5" = _tVDRU3X3;
        "pkg-1.0.6-1.21.4-fabric" = _NxfEZEmZ;
        "pkg-1.0.7-1.20.1-fabric" = _AiRRpGjU;
        "pkg-1.0.7-1.21.1-fabric" = _lFbsn3Bu;
        "pkg-1.0.7-1.21.4-fabric" = _j30WzRis;
        "pkg-1.0.7-1.21.5-fabric" = _K7FeGnhj;
        "pkg-1.0.7-1.20.1-forge" = _Dp3mqPGY;
        "pkg-1.0.7-1.21.1-neoforge" = _4ca4b8oX;
        "pkg-1.0.7-1.21.4-neoforge" = _ybqGwvU3;
        "pkg-1.0.7-1.21.5-neoforge" = _hR29fEdK;
        "pkg-1.0.8-1.21.5-neoforge" = _4ye0sIOE;
        "pkg-1.0.8-1.21.5-fabric" = _6ywx9I78;
        "pkg-1.0.9-1.20.1-fabric" = _oVGZ2aJ2;
        "pkg-1.0.9-1.20.1-forge" = _yHgedb07;
        "pkg-1.0.9-1.21.1-fabric" = _XWir08o9;
        "pkg-1.0.9-1.21.1-neoforge" = _keCue7wz;
        "pkg-1.0.9-1.21.4-fabric" = _gK03LfuF;
        "pkg-1.0.9-1.21.4-neoforge" = _W5AXGeEN;
        "pkg-1.0.9-1.21.5-fabric" = _7l0byias;
        "pkg-1.0.9-1.21.5-neoforge" = _VXBg6EIe;
        "pkg-1.1.0-1.20.1-fabric" = _LB31oO1o;
        "pkg-1.1.0-1.20.1-forge" = _H5cbKxn2;
        "pkg-1.1.0-1.21.1-fabric" = _5W7Dwq69;
        "pkg-1.1.0-1.21.1-neoforge" = _BK08T0Pd;
        "pkg-2.0.0-1.21.4-fabric" = _aej0CPpY;
        "pkg-2.0.0-1.21.4-neoforge" = _TpIflia3;
        "pkg-2.0.0-1.21.5-fabric" = _Rs8LmOuK;
        "pkg-2.0.0-1.21.5-neoforge" = _bNlbIUqE;
        "pkg-1.1.1-1.20.1-fabric" = _yJhOxhTR;
        "pkg-1.1.1-1.21.1-fabric" = _hVBWw5DA;
        "pkg-2.0.1-1.21.4-fabric" = _4ANzLfgA;
        "pkg-2.0.1-1.21.5-fabric" = _zX2ivWn9;
        "pkg-2.0.2-1.21.4-neoforge" = _Pvnc3MvA;
        "pkg-2.0.2-1.21.5-neoforge" = _sbIqbKD8;
        "pkg-2.0.2-1.21.6-neoforge" = _PHJ9nLF2;
        "pkg-2.0.1-1.21.6-fabric" = _ViUeYjJn;
        "pkg-2.0.1-1.21.7-fabric" = _fw0gmeky;
        "pkg-2.0.2-1.21.7-neoforge" = _H76qgevh;
        "pkg-2.0.1-1.21.8-fabric" = _TAScXXjO;
        "pkg-2.0.2-1.21.8-neoforge" = _SKMSafyD;
        "pkg-2.0.0-1.20.1-fabric" = _t7UmIbQ9;
        "pkg-2.0.0-1.20.1-forge" = _Ue3DdGkz;
        "pkg-2.0.0-1.21.1-fabric" = _sKoWSHX6;
        "pkg-2.0.0-1.21.1-neoforge" = _QLspDekF;
        "pkg-2.0.1+1.21.9-fabric" = _F3TcW2vx;
        "pkg-2.0.2-1.21.9-neoforge" = _DqF8Rwmk;
        "pkg-2.0.3-1.21.9-neoforge" = _yQKwOFIP;
        "pkg-2.0.1+1.21.10-fabric" = _QKO1p6tj;
        "pkg-2.0.3-1.21.10-neoforge" = _swyNsr4l;
        "pkg-2.0.4+1.21.1-fabric" = _B8xtvm5J;
        "pkg-2.0.4-1.21.1-neoforge" = _VPPcYEiH;
        "pkg-2.0.4+1.21.10-fabric" = _dkdn0GfI;
        "pkg-2.0.4-1.21.10-neoforge" = _EXhINDx7;
        "pkg-2.0.4-1.21.11-neoforge" = _LLyeJxom;
        "pkg-2.0.4+1.21.11-fabric" = _eK5rz4b1;
        "pkg-2.1.0-1.21.8-neoforge" = _J1P8Un5k;
        "pkg-2.1.0-1.21.10-neoforge" = _6b3U9uAT;
        "pkg-2.1.0-1.21.11-neoforge" = _UktCOail;
        "pkg-2.1.0-1.21.5-neoforge" = _oapdSPaZ;
        "pkg-2.1.0-1.21.4-neoforge" = _Y2a4Lo1s;
        "pkg-2.1.0-1.21.1-neoforge" = _u16tIH6v;
        "pkg-2.1.0-1.20.1-forge" = _UjxMRikW;
        "pkg-2.1.0+1.21.11-fabric" = _mER12xUZ;
        "pkg-2.1.0+1.21.10-fabric" = _oX2OnxQc;
        "pkg-2.1.0-1.21.8-fabric" = _fdnWyuMj;
        "pkg-2.1.0-1.21.5-fabric" = _s2Q9wNTQ;
        "pkg-2.1.0-1.21.4-fabric" = _VznUUkZy;
        "pkg-2.1.0+1.21.1-fabric" = _vle7zZZI;
        "pkg-2.1.0-1.20.1-fabric" = _nFsGwOC2;
        "pkg-2.2.0-1.21.11-neoforge" = _ljGjrSz7;
        "pkg-2.2.0-1.21.10-neoforge" = _aSZ9V8GK;
        "pkg-2.2.0+1.21.11-fabric" = _qNiHbulc;
        "pkg-2.2.0+1.21.10-fabric" = _Xq8zroIq;
        "pkg-2.2.0-26.1-snapshot-2-neoforge" = _vSYLyAjI;
        "pkg-2.2.0+26.1-snapshot-3-fabric" = _ZBai4W5a;
        "pkg-2.2.0-26.1-snapshot-3-neoforge" = _bJFUYeXe;
        "pkg-2.2.0+26.1-snapshot-4-fabric" = _b8RuISbs;
        "pkg-2.2.0-26.1-snapshot-4-neoforge" = _j1uGNdvV;
        "pkg-2.3.0-1.21.11-neoforge" = _86HxTNrX;
        "pkg-2.3.0+1.21.11-fabric" = _MmdKcpTv;
        "pkg-2.3.0+26.1-snapshot-7-fabric" = _Jlqtl1iq;
        "pkg-2.3.0-26.1-snapshot-7-neoforge" = _TTKGUeL6;
        "pkg-2.3.0+26.1-fabric" = _HmvnpcET;
        "pkg-2.3.0-26.1-neoforge" = _dxIEQSTG;
        "pkg-2.4.0+26.1-fabric" = _ZPOgrdsI;
        "pkg-2.4.0-26.1-neoforge" = _PBQF6XyC;
