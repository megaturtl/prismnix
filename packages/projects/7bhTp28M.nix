...
let
    versions = (let
        ...
        _jc9H7JO6 = {
            "id" = "jc9H7JO6";
            "file" = "ClearLag 1.12.3 VER 1.18-26.2.jar";
            "hash" = "sha512-3KvySdpZLscnhBybQgB2FguHasOWyiQ5utxpYM/QPtRMO4hWaK7+PJdocC5b4aBxcMRQs39Nvr0IbkayK3O7XQ==";
        };
        _iivMYrg7 = {
            "id" = "iivMYrg7";
            "file" = "ClearLag 1.12.4 VER 1.18-26.2.jar";
            "hash" = "sha512-pS7OcNEJVKbGCsDr3C7ICRcyfwqutXiE7LQFgk3eVhhVR1asf/yd1ikY4ohSWUDHUYFZvAzIpK2kfV+L2sDyNg==";
        };
        _aIxlPIj2 = {
            "id" = "aIxlPIj2";
            "file" = "ClearLag 1.12.5 VER 1.18-26.2.jar";
            "hash" = "sha512-W9ulMNpGwiExSVBmp4BoZ1YCCFoIx5uRRDYxz1aNqU4+fQS/XkVhE6bVjCgZ+9HkwNIwm7xyHf+UlclooOiSBg==";
        };
        _q9dfsdFC = {
            "id" = "q9dfsdFC";
            "file" = "ClearLag 1.13.0 VER 1.18-26.2.jar";
            "hash" = "sha512-WDO1fPueulhq0AzK7V0mtojVTm635oY7ssLojMU7efhGsXLj0LUAaqvfXv9ZkPK8TJAlnHfzj/Hh+PJVGhACpg==";
        };
    in {
        "IB5qSuYK" = _IB5qSuYK;
        "ti8VrNwX" = _ti8VrNwX;
        ...
        "aIxlPIj2" = _aIxlPIj2;
        "q9dfsdFC" = _q9dfsdFC;
        "bukkit-1.21.1" = _q9dfsdFC;
        "bukkit-1.21.2" = _q9dfsdFC;
        "bukkit-1.21.3" = _q9dfsdFC;
        "bukkit-1.21.4" = _q9dfsdFC;
        "bukkit-1.21" = _q9dfsdFC;
        "bukkit-1.21.5" = _q9dfsdFC;
        "bukkit-1.21.6" = _q9dfsdFC;
        "bukkit-1.21.7-rc1" = _SE1cSUQu;
        "bukkit-1.21.7-rc2" = _SE1cSUQu;
        "bukkit-1.21.7" = _q9dfsdFC;
        "bukkit-1.21.8" = _q9dfsdFC;
        "bukkit-1.20" = _q9dfsdFC;
        "bukkit-1.20.1" = _q9dfsdFC;
        "bukkit-1.20.2" = _q9dfsdFC;
        "bukkit-1.20.3" = _q9dfsdFC;
        "bukkit-1.20.4" = _q9dfsdFC;
        "bukkit-1.20.5" = _q9dfsdFC;
        "bukkit-1.20.6" = _q9dfsdFC;
        "bukkit-1.19" = _q9dfsdFC;
        "bukkit-1.19.1" = _q9dfsdFC;
        "bukkit-1.19.2" = _q9dfsdFC;
        "bukkit-1.19.3" = _q9dfsdFC;
        "bukkit-1.19.4" = _q9dfsdFC;
        ...
        "bukkit-1.18" = _q9dfsdFC;
        "bukkit-1.18.1" = _q9dfsdFC;
        "bukkit-1.18.2" = _q9dfsdFC;
        "bukkit-1.21.9" = _q9dfsdFC;
        "bukkit-1.21.10" = _q9dfsdFC;
        "bukkit-1.21.11" = _q9dfsdFC;
        "bukkit-26.1" = _q9dfsdFC;
        "bukkit-26.1.1" = _q9dfsdFC;
        "bukkit-26.1.2" = _q9dfsdFC;
        "bukkit-26.2" = _q9dfsdFC;
        "paper-1.21.1" = _q9dfsdFC;
        "paper-1.21.2" = _q9dfsdFC;
        "paper-1.21.3" = _q9dfsdFC;
        "paper-1.21.4" = _q9dfsdFC;
        "paper-1.21.5" = _q9dfsdFC;
        "paper-1.21" = _q9dfsdFC;
        "paper-1.21.6" = _q9dfsdFC;
        "paper-1.21.7-rc1" = _SE1cSUQu;
        "paper-1.21.7-rc2" = _SE1cSUQu;
        "paper-1.21.7" = _q9dfsdFC;
        "paper-1.21.8" = _q9dfsdFC;
        "paper-1.20" = _q9dfsdFC;
        "paper-1.20.1" = _q9dfsdFC;
        "paper-1.20.2" = _q9dfsdFC;
        "paper-1.20.3" = _q9dfsdFC;
        "paper-1.20.4" = _q9dfsdFC;
        "paper-1.20.5" = _q9dfsdFC;
        "paper-1.20.6" = _q9dfsdFC;
        "paper-1.19" = _q9dfsdFC;
        "paper-1.19.1" = _q9dfsdFC;
        "paper-1.19.2" = _q9dfsdFC;
        "paper-1.19.3" = _q9dfsdFC;
        "paper-1.19.4" = _q9dfsdFC;
        ...
        "paper-1.18" = _q9dfsdFC;
        "paper-1.18.1" = _q9dfsdFC;
        "paper-1.18.2" = _q9dfsdFC;
        "paper-1.21.9" = _q9dfsdFC;
        "paper-1.21.10" = _q9dfsdFC;
        "paper-1.21.11" = _q9dfsdFC;
        "paper-26.1" = _q9dfsdFC;
        "paper-26.1.1" = _q9dfsdFC;
        "paper-26.1.2" = _q9dfsdFC;
        "paper-26.2" = _q9dfsdFC;
        "spigot-1.21.1" = _q9dfsdFC;
        "spigot-1.21.2" = _q9dfsdFC;
        "spigot-1.21.3" = _q9dfsdFC;
        "spigot-1.21.4" = _q9dfsdFC;
        "spigot-1.21.5" = _q9dfsdFC;
        "spigot-1.21" = _q9dfsdFC;
        "spigot-1.21.6" = _q9dfsdFC;
        "spigot-1.21.7-rc1" = _SE1cSUQu;
        "spigot-1.21.7-rc2" = _SE1cSUQu;
        "spigot-1.21.7" = _q9dfsdFC;
        "spigot-1.21.8" = _q9dfsdFC;
        "spigot-1.20" = _q9dfsdFC;
        "spigot-1.20.1" = _q9dfsdFC;
        "spigot-1.20.2" = _q9dfsdFC;
        "spigot-1.20.3" = _q9dfsdFC;
        "spigot-1.20.4" = _q9dfsdFC;
        "spigot-1.20.5" = _q9dfsdFC;
        "spigot-1.20.6" = _q9dfsdFC;
        "spigot-1.19" = _q9dfsdFC;
        "spigot-1.19.1" = _q9dfsdFC;
        "spigot-1.19.2" = _q9dfsdFC;
        "spigot-1.19.3" = _q9dfsdFC;
        "spigot-1.19.4" = _q9dfsdFC;
        ...
        "spigot-1.18" = _q9dfsdFC;
        "spigot-1.18.1" = _q9dfsdFC;
        "spigot-1.18.2" = _q9dfsdFC;
        "spigot-1.21.9" = _q9dfsdFC;
        "spigot-1.21.10" = _q9dfsdFC;
        "spigot-1.21.11" = _q9dfsdFC;
        "spigot-26.1" = _q9dfsdFC;
        "spigot-26.1.1" = _q9dfsdFC;
        "spigot-26.1.2" = _q9dfsdFC;
        "spigot-26.2" = _q9dfsdFC;
        "purpur-1.21" = _q9dfsdFC;
        "purpur-1.21.1" = _q9dfsdFC;
        "purpur-1.21.2" = _q9dfsdFC;
        "purpur-1.21.3" = _q9dfsdFC;
        "purpur-1.21.4" = _q9dfsdFC;
        "purpur-1.21.5" = _q9dfsdFC;
        "purpur-1.21.6" = _q9dfsdFC;
        "purpur-1.21.7-rc1" = _SE1cSUQu;
        "purpur-1.21.7-rc2" = _SE1cSUQu;
        "purpur-1.21.7" = _q9dfsdFC;
        "purpur-1.21.8" = _q9dfsdFC;
        "purpur-1.20" = _q9dfsdFC;
        "purpur-1.20.1" = _q9dfsdFC;
        "purpur-1.20.2" = _q9dfsdFC;
        "purpur-1.20.3" = _q9dfsdFC;
        "purpur-1.20.4" = _q9dfsdFC;
        "purpur-1.20.5" = _q9dfsdFC;
        "purpur-1.20.6" = _q9dfsdFC;
        "purpur-1.19" = _q9dfsdFC;
        "purpur-1.19.1" = _q9dfsdFC;
        "purpur-1.19.2" = _q9dfsdFC;
        "purpur-1.19.3" = _q9dfsdFC;
        "purpur-1.19.4" = _q9dfsdFC;
        ...
        "purpur-1.18" = _q9dfsdFC;
        "purpur-1.18.1" = _q9dfsdFC;
        "purpur-1.18.2" = _q9dfsdFC;
        "purpur-1.21.9" = _q9dfsdFC;
        "purpur-1.21.10" = _q9dfsdFC;
        "purpur-1.21.11" = _q9dfsdFC;
        "purpur-26.1" = _q9dfsdFC;
        "purpur-26.1.1" = _q9dfsdFC;
        "purpur-26.1.2" = _q9dfsdFC;
        "purpur-26.2" = _q9dfsdFC;
        "pkg-1.0" = _IB5qSuYK;
        "pkg-1.1" = _ti8VrNwX;
        "pkg-1.2" = _qCtlcPAF;
        "pkg-1.3" = _9BmNHNet;
        ...
        "pkg-1.6.8" = _5L4jEdUT;
        "pkg-1.6.9" = _fXXyoZd2;
        "pkg-1.6.10" = _8IbYwuOH;
        "pkg-1.6.11" = _gPb1gG89;
        "pkg-1.6.12" = _bmHC1sue;
        "pkg-1.6.12.1" = _LzqOscXT;
        "pkg-1.6.13" = _xyz8Zv85;
        "pkg-1.6.14" = _81pqsEOd;
        "pkg-1.6.15" = _1TONXW0n;
        "pkg-1.6.16" = _djfWb41v;
        "pkg-1.6.17" = _dylRjOE4;
        "pkg-1.6.18" = _JVyRXOUn;
        "pkg-1.6.19" = _awJzy6Mo;
        "pkg-1.6.20" = _duYLppAN;
        "pkg-1.6.21" = _kCvbYmo4;
        "pkg-1.6.22" = _vCHVeBMh;
        "pkg-1.6.23" = _CFCjlE33;
        "pkg-1.6.24" = _i6XE54ry;
        "pkg-1.6.24.1" = _CdulMIUM;
        "pkg-1.6.24.2" = _AaGaJ6p3;
        "pkg-1.6.24.3" = _c0ZXYMXC;
        "pkg-1.6.25" = _RS7YVx9i;
        "pkg-1.6.25.1" = _Ao3cut7e;
        "pkg-1.6.25.2" = _RHIVa3GA;
        "pkg-1.6.26" = _yDtjS9Pp;
        "pkg-1.6.27" = _pcAGlzVZ;
        "pkg-1.6.28" = _OKqZ1GPL;
        "pkg-1.7" = _96WgXBUD;
        "pkg-1.7.1" = _rQ6BeYwI;
        "pkg-1.7.2" = _F5uUY1VV;
        "pkg-1.7.3" = _fS0KYaaK;
        ...
        "pkg-1.7.5" = _s1opzRoi;
        "pkg-1.7.6" = _JNvJfeWA;
        "pkg-1.7.6.1" = _7C0YLzRJ;
        "pkg-1.7.6.2" = _Qnl95Amr;
        "pkg-1.7.6.3" = _CPdrojbp;
        "pkg-1.7.7" = _mkU5InoM;
        "pkg-1.7.7.1" = _2LmTmEgF;
        "pkg-1.7.8" = _fwmxYjvv;
        "pkg-1.7.9" = _xyXxlnDX;
        "pkg-1.8.0" = _T3dZH6Ow;
        "pkg-1.9.0" = _zYjk8ShQ;
        "pkg-1.10.0" = _7r7xXmzr;
        "pkg-1.10.1" = _5wahQkC2;
        "pkg-1.11.0" = _lHaLHYKP;
        "pkg-1.11.1" = _LaNOJYUT;
        "pkg-1.12.0" = _8AS4gC5K;
        "pkg-1.12.1" = _FNiBp5TX;
        "pkg-1.12.2" = _u2Z8TuNl;
        "pkg-1.12.3" = _jc9H7JO6;
        "pkg-1.12.4" = _iivMYrg7;
        "pkg-1.12.5" = _aIxlPIj2;
        "pkg-1.13.0" = _q9dfsdFC;
        "default" = _q9dfsdFC;
    });
