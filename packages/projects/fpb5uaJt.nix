...
let
    ...
    in {
        ...
        "pkg-1.7.0" = _aGCY1nPh;
        "pkg-1.7.1" = _qfqgvljz;
        "pkg-1.7.2-1.21.5" = _FMyYQj6U;
        "pkg-1.7.2-1.21.8" = _H3ueHP7k;
        "pkg-1.7.3-1.21.5" = _GE3xfVVM;
        "pkg-1.7.3-1.21.8" = _1dJqrcRJ;
        "pkg-1.7.4-1.21.5" = _oj2eHMmM;
        "pkg-1.7.4-1.21.8" = _Gvajx1wi;
        "pkg-1.8.0-1.21.5" = _swKwLv1E;
        "pkg-1.8.0-1.21.8" = _gPlaOXeL;
        "pkg-1.8.0-1.21.10" = _uPWf3cHj;
        "pkg-1.9.0-1.21.5" = _IzDr69uk;
        "pkg-1.9.0-1.21.8" = _PsRk8dUm;
        "pkg-1.9.0-1.21.10" = _euL5hMDB;
        "pkg-1.9.1-1.21.10" = _L2XsKbnk;
        "pkg-1.9.1-1.21.8" = _ocmBW0OY;
        "pkg-1.9.1-1.21.5" = _d4yATBKO;
        "pkg-1.9.2-1.21.10" = _4HNRG9Sf;
        "pkg-1.9.2-1.21.8" = _B0gA5WFI;
        "pkg-1.9.2-1.21.5" = _wVzcCqZz;
        "pkg-1.10.0-1.21.5" = _2JC3rfYW;
        "pkg-1.10.0-1.21.8" = _i7nICxJN;
        "pkg-1.10.0-1.21.10" = _QRJ73pPE;
        "pkg-1.10.0-1.21.11" = _lEMeDKhu;
        "pkg-1.10.1-1.21.5" = _3XP1evU8;
        "pkg-1.10.1-1.21.8" = _B1boZ9ft;
        "pkg-1.10.1-1.21.10" = _Qe9m45z3;
        "pkg-1.10.1-1.21.11" = _ymHArVlE;
        "pkg-1.10.2-1.21.5" = _J7QKt9Ss;
        "pkg-1.10.2-1.21.8" = _VOrmPBkA;
        "pkg-1.10.2-1.21.10" = _FONOvHi2;
        "pkg-1.10.2-1.21.11" = _bUd5tsWl;
        "pkg-1.11.0-1.21.10" = _m0FQk0DM;
        "pkg-1.11.0-1.21.11" = _t4Guklt7;
        "pkg-1.11.1-1.21.10" = _QHlWZVcw;
        "pkg-1.11.1-1.21.11" = _enrTUO8c;
        "pkg-1.12.0-1.21.10" = _Y0gaXHiK;
        "pkg-1.12.0-1.21.11" = _oCvE35qI;
        "pkg-1.12.1-1.21.10" = _bSty6k9O;
        "pkg-1.12.1-1.21.11" = _hIcA9uq2;
        "pkg-1.12.2-1.21.10" = _lVZDL2p4;
        "pkg-1.12.2-1.21.11" = _I1LQzbCw;
        "pkg-1.12.3-1.21.10" = _BXPqYy3x;
        "pkg-1.12.3-1.21.11" = _RIWEJ0uh;
        "pkg-1.12.3-26.1" = _51NCGW9J;
        "pkg-1.12.4" = _31PNRKsQ;
        "pkg-1.12.5" = _66KkKQcD;
