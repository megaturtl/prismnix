...
let
    versions = (let
        ...
        _qXhPH9mA = {
            "id" = "qXhPH9mA";
            "file" = "slabstoblocks-fabric-1.18.2-3.jar";
            "hash" = "sha512-+oru88VyyAvOeoPy/1hlZ7d6N3SHA4Jp6//uGwyRrf+G08nEUJxenO9N4IQ4Q9Z3BPlfSgsNIrgFUb2MZXHXGQ==";
        };
        _uSPaFrtY = {
            "id" = "uSPaFrtY";
            "file" = "slabstoblocks-fabric-1.19.2-3.jar";
            "hash" = "sha512-DS6FmooPsweYkGkcZ4H1pVJ/Zl9Dg0lhmdSHXVtL3BUfHKf3Z4KU9ERsdBDqIiSmdS8diL8SYBu1ADGfX4sOMg==";
        };
        _oXJs3CHZ = {
            "id" = "oXJs3CHZ";
            "file" = "slabstoblocks-fabric-1.20.1-3.jar";
            "hash" = "sha512-wuZd80aywudimdq8jzirgQlBIofSK3Rz8M0I99toVzoPWht31d6CZjIKwOBdfbnd8rV02Z5L3WCynp4szb3i9g==";
        };
        _v7JsvbWh = {
            "id" = "v7JsvbWh";
            "file" = "slabstoblocks-fabric-1.21.1-3.jar";
            "hash" = "sha512-H2sOoigKJE8+1tJ5AYXB5SaLlaLNdkbmSkjnIc6Wdest/yxlF0J+ppv+p7hxPLJLkx7GH2PCIlTR/qWJKansUQ==";
        };
        _qQQbXy8G = {
            "id" = "qQQbXy8G";
            "file" = "slabstoblocks-fabric-26.1.2-3.jar";
            "hash" = "sha512-RIfK0CM9764UKaX0hn+GbI5tgKYC8gme0XvgTlNcaackf+qJ9Strc9vMmBij0F9QkoV8+DmnqtgkhOOQNVuPfA==";
        };
        _NwheeI3B = {
            "id" = "NwheeI3B";
            "file" = "slabstoblocks-fabric-26.2-3.jar";
            "hash" = "sha512-ayN4HBLjROJKq9NFSYOYNEMZMhhCOlbkUB1+Ky9PqPdsN7RqZoMPBz4NVtdWur5QdzWQLSa/Ur7OtBKqzUZcpg==";
        };
        _utyraG6n = {
            "id" = "utyraG6n";
            "file" = "slabstoblocks-forge-1.18.2-3.jar";
            "hash" = "sha512-E+W0a/lqMMzXZHUjYXthFjWpKLKEEB6lWn/DyGCc9B1HSNUZb7Z41vrTtbXn7ERkm28m6PySHp+3l138VPbwOA==";
        };
        _D1k8QUK3 = {
            "id" = "D1k8QUK3";
            "file" = "slabstoblocks-forge-1.19.2-3.jar";
            "hash" = "sha512-f+6nfmjA+mEA5jjks0CAVntx6PCNgVq9zsK5+izFiItitl07IjjJ2XIYVWmf2kcsREH3p99wC4z05ay45IztLw==";
        };
        _vCj26cfD = {
            "id" = "vCj26cfD";
            "file" = "slabstoblocks-forge-1.20.1-3.jar";
            "hash" = "sha512-BjjNF27AhwXqKCaDuqWVidN5fPqvkP3fEq1CDdNkyOp4J4+7C0tng5N8a7IfIZWjjCPuIasrqLlWla+rd1MLgQ==";
        };
        _2jQHjtnH = {
            "id" = "2jQHjtnH";
            "file" = "slabstoblocks-forge-1.21.1-3.jar";
            "hash" = "sha512-xzj8Z+4boOaZKMWMT1q2Z0+e5d3gAQunjk+nUezjvpXnUWl2UZ9hIXSZ6jOCvHcypawVhd+Rdwg2e0llbZfkMQ==";
        };
        _ffnmVCP5 = {
            "id" = "ffnmVCP5";
            "file" = "slabstoblocks-forge-26.1.2-3.jar";
            "hash" = "sha512-ZoYUrn2wURgk7zhc3G7ZZL/iA6KRWaMRqIdvBZsq5wcJNhB//sHO3wiM73mGmTp39Xsyaoddjf2ZnI+tO3du4g==";
        };
        _gPTWD9Qi = {
            "id" = "gPTWD9Qi";
            "file" = "slabstoblocks-forge-26.2-3.jar";
            "hash" = "sha512-t+YbsiT0xQy5RlF+7ohmjgjxXJQPNnpYFkuNJJ2yZnVjtrJ5yKH1RYH76frkFVz99pSc6fWhi3NCaaY1d/dsjQ==";
        };
        _eub7s6gG = {
            "id" = "eub7s6gG";
            "file" = "slabstoblocks-neoforge-1.21.1-3.jar";
            "hash" = "sha512-OroXGOaH5sV25EM6LrXSRmDg0EZA+rNaYAZS/gfAjxf+mV7t51VszBdQMKso0glIZrNz2c8R3vgU8DST7nVs7g==";
        };
        _5V3nceUf = {
            "id" = "5V3nceUf";
            "file" = "slabstoblocks-neoforge-26.1.2-3.jar";
            "hash" = "sha512-clxrbUjfnxYQSl22LI0wvBcTxsJuRQ3xf7Gi0FR9LMkYy6vNtDJamqnKl1YjdEzId5/u7dvg8RbD1R+3F+IXZg==";
        };
        _gYrt7mFC = {
            "id" = "gYrt7mFC";
            "file" = "slabstoblocks-neoforge-26.2-3.jar";
            "hash" = "sha512-n4F9AID4iqY+bpjBoJ0K7yyw2Y74cRrI8mILaq+siOoPSLZAjjId2z7zGi+tByykJyqFHZyqAxmg26V4S9OwXg==";
        };
    in {
        "qrWSAmwd" = _qrWSAmwd;
        "l1g75JNz" = _l1g75JNz;
        ...
        "fabric-26.1" = _qQQbXy8G;
        "fabric-26.1.1" = _qQQbXy8G;
        "fabric-26.1.2" = _qQQbXy8G;
        "fabric-26.2" = _NwheeI3B;
        "quilt-1.16.5" = _qrWSAmwd;
        "quilt-1.17" = _l1g75JNz;
        "quilt-1.17.1" = _q3JN6vVb;
        "quilt-1.18.1" = _qXhPH9mA;
        "quilt-1.18.2" = _qXhPH9mA;
        "quilt-1.19" = _uSPaFrtY;
        "quilt-1.19.1" = _uSPaFrtY;
        "quilt-1.19.2" = _uSPaFrtY;
        "quilt-1.19.3" = _8noBI5gy;
        "quilt-1.19.4" = _Ru7JExKt;
        "quilt-1.20" = _oXJs3CHZ;
        "quilt-1.20.1" = _oXJs3CHZ;
        "quilt-1.20.2" = _5hlV7nzy;
        "quilt-1.20.3" = _nzNsSoav;
        "quilt-1.20.4" = _nzNsSoav;
        "quilt-1.20.5" = _Xcg6A8vl;
        "quilt-1.20.6" = _Xcg6A8vl;
        "quilt-1.21" = _v7JsvbWh;
        "quilt-1.21.1" = _v7JsvbWh;
        "quilt-1.21.2" = _VP8IBUUJ;
        "quilt-1.21.3" = _VP8IBUUJ;
        "quilt-1.21.4" = _olwuUbI4;
        "quilt-1.18" = _qXhPH9mA;
        ...
        "quilt-26.1" = _qQQbXy8G;
        "quilt-26.1.1" = _qQQbXy8G;
        "quilt-26.1.2" = _qQQbXy8G;
        "quilt-26.2" = _NwheeI3B;
        "forge-1.16.5" = _STcxrfpX;
        "forge-1.17.1" = _onC7OSEo;
        "forge-1.18" = _utyraG6n;
        "forge-1.18.1" = _utyraG6n;
        "forge-1.18.2" = _utyraG6n;
        "forge-1.19" = _D1k8QUK3;
        "forge-1.19.1" = _D1k8QUK3;
        "forge-1.19.2" = _D1k8QUK3;
        "forge-1.19.3" = _o3wltJwq;
        "forge-1.19.4" = _YPN4t9Cm;
        "forge-1.20" = _vCj26cfD;
        "forge-1.20.1" = _vCj26cfD;
        "forge-1.20.2" = _LwjxAUnd;
        "forge-1.20.3" = _WJciAIuX;
        "forge-1.20.4" = _WJciAIuX;
        "forge-1.20.6" = _strrpCS9;
        "forge-1.21" = _2jQHjtnH;
        "forge-1.21.1" = _2jQHjtnH;
        ...
        "forge-26.1" = _ffnmVCP5;
        "forge-26.1.1" = _ffnmVCP5;
        "forge-26.1.2" = _ffnmVCP5;
        "forge-26.2" = _gPTWD9Qi;
        "neoforge-1.20.4" = _WEni9Gh0;
        "neoforge-1.20.6" = _GIOlAydo;
        "neoforge-1.21" = _eub7s6gG;
        "neoforge-1.21.1" = _eub7s6gG;
        "neoforge-1.21.2" = _5Rfjuan6;
        "neoforge-1.21.3" = _5Rfjuan6;
        "neoforge-1.21.4" = _unHIvtMr;
        "neoforge-1.20" = _vCj26cfD;
        "neoforge-1.20.1" = _vCj26cfD;
        ...
        "neoforge-26.1" = _5V3nceUf;
        "neoforge-26.1.1" = _5V3nceUf;
        "neoforge-26.1.2" = _5V3nceUf;
        "neoforge-26.2" = _gYrt7mFC;
        "pkg-1.16.5-0" = _qrWSAmwd;
        "pkg-1.17-0" = _l1g75JNz;
        "pkg-1.17.1-0" = _q3JN6vVb;
        "pkg-1.18.1-0" = _PuPHyqCi;
        "pkg-1.18.2-0" = _TcaDMUkO;
        "pkg-1.19-0" = _53JfVjpY;
        "pkg-1.19.1-0" = _3JMdr1ut;
        "pkg-1.19.2-0" = _uPrL1K7y;
        "pkg-1.19.3-0" = _8noBI5gy;
        "pkg-1.16.5-0-forge" = _STcxrfpX;
        "pkg-1.17.1-0-forge" = _onC7OSEo;
        "pkg-1.18-0-forge" = _oSHcziH3;
        "pkg-1.18.1-0-forge" = _EW7RmPR2;
        "pkg-1.18.2-0-forge" = _hNBcOusn;
        "pkg-1.19-0-forge" = _IYZgvhNp;
        "pkg-1.19.1-0-forge" = _UZqWr8y2;
        "pkg-1.19.2-0-forge" = _IySez87b;
        "pkg-1.19.3-0-forge" = _o3wltJwq;
        "pkg-1.19.4-0" = _9yebVUUQ;
        "pkg-1.19.4-0-forge" = _KwJA1cSW;
        "pkg-1.20-0" = _n31KFdKt;
        "pkg-1.20-0-forge" = _NDv7CCbq;
        "pkg-1.20-1-fabric" = _V0vQ3IkL;
        "pkg-1.20-1-forge" = _DPRTs0E5;
        "pkg-1.20.1-1-fabric" = _lZiHQmlZ;
        "pkg-1.20.1-1-forge" = _oIXrNCiy;
        "pkg-1.20.2-1-fabric" = _nIjSdtYM;
        "pkg-1.20.2-1-forge" = _socfMJCz;
        "pkg-1.20.3-1-fabric" = _oOxitiLv;
        "pkg-1.20.3-1-forge" = _wMdYJzrD;
        "pkg-1.20.4-1-forge" = _btRd3TOU;
        "pkg-1.20.4-1-fabric" = _6vtVTYxF;
        "pkg-1.20.4-0-neoforge" = _WEni9Gh0;
        "pkg-1.20.5-1-fabric" = _t5W9NuUZ;
        "pkg-1.20.6-1-fabric" = _mKYLGyNV;
        "pkg-1.20.6-0-neoforge" = _kRf7DKdk;
        "pkg-1.20.6-1-forge" = _PgJzI7jl;
        "pkg-1.21-1-fabric" = _uYgut4FI;
        "pkg-1.21-1-forge" = _2LV9PvBZ;
        "pkg-1.21-0-neoforge" = _wodx4AEf;
        "pkg-1.20.6-0.1-neoforge" = _t72u03st;
        "pkg-1.21-0.1-neoforge" = _7wmODLhi;
        "pkg-1.21.1-0.1-neoforge" = _WgC3j0q3;
        "pkg-1.21.1-1-fabric" = _7lRdFmLd;
        "pkg-1.21.1-1-forge" = _jl8tnIkG;
        "pkg-1.21.3-1-fabric" = _xybNpqMd;
        "pkg-1.21.3-1-forge" = _X2c395Vd;
        "pkg-1.21.3-0.1-neoforge" = _Aey3BUI8;
        "pkg-1.21.4-1-fabric" = _nXIqdRVa;
        "pkg-1.21.4-0.1-neoforge" = _r5iZTbkz;
        "pkg-1.21.4-1-forge" = _D8taO1sB;
        "pkg-fabric-1.18.2-2.jar" = _BOdVvXLa;
        "pkg-fabric-1.19.2-2.jar" = _AbpawDNb;
        "pkg-fabric-1.19.4-2.jar" = _95NMdExi;
        "pkg-fabric-1.20.1-2.jar" = _GR3BDK6N;
        "pkg-fabric-1.20.2-2.jar" = _Ywua8U2f;
        "pkg-fabric-1.20.4-2.jar" = _NMukXaBf;
        "pkg-fabric-1.20.6-2.jar" = _DCc90X26;
        "pkg-fabric-1.21.1-2.jar" = _YBZXz8rN;
        "pkg-fabric-1.21.3-2.jar" = _btssHL3f;
        "pkg-fabric-1.21.4-2.jar" = _cY6Skv7U;
        "pkg-forge-1.18.2-2.jar" = _8VdKD6N9;
        "pkg-forge-1.19.2-2.jar" = _lXGC6Mpq;
        "pkg-forge-1.19.4-2.jar" = _To47x2Za;
        "pkg-forge-1.20.1-2.jar" = _sx4DsqJw;
        "pkg-forge-1.20.2-2.jar" = _UfXyv2Ks;
        "pkg-forge-1.20.4-2.jar" = _1sZcHRBJ;
        "pkg-forge-1.20.6-2.jar" = _y0RunwjT;
        "pkg-forge-1.21.1-2.jar" = _8tsYuURc;
        "pkg-forge-1.21.3-2.jar" = _ksR9UdD4;
        "pkg-forge-1.21.4-2.jar" = _FyWckpEs;
        "pkg-neoforge-1.20.6-2.jar" = _ul0IYL62;
        "pkg-neoforge-1.21.1-2.jar" = _sxnt4LvY;
        "pkg-neoforge-1.21.3-2.jar" = _IEv0z2cW;
        "pkg-neoforge-1.21.4-2.jar" = _OGSAWQZh;
        "pkg-fabric-1.18.2-2.1.jar" = _j2xOI8wS;
        "pkg-fabric-1.19.2-2.1.jar" = _4tDZseIy;
        "pkg-fabric-1.19.4-2.1.jar" = _lW9N0RBO;
        "pkg-fabric-1.20.1-2.1.jar" = _JGM4QzoN;
        "pkg-fabric-1.20.2-2.1.jar" = _kr530lMb;
        "pkg-fabric-1.20.4-2.1.jar" = _b06CzNbd;
        "pkg-fabric-1.20.6-2.1.jar" = _7TwGo1hu;
        "pkg-fabric-1.21.1-2.1.jar" = _d9UScMmg;
        "pkg-fabric-1.21.3-2.1.jar" = _7VzyQKfg;
        "pkg-fabric-1.21.4-2.1.jar" = _ph68W23h;
        "pkg-forge-1.18.2-2.1.jar" = _MYd2JL1r;
        "pkg-forge-1.19.2-2.1.jar" = _FCXDbgBe;
        "pkg-forge-1.19.4-2.1.jar" = _eFKqQ3Xs;
        "pkg-forge-1.20.1-2.1.jar" = _YU2cRpu5;
        "pkg-forge-1.20.2-2.1.jar" = _9FD6e5nC;
        "pkg-forge-1.20.4-2.1.jar" = _nOUGM5YD;
        "pkg-forge-1.20.6-2.1.jar" = _hOTJCnUE;
        "pkg-forge-1.21.1-2.1.jar" = _hAWrV00J;
        "pkg-forge-1.21.3-2.1.jar" = _KIGBfuMj;
        "pkg-forge-1.21.4-2.1.jar" = _AUkB2yko;
        "pkg-neoforge-1.20.6-2.1.jar" = _dETF4xxe;
        "pkg-neoforge-1.21.1-2.1.jar" = _ytPs72uT;
        "pkg-neoforge-1.21.3-2.1.jar" = _Ahq5Gw9u;
        "pkg-neoforge-1.21.4-2.1.jar" = _bOjQPMYv;
        "pkg-fabric-1.18.2-2.2" = _3nNKieu0;
        "pkg-fabric-1.18.2-2.3" = _UHTPf3tt;
        "pkg-fabric-1.19.2-2.3" = _kw79v2l2;
        "pkg-fabric-1.19.4-2.3" = _Ru7JExKt;
        "pkg-fabric-1.20.1-2.3" = _SIHLRjey;
        "pkg-fabric-1.20.2-2.3" = _5hlV7nzy;
        "pkg-fabric-1.20.4-2.3" = _nzNsSoav;
        "pkg-fabric-1.20.6-2.3" = _Xcg6A8vl;
        "pkg-fabric-1.21.1-2.3" = _loIAU8p3;
        "pkg-fabric-1.21.3-2.3" = _VP8IBUUJ;
        "pkg-fabric-1.21.4-2.3" = _olwuUbI4;
        "pkg-forge-1.18.2-2.3" = _dGcKtp3C;
        "pkg-forge-1.19.2-2.3" = _jCbAUjBQ;
        "pkg-forge-1.19.4-2.3" = _YPN4t9Cm;
        "pkg-forge-1.20.1-2.3" = _hjQEVIJj;
        "pkg-forge-1.20.2-2.3" = _LwjxAUnd;
        "pkg-forge-1.20.4-2.3" = _WJciAIuX;
        "pkg-forge-1.20.6-2.3" = _strrpCS9;
        "pkg-forge-1.21.1-2.3" = _YuCwFAvQ;
        "pkg-forge-1.21.3-2.3" = _KtvFdxUx;
        "pkg-forge-1.21.4-2.3" = _PyPxBJaF;
        "pkg-neoforge-1.20.6-2.3" = _GIOlAydo;
        "pkg-neoforge-1.21.1-2.3" = _RqaB80qI;
        "pkg-neoforge-1.21.3-2.3" = _5Rfjuan6;
        "pkg-neoforge-1.21.4-2.3" = _unHIvtMr;
        "pkg-fabric-1.21.5-2.3" = _ZJ9G4HdM;
        "pkg-forge-1.21.5-2.3" = _8ad7eC2o;
        "pkg-neoforge-1.21.5-2.3" = _ARxmbnF1;
        "pkg-fabric-1.21.6-2.3" = _XqrGoxCt;
        "pkg-forge-1.21.6-2.3" = _8X4D6AHm;
        "pkg-neoforge-1.21.6-2.3" = _gn76CXs3;
        "pkg-fabric-1.21.7-2.3" = _SCooQlro;
        "pkg-forge-1.21.7-2.3" = _8h7eBLv3;
        "pkg-neoforge-1.21.7-2.3" = _ywUc4Qvq;
        "pkg-fabric-1.21.7-2.4" = _VNlIocsP;
        "pkg-forge-1.21.7-2.4" = _hhPVMniU;
        "pkg-neoforge-1.21.7-2.4" = _PRoxiLi6;
        "pkg-fabric-1.21.8-2.4" = _mtfsubLB;
        "pkg-forge-1.21.8-2.4" = _Xx5G3kHF;
        "pkg-neoforge-1.21.8-2.4" = _UHh7heW8;
        "pkg-fabric-1.21.9-2.4" = _8vYMtNKr;
        "pkg-forge-1.21.9-2.4" = _eVYZ7F4K;
        "pkg-neoforge-1.21.9-2.4" = _azInNk4F;
        "pkg-fabric-1.21.10-2.4" = _bCNK0U2M;
        "pkg-forge-1.21.10-2.4" = _rpKuilmn;
        "pkg-neoforge-1.21.10-2.4" = _xLnuOJG9;
        "pkg-fabric-1.21.11-2.4" = _y8DgTagN;
        "pkg-forge-1.21.11-2.4" = _y8WcvneB;
        "pkg-neoforge-1.21.11-2.4" = _rUmemd5j;
        "pkg-fabric-26.1.1-2.4" = _Dz2MZ6RU;
        "pkg-forge-26.1.1-2.4" = _TTH37JSA;
        "pkg-neoforge-26.1.1-2.4" = _Q1TA9Pp0;
        "pkg-fabric-26.1.2-2.4" = _OLDTb7NE;
        "pkg-forge-26.1.2-2.4" = _u0XVmGaR;
        "pkg-neoforge-26.1.2-2.4" = _zlZFGJkQ;
        "pkg-fabric-1.18.2-3" = _qXhPH9mA;
        "pkg-fabric-1.19.2-3" = _uSPaFrtY;
        "pkg-fabric-1.20.1-3" = _oXJs3CHZ;
        "pkg-fabric-1.21.1-3" = _v7JsvbWh;
        "pkg-fabric-26.1.2-3" = _qQQbXy8G;
        "pkg-fabric-26.2-3" = _NwheeI3B;
        "pkg-forge-1.18.2-3" = _utyraG6n;
        "pkg-forge-1.19.2-3" = _D1k8QUK3;
        "pkg-forge-1.20.1-3" = _vCj26cfD;
        "pkg-forge-1.21.1-3" = _2jQHjtnH;
        "pkg-forge-26.1.2-3" = _ffnmVCP5;
        "pkg-forge-26.2-3" = _gPTWD9Qi;
        "pkg-neoforge-1.21.1-3" = _eub7s6gG;
        "pkg-neoforge-26.1.2-3" = _5V3nceUf;
        "pkg-neoforge-26.2-3" = _gYrt7mFC;
        "default" = _gYrt7mFC;
    });
