...
let
    ...
    in {
        ...
        "pkg-1.1.5" = _PvTPs5y8;
        "pkg-2.0.0b7" = _qY4pe4tI;
        "pkg-2.0.0b8" = _S2k253jU;
        "pkg-2.0.0b9" = _pI6UZ6j1;
        "pkg-2.0.0b10" = _b5HCWQYt;
        "pkg-2.0.0b11" = _2I00OrPF;
        "pkg-2.0.0b12" = _weBqYmDH;
        "pkg-2.0.0b13" = _Bx0sCNaK;
        "pkg-2.0.0b14" = _1IdvtbAl;
        "pkg-2.0.0b15" = _pGPJOdNv;
        "pkg-2.0.0b16" = _bQAORua8;
        "pkg-2.0.0b17" = _YCO4FY6N;
        "pkg-2.0.0b18" = _v57ZmIs7;
        "pkg-2.0.0b19" = _gfoe77j5;
        "pkg-2.0.0b20" = _ivaxHKAs;
        "pkg-2.0.0b22" = _Dfy3Xd0e;
        "pkg-2.0.0b23" = _Ljq3Qh0y;
        "pkg-2.0.0b24" = _Wcxab1j8;
        "pkg-2.0.0b25" = _dK8TzPGm;
        "pkg-2.0.0b26" = _ksxRMdLK;
        "pkg-2.0.0b28" = _Hah89xlS;
        "pkg-2.0.0b29" = _8DhPJERr;
