...
let
    versions = (let
        ...
        _GsJirB1v = {
            "id" = "GsJirB1v";
            "file" = "MoreChiseledBookshelfVariants-1.8.1+1.21.4(-11)-Fabric.jar";
            "hash" = "sha512-JCK8J/VehPjQAIiJIjs2ziKPn3y+LeulOB73c/a3VAIuYXw/aL4HwyURnx9Mv9LbwEPOMuqE0zBNGsPCipCy/w==";
        };
        _IQtQPiON = {
            "id" = "IQtQPiON";
            "file" = "MoreChiseledBookshelfVariants-1.8.1+26.1(2)-Fabric.jar";
            "hash" = "sha512-QgwNmFOK9PWdVn14WquWYNuK8N+scZ1DYPdXRpjbS/GO7N40hxQs79ptXXZXxyuuTHb2FgXWiPzXaaFxrwDCNQ==";
        };
        _Wk8JJ9fU = {
            "id" = "Wk8JJ9fU";
            "file" = "MoreChiseledBookshelfVariants-1.8.1+26.3-Fabric.jar";
            "hash" = "sha512-MIbrvhEXwEQ9fhfDBEIKBvWlxdj2WCYY4+lHz/i4Os0c/6RXI0hqpT6sIfN9BfnuaKmhcrwCCGj/GKjaoQnCeA==";
        };
    in {
        "GGecVY7m" = _GGecVY7m;
        "esCEmw08" = _esCEmw08;
        ...
        "fabric-1.21.4" = _GsJirB1v;
        "fabric-1.21.5" = _GsJirB1v;
        "fabric-1.21.6" = _GsJirB1v;
        "fabric-1.21.7" = _GsJirB1v;
        "fabric-1.21.8" = _GsJirB1v;
        "fabric-1.21.9" = _GsJirB1v;
        "fabric-1.21.10" = _GsJirB1v;
        "fabric-1.21.11" = _GsJirB1v;
        "fabric-1.21.1-rc1" = _VrZanJCt;
        "fabric-25w02a" = _GsJirB1v;
        "fabric-25w03a" = _GsJirB1v;
        "fabric-25w04a" = _GsJirB1v;
        "fabric-25w05a" = _GsJirB1v;
        "fabric-25w06a" = _GsJirB1v;
        "fabric-25w07a" = _GsJirB1v;
        "fabric-25w08a" = _GsJirB1v;
        "fabric-25w09a" = _GsJirB1v;
        "fabric-25w09b" = _GsJirB1v;
        "fabric-25w10a" = _GsJirB1v;
        "fabric-1.21.5-pre1" = _GsJirB1v;
        "fabric-1.21.5-pre2" = _GsJirB1v;
        "fabric-1.21.5-pre3" = _GsJirB1v;
        "fabric-1.21.5-rc1" = _GsJirB1v;
        "fabric-1.21.5-rc2" = _GsJirB1v;
        "fabric-25w14craftmine" = _GsJirB1v;
        "fabric-25w15a" = _GsJirB1v;
        "fabric-25w16a" = _GsJirB1v;
        "fabric-25w17a" = _GsJirB1v;
        "fabric-25w18a" = _GsJirB1v;
        "fabric-25w19a" = _GsJirB1v;
        "fabric-25w20a" = _GsJirB1v;
        "fabric-25w21a" = _GsJirB1v;
        "fabric-1.21.6-pre1" = _GsJirB1v;
        "fabric-1.21.6-pre2" = _GsJirB1v;
        "fabric-1.21.6-pre3" = _GsJirB1v;
        "fabric-1.21.6-pre4" = _GsJirB1v;
        "fabric-1.21.6-rc1" = _GsJirB1v;
        "fabric-1.21.7-rc1" = _GsJirB1v;
        "fabric-1.21.7-rc2" = _GsJirB1v;
        "fabric-1.21.8-rc1" = _GsJirB1v;
        "fabric-25w31a" = _GsJirB1v;
        "fabric-25w32a" = _GsJirB1v;
        "fabric-25w33a" = _GsJirB1v;
        "fabric-25w34a" = _GsJirB1v;
        "fabric-25w34b" = _GsJirB1v;
        "fabric-25w35a" = _GsJirB1v;
        "fabric-25w36a" = _GsJirB1v;
        "fabric-25w36b" = _GsJirB1v;
        "fabric-25w37a" = _GsJirB1v;
        "fabric-1.21.9-pre1" = _GsJirB1v;
        "fabric-1.21.9-pre2" = _GsJirB1v;
        "fabric-1.21.9-pre3" = _GsJirB1v;
        "fabric-1.21.9-pre4" = _GsJirB1v;
        "fabric-1.21.9-rc1" = _GsJirB1v;
        "fabric-1.21.10-rc1" = _GsJirB1v;
        "fabric-25w41a" = _GsJirB1v;
        "fabric-25w42a" = _GsJirB1v;
        "fabric-25w43a" = _GsJirB1v;
        "fabric-25w44a" = _GsJirB1v;
        "fabric-25w45a" = _GsJirB1v;
        "fabric-25w46a" = _GsJirB1v;
        "fabric-1.21.11-pre1" = _GsJirB1v;
        "fabric-1.21.11-pre2" = _GsJirB1v;
        "fabric-1.21.11-pre3" = _GsJirB1v;
        "fabric-1.21.11-pre4" = _GsJirB1v;
        "fabric-1.21.11-pre5" = _GsJirB1v;
        "fabric-1.21.11-rc1" = _GsJirB1v;
        "fabric-1.21.11-rc2" = _GsJirB1v;
        "fabric-1.21.11-rc3" = _GsJirB1v;
        "fabric-26.1" = _IQtQPiON;
        "fabric-26.1.1" = _IQtQPiON;
        "fabric-26.1.2" = _IQtQPiON;
        "fabric-26.2" = _IQtQPiON;
        "fabric-26.3-snapshot-5" = _IuU32M4k;
        "fabric-26.3-snapshot-8" = _Wk8JJ9fU;
        "pkg-1.5.3" = _m7y9jGfs;
        "pkg-1.5.4" = _xWhWq8dl;
        "pkg-1.5.5" = _nIUb3omS;
        "pkg-1.6.0" = _fKCFxB5M;
