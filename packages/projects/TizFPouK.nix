...
let
    versions = (let
        ...
        _uiq4x4DD = {
            "id" = "uiq4x4DD";
            "file" = "CustomNameTags-1.5.1+26.2.jar";
            "hash" = "sha512-ZXfsC9V1aff3EvfCHQvOOuxlr45clChr2HuHHOyV/tEdpW5W0UXxMsv/prkO6zKnm1uGf6osUFMCLPJaiBz3pQ==";
        };
        _c0oULd8i = {
            "id" = "c0oULd8i";
            "file" = "CustomNameTags-1.5.2+26.2.jar";
            "hash" = "sha512-v90nbDxwN7/aC4Rue6oQKF3tJq+6c9uvGwW44DQj5SEDNmjh+Mlkf4FLAx+JPlIfBjgRBhYcrkyUwiop5CLJqw==";
        };
        _zKfQUMpj = {
            "id" = "zKfQUMpj";
            "file" = "CustomNameTags-2.0.0-beta.1+26.2.jar";
            "hash" = "sha512-8E9ZTOklKfnrAtPG/bR0hadaDdeZyB/LxNn00vD/XnMe5Zfkc0v8V90GxogxshhnvtQIY5wt0M2HMuBeHnPWQg==";
        };
        _IeCVVCPA = {
            "id" = "IeCVVCPA";
            "file" = "CustomNameTags-2.0.0+26.3.jar";
            "hash" = "sha512-gwDFb01pMoY6yjPlDWBErCfwQ5Uf7gMfK141zrV+Akosmrxv/GjSAom4cxnX6xaMsKyyifCa1Bn6W/Q16uwkaw==";
        };
    in {
        "LFeqaaA4" = _LFeqaaA4;
        "tEEhbdME" = _tEEhbdME;
        ...
        "fabric-26.2" = _zKfQUMpj;
        "fabric-26.3" = _IeCVVCPA;
        "pkg-0.1.0" = _LFeqaaA4;
        "pkg-0.1.1" = _tEEhbdME;
        "pkg-0.1.2" = _C5Ka9psn;
        "pkg-0.1.4" = _G8DXQ77C;
        "pkg-0.2.1" = _oHGw8W9a;
        "pkg-0.2.1+mc1.20.5" = _BaW8wQLv;
        "pkg-0.2.3+mc1.21" = _vuKz3L2C;
        "pkg-0.3.0+1.21.3" = _NrZ66do7;
        "pkg-0.3.1+1.21.4" = _rYhW3yd4;
        "pkg-0.3.3+1.21.4" = _IyKkE51L;
        "pkg-0.3.4+1.21.4" = _P1hHSVl9;
        "pkg-0.3.4+1.21.3" = _qLa1J4Pi;
        "pkg-0.3.4+1.21.1" = _SKiV1pKf;
        "pkg-0.3.6+1.21.4" = _DQWXzGQ2;
        "pkg-0.3.7+1.21.4" = _97Qqc7Rb;
        "pkg-0.4.0+1.21.4" = _7CcL65wZ;
        "pkg-0.4.3+1.21.5" = _aFnsH44s;
        "pkg-1.0.0+1.21.6" = _N0bxmVIt;
        "pkg-1.0.1+1.21.6" = _d8vtIPip;
        "pkg-1.0.2+1.21.8" = _BAcw45hN;
        "pkg-0.3.6+1.21.1" = _x6v5IUs6;
        "pkg-1.1.0+1.21.9" = _yhpp0SLa;
        "pkg-1.1.1+1.21.9" = _wfzeFsim;
        "pkg-1.2.0+1.21.11" = _ckoKgbSK;
        "pkg-1.2.2+1.21.11" = _LN5T5Vtv;
        "pkg-1.3.0+26.1" = _GLvEAwko;
        "pkg-1.3.1+26.1" = _Np9SyVot;
        "pkg-1.3.2+26.1" = _lKcuWaok;
        "pkg-1.3.3+26.1" = _2qq4xOjf;
        "pkg-1.4.0+26.2" = _thKPDjR8;
        "pkg-1.5.0+26.2" = _TtmTcDEi;
        "pkg-1.5.1+26.2" = _uiq4x4DD;
        "pkg-1.5.2+26.2" = _c0oULd8i;
        "pkg-2.0.0-beta.1+26.2" = _zKfQUMpj;
        "pkg-2.0.0+26.3" = _IeCVVCPA;
        "default" = _IeCVVCPA;
    });
