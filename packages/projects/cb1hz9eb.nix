...
let
    ...
    in {
        ...
        "pkg-1.1" = _jxXq7EUX;
        "pkg-1.1.1+mod" = _llWXBzKo;
        "pkg-1.2" = _FXX7kbk5;
        "pkg-1.2.1+mod" = _aSrfhwkf;
        "pkg-1.3" = _AoNgks0F;
        "pkg-1.3.1+mod" = _hsxiTj0K;
        "pkg-1.4" = _hwGjTzBc;
        "pkg-1.4.1+mod" = _V8rYYcfk;
        "pkg-1.5" = _QZpcVkSH;
        "pkg-1.5.1+mod" = _pH7qPgIC;
        "pkg-1.6" = _1Sj4lyq6;
        "pkg-1.6.1+mod" = _5Ky1Vj3Y;
        "pkg-1.7" = _hVDTATPu;
        "pkg-1.7.1+mod" = _aId4SYkZ;
        "pkg-1.8" = _epr3zVdx;
        "pkg-1.8.1+mod" = _lxX3DSDl;
        "pkg-1.9" = _bZuGAwQX;
