...
let
    ...
    in {
        ...
        "pkg-1.19.2-2.0.3-BETA" = _hjxxo1Zv;
        "pkg-1.19.2-2.0.4-BETA" = _UI9PFRy5;
        "pkg-1.19.2-2.0.5-BETA" = _Aw3I2Cb8;
        "pkg-1.19.2-2.0.6-BETA" = _Jhgntim5;
        "pkg-1.19.2-2.0.7-BETA" = _leVy8Ezy;
        "pkg-1.19.2-2.0.8-BETA" = _bczt8Tx6;
        "pkg-1.19.2-2.0.9-BETA" = _YgmztjBK;
        "pkg-1.19.2-2.0.10-BETA" = _tWlULqTK;
        "pkg-1.19.2-2.0.11-BETA" = _JgIPXOQs;
        "pkg-1.19.2-2.0.12-BETA" = _sVxUkmTt;
        "pkg-1.19.2-2.0.13-BETA" = _FEqpaGui;
        "pkg-1.19.2-2.0.14-BETA" = _63Wisd7u;
        "pkg-1.19.2-2.0.15-BETA" = _cUsKOSNx;
        "pkg-1.19.2-2.0.16-BETA" = _aPwLXNGa;
        "pkg-1.19.2-2.0.17-BETA" = _HJEizmmA;
        "pkg-1.19.2-2.0.18-BETA" = _OQrzO2KZ;
        "pkg-1.19.2-2.1.0-BETA" = _eUeMUsXM;
        "pkg-1.19.2-2.2.0-BETA" = _bXgHd6df;
        "pkg-1.19.2-2.3.0-BETA" = _cYWLCfFH;
        "pkg-1.19.2-2.4.0-BETA" = _2xKRdlK3;
        "pkg-1.19.2-2.5.0-BETA" = _jnpG1wEW;
        "pkg-1.19.2-2.6.0-BETA" = _Iu0iFHtL;
        "pkg-1.19.2-2.6.1-BETA" = _cJbv88Li;
        "pkg-1.19.2-2.6.2-BETA" = _dPhSihNi;
        "pkg-1.19.2-2.7.0-BETA" = _D33I0EAM;
        "pkg-1.19.2-2.8.0-BETA" = _dfNU7VTK;
        "pkg-1.19.2-2.9.0-BETA" = _nRRFJ9x3;
        "pkg-1.19.2-2.10.0-BETA" = _nmf9uSr1;
        "pkg-1.18.2-2.10.0-BETA" = _Bk4RRon3;
        "pkg-1.19.2-2.11.0-BETA" = _NAhFNu0N;
        "pkg-1.18.2-2.11.0-BETA" = _jlCS5XQ3;
        "pkg-1.19.2-2.12.0" = _QAsvtgtX;
        "pkg-1.18.2-2.12.0" = _VWrQ4NSc;
        "pkg-1.20.1-2.12.0" = _rSjfFWua;
        "pkg-1.20.1-2.12.1" = _GqSaQhJJ;
        "pkg-1.19.2-2.12.1" = _wP9n0H1x;
        "pkg-1.18.2-2.12.1" = _DhBmEzVP;
        "pkg-1.18.2-2.12.2" = _6vEVOXCl;
        "pkg-1.19.2-2.12.2" = _jvvSdVD7;
        "pkg-1.20.1-2.12.2" = _AH2xblIh;
        "pkg-1.18.2-2.12.3" = _zPnsYjtR;
        "pkg-1.19.2-2.12.3" = _3ERXUOiE;
        "pkg-1.20.1-2.12.3" = _MgaV7GoF;
        "pkg-1.20.1-2.12.4" = _hQ7ZaT7W;
        "pkg-1.18.2-2.13.0" = _7b35GStg;
        "pkg-1.19.2-2.13.0" = _s5uN3n5j;
        "pkg-1.20.1-2.13.0" = _FxMpqD84;
        "pkg-1.20.1-2.13.1" = _nFOmOJaQ;
        "pkg-1.18.2-2.14.0" = _dpiAznZh;
        "pkg-1.19.2-2.14.0" = _cxyXTS04;
        "pkg-1.20.1-2.14.0" = _VNJ5Knxa;
        "pkg-1.18.2-2.15.0" = _BXYEnaS0;
        "pkg-1.19.2-2.15.0" = _pkk7oPtp;
        "pkg-1.20.1-2.15.0" = _G4qLFLaw;
        "pkg-1.20.2-2.15.1" = _IEMItJnK;
        "pkg-1.18.2-2.15.1" = _OcC7zEJJ;
        "pkg-1.19.2-2.15.1" = _3kl9lQed;
        "pkg-1.20.1-2.15.1" = _hcGcBFAZ;
        "pkg-1.18.2-2.16.0" = _44z9tKFt;
        "pkg-1.19.2-2.16.0" = _DGxsXIVp;
        "pkg-1.20.1-2.16.0" = _ufkAsVao;
        "pkg-1.21.1-2.16.1" = _LZOR7TOT;
