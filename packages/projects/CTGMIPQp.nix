...
let
    ...
    in {
        ...
        "iaf1JEnX" = _iaf1JEnX;
        "EsgE3REf" = _EsgE3REf;
        "minecraft-1.21" = _EsgE3REf;
        "minecraft-1.21.1" = _EsgE3REf;
        "minecraft-1.21.2" = _EsgE3REf;
        "minecraft-1.21.3" = _EsgE3REf;
        "minecraft-1.21.4" = _EsgE3REf;
        "minecraft-1.21.5" = _EsgE3REf;
        "minecraft-1.21.6" = _EsgE3REf;
        "minecraft-1.21.7" = _EsgE3REf;
        "minecraft-1.21.8" = _EsgE3REf;
        "minecraft-1.21.9" = _EsgE3REf;
        "minecraft-1.21.10" = _EsgE3REf;
        "minecraft-1.19.4" = _EsgE3REf;
        "minecraft-1.20" = _EsgE3REf;
        "minecraft-1.20.1" = _EsgE3REf;
        "minecraft-1.20.2" = _EsgE3REf;
        "minecraft-1.20.3" = _EsgE3REf;
        "minecraft-1.20.4" = _EsgE3REf;
        "minecraft-1.20.5" = _EsgE3REf;
        "minecraft-1.20.6" = _EsgE3REf;
        "minecraft-1.21.11" = _EsgE3REf;
        ...
        "minecraft-26.1" = _EsgE3REf;
        "minecraft-26.1.1" = _EsgE3REf;
        "minecraft-26.1.2" = _EsgE3REf;
        "minecraft-26.2" = _EsgE3REf;
