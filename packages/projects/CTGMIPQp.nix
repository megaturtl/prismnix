...
let
    versions = (let
        ...
        _FRsOQii3 = {
            "id" = "FRsOQii3";
            "file" = "Forager.zip";
            "hash" = "sha512-2P9PTzsq4+2M9b0FsgF8jzZUtI73PPTtuBQV1Y9OgvXI+LzwzLdVxLw49Yw0mNzxR81q2j2iXlRwyAuDMi+U+g==";
        };
        _iaf1JEnX = {
            "id" = "iaf1JEnX";
            "file" = "Forager.zip";
            "hash" = "sha512-UJqtSQHgo5yN0WihESD0NOx65ERVy80wh5V7qb7Fs6T/Erhf1iZvjyYr5PXgWo6+OClLMxUnqKE9bolZjfQBnA==";
        };
        _EsgE3REf = {
            "id" = "EsgE3REf";
            "file" = "Forager.zip";
            "hash" = "sha512-bt6qw0tO4UtLU/uIFETW9Srpx7WhLEwkBcAsIIlrh56xajXTvevESDNzUrAPR34MLT7uZ5FFya6mSuAtWOTUTA==";
        };
        _oLbWjhc2 = {
            "id" = "oLbWjhc2";
            "file" = "Forager.zip";
            "hash" = "sha512-TQeb9aoQPS1/UtR2x2RukH7Q00iDa3TVMqZhqBu40Vhc9RoLmKSJGV38AYChhxbK+yTIMlZuXnRBXsIPNmkuJQ==";
        };
    in {
        "hgkXXMRY" = _hgkXXMRY;
        "LJGXFrrs" = _LJGXFrrs;
        ...
        "EsgE3REf" = _EsgE3REf;
        "oLbWjhc2" = _oLbWjhc2;
        "minecraft-1.21" = _oLbWjhc2;
        "minecraft-1.21.1" = _oLbWjhc2;
        "minecraft-1.21.2" = _oLbWjhc2;
        "minecraft-1.21.3" = _oLbWjhc2;
        "minecraft-1.21.4" = _oLbWjhc2;
        "minecraft-1.21.5" = _oLbWjhc2;
        "minecraft-1.21.6" = _oLbWjhc2;
        "minecraft-1.21.7" = _oLbWjhc2;
        "minecraft-1.21.8" = _oLbWjhc2;
        "minecraft-1.21.9" = _oLbWjhc2;
        "minecraft-1.21.10" = _oLbWjhc2;
        "minecraft-1.19.4" = _oLbWjhc2;
        "minecraft-1.20" = _oLbWjhc2;
        "minecraft-1.20.1" = _oLbWjhc2;
        "minecraft-1.20.2" = _oLbWjhc2;
        "minecraft-1.20.3" = _oLbWjhc2;
        "minecraft-1.20.4" = _oLbWjhc2;
        "minecraft-1.20.5" = _oLbWjhc2;
        "minecraft-1.20.6" = _oLbWjhc2;
        "minecraft-1.21.11" = _oLbWjhc2;
        ...
        "minecraft-26.1" = _oLbWjhc2;
        "minecraft-26.1.1" = _oLbWjhc2;
        "minecraft-26.1.2" = _oLbWjhc2;
        "minecraft-26.2" = _oLbWjhc2;
        "minecraft-26.3-pre-1" = _EsgE3REf;
        "minecraft-26.3-pre-2" = _EsgE3REf;
        "minecraft-26.3" = _oLbWjhc2;
        "pkg-1.0" = _hgkXXMRY;
        "pkg-2.0" = _LJGXFrrs;
        "pkg-3.0" = _K0YPIqkZ;
        "pkg-4.0" = _yP0Kpyh9;
