...
let
    versions = (let
        ...
        _eL2Qz0HE = {
            "id" = "eL2Qz0HE";
            "file" = "FancyDialogs-1.3.0+56.jar";
            "hash" = "sha512-wV90Zlhax6tBC/M7s1idAaaH41H01zxysS8roWdRJwY2UbYWNWZCT6ldUQDSmDKuNAMJCppm+BjzAWlQ1vqVuw==";
        };
        _Gcis9ccs = {
            "id" = "Gcis9ccs";
            "file" = "FancyDialogs-1.4.0.jar";
            "hash" = "sha512-xYJN1dKUfcJqNsos7kHjVIGplZT2vEUaZ7VFEZS7wmPtWsdcQ7o/lViZJbgg+O+0Vru8NRy7ZbalVbGgrSesJQ==";
        };
    in {
        "gBtV4C5g" = _gBtV4C5g;
        "vvbHJjMj" = _vvbHJjMj;
        ...
        "eL2Qz0HE" = _eL2Qz0HE;
        "Gcis9ccs" = _Gcis9ccs;
        "paper-1.21.6" = _Gcis9ccs;
        "paper-1.21.7" = _Gcis9ccs;
        "paper-1.21.8" = _Gcis9ccs;
        "paper-1.21.9" = _Gcis9ccs;
        "paper-1.21.10" = _Gcis9ccs;
        ...
        "paper-1.21.11" = _Gcis9ccs;
        "paper-26.1" = _TgVqF0y1;
        "paper-26.1.1" = _gsD2CW0n;
        "paper-26.1.2" = _Gcis9ccs;
        "paper-26.2" = _Gcis9ccs;
        "paper-26.3" = _Gcis9ccs;
        "folia-1.21.6" = _Gcis9ccs;
        "folia-1.21.7" = _Gcis9ccs;
        "folia-1.21.8" = _Gcis9ccs;
        "folia-1.21.9" = _Gcis9ccs;
        "folia-1.21.10" = _Gcis9ccs;
        ...
        "folia-1.21.11" = _Gcis9ccs;
        "folia-26.1.1" = _gsD2CW0n;
        "folia-26.1.2" = _Gcis9ccs;
        "folia-26.2" = _Gcis9ccs;
        "folia-26.3" = _Gcis9ccs;
        "pkg-0.0.1" = _gBtV4C5g;
        "pkg-0.0.2" = _vvbHJjMj;
        "pkg-0.0.3" = _mYzEcg3V;
        "pkg-0.0.4" = _nQiyXyTi;
        ...
        "pkg-0.0.8" = _FtMvxij9;
        "pkg-0.0.9" = _zx9W39SC;
        "pkg-0.0.10" = _lkLhtwi6;
        "pkg-0.0.11" = _bn05tppa;
        "pkg-0.0.12" = _AbAq6THE;
        "pkg-0.0.13" = _JSgTPTdu;
        "pkg-0.0.14" = _8fzSeIiU;
        "pkg-0.0.15" = _rxy443xB;
        "pkg-0.0.16" = _lOnO5p4D;
        "pkg-0.0.17" = _G8BV3TV9;
        "pkg-0.0.18" = _2vzWSMw9;
        "pkg-0.0.19" = _MDKnoT2D;
        "pkg-0.0.20" = _89cAehNg;
        "pkg-0.0.21" = _qLy6DFJ9;
        "pkg-0.0.22" = _B520C5C4;
        "pkg-0.0.23" = _I830PSYY;
        "pkg-0.0.24" = _NOP6n92B;
        "pkg-0.0.25" = _pK4TxpEm;
        "pkg-0.0.26" = _KSAzvOKz;
        "pkg-0.0.27" = _vbJ3nJce;
        "pkg-0.0.28" = _th1WSt9E;
        "pkg-0.0.29" = _4flMirlu;
        "pkg-0.0.30" = _PR1mUgba;
        "pkg-0.0.31" = _TeazUSBf;
        "pkg-0.0.32" = _7x4fHZ2I;
        "pkg-1.0.0" = _CEiTonX4;
        "pkg-1.0.1" = _1q5YVRRf;
        "pkg-1.0.1.33" = _coB3y2nz;
        "pkg-1.0.1.34" = _InSHsS6O;
        "pkg-1.0.1.35" = _yPW7p5uO;
        "pkg-1.0.1.36" = _RaSdgTYa;
        "pkg-1.0.1.37" = _9hdiPuqZ;
        "pkg-1.0.1.38" = _kVRHJfe7;
        "pkg-1.0.1.39" = _SVOo9VXg;
        "pkg-1.1.0" = _HCinGthM;
        "pkg-1.1.0.40" = _tOFcIq3l;
        "pkg-1.1.0.41" = _QddeuKIU;
        "pkg-1.1.0.42" = _rEcewbGr;
        "pkg-1.1.0.43" = _dgPP6Ps9;
        "pkg-1.1.0.44" = _dByDOXk9;
        "pkg-1.1.1" = _qmpwghug;
        "pkg-1.1.1.45" = _gAW63F5y;
        "pkg-1.1.1.46" = _dA9WzsYb;
        "pkg-1.1.1.47" = _qmi5ddMt;
        "pkg-1.1.1.48" = _jqHqUfAT;
        "pkg-1.1.2" = _FDN3VGi4;
        "pkg-1.1.2.49" = _ujFm2Fs5;
        "pkg-1.1.2.50" = _YIXnovmD;
        "pkg-1.1.2.51" = _T6rUVzZY;
        "pkg-1.1.2.52" = _TgVqF0y1;
        "pkg-1.1.2.53" = _gsD2CW0n;
        "pkg-1.1.2.54" = _q4VtSJFj;
        "pkg-1.2.0" = _fTwN1dpM;
        "pkg-1.2.0.55" = _UAGF0ICq;
        "pkg-1.3.0" = _nBkggYSH;
        "pkg-1.3.0+56" = _eL2Qz0HE;
        "pkg-1.4.0" = _Gcis9ccs;
        "default" = _Gcis9ccs;
    });
