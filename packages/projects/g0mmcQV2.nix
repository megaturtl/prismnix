...
let
    versions = (let
        ...
        _2UuT1EBg = {
            "id" = "2UuT1EBg";
            "file" = "UndeadNights-2.2.2-Fabric-mc26.2.jar";
            "hash" = "sha512-wzzQl+oXrgslkyGhHln0XMVKjsu4w4EoA64fqV7AsUg7rRMkah+faCeCA0toRjA67jZLtgkE/yg/mhmvRpbhqQ==";
        };
        _77uqE9Qc = {
            "id" = "77uqE9Qc";
            "file" = "UndeadNights-2.2.2-Fabric-mc26.1.jar";
            "hash" = "sha512-uo4WY+NI/jbM5fSyhjRLSYXZkHenTiTUFyri8KfFDo4dlmX2RlIxjeckCXRJJSRmlYTjyKyuu24neaQANBDgSQ==";
        };
        _8hbb74lT = {
            "id" = "8hbb74lT";
            "file" = "UndeadNights-2.2.3-NeoForge-mc1.21.jar";
            "hash" = "sha512-yoL9q83luW0iiNF07fLPrLizxYujRPOlx2Mm9GuGSH9Wc3AiXZEeIw59mcvMHVhC2WSfrOBpZ+EEK3g1uOOrNg==";
        };
        _pu09IVLQ = {
            "id" = "pu09IVLQ";
            "file" = "UndeadNights-2.2.4-Fabric-mc26.1.jar";
            "hash" = "sha512-znuoqSQppV3nBTpm+VGSd/R00aJ4pHT2NMJo8mwo3oqwgL6DyntD77bKdfsyBgI0euE3hZfBVT8aQjulCpGuqw==";
        };
        _SVU0JYwz = {
            "id" = "SVU0JYwz";
            "file" = "UndeadNights-2.2.4-Fabric-mc26.2.jar";
            "hash" = "sha512-m8UAkmBnqavt/5RFkVlzGLe8W9F1pK4Z7h0pvie7UkrR8gFhiLDCZe9zyDTeAhvjAR0oY8wVdgGGCoBycbyiIA==";
        };
        _PLYcr4Bu = {
            "id" = "PLYcr4Bu";
            "file" = "UndeadNights-2.2.4-NeoForge-mc1.21.jar";
            "hash" = "sha512-Uc+gDr2IcuOSIGrEmeYeitKmTt/hxsz13xw0hnfK6WXcy7mixeglNT+zGuErFvmCyRSlQYdySHKkqZAu4JNsOg==";
        };
        _FgfIMMU7 = {
            "id" = "FgfIMMU7";
            "file" = "UndeadNights-2.2.5-NeoForge-mc1.21.jar";
            "hash" = "sha512-MWJG179AF9C3dSM7pqpd3pIC0g8Piu3ilW9qJk/5OnV/QgCDh5mjUu7OfPd8cdKKcxQ0+n5RQVJTNhdGoBrhuw==";
        };
        _EhUBfDxJ = {
            "id" = "EhUBfDxJ";
            "file" = "UndeadNights-2.2.5-Fabric-mc26.1.jar";
            "hash" = "sha512-DoOz0OuKXNLbeUXin0bKW2BWvdGM2Bw+cBenYz/1KbFR8gJfF8lNro9q1KWSHVUlXXdN/RnTgaJJ4gV7TJfSQQ==";
        };
        _XcAQG78h = {
            "id" = "XcAQG78h";
            "file" = "UndeadNights-2.2.5-Fabric-mc26.2.jar";
            "hash" = "sha512-sXHTW0Te++fb1nNvhXLYm/Ohq+h+wBwsDtgw5MEdM+JxCcI+Or1uAPiHZSrd7bjVbbzac3TK3KLnnNYgXkyKQg==";
        };
        _a0Lh4LC0 = {
            "id" = "a0Lh4LC0";
            "file" = "UndeadNights-2.2.5-NeoForge-mc26.1.jar";
            "hash" = "sha512-mBthx0BClV4rCQmIQQ3ztGawU1y/pAm7MXmfjN2kQ2q5OtcbEUpb8+g5OL/sdf9XMM5pLA3s7vIoKw+ltavgkg==";
        };
        _dUVxg7wz = {
            "id" = "dUVxg7wz";
            "file" = "UndeadNights-2.2.5-NeoForge-mc26.2.jar";
            "hash" = "sha512-xtj71K3uOSV+OilAD7msEFWYs6/AP6EwV1NQGyhEfHUYa4U26L8xfkgMT2BkHPn8uiL61v+3L+msYqCC9o79iQ==";
        };
        _38iilX2y = {
            "id" = "38iilX2y";
            "file" = "UndeadNights-2.2.5-Forge-mc26.1.jar";
            "hash" = "sha512-q5haYirzki+tBkX0RwNcS6mEL1cu1UXkTYhfnQKXt0eTsT1yD8BepVSFicDGA0ZotF363e1yGY6JxlLUtPi/bA==";
        };
        _aGFoacXC = {
            "id" = "aGFoacXC";
            "file" = "UndeadNights-2.2.5-Forge-mc26.2.jar";
            "hash" = "sha512-nmRCzbrPD0sLOFnOSCYsvPUKzq/SkUua5++uxUPw6pHPCEoshsuBTGx/kDOHzixEL3NFTxwqWNVNslNj0xhUfw==";
        };
        _EMzeC0pU = {
            "id" = "EMzeC0pU";
    ...
    in {
        ...
        "pkg-0.8.2-Fabric-mc1.21.3" = _r18GX7mO;
        "pkg-0.8.4-Fabric-mc1.20.1" = _cRjhmI0J;
        "pkg-0.8.4-Fabric-mc1.20.4" = _mtgWCegW;
        "pkg-0.8.5-Fabric-mc1.20.1" = _OuddRnDn;
        "pkg-0.8.5-Fabric-mc1.20.4" = _OSRbDOhI;
        "pkg-0.8.5-Fabric-mc1.21" = _YnaWZ2Nb;
        "pkg-0.8.5-Fabric-mc1.21.3" = _V2YhF31z;
        "pkg-0.9.0-Fabric-mc1.20.1" = _IhbvcUbC;
        "pkg-0.9.0-Fabric-mc1.20.4" = _Txtc9uvI;
        "pkg-0.9.0-Fabric-mc1.21" = _aFkh9lCQ;
        "pkg-0.9.0-Fabric-mc1.21.3" = _N8wcIXUm;
        "pkg-0.9.1-Fabric-mc1.20.1" = _ag0J9CZ7;
        "pkg-0.9.2-Forge-mc1.20.1" = _BzqF2l46;
        "pkg-0.9.3-Forge-mc1.20.1" = _rUIlyQFw;
        "pkg-0.9.3-Fabric-mc1.20.1" = _f3YSHedS;
        "pkg-0.9.3-Fabric-mc1.20.4" = _GQNF0sxc;
        "pkg-0.9.3-Fabric-mc1.21" = _lmvs0IvX;
        "pkg-0.9.3-Fabric-mc1.21.3" = _ocXQ1Kg2;
        "pkg-0.9.3-NeoForge-mc1.21" = _UE1nSKLB;
        "pkg-0.9.4-NeoForge-mc1.21.3" = _vvrBYUOn;
        "pkg-0.9.5-Fabric-mc1.20.1" = _ReEoeVfb;
        "pkg-0.9.5-Fabric-mc1.20.4" = _F5RStaQy;
        "pkg-0.9.5-Fabric-mc1.21" = _x2RSvTcj;
        "pkg-0.9.5-Fabric-mc1.21.3" = _aDTiNGUp;
        "pkg-0.9.5-Forge-mc1.20.1" = _Iz68EONW;
        "pkg-0.9.5-NeoForge-mc1.21" = _4402tNJj;
        "pkg-0.9.5-NeoForge-mc1.21.3" = _HJkaW3ZY;
        "pkg-0.9.5-Forge-mc1.19.2" = _Y4aGmTBc;
        "pkg-0.9.5-Forge-mc1.18.2" = _H6fDRoqH;
        "pkg-0.9.5-Forge-mc1.21" = _BkY8ausB;
        "pkg-0.9.5-Forge-mc1.21.3" = _XjYKl4Jz;
        "pkg-1.0.0-beta1-Forge-mc1.20.1" = _UgQVGF2x;
        "pkg-1.0.0-beta2-Forge-mc1.20.1" = _YOUWREuL;
        "pkg-1.0.0-beta2-Forge-mc1.21" = _uGgHArUa;
        "pkg-1.0.0-beta2-Forge-mc1.21.3" = _pqReQZLj;
        "pkg-1.0.0-beta3-NeoForge-mc1.21" = _zuqeNsWY;
        "pkg-1.0.0-beta3-NeoForge-mc1.21.3" = _2QnT58Gz;
        "pkg-1.0.1-beta1-Fabric-mc1.20.1" = _o4GRsbuS;
        "pkg-1.0.1-beta1-Fabric-mc1.20.4" = _r0BvEKGJ;
        "pkg-1.0.1-beta1-Fabric-mc1.21" = _dkM8SfXl;
        "pkg-1.0.1-beta2-Fabric-mc1.21.3" = _jT4MoUZu;
        "pkg-1.0.1-Fabric-mc1.18.2" = _GvyPTc4y;
        "pkg-1.0.1-Fabric-mc1.19.2" = _yqbOGbgY;
        "pkg-1.0.1-Fabric-mc1.20.1" = _vJTLBjb9;
        "pkg-1.0.1-Fabric-mc1.20.4" = _HCC3fQmC;
        "pkg-1.0.1-Fabric-mc1.21" = _atGNXbcf;
        "pkg-1.0.1-Fabric-mc1.21.3" = _zvFsXnfq;
        "pkg-1.0.1-NeoForge-mc1.21" = _aLPTOper;
        "pkg-1.0.1-NeoForge-mc1.21.3" = _oanucNuN;
        "pkg-1.0.1-Forge-mc1.18.2" = _fIxZmIoE;
        "pkg-1.0.1-Forge-mc1.19.2" = _XJrXt1W5;
        "pkg-1.0.1-Forge-mc1.20.1" = _U3QE6ARq;
        "pkg-1.0.1-Forge-mc1.21" = _gPfLVg89;
        "pkg-1.0.1-Forge-mc1.21.3" = _a3WnW8Z1;
        "pkg-1.1.0-Forge-mc1.20.1" = _rojthrUk;
        "pkg-1.1.0-Fabric-mc1.20.1" = _weomfw2e;
        "pkg-1.1.0-Fabric-mc1.20.4" = _jOzvnpHT;
        "pkg-1.1.0-Fabric-mc1.21" = _JRN81j0t;
        "pkg-1.1.0-Forge-mc1.21" = _K5ynK1pH;
        "pkg-1.1.0-NeoForge-mc1.21" = _RPMDbFZE;
        "pkg-1.1.0-Fabric-mc1.21.3" = _UhQWBbqd;
        "pkg-1.1.0-Forge-mc1.21.3" = _1NugKiVm;
        "pkg-1.1.0-NeoForge-mc1.21.3" = _XzDGtetL;
        "pkg-1.1.0-Fabric-mc1.21.4" = _bHEl53hA;
        "pkg-1.1.0-Forge-mc1.21.4" = _a4TujpLb;
        "pkg-1.1.0-NeoForge-mc1.21.4" = _xXdLNALn;
        "pkg-1.1.0-Fabric-mc1.19.2" = _4bhmqQ5a;
        "pkg-1.1.0-Forge-mc1.19.2" = _9T8KKHkU;
        "pkg-1.1.0-Fabric-mc1.18.2" = _MDoKLIBH;
        "pkg-1.1.0-Forge-mc1.18.2" = _opYdFRz9;
        "pkg-1.1.1-Fabric-mc1.21.5" = _NBI5oGwM;
        "pkg-1.1.0-NeoForge-mc1.21.5" = _lhKcKHTA;
        "pkg-1.1.0-Forge-mc1.21.5" = _yVqfJfCz;
        "pkg-1.1.1-Fabric-mc1.21.3" = _poEBELlB;
        "pkg-1.1.1-Fabric-mc1.21.4" = _vUK68Pdn;
        "pkg-1.1.2-Fabric-mc1.21.5" = _pkBpUdL4;
        "pkg-1.1.2-Fabric-mc1.21.4" = _NDvgFn4k;
        "pkg-1.1.2-Fabric-mc1.21.3" = _83zbD5y7;
        "pkg-1.1.2-Fabric-mc1.21" = _v5PGkvsa;
        "pkg-1.1.2-NeoForge-mc1.21.5" = _6TtBMWpX;
        "pkg-1.1.2-NeoForge-mc1.21.4" = _Uxh7Kr2Y;
        "pkg-1.1.2-NeoForge-mc1.21.3" = _3c93ejB4;
        "pkg-1.1.2-NeoForge-mc1.21" = _JF8Mn1qL;
        "pkg-1.1.2-Forge-mc1.21.5" = _i9jeAmZF;
        "pkg-1.1.2-Forge-mc1.21.4" = _QfXB17lh;
        "pkg-1.1.2-Forge-mc1.21.3" = _qnACaqLl;
        "pkg-1.1.2-Forge-mc1.21" = _X3KGiQbs;
        "pkg-1.2.0-beta1-Forge-mc1.20.1" = _waGOsztj;
        "pkg-1.2.0-beta2-Forge-mc1.20.1" = _ArS8nIF4;
        "pkg-1.2.0-beta2-Fabric-mc1.20.1" = _3fQMcEf9;
        "pkg-1.2.0-beta3-Fabric-mc1.20.1" = _XgcsO9Dl;
        "pkg-1.2.0-beta4-Fabric-mc1.20.1" = _xv2RJTJY;
        "pkg-1.2.0-beta4-Forge-mc1.20.1" = _ujzTWFSi;
        "pkg-1.2.0-beta5-Forge-mc1.20.1" = _ukxyWaTi;
        "pkg-1.2.0-beta5-Fabric-mc1.20.1" = _NNzESfrJ;
        "pkg-1.2.0-Forge-mc1.20.1" = _5O5RD2rg;
        "pkg-1.2.0-Fabric-mc1.20.1" = _NlnuRnaf;
        "pkg-1.2.0-Fabric-mc1.21" = _9vmvKRjA;
        "pkg-1.2.0-Forge-mc1.21" = _T4NDkyK9;
        "pkg-1.2.0-NeoForge-mc1.21" = _4FV8ruEI;
        "pkg-1.2.1-Fabric-mc1.21" = _aObyFBfW;
        "pkg-1.2.1-Forge-mc1.21" = _AQWwRv9g;
        "pkg-1.2.1-NeoForge-mc1.21" = _yHG0Dwdf;
        "pkg-1.2.1-Fabric-mc1.21.3" = _vi8totxU;
        "pkg-1.2.1-Fabric-mc1.21.4" = _1gaS2Fho;
        "pkg-1.2.1-Forge-mc1.21.3" = _AGM5Zx0E;
        "pkg-1.2.1-Forge-mc1.21.4" = _IYhUJMnr;
        "pkg-1.2.1-NeoForge-mc1.21.3" = _u2QrqVfE;
        "pkg-1.2.1-NeoForge-mc1.21.4" = _8RMm5Kvl;
        "pkg-1.2.1-Fabric-mc1.21.5" = _2wzblAC8;
        "pkg-1.2.1-Forge-mc1.21.5" = _Q3FCq3cj;
        "pkg-1.2.1-NeoForge-mc1.21.5" = _uW9weaYl;
        "pkg-1.2.1-Fabric-mc1.18.2" = _zQb7MVEe;
        "pkg-1.2.1-Fabric-mc1.19.2" = _bjCHpbF5;
        "pkg-1.2.2-Forge-mc1.18.2" = _bSwHQmd8;
        "pkg-1.2.2-Forge-mc1.19.2" = _SmraxqvI;
        "pkg-1.2.2-Forge-mc1.20.1" = _imLgaZ0z;
        "pkg-1.2.3-Forge-mc1.21.5" = _VlwL5gYf;
        "pkg-1.2.3-Fabric-mc1.18.2" = _Xn9yWTpq;
        "pkg-1.2.3-Fabric-mc1.19.2" = _AS7BRz9j;
        "pkg-1.2.3-Forge-mc1.18.2" = _rS7F21eG;
        "pkg-1.2.3-Forge-mc1.19.2" = _Mq3UBkWi;
        "pkg-1.2.3-Fabric-mc1.21.5" = _gtVOSPdO;
        "pkg-1.2.3-NeoForge-mc1.21.5" = _Cc5rSHfA;
        "pkg-1.2.3-Fabric-mc1.20.1" = _ODR5QpzH;
        "pkg-1.2.3-Forge-mc1.20.1" = _ZW0oIw8g;
        "pkg-1.2.3-Fabric-mc1.20.4" = _nduukKik;
        "pkg-1.2.3-Fabric-mc1.21" = _qfiCJfvK;
        "pkg-1.2.3-Forge-mc1.21" = _DixOeP4J;
        "pkg-1.2.3-NeoForge-mc1.21" = _4WyXgEZ5;
        "pkg-1.2.3-Fabric-mc1.21.3" = _98YRWh2G;
        "pkg-1.2.3-Forge-mc1.21.3" = _evPPk82w;
        "pkg-1.2.3-NeoForge-mc1.21.3" = _dMuzgXYk;
        "pkg-1.2.3-Fabric-mc1.21.4" = _ayQJXwek;
        "pkg-1.2.3-Forge-mc1.21.4" = _rOjjYhtB;
        "pkg-1.2.3-NeoForge-mc1.21.4" = _qJwH4gZz;
        "pkg-1.2.3-Fabric-mc1.21.6" = _3qPgh0l4;
        "pkg-1.2.3-NeoForge-mc1.21.6" = _9zyoHMnQ;
        "pkg-1.2.3-Forge-mc1.21.6" = _hh5DcAIm;
        "pkg-1.3.0-beta1-Forge-mc1.20.1" = _2nhMvVhy;
        "pkg-1.3.0-Forge-mc1.20.1" = _XTkjPXyP;
        "pkg-1.3.1-Forge-mc1.20.1" = _5yogDlPa;
        "pkg-1.3.1-Fabric-mc1.20.1" = _SABHAX5O;
        "pkg-1.3.1-NeoForge-mc1.21" = _1y4c0tKD;
        "pkg-1.3.2-Forge-mc1.20.1" = _qNLc0M2A;
        "pkg-1.3.2-Fabric-mc1.20.1" = _dcvLpcX3;
        "pkg-1.3.2-NeoForge-mc1.21" = _InWn710r;
        "pkg-1.3.2-Forge-mc1.21" = _7ZA9b8oK;
        "pkg-1.3.2-Fabric-mc1.21" = _adJ1vrSk;
        "pkg-1.3.2-Fabric-mc1.21.6" = _y0ozEkCP;
        "pkg-1.3.2-NeoForge-mc1.21.6" = _OvxmFtmR;
        "pkg-1.3.2-Forge-mc1.21.6" = _QT5IXi2k;
        "pkg-1.3.3-Fabric-mc1.21.9" = _WGyRO9bB;
        "pkg-1.3.3-Forge-mc1.21.9" = _YNmFl05W;
        "pkg-1.3.3-NeoForge-mc1.21.9" = _NMQhkOz2;
        "pkg-1.3.4-Forge-mc1.21.9" = _hKN67T3c;
        "pkg-2.0.0-beta1-Forge-mc1.20.1" = _uDu71Qml;
        "pkg-2.0.0-beta2-Forge-mc1.20.1" = _sdr2fevw;
        "pkg-2.0.0-beta3-Forge-mc1.20.1" = _UrukzFmX;
        "pkg-2.0.0-beta4-Forge-mc1.20.1" = _zH5R38hM;
        "pkg-2.0.0-beta5-Forge-mc1.20.1" = _id4T9y6u;
        "pkg-2.0.0-Forge-mc1.20.1" = _L0hbLfza;
        "pkg-2.0.1-Forge-mc1.20.1" = _KEhC3ZQn;
        "pkg-2.0.1-Fabric-mc1.20.1" = _RyMVuaO8;
        "pkg-2.0.1-NeoForge-mc1.21" = _Wa0YUfRD;
        "pkg-2.0.2-Forge-mc1.20.1" = _6g3bQKzu;
        "pkg-2.0.2-NeoForge-mc1.21" = _52F1ObSC;
        "pkg-2.0.3-Forge-mc1.20.1" = _ha7epEz2;
        "pkg-1.3.3-Fabric-mc1.21.11" = _GxFABL56;
        "pkg-1.3.5-Fabric-mc1.21.11" = _zMNqlhDS;
        "pkg-1.3.3-NeoForge-mc1.21.11" = _si4T6JOE;
        "pkg-1.3.4-Forge-mc1.21.11" = _86ljMkI3;
        "pkg-2.0.4-Forge-mc1.20.1" = _llUi3l42;
        "pkg-2.0.5-Forge-mc1.20.1" = _oTe38LtW;
        "pkg-2.1.0-Forge-mc1.20.1" = _bY7ceEoK;
        "pkg-2.1.0-Fabric-mc1.20.1" = _2x9biGmj;
        "pkg-2.1.0-NeoForge-mc1.21" = _M1BxwppZ;
        "pkg-2.1.0-Forge-mc1.21" = _fQ6AzvVx;
        "pkg-2.1.0-Fabric-mc1.21" = _fHplDpSx;
        "pkg-2.1.0-Forge-mc1.18.2" = _DzRHSivN;
        "pkg-2.1.0-Forge-mc1.19.2" = _TnWq1om0;
        "pkg-2.1.1-Fabric-mc1.21" = _I0RTmgRq;
        "pkg-2.1.1-Forge-mc1.21" = _oy4TwqKy;
        "pkg-2.1.2-Forge-mc1.21" = _WxF0CSbb;
        "pkg-2.1.3-NeoForge-mc1.21.9" = _ytqIKre2;
        "pkg-2.1.3-NeoForge-mc1.21.11" = _dzN1PTfL;
        "pkg-2.1.3-Fabric-mc1.21.9" = _KcJtZoiT;
        "pkg-2.1.3-Fabric-mc1.21.11" = _X9DXsQAC;
        "pkg-2.1.3-Forge-mc1.21.9" = _O7ahDPBC;
        "pkg-2.1.3-Forge-mc1.21.11" = _NtSB4XEV;
        "pkg-2.1.4-Fabric-mc1.21.11" = _MzKw0Z8X;
        "pkg-2.1.4-Fabric-mc26.1" = _CeuLYynn;
        "pkg-2.1.3-NeoForge-mc26.1" = _bVvppEGK;
        "pkg-2.1.3-Forge-mc26.1" = _dWZl4wtF;
        "pkg-2.1.5-Fabric-mc26.1" = _ga9GGjqo;
        "pkg-2.1.6-Fabric-mc26.1" = _Mt7dkc9Z;
        "pkg-2.1.6-NeoForge-mc26.1" = _DHcwp7Aa;
        "pkg-2.1.6-Forge-mc26.1" = _Yb2mEHnG;
        "pkg-2.1.7-NeoForge-mc1.21" = _A0VPk41z;
        "pkg-2.2.0-NeoForge-mc26.1" = _3SYFPmrf;
        "pkg-2.2.0-Fabric-mc26.1" = _PNyHupjc;
        "pkg-2.2.0-Forge-mc26.1" = _EKy8jUUd;
        "pkg-2.2.1-Forge-mc1.20.1" = _s9koO19d;
        "pkg-2.2.1-Fabric-mc26.2" = _dmOSIQWy;
        "pkg-2.2.1-NeoForge-mc26.2" = _iTRJYdeQ;
        "pkg-2.2.1-Forge-mc26.2" = _7BxXJJki;
        "pkg-2.2.2-Fabric-mc26.2" = _2UuT1EBg;
        "pkg-2.2.2-Fabric-mc26.1" = _77uqE9Qc;
        "pkg-2.2.3-NeoForge-mc1.21" = _8hbb74lT;
        "pkg-2.2.4-Fabric-mc26.1" = _pu09IVLQ;
        "pkg-2.2.4-Fabric-mc26.2" = _SVU0JYwz;
        "pkg-2.2.4-NeoForge-mc1.21" = _PLYcr4Bu;
        "pkg-2.2.5-NeoForge-mc1.21" = _FgfIMMU7;
        "pkg-2.2.5-Fabric-mc26.1" = _EhUBfDxJ;
        "pkg-2.2.5-Fabric-mc26.2" = _XcAQG78h;
        "pkg-2.2.5-NeoForge-mc26.1" = _a0Lh4LC0;
        "pkg-2.2.5-NeoForge-mc26.2" = _dUVxg7wz;
