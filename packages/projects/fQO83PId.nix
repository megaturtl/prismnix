...
let
    ...
    in {
        ...
        "pkg-1.21.1-2.0.44.1245" = _5Kl8fxDQ;
        "pkg-1.20.1-2.0.45.1248" = _vi9ETZPs;
        "pkg-1.21.1-2.0.45.1250" = _IWDPfva0;
        "pkg-1.21.1-2.0.46.1252" = _I94BZZc1;
        "pkg-1.21.1-2.0.47.1253" = _1makBfiQ;
        "pkg-1.21.1-2.0.47.1254" = _8D6SRoQx;
        "pkg-1.8.9-1.3.1.296" = _kQqo1Ui8;
        "pkg-1.10.2-1.3.3.664" = _aVRfqARk;
        "pkg-1.12.2-1.3.4.796" = _iEa6eLTv;
        "pkg-1.16.5-1.3.5.1124" = _UPFWqKbe;
        "pkg-1.18.2-2.0.19.1161" = _LbhMjrUe;
        "pkg-1.19.2-2.0.40.1198" = _ZYC7gzKd;
        "pkg-1.21.1-2.0.48.1255" = _HJytQSXE;
        "pkg-1.20.1-2.0.46.1257" = _5xLMBBwn;
        "pkg-1.21.1-2.0.49.1259" = _f29Fd5Sq;
        "pkg-1.21.1-2.0.50.1260" = _PK21dt3l;
        "pkg-1.21.1-2.0.51.1261" = _ylVWbR0T;
        "pkg-1.21.1-2.0.51.1262" = _Iv4C1Vvy;
        "pkg-1.21.1-2.0.52.1264" = _HAv2taXc;
        "pkg-1.21.4-2.0.52.1266" = _fDHISm4s;
        "pkg-1.21.1-2.0.53.1267" = _Zkl7zkR7;
        "pkg-1.21.1-2.0.54.1268" = _R7LYcJ89;
        "pkg-1.21.1-2.0.54.1270" = _pmeL95I7;
        "pkg-1.20.1-2.0.49.1271" = _EsTtFMw0;
        "pkg-1.20.1-2.0.49.1272" = _rh1ghXCO;
        "pkg-1.21.4-2.0.52.1273" = _eU1AGYw1;
        "pkg-1.21.1-2.0.55.1275" = _xzaugXMG;
        "pkg-1.20.1-2.0.49.1276" = _ilAXySzb;
        "pkg-1.21.4-2.0.52.1277" = _SuwEtNfh;
        "pkg-1.21.1-2.0.56.1278" = _6gZDqBia;
        "pkg-1.21.4-2.0.53.1279" = _sUqPzRCN;
        "pkg-1.21.4-2.0.54.1280" = _1da92pjG;
        "pkg-1.21.5-2.0.54.1281" = _BsJKLXZT;
        "pkg-1.21.4-2.0.55.1282" = _lHD9lbBp;
        "pkg-1.21.5-2.0.55.1283" = _kIGOC1NM;
        "pkg-1.21.8-2.0.54.1284" = _TpXhhsw9;
        "pkg-1.21.8-2.0.57.1288" = _ziQWsxB6;
        "pkg-1.21.1-2.0.57.1285" = _ojBv3UKI;
        "pkg-1.21.4-2.0.57.1286" = _OeoJk8IZ;
        "pkg-1.21.5-2.0.57.1287" = _dMrvcQOz;
        "pkg-1.20.1-2.0.50.1289" = _VAVYuxTV;
        "pkg-1.21.1-2.0.58.1290" = _FUAwKVe0;
        "pkg-1.21.4-2.0.58.1291" = _tsTycAQU;
        "pkg-1.21.5-2.0.58.1292" = _VgvE4vZ4;
        "pkg-1.21.8-2.0.58.1293" = _uJgWV3HZ;
        "pkg-1.20.1-2.0.51.1294" = _7iHa02ra;
        "pkg-1.21.1-2.0.59.1295" = _s6nKh8Du;
        "pkg-1.21.4-2.0.59.1296" = _dNzaoawE;
        "pkg-1.21.5-2.0.59.1297" = _ZoFCZ450;
        "pkg-1.21.8-2.0.59.1298" = _1tqYSiTP;
        "pkg-1.20.1-2.0.52.1299" = _UeLVzo0d;
        "pkg-1.21.1-2.0.60.1300" = _AXE6Azab;
        "pkg-1.21.4-2.0.60.1301" = _lvCLWdzG;
        "pkg-1.21.5-2.0.60.1302" = _ot1LrxRp;
        "pkg-1.21.8-2.0.60.1303" = _nCefoJl9;
        "pkg-1.20.1-2.0.54.1304" = _FZBBY8HO;
        "pkg-1.21.1-2.0.61.1305" = _BuW2UCeK;
        "pkg-1.21.4-2.0.61.1306" = _HTkisGGB;
        "pkg-1.21.5-2.0.61.1307" = _nseY0p2h;
        "pkg-1.21.8-2.0.61.1308" = _wjlawSBE;
        "pkg-1.20.1-2.0.55.1309" = _DHhOI125;
        "pkg-1.21.1-2.0.62.1310" = _bWAQBjId;
        "pkg-1.21.4-2.0.62.1311" = _AEMOXbet;
        "pkg-1.21.5-2.0.62.1312" = _zB4RXouX;
        "pkg-1.21.8-2.0.62.1313" = _SlNVwCpn;
        "pkg-1.21.1-2.0.63.1314" = _Aar0IlG0;
        "pkg-1.21.4-2.0.63.1315" = _BL5zv7v7;
        "pkg-1.21.5-2.0.63.1316" = _JUYeQQlK;
        "pkg-1.21.8-2.0.63.1317" = _dqcCfkMa;
        "pkg-1.21.10-2.0.63.1318" = _V2rOIuHf;
        "pkg-1.21.1-2.0.63.1319" = _XRtlC8Yp;
        "pkg-1.21.4-2.0.63.1321" = _c21ugkup;
        "pkg-1.21.5-2.0.63.1322" = _8OEkOMYw;
        "pkg-1.21.8-2.0.63.1323" = _VLglNSUY;
        "pkg-1.21.10-2.0.63.1324" = _ecfHS8Gs;
        "pkg-1.20.1-2.0.55.1320" = _oxvwPn9b;
        "pkg-1.21.1-2.0.63.1325" = _TY5ZKJrm;
        "pkg-1.20.1-2.0.55.1326" = _2UyjTlNF;
        "pkg-1.21.4-2.0.63.1327" = _Md2WV50i;
        "pkg-1.21.5-2.0.63.1328" = _s4mMGJAU;
        "pkg-1.21.8-2.0.63.1329" = _Fo4pP31M;
        "pkg-1.21.10-2.0.63.1330" = _Hr9W0orF;
        "pkg-1.21.10-2.0.64.1331" = _UPGIhQlA;
        "pkg-1.21.8-2.0.64.1332" = _2IsPbUSG;
        "pkg-1.21.4-2.0.64.1333" = _ZSIEmvsV;
        "pkg-1.21.1-2.0.64.1334" = _LYP3bNgP;
        "pkg-1.21.11-2.0.64.1335" = _DQdvVKZs;
        "pkg-1.21.10-2.0.65.1336" = _W0uQZiCF;
        "pkg-1.21.11-2.0.65.1337" = _6ppXuWPC;
        "pkg-1.21.8-2.0.65.1338" = _G7tMNQue;
        "pkg-1.21.5-2.0.64.1339" = _NMSWNtDP;
        "pkg-1.21.4-2.0.65.1340" = _6ckh2pTY;
        "pkg-1.21.1-2.0.65.1341" = _SP3QJ3zb;
        "pkg-1.21.11-2.0.66.1349" = _GD6qA0js;
        "pkg-1.21.11-2.0.67.1362" = _zcWplfK7;
        "pkg-1.21.1-2.0.66.1363" = _sngZYqdK;
        "pkg-1.21.4-2.0.66.1364" = _k0lawBvc;
        "pkg-1.21.8-2.0.66.1365" = _94X7Opa2;
        "pkg-1.21.10-2.0.66.1366" = _Hw0qkA6f;
        "pkg-1.21.5-2.0.65.1367" = _yEcespH7;
        "pkg-26.1-2.0.67.1378" = _gmuQoLnW;
        "pkg-26.1-2.0.68.1381" = _UwVRLVKT;
        "pkg-26.1-2.0.69.1390" = _scmtwz23;
        "pkg-26.1-2.0.69.1391" = _kSyFnxIP;
        "pkg-26.1-2.0.70.1392" = _bm8Z7wWT;
        "pkg-26.1-2.0.71.1393" = _YCQeysaY;
        "pkg-26.1-2.0.72.1394" = _DTPKu7K0;
        "pkg-26.1-2.0.73.1395" = _SDVJuCHK;
        "pkg-1.21.11-2.0.68.1396" = _71GpS4QR;
        "pkg-1.21.10-2.0.67.1397" = _e1Hc6Sx9;
        "pkg-26.1-2.0.74.1398" = _5woIZIFO;
        "pkg-1.21.11-2.0.69.1399" = _RrF8mhIR;
        "pkg-26.1-2.0.75.1400" = _9fMKnvC1;
        "pkg-1.21.10-2.0.68.1401" = _NHcm4aOa;
        "pkg-1.21.1-2.0.67.1405" = _lYB94uNi;
        "pkg-26.1-2.0.76.1402" = _5QcJopV0;
        "pkg-1.21.11-2.0.70.1406" = _W5RUeZsu;
        "pkg-1.21.10-2.0.69.1409" = _5IXfW14J;
        "pkg-26.1-2.0.77.1411" = _uKayzwPm;
        "pkg-1.21.5-2.0.66.1408" = _ZemYo4r4;
        "pkg-1.21.4-2.0.67.1407" = _Nmuh4UZx;
        "pkg-1.21.8-2.0.67.1410" = _mFrBf7z3;
        "pkg-1.21.10-2.0.70.1413" = _uYQMa6in;
        "pkg-1.21.11-2.0.71.1414" = _JsUDvfqX;
        "pkg-26.1-2.0.78.1415" = _AzFaSvQn;
        "pkg-1.21.1-2.0.68.1417" = _LFKQya3V;
        "pkg-1.21.4-2.0.68.1419" = _um7UArsV;
        "pkg-1.21.5-2.0.67.1420" = _lfTRFCQV;
        "pkg-1.21.8-2.0.68.1421" = _7ytbshGD;
        "pkg-1.21.10-2.0.71.1422" = _zwFjnaNc;
        "pkg-1.21.11-2.0.72.1423" = _MRTK1yrR;
        "pkg-26.1.2-2.0.79.1424" = _iNJq7FeU;
        "pkg-1.20.1-2.0.56.1418" = _9wapcQed;
        "pkg-1.21.10-2.0.72.1425" = _UkESA4K4;
        "pkg-1.21.11-2.0.73.1426" = _MidNhF3x;
        "pkg-26.1.2-2.0.80.1427" = _pydcc3Iu;
        "pkg-26.1.2-2.0.81.1429" = _z3Y3RV0K;
        "pkg-1.21.10-2.0.73.1461" = _s2IeBTuy;
        "pkg-1.21.5-2.0.68.1456" = _EddwthMM;
        "pkg-1.21.1-2.0.69.1455" = _wVA8lTVe;
        "pkg-1.21.4-2.0.69.1457" = _RWGZLxNL;
        "pkg-1.21.11-2.0.74.1458" = _UxiDfvIC;
        "pkg-1.21.8-2.0.69.1459" = _mhHKTBos;
        "pkg-26.1.2-2.0.82.1460" = _DMurukmB;
        "pkg-1.21.8-2.0.70.1463" = _eBpvDO5v;
        "pkg-1.21.5-2.0.69.1466" = _YvIlnl2Z;
        "pkg-1.21.4-2.0.70.1465" = _6cbEMNKY;
        "pkg-1.21.10-2.0.74.1469" = _pubHsws0;
        "pkg-1.21.11-2.0.75.1462" = _8PoWWPzW;
        "pkg-1.21.1-2.0.70.1464" = _r8qaV0Jb;
        "pkg-26.1.2-2.0.83.1467" = _ms1jEXaW;
        "pkg-1.20.1-2.0.57.1468" = _25Cntz9b;
        "pkg-1.21.8-2.0.71.1478" = _rfP82neK;
        "pkg-1.20.1-2.0.58.1473" = _3V6nw2i6;
        "pkg-1.21.1-2.0.71.1479" = _ZxW6za2V;
        "pkg-1.21.4-2.0.71.1480" = _RQagjrH3;
        "pkg-1.21.8-2.0.72.1482" = _d7LrDe3e;
        "pkg-26.1.2-2.0.85.1483" = _y5CrukOw;
        "pkg-1.21.5-2.0.71.1485" = _cDeIgpcP;
        "pkg-1.21.10-2.0.76.1481" = _zIVaR2ZV;
        "pkg-1.21.11-2.0.77.1484" = _Qbdg3fte;
        "pkg-1.21.1-2.0.71.1486" = _tFV1rZ8q;
        "pkg-26.1.2-2.0.85.1493" = _WtROGsvV;
        "pkg-1.21.10-2.0.76.1491" = _VtGjgWbW;
        "pkg-1.20.1-2.0.58.1487" = _eASkPVRL;
        "pkg-1.21.4-2.0.71.1488" = _88jPgqYe;
        "pkg-1.21.5-2.0.71.1489" = _Bef5RpAR;
        "pkg-1.21.8-2.0.72.1490" = _mZvZcQKh;
        "pkg-1.21.11-2.0.77.1492" = _QVEo8oan;
        "pkg-26.1.2-2.0.86.1499" = _txFTu24s;
        "pkg-1.21.10-2.0.77.1500" = _phsmIu1u;
        "pkg-1.21.8-2.0.73.1495" = _j5qHebbJ;
        "pkg-1.21.11-2.0.78.1501" = _aIKxwqH0;
        "pkg-1.21.4-2.0.72.1494" = _V7Mxgjao;
        "pkg-1.21.1-2.0.73.1497" = _CSgI0JhM;
        "pkg-1.21.5-2.0.72.1498" = _8W5wBBrH;
        "pkg-1.20.1-2.0.60.1496" = _Od7ZmeFq;
        "pkg-1.21.5-2.0.73.1505" = _cdllWlRF;
        "pkg-1.21.10-2.0.78.1506" = _614ee1YT;
        "pkg-26.1.2-2.0.87.1510" = _UpKUsfZr;
        "pkg-1.21.1-2.0.74.1509" = _25aMmg2Y;
        "pkg-1.21.11-2.0.79.1508" = _v9cm8gGR;
        "pkg-1.21.8-2.0.74.1503" = _p2lrG0Tg;
        "pkg-1.21.4-2.0.73.1504" = _45UKkeJ8;
        "pkg-1.20.1-2.0.61.1507" = _LO8qZfR2;
        "pkg-26.2-2.0.87.1512" = _t688j4LE;
        "pkg-1.21.1-2.0.75.1526" = _X3UsUY8s;
        "pkg-1.21.11-2.0.80.1527" = _wmn9P0UY;
        "pkg-1.21.5-2.0.74.1524" = _2eBq2Gwt;
        "pkg-1.21.10-2.0.79.1523" = _DsV7ZzHF;
        "pkg-1.21.4-2.0.74.1522" = _EELP7q7Z;
        "pkg-26.1.2-2.0.88.1525" = _2kp341Fy;
        "pkg-1.21.8-2.0.75.1528" = _64WkzpI7;
        "pkg-1.21.10-2.0.80.1533" = _SBEEXG0K;
        "pkg-1.21.11-2.0.82.1529" = _nV7jlQ4k;
        "pkg-1.21.4-2.0.75.1530" = _o8CpcOW6;
        "pkg-1.21.1-2.0.77.1537" = _Ore7iCX1;
        "pkg-26.2-2.0.89.1531" = _6Y4nzaLN;
        "pkg-1.21.5-2.0.75.1535" = _mPBqntUO;
