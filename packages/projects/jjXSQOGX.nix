...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _IVDgfVCZ;
        "pkg-1.1.1" = _Bqpp2sDD;
        "pkg-1.1.2-beta.1" = _kGKSbybm;
        "pkg-1.1.2-beta.2" = _71xiWRMS;
        "pkg-1.1.2-beta.3" = _fmlCjzw4;
        "pkg-1.1.2" = _pKnElaZ5;
        "pkg-1.1.3" = _3Q7eKZFe;
        "pkg-1.1.4" = _IUjXtlj3;
        "pkg-1.1.5" = _3VwdWLCF;
        ...
        "pkg-1.2.0" = _G6NbXtX8;
        "pkg-1.2.3" = _ujgrDeHW;
        "pkg-1.2.4-beta" = _EEixIWu1;
        "pkg-1.2.4" = _YmA9zg0z;
        "pkg-1.2.5" = _KYKHAAc2;
        "pkg-1.3.0-beta.1" = _8CHdCYOY;
        "pkg-1.3.0" = _dQH3eLCB;
        "pkg-1.3.1" = _kJ04uwWr;
        "pkg-1.3.2" = _CvD4vEo4;
        "pkg-1.3.3" = _mzEL5YZ0;
        "pkg-1.3.4-beta.1" = _vFlGBKQp;
        "pkg-1.3.4" = _wo3KbCyd;
        "pkg-1.3.5" = _wcOXKBfv;
        "pkg-1.3.6-alpha.1" = _qD4RMi34;
        "pkg-1.3.6-alpha.2" = _9EvBfX23;
        "pkg-1.4.0-beta.1" = _f6p6vTxy;
        "pkg-1.4.0-beta.2" = _2a9UefOG;
        "pkg-1.4.0-beta.3" = _7NnzbCZs;
        "pkg-1.4.0" = _TAeOJsbt;
        "pkg-1.4.0.1" = _rgv8FN8G;
        "pkg-1.4.0.2" = _tBJGZKwE;
        "pkg-1.4.0.3" = _6twXW931;
        "pkg-1.4.1-beta.1" = _fmq7HPfs;
