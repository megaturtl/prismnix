...
let
    ...
    in {
        ...
        "pkg-10.1" = _JnCw303R;
        "pkg-15.1" = _1MgbGNXp;
        "pkg-15.1+mod" = _wJ79Q5g9;
        "pkg-12.1+mod" = _JYgqBbFi;
        "pkg-18.1" = _PwhE0elf;
        "pkg-18.1+mod" = _5yhhWWzt;
        "pkg-26.1" = _xhfPDrO0;
        "pkg-26.1+mod" = _FKNy7Lvw;
        "pkg-41.1" = _PYYzJt0Z;
        "pkg-41.1+mod" = _oMzult67;
        "pkg-48.1" = _IDHtb1su;
        "pkg-48.1+mod" = _INH6qM5a;
        "pkg-48.2" = _32pygdMq;
        "pkg-48.2+mod" = _B08n6fWZ;
        "pkg-57.1" = _ajqSs2hW;
        "pkg-57.1+mod" = _ykgNQXrN;
        "pkg-57.2+mod" = _alqqFrK5;
        "pkg-61.1" = _MtCAb3xu;
        "pkg-61.1+mod" = _Oz7J3uXH;
        "pkg-71.1" = _uCpGARTk;
        "pkg-71.1+mod" = _npYZgovB;
        "pkg-80" = _aUxHxYN4;
        "pkg-80+mod" = _dHkjaqxs;
        "pkg-81" = _DPmgmd71;
        "pkg-81+mod" = _mH2LwoX7;
        "pkg-88.0" = _VCqOnrWn;
        "pkg-88.0+mod" = _lHruIrYT;
        "pkg-94.1" = _jjLp8S59;
        "pkg-94.1+mod" = _87lvRXyM;
        "pkg-101.1" = _GvR0rVkJ;
