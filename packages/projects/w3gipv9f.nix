...
let
    versions = (let
        ...
        _YmOHKZqH = {
            "id" = "YmOHKZqH";
            "file" = "Seasonal Integration-v1.6.2-Mc1.21.1+.zip";
            "hash" = "sha512-fkSwn6ZaZoeZo2tVNaJXp7dBmu2TJURbcCma3LaxSGLzoL1yz0fvXi5hiLzf6XQzpv+pCO8/LK99J+CrubSzlQ==";
        };
        _HTMiggLq = {
            "id" = "HTMiggLq";
            "file" = "Seasonal Integration-v1.6.2-Mc1.21.1+.jar";
            "hash" = "sha512-v0bViDIds8piLIVx03qh1wfs6RAH9hzbWnOzvgdMQLxZCiITwDNb3CmXEat+uv1gwyVueViH42//H6GSqt85lg==";
        };
    in {
        "pfQgIzJT" = _pfQgIzJT;
        "UNQ1h21W" = _UNQ1h21W;
        ...
        "YmOHKZqH" = _YmOHKZqH;
        "HTMiggLq" = _HTMiggLq;
        "datapack-1.21" = _YmOHKZqH;
        "datapack-1.21.1" = _YmOHKZqH;
        "datapack-1.21.2" = _YmOHKZqH;
        "datapack-1.21.3" = _YmOHKZqH;
        "datapack-1.21.4" = _YmOHKZqH;
        "datapack-1.21.5" = _YmOHKZqH;
        "datapack-1.21.6" = _YmOHKZqH;
        "datapack-1.21.7" = _YmOHKZqH;
        "datapack-1.21.8" = _YmOHKZqH;
        "datapack-1.21.9" = _YmOHKZqH;
        "datapack-1.21.10" = _YmOHKZqH;
        "datapack-1.21.11" = _YmOHKZqH;
        "datapack-24w33a" = _YmOHKZqH;
        "datapack-24w34a" = _YmOHKZqH;
        "datapack-24w35a" = _YmOHKZqH;
        "datapack-24w36a" = _YmOHKZqH;
        "datapack-24w37a" = _YmOHKZqH;
        "datapack-24w38a" = _YmOHKZqH;
        "datapack-24w39a" = _YmOHKZqH;
        "datapack-24w40a" = _YmOHKZqH;
        "datapack-1.21.2-pre1" = _YmOHKZqH;
        "datapack-1.21.2-pre2" = _YmOHKZqH;
        "datapack-24w44a" = _YmOHKZqH;
        "datapack-24w45a" = _YmOHKZqH;
        "datapack-24w46a" = _YmOHKZqH;
        ...
        "datapack-26.1" = _YmOHKZqH;
        "datapack-26.1.1" = _YmOHKZqH;
        "datapack-26.1.2" = _YmOHKZqH;
        "datapack-26.2" = _YmOHKZqH;
        "neoforge-1.21" = _HTMiggLq;
        "neoforge-1.21.1" = _HTMiggLq;
        "neoforge-1.21.2" = _HTMiggLq;
        "neoforge-1.21.3" = _HTMiggLq;
        "neoforge-1.21.4" = _HTMiggLq;
        "neoforge-1.21.5" = _HTMiggLq;
        "neoforge-1.21.6" = _HTMiggLq;
        "neoforge-1.21.7" = _HTMiggLq;
        "neoforge-1.21.8" = _HTMiggLq;
        "neoforge-1.21.9" = _HTMiggLq;
        "neoforge-1.21.10" = _HTMiggLq;
        "neoforge-1.21.11" = _HTMiggLq;
        ...
        "neoforge-26.1" = _HTMiggLq;
        "neoforge-26.1.1" = _HTMiggLq;
        "neoforge-26.1.2" = _HTMiggLq;
        "neoforge-26.2" = _HTMiggLq;
        "forge-1.21" = _HTMiggLq;
        "forge-1.21.1" = _HTMiggLq;
        "forge-1.21.2" = _HTMiggLq;
        "forge-1.21.3" = _HTMiggLq;
        "forge-1.21.4" = _HTMiggLq;
        "forge-1.21.5" = _HTMiggLq;
        "forge-1.21.6" = _HTMiggLq;
        "forge-1.21.7" = _HTMiggLq;
        "forge-1.21.8" = _HTMiggLq;
        "forge-1.21.9" = _HTMiggLq;
        "forge-1.21.10" = _HTMiggLq;
        "forge-1.21.11" = _HTMiggLq;
        ...
        "forge-26.1" = _HTMiggLq;
        "forge-26.1.1" = _HTMiggLq;
        "forge-26.1.2" = _HTMiggLq;
        "forge-26.2" = _HTMiggLq;
        "fabric-1.21" = _HTMiggLq;
        "fabric-1.21.1" = _HTMiggLq;
        "fabric-1.21.2" = _HTMiggLq;
        "fabric-1.21.3" = _HTMiggLq;
        "fabric-1.21.4" = _HTMiggLq;
        "fabric-1.21.5" = _HTMiggLq;
        "fabric-1.21.6" = _HTMiggLq;
        "fabric-1.21.7" = _HTMiggLq;
        "fabric-1.21.8" = _HTMiggLq;
        "fabric-1.21.9" = _HTMiggLq;
        "fabric-1.21.10" = _HTMiggLq;
        "fabric-1.21.11" = _HTMiggLq;
        ...
        "fabric-26.1" = _HTMiggLq;
        "fabric-26.1.1" = _HTMiggLq;
        "fabric-26.1.2" = _HTMiggLq;
        "fabric-26.2" = _HTMiggLq;
        "pkg-1.0.0" = _pfQgIzJT;
        "pkg-1.0.0+mod" = _UNQ1h21W;
        "pkg-1.1.0" = _EuEqKcVO;
        "pkg-1.1.0+mod" = _t3xCMBr8;
        "pkg-1.1.1" = _I2gMEHin;
        "pkg-1.1.1+mod" = _AvQ1odZe;
        "pkg-1.1.2" = _b5RNY3yQ;
        "pkg-1.1.2+mod" = _bIkHDbUm;
        "pkg-1.2.0" = _Mb6nVrAW;
        "pkg-1.2.1" = _gIF0WvMo;
        "pkg-1.2.2" = _icztsIxG;
        "pkg-1.2.3" = _WPAefQYO;
