...
let
    ...
    in {
        ...
        "pkg-1.1" = _YKpW0vXM;
        "pkg-1.1.1+mod" = _D9nDuy9H;
        "pkg-1.2" = _7vGRPiDy;
        "pkg-1.2.1+mod" = _jebWXRUU;
        "pkg-1.3" = _HMSvbd8V;
        "pkg-1.3.1+mod" = _QgGGnBRh;
        "pkg-1.4" = _Zk2425iR;
        "pkg-1.4.1+mod" = _bEYff7ud;
        "pkg-1.5" = _zotq69bE;
        "pkg-1.5.1+mod" = _DZYDQWNT;
        "pkg-1.6" = _p1WWYhBR;
        "pkg-1.6.1+mod" = _nZkje7Kk;
        "pkg-1.7" = _uSxMMe3C;
        "pkg-1.7.1+mod" = _qzAJ2G7r;
        "pkg-1.8" = _qf7QBNNi;
        "pkg-1.8.1+mod" = _kUshmwjV;
        "pkg-1.9" = _zjItcZyh;
