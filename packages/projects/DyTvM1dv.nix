...
let
    versions = (let
        ...
        _8nLEdSG0 = {
            "id" = "8nLEdSG0";
            "file" = "AmbientEnvironment-fabric-26.3-26.3.2.jar";
            "hash" = "sha512-1FepeI/KbYIvrG2uZ3pgtTjcHaESN9dzvrHK4qPFl0T6pnk8grh6ayeIBr5zuMI0XgYL8qgJmFtcF4sqZ+Hiog==";
        };
        _Rp6XISGb = {
            "id" = "Rp6XISGb";
            "file" = "AmbientEnvironment-neoforge-26.3-26.3.2.jar";
            "hash" = "sha512-OAYuOCRypccymBX0Py0FPuD3kkxEcv5med9tuGOMsi71QVMBL+j5oeGlSYHLl3Oj/tJEtHVS4ayS27e1PwmwOg==";
        };
    in {
        "FTTAFPgP" = _FTTAFPgP;
        "J0BiNnwx" = _J0BiNnwx;
        ...
        "pkg-2.0.1" = _tfhGJ5Uh;
        "pkg-3.0.0" = _U5TfikCI;
        "pkg-3.0.0.2" = _Wy8kARaa;
        "pkg-4.0.0.1" = _CTjWngr1;
        "pkg-4.0.0.2" = _iZvWBxFq;
        "pkg-4.0.0.3" = _uh6saVAF;
        "pkg-4.0.0.4" = _u5dtlhop;
        "pkg-4.0.0.5" = _k067EYsv;
        "pkg-4.0.0.6" = _794B5jqX;
        "pkg-5.0.0.7" = _Cs8Zr6hC;
        "pkg-5.0.0.8" = _OafK7Tb7;
        "pkg-5.0.0" = _b7QZDZ24;
        "pkg-fabric-1.17-rc2-6.0.0.10" = _Vf0fjLgl;
        "pkg-fabric-1.17-rc2-6.0.0.11" = _I8rhMBN3;
        "pkg-5.0.0.11" = _sq5hHc4R;
        "pkg-3.0.0.3" = _hp3Gbx79;
        "pkg-fabric-1.17.1-6.0.13" = _oRIHpt3b;
        "pkg-6.0.0.17" = _ekC31vki;
        "pkg-6.0.0.18" = _Y1CUnbql;
        "pkg-6.0.0.19" = _ORsum27Q;
        "pkg-6.0.0.20" = _CDlItfFw;
        "pkg-6.0.21" = _EikK95iu;
        "pkg-6.0.22" = _A1sGPPD0;
        "pkg-7.0.1" = _3wGQDA76;
        "pkg-7.0.2" = _G1Xh94F0;
        "pkg-7.0.3" = _LR9PCNA5;
        "pkg-7.0.4" = _xxLyEhVo;
        "pkg-7.0+9" = _7woUNtDV;
        "pkg-7.0+10" = _MRaXQRYu;
        "pkg-7.0+16" = _1hDd0rSu;
        "pkg-7.0+17" = _LXKmzACa;
        "pkg-7.0+18" = _nP5xZ38Y;
        "pkg-7.0+19" = _kkgs8y06;
        "pkg-8.0+1" = _64HWXeGO;
        "pkg-8.0+2" = _9R0yzEOQ;
        "pkg-8.0+3" = _qi3AoGA2;
        "pkg-8.0+4" = _K2gk6zmi;
        "pkg-9.0.0.2" = _VS2PuH0W;
        "pkg-9.0.0.5" = _5zgepuVy;
        "pkg-9.0.0.6" = _NlGZZiAa;
        "pkg-10.0.0.1" = _1fRGL34M;
        "pkg-10.0.0.2" = _dQOLwZbv;
        "pkg-9.0.0.7" = _3cvbT7gE;
        "pkg-10.0.0.3" = _ybQJcXMa;
        "pkg-11.0.0.1" = _nmf6Pzbc;
        "pkg-12.0.0.1" = _DqHfBSF2;
        "pkg-12.0.0.2" = _xkARo7ZM;
        "pkg-12.0.0.4" = _f4NyX410;
        "pkg-13.0.0.1" = _lFSviBmi;
        "pkg-14.0.0.3" = _qboI6zoa;
        "pkg-14.0.0.4" = _kdoS3eJn;
        "pkg-15.0.0.1" = _mvfUVZsJ;
        "pkg-16.0.0.1" = _529CUbDy;
        "pkg-17.0.0.4" = _t0MhEGet;
        "pkg-17.0.0.5" = _tVZ01hA9;
        "pkg-18.0.0.1" = _QIQ83SXq;
        "pkg-18.0.0.2" = _N7jam3SN;
        "pkg-19.0.0.1" = _hxaQPhrB;
        "pkg-20.0.0.1" = _KH4H92By;
        "pkg-21.0.0.1" = _4kgABLDt;
        "pkg-21.0.0.3" = _S0iEs794;
        "pkg-22.0.0.2" = _EXBenvV6;
        "pkg-23.0.0.1" = _u58gYatU;
        "pkg-24.0.0.1" = _DZvKWMsh;
        "pkg-25.0.0.1" = _KafIOEwz;
        "pkg-26.0.0.1" = _IBjkcPcX;
        "pkg-27.0.0.2" = _clKtCG7V;
        "pkg-27.0.0.1" = _cKBs1oHy;
        "pkg-27.0.0.3" = _4lQ6ywjx;
        "pkg-26.1.0.1" = _pgfKdysM;
        "pkg-26.1.0.2" = _R0OybsFs;
        "pkg-26.1.0.3" = _WRziZKoi;
        "pkg-26.1.1.1" = _hWK5Q5Td;
        "pkg-26.1.2.1" = _WS1DDh2L;
        "pkg-26.2.1" = _1rqCUXVZ;
        "pkg-26.3.2" = _Rp6XISGb;
        "default" = _Rp6XISGb;
    });
