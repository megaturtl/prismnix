...
let
    versions = (let
        ...
        _B2MHnfkW = {
            "id" = "B2MHnfkW";
            "file" = "ImmediatelyFast-NeoForge-1.6.12+1.21.1.jar";
            "hash" = "sha512-hTyHRtCyj5fNPrfp5Vln+Y1sNY9gm52yxNLXr+52co2Ce62PPXPWoLfF42qCB3nymc3NpwGR44MtW9DyzwNNVg==";
        };
        _3xXzj2GW = {
            "id" = "3xXzj2GW";
            "file" = "ImmediatelyFast-Forge-1.6.12+1.21.1.jar";
            "hash" = "sha512-9g+OcmKS6RdYH1N+ZKNAfMTqtYtjmHQB2GG3eonMFJngzarcwVmvEDx7kgkmPAWMjopppSOYsPR+PBpwhZalhw==";
        };
        _nLX2NbyQ = {
            "id" = "nLX2NbyQ";
            "file" = "ImmediatelyFast-Fabric-1.6.12+1.21.1.jar";
            "hash" = "sha512-6X/+teLK+Rd7jb9KUkxLKGeiGAtOdDG2jG/Z4HJ31M71Kh4OuP//UfZ11rBqBmCOF9yNY9oefCg3GHYUB7mxpQ==";
        };
        _rxHcwxdQ = {
            "id" = "rxHcwxdQ";
            "file" = "ImmediatelyFast-Fabric-1.16.3+26.2.jar";
            "hash" = "sha512-eTIfALc3Va5U8IEg6B/VWdxdejTve+3d0enkZ94Nrr7IhbN321//1KoZDYHORMZq84+++CrUn2Ydpd3S7z/Eng==";
        };
        _HMgMQYxb = {
            "id" = "HMgMQYxb";
            "file" = "ImmediatelyFast-NeoForge-1.16.3+26.2.jar";
            "hash" = "sha512-905jPzUq7W2Q53QX3l/FauOy2Bt1n6hBNRzdOglKirU19CD4L2cCU9ydo1of/XXme6rXTCZF5m0Fh3r9ONtAjw==";
        };
        _hZvFDqhH = {
            "id" = "hZvFDqhH";
            "file" = "ImmediatelyFast-Fabric-1.6.13+1.21.1.jar";
            "hash" = "sha512-NcLq11ZFkQ9SW1uKz89RvPUhhlm6GDs0/6LZ+E0gA/Y+wRjSB8gOiZdrq/oOmCHRIjMVdIMQBjVddQqc0Vf1IQ==";
        };
        _xcQYt0Uy = {
            "id" = "xcQYt0Uy";
            "file" = "ImmediatelyFast-NeoForge-1.6.13+1.21.1.jar";
            "hash" = "sha512-OuVpA2eAoKFjfCNqE3DO4gBVcH0FypOjcA63KdLvcme3Zfsx1WcH0CEf1aEsvN8AR0bKMZ0qdUemmhDunWpDFg==";
        };
        _UjgM7lFA = {
            "id" = "UjgM7lFA";
            "file" = "ImmediatelyFast-Forge-1.6.13+1.21.1.jar";
            "hash" = "sha512-bdtVGyCO3n0XbhTF3oNvQ+EJXPa7FRigOlKBQbjiGQWXBMuLwU9OtKLzHWuO3bR8PNFBjosOLx9kPRkIHYt32Q==";
        };
        _kc7MJI19 = {
            "id" = "kc7MJI19";
            "file" = "ImmediatelyFast-NeoForge-1.16.4+26.2.jar";
            "hash" = "sha512-GNuxVQUNQ0QMr9co86CimuK7lBJZeonIsKpkuoMORreNuV3R7mwNcUwRYZOHqRJWpuYON0rBli+Ewr3GzyDlWQ==";
        };
        _vkW9vHhp = {
            "id" = "vkW9vHhp";
            "file" = "ImmediatelyFast-Fabric-1.16.4+26.2.jar";
            "hash" = "sha512-uLN15tR6zWBR/HEQBl0KGLWdtYTraGmWUs7SEuoKmyuaeNL3kfZBqzVH4MpWtR4K98YMEWS004kQ2aqU5FJBwA==";
        };
        _OUpXxw4n = {
            "id" = "OUpXxw4n";
            "file" = "ImmediatelyFast-NeoForge-1.6.14+1.21.1.jar";
            "hash" = "sha512-fRwubOMG9LuaoVX2S6h3MtwkQ9V/3iSUZ6meDtkP7ImnBiUoiLl/iC77xV1gRJcVGdtwQSXyeuU82a5AQk+bLA==";
        };
        _7XKnsIC8 = {
            "id" = "7XKnsIC8";
            "file" = "ImmediatelyFast-Fabric-1.6.14+1.21.1.jar";
            "hash" = "sha512-0/J0isK1FUgVfQrPnUTpmreGvqtTIsvEUq15mbGH6tKk7muyruGhedxy27e7KzlFs4xSms7kVP5LUmZI7vqwtA==";
        };
        _MEq3Zttz = {
            "id" = "MEq3Zttz";
            "file" = "ImmediatelyFast-Forge-1.6.14+1.21.1.jar";
            "hash" = "sha512-1mVH01/b5HuAYs6qwiN5VXJVDxft0vuscFzVzDQrPAJNI3UhPwVbhFT+fVDFWPUUGSs1rRwDdQErgpT2W1axKw==";
        };
        _4C8Vb9ab = {
            "id" = "4C8Vb9ab";
            "file" = "ImmediatelyFast-NeoForge-1.16.5+26.2.jar";
            "hash" = "sha512-Q15A5VXIf87X9huL1vXUTHupyHK5m9Vzidzq1FS3NKwS/BkSoi9TTIw/v1M4EswgjNc+mEy8lIi5g1jKFYAMDg==";
        };
        _pMWERcSu = {
            "id" = "pMWERcSu";
            "file" = "ImmediatelyFast-Fabric-1.16.5+26.2.jar";
            "hash" = "sha512-WDawiQcsD9eWYT1Cw70Bx+QBtq1T3oAyi7nXTVhd6b4P8M/E1v+h7UEAh1BXOwUl7/jAZBYqL3JK0WgXqP2vIg==";
        };
        _CRMLDZp0 = {
            "id" = "CRMLDZp0";
            "file" = "ImmediatelyFast-NeoForge-1.17.0+26.3.jar";
            "hash" = "sha512-bUKTR3S7e1hsAjgk6f7ctzQwcujGVhl8uldSc+SXRvhIF17dW8sVF8DdtoFm0ixMg4vOvnhwUflKJnlm4SC1sg==";
        };
        _ugNfVpVH = {
            "id" = "ugNfVpVH";
    ...
    in {
        ...
        "fabric-1.21" = _7XKnsIC8;
        "fabric-1.21.1" = _7XKnsIC8;
        ...
        "quilt-1.21" = _7XKnsIC8;
        "quilt-1.21.1" = _7XKnsIC8;
        ...
        "forge-1.21" = _MEq3Zttz;
        "forge-1.21.1" = _MEq3Zttz;
        ...
        "neoforge-1.21" = _OUpXxw4n;
        "neoforge-1.21.1" = _OUpXxw4n;
        ...
        "pkg-1.1.2" = _FcqoS76s;
        "pkg-1.1.3" = _vjevJCO1;
        "pkg-1.1.4+1.19" = _IYnEX1ly;
        "pkg-1.1.4+1.19.3" = _sTQ5rCbF;
        "pkg-1.1.5+1.19" = _Ly9dRsAI;
        "pkg-1.1.5+1.19.3" = _zkmYKBLC;
        "pkg-1.1.6+1.18.2" = _zImGOGqD;
        "pkg-1.1.6+1.19" = _A6GCxAD1;
        "pkg-1.1.6+1.19.3" = _vA8NWTKD;
        "pkg-1.1.7+1.18.2" = _VUTuPIlE;
        "pkg-1.1.7+1.19" = _UDnjDzur;
        "pkg-1.1.7+1.19.3" = _mo9q5fMn;
        "pkg-1.1.8+1.18.2" = _M7dmS1xe;
        "pkg-1.1.8+1.19" = _VoFPEhPL;
        "pkg-1.1.8+1.19.3" = _EHbdx1pF;
        "pkg-1.1.9+1.18.2" = _aWcTiEn8;
        "pkg-1.1.9+1.19.2" = _K3zjbY4P;
        "pkg-1.1.9+1.19.3" = _d6gX5lox;
        "pkg-1.1.10+1.18.2" = _YVmLXIsi;
        "pkg-1.1.10+1.19" = _q6hvGX5B;
        "pkg-1.1.10+1.19.3" = _CdpFa9ts;
        "pkg-1.1.10+1.19.4" = _izX4Zjnu;
        "pkg-1.1.11+1.19.4" = _IpEJi0ih;
        "pkg-1.1.12+1.18.2" = _D73h6MNI;
        "pkg-1.1.12+1.19" = _4yVqQKQO;
        "pkg-1.1.12+1.19.3" = _fnLm3B23;
        "pkg-1.1.12+1.19.4" = _8IFFeKYy;
        "pkg-1.1.13+1.19.4" = _fZkbywLp;
        "pkg-1.1.13+1.20" = _Jci0UG9F;
        "pkg-1.1.14+1.19.4" = _1OT6gCmX;
        "pkg-1.1.14+1.20.1" = _cpgGVZDs;
        "pkg-1.1.15+1.19.4" = _eiqdESrg;
        "pkg-1.1.15+1.20.1" = _4IDo27OL;
        "pkg-1.1.16+1.19.4" = _LEmCbzHA;
        "pkg-1.1.16+1.20.1" = _aptjkgGB;
        "pkg-1.1.17+1.19.4" = _15Hwli83;
        "pkg-1.1.17+1.20.1" = _24BUZiRe;
        "pkg-1.1.18+1.19.4" = _KjMKYa1K;
        "pkg-1.1.18+1.20.1" = _2cEsJ6Ix;
        "pkg-1.1.19+1.19.4" = _5arZz0qz;
        "pkg-1.1.19+1.20.1" = _mGqxsY9X;
        "pkg-1.1.20+1.19.4" = _VaRB1Uaj;
        "pkg-1.1.20+1.20.1" = _m8P58epq;
        "pkg-1.1.21+1.19.4" = _pQRqrmzs;
        "pkg-1.1.21+1.20.1" = _FtHQIJZd;
        "pkg-1.1.22+1.19.4" = _i5OWJDBj;
        "pkg-1.1.22+1.20.1" = _xFmHwVvA;
        "pkg-1.1.23+1.19.4" = _CG88v2FZ;
        "pkg-1.1.23+1.20.1" = _XHrRgyGN;
        "pkg-1.1.24+1.19.4" = _d4HBt40d;
        "pkg-1.1.24+1.20.1" = _1BSUFszc;
        "pkg-1.1.25+1.19.4" = _kQq0Qobv;
        "pkg-1.1.25+1.20.1" = _h38wJYho;
        "pkg-1.1.26+1.19.2" = _9RDk8aOc;
        "pkg-1.1.26+1.19.4" = _4Y4VXGXE;
        "pkg-1.1.26+1.20.1" = _fZa7YlyA;
        "pkg-1.1.27+1.19.2" = _gAAnfzrT;
        "pkg-1.1.27+1.19.4" = _LJYd35mB;
        "pkg-1.1.27+1.20.1" = _hgQwRPhD;
        "pkg-1.1.28+1.19.2" = _yhuSOfHc;
        "pkg-1.1.28+1.19.4" = _Hh5as8hY;
        "pkg-1.1.28+1.20.1" = _EANGsMsP;
        "pkg-1.2.0+1.19.2" = _Tf6O7B9h;
        "pkg-1.2.0+1.19.4" = _lPyP6Kcf;
        "pkg-1.2.0+1.20.1" = _zKKDqwCd;
        "pkg-1.2.1+1.19.2" = _nSd5x28T;
        "pkg-1.2.1+1.19.4" = _xSKg5aqE;
        "pkg-1.2.1+1.20.1" = _txcO4lNF;
        "pkg-1.2.2+1.19.2" = _tpfQ6Vm5;
        "pkg-1.2.2+1.19.4" = _I5zOy70w;
        "pkg-1.2.2+1.20.1" = _ZhW5WW22;
        "pkg-1.2.3+1.19.2" = _ADkpsbyz;
        "pkg-1.2.3+1.19.4" = _9DJ47QhP;
        "pkg-1.2.3+1.20.1" = _bHjLCRu6;
        "pkg-1.2.4+1.19.2" = _dTZfskbw;
        "pkg-1.2.4+1.19.4" = _YniADsYA;
        "pkg-1.2.4+1.20.1" = _NJ17fqEK;
        "pkg-1.2.5+1.19.2" = _BwkXA4tK;
        "pkg-1.2.5+1.19.4" = _A7g0Ha7U;
        "pkg-1.2.5+1.20.2" = _cswW9vJQ;
        "pkg-1.2.6+1.19.2" = _e8XCF1RN;
        "pkg-1.2.6+1.19.4" = _3jiSnSnx;
        "pkg-1.2.6+1.20.2" = _mbeaDZtb;
        "pkg-1.2.7+1.19.2" = _CdkNJPmV;
        "pkg-1.2.7+1.19.4" = _yPspsvFQ;
        "pkg-1.2.7+1.20.2" = _yciHw2oP;
        "pkg-1.2.8+1.19.2-fabric" = _bqv414X0;
        "pkg-1.2.8+1.19.2-forge" = _MPg7LytK;
        "pkg-1.2.8+1.19.4-forge" = _DBSdeovn;
        "pkg-1.2.8+1.19.4-fabric" = _VNkQO9oa;
        "pkg-1.2.8+1.20.4-neoforge" = _Vz2ebSk4;
        "pkg-1.2.8+1.20.4-fabric" = _3EgIBnht;
        "pkg-1.2.8+1.20.4-forge" = _ZGMKFbmk;
        "pkg-1.2.9+1.19.2-forge" = _eKcnzuDu;
        "pkg-1.2.9+1.19.2-fabric" = _4x5lLRwI;
        "pkg-1.2.9+1.19.4-forge" = _nxuFR8Zx;
        "pkg-1.2.9+1.19.4-fabric" = _kij8vKAw;
        "pkg-1.2.9+1.20.4-fabric" = _hh8K3O8j;
        "pkg-1.2.9+1.20.4-neoforge" = _6xkpzpoh;
        "pkg-1.2.9+1.20.4-forge" = _zM9yMVsk;
        "pkg-1.2.10+1.19.2-fabric" = _10hJ1wKC;
        "pkg-1.2.10+1.19.2-forge" = _sZaOJ6hY;
        "pkg-1.2.10+1.19.4-fabric" = _3sz82ybY;
        "pkg-1.2.10+1.19.4-forge" = _2JSRDFi1;
        "pkg-1.2.10+1.20.4-neoforge" = _sbQQizAw;
        "pkg-1.2.10+1.20.4-fabric" = _59UuNTrz;
        "pkg-1.2.10+1.20.4-forge" = _v2sxhCOI;
        "pkg-1.2.11+1.19.2-forge" = _ToyOhEyt;
        "pkg-1.2.11+1.19.2-fabric" = _xC3SC47B;
        "pkg-1.2.11+1.19.4-fabric" = _ezKTj0NE;
        "pkg-1.2.11+1.19.4-forge" = _s2nB1I8Z;
        "pkg-1.2.11+1.20.4-neoforge" = _bxOczWO3;
        "pkg-1.2.11+1.20.4-fabric" = _FEOsWs1E;
        "pkg-1.2.11+1.20.4-forge" = _7DjvwG1b;
        "pkg-1.2.12+1.19.2-fabric" = _GbH3WLI3;
        "pkg-1.2.12+1.19.2-forge" = _XJv24FpT;
        "pkg-1.2.12+1.20.4-neoforge" = _u2AFTh8j;
        "pkg-1.2.12+1.20.4-fabric" = _TqFSrfXD;
        "pkg-1.2.12+1.20.4-forge" = _Zmg9Im8A;
        "pkg-1.2.12+1.20.5-neoforge" = _RbjZFqTz;
        "pkg-1.2.12+1.20.5-fabric" = _cnnaUyZd;
        "pkg-1.2.13+1.19.2-fabric" = _PApQEGE3;
        "pkg-1.2.13+1.19.2-forge" = _Lw7F67te;
        "pkg-1.2.13+1.20.4-forge" = _7Twx0B8r;
        "pkg-1.2.13+1.20.4-neoforge" = _Xj7xCxJ1;
        "pkg-1.2.13+1.20.4-fabric" = _9HwVBmbJ;
        "pkg-1.2.13+1.20.6-fabric" = _Z4sPylCR;
        "pkg-1.2.13+1.20.6-neoforge" = _bKXy6tWA;
        "pkg-1.2.14+1.19.2-forge" = _LNw8xhY1;
        "pkg-1.2.14+1.19.2-fabric" = _cxatW0Qh;
        "pkg-1.2.14+1.20.4-neoforge" = _1ZDtilFf;
        "pkg-1.2.14+1.20.4-forge" = _2Ps4um76;
        "pkg-1.2.14+1.20.4-fabric" = _8eoEPo8E;
        "pkg-1.2.14+1.20.6-fabric" = _CdHWqPx2;
        "pkg-1.2.14+1.20.6-neoforge" = _rH9ktH6J;
        "pkg-1.2.15+1.19.2-fabric" = _wrvAzLRZ;
        "pkg-1.2.15+1.19.2-forge" = _NjjMcdYf;
        "pkg-1.2.15+1.20.4-fabric" = _Rh3MdqnM;
        "pkg-1.2.15+1.20.4-forge" = _lTRPaThw;
        "pkg-1.2.15+1.20.4-neoforge" = _Cq7J3qt5;
        "pkg-1.2.15+1.20.6-fabric" = _aY5V6MjG;
        "pkg-1.2.15+1.20.6-neoforge" = _iByzP2fT;
        "pkg-1.2.16+1.19.2-forge" = _N1D10Unu;
        "pkg-1.2.16+1.19.2-fabric" = _jQuacF3O;
        "pkg-1.2.16+1.20.4-neoforge" = _KIBNJ6Eg;
        "pkg-1.2.16+1.20.4-forge" = _yhbD6glS;
        "pkg-1.2.16+1.20.4-fabric" = _XHrZaGCh;
        "pkg-1.2.16+1.20.6-neoforge" = _8j42F49p;
        "pkg-1.2.16+1.20.6-fabric" = _LJDBWhHU;
        "pkg-1.2.17+1.19.2-fabric" = _5P52J1TG;
        "pkg-1.2.17+1.19.2-forge" = _us6sBMnH;
        "pkg-1.2.17+1.20.4-fabric" = _115Ubn3O;
        "pkg-1.2.17+1.20.4-neoforge" = _wXKNaUIY;
        "pkg-1.2.17+1.20.4-forge" = _DQelIUm0;
        "pkg-1.2.17+1.20.6-fabric" = _5PNUSQdg;
        "pkg-1.2.17+1.20.6-neoforge" = _nASiIiZX;
        "pkg-1.2.18+1.19.2-fabric" = _Z3V4Ooz5;
        "pkg-1.2.18+1.19.2-forge" = _qoAsDnt8;
        "pkg-1.2.18+1.20.4-fabric" = _HX5WEfoR;
        "pkg-1.2.18+1.20.4-neoforge" = _7twUbHcf;
        "pkg-1.2.18+1.20.4-forge" = _XgQjD9fF;
        "pkg-1.2.18+1.20.6-neoforge" = _wO9OiAE5;
        "pkg-1.2.18+1.20.6-fabric" = _fZXxgmhr;
        "pkg-1.2.18+1.21-neoforge" = _D5RdEm0i;
        "pkg-1.2.18+1.21-fabric" = _DA0kxiSe;
        "pkg-1.2.19+1.19.2-fabric" = _EYfMojUm;
        "pkg-1.2.19+1.19.2-forge" = _UBGmAH7G;
        "pkg-1.2.19+1.20.4-fabric" = _15AO7hhI;
        "pkg-1.2.19+1.20.4-neoforge" = _hzBCNiAq;
        "pkg-1.2.19+1.20.4-forge" = _bNDIzPW6;
        "pkg-1.2.19+1.20.6-fabric" = _99R9TBcr;
        "pkg-1.2.19+1.20.6-neoforge" = _FOlIrxtD;
        "pkg-1.2.19+1.21.1-neoforge" = _scqbRe6G;
        "pkg-1.2.19+1.21.1-fabric" = _1wCtstqk;
        "pkg-1.2.20+1.19.2-forge" = _5P3Jndqo;
        "pkg-1.2.20+1.19.2-fabric" = _3hcQtIB6;
        "pkg-1.2.20+1.20.4-fabric" = _ntbcEUWv;
        "pkg-1.2.20+1.20.4-forge" = _RTOwYh47;
        "pkg-1.2.20+1.20.4-neoforge" = _IigNsjFB;
        "pkg-1.2.20+1.20.6-fabric" = _9i03nYHg;
        "pkg-1.2.20+1.20.6-neoforge" = _cKYC4Ibz;
        "pkg-1.2.20+1.21.1-fabric" = _jMIMrEow;
        "pkg-1.2.20+1.21.1-neoforge" = _ZzknynUP;
        "pkg-1.2.21+1.19.2-fabric" = _xeClFgJx;
        "pkg-1.2.21+1.19.2-forge" = _OmQBhF2p;
        "pkg-1.2.21+1.20.4-fabric" = _tF2vt38m;
        "pkg-1.2.21+1.20.4-neoforge" = _QhUZq4N8;
        "pkg-1.2.21+1.20.4-forge" = _t7nOFG1k;
        "pkg-1.2.21+1.20.6-fabric" = _P28f9l8e;
        "pkg-1.2.21+1.20.6-forge" = _2nFEEjtP;
        "pkg-1.2.21+1.20.6-neoforge" = _TtgUqtOO;
        "pkg-1.2.21+1.21.1-neoforge" = _e56VUDg2;
        "pkg-1.2.21+1.21.1-fabric" = _ahszC7KU;
        "pkg-1.2.21+1.21.1-forge" = _9uzR8GM6;
        "pkg-1.3.0+1.19.2-fabric" = _174CMHsg;
        "pkg-1.3.0+1.19.2-forge" = _XobHzBZw;
        "pkg-1.3.0+1.20.4-fabric" = _pjGo59EB;
        "pkg-1.3.0+1.20.4-neoforge" = _zeqCJjQa;
        "pkg-1.3.0+1.20.4-forge" = _HfcDIKwc;
        "pkg-1.3.0+1.20.6-fabric" = _ISvVqTAo;
        "pkg-1.3.0+1.20.6-neoforge" = _J1qWHyyO;
        "pkg-1.3.0+1.20.6-forge" = _w5Vr5Pxu;
        "pkg-1.3.0+1.21.1-fabric" = _lQMxcaIl;
        "pkg-1.3.0+1.21.1-neoforge" = _HJBxSBAS;
        "pkg-1.3.0+1.21.1-forge" = _GSWKcdTA;
        "pkg-1.3.0+1.21.3-fabric" = _bsaX5YIx;
        "pkg-1.3.0+1.21.3-neoforge" = _7XyuAagp;
        "pkg-1.3.1+1.19.2-forge" = _BWvVcKIX;
        "pkg-1.3.1+1.19.2-fabric" = _onxZNw3d;
        "pkg-1.3.1+1.20.4-neoforge" = _zHIGlFBD;
        "pkg-1.3.1+1.20.4-fabric" = _MU7bOKWd;
        "pkg-1.3.1+1.20.4-forge" = _K9wJZa3T;
        "pkg-1.3.1+1.21.1-fabric" = _1jIYgnG2;
        "pkg-1.3.1+1.21.1-neoforge" = _M5MRuabk;
        "pkg-1.3.1+1.21.1-forge" = _7e4NK5z2;
        "pkg-1.3.1+1.21.3-fabric" = _yINhkOxW;
        "pkg-1.3.1+1.21.3-neoforge" = _5syrSAlX;
        "pkg-1.3.2+1.19.2-forge" = _6NXCTFJU;
        "pkg-1.3.2+1.19.2-fabric" = _hx9XEPxU;
        "pkg-1.3.2+1.20.4-fabric" = _eUAoLISt;
        "pkg-1.3.2+1.20.4-neoforge" = _Ax0J3uq7;
        "pkg-1.3.2+1.20.4-forge" = _DCUYwauY;
        "pkg-1.3.2+1.21.1-fabric" = _dYT65RCI;
        "pkg-1.3.2+1.21.1-forge" = _fitiSIpU;
        "pkg-1.3.2+1.21.1-neoforge" = _euNMxHVB;
        "pkg-1.3.2+1.21.3-fabric" = _owbCjycO;
        "pkg-1.3.2+1.21.3-neoforge" = _CaeZoifp;
        "pkg-1.3.2+1.21.3-forge" = _in03SJRC;
        "pkg-1.3.3+1.19.2-fabric" = _ECsG2WDZ;
        "pkg-1.3.3+1.19.2-forge" = _6onBEvZn;
        "pkg-1.3.3+1.20.4-fabric" = _H62RYZyG;
        "pkg-1.3.3+1.20.4-forge" = _abfWjwdT;
        "pkg-1.3.3+1.20.4-neoforge" = _3lP6y1pd;
        "pkg-1.3.3+1.21.1-fabric" = _MDHa3xsw;
        "pkg-1.3.3+1.21.1-forge" = _9n6mcxWP;
        "pkg-1.3.3+1.21.1-neoforge" = _6OvZcroD;
        "pkg-1.3.3+1.21.3-fabric" = _jzTwtSjE;
        "pkg-1.3.3+1.21.3-forge" = _8b4Dliu1;
        "pkg-1.3.3+1.21.3-neoforge" = _Eu681JXq;
        "pkg-1.3.3+1.21.4-fabric" = _gh2TGVZk;
        "pkg-1.3.3+1.21.4-neoforge" = _EkeqQ513;
        "pkg-1.3.4+1.19.2-fabric" = _StFP2R3G;
        "pkg-1.3.4+1.19.2-forge" = _EnNFdXHm;
        "pkg-1.3.4+1.20.4-neoforge" = _BCkMlqWk;
        "pkg-1.3.4+1.20.4-fabric" = _Oub8JunR;
        "pkg-1.3.4+1.20.4-forge" = _oFstJPTE;
        "pkg-1.3.4+1.21.1-fabric" = _UiT2QR9Q;
        "pkg-1.3.4+1.21.1-neoforge" = _E77ardrh;
        "pkg-1.3.4+1.21.1-forge" = _C8m29Ywk;
        "pkg-1.3.4+1.21.3-neoforge" = _3wxvSRB6;
        "pkg-1.3.4+1.21.3-forge" = _4klPwf0y;
        "pkg-1.3.4+1.21.3-fabric" = _bDev48Ja;
        "pkg-1.3.4+1.21.4-fabric" = _EEHOa7Ek;
        "pkg-1.3.4+1.21.4-neoforge" = _AYepA5yT;
        "pkg-1.3.5+1.19.2-fabric" = _RlIar3kA;
        "pkg-1.3.5+1.19.2-forge" = _3YjfFST0;
        "pkg-1.3.5+1.20.4-fabric" = _xXPjBbf0;
        "pkg-1.3.5+1.20.4-neoforge" = _8eq5eq5c;
        "pkg-1.3.5+1.20.4-forge" = _vY0gRu5i;
        "pkg-1.3.5+1.21.1-fabric" = _nLsUmFtQ;
        "pkg-1.3.5+1.21.1-neoforge" = _tQw4QnHI;
        "pkg-1.3.5+1.21.1-forge" = _B3VwQGFo;
        "pkg-1.3.5+1.21.3-fabric" = _EI2uPEb5;
        "pkg-1.3.5+1.21.3-neoforge" = _SQ75sT8k;
        "pkg-1.3.5+1.21.3-forge" = _QgF7HLj9;
        "pkg-1.3.5+1.21.4-fabric" = _Av1hDT1W;
        "pkg-1.3.5+1.21.4-neoforge" = _uX54J8VB;
        "pkg-1.3.5+1.21.4-forge" = _gwqJUEyy;
        "pkg-1.3.6+1.19.2-fabric" = _1It9LLOQ;
        "pkg-1.3.6+1.19.2-forge" = _z6ZR80F2;
        "pkg-1.3.6+1.20.4-fabric" = _nCsm7dwb;
        "pkg-1.3.6+1.20.4-neoforge" = _qz4XcXLJ;
        "pkg-1.3.6+1.20.4-forge" = _lLRqAhrD;
        "pkg-1.3.6+1.21.1-fabric" = _20SR13gN;
        "pkg-1.3.6+1.21.1-neoforge" = _GT363RS9;
        "pkg-1.3.6+1.21.1-forge" = _P9yX9Q4Y;
        "pkg-1.3.6+1.21.3-fabric" = _6UzzRn3q;
        "pkg-1.3.6+1.21.3-neoforge" = _Q2O2k8G2;
        "pkg-1.3.6+1.21.3-forge" = _8pz8MLnL;
        "pkg-1.3.6+1.21.4-fabric" = _WnDcuiGo;
        "pkg-1.3.6+1.21.4-forge" = _pNbcOwfL;
        "pkg-1.3.6+1.21.4-neoforge" = _PF2MIAIG;
        "pkg-1.6.0+1.21.1-neoforge" = _cNeyFzTb;
        "pkg-1.6.0+1.21.1-forge" = _UWLzu3QI;
        "pkg-1.6.0+1.21.1-fabric" = _T3rJAYXa;
        "pkg-1.6.1+1.21.1-fabric" = _Eau5kQoZ;
        "pkg-1.6.1+1.21.1-neoforge" = _DtmcGdi9;
        "pkg-1.6.1+1.21.1-forge" = _tdsizuq0;
        "pkg-1.4.0+1.19.2-fabric" = _gPV1o5PO;
        "pkg-1.4.0+1.19.2-forge" = _OWO57F2j;
        "pkg-1.5.0+1.20.4-neoforge" = _TKEYKmZh;
        "pkg-1.5.0+1.20.4-forge" = _xNaL38Bs;
        "pkg-1.5.0+1.20.4-fabric" = _6QvRWWbF;
        "pkg-1.6.2+1.21.1-neoforge" = _MlT0XaoV;
        "pkg-1.6.2+1.21.1-forge" = _LxFaqvYY;
        "pkg-1.6.2+1.21.1-fabric" = _9mHDDtCo;
        "pkg-1.7.0+1.21.3-fabric" = _tpyJcYBi;
        "pkg-1.7.0+1.21.3-forge" = _WhwSGX8G;
        "pkg-1.7.0+1.21.3-neoforge" = _H1c5UwGs;
        "pkg-1.8.0+1.21.4-fabric" = _ddjmgf0b;
        "pkg-1.8.0+1.21.4-neoforge" = _GvlZ6XnU;
        "pkg-1.8.0+1.21.4-forge" = _vNww15Pd;
        "pkg-1.9.0+1.21.5-fabric" = _4I1VLQHK;
        "pkg-1.6.3+1.21.1-forge" = _YQvUcdKu;
        "pkg-1.6.3+1.21.1-fabric" = _MVZzhAQJ;
        "pkg-1.6.3+1.21.1-neoforge" = _zjpu4fnp;
        "pkg-1.9.1+1.21.5-neoforge" = _CNaUIORb;
        "pkg-1.9.1+1.21.5-fabric" = _2v1FetLC;
        "pkg-1.6.4+1.21.1-fabric" = _mO6snTsy;
        "pkg-1.6.4+1.21.1-forge" = _A9AUUh8S;
        "pkg-1.6.4+1.21.1-neoforge" = _7efCI4DZ;
        "pkg-1.6.5+1.21.1-neoforge" = _paIuk6sO;
        "pkg-1.6.5+1.21.1-fabric" = _UDgEo3mK;
        "pkg-1.6.5+1.21.1-forge" = _DBogGBsN;
        "pkg-1.9.2+1.21.5-neoforge" = _HepLVXMu;
        "pkg-1.9.2+1.21.5-fabric" = _fpjFGEDv;
        "pkg-1.9.3+1.21.5-neoforge" = _x37EKGO7;
        "pkg-1.9.3+1.21.5-fabric" = _DjnwJdjY;
        "pkg-1.9.4+1.21.5-neoforge" = _Z4b7bI4c;
        "pkg-1.9.4+1.21.5-fabric" = _rkJHrPyc;
        "pkg-1.9.5+1.21.5-fabric" = _dk4uLLmV;
        "pkg-1.9.5+1.21.5-neoforge" = _IGwQSb2g;
        "pkg-1.10.0+1.21.6-fabric" = _sSXx59vk;
        "pkg-1.10.0+1.21.6-neoforge" = _2aWYHkHQ;
        "pkg-1.10.1+1.21.6-fabric" = _fjgmP9rv;
        "pkg-1.10.1+1.21.6-neoforge" = _J6rsvVaI;
        "pkg-1.11.0+1.21.7-fabric" = _cuRqLEAA;
        "pkg-1.11.0+1.21.7-neoforge" = _AeIwcc2p;
        "pkg-1.5.1+1.20.4-fabric" = _zJD8Yaa3;
        "pkg-1.5.1+1.20.4-forge" = _ShWk0wN3;
        "pkg-1.5.1+1.20.4-neoforge" = _CiZKgtZH;
        "pkg-1.6.6+1.21.1-fabric" = _giRXGeHH;
        "pkg-1.6.6+1.21.1-forge" = _yPO020MY;
        "pkg-1.6.6+1.21.1-neoforge" = _mWsZ4opk;
        "pkg-1.7.1+1.21.3-fabric" = _6nwCAkay;
        "pkg-1.7.1+1.21.3-neoforge" = _YQSlMoyS;
        "pkg-1.7.1+1.21.3-forge" = _MXTd4ExC;
        "pkg-1.8.1+1.21.4-fabric" = _TBPG2PYa;
        "pkg-1.8.1+1.21.4-forge" = _3OC182Ej;
        "pkg-1.8.1+1.21.4-neoforge" = _5IFvfSbY;
        "pkg-1.9.6+1.21.5-neoforge" = _43iGBJDV;
        "pkg-1.9.6+1.21.5-fabric" = _kcSoZlE9;
        "pkg-1.10.2+1.21.6-fabric" = _yrqsKf6n;
        "pkg-1.10.2+1.21.6-neoforge" = _FSZjzy4R;
        "pkg-1.11.1+1.21.7-neoforge" = _tg1pfqf9;
        "pkg-1.11.1+1.21.7-fabric" = _riHCXrIc;
        "pkg-1.12.0+1.21.8-fabric" = _dFWSDYH8;
        "pkg-1.12.0+1.21.8-neoforge" = _sHIZVDCA;
        "pkg-1.10.3+1.21.6-neoforge" = _d8kpGqVx;
        "pkg-1.10.3+1.21.6-fabric" = _9JPEk4KN;
        "pkg-1.11.2+1.21.7-fabric" = _WbU84LUp;
        "pkg-1.11.2+1.21.7-neoforge" = _emVJjGLj;
        "pkg-1.12.1+1.21.8-neoforge" = _Q596jkvR;
        "pkg-1.12.1+1.21.8-fabric" = _XxwOC2sk;
        "pkg-1.5.2+1.20.4-forge" = _aFMmx5Ig;
        "pkg-1.5.2+1.20.4-fabric" = _KIhjQeSw;
        "pkg-1.5.2+1.20.4-neoforge" = _cb3A2NLq;
        "pkg-1.6.7+1.21.1-forge" = _70fY7ZKu;
        "pkg-1.6.7+1.21.1-neoforge" = _VerzLexd;
        "pkg-1.6.7+1.21.1-fabric" = _5DprOQTR;
        "pkg-1.7.2+1.21.3-fabric" = _2zcdbf00;
        "pkg-1.7.2+1.21.3-forge" = _oJhhVc3a;
        "pkg-1.7.2+1.21.3-neoforge" = _Nm2QDRX6;
        "pkg-1.8.2+1.21.4-fabric" = _45EAWunP;
        "pkg-1.8.2+1.21.4-forge" = _VBfpe6hZ;
        "pkg-1.8.2+1.21.4-neoforge" = _bxFcCVNQ;
        "pkg-1.9.7+1.21.5-neoforge" = _95M404oY;
        "pkg-1.9.7+1.21.5-fabric" = _AJh4ziDx;
        "pkg-1.13.0+1.21.9-fabric" = _qpCb3lJs;
        "pkg-1.13.0+1.21.9-neoforge" = _cbfem1bW;
        "pkg-1.13.1+1.21.10-neoforge" = _rm1AZ9lI;
        "pkg-1.13.1+1.21.10-fabric" = _pAXzwgEN;
        "pkg-1.12.2+1.21.8-neoforge" = _QACTAwD8;
        "pkg-1.12.2+1.21.8-fabric" = _OrO3H19n;
        "pkg-1.13.2+1.21.10-fabric" = _mmM8JfKR;
        "pkg-1.13.2+1.21.10-neoforge" = _tbJcnc8g;
        "pkg-1.5.3+1.20.4-forge" = _a4stvpj6;
        "pkg-1.5.3+1.20.4-neoforge" = _lPEqSBsI;
        "pkg-1.5.3+1.20.4-fabric" = _AIFWhP2u;
        "pkg-1.6.8+1.21.1-forge" = _giAcSaOA;
        "pkg-1.6.8+1.21.1-fabric" = _uA4KLlrL;
        "pkg-1.6.8+1.21.1-neoforge" = _fWangWhY;
        "pkg-1.8.3+1.21.4-forge" = _JcdiQY7o;
        "pkg-1.8.3+1.21.4-neoforge" = _QmpRzrbj;
        "pkg-1.8.3+1.21.4-fabric" = _WuuAYaNS;
        "pkg-1.12.3+1.21.8-fabric" = _Pan1UGq3;
        "pkg-1.12.3+1.21.8-neoforge" = _vNsGSrRo;
        "pkg-1.13.3+1.21.10-neoforge" = _GG1FIh6m;
        "pkg-1.13.3+1.21.10-fabric" = _s1ScSs7O;
        "pkg-1.14.0+1.21.11-neoforge" = _rj7FM1f3;
        "pkg-1.14.0+1.21.11-fabric" = _1aEOUoaS;
        "pkg-1.6.9+1.21.1-neoforge" = _7TFPpGUU;
        "pkg-1.6.9+1.21.1-fabric" = _sy5ig8EF;
        "pkg-1.6.9+1.21.1-forge" = _prV7885W;
        "pkg-1.8.5+1.21.4-fabric" = _6SW04MkK;
        "pkg-1.8.5+1.21.4-neoforge" = _2fNalwF4;
        "pkg-1.8.5+1.21.4-forge" = _szcKFQBd;
        "pkg-1.12.4+1.21.8-fabric" = _49MPhz8k;
        "pkg-1.12.4+1.21.8-neoforge" = _EcRJOKd0;
        "pkg-1.13.4+1.21.10-fabric" = _aazFNTEy;
        "pkg-1.13.4+1.21.10-neoforge" = _P0Zr7xDx;
        "pkg-1.14.1+1.21.11-neoforge" = _S7zL2h9v;
        "pkg-1.14.1+1.21.11-fabric" = _XCnavm6o;
        "pkg-1.5.4+1.20.4-neoforge" = _wTyzrWRz;
        "pkg-1.5.4+1.20.4-fabric" = _Us8JqrP9;
        "pkg-1.5.4+1.20.4-forge" = _OomXW3xp;
        "pkg-1.6.10+1.21.1-fabric" = _yHztKxR5;
        "pkg-1.6.10+1.21.1-forge" = _iXVyMPxj;
        "pkg-1.6.10+1.21.1-neoforge" = _PhxY0iHw;
        "pkg-1.8.6+1.21.4-fabric" = _CFJfGS8F;
        "pkg-1.8.6+1.21.4-forge" = _kFkZRmDt;
        "pkg-1.8.6+1.21.4-neoforge" = _W5rVYtSz;
        "pkg-1.12.5+1.21.8-fabric" = _iNldtLH8;
        "pkg-1.12.5+1.21.8-neoforge" = _VnGTYiHN;
        "pkg-1.13.5+1.21.10-fabric" = _ntac1Na0;
        "pkg-1.13.5+1.21.10-neoforge" = _YzWS4cCk;
        "pkg-1.14.2+1.21.11-fabric" = _QwkfUKSj;
        "pkg-1.14.2+1.21.11-neoforge" = _4srycLDJ;
        "pkg-1.15.0+26.1-fabric" = _m3ka9Hsm;
        "pkg-1.15.0+26.1-neoforge" = _9eHiVFXX;
        "pkg-1.15.1+26.1.1-neoforge" = _tamty6yW;
        "pkg-1.15.1+26.1.1-fabric" = _UM3jWaXo;
        "pkg-1.15.2+26.1.2-fabric" = _lRuSLf0Y;
        "pkg-1.15.2+26.1.2-neoforge" = _KibcXkbk;
        "pkg-1.16.0+26.2-fabric" = _FQU5HWsp;
        "pkg-1.16.0+26.2-neoforge" = _TuU2J6Rb;
        "pkg-1.16.1+26.2-neoforge" = _Wc4AcZiR;
        "pkg-1.16.1+26.2-fabric" = _4r0uMdy5;
        "pkg-1.5.5+1.20.4-fabric" = _iwYUrQJO;
        "pkg-1.5.5+1.20.4-forge" = _rvsLEEZU;
        "pkg-1.5.5+1.20.4-neoforge" = _hGriwiGl;
        "pkg-1.6.11+1.21.1-forge" = _xlYmE90r;
        "pkg-1.6.11+1.21.1-neoforge" = _zxT50PTW;
        "pkg-1.6.11+1.21.1-fabric" = _ATB4eNEP;
        "pkg-1.8.7+1.21.4-fabric" = _gF6yVXr9;
        "pkg-1.8.7+1.21.4-neoforge" = _akEJ6o1m;
        "pkg-1.8.7+1.21.4-forge" = _6uDAsbov;
        "pkg-1.12.6+1.21.8-neoforge" = _kefcE2Oq;
        "pkg-1.12.6+1.21.8-fabric" = _zihthChu;
        "pkg-1.13.6+1.21.10-fabric" = _9hztj0xA;
        "pkg-1.13.6+1.21.10-neoforge" = _NWeE5tOf;
        "pkg-1.14.3+1.21.11-fabric" = _4EwhsTu7;
        "pkg-1.14.3+1.21.11-neoforge" = _jaBvDEKq;
        "pkg-1.15.3+26.1-neoforge" = _adbrNJLm;
        "pkg-1.15.3+26.1-fabric" = _xOA9hbpf;
        "pkg-1.16.2+26.2-fabric" = _uJHxuQxy;
        "pkg-1.16.2+26.2-neoforge" = _E76T0Qen;
        "pkg-1.6.12+1.21.1-neoforge" = _B2MHnfkW;
        "pkg-1.6.12+1.21.1-forge" = _3xXzj2GW;
        "pkg-1.6.12+1.21.1-fabric" = _nLX2NbyQ;
        "pkg-1.16.3+26.2-fabric" = _rxHcwxdQ;
        "pkg-1.16.3+26.2-neoforge" = _HMgMQYxb;
        "pkg-1.6.13+1.21.1-fabric" = _hZvFDqhH;
        "pkg-1.6.13+1.21.1-neoforge" = _xcQYt0Uy;
        "pkg-1.6.13+1.21.1-forge" = _UjgM7lFA;
        "pkg-1.16.4+26.2-neoforge" = _kc7MJI19;
        "pkg-1.16.4+26.2-fabric" = _vkW9vHhp;
        "pkg-1.6.14+1.21.1-neoforge" = _OUpXxw4n;
        "pkg-1.6.14+1.21.1-fabric" = _7XKnsIC8;
        "pkg-1.6.14+1.21.1-forge" = _MEq3Zttz;
        "pkg-1.16.5+26.2-neoforge" = _4C8Vb9ab;
