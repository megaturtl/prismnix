...
let
    versions = (let
        ...
        _J4I1wxJZ = {
            "id" = "J4I1wxJZ";
            "file" = "Clumps-fabric-26.3-26.3.2.jar";
            "hash" = "sha512-jBZq6X4ZmdDyE9Chgdbvh7mWSAFsksmqFBTSwuJDZLElSVac1+JHo9Z133A65qioj8F10/UngYxxBXhAhQjIqw==";
        };
        _kV095inH = {
            "id" = "kV095inH";
            "file" = "Clumps-neoforge-26.3-26.3.2.jar";
            "hash" = "sha512-cQrB8qyPL205tqT1ansBWaMrtk0/+DN+IPyp65kbMt9U04x8DB40h6fCIL3oCYje+FYpJfvF3F4slBNCRPQbSg==";
        };
    in {
        "9hlctcDE" = _9hlctcDE;
        "2PT9pbRj" = _2PT9pbRj;
        ...
        "pkg-5.0.1" = _fTWVa6NX;
        "pkg-5.0.2" = _Km2A7nLe;
        "pkg-5.0.1.2" = _2MDA8v5I;
        "pkg-5.0.1.3" = _A8fHbFS6;
        "pkg-6.0.0.2" = _D4jsjhXA;
        "pkg-6.0.0.3" = _ihiDVwNa;
        "pkg-5.0.2.4" = _F8pfwrMz;
        "pkg-6.0.0.4" = _W9FnDe1l;
        "pkg-5.0.2.5" = _aqIk2Edw;
        "pkg-6.0.0.5" = _xGvjcE7h;
        "pkg-6.0.0.7" = _HT5eROlq;
        "pkg-5.0.2.6" = _KBjSLpWi;
        "pkg-6.0.0.8" = _k0Jwkd3m;
        "pkg-6.0.0.9" = _BLPxOCPb;
        "pkg-6.0.0.10" = _14gDpVDM;
        "pkg-6.0.0.11" = _At7EuPwE;
        "pkg-6.0.0.12" = _ZG68IYMG;
        "pkg-6.0.0.13" = _gKfIS5UE;
        "pkg-6.0.0.14" = _CK3gP3au;
        "pkg-6.0.0.15" = _ABZ5Czfa;
        "pkg-6.0.0.16" = _gjSDwzYc;
        "pkg-6.0.0.17" = _60tArTRZ;
        "pkg-6.0.0.18" = _Ge8WfKwm;
        "pkg-6.0.0.19" = _a4YkXTss;
        "pkg-6.0.0.20" = _qMEjJ46Z;
        "pkg-6.0.0.21" = _iKpD3bu5;
        "pkg-6.0.0.22" = _v6nZL7ij;
        "pkg-5.0.2.7" = _kX922wv5;
        "pkg-6.0.0.23" = _QfW5PBK0;
        "pkg-6.0.0.24" = _QqCGODhN;
        "pkg-6.0.0.25" = _DeVfca9r;
        "pkg-5.0.2.8" = _bXpU2lu9;
        "pkg-fabric-1.17-7.0.0.2" = _Y3KgUihY;
        "pkg-fabric-1.17.1-7.0.4" = _c5XwSPGO;
        "pkg-fabric-1.17.1-7.0.5" = _LTLe60ZJ;
        "pkg-7.0.6" = _qgAkNod5;
        "pkg-7.0.7" = _rcImocgP;
        "pkg-6.0.0.26" = _ghtGew4o;
        "pkg-7.0.8" = _THJnSpxM;
        "pkg-6.0.0.27" = _WEPinRvr;
        "pkg-7.0.10" = _nZ5nhrKv;
        "pkg-8.0.1" = _4oD9zKPV;
        "pkg-8.0.2" = _3AH29I4c;
        "pkg-8.0.3" = _aogHNv3y;
        "pkg-8.0.4" = _QdyDo2La;
        "pkg-8.0.0+5" = _EAjgpiKA;
        "pkg-6.0.0.28" = _UutzgwbZ;
        "pkg-8.0.0+6" = _qy5gqUCM;
        "pkg-8.0.0+7" = _gRpWIMha;
        "pkg-8.0.0+8" = _xJwCqvzt;
        "pkg-9.0.0+1" = _ssnANiog;
        "pkg-8.0.0+9" = _lI1Rscqr;
        "pkg-9.0.0+2" = _nLgUCki4;
        "pkg-9.0.0+3" = _yPvrslL3;
        "pkg-8.0.0+10" = _ptOjPKUD;
        "pkg-9.0.0+4" = _sh7X4I2y;
        "pkg-8.0.0+11" = _r69CWcGO;
        "pkg-8.0.0+12" = _Hrt4D2se;
        "pkg-9.0.0+5" = _UmFe4S0c;
        "pkg-9.0.0+6" = _MkMRGkr6;
        "pkg-8.0.0+13" = _klW0myvn;
        "pkg-8.0.0+14" = _zkCCKRNT;
        "pkg-9.0.0+7" = _oTaQQP72;
        "pkg-9.0.0+8" = _HkwE1Hla;
        "pkg-9.0.0+9" = _jpwxpMB1;
        "pkg-8.0.0+15" = _wb2m4G4N;
        "pkg-9.0.0+10" = _FRktsfso;
        "pkg-9.0.0+11" = _UId1Oi4e;
        "pkg-8.0.0+16" = _MKiINIqy;
        "pkg-8.0.0+17" = _t18CfscF;
        "pkg-9.0.0+14" = _3GURrv52;
        "pkg-9.0.0+15" = _Nbrq3pvu;
        "pkg-9.0.0+16" = _Y5BmdUtM;
        "pkg-10.0.0.1" = _aTvlJ7V9;
        "pkg-10.0.0.2" = _qPvk2bmy;
        "pkg-10.0.0.3" = _pf9z7BdE;
        "pkg-11.0.0.1" = _5q2RWTZ9;
        "pkg-12.0.0.1" = _GnrWAVQK;
        "pkg-12.0.0.2" = _30DEnQJE;
        "pkg-11.0.0.2" = _ePSovy2R;
        "pkg-12.0.0.3" = _l3neajc5;
        "pkg-13.0.0.1" = _62dNqSyR;
        "pkg-13.0.0.2" = _h7A9nDyj;
        "pkg-13.0.0.3" = _JLW0F6Gv;
        "pkg-13.0.0.4" = _7uEaptM0;
        "pkg-13.0.0.5" = _rr2I0f2d;
        "pkg-13.0.0.6" = _FrcMJxfb;
        "pkg-14.0.0.1" = _ShUp2kQ2;
        "pkg-15.0.0.2" = _MWDyKE94;
        "pkg-12.0.0.4" = _hefSwtn6;
        "pkg-16.0.0.1" = _RE9nKxFT;
        "pkg-17.0.0.1" = _U9UF2NCO;
        "pkg-18.0.0.1" = _BBnb9L4J;
        "pkg-18.0.0.2" = _twamfmIi;
        "pkg-19.0.0.1" = _jo7lDoK4;
        "pkg-20.0.0.1" = _ubLGNAmB;
        "pkg-21.0.0.1" = _vDtmuZ5u;
        "pkg-21.0.0.2" = _EIZSZGPU;
        "pkg-22.0.0.1" = _2zQSp93Z;
        "pkg-23.0.0.1" = _2qitNPmx;
        "pkg-24.0.0.2" = _aSz9kT32;
        "pkg-25.0.0.1" = _Zfh2Lgy3;
        "pkg-26.0.0.1" = _CCwMI3eO;
        "pkg-27.0.0.2" = _nDafBe3P;
        "pkg-28.0.0.1" = _GfXBPCIN;
        "pkg-29.0.0.1" = _a8bNGdqK;
        "pkg-26.1.0.1" = _rRxlZyRs;
        "pkg-26.1.0.2" = _9kN5zABQ;
        "pkg-26.1.1.1" = _r5kiHYrj;
        "pkg-26.1.2.1" = _RXNrUIjA;
        "pkg-26.2.1" = _FPYWjnnE;
        "pkg-26.3.2" = _kV095inH;
        "default" = _kV095inH;
    });
