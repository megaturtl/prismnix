...
let
    versions = (let
        ...
        _6i6zmL3e = {
            "id" = "6i6zmL3e";
            "file" = "justenoughfilters-3.2.0+fabric-26.1.2.jar";
            "hash" = "sha512-Ij4jQPsrSjE2OxKJhz5M4Jfgy5WIDoD9GTJg9ZN4XhnXKqXBrPbSORS+qCpyJYxB6TmX4i1Uiozbfi/QNMAtEw==";
        };
        _eQIg1zOR = {
            "id" = "eQIg1zOR";
            "file" = "justenoughfilters-3.2.0+neoforge-26.1.2.jar";
            "hash" = "sha512-ZUhf5m1LObUO1pIIG93x3WRgmezopDzHLebZfZAOkAb9W8kRlrXyV4o6gOPDkzA29EPuVnRHcJDtZPGjUwn4Hg==";
        };
        _VP6OPAl2 = {
            "id" = "VP6OPAl2";
            "file" = "justenoughfilters-3.2.0+neoforge-26.2.jar";
            "hash" = "sha512-EqwUTvsII9B6rSH97sE8Jp30HIZlhkjQvCb8Y9VlXoGMJul1h0yBe/iJFQ3cV7bQ0DlWLD6Icjv2HzmQQXTLuA==";
        };
        _UHcUj9wX = {
            "id" = "UHcUj9wX";
            "file" = "justenoughfilters-3.2.0+fabric-26.2.jar";
            "hash" = "sha512-RTDPL0PHaysXt88Xjc5NbjzMIZoKG03eqqHhAKvTuQJhPKb4mvGmF9jMNl7j1Lwa+C98qzpCrvljzZjP1zXsqg==";
        };
        _f1C5OQsH = {
            "id" = "f1C5OQsH";
            "file" = "justenoughfilters-3.2.0+neoforge-1.21.11.jar";
            "hash" = "sha512-+OWjW4PwW55TAGQak/S7W1gBY+jowUYggZwX3tdbg0C6WIRPqzzqL3+ZheAZ4NVh1u617+xhzY7iDd5YT05EeQ==";
        };
        _l9O0GrUb = {
            "id" = "l9O0GrUb";
            "file" = "justenoughfilters-3.2.0+fabric-1.21.11.jar";
            "hash" = "sha512-oCTojngRn3Dufne9tvr4dWZJdw6JKuVbGJF9Cmzt+W8+4jQQpr4Sz1tYGBueeePWAKrpvbdRoL4uyNm9o2l8UQ==";
        };
        _O6o22Ohl = {
            "id" = "O6o22Ohl";
            "file" = "justenoughfilters-3.2.0+neoforge-1.21.1.jar";
            "hash" = "sha512-tfwJywAhpxpXuSnXqUK6ZPUQZ2mSvVb6qhtnmMBFz8gdBkO5lAmAfcg8ULKCoQCvpeKk71TiSSCAUb6Dygd2dw==";
        };
        _bVhjXONP = {
            "id" = "bVhjXONP";
            "file" = "justenoughfilters-3.2.0+fabric-1.21.1.jar";
            "hash" = "sha512-RVPiXON7ErG2EbULeMBlBZuaOQD0ZZyVD+tKGwGoVPjd+oc5bjnDl41pVPRdGjTjLwBipy9XoWLGqhXKmu+eiQ==";
        };
        _bNuhqaIa = {
            "id" = "bNuhqaIa";
            "file" = "justenoughfilters-3.2.0+forge-1.20.1.jar";
            "hash" = "sha512-nC1U462IEkDkL1mDffTC6hY7CtHEtv97umu4Gsdd6LZAaIdwglOpr2teKovrdr2QDagfMXD1PUKd2L4mZKcAhw==";
        };
        _a4SpK7Lq = {
            "id" = "a4SpK7Lq";
    ...
    in {
        ...
        "pkg-fabric-1.0.0+1.21.1" = _Eeuk5rEH;
        "pkg-neoforge-1.0.0+1.21.1" = _xQYEU09O;
        "pkg-fabric-1.0.1+1.21.1" = _w5dwpT7D;
        "pkg-neoforge-1.0.1+1.21.1" = _qQehuVq9;
        "pkg-fabric-1.0.1+1.20.1" = _Ci9nEiAN;
        "pkg-forge-1.0.1+1.20.1" = _JNSRVO1e;
        "pkg-fabric-1.1.0+1.21.1" = _e9a5KV2w;
        "pkg-neoforge-1.1.0+1.21.1" = _fpzFpmEc;
        "pkg-fabric-1.1.0+1.20.1" = _MAK9IYZk;
        "pkg-forge-1.1.0+1.20.1" = _d5WzZmfj;
        "pkg-fabric-1.1.0+1.21.10" = _HWzHQQgW;
        "pkg-neoforge-1.1.0+1.21.10" = _d5vLOmAn;
        "pkg-fabric-1.1.1+1.21.10" = _QUDYGYaR;
        "pkg-neoforge-1.1.1+1.21.10" = _eThSNS6E;
        "pkg-fabric-1.1.1+1.21.1" = _lX75fPHK;
        "pkg-neoforge-1.1.1+1.21.1" = _ENIPH2ta;
        "pkg-fabric-1.1.1+1.20.1" = _UsVFVE87;
        "pkg-forge-1.1.1+1.20.1" = _AFovezq7;
        "pkg-fabric-1.1.2+1.21.10" = _pfpco6DF;
        "pkg-neoforge-1.1.2+1.21.10" = _jwnf6LwU;
        "pkg-fabric-1.1.2+1.21.1" = _arvJi7XB;
        "pkg-neoforge-1.1.2+1.21.1" = _2NUkpIS2;
        "pkg-fabric-1.1.2+1.20.1" = _hFzDIDm0;
        "pkg-forge-1.1.2+1.20.1" = _RuD5SWfQ;
        "pkg-fabric-1.1.3+1.21.1" = _2yOPsGat;
        "pkg-neoforge-1.1.3+1.21.1" = _zFvhNQAj;
        "pkg-fabric-1.1.3+1.20.1" = _uiduz1Yz;
        "pkg-forge-1.1.3+1.20.1" = _c77uZ03t;
        "pkg-fabric-1.1.3+1.21.10" = _6QNUez0Z;
        "pkg-neoforge-1.1.3+1.21.10" = _Hy8SKQIx;
        "pkg-forge-1.1.4+1.20.1" = _2oaidglW;
        "pkg-fabric-1.1.5+1.20.1" = _KZVlxgpW;
        "pkg-forge-1.1.5+1.20.1" = _8abWmMmp;
        "pkg-neoforge-1.2.0+1.21.1" = _ni2gh2D1;
        "pkg-fabric-1.2.0+1.21.1" = _dtlrSZR1;
        "pkg-fabric-1.2.0+1.20.1" = _svf8e8wl;
        "pkg-forge-1.2.0+1.20.1" = _ahHRQiEe;
        "pkg-fabric-1.2.0+1.21.10" = _nroh3DFk;
        "pkg-neoforge-1.2.0+1.21.10" = _jzqFolqx;
        "pkg-fabric-1.3.0+1.21.10" = _3kb6yyKD;
        "pkg-neoforge-1.3.0+1.21.10" = _dbjeXbgq;
        "pkg-fabric-1.3.0+1.21.1" = _ANFpExcB;
        "pkg-neoforge-1.3.0+1.21.1" = _Osmb7AZd;
        "pkg-fabric-1.3.0+1.20.1" = _XZ5YHTBi;
        "pkg-forge-1.3.0+1.20.1" = _reOijqO2;
        "pkg-neoforge-2.0.0-beta+1.21.1" = _N0nhpiGJ;
        "pkg-fabric-2.0.0-beta+1.21.1" = _kfREYeOz;
        "pkg-neoforge-2.1.0-beta+1.21.1" = _yO5xo7r6;
        "pkg-fabric-2.1.0-beta+1.21.1" = _iws0jVUV;
        "pkg-neoforge-2.2.0+1.21.1" = _g0VqckfV;
        "pkg-fabric-2.2.0+1.21.1" = _JOWFfFOB;
        "pkg-fabric-2.2.0+1.20.1" = _mBscUjtg;
        "pkg-forge-2.2.0+1.20.1" = _oEPjYQo1;
        "pkg-neoforge-2.3.0+1.21.1" = _63J0Hft5;
        "pkg-fabric-2.3.0+1.21.1" = _KDGFqKdq;
        "pkg-fabric-2.4.0+1.20.1" = _BQ7uQdvz;
        "pkg-forge-2.4.0+1.20.1" = _Xbs0d9Mb;
        "pkg-fabric-2.4.0+1.21.11" = _bPRr1rtB;
        "pkg-neoforge-2.4.0+1.21.11" = _mWiBE59b;
        "pkg-fabric-2.4.0+1.21.1" = _SpRN0OQ2;
        "pkg-neoforge-2.4.0+1.21.1" = _KjLF557Y;
        "pkg-neoforge-2.5.0+1.21.1" = _VfUbGXC6;
        "pkg-fabric-2.5.0+1.21.1" = _XVJJ3vPH;
        "pkg-forge-2.5.0+1.20.1" = _K5G5vxAW;
        "pkg-fabric-2.5.0+1.20.1" = _pTPq9DSj;
        "pkg-neoforge-2.5.0+1.21.11" = _Mj7uyv6x;
        "pkg-fabric-2.5.0+1.21.11" = _dN41DerM;
        "pkg-neoforge-2.5.0-beta+26.1.2" = _LhfVnbQK;
        "pkg-fabric-2.5.0-beta+26.1.2" = _vcRAjTWj;
        "pkg-3.0.0-beta+neoforge-1.21.1" = _1t8QlKbh;
        "pkg-3.0.0-beta+fabric-1.21.1" = _83QxZPbf;
        "pkg-3.0.1-beta+neoforge-1.21.1" = _6Ymunoi1;
        "pkg-3.0.1-beta+fabric-1.21.1" = _vQw7cU5x;
        "pkg-3.0.1-beta+forge-1.20.1" = _K7kEMEXZ;
        "pkg-3.0.1-beta+fabric-1.20.1" = _OWP2andl;
        "pkg-3.1.0+neoforge-1.21.1" = _Y190Nftt;
        "pkg-3.1.0+fabric-1.21.1" = _7IqYELqP;
        "pkg-3.1.2+forge-1.20.1" = _fJr0Hhyr;
        "pkg-3.1.2+fabric-1.20.1" = _KC5U2png;
        "pkg-3.1.2+neoforge-1.21.1" = _Fl7jXZYB;
        "pkg-3.1.2+fabric-1.21.1" = _QvWjAuRm;
        "pkg-3.1.3+fabric-1.21.11" = _VZN4eQ6W;
        "pkg-3.1.3+neoforge-1.21.11" = _BNrx0mEJ;
        "pkg-3.1.4+neoforge-26.1.2" = _MbftBHM5;
        "pkg-3.1.4+fabric-26.1.2" = _T9cHttrv;
        "pkg-3.1.4+neoforge-1.21.11" = _CdTG96DT;
        "pkg-3.1.4+fabric-1.21.11" = _KVvUi5ON;
        "pkg-3.1.4+forge-1.20.1" = _dvteCHrG;
        "pkg-3.1.4+fabric-1.20.1" = _CqopBlhN;
        "pkg-3.1.4+neoforge-1.21.1" = _tYGxsZCC;
        "pkg-3.1.4+fabric-1.21.1" = _OPEJldTy;
        "pkg-3.1.5+neoforge-1.21.1" = _QbbpMkgy;
        "pkg-3.1.5+fabric-1.21.1" = _UAW1FV2F;
        "pkg-3.1.5+forge-1.20.1" = _E3O49Uxc;
        "pkg-3.1.5+fabric-1.20.1" = _wihQcXFd;
        "pkg-3.1.5+neoforge-1.21.11" = _H356RQOe;
        "pkg-3.1.5+fabric-1.21.11" = _QJJOo0uj;
        "pkg-3.1.5+neoforge-26.1.2" = _T8CFmiPV;
        "pkg-3.1.5+fabric-26.1.2" = _Cd4wN7b5;
        "pkg-3.2.0+fabric-26.1.2" = _6i6zmL3e;
        "pkg-3.2.0+neoforge-26.1.2" = _eQIg1zOR;
        "pkg-3.2.0+neoforge-26.2" = _VP6OPAl2;
        "pkg-3.2.0+fabric-26.2" = _UHcUj9wX;
        "pkg-3.2.0+neoforge-1.21.11" = _f1C5OQsH;
        "pkg-3.2.0+fabric-1.21.11" = _l9O0GrUb;
        "pkg-3.2.0+neoforge-1.21.1" = _O6o22Ohl;
