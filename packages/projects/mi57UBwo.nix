...
let
    versions = (let
        ...
        _jwg2tI4T = {
            "id" = "jwg2tI4T";
            "file" = "CraftableNameTag.zip";
            "hash" = "sha512-idKI51wZb02w9luoIYytn9Z+uL9bawQuwNNicUXLIM935/ih1DTv7EhzkRTHQ2OdOHQXoqVLqi0AopWPoAubKQ==";
        };
    in {
        "CSodDSiL" = _CSodDSiL;
        "VAx828tL" = _VAx828tL;
        ...
        "datapack-1.19" = _jwg2tI4T;
        "datapack-1.19.1" = _jwg2tI4T;
        "datapack-1.19.2" = _jwg2tI4T;
        "datapack-1.19.3" = _jwg2tI4T;
        "datapack-1.19.4" = _jwg2tI4T;
        "datapack-1.20" = _jwg2tI4T;
        "datapack-1.20.1" = _jwg2tI4T;
        "datapack-1.20.2" = _jwg2tI4T;
        "datapack-1.18" = _jwg2tI4T;
        "datapack-1.18.1" = _jwg2tI4T;
        "datapack-1.18.2" = _jwg2tI4T;
        "datapack-1.20.3" = _jwg2tI4T;
        "datapack-1.20.4" = _jwg2tI4T;
        "datapack-1.21.2" = _jwg2tI4T;
        "datapack-1.21.3" = _jwg2tI4T;
        "datapack-1.21.4" = _jwg2tI4T;
        "datapack-1.21.5" = _jwg2tI4T;
        "datapack-1.21.6" = _jwg2tI4T;
        "datapack-1.21.7" = _jwg2tI4T;
        "datapack-1.21.8" = _jwg2tI4T;
        "datapack-1.20.5" = _jwg2tI4T;
        "datapack-1.20.6" = _jwg2tI4T;
        "datapack-1.21" = _jwg2tI4T;
        "datapack-1.21.1" = _jwg2tI4T;
        "datapack-1.21.9" = _jwg2tI4T;
        "datapack-1.21.10" = _jwg2tI4T;
        "datapack-1.21.11" = _jwg2tI4T;
        "datapack-26.1" = _jwg2tI4T;
        "datapack-26.1.1" = _jwg2tI4T;
        "datapack-26.1.2" = _jwg2tI4T;
        "datapack-26.2" = _jwg2tI4T;
        ...
        "pkg-1.19-0.1" = _iT3Rog1W;
        "pkg-1.19.2-0.1" = _HrmHLmVk;
        "pkg-1.19.3-0.1" = _ZzwFX1rZ;
        "pkg-1.19.4-0.1" = _cFJpXnIG;
        "pkg-1.20-0.1" = _vPEnR2Xw;
        "pkg-1.20.1-0.1" = _uSnWsTRq;
        "pkg-1.20.2-0.1" = _yQ55iJkv;
        "pkg-1.19.1-0.1" = _D4ArYGlX;
        "pkg-0.1" = _ibtO6Wf0;
        "pkg-0.2" = _xTWCh8qd;
        "pkg-1.20.3-0.1" = _Ds2y7smA;
        "pkg-1.20.4-0.1" = _xg3hDL3I;
        "pkg-1.20.5-0.1" = _DYnkDwOM;
        "pkg-1.20.6-0.1" = _TxaHpkrP;
        "pkg-1.21-0.1" = _a00o4eaQ;
        "pkg-1.20.6-0.2" = _oHi7R6L3;
        "pkg-1.21-0.3" = _Yum8zi6D;
        "pkg-1.21.1-0.1" = _H7hEJ3Wt;
        "pkg-1.21.3-0.1" = _CYMnxdLO;
        "pkg-1.21.4-0.1" = _k0PWRnr7;
        "pkg-1.21.5-0.1" = _pNmUm5N9;
        "pkg-1.21.5-0.2" = _3IcVNVez;
        "pkg-1.21.6-0.1" = _s4h22gbV;
        "pkg-1.21.7-0.1" = _WFv9Mx4q;
        "pkg-1.21.8-0.1" = _Mk6utI8Y;
        "pkg-1.21.9-0.1" = _cmp55IVR;
        "pkg-1.21.10-0.1" = _bg68LPUG;
        "pkg-1.21.11-0.1" = _jjbhh3Tn;
        "pkg-26.1-0.1" = _LUkbDcaA;
        "pkg-26.1.1-0.1" = _Bj3kskxq;
        "pkg-26.1.2-0.1" = _a8wFSXEY;
        "pkg-0.3" = _MuNzjzpv;
        "pkg-26.2-0.1" = _38wZ38nj;
        "pkg-0.4" = _jwg2tI4T;
        "default" = _jwg2tI4T;
    });
