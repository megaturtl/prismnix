...
let
    ...
    in {
        ...
        "pkg-1.2.2" = _ZvGxUcIz;
        "pkg-1.0.2" = _5z5qnaZD;
        "pkg-1.18.2-1.2.2" = _g8jhKhr2;
        "pkg-1.19-1.3.0" = _nhSV273j;
        "pkg-1.18.2-1.3.1" = _JYBr476P;
        "pkg-1.19-1.3.1" = _PWGwEH45;
        "pkg-1.18.2-1.3.2" = _ipjshqES;
        "pkg-1.19-1.3.2" = _EyKLioEp;
        "pkg-1.19-1.3.3" = _5f8YLfFw;
        "pkg-1.18.2-1.3.4" = _OrXSMPTI;
        "pkg-1.19.1-1.3.4" = _9iXvGzzR;
        "pkg-1.20-1.3.4" = _HPMPaXfi;
        "pkg-1.20-1.3.6" = _bKm7XEFi;
        "pkg-1.20-1.3.8" = _JkDYXo0l;
        "pkg-1.3.8" = _hH9orSkx;
        "pkg-1.3.9" = _tuXkD3tn;
