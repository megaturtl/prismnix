...
let
    versions = (let
        ...
        _ZOJYV7US = {
            "id" = "ZOJYV7US";
            "file" = "Festive Mash-up.zip";
            "hash" = "sha512-N7WerSVvPcdTU2VHa9ijt1Lih/fUHq8OuzYUZ2cmYl/85CsPqhD8texsHCYy/u3gC5gkZJ6GY25MsUy5sxQVVw==";
        };
    in {
        "KnthCFlp" = _KnthCFlp;
        "QbNwYqNw" = _QbNwYqNw;
        ...
        "xg5RzqC5" = _xg5RzqC5;
        "ZOJYV7US" = _ZOJYV7US;
        "minecraft-1.20.4" = _ZOJYV7US;
        "minecraft-1.20.5" = _ZOJYV7US;
        "minecraft-1.20.6" = _ZOJYV7US;
        "minecraft-1.21.2" = _ZOJYV7US;
        "minecraft-1.21.3" = _ZOJYV7US;
        "minecraft-1.20.3" = _ZOJYV7US;
        "minecraft-1.21" = _ZOJYV7US;
        "minecraft-1.21.1" = _ZOJYV7US;
        "minecraft-1.21.4" = _ZOJYV7US;
        "minecraft-1.21.5" = _ZOJYV7US;
        "minecraft-1.21.6" = _ZOJYV7US;
        "minecraft-1.21.7" = _ZOJYV7US;
        "minecraft-1.21.8" = _ZOJYV7US;
        "minecraft-1.21.9" = _ZOJYV7US;
        "minecraft-1.21.10" = _ZOJYV7US;
        "minecraft-1.20.2" = _ZOJYV7US;
        "minecraft-1.21.11" = _ZOJYV7US;
        "minecraft-26.1" = _ZOJYV7US;
        "minecraft-26.1.1" = _ZOJYV7US;
        "minecraft-26.1.2" = _ZOJYV7US;
        "minecraft-26.2" = _ZOJYV7US;
        "minecraft-26.3" = _ZOJYV7US;
        "pkg-1.0.0" = _KnthCFlp;
        "pkg-1.0.1" = _QbNwYqNw;
        "pkg-1.0.2" = _Hi8FjvR1;
        "pkg-1.0.3" = _Yo0b4Hvv;
        ...
        "pkg-1.0.8" = _fTk1OmuV;
        "pkg-1.0.9" = _SCWjddE0;
        "pkg-1.0.10" = _Hj3ojy5W;
        "pkg-1.0.11" = _CJf4vErL;
        "pkg-1.0.12" = _ygJeZCAi;
        "pkg-1.0.13" = _EKaCsRA3;
        "pkg-1.0.14" = _1QQ6n2Rm;
        "pkg-1.0.15" = _D5bB70i8;
        "pkg-1.0.16" = _GvqMbx8z;
        "pkg-1.0.17" = _p6Kly86Y;
        "pkg-1.0.18" = _xg5RzqC5;
        "pkg-1.0.19" = _ZOJYV7US;
        "default" = _ZOJYV7US;
    });
