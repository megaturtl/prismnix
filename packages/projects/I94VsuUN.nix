...
let
    versions = (let
        ...
        _TbiIjduD = {
            "id" = "TbiIjduD";
            "file" = "BCC-2_4.zip";
            "hash" = "sha512-27EtCTGQqrG8MCt85Oae1MQhvNQxj4VH/X28pbBo2LwmptHeLoD1x4rfjKg0UQJpZk57PySrcexPuU9cAFv8Vw==";
        };
        _gfZZcFbQ = {
            "id" = "gfZZcFbQ";
            "file" = "balanced-copper-cutting-2.4.jar";
            "hash" = "sha512-B4LK3C/L3LsPhe5iXEX8zMHyynDxoQzPK3dp7HlNI71S/1AS4gxnfHY6Ju+qrm5KCPSKuVItYJh1541pcEWZtQ==";
        };
    in {
        "ja8oabHZ" = _ja8oabHZ;
        "JGu0AqEp" = _JGu0AqEp;
        ...
        "datapack-1.21.9" = _TbiIjduD;
        "datapack-1.21.10" = _TbiIjduD;
        "datapack-1.21.11" = _TbiIjduD;
        "datapack-26.1" = _TbiIjduD;
        "datapack-26.1.1" = _TbiIjduD;
        "datapack-26.1.2" = _TbiIjduD;
        "datapack-26.2" = _TbiIjduD;
        "datapack-26.3" = _TbiIjduD;
        ...
        "fabric-1.21.9" = _gfZZcFbQ;
        "fabric-1.21.10" = _gfZZcFbQ;
        "fabric-1.21.11" = _gfZZcFbQ;
        "fabric-26.1" = _gfZZcFbQ;
        "fabric-26.1.1" = _gfZZcFbQ;
        "fabric-26.1.2" = _gfZZcFbQ;
        "fabric-26.2" = _gfZZcFbQ;
        "fabric-26.3" = _gfZZcFbQ;
        ...
        "forge-1.21.9" = _gfZZcFbQ;
        "forge-1.21.10" = _gfZZcFbQ;
        "forge-1.21.11" = _gfZZcFbQ;
        "forge-26.1" = _gfZZcFbQ;
        "forge-26.1.1" = _gfZZcFbQ;
        "forge-26.1.2" = _gfZZcFbQ;
        "forge-26.2" = _gfZZcFbQ;
        "forge-26.3" = _gfZZcFbQ;
        ...
        "quilt-1.21.9" = _gfZZcFbQ;
        "quilt-1.21.10" = _gfZZcFbQ;
        "quilt-1.21.11" = _gfZZcFbQ;
        "quilt-26.1" = _gfZZcFbQ;
        "quilt-26.1.1" = _gfZZcFbQ;
        "quilt-26.1.2" = _gfZZcFbQ;
        "quilt-26.2" = _gfZZcFbQ;
        "quilt-26.3" = _gfZZcFbQ;
        ...
        "neoforge-1.21.9" = _gfZZcFbQ;
        "neoforge-1.21.10" = _gfZZcFbQ;
        "neoforge-1.21.11" = _gfZZcFbQ;
        "neoforge-26.1" = _gfZZcFbQ;
        "neoforge-26.1.1" = _gfZZcFbQ;
        "neoforge-26.1.2" = _gfZZcFbQ;
        "neoforge-26.2" = _gfZZcFbQ;
        "neoforge-26.3" = _gfZZcFbQ;
        "pkg-0.2" = _ja8oabHZ;
        "pkg-0.3" = _JGu0AqEp;
        "pkg-0.4-beta" = _fZP3dJ9Z;
        "pkg-1.0" = _99EbbamO;
        "pkg-1.0+mod" = _m1XfpJuD;
        "pkg-1.1" = _PyTDTk2q;
        "pkg-1.1+mod" = _KkcP5HPh;
        "pkg-1.3" = _j1Om1Vlu;
        "pkg-1.3+mod" = _31ofwLOC;
        "pkg-1.4" = _LtFBfufg;
        "pkg-1.4+mod" = _Mn92Z8dZ;
        "pkg-1.5" = _FrIzaxpR;
        "pkg-1.5+mod" = _TJdZbaNQ;
        "pkg-1.6" = _a5TN7wAd;
        "pkg-1.6+mod" = _m6eIYl14;
        "pkg-2.0" = _k1xm4PZp;
        "pkg-2.0+mod" = _hs8mfwPq;
        "pkg-2.1" = _vzaLIaK2;
        "pkg-2.1+mod" = _De2vQOaW;
        "pkg-2.2" = _dF4Na1U4;
        "pkg-2.2+mod" = _WekqQxmj;
        "pkg-2.3" = _dXkkCHSy;
        "pkg-2.3+mod" = _dEzOsl4b;
        "pkg-2.4" = _TbiIjduD;
        "pkg-2.4+mod" = _gfZZcFbQ;
        "default" = _gfZZcFbQ;
    });
