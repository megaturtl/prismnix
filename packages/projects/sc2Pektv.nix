...
let
    ...
    in {
        ...
        "pkg-1.2.6" = _JsONNvkB;
        "pkg-1.2.7" = _YBUTHRag;
        "pkg-1.2.3+1.20.1" = _h0WwUNRU;
        "pkg-1.2.8+1.21" = _o9KgAKrC;
        "pkg-1.2.9+1.21" = _BufbXYSe;
        "pkg-1.2.10+1.21" = _18hWonJm;
        "pkg-1.2.11+1.21.3" = _C6gAa38w;
        "pkg-1.2.10.1+1.21" = _zTOlZQXS;
        "pkg-1.2.11.1+1.21.3" = _UMzuWfIP;
        "pkg-1.2.4+1.20.1" = _Fbld0HME;
        "pkg-1.2.12+1.21.4" = _LyRMbqG5;
        "pkg-1.2.5+1.20.1" = _P2kARD78;
        "pkg-2.0.0+1.21.1" = _RQzGMu9s;
        "pkg-2.0.1+1.21.1" = _WVMjLwdO;
        "pkg-2.1.0+1.21.1" = _fSyh9bak;
        "pkg-2.1.1+1.21.1" = _kx04YViE;
        "pkg-2.1.2+1.21.1" = _ZROBJTDF;
        "pkg-2.2.0+1.21.10" = _MUrw35S8;
        "pkg-2.2.1+1.21.10" = _CHjYr4ji;
        "pkg-2.2.2+1.21.10" = _QxrGeMMG;
        "pkg-2.1.3+1.21.1" = _sotZqbWi;
        "pkg-2.3.0+1.21.11" = _pZIv9nND;
        "pkg-2.3.1+1.21.11" = _Xn8q6gIy;
        "pkg-2.1.4+1.21.1" = _skijTcJ3;
        "pkg-2.3.2+1.21.11" = _Hp3GDqeG;
        "pkg-2.3.3+1.21.11" = _mJPkzGFd;
        "pkg-2.3.4+1.21.11" = _mzo6bymL;
        "pkg-2.3.5+1.21.11" = _t1RXjICY;
        "pkg-2.3.6+1.21.11" = _ZgHuKzEj;
