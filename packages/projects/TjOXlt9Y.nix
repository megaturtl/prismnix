...
let
    versions = (let
        ...
        _9w3lMjPF = {
            "id" = "9w3lMjPF";
            "file" = "Midnighttigger's Default Connected Textures.zip";
            "hash" = "sha512-faAswHxoSgMiy3PKGEDOYTtARFLmpaHglwsOUZ6Vhx97jUtlvr5H9xRrwG0Z9fvg4HYUubTKKbZvjo8C6+9L6w==";
        };
        _NE7DY68v = {
            "id" = "NE7DY68v";
            "file" = "Midnighttigger's Default Connected Textures.zip";
            "hash" = "sha512-QypDXgHkx3ml6aUsO4ZHZ0VGDBUwfPEpot5pSm7Vp9HPSwRssbV+BO31MJEpEWcMH58nKckQKW3Q+hQEVFHFFw==";
        };
        _UPBKvt5T = {
            "id" = "UPBKvt5T";
            "file" = "Midnighttigger's Default Connected Textures.zip";
            "hash" = "sha512-rUO3fxClioOOa6Lm/YoZDz66gj35kdjEdRkrXHf/52q7MUwAj60dkvyNncKyOyDNDJYzF4ex5j1qth8CSThrEQ==";
        };
    in {
        "LR3pc0rj" = _LR3pc0rj;
        "LGrBLgMp" = _LGrBLgMp;
        ...
        "NE7DY68v" = _NE7DY68v;
        "UPBKvt5T" = _UPBKvt5T;
        "minecraft-1.19.4" = _UPBKvt5T;
        "minecraft-1.20" = _UPBKvt5T;
        "minecraft-1.20.1" = _UPBKvt5T;
        "minecraft-1.20.2" = _UPBKvt5T;
        "minecraft-1.20.3" = _UPBKvt5T;
        "minecraft-1.20.4" = _UPBKvt5T;
        "minecraft-1.13" = _l2LxEa20;
        "minecraft-1.13.1" = _l2LxEa20;
        "minecraft-1.13.2" = _l2LxEa20;
        "minecraft-1.14" = _NE7DY68v;
        "minecraft-1.14.1" = _NE7DY68v;
        "minecraft-1.14.2" = _NE7DY68v;
        "minecraft-1.14.3" = _NE7DY68v;
        "minecraft-1.14.4" = _NE7DY68v;
        "minecraft-1.15" = _NE7DY68v;
        "minecraft-1.15.1" = _NE7DY68v;
        "minecraft-1.15.2" = _NE7DY68v;
        "minecraft-1.16" = _NE7DY68v;
        "minecraft-1.16.1" = _NE7DY68v;
        "minecraft-1.16.2" = _NE7DY68v;
        "minecraft-1.16.3" = _NE7DY68v;
        "minecraft-1.16.4" = _NE7DY68v;
        "minecraft-1.16.5" = _NE7DY68v;
        "minecraft-1.17" = _NE7DY68v;
        "minecraft-1.17.1" = _NE7DY68v;
        "minecraft-1.18" = _NE7DY68v;
        "minecraft-1.18.1" = _NE7DY68v;
        "minecraft-1.18.2" = _NE7DY68v;
        "minecraft-1.19" = _UPBKvt5T;
        "minecraft-1.19.1" = _UPBKvt5T;
        "minecraft-1.19.2" = _UPBKvt5T;
        "minecraft-1.19.3" = _UPBKvt5T;
        "minecraft-1.20.5" = _UPBKvt5T;
        "minecraft-1.20.6" = _UPBKvt5T;
        "minecraft-1.21" = _UPBKvt5T;
        "minecraft-1.21.1" = _UPBKvt5T;
        "minecraft-1.10.2" = _l2LxEa20;
        "minecraft-1.11" = _l2LxEa20;
        "minecraft-1.11.1" = _l2LxEa20;
        "minecraft-1.11.2" = _l2LxEa20;
        "minecraft-1.12" = _9w3lMjPF;
        "minecraft-1.12.1" = _9w3lMjPF;
        "minecraft-1.12.2" = _9w3lMjPF;
        "minecraft-1.21.2" = _UPBKvt5T;
        "minecraft-1.21.3" = _UPBKvt5T;
        "minecraft-1.21.4" = _UPBKvt5T;
        "minecraft-1.21.5" = _UPBKvt5T;
        "minecraft-1.21.6" = _UPBKvt5T;
        "minecraft-1.21.7" = _UPBKvt5T;
        "minecraft-1.21.8" = _UPBKvt5T;
        "minecraft-1.21.9" = _UPBKvt5T;
        "minecraft-1.21.10" = _UPBKvt5T;
        "minecraft-1.21.11" = _UPBKvt5T;
        "minecraft-26.1" = _UPBKvt5T;
        "minecraft-26.1.1" = _UPBKvt5T;
        "minecraft-26.1.2" = _UPBKvt5T;
        "minecraft-26.2" = _UPBKvt5T;
        "pkg-V1" = _tfKvt8nl;
        "pkg-V2" = _LGrBLgMp;
        "pkg-1" = _FU7UlbOI;
        "pkg-2" = _l2LxEa20;
