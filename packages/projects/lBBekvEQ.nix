...
let
    versions = (let
        ...
        _woCeIe36 = {
            "id" = "woCeIe36";
            "file" = "NMinimap.jar";
            "hash" = "sha512-IcTbF9VuTJhA4eBaU7dCUI0eBqTrjuXBbWcZO+Rw04Tu1fIu6TgNqekW6w9M5X/c/FPGwSvb8LOLqjIrgn1YwA==";
        };
        _QXjxxWBy = {
            "id" = "QXjxxWBy";
            "file" = "NMinimap.jar";
    ...
    in {
        ...
        "pkg-1.0.3" = _jxNA1T5Q;
        "pkg-1.0.4" = _ctou4oD7;
        "pkg-1.0.4-quickfix-1" = _5N1Tx9Yc;
        "pkg-1.0.5" = _RTP92HxF;
        "pkg-1.0.6" = _jND1uTB1;
        "pkg-1.0.6-quickfix-1" = _FPxx8ga4;
        "pkg-1.0.6-quickfix-2" = _3l0V6K2p;
        "pkg-1.0.7" = _ihuLGVOz;
