...
let
    ...
    in {
        ...
        "pkg-V1.0.5" = _bnzQkwEW;
        "pkg-V1.0.5b" = _ZE4AAiLW;
        "pkg-1.0.7a" = _SgwXrT4U;
        "pkg-1.0.7" = _TxAl7hO0;
        "pkg-1.0.8a" = _JHhfWREq;
        "pkg-v1.0.8b" = _yrLMP7gR;
        "pkg-1.1.0-mc1.19" = _xd0bnr6l;
        "pkg-1.2.0-mc1.19.2" = _zercmUE6;
        "pkg-1.2.0-mc1.18.2" = _V0DyIuBa;
        "pkg-1.2.1-mc1.19.3" = _bV5QSwnJ;
        "pkg-1.2.2-mc1.19.4" = _5yzXKKSh;
        "pkg-1.2.3" = _N2EgY32s;
        "pkg-1.2.4-mc1.20" = _dEgZfXKp;
        "pkg-1.2.4-mc1.19.2" = _a6uPZBX8;
        "pkg-1.2.5" = _yE02A1oT;
        "pkg-1.2.6" = _Io4Kzgcn;
        "pkg-1.3.0" = _zN6Cmh3J;
        "pkg-1.3.0-1.21" = _QqyhOizq;
        "pkg-1.3.0v2" = _Gcubq0WU;
        "pkg-1.3.1" = _HyLIIQiD;
        "pkg-2.1.0+1.21.5-neoforge" = _sy6JHR8m;
        "pkg-2.1.0+1.21.11-neoforge" = _uXoYbMYb;
        "pkg-2.1.0+1.21.8-neoforge" = _5SZfaB0T;
        "pkg-2.1.0+1.21.10-neoforge" = _JXQRxXLU;
        "pkg-2.1.0+1.21.11-fabric" = _2A8WEnde;
        "pkg-2.1.0+1.21.5-fabric" = _eYqn8GVX;
        "pkg-2.1.0+1.21.8-fabric" = _rSgcfZd6;
        "pkg-2.1.0+1.21.10-fabric" = _Mw0OL5io;
        "pkg-2.1.0+26.1-fabric" = _GTvesAAZ;
        "pkg-2.1.0+26.1-neoforge" = _AslZ7BbY;
