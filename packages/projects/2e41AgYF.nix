...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _H5BBB5Fa;
        "pkg-texture-1.0.2" = _gqAKcKlC;
        "pkg-1.0.2" = _IoFHe6xp;
        "pkg-1.0.3" = _ALRKxtRf;
        "pkg-texture-1.0.4-1.21.4" = _IbIJQLZ4;
        "pkg-1.0.4-1.21.4" = _f8NyyPfJ;
        "pkg-texture-1.0.4-1.21.5" = _raYkcXaG;
        "pkg-1.0.4-1.21.5" = _5ayZ69IJ;
        "pkg-1.0.4-1.21.6" = _zrouRv0O;
        "pkg-1.0.4-1.21.9" = _3PgQfVnD;
