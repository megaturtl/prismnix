...
let
    ...
    in {
        ...
        "paper-1.21.4" = _opNHEZIB;
        "paper-1.21.5" = _opNHEZIB;
        "paper-1.21.6" = _opNHEZIB;
        "paper-1.21.7" = _opNHEZIB;
        "paper-1.21.8" = _opNHEZIB;
        "paper-1.21.9" = _opNHEZIB;
        "paper-1.21.10" = _opNHEZIB;
        "paper-1.21.11" = _opNHEZIB;
        ...
        "bukkit-1.21.4" = _opNHEZIB;
        "bukkit-1.21.5" = _opNHEZIB;
        "bukkit-1.21.6" = _opNHEZIB;
        "bukkit-1.21.7" = _opNHEZIB;
        "bukkit-1.21.8" = _opNHEZIB;
        "bukkit-1.21.9" = _opNHEZIB;
        "bukkit-1.21.10" = _opNHEZIB;
        "bukkit-1.21.11" = _opNHEZIB;
        ...
        "spigot-1.21.4" = _opNHEZIB;
        "spigot-1.21.5" = _opNHEZIB;
        "spigot-1.21.6" = _opNHEZIB;
        "spigot-1.21.7" = _opNHEZIB;
        "spigot-1.21.8" = _opNHEZIB;
        "spigot-1.21.9" = _opNHEZIB;
        "spigot-1.21.10" = _opNHEZIB;
        "spigot-1.21.11" = _opNHEZIB;
        "purpur-1.21" = _opNHEZIB;
        "purpur-1.21.1" = _opNHEZIB;
        "purpur-1.21.2" = _opNHEZIB;
        "purpur-1.21.3" = _opNHEZIB;
        "purpur-1.21.4" = _opNHEZIB;
        "purpur-1.21.5" = _opNHEZIB;
        "purpur-1.21.6" = _opNHEZIB;
        "purpur-1.21.7" = _opNHEZIB;
        "purpur-1.21.8" = _opNHEZIB;
        "purpur-1.21.9" = _opNHEZIB;
        "purpur-1.21.10" = _opNHEZIB;
        "purpur-1.21.11" = _opNHEZIB;
        "pkg-0.0.1" = _reBDjso3;
        "pkg-0.0.2" = _Lw9g7WvP;
        "pkg-0.0.3" = _JbI16tMy;
        "pkg-0.0.4" = _XTNsWq4G;
