...
let
    versions = (let
        ...
        _opNHEZIB = {
            "id" = "opNHEZIB";
            "file" = "LifeWars-0.1.8.jar";
            "hash" = "sha512-+bYJ9TVlAoXNP1+NAjcMqksommotDbUYUxhjvSwgIu/k12d1UKbUCQHgoHMhRqgKbbtS/sOT/5LhTyxXBX2URw==";
        };
        _H9zYmVua = {
            "id" = "H9zYmVua";
            "file" = "LifeWars-0.1.9.jar";
            "hash" = "sha512-EhKBpA07fNScm06YaWe83HUv+xb84TNay8AShe+WVAmHYQzx41xZhUPaDN68VOWL4Nt5Hwrc4zGFYbOXgebfUA==";
        };
        _EdkBUbU8 = {
            "id" = "EdkBUbU8";
            "file" = "LifeWars-0.1.9.jar";
            "hash" = "sha512-coEKPJrYU/ncYhvT6k7tN5rYmIMQOlrDZ3to/1NJYRLAjVAeqa2HMI3yRG/JpuuHMwqkk95p0YtbYEP3tOvFjQ==";
        };
    in {
        "reBDjso3" = _reBDjso3;
        "Lw9g7WvP" = _Lw9g7WvP;
        ...
        "paper-1.21" = _opNHEZIB;
        "paper-1.21.1" = _opNHEZIB;
        "paper-1.21.2" = _opNHEZIB;
        "paper-1.21.3" = _opNHEZIB;
        "paper-1.21.4" = _EdkBUbU8;
        "paper-1.21.5" = _EdkBUbU8;
        "paper-1.21.6" = _EdkBUbU8;
        "paper-1.21.7" = _EdkBUbU8;
        "paper-1.21.8" = _EdkBUbU8;
        "paper-1.21.9" = _EdkBUbU8;
        "paper-1.21.10" = _EdkBUbU8;
        "paper-1.21.11" = _EdkBUbU8;
        ...
        "bukkit-1.21" = _opNHEZIB;
        "bukkit-1.21.1" = _opNHEZIB;
        "bukkit-1.21.2" = _opNHEZIB;
        "bukkit-1.21.3" = _opNHEZIB;
        "bukkit-1.21.4" = _EdkBUbU8;
        "bukkit-1.21.5" = _EdkBUbU8;
        "bukkit-1.21.6" = _EdkBUbU8;
        "bukkit-1.21.7" = _EdkBUbU8;
        "bukkit-1.21.8" = _EdkBUbU8;
        "bukkit-1.21.9" = _EdkBUbU8;
        "bukkit-1.21.10" = _EdkBUbU8;
        "bukkit-1.21.11" = _EdkBUbU8;
        ...
        "spigot-1.21" = _opNHEZIB;
        "spigot-1.21.1" = _opNHEZIB;
        "spigot-1.21.2" = _opNHEZIB;
        "spigot-1.21.3" = _opNHEZIB;
        "spigot-1.21.4" = _EdkBUbU8;
        "spigot-1.21.5" = _EdkBUbU8;
        "spigot-1.21.6" = _EdkBUbU8;
        "spigot-1.21.7" = _EdkBUbU8;
        "spigot-1.21.8" = _EdkBUbU8;
        "spigot-1.21.9" = _EdkBUbU8;
        "spigot-1.21.10" = _EdkBUbU8;
        "spigot-1.21.11" = _EdkBUbU8;
        "purpur-1.21" = _opNHEZIB;
        "purpur-1.21.1" = _opNHEZIB;
        "purpur-1.21.2" = _opNHEZIB;
        "purpur-1.21.3" = _opNHEZIB;
        "purpur-1.21.4" = _EdkBUbU8;
        "purpur-1.21.5" = _EdkBUbU8;
        "purpur-1.21.6" = _EdkBUbU8;
        "purpur-1.21.7" = _EdkBUbU8;
        "purpur-1.21.8" = _EdkBUbU8;
        "purpur-1.21.9" = _EdkBUbU8;
        "purpur-1.21.10" = _EdkBUbU8;
        "purpur-1.21.11" = _EdkBUbU8;
        "pkg-0.0.1" = _reBDjso3;
        "pkg-0.0.2" = _Lw9g7WvP;
        "pkg-0.0.3" = _JbI16tMy;
        "pkg-0.0.4" = _XTNsWq4G;
        ...
        "pkg-0.0.7" = _ogu60yB8;
        "pkg-0.0.8" = _riBUBFUH;
        "pkg-0.0.8.1" = _KtN0st11;
        "pkg-0.0.8.2" = _4hVv2Rgo;
        "pkg-0.0.9" = _U7UIAEE7;
        "pkg-0.1.0" = _7ucqqV4n;
        "pkg-0.1.1" = _7IJMzvmk;
        "pkg-0.1.2" = _uoOj45I9;
