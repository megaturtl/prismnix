...
let
    versions = (let
        ...
        _zKOCnRdK = {
            "id" = "zKOCnRdK";
            "file" = "BetterAdvancements-Forge-1.20.1-0.6.0.73.jar";
            "hash" = "sha512-Enmke+hOXyTCUYvXWiduCe1SYqllc2V7SNS/AWCn8/Z0mjj41RIAzSiD6f2Q27Sjy8pZwJzhuZjSEtuYy2d96g==";
        };
        _1soYKvDK = {
            "id" = "1soYKvDK";
            "file" = "BetterAdvancements-Fabric-1.20.1-0.6.0.73.jar";
            "hash" = "sha512-zBD2qeWSdvhVdfTE7AvfzEtq11xl5g0tZOLj+wrMb++qaqKmWqpYyEZ3oDqFlKhNkdwGexYMbN3ZKFAeC7OGUg==";
        };
        _b7M4dLeR = {
            "id" = "b7M4dLeR";
            "file" = "BetterAdvancements-NeoForge-1.20.1-0.6.0.73.jar";
            "hash" = "sha512-ZS5+LTJMmlVd9DlmwrSbQUZcPfPsadMzd+VtmIJHuqVQ9NnoBSzn2Lhu9EpI6aTkxwAYCi7mV1MbxplP3XONgQ==";
        };
        _1ZMsbW2R = {
            "id" = "1ZMsbW2R";
            "file" = "BetterAdvancements-Fabric-26.1.2-0.6.0.75.jar";
            "hash" = "sha512-Wp099ulGsivlFYAR8YNFgUlc9Eqn52uoZnzlkL75lMtq98f55XtH0gl//4CubZD8wY0+1bwp1RRM3/dvdXs/Ug==";
        };
        _zLYDR3YP = {
            "id" = "zLYDR3YP";
            "file" = "BetterAdvancements-NeoForge-26.1.2-0.6.0.75.jar";
            "hash" = "sha512-daEaCXLpZ+LM1c09v114V2Ytej3KffhSzpd/rDA8NbNd69eQ1PJDOjdYRoHdxf2wQ5Jz9CzccCPGtekFlgURMQ==";
        };
        _KQm0nA2Y = {
            "id" = "KQm0nA2Y";
            "file" = "BetterAdvancements-Forge-26.1.2-0.6.0.75.jar";
            "hash" = "sha512-BknN0RM7HTnArYh9VGHwxbJYYxdURdpNd1kCDhFeBIqi6UNASzf3npU7EbXqG3Seyh1emtlN0AZQZ63I9s+jng==";
        };
        _EJXDbJy9 = {
            "id" = "EJXDbJy9";
            "file" = "BetterAdvancements-Fabric-26.1.2-0.6.0.76.jar";
            "hash" = "sha512-sZYlaBHxGjSAuJuBuZAr3MF5uhc44566vPBEMaPJYY5OcGQrx6S3ZkBUwdogc5CJCo/bXKBcPNW/VsBM2ZG/sA==";
        };
        _8Hsu82sg = {
            "id" = "8Hsu82sg";
            "file" = "BetterAdvancements-NeoForge-26.1.2-0.6.0.76.jar";
            "hash" = "sha512-fppSxfLhwNIdvbBXZOS6z4p39HkkdVTmym8XNo/rVoBP/lxTU7+Hnv45A4o6gWC4/YKwBqWA/294wjHdTahtCw==";
        };
        _QOJvSu6p = {
            "id" = "QOJvSu6p";
    ...
    in {
        ...
        "pkg-0.3.1.154" = _aarnAQQD;
        "pkg-0.3.1.156" = _XbRG4Rhv;
        "pkg-0.3.1.157" = _lAFAQGCz;
        "pkg-0.3.1.158" = _KcsAOipK;
        "pkg-0.3.2.159" = _7a94H0Hr;
        "pkg-0.3.2.160" = _pimFfXhN;
        "pkg-0.3.2.161" = _uHjK0raA;
        "pkg-0.3.0.148" = _MqXjcA0Z;
        "pkg-0.2.0.146" = _FA2V323R;
        "pkg-0.1.2.125" = _4b3NQ33t;
        "pkg-0.3.2.162" = _MoIoigS0;
        "pkg-0.3.3.163" = _Sc1lIwGT;
        "pkg-0.3.3.164" = _YuGHLIEE;
        "pkg-0.3.3.166" = _PrIiocM8;
        "pkg-0.4.0.170" = _FzyevU7Q;
        "pkg-0.4.0.171" = _HwWnm0Q5;
        "pkg-0.4.0.172" = _QjBEtzgB;
        "pkg-0.4.0.176" = _axkNZ11H;
        "pkg-0.4.1.4" = _AYqUHwBU;
        "pkg-0.4.1.5" = _3SCa7I21;
        "pkg-0.4.1.6" = _qgtWXkJl;
        "pkg-0.4.2.7" = _62DxRJjX;
        "pkg-0.4.2.8" = _48lJWucY;
        "pkg-0.4.2.10" = _U17TRk9r;
        "pkg-0.4.2.16" = _j25BSG4B;
        "pkg-0.4.2.18" = _x7jmFGpv;
        "pkg-0.4.2.19" = _HJ1X6Yzd;
        "pkg-0.4.3.20" = _SBXB2kbh;
        "pkg-0.4.3.21" = _j80BmLRo;
        "pkg-0.4.4.22" = _vBWUw74w;
        "pkg-0.4.2.25" = _NS5G3ENg;
        "pkg-0.4.4.24" = _GdX4Jtzg;
        "pkg-0.4.4.26" = _KtUUTEQp;
        "pkg-0.4.4.28" = _h32rrBdc;
        "pkg-0.4.4.30" = _zGiBiATt;
        "pkg-0.4.4.29" = _rmxVSoqW;
        "pkg-0.4.4.27" = _5CIyV9Fl;
        "pkg-0.4.5.34" = _BnwS5vet;
        "pkg-0.4.5.35" = _SN5UqmCX;
        "pkg-0.1.0.77" = _TanCG0k3;
        "pkg-0.4.6.36" = _E4QAYrXB;
        "pkg-0.4.6.37" = _oB8yEhTF;
        "pkg-0.4.6.38" = _KyWNa9ES;
        "pkg-0.4.6.39" = _4NjKjnFz;
        "pkg-0.4.6.40" = _fmPcUnaH;
        "pkg-0.4.6.41" = _oB3kr1lG;
        "pkg-0.4.6.43" = _wTJHNhSB;
        "pkg-0.4.6.44" = _sdfMc1Xe;
        "pkg-0.4.6.45" = _A5MfXbhr;
        "pkg-0.4.7.46" = _OEa6Sbrb;
        "pkg-0.4.7.47" = _q2YdPWpg;
        "pkg-0.4.7.48" = _HhGyHn8w;
        "pkg-0.4.7.49" = _gMYyeSg2;
        "pkg-0.4.7.50" = _EGiysNhh;
        "pkg-0.4.8.51" = _fFV5NoIk;
        "pkg-0.4.8.54" = _8im6QWDT;
        "pkg-0.5.0.58" = _tNNNQ3jr;
        "pkg-0.4.2.59" = _oKtHdFQT;
        "pkg-0.4.2.60" = _DuF0wElE;
        "pkg-0.4.6.62" = _mwBf16uM;
        "pkg-0.5.0.63" = _pll7WOgl;
        "pkg-0.5.1.64" = _4qmstDIn;
        "pkg-0.5.1.65" = _JwLHzQiF;
        "pkg-0.5.2.69" = _O8sg7mAD;
        "pkg-0.5.2.70" = _tEuTbF8k;
        "pkg-0.5.2.71" = _Kcih3ym1;
        "pkg-0.6.0.72" = _jpLkbcZh;
