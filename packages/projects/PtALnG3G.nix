...
let
    versions = (let
        ...
        _g3qLKPVC = {
            "id" = "g3qLKPVC";
            "file" = "minecart-trains-fork-2.5.0-beta.2+26.2.jar";
            "hash" = "sha512-AdTCFSgMwMJ8iFAUDScGthmpK7HdINwoZdZ2LwGKvVKUHeT+Wi8uIKljg968a5R3/gGoj3MViqzm/5O0ci4NBw==";
        };
        _ob4Ns9kd = {
            "id" = "ob4Ns9kd";
    ...
    in {
        ...
        "pkg-1.21.9-beta.2" = _yoKrRrE9;
        "pkg-1.21.9-beta.3" = _kMmPUaXs;
        "pkg-1.21.6-beta.1" = _FIN6o469;
        "pkg-1.21.5-beta.1" = _2nra6t4z;
        "pkg-1.21.4-beta.1" = _UdWCtReQ;
        "pkg-1.21.2-beta.1" = _ZRIa4W0I;
        "pkg-1.21-beta.1" = _QQ2BCAKN;
        "pkg-1.21.9-release.1" = _NhOsf2Go;
        "pkg-1.21.6-release.1" = _gLVKRcAM;
        "pkg-1.20.5-beta.1" = _3Gn1xhjs;
        "pkg-1.20.3-beta.1" = _CbRnpVVs;
        "pkg-1.20-beta.1" = _xRgysZm0;
        "pkg-1.19-beta.1" = _fcZ0fxzd;
        "pkg-1.18-beta.1" = _YMLzKlhA;
        "pkg-1.17-beta.1" = _Pyi9xd8G;
        "pkg-1.17-release.1" = _HQqgLebh;
        "pkg-1.18-release.1" = _Xien62dY;
        "pkg-1.19-release.1" = _HVmE3nKA;
        "pkg-1.20-release.1" = _hsR7Lmi9;
        "pkg-1.20.3-release.1" = _L0JYmUZg;
        "pkg-1.20.5-release.1" = _dW15tN76;
        "pkg-1.21-release.1" = _y78wKZyi;
        "pkg-1.21.2-release.1" = _aEE3ZM9x;
        "pkg-1.21.4-release.1" = _uoa506LS;
        "pkg-1.21.5-release.1" = _owGIbHyM;
        "pkg-1.21.6-release.2" = _QnTWy58e;
        "pkg-2.0.0-alpha.1+1.21.9" = _s8hfgVp8;
        "pkg-2.0.0-alpha.2+1.21.9" = _V9bBYiaK;
        "pkg-2.0.0-alpha.3+1.21.9" = _OC1Zl4U0;
        "pkg-2.0.0-alpha.3+1.21.11" = _wZ03KDFJ;
        "pkg-2.0.0-alpha.4+1.21.11" = _PSZPR8CO;
        "pkg-2.0.0-alpha.5+1.21.11" = _OdWyxMyG;
        "pkg-2.0.0-alpha.6+1.21.11" = _Vkxq4dKc;
        "pkg-2.0.0-beta.1+1.21.11" = _iehfSBMy;
        "pkg-2.0.0-beta.1+1.21" = _hbjKCOdP;
        "pkg-2.0.0+1.21.11" = _znr7mjpD;
        "pkg-2.0.0+1.21" = _kZjZT19n;
        "pkg-2.0.0+1.21.9" = _LpHTEklj;
        "pkg-2.1.0+1.21.11" = _7Ah7IJ5n;
        "pkg-2.1.0+1.21" = _jU4ewk6E;
        "pkg-2.1.1+1.21.11" = _Ty4q9GKv;
        "pkg-2.1.1+1.21" = _U2MOdWq7;
        "pkg-2.2.0-alpha.1+1.21.11" = _1jhG3Yrt;
        "pkg-2.1.1+1.21.9" = _rGe0UWq4;
        "pkg-2.1.1+1.21.6" = _8WSPu4In;
        "pkg-2.1.1+1.21.6.patch.1" = _pBgzeD4e;
        "pkg-2.1.1+1.21.5" = _OZZAqBGf;
        "pkg-2.1.1+1.21.4" = _2JUXqLOa;
        "pkg-2.1.1+1.21.2" = _fuWzdNgn;
        "pkg-2.2.0-alpha.2+1.21.11" = _jVu2lgJx;
        "pkg-2.2.0-alpha.3+1.21.11" = _7KOOmip6;
        "pkg-2.2.0-beta.1+1.21.11" = _JpAMkViX;
        "pkg-2.2.0+1.21.11" = _Tq3JtOuT;
        "pkg-2.2.0+1.21.9" = _X2Slqr8z;
        "pkg-2.2.1+1.21.11.fabric" = _ftLvxgIM;
        "pkg-2.2.1+1.21.9.fabric" = _ij7EZGeV;
        "pkg-2.2.1+1.21.6.fabric" = _ot3NQ2kr;
        "pkg-2.2.1+1.21.5.fabric" = _lfu0PhIJ;
        "pkg-2.2.1+1.21.4.fabric" = _7bwSgCDu;
        "pkg-2.2.1+1.21.2.fabric" = _4ANmxqjm;
        "pkg-2.2.1+1.21.fabric" = _PZExw6gz;
        "pkg-2.2.1+1.20.5.fabric" = _5svMW0uf;
        "pkg-2.2.2+1.21.11.fabric" = _yFZWXDm5;
        "pkg-2.2.2+1.21.9.fabric" = _w8Yq8yvH;
        "pkg-2.2.2+26.1.fabric" = _jLjoSj8z;
        "pkg-2.2.2+1.21.6" = _k71tUBQb;
        "pkg-2.2.2+1.21.5" = _cEckbG8B;
        "pkg-2.3.0-alpha.1+26.1" = _dOKeHdgk;
        "pkg-2.3.0-beta.1+26.1" = _JUnbKFYJ;
        "pkg-2.3.0+26.1" = _45106V07;
        "pkg-2.3.0+1.21.11" = _StQnjAu7;
        "pkg-2.3.0+1.21" = _x4qdEnQD;
        "pkg-2.3.0+1.20" = _KWHssq2H;
        "pkg-2.3.0+26.1.neoforge" = _Of0FdYv6;
        "pkg-2.3.0+1.21.neoforge" = _E5vF2vPe;
        "pkg-2.4.0-alpha.1+26.1" = _xYEApt65;
        "pkg-2.4.0-alpha.2+26.1" = _1XgTWPNU;
        "pkg-2.4.0-alpha.3+26.1" = _WWkwMaeO;
        "pkg-2.4.0-beta.1+26.1" = _6bDhaHmK;
        "pkg-2.4.0+26.1" = _AWeE8aMZ;
        "pkg-2.4.1+26.1" = _iHle6Vif;
        "pkg-2.4.1+26.1.neoforge" = _Zrft1mnS;
        "pkg-2.4.1+1.21.11" = _FBXVk0uI;
        "pkg-2.4.1+1.21" = _msB0EOAy;
        "pkg-2.4.1+1.21.neoforge" = _g5L6EyrA;
        "pkg-2.4.2+26.1" = _hgfjdGDB;
        "pkg-2.4.2+26.1.neoforge" = _RxwABNfE;
        "pkg-2.4.2+1.21.11" = _7bUR70FL;
        "pkg-2.4.2+1.21" = _qRiYRAoy;
        "pkg-2.4.2+1.21.neoforge" = _RHsGBMAz;
        "pkg-2.4.2+26.1.neoforge.r1" = _3VE9R1PJ;
        "pkg-2.4.2+1.20" = _7AszBjvw;
        "pkg-2.4.2+1.20.forge" = _7MAzZqel;
        "pkg-2.4.2+1.20.r1" = _5FQv5aIT;
