...
let
    versions = (let
        ...
        _XZXzw4h9 = {
            "id" = "XZXzw4h9";
            "file" = "CTM OF-Fabric 1.19.4.zip";
            "hash" = "sha512-gdSwDdlCY8or0fD7Dbb/E30g1ySrmALF/153KbVerBMOJPt9/kYi1nUrWuk9yl41pqyxAU5PUARH2eQ+LmXSNw==";
        };
        _zPqLDOmF = {
            "id" = "zPqLDOmF";
            "file" = "CTM OF-Fabric 1.18.x.zip";
            "hash" = "sha512-prhdh8so65w9einbEkMlu6oCQfibrENQJMeG4JscGqYbK3xzWMPPukFsH3JJfglqKLs0s+gDkcwYXcnXdTvbgQ==";
        };
        _JDjG4ZVm = {
            "id" = "JDjG4ZVm";
            "file" = "CTM OF-Fabric 1.17.x.zip";
            "hash" = "sha512-rfrkAUdoTuDSeCSnmSgzgyUa6Ec/3USA77YZOT5gmdZg2mNGG47QRnj2u78m/M2PeyEXJZfQFZ/Jcc7AKgp8Zw==";
        };
        _KHzPZnnF = {
            "id" = "KHzPZnnF";
            "file" = "CTM OF-Fabric 1.21.9-26.2.zip";
            "hash" = "sha512-OPsckLAueZYP8kSVGXkVWauSJsj3sm55hl80Bnrfu5uUd3iFbWkHih3lfGFvgG5XehQ+feZqBMBQxGO7nawtFw==";
        };
        _JPh318s1 = {
            "id" = "JPh318s1";
            "file" = "CTM OF-Fabric 1.20-1.20.1.zip";
            "hash" = "sha512-rN689hI7leePavn1DbZB65TWQQKDSyQrs4SgtU8lEGHUq6qUcQpqONpqCIccmm0Y8ZTRvm/UvkeUBC32iAXFiA==";
        };
        _xkCG09KI = {
            "id" = "xkCG09KI";
            "file" = "CTM OF-Fabric 1.19.3.zip";
            "hash" = "sha512-wT7vteSr/ubK8BM5iSF6URNRAZaISxXsaJEB8lQe1SsLThKuWFqTE8er5ohzyS2eKA11IUiLh3kbL4RSJMqtfQ==";
        };
        _ozhyhbhQ = {
            "id" = "ozhyhbhQ";
            "file" = "CTM OF-Fabric 1.20.2-1.21.8.zip";
            "hash" = "sha512-WvAYp4FMKpt9xEqi+CmWE6QLqnhWtgFVE16nAZY+WLBwC6ujm1UqGdXBD99mYlkugUHqL/jX3n6R1106stvcPw==";
        };
        _I38kQsHk = {
            "id" = "I38kQsHk";
            "file" = "CTM OF-Fabric 1.19-1.19.2.zip";
            "hash" = "sha512-wt6jN1vKbaS8twV/rkeWcBNK03bT8tSDORNQstT9qVPtonKbdi+sE4mHhYj8IMAtkasmLKTbU/z357psp1f1Ew==";
        };
    in {
        "xBVFbLWo" = _xBVFbLWo;
        "4xFgxZVZ" = _4xFgxZVZ;
        ...
        "ozhyhbhQ" = _ozhyhbhQ;
        "I38kQsHk" = _I38kQsHk;
        "minecraft-1.19.3" = _xkCG09KI;
        "minecraft-1.17" = _JDjG4ZVm;
        "minecraft-1.17.1" = _JDjG4ZVm;
        "minecraft-1.18" = _zPqLDOmF;
        "minecraft-1.18.1" = _zPqLDOmF;
        "minecraft-1.18.2" = _zPqLDOmF;
        "minecraft-1.19" = _I38kQsHk;
        "minecraft-1.19.1" = _I38kQsHk;
        "minecraft-1.19.2" = _I38kQsHk;
        "minecraft-1.19.4" = _XZXzw4h9;
        "minecraft-1.20" = _JPh318s1;
        "minecraft-1.20.1" = _JPh318s1;
        "minecraft-1.20.2" = _ozhyhbhQ;
        "minecraft-1.20.3" = _ozhyhbhQ;
        "minecraft-1.20.4" = _ozhyhbhQ;
        "minecraft-1.20.5" = _ozhyhbhQ;
        "minecraft-1.20.6" = _ozhyhbhQ;
        "minecraft-1.21" = _ozhyhbhQ;
        "minecraft-1.21.1" = _ozhyhbhQ;
        "minecraft-1.21.2" = _ozhyhbhQ;
        "minecraft-1.21.3" = _ozhyhbhQ;
        "minecraft-1.21.4" = _ozhyhbhQ;
        "minecraft-1.21.5" = _ozhyhbhQ;
        "minecraft-1.21.6" = _ozhyhbhQ;
        "minecraft-1.21.7" = _ozhyhbhQ;
        "minecraft-1.21.8" = _ozhyhbhQ;
        "minecraft-1.21.10" = _KHzPZnnF;
        "minecraft-1.21.11" = _KHzPZnnF;
        "minecraft-1.21.9" = _KHzPZnnF;
        "minecraft-26.1" = _KHzPZnnF;
        "minecraft-26.1.1" = _KHzPZnnF;
        "minecraft-26.1.2" = _KHzPZnnF;
        "minecraft-26.2" = _KHzPZnnF;
        "pkg-0.1" = _xBVFbLWo;
        "pkg-0.2" = _khCRofPw;
        "pkg-0.2+1.19.4" = _Fpr6tQLI;
        "pkg-0.2+1.20" = _AlizwGzt;
        "pkg-0.5.0+1.17.x" = _vJ0ZSK6L;
        "pkg-0.5.0+1.18.x" = _uHwmC8Oe;
        "pkg-0.5.0+1.19.x" = _NF55XGmA;
        "pkg-0.5.0+1.20.x" = _vuk7ih2u;
        "pkg-0.5.1+1.17.x" = _oGFiOeTm;
        "pkg-0.5.1+1.18.x" = _WQ5YR4gq;
        "pkg-0.5.1+1.19.x" = _3LvsU0Yl;
        "pkg-0.5.1+1.20.x" = _4ufd9RPJ;
        "pkg-0.5.1+1.20.2" = _MCqikj8g;
        "pkg-0.5.2+1.20.3-1.20.4" = _80vKCVhY;
        "pkg-0.5.3+1.17.x" = _bmn5mjFQ;
        "pkg-0.5.3+1.18.x" = _SBCod2JL;
        "pkg-0.5.3+1.19.4" = _QT5Tqj3d;
        "pkg-0.5.3+1.20.x" = _EM4zu6nI;
        "pkg-0.5.4+1.17.x" = _g1P2WnlS;
        "pkg-0.5.4+1.18.x" = _hQtgvATB;
        "pkg-0.5.4+1.19.4" = _lki2TrA9;
        "pkg-0.5.4+1.20.x" = _HWXETwna;
        "pkg-0.5.5+1.17.x" = _nmlavNQc;
        "pkg-0.5.5+1.18.x" = _SmOlYHrv;
        "pkg-0.5.5+1.19.4" = _7KfGFl4e;
        "pkg-0.5.5+1.20.x" = _W4aaz6cm;
        "pkg-0.5.6+1.20.x" = _pGtKZbhY;
        "pkg-0.6.0+1.17.x" = _x4SyQJGY;
        "pkg-0.6.0+1.18.x" = _rRmOY8it;
        "pkg-0.6.0+1.19.4" = _5yCs71VF;
        "pkg-0.6.0+1.20.x" = _qkuxpza7;
        "pkg-0.6.0+1.21.x" = _guSXFRmG;
        "pkg-0.6.1+1.17.x" = _BdDU6PFf;
        "pkg-0.6.1+1.18.x" = _HbZ7HLRL;
        "pkg-0.6.1+1.19.4" = _4tTZpGF7;
        "pkg-0.6.1+1.20.x-1.21.x" = _TJfYyote;
        "pkg-0.7.0+1.17.x" = _cMThMql8;
        "pkg-0.7.0+1.18.x" = _PPu1ePfC;
        "pkg-0.7.0+1.19.4" = _HMpUmLxQ;
        "pkg-0.7.0+1.20.x-1.21.x" = _fyKfPfoH;
        "pkg-0.7.1+1.17.x" = _7QRhkaTJ;
        "pkg-0.7.1+1.18.x" = _5Jigpy6l;
        "pkg-0.7.1+1.19-1.19.2" = _QFXuoQ2e;
        "pkg-0.7.1+1.19.3" = _rA4h3t5j;
        "pkg-0.7.1+1.19.4" = _QdX9Xoo6;
        "pkg-0.7.1+1.20.x-1.21.x" = _wJ9crocH;
        "pkg-0.7.2+1.17.x" = _kjd6P9cC;
        "pkg-0.7.2+1.18.x" = _2fUMKgjl;
        "pkg-0.7.2+1.19-1.19.2" = _qftlIn20;
        "pkg-0.7.2+1.19.3" = _PhtubLOs;
        "pkg-0.7.2+1.19.4" = _AVtVR8if;
        "pkg-0.7.2+1.20.x-1.21.x" = _xEcD5YLr;
        "pkg-0.7.3" = _IRnpAIEV;
        "pkg-0.8.0+1.17.x" = _B8FnmFhU;
        "pkg-0.8.0+1.18.x" = _unLJnQzM;
        "pkg-0.8.0+1.19-1.19.2" = _33EVpOoz;
        "pkg-0.8.0+1.19.3" = _6e2aBzF1;
        "pkg-0.8.0+1.19.4" = _b3kFFpXg;
        "pkg-0.8.0+1.20.x-1.21.x" = _M0BKkNQP;
        "pkg-0.8.1+1.20.x-1.21.x" = _QJlJHuvY;
        "pkg-0.8.1+1.21.10" = _HNJUwgfy;
        "pkg-0.9.0+1.17.x" = _BTc8HfwS;
        "pkg-0.9.0+1.18.x" = _pTWB7nWv;
        "pkg-0.9.0+1.19-1.19.2" = _fERoknLD;
        "pkg-0.9.0+1.19.3" = _sY9l7Uag;
        "pkg-0.9.0+1.19.4" = _NXqxOMHT;
        "pkg-0.9.0+1.20.x-1.21.8" = _oufKPc0V;
        "pkg-0.9.0+1.21.10" = _JnVKykyM;
        "pkg-0.9.1+1.17.x" = _mZ3d8yek;
        "pkg-0.9.1+1.18.x" = _3cT5in7o;
        "pkg-0.9.1+1.19-1.19.2" = _AhMGHg01;
        "pkg-0.9.1+1.19.3" = _6Js4QFfX;
        "pkg-0.9.1+1.19.4" = _unip3Ytu;
        "pkg-0.9.1+1.20.x-1.21.8" = _63LVYYnu;
        "pkg-0.9.1+1.21.10-1.21.11" = _uBkdlqOy;
        "pkg-0.10.0+1.17.x" = _3zgAgYaP;
        "pkg-0.10.0+1.18.x" = _oSvWYqGq;
        "pkg-0.10.0+1.19-1.19.2" = _kxBVnc9a;
        "pkg-0.10.0+1.19.3" = _xajsB4Ov;
        "pkg-0.10.0+1.19.4" = _6lBwCdO7;
        "pkg-0.10.0+1.20-1.20.1" = _ejdEUWSV;
        "pkg-0.10.0+1.20.2-1.21.8" = _ntZ8Nb8n;
        "pkg-0.10.0+1.21.9-26.1.x" = _SeIz3epM;
        "pkg-0.11.0+1.17.x" = _79dtCmyX;
        "pkg-0.11.0+1.18.x" = _grz6V4p0;
        "pkg-0.11.0+1.19-1.19.2" = _YPK4CvSO;
        "pkg-0.11.0+1.19.3" = _NwV8C92U;
        "pkg-0.11.0+1.19.4" = _O7OQfhJE;
        "pkg-0.11.0+1.20-1.20.1" = _IQSQIqDJ;
        "pkg-0.11.0+1.20.2-1.21.8" = _gYb8K20I;
        "pkg-0.11.0+1.21.9-26.2" = _SScqxsX9;
        "pkg-0.11.1+1.17.x" = _4Y8dhLh7;
        "pkg-0.11.1+1.18.x" = _FTIQ4ROv;
        "pkg-0.11.1+1.19-1.19.2" = _Yvrwsgbt;
        "pkg-0.11.1+1.19.3" = _DB568VgS;
        "pkg-0.11.1+1.19.4" = _AOzRH9RM;
        "pkg-0.11.1+1.20-1.20.1" = _LHARFf1v;
        "pkg-0.11.1+1.20.2-1.21.8" = _mEm85G7n;
        "pkg-0.11.1+1.21.9-26.2" = _FlDI6apA;
        "pkg-0.12.0+1.19.4" = _XZXzw4h9;
        "pkg-0.12.0+1.18.x" = _zPqLDOmF;
        "pkg-0.12.0+1.17.x" = _JDjG4ZVm;
        "pkg-0.12.0+1.21.9-26.2" = _KHzPZnnF;
        "pkg-0.12.0+1.20-1.20.1" = _JPh318s1;
        "pkg-0.12.0+1.19.3" = _xkCG09KI;
        "pkg-0.12.0+1.20.2-1.21.8" = _ozhyhbhQ;
        "pkg-0.12.0+1.19-1.19.2" = _I38kQsHk;
        "default" = _I38kQsHk;
    });
