...
let
    versions = (let
        ...
        _bTAM6ENy = {
            "id" = "bTAM6ENy";
            "file" = "itemscroller-fabric-1.21.11-0.30.7.jar";
            "hash" = "sha512-h+7McoZRgApgdunVSmn9oDqdAIFmObYZ+0doQkj7FbLpnmK97PtMWoxsJS/wtq/tPFJcqHoSRbbzvrBi6HMosQ==";
        };
        _eNCL15cc = {
            "id" = "eNCL15cc";
            "file" = "itemscroller-fabric-26.1.2-0.31.6.jar";
            "hash" = "sha512-HcvJyudYrYdCZmOoUo9pD5MMuDgR4F3NMBrZa2lYSrEM03ngLdIjT8m8kAu7nKefmRroadzA4PwhCIPvpmk8EQ==";
        };
        _dfYfqZ8t = {
            "id" = "dfYfqZ8t";
            "file" = "itemscroller-fabric-26.2-0.32.2.jar";
            "hash" = "sha512-eCAPlDJg/wli6z1i9fXCQFVXx95SzxeF8H4/iuC7ka8aH/u8R80iMmHuLWdPLS94CjL0EPMPKRfnyWUvSyzqJg==";
        };
        _dCHMUnrw = {
            "id" = "dCHMUnrw";
    ...
    in {
        ...
        "fabric-1.21.11" = _dCHMUnrw;
        "fabric-26.1" = _eNCL15cc;
        ...
        "pkg-0.9.0" = _fNWGONlZ;
        "pkg-0.9.1" = _Ut6gMD3Z;
        "pkg-0.10.0" = _sBrbFShH;
        "pkg-0.10.1" = _epQOhvdW;
        "pkg-0.10.2" = _hdjbS2qI;
        "pkg-0.10.3" = _ZQ9yPjd8;
        "pkg-0.11.0" = _OQ7nhkBO;
        "pkg-0.12.0-dev.20170317.003358" = _zubMm0dK;
        "pkg-0.12.0-alpha.1" = _Di1n67dW;
        "pkg-0.11.1-dev.20180301.160434" = _PvjdeCGi;
        "pkg-0.11.1-dev.20180308.164403" = _iN5wchzB;
        "pkg-0.11.1-dev.20180509.183459" = _Vj9gYbnW;
        "pkg-0.12.0" = _8WmEPnsy;
        "pkg-0.13.0" = _NzpDMt4I;
        "pkg-0.14.0-dev.20180824.012040" = _dksvah1e;
        "pkg-0.14.0-dev.20180824.012054" = _27xxnPww;
        "pkg-0.14.0" = _i0fZBrwU;
        "pkg-0.14.1" = _D6sbWniW;
        "pkg-0.14.2" = _BrsV98ms;
        "pkg-0.15.0-dev.20190209.173912" = _qPYOzPTk;
        "pkg-0.15.0-dev.20190222.224206" = _mxIoIHNy;
        "pkg-0.15.0-dev.20190303.020723" = _ky6wKztK;
        "pkg-0.15.0-dev.20190303.020738" = _Ti9KfVAI;
        "pkg-0.15.0-dev.20190315.001847" = _my1hZs61;
        "pkg-0.15.0-dev.20190317.002805" = _kXygAgpD;
        "pkg-0.15.0-dev.20190404.225140" = _LgDnXbo9;
        "pkg-0.15.0-dev.20190404.225156" = _Uo9ji2uS;
        "pkg-0.15.0-dev.20190426.011222" = _WCOGuTnP;
        "pkg-0.15.0-dev.20190426.011240" = _qH7slfoX;
        "pkg-0.15.0-dev.20190430.062822" = _HsRXE27E;
        "pkg-0.15.0-dev.20190430.062852" = _ntbsD9y8;
        "pkg-0.15.0-dev.20190504.212546" = _p9rktC4u;
        "pkg-0.15.0-dev.20190504.212609" = _AF3WMwVv;
        "pkg-0.14.3" = _Hx0Uz7VN;
        "pkg-0.15.0-dev.20190513.235741" = _nNN5pOfd;
        "pkg-0.15.0-dev.20190513.235751" = _qnarShex;
        "pkg-0.15.0-dev.20190523.143237" = _YY7Ijxsv;
        "pkg-0.15.0-dev.20190523.143316" = _Uvg1pEdg;
        "pkg-0.14.4" = _7E6cozOL;
        "pkg-0.15.0-dev.20190528.201610" = _ksJrz4jN;
        "pkg-0.15.0-dev.20190528.201648" = _lga82Kfa;
        "pkg-0.15.0-dev.20190529.162859" = _Iv7u7dOi;
        "pkg-0.15.0-dev.20190529.162915" = _NakVkbUc;
        "pkg-0.15.0-dev.20190609.195102" = _f7VTt5n2;
        "pkg-0.15.0-dev.20190610.012209" = _ZUgCFPie;
        "pkg-0.15.0-dev.20190610.012232" = _pIPBXq3H;
        "pkg-0.15.0-dev.20190613.131033" = _qdQCO3OQ;
        "pkg-0.12.1" = _EO7zPMXU;
        "pkg-0.15.0-dev.20190626.034657" = _JSpPr2BK;
        "pkg-0.15.0-dev.20190720.190250" = _7Du390ip;
        "pkg-0.15.0-dev.20190720.235518" = _keSZ7jmG;
        "pkg-0.15.0-dev.20190722.054145" = _qAMmHG65;
        "pkg-0.15.0-dev.20190722.215515" = _GsV5uOdI;
        "pkg-0.15.0-dev.20190722.215542" = _jJYKNFmS;
        "pkg-0.15.0-dev.20190806.191755" = _IavC1mR0;
        "pkg-0.15.0-dev.20190907.232707" = _SLyWVSVn;
        "pkg-0.15.0-dev.20190909.151706" = _70e2uiSU;
        "pkg-0.15.0-dev.20190913.204204" = _52dOByN8;
        "pkg-0.15.0-dev.20190917.182032" = _YxmIX8jA;
        "pkg-0.15.0-dev.20190917.182057" = _plYoxQEq;
        "pkg-0.15.0-dev.20191002.225333" = _gOOBuznF;
        "pkg-0.15.0-dev.20191011.225813" = _gdMko0xw;
        "pkg-0.15.0-dev.20191023.202251" = _gYNUqjxv;
        "pkg-0.15.0-dev.20191102.223528" = _NoYVSlDi;
        "pkg-0.15.0-dev.20191102.223552" = _1OWVzEHZ;
        "pkg-0.15.0-dev.20191121.220303" = _yniIHgN3;
        "pkg-0.15.0-dev.20191121.235250" = _dDrnRg7D;
        "pkg-0.15.0-dev.20191129.004712" = _kgE6AmB9;
        "pkg-0.15.0-dev.20191205.000749" = _u3W2HOVO;
        "pkg-0.15.0-dev.20191210.230125" = _EZqSczs0;
        "pkg-0.15.0-dev.20191211.010554" = _T5qBiHNx;
        "pkg-0.15.0-dev.20191217.194801" = _aVAQppG3;
        "pkg-0.15.0-dev.20191219.174131" = _S2u6TlMg;
        "pkg-0.15.0-dev.20191220.202710" = _TwiJTiIU;
        "pkg-0.15.0-dev.20200121.201417" = _XHjKGgAL;
        "pkg-0.15.0-dev.20200205.232841" = _T7frZJB6;
        "pkg-0.15.0-dev.20200212.183513" = _HaRzuof8;
        "pkg-0.15.0-dev.20200229.035553" = _kpkg2ViH;
        "pkg-0.15.0-dev.20200305.235615" = _PZxEAMuf;
        "pkg-0.15.0-dev.20200308.015649" = _ozXvQkxS;
        "pkg-0.15.0-dev.20200308.021849" = _hoeVMrRZ;
        "pkg-0.15.0-dev.20200312.002414" = _Ro5kSjf0;
        "pkg-0.15.0-dev.20200317.041920" = _aRRuSH5i;
        "pkg-0.15.0-dev.20200319.201356" = _u6WJy9Gq;
        "pkg-0.15.0-dev.20200322.005218" = _6s5fQCM0;
        "pkg-0.15.0-dev.20200326.033920" = _6CgbE8Sc;
        "pkg-0.15.0-dev.20200403.001744" = _vBVn1Uez;
        "pkg-0.15.0-dev.20200408.202205" = _F4VkMV6F;
        "pkg-0.15.0-dev.20200412.215031" = _rs1LM2tK;
        "pkg-0.15.0-dev.20200412.215325" = _dWa0x22T;
        "pkg-0.15.0-dev.20200416.001411" = _p9igNQJl;
        "pkg-0.15.0-dev.20200426.023540" = _39eLumwL;
        "pkg-0.15.0-dev.20200427.013720" = _jOofXHpE;
        "pkg-0.15.0-dev.20200430.003304" = _fPapnfaP;
        "pkg-0.15.0-dev.20200507.000139" = _B5VXOKwE;
        "pkg-0.15.0-dev.20200512.174928" = _kbZoSEQT;
        "pkg-0.15.0-dev.20200514.012232" = _OC1Vt9kH;
        "pkg-0.15.0-dev.20200515.215824" = _qWOlCqt7;
        "pkg-0.15.0-dev.20200522.010701" = _P9GT6qxz;
        "pkg-0.15.0-dev.20200529.222423" = _1r7U5l8O;
        "pkg-0.15.0-dev.20200531.030003" = _8YH5WBaL;
        "pkg-0.15.0-dev.20200608.223647" = _PifHCvrO;
        "pkg-0.15.0-dev.20200610.220730" = _W63ze0p5;
        "pkg-0.15.0-dev.20200624.214738" = _9EK58TwT;
        "pkg-0.15.0-dev.20200630.022843" = _lR8PSyV5;
        "pkg-0.15.0-dev.20200812.031004" = _ZA1o7KW5;
        "pkg-0.15.0-dev.20200824.205318" = _1kNDdmQN;
        "pkg-0.15.0-dev.20200824.205624" = _lFtmvDaE;
        "pkg-0.15.0-dev.20200912.221805" = _4mNrbD1Y;
        "pkg-0.15.0-dev.20200918.182509" = _Q1PtWgP7;
        "pkg-0.15.0-dev.20201103.183933" = _9ZnD875r;
        "pkg-0.15.0-dev.20201106.000258" = _aEs3TdtX;
        "pkg-0.15.0-dev.20201110.163710" = _XIJ6m2bO;
        "pkg-0.15.0-dev.20201125.225250" = _14rm2F3v;
        "pkg-0.15.0-dev.20201206.134314" = _qI9CxHO5;
        "pkg-0.15.0-dev.20201218.025932" = _Dkp3S1nE;
        "pkg-0.15.0-dev.20210105.174829" = _tbfgUaf9;
        "pkg-0.15.0-dev.20210108.022049" = _XQx8Sdn1;
        "pkg-0.15.0-dev.20210111.205029" = _CIcZ7WBJ;
        "pkg-0.15.0-dev.20210204.184345" = _iLrI70o9;
        "pkg-0.15.0-dev.20210307.001741" = _3faoSPDe;
        "pkg-0.15.0-dev.20210307.213813" = _UAFoCtwZ;
        "pkg-0.15.0-dev.20210404.182710" = _6ckfNjel;
        "pkg-0.15.0-dev.20210602.005919" = _vnZ44Zz6;
        "pkg-0.15.0-dev.20210603.040224" = _KUBo7t2J;
        "pkg-0.15.0-dev.20210603.144636" = _67tt9dfA;
        "pkg-0.15.0-dev.20210608.211652" = _IstLbBsE;
        "pkg-0.15.0-dev.20210624.025850" = _HMeCRAs7;
        "pkg-0.15.0-dev.20210707.005506" = _CUZGy58S;
        "pkg-0.15.0-dev.20210917.191808" = _qs7LyOGM;
        "pkg-0.15.0-dev.20211022.124449" = _dRHHUUIT;
        "pkg-0.15.0-dev.20211201.010054" = _IFBM5lya;
        "pkg-0.15.0" = _T23lYcq8;
        "pkg-0.16.0" = _EW41xf0N;
        "pkg-0.30.0" = _I9Ginfp2;
        "pkg-0.30.1" = _e1XlmieY;
        "pkg-0.31.0" = _QT3ZdOmj;
        "pkg-0.31.1" = _lBqRQXTh;
        "pkg-0.16.1" = _qmLRKNxp;
        "pkg-0.17.0" = _Ke6rIwsh;
        "pkg-0.17.1" = _3839VGk9;
        "pkg-0.18.0" = _d0K0MQJC;
        "pkg-0.19.2" = _CVKnjXnN;
        "pkg-0.20.0" = _XdGX4JFd;
        "pkg-0.21.0" = _q2fbrdkF;
        "pkg-0.22.0-beta.1" = _PsdxoP84;
        "pkg-0.22.0" = _UA8OibaS;
        "pkg-0.40.0-alpha.1" = _jtmiJuVd;
        "pkg-0.23.0" = _AqrOKuln;
        "pkg-0.24.50" = _uK5Njuv8;
        "pkg-0.24.51" = _ObmNNA5j;
        "pkg-0.24.52" = _OfCe7pFG;
        "pkg-0.24.53" = _QvxSqkE9;
        "pkg-0.25.0" = _5Kl8cEJ8;
        "pkg-0.24.54" = _kkiGk2HX;
        "pkg-0.25.1" = _3OMiGpU0;
        "pkg-0.24.55" = _9oIwbsjP;
        "pkg-0.25.2" = _8ksqAnkU;
        "pkg-0.26.0" = _awl8cjYT;
        "pkg-0.40.1" = _oyB7vP8E;
        "pkg-0.24.57" = _jKveiO18;
        "pkg-0.25.4" = _HBLhmLTt;
        "pkg-0.26.2" = _gLpCYGWp;
        "pkg-0.27.0" = _9rqfrRDE;
        "pkg-0.24.58" = _x9Fy5m5j;
        "pkg-0.25.5" = _7cvi5Z2b;
        "pkg-0.26.3" = _2dqBo02u;
        "pkg-0.27.1" = _or2Q8a63;
        "pkg-0.24.59" = _UfoXF5yo;
        "pkg-0.25.6" = _aNbZtOeS;
        "pkg-0.26.4" = _t8kXfehw;
        "pkg-0.27.2" = _cTfmVpPo;
        "pkg-0.28.0" = _4146nRwK;
        "pkg-0.28.1" = _hvzvjsCL;
        "pkg-0.28.2" = _7hi92a5X;
        "pkg-0.28.3" = _h3bWEtMy;
        "pkg-0.28.4" = _djHu7LSB;
        "pkg-0.29.0" = _wQFytPvp;
        "pkg-0.29.1" = _JB6YhGQU;
        "pkg-0.29.2" = _DlBrZwem;
        "pkg-0.29.4" = _rN8qrzoC;
        "pkg-0.24.60" = _BmE8Lr1a;
        "pkg-0.25.7" = _H0KjRIae;
        "pkg-0.26.5" = _JyPupzmm;
        "pkg-0.27.3" = _ZVXUVfk2;
        "pkg-0.28.5" = _pP0Z03i0;
        "pkg-0.29.5" = _p662PcEr;
        "pkg-0.30.2" = _FcppMcft;
        "pkg-0.30.3" = _aMcHiG8j;
        "pkg-0.31.2" = _9FhCZDDE;
        "pkg-0.30.4" = _tRlYI5oo;
        "pkg-0.31.3" = _xpCi8j1s;
        "pkg-0.30.5" = _nuEiK4qE;
        "pkg-0.31.4" = _4IOqE2jc;
        "pkg-0.32.0" = _ERY6RV4L;
        "pkg-0.30.6" = _ncgA0UCO;
        "pkg-0.31.5" = _CiSruvT0;
        "pkg-0.32.1" = _yAj3ZLjM;
        "pkg-0.30.7" = _bTAM6ENy;
