...
let
    ...
    in {
        ...
        "pkg-21.4.109" = _BQJYPc9Z;
        "pkg-21.4.112" = _4wdGg2pK;
        "pkg-21.5.0" = _g8ut5F1B;
        "pkg-21.5.1" = _69AWX8Jj;
        "pkg-21.5.9" = _wB0JdzHc;
        "pkg-21.5.16" = _m7Fh7lV3;
        "pkg-21.5.17" = _YBkLpzva;
        "pkg-21.5.18" = _Zjc9nXMc;
        "pkg-21.6.0" = _g7fIbMor;
        "pkg-21.7.0" = _L6MGU9OZ;
        "pkg-21.7.1" = _gweEy5JZ;
        "pkg-21.6.3" = _hn8UUb6K;
        "pkg-21.7.6" = _29ZFQ1Ql;
        "pkg-21.7.8" = _MNImxAM1;
        "pkg-21.10.0" = _P9nWHT3N;
        "pkg-21.10.4" = _cVN5QWR7;
        "pkg-21.11.0" = _Xtx7paLU;
        "pkg-21.10.5" = _w54azYnz;
        "pkg-21.11.1" = _yiMyr0Yo;
        "pkg-26.1.0" = _cNslNYSy;
