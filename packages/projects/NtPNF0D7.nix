...
let
    ...
    in {
        ...
        "pkg-0.1.2-1.20.1" = _qQVsKpiZ;
        "pkg-0.1.2-1.20.4" = _ngwTxI8B;
        "pkg-0.1.2-1.20.5" = _Y5yI7PaM;
        "pkg-0.1.2-1.20.5+6" = _ssmrZOF4;
        "pkg-0.1.3-1.20.4" = _GQg18N74;
        "pkg-0.1.3-1.20.5+6" = _xspdzYkV;
        "pkg-0.1.4-1.21" = _KKuUtFAb;
        "pkg-0.1.5-1.21" = _piOqmn1R;
        "pkg-0.1.5-1.21.1" = _ObxNHXfE;
        "pkg-0.1.5-1.21.2-pre1" = _8gWzuLWF;
        "pkg-0.1.5-1.21.3" = _aGO0QYI8;
        "pkg-0.1.5-1.21.4" = _AeRa5kkZ;
        "pkg-0.1.2-1.20.2" = _ZJUTQKXD;
        "pkg-0.1.5-1.21.5" = _eFp6RzGX;
        "pkg-0.1.5-1.21.6" = _mDL1e7Zw;
        "pkg-0.1.5-1.21.7" = _xSRg9pVs;
        "pkg-0.1.5-1.21.8" = _tWuCV9rM;
        "pkg-0.1.5-1.21.9" = _bKPMvzVi;
        "pkg-0.1.5-1.21.10" = _c9UWpLMq;
        "pkg-0.1.5-1.21.11" = _KJacCJnF;
