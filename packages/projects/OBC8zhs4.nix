...
let
    versions = (let
        ...
        _m7v84F4f = {
            "id" = "m7v84F4f";
            "file" = "金合欢的Xaero地图翻译_1.16+.zip";
            "hash" = "sha512-pqlPwapZP/2JzyQLQQ8Jcms9mwRoChsZYcQmCuwfWTgGKHBKCRRKEwkxIC7uZhBQQIb3b6xuSDxQNbJ3kLflyg==";
        };
    in {
        "HXWYc6iK" = _HXWYc6iK;
        "qBxzHymP" = _qBxzHymP;
        ...
        "minecraft-1.16" = _m7v84F4f;
        "minecraft-1.16.1" = _m7v84F4f;
        "minecraft-1.16.2" = _m7v84F4f;
        "minecraft-1.16.3" = _m7v84F4f;
        "minecraft-1.16.4" = _m7v84F4f;
        "minecraft-1.16.5" = _m7v84F4f;
        "minecraft-1.17" = _m7v84F4f;
        "minecraft-1.17.1" = _m7v84F4f;
        "minecraft-1.18" = _m7v84F4f;
        "minecraft-1.18.1" = _m7v84F4f;
        "minecraft-1.18.2" = _m7v84F4f;
        "minecraft-1.19" = _m7v84F4f;
        "minecraft-1.19.1" = _m7v84F4f;
        "minecraft-1.19.2" = _m7v84F4f;
        "minecraft-1.19.3" = _m7v84F4f;
        "minecraft-1.19.4" = _m7v84F4f;
        "minecraft-1.20" = _m7v84F4f;
        "minecraft-1.20.1" = _m7v84F4f;
        "minecraft-1.20.2" = _m7v84F4f;
        "minecraft-1.20.3" = _m7v84F4f;
        "minecraft-1.20.4" = _m7v84F4f;
        "minecraft-1.20.5" = _m7v84F4f;
        "minecraft-1.20.6" = _m7v84F4f;
        "minecraft-1.21" = _m7v84F4f;
        "minecraft-1.21.1" = _m7v84F4f;
        "minecraft-1.21.2" = _m7v84F4f;
        "minecraft-1.21.3" = _m7v84F4f;
        "minecraft-1.21.4" = _m7v84F4f;
        "minecraft-1.21.5" = _m7v84F4f;
        "minecraft-1.21.6" = _m7v84F4f;
        "minecraft-1.21.7" = _m7v84F4f;
        "minecraft-1.21.8" = _m7v84F4f;
        "minecraft-1.21.9" = _m7v84F4f;
        "minecraft-1.21.10" = _m7v84F4f;
        "minecraft-1.21.11" = _m7v84F4f;
        "minecraft-26.1" = _m7v84F4f;
        "minecraft-26.1.1" = _m7v84F4f;
        "minecraft-26.1.2" = _m7v84F4f;
        "minecraft-26.2" = _m7v84F4f;
        "pkg-v1" = _qBxzHymP;
        "pkg-v2" = _ZxOmZ6SZ;
        "pkg-v3" = _2IxkOdIh;
        "pkg-v4" = _zbFVizUL;
