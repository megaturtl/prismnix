...
let
    ...
    in {
        ...
        "pkg-1.1.1" = _hMxOcV5j;
        "pkg-1.1.2" = _tAgGHGih;
        "pkg-1.2.0+mc1.21" = _oH2pNZo9;
        "pkg-1.2.0+mc1.21.5" = _FxxRNkTb;
        "pkg-1.2.0+mc1.21.6" = _THASnJKC;
        "pkg-1.3.0+mc1.21.6" = _44yqH5Uj;
        "pkg-1.3.0+mc1.21.4" = _cga0c7Mc;
        "pkg-1.3.1+mc1.21.4" = _UcG6eKcY;
        "pkg-1.3.1+mc1.21.6" = _cBEYjsmv;
        "pkg-1.3.1+mc1.21.7" = _iLJlNquj;
        "pkg-1.3.2+mc1.21.7" = _MBxt6F7x;
        "pkg-1.3.2+mc1.21.4" = _cINN7tyn;
        "pkg-1.3.2+mc1.21.8" = _KVitJ4Px;
        "pkg-2.0.0+mc1.21.8" = _nDvwHrF0;
        "pkg-2.0.0+mc1.21.4" = _xhRG4oTd;
        "pkg-2.1.0+mc1.21.8" = _RgAViYBO;
        "pkg-2.1.0+mc1.21.4" = _KuPAcmFM;
        "pkg-2.2.0+mc1.21.4" = _kBoj9wiL;
        "pkg-2.2.0+mc1.21.8" = _zJLkLE3W;
        "pkg-3.0.0+mc1.21.4" = _WcVziLwX;
        "pkg-3.0.0+mc1.21.8" = _JkyNYl8l;
        "pkg-4.0.0+mc1.21.9" = _YZNH66WG;
        "pkg-4.0.0+mc1.21.4" = _vhf5GJwR;
        "pkg-4.0.1+mc1.21.9" = _xJ0shLgK;
        "pkg-4.0.1+mc1.21.4" = _kQk9eaOT;
        "pkg-4.0.1+mc1.21.10" = _8tcjNg7L;
        "pkg-4.0.2+mc1.21.4" = _oJWy0ptg;
        "pkg-4.0.2+mc1.21.10" = _rw1u26xC;
        "pkg-4.1.0+mc1.21.10" = _qks5JxJ3;
        "pkg-4.1.0+mc1.21.4" = _q04i8wAO;
        "pkg-4.1.1+mc1.21.4" = _QUUZmjKg;
        "pkg-4.1.1+mc1.21.10" = _8rKGHbLl;
        "pkg-4.1.1+mc1.21.11" = _pJ50gnai;
        "pkg-4.2.0+mc1.21.11" = _2VyjYtOP;
        "pkg-4.2.0+mc1.21.4" = _gPiWEGNb;
        "pkg-4.2.1+mc1.21.11" = _bN1DO5Fd;
        "pkg-4.2.1+mc1.21.4" = _7E509jhM;
        "pkg-4.2.2+mc1.21.11" = _FADO3vco;
        "pkg-4.2.2+mc1.21.4" = _M4Fhv9NJ;
        "pkg-4.2.3+mc1.21.11" = _15ymoiG9;
        "pkg-4.2.3+mc1.21.4" = _j5KJWIgm;
        "pkg-4.3.0+mc1.21.11" = _9a0N17bN;
