...
let
    ...
    in {
        ...
        "pkg-1.19.2" = _avorDzS1;
        "pkg-1.19.3" = _KCg1Yu95;
        "pkg-1.20" = _7Uc2KZC6;
        "pkg-2.0" = _3CyeUyM9;
        "pkg-3.0" = _3KbZPSow;
        "pkg-1.20.1" = _7JzeJFg1;
        "pkg-2.0.1" = _JWkbHgb8;
        "pkg-3.0.1" = _m1rnyPO7;
        "pkg-2.0.1.1" = _Wwxerlg3;
        "pkg-3.0.1.1" = _DhwiqAcT;
        "pkg-1.21" = _mtgMDOfN;
        "pkg-9112025" = _iEAGjlOc;
        "pkg-22112025" = _UKmlOfcR;
        "pkg-12122025" = _lGfOW52D;
        "pkg-3.1" = _jAPVVZ9s;
        "pkg-1.21.1" = _XZtYJmPq;
        "pkg-4.0" = _zwT4u8Li;
        "pkg-3.1.1" = _euDdfcYG;
        "pkg-3.1.2" = _ZVjKtXRH;
        "pkg-3.1.3" = _xlksRlm3;
