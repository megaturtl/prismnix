...
let
    versions = (let
        ...
        _hKLCNp3G = {
            "id" = "hKLCNp3G";
            "file" = "Mellow v3.4b.zip";
            "hash" = "sha512-9Vk7NhdZPry1jwFJc2Wp+t/aEo8A9XmjTTIPKur9ATfjdoqj2oFvz0gEnTvwml31pnbOgG7Q3iAXK2IuGgPvfw==";
        };
        _fORiOdHS = {
            "id" = "fORiOdHS";
            "file" = "Mellow Shader v3.4.zip";
            "hash" = "sha512-gC3j60v03cC6w+WJ3KD5FH8NxI2qwF07bsIRL912nDwXtcuw+Gix/0bJZEZsvDYA6M0VV5nd+HOQpT1xE6WtJA==";
        };
    in {
        "Z3BA66V7" = _Z3BA66V7;
        "vVRhPpGO" = _vVRhPpGO;
        ...
        "hKLCNp3G" = _hKLCNp3G;
        "fORiOdHS" = _fORiOdHS;
        "iris-1.20.4" = _fORiOdHS;
        "iris-1.20.6" = _fORiOdHS;
        "iris-1.17" = _fORiOdHS;
        "iris-1.17.1" = _fORiOdHS;
        "iris-1.18" = _fORiOdHS;
        "iris-1.18.1" = _fORiOdHS;
        "iris-1.18.2" = _fORiOdHS;
        "iris-1.19" = _fORiOdHS;
        "iris-1.19.1" = _fORiOdHS;
        "iris-1.19.2" = _fORiOdHS;
        "iris-1.19.3" = _fORiOdHS;
        "iris-1.19.4" = _fORiOdHS;
        "iris-1.20" = _fORiOdHS;
        "iris-1.20.1" = _fORiOdHS;
        "iris-1.20.2" = _fORiOdHS;
        "iris-1.20.3" = _fORiOdHS;
        "iris-1.20.5" = _fORiOdHS;
        "iris-1.8" = _fORiOdHS;
        "iris-1.8.1" = _fORiOdHS;
        "iris-1.8.2" = _fORiOdHS;
        "iris-1.8.3" = _fORiOdHS;
        "iris-1.8.4" = _fORiOdHS;
        "iris-1.8.5" = _fORiOdHS;
        "iris-1.8.6" = _fORiOdHS;
        "iris-1.8.7" = _fORiOdHS;
        "iris-1.8.8" = _fORiOdHS;
        "iris-1.8.9" = _fORiOdHS;
        "iris-1.9" = _fORiOdHS;
        "iris-1.9.1" = _fORiOdHS;
        "iris-1.9.2" = _fORiOdHS;
        "iris-1.9.3" = _fORiOdHS;
        "iris-1.9.4" = _fORiOdHS;
        "iris-1.10" = _fORiOdHS;
        "iris-1.10.1" = _fORiOdHS;
        "iris-1.10.2" = _fORiOdHS;
        "iris-1.11" = _fORiOdHS;
        "iris-1.11.1" = _fORiOdHS;
        "iris-1.11.2" = _fORiOdHS;
        "iris-1.12" = _fORiOdHS;
        "iris-1.12.1" = _fORiOdHS;
        "iris-1.12.2" = _fORiOdHS;
        "iris-1.13" = _fORiOdHS;
        "iris-1.13.1" = _fORiOdHS;
        "iris-1.13.2" = _fORiOdHS;
        "iris-1.14" = _fORiOdHS;
        "iris-1.14.1" = _fORiOdHS;
        "iris-1.14.2" = _fORiOdHS;
        "iris-1.14.3" = _fORiOdHS;
        "iris-1.14.4" = _fORiOdHS;
        "iris-1.15" = _fORiOdHS;
        "iris-1.15.1" = _fORiOdHS;
        "iris-1.15.2" = _fORiOdHS;
        "iris-1.16" = _fORiOdHS;
        "iris-1.16.1" = _fORiOdHS;
        "iris-1.16.2" = _fORiOdHS;
        "iris-1.16.3" = _fORiOdHS;
        "iris-1.16.4" = _fORiOdHS;
        "iris-1.16.5" = _fORiOdHS;
        "iris-1.21" = _fORiOdHS;
        "iris-1.21.1" = _fORiOdHS;
        "iris-1.21.2" = _fORiOdHS;
        "iris-1.21.3" = _fORiOdHS;
        "iris-1.21.4" = _fORiOdHS;
        "iris-1.21.5" = _fORiOdHS;
        "iris-1.21.6" = _fORiOdHS;
        "iris-1.21.7" = _fORiOdHS;
        "iris-1.21.8" = _fORiOdHS;
        "iris-1.21.9" = _fORiOdHS;
        "iris-1.21.10" = _fORiOdHS;
        "iris-1.21.11" = _fORiOdHS;
        "iris-26.1" = _fORiOdHS;
        "iris-26.1.1" = _fORiOdHS;
        "iris-26.1.2" = _fORiOdHS;
        "iris-26.2" = _fORiOdHS;
        "optifine-1.20.4" = _fORiOdHS;
        "optifine-1.20.6" = _fORiOdHS;
        "optifine-1.17" = _fORiOdHS;
        "optifine-1.17.1" = _fORiOdHS;
        "optifine-1.18" = _fORiOdHS;
        "optifine-1.18.1" = _fORiOdHS;
        "optifine-1.18.2" = _fORiOdHS;
        "optifine-1.19" = _fORiOdHS;
        "optifine-1.19.1" = _fORiOdHS;
        "optifine-1.19.2" = _fORiOdHS;
        "optifine-1.19.3" = _fORiOdHS;
        "optifine-1.19.4" = _fORiOdHS;
        "optifine-1.20" = _fORiOdHS;
        "optifine-1.20.1" = _fORiOdHS;
        "optifine-1.20.2" = _fORiOdHS;
        "optifine-1.20.3" = _fORiOdHS;
        "optifine-1.20.5" = _fORiOdHS;
        "optifine-1.8" = _fORiOdHS;
        "optifine-1.8.1" = _fORiOdHS;
        "optifine-1.8.2" = _fORiOdHS;
        "optifine-1.8.3" = _fORiOdHS;
        "optifine-1.8.4" = _fORiOdHS;
        "optifine-1.8.5" = _fORiOdHS;
        "optifine-1.8.6" = _fORiOdHS;
        "optifine-1.8.7" = _fORiOdHS;
        "optifine-1.8.8" = _fORiOdHS;
        "optifine-1.8.9" = _fORiOdHS;
        "optifine-1.9" = _fORiOdHS;
        "optifine-1.9.1" = _fORiOdHS;
        "optifine-1.9.2" = _fORiOdHS;
        "optifine-1.9.3" = _fORiOdHS;
        "optifine-1.9.4" = _fORiOdHS;
        "optifine-1.10" = _fORiOdHS;
        "optifine-1.10.1" = _fORiOdHS;
        "optifine-1.10.2" = _fORiOdHS;
        "optifine-1.11" = _fORiOdHS;
        "optifine-1.11.1" = _fORiOdHS;
        "optifine-1.11.2" = _fORiOdHS;
        "optifine-1.12" = _fORiOdHS;
        "optifine-1.12.1" = _fORiOdHS;
        "optifine-1.12.2" = _fORiOdHS;
        "optifine-1.13" = _fORiOdHS;
        "optifine-1.13.1" = _fORiOdHS;
        "optifine-1.13.2" = _fORiOdHS;
        "optifine-1.14" = _fORiOdHS;
        "optifine-1.14.1" = _fORiOdHS;
        "optifine-1.14.2" = _fORiOdHS;
        "optifine-1.14.3" = _fORiOdHS;
        "optifine-1.14.4" = _fORiOdHS;
        "optifine-1.15" = _fORiOdHS;
        "optifine-1.15.1" = _fORiOdHS;
        "optifine-1.15.2" = _fORiOdHS;
        "optifine-1.16" = _fORiOdHS;
        "optifine-1.16.1" = _fORiOdHS;
        "optifine-1.16.2" = _fORiOdHS;
        "optifine-1.16.3" = _fORiOdHS;
        "optifine-1.16.4" = _fORiOdHS;
        "optifine-1.16.5" = _fORiOdHS;
        "optifine-1.21" = _fORiOdHS;
        "optifine-1.21.1" = _fORiOdHS;
        "optifine-1.21.2" = _fORiOdHS;
        "optifine-1.21.3" = _fORiOdHS;
        "optifine-1.21.4" = _fORiOdHS;
        "optifine-1.21.5" = _fORiOdHS;
        "optifine-1.21.6" = _fORiOdHS;
        "optifine-1.21.7" = _fORiOdHS;
        "optifine-1.21.8" = _fORiOdHS;
        "optifine-1.21.9" = _fORiOdHS;
        "optifine-1.21.10" = _fORiOdHS;
        "optifine-1.21.11" = _fORiOdHS;
        "optifine-26.1" = _fORiOdHS;
        "optifine-26.1.1" = _fORiOdHS;
        "optifine-26.1.2" = _fORiOdHS;
        "optifine-26.2" = _fORiOdHS;
        "pkg-1" = _Z3BA66V7;
        "pkg-2" = _vVRhPpGO;
        "pkg-3" = _QqAYfNVD;
        "pkg-4" = _djpjAv4y;
