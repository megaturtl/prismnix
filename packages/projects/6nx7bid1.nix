...
let
    versions = (let
        ...
        _Clc7gsVj = {
            "id" = "Clc7gsVj";
            "file" = "Cubic Leaves 2.4 (resource pack compatible).zip";
            "hash" = "sha512-juJa3wNmi33O3kCco2QYelqPKq+hrQ6jkADWb8w4/S5lPYZWnfyJCD4srXt+nphSKu1NH4l9j/RuCt9ryhf1iA==";
        };
        _qcHDQhNX = {
            "id" = "qcHDQhNX";
            "file" = "Cubic Leaves 2.4 (performance).zip";
            "hash" = "sha512-ONPn+8OjTZf0mMBUvZdGyb4c6ga1U7gaMgkvSxL8F+XxgBdFGpuwBAIXZMITM3mgAuJB0kGTFFjt280CEQUK5g==";
        };
    in {
        "trNSoJqE" = _trNSoJqE;
        "BRwPWYA3" = _BRwPWYA3;
        ...
        "Clc7gsVj" = _Clc7gsVj;
        "qcHDQhNX" = _qcHDQhNX;
        "minecraft-1.13" = _qcHDQhNX;
        "minecraft-1.13.1" = _qcHDQhNX;
        "minecraft-1.13.2" = _qcHDQhNX;
        "minecraft-1.14" = _qcHDQhNX;
        "minecraft-1.14.1" = _qcHDQhNX;
        "minecraft-1.14.2" = _qcHDQhNX;
        "minecraft-1.14.3" = _qcHDQhNX;
        "minecraft-1.14.4" = _qcHDQhNX;
        "minecraft-1.15" = _qcHDQhNX;
        "minecraft-1.15.1" = _qcHDQhNX;
        "minecraft-1.15.2" = _qcHDQhNX;
        "minecraft-1.16" = _qcHDQhNX;
        "minecraft-1.16.1" = _qcHDQhNX;
        "minecraft-1.16.2" = _qcHDQhNX;
        "minecraft-1.16.3" = _qcHDQhNX;
        "minecraft-1.16.4" = _qcHDQhNX;
        "minecraft-1.16.5" = _qcHDQhNX;
        "minecraft-1.17" = _qcHDQhNX;
        "minecraft-1.17.1" = _qcHDQhNX;
        "minecraft-1.18" = _qcHDQhNX;
        "minecraft-1.18.1" = _qcHDQhNX;
        "minecraft-1.18.2" = _qcHDQhNX;
        "minecraft-1.19" = _qcHDQhNX;
        "minecraft-1.19.1" = _qcHDQhNX;
        "minecraft-1.19.2" = _qcHDQhNX;
        "minecraft-1.19.3" = _qcHDQhNX;
        "minecraft-1.19.4" = _qcHDQhNX;
        "minecraft-1.20" = _qcHDQhNX;
        "minecraft-1.20.1" = _qcHDQhNX;
        "minecraft-1.20.2" = _qcHDQhNX;
        "minecraft-1.20.3" = _qcHDQhNX;
        "minecraft-1.20.4" = _qcHDQhNX;
        "minecraft-1.20.5" = _qcHDQhNX;
        "minecraft-1.20.6" = _qcHDQhNX;
        "minecraft-1.21" = _qcHDQhNX;
        "minecraft-1.21.1" = _qcHDQhNX;
        "minecraft-1.21.2" = _qcHDQhNX;
        "minecraft-1.21.3" = _qcHDQhNX;
        "minecraft-1.21.4" = _qcHDQhNX;
        "minecraft-1.21.5" = _qcHDQhNX;
        "minecraft-1.21.6" = _qcHDQhNX;
        "minecraft-1.21.7" = _qcHDQhNX;
        "minecraft-1.21.8" = _qcHDQhNX;
        "minecraft-1.21.9" = _qcHDQhNX;
        "minecraft-1.21.10" = _qcHDQhNX;
        "minecraft-1.21.11" = _qcHDQhNX;
        "minecraft-26.1" = _qcHDQhNX;
        "minecraft-26.1.1" = _qcHDQhNX;
        "minecraft-26.1.2" = _qcHDQhNX;
        "minecraft-26.2" = _qcHDQhNX;
        "minecraft-26.3" = _qcHDQhNX;
        "pkg-1.0-mc1.13" = _trNSoJqE;
        "pkg-1.1-compat" = _BRwPWYA3;
        "pkg-1.1-fast" = _rziqqV79;
        "pkg-1.2-fast" = _qKx6iE5n;
        "pkg-1.3-fast" = _kJzlev7y;
        "pkg-1.4-compat" = _EvV6J7FP;
        "pkg-1.4-fast" = _EfP5ZLZq;
        "pkg-1.5-compat" = _DqvXnKdO;
        "pkg-1.5-fast" = _J8ayXYuv;
        "pkg-1.6-compat" = _SjyJgIbZ;
        "pkg-1.6-fast" = _HxhkQaVg;
        "pkg-1.7-compat" = _XrayeYgv;
        "pkg-1.7-fast" = _szy6618Q;
        "pkg-1.8-compat" = _38wvDZd7;
        "pkg-1.8-fast" = _lTGtAr1Q;
        "pkg-1.9-compat" = _YlEIRLJv;
        "pkg-1.9-perf" = _n7pEXIhN;
        "pkg-2.0-compat" = _j0wGRCyH;
        "pkg-2.0-perf" = _P2w7YDMz;
        "pkg-2.1-compat" = _FojO9zMW;
        "pkg-2.1-perf" = _gYt5uBbI;
        "pkg-2.2-compat" = _mLmXsxnB;
        "pkg-2.2-perf" = _nxIMir2h;
        "pkg-2.3-compat" = _aEDGXRLP;
        "pkg-2.3-perf" = _rtyFdBOa;
        "pkg-2.4-compat" = _Clc7gsVj;
        "pkg-2.4-perf" = _qcHDQhNX;
        "default" = _qcHDQhNX;
    });
