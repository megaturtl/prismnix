...
let
    versions = (let
        ...
        _gRJBLNWh = {
            "id" = "gRJBLNWh";
            "file" = "SimpleDiscordLink-Universal-3.4.5.jar";
            "hash" = "sha512-Ym48Qkq7r537afc5BtutAdLR0NL9uDtnZzlYYCl8b1Wkt6keF/vXZmbAMq2FGf9Uv4xFKeeRK6cGyYYZe4incA==";
        };
    in {
        "auQZxcmD" = _auQZxcmD;
        "77WtAgIY" = _77WtAgIY;
        ...
        "fabric-1.18.2" = _gRJBLNWh;
        "fabric-1.19" = _oxCi5LAQ;
        "fabric-1.19.1" = _YQcotmVn;
        "fabric-1.19.2" = _gRJBLNWh;
        "fabric-1.19.3" = _R49qbfnG;
        "fabric-1.19.4" = _R49qbfnG;
        "fabric-1.20" = _gRJBLNWh;
        "fabric-1.20.1-rc1" = _ZuyAYJhO;
        "fabric-1.20.1" = _gRJBLNWh;
        "fabric-1.20.2" = _R49qbfnG;
        "fabric-1.20.3" = _R49qbfnG;
        "fabric-1.20.4" = _R49qbfnG;
        "fabric-1.21" = _gRJBLNWh;
        "fabric-1.21.1" = _gRJBLNWh;
        "fabric-1.21.2" = _6sbR3f3z;
        "fabric-1.21.3" = _gRJBLNWh;
        "fabric-1.21.4" = _gRJBLNWh;
        "fabric-1.21.5" = _gRJBLNWh;
        "fabric-1.21.6" = _gRJBLNWh;
        "fabric-1.21.7" = _gRJBLNWh;
        "fabric-1.21.8" = _gRJBLNWh;
        "fabric-1.21.9" = _gRJBLNWh;
        "fabric-1.21.10" = _gRJBLNWh;
        "fabric-1.21.11" = _gRJBLNWh;
        ...
        "forge-1.19.2" = _gRJBLNWh;
        "forge-1.19.3" = _R49qbfnG;
        "forge-1.19.4" = _R49qbfnG;
        "forge-1.20" = _gRJBLNWh;
        "forge-1.20.1-rc1" = _f3SdouB3;
        "forge-1.20.1" = _gRJBLNWh;
        "forge-1.20.2" = _R49qbfnG;
        "forge-1.20.3" = _R49qbfnG;
        "forge-1.20.4" = _R49qbfnG;
        "forge-1.21" = _gRJBLNWh;
        "forge-1.21.1" = _gRJBLNWh;
        "forge-1.21.2" = _6sbR3f3z;
        "forge-1.21.3" = _gRJBLNWh;
        "forge-1.21.4" = _gRJBLNWh;
        "forge-1.21.5" = _gRJBLNWh;
        "forge-1.21.6" = _gRJBLNWh;
        "forge-1.21.7" = _gRJBLNWh;
        "forge-1.21.8" = _gRJBLNWh;
        "forge-1.21.9" = _gRJBLNWh;
        "forge-1.21.10" = _gRJBLNWh;
        "forge-1.21.11" = _gRJBLNWh;
        ...
        "quilt-1.19.2" = _gRJBLNWh;
        "quilt-1.19.3" = _R49qbfnG;
        "quilt-1.16.5" = _wCMtarLq;
        "quilt-1.19.4" = _R49qbfnG;
        "quilt-1.20" = _gRJBLNWh;
        "quilt-1.20.1-rc1" = _ZuyAYJhO;
        "quilt-1.20.1" = _gRJBLNWh;
        "quilt-1.20.2" = _R49qbfnG;
        "quilt-1.20.3" = _R49qbfnG;
        "quilt-1.20.4" = _R49qbfnG;
        "quilt-1.21" = _gRJBLNWh;
        "quilt-1.21.1" = _gRJBLNWh;
        "quilt-1.21.2" = _6sbR3f3z;
        "quilt-1.21.3" = _gRJBLNWh;
        "quilt-1.21.4" = _gRJBLNWh;
        "quilt-1.21.5" = _gRJBLNWh;
        "quilt-1.21.6" = _gRJBLNWh;
        "quilt-1.21.7" = _gRJBLNWh;
        "quilt-1.21.8" = _gRJBLNWh;
        "quilt-1.21.9" = _gRJBLNWh;
        "quilt-1.21.10" = _gRJBLNWh;
        "quilt-1.21.11" = _gRJBLNWh;
        ...
        "neoforge-1.20" = _gRJBLNWh;
        "neoforge-1.20.1" = _gRJBLNWh;
        "neoforge-1.20.2" = _R49qbfnG;
        "neoforge-1.20.3" = _R49qbfnG;
        "neoforge-1.20.4" = _R49qbfnG;
        "neoforge-1.21" = _gRJBLNWh;
        "neoforge-1.21.1" = _gRJBLNWh;
        "neoforge-1.21.2" = _6sbR3f3z;
        "neoforge-1.21.3" = _gRJBLNWh;
        "neoforge-1.21.4" = _gRJBLNWh;
        "neoforge-1.21.5" = _gRJBLNWh;
        "neoforge-1.21.6" = _gRJBLNWh;
        "neoforge-1.21.7" = _gRJBLNWh;
        "neoforge-1.21.8" = _gRJBLNWh;
        "neoforge-1.21.9" = _gRJBLNWh;
        "neoforge-1.21.10" = _gRJBLNWh;
        "neoforge-1.21.11" = _gRJBLNWh;
        ...
        "pkg-1.18.1-1.3.0" = _BTjkqnLg;
        "pkg-1.19-1.3.0f" = _FqYXzLn3;
        "pkg-1.19-1.3.0" = _fqFnyZNQ;
        "pkg-1.16.5-1.4.0f" = _1yVpcSNd;
        "pkg-1.16.5-1.4.0" = _zxMDnMI9;
        "pkg-1.18.1-1.4.0f" = _vbT17hJD;
        "pkg-1.18.1-1.4.0" = _DsJGohAf;
        "pkg-1.19-1.4.0f" = _oxCi5LAQ;
        "pkg-1.19-1.4.0" = _aBUBQJkP;
        "pkg-1.19.1-1.4.1f" = _TCkNED2m;
        "pkg-1.19.1-1.4.1" = _E3v6iBV7;
        "pkg-1.16.5-2.0.0f" = _rHhJ6V2S;
        "pkg-1.16.5-2.0.0" = _sC1pseCF;
        "pkg-1.18.1-2.0.0f" = _sGS5x6eI;
        "pkg-1.18.1-2.0.0" = _PLlsxCeJ;
        "pkg-1.19.1-2.0.0f" = _Ji1U4CvQ;
        "pkg-1.19.1-2.0.0" = _7TNliLg7;
        "pkg-1.18.1-2.0.1f" = _ZpYcn07S;
        "pkg-1.18.1-2.0.1" = _uEDW4N7e;
        "pkg-1.19.1-2.0.1f" = _XoNjYY7s;
        "pkg-1.19.1-2.0.1" = _WjkgQjyp;
        "pkg-1.16.5-2.1.0f" = _DFR4KJJy;
        "pkg-1.16.5-2.1.0" = _cMc4p2nQ;
        "pkg-1.18.1-2.1.0f" = _BIXPPbJA;
        "pkg-1.18.1-2.1.0" = _OreZ8XYQ;
        "pkg-1.19.1-2.1.0f" = _YGhQzzUV;
        "pkg-1.19.1-2.1.0" = _bqetmas6;
        "pkg-1.19.3-2.1.0f" = _JmRuwVRc;
        "pkg-1.19.3-2.1.0" = _mAB0YkWY;
        "pkg-1.16.5-2.2.0.finalf" = _SGjbdHbT;
        "pkg-1.16.5-2.2.0.final" = _3Gg018PA;
        "pkg-1.18.1-2.2.0f" = _fjb7PWNt;
        "pkg-1.18.1-2.2.0" = _KHBlQI8q;
        "pkg-1.19.1-2.2.0f" = _fcCvzfEN;
        "pkg-1.19.1-2.2.0" = _lhNSlUag;
        "pkg-1.19.3-2.2.0f" = _U77niVPZ;
        "pkg-1.19.3-2.2.0" = _AnpykLGB;
        "pkg-1.16.5-2.2.1.final" = _FmfBszJM;
        "pkg-1.18.1-2.2.1" = _3DZiaGx6;
        "pkg-1.19.1-2.2.1" = _uVcM0Gdk;
        "pkg-1.19.3-2.2.1" = _MTGFMPrs;
        "pkg-1.16.5-2.2.2.final" = _OBySo3h5;
        "pkg-1.18.1-2.2.2" = _XTeURROS;
        "pkg-1.19.1-2.2.2" = _L5o0Pta1;
        "pkg-1.19.3-2.2.2" = _o6PeNvt1;
        "pkg-1.20-2.2.2" = _f3SdouB3;
        "pkg-1.18.1-2.2.3" = _ORiipIRy;
        "pkg-1.19.1-2.2.3" = _EFOtYbjs;
        "pkg-1.20-2.2.3" = _9J2OOU2n;
        "pkg-1.18.1-2.2.4" = _CzZRBJWW;
        "pkg-1.19.1-2.2.4" = _YQcotmVn;
        "pkg-1.19.3-2.2.4" = _kBkO8a45;
        "pkg-1.20-2.2.4" = _txL4nZcz;
        "pkg-1.20.2-2.2.4" = _5qFJE9Cw;
        "pkg-1.18.2-3.0.0" = _J0BPITOp;
        "pkg-1.19.2-3.0.0" = _SJcyWCa1;
        "pkg-1.20-3.0.0" = _FrWZgcNC;
        "pkg-1.18.2-3.0.1" = _N0vEV4zK;
        "pkg-1.19.2-3.0.1" = _pREDfxP9;
        "pkg-1.20-3.0.1" = _rtVmg0Ey;
        "pkg-3.1.0" = _tsAzYS2f;
        "pkg-3.1.1" = _As4UhLqH;
        "pkg-3.1.2" = _FRKC30zu;
        "pkg-3.1.3" = _LmRVlHyB;
