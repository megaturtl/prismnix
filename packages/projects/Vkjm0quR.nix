...
let
    ...
    in {
        ...
        "pkg-1.2-aaa52d9" = _6tliwop6;
        "pkg-1.2-6081d2e" = _WbzS5bu4;
        "pkg-1.2-e28fe23" = _tSK3CdPj;
        "pkg-1.2-d3ca803" = _O6ELKAxC;
        "pkg-1.3-3413ada" = _s2w2F2Y4;
        "pkg-1.3-6e2c239" = _pZ6f0WUo;
        "pkg-1.3-e2454ef" = _5z2XFudE;
        "pkg-1.4-66cd23b" = _Vs5Iyx7I;
        "pkg-1.4-36ffa6c" = _1kzhNzNn;
        "pkg-1.5-caabe97" = _2hLiTeXE;
        "pkg-1.5-34f773e" = _DefPrCZw;
        "pkg-1.5-dd2acea" = _yYoBVIkr;
        "pkg-1.5-9c97b2a" = _tj4L6IIW;
        "pkg-1.5-7b11269" = _sGfR4BAc;
        "pkg-1.5-f08632b" = _ltbMycKQ;
        "pkg-1.5-a27f57f" = _nUBZPcf8;
