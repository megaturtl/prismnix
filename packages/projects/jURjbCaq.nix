...
let
    versions = (let
        ...
        _qNr2Ekc5 = {
            "id" = "qNr2Ekc5";
            "file" = "variants-cit-5.6.0+1.21.4.jar";
            "hash" = "sha512-8G9qBtvjbG5DWQH1t48+uAAg3Un2R2hrw+5T0RVFdAsS0TVD9aGkOy2hRD4PMklaucWL/icjXZzj+OTpCTIugg==";
        };
        _IxTbyRqs = {
            "id" = "IxTbyRqs";
            "file" = "variants-cit-5.6.0+1.21.5.jar";
            "hash" = "sha512-IXhjSHGgbz5Xw57NHY4yaEBPShAdVZ22Z+bGK3MDGKt26m1mzdyTzjKBawl4c6Vh0Q9kjPD8bTWRiGne5RkATg==";
        };
        _mCdtlWRK = {
            "id" = "mCdtlWRK";
            "file" = "variants-cit-5.6.0+1.21.8.jar";
            "hash" = "sha512-b5McUytmSAgYDv10FdyQrSXTrWx4bbh2EudamJNGyF2ogX8UU1i/cFVjehk9+fVnTVkswpnso7mAYRD8a3MELQ==";
        };
        _sVjh9UjS = {
            "id" = "sVjh9UjS";
            "file" = "variants-cit-5.6.0+1.21.11.jar";
            "hash" = "sha512-Nq0+BEMngnXMn8At+GUmDTnxABqzhB8gMd2cPrjkuHNvd1uejAnxnWexQogGjGsmMcsgPaWtD2+z/Bt+0zzV7g==";
        };
        _zG4G5vbC = {
            "id" = "zG4G5vbC";
            "file" = "variants-cit-5.6.0+26.1.2.jar";
            "hash" = "sha512-D764FmiasFiQjOv81Yj4P4VP/otM4whFPBwCmjlakfkppSdjlFnLnbELCbmrDAtuS6Nyp2cBSN562HCPvz/VDw==";
        };
        _AMG8x0YN = {
            "id" = "AMG8x0YN";
            "file" = "variants-cit-5.6.0+26.3-pre-2.jar";
            "hash" = "sha512-n2rBqCArWf6Y/udMvuUWCWJm0rShHhQYDpYzV6F7N4uBZzxt0oaTzEEFG22TO8Iov+CPpIUZfM8UsS/1qEaG1Q==";
        };
        _xBBpjwS7 = {
            "id" = "xBBpjwS7";
            "file" = "variants-cit-5.6.1+26.3-pre-2.jar";
            "hash" = "sha512-OLgNLB5ArDiUVpetnH+8FgWVSMd93Jm+zZTtC35tfTfJ6lg5USaRHN09NRlshBwwyhiJ40oNFL0ZtRw9ubXp4A==";
        };
        _xuvsPyPw = {
            "id" = "xuvsPyPw";
            "file" = "variants-cit-5.7.0+1.21.4.jar";
            "hash" = "sha512-u6CXtmAukQJboYZEdF1yPT9ghmIDF9ztkyfmkH+i/he8f+Y8R3jr3zLZBW6LgeWUBGnZC1HJR9DRA9DGFl9Ufw==";
        };
        _k6fQb675 = {
            "id" = "k6fQb675";
            "file" = "variants-cit-5.7.0+1.21.5.jar";
            "hash" = "sha512-N6AzawTu9D/R7iFvuE6wijNamfOPO6nRueuU3Qs3kyvTdYxS5vAq/qvnspOa/Ghq9MLGmMno+qATZebq1p6aNg==";
        };
        _u0NZSs58 = {
            "id" = "u0NZSs58";
            "file" = "variants-cit-5.7.0+1.21.8.jar";
            "hash" = "sha512-RxNGJS+DVBHuyguzJ+jqZf158s4EmMjW3NBu8hiMv3/1PW9WcMXb5Te7lwDpsnFVaWh2V0jHMK2lk+Utq7bQBQ==";
        };
        _I207Tba8 = {
            "id" = "I207Tba8";
            "file" = "variants-cit-5.7.0+1.21.11.jar";
            "hash" = "sha512-hecWq6MjUDGN6zVgTnGmqonTYkvr6nPDiwu8i0SVQcPxaAsWZ/co64DW1K5mg+wDW+ylQoM8/jdsBvQoHj4Vgw==";
        };
        _PWoHErnd = {
            "id" = "PWoHErnd";
            "file" = "variants-cit-5.7.0+26.1.2.jar";
            "hash" = "sha512-l5mjXpk8Hp3KIybWMCOYniTIL2i2p408RurPs9z1QILedsRRXwP1Clg59Y+bptORh1FLesk5AmwlhCcL33F5eg==";
        };
        _ZIvWBpId = {
            "id" = "ZIvWBpId";
            "file" = "variants-cit-5.7.0+26.3.jar";
            "hash" = "sha512-ooxMUd39FwfC8yQL2CUInpp3iYgChL2U/PEPqWakTVI7EB9rDxDgfkSBk1idEbXlGjssOiYbZbqW7CdaVJo62g==";
        };
    in {
        "6PgNWKdT" = _6PgNWKdT;
        "wEkwHyDf" = _wEkwHyDf;
        ...
        "fabric-1.21.4" = _xuvsPyPw;
        "fabric-1.21.5" = _k6fQb675;
        "fabric-1.21.6" = _u0NZSs58;
        "fabric-1.21.7" = _u0NZSs58;
        "fabric-1.21.8" = _u0NZSs58;
        "fabric-1.21.9" = _I207Tba8;
        "fabric-1.21.10" = _I207Tba8;
        "fabric-1.21.11" = _I207Tba8;
        "fabric-26.1-rc-1" = _xLQMEGLZ;
        "fabric-26.1-rc-2" = _xLQMEGLZ;
        "fabric-26.1-rc-3" = _xLQMEGLZ;
        "fabric-26.1" = _PWoHErnd;
        "fabric-26.1.1" = _PWoHErnd;
        "fabric-26.1.2" = _PWoHErnd;
        "fabric-26.2" = _PWoHErnd;
        "fabric-26.3-pre-1" = _AMG8x0YN;
        "fabric-26.3-pre-2" = _xBBpjwS7;
        "fabric-26.3" = _ZIvWBpId;
        "pkg-1.0.0+1.21" = _6PgNWKdT;
        "pkg-1.0.1+1.21" = _wEkwHyDf;
        "pkg-1.1.0+1.21.1" = _17Vgv9op;
        "pkg-2.0.0+1.21.1" = _7ndprNMm;
        "pkg-2.1.0+1.21.1" = _gIvKLAho;
        "pkg-2.2.0+1.21.1" = _19Jk9gSx;
        "pkg-2.3.0+1.21.1" = _fXJPp57h;
        "pkg-2.4.0+1.21.1" = _qpOIA1yF;
        "pkg-2.5.0+1.21.1" = _AzOnWvDr;
        "pkg-2.5.1+1.21.1" = _kP3iMfwE;
        "pkg-2.5.1+1.21.3" = _K4BAYnRQ;
        "pkg-3.0.0+1.21.4-pre1" = _xM6k2v8o;
        "pkg-2.6.0+1.21.1" = _zzrwajHL;
        "pkg-2.6.0+1.21.3" = _LD2ocE7Z;
        "pkg-3.1.0+1.21.4-pre1" = _1J9Chbde;
        "pkg-2.6.1+1.21.3" = _8Q98gOrq;
        "pkg-2.7.0+1.21.1" = _CZSzbTsc;
        "pkg-2.7.0+1.21.3" = _xQOzFQWa;
        "pkg-3.2.0+1.21.4" = _z0XcbRLK;
        "pkg-2.7.1+1.21.1" = _gpthkvVk;
        "pkg-2.7.1+1.21.3" = _sxwsSzjK;
        "pkg-3.2.1+1.21.4" = _t7eG4U9U;
        "pkg-2.8.0+1.21.1" = _o1AjLrt2;
        "pkg-2.8.0+1.21.3" = _A9CGkvXv;
        "pkg-3.3.0+1.21.4" = _7Yrf5Lnq;
        "pkg-2.9.0+1.21.1" = _NoeUiW97;
        "pkg-2.9.0+1.21.3" = _Gha0HUez;
        "pkg-3.4.0+1.21.4" = _nC4G4uCg;
        "pkg-3.4.1+1.21.4" = _MNkQVIQq;
        "pkg-3.4.2+1.21.4" = _7jFVHrKI;
        "pkg-2.10.0+1.21.1" = _sOgbKjGu;
        "pkg-2.10.0+1.21.3" = _bQGMHYkq;
        "pkg-3.5.0+1.21.4" = _LoluC7jD;
        "pkg-4.0.0+1.21.5" = _rxQPlXIg;
        "pkg-2.10.1+1.21.1" = _CcBjWUjE;
        "pkg-2.10.1+1.21.3" = _2IWQLpox;
        "pkg-3.5.1+1.21.4" = _CcJTboqw;
        "pkg-4.0.1+1.21.5" = _libx2f69;
        "pkg-2.11.0+1.21.1" = _JQ5va9oX;
        "pkg-2.11.0+1.21.3" = _cOdIb8NJ;
        "pkg-3.6.0+1.21.4" = _yLoUybiq;
        "pkg-4.1.0+1.21.5" = _gQXbFpHH;
        "pkg-2.11.1+1.21.1" = _i5h72KgY;
        "pkg-2.11.1+1.21.3" = _s8RJc7o4;
        "pkg-3.6.1+1.21.4" = _KqzYvZUe;
        "pkg-4.1.1+1.21.5" = _PDqFqS8B;
        "pkg-2.12.0+1.21.1" = _TDEvTEsC;
        "pkg-2.12.0+1.21.3" = _8EWKmqQm;
        "pkg-3.7.0+1.21.4" = _RLVKWsaX;
        "pkg-4.2.0+1.21.5" = _1dcU4zjE;
        "pkg-4.2.0+1.21.6" = _R0VbHmSQ;
        "pkg-3.8.0+1.21.4" = _kxA3QFbd;
        "pkg-4.3.0+1.21.5" = _jGTvx1bV;
        "pkg-4.3.0+1.21.6" = _lagDwF6T;
        "pkg-3.8.1+1.21.4" = _UxdrcoIz;
        "pkg-4.3.1+1.21.5" = _YHUN8N7X;
        "pkg-4.3.1+1.21.6" = _FrQbLZJe;
        "pkg-3.8.2+1.21.4" = _jYFAlxXi;
        "pkg-4.3.2+1.21.5" = _JiXJyCzc;
        "pkg-4.3.2+1.21.6" = _hOsp4Bn8;
        "pkg-4.3.3+1.21.6" = _6eaRxt3k;
        "pkg-4.3.4+1.21.6" = _DZhkyLr2;
        "pkg-2.13.0+1.21.1" = _BfwRZ2dm;
        "pkg-2.13.0+1.21.3" = _7vTLCEeh;
        "pkg-3.9.0+1.21.4" = _hGe2ydVE;
        "pkg-4.4.0+1.21.5" = _KqgWchv7;
        "pkg-4.4.0+1.21.6" = _jbqfrgRc;
        "pkg-2.13.1+1.21.1" = _Fr4sfbEV;
        "pkg-2.13.1+1.21.3" = _3k7BU89m;
        "pkg-3.9.1+1.21.4" = _Eivo6xPT;
        "pkg-4.4.1+1.21.5" = _Ys0izOad;
        "pkg-4.4.1+1.21.6" = _AAi1fkvs;
        "pkg-4.4.1+1.21.9" = _dCaZscgB;
        "pkg-2.14.0+1.21.1" = _hDhStLml;
        "pkg-2.14.0+1.21.3" = _StMXBeOq;
        "pkg-3.10.0+1.21.4" = _5nq3HLGt;
        "pkg-4.5.0+1.21.5" = _2RJT2CsK;
        "pkg-4.5.0+1.21.6" = _IfGU0bTb;
        "pkg-4.5.0+1.21.9" = _5mitZzMJ;
        "pkg-2.15.0+1.21.1" = _lbl2NEAM;
        "pkg-2.15.0+1.21.3" = _MJc3OOhz;
        "pkg-3.11.0+1.21.4" = _ZKMu72Hd;
        "pkg-4.6.0+1.21.5" = _YiG3B1av;
        "pkg-4.6.0+1.21.6" = _B6Mhynoj;
        "pkg-4.6.0+1.21.9" = _M66MgFIv;
        "pkg-3.11.1+1.21.4" = _HqAZEDWM;
        "pkg-4.6.1+1.21.5" = _JXj3O04g;
        "pkg-4.6.1+1.21.6" = _sMmav1Za;
        "pkg-4.6.1+1.21.9" = _vpsSRE3i;
        "pkg-3.12.0+1.21.4" = _ZU4zSPrm;
        "pkg-4.7.0+1.21.5" = _bv6XAgaD;
        "pkg-4.7.0+1.21.6" = _RqHe6mAY;
        "pkg-4.7.0+1.21.9" = _xlg7LH9B;
        "pkg-2.16.0+1.21.1" = _8zo3kkmp;
        "pkg-3.13.0+1.21.4" = _nFIw7Qzi;
        "pkg-4.8.0+1.21.5" = _P59QHodX;
        "pkg-4.8.0+1.21.6" = _eDJfqbVQ;
        "pkg-4.8.0+1.21.9" = _P68KjAry;
        "pkg-3.13.1+1.21.4" = _N251JoKa;
        "pkg-4.8.1+1.21.5" = _GxdKNBlm;
        "pkg-4.8.1+1.21.6" = _WmFKZ14a;
        "pkg-4.8.1+1.21.9" = _m1xDNDR8;
        "pkg-4.8.2+1.21.9" = _XzW1KYxs;
        "pkg-3.14.0+1.21.4" = _IyzbfbfY;
        "pkg-4.9.0+1.21.5" = _fy5kQ6uF;
        "pkg-4.9.0+1.21.6" = _URGDv4qg;
        "pkg-4.9.0+1.21.9" = _Kk8p22I3;
        "pkg-3.15.0+1.21.4" = _XjhwsdOp;
        "pkg-4.10.0+1.21.5" = _kmobsdU6;
        "pkg-4.10.0+1.21.6" = _H8W70Gb4;
        "pkg-4.10.0+1.21.9" = _QHjgbBVk;
        "pkg-2.17.0+1.21.1" = _Zq5N1Tuy;
        "pkg-3.16.0+1.21.4" = _sGL0iFjA;
        "pkg-4.11.0+1.21.5" = _aBlF1npe;
        "pkg-4.11.0+1.21.6" = _xsR8EtTe;
        "pkg-4.11.0+1.21.9" = _G6kaj2Qz;
        "pkg-3.16.1+1.21.4" = _DpnxPMsi;
        "pkg-4.11.1+1.21.5" = _qcCaBgxh;
        "pkg-4.11.1+1.21.6" = _oFV1di3U;
        "pkg-4.11.1+1.21.9" = _1O3S9C68;
        "pkg-2.17.1+1.21.1" = _ybKKQlzA;
        "pkg-3.16.2+1.21.4" = _eXaiUwdV;
        "pkg-4.11.2+1.21.5" = _uGg19VN7;
        "pkg-4.11.2+1.21.6" = _nmUgqtZe;
        "pkg-4.11.2+1.21.9" = _58zT1Sfp;
        "pkg-5.0.0+1.21.4" = _yBMuyMij;
        "pkg-5.0.0+1.21.5" = _SQlfT7rX;
        "pkg-5.0.0+1.21.6" = _oTUAydsH;
        "pkg-5.0.0+1.21.9" = _cBPq48MV;
        "pkg-5.0.0+26.1-rc-1" = _xLQMEGLZ;
        "pkg-5.1.0+1.21.4" = _7WMrrMJ3;
        "pkg-5.1.0+1.21.5" = _VfjAAs8k;
        "pkg-5.1.0+1.21.6" = _RI6DKfSZ;
        "pkg-5.1.0+1.21.9" = _MBN9hIUa;
        "pkg-5.1.0+26.1.2" = _ftyu6Jjd;
        "pkg-5.2.0+1.21.4" = _2Lthm07h;
        "pkg-5.2.0+1.21.5" = _A8o9kFsr;
        "pkg-5.2.0+1.21.6" = _YUGcG1vX;
        "pkg-5.2.0+1.21.9" = _XnMZxjll;
        "pkg-5.2.0+26.1.2" = _DGduY7fl;
        "pkg-5.2.1+1.21.4" = _U6ruHJBH;
        "pkg-5.2.1+1.21.5" = _Urp1Y9HS;
        "pkg-5.2.1+1.21.6" = _Ti4AeaSi;
        "pkg-5.2.1+1.21.9" = _A6c2OsWS;
        "pkg-5.2.1+26.1.2" = _i2dEYd1l;
        "pkg-5.3.0+1.21.4" = _iwxnJWmB;
        "pkg-5.3.0+1.21.5" = _KKbWxT2u;
        "pkg-5.3.0+1.21.6" = _jUPs96zF;
        "pkg-5.3.0+1.21.9" = _CeKKivFL;
        "pkg-5.3.0+26.1.2" = _OC9LtGBI;
        "pkg-2.17.2+1.21.1" = _eITngfig;
        "pkg-5.4.0+1.21.4" = _4oYuIHwn;
        "pkg-5.4.0+1.21.5" = _t66FD0nk;
        "pkg-5.4.0+1.21.6" = _v8ULy6Kb;
        "pkg-5.4.0+1.21.9" = _uVMKwW5I;
        "pkg-5.4.0+26.1.2" = _xkMXt6te;
        "pkg-5.4.1+1.21.4" = _FUWWvi5F;
        "pkg-5.4.1+1.21.5" = _5o7Wp7zx;
        "pkg-5.4.1+1.21.6" = _mFcx8I9E;
        "pkg-5.4.1+1.21.9" = _82pCS1O2;
        "pkg-5.4.1+26.1.2" = _juYjE2lO;
        "pkg-5.4.2+1.21.4" = _LKgcMLzV;
        "pkg-5.4.2+1.21.5" = _omb79rCF;
        "pkg-5.4.2+1.21.6" = _KPZjF65C;
        "pkg-5.4.2+1.21.9" = _EANZcsnY;
        "pkg-5.4.2+26.1.2" = _wEIHIdvr;
        "pkg-2.18.0+1.21.1" = _B5XMHaLw;
        "pkg-5.5.0+1.21.4" = _lE8RaNhl;
        "pkg-5.5.0+1.21.5" = _JESbeRaJ;
        "pkg-5.5.0+1.21.6" = _GcLNKfBG;
        "pkg-5.5.0+1.21.9" = _tSXo271z;
        "pkg-5.5.0+26.1.2" = _b4DROu2F;
        "pkg-5.6.0+1.21.4" = _qNr2Ekc5;
        "pkg-5.6.0+1.21.5" = _IxTbyRqs;
        "pkg-5.6.0+1.21.8" = _mCdtlWRK;
        "pkg-5.6.0+1.21.11" = _sVjh9UjS;
        "pkg-5.6.0+26.1.2" = _zG4G5vbC;
        "pkg-5.6.0+26.3-pre-2" = _AMG8x0YN;
        "pkg-5.6.1+26.3-pre-2" = _xBBpjwS7;
        "pkg-5.7.0+1.21.4" = _xuvsPyPw;
        "pkg-5.7.0+1.21.5" = _k6fQb675;
        "pkg-5.7.0+1.21.8" = _u0NZSs58;
        "pkg-5.7.0+1.21.11" = _I207Tba8;
        "pkg-5.7.0+26.1.2" = _PWoHErnd;
        "pkg-5.7.0+26.3" = _ZIvWBpId;
        "default" = _ZIvWBpId;
    });
