...
let
    ...
    in {
        ...
        "pkg-48.1" = _ntQ1IpBd;
        "pkg-48.1+mod" = _ZmUTq5n3;
        "pkg-57.1" = _kyjplSrG;
        "pkg-57.1+mod" = _8hbLxv7D;
        "pkg-61.1" = _rVfRrMLP;
        "pkg-61.1+mod" = _LVsDDYhT;
        "pkg-71.1" = _11DgmroU;
        "pkg-71.1+mod" = _GHWXfkYT;
        "pkg-80" = _ouBjKwJ4;
        "pkg-80+mod" = _GWPZdiXl;
        "pkg-81" = _CgVLKqwF;
        "pkg-81+mod" = _vKmRWmEv;
        "pkg-88.0" = _YVEWqoul;
        "pkg-88.0+mod" = _5jWj1Sfd;
        "pkg-94.1" = _tv7TnKCp;
        "pkg-94.1+mod" = _AobP3dON;
        "pkg-101.1" = _M8Ih2ySG;
