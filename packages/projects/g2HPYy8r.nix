...
let
    versions = (let
        ...
        _tCcJwY2n = {
            "id" = "tCcJwY2n";
            "file" = "showdurability-1.1.3+26.3.jar";
            "hash" = "sha512-msl4CBXQ9+Sc6s8MVd42mhZ/nMXJVooAzE7Vy1EdLETBkUGOlmaWXovcvzHbwtwMdBx8L9j99asGZKSmJyCcNw==";
        };
    in {
        "UzvKDdDR" = _UzvKDdDR;
        "yWzHe1OU" = _yWzHe1OU;
        ...
        "fabric-26.3" = _tCcJwY2n;
        "pkg-1.0.0+1.19" = _UzvKDdDR;
        "pkg-1.0.0+1.19.3" = _yWzHe1OU;
        "pkg-1.1.0+1.19.3" = _c8S3QYEq;
        "pkg-1.1.0+1.19.4" = _AEGK9Nlr;
        "pkg-1.1.0+1.19" = _ncymdmdd;
        "pkg-1.1.0+1.20" = _F5HtoP4q;
        "pkg-1.1.0+1.20.1" = _SXSF7axn;
        "pkg-1.1.1+1.20.2" = _9SCUIhjw;
        "pkg-1.1.1+1.20.4" = _dcKHGfDI;
        "pkg-1.1.1+1.20.5" = _k7vdPoxA;
        "pkg-1.1.1+1.20.6" = _VAtOum5G;
        "pkg-1.1.1+1.21.0" = _UbQ06vYZ;
        "pkg-1.1.1+1.21.3" = _oIhHCkWc;
        "pkg-1.1.1+1.21.4" = _DrVxPb7l;
        "pkg-1.1.2+1.21.5" = _p4rjc22r;
        "pkg-1.1.2+1.21.6" = _oTNMOM60;
        "pkg-1.1.2+1.21.7" = _3jHopItZ;
        "pkg-1.1.2+1.21.8" = _PVojG7Xq;
        "pkg-1.1.2+1.21.10" = _Z6n6DGas;
        "pkg-1.1.2+1.21.11" = _fuiLNB8b;
        "pkg-1.1.3+1.21.11" = _xWEF6IaN;
        "pkg-1.1.3+26.1" = _RRk2eBAw;
        "pkg-1.1.3+26.2" = _UccwYEfh;
        "pkg-1.1.3+26.3" = _tCcJwY2n;
        "default" = _tCcJwY2n;
    });
