...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.20.1-Forge" = _IbF8jOzM;
        "pkg-1.0.0-1.18.2-Fabric" = _zXYVf5JG;
        "pkg-1.0.0-1.18.2-Forge" = _Cw3IUw7T;
        "pkg-1.0.2-1.16.5-Fabric" = _db6ts2l2;
        "pkg-1.0.2-1.16.5-Forge" = _Cja7lDXS;
        "pkg-1.1.0-1.18.2-Fabric" = _tQlhI3bR;
        "pkg-1.1.0-1.18.2-Forge" = _QoVAHmet;
        "pkg-1.1.0-1.16.5-Fabric" = _98a77BJA;
        "pkg-1.1.0-1.16.5-Forge" = _XQ6WZLJ6;
        "pkg-1.1.0-1.19.2-Fabric" = _yS15dSuy;
        "pkg-1.1.0-1.19.2-Forge" = _cimbIKj4;
        "pkg-1.1.0-1.20.1-Forge" = _afnahih1;
        "pkg-1.1.0-1.20.1-Fabric" = _DI2kD0EC;
        "pkg-1.1.1-1.20.2-Forge" = _Vm1iBOCD;
        "pkg-1.1.1-1.20.2-Fabric" = _Ijeiwo7N;
        "pkg-1.1.1-1.20.4-Fabric" = _cxreeJW8;
        "pkg-1.1.1-1.20.4-Forge" = _CM94Xiae;
        "pkg-1.2.0-1.20.4-Forge" = _arc3ndMf;
        "pkg-1.2.0-1.20.4-Fabric" = _xLKJlgB0;
        "pkg-1.2.1-1.20.4-Forge" = _EuI84RYq;
        "pkg-1.2.0-1.16.5-Forge" = _rYmBY47Z;
        "pkg-1.2.0-1.16.5-Fabric" = _xbfr4lim;
        "pkg-1.2.0-1.18.2-Forge" = _qb9aPagK;
        "pkg-1.2.0-1.18.2-Fabric" = _DGjGD0D0;
        "pkg-1.2.0-1.19.2-Fabric" = _RFe4jWRM;
        "pkg-1.2.0-1.20.1-Fabric" = _U8v9zkui;
        "pkg-1.2.0-1.20.1-Forge" = _G0F2gcOY;
        "pkg-1.2.0-1.21-Fabric" = _MpxIF7MP;
        "pkg-1.2.0-1.21-Forge" = _eGhETkXP;
        "pkg-1.2.1-1.21-Fabric" = _j3dUJrxG;
        "pkg-1.2.1-1.21-Forge" = _whlPhfLP;
        "pkg-1.2.2-1.21-Forge" = _K67LIT0a;
        "pkg-1.2.2-1.21-Fabric" = _b9zF89o7;
        "pkg-1.2.3-1.21-Fabric" = _uJX3rgAp;
        "pkg-1.2.3-1.21-Neoforge" = _ls87N1Ne;
        "pkg-1.2.3-1.21-Forge" = _6b03xAy8;
        "pkg-1.2.3-1.20.1-Fabric" = _Oua9OehX;
        "pkg-1.2.3-1.20.4-Forge" = _dm4tdAhs;
        "pkg-1.2.3-1.20.4-Fabric" = _BvBQGsx6;
        "pkg-1.2.3-1.19.2-Forge" = _2YN7QqFc;
        "pkg-1.2.3-1.19.2-Fabric" = _iNmg5a83;
        "pkg-1.2.3-1.18.2-Fabric" = _1lsiSVyX;
        "pkg-1.2.3-1.16.5-Fabric" = _KVmVqTJs;
        "pkg-1.2.4-1.20.1-Fabric" = _NCt09DAw;
        "pkg-1.2.4-1.20.1-Forge" = _uf9xx8BP;
        "pkg-1.2.4-1.19.2-Forge" = _t9kM6QRA;
        "pkg-1.2.4-1.19.2-Fabric" = _ToXgclPU;
        "pkg-1.2.4-1.20.4-Fabric" = _KiuNAbiW;
        "pkg-1.2.4-1.20.4-Forge" = _Cl2ihohg;
        "pkg-1.2.4-1.18.2-Forge" = _KI5MiBAg;
        "pkg-1.2.4-1.18.2-Fabric" = _8mKO2IB3;
        "pkg-1.2.4-1.16.5-Forge" = _DkWDOmgk;
        "pkg-1.2.4-1.16.5-Fabric" = _295apnFi;
        "pkg-1.2.4-1.21.1-Neoforge" = _kMB7tpcR;
        "pkg-1.2.4-1.21.1-Fabric" = _83hz3HEv;
        "pkg-1.2.4-1.21.1-Forge" = _LncbqZar;
        "pkg-1.2.5-1.18.2-Fabric" = _bfMcoxF0;
        "pkg-1.2.5-1.18.2-Forge" = _8TsHevlV;
        "pkg-1.2.5-1.19.2-Fabric" = _emP79fkT;
        "pkg-1.2.5-1.19.2-Forge" = _k3V636fc;
        "pkg-1.2.5-1.20.1-Fabric" = _cwEr1CjI;
        "pkg-1.2.5-1.20.1-Forge" = _i5knTNOX;
        "pkg-1.2.5-1.21.1-Neoforge" = _INS2j6Hk;
        "pkg-1.2.5-1.21.1-Fabric" = _SYbMp1Ug;
        "pkg-1.2.5-1.21.1-Forge" = _yv5Pli9H;
        "pkg-1.2.5-1.20.4-Forge" = _ZamqLG39;
        "pkg-1.2.5-1.20.4-Fabric" = _kCS8N6zo;
        "pkg-1.2.7-1.21.3-Neoforge" = _L6JVbSJ7;
        "pkg-1.2.7-1.21.3-Fabric" = _zMaCrqeO;
        "pkg-1.2.7-1.21.3-Forge" = _QS73BxUJ;
        "pkg-1.2.7-1.21.4-Fabric" = _cGB5udSx;
        "pkg-1.2.7-1.21.4-Neoforge" = _bdWAkenU;
        "pkg-1.2.7-1.21.4-Forge" = _aUW4ipSi;
        "pkg-1.3.0-1.21.4-Fabric" = _5YzZYtog;
        "pkg-1.3.0-1.21.4-Neoforge" = _bPHoRv4h;
        "pkg-1.3.0-1.21.4-Forge" = _o9oIqKnv;
        "pkg-1.3.0-1.21.5-Fabric" = _Jji8vS14;
        "pkg-1.3.0-1.21.5-Neoforge" = _xenw3tpu;
        "pkg-1.3.1-1.21.5-Fabric" = _6561qtsx;
        "pkg-1.3.1-1.21.5-Neoforge" = _gwHNfdOn;
        "pkg-1.3.1-1.21.5-Forge" = _v2a13BRE;
        "pkg-1.3.1-1.21.4-Neoforge" = _ghW5emfm;
        "pkg-1.3.1-1.21.4-Forge" = _Y0H7YkCI;
        "pkg-1.3.1-1.21.4-Fabric" = _cgozK7gI;
        "pkg-1.2.6-1.21.1-Neoforge" = _VPnWN36i;
        "pkg-1.2.6-1.21.1-Fabric" = _wQHfjy9C;
        "pkg-1.2.6-1.21.1-Forge" = _WiTklYOR;
        "pkg-1.3.2-1.21.5-Neoforge" = _NEaFhH3W;
        "pkg-1.3.2-1.21.5-Forge" = _rIWloj7s;
        "pkg-1.3.3-1.21.5-Fabric" = _Jjy0dPhh;
        "pkg-1.3.3-1.21.5-Neoforge" = _JWXutdYR;
        "pkg-1.3.3-1.21.5-Forge" = _TwQmhvgv;
        "pkg-1.3.3-1.21.6-Forge" = _EYKIdi0D;
        "pkg-1.3.3-1.21.6-Fabric" = _ClSiY6aQ;
        "pkg-1.3.3-1.21.6-Neoforge" = _rOKTlkqx;
        "pkg-1.3.3-1.21.7-Fabric" = _B5n5xRvx;
        "pkg-1.3.3-1.21.7-Neoforge" = _PJPLrmq9;
        "pkg-1.3.3-1.21.7-Forge" = _WifiwA0F;
        "pkg-1.3.0-1.18.2-Fabric" = _VRG821wH;
        "pkg-1.3.0-1.18.2-Forge" = _wvT4iZMb;
        "pkg-1.3.0-1.19.2-Fabric" = _spnlarju;
        "pkg-1.3.0-1.19.2-Forge" = _biUpXuRd;
        "pkg-1.3.0-1.20.4-Fabric" = _qe2Hxzy3;
        "pkg-1.3.0-1.20.4-Forge" = _YfHtrenv;
        "pkg-1.3.0-1.21.1-Fabric" = _rdQmhk9h;
        "pkg-1.3.0-1.21.1-Forge" = _hFHlJkBk;
        "pkg-1.3.0-1.21.1-Neoforge" = _O8A77fvb;
        "pkg-1.3.2-1.21.4-Neoforge" = _RCR0agUo;
        "pkg-1.3.2-1.21.4-Forge" = _3iL7xWkn;
        "pkg-1.3.2-1.21.4-Fabric" = _xQ2IAnyP;
        "pkg-1.3.4-1.21.7-Fabric" = _spbm5eZf;
        "pkg-1.3.4-1.21.7-Neoforge" = _guEWUzBR;
        "pkg-1.3.4-1.21.7-Forge" = _tI6GLmF3;
        "pkg-1.3.4-1.21.5-Forge" = _s7DF8lN3;
        "pkg-1.3.4-1.21.5-Neoforge" = _JOQnkLEL;
        "pkg-1.3.4-1.21.5-Fabric" = _4Ji71gkZ;
        "pkg-1.3.5-1.21.5-Forge" = _vtXIaI1Q;
        "pkg-1.3.5-1.21.5-Neoforge" = _p1RrlMyO;
        "pkg-1.3.5-1.21.5-Fabric" = _2iSlQFsp;
        "pkg-1.3.1-1.20.4-Fabric" = _MixRoNUB;
        "pkg-1.3.1-1.20.4-Forge" = _RaSMAM6v;
        "pkg-1.3.1-1.18.2-Fabric" = _Ll7vTSVv;
        "pkg-1.3.1-1.18.2-Forge" = _JEkoETO5;
        "pkg-1.3.3-1.21.4-Fabric" = _UDlg4qHT;
        "pkg-1.3.3-1.21.4-Forge" = _BFDcSG6j;
        "pkg-1.3.3-1.21.4-Neoforge" = _8XntAbLM;
        "pkg-1.3.5-1.21.7-Forge" = _sBFzclQI;
        "pkg-1.3.5-1.21.7-Neoforge" = _vHAcKKXY;
        "pkg-1.3.5-1.21.7-Fabric" = _5fkculHk;
        "pkg-1.3.1-1.19.2-Fabric" = _Hu7WdEqE;
        "pkg-1.3.1-1.19.2-Forge" = _YZQOC1l1;
        "pkg-1.3.1-1.21.1-Forge" = _SUjgXUEs;
        "pkg-1.3.1-1.21.1-Fabric" = _lfyOId4O;
        "pkg-1.3.1-1.21.1-Neoforge" = _3qjQ3z7A;
        "pkg-1.3.1-1.20.1-Fabric" = _W3fCZ0RB;
        "pkg-1.3.1-1.20.1-Forge" = _k4CRSebV;
        "pkg-1.3.6-1.21.7-Forge" = _WbBZ1jLY;
        "pkg-1.3.6-1.21.7-Neoforge" = _hRgLasHV;
        "pkg-1.3.6-1.21.7-Fabric" = _4cPTyzaR;
        "pkg-1.3.6-1.21.5-Forge" = _4UarlE1b;
        "pkg-1.3.6-1.21.5-Neoforge" = _yIGGbEcH;
        "pkg-1.3.6-1.21.5-Fabric" = _guwyamyS;
        "pkg-1.3.4-1.21.4-Fabric" = _dgg00Aa5;
        "pkg-1.3.4-1.21.4-Forge" = _7Hk9v44h;
        "pkg-1.3.4-1.21.4-Neoforge" = _mecTziw3;
        "pkg-1.3.2-1.21.1-Fabric" = _Qr8G2To2;
        "pkg-1.3.2-1.21.1-Forge" = _qy6ha3Sl;
        "pkg-1.3.2-1.21.1-Neoforge" = _EBBvk8Ab;
        "pkg-1.3.2-1.18.2-Fabric" = _BRd86ISo;
        "pkg-1.3.2-1.18.2-Forge" = _fgPj79Hi;
        "pkg-1.3.2-1.20.4-Fabric" = _SgIScdQc;
        "pkg-1.3.2-1.20.4-Forge" = _93KXet3c;
        "pkg-1.3.2-1.20.1-Forge" = _nwv5o0Qc;
        "pkg-1.3.2-1.20.1-Fabric" = _29eHAf08;
        "pkg-1.3.2-1.19.2-Fabric" = _ZAEOiMGH;
        "pkg-1.3.2-1.19.2-Forge" = _AyNSBWFN;
        "pkg-1.2.5-1.16.5-Forge" = _DrkxuVVw;
        "pkg-1.3.7-1.21.7-Forge" = _xJiHYeU1;
        "pkg-1.3.7-1.21.7-Neoforge" = _K5r1Nq7O;
        "pkg-1.3.7-1.21.7-Fabric" = _tHIKquJD;
        "pkg-1.3.7-1.21.5-Forge" = _nmSiiBxm;
        "pkg-1.3.7-1.21.5-Neoforge" = _6lBk7ax4;
        "pkg-1.3.7-1.21.5-Fabric" = _qAGOOkjL;
        "pkg-1.3.5-1.21.4-Fabric" = _qjoNHtue;
        "pkg-1.3.5-1.21.4-Forge" = _7yMRiCXG;
        "pkg-1.3.5-1.21.4-Neoforge" = _dLYLXdfF;
        "pkg-1.3.3-1.21.1-Forge" = _e9Q13k5C;
        "pkg-1.3.3-1.21.1-Fabric" = _R6tqJcJR;
        "pkg-1.3.3-1.21.1-Neoforge" = _3SMQhTG7;
        "pkg-1.3.3-1.20.4-Fabric" = _f3dU9QPZ;
        "pkg-1.3.3-1.20.4-Forge" = _1jymdPBL;
        "pkg-1.3.3-1.20.1-Forge" = _JLxNv229;
        "pkg-1.3.3-1.20.1-Fabric" = _ACovo0tC;
        "pkg-1.3.3-1.19.2-Fabric" = _hIu7GW1c;
        "pkg-1.3.3-1.19.2-Forge" = _5x7njiTw;
        "pkg-1.3.3-1.18.2-Fabric" = _BL5hsf4w;
        "pkg-1.3.3-1.18.2-Forge" = _iUziL7bC;
        "pkg-1.2.6-1.16.5-Fabric" = _IwuGVBRe;
        "pkg-1.2.6-1.16.5-Forge" = _dncOGO9I;
        "pkg-1.3.8-1.21.7-Forge" = _DxNnc2tm;
        "pkg-1.3.8-1.21.7-Neoforge" = _S4Wfldwm;
        "pkg-1.3.8-1.21.7-Fabric" = _KvqjGbJD;
        "pkg-1.3.8-1.21.5-Forge" = _vVPocz5w;
        "pkg-1.3.8-1.21.5-Neoforge" = _jRSkV7rX;
        "pkg-1.3.8-1.21.5-Fabric" = _byEiDCcf;
        "pkg-1.3.6-1.21.4-Fabric" = _5t4Uxtuy;
        "pkg-1.3.6-1.21.4-Forge" = _nHttvX7S;
        "pkg-1.3.6-1.21.4-Neoforge" = _WGY1Lwu8;
        "pkg-1.3.4-1.21.1-Forge" = _xc2yJpQz;
        "pkg-1.3.4-1.21.1-Fabric" = _x1Jue57f;
        "pkg-1.3.4-1.21.1-Neoforge" = _eZmtu1d4;
        "pkg-1.3.4-1.20.4-Forge" = _YNN5WqIa;
        "pkg-1.3.4-1.20.4-Fabric" = _c5pH70aa;
        "pkg-1.3.4-1.20.1-Forge" = _MdeI2h1e;
        "pkg-1.3.4-1.20.1-Fabric" = _OzJI6RkM;
        "pkg-1.3.4-1.19.2-Fabric" = _UPEkAOZX;
        "pkg-1.3.4-1.19.2-Forge" = _vnzJZT3U;
        "pkg-1.3.4-1.18.2-Fabric" = _aJr5P06k;
        "pkg-1.3.4-1.18.2-Forge" = _Puu3WLBk;
        "pkg-1.2.7-1.16.5-Forge" = _yJZIx62B;
        "pkg-1.2.7-1.16.5-Fabric" = _jz8Md9kZ;
        "pkg-1.3.9-1.21.7-Forge" = _CEBLDP7x;
        "pkg-1.3.9-1.21.7-Neoforge" = _LplNBixd;
        "pkg-1.3.9-1.21.7-Fabric" = _vlNTTdIo;
        "pkg-1.3.9-1.21.5-Forge" = _Jvx66sDx;
        "pkg-1.3.9-1.21.5-Neoforge" = _gxGw24Lc;
        "pkg-1.3.9-1.21.5-Fabric" = _jSF6DY2R;
        "pkg-1.3.7-1.21.4-Forge" = _J1V3oFg0;
        "pkg-1.3.7-1.21.4-Fabric" = _PWR7FTy2;
        "pkg-1.3.7-1.21.4-Neoforge" = _8aUl7pYW;
        "pkg-1.3.5-1.21.1-Forge" = _ydRLH3k9;
        "pkg-1.3.5-1.21.1-Fabric" = _ZgQtK1Da;
        "pkg-1.3.5-1.21.1-Neoforge" = _8Nc4OS9I;
        "pkg-1.3.5-1.20.4-Forge" = _6HD2s27o;
        "pkg-1.3.5-1.20.4-Fabric" = _nQJ0Uyzg;
        "pkg-1.3.5-1.20.1-Forge" = _FeezCB0S;
        "pkg-1.3.5-1.20.1-Fabric" = _YhTRxYGv;
        "pkg-1.3.5-1.19.2-Fabric" = _U6OvjLgz;
        "pkg-1.3.5-1.19.2-Forge" = _P0z5Wssz;
        "pkg-1.3.5-1.18.2-Fabric" = _MeRyeWsJ;
        "pkg-1.3.5-1.18.2-Forge" = _PMAIXE1T;
        "pkg-1.2.8-1.16.5-Forge" = _H9Dk4vI0;
        "pkg-1.2.8-1.16.5-Fabric" = _qsKOjH0Y;
        "pkg-1.3.9-1.21.9-Fabric" = _7JRAwGur;
        "pkg-1.3.9-1.21.9-Neoforge" = _wUm4Q84r;
        "pkg-1.3.9-1.21.9-Forge" = _pX2SHJ7e;
        "pkg-1.3.10-1.21.9-Forge" = _Qm7dgTo5;
        "pkg-1.3.10-1.21.9-Neoforge" = _64l8Rywm;
        "pkg-1.3.10-1.21.7-Forge" = _7faWnM9F;
        "pkg-1.3.10-1.21.7-Neoforge" = _2uLf50OV;
        "pkg-1.3.10-1.21.7-Fabric" = _93fhabY4;
        "pkg-1.3.10-1.21.5-Forge" = _LFMBedFR;
        "pkg-1.3.10-1.21.5-Neoforge" = _yH8cxKIr;
        "pkg-1.3.10-1.21.5-Fabric" = _7UPDPlJS;
        "pkg-1.3.8-1.21.4-Fabric" = _hXGTeaZL;
        "pkg-1.3.8-1.21.4-Forge" = _sZiRoqFG;
        "pkg-1.3.8-1.21.4-Neoforge" = _GvZwhGiD;
        "pkg-1.3.6-1.21.1-Forge" = _yBkUpWHf;
        "pkg-1.3.6-1.21.1-Neoforge" = _qfyagL7S;
        "pkg-1.3.6-1.21.1-Fabric" = _rvrsePyG;
        "pkg-1.3.6-1.20.4-Forge" = _WjCwZpwF;
        "pkg-1.3.6-1.20.4-Fabric" = _CjZO0iej;
        "pkg-1.3.6-1.20.1-Forge" = _nPSUrT03;
        "pkg-1.3.6-1.20.1-Fabric" = _oKpdMqIM;
        "pkg-1.3.6-1.19.2-Forge" = _CHdHdc2Q;
        "pkg-1.3.6-1.19.2-Fabric" = _H9T0Sl6g;
        "pkg-1.3.6-1.18.2-Forge" = _8Ar0aSn3;
        "pkg-1.3.6-1.18.2-Fabric" = _uOCgKRgZ;
        "pkg-1.2.9-1.16.5-Forge" = _nwLmLeGF;
        "pkg-1.2.9-1.16.5-Fabric" = _6b4B0ec0;
        "pkg-1.3.10-1.21.9-Fabric" = _qMcdi54I;
        "pkg-1.3.11-1.21.10-Fabric" = _7I3Ig0rO;
        "pkg-1.3.11-1.21.10-Neoforge" = _npsNbCqV;
        "pkg-1.3.11-1.21.10-Forge" = _nIgEnreQ;
        "pkg-1.3.12-1.21.10-Fabric" = _VX2t6W3B;
        "pkg-1.3.12-1.21.10-Neoforge" = _Qj9didPU;
        "pkg-1.3.12-1.21.10-Forge" = _K9P02XKj;
        "pkg-1.3.11-1.21.7-Forge" = _U7agmOWg;
        "pkg-1.3.11-1.21.7-Neoforge" = _XpwVemu6;
        "pkg-1.3.11-1.21.7-Fabric" = _YcrnGSNK;
        "pkg-1.3.11-1.21.5-Forge" = _KMxstNEH;
        "pkg-1.3.11-1.21.5-Neoforge" = _U9km1y1A;
        "pkg-1.3.11-1.21.5-Fabric" = _pAWsDmBW;
        "pkg-1.3.9-1.21.4-Forge" = _smS3U5q8;
        "pkg-1.3.9-1.21.4-Neoforge" = _AryC75OC;
        "pkg-1.3.9-1.21.4-Fabric" = _uCWwhPLd;
        "pkg-1.3.7-1.21.1-Forge" = _Yg0YCXLJ;
        "pkg-1.3.7-1.21.1-Neoforge" = _kkS35m9R;
        "pkg-1.3.7-1.21.1-Fabric" = _AtVbaODj;
        "pkg-1.3.7-1.20.4-Forge" = _CNhjNrxo;
        "pkg-1.3.7-1.20.4-Fabric" = _6elgymK5;
        "pkg-1.3.7-1.20.1-Forge" = _L4mOxIPM;
        "pkg-1.3.7-1.20.1-Fabric" = _O4qlB22e;
        "pkg-1.3.7-1.19.2-Forge" = _FS3QQ3wB;
        "pkg-1.3.7-1.19.2-Fabric" = _75SViLte;
        "pkg-1.3.7-1.18.2-Forge" = _R6Tm5utJ;
        "pkg-1.3.7-1.18.2-Fabric" = _I165nzN5;
        "pkg-1.2.10-1.16.5-Forge" = _c2hxPqP5;
        "pkg-1.2.10-1.16.5-Fabric" = _fO3WMe2E;
        "pkg-1.4.0-1.21.10-Fabric" = _vxIYhXhx;
        "pkg-1.4.0-1.21.10-Forge" = _ZuDZ79oN;
        "pkg-1.4.0-1.21.10-Neoforge" = _9YORIwSp;
        "pkg-1.4.0-1.21.8-Fabric" = _QF5LeD3g;
        "pkg-1.4.0-1.21.8-Neoforge" = _1peFTACx;
        "pkg-1.4.0-1.21.8-Forge" = _RNr6BhkT;
        "pkg-1.4.1-1.21.8-Neoforge" = _dJbhsx6s;
        "pkg-1.4.1-1.21.8-Fabric" = _XOgP7E8P;
        "pkg-1.4.1-1.21.8-Forge" = _aVes3ZQK;
        "pkg-1.4.1-1.21.10-Forge" = _mc7KgYBC;
        "pkg-1.4.1-1.21.10-Neoforge" = _GcwNoh3h;
        "pkg-1.4.1-1.21.10-Fabric" = _IhgK5UPu;
        "pkg-1.4.0-1.21.5-Forge" = _hzgqOmh7;
        "pkg-1.4.0-1.21.5-Neoforge" = _LxiYxSyB;
        "pkg-1.4.0-1.21.5-Fabric" = _FWIFJldO;
        "pkg-1.4.0-1.21.4-Forge" = _CgwSjLyB;
        "pkg-1.4.0-1.21.4-Neoforge" = _Q4WkwPbx;
        "pkg-1.4.0-1.21.4-Fabric" = _6YiIf1lQ;
        "pkg-1.4.0-1.21.1-Forge" = _2tB5e9wa;
        "pkg-1.4.0-1.21.1-Neoforge" = _BUydVywT;
        "pkg-1.4.0-1.21.1-Fabric" = _6usTX36d;
        "pkg-1.4.0-1.20.4-Forge" = _HgW8tPCZ;
        "pkg-1.4.0-1.20.4-Fabric" = _RMOPKUpL;
        "pkg-1.4.0-1.20.1-Forge" = _W6vnJ7Tr;
        "pkg-1.4.0-1.20.1-Fabric" = _7H1ouSlB;
        "pkg-1.4.0-1.19.2-Forge" = _60YTYhYO;
        "pkg-1.4.0-1.19.2-Fabric" = _jcJ4YRm8;
        "pkg-1.4.0-1.18.2-Forge" = _cAq3EhJe;
        "pkg-1.4.0-1.18.2-Fabric" = _Pay82Wfb;
        "pkg-1.4.1-1.21.11-Fabric" = _1moz1wg4;
        "pkg-1.4.1-1.21.11-Neoforge" = _LZyU6N36;
        "pkg-1.4.1-1.21.11-Forge" = _LtBVcncI;
        "pkg-1.5.0-26.1-snapshot-9-Fabric" = _vv7M6shY;
        "pkg-1.5.0-1.21.8-Fabric" = _KTbevdSX;
        "pkg-1.5.0-1.21.8-Neoforge" = _74jFjX0j;
        "pkg-1.5.0-1.21.8-Forge" = _jAaape5M;
        "pkg-1.5.0-1.21.10-Fabric" = _Bit1YwnO;
        "pkg-1.5.0-1.21.10-Neoforge" = _PzEsYiZG;
        "pkg-1.5.0-1.21.10-Forge" = _so7timS8;
        "pkg-1.5.0-1.21.11-Fabric" = _6hMJfmwE;
        "pkg-1.5.0-1.21.11-Neoforge" = _kVRcnWNx;
        "pkg-1.5.0-1.21.11-Forge" = _ANt5iOa2;
        "pkg-1.5.0-1.21.5-Forge" = _3JgMbR40;
        "pkg-1.5.0-1.21.5-Neoforge" = _y14RnITn;
        "pkg-1.5.0-1.21.5-Fabric" = _iwD4FjzB;
        "pkg-1.5.0-1.21.4-Forge" = _E8MMhMu3;
        "pkg-1.5.0-1.21.4-Neoforge" = _YDvzBGMG;
        "pkg-1.5.0-1.21.4-Fabric" = _ybvvFtgp;
        "pkg-1.5.0-1.21.1-Forge" = _KYlWFpxR;
        "pkg-1.5.0-1.21.1-Neoforge" = _ESEO0a1b;
        "pkg-1.5.0-1.21.1-Fabric" = _bCIbHeyj;
        "pkg-1.5.0-1.20.4-Forge" = _vtf9CYiI;
        "pkg-1.5.0-1.20.4-Fabric" = _zItRw56t;
        "pkg-1.5.0-1.20.1-Fabric" = _sSbexxbQ;
        "pkg-1.5.0-1.20.1-Forge" = _Gc9tq73h;
        "pkg-1.5.0-1.19.2-Forge" = _JikOMO4n;
        "pkg-1.5.0-1.19.2-Fabric" = _t5LS660Q;
        "pkg-1.5.0-1.18.2-Forge" = _ibqORT2q;
        "pkg-1.5.0-1.18.2-Fabric" = _9FWd5BpA;
        "pkg-1.2.11-1.16.5-Forge" = _JwuOodpe;
        "pkg-1.2.11-1.16.5-Fabric" = _tBcPoR6k;
        "pkg-1.5.0-26.1-Fabric" = _QJkdWskl;
        "pkg-1.5.0-26.1-Forge" = _TtEMpt9L;
        "pkg-1.5.0-26.1-Neoforge" = _EyvSj8qe;
        "pkg-1.5.1-26.1.2-Neoforge" = _drJljNFC;
