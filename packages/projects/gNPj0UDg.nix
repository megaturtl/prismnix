...
let
    versions = (let
        ...
        _CW1msNgI = {
            "id" = "CW1msNgI";
            "file" = "sitanywhere-3.0.0.zip";
            "hash" = "sha512-T4gDpRAlqDiQGlEKnoOHHLUVQHmw4EFDLrD+rw0regpYKZ7c4VR0uInMlz/bJi+q0zLn6HVy6PJwnmNXf8Bi0g==";
        };
        _pPdax0F7 = {
            "id" = "pPdax0F7";
            "file" = "sit-anywhere!-3.0.0.jar";
            "hash" = "sha512-w1Mc4xxxyVsxa/9zSQLL4AxYQfFgQGjGCnNhvNoIoqUyLm51v0buryrocBE1VYMm9H/2FkxBFtYL9exk6owBZg==";
        };
        _QpFd9LGx = {
            "id" = "QpFd9LGx";
            "file" = "sit-anywhere!-3.1.0.zip";
            "hash" = "sha512-S0RCuDQ56hqvBg4uX83wAMjNImtRNb53bmLKpe/3B0EE3/TdwI0DW3pYICnIVpab9oj0A3gxzYcz/iZS1OWc3A==";
        };
        _4yjZB5K0 = {
            "id" = "4yjZB5K0";
            "file" = "sit-anywhere!-3.1.0.jar";
            "hash" = "sha512-FB1yejovkcgJbmdLGtLK5bY3KsgTCwQpBBOHpzssXGYB0DkZMhldteFxdmz2oypo0P4uoFH5bBFX53H4IXuqAA==";
        };
    in {
        "6WJ5IudO" = _6WJ5IudO;
        "UdzXoQOP" = _UdzXoQOP;
        ...
        "QpFd9LGx" = _QpFd9LGx;
        "4yjZB5K0" = _4yjZB5K0;
        "datapack-1.19.4" = _QpFd9LGx;
        "datapack-1.20" = _QpFd9LGx;
        "datapack-1.20.1" = _QpFd9LGx;
        "datapack-1.20.2" = _QpFd9LGx;
        "datapack-1.20.3" = _QpFd9LGx;
        "datapack-1.20.4" = _QpFd9LGx;
        "datapack-1.20.5" = _QpFd9LGx;
        "datapack-1.20.6" = _QpFd9LGx;
        "datapack-1.21" = _QpFd9LGx;
        "datapack-1.21.1" = _QpFd9LGx;
        "datapack-1.21.2" = _QpFd9LGx;
        "datapack-1.21.3" = _QpFd9LGx;
        "datapack-1.21.4" = _QpFd9LGx;
        "datapack-25w08a" = _30l4MiG7;
        "datapack-1.21.5" = _QpFd9LGx;
        "datapack-1.21.6" = _QpFd9LGx;
        "datapack-1.21.7" = _QpFd9LGx;
        "datapack-1.21.8" = _QpFd9LGx;
        "datapack-25w31a" = _2374rTQC;
        "datapack-25w32a" = _2374rTQC;
        "datapack-25w35a" = _3EjJ0zBQ;
        "datapack-1.21.9" = _QpFd9LGx;
        "datapack-1.21.10" = _QpFd9LGx;
        "datapack-1.21.11" = _QpFd9LGx;
        "datapack-26.1" = _QpFd9LGx;
        "datapack-26.1.1" = _QpFd9LGx;
        "datapack-26.1.2" = _QpFd9LGx;
        "datapack-26.2" = _QpFd9LGx;
        "datapack-26.3-snapshot-1" = _zL7j6wJO;
        "datapack-26.3-snapshot-2" = _zL7j6wJO;
        "datapack-26.3-snapshot-3" = _zL7j6wJO;
        "datapack-26.3-snapshot-4" = _zL7j6wJO;
        "datapack-26.3-snapshot-5" = _zL7j6wJO;
        "datapack-26.3-snapshot-6" = _zL7j6wJO;
        "datapack-26.3-snapshot-7" = _zL7j6wJO;
        "datapack-26.3-snapshot-9" = _CW1msNgI;
        "datapack-26.3-snapshot-10" = _QpFd9LGx;
        "fabric-1.19.4" = _4yjZB5K0;
        "fabric-1.20" = _4yjZB5K0;
        "fabric-1.20.1" = _4yjZB5K0;
        "fabric-1.20.2" = _4yjZB5K0;
        "fabric-1.20.3" = _4yjZB5K0;
        "fabric-1.20.4" = _4yjZB5K0;
        "fabric-1.20.5" = _4yjZB5K0;
        "fabric-1.20.6" = _4yjZB5K0;
        "fabric-1.21" = _4yjZB5K0;
        "fabric-1.21.1" = _4yjZB5K0;
        "fabric-1.21.2" = _4yjZB5K0;
        "fabric-1.21.3" = _4yjZB5K0;
        "fabric-1.21.4" = _4yjZB5K0;
        "fabric-25w08a" = _cK5DJvd8;
        "fabric-1.21.5" = _4yjZB5K0;
        "fabric-1.21.6" = _4yjZB5K0;
        "fabric-1.21.7" = _4yjZB5K0;
        "fabric-1.21.8" = _4yjZB5K0;
        "fabric-25w31a" = _kjgStF2l;
        "fabric-25w32a" = _kjgStF2l;
        "fabric-25w35a" = _oxBTUowG;
        "fabric-1.21.9" = _4yjZB5K0;
        "fabric-1.21.10" = _4yjZB5K0;
        "fabric-1.21.11" = _4yjZB5K0;
        "fabric-26.1" = _4yjZB5K0;
        "fabric-26.1.1" = _4yjZB5K0;
        "fabric-26.1.2" = _4yjZB5K0;
        "fabric-26.2" = _4yjZB5K0;
        "fabric-26.3-snapshot-1" = _keYknJ3X;
        "fabric-26.3-snapshot-2" = _keYknJ3X;
        "fabric-26.3-snapshot-3" = _keYknJ3X;
        "fabric-26.3-snapshot-4" = _keYknJ3X;
        "fabric-26.3-snapshot-5" = _keYknJ3X;
        "fabric-26.3-snapshot-6" = _keYknJ3X;
        "fabric-26.3-snapshot-7" = _keYknJ3X;
        "fabric-26.3-snapshot-9" = _pPdax0F7;
        "fabric-26.3-snapshot-10" = _4yjZB5K0;
        "forge-1.19.4" = _4yjZB5K0;
        "forge-1.20" = _4yjZB5K0;
        "forge-1.20.1" = _4yjZB5K0;
        "forge-1.20.2" = _4yjZB5K0;
        "forge-1.20.3" = _4yjZB5K0;
        "forge-1.20.4" = _4yjZB5K0;
        "forge-1.20.5" = _4yjZB5K0;
        "forge-1.20.6" = _4yjZB5K0;
        "forge-1.21" = _4yjZB5K0;
        "forge-1.21.1" = _4yjZB5K0;
        "forge-1.21.2" = _4yjZB5K0;
        "forge-1.21.3" = _4yjZB5K0;
        "forge-1.21.4" = _4yjZB5K0;
        "forge-25w08a" = _cK5DJvd8;
        "forge-1.21.5" = _4yjZB5K0;
        "forge-1.21.6" = _4yjZB5K0;
        "forge-1.21.7" = _4yjZB5K0;
        "forge-1.21.8" = _4yjZB5K0;
        "forge-25w31a" = _kjgStF2l;
        "forge-25w32a" = _kjgStF2l;
        "forge-25w35a" = _oxBTUowG;
        "forge-1.21.9" = _4yjZB5K0;
        "forge-1.21.10" = _4yjZB5K0;
        "forge-1.21.11" = _4yjZB5K0;
        "forge-26.1" = _4yjZB5K0;
        "forge-26.1.1" = _4yjZB5K0;
        "forge-26.1.2" = _4yjZB5K0;
        "forge-26.2" = _4yjZB5K0;
        "forge-26.3-snapshot-1" = _keYknJ3X;
        "forge-26.3-snapshot-2" = _keYknJ3X;
        "forge-26.3-snapshot-3" = _keYknJ3X;
        "forge-26.3-snapshot-4" = _keYknJ3X;
        "forge-26.3-snapshot-5" = _keYknJ3X;
        "forge-26.3-snapshot-6" = _keYknJ3X;
        "forge-26.3-snapshot-7" = _keYknJ3X;
        "forge-26.3-snapshot-9" = _pPdax0F7;
        "forge-26.3-snapshot-10" = _4yjZB5K0;
        "neoforge-1.19.4" = _4yjZB5K0;
        "neoforge-1.20" = _4yjZB5K0;
        "neoforge-1.20.1" = _4yjZB5K0;
        "neoforge-1.20.2" = _4yjZB5K0;
        "neoforge-1.20.3" = _4yjZB5K0;
        "neoforge-1.20.4" = _4yjZB5K0;
        "neoforge-1.20.5" = _4yjZB5K0;
        "neoforge-1.20.6" = _4yjZB5K0;
        "neoforge-1.21" = _4yjZB5K0;
        "neoforge-1.21.1" = _4yjZB5K0;
        "neoforge-1.21.2" = _4yjZB5K0;
        "neoforge-1.21.3" = _4yjZB5K0;
        "neoforge-1.21.4" = _4yjZB5K0;
        "neoforge-25w08a" = _cK5DJvd8;
        "neoforge-1.21.5" = _4yjZB5K0;
        "neoforge-1.21.6" = _4yjZB5K0;
        "neoforge-1.21.7" = _4yjZB5K0;
        "neoforge-1.21.8" = _4yjZB5K0;
        "neoforge-25w31a" = _kjgStF2l;
        "neoforge-25w32a" = _kjgStF2l;
        "neoforge-25w35a" = _oxBTUowG;
        "neoforge-1.21.9" = _4yjZB5K0;
        "neoforge-1.21.10" = _4yjZB5K0;
        "neoforge-1.21.11" = _4yjZB5K0;
        "neoforge-26.1" = _4yjZB5K0;
        "neoforge-26.1.1" = _4yjZB5K0;
        "neoforge-26.1.2" = _4yjZB5K0;
        "neoforge-26.2" = _4yjZB5K0;
        "neoforge-26.3-snapshot-1" = _keYknJ3X;
        "neoforge-26.3-snapshot-2" = _keYknJ3X;
        "neoforge-26.3-snapshot-3" = _keYknJ3X;
        "neoforge-26.3-snapshot-4" = _keYknJ3X;
        "neoforge-26.3-snapshot-5" = _keYknJ3X;
        "neoforge-26.3-snapshot-6" = _keYknJ3X;
        "neoforge-26.3-snapshot-7" = _keYknJ3X;
        "neoforge-26.3-snapshot-9" = _pPdax0F7;
        "neoforge-26.3-snapshot-10" = _4yjZB5K0;
        "quilt-1.19.4" = _4yjZB5K0;
        "quilt-1.20" = _4yjZB5K0;
        "quilt-1.20.1" = _4yjZB5K0;
        "quilt-1.20.2" = _4yjZB5K0;
        "quilt-1.20.3" = _4yjZB5K0;
        "quilt-1.20.4" = _4yjZB5K0;
        "quilt-1.20.5" = _4yjZB5K0;
        "quilt-1.20.6" = _4yjZB5K0;
        "quilt-1.21" = _4yjZB5K0;
        "quilt-1.21.1" = _4yjZB5K0;
        "quilt-1.21.2" = _4yjZB5K0;
        "quilt-1.21.3" = _4yjZB5K0;
        "quilt-1.21.4" = _4yjZB5K0;
        "quilt-25w08a" = _cK5DJvd8;
        "quilt-1.21.5" = _4yjZB5K0;
        "quilt-1.21.6" = _4yjZB5K0;
        "quilt-1.21.7" = _4yjZB5K0;
        "quilt-1.21.8" = _4yjZB5K0;
        "quilt-25w31a" = _kjgStF2l;
        "quilt-25w32a" = _kjgStF2l;
        "quilt-25w35a" = _oxBTUowG;
        "quilt-1.21.9" = _4yjZB5K0;
        "quilt-1.21.10" = _4yjZB5K0;
        "quilt-1.21.11" = _4yjZB5K0;
        "quilt-26.1" = _4yjZB5K0;
        "quilt-26.1.1" = _4yjZB5K0;
        "quilt-26.1.2" = _4yjZB5K0;
        "quilt-26.2" = _4yjZB5K0;
        "quilt-26.3-snapshot-1" = _keYknJ3X;
        "quilt-26.3-snapshot-2" = _keYknJ3X;
        "quilt-26.3-snapshot-3" = _keYknJ3X;
        "quilt-26.3-snapshot-4" = _keYknJ3X;
        "quilt-26.3-snapshot-5" = _keYknJ3X;
        "quilt-26.3-snapshot-6" = _keYknJ3X;
        "quilt-26.3-snapshot-7" = _keYknJ3X;
        "quilt-26.3-snapshot-9" = _pPdax0F7;
        "quilt-26.3-snapshot-10" = _4yjZB5K0;
        "pkg-1.0.0" = _6WJ5IudO;
        "pkg-1.0.1" = _UdzXoQOP;
        "pkg-1.1.0" = _1nuLyzGb;
        "pkg-1.1.1" = _Apa2Scyy;
        ...
        "pkg-2.0.0" = _cK5DJvd8;
        "pkg-2.1.0" = _OFr6neK3;
        "pkg-2.1.0+mod" = _bQtghYRb;
        "pkg-2.1.1" = _lVkijuAW;
        "pkg-2.1.1+mod" = _KOGfoM8P;
        "pkg-2.2.0" = _L3xhtUq8;
        "pkg-2.2.0+mod" = _d1LkloW7;
        "pkg-2.2.1" = _5sHbBwuK;
        "pkg-2.2.1+mod" = _IScL6JTd;
        "pkg-2.3.0-1.20.x" = _c04WgO6Z;
        "pkg-2.3.0-1.20.x+mod" = _2jAoPxpL;
        "pkg-2.3.0-1.21.x" = _BrHelHBx;
        "pkg-2.3.0-1.21.x+mod" = _4B0mHKIT;
        "pkg-2.3.1-1.20.x" = _znPEFbYn;
        "pkg-2.3.1-1.20.x+mod" = _wFmi5xMs;
        "pkg-2.3.1-1.21.x" = _5unEra6K;
        "pkg-2.3.1-1.21.x+mod" = _YfYt6MBi;
        "pkg-v2.3.1b-1.21.x+mod" = _8onSw1dL;
        "pkg-2.3.2-1.21.x" = _2374rTQC;
        "pkg-2.3.2-1.21.x+mod" = _kjgStF2l;
        "pkg-2.3.3" = _3EjJ0zBQ;
        "pkg-2.3.3+mod" = _oxBTUowG;
        "pkg-2.3.4" = _1GNM4wik;
        "pkg-2.3.4+mod" = _IzxDgWFY;
        "pkg-2.3.5" = _zL7j6wJO;
        "pkg-2.3.5+mod" = _keYknJ3X;
        "pkg-3.0.0" = _pPdax0F7;
        "pkg-3.1.0" = _4yjZB5K0;
        "default" = _4yjZB5K0;
    });
