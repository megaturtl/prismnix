...
let
    ...
    in {
        ...
        "pkg-fabric-1.19.2-1.0.2" = _ilZ1Gyt5;
        "pkg-fabric-1.19.2-1.0.3" = _ljZO4mJm;
        "pkg-fabric-1.19.3-1.0.3" = _FeoZscEV;
        "pkg-fabric-1.19.4-1.0.3" = _mk50VjEL;
        "pkg-fabric-1.20-1.0.3" = _6i6HNoT3;
        "pkg-fabric-1.20.1-1.0.3" = _2jPnBjYc;
        "pkg-fabric-1.20.2-1.0.3" = _OBliqbUm;
        "pkg-fabric-1.19.2-1.0.4" = _1OOyh31D;
        "pkg-fabric-1.19.4-1.0.4" = _QsSlzEQf;
        "pkg-fabric-1.20.1-1.0.4" = _RowtQNrx;
        "pkg-fabric-1.20.2-1.0.4" = _zFoKZurg;
        "pkg-fabric-1.19.2-1.0.5" = _55L90w2d;
        "pkg-fabric-1.19.4-1.0.5" = _7MYzKYs4;
        "pkg-fabric-1.20.1-1.0.5" = _v4X0aHw0;
        "pkg-fabric-1.20.2-1.0.5" = _kCOps8sU;
        "pkg-fabric-1.20.3-1.0.5" = _8UzlNkp5;
        "pkg-fabric-1.20.4-1.0.5" = _P2KEEmcw;
        "pkg-fabric-1.19.2-1.0.6" = _JU8Kmubk;
        "pkg-fabric-1.19.4-1.0.6" = _3amUmqf8;
        "pkg-fabric-1.20.1-1.0.6" = _LX0uNyw4;
        "pkg-fabric-1.20.2-1.0.6" = _7QS7AzHY;
        "pkg-fabric-1.20.4-1.0.6" = _i7ZfTsAF;
        "pkg-fabric-1.20.5-1.0.6" = _I7QfiiJx;
        "pkg-fabric-1.20.6-1.0.6" = _VoqoSFjv;
        "pkg-fabric-1.21-1.0.7" = _KoOapeKw;
        "pkg-fabric-1.21.1-1.0.7" = _fauY9zOQ;
        "pkg-fabric-1.21.1-1.0.8" = _4m0Fd6Fa;
        "pkg-fabric-1.21.2-1.0.8" = _k9QLnWhe;
        "pkg-fabric-1.21.3-1.0.8" = _5MeVBOF8;
        "pkg-fabric-1.21.4-1.0.8" = _MCSYkp3r;
        "pkg-fabric-1.21.5-1.0.8" = _FjQl1BYe;
        "pkg-fabric-1.21.6-1.0.8" = _aSXk30aF;
        "pkg-fabric-1.21.7-1.0.8" = _prgeBDfn;
        "pkg-fabric-1.21.8-1.0.8" = _M9BfeJDT;
        "pkg-fabric-1.21.9-1.0.8" = _PhtN4k6P;
        "pkg-fabric-1.21.10-1.0.8" = _kONRqDyw;
        "pkg-fabric-1.21.11-1.0.8" = _9PqoA83N;
        "pkg-fabric-1.0.8+26.1" = _VfJL4MK4;
