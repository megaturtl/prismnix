...
let
    versions = (let
        ...
        _xeJyIdi2 = {
            ...
            "hash" = "sha512-rEOYNL4gfhdyTzckQ3tFoLguK6HiBCdpkEgkb6uFDANNKaDFXn5qOSqIoqZPx/5dYevDZzApTe4iRgTWmlG6pw==";
        };
    in {
        "Jkqs8PzZ" = _Jkqs8PzZ;
        "EhScQtTv" = _EhScQtTv;
        ...
        "xgGlY82O" = _xgGlY82O;
        "xeJyIdi2" = _xeJyIdi2;
        "minecraft-1.20" = _xeJyIdi2;
        "minecraft-1.20.1" = _xeJyIdi2;
        "minecraft-1.20.2" = _xeJyIdi2;
        "minecraft-1.20.3" = _xeJyIdi2;
        "minecraft-1.20.4" = _xeJyIdi2;
        "minecraft-1.20.5" = _xeJyIdi2;
        "minecraft-1.20.6" = _xeJyIdi2;
        "minecraft-1.21" = _xeJyIdi2;
        "minecraft-1.21.1" = _xeJyIdi2;
        "minecraft-1.21.2" = _xeJyIdi2;
        "minecraft-1.21.4" = _xeJyIdi2;
        "minecraft-1.21.5" = _xeJyIdi2;
        "minecraft-1.21.3" = _xeJyIdi2;
        "minecraft-1.21.6" = _xeJyIdi2;
        "minecraft-1.21.7" = _xeJyIdi2;
        "minecraft-1.21.8" = _xeJyIdi2;
        "minecraft-1.21.9" = _xeJyIdi2;
        "minecraft-1.21.10" = _xeJyIdi2;
        "minecraft-1.21.11" = _xeJyIdi2;
        "minecraft-26.1" = _xeJyIdi2;
        "minecraft-26.1.1" = _xeJyIdi2;
        "minecraft-26.1.2" = _xeJyIdi2;
        "minecraft-26.2" = _xeJyIdi2;
        "minecraft-26.3" = _xeJyIdi2;
        "pkg-1.1" = _Jkqs8PzZ;
        "pkg-1.2" = _EhScQtTv;
        "pkg-1.3" = _m6WpQUaV;
        "pkg-1.4" = _t3nsZLUF;
