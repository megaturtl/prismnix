...
let
    ...
    in {
        ...
        "pkg-9.0.8" = _4MkxQteb;
        "pkg-9.0.9" = _9kJblF2V;
        "pkg-9.30.0" = _GcAIYp4g;
        "pkg-9.0.10" = _IG7kgtJH;
        "pkg-7.1.5" = _aVzW3Afg;
        "pkg-8.1.4" = _yTtY9wjE;
        "pkg-8.2.3" = _DTRhf6P8;
        "pkg-21.0.0" = _LdQKgQqO;
        "pkg-21.0.1" = _kuzkD1Dr;
        "pkg-21.0.2" = _tWePKjVG;
        "pkg-21.0.3" = _m70EkRqY;
        "pkg-21.0.4" = _1485z59I;
        "pkg-21.0.5" = _CtncSDC8;
        "pkg-21.0.6" = _zvfv1sJF;
        "pkg-21.0.7" = _iz7PX1xX;
        "pkg-21.0.8" = _X0EFJ5IG;
        "pkg-21.0.9" = _B4QtCd3h;
        "pkg-21.0.10" = _NSS8HlzK;
        "pkg-21.0.11" = _M1o6hR2m;
        "pkg-21.8.0" = _IwuxOwOJ;
        "pkg-21.8.1" = _TB8I1Vg6;
        "pkg-26.0.1" = _s8imfq7k;
        "pkg-21.8.2" = _E59DXXIe;
        "pkg-26.100.0" = _Nb5UPZ3f;
        "pkg-21.8.3" = _JuLJhAqM;
        "pkg-21.8.4" = _3f7bpuen;
        "pkg-26.100.1" = _Xb9gbGe1;
        "pkg-26.300.0" = _nAtMUV7Z;
        "pkg-21.8.5" = _Wll5BcXA;
        "pkg-26.100.2" = _7xGlpaum;
        "pkg-26.200.0" = _w7aIhiUZ;
