...
let
    ...
    in {
        ...
        "pkg-1.14" = _vwzzFWMg;
        "pkg-1.16" = _24moARIk;
        "pkg-1.16.2" = _XQJKRRGm;
        "pkg-1.17" = _KGxlxXZX;
        "pkg-1.18" = _4toIJlc9;
        "pkg-1.19" = _3TkQKotb;
        "pkg-1.19.3" = _hCxB55Ur;
        "pkg-1.20" = _X6jMrvZf;
        "pkg-1.19.4" = _anxvoSWH;
        "pkg-1.20-2" = _TNL5DVqm;
        "pkg-1.20-3" = _6B9z7vRF;
        "pkg-1.20.2" = _zlb6xSOl;
        "pkg-1.20.3" = _maauAKDy;
        "pkg-1.20.5" = _jEXMFo0c;
        "pkg-1.21" = _Cpqe5zZ3;
        "pkg-1.21-1" = _VGP5SSmY;
        "pkg-1.21-2" = _yVPiBVoR;
        "pkg-1.21.2" = _Fp0N3xuz;
        "pkg-1.21.4" = _OlEIDoIZ;
        "pkg-1.21.5" = _t5DlLL7v;
        "pkg-1.21.6" = _OPOoiui4;
        "pkg-1.21.7" = _TfAK0vjp;
        "pkg-1.21.9" = _sAMys3VN;
        "pkg-1.21.9-2" = _FAR10JlW;
        "pkg-1.21.11" = _dGInTCIX;
        "pkg-26.1" = _U6nFp5Sa;
