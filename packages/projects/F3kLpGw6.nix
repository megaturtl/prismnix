...
let
    ...
    in {
        ...
        "pkg-1.9.6.8" = _2OBy6SWk;
        "pkg-1.10.2" = _GqBS3CgY;
        "pkg-1.10.1" = _QmuFjlpe;
        "pkg-1.10.0" = _drrkGogA;
        "pkg-1.9.6.7" = _7BvEkjTa;
        "pkg-1.9.6.6" = _oCkEef2U;
        "pkg-1.9.6.5" = _EEX1HHB8;
        "pkg-1.9.6.4" = _Vegi0JQk;
        "pkg-1.9.7" = _7yTmKUMd;
        "pkg-1.9.6.3" = _QtnkwGLm;
        "pkg-1.9.6.2" = _ozMHuoEB;
        "pkg-1.9.6.1" = _jUvC1Kh8;
        "pkg-1.9.6" = _iinUnCin;
        "pkg-1.9.5" = _V8TcN6Rq;
        "pkg-1.9.4" = _xjfThyNA;
        "pkg-1.9.3" = _7N1bDvL5;
        "pkg-1.9.2" = _XrNGtFXL;
        "pkg-1.8.27" = _si67d5RR;
        "pkg-1.9.1" = _jPiV4mx3;
        "pkg-1.9" = _yXauS8gm;
        "pkg-1.8.26" = _xl79TCPX;
        "pkg-1.8.25" = _BqnJLylH;
        "pkg-1.8.24" = _nykxopNU;
        "pkg-1.8.23" = _j2S7wySz;
        "pkg-1.8.22" = _O0q2vVwr;
        "pkg-1.8.21" = _pzmBR2lS;
        "pkg-1.8.20" = _OjfipT67;
        "pkg-1.8.19" = _UbpUJnkH;
        "pkg-1.8.18" = _JZJisAk9;
        "pkg-1.8.17" = _TYZeP61i;
        "pkg-1.8.16" = _CE1WbhGY;
        "pkg-1.8.15" = _ypgpd3Bb;
        "pkg-1.8.14" = _MXsA5HuS;
        "pkg-1.8.13" = _ELiQFMCp;
        "pkg-1.8.12" = _MTvRosF1;
        "pkg-1.8.11" = _7DABCr0n;
        "pkg-1.8.10" = _uo1Ve2Le;
        "pkg-1.8.9" = _trKCyhAv;
        "pkg-1.8.8" = _n0Az3dL6;
        "pkg-1.8.7" = _wylXYzSG;
        "pkg-1.8.6" = _ilzm7J33;
        ...
        "pkg-1.8.1" = _TvZGSziq;
        "pkg-1.8" = _gu5Ss3PP;
        "pkg-1.10.3" = _uRUh1TQa;
        "pkg-1.10.4" = _b3fZxwQW;
        "pkg-1.10.5" = _W6dNi4FJ;
        "pkg-1.10.6" = _D4faeUBW;
        "pkg-1.10.6.1" = _aMoLU8PH;
        "pkg-1.9.6.10" = _zcmC2R6i;
        "pkg-1.10.7" = _LJOMXgP3;
        "pkg-1.9.6.11" = _SKAxvRgY;
        "pkg-1.10.7.1" = _zvjLucZU;
        "pkg-1.10.7.2" = _85qfaxhD;
        "pkg-1.10.7.3" = _jyQTQpje;
        "pkg-1.10.7.4" = _Zg5lSvyM;
        "pkg-1.10.7.5" = _iPO1zRlr;
        "pkg-1.4.2" = _GkW7VXzd;
        "pkg-1.4.2.1" = _QYsvMHjX;
        "pkg-1.10.7.6" = _LF8J5EFV;
        "pkg-1.10.8" = _xD4Bs4U4;
        "pkg-1.10.8.1" = _YP8Za3UB;
        "pkg-1.10.8.2" = _s6dUWNrf;
        "pkg-1.10.8.3" = _PYR6FqC4;
        "pkg-1.10.8.4" = _7oB7Nwau;
        "pkg-1.10.8.4.1" = _rsT9Nl0T;
        "pkg-1.10.8.4.2" = _MYgfnOry;
        "pkg-1.4.3.2" = _OIxWFruT;
        "pkg-1.10.9" = _vdQODXN6;
