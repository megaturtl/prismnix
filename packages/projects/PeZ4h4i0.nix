...
let
    ...
    in {
        ...
        "pkg-1.1.3" = _5554gKuw;
        "pkg-1.1.4" = _GZJoGVQT;
        "pkg-1.1.5-1.20.1" = _GGLxh2Qz;
        "pkg-1.2.0-1.20.1" = _rta4ltzQ;
        "pkg-1.2.1-1.20.1" = _28u2Qtle;
        "pkg-2.0.0-1.21.1" = _D8c0dnZO;
        "pkg-2.0.1-1.21.1" = _fzd5o7ET;
        "pkg-1.2.2-1.20.1" = _xYZBNpaR;
        "pkg-1.2.3-1.20.1" = _dnENA81e;
        "pkg-2.0.2-1.21.1" = _iGhW3B3g;
        "pkg-2.1.0-1.21.1" = _8nj4D4hc;
        "pkg-2.1.1-1.21.1" = _sV9ImcI8;
        "pkg-2.2.0-1.21.1" = _DaJXiCzZ;
        "pkg-2.2.1-1.21.1" = _OTI03WXn;
        "pkg-1.3.0-1.20.1" = _vTPwczmD;
        "pkg-1.3.1-1.20.1" = _nbdIVCYq;
        "pkg-2.3.0-1.21.1" = _jMEgzOgF;
        "pkg-2.3.1-1.21.1" = _EG2yAard;
        "pkg-2.4.0-1.21.1" = _8R5z8NFG;
        "pkg-1.3.2-1.20.1" = _c2o7JZhK;
        "pkg-1.3.3-1.20.1" = _mG5XK2aU;
        "pkg-2.4.1-1.21.1" = _QGtcfzmE;
        "pkg-2.4.2-1.21.1" = _OjlWEsDc;
        "pkg-2.4.3-1.21.1" = _m2j7AbXt;
        "pkg-2.4.4-1.21.1" = _kG0o7nub;
        "pkg-2.4.5-1.21.1" = _5ZgEsS9w;
        "pkg-2.4.6-1.21.1" = _Qt8v2oY6;
        "pkg-2.4.7-1.21.1" = _YI17Jfyr;
        "pkg-1.3.4-1.20.1" = _bMGESp5P;
        "pkg-2.4.8-1.21.1" = _sDf9NXdF;
        "pkg-2.4.9-1.21.1" = _GKq9CELz;
        "pkg-2.4.10-1.21.1" = _Ia6eKJML;
        "pkg-2.4.11-1.21.1" = _GUJ9fkNj;
        "pkg-1.3.5-1.20.1" = _EPqSHNn9;
        "pkg-2.5.0+1.21.1-fabric" = _qwiTqKaj;
        "pkg-2.5.0+1.21.1-neoforge" = _LpGoqEQh;
        "pkg-2.5.1+1.21.1-neoforge" = _MjHBkpG2;
        "pkg-2.5.1+1.21.1-fabric" = _nGaYPfXy;
        "pkg-2.5.2+1.21.1-neoforge" = _Sy0jiJFn;
        "pkg-2.5.2+1.21.1-fabric" = _53Ffyieo;
        "pkg-2.5.3+1.21.1-neoforge" = _C1DG4kZ0;
        "pkg-2.5.3+1.21.1-fabric" = _qO8bDTof;
        "pkg-1.3.6-1.20.1" = _Av1joJWQ;
        "pkg-2.5.4+1.21.1-fabric" = _aNaGreZH;
        "pkg-2.5.4+1.21.1-neoforge" = _BlNBW6VH;
        "pkg-2.6.0+1.21.1-fabric" = _ctqzv63i;
        "pkg-2.6.0+1.21.1-neoforge" = _Pr1bmmFy;
        "pkg-2.6.1+1.21.1-neoforge" = _WIqKwm8m;
        "pkg-2.6.1+1.21.1-fabric" = _2PmI1pTV;
        "pkg-2.6.2+1.21.1-fabric" = _kJgoIleS;
        "pkg-2.6.2+1.21.1-neoforge" = _r9eTqXcH;
        "pkg-2.6.3+1.21.1-neoforge" = _OfMHNZOI;
        "pkg-2.6.3+1.21.1-fabric" = _Cwxig52q;
        "pkg-2.6.4+1.21.1-neoforge" = _zMUATDUn;
        "pkg-2.6.4+1.21.1-fabric" = _lVcvbeQ8;
        "pkg-2.6.5+1.21.1-fabric" = _y6ewaagR;
        "pkg-2.6.5+1.21.1-neoforge" = _5DKxEteW;
        "pkg-2.6.6+1.21.1-neoforge" = _Buoluy5S;
        "pkg-2.6.6+1.21.1-fabric" = _6VFmMPko;
        "pkg-2.6.7+1.21.1-fabric" = _QaV86HqH;
        "pkg-2.6.7+1.21.1-neoforge" = _I33wTDbt;
        "pkg-1.3.7-1.20.1" = _PXKL6Des;
        "pkg-3.0.0+1.21.1-fabric" = _4VxWAMWz;
