...
let
    ...
    in {
        ...
        "GKeQIVCm" = _GKeQIVCm;
        "4tIeCPBp" = _4tIeCPBp;
        "fabric-1.20.1" = _56akTCx3;
        "fabric-1.17.1" = _3AdX17fc;
        "fabric-1.21.1" = _GKeQIVCm;
        "fabric-1.21.6" = _4tIeCPBp;
        "fabric-1.21.4" = _LMIJoMks;
        "fabric-1.20.4" = _PUw82G5D;
        "pkg-v1.0.0-mc1.20.1" = _LTeIRBt2;
        "pkg-v1.0.0-mc1.17.1" = _bKjcWp6b;
        "pkg-v1.0.0-mc1.21.1" = _OGe5biYE;
        "pkg-v1.0.0-mc1.21.6" = _Wu6XO0Az;
        "pkg-v1.0.0-mc1.21.4" = _b76JW3bV;
        "pkg-v1.1.0-mc1.21.6" = _fCK4hwKE;
        "pkg-v1.1.0-mc1.20.1" = _nQZLb82I;
        "pkg-v1.1.0-mc1.17.1" = _BDWkrYEn;
        "pkg-v1.1.0-mc1.21.4" = _EyR8Vxv0;
        "pkg-v1.1.0-mc1.21.1" = _t9zmowmG;
        "pkg-v1.2.0-mc1.20.1" = _NxslOBnw;
        "pkg-v1.2.0-mc1.21.6" = _HGxY07bQ;
        "pkg-v1.2.0-mc1.17.1" = _p8h3pm7T;
        "pkg-v1.2.0-mc1.21.1" = _fINzk61A;
        "pkg-v1.2.0-mc1.21.4" = _L2wBZ1Yw;
        "pkg-v2.0.0-mc1.21.6" = _2qYbhXny;
        "pkg-v2.0.0-mc1.17.1" = _GF4z9Iia;
        "pkg-v2.0.0-mc1.21.4" = _fQksKNcs;
        "pkg-v2.0.0-mc1.20.1" = _W9pfby2f;
        "pkg-v2.0.0-mc1.21.1" = _93TbAKa9;
        "pkg-v2.1.0-mc1.21.1" = _f8l3gX0r;
        "pkg-v2.1.0-mc1.20.1" = _bqwdjgG5;
        "pkg-v2.1.0-mc1.21.4" = _yaOoY5uX;
        "pkg-v2.1.0-mc1.21.6" = _jamlhFf1;
        "pkg-v2.1.0-mc1.17.1" = _yBtvJquT;
        "pkg-v2.2.0-mc1.20.1" = _seiizmaw;
        "pkg-v2.2.0-mc1.21.1" = _8K5aG4Ax;
        "pkg-v2.2.0-mc1.21.6" = _B2HE1xKd;
        "pkg-v2.2.0-mc1.21.4" = _s8RiiXoE;
        "pkg-v2.2.0-mc1.17.1" = _2bOKUpyh;
        "pkg-v2.3.0-mc1.17.1" = _MdhDIVFw;
        "pkg-v2.3.0-mc1.21.1" = _9zhXoS0g;
        "pkg-v2.3.0-mc1.21.6" = _Wi2m3dBa;
        "pkg-v2.3.0-mc1.21.4" = _4HJJGUbD;
        "pkg-v2.3.0-mc1.20.1" = _2uqhtEkD;
        "pkg-v2.3.1-mc1.20.4" = _z0U3wcI1;
        "pkg-v2.3.1-mc1.20.1" = _OcUreNL6;
        "pkg-v2.3.1-mc1.21.6" = _56rpiEOy;
        "pkg-v2.3.1-mc1.21.4" = _Bp9timwt;
        "pkg-v2.3.1-mc1.21.1" = _gMnZdX42;
        "pkg-v2.3.1-mc1.17.1" = _FSCF8ii2;
        "pkg-v2.3.2-mc1.20.4" = _PUw82G5D;
        "pkg-v2.3.2-mc1.21.1" = _GKeQIVCm;
        "pkg-v2.3.2-mc1.20.1" = _56akTCx3;
        "pkg-v2.3.2-mc1.21.4" = _LMIJoMks;
        "pkg-v2.3.2-mc1.17.1" = _3AdX17fc;
        "pkg-v2.3.2-mc1.21.6" = _4tIeCPBp;
        "default" = _4tIeCPBp;
    });
