...
let
    ...
    in {
        ...
        "pkg-2.9.0" = _Gtn66Aqe;
        "pkg-2.8.9" = _BPf7DxkS;
        "pkg-2.6.15" = _HXLfaO1w;
        "pkg-2.6.12" = _GDD2swja;
        "pkg-2.9.1" = _THwrApyJ;
        "pkg-2.9.2" = _T13Y5nnJ;
        "pkg-2.9.3" = _1AZhMXe7;
        "pkg-2.9.3+1.19.3" = _aoAZXkqx;
        "pkg-2.10.4" = _NBWDWypC;
        "pkg-2.10.7" = _SKxhUs2I;
        "pkg-2.10.12" = _qWKs9GSV;
        "pkg-2.10.14" = _EedSY5Xu;
        "pkg-2.10.20" = _khRcoGPl;
        "pkg-2.10.21" = _DIBiWudq;
        "pkg-2.10.22" = _nm6yLGRw;
        "pkg-2.10.23" = _JFyuzapJ;
        "pkg-2.9.4" = _kwUXLQPI;
        "pkg-2.10.24" = _Kwi2M0y8;
        "pkg-2.10.25" = _F7Y6iM8c;
        "pkg-2.10.26" = _YZCT4v9j;
        "pkg-2.6.17" = _CzQzXAu0;
        "pkg-2.10.27" = _tJeTcXuL;
        "pkg-2.10.28" = _jQhcsIZs;
        "pkg-2.10.29" = _OxSfDFIZ;
        "pkg-2.10.30" = _qzcyyZEL;
        "pkg-2.10.31" = _OJK97rFo;
        "pkg-2.10.32" = _4eXUvr6G;
        "pkg-2.10.33" = _cShf5aSJ;
        "pkg-2.10.34" = _dEwpO45X;
        "pkg-2.11.0" = _V9RNcrBX;
        "pkg-2.11.1" = _VCCVSkwk;
        "pkg-2.11.2" = _Z1JWpMGX;
        "pkg-2.11.3" = _NQQnmBuq;
        "pkg-2.11.5" = _i7eXEyKw;
        "pkg-2.11.6" = _QIXwZNQZ;
        "pkg-2.11.7" = _7CPnWljL;
        "pkg-2.11.8" = _FbEntYXT;
        "pkg-2.11.9" = _LC8MF8Fw;
        "pkg-2.11.10" = _wLXDszYV;
        "pkg-2.11.11" = _9XoRYjCa;
        "pkg-2.11.12" = _cO816I6W;
        "pkg-2.11.13" = _NdCQnmre;
        "pkg-2.11.14" = _GT8PJauX;
        "pkg-2.11.15" = _oKn0NhvA;
        "pkg-2.11.16" = _kIfhbwdL;
        "pkg-2.11.17" = _GKcyVz0N;
        "pkg-2.11.18" = _QsSBs6zK;
        "pkg-2.11.19" = _430wA8sU;
        "pkg-2.11.20" = _2GtNXZTI;
        "pkg-2.11.22" = _SNNpSfXt;
        "pkg-2.11.23" = _H6u7QFeC;
        "pkg-2.11.24" = _VB2iKU0F;
        "pkg-2.11.25" = _ERTYohOX;
        "pkg-2.11.26" = _G6uu8LDS;
        "pkg-2.11.27" = _U2uEG971;
        "pkg-2.11.28" = _FHuLs5LQ;
        "pkg-2.11.29" = _E92fDExg;
        "pkg-2.11.30" = _YnHGMBbt;
        "pkg-2.11.31" = _Msdrwz3h;
        "pkg-2.11.32" = _6l0P4h6I;
        "pkg-2.11.33" = _NHhWpLCK;
        "pkg-2.11.34" = _PIhqfa2p;
        "pkg-2.12.0" = _zVsuq1CR;
        "pkg-2.12.1" = _okK3RO4e;
        "pkg-2.12.2" = _vWwoWQNr;
        "pkg-2.12.3" = _R7jTgrCN;
        "pkg-2.12.4" = _KoQwFplo;
        "pkg-2.12.5" = _H2qW227x;
        "pkg-2.12.6" = _XhbN7Hjf;
        "pkg-2.12.7" = _YyqmVlCG;
        "pkg-2.11.35" = _DEQBtqzC;
        "pkg-2.11.36" = _T9lXHlU3;
        "pkg-2.12.8" = _CX0unjU0;
        "pkg-2.11.37" = _aI5XI1xQ;
        "pkg-2.12.9" = _Ee9C5Y9X;
        "pkg-2.12.10" = _IrQio3CK;
        "pkg-2.12.11" = _b1e6cO20;
        "pkg-2.12.12" = _5vEaaHg8;
        "pkg-2.11.38" = _i0ZmPKlU;
        "pkg-2.12.13" = _zpPhPSIE;
        "pkg-2.11.39" = _4IpK2oCQ;
        "pkg-2.12.14" = _yyR73fAR;
        "pkg-2.12.15" = _TMXT4IEs;
        "pkg-2.12.16" = _r5ykLPVP;
        "pkg-2.12.17" = _Sxi0GJEU;
        "pkg-2.12.18" = _y841FR2z;
        "pkg-2.12.19" = _ln1ifZ8z;
        "pkg-2.12.20" = _jND4IvsP;
        "pkg-2.12.21" = _c5s936XO;
        "pkg-2.12.22" = _lpDBXpaL;
        "pkg-2.12.23" = _WBF7plQj;
        "pkg-2.12.24" = _inrtMtqF;
        "pkg-2.12.25" = _1oQobesq;
        "pkg-2.12.26" = _x4KgcWg5;
        "pkg-2.12.27" = _jx15KTr4;
        "pkg-2.12.28" = _LmzdNFkt;
        "pkg-2.12.29" = _gZa9Yg6Q;
        "pkg-2.12.30" = _QH9hVcPi;
        "pkg-2.12.31" = _ERxjjtmi;
        "pkg-2.12.32" = _IbFWHI5h;
        "pkg-2.12.33" = _pcUy2Oig;
        "pkg-2.12.34" = _HoxFnPO8;
        "pkg-2.12.35" = _p6pvilEm;
        "pkg-2.13.0" = _YHfsJkH3;
        "pkg-2.13.1" = _7CVMkNmO;
        "pkg-2.13.2" = _3UaXgFEx;
        "pkg-2.12.36" = _O2mNrPeM;
        "pkg-2.13.3" = _vqdF0jcM;
        "pkg-2.13.4" = _UqagoK0C;
        "pkg-2.13.5" = _wQecY0h2;
        "pkg-2.13.6" = _vbyCSJW7;
        "pkg-2.13.7" = _jy6rEC2t;
        "pkg-2.14.0" = _399ewGhB;
        "pkg-2.13.8" = _RtXghe89;
        "pkg-2.13.9" = _VKAn3WBQ;
        "pkg-2.14.1" = _p6jbwYMc;
        "pkg-2.14.2" = _F2EXmCaH;
        "pkg-2.13.10" = _pP1judcE;
        "pkg-2.13.11" = _yYzo25U6;
        "pkg-2.13.12" = _M0hcwEit;
        "pkg-2.14.3" = _1TSofL7h;
        "pkg-2.13.13" = _V1tOX3OK;
        "pkg-2.14.4" = _zYbI2su2;
        "pkg-2.14.5" = _5l8QDdYQ;
        "pkg-2.14.6" = _xQmdayHu;
        "pkg-2.14.7" = _w3HjbqwI;
        "pkg-2.13.14" = _IAULUUTE;
        "pkg-2.14.8" = _YmUlOGtW;
        "pkg-2.13.15" = _TyV1CDvv;
        "pkg-2.13.16" = _9ZigtmFd;
        "pkg-2.13.17" = _8MuQz89B;
        "pkg-2.13.18" = _hVPK0cWC;
        "pkg-2.13.19" = _ZMr1ItMq;
        "pkg-2.13.20" = _tPJ3UDWB;
        "pkg-2.14.9" = _B6wfLCHB;
        "pkg-2.13.21" = _wgZymJZ1;
        "pkg-2.13.22" = _I406TcLd;
        "pkg-2.13.23" = _yuWwz7cV;
        "pkg-2.13.24" = _3ZRFwsQm;
        "pkg-2.13.25" = _ySdJAVOH;
        "pkg-2.14.10" = _yT7wW5Kc;
        "pkg-2.13.26" = _bsTflTIq;
        "pkg-2.13.27" = _YFsp9arp;
        "pkg-2.13.28" = _NGq1IzwC;
        "pkg-2.13.29" = _4EBcqGWq;
        "pkg-2.14.11" = _giAjpGSg;
        "pkg-2.13.30" = _owFMOoff;
        "pkg-2.13.31" = _1vGOcdnx;
        "pkg-2.13.32" = _fO6xFzDF;
        "pkg-2.13.33" = _R4zS2Jli;
        "pkg-2.13.34" = _fEMKr02l;
        "pkg-2.13.35" = _s5OIqWEA;
        "pkg-2.13.36" = _tXZudQfR;
        "pkg-2.14.12" = _X5yh6qug;
        "pkg-2.14.13" = _7v1qp2cp;
        "pkg-2.13.37" = _6l8zEHtZ;
        "pkg-2.14.14" = _yOsAMkZs;
        "pkg-2.13.38" = _ObUu8hxJ;
        "pkg-2.12.37" = _6fWimIyT;
