...
let
    ...
    in {
        ...
        "pkg-1.9.0" = _mArMdsl9;
        "pkg-1.9.3" = _iiLy8DRl;
        "pkg-1.9.31" = _Z4vtVSAV;
        "pkg-1.9.32" = _RBXYZrhd;
        "pkg-1.9.33" = _SVDPp6hH;
        "pkg-1.9.4" = _dJFY8ifx;
        "pkg-1.9.41" = _AVkvh264;
        "pkg-1.9.5" = _Lb5snEDa;
        "pkg-1.9.6" = _lbiawRGc;
        "pkg-1.9.61" = _41IWa5y8;
        "pkg-1.9.64" = _l75iZqyr;
        "pkg-1.9.65" = _BiyVpNx5;
        "pkg-1.9.66" = _28odnN1N;
        "pkg-1.9.67" = _uJ7EfPyj;
        "pkg-1.9.7" = _bANPT4dp;
        "pkg-1.9.71" = _PtnY6Vxo;
        "pkg-1.9.73" = _4uEe2uAy;
        "pkg-1.9.74" = _iLLFbYST;
        "pkg-1.9.75" = _tXJHYOAz;
        "pkg-1.9.76" = _sFqW7p0w;
        "pkg-1.9.77" = _sTj2d8pS;
