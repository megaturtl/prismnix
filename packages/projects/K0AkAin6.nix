...
let
    versions = (let
        ...
        _D3ZSlfPP = {
            "id" = "D3ZSlfPP";
            "file" = "clientsort-neoforge-3.102.6-beta.1+26.1.2.jar";
            "hash" = "sha512-y55GliW1/JRDzLV0OFQUTK/xAx5hkwSsdtVddqHsrzqaYDVVpSdbc5i7C64Zw2ylrVsRNuAyvtHzvIS4/mz8Mg==";
        };
        _wfv9jO0P = {
            "id" = "wfv9jO0P";
            "file" = "clientsort-fabric-3.102.6-beta.1+26.1.2.jar";
            "hash" = "sha512-U4ZEHA+PDBOiF2JGzxB8F+mWmEpw9/Oo3s+CVXWnjne6ICyY4iKSH8ijZB4ceqf47aoaLAD+Ryzj+ArHwSZUXA==";
        };
        _Nmd7ZEkq = {
            "id" = "Nmd7ZEkq";
            "file" = "clientsort-fabric-3.103.2-beta.1+26.2.jar";
            "hash" = "sha512-1LYKzn8Ew8LAd3lW8g2gvUPLVNP1NJwPQJ8L6nz/AQyWHCWdROOAZPT4iwdXNQJdJNZOXnw3dFZ6fBEqd+VPHA==";
        };
        _gSKTGzT1 = {
            "id" = "gSKTGzT1";
            "file" = "clientsort-neoforge-3.103.2-beta.1+26.2.jar";
            "hash" = "sha512-JWdQWwiNpl1yJ0gZ6WkJkXQ1Bgmo+ujN2juhfk3d763qVoe4Uipv/6/JaeJUNiiobBVwm30LryWEMPr8PoSjkA==";
        };
        _iFUwz54Y = {
            "id" = "iFUwz54Y";
            "file" = "clientsort-forge-3.82.0-beta.1+1.20.1.jar";
            "hash" = "sha512-iueiNidIhZOmGHWp03N6hQ7IkKJXlfXt4k12lSuln+26Oq5yGAOuwL+gbqHKPSI5hDf6mvbZ+KF0YPbedMX1kw==";
        };
        _ELwgMYrq = {
            "id" = "ELwgMYrq";
            "file" = "clientsort-fabric-3.82.0-beta.1+1.20.1.jar";
            "hash" = "sha512-/imBVI2CPIr+mBZll68WJR4DBtbJGDxMWfTkxdfiHOnWtq76OB7y9aHperXS2EOU3eHnKGByz5ohHF/pjFSiEg==";
        };
        _w94cODar = {
            "id" = "w94cODar";
            "file" = "clientsort-neoforge-3.89.0-beta.1+1.21.1.jar";
            "hash" = "sha512-jh9t6IJsiPo1W6RHNdtyx0JOhHrBQix6I4r685N6U8GTKMHudsNGimgsB38WKWtFTzrBriHgO1yl0QhGTewGGA==";
        };
        _dtAsIjXR = {
            "id" = "dtAsIjXR";
            "file" = "clientsort-fabric-3.89.0-beta.1+1.21.1.jar";
            "hash" = "sha512-c3AYQHla//nj2SsRxNdVMukAUqMMYy5bZU8763OJfGG2gXpCeFglL47l3BToGhY0odhijp72xPsSCOzX6ku90A==";
        };
        _fZvRlcJA = {
            "id" = "fZvRlcJA";
            "file" = "clientsort-forge-3.82.0-beta.2+1.20.1.jar";
            "hash" = "sha512-NFCbG2QIBnlZfxJ09yEeHPuAVeyjs4bh7ImCGb57wWW9GdEExFPdJK5oLOTpbv1Dc9KQqd7Ehl+VWSMHNpo04g==";
        };
        _gjxqMhgl = {
            "id" = "gjxqMhgl";
            "file" = "clientsort-fabric-3.82.0-beta.2+1.20.1.jar";
            "hash" = "sha512-xsL/0cVww0HTj93+2taIGBqrgT/JjqP9yAsnyw+bKnGIRyWnOXuhPseeAdtsn7lDDa10QKnogq00XGdI1daOrw==";
        };
        _kcEfphTi = {
            "id" = "kcEfphTi";
            "file" = "clientsort-neoforge-3.89.0-beta.2+1.21.1.jar";
            "hash" = "sha512-xrZBUl0vN6LSAWv80TTifimQQ7pVEaVX3Y9BaqKYIgnajHmSt3h37f0RAImEKYPFfGHpc29oiyAzu2jVCaVOWQ==";
        };
        _JERAOYUb = {
            "id" = "JERAOYUb";
            "file" = "clientsort-fabric-3.89.0-beta.2+1.21.1.jar";
            "hash" = "sha512-kQAxZ/q6RrIHdDUXNdH1qBVNpQoo30QreaW3npNjXU7gTts/2eKoaKTBxEv4gI02zr2fY5nLO3XY31Z2zGAI0g==";
        };
        _Yd1cw8iF = {
            "id" = "Yd1cw8iF";
            "file" = "clientsort-fabric-3.102.6-beta.2+26.1.2.jar";
            "hash" = "sha512-kEMxoa7MvA4dF7xLBOxJnbbEePVO6zSOpdOFKd6vbN3RbEGGunganJD6l3xiovjxOvlb16N+GGcl+cvnfY28Sg==";
        };
        _tBeNWgXE = {
            "id" = "tBeNWgXE";
            "file" = "clientsort-neoforge-3.102.6-beta.2+26.1.2.jar";
            "hash" = "sha512-ImhIorafVDAsJbpuVlcOHeh6zkV6fDnxPJeSOmu7uUcagid8m6j5Pp8QX2ojubRkZo1KQ6duIdLALKb9T7uPEQ==";
        };
        _XsfbuJTy = {
            "id" = "XsfbuJTy";
            "file" = "clientsort-fabric-3.103.2-beta.2+26.2.jar";
            "hash" = "sha512-iviYu8TlJWgqm7Ja2YaUF6U8vRYZtHE4xGyTp6AAGruKGED/SJye413duMm215XQsD12xF90U4JfCzPPlNvs6w==";
        };
        _L13YH0tr = {
            "id" = "L13YH0tr";
            "file" = "clientsort-neoforge-3.103.2-beta.2+26.2.jar";
            "hash" = "sha512-mYJJJYZyiwik3BC3uKibIrPg1FFUzvagdiMxKRIy2J6ckv2X/IXHiQs7aUakJWuiKo3Chcw2WayYqKvJmxkZEA==";
        };
        _GxQHymio = {
            "id" = "GxQHymio";
            "file" = "clientsort-forge-3.82.0+1.20.1.jar";
            "hash" = "sha512-ZZVsmblAtePGhtWsPNDu/zuF1p/kbnkpRsQ+2dQa1gV0IhF53k46VGf1NBphiMHSAQHy5Zpq5khzHV6JVji/pQ==";
        };
        _IbV7SCAY = {
            "id" = "IbV7SCAY";
            "file" = "clientsort-fabric-3.82.0+1.20.1.jar";
            "hash" = "sha512-sjX7b5LggkGo90e7V424zmcAMzn2Ewhg1WdmVd2Augv/OUmlkR1ZAnIRkGqmBvKHIXwiw9szSblWT47h00JYnw==";
        };
        _McLT0UHU = {
            "id" = "McLT0UHU";
            "file" = "clientsort-neoforge-3.89.0+1.21.1.jar";
            "hash" = "sha512-hXpiZrAgzqVkS9LrIvIdiYlCQrLI+hCAonzk5HahOeAW90xH0lvDcgjJnQRXOeLdEmRm58gFCGQvRpX8/sLh4g==";
        };
        _tOLBhgHL = {
            "id" = "tOLBhgHL";
            "file" = "clientsort-fabric-3.89.0+1.21.1.jar";
            "hash" = "sha512-coMxYC7sz2FNuv20PK8DC9SpyrisMzzq987hHgMH8d3BEuG85LxwDDnyEOldtetpgkOC5P2W8m5DmQU0lJcxaA==";
        };
        _gOByoSdu = {
            "id" = "gOByoSdu";
            "file" = "clientsort-fabric-3.102.6+26.1.2.jar";
            "hash" = "sha512-E1GGHkOH6WgPMJfRbdfmTkXsqJ034Dxz2RgNA7k9fZ/mn/mDCLL49pUhSVetR5FTeXALJCQB2FJ2c5HVr8wOqQ==";
        };
        _2HQI9HmC = {
            "id" = "2HQI9HmC";
            "file" = "clientsort-neoforge-3.102.6+26.1.2.jar";
            "hash" = "sha512-etiO68jBpEaSKKTbyDYiBQ7Dt4z6btV3BFcqGSqxKsZA+drTieJMfQDQpPCF29kU/dmWsFPo8nLpUjA9r2J1jQ==";
        };
        _fLc8GI2E = {
            "id" = "fLc8GI2E";
            "file" = "clientsort-fabric-3.103.2+26.2.jar";
            "hash" = "sha512-GfNQG4gGUaBRVZ8nlHYS5GaHv9qkUYkf2GUCZuJnDi+affu4c4M3zEHDtHq9J8qcIphgFB3hQ9muQ4u2GiZXlw==";
        };
        _EwCO9Jok = {
            "id" = "EwCO9Jok";
            "file" = "clientsort-neoforge-3.103.2+26.2.jar";
            "hash" = "sha512-3tdGaIinFBcz+nrcoRf1lICYGWz6aappSqG1SrtflwesAB23r+v89c2ysyfHCWupzMzkiq0CluEvRxeNmvcisw==";
        };
        _QnNvEvXw = {
            "id" = "QnNvEvXw";
            "file" = "clientsort-forge-3.82.1+1.20.1.jar";
            "hash" = "sha512-kjL6FzqXQ4Bq4pz6Tj4l41YonbryiHitDO2jfyuaxIhFbn/W4OcP6E8Gck5kx97sxqPivRFmuT5d2EuxER83NQ==";
        };
        _sQzUi7lU = {
            "id" = "sQzUi7lU";
            "file" = "clientsort-fabric-3.82.1+1.20.1.jar";
            "hash" = "sha512-OB3l9GZ0rMdlWpp/1c/1naT+f4CreSlh/mZw4Uzuppy4lyixXew5Tb0z5GZ7x3cfHWFBppKfCQhOiF7BS3wwoA==";
        };
        _WLIQfhd3 = {
            "id" = "WLIQfhd3";
            "file" = "clientsort-neoforge-3.89.1+1.21.1.jar";
            "hash" = "sha512-gpB0dkesXX3yTynbjoh2E+l8rGnLlJmB7HG5SNI0JQvH7BkohYx4bWRwunwtlBUgrs/cdf4nfpiulup+kacKqg==";
        };
        _VjoWIM78 = {
            "id" = "VjoWIM78";
            "file" = "clientsort-fabric-3.89.1+1.21.1.jar";
            "hash" = "sha512-4LELRzdNKnoXQn0g9MKoRHaFWTuSF6JX6YuVCqpBcN8Sp+l4vgBI4ZOC9SoKIxqprRzZ0e+PQbMdcIm3nX3sFA==";
        };
        _6wmJUPZr = {
            "id" = "6wmJUPZr";
            "file" = "clientsort-neoforge-3.102.7+26.1.2.jar";
            "hash" = "sha512-/ttviYaAIL7nnU+2uL/mjL6mEnChA8yeRPK7FDHeoufLSVHmTjZoIMOKzUDfQTlxN8R1pn0KwagPmcdMdh0IOw==";
        };
        _nef8elh5 = {
            "id" = "nef8elh5";
            "file" = "clientsort-fabric-3.102.7+26.1.2.jar";
            "hash" = "sha512-+2IjeUi2B2VeXI4UJ8bym08SCE6lqGoCfg27gwUrMPYS8T7fEQNEKtxEAC3QAq9Mn0LCEBl/VQrnm44zwnaf5w==";
        };
        _uaYUCqzH = {
            "id" = "uaYUCqzH";
            "file" = "clientsort-neoforge-3.103.3+26.2.jar";
            "hash" = "sha512-Lr+Um0VSGjXwQBq4qB+NvGiHNmFlukLFjzx2Uamr7s9hqXMKkLUOGxsp0RFMA1pwFhcbJZyleXCWiS1RiJtMjQ==";
        };
        _Em56vi9Q = {
            "id" = "Em56vi9Q";
            "file" = "clientsort-fabric-3.103.3+26.2.jar";
            "hash" = "sha512-A/DV5PkiXOcVxlFfe3ek7nUpst1325jEVVAZiUg+ZaTo+62fpOJohMDS4V+OniWvNTWjmTr0QCW7qKmNP7EnOw==";
        };
        _ZBIfOq2Y = {
            "id" = "ZBIfOq2Y";
            "file" = "clientsort-fabric-3.104.0-beta.1+26.3-rc-2.jar";
            "hash" = "sha512-5qZtQcfGbhfutzHt2dooETgZ3lgBD+7kNQZFX7DaNgjXeAQuBPwSBiIxkssI/sXadpG6J/XI02faxMdkcvuR4Q==";
        };
        _ZeNH6TQu = {
            "id" = "ZeNH6TQu";
            "file" = "clientsort-neoforge-3.104.0+26.3.jar";
            "hash" = "sha512-x9kTfzvS8mvYKoRCQ7Fmmuap76fg3wYXCk6HwKIVFwGzCQO3VifYyy6DAHK+heY5p0qtoCMGn8J+IV+7DZQIpw==";
        };
        _O1azWLtc = {
            "id" = "O1azWLtc";
    ...
    in {
        ...
        "pkg-0.9.0" = _LaH60GTz;
        "pkg-1.0.0" = _ZLHYgu2s;
        "pkg-1.0.1+1.21" = _cZisjL7s;
        "pkg-1.0.1+1.21.3" = _r1LHbqSn;
        "pkg-1.1.0+1.21" = _EF5I463M;
        "pkg-1.1.0+1.21.3" = _Rc0H0rGP;
        "pkg-1.1.1+1.21" = _tdAU91bg;
        "pkg-1.1.1+1.21.3" = _eLCsOTju;
        "pkg-1.1.2+1.21" = _KZLLCotN;
        "pkg-1.1.2+1.21.3" = _DvpYjKxf;
        "pkg-1.1.3-beta.1+1.21" = _1UWj118Y;
        "pkg-1.1.3-beta.1+1.21.3" = _ER6hABXq;
        "pkg-1.2.0-beta.1+1.21" = _xNlzB1ot;
        "pkg-1.2.0-beta.1+1.21.3" = _FP03cq6x;
        "pkg-1.3.0+1.20.1" = _J5P8yq9F;
        "pkg-1.3.0+1.21" = _aHqa1f5R;
        "pkg-1.3.0+1.21.3" = _P01wQ4sm;
        "pkg-1.3.0+1.21.5" = _wUf0mMHs;
        "pkg-1.3.1+1.20.1" = _PIA2QTg6;
        "pkg-1.3.1+1.21" = _XjlYoOmv;
        "pkg-1.3.1+1.21.3" = _yaa0bFW5;
        "pkg-1.3.1+1.21.5" = _4xGG3kjT;
        "pkg-1.3.2+1.20.1" = _nHUmc5XN;
        "pkg-1.3.2+1.21" = _8olRgko5;
        "pkg-1.3.2+1.21.3" = _AJOd9PCO;
        "pkg-1.3.2+1.21.5" = _bKq5EggM;
        "pkg-1.3.3+1.20.1" = _INpncXCm;
        "pkg-1.3.3+1.21" = _fVJAbtAY;
        "pkg-1.3.3+1.21.3" = _gmGmC0a9;
        "pkg-1.3.3+1.21.5" = _CjrYfUvx;
        "pkg-2.0.0-beta.1+1.20.1" = _IzWDnT0w;
        "pkg-2.0.0-beta.1+1.21" = _QP11oUhm;
        "pkg-1.3.3+1.21.6" = _n37RSzjF;
        "pkg-2.0.0-beta.2+1.20.1" = _4S7fRQyH;
        "pkg-2.0.0-beta.2+1.21" = _oXQqOXuH;
        "pkg-2.0.0-beta.3+1.20.1" = _3E5l92VA;
        "pkg-2.0.0-beta.3+1.21" = _ZB5etRpU;
        "pkg-2.0.0-beta.4+1.20.1" = _CtYIkvZZ;
        "pkg-2.0.0-beta.4+1.21" = _OD7NQ07c;
        "pkg-1.3.3+1.21.7" = _EZzDqjgw;
        "pkg-2.0.0-beta.5+1.20.1" = _Cjoxrf7X;
        "pkg-2.0.0-beta.5+1.21.1" = _Vqbj31ct;
        "pkg-2.0.0-beta.5+1.21.3" = _Zhy3aag3;
        "pkg-2.0.0-beta.5+1.21.5" = _mOgcdEvE;
        "pkg-2.0.0-beta.5+1.21.7" = _ws56Bvdf;
        "pkg-2.0.0-beta.7+1.20.1" = _j423nrLT;
        "pkg-2.0.0-beta.7+1.21.1" = _WJ9CypRq;
        "pkg-2.0.0-beta.7+1.21.3" = _kmvTP0Iv;
        "pkg-2.0.0-beta.7+1.21.5" = _tcTzQJi8;
        "pkg-2.0.0-beta.7+1.21.7" = _vVDc3gpA;
        "pkg-2.0.0-beta.8+1.20.1" = _LNyUtlHD;
        "pkg-2.0.0-beta.8+1.21.1" = _S15SaPHg;
        "pkg-2.0.0-beta.8+1.21.3" = _HpFPlcHj;
        "pkg-2.0.0-beta.8+1.21.5" = _CHYoWc9z;
        "pkg-2.0.0-beta.8+1.21.7" = _qD2flMvg;
        "pkg-2.0.0-beta.9+1.20.1" = _u1p5Knpu;
        "pkg-2.0.0-beta.9+1.21.1" = _DI5wHcFS;
        "pkg-2.0.0-beta.9+1.21.3" = _oadFILST;
        "pkg-2.0.0-beta.9+1.21.5" = _eHYMDKjC;
        "pkg-2.0.0-beta.9+1.21.7" = _wZfOWZR3;
        "pkg-2.0.0-beta.10+1.20.1" = _SOexKn8U;
        "pkg-2.0.0-beta.10+1.21.1" = _D0si7lln;
        "pkg-2.0.0-beta.10+1.21.3" = _cccvxPoP;
        "pkg-2.0.0-beta.10+1.21.5" = _kP1xcCRP;
        "pkg-2.0.0-beta.10+1.21.7" = _hBE30StP;
        "pkg-2.0.0-beta.11+1.20.1" = _AqeOQKsw;
        "pkg-2.0.0-beta.11+1.21.1" = _YQCdEbTF;
        "pkg-2.0.0-beta.11+1.21.3" = _la2klfjo;
        "pkg-2.0.0-beta.11+1.21.5" = _6ySrz3SB;
        "pkg-2.0.0-beta.11+1.21.8" = _q33YnHrL;
        "pkg-2.0.0-beta.12+1.20.1" = _qJYjGx9p;
        "pkg-2.0.0-beta.12+1.21.1" = _XQGYJRMx;
        "pkg-2.0.0-beta.12+1.21.3" = _lq09VxY9;
        "pkg-2.0.0-beta.12+1.21.5" = _MyJVvCXi;
        "pkg-2.0.0-beta.12+1.21.8" = _vr1XpMjf;
        "pkg-2.0.0-beta.13+1.20.1" = _kROjiI7U;
        "pkg-2.0.0-beta.13+1.21.1" = _8JYe7ADI;
        "pkg-2.0.0-beta.13+1.21.3" = _zuqwRyQG;
        "pkg-2.0.0-beta.13+1.21.5" = _jXq3EKuX;
        "pkg-2.0.0-beta.13+1.21.8" = _WQ1S0Dpx;
        "pkg-2.0.0-beta.14+1.20.1" = _uCXIvfFv;
        "pkg-2.0.0-beta.14+1.21.1" = _Yp64RITq;
        "pkg-2.0.0-beta.14+1.21.3" = _V7ovlRfA;
        "pkg-2.0.0-beta.14+1.21.5" = _8G7Ej3tZ;
        "pkg-2.0.0-beta.14+1.21.8" = _kpo7KILK;
        "pkg-2.0.0-beta.15+1.20.1" = _DhJAsYMT;
        "pkg-2.0.0-beta.15+1.21.1" = _4WSD4nGg;
        "pkg-2.0.0-beta.15+1.21.3" = _WkBlccNm;
        "pkg-2.0.0-beta.15+1.21.5" = _sGLBLAMW;
        "pkg-2.0.0-beta.15+1.21.8" = _ZY2aAhZU;
        "pkg-2.0.0-beta.16+1.20.1" = _Zew5jUYy;
        "pkg-2.0.0-beta.16+1.21.1" = _XZoCHdNW;
        "pkg-2.0.0-beta.16+1.21.3" = _P8Dxo6Vh;
        "pkg-2.0.0-beta.16+1.21.5" = _UQej7Zm1;
        "pkg-2.0.0-beta.16+1.21.8" = _bOw0V9en;
        "pkg-2.0.0-beta.17+1.20.1" = _2um8lPrT;
        "pkg-2.0.0-beta.17+1.21.1" = _Y88ogze7;
        "pkg-2.0.0-beta.17+1.21.3" = _mvMAdeGh;
        "pkg-2.0.0-beta.17+1.21.5" = _9DlERcJy;
        "pkg-2.0.0-beta.17+1.21.8" = _DC8U6df3;
        "pkg-2.0.0-beta.18+1.20.1" = _5Xb3GwHk;
        "pkg-2.0.0-beta.18+1.21.1" = _jcU56VWk;
        "pkg-2.0.0-beta.18+1.21.3" = _RJVqgFPO;
        "pkg-2.0.0-beta.18+1.21.5" = _F7MLq0kw;
        "pkg-2.0.0-beta.18+1.21.8" = _SFeyhrea;
        "pkg-2.0.0-beta.19+1.20.1" = _2WEhu9eZ;
        "pkg-2.0.0-beta.19+1.21.1" = _gobNJo72;
        "pkg-2.0.0-beta.19+1.21.3" = _LrgTFqlq;
        "pkg-2.0.0-beta.19+1.21.5" = _1r87zU8y;
        "pkg-2.0.0-beta.19+1.21.8" = _qWFhVVVY;
        "pkg-2.0.0-beta.20+1.20.1" = _6Bllnh7d;
        "pkg-2.0.0-beta.20+1.21.1" = _EFU5WUED;
        "pkg-2.0.0-beta.20+1.21.3" = _z8YZ5mMD;
        "pkg-2.0.0-beta.20+1.21.5" = _nV3uBZ5e;
        "pkg-2.0.0-beta.20+1.21.8" = _U4FffFMp;
        "pkg-2.0.0-beta.20+1.21.9" = _HNHgRd6K;
        "pkg-2.0.0+1.20.1" = _iwDOWKhk;
        "pkg-2.0.0+1.21.1" = _cT9K9FZP;
        "pkg-2.0.0+1.21.3" = _bd3Dqqcf;
        "pkg-2.0.0+1.21.5" = _kcvM9RMJ;
        "pkg-2.0.0+1.21.8" = _wzjsNZqi;
        "pkg-2.0.0+1.21.10" = _86AXR71O;
        "pkg-2.0.1+1.20.1" = _ZtYm2j6T;
        "pkg-2.0.1+1.21.1" = _IMiuab1A;
        "pkg-2.0.1+1.21.3" = _7mmCIbV4;
        "pkg-2.0.1+1.21.5" = _2pAaY1HU;
        "pkg-2.0.1+1.21.8" = _mVV0inkW;
        "pkg-2.0.1+1.21.10" = _i77z0faR;
        "pkg-2.0.2+1.20.1" = _J22SFWIT;
        "pkg-2.0.2+1.21.1" = _v8pn8nSs;
        "pkg-2.0.2+1.21.3" = _9JHK2Aoi;
        "pkg-2.0.2+1.21.5" = _URbEIOW3;
        "pkg-2.0.2+1.21.8" = _TUKpgXRZ;
        "pkg-2.0.2+1.21.10" = _EMMic0ae;
        "pkg-2.0.3+1.20.1" = _ZCBpJSiP;
        "pkg-2.0.3+1.21.1" = _ygNQUB4H;
        "pkg-2.0.3+1.21.3" = _q3LTnvQx;
        "pkg-2.0.3+1.21.5" = _6E5jjNHx;
        "pkg-2.0.3+1.21.8" = _ptetbmxv;
        "pkg-2.0.3+1.21.10" = _TE5Xc7c7;
        "pkg-2.1.0+1.20.1" = _wwiSbngS;
        "pkg-2.1.0+1.21.1" = _popyqJPd;
        "pkg-2.1.0+1.21.3" = _7i2qHn3i;
        "pkg-2.1.0+1.21.5" = _m8iOxp2G;
        "pkg-2.1.0+1.21.8" = _I17Hw2HO;
        "pkg-2.1.0+1.21.10" = _yZSzBXoK;
        "pkg-2.1.1+1.20.1" = _GNMOdUNE;
        "pkg-2.1.1+1.21.1" = _hMJnXoJn;
        "pkg-2.1.1+1.21.3" = _eaOf6bFM;
        "pkg-2.1.1+1.21.5" = _k0EBRKBa;
        "pkg-2.1.1+1.21.8" = _osOaPPvd;
        "pkg-2.1.1+1.21.10" = _eLp06LZt;
        "pkg-2.1.2+1.20.1" = _8KrkH9Lf;
        "pkg-2.1.2+1.21.1" = _FTA7Q63G;
        "pkg-2.1.2+1.21.3" = _Pa2TbPGe;
        "pkg-2.1.2+1.21.5" = _CvNRhrRO;
        "pkg-2.1.2+1.21.8" = _CZgXUaYz;
        "pkg-2.1.2+1.21.10" = _5qVto73j;
        "pkg-2.1.3+1.20.1" = _k6lGR9hk;
        "pkg-2.1.3+1.21.1" = _f2e6rvyT;
        "pkg-2.1.3+1.21.3" = _XI2U1r2n;
        "pkg-2.1.3+1.21.5" = _d0AUWf2y;
        "pkg-2.1.3+1.21.8" = _pU985lhn;
        "pkg-2.1.3+1.21.10" = _vCESWjDL;
        "pkg-2.1.4+1.20.1" = _R757oBOW;
        "pkg-2.1.4+1.21.1" = _LxCJOg7D;
        "pkg-2.1.4+1.21.3" = _d24AQaWs;
        "pkg-2.1.4+1.21.5" = _Gd4VP77i;
        "pkg-2.1.4+1.21.8" = _ZexvzUjW;
        "pkg-2.1.4+1.21.10" = _lMDhLxoF;
        "pkg-2.1.4+1.21.11" = _g22tzYSx;
        "pkg-2.1.5+1.20.1" = _raM7Uakj;
        "pkg-2.1.5+1.21.1" = _btv6jotg;
        "pkg-2.1.5+1.21.3" = _TTiYGh5R;
        "pkg-2.1.5+1.21.5" = _E8bbjGZj;
        "pkg-2.1.5+1.21.8" = _pyQ342na;
        "pkg-2.1.5+1.21.10" = _7ekCz5PV;
        "pkg-2.1.5+1.21.11" = _gRXUFIAH;
        "pkg-2.1.6+1.20.1" = _PSQSukIY;
        "pkg-2.1.6+1.21.1" = _FEzlhdr1;
        "pkg-2.1.6+1.21.3" = _9lHqJgDX;
        "pkg-2.1.6+1.21.5" = _qwkKDzbY;
        "pkg-2.1.6+1.21.8" = _vg4irxwM;
        "pkg-2.1.6+1.21.10" = _sDm584r5;
        "pkg-2.1.6+1.21.11" = _U0CjuW4H;
        "pkg-2.1.7+1.20.1" = _85Ea9ZN1;
        "pkg-2.1.8+1.21.10" = _ogjxcDIx;
        "pkg-2.1.8+1.21.11" = _Cd9211Ic;
        "pkg-2.2.0-beta.1+1.21.1" = _HEVNnBzl;
        "pkg-2.2.0+1.20.1" = _HBTww5DE;
        "pkg-2.2.0+1.21.1" = _N9uDtWTC;
        "pkg-2.2.0+1.21.3" = _9H7TwUDO;
        "pkg-2.2.0+1.21.5" = _1W3o8pES;
        "pkg-2.2.0+1.21.8" = _7IJO7YZk;
        "pkg-2.2.0+1.21.10" = _6KtpPOy0;
        "pkg-2.2.0+1.21.11" = _l0y3CdyG;
        "pkg-2.2.1+1.20.1" = _76pu3UoS;
        "pkg-2.2.1+1.21.1" = _ICs54uIi;
        "pkg-2.2.1+1.21.3" = _vjCJtMdA;
        "pkg-2.2.1+1.21.5" = _mojP70e1;
        "pkg-2.2.1+1.21.8" = _RFq5Z1CC;
        "pkg-2.2.1+1.21.10" = _EMP1U3SD;
        "pkg-2.2.1+1.21.11" = _YNOFvUDb;
        "pkg-3.0.0-beta.1+26.1-rc-2" = _ZLtG2nhU;
        "pkg-3.0.0-beta.2+26.1" = _1m2UMrVq;
        "pkg-3.0.0+26.1" = _xo1C5kjz;
        "pkg-3.1.1+26.1.1" = _km2lmT0H;
        "pkg-3.2.2+26.1.2" = _qY61RTn9;
        "pkg-2.2.2+1.20.1" = _lFaCwSHU;
        "pkg-2.2.2+1.21.1" = _HmreLmlE;
        "pkg-2.2.2+1.21.3" = _b67NYL1q;
        "pkg-2.2.2+1.21.5" = _xRfkt5bD;
        "pkg-2.2.2+1.21.8" = _euKYgGfM;
        "pkg-2.2.2+1.21.10" = _7NAh5aBV;
        "pkg-2.2.2+1.21.11" = _GOo6sdCe;
        "pkg-3.3.0-beta.1+26.2-pre-2" = _smGDbXMl;
        "pkg-3.2.3+26.1.2" = _hyuNunTV;
        "pkg-3.102.4+26.1.2" = _fcfKqeiu;
        "pkg-3.103.0+26.2" = _aorjP22d;
        "pkg-3.102.5+26.1.2" = _Z2ZSULVB;
        "pkg-3.103.1+26.2" = _X8LsOj1G;
        "pkg-3.102.6-beta.1+26.1.2" = _wfv9jO0P;
        "pkg-3.103.2-beta.1+26.2" = _gSKTGzT1;
        "pkg-3.82.0-beta.1+1.20.1" = _ELwgMYrq;
        "pkg-3.89.0-beta.1+1.21.1" = _dtAsIjXR;
        "pkg-3.82.0-beta.2+1.20.1" = _gjxqMhgl;
        "pkg-3.89.0-beta.2+1.21.1" = _JERAOYUb;
        "pkg-3.102.6-beta.2+26.1.2" = _tBeNWgXE;
        "pkg-3.103.2-beta.2+26.2" = _L13YH0tr;
        "pkg-3.82.0+1.20.1" = _IbV7SCAY;
        "pkg-3.89.0+1.21.1" = _tOLBhgHL;
        "pkg-3.102.6+26.1.2" = _2HQI9HmC;
        "pkg-3.103.2+26.2" = _EwCO9Jok;
        "pkg-3.82.1+1.20.1" = _sQzUi7lU;
        "pkg-3.89.1+1.21.1" = _VjoWIM78;
        "pkg-3.102.7+26.1.2" = _nef8elh5;
