...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.0.10" = _I6Z8OBVQ;
        "pkg-1.16.5-1.0.11" = _ii8YKUMW;
        "pkg-0.2.0-3" = _MShyJEuY;
        "pkg-0.2.1-4" = _FCNmIqur;
        "pkg-0.2.2-5" = _WvZs1Ed2;
        "pkg-0.2.3-10" = _uo96l4AD;
        "pkg-0.3.0-15" = _DjVHNx4I;
        "pkg-0.3.1-b24" = _cjS7blj9;
        "pkg-0.3.3-b27" = _UefJVejU;
        "pkg-0.4.0-b33" = _B1J9N8ir;
        "pkg-0.4.1-b34" = _GJMbkeYT;
        "pkg-0.5.0-b38" = _VlFuQbew;
        "pkg-0.5.1-b39" = _WVf3Owmt;
        "pkg-0.5.2-b40" = _VY74Gfpi;
        "pkg-0.5.3-b42" = _nwkxiHdT;
        "pkg-0.5.4-b44" = _gpXvyG7s;
        "pkg-0.5.5-b46" = _1jXTboEd;
        "pkg-0.5.6-b47" = _grTcz9Nx;
        "pkg-0.6.0-b49" = _RcIU3DHf;
        "pkg-0.6.1-b50" = _PFEEzZQQ;
        "pkg-0.6.5-b55" = _ya49dIdF;
        "pkg-0.6.6-b56" = _r2m4C4Ld;
        "pkg-0.6.7-b58" = _e8ZD1tfk;
        "pkg-0.6.9-b62" = _FIqYrajS;
        "pkg-0.6.10-b63" = _U8FdthBf;
        "pkg-0.6.11-b64" = _dQGB8NQO;
        "pkg-0.6.12-b65" = _TPgPC4Wr;
        "pkg-0.6.13-b66" = _NqDqtYQF;
        "pkg-0.7.0-b1594" = _ezzQOBnq;
        "pkg-0.7.1-b1627" = _4tjF06C8;
        "pkg-0.7.2-b1775" = _fA7FrnpP;
        "pkg-0.7.3-b1782" = _hIwTyNVd;
        "pkg-0.7.4-b1815" = _X5fpOhQD;
        "pkg-0.7.5-b1959" = _mNXSrHjc;
        "pkg-0.8.0-b4329" = _FblrngWA;
        "pkg-0.8.1-b4340" = _FRfbY3ep;
        "pkg-0.8.1-b4349" = _KIyOp68x;
        "pkg-0.8.2-b4368" = _GiGWrokU;
        "pkg-0.8.2-b4445" = _zA6KGfvE;
