...
let
    versions = (let
        ...
        _s0dtlNHu = {
            "id" = "s0dtlNHu";
            "file" = "livingthings-fabric-1.19.4-2.3.1.jar";
            "hash" = "sha512-oCACuekPJSvkTcvPgkQwntlNhEaF7kQTDGTfs15eI9XP2hGk7H6YAD6X5NpfgrEH6c5KTYPTxij4A9Tsp0EGJg==";
        };
        _9t1euR22 = {
            "id" = "9t1euR22";
            "file" = "livingthings-forge-1.19.4-2.3.1.jar";
            "hash" = "sha512-j8Zksr3mABjW1ln6tr0e1CC92unx1a3r6QyIdp2Z2J+igSkDxG9IugXZmNFDueOeHfuSID4ND6AsNRGGJN4Zbw==";
        };
        _POk0whCt = {
            "id" = "POk0whCt";
            "file" = "livingthings-fabric-1.20.1-2.3.1.jar";
            "hash" = "sha512-PITVTW0sfsnnKdg00snHqe6M6h7mCoiQW8XaWZub3ztXB035fCabhkaDiHxnGse1189kXdT4TRhxalbuzl2QWQ==";
        };
        _pZ3YhVSH = {
            "id" = "pZ3YhVSH";
            "file" = "livingthings-forge-1.20.1-2.3.1.jar";
            "hash" = "sha512-lzucHdeZpKPDCESKA5KSH8w3qMpslTROw4x+2RiuacGpu59eu2hDGaOwHX1RlnytifEK9ZYWv4q/TEsao6TZQg==";
        };
        _71l9opHc = {
            "id" = "71l9opHc";
            "file" = "livingthings-neoforge-1.20.4-2.3.1.jar";
            "hash" = "sha512-cOMbszwN37sbRHF9Jx44Bg9tVcO+7cbnfF6z7GphE7j0psa6iXdLx4/zI6ABcqig39y7LH36R629NuYp7FnziA==";
        };
        _MiE85B7X = {
            "id" = "MiE85B7X";
            "file" = "livingthings-fabric-1.20.4-2.3.1.jar";
            "hash" = "sha512-y3wk6FtPWgyaqn1vMZN1He41XW/eRrXGmZwTZZ956/NkivuxuQVsx2EZ6s0BJJljS4T9rXCnJ4pmxI6ar52dgg==";
        };
        _x8n52H4K = {
            "id" = "x8n52H4K";
            "file" = "livingthings-forge-1.20.4-2.3.1.jar";
            "hash" = "sha512-umhuX6grimU0UU2sgQ2QU4Z4qFxDGfgOunIJrkmx05vIuelf6xXrt8j8x0J7VJqyNI83bsbOIYIOIUwTeP27NA==";
        };
        _Jp2mskhk = {
            "id" = "Jp2mskhk";
            "file" = "livingthings-neoforge-1.20.6-2.3.1.jar";
            "hash" = "sha512-QwxVM3N57G1xmPvyPXBGi/hJXgGzuCbK5hA2GgCWa+4xnSdtaD+A6NO4EwnhwcYcXSgKgXu3vMP35BSLPMebDw==";
        };
        _bxNuxH5P = {
            "id" = "bxNuxH5P";
            "file" = "livingthings-fabric-1.20.6-2.3.1.jar";
            "hash" = "sha512-tcgTE/VE1LdbCTW5KW+iRya2iuRkmaRCMwVHa+ZWoazA4EPf12MHljHSHfQOWscLjsBjjAcQowiNtnjpxdSVcw==";
        };
        _GbfUHHzs = {
            "id" = "GbfUHHzs";
            "file" = "livingthings-forge-1.20.6-2.3.1.jar";
            "hash" = "sha512-wjaCYnuQeYC4NvqxQQWj8t9i5VXdGEPgRMHwu2kMOefgj30XrszfxqNEf0bqmhd8XBX+ZBjRj3aq8TMHlGs1Dw==";
        };
        _TdmauWXd = {
            "id" = "TdmauWXd";
            "file" = "livingthings-neoforge-1.21.1-2.3.1.jar";
            "hash" = "sha512-gy++fcAWw+pwRoBYFFReIEYVRjfupBA6AE8RE7osOamzjeVChTsOqTD09b0vV5LHoK5uUPUfIlU2nJg7xwvubw==";
        };
        _u3wSFmQk = {
            "id" = "u3wSFmQk";
            "file" = "livingthings-fabric-1.21.1-2.3.1.jar";
            "hash" = "sha512-kzffRgfmzg4lRyIY+9X+PQikMrjOIN8c37EQRRcRzybspIhrUdUcxyjDMmncPNCu7qCB5dmp/CkjMPd4qwgjqw==";
        };
        _qbFh6O1O = {
            "id" = "qbFh6O1O";
            "file" = "livingthings-forge-1.21.1-2.3.1.jar";
            "hash" = "sha512-Mbv44UMRwf2M7/A8Pph27NE5wCM1JHKfCpbFMbFLQjNb/T2keEtSN4w5ba1CsCbvun+yJC5ZoLg7F8B4LuXBug==";
        };
        _c8AcZP3S = {
            "id" = "c8AcZP3S";
            "file" = "livingthings-neoforge-1.21.1-2.3.2.jar";
            "hash" = "sha512-BecT9JQwSIo0emE4DaJ5Qx28wRM3VAI+Bx8Fnh2vPlO8nXfbwnTCJXqU0VAYQxZWewtWdSuzLkJnKMDskPIg/w==";
        };
        _FRIqLUOE = {
            "id" = "FRIqLUOE";
            "file" = "livingthings-fabric-1.21.1-2.3.2.jar";
            "hash" = "sha512-jxnOaoogQ5quQQSDuZse8/TcGmhPp1OLDyYeefXIJW1Q06NCm9XdMKzRxlaSe52xdbsebFhhd0FBt5FHoQGjwQ==";
        };
        _7FiVa5vQ = {
            "id" = "7FiVa5vQ";
            "file" = "livingthings-forge-1.21.1-2.3.2.jar";
            "hash" = "sha512-L9mqWWI99cZtjMaOTQnUv1gF6i28mH/p/NEusWuzucyziUuwWU0nvz68C/lyhdQUfUS40cZbk3nfJ1Tm/bq9DQ==";
        };
        _JcJoOauO = {
            "id" = "JcJoOauO";
            "file" = "livingthings-neoforge-1.21.4-2.3.1.jar";
            "hash" = "sha512-TnUcUjbx979PLlTDVt8mKMNhFYbUcC9SUdexb5YGQxjwbaNZH76rU9Tk/RdQC9IzVC4RoWqAZ8UhtKfRMfDE2w==";
        };
        _3UdVGJlQ = {
            "id" = "3UdVGJlQ";
            "file" = "livingthings-fabric-1.21.4-2.3.1.jar";
            "hash" = "sha512-LQJAGdRV/BMbcdnXyqd3YEUi4jSxdOX3cSQ0c7chjh+Ibou9lF12qX5sDtRbYnRWdWU6zMVk26YlCpls3K9xYA==";
        };
        _FQJJat5o = {
            "id" = "FQJJat5o";
    ...
    in {
        ...
        "forge-1.20.1" = _pZ3YhVSH;
        "forge-1.20.4" = _x8n52H4K;
        "forge-1.20.6" = _GbfUHHzs;
        ...
        "fabric-1.19.4" = _s0dtlNHu;
        "fabric-1.20" = _3PfAyen0;
        "fabric-1.20.1" = _POk0whCt;
        "fabric-1.20.4" = _MiE85B7X;
        "fabric-1.20.6" = _bxNuxH5P;
        ...
        "neoforge-1.20.4" = _71l9opHc;
        "neoforge-1.20.6" = _Jp2mskhk;
        ...
        "pkg-1.18.2-1.5.0" = _qjOOKObg;
        "pkg-1.19.2-2.0.0-Fabric-rc1" = _PAJylg69;
        "pkg-1.19.2-2.0.0-Forge-rc1" = _IjPgsBCW;
        "pkg-1.18.2-2.0.0-Fabric" = _zyN3wwsj;
        "pkg-1.18.2-2.0.0-Forge" = _Obmp1RxR;
        "pkg-1.19.4-2.0.0-Fabric" = _ilTqAkTE;
        "pkg-1.19.4-2.0.0-Forge" = _7okX0CYD;
        "pkg-1.20.1-2.0.0-Fabric" = _VRROUwZi;
        "pkg-1.20.1-2.0.0-Forge" = _DzeMo1CD;
        "pkg-1.18.2-2.0.1-Fabric" = _qoif957m;
        "pkg-1.18.2-2.0.1-Forge" = _qlyxIi0h;
        "pkg-1.19.2-2.0.1-Fabric" = _za1dLiCy;
        "pkg-1.19.2-2.0.1-Forge" = _4zkLxQd3;
        "pkg-1.19.4-2.0.1-Fabric" = _k8gqcLI9;
        "pkg-1.19.4-2.0.1-Forge" = _LBX0E60S;
        "pkg-1.20.1-2.0.1-Fabric" = _WJ9fO0JD;
        "pkg-1.20.1-2.0.1-Forge" = _nwRz6h40;
        "pkg-1.18.2-2.0.2-Fabric" = _zFZKaJFv;
        "pkg-1.18.2-2.0.2-Forge" = _BKPKyQCl;
        "pkg-1.19.2-2.0.2-Fabric" = _6qkvN2aX;
        "pkg-1.19.2-2.0.2-Forge" = _WBZALiat;
        "pkg-1.19.4-2.0.2-Fabric" = _3KX4qLIw;
        "pkg-1.19.4-2.0.2-Forge" = _2EHThFPs;
        "pkg-1.20.1-2.0.2-Fabric" = _3PfAyen0;
        "pkg-1.20.1-2.0.2-Forge" = _7oXD8FX7;
        "pkg-1.20.4-2.0.2-NeoForge" = _J01XFtMm;
        "pkg-1.20.4-2.0.2-Fabric" = _FpUdJ10y;
        "pkg-1.20.4-2.0.2-Forge" = _dq5N55oV;
        "pkg-1.20.6-2.0.3-NeoForge" = _jD4VtFd1;
        "pkg-1.20.6-2.0.3-Fabric" = _Km4r1Q7Z;
        "pkg-1.20.6-2.0.3-Forge" = _YrwI9pkU;
        "pkg-1.18.2-2.0.3-Fabric" = _foTPyRTs;
        "pkg-1.18.2-2.0.3-Forge" = _Q2WpR3XP;
        "pkg-1.19.2-2.0.3-Fabric" = _oj95ZqWG;
        "pkg-1.19.2-2.0.3-Forge" = _hApCFFgI;
        "pkg-1.19.4-2.0.3-Fabric" = _9WDRr4nX;
        "pkg-1.19.4-2.0.3-Forge" = _A2k88g7e;
        "pkg-1.20.1-2.0.3-Fabric" = _GP3rExzt;
        "pkg-1.20.1-2.0.3-Forge" = _6cG7SrrR;
        "pkg-1.20.4-2.0.3-NeoForge" = _U5njpBqi;
        "pkg-1.20.4-2.0.3-Fabric" = _Othzpl8M;
        "pkg-1.20.4-2.0.3-Forge" = _y5oDiXZS;
        "pkg-1.18.2-2.1.0-Fabric" = _mtzAMUWs;
        "pkg-1.18.2-2.1.0-Forge" = _fi0buVhr;
        "pkg-1.19.2-2.1.0-Fabric" = _5LXIk3yM;
        "pkg-1.19.2-2.1.0-Forge" = _l0wq3CzY;
        "pkg-1.20.1-2.1.0-Fabric" = _Ri9FH7r9;
        "pkg-1.19.4-2.1.0-Fabric" = _WZ1k3A2B;
        "pkg-1.20.1-2.1.0-Forge" = _sDUVmW63;
        "pkg-1.19.4-2.1.0-Forge" = _fxuXE2bm;
        "pkg-1.20.6-2.1.0-NeoForge" = _uhEYNITa;
        "pkg-1.20.6-2.1.0-Fabric" = _e6goav3T;
        "pkg-1.20.6-2.1.0-Forge" = _sxXBq7yH;
        "pkg-1.20.4-2.1.0-NeoForge" = _QfInQKxu;
        "pkg-1.20.4-2.1.0-Fabric" = _OFVR2fW7;
        "pkg-1.20.4-2.1.0-Forge" = _nNsPx7C4;
        "pkg-1.21-2.1.0-NeoForge" = _haeyG9y7;
        "pkg-1.21-2.1.0-Fabric" = _TMIdCD29;
        "pkg-1.21-2.1.0-Forge" = _fDl7EMIq;
        "pkg-1.21.1-2.1.0-NeoForge" = _KMplVQlN;
        "pkg-1.21.1-2.1.0-Fabric" = _nB8hMgXE;
        "pkg-1.21.1-2.1.0-Forge" = _qmOxChI1;
        "pkg-1.18.2-2.1.1-Fabric" = _rrJvtUxM;
        "pkg-1.18.2-2.1.1-Forge" = _6MqorzAh;
        "pkg-1.19.2-2.1.1-Fabric" = _txdbTu3Y;
        "pkg-1.19.2-2.1.1-Forge" = _lEJncse1;
        "pkg-1.19.4-2.1.1-Fabric" = _V6kDnRKg;
        "pkg-1.19.4-2.1.1-Forge" = _JNdV53ue;
        "pkg-1.20.1-2.1.1-Fabric" = _IqQYBP6z;
        "pkg-1.20.1-2.1.1-Forge" = _L8I6YTHd;
        "pkg-1.20.4-2.1.1-NeoForge" = _S3EB1t9O;
        "pkg-1.20.4-2.1.1-Fabric" = _HliwkfzL;
        "pkg-1.20.4-2.1.1-Forge" = _4AHIIP1F;
        "pkg-1.20.6-2.1.1-NeoForge" = _MLHkB4Rm;
        "pkg-1.20.6-2.1.1-Fabric" = _CXubk9pO;
        "pkg-1.20.6-2.1.1-Forge" = _lBU1nDwO;
        "pkg-1.21.1-2.1.1-NeoForge" = _svSnEX2w;
        "pkg-1.21.1-2.1.1-Fabric" = _cKZQaQvh;
        "pkg-1.21.1-2.1.1-Forge" = _UhJrkVe1;
        "pkg-1.21.1-2.1.2-NeoForge" = _WeJUWeE7;
        "pkg-1.21.1-2.1.2-Fabric" = _SbvGkhPx;
        "pkg-1.21.1-2.1.2-Forge" = _hry9MKKt;
        "pkg-1.18.2-2.1.3-Fabric" = _BVMfwGLg;
        "pkg-1.18.2-2.1.3-Forge" = _KayNP0kT;
        "pkg-1.19.2-2.1.3-Fabric" = _J385zT7e;
        "pkg-1.19.2-2.1.3-Forge" = _T3CKqDol;
        "pkg-1.19.4-2.1.3-Fabric" = _inYPkdKq;
        "pkg-1.19.4-2.1.3-Forge" = _dgGFHDjK;
        "pkg-1.20.1-2.1.3-Fabric" = _mP1vrvME;
        "pkg-1.20.1-2.1.3-Forge" = _f8tVyrGf;
        "pkg-1.20.4-2.1.3-NeoForge" = _ZPTOxg7O;
        "pkg-1.20.4-2.1.3-Fabric" = _cJDLVnJV;
        "pkg-1.20.4-2.1.3-Forge" = _O78twcxC;
        "pkg-1.20.6-2.1.3-NeoForge" = _zOeNQkyd;
        "pkg-1.20.6-2.1.3-Fabric" = _sRZCOnik;
        "pkg-1.20.6-2.1.3-Forge" = _E9APDjMj;
        "pkg-1.21.1-2.1.3-NeoForge" = _7fsQ7hmR;
        "pkg-1.21.1-2.1.3-Fabric" = _9k5iPnEP;
        "pkg-1.21.1-2.1.3-Forge" = _bN9hUteE;
        "pkg-1.18.2-2.2.0-Fabric" = _XScurBia;
        "pkg-1.18.2-2.2.0-Forge" = _7yyYneHV;
        "pkg-1.19.2-2.2.0-Fabric" = _YAph0aEJ;
        "pkg-1.19.2-2.2.0-Forge" = _aLP8wGZK;
        "pkg-1.19.4-2.2.0-Fabric" = _80iXkHxA;
        "pkg-1.19.4-2.2.0-Forge" = _Ov4dZCXB;
        "pkg-1.20.1-2.2.0-Fabric" = _etZ32FOy;
        "pkg-1.20.1-2.2.0-Forge" = _53MAbFZI;
        "pkg-1.20.4-2.2.0-NeoForge" = _rIupcczf;
        "pkg-1.20.4-2.2.0-Fabric" = _J3iZnuo4;
        "pkg-1.20.4-2.2.0-Forge" = _X6zR2tBb;
        "pkg-1.20.6-2.2.0-NeoForge" = _y3LIOZPZ;
        "pkg-1.20.6-2.2.0-Fabric" = _HvBtABGK;
        "pkg-1.20.6-2.2.0-Forge" = _HFUa0U4N;
        "pkg-1.21.1-2.2.0-NeoForge" = _jRYOVXrm;
        "pkg-1.21.1-2.2.0-Fabric" = _Cjktz3Pk;
        "pkg-1.21.1-2.2.0-Forge" = _l51BJgiP;
        "pkg-1.21.3-2.2.0-NeoForge" = _xDXUy68Z;
        "pkg-1.21.3-2.2.0-Fabric" = _uyUV0vS8;
        "pkg-1.21.3-2.2.0-Forge" = _mozeZGZd;
        "pkg-1.21.4-2.2.0-NeoForge" = _pRpyHM4Y;
        "pkg-1.21.4-2.2.0-Fabric" = _o0qd4aEK;
        "pkg-1.21.4-2.2.0-Forge" = _CBHW171L;
        "pkg-1.18.2-2.3.0-Fabric" = _PaYlORyo;
        "pkg-1.18.2-2.3.0-Forge" = _geSx16G3;
        "pkg-1.19.2-2.3.0-Fabric" = _gJb6JpZO;
        "pkg-1.19.2-2.3.0-Forge" = _RJM8Z9Ju;
        "pkg-1.19.4-2.3.0-Fabric" = _rFiIAVKm;
        "pkg-1.19.4-2.3.0-Forge" = _Jh1RT9na;
        "pkg-1.20.1-2.3.0-Fabric" = _O6r7xfHw;
        "pkg-1.20.1-2.3.0-Forge" = _5BxljW71;
        "pkg-1.20.4-2.3.0-NeoForge" = _MI1rAwIU;
        "pkg-1.20.4-2.3.0-Fabric" = _QdTbE6Xd;
        "pkg-1.20.4-2.3.0-Forge" = _PecVbIHO;
        "pkg-1.20.6-2.3.0-NeoForge" = _c9xOrBx8;
        "pkg-1.20.6-2.3.0-Fabric" = _il6yEuuu;
        "pkg-1.20.6-2.3.0-Forge" = _3r8uf808;
        "pkg-1.21.1-2.3.0-NeoForge" = _71TJHMjN;
        "pkg-1.21.1-2.3.0-Fabric" = _2zYxdih1;
        "pkg-1.21.1-2.3.0-Forge" = _XgGLdZzJ;
        "pkg-1.21.4-2.3.0-NeoForge" = _QEJMRHx8;
        "pkg-1.21.4-2.3.0-Fabric" = _adPxmDdL;
        "pkg-1.21.4-2.3.0-Forge" = _BLd0z7Iv;
        "pkg-1.21.5-2.3.0-NeoForge" = _CZN9c9ao;
        "pkg-1.21.5-2.3.0-Fabric" = _gfOaoMmO;
        "pkg-1.21.5-2.3.0-Forge" = _7s6wkOjQ;
        "pkg-1.21.6-2.3.0-NeoForge" = _OIU5URLY;
        "pkg-1.21.6-2.3.0-Fabric" = _InuRd3ii;
        "pkg-1.21.6-2.3.0-Forge" = _1HMgHCqa;
        "pkg-1.21.7-2.3.0-NeoForge" = _VkKv9K3q;
        "pkg-1.21.7-2.3.0-Fabric" = _HvS5sn2p;
        "pkg-1.21.7-2.3.0-Forge" = _mmhsmNCB;
        "pkg-1.21.8-2.3.0-NeoForge" = _xdWNsAUj;
        "pkg-1.21.8-2.3.0-Fabric" = _ogTgOj2j;
        "pkg-1.21.8-2.3.0-Forge" = _ylmzsZwt;
        "pkg-1.21.10-2.3.0-NeoForge" = _mHXCNPjy;
        "pkg-1.21.10-2.3.0-Fabric" = _JwDc6ZCi;
        "pkg-1.21.10-2.3.0-Forge" = _gjYDjEQ2;
        "pkg-1.18.2-2.3.1-Fabric" = _MThOk6RE;
        "pkg-1.18.2-2.3.1-Forge" = _A7GyvqFk;
        "pkg-1.19.2-2.3.1-Fabric" = _AwBfxL0t;
        "pkg-1.19.2-2.3.1-Forge" = _HwVBMcLJ;
        "pkg-1.19.4-2.3.1-Fabric" = _s0dtlNHu;
        "pkg-1.19.4-2.3.1-Forge" = _9t1euR22;
        "pkg-1.20.1-2.3.1-Fabric" = _POk0whCt;
        "pkg-1.20.1-2.3.1-Forge" = _pZ3YhVSH;
        "pkg-1.20.4-2.3.1-NeoForge" = _71l9opHc;
        "pkg-1.20.4-2.3.1-Fabric" = _MiE85B7X;
        "pkg-1.20.4-2.3.1-Forge" = _x8n52H4K;
        "pkg-1.20.6-2.3.1-NeoForge" = _Jp2mskhk;
        "pkg-1.20.6-2.3.1-Fabric" = _bxNuxH5P;
        "pkg-1.20.6-2.3.1-Forge" = _GbfUHHzs;
        "pkg-1.21.1-2.3.1-NeoForge" = _TdmauWXd;
        "pkg-1.21.1-2.3.1-Fabric" = _u3wSFmQk;
        "pkg-1.21.1-2.3.1-Forge" = _qbFh6O1O;
        "pkg-1.21.1-2.3.2-NeoForge" = _c8AcZP3S;
        "pkg-1.21.1-2.3.2-Fabric" = _FRIqLUOE;
        "pkg-1.21.1-2.3.2-Forge" = _7FiVa5vQ;
