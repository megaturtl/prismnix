...
let
    ...
    in {
        ...
        "pkg-1.21.1-1.0.1-fabric" = _Q39HpdbB;
        "pkg-1.21.1-1.0.1-neoforge" = _K9s9Ymkp;
        "pkg-1.20.1-1.0.1-forge" = _l7RnScx7;
        "pkg-1.20.1-1.0.1-fabric" = _O9WR1HGx;
        "pkg-1.21.10-1.0.1-fabric" = _jsQraIkc;
        "pkg-1.20.1-1.0.2-fabric" = _4kEDmdxr;
        "pkg-1.21.11-1.0.1-fabric" = _GGDd4Ep6;
        "pkg-26.1.x-1.0.1-fabric" = _XlzPW9pn;
        "pkg-1.21.1-1.0.2-fabric" = _u8uftKpv;
        "pkg-26.1.x-1.0.2-fabric" = _7LziN9dB;
        "pkg-1.20.1-1.0.2-forge" = _IoAw12Lt;
        "pkg-1.21.1-1.0.2-neoforge" = _vWF6Q78B;
        "pkg-3.0.0-beta.2+1.21.1-fabric" = _Xew0BOeq;
        "pkg-3.0.0-beta.2+26.1.x-fabric" = _8NcN7Z5B;
        "pkg-3.0.0-beta.2+1.21.1-neoforge" = _O3VxZCT8;
        "pkg-3.0.0-beta.3+1.21.1-fabric" = _77er35Kd;
        "pkg-3.0.0-beta.3+26.1.x-fabric" = _QCL6Q6af;
        "pkg-3.0.0-beta.3+1.21.1-neoforge" = _WBSHN22b;
        "pkg-3.0.0-beta.4+26.1.x-fabric" = _gymY9xyV;
        "pkg-3.0.0-beta.4+26.2.x-fabric" = _a2ALDEoA;
        "pkg-3.0.0-beta.6+1.21.1-fabric" = _aBXKpH8f;
        "pkg-3.0.0-beta.8+1.21.1-fabric" = _8TnX5EnK;
