...
let
    ...
    in {
        ...
        "pkg-1.7.3" = _5r7rxQfP;
        "pkg-1.7.4" = _f3WKakhU;
        "pkg-1.7.4+1.20.6" = _px65ibZ2;
        "pkg-1.7.4+1.18.2" = _Rca6D9mT;
        "pkg-1.8.0+1.21.4" = _TdiP13NB;
        "pkg-1.8.1+1.21.4" = _SCSmJvTG;
        "pkg-1.8.2+1.21.4" = _1mVtnn8N;
        "pkg-1.8.3+1.21.5" = _Akhw57wc;
        "pkg-1.8.4+1.21.5" = _LJGX2oO5;
        "pkg-1.8.5+1.21.6" = _AHTrONZC;
        "pkg-1.8.5+1.21.7" = _MGuObSQT;
        "pkg-1.8.5+1.20.1" = _x5Xi2PCj;
        "pkg-1.8.6+1.21.9" = _Vmwtve1b;
        "pkg-1.8.6+1.21.7" = _Znea4lI9;
        "pkg-1.8.7+1.21.9" = _4OS7Enyk;
        "pkg-1.8.7+1.21.7" = _IN500jkt;
        "pkg-1.8.8+1.21.10" = _bDaQxpRG;
        "pkg-2.0.0+1.21.10" = _prRkwH9u;
        "pkg-2.0.0+1.21.11" = _BQjxfWQz;
        "pkg-2.0.1+1.21.11" = _f83p0OcK;
        "pkg-2.1.0+1.21.11" = _ZVd6QWbr;
        "pkg-2.2.0+1.21.11" = _FIDalIXP;
        "pkg-2.2.0+1.21.10" = _yYcmAO3V;
        "pkg-2.2.0+26.1" = _4KhrL38Z;
        "pkg-2.2.1+1.21.11" = _eBkFLVc3;
        "pkg-2.2.1+1.21.10" = _ULYkMvN0;
        "pkg-2.2.1+26.1" = _r8tlK5Ea;
        "pkg-2.3.0+1.21.11" = _tKzHjwoj;
        "pkg-2.3.0+1.21.10" = _WCFpeyHA;
        "pkg-2.3.0+26.1" = _uUJtjayC;
        "pkg-2.3.1+1.20.1" = _reuKxgQc;
        "pkg-2.3.1+1.21.1" = _aU8CyLb7;
        "pkg-2.3.1+1.21.2" = _23O7l0kF;
        "pkg-2.3.1+1.21.3" = _blRq92dz;
        "pkg-2.3.1+1.21.4" = _nSBIvahE;
        "pkg-2.3.1+1.21.5" = _ImcxH9zz;
        "pkg-2.3.1+1.21.6" = _dbtVrhx9;
        "pkg-2.3.1+1.21.7" = _BeZBalyP;
        "pkg-2.3.1+1.21.8" = _KboKqVS9;
        "pkg-2.3.1+1.21.9" = _VWUeOZMz;
        "pkg-2.3.1+1.21.10" = _imEEgm18;
