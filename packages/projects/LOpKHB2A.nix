...
let
    versions = (let
        ...
        _yoIvi7IA = {
            "id" = "yoIvi7IA";
            "file" = "waystones-forge-1.21.1-21.1.40.jar";
            "hash" = "sha512-3savcutgSNjUOqYnl+CfBlHhW8a1OvzAuwJiODYRheLwsDzE9qpjqf5WDyxaC7iRbD3WSvcjKKtWikjj8e7PlQ==";
        };
        _y2ypoQsG = {
            "id" = "y2ypoQsG";
            "file" = "waystones-fabric-1.21.1-21.1.40.jar";
            "hash" = "sha512-oahNyw9x8/G0Saokhv+IqS4q3VeWEj9IfxiRQybzJrZGBgWgLt8fj7ainGQ2I4/o/RTXMNh7GInSC702Vn5ZXQ==";
        };
        _u7m5EznS = {
            "id" = "u7m5EznS";
            "file" = "waystones-neoforge-1.21.1-21.1.40.jar";
            "hash" = "sha512-KEG7NlHLW/s6xCRslRq6LZ3WYP1YQ7PSsbF6//gXPKjsM8UerlC7x9b/2RYPnl39Gx+09jvH13JV861EIf2kgg==";
        };
        _jIhstryV = {
            "id" = "jIhstryV";
            "file" = "waystones-fabric-26.1.2-26.1.2.12.jar";
            "hash" = "sha512-m6fgHM7m+RCbp0HXJmQXFCYVw/3zHOKBPO8qRmcfGlur43V6lpb+1RxqOaiu1QQQOFSnd0QMYZPIgw9bVpragQ==";
        };
        _grpTenJz = {
            "id" = "grpTenJz";
            "file" = "waystones-fabric-26.2-26.2.0.7.jar";
            "hash" = "sha512-zLzz9mhFErBTje/SSYszVu8hDz22EngQHGz2Ah402NkeAO/KsfTsT3Jq6AxXdnJ5WdI9GepS1zwiQ0CQUHYBfA==";
        };
        _FXcUHoaf = {
            "id" = "FXcUHoaf";
            "file" = "waystones-neoforge-26.1.2-26.1.2.12.jar";
            "hash" = "sha512-RHPYxjMywBp2tPrLfFhyMsadiy320DPXdeO+iYano/YNU+3joWYFCBTNzVyOb3Wc/VSTeNPdmo4o2MiGg/3Vmg==";
        };
        _CUOrAFzh = {
            "id" = "CUOrAFzh";
            "file" = "waystones-neoforge-26.2-26.2.0.7.jar";
            "hash" = "sha512-5TEZdq/DT9GbpNDRD+hn1SZwe1wPNChggYNfxvModGLAyyLVKVKFGpQZt1N8vUxqyb9SKb9mf4L3y0Hbn8w6VQ==";
        };
        _qtRSzbaZ = {
            "id" = "qtRSzbaZ";
            "file" = "waystones-fabric-1.21.1-21.1.41.jar";
            "hash" = "sha512-TS0J1pHDbz6wl3BDlTxgznQXSkbykSdZHoSmLOgqxNvewTXimfNKWbEDArYdTgIts1M+IJdrESTSys4fRYvsEg==";
        };
        _fxszxKRW = {
            "id" = "fxszxKRW";
            "file" = "waystones-neoforge-1.21.1-21.1.41.jar";
            "hash" = "sha512-GKEfgrd7pSDFhx+YFfAIs+GtEa8W+oSYFnCRw0ozvl0KqbJ2Hu+M76wuItZ9oyp2+y4B/T0ySOPwz8LBOWA9Nw==";
        };
        _IeaT1VS0 = {
            "id" = "IeaT1VS0";
            "file" = "waystones-neoforge-26.2-26.2.0.8.jar";
            "hash" = "sha512-vFmHCWrnhs5XEmjrPmQX0I8kHTAmu8I9m2ZkZ2t+utGlejo8xeBCIKW0I98jlYu6Gb3Aklvqq4r3M+nt93GfqA==";
        };
        _AUdyUW8e = {
            "id" = "AUdyUW8e";
            "file" = "waystones-forge-1.21.1-21.1.41.jar";
            "hash" = "sha512-b90S73ODGnZBRF2/O2V2W25B+pl0w3wpwwyipKZWysh84cddgEAd1cOxZ001IZG9OQxZhYO03e6HrR+4lhGsmA==";
        };
        _1fyuQx3K = {
            "id" = "1fyuQx3K";
            "file" = "waystones-fabric-26.2-26.2.0.8.jar";
            "hash" = "sha512-SeDg9ntKugpE5Vxqh6z3xULFHf4zPUvsRbngWkDCSuutDsg6xDMYngLHJKSyVDJvmJr0rMjPnuJvIuBlshakxA==";
        };
        _WBkjBJ2d = {
            "id" = "WBkjBJ2d";
            "file" = "waystones-fabric-26.1.2-26.1.2.13.jar";
            "hash" = "sha512-NmQTiWeynnqVJHIcqCBt1uzsl3EFmSslANEdm1sJSwd0h4SwAB+5UAGPf5ZFKTvGkCzD56EhRGcdHtV/DiTy/A==";
        };
        _wv319e52 = {
            "id" = "wv319e52";
            "file" = "waystones-neoforge-26.1.2-26.1.2.13.jar";
            "hash" = "sha512-7vKPAQfFRcIupNOlWiNaxOcU4iBhtGooZYlkzFEaDNVAuK/D6x1bAWF6oQKJ2qftDGBiI7eCGcLXDxXhtlBe/g==";
        };
        _F4vZ8CXb = {
            "id" = "F4vZ8CXb";
            "file" = "waystones-fabric-26.1.2-26.1.2.14.jar";
            "hash" = "sha512-+ilbVqaz2nJgr43NTqEseFp9hBCjbIu9h7SKjo3WCddBo49TntuvkpyESGyJhgTSHGEJccx1j4OF6poQWlbsag==";
        };
        _UDYNfgg8 = {
            "id" = "UDYNfgg8";
            "file" = "waystones-neoforge-26.1.2-26.1.2.14.jar";
            "hash" = "sha512-L0LUUTjq6NpR9kTpisRLQhfbo+QWaCtelL2GjbZKDzwI3h2K4M9MJukANy+E3X1NSZr5PwgZz8WIWJGTOuz+XA==";
        };
        _94TIf5SG = {
            "id" = "94TIf5SG";
            "file" = "waystones-neoforge-26.2-26.2.0.9.jar";
            "hash" = "sha512-OZfjwM0lfE0bnefosxNmBbOQj2VZSscLV7FX3VIBdJUN9t1pny09LUhx13GOhm/vBFeLtrd23esbogoyZRfnAA==";
        };
        _5lrxhmSm = {
            "id" = "5lrxhmSm";
            "file" = "waystones-fabric-26.2-26.2.0.9.jar";
            "hash" = "sha512-CbOf6gexdfVXqMPI6mc0NV4K8ayxnKLn+lzkP32zWp4h2CqdlrxZK/4oV8WYtU9llux14u0WJiUFlD/3ocK3rQ==";
        };
        _CciIsxpw = {
            "id" = "CciIsxpw";
            "file" = "waystones-forge-1.21.1-21.1.42.jar";
            "hash" = "sha512-Dnk2DjIeuQcjm0D0lH0MXUvOatG4GdXTscOiFGQ+NgsnR9vz45b/3FaEXrJjoZUA5UOjTWhTpTFpQliVCeJrKQ==";
        };
        _Ado0lAPN = {
            "id" = "Ado0lAPN";
            "file" = "waystones-fabric-1.21.1-21.1.42.jar";
            "hash" = "sha512-ifsrk25FJxrejvPXAcZ/rrhNrFZlawRvzIlgL0Qs1gqfFBo8Wv6lXEqAc/mEydXgwp9t3dfI0EUoQcDdur2gCg==";
        };
        _1gzy0HSm = {
            "id" = "1gzy0HSm";
            "file" = "waystones-neoforge-1.21.1-21.1.42.jar";
            "hash" = "sha512-jpJZaaTXffPCX9FTGpsO64Mc0Mnu5jSmNT5ttBJNW0GZJUlGN11dPB2tX6LBgTiS7dDf8sDfDII5GGSTKgJGgg==";
        };
        _FTqmHV0f = {
            "id" = "FTqmHV0f";
            "file" = "waystones-fabric-26.1.2-26.1.2.15.jar";
            "hash" = "sha512-URDsp4L2bgqni7QgRDrqyj24hlTxyfU2kgJ9yG31MDWinesfpCVFpklvbY9AvE2zM0EnfLF3wHjDX2vqaOzZoA==";
        };
        _dCxil648 = {
            "id" = "dCxil648";
            "file" = "waystones-neoforge-26.1.2-26.1.2.15.jar";
            "hash" = "sha512-6fI4OmtCHK3zjlQnww9o1XKrVTIueUaPSAWfiP19C+Kkv5b0egt45oZ2B3PeIZ2YDnjRy+bvjh4rs/iyS1wrXg==";
        };
        _wX9fdARw = {
            "id" = "wX9fdARw";
            "file" = "waystones-neoforge-26.2-26.2.0.11.jar";
            "hash" = "sha512-jTI0Z0zV3o47srq3YGFzmwj/A0XsCjUWyNOJK7q3R2Bq6xOrNJkUwNIEE6ESf+5mveHOMAcfuLm7nrQGjtGUNg==";
        };
        _jWQQgSGF = {
            "id" = "jWQQgSGF";
            "file" = "waystones-fabric-26.2-26.2.0.11.jar";
            "hash" = "sha512-BEjOq5ztL3k+c2GXLPhAgUczmSvN/3toDeet04aZRlUQIq0xIZf01YOJn3TUk7tsQzuu6iwI9OErmZ/Ss0128g==";
        };
        _LcO5SBoa = {
            "id" = "LcO5SBoa";
            "file" = "waystones-fabric-1.20.1-14.1.21.jar";
            "hash" = "sha512-SFmY0I9uOqC4dj4tKUG54URy/RWIs7bN80WRbz1NHfIEJWcQjPUtRCZPqBPwwgLmPUSqhhVRd0GSz0soI0z6Sg==";
        };
        _Y0IgdaoP = {
            "id" = "Y0IgdaoP";
            "file" = "waystones-forge-1.20.1-14.1.21.jar";
            "hash" = "sha512-N5ju8vgcL2Bm2dwtwiu+nRxLYtWqSUxZL/5n7n9PuAITYVBbPAsTWNT5ryflCx8S0pr7O0sLNitasifovhcQRw==";
        };
        _YgvCsKWn = {
            "id" = "YgvCsKWn";
            "file" = "waystones-fabric-26.1.2-26.1.2.16.jar";
            "hash" = "sha512-9kOXFDNjulgR17Bn+Stvl+4g+c4VxR7v0Sv/3EgXVTj/OefZvUZ8ZZI3TbWVHzuKscHqiJM1LQIwRsoqi32e5A==";
        };
        _Ywwtd3W2 = {
            "id" = "Ywwtd3W2";
            "file" = "waystones-neoforge-26.2-26.2.0.12.jar";
            "hash" = "sha512-3j0Foklj+ainsTVgjQ9NhbCQl1S5Aj6LIGWjm2kXi9Ykm566SUnNdhIFwtEYThW/IhJXxpjOzO+LpzmzrZr4gA==";
        };
        _VaeMtOuU = {
            "id" = "VaeMtOuU";
            "file" = "waystones-neoforge-26.1.2-26.1.2.16.jar";
            "hash" = "sha512-GHrmHuaxYJ9G6z/cSYC6aQVJYrr+3NhvgIGTVnN1oEU/4idSHOZB35J+j6w+ccJKXN2K/UlzwMx4HmzmVLUs5w==";
        };
        _HUacBshD = {
            "id" = "HUacBshD";
            "file" = "waystones-fabric-26.2-26.2.0.12.jar";
            "hash" = "sha512-jfEHbGv+gMBYsZ/njRodzdFHKWViE9DQVzz+5BapvkknYQlQ59P1mQ2uZ3925FPTyEVJqLltVEKPV3zw5GYIKg==";
        };
        _nB37Oycg = {
            "id" = "nB37Oycg";
            "file" = "waystones-forge-1.21.1-21.1.44.jar";
            "hash" = "sha512-TsY8x51K33+PwH0nvsE87xzH9SNVh+1tiCROXbiA1HQTLfPCLPVU0UuGeNqXpVl569b5Ez+U7srbWaNXbf85RA==";
        };
        _XKHZmiJm = {
            "id" = "XKHZmiJm";
            "file" = "waystones-neoforge-1.21.1-21.1.44.jar";
            "hash" = "sha512-+WXxJLrIgiOZjO91SeiO3vKMqBR7X5KBeX4JAxamT0Ih2w1ZGFy1+qDc0X32aQW5eNY+aHI58XKtGnt9MW6OGA==";
        };
        _L5IAXEaz = {
            "id" = "L5IAXEaz";
            "file" = "waystones-fabric-1.21.1-21.1.44.jar";
            "hash" = "sha512-HODNrdftQxOYPDH7Hs77zVzbU86xdpOAKmX+0opWhkXF0FKKKMGf4/3P4legE0JhBOcsiHBkVUc6ww9SthFR+A==";
        };
        _kcpLmG41 = {
            "id" = "kcpLmG41";
            "file" = "waystones-fabric-1.21.1-21.1.45.jar";
            "hash" = "sha512-AnYSRfvQ+8ht530KLh69euvSJj6DpZgkbMM5oSXfNDpTWD615njrEckTGA/s6vvhbWnqLYi02mXVdUQWLSoQaA==";
        };
        _TUYahGNK = {
            "id" = "TUYahGNK";
            "file" = "waystones-forge-1.21.1-21.1.45.jar";
            "hash" = "sha512-IzJSFWIxV9AM7N686ACFHvkfci7gfuAg+ydKl0HBSJp7mh0BsFkVEdSLLlEhEqh9V4AAQcIG5VARLrqtxU41+w==";
        };
        _Is55014l = {
            "id" = "Is55014l";
            "file" = "waystones-neoforge-1.21.1-21.1.45.jar";
            "hash" = "sha512-SV3NZ/ZysEowdMDWtj+z01wixhoALlBAZSa8TrKuhe/6f6g43aLkMqV2Jr/EhOlelBNI2BKI2RLiyvfrl756JQ==";
        };
        _UKjvFJAV = {
            "id" = "UKjvFJAV";
            "file" = "waystones-fabric-26.3-26.3.0.1.jar";
            "hash" = "sha512-ucCYcrYPeN1qN7qjKoZoIbhM1zhuLqLu1kGs3DH9JjWnCiK+gAbD+e5d5JX1Y8sZFaKhtoZLuuy4bJB8W0xq4g==";
        };
        _LJsZudo0 = {
            "id" = "LJsZudo0";
    ...
    in {
        ...
        "fabric-1.20" = _LcO5SBoa;
        "fabric-1.20.1" = _LcO5SBoa;
        ...
        "fabric-26.1.2" = _YgvCsKWn;
        "fabric-26.2" = _HUacBshD;
        "fabric-26.3" = _UKjvFJAV;
        ...
        "forge-1.20" = _Y0IgdaoP;
        "forge-1.20.1" = _Y0IgdaoP;
        ...
        "neoforge-26.1.2" = _VaeMtOuU;
        "neoforge-26.2" = _Ywwtd3W2;
        "neoforge-26.3" = _LJsZudo0;
        "pkg-11.0.0+fabric-1.19" = _k3DOCgDP;
        "pkg-11.0.0+forge-1.19" = _rXaeIKfW;
        "pkg-11.0.1+fabric-1.19" = _YcswVezO;
        "pkg-11.1.0+fabric-1.19" = _ERmnQBgT;
        "pkg-11.1.0+forge-1.19" = _2sIhirkG;
        "pkg-12.0.1+fabric-1.19.3" = _h0yESaEd;
        "pkg-12.0.1+forge-1.19.3" = _86lInR6T;
        "pkg-10.1.0+forge-1.18.2" = _FI0DhPtr;
        "pkg-10.1.0+fabric-1.18.2" = _sS8WHVk5;
        "pkg-12.0.2+fabric-1.19.3" = _q1NijjK6;
        "pkg-12.0.2+forge-1.19.3" = _t0xPX5FT;
        "pkg-11.1.1+forge-1.19.1" = _ACyrXeld;
        "pkg-11.1.1+fabric-1.19.1" = _G44v2WcK;
        "pkg-10.1.1+forge-1.18.2" = _WFGUxsrx;
        "pkg-10.1.1+fabric-1.18.2" = _u5nEY4VM;
        "pkg-12.1.0+forge-1.19.3" = _Cg9HRa9l;
        "pkg-11.2.0+forge-1.19.1" = _i9hvXXGQ;
        "pkg-12.1.0+fabric-1.19.3" = _LiB6TXSF;
        "pkg-11.2.0+fabric-1.19.1" = _SR3CAFPG;
        "pkg-10.2.0+fabric-1.18.2" = _peCrStqU;
        "pkg-10.2.0+forge-1.18.2" = _Vmeejp4H;
        "pkg-11.3.0+fabric-1.19.2" = _fMwJEadA;
        "pkg-11.3.0+forge-1.19.2" = _tNtnCHKB;
        "pkg-12.2.0+fabric-1.19.3" = _F1PTJa0K;
        "pkg-12.2.0+forge-1.19.3" = _Ub2DxkkF;
        "pkg-13.0.1+forge-1.19.4" = _N2Kh0K77;
        "pkg-11.3.1+forge-1.19.2" = _2qBDBwvW;
        "pkg-11.3.1+fabric-1.19.2" = _vU94QBQG;
        "pkg-13.0.1+fabric-1.19.4" = _wmNKAOHo;
        "pkg-13.1.0+fabric-1.19.4" = _iZdWcn0V;
        "pkg-13.1.0+forge-1.19.4" = _TFB8MtxI;
        "pkg-11.4.0+forge-1.19.2" = _5oFED6MB;
        "pkg-11.4.0+fabric-1.19.2" = _kA4IuZjx;
        "pkg-10.2.1+fabric-1.18.2" = _ucqZcaDp;
        "pkg-10.2.1+forge-1.18.2" = _VQwfrkis;
        "pkg-14.0.0+fabric-1.20" = _cpUETBLi;
        "pkg-14.0.0+forge-1.20" = _hnALd7fL;
        "pkg-14.0.1+fabric-1.20" = _SO3uXaGQ;
        "pkg-14.0.1+forge-1.20" = _sU9LXzp4;
        "pkg-11.4.1+fabric-1.19.2" = _H960jslF;
        "pkg-11.4.1+forge-1.19.2" = _gRfiP4CM;
        "pkg-14.0.2+fabric-1.20" = _pDItHk3J;
        "pkg-14.0.2+forge-1.20" = _ZlbgF4rR;
        "pkg-15.0.0+fabric-1.20.2" = _zvSaZ3Vl;
        "pkg-15.0.0+forge-1.20.2" = _k7ihGNYk;
        "pkg-15.0.1+forge-1.20.2" = _CxAeBEK9;
        "pkg-15.0.1+fabric-1.20.2" = _pAMqAKDB;
        "pkg-10.2.2+forge-1.18.2" = _tITxj58V;
        "pkg-10.2.2+fabric-1.18.2" = _SG2Z5rvn;
        "pkg-11.4.2+fabric-1.19.2" = _pBOTacL4;
        "pkg-11.4.2+forge-1.19.2" = _SybGnSuC;
        "pkg-14.1.0+fabric-1.20" = _TF747AZ0;
        "pkg-14.1.0+forge-1.20" = _hmpUhm6u;
        "pkg-15.1.0+fabric-1.20.2" = _p9hLeMWG;
        "pkg-15.1.0+forge-1.20.2" = _IyqfRDYe;
        "pkg-15.1.0+neoforge-1.20.2" = _wjTh2h62;
        "pkg-15.1.1+fabric-1.20.2" = _jn8WNtFs;
        "pkg-15.1.1+forge-1.20.2" = _kWMl0dCb;
        "pkg-15.1.1+neoforge-1.20.2" = _3FP3tS79;
        "pkg-15.1.2+fabric-1.20.2" = _vdwOnxQR;
        "pkg-15.1.2+forge-1.20.2" = _68BFoD83;
        "pkg-15.1.2+neoforge-1.20.2" = _DupxKECX;
        "pkg-14.1.1+fabric-1.20" = _4xRwUuNG;
        "pkg-14.1.1+forge-1.20" = _d47GDdJF;
        "pkg-14.1.2+fabric-1.20" = _8LjpgX3g;
        "pkg-14.1.2+forge-1.20" = _njEqTb5j;
        "pkg-15.1.3+fabric-1.20.2" = _UbWvU4sq;
        "pkg-15.1.3+forge-1.20.2" = _djOs9Gd3;
        "pkg-15.1.3+neoforge-1.20.2" = _vn4Cw6Cw;
        "pkg-14.1.3+fabric-1.20" = _36jYwMdH;
        "pkg-14.1.3+forge-1.20" = _TlRV5nuf;
        "pkg-15.2.0+fabric-1.20.2" = _BNUeKNMq;
        "pkg-15.2.0+forge-1.20.2" = _QT4kWPRg;
        "pkg-15.2.0+neoforge-1.20.2" = _dXSpWXb4;
        "pkg-16.0.1+fabric-1.20.4" = _kGaPUdUw;
        "pkg-16.0.1+forge-1.20.4" = _2LW0jpoR;
        "pkg-16.0.1+neoforge-1.20.4" = _LDHHWfww;
        "pkg-16.0.2+fabric-1.20.4" = _47OSNJ6k;
        "pkg-16.0.2+forge-1.20.4" = _Ngl77qPr;
        "pkg-16.0.2+neoforge-1.20.4" = _Vew0maAz;
        "pkg-16.0.3+fabric-1.20.4" = _Y0gzRT5v;
        "pkg-16.0.3+forge-1.20.4" = _YmgVm0Vg;
        "pkg-16.0.3+neoforge-1.20.4" = _swsqwuVk;
        "pkg-16.0.4+fabric-1.20.4" = _5rsvBzQq;
        "pkg-16.0.4+forge-1.20.4" = _SrRi70Ff;
        "pkg-16.0.4+neoforge-1.20.4" = _chhcV3PB;
        "pkg-16.0.5+fabric-1.20.4" = _PLcsWEIi;
        "pkg-16.0.5+forge-1.20.4" = _njKGu08k;
        "pkg-16.0.5+neoforge-1.20.4" = _rOTAiTFe;
        "pkg-17.0.1+fabric-1.20.6" = _6TSWKSQa;
        "pkg-17.0.1+forge-1.20.6" = _8qvPDSKr;
        "pkg-17.0.1+neoforge-1.20.6" = _6sITwJwf;
        "pkg-17.0.2+forge-1.20.6" = _hkW0ENli;
        "pkg-17.0.2+fabric-1.20.6" = _RJZj1nlX;
        "pkg-17.0.2+neoforge-1.20.6" = _3s7K7RYp;
        "pkg-21.0.1+fabric-1.21" = _tFOFXxNF;
        "pkg-21.0.1+forge-1.21" = _fKcBCzwV;
        "pkg-21.0.1+neoforge-1.21" = _59eTyqOw;
        "pkg-21.0.2+forge-1.21" = _ziGshm6R;
        "pkg-21.0.2+fabric-1.21" = _dCTmnsnv;
        "pkg-21.0.2+neoforge-1.21" = _uSWmR65D;
        "pkg-21.0.3+fabric-1.21" = _FX8O3crR;
        "pkg-21.0.3+forge-1.21" = _SPkXt74c;
        "pkg-21.0.3+neoforge-1.21" = _NRC81oFn;
        "pkg-21.0.4+fabric-1.21" = _YyhO1yXN;
        "pkg-21.0.4+forge-1.21" = _CGpMBNbZ;
        "pkg-21.0.4+neoforge-1.21" = _jdBXVE2O;
        "pkg-21.0.5+fabric-1.21" = _nvyptV1m;
        "pkg-21.0.5+forge-1.21" = _BBqcgWtN;
        "pkg-21.0.5+neoforge-1.21" = _O5RNeh44;
        "pkg-21.0.6+fabric-1.21" = _AbGHt1FY;
        "pkg-21.0.6+forge-1.21" = _i9oOUdC9;
        "pkg-21.0.6+neoforge-1.21" = _GVsdvKw9;
        "pkg-21.0.7+fabric-1.21" = _jqkMwqdk;
        "pkg-21.0.7+forge-1.21" = _c8iZDVS3;
        "pkg-14.1.4+fabric-1.20" = _wgUtWmqB;
        "pkg-14.1.4+forge-1.20" = _Rbp8Hzck;
        "pkg-21.0.7+neoforge-1.21" = _PDbJMKhA;
        "pkg-21.0.8+fabric-1.21" = _xvvdZQUn;
        "pkg-21.0.8+forge-1.21" = _LChb7xqe;
        "pkg-21.0.8+neoforge-1.21" = _kUD0wfiH;
        "pkg-21.1.1+fabric-1.21.1" = _pCpQ1Jxr;
        "pkg-21.1.1+forge-1.21.1" = _fuXwIEmK;
        "pkg-21.1.1+neoforge-1.21.1" = _d78zJMTz;
        "pkg-14.1.5+fabric-1.20" = _gazaC8Cz;
        "pkg-14.1.5+forge-1.20" = _W8MOY86K;
        "pkg-21.1.2+fabric-1.21.1" = _12MRAK1g;
        "pkg-21.1.2+forge-1.21.1" = _agNF9HI5;
        "pkg-21.1.2+neoforge-1.21.1" = _5LYADmRZ;
        "pkg-21.1.3+fabric-1.21.1" = _1kyHdLqK;
        "pkg-21.1.3+forge-1.21.1" = _LSofciCD;
        "pkg-21.1.3+neoforge-1.21.1" = _rWyY8Krr;
        "pkg-21.1.4+fabric-1.21.1" = _iG5MoBQU;
        "pkg-21.1.4+neoforge-1.21.1" = _so930FNB;
        "pkg-21.1.4+forge-1.21.1" = _zIH2OLc3;
        "pkg-21.3.1+fabric-1.21.3" = _th5nMBRf;
        "pkg-21.3.1+neoforge-1.21.3" = _mMka9F7z;
        "pkg-21.3.2+fabric-1.21.3" = _5Mp1PzMM;
        "pkg-21.3.2+neoforge-1.21.3" = _yqvPCLkk;
        "pkg-14.1.6+fabric-1.20" = _FOC8o94m;
        "pkg-21.1.5+fabric-1.21.1" = _JPtziByp;
        "pkg-21.1.5+neoforge-1.21.1" = _rdM0bu9h;
        "pkg-21.1.5+forge-1.21.1" = _VrKoSRzq;
        "pkg-14.1.6+forge-1.20" = _5LARDzDl;
        "pkg-21.3.3+fabric-1.21.3" = _Q54cy1iA;
        "pkg-21.3.3+neoforge-1.21.3" = _ro1oNjVL;
        "pkg-21.4.1+fabric-1.21.4" = _mHsEGxpy;
        "pkg-21.4.1+neoforge-1.21.4" = _AIWsfylA;
        "pkg-21.4.2+forge-1.21.4" = _vtzMp7zf;
        "pkg-21.4.3+fabric-1.21.4" = _GXtU6zCb;
        "pkg-21.4.3+neoforge-1.21.4" = _rrEuYCPT;
        "pkg-21.4.3+forge-1.21.4" = _z43b74W7;
        "pkg-21.1.7+fabric-1.21.1" = _28vIQSsa;
        "pkg-21.1.7+neoforge-1.21.1" = _V9L8Yh0Y;
        "pkg-21.1.7+forge-1.21.1" = _YPZk1CIJ;
        "pkg-14.1.7+fabric-1.20" = _4XzAgKUk;
        "pkg-14.1.7+forge-1.20" = _7P5PVCXN;
        "pkg-21.1.8+fabric-1.21.1" = _5UhD1YSy;
        "pkg-21.1.8+forge-1.21.1" = _wGteg316;
        "pkg-21.4.4+fabric-1.21.4" = _YNMHQoX0;
        "pkg-21.1.8+neoforge-1.21.1" = _JMXOTWUp;
        "pkg-21.4.4+neoforge-1.21.4" = _ZJCdplel;
        "pkg-21.4.4+forge-1.21.4" = _nJeLuf20;
        "pkg-14.1.8+fabric-1.20" = _bZcWw7Tf;
        "pkg-14.1.8+forge-1.20" = _HHr3VvKP;
        "pkg-21.1.9+fabric-1.21.1" = _H3aMxyNC;
        "pkg-21.1.9+forge-1.21.1" = _P8BaYqDc;
        "pkg-21.1.9+neoforge-1.21.1" = _c6GG0MrN;
        "pkg-21.4.5+fabric-1.21.4" = _Fy2nGHlF;
        "pkg-21.4.5+forge-1.21.4" = _Wc7F9izf;
        "pkg-21.4.5+neoforge-1.21.4" = _OCclF7Pe;
        "pkg-21.1.10+fabric-1.21.1" = _WD41KfAF;
        "pkg-21.1.10+neoforge-1.21.1" = _26cksoyV;
        "pkg-21.1.10+forge-1.21.1" = _d5GesLwT;
        "pkg-14.1.9+forge-1.20.1" = _AMfhjBey;
        "pkg-14.1.9+fabric-1.20.1" = _uP3VU7si;
        "pkg-21.4.6+fabric-1.21.4" = _jXMPYdnI;
        "pkg-21.4.6+forge-1.21.4" = _cQXiCVOu;
        "pkg-21.4.6+neoforge-1.21.4" = _zqgGCZHB;
        "pkg-1.16.5-7.6.4" = _vUV2WTLr;
        "pkg-21.1.11+neoforge-1.21.1" = _rCEDThbK;
        "pkg-21.1.11+forge-1.21.1" = _GYNtA1xf;
        "pkg-21.1.11+fabric-1.21.1" = _7DbUmANa;
        "pkg-14.1.10+fabric-1.20.1" = _sDou3RJ3;
        "pkg-21.4.7+fabric-1.21.4" = _T1ZBcctO;
        "pkg-21.4.7+neoforge-1.21.4" = _XXYZUzLR;
        "pkg-21.4.7+forge-1.21.4" = _EEYkk5BH;
        "pkg-14.1.10+forge-1.20.1" = _8irGDdJK;
        "pkg-21.1.12+fabric-1.21.1" = _Yj18WfKx;
        "pkg-21.1.12+forge-1.21.1" = _ik3uPwV7;
        "pkg-21.1.12+neoforge-1.21.1" = _dxBDkAjl;
        "pkg-21.4.8+fabric-1.21.4" = _zzQ96RiT;
        "pkg-21.4.8+forge-1.21.4" = _e1gitwMr;
        "pkg-21.4.8+neoforge-1.21.4" = _IXPX8II9;
        "pkg-14.1.11+fabric-1.20.1" = _xp7soos1;
        "pkg-14.1.11+forge-1.20.1" = _WKyfSzs9;
        "pkg-21.1.13+fabric-1.21.1" = _bUmXVpBV;
        "pkg-21.4.9+forge-1.21.4" = _AC5Poa21;
        "pkg-21.4.9+fabric-1.21.4" = _3TtqMkdS;
        "pkg-21.1.13+neoforge-1.21.1" = _UsjWHpLD;
        "pkg-21.1.13+forge-1.21.1" = _Robxh15H;
        "pkg-21.4.9+neoforge-1.21.4" = _6jWoYgVJ;
        "pkg-21.4.10+fabric-1.21.4" = _NaUj93u7;
        "pkg-21.4.10+forge-1.21.4" = _zx1artlX;
        "pkg-21.4.10+neoforge-1.21.4" = _c3nKFqHe;
        "pkg-21.5.1+neoforge-1.21.5" = _MwbnNrEP;
        "pkg-21.5.1+fabric-1.21.5" = _ca46XnXg;
        "pkg-21.5.2+forge-1.21.5" = _47GjmlC0;
        "pkg-21.4.11+fabric-1.21.4" = _wIhaBXAv;
        "pkg-21.4.11+forge-1.21.4" = _P25etPEE;
        "pkg-21.4.11+neoforge-1.21.4" = _A0W0G71O;
        "pkg-21.1.15+fabric-1.21.1" = _1ocFYaTS;
        "pkg-21.1.15+neoforge-1.21.1" = _S7CoS4PM;
        "pkg-21.1.15+forge-1.21.1" = _6IgZFeUh;
        "pkg-21.5.3+fabric-1.21.5" = _Fj4AuLMh;
        "pkg-21.4.12+fabric-1.21.4" = _HhZyz0Sd;
        "pkg-21.1.16+fabric-1.21.1" = _754pSuws;
        "pkg-21.1.17+fabric-1.21.1" = _YjMVj2aI;
        "pkg-21.1.17+neoforge-1.21.1" = _PV22OGX5;
        "pkg-21.1.17+forge-1.21.1" = _URfsQU4U;
        "pkg-21.4.13+fabric-1.21.4" = _o7junfFC;
        "pkg-21.4.13+forge-1.21.4" = _Piq6mu7q;
        "pkg-21.5.4+fabric-1.21.5" = _Ilo10X66;
        "pkg-21.4.13+neoforge-1.21.4" = _dpBFBSht;
        "pkg-21.5.4+forge-1.21.5" = _2Xrgb0p2;
        "pkg-21.5.4+neoforge-1.21.5" = _rCxvFaNM;
        "pkg-14.1.12+fabric-1.20.1" = _C58OV2js;
        "pkg-14.1.12+forge-1.20.1" = _rxfQI36N;
        "pkg-21.4.14+fabric-1.21.4" = _qIIDi9oK;
        "pkg-21.1.18+fabric-1.21.1" = _nIcT6ztO;
        "pkg-21.4.14+forge-1.21.4" = _srmrxRaz;
        "pkg-21.4.14+neoforge-1.21.4" = _h8dFTrNY;
        "pkg-21.1.18+forge-1.21.1" = _7dlwkMTn;
        "pkg-21.1.18+neoforge-1.21.1" = _3Wo2Zg2r;
        "pkg-21.5.5+fabric-1.21.5" = _fIeWu1PC;
        "pkg-21.5.5+forge-1.21.5" = _xM39c6kc;
        "pkg-21.5.5+neoforge-1.21.5" = _Gaf6mZoV;
        "pkg-14.1.13+fabric-1.20.1" = _Q7vns7oI;
        "pkg-21.5.6+fabric-1.21.5" = _uwws04jR;
        "pkg-21.5.6+forge-1.21.5" = _RYe9tkpA;
        "pkg-14.1.13+forge-1.20.1" = _8Mw54W1S;
        "pkg-21.1.19+forge-1.21.1" = _KLMZ7UQT;
        "pkg-21.5.6+neoforge-1.21.5" = _7w927aD5;
        "pkg-21.1.19+fabric-1.21.1" = _5QbmQMeD;
        "pkg-21.4.15+fabric-1.21.4" = _VjzW8Q1w;
        "pkg-21.4.15+forge-1.21.4" = _4TupwVbI;
        "pkg-21.1.19+neoforge-1.21.1" = _zKuhJ4Vo;
        "pkg-21.4.15+neoforge-1.21.4" = _r7qJAipW;
        "pkg-21.5.7+fabric-1.21.5" = _kL2KV02Y;
        "pkg-21.5.7+forge-1.21.5" = _ykhGfKuh;
        "pkg-21.5.7+neoforge-1.21.5" = _IkHpHirF;
        "pkg-21.6.1+fabric-1.21.6" = _MXoEdE8m;
        "pkg-21.6.1+neoforge-1.21.6" = _3KSnBC2i;
        "pkg-21.6.2+forge-1.21.6" = _oQ3mY4nC;
        "pkg-21.7.1+fabric-1.21.7" = _Aq9lKvYL;
        "pkg-21.7.1+neoforge-1.21.7" = _CYru1h3x;
        "pkg-21.7.1+forge-1.21.7" = _gwsTSrX2;
        "pkg-14.1.14+fabric-1.20.1" = _aYWhLlbJ;
        "pkg-21.1.20+fabric-1.21.1" = _YwO3nB2v;
        "pkg-14.1.14+forge-1.20.1" = _hUQ6a1gp;
        "pkg-21.1.20+forge-1.21.1" = _niXLMkAQ;
        "pkg-21.1.20+neoforge-1.21.1" = _MpndwqAs;
        "pkg-21.7.2+fabric-1.21.7" = _4J6CmdiE;
        "pkg-21.7.2+forge-1.21.7" = _zEBkZhTH;
        "pkg-21.4.16+fabric-1.21.4" = _aSwbJf20;
        "pkg-21.7.2+neoforge-1.21.7" = _Zp8buxPh;
        "pkg-21.4.16+forge-1.21.4" = _87a1ldH4;
        "pkg-21.4.16+neoforge-1.21.4" = _RCyTcDJ1;
        "pkg-21.5.8+fabric-1.21.5" = _mMhr96r2;
        "pkg-21.5.8+forge-1.21.5" = _Vipdrduy;
        "pkg-21.5.8+neoforge-1.21.5" = _mMkV6Fbp;
        "pkg-14.1.15+fabric-1.20.1" = _6VHEuV0k;
        "pkg-14.1.15+forge-1.20.1" = _PaSAsEfP;
        "pkg-21.8.1+fabric-1.21.8" = _N6KPgzOH;
        "pkg-21.8.1+neoforge-1.21.8" = _pN8f9HNi;
        "pkg-21.8.1+forge-1.21.8" = _BZkay3MN;
        "pkg-14.1.16+forge-1.20.1" = _ThZS9WOo;
        "pkg-14.1.16+fabric-1.20.1" = _ri0lPSAm;
        "pkg-21.1.21+fabric-1.21.1" = _OeyhCZFM;
        "pkg-21.4.17+fabric-1.21.4" = _uBGzTrSr;
        "pkg-21.1.21+neoforge-1.21.1" = _h39ARPtF;
        "pkg-21.4.17+forge-1.21.4" = _apMYa7rO;
        "pkg-21.1.21+forge-1.21.1" = _1w1ype1G;
        "pkg-21.4.17+neoforge-1.21.4" = _sHi2Af6L;
        "pkg-21.8.2+fabric-1.21.8" = _q7Xw8tAQ;
        "pkg-21.8.2+forge-1.21.8" = _I2rPNbfJ;
        "pkg-21.5.9+fabric-1.21.5" = _zw0Jl7KV;
        "pkg-21.8.2+neoforge-1.21.8" = _EWs4Asvd;
        "pkg-21.5.9+forge-1.21.5" = _Z6Vm0Udu;
        "pkg-21.5.9+neoforge-1.21.5" = _c2e11E8L;
        "pkg-21.5.10+fabric-1.21.5" = _T2plw3tZ;
        "pkg-21.1.22+fabric-1.21.1" = _eO18AQbh;
        "pkg-21.4.18+fabric-1.21.4" = _B3tC56vT;
        "pkg-21.1.22+forge-1.21.1" = _hw2iEIcK;
        "pkg-21.1.22+neoforge-1.21.1" = _qswlurGa;
        "pkg-21.5.10+forge-1.21.5" = _sP8jr2fl;
        "pkg-21.5.10+neoforge-1.21.5" = _7KcpxbeC;
        "pkg-21.4.18+neoforge-1.21.4" = _3GCdV1m2;
        "pkg-21.8.3+forge-1.21.8" = _nJLtzEBm;
        "pkg-21.8.3+fabric-1.21.8" = _tg7FAa4Z;
        "pkg-21.4.18+forge-1.21.4" = _G5cWbPJE;
        "pkg-21.8.3+neoforge-1.21.8" = _hcOQ0ypl;
        "pkg-14.1.17+fabric-1.20.1" = _USFFIy4C;
        "pkg-14.1.17+forge-1.20.1" = _WozH13dr;
        "pkg-21.4.19+fabric-1.21.4" = _rgbIrxOX;
        "pkg-21.1.23+fabric-1.21.1" = _kgXi5E7a;
        "pkg-21.1.23+forge-1.21.1" = _4O4P1YRV;
        "pkg-21.4.19+forge-1.21.4" = _EiCVNDa5;
        "pkg-21.4.19+neoforge-1.21.4" = _fuEeXjq1;
        "pkg-21.1.23+neoforge-1.21.1" = _oM0RXGC6;
        "pkg-21.8.4+fabric-1.21.8" = _TfggxplW;
        "pkg-21.8.4+neoforge-1.21.8" = _2bkDGwcy;
        "pkg-21.8.4+forge-1.21.8" = _OyIvAzwc;
        "pkg-21.5.11+forge-1.21.5" = _EsPM9Ldb;
        "pkg-21.5.11+fabric-1.21.5" = _OvdGcDja;
        "pkg-21.5.11+neoforge-1.21.5" = _Vp0qg9ml;
        "pkg-21.8.5+neoforge-1.21.8" = _mT9mtsiC;
        "pkg-21.8.5+forge-1.21.8" = _oNEeAUmj;
        "pkg-21.8.5+fabric-1.21.8" = _jPsizyXy;
        "pkg-21.9.1+fabric-1.21.9" = _XJD23521;
        "pkg-21.9.1+neoforge-1.21.9" = _GojcTfq1;
        "pkg-21.9.2+fabric-1.21.9" = _117bXtCF;
        "pkg-21.9.2+neoforge-1.21.9" = _HsyHHjCT;
        "pkg-21.10.1+forge-1.21.10" = _AGjoIwvU;
        "pkg-21.10.1+fabric-1.21.10" = _aaG9QWmB;
        "pkg-21.10.1+neoforge-1.21.10" = _GA7jWeoP;
        "pkg-21.10.2+fabric-1.21.10" = _GnM574mT;
        "pkg-21.10.2+neoforge-1.21.10" = _LDgCy9Dq;
        "pkg-21.10.2+forge-1.21.10" = _CPLVdb1p;
        "pkg-21.10.3+fabric-1.21.10" = _HOTNXNDm;
        "pkg-21.10.3+forge-1.21.10" = _GupbSqx6;
        "pkg-21.10.3+neoforge-1.21.10" = _dOw9KmGu;
        "pkg-21.1.24+fabric-1.21.1" = _SSwc4EdC;
        "pkg-21.1.24+forge-1.21.1" = _ahVLJRkN;
        "pkg-21.1.24+neoforge-1.21.1" = _ImHW5I5r;
        "pkg-21.10.4+fabric-1.21.10" = _KerTOSpd;
        "pkg-21.10.4+forge-1.21.10" = _lcfsmMXR;
        "pkg-21.10.4+neoforge-1.21.10" = _QQ1BGRyH;
        "pkg-21.11.2+fabric-1.21.11" = _S8zjtnTn;
        "pkg-21.11.2+neoforge-1.21.11" = _NEYAXfAI;
        "pkg-21.1.25+fabric-1.21.1" = _VdAnzzFj;
        "pkg-21.1.25+forge-1.21.1" = _R7WEszVO;
        "pkg-21.1.25+neoforge-1.21.1" = _f4A1aY3t;
        "pkg-21.10.5+fabric-1.21.10" = _ftCxiLY9;
        "pkg-21.10.5+neoforge-1.21.10" = _vHNilG6J;
        "pkg-21.11.4+fabric-1.21.11" = _MXw10FSq;
        "pkg-21.11.4+forge-1.21.11" = _iVipWFVv;
        "pkg-21.11.4+neoforge-1.21.11" = _neK41SQx;
        "pkg-21.10.5+forge-1.21.10" = _PcE7XbYH;
        "pkg-14.1.18+fabric-1.20.1" = _lnWg020B;
        "pkg-14.1.18+forge-1.20.1" = _Z7sBfgIR;
        "pkg-21.11.5+fabric-1.21.11" = _xgpoRk1M;
        "pkg-21.11.5+forge-1.21.11" = _IUNfsyUT;
        "pkg-21.11.5+neoforge-1.21.11" = _nnFSShqK;
        "pkg-21.1.26+fabric-1.21.1" = _4kYQEiFS;
        "pkg-21.1.26+neoforge-1.21.1" = _WF7RddDj;
        "pkg-21.1.26+forge-1.21.1" = _E6LIYfXE;
        "pkg-21.1.27+fabric-1.21.1" = _iemNwSsG;
        "pkg-21.1.27+neoforge-1.21.1" = _xMz5Hial;
        "pkg-21.1.27+forge-1.21.1" = _Wl1EaOoN;
        "pkg-14.1.19+fabric-1.20.1" = _LHID8HOT;
        "pkg-14.1.19+forge-1.20.1" = _vRjmrMsl;
        "pkg-21.11.6+fabric-1.21.11" = _bV31WsiH;
        "pkg-21.11.6+forge-1.21.11" = _GiwrrkZR;
        "pkg-21.11.6+neoforge-1.21.11" = _wdjGG3c4;
        "pkg-21.11.7+fabric-1.21.11" = _D59fqO7W;
        "pkg-21.11.7+forge-1.21.11" = _PP2c8ziC;
        "pkg-21.11.7+neoforge-1.21.11" = _grMklHqy;
        "pkg-21.1.28+fabric-1.21.1" = _LSIZDmlE;
        "pkg-14.1.20+fabric-1.20.1" = _qHh09oyJ;
        "pkg-21.1.28+neoforge-1.21.1" = _ShK7Iy1S;
        "pkg-21.1.28+forge-1.21.1" = _6oYEkNlU;
        "pkg-14.1.20+forge-1.20.1" = _sKoHLGbK;
        "pkg-21.11.8+fabric-1.21.11" = _eK2mcF5B;
        "pkg-21.11.8+forge-1.21.11" = _NBiEPc0I;
        "pkg-21.11.8+neoforge-1.21.11" = _SJrDRkMB;
        "pkg-21.1.29+fabric-1.21.1" = _hCuFNT3X;
        "pkg-21.1.29+neoforge-1.21.1" = _Ayolso4x;
        "pkg-21.1.29+forge-1.21.1" = _K3LI78Ed;
        "pkg-21.11.9+fabric-1.21.11" = _MydMW2TT;
        "pkg-21.11.9+forge-1.21.11" = _7TZJIsSn;
        "pkg-21.11.9+neoforge-1.21.11" = _z7behAlZ;
        "pkg-21.1.30+fabric-1.21.1" = _rojCNyJG;
        "pkg-21.1.30+neoforge-1.21.1" = _ylfzux81;
        "pkg-21.1.30+forge-1.21.1" = _l6RsMQLk;
        "pkg-21.1.32+forge-1.21.1" = _vMuWdBov;
        "pkg-21.1.32+fabric-1.21.1" = _Bghap715;
        "pkg-21.1.32+neoforge-1.21.1" = _4KYyPrDB;
        "pkg-21.1.33+forge-1.21.1" = _Pb4kCKpJ;
        "pkg-21.1.33+fabric-1.21.1" = _rR5i70Pd;
        "pkg-21.1.33+neoforge-1.21.1" = _PXntW965;
        "pkg-26.1.2.3+fabric-26.1.2" = _USJUMJNQ;
        "pkg-26.1.2.3+neoforge-26.1.2" = _cqcj5XA9;
        "pkg-26.1.2.4+fabric-26.1.2" = _crPXnQlJ;
        "pkg-26.1.2.4+neoforge-26.1.2" = _FzL1odRG;
        "pkg-26.1.2.5+fabric-26.1.2" = _A0mf0Qfe;
        "pkg-26.1.2.5+neoforge-26.1.2" = _RJUrDOyX;
        "pkg-21.1.34+forge-1.21.1" = _gJul4EYG;
        "pkg-21.1.34+fabric-1.21.1" = _h6AyNItT;
        "pkg-21.1.34+neoforge-1.21.1" = _CfDlUc6j;
        "pkg-26.2.0.1+fabric-26.2" = _mUndnFOa;
        "pkg-26.2.0.1+neoforge-26.2" = _TZQzYzpm;
        "pkg-26.1.2.6+fabric-26.1.2" = _t5tm0XMT;
        "pkg-26.1.2.6+neoforge-26.1.2" = _BlT0cRmo;
        "pkg-26.2.0.2+neoforge-26.2" = _TA42Huji;
        "pkg-26.2.0.2+fabric-26.2" = _FbrWmnxI;
        "pkg-26.1.2.7+fabric-26.1.2" = _O0cNtogH;
        "pkg-26.1.2.7+neoforge-26.1.2" = _zsD4SeIf;
        "pkg-26.1.2.8+fabric-26.1.2" = _738pxxN2;
        "pkg-26.1.2.8+neoforge-26.1.2" = _4oUzKyUJ;
        "pkg-26.2.0.3+fabric-26.2" = _hik3lvh8;
        "pkg-26.2.0.3+neoforge-26.2" = _JBdf58nm;
        "pkg-21.1.35+forge-1.21.1" = _xxYkWzyx;
        "pkg-21.1.35+neoforge-1.21.1" = _HH6C048t;
        "pkg-21.1.35+fabric-1.21.1" = _CxLc6vVg;
        "pkg-21.1.36+forge-1.21.1" = _dwWotk6d;
        "pkg-21.1.36+fabric-1.21.1" = _sj1O4rl4;
        "pkg-21.1.36+neoforge-1.21.1" = _1Z4G2Vgg;
        "pkg-26.1.2.9+fabric-26.1.2" = _jROI9WDP;
        "pkg-26.1.2.9+neoforge-26.1.2" = _62JOf3vq;
        "pkg-26.2.0.4+fabric-26.2" = _NLm5zPDQ;
        "pkg-26.2.0.4+neoforge-26.2" = _VO3iFjND;
        "pkg-21.1.37+forge-1.21.1" = _VZLIbfey;
        "pkg-21.1.37+neoforge-1.21.1" = _az73Oero;
        "pkg-21.1.37+fabric-1.21.1" = _Ub2AL65v;
        "pkg-26.2.0.5+fabric-26.2" = _TTs5sRpX;
        "pkg-26.2.0.5+neoforge-26.2" = _kOgpHdgA;
        "pkg-26.1.2.10+fabric-26.1.2" = _d692oI9e;
        "pkg-26.1.2.10+neoforge-26.1.2" = _IfguyX0r;
        "pkg-21.1.38+forge-1.21.1" = _sVhfqOtv;
        "pkg-21.1.38+fabric-1.21.1" = _cY8OPPXs;
        "pkg-21.1.38+neoforge-1.21.1" = _OL8Mnbav;
        "pkg-21.1.39+forge-1.21.1" = _66YE1eGB;
        "pkg-21.1.39+fabric-1.21.1" = _fOLqG9Y1;
        "pkg-21.1.39+neoforge-1.21.1" = _9lyx0L72;
        "pkg-26.1.2.11+fabric-26.1.2" = _VjI4nUP2;
        "pkg-26.1.2.11+neoforge-26.1.2" = _dAul1nfn;
        "pkg-26.2.0.6+fabric-26.2" = _7yziLAit;
        "pkg-26.2.0.6+neoforge-26.2" = _qlMvcfsw;
        "pkg-21.1.40+forge-1.21.1" = _yoIvi7IA;
        "pkg-21.1.40+fabric-1.21.1" = _y2ypoQsG;
        "pkg-21.1.40+neoforge-1.21.1" = _u7m5EznS;
        "pkg-26.1.2.12+fabric-26.1.2" = _jIhstryV;
        "pkg-26.2.0.7+fabric-26.2" = _grpTenJz;
        "pkg-26.1.2.12+neoforge-26.1.2" = _FXcUHoaf;
        "pkg-26.2.0.7+neoforge-26.2" = _CUOrAFzh;
        "pkg-21.1.41+fabric-1.21.1" = _qtRSzbaZ;
        "pkg-21.1.41+neoforge-1.21.1" = _fxszxKRW;
        "pkg-26.2.0.8+neoforge-26.2" = _IeaT1VS0;
        "pkg-21.1.41+forge-1.21.1" = _AUdyUW8e;
        "pkg-26.2.0.8+fabric-26.2" = _1fyuQx3K;
        "pkg-26.1.2.13+fabric-26.1.2" = _WBkjBJ2d;
        "pkg-26.1.2.13+neoforge-26.1.2" = _wv319e52;
        "pkg-26.1.2.14+fabric-26.1.2" = _F4vZ8CXb;
        "pkg-26.1.2.14+neoforge-26.1.2" = _UDYNfgg8;
        "pkg-26.2.0.9+neoforge-26.2" = _94TIf5SG;
        "pkg-26.2.0.9+fabric-26.2" = _5lrxhmSm;
        "pkg-21.1.42+forge-1.21.1" = _CciIsxpw;
        "pkg-21.1.42+fabric-1.21.1" = _Ado0lAPN;
        "pkg-21.1.42+neoforge-1.21.1" = _1gzy0HSm;
        "pkg-26.1.2.15+fabric-26.1.2" = _FTqmHV0f;
        "pkg-26.1.2.15+neoforge-26.1.2" = _dCxil648;
        "pkg-26.2.0.11+neoforge-26.2" = _wX9fdARw;
        "pkg-26.2.0.11+fabric-26.2" = _jWQQgSGF;
        "pkg-14.1.21+fabric-1.20.1" = _LcO5SBoa;
        "pkg-14.1.21+forge-1.20.1" = _Y0IgdaoP;
        "pkg-26.1.2.16+fabric-26.1.2" = _YgvCsKWn;
        "pkg-26.2.0.12+neoforge-26.2" = _Ywwtd3W2;
        "pkg-26.1.2.16+neoforge-26.1.2" = _VaeMtOuU;
        "pkg-26.2.0.12+fabric-26.2" = _HUacBshD;
        "pkg-21.1.44+forge-1.21.1" = _nB37Oycg;
        "pkg-21.1.44+neoforge-1.21.1" = _XKHZmiJm;
        "pkg-21.1.44+fabric-1.21.1" = _L5IAXEaz;
        "pkg-21.1.45+fabric-1.21.1" = _kcpLmG41;
        "pkg-21.1.45+forge-1.21.1" = _TUYahGNK;
