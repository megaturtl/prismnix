...
let
    versions = (let
        ...
        _NkiWZMwV = {
            "id" = "NkiWZMwV";
            "file" = "Orbital Strike Cannon v11.zip";
            "hash" = "sha512-pB3NoDbtFezmd/0EMiU/Gwaf54egREXjr8pxHECQ8CFupHjtAad8uRJUtBIMvJe6B4e957mCFMNiHWUXbQqwdg==";
        };
        _GFDvNInS = {
            "id" = "GFDvNInS";
            "file" = "orbital-strike-cannon-datapack-11.jar";
            "hash" = "sha512-/nHxMuH0vQJxqw+OwynXbY4RpiJaGRqOyL+MSRovq+je2c/MczeTHiMqn6cFQD1QHgRfaGsdJT8oXmtQ3Jf+/Q==";
        };
        _euVbyDtF = {
            "id" = "euVbyDtF";
            "file" = "Orbital Strike Cannon v11.0.zip";
            "hash" = "sha512-urkILv18jjde2Si3lUQyZ/39W+P95VBY2eq3RWT1sMkvmpXT6Hz6yu3mnsYYSIe3bNwSNAjSnNTeI3Ct3+/fVw==";
        };
        _T8pnRFhk = {
            "id" = "T8pnRFhk";
            "file" = "orbital-strike-cannon-datapack-11.0.jar";
            "hash" = "sha512-A0bbr51aU54umPFqJDhrGByza6zcTlhV+q3wyE+9rpZ6IRHhpM7bbev4frZ1/ZTSwgsSLerp1ln61JtqyYFSfw==";
        };
    in {
        "l0LincWd" = _l0LincWd;
        "HoVQByok" = _HoVQByok;
        ...
        "euVbyDtF" = _euVbyDtF;
        "T8pnRFhk" = _T8pnRFhk;
        "datapack-1.21.9" = _euVbyDtF;
        "datapack-1.21.10" = _euVbyDtF;
        "datapack-1.21.11" = _euVbyDtF;
        "datapack-26.1" = _euVbyDtF;
        "datapack-26.1.1" = _euVbyDtF;
        "datapack-26.1.2" = _euVbyDtF;
        "datapack-26.2" = _euVbyDtF;
        "fabric-1.21.9" = _T8pnRFhk;
        "fabric-1.21.10" = _T8pnRFhk;
        "fabric-1.21.11" = _T8pnRFhk;
        "fabric-26.1" = _T8pnRFhk;
        "fabric-26.1.1" = _T8pnRFhk;
        "fabric-26.1.2" = _T8pnRFhk;
        "fabric-26.2" = _T8pnRFhk;
        "forge-1.21.9" = _T8pnRFhk;
        "forge-1.21.10" = _T8pnRFhk;
        "forge-1.21.11" = _T8pnRFhk;
        "forge-26.1" = _T8pnRFhk;
        "forge-26.1.1" = _T8pnRFhk;
        "forge-26.1.2" = _T8pnRFhk;
        "forge-26.2" = _T8pnRFhk;
        "neoforge-1.21.9" = _T8pnRFhk;
        "neoforge-1.21.10" = _T8pnRFhk;
        "neoforge-1.21.11" = _T8pnRFhk;
        "neoforge-26.1" = _T8pnRFhk;
        "neoforge-26.1.1" = _T8pnRFhk;
        "neoforge-26.1.2" = _T8pnRFhk;
        "neoforge-26.2" = _T8pnRFhk;
        "quilt-1.21.9" = _T8pnRFhk;
        "quilt-1.21.10" = _T8pnRFhk;
        "quilt-1.21.11" = _T8pnRFhk;
        "quilt-26.1" = _T8pnRFhk;
        "quilt-26.1.1" = _T8pnRFhk;
        "quilt-26.1.2" = _T8pnRFhk;
        "quilt-26.2" = _T8pnRFhk;
        "pkg-1.0" = _l0LincWd;
        "pkg-2.0" = _HoVQByok;
        "pkg-3.0" = _ViJbB3kN;
        "pkg-4.0" = _JO9aYej0;
        ...
        "pkg-6.0" = _fxArx2OO;
        "pkg-7.0" = _tFtq2InW;
        "pkg-7.0+mod" = _9sT4ShvP;
        "pkg-7.5" = _ANKL8T9V;
        "pkg-7.5+mod" = _eAGekXJc;
        "pkg-v8" = _uFzaQBEW;
        "pkg-v8+mod" = _vOmnLRLq;
        "pkg-8.5" = _rf3maf0V;
        "pkg-8.5+mod" = _VmJNOFqc;
        "pkg-8.6" = _i3Kp7wxH;
        "pkg-8.6+mod" = _YkvEkKiS;
        "pkg-9.0" = _M3CpoKya;
        "pkg-9.0+mod" = _wepRyOsj;
        "pkg-9.5" = _PwNXuz17;
        "pkg-9.5+mod" = _orEdilpy;
        "pkg-10" = _K3RkjZT7;
        "pkg-10+mod" = _sOxbhOZT;
        "pkg-9.6" = _em3QFKSu;
        "pkg-9.6+mod" = _5CLId1ED;
        "pkg-10.5" = _GmSOidle;
        "pkg-10.5+mod" = _igZJl8da;
        "pkg-11" = _NkiWZMwV;
        "pkg-11+mod" = _GFDvNInS;
        "pkg-11.0" = _euVbyDtF;
        "pkg-11.0+mod" = _T8pnRFhk;
        "default" = _T8pnRFhk;
    });
