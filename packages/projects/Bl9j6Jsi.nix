...
let
    versions = (let
        ...
        _OqTKJi7Y = {
            "id" = "OqTKJi7Y";
            "file" = "translatorpp-2.6.1+fabric-1.20.1.jar";
            "hash" = "sha512-XltVSqJ3yo8E0ReCoqS0IaHEJ0N6L1fb7SjjsdKazabk47RO50HBNbDz9BgXpjYntL91r5WMSlRoAsG9mU/uDg==";
        };
        _dVpylwOy = {
            "id" = "dVpylwOy";
            "file" = "translatorpp-2.6.1+forge-1.20.1.jar";
            "hash" = "sha512-dFXJsuDpBRQn/Xb3bcSX0uFvkn779H8a+LgL3HIou3pDjGGbCoUSBIbtPu/qlsB7kJjbj/EqnwL0/AccWGhVvg==";
        };
        _Ht1fOlBU = {
            "id" = "Ht1fOlBU";
            "file" = "translatorpp-2.6.1+neoforge-26.2.jar";
            "hash" = "sha512-iA0SGcasiac9GXV9VmbNwvxI5V7skmdWY54qSdUOLwSg0XqBgDFwVNI5zkaGP0N63Ea5Q9GkSg9oQyGRJlDl/A==";
        };
        _dI7KMaIC = {
            "id" = "dI7KMaIC";
            "file" = "translatorpp-2.6.1+fabric-26.2.jar";
            "hash" = "sha512-6Fg31cwcflkfv/ck8NQYN4vjuR9T3g//vi58ITMj2umz/PM6alLSKYwxGbEV+jkC9+aF93/xBhCwgAL9LYKeng==";
        };
    in {
        "oJ39KOKh" = _oJ39KOKh;
        "Xy8RZg4Z" = _Xy8RZg4Z;
        ...
        "fabric-1.20" = _OqTKJi7Y;
        "fabric-1.20.1" = _OqTKJi7Y;
        ...
        "quilt-1.20" = _OqTKJi7Y;
        "quilt-1.20.1" = _OqTKJi7Y;
        ...
        "quilt-26.2" = _dI7KMaIC;
        "forge-1.20" = _dVpylwOy;
        "forge-1.20.1" = _dVpylwOy;
        "forge-1.19" = _hBdqefgS;
        "forge-1.19.1" = _hBdqefgS;
        "forge-1.19.2" = _hBdqefgS;
        "pkg-fabric-1.0.0+1.21.1" = _oJ39KOKh;
        "pkg-neoforge-1.0.0+1.21.1" = _Xy8RZg4Z;
        "pkg-fabric-1.1.1+1.21.1" = _rfzz8Ejj;
        "pkg-neoforge-1.1.1+1.21.1" = _JUJtlvjL;
        "pkg-fabric-1.2.0+1.21.1" = _GBLQhziN;
        "pkg-neoforge-1.2.0+1.21.1" = _CMqmSEvX;
        "pkg-fabric-1.3.0+1.21.5" = _O18Apixg;
        "pkg-neoforge-1.3.0+1.21.5" = _ydKD0JTS;
        "pkg-fabric-1.3.1+1.21.5" = _MgJ5cAyc;
        "pkg-neoforge-1.3.1+1.21.5" = _wpOtkJ1C;
        "pkg-fabric-1.3.1+1.21.6" = _SjyCACVP;
        "pkg-neoforge-1.3.1+1.21.6" = _5jOveDJj;
        "pkg-fabric-1.3.2+1.21.5" = _1K5d3OlA;
        "pkg-neoforge-1.3.2+1.21.5" = _sIhMAtUV;
        "pkg-fabric-1.3.2+1.21.6" = _KrTiyufd;
        "pkg-neoforge-1.3.2+1.21.6" = _ZFM06wYK;
        "pkg-fabric-1.3.3+1.21.6" = _jop5atoS;
        "pkg-fabric-2.0.0+1.21.5" = _yzKwbObl;
        "pkg-neoforge-2.0.0+1.21.5" = _nQU5auKe;
        "pkg-neoforge-2.0.0+1.21.6" = _stRoNA71;
        "pkg-fabric-2.0.0+1.21.6" = _wAQEzwKA;
        "pkg-fabric-2.0.1+1.21.5" = _5VZEPTkm;
        "pkg-neoforge-2.0.1+1.21.5" = _IGOSKpYH;
        "pkg-neoforge-2.0.1+1.21.6" = _VJyzvpeX;
        "pkg-fabric-2.0.1+1.21.6" = _Z2EFjOqI;
        "pkg-fabric-2.1.0+1.21.5" = _Ph1kOP7q;
        "pkg-neoforge-2.1.0+1.21.5" = _tVLMPpN9;
        "pkg-neoforge-2.1.0+1.21.6" = _ogu2N4DX;
        "pkg-fabric-2.1.0+1.21.6" = _XMHCxnHG;
        "pkg-fabric-2.1.0+1.21.10" = _W9TqFgfx;
        "pkg-neoforge-2.1.0+1.21.10" = _ZBpcR51W;
        "pkg-fabric-2.2.0+1.21.0-4" = _y5ONetpj;
        "pkg-neoforge-2.2.0+1.21.0-4" = _R8nVUX3a;
        "pkg-fabric-2.2.0+1.21.6-8" = _Fkzx9QbT;
        "pkg-neoforge-2.2.0+1.21.6-8" = _oXiEXeD6;
        "pkg-fabric-2.2.0+1.21.9-" = _vlTkvCMi;
        "pkg-neoforge-2.2.0+1.21.9-" = _uX4hNqqM;
        "pkg-fabric-2.2.0+1.20.0-1" = _pOpzpVPU;
        "pkg-forge-2.2.0+1.20.0-1" = _ZxM2Tnya;
        "pkg-fabric-2.2.1+1.21.6-8" = _wtgvBG7B;
        "pkg-neoforge-2.2.1+1.21.6-8" = _5wkL2q1G;
        "pkg-fabric-2.2.1+1.21.0-4" = _gd0zoawC;
        "pkg-neoforge-2.2.1+1.21.0-4" = _jVYhYUnh;
        "pkg-fabric-2.2.1+1.20.0-1" = _7uPFwZsm;
        "pkg-forge-2.2.1+1.20.0-1" = _Joy4gZhd;
        "pkg-fabric-2.2.1+1.19.0-2" = _lv7cAagX;
        "pkg-forge-2.2.1+1.19.0-2" = _61HaZqrb;
        "pkg-fabric-2.2.1+1.21.11+" = _AysEjgpU;
        "pkg-neoforge-2.2.1+1.21.11+" = _fZKVpBhs;
        "pkg-fabric-2.2.1+1.21.9-10" = _ZtUKL6Jy;
        "pkg-neoforge-2.2.1+1.21.9-10" = _7B6XZDXy;
        "pkg-fabric-2.2.2+1.21.11+" = _vuHVnAwa;
        "pkg-neoforge-2.2.2+1.21.11+" = _uv2Ay68W;
        "pkg-fabric-2.2.3+1.21.0-4" = _fjhs7K14;
        "pkg-neoforge-2.2.3+1.21.0-4" = _rlj4SbH3;
        "pkg-fabric-2.2.3+1.21.11+" = _GSlQjcd3;
        "pkg-neoforge-2.2.3+1.21.11+" = _lcqEXf9c;
        "pkg-fabric-2.3.0-beta+1.21.11" = _3amEAI4Q;
        "pkg-neoforge-2.3.0-beta+1.21.11" = _HcWz7wx9;
        "pkg-fabric-2.4.0-beta+1.21.11" = _YrDq8Na6;
        "pkg-neoforge-2.4.0-beta+1.21.11" = _SHJoAP9O;
        "pkg-fabric-2.4.0-beta+1.21.0-4" = _m5Yo3NLg;
        "pkg-neoforge-2.4.0-beta+1.21.0-4" = _1e52yq7a;
        "pkg-fabric-2.4.1-beta+1.21.0-4" = _Q4zlVLLR;
        "pkg-neoforge-2.4.1-beta+1.21.0-4" = _1e4MVMEq;
        "pkg-fabric-2.4.2-beta+1.20.0-1" = _d0GWx1LC;
        "pkg-forge-2.4.2-beta+1.20.0-1" = _3il1hEJi;
        "pkg-fabric-2.4.1-beta+1.21.11" = _dos7oIrt;
        "pkg-neoforge-2.4.1-beta+1.21.11" = _GfFAHDCE;
        "pkg-fabric-2.4.2-beta+1.19.0-2" = _V2VML4QT;
        "pkg-forge-2.4.2-beta+1.19.0-2" = _Zla95vy5;
        "pkg-fabric-2.5.0+1.19.0-2" = _Rxep4UAi;
        "pkg-forge-2.5.0+1.19.0-2" = _hBdqefgS;
        "pkg-fabric-2.5.0+1.20.0-1" = _BuBxchpR;
        "pkg-forge-2.5.0+1.20.0-1" = _HCVKKyYa;
        "pkg-fabric-2.5.0+1.21.0-4" = _vextc9p8;
        "pkg-neoforge-2.5.0+1.21.0-4" = _okkv4T8i;
        "pkg-neoforge-2.5.0+1.21.11" = _n88MBN36;
        "pkg-fabric-2.5.0+1.21.11" = _sk45aEAO;
        "pkg-fabric-2.5.0+26.1.x" = _uHuc7qha;
        "pkg-neoforge-2.5.0+26.1.x" = _uWPZpuM6;
        "pkg-2.6.0+fabric-26.1.x" = _IM8IVvLt;
        "pkg-2.6.0+neoforge-26.1.x" = _alu8X5JT;
        "pkg-2.6.1+fabric-26.1.x" = _UWmwxdpi;
        "pkg-2.6.1+neoforge-26.1.x" = _xLIpZV2h;
        "pkg-2.6.1+fabric-1.21.11" = _yhPZvHDl;
        "pkg-2.6.1+neoforge-1.21.11" = _8ZlnQEU6;
        "pkg-2.6.1+neoforge-1.21.0-4" = _PNkyIQqg;
        "pkg-2.6.1+fabric-1.21.0-4" = _oDMeWgH7;
        "pkg-2.6.1+fabric-1.20.1" = _OqTKJi7Y;
        "pkg-2.6.1+forge-1.20.1" = _dVpylwOy;
        "pkg-2.6.1+neoforge-26.2" = _Ht1fOlBU;
        "pkg-2.6.1+fabric-26.2" = _dI7KMaIC;
        "default" = _dI7KMaIC;
    });
