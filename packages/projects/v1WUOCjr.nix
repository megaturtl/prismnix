...
let
    ...
    in {
        ...
        "pkg-1.1.8" = _wNjIGFvT;
        "pkg-1.1.9" = _ajZRAx2k;
        "pkg-1.1.10" = _I00vuXo2;
        "pkg-1.1.11" = _hYaNukLg;
        "pkg-1.1.12" = _9RXza0pa;
        "pkg-1.1.13" = _6pYHwKX6;
        "pkg-1.1.14" = _7Khu6Ric;
        "pkg-1.1.15" = _BSGyevqG;
        "pkg-1.1.16" = _nqJWX7hV;
        "pkg-1.1.17" = _sKIsuQ8Y;
        "pkg-1.1.18" = _Lvjr33FR;
