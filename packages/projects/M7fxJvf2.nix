...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.2.8" = _7HuvecMe;
        "pkg-1.18.2-1.2.6" = _VEgSs8RI;
        "pkg-1.19.2-1.2.7" = _OI4TjExr;
        "pkg-1.19.4-1.2.9" = _EN75OGVs;
        "pkg-1.20-1.2.9" = _sF7vC61J;
        "pkg-1.20.1-1.2.9" = _hipaWpEE;
        "pkg-1.19.2-1.2.8" = _MEOVMLg4;
        "pkg-1.19.4-1.2.10" = _qCj4Erf8;
        "pkg-1.20-1.2.10" = _d7agzZxe;
        "pkg-1.20.1-1.2.10" = _moiLw7ZR;
        "pkg-1.19.2-1.2.9" = _e8k4ImfE;
        "pkg-1.19.4-1.2.11" = _Le9OkGcA;
