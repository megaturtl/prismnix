...
let
    ...
    in {
        ...
        "minecraft-1.20.2" = _PgtPdi80;
        "minecraft-1.20.3" = _PgtPdi80;
        "minecraft-1.20.4" = _PgtPdi80;
        "minecraft-1.20.5" = _PgtPdi80;
        "minecraft-1.20.6" = _PgtPdi80;
        "minecraft-1.21" = _PgtPdi80;
        "minecraft-1.21.1" = _PgtPdi80;
        "minecraft-1.21.2" = _PgtPdi80;
        "minecraft-1.21.3" = _PgtPdi80;
        "minecraft-1.21.4" = _PgtPdi80;
        "minecraft-1.21.5" = _PgtPdi80;
        "minecraft-1.21.6" = _PgtPdi80;
        "minecraft-1.21.7" = _PgtPdi80;
        "minecraft-1.21.8" = _PgtPdi80;
        "minecraft-1.21.9" = _PgtPdi80;
        "minecraft-1.21.10" = _PgtPdi80;
        "minecraft-1.21.11" = _PgtPdi80;
        "minecraft-1.21.2-pre1" = _gvsCZalR;
        "minecraft-1.21.2-pre2" = _gvsCZalR;
        "minecraft-26.1" = _PgtPdi80;
        "minecraft-26.1.1" = _PgtPdi80;
        "minecraft-26.1.2" = _PgtPdi80;
        "minecraft-26.2" = _PgtPdi80;
        "pkg-1.31" = _MBntcfdj;
        "pkg-1.32" = _TeOD3gz9;
        "pkg-1.33" = _S0Hl9yPd;
        "pkg-1.34" = _Nx8ZFnKI;
