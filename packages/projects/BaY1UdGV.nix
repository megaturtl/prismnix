...
let
    versions = (let
        ...
        _9gV8bMRB = {
            "id" = "9gV8bMRB";
            "file" = "Unique Dark - Lite - 1.16.5.zip";
            "hash" = "sha512-OpmhIDwCare26/cG0zqxxc5HUk9V8RxBrBVL4n2EP50f4ae9J6PXrR4UksH24NwFpvZ9VuYA/VE7wjYSje532A==";
        };
        _tG4atfOq = {
            "id" = "tG4atfOq";
            "file" = "Unique Dark - Lite - 1.18.2.zip";
            "hash" = "sha512-qVg0PuM9ZNAdkwPabK1KThUONEXsMuz+Hcv4moRcZcioD7SSyY7moRezNv8R1nv9vdT7jP9DTpgAdUaeBe53eA==";
        };
        _xWPJsh1A = {
            "id" = "xWPJsh1A";
            "file" = "Unique Dark - Lite - 1.19.2.zip";
            "hash" = "sha512-n8GecY2r/EFituKVzjIw0LBt7SSFDAOGJmMx8n0kOAeggtlmSfkm17xei9EnGQxlRtSbpDpEEgNS7dHSd755Mg==";
        };
        _Hl0za8j6 = {
            "id" = "Hl0za8j6";
            "file" = "Unique Dark - Lite - 1.20.1.zip";
            "hash" = "sha512-kc50VtbJpIJ1n8Fy/7BQL4zdKD4qfPejzrCS2OZ/rk/ASxul3sdgjCdx1jHJ3X3NmybZ0w9cDXDGurGa6ZF53g==";
        };
        _PgtPdi80 = {
            "id" = "PgtPdi80";
            "file" = "Unique Dark - Lite - 1.20.2-26.x.zip";
            "hash" = "sha512-YKwXpiFrTzW3m18E3WaVhredYz4gu9vlHDJSAULEC85UyDAuipJQnrahz1uEXNEyJCNHJTa8F6MFFakmltYf2g==";
        };
        _qVSXehMX = {
            "id" = "qVSXehMX";
            "file" = "Unique Dark - Lite - 1.20.2-26.x.zip";
            "hash" = "sha512-t95tr9Sr7GFozn5rNvgZ86O4z4UbF0eXaKXaFDKjbBoHVUzqvZP1QH6hgnrDYvx1jkTJ+EeLuHrzUsSN8mgfMw==";
        };
    in {
        "qXCG86Jg" = _qXCG86Jg;
        "fbAr1GI6" = _fbAr1GI6;
        ...
        "PgtPdi80" = _PgtPdi80;
        "qVSXehMX" = _qVSXehMX;
        "minecraft-1.16" = _9gV8bMRB;
        "minecraft-1.16.1" = _9gV8bMRB;
        "minecraft-1.16.2" = _9gV8bMRB;
        "minecraft-1.16.3" = _9gV8bMRB;
        "minecraft-1.16.4" = _9gV8bMRB;
        "minecraft-1.16.5" = _9gV8bMRB;
        "minecraft-1.17" = _d0A327cy;
        "minecraft-1.17.1" = _d0A327cy;
        "minecraft-1.18" = _tG4atfOq;
        "minecraft-1.18.1" = _tG4atfOq;
        "minecraft-1.18.2" = _tG4atfOq;
        "minecraft-1.19" = _xWPJsh1A;
        "minecraft-1.19.1" = _xWPJsh1A;
        "minecraft-1.19.2" = _xWPJsh1A;
        "minecraft-1.19.4" = _9eQDYOeT;
        "minecraft-1.20" = _Hl0za8j6;
        "minecraft-1.20.1" = _Hl0za8j6;
        "minecraft-1.20.2" = _qVSXehMX;
        "minecraft-1.20.3" = _qVSXehMX;
        "minecraft-1.20.4" = _qVSXehMX;
        "minecraft-1.20.5" = _qVSXehMX;
        "minecraft-1.20.6" = _qVSXehMX;
        "minecraft-1.21" = _qVSXehMX;
        "minecraft-1.21.1" = _qVSXehMX;
        "minecraft-1.21.2" = _qVSXehMX;
        "minecraft-1.21.3" = _qVSXehMX;
        "minecraft-1.21.4" = _qVSXehMX;
        "minecraft-1.21.5" = _qVSXehMX;
        "minecraft-1.21.6" = _qVSXehMX;
        "minecraft-1.21.7" = _qVSXehMX;
        "minecraft-1.21.8" = _qVSXehMX;
        "minecraft-1.21.9" = _qVSXehMX;
        "minecraft-1.21.10" = _qVSXehMX;
        "minecraft-1.21.11" = _qVSXehMX;
        "minecraft-1.21.2-pre1" = _gvsCZalR;
        "minecraft-1.21.2-pre2" = _gvsCZalR;
        "minecraft-26.1" = _qVSXehMX;
        "minecraft-26.1.1" = _qVSXehMX;
        "minecraft-26.1.2" = _qVSXehMX;
        "minecraft-26.2" = _qVSXehMX;
        "minecraft-26.3" = _qVSXehMX;
        "pkg-1.31" = _MBntcfdj;
        "pkg-1.32" = _TeOD3gz9;
        "pkg-1.33" = _S0Hl9yPd;
        "pkg-1.34" = _Nx8ZFnKI;
