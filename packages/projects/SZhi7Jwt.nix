...
let
    ...
    in {
        ...
        "pkg-1.2.0+1.21" = _6U2pYiyo;
        "pkg-1.2.0+1.21.3" = _e4olxsLR;
        "pkg-1.2.0+1.21.4" = _m6uvtiG1;
        "pkg-1.2.0+1.21.5" = _RFQLY6hL;
        "pkg-1.2.0+1.21.8" = _AWj8jxK0;
        "pkg-1.2.0+1.21.10" = _p4smm14l;
