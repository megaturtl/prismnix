...
let
    versions = (let
        ...
        _p3z2M9AO = {
            "id" = "p3z2M9AO";
            "file" = "goml-1.22.0+26.3-rc-1.jar";
            "hash" = "sha512-nReyA3lCs1INMylJ+lgwGm65i+KyV+wLaC3JyPerrqkEUsVFUV43KoV9stbIM5fTo658JzHvx1RQZDldrhJR4w==";
        };
    in {
        "ERinHdHQ" = _ERinHdHQ;
        "W0ceuNdR" = _W0ceuNdR;
        ...
        "fabric-26.3-rc-1" = _p3z2M9AO;
        "fabric-26.3" = _p3z2M9AO;
        ...
        "pkg-1.5.0-beta.1" = _ERinHdHQ;
        "pkg-1.5.0+beta.2+1.18.2" = _W0ceuNdR;
        "pkg-1.5.0-beta.3+1.18.2" = _WF7Vv1Ho;
        "pkg-1.5.0-beta.4+1.18.2" = _KFgYIDku;
        "pkg-1.5.0-beta.5+1.18.2" = _jHWTWpri;
        "pkg-1.5.0-pre.1+1.18.2" = _UEsEc3O6;
        "pkg-1.5.0-pre.2+1.19" = _hemcnXy3;
        "pkg-1.5.0-pre.3+1.19" = _jdCThxE1;
        "pkg-1.5.0-pre.4+1.19" = _76yK7gbo;
        "pkg-1.5.0-pre.5+1.19.1" = _gavyFBF8;
        "pkg-1.5.0+1.19.2" = _4uEr0SZh;
        "pkg-1.6.0+1.19.2" = _MfDS1xMy;
        "pkg-1.6.1+1.19.2" = _I6E6vvwx;
        "pkg-1.6.2+1.19.2" = _bQeUuky3;
        "pkg-1.7.0+1.19.3" = _pqLuXcwp;
        "pkg-1.6.3+1.19.2" = _XehGpseJ;
        "pkg-1.7.1+1.19.3" = _NUjkyzXL;
        "pkg-1.8.0+1.19.4-rc2" = _7vbOtaVG;
        "pkg-1.7.2+1.19.3" = _VzbQWgvd;
        "pkg-1.8.1+1.19.4-rc3" = _Ct24tmE3;
        "pkg-1.6.4+1.19.2" = _Ij7zNda1;
        "pkg-1.9.0+1.20-rc1" = _nQOmPFeh;
        "pkg-1.9.1+1.20.1" = _SRvkQG9B;
        "pkg-1.9.2+1.20.1" = _BSmpIfjX;
        "pkg-1.10.0+1.20.2-rc2" = _ritmrXx4;
        "pkg-1.9.3+1.20.1" = _2jtKcgAq;
        "pkg-1.10.1+1.20.2" = _9jtOFiwh;
        "pkg-1.9.4+1.20.1" = _GpomY6B1;
        "pkg-1.10.2+1.20.2" = _OJpK1TcB;
        "pkg-`1.11.0`+1.20.3-rc1" = _MyJk3MGt;
        "pkg-1.12.0+1.20.5" = _SMtWpRA4;
        "pkg-1.12.1+1.20.5" = _eqzaNUjY;
        "pkg-1.13.0+1.21-rc1" = _K3NFTG3d;
        "pkg-1.13.1+1.21" = _N4XW15zD;
        "pkg-1.14.0+1.21.2" = _myAS7v7d;
        "pkg-1.14.1+1.21.3" = _HmGO7L3C;
        "pkg-1.15.0+1.21.4-rc3" = _wyrT6ly9;
        "pkg-1.16.0+1.21.5" = _PqcVq0hS;
        "pkg-1.17.0+1.21.6" = _T6grA9qh;
        "pkg-1.17.1+1.21.7" = _WNZ9n53U;
        "pkg-1.18.0+1.21.9-rc1" = _zCWnzrWL;
        "pkg-1.18.1+1.21.10" = _xCAI6UK9;
        "pkg-1.19.0+1.21.11" = _a8TqWfwE;
        "pkg-1.19.1+1.21.11" = _pazGAlr2;
        "pkg-1.20.0+26.1.1" = _8yiFneQM;
        "pkg-1.20.1+26.1.2" = _sP4aeU7I;
        "pkg-1.20.2+26.1.2" = _cNhDEnhe;
        "pkg-1.21.0+26.2" = _ttqMQa3Y;
        "pkg-1.22.0+26.3-rc-1" = _p3z2M9AO;
        "default" = _p3z2M9AO;
    });
