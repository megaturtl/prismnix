...
let
    ...
    in {
        ...
        "pkg-2.2.0" = _PRtO7FA6;
        "pkg-3.0.0" = _3duqOSDX;
        "pkg-4.0.0-alpha.1" = _L6NoXU6X;
        "pkg-4.0.0-alpha.2" = _rQz7yTWD;
        "pkg-4.0.0-beta.1" = _3TPEMUhQ;
        "pkg-4.0.0" = _RPXuWP37;
        "pkg-4.0.1" = _m8zVhHWQ;
        "pkg-5.0.0-beta.1" = _kHXlOhot;
        "pkg-4.0.2" = _HbylQtUY;
        "pkg-5.0.0" = _klpY9GUw;
        "pkg-4.0.3" = _7XbPZVMj;
        "pkg-5.0.1" = _4CnfX4Ni;
        ...
        "pkg-4.0.6" = _Jjr0kRLm;
        "pkg-5.0.8" = _uk1ZXP1m;
        "pkg-5.1.0-beta.1" = _gTpBATjI;
        "pkg-5.1.0-beta.2" = _ymie7XoR;
        "pkg-5.1.0" = _1Wos7JGI;
        "pkg-5.1.1" = _5czOOdgm;
        "pkg-5.2.0-alpha.1" = _Zfl3f3os;
        "pkg-5.2.0-alpha.2" = _ms3JlPHo;
        "pkg-5.2.0-beta.1" = _jKEI9g59;
        "pkg-5.2.0" = _tFWbOQLY;
        "pkg-6.0.0-alpha.1" = _G3tk6U3q;
        "pkg-6.0.0-alpha.2" = _sSP4MYGR;
        "pkg-6.0.0-alpha.3" = _hNWwau8h;
        "pkg-6.0.0-beta.1" = _y8e93bwg;
        "pkg-5.2.1" = _J8rbTKGa;
        "pkg-5.0.9" = _6yrVFgGZ;
        "pkg-5.2.2" = _hMia8hLK;
        "pkg-6.0.0-beta.2" = _qspEdRNm;
        "pkg-6.0.0" = _MOM9OeBI;
        "pkg-5.0.10" = _YFxXxkHn;
        "pkg-5.2.3" = _xyJh17IK;
        "pkg-6.0.1" = _vbqhfsxo;
        "pkg-6.0.2" = _DHhpSKkD;
        "pkg-6.0.3" = _Li3Z12CH;
        "pkg-5.0.11" = _sCRQjLLk;
        "pkg-5.2.4" = _2iJDflHl;
        "pkg-6.0.4" = _Rlozs8sI;
        "pkg-5.2.5" = _dDeTwYYA;
        "pkg-6.0.5" = _qQfK9xRB;
        ...
        "pkg-6.0.9" = _EQkEUx8c;
        "pkg-5.2.6" = _nlMg38w3;
        "pkg-6.0.10" = _V8xdpUMo;
        "pkg-6.1.0-beta.1" = _hKcB5zNx;
        "pkg-6.1.0" = _4n8eEDLY;
        "pkg-6.0.11" = _7JyCbCPi;
        "pkg-6.1.1" = _1OysoazW;
        "pkg-5.0.12" = _Gs1YTW70;
        "pkg-5.2.7" = _yXxQ34NK;
        "pkg-6.0.12" = _d44hM9on;
        "pkg-6.1.2" = _Sp5fDlh1;
        "pkg-6.2.0-beta.1" = _wFyR4K2l;
        "pkg-6.0.13" = _3Q2d6Vf0;
        "pkg-6.1.3" = _cDug1oyP;
        "pkg-6.2.0" = _eFQKGDLf;
        "pkg-5.0.13" = _EI3kvVZ8;
        "pkg-6.3.0-alpha.1" = _cqrTHRrN;
        "pkg-6.3.0-alpha.2" = _5XWYOcyW;
        "pkg-6.3.0-alpha.3" = _qrtjS8hM;
        "pkg-6.3.0-alpha.4" = _LK58ofZw;
        "pkg-6.3.0-alpha.5" = _g0vqSIyf;
        "pkg-6.3.0-beta.1" = _XE7iq8hI;
        "pkg-6.3.0" = _kbGRAiMD;
        "pkg-7.0.0-beta.1" = _ZIOgna0a;
        "pkg-7.0.0-beta.2" = _Zq0SDd0D;
        "pkg-7.0.0" = _HsolkciH;
        "pkg-7.0.1" = _NToKa7WD;
        "pkg-7.1.0-beta.1" = _4Qcnn0uG;
        "pkg-7.1.0" = _i0piWRLt;
        "pkg-7.2.0-beta.1" = _tOUDK09t;
        "pkg-7.2.0" = _mIDDmfhS;
        "pkg-7.2.1" = _Ih96rqKi;
        "pkg-7.3.0-alpha.1" = _3US3hTUm;
        "pkg-7.3.0-alpha.2" = _EUtnbrKO;
        "pkg-7.3.0" = _P2OyDhBG;
        "pkg-7.0.2" = _jr4p04l7;
        "pkg-7.1.1" = _ROMyft7D;
        "pkg-7.2.2" = _tp0s1FFx;
        "pkg-7.3.1" = _veSp4cUv;
        "pkg-7.4.0-alpha.1" = _bzeE8Gav;
        "pkg-7.4.0" = _DLNLeilr;
        "pkg-7.4.1" = _8pJp1FM2;
        "pkg-7.5.0-alpha.1" = _YiosyOhv;
        "pkg-7.0.3" = _h7YX7L4K;
        "pkg-7.1.2" = _SF7JpQqN;
        "pkg-7.2.3" = _BQ5OprMW;
        "pkg-7.3.2" = _Z110PpwO;
        "pkg-7.4.2" = _MPUIg0xG;
        "pkg-7.5.0-beta.1" = _IGxP6GHT;
        "pkg-7.5.0" = _v6IzUhzu;
        "pkg-7.6.0-alpha.1" = _txjn73Q6;
        "pkg-7.6.0-beta.1" = _5y4uAE8k;
        "pkg-7.2.4" = _QCIN2pbY;
        "pkg-7.3.3" = _rgfLXn0J;
        "pkg-7.4.4" = _d5Aal13i;
        "pkg-7.5.1" = _FwsYF0ct;
