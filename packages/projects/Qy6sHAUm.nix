...
let
    ...
    in {
        ...
        "pkg-1.5-forge-1.21.1" = _e0TpG42C;
        "pkg-1.6-forge-26.1" = _AW9tTWMs;
        "pkg-1.6-forge-26.1.1" = _4YnLqErC;
        "pkg-1.6-forge-26.1.2" = _N1er4ixM;
        "pkg-1.8-forge-26.2" = _AAckl1o0;
        "pkg-1.6-neoforge-26.1" = _B8YiPEaS;
        "pkg-1.6-neoforge-26.1.1" = _YFA3yRxF;
        "pkg-1.6-neoforge-26.1.2" = _K0XsGKrT;
        "pkg-1.8-neoforge-26.2" = _4BeZCQgS;
        "pkg-1.5-fabric-1.20.1" = _gvulEHRp;
        "pkg-1.6-fabric-26.1" = _8LD4XG2J;
