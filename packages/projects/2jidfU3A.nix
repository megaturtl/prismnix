...
let
    ...
    in {
        ...
        "pkg-1.2.0-beta" = _PW1QySXi;
        "pkg-1.2.0-beta+fabric" = _N2iKDBoJ;
        "pkg-1.0.0+1.20.5+fabric" = _1iAu8DKe;
        "pkg-1.0.0+1.20.5" = _xviFJAot;
        "pkg-1.1.0+1.21+fabric" = _nytEh7Hm;
        "pkg-1.1.0+1.21" = _yoCjKh8Q;
        "pkg-1.1.1+1.21" = _RiF3MTzK;
        "pkg-1.1.1+1.21+fabric" = _7R2GLvyB;
        "pkg-1.1.2+1.21" = _V7FW3BRf;
        "pkg-1.1.2+1.21+fabric" = _AEFkYGzU;
        "pkg-1.1.2+1.21+forge" = _VwIuEszQ;
        "pkg-1.2.0+1.21.2" = _4T5S41l4;
        "pkg-1.2.0+1.21.2+mod" = _oRJAsE4V;
        "pkg-1.2.1+1.21.3" = _WbqXbkjD;
        "pkg-1.2.1+1.21.3+mod" = _wRWcWFVO;
        "pkg-1.2.1+1.21.4" = _Qxk7g9sT;
        "pkg-1.2.1+1.21.4+mod" = _3i4n47HR;
        "pkg-1.2.2+1.21.4" = _F38dzj36;
        "pkg-1.2.2+1.21.4+mod" = _oIMv3iqJ;
        "pkg-1.2.3+1.21.4" = _bP3E3YaF;
        "pkg-1.2.3+1.21.4+mod" = _l9njS1LW;
        "pkg-1.3.0a+1.21.5" = _I5yFtLtc;
        "pkg-1.3.0a+1.21.5+mod" = _1Tf3wai4;
        "pkg-1.3.0a+1.21.6+mod" = _GpYJUbUg;
        "pkg-1.3.0a+1.21.6" = _dHTXepsb;
        "pkg-1.3.0a+1.21.7" = _ERhK4ChE;
        "pkg-1.3.0a+1.21.7+mod" = _jwJSSDBp;
        "pkg-1.3.0a+1.21.8" = _f3lG09ao;
        "pkg-1.3.0a+1.21.8+mod" = _S6oWIAh6;
        "pkg-1.2.4+1.21.4" = _uhL1NoTb;
        "pkg-1.2.4+1.21.4+mod" = _BdjYndok;
        "pkg-1.3.0b+1.21.8" = _2IeUAEQx;
        "pkg-1.3.0b+1.21.8+mod" = _g3A58WGZ;
        "pkg-1.3.0b+1.21.10" = _JZczL5rz;
        "pkg-1.3.0b+1.21.10+mod" = _hvJ01Oqv;
        "pkg-1.3.0b+1.21.11" = _lkZq5bjK;
        "pkg-1.3.0b+1.21.11+mod" = _WrZEsons;
        "pkg-1.4.0+1.21.8" = _pDswQ0mz;
        "pkg-1.4.0+1.21.10" = _nXSNdaFM;
        "pkg-1.4.0+1.21.11" = _1e3ZVo4c;
        "pkg-1.4.0+1.21.8+mod" = _OEBVRE9D;
        "pkg-1.4.0+1.21.10+mod" = _kGkqBIG9;
        "pkg-1.4.0+1.21.11+mod" = _9QJxv92J;
        "pkg-1.4.1+26.1" = _r1KnGPK0;
        "pkg-1.4.1+26.1+mod" = _71kCv0DG;
        "pkg-1.5+26.2" = _qQEyvHFw;
        "pkg-1.5+26.1" = _xZaO8Rcc;
        "pkg-1.5+26.2+mod" = _OuwX3HMI;
        "pkg-1.5+26.1+mod" = _VcF8QAp9;
        "pkg-1.5.1+26.1" = _Wnvy0q1V;
