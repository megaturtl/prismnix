...
let
    versions = (let
        ...
        _nnazF9VP = {
            "id" = "nnazF9VP";
            "file" = "PaperDoll-v26.1.4-mc26.1.x-NeoForge.jar";
            "hash" = "sha512-EiM/fUguvrvqa/7kcexPsaPOhD7JJGuSuwNYVJHsjh4lBIhzWsFtGigOhkQ/CnNS2uL0QGsEnbgo+XYQxwlFNg==";
        };
        _wWpIiYXG = {
            "id" = "wWpIiYXG";
            "file" = "PaperDoll-v26.1.4-mc26.1.x-Fabric.jar";
            "hash" = "sha512-Rpz2Vd3YTQf4hzUl6kVSY71e+0siUE9DWJb3Vqow/ggZuO2slkkNaFoKYJ0iKa2vWDL4bvT83s1picuePAnu7w==";
        };
        _DNKmln1s = {
            "id" = "DNKmln1s";
            "file" = "PaperDoll-v26.1.5-mc26.1.x-NeoForge.jar";
            "hash" = "sha512-Sy/CsvuRoCj87Y7863F7OIzpWk7dQAiblO1HxKghsPjdZpqhZ9T5qoqUkr6dhPpvLYcqn1Q4ujZrCXml6QwjGA==";
        };
        _rPWUWLph = {
            "id" = "rPWUWLph";
            "file" = "PaperDoll-v26.1.5-mc26.1.x-Fabric.jar";
            "hash" = "sha512-KFxtUhmaXfZ00dmLTnRCLwqneH8ZiwEl9K+re4SW5C3xYLvDW9YGxQArSeohRkaTuDhduVhrApHcuk1AID9HXw==";
        };
        _30yVAyi7 = {
            "id" = "30yVAyi7";
            "file" = "PaperDoll-v26.2.3-mc26.2.x-NeoForge.jar";
            "hash" = "sha512-+neByVhMQjHRgp5Em1WzkOEwkHTlLvnE2147Jum9VASLkAvLPtM5uze9toZICEVw4tDPArGXC8L2ea6EVASs7A==";
        };
        _pyQ1p3iZ = {
            "id" = "pyQ1p3iZ";
    ...
    in {
        ...
        "pkg-v5.0.0-1.19.3-Forge" = _Aq2ZAW0Y;
        "pkg-v6.0.0-1.19.4-Forge" = _yKaSv01a;
        "pkg-v6.0.0-1.19.4-Fabric" = _I1pg3M7W;
        "pkg-v7.0.0-1.20-Forge" = _9hMvrKne;
        "pkg-v7.0.0-1.20-Fabric" = _uOTcSkCD;
        "pkg-v8.0.0-1.20.1-Forge" = _FNImhMZh;
        "pkg-v8.0.0-1.20.1-Fabric" = _m32rknsl;
        "pkg-v20.4.0-1.20.4-Fabric" = _rbRrq0gt;
        "pkg-v20.4.0-1.20.4-Forge" = _5iF7H08I;
        "pkg-v20.4.0-1.20.4-NeoForge" = _F7vmXOUg;
        "pkg-v20.4.1-1.20.4-Fabric" = _86A8Lw9q;
        "pkg-v20.4.1-1.20.4-Forge" = _uOcL6hbn;
        "pkg-v20.4.1-1.20.4-NeoForge" = _eU67vlr0;
        "pkg-v21.1.0-1.21.1-Fabric" = _nNOQwHCI;
        "pkg-v21.1.0-1.21.1-NeoForge" = _16MIDBTU;
        "pkg-v21.3.0-1.21.3-Fabric" = _VmjlnqTW;
        "pkg-v21.3.0-1.21.3-NeoForge" = _O9nE3jDm;
        "pkg-v21.4.0-1.21.4-Fabric" = _8BcJgebO;
        "pkg-v21.4.0-1.21.4-NeoForge" = _umQPwInU;
        "pkg-v21.5.0-1.21.5-Fabric" = _9FKgVTar;
        "pkg-v21.5.0-1.21.5-NeoForge" = _R9x9Av97;
        "pkg-v21.7.0-1.21.7-Fabric" = _5vrFrmB6;
        "pkg-v21.7.0-1.21.7-NeoForge" = _n7hkkwmf;
        "pkg-v21.8.0-1.21.8-Fabric" = _QzOJKxwB;
        "pkg-v21.8.0-1.21.8-NeoForge" = _XB5WfM0M;
        "pkg-v21.8.1-1.21.8-Fabric" = _vmWOcIuS;
        "pkg-v21.8.1-1.21.8-NeoForge" = _29recSQH;
        "pkg-v21.1.1-1.21.1-Fabric" = _MkOX4dB6;
        "pkg-v21.1.1-1.21.1-NeoForge" = _cCfXqOtQ;
        "pkg-v21.8.2-1.21.8-Fabric" = _SrNKHJXG;
        "pkg-v21.8.2-1.21.8-NeoForge" = _mDxQ21Zh;
        "pkg-v21.8.3-1.21.8-Fabric" = _pv2ymVAF;
        "pkg-v21.8.3-1.21.8-NeoForge" = _42WhriR2;
        "pkg-21.9.0" = _hzbXJH1e;
        "pkg-21.10.0" = _t2FvYoeP;
        "pkg-21.11.0" = _bW7ykiTZ;
        "pkg-26.1.0" = _ZexsfrPF;
        "pkg-26.2.0" = _TR8DyUE1;
        "pkg-26.1.1" = _f7B0cjoo;
        "pkg-26.2.1" = _5Lcr86ld;
        "pkg-26.1.2" = _YRBIjW7M;
        "pkg-26.1.3" = _5iY9M0BU;
        "pkg-26.2.2" = _Hati0btw;
