...
let
    versions = (let
        ...
        _1mQSm4Yb = {
            ...
            "hash" = "sha512-n0Ll8+VXEYqN7DZO6H+p7j2R+POG6vZWriQQ3/blJjvesNUy/hr32rUcP6+fpmctMImijlwEJC6GtVQH9BtxUg==";
        };
        _jMB94kRJ = {
            "id" = "jMB94kRJ";
    ...
    in {
        ...
        "pkg-1.3.6" = _TaHSjx5U;
        "pkg-1.3.7" = _VYkM1ThC;
        "pkg-1.3.7.b" = _60TXpK5Z;
        "pkg-1.3.7.c" = _4n2enWkM;
        "pkg-1.3.7.d" = _m6tP7wBk;
        "pkg-1.3.8" = _H1aOFRCq;
        "pkg-1.3.7.e" = _c5Lf1fof;
        "pkg-1.3.8.b" = _aM2GcNtS;
        "pkg-1.3.7.f" = _CouByMdr;
        "pkg-1.3.9" = _Pdz5WjgN;
        "pkg-1.3.9.b" = _dEE2CaZt;
        "pkg-1.3.7.g" = _L23FAk25;
        "pkg-1.3.9.c" = _IGKo8qfR;
        "pkg-1.3.9.d" = _qbm7F9G2;
        "pkg-1.3.9.e" = _SflTPlLg;
        "pkg-1.3.9.f" = _jkCiIZLr;
        "pkg-1.3.9.g" = _HS0ls7Zx;
        "pkg-1.3.10" = _8KyRvYb8;
        "pkg-1.3.11" = _fmoRRwOV;
        "pkg-1.3.11.b" = _od4T6h7p;
        "pkg-1.3.12" = _MX3EE060;
        "pkg-1.3.11.c" = _xfrRlEVH;
        "pkg-1.3.13" = _Bl1U5lSl;
        "pkg-1.4.0" = _xfk4VviH;
        "pkg-1.4.0.b" = _UfTnDbMI;
        "pkg-1.4.0.c" = _2qzNmc9g;
        "pkg-1.4.0.d" = _dcARtIPA;
        "pkg-2.0.0" = _X5lLRTNp;
        "pkg-2.0.1" = _eYXKvEXG;
        "pkg-2.1.0" = _SKZAa6qv;
        "pkg-1.4.1" = _TDatHO4i;
        ...
        "pkg-2.2.1" = _A91s4lsW;
        "pkg-2.2.2" = _RzO4WcPO;
        "pkg-2.2.2b" = _V55FwZ74;
        "pkg-2.2.3" = _Ds0YzVj6;
        "pkg-1.4.3" = _1J5a2AVp;
        "pkg-1.4.3b" = _b6J7xYnJ;
        "pkg-2.2.3b" = _9wJeYJJk;
        "pkg-2.2.4" = _D11HRJTY;
        "pkg-2.2.5" = _2B7aPZZ1;
        "pkg-2.2.6" = _rYgctWCz;
        "pkg-2.3.0" = _SpLHbsZw;
