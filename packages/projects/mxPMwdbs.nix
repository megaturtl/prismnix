...
let
    ...
    in {
        ...
        "pkg-1.21-1.1.0" = _KK6RH9Kj;
        "pkg-1.21-1.1.1" = _YFUE1waH;
        "pkg-1.21-1.2.0" = _rGQpUro2;
        "pkg-1.21-1.3.0" = _ITJkU7T0;
        "pkg-1.21-1.3.1" = _3vo3XVdS;
        "pkg-1.21-1.3.2" = _sS50vvoY;
        "pkg-1.21-1.3.3" = _c0M4COXC;
        "pkg-1.21.1-1.4.0" = _1MeEmqhT;
        "pkg-1.21.1-1.4.1" = _YaXDjLYt;
        "pkg-1.21.1-1.5.0" = _i6NiE5bu;
        "pkg-1.21.1-1.5.1" = _s9cBbR75;
        "pkg-1.21.1-1.5.4" = _nk3CP7Ei;
        "pkg-1.21.1-1.5.5" = _1Aiyg3Mx;
        "pkg-1.21.1-1.5.6" = _O4OWqPTa;
        "pkg-1.21.1-1.5.7" = _Sg0RuO6p;
        "pkg-1.21.1-1.5.8" = _WyOrchGs;
        "pkg-1.21.1-1.5.9" = _F86qupQg;
        "pkg-1.21.1-1.6.0" = _Pst8Tztb;
        "pkg-1.21.1-1.7.0" = _QMOqhpS8;
        "pkg-1.21.1-1.7.1" = _8a07omDe;
        "pkg-1.21.1-1.8.1" = _sgnPn0Vb;
        "pkg-1.21.1-1.8.2" = _HM3pY941;
        "pkg-26.1-pre-3-2.2.0" = _dDU01WEN;
        "pkg-26.1.1-2.3.0" = _W8mFhRUg;
        "pkg-26.1.2-2.4.0" = _NKanOVxE;
        "pkg-26.1.2-2.4.1" = _hD5JMvmq;
        "pkg-26.1.2-2.4.2" = _n94Jf9LY;
