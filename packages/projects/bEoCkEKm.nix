...
let
    ...
    in {
        ...
        "pkg-v1.0" = _h3ybP0uS;
        "pkg-v1.0+mod" = _n9cRt7ub;
        "pkg-v1.01" = _NewtMJuh;
        "pkg-v1.01+mod" = _OhwTSYwU;
        "pkg-v1.0.2" = _XW6JLNPV;
        "pkg-v1.0.2+mod" = _ygsXDseb;
        "pkg-1.1.0" = _A4Ikgnft;
        "pkg-1.1.0+mod" = _Asqgezt7;
        "pkg-1.1.1" = _lGOBpsL2;
        "pkg-1.1.1+mod" = _KptSeCll;
        "pkg-1.1.2" = _x04aR1uY;
        "pkg-1.1.2+mod" = _8covLlwR;
        "pkg-1.1.3" = _fEWgfWfT;
        "pkg-1.1.3+mod" = _tw5AFy9y;
        "pkg-1.2.0" = _MQSXr668;
        "pkg-1.2.0+mod" = _TWkHgiDW;
        "pkg-1.3.0" = _pR6pTZHf;
        "pkg-1.3.0+mod" = _62KOJBgJ;
        "pkg-1.3.1" = _hZjdZ9ii;
        "pkg-1.3.1+mod" = _mUp7Y0dn;
        "pkg-1.3.2" = _tUys0HMS;
