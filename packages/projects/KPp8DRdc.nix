...
let
    versions = (let
        ...
        _DizzzJyt = {
            "id" = "DizzzJyt";
            "file" = "hearts_green-1.1.0-mc26.3.zip";
            "hash" = "sha512-vWmd3tolfcdyPg882KawAh9G1HO7BWa9snfA4OLGGApmIa2BEuboDla6q0+ZJO5YUcxfcef0O2jriGS0xBdU9g==";
        };
    in {
        "buQhJsJK" = _buQhJsJK;
        "KjjciuFi" = _KjjciuFi;
