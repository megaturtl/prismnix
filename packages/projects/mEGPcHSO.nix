...
let
    versions = (let
        ...
        _n8Qpl2S4 = {
            "id" = "n8Qpl2S4";
            "file" = "AutoEat-Fabric-1.6.6+1.21.x+26.1.x+26.2.x+26.3-snapshot.x.jar";
            "hash" = "sha512-/DK+irfynq8rLWOZE0DhwcoJEtlZaYFlCi0giOyRuZtjWFwKqS/2wz9YEB+7b2Xf+elcW3tJinv0Y5brmDM9og==";
        };
        _xHsyPMMI = {
            "id" = "xHsyPMMI";
            "file" = "AutoEat-Forge-1.6.6+1.21.x+26.1.x+26.2.x.jar";
            "hash" = "sha512-/uI+iAbhLfonJSYKE3LOd12qFd/TmVKv21ppSAZZdH9FXBHShVR2Jhip2ozdhpuAuBL8SKBM7h8S6AwYA40Chw==";
        };
        _1wCNiJzx = {
            "id" = "1wCNiJzx";
            "file" = "AutoEat-NeoForge-1.6.6+1.21.x+26.1.x+26.2.x.jar";
            "hash" = "sha512-A7GplEkzOhE2Fv356E53NgHdxpU9Np/h87dtfmfQcrJ4MMDwZEt7YzCcG+BWaba38kZePP6IxMqhhzHxFzmc3A==";
        };
        _sXG7CIke = {
            "id" = "sXG7CIke";
            "file" = "AutoEat-Fabric-1.6.7+1.21.x+26.1.x+26.2.x+26.3-snapshot.x.jar";
            "hash" = "sha512-QNdTzoBsDzbLzv+gbHNojXn0c+inTRvFHFJeyDcYEwjBMc3Yi6bjma0Mz3rMuc68zPBG0W/j6YbOxIRhJzyyRg==";
        };
        _7PC8tVv0 = {
            "id" = "7PC8tVv0";
            "file" = "AutoEat-Forge-1.6.7+1.21.x+26.1.x+26.2.x.jar";
            "hash" = "sha512-NINby1ValPodRPh6rezh4kux7lBXDjcBUVcEW4wi0ktXhE+aAiQjyyd9XoAN0YK26nAKikx52NbMyBnc6WqB4g==";
        };
        _HWb9gtVv = {
            "id" = "HWb9gtVv";
            "file" = "AutoEat-NeoForge-1.6.7+1.21.x+26.1.x+26.2.x.jar";
            "hash" = "sha512-1zsTfenudRFGow0gK0iWdFMSRbdzedf7PESI2RoqtQHcdAY1Rkwx31rm7BccpC7svNPd6S5LIEZ25W9Bthn13A==";
        };
    in {
        "GZqmmEmh" = _GZqmmEmh;
        "QDpZisYu" = _QDpZisYu;
        ...
        "7PC8tVv0" = _7PC8tVv0;
        "HWb9gtVv" = _HWb9gtVv;
        "fabric-1.21.10" = _sXG7CIke;
        "fabric-1.21.11" = _sXG7CIke;
        "fabric-26.1" = _sXG7CIke;
        "fabric-26.1.1" = _sXG7CIke;
        "fabric-26.1.2" = _sXG7CIke;
        "fabric-1.21" = _sXG7CIke;
        "fabric-1.21.1" = _sXG7CIke;
        "fabric-1.21.2" = _sXG7CIke;
        "fabric-1.21.3" = _sXG7CIke;
        "fabric-1.21.4" = _sXG7CIke;
        "fabric-1.21.5" = _sXG7CIke;
        "fabric-1.21.6" = _sXG7CIke;
        "fabric-1.21.7" = _sXG7CIke;
        "fabric-1.21.8" = _sXG7CIke;
        "fabric-1.21.9" = _sXG7CIke;
        "fabric-26.2" = _sXG7CIke;
        "fabric-26.3-snapshot-3" = _sXG7CIke;
        "fabric-26.3-snapshot-1" = _sXG7CIke;
        "fabric-26.3-snapshot-2" = _sXG7CIke;
        "fabric-26.3-snapshot-4" = _sXG7CIke;
        "forge-1.21" = _7PC8tVv0;
        "forge-1.21.1" = _7PC8tVv0;
        "forge-1.21.2" = _7PC8tVv0;
        "forge-1.21.3" = _7PC8tVv0;
        "forge-1.21.4" = _7PC8tVv0;
        "forge-1.21.5" = _7PC8tVv0;
        "forge-1.21.6" = _7PC8tVv0;
        "forge-1.21.7" = _7PC8tVv0;
        "forge-1.21.8" = _7PC8tVv0;
        "forge-1.21.9" = _7PC8tVv0;
        "forge-1.21.10" = _7PC8tVv0;
        "forge-1.21.11" = _7PC8tVv0;
        "forge-26.1" = _7PC8tVv0;
        "forge-26.1.1" = _7PC8tVv0;
        "forge-26.1.2" = _7PC8tVv0;
        "forge-26.2" = _7PC8tVv0;
        "neoforge-1.21" = _HWb9gtVv;
        "neoforge-1.21.1" = _HWb9gtVv;
        "neoforge-1.21.2" = _HWb9gtVv;
        "neoforge-1.21.3" = _HWb9gtVv;
        "neoforge-1.21.4" = _HWb9gtVv;
        "neoforge-1.21.5" = _HWb9gtVv;
        "neoforge-1.21.6" = _HWb9gtVv;
        "neoforge-1.21.7" = _HWb9gtVv;
        "neoforge-1.21.8" = _HWb9gtVv;
        "neoforge-1.21.9" = _HWb9gtVv;
        "neoforge-1.21.10" = _HWb9gtVv;
        "neoforge-1.21.11" = _HWb9gtVv;
        "neoforge-26.1" = _HWb9gtVv;
        "neoforge-26.1.1" = _HWb9gtVv;
        "neoforge-26.1.2" = _HWb9gtVv;
        "neoforge-26.2" = _HWb9gtVv;
        "pkg-1.0.0+1.21.10" = _GZqmmEmh;
        "pkg-1.1.0+1.21.11" = _QDpZisYu;
        "pkg-1.1.1+1.21.11" = _9pRasXFT;
        "pkg-1.1.2+1.21.11" = _umEIY1h6;
        "pkg-1.2.0+26.1" = _Ys6BGkY0;
        "pkg-1.3.0+26.1.1" = _YOtshETc;
        "pkg-1.4.0+26.1.2" = _us0h1nlj;
        "pkg-1.5.0+26.1.x" = _DNNOtk6W;
        "pkg-1.5.1+1.21.x-26.1.x" = _epmrIvW0;
        "pkg-1.6.0" = _k2JK1g8q;
        "pkg-1.6.1" = _89fI2aMS;
        "pkg-1.6.2" = _T2sUYSDo;
        "pkg-1.6.3" = _HTDDbsXc;
