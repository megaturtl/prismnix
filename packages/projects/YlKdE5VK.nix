...
let
    ...
    in {
        ...
        "pkg-0.4.7+4-main" = _6Av0TZL9;
        "pkg-0.4.7+5-main" = _kWcusc4J;
        "pkg-0.4.7+6-main" = _3rsyasoA;
        "pkg-0.4.7+7-main" = _uyvP4Oy3;
        "pkg-0.4.7+9-main" = _a1MWD37A;
        "pkg-0.4.7+10-main" = _TLDV4FDJ;
        "pkg-0.4.7+11-main" = _uVSQ7dVi;
        "pkg-0.4.8+12-main" = _Hr6NjIqX;
        "pkg-0.4.8+13-main" = _NhWMe06K;
        "pkg-0.4.8+14-main" = _WL6x0p4G;
        "pkg-0.4.8+15-main" = _Tor3VXLm;
        "pkg-0.4.8+16-main" = _ng458qfc;
        "pkg-0.4.8+17-main" = _dRR5ETJX;
        "pkg-0.4.9+19-main" = _HDHqNX5V;
        "pkg-0.4.9+21-main" = _kw6nmgT0;
        "pkg-0.4.9+22-main" = _Su0V35Vs;
        "pkg-0.4.9+23-main" = _sHH8Y9BG;
        "pkg-0.4.9+24-main" = _1CbkwFOx;
        "pkg-0.4.9+25-main" = _sONNp7Wk;
        "pkg-0.4.9+27-dev" = _vzFAMo07;
        "pkg-0.4.9+28-main" = _QKSpzVkU;
        "pkg-0.4.9+29-main" = _xLDLYCrc;
        "pkg-0.4.9+30-main" = _zLtiL1ed;
        "pkg-0.4.10+32-dev" = _kzWLjSvk;
        "pkg-0.4.10+33-dev" = _HijWckMU;
        "pkg-0.4.10+34-dev" = _1wDlgp1s;
        "pkg-0.4.10+35-dev" = _ex4DwxBO;
        "pkg-0.4.10+36-dev" = _Qtx2zcBT;
        "pkg-0.4.10+38-dev" = _UBDfFRM7;
        "pkg-0.4.10+39-main" = _nT1wg9u0;
        "pkg-0.4.10+40-main" = _j15sFcP7;
        "pkg-0.4.11+41-dev" = _sGT8YD7M;
        "pkg-0.4.11+42-dev" = _EUyEnK0n;
        "pkg-0.4.11+43-dev" = _OpOiWFZK;
        "pkg-0.4.11+44-dev" = _aIWvRLYL;
        "pkg-0.4.11+45-main" = _7CcaGOg1;
        "pkg-0.4.11+46-main" = _srJAYL0g;
        "pkg-0.4.11+47-dev" = _2VZjnrNA;
        "pkg-0.4.11+48-dev" = _bTZ098Xs;
        "pkg-0.4.11+49-dev" = _xrVdJrGW;
        "pkg-0.4.11+50-dev" = _x9bibmK0;
        "pkg-0.4.12+51-main" = _8TXy7I5h;
        "pkg-0.4.12+52-main" = _BO5Xlbhq;
        "pkg-0.4.12+53-main" = _Ve1QfNie;
        "pkg-0.4.12+54-main" = _9snTv2mt;
        "pkg-0.4.12+55-dev" = _eAuT55f2;
        "pkg-0.4.12+56-dev" = _JrEMetos;
        "pkg-0.4.13+57-main" = _xydEaMij;
        "pkg-0.4.13+60-main" = _RXxeixHx;
        "pkg-0.4.13+61-main" = _y0Sk9CU6;
        "pkg-0.4.13+63-dev" = _ifjZlSsW;
        "pkg-0.4.13+64-main" = _WOdh6q3Y;
        "pkg-0.4.13+65-main" = _tPA7aBMn;
        "pkg-0.4.14+66-main" = _mFi1Bbuy;
        "pkg-0.4.14+67-main" = _ncLX0RTk;
        "pkg-0.4.14+68-main" = _aoSNBRsY;
        "pkg-0.4.14+69-main" = _bC9lFqvq;
        "pkg-0.4.14+70-main" = _OARxDm5F;
        "pkg-0.4.14+71-dev" = _iufzJLQX;
        "pkg-0.4.14+72-dev" = _4pvCyosx;
        "pkg-0.4.14+73-main" = _8w3rJlCB;
        "pkg-0.4.14+74-main" = _Tw6VYjjI;
        "pkg-0.4.14+76-legacy" = _1bSBOMnV;
        "pkg-0.4.14+77-main" = _H5kLGJTQ;
        "pkg-0.4.15+78-main" = _dS5UWGlC;
        "pkg-0.4.15+79-main" = _h1r2urqJ;
        "pkg-0.4.15+80-main" = _UQhB7UW1;
        "pkg-0.4.15+81-main" = _F2zahyhQ;
        "pkg-0.4.15+82-legacy" = _BI21ROWE;
        "pkg-0.4.15+83-main" = _HcMA9Ubr;
        "pkg-0.4.15+84-main" = _6DgogkJ3;
        "pkg-0.4.16+85-main" = _510fLIzT;
        "pkg-0.4.16+86-legacy" = _OpbhEAlg;
        "pkg-0.4.16+87-legacy" = _PoV5riHn;
        "pkg-0.4.16+88-main" = _CQ7NwggR;
        "pkg-0.4.17+90-legacy" = _hmvxr6ge;
        "pkg-0.4.17+91-main" = _Niu0KrUK;
        "pkg-0.4.17+92-legacy" = _oY9ZmB3o;
        "pkg-0.4.17+93-main" = _UGHhXjIX;
        "pkg-0.4.17+95-main" = _1l5X05Aw;
        "pkg-0.4.17+96-main" = _HtlOMtdf;
        "pkg-0.4.17+97-main" = _TKgrjQy7;
        "pkg-0.4.17+99-legacy" = _AmIl3O1t;
        "pkg-0.4.17+100-main" = _Nq2s57Tj;
        "pkg-0.4.17+101-legacy" = _aVYQ1muy;
        "pkg-0.4.17+102-main" = _YVYkific;
        "pkg-0.4.18+103-legacy" = _d2rawrRu;
        "pkg-0.4.18+104-main" = _n9T0mzox;
        "pkg-0.4.18+105-legacy" = _8WmvPM11;
        "pkg-0.4.18+106-legacy" = _qn78Nae0;
        "pkg-0.4.18+107-main" = _XJiIIczg;
        "pkg-0.4.18+108-legacy" = _tIpCWaiI;
        "pkg-0.4.18+109-main" = _2JihKmGc;
        "pkg-0.4.19+110-legacy" = _lhgFrJrN;
        "pkg-0.4.19+111-main" = _NDe36mau;
        "pkg-0.4.19+112-legacy" = _xmwBKXsD;
        "pkg-0.4.19+113-main" = _DCKVLFYo;
        "pkg-0.4.19+114-main" = _5FYJdq7i;
        "pkg-0.4.19+115-legacy" = _RPlqmo0N;
        "pkg-0.4.19+116-main" = _lhjzEj3K;
        "pkg-0.4.19+118-main" = _17bTjshZ;
        "pkg-0.4.20+119-legacy" = _hDAYnJVx;
        "pkg-0.4.20+120-main" = _nWGb09E0;
        "pkg-0.4.20+121-legacy" = _7LCYJDBn;
        "pkg-0.4.20+122-main" = _wDkGJEEN;
        "pkg-0.4.20+123-legacy" = _lrn0bLTg;
        "pkg-0.4.20+124-main" = _GxP4GkpP;
        "pkg-0.4.20+125-legacy" = _cFzk7Kas;
        "pkg-0.4.20+126-main" = _kdVGOJPv;
        "pkg-0.4.21+127-legacy" = _3S1GwzHU;
        "pkg-0.4.21+128-main" = _T1KYcv4S;
        "pkg-0.4.21+129-main" = _jmsoyTm9;
        "pkg-0.4.21+130-legacy" = _jIfyL2G3;
        "pkg-0.4.21+131-main" = _aHr1fyk8;
        "pkg-0.4.21+132-main" = _M1mjhoTt;
        "pkg-0.4.21+133-main" = _YSiPfYev;
        "pkg-0.4.21+134-main" = _541y6mBi;
        "pkg-0.4.21+135-main" = _ewp8jfiF;
        "pkg-0.4.21+136-main" = _KLGOka03;
        "pkg-0.4.21+137-main" = _aBfR35qM;
        "pkg-0.4.21+138-1.14-1.21" = _j78qte9T;
        "pkg-0.4.21+139-1.14-1.21" = _YcucYuIK;
        "pkg-0.4.21+140-1.14-1.21" = _pNqgYqjM;
        "pkg-0.4.21+142-26.x" = _h0k6NbzF;
        "pkg-0.4.21+143-26.x" = _zw4RAg5x;
        "pkg-0.4.21+144-26.x" = _zeLyZatg;
        "pkg-0.4.21+145-26.x" = _l4XBd1jh;
        "pkg-0.4.21+146-26.x" = _imIB3qtN;
        "pkg-0.4.21+147-26.x" = _1GjXZLX2;
        "pkg-0.4.21+148-26.x" = _1FooN0LE;
        "pkg-0.4.21+149-1.14-1.21" = _i6hoccma;
        "pkg-0.4.21+150-1.14-1.21" = _68H0iHhY;
        "pkg-0.4.21+151-26.x" = _3r4nq7JX;
        "pkg-0.4.21+152-26.x" = _uV2Dd86q;
        "pkg-0.4.21+153-1.14-1.21" = _epvpVCPS;
        "pkg-0.4.21+154-26.x" = _b2XxEJxb;
        "pkg-0.4.21+155-26.x" = _ukpaZz9g;
        "pkg-0.4.21+156-1.14-1.21" = _fX5DMuoH;
        "pkg-0.4.21+157-26.x" = _oLC0AkAn;
        "pkg-0.4.21+158-1.14-1.21" = _aO4M7GRq;
        "pkg-0.4.21+160-26.x" = _IfySEaKv;
        "pkg-0.4.21+159-1.14-1.21" = _xXnPtaqv;
        "pkg-0.4.21+161-1.14-1.21" = _JUie2YMf;
        "pkg-0.4.21+162-26.x" = _rwEWb3Gu;
        "pkg-0.4.21+163-1.14-1.21" = _gukVDlIF;
        "pkg-0.4.21+164-26.x" = _h2VwH6yu;
        "pkg-0.4.21+165-26.x" = _hFEES2yu;
        "pkg-0.4.21+167-26.x" = _z3OlAuMU;
        "pkg-0.4.21+166-1.14-1.21" = _MRUUxfWz;
        "pkg-0.4.21+169-26.x" = _jMktfGNP;
        "pkg-0.4.21+168-1.14-1.21" = _lCWkK6um;
        "pkg-0.4.21+170-26.x" = _Lt7HRboM;
        "pkg-0.4.21+172-26.x" = _rRHSH3qm;
        "pkg-0.4.21+171-1.14-1.21" = _ghuh2MQh;
