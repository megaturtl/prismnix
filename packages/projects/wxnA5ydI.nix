...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.3.0-alpha" = _UaUbxHuK;
        "pkg-1.18.2-1.4.0-alpha" = _ks6nIm9K;
        "pkg-1.18.2-1.4.1-alpha" = _tBSCbou5;
        "pkg-1.20.1-1.4.0-alpha" = _yZyi7NaI;
        "pkg-1.19.2-1.4.0-alpha" = _EzyWkPug;
        "pkg-1.19.2-1.4.1-alpha" = _Nhfcuq4n;
        "pkg-1.20.1-1.5.0-alpha" = _FIcyV12r;
        "pkg-1.20.1-1.6.0-alpha" = _aP75xzmI;
        "pkg-1.20.1-1.7.0-alpha" = _4t692UzP;
        "pkg-1.20.1-1.8.0-alpha" = _wb05ZZEg;
        "pkg-1.20.1-1.9.0-alpha" = _AAS9HDjC;
        "pkg-1.20.1-1.10.0-alpha" = _sLhdwhOD;
        "pkg-1.20.1-1.11.0-alpha" = _rpJDeCvI;
        "pkg-1.20.1-1.12.0-alpha" = _pd8dni7W;
        "pkg-1.20.1-1.13.0-alpha" = _5BTxR8p1;
        "pkg-1.20.1-1.13.1-alpha" = _WEQbn6EZ;
        "pkg-1.20.1-1.14.0-alpha" = _wHopv9dD;
        "pkg-1.20.1-1.15.0-alpha" = _5X6n19aQ;
        "pkg-1.20.1-1.15.1-alpha" = _lMQPlRmy;
        "pkg-1.20.1-1.16.0-alpha" = _FmN5uhmN;
        "pkg-1.20.1-1.16.1-alpha" = _TdzWT6b4;
        "pkg-1.20.1-1.16.2-alpha" = _PVzWCq3i;
        "pkg-1.20.1-1.17.0-alpha" = _EpXzBKzm;
        "pkg-1.20.1-1.17.1-alpha" = _DlfpKUmq;
        "pkg-1.20.1-1.17.2-alpha" = _zKBvzYLt;
        "pkg-1.20.1-1.17.3-alpha" = _Slsb3tKo;
        "pkg-1.20.1-1.17.4-alpha" = _kDyFVGfq;
        "pkg-1.18.0-alpha" = _3B51BJ43;
        "pkg-1.18.1-alpha" = _l6q2CJeb;
        "pkg-1.18.2-alpha" = _YABHJx8i;
        "pkg-1.18.3-alpha" = _qomm4VRI;
        "pkg-1.19.0-alpha" = _IvdStdGV;
        "pkg-1.19.1-alpha" = _Ny2VdFmW;
        "pkg-1.19.2-alpha" = _N7jDHX4T;
        "pkg-1.19.3-alpha" = _9ZtcVSxR;
        "pkg-1.19.4-alpha" = _7vTb48N7;
