...
let
    ...
    in {
        ...
        "pkg-1.0.2+mc1.19.3" = _DpA7h1fc;
        "pkg-1.0.2+mc1.19.4" = _m9I3HUG4;
        "pkg-1.0.2+mc1.20.1" = _dWdTuWrV;
        "pkg-1.0.2+mc1.20.2" = _XvX0g08K;
        "pkg-1.1.0-beta.02" = _G98WdvMH;
        "pkg-1.1.0" = _NRZKdwkR;
        "pkg-1.1.1" = _x6OwNzLN;
        "pkg-1.2.0-pre.1" = _T8JPyekL;
        "pkg-1.2.0-pre.2" = _sQLTjJjQ;
        "pkg-1.2.0-pre.3" = _vvSCaTR0;
        "pkg-1.2.0-pre.4" = _6FYlYtuq;
        "pkg-1.2.0" = _mxRO9epT;
        "pkg-1.3.0-pre.1" = _NmmhHUzd;
        "pkg-1.3.0-pre.2" = _2NsM5qA3;
        "pkg-1.3.0" = _CM2U9Vdq;
        "pkg-1.3.1" = _UxcCSjpA;
        "pkg-2.0.0" = _FZsFmdgI;
        "pkg-2.1.0-beta.1" = _fvl0PiIP;
        "pkg-2.1.0-beta.2" = _2aXCEUGM;
        "pkg-2.1.0-beta.3" = _FmmtEzwP;
        "pkg-2.1.0-beta.4" = _6GjloR22;
        "pkg-2.1.0" = _Fq5aL7My;
        "pkg-2.1.1+1.21" = _Z8CS7Bgj;
        "pkg-2.1.1+1.21.3" = _SaDoZ9w5;
        "pkg-2.2.0+1.21" = _jwR56Hft;
        "pkg-2.2.0+1.21.3" = _PeyITKHX;
        "pkg-2.2.0+1.21.4" = _9Piu0iJv;
        "pkg-2.3.0+1.21" = _A2laZkQj;
        "pkg-2.3.0+1.21.3" = _hHiPJ6Z5;
        "pkg-2.3.0+1.21.4" = _HzcwfZqC;
        "pkg-2.3.1+1.21" = _Tbs9jO6w;
        "pkg-2.3.1+1.21.3" = _iECWNf0i;
        "pkg-2.3.1+1.21.4" = _odv9wmlE;
        "pkg-2.3.2+1.21" = _glpRAuMy;
        "pkg-2.3.2+1.21.3" = _eg3Pn0sN;
        "pkg-2.3.2+1.21.4" = _EyaZW1Nw;
        "pkg-2.3.3+1.21" = _cOOWDip9;
        "pkg-2.3.3+1.21.3" = _BTGA4Qkl;
        "pkg-2.3.3+1.21.4" = _viYEOXCl;
        "pkg-2.3.4+1.21" = _VtjGPBNn;
        "pkg-2.3.4+1.21.3" = _MN2mlg7N;
        "pkg-2.3.4+1.21.4" = _Hm91G6ax;
        "pkg-2.3.5+1.21" = _jNbxJ0m4;
        "pkg-2.3.5+1.21.3" = _otqGNRPv;
        "pkg-2.3.5+1.21.4" = _bt3RRSKF;
        "pkg-2.3.6+1.21" = _D42nugsB;
        "pkg-2.3.6+1.21.3" = _RxZk5ibh;
        "pkg-2.3.6+1.21.4" = _su2l1PUd;
        "pkg-2.3.7+1.21" = _9fJ5XsWz;
        "pkg-2.3.7+1.21.3" = _jBu1FgCN;
        "pkg-2.3.7+1.21.4" = _x2DPLrYU;
        "pkg-2.3.8+1.21" = _wQGmx9Md;
        "pkg-2.3.8+1.21.3" = _oX961LHK;
        "pkg-2.3.8+1.21.4" = _fR3Jnlqo;
        "pkg-2.3.9+1.21" = _bj2EO0lM;
        "pkg-2.3.9+1.21.3" = _ucE7dq72;
        "pkg-2.3.9+1.21.4" = _yAP9elAj;
        "pkg-2.3.10+1.20.1" = _KPU8dWj4;
        "pkg-2.3.10+1.21" = _kkAuFWhJ;
        "pkg-2.3.10+1.21.3" = _lUus2zHq;
        "pkg-2.3.10+1.21.4" = _eAsxSam3;
        "pkg-2.3.11+1.20.1" = _R21bpq6D;
        "pkg-2.3.11+1.21" = _D67EZ6Ps;
        "pkg-2.3.11+1.21.3" = _OBmKOX1y;
        "pkg-2.3.11+1.21.4" = _AZv0ld7D;
        "pkg-2.4.0+1.20.1" = _MvQCfSht;
        "pkg-2.4.0+1.21" = _jlPqhFSq;
        "pkg-2.4.0+1.21.3" = _YHLWrgVV;
        "pkg-2.4.0+1.21.4" = _P6u9cbYT;
        "pkg-2.4.1+1.20.1" = _7DlK8XhD;
        "pkg-2.4.1+1.21" = _MBxFE8Sb;
        "pkg-2.4.1+1.21.3" = _f7Fmb1Ro;
        "pkg-2.4.1+1.21.4" = _mYIhRvAv;
        "pkg-2.4.2+1.20.1" = _TJf4TF1a;
        "pkg-2.4.2+1.21" = _sXsC9EHT;
        "pkg-2.4.2+1.21.3" = _SXghNW4Q;
        "pkg-2.4.2+1.21.4" = _h29EROuj;
        "pkg-2.4.3+1.20.1" = _oHlyTOoR;
        "pkg-2.4.3+1.21" = _1sxNL4Jv;
        "pkg-2.4.3+1.21.3" = _91BjerW0;
        "pkg-2.4.3+1.21.4" = _X83GUyep;
        "pkg-2.4.3+1.21.5" = _yz9Yw67R;
        "pkg-2.4.4+1.20.1" = _S5BJGyOa;
        "pkg-2.4.4+1.21" = _jAN2aOnu;
        "pkg-2.4.4+1.21.3" = _UWexddCD;
        "pkg-2.4.4+1.21.4" = _tVgZTeXM;
        "pkg-2.4.4+1.21.5" = _R7xPGe4t;
        "pkg-2.4.5+1.20.1" = _pNiqPTEW;
        "pkg-2.4.5+1.21.3" = _6ywgmanh;
        "pkg-2.4.5+1.21.4" = _e9ki9Ist;
        "pkg-2.4.5+1.21.5" = _JDEBXJPn;
        "pkg-2.4.5+1.21" = _nfLkZZuC;
        "pkg-2.4.6+1.20.1" = _DuvJvKI1;
        "pkg-2.4.6+1.21" = _SD1gGroG;
        "pkg-2.4.6+1.21.3" = _qUN0xhgU;
        "pkg-2.4.6+1.21.4" = _HRuayrna;
        "pkg-2.4.6+1.21.5" = _oZBSNkI2;
        "pkg-2.4.6+1.21.6" = _FiNpALlh;
        "pkg-2.4.7+1.20.1" = _lrxTZv5Z;
        "pkg-2.4.7+1.21.1" = _RdPP9pUH;
        "pkg-2.4.7+1.21.3" = _Vd9705ME;
        "pkg-2.4.7+1.21.4" = _Fq5walxk;
        "pkg-2.4.7+1.21.5" = _HF170Hoz;
        "pkg-2.4.7+1.21.7" = _waZZVBzA;
        "pkg-2.4.8+1.21.7" = _6RyyYr5X;
        "pkg-2.4.9+1.20.1" = _e5yInYYS;
        "pkg-2.4.9+1.21.1" = _1MSDq1Xq;
        "pkg-2.4.9+1.21.3" = _Qw2ZkMNB;
        "pkg-2.4.9+1.21.4" = _AMiHjQbB;
        "pkg-2.4.9+1.21.5" = _M3Ed7j5f;
        "pkg-2.4.9+1.21.7" = _uppIQKXF;
        "pkg-2.4.10+1.20.1" = _oMBDA7JH;
        "pkg-2.4.10+1.21.1" = _onITAStf;
        "pkg-2.4.10+1.21.3" = _74EfqXCu;
        "pkg-2.4.10+1.21.4" = _ot27RxZM;
        "pkg-2.4.10+1.21.5" = _rSwuHryT;
        "pkg-2.4.10+1.21.7" = _wP0fXyni;
        "pkg-2.4.11+1.20.1" = _e0OMTTWL;
        "pkg-2.4.11+1.21.1" = _lNYObUSQ;
        "pkg-2.4.11+1.21.3" = _P1ahrqnF;
        "pkg-2.4.11+1.21.4" = _zvVLLYDU;
        "pkg-2.4.11+1.21.5" = _NcsPnX2T;
        "pkg-2.4.11+1.21.7" = _SWCYP8qz;
        "pkg-2.5.0+1.20.1" = _n8aVH3tV;
        "pkg-2.5.0+1.21.1" = _ZtyBilDb;
        "pkg-2.5.0+1.21.3" = _WkvbMzOI;
        "pkg-2.5.0+1.21.4" = _Ibm8JMEF;
        "pkg-2.5.0+1.21.5" = _wm3fnqwg;
        "pkg-2.5.0+1.21.7" = _e1AvvnsJ;
        "pkg-2.5.1+1.20.1" = _BDQMLTtW;
        "pkg-2.5.1+1.21.1" = _3kAeMko8;
        "pkg-2.5.1+1.21.3" = _ac5obuEt;
        "pkg-2.5.1+1.21.4" = _OHlSMW08;
        "pkg-2.5.1+1.21.5" = _gnMKZoud;
        "pkg-2.5.1+1.21.7" = _10BpATBf;
        "pkg-2.5.2+1.20.1" = _gOrxozIc;
        "pkg-2.5.2+1.21.1" = _27DbK1JV;
        "pkg-2.5.2+1.21.3" = _UC5TufnM;
        "pkg-2.5.2+1.21.4" = _Ssu2AJ7Q;
        "pkg-2.5.2+1.21.5" = _3OFofvi6;
        "pkg-2.5.2+1.21.8" = _vEIGs7z5;
        "pkg-2.5.2+1.21.9" = _CWSGgt75;
        "pkg-2.6.0+1.20.1" = _BblnhoRg;
        "pkg-2.6.0+1.21.1" = _nYYCdxcy;
        "pkg-2.6.0+1.21.3" = _UuhZPusJ;
        "pkg-2.6.0+1.21.4" = _J0uGZlFZ;
        "pkg-2.6.0+1.21.5" = _mYlFdCy6;
        "pkg-2.6.0+1.21.8" = _G3UCmJEg;
        "pkg-2.6.0+1.21.10" = _QiI59336;
        "pkg-2.6.1+1.20.1" = _5MZcdrMo;
        "pkg-2.6.1+1.21.1" = _TfVJOqsu;
        "pkg-2.6.1+1.21.3" = _FBpW7Qfp;
        "pkg-2.6.1+1.21.4" = _IlRfkRJi;
        "pkg-2.6.1+1.21.5" = _OW3gLa7J;
        "pkg-2.6.1+1.21.8" = _f6LNbJou;
        "pkg-2.6.1+1.21.10" = _aqmYS6O9;
        "pkg-2.6.2+1.20.1" = _tjwU1CXK;
        "pkg-2.6.2+1.21.1" = _rSzfB9Ti;
        "pkg-2.6.2+1.21.3" = _dbssJLNW;
        "pkg-2.6.2+1.21.4" = _z9IGAiGU;
        "pkg-2.6.2+1.21.5" = _jbcW2zBR;
        "pkg-2.6.2+1.21.8" = _2xgOZGgD;
        "pkg-2.6.2+1.21.10" = _p3YAXtZ9;
        "pkg-2.6.2+1.21.11" = _iRwWD2B1;
        "pkg-2.6.3+1.20.1" = _d4RdIw0x;
        "pkg-2.6.3+1.21.1" = _97rXllpv;
        "pkg-2.6.3+1.21.3" = _xIlO1i1G;
        "pkg-2.6.3+1.21.4" = _vQacnhpP;
        "pkg-2.6.3+1.21.5" = _gBAQ1hYt;
        "pkg-2.6.3+1.21.8" = _jZyNQfcH;
        "pkg-2.6.3+1.21.10" = _1WJWbUA0;
        "pkg-2.6.3+1.21.11" = _9pp5nJmy;
        "pkg-2.6.4+1.21.10" = _DwwlGmgX;
        "pkg-2.6.4+1.21.11" = _XFM3DEfq;
        "pkg-2.6.5+1.21.10" = _QmlubduJ;
        "pkg-2.6.5+1.21.11" = _2r725TrM;
        "pkg-2.6.6+1.20.1" = _R3MILKnZ;
        "pkg-2.6.6+1.21.1" = _DbsS9LDW;
        "pkg-2.6.6+1.21.3" = _V9lHmOma;
        "pkg-2.6.6+1.21.4" = _S5NIyamW;
        "pkg-2.6.6+1.21.5" = _UV6dQNB0;
        "pkg-2.6.6+1.21.8" = _bIMeAlZy;
        "pkg-2.6.6+1.21.10" = _1yC3sNXI;
        "pkg-2.6.6+1.21.11" = _RLCaU0Pn;
        "pkg-3.0.0-beta.1+26.1-rc-2" = _kFBHzC5k;
        "pkg-3.0.0-beta.2+26.1" = _xuaBYGPK;
        "pkg-3.0.0+26.1" = _UAMrrXwl;
        "pkg-2.6.7+1.20.1" = _AdBrp3Ze;
        "pkg-2.6.7+1.21.1" = _MOR4AcZe;
        "pkg-2.6.7+1.21.4" = _aAozncYt;
        "pkg-2.6.7+1.21.3" = _shoFsv5k;
        "pkg-2.6.7+1.21.5" = _RLhOdT5G;
        "pkg-2.6.7+1.21.8" = _5LumRthR;
        "pkg-2.6.7+1.21.10" = _1ciyBzmR;
        "pkg-2.6.7+1.21.11" = _RpeQnplx;
        "pkg-3.2.1+26.1.2" = _pxOGuJKJ;
        "pkg-2.6.8+1.20.1" = _N8IGr20o;
        "pkg-2.6.8+1.21.1" = _klcfwgJy;
        "pkg-2.6.8+1.21.3" = _nBrzMbcC;
        "pkg-2.6.8+1.21.4" = _RsGclCcW;
        "pkg-2.6.8+1.21.5" = _6QsMpuLU;
        "pkg-2.6.8+1.21.8" = _zzPNLw9m;
        "pkg-2.6.8+1.21.10" = _5M0aa5y9;
        "pkg-2.6.8+1.21.11" = _IJshwMOT;
        "pkg-3.2.2+26.1.2" = _lqLDqxBb;
        "pkg-3.2.3+26.1.2" = _U2vJUODR;
        "pkg-2.6.9+1.20.1" = _vfXo8Wvn;
        "pkg-2.6.9+1.21.1" = _pLtuARnM;
        "pkg-2.6.9+1.21.3" = _GkPHa6M6;
        "pkg-2.6.9+1.21.4" = _GIpWmNX9;
        "pkg-2.6.9+1.21.5" = _JKz4d8BT;
        "pkg-2.6.9+1.21.8" = _YNC0cJM7;
        "pkg-2.6.9+1.21.10" = _ZVHfy3hm;
        "pkg-2.6.9+1.21.11" = _RDBy574X;
        "pkg-3.2.4+26.1.2" = _dsoQDzqn;
        "pkg-3.3.0-beta.1+26.2-pre-2" = _YmKqs1A5;
        "pkg-3.102.5+26.1.2" = _UWFmhcps;
