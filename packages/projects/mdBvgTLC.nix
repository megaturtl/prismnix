...
let
    versions = (let
        ...
        _zowISxI2 = {
            "id" = "zowISxI2";
            "file" = "Pool-Resourcepack-v1.3.6-mc1.21plus.zip";
            "hash" = "sha512-8JrBXYzGIMEDrlxXBHJCBmgJLT2FSox/jITxcsMwGZXZS1USQETzrgYy18YDzDfuAVy8WaG3FfPV+EE5FOE4xg==";
        };
    in {
        "tbvYcyIJ" = _tbvYcyIJ;
        "Y8VKI1jE" = _Y8VKI1jE;
        ...
        "minecraft-1.21" = _zowISxI2;
        "minecraft-1.21.1" = _zowISxI2;
        "minecraft-1.21.2" = _zowISxI2;
        "minecraft-1.21.3" = _zowISxI2;
        "minecraft-1.21.4" = _zowISxI2;
        "minecraft-1.21.5" = _zowISxI2;
        "minecraft-1.21.6" = _zowISxI2;
        "minecraft-1.21.7" = _zowISxI2;
        "minecraft-1.21.8" = _zowISxI2;
        "minecraft-1.21.9" = _zowISxI2;
        "minecraft-1.21.10" = _zowISxI2;
        "minecraft-1.21.11" = _zowISxI2;
        "minecraft-24w33a" = _zowISxI2;
        "minecraft-24w34a" = _zowISxI2;
        "minecraft-24w35a" = _zowISxI2;
        "minecraft-24w36a" = _zowISxI2;
        "minecraft-24w37a" = _zowISxI2;
        "minecraft-24w38a" = _zowISxI2;
        "minecraft-24w39a" = _zowISxI2;
        "minecraft-24w40a" = _zowISxI2;
        "minecraft-1.21.2-pre1" = _zowISxI2;
        "minecraft-1.21.2-pre2" = _zowISxI2;
        "minecraft-24w44a" = _zowISxI2;
        "minecraft-24w45a" = _zowISxI2;
        "minecraft-24w46a" = _zowISxI2;
        "minecraft-1.16" = _gVfpDRy4;
        "minecraft-1.16.1" = _gVfpDRy4;
        "minecraft-26.1" = _zowISxI2;
        "minecraft-26.1.1" = _zowISxI2;
        "minecraft-26.1.2" = _zowISxI2;
        "minecraft-26.2" = _zowISxI2;
        "minecraft-26.3" = _zowISxI2;
        ...
        "pkg-v1.3.6-mc1.21plus" = _zowISxI2;
        "default" = _zowISxI2;
    });
