...
let
    ...
    in {
        ...
        "pkg-1.6.8" = _JfLlQyDk;
        "pkg-1.6.9" = _9AQyeQQ8;
        "pkg-1.6.10" = _HkiGzbMD;
        "pkg-1.6.11" = _XwhZwIKJ;
        "pkg-1.6.12" = _IwQXABtp;
        "pkg-1.6.13" = _59T6nzY8;
        "pkg-1.6.14" = _A4v6afCD;
        "pkg-1.6.15" = _aPu4SpYm;
        "pkg-1.6.16" = _uWtNrLkT;
        "pkg-1.6.17" = _mVFhr44o;
