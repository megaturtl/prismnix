...
let
    versions = (let
        ...
        _45BTgYAJ = {
            "id" = "45BTgYAJ";
            "file" = "BetterStructures.jar";
            "hash" = "sha512-XxjXGGXRsyQDtIW7ApWCABI300eVUCWnUPmy9CFf//ki5wVXtEe9xTgH0O+aYcRTTpYKi+mxqsGabU6JE4vVVQ==";
        };
        _GF1zq4hi = {
            "id" = "GF1zq4hi";
            "file" = "BetterStructures.jar";
            "hash" = "sha512-4TdS1f2ig0JSdXu1FogwfsbgdjF6keuVfTHYSi/fSJtx8Xl6oEPqBLJfBCHzvOMr6uU6/Jx6uUfNZC1qJRAVuA==";
        };
        _JRWnt3qx = {
            "id" = "JRWnt3qx";
            "file" = "BetterStructures.jar";
            "hash" = "sha512-2Dajy+Qp6jKqmNk/luJYnzUv5smkhPXDi+h0X4JV3gHkZferPFx4kVXl3if/9spP+uFNVilZXsI8YahG3bk4SA==";
        };
        _2DHvwwMJ = {
            "id" = "2DHvwwMJ";
            "file" = "BetterStructures.jar";
            "hash" = "sha512-jDgLAPffYuw5q+mHvUiLFNkxetfoYMTa/v7Ot/wzUzwg12Bc2Pdumdo7o5ONNqkB+H5V/tx+dE/pQPV4EByLwA==";
        };
        _YARMuN5N = {
            "id" = "YARMuN5N";
            "file" = "BetterStructures.jar";
            "hash" = "sha512-zyFloNH5RhorNKx18x/3itqEpXAgYyE85Ag4Rv6IGuJI7jSU9njFcvjBJctn1BlH5YrN7dEapFSpkp6cBrsM+w==";
        };
    in {
        "4iaYHypu" = _4iaYHypu;
        "6yTK8OCv" = _6yTK8OCv;
        ...
        "paper-1.21.4" = _YARMuN5N;
        "paper-1.21.5" = _YARMuN5N;
        "paper-1.21.6" = _YARMuN5N;
        "paper-1.21.7" = _YARMuN5N;
        "paper-1.21.8" = _YARMuN5N;
        "paper-1.14" = _6yTK8OCv;
        "paper-1.14.1" = _6yTK8OCv;
        "paper-1.14.2" = _6yTK8OCv;
        "paper-1.14.3" = _6yTK8OCv;
        "paper-1.14.4" = _6yTK8OCv;
        "paper-1.21.9" = _YARMuN5N;
        "paper-1.21.10" = _YARMuN5N;
        "paper-1.21.11" = _YARMuN5N;
        "paper-26.1" = _YARMuN5N;
        "paper-26.1.1" = _YARMuN5N;
        "paper-26.1.2" = _YARMuN5N;
        "paper-26.2" = _YARMuN5N;
        "paper-26.3" = _YARMuN5N;
        ...
        "purpur-1.21.4" = _YARMuN5N;
        "purpur-1.21.5" = _YARMuN5N;
        "purpur-1.21.6" = _YARMuN5N;
        "purpur-1.21.7" = _YARMuN5N;
        "purpur-1.21.8" = _YARMuN5N;
        "purpur-1.14" = _6yTK8OCv;
        "purpur-1.14.1" = _6yTK8OCv;
        "purpur-1.14.2" = _6yTK8OCv;
        "purpur-1.14.3" = _6yTK8OCv;
        "purpur-1.14.4" = _6yTK8OCv;
        "purpur-1.21.9" = _YARMuN5N;
        "purpur-1.21.10" = _YARMuN5N;
        "purpur-1.21.11" = _YARMuN5N;
        "purpur-26.1" = _YARMuN5N;
        "purpur-26.1.1" = _YARMuN5N;
        "purpur-26.1.2" = _YARMuN5N;
        "purpur-26.2" = _YARMuN5N;
        "purpur-26.3" = _YARMuN5N;
        ...
        "spigot-1.21.4" = _YARMuN5N;
        "spigot-1.21.5" = _YARMuN5N;
        "spigot-1.21.6" = _YARMuN5N;
        "spigot-1.21.7" = _YARMuN5N;
        "spigot-1.21.8" = _YARMuN5N;
        "spigot-1.14" = _6yTK8OCv;
        "spigot-1.14.1" = _6yTK8OCv;
        "spigot-1.14.2" = _6yTK8OCv;
        "spigot-1.14.3" = _6yTK8OCv;
        "spigot-1.14.4" = _6yTK8OCv;
        "spigot-1.21.9" = _YARMuN5N;
        "spigot-1.21.10" = _YARMuN5N;
        "spigot-1.21.11" = _YARMuN5N;
        "spigot-26.1" = _YARMuN5N;
        "spigot-26.1.1" = _YARMuN5N;
        "spigot-26.1.2" = _YARMuN5N;
        "spigot-26.2" = _YARMuN5N;
        "spigot-26.3" = _YARMuN5N;
        "pkg-1.8.3" = _4iaYHypu;
        "pkg-2.0.0" = _6yTK8OCv;
        "pkg-2.0.1" = _zQ520r2Z;
        "pkg-2.0.2" = _XCiQTdwW;
