...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.3-forge" = _JkXI7qch;
        "pkg-1.18.2-1.4-forge" = _7ygtiqRA;
        "pkg-1.19.2-1.6-forge" = _TABTAps4;
        "pkg-1.16.5-2.0-fabric" = _xzAmNjAH;
        "pkg-1.18.2-2.0-fabric" = _fVhPfomp;
        "pkg-1.19.2-2.0-fabric" = _M4wdI7eH;
        "pkg-1.16.5-2.0-forge" = _hyMCSJZ3;
        "pkg-1.18.2-2.0-forge" = _OsWrrAAh;
        "pkg-1.19.2-2.0-forge" = _wr9W7Jm4;
        "pkg-1.16.5-2.1-fabric" = _RFg6XAHZ;
        "pkg-1.18.2-2.1-fabric" = _Zaw4WKW7;
        "pkg-1.19.2-2.1-fabric" = _tlIyO8zT;
        "pkg-1.19.3-2.2-fabric" = _mF2wFgy8;
        "pkg-1.19.3-2.0-forge" = _lJBCGt7t;
        "pkg-1.18.2-3.0-forge+fabric" = _FRdyYTEZ;
        "pkg-1.19.2-3.0-forge+fabric" = _KYJMVxjw;
        "pkg-1.19.3-3.0-forge+fabric" = _IDQaAAMG;
        "pkg-1.19.4-3.0-forge+fabric" = _MPKa2sgH;
        "pkg-1.20-3.0-forge+fabric" = _o9TiahqZ;
        "pkg-1.20.1-3.0-forge+fabric" = _SZ97jNK9;
        "pkg-1.20.2-3.0-forge+fabric" = _EC8pyz6J;
        "pkg-1.18.2-3.1-forge+fabric" = _FpIUilCH;
        "pkg-1.19.2-3.1-forge+fabric" = _p67PMgFs;
        "pkg-1.20.1-3.1-forge+fabric" = _MvHlG8lq;
        "pkg-1.20.2-3.1-forge+fabric" = _aAhS4Ag9;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _LuqYZRGk;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _astElKXZ;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _Lcmg6KrX;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _AX98rjQl;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _Uu58TEQ2;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _fe5F6eiL;
        "pkg-1.19.2-3.3-fabric+forge" = _rc0iDkuD;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _91kWmpro;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _D1mdy4OI;
        "pkg-1.20.5-3.3-fabric+neo" = _DWhnb7qp;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _Pl0eAoGx;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _lfV0Uzr5;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _JLYAKRz1;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _PWSTxQH6;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _iwf2HxnU;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _7DifWER1;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _GfA9m44Q;
        "pkg-1.21.2-3.5-fabric+neo" = _VaJZjktG;
        "pkg-1.21.3-3.5-fabric+forge+neo" = _3905eD9f;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _5AriqgKU;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _fpKkBC4T;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _ipuMshLc;
        "pkg-1.21.4-3.6-fabric+forge+neo" = _QWUIYTco;
        "pkg-1.21.5-3.6-fabric+forge+neo" = _3hSfooyO;
        "pkg-1.21.6-3.6-fabric+forge+neo" = _X86krQPs;
        "pkg-1.21.7-3.6-fabric+forge+neo" = _VLQcS55h;
        "pkg-1.21.8-3.6-fabric+forge+neo" = _kBg5RBAE;
        "pkg-1.21.9-3.6-fabric+forge+neo" = _9NIp2crt;
        "pkg-1.21.10-3.6-fabric+forge+neo" = _NhqEKwJ2;
        "pkg-1.21.11-3.6-fabric+forge+neo" = _dpp5X1Nh;
        "pkg-26.1.0-3.6-fabric+forge+neo" = _DVlTYWEN;
        "pkg-26.1.0-3.7-fabric+forge+neo" = _DpNEt0Gu;
        "pkg-26.1.1-3.7-fabric+forge+neo" = _FhkVPUVf;
        "pkg-26.1.2-3.7-fabric+forge+neo" = _3DLJ6prg;
        "pkg-1.20.1-3.8-fabric+forge+neo" = _8cSCUvBy;
        "pkg-1.21.1-3.8-fabric+forge+neo" = _GIGoRmUe;
