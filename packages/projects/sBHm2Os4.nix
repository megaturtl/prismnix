...
let
    versions = (let
        ...
        _8gCd54HG = {
            "id" = "8gCd54HG";
            "file" = "auraKills-1.9.jar";
            "hash" = "sha512-czPX1kBF+rwgjMGwkUjbt+i4sldDud22l75uFTJuI8/eDqhAE0L1MnVkMjx7ouM3A+qNYUAeeyTuYEJaltDY6w==";
        };
    in {
        "OI69oLhG" = _OI69oLhG;
        "wWq5LWBM" = _wWq5LWBM;
        ...
        "bukkit-1.21" = _8gCd54HG;
        "bukkit-1.21.1" = _8gCd54HG;
        "bukkit-1.21.2" = _8gCd54HG;
        "bukkit-1.21.3" = _8gCd54HG;
        "bukkit-1.21.4" = _8gCd54HG;
        "bukkit-1.21.5" = _8gCd54HG;
        "bukkit-1.21.6" = _8gCd54HG;
        "bukkit-1.21.7" = _8gCd54HG;
        "bukkit-1.21.8" = _8gCd54HG;
        "bukkit-1.21.9" = _8gCd54HG;
        "bukkit-1.21.10" = _8gCd54HG;
        "bukkit-1.21.11" = _8gCd54HG;
        "bukkit-26.1" = _8gCd54HG;
        "bukkit-26.1.1" = _8gCd54HG;
        "bukkit-26.1.2" = _8gCd54HG;
        "bukkit-26.2" = _8gCd54HG;
        "bukkit-26.3" = _8gCd54HG;
        ...
        "paper-1.21" = _8gCd54HG;
        "paper-1.21.1" = _8gCd54HG;
        "paper-1.21.2" = _8gCd54HG;
        "paper-1.21.3" = _8gCd54HG;
        "paper-1.21.4" = _8gCd54HG;
        "paper-1.21.5" = _8gCd54HG;
        "paper-1.21.6" = _8gCd54HG;
        "paper-1.21.7" = _8gCd54HG;
        "paper-1.21.8" = _8gCd54HG;
        "paper-1.21.9" = _8gCd54HG;
        "paper-1.21.10" = _8gCd54HG;
        "paper-1.21.11" = _8gCd54HG;
        "paper-26.1" = _8gCd54HG;
        "paper-26.1.1" = _8gCd54HG;
        "paper-26.1.2" = _8gCd54HG;
        "paper-26.2" = _8gCd54HG;
        "paper-26.3" = _8gCd54HG;
        ...
        "spigot-1.21" = _8gCd54HG;
        "spigot-1.21.1" = _8gCd54HG;
        "spigot-1.21.2" = _8gCd54HG;
        "spigot-1.21.3" = _8gCd54HG;
        "spigot-1.21.4" = _8gCd54HG;
        "spigot-1.21.5" = _8gCd54HG;
        "spigot-1.21.6" = _8gCd54HG;
        "spigot-1.21.7" = _8gCd54HG;
        "spigot-1.21.8" = _8gCd54HG;
        "spigot-1.21.9" = _8gCd54HG;
        "spigot-1.21.10" = _8gCd54HG;
        "spigot-1.21.11" = _8gCd54HG;
        "spigot-26.1" = _8gCd54HG;
        "spigot-26.1.1" = _8gCd54HG;
        "spigot-26.1.2" = _8gCd54HG;
        "spigot-26.2" = _8gCd54HG;
        "spigot-26.3" = _8gCd54HG;
