...
let
    ...
    in {
        ...
        "pkg-0.2-1.20.1" = _1ll2Ek0w;
        "pkg-0.3-1.21" = _Svqb3WIo;
        "pkg-0.3.1-1.21" = _HuZcKo12;
        "pkg-0.3.2" = _htBw9vjV;
        "pkg-0.3.3" = _7hvSfrVo;
        "pkg-0.3.4-1.21.1" = _jzSnp4NG;
        "pkg-0.5.0-1.21.5" = _3BDfkblN;
        "pkg-0.5.1-1.21.5" = _cR7v1RpY;
        "pkg-0.5.1-1.21.1" = _Bqy4ybd4;
        "pkg-0.5.2-1.21.5" = _oI7BZg4R;
        "pkg-0.5.3-1.21.5" = _NnxM4vjh;
        "pkg-0.5.3-1.21.1" = _gmO0dCcX;
        "pkg-0.5.4-1.21.5" = _ALeHSeAq;
        "pkg-0.5.5-1.21.1" = _2vrfaZPJ;
        "pkg-0.5.6-1.21.1" = _3XWuKaVc;
        "pkg-0.5.6-1.21.5" = _xYCeuchq;
        "pkg-0.5.7-1.21.1" = _ZCfxicPj;
