...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.5-forge" = _jl4qWxY5;
        "pkg-1.18.2-1.6-forge" = _3sQRIr7R;
        "pkg-1.19.2-1.8-forge" = _OVljatz2;
        "pkg-1.16.5-2.1-fabric" = _mPV1LSrH;
        "pkg-1.18.2-2.1-fabric" = _NvoVT06L;
        "pkg-1.19.2-2.1-fabric" = _XGpR45wy;
        "pkg-1.19.3-2.2-fabric" = _wDeBlCDj;
        "pkg-1.19.3-1.8-forge" = _aFBWilXl;
        "pkg-1.18.2-3.0-forge+fabric" = _tpqvyvh0;
        "pkg-1.19.2-3.0-forge+fabric" = _K14XRRBk;
        "pkg-1.19.3-3.0-forge+fabric" = _okc4YaJq;
        "pkg-1.19.4-3.0-forge+fabric" = _UokVxraT;
        "pkg-1.20-3.0-forge+fabric" = _Y03Xk82k;
        "pkg-1.20.1-3.0-forge+fabric" = _IOWwuxky;
        "pkg-1.20.2-3.0-forge+fabric" = _TP0nLASo;
        "pkg-1.18.2-3.1-forge+fabric" = _EpjQgMkL;
        "pkg-1.19.2-3.1-forge+fabric" = _VpRBIyt2;
        "pkg-1.20.1-3.1-forge+fabric" = _Wi58NwzJ;
        "pkg-1.20.2-3.1-forge+fabric" = _3VEbTHlN;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _LHO8hOhH;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _GBr1kSYS;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _osu0fWd1;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _lxaXWQmo;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _RNXZIVhg;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _ENOLc0l7;
        "pkg-1.20.5-3.2-fabric+neo" = _PqmaMJWv;
        "pkg-1.20.6-3.2-fabric+forge+neo" = _je2sdklW;
        "pkg-1.21.0-3.2-fabric+forge+neo" = _GMvHqLKy;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _mH7H05mh;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _Qds6Qg4h;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _g5ED4w8B;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _lryBt5u7;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _Z1RiLkcY;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _xZ2sWkpI;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _D9HC4wsy;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _H8wzRcpU;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _PmE5s6zJ;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _qx8mjq68;
        "pkg-1.21.2-3.5-fabric+neo" = _1WJooq37;
        "pkg-1.21.3-3.5-fabric+forge+neo" = _4iqAZcUN;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _FrZzAEND;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _8dvHq4gs;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _PVx8sPK6;
        "pkg-1.21.4-3.6-fabric+forge+neo" = _jbnDBycN;
        "pkg-1.21.5-3.6-fabric+forge+neo" = _WLUcEC9w;
        "pkg-1.21.6-3.6-fabric+forge+neo" = _S8jGkIoj;
        "pkg-1.21.7-3.6-fabric+forge+neo" = _6LIKnJ0J;
        "pkg-1.21.8-3.6-fabric+forge+neo" = _9ZWYtyGx;
        "pkg-1.21.9-3.6-fabric+forge+neo" = _RpWpOeg4;
        "pkg-1.21.10-3.6-fabric+forge+neo" = _Es8ERcfb;
        "pkg-1.21.11-3.6-fabric+forge+neo" = _wvyB4zHg;
        "pkg-26.1.0-3.6-fabric+forge+neo" = _DZnk67sl;
