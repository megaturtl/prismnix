...
let
    ...
    in {
        ...
        "pkg-0.0.3" = _gwwg4WqX;
        "pkg-0.0.4" = _VycSXNoO;
        "pkg-0.0.4-fabric" = _T1r2v6b1;
        "pkg-0.0.5" = _hNiL73Fv;
        "pkg-0.0.5-fabric" = _SBIfGHiZ;
        "pkg-forge-1.20.1-0.1.0" = _OPDRmlwQ;
        "pkg-forge-1.18.2-0.1.0" = _cGUA8xpW;
        "pkg-forge-1.19.2-0.1.0" = _2mbOjVnd;
        "pkg-forge-1.21.1-0.1.0" = _jeggHcH0;
        "pkg-0.1.0" = _s1uFXFq5;
        "pkg-Fabric-1.19.2-0.1.0" = _u3x7q9vG;
        "pkg-Fabric-1.20.1-0.1.0" = _OBGzXrAz;
        "pkg-forge-1.18.2-0.2.0" = _xHUNGiYl;
        "pkg-forge-1.19.2-0.2.0" = _M7nK64SU;
        "pkg-forge-1.20.1-0.2.0" = _yuxzgNen;
        "pkg-forge-1.21.1-0.2.0" = _5tVzRnZq;
        "pkg-Fabric-1.18.2-0.2.0" = _TnO5V14V;
        "pkg-Fabric-1.19.2-0.2.0" = _ghOlgCNx;
        "pkg-Fabric-1.20.1-0.2.0" = _pNIN9Sj3;
        "pkg-Fabric-1.21.1-0.2.0" = _d40paOYO;
        "pkg-forge-1.18.2-0.2.1" = _XuQkAJy1;
        "pkg-forge-1.19.2-0.2.1" = _2HSyZIF1;
        "pkg-forge-1.20.1-0.2.1" = _Ao3fwCZr;
        "pkg-forge-1.21.1-0.2.1" = _mW1rwwt7;
        "pkg-Fabric-1.21.4-0.2.1" = _BIm1nVd5;
        "pkg-1.18.2-0.2.1" = _j0ygLnoa;
        "pkg-1.19.2-0.2.1" = _Lq3PKzHH;
        "pkg-1.20.1-0.2.1" = _arQPxvsN;
        "pkg-1.21.1-0.2.1" = _MaNZuW9Y;
        "pkg-1.18.2-0.4.1" = _MLJXqakV;
        "pkg-1.19.2-0.4.1" = _srRIe03C;
        "pkg-1.20.1-0.4.1" = _lA5aMtD3;
        "pkg-1.21.1-0.4.1" = _Bc0i0Gct;
        "pkg-forge-1.18.2-0.4.1" = _pEs9984L;
        "pkg-forge-1.19.2-0.4.1" = _qFjhzpkI;
        "pkg-forge-1.20.1-0.4.1" = _PW9hKViV;
        "pkg-neoforge-1.21.1-0.4.1" = _KPjzMn9B;
        "pkg-forge-1.21.1-0.4.1" = _LGwfXMZG;
        "pkg-forge-1.16.5-0.4.1" = _r7kHoVlV;
        "pkg-neoforge-1.21.1-0.6.1" = _a54jwN6U;
        "pkg-forge-1.21.1-0.6.1" = _RkoDEPuj;
        "pkg-forge-1.18.2-0.6.1" = _XnX0hQ5a;
        "pkg-forge-1.16.5-0.6.1" = _tFgIXVkn;
        "pkg-forge-1.19.2-0.6.1" = _G0JZcmmG;
        "pkg-forge-1.20.1-0.6.1" = _moZX3TdE;
        "pkg-1.18.2-0.6.2" = _r5fdzNQS;
        "pkg-1.19.2-0.6.2" = _2XAXkggO;
        "pkg-1.20.1-0.6.2" = _fX3VLsIn;
        "pkg-1.21.1-0.6.2" = _gd0Tfo5x;
        "pkg-neoforge-1.21.1-0.6.2" = _AAVwgaTo;
        "pkg-forge-1.21.1-0.6.2" = _XtQwDIVk;
        "pkg-forge-1.16.5-0.6.2" = _ugL6FgYB;
        "pkg-forge-1.18.2-0.6.2" = _LhlcwARn;
        "pkg-forge-1.19.2-0.6.2" = _dWLloKWb;
        "pkg-forge-1.20.1-0.6.2" = _hzhcN4HQ;
        "pkg-forge-1.21.1-0.8.2" = _L0eg8ebR;
        "pkg-forge-1.19.2-0.8.2" = _OJvdOL5c;
        "pkg-neoforge-1.21.1-0.8.2" = _SDDbSF99;
        "pkg-forge-1.18.2-0.8.2" = _gtGrtyCP;
        "pkg-forge-1.20.1-0.8.2" = _hTkgZ3pe;
        "pkg-1.18.2-0.8.2" = _akjZZn65;
        "pkg-1.19.2-0.8.2" = _kyumeiVc;
        "pkg-1.20.1-0.8.2" = _7QP2ESJg;
        "pkg-1.21.4-0.8.2" = _L7YOSjP6;
        "pkg-1.21.1-0.8.2" = _JjcLKpsj;
        "pkg-forge-1.21.4-0.8.2" = _22HZa0hW;
        "pkg-neoforge-1.21.4-0.8.2" = _qgh1LmAO;
        "pkg-forge-1.20.1-0.8.5" = _XodilhUp;
        "pkg-forge-1.20.1-0.8.6" = _2JrLJJ4R;
        "pkg-neoforge-1.21.1-0.8.4" = _5mpHBfmn;
        "pkg-forge-1.21.1-0.8.4" = _3Wq2LGes;
        "pkg-forge-1.16.5-0.8.2" = _tRn8TME3;
        "pkg-forge-1.18.2-0.8.4" = _WXTOTRbN;
        "pkg-forge-1.19.2-0.8.4" = _OI0Nbma9;
        "pkg-1.20.1-0.8.6" = _OavhxgV0;
        "pkg-forge-1.18.2-1.0.0" = _AkGQCJVR;
        "pkg-forge-1.19.2-1.0.0" = _ht5bcuVO;
        "pkg-forge-1.20.1-1.0.0" = _onqI7MXh;
        "pkg-forge-1.21.1-1.0.0" = _AnBIDKNZ;
        "pkg-forge-1.21.4-1.0.0" = _MTv6f95a;
        "pkg-neoforge-1.21.4-1.0.0" = _X3ZQNqEq;
        "pkg-forge-1.18.2-1.0.1" = _Be0QcfHr;
        "pkg-forge-1.19.2-1.0.1" = _wXwTFo88;
        "pkg-forge-1.20.1-1.0.1" = _qz0O0wj6;
        "pkg-neoforge-1.21.1-1.0.0" = _SE9Atxuh;
        "pkg-forge-1.20.1-1.1.1" = _oDf2nP95;
        "pkg-forge-1.20.1-1.1.2" = _uIpqJZmQ;
        "pkg-forge-1.18.2-1.1.1" = _oXzFUBt3;
        "pkg-forge-1.19.2-1.1.1" = _zXuYhUK5;
        "pkg-forge-1.20.1-1.2.2" = _ywvZ8KUD;
        "pkg-neoforge-1.21.5-1.0.0" = _nBsuHkcF;
        "pkg-forge-1.20.1-1.4.2" = _EHmjQfIC;
        "pkg-fabric-1.21.4-1.0.0" = _dicnLg6b;
        "pkg-fabric-1.21.4-1.0.1" = _kS0UM7ZD;
        "pkg-forge-1.18.2-2.0.0-beta" = _79ByC2fr;
        "pkg-forge-1.19.2-2.0.0-beta" = _KOUkVjRq;
        "pkg-neoforge-1.21.1-2.0.0-beta" = _cKGuDRv9;
        "pkg-forge-1.21.1-2.0.0-beta" = _xiFMv1Sc;
        "pkg-forge-1.20.1-2.0.0-beta" = _lvtTZFWB;
        "pkg-forge-1.16.5-2.0.0" = _2gP89ttX;
        "pkg-forge-1.18.2-2.0.0" = _QHYVQBfy;
        "pkg-forge-1.19.2-2.0.0" = _cNUfhlyu;
        "pkg-forge-1.20.1-2.0.0" = _kvakiCaf;
        "pkg-forge-1.21.1-2.0.0" = _vesUd7dD;
        "pkg-forge-1.21.10" = _TeRXfZD3;
        "pkg-forge-1.21.11" = _9WPHT0vc;
        "pkg-forge-2.0.0-1.21.3" = _VwId0EXR;
        "pkg-forge-2.0.0-1.21.4" = _44F8fS6D;
        "pkg-forge-2.0.0-1.21.5" = _AdRSW2OS;
        "pkg-forge-1.21.6" = _LnZ5R6A5;
        "pkg-forge-1.21.7" = _32JbN7qD;
        "pkg-forge-1.21.8" = _zX7x2vyW;
        "pkg-forge-1.21.9" = _8EKfdPyX;
        "pkg-neoforge-1.21.7" = _r0LSuajV;
        "pkg-neoforge-1.21.6" = _REIDkBzy;
        "pkg-neoforge-1.21.4" = _dkB4D7Lh;
        "pkg-neoforge-1.21.11" = _P1RQsXLv;
        "pkg-neoforge-1.21.5" = _p3B4uBaS;
        "pkg-neoforge-1.21.8" = _raYf4jAv;
        "pkg-neoforge-1.21.3" = _8KjUttNG;
        "pkg-neoforge-1.21.10" = _t1Xd1XpO;
        "pkg-neoforge-1.21.2" = _UIMO6L1Y;
        "pkg-neoforge-1.21.9" = _II9J9Dks;
        "pkg-neoforge-1.21.1" = _zn90eeHp;
        "pkg-1.20.1-2.0.1" = _JdDp9eKS;
        "pkg-2.0.0-beta-fabric-v1" = _GREgLvsw;
        "pkg-2.0.0-beta-fabric-v2" = _kRoKX9Tz;
        "pkg-1.18.2-2.0.2-beta-v1" = _wDqeD5LU;
        "pkg-1.19.2-2.0.2-beta-v1" = _oV1FXxnL;
        "pkg-1.20.1-2.0.2-beta-v1" = _F1C2x841;
        "pkg-1.18.2-2.0.2-beta-v2" = _AjCLQtG7;
        "pkg-1.19.2-2.0.2-beta-v2" = _RS5oHidq;
        "pkg-1.20.1-2.0.2-beta-v2" = _wMIs4YwN;
        "pkg-1.18.2-2.0.2-beta-v3" = _iV22SmCW;
        "pkg-1.19.2-2.0.2-beta-v3" = _aR43VyJ0;
        "pkg-1.20.1-2.0.2-beta-v3" = _jXbIcGMI;
        "pkg-1.18.2-2.0.2" = _VSqwELfl;
        "pkg-1.19.2-2.0.2" = _39PN9pzY;
        "pkg-1.20.1-2.0.2" = _qqiNtj1z;
        "pkg-2.1.0-beta-fabric" = _9EKi3q0T;
        "pkg-2.1.1-beta-fabric" = _NF5368a7;
        "pkg-2.1.2-beta-fabric" = _AQeIXOlb;
