...
let
    ...
    in {
        ...
        "pkg-1.0.2" = _2hogVVJ3;
        "pkg-1.0.3+1.21.4-neoforge" = _qRqnocMA;
        "pkg-1.0.4+1.21.4-fabric" = _NGJDOyPM;
        "pkg-1.0.5+1.20.1-fabric" = _QEhVZpzF;
        "pkg-1.0.5+1.20.1-forge" = _JdGyKJNp;
        "pkg-1.0.5+1.21.1-fabric" = _RzS4JAU8;
        "pkg-1.0.5+1.21.1-neoforge" = _nugkKMjk;
        "pkg-1.0.5+1.21.4-fabric" = _Y7Ui9VTJ;
        "pkg-1.0.5+1.21.4-neoforge" = _kczHGHxI;
        "pkg-1.0.6+1.16.5-fabric" = _y3qJptEN;
        "pkg-1.0.6+1.16.5-forge" = _rZUT6EMT;
        "pkg-1.0.6+1.18.2-fabric" = _dxwEF6m3;
        "pkg-1.0.6+1.18.2-forge" = _9NAs6ZnW;
        "pkg-1.0.6+1.19.2-fabric" = _4E7AkdJE;
        "pkg-1.0.6+1.19.2-forge" = _Zh5IVRvO;
        "pkg-1.0.6+1.20.1-fabric" = _cEnvu2YH;
        "pkg-1.0.6+1.21.1-fabric" = _nvJ76VDd;
        "pkg-1.0.6+1.21.1-neoforge" = _jPdoLfgq;
        "pkg-1.0.6+1.21.4-fabric" = _rx6A3KfX;
        "pkg-1.0.6+1.21.4-neoforge" = _USjXh8xs;
        "pkg-1.0.8+1.20.1-forge" = _rBwuccG7;
        "pkg-1.0.9+1.20.1-forge" = _htetfn2o;
        "pkg-1.0.7+1.19.2-forge" = _njKhb1o9;
        "pkg-1.0.7+1.18.2-forge" = _XpEI65FJ;
        "pkg-1.0.7+1.16.5-forge" = _jKbBOeMk;
        "pkg-1.0.10+1.16.1-forge" = _BJhbAzpj;
        "pkg-1.0.10+1.16.1-fabric" = _eIpZRX0l;
        "pkg-1.0.10+1.16.5-forge" = _HVJnzbjE;
        "pkg-1.0.10+1.16.5-fabric" = _zPcLqNjB;
        "pkg-1.0.10+1.18.2-forge" = _nJBJCXI6;
        "pkg-1.0.10+1.18.2-fabric" = _VPPjXnva;
        "pkg-1.0.10+1.19.2-forge" = _wpAWKJ20;
        "pkg-1.0.10+1.19.2-fabric" = _hpiXLUtF;
        "pkg-1.0.10+1.20.1-forge" = _ITNrPlcs;
        "pkg-1.0.10+1.20.1-fabric" = _v4gfT0i9;
        "pkg-1.0.10+1.21.1-neoforge" = _Axad8miZ;
        "pkg-1.0.10+1.21.1-fabric" = _WgynUIut;
        "pkg-1.0.10+1.21.4-fabric" = _DbVnwRLS;
        "pkg-1.0.10+1.21.4-neoforge" = _1C65vMnA;
        "pkg-1.1.1+1.21.4-fabric" = _XrQ4AhSJ;
        "pkg-1.1.1+1.21.4-neoforge" = _S1HuNG4P;
        "pkg-1.1.1+1.21.5-fabric" = _uBUMz6rF;
        "pkg-1.1.1+1.21.5-neoforge" = _C5XJcusv;
        "pkg-1.1.1+1.21.6-fabric" = _Vj2lSmzq;
        "pkg-1.1.1+1.21.6-neoforge" = _gjVMru9s;
        "pkg-1.1.2+1.21.9-fabric" = _GsXdEZQO;
        "pkg-1.0.11+1.20.1-fabric" = _CTg3JEhH;
        "pkg-1.0.11+1.20.1-forge" = _EazfspJH;
        "pkg-1.0.11+1.21.1-fabric" = _5NVb2pjC;
        "pkg-1.0.11+1.21.1-neoforge" = _GCoftSqH;
        "pkg-1.1.3+1.21.4-fabric" = _bHRg7trW;
        "pkg-1.1.3+1.21.4-neoforge" = _YhHXfNRx;
        "pkg-1.1.3+1.21.5-fabric" = _FBhfNLzt;
        "pkg-1.1.3+1.21.5-neoforge" = _3pAMXGnb;
        "pkg-1.1.3+1.21.6-fabric" = _S2NMAT3P;
        "pkg-1.1.3+1.21.6-neoforge" = _L6KEDtAB;
        "pkg-1.1.3+1.21.9-fabric" = _oyoGAefN;
        "pkg-1.1.3+1.21.9-neoforge" = _wtrdrPO2;
        "pkg-1.1.3+1.21.11-fabric" = _Vn3ke7rH;
        "pkg-1.1.3+1.21.11-neoforge" = _L21aFJjN;
        "pkg-1.0.12+1.21.1-fabric" = _522Wudew;
        "pkg-1.0.12+1.21.1-neoforge" = _eTz03Gfd;
        "pkg-1.1.4+1.21.4-fabric" = _xZAIc7wz;
        "pkg-1.1.4+1.21.4-neoforge" = _eDF0meWQ;
        "pkg-1.1.4+1.21.5-fabric" = _LetSEnpl;
        "pkg-1.1.4+1.21.5-neoforge" = _SaHEYXeb;
        "pkg-1.1.4+1.21.6-fabric" = _qvfSaFES;
        "pkg-1.1.4+1.21.6-neoforge" = _1TRcqXfM;
        "pkg-1.1.4+1.21.9-fabric" = _d0Vgh2W9;
        "pkg-1.1.4+1.21.9-neoforge" = _RgIoXmlj;
        "pkg-1.1.4+1.21.11-fabric" = _YDgvKeWI;
        "pkg-1.1.4+1.21.11-neoforge" = _NqxTbQNh;
