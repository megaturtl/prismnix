...
let
    ...
    in {
        ...
        "pkg-1.0.2" = _23dHizoP;
        "pkg-1.0.3" = _f8WH4qot;
        "pkg-mc1.20.1-1.0.4-forge" = _BOFCV7M2;
        "pkg-mc1.20.1-1.0.5-forge" = _gJVe1pu4;
        "pkg-mc1.20.1-1.0.5.a-forge" = _RJ3LllVd;
        "pkg-mc1.20.1-1.0.5.b-forge" = _r97DDHfc;
        "pkg-mc1.20.1-1.0.6-forge" = _Hw17ncPA;
        "pkg-mc1.20.1-1.0.7-forge" = _UV7kGymG;
        "pkg-mc1.20.1-1.0.7.a-forge" = _yJB8WPtW;
        "pkg-mc1.20.1-1.0.7.c-forge" = _rdcsCJqZ;
        "pkg-mc1.20.1-1.0.7.d-forge" = _4OV0mPcq;
        "pkg-mc1.20.1-1.0.8-forge" = _8KV5UGbC;
        "pkg-mc1.20.1-1.0.8.a-forge" = _nkPYZmkU;
        "pkg-mc1.20.1-1.0.9-forge" = _IUA2v9Qc;
        "pkg-mc1.20.1-1.0.9.a-forge" = _ksvhxZn8;
        "pkg-mc1.20.1-1.0.10-forge" = _e2JrdzIb;
        "pkg-mc1.20.1-1.0.10.a-forge" = _7LcF70A1;
        "pkg-mc1.20.1-1.0.10.b-forge" = _RBEDkFGE;
        "pkg-mc1.20.1-1.0.11-forge" = _2B92mESr;
        "pkg-mc1.20.1-1.0.12-forge" = _xpWfxEKg;
        "pkg-mc1.20.1-1.0.12.a-forge" = _nSyiwWTh;
        "pkg-mc1.20.1-1.0.12.b-forge" = _3FKzmQU4;
        "pkg-mc1.20.1-1.0.13-forge" = _CKGq8bFq;
        "pkg-mc1.20.1-1.0.13.a-forge" = _CFJZjDzh;
        "pkg-mc1.20.1-1.0.14-forge" = _llfSyVIj;
        "pkg-mc1.20.1-1.0.14.a-forge" = _4IQIszoK;
        "pkg-mc1.20.1-1.0.14.b-forge" = _GYOc2dPl;
        "pkg-mc1.20.1-1.0.14.c-forge" = _fUbyfqLd;
        "pkg-mc1.20.1-1.0.14.d-forge" = _JQ39Hn0X;
        "pkg-mc1.20.1-1.0.14.e-forge" = _Ao55G59u;
        "pkg-mc1.20.1-1.0.15-forge" = _C8gtAFky;
        "pkg-mc1.20.1-1.0.15.a-forge" = _QXGyRXJz;
        "pkg-mc1.20.1-1.0.16-forge" = _JYgsdnAj;
        "pkg-mc1.20.1-1.0.16.a-forge" = _ZwvpZifN;
        "pkg-mc1.20.1-1.0.17-forge" = _SQoPoJKb;
        "pkg-mc1.20.1-1.0.17.a-forge" = _haxHhsaP;
        "pkg-mc1.20.1-1.0.17.b-forge" = _TimGT4XK;
        "pkg-mc1.20.1-1.0.18-forge" = _EO9MTfnT;
        "pkg-mc1.20.1-1.0.19-forge" = _uirtK1tX;
        "pkg-mc1.20.1-1.0.19.a-forge" = _ADw3tJOR;
        "pkg-mc1.20.1-1.0.19.b-forge" = _gjivj1ia;
        "pkg-mc1.20.1-1.0.20-forge" = _xt9pr1tV;
        "pkg-mc1.20.1-1.0.21-forge" = _eZpj9S6b;
        "pkg-mc1.20.1-1.0.21.a-forge" = _lqvgvSik;
        "pkg-mc1.20.1-1.0.21.b-forge" = _81bXtrNO;
        "pkg-mc1.20.1-1.0.21.c-forge" = _gTpotYtR;
        "pkg-mc1.20.1-1.0.22-forge" = _8hHNFn4K;
        "pkg-mc1.20.1-1.0.22.a-forge" = _9gXvNh7E;
        "pkg-mc1.20.1-1.0.23-forge" = _ScFPMpMO;
        "pkg-mc1.20.1-1.0.24-forge" = _kN2VbqYv;
        "pkg-mc1.20.1-1.0.25-forge" = _XUSRm36z;
        "pkg-mc1.20.1-1.0.25.a-forge" = _ZRgNP1hy;
        "pkg-mc1.20.1-1.0.26-forge" = _QsJiTocx;
        "pkg-mc1.20.1-1.0.27-forge" = _n1Gjx8cC;
        "pkg-mc1.20.1-1.0.28-forge" = _poG1hJxh;
        "pkg-mc1.20.1-1.0.28.a-forge" = _WmuUKn87;
        "pkg-mc1.20.1-1.0.28.b-forge" = _ny7NGafJ;
        "pkg-mc1.20.1-1.0.29-forge" = _vkQWNo9w;
        "pkg-mc1.20.1-1.0.30-forge" = _UJp5In2c;
        "pkg-mc1.20.1-1.0.31-forge" = _abib93Bg;
        "pkg-mc1.20.1-1.0.31.a-forge" = _o23N6JYi;
        "pkg-mc1.20.1-1.0.32-forge" = _DQgHJcpJ;
        "pkg-mc1.20.1-1.0.33-forge" = _taEok7fV;
        "pkg-mc1.20.1-1.0.34-forge" = _L8wzWamC;
        "pkg-mc1.20.1-1.0.34.a-forge" = _Lpz4yvTY;
        "pkg-mc1.20.1-1.0.35-forge" = _d163VcVD;
        "pkg-mc1.20.1-1.0.36-forge" = _SIaokdkA;
        "pkg-mc1.20.1-1.0.37-forge" = _Wb8828aH;
        "pkg-mc1.20.1-1.0.38.a-forge" = _Uf8VhleU;
        "pkg-mc1.21.1-21.0.1-neoforge" = _JI122gGu;
        "pkg-mc1.21.1-21.0.2-neoforge" = _Tm4AOxoC;
        "pkg-mc1.21.1-21.0.3-neoforge" = _DZZtFZI1;
        "pkg-mc1.21.1-21.0.4-neoforge" = _7UAlO5Dh;
        "pkg-mc1.21.1-21.0.5-neoforge" = _jUVgX9h9;
        "pkg-mc1.21.1-21.0.5.a-neoforge" = _krll3muP;
        "pkg-mc1.21.1-21.0.6-neoforge" = _5DWZP7vO;
        "pkg-mc1.21.1-21.0.7-neoforge" = _HedDgCem;
        "pkg-mc1.21.1-21.0.8-neoforge" = _DSZhPz3V;
        "pkg-mc1.21.1-21.0.9-neoforge" = _PgXvdvtI;
