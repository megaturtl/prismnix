...
let
    versions = (let
        ...
        _3cYA00oT = {
            "id" = "3cYA00oT";
            "file" = "MT & Faithful64x Addon.zip";
            "hash" = "sha512-y5e4CwotJOj6rIdZlgtFB209DTBQjpDz3jmU09Kv2n0ri+LSU0231119zrQoFQniBppyMlZlkLA2ldmevXE9Bw==";
        };
        _djFaDNDw = {
            "id" = "djFaDNDw";
            "file" = "MT & Faithful32x Addon.zip";
            "hash" = "sha512-SBrxMOtOvOYzsEy8t1wrheZgyMKjcbwlPWWl4H5VdRJPeAQ9FJWcnStW3AHy+f/agQb8mvMi/slhLSDBmaAQZg==";
        };
        _vWpdQhUy = {
            "id" = "vWpdQhUy";
            "file" = "MT & Bare Bones Addon.zip";
            "hash" = "sha512-ybyAxQ4B0DwO39ueIRXiMEHHVq5Y5JI0UcT7sSvkVY912hWS4ZLs1RkdRKAfO9SkqZKlXoEoq6iEbYsHb0lzhQ==";
        };
        _LhZOlRWp = {
            "id" = "LhZOlRWp";
            "file" = "MT & Programmer Art 'Jappa' Addon.zip";
            "hash" = "sha512-K4BiRCkugrtTHNu/N8gK+C1TpZ8IusVIngmqP/StKcIOURhPhXJDK2XZky+uT6tRrFT8VeZV55k/FkL2EG72sA==";
        };
        _bZDzjCAC = {
            "id" = "bZDzjCAC";
            "file" = "MT & Programmer Art Addon.zip";
            "hash" = "sha512-xn0ii17AYCcH4Nc1BX6hs5wpLZC3/XtSfLhS4myh+bH4iXwmoRGTPUNpggHm7KAVH0Qn62RjDUIyD/L3pLwPBg==";
        };
        _dnxLVA4h = {
            "id" = "dnxLVA4h";
            "file" = "MT & Clear Glass 1.12 (Programmer Art) Addon.zip";
            "hash" = "sha512-7GFv7jxU+YQpafhPFWkPmSUuS0dWIsCDXyaofFBFLS0ainAdLUJG3I6XYHMlkKbVnINGI9uvyGUolrMKqkWOAw==";
        };
        _8BWLPrmB = {
            "id" = "8BWLPrmB";
            "file" = "MT & Clear Glass 'Tinted' Addon.zip";
            "hash" = "sha512-Ho3CsmeYursYN52sva4MBrte6454CDbs5vGhWKTyN/Ii22RFfy9SVxxODN2c7z5PGLa03N+ZndxXYVF5QghEog==";
        };
        _ntipQK3M = {
            "id" = "ntipQK3M";
            "file" = "MT & Clear Glass Addon.zip";
            "hash" = "sha512-VB15onJ27SrDqd/jTcGPCVIyIWGHAfI+MivSGEdYEaKebURC6IEVoOVjY+RDJ/YuhIXuWp/PtpSDCnorpgFvrQ==";
        };
    in {
        "TcxJkoIv" = _TcxJkoIv;
        "ZJhL8MTK" = _ZJhL8MTK;
        ...
        "minecraft-1.12" = _ntipQK3M;
        "minecraft-1.12.1" = _ntipQK3M;
        "minecraft-1.12.2" = _ntipQK3M;
        "minecraft-1.13" = _ntipQK3M;
        "minecraft-1.13.1" = _ntipQK3M;
        "minecraft-1.13.2" = _ntipQK3M;
        "minecraft-1.14" = _ntipQK3M;
        "minecraft-1.14.1" = _ntipQK3M;
        "minecraft-1.14.2" = _ntipQK3M;
        "minecraft-1.14.3" = _ntipQK3M;
        "minecraft-1.14.4" = _ntipQK3M;
        "minecraft-1.15" = _ntipQK3M;
        "minecraft-1.15.1" = _ntipQK3M;
        "minecraft-1.15.2" = _ntipQK3M;
        "minecraft-1.16" = _ntipQK3M;
        "minecraft-1.16.1" = _ntipQK3M;
        "minecraft-1.16.2" = _ntipQK3M;
        "minecraft-1.16.3" = _ntipQK3M;
        "minecraft-1.16.4" = _ntipQK3M;
        "minecraft-1.16.5" = _ntipQK3M;
        "minecraft-1.17" = _ntipQK3M;
        "minecraft-1.17.1" = _ntipQK3M;
        "minecraft-1.18" = _ntipQK3M;
        "minecraft-1.18.1" = _ntipQK3M;
        "minecraft-1.18.2" = _ntipQK3M;
        "minecraft-1.19" = _ntipQK3M;
        "minecraft-1.19.1" = _ntipQK3M;
        "minecraft-1.19.2" = _ntipQK3M;
        "minecraft-1.19.3" = _ntipQK3M;
        "minecraft-1.19.4" = _ntipQK3M;
        "minecraft-1.20" = _ntipQK3M;
        "minecraft-1.20.1" = _ntipQK3M;
        "minecraft-1.20.2" = _ntipQK3M;
        "minecraft-1.20.3" = _ntipQK3M;
        "minecraft-1.20.4" = _ntipQK3M;
        "minecraft-1.20.5" = _ntipQK3M;
        "minecraft-1.20.6" = _ntipQK3M;
        "minecraft-1.21" = _ntipQK3M;
        "minecraft-1.21.1" = _ntipQK3M;
        "minecraft-1.21.2" = _ntipQK3M;
        "minecraft-1.21.3" = _ntipQK3M;
        "minecraft-1.21.4" = _ntipQK3M;
        "minecraft-1.21.5" = _ntipQK3M;
        "minecraft-1.21.6" = _ntipQK3M;
        "minecraft-1.21.7" = _ntipQK3M;
        "minecraft-1.21.8" = _ntipQK3M;
        "minecraft-1.21.9" = _ntipQK3M;
        "minecraft-1.21.10" = _ntipQK3M;
        "minecraft-1.21.11" = _ntipQK3M;
        "minecraft-26.1" = _ntipQK3M;
        "minecraft-26.1.1" = _ntipQK3M;
        "minecraft-26.1.2" = _ntipQK3M;
        "minecraft-26.2" = _ntipQK3M;
        "pkg-CG1" = _TcxJkoIv;
        "pkg-PA1" = _ZJhL8MTK;
        "pkg-PA2" = _kt1fDvTG;
        "pkg-CG2" = _87SlWoVR;
        ...
        "pkg-F64x_Fusion_1.0.0" = _3cYA00oT;
        "pkg-F32x_Fusion_1.0.0" = _djFaDNDw;
        "pkg-BB_Fusion_1.0.0" = _vWpdQhUy;
        "pkg-PA_Fusion_1.0.0" = _bZDzjCAC;
        "pkg-CG_Fusion_1.0.0" = _ntipQK3M;
        "default" = _ntipQK3M;
    });
