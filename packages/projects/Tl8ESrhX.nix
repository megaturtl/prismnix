...
let
    ...
    in {
        ...
        "pkg-18.1.0" = _D26cBYtG;
        "pkg-2.3.8" = _WgbbnI3t;
        "pkg-19.0.0-alpha" = _SuwQNxRE;
        "pkg-19.0.1-beta" = _c3CAtcfj;
        "pkg-19.0.2-beta" = _OMHnIalW;
        "pkg-19.2.0" = _YrzsAVU1;
        "pkg-19.2.1" = _4LefcyDZ;
        "pkg-18.2.0" = _bJD0ZdBE;
        "pkg-19.2.90" = _ajOF5mG5;
        "pkg-19.4.0" = _8jcT6lM6;
        "pkg-20.1.0" = _gw94H8MZ;
        "pkg-19.4.1" = _gHjAajlm;
        "pkg-20.1.1" = _m1vPl6dA;
        "pkg-18.2.1" = _4qWPsNk1;
        "pkg-19.2.91" = _tkSvYYiN;
        "pkg-20.1.2" = _aGDYTwZk;
        "pkg-19.4.2" = _t1yMz9LN;
        "pkg-19.2.92" = _cznarxo0;
        "pkg-20.1.3" = _Zu2igL6d;
        "pkg-19.2.93" = _XuZH2hD2;
        "pkg-19.4.3" = _dz6yGHtT;
        "pkg-20.1.4" = _LWu2i07G;
        "pkg-19.4.4" = _Rfk2bNWH;
        "pkg-20.1.5" = _mDKAXTiu;
        "pkg-20.1.6" = _xNEQid1X;
        "pkg-21.0.0" = _i7fuvEJr;
        "pkg-21.0.1-alpha" = _HHZHmKlb;
        "pkg-21.0.2-alpha" = _m0MqhPId;
        "pkg-21.1.0-alpha" = _NzTcnzQu;
        "pkg-21.1.2-beta" = _AhNr61oH;
        "pkg-21.0.3-alpha" = _DhYdtIaI;
        "pkg-20.1.7" = _TfjjgCwA;
        "pkg-20.1.8" = _QUWhIY1r;
        "pkg-21.1.3-beta" = _ZQAa8kiX;
        "pkg-21.1.4-beta" = _egF03vjQ;
        "pkg-21.1.5-beta" = _YfCEU9aL;
        "pkg-21.3.0-beta" = _qe6rMMNE;
        "pkg-20.1.9" = _OTbqpyC8;
        "pkg-21.0.4" = _tGbVq2io;
        "pkg-21.4.0-beta" = _rj6kik9u;
        "pkg-21.5.1-beta" = _rlWGJxsw;
        "pkg-21.5.2-beta" = _6PaYlAoI;
        "pkg-21.5.4-beta" = _UiSOqGlf;
        "pkg-21.1.7-release" = _zO1zQqql;
        "pkg-21.1.8-release" = _GK9ySRjA;
        "pkg-21.9.1-alpha" = _Y0BZ5x2L;
        "pkg-21.1.9-release" = _PhWXajPC;
