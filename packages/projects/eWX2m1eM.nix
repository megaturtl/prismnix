...
let
    ...
    in {
        ...
        "pkg-eidolon_repraised-1.20.1-0.3.7.2" = _BJg8U0nU;
        "pkg-eidolon_repraised-1.19.2-0.3.7.3" = _dBZxYly0;
        "pkg-eidolon_repraised-1.20.1-0.3.7.3" = _HcQJ7Zq1;
        "pkg-eidolon_repraised-1.20.1-0.3.7.4" = _6LKfrd89;
        "pkg-eidolon_repraised-1.19.2-0.3.7.4" = _OW8K2j9p;
        "pkg-eidolon_repraised-1.20.1-0.3.7.5" = _jaY9zNs6;
        "pkg-eidolon_repraised-1.19.2-0.3.7.5" = _ODZzJmmT;
        "pkg-eidolon_repraised-1.20.1-0.3.8.0" = _5g9SwyIu;
        "pkg-eidolon_repraised-1.20.1-0.3.8.1" = _I44ROR2x;
        "pkg-eidolon_repraised-1.19.2-0.3.8.1" = _L7ij9heh;
        "pkg-eidolon_repraised-1.20.1-0.3.8.9" = _sP4g36RP;
        "pkg-0.3.8.15" = _NJrT0yyU;
        "pkg-eidolon_repraised-1.20.1-0.3.10" = _ijWODpzP;
        "pkg-0.5.0.0-pre18" = _pC9pAl39;
        "pkg-eidolon_repraised-1.20.1-0.3.11" = _lpb7N644;
        "pkg-0.5.0.0-pre19" = _ikKnDktV;
        "pkg-0.5.0.0-pre20" = _kIsLcMy8;
