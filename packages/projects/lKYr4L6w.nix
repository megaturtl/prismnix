...
let
    ...
    in {
        ...
        "pkg-1.0.0-mc1.17.1-forge" = _iOxeAHhE;
        "pkg-1.0.0-mc1.18-fabric" = _pjQN2slY;
        "pkg-1.0.0-mc1.18-forge" = _guWt8ZbN;
        "pkg-1.1.0-mc1.16.5-fabric" = _zmGyIYuB;
        "pkg-1.1.0-mc1.16.5-forge" = _fwIe7oUX;
        "pkg-1.1.0-mc1.17.1-fabric" = _kVguOMec;
        "pkg-1.1.0-mc1.17.1-forge" = _PQxTT5EP;
        "pkg-1.1.0-mc1.18.1-fabric" = _ncF8AT7e;
        "pkg-1.1.0-mc1.18.1-forge" = _WlWM6tXA;
        "pkg-1.1.1-mc1.16.5-fabric" = _LRkDfHO3;
        "pkg-1.1.1-mc1.16.5-forge" = _HB0Tph9T;
        "pkg-1.1.1-mc1.17.1-fabric" = _PSoP9UtH;
        "pkg-1.1.1-mc1.17.1-forge" = _V98d3GkT;
        "pkg-1.1.1-mc1.18.1-fabric" = _KutnJdRN;
        "pkg-1.1.1-mc1.18.1-forge" = _29O6nhDp;
        "pkg-1.1.3-mc1.16.5-fabric" = _4vRpgpv7;
        "pkg-1.1.3-mc1.16.5-forge" = _OlQ6L2xI;
        "pkg-1.1.3-mc1.17.1-fabric" = _5rcqq8Oh;
        "pkg-1.1.3-mc1.17.1-forge" = _z19yNcKT;
        "pkg-1.1.3-mc1.18.1-fabric" = _7rgrzDWG;
        "pkg-1.1.3-mc1.18.1-forge" = _74EnW1HQ;
        "pkg-1.2.0-mc1.16.5-fabric" = _ZLeYyhte;
        "pkg-1.2.0-mc1.16.5-forge" = _XNBy6IjH;
        "pkg-1.2.0-mc1.17.1-fabric" = _4mpZMbsT;
        "pkg-1.2.0-mc1.17.1-forge" = _ve3fuUO8;
        "pkg-1.2.0-mc1.18.1-fabric" = _5n4BXa3z;
        "pkg-1.2.0-mc1.18.1-forge" = _mgnbpeWK;
        "pkg-1.2.0-mc1.18.2-fabric" = _17G7AnUe;
        "pkg-1.2.0-mc1.18.2-forge" = _JjTiGVQH;
        "pkg-1.2.1-mc1.19-fabric" = _8raH5rPp;
        "pkg-1.2.1-mc1.19-forge" = _Vg5cPzRC;
        "pkg-1.2.2-mc1.19-fabric" = _LFeFJXPx;
        "pkg-1.2.2-mc1.19-forge" = _x9zJWSsE;
        "pkg-1.2.3-mc1.19-fabric" = _uhinAWsC;
        "pkg-1.2.3-mc1.19-forge" = _llCD21nM;
        "pkg-1.2.4-mc1.19-fabric" = _rfWoITCI;
        "pkg-1.2.4-mc1.19-forge" = _bwwRaehj;
        "pkg-1.3.0-mc1.18.2-fabric" = _9j51i3pY;
        "pkg-1.3.0-mc1.18.2-forge" = _8NgD3h7F;
        "pkg-1.3.0-mc1.19-fabric" = _wedZI9jC;
        "pkg-1.3.0-mc1.19-forge" = _FBwsU9u0;
        "pkg-1.3.1-mc1.19.1-fabric" = _28qEI6pT;
        "pkg-1.3.1-mc1.19.1-forge" = _tsaSAc0e;
        "pkg-1.3.2-mc1.19.1-fabric" = _7q2EwF7Q;
        "pkg-1.3.2-mc1.19.1-forge" = _jg2Ag3OY;
        "pkg-1.4.0-mc1.19.2-fabric" = _waw1o0Bf;
        "pkg-1.4.0-mc1.19.2-forge" = _Py8Ygpcl;
        "pkg-1.4.1-mc1.19.2-fabric" = _CJZpBZtI;
        "pkg-1.4.1-mc1.19.2-forge" = _P3NesZKL;
        "pkg-1.4.2-mc1.19.2-fabric" = _oKKgeNRg;
        "pkg-1.4.2-mc1.19.2-forge" = _EdXuUNU5;
        "pkg-1.4.3-mc1.19.3-fabric" = _4vugn0bb;
        "pkg-1.4.3-mc1.19.3-forge" = _3w7yFzjF;
        "pkg-1.4.4-mc1.19.4-fabric" = _Q21B8ygL;
        "pkg-1.4.4-mc1.19.4-forge" = _brV1YCzH;
        "pkg-1.4.5-mc1.20-fabric" = _MmvlLeEw;
        "pkg-1.4.6-mc1.20-fabric" = _kJFQUpbj;
        "pkg-1.4.6-mc1.20-forge" = _HPjM97Qj;
        "pkg-1.4.7-mc1.20-fabric" = _W0JxyGf8;
        "pkg-1.4.7-mc1.20-forge" = _uDVhq8xO;
        "pkg-1.4.8-mc1.20-fabric" = _qIzdXMvT;
        "pkg-1.4.8-mc1.20-forge" = _iUeXLWfn;
        "pkg-1.5.0-mc1.20.1" = _OZvUpRXK;
        "pkg-1.5.1-mc1.20.1" = _3nN73j93;
        "pkg-1.5.2-mc1.20.2" = _PAvsdpU9;
        "pkg-1.5.3-mc1.20.2" = _22BkYjQI;
        "pkg-1.6.0-mc1.20.4" = _gWf5WQqa;
        "pkg-1.6.1-mc1.20.4" = _9WuE4tw7;
        "pkg-1.7.0-mc1.20.5-neoforge" = _cWozlBJJ;
        "pkg-1.7.0-mc1.20.5-fabric" = _ofzM42mI;
        "pkg-1.7.1-mc1.20.6-fabric" = _tL2sSaIN;
        "pkg-1.7.1-mc1.20.6-neoforge" = _nmbHvH9I;
        "pkg-1.7.2-mc1.21-neoforge" = _Z5PZyy5p;
        "pkg-1.7.2-mc1.21-fabric" = _vPAFzdEo;
        "pkg-1.8.0-mc1.21-fabric" = _s6EYPGiO;
        "pkg-1.8.0-mc1.21-neoforge" = _n1nVXN0T;
        "pkg-1.8.1-mc1.21-fabric" = _Upwb4cg2;
        "pkg-1.8.1-mc1.21-neoforge" = _o2TcgK8U;
        "pkg-1.8.2-mc1.21.2-fabric" = _o1M00dvj;
        "pkg-1.8.2-mc1.21.2-neoforge" = _AftVz6YR;
        "pkg-1.8.3-mc1.21.4-fabric" = _UV6bRKYb;
        "pkg-1.8.3-mc1.21.4-neoforge" = _HctHnpAP;
        "pkg-1.9.0-mc1.21.4-fabric" = _xNMQWB2F;
        "pkg-1.9.0-mc1.21.4-neoforge" = _Vusa2baj;
        "pkg-1.9.1-mc1.21.5-fabric" = _aqdYMZde;
        "pkg-1.9.1-mc1.21.5-neoforge" = _9vrZ450X;
        "pkg-1.9.2-mc1.21.6-fabric" = _G3J6hTRV;
        "pkg-1.9.2-mc1.21.6-neoforge" = _GWLfXboq;
        "pkg-1.9.3-mc1.21.6-fabric" = _g1ZuR8jZ;
        "pkg-1.9.3-mc1.21.6-neoforge" = _ApTfSLUk;
        "pkg-1.9.4-mc1.21.6-fabric" = _sU3UtdoM;
        "pkg-1.9.4-mc1.21.6-neoforge" = _ohPZ2ZC9;
        "pkg-1.9.5-mc1.21.6-fabric" = _vQ4ldzVw;
        "pkg-1.9.5-mc1.21.6-neoforge" = _W9MDgjVy;
        "pkg-1.9.6-mc1.21.6-fabric" = _ob1PDdRf;
        "pkg-1.9.6-mc1.21.6-neoforge" = _iaZaLKrV;
        "pkg-1.9.7-mc1.21.9-fabric" = _pWImfdgi;
        "pkg-1.9.7-mc1.21.9-neoforge" = _uR24EEeK;
        "pkg-1.9.8-mc1.21.11-fabric" = _jCYHkLZY;
        "pkg-1.9.8-mc1.21.11-neoforge" = _1KYVFMPY;
        "pkg-1.10.0-mc26.1-fabric" = _EQhChMBP;
        "pkg-1.10.0-mc26.1-neoforge" = _RYmKC6pw;
        "pkg-1.11.0-mc26.2-rc-2-fabric" = _f7180xGI;
