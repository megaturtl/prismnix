...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.20.4" = _AdPBr8aH;
        "pkg-1.0.0+1.16.5" = _bOTOm9xX;
        "pkg-1.0.0+1.17.1" = _Pxay8TiT;
        "pkg-1.0.1+1.16.5" = _U7ElfRKw;
        "pkg-1.0.1+1.17.1" = _feI9BW66;
        "pkg-1.0.1+1.18.2" = _wn72b16J;
        "pkg-1.0.1+1.19.2" = _ZCmAVgEA;
        "pkg-1.0.1+1.19.4" = _J6RJa9Ty;
        "pkg-1.0.1+1.20.1" = _G5sDbu5X;
        "pkg-1.0.1+1.20.4" = _8oQ0NIwK;
        "pkg-1.1.0+1.20.4" = _Sro5I6bX;
        "pkg-1.1.0+1.20.1" = _QCdk2wA6;
        "pkg-1.1.0-1.20.1" = _ZIjHuSiJ;
        "pkg-1.1.0+1.19.4" = _YZcn4yhl;
        "pkg-1.1.0+1.19.2" = _jVAqIodt;
        "pkg-1.1.0+1.18.2" = _fGk7ffGu;
        "pkg-1.1.0+1.17.1" = _ek5VI8gl;
        "pkg-1.1.0+1.16.5" = _eYPEID1l;
        "pkg-1.2.0+1.20.4" = _21sCGihz;
        "pkg-1.2.0+1.16.5-hotfix2" = _Oa9epfsC;
        "pkg-1.2.0+1.17.1-hotfix2" = _12G7vpxs;
        "pkg-1.2.0+1.18.2-hotfix2" = _7xleWGRs;
        "pkg-1.2.0+1.19.2-hotfix2" = _fYNwdk9c;
