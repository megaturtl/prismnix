...
let
    ...
    in {
        ...
        "pkg-9.10.15" = _bpza6rt7;
        "pkg-9.10.16" = _SzYKZ3PA;
        "pkg-9.10.17" = _qcVmlu6K;
        "pkg-9.10.18" = _cbJ4FRRa;
        "pkg-9.10.19" = _cnY3z0DG;
        "pkg-9.10.20" = _Jc4dMOlv;
        "pkg-9.10.21" = _3KLFb30z;
        "pkg-9.10.22" = _zxY8yRPm;
        "pkg-9.10.23" = _jpktZYmo;
        "pkg-9.10.24" = _gmBnKRLJ;
        "pkg-9.10.25" = _tGEv2xyK;
        "pkg-9.10.26" = _FqDIZP6S;
        "pkg-9.10.27" = _hFwkwBhG;
        "pkg-9.10.28" = _lvF27U2z;
        "pkg-9.12.5" = _1djoBCmn;
        "pkg-9.12.6" = _PjszUOyS;
        "pkg-9.10.29" = _P8to0a7y;
        "pkg-9.12.7" = _ZXMsRHxS;
        "pkg-9.10.30" = _Q2sof2BE;
        "pkg-9.10.31" = _PJqw394h;
        "pkg-9.12.8" = _sLyn9C9P;
        "pkg-9.10.32" = _ItFEevrG;
        "pkg-9.10.33" = _VxKSii0o;
        "pkg-9.10.36" = _c7oADfCd;
        "pkg-9.12.9" = _sbODc8fX;
        "pkg-9.12.10" = _uoizS8sE;
        "pkg-9.10.42" = _AOZtcRp3;
