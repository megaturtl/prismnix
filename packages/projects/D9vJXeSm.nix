...
let
    versions = (let
        ...
        _wMdpuuxC = {
            "id" = "wMdpuuxC";
            "file" = "nemos-mending-NeoForge-26.3-1.1.2.jar";
            "hash" = "sha512-R81MIp/Gd4pYP3I2Zwlv1uauB0jMWJ4pgrgDjpwGiOwb2+2p+Li05u+mhpH++yarcQNBmc9nOmuPdqoaq5TF1w==";
        };
        _QV7Hf05u = {
            "id" = "QV7Hf05u";
            "file" = "nemos-mending-Fabric-26.3-1.1.2.jar";
            "hash" = "sha512-LyTAyK4NjSD/yluu3qDxWteqqpLdQHD1ax7+XW5hfwKaEFEuGlBRuz3AEuYTMUMmDqaLoojvopQJXGry9Aun7w==";
        };
    in {
        "g4mku773" = _g4mku773;
        "UKmWtCF9" = _UKmWtCF9;
        ...
        "neoforge-26.3" = _wMdpuuxC;
        "pkg-1.0.0-1.20" = _g4mku773;
        "pkg-1.0.0-1.20.1" = _UKmWtCF9;
        "pkg-1.0.0-1.20.2" = _cgeUq8xP;
        "pkg-1.0.0-1.20.4" = _VMmVtBQF;
        "pkg-1.1.0-1.20" = _OW97KTx5;
        "pkg-1.1.0-1.20.1" = _ZnUzXEiX;
        "pkg-1.1.0-1.20.2" = _T1BTZDoS;
        "pkg-1.1.0-1.20.4" = _s1US2rQe;
        "pkg-1.1.1-1.20" = _GRXZJein;
        "pkg-1.1.1-1.20.1" = _GkeUgfMR;
        "pkg-1.1.1-1.20.2" = _lqdKiCqN;
        "pkg-1.1.1-1.20.4" = _SAjUiZhZ;
        "pkg-1.1.1-1.20.6" = _NkaTAJDg;
        "pkg-1.1.1-1.21" = _yj6eBlUq;
        "pkg-1.1.1-1.21.1" = _sS5m4ugT;
        "pkg-1.1.1-1.21.2" = _xVo4kuqD;
        "pkg-1.1.1-1.21.3" = _MC82JDFa;
        "pkg-1.21.4-1.1.1" = _Z9rhP2G1;
        "pkg-1.21.5-1.1.1" = _JYvwrrVa;
        "pkg-1.21.7-1.1.1" = _XHsYb2E8;
        "pkg-1.21.8-1.1.2" = _mXruY3iB;
        "pkg-1.21.10-1.1.2" = _j1h7XOyq;
        "pkg-1.21.11-1.1.2" = _ZD3cpZD4;
        "pkg-26.1-1.1.2" = _8zdke5a1;
        "pkg-26.2-1.1.2" = _DeLAGP6i;
        "pkg-26.3-1.1.2" = _QV7Hf05u;
        "default" = _QV7Hf05u;
    });
