...
let
    ...
    in {
        ...
        "pkg-1.2.8" = _gkHSVld5;
        "pkg-1.2.9" = _2y6UmVCy;
        "pkg-1.2.10" = _bR2UCM5I;
        "pkg-1.2.11" = _KCFIVBzR;
        "pkg-1.2.12" = _dekBGAN4;
        "pkg-1.2.13" = _ijCtQZSA;
        "pkg-1.2.14" = _gm7AEg9m;
        "pkg-1.2.15" = _Ej5OXEuA;
        "pkg-1.2.16" = _1H85LUWM;
        "pkg-1.2.17" = _S3ZmF6DW;
        "pkg-1.2.18" = _NoGF2P4Y;
        "pkg-2.0.0" = _rFQHNxTg;
        "pkg-2.0.0.6" = _bCVBjVJn;
        "pkg-2.0.0.7" = _UGEZg0JN;
        "pkg-2.0.0.9" = _eEnJMLcs;
        "pkg-3.0.0.10" = _dNT5tNCj;
        "pkg-3.0.0.11" = _UBFVNtnc;
        "pkg-2.0.0.12" = _9Q8X9knm;
        "pkg-3.0.0.13" = _2cQVzGit;
        "pkg-2.0.0.14" = _mtidpEGH;
        "pkg-3.0.0.15" = _Lv1psAYD;
        "pkg-3.0.0.16" = _XPVmEPn1;
        "pkg-3.0.0.17" = _KeBOILke;
        "pkg-3.0.0.18" = _cHVcIaqc;
        "pkg-3.0.0.19" = _r11BpR0V;
        "pkg-3.0.0.20" = _PgY4plsu;
        "pkg-3.0.0.21" = _cWVY151O;
        "pkg-3.0.0.22" = _h2zjuRaY;
        "pkg-3.0.0.23" = _R87MonN8;
        "pkg-3.0.0.24" = _NCRv8Yzx;
        "pkg-3.0.0.25" = _RB1Up5HI;
        "pkg-3.0.0.26" = _HKPCQLvy;
        "pkg-3.0.0.27" = _8ixGRPJA;
        "pkg-3.0.0.28" = _U24PoX9u;
        "pkg-3.0.0.29" = _SockqufJ;
        "pkg-3.0.0.30" = _lwuGHEkK;
        "pkg-3.0.0.31" = _SvBEuaKt;
        "pkg-3.0.0.32" = _cZNC1nbM;
        "pkg-3.0.0.33" = _kdfjinAY;
        "pkg-3.0.0.34" = _CR3fo6CW;
        "pkg-3.0.0.35" = _Etj1LeVU;
        "pkg-3.0.0.36" = _4DQ52TO9;
        "pkg-2.0.0.37" = _x7OReqVd;
        "pkg-3.0.0.39" = _frbKdQBk;
        "pkg-2.0.0.40" = _rsqbhjhq;
        "pkg-3.0.0.41" = _XLa48Oh1;
        "pkg-3.0.0.42" = _JBVZu5OQ;
        "pkg-3.0.0.43" = _xiYtpHsH;
        "pkg-3.0.0.44" = _qhbJmFQc;
        "pkg-3.0.0.48" = _XGZupM8x;
        "pkg-3.0.0.49" = _EBYuPWGn;
        "pkg-3.0.0.50" = _zVk3lsK0;
        "pkg-3.0.0.51" = _fKRa5tDC;
        "pkg-3.0.0.52" = _ZEReylra;
        "pkg-3.0.0.53" = _ZlzL50X8;
        "pkg-3.0.0.54" = _pT7s4NrS;
        "pkg-3.0.0.55" = _RAuCt1O0;
        "pkg-3.0.0.56" = _ZM1b9DRm;
        "pkg-3.0.0.57" = _8Iq3rRng;
        "pkg-3.0.0.58" = _2YaNofRz;
        "pkg-3.0.0.59" = _p3t0Hq0T;
        "pkg-3.0.0.60" = _Bse3J7GQ;
        "pkg-3.0.0.61" = _OsrW6093;
        "pkg-3.0.0.62" = _SvnnGfT0;
        "pkg-3.0.0.63" = _n9IKrHAc;
        "pkg-3.0.0.64" = _TRmH8Sri;
        "pkg-3.0.0.65" = _hdHgrkU3;
        "pkg-3.0.0.66" = _ksORk4Ok;
        "pkg-3.0.0.67" = _NVlWzKmg;
        "pkg-3.0.0.68" = _RTrrLYFK;
        "pkg-3.0.0.69" = _Pshn1YLW;
        "pkg-2.0.0.70" = _CK57CDbd;
        "pkg-3.0.0.71" = _biHM5Hqc;
        "pkg-3.0.0.72" = _H0u8N1XE;
        "pkg-3.0.0.73" = _VkdGFY7I;
        "pkg-3.0.0.74" = _bG6RS99E;
        "pkg-3.0.0.75" = _ql9HctSh;
        "pkg-4.0.0.76" = _336N8ZvL;
        "pkg-4.0.0.77" = _CcrzSPD8;
        "pkg-4.0.0.78" = _RZdqPObw;
        "pkg-4.0.0.79" = _2gr3lJ9g;
        "pkg-4.0.0.80" = _Ub00Xe1u;
        "pkg-4.0.0.81" = _AtTSGoPI;
        "pkg-4.0.0.82" = _OgKdtobW;
        "pkg-4.0.0.83" = _mb3tmKlc;
        "pkg-4.0.0.84" = _94V7116H;
        "pkg-4.0.0.85" = _HPEv72jH;
        "pkg-4.0.0.86" = _qKzywQXl;
        "pkg-4.0.0.87" = _5pPfV7hC;
        "pkg-4.0.1.88" = _djM2zZLV;
        "pkg-4.0.1.89" = _hdC8f5Xw;
        "pkg-4.0.1.91" = _BZvP0DdV;
        "pkg-3.0.0.92" = _eFd0rFk9;
        "pkg-4.0.1.119" = _OQCpfA9A;
        "pkg-4.0.1.120" = _YkLe7h6c;
        "pkg-5.0.0.1" = _6h2wZOPb;
        "pkg-4.0.1.121" = _1TlQiMoy;
        "pkg-5.0.0.2" = _npWjwk1c;
        "pkg-5.0.0.3" = _MQucNycC;
        "pkg-5.0.0.6" = _gpm6N5rr;
        "pkg-5.0.0.7" = _BADirHJj;
        "pkg-4.0.1.122" = _YeSaQHng;
        "pkg-6.0.0.8" = _dkUlOBkN;
        "pkg-6.0.0.9" = _RACNkn5z;
        "pkg-4.0.1.123" = _zCXfHDBt;
        "pkg-6.0.0.10" = _Z9M2XnkN;
        "pkg-6.0.0.11" = _ZX7ns0M3;
        "pkg-4.0.1.124" = _y4VNtPr7;
        "pkg-7.0.0.12" = _MESrHbku;
        "pkg-7.0.0.13" = _4pcRoPrL;
        "pkg-4.0.1.125" = _t5gJ6AFT;
        "pkg-7.0.0.14" = _CAi1ogrc;
        "pkg-7.0.0.15" = _k8G3p1jL;
        "pkg-8.0.0.16" = _FL8QiRjl;
        "pkg-8.0.0.17" = _usRxhyuN;
        "pkg-8.0.0.18" = _xFGZ849B;
        "pkg-8.0.0.19" = _w8LeNlbj;
        "pkg-4.0.1.126" = _ViHbOygj;
        "pkg-8.0.0.20" = _ymt85Mys;
        "pkg-8.1.0.21" = _kKfdmNYr;
        "pkg-8.1.0.22" = _dpH4Jih8;
        "pkg-8.1.0.23" = _UwZKRtHN;
        "pkg-8.1.0.24" = _O1v6mc2V;
        "pkg-4.0.1.127" = _ZiLB5kvu;
        "pkg-8.2.0.25" = _BdJwjuKq;
        "pkg-8.2.0.26" = _9IboVipN;
        "pkg-8.2.0.27" = _vv3peOCn;
        "pkg-8.2.0.28" = _7vZ2MHEb;
        "pkg-8.2.0.29" = _uUAoI0Sq;
        "pkg-8.3.0.31" = _XVXdUiLp;
        "pkg-8.3.0.32" = _YhngJoJb;
        "pkg-8.3.0.33" = _wGR9EPjH;
        "pkg-8.2.0.34" = _OkYqYQ4s;
        "pkg-8.3.0.35" = _4tkEmipR;
        "pkg-8.2.0.36" = _YoOAi1R3;
        "pkg-8.2.0.37" = _UqyTP3iN;
        "pkg-8.3.0.38" = _edi2fvwH;
        "pkg-4.0.1.129" = _8959KWib;
        "pkg-8.3.0.39" = _kLzi9Rbn;
        "pkg-4.0.1.130" = _Mu9dnHDM;
        "pkg-8.3.0.40" = _hsatEEy9;
        "pkg-9.0.0.41" = _EoO7wwKK;
        "pkg-9.0.0.42" = _AKtcjY5L;
        "pkg-9.0.0.43" = _Dk24OMju;
        "pkg-9.0.0.45" = _ckZ6GZn1;
        "pkg-9.0.0.46" = _gvqNV855;
        "pkg-9.1.0.47" = _zabiNo9J;
        "pkg-9.1.0.48" = _65af8rjO;
        "pkg-9.1.0.50" = _LAMZt59D;
        "pkg-9.1.0.51" = _KaJimrhc;
        "pkg-9.1.0.52" = _naYUU7lx;
        "pkg-9.1.0.53" = _8p2gOSIF;
        "pkg-9.1.0.54" = _iFallzsr;
        "pkg-9.1.0.55" = _IICqZWsG;
        "pkg-9.1.0.56" = _64lA7Csz;
        "pkg-9.1.0.57" = _vVTel2VY;
        "pkg-9.2.0.1" = _nwMcdvPT;
        "pkg-9.2.0.2" = _sCJbM5Os;
        "pkg-9.2.0.3" = _tmCEr889;
        "pkg-9.2.0.4" = _JIwGwGJE;
        "pkg-9.2.0.5" = _MBAxPUQ6;
        "pkg-9.3.0.0" = _Wot2SLuB;
        "pkg-9.3.0.2" = _GcJYGlaI;
        "pkg-9.3.0.3" = _4X6AXmne;
        "pkg-9.3.0.4" = _F0c8aXNF;
        "pkg-9.3.0.13" = _5w2bRFnN;
        "pkg-9.3.0.14" = _N8k1e1sY;
        "pkg-9.3.0.15" = _T1CytEf3;
        "pkg-9.3.0.16" = _q0FKz0aD;
        "pkg-9.3.0.17" = _VEb2HTnt;
        "pkg-9.3.0.18" = _cZtzA2Re;
        "pkg-9.3.0.19" = _mInlPvK5;
        "pkg-9.3.0.20" = _oAVPHB6R;
        "pkg-9.3.0.21" = _C0RIDRwM;
        "pkg-9.3.0.22" = _K81EBqoi;
        "pkg-9.3.0.23" = _TEJIh1b4;
        "pkg-9.3.0.24" = _beQdO070;
        "pkg-9.3.0.25" = _9QwOxxTJ;
        "pkg-9.4.0.0" = _WOJjWCfj;
        "pkg-9.4.0.1" = _doP9QTTl;
        "pkg-9.4.0.2" = _Bka360Jd;
        "pkg-9.4.0.3" = _u6w8aIEH;
        "pkg-9.4.0.4" = _fDYLcG5h;
        "pkg-9.4.0.5" = _edfetwrk;
        "pkg-9.4.0.6" = _pXkL38iE;
        "pkg-10.0.0.0" = _PSnbrfvG;
        "pkg-10.0.0.1" = _9VAh4jzJ;
        "pkg-10.0.0.2" = _kCqKV59a;
        "pkg-10.0.0.6" = _q8BN28TQ;
        "pkg-10.1.0.0" = _rYQQqnVE;
        "pkg-10.1.0.1" = _b2S4BcbP;
        "pkg-9.3.0.27" = _HFk4L0uv;
        "pkg-9.1.0.0" = _4RgDk9NB;
        "pkg-10.2.0.0" = _wVQhQLAh;
        "pkg-10.2.0.1" = _qw754dBa;
        "pkg-10.4.0.0" = _Nma1rZlQ;
        "pkg-10.4.0.1" = _n2el0kgr;
        "pkg-10.4.0.2" = _lYP03iZk;
        "pkg-10.2.0.2" = _SRNU974x;
        "pkg-10.1.0.3" = _SPj5bJoM;
        "pkg-10.2.0.3" = _KQ2wyU1I;
        "pkg-10.4.0.3" = _d6gkZhjT;
        "pkg-9.1.0.1" = _vk0sThi2;
        "pkg-10.4.0.4" = _ZkFRRD7B;
        "pkg-10.4.0.5" = _mZu72ROe;
        "pkg-10.4.0.6" = _D6fJLkyS;
        "pkg-10.5.0.0" = _14scaIL1;
        "pkg-10.4.0.7" = _yN9pMj56;
        "pkg-9.1.0.2" = _c1BdjabH;
        "pkg-10.5.0.1" = _FuStRzX7;
        "pkg-10.5.0.4" = _jNEAw2Jk;
        "pkg-21.6.0.0" = _FuJOYqfx;
        "pkg-21.7.0.0" = _OpOJrIBd;
        "pkg-10.5.0.5" = _kf9KmhKn;
        "pkg-21.8.0.0" = _30NJ0mrz;
        "pkg-21.8.0.1" = _5qHMm4uh;
        "pkg-21.9.0.0" = _hVJCc24X;
        "pkg-21.10.0.0" = _Y0zdqWGx;
        "pkg-21.9.0.1" = _s5sv0NSL;
        "pkg-21.10.0.1" = _RU1ifSV6;
        "pkg-21.11.0.0" = _Xj40Axjb;
        "pkg-21.11.0.1" = _8NezTPob;
        "pkg-21.11.0.2" = _nNCtJpD2;
        "pkg-21.11.0.3" = _8H6BdJij;
        "pkg-21.11.0.5" = _yn4DGUXH;
        "pkg-21.11.0.4" = _6GpaVF7N;
        "pkg-26.1.1.0.1" = _3vjAFp6O;
        "pkg-26.1.2.0.2" = _IJXbjLdO;
