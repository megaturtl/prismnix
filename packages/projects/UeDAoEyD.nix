...
let
    versions = (let
        ...
        _uRTsaXiJ = {
            "id" = "uRTsaXiJ";
            "file" = "TrueAdaptiveMusic-fabric-2.7.6+1.20.1.jar";
            "hash" = "sha512-xFQm1UL/F8le0vyX08ewDGJ1ay4fMuDFogNBhFPkiD0ggzUBcFoWTmqxTKqLuI4peRYdX6WoF/hPT400+mthZw==";
        };
        _kRtSyYUk = {
            "id" = "kRtSyYUk";
            "file" = "TrueAdaptiveMusic-forge-2.7.6+1.20.1-all.jar";
            "hash" = "sha512-tIuQIgCjD8pWW6e8vFB3LIii6qPm+fOfZ6pUXIcK638D6ZOj8GPcF12Ov+ymfqYJqUD+lIXSxJa2KlhmrrQBPw==";
        };
        _OzUUVFse = {
            "id" = "OzUUVFse";
            "file" = "TrueAdaptiveMusic-fabric-2.7.7+1.21.1.jar";
            "hash" = "sha512-zfxl3DKW9CPP7itDV4ZGxUksYhikldI1fNU16BM4jzqI2XQNddYGdUZ1+AVwba5vxBEORQurOwjFnjnNqAd+eg==";
        };
        _AbnP5F0w = {
            "id" = "AbnP5F0w";
            "file" = "TrueAdaptiveMusic-neoforge-2.7.7+1.21.1.jar";
            "hash" = "sha512-P202UZmO1uS8KfLq2aCCjLQN/h27v0aQXmxBFsAKcKDaplwxKt+tsmwriiZKuRr8dKuEnNej7SFUvZQIRKVsJw==";
        };
        _sA8AWW6D = {
            "id" = "sA8AWW6D";
            "file" = "TrueAdaptiveMusic-fabric-2.7.8+1.21.1.jar";
            "hash" = "sha512-G72A99oF9G8AovDhiFFj4pS96OqtEAgonHkQ5eYuMWWWy5xobA/1cfp1hxtaEXbWLmlor520F5sB8ysdNv+zPw==";
        };
        _vdKAu9DP = {
            "id" = "vdKAu9DP";
            "file" = "TrueAdaptiveMusic-neoforge-2.7.8+1.21.1.jar";
            "hash" = "sha512-NXTc9kEoR/igpjmvweJ3RiLm00J0zwVSviQ7s1fTiUvkLgm/lu7ugi3KQEz5jOH+zE6+LTAC4RqS7RR8JBSYzw==";
        };
        _zL6YPxSo = {
            "id" = "zL6YPxSo";
            "file" = "TrueAdaptiveMusic-fabric-2.7.9+1.21.11.jar";
            "hash" = "sha512-616P709koWyE7Zx01UTXOzVpYRWO7So78piZ03tFjmvg4Xi2sk2pzLelPfM0So22egpgF09S4DFXxsuSRiTlWQ==";
        };
        _T3qcz4pH = {
            "id" = "T3qcz4pH";
            "file" = "TrueAdaptiveMusic-neoforge-2.7.9+1.21.11.jar";
            "hash" = "sha512-xaO2V1seB9L+An0GEHCFsSE6uxIrAMZaIkq8+19QitaRIftTRgaXR2ZbyZPWJxHWH0o6CmFXnO8vYye//4H1tA==";
        };
        _blE52JTm = {
            "id" = "blE52JTm";
            "file" = "TrueAdaptiveMusic-fabric-2.7.9+1.21.9.jar";
            "hash" = "sha512-Srvao8uhQUzvT1yNGNCvmEOxfPHRoKWsb+Kr6VIrqVTzrfiAzTXv/eTCZGR567DtGvwvgowmtTPHneew8x9ajQ==";
        };
        _SBbxGLoR = {
            "id" = "SBbxGLoR";
            "file" = "TrueAdaptiveMusic-neoforge-2.7.9+1.21.9.jar";
            "hash" = "sha512-C2dllKGocMs+XVqu0m8lAc/TZtVxsc/TKKkroIfASACiKySpjKSN6wGUy2F21wui7cw2G1+7Iv18eu23FOFrGg==";
        };
        _evp7TWhd = {
            "id" = "evp7TWhd";
            "file" = "TrueAdaptiveMusic-fabric-2.7.9+1.21.8.jar";
            "hash" = "sha512-b1lGBh3ORQkN/9Z7h/NnviMyGT/TmIPxHJKURzNExkKsCeLRjBqqyYkjicxH1uLhVqh2fJjz15iphtZOW+Musw==";
        };
        _AWgLmxvj = {
            "id" = "AWgLmxvj";
            "file" = "TrueAdaptiveMusic-neoforge-2.7.9+1.21.8.jar";
            "hash" = "sha512-/NIjhRFli+I4Sl2I9HuO2+gGEeByMVcV7/0mV+3AIqLRCfBkNnUQsSuIom5cAV+RpDGSz7w6YoGg5vvAWivkfg==";
        };
        _5NJvzGsC = {
            "id" = "5NJvzGsC";
            "file" = "TrueAdaptiveMusic-fabric-2.7.9+1.21.5.jar";
            "hash" = "sha512-za4+Y5aLqEYaH9nsc1L489qIABjZZWg0GHn6qh3T8v4P3rnHZ3VWmll5QBT++ueAQ9aENes6QHzNZaUDxfBYyQ==";
        };
        _oigGEFXg = {
            "id" = "oigGEFXg";
            "file" = "TrueAdaptiveMusic-neoforge-2.7.9+1.21.5.jar";
            "hash" = "sha512-EpgvwkblooId4/b/vjn9ChXTRQF1FiRCjMitzreDOduX53oGcFph/ASb0jqAb3hZSsupL13ojUSccnImxJhRjg==";
        };
        _JeObAC6n = {
            "id" = "JeObAC6n";
            "file" = "TrueAdaptiveMusic-fabric-2.7.9+1.21.7.jar";
            "hash" = "sha512-HUeik7L6/jaYmuEa6ZHZWbkS7L8Uj7p6azU1VUnvFTOey4Nz1is0J7ZSz9c5wDb6SIOOPvz81cjvzlWeUJNTRg==";
        };
        _DZHZ5Dx4 = {
            "id" = "DZHZ5Dx4";
            "file" = "TrueAdaptiveMusic-fabric-2.7.9+1.21.3.jar";
            "hash" = "sha512-Pj/afDaY8GnHjskTPBAT82bnULkYnTbIZ01NUqwmVv914b750CIesyZv/+oFssrkrYYwBmI06bCTuX7etcno8w==";
        };
        _i8tKMzwn = {
            "id" = "i8tKMzwn";
            "file" = "TrueAdaptiveMusic-neoforge-2.7.9+1.21.7.jar";
            "hash" = "sha512-n1VR98yeWzpoGEf4YFuFagX5EriLSSLvS8C5LGWnspHmG6BMw7yKhFfz0sLDbnaWhMze/sts7LTLj2AYbX2MPw==";
        };
        _6P8AQmbq = {
            "id" = "6P8AQmbq";
            "file" = "TrueAdaptiveMusic-neoforge-2.7.9+1.21.3.jar";
            "hash" = "sha512-TXrsZn/ncVM76Jn/wFHigovubJAcTpTJy6fN2sj8Rd7XHyQ5JvS1CWs9fdnCdzi/wHtJ7axbPMzcaXjvQIjwxA==";
        };
        _bZF2L604 = {
            "id" = "bZF2L604";
            "file" = "TrueAdaptiveMusic-fabric-2.7.9+1.21.6.jar";
            "hash" = "sha512-qn6Vukf8g4wgCFdgCBE4sgvF83jph6kdVrA+6FVJxItZfPCyk8ZRkaIZj1Ag99kNsUvZFe4HP/wzG8txvkvLAA==";
        };
        _tovHluqX = {
            "id" = "tovHluqX";
            "file" = "TrueAdaptiveMusic-fabric-2.7.9+1.21.10.jar";
            "hash" = "sha512-Ny3ju5iGbvrkXHgOP/O1GM5lZfw9FjFHSZKx0E2xZkNrI77QJ1ydjuyjTAZ6UsxlyruRb7lwh+joqsMhJAk43g==";
        };
        _A8wT43xy = {
            "id" = "A8wT43xy";
            "file" = "TrueAdaptiveMusic-neoforge-2.7.9+1.21.6.jar";
            "hash" = "sha512-Wna6gDe1wBhVIyGeKsHpzTti4p7jpWDu/9WoBMW/J/84Z53BmTLY15AutdQ6obbhEVTUQMMnaj0kkjZWwmOdRQ==";
        };
        _29bDqgF5 = {
            "id" = "29bDqgF5";
            "file" = "TrueAdaptiveMusic-neoforge-2.7.9+1.21.10.jar";
            "hash" = "sha512-8K7ZPdG5UqPRnhxpzUKvNxQZj77Hxey9cOjd1jdbq/xFfhn1Tjc2hKq1D9Demlkoru3hBVJU9Vi/wYw4gOv/gQ==";
        };
        _e5jnKPd0 = {
            "id" = "e5jnKPd0";
            "file" = "TrueAdaptiveMusic-fabric-2.7.9+1.21.1.jar";
            "hash" = "sha512-reY19udtHua8d3XK+NXvb4AIZm+UIjccnlJzBOw6Aqq8OgoBRzJ9mGas4mu9raOw/HpEp0vl6G9r/12dPIgd7Q==";
        };
        _kRvRSeVY = {
            "id" = "kRvRSeVY";
            "file" = "TrueAdaptiveMusic-fabric-2.7.9+1.21.2.jar";
            "hash" = "sha512-gOEghyxT7LnINgbNCUO2asaoxU4QEXsXNXaa6WlaKWZ0+5wLmpXB09XcW6h2J/JuTPDevRhJGtK6lxMbvRzpwA==";
        };
        _AggbyHLt = {
            "id" = "AggbyHLt";
            "file" = "TrueAdaptiveMusic-neoforge-2.7.9+1.21.1.jar";
            "hash" = "sha512-GeQjSZYIGIvInXrLlqmHZIQUy62JpiTyVu9QnHoGvPycw8v5FXpa0Dx9y34tBapth6bCjfBUyWI4R0I1ZHnbCw==";
        };
        _oOrnyzlA = {
            "id" = "oOrnyzlA";
            "file" = "TrueAdaptiveMusic-neoforge-2.7.9+1.21.2.jar";
            "hash" = "sha512-PWwSwjAZ99RshXrggrvvYHunQu9gY+ZPkram1emricXD3hE6M8i7+JeH7Fiq41iGyddjjtxW1lCIge8l512nWw==";
        };
        _ll48rN9i = {
            "id" = "ll48rN9i";
            "file" = "TrueAdaptiveMusic-fabric-2.7.9+1.21.4.jar";
            "hash" = "sha512-b7BgAaWxDzF9wfJxf16WODsWEDYQ1t2QqNJSh9poUZxmkKKDMmKwYnfwOn+guGW8YiDJv4+ptZ1sDLHlR4cbjQ==";
        };
        _Fq2YExz4 = {
            "id" = "Fq2YExz4";
            "file" = "TrueAdaptiveMusic-neoforge-2.7.9+1.21.4.jar";
            "hash" = "sha512-RqWpoP69QcuXFGx/azyya95VIzHwjDYMu/A5HUkPll+XZyEPc5Ol60tk2UZrIA0XETZEj5XvmU7HaknhpRsQ2A==";
        };
        _wkLBDptP = {
            "id" = "wkLBDptP";
            "file" = "TrueAdaptiveMusic-fabric-2.7.9+1.20.1.jar";
            "hash" = "sha512-NRY8YlkA+EgiynQHthjlG1W2Yl3wMNfFXIBvXMFwRvKpdzuErOHQVn7BRhCwojC9ZYRSY2syqKzai72Sujuaww==";
        };
        _7JWJpMHa = {
            "id" = "7JWJpMHa";
            "file" = "TrueAdaptiveMusic-forge-2.7.9+1.20.1-all.jar";
            "hash" = "sha512-Z47ZpWHBjpvPauOrFESOSJLT8HPPmgNLOfb+OhWWwT5zQnKQ0ZhOoIeSmoPFi2P2op5eMTQjBtvxequmaNFKXQ==";
        };
        _q1vm2cyn = {
            "id" = "q1vm2cyn";
            "file" = "TrueAdaptiveMusic-fabric-2.7.9+1.21.3.jar";
            "hash" = "sha512-WH5Jo4n2MgymIi81lAgALyMEPh4VO2HT7JnS/xfL+Nq4hdBfwkjPYoRXZiofvtzjtQXG7r799DgQI74W2IszNg==";
        };
        _AOJCsote = {
            "id" = "AOJCsote";
            "file" = "TrueAdaptiveMusic-neoforge-2.7.9+1.21.3.jar";
            "hash" = "sha512-1oWjHtOdF/V7dug4vTL3/QBmzGxlOrhoHh8fOC96X8/QR8cjKCsv1XK+67IP0EhqPkDFeYpC415msxwuxO17/w==";
        };
        _L4nKziLq = {
            "id" = "L4nKziLq";
            "file" = "TrueAdaptiveMusic-fabric-2.7.9+1.21.1.jar";
            "hash" = "sha512-y+oJCeFdJNieV6M4moHKyRJVqaL+7b31zQUsI1q4Jt/dOe6vAOUe66F5pybB6XxY4392kMx3CnPWkG61x1lLmw==";
        };
        _F0FX7qk6 = {
            "id" = "F0FX7qk6";
            "file" = "TrueAdaptiveMusic-neoforge-2.7.9+1.21.1.jar";
            "hash" = "sha512-btnhui5gXVBLOZS6UB2AMCTmsyAwhkZI1SYPikvd16raTFw1U1SllAQ1J9t/PNSAf0A8IowSydFJpWAXncbg9w==";
        };
        _MJt3CBpi = {
            "id" = "MJt3CBpi";
            "file" = "TrueAdaptiveMusic-fabric-2.7.9+1.21.2.jar";
            "hash" = "sha512-Kqvw/sxLpve9WxWOru8Dor/PVIX1qFe+WlwZHCsSE3+6qngGwS38++YoSgIPsMNfxJ2CH+mF9LqXTFaolC5pyw==";
        };
        _5u2gbuSz = {
            "id" = "5u2gbuSz";
            "file" = "TrueAdaptiveMusic-neoforge-2.7.9+1.21.2.jar";
            "hash" = "sha512-49XctI6iaWD/TjxiM4N2KlKW5A0L4eCV2MrQSiClVQb6Wx2mDz4GY4nDFzY369ovLBwq2ptdvRfmvSXQQDV7zg==";
        };
        _IIuDdPg1 = {
            "id" = "IIuDdPg1";
            "file" = "TrueAdaptiveMusic-fabric-2.7.9+1.20.1.jar";
            "hash" = "sha512-FWUDwc0vFJchYRJgGsxw/+4P2yUHQFIvjHOAXI64XHohnnVlm4SJyo1AlJSgIdVVyNJSyNxD6Gh9mZZIrgMAvA==";
        };
        _iMXSeUxv = {
            "id" = "iMXSeUxv";
            "file" = "TrueAdaptiveMusic-forge-2.7.9+1.20.1-all.jar";
            "hash" = "sha512-XPp+BWI5ApvHfzDHf/I+y0D+3cTs7Z6257NyiO4wzkVzi+h7NeBy9WX0Db0tELOcDHq/W/CMrZQBv6TN+5afTw==";
        };
        _aRfTZKj6 = {
            "id" = "aRfTZKj6";
            "file" = "TrueAdaptiveMusic-fabric-2.8.0+26.1.jar";
            "hash" = "sha512-QjBYur14CGGK6tpEfDQhN+TNBWm4zYEapD5t1ZIEWTO8ZsMyrk7sib93wcGYjiseswbOYArWGWXGJ24A557jyQ==";
        };
        _ZFTvM4jV = {
            "id" = "ZFTvM4jV";
            "file" = "TrueAdaptiveMusic-neoforge-2.8.0+26.1.jar";
            "hash" = "sha512-c4rcY4zByFS8w3S0RfHEbpOycYHNIv+ELNNXphC05qeIJLvUmf2Db6Q+fAZ7mTIgwYF6epcndiTAANuiERhYxA==";
        };
        _qc0zgPXR = {
            "id" = "qc0zgPXR";
            "file" = "TrueAdaptiveMusic-fabric-2.8.0+26.2.jar";
            "hash" = "sha512-EOzh2JxEghOPiWlSbIEK9XMtrfGPk8tAXrobW98kLE2NjFy4kni1wdkY4kJ2AZoHuIt/Lrb2WUZIE1rRxKcrUw==";
        };
        _bVnegoq5 = {
            "id" = "bVnegoq5";
            "file" = "TrueAdaptiveMusic-neoforge-2.8.0+26.2.jar";
            "hash" = "sha512-whNfNo0cogCLjAeAFSHQY9TR1HZMeXdz61BhP0znQmxy77yRIihktEqEzskB5U9W2ydmxJEz4iIsPxRV7BsJIw==";
        };
        _BaoreZNW = {
            "id" = "BaoreZNW";
            "file" = "TrueAdaptiveMusic-fabric-2.8.0+1.21.4.jar";
            "hash" = "sha512-Jtcs/C7iSQp3clw2uXC5YzC/Dp7lkkJtox1D93aAVnRqB/sKlMfHq703Q+/Z8I749wzw8A0t0iZiJjA1GnAwrg==";
        };
        _PTf1wCxE = {
            "id" = "PTf1wCxE";
            "file" = "TrueAdaptiveMusic-neoforge-2.8.0+1.21.4.jar";
            "hash" = "sha512-CGd2knOK+7+7/511Y92PGEYEwhjJHcWlIuTUbtwJILujQwhC5sJjRJP01Jo84noRQ2IHsP+3eYACrGJdsEtmbQ==";
        };
        _Tq7q0ChV = {
            "id" = "Tq7q0ChV";
            "file" = "TrueAdaptiveMusic-fabric-2.8.0+1.21.10.jar";
            "hash" = "sha512-yaLZLmhKAP/tFbafOU9dgg6AuOph065INOflj5oOLki0+yvd9gJ1B7ToXmJYnGPa6cMKsZlmYUb6XozLvi39Ow==";
        };
        _O6sQM11Y = {
            "id" = "O6sQM11Y";
            "file" = "TrueAdaptiveMusic-fabric-2.8.0+1.21.5.jar";
            "hash" = "sha512-2okT7DaN7Iy6Cq/L73Q4kWkUM60mcGs5we0EBdPCiCP6xhpFZZnTFtAHZmp21yQCGVVkK18XGgT3gSf8BHlJzg==";
        };
        _ACVvfSAX = {
            "id" = "ACVvfSAX";
            "file" = "TrueAdaptiveMusic-fabric-2.8.0+1.21.11.jar";
            "hash" = "sha512-0m8L983aB+1LYZf7xEGmhwArnxUCZe/3XcHvMvQsCoj71u1dh3sklhhgBnUKGRWqrAW+NhX5FAXmipNaLq/71Q==";
        };
        _RKIGB6OJ = {
            "id" = "RKIGB6OJ";
            "file" = "TrueAdaptiveMusic-neoforge-2.8.0+1.21.10.jar";
            "hash" = "sha512-0HbFtS7vNkdCmhfDV2unjULgvDt2vheQi0kcr08EVj6GTSCbDXMJ5ADpnLKSmFSfzNHwHeyVpyDXwTOAKWsa7g==";
        };
        _d128UiGG = {
            "id" = "d128UiGG";
            "file" = "TrueAdaptiveMusic-fabric-2.8.0+1.21.6.jar";
            "hash" = "sha512-h1zm9Y1WCwq9EfJYuD4wS32gy3DNtPlEBg8aKoitzyUvJzOWQdaU12oyviVBmaBjTasvo7/4hMAStVM0FGH63w==";
        };
        _Vz6bgSvR = {
            "id" = "Vz6bgSvR";
            "file" = "TrueAdaptiveMusic-neoforge-2.8.0+1.21.5.jar";
            "hash" = "sha512-bREUiKWioosPhV5jvMvWZOqEfO23H61W3bu0NJmcQ8yY1yrW4fxUyQsyO24M8eXkWaJgenF6R4x3AcdCU2vTfw==";
        };
        _gPpsakw0 = {
            "id" = "gPpsakw0";
            "file" = "TrueAdaptiveMusic-neoforge-2.8.0+1.21.11.jar";
            "hash" = "sha512-O3uDE7t2z2AaG1OguSe6qgps0/oIXRBIWh35ua4vTk1Oe2d3vi6TEDJpcXI6YqMEaTezmTj2PiqA+wXjllEMTQ==";
        };
        _ckllLZQM = {
            "id" = "ckllLZQM";
            "file" = "TrueAdaptiveMusic-neoforge-2.8.0+1.21.6.jar";
            "hash" = "sha512-dnd+rpoqd0Jg3P1tIn2rJz1VZS4ay874Y6XM7setNNArhQBN15GV4rpzZqfFfzuaj1Gu3a8s8PTrGJ1uhCOLKg==";
        };
        _ypKW6SaW = {
            "id" = "ypKW6SaW";
            "file" = "TrueAdaptiveMusic-fabric-2.8.0+1.21.9.jar";
            "hash" = "sha512-g7vGMq0zbUsmVxVTL+EkNnAseA77NtpajO0UYvvDYmChixBWmX5F4C1qzuR6FNaSIRVOZv4KOR5MUyZl3L7Aqw==";
        };
        _2mFtFlEy = {
            "id" = "2mFtFlEy";
            "file" = "TrueAdaptiveMusic-neoforge-2.8.0+1.21.9.jar";
            "hash" = "sha512-8e3dvUbQo6qyeNaPE31NiqxI2mjMr53ovkil9EEVel2wCWs3PzwqUvNpA79lt3l4vQUHIsdSEbaDw6u9SdJlzw==";
        };
        _sicuoW1X = {
            "id" = "sicuoW1X";
            "file" = "TrueAdaptiveMusic-fabric-2.8.0+1.21.7.jar";
            "hash" = "sha512-mczzmKQtE8NMR1jv4FrmFpwiqN+7tJh796Fmph1x95ZvAiP98bltn0vDVRm8JLjRvrqRl7SS5xRyWIN+CwLV7Q==";
        };
        _7TIM1plX = {
            "id" = "7TIM1plX";
            "file" = "TrueAdaptiveMusic-neoforge-2.8.0+1.21.7.jar";
            "hash" = "sha512-G0grQ2exNYZw265Il81a9s0gvN8xyZ2rYJDcfYxeLLbFVYoexDyE+eXxUSM+bqogC7Oqk8OYXT5ZnUK2U9ATNg==";
        };
        _AVsVLpmn = {
            "id" = "AVsVLpmn";
            "file" = "TrueAdaptiveMusic-fabric-2.8.0+1.21.3.jar";
            "hash" = "sha512-khh1rBLeocMa+FnubFJvhnNKs/BKv92E+0aPMZI/2M3uu/Bby+e9zJXluY6B7sN/JFuTvCZ3/CiqStkClh618g==";
        };
        _VrZhBdWB = {
            "id" = "VrZhBdWB";
            "file" = "TrueAdaptiveMusic-neoforge-2.8.0+1.21.3.jar";
            "hash" = "sha512-PeLGPj0PQM7zg66QebkK2fPJZMUisXgCZbhrHeO9NFLD0FrShXhHT7haf62xJAgGO89xTsONoUzvieyWB9IqHQ==";
        };
        _YzcBPsK0 = {
            "id" = "YzcBPsK0";
            "file" = "TrueAdaptiveMusic-fabric-2.8.0+1.21.2.jar";
            "hash" = "sha512-p24jNF8m4QVhwsvhT6438Ur8VRbnJqRalxXyEkNMS3vI+vEa0yXqpTFSfuE2Hhetmy87d8nfBHQxODYwPnl4kQ==";
        };
        _sTA4uwg6 = {
            "id" = "sTA4uwg6";
            "file" = "TrueAdaptiveMusic-neoforge-2.8.0+1.21.2.jar";
            "hash" = "sha512-NV4UQlXhs57os7Wn1n0yJiE6Ss8zQNM5eAWSIaosboyyzgfrnfDE/TYdbbVPz1iZV0XXH/iglopDX9jlSilqjA==";
        };
        _ZAxV8o25 = {
            "id" = "ZAxV8o25";
            "file" = "TrueAdaptiveMusic-fabric-2.8.0+1.20.1.jar";
            "hash" = "sha512-qJFXYEIQl5xzm5w6PRLATxZg+xOfdrx/4oH+JkZR5P4oMPvqzVQ4Hfm9M/B0IRPmkahfMDXZ6Ik4UDrHPUCiPA==";
        };
        _mHiMdZho = {
            "id" = "mHiMdZho";
            "file" = "TrueAdaptiveMusic-fabric-2.8.0+1.21.8.jar";
            "hash" = "sha512-4J0Y0XiyjdnHXnfO08STcnui/zWkK5DEnoqsp5H0Mb770ilfVxr24mg10pffJLqxzj1OALORkuTqgLVLU4h46Q==";
        };
        _78K8rgOP = {
            "id" = "78K8rgOP";
            "file" = "TrueAdaptiveMusic-forge-2.8.0+1.20.1-all.jar";
            "hash" = "sha512-SxR54oMFBJflKnwDxjQxRBsIqUht5dCXIJbdSiiIBoiObBcoGwYNe+W1C4ZB7YOj2SJ+eHL37e8BqlrtRNpPzQ==";
        };
        _MxPxNSDL = {
            "id" = "MxPxNSDL";
            "file" = "TrueAdaptiveMusic-fabric-2.8.0+1.21.1.jar";
            "hash" = "sha512-I+j/P6z4gXwme3n+UK7rD/rHUPtRQdo6Rr8fCWs5xHnzd4ndLiPiqpVs5DD0/1CRQpq9F8zf91gvZQol64CtkQ==";
        };
        _ohibABNG = {
            "id" = "ohibABNG";
            "file" = "TrueAdaptiveMusic-neoforge-2.8.0+1.21.8.jar";
            "hash" = "sha512-9uJTRFv2jnBBJ+2Hzk2cX9690vQN/NPv7i0ul3uNitECK9BJlZ7ZkYyt+UGqs98HlnSQOSgye/pnLdsYmw3i3g==";
        };
        _lASzemq3 = {
            "id" = "lASzemq3";
            "file" = "TrueAdaptiveMusic-neoforge-2.8.0+1.21.1.jar";
            "hash" = "sha512-cs464GPJveuTK8PA5mPjpf0GSoYluskE8OupvhtsUUcCf+YsIvPCH6Hw4rgKc+hVBdfkBKlWs7fgCFuB3YHwmg==";
        };
        _FKh8ghmB = {
            "id" = "FKh8ghmB";
            "file" = "TrueAdaptiveMusic-fabric-2.8.0+1.20.1.jar";
        ...
        _XBhOWWad = {
            "id" = "XBhOWWad";
            "file" = "TrueAdaptiveMusic-forge-2.8.0+1.20.1-all.jar";
            "hash" = "sha512-wfyjJp91tsdnaFk5tVxbGlvAmFrzM2qF6ULAfKwnJ5grthE3ZKKy61fXcW3y4Q5qcy9jT0I7yu2pX8RiaAP4nw==";
        };
        _KEz36xeb = {
            "id" = "KEz36xeb";
            "file" = "TrueAdaptiveMusic-fabric-2.8.0+1.20.1.jar";
    ...
    in {
        ...
        "pkg-1.1+1.20.1" = _DVWt2Xk9;
        "pkg-1.2+1.20.1" = _X0UPnEK8;
        "pkg-1.2+1.20" = _GeRQl6ms;
        "pkg-1.2+1.20.2" = _dF5eZF4M;
        "pkg-1.3+" = _55htuNNR;
        "pkg-1.3.1+" = _oYQ7h4nC;
        "pkg-+" = _erWZbBeC;
        "pkg-1.3.2+1.21.9" = _laQ9GnIj;
        "pkg-1.3+1.20.1" = _bG8sIQfm;
        "pkg-1.3.1+1.21.1" = _Eaxb1umX;
        "pkg-1.3.1+1.21.2" = _kBmPx5JW;
        "pkg-1.3.1+1.21.3" = _GPyYXmcq;
        "pkg-1.3.1+1.21.5" = _wMfRK6vt;
        "pkg-1.3.1h1+1.21.7" = _iOKyhoSs;
        "pkg-1.3.1+1.21.4" = _tPl9xdbV;
        "pkg-1.3.1h1+1.21.6" = _bYm642GX;
        "pkg-1.3.1h1+1.21.8" = _KrhJyNGJ;
        "pkg-1.3.2+1.21.10" = _LG1Adq2Y;
        "pkg-1.3.2+1.21.11" = _vnFQW4Su;
        "pkg-1.3.1+1.20.1" = _zH5SqHft;
        "pkg-1.3.2+1.21.8" = _BQyXrNtE;
        "pkg-1.3.2+1.21.1" = _WjuJc7zu;
        "pkg-1.3.2+1.21.2" = _5ITlHggN;
        "pkg-1.3.2+1.20.1" = _UGMtdV9i;
        "pkg-1.3.2+1.21.7" = _ro4dpAV1;
        "pkg-1.3.2+1.21.6" = _f3X7cq8x;
        "pkg-1.3.2+1.21.4" = _iHT6TwMl;
        "pkg-1.3.2+1.21.3" = _S3eB5NPJ;
        "pkg-1.3.2+1.21.5" = _5BXSK15S;
        "pkg-1.4+1.20.1" = _TW9urwsH;
        "pkg-1.4+1.21.1" = _GLcRlPSG;
        "pkg-1.4+1.21.5" = _Smp1jK9Y;
        "pkg-1.4+1.21.2" = _CuV16r8k;
        "pkg-1.4+1.21.7" = _Nyb8pqed;
        "pkg-1.4+1.21.3" = _YSDf08gk;
        "pkg-1.4+1.21.8" = _MhtaH2lr;
        "pkg-1.4+1.21.6" = _BczvJkaW;
        "pkg-1.4+1.21.4" = _q9ElmQ6V;
        "pkg-1.4+1.21.9" = _luCF5KQL;
        "pkg-1.4+1.21.10" = _POaKAle1;
        "pkg-1.4+1.21.11" = _mIU66rFQ;
        "pkg-1.4h1+1.21.8" = _baeJgYyi;
        "pkg-1.4h1+1.21.7" = _2LWxquNH;
        "pkg-1.4h1+1.21.5" = _88vbjnVd;
        "pkg-1.4h1+1.21.4" = _JiyLN5fA;
        "pkg-1.4h1+1.21.9" = _WD6WKpEE;
        "pkg-1.4h1+1.21.11" = _6p4C7oM1;
        "pkg-1.4h1+1.21.10" = _E2Ssfr0U;
        "pkg-1.4h1+1.21.6" = _BBEpvX1l;
        "pkg-1.4h1+1.21.2" = _bXCTMaPU;
        "pkg-1.4h1+1.21.3" = _VaGmUJhH;
        "pkg-1.4h1+1.21.1" = _mVpfYP6Z;
        "pkg-1.4h1+1.20.1" = _ZXqbYxiP;
        "pkg-1.5+1.21.11" = _4e8NksV1;
        "pkg-1.5+1.21.10" = _Mwk1fXEP;
        "pkg-1.5+1.21.9" = _oCUgIiU2;
        "pkg-1.5+1.21.7" = _SOC2XfUm;
        "pkg-1.5+1.21.8" = _UwyNmCXK;
        "pkg-1.5+1.21.6" = _bI6aulFJ;
        "pkg-1.5+1.21.3" = _i4NDcYPD;
        "pkg-1.5+1.21.5" = _W97LcB8e;
        "pkg-1.5+1.21.4" = _FdCd0h8l;
        "pkg-1.5+1.21.2" = _WcDrUoX4;
        "pkg-1.5+1.21.1" = _3PDjSjwn;
        "pkg-1.5+1.20.1" = _w3BxStQl;
        "pkg-1.5.1+1.21.11" = _dodJQ78n;
        "pkg-1.5.1+1.21.9" = _Kbk4iwZr;
        "pkg-1.5.1+1.21.10" = _Tve69EP2;
        "pkg-1.5.1+1.21.4" = _2aJTXsPO;
        "pkg-1.5.1+1.21.6" = _5JThsrAW;
        "pkg-1.5.1+1.21.5" = _Qm6hQQgv;
        "pkg-1.5.1+1.21.7" = _letoUDvG;
        "pkg-1.5.1+1.21.3" = _1NZQa0Wi;
        "pkg-1.5.1+1.21.2" = _svw86Pcm;
        "pkg-1.5.1+1.21.8" = _whzo1Gj9;
        "pkg-1.5.1+1.20.1" = _O8O5wWkA;
        "pkg-1.5.1+1.21.1" = _GUfmDJsT;
        "pkg-1.6+1.21.6" = _GaXZIQ4d;
        "pkg-1.6+1.21.5" = _HhsbLe3q;
        "pkg-1.6+1.21.4" = _NbNVbGEg;
        "pkg-1.6+1.21.7" = _lDSezYiN;
        "pkg-1.6+1.21.10" = _mUTflkbf;
        "pkg-1.6+1.20.1" = _vpdeHam8;
        "pkg-1.6+1.21.3" = _TBsUvrAB;
        "pkg-1.6+1.21.1" = _jKERZb0a;
        "pkg-1.6+1.21.9" = _ulPWKBUd;
        "pkg-1.6+1.21.11" = _oNz9Dp9l;
        "pkg-1.6+1.21.8" = _IK7IBWJO;
        "pkg-1.6+1.21.2" = _PRElqlnC;
        "pkg-1.6h1+1.20.1" = _nUqe9dK0;
        "pkg-1.6h1+1.21.10" = _suN0rTDa;
        "pkg-1.6h1+1.21.9" = _eki6Uimu;
        "pkg-1.6h1+1.21.11" = _1TIHlYtv;
        "pkg-1.6h1+1.21.8" = _yazJyLtU;
        "pkg-1.6h1+1.21.7" = _ulBpRk30;
        "pkg-1.6h1+1.21.4" = _r9pBTzr4;
        "pkg-1.6h1+1.21.6" = _qVQofsIA;
        "pkg-1.6h1+1.21.5" = _suCfVixo;
        "pkg-1.6h1+1.21.3" = _h0og2WpJ;
        "pkg-1.6h1+1.21.2" = _4kwYtQGU;
        "pkg-1.6h1+1.21.1" = _DIneGPpL;
        "pkg-1.6.1+1.21.11" = _A8blTAlL;
        "pkg-1.6.1+1.21.10" = _NVyquekA;
        "pkg-1.6.1+1.21.9" = _EOR0H4ek;
        "pkg-1.6.1+1.21.6" = _8D99cFCG;
        "pkg-1.6.1+1.21.3" = _s5uA518t;
        "pkg-1.6.1+1.21.8" = _Li1On2mN;
        "pkg-1.6.1+1.21.1" = _WNXRcC7X;
        "pkg-1.6.1+1.21.4" = _4knpyJ7P;
        "pkg-1.6.1+1.20.1" = _YsJ9cgtP;
        "pkg-1.6.1+1.21.7" = _mG5slaD8;
        "pkg-1.6.1+1.21.2" = _Rn9IwkmR;
        "pkg-1.6.1+1.21.5" = _TuVya0MX;
        "pkg-1.7+1.21.10" = _WKqcvq49;
        "pkg-1.7+1.21.6" = _TjCAwC3Q;
        "pkg-1.7+1.21.11" = _nvaDct89;
        "pkg-1.7+1.21.7" = _MGIDO3M0;
        "pkg-1.7+1.21.8" = _MtPfhZPT;
        "pkg-1.7+1.21.5" = _BE1lr8pa;
        "pkg-1.7+1.21.9" = _tcY2HgCW;
        "pkg-1.7+1.21.4" = _r692d3Di;
        "pkg-1.7+1.21.3" = _hSFOYb3q;
        "pkg-1.7+1.20.1" = _Z56emVsd;
        "pkg-1.7+1.21.2" = _KNK1hDC6;
        "pkg-1.7+1.21.1" = _Yul9CdFu;
        "pkg-1.7h1+1.21.11" = _P6Go1hN6;
        "pkg-1.7h1+1.21.7" = _ZUWEAfwM;
        "pkg-1.7h1+1.21.5" = _JCEFo9E0;
        "pkg-1.7h1+1.21.10" = _ZcJOzgaL;
        "pkg-1.7h1+1.21.4" = _Q9IhUOKp;
        "pkg-1.7h1+1.21.3" = _AuLNemcG;
        "pkg-1.7h1+1.21.9" = _2JhlhnaJ;
        "pkg-1.7h1+1.20.1" = _huPjLo6F;
        "pkg-1.7h1+1.21.6" = _R62Xkt54;
        "pkg-1.7h1+1.21.1" = _gNbgyxXX;
        "pkg-1.7h1+1.21.8" = _Zw9i7wmf;
        "pkg-1.7h1+1.21.2" = _FT3ywA5M;
        "pkg-1.7.1+1.21.11" = _G5dkQCd9;
        "pkg-1.7.1+1.21.10" = _mvWexkxf;
        "pkg-1.7.1+1.21.6" = _9Oxq6z2S;
        "pkg-1.7.1+1.21.8" = _tee27MIM;
        "pkg-1.7.1+1.21.3" = _y704a0qT;
        "pkg-1.7.1+1.21.5" = _6cEP1t9o;
        "pkg-1.7.1+1.21.9" = _ImRpMZlk;
        "pkg-1.7.1+1.21.2" = _MYsi4KjY;
        "pkg-1.7.1+1.21.1" = _Mf4dakdT;
        "pkg-1.7.1+1.21.7" = _XcGXuo4i;
        "pkg-1.7.1+1.20.1" = _F87ifd0L;
        "pkg-1.7.1+1.21.4" = _PbrgImhm;
        "pkg-1.7.2+1.21.7" = _G5jqg9Ce;
        "pkg-1.7.2+1.21.11" = _f8gzpoXI;
        "pkg-1.7.2+1.21.9" = _V9gWWOfk;
        "pkg-1.7.2+1.21.10" = _PFRfG2RJ;
        "pkg-1.7.2+1.21.4" = _Yv8bk3fD;
        "pkg-1.7.2+1.21.3" = _aQPsXMNJ;
        "pkg-1.7.2+1.21.5" = _FkqP8BZR;
        "pkg-1.7.2+1.21.6" = _w69fwQvf;
        "pkg-1.7.2+1.21.2" = _xltvUdm2;
        "pkg-1.7.2+1.21.8" = _TINOUxfP;
        "pkg-1.7.2+1.20.1" = _UTRWon1F;
        "pkg-1.7.2+1.21.1" = _qe7Im2O6;
        "pkg-1.7.2-hotfix1+1.21.11" = _sC6X3g5O;
        "pkg-1.7.2-hotfix1+1.21.7" = _Q0M6jrbV;
        "pkg-1.7.2-hotfix1+1.21.9" = _FSOlbwgq;
        "pkg-1.7.2-hotfix1+1.21.6" = _AqRwWquz;
        "pkg-1.7.2-hotfix1+1.21.4" = _z1alkyHg;
        "pkg-1.7.2-hotfix1+1.21.8" = _GXny4pWJ;
        "pkg-1.7.2-hotfix1+1.21.10" = _4rSdztGZ;
        "pkg-1.7.2-hotfix1+1.21.5" = _SA4mMFR2;
        "pkg-1.7.2-hotfix1+1.20.1" = _8DKyZXUA;
        "pkg-1.7.2-hotfix1+1.21.1" = _gLwnzF2A;
        "pkg-1.7.2-hotfix1+1.21.2" = _IdM3vV6T;
        "pkg-1.7.2-hotfix2+1.21.8" = _WBPPghV5;
        "pkg-1.7.2-hotfix2+1.21.10" = _2sNSbOoL;
        "pkg-1.7.2-hotfix2+1.21.9" = _UGnwiYCH;
        "pkg-1.7.2-hotfix2+1.21.6" = _8zWnPdOc;
        "pkg-1.7.2-hotfix2+1.21.4" = _YTQrWmNL;
        "pkg-1.7.2-hotfix2+1.21.11" = _8SXg1i3t;
        "pkg-1.7.2-hotfix2+1.21.5" = _t7OoIUpk;
        "pkg-1.7.2-hotfix2+1.20.1" = _6US40gUC;
        "pkg-1.7.2-hotfix2+1.21.3" = _YmfEsLHh;
        "pkg-1.7.2-hotfix2+1.21.7" = _mu59bVDf;
        "pkg-1.7.2-hotfix2+1.21.2" = _dYIZVAVf;
        "pkg-1.7.2-hotfix2+1.21.1" = _EuKRey6k;
        "pkg-1.8+1.21.9" = _dpF1xz0Y;
        "pkg-1.8+1.21.10" = _8o8NrRgr;
        "pkg-1.8+1.21.11" = _GNMcU3dH;
        "pkg-1.8+1.21.3" = _F4IAV5l6;
        "pkg-1.8+1.21.1" = _GMbZ7w0r;
        "pkg-1.8+1.21.5" = _p3tL91Ds;
        "pkg-1.8+1.21.7" = _uq7uOY7n;
        "pkg-1.8+1.21.6" = _N8198AFo;
        "pkg-1.8+1.21.8" = _kbdR9j3I;
        "pkg-1.8+1.20.1" = _o6wzA9Bt;
        "pkg-1.8+1.21.2" = _lf9BcCge;
        "pkg-1.8+1.21.4" = _BcxLtz1u;
        "pkg-1.8-hotfix1+1.20.1" = _wy8lmLD9;
        "pkg-1.8-hotfix2+1.20.1" = _oYX0wC0X;
        "pkg-1.8-hotfix3+1.21.10" = _fC9e2STq;
        "pkg-1.8-hotfix3+1.21.9" = _LRXV33iB;
        "pkg-1.8-hotfix3+1.21.6" = _28s9dhoH;
        "pkg-1.8-hotfix3+1.21.5" = _sZHr9cLj;
        "pkg-1.8-hotfix3+1.21.7" = _joBqDTuZ;
        "pkg-1.8-hotfix3+1.21.8" = _4g9IKMpI;
        "pkg-1.8-hotfix3+1.21.4" = _XxM8Jlsh;
        "pkg-1.8-hotfix3+1.20.1" = _UUReYG3a;
        "pkg-1.8-hotfix3+1.21.1" = _hvqUvmBM;
        "pkg-1.8-hotfix3+1.21.3" = _oAwkbFyS;
        "pkg-1.8-hotfix3+1.21.2" = _FY7km6iO;
        "pkg-1.8-hotfix3+1.21.11" = _Jwro2SYK;
        "pkg-1.8-hotfix4+1.20.1" = _OYzexAT1;
        "pkg-1.8-hotfix5+1.20.1" = _mqyQJELv;
        "pkg-2.0+1.21.10" = _5h0BZ3sj;
        "pkg-2.0+1.21.6" = _nblxtuTh;
        "pkg-2.0+1.21.5" = _GA0qUzgw;
        "pkg-2.0+1.21.11" = _pwcQHGIA;
        "pkg-2.0+1.21.9" = _6SxZANmE;
        "pkg-2.0+1.21.3" = _JCHUgXOp;
        "pkg-2.0+1.21.7" = _zFzrfxpR;
        "pkg-2.0+1.20.1" = _wCX9b2pa;
        "pkg-2.0+1.21.4" = _KdTCZCGY;
        "pkg-2.0+1.21.2" = _gMBm5Oxh;
        "pkg-2.0+1.21.8" = _nFFcIqGA;
        "pkg-2.0+1.21.1" = _7GBthGFL;
        "pkg-2.1+1.21.7" = _KiDJunBE;
        "pkg-2.1+1.21.4" = _MrZbJ4hk;
        "pkg-2.1+1.21.9" = _n1Jhftkb;
        "pkg-2.1+1.21.6" = _luO6e2It;
        "pkg-2.1+1.21.8" = _nIrVSw5d;
        "pkg-2.1+1.21.11" = _hoq7q8fb;
        "pkg-2.1+1.21.2" = _oSRL0AJ7;
        "pkg-2.1+1.21.5" = _p6w9Wkvt;
        "pkg-2.1+1.21.1" = _BVXmgENW;
        "pkg-2.1+1.21.10" = _vlVFmPGB;
        "pkg-2.1+1.20.1" = _L79OthBu;
        "pkg-2.1+1.21.3" = _RGbZQecw;
        "pkg-2.1-hotfix2+1.21.11" = _4B8lgmCv;
        "pkg-2.1-hotfix2+1.21.1" = _RCiKUbUc;
        "pkg-2.1-hotfix2+1.21.4" = _8DheJTk6;
        "pkg-2.1-hotfix2+1.21.6" = _eUz2dnpo;
        "pkg-2.1-hotfix2+1.21.10" = _gakGRm7t;
        "pkg-2.1-hotfix2+1.21.8" = _TXSci8nW;
        "pkg-2.1-hotfix2+1.21.7" = _LgCCYpCZ;
        "pkg-2.1-hotfix2+1.21.9" = _SqB1uQTi;
        "pkg-2.1-hotfix2+1.21.2" = _EK39Y7sz;
        "pkg-2.1-hotfix2+1.21.5" = _zXzhiHgO;
        "pkg-2.1-hotfix2+1.21.3" = _JMjwboeQ;
        "pkg-2.1-hotfix2+1.20.1" = _5iH00Vso;
        "pkg-2.1-hotfix3+1.21.1" = _W4VaeEfQ;
        "pkg-2.1-hotfix3+1.21.11" = _l4pVHar3;
        "pkg-2.1-hotfix3+1.21.10" = _ElWBPfwJ;
        "pkg-2.1-hotfix3+1.20.1" = _xr94Y2hP;
        "pkg-2.1-hotfix3+1.21.9" = _K7yFhS1k;
        "pkg-2.1-hotfix3+1.21.2" = _7yEZWCAc;
        "pkg-2.1-hotfix3+1.21.3" = _vk9OYM70;
        "pkg-2.1-hotfix3+1.21.7" = _TJ8bxhfK;
        "pkg-2.1-hotfix3+1.21.6" = _n8IaJH4v;
        "pkg-2.1-hotfix3+1.21.4" = _oX6nfJiI;
        "pkg-2.1-hotfix3+1.21.5" = _yoZKPSAZ;
        "pkg-2.1-hotfix3+1.21.8" = _y9hOZEpc;
        "pkg-2.1.1+1.21.1" = _tWElvxzk;
        "pkg-2.1.1+1.20.1" = _AH9YFLtx;
        "pkg-2.1.1+1.21.4" = _nTYPGX3l;
        "pkg-2.1.1+1.21.8" = _ecmD13yA;
        "pkg-2.1.1+1.21.6" = _oTRD5ovj;
        "pkg-2.1.1+1.21.9" = _3fGzeDu2;
        "pkg-2.1.1+1.21.11" = _VF8P3ZVP;
        "pkg-2.1.1+1.21.2" = _IlaEAD6X;
        "pkg-2.1.1+1.21.3" = _X3nJLe4g;
        "pkg-2.1.1+1.21.10" = _4hGZ6YoU;
        "pkg-2.1.1+1.21.7" = _M3gA7ZZG;
        "pkg-2.1.1+1.21.5" = _3Qzd2CxT;
        "pkg-2.1.1+26.1" = _Ge2zORbv;
        "pkg-2.1.2+26.1" = _lXH8aFi4;
        "pkg-2.1.2+1.21.8" = _M4V4gjQq;
        "pkg-2.1.2+1.21.9" = _Iq10G5XR;
        "pkg-2.1.2+1.21.1" = _o8rJx1aT;
        "pkg-2.1.2+1.21.4" = _OFp2XFoB;
        "pkg-2.1.2+1.21.6" = _lUsT6QHI;
        "pkg-2.1.2+1.21.11" = _ZQoaDZgP;
        "pkg-2.1.2+1.21.2" = _JEZzyjPU;
        "pkg-2.1.2+1.20.1" = _GMjtjk0I;
        "pkg-2.1.2+1.21.10" = _D7sb7CvJ;
        "pkg-2.1.2+1.21.3" = _psHx6EEK;
        "pkg-2.1.2+1.21.7" = _fsK7F8J0;
        "pkg-2.1.2+1.21.5" = _6ULDNjLF;
        "pkg-2.1.2-hotfix1+1.21.11" = _Um6JaMdT;
        "pkg-2.1.2-hotfix1+1.20.1" = _x5o2xQdr;
        "pkg-2.1.2-hotfix1+1.21.1" = _B2vau4sF;
        "pkg-2.1.2-hotfix1+1.21.10" = _tQ4blPXO;
        "pkg-2.1.2-hotfix1+1.21.6" = _QqRNrspU;
        "pkg-2.1.2-hotfix1+1.21.9" = _6TYRhzOn;
        "pkg-2.1.2-hotfix1+1.21.7" = _WhQLNtyw;
        "pkg-2.1.2-hotfix1+1.21.3" = _pvOcHhVp;
        "pkg-2.1.2-hotfix1+1.21.4" = _1e9RL2Bv;
        "pkg-2.1.2-hotfix1+1.21.8" = _QAcAA6RF;
        "pkg-2.1.2-hotfix1+1.21.5" = _LTGDYcXe;
        "pkg-2.1.2-hotfix1+1.21.2" = _mFp6QN8q;
        "pkg-2.2+26.1" = _Y66qdvxA;
        "pkg-2.2+1.21.11" = _1jCQI6Aq;
        "pkg-2.2+1.21.9" = _5jiNKarU;
        "pkg-2.2+1.21.6" = _p1xAcwDK;
        "pkg-2.2+1.21.7" = _Q7VaMhuD;
        "pkg-2.2+1.20.1" = _e7Fo9FIx;
        "pkg-2.2+1.21.5" = _jUanNrwQ;
        "pkg-2.2+1.21.1" = _pLyfIBMl;
        "pkg-2.2+1.21.3" = _ZI9QXJLp;
        "pkg-2.2+1.21.2" = _h9P9h3Jy;
        "pkg-2.2+1.21.4" = _LtS14HJA;
        "pkg-2.2+1.21.8" = _GOChY0Uo;
        "pkg-2.2+1.21.10" = _5tdermco;
        "pkg-2.2-hotfix1+26.1" = _jEPfgfWh;
        "pkg-2.2-hotfix1+1.21.9" = _lOu9I6fM;
        "pkg-2.2-hotfix1+1.21.11" = _QprxP08e;
        "pkg-2.2-hotfix1+1.21.7" = _u1KZ39qJ;
        "pkg-2.2-hotfix1+1.21.5" = _BdmXSasB;
        "pkg-2.2-hotfix1+1.21.6" = _I9XgU7Mp;
        "pkg-2.2-hotfix1+1.21.10" = _70FfAXkF;
        "pkg-2.2-hotfix1+1.20.1" = _Lx6FTTRp;
        "pkg-2.2-hotfix1+1.21.1" = _f76KlJRB;
        "pkg-2.2-hotfix1+1.21.4" = _WyWnMtLq;
        "pkg-2.2-hotfix1+1.21.8" = _nMjtyKhx;
        "pkg-2.2-hotfix1+1.21.2" = _2kivjs6N;
        "pkg-2.2-hotfix1+1.21.3" = _nk5kaDik;
        "pkg-2.2-hotfix2+26.1" = _kzT9qesK;
        "pkg-2.2-hotfix2+1.21.10" = _XD9VIjFE;
        "pkg-2.2-hotfix2+1.21.3" = _HgZxYGee;
        "pkg-2.2-hotfix2+1.21.7" = _XSlYW9xJ;
        "pkg-2.2-hotfix2+1.21.5" = _Vhqipw1e;
        "pkg-2.2-hotfix2+1.21.4" = _rkHZ18ge;
        "pkg-2.2-hotfix2+1.21.11" = _QR1rt0Ki;
        "pkg-2.2-hotfix2+1.21.6" = _fGg0il0e;
        "pkg-2.2-hotfix2+1.21.2" = _ppVay1HX;
        "pkg-2.2-hotfix2+1.21.1" = _kF5ihc9W;
        "pkg-2.2-hotfix2+1.21.9" = _Dv9UMccJ;
        "pkg-2.2-hotfix2+1.20.1" = _kbS9j00K;
        "pkg-2.2-hotfix2+1.21.8" = _9WsW92Kg;
        "pkg-2.2.1+26.1" = _lIQlsZVh;
        "pkg-2.2.1+1.21.10" = _3RIuTvD3;
        "pkg-2.2.1+1.21.1" = _3E08Kcxc;
        "pkg-2.2.1+1.21.5" = _rAPLcK6k;
        "pkg-2.2.1+1.21.8" = _5T9m5Vpd;
        "pkg-2.2.1+1.21.3" = _X6cb785z;
        "pkg-2.2.1+1.21.2" = _w29442M1;
        "pkg-2.2.1+1.21.11" = _zniYrEjp;
        "pkg-2.2.1+1.21.6" = _TiXwplca;
        "pkg-2.2.1+1.21.7" = _l01sx06O;
        "pkg-2.2.1+1.21.4" = _XJktbrR4;
        "pkg-2.2.1+1.21.9" = _y0zGbP9C;
        "pkg-2.2.1+1.20.1" = _Jv2tPikb;
        "pkg-2.2.1-hotfix1+1.21.11" = _wAws1o3h;
        "pkg-2.2.1-hotfix1+1.21.10" = _fQWXSvij;
        "pkg-2.2.1-hotfix1+1.21.2" = _mS6syBAH;
        "pkg-2.2.1-hotfix1+1.21.8" = _qbLilMDi;
        "pkg-2.2.1-hotfix1+1.21.7" = _43II4rIw;
        "pkg-2.2.1-hotfix1+1.21.3" = _asbwZyYh;
        "pkg-2.2.1-hotfix1+1.20.1" = _F8YiPOB4;
        "pkg-2.2.1-hotfix1+1.21.6" = _PZIsysnE;
        "pkg-2.2.1-hotfix1+1.21.4" = _EIZb60oy;
        "pkg-2.2.1-hotfix1+1.21.5" = _LIHHqs1u;
        "pkg-2.2.1-hotfix1+1.21.1" = _NKKcJdPG;
        "pkg-2.2.1-hotfix1+1.21.9" = _NyuEMWtS;
        "pkg-2.3+26.1" = _itytrDS4;
        "pkg-2.3+1.21.6" = _DaIy0M3i;
        "pkg-2.3+1.21.2" = _er5OONjc;
        "pkg-2.3+1.21.9" = _U8PGg2e2;
        "pkg-2.3+1.21.5" = _lOe6LoR7;
        "pkg-2.3+1.21.4" = _qCap5Hzq;
        "pkg-2.3+1.21.8" = _kYLZgIzT;
        "pkg-2.3+1.21.3" = _UWByEzRK;
        "pkg-2.3+1.21.7" = _VzvGStyO;
        "pkg-2.3+1.21.11" = _DIZuLRU0;
        "pkg-2.3+1.21.1" = _pDrSnqyo;
        "pkg-2.3+1.21.10" = _Rp8BL6Td;
        "pkg-2.3+1.20.1" = _Y1LVsIOZ;
        "pkg-2.3-hotfix1+1.21.11" = _J73dvBeV;
        "pkg-2.3-hotfix1+1.21.9" = _wYf8SpMC;
        "pkg-2.3-hotfix1+1.21.10" = _o67cR4gb;
        "pkg-2.3-hotfix1+1.21.3" = _FPyYqO4n;
        "pkg-2.3-hotfix1+1.21.1" = _y0YERHwd;
        "pkg-2.3-hotfix1+1.21.6" = _69qdCIl3;
        "pkg-2.3-hotfix1+1.21.7" = _Q7IMcfsB;
        "pkg-2.3-hotfix1+1.21.5" = _q8eAhoed;
        "pkg-2.3-hotfix1+1.21.8" = _Ei9GEtEJ;
        "pkg-2.3-hotfix1+1.20.1" = _YDhvruzh;
        "pkg-2.3-hotfix1+1.21.4" = _hQ5Msgq8;
        "pkg-2.3-hotfix1+1.21.2" = _JA4Tl6iv;
        "pkg-2.3-hotfix2+1.21.11" = _VaLp81B4;
        "pkg-2.3-hotfix2+1.21.8" = _aWmyQDlK;
        "pkg-2.3-hotfix2+1.21.6" = _j2ZiKcg2;
        "pkg-2.3-hotfix2+1.21.10" = _Prf4aqpp;
        "pkg-2.3-hotfix2+1.21.4" = _SqWCCOCb;
        "pkg-2.3-hotfix2+1.21.3" = _xOmwIHaR;
        "pkg-2.3-hotfix2+1.21.9" = _LhNsal2k;
        "pkg-2.3-hotfix2+1.21.2" = _o4SFdT2M;
        "pkg-2.3-hotfix2+1.21.1" = _6v0S9SiW;
        "pkg-2.3-hotfix2+1.21.7" = _HK7jQIDc;
        "pkg-2.3-hotfix2+1.20.1" = _9dbN3h3J;
        "pkg-2.3-hotfix2+1.21.5" = _y0BrD8Rc;
        "pkg-2.3.1+26.1" = _tyaDePQS;
        "pkg-2.3.1+1.21.11" = _tmDPGsBC;
        "pkg-2.3.1+1.21.7" = _QFHWr2kK;
        "pkg-2.3.1+1.21.10" = _9MA3ItkO;
        "pkg-2.3.1+1.21.9" = _6ijGSCxK;
        "pkg-2.3.1+1.21.8" = _qzkRlxyt;
        "pkg-2.3.1+1.21.1" = _TAJlWqqC;
        "pkg-2.3.1+1.21.2" = _8UKCvhPo;
        "pkg-2.3.1+1.20.1" = _iZ1fSQ5x;
        "pkg-2.3.1+1.21.6" = _8T6lUoy9;
        "pkg-2.3.1+1.21.5" = _wNtbIn7g;
        "pkg-2.3.1+1.21.3" = _AjWgizAn;
        "pkg-2.3.1+1.21.4" = _2JjiufoV;
        "pkg-2.4+26.1" = _tEzoZfWH;
        "pkg-2.4+1.21.11" = _TQ4tSZUL;
        "pkg-2.4+1.21.10" = _oncLS0bH;
        "pkg-2.4+1.21.6" = _TNrhCrY4;
        "pkg-2.4+1.21.5" = _Lcy4iLDU;
        "pkg-2.4+1.21.8" = _D3Y7bh9m;
        "pkg-2.4+1.21.7" = _Mr22ZvR8;
        "pkg-2.4+1.21.1" = _9rRgo9eR;
        "pkg-2.4+1.20.1" = _oWd2vyBi;
        "pkg-2.4+1.21.9" = _aAdrHYYz;
        "pkg-2.4+1.21.2" = _5OvF5vFv;
        "pkg-2.4+1.21.4" = _638Uvw2t;
        "pkg-2.4+1.21.3" = _iBMCFV9z;
        "pkg-2.4-hotfix1+1.20.1" = _cTCLnNYB;
        "pkg-2.4.1+26.1" = _DOrUIBHD;
        "pkg-2.4.1+1.21.8" = _UQKFRucI;
        "pkg-2.4.1+1.21.9" = _Sqmo5Oae;
        "pkg-2.4.1+1.20.1" = _KV1Ithkf;
        "pkg-2.4.1+1.21.6" = _aCJvgfz1;
        "pkg-2.4.1+1.21.4" = _ulDAifsc;
        "pkg-2.4.1+1.21.1" = _opkGSqVn;
        "pkg-2.4.1+1.21.3" = _hfZd5YnN;
        "pkg-2.4.1+1.21.2" = _NpXtukr0;
        "pkg-2.4.1+1.21.5" = _xk3k5daA;
        "pkg-2.4.1+1.21.10" = _oFPbNnOy;
        "pkg-2.4.1+1.21.11" = _uhMKnbrd;
        "pkg-2.4.1+1.21.7" = _WpyDGD3X;
        "pkg-2.4.2+26.1" = _g1GUdkPd;
        "pkg-2.4.2+1.21.11" = _oag8wBFG;
        "pkg-2.4.2+1.21.9" = _XyZuCld6;
        "pkg-2.4.2+1.21.8" = _IalNaFcL;
        "pkg-2.4.2+1.21.10" = _GdX1ns44;
        "pkg-2.4.2+1.20.1" = _xCxfum6g;
        "pkg-2.4.2+1.21.7" = _UbBrim2i;
        "pkg-2.4.2+1.21.2" = _k7nuSZHi;
        "pkg-2.4.2+1.21.1" = _T1V0ugNY;
        "pkg-2.4.2+1.21.3" = _t5MdbOpD;
        "pkg-2.4.2+1.21.4" = _LqkItVi4;
        "pkg-2.4.2+1.21.6" = _Bd0HwwxO;
        "pkg-2.4.2+1.21.5" = _DaPVDNBP;
        "pkg-2.4.3+26.1" = _cysn2LBo;
        "pkg-2.4.3+1.21.11" = _875UTcha;
        "pkg-2.4.3+1.21.10" = _c0XZj4xg;
        "pkg-2.4.3+1.21.6" = _JUYquJaP;
        "pkg-2.4.3+1.21.5" = _B0XsbvOs;
        "pkg-2.4.3+1.21.9" = _ajqwX3cb;
        "pkg-2.4.3+1.21.3" = _rTp81OyR;
        "pkg-2.4.3+1.21.1" = _3ptsBWBm;
        "pkg-2.4.3+1.21.2" = _4nb6Vyl8;
        "pkg-2.4.3+1.21.8" = _wuvkZzlc;
        "pkg-2.4.3+1.21.7" = _fzvHEKYi;
        "pkg-2.4.3+1.20.1" = _IUaoo74i;
        "pkg-2.4.3+1.21.4" = _svqs6aTI;
        "pkg-2.4.4+1.21.1" = _OU1DGqs4;
        "pkg-2.4.4+1.20.1" = _Dvl3K9wg;
        "pkg-2.5.0+26.1" = _rylMmgm3;
        "pkg-2.5.0+1.21.11" = _8iuf4et2;
        "pkg-2.5.0+1.21.7" = _jFdgT4oC;
        "pkg-2.5.0+1.21.10" = _EcTrURG5;
        "pkg-2.5.0+1.21.5" = _r4ah3vjj;
        "pkg-2.5.0+1.21.6" = _TTWjrhXr;
        "pkg-2.5.0+1.21.4" = _twL493va;
        "pkg-2.5.0+1.21.1" = _USULkzj3;
        "pkg-2.5.0+1.21.9" = _jppW9c1v;
        "pkg-2.5.0+1.21.8" = _w63mlAph;
        "pkg-2.5.0+1.21.3" = _LmorHXvQ;
        "pkg-2.5.0+1.20.1" = _yXJcnYBr;
        "pkg-2.5.0+1.21.2" = _rM0hVcTV;
        "pkg-2.6.0+1.21.11" = _PwZqWsHd;
        "pkg-2.6.0+1.21.8" = _bclfs9KX;
        "pkg-2.6.0+1.21.9" = _MDff0Gs8;
        "pkg-2.6.0+1.21.10" = _BiLLlvwg;
        "pkg-2.6.0+1.21.7" = _BCPkOs0U;
        "pkg-2.6.0+1.21.4" = _Zv4UG5XE;
        "pkg-2.6.0+1.21.6" = _D2PrNwl4;
        "pkg-2.6.0+1.21.2" = _458805Tf;
        "pkg-2.6.0+1.21.1" = _tbCKmgB0;
        "pkg-2.6.0+1.21.3" = _p23qsA9s;
        "pkg-2.6.0+1.20.1" = _7lCOUvJy;
        "pkg-2.6.0+1.21.5" = _LBKp57zj;
        "pkg-2.6.0+26.2" = _ZAHiD2zW;
        "pkg-2.6.1+26.1" = _ESn4XYyX;
        "pkg-2.7.0+26.1" = _sGUtRaO4;
        "pkg-2.7.0+1.21.10" = _4sp8beS0;
        "pkg-2.7.0+26.2" = _BqZ5VdxG;
        "pkg-2.7.0+1.21.1" = _TYHsCcL0;
        "pkg-2.7.0+1.21.9" = _8fXF5Pwl;
        "pkg-2.7.0+1.21.2" = _LkFavVeI;
        "pkg-2.7.0+1.21.3" = _jSecrqEM;
        "pkg-2.7.0+1.21.7" = _P26D9uXb;
        "pkg-2.7.0+1.21.11" = _jfK34yt8;
        "pkg-2.7.0+1.21.8" = _8WWxQy59;
        "pkg-2.7.0+1.21.4" = _wf8XJmaQ;
        "pkg-2.7.0+1.21.5" = _Trh6Ze9s;
        "pkg-2.7.0+1.21.6" = _avz23vrM;
        "pkg-2.7.0+1.20.1" = _lVyusFrl;
        "pkg-2.7.1+1.20.1" = _Mvmpif4z;
        "pkg-2.7.2+26.2" = _REQ5ikHY;
        "pkg-2.7.2+26.1" = _l1inXkNj;
        "pkg-2.7.2+1.21.8" = _S4r6PulH;
        "pkg-2.7.2+1.21.6" = _hpogtjnN;
        "pkg-2.7.2+1.21.4" = _akPHnmFN;
        "pkg-2.7.2+1.21.11" = _c2Vbes5P;
        "pkg-2.7.2+1.21.9" = _Hhso4D4f;
        "pkg-2.7.2+1.21.10" = _6sJ1WFff;
        "pkg-2.7.2+1.21.5" = _AHMv4yIQ;
        "pkg-2.7.2+1.21.3" = _ge1jBfSh;
        "pkg-2.7.2+1.21.1" = _rt3l8LFH;
        "pkg-2.7.2+1.21.2" = _1GE4TyVP;
        "pkg-2.7.2+1.21.7" = _ZJB5XRe9;
        "pkg-2.7.2+1.20.1" = _8pHZPqXE;
        "pkg-2.7.3+1.20.1" = _BlkGJDgB;
        "pkg-2.7.4+26.2" = _PO2XOG8H;
        "pkg-2.7.4+1.21.4" = _sSifxx8o;
        "pkg-2.7.4+26.1" = _nzmJC6CM;
        "pkg-2.7.4+1.21.5" = _wqrsUqML;
        "pkg-2.7.4+1.21.8" = _4bhkdiCr;
        "pkg-2.7.4+1.21.1" = _ZCWiKbVt;
        "pkg-2.7.4+1.21.3" = _jCTKayRZ;
        "pkg-2.7.4+1.21.9" = _vHSsr5sZ;
        "pkg-2.7.4+1.21.10" = _UEKGKne4;
        "pkg-2.7.4+1.21.7" = _zzqTDjOY;
        "pkg-2.7.4+1.21.6" = _mIeiozVy;
        "pkg-2.7.4+1.21.11" = _ujcpaCvu;
        "pkg-2.7.4+1.21.2" = _ec2iUJ1o;
        "pkg-2.7.4+1.20.1" = _zfSDYoYq;
        "pkg-2.7.5+1.20.1" = _ywNSgXdV;
        "pkg-2.7.6+1.20.1" = _kRtSyYUk;
        "pkg-2.7.7+1.21.1" = _AbnP5F0w;
        "pkg-2.7.8+1.21.1" = _vdKAu9DP;
        "pkg-2.7.9+1.21.11" = _T3qcz4pH;
        "pkg-2.7.9+1.21.9" = _SBbxGLoR;
        "pkg-2.7.9+1.21.8" = _AWgLmxvj;
        "pkg-2.7.9+1.21.5" = _oigGEFXg;
        "pkg-2.7.9+1.21.7" = _i8tKMzwn;
        "pkg-2.7.9+1.21.3" = _AOJCsote;
        "pkg-2.7.9+1.21.6" = _A8wT43xy;
        "pkg-2.7.9+1.21.10" = _29bDqgF5;
        "pkg-2.7.9+1.21.1" = _F0FX7qk6;
        "pkg-2.7.9+1.21.2" = _5u2gbuSz;
        "pkg-2.7.9+1.21.4" = _Fq2YExz4;
        "pkg-2.7.9+1.20.1" = _iMXSeUxv;
        "pkg-2.8.0+26.1" = _ZFTvM4jV;
        "pkg-2.8.0+26.2" = _bVnegoq5;
        "pkg-2.8.0+1.21.4" = _PTf1wCxE;
        "pkg-2.8.0+1.21.10" = _RKIGB6OJ;
        "pkg-2.8.0+1.21.5" = _Vz6bgSvR;
        "pkg-2.8.0+1.21.11" = _gPpsakw0;
        "pkg-2.8.0+1.21.6" = _ckllLZQM;
        "pkg-2.8.0+1.21.9" = _2mFtFlEy;
        "pkg-2.8.0+1.21.7" = _7TIM1plX;
        "pkg-2.8.0+1.21.3" = _VrZhBdWB;
        "pkg-2.8.0+1.21.2" = _sTA4uwg6;
