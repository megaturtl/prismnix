...
let
    versions = (let
        ...
        _m9OSjHKb = {
            "id" = "m9OSjHKb";
            "file" = "Reforged-1.20.1-1.1.0-Fabric.jar";
            "hash" = "sha512-V2RiVHYaCeizqIREy/1rPQ18HL7AAKso0gZJ0xjjYqzfkLdqaB2b7Kkc8D6w3BPSvZNSqwnlnsHfPwuD/n60lw==";
        };
        _P4y37EDS = {
            "id" = "P4y37EDS";
            "file" = "Reforged-1.20.1-1.1.0-Forge.jar";
            "hash" = "sha512-Xu7xSfKJLv/azjlRj7XfYEPc/LtJIRl9Qmez/LMEMzxeV/HDmZtSN2VqSFwJfKYzYtDx69BkdNLi63R6oaCocA==";
        };
        _jm7LeisZ = {
            "id" = "jm7LeisZ";
            "file" = "Reforged-1.21.1-1.1.0-Fabric.jar";
            "hash" = "sha512-Y4YHrioHHi1z8OZxI69eyOJp7SCJii+19aXt9+3wg5tq+0vKRSu0g5gekpBJ4IuBcWQ1+hu1zlAEsnZUXm/wGw==";
        };
        _Neo6Vwro = {
            "id" = "Neo6Vwro";
            "file" = "Reforged-1.21.1-1.1.0-Forge.jar";
            "hash" = "sha512-Jqa+drN+OyMjTx7lFn4ZIUmcpvv2mkciBoapt9itguVTVlwXTxZrxh9smJK0Vkk6HAUL+XELAXpVRpIyGhmIpg==";
        };
        _9oYWF1jr = {
            "id" = "9oYWF1jr";
            "file" = "Reforged-1.21.1-1.1.0-NeoForge.jar";
            "hash" = "sha512-vKcblh0jFs+ctzGg2fjvAsWAl5c9b//jX+3K6uyzDF6t/GVQh5zmyDzCFdH5Rf7T6CjikBnf1inxJzy1dQ+I8A==";
        };
        _TDooRMtx = {
            "id" = "TDooRMtx";
            "file" = "Reforged-26.2-1.1.0-Fabric.jar";
            "hash" = "sha512-GjlekFzRX+AfyJ8zbhe8l6SkP4UoJ6phUb5YiEzIPKApgP6IBYKj8bsOVbBUS0QgxGtK8YDO1DXesCk25he38A==";
        };
        _HK7HGBfo = {
            "id" = "HK7HGBfo";
            "file" = "Reforged-26.2-1.1.0-Forge.jar";
            "hash" = "sha512-TjiQL/iySyhCW59v69BlXGmavP3bfYkzv3tW2NcZAWm3weEAwQksZc91CloH6opbvE5pxZPE+ZWd/Act+VYtAw==";
        };
        _nkbxbIwL = {
            "id" = "nkbxbIwL";
            "file" = "Reforged-26.2-1.1.0-NeoForge.jar";
            "hash" = "sha512-L/7YEC3iyM7ciC9M4/ltXBXMLooiqiNINbcvghEAN7M3Hk7ryndC5++rzgxq5wX/fUe8CG2UCal3X5jjf50s4w==";
        };
    in {
        "NfLm3aRj" = _NfLm3aRj;
        "be0W31Wz" = _be0W31Wz;
        ...
        "forge-1.20.1" = _P4y37EDS;
        "forge-1.19" = _8sHKk0Dj;
        "forge-1.19.1" = _8sHKk0Dj;
        "forge-1.20.6" = _pFe8FoPO;
        "forge-1.21" = _Neo6Vwro;
        "forge-1.21.1" = _Neo6Vwro;
        "forge-26.2" = _HK7HGBfo;
        "neoforge-1.20.6" = _U03cWUCu;
        "neoforge-1.21" = _9oYWF1jr;
        "neoforge-1.21.1" = _9oYWF1jr;
        "neoforge-1.20.1" = _P4y37EDS;
        "neoforge-26.2" = _nkbxbIwL;
        "fabric-1.20.6" = _8vSV00pt;
        "fabric-1.21" = _jm7LeisZ;
        "fabric-1.21.1" = _jm7LeisZ;
        "fabric-1.20.1" = _m9OSjHKb;
        "fabric-26.2" = _TDooRMtx;
        "quilt-1.20.6" = _8vSV00pt;
        "quilt-1.21" = _jm7LeisZ;
        "quilt-1.21.1" = _jm7LeisZ;
        "quilt-1.20.1" = _m9OSjHKb;
        "quilt-26.2" = _TDooRMtx;
        "pkg-1.19.3-5.0.0-Forge" = _NfLm3aRj;
        "pkg-1.19.3-5.0.1-Forge" = _be0W31Wz;
        "pkg-1.19.3-5.0.2-Forge" = _ud6CHfSY;
        "pkg-1.19.2-5.0.3-Forge" = _1FMKm0Ox;
        "pkg-1.19.3-5.0.3-Forge" = _vjbhaBVw;
        "pkg-1.19.4-5.0.4-Forge" = _cHzyQD7a;
        "pkg-1.19.3-5.0.4-Forge" = _Zd8G7A3r;
        "pkg-1.19.2-5.0.4-Forge" = _oCEBxYME;
        "pkg-1.19.2-5.0.4.1-Forge" = _KvsEKlCd;
        "pkg-1.19.4-5.1.0-Forge" = _19FMZ3Y3;
        "pkg-1.19.4-5.1.1-Forge" = _8hEIazSh;
        "pkg-1.20.1-6.0.0-Forge" = _NqR3l8RM;
        "pkg-1.20.1-6.0.1-Forge" = _NAZz6gaY;
        "pkg-1.20.1-6.0.2-Forge" = _CbKCoRkO;
        "pkg-1.20.1-6.0.3-Forge" = _NDyVXUw4;
        "pkg-1.20.1-6.0.4-Forge" = _FJaYxB37;
        "pkg-1.20.1-6.0.5-Forge" = _zd5fHqAy;
        "pkg-1.20.6-7.0.0-Forge" = _Bf02cA43;
        "pkg-1.20.6-7.0.1-NeoForge" = _aBRJiVzz;
        "pkg-1.20.6-7.0.2-Forge" = _ihHFVkel;
        "pkg-1.20.6-7.0.2-NeoForge" = _8oWWJ0UL;
        "pkg-1.20.1-6.0.6-Forge" = _4UCDJt3O;
        "pkg-1.20.6-7.0.3-Fabric" = _riu6nEcL;
        "pkg-1.20.6-7.0.3-NeoForge" = _ORrlKOTc;
        "pkg-1.20.6-7.0.3-Forge" = _gZaDrjth;
        "pkg-1.20.6-7.0.4-Forge" = _s8B86Liy;
        "pkg-1.20.6-7.0.4-NeoForge" = _LZ9WRnGP;
        "pkg-1.20.6-7.0.4-Fabric" = _lo2yq04t;
        "pkg-1.20.6-1.0.0-NeoForge" = _Hdr9Nquz;
        "pkg-1.20.6-1.0.0-Forge" = _zmoTzYMx;
        "pkg-1.20.6-1.0.0-Fabric" = _EFy4y50B;
        "pkg-1.21-1.0.0-NeoForge" = _4d8wJGXB;
        "pkg-1.21-1.0.0-Forge" = _gHGVs6Xi;
        "pkg-1.20.6-1.0.1-Forge" = _uw57UnBS;
        "pkg-1.20.6-1.0.1-NeoForge" = _p3CCpwdM;
        "pkg-1.20.6-1.0.1-Fabric" = _jNh2J2u2;
        "pkg-1.21-1.0.1-Fabric" = _jU2FZeFj;
        "pkg-1.21-1.0.1-Forge" = _KpkBtdj6;
        "pkg-1.20.1-6.0.7-Forge" = _8sHKk0Dj;
        "pkg-1.21-1.0.1-NeoForge" = _ZEX9kHI4;
        "pkg-1.20.6-1.0.2-Fabric" = _h1DSDafz;
        "pkg-1.20.6-1.0.2-Forge" = _6TarRZ34;
        "pkg-1.20.6-1.0.2-NeoForge" = _bIl324FB;
        "pkg-1.21-1.0.2-Fabric" = _cZROWTYK;
        "pkg-1.21-1.0.2-Forge" = _9870VYcW;
        "pkg-1.21-1.0.2-NeoForge" = _8ogp1XLq;
        "pkg-1.21.1-1.0.3-Fabric" = _2Fmke1K8;
        "pkg-1.21.1-1.0.3-Forge" = _FhiykApK;
        "pkg-1.21.1-1.0.3-NeoForge" = _uPwAwARz;
        "pkg-1.20.6-1.0.4-Fabric" = _qS0eWqcH;
        "pkg-1.20.6-1.0.4-Forge" = _a0gzvCdu;
        "pkg-1.20.6-1.0.4-NeoForge" = _SptA85xC;
        "pkg-1.21.1-1.0.4-Fabric" = _G55stGss;
        "pkg-1.21.1-1.0.4-Forge" = _IivVNTwq;
        "pkg-1.21.1-1.0.4-NeoForge" = _MKtKPz4d;
        "pkg-1.20.1-6.0.8-Forge" = _RgbnYPcY;
        "pkg-1.20.6-1.0.5-Fabric" = _3LiQHUvH;
        "pkg-1.20.6-1.0.5-Forge" = _vzoLvdF4;
        "pkg-1.20.6-1.0.5-NeoForge" = _eu0Fuynv;
        "pkg-1.21.1-1.0.5-NeoForge" = _LE0NgvTu;
        "pkg-1.21.1-1.0.5-Forge" = _eRQY1KCj;
        "pkg-1.21.1-1.0.5-Fabric" = _ctE65bNI;
        "pkg-1.20.1-1.0.6-Fabric" = _A8LgJy45;
        "pkg-1.20.6-1.0.6-Fabric" = _QzxLrnUy;
        "pkg-1.20.6-1.0.6-Forge" = _fAjXmlaQ;
        "pkg-1.20.6-1.0.6-NeoForge" = _D1nQlOYn;
        "pkg-1.21.1-1.0.6-Fabric" = _ttFbdnhm;
        "pkg-1.21.1-1.0.6-Forge" = _Qnn0Ymju;
        "pkg-1.21.1-1.0.6-NeoForge" = _eL0qCBI1;
        "pkg-1.20.1-1.0.7-Forge" = _81A67H8K;
        "pkg-1.20.6-1.0.7-Fabric" = _4LBNnYiO;
        "pkg-1.20.6-1.0.7-Forge" = _r8VZzaUY;
        "pkg-1.20.6-1.0.7-NeoForge" = _hKIkok8R;
        "pkg-1.21.1-1.0.7-Fabric" = _RhkBIi2l;
        "pkg-1.21.1-1.0.7-Forge" = _55jTY0Eg;
        "pkg-1.21.1-1.0.7-NeoForge" = _oTCi0CiH;
        "pkg-1.20.1-1.0.7-Fabric" = _4H7yJjpF;
        "pkg-1.20.1-1.0.8-Forge" = _NltKNzUE;
        "pkg-1.20.1-1.0.8-Fabric" = _4nioSjCx;
        "pkg-1.20.6-1.0.8-Fabric" = _XL6pjk3T;
        "pkg-1.20.6-1.0.8-Forge" = _bBscvNJp;
        "pkg-1.20.6-1.0.8-NeoForge" = _ehFVt59b;
        "pkg-1.21.1-1.0.8-Fabric" = _y9myZ5am;
        "pkg-1.21.1-1.0.8-Forge" = _GqITssoo;
        "pkg-1.21.1-1.0.8-NeoForge" = _jZumywM7;
        "pkg-1.20.1-1.0.9-Fabric" = _e0uwhygD;
        "pkg-1.20.1-1.0.9-Forge" = _w9Zt1SCW;
        "pkg-1.20.6-1.0.9-Fabric" = _yzjWvfLk;
        "pkg-1.20.6-1.0.9-Forge" = _clglf9o5;
        "pkg-1.20.6-1.0.9-NeoForge" = _eU9ZHGk7;
        "pkg-1.21.1-1.0.9-Fabric" = _rsKoNply;
        "pkg-1.21.1-1.0.9-Forge" = _7B5mZdoH;
        "pkg-1.21.1-1.0.9-NeoForge" = _woWiaquV;
        "pkg-1.20.1-1.0.10-Forge" = _Asr251YH;
        "pkg-1.20.1-1.0.10-Fabric" = _Tgipinyh;
        "pkg-1.20.6-1.0.10-Fabric" = _46fmIXIj;
        "pkg-1.20.6-1.0.10-Forge" = _Avpt9COw;
        "pkg-1.20.6-1.0.10-NeoForge" = _u3CUE5nH;
        "pkg-1.21.1-1.0.10-Fabric" = _NnarPKLH;
        "pkg-1.21.1-1.0.10-Forge" = _sTBHMaz5;
        "pkg-1.21.1-1.0.10-NeoForge" = _8vx86zAy;
        "pkg-1.20.1-1.0.11-Fabric" = _BNF6PFYN;
        "pkg-1.20.1-1.0.11-Forge" = _906LuUc8;
        "pkg-1.20.6-1.0.11-Fabric" = _otTGS0qT;
        "pkg-1.20.6-1.0.11-Forge" = _Pi4RyeIt;
        "pkg-1.20.6-1.0.11-NeoForge" = _Msmq2px4;
        "pkg-1.21.1-1.0.11-Fabric" = _73EL6Yfm;
        "pkg-1.21.1-1.0.11-Forge" = _gCBNWxVB;
        "pkg-1.21.1-1.0.11-NeoForge" = _4i6Fwe4A;
        "pkg-1.20.1-1.0.12-Fabric" = _xob4ADCL;
        "pkg-1.20.1-1.0.12-Forge" = _qx3hGOLO;
        "pkg-1.20.6-1.0.12-Fabric" = _8vSV00pt;
        "pkg-1.20.6-1.0.12-Forge" = _pFe8FoPO;
        "pkg-1.20.6-1.0.12-NeoForge" = _U03cWUCu;
        "pkg-1.21.1-1.0.12-Fabric" = _OL3rX95u;
        "pkg-1.21.1-1.0.12-Forge" = _eJBNRDXF;
        "pkg-1.21.1-1.0.12-NeoForge" = _T6C6wL60;
        "pkg-1.20.1-1.1.0-Fabric" = _m9OSjHKb;
        "pkg-1.20.1-1.1.0-Forge" = _P4y37EDS;
        "pkg-1.21.1-1.1.0-Fabric" = _jm7LeisZ;
        "pkg-1.21.1-1.1.0-Forge" = _Neo6Vwro;
        "pkg-1.21.1-1.1.0-NeoForge" = _9oYWF1jr;
        "pkg-26.2-1.1.0-Fabric" = _TDooRMtx;
        "pkg-26.2-1.1.0-Forge" = _HK7HGBfo;
        "pkg-26.2-1.1.0-NeoForge" = _nkbxbIwL;
        "default" = _nkbxbIwL;
    });
