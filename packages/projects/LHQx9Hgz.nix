...
let
    versions = (let
        ...
        _usaHblNb = {
            "id" = "usaHblNb";
            "file" = "GrowableOres_Extension-1.3.11-26.2-Fabric.jar";
            "hash" = "sha512-9VFw/kuL6NOnC5io1b9mlXYp0JKtiXlBVaJRL8Yeml8hVK9YbSYtL83SgumufHbgKRDxzLf81gT+FE66E5xF2Q==";
        };
        _Njn82zxO = {
            "id" = "Njn82zxO";
            "file" = "GrowableOres_Extension-1.3.11-26.2-Forge.jar";
            "hash" = "sha512-MCt99TFub5MNGa1OlGhSP01GM/MUBrsXoqfG+F1jG6HzN3NnvPOslNvyqQTxkryg7ZWUynzB2mf551IKULqmNQ==";
        };
        _Wo1g8I7U = {
            "id" = "Wo1g8I7U";
            "file" = "GrowableOres_Extension-1.3.11-26.2-NeoForge.jar";
            "hash" = "sha512-fowoXC7vVy6RlHb1oURuMvOa4n4dJ6DWfleeXKaLcN30y4ULLGe2yKcTzOcY2F2CwTYXSrGIm9g5/0XQGH6yZQ==";
        };
        _grrmLcLD = {
            "id" = "grrmLcLD";
            "file" = "GrowableOres_Extension-1.3.11-26.1.1-NeoForge.jar";
            "hash" = "sha512-POPJhb4woGgbPE7X1LpYrCfCh8XoN7myJWKB3Li+vsxk4SnjqD5YfTT/riZhEOTHESkCVNqAXOODYNQTNOiGAA==";
        };
        _TWwM3wMJ = {
            "id" = "TWwM3wMJ";
            "file" = "GrowableOres_Extension-1.3.11-26.1.1-Forge.jar";
            "hash" = "sha512-YYZ0Z8cj/AaAoZ6+inBtmonu5RIdQ9LxWBewRxJ1dbF9kduEx2tuoe+qRwtdj22QC+SchwZFXTrhitDI2PiSbQ==";
        };
        _yplsdRSY = {
            "id" = "yplsdRSY";
            "file" = "GrowableOres_Extension-1.3.11-26.1.1-Fabric.jar";
            "hash" = "sha512-rTxYdrb1Si/8rUi7foSLwEeBQomrv3SVcU1lTEYk3KT50OY2a2jnneJKUCYTV+Ui1RFdYAo+m2dRTSgwaj4kSg==";
        };
        _Fedq4ZOy = {
            "id" = "Fedq4ZOy";
            "file" = "GrowableOres_Extension-1.4.12-1.21.1-Fabric.jar";
            "hash" = "sha512-cPP+EYdsqEh4JYcc7M22JU5gXQr5fTPUemxCueXGOeIeazvhvZnyev58biPfPfz7IGrg0OWdzUGC7fvmbLK0wg==";
        };
        _s9lvdUQk = {
            "id" = "s9lvdUQk";
            "file" = "GrowableOres_Extension-1.4.12-1.21.1-NeoForge.jar";
            "hash" = "sha512-SiPqWTMPRxXyEUryDszlmnW8ciTHSO+a8OvuNzCVsP0QeTEV+GYXkmhM74aEAFhKK7+loDMHEDiQBIDmmWZj6w==";
        };
        _z2GEVn7K = {
            "id" = "z2GEVn7K";
            "file" = "GrowableOres_Extension-1.4.12-1.21.1-Forge.jar";
            "hash" = "sha512-OfWYZNrKY71Y5lw1Zk/A4dgJXaZgjiiaNureKVum080WnPtvTnzHZ9j5+IFbGuy5VNW7C9QwGzfi+IUatn2X4A==";
        };
        _V3X4MNQi = {
            "id" = "V3X4MNQi";
            "file" = "GrowableOres_Extension-1.4.14-1.20.1-Forge.jar";
            "hash" = "sha512-/9dXlzvafbWsYwObGBQ+1D3jUXIzNZpqdxWUeRCTEYi4EKkvejaJklnUJd0szNOoDjGkIy0NghVWbwlQ5lsdfA==";
        };
        _MpDaLIph = {
            "id" = "MpDaLIph";
    ...
    in {
        ...
        "forge-26.1" = _TWwM3wMJ;
        "forge-26.1.1" = _TWwM3wMJ;
        "forge-26.1.2" = _TWwM3wMJ;
        "forge-26.2" = _Njn82zxO;
        "neoforge-1.21" = _JzegyXa8;
        "neoforge-1.21.1" = _s9lvdUQk;
        ...
        "pkg-1.0.0-1.20.4-Fabric" = _lsFv7zFr;
        "pkg-1.0.0-1.20.1-Forge" = _w6IyrDgL;
        "pkg-1.0.0-1.20.1-Fabric" = _hnevKBi6;
        "pkg-1.0.0-1.19.2-Fabric" = _OVOgfO6E;
        "pkg-1.0.0-1.19.2-Forge" = _UXVLFNZ3;
        "pkg-1.0.0-1.21.3-Fabric" = _B2k6jJbp;
        "pkg-1.0.0-1.21.3-Forge" = _H2eS3JzJ;
        "pkg-1.0.0-1.21.3-NeoForge" = _93mmiU0p;
        "pkg-1.1.0-1.19.2-Fabric" = _Cal95U5V;
        "pkg-1.1.0-1.19.2-Forge" = _NxQcAz9X;
        "pkg-1.1.0-1.20.1-Fabric" = _icN7cOEy;
        "pkg-1.1.0-1.20.1-Forge" = _7qqHWPh7;
        "pkg-1.1.0-1.21.3-Fabric" = _1uq8CiYQ;
        "pkg-1.1.0-1.21.3-Forge" = _hXDjlrJm;
        "pkg-1.1.0-1.21.3-NeoForge" = _SN2MYxGL;
        "pkg-1.1.0-1.20.4-Fabric" = _4CQcUHem;
        "pkg-1.1.0-1.20.4-Forge" = _OX8zTybV;
        "pkg-1.1.0-1.21-Fabric" = _IdPF6Tqj;
        "pkg-1.1.0-1.21-Forge" = _NtuUKJae;
        "pkg-1.1.0-1.21-Neoforge" = _SnrQU1T5;
        "pkg-1.1.1-1.19.2-Forge" = _zwcLj1tm;
        "pkg-1.1.1-1.19.2-Fabric" = _tVSihLBF;
        "pkg-1.1.1-1.20.4-Fabric" = _E9H5NAkz;
        "pkg-1.1.1-1.20.4-Forge" = _SaJkp2Jo;
        "pkg-1.1.1-1.21.3-Fabric" = _SNQ1ucgL;
        "pkg-1.1.1-1.21.3-NeoForge" = _ZmNYANqQ;
        "pkg-1.1.1-1.21.3-Forge" = _AO8DIRwa;
        "pkg-1.1.1-1.20.1-Fabric" = _PRTPI7Y7;
        "pkg-1.1.1-1.20.1-Forge" = _c8bb2G6H;
        "pkg-1.1.1-1.21-Neoforge" = _sMMFJpfq;
        "pkg-1.1.1-1.21-Fabric" = _77BSF25H;
        "pkg-1.1.1-1.21-Forge" = _5sIrJPka;
        "pkg-1.1.1-1.21.4-Fabric" = _lSUVD6zt;
        "pkg-1.1.1-1.21.4-Forge" = _8t3ErijJ;
        "pkg-1.1.1-1.21.4-NeoForge" = _2ygAoAUC;
        "pkg-1.2.0-1.20.1-Fabric" = _TE3NKFeo;
        "pkg-1.2.0-1.20.1-Forge" = _Vcc6S0T3;
        "pkg-1.2.0-1.21.1-Fabric" = _NAEcLRtY;
        "pkg-1.2.0-1.21.1-Neoforge" = _MHDzE4Ks;
        "pkg-1.2.0-1.21.1-Forge" = _yNr1jgPs;
        "pkg-1.1.2-1.20.4-Fabric" = _hyMBZ5HZ;
        "pkg-1.1.2-1.20.4-Forge" = _h7BNmv3T;
        "pkg-1.1.2-1.21.4-Fabric" = _PiG771aj;
        "pkg-1.1.2-1.21.4-NeoForge" = _zEDVVlGP;
        "pkg-1.1.2-1.21.4-Forge" = _epxzv7BI;
        "pkg-1.1.2-1.21.3-Fabric" = _pFsseSlq;
        "pkg-1.1.2-1.21.3-NeoForge" = _EkUx6UDS;
        "pkg-1.1.2-1.21.3-Forge" = _NnCwZqZq;
        "pkg-1.2.0-1.18.2-Fabric" = _z9gszjN2;
        "pkg-1.2.0-1.18.2-Forge" = _mbWTAcu6;
        "pkg-1.2.0-1.19.2-Fabric" = _tfyJuzH6;
        "pkg-1.2.0-1.19.2-Forge" = _dbSGsCno;
        "pkg-1.2.1-1.19.2-Forge" = _RKvCwuYd;
        "pkg-1.2.1-1.18.2-Forge" = _BH2kMg0V;
        "pkg-1.2.1-1.20.1-Forge" = _6v9ZyxfO;
        "pkg-1.2.0-1.16.5-Forge" = _Gcy9EJGQ;
        "pkg-1.2.0-1.16.5-Fabric" = _QgdcuwM3;
        "pkg-1.3.0-1.21.1-NeoForge" = _WOIKYFwz;
        "pkg-1.3.0-1.21.4-NeoForge" = _fMZQ9aUn;
        "pkg-1.3.0-1.16.5-Forge" = _bCb4OlaN;
        "pkg-1.3.0-1.18.2-Forge" = _yMAGcmRW;
        "pkg-1.3.0-1.20.1-Forge" = _zH8usZt2;
        "pkg-1.3.0-1.19.2-Forge" = _aUCBXEr4;
        "pkg-1.3.1-1.21.4-Forge" = _PqSjNsrq;
        "pkg-1.4.1-1.19.2-Forge" = _OBJlkkyf;
        "pkg-1.4.1-1.20.1-Forge" = _i9pO1gKV;
        "pkg-1.4.1-1.21.1-NeoForge" = _h8w2Khpk;
        "pkg-1.4.1-1.21.1-Forge" = _DyyhdeMV;
        "pkg-1.4.1-1.18.2-Forge" = _RzZuuYOs;
        "pkg-1.4.0-1.21.1-Fabric" = _fsEnGyPC;
        "pkg-1.4.0-1.19.2-Fabric" = _MljX9mwD;
        "pkg-1.4.0-1.18.2-Fabric" = _cnncqQ65;
        "pkg-1.4.0-1.20.1-Fabric" = _ouV7ctUK;
        "pkg-1.4.2-1.21.1-Fabric" = _kGWLGfkM;
        "pkg-1.4.2-1.21.1-Forge" = _8OlPdWt2;
        "pkg-1.4.2-1.21.1-NeoForge" = _I91VYkj0;
        "pkg-1.4.2-1.19.2-Fabric" = _tAXxZfPo;
        "pkg-1.4.2-1.19.2-Forge" = _gopq80ht;
        "pkg-1.2.1-1.16.5-Fabric" = _Qhvyv5pt;
        "pkg-1.3.1-1.16.5-Forge" = _T9cjCbKX;
        "pkg-1.4.2-1.18.2-Fabric" = _JsqQmnjK;
        "pkg-1.4.2-1.18.2-Forge" = _C8jJqISq;
        "pkg-1.4.2-1.20.1-Fabric" = _yizenjq5;
        "pkg-1.4.3-1.19.2-Forge" = _gJcsJSgh;
        "pkg-1.4.3-1.19.2-Fabric" = _3jSkEr9P;
        "pkg-1.4.3-1.21.1-Fabric" = _ggzLRsNR;
        "pkg-1.4.3-1.21.1-NeoForge" = _MnQ2Siqr;
        "pkg-1.4.3-1.21.1-Forge" = _eBQWK8CP;
        "pkg-1.4.3-1.20.1-Forge" = _Fv77EjNl;
        "pkg-1.4.3-1.20.1-Fabric" = _sNJasNiY;
        "pkg-1.4.4-1.21.1-NeoForge" = _EgMsfz2c;
        "pkg-1.4.4-1.20.1-Forge" = _9Jxcz23a;
        "pkg-1.4.4-1.19.2-Forge" = _yVG2QzB7;
        "pkg-1.4.5-1.20.1-Forge" = _Kud0DkrJ;
        "pkg-1.4.5-1.20.1-Fabric" = _vULRITy0;
        "pkg-1.4.5-1.21.1-NeoForge" = _JzegyXa8;
        "pkg-1.4.5-1.21.1-Forge" = _zi4Z18Nl;
        "pkg-1.4.5-1.21.1-Fabric" = _HYeBl6po;
        "pkg-1.3.2-1.21.4-NeoForge" = _RLQGbd4N;
        "pkg-1.3.2-1.21.4-Forge" = _YX4mme1r;
        "pkg-1.3.2-1.21.4-Fabric" = _DUnfpjk7;
        "pkg-1.3.2-1.21.5-Fabric" = _N4hj12yQ;
        "pkg-1.3.2-1.21.5-NeoForge" = _AqCP7gPl;
        "pkg-1.3.2-1.21.5-Forge" = _CD18W9Pn;
        "pkg-1.3.2-1.21.6-Fabric" = _Rbz1tXql;
        "pkg-1.3.2-1.21.6-Forge" = _6R8wG7d5;
        "pkg-1.3.2-1.21.6-NeoForge" = _xLoawXBO;
        "pkg-1.4.3-1.18.2-Forge" = _lIynvbTQ;
        "pkg-1.4.3-1.18.2-Fabric" = _IPWa6wJG;
        "pkg-1.4.5-1.19.2-Forge" = _lP6y2Hze;
        "pkg-1.4.5-1.19.2-Fabric" = _SjRUq7sA;
        "pkg-1.4.6-1.21.1-Forge" = _U73sg5ZF;
        "pkg-1.4.6-1.20.1-Forge" = _qwCupnRb;
        "pkg-1.4.6-1.20.1-Fabric" = _T65u4y3b;
        "pkg-1.4.6-1.21.1-NeoForge" = _KRhZV829;
        "pkg-1.4.6-1.21.1-Fabric" = _bkQRtS1K;
        "pkg-1.3.3-1.21.5-Fabric" = _fjb7yLFd;
        "pkg-1.3.3-1.21.5-NeoForge" = _wuzOxIR9;
        "pkg-1.3.3-1.21.5-Forge" = _9NwVCi1n;
        "pkg-1.3.3-1.21.4-Forge" = _yDSL7Q7U;
        "pkg-1.3.3-1.21.4-NeoForge" = _ax7KASxs;
        "pkg-1.3.3-1.21.4-Fabric" = _84pivOEs;
        "pkg-1.3.3-1.21.7-Forge" = _WJLplhoA;
        "pkg-1.3.3-1.21.7-NeoForge" = _qJAR3Rod;
        "pkg-1.3.3-1.21.7-Fabric" = _OKFRZb5k;
        "pkg-1.4.7-1.20.1-Forge" = _Z3Cw0zoT;
        "pkg-1.4.7-1.20.1-Fabric" = _BVrxl3Hd;
        "pkg-1.4.4-1.18.2-Forge" = _gCHmWag0;
        "pkg-1.4.4-1.18.2-Fabric" = _etWS6nY2;
        "pkg-1.4.6-1.19.2-Forge" = _lBhAY6OD;
        "pkg-1.4.6-1.19.2-Fabric" = _ZX4GVJyN;
        "pkg-1.4.5-1.18.2-Forge" = _mujYH3Z5;
        "pkg-1.4.5-1.18.2-Fabric" = _mBoPc1pW;
        "pkg-1.4.7-1.19.2-Forge" = _bRq97mfB;
        "pkg-1.4.7-1.19.2-Fabric" = _DVe44KfB;
        "pkg-1.4.8-1.20.1-Forge" = _CACpDN16;
        "pkg-1.4.8-1.20.1-Fabric" = _Af9a36LH;
        "pkg-1.4.7-1.21.1-NeoForge" = _AyqEaDs5;
        "pkg-1.4.7-1.21.1-Forge" = _1P5MPHDs;
        "pkg-1.4.7-1.21.1-Fabric" = _YMrzsG5u;
        "pkg-1.3.4-1.21.4-NeoForge" = _K131tIxP;
        "pkg-1.3.4-1.21.4-Forge" = _zZkNzBwD;
        "pkg-1.3.4-1.21.4-Fabric" = _eEjRipiY;
        "pkg-1.3.4-1.21.5-Fabric" = _9WTgXxhV;
        "pkg-1.3.4-1.21.5-NeoForge" = _u53FZg2R;
        "pkg-1.3.4-1.21.5-Forge" = _ChP3n0Wu;
        "pkg-1.3.4-1.21.7-Fabric" = _2JrEJPy6;
        "pkg-1.3.4-1.21.7-NeoForge" = _iOHxE1bJ;
        "pkg-1.3.4-1.21.7-Forge" = _3n4G4N0f;
        "pkg-1.3.5-1.21.7-Forge" = _FD67zDGr;
        "pkg-1.3.5-1.21.7-NeoForge" = _fOiRbAmp;
        "pkg-1.3.5-1.21.7-Fabric" = _2ZcmboN4;
        "pkg-1.3.5-1.21.5-Forge" = _w7wUN6oI;
        "pkg-1.3.5-1.21.5-NeoForge" = _Gyu8oWZd;
        "pkg-1.3.5-1.21.5-Fabric" = _zZaZTV9J;
        "pkg-1.3.5-1.21.4-Forge" = _GFz9iMUU;
        "pkg-1.3.5-1.21.4-Fabric" = _2VuPH6fa;
        "pkg-1.3.5-1.21.4-NeoForge" = _acyHywsx;
        "pkg-1.4.8-1.21.1-Fabric" = _mda45XSk;
        "pkg-1.4.8-1.21.1-Forge" = _LoJ9SlOO;
        "pkg-1.4.8-1.21.1-NeoForge" = _DX4NJdEp;
        "pkg-1.4.9-1.20.1-Fabric" = _XWjHfllq;
        "pkg-1.4.9-1.20.1-Forge" = _aQSGGRMl;
        "pkg-1.4.8-1.19.2-Forge" = _jrg89GEC;
        "pkg-1.4.8-1.19.2-Fabric" = _6z1COuHH;
        "pkg-1.4.6-1.18.2-Fabric" = _Edp04x8G;
        "pkg-1.4.6-1.18.2-Forge" = _h0Pbw0Fl;
        "pkg-1.3.6-1.21.7-Forge" = _6SpEAYVE;
        "pkg-1.3.6-1.21.7-NeoForge" = _j1Ch3Dzk;
        "pkg-1.4.9-1.21.1-Forge" = _V39G4w0u;
        "pkg-1.3.6-1.21.7-Fabric" = _yGNHmbb8;
        "pkg-1.4.9-1.21.1-Fabric" = _Zm63WDbR;
        "pkg-1.4.9-1.21.1-NeoForge" = _36X1DWrS;
        "pkg-1.3.6-1.21.5-Forge" = _UIN8zlss;
        "pkg-1.3.6-1.21.5-Fabric" = _fpdLyVfb;
        "pkg-1.3.6-1.21.4-Forge" = _dliGyQni;
        "pkg-1.3.6-1.21.4-NeoForge" = _9vbRZv3d;
        "pkg-1.3.6-1.21.4-Fabric" = _MQWnHVWb;
        "pkg-1.4.10-1.20.1-Forge" = _Al33YKu8;
        "pkg-1.4.10-1.20.1-Fabric" = _ypvtYlAY;
        "pkg-1.4.9-1.19.2-Fabric" = _8XzZAuts;
        "pkg-1.4.9-1.19.2-Forge" = _2Je3yBYN;
        "pkg-1.4.7-1.18.2-Fabric" = _WCDKZ6YS;
        "pkg-1.4.7-1.18.2-Forge" = _OOsdXeOM;
        "pkg-1.3.6-1.21.5-NeoForge" = _tJxU2EDa;
        "pkg-1.3.7-1.21.7-Forge" = _7arC3hfG;
        "pkg-1.3.7-1.21.7-NeoForge" = _z80svdez;
        "pkg-1.3.7-1.21.7-Fabric" = _dT1XqUFu;
        "pkg-1.3.7-1.21.5-Forge" = _TWoklBBf;
        "pkg-1.3.7-1.21.5-NeoForge" = _z5W9hjAE;
        "pkg-1.3.7-1.21.5-Fabric" = _tzllkR4s;
        "pkg-1.3.7-1.21.4-Forge" = _3C0ZMQfk;
        "pkg-1.3.7-1.21.4-NeoForge" = _NcbVkQ0B;
        "pkg-1.3.7-1.21.4-Fabric" = _dgpiHcR8;
        "pkg-1.4.11-1.20.1-Fabric" = _UJHs2bJf;
        "pkg-1.4.11-1.20.1-Forge" = _vf7Xnaid;
        "pkg-1.4.10-1.19.2-Fabric" = _6rJpFnm0;
        "pkg-1.4.10-1.19.2-Forge" = _bq4yJKsL;
        "pkg-1.4.8-1.18.2-Fabric" = _geoy64jc;
        "pkg-1.4.8-1.18.2-Forge" = _1NY8iKbm;
        "pkg-1.3.7-1.21.9-Fabric" = _fia50GvI;
        "pkg-1.3.7-1.21.9-Forge" = _Hx20qCFe;
        "pkg-1.3.7-1.21.9-NeoForge" = _z3mMVhRH;
        "pkg-1.3.7-1.21.10-Fabric" = _Ssvbp5zq;
        "pkg-1.3.7-1.21.10-Forge" = _O3KpQcpM;
        "pkg-1.3.7-1.21.10-NeoForge" = _Nr13Fh0u;
        "pkg-1.3.8-1.21.10-Forge" = _6i15sbAT;
        "pkg-1.3.8-1.21.10-NeoForge" = _2fLjdvqr;
        "pkg-1.3.8-1.21.10-Fabric" = _vEXWrdk7;
        "pkg-1.3.8-1.21.7-Forge" = _mg0h1LZU;
        "pkg-1.3.8-1.21.7-NeoForge" = _bZ2jSGKv;
        "pkg-1.3.8-1.21.7-Fabric" = _nBGuj7lJ;
        "pkg-1.4.10-1.21.1-Fabric" = _V9qVPp2z;
        "pkg-1.4.10-1.21.1-Forge" = _G4SopZQu;
        "pkg-1.4.10-1.21.1-NeoForge" = _fEF4O6dA;
        "pkg-1.4.12-1.20.1-Forge" = _LdXQbwA1;
        "pkg-1.4.12-1.20.1-Fabric" = _mjJr0I4B;
        "pkg-1.4.11-1.19.2-Fabric" = _RBeBcyXI;
        "pkg-1.4.11-1.19.2-Forge" = _Ct31Sm6l;
        "pkg-1.4.9-1.18.2-Forge" = _4irMCZCC;
        "pkg-1.4.9-1.18.2-Fabric" = _ho88CY47;
        "pkg-1.3.8-1.21.11-Fabric" = _5IJkiE15;
        "pkg-1.3.8-1.21.11-Forge" = _fVd5hERh;
        "pkg-1.3.8-1.21.11-NeoForge" = _YdgkoAa2;
        "pkg-1.3.8-26.1-Fabric" = _ZZP4CCPO;
        "pkg-1.3.8-26.1-Forge" = _7hIQehKx;
        "pkg-1.3.8-26.1-NeoForge" = _QD1Lu9dR;
        "pkg-1.4.13-1.20.1-Forge" = _7fWDdQVY;
        "pkg-1.4.13-1.20.1-Fabric" = _AeyCig7g;
        "pkg-1.4.11-1.21.1-NeoForge" = _mcunOmB9;
        "pkg-1.4.11-1.21.1-Forge" = _JtXcb8HD;
        "pkg-1.4.11-1.21.1-Fabric" = _WM1n4NCX;
        "pkg-1.3.9-1.21.10-Fabric" = _h6x5AFrC;
        "pkg-1.3.9-1.21.10-NeoForge" = _hCK7XTiR;
        "pkg-1.3.9-1.21.10-Forge" = _OvFCAOFq;
        "pkg-1.3.9-1.21.11-NeoForge" = _GbTsRdtx;
        "pkg-1.3.9-1.21.11-Forge" = _zVsPwriM;
        "pkg-1.3.9-1.21.11-Fabric" = _zOCS5Bk8;
        "pkg-1.3.10-26.1.1-Fabric" = _1TPlpHGe;
        "pkg-1.3.10-26.1.1-NeoForge" = _KVAI7JhQ;
        "pkg-1.3.10-26.1.1-Forge" = _LTAXFlLb;
        "pkg-1.3.9-1.21.7-Fabric" = _R0T2d783;
        "pkg-1.3.9-1.21.7-NeoForge" = _qkBRrD37;
        "pkg-1.3.9-1.21.7-Forge" = _aG6j4998;
        "pkg-1.3.10-26.2-NeoForge" = _CEGeWeZI;
        "pkg-1.3.10-26.2-Fabric" = _7M9bXtS9;
        "pkg-1.3.10-26.2-Forge" = _CHcinRfz;
        "pkg-1.3.11-26.2-Fabric" = _usaHblNb;
        "pkg-1.3.11-26.2-Forge" = _Njn82zxO;
        "pkg-1.3.11-26.2-NeoForge" = _Wo1g8I7U;
        "pkg-1.3.11-26.1.1-NeoForge" = _grrmLcLD;
        "pkg-1.3.11-26.1.1-Forge" = _TWwM3wMJ;
        "pkg-1.3.11-26.1.1-Fabric" = _yplsdRSY;
        "pkg-1.4.12-1.21.1-Fabric" = _Fedq4ZOy;
        "pkg-1.4.12-1.21.1-NeoForge" = _s9lvdUQk;
