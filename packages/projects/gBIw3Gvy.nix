...
let
    ...
    in {
        ...
        "pkg-3.6.1" = _c0fK6v1O;
        "pkg-3.7.0" = _ZaADOQkd;
        "pkg-3.8.0-pre1" = _IcUk2XCU;
        "pkg-3.7.1" = _zhwiadBU;
        "pkg-3.8.0-pre2" = _SlryjGLq;
        "pkg-3.7.2" = _wKfiroHO;
        "pkg-3.8.0-pre3" = _XlGwNaiM;
        "pkg-3.7.3" = _fBKsU3QD;
        "pkg-3.8.0-pre4" = _NDwKMhzI;
        "pkg-3.7.4" = _4STs1pmp;
        "pkg-3.8.0-pre5" = _q6OJom8c;
        "pkg-3.7.5" = _jDUoU6ud;
        "pkg-3.8.0-pre6" = _AFGRPTug;
        "pkg-3.7.6" = _AD7gp66V;
        "pkg-3.8.0-pre7" = _cCjQWaZh;
        "pkg-3.8.0" = _h4pFXy6k;
        "pkg-3.9.0-pre1" = _a7IAeJyR;
        "pkg-3.8.1" = _oKwOWdJ0;
        "pkg-3.9.0-pre2" = _KZevmkQq;
        "pkg-3.8.1-mc1.21.4" = _Nb5VU6aH;
        "pkg-3.9.0" = _59jipeWW;
        "pkg-3.10.0" = _75QcoSo9;
        "pkg-3.10.0-mc1.21.8" = _Y1BBlgsW;
        "pkg-3.10.0-mc1.21.4" = _h1MtANf0;
        "pkg-3.10.1-mc1.21.4" = _Zn46mCNU;
        "pkg-3.10.1" = _Rzw3CXxA;
        "pkg-3.10.1-mc1.21.8" = _uV8isBfg;
        "pkg-3.10.2" = _lewREhtX;
        "pkg-3.10.2-mc1.21.8" = _33L7mwoC;
        "pkg-3.10.2-mc1.21.4" = _tD0dqUw2;
        "pkg-3.10.3" = _QO3oQCJF;
        "pkg-3.10.3-mc1.21.8" = _5rM3nkaK;
        "pkg-3.10.3-mc1.21.4" = _CmCLGFat;
        "pkg-3.10.3-mc1.21.11" = _IXsLP9tu;
        "pkg-3.10.4" = _eAGbIyNo;
        "pkg-3.10.4-mc1.21.11" = _oM0xwKt6;
        "pkg-3.10.4-mc1.21.8" = _YFwLeAXK;
        "pkg-3.10.4-mc1.21.4" = _9HiwYnw1;
        "pkg-3.10.5" = _tUYnBiVb;
        "pkg-3.10.5-mc1.21.10" = _6ewo4Elk;
        "pkg-3.10.5-mc1.21.8" = _iI20kYNa;
        "pkg-3.10.5-mc1.21.4" = _ghfukBHp;
        "pkg-3.11.0" = _ZIqG4Rb0;
        "pkg-3.11.0-mc1.21.10" = _SGKcc3rS;
        "pkg-3.11.0-mc1.21.8" = _DvAyAicq;
        "pkg-3.11.0-mc1.21.4" = _OO7lWAVU;
        "pkg-3.11.1-mc1.21.4" = _feAHiTAn;
        "pkg-3.11.1-mc1.21.8" = _liYdnEnq;
        "pkg-3.11.1" = _Q5YDi1Pg;
        "pkg-3.11.1-mc1.21.10" = _CE9lHNwR;
        "pkg-3.12.0-mc1.21.4" = _euovnOZX;
        "pkg-3.12.0-mc1.21.8" = _xjy0GNvC;
        "pkg-3.12.0" = _Gqxs4cAN;
        "pkg-3.12.0-mc1.21.10" = _gqkRCMAU;
        "pkg-3.12.1-mc1.21.4" = _oPCN9N2r;
        "pkg-3.12.1-mc1.21.8" = _1yGDyVKX;
        "pkg-3.12.1-mc1.21.10" = _KMmp2rJz;
        "pkg-3.12.1" = _HMLN1DUq;
        "pkg-3.12.2-mc1.21.4" = _2qIsmPrP;
        "pkg-3.12.2-mc1.21.8" = _KyB0dI4T;
        "pkg-3.12.2" = _1qewrGa8;
        "pkg-3.12.2-mc1.21.10" = _HZ4C4K0s;
        "pkg-3.12.3" = _RyT7A8QR;
        "pkg-3.12.3-mc1.21.8" = _BZy7HCaW;
        "pkg-3.12.3-mc1.21.4" = _aj5NO3OQ;
        "pkg-3.12.3-mc1.21.10" = _SIrB8OKd;
        "pkg-3.12.4" = _QozUj18T;
        "pkg-3.12.4-mc1.21.10" = _csPZSUQC;
        "pkg-4.0.0-pre1" = _99pJBAt5;
        "pkg-4.0.0" = _p3RAUk2B;
        "pkg-4.1.0" = _5M32eHgD;
        "pkg-4.1.1" = _xQUx6Tk9;
        "pkg-4.1.2" = _q0hN5wla;
