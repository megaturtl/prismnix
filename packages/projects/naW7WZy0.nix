...
let
    ...
    in {
        ...
        "pkg-1.0.6" = _aYAeZBcP;
        "pkg-1.0.6-fix" = _vp2EbqAp;
        "pkg-1.0.7-alpha" = _T1XfzgGp;
        "pkg-1.0.7-beta" = _LiKCzYUI;
        "pkg-1.0.7-beta-fix" = _X9SCnh1X;
        "pkg-1.0.7" = _uUp3mpt0;
        "pkg-1.0.8-beta" = _qRt3ZYbg;
        "pkg-1.0.8" = _w22Gsbai;
        "pkg-1.0.9-beta" = _Bi7OC56A;
        "pkg-1.0.9-beta-fix" = _ebbZTENb;
        "pkg-1.0.9Beta" = _F4ZxvMMm;
        "pkg-1.0.9" = _Gxlmj6Lp;
        "pkg-1.0.9-fix" = _bY4ptfkc;
        "pkg-1.1.0-alpha" = _x2DFgrEG;
        "pkg-1.1.0-beta" = _yalNyqma;
        "pkg-1.1.0-beta-fix" = _epcQ3AJQ;
        "pkg-1.1.0" = _BQaf3svm;
