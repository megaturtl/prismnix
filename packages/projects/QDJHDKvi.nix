...
let
    versions = (let
        ...
        _BKwfLQnA = {
            "id" = "BKwfLQnA";
            "file" = "AxPlayerWarps-1.16.2.jar";
            "hash" = "sha512-DGccufRZHfT8lBPM2faSPNf2lyjZM5SMTE1VHWYdVwxqWWOCiPxME4NruRgcGbU2HeMldfwEDWHj1xApZhrCEg==";
        };
        _blfe3yaK = {
            "id" = "blfe3yaK";
            "file" = "AxPlayerWarps-1.17.0.jar";
            "hash" = "sha512-0JjU8shQg43vxqi9qoH90+7VwFzfhl8kU4DkX4Wv4ttRUDWEbHpZk3VTFTT1bSanUAmRs5jVTOzLhTfrfbGZXw==";
        };
        _b4GRMOpT = {
            "id" = "b4GRMOpT";
            "file" = "AxPlayerWarps-1.17.1.jar";
            "hash" = "sha512-hd4GCjMqNRdZ2MHcqvuEHumG2my/wOt4buCLAQ3koViwMqQiLveTljmPMIcNHT0asWo8oO/fmNt3eTHUgkHNfw==";
        };
        _1ttFPrYt = {
            "id" = "1ttFPrYt";
            "file" = "AxPlayerWarps-1.17.2.jar";
            "hash" = "sha512-RkTd3zFyDxQmNeUG3EZVLfypZU9LfO9szbfuet5dB3SxCw4tNV1olOwV7DQaO0mukpQWyJWZq2ZSII7QeOOGDQ==";
        };
        _dM5vn1FC = {
            "id" = "dM5vn1FC";
            "file" = "AxPlayerWarps-1.17.3.jar";
            "hash" = "sha512-kwbkm8rh90JKrnbqE/+5XtjB5tac12+loPMELy/+gl0zq1ArMkbWJtZvPTSmFgDdGt2QyPT1uHeXPbspg5xiNQ==";
        };
    in {
        "WhtwdDDo" = _WhtwdDDo;
        "88Pd5xnc" = _88Pd5xnc;
        ...
        "bukkit-1.20.2" = _dM5vn1FC;
        "bukkit-1.20.3" = _dM5vn1FC;
        "bukkit-1.20.4" = _dM5vn1FC;
        "bukkit-1.20.5" = _dM5vn1FC;
        "bukkit-1.20.6" = _dM5vn1FC;
        "bukkit-1.21" = _dM5vn1FC;
        "bukkit-1.21.1" = _dM5vn1FC;
        "bukkit-1.21.2" = _dM5vn1FC;
        "bukkit-1.21.3" = _dM5vn1FC;
        "bukkit-1.21.4" = _dM5vn1FC;
        "bukkit-1.21.5" = _dM5vn1FC;
        "bukkit-1.21.6" = _dM5vn1FC;
        "bukkit-1.21.7" = _dM5vn1FC;
        "bukkit-1.21.8" = _dM5vn1FC;
        "bukkit-1.21.9" = _dM5vn1FC;
        "bukkit-1.21.10" = _dM5vn1FC;
        "bukkit-1.21.11" = _dM5vn1FC;
        "bukkit-26.1" = _dM5vn1FC;
        "bukkit-26.1.1" = _dM5vn1FC;
        "bukkit-26.1.2" = _dM5vn1FC;
        "bukkit-26.2" = _dM5vn1FC;
        ...
        "folia-1.20.2" = _dM5vn1FC;
        "folia-1.20.3" = _dM5vn1FC;
        "folia-1.20.4" = _dM5vn1FC;
        "folia-1.20.5" = _dM5vn1FC;
        "folia-1.20.6" = _dM5vn1FC;
        "folia-1.21" = _dM5vn1FC;
        "folia-1.21.1" = _dM5vn1FC;
        "folia-1.21.2" = _dM5vn1FC;
        "folia-1.21.3" = _dM5vn1FC;
        "folia-1.21.4" = _dM5vn1FC;
        "folia-1.21.5" = _dM5vn1FC;
        "folia-1.21.6" = _dM5vn1FC;
        "folia-1.21.7" = _dM5vn1FC;
        "folia-1.21.8" = _dM5vn1FC;
        "folia-1.21.9" = _dM5vn1FC;
        "folia-1.21.10" = _dM5vn1FC;
        "folia-1.21.11" = _dM5vn1FC;
        "folia-26.1" = _dM5vn1FC;
        "folia-26.1.1" = _dM5vn1FC;
        "folia-26.1.2" = _dM5vn1FC;
        "folia-26.2" = _dM5vn1FC;
        ...
        "paper-1.20.2" = _dM5vn1FC;
        "paper-1.20.3" = _dM5vn1FC;
        "paper-1.20.4" = _dM5vn1FC;
        "paper-1.20.5" = _dM5vn1FC;
        "paper-1.20.6" = _dM5vn1FC;
        "paper-1.21" = _dM5vn1FC;
        "paper-1.21.1" = _dM5vn1FC;
        "paper-1.21.2" = _dM5vn1FC;
        "paper-1.21.3" = _dM5vn1FC;
        "paper-1.21.4" = _dM5vn1FC;
        "paper-1.21.5" = _dM5vn1FC;
        "paper-1.21.6" = _dM5vn1FC;
        "paper-1.21.7" = _dM5vn1FC;
        "paper-1.21.8" = _dM5vn1FC;
        "paper-1.21.9" = _dM5vn1FC;
        "paper-1.21.10" = _dM5vn1FC;
        "paper-1.21.11" = _dM5vn1FC;
        "paper-26.1" = _dM5vn1FC;
        "paper-26.1.1" = _dM5vn1FC;
        "paper-26.1.2" = _dM5vn1FC;
        "paper-26.2" = _dM5vn1FC;
        ...
        "purpur-1.20.2" = _dM5vn1FC;
        "purpur-1.20.3" = _dM5vn1FC;
        "purpur-1.20.4" = _dM5vn1FC;
        "purpur-1.20.5" = _dM5vn1FC;
        "purpur-1.20.6" = _dM5vn1FC;
        "purpur-1.21" = _dM5vn1FC;
        "purpur-1.21.1" = _dM5vn1FC;
        "purpur-1.21.2" = _dM5vn1FC;
        "purpur-1.21.3" = _dM5vn1FC;
        "purpur-1.21.4" = _dM5vn1FC;
        "purpur-1.21.5" = _dM5vn1FC;
        "purpur-1.21.6" = _dM5vn1FC;
        "purpur-1.21.7" = _dM5vn1FC;
        "purpur-1.21.8" = _dM5vn1FC;
        "purpur-1.21.9" = _dM5vn1FC;
        "purpur-1.21.10" = _dM5vn1FC;
        "purpur-1.21.11" = _dM5vn1FC;
        "purpur-26.1" = _dM5vn1FC;
        "purpur-26.1.1" = _dM5vn1FC;
        "purpur-26.1.2" = _dM5vn1FC;
        "purpur-26.2" = _dM5vn1FC;
        ...
        "spigot-1.20.2" = _dM5vn1FC;
        "spigot-1.20.3" = _dM5vn1FC;
        "spigot-1.20.4" = _dM5vn1FC;
        "spigot-1.20.5" = _dM5vn1FC;
        "spigot-1.20.6" = _dM5vn1FC;
        "spigot-1.21" = _dM5vn1FC;
        "spigot-1.21.1" = _dM5vn1FC;
        "spigot-1.21.2" = _dM5vn1FC;
        "spigot-1.21.3" = _dM5vn1FC;
        "spigot-1.21.4" = _dM5vn1FC;
        "spigot-1.21.5" = _dM5vn1FC;
        "spigot-1.21.6" = _dM5vn1FC;
        "spigot-1.21.7" = _dM5vn1FC;
        "spigot-1.21.8" = _dM5vn1FC;
        "spigot-1.21.9" = _dM5vn1FC;
        "spigot-1.21.10" = _dM5vn1FC;
        "spigot-1.21.11" = _dM5vn1FC;
        "spigot-26.1" = _dM5vn1FC;
        "spigot-26.1.1" = _dM5vn1FC;
        "spigot-26.1.2" = _dM5vn1FC;
        "spigot-26.2" = _dM5vn1FC;
        "pkg-1.0.0" = _WhtwdDDo;
        "pkg-1.0.1" = _88Pd5xnc;
        "pkg-1.0.2" = _wQdd4pdX;
        "pkg-1.1.0" = _QLrgqjIW;
        ...
        "pkg-1.9.2" = _4MEd2CQL;
        "pkg-1.9.3" = _ckkPQIVF;
        "pkg-1.10.0" = _MF78cuZd;
        "pkg-1.10.1" = _rNKKDdTA;
        "pkg-1.10.2" = _KgxQ3pcj;
        "pkg-1.10.3" = _HpbUVxKX;
        "pkg-1.10.4" = _gbnlHHO7;
        "pkg-1.11.0" = _vYruG5yH;
        "pkg-1.11.1" = _mB9Pc4Vt;
        "pkg-1.11.2" = _qBzRtIT3;
        "pkg-1.12.0" = _MU0AvD0T;
        "pkg-1.12.1" = _6zmWOQXa;
        "pkg-1.12.2" = _demI3ojz;
        "pkg-1.12.3" = _OFtB80gc;
        "pkg-1.12.4" = _Zldsy9JV;
        "pkg-1.12.5" = _SQES4gIb;
        "pkg-1.13.0" = _55ITh80Y;
        "pkg-1.14.0" = _IkgMmz4D;
        "pkg-1.14.1" = _cdqL8eTz;
        "pkg-1.14.2" = _uuVbq684;
        "pkg-1.14.3" = _AntMFW9R;
        "pkg-1.15.0" = _FLSiedrb;
        "pkg-1.15.1" = _Pk5enZaj;
        "pkg-1.16.0" = _ZyuB9PZ2;
        "pkg-1.16.1" = _aM0sz1xl;
        "pkg-1.16.2" = _BKwfLQnA;
        "pkg-1.17.0" = _blfe3yaK;
        "pkg-1.17.1" = _b4GRMOpT;
        "pkg-1.17.2" = _1ttFPrYt;
        "pkg-1.17.3" = _dM5vn1FC;
        "default" = _dM5vn1FC;
    });
