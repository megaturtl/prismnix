...
let
    versions = (let
        ...
        _qvhtxmU6 = {
            "id" = "qvhtxmU6";
            "file" = "supplementaries-1.21.1-3.8.8-neoforge.jar";
            "hash" = "sha512-FgJQehSF6YlJDT5wLP3u/5nafQXwikNfMScPg597gPPD0p7hcbMapYwnUmswS6XGOVohGYCrWPeEt/U1c7BBFQ==";
        };
        _ddyB6HV3 = {
            "id" = "ddyB6HV3";
            "file" = "supplementaries-1.21.1-3.8.8-fabric.jar";
            "hash" = "sha512-iF57Q1jp41qu19nzSwMNstmBcCUHKZQUzAbs8i0TGP/lvx5U7s4uSn5XNV6hCj8k1gBMrforrtMl4kYa6EtOjg==";
        };
        _bnVCb2yf = {
            "id" = "bnVCb2yf";
            "file" = "supplementaries-1.21.1-3.8.9-fabric.jar";
            "hash" = "sha512-VuTtR0vo+fR1R9ShU04OsgQr3YcAAG3kfzSyEywmgTRxbdQpSTDF+0fSx1rESyPZk7N9s7sUB8uazJt7KfcPVQ==";
        };
        _ZHJvgW8G = {
            "id" = "ZHJvgW8G";
            "file" = "supplementaries-1.21.1-3.8.9-neoforge.jar";
            "hash" = "sha512-yNbCqlOH4axJk1tEiV82SdBUy302YMX6WzY2I9EPA5dOdeuGrUJsgXBaBFO/QGuC5dcRGFhrndjcQc1guB9EtA==";
        };
        _9UlfVS6z = {
            "id" = "9UlfVS6z";
            "file" = "supplementaries-1.21.1-3.8.10-fabric.jar";
            "hash" = "sha512-s4N5ayOeBau/o4CJsaUbGee1NWyY2LLvG7Y4DeRZkWWGMA0yVkiNezMe0Zf7MA0BaghLXZmGfD75sHGbqx4jDw==";
        };
        _svQdnO8W = {
            "id" = "svQdnO8W";
            "file" = "supplementaries-1.21.1-3.9.1-fabric.jar";
            "hash" = "sha512-+jVaR25dfjo/s2nSFI/tlFNdHwPyddVPURvrNSLhxNjPItCv1kPiVJSVaYl9a81JZmOUEvlit+eG30+QdPbTKw==";
        };
        _6vwrAvXf = {
            "id" = "6vwrAvXf";
            "file" = "supplementaries-1.21.1-3.9.1-neoforge.jar";
            "hash" = "sha512-ty+tHXfW2d1TbOAI8jqQFPTUcjHr9cTn1cIxViQ/UTXqyvNLLQIqAoQS/+XoAwgbSKvfPtYZUcaTCtRjYzyauw==";
        };
        _ZeuZfae2 = {
            "id" = "ZeuZfae2";
            "file" = "supplementaries-1.21.1-3.9.3-neoforge.jar";
            "hash" = "sha512-ALy1DotIyAvJgv1i5t6rcFqPdvSMoqK3K6tDnBQbP/btUsDmKYO9UgHhs4IC5hJpH33JzPfHaQ469J9r3vAIqQ==";
        };
        _8HLe7fdX = {
            "id" = "8HLe7fdX";
            "file" = "supplementaries-1.21.1-3.9.3-fabric.jar";
            "hash" = "sha512-DMzPm8GlNoITmUnqrOEwoQdaFcAszsosEqIsv2/12cGCvp5ZJ79jtQ4wt7dqMdqUY76/kOzDd4olryEEL5DifA==";
        };
        _tXziBmk3 = {
            "id" = "tXziBmk3";
            "file" = "supplementaries-1.21.1-3.9.5-fabric.jar";
            "hash" = "sha512-bwikhl7RCMgniDjJsikjI0N8uO/OUd1UU5JkeNqxDsxrxx5hb57PgrF73WsgMb4y2BTJ+KOSbRO58N/hbHq7XQ==";
        };
        _eHN3ZS1s = {
            "id" = "eHN3ZS1s";
            "file" = "supplementaries-1.21.1-3.9.5-neoforge.jar";
            "hash" = "sha512-hMuiTikaOCRh5NF2gz4nr36/hwHDlU75vdTMhH2DlXAqVT4vUsDaydGH3Oz0s/kyDX/ao+zOACAXcyU8kS3kJg==";
        };
        _Uds6VJIs = {
            "id" = "Uds6VJIs";
            "file" = "supplementaries-1.21.1-3.9.6-neoforge.jar";
            "hash" = "sha512-qRoXR2lJNqsZTXwxhlz3PqVfN8OJZiLsTKKRc+V8DdecVz4RotURde3tkTdzu5lfFgCu8FozuiL85EMaOQdleQ==";
        };
        _ecPmpscM = {
            "id" = "ecPmpscM";
            "file" = "supplementaries-1.21.1-3.9.6-fabric.jar";
            "hash" = "sha512-6ZH2tEwPY+xwWWSbC6XEII4FvVh3izaXqIpfyigJRQC/H0/o7MC4cl8hqIWoz7DGb/UTLgdRr4vPX6sz0Hp0ZQ==";
        };
        _A0lpiTgJ = {
            "id" = "A0lpiTgJ";
            "file" = "supplementaries-1.21.1-3.9.7-neoforge.jar";
            "hash" = "sha512-u0HzHwqAvjzM1p/m6UOsBbzkImdvIzdqXYVePUYGTxghKNJSL7lNsq8woaSxyLhOLcQwTwVQdRkxibuhfLEu3g==";
        };
        _kaToYG6R = {
            "id" = "kaToYG6R";
            "file" = "supplementaries-1.21.1-3.9.7-fabric.jar";
            "hash" = "sha512-4ajWgZBm4q563HjdCVtOFMnddm477EYU2cyo5wNC658WGi3RYa8yLgNsxmvMQo4FJUUWC7C77klbzuhqR0y8uQ==";
        };
        _iNQPlox8 = {
            "id" = "iNQPlox8";
            "file" = "supplementaries-1.21.1-3.9.8-fabric.jar";
            "hash" = "sha512-OSUIcsEpeOxlJJ6lAB8Tu+srM4Lq0aori2cq2VaiS+Myx+AxWfatB5IQ29kJ2x9PeDc7S1Vi/gO8WCFjOPmdDQ==";
        };
        _DOZiryjL = {
            "id" = "DOZiryjL";
            "file" = "supplementaries-1.21.1-3.9.8-neoforge.jar";
            "hash" = "sha512-9YGBVtD2W5//Ic8SkGU8PyZbNeXzF5Bm9nhRbmf+e0Id0wya1q9pkLL8DQ1RZ7UcyhkCB/RRjIj6fKsZDXctDw==";
        };
        _WrZWfRjP = {
            "id" = "WrZWfRjP";
            "file" = "supplementaries-1.21.1-3.9.9-neoforge.jar";
            "hash" = "sha512-80HQlx5kQlXAY/DLNju5PjEvTwBTBPivdtcknDy8DCWPQVz2573c3wIRWt6bqaIF7G0GLiYmtBSvrvVyVmfweQ==";
        };
        _h8FyJ2as = {
            "id" = "h8FyJ2as";
            "file" = "supplementaries-1.21.1-3.9.9-fabric.jar";
            "hash" = "sha512-9QcceL3S4agJxGf4D6BXErmSkQcSixOlgHPcCF4OG2PmMWSqoZZy2Lxr9brABlfjPY4Z9o2p9aI9UBUAizeT1w==";
        };
    in {
        "ZNg1UUpP" = _ZNg1UUpP;
        "7fEfk3ST" = _7fEfk3ST;
        ...
        "fabric-1.21.1" = _h8FyJ2as;
        "neoforge-1.20.1" = _S0TIJ1hU;
        "neoforge-1.21" = _ZeUwQQZo;
        "neoforge-1.21.1" = _WrZWfRjP;
        "pkg-0" = _ZNg1UUpP;
        "pkg-1" = _7fEfk3ST;
        "pkg-2" = _QwZE12dT;
        "pkg-3" = _FSwmKnuh;
        ...
        "pkg-241" = _t5DcO9dN;
        "pkg-242" = _5VUgaGau;
        "pkg-1.19.2-2.2.61" = _5xJypJYG;
        "pkg-1.19.2-2.2.62" = _aoABpErl;
        "pkg-1.19.2-2.2.64" = _vFXb9rqH;
        "pkg-1.19.2-2.2.65" = _nl0NOVtM;
        "pkg-1.19.2-2.3.0" = _w4IGYqie;
        "pkg-1.19.2-2.3.1" = _lkcvfmhv;
        "pkg-1.19.2-2.3.2" = _N4uFFIX0;
        "pkg-1.19.2-2.3.4" = _QVbyGGpE;
        "pkg-1.19.2-2.3.5" = _qHjinqKY;
        "pkg-1.19.2-2.3.6" = _UnAJ5QoX;
        "pkg-1.19.2-2.3.7" = _YxNTIErK;
        "pkg-1.19.2-2.3.8" = _8YjCjjgz;
        "pkg-1.19.2-2.3.9" = _PLlkwHgv;
        "pkg-1.19.2-2.3.10" = _FhErmd9g;
        "pkg-1.19.4-2.3.10" = _hUvwTfep;
        "pkg-1.19.2-2.3.11" = _VP5nOM64;
        "pkg-1.19.4-2.4.2" = _JqtYi61S;
        "pkg-1.19.4-2.4.3" = _TfDQMU7e;
        "pkg-1.19.4-2.4.4" = _JjyHwEG1;
        "pkg-1.19.4-2.4.5" = _UqblWwsI;
        "pkg-1.19.4-2.4.6" = _L7oFgkTu;
        "pkg-1.19.4-2.4.7" = _qElFnMpd;
        "pkg-1.19.4-2.4.9" = _Yn7xDk4D;
        "pkg-1.19.4-2.4.10" = _7qH07oyI;
        "pkg-1.19.2-2.3.12" = _ieQqcCHj;
        "pkg-1.19.4-2.4.11" = _wBR5c6pf;
        "pkg-1.19.2-2.3.13" = _iLJ4FF64;
        "pkg-1.19.4-2.4.12" = _7RqcoVLn;
        "pkg-1.19.2-2.3.14" = _aSaLvOTt;
        "pkg-1.19.2-2.3.14a" = _yg1vlxok;
        "pkg-1.19.4-2.4.13" = _yIWHR0zR;
        "pkg-1.19.4-2.4.14" = _b30OcW7J;
        "pkg-1.19.4-2.4.15" = _1mQDVX91;
        "pkg-1.19.2-2.3.15" = _9dl04zMd;
        "pkg-1.19.2-2.3.16" = _8NnOj1WR;
        "pkg-1.19.2-2.3.17" = _GWVHmL1K;
        "pkg-1.20-2.5.0" = _yupWdjrW;
        "pkg-1.20-2.5.1" = _eAO5rGEq;
        "pkg-1.20-2.5.2" = _tJf73FUO;
        "pkg-1.20-2.5.3" = _mvw6RVd6;
        "pkg-1.19.2-2.3.18" = _zPNX86bR;
        "pkg-1.20-2.5.4" = _5gq2sscI;
        "pkg-1.20-2.5.5" = _MLTO1p0v;
        "pkg-1.20-2.5.6" = _5GLPB2gZ;
        "pkg-1.20-2.5.7" = _uACIH75b;
        "pkg-1.20-2.5.8" = _AyMSk3ho;
        "pkg-1.19.2-2.3.19" = _NiA2jaNh;
        "pkg-1.20-2.5.10" = _eUAhOBuE;
        "pkg-1.20-2.5.11" = _S8cyqPIR;
        "pkg-1.20-2.5.12" = _cQxFs2gQ;
        "pkg-1.20-2.5.13" = _e6A5iria;
        "pkg-1.18.2-1.5.18" = _XrooimC8;
        "pkg-1.19.2-2.3.20" = _J3r1J6t6;
        "pkg-1.20-2.5.14" = _4fbiibIk;
        "pkg-1.20-2.5.15" = _wcgNRfcG;
        "pkg-1.20-2.5.16" = _buMd41Yx;
        "pkg-1.20-2.5.17" = _ct9nbby3;
        "pkg-1.20-2.5.18" = _2293Jq1G;
        "pkg-1.20-2.5.19" = _a0lPwvOO;
        "pkg-1.20-2.5.20" = _l6noDBuI;
        "pkg-1.20-2.5.21" = _yxYgkd6K;
        "pkg-1.20-2.5.22" = _tk9oLjAa;
        "pkg-1.20-2.5.23" = _als3bAaV;
        "pkg-1.20-2.5.24" = _p4c23nrv;
        "pkg-1.20-2.5.25" = _c4BJPiID;
        "pkg-1.20-2.5.26" = _9LH2MSxo;
        "pkg-1.19.2-2.3.21" = _V2HK2gYg;
        "pkg-1.19.2-2.3.22" = _YDNBKLpM;
        "pkg-1.19.2-2.3.23" = _IODmNmHW;
        "pkg-1.19.2-2.3.24" = _cvARGwCM;
        "pkg-1.20-2.5.28" = _ZqJBsA8q;
        "pkg-1.20-2.6.0" = _Vit1OblK;
        "pkg-1.20-2.6.1" = _MS5LHxpE;
        "pkg-1.20-2.6.2" = _xnC0H2hK;
        "pkg-1.20-2.6.3" = _7aGvV3zf;
        "pkg-1.20-2.6.4" = _7wN5oPe5;
        "pkg-1.20-2.6.5" = _VnldXbTj;
        "pkg-1.20-2.6.6" = _aEXnhsU4;
        "pkg-1.20-2.6.7" = _IUayNvVv;
        "pkg-1.20-2.6.8" = _IA9eMLlB;
        "pkg-1.20-2.6.9" = _GGYZzfZM;
        "pkg-1.20-2.6.11" = _SJkKNUtS;
        "pkg-1.20-2.6.10" = _cw9J7G7S;
        "pkg-1.20-2.6.12" = _N7Bej41a;
        "pkg-1.20-2.6.13" = _eLMFAPhO;
        "pkg-1.20-2.6.14" = _A6mwn7Gx;
        "pkg-1.20-2.6.15" = _mmaBnvfB;
        "pkg-1.20-2.6.16" = _gHtNB0eg;
        "pkg-1.20-2.6.17" = _dW6cGHDK;
        "pkg-1.19.2-2.4.0" = _SOFkmFU3;
        "pkg-1.19.2-2.4.1" = _WqRpE2OF;
        "pkg-1.19.2-2.4.3" = _pRhlIHxT;
        "pkg-1.19.2-2.4.4" = _2Xvue0py;
        "pkg-1.20-2.6.18" = _WqtybrPp;
        "pkg-1.20-2.6.19" = _aLcuQMSG;
        "pkg-1.19.2-2.4.5" = _8EQ2LLpY;
        "pkg-1.19.2-2.4.6" = _nmdofsyq;
        "pkg-1.19.2-2.4.7" = _DBB8mfiM;
        "pkg-1.20-2.6.20" = _3ttoUnCm;
        "pkg-1.19.2-2.4.8" = _jj4xXEPs;
        "pkg-1.19.2-2.4.9" = _txGidCMf;
        "pkg-1.19.2-2.4.10" = _oxRqUSrT;
        "pkg-1.20-2.6.23" = _XllhTM50;
        "pkg-1.20-2.6.24" = _T5k6fBoW;
        "pkg-1.20-2.6.26" = _O69H3PNt;
        "pkg-1.20-2.6.28" = _8e6RMmgI;
        "pkg-1.20-2.6.29" = _wFpSVDhy;
        "pkg-1.20-2.6.30" = _P54BEGWp;
        "pkg-1.19.2-2.4.11" = _bgeDoIaL;
        "pkg-1.20-2.6.31" = _JvEPNWH8;
        "pkg-1.19.2-2.4.12" = _PgPkPJK8;
        "pkg-1.20-2.6.33" = _O75uS6jE;
        "pkg-1.20-2.6.34" = _D9ONKdfl;
        "pkg-1.20-2.7.0" = _2FO5BLOP;
        "pkg-1.20-2.7.1" = _6plFJpWs;
        "pkg-1.20-2.7.2" = _rPTgjVXb;
        "pkg-1.20-2.7.6" = _ISYDeZfU;
        "pkg-1.20-2.7.7" = _2ABWoFuk;
        "pkg-1.20-2.7.8" = _OqRS908Z;
        "pkg-1.20-2.7.9" = _VKgb1vfq;
        "pkg-1.20-2.7.10" = _UcJCT98U;
        "pkg-1.20-2.7.11" = _je5qajaH;
        "pkg-1.19.2-2.4.14" = _rzUOljea;
        "pkg-1.20-2.7.12" = _BNNzFXXf;
        "pkg-1.20-2.7.13" = _QldP442I;
        "pkg-1.20-2.7.14" = _p9xeQvb6;
        "pkg-1.19.2-2.4.15" = _sQMur9qA;
        "pkg-1.20-2.7.17" = _7Dq0vhqo;
        "pkg-1.20-2.7.18" = _A1Lmfmcd;
        "pkg-1.20-2.7.19" = _cDYM0lKf;
        "pkg-1.20-2.7.20" = _8rvsAEun;
        "pkg-1.20-2.7.21" = _16GEKSIv;
        "pkg-1.19.2-2.4.16" = _lrRASJwQ;
        "pkg-1.19.2-2.4.17" = _tFyXILOh;
        "pkg-1.20-2.7.23" = _txDGD125;
        "pkg-1.20-2.7.25" = _m7GE5Bla;
        "pkg-1.20-2.7.27" = _7VAjQInR;
        "pkg-1.20-2.7.28" = _jHsBQTjo;
        "pkg-1.20-2.7.29" = _YoF8P2DI;
        "pkg-1.20-2.7.30" = _oXWPQJvf;
        "pkg-1.20-2.7.31" = _V5KpepeI;
        "pkg-1.20-2.7.32" = _6WZab0nc;
        "pkg-1.19.2-2.4.18" = _nENRvFLE;
        "pkg-1.19.2-2.4.19" = _AwtcJUkY;
        "pkg-1.20-2.7.33" = _w5OdhQw9;
        "pkg-1.20-2.7.35" = _OHsGwH5j;
        "pkg-1.20-2.7.36" = _KmsevR6N;
        "pkg-1.19.2-2.4.20" = _VNwz9Avv;
        "pkg-1.20-2.8.0" = _8IOIVITh;
        "pkg-1.20-2.8.1" = _aBuLi5aq;
        "pkg-1.20-2.8.2" = _zx3llw5i;
        "pkg-1.20-2.8.4" = _qtARIsSl;
        "pkg-1.20-2.8.5" = _DAyoPoA7;
        "pkg-1.20-2.8.6" = _roUQhhcO;
        "pkg-1.20-2.8.7" = _q0MRm1Nc;
        "pkg-1.20-2.8.8" = _k4WDfS6x;
        "pkg-1.20-2.8.9" = _18KY7MmS;
        "pkg-1.20-2.8.10" = _R5P1cLjK;
        "pkg-1.19.2-2.4.21" = _VQx7vGrB;
        "pkg-1.20-2.8.12" = _xQlCfB1N;
        "pkg-1.20-2.8.13" = _K7XS3qrW;
        "pkg-1.20-2.8.15" = _zOVMcKoT;
        "pkg-1.20-2.8.17" = _rNgF2xoZ;
        "pkg-1.20-3.0.0" = _v30mnESy;
        "pkg-fabric_1.21-3.0.0-alpha" = _glsiC8hz;
        "pkg-neoforge_1.21-3.0.0-alpha" = _ldi9YZHR;
        "pkg-1.20-3.0.1" = _XsRKOm3z;
        "pkg-fabric_1.21-3.0.2-alpha" = _2zT9GDgX;
        "pkg-neoforge_1.21-3.0.2-alpha" = _7rLGOVoV;
        "pkg-1.20-3.0.4" = _hZYfEqZA;
        "pkg-1.20-3.0.6" = _rTPSn6jw;
        "pkg-1.20-3.0.7" = _CNgM0OFi;
        "pkg-1.20-3.1.0" = _zU8oCBO1;
        "pkg-neoforge_1.21-3.0.5-alpha" = _t1oBEDEA;
        "pkg-fabric_1.21-3.0.5-alpha" = _BWGodlA2;
        "pkg-neoforge_1.21-3.0.6-alpha" = _d42pczAt;
        "pkg-fabric_1.21-3.0.6-alpha" = _pvUwZpQh;
        "pkg-neoforge_1.21-3.0.7-alpha" = _kkDuohfh;
        "pkg-fabric_1.21-3.0.7-alpha" = _hprQzsiE;
        "pkg-neoforge_1.21-3.0.8-alpha" = _7p31pIue;
        "pkg-fabric_1.21-3.0.8-alpha" = _ecYcGCYa;
        "pkg-neoforge_1.21-3.0.9-alpha" = _YGgNiE7u;
        "pkg-fabric_1.21-3.0.9-alpha" = _4MlLnD0j;
        "pkg-1.20-3.1.1" = _ANvcOsKZ;
        "pkg-neoforge_1.21-3.0.11-alpha" = _oCbvNoqg;
        "pkg-fabric_1.21-3.0.11-alpha" = _Suab4tdC;
        "pkg-1.20-3.1.2" = _albwHfc6;
        "pkg-1.20-3.1.3" = _VKTtfij5;
        "pkg-neoforge_1.21-3.0.10-alpha" = _FeacdFMi;
        "pkg-fabric_1.21-3.0.10-alpha" = _P5NF0MCv;
        "pkg-1.20-3.1.4" = _Scse0AUV;
        "pkg-neoforge_1.21-3.0.13-alpha" = _UeVNuJCw;
        "pkg-fabric_1.21-3.0.13-alpha" = _CBLtr6rT;
        "pkg-1.20-3.1.6" = _138WY9xy;
        "pkg-fabric_1.21-3.0.14-alpha" = _iUxrR1VT;
        "pkg-neoforge_1.21-3.0.14-alpha" = _vInCLE41;
        "pkg-neoforge_1.21-3.0.15-beta" = _lYG0LAFL;
        "pkg-fabric_1.21-3.0.15-beta" = _26FrA6Hc;
        "pkg-fabric_1.21-3.0.16-beta" = _D9PuDJDF;
        "pkg-neoforge_1.21-3.0.16-beta" = _vcllOqVZ;
        "pkg-fabric_1.21-3.0.17-beta" = _B69cENVs;
        "pkg-fabric_1.21-3.0.18-beta" = _PHFn4W5r;
        "pkg-neoforge_1.21-3.0.18-beta" = _6vWsVem8;
        "pkg-neoforge_1.21-3.0.19-beta" = _rUpl6QSq;
        "pkg-fabric_1.21-3.0.19-beta" = _5nGfj9fU;
        "pkg-neoforge_1.21-3.0.20-beta" = _V1HPMGsV;
        "pkg-fabric_1.21-3.0.20-beta" = _tl0vZxwl;
        "pkg-neoforge_1.21-3.0.21-beta" = _jeO0tgEH;
        "pkg-fabric_1.21-3.0.21-beta" = _7ErrrnpY;
        "pkg-neoforge_1.21-3.0.22-beta" = _KtqzMmtP;
        "pkg-fabric_1.21-3.0.22-beta" = _HUPe3k9m;
        "pkg-1.20-3.1.7" = _F4hwpxKp;
        "pkg-1.20-3.1.8" = _a3V94LSv;
        "pkg-neoforge_1.21-3.0.23-beta" = _B3FATkgs;
        "pkg-fabric_1.21-3.0.23-beta" = _KV0LYTUu;
        "pkg-1.20-3.1.9" = _UKTXjffk;
        "pkg-1.20-3.1.10" = _SFY0zXug;
        "pkg-fabric_1.21-3.0.25-beta" = _VsEP4fXk;
        "pkg-neoforge_1.21-3.0.25-beta" = _fVEJlC4X;
        "pkg-fabric_1.21-3.0.26-beta" = _94W0ycU3;
        "pkg-neoforge_1.21-3.0.26-beta" = _V29ojHxj;
        "pkg-neoforge_1.21-3.0.27-beta" = _WZKSkmOX;
        "pkg-fabric_1.21-3.0.27-beta" = _bLaQR0w4;
        "pkg-neoforge_1.21-3.0.28-beta" = _I0Ofy8J6;
        "pkg-fabric_1.21-3.0.28-beta" = _MyzFESrk;
        "pkg-fabric_1.21-3.0.29-beta" = _SP418f5W;
        "pkg-neoforge_1.21-3.0.29-beta" = _5UJVGbxs;
        "pkg-fabric_1.21-3.0.30-beta" = _RihagfdB;
        "pkg-neoforge_1.21-3.0.31-beta" = _LOVbtXAa;
        "pkg-fabric_1.21-3.0.31-beta" = _QcSlpRvz;
        "pkg-fabric_1.21-3.0.32-beta" = _GdJZT5eI;
        "pkg-neoforge_1.21-3.0.32-beta" = _GqyAZRF0;
        "pkg-neoforge_1.21-3.0.33-beta" = _4Mgk0NrK;
        "pkg-fabric_1.21-3.0.33-beta" = _fq6ggpjg;
        "pkg-1.20-3.1.12" = _9VWrLNGe;
        "pkg-neoforge_1.21-3.0.34-beta" = _n2dX5OSA;
        "pkg-neoforge_1.21-3.0.35-beta" = _xd3BKq7T;
        "pkg-1.20-3.1.15" = _gDGpUllt;
        "pkg-neoforge_1.21-3.0.36-beta" = _kzySmkyd;
        "pkg-fabric_1.21-3.0.36-beta" = _6QkfEncV;
        "pkg-1.20-3.1.16" = _1F6PXLSB;
        "pkg-neoforge_1.21-3.0.37-beta" = _VK6MqIRg;
        "pkg-fabric_1.21-3.0.37-beta" = _VbvO5MWb;
        "pkg-1.20-3.1.17" = _DqU0PbYW;
        "pkg-1.20-3.1.18" = _S4IygZ9g;
        "pkg-neoforge_1.21-3.0.39-beta" = _ASMr3AEe;
        "pkg-1.20-3.1.20" = _bHRxbeqq;
        "pkg-fabric_1.21-3.0.40-beta" = _vSs3Ecgt;
        "pkg-fabric_1.21-3.0.41-beta" = _9Bb4lbc0;
        "pkg-neoforge_1.21-3.0.41-beta" = _r7OfyZR6;
        "pkg-neoforge_1.21-3.0.43-beta" = _YtD69nSM;
        "pkg-neoforge_1.21-3.1.0" = _E2nuRgOl;
        "pkg-fabric_1.21-3.1.0" = _pwXgIKKs;
        "pkg-neoforge_1.21-3.1.1" = _8lr6B9o3;
        "pkg-fabric_1.21-3.1.1" = _w2Gx2i6w;
        "pkg-1.20-3.1.23" = _9kaNgmQC;
        "pkg-1.20-3.1.24" = _IWbAxeBd;
        "pkg-neoforge_1.21-3.1.3" = _mlnHXoo5;
        "pkg-fabric_1.21-3.1.3" = _kDARqFsJ;
        "pkg-neoforge_1.21-3.1.4" = _CMsA8g49;
        "pkg-fabric_1.21-3.1.4" = _4azVy1og;
        "pkg-1.20-3.1.26" = _KFHfXxsW;
        "pkg-neoforge_1.21-3.1.5" = _htrPoyTy;
        "pkg-fabric_1.21-3.1.5" = _Kj19f8YZ;
        "pkg-fabric_1.21-3.1.6" = _idvZhxbh;
        "pkg-neoforge_1.21-3.1.6" = _Hv69ySoY;
        "pkg-neoforge_1.21-3.1.7" = _MidHHWlX;
        "pkg-fabric_1.21-3.1.7" = _gTcgfFjQ;
        "pkg-1.20-3.1.28" = _qdvnjrOL;
        "pkg-1.20-3.1.29" = _b5Sql3tc;
        "pkg-1.20-3.1.31" = _nnzd0ymm;
        "pkg-neoforge_1.21-3.2.0-beta" = _VbpIArZ0;
        "pkg-fabric_1.21-3.2.0-beta" = _EzJaoj7u;
        "pkg-fabric_1.21-3.2.1" = _HZ5u0RzA;
        "pkg-neoforge_1.21-3.2.1" = _BFfPO73v;
        "pkg-neoforge_1.21-3.3.0" = _DyiNdMto;
        "pkg-fabric_1.21-3.3.0" = _zUlFzkD8;
        "pkg-neoforge_1.21-3.3.1" = _DtIzPj4C;
        "pkg-fabric_1.21-3.3.1" = _MROUEUxP;
        "pkg-neoforge_1.21-3.3.2" = _4PjbbW29;
        "pkg-fabric_1.21-3.3.2" = _X7FozFh1;
        "pkg-1.20-3.1.34" = _F0R5ANPz;
        "pkg-fabric_1.21-3.3.3" = _Q0Pc0OyD;
        "pkg-neoforge_1.21-3.3.3" = _n1CxAVtu;
        "pkg-neoforge_1.21-3.3.4" = _hKuZ4W1S;
        "pkg-fabric_1.21-3.3.4" = _5fUAfDM1;
        "pkg-1.20-3.1.35" = _Qnyfv88K;
        "pkg-1.20-3.1.36" = _gY8LSKD4;
        "pkg-neoforge_1.21-3.3.5" = _hc8opOzd;
        "pkg-fabric_1.21-3.3.5" = _XCUET7eO;
        "pkg-fabric_1.21-3.4.0" = _zDidMT8P;
        "pkg-neoforge_1.21-3.4.0" = _Av8xh5Bb;
        "pkg-fabric_1.21-3.4.1" = _xoghub3z;
        "pkg-neoforge_1.21-3.4.1" = _kXtnBWWn;
        "pkg-neoforge_1.21-3.4.2" = _EMTlMM9j;
        "pkg-fabric_1.21-3.4.2" = _Rx93e5Ri;
        "pkg-fabric_1.21-3.4.3" = _kAcPC9kV;
        "pkg-neoforge_1.21-3.4.3" = _Af63S0SZ;
        "pkg-neoforge_1.21-3.4.4" = _4kK80bNp;
        "pkg-fabric_1.21-3.4.4" = _53159AUk;
        "pkg-1.20-3.1.37" = _FIy84Umq;
        "pkg-fabric_1.21-3.4.6" = _pUFHwGLk;
        "pkg-neoforge_1.21-3.4.6" = _eincZal1;
        "pkg-fabric_1.21-3.4.9" = _racI1c7R;
        "pkg-neoforge_1.21-3.4.9" = _h38aoc8L;
        "pkg-fabric_1.21-3.4.12" = _GEE9sxCt;
        "pkg-neoforge_1.21-3.4.12" = _yZED03md;
        "pkg-neoforge_1.21-3.4.13" = _ZmXHg2oO;
        "pkg-fabric_1.21-3.4.13" = _YDmGxYYB;
        "pkg-neoforge_1.21-3.4.14" = _SwHISoKO;
        "pkg-fabric_1.21-3.4.14" = _WYJ7xwft;
        "pkg-1.20-3.1.38" = _vKSIoh22;
        "pkg-fabric_1.21-3.4.15" = _JJiF0jga;
        "pkg-neoforge_1.21-3.4.15" = _pUhoIgDe;
        "pkg-neoforge_1.21-3.4.16" = _HuLq3LuW;
        "pkg-fabric_1.21-3.4.16" = _YKS0ralQ;
        "pkg-1.20-3.1.39" = _nFuBlVta;
        "pkg-1.20-3.1.40" = _zKCC6OsO;
        "pkg-fabric_1.21-3.4.17" = _GtpOLFtb;
        "pkg-neoforge_1.21-3.4.17" = _qD8F2mCF;
        "pkg-1.20-3.1.41" = _LAQ22yJj;
        "pkg-neoforge_1.21-3.4.18" = _NjadYIGp;
        "pkg-fabric_1.21-3.4.18" = _PATkR9Nt;
        "pkg-fabric_1.21-3.4.20" = _DGhfsUAq;
        "pkg-neoforge_1.21-3.4.20" = _rEEPz2OX;
        "pkg-1.21-3.5.0-neoforge" = _CFpEyMe4;
        "pkg-1.21-3.5.0-fabric" = _a0BbASg8;
        "pkg-1.21-3.5.1-neoforge" = _GeB6blUx;
        "pkg-1.21-3.5.1-fabric" = _M5ijmFNU;
        "pkg-1.21-3.5.2-neoforge" = _MzquTEUE;
        "pkg-1.21-3.5.2-fabric" = _q2RCyZ1O;
        "pkg-1.21-3.5.3-fabric" = _nPew0mPI;
        "pkg-1.21-3.5.3-neoforge" = _VmG8uueu;
        "pkg-1.21-3.5.4-fabric" = _cOEFI9qR;
        "pkg-1.21-3.5.5-neoforge" = _6SI5uMIv;
        "pkg-1.21-3.5.5-fabric" = _So2MwkE1;
        "pkg-1.21-3.5.6-fabric" = _SLu3eWZT;
        "pkg-1.21-3.5.6-neoforge" = _riqCyLUO;
        "pkg-1.21-3.5.7-fabric" = _U1OM85Lp;
        "pkg-1.21-3.5.7-neoforge" = _g0PNlHNQ;
        "pkg-1.21-3.5.9-neoforge" = _xpLD5uSK;
        "pkg-1.21-3.5.9-fabric" = _j00lbfTW;
        "pkg-1.21-3.5.10-neoforge" = _PY30MemR;
        "pkg-1.21-3.5.10-fabric" = _UO88Q0Ai;
        "pkg-1.21-3.5.11-neoforge" = _bkyutEGf;
        "pkg-1.21-3.5.11-fabric" = _BIAekP8K;
        "pkg-1.21-3.5.13-fabric" = _eNkfhqoV;
        "pkg-1.21-3.5.13-neoforge" = _zRJwO1Lk;
        "pkg-1.21-3.5.14-neoforge" = _M5jn25j2;
        "pkg-1.21-3.5.14-fabric" = _bwnFqFRV;
        "pkg-1.21-3.5.16-fabric" = _sL3OlZYC;
        "pkg-1.21-3.5.16-neoforge" = _Q3zTcprv;
        "pkg-1.20-3.1.42-fabric" = _xZP8KbxH;
        "pkg-1.20-3.1.42-forge" = _KgkjZ2z3;
        "pkg-1.21-3.5.17-fabric" = _tqVK2pBK;
        "pkg-1.21-3.5.17-neoforge" = _ZeUwQQZo;
        "pkg-1.21-3.5.18-fabric" = _hIBY8pVP;
        "pkg-1.21-3.5.18-neoforge" = _7UoJJAp8;
        "pkg-1.21-3.5.19-neoforge" = _GCthWMfx;
        "pkg-1.21-3.5.19-fabric" = _qkYPbsg0;
        "pkg-1.21-3.5.20-fabric" = _KUv4eCUi;
        "pkg-1.21-3.5.20-neoforge" = _PKjyQRZ0;
        "pkg-1.21-3.5.21-neoforge" = _SluXy6ix;
        "pkg-1.21-3.5.21-fabric" = _dw5GMH9U;
        "pkg-1.21-3.5.24-neoforge" = _5B2mN7yR;
        "pkg-1.21-3.5.24-fabric" = _8zcH8oKA;
        "pkg-1.21-3.5.25-fabric" = _lCX23NTg;
        "pkg-1.21-3.5.25-neoforge" = _DxYRPQ6h;
        "pkg-1.21-3.5.26-neoforge" = _MSKshgx9;
        "pkg-1.21-3.5.26-fabric" = _ECp8OxzU;
        "pkg-1.21-3.5.27-neoforge" = _B4k8qIJB;
        "pkg-1.21-3.5.27-fabric" = _wVkX2tMY;
        "pkg-1.21-3.5.30-fabric" = _VZpjVZ38;
        "pkg-1.21-3.5.30-neoforge" = _yvqgPkmW;
        "pkg-1.21-3.5.31-neoforge" = _hdph9h1U;
        "pkg-1.21-3.5.31-fabric" = _oH3b01EK;
        "pkg-1.21-3.5.32-neoforge" = _amkd53BE;
        "pkg-1.21-3.5.32-fabric" = _n9RyCPTb;
        "pkg-1.21-3.5.33-neoforge" = _i5gsy1xF;
        "pkg-1.21-3.5.33-fabric" = _XKXoerlH;
        "pkg-1.20-3.1.43-forge" = _S0TIJ1hU;
        "pkg-1.20-3.1.43-fabric" = _i7ejA878;
        "pkg-1.21-3.5.34-neoforge" = _NuQNqCLy;
        "pkg-1.21-3.5.34-fabric" = _W65LrELj;
        "pkg-1.21.1-3.6.0" = _9YHdVOf7;
        "pkg-1.21.1-3.6.1" = _GWSk5E4L;
        "pkg-1.21.1-3.6.2" = _OOAnM9QT;
        "pkg-1.21.1-3.6.3" = _8jDcC3Ml;
        "pkg-1.21.1-3.6.4" = _hVuiFBZD;
        "pkg-1.21.1-3.6.5" = _jeSbi9B9;
        "pkg-1.21.1-3.6.6" = _iZW24EZo;
        "pkg-1.21.1-3.6.7" = _Exz712sl;
        "pkg-1.21.1-3.6.8" = _Agn1kmUY;
        "pkg-1.21.1-3.7.0" = _ThuW1oBG;
        "pkg-1.21.1-3.7.2" = _H3rSBkgZ;
        "pkg-1.21.1-3.7.4" = _BF0SUpAZ;
        "pkg-1.21.1-3.7.7" = _FPL7hXrE;
        "pkg-1.21.1-3.8.0" = _HAFNpQz4;
        "pkg-1.21.1-3.8.2" = _Ud6brJoG;
        "pkg-1.21.1-3.8.3" = _GLhAIvzK;
        "pkg-1.21.1-3.8.4" = _KfWCJ4fj;
        "pkg-1.21.1-3.8.5" = _b6fx0XZz;
        "pkg-1.21.1-3.8.8" = _ddyB6HV3;
        "pkg-1.21.1-3.8.9" = _ZHJvgW8G;
        "pkg-1.21.1-3.8.10" = _9UlfVS6z;
        "pkg-1.21.1-3.9.1" = _6vwrAvXf;
        "pkg-1.21.1-3.9.3" = _8HLe7fdX;
        "pkg-1.21.1-3.9.5" = _eHN3ZS1s;
        "pkg-1.21.1-3.9.6" = _ecPmpscM;
        "pkg-1.21.1-3.9.7" = _kaToYG6R;
        "pkg-1.21.1-3.9.8" = _DOZiryjL;
        "pkg-1.21.1-3.9.9" = _h8FyJ2as;
        "default" = _h8FyJ2as;
    });
