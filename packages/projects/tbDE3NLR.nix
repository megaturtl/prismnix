...
let
    ...
    in {
        ...
        "pkg-1.3" = _RZrAhKq8;
        "pkg-1.4" = _L6Z7eG4m;
        "pkg-1.4-hotfix" = _Hob2FiSW;
        "pkg-1.5" = _yVmIAH8v;
        "pkg-1.5-forge-hotfix" = _XZrjNmWA;
        "pkg-1.6-fabric" = _b7pevbA1;
        "pkg-1.6-forge" = _4alo2PqQ;
        "pkg-1.7-forge" = _2zRaTZRd;
        "pkg-1.8-fabric" = _2RmLgZ3A;
        "pkg-1.8-forge" = _hEQepno0;
        "pkg-1.9-forge" = _rauIXKTb;
        "pkg-1.9-forge-hotfix" = _KHxOch3Y;
        "pkg-1.8-fabric-hotfix" = _nRNC2Nm4;
        "pkg-1.10-forge" = _SkD1K2Z7;
        "pkg-1.9-fabric" = _fx4dkJlV;
        "pkg-1.10.1-forge" = _TtW65fLb;
        "pkg-1.9.1-fabric" = _H7YjoFh5;
        "pkg-1.11-forge" = _Wmh5YYaI;
        "pkg-1.10-fabric" = _Uvt7EfgL;
        "pkg-1.11-neoforge" = _Unq1N0z5;
        "pkg-2.0-forge" = _sfylyEqu;
        "pkg-2.1-forge" = _lEDbzgJL;
        "pkg-2.1.1-forge" = _eMpXUcMm;
        "pkg-2.1.1-neoforge" = _iCd9bDE0;
