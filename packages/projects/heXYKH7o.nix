...
let
    ...
    in {
        ...
        "uJj3lxqq" = _uJj3lxqq;
        "WwKTG8w8" = _WwKTG8w8;
        "minecraft-1.16.5" = _WwKTG8w8;
        "minecraft-1.18" = _WwKTG8w8;
        "minecraft-1.18.1" = _WwKTG8w8;
        "minecraft-1.18.2" = _WwKTG8w8;
        "minecraft-1.19.4" = _WwKTG8w8;
        "minecraft-1.20" = _WwKTG8w8;
        "minecraft-1.20.1" = _WwKTG8w8;
        "minecraft-1.20.2" = _WwKTG8w8;
        "minecraft-1.20.3" = _WwKTG8w8;
        "minecraft-1.20.4" = _WwKTG8w8;
        "minecraft-1.20.5" = _WwKTG8w8;
        "minecraft-1.20.6" = _WwKTG8w8;
        "minecraft-1.21" = _WwKTG8w8;
        "minecraft-1.21.1" = _WwKTG8w8;
        "minecraft-1.21.2" = _WwKTG8w8;
        "minecraft-1.21.3" = _WwKTG8w8;
        "minecraft-1.21.4" = _WwKTG8w8;
        "minecraft-1.21.5" = _WwKTG8w8;
        "minecraft-1.21.6" = _WwKTG8w8;
        "minecraft-1.21.7" = _WwKTG8w8;
        "minecraft-1.21.8" = _WwKTG8w8;
        ...
        "minecraft-1.21.9" = _WwKTG8w8;
        "minecraft-1.21.10" = _WwKTG8w8;
        "minecraft-1.21.11" = _WwKTG8w8;
        "minecraft-26.1" = _WwKTG8w8;
        "minecraft-26.1.1" = _WwKTG8w8;
        "minecraft-26.1.2" = _WwKTG8w8;
        "minecraft-26.2" = _WwKTG8w8;
        "pkg-1.0" = _bpacUt9g;
        "pkg-1.1" = _jGKcXs4a;
        "pkg-1.2" = _8XF8usON;
        "pkg-1.3" = _4iNCslaS;
