...
let
    versions = (let
        ...
        _WwKTG8w8 = {
            "id" = "WwKTG8w8";
            "file" = "Underwater_Sky_[v1.9].zip";
            "hash" = "sha512-HVpSrGD1srrMRENv2Vjzl6vTFCAD2pNlth23XMCqbk+X9sP7V1GW2o00iETVNMmaVoN5ItCgk85LfoD7PN3odA==";
        };
        _379G8L9O = {
            "id" = "379G8L9O";
            "file" = "Underwater_Sky_[v2.0].zip";
            "hash" = "sha512-WSBwIpm4r3YCqf1ZX+prlWrunyAQU+LcsvME4yCGb4nUlehAKcO69alal85B3NFVVtetlSAcEHfYN8UigGFdZg==";
        };
    in {
        "QmZklDGw" = _QmZklDGw;
        "bpacUt9g" = _bpacUt9g;
        ...
        "WwKTG8w8" = _WwKTG8w8;
        "379G8L9O" = _379G8L9O;
        "minecraft-1.16.5" = _379G8L9O;
        "minecraft-1.18" = _379G8L9O;
        "minecraft-1.18.1" = _379G8L9O;
        "minecraft-1.18.2" = _379G8L9O;
        "minecraft-1.19.4" = _379G8L9O;
        "minecraft-1.20" = _379G8L9O;
        "minecraft-1.20.1" = _379G8L9O;
        "minecraft-1.20.2" = _379G8L9O;
        "minecraft-1.20.3" = _379G8L9O;
        "minecraft-1.20.4" = _379G8L9O;
        "minecraft-1.20.5" = _379G8L9O;
        "minecraft-1.20.6" = _379G8L9O;
        "minecraft-1.21" = _379G8L9O;
        "minecraft-1.21.1" = _379G8L9O;
        "minecraft-1.21.2" = _379G8L9O;
        "minecraft-1.21.3" = _379G8L9O;
        "minecraft-1.21.4" = _379G8L9O;
        "minecraft-1.21.5" = _379G8L9O;
        "minecraft-1.21.6" = _379G8L9O;
        "minecraft-1.21.7" = _379G8L9O;
        "minecraft-1.21.8" = _379G8L9O;
        ...
        "minecraft-1.21.9" = _379G8L9O;
        "minecraft-1.21.10" = _379G8L9O;
        "minecraft-1.21.11" = _379G8L9O;
        "minecraft-26.1" = _379G8L9O;
        "minecraft-26.1.1" = _379G8L9O;
        "minecraft-26.1.2" = _379G8L9O;
        "minecraft-26.2" = _379G8L9O;
        "minecraft-26.3" = _379G8L9O;
        "pkg-1.0" = _bpacUt9g;
        "pkg-1.1" = _jGKcXs4a;
        "pkg-1.2" = _8XF8usON;
        "pkg-1.3" = _4iNCslaS;
