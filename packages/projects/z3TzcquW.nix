...
let
    ...
    in {
        ...
        "pkg-1.20-1.1.0" = _YenlZc51;
        "pkg-1.20-1.1.1" = _WD0b0dT2;
        "pkg-1.19-1.1.1" = _whZ8crGh;
        "pkg-1.20-1.2.0" = _MnPJ3LFC;
        "pkg-1.19-1.1.2" = _zP52opck;
        "pkg-1.20-1.2.2" = _nzZ6aKDr;
        "pkg-1.20-1.2.3" = _lMKLnUHm;
        "pkg-1.20-1.2.4" = _dtPVJ8j9;
        "pkg-1.20.4-1.2.6" = _KIwO1JW0;
        "pkg-1.20.4-1.8.2" = _82JG1ncG;
        "pkg-1.20.4-1.2.7" = _WbPgzxfI;
        "pkg-1.19-1.1.3" = _6yTegMt6;
        "pkg-1.20.4-1.2.9" = _VxB8EM3v;
        "pkg-1.20-1.2.5" = _QGmXstXn;
        "pkg-1.20-1.2.6" = _BXACdA7V;
        "pkg-1.20-1.2.7" = _Bvjyyy1T;
        "pkg-neoforge_1.21-1.2.8" = _r8yTuej3;
        "pkg-fabric_1.21-1.2.8" = _loNsCLcg;
        "pkg-fabric_1.21-1.2.9" = _212YmeOP;
        "pkg-neoforge_1.21-1.2.10" = _4sBRv6Jz;
        "pkg-fabric_1.21-1.2.10" = _h695yyZJ;
        "pkg-neoforge_1.21-1.2.11" = _I1MRWqaN;
        "pkg-fabric_1.21-1.2.11" = _VjmICHe8;
        "pkg-neoforge_1.21-1.2.12" = _ai57lxpK;
        "pkg-fabric_1.21-1.2.13" = _65QSAH7D;
        "pkg-neoforge_1.21-1.2.13" = _TOV6LTw1;
        "pkg-neoforge_1.21-1.2.14" = _yM7pjE3g;
        "pkg-neoforge_1.21-1.2.15" = _fln5Hr04;
