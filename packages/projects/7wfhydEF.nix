...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _LT5ECUEd;
        "pkg-1.0.9" = _OU8FkDrO;
        "pkg-1.0.10" = _1zGUMRC1;
        "pkg-1.0.11" = _CGtlZP3t;
        "pkg-1.21.10+build.3" = _7hJl8Eaj;
        "pkg-1.21.10+build.4" = _5LHaM4Ms;
        "pkg-1.21.11+build.1" = _lEXfkAaF;
