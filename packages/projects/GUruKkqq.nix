...
let
    ...
    in {
        ...
        "SDUs45n9" = _SDUs45n9;
        "aXIN1aCc" = _aXIN1aCc;
        "minecraft-1.21.9" = _aXIN1aCc;
        "minecraft-1.21.10" = _aXIN1aCc;
        "minecraft-1.21.11" = _aXIN1aCc;
        "minecraft-26.1" = _aXIN1aCc;
        "minecraft-26.1.1" = _aXIN1aCc;
        "minecraft-26.1.2" = _aXIN1aCc;
        "minecraft-1.21" = _aXIN1aCc;
        "minecraft-1.21.1" = _aXIN1aCc;
        "minecraft-1.21.2" = _aXIN1aCc;
        "minecraft-1.21.3" = _aXIN1aCc;
        "minecraft-1.21.4" = _aXIN1aCc;
        "minecraft-1.21.5" = _aXIN1aCc;
        "minecraft-1.21.6" = _aXIN1aCc;
        "minecraft-1.21.7" = _aXIN1aCc;
        "minecraft-1.21.8" = _aXIN1aCc;
        "minecraft-26.2" = _aXIN1aCc;
        "pkg-1.0" = _9YTE3hiD;
        "pkg-1.1" = _SDUs45n9;
        "pkg-2.0" = _aXIN1aCc;
        "default" = _aXIN1aCc;
