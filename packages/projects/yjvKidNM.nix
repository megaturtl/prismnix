...
let
    versions = (let
        ...
        _37cxXiE9 = {
            "id" = "37cxXiE9";
            "file" = "lighty-fabric-4.0.1+26.3.jar";
            "hash" = "sha512-5gaoSzV9Nr3bwJtVrqgl4VjEXvezu5MesILm4zefH8ayzd4vEC1dFrE7OtehG9ZLqMFDXBhrwsyl8TGySG5Otw==";
        };
        _q26PYT9F = {
            "id" = "q26PYT9F";
            "file" = "lighty-neoforge-4.0.1+26.3.jar";
            "hash" = "sha512-QsUggi1Dmy1y8Ko2T2I+NGBvD+hv8mB3vGACYXJVRFKjYNS0PWlG40Zlcxvg+Hidvw0Wp+AZ/TLnM5PZ0vyOxg==";
        };
    in {
        "YaBkSKF1" = _YaBkSKF1;
        "to3GEPP3" = _to3GEPP3;
        ...
        "neoforge-26.3" = _q26PYT9F;
        "bta-babric-b1.7.3" = _20VmNbkH;
        "pkg-1.0.1+1.18.2" = _YaBkSKF1;
        "pkg-v1.0.2+1.18.2" = _to3GEPP3;
        "pkg-v1.0.3+1.18.2" = _AAgzJITw;
        "pkg-v1.0.4+1.18.2" = _WUNXg3tj;
        "pkg-v1.0.4+1.19.1" = _jOzg7Rs0;
        "pkg-v1.0.5+1.19.1" = _MOxuF29E;
        "pkg-v1.0.5+1.18.2" = _WE6Lafdb;
        "pkg-v1.0.6+1.19.1" = _U9YmAW1y;
        "pkg-v1.0.6+1.18.2" = _7TTmTIc3;
        "pkg-v1.0.6+1.19.3" = _zGYvxmKF;
        "pkg-v1.1.0+1.19.3" = _cIcJkZrY;
        "pkg-v1.1.0+1.19.1" = _IcDi3FdH;
        "pkg-v1.1.0+1.18.2" = _PsCAtCcO;
        "pkg-v1.1.0+23w03a" = _UR2JD4Vq;
        "pkg-v1.1.0+23w07a" = _rbWjWuzv;
        "pkg-v1.2.0+1.18.2" = _B88oyyMX;
        "pkg-v1.2.0+1.19.2" = _tYdDf1O7;
        "pkg-v1.2.0+1.19.3" = _lHJJbUa8;
        "pkg-v1.2.0+1.19.4-pre1" = _avCUpNIQ;
        "pkg-v1.2.1+1.19.4" = _VGTmLBcm;
        "pkg-v1.2.1+1.19.1" = _GzFkrvMc;
        "pkg-v1.2.1+1.19.3" = _1dewYXbP;
        "pkg-v1.2.1+1.18.2" = _LwWqa60V;
        "pkg-v1.2.1+23w12a" = _ZkWcGUdS;
        "pkg-v2.0.0-alpha+23w14a" = _ii8pbsZl;
        "pkg-v2.0.0-alpha.2+23w16a" = _r31KSq6s;
        "pkg-v2.0.0-alpha.2+23w17a" = _sp6oX0cF;
        "pkg-v2.0.0-alpha.3+23w18a" = _oqXp6vUY;
        "pkg-v1.3.0+1.19.4" = _Lt1yOskt;
        "pkg-v1.3.0+1.19" = _V8vjjQIU;
        "pkg-v2.0.0-alpha.3+1.20-pre1" = _KrBZ4TL3;
        "pkg-v1.3.1+1.19.4" = _NDfKz9TX;
        "pkg-v2.0.0-alpha.3+1.20-pre2" = _dlOfIVid;
        "pkg-v2.0.0-alpha.4+1.20-pre6" = _ENMSYUhz;
        "pkg-v2.0.0-alpha.5+1.20-pre6" = _GtJ7Hd7k;
        "pkg-v2.0.0+1.20" = _eJLToU9T;
        "pkg-v2.0.0+1.20.1" = _c2S07SIs;
        "pkg-v2.0.1+1.20.1" = _uxejZMKi;
        "pkg-v2.0.2+1.20.1" = _I0Ub39rH;
        "pkg-v2.0.2+1.20" = _qisVJNDU;
        "pkg-2.0.3+1.20.1" = _QZ33NSQO;
        "pkg-v2.0.4+1.20.1" = _jivTkKnd;
        "pkg-v2.0.5+1.20.1" = _VMOdiW8x;
        "pkg-v2.0.6+1.20.1" = _HC2yYYSh;
        "pkg-v2.0.7+1.20.1" = _gRwZndqb;
        "pkg-v2.0.8+1.20.1" = _vYXjXYZc;
        "pkg-v2.0.9+1.20.1" = _6yLQJFwc;
        "pkg-v2.0.9+23w32a" = _sL8JroDY;
        "pkg-v2.1.0+1.20.1" = _Ohjb70iU;
        "pkg-v2.1.1+1.20.1" = _iLpPxmsd;
        "pkg-v2.1.2+1.20.1" = _7MqyU696;
        "pkg-v2.1.2+1.20.2" = _kABf9vLK;
        "pkg-v2.1.2+1.20.3" = _l6qzxcq2;
        "pkg-v2.1.2+1.20.3+1.20.4" = _pje3sFlu;
        "pkg-3.0.0-alpha.1+24w06a" = _97c3iDeQ;
        "pkg-v2.2.0+1.20.3+1.20.4" = _4uJvwVjH;
        "pkg-v3.0.0-beta.1+1.20.5" = _fr63f3XG;
        "pkg-2.3.0+1.20.3+1.20.4" = _bEAnLk42;
        "pkg-3.0.0-beta.2+1.20.6" = _GKOPotN2;
        "pkg-3.0.0-beta.3+1.20.6" = _nx1PVeGD;
        "pkg-3.0.0-beta.3+1.21.0" = _YltoFrBX;
        "pkg-2.1.3+1.20.1" = _9xbi0x5Q;
        "pkg-3.0.0-beta.4+1.21.0+1.21.1" = _pp45AOCt;
        "pkg-3.0.0-beta.5+1.21.3" = _es9yqQRf;
        "pkg-3.0.0-beta.6+1.21.3" = _6U9OeqAF;
        "pkg-3.0.0-beta.7+1.21.3" = _ldPW2YNs;
        "pkg-3.0.0-beta.7+1.21.1" = _gP508hJP;
        "pkg-3.0.0-beta.8+1.21.1" = _Ua5CgydL;
        "pkg-3.0.0-beta.8+1.21.4" = _C4vzoZmL;
        "pkg-3.0.0-beta.8+1.21.3+fix" = _CAeqWVWu;
        "pkg-3.0.0-beta.8+1.21.5" = _NlJvfXQd;
        "pkg-3.0.0-beta.9+1.21.5" = _J0dwD4t2;
        "pkg-3.0.0+1.21.6" = _5dR84D9t;
        "pkg-3.0.1+1.21.6" = _6omBaFXG;
        "pkg-3.0.2+1.21.6" = _m4vrYZZW;
        "pkg-1.0.0-BTA" = _s41x7x4z;
        "pkg-3.1.0+1.21.6" = _7TdNhjq9;
        "pkg-3.1.1+1.21.10" = _dLNvK0tR;
        "pkg-3.1.2+1.21.10" = _4NmN33hG;
        "pkg-3.1.3+1.21.10" = _cDSrz5rk;
        "pkg-3.1.3+1.21.11" = _lMOlDoeP;
        "pkg-3.1.4+1.21.11" = _XCmd51fQ;
        "pkg-4.0.0+26.1.2" = _tn4yyUpy;
        "pkg-4.0.1+26.1.2" = _Vco3tFfO;
        "pkg-1.1.0-BTA" = _20VmNbkH;
        "pkg-4.0.1+26.2" = _ES3Y63qA;
        "pkg-4.0.1+26.3" = _q26PYT9F;
        "default" = _q26PYT9F;
    });
