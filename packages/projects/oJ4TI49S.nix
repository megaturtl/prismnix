...
let
    ...
    in {
        ...
        "pkg-21.4.107" = _tgu2POqE;
        "pkg-21.4.109" = _yiScMiII;
        "pkg-21.4.112" = _2wWMR3sX;
        "pkg-21.5.0" = _Dq3rWEs0;
        "pkg-21.5.1" = _fRXbp7q2;
        "pkg-21.5.9" = _Hd8lCmiQ;
        "pkg-21.5.16" = _iLTcWqPo;
        "pkg-21.5.17" = _e1CHWScm;
        "pkg-21.5.18" = _hen1yeGl;
        "pkg-21.6.0" = _fCovnYcD;
        "pkg-21.7.0" = _zzUnXuUQ;
        "pkg-21.7.1" = _voA3E9GI;
        "pkg-21.6.3" = _tN6qdu8M;
        "pkg-21.7.6" = _rqkeA0dI;
        "pkg-21.7.8" = _Ra8b0MOZ;
        "pkg-21.10.0" = _LxHppOuE;
        "pkg-21.10.4" = _IpJxPDSF;
        "pkg-21.11.0" = _nsPbdzIR;
        "pkg-21.10.5" = _RVVVB4UA;
        "pkg-21.11.1" = _4pu96Vwp;
        "pkg-26.1.0" = _gKrySc3k;
