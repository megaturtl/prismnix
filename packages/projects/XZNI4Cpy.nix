...
let
    ...
    in {
        ...
        "pkg-1.18-1.1.19" = _fdhDNAWT;
        "pkg-1.18.2-1.3.0" = _4oeWkUHc;
        "pkg-1.18.2-1.3.0-fabric" = _OcXbkZ3B;
        "pkg-1.18.2-1.3.1" = _nBaVTJSp;
        "pkg-1.18.2-1.3.1-fabric" = _crCd1HBa;
        "pkg-1.19-1.3.1-fabric" = _IdEpyr8t;
        "pkg-1.18.2-1.3.2" = _RzYDfRjE;
        "pkg-1.18.2-1.3.2-fabric" = _EBqX5wVW;
        "pkg-1.19-1.3.2-fabric" = _GE0UMjUo;
        "pkg-1.19-1.3.3" = _Vzz506WJ;
        "pkg-1.19-1.3.3-fabric" = _PIHgfwum;
        "pkg-1.18.2-1.3.3" = _kSr7SeN3;
        "pkg-1.19-1.3.4" = _ljpuOmz5;
        "pkg-1.18.2-1.3.3-fabric" = _cRdoFWn6;
        "pkg-1.19-1.3.4-fabric" = _e9n8gBsP;
        "pkg-1.18.2-1.3.4" = _wlhEWC1H;
        "pkg-1.19-1.3.5" = _SPb84VOI;
        "pkg-1.18.2-1.3.4-fabric" = _owPrqlaa;
        "pkg-1.19-1.3.5-fabric" = _ao1uatnH;
        "pkg-1.19-1.3.6" = _hyTR1BKX;
        "pkg-1.19-1.3.7" = _9L6LHP0R;
        "pkg-1.19-1.3.8" = _F4ngtiI8;
        "pkg-1.19-1.4.0-1" = _SYfhb4FV;
        "pkg-1.18.2-1.3.5" = _A6dk24C8;
        "pkg-1.19-1.3.9" = _7MNLYHJL;
        "pkg-1.18.2-1.4.1-fabric" = _5MnnzrVJ;
        "pkg-1.19-1.4.1-fabric" = _4ASuvomO;
        "pkg-1.18.2-1.4.2-fabric" = _CkBCnqcO;
        "pkg-1.19-1.4.2-fabric" = _DdEnH0yL;
        "pkg-1.18.2-1.4.3-fabric" = _D6WrGoAd;
        "pkg-1.19.2-1.4.3-fabric" = _vuy50CXH;
        "pkg-1.18-1.3.6" = _9q13KA3F;
        "pkg-1.19-1.3.10" = _K8yDgSg3;
        "pkg-1.19.3-1.3.10" = _BHeFoqle;
        "pkg-1.18-1.4.4-fabric" = _uZdKKT51;
        "pkg-1.19-1.4.4-fabric" = _mYcdNQwZ;
        "pkg-1.19.3-1.4.4-fabric" = _64R2ex4K;
        "pkg-1.18-1.4.5-fabric" = _8dFHNqhj;
        "pkg-1.19-1.4.5-fabric" = _OeS1mkfF;
        "pkg-1.19.3-1.4.5-fabric" = _fk2bPJjT;
        "pkg-1.19.3-1.3.11" = _5CZKq50T;
        "pkg-1.18-1.4.6-fabric" = _iRop3g5j;
        "pkg-1.19-1.4.6-fabric" = _yfhWfXHT;
        "pkg-1.19.3-1.4.6-fabric" = _dn6eFq4r;
        "pkg-1.18-1.4.0" = _ZVymX5J7;
        "pkg-1.18-1.5.0-fabric" = _AP8wPnjs;
        "pkg-1.19-1.5.0" = _DdLqEsTd;
        "pkg-1.19.3-1.5.0" = _i5eryqGC;
        "pkg-1.19-1.5.0-fabric" = _dEjkNqa2;
        "pkg-1.19.3-1.5.0-fabric" = _gLbDrpeI;
        "pkg-1.19-1.5.1" = _5eUOZfXQ;
        "pkg-1.19.3-1.5.1" = _xMQxdEUU;
        "pkg-1.19-1.5.1-fabric" = _DhDv8YjC;
        "pkg-1.19.3-1.5.1-fabric" = _BZ1HG9F3;
        "pkg-1.19.4-1.5.1-fabric" = _imirPErw;
        "pkg-1.18-1.4.1" = _YBlUk1qW;
        "pkg-1.18-1.5.1-fabric" = _ZA45gbid;
        "pkg-1.19-1.5.2" = _5qAQiVjw;
        "pkg-1.19.3-1.5.2" = _zxj1ThHy;
        "pkg-1.19.4-1.5.2" = _yOH47BFp;
        "pkg-1.19-1.5.2-fabric" = _T9uckikI;
        "pkg-1.19.3-1.5.2-fabric" = _hGI5xhJV;
        "pkg-1.19.4-1.5.2-fabric" = _y8WrnXmu;
        "pkg-1.19-1.5.3" = _K4DKZDHW;
        "pkg-1.19.3-1.5.3" = _SQzROm9G;
        "pkg-1.19.4-1.5.3" = _ijsXQZ6Z;
        "pkg-1.19-1.5.3-fabric" = _VlBshpZ7;
        "pkg-1.19.3-1.5.3-fabric" = _i7BWS4W4;
        "pkg-1.19.4-1.5.3-fabric" = _y0jwO4Ho;
        "pkg-1.18-1.4.2" = _zLR4iPPY;
        "pkg-1.19-1.5.4" = _dlLtp8Sc;
        "pkg-1.19.3-1.5.4" = _w2qxPjRZ;
        "pkg-1.19.4-1.5.4" = _zq96vtTQ;
        "pkg-1.18-1.5.2-fabric" = _51Bth2Nr;
        "pkg-1.19-1.5.4-fabric" = _FBuf8cT2;
        "pkg-1.19.3-1.5.4-fabric" = _yyidMnF2;
        "pkg-1.19.4-1.5.4-fabric" = _Ge4gJGWD;
        "pkg-1.19.4-1.5.5" = _Ym7RBlaa;
        "pkg-1.19.4-1.5.5-fabric" = _MLw37YiL;
        "pkg-1.5.4" = _ttkfUyA9;
        "pkg-1.18-1.4.3" = _S9DsrxZO;
        "pkg-1.19-1.5.5" = _ezA9V2do;
        "pkg-1.19.3-1.5.5" = _WFX1sN7l;
        "pkg-1.19.4-1.5.6" = _QvEI1TUp;
        "pkg-1.18-1.5.3-fabric" = _pa0cyjvN;
        "pkg-1.19-1.5.5-fabric" = _tIR9ig6j;
        "pkg-1.19.3-1.5.5-fabric" = _EAu3YCFF;
        "pkg-1.19.4-1.5.6-fabric" = _zMRuRSwy;
        "pkg-1.20-1.5.5-fabric" = _XrJ7enDf;
        "pkg-1.19-1.5.6" = _aXYnsvlN;
        "pkg-1.19.3-1.5.6" = _PyvSEshm;
        "pkg-1.19.4-1.5.7" = _lAqeDSE1;
        "pkg-1.19-1.5.6-fabric" = _aDq1NsR2;
        "pkg-1.19.3-1.5.6-fabric" = _Acanr9uk;
        "pkg-1.19.4-1.5.7-fabric" = _KNgiQKr2;
        "pkg-1.20-1.5.6-fabric" = _eYNqoF5J;
        "pkg-1.19-1.5.7" = _slghbR9B;
        "pkg-1.19.3-1.5.7" = _8WhJa3MU;
        "pkg-1.19.4-1.5.8" = _p61xSc0x;
        "pkg-1.19-1.5.7-fabric" = _vMv2JpvI;
        "pkg-1.19.3-1.5.7-fabric" = _bJyMIOsL;
        "pkg-1.19.4-1.5.8-fabric" = _mUvhKgYA;
        "pkg-1.20-1.6.0" = _VMyFhFSQ;
        "pkg-1.20-1.6.0-fabric" = _nDEGx2eV;
        "pkg-1.20-1.6.1" = _9rk49fqM;
        "pkg-1.20-1.6.1-fabric" = _v4I2NLi0;
        "pkg-1.20-1.6.2" = _XCrQkltB;
        "pkg-1.20-1.6.2-fabric" = _3nhy6d9O;
        "pkg-1.19-1.5.8" = _NDqa2kWo;
        "pkg-1.19.3-1.5.8" = _OEviSpZX;
        "pkg-1.19.4-1.5.9" = _X7jVMQbz;
        "pkg-1.20-1.6.3" = _kkINzA6r;
        "pkg-1.19-1.5.8-fabric" = _F0Q0xQ1g;
        "pkg-1.19.3-1.5.8-fabric" = _56p3SPXc;
        "pkg-1.19.4-1.5.9-fabric" = _Mb7OhwXR;
        "pkg-1.20-1.6.3-fabric" = _N10jYjoU;
        "pkg-1.18-1.4.4" = _VK2hsAjO;
        "pkg-1.19-1.5.9" = _yQi6tsiF;
        "pkg-1.19.3-1.5.9" = _Nw9V4sxF;
        "pkg-1.19.4-1.5.10" = _KsfO2TIm;
        "pkg-1.20-1.6.4" = _nOSh8UFo;
        "pkg-1.18-1.5.4-fabric" = _dGP3IcWz;
        "pkg-1.19-1.5.9-fabric" = _mI1bA7bA;
        "pkg-1.19.3-1.5.9-fabric" = _qwpcyBJt;
        "pkg-1.19.4-1.5.10-fabric" = _puLsAb0p;
        "pkg-1.20-1.6.4-fabric" = _gT2rdlHL;
        "pkg-1.20.2-1.6.4-fabric" = _chEwL7Re;
        "pkg-1.20.2-1.6.5-fabric" = _1fZzqZ4s;
        "pkg-1.20.2-1.6.6-fabric" = _sUpvaCrp;
        "pkg-1.20.2-1.6.5" = _ze4DZ0UL;
        "pkg-1.20.2-1.6.7-fabric" = _wphhssH1;
        "pkg-1.20-1.6.5" = _taaU7hQG;
        "pkg-1.20.2-1.6.6" = _L8TO0uXq;
        "pkg-1.20-1.6.5-fabric" = _l63ucSOn;
        "pkg-1.20.2-1.6.8-fabric" = _s3MMZ8BE;
        "pkg-1.20.3-1.6.9-fabric" = _hOStIkXw;
        "pkg-1.20.2-1.6.7" = _UeHrazxx;
        "pkg-1.20.2-1.6.8" = _qP917dEU;
        "pkg-1.20.4-1.6.8" = _qhiqzQNF;
        "pkg-1.20.4-1.6.9-fabric" = _4b3kYw5h;
        "pkg-1.20.2-1.6.9" = _aaAlZOIm;
        "pkg-1.20.4-1.6.7" = _H7OdB5Fr;
        "pkg-1.20.4-1.6.9" = _CFuNWT3O;
        "pkg-1.20.4-1.6.10-fabric" = _SwsNBLFw;
        "pkg-1.20.5-1.6.10-fabric" = _woIvoytK;
        "pkg-1.20.4-1.6.10" = _1Pga87iV;
        "pkg-1.20.4-1.6.11-fabric" = _Rj7NEBNn;
        "pkg-1.20.5-1.6.11-fabric" = _TRfeupoU;
        "pkg-1.20.5-1.6.12-fabric" = _1S9DZ46R;
        "pkg-1.15.2-1.1.5" = _HfXAoJKS;
        "pkg-1.17.1-1.2.21" = _ktTtec0f;
        "pkg-1.17.1-1.1.18-fabric" = _ODpXMnSN;
        "pkg-1.16-1.2.20" = _2vreNVKA;
        "pkg-1.16-1.2.21" = _qhhYS7JJ;
        "pkg-1.20.5-1.6.13-fabric" = _jz43q4j4;
        "pkg-1.16-1.2.22" = _KjeawKgS;
        "pkg-1.18-1.4.5" = _dETfeMGK;
        "pkg-1.19-1.5.10" = _VsIk4zYy;
        "pkg-1.19.3-1.5.10" = _NCxLmejx;
        "pkg-1.19.4-1.5.11" = _qgWoG7cD;
        "pkg-1.20-1.6.6" = _MiLXJHWR;
        "pkg-1.20.2-1.6.10" = _fmt7usez;
        "pkg-1.20.4-1.6.11" = _cv3DRJVB;
        "pkg-1.18-1.5.5-fabric" = _vCfZmtDS;
        "pkg-1.19-1.5.10-fabric" = _Z7Z7HzQd;
        "pkg-1.19.3-1.5.10-fabric" = _SGjDehJg;
        "pkg-1.19.4-1.5.11-fabric" = _t4nYbMUj;
        "pkg-1.20-1.6.6-fabric" = _FVJja9qr;
        "pkg-1.20.2-1.6.9-fabric" = _zBOR5Put;
        "pkg-1.20.4-1.6.12-fabric" = _uYJ8RWmZ;
        "pkg-1.20.5-1.6.14-fabric" = _maJnquZH;
        "pkg-1.20.5-1.6.12" = _siq1pRyd;
        "pkg-1.20.5-1.6.15-fabric" = _3cTjzNHP;
        "pkg-1.20.5-1.6.13" = _UZcSiXSk;
        "pkg-1.20.6-1.6.14" = _6cSLFjTm;
        "pkg-1.20.6-1.6.16-fabric" = _wEhkPXwL;
        "pkg-1.20.6-1.6.15" = _qW9gLVfd;
        "pkg-1.20.6-1.6.17-fabric" = _mU5uxKdU;
        "pkg-1.19-1.5.11" = _Xoa4RYRL;
        "pkg-1.19.3-1.5.11" = _IftaXdt2;
        "pkg-1.19.4-1.5.12" = _lKWgNFOX;
        "pkg-1.20-1.6.7" = _OuvnACAf;
        "pkg-1.20.2-1.6.11" = _akO6yBTi;
        "pkg-1.20.4-1.6.12" = _Dc0h973P;
        "pkg-1.19-1.5.11-fabric" = _hHYdW4AJ;
        "pkg-1.19.3-1.5.11-fabric" = _fYVXXuqF;
        "pkg-1.19.4-1.5.12-fabric" = _T2tlL1ay;
        "pkg-1.20-1.6.7-fabric" = _4Ie0pZX5;
        "pkg-1.20.2-1.6.10-fabric" = _C1KsOueh;
        "pkg-1.20.4-1.6.13-fabric" = _OgkgVrpE;
        "pkg-1.20.6-1.6.16" = _P5E9hQHZ;
        "pkg-1.20.6-1.6.18-fabric" = _5VgXZMem;
        "pkg-1.21-2.0.0" = _p81lj0zd;
        "pkg-1.21-2.0.0-fabric" = _fbgYsydq;
        "pkg-1.20.6-1.6.19-fabric" = _iMAAYCI3;
        "pkg-1.21-2.0.1" = _JbuXSFQc;
        "pkg-1.21-2.0.1-fabric" = _16X296jl;
        "pkg-1.21-2.0.2-fabric" = _P13hVADH;
        "pkg-1.16-1.2.23" = _uS6lRfqY;
        "pkg-1.21-2.0.2" = _lrZ943Aa;
        "pkg-1.21-2.0.3-fabric" = _1u5j6tru;
        "pkg-1.21-2.0.3" = _6vyCwtjm;
        "pkg-1.21-2.0.4-fabric" = _FxgmQLEC;
        "pkg-1.21-2.0.4" = _yauWNVoS;
        "pkg-1.21-2.0.5-fabric" = _xnCLdUUC;
        "pkg-1.21-2.0.5" = _Fh4DWvWl;
        "pkg-1.21-2.0.6-fabric" = _FUKGrRvt;
        "pkg-1.21-2.0.6" = _dX6nFGVU;
        "pkg-1.21-2.0.7-fabric" = _V4mwo7v5;
        "pkg-1.20-1.6.8" = _KLq8PemV;
        "pkg-1.20.2-1.6.12" = _UFM7XhmI;
        "pkg-1.20.4-1.6.13" = _BEakrZ61;
        "pkg-1.20.6-1.6.17" = _1JqY9TTx;
        "pkg-1.20-1.6.8-fabric" = _9YQrQcI9;
        "pkg-1.20.2-1.6.11-fabric" = _u1LXOthC;
        "pkg-1.20.4-1.6.14-fabric" = _JGgg4c2g;
        "pkg-1.20.6-1.6.20-fabric" = _FpbYdAH4;
        "pkg-1.21-2.0.7" = _tko0sGV9;
        "pkg-1.21-2.0.8-fabric" = _noHIwpc0;
        "pkg-1.21-2.0.8" = _o3uKy0rX;
        "pkg-1.21-2.0.9-fabric" = _mchezbKx;
        "pkg-1.16-1.2.24" = _vA1AvvN1;
        "pkg-1.21-2.0.9" = _cD1azUms;
        "pkg-1.21-2.0.10-fabric" = _8uoE28Fs;
        "pkg-1.21-2.0.10" = _o6ACnmeA;
        "pkg-1.21-2.0.11-fabric" = _3ust8dEW;
        "pkg-1.21.2-2.1.0-fabric" = _BD8Ro7tR;
        "pkg-1.21.3-2.1.0" = _wa63aEw4;
        "pkg-1.21.3-2.1.1-fabric" = _t4dmpxAg;
        "pkg-1.20-1.6.9" = _hKLNn4tS;
        "pkg-1.20-1.6.9-fabric" = _Nq1nC44P;
        "pkg-1.21-2.0.11" = _8JAtMaFz;
        "pkg-1.21-2.0.12-fabric" = _T3L4FeKj;
        "pkg-1.21.3-2.1.1" = _NWgkxW4I;
        "pkg-1.21.3-2.1.2-fabric" = _h9IMZ6BE;
        "pkg-1.21.4-2.1.2" = _jBt1lNc0;
        "pkg-1.21.4-2.1.3-fabric" = _wyAACtbn;
        "pkg-1.21-2.0.12" = _wXkxg2sa;
        "pkg-1.21.4-2.1.3" = _3sguGyld;
        "pkg-1.21-2.0.13-fabric" = _AqDadlr7;
        "pkg-1.21.4-2.1.4-fabric" = _54T0tvuE;
        "pkg-1.20-1.7.0" = _UjCLHkAa;
        "pkg-1.20-1.7.0-fabric" = _V3qjjiMa;
        "pkg-1.21-2.1.0" = _CMZaxFHT;
        "pkg-1.21-2.1.0-fabric" = _sVfZgag9;
        "pkg-1.21.4-2.2.0" = _7VSSXrHl;
        "pkg-1.21.4-2.2.0-fabric" = _xDxoda9E;
        "pkg-1.21-2.1.1" = _r27zH9Nx;
        "pkg-1.21-2.1.1-fabric" = _tAMOuTVF;
        "pkg-1.21.4-2.2.1" = _dufWDBzz;
        "pkg-1.21.4-2.2.1-fabric" = _dVmj8WG1;
        "pkg-1.21-2.1.2-fabric" = _XRowOrAu;
        "pkg-1.21.4-2.2.2-fabric" = _rFkPiXVS;
        "pkg-1.21-2.1.2" = _eNhDi6wG;
        "pkg-1.21.4-2.2.2" = _N3IQNcfb;
        "pkg-1.21-2.1.3-fabric" = _zjA53Pxy;
        "pkg-1.21.4-2.2.3-fabric" = _HxyUAcZw;
        "pkg-1.21.5-2.3.0" = _sAxarHor;
        "pkg-1.21.5-2.3.0-fabric" = _qX0yhOIg;
        "pkg-1.20-1.7.1" = _XELeoPjZ;
        "pkg-1.20-1.7.1-fabric" = _nvqkBIsD;
        "pkg-1.21-2.1.3" = _rfZG2FW3;
        "pkg-1.21-2.1.4-fabric" = _Lyp3E5zZ;
        "pkg-1.21.4-2.2.3" = _59m88a4K;
        "pkg-1.21.4-2.2.4-fabric" = _VrrpO1RE;
        "pkg-1.21.5-2.3.1" = _ndqhoHkO;
        "pkg-1.21.5-2.3.1-fabric" = _SMV2iZkO;
        "pkg-1.21-2.1.4" = _PWBo9zfe;
        "pkg-1.21-2.1.5-fabric" = _mZA1tpfc;
        "pkg-1.21.4-2.2.4" = _eDZBNeYI;
        "pkg-1.21.4-2.2.5-fabric" = _UEu4ZhTI;
        "pkg-1.21.5-2.3.2" = _Sq33RM7h;
        "pkg-1.21.5-2.3.2-fabric" = _cUeGZdLk;
        "pkg-1.21-2.2.0" = _38X6wMDM;
        "pkg-1.21-2.2.0-fabric" = _BPR41vzK;
        "pkg-1.21.4-2.3.0" = _2TvJ9iDH;
        "pkg-1.21.4-2.3.0-fabric" = _urmK8OFU;
        "pkg-1.21.5-2.4.0" = _7e7BNlCs;
        "pkg-1.21.5-2.4.0-fabric" = _PbMokF2H;
        "pkg-1.21.6-2.4.0" = _YL8nu4pL;
        "pkg-1.21.6-2.4.0-fabric" = _Wc6TVAIP;
        "pkg-1.21-2.2.1" = _uj7DPLdB;
        "pkg-1.21-2.2.1-fabric" = _jPuHszUe;
        "pkg-1.21.4-2.3.1" = _2rtP4FI0;
        "pkg-1.21.4-2.3.1-fabric" = _NyEIeKj5;
        "pkg-1.21.5-2.4.1" = _6WzymKvQ;
        "pkg-1.21.5-2.4.1-fabric" = _jSWVU5YN;
        "pkg-1.21.6-2.4.1" = _owI5qXEn;
        "pkg-1.21.6-2.4.1-fabric" = _YTzOMaus;
        "pkg-1.21.7-2.5.0" = _SlpiAfRU;
        "pkg-1.21.7-2.5.0-fabric" = _iBZNE98f;
        "pkg-1.21-2.2.2" = _EEFysEme;
        "pkg-1.21.4-2.3.2" = _V3otLlal;
        "pkg-1.21.5-2.4.2" = _t37eIavc;
        "pkg-1.21.8-2.5.1" = _up3u7Y0W;
        "pkg-1.21-2.2.2-fabric" = _7EvspCjd;
        "pkg-1.21.4-2.3.2-fabric" = _LfcFusEs;
        "pkg-1.21.5-2.4.2-fabric" = _UgT7dsMt;
        "pkg-1.21.8-2.5.1-fabric" = _hUHaVHCk;
        "pkg-1.21.10-2.6.0" = _bvPe1MLJ;
        "pkg-1.21.10-2.6.0-fabric" = _z9q8nGMl;
        "pkg-1.21.10-2.6.1-fabric" = _Ze9yVQwH;
        "pkg-1.21-2.2.3" = _YZ629sQj;
        "pkg-1.21.4-2.3.3" = _cERcDmW2;
        "pkg-1.21.5-2.4.3" = _auLypMs2;
        "pkg-1.21.8-2.5.2" = _9tbAfwnA;
        "pkg-1.21.10-2.6.1" = _k46Yooua;
        "pkg-1.21-2.2.3-fabric" = _ffDTcs80;
        "pkg-1.21.4-2.3.3-fabric" = _Z9Cp2F8F;
        "pkg-1.21.5-2.4.3-fabric" = _YgtSXmV0;
        "pkg-1.21.8-2.5.2-fabric" = _4EjgIm9b;
        "pkg-1.21.10-2.6.2-fabric" = _afOJDfev;
        "pkg-1.21.11-2.7.0" = _NvA1xNoB;
        "pkg-1.21.11-2.7.0-fabric" = _bxbED3Sl;
        "pkg-1.21.10-2.6.2" = _uBA9by0Y;
        "pkg-1.21.10-2.6.3-fabric" = _xrl3Q8jp;
        "pkg-1.21.11-2.7.1" = _EOGExoTs;
        "pkg-1.21.11-2.7.1-fabric" = _r6ZDBA5Q;
        "pkg-1.21-2.2.4" = _AQUMoQqW;
        "pkg-1.21.8-2.5.3" = _kOjvybx5;
        "pkg-1.21.10-2.6.3" = _1EYJbxGa;
        "pkg-1.21.11-2.7.2" = _LhoGWy2T;
        "pkg-1.21-2.2.4-fabric" = _ffa8Bl7Z;
        "pkg-1.21.8-2.5.3-fabric" = _gNLLiGf4;
        "pkg-1.21.10-2.6.4-fabric" = _bcjcTQVi;
        "pkg-1.21.11-2.7.2-fabric" = _tsqVx9hT;
        "pkg-1.21.11-2.7.3" = _Z9lBCK1f;
        "pkg-1.21.11-2.7.3-fabric" = _59gBQhQ5;
        "pkg-1.21-2.3.0" = _Ft5r1IwP;
        "pkg-1.21-2.3.0-fabric" = _GwLz79tK;
        "pkg-1.21.8-2.6.0" = _jphnAgx1;
        "pkg-1.21.8-2.6.0-fabric" = _eOUsxNs8;
        "pkg-1.21.10-2.7.0" = _SDKiYFrM;
        "pkg-1.21.10-2.7.0-fabric" = _Gk2tI0ZM;
        "pkg-1.21.11-2.8.0" = _J63C1Uex;
        "pkg-1.21.11-2.8.0-fabric" = _FydlCSUl;
        "pkg-26.1-2.9.0" = _MGWODATJ;
        "pkg-26.1-2.9.1" = _jAcbtOf6;
        "pkg-26.1-2.9.0-fabric" = _2dYvqACq;
        "pkg-1.21-2.3.1" = _mgIPCvGV;
        "pkg-26.1-2.9.2" = _eV8KDnu6;
        "pkg-26.1-2.9.1-fabric" = _4UJjUNam;
        "pkg-1.21-2.3.2" = _x8jcBWWG;
        "pkg-26.1-2.9.3" = _7WFLSB6P;
        "pkg-26.1-2.9.4" = _qPUNrC0U;
        "pkg-26.1-2.9.5" = _vvLJptyl;
        "pkg-26.1-2.9.2-fabric" = _ujGuSHwo;
        "pkg-26.2-2.10.0" = _AcA6o7wy;
        "pkg-26.2-2.10.0-fabric" = _Hm8mRDJc;
        "pkg-1.21.10-2.7.1" = _L2uLEsyv;
        "pkg-1.21.11-2.8.1" = _Cl6WdkOf;
        "pkg-26.2-2.10.1" = _k7eYceQI;
        "pkg-26.2-2.10.1-fabric" = _hdkO0f3w;
        "pkg-1.21-2.4.0" = _IW2x3fIm;
        "pkg-1.21-2.4.0-fabric" = _W8Kkx3wD;
        "pkg-26.1-2.10.0" = _W1eInbbl;
        "pkg-26.1-2.10.0-fabric" = _pausGn6i;
        "pkg-26.2-2.11.0" = _MWkP9UBb;
        "pkg-26.2-2.11.1-fabric" = _jCABf2nF;
        "pkg-1.21-2.4.1" = _QQqFyS6K;
        "pkg-1.21-2.4.1-fabric" = _rfiala5p;
        "pkg-26.1-2.10.1" = _LJuuSq8p;
