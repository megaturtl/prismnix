...
let
    versions = (let
        ...
        _Y96ThKg6 = {
            "id" = "Y96ThKg6";
            "file" = "lib39-2.0.40+1.20.1-all.deflated.jar";
            "hash" = "sha512-MoWKEu8xacm3Ah7jzghJyCTGjYvEJcZYdGE6wbixdBXZRFYbe8nBxiILIKOjE4zGoNdeKr/9dTRN11gQVhgSJA==";
        };
    in {
        "VgH3d3Tj" = _VgH3d3Tj;
        "Te26714S" = _Te26714S;
        ...
        "pkg-1.4.1" = _10ommXsO;
        "pkg-1.4.2" = _EsnZ2MDc;
        "pkg-1.5.0-pre1+1.18.2" = _GT5l7ej8;
        "pkg-1.5.0-pre1+1.19.2" = _WDONcaIv;
        "pkg-1.5.0-pre1+1.19.3" = _RkRIKL5T;
        "pkg-1.5.0-pre3+1.18.2" = _jWnDFwho;
        "pkg-1.5.0-pre3+1.19.2" = _T1vg9BJo;
        "pkg-1.5.0-pre3+1.19.3" = _rg73PO9t;
        "pkg-1.5.0-experimental7+1.20.1" = _mSN8gyCX;
        "pkg-2.0.12+1.20.1" = _AtyvvaKJ;
        "pkg-2.0.40+1.20.1" = _Y96ThKg6;
        "default" = _Y96ThKg6;
    });
