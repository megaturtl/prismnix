...
let
    versions = (let
        ...
        _T1b5ROgI = {
            "id" = "T1b5ROgI";
            "file" = "recipes_plus.zip";
            "hash" = "sha512-0HWU7pbX148/uLMdHhunjnZuROCtfm2mxNnPBks7iy2RKAd+SmiaqqrvgSzieybSnHB2lj/colByNFyDj0gbpA==";
        };
        _vaWbUXqh = {
            "id" = "vaWbUXqh";
            "file" = "recipes-plus-1.8.6.jar";
            "hash" = "sha512-V8iimGhhV+fUurHLZUmsfdm6DdZF+awSjtmnUD+LmtXqcMfFprFC1RADMkYhgwhyLqRFGl7JSgqW5uwseACjRQ==";
        };
        _epBdHyxx = {
            "id" = "epBdHyxx";
            "file" = "recipes_plus.zip";
            "hash" = "sha512-2c+FI2mD99IsdMCBiEFDDsefczSZx0B4M2sKS1H2Hap6yy/aQ22Lr6qIbkiHzD+LCvESJliPe+tUeWIh9fXtig==";
        };
        _EWIpaGka = {
            "id" = "EWIpaGka";
            "file" = "recipes-plus-1.8.7.jar";
            "hash" = "sha512-Tz88T42Nz0BMaobYGIdE7fMBEK6ETj9Sas6/4Rn/UTXh8SGbFamuaVxtr61L/I/zjH500Gcn/i5qpEua9mIf9A==";
        };
        _i5fglCti = {
            "id" = "i5fglCti";
            "file" = "recipes_plus.zip";
            "hash" = "sha512-SC1a5hFXRCX1rDkMqrA9ohQCJvVP80A1UcqdwTwU3xyENr5oHXS8/6OiBG6JO3iF+hzB2YHAX5ott1u1huswjw==";
        };
        _otedEDPB = {
            "id" = "otedEDPB";
            "file" = "recipes-plus-1.8.7+backport.jar";
            "hash" = "sha512-aGjmuvsdz1K0uhhLlE5IKkaCluwrpi7NKrduIbqqkHiS7Ls2qa+enL+Me1rkViouNPhtTkb71Qh/RuWfROyi5Q==";
        };
    in {
        "MnekBwlC" = _MnekBwlC;
        "cWv1yVzi" = _cWv1yVzi;
        ...
        "datapack-1.16" = _i5fglCti;
        "datapack-1.16.1" = _i5fglCti;
        "datapack-1.16.2" = _i5fglCti;
        "datapack-1.16.3" = _i5fglCti;
        "datapack-1.16.4" = _i5fglCti;
        "datapack-1.16.5" = _i5fglCti;
        "datapack-1.17" = _i5fglCti;
        "datapack-1.17.1" = _i5fglCti;
        "datapack-1.18" = _i5fglCti;
        "datapack-1.18.1" = _i5fglCti;
        "datapack-1.18.2" = _i5fglCti;
        "datapack-1.19" = _i5fglCti;
        "datapack-1.19.1" = _i5fglCti;
        "datapack-1.19.2" = _i5fglCti;
        "datapack-1.19.3" = _i5fglCti;
        "datapack-1.19.4" = _i5fglCti;
        "datapack-1.20" = _i5fglCti;
        "datapack-1.20.1" = _i5fglCti;
        "datapack-1.20.2" = _i5fglCti;
        "datapack-1.20.3" = _i5fglCti;
        "datapack-1.20.4" = _i5fglCti;
        ...
        "datapack-1.21.5" = _epBdHyxx;
        "datapack-1.21.6" = _epBdHyxx;
        "datapack-1.21.7" = _epBdHyxx;
        "datapack-1.21.8" = _epBdHyxx;
        "datapack-1.21.9" = _epBdHyxx;
        "datapack-1.21.10" = _epBdHyxx;
        "datapack-1.21.11" = _epBdHyxx;
        "datapack-26.1" = _epBdHyxx;
        "datapack-26.1.1" = _epBdHyxx;
        "datapack-26.1.2" = _epBdHyxx;
        "datapack-26.2" = _epBdHyxx;
        "datapack-26.3-snapshot-1" = _epBdHyxx;
        "datapack-26.3-snapshot-2" = _epBdHyxx;
        "datapack-26.3-snapshot-3" = _epBdHyxx;
        "datapack-26.3-snapshot-4" = _epBdHyxx;
        "datapack-26.3-snapshot-5" = _epBdHyxx;
        "datapack-26.3-snapshot-6" = _epBdHyxx;
        "datapack-26.3-snapshot-7" = _epBdHyxx;
        "datapack-26.3-snapshot-8" = _epBdHyxx;
        "datapack-26.3-snapshot-9" = _epBdHyxx;
        "datapack-26.3-snapshot-10" = _epBdHyxx;
        "datapack-26.3-pre-1" = _epBdHyxx;
        "datapack-23w03a" = _i5fglCti;
        "datapack-23w04a" = _i5fglCti;
        "datapack-23w05a" = _i5fglCti;
        "datapack-23w12a" = _i5fglCti;
        "datapack-23w13a" = _i5fglCti;
        "datapack-23w13a_or_b" = _i5fglCti;
        "datapack-23w14a" = _i5fglCti;
        "datapack-23w16a" = _i5fglCti;
        "datapack-23w17a" = _i5fglCti;
        "datapack-23w31a" = _i5fglCti;
        "datapack-23w32a" = _i5fglCti;
        "datapack-23w33a" = _i5fglCti;
        "datapack-23w35a" = _i5fglCti;
        "datapack-1.20.2-pre1" = _i5fglCti;
        "datapack-23w40a" = _i5fglCti;
        "datapack-23w41a" = _i5fglCti;
        "datapack-23w42a" = _i5fglCti;
        "datapack-23w43a" = _i5fglCti;
        "datapack-23w43b" = _i5fglCti;
        "datapack-23w44a" = _i5fglCti;
        "datapack-23w45a" = _i5fglCti;
        "datapack-23w46a" = _i5fglCti;
        "datapack-1.20.3-pre1" = _i5fglCti;
        "datapack-1.20.3-pre2" = _i5fglCti;
        "datapack-1.20.3-pre3" = _i5fglCti;
        "datapack-1.20.3-pre4" = _i5fglCti;
        "fabric-1.15" = _2esMfqkO;
        "fabric-1.15.1" = _2esMfqkO;
        "fabric-1.15.2" = _2esMfqkO;
        "fabric-1.16" = _otedEDPB;
        "fabric-1.16.1" = _otedEDPB;
        "fabric-1.16.2" = _otedEDPB;
        "fabric-1.16.3" = _otedEDPB;
        "fabric-1.16.4" = _otedEDPB;
        "fabric-1.16.5" = _otedEDPB;
        "fabric-1.17" = _otedEDPB;
        "fabric-1.17.1" = _otedEDPB;
        "fabric-1.18" = _otedEDPB;
        "fabric-1.18.1" = _otedEDPB;
        "fabric-1.18.2" = _otedEDPB;
        "fabric-1.19" = _otedEDPB;
        "fabric-1.19.1" = _otedEDPB;
        "fabric-1.19.2" = _otedEDPB;
        "fabric-1.19.3" = _otedEDPB;
        "fabric-1.19.4" = _otedEDPB;
        "fabric-1.20" = _otedEDPB;
        "fabric-1.20.1" = _otedEDPB;
        "fabric-1.20.2" = _otedEDPB;
        "fabric-1.20.3" = _otedEDPB;
        "fabric-1.20.4" = _otedEDPB;
        ...
        "fabric-1.21.5" = _EWIpaGka;
        "fabric-1.21.6" = _EWIpaGka;
        "fabric-1.21.7" = _EWIpaGka;
        "fabric-1.21.8" = _EWIpaGka;
        "fabric-1.21.9" = _EWIpaGka;
        "fabric-1.21.10" = _EWIpaGka;
        "fabric-1.21.11" = _EWIpaGka;
        "fabric-26.1" = _EWIpaGka;
        "fabric-26.1.1" = _EWIpaGka;
        "fabric-26.1.2" = _EWIpaGka;
        "fabric-26.2" = _EWIpaGka;
        "fabric-26.3-snapshot-1" = _EWIpaGka;
        "fabric-26.3-snapshot-2" = _EWIpaGka;
        "fabric-26.3-snapshot-3" = _EWIpaGka;
        "fabric-26.3-snapshot-4" = _EWIpaGka;
        "fabric-26.3-snapshot-5" = _EWIpaGka;
        "fabric-26.3-snapshot-6" = _EWIpaGka;
        "fabric-26.3-snapshot-7" = _EWIpaGka;
        "fabric-26.3-snapshot-8" = _EWIpaGka;
        "fabric-26.3-snapshot-9" = _EWIpaGka;
        "fabric-26.3-snapshot-10" = _EWIpaGka;
        "fabric-26.3-pre-1" = _EWIpaGka;
        "fabric-23w03a" = _otedEDPB;
        "fabric-23w04a" = _otedEDPB;
        "fabric-23w05a" = _otedEDPB;
        "fabric-23w12a" = _otedEDPB;
        "fabric-23w13a" = _otedEDPB;
        "fabric-23w13a_or_b" = _otedEDPB;
        "fabric-23w14a" = _otedEDPB;
        "fabric-23w16a" = _otedEDPB;
        "fabric-23w17a" = _otedEDPB;
        "fabric-23w31a" = _otedEDPB;
        "fabric-23w32a" = _otedEDPB;
        "fabric-23w33a" = _otedEDPB;
        "fabric-23w35a" = _otedEDPB;
        "fabric-1.20.2-pre1" = _otedEDPB;
        "fabric-23w40a" = _otedEDPB;
        "fabric-23w41a" = _otedEDPB;
        "fabric-23w42a" = _otedEDPB;
        "fabric-23w43a" = _otedEDPB;
        "fabric-23w43b" = _otedEDPB;
        "fabric-23w44a" = _otedEDPB;
        "fabric-23w45a" = _otedEDPB;
        "fabric-23w46a" = _otedEDPB;
        "fabric-1.20.3-pre1" = _otedEDPB;
        "fabric-1.20.3-pre2" = _otedEDPB;
        "fabric-1.20.3-pre3" = _otedEDPB;
        "fabric-1.20.3-pre4" = _otedEDPB;
        "forge-1.15" = _2esMfqkO;
        "forge-1.15.1" = _2esMfqkO;
        "forge-1.15.2" = _2esMfqkO;
        "forge-1.16" = _otedEDPB;
        "forge-1.16.1" = _otedEDPB;
        "forge-1.16.2" = _otedEDPB;
        "forge-1.16.3" = _otedEDPB;
        "forge-1.16.4" = _otedEDPB;
        "forge-1.16.5" = _otedEDPB;
        "forge-1.17" = _otedEDPB;
        "forge-1.17.1" = _otedEDPB;
        "forge-1.18" = _otedEDPB;
        "forge-1.18.1" = _otedEDPB;
        "forge-1.18.2" = _otedEDPB;
        "forge-1.19" = _otedEDPB;
        "forge-1.19.1" = _otedEDPB;
        "forge-1.19.2" = _otedEDPB;
        "forge-1.19.3" = _otedEDPB;
        "forge-1.19.4" = _otedEDPB;
        "forge-1.20" = _otedEDPB;
        "forge-1.20.1" = _otedEDPB;
        "forge-1.20.2" = _otedEDPB;
        "forge-1.20.3" = _otedEDPB;
        "forge-1.20.4" = _otedEDPB;
        ...
        "forge-1.21.5" = _EWIpaGka;
        "forge-1.21.6" = _EWIpaGka;
        "forge-1.21.7" = _EWIpaGka;
        "forge-1.21.8" = _EWIpaGka;
        "forge-1.21.9" = _EWIpaGka;
        "forge-1.21.10" = _EWIpaGka;
        "forge-1.21.11" = _EWIpaGka;
        "forge-26.1" = _EWIpaGka;
        "forge-26.1.1" = _EWIpaGka;
        "forge-26.1.2" = _EWIpaGka;
        "forge-26.2" = _EWIpaGka;
        "forge-26.3-snapshot-1" = _EWIpaGka;
        "forge-26.3-snapshot-2" = _EWIpaGka;
        "forge-26.3-snapshot-3" = _EWIpaGka;
        "forge-26.3-snapshot-4" = _EWIpaGka;
        "forge-26.3-snapshot-5" = _EWIpaGka;
        "forge-26.3-snapshot-6" = _EWIpaGka;
        "forge-26.3-snapshot-7" = _EWIpaGka;
        "forge-26.3-snapshot-8" = _EWIpaGka;
        "forge-26.3-snapshot-9" = _EWIpaGka;
        "forge-26.3-snapshot-10" = _EWIpaGka;
        "forge-26.3-pre-1" = _EWIpaGka;
        "forge-23w03a" = _otedEDPB;
        "forge-23w04a" = _otedEDPB;
        "forge-23w05a" = _otedEDPB;
        "forge-23w12a" = _otedEDPB;
        "forge-23w13a" = _otedEDPB;
        "forge-23w13a_or_b" = _otedEDPB;
        "forge-23w14a" = _otedEDPB;
        "forge-23w16a" = _otedEDPB;
        "forge-23w17a" = _otedEDPB;
        "forge-23w31a" = _otedEDPB;
        "forge-23w32a" = _otedEDPB;
        "forge-23w33a" = _otedEDPB;
        "forge-23w35a" = _otedEDPB;
        "forge-1.20.2-pre1" = _otedEDPB;
        "forge-23w40a" = _otedEDPB;
        "forge-23w41a" = _otedEDPB;
        "forge-23w42a" = _otedEDPB;
        "forge-23w43a" = _otedEDPB;
        "forge-23w43b" = _otedEDPB;
        "forge-23w44a" = _otedEDPB;
        "forge-23w45a" = _otedEDPB;
        "forge-23w46a" = _otedEDPB;
        "forge-1.20.3-pre1" = _otedEDPB;
        "forge-1.20.3-pre2" = _otedEDPB;
        "forge-1.20.3-pre3" = _otedEDPB;
        "forge-1.20.3-pre4" = _otedEDPB;
        "quilt-1.15" = _2esMfqkO;
        "quilt-1.15.1" = _2esMfqkO;
        "quilt-1.15.2" = _2esMfqkO;
        "quilt-1.16" = _otedEDPB;
        "quilt-1.16.1" = _otedEDPB;
        "quilt-1.16.2" = _otedEDPB;
        "quilt-1.16.3" = _otedEDPB;
        "quilt-1.16.4" = _otedEDPB;
        "quilt-1.16.5" = _otedEDPB;
        "quilt-1.17" = _otedEDPB;
        "quilt-1.17.1" = _otedEDPB;
        "quilt-1.18" = _otedEDPB;
        "quilt-1.18.1" = _otedEDPB;
        "quilt-1.18.2" = _otedEDPB;
        "quilt-1.19" = _otedEDPB;
        "quilt-1.19.1" = _otedEDPB;
        "quilt-1.19.2" = _otedEDPB;
        "quilt-1.19.3" = _otedEDPB;
        "quilt-1.19.4" = _otedEDPB;
        "quilt-1.20" = _otedEDPB;
        "quilt-1.20.1" = _otedEDPB;
        "quilt-1.20.2" = _otedEDPB;
        "quilt-1.20.3" = _otedEDPB;
        "quilt-1.20.4" = _otedEDPB;
        ...
        "quilt-1.21.5" = _EWIpaGka;
        "quilt-1.21.6" = _EWIpaGka;
        "quilt-1.21.7" = _EWIpaGka;
        "quilt-1.21.8" = _EWIpaGka;
        "quilt-1.21.9" = _EWIpaGka;
        "quilt-1.21.10" = _EWIpaGka;
        "quilt-1.21.11" = _EWIpaGka;
        "quilt-26.1" = _EWIpaGka;
        "quilt-26.1.1" = _EWIpaGka;
        "quilt-26.1.2" = _EWIpaGka;
        "quilt-26.2" = _EWIpaGka;
        "quilt-26.3-snapshot-1" = _EWIpaGka;
        "quilt-26.3-snapshot-2" = _EWIpaGka;
        "quilt-26.3-snapshot-3" = _EWIpaGka;
        "quilt-26.3-snapshot-4" = _EWIpaGka;
        "quilt-26.3-snapshot-5" = _EWIpaGka;
        "quilt-26.3-snapshot-6" = _EWIpaGka;
        "quilt-26.3-snapshot-7" = _EWIpaGka;
        "quilt-26.3-snapshot-8" = _EWIpaGka;
        "quilt-26.3-snapshot-9" = _EWIpaGka;
        "quilt-26.3-snapshot-10" = _EWIpaGka;
        "quilt-26.3-pre-1" = _EWIpaGka;
        "quilt-23w03a" = _otedEDPB;
        "quilt-23w04a" = _otedEDPB;
        "quilt-23w05a" = _otedEDPB;
        "quilt-23w12a" = _otedEDPB;
        "quilt-23w13a" = _otedEDPB;
        "quilt-23w13a_or_b" = _otedEDPB;
        "quilt-23w14a" = _otedEDPB;
        "quilt-23w16a" = _otedEDPB;
        "quilt-23w17a" = _otedEDPB;
        "quilt-23w31a" = _otedEDPB;
        "quilt-23w32a" = _otedEDPB;
        "quilt-23w33a" = _otedEDPB;
        "quilt-23w35a" = _otedEDPB;
        "quilt-1.20.2-pre1" = _otedEDPB;
        "quilt-23w40a" = _otedEDPB;
        "quilt-23w41a" = _otedEDPB;
        "quilt-23w42a" = _otedEDPB;
        "quilt-23w43a" = _otedEDPB;
        "quilt-23w43b" = _otedEDPB;
        "quilt-23w44a" = _otedEDPB;
        "quilt-23w45a" = _otedEDPB;
        "quilt-23w46a" = _otedEDPB;
        "quilt-1.20.3-pre1" = _otedEDPB;
        "quilt-1.20.3-pre2" = _otedEDPB;
        "quilt-1.20.3-pre3" = _otedEDPB;
        "quilt-1.20.3-pre4" = _otedEDPB;
        "neoforge-1.15" = _2esMfqkO;
        "neoforge-1.15.1" = _2esMfqkO;
        "neoforge-1.15.2" = _2esMfqkO;
        "neoforge-1.16" = _otedEDPB;
        "neoforge-1.16.1" = _otedEDPB;
        "neoforge-1.16.2" = _otedEDPB;
        "neoforge-1.16.3" = _otedEDPB;
        "neoforge-1.16.4" = _otedEDPB;
        "neoforge-1.16.5" = _otedEDPB;
        "neoforge-1.17" = _otedEDPB;
        "neoforge-1.17.1" = _otedEDPB;
        "neoforge-1.18" = _otedEDPB;
        "neoforge-1.18.1" = _otedEDPB;
        "neoforge-1.18.2" = _otedEDPB;
        "neoforge-1.19" = _otedEDPB;
        "neoforge-1.19.1" = _otedEDPB;
        "neoforge-1.19.2" = _otedEDPB;
        "neoforge-1.19.3" = _otedEDPB;
        "neoforge-1.19.4" = _otedEDPB;
        "neoforge-1.20" = _otedEDPB;
        "neoforge-1.20.1" = _otedEDPB;
        "neoforge-1.20.2" = _otedEDPB;
        "neoforge-1.20.3" = _otedEDPB;
        "neoforge-1.20.4" = _otedEDPB;
        ...
        "neoforge-1.21.5" = _EWIpaGka;
        "neoforge-1.21.6" = _EWIpaGka;
        "neoforge-1.21.7" = _EWIpaGka;
        "neoforge-1.21.8" = _EWIpaGka;
        "neoforge-1.21.9" = _EWIpaGka;
        "neoforge-1.21.10" = _EWIpaGka;
        "neoforge-1.21.11" = _EWIpaGka;
        "neoforge-26.1" = _EWIpaGka;
        "neoforge-26.1.1" = _EWIpaGka;
        "neoforge-26.1.2" = _EWIpaGka;
        "neoforge-26.2" = _EWIpaGka;
        "neoforge-26.3-snapshot-1" = _EWIpaGka;
        "neoforge-26.3-snapshot-2" = _EWIpaGka;
        "neoforge-26.3-snapshot-3" = _EWIpaGka;
        "neoforge-26.3-snapshot-4" = _EWIpaGka;
        "neoforge-26.3-snapshot-5" = _EWIpaGka;
        "neoforge-26.3-snapshot-6" = _EWIpaGka;
        "neoforge-26.3-snapshot-7" = _EWIpaGka;
        "neoforge-26.3-snapshot-8" = _EWIpaGka;
        "neoforge-26.3-snapshot-9" = _EWIpaGka;
        "neoforge-26.3-snapshot-10" = _EWIpaGka;
        "neoforge-26.3-pre-1" = _EWIpaGka;
        "neoforge-23w03a" = _otedEDPB;
        "neoforge-23w04a" = _otedEDPB;
        "neoforge-23w05a" = _otedEDPB;
        "neoforge-23w12a" = _otedEDPB;
        "neoforge-23w13a" = _otedEDPB;
        "neoforge-23w13a_or_b" = _otedEDPB;
        "neoforge-23w14a" = _otedEDPB;
        "neoforge-23w16a" = _otedEDPB;
        "neoforge-23w17a" = _otedEDPB;
        "neoforge-23w31a" = _otedEDPB;
        "neoforge-23w32a" = _otedEDPB;
        "neoforge-23w33a" = _otedEDPB;
        "neoforge-23w35a" = _otedEDPB;
        "neoforge-1.20.2-pre1" = _otedEDPB;
        "neoforge-23w40a" = _otedEDPB;
        "neoforge-23w41a" = _otedEDPB;
        "neoforge-23w42a" = _otedEDPB;
        "neoforge-23w43a" = _otedEDPB;
        "neoforge-23w43b" = _otedEDPB;
        "neoforge-23w44a" = _otedEDPB;
        "neoforge-23w45a" = _otedEDPB;
        "neoforge-23w46a" = _otedEDPB;
        "neoforge-1.20.3-pre1" = _otedEDPB;
        "neoforge-1.20.3-pre2" = _otedEDPB;
        "neoforge-1.20.3-pre3" = _otedEDPB;
        "neoforge-1.20.3-pre4" = _otedEDPB;
        "pkg-0.4" = _MnekBwlC;
        "pkg-0.4+mod" = _cWv1yVzi;
        "pkg-0.4.1" = _NMnJGpQJ;
        "pkg-0.4.1+mod" = _3ziVeby6;
        "pkg-1.0.0" = _15BYeB8y;
        "pkg-1.0.0+mod" = _hpQU64Mu;
        "pkg-1.1.0" = _m2FV2n19;
        "pkg-1.1.0+mod" = _hW6sVVEz;
        "pkg-1.1.1" = _lWaYibnS;
        "pkg-1.1.1+mod" = _ruc1zT2h;
        "pkg-1.2.0" = _RxaETmkO;
        "pkg-1.2.0+mod" = _w2W5hmIj;
        "pkg-1.2.1" = _9KhJKOpi;
        "pkg-1.2.1+mod" = _r8SENRzb;
        "pkg-1.2.2" = _ZWY0AaG5;
        "pkg-1.2.2+mod" = _Lcqkh78p;
        "pkg-1.2.3" = _SH8GnkL1;
        "pkg-1.2.3+mod" = _G2mB1cLu;
        "pkg-1.2.4" = _Mh9Jbuwo;
        "pkg-1.2.4+mod" = _2esMfqkO;
        "pkg-1.3.0" = _3Ln92sIu;
        "pkg-1.3.0+mod" = _MyJleUrW;
        "pkg-1.3.1" = _fVYATg5q;
        "pkg-1.3.1+mod" = _5pKQh6Yd;
        "pkg-1.3.2" = _UmX7YzFs;
        "pkg-1.3.2+mod" = _nLZvsWQk;
        "pkg-1.3.3" = _KDPv5PF1;
        "pkg-1.3.3+mod" = _Q1tpmRlg;
        "pkg-1.3.4" = _2ZFGFXJ6;
        "pkg-1.3.4+mod" = _U6OHX9vO;
        "pkg-1.3.5" = _glE3fPyZ;
        "pkg-1.3.5+mod" = _fyQHZFbE;
        "pkg-1.4.0" = _vJvFUSIA;
        "pkg-1.4.0+mod" = _qmQPccgK;
        "pkg-1.4.1" = _boe29gCJ;
        "pkg-1.4.1+mod" = _k6PNGk3r;
        "pkg-1.4.2" = _VH45K4mx;
        "pkg-1.4.2+mod" = _2UUTHSVC;
        "pkg-1.4.3" = _dz7thYtE;
        "pkg-1.4.3+mod" = _HFJ03rn0;
        "pkg-1.4.4" = _o5rOhlWf;
        "pkg-1.4.4+mod" = _coN5aq9a;
        "pkg-1.4.5" = _KbUkMFpP;
        "pkg-1.4.5+mod" = _PA2CAv99;
        "pkg-1.4.6" = _k3oy8FhY;
        "pkg-1.4.6+mod" = _yxJfXUAi;
        "pkg-1.5.0" = _fSs6GYqm;
        "pkg-1.5.0+mod" = _HESK4PmO;
        "pkg-1.5.1" = _1Izn8egX;
        "pkg-1.5.1+mod" = _9s5GLJ4t;
        "pkg-1.5.2" = _y7X82ZMb;
        "pkg-1.5.2+mod" = _w7ynEAkh;
        "pkg-1.6.0" = _5KF3c1RZ;
        "pkg-1.6.0+mod" = _FVnzT2qu;
        "pkg-1.6.1" = _Da3cYKC8;
        "pkg-1.6.1+mod" = _s5lXCvvy;
        "pkg-1.7.0" = _4TIoyJsl;
        "pkg-1.7.0+mod" = _gadtePSV;
        "pkg-1.7.1" = _15NnVgh4;
        "pkg-1.7.1+mod" = _xdfN6Y52;
        "pkg-1.7.2" = _vpQB7DjE;
        "pkg-1.7.2+mod" = _r5kU0J8a;
        "pkg-1.7.3" = _soz9eUa2;
        "pkg-1.7.3+mod" = _Exrd8myQ;
        "pkg-1.7.4" = _sUw3oxou;
        "pkg-1.7.4+mod" = _hPGmfM6U;
        "pkg-1.7.5" = _bS7m7V2B;
        "pkg-1.7.5+mod" = _Ep7f9Ml1;
        "pkg-1.7.6" = _Qdrhfmxh;
        "pkg-1.7.6+mod" = _t3QtNWrX;
        "pkg-1.7.7" = _o1lHPKTC;
        "pkg-1.7.7+mod" = _os1gM9Z6;
        "pkg-1.7.8" = _5nvBINk0;
        "pkg-1.7.8+mod" = _DZAvvxXl;
        "pkg-1.7.9" = _F8wp3MUy;
        "pkg-1.7.9+mod" = _67dnNYOD;
        "pkg-1.7.10" = _J9z1tI1G;
        "pkg-1.7.10+mod" = _QVOa2UTa;
        "pkg-1.8.0" = _2qpgyiMe;
        "pkg-1.8.0+mod" = _jSawkkmy;
        "pkg-1.8.1" = _y28jl6nR;
        "pkg-1.8.1+mod" = _IbGFw7X6;
        "pkg-1.8.2" = _ebaBoh1e;
        "pkg-1.8.2+mod" = _pUDNFdB5;
        "pkg-1.8.3" = _zXWgt5bH;
        "pkg-1.8.3+mod" = _ltbh0VE6;
        "pkg-1.8.4" = _8sLGRCP2;
        "pkg-1.8.4+mod" = _ITUyvlmo;
        "pkg-1.8.5" = _BCxbK99j;
        "pkg-1.8.5+mod" = _FK9Ga4nh;
        "pkg-1.8.6" = _T1b5ROgI;
        "pkg-1.8.6+mod" = _vaWbUXqh;
        "pkg-1.8.7" = _epBdHyxx;
        "pkg-1.8.7+mod" = _EWIpaGka;
        "pkg-1.8.7+backport_(!incomplete)" = _i5fglCti;
        "pkg-1.8.7+backport+mod_(!incomplete)" = _otedEDPB;
        "default" = _otedEDPB;
    });
