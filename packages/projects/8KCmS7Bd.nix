...
let
    versions = (let
        ...
        _HdM6xlQf = {
            "id" = "HdM6xlQf";
            "file" = "iconexporter-26.1.2-fabric-1.4.2-213.jar";
            "hash" = "sha512-2YGk8eYGIGrK10TOxYMKB3aIV1tNSz6QAqayKmZ6oJokdGi15mBQpzVYTQqP6sbwitAswUyfg7Gl+2jJ87Insg==";
        };
        _yfjX3L6B = {
            "id" = "yfjX3L6B";
            "file" = "iconexporter-26.1.2-forge-1.4.2-213.jar";
            "hash" = "sha512-7g+v4l+Qag1dbzIMVGIH/E0btnXKKcLY1VI6wdjtEw9jVSDRCoaTcMdA6pPH4RyjjmpAabhTwUWwvoz3ItzGmA==";
        };
        _AbtpaV7B = {
            "id" = "AbtpaV7B";
            "file" = "iconexporter-26.1.2-neoforge-1.4.2-213.jar";
            "hash" = "sha512-jZ57pNkfSMuIFCYrpOUBKmmlWnOx1ZNoydC/qwaC7RmF4VUqRQCH1lP0SJWVrWWEoSw0sZT83jpM/sobMzaABg==";
        };
        _K4MQYtqE = {
            "id" = "K4MQYtqE";
            "file" = "iconexporter-26.2-fabric-1.4.2-214.jar";
            "hash" = "sha512-1HQNi69TAf2Hyde1QzKXk4gPmhi72KcwsXvWeHX74bhaXx89ylN2HaXHaXFYSebqcFtR6Z2fb53EeT5FCGB/RQ==";
        };
        _OBnhNtB3 = {
            "id" = "OBnhNtB3";
            "file" = "iconexporter-26.2-forge-1.4.2-214.jar";
            "hash" = "sha512-VfNL9skEVD1jyGTRuvaaQHUqLNohQeG8nOtp81F+XVTblKm9Cs3Yh+JD0Cqe3TeXSnVuk5QLMIDhcn8UkK253g==";
        };
        _WbvT5amz = {
            "id" = "WbvT5amz";
            "file" = "iconexporter-26.2-neoforge-1.4.2-214.jar";
            "hash" = "sha512-lyQTOByd6UThutYWlP5fpJ+sOoGZ2RMYwNxlx41jVo0tNezN1sWUeii2q63tAJp+DaM94jirUc38E47BKfm/Jg==";
        };
        _EN2nrRvf = {
            "id" = "EN2nrRvf";
            "file" = "iconexporter-1.21.1-forge-1.4.2.jar";
            "hash" = "sha512-4CZ6eBPZrl2gHSKmO/ohgtkaXb1jUzXgAjZWJHIuJIdgW4GpNlsA/J2VNYHljXjBwvPoeywTyRu9mwpAFDygKQ==";
        };
        _7vRbGE4L = {
            "id" = "7vRbGE4L";
            "file" = "iconexporter-1.21.1-neoforge-1.4.2.jar";
            "hash" = "sha512-hgZH4mjvSg2BtOiXzl6o7dPlVlwvfgUYhhPW3xwm/oaUzsFF5h5kNdc3DS2dYxTrm0BJTwCzk1o2EHSM2MWQ8Q==";
        };
        _kTyN3V2u = {
            "id" = "kTyN3V2u";
            "file" = "iconexporter-1.21.1-fabric-1.4.2.jar";
            "hash" = "sha512-q/9p9jkolt7hTojL8NlHOlTkXXB8ZiUKE/wj27MH4xaRupjSm7U8/1uLyP6oi6CAToCM/kT42RY6eSA8n9k5hA==";
        };
        _RcCdC8gA = {
            "id" = "RcCdC8gA";
            "file" = "iconexporter-1.21.1-forge-1.4.2-220.jar";
            "hash" = "sha512-aLzYPbL2oHhfW3wvzBvrh1WtFv5o/78uukyx/COz/7WUIf1MxWoK1a8iLLMmDVdY4NeLTe7d0Z32pOUcQvKkMA==";
        };
        _bbZzqPdK = {
            "id" = "bbZzqPdK";
            "file" = "iconexporter-1.21.1-fabric-1.4.2-220.jar";
            "hash" = "sha512-jWuQD/QE7zy5JWrqFEASI6WT2ggUJfSUZRiHJ/RUcklUBuUiceWotylLeg+MA5X55cbeCHwyOl74XuXKedhHEg==";
        };
        _Yx4hI5Ze = {
            "id" = "Yx4hI5Ze";
            "file" = "iconexporter-1.21.1-neoforge-1.4.2-220.jar";
            "hash" = "sha512-RWqXpXD9wx3h1PUuK3yzqf0gmvQVmcp7FlfUDsQMu2+BKvpL2f6IgKA6vusxo4UCsWA8HL4Zi5nYzD+76+SCDw==";
        };
        _QOYNEzi2 = {
            "id" = "QOYNEzi2";
            "file" = "iconexporter-26.1.2-forge-1.4.2-221.jar";
            "hash" = "sha512-VnyghKpofZRPXKk1wWUmYLmsH1CMfB8HhYxHZHd+msZf1972NVjmDDfY1n8j3PAVK1O2rUgM6498N1OiXOkBGA==";
        };
        _z5b43HiY = {
            "id" = "z5b43HiY";
            "file" = "iconexporter-26.1.2-fabric-1.4.2-221.jar";
            "hash" = "sha512-QzefQ/BZD7d/42bn27WyLvXkAdaCRAD6s24cGbWbwkmgiLbZObyhSeVgDvOs2ider0+6NOI6+vI0D7BjU4i2mQ==";
        };
        _KQZRQXbt = {
            "id" = "KQZRQXbt";
            "file" = "iconexporter-26.1.2-neoforge-1.4.2-221.jar";
            "hash" = "sha512-xu0egrrwcwoIAlmdLbZaca0mEJPu5rSsj3N3HVj/5begZ6x/sDbC3ZkWPqbMr/M20ttSjJPf0URBi9JBd7zIsQ==";
        };
        _LdJNJuNf = {
            "id" = "LdJNJuNf";
            "file" = "iconexporter-26.2-fabric-1.4.2-222.jar";
            "hash" = "sha512-WjgA3tGi+fFn0gVFcWhvN4wFOlNb0US5mkjuo1aLqMoBMMeRK/qa7uy07ymh4HfWmbrmTTvj9T0pnhg3391bMw==";
        };
        _LfEzBLir = {
            "id" = "LfEzBLir";
            "file" = "iconexporter-26.2-forge-1.4.2-222.jar";
            "hash" = "sha512-lDIEGRniatOuVHui28P/TvfHKbCecPuVjpfXwxbnA2n/p9VevHik1PjAMbs27IdaMk+n8Se5TVlKpJfjbze6gg==";
        };
        _pyhqFMsn = {
            "id" = "pyhqFMsn";
            "file" = "iconexporter-26.2-neoforge-1.4.2-222.jar";
            "hash" = "sha512-xsPGdBPjRfACu77NqauIatT9wQj3nINDZQePFbpZf+MFoL0DwDV7LwsBhaZQ1UqdatvBp2f7+95UT6/Tx63esA==";
        };
        _kp2xOOI6 = {
            "id" = "kp2xOOI6";
            "file" = "iconexporter-26.1.2-fabric-1.4.2-223.jar";
            "hash" = "sha512-XsCMMFLBXz3r0TLOh/5AX36CCvgNbu7iQ/L5pUVfOdW096JgWwUOOXc/18lcMQEnsJC90Eh7qe7zlixb8ib80Q==";
        };
        _rH9OoIyG = {
            "id" = "rH9OoIyG";
            "file" = "iconexporter-26.1.2-forge-1.4.2-223.jar";
            "hash" = "sha512-l6M7dQnyDultRo1si2ZaYIHWjR+uPdSj5qPIwL7kuEyajSIL8eIEpIBG79WCe/OrnSAic1iSgOhaEEjXzDdLbA==";
        };
        _7bkBSzwG = {
            "id" = "7bkBSzwG";
    ...
    in {
        ...
        "pkg-1.19-1.2.4" = _StmCKrrt;
        "pkg-1.19.2-1.2.4" = _wfNUN2we;
        "pkg-1.19.3-1.2.4" = _lhLzmoYO;
        "pkg-1.19.4-1.2.4" = _1HA2E0v1;
        "pkg-1.20.1-1.2.4" = _pNEeD58A;
        "pkg-1.18.2-1.2.5" = _P31kuepZ;
        "pkg-1.19.2-1.2.5" = _UBIIZJ5B;
        "pkg-1.20.1-1.2.5" = _xfNlYU3s;
        "pkg-1.19.2-1.2.6" = _2OoWDvlS;
        "pkg-1.20.1-1.3.0" = _k3Il2YuC;
        "pkg-1.20.4-1.2.5" = _3iYu4slB;
        "pkg-1.21-1.2.5" = _6ceEbU2d;
        "pkg-1.21.1-1.3.1" = _QLIVf0TS;
        "pkg-1.21.1-1.3.1-109" = _51fPNgYm;
        "pkg-1.21.1-1.3.1-110" = _G1RWy1HZ;
        "pkg-1.21.1-1.3.1-111" = _GqjxzBSK;
        "pkg-1.21.1-1.3.1-112" = _SdJAdAQb;
        "pkg-1.21.1-1.3.1-113" = _88TZvII0;
        "pkg-1.21.1-1.3.1-114" = _p2m7kIua;
        "pkg-1.21.1-1.3.1-116" = _XUuzs2S6;
        "pkg-1.21.1-1.3.1-118" = _1t0IoZ5c;
        "pkg-1.21.1-1.3.1-120" = _axfS9uTY;
        "pkg-1.21.1-1.3.1-123" = _FEDYWauO;
        "pkg-1.21.1-1.3.1-125" = _nJmAGlMg;
        "pkg-1.21.4-1.3.1-126" = _iPVh2q72;
        "pkg-1.21.1-1.3.1-127" = _DBACliMs;
        "pkg-1.21.1-1.3.1-129" = _gg08Yz8D;
        "pkg-1.21.4-1.3.1-131" = _X99XZdK6;
        "pkg-1.21.1-1.3.1-134" = _4qS7R14A;
        "pkg-1.21.4-1.3.1-135" = _oJqaOyCQ;
        "pkg-1.21.4-1.3.1-136" = _I167f2dh;
        "pkg-1.21.7-1.3.1-137" = _h0rQ5aUk;
        "pkg-1.21.1-1.3.1-138" = _95ltVf1M;
        "pkg-1.21.8-1.3.1-139" = _vsJOiBvK;
        "pkg-1.21.1-1.3.1-140" = _tFxF4E62;
        "pkg-1.21.8-1.3.1-141" = _ldDaSUfl;
        "pkg-1.21.1-1.3.1-142" = _hK65GOmf;
        "pkg-1.21.1-1.3.1-143" = _JavaJg2b;
        "pkg-1.20.1-1.4.0" = _Erdld4Aa;
        "pkg-1.21.1-1.4.0" = _KnLfmTrd;
        "pkg-1.21.8-1.3.1-153" = _N0mbBzL2;
        "pkg-1.21.1-1.4.0-155" = _INmRvdJV;
        "pkg-1.21.8-1.3.1-156" = _ssBdu0ib;
        "pkg-1.21.1-1.4.0-158" = _yxuNsXHX;
        "pkg-1.21.8-1.3.1-159" = _9jyg2F2g;
        "pkg-1.21.10-1.3.1-160" = _WO9HCKBM;
        "pkg-1.21.1-1.4.0-162" = _x46CawU0;
        "pkg-1.21.10-1.3.1-163" = _hOgfRqyB;
        "pkg-1.21.10-1.3.1-164" = _9LJOnR5H;
        "pkg-1.21.11-1.3.1-165" = _iZPIougc;
        "pkg-1.21.11-1.3.1-166" = _KO4hJTwm;
        "pkg-1.21.1-1.4.0-168" = _bjAloReE;
        "pkg-1.21.1-1.4.0-169" = _z4yh19Zz;
        "pkg-1.21.1-1.4.0-172" = _bX02RxwP;
        "pkg-1.21.11-1.3.1-173" = _V4sjaMIy;
        "pkg-1.21.1-1.4.0-174" = _AOgDj1pu;
        "pkg-1.21.1-1.4.0-176" = _1zu8ssQM;
        "pkg-1.21.11-1.3.1-177" = _Z6t3ylHZ;
        "pkg-1.21.11-1.3.1-178" = _BoWEm25G;
        "pkg-1.21.1-1.4.0-179" = _2oKGsqYY;
        "pkg-1.21.11-1.3.1-180" = _Ji99Q2w2;
        "pkg-1.21.11-1.3.1-181" = _AXWTRJ4l;
        "pkg-26.1.1-1.3.1-182" = _8lfGvXJq;
        "pkg-26.1.1-1.3.1-183" = _7DrbsKCj;
        "pkg-26.1.1-1.3.1-184" = _xo9hywfV;
        "pkg-26.1.1-1.3.1-190" = _zB1dustw;
        "pkg-26.1.1-1.3.1-191" = _OtyAHWoO;
        "pkg-26.1.1-1.4.0" = _B6GYvv8N;
        "pkg-26.1.1-1.4.0-195" = _vtMpS4zh;
        "pkg-26.1.2-1.4.1" = _38a9FVvE;
        "pkg-26.1.2-1.4.2" = _Twd7QfX9;
        "pkg-1.21.1-1.4.1" = _LBrjyRMQ;
        "pkg-26.1.2-1.4.2-205" = _4kQIGBaL;
        "pkg-26.1.2-1.4.2-206" = _bXAFoRsH;
        "pkg-26.2-1.4.2-207" = _atTFSDhA;
        "pkg-26.2-1.4.2-208" = _ePIjmnak;
        "pkg-1.21.1-1.4.1-210" = _GfIydKTJ;
        "pkg-26.1.2-1.4.2-211" = _V5ZcT9kY;
        "pkg-26.2-1.4.2-212" = _OwRkxsti;
        "pkg-26.1.2-1.4.2-213" = _AbtpaV7B;
        "pkg-26.2-1.4.2-214" = _WbvT5amz;
        "pkg-1.21.1-1.4.2" = _kTyN3V2u;
        "pkg-1.21.1-1.4.2-220" = _Yx4hI5Ze;
