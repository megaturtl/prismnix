...
let
    ...
    in {
        ...
        "pkg-1.0.0-fabric" = _mD8bX2b0;
        "pkg-1.0.0-forge" = _T2n6jzBn;
        "pkg-1.0.0-neoforge" = _N2X1ph6R;
        "pkg-1.0.1-forge" = _SNm2Mvo0;
        "pkg-1.0.1-fabric" = _dnO6Yb3B;
        "pkg-1.0.2-fabric" = _cAOeup0r;
        "pkg-1.0.2-forge" = _PHscmX12;
        "pkg-1.0.2-neoforge" = _AsiSEmeX;
        "pkg-1.0.1-neoforge" = _92bLhxeo;
        "pkg-1.0.3-1.21-neoforge" = _KJuKNBGd;
        "pkg-1.0.3-1.21-fabric" = _pI1Amp5J;
        "pkg-1.0.3-1.16+1.20-fabric" = _TvB3R6BP;
        "pkg-1.0.3-1.16+1.20-forge" = _isOvJaqH;
        "pkg-1.0.4-1.16+1.20-fabric" = _uvbBDa1p;
        "pkg-1.0.4-1.16+1.20-forge" = _1HinzvcF;
        "pkg-1.0.4-1.21-fabric" = _8XePHkHv;
        "pkg-1.0.4-1.21-neoforge" = _xeOlBFUd;
        "pkg-1.0.4-1.21.3-neoforge" = _C1GufITG;
        "pkg-1.0.4-1.21.3-fabric" = _3QrEdP73;
        "pkg-1.0.5-1.21-fabric" = _GaHut5Kf;
        "pkg-1.0.5-1.21-neoforge" = _sELat57Y;
        "pkg-1.0.5-1.21.5-neoforge" = _Rw2F7sgZ;
        "pkg-1.0.5-1.21.5-fabric" = _fwEKeXbZ;
        "pkg-1.0.5-1.21.3-neoforge" = _NnpisY6c;
        "pkg-1.0.5-1.21.3-fabric" = _qDxK0sST;
        "pkg-1.0.5-1.16+1.20-forge" = _c48wZPxQ;
        "pkg-1.0.5-1.16+1.20-fabric" = _1AaUS1nD;
        "pkg-1.0.5-1.20.1-fabric" = _5RYjQe5t;
        "pkg-1.0.5-1.20.1-forge" = _5fdLEhq1;
        "pkg-1.0.6-1.21.5-neoforge" = _YmQBNv0P;
        "pkg-1.0.6-1.21.5-fabric" = _3BeKWpyV;
        "pkg-1.0.6-1.21.3-fabric" = _XOkdy4pe;
        "pkg-1.0.6-1.21.3-neoforge" = _5tLQ94yC;
        "pkg-1.0.6-1.21-neoforge" = _dgmVaZnt;
        "pkg-1.0.6-1.21-fabric" = _yJWcX213;
        "pkg-1.0.6-1.20.1-fabric" = _RQ8ZKySk;
        "pkg-1.0.6-1.20.1-forge" = _pzJdM2l6;
        "pkg-1.0.6-1.16+1.19-fabric" = _Lppz4IGq;
        "pkg-1.0.6-1.16+1.19-forge" = _7YKO95w8;
        "pkg-1.0.7-1.21.5-fabric" = _T3MjgkXP;
        "pkg-1.0.7-1.21.5-neoforge" = _wvLHG6ut;
        "pkg-1.0.7-1.21.3-fabric" = _eAusVVVS;
        "pkg-1.0.7-1.21.3-neoforge" = _VSYmtwy2;
        "pkg-1.0.8-1.20.1-fabric" = _lxXZF3cO;
        "pkg-1.0.8-1.20.1-forge" = _aEayMqf2;
        "pkg-1.0.8-1.21.3-fabric" = _8yaB2jD6;
        "pkg-1.0.8-1.21.3-neoforge" = _wSkVynsI;
        "pkg-1.0.8-1.21.5-fabric" = _df8GGidT;
        "pkg-1.0.8-1.21.5-neoforge" = _AvKYMswZ;
        "pkg-1.0.8-1.16+1.19-fabric" = _sc8VPmdb;
        "pkg-1.0.8-1.16+1.19-forge" = _gV9SjvUt;
        "pkg-1.0.9-26.1-fabric" = _bpbvYIIK;
        "default" = _bpbvYIIK;
    });
