...
let
    versions = (let
        ...
        _MMZecuPQ = {
            "id" = "MMZecuPQ";
            "file" = "EnchantmentDescriptions-neoforge-MC26.1.2-26.1.2.6.jar";
            "hash" = "sha512-fnrUg0QIQKaARBPBL8Od3xvD9BI23UXGmPUT/xw1jeldd91AuvGZVdIisTqit6N347rso1Czv2zVuOpUKLIVwA==";
        };
        _AJzO4pYf = {
            "id" = "AJzO4pYf";
            "file" = "EnchantmentDescriptions-fabric-MC26.1.2-26.1.2.6.jar";
            "hash" = "sha512-R1kblq1Im+3SuzKb1N4JfAtamI5R5aX/ooYZZ0nVDsTMPQrM/NKtMwbTzD4AVKh7eduL1UQa/DYPMydo+uMW4Q==";
        };
        _CKyUV0Hj = {
            "id" = "CKyUV0Hj";
            "file" = "EnchantmentDescriptions-neoforge-MC26.2-26.2.0.2.jar";
            "hash" = "sha512-6IMw5ka/UMJ+Jx5j960ITSS/oT0/T1rtefFWtD5fLi/kOus1dUW9+T10vP0bb1LjqC2XEYPOE048txyGTSBPUg==";
        };
        _PTAK0HD2 = {
            "id" = "PTAK0HD2";
            "file" = "EnchantmentDescriptions-fabric-MC26.2-26.2.0.2.jar";
            "hash" = "sha512-lG9e/UWwNJQTN6tZIFBgTwnW7JRV71lEnKvD/nhuxag7PA//UOLIHG8j+KHn/dj7RL9l/dtbrlcXU7sTR3nMGw==";
        };
        _NBccO5gj = {
            "id" = "NBccO5gj";
            "file" = "enchdesc-fabric-1.21.1-21.1.11.jar";
            "hash" = "sha512-IFb36Btb+SViw5IY7Wt3mgCLBouSA1j2ibeFyAkkp7B5WqVPixzt/b+GwJwmDzqkir1+6/KaOW9kJwBpTFwfOg==";
        };
        _J8R9lskv = {
            "id" = "J8R9lskv";
            "file" = "enchdesc-forge-1.21.1-21.1.11.jar";
            "hash" = "sha512-ZD+9CMSjbKihRwJN598vZ+643dcHQ/ZeFdrWSJmHpDPYbTp/p/LQzWlIiUpZVILsw/9PQr+3cqRoH1B5iGjNpw==";
        };
        _IktklYWh = {
            "id" = "IktklYWh";
            "file" = "enchdesc-neoforge-1.21.1-21.1.11.jar";
            "hash" = "sha512-sS639f5GC4ZdVMI67gS7cupH/ZaB0pz0bZatZyy+jlu1y85bh7qvxpFGruRoxWfPbu7cQv7AgWn7Q5XDnvkiUg==";
        };
        _NvvMHtHw = {
            "id" = "NvvMHtHw";
            "file" = "enchdesc-fabric-1.21.11-21.11.2.jar";
            "hash" = "sha512-UANFH3NTRYQwUEoApaCdWnTHfDiDTuaWcguc4YBEdY0r7D1hiFdH52acbyvNzU/lZa0y9Bj7TgJK3pyNvmCX9g==";
        };
        _S9bk4YqE = {
            "id" = "S9bk4YqE";
    ...
    in {
        ...
        "fabric-1.21.11" = _NvvMHtHw;
        "fabric-26.1" = _AJzO4pYf;
        ...
        "neoforge-1.21.11" = _S9bk4YqE;
        "neoforge-26.1" = _MMZecuPQ;
        ...
        "pkg-1.1.8" = _SuJEl36V;
        "pkg-1.1.9" = _s03jOS7g;
        "pkg-1.1.10" = _Q2UNDkTx;
        "pkg-1.1.11" = _ybJXjauf;
        "pkg-1.1.12" = _gJmQFLux;
        "pkg-1.1.13" = _f4tqKNj6;
        "pkg-1.1.14" = _afvD3pyf;
        "pkg-1.1.15" = _qUEJlzny;
        "pkg-1.2.2" = _YeUH2n9E;
        "pkg-1.2.3" = _Y32Q98mt;
        "pkg-1.2.4" = _MTRnsmy2;
        "pkg-1.2.5" = _cFoB9U6m;
        "pkg-1.3.2" = _esOPZ9HX;
        "pkg-1.3.3" = _hlVbuX4k;
        "pkg-1.1.17" = _Soy4Ff8a;
        "pkg-1.2.6" = _KD05Z3BU;
        "pkg-1.3.4" = _ro5NXp7L;
        "pkg-1.2.7" = _Me4gBMtS;
        "pkg-1.3.5" = _umaYYh5q;
        "pkg-1.1.19" = _LRDJsK9V;
        "pkg-1.3.1" = _2WRSNroy;
        "pkg-1.3.6" = _hwWMrh8e;
        "pkg-1.3.7" = _oig4UEhd;
        "pkg-1.3.8" = _WlhgEXhY;
        ...
        "pkg-1.5.2" = _GdrnfJ7w;
        "pkg-1.5.4" = _3lyIql3T;
        "pkg-1.3.10" = _rZO6y9US;
        "pkg-1.3.11" = _7dbMODft;
        "pkg-2.0.1" = _DJWhbDWo;
        "pkg-1.3.12" = _nR4anJ0X;
        "pkg-2.0.2" = _58oLGTcw;
        "pkg-1.3.13" = _SGdkTZ0O;
        "pkg-2.0.3" = _VJPNOGag;
        "pkg-1.3.14" = _ZERNF0aL;
        "pkg-2.0.4" = _sPOazxnh;
        "pkg-1.1.20" = _XtD5InVd;
        "pkg-2.0.5" = _KOrEfgLQ;
        "pkg-2.0.6" = _CBWchJSF;
        "pkg-2.0.7" = _pseIp9s3;
        "pkg-2.0.8" = _gJyF8m7f;
        ...
        "pkg-3.0.8" = _t2i6noLU;
        "pkg-3.0.9" = _XxrIMyFh;
        "pkg-3.0.10" = _DInA7ZoN;
        "pkg-3.0.11" = _mT2YIkP4;
        "pkg-7.0.9" = _3QtXij64;
        "pkg-7.0.10" = _DSesr2AB;
        "pkg-7.0.11" = _b3GkExvS;
        "pkg-7.0.12" = _VGrBf3Iz;
        "pkg-7.0.13" = _yqqOtKKW;
        "pkg-3.0.12" = _2cBeudkj;
        "pkg-7.0.14" = _UMzHgXZP;
        "pkg-4.0.1" = _cURpiLFL;
        "pkg-7.0.15" = _N0dVE8pP;
        "pkg-7.0.16" = _K5CBlP42;
        "pkg-7.0.17" = _nHHpCAFF;
        "pkg-8.0.1" = _2DyNgO2n;
        "pkg-8.0.3" = _zvfyXSe9;
        "pkg-9.0.1" = _9lNV7FCK;
        "pkg-7.0.18" = _XSMJTnC9;
        "pkg-9.0.2" = _app1bQ2W;
        "pkg-9.0.3" = _T7GD8Mq9;
        "pkg-8.17.1" = _dd8NAEDa;
        "pkg-9.0.4" = _DKYlbVmt;
        "pkg-8.17.2" = _4kG0jhon;
        "pkg-9.0.5" = _aON2YfIM;
        "pkg-9.0.7" = _pcXaXI9A;
        "pkg-9.0.8" = _3g7FEYUz;
        "pkg-9.0.9" = _1sjExGJb;
        "pkg-9.0.10" = _nZEba1jN;
        "pkg-9.0.11" = _G7wwhxyM;
        "pkg-9.0.12" = _1t7xXh6t;
        "pkg-9.0.13" = _P5PwkPIe;
        "pkg-10.0.2" = _W9JG6hyu;
        "pkg-7.0.19" = _eCkh04of;
        "pkg-11.0.3" = _rEXMCTfN;
        "pkg-11.0.4" = _FM0XOAJX;
        "pkg-8.17.3" = _H36HiwAs;
        "pkg-10.0.3" = _R7c9ZMkZ;
        "pkg-10.0.4" = _LU8bVJwY;
        "pkg-11.0.1" = _34k0FdXe;
        "pkg-11.0.2" = _DlXj4DBu;
        "pkg-7.1.20" = _cbxxs91S;
        "pkg-11.0.5" = _YH8a4eUj;
        "pkg-10.0.5" = _Koc1xxF1;
        "pkg-10.0.6" = _MKgAUxbS;
        "pkg-11.0.6" = _HQwTWfib;
        "pkg-11.0.7" = _3rXmbZl4;
        "pkg-11.0.8" = _aCPECd67;
        "pkg-11.1.9" = _sL4k09QT;
        "pkg-12.0.1" = _rMRUhDim;
        "pkg-12.0.2" = _CLkoV3DR;
        "pkg-10.0.7" = _ElNzKxEw;
        "pkg-12.0.3" = _70DKnLkT;
        "pkg-12.0.4" = _5YU6oyTn;
        "pkg-12.0.5" = _1kn0R7Wa;
        "pkg-10.0.8" = _Cu1YlHdN;
        "pkg-13.0.1" = _Vyq1Uveb;
        "pkg-13.0.2" = _1uvSbJRH;
        "pkg-13.0.3" = _GDuLtLaj;
        "pkg-10.0.9" = _o7UZoWy3;
        "pkg-13.0.4" = _fyrO4LG6;
        "pkg-13.0.5" = _qOXJhOUU;
        "pkg-13.0.6" = _YqGAibSe;
        "pkg-13.0.7" = _qSNc0NpY;
        "pkg-13.0.8" = _wmsK4WhV;
        "pkg-13.0.9" = _N16R2DVE;
        "pkg-10.0.10" = _CCSjAV3Y;
        "pkg-13.0.10" = _7ZqJt6JN;
        "pkg-13.0.11" = _EwKyYJht;
        "pkg-14.0.1" = _3Fw0xjuf;
        "pkg-13.0.12" = _u2jK5VJn;
        "pkg-13.0.13" = _FHPnvFdu;
        "pkg-10.0.11" = _ZFnJhKfC;
        "pkg-14.0.2" = _g9yVvNmR;
        "pkg-14.0.3" = _eGAu2V4T;
        "pkg-10.0.12" = _DE8PjvQJ;
        "pkg-13.0.14" = _Gw7efrux;
        "pkg-14.0.4" = _1FZsCCSr;
        "pkg-14.0.5" = _LcbweSFj;
        "pkg-14.0.6" = _GaEI4DhF;
        "pkg-14.0.7" = _yiInxmxY;
        "pkg-15.0.1" = _x54mQP4X;
        "pkg-15.0.2" = _8Wqy9vtq;
        "pkg-15.0.3" = _JfDot7AP;
        "pkg-16.0.1" = _FGOXfyqF;
        "pkg-17.0.1" = _iV0kJTSM;
        "pkg-17.0.2" = _PpjNXne5;
        "pkg-17.0.3" = _2kOpqSpn;
        "pkg-17.0.4" = _ZcjVyfLh;
        "pkg-17.0.5" = _QsJi6mwZ;
        "pkg-17.0.6" = _uAwWMkFv;
        "pkg-17.0.7" = _nkyiWnqQ;
        "pkg-17.0.8" = _IbpYYTw4;
        "pkg-18.0.1" = _rtavYJQ9;
        "pkg-18.0.2" = _yILwCqm7;
        "pkg-18.0.3" = _RmyQXTyQ;
        "pkg-17.0.9" = _mx2NdM4x;
        "pkg-18.0.5" = _cjXJB5eS;
        "pkg-17.0.10" = _O6UOhfpD;
        "pkg-17.0.11" = _UBwPr68i;
        "pkg-19.0.1" = _55ENFpMU;
        "pkg-19.0.2" = _p5NqqlTQ;
        "pkg-20.0.1" = _NGczokru;
        "pkg-17.0.12" = _DZvM2G0e;
        "pkg-17.0.13" = _H9lpjTvf;
        "pkg-18.0.6" = _49BrX6ZT;
        "pkg-18.0.7" = _8wGtuNga;
        "pkg-20.0.2" = _xbMlopMD;
        "pkg-17.0.14" = _jpf7NOlL;
        "pkg-20.0.3" = _yYRr8YuJ;
        "pkg-20.0.4" = _BvDK9nGq;
        "pkg-17.0.15" = _mqvC3H0Q;
        "pkg-17.0.16" = _Ndxl3lVQ;
        "pkg-20.1.7" = _qF9aIfV0;
        "pkg-17.1.18" = _G4P1MSAp;
        "pkg-21.1.1" = _Je49IIH3;
        "pkg-21.1.2" = _IzbZt8rE;
        "pkg-21.1.3" = _u66ExibB;
        "pkg-21.1.4" = _meXnktRL;
        "pkg-21.1.5" = _ev1Ql5aa;
        "pkg-17.1.19" = _nq9ce04C;
        "pkg-20.1.8" = _iJ5e2TBg;
        "pkg-21.1.6" = _sElvDVhw;
        "pkg-21.1.7" = _pNpo2TdS;
        "pkg-21.1.8" = _2J8rg8A0;
        "pkg-21.2.1" = _AurDsY2f;
        "pkg-21.3.1" = _Hf6UsyLZ;
        "pkg-21.5.1" = _BnJpG0o5;
        "pkg-21.4.1" = _5RwpkUHf;
        "pkg-21.6.1" = _aRUOyhNx;
        "pkg-21.7.1" = _EdyuJQFJ;
        "pkg-21.8.1" = _S23zkbXM;
        "pkg-21.1.9" = _zfAkJn0r;
        "pkg-21.10.1" = _7qVGs8W6;
        "pkg-21.9.2" = _cpajv569;
        "pkg-17.1.20" = _ADwLz4np;
        "pkg-21.10.2" = _kPVmbCOx;
        "pkg-21.11.1" = _IWiKbCr5;
        "pkg-17.1.21" = _YWWrhjUf;
        "pkg-26.1.2.1" = _qmDEL4fc;
        "pkg-26.1.2.2" = _FTiVZfb4;
        "pkg-26.1.2.3" = _ddSoHuZi;
        "pkg-21.1.10" = _OuJDPGSM;
        "pkg-26.1.2.4" = _k3wgDGNf;
        "pkg-26.1.2.5" = _6DNanjmN;
        "pkg-26.2.0.1" = _2khC341p;
        "pkg-26.1.2.6" = _AJzO4pYf;
