...
let
    ...
    in {
        ...
        "pkg-0.8.12" = _mj214UCa;
        "pkg-0.8.13" = _tVmGgc04;
        "pkg-0.8.14" = _pXfmvzA9;
        "pkg-0.8.15" = _HnPBD6tW;
        "pkg-0.8.16" = _py6nNtEz;
        "pkg-0.8.17" = _qo1HMVMO;
        "pkg-0.8.18" = _zvw9BAwI;
        "pkg-0.8.19" = _Z7d9v7zi;
        "pkg-0.8.20" = _Jx33ll0l;
        "pkg-0.8.21" = _eEiUSFve;
        "pkg-0.8.22" = _KE5dgP9X;
        "pkg-0.9.0" = _PmBmpTQz;
        "pkg-0.9.1" = _GiwXR76X;
        "pkg-0.9.2" = _XhTOfM1I;
        "pkg-0.9.3" = _eTNhFdEv;
