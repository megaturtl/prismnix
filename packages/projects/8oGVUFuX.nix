...
let
    ...
    in {
        ...
        "pkg-1.1.5" = _ayrZL1Bq;
        "pkg-1.2" = _M1hdFimM;
        "pkg-1.2.1-1.20.1" = _FLDfDzFz;
        "pkg-1.2-1.20.6" = _zMNlWatL;
        "pkg-1.2-1.21.4" = _71FWEABN;
        "pkg-1.2-1.21.1" = _q6s9RMJX;
        "pkg-1.2.2-1.21.4" = _zJdi7yvj;
        "pkg-1.2.2-1.20.6" = _HtkxLqNz;
        "pkg-1.2.2-1.20.1" = _WnSO9Wt9;
        "pkg-1.2.2-1.21.1" = _FFhKb1QM;
        "pkg-1.2.3-1.21.1" = _bQlfVJjH;
        "pkg-1.2.3-1.21.4" = _XGi1Rcpd;
        "pkg-1.2.3-1.20.1" = _HXfNBHbe;
        "pkg-1.2.4-1.21.1" = _f3o18hLI;
        "pkg-1.2.4-1.21.4" = _6QzQ6wpc;
        "pkg-1.2.5-1.21.1" = _nvRsERUS;
        "pkg-1.2.5-1.21.4" = _wLnJqIGN;
        "pkg-1.2.5-1.21.5" = _lCAQhrJc;
        "pkg-1.2.6-1.21.4" = _L2sIrzQA;
        "pkg-1.2.6-1.21.5" = _afCsfW2Y;
        "pkg-1.2.6-1.21.1" = _8rAPEq6R;
        "pkg-1.2.3-1.20.6" = _GNv8GEeI;
        "pkg-1.2.4-1.20.1" = _lXYmV1xl;
        "pkg-1.2.6-1.21.6" = _bN05IRLE;
        "pkg-1.2.7-1.21.1" = _a8nowdtu;
        "pkg-1.2.7-1.21.4" = _bH3uWgmU;
        "pkg-1.2.7-1.21.5" = _bC5Mk8ri;
        "pkg-1.2.7-1.21.6" = _NLN6QcKQ;
        "pkg-1.2.8-1.21.6" = _6Ov5cycS;
        "pkg-1.2.8-1.21.9" = _kAalJWN7;
        "pkg-1.2.8-1.21.1" = _FEJaHtfm;
        "pkg-1.2.9-1.21.1" = _Rmp3tvQg;
        "pkg-1.2.8-1.21.4" = _N9PKngXe;
        "pkg-1.2.8-1.21.5" = _4Xe23PAw;
        "pkg-1.2.9-1.21.6" = _QKDUKDRk;
        "pkg-1.2.9-1.21.9" = _6VwFUHXW;
        "pkg-19.0.0" = _c7LgVW7h;
        "pkg-19.0.1" = _KIuN3nSu;
        "pkg-19.0.2" = _S1ktinXp;
        "pkg-19.0.3" = _pi3d9fHQ;
        "pkg-19.0.4" = _4hKmjUjy;
        "pkg-19.0.5" = _oNHtwn8u;
        "pkg-19.1.0" = _w34GP30m;
        "pkg-19.1.1" = _Gi0K1Nwh;
        "pkg-20.1.0" = _xeczZIgH;
        "pkg-21.1.0" = _PcfVYewY;
        "pkg-1.2.10-1.21.1" = _zPIDeXeI;
        "pkg-21.1.1" = _6tIPAwFn;
