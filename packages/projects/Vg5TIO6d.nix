...
let
    versions = (let
        ...
        _Xe7EqzfQ = {
            ...
            "hash" = "sha512-SFZ1aTmAomZhFmmFf6nNNI4qKRQLh78KirPhPDWRQizOqja3ouuQCE017BhoyO7J+SQ4O7Ta2i3dy3Lp8JNhsA==";
        };
    in {
        "UOBPiKI6" = _UOBPiKI6;
        "8eIFIbKx" = _8eIFIbKx;
        ...
        "neoforge-1.21.1" = _Xe7EqzfQ;
        "pkg-0.0.1-mc1.20.1" = _UOBPiKI6;
        "pkg-0.0.2-mc1.20.1" = _8eIFIbKx;
        "pkg-0.0.3-mc1.20.1" = _LojRR2iL;
        "pkg-0.0.4-mc1.20.1" = _pKQCdJVT;
        "pkg-0.0.5-mc1.20.1" = _A1Xi2mL7;
        "pkg-0.1.0-mc1.20.1" = _RyZaU1gq;
        "pkg-0.1.0-mc1.19.2" = _QflJ4ZXc;
        "pkg-0.1.0-mc1.18.2" = _3T2KxKD8;
        "pkg-0.2.0-mc1.20.1" = _Dqlh8qrA;
        "pkg-0.2.0-mc1.19.2" = _JoMIEQgT;
        "pkg-0.2.0-mc1.18.2" = _BHCJiU44;
        "pkg-0.3.0-mc1.20.1" = _xnbEOWVS;
        "pkg-0.3.0-mc1.19.2" = _KWIsOBlU;
        "pkg-0.3.0-mc1.18.2" = _yCYW0mvn;
        "pkg-0.3.1-mc1.20.1" = _9VWGEKOr;
        "pkg-0.3.1-mc1.19.2" = _CHbWnhEJ;
        "pkg-0.3.1-mc1.18.2" = _vJuwo471;
        "pkg-0.4.0-mc1.20.1" = _QRvZ57TE;
        "pkg-0.4.1-mc1.20.1" = _Ca0bdDbG;
        "pkg-0.4.1-mc1.19.2" = _Ey6bJBnq;
        "pkg-0.4.2-mc1.20.1" = _ikBLKaJY;
        "pkg-0.4.2-mc1.19.2" = _igFgF4cL;
        "pkg-0.4.2-mc1.18.2" = _udKX2hJ7;
        "pkg-0.5.0-mc1.20.1" = _2aU2wG2k;
        "pkg-0.5.1-mc1.20.1" = _o61LXqUc;
        "pkg-0.5.1-mc1.19.2" = _PUKIoeMP;
        "pkg-0.5.1-mc1.18.2" = _7eqfDkhF;
        "pkg-0.6.0-mc1.20.1" = _EUlYFHXh;
        "pkg-0.6.0-mc1.19.2" = _rclv3TJ7;
        "pkg-0.6.1-mc1.20.1" = _Y4sqkIV1;
        "pkg-0.6.1-mc1.19.2" = _oXHXQagZ;
        "pkg-0.6.1-mc1.18.2" = _tnlpFwMs;
        "pkg-0.7.0-mc1.20.1" = _uNWHReBn;
        "pkg-0.7.0-mc1.19.2" = _g28UkIBL;
        "pkg-0.7.0-mc1.18.2" = _i5HMit28;
        "pkg-0.7.1-mc1.20.1" = _hcYgQeMJ;
        "pkg-0.7.1-mc1.19.2" = _cMDn9SEe;
        "pkg-0.7.1-mc1.18.2" = _shKqR66z;
        "pkg-0.7.2-mc1.20.1" = _28e7nphL;
        "pkg-0.7.2-mc1.19.2" = _elXyoxAP;
        "pkg-0.7.2-mc1.18.2" = _qq1Suwfp;
        "pkg-0.7.3-mc1.20.1" = _mGac22rI;
        "pkg-0.7.3-mc1.19.2" = _tFp9Akhk;
        "pkg-0.7.3-mc1.18.2" = _4d5Tj1oU;
        "pkg-0.7.4-mc1.20.1" = _AZBGh6f2;
        "pkg-0.7.4-mc1.19.2" = _GefGO2KP;
        "pkg-0.7.4-mc1.18.2" = _3mNr6Ov0;
        "pkg-0.8.0-mc1.20.1" = _OVtGotNF;
        "pkg-0.8.0-mc1.19.2" = _NCmuwBdj;
        "pkg-0.8.0-mc1.18.2" = _5qCTnRWl;
        "pkg-0.8.1-mc1.20.1" = _C7iiSXTX;
        "pkg-0.8.1-mc1.19.2" = _3XZmwD4s;
        "pkg-0.8.1-mc1.18.2" = _QQzH5Cxb;
        "pkg-0.8.2-mc1.20.1" = _gKrm9DLf;
        "pkg-0.8.2-mc1.19.2" = _1HrN6TRS;
        "pkg-0.8.2-mc1.18.2" = _DNGhyPzl;
        "pkg-0.9.0-mc1.20.1" = _HlCC58dD;
        "pkg-0.9.1-mc1.20.1" = _EhWwzIwV;
        "pkg-0.9.2-mc1.20.1" = _Oiv4wt0G;
        "pkg-0.9.3-mc1.20.1" = _82iCuwFZ;
        "pkg-0.9.4-mc1.20.1" = _1o1CPwZD;
        "pkg-0.9.4-mc1.19.2" = _CLTrW9A5;
        "pkg-0.9.4-mc1.18.2" = _5ceQLnpQ;
        "pkg-0.9.5-mc1.18.2" = _5Q45khlO;
        "pkg-1.0.0-mc1.20.1" = _fg2CYJlQ;
        "pkg-1.0.1-mc1.20.1" = _2N1jRZB4;
        "pkg-1.0.2-mc1.21.1" = _HsLqZ7XE;
        "pkg-1.0.2-mc1.20.1" = _d8TZbyDB;
        "pkg-1.0.3-mc1.21.1" = _ESygTQNI;
        "pkg-1.0.3-mc1.20.1" = _3VdM3n84;
        "pkg-1.1.0-mc1.21.1" = _Zv5siGpu;
        "pkg-1.1.0-mc1.20.1" = _g8IuhgFJ;
        "pkg-1.1.1-mc1.21.1" = _hCszCCBy;
        "pkg-1.1.1-mc1.20.1" = _aEyGCu2t;
        "pkg-1.1.2-mc1.21.1" = _8lHS9jrm;
        "pkg-1.1.2-mc1.20.1" = _3BSNIZZd;
        "pkg-1.1.3-mc1.21.1" = _FkB2K56I;
        "pkg-1.1.3-mc1.20.1" = _d9UoAlY9;
        "pkg-1.1.4-mc1.21.1" = _HkdwEV0c;
        "pkg-1.1.4-mc1.20.1" = _m2YgKGzS;
        "pkg-1.1.5-mc1.21.1" = _fmWBqX5E;
        "pkg-1.1.5-mc1.20.1" = _axChE7Jj;
        "pkg-1.1.6-mc1.21.1" = _LEoHpQEQ;
        "pkg-1.1.6-mc1.20.1" = _Vy0n7ooH;
        "pkg-1.1.7-mc1.20.1" = _HMzC945H;
        "pkg-1.1.8-mc1.21.1" = _MpTJwpqS;
        "pkg-1.1.8-mc1.20.1" = _jPgzJe8d;
        "pkg-1.1.9-mc1.21.1" = _zVNGCKT3;
        "pkg-1.1.9-mc1.20.1" = _j8VEpPsE;
        "pkg-1.1.10-mc1.21.1" = _FWJ0vXEt;
        "pkg-1.1.10-mc1.20.1" = _saiZ8AwJ;
        "pkg-1.1.11-mc1.21.1" = _m7uhxeH6;
        "pkg-1.1.11-mc1.20.1" = _VjLFXhLl;
        "pkg-1.1.12-mc1.21.1" = _yExyw5DN;
        "pkg-1.1.12-mc1.20.1" = _aN0bSww5;
        "pkg-1.1.13-mc1.21.1" = _cpErBxbD;
        "pkg-1.1.13-mc1.20.1" = _cd0NZDvE;
        "pkg-1.1.14-mc1.21.1" = _ffuMPkho;
        "pkg-1.1.15-mc1.21.1" = _fiKkkk2x;
        "pkg-1.1.16-mc1.21.1" = _EHyCRpCV;
        "pkg-1.2.0-mc1.21.1" = _tSy3IGxT;
        "pkg-1.2.0-mc1.20.1" = _ODCH98Xs;
        "pkg-1.2.1-mc1.21.1" = _zA4RBHrC;
        "pkg-1.2.2-mc1.21.1" = _iUFG9osW;
        "pkg-1.2.2-mc1.20.1" = _k4GXYL2a;
        "pkg-1.3.0-mc1.21.1" = _maJDa4Ni;
        "pkg-1.2.3-mc1.20.1" = _6gnvaVkN;
        "pkg-1.3.1-mc1.21.1" = _ZYZ7Y9iB;
        "pkg-1.3.2-mc1.21.1" = _klOWKza5;
        "pkg-1.3.3-mc1.21.1" = _Xe7EqzfQ;
        "default" = _Xe7EqzfQ;
    });
