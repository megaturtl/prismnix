...
let
    versions = (let
        ...
        _659HouM5 = {
            "id" = "659HouM5";
            "file" = "FluffyLobby-1.7.4.jar";
            "hash" = "sha512-qzZ4uidjj/gGBj0FXkfj591Y/eOHf4ktwjWYmqXxmHik+lmYf2FuryrMW0k9Pe49dAfCi6V8yE0014B8ILFfpg==";
        };
        _la4sUnbV = {
            "id" = "la4sUnbV";
            "file" = "FluffyLobby-1.7.5.jar";
            "hash" = "sha512-2rJkuGl4v4FRNYjaO8OxovzS+7kTuLmz7kO33RUVRdhej5XwESlYtLL8XWG4ASdgkjzDJUWVi8UBhc7wZKHr8A==";
        };
    in {
        "fAt9FuD9" = _fAt9FuD9;
        "YIfLLWBL" = _YIfLLWBL;
        ...
        "purpur-1.21" = _la4sUnbV;
        "purpur-1.21.1" = _la4sUnbV;
        "purpur-1.21.2" = _la4sUnbV;
        "purpur-1.21.3" = _la4sUnbV;
        "purpur-1.18.2" = _MHEKiJPU;
        "purpur-1.21.4" = _la4sUnbV;
        "purpur-1.21.5" = _la4sUnbV;
        "purpur-1.21.6" = _la4sUnbV;
        "purpur-1.21.7" = _la4sUnbV;
        "purpur-1.21.8" = _la4sUnbV;
        "purpur-1.21.9" = _la4sUnbV;
        "purpur-1.21.10" = _la4sUnbV;
        "purpur-1.21.11" = _la4sUnbV;
        "purpur-26.1" = _la4sUnbV;
        "purpur-26.1.1" = _la4sUnbV;
        "purpur-26.1.2" = _la4sUnbV;
        "purpur-26.2" = _la4sUnbV;
        ...
        "bukkit-1.21" = _la4sUnbV;
        "bukkit-1.21.1" = _la4sUnbV;
        "bukkit-1.21.2" = _la4sUnbV;
        "bukkit-1.21.3" = _la4sUnbV;
        "bukkit-1.18.2" = _MHEKiJPU;
        "bukkit-1.21.4" = _la4sUnbV;
        "bukkit-1.21.5" = _la4sUnbV;
        "bukkit-1.21.6" = _la4sUnbV;
        "bukkit-1.21.7" = _la4sUnbV;
        "bukkit-1.21.8" = _la4sUnbV;
        "bukkit-1.21.9" = _la4sUnbV;
        "bukkit-1.21.10" = _la4sUnbV;
        "bukkit-1.21.11" = _la4sUnbV;
        "bukkit-26.1" = _la4sUnbV;
        "bukkit-26.1.1" = _la4sUnbV;
        "bukkit-26.1.2" = _la4sUnbV;
        "bukkit-26.2" = _la4sUnbV;
        ...
        "paper-1.21" = _la4sUnbV;
        "paper-1.21.1" = _la4sUnbV;
        "paper-1.21.2" = _la4sUnbV;
        "paper-1.21.3" = _la4sUnbV;
        "paper-1.18.2" = _MHEKiJPU;
        "paper-1.21.4" = _la4sUnbV;
        "paper-1.21.5" = _la4sUnbV;
        "paper-1.21.6" = _la4sUnbV;
        "paper-1.21.7" = _la4sUnbV;
        "paper-1.21.8" = _la4sUnbV;
        "paper-1.21.9" = _la4sUnbV;
        "paper-1.21.10" = _la4sUnbV;
        "paper-1.21.11" = _la4sUnbV;
        "paper-26.1" = _la4sUnbV;
        "paper-26.1.1" = _la4sUnbV;
        "paper-26.1.2" = _la4sUnbV;
        "paper-26.2" = _la4sUnbV;
        ...
        "spigot-1.21" = _la4sUnbV;
        "spigot-1.21.1" = _la4sUnbV;
        "spigot-1.21.2" = _la4sUnbV;
        "spigot-1.21.3" = _la4sUnbV;
        "spigot-1.18.2" = _MHEKiJPU;
        "spigot-1.21.4" = _la4sUnbV;
        "spigot-1.21.5" = _la4sUnbV;
        "spigot-1.21.6" = _la4sUnbV;
        "spigot-1.21.7" = _la4sUnbV;
        "spigot-1.21.8" = _la4sUnbV;
        "spigot-1.21.9" = _la4sUnbV;
        "spigot-1.21.10" = _la4sUnbV;
        "spigot-1.21.11" = _la4sUnbV;
        "spigot-26.1" = _la4sUnbV;
        "spigot-26.1.1" = _la4sUnbV;
        "spigot-26.1.2" = _la4sUnbV;
        "spigot-26.2" = _la4sUnbV;
        "pkg-1.0" = _fAt9FuD9;
        "pkg-1.2" = _YIfLLWBL;
        "pkg-1.3" = _Br2jsU1c;
        "pkg-1.4" = _NsHpEzld;
