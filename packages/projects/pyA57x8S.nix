...
let
    ...
    in {
        ...
        "pkg-1.1.0+mc1.19-fabric" = _rpjM8xut;
        "pkg-1.1.0+mc1.19.1-fabric" = _SZiKMEQN;
        "pkg-1.1.0+mc1.19.2-fabric" = _NsoG9e65;
        "pkg-1.1.0+mc1.19.3-fabric" = _i9VIebzY;
        "pkg-1.1.0+mc1.19.4-fabric" = _3TZ4pfH8;
        "pkg-1.1.0+mc1.20-fabric" = _GqKs2Lsd;
        "pkg-1.1.0+mc1.20.1-fabric" = _S4BMDUkP;
        "pkg-1.1.0+mc1.20.2-fabric" = _gaP39j5B;
        "pkg-1.1.0+mc1.20.3-fabric" = _O1n2MBfk;
        "pkg-1.1.0+mc1.20.4-fabric" = _yip9W8Yn;
        "pkg-1.1.0+mc1.20.5-fabric" = _taYdIa6I;
        "pkg-1.1.0+mc1.20.6-fabric" = _ozfcvtim;
        "pkg-1.1.0+mc1.21-fabric" = _lJ1e19Jj;
        "pkg-1.1.0+mc1.21.1-fabric" = _p7MMuMwI;
        "pkg-1.1.0+mc1.21.10-fabric" = _4lukkE0S;
        "pkg-1.1.0+mc1.21.2-fabric" = _I2EMGCqC;
        "pkg-1.1.0+mc1.21.3-fabric" = _rhfOoX9C;
        "pkg-1.1.0+mc1.21.4-fabric" = _pNPSzXos;
        "pkg-1.1.0+mc1.21.5-fabric" = _v7QWlV8y;
        "pkg-1.1.0+mc1.21.6-fabric" = _u9FYKzo8;
        "pkg-1.1.0+mc1.21.7-fabric" = _J3SrIgIU;
        "pkg-1.1.0+mc1.21.8-fabric" = _VpbYCEsp;
        "pkg-1.1.0+mc1.21.9-fabric" = _tYRYVnjD;
        "pkg-1.1.0+mc1.18.2-forge" = _ULaMSLvP;
        "pkg-1.1.0+mc1.19-forge" = _XnXTgQNr;
        "pkg-1.1.0+mc1.19.1-forge" = _pwW9LfO4;
        "pkg-1.1.0+mc1.19.2-forge" = _vIGVXe4N;
        "pkg-1.1.0+mc1.19.3-forge" = _DavuNPkb;
        "pkg-1.1.0+mc1.19.4-forge" = _AsPzVdox;
        "pkg-1.1.0+mc1.20-forge" = _1Ozy6Y9M;
        "pkg-1.1.0+mc1.20.1-forge" = _hmpe2RlJ;
        "pkg-1.1.0+mc1.20.2-forge" = _7VyPAwTz;
        "pkg-1.1.0+mc1.20.3-forge" = _qA5e9PVz;
        "pkg-1.1.0+mc1.20.4-forge" = _tKmTk8sX;
        "pkg-1.1.0+mc1.20.6-forge" = _zlDGR9HA;
        "pkg-1.1.0+mc1.21-forge" = _gs00rhxs;
        "pkg-1.1.0+mc1.21.1-forge" = _Az87ESYZ;
        "pkg-1.1.0+mc1.21.10-forge" = _zCMmbvML;
        "pkg-1.1.0+mc1.21.3-forge" = _aOAm0MMi;
        "pkg-1.1.0+mc1.21.4-forge" = _aF4S4TQQ;
        "pkg-1.1.0+mc1.21.5-forge" = _iUGkfilA;
        "pkg-1.1.0+mc1.21.6-forge" = _jxxXk6we;
        "pkg-1.1.0+mc1.21.7-forge" = _uT4lqnM7;
        "pkg-1.1.0+mc1.21.8-forge" = _2hy6ylWv;
        "pkg-1.1.0+mc1.21.9-forge" = _R7PCTfT6;
        "pkg-1.2.0+mc1.18.2-fabric" = _6GN0Nnst;
        "pkg-1.2.0+mc1.19-fabric" = _lN6HBUOO;
        "pkg-1.2.0+mc1.19.1-fabric" = _Xr7aS4DP;
        "pkg-1.2.0+mc1.19.2-fabric" = _Jrl53Bib;
        "pkg-1.2.0+mc1.19.3-fabric" = _bY7zBiBL;
        "pkg-1.2.0+mc1.19.4-fabric" = _qI2qZitc;
        "pkg-1.2.0+mc1.20-fabric" = _owZBHQjK;
        "pkg-1.2.0+mc1.20.1-fabric" = _NWervAQ6;
        "pkg-1.2.0+mc1.20.2-fabric" = _71kP6Qv1;
        "pkg-1.2.0+mc1.20.3-fabric" = _427XWmRd;
        "pkg-1.2.0+mc1.20.4-fabric" = _gPOn1fKY;
        "pkg-1.2.0+mc1.20.5-fabric" = _EtDhzVFL;
        "pkg-1.2.0+mc1.20.6-fabric" = _EdmX9OqF;
        "pkg-1.2.0+mc1.21-fabric" = _gmDC6Bkq;
        "pkg-1.2.0+mc1.21.1-fabric" = _AJz0hskd;
        "pkg-1.2.0+mc1.21.2-fabric" = _HsSFUISZ;
        "pkg-1.2.0+mc1.21.3-fabric" = _RJ3HXEbu;
        "pkg-1.2.0+mc1.21.4-fabric" = _TcvYQ9iN;
        "pkg-1.2.0+mc1.21.5-fabric" = _dM1QtmQ5;
        "pkg-1.2.0+mc1.21.6-fabric" = _5HLgrM8V;
        "pkg-1.2.0+mc1.21.7-fabric" = _Zft8j1eW;
        "pkg-1.2.0+mc1.21.8-fabric" = _XYtYXHO3;
        "pkg-1.2.0+mc1.21.9-fabric" = _fBvb76Sg;
        "pkg-1.2.0+mc1.21.10-fabric" = _4TDNT7gD;
        "pkg-1.2.0+mc1.21.11-fabric" = _qJsbEAut;
        "pkg-1.2.0+mc26.1-fabric" = _m5qX2INb;
        "pkg-1.2.0+mc26.1.1-fabric" = _RUH8O3LP;
        "pkg-1.2.0+mc26.1.2-fabric" = _Mh5jhhrO;
        "pkg-1.2.0+mc1.18.2-forge" = _XP6p9mh8;
        "pkg-1.2.0+mc1.19-forge" = _PPRi8Ymg;
        "pkg-1.2.0+mc1.19.1-forge" = _3UsvBUSq;
        "pkg-1.2.0+mc1.19.2-forge" = _faSTESas;
        "pkg-1.2.0+mc1.19.3-forge" = _DSNYjTrv;
        "pkg-1.2.0+mc1.19.4-forge" = _W36zLNvR;
        "pkg-1.2.0+mc1.20-forge" = _E1V6XPIB;
        "pkg-1.2.0+mc1.20.1-forge" = _76rWa9Wc;
        "pkg-1.2.0+mc1.20.2-forge" = _cgbjl1TV;
        "pkg-1.2.0+mc1.20.3-forge" = _LLLs1Hcz;
        "pkg-1.2.0+mc1.20.4-forge" = _iswKx00t;
        "pkg-1.2.0+mc1.20.6-forge" = _R48yETmY;
        "pkg-1.2.0+mc1.21-forge" = _xJEhdq13;
        "pkg-1.2.0+mc1.21.1-forge" = _FCteEDog;
        "pkg-1.2.0+mc1.21.3-forge" = _BEmEZ7ji;
        "pkg-1.2.0+mc1.21.4-forge" = _lCztJuD0;
        "pkg-1.2.0+mc1.21.5-forge" = _R53gnlsR;
        "pkg-1.2.0+mc1.21.6-forge" = _1i72G7Ak;
        "pkg-1.2.0+mc1.21.7-forge" = _TCuG5On9;
        "pkg-1.2.0+mc1.21.8-forge" = _6DM1aXTL;
        "pkg-1.2.0+mc1.21.9-forge" = _OL9OCwAx;
        "pkg-1.2.0+mc1.21.10-forge" = _ApWgleXv;
        "pkg-1.2.0+mc1.21.11-forge" = _tZFxh83E;
        "pkg-1.2.0+mc26.1-forge" = _XgsVmmNC;
        "pkg-1.2.0+mc26.1.1-forge" = _JZMTOCys;
        "pkg-1.2.0+mc26.1.2-forge" = _6o56Aw8G;
        "pkg-2.0+mc1.18.2-fabric" = _u5zHg3eX;
        "pkg-2.0+mc1.19-fabric" = _HlqAEk1N;
        "pkg-2.0+mc1.19.1-fabric" = _llXulJT9;
        "pkg-2.0+mc1.19.2-fabric" = _pBLXY2lb;
        "pkg-2.0+mc1.19.3-fabric" = _O0omu2YM;
        "pkg-2.0+mc1.19.4-fabric" = _2ntRg7l0;
        "pkg-2.0+mc1.20-fabric" = _kJiK2R1g;
        "pkg-2.0+mc1.20.1-fabric" = _ntCwsOeF;
        "pkg-2.0+mc1.20.2-fabric" = _ORJk5eev;
        "pkg-2.0+mc1.20.3-fabric" = _RvP6Yreg;
        "pkg-2.0+mc1.20.4-fabric" = _NbO6mizs;
        "pkg-2.0+mc1.20.5-fabric" = _fuTUgE7E;
        "pkg-2.0+mc1.20.6-fabric" = _q1dT5b6c;
        "pkg-2.0+mc1.21-fabric" = _mupnrsOl;
        "pkg-2.0+mc1.21.1-fabric" = _stC75pyF;
        "pkg-2.0+mc1.21.2-fabric" = _veWA8Zqw;
        "pkg-2.0+mc1.21.3-fabric" = _MzlUUnfE;
        "pkg-2.0+mc1.21.4-fabric" = _eBiQpO3q;
        "pkg-2.0+mc1.21.5-fabric" = _CRdw9KrI;
        "pkg-2.0+mc1.21.6-fabric" = _uEK0rztD;
        "pkg-2.0+mc1.21.7-fabric" = _bZ0tKq21;
        "pkg-2.0+mc1.21.8-fabric" = _BD8JjODZ;
        "pkg-2.0+mc1.21.9-fabric" = _2hOpya69;
        "pkg-2.0+mc1.21.10-fabric" = _jkOEv1FM;
        "pkg-2.0+mc1.21.11-fabric" = _bJl3rBMz;
        "pkg-2.0+mc26.1-fabric" = _Vp7GkHQN;
        "pkg-2.0+mc26.1.1-fabric" = _ygclHCTO;
        "pkg-2.0+mc26.1.2-fabric" = _KoC5W603;
        "pkg-2.0+mc1.18.2-forge" = _4qkc9hgf;
        "pkg-2.0+mc1.19-forge" = _qQUprB45;
        "pkg-2.0+mc1.19.1-forge" = _CcxC4rA3;
        "pkg-2.0+mc1.19.2-forge" = _WiL0S6ti;
        "pkg-2.0+mc1.19.3-forge" = _qWpBnF8Q;
        "pkg-2.0+mc1.19.4-forge" = _ZqwXyS5i;
        "pkg-2.0+mc1.20-forge" = _FWpim8z1;
        "pkg-2.0+mc1.20.1-forge" = _iK9vr4W1;
        "pkg-2.0+mc1.20.2-forge" = _I8LgEd7q;
        "pkg-2.0+mc1.20.3-forge" = _54HJnbaO;
        "pkg-2.0+mc1.20.4-forge" = _P2FGUU7U;
        "pkg-2.0+mc1.20.6-forge" = _AjY7yhJV;
        "pkg-2.0+mc1.21-forge" = _j6GAff3R;
        "pkg-2.0+mc1.21.1-forge" = _P1XZOK6i;
        "pkg-2.0+mc1.21.3-forge" = _T7fj5M40;
        "pkg-2.0+mc1.21.4-forge" = _23B7jLBH;
        "pkg-2.0+mc1.21.5-forge" = _GxjYtHJa;
        "pkg-2.0+mc1.21.6-forge" = _B4Vmc56Q;
        "pkg-2.0+mc1.21.7-forge" = _wBUUYBz6;
        "pkg-2.0+mc1.21.8-forge" = _GjbUmUek;
        "pkg-2.0+mc1.21.9-forge" = _sn379jSu;
        "pkg-2.0+mc1.21.10-forge" = _Ce27oc2T;
        "pkg-2.0+mc1.21.11-forge" = _fXMQwEQ4;
        "pkg-2.0+mc26.1-forge" = _Kl3MY8ch;
        "pkg-2.0+mc26.1.1-forge" = _OcPAKpAL;
        "pkg-2.0+mc26.1.2-forge" = _bFaRmLbV;
        "pkg-2.0+mc1.21.1-neoforge" = _1fcBVIUx;
        "pkg-2.0+mc1.21.11-fabric-hotfix3" = _N4gVJvD8;
        "pkg-2.1+mc1.18.2-fabric" = _ZuoWSxpe;
        "pkg-2.1+mc1.19-fabric" = _ovYlzcmc;
        "pkg-2.1+mc1.19.1-fabric" = _BVx4f2Y0;
        "pkg-2.1+mc1.19.2-fabric" = _fGjEhYvI;
        "pkg-2.1+mc1.19.3-fabric" = _4mVjph57;
        "pkg-2.1+mc1.19.4-fabric" = _dcub73Vf;
        "pkg-2.1+mc1.20-fabric" = _BAR1KpBj;
        "pkg-2.1+mc1.20.1-fabric" = _MfDYUNRK;
        "pkg-2.1+mc1.20.2-fabric" = _hPTpU262;
        "pkg-2.1+mc1.20.3-fabric" = _8zzObf6r;
        "pkg-2.1+mc1.20.4-fabric" = _g6Q0DKho;
        "pkg-2.1+mc1.20.5-fabric" = _Gkw8Omix;
        "pkg-2.1+mc1.20.6-fabric" = _yKoSH996;
        "pkg-2.1+mc1.21-fabric" = _PllJ4tkf;
        "pkg-2.1+mc1.21.1-fabric" = _iDuGEqqB;
        "pkg-2.1+mc1.21.2-fabric" = _TpqwJFRe;
        "pkg-2.1+mc1.21.3-fabric" = _RBuZ8OG3;
        "pkg-2.1+mc1.21.4-fabric" = _46DFnWs8;
        "pkg-2.1+mc1.21.5-fabric" = _XcZRYcK4;
        "pkg-2.1+mc1.21.6-fabric" = _ZdzD0VyH;
        "pkg-2.1+mc1.21.7-fabric" = _PAPggW83;
        "pkg-2.1+mc1.21.8-fabric" = _lU5Qry8Y;
        "pkg-2.1+mc1.21.9-fabric" = _3vnXLXYi;
        "pkg-2.1+mc1.21.10-fabric" = _Xk4mZHkL;
        "pkg-2.1+mc1.21.11-fabric" = _TEucll3h;
        "pkg-2.1+mc26.1-fabric" = _y1148Hec;
        "pkg-2.1+mc26.1.1-fabric" = _lLXt8ENs;
        "pkg-2.1+mc26.1.2-fabric" = _4W605174;
        "pkg-2.1+mc26.2-fabric" = _ucyutBp5;
        "pkg-2.1+mc1.18.2-forge" = _1V5p9aVM;
        "pkg-2.1+mc1.19-forge" = _JXWCP29G;
        "pkg-2.1+mc1.19.1-forge" = _8lj7BzMm;
        "pkg-2.1+mc1.19.2-forge" = _R0n5cQd9;
        "pkg-2.1+mc1.19.3-forge" = _8dWgSr2A;
        "pkg-2.1+mc1.19.4-forge" = _oZRUbssS;
        "pkg-2.1+mc1.20-forge" = _zsAQ33rC;
        "pkg-2.1+mc1.20.1-forge" = _UVMpw7Ei;
        "pkg-2.1+mc1.20.2-forge" = _Sk2WsHKa;
        "pkg-2.1+mc1.20.3-forge" = _F1QozgQ9;
        "pkg-2.1+mc1.20.4-forge" = _3fll2vVl;
        "pkg-2.1+mc1.20.6-forge" = _WXsHmlkd;
        "pkg-2.1+mc1.21-forge" = _l7nKBTtE;
        "pkg-2.1+mc1.21.1-forge" = _NJtDonL3;
        "pkg-2.1+mc1.21.3-forge" = _96ZIyPDy;
        "pkg-2.1+mc1.21.4-forge" = _nnHhHgNI;
        "pkg-2.1+mc1.21.5-forge" = _WRmpetbe;
        "pkg-2.1+mc1.21.6-forge" = _VLg1LMc7;
        "pkg-2.1+mc1.21.7-forge" = _VRHcKtGx;
        "pkg-2.1+mc1.21.8-forge" = _Xz4TwhKx;
        "pkg-2.1+mc1.21.9-forge" = _pX2kLGRG;
        "pkg-2.1+mc1.21.10-forge" = _roLIKt9k;
        "pkg-2.1+mc1.21.11-forge" = _wXsuTxNr;
        "pkg-2.1+mc26.1-forge" = _aZyXfVqS;
        "pkg-2.1+mc26.1.1-forge" = _qbcX4KVw;
        "pkg-2.1+mc26.1.2-forge" = _Vm85hUlQ;
        "pkg-2.1+mc26.2-forge" = _UF7yJ3Qf;
        "pkg-2.1+mc1.20.2-neoforge" = _QgLHXaX7;
        "pkg-2.1+mc1.20.3-neoforge" = _3Y9L4MkZ;
        "pkg-2.1+mc1.20.4-neoforge" = _6AwXXKCG;
        "pkg-2.1+mc1.20.5-neoforge" = _rib0jS1E;
        "pkg-2.1+mc1.20.6-neoforge" = _duLGflis;
        "pkg-2.1+mc1.21-neoforge" = _aX1gIzYs;
        "pkg-2.1+mc1.21.1-neoforge" = _IM5iqNo4;
        "pkg-2.1+mc1.21.2-neoforge" = _XL5440NA;
        "pkg-2.1+mc1.21.3-neoforge" = _oeffjhnE;
        "pkg-2.1+mc1.21.4-neoforge" = _9k6tvyCE;
        "pkg-2.1+mc1.21.5-neoforge" = _J1sHIPSb;
        "pkg-2.1+mc1.21.6-neoforge" = _Jxrayy45;
        "pkg-2.1+mc1.21.7-neoforge" = _CShpNXbx;
        "pkg-2.1+mc1.21.8-neoforge" = _dsVRqnPZ;
        "pkg-2.1+mc1.21.9-neoforge" = _e49oxnVZ;
        "pkg-2.1+mc1.21.10-neoforge" = _5K6cBoSU;
        "pkg-2.1+mc1.21.11-neoforge" = _AEs6QCsm;
        "pkg-2.1+mc26.1-neoforge" = _aPZ3MVLB;
        "pkg-2.1+mc26.1.1-neoforge" = _KgOrYSOL;
        "pkg-2.1+mc26.1.2-neoforge" = _qmMusjNb;
        "pkg-2.1+mc26.2-neoforge" = _HRkehjvH;
        "pkg-2.2+mc1.18.2-fabric" = _Vp4QPKKj;
        "pkg-2.2+mc1.19-fabric" = _QemMmwpI;
        "pkg-2.2+mc1.19.1-fabric" = _HNS7QZEc;
        "pkg-2.2+mc1.19.2-fabric" = _cQ7G0ahG;
        "pkg-2.2+mc1.19.3-fabric" = _cymrO9IU;
        "pkg-2.2+mc1.19.4-fabric" = _Z1tQwjW0;
        "pkg-2.2+mc1.20-fabric" = _bcXDQm0x;
        "pkg-2.2+mc1.20.1-fabric" = _rNd9UuCc;
        "pkg-2.2+mc1.20.2-fabric" = _mqFVcLtC;
        "pkg-2.2+mc1.20.3-fabric" = _hcLzh50o;
        "pkg-2.2+mc1.20.4-fabric" = _Gibbxk2a;
        "pkg-2.2+mc1.20.5-fabric" = _Oqknfvhh;
        "pkg-2.2+mc1.20.6-fabric" = _6J6LBLoC;
        "pkg-2.2+mc1.21-fabric" = _K6P7EX6a;
        "pkg-2.2+mc1.21.1-fabric" = _iNip2pKg;
        "pkg-2.2+mc1.21.2-fabric" = _3JCFL87m;
        "pkg-2.2+mc1.21.3-fabric" = _8B4flIvW;
        "pkg-2.2+mc1.21.4-fabric" = _BWcvTuNS;
        "pkg-2.2+mc1.21.5-fabric" = _ajAmmuNO;
        "pkg-2.2+mc1.21.6-fabric" = _Ys6jCZg5;
        "pkg-2.2+mc1.21.7-fabric" = _oCvUpbQX;
        "pkg-2.2+mc1.21.8-fabric" = _LBLeHXvL;
        "pkg-2.2+mc1.21.9-fabric" = _vbBEt84k;
        "pkg-2.2+mc1.21.10-fabric" = _WoYIiRdK;
        "pkg-2.2+mc1.21.11-fabric" = _XbLWsMD5;
        "pkg-2.2+mc26.1-fabric" = _ben7Dml3;
        "pkg-2.2+mc26.1.1-fabric" = _XEAoND9h;
        "pkg-2.2+mc26.1.2-fabric" = _s481wEDS;
        "pkg-2.2+mc26.2-fabric" = _dxHZd7zz;
        "pkg-2.2+mc1.18.2-forge" = _RRQQMXRE;
        "pkg-2.2+mc1.19-forge" = _74lR6DHl;
        "pkg-2.2+mc1.19.1-forge" = _Uvhjg6IB;
        "pkg-2.2+mc1.19.2-forge" = _C65Zwiv1;
        "pkg-2.2+mc1.19.3-forge" = _fwTUR6KF;
        "pkg-2.2+mc1.19.4-forge" = _hZ7m71rh;
        "pkg-2.2+mc1.20-forge" = _tis1mQZo;
        "pkg-2.2+mc1.20.1-forge" = _VNhAnGta;
        "pkg-2.2+mc1.20.2-forge" = _DbiknlHt;
        "pkg-2.2+mc1.20.3-forge" = _tepmNVuf;
        "pkg-2.2+mc1.20.4-forge" = _TFzGpefW;
        "pkg-2.2+mc1.20.6-forge" = _BDSntUeI;
        "pkg-2.2+mc1.21-forge" = _xLXBBKjP;
        "pkg-2.2+mc1.21.1-forge" = _nysvdZFf;
        "pkg-2.2+mc1.21.3-forge" = _p4qjDc98;
        "pkg-2.2+mc1.21.4-forge" = _O4zHu819;
        "pkg-2.2+mc1.21.5-forge" = _uZ853lLu;
        "pkg-2.2+mc1.21.6-forge" = _utKrrhjO;
        "pkg-2.2+mc1.21.7-forge" = _OBueuD2p;
        "pkg-2.2+mc1.21.8-forge" = _LJFDofQR;
        "pkg-2.2+mc1.21.9-forge" = _JOw75pZy;
        "pkg-2.2+mc1.21.10-forge" = _PbC7U9Go;
        "pkg-2.2+mc1.21.11-forge" = _TlUXaZp2;
        "pkg-2.2+mc26.1-forge" = _yDRGYLlb;
        "pkg-2.2+mc26.1.1-forge" = _ZDySQ4wU;
        "pkg-2.2+mc26.1.2-forge" = _IRtZIsZV;
        "pkg-2.2+mc26.2-forge" = _RaeG6pD8;
        "pkg-2.2+mc1.20.2-neoforge" = _qDONmwMM;
        "pkg-2.2+mc1.20.3-neoforge" = _2SsVJeZo;
        "pkg-2.2+mc1.20.4-neoforge" = _wBcWYrhe;
        "pkg-2.2+mc1.20.5-neoforge" = _MqnhxWZY;
        "pkg-2.2+mc1.20.6-neoforge" = _F6awjXOC;
        "pkg-2.2+mc1.21-neoforge" = _EFGSaQSd;
        "pkg-2.2+mc1.21.1-neoforge" = _hJRs0bOw;
        "pkg-2.2+mc1.21.2-neoforge" = _kFBtSQPd;
        "pkg-2.2+mc1.21.3-neoforge" = _JLqtY9kS;
        "pkg-2.2+mc1.21.4-neoforge" = _ppKhwvKb;
        "pkg-2.2+mc1.21.5-neoforge" = _jZBRv3wC;
        "pkg-2.2+mc1.21.6-neoforge" = _DQgwCDqK;
        "pkg-2.2+mc1.21.7-neoforge" = _Jq8VDqmn;
        "pkg-2.2+mc1.21.8-neoforge" = _9QyUhY4X;
        "pkg-2.2+mc1.21.9-neoforge" = _YX8331Qx;
        "pkg-2.2+mc1.21.10-neoforge" = _aoiM7TXP;
        "pkg-2.2+mc1.21.11-neoforge" = _a1xxqGB4;
        "pkg-2.2+mc26.1-neoforge" = _Dv2AADDW;
        "pkg-2.2+mc26.1.1-neoforge" = _Knj6yrD1;
        "pkg-2.2+mc26.1.2-neoforge" = _nzjCzRWO;
        "pkg-2.2+mc26.2-neoforge" = _ORrvo6Zy;
        "pkg-2.3+mc1.20.5-fabric" = _WDIPWCm1;
        "pkg-2.3+mc1.21.2-fabric" = _GkYKaQAN;
        "pkg-2.3+mc1.21.5-fabric" = _5dK7V2lk;
        "pkg-2.3+mc1.21.6-fabric" = _S3coa3F7;
        "pkg-2.3+mc1.21.7-fabric" = _9ApZ72f2;
        "pkg-2.3+mc1.21.8-fabric" = _pD4VaK5M;
        "pkg-2.3+mc1.21.9-fabric" = _Sjhoovrv;
        "pkg-2.3+mc1.21.10-fabric" = _mmlan5SS;
        "pkg-2.3+mc1.21.11-fabric" = _HrafvLJs;
        "pkg-2.3+mc26.1-fabric" = _u8PrxVgJ;
        "pkg-2.3+mc26.1.1-fabric" = _jhvzV7LJ;
        "pkg-2.3+mc26.1.2-fabric" = _uLnqeU1A;
        "pkg-2.3+mc26.2-fabric" = _1iENGhK8;
        "pkg-2.3+mc1.19-forge" = _bI37WNoz;
        "pkg-2.3+mc1.19.1-forge" = _gXXxPmkP;
        "pkg-2.3+mc1.20-forge" = _3p8EDMfo;
        "pkg-2.3+mc1.20.6-forge" = _KAupwHzY;
        "pkg-2.3+mc1.21-forge" = _NT2ajNxF;
        "pkg-2.3+mc1.21.1-forge" = _7x5xcWgk;
        "pkg-2.3+mc1.21.3-forge" = _9tU0ZL2Q;
        "pkg-2.3+mc1.21.4-forge" = _bl3bRmuz;
        "pkg-2.3+mc1.21.5-forge" = _TTSSwDkk;
        "pkg-2.3+mc1.21.6-forge" = _zmZQ3P4R;
        "pkg-2.3+mc1.21.7-forge" = _pNple2DV;
        "pkg-2.3+mc1.21.8-forge" = _uRw0Jhx2;
        "pkg-2.3+mc1.21.9-forge" = _doMsNvTX;
        "pkg-2.3+mc1.21.10-forge" = _KknaMoJm;
        "pkg-2.3+mc1.21.11-forge" = _pa37X9KE;
        "pkg-2.3+mc26.1-forge" = _Iff0llt1;
        "pkg-2.3+mc26.1.1-forge" = _blZG6L8X;
        "pkg-2.3+mc26.1.2-forge" = _3g5MxlCs;
        "pkg-2.3+mc26.2-forge" = _suq5jqVC;
        "pkg-2.3+mc1.20.2-neoforge" = _DKYBNtXB;
        "pkg-2.3+mc1.20.3-neoforge" = _nf1OUbT5;
        "pkg-2.3+mc1.21.2-neoforge" = _tXtVHCKi;
        "pkg-2.3+mc1.21.5-neoforge" = _xdtB3kW2;
        "pkg-2.3+mc1.21.6-neoforge" = _dKl6NRad;
        "pkg-2.3+mc1.21.7-neoforge" = _VjYVpZbd;
        "pkg-2.3+mc1.21.8-neoforge" = _13GwlldF;
        "pkg-2.3+mc1.21.9-neoforge" = _JLCuSZEL;
        "pkg-2.3+mc1.21.10-neoforge" = _FhJzKyvV;
        "pkg-2.3+mc1.21.11-neoforge" = _CRxSZD2q;
        "pkg-2.3+mc26.1-neoforge" = _S5QG0zij;
        "pkg-2.3+mc26.1.1-neoforge" = _6F2q7Wt3;
        "pkg-2.3+mc26.1.2-neoforge" = _fYC07qfQ;
        "pkg-2.3+mc26.2-neoforge" = _bcLAKYg2;
        "pkg-2.3+mc1.18.2-fabric" = _KmB6S9Nj;
        "pkg-2.3+mc1.19-fabric" = _Vii5Pz88;
        "pkg-2.3+mc1.19.1-fabric" = _F7i1p1mI;
        "pkg-2.3+mc1.19.3-fabric" = _HzPKcPUZ;
        "pkg-2.3+mc1.19.4-fabric" = _D1FH8ojB;
        "pkg-2.3+mc1.19.2-fabric" = _Vho09qJy;
        "pkg-2.3+mc1.20-fabric" = _uaPb14lZ;
        "pkg-2.3+mc1.20.2-fabric" = _FiLc1FH5;
        "pkg-2.3+mc1.20.3-fabric" = _3e9Q1pE3;
        "pkg-2.3+mc1.20.1-fabric" = _n7r38aPp;
        "pkg-2.3+mc1.20.4-fabric" = _I5l8Rew7;
        "pkg-2.3+mc1.20.6-fabric" = _vivvTugI;
        "pkg-2.3+mc1.21-fabric" = _9pI8YzI6;
        "pkg-2.3+mc1.21.1-fabric" = _R76fifsV;
        "pkg-2.3+mc1.21.3-fabric" = _Hewb3C6H;
        "pkg-2.3+mc1.21.4-fabric" = _EvDCdfqz;
        "pkg-2.3+mc1.18.2-forge" = _uOl3fntT;
        "pkg-2.3+mc1.19.3-forge" = _yVeNJceV;
        "pkg-2.3+mc1.19.4-forge" = _GbJArG3w;
        "pkg-2.3+mc1.19.2-forge" = _uwknFcZt;
        "pkg-2.3+mc1.20.2-forge" = _VU3RM9bo;
        "pkg-2.3+mc1.20.3-forge" = _kVHHH7Ok;
        "pkg-2.3+mc1.20.4-forge" = _iCXF5WQe;
        "pkg-2.3+mc1.20.1-forge" = _GlJexfzo;
        "pkg-2.3+mc1.20.4-neoforge" = _pS6sTLsl;
        "pkg-2.3+mc1.20.5-neoforge" = _zARafeNJ;
        "pkg-2.3+mc1.20.6-neoforge" = _197YxmGF;
        "pkg-2.3+mc1.21-neoforge" = _XGgcr6Y0;
