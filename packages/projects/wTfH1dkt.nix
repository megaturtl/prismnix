...
let
    versions = (let
        ...
        _uHxekeNF = {
            "id" = "uHxekeNF";
            "file" = "better-boat-movement-3.1.0-26.1+paper.jar";
            "hash" = "sha512-8ODNf3mgoO/zK2p+TENELuLgbCaZT0d3W8Ldkn0X4+sZ/IGSdDOsiWSm0NWqob1p5gsHl6GFgz9YKm5GoAqBUA==";
        };
        _61GvUXsM = {
            "id" = "61GvUXsM";
            "file" = "better-boat-movement-3.1.0-26.1+fabric.jar";
            "hash" = "sha512-w5t4dEBfTeVRL/6GaoVB5FLYqoRTwGFUdaYgaFKnUeCqR9y0TLNzTLriehJEUKQTGlZntUobYkAKgg4SwhYhxw==";
        };
        _FQIXuR2r = {
            "id" = "FQIXuR2r";
            "file" = "better-boat-movement-3.1.0-26.1+neoforge.jar";
            "hash" = "sha512-lue4+Y6euVT5yjXXrZINbK0UVjjo0Uud80Qid+9312PiG6se1Xsec8fiJO1YXv8cRPou1m6xwKmGZEau2OI5BQ==";
        };
        _loNzemei = {
            "id" = "loNzemei";
            "file" = "better-boat-movement-3.1.0-26.3+fabric.jar";
            "hash" = "sha512-avhJ0SH/AdVRcpE3iGq1OwQciCR0MPsbvdQhQlkgfe00o44Aff832ly8ZFir6y3DerF2DDuFzX2uv9S2+ZO+Og==";
        };
        _wYAx89lb = {
            "id" = "wYAx89lb";
            "file" = "better-boat-movement-3.1.0-26.3+neoforge.jar";
            "hash" = "sha512-iD8ZlMeeXUUD+NNdmXFy+OQUwFNmJSwk0ZEW3wGAQi7T2RMro8gvT/xMOYSq1IFsRTsb5G4jREC+hvIf+oer1A==";
        };
    in {
        "sbu9FMx0" = _sbu9FMx0;
        "VwauooPs" = _VwauooPs;
        ...
        "fabric-26.1" = _61GvUXsM;
        "fabric-26.1.1" = _61GvUXsM;
        "fabric-26.1.2" = _61GvUXsM;
        "fabric-26.2-pre-4" = _uEq6Sxii;
        "fabric-26.2" = _61GvUXsM;
        "fabric-26.3" = _loNzemei;
        ...
        "quilt-26.1" = _61GvUXsM;
        "quilt-26.1.1" = _61GvUXsM;
        "quilt-26.1.2" = _61GvUXsM;
        "quilt-26.2-pre-4" = _uEq6Sxii;
        "quilt-26.2" = _61GvUXsM;
        "quilt-26.3" = _loNzemei;
        ...
        "neoforge-26.1" = _FQIXuR2r;
        "neoforge-26.1.1" = _FQIXuR2r;
        "neoforge-26.1.2" = _FQIXuR2r;
        "neoforge-26.2-pre-4" = _rEwCEChM;
        "neoforge-26.2" = _FQIXuR2r;
        "neoforge-26.3" = _wYAx89lb;
        "forge-1.20" = _KYajINox;
        "forge-1.20.1" = _KYajINox;
        "forge-1.20.2" = _KYajINox;
        "forge-1.19.3" = _V1bM1p9n;
        "forge-1.19.4" = _V1bM1p9n;
        "folia-26.1" = _uHxekeNF;
        "folia-26.1.1" = _uHxekeNF;
        "folia-26.1.2" = _uHxekeNF;
        "folia-26.2" = _uHxekeNF;
        "folia-26.3" = _uHxekeNF;
        "paper-26.1" = _uHxekeNF;
        "paper-26.1.1" = _uHxekeNF;
        "paper-26.1.2" = _uHxekeNF;
        "paper-26.2" = _uHxekeNF;
        "paper-26.3" = _uHxekeNF;
        "purpur-26.1" = _uHxekeNF;
        "purpur-26.1.1" = _uHxekeNF;
        "purpur-26.1.2" = _uHxekeNF;
        "purpur-26.2" = _uHxekeNF;
        "purpur-26.3" = _uHxekeNF;
        "pkg-1.0.0-1.20.1" = _sbu9FMx0;
        "pkg-1.1.0-1.20.4" = _VwauooPs;
        "pkg-1.1.1-1.20.4" = _lWl52GfZ;
        "pkg-1.1.2-1.20.4" = _wWzmWUHR;
        "pkg-1.1.3-1.20.6" = _cjI9Zw1t;
        "pkg-1.1.3-1.20.4" = _KjeXPiEg;
        "pkg-1.1.3-1.20.1" = _HVk52PLN;
        "pkg-1.1.4-1.20.6" = _5lukYau9;
        "pkg-1.1.4-1.20.4" = _tZh43trB;
        "pkg-1.1.4-1.20.1" = _wab1LgQF;
        "pkg-1.2.0-1.21" = _9TZf9tJ0;
        "pkg-1.2.0-1.20.4" = _EG5JnRTi;
        "pkg-1.2.0-1.20.1" = _gxR50LpF;
        "pkg-2.0.0-1.21" = _8M2kae2S;
        "pkg-2.0.0-1.20.6" = _nRyotmPq;
        "pkg-2.0.0-1.20.4" = _GQ2fS3eg;
        "pkg-2.0.0-1.20.1" = _49hChtRk;
        "pkg-2.1.0-1.21" = _YzhQ4fgg;
        "pkg-2.1.0-1.20.6" = _kjvupLwx;
        "pkg-2.1.0-1.20.4" = _NTk2HIPX;
        "pkg-2.1.0-1.20.1" = _xGTQHHTS;
        "pkg-2.2.0-1.21" = _eHAOWXg9;
        "pkg-2.2.0-1.20.6" = _IYAlcNf0;
        "pkg-2.2.0-1.20.4" = _kCzyzTjb;
        "pkg-2.2.0-1.20.1" = _S4FmdfXd;
        "pkg-2.2.1-1.21+neoforge" = _iQED4fGb;
        "pkg-2.2.1-1.21+fabric" = _vOBE6zNc;
        "pkg-2.2.1-1.20.6+neoforge" = _hcpWYEBX;
        "pkg-2.2.1-1.20.6+fabric" = _6YgYK60q;
        "pkg-2.2.1-1.20.4+neoforge" = _r039kMwF;
        "pkg-2.2.1-1.20.4+fabric" = _Oz6WfZSc;
        "pkg-2.2.1-1.20.1+forge" = _PIkfk9Gv;
        "pkg-2.2.1-1.20.1+fabric" = _P3WJWJBJ;
        "pkg-2.2.1-1.19.4+forge" = _bj0dKKbd;
        "pkg-2.2.1-1.19.4+fabric" = _80du8hYp;
        "pkg-2.2.2-1.21+neoforge" = _AxSu2FUE;
        "pkg-2.2.2-1.21+fabric" = _VzdVGpoV;
        "pkg-2.2.2-1.20.6+neoforge" = _RiUYduf8;
        "pkg-2.2.2-1.20.6+fabric" = _ewOpuKJZ;
        "pkg-2.2.2-1.20.4+neoforge" = _V3L6Q9Ak;
        "pkg-2.2.2-1.20.4+fabric" = _EkhQw6rB;
        "pkg-2.2.2-1.20.1+forge" = _y9ICdRMs;
        "pkg-2.2.2-1.20.1+fabric" = _oW3EkzuQ;
        "pkg-2.2.2-1.19.4+forge" = _nfmd162P;
        "pkg-2.2.2-1.19.4+fabric" = _HbDxT8D3;
        "pkg-2.2.3-1.20.6+neoforge" = _1f3fxMfV;
        "pkg-2.2.3-1.20.4+neoforge" = _Qt6zHPfN;
        "pkg-2.2.3-1.19.4+forge" = _KP9iQGBU;
        "pkg-2.2.3-1.21+neoforge" = _t83s8Fy1;
        "pkg-2.2.3-1.19.4+fabric" = _4LeEPoi4;
        "pkg-2.2.3-1.20.4+fabric" = _SoqLPxSu;
        "pkg-2.2.3-1.20.6+fabric" = _wcKrO8mP;
        "pkg-2.2.3-1.20.1+forge" = _f5zpetXW;
        "pkg-2.2.3-1.20.1+fabric" = _MGatccOx;
        "pkg-2.2.3-1.21+fabric" = _3x8hTIdF;
        "pkg-2.2.4-1.21+neoforge" = _2nO6y5L2;
        "pkg-2.2.4-1.21+fabric" = _zZlKDSC4;
        "pkg-2.2.4-1.20.6+neoforge" = _GXXebHeW;
        "pkg-2.2.4-1.20.6+fabric" = _LA5d4xlm;
        "pkg-2.2.4-1.20.4+neoforge" = _kkL2OKng;
        "pkg-2.2.4-1.20.4+fabric" = _M3CanvwO;
        "pkg-2.2.4-1.20.1+forge" = _kJulhWLw;
        "pkg-2.2.4-1.20.1+fabric" = _Iug6Jb6A;
        "pkg-2.2.4-1.19.4+forge" = _WwWd30Tj;
        "pkg-2.2.4-1.19.4+fabric" = _s5uRCZxe;
        "pkg-2.2.5-1.21+neoforge" = _MdZdHN03;
        "pkg-2.2.5-1.21+fabric" = _oqS54g1d;
        "pkg-2.2.5-1.20.6+neoforge" = _dzdrzIrw;
        "pkg-2.2.5-1.20.6+fabric" = _g8T6EFKg;
        "pkg-2.2.5-1.20.4+neoforge" = _BXflJm2H;
        "pkg-2.2.5-1.20.4+fabric" = _vu8NNPJJ;
        "pkg-2.2.5-1.20.1+forge" = _e0NihgVb;
        "pkg-2.2.5-1.20.1+fabric" = _buWG9wVX;
        "pkg-2.2.5-1.19.4+forge" = _VJst0SoQ;
        "pkg-2.2.5-1.19.4+fabric" = _wocLzzmc;
        "pkg-2.2.6-1.21+neoforge" = _irDDAjfS;
        "pkg-2.2.6-1.21+fabric" = _rLY9FDgL;
        "pkg-2.2.6-1.20.6+neoforge" = _CgfpDapp;
        "pkg-2.2.6-1.20.6+fabric" = _sspdVOWR;
        "pkg-2.2.6-1.20.4+neoforge" = _s3Fesmvi;
        "pkg-2.2.6-1.20.4+fabric" = _DrTbhHtG;
        "pkg-2.2.6-1.20.1+forge" = _KYajINox;
        "pkg-2.2.6-1.20.1+fabric" = _FJcBEiPS;
        "pkg-2.2.6-1.19.4+forge" = _V1bM1p9n;
        "pkg-2.2.6-1.19.4+fabric" = _HE1v9IXM;
        "pkg-2.2.6-1.21.3+neoforge" = _HEVaZxhK;
        "pkg-2.2.6-1.21.3+fabric" = _mBJV59Ry;
        "pkg-2.3.0-1.21.3+neoforge" = _zdwowX1S;
        "pkg-2.3.0-1.21.3+fabric" = _Vc1UmIUH;
        "pkg-2.3.0-1.21+neoforge" = _KqZMnJXZ;
        "pkg-2.3.0-1.21+fabric" = _bkqqD44l;
        "pkg-2.3.1-1.21.3+neoforge" = _9PrVW4hl;
        "pkg-2.3.1-1.21.3+fabric" = _hQtZlyAy;
        "pkg-2.3.1-1.21+neoforge" = _m4gyVYzF;
        "pkg-2.3.1-1.21+fabric" = _GVdx0b6P;
        "pkg-2.3.2-1.21+fabric" = _flGBW5sT;
        "pkg-2.3.2-1.21+neoforge" = _I7v9kyw6;
        "pkg-2.3.2-1.21.3+fabric" = _yoNAOK4G;
        "pkg-2.3.2-1.21.3+neoforge" = _mO705GuA;
        "pkg-2.3.2-1.21.8+neoforge" = _EuGJki8M;
        "pkg-2.3.3-1.21+fabric" = _W2Hpq2So;
        "pkg-2.3.3-1.21+neoforge" = _Q6Prcbs3;
        "pkg-2.3.3-1.21.3+fabric" = _G8lDH7ug;
        "pkg-2.3.3-1.21.3+neoforge" = _PXG6P8hL;
        "pkg-2.3.3-1.21.8+neoforge" = _Xy1tFoVP;
        "pkg-2.3.4-1.21+fabric" = _bpgy5DTd;
        "pkg-2.3.4-1.21+neoforge" = _ZLQYvoaj;
        "pkg-2.3.4-1.21.3+neoforge" = _7e2b4Gok;
        "pkg-2.3.4-1.21.3+fabric" = _1Jc54QNe;
        "pkg-2.3.4-1.21.8+neoforge" = _3YEHVUWL;
        "pkg-2.3.5-1.21+fabric" = _gybzS2XT;
        "pkg-2.3.5-1.21+neoforge" = _8Zk8yh0x;
        "pkg-2.3.5-1.21.3+fabric" = _ynxLSLJR;
        "pkg-2.3.5-1.21.3+neoforge" = _HOJgRBbK;
        "pkg-2.3.5-1.21.8+neoforge" = _b5NhMRwB;
        "pkg-2.3.5-1.21.9+fabric" = _7uLKFy0I;
        "pkg-2.3.5-1.21.9+neoforge" = _IFzCsriP;
        "pkg-2.3.6-1.21+fabric" = _8k5N1LPc;
        "pkg-2.3.6-1.21+neoforge" = _vsflhTjE;
        "pkg-2.3.6-1.21.3+fabric" = _zKbZqtjh;
        "pkg-2.3.6-1.21.3+neoforge" = _2aQ1Ngx2;
        "pkg-2.3.6-1.21.8+neoforge" = _hLEBhMz7;
        "pkg-2.3.6-1.21.9+fabric" = _5tbaX74l;
        "pkg-2.3.6-1.21.9+neoforge" = _SJah7TKo;
        "pkg-2.4.1-1.21+fabric" = _dTRyQVsM;
        "pkg-2.4.1-1.21+neoforge" = _mukG719i;
        "pkg-2.4.1-1.21.3+fabric" = _nECanJvD;
        "pkg-2.4.1-1.21.3+neoforge" = _YcGOsivt;
        "pkg-2.4.1-1.21.8+neoforge" = _S67OSOU8;
        "pkg-2.4.1-1.21.9+fabric" = _POidDR9g;
        "pkg-2.4.1-1.21.9+neoforge" = _8wcLDzI4;
        "pkg-2.5.0-1.21+fabric" = _rcEZ1Kq7;
        "pkg-2.5.0-1.21+neoforge" = _pbNv5nYK;
        "pkg-2.5.0-1.21.3+fabric" = _DQtJ8WpU;
        "pkg-2.5.0-1.21.3+neoforge" = _icJPE3bU;
        "pkg-2.5.0-1.21.8+neoforge" = _TftHhTpW;
        "pkg-2.5.0-1.21.9+fabric" = _CbxqZSdI;
        "pkg-2.5.0-1.21.9+neoforge" = _J2K3HiZF;
        "pkg-2.5.1-1.21+fabric" = _gHtCKLy8;
        "pkg-2.5.1-1.21+neoforge" = _eMXwbPt2;
        "pkg-2.5.1-1.21.3+fabric" = _uM31Kt4u;
        "pkg-2.5.1-1.21.3+neoforge" = _oeYmqxxR;
        "pkg-2.5.1-1.21.8+neoforge" = _P7esrRio;
        "pkg-2.5.1-1.21.9+fabric" = _Q3046vLv;
        "pkg-2.5.1-1.21.9+neoforge" = _AcN5NMQw;
        "pkg-2.5.2-1.21+fabric" = _yD2cOm8R;
        "pkg-2.5.2-1.21+neoforge" = _y1KhO6S3;
        "pkg-2.5.2-1.21.11+fabric" = _EWtdUISy;
        "pkg-2.5.2-1.21.11+neoforge" = _Nx75hVgH;
        "pkg-2.5.2-1.21.3+fabric" = _rkgRZoYX;
        "pkg-2.5.2-1.21.3+neoforge" = _G1l28xmP;
        "pkg-2.5.2-1.21.8+neoforge" = _KlHFBVaz;
        "pkg-2.5.2-1.21.9+fabric" = _16m6ptOG;
        "pkg-2.5.2-1.21.9+neoforge" = _viXa8cNx;
        "pkg-2.5.3-1.21+fabric" = _vuujooOD;
        "pkg-2.5.3-1.21+neoforge" = _kJ1faJkz;
        "pkg-2.5.3-1.21.11+fabric" = _ehsykGvC;
        "pkg-2.5.3-1.21.11+neoforge" = _5o4nrSh5;
        "pkg-2.5.3-1.21.3+fabric" = _guAOmBc0;
        "pkg-2.5.3-1.21.3+neoforge" = _Kpe0TVta;
        "pkg-2.5.3-1.21.8+neoforge" = _HRayqAfb;
        "pkg-2.5.3-1.21.9+fabric" = _2usZFFiU;
        "pkg-2.5.3-1.21.9+neoforge" = _JK2Jnnjk;
        "pkg-2.5.4-1.21+fabric" = _lJAI1VBz;
        "pkg-2.5.4-1.21+neoforge" = _67C3cArI;
        "pkg-2.5.4-1.21.11+fabric" = _zEg99RFy;
        "pkg-2.5.4-1.21.11+neoforge" = _qVES4GzA;
        "pkg-2.5.4-1.21.3+fabric" = _rRNlaCym;
        "pkg-2.5.4-1.21.3+neoforge" = _nDrNaJW1;
        "pkg-2.5.4-1.21.8+neoforge" = _JQaAx8zY;
        "pkg-2.5.4-1.21.9+fabric" = _4ZsRzJNT;
        ...
        "pkg-3.1.0-26.1+paper" = _uHxekeNF;
        "pkg-3.1.0-26.1+fabric" = _61GvUXsM;
        "pkg-3.1.0-26.1+neoforge" = _FQIXuR2r;
        "pkg-3.1.0-26.3+fabric" = _loNzemei;
        "pkg-3.1.0-26.3+neoforge" = _wYAx89lb;
        "default" = _wYAx89lb;
    });
