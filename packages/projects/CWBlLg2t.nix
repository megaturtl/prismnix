...
let
    versions = (let
        ...
        _lNrMNP5T = {
            "id" = "lNrMNP5T";
            "file" = "Balanced-Music-0.2.3+mc26.2.zip";
            "hash" = "sha512-J1iP2J0JtbFvzxEA2+Pr2XtI6PjWEwCWOgjA6RUl/GvIxLg5Dq5ipNbz3dorK6WsmGEL7HYvTDggzedvouZNaw==";
        };
    in {
        "11kpxxgr" = _11kpxxgr;
        "d7xT5EqH" = _d7xT5EqH;
        ...
        "minecraft-26.1.1" = _tW4gOPA0;
        "minecraft-26.1.2" = _tW4gOPA0;
        "minecraft-26.2" = _lNrMNP5T;
        "pkg-0.1.0" = _11kpxxgr;
        "pkg-0.1.1" = _d7xT5EqH;
        "pkg-0.2.0" = _vT3bNvrK;
        "pkg-0.2.1" = _rE6RrD39;
        "pkg-0.2.2" = _6ROD7Jn7;
        "pkg-0.2.2+1.20.3" = _OIQViWfz;
        "pkg-0.2.2+1.21" = _gVv72SZc;
        "pkg-0.2.2+1.21.6-8" = _p683oaw2;
        "pkg-0.2.2+1.21.6-11" = _tW4gOPA0;
        "pkg-0.2.3" = _lNrMNP5T;
        "default" = _lNrMNP5T;
    });
