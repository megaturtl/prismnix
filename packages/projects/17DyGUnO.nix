...
let
    ...
    in {
        ...
        "pkg-5.5.0" = _hR20KljA;
        "pkg-5.5.1" = _GVPU6K1I;
        "pkg-5.6.0.beta1" = _hZbLCsWX;
        "pkg-5.6.0.beta2" = _6hylVoMD;
        "pkg-5.6.0.beta3" = _d1qoaqdU;
        "pkg-5.6.1" = _bpMNvs3i;
        "pkg-5.6.2" = _gA3aWqgl;
        "pkg-5.6.3" = _ZWkmUcZX;
        "pkg-5.7.0" = _8ToymkDt;
        ...
        "pkg-5.9.0" = _B7Hh3Mqf;
        "pkg-5.9.1" = _AzUBKaUJ;
        "pkg-v5.10.0" = _T2c3xZT8;
        "pkg-5.10.1" = _B8ovML6I;
        "pkg-5.11.0" = _Mp6dseAm;
        "pkg-5.12.0" = _EfH8wXSy;
        "pkg-5.12.1" = _eyl6ki4Y;
        "pkg-5.13.0" = _bGc2nQqF;
        "pkg-5.13.1" = _8flt30LS;
        "pkg-5.14.0" = _TfFmtTF8;
        "pkg-5.15.0" = _rS0b6jwS;
        "pkg-5.16.0" = _F1KD1VnH;
        "pkg-5.16.1" = _wIF17HZa;
        "pkg-5.17.0" = _qkg5iYQn;
        "pkg-5.17.1" = _gZusrWr7;
        "pkg-5.18.0" = _IuEyPrJs;
        "pkg-5.18.1" = _qIyckFNx;
        "pkg-5.18.2" = _SvddpNdl;
        "pkg-5.19.0" = _y6SVGobn;
        "pkg-6.0.0" = _poxMMVHD;
        "pkg-6.0.1" = _XSJbgevQ;
        "pkg-6.1.0" = _U4iyQPBQ;
        "pkg-6.1.1" = _Al13XVnJ;
