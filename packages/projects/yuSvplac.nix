...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.0.0-forge" = _oRNX6YIK;
        "pkg-1.19.2-1.0.0-quilt" = _JNg3wkO8;
        "pkg-1.19.2-1.0.0-fabric" = _q1rPjkGQ;
        "pkg-1.19.2-1.0.0-forge" = _7YhmOgNR;
        "pkg-1.19.3-1.0.0-quilt" = _5mPGWPY0;
        "pkg-1.19.3-1.0.0-fabric" = _XYoKOAeW;
        "pkg-1.19.3-1.0.0-forge" = _LatGFQnv;
        "pkg-1.19.4-1.0.0-quilt" = _Pl3EHVks;
        "pkg-1.19.4-1.0.0-fabric" = _f9bKuInt;
        "pkg-1.19.4-1.0.0-forge" = _EcNjETtz;
        "pkg-1.20.1-1.0.0-quilt" = _9cYQYfVA;
        "pkg-1.20.1-1.0.0-fabric" = _LI5Q0S2Y;
        "pkg-1.20.1-1.0.0-forge" = _D9Q8pPYB;
        "pkg-1.20.2-1.0.0-fabric" = _Aa3gsddS;
        "pkg-1.20.2-1.0.0-forge" = _UQ7DHZSz;
        "pkg-1.20.1-1.0.1-fabric" = _fx79gW1L;
        "pkg-1.18.2-1.0.1-fabric" = _A22uWakC;
        "pkg-1.19.2-1.0.1-fabric" = _Vvz55Haf;
        "pkg-1.19.3-1.0.1-fabric" = _COzvhHTQ;
        "pkg-1.19.4-1.0.1-fabric" = _4wffpn4B;
        "pkg-1.20.2-1.0.1-fabric" = _hMs8fM9E;
        "pkg-1.18.2-1.1.0-fabric" = _B9FXX9RQ;
        "pkg-1.18.2-1.1.0-forge" = _lw6AIOjU;
        "pkg-1.19.2-1.1.0-fabric" = _EDsstzzU;
        "pkg-1.19.2-1.1.0-forge" = _yUar1rTx;
        "pkg-1.19.3-1.1.0-fabric" = _bnJga3BJ;
        "pkg-1.19.3-1.1.0-forge" = _eLoC2JG5;
        "pkg-1.19.4-1.1.0-fabric" = _oN16VOUp;
        "pkg-1.19.4-1.1.0-forge" = _v6UNmqA6;
        "pkg-1.20.1-1.1.0-fabric" = _Nzaca4vB;
        "pkg-1.20.1-1.1.0-forge" = _3TZoRtGI;
        "pkg-1.20.2-1.1.0-fabric" = _tqSVriNA;
        "pkg-1.20.2-1.1.0-forge" = _jlzpKBL5;
        "pkg-1.1.1" = _uERVExsX;
        "pkg-1.1.2" = _7KOSlc6H;
        "pkg-2.0.0" = _cgo1aczU;
