...
let
    ...
    in {
        ...
        "pkg-1.9.2" = _h1uB49Cc;
        "pkg-1.9.3" = _ZhZbihGL;
        "pkg-1.10.0" = _CimNHVzi;
        "pkg-1.10.1" = _fW65t21C;
        "pkg-1.10.2" = _Jlrlqza0;
        "pkg-1.10.3" = _ub6qgG0N;
        "pkg-1.10.4" = _NsloXZ5i;
        "pkg-1.10.5" = _9GNrjIDC;
        "pkg-1.10.6" = _mg4vRKO1;
        "pkg-1.10.7" = _zZrgKUQq;
        "pkg-1.10.8" = _FD6Y71Rj;
        "pkg-1.10.9" = _cH55PaAd;
        "pkg-1.10.10" = _PjPCjWGG;
        "pkg-1.11.0_1.16" = _VvoaRxHI;
        "pkg-1.11.0_1.17" = _S1Cvjcjv;
        "pkg-1.11.0_1.18" = _XfhqYUWs;
        "pkg-1.11.1_1.17" = _8w2NzvYU;
        "pkg-1.11.1_1.18" = _Sap7tIKQ;
        "pkg-1.11.2_1.17" = _JFSY15ZW;
        "pkg-1.11.2_1.18" = _KviN27dP;
        "pkg-1.11.3_1.17" = _NLQdpp5K;
        "pkg-1.11.3_1.18" = _erkIpdLq;
        "pkg-1.11.4_1.17" = _oBtNoAkE;
        "pkg-1.11.4_1.18" = _uDmCURja;
        "pkg-1.12.0_1.17" = _SyXLABBY;
        "pkg-1.12.0_1.18" = _63sITOd4;
        "pkg-1.12.1_1.17" = _sZsio9ig;
        "pkg-1.12.1_1.18" = _eLzGtN8T;
        "pkg-2.0.0-alpha.1_1.16" = _WtzTqxkb;
        "pkg-2.0.0-alpha.1_1.17" = _X36UDGNU;
        "pkg-2.0.0-alpha.1_1.18" = _T8xKLbJh;
        "pkg-2.0.0-alpha.2_1.16" = _k3JN7kvf;
        "pkg-2.0.0-alpha.2_1.17" = _eGonceym;
        "pkg-2.0.0-alpha.2_1.18" = _nA7VNMLm;
        "pkg-2.0.0-alpha.3_1.17" = _faFRbRLi;
        "pkg-2.0.0-alpha.3_1.18" = _jO469Xna;
        "pkg-2.0.0-alpha.3_1.19" = _trI0vmr7;
        "pkg-2.0.0-alpha.4_1.14" = _rsqbncYy;
        "pkg-2.0.0-alpha.4_1.15" = _NZWGlH2E;
        "pkg-2.0.0-alpha.4_1.16" = _cQqCBaFw;
        "pkg-2.0.0-alpha.4_1.17" = _kp1ZbIQX;
        "pkg-2.0.0-alpha.4_1.18" = _qx5B6b4C;
        "pkg-2.0.0-alpha.4_1.19" = _BvRLclIj;
        "pkg-2.0.0-alpha.5_1.14" = _dwPkAPbK;
        "pkg-2.0.0-alpha.5_1.15" = _1WiHEYHU;
        "pkg-2.0.0-alpha.5_1.16" = _MSj2AU9V;
        "pkg-2.0.0-alpha.5_1.17" = _ZVvvFkDF;
        "pkg-2.0.0-alpha.5_1.18" = _uLL1WnNn;
        "pkg-2.0.0-alpha.5_1.19" = _ST39pz2u;
        "pkg-2.0.0-alpha.6" = _JoL8KX3u;
        "pkg-2.0.0-alpha.7" = _OlmUtOkv;
        "pkg-2.0.0-alpha.8" = _5ph3jegx;
        "pkg-2.0.0-alpha.9" = _ayhqxcLJ;
        "pkg-2.0.0-alpha.10" = _52WTsu09;
        "pkg-2.0.0-rc.1" = _TOUtdvRY;
        "pkg-2.0.0" = _qdchULd2;
        "pkg-2.1.0" = _BpgHHZbm;
        "pkg-2.1.1" = _pPv3Xq6F;
        "pkg-1.19.2-2.1.2" = _JkO4CnWv;
        "pkg-1.19.3-2.1.2" = _KfjWYrXa;
        "pkg-2.1.3" = _fLICu606;
        "pkg-2.1.4" = _XWK9xoXO;
        "pkg-1.20-2.1.4" = _IOsuelCG;
        "pkg-2.2.0" = _s3vYTmUO;
        "pkg-2.2.1" = _JCLi6ZTO;
        "pkg-2.2.2" = _b6Ps3ai7;
        "pkg-2.2.3" = _sKghQcdd;
        "pkg-2.2.4" = _Izyf8EVb;
        "pkg-2.2.5-compat" = _c8ocR6sc;
        "pkg-2.2.5" = _tldGNWOW;
        "pkg-2.2.6" = _KWGQ6JXw;
        "pkg-2.3.0-compat" = _eunkaXUN;
        "pkg-2.3.0" = _rlKvLukS;
        "pkg-2.3.1-compat" = _6DTYhPzV;
        "pkg-2.3.1" = _7q4u811c;
        "pkg-2.3.2-compat" = _sUMLlpKE;
        "pkg-2.3.2" = _3TuVILNu;
        "pkg-1.20.5-2.3.2" = _JIhCKnJo;
        "pkg-2.3.3-compat" = _eSqIymiM;
        "pkg-2.3.3" = _elpg20NQ;
        "pkg-2.3.4-compat" = _94UoXXce;
        "pkg-2.3.4" = _MSrTED1f;
        "pkg-2.3.5" = _vx7HS6q7;
        "pkg-2.4.0" = _fgxnpAd1;
        "pkg-2.4.1" = _7ptDmFQV;
        ...
        "pkg-2.7.0" = _ojHbX39A;
        "pkg-2.7.1" = _aWxpt7iY;
        "pkg-2.7.1-compat.1" = _iBEvrd8z;
        "pkg-3.0.0-beta.1-1.21.11" = _k00Eqncp;
