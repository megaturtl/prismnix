...
let
    versions = (let
        ...
        _qXQcYCpV = {
            "id" = "qXQcYCpV";
            "file" = "tolaserblade-neoforge-17.0.0-beta.7+26.1.2.jar";
            "hash" = "sha512-b3459QZCHdFbsEonTxbcmbN1CAgLo/d2yq+6kYy54D2Lcofx2Xxc84sbFLGx0s455OeVQEyBj34bOVB70Mt7zg==";
        };
        _kAsovBMJ = {
            "id" = "kAsovBMJ";
            "file" = "tolaserblade-forge-17.0.0-beta.7+26.1.2.jar";
            "hash" = "sha512-C3P1W0shdi9TTAeJZVqOzFqUBAQpHsGAbZjDkU8EWYVVAkVXvvv/zIaGipgZN4l/hn9xBlBoUYVZjJHZ/lW2NQ==";
        };
        _zxQHLTG7 = {
            "id" = "zxQHLTG7";
            "file" = "tolaserblade-fabric-17.0.0-beta.7+26.1.2.jar";
            "hash" = "sha512-r5pqSwXQz8FL/Pj9QPVSNpzZoCF4TbOF8G1E0+xjzWa/BG7zapDkS3bOTo9mwoE9Q4HxA+gDA3PqWGui2h65pA==";
        };
        _BA6Nwh5q = {
            "id" = "BA6Nwh5q";
            "file" = "tolaserblade-bta-1.4.0+8.0.1.jar";
            "hash" = "sha512-y7pNVuNZPJcKzkeokDqqFG6EfeKUML36YN717i/SUcxQYJKMGdef+UPN/Sspa5dXitDiYeNQbFi9FHj1WtGoPA==";
        };
        _tSb1WqgM = {
            "id" = "tSb1WqgM";
            "file" = "tolaserblade-neoforge-17.0.0-beta.8+26.1.2.jar";
            "hash" = "sha512-i7Zaaq/9seGjRgo62b9my0ggc08yGtT9PFBMW8Pt4UCnDyR5RBjjt2PmTnGJBffCW8sy7Ki7O0NL/IkDaGlyNA==";
        };
        _zLgbtsS9 = {
            "id" = "zLgbtsS9";
            "file" = "tolaserblade-forge-17.0.0-beta.8+26.1.2.jar";
            "hash" = "sha512-p0NVMUMrUzdI71ukr9oYUF5JqMFm4xFwDTA+kXvDv7jhmVFoR5c/phfF+ve23AmirApIL8HdypgD/lQdlFOA3Q==";
        };
        _XLvm5N2n = {
            "id" = "XLvm5N2n";
    ...
    in {
        ...
        "neoforge-26.1.2" = _tSb1WqgM;
        "fabric-26.1.2" = _XLvm5N2n;
        "pkg-1.0.0-beta.1-bta" = _nAt8GhWJ;
        "pkg-1.1.0-bta" = _Deo5c5Cz;
        "pkg-1.20.1-7.0.1.0" = _jAWKQxyx;
        "pkg-8.4.0-forge" = _O1L0kXie;
        "pkg-8.4.0-neoforge" = _IOUlAK2h;
        "pkg-9.1.0-neoforge" = _A72TUYbu;
        "pkg-9.1.0-forge" = _ynENkNj1;
        "pkg-10.0.0-neoforge" = _x8gYEkXc;
        "pkg-10.0.0-forge" = _pbzUelpF;
        "pkg-8.4.1-forge" = _qNQapYMH;
        "pkg-8.4.1-neoforge" = _oySqk2C1;
        "pkg-9.1.1-forge" = _cFiqEhE2;
        "pkg-9.1.1-neoforge" = _BGiqcRNK;
        "pkg-10.0.1-forge" = _fGfIePhc;
        "pkg-10.0.1-neoforge" = _qo9p7igp;
        "pkg-10.0.2-forge" = _riFzbZ6D;
        "pkg-10.0.2-neoforge" = _XD9Hgurr;
        "pkg-10.0.3-neoforge" = _RZB4BQhP;
        "pkg-1.20.1-7.0.1.1" = _7zBYupuV;
        "pkg-10.0.4-forge" = _A6mdjbUo;
        "pkg-10.0.4-neoforge" = _CLyvExrj;
        "pkg-11.0.0-forge" = _TUYN0mMd;
        "pkg-11.0.0-neoforge" = _HJM7SQ58;
        "pkg-12.0.0-neoforge" = _DCYg3CK4;
        "pkg-12.0.0-forge" = _q76FSJFX;
        "pkg-1.20.1-7.0.2.0" = _LOdDCdwT;
        "pkg-12.1.0-neoforge" = _gSvfgIMN;
        "pkg-1.20.1-7.0.2.1" = _xyKSJJCX;
        "pkg-12.1.0-forge" = _YNH4OcW2;
        "pkg-12.1.1-neoforge" = _qnbfY8XJ;
        "pkg-1.20.1-7.1.0.0" = _fLebJ1Cx;
        "pkg-12.2.0-neoforge" = _gqxbKq8F;
        "pkg-12.2.0-forge" = _LtZBMUXh;
        "pkg-13.0.0-forge" = _HcZMW8Kj;
        "pkg-13.0.0-neoforge" = _b92j09nX;
        "pkg-13.0.1-forge" = _rL9HIV7T;
        "pkg-14.0.0-neoforge" = _jJEdC5bH;
        "pkg-14.0.0-forge" = _oU9bg63B;
        "pkg-1.2.0-bta" = _Dd1zlV75;
        "pkg-15.0.0-neoforge" = _xAeEZzDJ;
        "pkg-15.0.0-forge" = _Ioi3sN4J;
        "pkg-16.0.0-neoforge" = _mBTTEjSR;
        "pkg-16.0.0-forge" = _vqMGRqRS;
        "pkg-17.0.0-beta.1-neoforge" = _8nQLsUJX;
        "pkg-17.0.0-beta.2+26.1.2-neoforge" = _6NmF3hT5;
        "pkg-17.0.0-beta.2+26.1.2-fabric" = _VdOOVH0y;
        "pkg-17.0.0-beta.3+26.1.2-neoforge" = _blnqpiaD;
        "pkg-17.0.0-beta.3+26.1.2-fabric" = _ErO86u7Q;
        "pkg-17.0.0-beta.4+26.1.2-neoforge" = _Vr5rFTUt;
        "pkg-17.0.0-beta.4+26.1.2-fabric" = _i85GQMDQ;
        "pkg-17.0.0-beta.5+26.1.2-neoforge" = _IwM7vyNU;
        "pkg-17.0.0-beta.5+26.1.2-fabric" = _VwzhzZXR;
        "pkg-17.0.0-beta.6+26.1.2-neoforge" = _yacSBMNv;
        "pkg-17.0.0-beta.6+26.1.2-fabric" = _2eJ4s19k;
        "pkg-1.3.0+8.0.1-bta" = _7EjNfMFP;
        "pkg-17.0.0-beta.7+26.1.2-neoforge" = _qXQcYCpV;
        "pkg-17.0.0-beta.7+26.1.2-forge" = _kAsovBMJ;
        "pkg-17.0.0-beta.7+26.1.2-fabric" = _zxQHLTG7;
        "pkg-1.4.0+8.0.1-bta" = _BA6Nwh5q;
