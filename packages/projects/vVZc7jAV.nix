...
let
    versions = (let
        ...
        _2l2OeAlK = {
            "id" = "2l2OeAlK";
            "file" = "Dominion-4.9.1-release-lite.jar";
            "hash" = "sha512-LNA0qfMhC0CRrThfjNdLfUsWbkT+s9Tro81tNLsj03ggFQ0QzU0awrYuivvMpcRrdXNG/0Jq8Dii2hef80jJyA==";
        };
        _eGNkWidK = {
            "id" = "eGNkWidK";
            "file" = "Dominion-4.9.3-release-lite.jar";
            "hash" = "sha512-bnNOmDxLYrrQsm2mt6Op/zZiGa5V4HGCksfqSKOotTSchdApTAb5+pGSLtUKe1jPxrgH/NKNjosnOlPNgroaOg==";
        };
        _Hqz4jiTQ = {
            "id" = "Hqz4jiTQ";
            "file" = "Dominion-4.9.4-release-lite.jar";
            "hash" = "sha512-NPtEQiOYA48j9WVKZOkmGoZnHQK9QwmTeotEzRPqDp2Q2jGVa0YqO5ej2HwEIQtDbLzYk2cWWdqxnd2+Y/Ay9Q==";
        };
    in {
        "OpYkXFpy" = _OpYkXFpy;
        "E1gUYuzB" = _E1gUYuzB;
        ...
        "eGNkWidK" = _eGNkWidK;
        "Hqz4jiTQ" = _Hqz4jiTQ;
        "bukkit-1.20.1" = _Hqz4jiTQ;
        "bukkit-1.20.2" = _Hqz4jiTQ;
        "bukkit-1.20.3" = _Hqz4jiTQ;
        "bukkit-1.20.4" = _Hqz4jiTQ;
        "bukkit-1.20.5" = _Hqz4jiTQ;
        "bukkit-1.20.6" = _Hqz4jiTQ;
        "bukkit-1.21" = _Hqz4jiTQ;
        "bukkit-1.21.1" = _Hqz4jiTQ;
        "bukkit-1.21.2" = _Hqz4jiTQ;
        "bukkit-1.21.3" = _Hqz4jiTQ;
        "bukkit-1.21.4" = _Hqz4jiTQ;
        "bukkit-1.21.5" = _Hqz4jiTQ;
        "bukkit-1.21.6" = _Hqz4jiTQ;
        "bukkit-1.21.7" = _Hqz4jiTQ;
        "bukkit-1.21.8" = _Hqz4jiTQ;
        "bukkit-1.21.9" = _Hqz4jiTQ;
        "bukkit-1.21.10" = _Hqz4jiTQ;
        "bukkit-1.21.11" = _Hqz4jiTQ;
        "bukkit-26.1.2" = _Hqz4jiTQ;
        "bukkit-26.2" = _Hqz4jiTQ;
        "folia-1.20.1" = _Hqz4jiTQ;
        "folia-1.20.2" = _Hqz4jiTQ;
        "folia-1.20.3" = _Hqz4jiTQ;
        "folia-1.20.4" = _Hqz4jiTQ;
        "folia-1.20.5" = _Hqz4jiTQ;
        "folia-1.20.6" = _Hqz4jiTQ;
        "folia-1.21" = _Hqz4jiTQ;
        "folia-1.21.1" = _Hqz4jiTQ;
        "folia-1.21.2" = _Hqz4jiTQ;
        "folia-1.21.3" = _Hqz4jiTQ;
        "folia-1.21.4" = _Hqz4jiTQ;
        "folia-1.21.5" = _Hqz4jiTQ;
        "folia-1.21.6" = _Hqz4jiTQ;
        "folia-1.21.7" = _Hqz4jiTQ;
        "folia-1.21.8" = _Hqz4jiTQ;
        "folia-1.21.9" = _Hqz4jiTQ;
        "folia-1.21.10" = _Hqz4jiTQ;
        "folia-1.21.11" = _Hqz4jiTQ;
        "folia-26.1.2" = _Hqz4jiTQ;
        "folia-26.2" = _Hqz4jiTQ;
        "paper-1.20.1" = _Hqz4jiTQ;
        "paper-1.20.2" = _Hqz4jiTQ;
        "paper-1.20.3" = _Hqz4jiTQ;
        "paper-1.20.4" = _Hqz4jiTQ;
        "paper-1.20.5" = _Hqz4jiTQ;
        "paper-1.20.6" = _Hqz4jiTQ;
        "paper-1.21" = _Hqz4jiTQ;
        "paper-1.21.1" = _Hqz4jiTQ;
        "paper-1.21.2" = _Hqz4jiTQ;
        "paper-1.21.3" = _Hqz4jiTQ;
        "paper-1.21.4" = _Hqz4jiTQ;
        "paper-1.21.5" = _Hqz4jiTQ;
        "paper-1.21.6" = _Hqz4jiTQ;
        "paper-1.21.7" = _Hqz4jiTQ;
        "paper-1.21.8" = _Hqz4jiTQ;
        "paper-1.21.9" = _Hqz4jiTQ;
        "paper-1.21.10" = _Hqz4jiTQ;
        "paper-1.21.11" = _Hqz4jiTQ;
        "paper-26.1.2" = _Hqz4jiTQ;
        "paper-26.2" = _Hqz4jiTQ;
        "purpur-1.20.1" = _Hqz4jiTQ;
        "purpur-1.20.2" = _Hqz4jiTQ;
        "purpur-1.20.3" = _Hqz4jiTQ;
        "purpur-1.20.4" = _Hqz4jiTQ;
        "purpur-1.20.5" = _Hqz4jiTQ;
        "purpur-1.20.6" = _Hqz4jiTQ;
        "purpur-1.21" = _Hqz4jiTQ;
        "purpur-1.21.1" = _Hqz4jiTQ;
        "purpur-1.21.2" = _Hqz4jiTQ;
        "purpur-1.21.3" = _Hqz4jiTQ;
        "purpur-1.21.4" = _Hqz4jiTQ;
        "purpur-1.21.5" = _Hqz4jiTQ;
        "purpur-1.21.6" = _Hqz4jiTQ;
        "purpur-1.21.7" = _Hqz4jiTQ;
        "purpur-1.21.8" = _Hqz4jiTQ;
        "purpur-1.21.9" = _Hqz4jiTQ;
        "purpur-1.21.10" = _Hqz4jiTQ;
        "purpur-1.21.11" = _Hqz4jiTQ;
        "purpur-26.1.2" = _Hqz4jiTQ;
        "purpur-26.2" = _Hqz4jiTQ;
        "spigot-1.20.1" = _Hqz4jiTQ;
        "spigot-1.20.2" = _Hqz4jiTQ;
        "spigot-1.20.3" = _Hqz4jiTQ;
        "spigot-1.20.4" = _Hqz4jiTQ;
        "spigot-1.20.5" = _Hqz4jiTQ;
        "spigot-1.20.6" = _Hqz4jiTQ;
        "spigot-1.21" = _Hqz4jiTQ;
        "spigot-1.21.1" = _Hqz4jiTQ;
        "spigot-1.21.2" = _Hqz4jiTQ;
        "spigot-1.21.3" = _Hqz4jiTQ;
        "spigot-1.21.4" = _Hqz4jiTQ;
        "spigot-1.21.5" = _Hqz4jiTQ;
        "spigot-1.21.6" = _Hqz4jiTQ;
        "spigot-1.21.7" = _Hqz4jiTQ;
        "spigot-1.21.8" = _Hqz4jiTQ;
        "spigot-1.21.9" = _Hqz4jiTQ;
        "spigot-1.21.10" = _Hqz4jiTQ;
        "spigot-1.21.11" = _Hqz4jiTQ;
        "spigot-26.1.2" = _Hqz4jiTQ;
        "spigot-26.2" = _Hqz4jiTQ;
        ...
        "pkg-v4.9.2-release" = _2l2OeAlK;
        "pkg-v4.9.3-release" = _eGNkWidK;
        "pkg-v4.9.4-release" = _Hqz4jiTQ;
        "default" = _Hqz4jiTQ;
    });
