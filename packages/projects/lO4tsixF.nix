...
let
    versions = (let
        ...
        _2EkFsXm1 = {
            ...
            "hash" = "sha512-1ZxcZjxtRLIis+NFr0H0PmPrW4INtMzLMXuFiZSaor8nuDSCAW0eDnUodftP36IQ5nb5siKe9q4FAjSGaUuRRA==";
        };
    in {
        "5Vaq0Rxx" = _5Vaq0Rxx;
        "UJGZ6d7G" = _UJGZ6d7G;
        ...
        "4rbMNiZX" = _4rbMNiZX;
        "2EkFsXm1" = _2EkFsXm1;
        "bukkit-1.21.4" = _2EkFsXm1;
        "bukkit-1.21.5" = _2EkFsXm1;
        "bukkit-1.21.6" = _2EkFsXm1;
        "bukkit-1.21.7" = _2EkFsXm1;
        "bukkit-1.21.8" = _2EkFsXm1;
        "bukkit-1.21" = _2EkFsXm1;
        "bukkit-1.21.1" = _2EkFsXm1;
        "bukkit-1.21.2" = _2EkFsXm1;
        "bukkit-1.21.3" = _2EkFsXm1;
        "bukkit-1.21.9" = _2EkFsXm1;
        "bukkit-1.21.10" = _2EkFsXm1;
        "bukkit-1.21.11" = _2EkFsXm1;
        "paper-1.21.4" = _2EkFsXm1;
        "paper-1.21.5" = _2EkFsXm1;
        "paper-1.21.6" = _2EkFsXm1;
        "paper-1.21.7" = _2EkFsXm1;
        "paper-1.21.8" = _2EkFsXm1;
        "paper-1.21" = _2EkFsXm1;
        "paper-1.21.1" = _2EkFsXm1;
        "paper-1.21.2" = _2EkFsXm1;
        "paper-1.21.3" = _2EkFsXm1;
        "paper-1.21.9" = _2EkFsXm1;
        "paper-1.21.10" = _2EkFsXm1;
        "paper-1.21.11" = _2EkFsXm1;
        "purpur-1.21.4" = _2EkFsXm1;
        "purpur-1.21.5" = _2EkFsXm1;
        "purpur-1.21.6" = _2EkFsXm1;
        "purpur-1.21.7" = _2EkFsXm1;
        "purpur-1.21.8" = _2EkFsXm1;
        "purpur-1.21" = _2EkFsXm1;
        "purpur-1.21.1" = _2EkFsXm1;
        "purpur-1.21.2" = _2EkFsXm1;
        "purpur-1.21.3" = _2EkFsXm1;
        "purpur-1.21.9" = _2EkFsXm1;
        "purpur-1.21.10" = _2EkFsXm1;
        "purpur-1.21.11" = _2EkFsXm1;
        "spigot-1.21" = _2EkFsXm1;
        "spigot-1.21.1" = _2EkFsXm1;
        "spigot-1.21.2" = _2EkFsXm1;
        "spigot-1.21.3" = _2EkFsXm1;
        "spigot-1.21.4" = _2EkFsXm1;
        "spigot-1.21.5" = _2EkFsXm1;
        "spigot-1.21.6" = _2EkFsXm1;
        "spigot-1.21.7" = _2EkFsXm1;
        "spigot-1.21.8" = _2EkFsXm1;
        "spigot-1.21.9" = _2EkFsXm1;
        "spigot-1.21.10" = _2EkFsXm1;
        "spigot-1.21.11" = _2EkFsXm1;
        "pkg-V1.0" = _5Vaq0Rxx;
        "pkg-1.0.1" = _UJGZ6d7G;
        "pkg-1.0.2" = _fR8SgoEq;
        "pkg-1.0.3" = _KZwzDtCN;
