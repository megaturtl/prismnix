...
let
    versions = (let
        ...
        _dJA1qBML = {
            "id" = "dJA1qBML";
            "file" = "create_stats-1.13.0.jar";
            "hash" = "sha512-2+FxfLcQLcZXpFBfoOMa4wBMadnFfouBtJ455LLX5OsbAlqbOco4+ADoZuC62Bv02EeCMzPYrihjwsxKsaLpCg==";
        };
        _qNHHPdLy = {
            "id" = "qNHHPdLy";
    ...
    in {
        ...
        "pkg-0.10.30" = _dltl0unZ;
        "pkg-0.10.31" = _1w1Ji8kJ;
        "pkg-0.10.32_R" = _DpbBbw2R;
        "pkg-0.10.33" = _uw4ZXVFd;
        "pkg-0.10.35.T1" = _LlesTzJc;
