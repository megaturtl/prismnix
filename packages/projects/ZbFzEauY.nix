...
let
    versions = (let
        ...
        _FGcQSnqq = {
            "id" = "FGcQSnqq";
            "file" = "packedup-1.1.1-forge-mc1.12.jar";
            "hash" = "sha512-WWQsE+i8KbZWtJyOCcOa8R4/7VjONw94473KJng03CAuh0C7FyS9o6ZNywBFRLWd2I2rfdYo3JqORrKGv0T+/A==";
        };
        _55rxFtsc = {
            "id" = "55rxFtsc";
            "file" = "packedup-1.1.1-forge-mc1.14.jar";
            "hash" = "sha512-EElbO7mPPJZoX7yIKPDDrFUQaC+kSxbOFK08zeEmjjEwGNTem2ulwRlszU3LCPH2IqRkHniOAD+kAE7sPufr/Q==";
        };
        _uXFJy9dO = {
            "id" = "uXFJy9dO";
            "file" = "packedup-1.1.1-forge-mc1.15.jar";
            "hash" = "sha512-nF/A+uLRTtXXvvxqllbaSZ/zaFsRzMGpyUD4i+k6fSsTatWbQrVx0Da+R0D26f64784qBPHMeQmyh0Cz8FdjuQ==";
        };
        _M6JfFhtr = {
            "id" = "M6JfFhtr";
            "file" = "packedup-1.1.1-forge-mc1.16.jar";
            "hash" = "sha512-9A8oGCBZ+QIO3qV0pxokUC3YVioyKCQXkZhwxNtYlyf/u5bl/kljLuADerlnxywZ7QRa4GRG5NbpY8MPiMEmIA==";
        };
        _uKXxZOY4 = {
            "id" = "uKXxZOY4";
            "file" = "packedup-1.1.1-forge-mc1.17.jar";
            "hash" = "sha512-kYEfi737dV2lJwVrSgxH3rSk1GMeA9hHa1ZeGtL9maYn48Sd7cV38PGw0wn14QrtBRmLYc38evGEB2rhBKA2Tw==";
        };
        _RXAEMVET = {
            "id" = "RXAEMVET";
            "file" = "packedup-1.1.1-forge-mc1.18.jar";
            "hash" = "sha512-LLL5UBG7CDPPAbDmssWFz8Lhy4rkF+Eg2QlEJExg33TCIpp/9QOOBJw0phyheXvaglrp1QteWTsxi1vQG00tvw==";
        };
        _lwuSP5XT = {
            "id" = "lwuSP5XT";
            "file" = "packedup-1.1.1-forge-mc1.19.2.jar";
            "hash" = "sha512-1KpedcxhpxJWgLGhJ2VAAHrdgNsZz2HVvAusq9d4TfZN8GNbjJsZYAmK6jfWUk93tVHJlVNlD0U3pDAH0iG3pw==";
        };
        _O7Yn9Dsb = {
            "id" = "O7Yn9Dsb";
            "file" = "packedup-1.1.1-forge-mc1.19.3.jar";
            "hash" = "sha512-59Piqj5wmTRuI5I/kp0utncgOqjr3EjVkyZhj7ufFp18zklo7XBlR3qwXTnZaNQspmLYsvdNMvV39ra0p/X2dg==";
        };
        _yW43eXzn = {
            "id" = "yW43eXzn";
            "file" = "packedup-1.1.1-forge-mc1.19.4.jar";
            "hash" = "sha512-IZ0LmeK8EItxp/FEMjX1+8DMTZaDpBMSnm8qNAKg8OwUezZceP2ZWEmCjlIKBMJ4JSzhWL3QXkW83CB32PDnrQ==";
        };
        _UkFec0Aq = {
            "id" = "UkFec0Aq";
            "file" = "packedup-1.1.1-forge-mc1.20.1.jar";
            "hash" = "sha512-R1ryvcqdY4qG1M1gS4rmbNYmAABifq/KTqh7jHcavWxdyMM+wwo4++0Fpngc8aX7ZAPKyQhsQFeGsccdcoFZaA==";
        };
        _HyDZMUrh = {
            "id" = "HyDZMUrh";
            "file" = "packedup-1.1.1-forge-mc1.20.2.jar";
            "hash" = "sha512-dzMIw4pKTsoih1dQJ4ON/elRM9vcZm/+F3uvu8FUpA1GQXxEe9QRpk9shSKv0IUCQNwvyJKqAxgSiGirxuXyEw==";
        };
        _kLR0Qoew = {
            "id" = "kLR0Qoew";
            "file" = "packedup-1.1.1-forge-mc1.20.4.jar";
            "hash" = "sha512-IGrobGF/WdiUnl/L/+YVjWbjTSmisGDvCC5PJeFz1jBcE8iLl5JVYVn5Jn3lRwNWPkUk5WSb4rUX7QSse6wldg==";
        };
        _S99D7kg0 = {
            "id" = "S99D7kg0";
            "file" = "packedup-1.1.1-forge-mc1.20.6.jar";
            "hash" = "sha512-SoqZHbcjzEw55hDcvnGMXKi5nRzXiT/JETZ3J4ct0kBZafi/pj8fqzdd7qs0SsO8TZHVN4gWy8tyQGj9X3I2Rg==";
        };
        _BHKXRYtR = {
            "id" = "BHKXRYtR";
            "file" = "packedup-1.1.1-forge-mc1.21.jar";
            "hash" = "sha512-dbYfMtuk2kOsU9WczawDRX8MJwuxJM30CQnhixW5CkDFC2yDAh5xmMdFWbKnGDgqZBmUxOKG7i++hDADA++xZg==";
        };
        _E29Iy3dG = {
            "id" = "E29Iy3dG";
            "file" = "packedup-1.1.1-forge-mc1.21.3.jar";
            "hash" = "sha512-5BclkByYPmTwLG7nbmRrkyL1DJiZ0v2zwsdHduBKRqXuD+ZDo+AiQhD5WgKmiyNS0G32h02ROHBy2BvxHgO82A==";
        };
        _FiizglBo = {
            "id" = "FiizglBo";
            "file" = "packedup-1.1.1-forge-mc1.21.4.jar";
            "hash" = "sha512-5Xvpvb1QjKX/qpn4bgfLgP3e1YvwvyHKwraO3ZOObVYEOa8Xfqidv/mmf6gErt8ANP5rCeNbJeYOJJTS606J4g==";
        };
        _1yYbAnDJ = {
            "id" = "1yYbAnDJ";
            "file" = "packedup-1.1.1-forge-mc1.21.5.jar";
            "hash" = "sha512-bYRhE6wkQNpIJc9kX9Wvry/XVH0EY55GmQdkkN+nWrt660ccBtbj+1NCDd/1bw1Eu+LhMRwHpkbzHLb3j+TNfA==";
        };
        _b1WVZ8LI = {
            "id" = "b1WVZ8LI";
            "file" = "packedup-1.1.1-forge-mc1.21.8.jar";
            "hash" = "sha512-at5hsphDWZ9lJNzqjs1vbmPvTafq8PZDeL0i3j8NiRnjxB2jszlee9Yj+T+t4pub//S3RH+t4wZG99oDkkC9Nw==";
        };
        _7GaX4ZMO = {
            "id" = "7GaX4ZMO";
            "file" = "packedup-1.1.1-forge-mc1.21.10.jar";
            "hash" = "sha512-+oOJoWQsiW6Pm5ZTBMbUROc/7rQMXm6ZN/pYJJ0mIzsVwALLj50XHFyrEAf+RnJzUcq9ceb9ozBe7yhGFi2qEA==";
        };
        _dOoX7DwE = {
            "id" = "dOoX7DwE";
            "file" = "packedup-1.1.1-forge-mc1.21.11.jar";
            "hash" = "sha512-dKmgr6YdpVpVmdVW/l/yn4PS6TgOk7/AZMOkgh4r8/sIJE+ugdpv33iAq5ZJbshQZmz7m/F5UhcYRJxnajY2Eg==";
        };
        _ONQot6hr = {
            "id" = "ONQot6hr";
            "file" = "packedup-1.1.1-forge-mc26.1.jar";
            "hash" = "sha512-OKxnoVGhW6MxPJE8jOb9ZxOQuLxI1NAhBTrlbHXppmT/XC4p6cygXxZ1SLYVMZcg2RCEGyXP3Y8wkn2vC336tg==";
        };
        _shbTHtwL = {
            "id" = "shbTHtwL";
            "file" = "packedup-1.1.1-forge-mc26.2.jar";
            "hash" = "sha512-Q9adlCGszyDFa0q+S5UscWdWhI74Q/uD4LwHGDivgGS5n4cweUNbOqxTHzjqoK5z2KfkMGo65/hXmdtKWuBc+w==";
        };
        _lsnGw7FA = {
            "id" = "lsnGw7FA";
            "file" = "packedup-1.1.1-fabric-mc1.18.jar";
            "hash" = "sha512-2NedVAT1O78e5d3fkmbV9cf3i8M6im1N6FOWjBNE9RNAL+G3Jp0UEUntdKWYvkeqNryzvnkTRerhUsTsGwu2ig==";
        };
        _x9MlqNJ5 = {
            "id" = "x9MlqNJ5";
            "file" = "packedup-1.1.1-fabric-mc1.19.2.jar";
            "hash" = "sha512-ORDsSJ7GOxxE2ZXraZ8e+B7RoWNjf9TDi/n/L6SK7qq00bI2sgG/+YoV0DKYUntgaoF7rqzrHQd6Uo5wEmjQ+A==";
        };
        _aUWDQ2uF = {
            "id" = "aUWDQ2uF";
            "file" = "packedup-1.1.1-fabric-mc1.19.4.jar";
            "hash" = "sha512-KoPdRKaY17d9bUbjOhrvkaGPHHA7j+I3FJn27pw5O2t0v5WST9CJ1yWanDFzOE9/1Yza8UsIy4uwpY7FoYe8yw==";
        };
        _raY2UrPA = {
            "id" = "raY2UrPA";
            "file" = "packedup-1.1.1-fabric-mc1.20.1.jar";
            "hash" = "sha512-0WK7WsWb43L8ST8jnI0iYUdIQJMuy0YDM+zPYSMjvJXJXAhwIsX8ObH1Thsdt6l8I/u0N07pgFD515DXuLgBCw==";
        };
        _Y2yC9jDH = {
            "id" = "Y2yC9jDH";
            "file" = "packedup-1.1.1-fabric-mc1.20.2.jar";
            "hash" = "sha512-0ZRkUUe6qTwHqiVQfE1JPjVwVuCjfBsN+uim3xfVZY3ooPxrYdwJyiTPCTdXLzDzeNunheVuzrfg+BeTFLMsaQ==";
        };
        _JvGqezei = {
            "id" = "JvGqezei";
            "file" = "packedup-1.1.1-fabric-mc1.20.4.jar";
            "hash" = "sha512-xT1zpVCNP7lTikYe5Xfc5ehK+341zOguixhWZ1CzgkXG0swJfZuPyc8SUYafF/gB5FpcoaeR8gjHoxAiNETRlg==";
        };
        _Hy9Lt8AQ = {
            "id" = "Hy9Lt8AQ";
            "file" = "packedup-1.1.1-fabric-mc1.20.6.jar";
            "hash" = "sha512-bFIDCyEqOzzjxL6rf4NXkHPYEKFQPNqryN1I6Ke3q9h9W+oScCojeVKuaI9WCUBbjQJfUSxx6OhNU1F6R4xnsA==";
        };
        _NEzwIdIw = {
            "id" = "NEzwIdIw";
            "file" = "packedup-1.1.1-fabric-mc1.21.jar";
            "hash" = "sha512-YXVO7+tqomXgNEglClUBGCUEm6rLiphlXB2ePIZFYds+AWAbj9PqiUL4dTnftBndvDf4Jhjiahirutt9VTcXhA==";
        };
        _4eC1dtjj = {
            "id" = "4eC1dtjj";
            "file" = "packedup-1.1.1-fabric-mc1.21.3.jar";
            "hash" = "sha512-I17z5jicHiJq1W0EIYp+nM+qadVlDlcDSKRCFROAkcTnf3c/YPdawUQGLqVTx1pWhuAuFRca/QgfuNyQ/pQYUw==";
        };
        _CNV764la = {
            "id" = "CNV764la";
            "file" = "packedup-1.1.1-fabric-mc1.21.4.jar";
            "hash" = "sha512-baBSPOpIR7S26/jtjZwHf4Le+64zZLfuwgWu9HR5sggmqcoW9vZ9JXqKihOOF557rgELgf4ySR4Lol1uW1y7zQ==";
        };
        _Z7clbOO0 = {
            "id" = "Z7clbOO0";
            "file" = "packedup-1.1.1-fabric-mc1.21.5.jar";
            "hash" = "sha512-ScUTxAqCSJstBNIXPN9rm4GbT76iJt/+QzLOOBj6dGhvpGdrFmkIwbwMNWWEpmSGkm8YSd9LhtXGppJrhhSywQ==";
        };
        _68qm6mHe = {
            "id" = "68qm6mHe";
            "file" = "packedup-1.1.1-fabric-mc1.21.8.jar";
            "hash" = "sha512-K5RBW/dbtQ4D4Zi1re/vPUd5E8NdHiHI7FVQcFHB6OqBX2rKammpxHVcMzIR8YWP+Ifp/Jir/RgCthrFoaJRqw==";
        };
        _ceKTN90i = {
            "id" = "ceKTN90i";
            "file" = "packedup-1.1.1-fabric-mc1.21.10.jar";
            "hash" = "sha512-8nQT7TysXYu6Aevf/m/ocSAPZqKuzCKqlx7stpnrpnhCYlR5b2rBqPXmCtLNll4k9pV5Xx3jm1AMDgsR9OnFXg==";
        };
        _ehqxztOS = {
            "id" = "ehqxztOS";
            "file" = "packedup-1.1.1-fabric-mc1.21.11.jar";
            "hash" = "sha512-jC57nMF8GLv0fvkS/6RyidawRaodOstIhN2XL3od0WvK4DpEM7g2HvkekIhfgj0LF8MXZUEfxGYKANXgpIXAgQ==";
        };
        _JAU4tIH6 = {
            "id" = "JAU4tIH6";
            "file" = "packedup-1.1.1-fabric-mc26.1.jar";
            "hash" = "sha512-u/7m961/hjO36wSWK/7eqNz7IrbiMmG076sRlyaw5bUp+wMliRV5A1jYVD8ATV/eOKHA77AdqQ6j/yH0cmt2mQ==";
        };
        _fOSZLcB0 = {
            "id" = "fOSZLcB0";
            "file" = "packedup-1.1.1-fabric-mc26.2.jar";
            "hash" = "sha512-otzhT7q8J+s9TJxkAuoEIJgKp0zjEDeE5h9HMmv0awuj6pUFfJR6KcyGtEjRfbZoxIPkThnxl+DIiZpznzguoA==";
        };
        _crBTEDCL = {
            "id" = "crBTEDCL";
            "file" = "packedup-1.1.1-neoforge-mc1.20.4.jar";
            "hash" = "sha512-X/EdCTegrhIzuNxvDHOKOrqVHKQl7X4n6jurEEbULKc/mNPqUOGYFZyPrwq54pioYrVgeJKkJRdIJL4OUJiQUA==";
        };
        _3GTA0Ab6 = {
            "id" = "3GTA0Ab6";
            "file" = "packedup-1.1.1-neoforge-mc1.20.6.jar";
            "hash" = "sha512-D6nR6QbDrZtiA1yiLg+JmYab4ICqfkPynDGujm7u0MQhX/l4Z61MaTqaLbMSeFSt/IcuYCLQ1h9lD9NWpk1ywg==";
        };
        _l8RlFGEp = {
            "id" = "l8RlFGEp";
            "file" = "packedup-1.1.1-neoforge-mc1.21.jar";
            "hash" = "sha512-NwE9GkS2xkrflWemGId/DqZq1Z+gMxQl+bv5WDACbrKeBlS/obUd6pnn2Bj8+6JwFCkG6K0RIXgh2o3EYlNQmw==";
        };
        _VIgiQ6CC = {
            "id" = "VIgiQ6CC";
            "file" = "packedup-1.1.1-neoforge-mc1.21.3.jar";
            "hash" = "sha512-WbPMhwsH2tX7EEy8LCj2GfJ8MURqacFhUz0IrTbw9hw/NbdSlpmvY3+ArNMkeMRTwAQzYPM96GzalsznJhmCaA==";
        };
        _OSs54fEO = {
            "id" = "OSs54fEO";
            "file" = "packedup-1.1.1-neoforge-mc1.21.4.jar";
            "hash" = "sha512-cyGpMpSwGKOm7gZVFOZcAmJnnqbT08xPGSm0MwWa+Joo3wBPHh+mHqosjvpITq4IZJ8dGsM6SE7jK921V5RX6Q==";
        };
        _49Zt957C = {
            "id" = "49Zt957C";
            "file" = "packedup-1.1.1-neoforge-mc1.21.5.jar";
            "hash" = "sha512-v8LseJJAAOQhgBxb/CXg0GNpSu3h8bjiRZch+DCWmXRJm+xnAUEM4Mm5ws9GScnivIQ0nVpR3UYlAmoVL1youg==";
        };
        _hBpgRFhK = {
            "id" = "hBpgRFhK";
            "file" = "packedup-1.1.1-neoforge-mc1.21.8.jar";
            "hash" = "sha512-MybSCikWdmmtEEl737IuZ6U5SEUHaflYG3ec3BJPhnz02D7LxmzBydyzNWZPJJ+wzCfusrQgQh1EWh6olPGzqw==";
        };
        _ohPQdHDr = {
            "id" = "ohPQdHDr";
            "file" = "packedup-1.1.1-neoforge-mc1.21.10.jar";
            "hash" = "sha512-oNlaXNfVObvFk6WkNAV88VtcdHd5HgIqw7KBrGrASms88Tq8/nXTMPlUztUEkGqFtz3DlYKk+O9huwrLbw+IHA==";
        };
        _FUymeQXQ = {
            "id" = "FUymeQXQ";
            "file" = "packedup-1.1.1-neoforge-mc1.21.11.jar";
            "hash" = "sha512-DMUWZXCaJY1K+I8U3Qr+ATBAvUdTFuwCZhWnNJrsrd4q3fJCDgiM+zsLSXHn6W97ZtpxEA9KC+razA7YwuhIzw==";
        };
        _8BaJWtsl = {
            "id" = "8BaJWtsl";
            "file" = "packedup-1.1.1-neoforge-mc26.1.jar";
            "hash" = "sha512-L4ILbyK/87moWZ3Sc4bqiZdcerjNuDr7O6/6G7Uh2+GEidd/3hINiI518tt/2HMJzcb7bi0GZJqJ3mFVdlRA5A==";
        };
        _mEkrPug0 = {
            "id" = "mEkrPug0";
    ...
    in {
        ...
        "forge-1.14" = _55rxFtsc;
        "forge-1.14.1" = _55rxFtsc;
        "forge-1.14.2" = _55rxFtsc;
        "forge-1.14.3" = _55rxFtsc;
        "forge-1.14.4" = _55rxFtsc;
        "forge-1.15" = _uXFJy9dO;
        "forge-1.15.1" = _uXFJy9dO;
        "forge-1.15.2" = _uXFJy9dO;
        "forge-1.16" = _M6JfFhtr;
        "forge-1.16.1" = _M6JfFhtr;
        "forge-1.16.2" = _M6JfFhtr;
        "forge-1.16.3" = _M6JfFhtr;
        "forge-1.16.4" = _M6JfFhtr;
        "forge-1.16.5" = _M6JfFhtr;
        "forge-1.17" = _uKXxZOY4;
        "forge-1.17.1" = _uKXxZOY4;
        "forge-1.18" = _RXAEMVET;
        "forge-1.18.1" = _RXAEMVET;
        "forge-1.18.2" = _RXAEMVET;
        "forge-1.19" = _lwuSP5XT;
        "forge-1.19.1" = _lwuSP5XT;
        "forge-1.19.2" = _lwuSP5XT;
        "forge-1.19.3" = _O7Yn9Dsb;
        "forge-1.19.4" = _yW43eXzn;
        "forge-1.20" = _UkFec0Aq;
        "forge-1.20.1" = _UkFec0Aq;
        "forge-1.20.2" = _HyDZMUrh;
        "forge-1.20.3" = _kLR0Qoew;
        "forge-1.20.4" = _kLR0Qoew;
        "forge-1.20.5" = _S99D7kg0;
        "forge-1.20.6" = _S99D7kg0;
        "forge-1.21" = _BHKXRYtR;
        "forge-1.21.1" = _BHKXRYtR;
        "forge-1.21.2" = _E29Iy3dG;
        "forge-1.21.3" = _E29Iy3dG;
        "forge-1.21.4" = _FiizglBo;
        "forge-1.21.5" = _1yYbAnDJ;
        "forge-1.21.6" = _b1WVZ8LI;
        "forge-1.21.7" = _b1WVZ8LI;
        "forge-1.21.8" = _b1WVZ8LI;
        "forge-1.21.9" = _7GaX4ZMO;
        "forge-1.21.10" = _7GaX4ZMO;
        "forge-1.21.11" = _dOoX7DwE;
        "forge-26.1" = _ONQot6hr;
        "forge-26.1.1" = _ONQot6hr;
        "forge-26.1.2" = _ONQot6hr;
        "forge-26.2" = _shbTHtwL;
        "fabric-1.19.4" = _aUWDQ2uF;
        "fabric-1.18" = _lsnGw7FA;
        "fabric-1.18.1" = _lsnGw7FA;
        "fabric-1.18.2" = _lsnGw7FA;
        "fabric-1.19.2" = _x9MlqNJ5;
        "fabric-1.20" = _raY2UrPA;
        "fabric-1.20.1" = _raY2UrPA;
        "fabric-1.20.2" = _Y2yC9jDH;
        "fabric-1.20.3" = _JvGqezei;
        "fabric-1.20.4" = _JvGqezei;
        "fabric-1.20.5" = _Hy9Lt8AQ;
        "fabric-1.20.6" = _Hy9Lt8AQ;
        "fabric-1.21" = _NEzwIdIw;
        "fabric-1.21.1" = _NEzwIdIw;
        "fabric-1.21.2" = _4eC1dtjj;
        "fabric-1.21.3" = _4eC1dtjj;
        "fabric-1.21.4" = _CNV764la;
        "fabric-1.21.5" = _Z7clbOO0;
        "fabric-1.21.6" = _68qm6mHe;
        "fabric-1.21.7" = _68qm6mHe;
        "fabric-1.21.8" = _68qm6mHe;
        "fabric-1.21.9" = _ceKTN90i;
        "fabric-1.21.10" = _ceKTN90i;
        "fabric-1.21.11" = _ehqxztOS;
        "fabric-26.1" = _JAU4tIH6;
        ...
        "neoforge-1.20.3" = _crBTEDCL;
        "neoforge-1.20.4" = _crBTEDCL;
        "neoforge-1.20.5" = _3GTA0Ab6;
        "neoforge-1.20.6" = _3GTA0Ab6;
        "neoforge-1.21" = _l8RlFGEp;
        "neoforge-1.21.1" = _l8RlFGEp;
        "neoforge-1.21.2" = _VIgiQ6CC;
        "neoforge-1.21.3" = _VIgiQ6CC;
        "neoforge-1.21.4" = _OSs54fEO;
        "neoforge-1.21.5" = _49Zt957C;
        "neoforge-1.21.6" = _hBpgRFhK;
        "neoforge-1.21.7" = _hBpgRFhK;
        "neoforge-1.21.8" = _hBpgRFhK;
        "neoforge-1.21.9" = _ohPQdHDr;
        "neoforge-1.21.10" = _ohPQdHDr;
        "neoforge-1.21.11" = _FUymeQXQ;
        ...
        "quilt-1.19.2" = _x9MlqNJ5;
        "quilt-1.19.4" = _aUWDQ2uF;
        "quilt-1.20" = _raY2UrPA;
        "quilt-1.20.1" = _raY2UrPA;
        "quilt-1.20.2" = _Y2yC9jDH;
        "quilt-1.20.3" = _JvGqezei;
        "quilt-1.20.4" = _JvGqezei;
        "quilt-1.20.5" = _Hy9Lt8AQ;
        "quilt-1.20.6" = _Hy9Lt8AQ;
        "quilt-1.21" = _NEzwIdIw;
        "quilt-1.21.1" = _NEzwIdIw;
        "quilt-1.21.2" = _4eC1dtjj;
        "quilt-1.21.3" = _4eC1dtjj;
        "quilt-1.21.4" = _CNV764la;
        "quilt-1.21.5" = _Z7clbOO0;
        "quilt-1.21.6" = _68qm6mHe;
        "quilt-1.21.7" = _68qm6mHe;
        "quilt-1.21.8" = _68qm6mHe;
        "quilt-1.21.9" = _ceKTN90i;
        "quilt-1.21.10" = _ceKTN90i;
        "quilt-1.21.11" = _ehqxztOS;
        "quilt-26.1" = _JAU4tIH6;
        ...
        "pkg-1.1.1-forge-mc1.12" = _FGcQSnqq;
        "pkg-1.1.1-forge-mc1.14" = _55rxFtsc;
        "pkg-1.1.1-forge-mc1.15" = _uXFJy9dO;
        "pkg-1.1.1-forge-mc1.16" = _M6JfFhtr;
        "pkg-1.1.1-forge-mc1.17" = _uKXxZOY4;
        "pkg-1.1.1-forge-mc1.18" = _RXAEMVET;
        "pkg-1.1.1-forge-mc1.19.2" = _lwuSP5XT;
        "pkg-1.1.1-forge-mc1.19.3" = _O7Yn9Dsb;
        "pkg-1.1.1-forge-mc1.19.4" = _yW43eXzn;
        "pkg-1.1.1-forge-mc1.20.1" = _UkFec0Aq;
        "pkg-1.1.1-forge-mc1.20.2" = _HyDZMUrh;
        "pkg-1.1.1-forge-mc1.20.4" = _kLR0Qoew;
        "pkg-1.1.1-forge-mc1.20.6" = _S99D7kg0;
        "pkg-1.1.1-forge-mc1.21" = _BHKXRYtR;
        "pkg-1.1.1-forge-mc1.21.3" = _E29Iy3dG;
        "pkg-1.1.1-forge-mc1.21.4" = _FiizglBo;
        "pkg-1.1.1-forge-mc1.21.5" = _1yYbAnDJ;
        "pkg-1.1.1-forge-mc1.21.8" = _b1WVZ8LI;
        "pkg-1.1.1-forge-mc1.21.10" = _7GaX4ZMO;
        "pkg-1.1.1-forge-mc1.21.11" = _dOoX7DwE;
        "pkg-1.1.1-forge-mc26.1" = _ONQot6hr;
        "pkg-1.1.1-forge-mc26.2" = _shbTHtwL;
        "pkg-1.1.1-fabric-mc1.18" = _lsnGw7FA;
        "pkg-1.1.1-fabric-mc1.19.2" = _x9MlqNJ5;
        "pkg-1.1.1-fabric-mc1.19.4" = _aUWDQ2uF;
        "pkg-1.1.1-fabric-mc1.20.1" = _raY2UrPA;
        "pkg-1.1.1-fabric-mc1.20.2" = _Y2yC9jDH;
        "pkg-1.1.1-fabric-mc1.20.4" = _JvGqezei;
        "pkg-1.1.1-fabric-mc1.20.6" = _Hy9Lt8AQ;
        "pkg-1.1.1-fabric-mc1.21" = _NEzwIdIw;
        "pkg-1.1.1-fabric-mc1.21.3" = _4eC1dtjj;
        "pkg-1.1.1-fabric-mc1.21.4" = _CNV764la;
        "pkg-1.1.1-fabric-mc1.21.5" = _Z7clbOO0;
        "pkg-1.1.1-fabric-mc1.21.8" = _68qm6mHe;
        "pkg-1.1.1-fabric-mc1.21.10" = _ceKTN90i;
        "pkg-1.1.1-fabric-mc1.21.11" = _ehqxztOS;
        "pkg-1.1.1-fabric-mc26.1" = _JAU4tIH6;
        "pkg-1.1.1-fabric-mc26.2" = _fOSZLcB0;
        "pkg-1.1.1-neoforge-mc1.20.4" = _crBTEDCL;
        "pkg-1.1.1-neoforge-mc1.20.6" = _3GTA0Ab6;
        "pkg-1.1.1-neoforge-mc1.21" = _l8RlFGEp;
        "pkg-1.1.1-neoforge-mc1.21.3" = _VIgiQ6CC;
        "pkg-1.1.1-neoforge-mc1.21.4" = _OSs54fEO;
        "pkg-1.1.1-neoforge-mc1.21.5" = _49Zt957C;
        "pkg-1.1.1-neoforge-mc1.21.8" = _hBpgRFhK;
        "pkg-1.1.1-neoforge-mc1.21.10" = _ohPQdHDr;
