...
let
    versions = (let
        ...
        _DVQFhrV3 = {
            ...
            "hash" = "sha512-QMewt6t+nlMsV2DYnXNZTJkgqsDa7+U37VqJpcEXEvCOooCTpUUrqvd/LHYgu1ZuzIblKIMjbuAfKffJ5skcMA==";
        };
        _pPGFgA7j = {
            "id" = "pPGFgA7j";
            "file" = "copycats-3.0.8+mc.1.20.1-fabric.jar";
            "hash" = "sha512-8UrEKtynm33t8J/kP9WxnTqy117Q5edLUi5cmEh1DV98HuumW2gXeFXc6rjclGlYlZYg9MFOeeZWNEv5LzMbEw==";
        };
        _qFxYcLc0 = {
            "id" = "qFxYcLc0";
            "file" = "copycats-3.0.8+mc.1.20.1-forge.jar";
            "hash" = "sha512-Mrh3f5pUBNt9cqbvnit87mz3Hms+EaIXpX0gYRrkUJNt8MbozDwKr2mMhkQMeAQmAyimdqC/DblzuElveTPfQg==";
        };
        _8cABiKTp = {
            "id" = "8cABiKTp";
            "file" = "copycats-3.0.7+mc.1.21.1-neoforge.jar";
            "hash" = "sha512-ctPShkaim53m4p/MrCWRMhGY3YrRqC8pDLOf9CIBFP0dMFm1cwvph175x5suIXmi5wgt/MWTTkBb3wprDxzQFQ==";
        };
        _ZwGlMBIk = {
            "id" = "ZwGlMBIk";
            "file" = "copycats-3.0.8+mc.1.21.1-neoforge.jar";
        ...
        _bPYeUWZx = {
            ...
            "hash" = "sha512-Qytc3kc5dkdrBykXJxDTKAVXbQw6X9ZtIfiC2WzvDE7vG4Xk46GjFuKtxHN4SxHhVrAmWw9ivP1bA1pv99/Mbg==";
        };
        _E0aagkjc = {
            "id" = "E0aagkjc";
            "file" = "copycats-3.0.10+mc.1.20.1-fabric.jar";
            "hash" = "sha512-T1SiPhWhkIJhla1+0uxI7F6bz13cc3n9g3pD1Adv5Q4vs9BnSy8BjRAdbNA2E7gJdeb74g3qKr/ICYu+v/Dglg==";
        };
        _LlMxIysb = {
            "id" = "LlMxIysb";
            "file" = "copycats-3.0.10+mc.1.20.1-forge.jar";
            "hash" = "sha512-uS1QbrIbRuGtALU+Mp54cLS1wLPL/5p1tWDeccDZUJElADhLLqOW9rCjppOIp80b6v9xHPdQHEzFUSZzM51G/w==";
        };
    in {
        "KaWzxkbC" = _KaWzxkbC;
        "irW6AAOQ" = _irW6AAOQ;
        ...
        "E0aagkjc" = _E0aagkjc;
        "LlMxIysb" = _LlMxIysb;
        "forge-1.20.1" = _LlMxIysb;
        "forge-1.19.2" = _ZURtfrZY;
        "forge-1.18.2" = _PAs43lPf;
        "fabric-1.20.1" = _E0aagkjc;
        "fabric-1.19.2" = _2i0xjpG2;
        "fabric-1.18.2" = _DJEPdsxc;
        "neoforge-1.20.1" = _LlMxIysb;
        "neoforge-1.21.1" = _bPYeUWZx;
        "pkg-1.1.0-mc1.20.1" = _KaWzxkbC;
        "pkg-1.1.0-mc1.19.2" = _irW6AAOQ;
        "pkg-1.1.0-mc1.18.2" = _PA6ZJutS;
        "pkg-1.1.0-mc1.20.1-fabric" = _yzIUG8qO;
        "pkg-1.1.0-mc1.19.2-fabric" = _xTPwJSk1;
        "pkg-1.1.0-mc1.18.2-fabric" = _Bm4EYWGi;
        "pkg-1.1.1-mc1.20.1-fabric" = _8020527j;
        "pkg-1.1.1-mc1.19.2-fabric" = _eu2LKyM6;
        "pkg-1.1.1-mc1.18.2-fabric" = _KshWQssF;
        "pkg-1.18.2-1.2.0" = _mz6UJrc5;
        "pkg-1.19.2-1.2.0" = _AOpAQAOA;
        "pkg-1.20.1-1.2.0" = _L3l4jW7j;
        "pkg-1.18.2-1.2.1" = _ORj0hM3r;
        "pkg-1.19.2-1.2.1" = _nvUBsgqf;
        "pkg-1.20.1-1.2.1" = _cJIWp8cv;
        "pkg-1.18.2-1.2.2" = _5EkA6AQZ;
        "pkg-1.19.2-1.2.2" = _DxYOe2Ym;
        "pkg-1.20.1-1.2.2" = _jgOQ8nj6;
        "pkg-1.18.2-1.2.5" = _g3m9RPx3;
        "pkg-1.19.2-1.2.5" = _hJh4t3fm;
        "pkg-1.20.1-1.2.5" = _3aFxGW18;
        "pkg-1.20.1-1.2.6" = _BYUGDUG0;
        "pkg-1.20.1-1.3.0" = _lgy7ojG5;
        "pkg-1.19.2-1.3.0" = _LjBP2nSC;
        "pkg-1.18.2-1.3.0" = _45R2NaCg;
        "pkg-1.20.1-1.3.1" = _6MEpzmfX;
        "pkg-1.19.2-1.3.1" = _KT25YImT;
        "pkg-1.18.2-1.3.1" = _zshaanfF;
        "pkg-fabric.1.20.1-1.3.2" = _JmibGEYK;
        "pkg-forge.1.20.1-1.3.2" = _DlYBdaIA;
        "pkg-fabric.1.19.2-1.3.2" = _dVlRE48M;
        "pkg-forge.1.19.2-1.3.2" = _8Va6yYQl;
        "pkg-forge.1.18.2-1.3.2" = _JVhcrIOO;
        "pkg-fabric.1.18.2-1.3.2" = _ZwmZYoGi;
        "pkg-fabric.1.20.1-1.3.3" = _zKGWCj4Y;
        "pkg-forge.1.20.1-1.3.3" = _iQY7J3rA;
        "pkg-forge.1.19.2-1.3.3" = _6exPlg0s;
        "pkg-fabric.1.19.2-1.3.3" = _yOaeLpUZ;
        "pkg-forge.1.18.2-1.3.3" = _r3DYHUkj;
        "pkg-fabric.1.18.2-1.3.3" = _vJwOWpYq;
        "pkg-fabric.1.20.1-1.3.4" = _FiaB6nOi;
        "pkg-forge.1.20.1-1.3.4" = _ofIEaVKl;
        "pkg-fabric.1.19.2-1.3.4" = _6Zc4htMn;
        "pkg-forge.1.19.2-1.3.4" = _5YMYRFXm;
        "pkg-fabric.1.18.2-1.3.4" = _qA6DiPw5;
        "pkg-forge.1.18.2-1.3.4" = _HraWSX3l;
        "pkg-1.3.5+mc.1.20.1-fabric" = _cTM41Sbh;
        "pkg-1.3.5+mc.1.20.1-forge" = _hSwIAVAu;
        "pkg-1.3.6+mc.1.20.1-forge" = _gIUSc8WV;
        "pkg-1.3.6+mc.1.20.1-fabric" = _t8gHl18M;
        "pkg-1.3.7+mc.1.20.1-forge" = _ET9s6C78;
        "pkg-1.3.7+mc.1.20.1-fabric" = _8Gtuq9bo;
        "pkg-1.3.8+mc.1.20.1-forge" = _MeMaWy4r;
        "pkg-1.3.8+mc.1.20.1-fabric" = _TtUJDjF2;
        "pkg-1.3.8+mc.1.19.2-forge" = _CUtpx2H6;
        "pkg-1.3.8+mc.1.19.2-fabric" = _3tKcIBlL;
        "pkg-1.3.8+mc.1.18.2-fabric" = _7RYZkgiJ;
        "pkg-1.3.8+mc.1.18.2-forge" = _r0zcWp96;
        "pkg-2.0.0+mc.1.20.1-forge" = _RBwMuYgU;
        "pkg-2.0.0+mc.1.20.1-fabric" = _6V6TDYy6;
        "pkg-2.0.0+mc.1.19.2-forge" = _mgfmIlLW;
        "pkg-2.0.0+mc.1.19.2-fabric" = _uJF41nmq;
        "pkg-2.0.0+mc.1.18.2-forge" = _i6pevmVn;
        "pkg-2.0.0+mc.1.18.2-fabric" = _Mhvozemv;
        "pkg-2.0.1+mc.1.20.1-forge" = _aU26qOzq;
        "pkg-2.0.1+mc.1.20.1-fabric" = _HSvnQaxl;
        "pkg-2.0.2+mc.1.18.2-fabric" = _Yg2vCIr0;
        "pkg-2.0.2+mc.1.18.2-forge" = _hgMqB8if;
        "pkg-2.0.2+mc.1.19.2-forge" = _TpLcIsbl;
        "pkg-2.0.2+mc.1.19.2-fabric" = _W8xxIEiA;
        "pkg-2.0.2+mc.1.20.1-forge" = _ZkzY6meh;
        "pkg-2.0.2+mc.1.20.1-fabric" = _Mqd0kA0G;
        "pkg-2.0.3+mc.1.20.1-forge" = _EwQRBJFL;
        "pkg-2.0.3+mc.1.20.1-fabric" = _8BBBJUw8;
        "pkg-2.0.3+mc.1.19.2-fabric" = _i9kuVzgC;
        "pkg-2.0.3+mc.1.19.2-forge" = _qzqXeiur;
        "pkg-2.0.3+mc.1.18.2-forge" = _VP6rCVUJ;
        "pkg-2.0.3+mc.1.18.2-fabric" = _P7SXVFq1;
        "pkg-2.0.4+mc.1.20.1-forge" = _NI3Wxj2R;
        "pkg-2.0.4+mc.1.20.1-fabric" = _Vtylonm5;
        "pkg-2.0.4+mc.1.19.2-fabric" = _StlmSRrK;
        "pkg-2.0.4+mc.1.19.2-forge" = _gldbSWZ8;
        "pkg-2.0.4+mc.1.18.2-fabric" = _pBd77CWk;
        "pkg-2.0.4+mc.1.18.2-forge" = _RAE5Qwk9;
        "pkg-2.0.5+mc.1.20.1-fabric" = _vNqknQZo;
        "pkg-2.0.5+mc.1.20.1-forge" = _H8ITJISV;
        "pkg-2.0.5+mc.1.19.2-fabric" = _UYcp49yS;
        "pkg-2.0.5+mc.1.19.2-forge" = _T3xHtt73;
        "pkg-2.0.5+mc.1.18.2-fabric" = _aGhlY86F;
        "pkg-2.0.5+mc.1.18.2-forge" = _PUbUAHUk;
        "pkg-2.1.0+mc.1.20.1-fabric" = _Tfrz9GmZ;
        "pkg-2.1.0+mc.1.20.1-forge" = _O2G5ozbU;
        "pkg-2.1.0+mc.1.19.2-fabric" = _nCCUYhke;
        "pkg-2.1.0+mc.1.19.2-forge" = _YtoM6nPv;
        "pkg-2.1.0+mc.1.18.2-fabric" = _BsJtbZ29;
        "pkg-2.1.0+mc.1.18.2-forge" = _eICS6PxV;
        "pkg-2.1.1+mc.1.20.1-fabric" = _6A5o85pa;
        "pkg-2.1.1+mc.1.20.1-forge" = _hs8Tkkxq;
        "pkg-2.1.1+mc.1.19.2-fabric" = _SSeS5Dym;
        "pkg-2.1.1+mc.1.19.2-forge" = _73jPbpls;
        "pkg-2.1.1+mc.1.18.2-fabric" = _XRqLIwg0;
        "pkg-2.1.1+mc.1.18.2-forge" = _YxOZPNBC;
        "pkg-2.1.2+mc.1.20.1-fabric" = _uLMBgtLt;
        "pkg-2.1.2+mc.1.20.1-forge" = _zyXQ6jAy;
        "pkg-2.1.2+mc.1.19.2-fabric" = _brdhvEhn;
        "pkg-2.1.2+mc.1.19.2-forge" = _KQoThE68;
        "pkg-2.1.2+mc.1.18.2-fabric" = _FRXgiRJS;
        "pkg-2.1.2+mc.1.18.2-forge" = _k81ySF0Z;
        "pkg-2.1.3+mc.1.20.1-fabric" = _FQqplcbP;
        "pkg-2.1.3+mc.1.20.1-forge" = _T9wEAcx2;
        "pkg-2.1.3+mc.1.19.2-fabric" = _OVOkPIgb;
        "pkg-2.1.3+mc.1.19.2-forge" = _goD7PBMm;
        "pkg-2.1.3+mc.1.18.2-fabric" = _AqrDMhrm;
        "pkg-2.1.3+mc.1.18.2-forge" = _h13ytk5W;
        "pkg-2.1.4+mc.1.20.1-fabric" = _r8HAtEtA;
        "pkg-2.1.4+mc.1.20.1-forge" = _LyrlrAYd;
        "pkg-2.1.4+mc.1.19.2-fabric" = _HXJrCKCJ;
        "pkg-2.1.4+mc.1.19.2-forge" = _y9yKtgzo;
        "pkg-2.1.4+mc.1.18.2-fabric" = _gBJHxQFt;
        "pkg-2.1.4+mc.1.18.2-forge" = _zLdEWcdE;
        "pkg-2.2.0+mc.1.20.1-fabric" = _S4Qh89bx;
        "pkg-2.2.0+mc.1.20.1-forge" = _DAn2YIli;
        "pkg-2.2.0+mc.1.19.2-fabric" = _3fuqx1Of;
        "pkg-2.2.0+mc.1.19.2-forge" = _jnvgrniG;
        "pkg-2.2.0+mc.1.18.2-fabric" = _oTSisdhE;
        "pkg-2.2.0+mc.1.18.2-forge" = _yIXIlZR9;
        "pkg-2.2.1+mc.1.20.1-fabric" = _ecJyY73Y;
        "pkg-2.2.1+mc.1.20.1-forge" = _wye0a6lp;
        "pkg-2.2.1+mc.1.19.2-fabric" = _aVSfcPG6;
        "pkg-2.2.1+mc.1.19.2-forge" = _AXNQH69L;
        "pkg-2.2.1+mc.1.18.2-forge" = _L6kYto4E;
        "pkg-2.2.1+mc.1.18.2-fabric" = _eOEs6eAY;
        "pkg-2.2.1a+mc.1.18.2-fabric" = _bEVF8cyY;
        "pkg-2.2.1a+mc.1.18.2-forge" = _XTeZbSrs;
        "pkg-2.2.2+mc.1.20.1-forge" = _oeTB57Pr;
        "pkg-2.2.2+mc.1.20.1-fabric" = _WYmjbo0H;
        "pkg-2.2.2+mc.1.19.2-fabric" = _2i0xjpG2;
        "pkg-2.2.2+mc.1.19.2-forge" = _ZURtfrZY;
        "pkg-2.2.2+mc.1.18.2-fabric" = _DJEPdsxc;
        "pkg-2.2.2+mc.1.18.2-forge" = _PAs43lPf;
        "pkg-3.0.0+mc.1.20.1-forge" = _u3FzFq67;
        "pkg-3.0.1+mc.1.21.1-neoforge" = _yJiPTmhu;
        "pkg-3.0.1+mc.1.20.1-forge" = _N0bPoy0A;
        "pkg-3.0.2+mc.1.21.1-neoforge" = _wj2p9GZw;
        "pkg-3.0.2+mc.1.20.1-forge" = _ibcPwZZT;
        "pkg-3.0.4+mc.1.21.1-neoforge" = _kecZ0sl7;
        "pkg-3.0.4+mc.1.20.1-forge" = _OjWz9bJQ;
        "pkg-3.0.5+mc.1.20.1-fabric" = _ESUZ9nT1;
        "pkg-3.0.5+mc.1.20.1-forge" = _F3G2y1NH;
        "pkg-3.0.6+mc.1.20.1-fabric" = _7xeb6RlP;
        "pkg-3.0.6+mc.1.20.1-forge" = _5Rb9nZ9U;
        "pkg-3.0.7+mc.1.20.1-forge" = _z7s54cjL;
        "pkg-3.0.7+mc.1.20.1-fabric" = _dMrxOciv;
        "pkg-3.0.6+mc.1.21.1-neoforge" = _DVQFhrV3;
        "pkg-3.0.8+mc.1.20.1-fabric" = _pPGFgA7j;
        "pkg-3.0.8+mc.1.20.1-forge" = _qFxYcLc0;
        "pkg-3.0.7+mc.1.21.1-neoforge" = _8cABiKTp;
        "pkg-3.0.8+mc.1.21.1-neoforge" = _ZwGlMBIk;
        "pkg-3.0.9+mc.1.21.1-neoforge" = _bPYeUWZx;
        "pkg-3.0.10+mc.1.20.1-fabric" = _E0aagkjc;
        "pkg-3.0.10+mc.1.20.1-forge" = _LlMxIysb;
        "default" = _LlMxIysb;
    });
