...
let
    versions = (let
        ...
        _UKazG2k1 = {
            "id" = "UKazG2k1";
            "file" = "ShopShelvesSpigot-1.0.14.jar";
            "hash" = "sha512-h07e9lna+1cWOLR43XdtEar4iabzzME88/jC8soL8L3ZOkZLSLkdtqzgwLz55Oh38x2/rwnkT8reZvdYiEDncQ==";
        };
        _glDdDwsD = {
            "id" = "glDdDwsD";
            "file" = "shopshelves-1.0.14.jar";
            "hash" = "sha512-ML8SWbm6GDYa/JPWlr8ZyHbdjM8a4vOfdZUfoUA2wKsMvh63ITP4uVGdJbj/5Rsx3hx1krRPIz1gF7akyfPW9A==";
        };
        _qacM8mIK = {
            "id" = "qacM8mIK";
            "file" = "shopshelves-1.0.14.jar";
            "hash" = "sha512-oohF0VBi81/wDAz7q46sneI4bwzYfluZ1Kt5KLb0fPvcTTJ3EkAEkFC+gw1ID51+7uTI7HkoOeIRECxCGgNqzQ==";
        };
        _9cnTyBdi = {
            "id" = "9cnTyBdi";
            "file" = "ShopShelves-1.0.14.jar";
            "hash" = "sha512-daMIJmfHqlByRYjYNG++Y2ZlCdI0r+yt+iZu6O9VLORCaO6BZtmvAC/gG8HJb/afwdDY6FfccVC3/uOJGZh9sw==";
        };
        _OBRkMu7Z = {
            "id" = "OBRkMu7Z";
            "file" = "ShopShelves-1.0.14.jar";
            "hash" = "sha512-oSEW/XJfpPZ897NXvkdBEKqFFImEsRsRwQEso/X2s/6equ+IBK3IAMR0s07I77RXC61c2K5kGge/I1hD9b/xpg==";
        };
        _bsgfiryo = {
            "id" = "bsgfiryo";
            "file" = "shopshelves-1.0.14.jar";
            "hash" = "sha512-N+8QtZO97+vTWZXoQCOJES+W2NVD2MGd45PZ9XzhQZPtzaAq3gQ/W7MZ9YjXej2TBQV/N1BNL7Uv7/OCJ9eTYw==";
        };
    in {
        "X2IByZ28" = _X2IByZ28;
        "vW4C4122" = _vW4C4122;
        ...
        "OBRkMu7Z" = _OBRkMu7Z;
        "bsgfiryo" = _bsgfiryo;
        "fabric-1.21.9" = _OBRkMu7Z;
        "fabric-1.21.10" = _OBRkMu7Z;
        "fabric-1.21.11" = _9cnTyBdi;
        "fabric-26.1" = _qacM8mIK;
        "fabric-26.1.1" = _qacM8mIK;
        "fabric-26.1.2" = _qacM8mIK;
        "fabric-26.2" = _glDdDwsD;
        "fabric-26.3" = _bsgfiryo;
        "paper-1.21.9" = _UKazG2k1;
        "paper-1.21.10" = _UKazG2k1;
        "paper-1.21.11" = _UKazG2k1;
        "paper-26.1" = _UKazG2k1;
        "paper-26.1.1" = _UKazG2k1;
        "paper-26.1.2" = _UKazG2k1;
        "paper-26.2" = _UKazG2k1;
        "paper-26.3" = _UKazG2k1;
        "spigot-1.21.9" = _UKazG2k1;
        "spigot-1.21.10" = _UKazG2k1;
        "spigot-1.21.11" = _UKazG2k1;
        "spigot-26.1" = _UKazG2k1;
        "spigot-26.1.1" = _UKazG2k1;
        "spigot-26.1.2" = _UKazG2k1;
        "spigot-26.2" = _UKazG2k1;
        "spigot-26.3" = _UKazG2k1;
        "bukkit-1.21.9" = _UKazG2k1;
        "bukkit-1.21.10" = _UKazG2k1;
        "bukkit-1.21.11" = _UKazG2k1;
        "bukkit-26.1" = _UKazG2k1;
        "bukkit-26.1.1" = _UKazG2k1;
        "bukkit-26.1.2" = _UKazG2k1;
        "bukkit-26.2" = _UKazG2k1;
        "bukkit-26.3" = _UKazG2k1;
        "purpur-1.21.9" = _UKazG2k1;
        "purpur-1.21.10" = _UKazG2k1;
        "purpur-1.21.11" = _UKazG2k1;
        "purpur-26.1" = _UKazG2k1;
        "purpur-26.1.1" = _UKazG2k1;
        "purpur-26.1.2" = _UKazG2k1;
        "purpur-26.2" = _UKazG2k1;
        "purpur-26.3" = _UKazG2k1;
        "pkg-1.0.0" = _vW4C4122;
        "pkg-1.0.1" = _E82DAh0e;
        ...
        "pkg-Paper_Spigot_Purpur_1.0.14" = _UKazG2k1;
        "pkg-Fabric_1.0.14" = _OBRkMu7Z;
        "pkg-1.0.14" = _bsgfiryo;
        "default" = _bsgfiryo;
    });
