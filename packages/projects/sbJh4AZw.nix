...
let
    versions = (let
        ...
        _Gyi0J3RV = {
            "id" = "Gyi0J3RV";
            "file" = "occultism-26.1.2-neoforge-1.250.0.jar";
            "hash" = "sha512-vr0IC+ZiXQOVh9x0VN2HBlhUFYuvrQ4mCeahO+dKzCK/7y17lGksiUEZmV73QkyGsGsSYK22s4b2aR6LuynhEQ==";
        };
        _BTx5emCK = {
            "id" = "BTx5emCK";
            "file" = "occultism-26.2-neoforge-1.253.0.jar";
            "hash" = "sha512-FvDomNIrZ3hHexkuFB0XZ4XOcF1fI52zEIxeP4zd0p/wuH/199mzrSjAEffV5eYg+ADwY6FKReLbQB6sRUu/Bg==";
        };
        _siQto95t = {
            "id" = "siQto95t";
            "file" = "occultism-26.2-neoforge-1.253.1.jar";
            "hash" = "sha512-Zm9MOpdyxyDgQ6qHmnApY8ihTjTXM7GvpbPWAgGlpFtabzpmKxrSQQj90yB5sT/ujwJf/qZe9KaLuGFu38osNg==";
        };
        _zDQNiFLo = {
            "id" = "zDQNiFLo";
            "file" = "occultism-26.1.2-neoforge-1.251.0.jar";
            "hash" = "sha512-Tqn7tvFL48ZX0w0JTfBoWGj76jUht4ogtRuhi1Od7FOBxdFqhI6Vev5MP/HnQtUm8aZ5H442GzrdYokee9zQTw==";
        };
        _J0KLNnym = {
            "id" = "J0KLNnym";
            "file" = "occultism-26.1.2-neoforge-1.252.0.jar";
            "hash" = "sha512-qkeQaajUaWxiV//GMRzon9Lp3NXW725u7Af7X7bddynhPEWcKqCgESDB+6IlncWfcd8ROhtuJpp4UKaYdDWnzQ==";
        };
        _siQWrbKK = {
            "id" = "siQWrbKK";
            "file" = "occultism-26.2-neoforge-1.254.0.jar";
            "hash" = "sha512-0gy6JQkxoyabkvG57/hNjuEum8Gt2LKUknxNaN5X6dNrME2UGSc4GO9Yo1X/I+yyoqqgRwWGoUVuitbONrZ4gg==";
        };
        _g2Mviq04 = {
            "id" = "g2Mviq04";
            "file" = "occultism-26.1.2-neoforge-1.253.0.jar";
            "hash" = "sha512-mTcjlPD9vbwWwnDnf0NAZSZdsb8Ipv8rTL1iGWAHryofdwSHQAgtMOXNgqgjEpvhkVZ9m+R+t3esFovDg+p9kw==";
        };
        _h1YHlTnq = {
            "id" = "h1YHlTnq";
    ...
    in {
        ...
        "pkg-1.20.1-1.81.0" = _7KCoUbfq;
        "pkg-1.20.1-1.81.1" = _x7tS2bmG;
        "pkg-1.19.4-1.80.8" = _SVGO9i56;
        "pkg-1.19.2-1.81.2" = _P2gNRfvb;
        "pkg-1.19.3-1.74.1" = _Pxkb8WqV;
        "pkg-1.18.2-1.81.4" = _oDNByrMW;
        "pkg-1.20.1-1.81.3" = _xLSTdXGN;
        "pkg-1.20.1-1.81.4" = _mQ7s4MTd;
        "pkg-1.20.1-1.81.5" = _dTdsfCum;
        "pkg-1.20.1-1.81.6" = _KwLZG5Ye;
        "pkg-1.19.2-1.81.6" = _tBfaSdZ0;
        "pkg-1.20.1-1.81.7" = _R54D5qJh;
        "pkg-1.20.1-1.81.8" = _T2vsO0Lv;
        "pkg-1.19.2-1.81.8" = _i8GhzSIf;
        "pkg-1.19.2-1.81.9" = _t44hXLgk;
        "pkg-1.20.1-1.81.9" = _XRCjsZTO;
        "pkg-1.20.1-1.81.10" = _PQwERc8x;
        "pkg-1.19.2-1.81.10" = _oaIV3gWy;
        "pkg-1.19.2-1.82.0" = _6QypPnyQ;
        "pkg-1.20.1-1.82.0" = _cD87O8N0;
        "pkg-1.18.2-1.83.0" = _hKmjtbQ1;
        "pkg-1.19.2-1.83.0" = _qUfaiHG3;
        "pkg-1.20.1-1.83.0" = _Qk97urBa;
        "pkg-1.20.1-1.84.0" = _DeVJlA7C;
        "pkg-1.19.2-1.84.0" = _JJxESCBX;
        "pkg-1.20.1-1.85.0" = _m9WvoEeB;
        "pkg-1.20.1-1.85.1" = _CHm2MZBK;
        "pkg-1.19.2-1.84.1" = _TcrrnMlu;
        "pkg-1.20.1-1.86.0" = _KWIMCkNS;
        "pkg-1.19.2-1.86.0" = _MoRGmX0t;
        "pkg-1.20.1-1.86.1" = _gDG764kk;
        "pkg-1.18.2-1.84.0" = _xZudBwB9;
        "pkg-1.19.2-1.87.0" = _qk5ozuL1;
        "pkg-1.20.1-1.87.0" = _4c72ToTQ;
        "pkg-1.20.1-1.87.1" = _D1DNvc25;
        "pkg-1.20.1-1.87.2" = _MQOdpa49;
        "pkg-1.19.2-1.87.1" = _dtIA8sgb;
        "pkg-1.20.1-1.88.0" = _EIFHogAL;
        "pkg-1.19.2-1.88.0" = _uhLIcWxZ;
        "pkg-1.20.1-1.88.1" = _51vcW7Ot;
        "pkg-1.20.1-1.89.0" = _FtptEmHx;
        "pkg-1.20.1-1.89.1" = _G7w86ftB;
        "pkg-1.20.1-1.90.0" = _cqF8XM14;
        "pkg-1.20.1-1.91.0" = _Zft5cHlu;
        "pkg-1.20.1-1.92.0" = _IEqQ36V4;
        "pkg-1.20.1-1.93.0" = _2qrMO3lJ;
        "pkg-1.20.1-1.94.0" = _9zZn33nl;
        "pkg-1.19.2-1.88.1" = _4k0aHiCr;
        "pkg-1.20.1-1.94.1" = _ifPirwjW;
        "pkg-1.20.1-1.95.0" = _JOyU2nsf;
        "pkg-1.20.1-1.95.1" = _wK8uzJHE;
        "pkg-1.20.1-1.95.2" = _92O9dbCQ;
        "pkg-1.20.1-1.96.0" = _DJAJe8x4;
        "pkg-1.20.1-1.97.0" = _3C5zUnqi;
        "pkg-1.19.2-1.88.2" = _gItNQJBr;
        "pkg-1.19.2-1.89.0" = _YBO4t9O1;
        "pkg-1.20.1-1.98.0" = _2zLXaTMR;
        "pkg-1.20.1-1.99.0" = _SfKJCqYO;
        "pkg-1.20.1-1.100.0" = _iEbfv3Xo;
        "pkg-1.20.1-1.101.0" = _e0U1d6Wv;
        "pkg-1.20.1-1.102.0" = _eevKH0ZM;
        "pkg-1.20.1-1.103.0" = _Jc3NZuOE;
        "pkg-1.20.1-1.104.0" = _SXSljrEU;
        "pkg-1.20.1-1.104.1" = _jQ5V6flv;
        "pkg-1.20.4-neoforge-1.104.0" = _N7TZOPDf;
        "pkg-1.20.4-neoforge-1.104.1" = _8WGv0RvR;
        "pkg-1.20.1-1.105.0" = _netb6aYq;
        "pkg-1.20.4-neoforge-1.105.0" = _lf7H0Z9w;
        "pkg-1.20.1-1.106.0" = _xZQYteMY;
        "pkg-1.20.1-1.106.1" = _Av4ib51O;
        "pkg-1.20.1-1.107.0" = _qxEA5pNa;
        "pkg-1.20.4-neoforge-1.107.0" = _mBbE7khh;
        "pkg-1.20.4-neoforge-1.108.0" = _ZW1OXg0q;
        "pkg-1.20.1-1.108.0" = _VlpJQMBH;
        "pkg-1.20.1-1.109.0" = _xLOIPsGJ;
        "pkg-1.20.4-neoforge-1.109.0" = _xnAbhd4M;
        "pkg-1.20.1-1.110.0" = _WZIMLpC9;
        "pkg-1.20.4-neoforge-1.110.0" = _9xzspcKL;
        "pkg-1.20.1-1.111.0" = _gPdNRkRQ;
        "pkg-1.20.4-neoforge-1.111.0" = _eaTJQ21G;
        "pkg-1.20.1-1.112.0" = _m3wNBzwW;
        "pkg-1.20.4-neoforge-1.112.0" = _R2KQ5nQZ;
        "pkg-1.20.1-1.112.1" = _D0TXPpr4;
        "pkg-1.20.4-neoforge-1.112.1" = _Dw8VqD1F;
        "pkg-1.20.1-1.112.2" = _twwL4FUU;
        "pkg-1.20.4-neoforge-1.112.2" = _DZm1Ttik;
        "pkg-1.20.1-1.113.0" = _iHMRIJnh;
        "pkg-1.20.4-neoforge-1.113.0" = _xUYK2XwD;
        "pkg-1.20.1-1.113.1" = _QZeeIWkM;
        "pkg-1.20.4-neoforge-1.113.1" = _eb51HFIf;
        "pkg-1.20.1-1.114.0" = _5UOYbGla;
        "pkg-1.20.4-neoforge-1.114.0" = _QGYBEBmY;
        "pkg-1.20.4-neoforge-1.114.1" = _e8w9GVKq;
        "pkg-1.20.1-1.115.0" = _GLl3bJIU;
        "pkg-1.20.4-neoforge-1.115.0" = _UrgADJUL;
        "pkg-1.20.1-1.116.0" = _GEdcWsMb;
        "pkg-1.20.4-neoforge-1.116.0" = _unaZyxtK;
        "pkg-1.20.1-1.116.1" = _7uZK4c6g;
        "pkg-1.19.2-1.90.0" = _mSKrPJlp;
        "pkg-1.20.1-1.116.2" = _ryJQzbmv;
        "pkg-1.20.4-neoforge-1.116.2" = _r51Hjl6a;
        "pkg-1.20.1-1.117.0" = _3lHUGHBa;
        "pkg-1.20.4-neoforge-1.117.0" = _tObYbzTz;
        "pkg-1.20.1-1.118.0" = _LJE9gVcb;
        "pkg-1.20.4-neoforge-1.118.0" = _S5YU3HIV;
        "pkg-1.20.1-1.119.0" = _SXJfp4CZ;
        "pkg-1.20.4-neoforge-1.119.0" = _ts8NiEli;
        "pkg-1.20.1-1.120.0" = _6HgeHF6D;
        "pkg-1.20.4-neoforge-1.120.0" = _Lunmw6yS;
        "pkg-1.20.4-neoforge-1.120.1" = _2ir2arYV;
        "pkg-1.20.1-1.121.0" = _Xpo8FIYs;
        "pkg-1.20.4-neoforge-1.121.0" = _yk8jtmNa;
        "pkg-1.20.1-1.121.1" = _kVTA1HWL;
        "pkg-1.20.4-neoforge-1.121.1" = _RCaZdsi1;
        "pkg-1.20.4-neoforge-1.121.2" = _bsCXctz7;
        "pkg-1.20.1-1.121.2" = _QcJrz7Pi;
        "pkg-1.20.4-neoforge-1.121.3" = _934Je4EZ;
        "pkg-1.20.1-1.121.3" = _5g8zhGRe;
        "pkg-1.20.4-neoforge-1.121.4" = _pX7eHbJb;
        "pkg-1.20.1-1.122.0" = _MEovnCT1;
        "pkg-1.20.4-neoforge-1.122.0" = _4r5Z8JN7;
        "pkg-1.20.1-1.122.1" = _XDoEUFSJ;
        "pkg-1.20.4-neoforge-1.122.1" = _b0TvmHxg;
        "pkg-1.20.1-1.123.0" = _1AnM1jj7;
        "pkg-1.20.4-neoforge-1.123.0" = _CW3vegfs;
        "pkg-1.20.4-neoforge-1.123.1" = _wzaEVqII;
        "pkg-1.20.1-1.124.0" = _DmIJ2gHs;
        "pkg-1.20.4-neoforge-1.124.0" = _tcGUflOW;
        "pkg-1.20.1-1.124.1" = _HtMchN6x;
        "pkg-1.20.4-neoforge-1.124.1" = _RdzblIeR;
        "pkg-1.20.1-1.124.2" = _4zTSbV7H;
        "pkg-1.20.4-neoforge-1.124.2" = _Eg2JnjRe;
        "pkg-1.20.1-1.124.3" = _g4AuyswG;
        "pkg-1.20.4-neoforge-1.124.3" = _Nv4krKFe;
        "pkg-1.20.1-1.124.4" = _MlkRDmQo;
        "pkg-1.20.4-neoforge-1.124.4" = _uvGQvyAA;
        "pkg-1.20.1-1.125.0" = _j1rKgfQY;
        "pkg-1.20.4-neoforge-1.125.0" = _4C0ERrRv;
        "pkg-1.20.4-neoforge-1.125.1" = _gotwfIsr;
        "pkg-1.20.1-1.126.0" = _bnBNL9JV;
        "pkg-1.20.4-neoforge-1.126.0" = _PCVXb45E;
        "pkg-1.20.1-1.126.1" = _XDmzFSmS;
        "pkg-1.20.4-neoforge-1.126.1" = _ZqThYo1p;
        "pkg-1.20.1-1.127.0" = _pDkMKmRo;
        "pkg-1.20.4-neoforge-1.127.0" = _Pb4KrU3q;
        "pkg-1.20.4-neoforge-1.128.0" = _nA9jAkNw;
        "pkg-1.20.1-1.128.0" = _CWJWRica;
        "pkg-1.20.4-neoforge-1.129.0" = _2wG9PMEP;
        "pkg-1.20.6-neoforge-1.129.0" = _Q38Spqa0;
        "pkg-1.20.4-neoforge-1.130.0" = _uOU79WMv;
        "pkg-1.20.1-1.130.0" = _7uIkeWmH;
        "pkg-1.20.6-neoforge-1.130.0" = _89oObVB9;
        "pkg-1.20.4-neoforge-1.131.0" = _Ng3s9AWj;
        "pkg-1.20.6-neoforge-1.131.0" = _jkqfk5MU;
        "pkg-1.20.1-1.131.0" = _vd2BPAJz;
        "pkg-1.20.1-1.131.1" = _IiICn1SX;
        "pkg-1.20.4-neoforge-1.131.1" = _F8YnO4bn;
        "pkg-1.20.6-neoforge-1.131.1" = _MdS5aKyT;
        "pkg-1.20.6-neoforge-1.132.0" = _ceVlMqTJ;
        "pkg-1.20.4-neoforge-1.131.2" = _Xcvw8FOo;
        "pkg-1.20.6-neoforge-1.131.2" = _1LES10CA;
        "pkg-1.20.1-1.131.2" = _2l6LFefn;
        "pkg-1.20.1-1.132.0" = _67PFjDxj;
        "pkg-1.20.4-neoforge-1.132.0" = _rzfGqnsJ;
        "pkg-1.20.1-1.132.1" = _fwqvjGnl;
        "pkg-1.20.4-neoforge-1.132.1" = _s0NrhTLh;
        "pkg-1.21-neoforge-1.132.2" = _6uyClI75;
        "pkg-1.21-neoforge-1.132.3" = _t4lMt0LG;
        "pkg-1.21-neoforge-1.133.0" = _UvB1ZImc;
        "pkg-1.21-neoforge-1.133.1" = _BTl24m5s;
        "pkg-1.21-neoforge-1.133.2" = _5Q1Mbgjl;
        "pkg-1.21-neoforge-1.133.3" = _fNyFM7xI;
        "pkg-1.21-neoforge-1.134.0" = _fnye2h3X;
        "pkg-1.20.4-neoforge-1.132.2" = _gTZ2Ynru;
        "pkg-1.21-neoforge-1.134.1" = _Wq1VbIyf;
        "pkg-1.21-neoforge-1.134.2" = _h3YCBAna;
        "pkg-1.21-neoforge-1.134.3" = _iPcp95dt;
        "pkg-1.21-neoforge-1.134.4" = _tgGNpdBY;
        "pkg-1.21-neoforge-1.134.5" = _JnQOdShI;
        "pkg-1.21-neoforge-1.134.6" = _uZFrUOPt;
        "pkg-1.21-neoforge-1.134.7" = _CK3tV44S;
        "pkg-1.21-neoforge-1.135.0" = _CZUOWlkc;
        "pkg-1.21-neoforge-1.135.1" = _rWy01e3b;
        "pkg-1.21-neoforge-1.136.0" = _KozQTnnS;
        "pkg-1.21-neoforge-1.136.1" = _SkiOFoM6;
        "pkg-1.21-neoforge-1.136.2" = _OxbfEU95;
        "pkg-1.21-neoforge-1.136.3" = _2ZxLq4VS;
        "pkg-1.21-neoforge-1.136.4" = _jHxJHYug;
        "pkg-1.21-neoforge-1.136.5" = _IFHWsVJ2;
        "pkg-1.20.1-1.132.2" = _3onU1pKS;
        "pkg-1.21-neoforge-1.137.0" = _H0eI5A7n;
        "pkg-1.21-neoforge-1.137.1" = _l8FDgW6i;
        "pkg-1.21-neoforge-1.137.2" = _FqQesTPz;
        "pkg-1.21-neoforge-1.137.3" = _59K14hnI;
        "pkg-1.21-neoforge-1.137.4" = _UhRsHqxf;
        "pkg-1.21-neoforge-1.138.0" = _rnvQPBti;
        "pkg-1.21-neoforge-1.139.0" = _AHwUtpC3;
        "pkg-1.21-neoforge-1.139.1" = _ql16iVXK;
        "pkg-1.21-neoforge-1.139.2" = _hxLbN3jW;
        "pkg-1.21-neoforge-1.139.3" = _vcesH97v;
        "pkg-1.21-neoforge-1.140.0" = _QiZ3sZji;
        "pkg-1.21-neoforge-1.141.0" = _SMOuRLnV;
        "pkg-1.21-neoforge-1.142.0" = _FjguHkqs;
        "pkg-1.21-neoforge-1.142.1" = _LbEs9nY4;
        "pkg-1.21-neoforge-1.142.2" = _hgZvENYK;
        "pkg-1.21-neoforge-1.143.0" = _cpT4nQRi;
        "pkg-1.21-neoforge-1.143.1" = _2qb495AB;
        "pkg-1.21-neoforge-1.143.2" = _ebsp13bX;
        "pkg-1.21-neoforge-1.143.3" = _qPKy5LnM;
        "pkg-1.21-neoforge-1.143.4" = _zGjglcgF;
        "pkg-1.20.1-1.132.3" = _mZ11bCS3;
        "pkg-1.21-neoforge-1.144.0" = _CH7Lia8B;
        "pkg-1.20.1-1.133.0" = _jIWqjyTf;
        "pkg-1.20.1-1.133.1" = _ApOKDFCF;
        "pkg-1.21-neoforge-1.144.1" = _3pOjKCxZ;
        "pkg-1.21-neoforge-1.145.0" = _3AbYA2YI;
        "pkg-1.21-neoforge-1.145.1" = _3AG2Tk2d;
        "pkg-1.21-neoforge-1.146.0" = _5oDLcjE3;
        "pkg-1.21-neoforge-1.146.1" = _KDkV74js;
        "pkg-1.21-neoforge-1.147.0" = _g2R1RBzF;
        "pkg-1.21-neoforge-1.147.1" = _K3iVxxL5;
        "pkg-1.20.1-1.134.1" = _Gukyr3DK;
        "pkg-1.21-neoforge-1.148.0" = _1lugNFuj;
        "pkg-1.21-neoforge-1.148.1" = _DleDuX7e;
        "pkg-1.21-neoforge-1.148.2" = _SRk8vyL2;
        "pkg-1.21-neoforge-1.149.0" = _AnG8li6e;
        "pkg-1.20.1-1.135.0" = _srJgefYD;
        "pkg-1.21.1-neoforge-1.150.0" = _OhYC01hq;
        "pkg-1.21.1-neoforge-1.151.0" = _LsBTisfQ;
        "pkg-1.20.1-1.136.0" = _Hv8Cylez;
        "pkg-1.21.1-neoforge-1.151.1" = _gU91nptm;
        "pkg-1.21.1-neoforge-1.151.2" = _Yz8e2Ah7;
        "pkg-1.20.1-1.136.1" = _vj0mTfCU;
        "pkg-1.21.1-neoforge-1.151.3" = _4ztZpeju;
        "pkg-1.21.1-neoforge-1.152.0" = _4ZYq5YSL;
        "pkg-1.21.1-neoforge-1.153.0" = _w0Ve2NqV;
        "pkg-1.21.1-neoforge-1.153.1" = _VjExauE3;
        "pkg-1.21.1-neoforge-1.153.2" = _8l2zGUlf;
        "pkg-1.21.1-neoforge-1.153.3" = _T7Efmt56;
        "pkg-1.20.1-1.136.2" = _zH309s4D;
        "pkg-1.21.1-neoforge-1.153.4" = _muT46wFC;
        "pkg-1.20.1-1.136.3" = _ekpcr8zj;
        "pkg-1.21.1-neoforge-1.153.5" = _p5fqxMng;
        "pkg-1.20.1-1.137.0" = _ZHddhqeP;
        "pkg-1.21.1-neoforge-1.154.0" = _chZfoj4Q;
        "pkg-1.20.1-1.137.1" = _zzB3y40z;
        "pkg-1.21.1-neoforge-1.154.1" = _sZJpXbVu;
        "pkg-1.21.1-neoforge-1.155.0" = _GVjWwMBr;
        "pkg-1.21.1-neoforge-1.155.1" = _l7rLj3OI;
        "pkg-1.20.1-1.138.0" = _AShLJC5n;
        "pkg-1.21.1-neoforge-1.156.0" = _XNkmL8wR;
        "pkg-1.21.1-neoforge-1.157.0" = _5M8tVylF;
        "pkg-1.21.1-neoforge-1.157.1" = _K06NuQhF;
        "pkg-1.20.1-1.139.0" = _cLhvwmcj;
        "pkg-1.21.1-neoforge-1.158.0" = _Z49XL7Sj;
        "pkg-1.21.1-neoforge-1.159.0" = _s1pBCxSz;
        "pkg-1.21.1-neoforge-1.159.1" = _uwfXcL0i;
        "pkg-1.21.1-neoforge-1.159.3" = _CigbXCe1;
        "pkg-1.21.1-neoforge-1.159.5" = _O23nTVoM;
        "pkg-1.21.1-neoforge-1.159.6" = _S0Rt5Ygu;
        "pkg-1.21.1-neoforge-1.159.7" = _nWOtHGuy;
        "pkg-1.21.1-neoforge-1.160.0" = _c1kM3XTb;
        "pkg-1.21.1-neoforge-1.160.1" = _HVlkZJGK;
        "pkg-1.21.1-neoforge-1.161.0" = _ZxvSCFKg;
        "pkg-1.21.1-neoforge-1.161.1" = _dBOPKyIy;
        "pkg-1.21.1-neoforge-1.161.2" = _VfVtWgB0;
        "pkg-1.21.1-neoforge-1.161.3" = _1j9DAVGv;
        "pkg-1.20.1-1.139.1" = _GD8n8w4H;
        "pkg-1.21.1-neoforge-1.161.4" = _khxXznVH;
        "pkg-1.21.1-neoforge-1.162.0" = _2mAh0WH0;
        "pkg-1.21.1-neoforge-1.163.0" = _RWnsL1GY;
        "pkg-1.21.1-neoforge-1.164.0" = _BdzPPHh5;
        "pkg-1.20.1-1.140.1" = _5oM6irnq;
        "pkg-1.21.1-neoforge-1.165.0" = _4nuJGwXS;
        "pkg-1.21.1-neoforge-1.166.0" = _Xj3O8Afe;
        "pkg-1.21.1-neoforge-1.166.1" = _iAar0eP4;
        "pkg-1.20.1-1.140.2" = _EbOztEEx;
        "pkg-1.21.1-neoforge-1.167.0" = _8OUItQhd;
        "pkg-1.21.1-neoforge-1.168.0" = _DE3t1jRZ;
        "pkg-1.21.1-neoforge-1.169.0" = _efBauNWH;
        "pkg-1.21.1-neoforge-1.170.0" = _XlIJEHAf;
        "pkg-1.21.1-neoforge-1.171.0" = _bRyo3jvS;
        "pkg-1.21.1-neoforge-1.171.1" = _9yUkurRF;
        "pkg-1.21.1-neoforge-1.171.2" = _v7w8PWpl;
        "pkg-1.21.1-neoforge-1.172.0" = _WhD1WCJt;
        "pkg-1.21.1-neoforge-1.173.0" = _xJp6Rno0;
        "pkg-1.21.1-neoforge-1.173.1" = _dMRr15IJ;
        "pkg-1.20.1-1.141.0" = _BfVo6rP0;
        "pkg-1.21.1-neoforge-1.173.2" = _n6hKbuDb;
        "pkg-1.20.1-1.141.2" = _81Jyecgn;
        "pkg-1.21.1-neoforge-1.173.3" = _DIOLSo0h;
        "pkg-1.21.1-neoforge-1.173.4" = _IIemah5N;
        "pkg-1.21.1-neoforge-1.174.0" = _t7cPDQ7C;
        "pkg-1.21.1-neoforge-1.174.1" = _CwgAXH2m;
        "pkg-1.21.1-neoforge-1.175.0" = _ijwHW8Vl;
        "pkg-1.21.1-neoforge-1.175.1" = _46PrJC9K;
        "pkg-1.21.1-neoforge-1.175.2" = _4CvHu0zM;
        "pkg-1.20.1-1.141.3" = _OC9ArLfN;
        "pkg-1.21.1-neoforge-1.176.0" = _e4Y9w8IC;
        "pkg-1.21.1-neoforge-1.177.1" = _4xh16kTH;
        "pkg-1.20.1-1.141.4" = _AYukkDMX;
        "pkg-1.21.1-neoforge-1.179.1" = _4dZmdJ1a;
        "pkg-1.21.1-neoforge-1.179.2" = _xbBVY3YO;
        "pkg-1.21.1-neoforge-1.179.3" = _i0a4QLvz;
        "pkg-1.21.1-neoforge-1.180.0" = _dqgQOUPr;
        "pkg-1.21.1-neoforge-1.180.1" = _glsOnQZ6;
        "pkg-1.21.1-neoforge-1.181.0" = _8XOGtx3W;
        "pkg-1.21.1-neoforge-1.182.0" = _5nAvssva;
        "pkg-1.21.1-neoforge-1.183.0" = _tMiHTvlC;
        "pkg-1.20.1-1.142.0" = _gqO1ruNb;
        "pkg-1.20.1-1.143.0" = _wzIe4mcQ;
        "pkg-1.20.1-1.144.0" = _zixdr1jN;
        "pkg-1.21.1-neoforge-1.184.0" = _ym1iOt4B;
        "pkg-1.20.1-1.145.0" = _ANzX4OZo;
        "pkg-1.21.1-neoforge-1.185.0" = _63LcEbTv;
        "pkg-1.20.1-1.146.0" = _5TAYkMb6;
        "pkg-1.21.1-neoforge-1.186.0" = _o0b79t7F;
        "pkg-1.20.1-1.147.0" = _6RaoEdk6;
        "pkg-1.21.1-neoforge-1.187.0" = _7esMDjy5;
        "pkg-1.21.1-neoforge-1.188.0" = _SehO3dxN;
        "pkg-1.21.1-neoforge-1.189.0" = _MLXpN5sA;
        "pkg-1.21.1-neoforge-1.190.0" = _nddMNSDp;
        "pkg-1.20.1-1.148.0" = _Lz3qF1Ko;
        "pkg-1.21.1-neoforge-1.190.1" = _lCu1Uc3v;
        "pkg-1.20.1-1.149.0" = _rBwSnEHD;
        "pkg-1.21.1-neoforge-1.191.0" = _CjQrmcID;
        "pkg-1.20.1-1.150.0" = _Y95p2zRF;
        "pkg-1.20.1-1.151.0" = _eMQ2WzEa;
        "pkg-1.20.1-1.152.0" = _kkfAnnxf;
        "pkg-1.20.1-1.152.1" = _klR7MN3E;
        "pkg-1.21.1-neoforge-1.192.0" = _qou5hjO0;
        "pkg-1.21.1-neoforge-1.192.1" = _ij9nqMag;
        "pkg-1.21.1-neoforge-1.192.2" = _iBmYLl1N;
        "pkg-1.21.1-neoforge-1.193.0" = _5f26TGxc;
        "pkg-1.21.1-neoforge-1.194.0" = _Ll5mysGu;
        "pkg-1.20.1-1.153.0" = _si5i4rB5;
        "pkg-1.21.1-neoforge-1.195.0" = _lM39UKk9;
        "pkg-1.21.1-neoforge-1.196.0" = _vSdj9tcL;
        "pkg-1.21.1-neoforge-1.197.0" = _U90SRtJ2;
        "pkg-1.21.1-neoforge-1.198.0" = _wrISfl7q;
        "pkg-1.20.1-1.155.0" = _et6isRbO;
        "pkg-1.21.1-neoforge-1.199.0" = _koWJU1pV;
        "pkg-1.21.1-neoforge-1.200.0" = _DshNcQ2U;
        "pkg-1.21.1-neoforge-1.201.0" = _YWrEAXHj;
        "pkg-1.20.1-1.156.0" = _t5cH5MGB;
        "pkg-1.21.1-neoforge-1.202.0" = _piFEmODH;
        "pkg-1.20.1-1.157.0" = _jzJh1NvL;
        "pkg-1.21.1-neoforge-1.203.0" = _wuPU8cJU;
        "pkg-1.21.1-neoforge-1.204.0" = _SRkRpibR;
        "pkg-1.21.1-neoforge-1.205.0" = _fXmTszek;
        "pkg-1.21.1-neoforge-1.207.0" = _3pdMn7L1;
        "pkg-1.21.1-neoforge-1.207.1" = _GVrYWQey;
        "pkg-26.1-neoforge-1.208.0" = _PioBYw9A;
        "pkg-26.1-neoforge-1.208.1" = _MCbVdAMI;
        "pkg-1.21.1-neoforge-1.207.2" = _YZ1WgutZ;
        "pkg-26.1-neoforge-1.208.2" = _lY3emO41;
        "pkg-26.1-neoforge-1.209.0" = _FANayUz3;
        "pkg-26.1-neoforge-1.210.0" = _C23mrt01;
        "pkg-26.1-neoforge-1.210.1" = _1x15cFrv;
        "pkg-26.1-neoforge-1.210.2" = _lTmybJAC;
        "pkg-1.21.1-neoforge-1.208.0" = _lZLUlxl8;
        "pkg-1.21.1-neoforge-1.208.1" = _KkVncBDW;
        "pkg-26.1-neoforge-1.210.3" = _rVwmhNTI;
        "pkg-1.21.1-neoforge-1.208.2" = _4faqFaxj;
        "pkg-1.21.1-neoforge-1.208.3" = _9oothqCZ;
        "pkg-26.1-neoforge-1.210.4" = _Tey2AcEc;
        "pkg-26.1-neoforge-1.210.5" = _lFb7yrkC;
        "pkg-1.21.1-neoforge-1.208.4" = _dTEwO6OP;
        "pkg-1.21.1-neoforge-1.209.0" = _spAE97zX;
        "pkg-1.21.1-neoforge-1.209.1" = _ALFCNfGA;
        "pkg-26.1.2-neoforge-1.211.2" = _N1J0UJTW;
        "pkg-26.1.2-neoforge-1.211.3" = _dGD9479u;
        "pkg-1.21.1-neoforge-1.209.2" = _A0IVNy7R;
        "pkg-1.21.1-neoforge-1.209.3" = _4YqzP2tz;
        "pkg-26.1.2-neoforge-1.211.4" = _fjoIiglG;
        "pkg-1.21.1-neoforge-1.210.0" = _F3jTFx9b;
        "pkg-26.1.2-neoforge-1.212.0" = _oMZHTozh;
        "pkg-26.1.2-neoforge-1.213.0" = _zpzwvwgV;
        "pkg-26.1.2-neoforge-1.214.0" = _fT84wXhf;
        "pkg-26.1.2-neoforge-1.214.1" = _U3mvX3vA;
        "pkg-26.1.2-neoforge-1.215.0" = _Hmqyf3oM;
        "pkg-26.1.2-neoforge-1.216.0" = _bAVkfWhU;
        "pkg-1.21.1-neoforge-1.212.0" = _xFvXi5Zs;
        "pkg-26.1.2-neoforge-1.216.1" = _5G40dnYM;
        "pkg-26.1.2-neoforge-1.217.0" = _kV3DGQfj;
        "pkg-26.1.2-neoforge-1.218.0" = _TnsV87GU;
        "pkg-26.1.2-neoforge-1.218.1" = _6pyXpqcT;
        "pkg-26.1.2-neoforge-1.218.2" = _Qekgk2i4;
        "pkg-26.1.2-neoforge-1.218.4" = _ENwSkEAZ;
        "pkg-1.21.1-neoforge-1.214.0" = _CEkDp1xr;
        "pkg-26.1.2-neoforge-1.220.0" = _qj5cKrZM;
        "pkg-26.1.2-neoforge-1.221.0" = _7cCh6MHg;
        "pkg-26.1.2-neoforge-1.221.1" = _h6eUw2cx;
        "pkg-26.1.2-neoforge-1.222.0" = _93TMoRxC;
        "pkg-26.1.2-neoforge-1.222.1" = _JxKLZ8te;
        "pkg-26.1.2-neoforge-1.223.0" = _tCBOwIAD;
        "pkg-1.21.1-neoforge-1.214.1" = _Pzzqr6s8;
        "pkg-26.1.2-neoforge-1.224.0" = _8VZJSbJy;
        "pkg-1.21.1-neoforge-1.215.0" = _8YVnfDm6;
        "pkg-26.1.2-neoforge-1.225.0" = _cIlD98B2;
        "pkg-26.1.2-neoforge-1.226.0" = _xR1i7uK1;
        "pkg-26.1.2-neoforge-1.227.0" = _KuxYoCrD;
        "pkg-26.1.2-neoforge-1.227.1" = _GkgnZRLU;
        "pkg-26.1.2-neoforge-1.228.0" = _89fhD3FN;
        "pkg-26.1.2-neoforge-1.229.0" = _nZpDEWWv;
        "pkg-26.1.2-neoforge-1.229.1" = _VFwPdXaK;
        "pkg-26.1.2-neoforge-1.229.2" = _UAM7Imk6;
        "pkg-26.1.2-neoforge-1.229.3" = _nKZo8jIr;
        "pkg-26.1.2-neoforge-1.230.0" = _ozqCSfMX;
        "pkg-26.1.2-neoforge-1.230.1" = _isatdUZd;
        "pkg-26.1.2-neoforge-1.231.0" = _jtwm9B46;
        "pkg-26.1.2-neoforge-1.232.0" = _hHi9Yfg5;
        "pkg-26.1.2-neoforge-1.233.0" = _hYqeEigb;
        "pkg-26.1.2-neoforge-1.234.0" = _M0iVZ6YF;
        "pkg-26.1.2-neoforge-1.235.0" = _LCPlxFwc;
        "pkg-1.21.1-neoforge-1.218.0" = _XvOCJCZs;
        "pkg-26.1.2-neoforge-1.237.0" = _RsYIBmSx;
        "pkg-1.20.1-1.158.0" = _hs5pHmiU;
        "pkg-1.21.1-neoforge-1.219.0" = _Jlg4uZw5;
        "pkg-26.1.2-neoforge-1.237.1" = _FG4dUMYQ;
        "pkg-26.1.2-neoforge-1.238.0" = _rWzPMzRo;
        "pkg-26.1.2-neoforge-1.239.0" = _vLJkxM1B;
        "pkg-1.21.1-neoforge-1.220.0" = _SUpOfSJL;
        "pkg-26.1.2-neoforge-1.239.1" = _601rbnVQ;
        "pkg-1.21.1-neoforge-1.220.1" = _i2oxSN3N;
        "pkg-1.21.1-neoforge-1.220.2" = _BmUZRYTT;
        "pkg-26.1.2-neoforge-1.240.0" = _VWbJWYFY;
        "pkg-1.21.1-neoforge-1.220.3" = _hQ2B7r6N;
        "pkg-1.21.1-neoforge-1.220.4" = _jo7hLXV2;
        "pkg-26.1.2-neoforge-1.240.1" = _gXTgQdVT;
        "pkg-26.1.2-neoforge-1.241.0" = _9Iar1NHm;
        "pkg-1.21.1-neoforge-1.221.0" = _Bbrply0D;
        "pkg-26.1.2-neoforge-1.242.0" = _V03ful43;
        "pkg-26.1.2-neoforge-1.243.0" = _NXeidXpy;
        "pkg-1.21.1-neoforge-1.222.0" = _hE3aRDmk;
        "pkg-26.1.2-neoforge-1.244.0" = _x9xmF2yL;
        "pkg-1.21.1-neoforge-1.223.0" = _zA0qqIZC;
        "pkg-26.1.2-neoforge-1.244.1" = _CYfmaZdN;
        "pkg-26.1.2-neoforge-1.245.0" = _AheUOBI5;
        "pkg-1.21.1-neoforge-1.224.0" = _84xuG5rN;
        "pkg-26.1.2-neoforge-1.246.1" = _qu1dSN4O;
        "pkg-26.1.2-neoforge-1.247.0" = _cYLiJ33T;
        ...
        "pkg-26.1.2-neoforge-1.250.0" = _Gyi0J3RV;
        "pkg-26.2-neoforge-1.253.0" = _BTx5emCK;
        "pkg-26.2-neoforge-1.253.1" = _siQto95t;
        "pkg-26.1.2-neoforge-1.251.0" = _zDQNiFLo;
        "pkg-26.1.2-neoforge-1.252.0" = _J0KLNnym;
