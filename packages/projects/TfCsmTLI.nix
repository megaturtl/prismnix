...
let
    ...
    in {
        ...
        "pkg-0.12.3-alpha" = _kkn8Hffl;
        "pkg-0.12.4-alpha" = _wcFdyTns;
        "pkg-0.12.5-alpha" = _2dp4f4LH;
        "pkg-0.13.0-alpha" = _DvM63J9l;
        "pkg-0.13.1-alpha" = _GgLxTlTT;
        "pkg-0.13.2-alpha" = _94YOq64L;
        "pkg-0.13.3-alpha" = _phZEAXRX;
        "pkg-0.13.4-alpha" = _aucPYG80;
        "pkg-0.13.5-alpha" = _VMZd0hVv;
        "pkg-0.13.6-alpha" = _ooGZtvcR;
        "pkg-0.13.7-alpha" = _tiNofWGD;
        "pkg-0.13.8-alpha" = _XrsYiumo;
        "pkg-0.13.9-alpha" = _QGYpi5nm;
        "pkg-0.13.10-alpha" = _Ly2P1rFj;
        "pkg-0.14.0-alpha" = _uXLOkfaf;
        "pkg-0.14.1-alpha" = _40e9Imeb;
        "pkg-0.14.2-alpha" = _v6qlduEW;
        "pkg-0.14.3-alpha" = _rmQt8Arp;
        "pkg-0.14.4-alpha" = _Fqujov3H;
        "pkg-0.14.5-alpha" = _5MFxeVZE;
        "pkg-0.14.6-alpha" = _LMkHCxgS;
        "pkg-0.14.7-alpha" = _uK5ZapJJ;
        "pkg-0.14.8-alpha" = _cW6QATcK;
        "pkg-0.14.9-alpha" = _TnldaRMN;
        "pkg-0.14.10-alpha" = _4rN0lU2G;
        "pkg-0.14.11-alpha" = _isktFt5L;
        "pkg-0.14.12-alpha" = _VOuW2C0E;
        "pkg-0.14.13-alpha" = _8qpzGZb1;
        "pkg-0.14.14-alpha" = _DVL6sxj8;
        "pkg-0.14.15-alpha" = _c4YYs3CB;
        "pkg-0.14.16-alpha" = _TLwH18Db;
        "pkg-0.15.0-alpha" = _ZNiJbymH;
        "pkg-0.15.1-alpha" = _fLsLFoBw;
        "pkg-0.15.2-alpha" = _oCZVdHyt;
        "pkg-0.15.3-alpha" = _LfBhrKSx;
        "pkg-0.16.0-alpha" = _eZYMVHld;
        "pkg-0.16.1-alpha" = _oEJfv9Pp;
        "pkg-0.16.2-alpha" = _IXC9TzGn;
        "pkg-0.16.3-alpha" = _ZikKn8n8;
        "pkg-0.16.4-alpha" = _QIG999g7;
        "pkg-0.17.0-alpha" = _oaVQopv5;
