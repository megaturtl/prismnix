...
let
    versions = (let
        ...
        _cgPvkdv6 = {
            "id" = "cgPvkdv6";
            "file" = "golden-days-alpha-16.3-[1.20-to-26.3].zip";
            "hash" = "sha512-SORHChm/9tugxF3UMvymIKCY1m6HefHRA8C4h9WBDnkDG/J3BAwE5v9YAbFRnpRprdDInNWVCilcLI3NPYwcNw==";
        };
    in {
        "WxvbGlvp" = _WxvbGlvp;
        "aMpi9IMa" = _aMpi9IMa;
        ...
        "minecraft-1.20" = _cgPvkdv6;
        "minecraft-1.20.1" = _cgPvkdv6;
        "minecraft-1.20.2" = _cgPvkdv6;
        "minecraft-1.20.3" = _cgPvkdv6;
        "minecraft-1.20.4" = _cgPvkdv6;
        "minecraft-1.20.5" = _cgPvkdv6;
        "minecraft-1.20.6" = _cgPvkdv6;
        "minecraft-1.21" = _cgPvkdv6;
        "minecraft-1.21.1" = _cgPvkdv6;
        "minecraft-1.21.2" = _cgPvkdv6;
        "minecraft-1.21.3" = _cgPvkdv6;
        "minecraft-1.21.4" = _cgPvkdv6;
        "minecraft-1.21.5" = _cgPvkdv6;
        "minecraft-1.21.6" = _cgPvkdv6;
        "minecraft-1.21.7" = _cgPvkdv6;
        "minecraft-1.21.8" = _cgPvkdv6;
        "minecraft-1.21.9" = _cgPvkdv6;
        "minecraft-1.21.10" = _cgPvkdv6;
        "minecraft-1.21.11" = _cgPvkdv6;
        "minecraft-26.1" = _cgPvkdv6;
        "minecraft-26.1.1" = _cgPvkdv6;
        "minecraft-26.1.2" = _cgPvkdv6;
        "minecraft-26.2" = _cgPvkdv6;
        "minecraft-26.3" = _cgPvkdv6;
        "pkg-1.7.0" = _WxvbGlvp;
        "pkg-1.8.2" = _aMpi9IMa;
        "pkg-1.9.1" = _mpgJCu0C;
        "pkg-1.10.0" = _9cNEh5Ut;
        "pkg-1.12.0" = _qnc6cK6A;
        "pkg-1.12.1" = _2z6Zz26u;
        "pkg-1.12.2" = _NecL6kob;
        "pkg-1.13.0" = _iJXxeZ11;
        "pkg-1.15.0" = _vnU5h5L2;
        "pkg-1.15.2" = _IMAS2Bsd;
        "pkg-16.0" = _UhQHwjFs;
        "pkg-16.2" = _P7EQSmwP;
        "pkg-16.3" = _cgPvkdv6;
        "default" = _cgPvkdv6;
