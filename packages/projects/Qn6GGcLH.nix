...
let
    ...
    in {
        ...
        "pkg-v0.1.1-fabric-1.21.4" = _LPlnXIWv;
        "pkg-v0.1.1-fabric-1.21.5" = _Ww6IDtKG;
        "pkg-v0.1.1-fabric-1.21.6" = _YqmTocJV;
        "pkg-v0.1.1-fabric-1.21.7" = _d3JJZS4Z;
        "pkg-v0.1.1-fabric-1.21.8" = _wsuem2A4;
        "pkg-v0.1.1-fabric-1.21.9" = _5m85clu4;
        "pkg-v0.1.1-fabric-1.21.10" = _Byg61Ah9;
        "pkg-v0.1.1-fabric-1.21.11" = _ggEH6OxD;
        "pkg-v0.1.1-fabric-26.1" = _1Ur3dsnY;
        "pkg-v0.1.1-fabric-26.1.1" = _X3kjx6i2;
        "pkg-v0.1.1-fabric-26.1.2" = _mdJTamKh;
        "pkg-v0.1.1-neoforge-1.21.1" = _HVpSDt2r;
        "pkg-v0.1.1-neoforge-1.21.2" = _Jz2OBREn;
        "pkg-v0.1.1-neoforge-1.21.3" = _jouMf41d;
        "pkg-v0.1.1-neoforge-1.21.4" = _noPeKTTh;
        "pkg-v0.1.1-neoforge-1.21.5" = _w3TF0obB;
        "pkg-v0.1.1-neoforge-1.21.6" = _Gn1C9QWn;
        "pkg-v0.1.1-neoforge-1.21.7" = _uGJ30GEM;
        "pkg-v0.1.1-neoforge-1.21.8" = _gQgkMR9t;
        "pkg-v0.1.1-neoforge-1.21.9" = _R8LE14cy;
        "pkg-v0.1.1-neoforge-1.21.10" = _mFX0sCTJ;
        "pkg-v0.1.1-neoforge-1.21.11" = _VKBv25uj;
        "pkg-v0.1.1-neoforge-26.1" = _ViIAm05R;
        "pkg-v0.1.1-neoforge-26.1.1" = _DO0NJ0lf;
