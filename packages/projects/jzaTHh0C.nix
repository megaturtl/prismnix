...
let
    versions = (let
        ...
        _KIqCZqqo = {
            "id" = "KIqCZqqo";
            "file" = "shrink-neoforge-26.3-2.1.2.jar";
            "hash" = "sha512-aLoSphniJvoAz4kJNAmDUw+cuhhZXb1uG2fI4OnPtIAe5DJ29Al2LJx2widRHY0QEbeAq2TggCXVwoFxNdPOtA==";
        };
        _OJm2iTXC = {
            "id" = "OJm2iTXC";
            "file" = "shrink-fabric-26.3-2.1.2.jar";
            "hash" = "sha512-uzO4YenZ0GCyf665DuNldiHm5BFM3KoKu/SEO3Eue1u+432cMMf4j/OE8sdKl4pBZSBY5xQn0roM8yDsMrdpuQ==";
        };
    in {
        "JIH9dT7q" = _JIH9dT7q;
        "9FevdKTW" = _9FevdKTW;
