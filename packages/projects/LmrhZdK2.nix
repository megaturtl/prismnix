...
let
    ...
    in {
        ...
        "pkg-1.2.0" = _NOHOZpkQ;
        "pkg-1.2.1" = _VuT2UJb3;
        "pkg-2.0.0+neoforge" = _bFCn33sE;
        "pkg-2.0.0+fabric" = _j8EupRKr;
        "pkg-2.0.1+neoforge" = _AFwDl67W;
        "pkg-2.0.1+fabric" = _oNoOVbcr;
        "pkg-2.0.2+neoforge" = _WfI4r5yu;
        "pkg-2.0.2+fabric" = _AXCJLrGp;
        "pkg-2.3.0-1.20.1+fabric" = _TGedNFfn;
        "pkg-2.3.0-1.20.1+forge" = _nRU0Aumi;
        "pkg-2.3.0-1.21.1+neoforge" = _l6Xj39BT;
        "pkg-2.3.0-1.21.1+fabric" = _idllydr0;
        "pkg-3.0.0-1.21.1+fabric" = _3eG2fybk;
        "pkg-3.0.0-1.21.1+neoforge" = _aVz7IhyJ;
        "pkg-3.0.0-1.20.1+fabric" = _MDHJCHra;
        "pkg-3.0.0-1.20.1+forge" = _NPBEnvXx;
        "pkg-3.0.1-1.21.1+fabric" = _m01ELvrM;
        "pkg-3.0.1-1.21.1+neoforge" = _Be9Mffgo;
        "pkg-3.0.1-1.20.1+fabric" = _p8haI0h3;
        "pkg-3.0.1-1.20.1+forge" = _8YOM9XBK;
        "pkg-3.1.2-1.20.1+fabric" = _AvViY1gY;
        "pkg-3.1.2-1.20.1+forge" = _bvzALKMU;
        "pkg-3.1.2-1.21.1+fabric" = _4I9OROrh;
        "pkg-3.1.2-1.21.1+neoforge" = _e1f78s9u;
        "pkg-3.2.0-1.20.1+fabric" = _ipJ2hHD2;
        "pkg-3.2.0-1.20.1+forge" = _MqcvyND1;
        "pkg-3.2.0-1.21.1+fabric" = _KVAECTx3;
        "pkg-3.2.0-1.21.1+neoforge" = _W3wIN2OB;
        "pkg-3.3.0-1.21.1+fabric" = _cnTZrKuu;
        "pkg-3.3.0-1.21.1+neoforge" = _OtAQZd9N;
        "pkg-3.3.0-1.20.1+fabric" = _zDX4C06K;
        "pkg-3.3.0-1.20.1+forge" = _YVtVVdQO;
        "pkg-3.3.1-1.21.1+fabric" = _93q02eFk;
        "pkg-3.3.1-1.21.1+neoforge" = _fdk3qWm1;
        "pkg-3.3.1-1.20.1+fabric" = _m2iRGkva;
        "pkg-3.3.1-1.20.1+forge" = _BdNBxYl5;
        "pkg-3.3.2-1.21.1+fabric" = _xksaQlB8;
        "pkg-3.3.2-1.21.1+neoforge" = _Hh1zkhZl;
        "pkg-3.3.2-1.20.1+fabric" = _tT6Izhdq;
        "pkg-3.3.2-1.20.1+forge" = _4b0ZVWgY;
        "pkg-3.4.0-1.20.1+fabric" = _Ln44ZJCF;
        "pkg-3.4.0-1.20.1+forge" = _s4RU108r;
        "pkg-3.4.0-1.21.1+fabric" = _8SujCzpt;
        "pkg-3.4.0-1.21.1+neoforge" = _qewLO4CO;
        "pkg-3.4.1-1.21.1+fabric" = _yeNtRrXc;
        "pkg-3.4.1-1.21.1+neoforge" = _QyHdJGpu;
        "pkg-3.4.1-1.20.1+fabric" = _PArBLnzS;
        "pkg-3.4.1-1.20.1+forge" = _PQawSG7k;
        "pkg-3.4.2-1.21.1+fabric" = _SmtZObtZ;
        "pkg-3.4.2-1.21.1+neoforge" = _muZTnA9P;
        "pkg-3.4.2-1.20.1+fabric" = _BbhiDYLc;
        "pkg-3.4.2-1.20.1+forge" = _p2gDCM5V;
        "pkg-3.4.3-1.21.1+fabric" = _oY9z8vAY;
        "pkg-3.4.3-1.21.1+neoforge" = _MRf39DcQ;
        "pkg-3.4.3-1.20.1+fabric" = _EcHceYF4;
        "pkg-3.4.3-1.20.1+forge" = _7SmUjNGe;
        "pkg-3.5.0-1.21.1+fabric" = _DLllfJ2R;
        "pkg-3.5.0-1.21.1+neoforge" = _npUdncph;
        "pkg-3.5.0-1.20.1+fabric" = _a2tuI4xi;
        "pkg-3.5.0-1.20.1+forge" = _Cv14eccr;
        "pkg-3.6.0-1.21.1+fabric" = _3n6zLiio;
        "pkg-3.6.0-1.21.1+neoforge" = _YtAMyMxt;
        "pkg-3.6.0-1.20.1+fabric" = _jq6eiTlz;
        "pkg-3.6.0-1.20.1+forge" = _MXBn3isV;
        "pkg-3.6.1-1.21.1+fabric" = _QitZ5fVO;
