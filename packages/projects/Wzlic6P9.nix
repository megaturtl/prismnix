...
let
    ...
    in {
        ...
        "pkg-0.0.8" = _6ZwO2dBH;
        "pkg-0.0.9" = _6CZFI1ZI;
        "pkg-0.0.10" = _zXkOkDv8;
        "pkg-0.0.11" = _DE2HMrrR;
        "pkg-0.0.12" = _dpoKr6PM;
        "pkg-0.0.13" = _ZnSFRBxU;
        "pkg-0.0.14" = _7C1PTiZV;
        "pkg-0.0.15" = _sKShG5In;
        "pkg-0.0.16" = _lAVSv3gQ;
        "pkg-0.0.17" = _KbQ4riE4;
        "pkg-0.0.18" = _YIjaaZQ0;
        "pkg-0.0.181" = _DrC8GTir;
        "pkg-0.0.182" = _wPGcQM3a;
        "pkg-0.0.19" = _xT5MuAhd;
        "pkg-0.0.20" = _e9txN9VO;
        "pkg-0.0.21" = _7AhfsJil;
        "pkg-0.0.211" = _r4TRwpAa;
        "pkg-0.0.22" = _1Gvazedn;
        "pkg-0.0.23" = _LFKXMwLf;
        "pkg-0.0.23-forge" = _gsYQXekZ;
        "pkg-0.0.231-forge" = _iLYYrKOx;
        "pkg-0.0.24" = _aIeZApZ6;
