...
let
    ...
    in {
        ...
        "pkg-0.0.4" = _G6Du7mfz;
        "pkg-0.0.5" = _KRb4A4ev;
        "pkg-0.0.5.1" = _sTPIXspH;
        "pkg-0.0.6" = _NimIX4VY;
        "pkg-0.0.6.1" = _SE26nekR;
        "pkg-0.0.6.2" = _bMtcIBWD;
        "pkg-0.0.6.3" = _1R5LfkEb;
        "pkg-0.0.7" = _mRrqMoVq;
        "pkg-0.0.7.1" = _9ZCDE3R7;
        "pkg-0.0.7.2" = _urOJ52Nl;
        "pkg-0.0.8" = _Z8RR1uaO;
        "pkg-0.0.8.1" = _J3hcU3Re;
        "pkg-0.0.8.2" = _QEJm4Aq0;
        "pkg-0.0.8.3" = _ls1HEkEM;
        "pkg-0.0.8.4" = _8IgadNhx;
        "pkg-0.0.8.5" = _ZSf2BKBN;
