...
let
    ...
    in {
        ...
        "pkg-4.12.0" = _W7Fdiwf4;
        "pkg-4.15.0" = _aaJ9fjNS;
        "pkg-4.15.1" = _WGe6YeAU;
        "pkg-4.18.0" = _mKhlz7zk;
        "pkg-4.20.0" = _8zbpGxJ1;
        "pkg-4.20.1" = _mBkijfNG;
        "pkg-4.22.0" = _BxxtwBwo;
        "pkg-4.26.0" = _ZvDzzgL2;
        "pkg-5.3.0" = _2cD86a2G;
        "pkg-5.4.0" = _mdZg258H;
        "pkg-6.3.0" = _ne8WGGQi;
        "pkg-6.4.0" = _BooPdbLG;
        ...
        "pkg-6.4.2" = _llzGpTFO;
        "pkg-6.4.3" = _X2JWHbkA;
        "pkg-6.13.0" = _DgKBQXP1;
        "pkg-7.0.0" = _fgqB9tZV;
        "pkg-7.2.0" = _WDeADsuv;
        "pkg-7.2.1" = _BJgog8F4;
        "pkg-7.2.2" = _YOh287Dk;
        "pkg-7.2.3" = _TvKcuaL2;
        "pkg-7.12.0" = _aWSZG0Vo;
        "pkg-7.15.0" = _Y9Fyd07K;
        "pkg-7.18.0" = _ufDnLEUL;
        "pkg-7.23.0" = _NcKjo22P;
