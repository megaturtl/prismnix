...
let
    versions = (let
        ...
        _DvqIMypT = {
            "id" = "DvqIMypT";
            "file" = "zipline-fabric-1.21.1-1.5.1.jar";
            "hash" = "sha512-fIDaRNccOJ/VFddYuww67DM6dggOkH696oh2iUEOWpop0g6tM2cSoFUj2REdw+uQT3Csge0enKpsHeH1BW9lZg==";
        };
        _PpntSdsm = {
            "id" = "PpntSdsm";
            "file" = "zipline-neoforge-1.21.1-1.5.1.jar";
            "hash" = "sha512-/GD5HyQGikKWwNccYjgm2jhKH9cmnJ7spIrRUc8yloH517BrgwowQF2Qnprz9efw7byxD018DCzQjaQ/qASfdA==";
        };
        _4aA41064 = {
            "id" = "4aA41064";
            "file" = "zipline-neoforge-1.21.1-1.5.2.jar";
            "hash" = "sha512-NxgVDbvzF00Q/LZEcWnPkK3hc7F9uIbnnyf5osK8VJhSndSPIsubvo3T8DAWBHYvSpcE69rhsFOCk2R/c3X5DQ==";
        };
        _PTa48tUi = {
            "id" = "PTa48tUi";
    ...
    in {
        ...
        "pkg-1.0.1" = _pUAJcoJ4;
        "pkg-1.0.2" = _OtOoMdaD;
        "pkg-1.0.3-1.20.1-fabric" = _z0FE3K7I;
        "pkg-1.0.3-1.20.1-forge" = _l58D77Bj;
        "pkg-1.0.3-1.21.1-fabric" = _5lSJRBmg;
        "pkg-1.0.3-1.21.1-neoforge" = _EezeLHnd;
        "pkg-1.1.0-1.20.1-fabric" = _ulKbUMJL;
        "pkg-1.1.0-1.20.1-forge" = _FL0O2DDG;
        "pkg-1.1.0" = _Vo1bjSLq;
        "pkg-1.1.0-26.1.2-neoforge" = _hyLlzySI;
        "pkg-1.1.0-26.1.2-fabric" = _RUh3V9JY;
        "pkg-1.1.1-1.20.1-fabric" = _737vO4Hs;
        "pkg-1.1.1-1.20.1-forge" = _CA9TfUdM;
        "pkg-1.1.1-1.21.1-neoforge" = _bunyeFxL;
        "pkg-1.1.1-1.21.1-fabric" = _ziiiGVi3;
        "pkg-1.1.1-26.1.2-neoforge" = _Cj2C72uC;
        "pkg-1.1.1-26.1.2-fabric" = _8E0U8WHr;
        "pkg-1.2.0-26.1.2-fabric" = _vL9oeB7N;
        "pkg-1.2.0-26.1.2-neoforge" = _YmeAOjX6;
        "pkg-1.2.0-1.21.1-fabric" = _xRMoDWe3;
        "pkg-1.2.0-1.21.1-neoforge" = _hWvibVaC;
        "pkg-1.2.0-1.20.1-forge" = _NNFxlh2Q;
        "pkg-1.2.0-1.20.1-fabric" = _n7kVRTVV;
        "pkg-1.2.1-1.21.1-neoforge" = _Vuq0V0Pe;
        "pkg-1.2.1-1.21.1-fabric" = _dxdk8ZEH;
        "pkg-1.2.2-1.21.1-neoforge" = _emIYdkrI;
        "pkg-1.2.2-1.21.1-fabric" = _RxsL1ud2;
        "pkg-1.2.2-26.1.2-fabric" = _wKfk6j5v;
        "pkg-1.2.2-26.1.2-neoforge" = _VZHu7Qe1;
        "pkg-1.2.2-1.20.1-fabric" = _Nb6p8u65;
        "pkg-1.2.2-1.20.1-forge" = _FcdiilTQ;
        "pkg-1.3.0-1.21.1-fabric" = _uUmZz0lj;
        "pkg-1.3.0-1.21.1-neoforge" = _AMUQhQYc;
        "pkg-1.3.0-1.20.1-forge" = _AZLF926r;
        "pkg-1.3.0-1.20.1-fabric" = _jqVbgM73;
        "pkg-1.4.0-1.21.1-neoforge" = _aVb4ojPr;
        "pkg-1.4.0-1.21.1-fabric" = _cs2FaTHz;
        "pkg-1.2.2-26.2-neoforge" = _V6N34h0b;
        "pkg-1.2.2-26.2-fabric" = _PgqTlL3O;
        "pkg-1.5.0-1.21.1-neoforge" = _Rjr0HKPQ;
        "pkg-1.5.0-1.21.1-fabric" = _p7qtj0Yq;
        "pkg-1.5.1-1.21.1-fabric" = _DvqIMypT;
