...
let
    ...
    in {
        ...
        "pkg-1.3.9+MC1.17-1.17.1" = _eSwyyJYs;
        "pkg-1.3.10+MC1.18" = _huKlAOBN;
        "pkg-1.3.11+MC1.18" = _X1toGvVH;
        "pkg-1.3.12+MC1.18-1.18.1" = _Q0AkkKrk;
        "pkg-1.3.13+MC1.18-1.18.2" = _Gp9rTQZa;
        "pkg-1.3.15+MC1.19" = _3zMPEsxT;
        "pkg-1.3.16+MC1.19" = _b7OISMlP;
        "pkg-1.3.17+MC1.19-1.19.1" = _ixvmYFQ7;
        "pkg-1.3.18+MC1.19-1.19.2" = _BZZb9Ac5;
        "pkg-1.3.19+MC1.19-1.19.2" = _oHQseO1B;
        "pkg-1.3.20+MC1.19.3-1.19.4" = _zqgPupDi;
        "pkg-1.3.21+MC1.19-1.19.2" = _OYBO4wTy;
        "pkg-1.3.21+MC1.19.3-1.19.4" = _v6cdqrPp;
        "pkg-1.3.22+MC1.19-1.19.2" = _pbYNr0Sf;
        "pkg-1.3.22+MC1.19.3" = _xy01j8HE;
        "pkg-1.3.24+MC1.19.4" = _Yd8dS54O;
        "pkg-1.3.24+MC1.20-1.20.1" = _VcHbwjAW;
        "pkg-1.3.25+MC1.19-1.19.2" = _feO7JDq6;
        "pkg-1.3.25+MC1.19.3" = _FF3vtaEo;
        "pkg-1.3.25+MC1.19.4" = _CREftRXE;
        "pkg-1.3.25+MC1.20-1.20.1" = _iKSZqXsI;
        "pkg-1.3.25-1+MC1.20-1.20.1" = _2gm5Z2K4;
        "pkg-1.3.26+MC1.19-1.19.2" = _k6H6swoc;
        "pkg-1.3.26+MC1.19.3" = _3vPpp1SO;
        "pkg-1.3.26+MC1.19.4" = _YviDRgGL;
        "pkg-1.3.26+MC1.20-1.20.1" = _OZZM1kjW;
        "pkg-1.3.27+MC1.20-1.20.1" = _ELAXQHOt;
        "pkg-1.3.28+MC1.20.2" = _fa01BzgF;
        "pkg-1.3.29+MC1.20.2-1.20.4" = _WUjNSDMF;
        "pkg-1.3.30+MC1.20.5" = _DM2aqCdL;
        "pkg-1.3.31+MC1.20.5-1.20.6" = _4oBEk8ah;
        "pkg-1.4.0+MC1.21" = _akbsMRRb;
        "pkg-1.4.1+MC1.21-1.21.1" = _WZK3WdMY;
        "pkg-1.5.0+MC1.21.2-1.21.3" = _1YZgrGci;
        "pkg-1.6.0+MC1.21.4" = _6G30eeSM;
        "pkg-1.5.1+MC1.21.2-1.21.3" = _fvHf3j0i;
        "pkg-1.6.1+MC1.21.4" = _HnasZNoh;
        "pkg-1.7.0+MC1.21.5" = _y2sixgcY;
        "pkg-1.8.0+MC1.21.6" = _rNVp6BLc;
        "pkg-1.8.1+MC1.21.6-1.21.7" = _MoYwVqic;
        "pkg-1.8.2+MC1.21.6-1.21.8" = _Pk6Li2rL;
        "pkg-1.9.0+MC1.21.9-1.21.10" = _7pxTskic;
        "pkg-1.10.0+MC1.21.11" = _LoO0tXdi;
        "pkg-1.8.3+MC1.21.6-1.21.8" = _fQ5XJBxb;
