...
let
    versions = (let
        ...
        _XPK90WJL = {
            "id" = "XPK90WJL";
            "file" = "explorations-neoforge-26.1.2-1.6.3.jar";
            "hash" = "sha512-a4CKXaQJHdhW3A+QbO2ziIeaXjWOP/5/Q3UjDE+SdyVIZvgYbL4N9ujCT4NQIQkzesuADs2E6VE3AGyU6J1axg==";
        };
        _K81iauru = {
            "id" = "K81iauru";
            "file" = "explorations-fabric-26.1.2-1.6.3.jar";
            "hash" = "sha512-FDpRG08oIRR55lFO3fO9pY59yDNb9hBkDIYfoMRkhS5XCmH8/KxAscOo6dKtgYRtXMA4k96bOeOtFAi6kNPSdg==";
        };
        _TuxHelgj = {
            "id" = "TuxHelgj";
            "file" = "explorations-forge-26.1.2-1.6.3.jar";
            "hash" = "sha512-13KAGsj0FWrF8i2sJVHA7jH8AMtEH7ifFEyiL6VKdqvO0jtXCWOIS3cycs29CXYRGZuca1WiDkeahcUOpgNZ9w==";
        };
        _yIyfvOvl = {
            "id" = "yIyfvOvl";
            "file" = "explorations-neoforge-26.1.2-1.6.4.jar";
            "hash" = "sha512-V8vAvBn1/jmnLC2rViMNAeCJiN6FXZsggKQUG4XRNun94LPPBKUTi94jMNKtdrb4H8XY7mAcsLdtwfoFitquYQ==";
        };
        _EPtcBRBP = {
            "id" = "EPtcBRBP";
            "file" = "explorations-fabric-26.1.2-1.6.4.jar";
            "hash" = "sha512-NwaxXIKR78e4YbsfQ4gNeOTtZOoxcbgpzDFAt5sR40zaGayBahPUogLna09acSgf/VrzrCD/ADfxN6i3eqWQlQ==";
        };
        _Zp3zA4sj = {
            "id" = "Zp3zA4sj";
            "file" = "explorations-forge-26.1.2-1.6.4.jar";
            "hash" = "sha512-gJoLkC8/+9MnIdoK54EabScoakA4PjUeIseJ60PG4dLSUEWmRpfAq3h5cD42fopeI7bi5zor7csP4G9ouDonsw==";
        };
        _oRm12zZP = {
            "id" = "oRm12zZP";
            "file" = "explorations-neoforge-26.2-1.6.4.jar";
            "hash" = "sha512-4c7/OzrW2/sLbywVIFeoW//5Na7wlAE2BR7r7XDK1Cvno8f9oklYP3CJFjIy7fXuA9kSl6M5cU2ByfGHBaqK4Q==";
        };
        _pZDRvBKj = {
            "id" = "pZDRvBKj";
            "file" = "explorations-fabric-26.2-1.6.4.jar";
            "hash" = "sha512-Fvl5QClcejNyzo7Nylb+GFyfxLz9tWEd5K2T+Gv0RJsyIBv9mNFcosS42JlYTQlGfrJ7N+RAhvr/7SRJYm2mSg==";
        };
        _JV8NT4EW = {
            "id" = "JV8NT4EW";
            "file" = "explorations-forge-26.2-1.6.4.jar";
            "hash" = "sha512-Gp9qddccSDIjP/JJGjZSrr34BAefteQ36qL/sRncgOyOLkNH8eiVnGaZ/0aD/qYAbC9hgjvc4sCcpFjf6i5YHQ==";
        };
    in {
        "WNXLm3By" = _WNXLm3By;
        "LFrsRn9T" = _LFrsRn9T;
        ...
        "forge-26.1.2" = _Zp3zA4sj;
        "forge-26.2" = _JV8NT4EW;
        ...
        "fabric-26.1.2" = _EPtcBRBP;
        "fabric-26.2" = _pZDRvBKj;
        ...
        "neoforge-26.1.2" = _yIyfvOvl;
        "neoforge-26.2" = _oRm12zZP;
        "pkg-1.18.2-1.1.1-Forge" = _WNXLm3By;
        "pkg-1.18.2-1.1.0-Forge" = _LFrsRn9T;
        "pkg-1.19-1.1.2-Forge" = _OzAuorNK;
        "pkg-1.19-1.2-Forge" = _osAUR6i9;
        "pkg-1.19.2-1.3-Fabric" = _aBl5QxpX;
        "pkg-1.19.2-1.3-Forge" = _MlmEeTNR;
        "pkg-1.19.3-1.3-Fabric" = _Me79PSMD;
        "pkg-1.19.3-1.3-Forge" = _BAsPnPxX;
        "pkg-1.19.3-1.3.1-Fabric" = _CDUvzyFl;
        "pkg-1.19.3-1.3.1-Forge" = _lT2CLUE6;
        "pkg-1.18.2-1.4.0-Fabric" = _BvQWGaE7;
        "pkg-1.18.2-1.4.0-Forge" = _BERDOeiV;
        "pkg-1.19.2-1.4.0-Fabric" = _Rs2dUd6m;
        "pkg-1.19.2-1.4.0-Forge" = _f6yFhyiW;
        "pkg-1.19.3-1.4.0-Fabric" = _8wuUgySp;
        "pkg-1.19.3-1.4.0-Forge" = _94EXKDa5;
        "pkg-1.18.2-1.5.0-Fabric" = _2BpMfHYN;
        "pkg-1.18.2-1.5.0-Forge" = _kiN3EFwY;
        "pkg-1.19.2-1.5.0-Fabric" = _bAfmWArn;
        "pkg-1.19.2-1.5.0-Forge" = _Sx3LunNg;
        "pkg-1.19.3-1.5.0-Fabric" = _Juyns8Qq;
        "pkg-1.19.3-1.5.0-Forge" = _2jxxuHqA;
        "pkg-1.19.4-1.5.0-Fabric" = _5dy9IcZH;
        "pkg-1.19.4-1.5.0-Forge" = _qWgv80WX;
        "pkg-1.18.2-1.5.1-Fabric" = _rZd48BXR;
        "pkg-1.18.2-1.5.1-Forge" = _stFW1owg;
        "pkg-1.19.2-1.5.1-Fabric" = _iVk3nx9c;
        "pkg-1.19.2-1.5.1-Forge" = _r2NFwLsw;
        "pkg-1.19.4-1.5.1-Fabric" = _g3Oyom1j;
        "pkg-1.19.4-1.5.1-Forge" = _kpcmrqrB;
        "pkg-1.20.1-1.5.1-Fabric" = _M0EKBnDS;
        "pkg-1.20.1-1.5.1-Forge" = _tKU4bG2v;
        "pkg-1.18.2-1.5.2-Fabric" = _ZZHaAfqw;
        "pkg-1.18.2-1.5.2-Forge" = _SOJqRvF6;
        "pkg-1.19.2-1.5.2-Fabric" = _IRQMgOQS;
        "pkg-1.19.2-1.5.2-Forge" = _VtnbJzfx;
        "pkg-1.19.4-1.5.2-Fabric" = _oV03Br42;
        "pkg-1.19.4-1.5.2-Forge" = _Jt2GuWv4;
        "pkg-1.20.1-1.5.2-Fabric" = _bxBfl7rM;
        "pkg-1.20.1-1.5.2-Forge" = _p6rfGUTW;
        "pkg-1.20.4-1.5.3-Neoforge" = _3rffLJls;
        "pkg-1.20.4-1.5.3-Fabric" = _rkLtZVIF;
        "pkg-1.20.4-1.5.3-Forge" = _txpuj833;
        "pkg-1.16.5-1.5.3-Forge" = _j2hIT5Qi;
        "pkg-1.20.6-1.5.3-NeoForge" = _13OiLfi3;
        "pkg-1.20.6-1.5.3-Fabric" = _NtJn0twT;
        "pkg-1.20.6-1.5.3-Forge" = _M06mrc92;
        "pkg-1.21-1.5.3-NeoForge" = _bwLWbh1z;
        "pkg-1.21-1.5.3-Fabric" = _P2h29sY2;
        "pkg-1.21-1.5.3-Forge" = _X1PsatOm;
        "pkg-1.16.5-1.6.0-Forge" = _RgQcPkBy;
        "pkg-1.18.2-1.6.0-Fabric" = _G53YYjmY;
        "pkg-1.18.2-1.6.0-Forge" = _wVbprFUf;
        "pkg-1.16.5-1.6.1-Forge" = _OG2OXPYM;
        "pkg-1.18.2-1.6.1-Fabric" = _YQ9JDnUR;
        "pkg-1.18.2-1.6.1-Forge" = _guBUE49g;
        "pkg-1.19.2-1.6.1-Fabric" = _73HAzI2T;
        "pkg-1.19.2-1.6.1-Forge" = _uZHTkBA3;
        "pkg-1.19.4-1.6.1-Fabric" = _ZCieFtVh;
        "pkg-1.19.4-1.6.1-Forge" = _WhJVe6YH;
        "pkg-1.20.1-1.6.1-Fabric" = _EQZmtWsQ;
        "pkg-1.20.1-1.6.1-Forge" = _DrsYEYkr;
        "pkg-1.20.4-1.6.1-NeoForge" = _ikvIkS7r;
        "pkg-1.20.4-1.6.1-Fabric" = _gtnmiBti;
        "pkg-1.20.4-1.6.1-Forge" = _piuCqE9R;
        "pkg-1.20.6-1.6.1-NeoForge" = _If1ydsru;
        "pkg-1.20.6-1.6.1-Fabric" = _WhiwZWLw;
        "pkg-1.20.6-1.6.1-Forge" = _Z3dQ5LDl;
        "pkg-1.21-1.6.1-NeoForge" = _ofmPSqtx;
        "pkg-1.21-1.6.1-Fabric" = _CI09H390;
        "pkg-1.21-1.6.1-Forge" = _eG6IaTDz;
        "pkg-1.20.6-1.6.2-NeoForge" = _lBJHOeAF;
        "pkg-1.20.6-1.6.2-Fabric" = _MNfoyVKt;
        "pkg-1.20.6-1.6.2-Forge" = _WVXU81vj;
        "pkg-1.21.3-1.6.1-NeoForge" = _pW7xzHeN;
        "pkg-1.21.3-1.6.1-Fabric" = _ij4OtLbv;
        "pkg-1.21.3-1.6.1-Forge" = _ZNaT1N8h;
        "pkg-1.21.4-1.6.1-NeoForge" = _iveJKgmc;
        "pkg-1.21.4-1.6.1-Fabric" = _tmIm8LtY;
        "pkg-1.21.4-1.6.1-Forge" = _REee5SON;
        "pkg-1.21.1-1.6.2-NeoForge" = _LXWlvQLv;
        "pkg-1.21.1-1.6.2-Fabric" = _u3zAhTEO;
        "pkg-1.21.1-1.6.2-Forge" = _9yBwonlM;
        "pkg-1.21.4-1.6.2-NeoForge" = _sK0kKFmP;
        "pkg-1.21.4-1.6.2-Fabric" = _wRVhIZk1;
        "pkg-1.21.4-1.6.2-Forge" = _AbJWlYtg;
        "pkg-1.21.5-1.6.2-NeoForge" = _SrCLBwDF;
        "pkg-1.21.5-1.6.2-Fabric" = _e3PQefJc;
        "pkg-1.21.5-1.6.2-Forge" = _wePnj8eF;
        "pkg-1.21.6-1.6.2-NeoForge" = _nMWWCS9X;
        "pkg-1.21.6-1.6.2-Fabric" = _vixckr4p;
        "pkg-1.21.6-1.6.2-Forge" = _tQyAmoRH;
        "pkg-1.21.7-1.6.2-NeoForge" = _P4hotebG;
        "pkg-1.21.7-1.6.2-Fabric" = _t4yn1MsX;
        "pkg-1.21.7-1.6.2-Forge" = _FaaJLXuM;
        "pkg-1.21.8-1.6.2-NeoForge" = _ABNRVwTh;
        "pkg-1.21.8-1.6.2-Fabric" = _5CS5rTlk;
        "pkg-1.21.8-1.6.2-Forge" = _899KDYC2;
        "pkg-1.21.10-1.6.3-NeoForge" = _9eT2wYE4;
        "pkg-1.21.10-1.6.3-Fabric" = _c8YtY8m3;
        "pkg-1.21.10-1.6.3-Forge" = _ETxilbQT;
        "pkg-1.21.11-1.6.3-NeoForge" = _nvSGSBOF;
        "pkg-1.21.11-1.6.3-Fabric" = _N8ZGktzQ;
        "pkg-1.21.11-1.6.3-Forge" = _BBpqbIWW;
        "pkg-26.1.2-1.6.3-NeoForge" = _XPK90WJL;
        "pkg-26.1.2-1.6.3-Fabric" = _K81iauru;
        "pkg-26.1.2-1.6.3-Forge" = _TuxHelgj;
        "pkg-26.1.2-1.6.4-NeoForge" = _yIyfvOvl;
        "pkg-26.1.2-1.6.4-Fabric" = _EPtcBRBP;
        "pkg-26.1.2-1.6.4-Forge" = _Zp3zA4sj;
        "pkg-26.2-1.6.4-NeoForge" = _oRm12zZP;
        "pkg-26.2-1.6.4-Fabric" = _pZDRvBKj;
        "pkg-26.2-1.6.4-Forge" = _JV8NT4EW;
        "default" = _JV8NT4EW;
    });
