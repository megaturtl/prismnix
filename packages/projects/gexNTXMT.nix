...
let
    versions = (let
        ...
        _hksug3Se = {
            "id" = "hksug3Se";
            "file" = "BareBonesOR-Version14.zip";
            "hash" = "sha512-Z479tpOB9lIbZ26Kbbi1ikOpj7G3hK4MOdgX3ipfth0HtyEVfBPRTOY9PoT1cfADK/qgbS5uL/eT3G3UtmyXYA==";
        };
    in {
        "ksmnacLX" = _ksmnacLX;
        "nBJVLn0U" = _nBJVLn0U;
        ...
        "i4oOt53n" = _i4oOt53n;
        "hksug3Se" = _hksug3Se;
        "minecraft-1.18" = _hksug3Se;
        "minecraft-1.18.1" = _hksug3Se;
        "minecraft-1.18.2" = _hksug3Se;
        "minecraft-1.19.1" = _hksug3Se;
        "minecraft-1.19.2" = _hksug3Se;
        "minecraft-1.19.3" = _hksug3Se;
        "minecraft-1.19.4" = _hksug3Se;
        "minecraft-1.20" = _hksug3Se;
        "minecraft-1.20.1" = _hksug3Se;
        "minecraft-1.20.2" = _hksug3Se;
        "minecraft-1.20.3" = _hksug3Se;
        "minecraft-1.20.4" = _hksug3Se;
        "minecraft-1.20.5" = _hksug3Se;
        "minecraft-1.20.6" = _hksug3Se;
        "minecraft-1.19" = _hksug3Se;
        "minecraft-1.21" = _hksug3Se;
        "minecraft-1.21.1" = _hksug3Se;
        "minecraft-1.21.2" = _hksug3Se;
        "minecraft-1.21.3" = _hksug3Se;
        "minecraft-1.21.4" = _hksug3Se;
        "minecraft-1.21.5" = _hksug3Se;
        "minecraft-1.21.6" = _hksug3Se;
        "minecraft-1.21.7" = _hksug3Se;
        "minecraft-1.21.8" = _hksug3Se;
        "minecraft-1.21.9" = _hksug3Se;
        "minecraft-1.21.10" = _hksug3Se;
        "minecraft-1.21.11" = _hksug3Se;
        "pkg-1.8" = _ksmnacLX;
        "pkg-2" = _nBJVLn0U;
        "pkg-3" = _EPY52I0t;
        "pkg-4" = _2u9n2sy7;
