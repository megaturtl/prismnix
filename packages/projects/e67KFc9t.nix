...
let
    ...
    in {
        ...
        "minecraft-26.1" = _uyv0yOr2;
        "minecraft-26.1.1" = _uyv0yOr2;
        "minecraft-26.1.2" = _uyv0yOr2;
        ...
        "minecraft-26.2" = _uyv0yOr2;
        "minecraft-26.3-snapshot-1" = _uyv0yOr2;
        "minecraft-26.3-snapshot-2" = _uyv0yOr2;
        "minecraft-26.3-snapshot-3" = _uyv0yOr2;
        "minecraft-26.3-snapshot-4" = _uyv0yOr2;
        "minecraft-26.3-snapshot-5" = _uyv0yOr2;
        "minecraft-26.3-snapshot-6" = _uyv0yOr2;
        "minecraft-26.3-snapshot-7" = _uyv0yOr2;
        "minecraft-26.3-snapshot-8" = _uyv0yOr2;
        "minecraft-26.3-snapshot-9" = _uyv0yOr2;
        "minecraft-26.3-snapshot-10" = _uyv0yOr2;
        "minecraft-26.3-pre-1" = _uyv0yOr2;
        "minecraft-26.3-pre-2" = _uyv0yOr2;
        ...
        "pkg-12.7" = _H2DV12UA;
        "pkg-13" = _zCTn1V5T;
        "pkg-1.13.1" = _l7iOMCi2;
        "pkg-13.2" = _srxHY2DV;
        "pkg-13.3" = _tLJuL4dG;
        "pkg-13.4" = _1iMzvdF7;
        "pkg-13.5" = _geJQAzYS;
        "pkg-13.6" = _yOp8r33b;
        "pkg-1.13.8" = _OVgj0SnM;
        "pkg-13.9" = _MWeQWZLR;
        "pkg-13.10" = _sAMKKCZg;
        "pkg-13.11" = _EgsmPeTq;
        "pkg-13.12" = _cbSxUsxQ;
        ...
        "pkg-17.25" = _bxrqhVN7;
        "pkg-17.26" = _HonPgrRi;
        "pkg-17.26.2" = _SAHo72pI;
        "pkg-17.27" = _poCogTbw;
        "pkg-17.27.2" = _hSuSt9KR;
        "pkg-17.27.3" = _q7s8OloV;
        "pkg-17.28" = _DphtCniV;
        "pkg-17.29" = _9PxVhAGa;
        "pkg-17.30" = _LvOYURqG;
        "pkg-17.31" = _iaEHPAdb;
        "pkg-17.32" = _9ihRk37M;
        "pkg-17.33" = _4ParvtAE;
        "pkg-17.33.2" = _JJVRapdI;
        "pkg-17.34" = _aKo3uYhK;
        "pkg-18" = _5QX6EC8E;
        "pkg-18.0.2" = _4pnoBiRj;
        "pkg-18.1" = _622m84DO;
        "pkg-18.2" = _XMoeF8TU;
        "pkg-18.2.2" = _PY6RDZBW;
        "pkg-18.3" = _qvjuyijB;
        "pkg-18.4" = _mmQoaOOe;
        "pkg-18.4.2" = _nRkq3EN6;
        "pkg-18.5" = _DLiLf83E;
        "pkg-18.6" = _2uIFIbHT;
        "pkg-18.7" = _J1u4Q7bW;
        "pkg-18.8" = _KVnT6o8h;
        "pkg-18.8.2" = _5GmgNiFM;
        "pkg-18.9" = _kUwBufGD;
        "pkg-18.10" = _3P2D3bQN;
        "pkg-18.11" = _r5OUeQRN;
        "pkg-18.12" = _EIVGfuy1;
