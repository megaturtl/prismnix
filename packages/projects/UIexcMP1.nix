...
let
    ...
    in {
        ...
        "pkg-2.2.0" = _nQgMagMt;
        "pkg-2.2.1" = _DYz146sd;
        "pkg-2.2.1a" = _cWNwTFQE;
        "pkg-2.2.1-1.21.9" = _tD2fz6dI;
        "pkg-2.3.0-1.21.1" = _rc5aJrDs;
        "pkg-2.3.0-1.20.1" = _lM8z6nKu;
        "pkg-2.3.0_01" = _88Drdurs;
        "pkg-2.4.0-26.1" = _TUQLLl9g;
        "pkg-2.4.0-26.1.1" = _UqTxrpda;
        "pkg-2.4.1-1.21.1" = _a7RyAE2L;
