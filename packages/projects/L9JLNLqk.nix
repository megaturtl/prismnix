...
let
    ...
    in {
        ...
        "pkg-1.17.1-2.2.1" = _pTaR01tc;
        "pkg-1.18-3.0.0" = _o793YqPm;
        "pkg-1.18.1-3.0.0" = _MVwjDPGu;
        "pkg-1.18.1-3.0.1" = _tYRimb2L;
        "pkg-1.18.1-3.0.2" = _Vb86ivfv;
        "pkg-1.18.2-3.1.0" = _mq0Zrjnl;
        "pkg-1.16.2-1.3.2" = _MIlEYSV3;
        "pkg-1.19-4.0.0" = _SfYH1yZR;
        "pkg-1.18.2-3.1.1" = _DX7mySkS;
        "pkg-1.19-4.0.1" = _wzCv6CJ6;
        "pkg-1.19-4.1.0" = _Uza3tWZm;
        "pkg-1.19-4.1.1" = _fPBV9RJl;
        "pkg-1.18.2-3.1.2" = _VyYUuw8G;
        "pkg-1.19-4.1.2" = _AVj4YOmV;
        "pkg-1.18.2-3.1.3" = _ElqrT4KO;
        "pkg-1.19-4.1.3" = _vBo8dI6L;
        "pkg-1.18.2-3.1.4" = _Py8XXtXl;
        "pkg-1.19-4.1.4" = _IRU1Mcpc;
        "pkg-1.19-4.1.5" = _oLx5jZzp;
        "pkg-1.19-4.1.6" = _ia1Vt4BC;
        "pkg-1.19-4.1.7" = _GXjSFQDi;
        "pkg-1.18.2-3.1.5" = _cAw3zQeP;
        "pkg-1.19.1-4.2.0" = _QcZkUSuZ;
        "pkg-1.16.2-1.3.4" = _jwmmulma;
        "pkg-1.19.3-4.3.0" = _rfEiBAh7;
        "pkg-1.19.4-4.4.0" = _tGYjHPH4;
        "pkg-1.19.4-4.4.1" = _VwjGUHMl;
        "pkg-1.20.1-5.0.0" = _oAXMMbAT;
        "pkg-1.20.1-5.0.1" = _ijsTB1o0;
        "pkg-1.20.1-5.0.2" = _X6LAMogH;
        "pkg-1.20.1-5.0.3" = _qniFHUVs;
        "pkg-1.20.1-5.0.4" = _sXFURLYY;
        "pkg-1.20.1-5.0.6" = _d9CQIJX3;
        "pkg-1.21-6.0.0" = _glcCTOjV;
        "pkg-1.21-6.0.1" = _8Opm0aJ4;
        "pkg-1.21-6.0.2" = _STIXD2Vh;
        "pkg-1.21-6.0.3" = _xeiYYQxZ;
        "pkg-21.5.0" = _8Z0V0KCu;
        "pkg-21.9.0" = _x0zp6fuz;
        "pkg-21.11.0" = _NqrfcLf1;
