...
let
    ...
    in {
        ...
        "pkg-1.0.3-NeoForge-1.21.1" = _b3j7ycIY;
        "pkg-1.0.3-NeoForge-1.21.5" = _QCPYJqpT;
        "pkg-1.0.3-NeoForge-1.21.8" = _RREicb7T;
        "pkg-1.0.4-NeoForge-1.21.8" = _kb0lBhXx;
        "pkg-1.0.4-NeoForge-1.21.1" = _rpVQlXHl;
        "pkg-1.0.4-NeoForge-1.21.4" = _Kc4QxI6a;
        "pkg-1.0.4-NeoForge-1.21.5" = _GnDcUA6K;
        "pkg-1.0.5-NeoForge-1.21.8" = _oF8DzAKH;
        "pkg-1.1.0-NeoForge-1.21.1" = _pc0KrdtP;
        "pkg-1.1.0-NeoForge-1.21.4" = _GgsXo75V;
        "pkg-1.1.0-NeoForge-1.21.5" = _1vmuY7Gz;
        "pkg-1.1.0-NeoForge-1.21.8" = _5UUWWN7o;
        "pkg-1.1.0-Forge-1.20.1" = _1Kma3yML;
        "pkg-1.1.0-NeoForge-1.21.9" = _iYIZS3Iw;
        "pkg-1.1.1-NeoForge-1.21.1" = _7ElHo2qY;
        "pkg-1.1.1-NeoForge-1.21.4" = _QfTcRrwC;
        "pkg-1.1.1-NeoForge-1.21.5" = _T9OttXtE;
        "pkg-1.1.1-NeoForge-1.21.8" = _vaVBzPpk;
        "pkg-1.1.1-NeoForge-1.21.9" = _LJtKGFpn;
        "pkg-1.1.1.1-NeoForge-1.21.1" = _r8hMcvgE;
        "pkg-1.1.1-NeoForge-1.21.11" = _M0cp066F;
        "pkg-1.1.1.1-NeoForge-1.21.11" = _llNsLnh6;
        "pkg-1.1.2-NeoForge-1.21.1" = _ioneimbM;
        "pkg-1.1.2-NeoForge-1.21.4" = _nVzLUEjK;
        "pkg-1.1.2-NeoForge-1.21.5" = _vT1DPocg;
        "pkg-1.1.2-NeoForge-1.21.8" = _aQu1cg1h;
        "pkg-1.1.2-NeoForge-1.21.9" = _jhhRJidX;
        "pkg-1.1.2-NeoForge-1.21.11" = _vGxFrNIu;
        "pkg-1.1.2.2-NeoForge-1.21.11" = _3hbg9AuG;
        "pkg-1.1.2.3-NeoForge-1.21.11" = _VotQq3nV;
        "pkg-1.1.2-beta.5-Forge-1.20.1" = _Ge7rLJV5;
        "pkg-1.1.2.4-NeoForge-1.21.11" = _9zoBb0LL;
        "pkg-1.1.2-NeoForge-26.1" = _OdSUNES3;
        "pkg-1.1.2.1-NeoForge-26.1" = _hdna0wIp;
        "pkg-1.1.2.2-NeoForge-26.1" = _30u92iMH;
        "pkg-1.1.2.3-NeoForge-26.1.2" = _5Pk8gBM1;
        "pkg-1.1.2.4-NeoForge-26.1.2" = _G7tbADeE;
        "pkg-1.1.3-NeoForge-26.1.2" = _Fc2dAJyZ;
        "pkg-1.1.2-Forge-1.20.1" = _oygQqwNu;
        "pkg-1.1.2.1-Forge-1.20.1" = _g4nFACm8;
        "pkg-1.1.2.2-Forge-1.20.1" = _pxf08VYw;
        "pkg-1.1.2.3-Forge-1.20.1" = _HuMQMXjz;
        "pkg-1.1.2.4-Forge-1.20.1" = _kcSYtCs7;
        "pkg-1.1.3.1-NeoForge-26.1.2" = _Zt0ZAGOd;
