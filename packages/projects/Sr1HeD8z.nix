...
let
    versions = (let
        ...
        _Qm55cVAm = {
            "id" = "Qm55cVAm";
            "file" = "walkers-5.8.12.jar";
            "hash" = "sha512-V4RPa4wkEaBP8iYVv1QV65fZRTyTJ5PwGH3SNbH7z2vOCkp2bu/aXudNPoeJgjEOw/iPDSEM/LYtknNta/j3FA==";
        };
        _5zoTu95C = {
            "id" = "5zoTu95C";
            "file" = "walkers-5.8.12.jar";
            "hash" = "sha512-sodmtRw9cZM0MUey0WDONNiLqVx1NjnvrgzuS+qW7zp0RWbtN1AENsQOKD4cr4PcelD7M/FZ2gh0fS5c66EHvg==";
        };
        _WaEURD8X = {
            "id" = "WaEURD8X";
            "file" = "walkers-5.8.12.jar";
            "hash" = "sha512-aYoKy6xaqWZiXkjFvoasneFjyIP4SYPZC5aDacCzKjaY/7umeeQ99V62GCsFDiKEkOxhtXoSU23a84VPkPY4DQ==";
        };
        _3cwpr6Dw = {
            "id" = "3cwpr6Dw";
            "file" = "walkers-5.8.12.jar";
            "hash" = "sha512-+rFPilSXHPnBHOssgQAMuVTf3uwNCI0OyuN7eZMuMGIfwLgofQe3Bstt4HP3eLrLMhPr+a3K96b0wVeuJ/Uajg==";
        };
        _dfZq8uQH = {
            "id" = "dfZq8uQH";
            "file" = "walkers-5.8.12.jar";
            "hash" = "sha512-dXU9/DlfM2KZQ7VZB00fFd2IjQ45S2pZKgInF4O48BUIysCvD/f10SDwgo72N7rx4VBHRJRu0DLhroekpPUIaA==";
        };
        _jwRJnzXz = {
            "id" = "jwRJnzXz";
            "file" = "walkers-5.8.12.jar";
            "hash" = "sha512-pFikdu9xpIZsFi8KrqJdjEL9Gh+SyuzGrsssCFaVP2dZ6nIDw+e/lgQzRRmjQMFEnabrQRwDxriDIvDHejwj0Q==";
        };
        _AQk2IkAL = {
            "id" = "AQk2IkAL";
            "file" = "walkers-5.8.12.jar";
            "hash" = "sha512-DYD2FMXEjZZiGk5u0y8xMAsYwsEY0dIPYSpha/QC9bO4TtuBLOSUHvi7iCIy3S6bk+K5m6luuLsgvFdQHcuMQQ==";
        };
        _LzcdVpaD = {
            "id" = "LzcdVpaD";
            "file" = "walkers-5.8.12.jar";
            "hash" = "sha512-CUadyrAZmQyWHypZxSiDKurjMKtObR0EtZiHfBdk64Q6x4M3hUILWhVR8Onc2CrKGL3tr5BGMjjmL5zwUc2jqg==";
        };
        _mAbVxtM6 = {
            "id" = "mAbVxtM6";
            "file" = "walkers-5.8.12.jar";
            "hash" = "sha512-HuQlD+897dDfRzvod8EXPttBic9flcPTcAUF/5nmlQpCz9KWaXhMpr7tD2mb1s3Lrun0p8zmWHp5GWNGQU5cew==";
        };
        _6w34uZgD = {
            "id" = "6w34uZgD";
            "file" = "walkers-5.8.12.jar";
            "hash" = "sha512-sVB36sG7F7PWViB9Hhn0iDhRySHRWWQE0UmBCqxN2cmuigqFAhbF82cecHw0e9+RvV8cVOP+mPOamTp8EpCEzA==";
        };
        _2vgCzoAA = {
            "id" = "2vgCzoAA";
            "file" = "walkers-5.8.12.jar";
            "hash" = "sha512-Imtcj1Nm+YgCkDx5Uem4t9rUukqHEFD7fU9NAlcEMV351vcb1Tg8Yxp2IWByMx3V2FaojeuNxoF0o/VSfbBYug==";
        };
        _wczfvCh5 = {
            "id" = "wczfvCh5";
            "file" = "walkers-5.8.12.jar";
            "hash" = "sha512-7RbaqU302OiSCqPwVsz5ljD8vL2NBO/gUJySM2lCSQDDJ7sFUqaV5UOeUF/kp42Ulyd3+HSj9fJWddU1af/k7g==";
        };
        _k4HHxrBE = {
            "id" = "k4HHxrBE";
            "file" = "walkers-fabric-8.3.jar";
            "hash" = "sha512-NkDaYtgQVBbVk5zJDmSpuSAmIgkEn7fMhcuMx9dnEMwFoXV57FDDu8EQ4i776QUAwyjE1uVLKbyz82aSsOYjeA==";
        };
        _eVFgq5VB = {
            "id" = "eVFgq5VB";
            "file" = "walkers-neoforge-8.3.jar";
            "hash" = "sha512-G6bWYlATKX+5KhX1milJ3A4+SGg5SU449HhnC3a6kAOmJBPwUa4R/Dnrn2WeTjlAYm6BGiwvN1Voj1UV33LI7A==";
        };
        _T42GUH63 = {
            "id" = "T42GUH63";
            "file" = "walkers-fabric-8.3.1.jar";
            "hash" = "sha512-n/ZgrfXb/i27ZJfl7lo23DtV1GvwvJH4HMnzaCCCAGyT9PDIUfXIJyCFlZgT5vK0b3MsbJDmzY6DgRbSrI/00w==";
        };
        _9vpimkvG = {
            "id" = "9vpimkvG";
            "file" = "walkers-neoforge-8.3.1.jar";
            "hash" = "sha512-6ebAOnQbPkBCziSQrrBIo9xsHiT1zof6EpbK2Wk4vwPTrTp3Vp6lsbbdtwA5J0d2FCZcyE4hkuY31bhVlW2yOw==";
        };
        _rnxXXoos = {
            "id" = "rnxXXoos";
            "file" = "walkers-5.8.13.jar";
            "hash" = "sha512-gJVSg/+uZ8eFxiXi0KnYGlX6AaPdfnk44P4tobr23XclnjmbOUBUUYxyGnEUPBrr1uYErpito4gTy7WonOCBcg==";
        };
        _xaf1XAz2 = {
            "id" = "xaf1XAz2";
            "file" = "walkers-5.8.13.jar";
            "hash" = "sha512-YqpwNLy60KgB8K1kHtZLzbZYYjcxq8DJlhDSsJ6UluhwSYPVcnl61uu2PrS//Zfzz5/W90a0zu0W901pD9N7rQ==";
        };
        _bz48L4BA = {
            "id" = "bz48L4BA";
            "file" = "walkers-5.8.13.jar";
            "hash" = "sha512-MOeossOBcRuXWLe9rIO4Gc0AMZ7yklJhubougTxFxFkLsYIvt7g32AIuiyRaZKb9RqNmYcSrdVlAMHF+2L5iqg==";
        };
        _pnEjhsfX = {
            "id" = "pnEjhsfX";
            "file" = "walkers-5.8.13.jar";
            "hash" = "sha512-/N6uMuLxY/8p1J9qojYVfZsxoVkx4BkYcrXcUTI8cf15+Bu4OCGvPOc8L4bpE06OAqse+TGBMfuPyYd9tpYnpQ==";
        };
        _Fvtf1Lii = {
            "id" = "Fvtf1Lii";
            "file" = "walkers-5.8.13.jar";
            "hash" = "sha512-2s7KaWC2i1wVA3g3/ZqznpkudTT4FbQAXpx55WiUffIHOucRsQAbFwFvUdiq+uQD7DyOq/JazVnMeW9veqzb8Q==";
        };
        _ys4b3BBp = {
            "id" = "ys4b3BBp";
            "file" = "walkers-5.8.13.jar";
            "hash" = "sha512-VO9AeH4FDVLW1/KnN95vIhJ5ixg8ZWFX0uBS6j4GwUu7Er9OySSiQjfbV+9eEy8+Nk8VuJ/VZBoWbVLBLS475g==";
        };
        _Gig5Jpkn = {
            "id" = "Gig5Jpkn";
            "file" = "walkers-5.8.13.jar";
            "hash" = "sha512-Ol69WgTiIYyulZBWruc8u2aWEhVcaX0NHp2By3WRNqqSBPUZXb49doXf7p3rJxVn6Iv/29lLNCBAnGcjJ17SdA==";
        };
        _yzgvuaPD = {
            "id" = "yzgvuaPD";
            "file" = "walkers-5.8.13.jar";
            "hash" = "sha512-S2xwoT0HDonmMsMwIhLOR5gQFHB/fxarZT5Ztxw3SN+E6VixlcP4Qa3mhIVUEAoIT3QogNE51TlkvTJsrHJT4Q==";
        };
        _TtNQl0G4 = {
            "id" = "TtNQl0G4";
            "file" = "walkers-5.8.13.jar";
            "hash" = "sha512-SHT3cdMBJePM6D8jMK0ifru9RabprxfYpJ5Q34R3XfVSKO76PRiWyi+6psMfYPk4/5awpyhjqPym/i72ksF9vA==";
        };
        _P8tJ9IKm = {
            "id" = "P8tJ9IKm";
            "file" = "walkers-5.8.13.jar";
            "hash" = "sha512-Tdu/uATInEtQAK17H3+WCqKpC3Ri078EcDnfEtr1DAgeoG9O/dUghswGGFIzBn2Oj4jn3r33dyllEr8Phal0Cg==";
        };
        _shj88bUV = {
            "id" = "shj88bUV";
            "file" = "walkers-5.8.13.jar";
            "hash" = "sha512-bqTBm0JxIH8NaTwXodUkflxENzgVvg3pJrzBFJpzit2bM3DuYe2CMqYz/cx3iimLtIJez9uzAAIH9g6i9+E3lg==";
        };
        _k5PBmBwF = {
            "id" = "k5PBmBwF";
            "file" = "walkers-5.8.13.jar";
            "hash" = "sha512-IYpp/JDMn5+v9E9nFfCeBnixLocw1KBdQPsWjyEk3kqWM3GKFJ3iutV8iNCRwXCfq51gciLQ9S/84/G8GygnCw==";
        };
        _jGdy7uQy = {
            "id" = "jGdy7uQy";
            "file" = "walkers-6.3.8.jar";
            "hash" = "sha512-Vzaq14zt6HjksZDJd3o+aSIH6DEwoQcRS4GLxebHFoGzWCKfAOz3JRIg2oJLskO7L1PjxEMBg+iSwDvyz02Sdw==";
        };
        _zpVgqUOB = {
            "id" = "zpVgqUOB";
            "file" = "walkers-6.3.8.jar";
            "hash" = "sha512-Y6BnKuD/7Bn9tLQUGzbgp7hCpv1dBJupmupE7aHVi8cY2zaF1QzgkciA3tcWVbESTqQOJwwuPXvF0T6y8dMlLQ==";
        };
        _eNDrQfKq = {
            "id" = "eNDrQfKq";
            "file" = "walkers-fabric-8.3.2.jar";
            "hash" = "sha512-D2QmEPlm35tqwBdtOnpLnMqW9haHka+mapeNSdD55eknd6PryhzuxbW4GDWJsImESjrTYwFWJ0/NLr7WYnMwMA==";
        };
        _uZ2EUa8m = {
            "id" = "uZ2EUa8m";
            "file" = "walkers-neoforge-8.3.2.jar";
            "hash" = "sha512-pNC50Fy+sCo+eodSskM45/75clfPkeLaQvjxlhYxzM2uPveumEw+dJYHmTjEaxQhft5A1FZ0uuAwQAD12zaxBw==";
        };
    in {
        "cAdnEJ7v" = _cAdnEJ7v;
        "NPuAQyjS" = _NPuAQyjS;
        ...
        "fabric-1.20.1" = _rnxXXoos;
        "fabric-1.20.2" = _bz48L4BA;
        "fabric-1.16.5" = _4t1U4JCZ;
        "fabric-1.18.2" = _M67ffEew;
        "fabric-1.20.3" = _bz48L4BA;
        "fabric-1.20.4" = _ys4b3BBp;
        "fabric-1.20.6" = _TtNQl0G4;
        "fabric-1.21" = _shj88bUV;
        "fabric-1.21.1" = _shj88bUV;
        "fabric-1.21.2" = _jGdy7uQy;
        "fabric-1.21.3" = _jGdy7uQy;
        "fabric-1.21.4" = _qnr11W6p;
        "fabric-1.21.5" = _TOci5K0A;
        "fabric-1.21.7" = _Cvwuupth;
        "fabric-1.21.8" = _Cvwuupth;
        "fabric-26.1.2" = _32DtlEjn;
        "fabric-26.2" = _eNDrQfKq;
        "forge-1.19.4" = _RmGWjJu5;
        "forge-1.20.1" = _xaf1XAz2;
        "forge-1.20" = _NCFA42dl;
        "forge-1.20.2" = _pnEjhsfX;
        "forge-1.16.5" = _qCyFXMqg;
        "forge-1.18.2" = _XJsYHEyO;
        "forge-1.20.3" = _pnEjhsfX;
        "forge-1.20.4" = _Gig5Jpkn;
        "neoforge-1.20.2" = _Fvtf1Lii;
        "neoforge-1.20.3" = _Fvtf1Lii;
        "neoforge-1.20.4" = _yzgvuaPD;
        "neoforge-1.20.6" = _P8tJ9IKm;
        "neoforge-1.21" = _k5PBmBwF;
        "neoforge-1.21.1" = _k5PBmBwF;
        "neoforge-1.21.2" = _zpVgqUOB;
        "neoforge-1.21.3" = _zpVgqUOB;
        ...
        "neoforge-26.2" = _uZ2EUa8m;
        "neoforge-1.20.1" = _xaf1XAz2;
        "quilt-1.20.1" = _rnxXXoos;
        "quilt-1.20.2" = _bz48L4BA;
        "quilt-1.20.3" = _bz48L4BA;
        "quilt-1.20.4" = _ys4b3BBp;
        "quilt-1.19.4" = _KrDiPcLl;
        "quilt-1.18.2" = _M67ffEew;
        "quilt-1.20.6" = _TtNQl0G4;
        "quilt-1.21" = _shj88bUV;
        "quilt-1.21.1" = _shj88bUV;
        "quilt-1.21.2" = _jGdy7uQy;
        "quilt-1.21.3" = _jGdy7uQy;
        "quilt-1.21.4" = _qnr11W6p;
        "quilt-1.21.5" = _TOci5K0A;
        "quilt-1.21.7" = _Cvwuupth;
        "quilt-1.21.8" = _Cvwuupth;
        "quilt-26.1.2" = _32DtlEjn;
        "quilt-26.2" = _eNDrQfKq;
        "pkg-1.5" = _NPuAQyjS;
        "pkg-1.6" = _53gfLuw1;
        "pkg-1.6.1" = _o48jDvD0;
        "pkg-1.6.2" = _WRbxIFV8;
        "pkg-1.7" = _oUbmSdIT;
        "pkg-1.8" = _2R2zNZtC;
        "pkg-1.20.1-fabric-1.8" = _eDO9Igez;
        "pkg-1.20.1-fabric-1.9" = _eVsrtzkJ;
        "pkg-1.20.1-forge-1.9" = _Uc9Oo6KC;
        "pkg-1.20.1-fabric-1.9.1" = _rmWEhBWo;
        "pkg-1.20.1-forge-1.9.1" = _L6u4N78H;
        "pkg-1.19.4-fabric-1.9.1" = _k1efpZNJ;
        "pkg-1.19.4-forge-1.9.1" = _RjE9plIW;
        "pkg-1.19.4-fabric-1.10" = _9zAuqtNL;
        "pkg-1.19.4-forge-1.10" = _tfws0UbT;
        "pkg-1.20.1-fabric-1.10" = _7oPAEF6B;
        "pkg-1.20.1-forge-1.10" = _NnIuym6A;
        "pkg-1.20.2-fabric-1.10" = _ITMhwnOn;
        "pkg-1.20.2-forge-1.10" = _LlEv4L9J;
        "pkg-1.16.5-fabric-1.10" = _IT78gFEi;
        "pkg-1.16.5-forge-1.10" = _6V1xmzj0;
        "pkg-1.18.2-fabric-1.10" = _xoyGiRSr;
        "pkg-1.18.2-forge-1.10" = _R9V52JHO;
        "pkg-1.16.5-fabric-1.10.1" = _KOtoOc8I;
        "pkg-1.16.5-forge-1.10.1" = _Em1JnArX;
        "pkg-1.18.2-fabric-1.10.1" = _z8oP3ZQc;
        "pkg-1.18.2-forge-1.10.1" = _rrb3t5uD;
        "pkg-1.19.4-fabric-1.10.1" = _VAPhaVNb;
        "pkg-1.19.4-forge-1.10.1" = _9vQfEcvL;
        "pkg-1.20.1-fabric-1.10.1" = _Ntg6hRKY;
        "pkg-1.20.1-forge-1.10.1" = _MnfbW0pc;
        "pkg-1.20.2-fabric-1.10.1" = _t2fmvKFJ;
        "pkg-1.20.2-forge-1.10.1" = _dsnIMBZ8;
        "pkg-1.16.5-fabric-1.11" = _DJg3LiDR;
        "pkg-1.16.5-forge-1.11" = _EneL2m4x;
        "pkg-1.18.2-fabric-1.11" = _Kb19ElB9;
        "pkg-1.18.2-forge-1.11" = _CPXXaqyt;
        "pkg-1.19.4-fabric-1.11" = _CrG3Cglh;
        "pkg-1.19.4-forge-1.11" = _Tm00y5nw;
        "pkg-1.20.1-fabric-1.11" = _rgif8ugO;
        "pkg-1.20.1-forge-1.11" = _lvNaCtYs;
        "pkg-1.20.2-fabric-1.11" = _gxi6IOU3;
        "pkg-1.20.2-forge-1.11" = _hbUFHxDR;
        "pkg-1.16.5-fabric-1.11.1" = _6TmH3jfH;
        "pkg-1.16.5-forge-1.11.1" = _sLIX5Y7Z;
        "pkg-1.18.2-fabric-1.11.1" = _q8B1ue2v;
        "pkg-1.18.2-forge-1.11.1" = _Rl9Tsh7o;
        "pkg-1.19.4-fabric-1.11.1" = _FGK80f6X;
        "pkg-1.19.4-forge-1.11.1" = _RiTETWI8;
        "pkg-1.20.1-fabric-1.11.1" = _ghsKpRie;
        "pkg-1.20.1-forge-1.11.1" = _NYCBKUvZ;
        "pkg-1.20.2-fabric-1.11.1" = _SC2AemGe;
        "pkg-1.20.2-forge-1.11.1" = _nE4c2sV4;
        "pkg-1.16.5-fabric-1.11.2" = _FtDAzqgi;
        "pkg-1.16.5-forge-1.11.2" = _WbtFSzOn;
        "pkg-1.18.2-fabric-1.11.2" = _pvAHkRka;
        "pkg-1.18.2-forge-1.11.2" = _iQCruYuD;
        "pkg-1.19.4-fabric-1.11.2" = _vzJZhSO4;
        "pkg-1.19.4-forge-1.11.2" = _JE6fPw7H;
        "pkg-1.20.1-fabric-1.11.2" = _qFkAXlos;
        "pkg-1.20.1-forge-1.11.2" = _ekIiVrdY;
        "pkg-1.20.2-fabric-1.11.2" = _mZrMsApt;
        "pkg-1.20.2-forge-1.11.2" = _1DPHewmn;
        "pkg-1.19.4-fabric-1.12" = _mddmAG6i;
        "pkg-1.19.4-forge-1.12" = _QEsNIEwf;
        "pkg-1.20.1-fabric-1.12" = _RVDQutVB;
        "pkg-1.20.1-forge-1.12" = _2SEVyMoP;
        "pkg-1.20.2-forge-1.12" = _7QnhfZxd;
        "pkg-1.20.2-fabric-1.12" = _LSdEqjyl;
        "pkg-1.20.2-neoforge-1.12" = _PGSGatGI;
        "pkg-1.16.5-forge-1.12" = _pD595gUT;
        "pkg-1.16.5-fabric-1.12" = _bGoHIqZb;
        "pkg-1.18.2-fabric-1.12" = _LvnFzX97;
        "pkg-1.18.2-forge-1.12" = _kpb5H8dT;
        "pkg-1.16.5-fabric-1.12.1" = _4t1U4JCZ;
        "pkg-1.16.5-forge-1.12.1" = _qCyFXMqg;
        "pkg-1.18.2-fabric-1.12.1" = _XF2O2Nnc;
        "pkg-1.18.2-forge-1.12.1" = _59uYfZVd;
        "pkg-1.19.4-fabric-1.12.1" = _YoR5tE2y;
        "pkg-1.19.4-forge-1.12.1" = _CzFgZxUG;
        "pkg-1.20.1-fabric-1.12.1" = _g8srZkEw;
        "pkg-1.20.1-forge-1.12.1" = _YWeilqFQ;
        "pkg-1.20.2-fabric-1.12.1" = _5DvKXnLf;
        "pkg-1.20.2-forge-1.12.1" = _zmlxO08h;
        "pkg-1.20.2-neoforge-1.12.1" = _BDiJo8zm;
        "pkg-1.18.2-fabric-1.12.1.1" = _aA6Xc7aP;
        "pkg-1.18.2-forge-1.12.1.1" = _rV1CqWEZ;
        "pkg-2.0+fabric" = _sIlyAlF4;
        "pkg-2.0+forge" = _K7Q93kxX;
        "pkg-2.0+neoforge" = _ghH3AoEt;
        "pkg-2.1+fabric" = _ZeOr4smS;
        "pkg-2.1+forge" = _Kg13tsu5;
        "pkg-2.1+neoforge" = _JhwPCptY;
        "pkg-3.0+fabric" = _MC0po0f2;
        "pkg-3.0+forge" = _FrBKbpaD;
        "pkg-3.0+neoforge" = _riHGwAFR;
        "pkg-3.1+fabric" = _8B4MnJPn;
        "pkg-3.1+forge" = _G42meOQF;
        "pkg-3.1+neoforge" = _b8E4K4lX;
        "pkg-1.20.2-fabric-3.2" = _AfKkCbV2;
        "pkg-1.20.2-forge-3.2" = _9P8cEiDe;
        "pkg-1.20.2-neoforge-3.2" = _pjak7mhf;
        "pkg-1.19.4-fabric-3.2" = _5tFkPbo9;
        "pkg-1.18.2-fabric-3.2" = _EfdnM2Nk;
        "pkg-1.19.4-forge-3.2" = _nfXzOOu8;
        "pkg-1.18.2-forge-3.2" = _R1r2Ah4B;
        "pkg-1.20.1-fabric-3.2" = _v7hN1lii;
        "pkg-1.20.1-forge-3.2" = _KiJLwGCZ;
        "pkg-1.20.2-fabric-4.0" = _qecD9eIW;
        "pkg-1.20.2-forge-4.0" = _CpcdfMlA;
        "pkg-1.20.2-neoforge-4.0" = _NAVc08ra;
        "pkg-1.18.2-fabric-4.0" = _kNJXTobO;
        "pkg-1.18.2-forge-4.0" = _76cbptke;
        "pkg-1.20.1-fabric-4.0" = _VyiH6SVt;
        "pkg-1.20.1-forge-4.0" = _fbdEyAhG;
        "pkg-1.19.4-fabric-4.0" = _6QShyHB0;
        "pkg-1.19.4-forge-4.0" = _q8yA0Qs4;
        "pkg-1.20.2-fabric-4.1" = _imgn23Bg;
        "pkg-1.20.2-forge-4.1" = _3orgHKTh;
        "pkg-1.20.2-neoforge-4.1" = _RBC73hMD;
        "pkg-1.20.1-fabric-4.1" = _cPiM5WJl;
        "pkg-1.20.1-forge-4.1" = _kEOwdlHx;
        "pkg-1.19.4-fabric-4.1" = _2KQC7ejT;
        "pkg-1.19.4-forge-4.1" = _IqOR8gjh;
        "pkg-1.18.2-fabric-4.1" = _AZpbkAnB;
        "pkg-1.18.2-forge-4.1" = _CJLgwLfN;
        "pkg-1.20.2-fabric-4.2" = _hW3popAV;
        "pkg-1.20.2-forge-4.2" = _gtU29UgG;
        "pkg-1.20.2-neoforge-4.2" = _y2axSdWF;
        "pkg-1.20.1-fabric-4.2" = _35uFavGY;
        "pkg-1.20.1-forge-4.2" = _gG25s6n5;
        "pkg-1.19.4-fabric-4.2" = _KHqWvUa6;
        "pkg-1.19.4-forge-4.2" = _rwPg90pz;
        "pkg-1.18.2-fabric-4.2" = _8h2Py8VA;
        "pkg-1.18.2-forge-4.2" = _wFbywXis;
        "pkg-1.20.2-fabric-4.3" = _GBwZDJl2;
        "pkg-1.20.2-forge-4.3" = _id1UILqG;
        "pkg-1.20.2-neoforge-4.3" = _TgyAPPej;
        "pkg-1.18.2-fabric-4.3" = _9VpI2bak;
        "pkg-1.18.2-forge-4.3" = _bcwztKNs;
        "pkg-1.19.4-fabric-4.3" = _fcdGndwq;
        "pkg-1.19.4-forge-4.3" = _gT5dvjln;
        "pkg-1.20.1-fabric-4.3" = _PlVVMUpH;
        "pkg-1.20.1-forge-4.3" = _NsmKU000;
        "pkg-1.20.2-fabric-4.4" = _j4St0Aj1;
        "pkg-1.20.2-forge-4.4" = _zN05v3AU;
        "pkg-1.20.2-neoforge-4.4" = _3UsHmveI;
        "pkg-1.20.1-fabric-4.4" = _M5IJ4yWD;
        "pkg-1.20.1-forge-4.4" = _6umscgvJ;
        "pkg-1.19.4-fabric-4.4" = _IHX8uDfw;
        "pkg-1.19.4-forge-4.4" = _DbPeRS8L;
        "pkg-1.18.2-fabric-4.4" = _kOh3pKmZ;
        "pkg-1.18.2-forge-4.4" = _IlUWMK66;
        "pkg-1.20.6-fabric-4.4.1" = _8m7XO1AI;
        "pkg-1.20.6-neoforge-4.4.1" = _ZndFIQ5f;
        "pkg-1.18.2-fabric-4.4.1" = _lOZcIxfT;
        "pkg-1.18.2-forge-4.4.1" = _pRO2Y3jb;
        "pkg-1.19.4-fabric-4.4.1" = _speMUWJ2;
        "pkg-1.19.4-forge-4.4.1" = _1TC3jr0v;
        "pkg-1.20.2-fabric-4.4.1" = _RuJBVjzG;
        "pkg-1.20.2-forge-4.4.1" = _XZOBRMSr;
        "pkg-1.20.2-neoforge-4.4.1" = _MHl4uf0x;
        "pkg-1.20.1-fabric-4.4.1" = _tu0l6MBl;
        "pkg-1.20.1-forge-4.4.1" = _O7tU2EHC;
        "pkg-1.20.6-fabric-4.4.2" = _eLk87zb4;
        "pkg-1.20.6-neoforge-4.4.2" = _CTmp0WWH;
        "pkg-1.19.4-fabric-4.4.2" = _4kQuXBJv;
        "pkg-1.19.4-forge-4.4.2" = _sstEIuaQ;
        "pkg-1.20.1-fabric-4.4.2" = _gIxTGVrM;
        "pkg-1.20.1-forge-4.4.2" = _PEToG62j;
        "pkg-1.18.2-fabric-4.4.2" = _I2kGegma;
        "pkg-1.18.2-forge-4.4.2" = _wK5PaTkD;
        "pkg-1.20.2-fabric-4.4.2" = _Bz5S5skw;
        "pkg-1.20.2-forge-4.4.2" = _sz7MeuKi;
        "pkg-1.20.2-neoforge-4.4.2" = _ms0ZYdBd;
        "pkg-1.20.2-fabric-4.4.3" = _Bf1P5Lic;
        "pkg-1.20.2-forge-4.4.3" = _sMwnbN46;
        "pkg-1.20.2-neoforge-4.4.3" = _1oaRiy88;
        "pkg-1.20.1-fabric-4.4.3" = _7JhMJMPO;
        "pkg-1.20.1-forge-4.4.3" = _MPF4BacJ;
        "pkg-1.19.4-fabric-4.4.3" = _m6WF15K6;
        "pkg-1.19.4-forge-4.4.3" = _Mukywnue;
        "pkg-1.20.6-fabric-4.4.3" = _fBGjnzRO;
        "pkg-1.20.6-neoforge-4.4.3" = _AmW8TY8A;
        "pkg-1.18.2-fabric-4.4.3" = _q2uBr8K7;
        "pkg-1.18.2-forge-4.4.3" = _LUOQ8Lsd;
        "pkg-1.20.6-fabric-4.5" = _spIZe7P2;
        "pkg-1.20.6-neoforge-4.5" = _DsokLtei;
        "pkg-1.20.6-fabric-4.5.1+build.1" = _6Dmo27bi;
        "pkg-1.20.6-neoforge-4.5.1+build.1" = _yEmO2puR;
        "pkg-1.20.2-fabric-4.5" = _geUnluuE;
        "pkg-1.20.2-forge-4.5" = _cVaphp8x;
        "pkg-1.20.2-neoforge-4.5" = _6Dks0Kwy;
        "pkg-1.20.1-fabric-4.5" = _h6UXskH7;
        "pkg-1.20.1-forge-4.5" = _m7WDFY5e;
        "pkg-1.19.4-fabric-4.5" = _786dAYJE;
        "pkg-1.19.4-forge-4.5" = _6yPkgYVC;
        "pkg-1.18.2-fabric-4.5" = _hkpagWbx;
        "pkg-1.18.2-forge-4.5" = _iCNczsjS;
        "pkg-1.20.1-fabric-4.5.1" = _MOobOiEk;
        "pkg-1.20.1-forge-4.5.1" = _B31LSVXt;
        "pkg-1.20.6-fabric-4.5.1" = _isAjEOx3;
        "pkg-1.20.6-neoforge-4.5.1" = _HBDDdL6S;
        "pkg-1.19.4-fabric-4.5.1" = _1A5pRTCT;
        "pkg-1.19.4-forge-4.5.1" = _943at5jS;
        "pkg-1.18.2-fabric-4.5.1" = _AjjynoTY;
        "pkg-1.18.2-forge-4.5.1" = _k9YnrZ2m;
        "pkg-1.20.2-fabric-4.5.1" = _7iyuqT5E;
        "pkg-1.20.2-forge-4.5.1" = _XuDiKsfN;
        "pkg-1.20.2-neoforge-4.5.1" = _fzReJPus;
        "pkg-1.20.6-neoforge-4.6" = _mrQs1zLD;
        "pkg-1.20.6-fabric-4.6" = _flGbp5AC;
        "pkg-1.21-fabric-4.6" = _kXLh4AHf;
        "pkg-1.21-neoforge-4.6" = _7Cayidq8;
        "pkg-1.20.1-fabric-4.6" = _3VP7d7pZ;
        "pkg-1.20.1-forge-4.6" = _yRPWbFRl;
        "pkg-1.19.4-fabric-4.6" = _ykqbyRjM;
        "pkg-1.19.4-forge-4.6" = _VvT8ffv4;
        "pkg-1.20.2-fabric-4.6" = _GOT58myh;
        "pkg-1.20.2-neoforge-4.6" = _fBlGFyjn;
        "pkg-1.20.2-forge-4.6" = _MIYdLlSw;
        "pkg-1.18.2-fabric-4.6" = _ilTJWEmB;
        "pkg-1.18.2-forge-4.6" = _n3Egx6qH;
        "pkg-1.18.2-fabric-5" = _WlpMByUa;
        "pkg-1.18.2-forge-5" = _v8oCX8bF;
        "pkg-1.19.4-forge-5" = _ePjH84EK;
        "pkg-1.19.4-fabric-5" = _kDcnRyUv;
        "pkg-1.20.1-fabric-5" = _qH29u5Of;
        "pkg-1.20.1-forge-5" = _rdan6qBa;
        "pkg-1.20.2-fabric-5" = _svkEa5pB;
        "pkg-1.20.2-forge-5" = _mYaAJhej;
        "pkg-1.20.2-neoforge-5" = _M03JfuC7;
        "pkg-1.20.4-fabric-5" = _JnOJ8f9K;
        "pkg-1.20.4-forge-5" = _XcI6RHUu;
        "pkg-1.20.4-neoforge-5" = _ypr8CETX;
        "pkg-1.20.6-fabric-5" = _aAza6lNB;
        "pkg-1.20.6-neoforge-5" = _BZYb95HY;
        "pkg-1.21-fabric-5" = _XlauxiaW;
        "pkg-1.21-neoforge-5" = _50ZX0Ilp;
        "pkg-1.18.2-fabric-5.1" = _GXJbVO9v;
        "pkg-1.18.2-forge-5.1" = _mT9qiPG6;
        "pkg-1.19.4-fabric-5.1" = _Lb8o0h2q;
        "pkg-1.19.4-forge-5.1" = _boT8emSG;
        "pkg-1.20.1-fabric-5.1" = _UeQB5xHj;
        "pkg-1.20.1-forge-5.1" = _7idWsmuu;
        "pkg-1.20.2-fabric-5.1" = _XGG0YH88;
        "pkg-1.20.2-forge-5.1" = _q3HiaGU5;
        "pkg-1.20.2-neoforge-5.1" = _HoAz5yUz;
        "pkg-1.20.4-fabric-5.1" = _AwKHGQt6;
        "pkg-1.20.4-forge-5.1" = _T5Lrb14O;
        "pkg-1.20.4-neoforge-5.1" = _2VUMCAkh;
        "pkg-1.20.6-fabric-5.1" = _Z65LeQGK;
        "pkg-1.20.6-neoforge-5.1" = _Ym9Qu3Cc;
        "pkg-1.21-fabric-5.1" = _toW4aXL5;
        "pkg-1.21-neoforge-5.1" = _6xtWcHHI;
        "pkg-1.18.2-fabric-5.2" = _oQdqOI3t;
        "pkg-1.18.2-forge-5.2" = _LJtP4LWa;
        "pkg-1.19.4-fabric-5.2" = _y9OAme2I;
        "pkg-1.19.4-forge-5.2" = _KVSmi4Va;
        "pkg-1.20.1-fabric-5.2" = _3jLiQ9CD;
        "pkg-1.20.1-forge-5.2" = _b273N7e1;
        "pkg-1.20.2-fabric-5.2" = _g7qelT4G;
        "pkg-1.20.2-forge-5.2" = _lqKRCxRc;
        "pkg-1.20.2-neoforge-5.2" = _RKp7QDqj;
        "pkg-1.20.4-fabric-5.2" = _SLm8AHWl;
        "pkg-1.20.4-forge-5.2" = _KubDvr5r;
        "pkg-1.20.4-neoforge-5.2" = _q2wnSwKS;
        "pkg-1.20.6-fabric-5.2" = _6WNiMVZG;
        "pkg-1.20.6-neoforge-5.2" = _K3QeSlZU;
        "pkg-1.21-fabric-5.2" = _m7LYfGBw;
        "pkg-1.21-neoforge-5.2" = _HZDnix2K;
        "pkg-1.18.2-fabric-5.3" = _IOVgN8oi;
        "pkg-1.18.2-forge-5.3" = _UC6cMpeu;
        "pkg-1.19.4-fabric-5.3" = _vuracE7x;
        "pkg-1.19.4-forge-5.3" = _iaOYQXxK;
        "pkg-1.20.1-fabric-5.3" = _lvHmAf3A;
        "pkg-1.20.1-forge-5.3" = _9T9KIBfo;
        "pkg-1.20.2-fabric-5.3" = _y4ppSaMQ;
        "pkg-1.20.2-forge-5.3" = _61h01665;
        "pkg-1.20.2-neoforge-5.3" = _W3GAcPug;
        "pkg-1.20.4-fabric-5.3" = _r7R1v9OF;
        "pkg-1.20.4-forge-5.3" = _pkd2n7Yy;
        "pkg-1.20.4-neoforge-5.3" = _sEt0tBC5;
        "pkg-1.20.6-fabric-5.3" = _ZE5omAuC;
        "pkg-1.20.6-neoforge-5.3" = _Mo79EpGK;
        "pkg-1.21-fabric-5.3" = _awVW9UzK;
        "pkg-1.21-neoforge-5.3" = _BZz7TioA;
        "pkg-1.18.2-fabric-5.3.1" = _ArG2iR7l;
        "pkg-1.18.2-forge-5.3.1" = _S0n93GwN;
        "pkg-1.19.4-fabric-5.3.1" = _koV2vTxK;
        "pkg-1.19.4-forge-5.3.1" = _z1if6B7o;
        "pkg-1.20.1-fabric-5.3.1" = _riNgDHr3;
        "pkg-1.20.1-forge-5.3.1" = _ucP2NkVe;
        "pkg-1.20.2-fabric-5.3.1" = _RZcr2YhJ;
        "pkg-1.20.2-forge-5.3.1" = _EHKwA6uY;
        "pkg-1.20.2-neoforge-5.3.1" = _Lok0tCH1;
        "pkg-1.20.4-fabric-5.3.1" = _Lxh6P4wl;
        "pkg-1.20.4-forge-5.3.1" = _uqg5xyBD;
        "pkg-1.20.4-neoforge-5.3.1" = _6u2PpVcW;
        "pkg-1.20.6-fabric-5.3.1" = _ASHEgOJZ;
        "pkg-1.20.6-neoforge-5.3.1" = _hGgvKCUd;
        "pkg-1.21-fabric-5.3.1" = _3Fy5uVmV;
        "pkg-1.21-neoforge-5.3.1" = _NxmE2usw;
        "pkg-1.18.2-fabric-5.3.2" = _cK4Gb53b;
        "pkg-1.18.2-forge-5.3.2" = _b5QQRjOi;
        "pkg-1.19.4-fabric-5.3.2" = _Zvaqiq1A;
        "pkg-1.19.4-forge-5.3.2" = _YYkmNQF2;
        "pkg-1.20.1-fabric-5.3.2" = _V4eFqnJw;
        "pkg-1.20.1-forge-5.3.2" = _uFk1r2mt;
        "pkg-1.20.2-fabric-5.3.2" = _aSphkVVP;
        "pkg-1.20.2-forge-5.3.2" = _SWVNpn9T;
        "pkg-1.20.2-neoforge-5.3.2" = _TJJtbBlp;
        "pkg-1.20.4-fabric-5.3.2" = _pp9U9VqF;
        "pkg-1.20.4-forge-5.3.2" = _lA8TW14u;
        "pkg-1.20.4-neoforge-5.3.2" = _Yihxjs0t;
        "pkg-1.20.6-fabric-5.3.2" = _8oQyzH4h;
        "pkg-1.20.6-neoforge-5.3.2" = _EzGKT0SV;
        "pkg-1.21-fabric-5.3.2" = _d9CI1DgW;
        "pkg-1.21-neoforge-5.3.2" = _RT0cZ7u7;
        "pkg-1.18.2-fabric-5.3.3" = _iS2C5WWW;
        "pkg-1.18.2-forge-5.3.3" = _I1lH4dGV;
        "pkg-1.19.4-fabric-5.3.3" = _esl2OsrG;
        "pkg-1.19.4-forge-5.3.3" = _qNx2Hqh0;
        "pkg-1.20.1-fabric-5.3.3" = _1GbfM1Kv;
        "pkg-1.20.1-forge-5.3.3" = _HJsm7Tp5;
        "pkg-1.20.2-fabric-5.3.3" = _EWc8mIx7;
        "pkg-1.20.2-forge-5.3.3" = _yWj8GnBK;
        "pkg-1.20.2-neoforge-5.3.3" = _88tJLRwQ;
        "pkg-1.20.4-fabric-5.3.3" = _YtFd3hLo;
        "pkg-1.20.4-forge-5.3.3" = _xU1QtVxe;
        "pkg-1.20.4-neoforge-5.3.3" = _LrhwhxoR;
        "pkg-1.20.6-fabric-5.3.3" = _taOuf2Gq;
        "pkg-1.20.6-neoforge-5.3.3" = _iBywdcmg;
        "pkg-1.21-fabric-5.3.3" = _8Dp0cTf7;
        "pkg-1.21-neoforge-5.3.3" = _weI0cSse;
        "pkg-1.18.2-fabric-5.4" = _mYhwXA0w;
        "pkg-1.18.2-forge-5.4" = _fugtyslh;
        "pkg-1.19.4-fabric-5.4" = _E9I12XDG;
        "pkg-1.19.4-forge-5.4" = _alBP1hog;
        "pkg-1.20.1-fabric-5.4" = _vM3LUWcj;
        "pkg-1.20.1-forge-5.4" = _jGbNbjMs;
        "pkg-1.20.2-fabric-5.4" = _sRePibi9;
        "pkg-1.20.2-forge-5.4" = _ZEtF6JHY;
        "pkg-1.20.2-neoforge-5.4" = _mjlUDs49;
        "pkg-1.20.4-fabric-5.4" = _Uu0kbutY;
        "pkg-1.20.4-forge-5.4" = _TVDMptfH;
        "pkg-1.20.4-neoforge-5.4" = _xT3VM8aC;
        "pkg-1.20.6-fabric-5.4" = _mhkUvLEH;
        "pkg-1.20.6-neoforge-5.4" = _MdLEpXTE;
        "pkg-1.21-fabric-5.4" = _f0J79VXR;
        "pkg-1.21-neoforge-5.4" = _cfz6YcWB;
        "pkg-1.21.2-fabric-6.0" = _RVeJL63Y;
        "pkg-1.21.2-neoforge-6.0" = _ymcC46pP;
        "pkg-1.18.2-fabric-5.5" = _oLJa6ClP;
        "pkg-1.18.2-forge-5.5" = _eml0tDXI;
        "pkg-1.19.4-fabric-5.5" = _uQySYBOn;
        "pkg-1.19.4-forge-5.5" = _VzW4xwHI;
        "pkg-1.20.1-fabric-5.5" = _8ybBBNrr;
        "pkg-1.20.1-forge-5.5" = _mf2Oy9iN;
        "pkg-1.20.2-fabric-5.5" = _L7WMC4kN;
        "pkg-1.20.2-forge-5.5" = _SVMLZkH2;
        "pkg-1.20.2-neoforge-5.5" = _YNLT8zsv;
        "pkg-1.20.4-fabric-5.5" = _9J352E6k;
        "pkg-1.20.4-forge-5.5" = _CQq6lfiG;
        "pkg-1.20.4-neoforge-5.5" = _I2c2AMCc;
        "pkg-1.20.6-fabric-5.5" = _ws0Gsdyx;
        "pkg-1.21-neoforge-5.5" = _qQRuUzLm;
        "pkg-1.20.6-neoforge-5.5" = _AofdNcSn;
        "pkg-1.21-fabric-5.5" = _UvFXQK7C;
        "pkg-1.21.2-fabric-6.1" = _c1ehI2Wb;
        "pkg-1.21.2-neoforge-6.1" = _WRWOzkbF;
        "pkg-1.21.4-fabric-6.1" = _RgxA8O4p;
        "pkg-1.21.4-neoforge-6.1" = _eWfHzyUl;
        "pkg-1.21.2-fabric-6.2" = _vwDyE1q0;
        "pkg-1.21.2-neoforge-6.2" = _QBLYcwKc;
        "pkg-1.21.4-fabric-6.2" = _47SJUTQN;
        "pkg-1.21.4-neoforge-6.2" = _KXWNylkR;
        "pkg-1.18.2-fabric-5.6" = _YmYXkfeK;
        "pkg-1.18.2-forge-5.6" = _ar1ufJDs;
        "pkg-1.19.4-fabric-5.6" = _zfelXd4i;
        "pkg-1.19.4-forge-5.6" = _GYZzKcIS;
        "pkg-1.20.1-fabric-5.6" = _bRsKqEpA;
        "pkg-1.20.1-forge-5.6" = _tUYG9ouQ;
        "pkg-1.20.2-fabric-5.6" = _9r3N79Uu;
        "pkg-1.20.2-forge-5.6" = _1uMAq6qn;
        "pkg-1.20.2-neoforge-5.6" = _zGEqatMe;
        "pkg-1.20.4-fabric-5.6" = _EbIHHsa3;
        "pkg-1.20.4-forge-5.6" = _9mEgfKfJ;
        "pkg-1.20.4-neoforge-5.6" = _WlMR6Z8u;
        "pkg-1.20.6-fabric-5.6" = _Mz7YZqn2;
        "pkg-1.20.6-neoforge-5.6" = _Wh9BEGwa;
        "pkg-1.21-fabric-5.6" = _vS2by48B;
        "pkg-1.21-neoforge-5.6" = _WnkzCjg9;
        "pkg-1.21.2-fabric-6.3" = _wNKZpQ0f;
        "pkg-1.21.2-neoforge-6.3" = _nkrD2L9D;
        "pkg-1.21.4-fabric-6.3" = _yzd66S7E;
        "pkg-1.21.4-neoforge-6.3" = _WaMQMNtR;
        "pkg-1.21.5-fabric-6.4" = _qQQW2f3t;
        "pkg-1.21.5-neoforge-6.4" = _Vmp4OBOS;
        "pkg-1.18.2-fabric-5.7" = _AhhDDayt;
        "pkg-1.18.2-forge-5.7" = _g2dvXrPu;
        "pkg-1.19.4-fabric-5.7" = _kmVqm4Td;
        "pkg-1.19.4-forge-5.7" = _Q6sfISgp;
        "pkg-1.20.1-fabric-5.7" = _yjgCcH2a;
        "pkg-1.20.1-forge-5.7" = _ghL78vcZ;
        "pkg-1.20.2-fabric-5.7" = _fLIoPEpz;
        "pkg-1.20.2-forge-5.7" = _c1JkPECl;
        "pkg-1.20.2-neoforge-5.7" = _JkAaIPwR;
        "pkg-1.20.4-fabric-5.7" = _yX5Ejx6q;
        "pkg-1.20.4-forge-5.7" = _6BYGwmei;
        "pkg-1.20.4-neoforge-5.7" = _gf6URSms;
        "pkg-1.20.6-fabric-5.7" = _9V32YfD8;
        "pkg-1.20.6-neoforge-5.7" = _ZssRk33g;
        "pkg-1.21-fabric-5.7" = _qRgYsJ1q;
        "pkg-1.21-neoforge-5.7" = _U8qeJGhc;
        "pkg-1.21.2-fabric-6.3.1" = _aB7piVua;
        "pkg-1.21.2-neoforge-6.3.1" = _GlU5MTj9;
        "pkg-1.21.4-fabric-6.3.1" = _cq6g1bkO;
        "pkg-1.21.4-neoforge-6.3.1" = _pYCm9nHC;
        "pkg-1.21.5-neoforge-6.5" = _cm4JFCkG;
        "pkg-1.21.5-fabric-6.5" = _TIf4TVAO;
        "pkg-1.21.5-neoforge-6.6" = _nOFU19bz;
        "pkg-1.21.5-fabric-6.6" = _TOci5K0A;
        "pkg-neoforge-7.0" = _vVBlh9MQ;
        "pkg-fabric-7.0" = _2yADeTvk;
        "pkg-neoforge-7.1.0" = _QqC4OZAJ;
        "pkg-fabric-7.1.0" = _hozBLCoI;
        "pkg-fabric-7.2.0" = _UkwGjDJk;
        "pkg-neoforge-7.2.0" = _IDFBoB2D;
        "pkg-neoforge-7.2.1" = _oOTijuRg;
        "pkg-fabric-7.2.1" = _wMH2CYLL;
        "pkg-1.21.2-fabric-6.3.2" = _yWfQXqvb;
        "pkg-1.21.2-neoforge-6.3.2" = _NPqoDvug;
        "pkg-1.21.4-neoforge-6.3.2" = _ZWdSrgOY;
        "pkg-1.21.4-fabric-6.3.2" = _n7xzufpU;
        "pkg-1.18.2-fabric-5.8.0" = _r2h5gH0a;
        "pkg-1.18.2-forge-5.8.0" = _AsOsySL9;
        "pkg-1.19.4-fabric-5.8.0" = _c9sdFNBA;
        "pkg-1.19.4-forge-5.8.0" = _b4beFiKX;
        "pkg-1.20.1-fabric-5.8.0" = _ktyUCfqR;
        "pkg-1.20.1-forge-5.8.0" = _dJOLeabO;
        "pkg-1.20.2-fabric-5.8.0" = _A4RcgkY2;
        "pkg-1.20.2-forge-5.8.0" = _mjA4Jxmk;
        "pkg-1.20.2-neoforge-5.8.0" = _UklR2FAe;
        "pkg-1.20.4-fabric-5.8.0" = _NbSr6wSI;
        "pkg-1.20.4-forge-5.8.0" = _kiZqQFsP;
        "pkg-1.20.4-neoforge-5.8.0" = _zsSEU1wp;
        "pkg-1.20.6-fabric-5.8.0" = _IuSJFiYJ;
        "pkg-1.20.6-neoforge-5.8.0" = _Mv5yWk2T;
        "pkg-1.21-fabric-5.8.0" = _vUIRNjVD;
        "pkg-1.21-neoforge-5.8.0" = _xEMJmUcI;
        "pkg-1.18.2-fabric-5.8.1" = _M67ffEew;
        "pkg-1.18.2-forge-5.8.1" = _XJsYHEyO;
        "pkg-1.19.4-fabric-5.8.1" = _KrDiPcLl;
        "pkg-1.19.4-forge-5.8.1" = _RmGWjJu5;
        "pkg-1.20.1-fabric-5.8.1" = _Jfc2M6zm;
        "pkg-1.20.1-forge-5.8.1" = _IH4nJfg6;
        "pkg-1.20.2-fabric-5.8.1" = _o8f7KacG;
        "pkg-1.20.2-forge-5.8.1" = _jHcPgfVE;
        "pkg-1.20.2-neoforge-5.8.1" = _j451jEdP;
        "pkg-1.20.4-fabric-5.8.1" = _3gLikkTR;
        "pkg-1.20.4-forge-5.8.1" = _cOJ6Mtx7;
        "pkg-1.20.4-neoforge-5.8.1" = _U2b3JOlH;
        "pkg-1.20.6-fabric-5.8.1" = _UQXRvZV7;
        "pkg-1.20.6-neoforge-5.8.1" = _FCzUejrm;
        "pkg-1.21-fabric-5.8.1" = _jnXc7T1U;
        "pkg-1.21-neoforge-5.8.1" = _eEJxlUzI;
        "pkg-1.20.1-fabric-5.8.2" = _q24ztWJY;
        "pkg-1.20.1-forge-5.8.2" = _sw5KSoCk;
        "pkg-neoforge-7.2.2" = _MG91BkOp;
        "pkg-fabric-7.2.2" = _cb2eGTPg;
        "pkg-1.20.1-fabric-5.8.3" = _tFha5TS5;
        "pkg-1.20.1-fabric-5.8.4" = _3oeTBtIK;
        "pkg-1.20.1-forge-5.8.4" = _GmHDAvOv;
        "pkg-fabric-7.2.3" = _t81iglWE;
        "pkg-neoforge-7.2.3" = _Ww82zxJF;
        "pkg-1.20.1-fabric-5.8.5" = _Ft9zotVV;
        "pkg-1.20.1-forge-5.8.5" = _plfRoSpn;
        "pkg-1.20.2-fabric-5.8.5" = _oMU54TlZ;
        "pkg-1.20.2-forge-5.8.5" = _urOMfIqt;
        "pkg-1.20.2-neoforge-5.8.5" = _HeIg6WN5;
        "pkg-1.20.4-fabric-5.8.5" = _k7iSJz77;
        "pkg-1.20.4-forge-5.8.5" = _6NHngF0i;
        "pkg-1.20.4-neoforge-5.8.5" = _wepFFjnE;
        "pkg-1.20.6-fabric-5.8.5" = _5wlrL4Cp;
        "pkg-1.20.6-neoforge-5.8.5" = _NZB54WsD;
        "pkg-1.21-fabric-5.8.5" = _myE02FvD;
        "pkg-1.21-neoforge-5.8.5" = _f0Xxrra4;
        "pkg-neoforge-7.2.4" = _meV72WzZ;
        "pkg-fabric-7.2.4" = _CevKP42d;
        "pkg-1.20.1-fabric-5.8.6" = _SwNEKIuL;
        "pkg-1.20.1-forge-5.8.6" = _2x413EzY;
        "pkg-1.20.2-fabric-5.8.6" = _9VcOVLS0;
        "pkg-1.20.2-forge-5.8.6" = _XT1OXmH0;
        "pkg-1.20.2-neoforge-5.8.6" = _fvN8rOKt;
        "pkg-1.20.4-fabric-5.8.6" = _R5t8J3fm;
        "pkg-1.20.4-forge-5.8.6" = _HSzzQqTA;
        "pkg-1.20.4-neoforge-5.8.6" = _qE0lZNxP;
        "pkg-1.20.6-fabric-5.8.6" = _n07MQBSY;
        "pkg-1.20.6-neoforge-5.8.6" = _Qm6MEalD;
        "pkg-1.21-fabric-5.8.6" = _F3zhDkVh;
        "pkg-1.21-neoforge-5.8.6" = _3DFurYSx;
        "pkg-neoforge-7.2.5" = _ydziWQbA;
        "pkg-fabric-7.2.5" = _Px4WsMa1;
        "pkg-1.21.2-fabric-6.3.4" = _qTXfXToL;
        "pkg-1.21.2-neoforge-6.3.4" = _j17QnCN1;
        "pkg-1.21.4-fabric-6.3.4" = _xaK6rq9e;
        "pkg-1.21.4-neoforge-6.3.4" = _jMIOzSc4;
        "pkg-1.20.1-fabric-5.8.7" = _19z6WQEG;
        "pkg-1.20.1-forge-5.8.7" = _Rrt0dP20;
        "pkg-1.20.2-fabric-5.8.7" = _4KSsDQBw;
        "pkg-1.20.2-forge-5.8.7" = _yr2hvGj4;
        "pkg-1.20.2-neoforge-5.8.7" = _ujkqzQoU;
        "pkg-1.20.4-fabric-5.8.7" = _FPtjyK1e;
        "pkg-1.20.4-forge-5.8.7" = _55KyomR4;
        "pkg-1.20.4-neoforge-5.8.7" = _7kIx55QZ;
        "pkg-1.20.6-fabric-5.8.7" = _OJThDCPS;
        "pkg-1.20.6-neoforge-5.8.7" = _Ttp1c3j9;
        "pkg-1.21-fabric-5.8.7" = _Cp3xmBQq;
        "pkg-1.21-neoforge-5.8.7" = _6v9SibcH;
        "pkg-1.21.2-fabric-6.3.5" = _be574ol1;
        "pkg-1.21.2-neoforge-6.3.5" = _zSqdJaLQ;
        "pkg-1.21.4-fabric-6.3.5" = _AcAgewR7;
        "pkg-1.21.4-neoforge-6.3.5" = _5QAteA5L;
        "pkg-neoforge-7.2.6" = _ymY2pXjE;
        "pkg-fabric-7.2.6" = _HKjcSXGj;
        "pkg-1.20.1-fabric-5.8.8" = _LCEdJudd;
        "pkg-1.20.1-forge-5.8.8" = _q6hNxW6X;
        "pkg-1.20.2-fabric-5.8.8" = _hGKnARrU;
        "pkg-1.20.2-forge-5.8.8" = _hGXl6KOG;
        "pkg-1.20.2-neoforge-5.8.8" = _Ciza8RcC;
        "pkg-1.20.4-fabric-5.8.8" = _766SpoUp;
        "pkg-1.20.4-forge-5.8.8" = _oT9Kyaxa;
        "pkg-1.20.4-neoforge-5.8.8" = _RRRSV1nL;
        "pkg-1.20.6-fabric-5.8.8" = _I41UcXIf;
        "pkg-1.20.6-neoforge-5.8.8" = _Tw4ieLsF;
        "pkg-1.21-fabric-5.8.8" = _aJOwQvTA;
        "pkg-1.21-neoforge-5.8.8" = _ncYbfzsu;
        "pkg-fabric-7.2.7" = _Cvwuupth;
        "pkg-neoforge-7.2.7" = _O7voVBZ7;
        "pkg-1.21.2-fabric-6.3.6" = _ksT5Ixx1;
        "pkg-1.21.2-neoforge-6.3.6" = _EBAWQDTr;
        "pkg-1.21.4-neoforge-6.3.6" = _wou3WLvY;
        "pkg-1.21.4-fabric-6.3.6" = _qnr11W6p;
        "pkg-1.20.1-fabric-5.8.9" = _sYSF3OZ1;
        "pkg-1.20.1-forge-5.8.9" = _Sq96vC9F;
        "pkg-1.20.2-fabric-5.8.9" = _xUga41YV;
        "pkg-1.20.2-forge-5.8.9" = _3qcyKrzU;
        "pkg-1.20.2-neoforge-5.8.9" = _46E2ntQA;
        "pkg-1.20.4-fabric-5.8.9" = _BXjn95FG;
        "pkg-1.20.4-forge-5.8.9" = _vRSwQ8XT;
        "pkg-1.21-fabric-5.8.10" = _Z4bD6odf;
        "pkg-1.21-neoforge-5.8.10" = _ceqIABAP;
        "pkg-1.20.1-fabric-5.8.11" = _sEpIgf9f;
        "pkg-1.20.1-forge-5.8.11" = _gb26udsS;
        "pkg-1.20.2-fabric-5.8.11" = _mlC4TtAj;
        "pkg-1.20.2-forge-5.8.11" = _3q2zfwQ7;
        "pkg-1.20.2-neoforge-5.8.11" = _2CGK2kGV;
        "pkg-1.20.4-fabric-5.8.11" = _Km2zNs2R;
        "pkg-1.20.4-forge-5.8.11" = _va5duVLQ;
        "pkg-1.20.4-neoforge-5.8.11" = _80UgJehD;
        "pkg-1.20.6-fabric-5.8.11" = _k2Ms3PHy;
        "pkg-1.20.6-neoforge-5.8.11" = _uEkVK6Xu;
        "pkg-1.21-fabric-5.8.11" = _oJ7NfH4W;
        "pkg-1.21-neoforge-5.8.11" = _3ucHDEhf;
        "pkg-neoforge-8.0" = _wWkMJoEd;
        "pkg-fabric-8.0" = _b3mhTYgJ;
        "pkg-neoforge-8.1" = _T477ayQb;
        "pkg-fabric-8.1" = _BnyexMxY;
        "pkg-fabric-8.2" = _32DtlEjn;
        "pkg-neoforge-8.2" = _77s2UUQy;
        "pkg-1.20.2-fabric-5.8.12" = _Qm55cVAm;
        "pkg-1.20.1-forge-5.8.12" = _5zoTu95C;
        "pkg-1.20.1-fabric-5.8.12" = _WaEURD8X;
        "pkg-1.20.2-forge-5.8.12" = _3cwpr6Dw;
        "pkg-1.20.2-neoforge-5.8.12" = _dfZq8uQH;
        "pkg-1.20.4-fabric-5.8.12" = _jwRJnzXz;
        "pkg-1.20.4-forge-5.8.12" = _AQk2IkAL;
        "pkg-1.20.4-neoforge-5.8.12" = _LzcdVpaD;
        "pkg-1.20.6-fabric-5.8.12" = _mAbVxtM6;
        "pkg-1.20.6-neoforge-5.8.12" = _6w34uZgD;
        "pkg-1.21-fabric-5.8.12" = _2vgCzoAA;
        "pkg-1.21-neoforge-5.8.12" = _wczfvCh5;
        "pkg-fabric-8.3" = _k4HHxrBE;
        "pkg-neoforge-8.3" = _eVFgq5VB;
        "pkg-fabric-8.3.1" = _T42GUH63;
        "pkg-neoforge-8.3.1" = _9vpimkvG;
        "pkg-1.20.1-fabric-5.8.13" = _rnxXXoos;
        "pkg-1.20.1-forge-5.8.13" = _xaf1XAz2;
        "pkg-1.20.2-fabric-5.8.13" = _bz48L4BA;
        "pkg-1.20.2-forge-5.8.13" = _pnEjhsfX;
        "pkg-1.20.2-neoforge-5.8.13" = _Fvtf1Lii;
        "pkg-1.20.4-fabric-5.8.13" = _ys4b3BBp;
        "pkg-1.20.4-forge-5.8.13" = _Gig5Jpkn;
        "pkg-1.20.4-neoforge-5.8.13" = _yzgvuaPD;
        "pkg-1.20.6-fabric-5.8.13" = _TtNQl0G4;
        "pkg-1.20.6-neoforge-5.8.13" = _P8tJ9IKm;
        "pkg-1.21-fabric-5.8.13" = _shj88bUV;
        "pkg-1.21-neoforge-5.8.13" = _k5PBmBwF;
        "pkg-1.21.2-fabric-6.3.8" = _jGdy7uQy;
        "pkg-1.21.2-neoforge-6.3.8" = _zpVgqUOB;
        "pkg-fabric-8.3.2" = _eNDrQfKq;
        "pkg-neoforge-8.3.2" = _uZ2EUa8m;
        "default" = _uZ2EUa8m;
    });
