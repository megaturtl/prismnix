...
let
    ...
    in {
        ...
        "pkg-1.7.2+mc1.21.4" = _8agvVsxB;
        "pkg-1.7.3+mc1.21.4" = _E2qhoREA;
        "pkg-1.7.3+mc1.21.5" = _MrDjcYKL;
        "pkg-1.7.3+mc1.21.6" = _UDyjLAf4;
        "pkg-1.7.3+mc1.21.7" = _apnYIkcs;
        "pkg-1.7.4+mc1.21.7" = _O8hFiZjM;
        "pkg-1.7.4+mc1.21.6" = _Buipzrmf;
        "pkg-1.7.4+mc1.21.5" = _nYxUSgZG;
        "pkg-1.7.4+mc1.21.4" = _BPgPMUlj;
        "pkg-1.7.5+mc1.21.8" = _KOz5pk1c;
        "pkg-1.7.5+mc1.21.6" = _ajrBDpJy;
        "pkg-1.7.5+mc1.21.5" = _7ANDWlJY;
        "pkg-1.7.5+mc1.21.4" = _HJXLLP38;
        "pkg-1.7.6+mc1.21.8" = _M9JwvIt3;
        "pkg-1.7.6+mc1.21.6" = _jTZmkyuP;
        "pkg-1.7.6+mc1.21.5" = _D9vKo5x2;
        "pkg-1.7.6+mc1.21.4" = _cLmgWNpV;
        "pkg-1.7.6+mc1.21.9" = _xCO3126E;
        "pkg-1.7.7+mc1.21.11" = _VFVVI9Sx;
        "pkg-1.7.8+mc1.21.11" = _T2SCs5eg;
        "pkg-1.7.8+mc1.21.10" = _D6FuXXx1;
        "pkg-1.7.8+mc1.21.8" = _vaI5nnZq;
        "pkg-1.7.8+mc1.21.5" = _hiZDvUt2;
        "pkg-1.7.8+mc1.21.4" = _5PK9JsEm;
        "pkg-1.7.8+mc26.1.2" = _qpM9LN5o;
        "pkg-1.7.9+mc26.1.2" = _JG8hcXre;
        "pkg-1.7.9+mc1.21.11" = _Cs4LcPfV;
        "pkg-1.7.9+mc1.21.10" = _sLDxbIaS;
        "pkg-1.7.9+mc1.21.8" = _Pz2VmNlo;
