...
let
    ...
    in {
        ...
        "pkg-1.0.0-fabric" = _NGudpbFi;
        "pkg-1.0.0-forge" = _EN4GbYLC;
        "pkg-1.0.1-forge" = _BZbh0s4o;
        "pkg-1.0.1-fabric" = _DHVwP65e;
        "pkg-1.0.2-fabric" = _xGDkCvHa;
        "pkg-1.0.2-forge" = _V8AvCbN5;
        "pkg-1.0.3-fabric" = _evi3lK4K;
        "pkg-1.0.4-fabric" = _M1xfZv1J;
        "pkg-1.0.4-forge" = _Ugn4A3pZ;
        "pkg-1.0.5-fabric" = _ENc7XbFW;
        "pkg-1.0.5-forge" = _GPjG8Ote;
        "pkg-1.0.6-fabric" = _hzLIGp19;
        "pkg-1.0.6-forge" = _zM8kE3cd;
        "pkg-1.0.7-fabric" = _BOpmFXe4;
        "pkg-1.0.7-forge" = _cTXYzGgg;
        "pkg-1.0.8-forge" = _iVB2hHQA;
        "pkg-1.0.8-fabric" = _7wAWX8Rk;
        "pkg-1.0.9-fabric" = _WgoSRNjD;
        "pkg-1.0.9-forge" = _odFmUXtk;
        "pkg-1.1.0-forge" = _T15MpB2f;
        "pkg-1.1.0-fabric" = _v0LYc24J;
        "pkg-1.1.1-fabric" = _PTY1ipcK;
        "pkg-1.1.1-forge" = _xixTqtjt;
        "pkg-1.1.2-forge" = _uTW5e2T4;
        "pkg-1.1.2-fabric" = _PfNSbJzi;
        "default" = _PfNSbJzi;
    });
