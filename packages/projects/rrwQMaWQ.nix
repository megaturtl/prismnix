...
let
    ...
    in {
        ...
        "pkg-fabric-1.19.1-1.0.2" = _EX0mWcu9;
        "pkg-fabric-1.19.2-1.0.2" = _xYmi2nIY;
        "pkg-fabric-1.19.2-1.0.3" = _efnXM4hB;
        "pkg-fabric-1.19.3-1.0.3" = _dFHhHcm8;
        "pkg-fabric-1.19.4-1.0.3" = _zJdJhRKt;
        "pkg-fabric-1.19.4-1.0.4" = _bEYSq4qq;
        "pkg-fabric-1.20-1.0.4" = _M3bThX1I;
        "pkg-fabric-1.20.1-1.0.4" = _UDbaSacp;
        "pkg-fabric-1.20.1-1.0.5" = _Hlt5l77f;
        "pkg-fabric-1.20.2-1.0.5" = _Fe0jwjlk;
        "pkg-fabric-1.20.2-1.0.6" = _KoTtvXIg;
        "pkg-fabric-1.20.2-1.0.7" = _H0xqd9CT;
        "pkg-fabric-1.20.3-1.0.7" = _yUZlT513;
        "pkg-fabric-1.20.4-1.0.7" = _hvgbx9bY;
        "pkg-fabric-1.19.2-1.0.8" = _qcLHgn3C;
        "pkg-fabric-1.19.4-1.0.8" = _xtZmazi5;
        "pkg-fabric-1.20.1-1.0.8" = _pFAButDT;
        "pkg-fabric-1.20.2-1.0.8" = _vXAC1xWr;
        "pkg-fabric-1.20.4-1.0.8" = _PTOnTQLG;
        "pkg-fabric-1.19.2-1.0.9" = _jmiPKcHX;
        "pkg-fabric-1.19.4-1.0.9" = _P4stEmWb;
        "pkg-fabric-1.20.1-1.0.9" = _jqQWbvCg;
        "pkg-fabric-1.20.2-1.0.9" = _GUg5zBpO;
        "pkg-fabric-1.20.4-1.0.9" = _pGJ34XO6;
        "pkg-fabric-1.20.5-1.0.9" = _aJqS2yy7;
        "pkg-fabric-1.20.6-1.0.9" = _z4AIHwdB;
        "pkg-fabric-1.21-1.0.9" = _WVeSUryl;
        "pkg-fabric-1.19.2-1.0.10" = _Tw5QiBb4;
        "pkg-fabric-1.20.1-1.0.10" = _qbSnU8KN;
        "pkg-fabric-1.20.4-1.0.10" = _iEo8ADGb;
        "pkg-fabric-1.20.6-1.0.10" = _kE4Ftzx3;
        "pkg-fabric-1.21-1.0.10" = _upY9GhIX;
        "pkg-fabric-1.19.2-1.0.11" = _Kc4CxG8i;
        "pkg-fabric-1.20.1-1.0.11" = _y8l0kB3k;
        "pkg-fabric-1.20.4-1.0.11" = _helJlOtr;
        "pkg-fabric-1.20.6-1.0.11" = _fpWVudal;
        "pkg-fabric-1.21-1.0.11" = _gm6YkMW6;
        "pkg-fabric-1.19.2-1.0.12" = _db0MbhFZ;
        "pkg-fabric-1.20.1-1.0.12" = _S1B2b2iN;
        "pkg-fabric-1.20.4-1.0.12" = _7ehhnBbP;
        "pkg-fabric-1.20.6-1.0.12" = _m97UnY5M;
        "pkg-fabric-1.21-1.0.12" = _3mE4jMR1;
        "pkg-fabric-1.19.2-1.0.14" = _A3WbFpwQ;
        "pkg-fabric-1.20.1-1.0.14" = _L8zXWAmp;
        "pkg-fabric-1.21-1.0.14" = _Odlk6DyI;
        "pkg-fabric-1.21.1-1.0.14" = _HNgfi3he;
        "pkg-fabric-1.21.1-1.0.15" = _DVSwlcve;
        "pkg-fabric-1.21.1-1.0.16" = _ZUEjVQxa;
        "pkg-fabric-1.21.2-1.0.16" = _wvyYL03U;
        "pkg-fabric-1.21.3-1.0.16" = _MVdUFjzA;
        "pkg-fabric-1.21.4-1.0.16" = _GWXCwN5R;
        "pkg-fabric-1.21.5-1.0.16" = _WMcxQNoc;
        "pkg-fabric-1.21.6-1.0.16" = _1AWHXcNy;
        "pkg-fabric-1.21.7-1.0.16" = _WXTDAzO0;
        "pkg-fabric-1.21.7-1.1.0" = _C7vXzF7v;
        "pkg-fabric-1.21.8-1.1.0" = _bsClkwhQ;
        "pkg-fabric-1.21.8-1.1.1" = _91o092Ca;
        "pkg-fabric-1.21.9-1.1.1" = _K0am0dZg;
        "pkg-fabric-1.21.10-1.1.1" = _JgT0biYh;
        "pkg-fabric-1.21.8-1.1.2" = _xxmLEj1i;
        "pkg-fabric-1.21.10-1.1.2" = _VYqMKaAW;
        "pkg-fabric-1.21.11-1.1.2" = _iTsiAfu8;
        "pkg-fabric-1.1.2+26.1" = _JH60mu9d;
