...
let
    ...
    in {
        ...
        "pkg-1.0.7" = _FsXTegoS;
        "pkg-1.0.8" = _l18dTI1j;
        "pkg-1.20-v1.0.8" = _b9HUcPdW;
        "pkg-1.0.9" = _qcfM3x6V;
        "pkg-1.20.4-v1.0.10" = _DeQZaCNn;
        "pkg-1.21.4-v1.0.0" = _Ie7IM6ap;
        "pkg-1.21.4-v1.0.1" = _lv71ACDv;
        "pkg-1.21.4-v1.0.2" = _8thSAiB9;
        "pkg-1.21.4-v1.0.3" = _VUdIJ0bF;
        "pkg-1.21.4-v1.0.4" = _n4im1V2U;
        "pkg-1.21.4-v1.0.5" = _jH24o2Q5;
        "pkg-1.21.4-v1.0.6" = _4g6bszPe;
        "pkg-1.21.4-v1.0.7" = _ZzRy5afG;
        "pkg-1.21.4-v1.0.8" = _LrTuFLUh;
        "pkg-1.21.4-v1.0.9" = _Ruv9Du4S;
        "pkg-1.21.4-v1.1.0" = _rV1iQFUh;
        "pkg-1.21.4-v1.1.1" = _xzEy2riv;
        "pkg-1.21.5-v1.2.0" = _2MCnaXNK;
        "pkg-1.21.5-v1.2.1" = _VizEyXIW;
        "pkg-1.21.5-v1.2.2" = _dSFgZa2X;
        "pkg-1.21.4-v1.1.2" = _nuMxXVsF;
        "pkg-1.21.5-v1.2.3" = _lDHxOENF;
        "pkg-1.21.5-v1.2.4" = _o2qDnwCQ;
        "pkg-1.21.11-v1.3.0" = _zONA8naP;
        "pkg-1.21.11-v1.3.1" = _DqPh1fpJ;
        "pkg-1.21.11-v1.3.2" = _WGZLlwsD;
        "pkg-1.21.11-v1.3.3" = _pK1dVqWU;
        "pkg-1.21.11-v1.3.4" = _IKw3xWMX;
        "pkg-1.21.11-v1.3.5" = _jMamBohH;
        "pkg-1.21.11-v1.3.6" = _auIkzj9n;
        "pkg-1.21.11-v1.3.7" = _xZBMJmVH;
        "pkg-1.21.11-v1.3.8" = _HdS5lp3k;
        "pkg-1.21.11-v1.3.9" = _jwVSQRzP;
        "pkg-1.21.11-v1.3.10" = _P9U9V01J;
        "pkg-1.21.11-v1.3.11" = _xdNOFifW;
        "pkg-1.21.11-v1.3.12" = _5e6Wd9AY;
        "pkg-26.1-r1.0-neoforge" = _bg3pszSB;
        "pkg-26.1-r1.0-fabric" = _jnW37xvf;
        "pkg-26.1-r1.1-neoforge" = _1Jc30gNG;
        "pkg-26.1-r1.1-fabric" = _ARDl3lZN;
        "pkg-26.1-r1.2-neoforge" = _xA8A7jVm;
        "pkg-26.1-r1.2-fabric" = _YyXppmE2;
        "pkg-26.1-r1.3-neoforge" = _1hPJWftI;
