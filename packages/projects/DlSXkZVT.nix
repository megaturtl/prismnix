...
let
    ...
    in {
        ...
        "pkg-2.4.0+1.21.1" = _LzlGw3Uq;
        "pkg-2.5.0+1.21.3" = _llYgRMp5;
        "pkg-2.6.0+1.21.4-rc3" = _l1huJSrg;
        "pkg-2.7.0+1.21.5" = _vnRGqK0o;
        "pkg-2.8.0+1.21.6" = _2AMKOBLR;
        "pkg-2.9.0+1.21.9-rc1" = _hCfytgpD;
