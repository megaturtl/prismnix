...
let
    ...
    in {
        ...
        "pkg-0.0.2" = _fltyuAOr;
        "pkg-0.0.3" = _L62d4xX5;
        "pkg-0.0.3.1" = _D1PCsHqq;
        "pkg-0.0.3.2" = _QL0YnBNd;
        "pkg-0.1" = _eKObR387;
        "pkg-0.1.1" = _1TpXUQYC;
        "pkg-0.1.2" = _9tmuMS1P;
        "pkg-0.1.2.1" = _T7ZBn5oJ;
        "pkg-0.2" = _Rgbz8vqU;
        "pkg-0.3" = _gBIMCgRq;
        "pkg-0.3.1" = _kuvamKQK;
        "pkg-0.3.2" = _Vr1e67hb;
        "pkg-0.4" = _WuOzkOPV;
        "pkg-0.4.0.1" = _zi5AKBoC;
        "pkg-0.4.0.2" = _hUTzoZ2o;
        "pkg-0.4.1.0" = _83GX9u8u;
        "pkg-0.5" = _akVlEg4i;
        "pkg-0.5.2" = _Ubc1W1Ev;
        "pkg-0.5.3" = _w15g6DC7;
        "pkg-0.5.4" = _HEPSC2tf;
        "pkg-0.5.4.2" = _vlwkBHXQ;
        "pkg-0.5.5" = _KCSWqeIX;
        "pkg-0.5.6" = _SKMCaTQf;
        "pkg-0.5.6.1" = _PTaaW9nN;
        "pkg-0.6" = _Oqqjy0vX;
        "pkg-0.7.1" = _2UYDJEKy;
        "pkg-0.7.2" = _b3lFbWfr;
        "pkg-0.7.4" = _AKUBrioq;
