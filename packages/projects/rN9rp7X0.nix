...
let
    ...
    in {
        ...
        "ctWACPjh" = _ctWACPjh;
        "tLs1effs" = _tLs1effs;
        "fabric-1.18" = _ySQmhwYI;
        "fabric-1.18.1" = _ySQmhwYI;
        "fabric-1.18.2" = _ySQmhwYI;
        "fabric-1.21.6" = _7xM9vRpp;
        "fabric-1.19.2" = _ObyXszFI;
        "fabric-1.19.4" = _1plsFHBR;
        "fabric-1.20" = _6yWT0k4T;
        "fabric-1.20.1" = _6yWT0k4T;
        ...
        "fabric-26.1" = _CdAoZwLd;
        "fabric-26.1.1" = _CdAoZwLd;
        "fabric-26.1.2" = _CdAoZwLd;
        "fabric-26.2" = _KW9ErSDR;
        "fabric-1.19" = _ObyXszFI;
        "fabric-1.19.1" = _ObyXszFI;
        "quilt-1.18" = _ySQmhwYI;
        "quilt-1.18.1" = _ySQmhwYI;
        "quilt-1.18.2" = _ySQmhwYI;
        "quilt-1.21.6" = _7xM9vRpp;
        "quilt-1.19.2" = _ObyXszFI;
        "quilt-1.19.4" = _1plsFHBR;
        "quilt-1.20" = _6yWT0k4T;
        "quilt-1.20.1" = _6yWT0k4T;
        ...
        "quilt-26.1" = _CdAoZwLd;
        "quilt-26.1.1" = _CdAoZwLd;
        "quilt-26.1.2" = _CdAoZwLd;
        "quilt-26.2" = _KW9ErSDR;
        "quilt-1.19" = _ObyXszFI;
        "quilt-1.19.1" = _ObyXszFI;
        "forge-1.21.6" = _34EaukCd;
        "forge-1.18" = _PaZWEaph;
        "forge-1.18.1" = _PaZWEaph;
        "forge-1.18.2" = _PaZWEaph;
        "forge-1.19" = _dvEpjkFI;
        "forge-1.19.1" = _dvEpjkFI;
        "forge-1.19.2" = _dvEpjkFI;
        "forge-1.19.4" = _dleakJaZ;
        "forge-1.20" = _FOvemCnw;
        "forge-1.20.1" = _FOvemCnw;
        ...
        "forge-26.1" = _Ho2QeIuW;
        "forge-26.1.1" = _Ho2QeIuW;
        "forge-26.1.2" = _Ho2QeIuW;
        "forge-26.2" = _ctWACPjh;
        "neoforge-1.21.6" = _1R6HC1Xu;
        "neoforge-1.20" = _FOvemCnw;
        "neoforge-1.20.1" = _FOvemCnw;
        ...
        "neoforge-26.1" = _2XtCHrCO;
        "neoforge-26.1.1" = _2XtCHrCO;
        "neoforge-26.1.2" = _2XtCHrCO;
        "neoforge-26.2" = _tLs1effs;
