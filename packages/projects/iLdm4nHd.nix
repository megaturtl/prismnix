...
let
    versions = (let
        ...
        _5mhkRY9J = {
            "id" = "5mhkRY9J";
            "file" = "mobspropertiesrandomness-6.1.7.0.jar";
            "hash" = "sha512-wjWm39oVPGZCphdTkvqUJER60m/JYk4UPcmTdX7SzZJN/iV47rBdeLwmQiRw5PKRASWqs+q+TVed7CeykJDTyw==";
        };
        _haWfqsM5 = {
            "id" = "haWfqsM5";
            "file" = "mobspropertiesrandomness-6.1.7.1.jar";
            "hash" = "sha512-8ziEdSx6wBDgIhmO8yEPhhrVB4vHbsNzLJV7xiZodTvyEmz1d994E2YWSoRrhjcB591lVl3C2hP7SvS5/TBtpg==";
        };
        _UYiPd3JI = {
            "id" = "UYiPd3JI";
            "file" = "mobspropertiesrandomness-6.1.7.2.jar";
            "hash" = "sha512-NkBZ4gZ1CRLH6A7T0XFmm6qacEJF/HmFsboOeTD4fNQdAKfkwspl01tksGzgc8IEiBBQ8+jPJ5Pn4eHhdirIxA==";
        };
        _e9yoywyb = {
            "id" = "e9yoywyb";
            "file" = "mobspropertiesrandomness-6.1.8.0.jar";
            "hash" = "sha512-JaRvx8D38uqwKbnY53MPWSSQYPv2d1jQ+0XYFd5H2cSuNwS1BpPeo8E7JpIRZq+ii5gHq9J1cyhIZ4FBSPmOCA==";
        };
        _Hm79RoYs = {
            "id" = "Hm79RoYs";
    ...
    in {
        ...
        "pkg-4.7.2" = _ju2RPGsf;
        "pkg-4.0.3" = _vqxOvqrF;
        "pkg-4.10.11" = _bWR3LyUi;
        "pkg-4.10.13" = _dRcjLRi4;
        "pkg-4.10.16" = _7c2KwinQ;
        "pkg-5.0.0-alpha" = _qynfTP6T;
        "pkg-5.0.1-alpha" = _ahfqgZIA;
        "pkg-5.0.2-alpha" = _yTSkNo9o;
        "pkg-5.0.3-alpha" = _JzEqgRn7;
        "pkg-5.0.4-alpha" = _1KvVMgxl;
        "pkg-5.0.5-alpha" = _lF91rgta;
        "pkg-5.0.6-alpha" = _bEMxgeDi;
        "pkg-5.0.7-alpha" = _L7kgOY8G;
        "pkg-5.0.8-beta" = _1B38HpGe;
        "pkg-5.0.9-beta" = _FKpnLCXj;
        "pkg-5.0.10-beta" = _O8C9ZruK;
        "pkg-5.0.11-beta" = _MaYmir0g;
        "pkg-5.0.12" = _jxbTadqK;
        "pkg-5.0.13" = _NlkdtY9k;
        "pkg-5.0.14" = _Tv7pTl65;
        "pkg-5.0.15" = _49rn7cL9;
        "pkg-5.0.17" = _gkqF0G5y;
        "pkg-5.0.18" = _DDDIq4m7;
        "pkg-5.0.19" = _2wlI3uyO;
        "pkg-5.0.20" = _NWwAx5hz;
        "pkg-5.0.21" = _bciIn9wv;
        "pkg-5.0.2" = _mGtVno7z;
        "pkg-5.0.22" = _GCnMmKUJ;
        "pkg-5.0.23" = _qJNrrBIw;
        "pkg-5.0.24" = _jNkHos23;
        "pkg-5.1.0.0-beta" = _D64nhu4b;
        "pkg-5.1.0.1-beta" = _9zvQnLtJ;
        "pkg-5.1.0.2-beta" = _VuyPLQGL;
        "pkg-5.1.1.0" = _NCEK9ZCZ;
        "pkg-5.1.2.0" = _YrL3atxU;
        "pkg-5.1.2.1" = _NSwL7AZv;
        "pkg-5.1.2.2" = _oUmd5eVe;
        "pkg-5.1.2.3" = _zI7u03ti;
        "pkg-5.1.3.0" = _fbSSdTYc;
        "pkg-5.1.4.0" = _tY1h0ewy;
        "pkg-5.1.4.3" = _6ZlMlaE1;
        "pkg-5.1.5.0" = _uACnR6m5;
        "pkg-5.1.6.0" = _EGxgVPEM;
        "pkg-5.1.7.0" = _QqN9W3eZ;
        "pkg-5.1.7.1" = _lKVMDfcs;
        "pkg-6.0.0.0-alpha" = _qSDgZaXt;
        "pkg-6.0.1.0-beta" = _zPcmcVZY;
        "pkg-6.0.1.1-beta" = _EybI6roU;
        "pkg-6.0.1.2-beta" = _h4098zDi;
        "pkg-5.1.7.2" = _y3e6V74W;
        "pkg-6.0.1.3" = _8uIEtgJ5;
        "pkg-5.1.7.3" = _ppZ5cfS5;
        "pkg-6.1.0.0-alpha" = _ACn4oy4r;
        "pkg-6.1.1.0-beta" = _qtPSPxDD;
        "pkg-6.1.2.0" = _LUOeOsTv;
        "pkg-6.1.3.1" = _bF5lbu0r;
        "pkg-6.1.3.2" = _IFTUagkV;
        "pkg-6.1.4.1" = _yIddzryk;
        "pkg-6.1.5.0" = _WL6js5Cy;
        "pkg-6.1.5.1" = _idw39qC9;
        "pkg-6.1.5.2" = _XeUgTNGb;
        "pkg-6.1.6.0" = _2SwWJpWI;
        "pkg-6.1.6.1" = _2aSHDFNd;
        "pkg-6.1.7.0" = _5mhkRY9J;
        "pkg-6.1.7.1" = _haWfqsM5;
