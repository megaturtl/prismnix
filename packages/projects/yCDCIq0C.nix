...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.20.5" = _bLKUcj9T;
        "pkg-1.0.0-1.20.6" = _bixQ66Nx;
        "pkg-1.0.0-1.21" = _W1IIAHjD;
        "pkg-1.0.0-1.21.2" = _jrkDKPKd;
        "pkg-1.0.1-1.20.2" = _5gKQyi8m;
        "pkg-1.0.1-1.20.3" = _zkqHOHlZ;
        "pkg-1.0.1-1.20.4" = _TMKCYbWx;
        "pkg-1.0.1-1.20.5" = _gZZP6G1b;
        "pkg-1.0.1-1.20.6" = _P1K1UT31;
        "pkg-1.0.1-1.21" = _RHBMH8Pa;
        "pkg-1.0.1-1.21.2" = _nqFTq7it;
        "pkg-1.0.2-1.20.2" = _8LwzshAJ;
        "pkg-1.0.2-1.20.3" = _uGi0TeRy;
        "pkg-1.0.2-1.20.4" = _nhe3EguT;
        "pkg-1.0.2-1.20.5" = _wdrO3DoY;
        "pkg-1.0.2-1.20.6" = _2IY9LfZn;
        "pkg-1.0.2-1.21" = _96xfQdWb;
        "pkg-1.0.2-1.21.2" = _EXCjsFvs;
        "pkg-1.0.2-1.21.5" = _G7zJ4WkC;
        "pkg-1.0.2-1.20.1" = _r7RljRUj;
        "pkg-1.0.2-1.21.6" = _zQ75Telp;
        "pkg-1.0.3-1.20.1" = _9DyAwq3z;
        "pkg-1.0.3-1.21.9" = _H2OCGFWM;
        "pkg-1.1.0-1.20.1" = _gDiIYXQG;
        "pkg-1.1.0-1.20.2" = _AX5MYmKz;
        "pkg-1.1.0-1.20.3" = _TUzHYoXl;
        "pkg-1.1.0-1.20.5" = _3XpUnY2o;
        "pkg-1.1.0-1.21" = _hDalAYCA;
        "pkg-1.1.0-1.21.2" = _ySKGKxIf;
        "pkg-1.1.0-1.21.4" = _tkhNyoOU;
        "pkg-1.1.0-1.21.5" = _tWrBzS0E;
        "pkg-1.1.0-1.21.6" = _J6G1T9C0;
        "pkg-1.1.0-1.21.9" = _PjDFX5nu;
