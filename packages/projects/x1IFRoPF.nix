...
let
    versions = (let
        ...
        _tuF42Mm6 = {
            "id" = "tuF42Mm6";
            "file" = "Simple Revive v3.0 mc1.21.1.zip";
            "hash" = "sha512-OVO+cy8ALlOqmh5EUTr4FTI3mNHgj0Z8zT7KHPgBcKxffI/7J+xItjC0Q/MUuY/LxKg4pLpv5ZlKBBH8MyRhnw==";
        };
        _XhfNkAiO = {
            "id" = "XhfNkAiO";
    ...
    in {
        ...
        "datapack-1.21" = _tuF42Mm6;
        "datapack-1.21.1" = _tuF42Mm6;
        ...
        "fabric-1.21" = _XhfNkAiO;
        "fabric-1.21.1" = _XhfNkAiO;
        ...
        "forge-1.21" = _XhfNkAiO;
        "forge-1.21.1" = _XhfNkAiO;
        ...
        "neoforge-1.21" = _XhfNkAiO;
        "neoforge-1.21.1" = _XhfNkAiO;
        ...
        "quilt-1.21" = _XhfNkAiO;
        "quilt-1.21.1" = _XhfNkAiO;
        ...
        "pkg-1.1+Mod" = _1pVk1rTA;
        "pkg-1.2+Datapack" = _mAQ4eyvT;
        "pkg-1.2+Mod" = _VTjw3iYx;
        "pkg-1.3+Datapack" = _wbRUAPdd;
        "pkg-1.3+Mod" = _xoaSEOW8;
        "pkg-1.4+1.21.1+Datapack" = _7xESgaHM;
        "pkg-1.4+1.21.1+Mod" = _7TVRfwhG;
        "pkg-1.4+1.21.5-1.21.8+Datapack" = _SHE7ZtnD;
        "pkg-1.4+1.21.5-1.21.8+Mod" = _ZGfnj51G;
        "pkg-1.5+1.21.5-1.21.8+Datapack" = _g6tm0yJv;
        "pkg-1.5+1.21.5-1.21.8+Mod" = _ZBis1MMw;
        "pkg-1.6+1.21.5-1.21.8+Datapack" = _OBZUt0He;
        "pkg-1.6+1.21.5-1.21.8+Mod" = _6thKiZ0s;
        "pkg-1.7+1.21.1+Datapack" = _uldteIbW;
        "pkg-1.7+1.21.1+Mod" = _a7XYcbre;
        "pkg-1.7+1.21.5-1.21.8+Datapack" = _UcJXC1rX;
        "pkg-1.7+1.21.5-1.21.8+Mod" = _4MLjeKOQ;
        "pkg-1.8+1.21.5-1.21.8+Datapack" = _jWiWZfqN;
        "pkg-1.8+1.21.5-1.21.8+Mod" = _OrUeT6Y4;
        "pkg-1.9+1.21.1+Datapack" = _vdIAhFdI;
        "pkg-1.9+1.21.1+Mod" = _8RPlhT02;
        "pkg-1.9+1.21.2-1.21.4+Datapack" = _s7senkOF;
        "pkg-1.9+1.21.2-1.21.4+Mod" = _eYf7wo6k;
        "pkg-1.9+1.21.5-1.21.8+Datapack" = _bZKodP2t;
        "pkg-1.9+1.21.5-1.21.8+Mod" = _kbRIBQ5r;
        "pkg-1.9+1.21.9+Datapack" = _zUa9qOP2;
        "pkg-1.9+1.21.9+Mod" = _hl7uptWM;
        "pkg-1.9+1.21.11+Datapack" = _YuEGZhD8;
        "pkg-1.9+1.21.11+Mod" = _m7vy8D81;
        "pkg-v2.0-1.21.10-Datapack" = _waUxJTQM;
        "pkg-v2.0+1.21.10+Mod" = _BX4kRikO;
        "pkg-v2.0-1.21.11-Datapack" = _T3ziKWX3;
        "pkg-v2.0-1.21.11-Mod" = _6hqEqg7o;
        "pkg-v2.0-mc26.2-datapack" = _KylupUaj;
        "pkg-v2.0-mc26.2-mod" = _ii3WOsTS;
        "pkg-v3.0-mc26.2-datapack" = _eGiT5q5A;
        "pkg-v3.0-mc26.2-mod" = _3GCpHKto;
        "pkg-v3.0-mc26.1.x-datapack" = _NmaonTfQ;
        "pkg-v3.0-mc26.1.x-mod" = _AT9pH7Nd;
        "pkg-v3.0-mc1.21.10-datapack" = _FuxdC1eD;
