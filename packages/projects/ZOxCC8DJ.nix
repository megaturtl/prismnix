...
let
    ...
    in {
        ...
        "pkg-1.2.4.3" = _stNXgLef;
        "pkg-1.2.4.4" = _JS5C85G9;
        "pkg-1.2.4.5" = _KUIR7trl;
        "pkg-1.2.4.6" = _jDRViy9t;
        "pkg-1.3.0.0" = _iRyCr7TY;
        "pkg-1.3.0.1" = _MGHBJnen;
        "pkg-1.3.1.0" = _T2xhHFpH;
        "pkg-1.4.0.0" = _yl6z9VnT;
        "pkg-1.4.0.1" = _e9WqWK3w;
        "pkg-1.4.0.2" = _7snj7XqQ;
        "pkg-1.4.0.3" = _YvPaHXZ2;
        "pkg-1.4.1.0" = _25blXm7U;
        "pkg-1.4.1.1" = _G3HgTlnR;
        "pkg-1.4.2.0" = _2GsjLofJ;
        "pkg-1.4.2.1" = _kKD1AHsE;
        "pkg-1.4.2.2" = _B5MbmYot;
        "pkg-1.4.3.0" = _H4Sr7CwL;
        "pkg-1.4.3.1" = _iRnlbjnq;
        "pkg-1.4.4.0" = _IQF7QfY9;
        "pkg-1.4.4.1" = _Uod4yVHg;
        "pkg-1.5.0.0" = _CSf8f0uE;
        "pkg-1.5.0.1" = _HdHJXEs4;
        "pkg-1.5.1.0" = _ZeaMDVVc;
        "pkg-1.5.1.1" = _ZrNvTvqU;
        "pkg-1.5.2.0" = _9YKtKU1l;
        "pkg-1.5.2.1" = _gL3S1xOR;
        "pkg-1.5.2.2" = _OKeFrl6k;
