...
let
    ...
    in {
        ...
        "pkg-b1.7" = _VAXTYeSW;
        "pkg-b1.7.1" = _6P5C97Ut;
        "pkg-b1.8" = _FKsby217;
        "pkg-1.1.9" = _qJp00oqq;
        "pkg-1.1.9.1" = _5znWZZin;
        "pkg-1.1.9.2" = _xbq8If0l;
        "pkg-1.1.9.3" = _XY82oHt4;
        "pkg-1.1.9.4" = _7dntVV2M;
        "pkg-dev251112a" = _a1hq55Yk;
        "pkg-dev251116a" = _mGDLg5tZ;
        "pkg-dev251116b" = _dzzAIpex;
