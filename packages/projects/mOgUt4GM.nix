...
let
    versions = (let
        ...
        _9PxiZuDD = {
            "id" = "9PxiZuDD";
            "file" = "modmenu-18.0.1.jar";
            "hash" = "sha512-Q2JCRF8wXMUrMgoPddD6N60pdszbD/v6+9KrBFUNIcg9pdieGVMrbBIaQ/koWCd8evy+DywwG+WXThJeb+NP4Q==";
        };
        _WdLLrOzD = {
            "id" = "WdLLrOzD";
            "file" = "modmenu-20.0.2.jar";
            "hash" = "sha512-m669Ip/1oKN3oCafKoeD3ZveaCsHc9nOOA3t9hshRnbx0TuZBOhEA6+0GME9PuI8MSDgkDLFPLTHYgka8aSw+w==";
        };
        _lcxkZSq6 = {
            "id" = "lcxkZSq6";
    ...
    in {
        ...
        "pkg-1.16.1" = _zC13OZD9;
        "pkg-1.16.2" = _7QWIhei3;
        "pkg-1.16.3" = _79rtoAM6;
        "pkg-1.16.4" = _kBofQyu4;
        "pkg-1.16.5" = _TleLdS1A;
        "pkg-1.16.6" = _PqgXyy3N;
        "pkg-1.16.7" = _Mnl0OeFI;
        "pkg-1.10.5" = _pxj9L3Vy;
        "pkg-2.0.0-beta.2" = _6YvLIUDN;
        "pkg-1.16.8" = _wb5nbuL5;
        "pkg-1.16.9" = _bPE0GIoY;
        "pkg-2.0.0-beta.3" = _pqlMITZQ;
        "pkg-2.0.0-beta.4" = _RIf7gcLA;
        "pkg-1.10.6" = _Gz5wa6j2;
        "pkg-2.0.0-beta.5" = _EDbIonje;
        "pkg-2.0.0-beta.7" = _wRE7Emzz;
        "pkg-2.0.2" = _mzVbb1XI;
        "pkg-1.16.10" = _bHODZExo;
        "pkg-2.0.3" = _a8bewBQT;
        "pkg-1.16.11" = _NyFB1gry;
        "pkg-2.0.4" = _oQr5VO7q;
        "pkg-1.16.12" = _u955lyFM;
        "pkg-2.0.5" = _E4QBMVtO;
        "pkg-1.16.13" = _c6uDXZX8;
        "pkg-2.0.6" = _bojzkt4w;
        "pkg-1.16.14" = _4Ar2wg0k;
        "pkg-2.0.7" = _G8sCBZ1X;
        "pkg-2.0.8" = _JyL5b75a;
        "pkg-1.16.15" = _GOPQZTVp;
        "pkg-1.16.16" = _Wr4GfZdy;
        "pkg-2.0.9" = _tlM0eBmY;
        "pkg-1.16.17" = _DOitjZ89;
        "pkg-2.0.10" = _XtL1i60M;
        "pkg-1.16.18" = _VaZTuVan;
        "pkg-2.0.11" = _FMqdptUn;
        "pkg-1.16.19" = _aH8qgnVM;
        "pkg-2.0.12" = _9xECQHnM;
        "pkg-2.1.0" = _LVxVja5i;
        "pkg-1.16.20" = _JOqf8AZn;
        "pkg-2.0.13" = _WKj0jgYj;
        "pkg-2.1.1" = _jZQ0G78K;
        "pkg-1.16.21" = _PN4NcBa1;
        "pkg-1.16.22" = _WkUCkcQA;
        "pkg-2.0.14" = _3CD6YUw1;
        "pkg-3.0.0" = _JPP6w2U1;
        "pkg-3.0.1" = _eueI9czw;
        "pkg-3.1.0" = _4JrWqhWw;
        "pkg-3.1.1" = _Ui2loaCY;
        "pkg-4.0.0-beta.2" = _fw5MM4c4;
        "pkg-4.0.0-beta.3" = _6f25OJ7w;
        "pkg-4.0.0-beta.4" = _E4VKK6kQ;
        "pkg-3.2.1" = _y8cYdaYa;
        "pkg-3.2.2" = _GYRoFp1I;
        "pkg-4.0.0" = _Tk7mCRX1;
        "pkg-1.16.23" = _aShj7736;
        "pkg-2.0.15" = _dP3zrFbp;
        "pkg-3.2.3" = _cx9D94fU;
        "pkg-4.0.1" = _pnFEFiHq;
        "pkg-4.0.2" = _ybXxCvz4;
        "pkg-4.0.3" = _NsD1IoUs;
        ...
        "pkg-4.0.5" = _2Ys0a7JE;
        "pkg-4.0.6" = _8TOgNwQL;
        "pkg-1.7.17" = _kQDE01D3;
        "pkg-1.10.7" = _3umfHb6R;
        "pkg-2.0.16" = _Gbkn1raO;
        "pkg-3.2.4" = _d86kV6wd;
        "pkg-4.1.0" = _NAs8eiQa;
        "pkg-5.0.0-alpha.1" = _RxrqnH1z;
        "pkg-5.0.0-alpha.2" = _GI1HTA1O;
        "pkg-5.0.0-alpha.3" = _sI3kiPZE;
        "pkg-4.1.1" = _4dReZoTJ;
        "pkg-5.0.0-alpha.4" = _7mdkE3Od;
        "pkg-5.0.0" = _qDXCbEz4;
        "pkg-5.0.1" = _IPLgxPn7;
        "pkg-4.1.2" = _V4hnfgRO;
        "pkg-3.2.5" = _nVxObSbX;
        "pkg-2.0.17" = _7kh2ofyR;
        "pkg-5.0.2" = _eIrlBn1Z;
        "pkg-6.0.0-beta.1" = _yA8g3pEj;
        "pkg-6.1.0-alpha.1" = _oqeCO757;
        "pkg-6.1.0-alpha.2" = _4LXaG2xg;
        "pkg-5.1.0-beta.1" = _5qqTBb38;
        "pkg-5.1.0-beta.2" = _7E8dbVv0;
        "pkg-6.1.0-beta.1" = _5aw4r6fS;
        "pkg-6.1.0-beta.2" = _pyDmgV07;
        "pkg-5.1.0-beta.3" = _jRqFAHRH;
        "pkg-4.2.0-beta.1" = _4EOA40rU;
        "pkg-4.2.0-beta.2" = _gSoPJyVn;
        "pkg-5.1.0-beta.4" = _RtaGQNyd;
        "pkg-6.1.0-beta.3" = _sXVmzBDB;
        "pkg-6.1.0-rc.1" = _U31K6311;
        "pkg-6.1.0-rc.2" = _JYTmttex;
        "pkg-6.1.0-rc.3" = _pged5sGx;
        "pkg-6.1.0-rc.4" = _5e62j63G;
        "pkg-6.1.0" = _nM5QaZNo;
        "pkg-6.2.0" = _aMxXwo9x;
        "pkg-1.14.5+build.30" = _3gwnUSKz;
        "pkg-6.2.1" = _yjjsLqbS;
        "pkg-7.0.0-beta.1" = _RdCGzY7B;
        "pkg-7.0.0-beta.2" = _EuNUYds8;
        "pkg-6.2.2" = _iZRiOnnj;
        "pkg-7.0.0" = _M7LIgtWJ;
        "pkg-7.0.1" = _RTFDnTKf;
        "pkg-6.2.3" = _CtMNOUcV;
        ...
        "pkg-7.2.1" = _eTCL1uh8;
        "pkg-6.3.1" = _lMqXEzUw;
        "pkg-8.0.0-beta.1" = _jbNN4rAs;
        "pkg-7.2.2" = _lEkperf6;
        "pkg-8.0.0-beta.2" = _sMAXpy0X;
        "pkg-8.0.0" = _TwfjidT5;
        "pkg-9.0.0-alpha.1" = _qpKaDJtd;
        "pkg-9.0.0-alpha.2" = _Edgke5GX;
        "pkg-9.0.0-alpha.3" = _tXEHCONL;
        "pkg-9.0.0-pre.1" = _4EYB2Bxx;
        "pkg-8.0.1" = _fCQyI9Zj;
        "pkg-9.0.0" = _sjtVVlsA;
        "pkg-10.0.0-alpha.1" = _ua8KrvY4;
        "pkg-10.0.0-alpha.3" = _mtTzRMV2;
        "pkg-9.1.0-beta.1" = _w3icASIi;
        "pkg-9.2.0-beta.1" = _VOHp29AO;
        "pkg-9.2.0-beta.2" = _ybV7vGT5;
        "pkg-10.0.0-beta.1" = _NgnZx44E;
        "pkg-11.0.0-beta.1" = _9FL4cmP7;
        "pkg-11.0.0-beta.2" = _KXx8jdVE;
        "pkg-11.0.0-rc.1" = _YLesFuAc;
        "pkg-11.0.0-rc.2" = _I7OSH8Gw;
        "pkg-11.0.0-rc.4" = _jnj30PDT;
        "pkg-10.0.0" = _HLa8flfl;
        "pkg-9.2.0" = _FawTQg29;
        "pkg-11.0.0" = _lJ1xXMce;
        "pkg-11.0.1" = _xhN1IvHi;
        "pkg-12.0.0-alpha.1" = _ixIyiMpO;
        "pkg-11.0.2" = _3ib3Uvvv;
        "pkg-11.0.3" = _YIfqIJ8q;
        "pkg-12.0.0-beta.1" = _PcJvQYqu;
        "pkg-12.0.0" = _4xPSbh0l;
        "pkg-13.0.0-beta.1" = _2pJcGBVh;
        "pkg-13.0.0" = _dG06oDvH;
        "pkg-13.0.1" = _4z29vhIo;
        "pkg-13.0.2" = _qPUMDJX6;
        "pkg-14.0.0-beta.1" = _hsiHpAl5;
        "pkg-13.0.3" = _7iGb2ltH;
        "pkg-14.0.0-beta.2" = _R7uVB42W;
        "pkg-14.0.0-rc.1" = _OZuPErV6;
        "pkg-14.0.0-rc.2" = _T7GjZmwP;
        "pkg-15.0.0-beta.1" = _MddiUHup;
        "pkg-15.0.0-beta.2" = _Dg11hN2f;
        "pkg-15.0.0-beta.3" = _JY1tNj8H;
        "pkg-15.0.0" = _am1Siv7F;
        "pkg-16.0.0-rc.1" = _e0mxOOIE;
        "pkg-17.0.0-alpha.1" = _fP9olSIC;
        "pkg-14.0.0" = _gDqVZdY6;
        "pkg-17.0.0-beta.1" = _hGuj7hNc;
        "pkg-16.0.0-rc.2" = _47oRvemD;
        "pkg-18.0.0-alpha.2" = _OcyoPys8;
        "pkg-18.0.0-alpha.3" = _KL1bxkAs;
        "pkg-18.0.0-alpha.4" = _QkuQWh6y;
        "pkg-17.0.0-beta.2" = _JWQVh32x;
        "pkg-14.0.1" = _C4UoE3E9;
        "pkg-15.0.1" = _kiOz1Uxm;
        "pkg-16.0.0" = _QuU0ciaR;
        "pkg-18.0.0-alpha.5" = _DNADU7oH;
        "pkg-18.0.0-alpha.6" = _lWZE38V3;
        "pkg-18.0.0-alpha.7" = _XIDyVLo7;
        "pkg-11.0.4" = _v6Xx3fbU;
        "pkg-12.0.1" = _fzwJOLlA;
        "pkg-13.0.4" = _qEKKsTqd;
        "pkg-14.0.2" = _2ZvBR7XI;
        "pkg-15.0.2" = _ku5NivOP;
        "pkg-16.0.1" = _pYbFlVtR;
        "pkg-17.0.0" = _Tyk71iSw;
        "pkg-18.0.0-alpha.8" = _jvjwXH6l;
        "pkg-18.0.0-beta.1" = _p7gjPPpV;
        "pkg-19.0.0-alpha.1" = _XWjeEU9h;
        "pkg-20.0.0-alpha.1" = _A1KYIXpK;
        "pkg-20.0.0-beta.1" = _gKOCZzz9;
        "pkg-20.0.0-beta.2" = _TLnEHUyx;
        "pkg-20.0.0-beta.3" = _dTGuPZ91;
        "pkg-20.0.0-beta.4" = _3gAjUrx6;
        "pkg-20.0.0" = _QEDySGIN;
        "pkg-18.0.0" = _3rsoV1bk;
