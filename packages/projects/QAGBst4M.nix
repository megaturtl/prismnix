...
let
    versions = (let
        ...
        _HFWoPgRC = {
            "id" = "HFWoPgRC";
            "file" = "PuzzlesLib-v26.1.13-mc26.1.x-Fabric.jar";
            "hash" = "sha512-cg+5hZNZjXHhVhbZf9QdA1rrnv7TEItaSmYWorEdjMv5YgAiYUlyYOcCJoWUZ/mBwPZPZqHJPHMeQWmxoqjG2w==";
        };
        _Mm0HmpcL = {
            "id" = "Mm0HmpcL";
            "file" = "PuzzlesLib-v26.1.13-mc26.1.x-NeoForge.jar";
            "hash" = "sha512-hgFN+0tyq0JRvmAMRvoP8UHQZVwOwuoZDkipQlp22uc5Nj1cI6Cq7TJCYlC3ybtOnOU5JNblFefptXQbpBfvXg==";
        };
        _dmNao5Pi = {
            "id" = "dmNao5Pi";
            "file" = "PuzzlesLib-v26.2.2-mc26.2.x-Fabric.jar";
            "hash" = "sha512-I5bO65nRLUxSk1OLhbchWbdPxgL07mNZVbbXj19eji4P6ppjWQ6Kf111Uu7UJTiBn72oUxFIe6Ftdv8Sy6fJ1w==";
        };
        _eI8PIwKt = {
            "id" = "eI8PIwKt";
            "file" = "PuzzlesLib-v26.2.2-mc26.2.x-NeoForge.jar";
            "hash" = "sha512-+Tkkw2HAlVVDlXUTPLt7RsGhh2AvSl8f+g0YWzJtBmAhhHZf11wO3SkxKbWoZih8h2xQj29XG0HN/CCEmycYRw==";
        };
        _rEJUehiZ = {
            "id" = "rEJUehiZ";
            "file" = "PuzzlesLib-v26.1.14-mc26.1.x-Fabric.jar";
            "hash" = "sha512-V/9qhIa4wOvW5BofLBLqj4E9NcOFAZ39wPX+2uCKiRDSXqg/3hT0GJOCVXWjXGvffOgEf7wgthHdCHGLwpMBsA==";
        };
        _JzsAJpZS = {
            "id" = "JzsAJpZS";
            "file" = "PuzzlesLib-v26.1.14-mc26.1.x-NeoForge.jar";
            "hash" = "sha512-jSX+ehphzZ31zZG15FVZvf1i7xSZbVQNGgAIsV6Q5rQHnN9Vk9QmGCm/O50fLFTf6TuPiqCkZWHUCWDqephsfA==";
        };
        _KU5rZUAR = {
            "id" = "KU5rZUAR";
            "file" = "PuzzlesLib-v26.2.3-mc26.2.x-Fabric.jar";
            "hash" = "sha512-PVwPpY918800W8SKCKeDiQqrjvAdG+ETCIE43aG/eQMKeC3SZ2iMB8wup6fQlxDVB5dBb8IpLFgATMb/J8eRvQ==";
        };
        _KUdzkzSd = {
            "id" = "KUdzkzSd";
            "file" = "PuzzlesLib-v26.2.3-mc26.2.x-NeoForge.jar";
            "hash" = "sha512-+kutjSDgP+2TfD++zkyBZEThoKLSrLgFC7oZFnyJG+Rj6FwC6UDZmn9GbzOUPlXRv2eqCFC8YWAhZX1dStycHg==";
        };
        _qbF2d7Ma = {
            "id" = "qbF2d7Ma";
            "file" = "PuzzlesLib-v21.1.56-mc1.21.1-NeoForge.jar";
            "hash" = "sha512-eg9uWHKGhMUJnZ+hV6SpoHgBnPwmOERQaqQ7qH7hyPVW4B8LJM+W+bbdNzvF2nFHc/OURCpq0EWxV9moo2ultA==";
        };
        _T2RZmnLI = {
            "id" = "T2RZmnLI";
    ...
    in {
        ...
        "pkg-v4.0.5-1.19-Fabric" = _4T4HZk3f;
        "pkg-v4.0.6-1.19-Forge" = _jrxiZIJg;
        "pkg-v4.0.6-1.19-Fabric" = _ggK4alzB;
        "pkg-v4.0.8-1.19-Forge" = _3FVGVSRL;
        "pkg-v4.0.8-1.19-Fabric" = _3R2noZBz;
        "pkg-v4.0.10-1.19-Forge" = _GEaTK1To;
        "pkg-v4.0.10-1.19-Fabric" = _MORtFjT7;
        "pkg-v4.0.11-1.19-Forge" = _SRIg4iQn;
        "pkg-v4.0.11-1.19-Fabric" = _1osO35Q5;
        "pkg-v4.0.13-1.19-Forge" = _vy6Bovd4;
        "pkg-v4.0.13-1.19-Fabric" = _wQvOrCfA;
        "pkg-v4.0.14-1.19-Forge" = _ZwirJqdf;
        "pkg-v4.0.14-1.19-Fabric" = _O8agM1Hz;
        "pkg-v4.0.15-1.19-Forge" = _vi5hw79t;
        "pkg-v4.0.15-1.19-Fabric" = _8ae5TjLO;
        "pkg-v4.0.17-1.19-Fabric" = _yDmfcIc3;
        "pkg-v4.0.17-1.19-Forge" = _V7IXjDfj;
        "pkg-v4.0.18-1.19-Forge" = _o5YLPKfR;
        "pkg-v4.0.18-1.19-Fabric" = _U7RPCAL4;
        "pkg-v4.1.0-1.19.1-Fabric" = _w1IA6pkN;
        "pkg-v4.1.0-1.19.1-Forge" = _1PvxPgTS;
        "pkg-v4.1.1-1.19.1-Forge" = _Dfk6Kdpk;
        "pkg-v4.1.1-1.19.1-Fabric" = _R9uwqQnV;
        "pkg-v4.1.2-1.19.1-Forge" = _mH2iiwlr;
        "pkg-v4.1.2-1.19.1-Fabric" = _Pg6wh6Id;
        "pkg-v4.1.3-1.19.1-Forge" = _48jeSKzO;
        "pkg-v4.1.3-1.19.1-Fabric" = _E9Qlol2T;
        "pkg-v4.1.4-1.19.1-Forge" = _V5LBscZ6;
        "pkg-v4.1.4-1.19.1-Fabric" = _s6sGKfbx;
        "pkg-v4.1.6-1.19.1-Forge" = _bRZ6AoTv;
        "pkg-v4.1.6-1.19.1-Fabric" = _9VA381uD;
        "pkg-v4.1.8-1.19.1-Forge" = _ZxiflfQp;
        "pkg-v4.1.8-1.19.1-Fabric" = _1DmyxKmi;
        "pkg-v4.2.1-1.19.2-Fabric" = _jA529ngn;
        "pkg-v4.2.1-1.19.2-Forge" = _JSEHdamZ;
        "pkg-v4.2.2-1.19.2-Forge" = _BpOQ6Lqg;
        "pkg-v4.2.2-1.19.2-Fabric" = _SJGSFBMc;
        "pkg-v4.2.4-1.19.2-Forge" = _iYV1Feh5;
        "pkg-v4.2.4-1.19.2-Fabric" = _gd0G2hhz;
        "pkg-v4.3.0-1.19.2-Fabric" = _Ez5gkdlU;
        "pkg-v4.3.0-1.19.2-Forge" = _45edveqj;
        "pkg-v4.3.1-1.19.2-Forge" = _oQsbSTy3;
        "pkg-v4.3.1-1.19.2-Fabric" = _6NuJBhyA;
        "pkg-v4.3.2-1.19.2-Fabric" = _Dp7R36Xs;
        "pkg-v4.3.2-1.19.2-Forge" = _jgMObcuM;
        "pkg-v4.3.4-1.19.2-Forge" = _2bEMzr1L;
        "pkg-v4.3.4-1.19.2-Fabric" = _6GQc3co6;
        "pkg-v4.3.8-1.19.2-Forge" = _BP33eOxU;
        "pkg-v4.3.8-1.19.2-Fabric" = _D9vM6NoG;
        "pkg-v4.3.9-1.19.2-Forge" = _b4lBddf3;
        "pkg-v4.3.9-1.19.2-Fabric" = _wZcJ8cWK;
        "pkg-v4.3.10-1.19.2-Forge" = _y4nUf0PC;
        "pkg-v4.3.10-1.19.2-Fabric" = _XWUp4icb;
        "pkg-v4.3.11-1.19.2-Forge" = _i21HIDqx;
        "pkg-v4.3.11-1.19.2-Fabric" = _h6zwrOXh;
        "pkg-v4.3.12-1.19.2-Forge" = _mC47wVQz;
        "pkg-v4.3.12-1.19.2-Fabric" = _FCWQcWnv;
        "pkg-v5.0.5-1.19.3-Fabric" = _8CR0bnID;
        "pkg-v5.0.5-1.19.3-Forge" = _HwzoFHC1;
        "pkg-v5.0.6-1.19.3-Fabric" = _VGj1zGrn;
        "pkg-v5.0.6-1.19.3-Forge" = _FkILlZd7;
        "pkg-v5.0.8-1.19.3-Fabric" = _p1tTNyCv;
        "pkg-v5.0.8-1.19.3-Forge" = _fL77THCh;
        "pkg-v5.0.10-1.19.3-Fabric" = _Lm5gebmK;
        "pkg-v5.0.10-1.19.3-Forge" = _LGbvfJUd;
        "pkg-v5.0.11-1.19.3-Forge" = _2ztHmiwc;
        "pkg-v5.0.11-1.19.3-Fabric" = _YoJzLFN6;
        "pkg-v5.0.12-1.19.3-Forge" = _VPPkHE7i;
        "pkg-v5.0.12-1.19.3-Fabric" = _z7svCBW6;
        "pkg-v5.0.14-1.19.3-Forge" = _kwepeOdS;
        "pkg-v5.0.14-1.19.3-Fabric" = _xDxHThlp;
        "pkg-v5.0.17-1.19.3-Fabric" = _FHljGbgZ;
        "pkg-v5.0.17-1.19.3-Forge" = _WtjnkHmQ;
        "pkg-v5.0.18-1.19.3-Fabric" = _5uHrsodn;
        "pkg-v5.0.18-1.19.3-Forge" = _ObWocDjJ;
        "pkg-v5.0.19-1.19.3-Fabric" = _Gx40SdoU;
        "pkg-v5.0.19-1.19.3-Forge" = _m2m1WsQC;
        "pkg-v4.4.0-1.19.2-Forge" = _NjsLQCQh;
        "pkg-v4.4.0-1.19.2-Fabric" = _LSUMYLnt;
        "pkg-v5.0.20-1.19.3-Forge" = _NRIoCBh3;
        "pkg-v5.0.20-1.19.3-Fabric" = _iKGK4NBG;
        "pkg-v5.0.22-1.19.3-Fabric" = _QpkkVVyn;
        "pkg-v5.0.22-1.19.3-Forge" = _4DEcuUZZ;
        "pkg-v5.0.24-1.19.3-Fabric" = _fgZrY52r;
        "pkg-v5.0.24-1.19.3-Forge" = _8QmUx5Fl;
        "pkg-v6.0.0-1.19.4-Fabric" = _mPEMMhvN;
        "pkg-v6.0.0-1.19.4-Forge" = _2kp8bKQO;
        "pkg-v5.0.26-1.19.3-Forge" = _rD8mGLPb;
        "pkg-v5.0.26-1.19.3-Fabric" = _L5GPGt7F;
        "pkg-v6.0.2-1.19.4-Fabric" = _DFhQb5uf;
        "pkg-v6.0.2-1.19.4-Forge" = _JrupytDU;
        "pkg-v6.0.3-1.19.4-Fabric" = _GwsJMvCw;
        "pkg-v6.0.3-1.19.4-Forge" = _hP9hXoCe;
        "pkg-v5.0.27-1.19.3-Forge" = _1lSk5VZh;
        "pkg-v5.0.27-1.19.3-Fabric" = _rO6E3jGm;
        "pkg-v5.0.28-1.19.3-Fabric" = _LZOEQVQC;
        "pkg-v5.0.28-1.19.3-Forge" = _i2xTbv7Y;
        "pkg-v5.0.30-1.19.3-Fabric" = _a8ZgypYg;
        "pkg-v5.0.30-1.19.3-Forge" = _h1ns5GaM;
        "pkg-v6.0.4-1.19.4-Forge" = _rKfjKi33;
        "pkg-v6.0.4-1.19.4-Fabric" = _yeHvhYOD;
        "pkg-v5.0.31-1.19.3-Fabric" = _ns69L8dI;
        "pkg-v5.0.31-1.19.3-Forge" = _sv1iPMzi;
        "pkg-v5.0.33-1.19.3-Forge" = _OXRJbrn6;
        "pkg-v5.0.33-1.19.3-Fabric" = _PxXJo3k4;
        "pkg-v6.0.5-1.19.4-Forge" = _KFG50Qhy;
        "pkg-v6.0.5-1.19.4-Fabric" = _6As7amla;
        "pkg-v6.0.6-1.19.4-Forge" = _op5e6xRq;
        "pkg-v6.0.6-1.19.4-Fabric" = _7ABrOIgA;
        "pkg-v6.0.7-1.19.4-Fabric" = _zizb6yD6;
        "pkg-v6.0.7-1.19.4-Forge" = _KCA6vQD5;
        "pkg-v6.0.8-1.19.4-Fabric" = _UCiKAgMn;
        "pkg-v6.0.8-1.19.4-Forge" = _zBzpSBKZ;
        "pkg-v6.0.9-1.19.4-Fabric" = _KoZGuWml;
        "pkg-v6.0.9-1.19.4-Forge" = _QiVyRzQB;
        "pkg-v3.4.0-1.18.2-Fabric" = _690IIFFZ;
        "pkg-v3.4.0-1.18.2-Forge" = _TkxPgn47;
        "pkg-v3.4.4-1.18.2-Forge" = _R1uJEZ31;
        "pkg-v3.4.4-1.18.2-Fabric" = _7yxa655A;
        "pkg-v3.4.5-1.18.2-Forge" = _P6S26sSD;
        "pkg-v3.4.5-1.18.2-Fabric" = _7fAHr6w5;
        "pkg-v7.0.0-1.20-Forge" = _IEXOIGVL;
        "pkg-v7.0.0-1.20-Fabric" = _wCK8ij3a;
        "pkg-v7.0.2-1.20-Forge" = _lf6PGWwe;
        "pkg-v7.0.2-1.20-Fabric" = _OKZ6mA1W;
        "pkg-v7.0.3-1.20-Forge" = _pvuBqFqb;
        "pkg-v7.0.3-1.20-Fabric" = _DHk61kCu;
        "pkg-v4.4.1-1.19.2-Forge" = _SuhOII0F;
        "pkg-v4.4.1-1.19.2-Fabric" = _cPGoonJT;
        "pkg-v6.0.11-1.19.4-Forge" = _yP5oQ3Ak;
        "pkg-v6.0.11-1.19.4-Fabric" = _Fnlslono;
        "pkg-v4.4.2-1.19.2-Forge" = _Bp8RvlYw;
        "pkg-v4.4.2-1.19.2-Fabric" = _bEmPd1vO;
        "pkg-v7.0.9-1.20-Forge" = _9Q6cCSz6;
        "pkg-v7.0.9-1.20-Fabric" = _UUEjLtmS;
        "pkg-v3.4.6-1.18.2-Forge" = _GpusdAdv;
        "pkg-v3.4.6-1.18.2-Fabric" = _gd7iDa09;
        "pkg-v4.4.3-1.19.2-Forge" = _UbCrBSit;
        "pkg-v4.4.3-1.19.2-Fabric" = _hYKHLRZ3;
        "pkg-v8.0.0-1.20.1-Forge" = _qdNeRisk;
        "pkg-v8.0.0-1.20.1-Fabric" = _Q1j5L2yM;
        "pkg-v8.0.1-1.20.1-Forge" = _KmQylKLN;
        "pkg-v8.0.1-1.20.1-Fabric" = _lSd7CXvO;
        "pkg-v8.0.2-1.20.1-Forge" = _g8d307PL;
        "pkg-v8.0.2-1.20.1-Fabric" = _TwMB98sM;
        "pkg-v8.0.4-1.20.1-Forge" = _31TqmnJN;
        "pkg-v8.0.4-1.20.1-Fabric" = _a5MLEWK6;
        "pkg-v8.0.5-1.20.1-Forge" = _WyvOkbnG;
        "pkg-v8.0.5-1.20.1-Fabric" = _e0aWlelt;
        "pkg-v8.0.7-1.20.1-Forge" = _WjRzXRln;
        "pkg-v8.0.7-1.20.1-Fabric" = _Noj6vMtz;
        "pkg-v8.0.11-1.20.1-Forge" = _5r3BfjAc;
        "pkg-v8.0.11-1.20.1-Fabric" = _H9EbhiH7;
        "pkg-v8.0.12-1.20.1-Forge" = _hPp2iJwv;
        "pkg-v8.0.12-1.20.1-Fabric" = _RUsPffnS;
        "pkg-v8.0.13-1.20.1-Forge" = _Y5Kjea08;
        "pkg-v8.0.13-1.20.1-Fabric" = _51n2dMFU;
        "pkg-v8.0.14-1.20.1-Forge" = _gAz4ZDBl;
        "pkg-v8.0.14-1.20.1-Fabric" = _RayW5xBY;
        "pkg-v8.0.15-1.20.1-Forge" = _V4g0yKzo;
        "pkg-v8.0.15-1.20.1-Fabric" = _wfZ1WUlB;
        "pkg-v3.4.7-1.18.2-Forge" = _Lr1pamFx;
        "pkg-v3.4.7-1.18.2-Fabric" = _rNieKbmF;
        "pkg-v8.0.18-1.20.1-Forge" = _RDV4dG9C;
        "pkg-v8.0.18-1.20.1-Fabric" = _1UwAgU9l;
        "pkg-v3.5.2-1.18.2-Forge" = _paSPjnHb;
        "pkg-v3.5.2-1.18.2-Fabric" = _ItncP8dX;
        "pkg-v8.0.19-1.20.1-Forge" = _8BIig8L5;
        "pkg-v8.0.19-1.20.1-Fabric" = _HEzEuCRw;
        "pkg-v3.5.3-1.18.2-Forge" = _UMRz9cBy;
        "pkg-v3.5.3-1.18.2-Fabric" = _tcY2bo8S;
        "pkg-v3.5.4-1.18.2-Forge" = _LTuYPgiM;
        "pkg-v3.5.4-1.18.2-Fabric" = _8mMvpXiC;
        "pkg-v3.5.5-1.18.2-Forge" = _cJqMmNyP;
        "pkg-v3.5.5-1.18.2-Fabric" = _qiuZsD4R;
        "pkg-v3.5.6-1.18.2-Forge" = _RVGrKpDw;
        "pkg-v3.5.6-1.18.2-Fabric" = _gJPobzvP;
        "pkg-v8.0.20-1.20.1-Forge" = _d3flGMAv;
        "pkg-v8.0.20-1.20.1-Fabric" = _ZwbaWApq;
        "pkg-v3.5.7-1.18.2-Forge" = _83sS3ngW;
        "pkg-v3.5.7-1.18.2-Fabric" = _jLn169xV;
        "pkg-v8.0.21-1.20.1-Forge" = _RYhkOF7A;
        "pkg-v8.0.21-1.20.1-Fabric" = _3aTpS1mg;
        "pkg-v8.0.23-1.20.1-Forge" = _ZtDMfIUN;
        "pkg-v8.0.23-1.20.1-Fabric" = _dXLl9uWi;
        "pkg-v8.0.24-1.20.1-Forge" = _Sk64RP7y;
        "pkg-v8.0.24-1.20.1-Fabric" = _KGAO1rK6;
        "pkg-v3.5.8-1.18.2-Forge" = _nEMiPLZ0;
        "pkg-v3.5.8-1.18.2-Fabric" = _bKkfr7ay;
        "pkg-v8.1.0-1.20.1-Forge" = _oPr3RcvY;
        "pkg-v8.1.0-1.20.1-Fabric" = _oFX0OV3d;
        "pkg-v8.1.1-1.20.1-Forge" = _WKcrcW20;
        "pkg-v8.1.1-1.20.1-Fabric" = _5nBTQI8o;
        "pkg-v8.1.2-1.20.1-Forge" = _ltzRj1Al;
        "pkg-v8.1.2-1.20.1-Fabric" = _XqZXczYQ;
        "pkg-v8.1.3-1.20.1-Fabric" = _XcEPni7L;
        "pkg-v8.1.3-1.20.1-Forge" = _mnz2Hm7Z;
        "pkg-v8.1.5-1.20.1-Forge" = _TXMzWrbS;
        "pkg-v8.1.5-1.20.1-Fabric" = _gGsQ0pWm;
        "pkg-v8.1.7-1.20.1-Forge" = _lOhe38BY;
        "pkg-v8.1.7-1.20.1-Fabric" = _xShIH08f;
        "pkg-v8.1.8-1.20.1-Forge" = _V1MfC0Mw;
        "pkg-v8.1.8-1.20.1-Fabric" = _57xICvxd;
        "pkg-v8.1.9-1.20.1-Forge" = _OGBBlBRy;
        "pkg-v8.1.9-1.20.1-Fabric" = _MCFpJ1Oq;
        "pkg-v8.1.11-1.20.1-Forge" = _Wb6w0J7U;
        "pkg-v8.1.11-1.20.1-Fabric" = _cCopyIlz;
        "pkg-v8.1.12-1.20.1-Forge" = _5ADGGlfq;
        "pkg-v8.1.12-1.20.1-Fabric" = _LTVbnixz;
        "pkg-v8.1.13-1.20.1-Forge" = _nBWJys7K;
        "pkg-v8.1.13-1.20.1-Fabric" = _6VIgAUJL;
        "pkg-v20.4.2-1.20.4-Fabric" = _xiHYPU0O;
        "pkg-v20.4.2-1.20.4-NeoForge" = _ZUVLIzWs;
        "pkg-v20.4.2-1.20.4-Forge" = _SW4ids1s;
        "pkg-v20.4.3-1.20.4-Fabric" = _Txoaqdfx;
        "pkg-v20.4.3-1.20.4-NeoForge" = _EFyslVOo;
        "pkg-v20.4.3-1.20.4-Forge" = _HANk7S8Y;
        "pkg-v20.4.4-1.20.4-Fabric" = _8gv1l93Y;
        "pkg-v20.4.4-1.20.4-NeoForge" = _vWlFyCm4;
        "pkg-v20.4.4-1.20.4-Forge" = _SWQ2ahqO;
        "pkg-v20.4.7-1.20.4-Fabric" = _tfARtYYn;
        "pkg-v20.4.7-1.20.4-NeoForge" = _9nJxieAS;
        "pkg-v20.4.7-1.20.4-Forge" = _v423n2Pm;
        "pkg-v8.1.14-1.20.1-Forge" = _DIhm8o76;
        "pkg-v8.1.14-1.20.1-Fabric" = _SgNgKci7;
        "pkg-v20.4.9-1.20.4-Fabric" = _6Pjd6OaZ;
        "pkg-v20.4.9-1.20.4-Forge" = _iKy6nFZL;
        "pkg-v20.4.9-1.20.4-NeoForge" = _e4lzFDZS;
        "pkg-v8.1.15-1.20.1-Forge" = _jkphsaH8;
        "pkg-v8.1.15-1.20.1-Fabric" = _O4VA1IJL;
        "pkg-v20.4.11-1.20.4-Fabric" = _pVdAf92x;
        "pkg-v20.4.11-1.20.4-NeoForge" = _3wteGlwJ;
        "pkg-v20.4.11-1.20.4-Forge" = _L30yzNuL;
        "pkg-v20.4.12-1.20.4-Fabric" = _k8mU0QlS;
        "pkg-v20.4.12-1.20.4-NeoForge" = _Ab5KUgTb;
        "pkg-v20.4.12-1.20.4-Forge" = _nmSD44fp;
        "pkg-v20.4.13-1.20.4-Fabric" = _kQgkv5iT;
        "pkg-v20.4.13-1.20.4-Forge" = _yv0STfcl;
        "pkg-v20.4.13-1.20.4-NeoForge" = _wyqkVBR6;
        "pkg-v20.4.14-1.20.4-Fabric" = _62Td8gAV;
        "pkg-v20.4.14-1.20.4-Forge" = _gfFhZGIK;
        "pkg-v20.4.14-1.20.4-NeoForge" = _t21ZaLpl;
        "pkg-v8.1.16-1.20.1-Forge" = _dGKTOxmu;
        "pkg-v8.1.16-1.20.1-Fabric" = _NZat9O7c;
        "pkg-v20.4.15-1.20.4-Fabric" = _SNpPIaBe;
        "pkg-v20.4.15-1.20.4-Forge" = _VWijWTpQ;
        "pkg-v20.4.15-1.20.4-NeoForge" = _QPlKuTc3;
        "pkg-v20.4.16-1.20.4-Fabric" = _2MTgLRdA;
        "pkg-v20.4.16-1.20.4-NeoForge" = _EuOcMDkX;
        "pkg-v20.4.16-1.20.4-Forge" = _UmSXV9Rq;
        "pkg-v20.4.17-1.20.4-Fabric" = _Hd24Sjqn;
        "pkg-v20.4.17-1.20.4-NeoForge" = _qTyUOUnm;
        "pkg-v20.4.17-1.20.4-Forge" = _lWxIr4jA;
        "pkg-v20.4.18-1.20.4-Fabric" = _ztwxN6az;
        "pkg-v20.4.18-1.20.4-Forge" = _heTs4xwy;
        "pkg-v20.4.18-1.20.4-NeoForge" = _fRs9GSN9;
        "pkg-v20.4.21-1.20.4-Fabric" = _4pPSXzLY;
        "pkg-v20.4.21-1.20.4-Forge" = _RXjYpwik;
        "pkg-v20.4.21-1.20.4-NeoForge" = _hAnXRGE6;
        "pkg-v20.4.22-1.20.4-Fabric" = _mi9Mryhy;
        "pkg-v20.4.22-1.20.4-NeoForge" = _VX10tpqr;
        "pkg-v20.4.22-1.20.4-Forge" = _TbC3Jf6X;
        "pkg-v20.4.23-1.20.4-Fabric" = _EnIz7EYT;
        "pkg-v20.4.23-1.20.4-Forge" = _qdBCO6ts;
        "pkg-v20.4.23-1.20.4-NeoForge" = _8DBzZOGj;
        "pkg-v8.1.17-1.20.1-Forge" = _iwDQtahk;
        "pkg-v8.1.17-1.20.1-Fabric" = _FTMya93H;
        "pkg-v3.5.9-1.18.2-Forge" = _4MxDan2p;
        "pkg-v3.5.9-1.18.2-Fabric" = _tDJF06pn;
        "pkg-v20.4.24-1.20.4-Fabric" = _DxOr6NRG;
        "pkg-v20.4.24-1.20.4-Forge" = _9MMQnG3c;
        "pkg-v20.4.24-1.20.4-NeoForge" = _WzEMd08l;
        "pkg-v20.4.25-1.20.4-Fabric" = _I0w9FYVT;
        "pkg-v20.4.25-1.20.4-Forge" = _8biFI7PT;
        "pkg-v20.4.25-1.20.4-NeoForge" = _2W0fLYmI;
        "pkg-v20.4.30-1.20.4-Fabric" = _XrQEeA3j;
        "pkg-v20.4.30-1.20.4-Forge" = _DD87WPm0;
        "pkg-v20.4.30-1.20.4-NeoForge" = _6lsMD0wH;
        "pkg-v20.4.31-1.20.4-Fabric" = _GHuvKmu8;
        "pkg-v20.4.31-1.20.4-Forge" = _EpSfQOOy;
        "pkg-v20.4.31-1.20.4-NeoForge" = _hs4gH8fg;
        "pkg-v20.4.36-1.20.4-Fabric" = _9SKeDQfZ;
        "pkg-v20.4.36-1.20.4-Forge" = _KI13IqvB;
        "pkg-v20.4.36-1.20.4-NeoForge" = _8TeiPNFS;
        "pkg-v20.4.39-1.20.4-Forge" = _8H0WEHWb;
        "pkg-v20.4.39-1.20.4-Fabric" = _YV5fPHDv;
        "pkg-v20.4.39-1.20.4-NeoForge" = _aYUxnbFX;
        "pkg-v20.4.40-1.20.4-Fabric" = _8ENMTJuS;
        "pkg-v20.4.40-1.20.4-Forge" = _Kzujt3Wg;
        "pkg-v20.4.40-1.20.4-NeoForge" = _h49wtUmr;
        "pkg-v8.1.18-1.20.1-Fabric" = _UevkyHdQ;
        "pkg-v8.1.18-1.20.1-Forge" = _1radnytC;
        "pkg-v20.4.41-1.20.4-Fabric" = _5AajzfKh;
        "pkg-v20.4.41-1.20.4-NeoForge" = _dg6ziRn7;
        "pkg-v20.4.41-1.20.4-Forge" = _3FxP0dZE;
        "pkg-v20.4.42-1.20.4-Fabric" = _tXRgMC8h;
        "pkg-v20.4.42-1.20.4-NeoForge" = _L3apApXu;
        "pkg-v20.4.42-1.20.4-Forge" = _juwmigdj;
        "pkg-v8.1.19-1.20.1-Forge" = _G9liaLgv;
        "pkg-v8.1.19-1.20.1-Fabric" = _ZHG4YWEj;
        "pkg-v20.4.43-1.20.4-Fabric" = _5EdhqiJS;
        "pkg-v20.4.43-1.20.4-NeoForge" = _dn3USeHA;
        "pkg-v20.4.43-1.20.4-Forge" = _mgFflJ2j;
        "pkg-v8.1.20-1.20.1-Forge" = _FWuIR2cX;
        "pkg-v8.1.20-1.20.1-Fabric" = _R9M0uem6;
        "pkg-v20.4.44-1.20.4-Fabric" = _GeTxzirf;
        "pkg-v20.4.44-1.20.4-NeoForge" = _5IOFWbWY;
        "pkg-v20.4.44-1.20.4-Forge" = _JH9UaBnb;
        "pkg-v8.1.21-1.20.1-Forge" = _z0kHAGDv;
        "pkg-v8.1.21-1.20.1-Fabric" = _xjQF8bha;
        "pkg-v20.4.52-1.20.4-Fabric" = _vGTq0Oye;
        "pkg-v20.4.52-1.20.4-Forge" = _xkn7hkSC;
        "pkg-v20.4.52-1.20.4-NeoForge" = _smpYKI3H;
        "pkg-v21.0.4-1.21-NeoForge" = _hzqpfUyq;
        "pkg-v21.0.4-1.21-Fabric" = _qxsoKMgp;
        "pkg-v21.0.6-1.21-NeoForge" = _bO46WSgf;
        "pkg-v21.0.6-1.21-Fabric" = _yRKzQH0Y;
        "pkg-v21.0.7-1.21-NeoForge" = _umed6mI7;
        "pkg-v21.0.7-1.21-Fabric" = _ZX11O3AP;
        "pkg-v21.0.8-1.21-NeoForge" = _v5xtZkKN;
        "pkg-v21.0.8-1.21-Fabric" = _iaUdZflF;
        "pkg-v21.0.9-1.21-NeoForge" = _pNxX74mc;
        "pkg-v21.0.9-1.21-Fabric" = _FjvlNKLa;
        "pkg-v21.0.11-1.21-NeoForge" = _VTkKjHAE;
        "pkg-v21.0.11-1.21-Fabric" = _vBUQ7u2A;
        "pkg-v21.0.12-1.21-NeoForge" = _r2YdKG6L;
        "pkg-v21.0.12-1.21-Fabric" = _rutUEgUD;
        "pkg-v21.0.13-1.21-Fabric" = _NPwuTRlv;
        "pkg-v21.0.13-1.21-NeoForge" = _1KI644C2;
        "pkg-v21.0.15-1.21-NeoForge" = _1rbMiEHY;
        "pkg-v21.0.15-1.21-Fabric" = _FBiKXkKa;
        "pkg-v21.0.17-1.21-NeoForge" = _BmlBHZrC;
        "pkg-v21.0.17-1.21-Fabric" = _vOobFb4y;
        "pkg-v21.0.18-1.21-NeoForge" = _OSy4cscJ;
        "pkg-v21.0.18-1.21-Fabric" = _tAdUNfuF;
        "pkg-v21.0.19-1.21-NeoForge" = _YU1mI7Kd;
        "pkg-v21.0.19-1.21-Fabric" = _oj9qLzJM;
        "pkg-v21.0.20-1.21-Fabric" = _YSIFLimp;
        "pkg-v21.0.20-1.21-NeoForge" = _ZYDbSmpi;
        "pkg-v21.0.22-1.21-NeoForge" = _H27pFMsx;
        "pkg-v21.0.22-1.21-Fabric" = _Rzc9NmZd;
        "pkg-v21.0.23-1.21-NeoForge" = _fUDadWzn;
        "pkg-v21.0.23-1.21-Fabric" = _ULwmfapj;
        "pkg-v8.1.22-1.20.1-Forge" = _WHDG4o9c;
        "pkg-v8.1.22-1.20.1-Fabric" = _aytL8HYY;
        "pkg-v21.0.24-1.21-NeoForge" = _6u1xql6V;
        "pkg-v21.0.24-1.21-Fabric" = _8eLS73LA;
        "pkg-v21.0.25-1.21-Fabric" = _PZ9FEHEU;
        "pkg-v21.0.25-1.21-NeoForge" = _dlX1sSPg;
        "pkg-v21.0.26-1.21-Fabric" = _29HHWaC9;
        "pkg-v21.0.26-1.21-NeoForge" = _aIK7mOe1;
        "pkg-v21.0.27-1.21-Fabric" = _qcSqMOj7;
        "pkg-v21.0.27-1.21-NeoForge" = _m177dQUy;
        "pkg-v21.0.28-1.21-Fabric" = _a5KN1w1N;
        "pkg-v21.0.28-1.21-NeoForge" = _X06v0OZx;
        "pkg-v8.1.23-1.20.1-Forge" = _UlSkomup;
        "pkg-v8.1.23-1.20.1-Fabric" = _wTaZZcm5;
        "pkg-v21.1.0-1.21.1-NeoForge" = _wRGMLeIO;
        "pkg-v21.1.0-1.21.1-Fabric" = _K7Kortlb;
        "pkg-v21.1.1-1.21.1-NeoForge" = _qM1R8iOr;
        "pkg-v21.1.1-1.21.1-Fabric" = _Jxg2nQsP;
        "pkg-v21.1.3-1.21.1-NeoForge" = _C9H2TvKn;
        "pkg-v21.1.3-1.21.1-Fabric" = _Uc8Qr1KJ;
        "pkg-v3.5.10-1.18.2-Forge" = _IIordDD2;
        "pkg-v3.5.10-1.18.2-Fabric" = _miLZT25C;
        "pkg-v21.1.7-1.21.1-Fabric" = _pY6y1edj;
        "pkg-v21.1.7-1.21.1-NeoForge" = _Wfq1cAc5;
        "pkg-v21.1.8-1.21.1-NeoForge" = _GWO597Ka;
        "pkg-v21.1.8-1.21.1-Fabric" = _y8ZIL6Mn;
        "pkg-v21.1.9-1.21.1-NeoForge" = _B46a6kV7;
        "pkg-v21.1.9-1.21.1-Fabric" = _fzlyrggz;
        "pkg-v21.1.10-1.21.1-NeoForge" = _pY1eM2sz;
        "pkg-v21.1.10-1.21.1-Fabric" = _IoofBwKp;
        "pkg-v21.1.11-1.21.1-NeoForge" = _7tNxsZzz;
        "pkg-v21.1.11-1.21.1-Fabric" = _SxuQNxNr;
        "pkg-v21.1.14-1.21.1-NeoForge" = _q6e1uv1q;
        "pkg-v21.1.14-1.21.1-Fabric" = _lRsgI6Mw;
        "pkg-v21.1.15-1.21.1-NeoForge" = _yvI9WNiX;
        "pkg-v21.1.15-1.21.1-Fabric" = _T3Kex73T;
        "pkg-v21.1.16-1.21.1-Fabric" = _91dge9xu;
        "pkg-v21.1.16-1.21.1-NeoForge" = _IpGLraiE;
        "pkg-v21.1.17-1.21.1-NeoForge" = _cjTOppFY;
        "pkg-v21.1.17-1.21.1-Fabric" = _4OiP6mQJ;
        "pkg-v8.1.24-1.20.1-Forge" = _CRWEHl5m;
        "pkg-v8.1.24-1.20.1-Fabric" = _LT6tSsY5;
        "pkg-v21.1.18-1.21.1-NeoForge" = _gmaljwfy;
        "pkg-v21.1.18-1.21.1-Fabric" = _yhYluojE;
        "pkg-v21.1.22-1.21.1-NeoForge" = _y2hCHcY2;
        "pkg-v21.1.22-1.21.1-Fabric" = _1tsnZQza;
        "pkg-v8.1.25-1.20.1-Forge" = _2qznQtPr;
        "pkg-v8.1.25-1.20.1-Fabric" = _qjSRRf2B;
        "pkg-v21.3.1-1.21.3-Fabric" = _EvAPMmr2;
        "pkg-v21.3.1-1.21.3-NeoForge" = _lnBghSwr;
        "pkg-v21.3.2-1.21.3-NeoForge" = _XUlPXw4e;
        "pkg-v21.3.2-1.21.3-Fabric" = _Fh1J7SY2;
        "pkg-v21.3.3-1.21.3-NeoForge" = _VIdPVQop;
        "pkg-v21.3.3-1.21.3-Fabric" = _GADShcVL;
        "pkg-v21.3.5-1.21.3-NeoForge" = _KPQ89Cg1;
        "pkg-v21.3.5-1.21.3-Fabric" = _8bixHH8c;
        "pkg-v21.3.8-1.21.3-Fabric" = _GQghtNIa;
        "pkg-v21.3.8-1.21.3-NeoForge" = _TglnuvYi;
        "pkg-v21.3.9-1.21.3-Fabric" = _Gp8eUK5a;
        "pkg-v21.3.9-1.21.3-NeoForge" = _y3l6NtO9;
        "pkg-v21.3.10-1.21.3-NeoForge" = _VwccRcOl;
        "pkg-v21.3.10-1.21.3-Fabric" = _rOCUy6qE;
        "pkg-v21.3.11-1.21.3-NeoForge" = _gnkVP0Mh;
        "pkg-v21.3.11-1.21.3-Fabric" = _lK50eogU;
        "pkg-v21.3.12-1.21.3-Fabric" = _oT54ACrp;
        "pkg-v21.3.12-1.21.3-NeoForge" = _N9i7odCN;
        "pkg-v21.3.13-1.21.3-NeoForge" = _LP2PJQEa;
        "pkg-v21.3.13-1.21.3-Fabric" = _gm6xM51m;
        "pkg-v21.1.24-1.21.1-NeoForge" = _zG8zY2wO;
        "pkg-v21.1.24-1.21.1-Fabric" = _E8hn913v;
        "pkg-v21.3.14-1.21.3-NeoForge" = _En6JGAzC;
        "pkg-v21.3.14-1.21.3-Fabric" = _sK7aTG3H;
        "pkg-v21.3.15-1.21.3-NeoForge" = _ByGQRsm7;
        "pkg-v21.3.15-1.21.3-Fabric" = _bB83Shb5;
        "pkg-v21.3.16-1.21.3-NeoForge" = _rqAUTyQ4;
        "pkg-v21.3.16-1.21.3-Fabric" = _4a5xiRoZ;
        "pkg-v21.3.17-1.21.3-NeoForge" = _X81vHfC7;
        "pkg-v21.3.17-1.21.3-Fabric" = _XrmQVAV8;
        "pkg-v21.1.25-1.21.1-NeoForge" = _44daBhBy;
        "pkg-v21.1.25-1.21.1-Fabric" = _CPRIM9lt;
        "pkg-v21.1.26-1.21.1-NeoForge" = _3OGetg4b;
        "pkg-v21.1.26-1.21.1-Fabric" = _BSIrR0oe;
        "pkg-v21.1.27-1.21.1-NeoForge" = _mJojeOp4;
        "pkg-v21.1.27-1.21.1-Fabric" = _bFrzP4L0;
        "pkg-v21.3.21-1.21.3-NeoForge" = _nmKBIVA3;
        "pkg-v21.3.21-1.21.3-Fabric" = _bmmnUUAE;
        "pkg-v21.4.2-1.21.4-NeoForge" = _s6EJH4D2;
        "pkg-v21.4.2-1.21.4-Fabric" = _yzjkADhF;
        "pkg-v21.4.3-1.21.4-NeoForge" = _co4yEU40;
        "pkg-v21.4.3-1.21.4-Fabric" = _XXNy4wk0;
        "pkg-v21.4.4-1.21.4-NeoForge" = _xy2CGexN;
        "pkg-v21.4.4-1.21.4-Fabric" = _uqnldZ9Y;
        "pkg-v21.4.5-1.21.4-Fabric" = _oXl7TbF5;
        "pkg-v21.4.5-1.21.4-NeoForge" = _ODFTdhl8;
        "pkg-v21.4.6-1.21.4-NeoForge" = _hUz1UUcT;
        "pkg-v21.4.6-1.21.4-Fabric" = _Q4Gpl1v2;
        "pkg-v21.4.7-1.21.4-NeoForge" = _3SDAJlfM;
        "pkg-v21.4.7-1.21.4-Fabric" = _MjKblf8q;
        "pkg-v21.4.8-1.21.4-NeoForge" = _yH7okSFY;
        "pkg-v21.4.8-1.21.4-Fabric" = _kzvSJ5nv;
        "pkg-v21.1.28-1.21.1-NeoForge" = _RBxRIqv6;
        "pkg-v21.1.28-1.21.1-Fabric" = _xdMqutdE;
        "pkg-v21.4.9-1.21.4-NeoForge" = _o6kApiAl;
        "pkg-v21.4.9-1.21.4-Fabric" = _JbPZL7gN;
        "pkg-v21.4.10-1.21.4-NeoForge" = _EKX5KtVX;
        "pkg-v21.4.10-1.21.4-Fabric" = _V4N99PoP;
        "pkg-v8.1.28-1.20.1-Forge" = _L2iYITL0;
        "pkg-v8.1.28-1.20.1-Fabric" = _woU56EEG;
        "pkg-v21.1.29-1.21.1-Fabric" = _TgeKUTdi;
        "pkg-v21.1.29-1.21.1-NeoForge" = _qnfV7493;
        "pkg-v8.1.29-1.20.1-Forge" = _pbMkjqgd;
        "pkg-v8.1.29-1.20.1-Fabric" = _6dQXvzl5;
        "pkg-v21.1.30-1.21.1-NeoForge" = _UmQp641s;
        "pkg-v21.1.30-1.21.1-Fabric" = _Xp5RSbEU;
        "pkg-v21.1.32-1.21.1-NeoForge" = _figwuUhN;
        "pkg-v21.1.32-1.21.1-Fabric" = _VVnHCqJQ;
        "pkg-v21.4.12-1.21.4-NeoForge" = _QBayYIMv;
        "pkg-v21.4.12-1.21.4-Fabric" = _3rVDYk1s;
        "pkg-v21.1.33-1.21.1-NeoForge" = _8XnxRpeZ;
        "pkg-v21.1.33-1.21.1-Fabric" = _dPt39j5K;
        "pkg-v21.4.13-1.21.4-NeoForge" = _PI5mXUeA;
        "pkg-v21.4.13-1.21.4-Fabric" = _MITyEk30;
        "pkg-v21.5.1-1.21.5-NeoForge" = _1Cuuw2mJ;
        "pkg-v21.5.1-1.21.5-Fabric" = _7LEKuILd;
        "pkg-v21.5.2-1.21.5-NeoForge" = _WcsAkiu6;
        "pkg-v21.5.2-1.21.5-Fabric" = _yW0xhhnW;
        "pkg-v21.5.3-1.21.5-Fabric" = _gn7fszgY;
        "pkg-v21.5.3-1.21.5-NeoForge" = _eItQKSak;
        "pkg-v21.5.4-1.21.5-NeoForge" = _2S9fXDgU;
        "pkg-v21.5.4-1.21.5-Fabric" = _fVfkpTP8;
        "pkg-v8.1.32-1.20.1-Forge" = _YFZdsqXl;
        "pkg-v8.1.32-1.20.1-Fabric" = _RbcWdHr1;
        "pkg-v21.5.5-1.21.5-NeoForge" = _Cgxg3HQq;
        "pkg-v21.5.5-1.21.5-Fabric" = _7q4pLSuW;
        "pkg-v21.5.6-1.21.5-NeoForge" = _JpnS1lD4;
        "pkg-v21.5.6-1.21.5-Fabric" = _sC28bqgz;
        "pkg-v21.5.9-1.21.5-NeoForge" = _UoMPtyp0;
        "pkg-v21.5.9-1.21.5-Fabric" = _Bu2P97HK;
        "pkg-v21.1.34-1.21.1-Fabric" = _yLd80Jov;
        "pkg-v21.1.34-1.21.1-NeoForge" = _F1SMLyXe;
        "pkg-v21.5.10-1.21.5-NeoForge" = _Cwjx4Ktt;
        "pkg-v21.5.10-1.21.5-Fabric" = _xsg21CnF;
        "pkg-v21.1.36-1.21.1-NeoForge" = _AcwAgaYA;
        "pkg-v21.1.36-1.21.1-Fabric" = _oYPPpKUB;
        "pkg-v21.5.11-1.21.5-NeoForge" = _oe9zYtt5;
        "pkg-v21.5.11-1.21.5-Fabric" = _RC11u2rI;
        "pkg-v21.5.12-1.21.5-NeoForge" = _rIT8qEsZ;
        "pkg-v21.5.12-1.21.5-Fabric" = _r7PWZhLB;
        "pkg-v21.6.0-1.21.6-NeoForge" = _PiaFpEag;
        "pkg-v21.6.0-1.21.6-Fabric" = _mKQ7WAVh;
        "pkg-v21.6.1-1.21.6-NeoForge" = _LhBdXHSW;
        "pkg-v21.6.1-1.21.6-Fabric" = _i7vy7nRG;
        "pkg-v21.6.2-1.21.6-Fabric" = _RC2qHWN3;
        "pkg-v21.6.2-1.21.6-NeoForge" = _Uqpyxk5L;
        "pkg-v21.6.6-1.21.6-NeoForge" = _GxaHBZsU;
        "pkg-v21.6.6-1.21.6-Fabric" = _zE2pkDXA;
        "pkg-v21.7.0-1.21.7-NeoForge" = _8X5V1MMp;
        "pkg-v21.7.0-1.21.7-Fabric" = _sPQhTMzj;
        "pkg-v21.7.1-1.21.7-NeoForge" = _rYHT3iNd;
        "pkg-v21.7.1-1.21.7-Fabric" = _WMZW45pT;
        "pkg-v21.8.0-1.21.8-Fabric" = _r7k5ueTs;
        "pkg-v21.8.0-1.21.8-NeoForge" = _zQ3IIX98;
        "pkg-v21.8.2-1.21.8-Fabric" = _EboZe69Q;
        "pkg-v21.8.2-1.21.8-NeoForge" = _K9ufhi4f;
        "pkg-v21.8.3-1.21.8-Fabric" = _EGKy2PLt;
        "pkg-v21.8.3-1.21.8-NeoForge" = _FdBKE0vH;
        "pkg-v21.1.37-1.21.1-Fabric" = _xFxjvN0q;
        "pkg-v21.1.37-1.21.1-NeoForge" = _qSpAmWns;
        "pkg-v21.8.6-1.21.8-Fabric" = _sYuwlGfN;
        "pkg-v21.8.6-1.21.8-NeoForge" = _f8MCcu3O;
        "pkg-v21.1.38-1.21.1-NeoForge" = _wzY6RY3b;
        "pkg-v21.1.38-1.21.1-Fabric" = _fxxItf4t;
        "pkg-v8.1.33-1.20.1-Forge" = _mIyVGf3d;
        "pkg-v8.1.33-1.20.1-Fabric" = _N8gFdljq;
        "pkg-21.9.1" = _6H8eSPnl;
        "pkg-21.9.2" = _hnKrmcsg;
        "pkg-21.9.3" = _ErgzkDD9;
        "pkg-21.9.4" = _W4cWteM4;
        "pkg-21.9.5" = _SOq2qjXe;
        "pkg-21.10.0" = _tEDtv0i0;
        "pkg-21.10.1" = _1H47JXkY;
        "pkg-21.10.2" = _YKq8dgpA;
        "pkg-21.10.3" = _3Q61n79f;
        "pkg-21.10.4" = _d6FTuYSs;
        "pkg-21.10.5" = _5IsLRCgz;
        "pkg-v20.4.53-1.20.4-Fabric" = _PYkg1A3a;
        "pkg-v20.4.53-1.20.4-Forge" = _x0xYnYOV;
        "pkg-v20.4.53-1.20.4-NeoForge" = _U81E0ABr;
        "pkg-v21.1.39-1.21.1-NeoForge" = _EgWWSAhJ;
        "pkg-v21.1.39-1.21.1-Fabric" = _L007zH3l;
        "pkg-v21.3.25-1.21.3-NeoForge" = _CyRDUXp9;
        "pkg-v21.3.25-1.21.3-Fabric" = _vMKyNIOg;
        "pkg-v21.4.14-1.21.4-NeoForge" = _HOC9OUuE;
        "pkg-v21.4.14-1.21.4-Fabric" = _s2SzGyZz;
        "pkg-v21.5.13-1.21.5-NeoForge" = _b9thQ57Y;
        "pkg-v21.5.13-1.21.5-Fabric" = _25gaMibl;
        "pkg-v21.8.9-1.21.8-Fabric" = _tXTEdgyF;
        "pkg-v21.8.9-1.21.8-NeoForge" = _SmG35tzq;
        "pkg-21.10.7" = _nXoIV92k;
        "pkg-21.10.8" = _cc5UQbCp;
        "pkg-21.11.0" = _EiRrQ5MH;
        "pkg-21.11.1" = _VZKF4wG1;
        "pkg-21.11.2" = _6HTeq0uA;
        "pkg-21.11.3" = _mduzHuXT;
        "pkg-21.11.4" = _papKcBDm;
        "pkg-21.11.6" = _7L1WGsjw;
        "pkg-21.11.10" = _qoxLMKD1;
        "pkg-21.11.11" = _O1SlsQzW;
        "pkg-21.11.12" = _owXZpJai;
        "pkg-26.1.1" = _S9FpoHEJ;
        "pkg-26.1.2" = _ZukDdyJs;
        "pkg-26.1.3" = _hpDvq0QC;
        "pkg-26.1.4" = _bfjhQCaU;
        "pkg-26.1.5" = _bK6230pY;
        "pkg-26.1.6" = _3OADGa7L;
        "pkg-26.1.7" = _CrJuoCTO;
        "pkg-26.1.8" = _ieoedmvp;
        "pkg-v21.1.44-1.21.1-NeoForge" = _uxVsdkST;
        "pkg-v21.1.44-1.21.1-Fabric" = _8lUcewQG;
        "pkg-v21.1.46-1.21.1-NeoForge" = _7IlRqegD;
        "pkg-v21.1.46-1.21.1-Fabric" = _lMaayo2Q;
        "pkg-v21.1.49-1.21.1-Fabric" = _24I0TfgA;
        "pkg-v21.1.49-1.21.1-NeoForge" = _jjxw9Xbe;
        "pkg-v21.1.50-1.21.1-NeoForge" = _T8ql5y0R;
        "pkg-v21.1.50-1.21.1-Fabric" = _qxBzDFcq;
        "pkg-21.11.13" = _xTX7sOwU;
        "pkg-26.1.9" = _cQDipfay;
        "pkg-v21.1.51-1.21.1-Fabric" = _3ADQgPy0;
        "pkg-v21.1.51-1.21.1-NeoForge" = _PRF4qcdp;
        "pkg-26.1.10" = _ye9Zrmh4;
        "pkg-v21.1.52-1.21.1-NeoForge" = _5A6wiMVf;
        "pkg-v21.1.52-1.21.1-Fabric" = _pqCNhF6A;
        "pkg-26.1.11" = _EzXrKtxs;
        "pkg-26.2.0" = _7NdidvUq;
        "pkg-26.2.1" = _HfGQTxSR;
        "pkg-26.1.12" = _A85OttK1;
        "pkg-26.1.13" = _Mm0HmpcL;
        "pkg-26.2.2" = _eI8PIwKt;
