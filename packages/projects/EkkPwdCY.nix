...
let
    versions = (let
        ...
        _gJj05RZN = {
            "id" = "gJj05RZN";
            "file" = "UnionLib-1.20.1-13.0-Fabric.jar";
            "hash" = "sha512-h5HReLazieHPValnI96ypSVcxYxQc/IQb3f2EDquck4U31+PVmf4DfyB7wU7q/vZUVVsDNp/HeTyj5xQwLV+Og==";
        };
        _qyrgV6a6 = {
            "id" = "qyrgV6a6";
            "file" = "UnionLib-1.20.1-13.0-Forge-all.jar";
            "hash" = "sha512-grVQtidu4LS3eI++P+E7a/3LlKqK7kkAYeIGe46q5BesZGkDM2pmknzHYWRhv1JL3cUja87G+rYlARYg0BuiKA==";
        };
        _BNJaVOT0 = {
            "id" = "BNJaVOT0";
            "file" = "UnionLib-1.21.1-13.0-Fabric.jar";
            "hash" = "sha512-T2bCV9bhhsWZtugGV6UOoB5UO6cdq5M+GlMFkfposDY5Kgpmp3il767XZOd0l1A0SNUviDy6psjEvy5XGnsxVg==";
        };
        _CiXTgs4G = {
            "id" = "CiXTgs4G";
            "file" = "UnionLib-1.21.1-13.0-Forge-all.jar";
            "hash" = "sha512-j5NmZUhwPINh8j9f52d77NqWIYGRGrSSkG3qh61Qmh1duudbvObb5may9ECSFRany8UEWAOMkKWWtF+K/W+K3w==";
        };
        _VB2WKgjL = {
            "id" = "VB2WKgjL";
            "file" = "UnionLib-1.21.1-13.0-NeoForge.jar";
            "hash" = "sha512-ehw/tHm62F+ciMoc9FuR/ZQV9Co9yc82MxgKxT11lcRA8yKeJy8IbVdks/f/u0bJkepICJgdSF2tGeMOeCBcaw==";
        };
        _x41XFELA = {
            "id" = "x41XFELA";
            "file" = "UnionLib-26.2-13.0-Fabric.jar";
            "hash" = "sha512-uuIzZHbGOESsywkj9etXSHCIol7VO0h4YYcI2qQqgIJBDBJdDI0//rIQaLzRN/789LNwHMX+clsNyYmuOiwixA==";
        };
        _OnhsgAjj = {
            "id" = "OnhsgAjj";
            "file" = "UnionLib-26.2-13.0-Forge.jar";
            "hash" = "sha512-1mRTMSOO2eKaWYVImPjwkIPwFm+CAdWKY99dMtGCDyLwa37MWcx+XlfWUnqKRYAVGvot8TNmPL4H1sF81XPBhA==";
        };
        _DYr8dHJf = {
            "id" = "DYr8dHJf";
            "file" = "UnionLib-26.2-13.0-NeoForge.jar";
            "hash" = "sha512-aPv0rtxlFzyOWrkrjTIsAYw6fyyKreBOJhr+UzahP0yDpSHbT+W/4Mq9QXWuQrvMWjJ+6VWGjK08NOz+eTWEEA==";
        };
        _TZdP1RuC = {
            "id" = "TZdP1RuC";
            "file" = "UnionLib-1.20.1-13.1-Fabric.jar";
            "hash" = "sha512-YRrHjcGFDvtvvx7OntPZnjkAj4DLOW16/ql6bm+FDqk9us4HlkAgp9sZsvMCieJkE/cVfG4Zrdw/nFQJppXPyA==";
        };
        _s4b7ugMD = {
            "id" = "s4b7ugMD";
            "file" = "UnionLib-1.20.1-13.1-Forge-all.jar";
            "hash" = "sha512-sO8DoSXqDolFykTHpDjE0fpuN+/1NgJjBaKi50AVmSMTOQr5mfWZt+MjBTmZq1hiuCDIJ5Sjp9BWpsEhcwSKQw==";
        };
        _my6hWX66 = {
            "id" = "my6hWX66";
            "file" = "UnionLib-1.21.1-13.1-Fabric.jar";
            "hash" = "sha512-+Gsu91VnRDrCOpWOVSIU5Xwue3J+1nSLJpkFR3uaZBXlnWWqJDk/XsNmpPZC1c/Up18j40A1Ggk2j11AY9e5OQ==";
        };
        _VuiwwsGQ = {
            "id" = "VuiwwsGQ";
            "file" = "UnionLib-1.21.1-13.1-Forge-all.jar";
            "hash" = "sha512-MecUxkcGVu52DlCVJDrJ3i/en4Rb//2l84e4c2hNjeJ7crNLzhhyMdqGJWf2uew5o8XLRnWZGPdx2k0P5l5mcQ==";
        };
        _3efgw17f = {
            "id" = "3efgw17f";
            "file" = "UnionLib-1.21.1-13.1-NeoForge.jar";
            "hash" = "sha512-MrIJ04aJoqYJQmNcW7KmJdvSuBlRpFBSeQBFNAvSZlB28Q2Ai/rLCPDIjh5stWOz9P2KEmV5thaaL3WAzPSIWA==";
        };
        _lPxc9fjb = {
            "id" = "lPxc9fjb";
            "file" = "UnionLib-26.2-13.1-Fabric.jar";
            "hash" = "sha512-jGwJsiJe+A6k8Suvi3sLznTYl2sSsu7b96o4GgvsAghDmj7qUL4PuvOnfSyXqKmRK1LPWifxL29PUHSEjIvypg==";
        };
        _QnV271zw = {
            "id" = "QnV271zw";
            "file" = "UnionLib-26.2-13.1-Forge.jar";
            "hash" = "sha512-rjSWV22WtbF2VJ8ghbli1PenWLz37rVDZmwmNvJiZxkU7dFMAJYaNcxpzecl1T+r8ZtUKmR+2LnsZCzNMt0NTA==";
        };
        _DFcPruQZ = {
            "id" = "DFcPruQZ";
            "file" = "UnionLib-26.2-13.1-NeoForge.jar";
            "hash" = "sha512-mNj9mpv3HbHf9FJqZ188wxdgQdtq5wrDubirMcthBIk3VrkNNghpkHeZgv9ucWNeia3rfTJSF0vKAsxAhRpTIQ==";
        };
        _3iICyeZa = {
            "id" = "3iICyeZa";
            "file" = "UnionLib-1.20.1-13.2-Fabric.jar";
            "hash" = "sha512-7pp04j5BX9rIS6MeLGU4oO7veEhtj9o02xPlitTb3ODRTaWH8xmK22wKXDDlVZ1yCRukJUDyQFSfipqDPZ2s5g==";
        };
        _ew2ARS1V = {
            "id" = "ew2ARS1V";
            "file" = "UnionLib-1.20.1-13.2-Forge-all.jar";
            "hash" = "sha512-vLxCs/ZUz+CGxELkt+px4idml7HboG2ySqfnWovfMrtJ9xRTkYriypndYI9cE5g9YSFoaWg2s89ZZxy4gVJqYw==";
        };
        _yyfdRIeC = {
            "id" = "yyfdRIeC";
            "file" = "UnionLib-1.21.1-13.2-Fabric.jar";
            "hash" = "sha512-vkFrvIVPX6Rx4NWYDR5FNqvdoLyfaRQcYYesWbpxSGI2kpNFrOOXDebJ3k1HQnpDpos4kn4/i7EdJnDv/+S87Q==";
        };
        _KJ6nTxny = {
            "id" = "KJ6nTxny";
            "file" = "UnionLib-1.21.1-13.2-Forge-all.jar";
            "hash" = "sha512-ukPq/5fy7YYv4UU1XwylNBBWZMit2cKzX5m+QYtEe9tw2f+5bTkLckg8CHUXFUdYcBDCKo8BkCcYLEYqsu13gA==";
        };
        _vJM7xpF3 = {
            "id" = "vJM7xpF3";
            "file" = "UnionLib-1.21.1-13.2-NeoForge.jar";
            "hash" = "sha512-J5QSFAiw2YTyrkpd0wUbHgQp8r16C+yUN/ue04S22AWbWsv8bqOtEmDjNSHx4NLGOt6WVqwrP7NliP3g3XbpGQ==";
        };
        _9STJKE6d = {
            "id" = "9STJKE6d";
            "file" = "UnionLib-26.2-13.2-Fabric.jar";
            "hash" = "sha512-0GkFPpszlmg3rLoxE5pBjU2psIdVpvTvz1iAXgoTclcPxYyPx4DXghEta0ziUe33s2vegdrxPt/9lVoi2fQDCA==";
        };
        _NigKI0S5 = {
            "id" = "NigKI0S5";
            "file" = "UnionLib-26.2-13.2-Forge.jar";
            "hash" = "sha512-5ixFudDSWAztVjHPAznVF7Ca8XsXl8So/aoJG6C9iiitZ0tRAawzddnQ/owMpEqWGFX5y8lef6Ky6PVmtcm5tQ==";
        };
        _60i3ur7q = {
            "id" = "60i3ur7q";
            "file" = "UnionLib-26.2-13.2-NeoForge.jar";
            "hash" = "sha512-CUCr7GJ4B/EhjNC4JDPAzBc1vxDyooi0PHNpxYsz31GGF9sg/xp3iYvsARIaQGBbozjJJQJWoEMr4RTOw2jb6Q==";
        };
        _YJcaI7kN = {
            "id" = "YJcaI7kN";
            "file" = "UnionLib-1.20.1-13.3-Fabric.jar";
            "hash" = "sha512-tOwQFShc2CWqLYJ5deUlO2nb8/7r/q/fLTfMYbtVq4bzbmrqt/TNnte5+7nXIyeM+xDRmhEZUt5VxdvQ1hHLQg==";
        };
        _H38qSkPd = {
            "id" = "H38qSkPd";
            "file" = "UnionLib-1.20.1-13.3-Forge-all.jar";
            "hash" = "sha512-H8UKdLBjHnFwNm2HY/7fKIHZmICqhovGUk3HODS8+8zA7c6buOXnjlXStISRef/SmqML2hSESNJSbj0ZVQLNXw==";
        };
        _FFmwNLge = {
            "id" = "FFmwNLge";
            "file" = "UnionLib-1.21.1-13.3-Fabric.jar";
            "hash" = "sha512-UrLb0AiebAqIO9K8ihujo03VtNU6o1Qhyz/kWe83dgsgKFlDaNNt0s30Xy3hm52MatehbHWkSMtrB390wFPZjg==";
        };
        _FipRQ3od = {
            "id" = "FipRQ3od";
            "file" = "UnionLib-1.21.1-13.3-Forge-all.jar";
            "hash" = "sha512-ipbrdJqkq3UlDM21+mP646KT0lGJn+aLrPt7iUWVcNxoIm5jEf5id841bnPth2YSqQSTMp+F6FAkhDJ8pszesQ==";
        };
        _pczRnFkr = {
            "id" = "pczRnFkr";
            "file" = "UnionLib-1.21.1-13.3-NeoForge.jar";
            "hash" = "sha512-YJUa+Ip7fzczYoT4gDk7yDmJUWa3c6zdPGfzfkmkD0I+hwcCEahstpp+Qtw+anYjA4AQwwavNKo7WUkDVODreg==";
        };
        _vRh03X9e = {
            "id" = "vRh03X9e";
            "file" = "UnionLib-26.2-13.3-Fabric.jar";
            "hash" = "sha512-YseLdRE9uUkECTK4DHDqmFlF2kLOrpTCzfCn4wYZ5yWS1AJxl9q6VS1UB+lHztEbZUM2viwlPZVMDOQ0BcOpFg==";
        };
        _fPRFIPwB = {
            "id" = "fPRFIPwB";
            "file" = "UnionLib-26.2-13.3-Forge.jar";
            "hash" = "sha512-DsCdhIyl2J18K8EJ0aBsprjE66/nQyIlUFasad5bmbP2SK3rcVR2SPI8aeH/b/4oZbtRePpkECO5f5opi3WTpg==";
        };
        _SJPTjqXN = {
            "id" = "SJPTjqXN";
            "file" = "UnionLib-26.2-13.3-NeoForge.jar";
            "hash" = "sha512-po55czvSXzsVmRovc499+dZPlFY3PDt4S9eFkGAZD1hoD53PJVQUFL+eiXiDy2ix6UAQSBkdHheOOYuYKT9sUA==";
        };
    in {
        "gMKw81jZ" = _gMKw81jZ;
        "NsMBnF7B" = _NsMBnF7B;
        ...
        "forge-1.20.1" = _H38qSkPd;
        "forge-1.18.2" = _XvUIz2HF;
        "forge-1.20.6" = _IsjpYAqg;
        "forge-1.21" = _FipRQ3od;
        "forge-1.21.1" = _FipRQ3od;
        "forge-1.16.1" = _BqjtpV7K;
        "forge-26.2" = _fPRFIPwB;
        "fabric-1.19.3" = _igR8mvjf;
        "fabric-1.19.2" = _5r44WcyX;
        "fabric-1.20.1" = _YJcaI7kN;
        "fabric-1.19" = _5r44WcyX;
        "fabric-1.19.1" = _5r44WcyX;
        "fabric-1.20.6" = _1iVWodp7;
        "fabric-1.21" = _FFmwNLge;
        "fabric-1.21.1" = _FFmwNLge;
        "fabric-1.21.11" = _Ok6rYGWT;
        "fabric-26.2" = _vRh03X9e;
        "neoforge-1.20.6" = _cVV4KWdX;
        "neoforge-1.21" = _pczRnFkr;
        "neoforge-1.21.1" = _pczRnFkr;
        "neoforge-1.20.1" = _H38qSkPd;
        "neoforge-1.21.10" = _lGOnDo0u;
        "neoforge-1.21.11" = _LBcc4DDI;
        "neoforge-26.2" = _SJPTjqXN;
        "quilt-1.21" = _FFmwNLge;
        "quilt-1.21.1" = _FFmwNLge;
        "quilt-1.20.6" = _1iVWodp7;
        "quilt-1.20.1" = _YJcaI7kN;
        "quilt-1.21.11" = _Ok6rYGWT;
        "quilt-26.2" = _vRh03X9e;
        "pkg-1.19.3-8.0.0-Forge" = _gMKw81jZ;
        "pkg-1.19.3-8.0.1-Forge" = _NsMBnF7B;
        "pkg-1.19.3-8.0.2-Forge" = _wHGq1ZTS;
        "pkg-1.19.3-8.0.3-Forge" = _hhgG6h2J;
        "pkg-1.19.3-8.0.4-Forge" = _Bf9RxBle;
        "pkg-1.19.3-8.0.5-Forge" = _LJIldqKo;
        "pkg-1.19.3-8.0.0-Fabric" = _N0j7MhH1;
        "pkg-1.19.2-8.0.0.1-Fabric" = _32Up78QW;
        "pkg-1.19.3-8.0.1-Fabric" = _O9NnDXVT;
        "pkg-1.19.2-8.0.1.1-Fabric" = _qhhsjvi3;
        "pkg-1.19.3-8.0.6-Forge" = _k5V7AVso;
        "pkg-1.19.3-8.0.7-Forge" = _hqTQTtGn;
        "pkg-1.19.3-8.0.8-Forge" = _T9PXlbkz;
        "pkg-1.19.3-8.0.9-Forge" = _rRYjM1KG;
        "pkg-1.19.4-9.0.0-Forge" = _amBHWrSB;
        "pkg-1.19.3-9.0.0.1-Forge" = _nqrcb3dj;
        "pkg-1.19.4-9.0.1-Forge" = _1gZYHLpG;
        "pkg-1.19.3-9.0.1.1-Forge" = _axJHOBZ5;
        "pkg-1.19.2-9.0.1.1-Forge" = _yFVHlUpq;
        "pkg-1.19.4-9.0.2-Forge" = _DBSeHtVR;
        "pkg-1.19.3-9.0.2.1-Forge" = _uCfkMgFj;
        "pkg-1.19.2-9.0.2.1-Forge" = _9BVGKpOW;
        "pkg-1.19.4-9.0.3-Forge" = _DOuXPqhm;
        "pkg-1.19.3-9.0.3.1-Forge" = _2h1AOVSF;
        "pkg-1.19.2-9.0.3.1-Forge" = _8ENp5psK;
        "pkg-1.19.4-9.0.4-Forge" = _zIK8KHC3;
        "pkg-1.19.3-9.0.4-Forge" = _r9vIY69Z;
        "pkg-1.19.2-9.0.4.1-Forge" = _NXkpzuBl;
        "pkg-1.20-10.0.0-Forge" = _k1SZoVSx;
        "pkg-1.19.4-10.0.0-Forge" = _YAvlUZaI;
        "pkg-1.19.3-10.0.0-Forge" = _6TjTS4Hk;
        "pkg-1.20.1-10.0.0-Forge" = _fd9jufUe;
        "pkg-1.20.1-10.0.1-Forge" = _iEGqxfut;
        "pkg-1.19.4-10.0.1-Forge" = _HsMciZcR;
        "pkg-1.19.3-10.0.1-Forge" = _oWdJ9LCP;
        "pkg-1.19.2-10.0.1-Forge" = _AHaIkwJ8;
        "pkg-7.2.3" = _XvUIz2HF;
        "pkg-1.20.1-10.1.0-Fabric" = _lduWSARR;
        "pkg-1.19.2-10.1.0-Forge" = _wkLfPNjQ;
        "pkg-1.19.3-10.1.0-Forge" = _hSQhXyjv;
        "pkg-1.19.3-10.1.0-Fabric" = _qfy3dL5Z;
        "pkg-1.19.4-10.1.0-Forge" = _i2tr2hFH;
        "pkg-1.20.1-10.1.0-Forge" = _AyHfEXgw;
        "pkg-1.19.2-10.1.1-Forge" = _B10oJVh7;
        "pkg-1.19.3-10.1.1-Forge" = _2DXSy1se;
        "pkg-1.19.4-10.1.1-Forge" = _IYLN40oz;
        "pkg-1.20.1-10.1.1-Forge" = _peEvEAvd;
        "pkg-1.19.2-10.1.1-Fabric" = _5GidK9vF;
        "pkg-1.19.3-10.1.1-Fabric" = _ujU58Qdo;
        "pkg-1.20.1-10.1.1-Fabric" = _d0reEVQx;
        "pkg-1.19.2-10.2.0-Forge" = _70yyFb71;
        "pkg-1.19.3-10.2.0-Forge" = _TISjpHKU;
        "pkg-1.19.4-10.2.0-Forge" = _9G53b72G;
        "pkg-1.19.2-10.2.0-Fabric" = _yqpqB7PP;
        "pkg-1.19.3-10.2.0-Fabric" = _hN7SIwMa;
        "pkg-1.20.1-10.2.0-Fabric" = _k5m4veQ8;
        "pkg-1.20.1-10.2.0-Forge" = _aPJvl5XE;
        "pkg-1.19.2-10.2.1-Forge" = _KEYbII0B;
        "pkg-1.19.3-10.2.1-Forge" = _Tw4AbR2H;
        "pkg-1.19.4-10.2.1-Forge" = _vgdg9a5g;
        "pkg-1.19.2-10.2.1-Fabric" = _kLedD0Ur;
        "pkg-1.19.3-10.2.1-Fabric" = _Cpt8KaUu;
        "pkg-1.20.1-10.2.1-Forge" = _5J8h3kKU;
        "pkg-1.20.1-10.2.1-Fabric" = _iNJ10Oef;
        "pkg-1.19.2-10.2.2-Fabric" = _mcUiiUoD;
        "pkg-1.19.3-10.2.2-Fabric" = _l0c6xBPU;
        "pkg-1.19.2-10.2.2-Forge" = _Hkmn2w8y;
        "pkg-1.19.3-10.2.2-Forge" = _He3XQEPQ;
        "pkg-1.19.4-10.2.2-Forge" = _IyguWnRd;
        "pkg-1.20.1-10.2.2-Fabric" = _OlJw2Ow0;
        "pkg-1.20.1-10.2.2-Forge" = _BtRlIXaT;
        "pkg-1.19.2-10.2.3-Fabric" = _kmjZ0l21;
        "pkg-1.19.3-10.2.3-Fabric" = _iD7bxGna;
        "pkg-1.20.1-10.2.3-Fabric" = _NCNVp27c;
        "pkg-1.20.1-10.2.4-Forge" = _f7unjDsD;
        "pkg-1.19.2-10.2.5-Forge" = _cUbqe1RI;
        "pkg-1.19.3-10.2.5-Forge" = _wjVwaVgr;
        "pkg-1.19.4-10.2.5-Forge" = _FDTGcI9K;
        "pkg-1.19.2-10.2.5-Fabric" = _sQoyKIHd;
        "pkg-1.19.3-10.2.5-Fabric" = _6jjQphus;
        "pkg-1.20.1-10.2.5-Fabric" = _HfJSSt5U;
        "pkg-1.20.1-10.2.5-Forge" = _yoSqbzxs;
        "pkg-1.20.6-11.0.0-Forge" = _xZaIFucO;
        "pkg-1.20.6-11.0.1-Forge" = _BBXBjgN2;
        "pkg-1.20.6-11.0.2-Neoforge" = _IBNE2Awz;
        "pkg-1.20.6-11.0.2-Forge" = _quEI3L9Q;
        "pkg-1.20.6-11.0.3-Fabric" = _8ropZ57L;
        "pkg-1.20.6-11.0.3-Forge" = _j6nyi93T;
        "pkg-1.20.6-11.0.3-NeoForge" = _1tI94Ge9;
        "pkg-1.20.6-11.0.4-Fabric" = _oEVDeape;
        "pkg-1.20.6-11.0.5-Fabric" = _qBsVCp6V;
        "pkg-1.20.6-11.0.5-NeoForge" = _uFlGseL2;
        "pkg-1.20.6-11.0.5-Forge" = _OeAAiZdF;
        "pkg-1.20.6-11.0.6-Forge" = _wj84uV1w;
        "pkg-1.20.6-11.0.6-Fabric" = _3byMJyai;
        "pkg-1.20.6-11.0.6-NeoForge" = _BNzl7ZGu;
        "pkg-1.20.6-12.0.0-NeoForge" = _qyQjCli9;
        "pkg-1.21-12.0.0-NeoForge" = _rFeFTj7f;
        "pkg-1.20.6-12.0.1-Forge" = _V3pEK3BT;
        "pkg-1.20.6-12.0.1-NeoForge" = _kfzxXpQV;
        "pkg-1.21-12.0.1-NeoForge" = _f5t7n7cL;
        "pkg-1.21-12.0.1-Forge" = _5Pg0O5Yv;
        "pkg-1.20.6-12.0.1-Fabric" = _wmqxUnub;
        "pkg-1.21-12.0.1-Fabric" = _Ebmniag7;
        "pkg-1.20.6-12.0.2-Fabric" = _6XXRk0zx;
        "pkg-1.20.6-12.0.2-Forge" = _PAyf5Ien;
        "pkg-1.20.6-12.0.2-NeoForge" = _PvBRMgdR;
        "pkg-1.21-12.0.2-Fabric" = _fg2TtIx6;
        "pkg-1.21-12.0.2-Forge" = _SVSgUbFZ;
        "pkg-1.21-12.0.2-NeoForge" = _4PaiiEc5;
        "pkg-1.20.1-10.2.6-Forge" = _ibFB2yYJ;
        "pkg-1.20.6-12.0.3-Fabric" = _v3DIxOfW;
        "pkg-1.20.6-12.0.3-Forge" = _ffRW61ft;
        "pkg-1.20.6-12.0.3-NeoForge" = _djeGjnua;
        "pkg-1.21-12.0.3-Fabric" = _nujjiW9j;
        "pkg-1.21-12.0.3-Forge" = _5osyNTEF;
        "pkg-1.21-12.0.3-NeoForge" = _qQZ8aWaP;
        "pkg-1.20.6-12.0.4-Forge" = _FvHfXT7S;
        "pkg-1.20.6-12.0.4-Fabric" = _6ylbNI06;
        "pkg-1.20.6-12.0.4-NeoForge" = _oR2PdsF9;
        "pkg-1.21-12.0.4-Fabric" = _TDYPRE7M;
        "pkg-1.21-12.0.4-Forge" = _LngFCQfR;
        "pkg-1.21-12.0.4-NeoForge" = _1oKK6bhG;
        "pkg-1.20.6-12.0.5-NeoForge" = _pM4dxoI7;
        "pkg-1.20.6-12.0.5-Forge" = _j5uRuYUm;
        "pkg-1.20.6-12.0.5-Fabric" = _HRMqY9Sl;
        "pkg-1.21.1-12.0.5-Fabric" = _1Rw5MhS7;
        "pkg-1.21.1-12.0.5-Forge" = _W30rqa1G;
        "pkg-1.21.1-12.0.5-NeoForge" = _za79WNro;
        "pkg-1.20.6-12.0.6-Fabric" = _NNb9MGwK;
        "pkg-1.21.1-12.0.6-Fabric" = _DTVwytxo;
        "pkg-1.20.6-12.0.6-NeoForge" = _xUi9xVFN;
        "pkg-1.21.1-12.0.6-NeoForge" = _OpCVi9cc;
        "pkg-1.20.6-12.0.6-Forge" = _bg9cTzxL;
        "pkg-1.21.1-12.0.6-Forge" = _HYBGmltr;
        "pkg-1.21.1-12.0.7-Fabric" = _6HsxIYUs;
        "pkg-1.20.6-12.0.7-Fabric" = _U0GtH1e0;
        "pkg-1.20.6-12.0.7-NeoForge" = _pABJIiqw;
        "pkg-1.21.1-12.0.7-NeoForge" = _2PrWwWCy;
        "pkg-1.20.6-12.0.7-Forge" = _KuuBpbs6;
        "pkg-1.21.1-12.0.7-Forge" = _gmT1NQWB;
        "pkg-1.19.2-10.2.6-Fabric" = _5r44WcyX;
        "pkg-1.19.3-10.2.6-Fabric" = _igR8mvjf;
        "pkg-1.19.2-10.2.6-Forge" = _ND5fhJtB;
        "pkg-1.19.3-10.2.6-Forge" = _IPkVukh8;
        "pkg-1.19.4-10.2.6-Forge" = _Wb04hpiv;
        "pkg-1.20.6-12.0.8-NeoForge" = _lwuNaTrg;
        "pkg-1.20.6-12.0.8-Forge" = _nIKFVSeW;
        "pkg-1.20.6-12.0.8-Fabric" = _DUkvgkF2;
        "pkg-1.21.1-12.0.8-NeoForge" = _M0OJ35Pf;
        "pkg-1.21.1-12.0.8-Forge" = _klfRtSEf;
        "pkg-1.21.1-12.0.8-Fabric" = _yKtGy2jg;
        "pkg-1.21.1-12.0.9-NeoForge" = _x7L8xqF3;
        "pkg-1.21.1-12.0.9-Fabric" = _WOlAyoaA;
        "pkg-1.21.1-12.0.9-Forge" = _CzoImHTt;
        "pkg-1.20.1-10.2.7-Forge" = _x5FjXoS2;
        "pkg-1.16.1-3.3.7" = _BqjtpV7K;
        "pkg-1.20.6-12.0.9-Fabric" = _tp33FhSd;
        "pkg-1.20.1-12.0.9-Fabric" = _W8znmb4n;
        "pkg-1.20.6-12.0.9-Forge" = _WzBl30QI;
        "pkg-1.20.6-12.0.9-NeoForge" = _5LH6vrL9;
        "pkg-1.20.1-12.0.10-Fabric" = _1qXiwvna;
        "pkg-1.20.6-12.0.10-Fabric" = _jkP9XIGw;
        "pkg-1.20.6-12.0.10-NeoForge" = _jgRytBp8;
        "pkg-1.21.1-12.0.10-Fabric" = _g4zUwayD;
        "pkg-1.21.1-12.0.10-NeoForge" = _sGMDUxkp;
        "pkg-1.20.6-12.0.10-Forge" = _6k6Hx96E;
        "pkg-1.21.1-12.0.10-Forge" = _Wshr1Hbj;
        "pkg-1.20.1-12.0.11-Fabric" = _wfZvOOfG;
        "pkg-1.20.6-12.0.11-Fabric" = _kcSLg3oD;
        "pkg-1.21.1-12.0.11-Fabric" = _i9v23kas;
        "pkg-1.20.6-12.0.11-Forge" = _YAWRBhEg;
        "pkg-1.21.1-12.0.11-Forge" = _dwX2dnX3;
        "pkg-1.20.6-12.0.11-NeoForge" = _OerJGYpD;
        "pkg-1.21.1-12.0.11-NeoForge" = _yN3HIYua;
        "pkg-1.20.1-12.0.12-Fabric" = _qXbl50jW;
        "pkg-1.20.6-12.0.12-Fabric" = _ZOesOaXY;
        "pkg-1.21.1-12.0.12-Fabric" = _XGD0PyLG;
        "pkg-1.20.1-12.0.12-Forge" = _pJjIFWhv;
        "pkg-1.20.6-12.0.12-Forge" = _KmeycFfX;
        "pkg-1.21.1-12.0.12-Forge" = _Hvl3XamS;
        "pkg-1.20.6-12.0.12-NeoForge" = _rwnr0JqQ;
        "pkg-1.21.1-12.0.12-NeoForge" = _vZE1xj9o;
        "pkg-1.20.1-12.0.13-Fabric" = _hbNw1xAJ;
        "pkg-1.20.6-12.0.13-Fabric" = _7oX9nY7O;
        "pkg-1.21.1-12.0.13-Fabric" = _p7sPGXia;
        "pkg-1.20.1-12.0.13-Forge" = _jQ1gFlsW;
        "pkg-1.20.6-12.0.13-Forge" = _RLz4b0fa;
        "pkg-1.21.1-12.0.13-Forge" = _V3DINreY;
        "pkg-1.20.6-12.0.13-NeoForge" = _W934nT5f;
        "pkg-1.21.1-12.0.13-NeoForge" = _eEoyEiKg;
        "pkg-1.20.1-12.0.14-Fabric" = _LoJKE6v0;
        "pkg-1.20.6-12.0.14-Fabric" = _JS4tOUfn;
        "pkg-1.20.6-12.0.14-Forge" = _3y1PJ0bY;
        "pkg-1.20.6-12.0.14-NeoForge" = _KM5ywSeC;
        "pkg-1.21.1-12.0.14-Fabric" = _MWEarmBv;
        "pkg-1.21.1-12.0.14-Forge" = _dtysbLZu;
        "pkg-1.21.1-12.0.14-NeoForge" = _dBJaO0P8;
        "pkg-1.20.1-12.0.14-Forge" = _d0DcwzpW;
        "pkg-1.20.1-12.0.15-Fabric" = _FHIApn5x;
        "pkg-1.20.1-12.0.15-Forge" = _DfgZ7ytY;
        "pkg-1.20.6-12.0.15-Fabric" = _pDpcBbtI;
        "pkg-1.20.6-12.0.15-Forge" = _2DGV3xhG;
        "pkg-1.20.6-12.0.15-NeoForge" = _1TZoc89k;
        "pkg-1.21.1-12.0.15-Fabric" = _Da4j9itd;
        "pkg-1.21.1-12.0.15-Forge" = _BoGnFWj0;
        "pkg-1.21.1-12.0.15-NeoForge" = _pRTcPhHI;
        "pkg-1.20.1-12.0.16-Fabric" = _c6t7MaRF;
        "pkg-1.20.1-12.0.16-Forge" = _S5cDlIE7;
        "pkg-1.20.6-12.0.16-Fabric" = _SV2OYjqX;
        "pkg-1.20.6-12.0.16-Forge" = _itP7nQYw;
        "pkg-1.20.6-12.0.16-NeoForge" = _6iVbLKXA;
        "pkg-1.21.1-12.0.16-Fabric" = _Vxs0J30H;
        "pkg-1.21.1-12.0.16-Forge" = _7wyvbKly;
        "pkg-1.21.1-12.0.16-NeoForge" = _FCUVG6OB;
        "pkg-1.20.1-12.0.17-Fabric" = _52m54x35;
        "pkg-1.20.1-12.0.17-Forge" = _eb2hSwT1;
        "pkg-1.20.6-12.0.17-Fabric" = _RBRCkc92;
        "pkg-1.20.6-12.0.17-Forge" = _Ccs6GbEE;
        "pkg-1.20.6-12.0.17-NeoForge" = _qGHEAeyl;
        "pkg-1.21.1-12.0.17-Fabric" = _dvKmMfmm;
        "pkg-1.21.1-12.0.17-Forge" = _Wq2NIAzy;
        "pkg-1.21.1-12.0.17-NeoForge" = _RfvfGKWC;
        "pkg-1.20.1-12.0.18-Fabric" = _dqC4hH1g;
        "pkg-1.20.1-12.0.18-Forge" = _b3SZJ0AS;
        "pkg-1.20.6-12.0.18-Fabric" = _Klcfz8xS;
        "pkg-1.20.6-12.0.18-NeoForge" = _g9AS04AL;
        "pkg-1.21.1-12.0.18-Fabric" = _ZdGIJzgS;
        "pkg-1.20.6-12.0.18-Forge" = _jzHS86ib;
        "pkg-1.21.1-12.0.18-Forge" = _EPRKhYI6;
        "pkg-1.21.1-12.0.18-NeoForge" = _apj1lnco;
        "pkg-1.20.1-12.1.0-Fabric" = _TnVPgZRF;
        "pkg-1.20.1-12.1.0-Forge" = _CUVZ1RgX;
        "pkg-1.20.6-12.1.0-Fabric" = _tkRixaAo;
        "pkg-1.20.6-12.1.0-Forge" = _V77bIdsT;
        "pkg-1.20.6-12.1.0-NeoForge" = _ziDHCAvd;
        "pkg-1.21.1-12.1.0-Fabric" = _TDww2IKG;
        "pkg-1.21.1-12.1.0-Forge" = _zouRNURm;
        "pkg-1.21.1-12.1.0-NeoForge" = _aB9OnCuP;
        "pkg-1.20.1-12.1.1-Fabric" = _o1S1mxJO;
        "pkg-1.20.1-12.1.1-Forge" = _bNaZIvDD;
        "pkg-1.20.6-12.1.1-Fabric" = _iizGPGeG;
        "pkg-1.20.6-12.1.1-Forge" = _3MHOT4oY;
        "pkg-1.20.6-12.1.1-NeoForge" = _s3ahdNyn;
        "pkg-1.21.1-12.1.1-Fabric" = _5Z24KZEv;
        "pkg-1.21.1-12.1.1-Forge" = _fcEDc2QE;
        "pkg-1.21.1-12.1.1-NeoForge" = _kKkuFRXB;
        "pkg-1.20.1-12.2-Fabric" = _v4JVbuL9;
        "pkg-1.20.1-12.2-Forge" = _7UFK0RCj;
        "pkg-1.20.6-12.2-Fabric" = _1iVWodp7;
        "pkg-1.20.6-12.2-Forge" = _IsjpYAqg;
        "pkg-1.20.6-12.2-NeoForge" = _cVV4KWdX;
        "pkg-1.21.1-12.2-Fabric" = _S2TeDDAU;
        "pkg-1.21.1-12.2-Forge" = _hUikrKhj;
        "pkg-1.21.1-12.2-NeoForge" = _OTfDJr7z;
        "pkg-1.21.11-12.2-Fabric" = _Ok6rYGWT;
        "pkg-1.21.10-12.2-NeoForge" = _lGOnDo0u;
        "pkg-1.21.11-12.2-NeoForge" = _LBcc4DDI;
        "pkg-1.20.1-13.0-Fabric" = _gJj05RZN;
        "pkg-1.20.1-13.0-Forge" = _qyrgV6a6;
        "pkg-1.21.1-13.0-Fabric" = _BNJaVOT0;
        "pkg-1.21.1-13.0-Forge" = _CiXTgs4G;
        "pkg-1.21.1-13.0-NeoForge" = _VB2WKgjL;
        "pkg-26.2-13.0-Fabric" = _x41XFELA;
        "pkg-26.2-13.0-Forge" = _OnhsgAjj;
        "pkg-26.2-13.0-NeoForge" = _DYr8dHJf;
        "pkg-1.20.1-13.1-Fabric" = _TZdP1RuC;
        "pkg-1.20.1-13.1-Forge" = _s4b7ugMD;
        "pkg-1.21.1-13.1-Fabric" = _my6hWX66;
        "pkg-1.21.1-13.1-Forge" = _VuiwwsGQ;
        "pkg-1.21.1-13.1-NeoForge" = _3efgw17f;
        "pkg-26.2-13.1-Fabric" = _lPxc9fjb;
        "pkg-26.2-13.1-Forge" = _QnV271zw;
        "pkg-26.2-13.1-NeoForge" = _DFcPruQZ;
        "pkg-1.20.1-13.2-Fabric" = _3iICyeZa;
        "pkg-1.20.1-13.2-Forge" = _ew2ARS1V;
        "pkg-1.21.1-13.2-Fabric" = _yyfdRIeC;
        "pkg-1.21.1-13.2-Forge" = _KJ6nTxny;
        "pkg-1.21.1-13.2-NeoForge" = _vJM7xpF3;
        "pkg-26.2-13.2-Fabric" = _9STJKE6d;
        "pkg-26.2-13.2-Forge" = _NigKI0S5;
        "pkg-26.2-13.2-NeoForge" = _60i3ur7q;
        "pkg-1.20.1-13.3-Fabric" = _YJcaI7kN;
        "pkg-1.20.1-13.3-Forge" = _H38qSkPd;
        "pkg-1.21.1-13.3-Fabric" = _FFmwNLge;
        "pkg-1.21.1-13.3-Forge" = _FipRQ3od;
        "pkg-1.21.1-13.3-NeoForge" = _pczRnFkr;
        "pkg-26.2-13.3-Fabric" = _vRh03X9e;
        "pkg-26.2-13.3-Forge" = _fPRFIPwB;
        "pkg-26.2-13.3-NeoForge" = _SJPTjqXN;
        "default" = _SJPTjqXN;
    });
