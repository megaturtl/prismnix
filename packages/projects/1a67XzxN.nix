...
let
    versions = (let
        ...
        _AZArPttx = {
            "id" = "AZArPttx";
            "file" = "hearts_purple-1.1.0-mc26.3.zip";
            "hash" = "sha512-zGOQ1Rna/OTw1eNaDc+yFeHvbCKeSXa8CL0CbrPKEfn5rs5pLhtjjRoqSXkiSuZ4z09bReREuEuQh2JnlMgltw==";
        };
    in {
        "OVtOHAHT" = _OVtOHAHT;
        "RKy32PvS" = _RKy32PvS;
