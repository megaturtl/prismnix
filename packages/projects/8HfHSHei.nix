...
let
    versions = (let
        ...
        _UNF5L66G = {
            "id" = "UNF5L66G";
            "file" = "MaxClear-4.1.0.jar";
            "hash" = "sha512-+6k3ZQYIpbbTA3f2dbylOKCcm6U7/gHJt2j9nwCmLrVUauulstupdJo/2GXpUNl4tUKs9EidnnGT0q8AQ+izjA==";
        };
        _mPzvIspS = {
            "id" = "mPzvIspS";
            "file" = "MaxClear-4.1.1.jar";
            "hash" = "sha512-/9O7a2/JSrJlCIDdqg+vgFQk5SboyN9fc5UxAw4DPG5dcRQFnzMfhrCWmncBbhExQsPf99psNdky4fuyXkIpaA==";
        };
    in {
        "1HjjrBBs" = _1HjjrBBs;
        "7WYrcSM9" = _7WYrcSM9;
        ...
        "UNF5L66G" = _UNF5L66G;
        "mPzvIspS" = _mPzvIspS;
        "paper-1.21.5" = _mPzvIspS;
        "paper-1.21.6" = _mPzvIspS;
        "paper-1.21.7" = _mPzvIspS;
        "paper-1.21.8" = _mPzvIspS;
        "paper-1.21" = _mPzvIspS;
        "paper-1.21.1" = _mPzvIspS;
        "paper-1.21.2" = _mPzvIspS;
        "paper-1.21.3" = _mPzvIspS;
        "paper-1.21.4" = _mPzvIspS;
        "paper-1.21.9" = _mPzvIspS;
        "paper-1.21.10" = _mPzvIspS;
        "paper-1.21.11" = _mPzvIspS;
        ...
        "paper-26.1" = _mPzvIspS;
        "paper-26.1.1" = _mPzvIspS;
        "paper-26.1.2" = _mPzvIspS;
        "paper-26.2" = _mPzvIspS;
        "purpur-1.21.5" = _mPzvIspS;
        "purpur-1.21.6" = _mPzvIspS;
        "purpur-1.21.7" = _mPzvIspS;
        "purpur-1.21.8" = _mPzvIspS;
        "purpur-1.21" = _mPzvIspS;
        "purpur-1.21.1" = _mPzvIspS;
        "purpur-1.21.2" = _mPzvIspS;
        "purpur-1.21.3" = _mPzvIspS;
        "purpur-1.21.4" = _mPzvIspS;
        "purpur-1.21.9" = _mPzvIspS;
        "purpur-1.21.10" = _mPzvIspS;
        "purpur-1.21.11" = _mPzvIspS;
        ...
        "purpur-26.1" = _mPzvIspS;
        "purpur-26.1.1" = _mPzvIspS;
        "purpur-26.1.2" = _mPzvIspS;
        "purpur-26.2" = _mPzvIspS;
        ...
        "folia-1.21" = _mPzvIspS;
        "folia-1.21.1" = _mPzvIspS;
        "folia-1.21.2" = _mPzvIspS;
        "folia-1.21.3" = _mPzvIspS;
        "folia-1.21.4" = _mPzvIspS;
        "folia-1.21.5" = _mPzvIspS;
        "folia-1.21.6" = _mPzvIspS;
        "folia-1.21.7" = _mPzvIspS;
        "folia-1.21.8" = _mPzvIspS;
        "folia-1.21.9" = _mPzvIspS;
        "folia-1.21.10" = _mPzvIspS;
        "folia-1.21.11" = _mPzvIspS;
        "folia-26.1" = _mPzvIspS;
        "folia-26.1.1" = _mPzvIspS;
        "folia-26.1.2" = _mPzvIspS;
        "folia-26.2" = _mPzvIspS;
        "pkg-1.0.2" = _1HjjrBBs;
        "pkg-1.0.3" = _7WYrcSM9;
        "pkg-1.0.4" = _3wazKBzu;
        "pkg-1.0.5" = _vQsJibMc;
        ...
        "pkg-1.0.8" = _mp4JXDVE;
        "pkg-1.0.9" = _fVtM4m1x;
        "pkg-1.1.10" = _ci1TaPWG;
        "pkg-1.1.11" = _XVSzDOSG;
        "pkg-2.0.0" = _BHzcvfHT;
        "pkg-2.0.1" = _YluJcaNe;
        "pkg-3.0.0" = _BKzutOTf;
        "pkg-3.0.1" = _YM45MuLo;
