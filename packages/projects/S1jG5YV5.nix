...
let
    versions = (let
        ...
        _V3XoOhMl = {
            "id" = "V3XoOhMl";
            "file" = "voicechat-discord-fabric-26.1-3.2.1.jar";
            "hash" = "sha512-e0DM8ARGQaYVuRSLkRpDH7fOwDlp7hw9tzKOITVXH22nVJfW5wknTszBRy9gjHdRgzslho5Hlt4nvSMIBBkD9Q==";
        };
        _PdiBldC4 = {
            "id" = "PdiBldC4";
            "file" = "voicechat-discord-neoforge-1.21.11-3.2.1.jar";
            "hash" = "sha512-HkgY7Zj07/oH0T11iY6K9OJzXmCD2mQNT88QpUzpU9SX1HC9VYegD02TyVkr7ApMg/cd0GB4nQj8rnSdRaAQmw==";
        };
        _nvCC9kPp = {
            "id" = "nvCC9kPp";
            "file" = "voicechat-discord-paper-3.2.1.jar";
            "hash" = "sha512-jdxZnW/gh5I0pRNlYdoU9q4GllYZllXVhC1IaDufE/dZGMOtzQE75O6N8472T/rvehem+7SMV32j5OTLKA9ueQ==";
        };
        _yq39xmR3 = {
            "id" = "yq39xmR3";
            "file" = "voicechat-discord-fabric-1.16.5-3.2.1.jar";
            "hash" = "sha512-DABpp1pSL27yki4t6r+I1HBSZ4LWX15SVlbr0AZPSQFsw2Mf6hniP5htVAs5ru0gbqD+pp8CKC3SiE8/QcwE4A==";
        };
        _6xc36ZZ8 = {
            "id" = "6xc36ZZ8";
            "file" = "voicechat-discord-fabric-1.21.11-3.2.1.jar";
            "hash" = "sha512-+XuLjrbMA9gP7RiurbhkbTnw8ABAjqQChM5y6Px7YcZHRxJnu36WzTZaT6L+zN4RtisxNngrX2tpfCMaboPgrg==";
        };
        _cqHQFTuo = {
            "id" = "cqHQFTuo";
            "file" = "voicechat-discord-fabric-1.19.2-3.2.1.jar";
            "hash" = "sha512-D+fUcKAGB4bc7Rd1JrUtSg1XartawJiX0YfrhDnjiFlRCuzFN3mfVRVeF1GufZADrsjD/xGVfr3rKbL/dle1hA==";
        };
        _2YKpA7Zu = {
            "id" = "2YKpA7Zu";
            "file" = "voicechat-discord-fabric-1.21.2-3.2.1.jar";
            "hash" = "sha512-CaWBVoXaX6gbV6stT1fGDCuwEJrgERt5kio6bghwk+h094A/p6K4gVDo+Hb85tRH1xeRCZzKg2otdUCGv36Vqg==";
        };
        _nt3Rr2AD = {
            "id" = "nt3Rr2AD";
            "file" = "voicechat-discord-fabric-1.21.5-3.2.1.jar";
            "hash" = "sha512-NbDUGGbWvioUmcZX1U03rtiktxL/zxcG1TpVNcgYM9K2fEWNnwZ/z/FCFuxZ3aH5/h/c0K8HcafgDx51ybTpMQ==";
        };
        _bdosRMyU = {
            "id" = "bdosRMyU";
            "file" = "voicechat-discord-neoforge-1.20.5-3.2.1.jar";
            "hash" = "sha512-scFZkfieqAAIkzWXG9y2yAHePBwbF+3Vu0CgRhMd/0d3LetmunUd93fN+mumw2c6km1o8CKa7OKC5CxAW4YVcQ==";
        };
        _MAskitr7 = {
            "id" = "MAskitr7";
            "file" = "voicechat-discord-neoforge-1.21.9-3.2.1.jar";
            "hash" = "sha512-Z6GqDLRrRo9BP+ru+q+p5KhtiVXhC9wHwtMOPkhya9uPzzHHboyCDvOfeCofJ3yKIj09yRjNS8ubqlXlts1xwQ==";
        };
    in {
        "2SMkF7rS" = _2SMkF7rS;
        "6o7bmQRr" = _6o7bmQRr;
        ...
        "paper-1.20.5" = _nvCC9kPp;
        "paper-1.20.6" = _nvCC9kPp;
        "paper-1.21" = _nvCC9kPp;
        "paper-1.21.1" = _nvCC9kPp;
        "paper-1.21.2" = _nvCC9kPp;
        "paper-1.21.3" = _nvCC9kPp;
        "paper-1.21.4" = _nvCC9kPp;
        "paper-1.21.5" = _nvCC9kPp;
        "paper-1.21.8" = _nvCC9kPp;
        "paper-1.21.9" = _nvCC9kPp;
        "paper-1.21.10" = _nvCC9kPp;
        "paper-1.16.5" = _cAaWO31V;
        "paper-1.18.2" = _cAaWO31V;
        "paper-1.21.6" = _nvCC9kPp;
        "paper-1.21.7" = _nvCC9kPp;
        "paper-1.21.11" = _nvCC9kPp;
        "paper-26.1" = _nvCC9kPp;
        "paper-26.1.1" = _nvCC9kPp;
        "paper-26.1.2" = _nvCC9kPp;
        "paper-26.2" = _nvCC9kPp;
        ...
        "purpur-1.20.5" = _nvCC9kPp;
        "purpur-1.20.6" = _nvCC9kPp;
        "purpur-1.21" = _nvCC9kPp;
        "purpur-1.21.1" = _nvCC9kPp;
        "purpur-1.21.2" = _nvCC9kPp;
        "purpur-1.21.3" = _nvCC9kPp;
        "purpur-1.21.4" = _nvCC9kPp;
        "purpur-1.21.5" = _nvCC9kPp;
        "purpur-1.21.8" = _nvCC9kPp;
        "purpur-1.21.9" = _nvCC9kPp;
        "purpur-1.21.10" = _nvCC9kPp;
        "purpur-1.16.5" = _cAaWO31V;
        "purpur-1.18.2" = _cAaWO31V;
        "purpur-1.21.6" = _nvCC9kPp;
        "purpur-1.21.7" = _nvCC9kPp;
        "purpur-1.21.11" = _nvCC9kPp;
        "purpur-26.1" = _nvCC9kPp;
        "purpur-26.1.1" = _nvCC9kPp;
        "purpur-26.1.2" = _nvCC9kPp;
        "purpur-26.2" = _nvCC9kPp;
        "spigot-1.19.2" = _eAunOqu4;
        "spigot-1.19.3" = _eAunOqu4;
        "spigot-1.19.4" = _eAunOqu4;
        "spigot-1.20" = _eAunOqu4;
        "fabric-1.19.2" = _cqHQFTuo;
        "fabric-1.19.3" = _RqRlRQyf;
        "fabric-1.19.4" = _aDOGmnah;
        "fabric-1.20" = _cqHQFTuo;
        "fabric-1.20.1" = _cqHQFTuo;
        "fabric-1.20.2" = _cqHQFTuo;
        "fabric-1.20.3" = _cqHQFTuo;
        "fabric-1.20.4" = _cqHQFTuo;
        "fabric-1.20.5" = _cqHQFTuo;
        "fabric-1.20.6" = _cqHQFTuo;
        "fabric-1.21" = _cqHQFTuo;
        "fabric-1.21.1" = _cqHQFTuo;
        "fabric-1.21.2" = _2YKpA7Zu;
        "fabric-1.21.3" = _2YKpA7Zu;
        "fabric-1.21.4" = _2YKpA7Zu;
        "fabric-1.21.5" = _nt3Rr2AD;
        "fabric-1.21.8" = _nt3Rr2AD;
        "fabric-1.21.10" = _nt3Rr2AD;
        "fabric-1.21.9" = _nt3Rr2AD;
        "fabric-1.18.2" = _yq39xmR3;
        "fabric-1.21.6" = _nt3Rr2AD;
        "fabric-1.16.5" = _yq39xmR3;
        "fabric-1.21.7" = _nt3Rr2AD;
        "fabric-1.21.11" = _6xc36ZZ8;
        "fabric-26.1" = _V3XoOhMl;
        "fabric-26.1.1" = _V3XoOhMl;
        "fabric-26.1.2" = _V3XoOhMl;
        "fabric-26.2" = _V3XoOhMl;
        ...
        "folia-1.20.5" = _nvCC9kPp;
        "folia-1.20.6" = _nvCC9kPp;
        "folia-1.21" = _nvCC9kPp;
        "folia-1.21.1" = _nvCC9kPp;
        "folia-1.21.2" = _nvCC9kPp;
        "folia-1.21.3" = _nvCC9kPp;
        "folia-1.21.4" = _nvCC9kPp;
        "folia-1.21.5" = _nvCC9kPp;
        "folia-1.21.6" = _nvCC9kPp;
        "folia-1.21.7" = _nvCC9kPp;
        "folia-1.21.8" = _nvCC9kPp;
        "folia-1.21.9" = _nvCC9kPp;
        "folia-1.21.10" = _nvCC9kPp;
        "folia-1.21.11" = _nvCC9kPp;
        "folia-26.1" = _nvCC9kPp;
        "folia-26.1.1" = _nvCC9kPp;
        "folia-26.1.2" = _nvCC9kPp;
        "folia-26.2" = _nvCC9kPp;
        "neoforge-1.21.11" = _PdiBldC4;
        "neoforge-26.1" = _PdiBldC4;
        "neoforge-26.1.1" = _PdiBldC4;
        "neoforge-26.1.2" = _PdiBldC4;
        "neoforge-26.2" = _PdiBldC4;
        "neoforge-1.20.5" = _bdosRMyU;
        "neoforge-1.20.6" = _bdosRMyU;
        "neoforge-1.21" = _bdosRMyU;
        "neoforge-1.21.1" = _bdosRMyU;
        "neoforge-1.21.2" = _bdosRMyU;
        "neoforge-1.21.3" = _bdosRMyU;
        "neoforge-1.21.4" = _bdosRMyU;
        "neoforge-1.21.5" = _bdosRMyU;
        "neoforge-1.21.6" = _bdosRMyU;
        "neoforge-1.21.7" = _bdosRMyU;
        "neoforge-1.21.8" = _bdosRMyU;
        "neoforge-1.21.9" = _MAskitr7;
        "neoforge-1.21.10" = _MAskitr7;
        "pkg-1.0.0" = _2SMkF7rS;
        "pkg-1.1.0" = _rHfzB2qY;
        "pkg-1.2.0" = _NANqbP01;
        "pkg-1.3.0" = _q1DgxWxV;
        ...
        "pkg-3.0.8" = _e80OEQpP;
        "pkg-3.0.9" = _Qg7YZSCN;
        "pkg-3.0.10" = _aDOGmnah;
        "pkg-3.0.11" = _PfUsJMjI;
        "pkg-paper-3.0.12" = _cSPPLrLI;
        "pkg-fabric-1.21.10-3.0.12" = _x1Uaep0d;
        "pkg-fabric-1.21.5-3.0.12" = _B3KS8GBX;
        "pkg-fabric-1.21.1-3.0.12" = _kPKLeb0j;
        "pkg-fabric-1.21.4-3.0.12" = _4lX5ecs9;
        "pkg-fabric-1.20.1-3.0.12" = _RnQ1xa5o;
        "pkg-fabric-1.19.2-3.0.12" = _fe9XAruH;
        "pkg-fabric-1.21.8-3.0.12" = _e1NX3gWS;
        "pkg-fabric-1.21.9-3.0.12" = _347xjR6t;
        "pkg-paper-3.0.13" = _29K6Ef2Y;
        "pkg-fabric-1.21.4-3.0.13" = _JfghMpLn;
        "pkg-fabric-1.21.10-3.0.13" = _JfTVnTA6;
        "pkg-fabric-1.21.8-3.0.13" = _mKQxZOOU;
        "pkg-fabric-1.21.5-3.0.13" = _4aIlW6Yo;
        "pkg-fabric-1.20.1-3.0.13" = _FjCLXdid;
        "pkg-fabric-1.21.9-3.0.13" = _Oz6BcnZM;
        "pkg-fabric-1.21.1-3.0.13" = _CkZ49Nux;
        "pkg-fabric-1.19.2-3.0.13" = _SNYvyGAf;
        "pkg-fabric-1.18.2-3.1.1" = _S0r5tq0d;
        "pkg-fabric-1.21-3.1.1" = _TakZXSBF;
        "pkg-paper-3.1.1" = _jQADwBQT;
        "pkg-fabric-1.20-3.1.1" = _GdgFZBh2;
        "pkg-fabric-1.20.5-3.1.1" = _OHD3a5RA;
        "pkg-fabric-1.19.2-3.1.1" = _XyexokKC;
        "pkg-fabric-1.20.3-3.1.1" = _6iZyxEih;
        "pkg-fabric-1.20.1-3.1.1" = _IyvCxwEl;
        "pkg-fabric-1.21.6-3.1.1" = _q67fvP2R;
        "pkg-fabric-1.21.10-3.1.1" = _2ZIOi4SN;
        "pkg-fabric-1.21.5-3.1.1" = _qWnyniUT;
        "pkg-fabric-1.16.5-3.1.1" = _PxnWAoGx;
        "pkg-fabric-1.21.2-3.1.1" = _NrsNazB5;
        "pkg-fabric-1.20.4-3.1.1" = _GGpQ47Qx;
        "pkg-fabric-1.20.2-3.1.1" = _Di58WfgD;
        "pkg-fabric-1.21.7-3.1.1" = _Aelieeki;
        "pkg-fabric-1.21.9-3.1.1" = _llCjWOTF;
        "pkg-fabric-1.20.6-3.1.1" = _qqSNAlfD;
        "pkg-fabric-1.21.3-3.1.1" = _a00yXCVB;
        "pkg-fabric-1.21.1-3.1.1" = _9awZQogl;
        "pkg-fabric-1.21.4-3.1.1" = _bgl5BYQx;
        "pkg-fabric-1.21.8-3.1.1" = _ZQLH5Txg;
        "pkg-paper-3.1.2" = _6BA3AySc;
        "pkg-fabric-1.16.5-3.1.2" = _ve9zXhBR;
        "pkg-fabric-1.19.2-3.1.2" = _WUvDAYeX;
        "pkg-fabric-1.21.5-3.1.2" = _FedqOwXd;
        "pkg-fabric-1.21.11-3.1.2" = _gDce0jOj;
        "pkg-fabric-1.21.2-3.1.2" = _xVi6NB3l;
        "pkg-paper-3.1.3" = _Ferm6xRw;
        "pkg-fabric-1.19.2-3.1.3" = _TMCr0ZSe;
        "pkg-fabric-1.21.2-3.1.3" = _fOViZoF3;
        "pkg-fabric-1.21.5-3.1.3" = _l4sgs84R;
        "pkg-fabric-1.21.11-3.1.3" = _ZF3WsZFm;
        "pkg-fabric-1.16.5-3.1.3" = _wE9abWx3;
        "pkg-paper-3.1.4" = _cAaWO31V;
        "pkg-fabric-1.16.5-3.1.4" = _YN5079n4;
        "pkg-fabric-1.21.11-3.1.4" = _jCtQE7Qi;
        "pkg-fabric-1.21.2-3.1.4" = _3SAhpRg4;
        "pkg-fabric-1.21.5-3.1.4" = _MXwS7cjc;
        "pkg-fabric-1.19.2-3.1.4" = _RRteg6PX;
        "pkg-fabric-1.16.5-3.2.0" = _5aGexo6D;
        "pkg-fabric-1.19.2-3.2.0" = _CBIZXfwh;
        "pkg-paper-3.2.0" = _i6HuMktV;
        "pkg-fabric-26.1-3.2.0" = _ugN1Nbnv;
        "pkg-fabric-1.21.2-3.2.0" = _oJE1ePv3;
        "pkg-fabric-1.21.11-3.2.0" = _Co2eMOXm;
        "pkg-neoforge-1.21.11-3.2.0" = _XI1yQr7x;
        "pkg-fabric-1.21.5-3.2.0" = _JUoYQEUd;
        "pkg-neoforge-1.20.5-3.2.0" = _jtow6yD7;
        "pkg-neoforge-1.21.9-3.2.0" = _j91tN1mh;
        "pkg-fabric-26.1-3.2.1" = _V3XoOhMl;
        "pkg-neoforge-1.21.11-3.2.1" = _PdiBldC4;
        "pkg-paper-3.2.1" = _nvCC9kPp;
        "pkg-fabric-1.16.5-3.2.1" = _yq39xmR3;
        "pkg-fabric-1.21.11-3.2.1" = _6xc36ZZ8;
        "pkg-fabric-1.19.2-3.2.1" = _cqHQFTuo;
        "pkg-fabric-1.21.2-3.2.1" = _2YKpA7Zu;
        "pkg-fabric-1.21.5-3.2.1" = _nt3Rr2AD;
        "pkg-neoforge-1.20.5-3.2.1" = _bdosRMyU;
        "pkg-neoforge-1.21.9-3.2.1" = _MAskitr7;
        "default" = _MAskitr7;
    });
