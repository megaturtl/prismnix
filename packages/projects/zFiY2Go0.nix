...
let
    ...
    in {
        ...
        "pkg-2.6.8+1.19.4" = _uaG9TuDg;
        "pkg-2.7.1+1.20" = _tE0Kqoon;
        "pkg-2.7.2+1.20.1" = _EclPkOFv;
        "pkg-2.7.3+1.20.1" = _RWTR7ejx;
        "pkg-2.5.11+1.19.2" = _auLMDCrc;
        "pkg-2.6.9+1.19.4" = _vd8yHiWL;
        "pkg-2.7.4+1.20.1" = _IxdXloNv;
        "pkg-2.7.5+1.20.1" = _GD2szkt5;
        "pkg-2.7.6+1.20.1" = _Ed11GSJv;
        "pkg-2.7.7+1.20.2" = _GwDH0oOA;
        "pkg-2.7.8+1.20.2" = _QsTMI4w2;
        "pkg-2.8.0+1.20.3" = _YNNUI6QH;
        "pkg-2.7.9+1.20.1" = _7iKK6cRc;
        "pkg-2.7.9+1.20.2" = _rbBExQca;
        "pkg-2.8.1+1.20.4" = _TrEpwJah;
        "pkg-2.7.10+1.20.1" = _TsvrmUbJ;
        "pkg-2.7.10+1.20.2" = _gKaqlMDn;
        "pkg-2.8.2+1.20.4" = _MNoEmcXd;
        "pkg-2.7.11+1.20.1" = _6oMLsJym;
        "pkg-2.7.11+1.20.2" = _SrB5Bgro;
        "pkg-2.8.3+1.20.4" = _MHblC6Lv;
        "pkg-2.7.12+1.20.1" = _QryNVqtA;
        "pkg-2.7.12+1.20.2" = _3Oj1w6BV;
        "pkg-2.8.4+1.20.4" = _xXmCRnqu;
        "pkg-2.8.5+1.20.5" = _7IRVPPz6;
        "pkg-2.8.6+1.20.4" = _JflwrixL;
        "pkg-2.8.6+1.20.6" = _5vPT5xKK;
        "pkg-2.7.13+1.20.1" = _pdKkC1Qv;
        "pkg-2.7.13+1.20.2" = _NS8BPDMr;
        "pkg-2.8.7+1.20.4" = _clwgoaxe;
        "pkg-2.8.7+1.20.6" = _GfTXzpT7;
        "pkg-2.7.14+1.20.1" = _YensC9Zq;
        "pkg-2.7.14+1.20.2" = _c6jaTnCk;
        "pkg-2.8.8+1.20.4" = _rG8Gt4XE;
        "pkg-2.8.8+1.20.6" = _VrN9M24e;
        "pkg-2.9.0+1.21" = _KAj7TcPp;
        "pkg-2.7.15+1.20.1" = _v83bAtLU;
        "pkg-2.8.9+1.20.6" = _lqI9Ia9J;
        "pkg-2.9.1+1.21" = _LSQaGN5A;
        "pkg-2.7.16+1.20.1" = _DAANYszf;
        "pkg-2.8.10+1.20.6" = _JiKd0uZv;
        "pkg-2.9.2+1.21.1" = _qnKSBmCe;
        "pkg-2.7.18+1.20.1" = _21JjOOYj;
        "pkg-2.9.4+1.21.1" = _5dCnaSHW;
        "pkg-2.7.19+1.20.1" = _6JUrgXXz;
        "pkg-2.9.5+1.21.1" = _iRAmmXmv;
        "pkg-2.10.0+1.21.3" = _kNUrChAX;
        "pkg-2.7.20+1.20.1" = _8DwRzjqT;
        "pkg-2.9.6+1.21.1" = _wRpcrHjd;
        "pkg-2.10.1+1.21.3" = _aouV650x;
        "pkg-2.11.0+1.21.4" = _HZAiLt8s;
        "pkg-2.9.7+1.21.1" = _eaWOqR0h;
        "pkg-2.11.1+1.21.4" = _ok02T8ij;
        "pkg-2.7.21+1.20.1" = _pVkZpp5R;
        "pkg-2.9.8+1.21.1" = _AWoMU6pz;
        "pkg-2.11.2+1.21.4" = _6MYjNYWi;
        "pkg-2.9.9+1.21.1" = _8SbeB5D1;
        "pkg-2.11.3+1.21.4" = _nK0re1cF;
        "pkg-2.12.0+1.21.5" = _jrUt1DR3;
        "pkg-2.9.10+1.21.1" = _xTq7CEt2;
        "pkg-2.11.4+1.21.4" = _pcwd0T3G;
        "pkg-2.13.0+1.21.7" = _5gMVF24e;
        "pkg-2.13.1+1.21.8" = _lf4fFx2K;
        "pkg-2.9.11+1.21.1" = _RZRTS1Rn;
        "pkg-2.13.2+1.21.8" = _RQPxlHhj;
        "pkg-2.14.0+1.21.10" = _759WVOa4;
        "pkg-2.9.12+1.21.1" = _Nw12fcYg;
        "pkg-2.14.1+1.21.10" = _LuDiztuA;
        "pkg-2.15.0+1.21.11" = _uL4wb67c;
        "pkg-2.9.13+1.21.1" = _wghgm8sq;
        "pkg-2.15.1+1.21.11" = _REyn5V31;
        "pkg-2.16.0+26.1" = _9QpqgN4B;
        "pkg-2.15.2+1.21.11" = _SK8f5sLI;
        "pkg-2.16.1+26.1.1" = _V5Omjy6B;
        "pkg-2.9.14+1.21.1" = _xwxrtwoc;
        "pkg-2.9.15+1.21.1" = _8gFyM8r5;
        "pkg-2.15.3+1.21.11" = _nxBSSxhg;
        "pkg-2.16.2+26.1.2" = _5vTpOwLT;
        "pkg-2.7.22+1.20.1" = _vhQmw0yJ;
        "pkg-2.9.16+1.21.1" = _osKPtJST;
        "pkg-2.16.3+26.1.2" = _scln7ujv;
        "pkg-2.17.0+26.2" = _Q67r8rET;
        "pkg-2.9.17+1.21.1" = _KICH1eJE;
        "pkg-2.16.4+26.1.2" = _Z8rvq5FJ;
        "pkg-2.17.1+26.2" = _19qmHecK;
        "pkg-2.9.18+1.21.1" = _BduJoveu;
        "pkg-2.16.5+26.1.2" = _1uMVWtau;
