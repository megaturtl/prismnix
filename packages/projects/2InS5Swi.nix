...
let
    ...
    in {
        ...
        "pkg-0.3-alpha" = _Um2RANus;
        "pkg-0.4-alpha" = _vqHU0Z5F;
        "pkg-0.5-alpha" = _Zd6qvsju;
        "pkg-0.6-beta" = _b3yV0hyp;
        "pkg-0.7-beta" = _VcEuC2w8;
        "pkg-0.7.1-beta" = _ZLBDJj2q;
        "pkg-0.7.2-beta" = _B7GO2kfK;
        "pkg-0.8.0-beta" = _g6VmPsJP;
        "pkg-0.8.1-beta" = _rm29uZjx;
        "pkg-0.8.2-beta" = _dTGERxum;
        "pkg-0.8.3-beta" = _m8wUMCOH;
        "pkg-0.8.4-beta" = _zSIozPFe;
        "pkg-0.8.5-beta" = _uU8Fi3nY;
        "pkg-0.9.0-beta" = _kifqx3W6;
        "pkg-0.9.1-beta" = _SlG0p9O9;
        "pkg-0.9.2-beta" = _AqD2rbwu;
        "pkg-0.9.3-beta" = _P5QRBwIG;
        "pkg-0.9.3-alpha" = _6o2ZzO40;
        "pkg-1.0.0" = _UMNbv0Z8;
        "pkg-1.0.1" = _s0WrF5uj;
        "pkg-1.0.2-beta" = _qBGynRrA;
        "pkg-1.0.2" = _1UOP4wOs;
        "pkg-neoforge-1.21.1-1.0.3" = _Q6CHnqSc;
        "pkg-fabric-1.21.1-1.0.3" = _TMglyjie;
        "pkg-forge-1.20.1-1.0.3-beta" = _7YYXz9Vy;
        "pkg-fabric-1.20.1-1.0.3-beta" = _jzA3Iy8f;
        "pkg-fabric-26.2-1.0.3" = _EcuNVXQk;
        "pkg-neoforge-26.2-1.0.3" = _jjaACraS;
        "pkg-neoforge-26.2-1.0.4" = _7MfHGTEI;
        "pkg-fabric-26.2-1.0.4" = _74GKUF3I;
        "pkg-fabric-1.21.1-1.0.4" = _dKI88zaK;
        "pkg-neoforge-1.21.1-1.0.4" = _19jubgJL;
        "pkg-fabric-1.20.1-1.0.4-beta" = _fTHQCE8V;
        "pkg-forge-1.20.1-1.0.4-beta" = _N6XyDK0j;
        "pkg-fabric-26.2-1.1.0" = _pNkFt5Vl;
        "pkg-neoforge-26.2-1.1.0" = _BsDKNoee;
        "pkg-neoforge-1.21.1-1.1.0" = _XZa8eTap;
        "pkg-fabric-1.21.1-1.1.0" = _z7mWzddQ;
        "pkg-fabric-1.20.1-1.1.0" = _tXzV4C9r;
        "pkg-forge-1.20.1-1.1.0" = _SLKe6uBV;
        "pkg-fabric-1.21.1-1.1.0_1" = _pBAsxcmg;
        "pkg-forge-1.20.1-1.1.1" = _o9ITu3vF;
        "pkg-fabric-1.20.1-1.1.1" = _uCwyBsEu;
        "pkg-fabric-26.1.2-1.1.1" = _iRRFPfwH;
        "pkg-neoforge-26.1.2-1.1.1" = _K37wFNcN;
        "pkg-neoforge-26.2-1.1.1" = _5nyUad23;
