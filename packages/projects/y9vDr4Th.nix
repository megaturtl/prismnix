...
let
    versions = (let
        ...
        _9kFrJBPl = {
            "id" = "9kFrJBPl";
            "file" = "itemcollectors-1.1.12b-neoforge-mc26.2.jar";
            "hash" = "sha512-kWSGK2lsU0BEHoLafEJlYC16Ia/34UAgZ0bMfxdzUNMGr/ARpHQV1ysxj/FppXA3SV4pfmbvzuj3OFERiGF3kQ==";
        };
        _bfNvzoXh = {
            "id" = "bfNvzoXh";
            "file" = "itemcollectors-1.1.12-fabric-mc26.3.jar";
            "hash" = "sha512-95jIWbbWk194r6Fo2Nz0/t5A7bM8k/5umX7IangGAaPTMDGGwZ9ovtw8y3oW7ad/m7HxBydJatYjTvWgvFFyVQ==";
        };
        _yQgjoTW9 = {
            "id" = "yQgjoTW9";
            "file" = "itemcollectors-1.1.12-neoforge-mc26.3.jar";
            "hash" = "sha512-eVFl+gifvzNU27Z95QqJWjlfOCIzUIYff5QlILoz+T7MiFV3YggpaKrcNxCmpCNh+3ZZsURmSqfMOlu/6JXVsw==";
        };
    in {
        "mwjfhsmc" = _mwjfhsmc;
        "upQpvDJd" = _upQpvDJd;
        ...
        "neoforge-26.2" = _9kFrJBPl;
        "neoforge-26.3" = _yQgjoTW9;
        ...
        "quilt-26.3" = _bfNvzoXh;
        "pkg-1.1.5-forge-mc1.12" = _mwjfhsmc;
        "pkg-1.1.5-forge-mc1.14" = _upQpvDJd;
        "pkg-1.1.5-forge-mc1.15" = _vyuGV5DU;
        "pkg-1.1.5-forge-mc1.16" = _R4XS8AO8;
        "pkg-1.1.5-forge-mc1.17" = _YrmQmEgY;
        "pkg-1.1.5-forge-mc1.18" = _mzLxc10u;
        "pkg-1.1.5b-forge-mc1.19" = _QYFGc0y2;
        "pkg-1.1.6-forge-mc1.12" = _cRqN9N25;
        "pkg-1.1.6-forge-mc1.14" = _eR68Crkl;
        "pkg-1.1.6-forge-mc1.15" = _U84ole1U;
        "pkg-1.1.6-forge-mc1.16" = _3UYtHvzA;
        "pkg-1.1.6-forge-mc1.17" = _W3zAKd9P;
        "pkg-1.1.6-forge-mc1.18" = _apgUS7gh;
        "pkg-1.1.6-forge-mc1.19" = _rZaKzsWA;
        "pkg-1.1.6-forge-mc1.19.3" = _K8Al39ut;
        "pkg-1.1.7-forge-mc1.19.3" = _uZPBzGCu;
        "pkg-1.1.7-forge-mc1.19" = _R76Ojpj1;
        "pkg-1.1.7-forge-mc1.18" = _wFu4i5cB;
        "pkg-1.1.7-forge-mc1.17" = _7cHr03yL;
        "pkg-1.1.7-forge-mc1.16" = _mkDKxzA5;
        "pkg-1.1.7-forge-mc1.15" = _xXnVGtXY;
        "pkg-1.1.7-forge-mc1.14" = _KJrbVFja;
        "pkg-1.1.7-forge-mc1.12" = _dByRFZIS;
        "pkg-1.1.7-fabric-mc1.18" = _OjyNi56r;
        "pkg-1.1.7-fabric-mc1.19" = _5zvaElvj;
        "pkg-1.1.7-fabric-mc1.19.2" = _i1UC35qX;
        "pkg-1.1.7-forge-mc1.20" = _HOdQOS79;
        "pkg-1.1.7-fabric-mc1.20" = _v4iPbmCU;
        "pkg-1.1.7a-fabric-mc1.18" = _8Bpa2Gp9;
        "pkg-1.1.7a-fabric-mc1.19.2" = _wQUnjaNh;
        "pkg-1.1.7a-fabric-mc1.19.4" = _mXyXmwPL;
        "pkg-1.1.7a-fabric-mc1.20" = _KiC1HZ9w;
        "pkg-1.1.8-forge-mc1.12" = _EXr3rf4w;
        "pkg-1.1.8-forge-mc1.14" = _45hbv3CN;
        "pkg-1.1.8-forge-mc1.15" = _DTcAAXKy;
        "pkg-1.1.8-forge-mc1.16" = _pzLtwUlX;
        "pkg-1.1.8-forge-mc1.17" = _hhr7mAWO;
        "pkg-1.1.8-forge-mc1.18" = _OsQboxNh;
        "pkg-1.1.8-forge-mc1.19" = _zQT0MWYq;
        "pkg-1.1.8-forge-mc1.19.3" = _PGWGmBBb;
        "pkg-1.1.8-forge-mc1.20" = _ik2HYJTx;
        "pkg-1.1.8-fabric-mc1.18" = _wh7tYnLr;
        "pkg-1.1.8-fabric-mc1.19.2" = _Eu12ZHzW;
        "pkg-1.1.8-fabric-mc1.19.4" = _FmCB2IOM;
        "pkg-1.1.8-fabric-mc1.20" = _pTgc4civ;
        "pkg-1.1.8-neoforge-mc1.20.4" = _dFPImZPv;
        "pkg-1.1.9-forge-mc1.12" = _SipFa4D7;
        "pkg-1.1.9-forge-mc1.14" = _9QL5DimL;
        "pkg-1.1.9-forge-mc1.15" = _RefN1PtF;
        "pkg-1.1.9-forge-mc1.16" = _rWRbHpsY;
        "pkg-1.1.9-forge-mc1.17" = _jtAjmMDS;
        "pkg-1.1.9-forge-mc1.18" = _gJbUX5W5;
        "pkg-1.1.9-forge-mc1.19" = _Cjn1pYcv;
        "pkg-1.1.9-forge-mc1.19.3" = _RhJJ4rRF;
        "pkg-1.1.9-forge-mc1.20" = _jwFcHMbq;
        "pkg-1.1.9-fabric-mc1.18" = _INiezTEb;
        "pkg-1.1.9-fabric-mc1.19.2" = _i5PmcFbz;
        "pkg-1.1.9-fabric-mc1.19.4" = _QmYgB8hd;
        "pkg-1.1.9-fabric-mc1.20" = _btBxRdgd;
        "pkg-1.1.9-neoforge-mc1.20.4" = _AUNCYo1r;
        "pkg-1.1.9-fabric-mc1.20.4" = _Tvkgl0Q8;
        "pkg-1.1.9-forge-mc1.20.4" = _hqZpQ9ea;
        "pkg-1.1.10-forge-mc1.12" = _758XjMJ3;
        "pkg-1.1.10-forge-mc1.14" = _TDQqJ91g;
        "pkg-1.1.10-forge-mc1.15" = _OqSWkbp8;
        "pkg-1.1.10-forge-mc1.16" = _tNneLgsf;
        "pkg-1.1.10-forge-mc1.17" = _uD6qEUj4;
        "pkg-1.1.10-forge-mc1.18" = _m8dfaKeb;
        "pkg-1.1.10-forge-mc1.19" = _TnVwMQBJ;
        "pkg-1.1.10-forge-mc1.19.3" = _xLJQ6FGQ;
        "pkg-1.1.10-forge-mc1.20" = _UQ2T8KDU;
        "pkg-1.1.10-forge-mc1.20.4" = _AKge7dPP;
        "pkg-1.1.10-fabric-mc1.18" = _yyzWaMor;
        "pkg-1.1.10-fabric-mc1.19.2" = _HYGXfR34;
        "pkg-1.1.10-fabric-mc1.19.4" = _na0bex9Y;
        "pkg-1.1.10-fabric-mc1.20" = _W2clu40G;
        "pkg-1.1.10-fabric-mc1.20.4" = _JfaY9sCB;
        "pkg-1.1.10-neoforge-mc1.20.4" = _bZJb4wGR;
        "pkg-1.1.10-forge-mc1.20.6" = _ppkzs4uy;
        "pkg-1.1.10-forge-mc1.21" = _VpfkpM6a;
        "pkg-1.1.10-fabric-mc1.20.6" = _3XzQg2vo;
        "pkg-1.1.10-fabric-mc1.21" = _5mQbcYf1;
        "pkg-1.1.10-neoforge-mc1.20.6" = _Eijc31nE;
        "pkg-1.1.10-neoforge-mc1.21" = _V19vXCQ0;
        "pkg-1.1.10-fabric-mc1.21.2" = _6Idk72y1;
        "pkg-1.1.10-neoforge-mc1.21.3" = _MinJQcdD;
        "pkg-1.1.10-forge-mc1.21.3" = _n7TM3llG;
        "pkg-1.1.10-forge-mc1.21.4" = _UOGgyRzX;
        "pkg-1.1.10-fabric-mc1.21.4" = _Slea12lG;
        "pkg-1.1.10-neoforge-mc1.21.4" = _JrrXQd6J;
        "pkg-1.1.10-forge-mc1.21.5" = _AOMvi8rt;
        "pkg-1.1.10-forge-mc1.21.6" = _rLUsE1bU;
        "pkg-1.1.10-fabric-mc1.21.5" = _YWoPpztv;
        "pkg-1.1.10-fabric-mc1.21.6" = _XhkviRr6;
        "pkg-1.1.10-neoforge-mc1.21.5" = _8YDEOFVB;
        "pkg-1.1.10-neoforge-mc1.21.6" = _JVbYHlQr;
        "pkg-1.1.11-forge-mc1.12" = _jC61TdP0;
        "pkg-1.1.11-forge-mc1.14" = _30vJIwCp;
        "pkg-1.1.11-forge-mc1.15" = _dOs0mROp;
        "pkg-1.1.11-forge-mc1.16" = _gw6MG4GF;
        "pkg-1.1.11-forge-mc1.17" = _xBaRsRDt;
        "pkg-1.1.11-forge-mc1.18" = _KcWHQaIE;
        "pkg-1.1.11-forge-mc1.19.2" = _zwMl6d2M;
        "pkg-1.1.11-forge-mc1.19.4" = _DDysQQKu;
        "pkg-1.1.11-forge-mc1.20.2" = _9CulBnqc;
        "pkg-1.1.11-forge-mc1.20.4" = _hG4rYOEu;
        "pkg-1.1.11-forge-mc1.20.6" = _y6RfdrY2;
        "pkg-1.1.11-forge-mc1.21" = _E4ARwaSr;
        "pkg-1.1.11-forge-mc1.21.3" = _G8oHDQJ6;
        "pkg-1.1.11-forge-mc1.21.4" = _hRItKJdh;
        "pkg-1.1.11-forge-mc1.21.5" = _euiPOpK3;
        "pkg-1.1.11-forge-mc1.21.6" = _pSNMEbqm;
        "pkg-1.1.11-neoforge-mc1.20.4" = _sA7089yR;
        "pkg-1.1.11-neoforge-mc1.20.6" = _rDBUSnLl;
        "pkg-1.1.11-neoforge-mc1.21" = _HFCcb9M7;
        "pkg-1.1.11-neoforge-mc1.21.3" = _6Q7VBjHF;
        "pkg-1.1.11-neoforge-mc1.21.4" = _MUR4ues8;
        "pkg-1.1.11-neoforge-mc1.21.5" = _m8192Ait;
        "pkg-1.1.11-neoforge-mc1.21.6" = _ymwIvvyz;
        "pkg-1.1.11-fabric-mc1.18" = _z5uIDMk3;
        "pkg-1.1.11-fabric-mc1.19.2" = _iLThNckW;
        "pkg-1.1.11-fabric-mc1.19.4" = _vCpjtPoe;
        "pkg-1.1.11-fabric-mc1.20.2" = _aJFclmrq;
        "pkg-1.1.11-fabric-mc1.20.4" = _UVI2cM9I;
        "pkg-1.1.11-fabric-mc1.20.6" = _5pgDxD5T;
        "pkg-1.1.11-fabric-mc1.21" = _efUdnIGI;
        "pkg-1.1.11-fabric-mc1.21.3" = _fRoCNnTP;
        "pkg-1.1.11-fabric-mc1.21.4" = _VL7XRfyR;
        "pkg-1.1.11-fabric-mc1.21.5" = _lgufBHJ2;
        "pkg-1.1.11-fabric-mc1.21.6" = _9PNLxjc3;
        "pkg-1.1.11-forge-mc1.21.10" = _l4fAhRmK;
        "pkg-1.1.11-fabric-mc1.21.10" = _vOlAiFa1;
        "pkg-1.1.11-neoforge-mc1.21.10" = _j77jpye5;
        "pkg-1.1.11-forge-mc1.21.11" = _pgkT9Sxc;
        "pkg-1.1.11-fabric-mc1.21.11" = _gTrlYfhR;
        "pkg-1.1.11-neoforge-mc1.21.11" = _8vegArXB;
        "pkg-1.1.12-forge-mc1.12" = _Kve24Rrw;
        "pkg-1.1.12-forge-mc1.14" = _jS6DuWhe;
        "pkg-1.1.12-forge-mc1.15" = _duNZbH8e;
        "pkg-1.1.12-forge-mc1.16" = _JKIK35m3;
        "pkg-1.1.12-forge-mc1.17" = _ciTruHBS;
        "pkg-1.1.12-forge-mc1.18" = _kX7m2O24;
        "pkg-1.1.12-forge-mc1.19.2" = _lQX2uPQQ;
        "pkg-1.1.12-forge-mc1.19.4" = _6WaiSp7t;
        "pkg-1.1.12-forge-mc1.20.2" = _VxDl7akr;
        "pkg-1.1.12-forge-mc1.20.4" = _ZoEb3M1i;
        "pkg-1.1.12-forge-mc1.20.6" = _oVRWTCs0;
        "pkg-1.1.12-forge-mc1.21" = _oUk3mhNE;
        "pkg-1.1.12-forge-mc1.21.3" = _peUQH1Zb;
        "pkg-1.1.12-forge-mc1.21.4" = _IHvOk2zp;
        "pkg-1.1.12-forge-mc1.21.5" = _FGSGmH6c;
        "pkg-1.1.12-forge-mc1.21.8" = _n39sk5rt;
        "pkg-1.1.12-forge-mc1.21.10" = _xej9k0in;
        "pkg-1.1.12-forge-mc1.21.11" = _ofadlhIP;
        "pkg-1.1.12-fabric-mc1.18" = _pwIyX6eM;
        "pkg-1.1.12-fabric-mc1.19.2" = _S6G9bIBa;
        "pkg-1.1.12-fabric-mc1.19.4" = _4EZmuBdn;
        "pkg-1.1.12-fabric-mc1.20.2" = _DcWenLH6;
        "pkg-1.1.12-fabric-mc1.20.4" = _Zb3OZczV;
        "pkg-1.1.12-fabric-mc1.20.6" = _ck66IByx;
        "pkg-1.1.12-fabric-mc1.21" = _guHBAUUh;
        "pkg-1.1.12-fabric-mc1.21.3" = _jURGZTPF;
        "pkg-1.1.12-fabric-mc1.21.4" = _7j9k9WVZ;
        "pkg-1.1.12-fabric-mc1.21.5" = _TlIxFWmp;
        "pkg-1.1.12-fabric-mc1.21.8" = _S90Ydrzh;
        "pkg-1.1.12-fabric-mc1.21.10" = _MbFOMtHV;
        "pkg-1.1.12-fabric-mc1.21.11" = _xBpUk7RX;
        "pkg-1.1.12-neoforge-mc1.20.4" = _4m2BHJYl;
        "pkg-1.1.12-neoforge-mc1.20.6" = _uBRUlFCM;
        "pkg-1.1.12-neoforge-mc1.21" = _KSg6wzol;
        "pkg-1.1.12-neoforge-mc1.21.3" = _2trkClAo;
        "pkg-1.1.12-neoforge-mc1.21.4" = _24FSfdmK;
        "pkg-1.1.12-neoforge-mc1.21.5" = _Gq8DF49X;
        "pkg-1.1.12-neoforge-mc1.21.8" = _ePDD9RVB;
        "pkg-1.1.12-neoforge-mc1.21.10" = _krZwS23C;
        "pkg-1.1.12-neoforge-mc1.21.11" = _rH5c1aUY;
        "pkg-1.1.12-forge-mc26.1" = _uLnYiVzQ;
        "pkg-1.1.12-fabric-mc26.1" = _KCcDY7as;
        "pkg-1.1.12-neoforge-mc26.1" = _47j9hkX0;
        "pkg-1.1.12-forge-mc26.2" = _kIgNPtsx;
        "pkg-1.1.12-fabric-mc26.2" = _Ouv8Ai3p;
        "pkg-1.1.12-neoforge-mc26.2" = _k53pu2fv;
        "pkg-1.1.12a-forge-mc26.1" = _LqcuwfFT;
        "pkg-1.1.12a-fabric-mc26.1" = _lIfQwRJq;
        "pkg-1.1.12a-neoforge-mc26.1" = _dxlT0s0l;
        "pkg-1.1.12a-forge-mc26.2" = _7bWSR3cM;
        "pkg-1.1.12a-fabric-mc26.2" = _kn8vF2Jq;
        "pkg-1.1.12a-neoforge-mc26.2" = _n3Xvdwpz;
        "pkg-1.1.12b-neoforge-mc26.2" = _9kFrJBPl;
        "pkg-1.1.12-fabric-mc26.3" = _bfNvzoXh;
        "pkg-1.1.12-neoforge-mc26.3" = _yQgjoTW9;
        "default" = _yQgjoTW9;
    });
