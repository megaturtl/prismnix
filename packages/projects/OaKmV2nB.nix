...
let
    ...
    in {
        ...
        "pkg-v0.0.7+26.1.2" = _bklb78LR;
        "pkg-v0.0.8+26.1.2" = _zKsBjMIl;
        "pkg-v0.0.9+26.1.2" = _hDpfuyLG;
        "pkg-v0.0.10+26.2" = _jEqx54dE;
        "pkg-v0.0.12+26.1.2" = _MG1to5BB;
        "pkg-v0.0.12+26.2" = _lO2JezoP;
        "pkg-v0.0.13+26.1.2" = _UbB9GuUb;
        "pkg-v0.0.13+26.2" = _nxaISuFK;
        "pkg-v0.0.14+26.1.2" = _LVTCLRr0;
        "pkg-v0.0.14+26.2" = _zFUeM7zb;
        "pkg-v0.0.15+26.1.2" = _jkUMnNQi;
        "pkg-v0.0.15+26.2" = _oWy3YgLG;
        "pkg-v0.0.16+26.1.2" = _Z03vQnyE;
        "pkg-v0.0.16+26.2" = _OZY9g71a;
        "pkg-v0.0.17+26.1.2" = _jE4oqTbM;
        "pkg-v0.0.17+26.2" = _owYJ4PR9;
        "pkg-v0.0.18+26.1.2" = _CeCMvMF8;
