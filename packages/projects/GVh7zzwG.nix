...
let
    versions = (let
        ...
        _eslZVk4m = {
            "id" = "eslZVk4m";
            "file" = "reliable_backpacks-neoforge-1.21.1-1.9.0.jar";
            "hash" = "sha512-uMDhukvlzPzx/YTOa6cLgNxKeUXPkSQT6v2ceOS8BjbR3ne+lsSL9OrwQVKrvJUonZr3dOBHCH8YlZ63NnxnmQ==";
        };
        _FCsBy1nK = {
            "id" = "FCsBy1nK";
            "file" = "reliable_backpacks-fabric-1.21.1-1.9.0.jar";
            "hash" = "sha512-RXrRcg9PFsGIbB1ANO3M16AbBn2cqasTbOI0IRH7Nt5UF4wsl2siUPCwDmbJMjuq/b4uQvVkY33yJCNZVKPecg==";
        };
        _q9JfAYPM = {
            "id" = "q9JfAYPM";
            "file" = "reliable_backpacks-fabric-1.19.2-1.4.2.jar";
            "hash" = "sha512-hYtvSJZ7RPLljafhb9/QtynlFt/3fGpmlKE/POcdwSB3zI+8rwnkzp8ofLqTUPuLlojJDb4XsVBP7bNc9G4DkQ==";
        };
        _pBb187fT = {
            "id" = "pBb187fT";
            "file" = "reliable_backpacks-forge-1.19.2-1.4.2.jar";
            "hash" = "sha512-PPHj9I5mqCMAXuOxUr4tYFd0arBxQvduZMYpgS5hE4tcwKPsL8U7/vuL2QCoU2VsEpVIV48HhvvE8LXLEkRE4A==";
        };
        _HRVysOMj = {
            "id" = "HRVysOMj";
            "file" = "reliable_backpacks-neoforge-1.21.1-1.9.1.jar";
            "hash" = "sha512-zZ7wz/vArggfPnvv1rg05ZgItyvcBIPJwAMdxSbB9XbitRqy72FwkQqJX6OsGsBmBeGtClKr21dwbuvkS5ThsA==";
        };
        _HKiynNI4 = {
            "id" = "HKiynNI4";
            "file" = "reliable_backpacks-fabric-1.21.1-1.9.1.jar";
            "hash" = "sha512-TppymvF7jtCEij70YzgEPEqbXwidCs0mIXmh6gShKb7ZYfy7l1KFIAxOjCrYTSRlvCN5JbGRH2Lqsrrgpc4T9w==";
        };
    in {
        "3818b3Uu" = _3818b3Uu;
        "vWwzXKZE" = _vWwzXKZE;
        ...
        "fabric-1.21.1" = _HKiynNI4;
        "fabric-1.19.2" = _q9JfAYPM;
        "forge-1.20.1" = _jyyQGzvi;
        "forge-1.19.2" = _pBb187fT;
        "neoforge-1.21.1" = _HRVysOMj;
        "pkg-1.0.0-1.20.1-fabric" = _3818b3Uu;
        "pkg-1.0.0-1.20.1-forge" = _vWwzXKZE;
        "pkg-1.0.0-neoforge-1.21.1" = _wEhf21z3;
        "pkg-1.0.0-fabric-1.21.1" = _JGCTt60l;
        "pkg-1.1.0-1.20.1-fabric" = _DilJUX3b;
        "pkg-1.1.0-1.20.1-forge" = _fD2RsB5L;
        "pkg-1.1.1-1.20.1-fabric" = _pDYLjuC0;
        "pkg-1.1.1-1.20.1-forge" = _eb5h6HkH;
        "pkg-1.1.2-1.20.1-fabric" = _pYFD6eCy;
        "pkg-1.1.2-1.20.1-forge" = _ORNPQ8fT;
        "pkg-1.1.3-1.20.1-fabric" = _6VVscdZH;
        "pkg-1.1.3-1.20.1-forge" = _Iiu8HnDX;
        "pkg-1.1.0-1.21.1-fabric" = _dbrY8q3Q;
        "pkg-1.1.0-1.21.1-neoforge" = _MHEzDoTv;
        "pkg-1.1.4-1.21.1-neoforge" = _NCtsvcxa;
        "pkg-1.1.4-1.21.1-fabric" = _RWqTsCqD;
        "pkg-1.1.4-1.20.1-fabric" = _HzSnoyuh;
        "pkg-1.1.4-1.20.1-forge" = _pvjvxrGQ;
        "pkg-1.1.4-1.19.2-forge" = _S6stQno6;
        "pkg-1.1.4-1.19.2-fabric" = _i8XJ0LAw;
        "pkg-1.2.0-1.19.2-fabric" = _eIym9ZlY;
        "pkg-1.2.0-1.19.2-forge" = _JznK8ZxL;
        "pkg-1.2.1-1.19.2-forge" = _z98Vidn9;
        "pkg-1.2.1-1.19.2-fabric" = _9wLKkeTT;
        "pkg-1.2.0-1.20.1-fabric" = _mbV9SbJI;
        "pkg-1.2.0-1.20.1-forge" = _HoruUOrD;
        "pkg-1.2.0-1.21.1-neoforge" = _rr4RWfUK;
        "pkg-1.2.0-1.21.1-fabric" = _LEpEhbpJ;
        "pkg-1.2.2-1.19.2-fabric" = _aFzG5pI2;
        "pkg-1.2.2-1.19.2-forge" = _MDqi2Tuc;
        "pkg-1.2.2-1.20.1-fabric" = _NBkfQ6aj;
        "pkg-1.2.2-1.20.1-forge" = _rhThmPlX;
        "pkg-1.3.0-1.20.1-fabric" = _oKD3qfUT;
        "pkg-1.3.0-1.20.1-forge" = _UfxzcQje;
        "pkg-1.3.0-1.19.2-fabric" = _DdKV0Vfi;
        "pkg-1.3.0-1.19.2-forge" = _kg5TgBxN;
        "pkg-1.3.0-1.21.1-neoforge" = _PrU2qmNc;
        "pkg-1.3.0-1.21.1-fabric" = _DbfFINJq;
        "pkg-1.3.0-rf-1.19.2-fabric" = _6cuMnKgn;
        "pkg-1.3.0-rf-1.19.2-forge" = _1B1trHH8;
        "pkg-1.4.0-1.21.1-fabric" = _AorR02Tk;
        "pkg-1.4.0-1.21.1-neoforge" = _9Trn2xBh;
        "pkg-1.4.1-1.20.1-fabric" = _xyvfTwd2;
        "pkg-1.4.1-1.20.1-forge" = _sKZATVrN;
        "pkg-1.4.1-1.19.2-fabric" = _nOQbwBcr;
        "pkg-1.4.1-1.19.2-forge" = _3QPOPLzw;
        "pkg-1.5.0-1.20.1-fabric" = _wi4BNvCP;
        "pkg-1.5.0-1.20.1-forge" = _rPku9YQ9;
        "pkg-1.5.0-1.21.1-fabric" = _cloatBgS;
        "pkg-1.5.0-1.21.1-neoforge" = _QPLRMNpD;
        "pkg-1.6.0-1.21.1-fabric" = _9tFUxfmV;
        "pkg-1.6.0-1.21.1-neoforge" = _UxGA4X1m;
        "pkg-1.6.0-1.20.1-fabric" = _6EjhKzLB;
        "pkg-1.6.0-1.20.1-forge" = _CvwKMg3l;
        "pkg-1.6.1-1.21.1-neoforge" = _Fc6ccZAZ;
        "pkg-1.6.1-1.21.1-fabric" = _6pMzraB1;
        "pkg-1.6.1-1.20.1-fabric" = _nzhOd78h;
        "pkg-1.6.1-1.20.1-forge" = _Y7IjqvBX;
        "pkg-1.7.0-1.21.1-neoforge" = _BB51S3UG;
        "pkg-1.7.0-1.21.1-fabric" = _prfaaYWC;
        "pkg-1.7.0-1.20.1-fabric" = _xmrFKfCa;
        "pkg-1.7.0-1.20.1-forge" = _yWZNRpuV;
        "pkg-1.7.1-1.21.1-neoforge" = _d9HcUEWq;
        "pkg-1.7.1-1.21.1-fabric" = _lSISvtjj;
        "pkg-1.8.0-1.21.1-neoforge" = _RHEClEMU;
        "pkg-1.8.0-1.21.1-fabric" = _ysAnIs3D;
        "pkg-1.8.0-1.20.1-fabric" = _MFxdjI5y;
        "pkg-1.8.0-1.20.1-forge" = _sH1dfJmr;
        "pkg-1.8.1-1.20.1-fabric" = _ikm7jkE8;
        "pkg-1.8.2-1.20.1-fabric" = _X7N08zJk;
        "pkg-1.8.2-1.20.1-forge" = _PYmzWfAw;
        "pkg-1.8.3-1.20.1-fabric" = _KZwxJQze;
        "pkg-1.8.3-1.20.1-forge" = _jyyQGzvi;
        "pkg-1.8.1-1.21.1-neoforge" = _rwmePr9b;
        "pkg-1.8.1-1.21.1-fabric" = _gOfWKcvL;
        "pkg-1.8.2-1.21.1-neoforge" = _BDsJ2CoG;
        "pkg-1.8.2-1.21.1-fabric" = _exnriFBo;
        "pkg-1.9.0-1.21.1-neoforge" = _eslZVk4m;
        "pkg-1.9.0-1.21.1-fabric" = _FCsBy1nK;
        "pkg-1.4.2-1.19.2-fabric" = _q9JfAYPM;
        "pkg-1.4.2-1.19.2-forge" = _pBb187fT;
        "pkg-1.9.1-1.21.1-neoforge" = _HRVysOMj;
        "pkg-1.9.1-1.21.1-fabric" = _HKiynNI4;
        "default" = _HKiynNI4;
    });
