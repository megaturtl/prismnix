...
let
    versions = (let
        ...
        _rr0hYX9b = {
            "id" = "rr0hYX9b";
            "file" = "modularui2-2.3.86-1.7.10.jar";
            "hash" = "sha512-SWgqVaNHlWOg9wEVNPPRpDOhuuRWgzlZroP793X++lr+0nvGMjI4fmH1w9csEDQtKrdSHECzmsdE3KFg0pgqQw==";
        };
        _hpIEfpKx = {
            "id" = "hpIEfpKx";
            "file" = "modularui2-2.3.87-1.7.10.jar";
            "hash" = "sha512-YMBAUzajTxjxWp+9xzJqlMak+YgVwQsGbVKzZj3Mp8fa3G8wJtmMem0vB35S8KIkZlg3tiCNILxgMHXmpXwnEg==";
        };
        _VVrb7soX = {
            "id" = "VVrb7soX";
    ...
    in {
        ...
        "pkg-2.4.2" = _nMgQL5Ao;
        "pkg-2.4.3" = _CscJAJSo;
        "pkg-2.5.0-rc3" = _CUoOUhyE;
        "pkg-2.5.0-rc4" = _Bs36wHXR;
        "pkg-2.5.0-rc5" = _uxiQgZzo;
        "pkg-2.5.0-rc6" = _vnfYqcgr;
        "pkg-2.5.0" = _oo6MCpre;
        "pkg-2.5.1" = _2jD6POUF;
        "pkg-3.0.2" = _XAswUcYw;
        "pkg-3.0.3" = _WTDwMP7x;
        ...
        "pkg-3.1.0" = _Hi2zN8gd;
        "pkg-3.1.1" = _RvQi7BLv;
        "pkg-mc1.20.1-3.1.1" = _zUSQVQYS;
        "pkg-3.1.2" = _kqWHjZFM;
        "pkg-3.1.3" = _H9ynQUkZ;
        "pkg-3.1.4" = _SnfsGGig;
        "pkg-3.1.4-mc1.20.1" = _fWzd0GGV;
        "pkg-3.1.5" = _l9CAKRhR;
        "pkg-3.1.5-mc1.20.1" = _DSLmCk4L;
        "pkg-3.2.0-mc1.20.1" = _Xq0TTx4r;
        "pkg-3.1.6" = _1twp2z8Y;
        "pkg-2.3.60-1.7.10" = _GmpnV0IZ;
        "pkg-2.3.61-1.7.10" = _JGRwKMvK;
        "pkg-2.3.62-1.7.10" = _7kB1Q6ZI;
        "pkg-2.3.63-1.7.10" = _q1dtc7NE;
        "pkg-2.3.64-1.7.10" = _TvZsCXut;
        "pkg-2.3.65-1.7.10" = _uYD6iHpj;
        "pkg-3.3.0-mc1.20.1" = _durr5IDC;
        "pkg-2.3.66-1.7.10" = _6j7LcXKC;
        "pkg-2.3.67-1.7.10" = _CFlNcFec;
        "pkg-2.3.68-1.7.10" = _gsAnnfme;
        "pkg-2.3.69-1.7.10" = _ka2dafVQ;
        "pkg-2.3.70-1.7.10" = _e71dej20;
        "pkg-2.3.71-1.7.10" = _nnqsIvbP;
        "pkg-2.3.72-1.7.10" = _HIZLmJ8M;
        "pkg-2.3.73-1.7.10" = _AnnJDCUH;
        "pkg-2.3.74-1.7.10" = _wXlOToAU;
        "pkg-2.3.75-1.7.10" = _wgAEopEd;
        "pkg-2.3.76-1.7.10" = _WQq3X6px;
        "pkg-2.3.77-1.7.10" = _YY7XbBAJ;
        "pkg-2.3.78-1.7.10" = _aMO9KAXV;
        "pkg-2.3.79-1.7.10" = _7mpbCLHh;
        "pkg-3.3.1-mc1.20.1" = _SLauVa1g;
        "pkg-2.3.80-1.7.10" = _Y3AeNx9J;
        "pkg-2.3.81-1.7.10" = _Az2JAt0W;
        "pkg-2.3.82-1.7.10" = _5gXNrwa8;
        "pkg-2.3.83-1.7.10" = _VFBtYbbL;
        "pkg-2.3.84-1.7.10" = _5XBMAmQs;
        "pkg-2.3.85-1.7.10" = _yOAYvKU8;
