...
let
    versions = (let
        ...
        _wBkuBKia = {
            "id" = "wBkuBKia";
            "file" = "elytra_white-1.0.1-mc26.3.zip";
            "hash" = "sha512-Mg0QrvLu3WDOXKGWoB7w6QkCJpCg2kgB6FFtiUY2Rd/0LpZIoDxVal9fh71ggI4suDbhQmlmR+le+4RzhtoR+Q==";
        };
    in {
        "2YFHT2yJ" = _2YFHT2yJ;
        "KGsj9wdJ" = _KGsj9wdJ;
