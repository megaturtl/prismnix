...
let
    ...
    in {
        ...
        "pkg-2.3.0" = _FmhndaVU;
        "pkg-2.3.1" = _vEP2Q1TW;
        "pkg-2.3.1-neoforge" = _uHI27pGU;
        "pkg-2.4.0" = _51JIpo0U;
        "pkg-2.4.0-neoforge" = _DKl4ydVy;
        "pkg-2.4.1-neoforge" = _C3QE0o9C;
        "pkg-2.5.0" = _euEKMAXA;
        "pkg-2.5.0-neoforge" = _zciq7mS3;
        "pkg-2.5.1" = _EkaVRJvO;
        "pkg-2.5.1-neoforge" = _HL1u5Oap;
        "pkg-2.5.2" = _c8Kj2KQ0;
        "pkg-2.5.2-neoforge" = _wUKVHPmV;
        "pkg-2.6.0" = _k5CitVOR;
        "pkg-2.6.0-neoforge" = _OhpHBaAk;
        "pkg-2.7.0" = _7cDCMfGP;
        "pkg-2.7.0-neoforge" = _ZMJITtsF;
        "pkg-2.7.1" = _ofcA0suR;
        "pkg-2.7.1-neoforge" = _OkJYDl5o;
        "pkg-2.7.2-neoforge" = _NJNekNVZ;
        "pkg-2.7.3-neoforge" = _fsuFxsHL;
        "pkg-2.8.0" = _Dp9qHFCO;
        "pkg-2.8.0-neoforge" = _Hq9dNlNe;
        "pkg-2.8.1" = _wa7gOrmo;
        "pkg-2.8.1-neoforge" = _hpbOuQ0s;
        "pkg-2.9.0" = _AwlQ7dam;
        "pkg-2.9.0-neoforge" = _CeMvpEWE;
        "pkg-2.9.1-neoforge" = _DAeoZyh7;
        "pkg-2.9.2-neoforge" = _9RqUa8kz;
        "pkg-2.9.3-neoforge" = _D3489BlJ;
        "pkg-2.10.0" = _DFsuhIyv;
