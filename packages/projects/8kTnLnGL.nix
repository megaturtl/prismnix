...
let
    ...
    in {
        ...
        "pkg-1.0.2" = _LMCWfmi7;
        "pkg-1.1.0" = _CG1r0Ukt;
        "pkg-1.1.0.1" = _UzV3V3dM;
        "pkg-1.1.2" = _u2lKb6m7;
        "pkg-1.1.3" = _dSSddXR1;
        "pkg-1.1.3.1" = _GtnnJBQZ;
        "pkg-1.1.3.2" = _U4fsc7Q2;
        "pkg-1.1.4" = _cBZoqc04;
        "pkg-1.1.4.1" = _s1UdHDTV;
        "pkg-1.1.5" = _tCExmq63;
        "pkg-1.1.6" = _thVH4Zw1;
        "pkg-1.1.6.1" = _4QcuiJqE;
        "pkg-1.1.7" = _5WGN2fzK;
        "pkg-1.1.7.1" = _NSbyxZC1;
        "pkg-1.1.7.1.1" = _DWWCTfHS;
        "pkg-1.1.8" = _Vd3CUZZD;
        "pkg-1.1.9" = _prHxHons;
        "pkg-1.2" = _qsgu0udC;
        "pkg-1.2.1" = _WZQqSrWf;
        ...
        "pkg-1.2.6" = _5VQOKNZx;
        "pkg-1.2.7" = _4JVtLZCz;
        "pkg-1.2.7.1" = _7rDwJnJO;
        "pkg-1.2.8" = _WMLTzT1T;
        "pkg-1.2.9" = _M6LPhtzl;
        "pkg-1.2.10" = _KysF5zq7;
        "pkg-1.2.11" = _g7APTJdg;
        "pkg-1.2.11.1" = _5kNdwCe0;
        "pkg-1.3" = _vpzLPVCg;
        "pkg-1.3.1" = _ibVtuy3U;
        "pkg-1.3.2" = _WHhymtHc;
        "pkg-1.3.3" = _BhfMvHRb;
