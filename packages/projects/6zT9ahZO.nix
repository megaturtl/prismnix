...
let
    versions = (let
        ...
        _NtAOUls5 = {
            "id" = "NtAOUls5";
            "file" = "simplefullbright-fabric-26.3-1.4.0.jar";
            "hash" = "sha512-ze6EOF0guv4oNXiCduPYn9m9Ivv7mEWCghb8d7Nn589Eu8785KQ9zzuu1g/dc6vWBG191P1x6XWVTVuoLfuajw==";
        };
        _ZPuXRFBT = {
            "id" = "ZPuXRFBT";
