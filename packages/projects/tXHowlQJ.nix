...
let
    versions = (let
        ...
        _Gun2LPey = {
            "id" = "Gun2LPey";
            "file" = "Better-Ghast-Harness-DP-v1.2.1.zip";
            "hash" = "sha512-6q++1/GqQ7CXuxnUUuLUv7YVc8F3pbe+oIWYTC/FPx4/AH7N453XiU12M6Z9/FTwcMZsPzWndU6yBsu0WgphGA==";
        };
        _j7SR30Md = {
            "id" = "j7SR30Md";
            "file" = "fantazs-better-ghast-harness-v1.2.1.jar";
            "hash" = "sha512-JY7L4KjJoGhPJswnXV4JgRR7XXrRJYZvlI09RnojL5dj57UjoD4L/jAwkFSueGckOvOFCqCrGH9Ta7miZPuRDA==";
        };
    in {
        "ph4NdlJS" = _ph4NdlJS;
        "E1GUWqQz" = _E1GUWqQz;
        ...
        "Gun2LPey" = _Gun2LPey;
        "j7SR30Md" = _j7SR30Md;
        "datapack-1.21.6" = _Gun2LPey;
        "datapack-1.21.7" = _Gun2LPey;
        "datapack-1.21.8" = _Gun2LPey;
        "datapack-1.21.9" = _Gun2LPey;
        "datapack-1.21.10" = _Gun2LPey;
        "datapack-1.21.11" = _Gun2LPey;
        "datapack-26.1" = _Gun2LPey;
        "datapack-26.1.1" = _Gun2LPey;
        "datapack-26.1.2" = _Gun2LPey;
        "datapack-26.2" = _Gun2LPey;
        "fabric-1.21.6" = _j7SR30Md;
        "fabric-1.21.7" = _j7SR30Md;
        "fabric-1.21.8" = _j7SR30Md;
        "fabric-1.21.9" = _j7SR30Md;
        "fabric-1.21.10" = _j7SR30Md;
        "fabric-1.21.11" = _j7SR30Md;
        "fabric-26.1" = _j7SR30Md;
        "fabric-26.1.1" = _j7SR30Md;
        "fabric-26.1.2" = _j7SR30Md;
        "fabric-26.2" = _j7SR30Md;
        "forge-1.21.6" = _j7SR30Md;
        "forge-1.21.7" = _j7SR30Md;
        "forge-1.21.8" = _j7SR30Md;
        "forge-1.21.9" = _j7SR30Md;
        "forge-1.21.10" = _j7SR30Md;
        "forge-1.21.11" = _j7SR30Md;
        "forge-26.1" = _j7SR30Md;
        "forge-26.1.1" = _j7SR30Md;
        "forge-26.1.2" = _j7SR30Md;
        "forge-26.2" = _j7SR30Md;
        "neoforge-1.21.6" = _j7SR30Md;
        "neoforge-1.21.7" = _j7SR30Md;
        "neoforge-1.21.8" = _j7SR30Md;
        "neoforge-1.21.9" = _j7SR30Md;
        "neoforge-1.21.10" = _j7SR30Md;
        "neoforge-1.21.11" = _j7SR30Md;
        "neoforge-26.1" = _j7SR30Md;
        "neoforge-26.1.1" = _j7SR30Md;
        "neoforge-26.1.2" = _j7SR30Md;
        "neoforge-26.2" = _j7SR30Md;
        "quilt-1.21.6" = _j7SR30Md;
        "quilt-1.21.7" = _j7SR30Md;
        "quilt-1.21.8" = _j7SR30Md;
        "quilt-1.21.9" = _j7SR30Md;
        "quilt-1.21.10" = _j7SR30Md;
        "quilt-1.21.11" = _j7SR30Md;
        "quilt-26.1" = _j7SR30Md;
        "quilt-26.1.1" = _j7SR30Md;
        "quilt-26.1.2" = _j7SR30Md;
        "quilt-26.2" = _j7SR30Md;
        "pkg-1.0.0" = _E1GUWqQz;
        "pkg-1.0.1" = _Xqg8J6eA;
        "pkg-1.1.0" = _YXnu0hNk;
        "pkg-1.1.1" = _uZxFK5an;
