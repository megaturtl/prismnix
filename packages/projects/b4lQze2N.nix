...
let
    versions = (let
        ...
        _MIMcHjGX = {
            "id" = "MIMcHjGX";
            "file" = "Gerudoku Faithful.zip";
            "hash" = "sha512-yZas/0koeTJ26ioSmVBfckq6DwE17DLi+yqG0sRTBKCXjf0mlRE/5nVfxtEv/OkX0X1Oxi++XNxbfGo7iVWa8Q==";
        };
        _dqi5uP1E = {
            "id" = "dqi5uP1E";
            "file" = "Gerudoku Faithful b1.4 - b1.6.6.zip";
            "hash" = "sha512-bXCVQMqEDGtsqja0sA/p8TfwCJfVuXgKHoBjXmZVs5TrtA4GmzQYSrpHdSnhPmeXoepUk1ycYVYsKm3H8FWWpg==";
        };
        _NyIwabgJ = {
            "id" = "NyIwabgJ";
            "file" = "Gerudoku Faithful b1.7 - b1.7.3.zip";
            "hash" = "sha512-zae8aVaNN9Q5+uLnGhIkZu3LuNVZG+MPWV5Kct6AhV25JYl7NqEQ04enatzRM2pfUCOAXVCIOS2AVRzfbFtaLw==";
        };
        _kqyPmcaw = {
            "id" = "kqyPmcaw";
            "file" = "Gerudoku Faithful 1.0 - 1.3.2.zip";
            "hash" = "sha512-247T44XSlL0nok6sqVn8G0M6JBGnmtTbUtHTF0icAmboybADewnBvHUQSexf6BaPkHL7LaZ7nsp/ao4GdqSfTg==";
        };
        _cQxAI35d = {
            "id" = "cQxAI35d";
            "file" = "Gerudoku Faithful 1.4 - 1.4.7.zip";
            "hash" = "sha512-0bmEIiSiUmaY32CNQJ8dJRdSXk2pu1p8I+2AdNJJW2Q//MS+z+DoJl/1XAw0QUVtE1qFypGuBx2ThpSFp6dsqQ==";
        };
        _woPshiuM = {
            "id" = "woPshiuM";
            "file" = "Gerudoku Faithful 1.5 - 1.5.2.zip";
            "hash" = "sha512-8BRCngZhVQf2bKGhOAA2tAf/VfJVUt4hRkLLS9vToxP3OPGNeCzPdJ7UMA/dyBh5VHQQBY8haqDlpdzkFPpITA==";
        };
        _W0RuZjtO = {
            "id" = "W0RuZjtO";
            "file" = "Gerudoku Faithful 1.6 - 1.8.9.zip";
            "hash" = "sha512-q/Ej1FOBBDvn6MbWoHzDOBJCJADTzs7PzzcIg6rrGhUvnM4wAFeb4QcJeGY3S8kEphVWHI6ksN3W2/2lP8t8hQ==";
        };
        _K9MSUQqn = {
            "id" = "K9MSUQqn";
            "file" = "Gerudoku Faithful 1.9 - 1.9.4.zip";
            "hash" = "sha512-Ds7FyCcoNoHH2DjutIabelDybdFEjSj2ejXFJD5l6GZDRO5qXfasO22qNZhmQe4n4hJ3pu+L51hkSBKQYlj+RQ==";
        };
        _CTHvSMXG = {
            "id" = "CTHvSMXG";
            "file" = "Gerudoku Faithful 1.10 - 1.12.2.zip";
            "hash" = "sha512-XJ/XmFvY/dBX1DoYwhk6xbm79XYVBrq72dqDybXaPK2cqckIGc4VkhpOXhXUE5g5AMb2ZROQfEVVv8D9GvSbQg==";
        };
        _EkiuLSek = {
            "id" = "EkiuLSek";
            "file" = "Gerudoku Faithful 1.13 - 1.14.4.zip";
            "hash" = "sha512-hWw4v5KsTWuQvgAfXICTAmoPQrDBGqW/kroC6p+y1FdMJpLZQVKTyQ/YFNjs+RxQ2NVR6IjB9T5llg76By69wA==";
        };
        _KPok7J7P = {
            "id" = "KPok7J7P";
            "file" = "Gerudoku Faithful 1.15 - 1.16.1.zip";
            "hash" = "sha512-LCFzFEbHC2dYsErTLuJw0RVH5u5cPCv8mro4PTRR3fAncOsK72Zfa2b4pYCXMrj6m3Xn6RCFIGtBSabpnEcTFQ==";
        };
        _fJGO1xMV = {
            "id" = "fJGO1xMV";
            "file" = "Gerudoku Faithful 1.16.2 - 1.19.2.zip";
            "hash" = "sha512-GfrC1Ju0+vYOn4lLXQgmUIVoTv5v59L4hGX8b++0zsyGLHZOmpaKhAB1CZVS0K9djtOy8oZ3GN489kV4HtPZLw==";
        };
        _zOuVV1Ah = {
            "id" = "zOuVV1Ah";
            "file" = "Gerudoku Faithful 1.19.3 - 1.20.1.zip";
            "hash" = "sha512-LSHRdgxCdPWFoPPUS5uRkIS5hhS5YbNBlREh8NCAfkOtFnNU9ZH166UPT3pdoc1ubPeabofy+TFFgKnXo91v9A==";
        };
        _aLZDKrAO = {
            "id" = "aLZDKrAO";
            "file" = "Gerudoku Faithful 1.20.2 - 1.21.11.zip";
            "hash" = "sha512-e/cZl6iEa9xDYKiyA9gd+55MHQjXFp2ymwtT68DgeEYYKFTeANMukmeoTHb4HR0S2sTegZpkHtQJ+3DEiw1zMw==";
        };
        _VFjnOzBb = {
            "id" = "VFjnOzBb";
            "file" = "Gerudoku Faithful 26.1 - 26.2.zip";
            "hash" = "sha512-0HE9Uyfv7Sc7caGaIqQELhtbUZfGMepDhcbYbOQK0NI8LLE/J/H/TCC+CNpW2GQHJ6VKCVQxkdd8298e9455CA==";
        };
        _9yjKoxXO = {
            "id" = "9yjKoxXO";
            "file" = "Gerudoku Faithful.zip";
            "hash" = "sha512-C9V92yuqNFtTMe448wHI1/2UyJirgyJfXMmuJJLv7jtBIt8/HIla9pyZ6X5K4scEh0pE+6AUPu/UJTZfuR7nRQ==";
        };
        _QgD0P15x = {
            "id" = "QgD0P15x";
            "file" = "Gerudoku Faithful.zip";
            "hash" = "sha512-SlIBcoHXdYO71J0vXfwdgT2/z/3vYo6nBXA7s4m0aqpaX9m5dAJZyipM8taUvbv/+9tCdSCmRhuBoqu58RG0Gw==";
        };
    in {
        "ih9CxZT9" = _ih9CxZT9;
        "7fXPfuhb" = _7fXPfuhb;
        ...
        "9yjKoxXO" = _9yjKoxXO;
        "QgD0P15x" = _QgD0P15x;
        "minecraft-1.20" = _zOuVV1Ah;
        "minecraft-1.20.1" = _zOuVV1Ah;
        "minecraft-1.17" = _fJGO1xMV;
        "minecraft-1.17.1" = _fJGO1xMV;
        "minecraft-1.18" = _fJGO1xMV;
        "minecraft-1.18.1" = _fJGO1xMV;
        "minecraft-1.18.2" = _fJGO1xMV;
        "minecraft-1.19" = _fJGO1xMV;
        "minecraft-1.19.1" = _fJGO1xMV;
        "minecraft-1.19.2" = _fJGO1xMV;
        "minecraft-1.19.3" = _zOuVV1Ah;
        "minecraft-1.19.4" = _zOuVV1Ah;
        ...
        "minecraft-1.20.2" = _aLZDKrAO;
        "minecraft-23w40a" = _PKUQAdXJ;
        "minecraft-23w41a" = _PKUQAdXJ;
        "minecraft-1.20.3" = _aLZDKrAO;
        "minecraft-1.20.4" = _aLZDKrAO;
        "minecraft-24w04a" = _CcPHjzzT;
        "minecraft-24w05a" = _CcPHjzzT;
        "minecraft-24w05b" = _CcPHjzzT;
        "minecraft-24w06a" = _TnM3ILLs;
        "minecraft-b1.4" = _dqi5uP1E;
        "minecraft-b1.4_01" = _lJ8wuE2Y;
        "minecraft-b1.5" = _dqi5uP1E;
        "minecraft-b1.5_01" = _lJ8wuE2Y;
        "minecraft-b1.6" = _dqi5uP1E;
        "minecraft-b1.6.1" = _dqi5uP1E;
        "minecraft-b1.6.2" = _dqi5uP1E;
        "minecraft-b1.6.3" = _dqi5uP1E;
        "minecraft-b1.6.4" = _dqi5uP1E;
        "minecraft-b1.6.5" = _dqi5uP1E;
        "minecraft-b1.6.6" = _dqi5uP1E;
        "minecraft-b1.7" = _NyIwabgJ;
        "minecraft-b1.7.2" = _NyIwabgJ;
        "minecraft-b1.7.3" = _NyIwabgJ;
        "minecraft-b1.8" = _kqyPmcaw;
        "minecraft-b1.8.1" = _kqyPmcaw;
        "minecraft-1.0" = _kqyPmcaw;
        "minecraft-1.1" = _kqyPmcaw;
        "minecraft-1.2.1" = _kqyPmcaw;
        "minecraft-1.2.2" = _kqyPmcaw;
        "minecraft-1.2.3" = _kqyPmcaw;
        "minecraft-1.2.4" = _kqyPmcaw;
        "minecraft-1.2.5" = _kqyPmcaw;
        "minecraft-1.3" = _kqyPmcaw;
        "minecraft-1.3.1" = _kqyPmcaw;
        "minecraft-1.3.2" = _kqyPmcaw;
        "minecraft-1.4" = _cQxAI35d;
        "minecraft-1.4.1" = _cQxAI35d;
        "minecraft-1.4.2" = _cQxAI35d;
        "minecraft-1.4.3" = _cQxAI35d;
        "minecraft-1.4.4" = _cQxAI35d;
        "minecraft-1.4.5" = _cQxAI35d;
        "minecraft-1.4.6" = _cQxAI35d;
        "minecraft-1.4.7" = _cQxAI35d;
        "minecraft-1.5" = _woPshiuM;
        "minecraft-1.5.1" = _woPshiuM;
        "minecraft-1.5.2" = _woPshiuM;
        "minecraft-1.6.1" = _W0RuZjtO;
        "minecraft-1.6.2" = _W0RuZjtO;
        "minecraft-1.6.4" = _W0RuZjtO;
        "minecraft-1.7.2" = _W0RuZjtO;
        "minecraft-1.7.3" = _W0RuZjtO;
        "minecraft-1.7.4" = _W0RuZjtO;
        "minecraft-1.7.5" = _W0RuZjtO;
        "minecraft-1.7.6" = _W0RuZjtO;
        "minecraft-1.7.7" = _W0RuZjtO;
        "minecraft-1.7.8" = _W0RuZjtO;
        "minecraft-1.7.9" = _W0RuZjtO;
        "minecraft-1.7.10" = _W0RuZjtO;
        "minecraft-1.8" = _W0RuZjtO;
        "minecraft-1.8.1" = _W0RuZjtO;
        "minecraft-1.8.2" = _W0RuZjtO;
        "minecraft-1.8.3" = _W0RuZjtO;
        "minecraft-1.8.4" = _W0RuZjtO;
        "minecraft-1.8.5" = _W0RuZjtO;
        "minecraft-1.8.6" = _W0RuZjtO;
        "minecraft-1.8.7" = _W0RuZjtO;
        "minecraft-1.8.8" = _W0RuZjtO;
        "minecraft-1.8.9" = _W0RuZjtO;
        "minecraft-1.9" = _K9MSUQqn;
        "minecraft-1.9.1" = _K9MSUQqn;
        "minecraft-1.9.2" = _K9MSUQqn;
        "minecraft-1.9.3" = _K9MSUQqn;
        "minecraft-1.9.4" = _K9MSUQqn;
        "minecraft-1.10" = _CTHvSMXG;
        "minecraft-1.10.1" = _CTHvSMXG;
        "minecraft-1.10.2" = _CTHvSMXG;
        "minecraft-1.11" = _CTHvSMXG;
        "minecraft-1.11.1" = _CTHvSMXG;
        "minecraft-1.11.2" = _CTHvSMXG;
        "minecraft-1.12" = _CTHvSMXG;
        "minecraft-1.12.1" = _CTHvSMXG;
        "minecraft-1.12.2" = _CTHvSMXG;
        ...
        "minecraft-1.20.5" = _aLZDKrAO;
        "minecraft-1.20.6" = _aLZDKrAO;
        "minecraft-1.21" = _aLZDKrAO;
        "minecraft-1.21.1" = _aLZDKrAO;
        ...
        "minecraft-1.21.2" = _aLZDKrAO;
        "minecraft-1.21.3" = _aLZDKrAO;
        ...
        "minecraft-1.21.6" = _aLZDKrAO;
        "minecraft-1.21.7" = _aLZDKrAO;
        "minecraft-1.21.8" = _aLZDKrAO;
        ...
        "minecraft-1.21.9" = _aLZDKrAO;
        "minecraft-1.21.10-rc1" = _ZS1B7Chn;
        "minecraft-1.21.10" = _aLZDKrAO;
        ...
        "minecraft-1.21.11" = _aLZDKrAO;
        "minecraft-26.1-snapshot-1" = _vYcO79NP;
        "minecraft-26.1-snapshot-10" = _WE5wj3Qa;
        "minecraft-26.1-snapshot-11" = _8EpDz1mi;
        "minecraft-1.13" = _EkiuLSek;
        "minecraft-1.13.1" = _EkiuLSek;
        "minecraft-1.13.2" = _EkiuLSek;
        "minecraft-1.14" = _EkiuLSek;
        "minecraft-1.14.1" = _EkiuLSek;
        "minecraft-1.14.2" = _EkiuLSek;
        "minecraft-1.14.3" = _EkiuLSek;
        "minecraft-1.14.4" = _EkiuLSek;
        "minecraft-1.15" = _KPok7J7P;
        "minecraft-1.15.1" = _KPok7J7P;
        "minecraft-1.15.2" = _KPok7J7P;
        "minecraft-1.16" = _KPok7J7P;
        "minecraft-1.16.1" = _KPok7J7P;
        ...
        "minecraft-26.1" = _VFjnOzBb;
        "minecraft-26.1.1-rc-1" = _DqvzdrIW;
        "minecraft-26.1.1" = _VFjnOzBb;
        "minecraft-26.1.2" = _VFjnOzBb;
        ...
        "minecraft-26.2" = _VFjnOzBb;
        "minecraft-26.3-snapshot-6" = _MIMcHjGX;
        "minecraft-26.3-snapshot-7" = _MIMcHjGX;
        "minecraft-1.16.2" = _fJGO1xMV;
        "minecraft-1.16.3" = _fJGO1xMV;
        "minecraft-1.16.4" = _fJGO1xMV;
        "minecraft-1.16.5" = _fJGO1xMV;
        "minecraft-26.3-snapshot-8" = _9yjKoxXO;
        "minecraft-26.3-snapshot-9" = _9yjKoxXO;
        "minecraft-26.3-pre-1" = _QgD0P15x;
        "minecraft-26.3-pre-2" = _QgD0P15x;
        "pkg-1.0" = _PbPvseW1;
        "pkg-1.1" = _LFv1TuEI;
        "pkg-1.2" = _Qlu30aL6;
        "pkg-1.3" = _VFjnOzBb;
