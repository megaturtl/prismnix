...
let
    versions = (let
        ...
        _RExE80IN = {
            "id" = "RExE80IN";
            "file" = "Dynamic Lights v5.4 1.21.9 - 26.2.zip";
            "hash" = "sha512-SucZ64PksbbDOp4YreHZ8G1m5rQjOt1XMRvaPIp/WMsbNjkYRRbNow2XQZ96QVy7Lsa9JnE6t0OrLdBQgCV9QA==";
        };
        _N7C8uYP4 = {
            "id" = "N7C8uYP4";
            "file" = "dynamic-torches-5.4.jar";
            "hash" = "sha512-qx9ruYfNjDPcERIRdx0hSn0STISFzoydKjI5ys2y9jhdJyzdxKXwyVLErcOkKviymDn8t3EDgJxN2ocG1pgttQ==";
        };
        _zqiTZ9Xf = {
            "id" = "zqiTZ9Xf";
            "file" = "Dynamic Lights v5.4 26.3.zip";
            "hash" = "sha512-LTIlLNMJATL2sNVkjCfCFlj7WySM5XZq9Di12UEeLmyZD8+Po1pc81BjcahT0+NuTmvX3FeIprn+rGRhu1bp4g==";
        };
        _DJSC5XHi = {
            "id" = "DJSC5XHi";
            "file" = "dynamic-torches-5.4.jar";
            "hash" = "sha512-E3yBVjP4cqVWfQeHG/HQWTnjBxZyrW1tI1z4C+Da/oqbC4S9+3ZtVWMt6GOlcPfSjxYLKQamzpXMD+De2CNdTQ==";
        };
    in {
        "MpRxnRf3" = _MpRxnRf3;
        "biU0kkbn" = _biU0kkbn;
        ...
        "datapack-1.21.9" = _RExE80IN;
        "datapack-1.21.10" = _RExE80IN;
        "datapack-1.21.11" = _RExE80IN;
        "datapack-26.1" = _RExE80IN;
        "datapack-26.1.1" = _RExE80IN;
        "datapack-26.1.2" = _RExE80IN;
        "datapack-26.2" = _RExE80IN;
        "datapack-26.3" = _zqiTZ9Xf;
        ...
        "fabric-1.21.9" = _N7C8uYP4;
        "fabric-1.21.10" = _N7C8uYP4;
        "fabric-1.21.11" = _N7C8uYP4;
        "fabric-26.1" = _N7C8uYP4;
        "fabric-26.1.1" = _N7C8uYP4;
        "fabric-26.1.2" = _N7C8uYP4;
        "fabric-26.2" = _N7C8uYP4;
        "fabric-26.3" = _DJSC5XHi;
        ...
        "forge-1.21.9" = _N7C8uYP4;
        "forge-1.21.10" = _N7C8uYP4;
        "forge-1.21.11" = _N7C8uYP4;
        "forge-26.1" = _N7C8uYP4;
        "forge-26.1.1" = _N7C8uYP4;
        "forge-26.1.2" = _N7C8uYP4;
        "forge-26.2" = _N7C8uYP4;
        "forge-26.3" = _DJSC5XHi;
        ...
        "quilt-1.21.9" = _N7C8uYP4;
        "quilt-1.21.10" = _N7C8uYP4;
        "quilt-1.21.11" = _N7C8uYP4;
        "quilt-26.1" = _N7C8uYP4;
        "quilt-26.1.1" = _N7C8uYP4;
        "quilt-26.1.2" = _N7C8uYP4;
        "quilt-26.2" = _N7C8uYP4;
        "quilt-26.3" = _DJSC5XHi;
        ...
        "neoforge-1.21.9" = _N7C8uYP4;
        "neoforge-1.21.10" = _N7C8uYP4;
        "neoforge-1.21.11" = _N7C8uYP4;
        "neoforge-26.1" = _N7C8uYP4;
        "neoforge-26.1.1" = _N7C8uYP4;
        "neoforge-26.1.2" = _N7C8uYP4;
        "neoforge-26.2" = _N7C8uYP4;
        "neoforge-26.3" = _DJSC5XHi;
        "pkg-v1" = _MpRxnRf3;
        "pkg-v2" = _biU0kkbn;
