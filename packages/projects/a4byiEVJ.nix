...
let
    ...
    in {
        ...
        "pkg-2.0.1+1.21.5" = _xBO2xHVY;
        "pkg-3.0.0+1.21.5" = _ZgteQW07;
        "pkg-3.1.0+1.21.6" = _w1618yas;
        "pkg-3.2.0+1.21.7" = _BMET9tpv;
        "pkg-3.3.0+1.21.6-neoforge" = _2DqcLwJo;
        "pkg-3.3.0+1.21.6-fabric" = _23VCNbst;
        "pkg-3.3.0+1.21.7-neoforge" = _ULZEJfnb;
        "pkg-3.3.0+1.21.7-fabric" = _bKmuoDZL;
        "pkg-3.4.0+1.21.6-fabric" = _ONoxsMvv;
        "pkg-3.4.0+1.21.6-neoforge" = _Ls3299C7;
        "pkg-3.4.0+1.21.7-fabric" = _RIq0uV4m;
        "pkg-3.4.0+1.21.7-neoforge" = _gXPfscYw;
        "pkg-3.4.0+1.21.9-fabric" = _nd6korVE;
        "pkg-3.4.0+1.21.9-neoforge" = _FgGGjkVo;
        "pkg-3.4.1+1.21.6-neoforge" = _yzqKDf8c;
        "pkg-3.4.1+1.21.6-fabric" = _y1c3CrZX;
        "pkg-3.4.1+1.21.8-neoforge" = _1QGMW0cC;
        "pkg-3.4.1+1.21.8-fabric" = _vgW19Ke4;
        "pkg-3.4.1+1.21.10-neoforge" = _kUexdInK;
        "pkg-3.4.1+1.21.10-fabric" = _S9WW09Dr;
        "pkg-3.4.2+1.21.11-fabric" = _Wlx2Xk5X;
        "pkg-3.4.2+1.21.11-neoforge" = _OVXKjumQ;
        "pkg-3.4.3+26.1-fabric" = _cQEoBWmz;
