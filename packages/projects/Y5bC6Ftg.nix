...
let
    ...
    in {
        ...
        "pkg-1.21.4-0.1" = _Atzb2Nnu;
        "pkg-1.21.5-0.1" = _7lIGPSdx;
        "pkg-1.21.5-0.2" = _uq0cjf7L;
        "pkg-1.21.6-0.1" = _Ddc8zy8D;
        "pkg-1.21.7-0.1" = _3z73v71p;
        "pkg-1.21.8-0.1" = _F4CuFyZR;
        "pkg-1.21.8-0.2" = _AVCf94ED;
        "pkg-1.21.7-0.2" = _oBm7oaxh;
        "pkg-1.21.6-0.2" = _ZpR4JEIX;
        "pkg-1.21.5-0.3" = _hWoOn4e7;
        "pkg-1.21.4-0.2" = _G1N8mMlZ;
        "pkg-1.21.3-0.2" = _yFDJfdsC;
        "pkg-1.21.1-0.2" = _eA7KuS4d;
        "pkg-1.21-0.2" = _76Dfg1zC;
        "pkg-1.21.8-0.3" = _K473Qdci;
        "pkg-1.21.7-0.3" = _IArBzRWh;
        "pkg-1.21.6-0.3" = _NvttF5Sb;
        "pkg-1.21.5-0.4" = _AOliRH1a;
        "pkg-1.21.4-0.3" = _kzBKUNS3;
        "pkg-1.21.3-0.3" = _HTo3ZZ7V;
        "pkg-1.21.1-0.3" = _qREiFwZU;
        "pkg-1.21-0.3" = _bqgXizvG;
        "pkg-1.21.9-0.1" = _aGPyg1KA;
        "pkg-1.21.10-0.1" = _Hd5y8fWy;
        "pkg-1.21.11-0.1" = _SRzzIb7Z;
