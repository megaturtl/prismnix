...
let
    ...
    in {
        ...
        "pkg-0.1" = _Eo0BXkvG;
        "pkg-0.1.1" = _fByUVcNO;
        "pkg-0.1.1.1" = _8vs6xe0B;
        "pkg-0.1.1.2" = _1ZoKG2zN;
        "pkg-0.1.2" = _teB40LZQ;
        "pkg-0.1.3" = _AO4mYkOn;
        "pkg-0.1.4" = _mmpczKTW;
        "pkg-0.1.5" = _y58HEYdI;
        "pkg-0.1.5.1" = _OViL8GRq;
        "pkg-0.1.5.2" = _UeOwPiio;
        "pkg-0.1.5.3" = _5jJGEGcU;
        "pkg-0.1.5.4" = _ZJmrBe0o;
        "pkg-0.1.7" = _IaxPekv3;
        "pkg-0.1.7.1" = _M54fEo0f;
        "pkg-0.1.8" = _oEO0ARF9;
        "pkg-0.1.8.1" = _CogQ5Vv7;
        "pkg-0.1.8.2" = _hjx8Xkvg;
        "pkg-0.1.9" = _wbLsPVbx;
        "pkg-0.1.10" = _74MjvlBt;
        "pkg-0.1.11" = _k8pAlsO2;
