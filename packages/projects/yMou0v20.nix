...
let
    versions = (let
        ...
        _T6K6kcrK = {
            "id" = "T6K6kcrK";
            "file" = "ModernNetworking-fabric-2.0.0+1.18.2.jar";
            "hash" = "sha512-qAy/uDc7OeMgWSUf4fh1wnUy8jqaFZJXnfBnke7XNhcEpllgQUVWHxMGbnzPD8GOTYpMOrxCMaJiUEId2ZYKaw==";
        };
        _rhAk2Rby = {
            "id" = "rhAk2Rby";
            "file" = "ModernNetworking-fabric-2.0.1+1.18.2.jar";
            "hash" = "sha512-iqkkJWgzQZNp4oNrjFo0xCP+IT6gjpjumskBHl9DauT9ydEqVlulRf5H5guduLac2hHMUx6HNCZwuwsWbijgcw==";
        };
        _w749Mw7k = {
            "id" = "w749Mw7k";
            "file" = "ModernNetworking-fabric-2.0.1+1.19.2.jar";
            "hash" = "sha512-exmTq7pURwu1adknJortgB1gA2sVUwOotPvhDOyEaK/LeveKzJig4TrjOcoLQnqamga7HU2t7m9q65lwP06ucQ==";
        };
        _bmwT1kMx = {
            "id" = "bmwT1kMx";
            "file" = "ModernNetworking-fabric-2.0.1+1.20.4.jar";
            "hash" = "sha512-TDkv23SacIqMjRLjin16ifPm/qc6bs0MBX91GvdM9vbtXv2nP6QfUgH3vkJJ6Tu1LRcVjUGF7grmsveXUZqnCg==";
        };
        _pJTi13Iv = {
            "id" = "pJTi13Iv";
            "file" = "ModernNetworking-fabric-2.0.1+1.20.6.jar";
            "hash" = "sha512-uvnQmkmn9Owsvu2Q+CGWzG7jz3lGRaGs2BkVRmg5f+Htaz/lo16SHJ8IJd2sEYFVPoKHxLLXDVEbiVyx4atRUQ==";
        };
        _qPnrxfhI = {
            "id" = "qPnrxfhI";
            "file" = "ModernNetworking-fabric-2.0.1+1.21.1.jar";
            "hash" = "sha512-NFXGfWMy2GQYzX4KxwFcYS8i45+eCL7nRiLCtOtvSTiTMXpk6bIxe+hcnRDtonNh3neEngijslgWaAO53FOwnA==";
        };
        _q45yc3Cb = {
            "id" = "q45yc3Cb";
            "file" = "ModernNetworking-fabric-2.0.1+1.21.10.jar";
            "hash" = "sha512-rlzcT3yhDDa2MoWJ1WluSXrtexuMYojIunXX2fYufv+pTdRq0yl4C/qaUlFeYetBb16GCOnNHlxEtmbKGV9BGQ==";
        };
        _7tfTF1x4 = {
            "id" = "7tfTF1x4";
            "file" = "ModernNetworking-fabric-2.0.1+1.21.11.jar";
            "hash" = "sha512-/GrU4xXGcZwzn0Arm3XZ+5JzngLKmf6+7d9evP7PemiZircXhUnaEalUFWnjPPjCmRzl42Ob3m6NIbwgm5Q/Dg==";
        };
        _BM2Xgl57 = {
            "id" = "BM2Xgl57";
            "file" = "ModernNetworking-fabric-2.0.1+1.21.8.jar";
            "hash" = "sha512-GHCtX/jOZQtILiqLz9Jygi+NrWDgQQBdVIBUqyHnWxTKpq3K/Lh2UzddA1h5Vl7jH1iwNT4L5fjFvgyxrz3gWw==";
        };
        _dq6C1rW6 = {
            "id" = "dq6C1rW6";
            "file" = "ModernNetworking-fabric-2.0.1+26.1.2.jar";
            "hash" = "sha512-wpJHXerTS0fK0Bo7u+TECld5Gvk3YnwYk9llLI1UEPWrzxzQ+bhe+hcYhLV1px1VOCfvvwfNe8DrUsHYQpAKTg==";
        };
        _PzP3uaIq = {
            "id" = "PzP3uaIq";
            "file" = "ModernNetworking-forge-2.0.1+1.18.2.jar";
            "hash" = "sha512-QKLAScsczQhaJPezH3S7AwRfpb8X1eNPnVj7UQbB3IKFeHzYohvrvWNdfV07v/v1gIBFnC6mOxQEOgywA7QXRQ==";
        };
        _zNZdk1nr = {
            "id" = "zNZdk1nr";
            "file" = "ModernNetworking-forge-2.0.1+1.19.2.jar";
            "hash" = "sha512-o9V+ehaQQijTVRmSw1eOENBh6OvjbDAqP1krorCXUikaqoPDDz9hFqoPWG6yYgiUoKxVYjG1LpzC2BP3eOdgVg==";
        };
        _Y0r4o6tx = {
            "id" = "Y0r4o6tx";
            "file" = "ModernNetworking-neoforge-2.0.1+1.20.4.jar";
            "hash" = "sha512-oTIJtfpodLn3ryy2GN+/Im4nsfx5P6tzp84Isuz5lYkkRGrTwbYoOCzx7SF39G9rAz8aZZHsgMvdYdkb09CgoQ==";
        };
        _39GdwGIn = {
            "id" = "39GdwGIn";
            "file" = "ModernNetworking-neoforge-2.0.1+1.20.6.jar";
            "hash" = "sha512-1suWtllT+Sm2elqoGf1etbLmqR6dmojH+1X6ELPxqLhXNE9VO5txPE7cZsHxfXdty2ES8JIbGucWPKoMy+ZrNg==";
        };
        _OpsR4tnJ = {
            "id" = "OpsR4tnJ";
            "file" = "ModernNetworking-neoforge-2.0.1+1.21.1.jar";
            "hash" = "sha512-PN8G6zwOgSxfmVHP9GlorFxNAdhTFAFiIZyRUImYL0NQljFfzk2TvCut4BOU1scgiHT8+oDTeV84KbbriYveeg==";
        };
        _9GuWRYzz = {
            "id" = "9GuWRYzz";
            "file" = "ModernNetworking-neoforge-2.0.1+1.21.10.jar";
            "hash" = "sha512-pZ8e3aD68tvCJY58l1jSD7kiPgOfwuGMgaAEUFoyaXIekLXXlW3oQTJZhUlhcSkCwfx/qJu8KW5gRQpj2T219g==";
        };
        _n4RK9kh4 = {
            "id" = "n4RK9kh4";
            "file" = "ModernNetworking-neoforge-2.0.1+1.21.11.jar";
            "hash" = "sha512-dIsKDeuWG+LrDzwW0ZLBg9OwVII5fPID68P0t6HfXXVmzs1prd4fWITWykLl68ik5fxt/IA6YdNCxwgBecyH+g==";
        };
        _vpU13tN8 = {
            "id" = "vpU13tN8";
            "file" = "ModernNetworking-neoforge-2.0.1+1.21.8.jar";
            "hash" = "sha512-/VGky7Ty6QqCoRAYU6i8bv9VOQwV4P44VP1FU7mI+I2whYanemccqazAB7UY6wJ+UParA4vRYOZ7L+ORbsQHgg==";
        };
        _beLMIG1b = {
            "id" = "beLMIG1b";
            "file" = "ModernNetworking-neoforge-2.0.1+26.1.2.jar";
            "hash" = "sha512-HdMRNg3sGxigXeR0llxerfIE+H2Qtdm4P+aZiwGzOsEXMm7/QinOMi2S+kjrZ9MQssLnM1D+vgiJ0WP9ZjADfQ==";
        };
    in {
        "McokpKtn" = _McokpKtn;
        "7mHy5nes" = _7mHy5nes;
        ...
        "vpU13tN8" = _vpU13tN8;
        "beLMIG1b" = _beLMIG1b;
        "fabric-1.21" = _qPnrxfhI;
        "fabric-1.21.1" = _qPnrxfhI;
        "fabric-1.21.2" = _qPnrxfhI;
        "fabric-1.21.3" = _qPnrxfhI;
        "fabric-1.21.4" = _qPnrxfhI;
        "fabric-1.21.5" = _qPnrxfhI;
        "fabric-1.18" = _rhAk2Rby;
        "fabric-1.18.1" = _rhAk2Rby;
        "fabric-1.18.2" = _rhAk2Rby;
        "fabric-1.19" = _w749Mw7k;
        "fabric-1.19.1" = _w749Mw7k;
        "fabric-1.19.2" = _w749Mw7k;
        "fabric-1.20" = _w749Mw7k;
        "fabric-1.20.1" = _w749Mw7k;
        "fabric-1.20.2" = _bmwT1kMx;
        "fabric-1.20.3" = _bmwT1kMx;
        "fabric-1.20.4" = _bmwT1kMx;
        "fabric-1.20.5" = _pJTi13Iv;
        "fabric-1.20.6" = _pJTi13Iv;
        "fabric-1.21.6" = _BM2Xgl57;
        "fabric-1.21.7" = _BM2Xgl57;
        "fabric-1.21.8" = _BM2Xgl57;
        "fabric-1.19.3" = _w749Mw7k;
        "fabric-1.19.4" = _w749Mw7k;
        "fabric-1.21.9" = _q45yc3Cb;
        "fabric-1.21.10" = _q45yc3Cb;
        "fabric-1.21.11" = _7tfTF1x4;
        "fabric-26.1" = _dq6C1rW6;
        "fabric-26.1.1" = _dq6C1rW6;
        "fabric-26.1.2" = _dq6C1rW6;
        "fabric-26.2" = _dq6C1rW6;
        "neoforge-1.20.5" = _39GdwGIn;
        "neoforge-1.20.6" = _39GdwGIn;
        "neoforge-1.21" = _OpsR4tnJ;
        "neoforge-1.21.1" = _OpsR4tnJ;
        "neoforge-1.21.2" = _OpsR4tnJ;
        "neoforge-1.21.3" = _OpsR4tnJ;
        "neoforge-1.21.4" = _OpsR4tnJ;
        "neoforge-1.21.5" = _OpsR4tnJ;
        "neoforge-1.20.2" = _Y0r4o6tx;
        "neoforge-1.20.3" = _Y0r4o6tx;
        "neoforge-1.20.4" = _Y0r4o6tx;
        "neoforge-1.21.6" = _vpU13tN8;
        "neoforge-1.21.7" = _vpU13tN8;
        "neoforge-1.21.8" = _vpU13tN8;
        "neoforge-1.21.9" = _9GuWRYzz;
        "neoforge-1.21.10" = _9GuWRYzz;
        "neoforge-1.21.11" = _n4RK9kh4;
        "neoforge-26.1" = _beLMIG1b;
        "neoforge-26.1.1" = _beLMIG1b;
        "neoforge-26.1.2" = _beLMIG1b;
        "neoforge-26.2" = _beLMIG1b;
        "forge-1.18" = _PzP3uaIq;
        "forge-1.18.1" = _PzP3uaIq;
        "forge-1.18.2" = _PzP3uaIq;
        "forge-1.19" = _zNZdk1nr;
        "forge-1.19.1" = _zNZdk1nr;
        "forge-1.19.2" = _zNZdk1nr;
        "forge-1.20" = _zNZdk1nr;
        "forge-1.20.1" = _zNZdk1nr;
        ...
        "forge-1.19.3" = _zNZdk1nr;
        "forge-1.19.4" = _zNZdk1nr;
        ...
        "pkg-1.0.0+1.21.1-fabric" = _McokpKtn;
        "pkg-1.0.0+1.20.6-neoforge" = _7mHy5nes;
        "pkg-1.0.0+1.21.1-neoforge" = _mvNA0OMK;
        "pkg-1.0.0+1.18.2-forge" = _3ni2UI0S;
        "pkg-1.0.0+1.21.1-forge" = _mzY3FcDG;
        "pkg-1.0.0+1.20.4-neoforge" = _4HEEB0eu;
        "pkg-1.0.0+1.18.2-fabric" = _sVqhDhjT;
        "pkg-1.0.0+1.20.4-fabric" = _LsUl5r4g;
        "pkg-1.0.0+1.20.6-forge" = _NU9UJ7u4;
        "pkg-1.0.0+1.20.6-fabric" = _6ORvkAI3;
        "pkg-1.0.0+1.20.4-forge" = _6N5dyRzu;
        "pkg-1.0.1-bukkit" = _z8EKVBRe;
        "pkg-1.0.1+1.21.1-neoforge" = _xDWXlS4r;
        "pkg-1.0.1+1.21.1-fabric" = _BUTE6y4Y;
        "pkg-1.0.1+1.20.4-neoforge" = _hiPq4FTD;
        "pkg-1.0.1+1.18.2-forge" = _6AQN1SPw;
        "pkg-1.0.1+1.21.1-forge" = _vGN7Vcyn;
        "pkg-1.0.1+1.20.4-forge" = _66N04CRj;
        "pkg-1.0.1+1.20.6-forge" = _tBJDsV9Q;
        "pkg-1.0.1+1.20.6-fabric" = _IkBAsRsZ;
        "pkg-1.0.1+1.20.4-fabric" = _LAMTMxDZ;
        "pkg-1.0.1+1.18.2-fabric" = _OabWTbIK;
        "pkg-1.0.1+1.20.6-neoforge" = _dhxeRjJt;
        "pkg-1.1.0-bukkit" = _sB4omEzs;
        "pkg-1.1.0+1.21.1-fabric" = _xeUxQhAH;
        "pkg-1.1.0+1.20.4-neoforge" = _mrkzTYLM;
        "pkg-1.1.0+1.20.4-forge" = _l71gIjB9;
        "pkg-1.1.0+1.21.1-neoforge" = _ZjoUj1M6;
        "pkg-1.1.0+1.21.1-forge" = _ey1ZtDww;
        "pkg-1.1.0+1.20.6-neoforge" = _ks7P6x9Y;
        "pkg-1.1.0+1.20.6-forge" = _IkXxESd4;
        "pkg-1.1.0+1.18.2-forge" = _z6rchQAL;
        "pkg-1.1.0+1.20.6-fabric" = _cZpPuqF8;
        "pkg-1.1.0+1.20.4-fabric" = _dAGracV6;
        "pkg-1.1.0+1.18.2-fabric" = _oFJqQTMQ;
        "pkg-1.1.1-bukkit" = _J7iMfxMR;
        "pkg-1.1.1+1.21.1-neoforge" = _HxkQi2g7;
        "pkg-1.1.1+1.20.6-neoforge" = _qBG9rJBE;
        "pkg-1.1.1+1.20.4-forge" = _u8k7t5Rs;
        "pkg-1.1.1+1.20.6-forge" = _TlP8ECt1;
        "pkg-1.1.1+1.20.4-neoforge" = _FlhuUYQ5;
        "pkg-1.1.1+1.21.1-forge" = _E4RzBs6s;
        "pkg-1.1.1+1.21.1-fabric" = _SQpbc41o;
        "pkg-1.1.1+1.18.2-forge" = _U9Zd7hQ0;
        "pkg-1.1.1+1.20.6-fabric" = _cTBI8JmV;
        "pkg-1.1.1+1.20.4-fabric" = _W2QbVWa9;
        "pkg-1.1.1+1.18.2-fabric" = _BZQ9HRec;
        "pkg-1.1.2-bukkit" = _VAbY6OX8;
        "pkg-1.1.2-velocity" = _e64eykZo;
        "pkg-1.1.3-bukkit" = _QQcd3YiQ;
        "pkg-1.1.3-velocity" = _3nAMeFLF;
        "pkg-1.1.3+1.21.1-neoforge" = _l8YA4JYK;
        "pkg-1.1.3+1.20.4-neoforge" = _33okv1FJ;
        "pkg-1.1.3+1.21.1-fabric" = _nJXF64A3;
        "pkg-1.1.3+1.20.6-neoforge" = _fRH0e1yP;
        "pkg-1.1.3+1.20.4-forge" = _Qrh9HTfZ;
        "pkg-1.1.3+1.18.2-forge" = _zN8mVdOu;
        "pkg-1.1.3+1.21.1-forge" = _89ra2tZY;
        "pkg-1.1.3+1.20.6-forge" = _AR6k7jKq;
        "pkg-1.1.3+1.20.6-fabric" = _fWVt7JuV;
        "pkg-1.1.3+1.18.2-fabric" = _isiLV6Nw;
        "pkg-1.1.3+1.20.4-fabric" = _eIfMCyIP;
        "pkg-1.1.4-velocity" = _3JVqoWFS;
        "pkg-1.1.4-bukkit" = _EG5Gdcp2;
        "pkg-1.1.4+1.20.6-neoforge" = _j1a4PGTe;
        "pkg-1.1.4+1.21.1-fabric" = _R05eoA6J;
        "pkg-1.1.4+1.21.1-neoforge" = _ubdUKJWK;
        "pkg-1.1.4+1.20.4-neoforge" = _MsHlQIZz;
        "pkg-1.1.4+1.18.2-forge" = _49L2hJFd;
        "pkg-1.1.4+1.21.1-forge" = _ALGZIQL5;
        "pkg-1.1.4+1.20.4-forge" = _GJEYAkv4;
        "pkg-1.1.4+1.20.6-forge" = _3tC9D39s;
        "pkg-1.1.4+1.20.4-fabric" = _8jnTOu6Q;
        "pkg-1.1.4+1.20.6-fabric" = _2sMKL5jD;
        "pkg-1.1.4+1.18.2-fabric" = _fKJGzRAW;
        "pkg-1.1.5-bukkit" = _QMvdV0i2;
        "pkg-1.1.5-velocity" = _CjEJ48Gh;
        "pkg-1.1.5+1.21.1-neoforge" = _EZ7xYj4c;
        "pkg-1.1.5+1.20.6-neoforge" = _m9j597VX;
        "pkg-1.1.5+1.20.4-neoforge" = _L8M0yNl3;
        "pkg-1.1.5+1.21.1-forge" = _GcvIiLcg;
        "pkg-1.1.5+1.21.1-fabric" = _kL9sqgta;
        "pkg-1.1.5+1.20.6-forge" = _ZuWNladz;
        "pkg-1.1.5+1.20.6-fabric" = _Lbto2Mji;
        "pkg-1.1.5+1.20.4-fabric" = _C25HPVLW;
        "pkg-1.1.5+1.18.2-fabric" = _ThzbHE9t;
        "pkg-1.1.5+1.20.4-forge" = _GpvfVLKl;
        "pkg-1.1.5+1.18.2-forge" = _zEiQC2xE;
        "pkg-1.2.0-bukkit" = _NbRHAe5P;
        "pkg-1.2.0-velocity" = _HiE1EUE1;
        "pkg-1.2.0+1.20.4-neoforge" = _hJRbwYI4;
        "pkg-1.2.0+1.21.1-neoforge" = _sknIBM6v;
        "pkg-1.2.0+1.21.1-forge" = _C95sBjPD;
        "pkg-1.2.0+1.20.4-forge" = _AkP6qYth;
        "pkg-1.2.0+1.20.6-neoforge" = _7u6xXTD7;
        "pkg-1.2.0+1.19.2-forge" = _fM2vAR7D;
        "pkg-1.2.0+1.18.2-forge" = _d4hoafb0;
        "pkg-1.2.0+1.21.1-fabric" = _2fuk3mXc;
        "pkg-1.2.0+1.20.6-fabric" = _QEwWNx9L;
        "pkg-1.2.0+1.20.4-fabric" = _QHaKCvgk;
        "pkg-1.2.0+1.18.2-fabric" = _elFVtcZA;
        "pkg-1.2.0+1.20.6-forge" = _uoxZqE1T;
        "pkg-1.2.2+1.20.4-fabric" = _TYCJNnMq;
        "pkg-1.2.2+1.18.2-fabric" = _KWyCbw4B;
        "pkg-1.2.2+1.18.2-forge" = _8D3GJZ6L;
        "pkg-1.2.2+1.21.1-fabric" = _WTCUjcI5;
        "pkg-1.2.2+1.21.10-fabric" = _1PVucmVi;
        "pkg-1.2.2+1.19.2-forge" = _t7ncfuPz;
        "pkg-1.2.2+1.20.6-fabric" = _NCAbeMg7;
        "pkg-1.2.2+1.20.6-neoforge" = _x2pnOPrz;
        "pkg-1.2.2+1.20.4-neoforge" = _rflRFROF;
        "pkg-1.2.2+1.21.7-neoforge" = _twiluX8x;
        "pkg-1.2.2+1.21.1-neoforge" = _xpw0zDVS;
        "pkg-1.2.2-bukkit" = _sySrpCBW;
        "pkg-1.2.2+1.21.10-neoforge" = _RvTexXJt;
        "pkg-1.2.2-velocity" = _kHCfoFyI;
        "pkg-1.2.2+1.20.4-forge" = _t8b1gpT3;
        "pkg-1.2.3-bukkit" = _jSyEI8Pi;
        "pkg-1.2.3+1.18.2-fabric" = _ksflKmmx;
        "pkg-1.2.3-velocity" = _R0e8R0jF;
        "pkg-1.2.3+1.20.4-fabric" = _5oBiJu9v;
        "pkg-1.2.3+1.20.6-fabric" = _fQQxKVd8;
        "pkg-1.2.3+1.21.1-fabric" = _Gp2kTycz;
        "pkg-1.2.3+1.21.10-fabric" = _i5J9Qksv;
        "pkg-1.2.3+1.18.2-forge" = _AivrBuKE;
        "pkg-1.2.3+1.19.2-forge" = _omhKcs9w;
        "pkg-1.2.3+1.20.4-forge" = _UuawazMs;
        "pkg-1.2.3+1.20.4-neoforge" = _UlxfRU25;
        "pkg-1.2.3+1.20.6-neoforge" = _bccKXwcU;
        "pkg-1.2.3+1.21.1-neoforge" = _R6FFxOX3;
        "pkg-1.2.3+1.21.10-neoforge" = _Ss6jFI0F;
        "pkg-1.2.3+1.21.7-neoforge" = _NVQJ8K8O;
        "pkg-1.2.4-bukkit" = _7jcznrh3;
        "pkg-1.2.4+1.18.2-fabric" = _O685ga1f;
        "pkg-1.2.4+1.20.4-fabric" = _2S69dLyd;
        "pkg-1.2.4+1.20.6-fabric" = _fEcS5WS4;
        "pkg-1.2.4-velocity" = _A4QE4yZ3;
        "pkg-1.2.4+1.21.1-fabric" = _MCRVGGAN;
        "pkg-1.2.4+1.18.2-forge" = _QmaOsJjX;
        "pkg-1.2.4+1.19.2-forge" = _81TidSBh;
        "pkg-1.2.4+1.20.4-forge" = _ulW5d19M;
        "pkg-1.2.4+1.21.10-fabric" = _lz9u9b9Q;
        "pkg-1.2.4+1.20.4-neoforge" = _FXhli3Kj;
        "pkg-1.2.4+1.21.1-neoforge" = _DZhT2u7t;
        "pkg-1.2.4+1.21.10-neoforge" = _L8a8KXhD;
        "pkg-1.2.4+1.20.6-neoforge" = _ptt1OVPP;
        "pkg-1.2.4+1.21.7-neoforge" = _HAvjavRs;
        "pkg-1.2.5+1.20.4-fabric" = _YVoUqjer;
        "pkg-1.2.5+1.18.2-fabric" = _ZUoF8tTo;
        "pkg-1.2.5+1.21.1-fabric" = _lPGfUq8a;
        "pkg-1.2.5+1.20.6-fabric" = _EiJSvFoI;
        "pkg-1.2.5-bukkit" = _iqEc6hzx;
        "pkg-1.2.5-velocity" = _Pqg95Oeh;
        "pkg-1.2.5+1.21.10-fabric" = _wEBpWzDj;
        "pkg-1.2.5+1.18.2-forge" = _bCrfp9Yw;
        "pkg-1.2.5+1.19.2-forge" = _147hjHFv;
        "pkg-1.2.5+1.20.4-forge" = _4TjtDocB;
        "pkg-1.2.5+1.20.4-neoforge" = _O8HrTYmk;
        "pkg-1.2.5+1.20.6-neoforge" = _z1kAmeWK;
        "pkg-1.2.5+1.21.1-neoforge" = _8hd2AC7r;
        "pkg-1.2.5+1.21.7-neoforge" = _2nWZC1Sw;
        "pkg-1.2.5+1.21.10-neoforge" = _jvBj0FzI;
        "pkg-1.2.6+1.20.4-fabric" = _WF0k0aOK;
        "pkg-1.2.6+1.18.2-fabric" = _vj7MzLPX;
        "pkg-1.2.6-bukkit" = _gDvd8oYw;
        "pkg-1.2.6+1.21.1-fabric" = _htH5oB8d;
        "pkg-1.2.6+1.20.6-fabric" = _9JczJLhh;
        "pkg-1.2.6-velocity" = _1YTAhGVK;
        "pkg-1.2.6+1.21.10-fabric" = _SvvsHJzH;
        "pkg-1.2.6+1.19.2-forge" = _nmxil04T;
        "pkg-1.2.6+1.18.2-forge" = _WSkzNkr1;
        "pkg-1.2.6+1.20.4-forge" = _VIv0kTrO;
        "pkg-1.2.6+1.20.4-neoforge" = _9a6eJQ57;
        "pkg-1.2.6+1.20.6-neoforge" = _QaSH7Lbm;
        "pkg-1.2.6+1.21.1-neoforge" = _IqQD0CE8;
        "pkg-1.2.6+1.21.10-neoforge" = _1oA378aX;
        "pkg-1.2.6+1.21.7-neoforge" = _etXCVUlA;
        "pkg-1.2.7-bukkit" = _PzRdMkQx;
        "pkg-1.2.7+1.18.2-fabric" = _tkeJLUqK;
        "pkg-1.2.7+1.20.4-fabric" = _IoypuxhD;
        "pkg-1.2.7+1.21.1-fabric" = _2NybPE4o;
        "pkg-1.2.7+1.20.6-fabric" = _kpEZdjg2;
        "pkg-1.2.7+1.18.2-forge" = _Ojxm2m8W;
        "pkg-1.2.7+1.21.10-fabric" = _qF9lTDr1;
        "pkg-1.2.7+1.19.2-forge" = _Jry7NwWB;
        "pkg-1.2.7+1.20.4-forge" = _B4lbLT7q;
        "pkg-1.2.7+1.20.4-neoforge" = _jYY4Vu1L;
        "pkg-1.2.7+1.20.6-neoforge" = _tHZ6ZCTm;
        "pkg-1.2.7-velocity" = _70cr6F0U;
        "pkg-1.2.7+1.21.1-neoforge" = _d1809Tq4;
        "pkg-1.2.7+1.21.10-neoforge" = _ec88GlMq;
        "pkg-1.2.7+1.21.7-neoforge" = _7i1kPro6;
        "pkg-1.2.8+1.18.2-fabric" = _Xuyqs06X;
        "pkg-1.2.8+1.20.4-fabric" = _8LfX2REv;
        "pkg-1.2.8+1.18.2-forge" = _jgwx6IAI;
        "pkg-1.2.8+1.21.1-fabric" = _hUPv5DQ5;
        "pkg-1.2.8+1.20.6-fabric" = _xuUfZdBt;
        "pkg-1.2.8+1.21.11-fabric" = _y2Yd8oNJ;
        "pkg-1.2.8+1.21.10-fabric" = _F9l3kKCj;
        "pkg-1.2.8-bukkit" = _mhd015p2;
        "pkg-1.2.8-velocity" = _AIy0rQsQ;
        "pkg-1.2.8+1.19.2-forge" = _Z5e4EDMB;
        "pkg-1.2.8+1.20.6-neoforge" = _CJQ5rKkc;
        "pkg-1.2.8+1.20.4-forge" = _wKSWIEEI;
        "pkg-1.2.8+1.20.4-neoforge" = _b1KXYpx9;
        "pkg-1.2.8+1.21.1-neoforge" = _yLdPC5Ye;
        "pkg-1.2.8+1.21.10-neoforge" = _jlFFB88R;
        "pkg-1.2.8+1.21.11-neoforge" = _PFaPb5ps;
        "pkg-1.2.8+1.21.7-neoforge" = _Lsi7xFkr;
        "pkg-2.0.0+1.18.2-fabric" = _T6K6kcrK;
        "pkg-2.0.1+1.18.2-fabric" = _rhAk2Rby;
        "pkg-2.0.1+1.19.2-fabric" = _w749Mw7k;
        "pkg-2.0.1+1.20.4-fabric" = _bmwT1kMx;
        "pkg-2.0.1+1.20.6-fabric" = _pJTi13Iv;
        "pkg-2.0.1+1.21.1-fabric" = _qPnrxfhI;
        "pkg-2.0.1+1.21.10-fabric" = _q45yc3Cb;
        "pkg-2.0.1+1.21.11-fabric" = _7tfTF1x4;
        "pkg-2.0.1+1.21.8-fabric" = _BM2Xgl57;
        "pkg-2.0.1+26.1.2-fabric" = _dq6C1rW6;
        "pkg-2.0.1+1.18.2-forge" = _PzP3uaIq;
        "pkg-2.0.1+1.19.2-forge" = _zNZdk1nr;
        "pkg-2.0.1+1.20.4-neoforge" = _Y0r4o6tx;
        "pkg-2.0.1+1.20.6-neoforge" = _39GdwGIn;
        "pkg-2.0.1+1.21.1-neoforge" = _OpsR4tnJ;
        "pkg-2.0.1+1.21.10-neoforge" = _9GuWRYzz;
        "pkg-2.0.1+1.21.11-neoforge" = _n4RK9kh4;
        "pkg-2.0.1+1.21.8-neoforge" = _vpU13tN8;
        "pkg-2.0.1+26.1.2-neoforge" = _beLMIG1b;
        "default" = _beLMIG1b;
    });
