...
let
    ...
    in {
        ...
        "pkg-1.2.2" = _LV5jkO7Q;
        "pkg-1.2.3" = _IqPsCegw;
        "pkg-1.2.4-Forge" = _ouZmzVmW;
        "pkg-1.2.4-Fabric" = _CgXwLXrN;
        "pkg-1.2.5-Forge" = _y6LvYOgL;
        "pkg-1.2.5-Fabric" = _9Rq2igl6;
        "pkg-1.2.6-Forge" = _mmIQxK7e;
        "pkg-1.2.6-Fabric" = _nfPIQRRv;
        "pkg-1.3.0-Forge" = _SXeEDxmB;
        "pkg-1.3.0-Fabric" = _5O6EttXz;
        "pkg-1.3.1-Forge" = _KslEDeor;
        "pkg-1.3.1-Fabric" = _eOKwDHqJ;
        "pkg-1.3.2-Forge" = _3Nhvq8ZJ;
        "pkg-1.3.2-Fabric" = _rUs6Hg2K;
        "pkg-1.3.3-Forge" = _6OUub0rc;
        "pkg-1.3.3-Fabric" = _iiYRb2Hg;
        "default" = _iiYRb2Hg;
    });
