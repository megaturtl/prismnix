...
let
    ...
    in {
        ...
        "pkg-0.2" = _Slc17gdg;
        "pkg-0.2+mod" = _mA4JFWyg;
        "pkg-1.3.0" = _HjeKkfae;
        "pkg-1.3.0+mod" = _o1TkSU7P;
        "pkg-1.3.1" = _6fmO9pXQ;
        "pkg-1.3.1+mod" = _9gs5ZcLQ;
        "pkg-1.4.0" = _2PYaa0x4;
        "pkg-1.4.0+mod" = _hjVhvwkx;
        "pkg-1.4.1" = _xFdtGsMn;
        "pkg-1.4.1+mod" = _sLbfB1Q6;
        "pkg-1.5.0" = _JvpbDmkj;
        "pkg-1.5.0+mod" = _S6ctVlom;
        "pkg-1.5.1" = _MzYy3kL6;
        "pkg-1.5.1+mod" = _hrh0gGex;
        "pkg-1.5.2" = _9EqQ8i21;
        "pkg-1.5.2+mod" = _gj8HHyrC;
        "pkg-1.5.3" = _70lS8XsG;
        "pkg-1.5.3+mod" = _CddTWJjH;
        "pkg-1.5.4" = _DgkgkM55;
        "pkg-1.5.4+mod" = _hRjgWGNu;
        "pkg-1.5.5" = _82v9KjVB;
        "pkg-1.5.5+mod" = _Zcbfm6aC;
        "pkg-1.5.6" = _OSQ59poY;
        "pkg-1.5.6+mod" = _VcAQ9QSi;
        "pkg-1.6.0" = _xuZKViM8;
        "pkg-1.6.0+mod" = _QbjSyDKJ;
        "pkg-1.6.1" = _hJjB7tDC;
        "pkg-1.6.1+mod" = _tEHVPgta;
        "pkg-1.6.2" = _pyDDkkAC;
        "pkg-1.6.2+mod" = _IX1TvK7e;
        "pkg-1.6.3" = _GLXmWhnf;
        "pkg-1.6.3+mod" = _Vu7afFvf;
        "pkg-1.7.0" = _AgU0uV9U;
        "pkg-1.7.0+mod" = _j6sFptyk;
        "pkg-1.7.1" = _XQ2cyctt;
        "pkg-1.7.1+mod" = _bnGi6FWa;
        "pkg-1.7.2" = _qLwDuIdr;
        "pkg-1.7.2+mod" = _pWZtgC8x;
        "pkg-1.8.0" = _usr6Umid;
        "pkg-1.8.0+mod" = _otDYlmV3;
        "pkg-1.8.1" = _Cttn2fAo;
        "pkg-1.8.1+mod" = _nhZ23Tbs;
        "pkg-1.8.2" = _1KM3Sdxb;
        "pkg-1.8.2+mod" = _4BIpNCU7;
        "pkg-1.8.3" = _tjAKiS4Z;
        "pkg-1.8.3+mod" = _nmVPMUyD;
        "pkg-1.8.4" = _oQhDBjgF;
        "pkg-1.8.4+mod" = _XhG9gsv7;
        "pkg-1.8.5" = _dtMspp4A;
        "pkg-1.8.5+mod" = _CNWxuKW9;
        "pkg-1.9.0" = _eRvK73Bq;
        "pkg-1.9.0+mod" = _jnGWmXTX;
        "pkg-1.9.1" = _kfFT2mam;
        "pkg-1.9.1+mod" = _L8nqP394;
        "pkg-1.9.2" = _5qSymcOk;
        "pkg-1.9.2+mod" = _24lFr7v7;
        "pkg-1.9.3" = _4pzSROQS;
        "pkg-1.9.3+mod" = _jmINTRY7;
        "pkg-1.9.4" = _gHmwuUP8;
        "pkg-1.9.4+mod" = _1x2emuEd;
        "pkg-1.9.5" = _mfnS5m63;
        "pkg-1.9.5+mod" = _JjUjXRVo;
        "pkg-1.9.6" = _2Ql8txBH;
        "pkg-1.9.6+mod" = _suLihArF;
        "pkg-1.9.7" = _BlO6mcHo;
        "pkg-1.9.7+mod" = _Xtw2seEL;
        "pkg-1.10.0" = _YRn6o53q;
        "pkg-1.10.0+mod" = _1T4ghBMD;
        "pkg-1.10.1" = _RqAz7S6m;
        "pkg-1.10.1+mod" = _sdTMCf6g;
        "pkg-1.10.2" = _CktXCkxf;
        "pkg-1.10.2+mod" = _RRiZgBm2;
        "pkg-1.10.3" = _AEwKcStb;
        "pkg-1.10.3+mod" = _mKi5a96L;
        "default" = _mKi5a96L;
    });
