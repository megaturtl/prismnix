...
let
    ...
    in {
        ...
        "pkg-1.8.0" = _wsAbZhqk;
        "pkg-1.8.1" = _c9GNLsi2;
        "pkg-fabric-1.21.1-1.8.1" = _Qb6m2ITi;
        "pkg-neoforge-1.21.1-1.8.1" = _eBc9Y0Ku;
        "pkg-fabric-1.21.1-1.8.2" = _qcAbnihU;
        "pkg-neoforge-1.21.1-1.8.2" = _FlQEh8ON;
        "pkg-fabric-1.21.3-1.8.2" = _cBVcVjnY;
        "pkg-neoforge-1.21.3-1.8.2" = _7POJOMBU;
        "pkg-fabric-1.21.3-1.8.3" = _dIEhNiMa;
        "pkg-neoforge-1.21.3-1.8.3" = _Qpg6J1u2;
        "pkg-fabric-1.21.4-1.8.3" = _jdydiqQo;
        "pkg-neoforge-1.21.4-1.8.3" = _StYSWfK2;
        "pkg-fabric-1.20.4-1.9.0" = _koTEj4FX;
        "pkg-neoforge-1.20.4-1.9.0" = _u5XR7GOm;
        "pkg-forge-1.20.4-1.9.0" = _p3rAGGMk;
        "pkg-fabric-1.20.6-1.9.0" = _3blmY46t;
        "pkg-neoforge-1.20.6-1.9.0" = _xmXg2jJ7;
        "pkg-fabric-1.21.1-1.9.0" = _pFypzrD1;
        "pkg-neoforge-1.21.1-1.9.0" = _BEpXGEvn;
        "pkg-fabric-1.21.4-1.9.0" = _3lldfP4h;
        "pkg-neoforge-1.21.4-1.9.0" = _AppdnJBn;
        "pkg-fabric-1.20.1-2.0.0" = _MCaQX97J;
        "pkg-forge-1.20.1-2.0.0" = _7TXJbdEY;
        "pkg-fabric-1.20.4-2.0.0" = _onVN9Uy7;
        "pkg-forge-1.20.4-2.0.0" = _7E1GBCTD;
        "pkg-fabric-1.20.6-2.0.0" = _eflCAqW7;
        "pkg-neoforge-1.20.6-2.0.0" = _zUmjqe2U;
        "pkg-fabric-1.21.1-2.0.0" = _QBqeHY1t;
        "pkg-neoforge-1.21.1-2.0.0" = _uBrND6yn;
        "pkg-fabric-1.21.4-2.0.0" = _8gY6LyiR;
        "pkg-neoforge-1.21.4-2.0.0" = _CoRSKg1F;
        "pkg-neoforge-1.20.4-2.0.0" = _D5LefDPA;
        "pkg-fabric-1.21.5-2.0.1" = _mHUTT9eG;
        "pkg-neoforge-1.21.5-2.0.1" = _xMnwB3Qb;
        "pkg-fabric-1.21.6-2.0.1" = _AQey6MHs;
        "pkg-neoforge-1.21.6-2.0.1" = _KtVyFutA;
        "pkg-fabric-1.21.6-2.1.0" = _WhC4Et1m;
        "pkg-neoforge-1.21.6-2.1.0" = _wdFf0VE9;
        "pkg-fabric-1.21.7-2.1.0" = _wDP19jWw;
        "pkg-neoforge-1.21.7-2.1.0" = _6BoEu7O4;
        "pkg-fabric-1.21.8-2.1.0" = _Jf2mmqTM;
        "pkg-neoforge-1.21.8-2.1.0" = _4E2B5n2n;
        "pkg-fabric-1.21.9-2.2.0" = _fpwd5s9X;
        "pkg-neoforge-1.21.9-2.2.0" = _FVMrrBAA;
        "pkg-fabric-1.21.10-2.2.0" = _pNdpvk8t;
        "pkg-neoforge-1.21.10-2.2.0" = _xhyXQeMI;
        "pkg-fabric-1.21.11-2.2.0" = _rjYGg6Vu;
        "pkg-neoforge-1.21.11-2.2.0" = _2ELNuids;
        "pkg-fabric-26.1.2-2.2.0" = _f4j6VwyG;
        "pkg-neoforge-26.1.2-2.2.0" = _p2aVGiuv;
        "pkg-fabric-26.1.2-2.2.1" = _WQbN3Zxu;
