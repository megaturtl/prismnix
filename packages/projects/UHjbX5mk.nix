...
let
    versions = (let
        ...
        _oeQPTCFH = {
            "id" = "oeQPTCFH";
            "file" = "gugle-carpet-addition-v2.12.7+build.96.jar";
            "hash" = "sha512-JM179wp6XdD/FIqbqykuzru8Z/eBjCH4zXcs9/SkzS34evD9zeoW0IMQamqOYpMyr+T1RBQSUAjy6cnRaPLWXg==";
        };
        _p6msjBuJ = {
            "id" = "p6msjBuJ";
            "file" = "gugle-carpet-addition-v2.12.8+build.97.jar";
            "hash" = "sha512-Ov/29fyc/n702SfhJq4HeGnArYfODRN1L7B2WI4WACHApT7oEOAPOQCE6XUugbDU6ifggtsp68Y+peDeO1dmXg==";
        };
    in {
        "tIOUOdQZ" = _tIOUOdQZ;
        "XAGpO341" = _XAGpO341;
        ...
        "fabric-1.20" = _p6msjBuJ;
        "fabric-1.20.1" = _p6msjBuJ;
        "fabric-1.20.2" = _p6msjBuJ;
        "fabric-1.20.3" = _p6msjBuJ;
        "fabric-1.20.4" = _p6msjBuJ;
        "fabric-1.21" = _p6msjBuJ;
        "fabric-1.20.6" = _p6msjBuJ;
        "fabric-1.21.1" = _p6msjBuJ;
        "fabric-1.21.4" = _p6msjBuJ;
        "fabric-1.21.5" = _p6msjBuJ;
        "fabric-1.21.2" = _p6msjBuJ;
        "fabric-1.21.3" = _p6msjBuJ;
        "fabric-1.21.6" = _p6msjBuJ;
        "fabric-1.21.7" = _p6msjBuJ;
        "fabric-1.21.8" = _p6msjBuJ;
        "fabric-1.21.10" = _p6msjBuJ;
        "fabric-1.21.11" = _p6msjBuJ;
        "fabric-1.20.5" = _p6msjBuJ;
        "fabric-1.21.9" = _p6msjBuJ;
        "fabric-26.1" = _p6msjBuJ;
        "fabric-26.1.1" = _p6msjBuJ;
        "fabric-26.1.2" = _p6msjBuJ;
        "fabric-26.2" = _p6msjBuJ;
        "fabric-26.3-snapshot-2" = _trm436TM;
        "fabric-26.3-snapshot-3" = _Kx2E7Hag;
        "fabric-26.3-snapshot-9" = _p6msjBuJ;
        "forge-1.18" = _TvxcSfcj;
        "forge-1.18.1" = _TvxcSfcj;
        "forge-1.18.2" = _TvxcSfcj;
        "quilt-1.20.1" = _p6msjBuJ;
        "quilt-1.21" = _p6msjBuJ;
        "quilt-1.20.6" = _p6msjBuJ;
        "quilt-1.21.1" = _p6msjBuJ;
        "quilt-1.21.4" = _p6msjBuJ;
        "quilt-1.21.5" = _p6msjBuJ;
        "quilt-1.21.2" = _p6msjBuJ;
        "quilt-1.21.3" = _p6msjBuJ;
        "quilt-1.21.6" = _p6msjBuJ;
        "quilt-1.21.7" = _p6msjBuJ;
        "quilt-1.21.8" = _p6msjBuJ;
        "quilt-1.21.10" = _p6msjBuJ;
        "quilt-1.21.11" = _p6msjBuJ;
        "quilt-1.20.2" = _p6msjBuJ;
        "quilt-1.20.3" = _p6msjBuJ;
        "quilt-1.20.4" = _p6msjBuJ;
        "quilt-1.20.5" = _p6msjBuJ;
        "quilt-1.20" = _p6msjBuJ;
        "quilt-1.21.9" = _p6msjBuJ;
        "quilt-26.1" = _p6msjBuJ;
        "quilt-26.1.1" = _p6msjBuJ;
        "quilt-26.1.2" = _p6msjBuJ;
        "quilt-26.2" = _p6msjBuJ;
        "quilt-26.3-snapshot-2" = _trm436TM;
        "quilt-26.3-snapshot-3" = _Kx2E7Hag;
        "quilt-26.3-snapshot-9" = _p6msjBuJ;
        "pkg-1.0.0" = _tIOUOdQZ;
        "pkg-1.1.0" = _wpk2R6ww;
        "pkg-2.0.0" = _EH9jxQ0i;
        "pkg-2.0.1" = _MC1ECHEu;
        ...
        "pkg-2.5.0" = _YT2pJXyS;
        "pkg-2.6.0" = _QTsuBFtB;
        "pkg-2.6.0-1.20" = _l9yM70sO;
        "pkg-2.6.0-1.20.1" = _YtVFT6Ao;
        "pkg-2.7.0" = _KX8yAeNd;
        "pkg-2.7.0-1.20.2" = _ojKrtRio;
        "pkg-2.7.0-1.20.4" = _eP6zER8I;
        "pkg-mc1.20.1-2.8.0+build.40" = _erpf2Dgb;
        "pkg-mc1.20.1-2.8.0+build.41" = _LG0jGYOs;
        "pkg-mc1.20.1-2.8.0+build.42" = _GpFK49Xj;
        "pkg-mc1.20.1-2.8.0+build.43" = _WgGyqvcP;
        "pkg-mc1.21-2.8.0+build.46" = _h9yLcTnL;
        "pkg-mc1.21-2.8.0+build.47" = _e5iwhYku;
        "pkg-mc1.21-2.8.0+build.48" = _k0ujk9rV;
        "pkg-mc1.21-2.9.0+build.50" = _iTAq7W0H;
        "pkg-mc1.21-2.9.0+build.51" = _eNupXbDp;
        "pkg-mc1.21-2.9.0+build.52" = _6ilOqniv;
        "pkg-mc1.21-2.9.0+build.53" = _xw0EUqk6;
        "pkg-mc1.21-2.9.0+build.54" = _kDfLwiEY;
        "pkg-mc1.21-2.9.0+build.56" = _yKKVWkpZ;
        "pkg-mc1.20.1-2.8.0+build.55" = _I8ELKpAP;
        "pkg-mc1.21-2.9.0+build.57" = _3iruDkIB;
        "pkg-mc1.20.6-2.9.0+build.1.20.6" = _Exu6yI4q;
        "pkg-mc1.21-2.9.0+build.59" = _Ws3NZycj;
        "pkg-mc1.21-2.9.0+build.60" = _nSURjl42;
        "pkg-mc1.21-2.9.0+build.61" = _WJJcgUX1;
        "pkg-mc1.21.1-2.9.0+build.62" = _BrkJLl7u;
        "pkg-mc1.21.1-2.9.0+build.64" = _y7UKN15M;
        "pkg-mc1.21.1-2.9.0+build.65" = _vBGKP4XK;
        "pkg-mc1.21.1-2.9.0+build.66" = _ieaP1WQE;
        "pkg-mc1.21.1-2.9.0+build.67" = _QeC5kMzF;
        "pkg-mc1.21.1-2.9.0+build.68" = _hiHfb71c;
        "pkg-mc1.21.1-2.9.0+build.69" = _o9vgBme7;
        "pkg-mc1.21.1-2.9.0+build.70" = _U5tLd9JO;
        "pkg-mc1.21.1-2.9.0+build.71" = _asFWCx8K;
        "pkg-mc1.21.1-2.9.0+build.72" = _4kuCodR8;
        "pkg-mc1.21.1-2.9.0+build.73" = _wf3o8KJm;
        "pkg-mc1.21.1-2.9.0+build.74" = _hlgp9xmH;
        "pkg-mc1.21.1-2.9.0+build.75" = _awBO6GPj;
        "pkg-mc1.21.1-2.9.0+build.76" = _xQQy2vpq;
        "pkg-mc1.21.1-2.9.0+build.77" = _yUEavL5D;
        "pkg-mc1.21.1-2.9.0+build.78" = _WAYMhBGN;
        "pkg-mc1.21.1-2.9.0+build.79" = _DxzehEQO;
        "pkg-mc1.21.1-2.9.0+build.80" = _Z8vZh5PS;
        "pkg-mc1.21.1-2.9.0+build.82" = _vtyiGkAR;
        "pkg-mc1.20.1-2.8.0+build.81" = _rUvZM4hd;
        "pkg-mc1.21.1-2.9.0+build.83" = _ztFE5QAl;
        "pkg-mc1.21.1-2.9.0+build.84" = _NkDFooTa;
        "pkg-v2.10.0+build.1" = _1piCW3iu;
        "pkg-v2.10.0+build.2" = _bIG5rufO;
        "pkg-v2.10.0+build.3" = _kzdurWvg;
        "pkg-v2.10.0+build.4" = _LkQf4fUH;
        "pkg-v2.10.0+build.6" = _UOcwl0a0;
        "pkg-v2.10.0+build.5" = _qKa8NDWG;
        "pkg-v2.10.0+build.7" = _bYBtcV6N;
        "pkg-v2.10.0+build.8" = _8yphDasb;
        "pkg-v2.10.0+build.9" = _M7nHbOTI;
        "pkg-v2.10.0+build.11" = _XNwb5VhS;
        "pkg-v2.10.0+build.12" = _LjMNdLcG;
        "pkg-v2.10.0+build.13" = _xG4xQuIZ;
        "pkg-v2.10.0+build.14" = _DTepQQmh;
        "pkg-v2.10.0+build.15" = _mut7abl6;
        "pkg-v2.10.0+build.16" = _JJDHO3jz;
        "pkg-v2.10.0+build.17" = _NXUY8Jw9;
        "pkg-v2.10.0+build.18" = _5Kz9DJZl;
        "pkg-v2.10.0+build.19" = _qKFpN3j4;
        "pkg-v2.10.0+build.20" = _f3pt4erN;
        "pkg-v2.10.0+build.21" = _rF6j1NxF;
        "pkg-v2.10.0+build.22" = _sztOz65b;
        "pkg-v2.10.0+build.23" = _Qmg302WH;
        "pkg-v2.10.0+build.24" = _KKmMjiPe;
        "pkg-v2.10.1+build.25" = _K8KCCxwY;
        "pkg-v2.10.1+build.26" = _KjoCzcAz;
        "pkg-v2.10.1+build.27" = _krf1173B;
        "pkg-v2.10.1+build.28" = _jiG6obBj;
        "pkg-v2.10.1+build.29" = _AHWkboYq;
        "pkg-v2.10.1+build.30" = _OWRdcTAF;
        "pkg-v2.10.1+build.32" = _BKg4W7kV;
        "pkg-v2.10.1+build.33" = _CfyJcRH5;
        "pkg-v2.10.1+build.34" = _GSIrKksB;
        "pkg-v2.10.1+build.35" = _g7MtdGQT;
        "pkg-v2.10.1+build.36" = _gnTOqPEp;
        "pkg-v2.10.1+build.37" = _zPq0xrtI;
        "pkg-v2.10.1+build.38" = _1Mrb3aSv;
        "pkg-v2.10.1+build.39" = _e1uWkiaN;
        "pkg-v2.10.1+build.40" = _CwxWt8CU;
        "pkg-v2.11.0+build.42" = _p25aI9UT;
        "pkg-v2.11.1+build.44" = _A67o4wWC;
        "pkg-v2.11.2+build.46" = _K1ZUnG8o;
        "pkg-v2.11.3+build.50" = _NynkYi13;
        "pkg-v2.11.4+build.57" = _AlclMAcf;
        "pkg-v2.11.5+build.58" = _QtEoLkxy;
        "pkg-v2.11.6+build.62" = _aH0vOoWq;
        "pkg-v2.11.7+build.65" = _oSQrLMh2;
        "pkg-v2.11.8+build.68" = _TlCGgrlJ;
        "pkg-v2.12.0+build.80" = _vBCdh80K;
        "pkg-v2.12.1+build.83" = _6aMO24j0;
        "pkg-v2.12.2+build.84" = _yOXRLgaO;
        "pkg-v2.12.3+build.85" = _fmMryoTt;
        "pkg-v2.12.4+build.88" = _oKdQHnpm;
        "pkg-v2.12.5+build.91" = _trm436TM;
        "pkg-v2.12.6+build.94" = _Kx2E7Hag;
        "pkg-v2.12.7+build.96" = _oeQPTCFH;
        "pkg-v2.12.8+build.97" = _p6msjBuJ;
        "default" = _p6msjBuJ;
    });
