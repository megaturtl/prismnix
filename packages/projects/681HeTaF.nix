...
let
    ...
    in {
        ...
        "pkg-1.3.beta" = _zPsiLILv;
        "pkg-1.4.beta" = _jpQ26xBv;
        "pkg-1.5.beta" = _1bQ2tdZy;
        "pkg-1.6-1.20.pr" = _wdAIx998;
        "pkg-1-1.20" = _UyYByAv2;
        "pkg-1.1-1.20" = _IslqcXw5;
        "pkg-1.1-1.20.3" = _dKEfcYSE;
        "pkg-1.1-24w14potato" = _Zpjnff2I;
        "pkg-3.0" = _7JVIxXpg;
        "pkg-3.1" = _HglGJx5o;
        "pkg-3.3" = _hd0A3oFO;
        "pkg-1.0" = _nRpAKgv2;
