...
let
    ...
    in {
        ...
        "pkg-1.0.0-alpha38" = _HPoSNsE6;
        "pkg-1.0.0-alpha39" = _DPefMckr;
        "pkg-1.0.0-alpha40" = _yZY65dWF;
        "pkg-1.0.0-alpha41" = _rkDSJgiy;
        "pkg-1.0.0-alpha42" = _4HIZ8B6z;
        "pkg-1.0.0-alpha43" = _ZkT3Aj1D;
        "pkg-1.0.0-alpha44" = _z7D5qQCS;
        "pkg-1.0.0-alpha45" = _PhMViSUG;
        "pkg-1.0.0-alpha46" = _IkbgSQYV;
        "pkg-1.0.0-alpha47" = _K1hXVFS1;
        "pkg-1.0.0-alpha48" = _5Y44W39A;
        "pkg-1.0.0-alpha50" = _lAi8MbZn;
        "pkg-1.0.0-alpha51" = _m2xgL4Uf;
        "pkg-1.0.0-alpha52" = _VJlJZbN0;
        "pkg-1.0.0-alpha53" = _wnza47eq;
        "pkg-1.0.0-beta1" = _TnStIRhq;
        "pkg-1.0.0-beta2" = _UD65j4wK;
        "pkg-1.0.0-beta4" = _AskvF2pr;
        "pkg-1.0.0-beta5" = _k9rQf3zJ;
        "pkg-1.0.0-beta6" = _zXYvfmp5;
        "pkg-1.0.0-beta7" = _iIqofjVW;
        "pkg-1.0.0-beta8" = _ujpa226W;
        "pkg-1.0.0-beta9" = _4dXwPaXv;
        "pkg-1.0.0-beta10" = _eRz4i1nt;
        "pkg-1.0.0-beta11" = _ahSxgEum;
        "pkg-1.0.0-beta12" = _dsdgEdkZ;
        "pkg-1.0.0-beta13" = _oZ5qUfCv;
        "pkg-1.0.0-beta14" = _SX0jlPAp;
        "pkg-1.0.0-beta15" = _snqRF2Dx;
        "pkg-1.0.0-beta16" = _CDHwsFny;
        "pkg-1.0.0-beta17" = _l6370LMy;
        "pkg-1.0.0-beta18" = _4kGJwAVT;
        "pkg-1.0.0-beta19" = _lbhfWZna;
        "pkg-1.0.0-beta20" = _kfPLXZvH;
        "pkg-1.0.0-beta21" = _KZ0lggf0;
        "pkg-1.0.0-beta22" = _nHphyx4T;
        "pkg-1.0.0-beta23" = _BnOGjrcB;
        "pkg-1.0.0-beta24" = _X3ghfeQ7;
        "pkg-1.0.0-beta25" = _IzqWIUvm;
        "pkg-1.0.0-beta26" = _XDNn7y7T;
        "pkg-1.0.0-beta27" = _y9RyECAb;
        "pkg-1.0.0-beta28" = _vg4HIdC4;
        "pkg-1.0.0-beta29" = _JYSyXDXJ;
        "pkg-1.0.0-beta30" = _BrvrIiy7;
        "pkg-1.0.0-beta31" = _qzysz1Zw;
        "pkg-1.0.0-beta32" = _THFAroty;
        "pkg-1.0.0-beta33" = _W3vjdeS2;
        "pkg-1.0.0-beta34" = _JQEeZFT0;
        "pkg-1.0.0-beta35" = _HQwfqsbt;
        "pkg-1.0.0-beta36" = _lJRrlvJk;
        "pkg-1.0.0-beta37" = _zvUyfW54;
        "pkg-1.0.0-beta38" = _v22Nyk7i;
        "pkg-1.0.0-beta39" = _ItuXTsr9;
        "pkg-1.0.0-beta40" = _z60hDo6T;
        "pkg-1.0.0-beta41" = _9m0peO6v;
        "pkg-1.0.0-beta42" = _rGqcT7mY;
        "pkg-1.0.0-beta43" = _d0L0bOgN;
        "pkg-1.0.0-beta44" = _Lv9E9dTb;
        "pkg-1.0.0-beta45" = _fszXdW0c;
        "pkg-1.0.0-beta46" = _eViGqFHR;
        "pkg-1.0.0-beta47" = _icdLkY52;
        "pkg-1.0.0-beta48" = _UPGigeDS;
        "pkg-1.0.0-beta49" = _W7FrPdb9;
        "pkg-1.0.0-beta50" = _Tq5qPPPZ;
        "pkg-1.0.0-beta51" = _CbcVl1nK;
        "pkg-1.0.0-beta52" = _fyj2oGV8;
        "pkg-1.0.0-beta53" = _Rn2uwq5T;
        "pkg-1.0.0-beta54" = _QYFf5zUZ;
        "pkg-1.0.0-beta55" = _fj5qsWZ8;
        "pkg-1.0.0-beta56" = _lLr0kydq;
        "pkg-1.0.0-beta57" = _OvY4JJEn;
        "pkg-1.0.0-beta58" = _27W3AI0I;
        "pkg-1.0.0-beta59" = _NVPGMkS4;
        "pkg-1.0.0-beta60" = _2SqCjtFB;
        "pkg-1.0.0-beta61" = _5epx0Cc4;
        "pkg-1.0.0-beta62" = _P5cnReTJ;
        "pkg-1.0.0-beta63" = _1pYaLnWQ;
        "pkg-1.0.0-beta64" = _ph9RaeIi;
        "pkg-1.0.0-beta65" = _ugbaMJ9Q;
        "pkg-1.0.0-beta66" = _zwsU0taz;
        "pkg-1.0.0-beta67" = _taWGR5Zl;
        "pkg-1.0.0-beta68" = _Zu5nq767;
        "pkg-1.0.0-beta66a" = _h5WNHETX;
        "pkg-1.0.0-beta66b" = _XFfvDPfo;
        "pkg-1.0.0-beta68a" = _eErTfV3O;
        "pkg-2.0.0-alpha1" = _jZ7eD4MN;
        "pkg-2.0.0-alpha2" = _pssjHpcp;
        "pkg-2.0.0-alpha3" = _t3JaMsbn;
        "pkg-2.0.0-alpha4" = _sZQ5u2TV;
        "pkg-2.0.0-alpha5" = _fQhAN9Zl;
        "pkg-2.0.0-alpha6" = _dGOTwpXx;
        "pkg-2.0.0-alpha7" = _ocP3gNBt;
        "pkg-2.0.0-alpha9" = _9qVlwUi3;
        "pkg-2.0.0-alpha10" = _LuV5jFFT;
        "pkg-2.0.0-alpha11" = _VA75K6FT;
        "pkg-2.0.0-alpha12" = _sgPRg8UT;
        "pkg-2.0.0-alpha13" = _k9StEPHE;
        "pkg-2.0.0-alpha14" = _9PyR4lh5;
        "pkg-2.0.0-alpha15" = _77qkaQow;
        "pkg-2.0.0-alpha16" = _4QiMceMn;
        "pkg-2.0.0-alpha17" = _TKANw8YT;
        "pkg-2.0.0-alpha18" = _Lt1FVSXb;
        "pkg-2.0.0-alpha19" = _F09ZvaKn;
        "pkg-2.0.0-alpha20" = _uAhBzLL4;
        "pkg-2.0.0-alpha21" = _H1Muxxog;
        "pkg-2.0.0-alpha22" = _aU0vRAvM;
        "pkg-2.0.0-alpha23" = _h9wrSmoy;
        "pkg-2.0.0-alpha24" = _HCdbOWwo;
        "pkg-2.0.0-alpha25" = _SaVkiMk5;
        "pkg-2.1.0" = _Q8YvmWPK;
        "pkg-2.1.1" = _4fm4PwTO;
        "pkg-2.1.2" = _uopt2SxR;
        "pkg-2.1.3" = _tlIWbHyY;
        ...
        "pkg-2.1.8" = _2biJ6Zt8;
        "pkg-2.1.9" = _aAkAbds8;
        "pkg-2.1.10" = _26iNyHtO;
        "pkg-2.1.11" = _fvLqHXdp;
        "pkg-2.1.12" = _dPA3alzi;
        "pkg-2.1.13" = _ybGcQBFH;
        "pkg-2.1.14" = _4O7JStX5;
        "pkg-2.1.15" = _nbNRJlFq;
        "pkg-2.1.16" = _qX5yXTe4;
        "pkg-2.1.17" = _1ZTf8HIn;
        "pkg-2.1.18" = _KMWd8izD;
        "pkg-2.1.19" = _hcyQ9LlF;
        "pkg-2.1.20" = _N0dgiJMB;
        "pkg-2.1.21" = _rkc1G1SF;
        "pkg-2.1.22" = _HDAXsYY3;
        "pkg-2.1.23" = _NQh3Eccf;
        "pkg-2.1.24" = _4g0EYvBA;
        "pkg-2.1.25" = _KQuYxZ65;
        "pkg-2.1.26" = _v55eARrO;
        "pkg-2.1.27" = _8evDrE6q;
        "pkg-2.1.28" = _n29M7yoq;
        "pkg-2.1.29" = _zj1vLIXt;
        "pkg-2.1.30" = _rXDtkGqD;
        "pkg-2.1.31" = _6HLDVpOy;
        "pkg-2.1.32" = _FgfWCxYf;
        "pkg-2.1.33" = _VGttfXnV;
        "pkg-2.1.34" = _6AyyHiZk;
        "pkg-2.1.35" = _CSbY2Ydn;
        "pkg-2.1.36" = _GWw9gtx6;
        "pkg-2.1.37" = _A9qj7uss;
        "pkg-2.1.38" = _tnGkR7bC;
        "pkg-2.1.39" = _X5T3FM93;
        "pkg-2.1.40" = _chJ4Il0c;
        "pkg-2.1.41" = _JgN5GUs2;
        "pkg-2.1.42" = _zzybEh4j;
        "pkg-2.1.43" = _lKSTr8pC;
        "pkg-2.1.44" = _X0ddFqcx;
        "pkg-2.1.45" = _LKZRJPUb;
        "pkg-2.1.46" = _RkvP3r3F;
        "pkg-2.1.47" = _rShLMEsN;
        "pkg-2.1.48" = _x7e1H6hI;
        "pkg-2.1.49" = _bvsKos0C;
        "pkg-2.1.50" = _1U6IWMnt;
        "pkg-2.1.51" = _wjsYxVr4;
        "pkg-2.1.52" = _2X4YTyth;
        "pkg-2.1.53" = _DNrd6Iga;
        "pkg-2.1.54" = _fxQw9uaJ;
        "pkg-2.1.55" = _aCyjNqA0;
        "pkg-2.1.56" = _IndBU3x5;
