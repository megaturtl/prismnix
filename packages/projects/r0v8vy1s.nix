...
let
    ...
    in {
        ...
        "pkg-0.1.2" = _Wcg8QtlB;
        "pkg-0.1.3" = _Ca2crPBC;
        "pkg-mc1.16-0.2.0" = _rdScmQX2;
        "pkg-mc1.17-0.2.0" = _z78WRI0B;
        "pkg-mc1.14-0.3.0" = _CSFStoYN;
        "pkg-mc1.15-0.3.0" = _JZErTOBa;
        "pkg-mc1.16-0.3.0" = _9uewQm0i;
        "pkg-mc1.17-0.3.0" = _1ebDeupo;
        "pkg-mc1.14-0.4.0" = _5OYFZNQb;
        "pkg-mc1.15-0.4.0" = _gKNMWQFe;
        "pkg-mc1.16-0.4.0" = _qZQ7ath8;
        "pkg-mc1.17-0.4.0" = _eKThDBxV;
        "pkg-mc1.17-0.4.1" = _fIgfufLA;
        "pkg-mc1.14-1.0.0" = _MbEV8ysu;
        "pkg-mc1.15-1.0.0" = _oaPAZHeF;
        "pkg-mc1.16-1.0.0" = _30P7c8Sc;
        "pkg-mc1.17-1.0.0" = _cnm8f9GG;
        "pkg-mc1.14-1.1.0" = _N3bxgXDH;
        "pkg-mc1.15-1.1.0" = _DDiRJszQ;
        "pkg-mc1.16-1.1.0" = _GiAWvJK9;
        "pkg-mc1.17-1.1.0" = _LynxUXOP;
        "pkg-mc1.18-1.1.0" = _9F6atBKt;
        "pkg-forge-mc1.18-1.1.0" = _GwY5IFEy;
        "pkg-mc1.14-1.2.0" = _9SXtCwu0;
        "pkg-mc1.15-1.2.0" = _t5DWN1gm;
        "pkg-mc1.16-1.2.0" = _G27JrgiI;
        "pkg-mc1.17-1.2.0" = _HhzkvE6O;
        "pkg-mc1.18-1.2.0" = _N8AvvTfs;
        "pkg-mc1.14-1.2.1" = _DS5ILIxG;
        "pkg-mc1.15-1.2.1" = _txTm74H4;
        "pkg-mc1.16-1.2.1" = _ZF4E7jII;
        "pkg-mc1.17-1.2.1" = _XyChhmMe;
        "pkg-mc1.18-1.2.1" = _sYu2D6ez;
        "pkg-forge-mc1.18-1.2.1" = _MLH4H0y2;
        "pkg-mc1.14-1.3.0" = _2DSIjEoj;
        "pkg-mc1.15-1.3.0" = _emgpmBBm;
        "pkg-mc1.16-1.3.0" = _lQpWSj6j;
        "pkg-mc1.17-1.3.0" = _yQIu276H;
        "pkg-mc1.18-1.3.0" = _XQit89EZ;
        "pkg-mc1.19-1.3.0" = _5vr2yCCO;
        "pkg-mc1.14-1.4.0" = _S4dJ2iyh;
        "pkg-mc1.15-1.4.0" = _1I4OWQil;
        "pkg-mc1.16-1.4.0" = _VWU16jcy;
        "pkg-mc1.17-1.4.0" = _FV0dyi7m;
        "pkg-mc1.18-1.4.0" = _gUosQHld;
        "pkg-mc1.19-1.4.0" = _4QElEqe4;
        "pkg-forge-mc1.19-1.4.0" = _NzZe7tXs;
        "pkg-forge-mc1.19-1.5.0" = _gxfBnR7p;
        "pkg-mc1.14-1.5.0" = _T52JhWsT;
        "pkg-mc1.15-1.5.0" = _cGXi6arS;
        "pkg-mc1.16-1.5.0" = _vettdZX4;
        "pkg-mc1.17-1.5.0" = _u8zKAKt8;
        "pkg-mc1.18-1.5.0" = _ER3cM1dr;
        "pkg-mc1.19-1.5.0" = _F0ROppUm;
        "pkg-forge-mc1.19-1.6.0" = _r0y55em7;
        "pkg-mc1.14-1.6.0" = _xapZdXkF;
        "pkg-mc1.15-1.6.0" = _8NEwN8KM;
        "pkg-mc1.16-1.6.0" = _xPdjvwwA;
        "pkg-mc1.17-1.6.0" = _BvQnpyPj;
        "pkg-mc1.18-1.6.0" = _VkwuA8t1;
        "pkg-mc1.19-1.6.0" = _4nKkKsjy;
        "pkg-mc1.20-1.6.0" = _L6nyX2yD;
        "pkg-forge-mc1.19-1.7.0" = _v9lKbHW6;
        "pkg-mc1.14-1.7.0" = _bVYFJbvx;
        "pkg-mc1.15-1.7.0" = _W78bVcwe;
        "pkg-mc1.16-1.7.0" = _MzCxRhC6;
        "pkg-mc1.17-1.7.0" = _JyMccsNd;
        "pkg-mc1.18-1.7.0" = _jYQUIR7B;
        "pkg-mc1.19-1.7.0" = _FkanfPQt;
        "pkg-mc1.20-1.7.0" = _zrRsTCOk;
        "pkg-ornithe-mca1.0.6-1.7.0" = _oUiJaPJ4;
        "pkg-ornithe-mcb1.0-1.7.0" = _otRJ7qRt;
        "pkg-ornithe-mcb1.6-1.7.0" = _ScVaodC7;
        "pkg-ornithe-mc1.2-1.7.0" = _jeBtGGPj;
        "pkg-ornithe-mc1.3-1.7.0" = _GHvIXuaf;
        "pkg-ornithe-mc1.4-1.7.0" = _qmLJQdlV;
        "pkg-ornithe-mc1.5-1.7.0" = _APKbnFb7;
        "pkg-ornithe-mc1.6-1.7.0" = _yeEKF5Cu;
        "pkg-ornithe-mc1.7-1.7.0" = _Y5Q8sEjA;
        "pkg-ornithe-mc1.8-1.7.0" = _dxOkiCsx;
        "pkg-ornithe-mc1.9-1.7.0" = _8sC1JfwZ;
        "pkg-ornithe-mc1.10-1.7.0" = _bM8opJlV;
        "pkg-ornithe-mc1.11-1.7.0" = _BjloWltb;
        "pkg-ornithe-mc1.12-1.7.0" = _F7ERk3df;
        "pkg-ornithe-mc1.13-1.7.0" = _4SkLYef2;
        "pkg-forge-mc1.20-1.7.0" = _kC6SY4Zp;
        "pkg-mc1.20-1.8.0-beta.1" = _3Y7l1hJc;
        "pkg-mc1.20-1.8.0-beta.2" = _lxVatUAV;
        "pkg-mc1.20-1.8.0-beta.3" = _CFNRLnDw;
        "pkg-mc1.20-1.8.0-beta.4" = _TGC7Ch3w;
        "pkg-mc1.21-1.8.0" = _fA9M0yW3;
        "pkg-mc1.21-1.8.1" = _vllKXZ2v;
        "pkg-mc1.21-1.8.2" = _MFriNx0G;
        "pkg-ornithe-mc1.3-1.9.0" = _tkxzCZc9;
        "pkg-ornithe-mc1.4-1.9.0" = _tIPaXPvI;
        "pkg-ornithe-mc1.5-1.9.0" = _2MVDVmEX;
        "pkg-ornithe-mc1.6-1.9.0" = _gr9Q8CGP;
        "pkg-ornithe-mc1.7-1.9.0" = _DzewbbCz;
        "pkg-ornithe-mc1.8-1.9.0" = _neSQ3w1G;
        "pkg-ornithe-mc1.9-1.9.0" = _tY0PbMI1;
        "pkg-ornithe-mc1.10-1.9.0" = _S2NQWd0V;
        "pkg-ornithe-mc1.11-1.9.0" = _KoIBDaqW;
        "pkg-ornithe-mc1.12-1.9.0" = _6sfeQATP;
        "pkg-ornithe-mc1.13-1.9.0" = _56rmvesy;
        "pkg-mc1.14-1.9.0" = _W26SrCEU;
        "pkg-mc1.15-1.9.0" = _wYMhBMml;
        "pkg-mc1.16-1.9.0" = _eCfaPr1x;
        "pkg-mc1.17-1.9.0" = _656EAlsi;
        "pkg-mc1.18-1.9.0" = _bCj5orh2;
        "pkg-mc1.19-1.9.0" = _J9KWRYnZ;
        "pkg-mc1.20-1.9.0" = _ckuIQWvo;
        "pkg-mc1.21-1.9.0" = _78P98rac;
        "pkg-neoforge-mc1.21-1.9.0" = _PCNyL6v4;
        "pkg-mc1.21.2-1.9.0" = _ponAdJiF;
        "pkg-neoforge-mc1.21.2-1.9.0" = _fStBK8hF;
        "pkg-mc1.21.2-1.9.1" = _DwfiGUVU;
        "pkg-neoforge-mc1.21.2-1.9.1" = _rhjrO8IF;
        "pkg-mc1.21.5-1.9.0" = _eTNKfjl1;
        "pkg-neoforge-mc1.21.2-1.9.2" = _k8Ee9wu8;
        "pkg-neoforge-mc1.21.5-1.9.0" = _KnldqVfO;
        "pkg-mc1.21.9-1.9.0" = _FY6xclLZ;
        "pkg-neoforge-mc1.21.9-1.9.0" = _vu3c0Zrw;
        "pkg-mc1.21.11-1.9.0" = _XdouG8YV;
        "pkg-neoforge-mc1.21.11-1.9.0" = _YHZsmom1;
        "pkg-mc26.1-1.9.0" = _PGm6TCxh;
        "pkg-neoforge-mc26.1-1.9.0" = _ZyKpKsQZ;
