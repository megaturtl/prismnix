...
let
    versions = (let
        ...
        _3ZbNN1xQ = {
            "id" = "3ZbNN1xQ";
            "file" = "happy_ghast-1.15.0-26.3+.jar";
            "hash" = "sha512-uUWOfhC7Va6HlVU7sBuxJSN+qn/tkOoWWf4iGyc99LFpnsY1RSuve3Hq89JaQCI3YScyflYx3pUfic5dtjTwQQ==";
        };
    in {
        "C8gV31Su" = _C8gV31Su;
        "AsG7Unsk" = _AsG7Unsk;
