...
let
    versions = (let
        ...
        _FNkZuJUx = {
            "id" = "FNkZuJUx";
            "file" = "UncraftingTable-neoforge-1.5.6-fix.1.jar";
            "hash" = "sha512-2bs7oHIX7pLkzCkFxSJi/VSDex69N3xoE9lXBaPgz5hki6Q8dmY/3X/EnCnz4wDZN4zv6Eex9IBhfIIRDTZoeA==";
        };
    in {
        "iupijkie" = _iupijkie;
        "UuKKYMwl" = _UuKKYMwl;
        ...
        "neoforge-1.18" = _FNkZuJUx;
        "neoforge-1.18.1" = _FNkZuJUx;
        "neoforge-1.18.2" = _FNkZuJUx;
        "neoforge-1.19" = _FNkZuJUx;
        "neoforge-1.19.1" = _FNkZuJUx;
        "neoforge-1.19.2" = _FNkZuJUx;
        "neoforge-1.19.3" = _I7TUfq9h;
        "neoforge-1.19.4" = _I7TUfq9h;
        "neoforge-1.20" = _FNkZuJUx;
        "neoforge-1.20.1" = _FNkZuJUx;
        "neoforge-1.20.2" = _I7TUfq9h;
        "neoforge-1.20.3" = _FNkZuJUx;
        "neoforge-1.20.4" = _FNkZuJUx;
        "neoforge-1.21" = _FNkZuJUx;
        "neoforge-1.21.1" = _FNkZuJUx;
        "neoforge-1.21.2" = _FNkZuJUx;
        "neoforge-1.21.3" = _FNkZuJUx;
        "neoforge-1.21.4" = _FNkZuJUx;
        "neoforge-1.21.5" = _FNkZuJUx;
        "neoforge-1.21.6" = _FNkZuJUx;
        "neoforge-1.21.7" = _FNkZuJUx;
        "neoforge-1.21.8" = _FNkZuJUx;
        "neoforge-1.21.9" = _FNkZuJUx;
        "neoforge-1.21.10" = _FNkZuJUx;
        "neoforge-1.21.11" = _FNkZuJUx;
        "neoforge-26.1" = _FNkZuJUx;
        "neoforge-26.1.1" = _FNkZuJUx;
        "pkg-1.1.4-fabric" = _iupijkie;
        "pkg-1.1.4-forge" = _UuKKYMwl;
        "pkg-1.1.5-fabric" = _IWhc5pvH;
        "pkg-1.1.5-forge" = _Cft2aZ2H;
        "pkg-1.1.6-forge" = _TuKf8saX;
        "pkg-1.1.6-fabric" = _13HXzFyQ;
        "pkg-1.1.7-fabric" = _QW9m8h2j;
        "pkg-1.1.7-forge" = _f4aKdcld;
        "pkg-1.1.8-fabric" = _Oaiqkp6E;
        "pkg-1.1.8-forge" = _rwtEJ5sz;
        "pkg-1.1.9-forge" = _pGLxLJct;
        "pkg-1.1.9-fabric" = _sUDLHpCY;
        "pkg-1.2.1-forge" = _Xxcza6Xp;
        "pkg-1.2.1-fabric" = _tjyulH7T;
        "pkg-1.2.2-forge" = _5EvL29zk;
        "pkg-1.2.2-fabric" = _MDQq3Qce;
        "pkg-1.2.3-fabric" = _OosmXsOB;
        "pkg-1.2.3-forge" = _ZLt4QGub;
        "pkg-1.2.4-forge" = _NvzlALMC;
        "pkg-1.2.4-fabric" = _HO4LY3pq;
        "pkg-1.2.5-forge" = _6dv8XO2n;
        "pkg-1.2.5-fabric" = _RS5FbSx6;
        "pkg-1.2.6-fabric" = _LnwGEtOt;
        "pkg-1.2.6-forge" = _JBg8f0Yi;
        "pkg-1.2.8-fabric" = _3hg8aK0P;
        "pkg-1.2.8-forge" = _qOPIEycj;
        "pkg-1.2.9-forge" = _8F2otNUX;
        "pkg-1.2.9-fabric" = _H0jE8YbS;
        "pkg-1.3.0-forge" = _3mIgJ8fe;
        "pkg-1.3.0-fabric" = _4WqtgPQV;
        "pkg-1.3.0-neoforge" = _I7TUfq9h;
        "pkg-1.3.1-fabric" = _YQuZ5qP3;
        "pkg-1.3.1-forge" = _LLq5lxeb;
        "pkg-1.3.1-neoforge" = _eOjKxHth;
        "pkg-1.3.2-fabric" = _LvZty0v4;
        "pkg-1.3.2-forge" = _Ql8CO8qz;
        "pkg-1.3.2-neoforge" = _R6vzvVRz;
        "pkg-1.3.3-forge" = _FTmUyfBn;
        "pkg-1.3.4-fabric" = _Ob5h4oKA;
        "pkg-1.3.4-forge" = _WsagyeDP;
        "pkg-1.3.4-neoforge" = _l6oPq58R;
        "pkg-1.3.5-forge" = _U15ubkbb;
        "pkg-1.3.6-forge" = _8gW8tt5x;
        "pkg-1.3.6-fabric" = _1Jb9RfjX;
        "pkg-1.3.6-neoforge" = _OhwMMJCd;
        "pkg-1.3.7-fabric" = _bBDWr1el;
        "pkg-1.3.7-forge" = _kuYvHukp;
        "pkg-1.3.7-neoforge" = _sxySIskW;
        "pkg-1.3.7-fix.1-neoforge" = _yJ8GnADE;
        "pkg-1.3.7-fix.2-neoforge" = _mo2UPP72;
        "pkg-1.3.8-neoforge" = _2SX0WeKW;
        "pkg-1.3.8-fabric" = _D93jJdNo;
        "pkg-1.3.8-forge" = _3x2U3PqE;
        "pkg-1.3.9-forge" = _c0yn6NZ9;
        "pkg-1.3.9-fabric" = _YVdNvwpy;
        "pkg-1.4.0-fabric" = _UWY9FjDO;
        "pkg-1.4.0-forge" = _QCo6XSPT;
        "pkg-1.4.0-neoforge" = _zIbWb2K5;
        "pkg-1.4.1-fabric" = _b9mYrnqS;
        "pkg-1.4.1-forge" = _dDsDtVIE;
        "pkg-1.4.1-neoforge" = _rwrMTCZJ;
        "pkg-1.4.2-neoforge" = _t4PIXzGy;
        "pkg-1.4.2-forge" = _c9B2ChZo;
        "pkg-1.4.2-fabric" = _GLEmpiUX;
        "pkg-1.4.3-fabric" = _dbPV3saC;
        "pkg-1.4.3-forge" = _q8UwgjOg;
        "pkg-1.4.3-neoforge" = _DNweBaOa;
        "pkg-1.4.5-fabric" = _tBjrUHZn;
        "pkg-1.4.5-neoforge" = _rpleoEbC;
        "pkg-1.4.5-forge" = _y7bEGsGG;
        "pkg-1.5.0-fabric" = _54Mu4zB6;
        "pkg-1.5.0-neoforge" = _rMCRnj6x;
        "pkg-1.5.0-forge" = _yDm81Io2;
        "pkg-1.5.1-fabric" = _8caLKKmp;
        "pkg-1.5.1-neoforge" = _PNKAVtss;
        "pkg-1.5.1-forge" = _YYcNy22D;
        "pkg-1.5.2-fabric" = _LYRPe9S3;
        "pkg-1.5.2-neoforge" = _6lUQeC32;
        "pkg-1.5.2-forge" = _5ODn5Eii;
        "pkg-1.5.3-fabric" = _LXliTCS0;
        "pkg-1.5.3-forge" = _pbRRsj5B;
        "pkg-1.5.3-neoforge" = _AshCNXn8;
        "pkg-1.5.3-fix.1-neoforge" = _bKmI6FbB;
        "pkg-1.5.4-fabric" = _3eU1mije;
        "pkg-1.5.4-forge" = _xfjQZjoW;
        "pkg-1.5.4-neoforge" = _NhIBTWNp;
        "pkg-1.5.6-fabric" = _Tv5AwjFD;
        "pkg-1.5.6-forge" = _qemM1hXa;
        "pkg-1.5.6-neoforge" = _dUsArJUU;
        "pkg-1.5.6-fix.1-neoforge" = _FNkZuJUx;
        "default" = _FNkZuJUx;
    });
