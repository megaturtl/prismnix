...
let
    ...
    in {
        ...
        "pkg-1.4.8" = _5EDmtAfS;
        "pkg-1.4.9" = _LoFpSOvM;
        "pkg-1.4.10" = _aCtsNF5j;
        "pkg-1.4.11" = _FbFzH6RB;
        "pkg-1.4.12" = _IXNui8Zm;
        "pkg-1.4.13" = _yc9dHC9U;
        "pkg-1.4.14" = _SXU5mzSR;
        "pkg-1.4.15" = _JtkMYWlU;
        "pkg-1.4.16" = _qiRLJfgd;
        "pkg-1.4.17" = _KOQpzPdU;
        "pkg-1.4.18" = _qJeZ5FRc;
        "pkg-1.4.19" = _kq5t68Gw;
        "pkg-1.4.20" = _GVUeMKxe;
