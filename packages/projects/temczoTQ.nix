...
let
    ...
    in {
        ...
        "pkg-1.6.2" = _d61bDuF0;
        "pkg-1.7" = _GuNROkc3;
        "pkg-1.7+1.19" = _leGhLwNO;
        "pkg-1.7.2+1.18.2" = _gg8yDhWA;
        "pkg-1.7.2+1.19" = _LC9RNrO7;
        "pkg-2.0+1.18.2" = _8WOdEzK6;
        "pkg-2.0+1.19" = _zTuQLyEl;
        "pkg-2.1+1.18.2" = _lLlp71PI;
        "pkg-2.1+1.19" = _9hkuLTj0;
        "pkg-2.1.1+1.19.1" = _gseAIZ7u;
        "pkg-2.2+1.19.1" = _qS2GQgVk;
        "pkg-2.2.1+1.19.1" = _qEWpUaOD;
        "pkg-2.3+1.19.1" = _M0EtcTxa;
        "pkg-2.3.1+1.19.1" = _R2knSP1S;
        "pkg-2.4+1.19.1" = _Kf6HHhAt;
        "pkg-2.5+1.19.1" = _G4HByt5W;
        "pkg-2.5+1.19.3" = _aJ055eLf;
        "pkg-2.5.1+1.19.3" = _vmvZvy8I;
        "pkg-2.5.2+1.19.3" = _BOYnLpHO;
        "pkg-3.0+1.19.1" = _Wh2LV1ge;
        "pkg-3.0+1.19.3" = _3wFa8YaY;
        "pkg-3.1+1.19.3" = _JHsN5Roa;
        "pkg-3.2+1.19.3" = _8chOrCT6;
        "pkg-3.1+1.19.1" = _x54fp8G8;
        "pkg-3.2+1.19.1" = _TyP9drU7;
        "pkg-3.2.1+1.19.3" = _1ZeOZDX2;
        "pkg-3.2.1+1.19.4" = _fxT885N5;
        "pkg-2.1.1+1.18.2" = _UdOSHnLF;
        "pkg-4.0+1.19.4" = _reoNwDVa;
        "pkg-4.1+1.19.4" = _HA6IGW4x;
        "pkg-4.2+1.19.4" = _ljaWlVnm;
        "pkg-5.0+1.20" = _sOyMYLH5;
        "pkg-5.0.1+1.20" = _E4NrmrgJ;
        "pkg-5.0.2+1.20" = _5kaRBTkJ;
        "pkg-5.0.3+1.20" = _TwRwJ0OH;
        "pkg-6.0+1.20" = _DpuFiAei;
        "pkg-6.1+1.20" = _SlKgUH2p;
        "pkg-4.3+1.19.4" = _MnW3SMZG;
        "pkg-4.3+1.19.2" = _EGmh8rjR;
        "pkg-6.1+1.20.1" = _IXk3IFsq;
        "pkg-4.3+1.18.2" = _kE6Zmve6;
        "pkg-6.1+1.20.2" = _Ihi0Xf86;
        "pkg-6.2+1.20.1-fabric" = _u08m9EPu;
        "pkg-6.2+1.20.1-forge" = _RdJKUbal;
        "pkg-6.2+1.20.2-fabric" = _Zi51qlMs;
        "pkg-6.2+1.20.2-forge" = _nDpI0hXp;
        "pkg-6.3+1.20.1-fabric" = _UkWMZyQX;
        "pkg-6.3+1.20.1-forge" = _kCfTnRUl;
        "pkg-6.3+1.20.2-forge" = _zXP5A92C;
        "pkg-6.3.1+1.20.1-fabric" = _Tkxkvq4z;
        "pkg-6.3.1+1.20.1-forge" = _ZLIBmTqT;
        "pkg-6.4+1.20.2-fabric" = _4fvepZ9t;
        "pkg-6.4+1.20.2-forge" = _typ9u2OO;
        "pkg-6.3.2+1.20.1-fabric" = _ZxtFysns;
        "pkg-6.5+1.20.2-fabric" = _JBeJMHTm;
        "pkg-6.5+1.20.2-forge" = _pyZnHkju;
        "pkg-6.5+1.20.2-neoforge" = _c0wouvtm;
        "pkg-4.3.1+1.19.2" = _XQE01yYQ;
        "pkg-6.5+1.20.3-fabric" = _ySSVsmvP;
        "pkg-6.5+1.20.3-forge" = _1prjGrKR;
        "pkg-6.5+1.20.3-neoforge" = _m1ldNZ82;
        "pkg-6.5.1+1.20.2-fabric" = _IJPIWcT3;
        "pkg-6.5.1+1.20.4-fabric" = _BOMzBD9B;
        "pkg-6.3.3+1.20.1-forge" = _l5Z1K4H0;
        "pkg-6.5.2+1.20.2-forge" = _Pfa1PFdF;
        "pkg-6.5.2+1.20.2-neoforge" = _t3h2GnqQ;
        "pkg-6.5.2+1.20.4-forge" = _R90QkfkN;
        "pkg-6.5.2+1.20.4-neoforge" = _BCEOcOsl;
        "pkg-6.5.3+1.20.4-forge" = _gIQSoRbC;
        "pkg-6.3.3+1.20.1-fabric" = _BYHE4afx;
        "pkg-6.5.4+1.20.4-forge" = _icYXF5W4;
        "pkg-6.3.4+1.20.1-forge" = _sEDA9iGr;
        "pkg-6.6.1+1.20.4-fabric" = _P3cVFlJR;
        "pkg-6.6.1+1.20.4-forge" = _YCoMn1gz;
        "pkg-6.6.1+1.20.4-neoforge" = _INC5f8os;
        "pkg-6.6.2+1.20.4-forge" = _WwvkkFJ4;
        "pkg-6.6.2+1.20.4-fabric" = _bm8m6sXM;
        "pkg-6.6.3+1.20.4-fabric" = _RaYAxE43;
        "pkg-6.6.3+1.20.4-forge" = _3lulqHuH;
        "pkg-6.6.3+1.20.4-neoforge" = _UwNuF9UO;
        "pkg-7.0+1.20.5-fabric" = _SBLyTIHH;
        "pkg-7.1+1.20.5-fabric" = _KRrDKR23;
        "pkg-7.1+1.20.5-neoforge" = _BUTber77;
        "pkg-7.2+1.20.6-fabric" = _Hr6IEiXa;
        "pkg-6.3.5+1.20.1-fabric" = _GyQI10EF;
        "pkg-6.3.5+1.20.1-forge" = _cNPqHzLJ;
        "pkg-7.2.1+1.21-fabric" = _5xcxoJPy;
        "pkg-7.2.3+1.21-neoforge" = _az2e8rGS;
        "pkg-7.2.4+1.21-neoforge" = _EENU8tpT;
        "pkg-6.3.6+1.20.1-forge" = _dGN1kqQy;
        "pkg-7.2.5+1.21-neoforge" = _qik6J9jM;
        "pkg-7.2.6+1.21-fabric" = _u3KJnHRp;
        "pkg-7.2.6+1.21-neoforge" = _JzHbHLcH;
        "pkg-6.3.7+1.20.1-fabric" = _nGjgS2WU;
        "pkg-6.3.7+1.20.1-forge" = _sVKWBkN5;
        "pkg-7.2.7+1.21-neoforge" = _wkx1tZYd;
        "pkg-7.2.7+1.21-fabric" = _8I2e3ap6;
        "pkg-7.2.9+1.21.2-fabric" = _GcGYrQqo;
        "pkg-7.2.9+1.21.2-neoforge" = _fc3IRhtV;
        "pkg-8.0+1.21.3-neoforge" = _Kj2Fu7hC;
        "pkg-8.0+1.21.1-neoforge" = _e7VpM7kW;
        "pkg-8.0+1.20.6-neoforge" = _bFBViAkU;
        "pkg-8.0+1.20.4-neoforge" = _fB5BdznR;
        "pkg-8.0+1.21.3-forge" = _87pd0BSM;
        "pkg-8.0+1.21.1-forge" = _2cJVgPni;
        "pkg-8.0+1.20.6-forge" = _DgaxrR3K;
        "pkg-8.0+1.21.3-fabric" = _1tDtyaMv;
        "pkg-8.0+1.21.1-fabric" = _tMPTgZ83;
        "pkg-8.0+1.20.4-forge" = _hiOhfdMY;
        "pkg-8.0+1.20.6-fabric" = _eObe7Ghj;
        "pkg-8.0+1.20.4-fabric" = _EdWNWR1b;
        "pkg-8.0+1.20.1-forge" = _2KLkVm4F;
        "pkg-8.0+1.20.1-fabric" = _Ksjb1AQt;
        "pkg-8.1+1.20.6-neoforge" = _XDXjGdYr;
        "pkg-8.1+1.21.3-forge" = _MDul3apE;
        "pkg-8.1+1.21.1-neoforge" = _lxiwdgcG;
        "pkg-8.1+1.21.3-neoforge" = _sDkT5PKl;
        "pkg-8.1+1.20.4-neoforge" = _YGfuqMQa;
        "pkg-8.1+1.20.4-forge" = _h4pXS31G;
        "pkg-8.1+1.21.1-forge" = _Hdy1XRKT;
        "pkg-8.1+1.21.1-fabric" = _anwdt85S;
        "pkg-8.1+1.20.6-fabric" = _mxVlDyUS;
        "pkg-8.1+1.20.6-forge" = _vK832jAu;
        "pkg-8.1+1.21.3-fabric" = _A8g2keFd;
        "pkg-8.1+1.20.1-forge" = _7pl6uxXm;
        "pkg-8.1+1.20.1-fabric" = _yPUnR6sh;
        "pkg-8.1+1.20.4-fabric" = _ox3Q54hX;
        "pkg-8.2+1.21.3-neoforge" = _ittTUcFh;
        "pkg-8.2+1.21.1-neoforge" = _GYqo8GVA;
        "pkg-8.2+1.20.6-neoforge" = _7marY4Qb;
        "pkg-8.2+1.20.4-neoforge" = _8MZvanCU;
        "pkg-8.2+1.21.3-forge" = _Qd3OMhAV;
        "pkg-8.2+1.20.6-forge" = _o65M9Xke;
        "pkg-8.2+1.21.1-forge" = _VAqYPTuO;
        "pkg-8.2+1.20.4-forge" = _rvdbz3LJ;
        "pkg-8.2+1.20.6-fabric" = _Iiyg2haq;
        "pkg-8.2+1.21.3-fabric" = _T4UMmflt;
        "pkg-8.2+1.21.1-fabric" = _SXOghT24;
        "pkg-8.2+1.20.1-forge" = _hzcxyAKp;
        "pkg-8.2+1.20.4-fabric" = _I57MCGCJ;
        "pkg-8.2+1.20.1-fabric" = _ZkdqioJB;
        "pkg-8.3+1.20.1-fabric" = _q0cvdlHk;
        "pkg-8.4+1.21.5-fabric" = _HN5WI2Zl;
        "pkg-8.4+1.21.3-neoforge" = _tsGQVZQw;
        "pkg-8.4+1.21.1-neoforge" = _VYwhWOaW;
        "pkg-8.4+1.21.3-forge" = _VmfzdOTo;
        "pkg-8.4+1.20.1-fabric" = _uC1CV5Ry;
        "pkg-8.4+1.21.3-fabric" = _u5raRlJi;
        "pkg-8.4+1.20.1-forge" = _FmdEZnCk;
        "pkg-8.4+1.21.1-forge" = _D8znxVp9;
        "pkg-8.4+1.21.1-fabric" = _uRzy58BQ;
        "pkg-8.5+1.21.3-fabric" = _JmvcNhwk;
        "pkg-8.5+1.21.1-fabric" = _Ir6Tj7eC;
        "pkg-8.5+1.20.1-fabric" = _A4K3nz63;
        "pkg-8.5+1.21.1-neoforge" = _pHcwiIFC;
        "pkg-8.5+1.21.1-forge" = _lqIs5qrx;
        "pkg-8.5+1.20.1-forge" = _LU8aZtwY;
        "pkg-8.5+1.21.3-forge" = _DjEAol3X;
        "pkg-8.5+1.21.5-fabric" = _ELMnZQ3G;
        "pkg-8.5+1.21.3-neoforge" = _z0JeomjE;
        "pkg-8.6+1.20.1-fabric" = _U4nOdn7C;
        "pkg-8.6+1.21.1-fabric" = _UOt2W1Fl;
        "pkg-8.6+1.21.1-neoforge" = _87o9eQl6;
        "pkg-8.6+1.21.3-fabric" = _5ClEmYQn;
        "pkg-8.6+1.21.1-forge" = _bGoxB3GH;
        "pkg-8.6+1.20.1-forge" = _rjQubX3O;
        "pkg-8.6+1.21.3-neoforge" = _tkG08Chp;
        "pkg-8.6+1.21.3-forge" = _213JFDZ5;
        "pkg-8.6+1.21.5-fabric" = _QVSizyaG;
        "pkg-8.6+1.21.7-fabric" = _2WggGtpw;
        "pkg-8.7+1.20.1-fabric" = _KRiY9Gqo;
        "pkg-8.7+1.21.1-fabric" = _UIfdln5v;
        "pkg-8.7+1.21.1-neoforge" = _9qGDflSq;
        "pkg-8.7+1.21.3-fabric" = _eIcai2cx;
        "pkg-8.7+1.21.1-forge" = _MaHYEa7k;
        "pkg-8.7+1.20.1-forge" = _E3V1cOmD;
        "pkg-8.7+1.21.3-neoforge" = _9ueIkBNH;
        "pkg-8.7+1.21.5-fabric" = _IJvY2eDQ;
        "pkg-8.7+1.21.3-forge" = _cW53LtQP;
        "pkg-8.7+1.21.7-fabric" = _VVZrvCRM;
        "pkg-8.8+1.21.7-fabric" = _R5ZuFHJ4;
        "pkg-8.9+1.21.7-fabric" = _8Pr09zfj;
        "pkg-8.10+1.21.9-fabric" = _KzlQtK91;
        "pkg-8.10+1.21.11-fabric" = _E8hWPu4w;
        "pkg-8.11+1.20.1-fabric" = _REtuWqYS;
        "pkg-8.11+1.21.1-neoforge" = _JlBOYx2k;
        "pkg-8.11+1.21.1-fabric" = _aQVVpweV;
        "pkg-8.11+1.21.11-fabric" = _8sEdPebk;
        "pkg-8.11+1.21.3-neoforge" = _jsrEp1qK;
        "pkg-8.11+1.21.3-fabric" = _bkN4DWHx;
