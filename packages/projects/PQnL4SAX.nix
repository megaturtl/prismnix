...
let
    ...
    in {
        ...
        "minecraft-26.3-snapshot-4" = _cFr7lwUy;
        "minecraft-26.3-snapshot-5" = _cFr7lwUy;
        "minecraft-26.3-snapshot-6" = _cFr7lwUy;
        "minecraft-26.3-snapshot-7" = _cFr7lwUy;
        "minecraft-26.3-snapshot-8" = _cFr7lwUy;
        ...
        "pkg-v0.4.1" = _O4fNPscD;
        "pkg-v0.4.2" = _d83NowhG;
        "pkg-v1.0.0" = _cH5YSatq;
        "pkg-v1.1.0" = _ZY2VvWSD;
        "pkg-v1.1.1-beta1" = _o0rOzI2E;
        "pkg-v1.1.1-beta2" = _vO778gYM;
        "pkg-v0.1.1" = _KAKU1MQn;
        "pkg-v0.3.0" = _f1dZWRp6;
        "pkg-v0.3.1" = _9mXuGc1p;
        "pkg-v0.3.2" = _MWFZRzKI;
        "pkg-v1.1.1-beta3" = _NRtoTZyq;
        "pkg-v1.1.1-beta4" = _wGNENtVJ;
        "pkg-v1.1.1-beta5" = _V3kqcyqs;
        "pkg-v1.1.1-beta6" = _ZeCvolkx;
        "pkg-v1.1.1-beta7" = _7QdI8h4p;
        "pkg-v1.1.1-beta8" = _iY3wwHXH;
        "pkg-v1.1.1-beta9" = _lFgZE33u;
        "pkg-v1.1.1" = _xZDyuko7;
        "pkg-v1.2.0-beta1" = _ApEaLeOW;
        "pkg-v1.2.0-beta2" = _GXHuDsxV;
        "pkg-v1.2.0-beta3" = _kLKQ7OdD;
        "pkg-v1.2.0-beta4" = _EGNEMxQa;
        "pkg-v1.2.0" = _eSDcbgnh;
        "pkg-v1.2.1-beta1" = _F8xhrLpG;
        "pkg-v1.2.1-beta2" = _1ogaEkDH;
        "pkg-v1.2.1-beta3" = _JjOhaBrg;
        "pkg-v1.2.1-beta4" = _LLWRSHGW;
        "pkg-v1.2.1-beta5" = _2dvD84qe;
        "pkg-v1.2.1-beta6" = _22jAZ93O;
        "pkg-v1.2.1-beta7" = _w9sjGY4k;
        "pkg-v1.2.1-beta8" = _uNEpSqff;
        "pkg-v1.2.1-beta9" = _BAr7JRJC;
        "pkg-v1.3.0-pre1" = _PKd2SWiC;
        "pkg-v1.3.0" = _Dr8LJh8s;
        "pkg-v1.4.0-beta1" = _DjQIZpRD;
        "pkg-v1.4.0-beta2" = _pPJ2Ufid;
        "pkg-v1.4.0-beta3" = _IKjHHC3i;
        "pkg-v1.4.0-beta4" = _Xe1zEFCr;
        "pkg-v0.3.3" = _WUubxlov;
        "pkg-v0.3.4" = _4HI7GSL4;
        "pkg-v0.3.5" = _lcgxsHeL;
        "pkg-v0.4.3" = _b6H6hJ3N;
        "pkg-v2.0.0-beta1" = _4WV444G6;
        "pkg-v2.0.0-beta2" = _doyeZV9B;
        "pkg-v2.0.0-beta3" = _if7SmbJ7;
        "pkg-v2.0.0-pre1" = _hADp849V;
        "pkg-v2.0.0" = _cG7YyzKs;
        "pkg-v2.1.0-beta1" = _eyARxJEz;
        "pkg-v2.1.0-pre1" = _mGbkI4J8;
        "pkg-v2.1.0" = _c4EXGa1J;
        "pkg-v2.1.1-pre1" = _DG3wYEAt;
        "pkg-v2.1.1" = _R5LKHVNi;
        "pkg-v3.0.0-beta1" = _Rwk9VOYd;
        "pkg-v3.0.0-beta2" = _tbFCy3AL;
        "pkg-v3.0.0-pre1" = _A6e52W19;
        "pkg-v3.0.0-pre2" = _pjr0TzTx;
        "pkg-v3.0.0-pre3" = _Dqfzb1gD;
        "pkg-v3.0.0-pre4" = _FtKL9nHM;
        "pkg-v3.0.0" = _ybt80BRh;
        "pkg-v3.1.0-beta1" = _Gd1qg6PQ;
        "pkg-v3.1.0-pre1" = _27r7tXuP;
        "pkg-v3.1.0" = _tQY5YcDc;
        "pkg-v3.2.0-pre1" = _ThueuTh1;
        "pkg-v3.2.0" = _ZfyQHkiE;
        "pkg-v3.3.0-beta.1" = _L3OVHl3C;
