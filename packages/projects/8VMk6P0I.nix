...
let
    versions = (let
        ...
        _a5lYo3E1 = {
            "id" = "a5lYo3E1";
            "file" = "multiverse-portals-5.3.0-pre.jar";
            "hash" = "sha512-5FzIrYNneqA0iiTO+NqJhBt1UIYuyUVaAgrkeyv7j/bS06woEdjKIHlbirHt7/WFz+NUmrN1Q4qaWl6JuE0NlA==";
        };
        _otf0vOqh = {
            "id" = "otf0vOqh";
            "file" = "multiverse-portals-5.3.0.jar";
            "hash" = "sha512-cxTZ98FPpHBrEoPIChs7rywRPymVENmAM74gHAeXmyg8Y30cwpoqPwJnebfnDMfKU8kmSa8hWg+Ies2AOZH44w==";
        };
    in {
        "E0F1GDgy" = _E0F1GDgy;
        "EPEE9mXU" = _EPEE9mXU;
        ...
        "bukkit-1.18.2" = _otf0vOqh;
        "bukkit-1.19" = _otf0vOqh;
        "bukkit-1.19.1" = _otf0vOqh;
        "bukkit-1.19.2" = _otf0vOqh;
        "bukkit-1.19.3" = _otf0vOqh;
        "bukkit-1.19.4" = _otf0vOqh;
        "bukkit-1.20" = _otf0vOqh;
        "bukkit-1.20.1" = _otf0vOqh;
        "bukkit-1.20.2" = _otf0vOqh;
        "bukkit-1.20.3" = _otf0vOqh;
        "bukkit-1.20.4" = _otf0vOqh;
        "bukkit-1.20.5" = _otf0vOqh;
        "bukkit-1.20.6" = _otf0vOqh;
        "bukkit-1.21" = _otf0vOqh;
        "bukkit-1.21.1" = _otf0vOqh;
        "bukkit-1.21.2" = _otf0vOqh;
        "bukkit-1.21.3" = _otf0vOqh;
        "bukkit-1.21.4" = _otf0vOqh;
        "bukkit-1.21.5" = _otf0vOqh;
        "bukkit-1.21.6" = _otf0vOqh;
        "bukkit-1.21.7" = _otf0vOqh;
        "bukkit-1.21.8" = _otf0vOqh;
        "bukkit-1.21.9" = _otf0vOqh;
        "bukkit-1.21.10" = _otf0vOqh;
        "bukkit-1.21.11" = _otf0vOqh;
        "bukkit-26.1" = _otf0vOqh;
        "bukkit-26.1.1" = _otf0vOqh;
        "bukkit-26.1.2" = _otf0vOqh;
        "bukkit-26.2" = _otf0vOqh;
        ...
        "paper-1.18.2" = _otf0vOqh;
        "paper-1.19" = _otf0vOqh;
        "paper-1.19.1" = _otf0vOqh;
        "paper-1.19.2" = _otf0vOqh;
        "paper-1.19.3" = _otf0vOqh;
        "paper-1.19.4" = _otf0vOqh;
        "paper-1.20" = _otf0vOqh;
        "paper-1.20.1" = _otf0vOqh;
        "paper-1.20.2" = _otf0vOqh;
        "paper-1.20.3" = _otf0vOqh;
        "paper-1.20.4" = _otf0vOqh;
        "paper-1.20.5" = _otf0vOqh;
        "paper-1.20.6" = _otf0vOqh;
        "paper-1.21" = _otf0vOqh;
        "paper-1.21.1" = _otf0vOqh;
        "paper-1.21.2" = _otf0vOqh;
        "paper-1.21.3" = _otf0vOqh;
        "paper-1.21.4" = _otf0vOqh;
        "paper-1.21.5" = _otf0vOqh;
        "paper-1.21.6" = _otf0vOqh;
        "paper-1.21.7" = _otf0vOqh;
        "paper-1.21.8" = _otf0vOqh;
        "paper-1.21.9" = _otf0vOqh;
        "paper-1.21.10" = _otf0vOqh;
        "paper-1.21.11" = _otf0vOqh;
        "paper-26.1" = _otf0vOqh;
        "paper-26.1.1" = _otf0vOqh;
        "paper-26.1.2" = _otf0vOqh;
        "paper-26.2" = _otf0vOqh;
        ...
        "spigot-1.18.2" = _otf0vOqh;
        "spigot-1.19" = _otf0vOqh;
        "spigot-1.19.1" = _otf0vOqh;
        "spigot-1.19.2" = _otf0vOqh;
        "spigot-1.19.3" = _otf0vOqh;
        "spigot-1.19.4" = _otf0vOqh;
        "spigot-1.20" = _otf0vOqh;
        "spigot-1.20.1" = _otf0vOqh;
        "spigot-1.20.2" = _otf0vOqh;
        "spigot-1.20.3" = _otf0vOqh;
        "spigot-1.20.4" = _otf0vOqh;
        "spigot-1.20.5" = _otf0vOqh;
        "spigot-1.20.6" = _otf0vOqh;
        "spigot-1.21" = _otf0vOqh;
        "spigot-1.21.1" = _otf0vOqh;
        "spigot-1.21.2" = _otf0vOqh;
        "spigot-1.21.3" = _otf0vOqh;
        "spigot-1.21.4" = _otf0vOqh;
        "spigot-1.21.5" = _otf0vOqh;
        "spigot-1.21.6" = _otf0vOqh;
        "spigot-1.21.7" = _otf0vOqh;
        "spigot-1.21.8" = _otf0vOqh;
        "spigot-1.21.9" = _otf0vOqh;
        "spigot-1.21.10" = _otf0vOqh;
        "spigot-1.21.11" = _otf0vOqh;
        "spigot-26.1" = _otf0vOqh;
        "spigot-26.1.1" = _otf0vOqh;
        "spigot-26.1.2" = _otf0vOqh;
        "spigot-26.2" = _otf0vOqh;
        "purpur-1.18.2" = _otf0vOqh;
        "purpur-1.19" = _otf0vOqh;
        "purpur-1.19.1" = _otf0vOqh;
        "purpur-1.19.2" = _otf0vOqh;
        "purpur-1.19.3" = _otf0vOqh;
        "purpur-1.19.4" = _otf0vOqh;
        "purpur-1.20" = _otf0vOqh;
        "purpur-1.20.1" = _otf0vOqh;
        "purpur-1.20.2" = _otf0vOqh;
        "purpur-1.20.3" = _otf0vOqh;
        "purpur-1.20.4" = _otf0vOqh;
        "purpur-1.20.5" = _otf0vOqh;
        "purpur-1.20.6" = _otf0vOqh;
        "purpur-1.21" = _otf0vOqh;
        "purpur-1.21.1" = _otf0vOqh;
        "purpur-1.21.2" = _otf0vOqh;
        "purpur-1.21.3" = _otf0vOqh;
        "purpur-1.21.4" = _otf0vOqh;
        "purpur-1.21.5" = _otf0vOqh;
        "purpur-1.21.6" = _otf0vOqh;
        "purpur-1.21.7" = _otf0vOqh;
        "purpur-1.21.8" = _otf0vOqh;
        "purpur-1.21.9" = _otf0vOqh;
        "purpur-1.21.10" = _otf0vOqh;
        "purpur-1.21.11" = _otf0vOqh;
        "purpur-26.1" = _otf0vOqh;
        "purpur-26.1.1" = _otf0vOqh;
        "purpur-26.1.2" = _otf0vOqh;
        "purpur-26.2" = _otf0vOqh;
        "pkg-4.2.3-pre.2" = _E0F1GDgy;
        "pkg-4.2.3" = _EPEE9mXU;
        "pkg-4.3.0-pre" = _R2j8xMnO;
        "pkg-5.0.0-pre.1" = _ceH0Bpn3;
        "pkg-5.0.0-pre.2" = _bdeJDrp3;
        "pkg-5.0.0-pre.3" = _TvVEJ0N5;
        "pkg-5.0.0-pre.4" = _6XocCRON;
        "pkg-5.0.0" = _LRjiRiFd;
        "pkg-5.0.1-pre" = _AHpZQVSr;
        "pkg-5.0.1" = _TbCRicKF;
        "pkg-5.0.2-pre" = _6LdCT8hO;
        "pkg-5.0.2" = _pZ1siccd;
        "pkg-5.0.3-pre" = _VwE5w1an;
        "pkg-5.0.3" = _EkQ7Vwln;
        "pkg-5.1.0-pre" = _aPjlV0Ef;
        "pkg-5.1.0-pre.1" = _aGpeYuE9;
        "pkg-5.1.0" = _BDDtFhux;
        "pkg-5.1.1-pre" = _1QezrQYF;
        "pkg-5.1.1-pre.1" = _U70eAvCK;
        "pkg-5.1.1" = _wGbGsgLc;
        "pkg-5.2.0-pre" = _ZoViatZI;
        "pkg-5.2.0" = _E3ORL9Su;
        "pkg-5.2.1-pre" = _uHqWQrMH;
        "pkg-5.2.1-pre.1" = _MuitfCOF;
        "pkg-5.2.1" = _Qy5wD65R;
        "pkg-5.2.2-pre" = _cSK0RHP5;
        "pkg-5.2.2" = _BguzNJ3r;
        "pkg-5.2.3-pre" = _2KUNIuoZ;
        "pkg-5.2.3" = _b7zoWTL2;
        "pkg-5.3.0-pre" = _a5lYo3E1;
        "pkg-5.3.0" = _otf0vOqh;
        "default" = _otf0vOqh;
    });
