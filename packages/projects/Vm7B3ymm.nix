...
let
    ...
    in {
        ...
        "pkg-0.3.1" = _AVunKmOr;
        "pkg-0.4.0" = _vm72YJNS;
        "pkg-0.4.1-dev-d9418ad" = _LJDc2Tu5;
        "pkg-0.4.1-dev-5f394a8" = _rV0G4FJV;
        "pkg-0.4.1-dev-c1f4a91" = _IrdmpSuw;
        "pkg-0.4.1-dev-3df7a7f" = _aAhisegQ;
        "pkg-0.4.1-dev-2645b90" = _j2N1wD66;
        "pkg-0.4.1-dev-068f2cf" = _dlKdYmeN;
        "pkg-0.4.1-dev-715b87a" = _6JffKe8e;
        "pkg-0.4.1-dev-623fa3c" = _v7xJ5tuk;
        "pkg-0.4.1-dev-1c078ea" = _n7bmHT5F;
        "pkg-0.4.1-dev-590994c" = _nLymR1uv;
        "pkg-0.4.1-dev-19ba7b7" = _NDCSgafP;
        "pkg-0.4.1-dev-2527fe9" = _kbPEy1LX;
        "pkg-0.4.1-dev-0cffb3f" = _Xh7vZMse;
        "pkg-0.4.1-dev-47" = _JxHq2J5e;
        "pkg-0.4.1-dev-48" = _fdFKqkhC;
        "pkg-0.4.1-dev-49" = _4k1kKM2I;
        "pkg-0.4.1" = _jDVkVX2W;
        "pkg-0.5.0-dev-55" = _Z7SFeezn;
        "pkg-0.5.0-dev-56" = _p0O0hkGD;
        "pkg-0.5.0-dev-57" = _bo1fxZXo;
        "pkg-0.5.0-dev-59" = _cd4YicpU;
        "pkg-0.5.0-dev-61" = _y2XeKyMT;
        "pkg-0.5.0-dev-62" = _pALBBypK;
        "pkg-0.5.0-dev-63" = _gmkJO8q4;
        "pkg-0.5.0-dev-64" = _pKqgXRTB;
        "pkg-0.4.2" = _zYrhZVZ8;
        "pkg-0.5.0-dev-65" = _7J2B09dr;
        "pkg-0.5.0-dev-67" = _eL0eq6Ke;
        "pkg-0.5.0-dev-68" = _OiyZbSh0;
        "pkg-0.5.0-dev-69" = _dtfAq0Fv;
        "pkg-0.5.0-dev-70" = _30KTDMGB;
        "pkg-0.5.0-dev-72" = _jttWXW2T;
        "pkg-0.5.0-dev-73" = _bIxcdjbM;
        "pkg-0.5.0-beta-75" = _vgfGf8P1;
        "pkg-0.5.0-beta-77" = _tG6eWve3;
        "pkg-0.5.0-beta-79" = _OZKwgN7A;
        "pkg-0.5.0-beta-82" = _z8bgOM8x;
        "pkg-0.5.0-beta-83" = _sKgsd6zr;
        "pkg-0.5.0-beta-84" = _ZmOHWlb4;
        "pkg-0.5.0-beta-85" = _dXQ03x3n;
        "pkg-0.5.0-beta-87" = _GeN3r16c;
        "pkg-0.5.0-beta-88" = _m0znr6aJ;
        "pkg-0.5.0-beta-91" = _46F4ymPD;
        "pkg-0.5.0-beta-94" = _5sdGe6D1;
        "pkg-0.5.0-beta-96" = _2ZOvfY8Y;
        "pkg-0.5.0-beta-97" = _gpiwI8qf;
        "pkg-0.5.0-beta-98" = _narascjD;
        "pkg-0.5.0-beta-99" = _khB3Decf;
        "pkg-0.5.0-beta-100" = _SsIt11sE;
        "pkg-0.5.0-beta-102" = _NrOnkaWr;
        "pkg-0.5.0-beta-104" = _sQK1m69M;
        "pkg-0.5.0-beta-109" = _O2eyHMSY;
        "pkg-0.5.0-beta-110" = _MdrNTCBn;
        "pkg-0.5.0-beta-111" = _SO2ztoCX;
        "pkg-0.5.0-beta-112" = _p4IvcebJ;
        "pkg-0.5.0" = _JUN4SxTQ;
        "pkg-0.6.0-beta-113" = _lFeDVuum;
        "pkg-0.5.1" = _kcjmcgTa;
        "pkg-0.6.0-beta-114" = _aUR3fab6;
        "pkg-0.6.0-beta-122" = _HOepJoyq;
        "pkg-0.6.0-beta-123" = _ivhXAjsL;
        "pkg-0.6.0-beta-124" = _3nwT2Mlj;
        "pkg-0.6.0-beta-127" = _Xjq4CegX;
        "pkg-0.6.0-beta-128" = _jmeYRQcZ;
        "pkg-0.6.0-beta-129" = _wREGFcJv;
        "pkg-0.6.0-beta-131" = _O90PHMZF;
        "pkg-0.6.0-beta-133" = _KoMI0kAk;
        "pkg-0.6.0-beta-135" = _Ph0UU16X;
        "pkg-0.6.0" = _ILeH3cs7;
        "pkg-0.7.0-beta-136" = _q88FJ96e;
        "pkg-0.6.1" = _rRndrsgN;
        "pkg-0.7.0-beta-137" = _ZzsjSNwx;
        "pkg-0.7.0-beta-138" = _PYONXInB;
        "pkg-0.7.0" = _oQQmPI0c;
        "pkg-0.8.0-beta-143" = _17S3R7mY;
        "pkg-0.8.0-beta-144" = _WzJWDfRq;
        "pkg-0.8.0-beta-145" = _tjUgDQq1;
        "pkg-0.8.0-beta-146" = _7iJQEdY3;
        "pkg-0.8.0-beta-147" = _ufZ8hj47;
        "pkg-0.8.0-beta-148" = _xRye0pFC;
        "pkg-0.8.0-beta-149" = _h112AuKf;
        "pkg-0.8.0-beta-150" = _gKFQQ6IM;
        "pkg-0.8.0-beta-151" = _JD2D3hJV;
        "pkg-0.8.0-beta-153" = _adTtmUSg;
        "pkg-0.8.0-beta-154" = _Knp6yMqY;
        "pkg-0.8.0-beta-155" = _5thuCUm6;
        "pkg-0.8.0-beta-156" = _NroGC3Ut;
        "pkg-0.8.0-beta-157" = _u74feRbn;
        "pkg-0.8.0-beta-158" = _jjpyjKkH;
        "pkg-0.8.0" = _6zRHSEd6;
        "pkg-0.9.0-beta-159" = _pxpekWNx;
        "pkg-0.9.0-beta-160" = _nDoPJ1Vc;
        "pkg-0.9.0-beta-161" = _aRyM8VK0;
        "pkg-0.9.0-beta-162" = _QyDioqWr;
        "pkg-0.9.0-beta-163" = _PltVZ2ft;
        "pkg-0.9.0-beta-164" = _2MSiUrjr;
        "pkg-0.9.0-beta-165" = _7OxOiYNg;
        "pkg-0.9.0-beta-166" = _XgzR6MPo;
        "pkg-0.9.0-beta-167" = _gSVsIraP;
        "pkg-0.9.0-beta-168" = _UeIwr0VS;
        "pkg-0.9.0-beta-169" = _sOOJlrQ1;
        "pkg-0.9.0-beta-170" = _FeSn4OYm;
        "pkg-0.9.0-beta-171" = _YY9ccUh5;
        "pkg-0.9.0-beta-172" = _N6I8TLXv;
        "pkg-0.9.0-beta-173" = _CPpAUbgE;
