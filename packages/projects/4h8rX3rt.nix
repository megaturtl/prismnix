...
let
    ...
    in {
        ...
        "folia-1.21.4" = _quvsDmZu;
        "folia-1.19.4" = _KuCRBUAX;
        "folia-1.20" = _KuCRBUAX;
        "folia-1.20.1" = _KuCRBUAX;
        "folia-1.20.2" = _NFKGrOl1;
        "folia-1.20.3" = _a6D0Fxp1;
        "folia-1.21.5" = _quvsDmZu;
        "folia-1.21.6" = _quvsDmZu;
        "folia-1.21.7" = _quvsDmZu;
        "folia-1.21.8" = _quvsDmZu;
        "folia-1.21.9" = _quvsDmZu;
        "folia-1.21.10" = _quvsDmZu;
        "folia-1.21.11" = _quvsDmZu;
        "folia-26.1" = _quvsDmZu;
        "folia-26.1.1" = _quvsDmZu;
        "folia-26.1.2" = _quvsDmZu;
        "folia-26.2" = _quvsDmZu;
        ...
        "paper-1.21.4" = _quvsDmZu;
        "paper-1.19.4" = _KuCRBUAX;
        "paper-1.20" = _KuCRBUAX;
        "paper-1.20.1" = _KuCRBUAX;
        "paper-1.20.2" = _NFKGrOl1;
        "paper-1.20.3" = _a6D0Fxp1;
        "paper-1.21.5" = _quvsDmZu;
        "paper-1.21.6" = _quvsDmZu;
        "paper-1.21.7" = _quvsDmZu;
        "paper-1.21.8" = _quvsDmZu;
        "paper-1.21.9" = _quvsDmZu;
        "paper-1.21.10" = _quvsDmZu;
        "paper-1.21.11" = _quvsDmZu;
        "paper-26.1" = _quvsDmZu;
        "paper-26.1.1" = _quvsDmZu;
        "paper-26.1.2" = _quvsDmZu;
        "paper-26.2" = _quvsDmZu;
        ...
        "purpur-1.21.4" = _quvsDmZu;
        "purpur-1.19.4" = _KuCRBUAX;
        "purpur-1.20" = _KuCRBUAX;
        "purpur-1.20.1" = _KuCRBUAX;
        "purpur-1.20.2" = _NFKGrOl1;
        "purpur-1.20.3" = _a6D0Fxp1;
        "purpur-1.21.5" = _quvsDmZu;
        "purpur-1.21.6" = _quvsDmZu;
        "purpur-1.21.7" = _quvsDmZu;
        "purpur-1.21.8" = _quvsDmZu;
        "purpur-1.21.9" = _quvsDmZu;
        "purpur-1.21.10" = _quvsDmZu;
        "purpur-1.21.11" = _quvsDmZu;
        "purpur-26.1" = _quvsDmZu;
        "purpur-26.1.1" = _quvsDmZu;
        "purpur-26.1.2" = _quvsDmZu;
        "purpur-26.2" = _quvsDmZu;
        ...
        "spigot-1.21.4" = _Uk0ciDxX;
        "spigot-1.19.4" = _KuCRBUAX;
        "spigot-1.20" = _KuCRBUAX;
        "spigot-1.20.1" = _KuCRBUAX;
        "spigot-1.20.2" = _NFKGrOl1;
        "spigot-1.20.3" = _a6D0Fxp1;
        "spigot-1.21.5" = _Uk0ciDxX;
        "spigot-1.21.6" = _Uk0ciDxX;
        "spigot-1.21.7" = _Uk0ciDxX;
        "spigot-1.21.8" = _Uk0ciDxX;
        "spigot-1.21.9" = _Uk0ciDxX;
        "spigot-1.21.10" = _Uk0ciDxX;
        "spigot-1.21.11" = _Uk0ciDxX;
        "spigot-26.1" = _Uk0ciDxX;
        "spigot-26.1.1" = _Uk0ciDxX;
        "spigot-26.1.2" = _Uk0ciDxX;
        "spigot-26.2" = _Uk0ciDxX;
        "fabric-1.21.11" = _pWUkpolk;
        "fabric-26.1" = _W3YucxNt;
        "fabric-26.1.1" = _W3YucxNt;
        "fabric-26.1.2" = _W3YucxNt;
        "fabric-26.2" = _Wh6XxT7X;
        "quilt-1.21.11" = _pWUkpolk;
        "quilt-26.1" = _W3YucxNt;
        "quilt-26.1.1" = _W3YucxNt;
        "quilt-26.1.2" = _W3YucxNt;
        "quilt-26.2" = _Wh6XxT7X;
        "pkg-1.1" = _F3PhxS5T;
        "pkg-1.2" = _fq2EahD7;
        "pkg-1.3.1" = _9wD8nLeR;
