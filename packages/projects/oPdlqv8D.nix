...
let
    ...
    in {
        ...
        "pkg-1.21.1-1.1.5" = _x7ZBVnzb;
        "pkg-1.21.1-1.1.6" = _2YH6BCfY;
        "pkg-1.21.1-1.1.7" = _VZmbjJzo;
        "pkg-1.21.1-1.1.8" = _AIh3sYiX;
        "pkg-1.21.1-1.1.9" = _jC6ggTAr;
        "pkg-1.21.1-1.1.10" = _qpH3EDyr;
        "pkg-1.21.1-1.1.11" = _VMHwpz8o;
        "pkg-1.21.1-1.1.12" = _ek6vsxhX;
        "pkg-1.21.1-1.1.13" = _CDjrqQp6;
        "pkg-1.21.1-1.1.14" = _83B5Tx90;
        "pkg-1.21.1-1.1.15" = _Gbd3ORK6;
        "pkg-1.21.1-1.1.16" = _jFpHqa4k;
        "pkg-1.21.1-1.1.17" = _h1BjMtTG;
        "pkg-1.21.1-1.1.18" = _5DOUn23T;
        "pkg-1.21.1-1.1.19" = _avOOtWAH;
        "pkg-1.21.1-2.0.0" = _BxcBEUHZ;
        "pkg-1.21.1-2.1.0" = _tKpgf1kb;
        "pkg-1.21.1-2.1.1" = _F41ECmbC;
        "pkg-1.21.1-2.1.2" = _ZymfW75i;
        "pkg-1.21.1-2.1.3" = _veWz5JJz;
        "pkg-1.21.1-2.1.4" = _4CVLNQ9X;
        "pkg-1.21.1-2.1.5" = _6zW4FJUu;
        "pkg-1.21.1-2.2.0" = _IJhKJxLi;
        "pkg-1.21.1-2.2.1" = _EN323s72;
        "pkg-1.21.1-2.2.2" = _87gJ4PM6;
        "pkg-1.21.1-2.2.3" = _652XXeKy;
        "pkg-1.21.1-2.3.0" = _bqPOzBzr;
        "pkg-1.21.1-2.3.1" = _2ZrkRYak;
        "pkg-1.21.1-2.3.2" = _x7Lj8CsZ;
        "pkg-1.21.1-2.3.3" = _EEOENf2a;
        "pkg-1.21.1-2.4.0" = _lZ0XMN9m;
        "pkg-1.21.1-2.4.1" = _mbB2flEV;
        "pkg-1.21.1-2.4.2" = _6PKrazuF;
        "pkg-1.21.1-2.4.3" = _iD2DKwYV;
        "pkg-1.21.1-2.4.4" = _NIwz94sN;
        "pkg-1.21.1-2.4.5" = _lrC9pire;
        "pkg-1.21.1-2.4.6" = _tolHGnS4;
        "pkg-1.21.1-2.4.7" = _MDmLzDC8;
        "pkg-1.21.1-2.5.0" = _6P02iosX;
        "pkg-1.21.1-2.5.1" = _r3P7K1ud;
        "pkg-1.21.1-3.0.0" = _PrhJASxK;
        "pkg-1.21.1-3.0.1" = _tL2kkYWF;
        "pkg-1.21.1-3.0.2" = _3sWx3sGZ;
        "pkg-1.21.1-3.0.3" = _Kk62nQBy;
        "pkg-1.21.1-3.0.4" = _gPSnjjRD;
        "pkg-1.21.1-3.0.5" = _7lwD07Zl;
        "pkg-1.21.1-3.0.6" = _VMpSOiZZ;
        "pkg-1.21.1-3.0.7" = _de2DY6q5;
        "pkg-1.21.1-3.0.8" = _vmhyakFr;
        "pkg-1.21.1-3.0.9" = _wwflVp0N;
        "pkg-1.21.1-3.0.10" = _pxFBikCZ;
        "pkg-1.21.1-3.0.11" = _Czpn8Puj;
        "pkg-1.21.1-3.0.12" = _Wh9OOmOU;
        "pkg-1.21.1-3.0.13" = _ewjHFuLb;
        "pkg-1.21.1-3.0.14" = _qoPJS4YP;
        "pkg-1.21.1-3.0.15" = _dF4ZLwX4;
        "pkg-1.21.1-3.0.16" = _FCpbIC1i;
        "pkg-1.21.1-3.0.17" = _ThNbTOeP;
        "pkg-1.21.1-3.0.18" = _ygc3DVr9;
        "pkg-1.21.1-3.0.19" = _j1F9cKZa;
