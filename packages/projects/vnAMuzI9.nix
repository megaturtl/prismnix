...
let
    ...
    in {
        ...
        "8MzWnDVC" = _8MzWnDVC;
        "GjMQwb73" = _GjMQwb73;
        "fabric-1.21.1" = _GjMQwb73;
        "fabric-1.21.2" = _GjMQwb73;
        "fabric-1.21.3" = _GjMQwb73;
        "fabric-1.21" = _GjMQwb73;
        "fabric-1.21.4" = _GjMQwb73;
        ...
        "fabric-1.20" = _GjMQwb73;
        "fabric-1.20.1" = _GjMQwb73;
        "fabric-1.20.2" = _GjMQwb73;
        "fabric-1.20.3" = _GjMQwb73;
        "fabric-1.20.4" = _GjMQwb73;
        "fabric-1.20.5" = _GjMQwb73;
        "fabric-1.20.6" = _GjMQwb73;
        "fabric-1.21.5" = _GjMQwb73;
        "fabric-1.21.6" = _GjMQwb73;
        "fabric-1.21.7" = _GjMQwb73;
        "fabric-1.21.8" = _GjMQwb73;
        "fabric-1.21.9" = _GjMQwb73;
        "fabric-1.21.10" = _GjMQwb73;
        "fabric-1.21.11" = _GjMQwb73;
        "fabric-26.1" = _GjMQwb73;
        "fabric-26.1.1" = _GjMQwb73;
        "fabric-26.1.2" = _GjMQwb73;
        "fabric-26.2" = _GjMQwb73;
        "pkg-0.0.1" = _wVCOMLyY;
        "pkg-0.0.2" = _ZAXQRqZ3;
        "pkg-0.0.3" = _8MzWnDVC;
        "pkg-0.0.4" = _GjMQwb73;
