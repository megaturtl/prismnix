...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _RLVUIiig;
        "pkg-1.1.0+1.21" = _WkfUM9Ip;
        "pkg-1.1.1+1.21" = _NVVA5lDb;
        "pkg-1.2.0+1.21" = _puWwzj7Q;
        "pkg-1.2.1+1.21" = _WdEqtu6M;
        "pkg-1.3.0+1.21" = _ohq95z9O;
        "pkg-1.3.1+1.21" = _ZzjJc7l6;
        "pkg-1.3.2+1.21" = _jexZVtny;
        "pkg-1.3.3+1.21" = _CaNLusxN;
        "pkg-1.3.4+1.21" = _SafjyA50;
        "pkg-2.0.0" = _7CC6YyPG;
        "pkg-2.0.1" = _XCE2X7Ka;
        "pkg-2.1.0" = _m1pvDow0;
        "pkg-2.1.1" = _TeLlG37i;
