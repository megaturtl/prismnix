...
let
    ...
    in {
        ...
        "pkg-1.0-Beta.1+1.21.4" = _7bYXA3iF;
        "pkg-1.0-Beta.2+1.21" = _FqxuGwqE;
        "pkg-1.0-Beta.2+1.21.1" = _Oxsuc67X;
        "pkg-1.0-Beta.2+1.21.3" = _l8svrmXu;
        "pkg-1.0-Beta.2+1.21.4" = _2GClT7zL;
        "pkg-1.0-Beta.3+1.21.5" = _f4EaMltV;
        "pkg-2.0.0+1.21.6" = _siaDlWuy;
        "pkg-2.0.1+1.21.6" = _VXKIt9S0;
        "pkg-2.0.1+1.21.8" = _VCpyDx7y;
        "pkg-2.0.1+1.21.10" = _rsMcnfWq;
        "pkg-2.1.0+1.21.10" = _sl4KfL1b;
        "pkg-2.2.0+1.21.10" = _yu3zjz3x;
        "pkg-2.3.0+1.21.10" = _6jhQplxe;
        "pkg-2.3.1+1.21.10" = _7b6uCWln;
        "pkg-2.4.0+1.21.10" = _lofoy2BK;
        "pkg-2.5.0+owo-0.13.0-alpha+1.21.11" = _4UwaknUk;
        "pkg-2.5.1+owo-0.13.0-alpha+1.21.11" = _eC2rycbG;
        "pkg-2.6.0+owo-0.13.0-alpha+1.21.11" = _aE9tiweQ;
        "pkg-2.6.1+1.21.11" = _EIHUsxlQ;
