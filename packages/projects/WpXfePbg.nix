...
let
    ...
    in {
        ...
        "pkg-0.4.1-alpha" = _8ejc3PX4;
        "pkg-0.4.2-alpha" = _mqIXemm9;
        "pkg-0.4.4-alpha" = _WuG14boJ;
        "pkg-0.4.5-alpha" = _JVw8E3Kn;
        "pkg-0.4.6-alpha" = _GoojAZf5;
        "pkg-0.5.0-alpha" = _3ZiTni3p;
        "pkg-0.5.1-alpha" = _lSmKssWq;
        "pkg-0.5.2-alpha" = _ESMeTdfu;
        "pkg-0.5.3-alpha" = _kKb4PUmo;
        "pkg-0.5.4-alpha" = _qiVa7ev1;
        "pkg-0.5.5-alpha+1.21.1" = _Mqo5ATdc;
        "pkg-0.5.5-alpha+1.20.1" = _d4fsc8fq;
        "pkg-0.6.0-alpha+1.21.1" = _WcBqCSTr;
        "pkg-0.6.1-alpha+1.21.1" = _EsaFoLta;
        "pkg-0.6.2-alpha+1.20.1" = _37QQcLbR;
        "pkg-0.6.2-alpha+1.21.1" = _VJBWTiOL;
        "pkg-1.0.0-beta.1+1.21.1" = _Ih6d71nt;
        "pkg-1.0.0-beta.1+1.20.1" = _Ndte06Vh;
        "pkg-1.0.0-beta.2+1.20.1" = _RdD8PKo3;
        "pkg-1.0.0-beta.3+1.21.1" = _qJi5m8B3;
        "pkg-1.0.0-beta.3+1.20.1" = _ZJGuhzlI;
        "pkg-1.0.0-beta.4+1.21.1" = _EdOR8H2G;
        "pkg-1.0.0-beta.4+1.20.1" = _BvwcQLTT;
        "pkg-1.0.0-beta.5+1.21.1" = _yh87fJbm;
        "pkg-1.0.0-beta.6+1.21.1" = _Suzt0hJP;
        "pkg-1.0.0-beta.6+1.20.1" = _GCgU3uuf;
        "pkg-1.0.0-beta.7+1.21.1" = _iX8UVmAG;
        "pkg-1.0.0-beta.7+1.20.1" = _O4wJ7c21;
        "pkg-1.0.0-beta.7+1.21.1-sinytra" = _XBFpQ1Nb;
        "pkg-1.0.0-beta.7+1.20.1-sinytra" = _ZD4eoRfX;
        "pkg-1.0.0-beta.8+1.21.1" = _DM5LZssq;
        "pkg-1.0.0-beta.8+1.20.1" = _9i5ebr4B;
        "pkg-1.0.0-beta.8+1.21.1-sinytra" = _aLIdJQwV;
        "pkg-1.0.0-beta.8+1.20.1-sinytra" = _oV0Psung;
        "pkg-1.0.0-beta.9+1.21.1" = _gnOpiftE;
        "pkg-1.0.0-beta.9+1.21.1-sinytra" = _HzQ9vKVs;
        "pkg-1.0.0-beta.10+1.21.1-fabric" = _TkwpwEYv;
        "pkg-1.0.0-beta.10+1.21.1-neoforge" = _UrTG6dMB;
        "pkg-1.0.0-beta.11+1.21.1-fabric" = _l1KpvU7C;
        "pkg-1.0.0-beta.11+1.21.1-neoforge" = _SWOBV0LZ;
        "pkg-1.0.0-beta.12+1.21.1-fabric" = _ShgjA3Fl;
        "pkg-1.0.0-beta.12+1.21.1-neoforge" = _Ab0qdifs;
        "pkg-1.0.0-beta.12+1.20.1-fabric" = _SlwZh1Qj;
        "pkg-1.0.0-beta.12+1.20.1-forge" = _8Cry0LQ3;
        "pkg-1.0.0+1.21.1-fabric" = _n219zwp6;
        "pkg-1.0.0+1.21.1-neoforge" = _o3xdxJLk;
        "pkg-1.0.0+1.20.1-fabric" = _LLYHa5LG;
        "pkg-1.0.0+1.20.1-forge" = _vMohfKyD;
        "pkg-1.1.0-beta.1+1.21.1-fabric" = _9ob8JfX9;
        "pkg-1.1.0-beta.1+1.21.1-neoforge" = _9DtKaNZ3;
        "pkg-1.1.0-beta.2+1.21.1-fabric" = _KMKVfDU7;
        "pkg-1.1.0-beta.2+1.21.1-neoforge" = _MdrBRtrE;
        "pkg-1.1.0-beta.3+1.21.1-fabric" = _nL2pCYNV;
        "pkg-1.1.0-beta.3+1.21.1-neoforge" = _Vc3u6Hop;
        "pkg-1.1.0-beta.3+1.20.1-forge" = _LsUH12X4;
        "pkg-1.1.0-beta.3+1.20.1-fabric" = _8Fi5vAxM;
        "pkg-1.1.0-beta.4+1.21.1-fabric" = _SqzrNgk2;
        "pkg-1.1.0-beta.4+1.21.1-neoforge" = _PdcNePC3;
        "pkg-1.1.0-beta.4+1.20.1-fabric" = _ATFxRhiR;
        "pkg-1.1.0-beta.4+1.20.1-forge" = _Jovjia6T;
        "pkg-1.1.0-beta.5+1.21.1-fabric" = _m6aK2z4D;
        "pkg-1.1.0-beta.5+1.21.1-neoforge" = _IknNGALU;
        "pkg-1.1.0-beta.5+1.20.1-forge" = _mEG09Bvw;
        "pkg-1.1.0-beta.5+1.20.1-fabric" = _i5yPweD8;
        "pkg-1.1.0-beta.6+1.21.1-fabric" = _DvZ1EHCb;
        "pkg-1.1.0-beta.6+1.21.1-neoforge" = _nAg8WrkS;
        "pkg-1.1.0-beta.6+1.20.1-fabric" = _pmnYxSmf;
        "pkg-1.1.0-beta.6+1.20.1-forge" = _jYUlyFP7;
        "pkg-1.1.0+1.21.1-neoforge" = _KetYYg16;
        "pkg-1.1.0+1.21.1-fabric" = _vGnvKWdF;
        "pkg-1.1.0+1.20.1-forge" = _P5WuIzER;
        "pkg-1.1.0+1.20.1-fabric" = _z7gRNPe2;
        "pkg-1.1.1+1.21.1-neoforge" = _E8sSxhfr;
        "pkg-1.1.1+1.21.1-fabric" = _jWGcwlvi;
        "pkg-1.1.1+1.20.1-forge" = _3YuIdwP4;
        "pkg-1.1.1+1.20.1-fabric" = _R9bmP5qx;
        "pkg-1.1.2+1.21.1-fabric" = _6uUzt2nw;
        "pkg-1.1.2+1.21.1-neoforge" = _F8PYwXS5;
        "pkg-1.1.2+1.20.1-fabric" = _qQ4ULoUE;
        "pkg-1.1.2+1.20.1-forge" = _bFaRIH6B;
        "pkg-1.2.0+1.21.1-fabric" = _isfZWvE5;
        "pkg-1.2.0+1.21.1-neoforge" = _b8RarI02;
        "pkg-1.2.0+1.20.1-forge" = _3p8FoEGd;
        "pkg-1.2.0+1.20.1-fabric" = _fToJ9Y0C;
        "pkg-1.2.1+1.21.1-fabric" = _v2I2cVxZ;
        "pkg-1.2.1+1.21.1-neoforge" = _OYMIKqja;
        "pkg-1.2.1+1.20.1-forge" = _6VrsjGXO;
        "pkg-1.2.1+1.20.1-fabric" = _1MoqsOL0;
        "pkg-1.2.2+1.21.1-neoforge" = _Ax2DbKoP;
