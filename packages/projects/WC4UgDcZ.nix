...
let
    ...
    in {
        ...
        "pkg-1.2.1+1.17.1" = _TzX5htHC;
        "pkg-1.3.0+1.17.1" = _Sscx1ICQ;
        "pkg-1.4.0+1.17.1" = _urzDpSmJ;
        "pkg-1.6.1+1.18.2" = _YgkcQnAa;
        "pkg-1.6.4+1.19" = _xP4gJIz9;
        "pkg-1.6.4+1.18.2" = _eDOIGDH2;
        "pkg-2.0.0+beta.2" = _YjECeC3L;
        "pkg-2.0.0+1.19.3" = _rO2oT9wY;
        "pkg-3.0.0-beta.1+1.19.3" = _xPYzzYUa;
        "pkg-3.0.0-beta.1+1.19.2" = _P30205Ui;
        "pkg-3.0.0+1.19.4" = _M07l4UUr;
        "pkg-3.1.0+1.19.2" = _IgHswvHv;
        "pkg-3.1.0+1.19.4" = _Oc3FEOr2;
        "pkg-3.1.1+1.19.2" = _ovm1IPze;
        "pkg-3.1.1+1.19.4" = _zBHuFQ6z;
        "pkg-3.1.2+1.20" = _Tw5AjLl7;
        "pkg-3.1.2+23w31a" = _HwskbxUV;
        "pkg-3.1.2+1.20.4" = _4yJLQCV2;
        "pkg-3.1.3+1.20.5-rc3" = _kLWORgCG;
        "pkg-3.2.0+1.20.5" = _LBk30s3O;
        "pkg-3.2.1+1.20.6" = _vAm2WOgJ;
        "pkg-3.2.2+1.21-rc1" = _yckYZpeJ;
        "pkg-3.2.2+1.21.2-rc1" = _QB8zUnTg;
        "pkg-4.0.0-beta.1+1.21.4-rc3" = _69T5Sezd;
        "pkg-3.1.3+1.20.1" = _Y2HLPp5D;
        "pkg-4.0.0+1.21.4-rc3" = _Nx5MtX4r;
        "pkg-3.1.4+1.20.1" = _W0SU2n1V;
        "pkg-4.0.0+1.21.1" = _fQ1HXxD4;
        "pkg-4.0.1+1.21.4" = _J7gsBhuf;
        "pkg-4.0.1+1.21.5" = _zKmPxbbK;
        "pkg-4.0.1+1.21.6-rc1" = _7ofXrpfO;
        "pkg-4.0.1+neoforge-1.21.1" = _jUOOQMmy;
        "pkg-4.0.1+1.21.9-rc1" = _gHxAH9J8;
