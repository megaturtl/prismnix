...
let
    ...
    in {
        ...
        "pkg-1.0.1-alpha-2" = _7u89NqBo;
        "pkg-1.0.2" = _ye1rUTJo;
        "pkg-1.0.2-hotfix-1" = _vYRw1LFR;
        "pkg-1.0.2-hotfix-2" = _MJB4L12y;
        "pkg-1.0.2-hotfix-3" = _3im1XYh5;
        "pkg-1.0.3-alpha-1" = _IspPN8Eg;
        "pkg-1.0.3-alpha-2" = _pxXd0G9S;
        "pkg-1.0.3-alpha-2-hotfix-1" = _6IQjzpYw;
        "pkg-1.0.4-beta-1" = _eaXsP8Kq;
        "pkg-1.0.4-release+1.20.6" = _EdZpaoHW;
        "pkg-1.0.4-release+1.20.4" = _H5WjPV0J;
        "pkg-1.0.4-release+1.20.1" = _Uutim7s5;
        "pkg-1.0.4-release+1.20.6-bugfix" = _cblL9uIN;
        "pkg-1.0.4-release+1.20.4-bugfix" = _42JdHwOX;
        "pkg-1.0.5.1-release+1.20.6" = _gu3ILs05;
        "pkg-1.0.5.1-release+1.20.6-bugfix" = _oR3IAuNX;
