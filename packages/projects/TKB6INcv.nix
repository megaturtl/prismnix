...
let
    ...
    in {
        ...
        "pkg-ars_nouveau-1.19.2-4.3.0" = _uW3BJTEA;
        "pkg-ars_nouveau-1.20.1-4.3.0" = _j0U7icsc;
        "pkg-ars_nouveau-1.19.2-3.18.0" = _zkByvUzn;
        "pkg-ars_nouveau-1.20.1-4.4.0" = _Vze5d23n;
        "pkg-ars_nouveau-1.19.2-3.19.0" = _y8LyFmNc;
        "pkg-ars_nouveau-1.20.1-4.5.0" = _je1NQgBI;
        "pkg-ars_nouveau-1.19.2-3.20" = _biETpsbh;
        "pkg-ars_nouveau-1.20.1-4.6.0" = _xdITBwya;
        "pkg-4.7.0" = _CjoGOxiS;
        "pkg-3.21.0" = _e9HNjv3O;
        "pkg-4.8.1" = _8164ilRA;
        "pkg-3.22.1" = _LuCLFFCk;
        "pkg-2.9.0" = _ffFSfxZE;
        "pkg-4.8.3" = _Wypz6cmk;
        "pkg-3.22.2" = _VEGYBbXt;
        "pkg-3.22.3" = _bm2MrJeJ;
        "pkg-4.9.0" = _qtW93rN7;
        "pkg-5.8.2" = _c8Ssk6O6;
        "pkg-4.12.6" = _5FicuxZm;
        "pkg-5.8.3" = _3ZneDEV4;
        "pkg-5.8.4" = _asuvWDxU;
        "pkg-5.8.5" = _eWFT4zXG;
        "pkg-5.8.6" = _qVheh4H2;
        "pkg-4.12.7" = _Hw2aD01e;
        "pkg-5.9.0" = _6HjOoz99;
        "pkg-5.9.1" = _EqUriQjO;
        "pkg-5.9.2" = _OBJEolKK;
        "pkg-5.9.3" = _OxDRzp1L;
        "pkg-5.9.4" = _XbkLdBPV;
        "pkg-5.10.0" = _wMbhv5fp;
        "pkg-5.10.1" = _GDlb35ZZ;
        "pkg-5.10.2" = _25UIRyBN;
        "pkg-5.10.3" = _xIV96Oiu;
        "pkg-5.10.4" = _kbGRLdlE;
        "pkg-5.10.5" = _DwPYVJRe;
        "pkg-5.10.6" = _pFwdTxwL;
        "pkg-5.11.0" = _o3KBA7yy;
        "pkg-5.11.1" = _iZimtaF0;
        "pkg-5.11.2" = _jQHRV6Y0;
        "pkg-5.11.3" = _BmGGrC9A;
        "pkg-5.11.4" = _IFrXME1k;
        "pkg-5.11.5" = _8VP4YHYr;
        "pkg-5.11.6" = _ZjQKuuy5;
        "pkg-5.11.7" = _7it3AMKj;
