...
let
    versions = (let
        ...
        _WI3Za7Qg = {
            "id" = "WI3Za7Qg";
            "file" = "hearts_white-1.1.0-mc26.3.zip";
            "hash" = "sha512-RtOanRh41G8phCJ5wfUe0DmRjvx5pJPJOvN+b+l03/U5Vg+/pvF04IIbNu8tLn8EXr+nWxAiVz2HCuXDpq/yeA==";
        };
    in {
        "Y1ZmvFOE" = _Y1ZmvFOE;
        "c47YFpXE" = _c47YFpXE;
