...
let
    ...
    in {
        ...
        "pkg-1.0.0-forge-1.21.8-58.1.4" = _YuLfGD2l;
        "pkg-1.0.0-forge-1.21.4-54.1.8" = _cNoPR07y;
        "pkg-1.0.0-forge-1.21.1-52.1.5" = _wzNxQyHI;
        "pkg-1.0.0-forge-1.20.1-47.4.9" = _uq8Y2dJV;
        "pkg-1.0.0-fabric-1.21.8-0.133.4" = _9CohVkB0;
        "pkg-1.0.0-fabric-1.21.9-0.134.0" = _s5FU8pjO;
        "pkg-1.0.0-forge-1.21.9-59.0.1" = _Egh96fog;
        "pkg-1.0.1-forge-1.21.9-59.0.5" = _XtdwrOo8;
        "pkg-1.0.0-neoforge-1.21.1-21.1.218" = _Ny6yTgmS;
        "pkg-1.0.1-forge-1.21.11-61.0.5" = _TgYWe73N;
        "pkg-1.0.1-neoforge-1.21.11-21.11.32b" = _K8Ve7ULC;
        "pkg-1.0.1-fabric-1.21.11-0.141.1" = _yMP4DEUj;
        "pkg-1.0.1-fabric-1.21.1-0.116.8" = _zp6dxAh3;
        "pkg-1.0.1-fabric-1.20.1-0.92.7" = _OjyruZBs;
        "pkg-1.0.2-fabric-26.1.1-0.145.3" = _6GPCYR02;
        "pkg-1.0.2-neoforge-26.1.1.1" = _ppDswYfg;
        "pkg-1.0.2-forge-26.1.1-63.0.0" = _AEKeSFeU;
        "pkg-1.0.3-forge-26.1.1-63.0.0" = _kEaqRxaF;
        "pkg-1.0.3-neoforge-26.1.1.1" = _MmGqHXu6;
        "pkg-1.0.3-fabric-26.1.1-0.145.3" = _wdYIwGPE;
        "pkg-1.0.3-fabric-1.20.1-0.92.7" = _2U5UKXJI;
        "pkg-1.0.4-fabric-26.1.1-0.145.2" = _D6vW41ua;
        "pkg-1.0.4-neoforge-26.1.1.1" = _QHoefRBD;
        "pkg-1.0.4-forge-26.1.1-63.0.0" = _911JdxzM;
        "pkg-1.0.4-forge-1.21.11-61.0.5" = _J5cjiv1I;
        "pkg-1.0.4-forge-1.21.9-59.0.5" = _koRoWgqZ;
        "pkg-1.0.4-forge-1.21.8-58.1.4" = _B6XjPSxV;
