...
let
    ...
    in {
        ...
        "pkg-1.0.0.3" = _bqENp0Tx;
        "pkg-1.0.0.4" = _I7GB9rew;
        "pkg-1.0.0.5" = _w3t9zxDb;
        "pkg-1.0.0.6" = _jn8eF5yh;
        "pkg-1.0.0.7" = _RFuw9Zk2;
        "pkg-1.0.0.8" = _5Txty5eW;
        "pkg-1.0.0.9" = _mkgEYv5s;
        "pkg-1.0.1.0" = _2ExgOgX8;
        "pkg-1.0.1.1" = _AtW6StuM;
        "pkg-1.0.1.2" = _VNw9PLMj;
        "pkg-1.0.1.3" = _vPb74oEc;
        "pkg-1.0.1.4" = _c4TfQwUW;
        "pkg-1.0.1.5" = _S1gx4SRX;
        "pkg-1.0.1.6" = _sEFZoPVp;
        "pkg-1.0.1.7" = _xUf5qheB;
        "pkg-1.0.1.8" = _KU4XBl8z;
        "pkg-1.0.1.9" = _kI28HKTd;
        "pkg-1.0.2.0" = _wx2kVZSO;
        "pkg-1.0.2.1" = _60uZCeFA;
        "pkg-1.0.2.2" = _BcBbugUU;
        "pkg-1.0.2.3" = _WYOAG1ac;
        "pkg-1.0.2.4" = _ga2mcfhy;
        "pkg-1.0.2.5" = _ZGHJ9fEA;
        "pkg-1.0.2.6" = _1mkMljD5;
        "pkg-2.0.0.0" = _7RqlWO7E;
        "pkg-2.0.0.1" = _1hP5ZC1B;
        "pkg-2.0.0.2" = _1yBuAvbl;
        "pkg-2.0.0.3" = _Lkz4yGwj;
        "pkg-2.0.0.5" = _paAT3NuB;
        "pkg-2.0.0.6" = _a4DerzZM;
        "pkg-2.0.0.8" = _kD42JfT9;
