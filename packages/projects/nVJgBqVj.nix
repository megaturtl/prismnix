...
let
    versions = (let
        ...
        _Kzmqv5O7 = {
            "id" = "Kzmqv5O7";
            "file" = "Animated-Ore-0.6.10+mc1.20-26.3.zip";
            "hash" = "sha512-09KKv+4KtQgGbNQwte2yGvi7HuE6mrVmzSsDM9dVAboCmt1CNM2hXdyABHPW8tsc/tkhRvZ3COJiKr2alyfyuw==";
        };
    in {
        "JTHu0m3R" = _JTHu0m3R;
        "XzhGErKz" = _XzhGErKz;
        ...
        "minecraft-1.20" = _Kzmqv5O7;
        "minecraft-1.20.1" = _Kzmqv5O7;
        "minecraft-1.20.2" = _Kzmqv5O7;
        "minecraft-1.20.3" = _Kzmqv5O7;
        "minecraft-1.20.4" = _Kzmqv5O7;
        "minecraft-1.20.5" = _Kzmqv5O7;
        "minecraft-1.20.6" = _Kzmqv5O7;
        "minecraft-1.21" = _Kzmqv5O7;
        "minecraft-1.21.1" = _Kzmqv5O7;
        ...
        "minecraft-1.21.2" = _Kzmqv5O7;
        "minecraft-1.21.3" = _Kzmqv5O7;
        "minecraft-1.21.4" = _Kzmqv5O7;
        "minecraft-1.21.5" = _Kzmqv5O7;
        "minecraft-1.21.6" = _Kzmqv5O7;
        "minecraft-1.21.7" = _Kzmqv5O7;
        "minecraft-1.21.8" = _Kzmqv5O7;
        "minecraft-1.21.9" = _Kzmqv5O7;
        "minecraft-1.21.10" = _Kzmqv5O7;
        "minecraft-1.21.11" = _Kzmqv5O7;
        "minecraft-23w31a" = _Kzmqv5O7;
        "minecraft-23w32a" = _Kzmqv5O7;
        "minecraft-23w33a" = _Kzmqv5O7;
        "minecraft-23w35a" = _Kzmqv5O7;
        "minecraft-1.20.2-pre1" = _Kzmqv5O7;
        "minecraft-23w42a" = _Kzmqv5O7;
        "minecraft-23w43a" = _Kzmqv5O7;
        "minecraft-23w43b" = _Kzmqv5O7;
        "minecraft-23w44a" = _Kzmqv5O7;
        "minecraft-23w45a" = _Kzmqv5O7;
        "minecraft-23w46a" = _Kzmqv5O7;
        "minecraft-24w03a" = _Kzmqv5O7;
        "minecraft-24w03b" = _Kzmqv5O7;
        "minecraft-24w04a" = _Kzmqv5O7;
        "minecraft-24w05a" = _Kzmqv5O7;
        "minecraft-24w05b" = _Kzmqv5O7;
        "minecraft-24w06a" = _Kzmqv5O7;
        "minecraft-24w07a" = _Kzmqv5O7;
        "minecraft-24w09a" = _Kzmqv5O7;
        "minecraft-24w10a" = _Kzmqv5O7;
        "minecraft-24w11a" = _Kzmqv5O7;
        "minecraft-24w12a" = _Kzmqv5O7;
        "minecraft-24w13a" = _Kzmqv5O7;
        "minecraft-24w14potato" = _Kzmqv5O7;
        "minecraft-24w14a" = _Kzmqv5O7;
        "minecraft-1.20.5-pre1" = _Kzmqv5O7;
        "minecraft-1.20.5-pre2" = _Kzmqv5O7;
        "minecraft-1.20.5-pre3" = _Kzmqv5O7;
        "minecraft-24w18a" = _Kzmqv5O7;
        "minecraft-24w19a" = _Kzmqv5O7;
        "minecraft-24w19b" = _Kzmqv5O7;
        "minecraft-24w20a" = _Kzmqv5O7;
        "minecraft-24w33a" = _Kzmqv5O7;
        "minecraft-24w34a" = _Kzmqv5O7;
        "minecraft-24w35a" = _Kzmqv5O7;
        "minecraft-24w36a" = _Kzmqv5O7;
        "minecraft-24w37a" = _Kzmqv5O7;
        "minecraft-24w38a" = _Kzmqv5O7;
        "minecraft-24w39a" = _Kzmqv5O7;
        "minecraft-24w40a" = _Kzmqv5O7;
        "minecraft-1.21.2-pre1" = _Kzmqv5O7;
        "minecraft-1.21.2-pre2" = _Kzmqv5O7;
        "minecraft-24w44a" = _Kzmqv5O7;
        "minecraft-24w45a" = _Kzmqv5O7;
        "minecraft-24w46a" = _Kzmqv5O7;
        "minecraft-26.1" = _Kzmqv5O7;
        "minecraft-26.1.1" = _Kzmqv5O7;
        "minecraft-26.1.2" = _Kzmqv5O7;
        "minecraft-26.2" = _Kzmqv5O7;
        "minecraft-26.3" = _Kzmqv5O7;
        "pkg-0.1.0" = _JTHu0m3R;
        "pkg-0.1.1" = _XzhGErKz;
        "pkg-0.2.0" = _pzvmYqah;
        "pkg-0.2.1" = _hx09Gg0j;
