...
let
    ...
    in {
        ...
        "pkg-1.1.2" = _jLmh1Q4M;
        "pkg-1.1.3" = _uua8xPy8;
        "pkg-2.0.0-1.21.1-neoforge" = _TgiUbrxr;
        "pkg-2.0.0-1.21.1-fabric" = _67gaaurq;
        "pkg-2.0.1-1.21.1-neoforge" = _h7unxPnM;
        "pkg-2.0.1-1.21.1-fabric" = _91fPbexz;
        "pkg-2.1.0-1.21.1-neoforge" = _8s9SOp3Q;
        "pkg-2.1.0-1.21.1-fabric" = _OO42hd40;
        "pkg-2.1.1-1.21.1-neoforge" = _F3DT6gky;
        "pkg-2.1.1-1.21.1-fabric" = _zh9VGnBg;
        "pkg-2.1.2-1.21.1-fabric" = _UDQBpEx2;
        "pkg-2.1.2-1.21.1-neoforge" = _k0Sx5TAw;
        "pkg-2.1.3-1.21.1-fabric" = _7owQDHLr;
        "pkg-2.1.3-1.21.1-neoforge" = _Y4VqYN0h;
        "pkg-2.1.4-1.21.1-neoforge" = _ioG96bRW;
