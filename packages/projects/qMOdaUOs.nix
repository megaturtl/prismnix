...
let
    ...
    in {
        ...
        "pkg-1.1.13" = _9PXtqjdr;
        "pkg-1.2.1" = _ZJxSYmNH;
        "pkg-1.2.2-pre" = _XjZMp6w6;
        "pkg-1.3.0" = _NQaipup5;
        "pkg-1.3.1" = _FK3WXvF9;
        "pkg-1.3.2-pre" = _XDELdljJ;
        "pkg-1.3.4" = _EIT4PTWK;
        "pkg-1.3.5-pre" = _nku320hs;
        "pkg-1.3.6" = _VEX8yogi;
        "pkg-1.3.7" = _KbI2fIgX;
        "pkg-1.3.8" = _XzybJbWA;
        "pkg-1.3.9" = _1AKxzdU2;
        "pkg-1.3.10" = _h0kKcsa9;
        "pkg-1.4.0" = _Pu2Qvkoe;
        "pkg-1.4.1" = _oDLsEmoc;
        "pkg-1.3.11" = _qRKTNVYA;
        "pkg-1.4.2" = _XMr0zOgP;
        "pkg-1.4.3" = _Dbl4pDXW;
        "pkg-1.4.5" = _wnbULEbM;
        "pkg-1.4.7" = _yJUaA8Wo;
        "pkg-1.4.8" = _PHlNkayM;
        "pkg-1.4.9" = _w0qNdbq8;
        "pkg-1.4.10" = _jmimfpRN;
        "pkg-1.4.11" = _5QscGEmJ;
        "pkg-1.4.12" = _eu8lHkhd;
        "pkg-1.4.13" = _S945zFQT;
