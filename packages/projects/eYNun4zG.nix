...
let
    ...
    in {
        ...
        "pkg-2.1" = _OIeKTWIY;
        "pkg-2.0" = _qNhke7Oo;
        "pkg-1.16.3.0" = _FMO5CVq8;
        "pkg-1.16.1.0" = _Ar2dnr1f;
        "pkg-1.15.2.0" = _Vl2LT6NP;
        "pkg-1.12.2.24" = _yjlrMvnN;
        "pkg-1.14.4.3" = _fPjvG4jW;
        "pkg-1.14.4.2" = _dl8AjdCh;
        "pkg-1.14.4.1" = _fvmhneNB;
        "pkg-1.14.4.0" = _BARkMKsN;
        "pkg-1.14.3.5" = _qqkDwei8;
        "pkg-1.14.3.4" = _oM9PC7D9;
        "pkg-1.14.3.3" = _shxbl1sA;
        "pkg-1.14.3.2" = _g7dwSqzL;
        "pkg-1.14.3.1" = _DQukPOgd;
        "pkg-1.14.3.0" = _FsLfmmCG;
        "pkg-1.12.2.23" = _295DJRW8;
        "pkg-1.12.2.22" = _BSmOLqQ9;
        "pkg-1.12.2.21" = _5d05QSmf;
        "pkg-1.12.2.20" = _kGvbKlHi;
        "pkg-1.12.2.19" = _PF7c7L0F;
        "pkg-1.12.2.18" = _4nml0DMF;
        "pkg-1.12.2.17" = _VNhPc2RL;
        "pkg-1.12.2.16" = _LwsVKhhZ;
        "pkg-1.12.2.15" = _tbi3NwR2;
        "pkg-1.12.2.14" = _FgY1x4Hd;
        "pkg-1.12.2.13" = _y78RRR6T;
        "pkg-1.12.2.12" = _JOK1BxfQ;
        "pkg-1.12.2.11" = _Kb4J7UpO;
        "pkg-1.12.2.10" = _zWt3QNEO;
        "pkg-1.12.2.10-1" = _qAQnwE1l;
        "pkg-1.12.2.9" = _LpAPlXwH;
        "pkg-1.12.2.8" = _BVwV8OUH;
        "pkg-1.12.2.7" = _7jIPiWRA;
        "pkg-1.12.2.6" = _2p4LpygO;
        "pkg-1.12.2.5" = _OaqbUF7K;
        "pkg-1.12.2.4" = _XUUwQRjg;
        "pkg-1.12.2.2" = _cIhBPvRY;
        "pkg-1.12.2.1" = _DrnTuQNA;
        "pkg-2.5" = _z4WaGFJq;
        "pkg-1.12.1.9-1.12.1" = _JbDLJHmB;
        "pkg-2.6" = _SRd6WMRu;
        "pkg-2.6.1" = _DThQodwx;
        "pkg-2.6.2" = _zlTuegLc;
        "pkg-2.6.3" = _nYuglY13;
