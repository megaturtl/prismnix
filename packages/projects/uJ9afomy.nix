...
let
    ...
    in {
        ...
        "pkg-1.21.1-neoforge-1.0.0" = _gkP8DuKQ;
        "pkg-1.21.1-neoforge-1.0.1" = _ICQgFwj4;
        "pkg-1.21.1-neoforge-1.0.2" = _tNqIbVWE;
        "pkg-1.21.1-neoforge-1.0.3" = _LKbkwQkf;
        "pkg-1.21.1-neoforge-1.0.4" = _YwyR8xds;
        "pkg-1.21.1-neoforge-1.0.5" = _qGcxpjQ5;
        "pkg-1.21.1-neoforge-1.0.6" = _ymYVinc8;
        "pkg-1.21.1-neoforge-1.0.7" = _7feqDcc3;
        "pkg-1.21.1-neoforge-1.0.8" = _iejV7mEP;
        "pkg-1.21.1-neoforge-1.0.9" = _xBeEHEwu;
        "pkg-1.21.1-neoforge-1.0.10" = _grPcKcqb;
        "pkg-1.21.1-neoforge-1.0.11" = _8icRweax;
        "pkg-1.21.1-neoforge-1.0.12" = _ljLcGP7u;
        "pkg-1.21.1-neoforge-1.1.0" = _yocUjT2t;
        "pkg-1.21.1-neoforge-1.1.1" = _vVCe5sPS;
        "pkg-1.20.1-forge-1.1.1" = _p2yuQ67y;
        "pkg-1.21.1-neoforge-1.1.2" = _8utlc1El;
        "pkg-1.20.1-forge-1.1.2" = _K3xpfGKM;
        "pkg-1.21.1-neoforge-1.1.3" = _d7WJgjCJ;
        "pkg-1.20.1-forge-1.1.3" = _WzfmNoo1;
        "pkg-1.20.1-forge-1.1.3.1" = _ZUA4eiHe;
        "pkg-1.20.1-forge-1.1.3.2" = _tR95Zs0m;
        "pkg-1.1.4" = _N5ikeQGg;
        "pkg-1.1.4.514-1.20.1-forge" = _ReXfuIoE;
        "pkg-1.1.5-1.21.1-neoforge" = _emZMlvJn;
        "pkg-1.1.6-1.21.1-neoforge" = _iZWZ6ORO;
        "pkg-1.1.7-1.21.1-neoforge" = _8rSBbVlC;
        "pkg-1.1.8-1.21.1-neoforge" = _1lwSJ3qz;
        "pkg-1.1.9-1.21.1-neoforge" = _GmMsMiWc;
        "pkg-1.1.11-1.21.1-neoforge" = _t9IMQi3V;
        "pkg-1.1.12-1.21.1-neoforge" = _PP2uuQ6t;
        "pkg-26.1.2-1.1.12" = _9wyPpLcp;
        "pkg-1.20.1-1.2.0" = _VGhHOKsP;
        "pkg-1.21.1-1.2.0" = _4W20Zp4P;
        "pkg-1.21.1-1.2.1" = _taIhgdOA;
        "default" = _taIhgdOA;
    });
