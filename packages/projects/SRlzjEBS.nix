...
let
    ...
    in {
        ...
        "pkg-fabric-1.19-1.2.1" = _Y2cphNfd;
        "pkg-fabric-1.19-1.3.0" = _LpibuSil;
        "pkg-fabric-1.19.1-1.3.0" = _bzk3wwaq;
        "pkg-fabric-1.19-1.4.0" = _1lBjollB;
        "pkg-fabric-1.19.1-1.4.0" = _bFbftL8q;
        "pkg-fabric-1.19-1.4.1" = _IumVE2FS;
        "pkg-fabric-1.19.1-1.4.1" = _Uib0DhkK;
        "pkg-fabric-1.19.2-1.4.1" = _ruKoiklq;
        "pkg-fabric-1.19-1.4.2" = _VkNDGYXh;
        "pkg-fabric-1.19.1-1.4.2" = _emL3xnCI;
        "pkg-fabric-1.19.2-1.4.2" = _IXnyhepU;
        "pkg-fabric-1.19-1.4.3" = _PFbPsyGl;
        "pkg-fabric-1.19.1-1.4.3" = _EK7QkTom;
        "pkg-fabric-1.19.2-1.4.3" = _RxdVdQMh;
        "pkg-fabric-1.19.2-1.4.4" = _6LbglOp5;
        "pkg-fabric-1.19.2-1.4.5" = _BhQxltzU;
        "pkg-fabric-1.19.3-1.4.5" = _WUI9tQTS;
        "pkg-fabric-1.19.4-1.5.0" = _L2uZl4yD;
        "pkg-fabric-1.19.4-1.5.1" = _SHmJR6hM;
        "pkg-fabric-1.19.4-1.5.2" = _2QQ2DTV0;
        "pkg-fabric-1.20-1.5.2" = _J6UOUzmz;
        "pkg-fabric-1.20.1-1.5.2" = _VsVdOs5V;
        "pkg-fabric-1.19.2-1.6.0" = _FsYVtipF;
        "pkg-fabric-1.19.4-1.6.0" = _JBvfTj6z;
        "pkg-fabric-1.20.1-1.6.0" = _w2d5GWbr;
        "pkg-fabric-1.19.2-1.6.1" = _lbgmMGy4;
        "pkg-fabric-1.19.4-1.6.1" = _fBK5juS7;
        "pkg-fabric-1.20.1-1.6.1" = _OdqgxAuH;
        "pkg-fabric-1.19.2-1.6.2" = _wlite8gQ;
        "pkg-fabric-1.19.4-1.6.2" = _PgJUL2ol;
        "pkg-fabric-1.20.1-1.6.2" = _MJIzsPLC;
        "pkg-fabric-1.19.2-1.7.0" = _v7XMKJXL;
        "pkg-fabric-1.19.4-1.7.0" = _ILF6hjrX;
        "pkg-fabric-1.20.1-1.7.0" = _IgVHamWI;
        "pkg-fabric-1.19.2-1.7.1" = _2cm1mjlp;
        "pkg-fabric-1.19.4-1.7.1" = _2f0iEEMy;
        "pkg-fabric-1.20.1-1.7.1" = _3WIslIUo;
        "pkg-fabric-1.19.2-1.8.0" = _AtLYMxQU;
        "pkg-fabric-1.19.4-1.8.0" = _iQlYUAN2;
        "pkg-fabric-1.20.1-1.8.0" = _mUHyN1XK;
        "pkg-fabric-1.19.2-1.8.1" = _N1SvtjUW;
        "pkg-fabric-1.19.4-1.8.1" = _U76skYXV;
        "pkg-fabric-1.20.1-1.8.1" = _dyAoCTEw;
        "pkg-fabric-1.20.2-1.8.1" = _INB3CThE;
        "pkg-fabric-1.19.2-1.8.2" = _Sr7kRfvf;
        "pkg-fabric-1.19.4-1.8.2" = _gNH3nWWN;
        "pkg-fabric-1.20.1-1.8.2" = _easvO8X7;
        "pkg-fabric-1.20.2-1.8.2" = _sqrrgHuG;
        "pkg-fabric-1.19.2-1.8.3" = _ecpQWez8;
        "pkg-fabric-1.19.4-1.8.3" = _j6JsEyhs;
        "pkg-fabric-1.20.1-1.8.3" = _mX3Gq9Ez;
        "pkg-fabric-1.20.2-1.8.3" = _sWu45rBH;
        "pkg-fabric-1.19.2-1.8.4" = _y28TkwEC;
        "pkg-fabric-1.19.4-1.8.4" = _owxcSQE0;
        "pkg-fabric-1.20.1-1.8.4" = _b7LNlHB6;
        "pkg-fabric-1.20.2-1.8.4" = _8SW9C4c0;
        "pkg-fabric-1.19.2-1.8.5" = _l0svvRat;
        "pkg-fabric-1.19.4-1.8.5" = _fBbdoxMS;
        "pkg-fabric-1.20.1-1.8.5" = _AaHt4ziE;
        "pkg-fabric-1.20.2-1.8.5" = _V7VEXKMb;
        "pkg-fabric-1.20.3-1.8.5" = _fOpJeX6i;
        "pkg-fabric-1.20.4-1.8.5" = _k53Fto1X;
        "pkg-fabric-1.19.2-1.8.6" = _NtCwrzkw;
        "pkg-fabric-1.19.4-1.8.6" = _MNGTjmkw;
        "pkg-fabric-1.20.1-1.8.6" = _PuGsTicx;
        "pkg-fabric-1.20.2-1.8.6" = _9lGjhdnd;
        "pkg-fabric-1.20.4-1.8.6" = _kI5CWPQa;
        "pkg-fabric-1.19.2-1.8.7" = _s6XhflgU;
        "pkg-fabric-1.19.4-1.8.7" = _6W3Rpja8;
        "pkg-fabric-1.20.1-1.8.7" = _oPgu3WYf;
        "pkg-fabric-1.20.2-1.8.7" = _ZFCkqM8e;
        "pkg-fabric-1.20.4-1.8.7" = _JDN9sb58;
        "pkg-fabric-1.19.2-1.8.8" = _cFPnLAOP;
        "pkg-fabric-1.19.4-1.8.8" = _ynNLYqD5;
        "pkg-fabric-1.20.1-1.8.8" = _BHHLnFVT;
        "pkg-fabric-1.20.2-1.8.8" = _X6MuqNY7;
        "pkg-fabric-1.20.4-1.8.8" = _VO20s4JC;
        "pkg-fabric-1.19.2-1.8.9" = _s5oivqda;
        "pkg-fabric-1.19.4-1.8.9" = _Y9yiwT8X;
        "pkg-fabric-1.20.1-1.8.9" = _hDi749ai;
        "pkg-fabric-1.20.2-1.8.9" = _TEMl5tcB;
        "pkg-fabric-1.20.4-1.8.9" = _stSyrtc4;
        "pkg-fabric-1.19.2-1.9.0" = _3I7Un9ea;
        "pkg-fabric-1.20.1-1.9.0" = _leSdRVZw;
        "pkg-fabric-1.20.2-1.9.0" = _7kbNLKxh;
        "pkg-fabric-1.20.4-1.9.0" = _fh0XFTz3;
        "pkg-fabric-1.19.2-1.9.1" = _DYPQhZai;
        "pkg-fabric-1.20.1-1.9.1" = _mN7QWOpr;
        "pkg-fabric-1.20.4-1.9.1" = _34d1C0gI;
        "pkg-fabric-1.20.5-1.9.1" = _ilBaou4o;
        "pkg-fabric-1.20.6-1.9.1" = _dNM9Ps0Z;
        "pkg-fabric-1.19.2-1.9.2" = _CiOBca3e;
        "pkg-fabric-1.20.1-1.9.2" = _3c0r9n0U;
        "pkg-fabric-1.20.4-1.9.2" = _HAxJuN8z;
        "pkg-fabric-1.20.6-1.9.2" = _OwGxcHnL;
        "pkg-fabric-1.20.6-1.9.3" = _bzuJfql3;
        "pkg-fabric-1.19.2-1.10.0" = _D7yqPxy9;
        "pkg-fabric-1.20.1-1.10.0" = _KqAoQhKA;
        "pkg-fabric-1.20.4-1.10.0" = _S8NRSplH;
        "pkg-fabric-1.20.6-1.10.0" = _JivX9DVU;
        "pkg-fabric-1.19.2-1.10.1" = _MGzpxf4Y;
        "pkg-fabric-1.20.1-1.10.1" = _eu3KVfnD;
        "pkg-fabric-1.20.4-1.10.1" = _GN1Cblk9;
        "pkg-fabric-1.20.6-1.10.1" = _NGfQ1mH3;
        "pkg-fabric-1.19.2-1.10.2" = _tDjvsvLH;
        "pkg-fabric-1.20.1-1.10.2" = _kzX85vih;
        "pkg-fabric-1.20.4-1.10.2" = _6nM3cFNv;
        "pkg-fabric-1.20.6-1.10.2" = _iWsbHrwJ;
        "pkg-fabric-1.21-1.10.2" = _1ml6cwS0;
        "pkg-fabric-1.21.1-1.10.2" = _USkw8wQQ;
        "pkg-fabric-1.21.1-1.10.3" = _j4Ln78VF;
        "pkg-fabric-1.19.2-1.11.0" = _XYGFrPr9;
        "pkg-fabric-1.20.1-1.11.0" = _BNaUH1EL;
        "pkg-fabric-1.21.1-1.11.0" = _sj20Kdbr;
        "pkg-fabric-1.21.1-1.12.0" = _feUw7ncq;
        "pkg-fabric-1.19.2-1.11.1" = _kMvN8BZs;
        "pkg-fabric-1.20.1-1.11.1" = _X5VnNQLt;
        "pkg-fabric-1.21.1-1.12.1" = _GSzrlWyD;
        "pkg-fabric-1.21.2-1.12.1" = _bPENebcJ;
        "pkg-fabric-1.21.2-1.12.2" = _HaxA7Tye;
        "pkg-fabric-1.21.3-1.12.2" = _kxpkRdpO;
        "pkg-fabric-1.20.1-1.13.0" = _jkyRKGIu;
        "pkg-fabric-1.21.1-1.13.0" = _HRkzrgMC;
        "pkg-fabric-1.21.3-1.13.0" = _hiD9a0hF;
        "pkg-fabric-1.20.1-1.13.1" = _7LsFhSCP;
        "pkg-fabric-1.21.1-1.13.1" = _DSyTFnau;
        "pkg-fabric-1.21.3-1.13.1" = _8Facm7PS;
        "pkg-fabric-1.21.4-1.13.1" = _we6TNJhS;
        "pkg-fabric-1.20.1-1.13.2" = _M6EFtrdy;
        "pkg-fabric-1.21.1-1.13.2" = _7SlDRxwD;
        "pkg-fabric-1.21.4-1.13.2" = _377C94c4;
        "pkg-fabric-1.21.5-1.13.2" = _gJYpGwtr;
        "pkg-fabric-1.21.6-1.13.2" = _SjXhQiPH;
        "pkg-fabric-1.21.7-1.13.2" = _1cNRNynB;
        "pkg-fabric-1.21.8-1.13.2" = _iSKldPrA;
        "pkg-fabric-2.0.0+1.21.9" = _jydNO5QR;
        "pkg-fabric-2.0.1+1.21.9" = _gHqPNYEH;
        "pkg-fabric-2.0.2+1.21.10" = _y8XpABBi;
        "pkg-fabric-2.0.3+1.21.10" = _Y22V4XOC;
        "pkg-fabric-2.0.4+1.21.10" = _lr4WB1az;
        "pkg-fabric-2.0.5+1.21.10" = _YTCMsVNR;
        "pkg-fabric-2.0.6+1.21.10" = _e2U6jlos;
        "pkg-fabric-2.0.7+1.21.10" = _h9hbHF6j;
        "pkg-fabric-2.0.8+1.21.10" = _TzIW82aR;
        "pkg-fabric-2.0.9+1.21.10" = _cD1eR1si;
        "pkg-fabric-2.0.9+1.21.11" = _c2QbXkNj;
        "pkg-fabric-2.0.10+1.21.11" = _J0LiTi6e;
        "pkg-fabric-2.1.0+1.21.10" = _x7zCnstm;
        "pkg-fabric-2.1.0+1.21.11" = _cxRGd2KF;
        "pkg-fabric-2.1.1+26.1" = _DpRWl6UL;
        "pkg-fabric-2.2.0+1.21.10" = _16QVCO5B;
        "pkg-fabric-2.2.0+1.21.11" = _7ZlqajxU;
        "pkg-fabric-2.2.0+26.1.1" = _OcGZ6w5N;
        "pkg-fabric-2.2.0+26.1.2" = _UVK6lzoH;
        "pkg-fabric-2.2.1+1.21.10" = _uPoYmW9g;
        "pkg-fabric-2.2.1+1.21.11" = _T3MNIyE2;
        "pkg-fabric-2.2.1+26.1.2" = _WJG4dBDJ;
        "pkg-fabric-2.2.1+26.2" = _sCarPr7x;
        "pkg-fabric-2.3.0+1.21.10" = _wSvxd5II;
        "pkg-fabric-2.3.0+1.21.11" = _42vONW2u;
        "pkg-fabric-2.3.0+26.1.2" = _B16e2Sw8;
        "pkg-fabric-2.3.0+26.2" = _wq8kEcV7;
        "pkg-fabric-2.4.0+1.21.10" = _IEt5o8BM;
