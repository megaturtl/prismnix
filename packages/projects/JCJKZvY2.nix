...
let
    versions = (let
        ...
        _kK77FzJA = {
            "id" = "kK77FzJA";
            "file" = "cloud-api-bungeecord.jar";
            "hash" = "sha512-lKoFGU2Btts7Zl9VErB5tI3zUYP49qnslox+fDQncsZjpqS3qEI/P7683D06QcBp1MCZRP7OAKtX3x8dY40tGQ==";
        };
        _5cdxEhlp = {
            "id" = "5cdxEhlp";
            "file" = "cloud-api-fabric.jar";
            "hash" = "sha512-7b/HpeBwGbTzVwTSazFphEoHK9dZxzo4i76Wyccp56u/U40qD24SAG3VEr7rqQfyBF5vmRyIluGNfgP+bNI/Iw==";
        };
        _Kiz9nGmW = {
            "id" = "Kiz9nGmW";
            "file" = "cloud-api-folia.jar";
            "hash" = "sha512-wvipRQojlEMLK4weZLHcSINMBZX1ruxwJ2qLV5vTftiIDR0h+AZ4xX5keFc0tKpr+sy2PzCBJBMLp729jsTwOA==";
        };
        _ZfhAcdoq = {
            "id" = "ZfhAcdoq";
            "file" = "cloud-api-neoforge.jar";
            "hash" = "sha512-K3IK4zfsldKDVvYreOsAqSCLwKbji5wbZF2NaSBpCSyfVOgi/7MujGzjMo1psgW+FDDjL5SClgw6PEDJIIgAQw==";
        };
        _l4wGwzOP = {
            "id" = "l4wGwzOP";
            "file" = "cloud-api-paper.jar";
            "hash" = "sha512-KnijyWJ+KsaMZEgssh3R21Entd9Q0kuoD+YVL6Ais8dGIp21EGyGrcquzoIxuBR6nS6Ppaf89uFwQlaVMlpc9w==";
        };
        _kzzgSCcl = {
            "id" = "kzzgSCcl";
            "file" = "cloud-api-spigot.jar";
            "hash" = "sha512-HpIGM3JgJ5aI5gSh745UyBFLzxYS6ACWTp/dVtybGQncHyuW58l7jlASiOnhspJyTfBJpBSx/FUy7NCx9iM52A==";
        };
        _lZftp12l = {
            "id" = "lZftp12l";
            "file" = "cloud-api-spigot-legacy.jar";
            "hash" = "sha512-2ntwdjFhuCyVY8aGv4bNGlhs76CKlbHIVeT2DJPawsyiSIbccTGStvOUEATPCdkDLFPreWgpUHAywmuaVnslow==";
        };
        _b8RbP2ji = {
            "id" = "b8RbP2ji";
            "file" = "cloud-api-velocity.jar";
            "hash" = "sha512-Ui4YsfhM0QL8pjRg/0G41IHCMs2sLBqRCmHw1nnHoAuAoCoWA+wRd9zcrfh25zxw952TjJlE2B8Pr9pkQqAZHw==";
        };
        _mmf0DBXL = {
            "id" = "mmf0DBXL";
            "file" = "cloud-api-bungeecord.jar";
            "hash" = "sha512-DZBxdLJRrt0wKKgS8nVYM129tB/OKf5CSsqvQRM0nc0xBwRZ0NfagLJh9sfN4xZvaA1DXVellTcmmPZLZghuqg==";
        };
        _RtTHx08x = {
            "id" = "RtTHx08x";
            "file" = "cloud-api-fabric.jar";
            "hash" = "sha512-08YJCMvHrIv0bjVoh/9k3V8t2QMT3AR0b5S57H2yrAlkGtrmNe2KJec10CsLFHbI1bc1ZYyIAQ5vgY8SuGRkgQ==";
        };
        _tRZgefYe = {
            "id" = "tRZgefYe";
            "file" = "cloud-api-folia.jar";
            "hash" = "sha512-3T008I4hc0vDRnj9pQjfWgj4WUTim8un57WgyKIhwYVf+3X7mYCON2xgazdeWERel74s302I+69Aj3w1Xhx8KA==";
        };
        _PPlnaQel = {
            "id" = "PPlnaQel";
            "file" = "cloud-api-neoforge.jar";
            "hash" = "sha512-nX8/1NNy0jq1eulior9kZX1trwJxfts5pN6m7azhIG8cvbu8z/rZeok/aWmEB7eG3kRnqrOv6ikabV731HI1Ow==";
        };
        _aerbjfPO = {
            "id" = "aerbjfPO";
            "file" = "cloud-api-paper.jar";
            "hash" = "sha512-9Cnjv5RLKWzyd/8Xt7w5L3Z6KL82eCJgSvA16Yu6Zkm8wa7glDQMxt/4NPZinUBZHOgPyq1mL1S5+4k3/vsj3A==";
        };
        _nqQF4mek = {
            "id" = "nqQF4mek";
            "file" = "cloud-api-spigot.jar";
            "hash" = "sha512-WskD2fZAdTB1LNiBKFUdoLN0pcArR2Qv3ORkRvyuUXEY0G5Q667LziM+rTN8IJPfyDkXQ2TAypE9R3Yplo1yDw==";
        };
        _N4dt1qKc = {
            "id" = "N4dt1qKc";
            "file" = "cloud-api-spigot-legacy.jar";
            "hash" = "sha512-FF5xo5+sqvLWU0ANaDM5j7t9LlLf87YgnoAt7xleWtf1uFErv7tGjehxSZ9ag5YUs9TLBabD/Q9eizCZMshYNg==";
        };
        _3cOFbECo = {
            "id" = "3cOFbECo";
            "file" = "cloud-api-velocity.jar";
            "hash" = "sha512-g1T/JU2JAsxG87bGNGpw4PBuoq1khXUMU7XPkKLv7fhiCBcuKFL/+9t7zrC5AvdzHZkCY1z8pOyNILih2UJt8Q==";
        };
        _L9Opa76P = {
            "id" = "L9Opa76P";
            "file" = "cloud-api-bungeecord.jar";
            "hash" = "sha512-yEnJnhcCc62ELw90zhqqiOc6+le3jcXy3ZHrAhoPYaKfpZ+9/ozjyqafxlfQZhxwOXvVW5ZPiHYLV4/kUtXBaQ==";
        };
        _6o6IxHCh = {
            "id" = "6o6IxHCh";
            "file" = "cloud-api-fabric.jar";
            "hash" = "sha512-BZDCfMRHUhLg0HPt9qHbRuuSGf8ZOWJLXiM6E4gnbYaRHoH0x4S7yveuhS+jFCeJtU1GUgSGLFySmaYZa2EX1g==";
        };
        _Bxa8brPY = {
            "id" = "Bxa8brPY";
            "file" = "cloud-api-folia.jar";
            "hash" = "sha512-lWZZBvjBIMRKxQHhHZ+b8YDMquycxNyBxNOwDBS9sSMZKcG3JohypFn8EhTNLZIBvICy4JUg5UADNoyDF+fiKg==";
        };
        _G5aRjj8J = {
            "id" = "G5aRjj8J";
            "file" = "cloud-api-neoforge.jar";
            "hash" = "sha512-fw4VDUEZ4K3cp0f+2w10InVYO8mjN6/MWhBI6erTD/PUjEFd6H2E2ym76KvFwgXIeJILP1NNADjxgqiNnT0pkw==";
        };
        _u6Kzu7Vl = {
            "id" = "u6Kzu7Vl";
            "file" = "cloud-api-paper.jar";
            "hash" = "sha512-4yuzi1XX7nK0y4GqOYl2KvLIK09A3AsELaqfjnmP1uudHzvYZN+Jv++DhmbhCnDzrqa3uLxU8KOG7CSI8/d7xw==";
        };
        _o7NSrxxr = {
            "id" = "o7NSrxxr";
            "file" = "cloud-api-spigot.jar";
            "hash" = "sha512-dxrBKqRP3OpoNsof8x/rKyzEVhdiXkXSNxJXOT2G+O7Re3B5r0fBCZjUgwjlfd1fK8syK5jVkArrZO7VD8fKaw==";
        };
        _dgXHsB4Z = {
            "id" = "dgXHsB4Z";
            "file" = "cloud-api-spigot-legacy.jar";
            "hash" = "sha512-in8vO41PXTDV7HRBTws4mOhBnj458a6LMdZtlZhn2q5KCic5z0m3xVK3as6X64WSAGH7bzyMrpWRsBHF7M4qqQ==";
        };
        _TzzhK0G4 = {
            "id" = "TzzhK0G4";
            "file" = "cloud-api-velocity.jar";
            "hash" = "sha512-u9lG4OaSrYgqeRjOH4RdhzxiA0L8J0MzGs3KH4ikVIN/Tt/Q7pXyzT8blO+eHurzhu40i1+hjUyuSx8jdF1Zyw==";
        };
        _Ma6HuIbs = {
            "id" = "Ma6HuIbs";
            "file" = "cloud-api-bungeecord.jar";
            "hash" = "sha512-zBEC4W+itnfASTlerT7Zkx7+wQJb2aUROv/elbHEOV7mSBwOcMsOwH3rOFIVizdfgSLNbqD5l43rwFTnAk+ePQ==";
        };
        _ptimmqt1 = {
            "id" = "ptimmqt1";
            "file" = "cloud-api-fabric.jar";
            "hash" = "sha512-67AVX4cukWDFXSCV50bJMqT49gKewRfEiOB6QKFRrj1iNdsLBy9M1ljwrN7V+ZrQn+rR+P8gkcnAnNyjT5qVsg==";
        };
        _obHPJfTi = {
            "id" = "obHPJfTi";
            "file" = "cloud-api-folia.jar";
            "hash" = "sha512-qU4V6ce/day74CWR5T0a09ZV9eiWwlkmP4bSLt/KSBl3gs9SOlg333ML2hiv3u0BuFlXahoMgYw+eoL0EFGXWA==";
        };
        _3h07trhG = {
            "id" = "3h07trhG";
            "file" = "cloud-api-neoforge.jar";
            "hash" = "sha512-OoSMbcB+reNTjDqjg2KgCy2y7PEVCPn+GzfL1avo3TXBZnppJxbs4rScQDYxNpa3h05FtDdXqxsj4hmikQqjOw==";
        };
        _ycODalQR = {
            "id" = "ycODalQR";
            "file" = "cloud-api-paper.jar";
            "hash" = "sha512-GaJY/chS/Xz7CtTeVB3Vpn9f3C4JUqANV57vKjJS4mtW3nUrNtMgFTlpVyHMqiihRQWYbgA+nLMyl337K2JJgw==";
        };
        _eP1O4gMf = {
            "id" = "eP1O4gMf";
            "file" = "cloud-api-spigot.jar";
            "hash" = "sha512-9yv/Unz6Adn9+7PtAygJmR7AqXVoB8FTgqeb82ZUjWqrLn4+3DQ8udejd9Nnvw352OQm+ewrlOPPADklVoyiPw==";
        };
        _nxQl71qC = {
            "id" = "nxQl71qC";
            "file" = "cloud-api-spigot-legacy.jar";
            "hash" = "sha512-zeqsyEKdaWW+2rKD7uZr2JW7QAULGBM0dOLNycMuAgALNe3l2zpBzqI26GbdKrgDwToGx+5YWy8flh6pPP/Llw==";
        };
        _Xvwfjvs9 = {
            "id" = "Xvwfjvs9";
            "file" = "cloud-api-velocity.jar";
            "hash" = "sha512-ZmLhoXiu8jhIm/yJIL1ydVsDmzZ+jtPHPqdBC8EhaSiNDvGzEiuznV/4hSOsMLOPuWtJ9RLRIkYNQmm2FSGgRQ==";
        };
        _3IvjOBsm = {
            "id" = "3IvjOBsm";
            "file" = "cloud-api-bungeecord.jar";
            "hash" = "sha512-Z+Pu0mIsjdSqGUGXE6oxI+0UWSvZ6nG+nG2SJz4WuLA6OPobh6VfE4DRbI/NmAv3MMgbeEgH8mHyxJ6qxU3h7Q==";
        };
        _J2FGSKVi = {
            "id" = "J2FGSKVi";
            "file" = "cloud-api-fabric.jar";
            "hash" = "sha512-C6vXX+q08qDeRaLQeGZbRzqQsuZB6n3MJHU053OqMzqkXNYLqe0fHjEM8DDKpY2ndaSf+JBjLvtMCV9u6MEfiQ==";
        };
        _U3YhxIHX = {
            "id" = "U3YhxIHX";
            "file" = "cloud-api-folia.jar";
            "hash" = "sha512-Wbn20rmvPKpkRHCVkUPKIURCtuTs+jgi/EWj8EUGRAgq5C4GkHuUyYyjTQseYh+7exmW35RKdu2o49XCdiwBLQ==";
        };
        _dCc3FYje = {
            "id" = "dCc3FYje";
            "file" = "cloud-api-neoforge.jar";
            "hash" = "sha512-pAFZf6CvZMjp/GH9+cO9bm5S/0ZeAo8dZNTMgWuaomXUclbEV2gUejZ1r6G6hQd9sHZ6ikIH4a7rZlkNZe9efw==";
        };
        _4gZZkloZ = {
            "id" = "4gZZkloZ";
            "file" = "cloud-api-paper.jar";
            "hash" = "sha512-ExFXjm/nGuzb7rm1cGvJ87j4HOPkCmXBHtgcxmHCTqfauSEEB6ZdFvKFDvJN3GiIbwTzXGS/zgcWxz36cgiBDg==";
        };
        _jv5DDKIT = {
            "id" = "jv5DDKIT";
            "file" = "cloud-api-spigot.jar";
            "hash" = "sha512-b8tOcQjsKFh3gjsfalm8F6+P6TEFxQaCUKOs6pNsS9jYwGV9003Rw8aU4u4kKraiUFw7XSGUzeDpwcJbM+mVbg==";
        };
        _b4cm0IZd = {
            "id" = "b4cm0IZd";
            "file" = "cloud-api-spigot-legacy.jar";
            "hash" = "sha512-Q6t0Oq03czuoaXqgU/gTqNjbin6Zbbpj4xOTY+PyaZZvLKf5KXVT2nW2mwVMzK6RRWWM0BX/92OFZViydVawZg==";
        };
        _zIIbDSu9 = {
            "id" = "zIIbDSu9";
            "file" = "cloud-api-velocity.jar";
            "hash" = "sha512-rY9mLpEstd2wOmQx/niMr3Epq/vEa26SzV4Gr0JijjF4ffNWuynCTLRbGpTK2f6U01OK4/JuO2bDR23Z++Q5rw==";
        };
    in {
        "jKn3X0Bp" = _jKn3X0Bp;
        "6NRwVGLp" = _6NRwVGLp;
        ...
        "b4cm0IZd" = _b4cm0IZd;
        "zIIbDSu9" = _zIIbDSu9;
        "bungeecord-1.20" = _3IvjOBsm;
        "bungeecord-1.20.1" = _3IvjOBsm;
        "bungeecord-1.20.2" = _3IvjOBsm;
        "bungeecord-1.20.3" = _3IvjOBsm;
        "bungeecord-1.20.4" = _3IvjOBsm;
        "bungeecord-1.20.5" = _3IvjOBsm;
        "bungeecord-1.20.6" = _3IvjOBsm;
        "bungeecord-1.21" = _3IvjOBsm;
        "bungeecord-1.21.1" = _3IvjOBsm;
        "bungeecord-1.21.2" = _3IvjOBsm;
        "bungeecord-1.21.3" = _3IvjOBsm;
        "bungeecord-1.21.4" = _3IvjOBsm;
        "bungeecord-1.21.5" = _3IvjOBsm;
        "bungeecord-1.21.6" = _3IvjOBsm;
        "bungeecord-1.21.7" = _3IvjOBsm;
        "bungeecord-1.21.8" = _3IvjOBsm;
        "bungeecord-1.21.9" = _3IvjOBsm;
        "bungeecord-1.21.10" = _3IvjOBsm;
        "bungeecord-1.21.11" = _3IvjOBsm;
        "bungeecord-26.1" = _3IvjOBsm;
        "bungeecord-26.1.1" = _3IvjOBsm;
        "bungeecord-26.1.2" = _3IvjOBsm;
        "bungeecord-26.2" = _3IvjOBsm;
        "bungeecord-26.3" = _3IvjOBsm;
        "paper-1.20" = _4gZZkloZ;
        "paper-1.20.1" = _4gZZkloZ;
        "paper-1.20.2" = _4gZZkloZ;
        "paper-1.20.3" = _4gZZkloZ;
        "paper-1.20.4" = _4gZZkloZ;
        "paper-1.20.5" = _4gZZkloZ;
        "paper-1.20.6" = _4gZZkloZ;
        "paper-1.21" = _4gZZkloZ;
        "paper-1.21.1" = _4gZZkloZ;
        "paper-1.21.2" = _4gZZkloZ;
        "paper-1.21.3" = _4gZZkloZ;
        "paper-1.21.4" = _4gZZkloZ;
        "paper-1.21.5" = _4gZZkloZ;
        "paper-1.21.6" = _4gZZkloZ;
        "paper-1.21.7" = _4gZZkloZ;
        "paper-1.8.8" = _b4cm0IZd;
        "paper-1.8.9" = _b4cm0IZd;
        "paper-1.9" = _b4cm0IZd;
        "paper-1.9.1" = _b4cm0IZd;
        "paper-1.9.2" = _b4cm0IZd;
        "paper-1.9.3" = _b4cm0IZd;
        "paper-1.9.4" = _b4cm0IZd;
        "paper-1.10" = _b4cm0IZd;
        "paper-1.10.1" = _b4cm0IZd;
        "paper-1.10.2" = _b4cm0IZd;
        "paper-1.11" = _b4cm0IZd;
        "paper-1.11.1" = _b4cm0IZd;
        "paper-1.11.2" = _b4cm0IZd;
        "paper-1.12" = _b4cm0IZd;
        "paper-1.12.1" = _b4cm0IZd;
        "paper-1.12.2" = _b4cm0IZd;
        "paper-1.13" = _b4cm0IZd;
        "paper-1.13.1" = _b4cm0IZd;
        "paper-1.13.2" = _b4cm0IZd;
        "paper-1.14" = _b4cm0IZd;
        "paper-1.14.1" = _b4cm0IZd;
        "paper-1.14.2" = _b4cm0IZd;
        "paper-1.14.3" = _b4cm0IZd;
        "paper-1.14.4" = _b4cm0IZd;
        "paper-1.15" = _b4cm0IZd;
        "paper-1.15.1" = _b4cm0IZd;
        "paper-1.15.2" = _b4cm0IZd;
        "paper-1.16" = _b4cm0IZd;
        "paper-1.16.1" = _b4cm0IZd;
        "paper-1.16.2" = _b4cm0IZd;
        "paper-1.16.3" = _b4cm0IZd;
        "paper-1.16.4" = _b4cm0IZd;
        "paper-1.16.5" = _b4cm0IZd;
        "paper-1.17" = _b4cm0IZd;
        "paper-1.17.1" = _b4cm0IZd;
        "paper-1.18" = _b4cm0IZd;
        "paper-1.18.1" = _b4cm0IZd;
        "paper-1.18.2" = _b4cm0IZd;
        "paper-1.19" = _b4cm0IZd;
        "paper-1.19.1" = _b4cm0IZd;
        "paper-1.19.2" = _b4cm0IZd;
        "paper-1.19.3" = _b4cm0IZd;
        "paper-1.19.4" = _b4cm0IZd;
        "paper-1.21.8" = _4gZZkloZ;
        "paper-1.21.9" = _4gZZkloZ;
        "paper-1.21.10" = _4gZZkloZ;
        "paper-1.21.11" = _4gZZkloZ;
        "paper-26.1" = _4gZZkloZ;
        "paper-26.1.1" = _4gZZkloZ;
        "paper-26.1.2" = _4gZZkloZ;
        "paper-26.2" = _4gZZkloZ;
        "paper-26.3" = _4gZZkloZ;
        "spigot-1.20" = _jv5DDKIT;
        "spigot-1.20.1" = _jv5DDKIT;
        "spigot-1.20.2" = _jv5DDKIT;
        "spigot-1.20.3" = _jv5DDKIT;
        "spigot-1.20.4" = _jv5DDKIT;
        "spigot-1.20.5" = _jv5DDKIT;
        "spigot-1.20.6" = _jv5DDKIT;
        "spigot-1.21" = _jv5DDKIT;
        "spigot-1.21.1" = _jv5DDKIT;
        "spigot-1.21.2" = _jv5DDKIT;
        "spigot-1.21.3" = _jv5DDKIT;
        "spigot-1.21.4" = _jv5DDKIT;
        "spigot-1.21.5" = _jv5DDKIT;
        "spigot-1.21.6" = _jv5DDKIT;
        "spigot-1.21.7" = _jv5DDKIT;
        "spigot-1.8.8" = _b4cm0IZd;
        "spigot-1.8.9" = _b4cm0IZd;
        "spigot-1.9" = _b4cm0IZd;
        "spigot-1.9.1" = _b4cm0IZd;
        "spigot-1.9.2" = _b4cm0IZd;
        "spigot-1.9.3" = _b4cm0IZd;
        "spigot-1.9.4" = _b4cm0IZd;
        "spigot-1.10" = _b4cm0IZd;
        "spigot-1.10.1" = _b4cm0IZd;
        "spigot-1.10.2" = _b4cm0IZd;
        "spigot-1.11" = _b4cm0IZd;
        "spigot-1.11.1" = _b4cm0IZd;
        "spigot-1.11.2" = _b4cm0IZd;
        "spigot-1.12" = _b4cm0IZd;
        "spigot-1.12.1" = _b4cm0IZd;
        "spigot-1.12.2" = _b4cm0IZd;
        "spigot-1.13" = _b4cm0IZd;
        "spigot-1.13.1" = _b4cm0IZd;
        "spigot-1.13.2" = _b4cm0IZd;
        "spigot-1.14" = _b4cm0IZd;
        "spigot-1.14.1" = _b4cm0IZd;
        "spigot-1.14.2" = _b4cm0IZd;
        "spigot-1.14.3" = _b4cm0IZd;
        "spigot-1.14.4" = _b4cm0IZd;
        "spigot-1.15" = _b4cm0IZd;
        "spigot-1.15.1" = _b4cm0IZd;
        "spigot-1.15.2" = _b4cm0IZd;
        "spigot-1.16" = _b4cm0IZd;
        "spigot-1.16.1" = _b4cm0IZd;
        "spigot-1.16.2" = _b4cm0IZd;
        "spigot-1.16.3" = _b4cm0IZd;
        "spigot-1.16.4" = _b4cm0IZd;
        "spigot-1.16.5" = _b4cm0IZd;
        "spigot-1.17" = _b4cm0IZd;
        "spigot-1.17.1" = _b4cm0IZd;
        "spigot-1.18" = _b4cm0IZd;
        "spigot-1.18.1" = _b4cm0IZd;
        "spigot-1.18.2" = _b4cm0IZd;
        "spigot-1.19" = _b4cm0IZd;
        "spigot-1.19.1" = _b4cm0IZd;
        "spigot-1.19.2" = _b4cm0IZd;
        "spigot-1.19.3" = _b4cm0IZd;
        "spigot-1.19.4" = _b4cm0IZd;
        "spigot-1.21.8" = _jv5DDKIT;
        "spigot-1.21.9" = _jv5DDKIT;
        "spigot-1.21.10" = _jv5DDKIT;
        "spigot-1.21.11" = _jv5DDKIT;
        "spigot-26.1" = _jv5DDKIT;
        "spigot-26.1.1" = _jv5DDKIT;
        "spigot-26.1.2" = _jv5DDKIT;
        "spigot-26.2" = _jv5DDKIT;
        "spigot-26.3" = _jv5DDKIT;
        "velocity-1.20" = _zIIbDSu9;
        "velocity-1.20.1" = _zIIbDSu9;
        "velocity-1.20.2" = _zIIbDSu9;
        "velocity-1.20.3" = _zIIbDSu9;
        "velocity-1.20.4" = _zIIbDSu9;
        "velocity-1.20.5" = _zIIbDSu9;
        "velocity-1.20.6" = _zIIbDSu9;
        "velocity-1.21" = _zIIbDSu9;
        "velocity-1.21.1" = _zIIbDSu9;
        "velocity-1.21.2" = _zIIbDSu9;
        "velocity-1.21.3" = _zIIbDSu9;
        "velocity-1.21.4" = _zIIbDSu9;
        "velocity-1.21.5" = _zIIbDSu9;
        "velocity-1.21.6" = _zIIbDSu9;
        "velocity-1.21.7" = _zIIbDSu9;
        "velocity-1.21.8" = _zIIbDSu9;
        "velocity-1.21.9" = _zIIbDSu9;
        "velocity-1.21.10" = _zIIbDSu9;
        "velocity-1.21.11" = _zIIbDSu9;
        "velocity-26.1" = _zIIbDSu9;
        "velocity-26.1.1" = _zIIbDSu9;
        "velocity-26.1.2" = _zIIbDSu9;
        "velocity-26.2" = _zIIbDSu9;
        "velocity-26.3" = _zIIbDSu9;
        ...
        "waterfall-1.20" = _3IvjOBsm;
        "waterfall-1.20.1" = _3IvjOBsm;
        "waterfall-1.20.2" = _3IvjOBsm;
        "waterfall-1.20.3" = _3IvjOBsm;
        "waterfall-1.20.4" = _3IvjOBsm;
        "waterfall-1.20.5" = _3IvjOBsm;
        "waterfall-1.20.6" = _3IvjOBsm;
        "waterfall-1.21" = _3IvjOBsm;
        "waterfall-1.21.1" = _3IvjOBsm;
        "waterfall-1.21.2" = _3IvjOBsm;
        "waterfall-1.21.3" = _3IvjOBsm;
        "waterfall-1.21.4" = _3IvjOBsm;
        "waterfall-1.21.5" = _3IvjOBsm;
        "waterfall-1.21.6" = _3IvjOBsm;
        "waterfall-1.21.7" = _3IvjOBsm;
        "waterfall-1.21.8" = _3IvjOBsm;
        "waterfall-1.21.9" = _3IvjOBsm;
        "waterfall-1.21.10" = _3IvjOBsm;
        "waterfall-1.21.11" = _3IvjOBsm;
        "waterfall-26.1" = _3IvjOBsm;
        "waterfall-26.1.1" = _3IvjOBsm;
        "waterfall-26.1.2" = _3IvjOBsm;
        "waterfall-26.2" = _3IvjOBsm;
        "waterfall-26.3" = _3IvjOBsm;
        "folia-1.20" = _U3YhxIHX;
        "folia-1.20.1" = _U3YhxIHX;
        "folia-1.20.2" = _U3YhxIHX;
        "folia-1.20.3" = _U3YhxIHX;
        "folia-1.20.4" = _U3YhxIHX;
        "folia-1.20.5" = _U3YhxIHX;
        "folia-1.20.6" = _U3YhxIHX;
        "folia-1.21" = _U3YhxIHX;
        "folia-1.21.1" = _U3YhxIHX;
        "folia-1.21.2" = _U3YhxIHX;
        "folia-1.21.3" = _U3YhxIHX;
        "folia-1.21.4" = _U3YhxIHX;
        "folia-1.21.5" = _U3YhxIHX;
        "folia-1.21.6" = _U3YhxIHX;
        "folia-1.21.7" = _U3YhxIHX;
        "folia-1.21.8" = _U3YhxIHX;
        "folia-1.21.9" = _U3YhxIHX;
        "folia-1.21.10" = _U3YhxIHX;
        "folia-1.21.11" = _U3YhxIHX;
        "folia-26.1" = _U3YhxIHX;
        "folia-26.1.1" = _U3YhxIHX;
        "folia-26.1.2" = _U3YhxIHX;
        "folia-26.2" = _U3YhxIHX;
        "folia-26.3" = _U3YhxIHX;
        "fabric-26.2" = _J2FGSKVi;
        "quilt-26.2" = _J2FGSKVi;
        "neoforge-26.2" = _dCc3FYje;
        "pkg-1.0-SNAPSHOT" = _arGa1rzo;
        "pkg-0.0.1-dev.1743688443442-aff7cfa" = _bdiDVOXQ;
        "pkg-0.0.1-dev.1743688796589-69c93a8" = _duV9DFyD;
        "pkg-0.0.1-dev.1743688942509-a242341" = _3uWD4Q49;
        "pkg-0.0.1-dev.1743700894431-2f98560" = _TBUAaVG3;
        "pkg-0.0.1-dev.1744713131470-a7802c0" = _EGFmkXKF;
        "pkg-0.0.2-dev.1744717078727-819585e" = _znAcxl73;
        "pkg-0.0.3-dev.1744717526020-34dfb30" = _2R0oJpOk;
        "pkg-0.0.3-dev.1744920787482-4122069" = _GtpCDLZc;
        "pkg-0.0.4-dev.1744920927981-3c27388" = _gMIdcgQk;
        "pkg-0.0.4-dev.1745076813105-0904482" = _80pDJsxb;
        "pkg-0.0.5-dev.1745077023874-28517d8" = _UWoE56wA;
        "pkg-0.0.6-dev.1747916569574-b7deffb" = _tkBjkJPX;
        "pkg-0.0.7-dev.1747949363563-0c7674c" = _xFF2HzQn;
        "pkg-0.0.7-dev.1749992250931-c9348e3" = _RANW6Hjk;
        "pkg-0.0.8-dev.1749992712896-56a5cc1" = _v88eVqBd;
        "pkg-0.0.8-dev.1750000467265-aa565db" = _TNvYAWHr;
        "pkg-0.0.9-dev.1750000683327-f3c29aa" = _covwiCE4;
        "pkg-0.0.9-dev.1750782287408-1b2646b" = _e5NQuhKz;
        "pkg-0.0.9-dev.1750784237749-b2530e7" = _rjk3d0LR;
        "pkg-0.0.10-dev.1751299068518-450d276" = _7AgQC9xG;
        "pkg-0.0.11-dev.1751395143885-f141b9f" = _5rTWs4Mj;
        "pkg-0.0.11-dev.1751445471668-178848a" = _g9iIQ6tQ;
        "pkg-0.0.12-dev.1751445628553-de60119" = _YyXcLQpQ;
        "pkg-0.0.13-dev.1752279992182-bdc4186" = _ckLZus14;
        "pkg-0.0.14-dev.1754211550807-3e24206" = _vUVErsMj;
        "pkg-0.0.14-dev.1754248809479-5f2e488" = _tJtIDFP3;
        "pkg-0.0.14-dev.1754248985479-5f2e488" = _CCjVfmTj;
        "pkg-0.0.15-dev.1758036990113-37b6163" = _Je4dY9FN;
        "pkg-0.0.16-dev.1758038165717-6daaeb8" = _spgs62Rx;
        "pkg-0.0.17-dev.1758048822020-3d8034d" = _RDhNvfoE;
        "pkg-0.0.17-dev.1759168946920-dbf411c" = _qOdXk8mm;
        "pkg-0.0.18-dev.1759300883428-a51272f" = _EUvW7FbS;
        "pkg-0.0.19-dev.1759301406479-7c4f1cf" = _pQwxRTeA;
        "pkg-0.0.19-dev.1759492302965-76bfef5" = _VYQjSgnl;
        "pkg-0.0.19-dev.1759492355194-76bfef5" = _LeuuteQz;
        "pkg-0.0.19-dev.1759492405571-76bfef5" = _pfcVYkTK;
        "pkg-0.0.19-dev.1760002025909-76bfef5" = _xCH54qkQ;
        "pkg-0.0.20-dev.1760082920383-0321d9b" = _dMfLfVxS;
        "pkg-0.0.21-dev.1765303621168-deebea0" = _egitxECD;
        "pkg-0.0.21-dev.1767142572980-6540460" = _oBqClkSf;
        "pkg-0.0.22-dev.1767982860653-61d2d27" = _o6MdNc42;
        "pkg-0.0.23-dev.1775065720342-7358f3b" = _7hQq5N8V;
        "pkg-0.1.0-platform.33" = _FGN7PkRs;
        "pkg-0.1.0-platform.34" = _jWrrtjhC;
        "pkg-0.1.0-platform.35" = _eqoTIiy2;
        "pkg-0.1.0-platform.36" = _1lpfp7jZ;
        "pkg-0.1.0-platform.37" = _v3kneJt9;
        "pkg-0.1.0-platform.38" = _FpHWA67v;
        "pkg-0.1.0-platform.39" = _RMs6zBin;
        "pkg-0.1.0-platform.40" = _lZ1iUGZl;
        "pkg-0.1.0-platform.46" = _FPqH9iDh;
        "pkg-0.1.0-platform.47" = _6H0cU3ou;
        "pkg-0.1.0-platform.48" = _WuePFq46;
        "pkg-0.1.0-platform.49" = _q7J7I4cO;
        "pkg-0.1.0-platform.50" = _sO6SIkjJ;
        "pkg-0.1.0-platform.51" = _zL4QiPsW;
        "pkg-0.1.0-platform.52" = _DimFgYWb;
        "pkg-0.1.0-platform.53" = _b8RbP2ji;
        "pkg-0.1.0-platform.54" = _3cOFbECo;
        "pkg-0.1.0-platform.55" = _TzzhK0G4;
        "pkg-0.1.0-platform.57" = _Xvwfjvs9;
        "pkg-0.1.0-platform.58" = _zIIbDSu9;
        "default" = _zIIbDSu9;
    });
