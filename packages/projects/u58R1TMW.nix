...
let
    versions = (let
        ...
        _oY5C4GFW = {
            "id" = "oY5C4GFW";
            "file" = "connector-3.0.0-beta.6+26.1.2-full.jar";
            "hash" = "sha512-KzZFDF+AxdUESVY0CRzXiXRm3EWi9rdxMF4TOxEdFWFcemud+DNIEpXFuIMMmt4P1Ea2zSZRfMDRaXxdFs8j9Q==";
        };
    in {
        "x1afUqsm" = _x1afUqsm;
        "JWbnXhg0" = _JWbnXhg0;
        ...
        "neoforge-1.21.1" = _IITF0PRC;
        "neoforge-26.1.2" = _oY5C4GFW;
        "pkg-1.0.0-beta+1.20.1" = _x1afUqsm;
        "pkg-1.0.0-beta.2+1.20.1" = _JWbnXhg0;
        "pkg-1.0.0-beta.3+1.20.1" = _gKBKb99q;
        "pkg-1.0.0-beta.4+1.20.1" = _x8LaUbEp;
        "pkg-1.0.0-beta.5+1.20.1" = _DZYI281P;
        "pkg-1.0.0-beta.6+1.20.1" = _5TYpxsR7;
        "pkg-1.0.0-beta.7+1.20.1" = _LGcPLVIP;
        "pkg-1.0.0-beta.8+1.20.1" = _IPEg6pkI;
        "pkg-1.0.0-beta.9+1.20.1" = _xyZMpNzL;
        "pkg-1.0.0-beta.10+1.20.1" = _vpi7AAYB;
        "pkg-1.0.0-beta.11+1.20.1" = _kYNUpysG;
        "pkg-1.0.0-beta.12+1.20.1" = _9qx3DwxO;
        "pkg-1.0.0-beta.13+1.20.1" = _8nRTNpqF;
        "pkg-1.0.0-beta.14+1.20.1" = _DB3pK0Dc;
        "pkg-1.0.0-beta.15+1.20.1" = _yu3pdHFr;
        "pkg-1.0.0-beta.16+1.20.1" = _UoBtOeEO;
        "pkg-1.0.0-beta.17+1.20.1" = _Hxdn3Zfz;
        "pkg-1.0.0-beta.18+1.20.1" = _OXnySc1F;
        "pkg-1.0.0-beta.19+1.20.1" = _h5mwQNy7;
        "pkg-1.0.0-beta.20+1.20.1" = _XkUESEqO;
        "pkg-1.0.0-beta.21+1.20.1" = _MHAyXeJP;
        "pkg-1.0.0-beta.22+1.20.1" = _QGP7tBgc;
        "pkg-1.0.0-beta.23+1.20.1" = _cSZ5EdVr;
        "pkg-1.0.0-beta.24+1.20.1" = _QjnJFPMW;
        "pkg-1.0.0-beta.25+1.20.1" = _qa4cZXso;
        "pkg-1.0.0-beta.26+1.20.1" = _fdIYDlZY;
        "pkg-1.0.0-beta.27+1.20.1" = _X93mIiQG;
        "pkg-1.0.0-beta.28+1.20.1" = _XLGFwwHh;
        "pkg-1.0.0-beta.29+1.20.1" = _SY7t0uHa;
        "pkg-1.0.0-beta.30+1.20.1" = _sznNhu5Y;
        "pkg-1.0.0-beta.31+1.20.1" = _UzsmgXt1;
        "pkg-1.0.0-beta.32+1.20.1" = _x3KdstVI;
        "pkg-1.0.0-beta.33+1.20.1" = _bkH1saJX;
        "pkg-1.0.0-beta.34+1.20.1" = _Z8MT1gHr;
        "pkg-1.0.0-beta.35+1.20.1" = _D0wNzrR0;
        "pkg-1.0.0-beta.36+1.20.1" = _NN8d83mu;
        "pkg-1.0.0-beta.37+1.20.1" = _uWns8SzT;
        "pkg-1.0.0-beta.38+1.20.1" = _fuXsDpfV;
        "pkg-1.0.0-beta.39+1.20.1" = _gM2p6NVT;
        "pkg-1.0.0-beta.40+1.20.1" = _aKnE8qBS;
        "pkg-1.0.0-beta.41+1.20.1" = _4wu0Vsg4;
        "pkg-1.0.0-beta.42+1.20.1" = _U0BPUJsB;
        "pkg-1.0.0-beta.43+1.20.1" = _LM3aqTbN;
        "pkg-1.0.0-beta.44+1.20.1" = _74Z0Kmgx;
        "pkg-1.0.0-beta.45+1.20.1" = _j0igWmaL;
        "pkg-2.0.0-beta.1+1.21" = _PHaoQIFN;
        "pkg-2.0.0-beta.2+1.21.1" = _WFiIDhbD;
        "pkg-2.0.0-beta.3+1.21.1" = _x3AHjKpg;
        "pkg-1.0.0-beta.46+1.20.1" = _e8hSZ4vp;
        "pkg-2.0.0-beta.4+1.21.1" = _aQSgBo32;
        "pkg-2.0.0-beta.5+1.21.1" = _i1rqgLSL;
        "pkg-2.0.0-beta.6+1.21.1" = _k3UrqfQk;
        "pkg-2.0.0-beta.7+1.21.1" = _mk9pRgwU;
        "pkg-2.0.0-beta.8+1.21.1" = _KrmWHpgS;
        "pkg-2.0.0-beta.9+1.21.1" = _leZwcwvX;
        "pkg-2.0.0-beta.10+1.21.1" = _a4IkLwwg;
        "pkg-2.0.0-beta.11+1.21.1" = _6MgWNmMr;
        "pkg-1.0.0-beta.47+1.20.1" = _XoBmts8o;
        "pkg-2.0.0-beta.12+1.21.1" = _YCMXHxwl;
        "pkg-1.0.0-beta.48+1.20.1" = _dmW0aite;
        "pkg-2.0.0-beta.13+1.21.1" = _HOPIDf1H;
        "pkg-2.0.0-beta.14+1.21.1" = _1i8teo7m;
        "pkg-1.0.0-beta.49+1.20.1" = _1MQDrKN7;
        "pkg-2.0.0-beta.15+1.21.1" = _kDbM9LpX;
        "pkg-3.0.0-beta.1+26.1.2" = _NyVvh1Pl;
        "pkg-3.0.0-beta.2+26.1.2" = _y4FK1E0O;
        "pkg-3.0.0-beta.3+26.1.2" = _E1SvcIi5;
        "pkg-3.0.0-beta.4+26.1.2" = _hwuc5SM5;
        "pkg-3.0.0-beta.5+26.1.2" = _qvJxq71C;
        "pkg-2.0.0-beta.16+1.21.1" = _9Bz9VtV5;
        "pkg-2.0.0-beta.17+1.21.1" = _IITF0PRC;
        "pkg-3.0.0-beta.6+26.1.2" = _oY5C4GFW;
        "default" = _oY5C4GFW;
    });
