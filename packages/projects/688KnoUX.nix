...
let
    versions = (let
        ...
        _ndCgS0wI = {
            "id" = "ndCgS0wI";
            "file" = "ItemMakerX-1.2.jar";
            "hash" = "sha512-JmlX25JjeJ6AxwgBGKGGRge19BPekpGRHQO/Oo+EkYNUI86GL6eirEBU7y15E/1hGpEj4X3RyicGrF694KMuAg==";
        };
    in {
        "sFpr36yr" = _sFpr36yr;
        "Xs7IPpGQ" = _Xs7IPpGQ;
        ...
        "bukkit-1.21" = _ndCgS0wI;
        "bukkit-1.21.1" = _ndCgS0wI;
        "bukkit-1.21.2" = _ndCgS0wI;
        "bukkit-1.21.3" = _ndCgS0wI;
        "bukkit-1.21.4" = _ndCgS0wI;
        "bukkit-1.21.5" = _ndCgS0wI;
        "bukkit-1.21.6" = _ndCgS0wI;
        "bukkit-1.21.7" = _ndCgS0wI;
        "bukkit-1.21.8" = _ndCgS0wI;
        "bukkit-1.21.9" = _ndCgS0wI;
        "bukkit-1.21.10" = _ndCgS0wI;
        "bukkit-1.21.11" = _ndCgS0wI;
        "bukkit-26.1" = _ndCgS0wI;
        "bukkit-26.1.1" = _ndCgS0wI;
        "bukkit-26.1.2" = _ndCgS0wI;
        "bukkit-26.2" = _ndCgS0wI;
        "bukkit-26.3" = _ndCgS0wI;
        ...
        "paper-1.21" = _ndCgS0wI;
        "paper-1.21.1" = _ndCgS0wI;
        "paper-1.21.2" = _ndCgS0wI;
        "paper-1.21.3" = _ndCgS0wI;
        "paper-1.21.4" = _ndCgS0wI;
        "paper-1.21.5" = _ndCgS0wI;
        "paper-1.21.6" = _ndCgS0wI;
        "paper-1.21.7" = _ndCgS0wI;
        "paper-1.21.8" = _ndCgS0wI;
        "paper-1.21.9" = _ndCgS0wI;
        "paper-1.21.10" = _ndCgS0wI;
        "paper-1.21.11" = _ndCgS0wI;
        "paper-26.1" = _ndCgS0wI;
        "paper-26.1.1" = _ndCgS0wI;
        "paper-26.1.2" = _ndCgS0wI;
        "paper-26.2" = _ndCgS0wI;
        "paper-26.3" = _ndCgS0wI;
        ...
        "spigot-1.21" = _ndCgS0wI;
        "spigot-1.21.1" = _ndCgS0wI;
        "spigot-1.21.2" = _ndCgS0wI;
        "spigot-1.21.3" = _ndCgS0wI;
        "spigot-1.21.4" = _ndCgS0wI;
        "spigot-1.21.5" = _ndCgS0wI;
        "spigot-1.21.6" = _ndCgS0wI;
        "spigot-1.21.7" = _ndCgS0wI;
        "spigot-1.21.8" = _ndCgS0wI;
        "spigot-1.21.9" = _ndCgS0wI;
        "spigot-1.21.10" = _ndCgS0wI;
        "spigot-1.21.11" = _ndCgS0wI;
        "spigot-26.1" = _ndCgS0wI;
        "spigot-26.1.1" = _ndCgS0wI;
        "spigot-26.1.2" = _ndCgS0wI;
        "spigot-26.2" = _ndCgS0wI;
        "spigot-26.3" = _ndCgS0wI;
        "pkg-1.0" = _uXzPDtB6;
        "pkg-1.0-hotfix" = _Xs7IPpGQ;
        "pkg-1.1" = _aZdTLSLl;
        "pkg-1.1-1" = _zhIlnEB2;
        "pkg-1.2" = _OArZRVaY;
        "pkg-1.2-1" = _d3ZwzFiO;
