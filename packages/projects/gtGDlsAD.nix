...
let
    ...
    in {
        ...
        "pkg-1.5.4" = _g6KF90zn;
        "pkg-1.7.6" = _WwHMaYn2;
        "pkg-2.4.12" = _kTYxiUdx;
        "pkg-2.4.18" = _73AidY3m;
        "pkg-2.4.20" = _TCDyhIFO;
        "pkg-2.4.37" = _eqDKmYDt;
        "pkg-2.4.38" = _mF7WsCxF;
        "pkg-3.0.0+5" = _9q4RZvl3;
        "pkg-2.4.39" = _aKTaEzUA;
        "pkg-3.0.0+7" = _QJ61RiY4;
        "pkg-3.0.0+8" = _ISxByGki;
        "pkg-3.0.1+1" = _Q5B0tTit;
        "pkg-3.0.1+2" = _wOQN0L3r;
        "pkg-3.0.1+3" = _ht81vL3n;
        "pkg-3.0.1+4" = _O3cOgd0B;
        "pkg-2.4.40" = _rrz9AQRc;
        "pkg-2.4.41" = _HdbdAuou;
        "pkg-2.4.42" = _juZjyee4;
        "pkg-3.0.2" = _XN5P5M7S;
        "pkg-3.0.3" = _Tats05gT;
        "pkg-3.0.4" = _HWqbFBtM;
        "pkg-2.4.43" = _YJCyTaOG;
        "pkg-2.4.44" = _drab1STJ;
        "pkg-3.0.5" = _tkYEGQSo;
        "pkg-2.4.45" = _3xKNgu8l;
        "pkg-2.4.46" = _F0nfyupX;
        "pkg-2.4.47" = _7fLxXkX4;
        "pkg-3.0.6" = _7RbfOIGq;
        "pkg-3.0.7" = _NCY1PrXQ;
        "pkg-2.4.48" = _VH7GwDBb;
        "pkg-2.5.0" = _JvQpUpuN;
        "pkg-2.5.1" = _MGgRBH3b;
        "pkg-2.5.2" = _XYrfGFW6;
        "pkg-3.0.9" = _iEVLh1fL;
        "pkg-3.0.10" = _aMVvfx1F;
        "pkg-2.5.3" = _KWgVH8aw;
        "pkg-2.5.4" = _MaoGlsSN;
        "pkg-3.0.11" = _UPKyNIn7;
        "pkg-3.0.12" = _XaJxHpxL;
        "pkg-2.5.5" = _CfANsTfR;
        "pkg-2.5.6" = _I6jU7L4M;
        "pkg-3.0.13" = _T4w7T0TH;
        "pkg-3.0.14" = _DdfnrNkX;
        "pkg-2.5.7" = _6va8xqD9;
        "pkg-3.0.15" = _hQN3PhBg;
        "pkg-2.5.8" = _VVJYVdKR;
        "pkg-3.0.16" = _Fc657Jjx;
        "pkg-3.0.17" = _bjzTgO8s;
        "pkg-2.5.9" = _Xe8qvVxT;
        "pkg-2.5.10" = _2AO7oKwo;
        "pkg-3.0.18" = _VdXHXrRQ;
        "pkg-2.5.11" = _6o5vkmvi;
        "pkg-3.0.19" = _GkOKKNjQ;
        "pkg-2.5.12" = _E5idwl3K;
        "pkg-3.0.21" = _nN8EcSZp;
        "pkg-2.5.13" = _CPDyJiyg;
        "pkg-2.5.14" = _ehEXzrzC;
        "pkg-3.0.22" = _ua7taZ6N;
        "pkg-2.5.15" = _iqrMnzSa;
        "pkg-2.5.16" = _bcwJttuE;
        "pkg-2.5.17" = _AM5ZW7uB;
        "pkg-2.5.18" = _VkZBL8im;
        "pkg-2.5.19" = _MIUAAsys;
        "pkg-3.0.23" = _x6JX35KR;
        "pkg-2.5.20" = _LjK8dowY;
        "pkg-3.0.24" = _LIKMb8eL;
        "pkg-3.0.25" = _R81vtgPe;
        "pkg-2.5.21" = _nvOnfJ7b;
        "pkg-2.5.22" = _8PCMRGzo;
        "pkg-3.0.26" = _ZlLm3aaI;
        "pkg-2.5.23" = _ulLwmMrb;
        "pkg-2.5.24" = _R2BHUhhn;
        "pkg-2.5.25" = _cAZ5peln;
        "pkg-2.5.26" = _VmKgnNpa;
        "pkg-3.0.27" = _kAGzCTjX;
        "pkg-2.5.27" = _Hoe7KVoe;
        "pkg-3.0.28" = _iIqhYpFv;
        "pkg-2.6.1" = _pAuAZpV7;
        "pkg-2.6.2" = _rK3uhBAp;
        "pkg-2.6.3" = _VtG1fd9L;
        "pkg-3.1.0" = _6ekkIBxu;
        ...
        "pkg-3.1.4" = _pE1gtroq;
        "pkg-3.1.5" = _6a6IHeul;
        "pkg-2.6.10" = _yIQPCs4V;
        "pkg-3.1.6" = _F5ecZ2Qc;
        "pkg-2.6.12" = _fyjD2Kl3;
        "pkg-3.1.7" = _27Z0rAmX;
        "pkg-2.6.13" = _UKNE7nxz;
        "pkg-3.1.8" = _Hn2SSVLB;
        "pkg-2.6.14" = _h0vDxDi6;
        "pkg-2.6.15" = _91Kc2okJ;
        "pkg-2.6.16" = _eBHeg47o;
        "pkg-3.1.9" = _QuSvPd46;
        "pkg-2.6.17" = _c58IsS9o;
        "pkg-2.6.18" = _4SAvKYne;
        "pkg-3.1.10" = _H5RKnHqg;
        "pkg-2.6.19" = _ZGSG5wuZ;
        "pkg-3.1.11" = _chfNTs3y;
        "pkg-2.6.20" = _GQNpEySG;
        "pkg-3.1.12" = _nznrYEmz;
        "pkg-2.6.21" = _ZdkCwo7c;
        "pkg-3.1.13" = _KQ3T1RwO;
        "pkg-3.1.14" = _Bs52Ej6A;
        "pkg-3.1.15" = _HnncpXmR;
        "pkg-2.6.22" = _H9c7qYiR;
        "pkg-2.6.23" = _7QI8Gfky;
        "pkg-3.1.16" = _ba7lcEbF;
        "pkg-2.6.24" = _6fzDQqGr;
        "pkg-3.1.17" = _ZYqIl5oM;
        "pkg-2.6.25" = _XBhMOrPW;
        "pkg-3.1.18" = _fXJc12Xc;
        "pkg-3.1.19" = _5axijt7W;
        "pkg-2.6.26" = _mKR67lOx;
        "pkg-2.6.27" = _5OIJ60ZX;
        "pkg-3.1.20" = _IMlOH9Mv;
        "pkg-3.1.21" = _W3eagGsV;
        "pkg-2.6.28" = _cVfCju7g;
        "pkg-2.6.29" = _eOmk6zTm;
        "pkg-3.1.22" = _RhpeBavA;
        "pkg-3.1.23" = _8CEwEfvg;
        "pkg-2.6.30" = _84R4qud8;
        "pkg-3.1.24" = _dT8k1Yqq;
        "pkg-2.6.31" = _xqihzj52;
        "pkg-3.1.25" = _ddxY407h;
        "pkg-2.6.32" = _qCphQ4EU;
        "pkg-2.6.33" = _xXCcbPpR;
        "pkg-3.1.27" = _mCWJSJHu;
        "pkg-2.6.34" = _nWDW8kS9;
        "pkg-3.1.28" = _LoCZGKIB;
        "pkg-2.6.36" = _hNraG3J9;
        "pkg-3.1.29" = _sT63L2ha;
        "pkg-3.1.30" = _ANvwIPCs;
        "pkg-2.6.37" = _gvPQ49hV;
        "pkg-3.1.31" = _17eObxei;
        "pkg-2.6.38" = _x47rCVIe;
        "pkg-3.1.32" = _eZ6Z208R;
        "pkg-2.6.39" = _qEdursr0;
        "pkg-3.1.33" = _ajoO5TkA;
        "pkg-2.6.40" = _kAjzOzhz;
        "pkg-3.1.34" = _lhO7Ad1G;
        "pkg-3.1.35" = _MME3vRqK;
        "pkg-2.6.41" = _Jhw5tK70;
        "pkg-3.1.36" = _gBiEYgyx;
        "pkg-2.6.42" = _HXJvU3TC;
        "pkg-2.6.43" = _r5neVIWV;
        "pkg-3.1.37" = _qXKQxKA5;
        "pkg-3.1.38" = _TOZNxPlx;
        "pkg-2.6.44" = _EGttKG9N;
        "pkg-26.1.2.1" = _Fucfe6bn;
        "pkg-3.1.39" = _d2QJV5kW;
        "pkg-3.1.40" = _N3Y5akxr;
        "pkg-2.6.45" = _jDWHTRE0;
        "pkg-2.7.0" = _R4Rm98jY;
        "pkg-2.7.1" = _bf2pAHw5;
        "pkg-26.1.2.2" = _rOBOCXW3;
        "pkg-2.7.2" = _Nmtwu8jD;
        "pkg-3.1.41" = _n3GiMWqv;
        "pkg-26.1.2.3" = _po93hUme;
