...
let
    ...
    in {
        ...
        "pkg-forge-1.19.1-1.0.0" = _c62TwMOY;
        "pkg-forge-1.19.2-1.0.0" = _YuxY3EJM;
        "pkg-forge-1.19.2-1.0.1" = _EArbIA7k;
        "pkg-forge-1.19.3-1.0.1" = _pl9gVNU6;
        "pkg-forge-1.19.3-1.0.2" = _fKOXN6dU;
        "pkg-forge-1.19.3-1.0.3" = _DgXuoLkA;
        "pkg-forge-1.19.4-1.0.3" = _9neiCvL3;
        "pkg-forge-1.20-1.0.3" = _cCQtNRc4;
        "pkg-forge-1.20.1-1.0.3" = _itQsm4Jz;
        "pkg-forge-1.20.1-1.0.5" = _RHJuIsAQ;
        "pkg-forge-1.20.2-1.0.5" = _5eIsiuW7;
        "pkg-forge-1.20.2-1.0.6" = _cIYWy4Sh;
        "pkg-neoforge-1.20.2-1.0.6" = _w3Bt1SxC;
        "pkg-forge-1.20.2-1.0.7" = _bRnBAnzU;
        "pkg-neoforge-1.20.2-1.0.7" = _i6S2bVPA;
        "pkg-neoforge-1.20.2-1.0.8" = _Klzu1vtU;
        "pkg-neoforge-1.20.2-1.0.9" = _6NqoMVgi;
        "pkg-forge-1.19.2-1.0.10" = _YwnbCQ4s;
        "pkg-forge-1.20.1-1.0.10" = _wXySYo0E;
        "pkg-forge-1.20.2-1.0.10" = _YgiTnigc;
        "pkg-neoforge-1.20.2-1.0.10" = _9s32tk11;
        "pkg-neoforge-1.20.3-1.0.10" = _6NffCJQB;
        "pkg-neoforge-1.20.4-1.0.10" = _nYMobyic;
        "pkg-forge-1.19.2-1.0.11" = _XROoUJM6;
        "pkg-forge-1.20.1-1.0.11" = _xZYJq8x1;
        "pkg-neoforge-1.20.4-1.0.11" = _kWeYC5yS;
        "pkg-forge-1.19.2-1.0.12" = _7FtLrXLb;
        "pkg-forge-1.20.1-1.0.12" = _4gad8x19;
        "pkg-neoforge-1.20.4-1.0.12" = _X7xIpB9i;
        "pkg-neoforge-1.20.4-1.0.13" = _WBn8rdaz;
        "pkg-forge-1.19.2-1.0.14" = _5dwu68DX;
        "pkg-forge-1.20.1-1.0.14" = _wHpd1Qzl;
        "pkg-neoforge-1.20.4-1.0.14" = _ViTn5ITB;
        "pkg-forge-1.19.2-1.0.15" = _dNr0O7lg;
        "pkg-forge-1.20.1-1.0.15" = _OmP48Fw1;
        "pkg-neoforge-1.20.4-1.0.15" = _neHbvVxQ;
        "pkg-neoforge-1.20.5-1.0.15" = _7euNhwoM;
        "pkg-neoforge-1.20.6-1.0.15" = _i7dZ8lbC;
        "pkg-neoforge-1.21-1.0.15" = _OSCrIRwB;
        "pkg-forge-1.19.2-1.0.16" = _kBIOSv29;
        "pkg-forge-1.20.1-1.0.16" = _5XT5n1uE;
        "pkg-neoforge-1.21-1.0.16" = _4Hcllmrz;
        "pkg-forge-1.19.2-1.0.17" = _BBKYCdkY;
        "pkg-forge-1.20.1-1.0.17" = _7YuJzZXl;
        "pkg-neoforge-1.21-1.0.17" = _FolckzBg;
        "pkg-forge-1.19.2-1.0.18" = _6down53E;
        "pkg-forge-1.20.1-1.0.18" = _56inTUhw;
        "pkg-neoforge-1.21-1.0.18" = _JVYyQ2MB;
        "pkg-neoforge-1.21-1.0.19" = _1BHYAnLp;
        "pkg-neoforge-1.21.1-1.0.19" = _lN4ZMEct;
        "pkg-forge-1.19.2-1.0.20" = _Ha3V0w1R;
        "pkg-forge-1.20.1-1.0.20" = _DH68m6VN;
        "pkg-neoforge-1.21.1-1.0.20" = _51GCat5u;
        "pkg-forge-1.19.2-1.0.21" = _wb9vCtzz;
        "pkg-forge-1.20.1-1.0.21" = _Q3m9gCoC;
        "pkg-neoforge-1.21.1-1.0.21" = _I1EyO4Ba;
        "pkg-neoforge-1.21.1-1.0.22" = _q3DpYLgl;
        "pkg-forge-1.19.2-1.0.23" = _6diVPFo7;
        "pkg-forge-1.20.1-1.0.23" = _No7NPOP4;
        "pkg-neoforge-1.21.1-1.0.23" = _EWiIjUNP;
        "pkg-forge-1.19.2-1.0.24" = _BdpmfW7F;
        "pkg-forge-1.20.1-1.0.24" = _YuF7RHRe;
        "pkg-neoforge-1.21.1-1.0.24" = _4QqerCZp;
        "pkg-neoforge-1.21.2-1.0.24" = _XZyzDYQK;
        "pkg-neoforge-1.21.3-1.0.24" = _FEsTPgO2;
        "pkg-neoforge-1.21.4-1.0.24" = _YHis8Fd3;
        "pkg-neoforge-1.21.5-1.0.24" = _GLbDLf9r;
        "pkg-neoforge-1.21.5-1.0.25" = _mxsOjIk1;
        "pkg-neoforge-1.21.6-1.0.25" = _exAvlcQg;
        "pkg-neoforge-1.21.6-1.0.26" = _JZ1bq5XG;
        "pkg-neoforge-1.21.6-1.0.27" = _WiW1No62;
        "pkg-neoforge-1.21.6-1.0.28" = _1TnK0agL;
        "pkg-neoforge-1.21.6-1.0.29" = _EMaJgl2u;
        "pkg-neoforge-1.21.7-1.0.29" = _7XHhFSjn;
        "pkg-neoforge-1.21.7-1.0.30" = _FfyhypOc;
        "pkg-forge-1.20.1-1.0.31" = _kj2dsQ8q;
        "pkg-neoforge-1.21.1-1.0.31" = _D5gPg3wi;
        "pkg-neoforge-1.21.5-1.0.31" = _SOoSXEka;
        "pkg-neoforge-1.21.7-1.0.31" = _1TeGAKGD;
        "pkg-forge-1.20.1-1.0.32" = _kSpC0ysX;
        "pkg-neoforge-1.21.1-1.0.32" = _RMwfWbij;
        "pkg-neoforge-1.21.5-1.0.32" = _7zjq6fkA;
        "pkg-neoforge-1.21.7-1.0.32" = _dsix5aqC;
        "pkg-neoforge-1.21.8-1.0.32" = _MBoldfsh;
        "pkg-forge-1.20.1-1.0.33" = _UQMeEqbE;
        "pkg-neoforge-1.21.1-1.0.33" = _8TgkUp5F;
        "pkg-neoforge-1.21.4-1.0.33" = _B9qiU7WK;
        "pkg-neoforge-1.21.5-1.0.33" = _A6hEenKn;
        "pkg-neoforge-1.21.8-1.0.33" = _JFwiVlN5;
        "pkg-neoforge-1.21.9-1.0.33" = _S0mVz1jB;
        "pkg-neoforge-1.21.10-1.0.33" = _hzNUFDho;
        "pkg-neoforge-1.21.10-1.0.34" = _7isBxFWL;
        "pkg-forge-1.20.1-1.0.35" = _q9kZE5Xo;
        "pkg-neoforge-1.21.1-1.0.35" = _AZm51eX1;
        "pkg-neoforge-1.21.4-1.0.35" = _ySDPDb0E;
        "pkg-neoforge-1.21.5-1.0.35" = _3UVrsFGN;
        "pkg-neoforge-1.21.8-1.0.35" = _Ddjw1GAx;
        "pkg-neoforge-1.21.10-1.0.35" = _dNXm4BUA;
        "pkg-neoforge-1.21.11-1.0.35" = _md5D7LJN;
        "pkg-neoforge-1.0.35+26.1" = _XiTwoyTS;
        "pkg-neoforge-1.0.35+26.1.1" = _Z5CkU6Om;
        "pkg-neoforge-1.0.36+26.1.1" = _TWxWoHPp;
        "pkg-neoforge-1.0.36+26.1.2" = _1Yl0pxiA;
        "pkg-neoforge-1.21.1-1.0.37" = _Y29z3Y9Y;
        "pkg-neoforge-1.21.10-1.0.37" = _yNVuwCGs;
        "pkg-neoforge-1.21.11-1.0.37" = _QMvpIl7J;
        "pkg-neoforge-1.0.37+26.1.2" = _9fuljXEm;
        "pkg-neoforge-1.0.37+26.2" = _PpSSGRyy;
        "pkg-neoforge-1.21.1-1.0.38" = _3a6KIbgL;
