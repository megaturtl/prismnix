...
let
    versions = (let
        ...
        _7cNbD19m = {
            "id" = "7cNbD19m";
            "file" = "netherarchives-0.5.10+mc26.2.jar";
            "hash" = "sha512-E26ozlzen0nH+mFw4MrxjoQ4PObe/2mB93NMC7y9x13dfWl06Vs8uZbOcvxGAf8jhPuwyh7BrFsdnRVjPr393Q==";
        };
        _11AhKsSE = {
            "id" = "11AhKsSE";
    ...
    in {
        ...
        "pkg-0.3.2" = _FrOSdH4H;
        "pkg-0.3.3" = _2qs1cAPO;
        "pkg-0.3.4+mc1.20.1" = _21SK5QoW;
        "pkg-0.3.4+mc1.20.3" = _F6fgI8B7;
        "pkg-0.3.5+mc1.20.1" = _Wtyw5mTr;
        "pkg-0.3.5+mc1.20.3" = _mN8J9udt;
        "pkg-0.3.6" = _liW4i7Ay;
        "pkg-0.4.0" = _CaohzZsn;
        "pkg-0.5.0" = _D8f3J2a4;
        "pkg-0.5.1" = _oyKxgbwE;
        "pkg-0.5.1+mc1.21.8" = _Ovu06tjr;
        "pkg-0.5.2+mc1.21.9" = _4Ntjop36;
        "pkg-0.5.2+mc1.21.1" = _EpeXE9Po;
        "pkg-0.5.3+mc1.21.1" = _uNeaKPLG;
        "pkg-0.5.3+mc1.21.10" = _t1mT1nUZ;
        "pkg-0.5.4+mc1.21.1" = _HSPGivVx;
        "pkg-0.5.4+mc1.21.10" = _N50p4y7c;
        "pkg-0.5.4+mc1.21.11-pre3" = _QLA3BdwX;
        "pkg-0.5.5+mc1.21.1" = _QlDyTy73;
        "pkg-0.5.6+mc1.21.1" = _enKlocdz;
        "pkg-0.5.6+mc1.21.11" = _1K0IMlz2;
        "pkg-0.5.7+mc1.21.1" = _cNMgECnL;
        "pkg-0.5.7+mc1.21.11" = _gZJtWHRO;
        "pkg-0.5.8+mc1.21.1" = _5RHTHb9o;
        "pkg-0.5.8+mc1.21.11" = _uMqSWqGw;
        "pkg-0.5.8+mc26.1" = _KZr2Nxen;
        "pkg-0.5.9+connector+mc1.21.1" = _smkVIf6s;
