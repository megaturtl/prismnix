...
let
    ...
    in {
        ...
        "pkg-1.1" = _FsQL6FXV;
        "pkg-1.1.0" = _y3Ko1fGT;
        "pkg-1.1.1-quilt" = _LlLYE55K;
        "pkg-1.1.1-forge" = _sc0QxThr;
        "pkg-1.1.1-fabric" = _TRoJ8Yc4;
        "pkg-1.1.2-quilt" = _wSQEXFVB;
        "pkg-1.1.2-forge" = _VGzwSAM8;
        "pkg-1.1.2-fabric" = _FGDF6byY;
        "pkg-1.1.3-forge" = _vwJk3fWs;
        "pkg-1.1.3-fabric" = _k0RzoTGC;
        "pkg-1.1.4-forge" = _BNcnK1k5;
        "pkg-1.1.4-fabric" = _LRFIdFuW;
        "pkg-1.1.5-forge" = _amI1oyGG;
        "pkg-1.1.5-fabric" = _tBnivdbu;
        "pkg-1.2.0-forge" = _rXMG4HtT;
        "pkg-1.2.0-fabric" = _HiLmugPC;
        "pkg-1.2.1-neoforge" = _fANI0ba4;
        "pkg-1.2.2-forge" = _LOGne5BJ;
        "pkg-1.2.2-neoforge" = _oTRDEoMt;
        "pkg-1.2.2-fabric" = _QzhenNWE;
        "pkg-1.2.3-fabric" = _9e6KHhU3;
        "pkg-1.2.4-fabric" = _3aypqSNl;
        "pkg-1.2.5-neoforge" = _ElM4X70m;
        "pkg-1.2.5-fabric" = _jMYaXwo6;
        "pkg-1.2.6-fabric" = _QKpglnFb;
        "pkg-1.2.6-neoforge" = _LXyrdywi;
        "pkg-1.2.7-neoforge" = _VjaAEPBl;
        "pkg-1.2.7-fabric" = _V8kulhC0;
        "pkg-1.2.8-neoforge" = _oLp2OCg3;
        "pkg-1.2.8-fabric" = _8iGbvXwk;
        "pkg-1.1.6-forge" = _DOsSK4NK;
        "pkg-1.2.9-neoforge" = _oT04jpll;
        "pkg-1.2.9-fabric" = _pcnAJaO5;
        "pkg-1.2.10-neoforge" = _ADKSOV3O;
        "pkg-1.2.10-fabric" = _Z4HqO4Am;
        "pkg-2.0.1-neoforge" = _T2JWurbR;
        "pkg-2.0.1-fabric" = _sILGNCx4;
        "pkg-2.0.2-neoforge" = _nvBbYALa;
        "pkg-2.0.2-fabric" = _waCffck8;
        "pkg-2.0.3-neoforge" = _TF0bB1VS;
        "pkg-2.0.3-fabric" = _bgdjh4pG;
        "pkg-3.0.0" = _wEUhAqMj;
        "pkg-3.0.1" = _3d4XeMfd;
        "pkg-fabric-1.21.10-3.0.2" = _pRNiTy0y;
        "pkg-neoforge-1.21.7-3.0.2" = _BLa9dOnj;
        "pkg-fabric-1.21.7-3.0.2" = _a2knYCon;
        "pkg-neoforge-1.21.10-3.0.2" = _fpeYegvZ;
        "pkg-neoforge-1.21.1-3.0.2" = _UfivGGmq;
        "pkg-fabric-1.21.1-3.0.2" = _oFrnFrNm;
        "pkg-neoforge-1.21.10-3.0.3" = _7Ntp9dD3;
        "pkg-fabric-1.21.10-3.0.3" = _ZvMKpvgf;
        "pkg-3.0.2.1" = _K2pVXHCe;
        "pkg-neoforge-1.21.11-3.0.4" = _z86zTl4X;
        "pkg-fabric-1.21.11-3.0.4" = _6vtzWpRI;
        "pkg-3.0.3" = _h5nfApnW;
        "pkg-neoforge-1.21.11-3.1.0" = _q4ANRUMZ;
        "pkg-fabric-1.21.11-3.1.0" = _QW7dcPGu;
        "pkg-neoforge-1.21.11-3.1.1" = _pFmaiGvS;
        "pkg-fabric-1.21.11-3.1.1" = _p21e0kLQ;
        "pkg-neoforge-1.21.11-3.1.2" = _gJe55Neh;
        "pkg-fabric-1.21.11-3.1.2" = _yWdD26Oh;
        "pkg-neoforge-26.1-3.1.3" = _HhcCCbE2;
        "pkg-fabric-26.1-3.1.3" = _1k0Rv30o;
        "pkg-neoforge-26.1.2-3.1.4" = _MRyvygQV;
        "pkg-fabric-26.1.2-3.1.4" = _GBVtWlUN;
        "pkg-fabric-1.21.1-3.1.4" = _PKOCWiGJ;
        "pkg-neoforge-1.21.1-3.1.4" = _bDd8Xl0w;
        "pkg-neoforge-1.21.1-3.1.5" = _JbGjwnV6;
        "pkg-fabric-1.21.1-3.1.5" = _BRVWgniI;
        "pkg-neoforge-1.21.1-3.1.6" = _GlBkE8Zq;
        "pkg-fabric-1.21.1-3.1.6" = _5Skaj6dw;
        "pkg-neoforge-1.21.1-3.1.7" = _Sduz0AWP;
        "pkg-fabric-1.21.1-3.1.7" = _K1dyr5gj;
        "pkg-neoforge-1.21.11-3.1.7" = _rhpKhWXb;
        "pkg-fabric-1.21.11-3.1.7" = _1NM741mO;
        "pkg-fabric-26.1.2-3.1.7" = _ofxpupA4;
        "pkg-neoforge-26.1.2-3.1.7" = _1yyRhsti;
        "pkg-fabric-26.2-3.1.8" = _OoKByyJE;
        "pkg-neoforge-26.2-3.1.8" = _bWDW9ZQ9;
        "pkg-neoforge-26.1.2-3.1.8" = _YrhjS3HR;
        "pkg-fabric-26.1.2-3.1.8" = _nyrGV1GK;
        "pkg-fabric-26.1.2-3.1.9" = _Yp0XKKMq;
        "pkg-neoforge-26.1.2-3.1.9" = _A4jiHA7w;
        "pkg-fabric-26.2-3.1.9" = _xNJVQZkW;
        "pkg-neoforge-26.2-3.1.9" = _B50feQkV;
        "pkg-neoforge-26.1.2-3.1.10" = _8CVrcGex;
        "pkg-fabric-26.1.2-3.1.10" = _8049CnMl;
        "pkg-neoforge-26.2-3.1.10" = _rcSodUE0;
        "pkg-fabric-26.2-3.1.10" = _bociZXpN;
        "pkg-fabric-26.1.2-3.1.11" = _QLCbh6Ql;
