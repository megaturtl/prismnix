...
let
    versions = (let
        ...
        _wCRmAXn4 = {
            "id" = "wCRmAXn4";
            "file" = "Toms New Painting Textures 0.0.15 Beta TNPT.zip";
            "hash" = "sha512-RFktWdN8IXkpF6hgEo/nmitF9//QrlzT/XbQ14befunqT5e8XJoaVImB/AoHWZatjsO8Be5KtkdXIcgRGg2INA==";
        };
    in {
        "r6hJc2Wo" = _r6hJc2Wo;
        "hulUIR1c" = _hulUIR1c;
        ...
        "minecraft-1.21" = _wCRmAXn4;
        "minecraft-1.21.1" = _wCRmAXn4;
        "minecraft-1.18" = _CcGvlzWQ;
        "minecraft-1.18.1" = _CcGvlzWQ;
        "minecraft-1.18.2" = _CcGvlzWQ;
        "minecraft-1.19.4" = _yb6iPzAH;
        "minecraft-1.21.7" = _wCRmAXn4;
        "minecraft-1.21.8" = _wCRmAXn4;
        "minecraft-1.21.2" = _wCRmAXn4;
        "minecraft-1.21.3" = _wCRmAXn4;
        "minecraft-1.21.4" = _wCRmAXn4;
        "minecraft-1.21.5" = _wCRmAXn4;
        "minecraft-1.21.6" = _wCRmAXn4;
        "minecraft-1.21.9" = _wCRmAXn4;
        "minecraft-1.21.10" = _wCRmAXn4;
        "minecraft-1.21.11" = _wCRmAXn4;
        "minecraft-24w33a" = _wCRmAXn4;
        "minecraft-24w34a" = _wCRmAXn4;
        "minecraft-24w35a" = _wCRmAXn4;
        "minecraft-24w36a" = _wCRmAXn4;
        "minecraft-24w37a" = _wCRmAXn4;
        "minecraft-24w38a" = _wCRmAXn4;
        "minecraft-24w39a" = _wCRmAXn4;
        "minecraft-24w40a" = _wCRmAXn4;
        "minecraft-1.21.2-pre1" = _wCRmAXn4;
        "minecraft-1.21.2-pre2" = _wCRmAXn4;
        "minecraft-24w44a" = _wCRmAXn4;
        "minecraft-24w45a" = _wCRmAXn4;
        "minecraft-24w46a" = _wCRmAXn4;
        "minecraft-26.1" = _wCRmAXn4;
        "minecraft-26.1.1" = _wCRmAXn4;
        "minecraft-26.1.2" = _wCRmAXn4;
        ...
        "minecraft-1.20.5" = _wCRmAXn4;
        "minecraft-1.20.6" = _wCRmAXn4;
        "minecraft-24w18a" = _wCRmAXn4;
        "minecraft-24w19a" = _wCRmAXn4;
        "minecraft-24w19b" = _wCRmAXn4;
        "minecraft-24w20a" = _wCRmAXn4;
        "minecraft-26.2" = _wCRmAXn4;
        "pkg-0.0.1" = _CcGvlzWQ;
        "pkg-0.0.2" = _idDaX3td;
        "pkg-0.0.3" = _iWA96iVD;
        "pkg-0.0.4" = _VayOuZDi;
        "pkg-0.0.5" = _eIBvTf1Y;
        "pkg-0.0.5.fix1.21-1.21.1" = _KQM2SJtZ;
        "pkg-0.0.5.fix" = _DQwMb6RZ;
        "pkg-0.0.6-Beta" = _ybFqb7Td;
        "pkg-0.0.7-Beta" = _l0g2JLpH;
        "pkg-0.0.8-Beta" = _aiDDyVCW;
        "pkg-0.0.9" = _zdJWDwGl;
        "pkg-0.0.10-Beta" = _awo46Cq3;
        "pkg-0.0.11-Beta" = _MHjnlVyG;
        "pkg-0.0.12-Beta" = _8hGZytU7;
        "pkg-0.0.13-Beta" = _9p1IzLXj;
        "pkg-0.0.14-Beta" = _9LnHLrUj;
        "pkg-0.0.15-Beta" = _wCRmAXn4;
        "default" = _wCRmAXn4;
    });
