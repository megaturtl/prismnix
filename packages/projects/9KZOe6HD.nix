...
let
    ...
    in {
        ...
        "pkg-1.3.8-forge-mc1.16" = _qYT3gZZh;
        "pkg-1.3.8-forge-mc1.17" = _oGqjaK60;
        "pkg-1.3.8-forge-mc1.18" = _IldfEb6C;
        "pkg-1.3.8a-forge-mc1.19" = _Ak0GanGX;
        "pkg-1.3.9-forge-mc1.12" = _YIkLX45j;
        "pkg-1.3.9-forge-mc1.14" = _fC4TLSLD;
        "pkg-1.3.9-forge-mc1.15" = _MzXoHnMA;
        "pkg-1.3.9-forge-mc1.16" = _Fw2AqBFf;
        "pkg-1.3.9-forge-mc1.17" = _PLCwF0WO;
        "pkg-1.3.9-forge-mc1.18" = _v4FwImIb;
        "pkg-1.3.9-forge-mc1.19" = _jJfqyY20;
        "pkg-1.3.10-forge-mc1.12" = _EiRkqbff;
        "pkg-1.3.10-forge-mc1.14" = _CmufkLEG;
        "pkg-1.3.10-forge-mc1.15" = _8rgbipgS;
        "pkg-1.3.10-forge-mc1.16" = _94GuB0KW;
        "pkg-1.3.10-forge-mc1.17" = _mRKUqUic;
        "pkg-1.3.10-forge-mc1.18" = _hWMjCks6;
        "pkg-1.3.10-forge-mc1.19" = _KrunW7K5;
        "pkg-1.3.11-forge-mc1.12" = _dgdSWq9K;
        "pkg-1.3.11-forge-mc1.14" = _irXLI83u;
        "pkg-1.3.11-forge-mc1.15" = _CVymdzZU;
        "pkg-1.3.11-forge-mc1.16" = _l8cIvmO2;
        "pkg-1.3.11-forge-mc1.17" = _7fzeewIV;
        "pkg-1.3.11-forge-mc1.18" = _sr83Bz0w;
        "pkg-1.3.11-forge-mc1.19" = _LzxgykzT;
        "pkg-1.3.11-forge-mc1.19.3" = _jgQkwIn9;
        "pkg-1.3.11a-forge-mc1.15" = _WNFChHUf;
        "pkg-1.3.11a-forge-mc1.16" = _jyudkosm;
        "pkg-1.3.11a-forge-mc1.17" = _gkXKBbtw;
        "pkg-1.3.11a-forge-mc1.18" = _79PnjqT5;
        "pkg-1.3.11a-forge-mc1.19" = _BDUXlzJG;
        "pkg-1.3.11a-forge-mc1.19.3" = _nkz7Nfrf;
        "pkg-1.3.11b-forge-mc1.18" = _zrq4poM1;
        "pkg-1.3.11b-forge-mc1.19" = _7C7uLJuI;
        "pkg-1.3.11b-forge-mc1.19.3" = _Hx2orFH2;
        "pkg-1.3.12-forge-mc1.12" = _JYtJbpaV;
        "pkg-1.3.12-forge-mc1.14" = _T5OHSWjC;
        "pkg-1.3.12-forge-mc1.15" = _jnUC2YQk;
        "pkg-1.3.12-forge-mc1.16" = _nkYtUJJB;
        "pkg-1.3.12-forge-mc1.17" = _cr6rWUMK;
        "pkg-1.3.12-forge-mc1.18" = _1hTgIzcA;
        "pkg-1.3.12-forge-mc1.19" = _inFZMEHg;
        "pkg-1.3.12-forge-mc1.19.3" = _gz5Rh0Jb;
        "pkg-1.3.12a-forge-mc1.19" = _jr6bIXN2;
        "pkg-1.3.12a-forge-mc1.19.3" = _V268ifs9;
        "pkg-1.3.12-fabric-mc1.18" = _53gf3Bzz;
        "pkg-1.3.12-fabric-mc1.19" = _FWn5GI6M;
        "pkg-1.3.12a-fabric-mc1.19" = _5iSVYWpL;
        "pkg-1.3.12-forge-mc1.19.4" = _zceVAUa1;
        "pkg-1.4.0-forge-mc1.12" = _OOtr2vhm;
        "pkg-1.4.0-forge-mc1.14" = _caPujMZJ;
        "pkg-1.4.0-forge-mc1.15" = _4VaCW3hM;
        "pkg-1.4.0-forge-mc1.16" = _LrqojkMy;
        "pkg-1.4.0-forge-mc1.17" = _ikwkam5z;
        "pkg-1.4.0-forge-mc1.18" = _uXNc2TgK;
        "pkg-1.4.0-forge-mc1.19" = _Te3HytPo;
        "pkg-1.4.0-forge-mc1.19.3" = _W2uWni8b;
        "pkg-1.4.0-forge-mc1.19.4" = _O9jMo82d;
        "pkg-1.4.0-fabric-mc1.18" = _bseHetBL;
        "pkg-1.4.0-fabric-mc1.19" = _1u3FnC7Z;
        "pkg-1.4.0a-forge-mc1.18" = _OBL6DiBe;
        "pkg-1.4.0a-forge-mc1.19" = _DNaboorU;
        "pkg-1.4.0a-forge-mc1.19.3" = _4zPOs43E;
        "pkg-1.4.0a-forge-mc1.19.4" = _O5LMDuFG;
        "pkg-1.4.0a-fabric-mc1.18" = _4W2e47v2;
        "pkg-1.4.0a-fabric-mc1.19" = _nOPOT0uL;
        "pkg-1.4.0a-forge-mc1.16" = _j57yKdGx;
        "pkg-1.4.1-forge-mc1.12" = _JdlngWdD;
        "pkg-1.4.1-forge-mc1.14" = _xNujfAQv;
        "pkg-1.4.1-forge-mc1.15" = _rKu3LoQr;
        "pkg-1.4.1-forge-mc1.16" = _ykX3WmO9;
        "pkg-1.4.1-forge-mc1.17" = _L2gnnNrl;
        "pkg-1.4.1-forge-mc1.18" = _xXDzx7t9;
        "pkg-1.4.1-forge-mc1.19" = _aNeHlEtP;
        "pkg-1.4.1-forge-mc1.19.3" = _JkqqrbzA;
        "pkg-1.4.1-forge-mc1.19.4" = _9GLW1hxp;
        "pkg-1.4.1-fabric-mc1.18" = _LcSPZedN;
        "pkg-1.4.1-fabric-mc1.19" = _uORYLSxg;
        "pkg-1.4.1a-fabric-mc1.18" = _7QhM9NYG;
        "pkg-1.4.1a-fabric-mc1.19" = _jIqKWfMU;
        "pkg-1.4.2-forge-mc1.12" = _ewFIDxzd;
        "pkg-1.4.2-forge-mc1.14" = _LfbNBDh5;
        "pkg-1.4.2-forge-mc1.15" = _yK2nEYGT;
        "pkg-1.4.2-forge-mc1.16" = _F8gp9Nmv;
        "pkg-1.4.2-forge-mc1.17" = _EXKA8CeM;
        "pkg-1.4.2-forge-mc1.18" = _k6puwiNt;
        "pkg-1.4.2-forge-mc1.19" = _2FnM6HXg;
        "pkg-1.4.2-forge-mc1.19.3" = _bJ2q0pnC;
        "pkg-1.4.2-forge-mc1.19.4" = _6KqMFHcT;
        "pkg-1.4.2-fabric-mc1.18" = _3pdzeRT4;
        "pkg-1.4.2-fabric-mc1.19" = _DiWPyb3l;
        "pkg-1.4.2-fabric-mc1.19.2" = _JIMmVVom;
        "pkg-1.4.3-forge-mc1.12" = _FDkSDYkD;
        "pkg-1.4.3-forge-mc1.14" = _qcAKW4JV;
        "pkg-1.4.3-forge-mc1.15" = _zz1FtuYf;
        "pkg-1.4.3-forge-mc1.16" = _nXYIL2I2;
        "pkg-1.4.3-forge-mc1.17" = _jVr6QCUe;
        "pkg-1.4.3-forge-mc1.18" = _kfoZ2JVZ;
        "pkg-1.4.3-forge-mc1.19" = _vsQ3xh3Z;
        "pkg-1.4.3-forge-mc1.19.3" = _9UVwkJVc;
        "pkg-1.4.3-forge-mc1.19.4" = _sMhggvfs;
        "pkg-1.4.3-fabric-mc1.18" = _S9N1OLVI;
        "pkg-1.4.3-fabric-mc1.19.2" = _R16RXpyG;
        "pkg-1.4.3-fabric-mc1.19.4" = _mE1THOrU;
        "pkg-1.4.3-forge-mc1.20" = _P6bSPxaA;
        "pkg-1.4.3-fabric-mc1.20" = _BnJM7xuK;
        "pkg-1.4.3a-forge-mc1.20" = _KGvxC1b2;
        "pkg-1.4.3a-fabric-mc1.20" = _2KP8mf1n;
        "pkg-1.4.3b-fabric-mc1.20" = _wPvHYOeK;
        "pkg-1.4.3a-forge-mc1.16" = _SeGwiGEk;
        "pkg-1.4.3a-forge-mc1.17" = _pCc3tz3t;
        "pkg-1.4.3a-forge-mc1.18" = _QxyIAx43;
        "pkg-1.4.3a-forge-mc1.19" = _76XfQNGl;
        "pkg-1.4.3a-forge-mc1.19.3" = _BdTtsa7k;
        "pkg-1.4.3a-forge-mc1.19.4" = _lMbDCbJS;
        "pkg-1.4.3b-forge-mc1.20" = _D6dGXJbs;
        "pkg-1.4.3a-fabric-mc1.18" = _FxWFlzXQ;
        "pkg-1.4.3a-fabric-mc1.19.2" = _tfFW1jhT;
        "pkg-1.4.3a-fabric-mc1.19.4" = _sj6Jv0QQ;
        "pkg-1.4.3c-fabric-mc1.20" = _9P2bjDTx;
        "pkg-1.4.3c-forge-mc1.20" = _u346MNQ2;
        "pkg-1.4.3-forge-mc1.20.2" = _5MvEeEcP;
        "pkg-1.4.3-fabric-mc1.20.2" = _ZjctycDZ;
        "pkg-1.4.4-forge-mc1.12" = _PluWKzTc;
        "pkg-1.4.4-forge-mc1.14" = _cz9veyEs;
        "pkg-1.4.4-forge-mc1.15" = _kBQ1IMc2;
        "pkg-1.4.4-forge-mc1.16" = _VZVSwhAx;
        "pkg-1.4.4-forge-mc1.17" = _thdxBqEg;
        "pkg-1.4.4-forge-mc1.18" = _NaUidlSc;
        "pkg-1.4.4-forge-mc1.19" = _curG06a1;
        "pkg-1.4.4-forge-mc1.19.3" = _GlgbzINx;
        "pkg-1.4.4-forge-mc1.19.4" = _KtrAEtF0;
        "pkg-1.4.4-forge-mc1.20.2" = _Nut3P0Ud;
        "pkg-1.4.4-fabric-mc1.18" = _IHAFANxx;
        "pkg-1.4.4-fabric-mc1.19.2" = _eiMB9UnT;
        "pkg-1.4.4-fabric-mc1.19.4" = _w44oAGSm;
        "pkg-1.4.4-fabric-mc1.20.1" = _6E2wRGRi;
        "pkg-1.4.4-fabric-mc1.20.2" = _P74a6rS1;
        "pkg-1.4.4-forge-mc1.20.1" = _udVyB9Ru;
        "pkg-1.4.4a-forge-mc1.20.2" = _ZZMn7RLA;
        "pkg-1.4.4a-fabric-mc1.20.2" = _1yViv2CX;
        "pkg-1.4.4a-fabric-mc1.18" = _qF82ZerD;
        "pkg-1.4.4a-fabric-mc1.19.2" = _cDIGj4VZ;
        "pkg-1.4.4a-fabric-mc1.19.4" = _I7VD6vL9;
        "pkg-1.4.4a-fabric-mc1.20.1" = _vlZ8Zl9F;
        "pkg-1.4.4b-fabric-mc1.20.2" = _z9leTOuY;
        "pkg-1.4.5-forge-mc1.12" = _wvMBrhNm;
        "pkg-1.4.5-forge-mc1.14" = _9DS9MX4B;
        "pkg-1.4.5-forge-mc1.15" = _EEB8pIsc;
        "pkg-1.4.5-forge-mc1.16" = _LKB82MEG;
        "pkg-1.4.5-forge-mc1.17" = _7GAzOzDS;
        "pkg-1.4.5-forge-mc1.18" = _8ZvLtMjm;
        "pkg-1.4.5-forge-mc1.19" = _rWCTdFDr;
        "pkg-1.4.5-forge-mc1.19.3" = _hauAAVeu;
        "pkg-1.4.5-forge-mc1.19.4" = _MFtQQvA8;
        "pkg-1.4.5-forge-mc1.20.1" = _GKpSTDg8;
        "pkg-1.4.5-forge-mc1.20.2" = _MvhzF7Si;
        "pkg-1.4.5-fabric-mc1.18" = _Ce6kvAB7;
        "pkg-1.4.5-fabric-mc1.19.2" = _CHMWC7dr;
        "pkg-1.4.5-fabric-mc1.19.4" = _xPW2s5xy;
        "pkg-1.4.5-fabric-mc1.20.1" = _60Au29eq;
        "pkg-1.4.5-fabric-mc1.20.2" = _eMEI1V8t;
        "pkg-1.4.5-forge-mc1.20.4" = _kwUF23hF;
        "pkg-1.4.5-fabric-mc1.20.4" = _1SXLn4Bd;
        "pkg-1.4.5-neoforge-mc1.20.4" = _2iM5Lxmu;
        "pkg-1.4.6-forge-mc1.12" = _S33SLGQm;
        "pkg-1.4.6-forge-mc1.14" = _E0PmrIoy;
        "pkg-1.4.6-forge-mc1.15" = _kf221tgD;
        "pkg-1.4.6-forge-mc1.16" = _Z4Z3mlYh;
        "pkg-1.4.6-forge-mc1.17" = _7PXuiMvw;
        "pkg-1.4.6-forge-mc1.18" = _C7QPACQ3;
        "pkg-1.4.6-forge-mc1.19" = _yjUM4vRI;
        "pkg-1.4.6-forge-mc1.19.3" = _VudJuHyz;
        "pkg-1.4.6-forge-mc1.19.4" = _RQfHgz4W;
        "pkg-1.4.6-forge-mc1.20.1" = _7UK7slfm;
        "pkg-1.4.6-forge-mc1.20.2" = _lfVerZTY;
        "pkg-1.4.6-forge-mc1.20.4" = _I92RerBf;
        "pkg-1.4.6-fabric-mc1.18" = _30pHWhTh;
        "pkg-1.4.6-fabric-mc1.19.2" = _qjilmGSy;
        "pkg-1.4.6-fabric-mc1.19.4" = _aQfYXQrU;
        "pkg-1.4.6-fabric-mc1.20.1" = _NyZRxwVH;
        "pkg-1.4.6-fabric-mc1.20.2" = _fyZjEuFu;
        "pkg-1.4.6-fabric-mc1.20.4" = _ZX82Dfbl;
        "pkg-1.4.6-neoforge-mc1.20.4" = _BUiPnY2Y;
        "pkg-1.4.7-forge-mc1.12" = _YDfniue0;
        "pkg-1.4.7-forge-mc1.14" = _rLAnyNun;
        "pkg-1.4.7-forge-mc1.15" = _pWwjfLjD;
        "pkg-1.4.7-forge-mc1.16" = _fcYuYuFr;
        "pkg-1.4.7-forge-mc1.17" = _nmjPtC9c;
        "pkg-1.4.7-forge-mc1.18" = _SV32fKQ8;
        "pkg-1.4.7-forge-mc1.19" = _hDkEI9ws;
        "pkg-1.4.7-forge-mc1.19.3" = _F3z15Z7y;
        "pkg-1.4.7-forge-mc1.19.4" = _PChNFAvC;
        "pkg-1.4.7-forge-mc1.20.1" = _Et4cudq7;
        "pkg-1.4.7-forge-mc1.20.2" = _bJEtOeVe;
        "pkg-1.4.7-forge-mc1.20.4" = _EjbtBzci;
        "pkg-1.4.7-fabric-mc1.18" = _DbDfmwKy;
        "pkg-1.4.7-fabric-mc1.19.2" = _6OPjecVE;
        "pkg-1.4.7-fabric-mc1.19.4" = _zNXwiiND;
        "pkg-1.4.7-fabric-mc1.20.1" = _7ZMChsct;
        "pkg-1.4.7-fabric-mc1.20.2" = _X41U8246;
        "pkg-1.4.7-fabric-mc1.20.4" = _n4I2OEcI;
        "pkg-1.4.7-neoforge-mc1.20.4" = _qkf6slOB;
        "pkg-1.4.7-forge-mc1.20.6" = _xSRDeCNx;
        "pkg-1.4.7-forge-mc1.21" = _fQqsRmzl;
        "pkg-1.4.7-fabric-mc1.20.6" = _UzKG0Y0i;
        "pkg-1.4.7-fabric-mc1.21" = _y6YtrSXd;
        "pkg-1.4.7-neoforge-mc1.20.6" = _jRmKX5hU;
        "pkg-1.4.7-neoforge-mc1.21" = _Q74CvfVr;
        "pkg-1.4.7a-neoforge-mc1.21" = _cjY6WRSz;
        "pkg-1.4.7a-forge-mc1.20.6" = _PwoVvEdI;
        "pkg-1.4.7a-forge-mc1.21" = _P23h2Cj4;
        "pkg-1.4.7a-fabric-mc1.20.6" = _22sh6Ha2;
        "pkg-1.4.7a-fabric-mc1.21" = _Cl93HyMd;
        "pkg-1.4.7a-neoforge-mc1.20.6" = _9jjWdNuc;
        "pkg-1.4.7b-neoforge-mc1.21" = _bQVy6Gkh;
        "pkg-1.4.8-forge-mc1.12" = _fQHHKMzR;
        "pkg-1.4.8-forge-mc1.14" = _wRPIXPh8;
        "pkg-1.4.8-forge-mc1.15" = _1jKthKFh;
        "pkg-1.4.8-forge-mc1.16" = _yBuO1p2g;
        "pkg-1.4.8-forge-mc1.17" = _GDk4xIVM;
        "pkg-1.4.8-forge-mc1.18" = _R2UDHdRd;
        "pkg-1.4.8-forge-mc1.19.2" = _a9q5mLf4;
        "pkg-1.4.8-forge-mc1.19.3" = _DBlGdXbR;
        "pkg-1.4.8-forge-mc1.19.4" = _D3tkpe0i;
        "pkg-1.4.8-forge-mc1.20.1" = _GhEYoKEI;
        "pkg-1.4.8-forge-mc1.20.2" = _GlsNlUof;
        "pkg-1.4.8-forge-mc1.20.4" = _tDtOqBju;
        "pkg-1.4.8-forge-mc1.20.6" = _TScV79Ji;
        "pkg-1.4.8-forge-mc1.21" = _DYr8PSPg;
        "pkg-1.4.8-fabric-mc1.18" = _TkHetJtD;
        "pkg-1.4.8-fabric-mc1.19.2" = _jOtpAuJG;
        "pkg-1.4.8-fabric-mc1.19.4" = _3NMePLON;
        "pkg-1.4.8-fabric-mc1.20.1" = _5y81pnyG;
        "pkg-1.4.8-fabric-mc1.20.2" = _93XLNSBZ;
        "pkg-1.4.8-fabric-mc1.20.4" = _cCAl7d11;
        "pkg-1.4.8-fabric-mc1.20.6" = _vPDUwKc4;
        "pkg-1.4.8-fabric-mc1.21" = _Cbf7XAwb;
        "pkg-1.4.8-neoforge-mc1.20.4" = _TWManMVL;
        "pkg-1.4.8-neoforge-mc1.20.6" = _ZXxO6lzY;
        "pkg-1.4.8-neoforge-mc1.21" = _Mk8IhtiS;
        "pkg-1.4.8a-forge-mc1.12" = _jFVVqN5s;
        "pkg-1.4.9-forge-mc1.12" = _a1Q3hnT3;
        "pkg-1.4.9-forge-mc1.14" = _z9duey5P;
        "pkg-1.4.9-forge-mc1.15" = _eNGOodBA;
        "pkg-1.4.9-forge-mc1.16" = _BMu4YSdr;
        "pkg-1.4.9-forge-mc1.17" = _lJqbSLR2;
        "pkg-1.4.9-forge-mc1.18" = _VrFt8Ww9;
        "pkg-1.4.9-forge-mc1.19.2" = _icQaXez1;
        "pkg-1.4.9-forge-mc1.19.3" = _vs8AUQCJ;
        "pkg-1.4.9-forge-mc1.19.4" = _IVQULSB8;
        "pkg-1.4.9-forge-mc1.20.1" = _HkIZro3U;
        "pkg-1.4.9-forge-mc1.20.2" = _Lp1LfJTu;
        "pkg-1.4.9-forge-mc1.20.4" = _IOl0HMvW;
        "pkg-1.4.9-forge-mc1.20.6" = _Zo4hcTPL;
        "pkg-1.4.9-forge-mc1.21" = _3sH6uqAs;
        "pkg-1.4.9-fabric-mc1.18" = _8tQiQwV3;
        "pkg-1.4.9-fabric-mc1.19.2" = _DBWg0oe7;
        "pkg-1.4.9-fabric-mc1.19.4" = _xbLItSVG;
        "pkg-1.4.9-fabric-mc1.20.1" = _pWBk3UsA;
        "pkg-1.4.9-fabric-mc1.20.2" = _2UkXRRSY;
        "pkg-1.4.9-fabric-mc1.20.4" = _Fpw8xNKH;
        "pkg-1.4.9-fabric-mc1.20.6" = _1G84OSJy;
        "pkg-1.4.9-fabric-mc1.21" = _cUr8Qmvw;
        "pkg-1.4.9-neoforge-mc1.20.4" = _E024fS3c;
        "pkg-1.4.9-neoforge-mc1.20.6" = _oKk2f9kj;
        "pkg-1.4.9-neoforge-mc1.21" = _4ZQgK3yN;
        "pkg-1.4.9-fabric-mc1.21.2" = _z4l5PjFF;
        "pkg-1.4.9-neoforge-mc1.21.3" = _PNBh617V;
        "pkg-1.4.9a-forge-mc1.12" = _8NuLemP2;
        "pkg-1.4.9a-forge-mc1.14" = _H5cz4rDe;
        "pkg-1.4.9a-forge-mc1.15" = _hQKrQrG3;
        "pkg-1.4.9a-forge-mc1.16" = _8NsGnH6U;
        "pkg-1.4.10-forge-mc1.12" = _OUwwfT2b;
        "pkg-1.4.10-forge-mc1.14" = _Gbti4DHV;
        "pkg-1.4.10-forge-mc1.15" = _YkV4BsTD;
        "pkg-1.4.10-forge-mc1.16" = _cE2E6aab;
        "pkg-1.4.10-forge-mc1.17" = _HSVf7ViJ;
        "pkg-1.4.10-forge-mc1.18" = _Hdt9zJjE;
        "pkg-1.4.10-forge-mc1.19.2" = _PjrbOIaR;
        "pkg-1.4.10-forge-mc1.19.3" = _zEg78Osn;
        "pkg-1.4.10-forge-mc1.19.4" = _9rGrjWB8;
        "pkg-1.4.10-forge-mc1.20.1" = _cEsWHnKb;
        "pkg-1.4.10-forge-mc1.20.2" = _qMaw84rD;
        "pkg-1.4.10-forge-mc1.20.4" = _4d40HtBq;
        "pkg-1.4.10-forge-mc1.20.6" = _JgRMF7Xj;
        "pkg-1.4.10-forge-mc1.21" = _qNsLchJ6;
        "pkg-1.4.10-fabric-mc1.18" = _xC4gcIsc;
        "pkg-1.4.10-fabric-mc1.19.2" = _G6IbEMTC;
        "pkg-1.4.10-fabric-mc1.19.4" = _LKAhV2Bn;
        "pkg-1.4.10-fabric-mc1.20.1" = _PoP2eGwB;
        "pkg-1.4.10-fabric-mc1.20.2" = _3auiVGcC;
        "pkg-1.4.10-fabric-mc1.20.4" = _pwtVcjMU;
        "pkg-1.4.10-fabric-mc1.20.6" = _NLHMMVvp;
        "pkg-1.4.10-fabric-mc1.21" = _rGGoZVLu;
        "pkg-1.4.10-fabric-mc1.21.3" = _yvOC9tO3;
        "pkg-1.4.10-neoforge-mc1.20.4" = _d1DM7v8K;
        "pkg-1.4.10-neoforge-mc1.20.6" = _6CBNFdq0;
        "pkg-1.4.10-neoforge-mc1.21" = _vMJUtrtv;
        "pkg-1.4.10-neoforge-mc1.21.3" = _nXtnmwrP;
        "pkg-1.4.10-forge-mc1.21.3" = _yh3bsUKl;
        "pkg-1.4.10-forge-mc1.21.4" = _dtvRN7fZ;
        "pkg-1.4.10-fabric-mc1.21.4" = _DwElbx1I;
        "pkg-1.4.10-neoforge-mc1.21.4" = _snzUP4ty;
        "pkg-1.4.10a-forge-mc1.21.4" = _SvlJ0mbA;
        "pkg-1.4.10a-neoforge-mc1.21.4" = _CldfqJg0;
        "pkg-1.4.11-forge-mc1.12" = _Hdx5T0I4;
        "pkg-1.4.11-forge-mc1.14" = _eKWmVCJz;
        "pkg-1.4.11-forge-mc1.15" = _Nxtdaz8h;
        "pkg-1.4.11-forge-mc1.16" = _4GeP1gSw;
        "pkg-1.4.11-forge-mc1.17" = _fDYRIw63;
        "pkg-1.4.11-forge-mc1.18" = _85WhMak6;
        "pkg-1.4.11-forge-mc1.19.2" = _a3nKtX0j;
        "pkg-1.4.11-forge-mc1.19.3" = _4mks9igy;
        "pkg-1.4.11-forge-mc1.19.4" = _DvV9IGRX;
        "pkg-1.4.11-forge-mc1.20.1" = _TBwf7VQL;
        "pkg-1.4.11-forge-mc1.20.2" = _KTMKbJ0f;
        "pkg-1.4.11-forge-mc1.20.4" = _TzTHQrOF;
        "pkg-1.4.11-forge-mc1.20.6" = _D5MJISFK;
        "pkg-1.4.11-forge-mc1.21" = _Vkb0ZJOa;
        "pkg-1.4.11-forge-mc1.21.3" = _EDeenp4J;
        "pkg-1.4.11-forge-mc1.21.4" = _X2EWkQtd;
        "pkg-1.4.11-fabric-mc1.18" = _UL9gIf3c;
        "pkg-1.4.11-fabric-mc1.19.2" = _8zxXcM5A;
        "pkg-1.4.11-fabric-mc1.19.4" = _eft6vhWl;
        "pkg-1.4.11-fabric-mc1.20.1" = _g7ASGYxs;
        "pkg-1.4.11-fabric-mc1.20.2" = _rUly1FUs;
        "pkg-1.4.11-fabric-mc1.20.4" = _zKxlv06h;
        "pkg-1.4.11-fabric-mc1.20.6" = _gghuFeXn;
        "pkg-1.4.11-fabric-mc1.21" = _3oUjHjM8;
        "pkg-1.4.11-fabric-mc1.21.3" = _8bDT5KAh;
        "pkg-1.4.11-fabric-mc1.21.4" = _hdIuVhy1;
        "pkg-1.4.11-neoforge-mc1.20.4" = _fJ4Jzo8A;
        "pkg-1.4.11-neoforge-mc1.20.6" = _dGeNfJDH;
        "pkg-1.4.11-neoforge-mc1.21" = _UOZia0QY;
        "pkg-1.4.11-neoforge-mc1.21.3" = _6cfuKBNX;
        "pkg-1.4.11-neoforge-mc1.21.4" = _AoULhZez;
        "pkg-1.4.11-forge-mc1.21.5" = _uGLnNLlO;
        "pkg-1.4.11-forge-mc1.21.6" = _XNZzH7DZ;
        "pkg-1.4.11-fabric-mc1.21.5" = _8qeHOfuR;
        "pkg-1.4.11-fabric-mc1.21.6" = _hB6R87zo;
        "pkg-1.4.11-neoforge-mc1.21.5" = _GdfplNBX;
        "pkg-1.4.11-neoforge-mc1.21.6" = _eMb8l2ms;
        "pkg-1.4.11a-fabric-mc1.21.5" = _ZNxnLyyL;
        "pkg-1.4.11-forge-mc1.21.10" = _wbMqMdSG;
        "pkg-1.4.11-fabric-mc1.21.10" = _7LpCwisk;
        "pkg-1.4.11-neoforge-mc1.21.10" = _x1CGDEs6;
        "pkg-1.4.11a-forge-mc1.21.10" = _BHjRYBD5;
        "pkg-1.4.11a-fabric-mc1.21.10" = _xYzGCXSq;
        "pkg-1.4.11a-neoforge-mc1.21.10" = _zowRfMil;
        "pkg-1.4.11-forge-mc1.21.11" = _Np7KD4KJ;
        "pkg-1.4.11-fabric-mc1.21.11" = _k7Aj07lT;
        "pkg-1.4.11-neoforge-mc1.21.11" = _i4edqIrE;
        "pkg-1.4.12-forge-mc1.12" = _eSCQSnUy;
        "pkg-1.4.12-forge-mc1.14" = _5XWqDvG7;
        "pkg-1.4.12-forge-mc1.15" = _MpjsVTgo;
        "pkg-1.4.12-forge-mc1.16" = _TOLVdTvT;
        "pkg-1.4.12-forge-mc1.17" = _EkRwim0u;
        "pkg-1.4.12-forge-mc1.18" = _nE0lqNWQ;
        "pkg-1.4.12-forge-mc1.19.2" = _zYy3Ft3N;
        "pkg-1.4.12-forge-mc1.19.3" = _4EVjYIH5;
        "pkg-1.4.12-forge-mc1.19.4" = _42MdkywT;
        "pkg-1.4.12-forge-mc1.20.1" = _noPT9kd8;
        "pkg-1.4.12-forge-mc1.20.2" = _1eeTJJPF;
        "pkg-1.4.12-forge-mc1.20.4" = _qm21iN3v;
        "pkg-1.4.12-forge-mc1.20.6" = _rEiOQOFx;
        "pkg-1.4.12-forge-mc1.21" = _PLk7NCsI;
        "pkg-1.4.12-forge-mc1.21.3" = _nMrpzNxd;
        "pkg-1.4.12-forge-mc1.21.4" = _CAPznxxD;
        "pkg-1.4.12-forge-mc1.21.5" = _JqCkpZJi;
        "pkg-1.4.12-forge-mc1.21.8" = _o3ouAbKP;
        "pkg-1.4.12-forge-mc1.21.10" = _tONsizeg;
        "pkg-1.4.12-forge-mc1.21.11" = _NMAu50Qv;
        "pkg-1.4.12-fabric-mc1.18" = _qlvEaOwW;
        "pkg-1.4.12-fabric-mc1.19.2" = _B1ns9PiD;
        "pkg-1.4.12-fabric-mc1.19.4" = _ylwJHKSJ;
        "pkg-1.4.12-fabric-mc1.20.1" = _n5IrH04G;
        "pkg-1.4.12-fabric-mc1.20.2" = _MGR8moom;
        "pkg-1.4.12-fabric-mc1.20.4" = _mDNpFHaz;
        "pkg-1.4.12-fabric-mc1.20.6" = _uihE8YKf;
        "pkg-1.4.12-fabric-mc1.21" = _IJCr5RV5;
        "pkg-1.4.12-fabric-mc1.21.3" = _TcKt7Zb2;
        "pkg-1.4.12-fabric-mc1.21.4" = _EeOvKibH;
        "pkg-1.4.12-fabric-mc1.21.5" = _NEvuK9i3;
        "pkg-1.4.12-fabric-mc1.21.8" = _dNoHtZcp;
        "pkg-1.4.12-fabric-mc1.21.10" = _3NvLP2yK;
        "pkg-1.4.12-fabric-mc1.21.11" = _qr1ViZ9C;
        "pkg-1.4.12-neoforge-mc1.20.4" = _goteXinz;
        "pkg-1.4.12-neoforge-mc1.20.6" = _ac944Q0I;
        "pkg-1.4.12-neoforge-mc1.21" = _TIxoPOmH;
        "pkg-1.4.12-neoforge-mc1.21.3" = _xzR9Ud1V;
        "pkg-1.4.12-neoforge-mc1.21.4" = _TXzWGAXj;
        "pkg-1.4.12-neoforge-mc1.21.5" = _B5JZ64xL;
        "pkg-1.4.12-neoforge-mc1.21.8" = _1fBVl1qZ;
        "pkg-1.4.12-neoforge-mc1.21.10" = _LYLa1E4I;
        "pkg-1.4.12-neoforge-mc1.21.11" = _sezl55zX;
        "pkg-1.4.12-forge-mc26.1" = _PWjNo0Ft;
        "pkg-1.4.12-fabric-mc26.1" = _wxm2ZM4Z;
        "pkg-1.4.12-neoforge-mc26.1" = _2qcPUQc4;
        "pkg-1.4.12-forge-mc26.2" = _VWHINYrN;
        "pkg-1.4.12-fabric-mc26.2" = _OVXe376H;
        "pkg-1.4.12-neoforge-mc26.2" = _u5xaEQEA;
        "pkg-1.4.12a-neoforge-mc26.1" = _lI5Wde1k;
        "pkg-1.4.12a-forge-mc26.1" = _Khzjkyrg;
        "pkg-1.4.12a-fabric-mc26.1" = _YdrA6dUw;
