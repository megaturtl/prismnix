...
let
    versions = (let
        ...
        _YkchMFP2 = {
            "id" = "YkchMFP2";
            "file" = "serverpingerfixer-1.0.6.jar";
            "hash" = "sha512-9XKpn1VIRIdwK7FiAmdeir15s9Finq33ylxFBtLQb8r4/CGqFSKKUmeCmZUVVpIQ5uTUUxxRVUB2GpEi4xiMRw==";
        };
        _S5jb0bIg = {
            "id" = "S5jb0bIg";
            "file" = "serverpingerfixer+26.1-1.1.1.jar";
            "hash" = "sha512-o5rXZ16kGj6GIBAUl6FPMkKtzlXC00+ubWszXIo15VSl/XoPYDti/98CNVcceVjSIvFDwTrRdGsjDyLZkAqniA==";
        };
    in {
        "JOpI0srf" = _JOpI0srf;
        "9xhu5jYz" = _9xhu5jYz;
        ...
        "YkchMFP2" = _YkchMFP2;
        "S5jb0bIg" = _S5jb0bIg;
        "fabric-1.20.1" = _YkchMFP2;
        "fabric-1.19.4" = _YkchMFP2;
        "fabric-1.18" = _YkchMFP2;
        "fabric-1.18.1" = _YkchMFP2;
        "fabric-1.18.2" = _YkchMFP2;
        "fabric-1.19" = _YkchMFP2;
        "fabric-1.19.1" = _YkchMFP2;
        "fabric-1.19.2" = _YkchMFP2;
        "fabric-1.19.3" = _YkchMFP2;
        "fabric-1.20" = _YkchMFP2;
        "fabric-1.20.2" = _YkchMFP2;
        "fabric-1.20.3" = _YkchMFP2;
        "fabric-1.20.4" = _YkchMFP2;
        "fabric-1.20.5" = _YkchMFP2;
        "fabric-1.20.6" = _YkchMFP2;
        "fabric-1.21" = _YkchMFP2;
        "fabric-1.21.1" = _YkchMFP2;
        "fabric-1.21.2" = _YkchMFP2;
        "fabric-1.21.3" = _YkchMFP2;
        "fabric-1.21.4" = _YkchMFP2;
        "fabric-1.21.5" = _YkchMFP2;
        "fabric-1.21.6" = _YkchMFP2;
        "fabric-1.21.7" = _YkchMFP2;
        "fabric-1.21.8" = _YkchMFP2;
        "fabric-1.21.9" = _YkchMFP2;
        "fabric-1.21.10" = _YkchMFP2;
        "fabric-1.21.11" = _YkchMFP2;
        "fabric-26.1" = _S5jb0bIg;
        "fabric-26.1.1" = _S5jb0bIg;
        "fabric-26.1.2" = _S5jb0bIg;
        "fabric-26.2" = _S5jb0bIg;
        "pkg-1.0.0+1.20.1" = _JOpI0srf;
        "pkg-1.0.0+1.19.4" = _9xhu5jYz;
        "pkg-1.0.1" = _VSIi6KML;
        "pkg-1.0.2" = _etDgLjqA;
        "pkg-1.0.3" = _tsvH4Ltn;
        "pkg-1.0.4" = _fHvfA2My;
