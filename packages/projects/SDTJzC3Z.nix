...
let
    ...
    in {
        ...
        "pkg-1.2.6-neoforge" = _neztD500;
        "pkg-1.2.7-fabric" = _5MJiAwp5;
        "pkg-1.2.7-forge" = _CXMWmhIJ;
        "pkg-1.2.7-neoforge" = _fmVqnvvV;
        "pkg-1.3.0-fabric" = _XYR40j59;
        "pkg-1.3.0-forge" = _o27FW5RI;
        "pkg-1.3.0-neoforge" = _ETrRO9yS;
