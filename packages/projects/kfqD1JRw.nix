...
let
    ...
    in {
        ...
        "pkg-v4.1.0-1.19.1-Fabric" = _ECpcrj5G;
        "pkg-v4.1.1-1.19.1-Forge" = _an5hlYvx;
        "pkg-v4.1.1-1.19.1-Fabric" = _hKvqOI9E;
        "pkg-v4.2.0-1.19.2-Forge" = _f1ktO3g4;
        "pkg-v4.2.0-1.19.2-Fabric" = _wp3azK8k;
        "pkg-v4.2.1-1.19.2-Forge" = _pp2m6C0d;
        "pkg-v4.2.1-1.19.2-Fabric" = _ci428HLo;
        "pkg-v4.2.2-1.19.2-Forge" = _ovLGPk2F;
        "pkg-v4.2.2-1.19.2-Fabric" = _VZ2wjeE6;
        "pkg-v4.2.3-1.19.2-Forge" = _S660s8GR;
        "pkg-v4.2.3-1.19.2-Fabric" = _F8eCsWpQ;
        "pkg-v4.2.4-1.19.2-Forge" = _1u457HoS;
        "pkg-v4.2.4-1.19.2-Fabric" = _h5Ifh4lN;
        "pkg-v5.0.0-1.19.3-Forge" = _TeAf8Mg3;
        "pkg-v5.0.0-1.19.3-Fabric" = _k4UIWslQ;
        "pkg-v6.0.0-1.19.4-Forge" = _Zz4BSyuq;
        "pkg-v6.0.0-1.19.4-Fabric" = _l8y9fFba;
        "pkg-v6.0.1-1.19.4-Fabric" = _VqvvjhAR;
        "pkg-v6.0.1-1.19.4-Forge" = _tHZzZWS0;
        "pkg-v7.0.0-1.20-Forge" = _Red4pnz9;
        "pkg-v7.0.0-1.20-Fabric" = _niu1gOTE;
        "pkg-v8.0.0-1.20.1-Forge" = _c22Z4rsv;
        "pkg-v8.0.0-1.20.1-Fabric" = _vhuwOiNO;
        "pkg-v20.4.0-1.20.4-Fabric" = _kbrqnTsO;
        "pkg-v20.4.0-1.20.4-Forge" = _TTMC5dxP;
        "pkg-v20.4.0-1.20.4-NeoForge" = _Nqqfj4b0;
        "pkg-v20.4.1-1.20.4-Fabric" = _H5OUusrI;
        "pkg-v20.4.1-1.20.4-Forge" = _7MTAGr2H;
        "pkg-v20.4.1-1.20.4-NeoForge" = _LrjyRsmi;
        "pkg-v20.4.2-1.20.4-Fabric" = _En0eBVl1;
        "pkg-v20.4.2-1.20.4-Forge" = _Xt6qbOHK;
        "pkg-v20.4.2-1.20.4-NeoForge" = _fndrNbOK;
        "pkg-v21.0.0-1.21-Fabric" = _Pj1Q3lig;
        "pkg-v21.0.0-1.21-NeoForge" = _IXNeE4X3;
        "pkg-v21.0.1-1.21-Fabric" = _VO22sn7H;
        "pkg-v21.0.1-1.21-NeoForge" = _Tp5b9TyW;
        "pkg-v21.0.3-1.21-Fabric" = _vwXLcwsZ;
        "pkg-v21.0.3-1.21-NeoForge" = _M55HFhZt;
        "pkg-v21.0.4-1.21-Fabric" = _Ri7RSp90;
        "pkg-v21.0.4-1.21-NeoForge" = _dm7nl1iX;
        "pkg-v21.0.5-1.21-Fabric" = _2F4w4356;
        "pkg-v21.0.5-1.21-NeoForge" = _4yCmKA9D;
        "pkg-v21.1.0-1.21.1-Fabric" = _c1Cea0fX;
        "pkg-v21.1.0-1.21.1-NeoForge" = _e78502KA;
        "pkg-v21.3.0-1.21.3-Fabric" = _itM6w7NL;
        "pkg-v21.3.0-1.21.3-NeoForge" = _Jnq6HJyn;
        "pkg-v21.4.0-1.21.4-Fabric" = _gg4Wflea;
        "pkg-v21.4.0-1.21.4-NeoForge" = _l3GZOaiE;
        "pkg-v21.4.1-1.21.4-Fabric" = _eEmPD3gO;
        "pkg-v21.4.1-1.21.4-NeoForge" = _R96kEpJG;
        "pkg-v21.5.0-1.21.5-Fabric" = _GLNQXUBq;
        "pkg-v21.5.0-1.21.5-NeoForge" = _z8m9r3qh;
        "pkg-v21.6.0-1.21.6-Fabric" = _1QxLislr;
        "pkg-v21.6.0-1.21.6-NeoForge" = _FVgzbXwS;
        "pkg-v21.7.0-1.21.7-Fabric" = _aM6xUbax;
        "pkg-v21.7.0-1.21.7-NeoForge" = _vVIL8qlW;
        "pkg-v21.8.0-1.21.8-Fabric" = _kmvuHzhX;
        "pkg-v21.8.0-1.21.8-NeoForge" = _vudzHO0k;
        "pkg-v8.0.1-1.20.1-Forge" = _qaWEHDC3;
        "pkg-v8.0.1-1.20.1-Fabric" = _NP7AXO6Q;
        "pkg-v21.1.1-1.21.1-Fabric" = _fGXmFJ8q;
        "pkg-v21.1.1-1.21.1-NeoForge" = _Jy5V5FNj;
        "pkg-v21.8.1-1.21.8-Fabric" = _tpfB5hBp;
        "pkg-v21.8.1-1.21.8-NeoForge" = _4vvuRSgh;
        "pkg-21.9.0" = _9nYgezDa;
        "pkg-21.10.0" = _itng3HTw;
        "pkg-21.11.0" = _t5vbeALi;
        "pkg-21.11.1" = _tbgn1zIa;
