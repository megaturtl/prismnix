...
let
    versions = (let
        ...
        _FAYSwrZc = {
            "id" = "FAYSwrZc";
            "file" = "tcdcommons-5.5.5+fn-26.1.jar";
            "hash" = "sha512-20W/HDs7WIH1J2Vs+bG/2x+So2p7Nfa7Yt8BedtR/bR9qT3LmaT9H7hKezl8xdyg/tvyBVBObq9gdT4KK6f1kg==";
        };
        _NM3aWYRR = {
            "id" = "NM3aWYRR";
            "file" = "tcdcommons-5.5.6+fn-26.2.jar";
            "hash" = "sha512-DR3EsUtC1RajXdtbRYxwiYHPsr+MC/ieSl73nZ4/yO4NJ4e5uCrVzjtfrPgm/fDnFogKRTPRkpQe9ejD4TbF4g==";
        };
        _uSpV2sxA = {
            "id" = "uSpV2sxA";
    ...
    in {
        ...
        "fabric-26.1" = _uSpV2sxA;
        "fabric-26.1.1" = _uSpV2sxA;
        ...
        "neoforge-26.1" = _uSpV2sxA;
        "neoforge-26.1.1" = _uSpV2sxA;
        ...
        "pkg-v2.0+1.19.2" = _AW8Hm3pk;
        "pkg-v2.0+1.19+3" = _OGJiBTH1;
        "pkg-v2.0+forge-1.18.2" = _ivQchSYZ;
        "pkg-2.0+forge-1.19.2" = _10HOtsnN;
        "pkg-2.1+forge-1.18.2" = _qaqOlTe0;
        "pkg-2.1+forge-1.19.2" = _gNB0ls81;
        "pkg-v2.1+fabric-1.18.2" = _yYtHijwo;
        "pkg-v2.1+fabric-1.19.2" = _Zpeb7kj9;
        "pkg-v2.1+fabric-1.19.3" = _EL5twzsL;
        "pkg-v2.1.1+fabric-1.18.2" = _MhbjMaax;
        "pkg-v2.1.1+fabric-1.19.2" = _clnm4baD;
        "pkg-v2.1.1+fabric-1.19.3" = _RPIttN1w;
        "pkg-v2.2+forge-1.18.2" = _Jf38xzKF;
        "pkg-v2.2+forge-1.19.2" = _ziv1qJtR;
        "pkg-v2.3+fabric-1.18.2" = _XPHdxTie;
        "pkg-v2.3+fabric-1.19.2" = _V5oc2rXu;
        "pkg-v2.3+fabric-1.19.3" = _1UPK4b4G;
        "pkg-v2.4+fabric-1.18.2" = _c6X0iVds;
        "pkg-v2.4+fabric-1.19.2" = _h1OWsYrN;
        "pkg-v2.4+fabric-1.19.3" = _sbiLVJWw;
        "pkg-v2.4.1+fabric-1.19.3" = _KaNsJNKt;
        "pkg-v2.5.1+fabric-1.19.4" = _AxBhioFO;
        "pkg-v2.6+fabric-1.18.2" = _WLnpQgAL;
        "pkg-v2.6+fabric-1.19.2" = _dYWIngXI;
        "pkg-v2.6+fabric-1.19.3" = _tB9hSxG6;
        "pkg-v2.6+fabric-1.19.4" = _jpLVCRXX;
        "pkg-v2.7+fabric-1.18.2" = _M6tyqMXa;
        "pkg-v2.7+fabric-1.19.2" = _u22SBJlT;
        "pkg-v2.7+fabric-1.19.3" = _CasG3RG1;
        "pkg-v2.7+fabric-1.19.4" = _HdmOq7kr;
        "pkg-v2.8+fabric-1.18.2" = _2ye1HWLK;
        "pkg-v2.8+fabric-1.19.2" = _iuHvdvT4;
        "pkg-v2.8+fabric-1.19.3" = _Wjv0Dpxp;
        "pkg-v2.8+fabric-1.19.4" = _tFfc16er;
        "pkg-v2.9.1+fabric-1.18.2" = _3ozJR9Wg;
        "pkg-v2.9.1+fabric-1.19.2" = _TDJYcvSZ;
        "pkg-v2.9.1+fabric-1.19.3" = _o6Y39pqg;
        "pkg-v2.9.1+fabric-1.19.4" = _DXJpxVyV;
        "pkg-v2.10+fabric-1.20.1" = _V6sA8277;
        "pkg-v2.10.1+fabric-1.20.1" = _S8L1IZcx;
        "pkg-v2.10.2+fabric-1.20.1" = _5PUU6vdx;
        "pkg-3.0.0+fabric-1.20.1" = _2NYwebZx;
        "pkg-3.1+fabric-1.20.2" = _XeGsAZ4z;
        "pkg-3.2+fabric-1.20.2" = _CZ4ut4Gy;
        "pkg-3.2+fabric-1.20.1" = _QRXIO4EG;
        "pkg-3.3+fabric-1.20.1" = _156Vt6nc;
        "pkg-3.3+fabric-1.20.2" = _R2cgti0m;
        "pkg-3.4+fabric-1.20.1" = _8V9EoAFr;
        "pkg-3.4+fabric-1.20.2" = _qtc1IEZL;
        "pkg-3.5+fabric-1.20.1" = _MWdaY0zb;
        "pkg-3.5+fabric-1.20.2" = _XiBRETiW;
        "pkg-3.7+fabric-1.20.1" = _fdUdJnzF;
        "pkg-3.7+fabric-1.20.2" = _D8xA7Gql;
        "pkg-3.7+fabric-1.20.4" = _b9QGgU1f;
        "pkg-3.8+fabric-1.20.1" = _ZyfhF0xv;
        "pkg-3.8+fabric-1.20.2" = _73Z5JwuT;
        "pkg-3.8+fabric-1.20.4" = _ZJYRbF8b;
        "pkg-3.8.1+fabric-1.20.1" = _l4p4bSCy;
        "pkg-3.8.1+fabric-1.20.2" = _D1cJROfj;
        "pkg-3.8.1+fabric-1.20.4" = _Z8lviisV;
        "pkg-3.9+fabric-1.20.1" = _8HfWPCiX;
        "pkg-3.9+fabric-1.20.2" = _tI6ZLyLU;
        "pkg-3.9+fabric-1.20.4" = _MfGcm0WV;
        "pkg-3.9.1+fabric-1.20.1" = _F3x2xkav;
        "pkg-3.9.1+fabric-1.20.2" = _1GNXRiLH;
        "pkg-3.9.1+fabric-1.20.4" = _hDunL3WT;
        "pkg-3.9.2+fabric-1.20.1" = _apHsOK1G;
        "pkg-3.9.2+fabric-1.20.2" = _TLey8sva;
        "pkg-3.9.2+fabric-1.20.4" = _LZP9nlNC;
        "pkg-3.9.3+fabric-1.20.1" = _e6Rvaouj;
        "pkg-3.9.3+fabric-1.20.2" = _BuWlF7tx;
        "pkg-3.9.3+fabric-1.20.4" = _RWL89mdC;
        "pkg-3.9.4+fabric-1.20.1" = _4WOufSl7;
        "pkg-3.9.4+fabric-1.20.2" = _zR4noBmW;
        "pkg-3.9.4+fabric-1.20.4" = _mfemepw0;
        "pkg-3.9.5+fabric-1.20.1" = _aS16wBuk;
        "pkg-3.9.5+fabric-1.20.2" = _ek1UsZtN;
        "pkg-3.9.5+fabric-1.20.4" = _2Kh24DqD;
        "pkg-3.9.7+fabric-1.20.1" = _2mfYVOhd;
        "pkg-3.9.7+fabric-1.20.2" = _KrL691SI;
        "pkg-3.9.7+fabric-1.20.4" = _6GY5dK6d;
        "pkg-3.9.7+fabric-1.20.5" = _dSruzhTG;
        "pkg-3.10+fabric-1.20.6" = _MfOyBqDo;
        "pkg-3.11+fabric-1.20.6" = _aREND1nc;
        "pkg-3.11+fabric-1.21" = _uJTymhdj;
        "pkg-3.11.1+fabric-1.20.6" = _z9NdJvlY;
        "pkg-3.11.1+fabric-1.21" = _EbhWGkSn;
        "pkg-3.12+fabric-1.20.6" = _909sYDc6;
        "pkg-3.12+fabric-1.21" = _GtbLVhaj;
        "pkg-3.12.1+fabric-1.20.6" = _xkAQlFu1;
        "pkg-3.12.1+fabric-1.21" = _zPxlmI30;
        "pkg-3.12.2+fabric-1.20.6" = _RZnih7Ji;
        "pkg-3.12.2+fabric-1.21" = _cVQPWmLi;
        "pkg-3.12.2+fabric-1.20.4" = _jyEnO1cb;
        "pkg-3.12.2+fabric-1.20.2" = _Cgo1rJq8;
        "pkg-3.12.2+fabric-1.20.1" = _E2kWwGpi;
        "pkg-3.12.3+fabric-1.20.1" = _Gob4d0A8;
        "pkg-3.12.3+fabric-1.20.2" = _AQQGQgg4;
        "pkg-3.12.3+fabric-1.20.4" = _nbKbUntj;
        "pkg-3.12.3+fabric-1.20.6" = _a2hQr9cD;
        "pkg-3.12.3+fabric-1.21" = _q0tTf22O;
        "pkg-3.12.3+fabric-1.21.3" = _5F1QyhMG;
        "pkg-3.12.4+fabric-1.21" = _yBjt6GDr;
        "pkg-3.12.4+fabric-1.21.3" = _5yCLsHlo;
        "pkg-3.12.4+fabric-1.21.4" = _nf0Pj3lg;
        "pkg-3.12.5+fabric-1.21" = _u5IY2Agn;
        "pkg-3.12.5+fabric-1.21.3" = _JVU1Wsml;
        "pkg-3.12.5+fabric-1.21.4" = _8WcLnbZL;
        "pkg-3.12.7+fabric-1.21" = _RvXDhazY;
        "pkg-3.12.7+fabric-1.21.3" = _nLrVeepP;
        "pkg-3.12.7+fabric-1.21.4" = _J9cwsnsK;
        "pkg-3.12.7+fabric-1.21.5" = _HraP4Op2;
        "pkg-3.12.3.3+fabric-1.20.1" = _BBxTOVSm;
        "pkg-3.12.3.3+fabric-1.20.2" = _AGXm5KcH;
        "pkg-3.12.3.3+fabric-1.20.4" = _a6OB08Cz;
        "pkg-3.12.3.3+fabric-1.20.6" = _3U6mwMus;
        "pkg-3.12.8-beta.1+fabric-1.21.6" = _kCYDj9zO;
        "pkg-3.12.8-beta.1+fabric-1.21.7" = _vG8asQVB;
        "pkg-3.12.8+fabric-1.21.8" = _95522OOI;
        "pkg-4.0.0+fabric-1.21.8" = _yXdv9CZh;
        "pkg-4.0.0+neoforge-1.21.8" = _ReAA6vbz;
        "pkg-4.0.1+fabric-1.21.8" = _mPtjd8Nu;
        "pkg-4.0.1+neoforge-1.21.8" = _98ccfw51;
        "pkg-4.0.1+fabric-1.21.9" = _svunM3ft;
        "pkg-4.0.1+neoforge-1.21.9" = _WU9PSR5k;
        "pkg-4.0.1+fabric-1.21.10" = _LbgckUvR;
        "pkg-4.0.1+neoforge-1.21.10" = _fBfQmdmP;
        "pkg-5.0.0-alpha.1+fabric-1.21.11" = _YMGq7X5F;
        "pkg-5.0.0-alpha.1+neoforge-1.21.11" = _UNBn1h1e;
        "pkg-5.0.0-alpha.2+fabric-1.21.11" = _Hbo8bT4d;
        "pkg-5.0.0-alpha.2+neoforge-1.21.11" = _bXL2Eb2r;
        "pkg-5.0.0-beta.1+fabric-1.21.11" = _WxppHfdM;
        "pkg-5.0.0-beta.1+neoforge-1.21.11" = _wRaTa2jA;
        "pkg-5.0.0-beta.4+fabric-1.21.11" = _hFMJAyVP;
        "pkg-5.0.0-beta.4+neoforge-1.21.11" = _gsWNkT5N;
        "pkg-5.0.0-beta.5+fabric-1.21.11" = _9ck6BCCe;
        "pkg-5.0.0-beta.5+neoforge-1.21.11" = _w3guU71s;
        "pkg-5.0.0-beta.6+fabric-1.21.11" = _OmtB7Ofw;
        "pkg-5.0.0-beta.6+neoforge-1.21.11" = _cV7XLcgf;
        "pkg-5.0.0+neoforge-1.21.11" = _h71dcN0v;
        "pkg-5.0.0+fabric-1.21.11" = _ZQdmJdKB;
        "pkg-5.1.0+fabric-1.21.11" = _X850L9UC;
        "pkg-5.1.0+neoforge-1.21.11" = _eG8M6J3m;
        "pkg-5.2.0+fabric-26.1" = _4621oCjG;
        "pkg-5.2.0+fn-26.1" = _JXSmS6KG;
        "pkg-5.2.0+fn-26.1.1" = _DZTuHw7J;
        "pkg-5.2.0+fn-26w14a" = _aFyLTwuY;
        "pkg-5.2.1+fn-26.1" = _ZqK3fcVL;
        "pkg-5.3.0+fn-26.1" = _ppnp3shz;
        "pkg-5.3.1+fn-26.1" = _H24c2CiG;
        "pkg-5.3.2+fn-26.1" = _Zdxovwk8;
        "pkg-5.4.0+fn-26.2" = _MPcP0l9g;
        "pkg-5.4.1+fn-26.2" = _xIdzCjYP;
        "pkg-5.5.0+fn-26.2" = _mcT8lul0;
        "pkg-5.5.1+fn-26.2" = _hFj2baY6;
        "pkg-5.5.2+fn-26.2" = _E6ayJzhw;
        "pkg-5.5.3+fn-26.2" = _luZFA1kz;
        "pkg-5.5.4+fn-26.2" = _6YYTlCvO;
        "pkg-5.5.5+fn-26.2" = _E3obAdZc;
