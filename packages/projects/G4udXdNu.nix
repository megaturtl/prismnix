...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.1.9" = _6Kq9kBor;
        "pkg-1.20.1-1.2.0" = _5CXVxE4q;
        "pkg-1.20.1-1.2.1" = _vitGki9d;
        "pkg-1.20.2-1.2.2" = _q0pd4EmY;
        "pkg-1.20.5" = _Mt0Od57k;
        "pkg-1.20.6" = _e184h9mI;
        "pkg-1.21-1.2.21" = _TV61sV9X;
        "pkg-1.21-1.2.34" = _K4ydITjE;
        "pkg-1.21.2-1.2.34" = _XUEmCOXQ;
        "pkg-1.21.4-1.2.34" = _5MslUrk7;
        "pkg-1.21.5-1.2.34" = _Klso6S6T;
        "pkg-1.21.6-1.2.34" = _yBQcH9gN;
        "pkg-1.21.7-1.2.34" = _Le3IxtVx;
        "pkg-1.21.8-1.2.34" = _jjKvVXES;
        "pkg-v1.3.1-mc1.19.3" = _3S9ArDVP;
        "pkg-v1.3.1-mc1.20.2" = _6A8uY4rT;
        "pkg-v1.3.1-mc1.21.7" = _9SF2fu6Y;
        "pkg-v1.3.1-mc1.20.1" = _xf85ZKxl;
        "pkg-v1.3.1-mc1.21.1" = _hUl1J9Wr;
        "pkg-v1.3.1-mc1.19" = _GYXVd3y4;
        "pkg-v1.3.1-mc1.21.9" = _5FfrXd72;
        "pkg-v1.3.1-mc1.21.6" = _FfMqnBEo;
        "pkg-v1.3.1-mc1.19.4" = _h3026PGM;
        "pkg-v1.3.1-mc1.21.4" = _ZYZpN2AC;
        "pkg-v1.3.1-mc1.21.8" = _wspCONFZ;
        "pkg-v1.3.1-mc1.20" = _AWUCmYaE;
        "pkg-v1.3.1-mc1.20.4" = _YXbVDOOY;
        "pkg-v1.3.1-mc1.20.3" = _1aOzbpQy;
        "pkg-v1.3.1-mc1.20.6" = _h8oG65aL;
        "pkg-v1.3.1-mc1.19.2" = _4UBX3YpM;
        "pkg-v1.3.1-mc1.21.5" = _mKug7MIh;
        "pkg-v1.3.1-mc1.21" = _IsSXTfAo;
        "pkg-v1.3.1-mc1.21.3" = _x0stjd3l;
        "pkg-v1.3.1-mc1.21.2" = _71pAlNZH;
        "pkg-v1.3.1-mc1.21.10" = _oSaBUXf9;
        "pkg-v1.3.1-mc1.20.5" = _9i7atE9k;
        "pkg-v1.4.0-mc1.19" = _WWdg6vgk;
        "pkg-v1.4.0-mc1.20" = _EXo3EfH6;
        "pkg-v1.4.0-mc1.21.4" = _EKDZRDNc;
        "pkg-v1.4.0-mc1.20.5" = _kmqyq7tu;
        "pkg-v1.4.0-mc1.21.9" = _EFD5cGX3;
        "pkg-v1.4.0-mc1.21.8" = _Nbmriw2C;
        "pkg-v1.4.0-mc1.19.3" = _PwgQai6E;
        "pkg-v1.4.0-mc1.21.6" = _IpHc9xSg;
        "pkg-v1.4.0-mc1.21.2" = _uYH8VSAt;
        "pkg-v1.4.0-mc1.20.2" = _EJrio0kA;
        "pkg-v1.4.0-mc1.20.3" = _P91xdHY7;
        "pkg-v1.4.0-mc1.19.4" = _PzHgCrI9;
        "pkg-v1.4.0-mc1.21.5" = _AWQ9SLZc;
        "pkg-v1.4.0-mc1.21.7" = _INetpVrp;
        "pkg-v1.4.0-mc1.19.1" = _UzISDuDd;
        "pkg-v1.4.0-mc1.20.6" = _LdgULkeK;
        "pkg-v1.4.0-mc1.19.2" = _QKPBAJLq;
        "pkg-v1.4.0-mc1.20.1" = _UMJDeAnD;
        "pkg-v1.4.0-mc1.21.3" = _6HkMytoa;
        "pkg-v1.4.0-mc1.20.4" = _scNmfl3Y;
        "pkg-v1.4.0-mc1.21" = _T96eXXlL;
        "pkg-v1.4.0-mc1.21.1" = _JJR4HKO6;
        "pkg-v1.4.0-mc1.21.10" = _Lwdj9m1m;
        "pkg-v1.4.1-mc1.21.4" = _u0vXZox4;
        "pkg-v1.4.1-mc1.21.5" = _nlU5u0ba;
        "pkg-v1.4.1-mc1.20.3" = _CGdFEYFM;
        "pkg-v1.4.1-mc1.20.4" = _Q9O40dCo;
        "pkg-v1.4.1-mc1.21.3" = _tnsd0etk;
        "pkg-v1.4.1-mc1.19.2" = _hUCl6rP5;
        "pkg-v1.4.1-mc1.20.6" = _so07li68;
        "pkg-v1.4.1-mc1.21.6" = _ORb2KKoB;
        "pkg-v1.4.1-mc1.21" = _PalqptDK;
        "pkg-v1.4.1-mc1.20" = _Cn6jWbnf;
        "pkg-v1.4.1-mc1.20.1" = _XgfaCvl9;
        "pkg-v1.4.1-mc1.21.2" = _H04W1EW5;
        "pkg-v1.4.1-mc1.21.9" = _9F0fCm7K;
        "pkg-v1.4.1-mc1.21.7" = _tYTwIde1;
        "pkg-v1.4.1-mc1.21.8" = _cXAP7Iqx;
        "pkg-v1.4.1-mc1.21.1" = _JnXL1x66;
        "pkg-v1.4.1-mc1.19" = _ljJtUrVw;
        "pkg-v1.4.1-mc1.19.3" = _zCGqtbEG;
        "pkg-v1.4.1-mc1.19.1" = _BlsycGG5;
        "pkg-v1.4.1-mc1.20.2" = _CI1DsNZw;
        "pkg-v1.4.1-mc1.20.5" = _WKtVVH9n;
        "pkg-v1.4.1-mc1.19.4" = _Wldupx3a;
        "pkg-v1.4.4-mc1.20.2" = _9biDWrXT;
        "pkg-v1.4.4-mc1.19.2" = _JwAFGgeR;
        "pkg-v1.4.4-mc1.21.4" = _FPme4UcD;
        "pkg-v1.4.4-mc1.19.4" = _AvoRo0RG;
        "pkg-v1.4.4-mc1.21" = _fk9KWAGD;
        "pkg-v1.4.4-mc1.19.1" = _xgVHcUnU;
        "pkg-v1.4.4-mc1.21.6" = _Frq9x2Yg;
        "pkg-v1.4.4-mc1.21.1" = _EivLJPBJ;
        "pkg-v1.4.4-mc1.19" = _ydKNz5dg;
        "pkg-v1.4.4-mc1.21.7" = _d0kaTmPh;
        "pkg-v1.4.4-mc1.20.4" = _4anOHPHS;
        "pkg-v1.4.4-mc1.20.3" = _CXVhcMuT;
        "pkg-v1.4.4-mc1.20.6" = _RgDAfswu;
        "pkg-v1.4.4-mc1.19.3" = _5cxeJjS5;
        "pkg-v1.4.4-mc1.20.1" = _9DnjWmA9;
        "pkg-v1.4.4-mc1.21.10" = _xqxn9Eu7;
        "pkg-v1.4.4-mc1.20" = _nqR3vwuA;
        "pkg-v1.4.4-mc1.21.9" = _HinOVHvF;
        "pkg-v1.4.4-mc1.21.5" = _5ZXBdUen;
        "pkg-v1.4.4-mc1.20.5" = _GiiAFq0G;
        "pkg-v1.4.4-mc1.21.8" = _BrWhVH80;
        "pkg-v1.4.4-mc1.21.3" = _wRMrUcZL;
        "pkg-v1.4.4-mc1.21.2" = _sJ24nxow;
        "pkg-v1.4.5-mc1.21.10" = _MVtWWhmu;
        "pkg-v1.4.5-mc1.19.1" = _O9ZvD6iG;
        "pkg-v1.4.5-mc1.21.6" = _LTcI8CI0;
        "pkg-v1.4.5-mc1.20.1" = _Q7dzBrH6;
        "pkg-v1.4.5-mc1.19.3" = _i1gdwgAV;
        "pkg-v1.4.5-mc1.20.2" = _M5CzjCbi;
        "pkg-v1.4.5-mc1.19.4" = _ZoYCwRk1;
        "pkg-v1.4.5-mc1.20.3" = _7yYxt6EH;
        "pkg-v1.4.5-mc1.21.4" = _DeJ4dk1X;
        "pkg-v1.4.5-mc1.21.2" = _BTq5xorf;
        "pkg-v1.4.5-mc1.20.5" = _HMXOEdgN;
        "pkg-v1.4.5-mc1.21.8" = _hniCYjVF;
        "pkg-v1.4.5-mc1.21.3" = _i9vKIRcK;
        "pkg-v1.4.5-mc1.21.1" = _Ub7iKSfM;
        "pkg-v1.4.5-mc1.21" = _auY60U5D;
        "pkg-v1.4.5-mc1.19.2" = _6wBSiiYt;
        "pkg-v1.4.5-mc1.20" = _9sLELxlo;
        "pkg-v1.4.5-mc1.21.5" = _G682Za5h;
        "pkg-v1.4.5-mc1.19" = _H2oc2TVY;
        "pkg-v1.4.5-mc1.20.6" = _Qk8nqRjF;
        "pkg-v1.4.5-mc1.20.4" = _1i4Lsf99;
        "pkg-v1.4.5-mc1.21.9" = _bKM5vOec;
        "pkg-v1.4.5-mc1.21.7" = _oyREQ9nj;
        "pkg-v1.4.6-mc1.21.9" = _1twnTWUD;
        "pkg-v1.4.6-mc1.21.8" = _1YOvE4Tf;
        "pkg-v1.4.6-mc1.21.7" = _pGuQiWyI;
        "pkg-v1.4.6-mc1.20.6" = _9OwEpxgr;
        "pkg-v1.4.6-mc1.21.2" = _V2wqhOqK;
        "pkg-v1.4.6-mc1.21.4" = _YZYrzNWZ;
        "pkg-v1.4.6-mc1.19" = _Y32Gp193;
        "pkg-v1.4.6-mc1.21" = _hNWx89Oa;
        "pkg-v1.4.6-mc1.20" = _c6OMh5yx;
        "pkg-v1.4.6-mc1.19.3" = _EWO4lttU;
        "pkg-v1.4.6-mc1.19.4" = _65YSzYS5;
        "pkg-v1.4.6-mc1.19.2" = _DOnyZQEe;
        "pkg-v1.4.6-mc1.19.1" = _m8BrT4BT;
        "pkg-v1.4.6-mc1.20.3" = _DooZv7fm;
        "pkg-v1.4.6-mc1.21.6" = _VRnQf9uf;
        "pkg-v1.4.6-mc1.20.1" = _m3QucJgO;
        "pkg-v1.4.6-mc1.21.10" = _zttdLjN6;
        "pkg-v1.4.6-mc1.20.4" = _TNCIvqWh;
        "pkg-v1.4.6-mc1.21.3" = _gIGkqEbO;
        "pkg-v1.4.6-mc1.21.5" = _hVcIBcXA;
        "pkg-v1.4.6-mc1.21.1" = _kI8xZo7N;
        "pkg-v1.4.6-mc1.20.5" = _4GSk8Izb;
        "pkg-v1.4.6-mc1.20.2" = _BuQo4vJo;
        "pkg-v1.4.7-mc1.21.1" = _bxaJZTiw;
        "pkg-v1.4.7-mc1.20.4" = _OMtMjtza;
        "pkg-v1.4.7-mc1.21.9" = _tCTPdzu3;
        "pkg-v1.4.7-mc1.19.4" = _KeS3E5CI;
        "pkg-v1.4.7-mc1.19.1" = _1g9lcA5t;
        "pkg-v1.4.7-mc1.19.2" = _2eJ5c04Y;
        "pkg-v1.4.7-mc1.20" = _mDHoxYuy;
        "pkg-v1.4.7-mc1.21.7" = _uZ4NgW3f;
        "pkg-v1.4.7-mc1.20.5" = _k5bLXdnU;
        "pkg-v1.4.7-mc1.21.5" = _qyawIhqu;
        "pkg-v1.4.7-mc1.21.2" = _rwgwHtjG;
        "pkg-v1.4.7-mc1.20.6" = _Btm56wgs;
        "pkg-v1.4.7-mc1.20.2" = _LGIHjGoz;
        "pkg-v1.4.7-mc1.21.8" = _5GCK34kU;
        "pkg-v1.4.7-mc1.21" = _K7eD3Jgm;
        "pkg-v1.4.7-mc1.20.3" = _zylrCwIb;
        "pkg-v1.4.7-mc1.21.3" = _6ejIfefu;
        "pkg-v1.4.7-mc1.21.10" = _KEbUHwuK;
        "pkg-v1.4.7-mc1.19" = _UuKV77YM;
        "pkg-v1.4.7-mc1.19.3" = _h0T6SSg3;
        "pkg-v1.4.7-mc1.21.6" = _EB3PkhWU;
        "pkg-v1.4.7-mc1.21.4" = _LQquMT8l;
        "pkg-v1.4.7-mc1.20.1" = _pzLTIUUQ;
        "pkg-v1.4.8-mc1.19.4" = _H4OSejVB;
        "pkg-v1.4.8-mc1.21.1" = _Wc7lHfMJ;
        "pkg-v1.4.8-mc1.19.2" = _Ui2pZyhP;
        "pkg-v1.4.8-mc1.21.10" = _3PhZagPy;
        "pkg-v1.4.8-mc1.20.4" = _BxOW5LFu;
        "pkg-v1.4.8-mc1.20.1" = _2C1EQhoG;
        "pkg-v1.4.8-mc1.19.3" = _6U0ExMLX;
        "pkg-v1.4.8-mc1.21.8" = _p2GHkh20;
        "pkg-v1.4.8-mc1.20.3" = _pquMT51a;
        "pkg-v1.4.8-mc1.21.2" = _trMoiNfH;
        "pkg-v1.4.8-mc1.20.5" = _JCBxNqlU;
        "pkg-v1.4.8-mc1.21.6" = _ELUI4K7L;
        "pkg-v1.4.8-mc1.21.4" = _aOF6GN0x;
        "pkg-v1.4.8-mc1.21.9" = _e06a4Pwx;
        "pkg-v1.4.8-mc1.21.3" = _eTk4uIRD;
        "pkg-v1.4.8-mc1.20" = _HGrqCCpG;
        "pkg-v1.4.8-mc1.19.1" = _lkfH2pA5;
        "pkg-v1.4.8-mc1.21.5" = _Jp8O1Rbn;
        "pkg-v1.4.8-mc1.20.2" = _KeT68zHG;
        "pkg-v1.4.8-mc1.21" = _ShXROE3d;
        "pkg-v1.4.8-mc1.19" = _OWJRCOLg;
        "pkg-v1.4.8-mc1.21.7" = _yfyRzQrG;
        "pkg-v1.4.8-mc1.20.6" = _PUI8R4Yd;
        "pkg-v1.4.8-mc1.21.11" = _cUQ3qalt;
        "pkg-v1.4.9-mc1.19.2" = _ky1MBQqe;
        "pkg-v1.4.9-mc1.21.6" = _YdFDdjwc;
        "pkg-v1.4.9-mc1.20.1" = _5lQley66;
        "pkg-v1.4.9-mc1.21.5" = _XxZzkIWH;
        "pkg-v1.4.9-mc1.19.4" = _r1TJxp2E;
        "pkg-v1.4.9-mc1.19" = _xl1BtfEB;
        "pkg-v1.4.9-mc1.21.10" = _7yyngRmB;
        "pkg-v1.4.9-mc1.21.3" = _BldHdwAu;
        "pkg-v1.4.9-mc1.21.9" = _PKxp3y5c;
        "pkg-v1.4.9-mc1.21.4" = _FYZLx4nc;
        "pkg-v1.4.9-mc1.21.11" = _VKgAl4s6;
        "pkg-v1.4.9-mc1.20.2" = _u0xNUaIV;
        "pkg-v1.4.9-mc26.1" = _TBVquG4H;
        "pkg-v1.4.9-mc1.21" = _SOC8I90n;
        "pkg-v1.4.9-mc1.20.4" = _ZGBp28G5;
        "pkg-v1.4.9-mc1.20.5" = _uwPkQ4CJ;
        "pkg-v1.4.9-mc1.20.3" = _VQmslHpD;
        "pkg-v1.4.9-mc1.21.8" = _MGA9HrcU;
        "pkg-v1.4.9-mc1.21.7" = _YeosZv3b;
        "pkg-v1.4.9-mc1.19.1" = _MnpSMFeX;
        "pkg-v1.4.9-mc1.19.3" = _OvoGQKIi;
        "pkg-v1.4.9-mc1.21.2" = _U20aj76c;
        "pkg-v1.4.9-mc1.21.1" = _azH0BUt8;
        "pkg-v1.4.9-mc1.20" = _6nzAQ2U6;
        "pkg-v1.4.9-mc1.20.6" = _tEXCuabD;
        "pkg-v1.4.10-mc1.21" = _UlnIaMx2;
        "pkg-v1.4.10-mc1.20.6" = _JA7gz2Qy;
        "pkg-v1.4.10-mc1.20.4" = _MD0pm3vd;
        "pkg-v1.4.10-mc26.1" = _XTRNV1Gl;
        "pkg-v1.4.10-mc1.20" = _UAFKUVES;
        "pkg-v1.4.10-mc1.19.2" = _6NKelmFB;
        "pkg-v1.4.10-mc1.21.1" = _EgyminrN;
        "pkg-v1.4.10-mc1.20.5" = _LlG7bUtc;
        "pkg-v1.4.10-mc1.21.8" = _8kfyHrl2;
        "pkg-v1.4.10-mc1.21.9" = _SMA9iFCb;
        "pkg-v1.4.10-mc1.19" = _ZbwoeofL;
        "pkg-v1.4.10-mc1.21.11" = _lk6u2rqe;
        "pkg-v1.4.10-mc1.21.10" = _xIyFxzRV;
        "pkg-v1.4.10-mc1.21.4" = _q9DhI9AZ;
        "pkg-v1.4.10-mc1.20.2" = _L5W8dXfL;
        "pkg-v1.4.10-mc1.19.4" = _oOPk38QS;
        "pkg-v1.4.10-mc1.20.3" = _ZxFKM6ni;
        "pkg-v1.4.10-mc1.21.2" = _c7t2pnFI;
        "pkg-v1.4.10-mc1.21.5" = _cgdX6TCv;
        "pkg-v1.4.10-mc1.19.1" = _MROylRUy;
        "pkg-v1.4.10-mc1.21.6" = _wswJqcNV;
        "pkg-v1.4.10-mc1.21.3" = _nmTI8IIf;
        "pkg-v1.4.10-mc1.19.3" = _WCupv71y;
        "pkg-v1.4.10-mc1.21.7" = _IX5GTZsI;
        "pkg-v1.4.10-mc1.20.1" = _vFGpOW5t;
        "pkg-v1.5.0-mc1.20.5" = _kWu6e60g;
        "pkg-v1.5.0-mc1.19.2" = _IZ8Ww3di;
        "pkg-v1.5.0-mc1.20.4" = _4GkT1FOI;
        "pkg-v1.5.0-mc1.19.3" = _933X5fuv;
        "pkg-v1.5.0-mc1.20.2" = _ATohl1Ja;
        "pkg-v1.5.0-mc1.20.6" = _pJScNXKm;
        "pkg-v1.5.0-mc1.21.11" = _N15vr5p2;
        "pkg-v1.5.0-mc1.21.1" = _3GfKltte;
        "pkg-v1.5.0-mc1.21.7" = _wMxeF7OP;
        "pkg-v1.5.0-mc26.1" = _7L0IPqQJ;
        "pkg-v1.5.0-mc1.20.3" = _Sn40ZeUf;
        "pkg-v1.5.0-mc1.19.1" = _i3J1Ofqo;
        "pkg-v1.5.0-mc1.20" = _ksiZLsaQ;
        "pkg-v1.5.0-mc1.19.4" = _ejR69wpp;
        "pkg-v1.5.0-mc1.20.1" = _9KFea8WR;
        "pkg-v1.5.0-mc1.21.9" = _POIBI6ev;
        "pkg-v1.5.0-mc1.21.3" = _7Z5C0z6L;
        "pkg-v1.5.0-mc1.21.6" = _zhGLiSpW;
        "pkg-v1.5.0-mc1.21.8" = _pqdy5Ot6;
        "pkg-v1.5.0-mc1.19" = _srYaDqAW;
        "pkg-v1.5.0-mc1.21.2" = _Z3iP2UBk;
        "pkg-v1.5.0-mc1.21.10" = _su9ei7lh;
        "pkg-v1.5.0-mc1.21.5" = _BMKa6giQ;
        "pkg-v1.5.0-mc1.21" = _eI4pOciY;
        "pkg-v1.5.0-mc1.21.4" = _Bvm9F2Wr;
        "pkg-v1.5.1-mc1.21" = _bS4fETYE;
        "pkg-v1.5.1-mc1.21.4" = _DRmIjm72;
        "pkg-v1.5.1-mc1.21.2" = _U5UbvugM;
        "pkg-v1.5.1-mc1.20.1" = _GBxtgeAN;
        "pkg-v1.5.1-mc1.21.7" = _eQFhtCaN;
        "pkg-v1.5.1-mc1.19.3" = _peY7G1sM;
        "pkg-v1.5.1-mc1.21.10" = _w9lySOa7;
        "pkg-v1.5.1-mc1.21.5" = _ObGeLzxO;
        "pkg-v1.5.1-mc1.21.9" = _rEflsbZk;
        "pkg-v1.5.1-mc1.21.11" = _sMor99aD;
        "pkg-v1.5.1-mc1.21.6" = _wkkaCSVQ;
        "pkg-v1.5.1-mc1.20" = _pPz450la;
        "pkg-v1.5.1-mc1.20.4" = _mc3MVNYe;
        "pkg-v1.5.1-mc26.1" = _Z40uesg4;
        "pkg-v1.5.1-mc1.20.3" = _Y1am14lZ;
        "pkg-v1.5.1-mc1.20.5" = _ZdF3bE44;
        "pkg-v1.5.1-mc1.20.2" = _FiP8KBV6;
        "pkg-v1.5.1-mc1.19.2" = _1842UWQJ;
        "pkg-v1.5.1-mc1.20.6" = _SuivdR4H;
        "pkg-v1.5.1-mc1.21.1" = _izMc9y4j;
        "pkg-v1.5.1-mc1.21.3" = _ALBAk6OO;
        "pkg-v1.5.1-mc1.19.1" = _G3Yvzi05;
        "pkg-v1.5.1-mc1.21.8" = _oZUfBDOM;
        "pkg-v1.5.1-mc1.19.4" = _FiGCS3tM;
        "pkg-v1.5.1-mc1.19" = _49i3CD73;
        "pkg-v1.5.2-mc1.20.3" = _4508jEZz;
        "pkg-v1.5.2-mc1.20.2" = _i3snM3Dc;
        "pkg-v1.5.2-mc1.19" = _cfcJzfVz;
        "pkg-v1.5.2-mc1.21.5" = _ueTioKFh;
        "pkg-v1.5.2-mc1.21.7" = _wRu4eMRC;
        "pkg-v1.5.2-mc1.19.1" = _m4tPpM8i;
        "pkg-v1.5.2-mc1.19.4" = _Q98Hktqm;
        "pkg-v1.5.2-mc1.21.2" = _Mf59uZ6z;
        "pkg-v1.5.2-mc1.19.3" = _WzoDur4w;
        "pkg-v1.5.2-mc1.21.8" = _wigm2AAl;
        "pkg-v1.5.2-mc1.19.2" = _XHtN6HFd;
        "pkg-v1.5.2-mc1.21.6" = _T3ZOzj1A;
        "pkg-v1.5.2-mc1.21.4" = _m5DnhSyT;
        "pkg-v1.5.2-mc1.20.6" = _UOCnZdpU;
        "pkg-v1.5.2-mc1.20.1" = _Pzh5568H;
        "pkg-v1.5.2-mc1.20" = _KlqTzoYI;
        "pkg-v1.5.2-mc1.20.4" = _yQpzxsUb;
        "pkg-v1.5.2-mc1.21.1" = _XYMDJp7r;
        "pkg-v1.5.2-mc1.21" = _IKDaMRk2;
        "pkg-v1.5.2-mc26.1" = _KPdL6YpF;
        "pkg-v1.5.2-mc1.21.9" = _3zbtcZ0b;
        "pkg-v1.5.2-mc1.20.5" = _IU0RvT3X;
        "pkg-v1.5.2-mc1.21.10" = _mqVFBtJq;
        "pkg-v1.5.2-mc1.21.3" = _E8IeGJ3z;
        "pkg-v1.5.2-mc1.21.11" = _npgzeAiG;
        "pkg-v1.5.2-mc26.2" = _JVqbyyj3;
        "pkg-v1.5.3-mc1.19.3" = _ZYg6GXxn;
        "pkg-v1.5.3-mc1.21" = _DjfdBy8P;
        "pkg-v1.5.3-mc1.20.4" = _GDgctv9g;
        "pkg-v1.5.3-mc1.20" = _tD4ONdfJ;
        "pkg-v1.5.3-mc1.21.5" = _O9XsySu1;
        "pkg-v1.5.3-mc1.19" = _gwk8jW93;
        "pkg-v1.5.3-mc1.21.11" = _pJHQYKZm;
        "pkg-v1.5.3-mc1.21.9" = _WZ0BUIwt;
        "pkg-v1.5.3-mc1.19.1" = _egnDRIgJ;
        "pkg-v1.5.3-mc1.21.3" = _J5HgrUX1;
        "pkg-v1.5.3-mc1.21.1" = _BWn3YO9k;
        "pkg-v1.5.3-mc1.19.2" = _zch04alg;
        "pkg-v1.5.3-mc1.19.4" = _ZX86yzrm;
        "pkg-v1.5.3-mc1.21.10" = _odzSbSKc;
        "pkg-v1.5.3-mc1.21.7" = _yZWKmHIE;
        "pkg-v1.5.3-mc1.21.6" = _FUyj1i7O;
        "pkg-v1.5.3-mc1.20.2" = _fcvtSaxv;
        "pkg-v1.5.3-mc1.21.8" = _kqssykeH;
        "pkg-v1.5.3-mc26.1" = _vV5365jz;
        "pkg-v1.5.3-mc1.20.6" = _67RMPImE;
        "pkg-v1.5.3-mc1.20.1" = _2FSjO6gB;
        "pkg-v1.5.3-mc1.20.3" = _RolC5Q6X;
        "pkg-v1.5.3-mc1.21.2" = _lIHgKvom;
        "pkg-v1.5.3-mc1.20.5" = _jXbKYVME;
        "pkg-v1.5.3-mc1.21.4" = _wSc63buw;
        "pkg-v1.5.3-mc26.2" = _AG00otSU;
        "pkg-v1.5.4-mc1.19.3" = _7V3LENPB;
        "pkg-v1.5.4-mc1.21.11" = _BYA8UrRu;
        "pkg-v1.5.4-mc1.20.5" = _BfIyccB6;
        "pkg-v1.5.4-mc1.20.3" = _LItPrdo3;
        "pkg-v1.5.4-mc1.21.5" = _gEl0yhmQ;
        "pkg-v1.5.4-mc1.21.1" = _XJ2xxslB;
        "pkg-v1.5.4-mc26.1" = _lnhP4saM;
        "pkg-v1.5.4-mc1.19.2" = _LcAHOcOp;
        "pkg-v1.5.4-mc1.20.2" = _BPJviyAO;
        "pkg-v1.5.4-mc1.21.8" = _sUZXL11F;
        "pkg-v1.5.4-mc1.19.1" = _ovG2NorX;
        "pkg-v1.5.4-mc26.2" = _l7cZW8Cq;
        "pkg-v1.5.4-mc1.21" = _AgA0lzu5;
        "pkg-v1.5.4-mc1.19.4" = _SV31AFsj;
        "pkg-v1.5.4-mc1.21.10" = _CGzSCcPW;
        "pkg-v1.5.4-mc1.21.7" = _2BWkHAmP;
        "pkg-v1.5.4-mc1.21.4" = _JEJgRwiB;
        "pkg-v1.5.4-mc1.20" = _QTqYOs13;
        "pkg-v1.5.4-mc1.20.6" = _9nXcyqeA;
        "pkg-v1.5.4-mc1.21.3" = _zcTpJfUj;
        "pkg-v1.5.4-mc1.20.4" = _qkCgWzEW;
        "pkg-v1.5.4-mc1.21.9" = _XH1MDFkj;
        "pkg-v1.5.4-mc1.20.1" = _sxff2aPd;
