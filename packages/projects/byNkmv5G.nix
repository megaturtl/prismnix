...
let
    versions = (let
        ...
        _7gR3CqIs = {
            "id" = "7gR3CqIs";
            "file" = "SkyHanni-7.42.0-mc26.1.jar";
            "hash" = "sha512-liJMMC7t3veZgx52DZRaUPX5I7+s7O3L/H8avVeXKN2CAKMWaO5aNNZB0ar0AMzatter/nVCvwiCUFAso/t0rg==";
        };
        _oFigt67j = {
            "id" = "oFigt67j";
            "file" = "SkyHanni-7.42.0-mc1.21.11.jar";
            "hash" = "sha512-UvQ5SKoLIkvW7AyeFBvmJkVmv/YQ9X0Acd1gnpf1XkUJ6E3lVahXOI3JTwwqmy1H70utj6o7yLrbfVMLSNSTdw==";
        };
        _Jk33EqTC = {
            "id" = "Jk33EqTC";
            "file" = "SkyHanni-7.43.0-mc26.1.jar";
            "hash" = "sha512-ByLdThJ5zz2QHxInhdDrqvGrrDsZhEfV6vhnmqL9MDyBAl6On4NsIliUMGbzD3/N96rTFJ+wdnebRylvH0MBLw==";
        };
        _Shd8uu5Z = {
            "id" = "Shd8uu5Z";
            "file" = "SkyHanni-7.44.0-mc26.1.jar";
            "hash" = "sha512-SVERITyijf3S63dPmvKdGFZ0lRNFlOLnih5LEj9Mb+Z+LpGYhgB7xHaYhtBw3j7hbAYJy+bTOuN5/7dVdSR6fQ==";
        };
        _ECR0xuxp = {
            "id" = "ECR0xuxp";
            "file" = "SkyHanni-7.45.0-mc26.1.jar";
            "hash" = "sha512-L5GTp7JW9ykD0cKjw3pueuMbAK2TJuEvoKp/ODyHLZb5udnOK3h8PC++8cDUzK+1XtaWs4gIF2VgJOIXIvYEbw==";
        };
        _ME91JJhe = {
            "id" = "ME91JJhe";
            "file" = "SkyHanni-7.46.0-mc26.1.jar";
            "hash" = "sha512-VA/ix5s77uH+q4285E41k1zKzDBsDc1KBezOAoosRTpl9ZhpUsd6bkn2s90UBlt0xsZ3witxjTS+8529kO+Eew==";
        };
        _WJyxJxPN = {
            "id" = "WJyxJxPN";
            "file" = "SkyHanni-7.47.0-mc26.1.jar";
            "hash" = "sha512-gdxmeT4fKNvBotlz9/eDqhjvLoSh2cyzYd4GO6QiJ7DmReA0aNp4gCHFdAVPCV+coNPYNH3wh0EMLR3lNzioyw==";
        };
        _aARfJswC = {
            "id" = "aARfJswC";
            "file" = "SkyHanni-7.47.0-mc26.2.jar";
            "hash" = "sha512-UszNMuHGsWSl1XtogtnhmRWAlslc2cQePz0bIaMkjF1WsOcvug+9ElrGlxEjlOzKTPx4QNLi4RL/6iEr775C4Q==";
        };
        _KREd9Yk8 = {
            "id" = "KREd9Yk8";
            "file" = "SkyHanni-7.48.0-mc26.1.jar";
            "hash" = "sha512-KHdTUu61xTm5QTUeMA/Dh5u1QvFWALHb/jtQhrgv+3C9MM7Ez/U/oFTIdJkTZlquweHSGvQcOaOF8xZjT3v1sA==";
        };
        _HWpPZGho = {
            "id" = "HWpPZGho";
            "file" = "SkyHanni-7.48.0-mc26.2.jar";
            "hash" = "sha512-fr4E1MhuZ8orzOXbvZNDUCKdgBN4oNaUIxXaIJsbgWrh080YRCpbgKmGeoeFfGmJPaZIke6AcRqNexRH5A6YOw==";
        };
        _oYS1qKJX = {
            "id" = "oYS1qKJX";
            "file" = "SkyHanni-7.49.0-mc26.1.jar";
            "hash" = "sha512-nF2ig5rcW3mAM81KV1O+JJenRFSwk0dfrIJzzDUoWAMVMWStW5C6PaCsTb1PF4ug5WMoLSXUFfSJrHLyVJj1lA==";
        };
        _6ptbCdrE = {
            "id" = "6ptbCdrE";
            "file" = "SkyHanni-7.49.0-mc26.2.jar";
            "hash" = "sha512-tGpN4w0KFEki6lqnWE5Me+2QVzHo57T/L36Fak1bA6Yv2agHQQavWX1wOQdOBVaKWcncu85gp9jjk+KtNuAIoQ==";
        };
        _jH8OYObh = {
            "id" = "jH8OYObh";
            "file" = "SkyHanni-7.50.0-mc26.1.jar";
            "hash" = "sha512-UvN6kKwNAdwL0SZuDL8Z3to7KlTQi7O+mhoOpyDKJIyxYL7scle2EQ1Ee/XTgrdSD/4AxrB3yEYAL/Fn8FdiBw==";
        };
        _MqJtbhuf = {
            "id" = "MqJtbhuf";
            "file" = "SkyHanni-7.50.0-mc26.2.jar";
            "hash" = "sha512-60x53fITPNipohDzgZGPXsWP+6WMh4t3tCjx6WXWvs1jXNLVxz5bx3pIXHCJPYmDhHOL5XCk64/LqTMojBapWw==";
        };
        _tQUWPVzg = {
            "id" = "tQUWPVzg";
            "file" = "SkyHanni-7.51.0-mc26.1.jar";
            "hash" = "sha512-qPdnp7p2KSHTWpHgoyTJ+Kw5NA4LTKfPAjok/a3MFybnH9wEpWGWRanCSufuaUGU76v22I41lhpJyX5snU0bfQ==";
        };
        _88CNXwTQ = {
            "id" = "88CNXwTQ";
            "file" = "SkyHanni-7.51.0-mc26.2.jar";
            "hash" = "sha512-xk2HN5EdcfckNSxOUU8tvgAHz7amzGG7Svqaz3HIsBykNshP//SewTR//MC/EqrYCX3GIH1H746hnZwOfYTQ6g==";
        };
        _fxLATOFA = {
            "id" = "fxLATOFA";
            "file" = "SkyHanni-7.52.0-mc26.1.jar";
            "hash" = "sha512-RSzJtMw3vrcimlkDudux22kJaUnAzF/kUt6IR4EVM2nTMkjay+NFz4BI9nB0sR4rA/qoEr1GW+iZ89x6LaS5BQ==";
        };
        _35fZnKqP = {
            "id" = "35fZnKqP";
            "file" = "SkyHanni-7.52.0-mc26.2.jar";
            "hash" = "sha512-xtvOZwL0AmbUpTuYIGLL+k6HjgLJ0aV9CUEicH5lDlcEgmMXARcmXQhT8Os6pYYgqYc1gbEa9zeywQ0RSNr4UA==";
        };
        _H16Otevd = {
            "id" = "H16Otevd";
            "file" = "SkyHanni-7.53.0-mc26.1.jar";
            "hash" = "sha512-jtV7DFZWU9UoO3PB1t0QABHzfQFegk0vyy5lCY7nTdX0udivsajUKdgfiAoSbsHWVuuxNobW2aO8Svw9kDM+yQ==";
        };
        _ZmsMCG54 = {
            "id" = "ZmsMCG54";
            "file" = "SkyHanni-7.53.0-mc26.2.jar";
            "hash" = "sha512-MYJGJbgrWmStekzlbojbO0vjORNkvCsjGnOWdFHpLenJqS3ziHheJfBtVFUZgLHJazajg4tsAGJaDV+VQ4okWg==";
        };
        _UiVoPA2p = {
            "id" = "UiVoPA2p";
            "file" = "SkyHanni-7.54.0-mc26.1.jar";
            "hash" = "sha512-iPyRy9s8LVv+QAsLoy9fjqyjdHCNUXuUCodx6w7WEUEDpNNBxp3dAPD1CBupOD31jDqroGLUVcAxLQK+G798rQ==";
        };
        _dNjGZT7g = {
            "id" = "dNjGZT7g";
            "file" = "SkyHanni-7.54.0-mc26.2.jar";
            "hash" = "sha512-JdFaZ+S7OSUbtYxYE/vy9zDxiuqmS840wdvE41W5kOJQ5mIOiqhP2Oc+k/3b8Bp3Mk2/LN7FkB9uAeBPpfVibw==";
        };
        _oOFwRQYU = {
            "id" = "oOFwRQYU";
            "file" = "SkyHanni-7.55.0-mc26.1.jar";
            "hash" = "sha512-xY7j6PXVdHSwINjx/mYyxNoMZ63aKv6akuNggto2QouXHdVqj7dJgcIVgALZi7hCzsI0IStcSjYYPOrY7ksSmg==";
        };
        _dl18fu0f = {
            "id" = "dl18fu0f";
            "file" = "SkyHanni-7.55.0-mc26.2.jar";
            "hash" = "sha512-NoEP53Fq6GptS6PTSZ7uW9Xz9BlifxyF+lZEmiGI9Fle8h6vVnekrrGFM9ieEIMT6V4UfAtEe0frGKvQ5qUZ6A==";
        };
        _MnRBvQlm = {
            "id" = "MnRBvQlm";
            "file" = "SkyHanni-7.56.0-mc26.1.jar";
            "hash" = "sha512-ls1/YenOYL9vr+/UmmZLB3ywAqhogvmrXVKvee2/th6Ytjvg2XW3NuBjGLknfGDsd+BkEFDoB2a7R8Mv1LKvAg==";
        };
        _6807putL = {
            "id" = "6807putL";
            "file" = "SkyHanni-7.56.0-mc26.2.jar";
            "hash" = "sha512-0qhM2mrcVzCde2fCsYsjmuVDateV1USmSfB5mIibzbuQGGw+UkaVWW01wI88euxbMvr7tOyLlWH6vcARVkXyBg==";
        };
        _P9Xpl2Px = {
            "id" = "P9Xpl2Px";
            "file" = "SkyHanni-7.57.0-mc26.1.jar";
            "hash" = "sha512-WMT0UcxYOr1FfubSGQDbA9oxCQfZlwFSXM0v8Co2kD/2kmrzKAZ5Dxd4Cx9YCxOKqcSdk6QVKGiRbNmsJncJIA==";
        };
        _Sr6h8gnh = {
            "id" = "Sr6h8gnh";
            "file" = "SkyHanni-7.57.0-mc26.2.jar";
            "hash" = "sha512-7Zq2kYi1Rw1rtpe8B/JvA9Rlwp2zidMen/HsQ2K8RyAmRh4LARNIXYZjMBuR7Ymlq6EXvpSCeJKJh5yqYA+NXQ==";
        };
        _FxKnACkb = {
            "id" = "FxKnACkb";
            "file" = "SkyHanni-9.0.0-mc26.1.jar";
            "hash" = "sha512-dr66N/zX/sIs9j2V2VlM/jelht8j50qrUHnaukdzhVghQdIbYlxqS5JWQggH894a2YAnmskp+t8tkIClSf6Ovw==";
        };
        _YIQcPmgw = {
            "id" = "YIQcPmgw";
    ...
    in {
        ...
        "pkg-2.0.1" = _yFniMK5U;
        "pkg-3.0.0" = _4LbRUqIX;
        "pkg-3.10.0" = _ZlN5jIgb;
        "pkg-3.12.0" = _vLIgdglG;
        "pkg-3.13.0" = _53uSGRuc;
        "pkg-3.14.0" = _Bv3Ys25W;
        "pkg-3.15.0" = _NYA8RHrn;
        "pkg-3.16.0" = _Njpf7e7g;
        "pkg-3.17.0" = _jSCYsN7O;
        "pkg-3.18.0" = _Gulmik2r;
        "pkg-4.0.0" = _sC69WJz6;
        "pkg-4.1.0" = _d7B8sxqM;
        "pkg-4.2.0" = _1vJIt4Hc;
        "pkg-4.3.0" = _glCGOeVA;
        ...
        "pkg-4.8.0" = _xq4bVspY;
        "pkg-4.9.0" = _qaQLVmNB;
        "pkg-4.10.0" = _AJDDiZf0;
        "pkg-4.11.0" = _nNFL6CjA;
        "pkg-4.12.0" = _r3aO2bun;
        "pkg-4.13.0" = _sSsQ6bQ5;
        "pkg-4.14.0" = _OOmEfz5f;
        "pkg-4.15.0" = _uXixPRbt;
        "pkg-4.16.0" = _anG5dPq4;
        "pkg-4.17.0" = _HPjW9lKh;
        "pkg-4.18.0" = _QO5d2ORB;
        "pkg-4.19.0" = _XcrqjySB;
        "pkg-4.20.0" = _o4zv17sN;
        "pkg-4.21.0" = _KTVXI9Dh;
        "pkg-4.22.0" = _XSUKCjBh;
        "pkg-4.23.0" = _JoN0xX0p;
        "pkg-4.24.0" = _gLwFaLYA;
        "pkg-4.26.0" = _mTwzXLH7;
        "pkg-4.27.0" = _BIc7Jt3G;
        "pkg-5.0.0" = _mY19aaOo;
        "pkg-5.0.1" = _KjeCjtwa;
        "pkg-5.0.2" = _mgsR4guz;
        "pkg-5.1.0" = _Pt1zjzFR;
        ...
        "pkg-6.8.0" = _kztaJjrO;
        "pkg-6.9.0" = _BT3MWluZ;
        "pkg-6.10.0" = _m2aev9NO;
        "pkg-6.11.0" = _t1iT7XFK;
        "pkg-6.12.0" = _g0FOZYHM;
        "pkg-6.13.0" = _7pqoYbxz;
        "pkg-6.14.0" = _paJx0OF3;
        "pkg-6.15.0" = _pAojX7mA;
        "pkg-6.16.0" = _f109U3uk;
        "pkg-6.17.0" = _DglkbEiW;
        "pkg-6.18.0" = _CSBa1OTG;
        "pkg-6.19.0" = _tyiuperK;
        "pkg-6.20.0" = _izdHGOBV;
        "pkg-7.0.0" = _84E3TYyD;
        "pkg-7.1.0" = _x0K4Mczh;
        "pkg-7.2.0" = _Md1ZSSjR;
        "pkg-7.3.0" = _wUyYqBcf;
        ...
        "pkg-7.8.0" = _AIYt7z3F;
        "pkg-7.9.0" = _8xoQwXvV;
        "pkg-7.10.0" = _xkp9hCZT;
        "pkg-7.11.0" = _UszbB1o9;
        "pkg-7.12.0" = _7J5MBCvV;
        "pkg-7.13.0" = _yvYh00Zq;
        "pkg-7.14.0" = _7BuK5mAi;
        "pkg-7.15.0" = _cosLs9jw;
        "pkg-7.16.1" = _wbt5gHYE;
        "pkg-7.17.0" = _mSgNMOLQ;
        "pkg-7.18.0" = _SpVt7IXR;
        "pkg-7.19.0" = _NSYHw01z;
        "pkg-7.20.0" = _2IcmoyFE;
        "pkg-7.21.0" = _VDhg1XmH;
        "pkg-7.22.0" = _t8wHSaR9;
        "pkg-7.23.0" = _t65guMBy;
        "pkg-7.24.0" = _Aqj6DSE7;
        "pkg-7.25.0" = _CFF8KOMv;
        "pkg-7.26.0" = _W98wZD1J;
        "pkg-7.27.0" = _vwMnEMdJ;
        "pkg-7.28.0" = _9rqdBRaV;
        "pkg-7.29.0" = _nNSSRrko;
        "pkg-7.30.0" = _reUwRlAu;
        "pkg-7.31.0" = _Vx2sANPs;
        "pkg-7.32.0" = _hkY415Hz;
        "pkg-7.33.0" = _d8SLvpH3;
        "pkg-7.34.0" = _9ahLvFuW;
        "pkg-7.35.0" = _Ef6HLO1q;
        "pkg-7.36.0" = _AHyKg37k;
        "pkg-7.37.0" = _IAznUMxq;
        "pkg-7.38.0" = _j5y0h754;
        "pkg-7.39.0" = _DRGDJ40M;
        "pkg-7.40.0" = _ppYsCy0y;
        "pkg-7.41.0" = _jYnNuJvA;
        "pkg-7.42.0" = _oFigt67j;
        "pkg-7.43.0" = _Jk33EqTC;
        "pkg-7.44.0" = _Shd8uu5Z;
        "pkg-7.45.0" = _ECR0xuxp;
        "pkg-7.46.0" = _ME91JJhe;
        "pkg-7.47.0" = _aARfJswC;
        "pkg-7.48.0" = _HWpPZGho;
        "pkg-7.49.0" = _6ptbCdrE;
        "pkg-7.50.0" = _MqJtbhuf;
        "pkg-7.51.0" = _88CNXwTQ;
        "pkg-7.52.0" = _35fZnKqP;
        "pkg-7.53.0" = _ZmsMCG54;
        "pkg-7.54.0" = _dNjGZT7g;
        "pkg-7.55.0" = _dl18fu0f;
