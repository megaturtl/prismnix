...
let
    ...
    in {
        ...
        "pkg-1.8.0" = _sAdTqYON;
        "pkg-1.9.0" = _xzsT8tBp;
        "pkg-1.10.0" = _73BYehcr;
        "pkg-1.11.0" = _NRzO9Fdc;
        "pkg-1.12.0" = _kcrM42jk;
        "pkg-1.12.1" = _BihGErWJ;
        "pkg-1.13" = _CoxwsOm5;
        "pkg-1.14.0" = _4lqqbLCW;
        "pkg-1.14.1" = _jSN18pD5;
        "pkg-1.15.0" = _9ZIvZMkS;
        "pkg-1.16.0" = _g3VOYKqc;
        "pkg-1.16.1" = _IJWXttZC;
        "pkg-1.16.2" = _fKnYBm9e;
        "pkg-1.17.0" = _YNRahwPM;
        "pkg-1.18.0" = _8oXYvspi;
        "pkg-1.18.1" = _YNAgnTcA;
        "pkg-1.18.2" = _spPHHpfM;
        "pkg-2.0.0" = _773OTmyx;
        "pkg-2.0.1" = _altSgOFb;
        "pkg-2.0.2" = _gWXlQsEI;
        "pkg-2.0.3" = _27mwUTY0;
