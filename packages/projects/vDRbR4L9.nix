...
let
    versions = (let
        ...
        _a27lDQjI = {
            "id" = "a27lDQjI";
            "file" = "shadowhunter22s-config-library-12.0.0+26.3.jar";
            "hash" = "sha512-6S0OXLUkXB4iFIEHQwjxR6a7PuPdg4kbYVwePx1v3RgRn/g0iCxHfMruVZ1Kg+5o9kfqvWMal4b+pQlcyrfQVA==";
        };
    in {
        "zopy33XV" = _zopy33XV;
        "WhOrG0CN" = _WhOrG0CN;
        ...
        "fabric-26.3" = _a27lDQjI;
        "pkg-0.1.0-beta+1.20" = _zopy33XV;
        "pkg-0.1.1-beta+1.20" = _WhOrG0CN;
        "pkg-0.1.2-beta+1.20" = _QbAGijOu;
        "pkg-1.0.0+1.20" = _Fjbyb1uP;
        "pkg-2.0.0+1.20.2" = _r8eCoXjx;
        "pkg-3.0.0+1.20.3" = _e5mCZcxW;
        "pkg-4.0.0+1.20.5" = _WRqWmzi7;
        "pkg-5.0.0+1.21" = _fA9lBCea;
        "pkg-6.0.0+1.21.2" = _uoGNhVKd;
        "pkg-2.0.1+1.20.2" = _ei6M08nK;
        "pkg-3.0.1+1.20.3" = _1X6bwNA3;
        "pkg-1.1.0+1.20" = _vZrkijOf;
        "pkg-2.1.0+1.20.2" = _SdSp2avA;
        "pkg-3.1.0+1.20.3" = _VCPbJQqF;
        "pkg-4.1.0+1.20.5" = _qsDlmqid;
        "pkg-5.1.0+1.21" = _RSriRVoL;
        "pkg-6.1.0+1.21.2" = _zk8mG5bp;
        "pkg-6.1.1+1.21.2" = _W920ELu1;
        "pkg-7.0.0+1.21.6" = _zHYIbQyo;
        "pkg-8.0.0+1.21.9" = _uFxrk5aH;
        "pkg-9.0.0+1.21.11" = _nVzBYOiI;
        "pkg-10.0.0+26.1" = _NrtpbxVx;
        "pkg-7.0.1+1.21.6" = _WDqt29Eo;
        "pkg-11.0.0-beta+26.2" = _uZ2u95qd;
        "pkg-11.0.0+26.2" = _XkFTV4mM;
        "pkg-12.0.0-beta+26.3" = _3TInI82U;
        "pkg-12.0.0+26.3" = _a27lDQjI;
        "default" = _a27lDQjI;
    });
