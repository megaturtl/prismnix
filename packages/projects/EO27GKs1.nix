...
let
    versions = (let
        ...
        _kRjsKEYr = {
            "id" = "kRjsKEYr";
            "file" = "jeed-1.20-2.2.6-fabric.jar";
            "hash" = "sha512-mZ98aWgBb10jUAGGIOtqdW99j0kpRId/M+aeVQAekj7I80bRUx3VFq14XYy2Al7GVy/Q/dNHVlLf6vJ+aHvnkg==";
        };
        _6zbEptBe = {
            "id" = "6zbEptBe";
            "file" = "jeed-1.20-2.2.6.jar";
            "hash" = "sha512-b+yZuxanQqd7tlPzVcBs0iHoDcEWT1i8Y2t447/Ke3Qd8nuAc6XhGRZemd6uVkgXOIfn0ol0T/J4ExgFxAgV8g==";
        };
        _FfzAeQjb = {
            "id" = "FfzAeQjb";
            "file" = "jeed-1.21.11-2.5.0-neoforge.jar";
            "hash" = "sha512-rCqIeMIJJSYhuhNZ2As9siS4f+8Zk3dm2/lzVXR4++RxiwJpGdBZFa640mxMbvPoA45+Y57SzyBZWPVGCT/S0A==";
        };
        _uo8mpHMe = {
            "id" = "uo8mpHMe";
            "file" = "jeed-1.21.11-2.5.0-fabric.jar";
            "hash" = "sha512-uLsVO8isoZHU44wbvpbbiZf7/6vCI5OjD3PKtlIj7dSbS0HkbTyh5RZ2h9dj5Wnm6u+aVsbVnH7/TwVlpNCVZQ==";
        };
        _wovtJlcb = {
            "id" = "wovtJlcb";
            "file" = "jeed-26.1.2-2.5.0-fabric.jar";
            "hash" = "sha512-uuDgqAlggep3wk7hoY+alh4uEMwTvTJzUcsRUYUkwY8RgWYSKf6kYLliSSsWuhvhxBa1vsqujufRgiGssPL8AA==";
        };
        _psqZH9Jj = {
            "id" = "psqZH9Jj";
    ...
    in {
        ...
        "pkg-23" = _YNcddmNT;
        "pkg-24" = _ITRSHIzZ;
        "pkg-1.19.2-2.0.1" = _ApH6uq6v;
        "pkg-1.19.2-2.1.0" = _LPtE5CBq;
        "pkg-1.19.2-2.1.1" = _OAXlzeot;
        "pkg-1.19.2-2.1.2" = _HKSwgNDX;
        "pkg-1.19.4-2.1.2" = _pO94hW31;
        "pkg-1.19.4-2.1.3" = _oXWuANww;
        "pkg-1.19.2-2.1.3" = _9Yc8OdQP;
        "pkg-1.19.4-2.1.4" = _RrddfUM7;
        "pkg-1.19.2-2.1.4" = _rs6dQpA4;
        "pkg-1.20-2.1.4" = _Hd8hTly8;
        "pkg-1.20-2.1.5" = _xX035dS2;
        "pkg-1.20-2.1.6" = _E0zeBCwl;
        "pkg-1.20-2.1.7" = _MvsIQcSo;
        "pkg-1.20-2.1.8" = _7jxogCuw;
        "pkg-1.20-2.1.9" = _NRHsvP36;
        "pkg-1.20-2.1.10" = _s9kg2Qzr;
        "pkg-1.20-2.1.11" = _WhueCHDu;
        "pkg-1.20-2.1.12" = _rONG0iY3;
        "pkg-1.20-2.2.0" = _FRC6noHL;
        "pkg-1.20-2.2.1" = _cCbKMLHm;
        "pkg-1.21-2.2.0" = _NDp0948D;
        "pkg-1.21-2.2.1" = _w0yY38Fh;
        "pkg-1.21-2.2.2" = _QoPDWn5c;
        "pkg-1.21-2.2.3" = _zD08VX19;
        "pkg-1.21-2.2.4" = _OeRUEqVC;
        "pkg-1.21-2.2.5" = _f8sQIewK;
        "pkg-1.20-2.2.2" = _UsKXS9eh;
        "pkg-1.21-2.2.6" = _NLTVj39H;
        "pkg-1.21-2.2.7" = _OStJ1VzV;
        "pkg-1.21-2.2.8" = _2GaZDdar;
        "pkg-1.21-2.2.9" = _m7gSD9ey;
        "pkg-1.20-2.2.3" = _5B7y9S7R;
        "pkg-1.21-2.2.10" = _wnL9DAO6;
        "pkg-1.21-2.2.11" = _Ezvy15to;
        "pkg-1.20-2.2.4" = _ZuF7fAUy;
        "pkg-1.21-2.2.12" = _1p77EY0O;
        "pkg-1.21-2.2.13" = _OphhSR8E;
        "pkg-1.20-2.2.5" = _jHYonbva;
        "pkg-1.21-2.2.14" = _XgM82oEy;
        "pkg-1.21-2.2.15" = _u4YxcadL;
        "pkg-1.21-2.2.16" = _fwht3KQn;
        "pkg-1.21-2.2.17" = _r0tKsRZd;
        "pkg-1.21-2.2.18" = _VSSPHpel;
        "pkg-1.21-2.2.19" = _qgMwgVRF;
        "pkg-1.21-2.3.0" = _zBsbdMmw;
        "pkg-1.21-2.3.1" = _uhT8AByn;
        "pkg-1.21-2.3.2" = _ACRqKDcv;
        "pkg-26.1.2-2.4.0" = _NxTWzDq9;
        "pkg-26.1.2-2.4.1" = _IhSy3h5V;
        "pkg-26.1.2-2.4.2" = _2hF7h4lP;
        "pkg-1.21-2.3.3" = _yfyTcGmb;
        "pkg-1.21.11-2.4.2" = _U9Hw48tf;
