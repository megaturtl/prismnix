...
let
    versions = (let
        ...
        _GqSTPgfI = {
            "id" = "GqSTPgfI";
            "file" = "onebar-5.3.0.jar";
            "hash" = "sha512-ujo4lJsGwY9U4oVD395SWlYwBo8qCJzfArwSYoNG3vrRnDcuwWYma1Y4tmgM+Ujq0kYgqErvhUqNxUkTaU1esw==";
        };
        _N21U2sTm = {
            "id" = "N21U2sTm";
