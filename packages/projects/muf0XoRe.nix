...
let
    versions = (let
        ...
        _jaRcykAY = {
            "id" = "jaRcykAY";
            "file" = "repurposed_structures-7.1.25+1.20.1-fabric.jar";
            "hash" = "sha512-9Zz0C9aH6bbolRDztxMOBHyxqvqp2XQVebJJ/lS/ucNmUejbc2VLSUV3rDVourdXFKgEyenehnv5Xp7i9v+ebQ==";
        };
        _JRMMCb1O = {
            "id" = "JRMMCb1O";
            "file" = "repurposed_structures-7.5.22+1.21.1-fabric.jar";
            "hash" = "sha512-IjePqLjM0mQPMD5t7p2GVsFdkCgTRtbaZ6x6rWsBOiUq6lmexqWM1eWptZhRjjQ/tELrDD4mI8ydCFjHlK2lWw==";
        };
        _qcp0GuuQ = {
            "id" = "qcp0GuuQ";
            "file" = "repurposed_structures-7.7.6+26.1-fabric.jar";
            "hash" = "sha512-al+Fl1gNVAb5sbPM28s2QJcClA17IYVovAwPG42CgzpfZEJLBwNniKpnpwEbHttwhw08q84RlKD6mKol7a6qyw==";
        };
        _CrmgMIJp = {
            "id" = "CrmgMIJp";
    ...
    in {
        ...
        "pkg-1.16.5-1.10.5-fabric" = _35dtx51R;
        "pkg-1.16.5-1.11.0-fabric" = _E2iWqSXl;
        "pkg-1.16.5-1.11.1-fabric" = _A4ZSc9XN;
        "pkg-1.16.5-1.11.2-fabric" = _Dmax49Od;
        "pkg-1.16.5-1.11.3-fabric" = _IgAGOh1h;
        "pkg-1.16.5-1.11.4-fabric" = _VKVkP6Jk;
        "pkg-1.16.5-1.11.5-fabric" = _WA7qPIfe;
        "pkg-2.0.0+1.17.0" = _JzePUPKQ;
        "pkg-2.0.1+1.17.0" = _zFb4dghk;
        "pkg-2.0.2+1.17.0" = _Jn08ZT9H;
        "pkg-1.16.5-1.11.6-fabric" = _5yP9SNTr;
        "pkg-2.0.3+1.17.0" = _Q15ewCnG;
        "pkg-2.0.5+1.17.1" = _Y4qPd6fm;
        "pkg-2.0.6+1.17.1" = _WTB6X40T;
        "pkg-2.1.0+1.17.1" = _uEWSNo9z;
        "pkg-2.1.1+1.17.1" = _dAeJw0gz;
        "pkg-2.1.2+1.17.1" = _E8m8cdYN;
        "pkg-2.1.4+1.17.1" = _WnumpTbU;
        "pkg-2.1.5+1.17.1" = _6Y73dMng;
        "pkg-2.1.6+1.17.1" = _NHQMkHAX;
        "pkg-2.1.7+1.17.1" = _xYQx55rz;
        "pkg-2.1.8+1.17.1" = _ZXPbIXqU;
        "pkg-2.1.9+1.17.1" = _dO8zzp76;
        "pkg-2.1.10+1.17.1" = _7HyMKcOR;
        "pkg-2.1.11+1.17.1" = _pXKdT8J1;
        "pkg-2.2.0+1.17.1" = _Hp3zNCHi;
        "pkg-2.2.1+1.17.1" = _uYLxUo0w;
        "pkg-2.2.2+1.17.1" = _9rYhtURC;
        "pkg-2.3.0+1.17.1" = _ijhsyQJW;
        "pkg-2.3.1+1.17.1" = _WY511Xye;
        "pkg-2.3.2+1.17.1" = _LibbrlRA;
        "pkg-2.3.3+1.17.1" = _VkcvApwP;
        "pkg-2.3.4+1.17.1" = _Q9t95S6K;
        "pkg-2.3.5+1.17.1" = _GL4KREuI;
        "pkg-2.3.6+1.17.1" = _BqQeZnPd;
        "pkg-2.3.7+1.17.1" = _uxrWPrNq;
        "pkg-2.3.8+1.17.1" = _gbTOjIDW;
        "pkg-2.3.9+1.17.1" = _DaoliEUQ;
        "pkg-2.4.0+1.17.1" = _aXWYK9dm;
        "pkg-2.4.1+1.17.1" = _6n0YfMae;
        "pkg-2.4.2+1.17.1" = _4y7pLbWm;
        "pkg-2.4.3+1.17.1" = _hE83o7o6;
        "pkg-2.4.4+1.17.1" = _GTMNoD82;
        "pkg-2.5.0+1.17.1" = _Ce3JdkUu;
        "pkg-2.5.1+1.17.1" = _9BTPaJCb;
        "pkg-2.5.2+1.17.1" = _woCUEPa1;
        "pkg-2.5.3+1.17.1" = _Kv8zCPAI;
        "pkg-2.5.4+1.17.1" = _ycPWa5oa;
        "pkg-2.5.5+1.17.1" = _KKc3hcdc;
        "pkg-2.5.6+1.17.1" = _FLbpPTUH;
        "pkg-2.5.7+1.17.1" = _F70cRVpm;
        "pkg-3.0.0+1.18-pre5" = _w2G6eO96;
        "pkg-3.0.1+1.18-rc3" = _HsKRhKTh;
        "pkg-3.0.2+1.18-rc3" = _E250qFte;
        "pkg-3.1.0+1.18-rc3" = _5ncbxBYc;
        "pkg-3.1.1+1.18-rc3" = _F85q1GQ4;
        "pkg-3.1.2+1.18.0" = _KwloMBmF;
        "pkg-3.1.3+1.18.0" = _yQbS2tXT;
        "pkg-3.1.4+1.18.0" = _p1poxtij;
        "pkg-3.1.5+1.18.0" = _BT2jwX10;
        "pkg-3.1.6+1.18.0" = _NXiDjUFA;
        "pkg-3.1.7+1.18.0" = _UfYhlKLS;
        "pkg-3.1.8+1.18.0" = _mjRrGqsz;
        "pkg-3.1.9+1.18.1" = _PCG3bWAW;
        "pkg-3.1.10+1.18.1" = _jwEScio6;
        "pkg-3.1.11+1.18.1" = _oWQa6nV0;
        "pkg-3.1.12+1.18.1" = _Lje82pJ7;
        "pkg-3.1.13+1.18.1" = _VrGXigty;
        "pkg-3.2.0+1.18.1" = _9BWcZtDI;
        "pkg-3.3.0+1.18.1" = _ADfl8WUh;
        "pkg-3.3.1+1.18.1" = _7UyHjyWS;
        "pkg-3.3.2+1.18.1" = _FJZWpP4F;
        "pkg-3.3.4+1.18.1" = _A40ugBKj;
        "pkg-3.3.6+1.18.1" = _kRDeyLfM;
        "pkg-3.3.7+1.18.1" = _CybQv2Yj;
        "pkg-3.3.8+1.18.1" = _DPhbA3zv;
        "pkg-3.3.9+1.18.1" = _hfIaM0WR;
        "pkg-3.3.10+1.18.1" = _MpfWG418;
        "pkg-3.3.11+1.18.1" = _bknOqCHj;
        "pkg-3.3.12+1.18.1" = _4sr6Y94P;
        "pkg-4.0.0+1.18.2" = _AOVK4K8u;
        "pkg-4.0.1+1.18.2" = _urVr7RhM;
        "pkg-4.0.2+1.18.2" = _Mab8p0XV;
        "pkg-4.1.0+1.18.2" = _t2HVy9DA;
        "pkg-4.1.1+1.18.2" = _UBaLE7SF;
        "pkg-4.1.2+1.18.2" = _2FM7n3oR;
        "pkg-4.1.3+1.18.2" = _AxQxycpQ;
        "pkg-4.1.5+1.18.2" = _K1Bb1c83;
        "pkg-4.1.6+1.18.2" = _hK7BolYG;
        "pkg-4.1.7+1.18.2" = _XoF5k3mY;
        "pkg-4.1.8+1.18.2" = _CGkSggJi;
        "pkg-4.1.9+1.18.2" = _vviXPWRq;
        "pkg-4.1.10+1.18.2" = _yYSCrgcw;
        "pkg-4.1.11+1.18.2" = _YIwaalDX;
        "pkg-4.1.12+1.18.2" = _Vf829t9B;
        "pkg-4.1.14+1.18.2" = _N5NgHkyr;
        "pkg-6.0.0+1.19" = _9oGWR6M4;
        "pkg-6.0.1+1.19" = _IztniRej;
        "pkg-6.0.2+1.19" = _AjWLUPV8;
        "pkg-6.0.3+1.19" = _dPCFR7yN;
        "pkg-6.0.4+1.19" = _sVGk3bX5;
        "pkg-6.0.5+1.19" = _OGvotiqt;
        "pkg-6.0.6+1.19" = _coQA1v6u;
        "pkg-6.0.7+1.19" = _RKDqqU4O;
        "pkg-6.0.8+1.19" = _9h2HQRvi;
        "pkg-6.1.0+1.19" = _mIzgHryB;
        "pkg-6.1.1+1.19" = _PLDOCP6C;
        "pkg-6.1.0+1.19+quilt" = _mGlMoc9F;
        "pkg-6.1.1+1.19+quilt" = _dgE3oMcH;
        "pkg-6.2.0+1.19.2+quilt" = _Q6AL8SxV;
        "pkg-6.2.1+1.19.2+quilt" = _dHt4hw7n;
        "pkg-6.2.2+1.19.2+quilt" = _XVakHClu;
        "pkg-6.2.3+1.19.2+quilt" = _tYzItxkG;
        "pkg-6.3.0+1.19.2+quilt" = _31HRd1iE;
        "pkg-6.3.1+1.19.2+quilt" = _gZH9qDLd;
        "pkg-6.3.2+1.19.2+quilt" = _ZZrAajq6;
        "pkg-6.1.2+1.19" = _N1wHVfRv;
        "pkg-6.3.3+1.19.2+quilt" = _tMCPTDng;
        "pkg-6.3.4+1.19.2+quilt" = _iG8Ypcsp;
        "pkg-6.3.5+1.19.2+quilt" = _zsbFcYgy;
        "pkg-6.3.6+1.19.2+quilt" = _DzFkGeO0;
        "pkg-4.1.15+1.18.2" = _IgOLXw7Q;
        "pkg-6.3.7+1.19.2+quilt" = _sbBNqh1o;
        "pkg-6.3.8+1.19.2+quilt" = _VBiVXMKq;
        "pkg-6.3.9+1.19.2+quilt" = _sMKowScu;
        "pkg-6.3.10+1.19.3+quilt" = _hkMpGFdt;
        "pkg-6.3.11+1.19.3+quilt" = _2T96DP3p;
        "pkg-6.1.4+1.19.3" = _EjcBNcsi;
        "pkg-6.1.3+1.19.2" = _Sq3mPEVJ;
        "pkg-6.3.1+1.19.3" = _mfzzEY2V;
        "pkg-6.3.12+1.19.3+quilt" = _RxLs3qRz;
        "pkg-6.1.4+1.19.2" = _ZhheiZx4;
        "pkg-6.3.10+1.19.2+quilt" = _vtYHuYkJ;
        "pkg-6.3.2+1.19.3+fabric" = _DUlHZpb5;
        "pkg-6.3.13+1.19.3+quilt" = _i3gosD9I;
        "pkg-6.3.14+1.19.3-fabric" = _pFzKEBz5;
        "pkg-6.3.14+1.19.3-quilt" = _QJyCKg8Q;
        "pkg-6.1.6+1.19.2" = _As9fMq7o;
        "pkg-6.3.11+1.19.2+quilt" = _RSxremwp;
        "pkg-6.3.15+1.19.3-fabric" = _dzjtahRW;
        "pkg-6.3.15+1.19.3-quilt" = _eecVZkni;
        "pkg-6.3.16+1.19.2+quilt" = _am2gm5sk;
        "pkg-6.3.16+1.19.2+fabric" = _ez14wVbu;
        "pkg-6.3.16+1.19.3-fabric" = _ThqtNnYb;
        "pkg-6.3.16+1.19.3-quilt" = _wmGyaJVE;
        "pkg-6.3.17+1.19.2+fabric" = _CPe9o7CM;
        "pkg-6.3.18+1.19.3-fabric" = _YdEqRckm;
        "pkg-6.3.17+1.19.2+quilt" = _n23dmp2J;
        "pkg-6.3.18+1.19.3-quilt" = _4uB2m0JP;
        "pkg-6.3.18+1.19.2+fabric" = _GN2vsPet;
        "pkg-6.3.18+1.19.2+quilt" = _MbKRdxX5;
        "pkg-6.3.19+1.19.3-fabric" = _y0husUen;
        "pkg-6.3.19+1.19.3-quilt" = _tsCcRryd;
        "pkg-6.3.19+1.19.4-fabric" = _kt9tyd8y;
        "pkg-6.3.19+1.19.4-quilt" = _TTOfssVq;
        "pkg-6.3.20+1.19.2+fabric" = _3GviBkmG;
        "pkg-6.3.20+1.19.2+quilt" = _Fpb1Npbq;
        "pkg-6.3.20+1.19.4-fabric" = _o1aokaUw;
        "pkg-6.3.20+1.19.4-quilt" = _4bqHFTpt;
        "pkg-6.3.21+1.19.2+fabric" = _LpuYRZ8i;
        "pkg-6.3.21+1.19.2+quilt" = _p01ZgFXM;
        "pkg-6.3.21+1.19.4-fabric" = _7m7Hx7K3;
        "pkg-6.3.21+1.19.4-quilt" = _efCY7VWf;
        "pkg-6.3.22+1.19.4-fabric" = _NVzCh0BE;
        "pkg-6.3.22+1.19.4-quilt" = _yj1DIllP;
        "pkg-6.3.23+1.19.4-quilt" = _2fZKLqRM;
        "pkg-6.3.24+1.19.2+quilt" = _Wv3yQoAh;
        "pkg-6.3.24+1.19.2+fabric" = _3vxgVHLo;
        "pkg-6.3.24+1.19.4-fabric" = _nWriSpKm;
        "pkg-6.3.24+1.19.4-quilt" = _idYNIP8G;
        "pkg-6.3.25+1.19.4-fabric" = _lkpc06Uc;
        "pkg-6.3.25+1.19.4-quilt" = _vD0XVIce;
        "pkg-7.0.0+1.20-fabric" = _axQ7XPoZ;
        "pkg-7.0.0+1.20-quilt" = _6PRi8DLN;
        "pkg-7.1.0+1.20.1-fabric" = _gwmCJFDP;
        "pkg-7.1.0+1.20.1-quilt" = _juNYXHbs;
        "pkg-7.1.1+1.20.1-fabric" = _grW3F5dO;
        "pkg-7.1.1+1.20.1-quilt" = _BmjEG72r;
        "pkg-7.1.2+1.20.1-fabric" = _hWifdziK;
        "pkg-7.1.2+1.20.1-quilt" = _Yp9S1Yia;
        "pkg-6.3.26+1.19.2+fabric" = _Kqm0nSMW;
        "pkg-6.3.26+1.19.2+quilt" = _iCDtxUaP;
        "pkg-7.1.3+1.20.1-fabric" = _CrHwNAud;
        "pkg-7.1.3+1.20.1-quilt" = _HSnVVOGG;
        "pkg-7.1.4+1.20.1-fabric" = _UUsn75P9;
        "pkg-7.1.4+1.20.1-quilt" = _xwLyuBKM;
        "pkg-7.1.5+1.20.1-fabric" = _VdQAzykP;
        "pkg-7.1.5+1.20.1-quilt" = _71vfmZQS;
        "pkg-7.1.6+1.20.1-fabric" = _SFLj7mfN;
        "pkg-7.1.6+1.20.1-quilt" = _zx21s0f2;
        "pkg-7.1.7+1.20.1-fabric" = _SHHipthG;
        "pkg-7.1.7+1.20.1-quilt" = _3vUlZOkO;
        "pkg-7.1.8+1.20.1-fabric" = _ncjaCbrl;
        "pkg-7.1.8+1.20.1-quilt" = _OJpvRn6p;
        "pkg-6.3.27+1.19.2+quilt" = _k9hRe80t;
        "pkg-7.1.9+1.20.1-fabric" = _WnrZpxNg;
        "pkg-6.3.28+1.19.2+quilt" = _K4HlreX3;
        "pkg-6.3.28+1.19.2+fabric" = _bxc0tyY5;
        "pkg-7.1.10+1.20.1-fabric" = _2jNzsnfc;
        "pkg-7.1.10+1.20.1-quilt" = _UlOoMXRb;
        "pkg-7.1.11+1.20.1-fabric" = _VxJqyOqo;
        "pkg-7.1.11+1.20.1-quilt" = _gWyMS104;
        "pkg-7.2.0+1.20.2-fabric" = _Trguc5g0;
        "pkg-7.2.1+1.20.2-fabric" = _VQUSPq2M;
        "pkg-7.2.2+1.20.3-fabric" = _piuKopqq;
        "pkg-7.2.2+1.20.4-fabric" = _N13lemXR;
        "pkg-7.2.4+1.20.4-fabric" = _wfu27gZE;
        "pkg-7.3.0+1.20.4-fabric" = _D7B8ZYMc;
        "pkg-7.3.1+1.20.4-fabric" = _uoUZYtkl;
        "pkg-7.1.12+1.20.1-fabric" = _XPHE3BcK;
        "pkg-7.1.12+1.20.1-quilt" = _E9ISQLuh;
        "pkg-7.3.2+1.20.4-fabric" = _ixCPaHf0;
        "pkg-7.1.13+1.20.1-fabric" = _k2A5VTDF;
        "pkg-7.1.13+1.20.1-quilt" = _FBZX2g2v;
        "pkg-7.3.3+1.20.4-fabric" = _tRkofIO1;
        "pkg-7.1.14+1.20.1-fabric" = _WqmnFKp9;
        "pkg-7.1.14+1.20.1-quilt" = _ZMocJ0mc;
        "pkg-7.3.4+1.20.4-fabric" = _qMa85PfD;
        "pkg-7.1.15+1.20.1-fabric" = _MuqUgLqO;
        "pkg-7.1.15+1.20.1-quilt" = _k5hMtMM5;
        "pkg-7.3.5+1.20.4-fabric" = _GqKmSBFV;
        "pkg-7.4.0+1.20.6-fabric" = _qrzdVdPK;
        "pkg-7.5.1+1.21-fabric" = _5a8QNDiP;
        "pkg-7.5.2+1.21-fabric" = _yiBZwcBJ;
        "pkg-7.5.3+1.21-fabric" = _SCBq1LMb;
        "pkg-7.5.4+1.21-fabric" = _ayr5NDIc;
        "pkg-7.5.5+1.21.1-fabric" = _HOszq7Us;
        "pkg-7.5.6+1.21.1-fabric" = _7Om6mrZd;
        "pkg-7.5.7+1.21.1-fabric" = _sHyle0j1;
        "pkg-6.3.29+1.19.2+fabric" = _ZrIT5PK7;
        "pkg-6.3.29+1.19.2+quilt" = _TajvjPIp;
        "pkg-4.1.16+1.18.2" = _Q7nQ7vdG;
        "pkg-7.5.8+1.21.1-fabric" = _jkd4kB95;
        "pkg-7.5.9+1.21.1-fabric" = _kyBAwt1N;
        "pkg-7.5.10+1.21.1-fabric" = _sYdqCzqY;
        "pkg-7.5.11+1.21.1-fabric" = _2kHf7ECU;
        "pkg-7.5.12+1.21.1-fabric" = _hiV92v7s;
        "pkg-7.5.13+1.21.4-fabric" = _d8GJlOgV;
        "pkg-7.5.13+1.21.1-fabric" = _DtIpRGTe;
        "pkg-7.5.15+1.21.4-fabric" = _SLFpJJdu;
        "pkg-7.5.17+1.21.5-fabric" = _xAM6Auy6;
        "pkg-7.1.17+1.20.1-fabric" = _rt7Podx9;
        "pkg-7.5.15+1.21.1-fabric" = _AQd0jYwh;
        "pkg-7.5.19+1.21.5-fabric" = _wXU1Y3cY;
        "pkg-7.1.18+1.20.1-fabric" = _Q88icklM;
        "pkg-7.5.19+1.21.6-fabric" = _Hpumx4ZI;
        "pkg-7.5.16+1.21.1-fabric" = _d1ndV3Co;
        "pkg-7.5.20+1.21.6-fabric" = _6lAKjCIy;
        "pkg-7.5.20+1.21.7-fabric" = _5QQ611TJ;
        "pkg-7.5.21+1.21.7-fabric" = _GrkVcTC3;
        "pkg-7.1.19+1.20.1-fabric" = _Dt9OIvgm;
        "pkg-7.5.17+1.21.1-fabric" = _Fl1vtnd3;
        "pkg-7.5.22+1.21.8-fabric" = _MkVAurws;
        "pkg-7.5.22+1.21.9-fabric" = _Qn9MHk0P;
        "pkg-7.6.0+1.21.11-fabric" = _roNP79dp;
        "pkg-7.5.18+1.21.1-fabric" = _L09cCecn;
        "pkg-7.6.1+1.21.11-fabric" = _plvrc4Gd;
        "pkg-7.1.21+1.20.1-fabric" = _27yUYgkT;
        "pkg-7.7.0+26.1-fabric" = _hM2Fbqsm;
        "pkg-7.6.2+1.21.11-fabric" = _LgshXq1u;
        "pkg-7.7.1+26.1-fabric" = _7h1TCyvJ;
        "pkg-7.5.19+1.21.1-fabric" = _z0e5x5L7;
        "pkg-7.1.22+1.20.1-fabric" = _hZnYyLGu;
        "pkg-7.7.2+26.1-fabric" = _8u54exjf;
        "pkg-7.1.23+1.20.1-fabric" = _eshDdTJx;
        "pkg-7.5.20+1.21.1-fabric" = _yF04lJoO;
        "pkg-7.7.4+26.1-fabric" = _Jvol4Hh2;
        "pkg-7.1.24+1.20.1-fabric" = _Hvm2wv28;
        "pkg-7.5.21+1.21.1-fabric" = _4uDzF4B9;
        "pkg-7.7.5+26.1-fabric" = _Xq8WAWDr;
        "pkg-7.7.5+26.2-fabric" = _dz8fp9GC;
        "pkg-7.1.25+1.20.1-fabric" = _jaRcykAY;
