...
let
    versions = (let
        ...
        _PNjeZ7e4 = {
            "id" = "PNjeZ7e4";
            "file" = "WorldEvents-1.8.35.jar";
            "hash" = "sha512-G2wrY3J9zgvOrazCILU462Ev2SIani44rtZqNso8h7CbdkssuPafJT9jRuxXrtQLNy4wiuSettiWP8aD72Xc3A==";
        };
        _T62JNoJw = {
            "id" = "T62JNoJw";
            "file" = "WorldEvents-1.9.0.jar";
            "hash" = "sha512-gSTyqcwr/4IHQdVU4TQyUwh9RiVC0WCybd3uhtSWY2SoqtGFWZe1D09X0FFzDWYaBQ3nX3WKzSirMdWvW8nP6w==";
        };
        _DdGKKT9h = {
            "id" = "DdGKKT9h";
            "file" = "WorldEvents-1.9.1.jar";
            "hash" = "sha512-EyTC6KoLB45p0AIZ01f7P5qSVuwpSTfscuYk1rZJ9WqRKWg69JklSxYDlJMwr+CmLmt3oUnuyfrZ9a7M4rQQ4Q==";
        };
        _HjxvNOBk = {
            "id" = "HjxvNOBk";
            "file" = "original-WorldEvents-1.9.3.jar";
            "hash" = "sha512-Vcx5M7Au/VLkbowY7zy9xpP5xX4Vn35AY2tD8gMbOtDdP/FY6lXQ9yd5TqRf5U4GcP7trbYp9yKQigqd4tinmA==";
        };
        _5hkpOEZR = {
            "id" = "5hkpOEZR";
            "file" = "WorldEvents-1.9.4.jar";
            "hash" = "sha512-IZwlarUp3ArT81cVw4I1zAm5WEsO6bDj1+vLm8JNBdsedMFiOuqYjlRHQF/RJtPE0lg6kE//sU1OFOxshiMicw==";
        };
    in {
        "vMteVOdl" = _vMteVOdl;
        "CNhl1dAl" = _CNhl1dAl;
        ...
        "HjxvNOBk" = _HjxvNOBk;
        "5hkpOEZR" = _5hkpOEZR;
        "paper-1.21" = _5hkpOEZR;
        "paper-1.21.1" = _5hkpOEZR;
        "paper-1.21.2" = _5hkpOEZR;
        "paper-1.21.3" = _5hkpOEZR;
        "paper-1.21.4" = _5hkpOEZR;
        "paper-1.21.5" = _5hkpOEZR;
        "paper-1.21.6" = _5hkpOEZR;
        "paper-1.21.7" = _5hkpOEZR;
        "paper-1.21.8" = _5hkpOEZR;
        "paper-1.21.9" = _5hkpOEZR;
        "paper-1.21.10" = _5hkpOEZR;
        "paper-1.20.1" = _3KM9F930;
        "paper-1.20.2" = _3KM9F930;
        "paper-1.20.3" = _3KM9F930;
        "paper-1.20.4" = _3KM9F930;
        "paper-1.20.5" = _3KM9F930;
        "paper-1.20.6" = _5hkpOEZR;
        "paper-1.20" = _y4h8OTQk;
        "paper-1.21.11" = _5hkpOEZR;
        "paper-26.1" = _5hkpOEZR;
        "paper-26.1.1" = _5hkpOEZR;
        "paper-26.1.2" = _5hkpOEZR;
        "paper-26.2" = _5hkpOEZR;
        "purpur-1.21" = _5hkpOEZR;
        "purpur-1.21.1" = _5hkpOEZR;
        "purpur-1.21.2" = _5hkpOEZR;
        "purpur-1.21.3" = _5hkpOEZR;
        "purpur-1.21.4" = _5hkpOEZR;
        "purpur-1.21.5" = _5hkpOEZR;
        "purpur-1.21.6" = _5hkpOEZR;
        "purpur-1.21.7" = _5hkpOEZR;
        "purpur-1.21.8" = _5hkpOEZR;
        "purpur-1.21.9" = _5hkpOEZR;
        "purpur-1.21.10" = _5hkpOEZR;
        "purpur-1.20.1" = _3KM9F930;
        "purpur-1.20.2" = _3KM9F930;
        "purpur-1.20.3" = _3KM9F930;
        "purpur-1.20.4" = _3KM9F930;
        "purpur-1.20.5" = _3KM9F930;
        "purpur-1.20.6" = _5hkpOEZR;
        "purpur-1.20" = _y4h8OTQk;
        "purpur-1.21.11" = _5hkpOEZR;
        "purpur-26.1" = _5hkpOEZR;
        "purpur-26.1.1" = _5hkpOEZR;
        "purpur-26.1.2" = _5hkpOEZR;
        "purpur-26.2" = _5hkpOEZR;
        "spigot-1.21" = _5hkpOEZR;
        "spigot-1.21.1" = _5hkpOEZR;
        "spigot-1.21.2" = _5hkpOEZR;
        "spigot-1.21.3" = _5hkpOEZR;
        "spigot-1.21.4" = _5hkpOEZR;
        "spigot-1.21.5" = _5hkpOEZR;
        "spigot-1.21.6" = _5hkpOEZR;
        "spigot-1.21.7" = _5hkpOEZR;
        "spigot-1.21.8" = _5hkpOEZR;
        "spigot-1.21.9" = _5hkpOEZR;
        "spigot-1.21.10" = _5hkpOEZR;
        "spigot-1.20.1" = _3KM9F930;
        "spigot-1.20.2" = _3KM9F930;
        "spigot-1.20.3" = _3KM9F930;
        "spigot-1.20.4" = _3KM9F930;
        "spigot-1.20.5" = _3KM9F930;
        "spigot-1.20.6" = _5hkpOEZR;
        "spigot-1.20" = _y4h8OTQk;
        "spigot-1.21.11" = _5hkpOEZR;
        "spigot-26.1" = _5hkpOEZR;
        "spigot-26.1.1" = _5hkpOEZR;
        "spigot-26.1.2" = _5hkpOEZR;
        "spigot-26.2" = _5hkpOEZR;
        "pkg-1.0.0" = _vMteVOdl;
        "pkg-1.1.0" = _CNhl1dAl;
        "pkg-1.2.0" = _67btxO62;
        "pkg-1.3.0" = _UQGcAbEW;
        ...
        "pkg-1.7.8" = _n1pu6yUI;
        "pkg-1.7.9" = _Q1IfsaSx;
        "pkg-1.7.10" = _ZgZBurp7;
        "pkg-1.7.11" = _po1u262C;
        "pkg-1.7.12" = _58P47gPw;
        "pkg-1.7.13" = _kuHXqHJq;
        "pkg-1.7.14" = _gQyWVNQo;
        "pkg-1.7.15" = _YRA5mzzI;
        "pkg-1.7.16" = _A0z3gdf5;
        "pkg-1.7.17" = _XSvsqFa4;
        "pkg-1.7.18" = _PM9YLzmd;
        "pkg-1.7.19" = _mF965qjp;
        "pkg-1.7.20" = _DZG26Ylv;
        "pkg-1.7.21" = _EyeSBHYr;
        "pkg-1.7.22" = _BQ2GjOGf;
        "pkg-1.7.23" = _43DbDLO6;
        "pkg-1.7.24" = _BWnfMVQ5;
        "pkg-1.7.25" = _kLZqh6LY;
        "pkg-1.7.26" = _d7fCBW8O;
        "pkg-1.7.27" = _9beBJWOS;
        "pkg-1.7.28" = _VkfmcCcP;
        "pkg-1.7.29" = _YOd0Dqxp;
        "pkg-1.7.30" = _jvqFTjm8;
        "pkg-1.7.31" = _dWqM5o5Y;
        "pkg-1.7.32" = _Arw1Kl45;
        "pkg-1.7.33" = _kuRX5OTa;
        "pkg-1.7.34" = _n2h5z2SQ;
        "pkg-1.8.0" = _fmGW8UnH;
        "pkg-1.8.1" = _AQ8SCXRD;
        "pkg-1.8.2" = _S4upou8E;
        "pkg-1.8.3" = _woc76fLG;
        ...
        "pkg-1.8.8" = _3KM9F930;
        "pkg-1.8.9" = _P6zNZkH1;
        "pkg-1.8.10" = _xOGU3XgH;
        "pkg-1.8.11" = _PSqufbxE;
        "pkg-1.8.12" = _iP70XxkS;
        "pkg-1.8.13" = _xRmIZH1c;
        "pkg-1.8.14" = _AEbwNGZa;
        "pkg-1.8.15" = _7pDM3TWz;
        "pkg-1.8.16" = _ft5ZOoBH;
        "pkg-1.8.17" = _TLYrDSMK;
        "pkg-1.8.18" = _zqMsreQU;
        "pkg-1.8.19" = _I0ifwSJf;
        "pkg-1.8.20" = _m95w9C9b;
        "pkg-1.8.21" = _M6SLvWfr;
        "pkg-1.8.22" = _9eqYwqQ8;
        "pkg-1.8.23" = _HW2M0Xqt;
        "pkg-1.8.24" = _YrjpIR2g;
        "pkg-1.8.25" = _wyHjPyMZ;
        "pkg-1.8.26" = _53Zu2qwN;
        "pkg-1.8.27" = _5qmZ3923;
        "pkg-1.8.28" = _2F2vfhqF;
        "pkg-1.8.30" = _3TwBGHnL;
        "pkg-1.8.31" = _AuE0c2KS;
        "pkg-1.8.32" = _1WGmio1T;
        "pkg-1.8.33" = _6GbOH8dC;
        "pkg-1.8.34" = _2MmlkoWz;
        "pkg-1.8.35" = _PNjeZ7e4;
        "pkg-1.9.0" = _T62JNoJw;
        "pkg-1.9.1" = _DdGKKT9h;
        "pkg-1.9.3" = _HjxvNOBk;
        "pkg-1.9.4" = _5hkpOEZR;
