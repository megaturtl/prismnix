...
let
    ...
    in {
        ...
        "pkg-8.0.0" = _l0x11YBA;
        "pkg-9.0.0" = _pyO9p3iq;
        "pkg-10.0.0" = _NjPeWhOp;
        "pkg-11.0.0" = _Ka9uSerF;
        "pkg-12.0.0" = _HBYqNo39;
        "pkg-13.0.0" = _3vKNNXf4;
        "pkg-13.1.0" = _MvBxvjKJ;
        "pkg-14.0.0" = _wIJ1Zhuc;
        "pkg-15.0.0" = _nwbEBb1u;
        "pkg-16.0.0" = _lYBDvIOK;
