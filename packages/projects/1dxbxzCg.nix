...
let
    ...
    in {
        ...
        "forge-1.20.1" = _d7UccVPh;
        "forge-1.18.2" = _YE71pvd3;
        "forge-1.20" = _d7UccVPh;
        "forge-1.20.2" = _d7UccVPh;
        "forge-1.20.3" = _d7UccVPh;
        "forge-1.20.4" = _d7UccVPh;
        "forge-1.20.5" = _d7UccVPh;
        "forge-1.20.6" = _d7UccVPh;
        "neoforge-1.20.1" = _d7UccVPh;
        "neoforge-1.21.1" = _O6sbvxEA;
        "neoforge-1.21.2" = _O6sbvxEA;
        "neoforge-1.21.3" = _O6sbvxEA;
        "neoforge-1.21.4" = _O6sbvxEA;
        "neoforge-1.20" = _d7UccVPh;
        "neoforge-1.20.2" = _d7UccVPh;
        "neoforge-1.20.3" = _d7UccVPh;
        "neoforge-1.20.4" = _d7UccVPh;
        "neoforge-1.20.5" = _d7UccVPh;
        "neoforge-1.20.6" = _d7UccVPh;
        "neoforge-1.21" = _O6sbvxEA;
        "neoforge-1.21.5" = _O6sbvxEA;
        "neoforge-1.21.6" = _O6sbvxEA;
        "neoforge-1.21.7" = _O6sbvxEA;
        "neoforge-1.21.8" = _O6sbvxEA;
        "neoforge-1.21.9" = _O6sbvxEA;
        "neoforge-1.21.10" = _O6sbvxEA;
        "neoforge-1.21.11" = _O6sbvxEA;
        "pkg-2.7.0" = _7T3uBAeW;
        "pkg-2.8.0" = _mlUBN8Fe;
        "pkg-2.9.0" = _mfTbZT7T;
        "pkg-3.0.0" = _HKyAwLl6;
