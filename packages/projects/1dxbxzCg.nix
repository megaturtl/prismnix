...
let
    versions = (let
        ...
        _d7UccVPh = {
            "id" = "d7UccVPh";
            "file" = "meed-1.20.1-8.0.6.jar";
            "hash" = "sha512-V+7VE6M/Ujv1+18jvyfPR1yyn4Xxp37+isJavAIoBiciBKDsh9wrUv9IpJDZeoeuXI693UgVsM7lTGOQBKy6kQ==";
        };
        _O6sbvxEA = {
            "id" = "O6sbvxEA";
            "file" = "meed-1.21.1-8.0.6.jar";
            "hash" = "sha512-L5GT/f/rTK3WB1IRHkede+9SQIAUevkEmi/f8LSd9HApRMMaaRAc1cJ5cPjIYLU2rZt/77LofHNke4G6ZsJ6Jg==";
        };
        _AC6PrsIF = {
            "id" = "AC6PrsIF";
            "file" = "meed-1.20.1-8.1.0.jar";
            "hash" = "sha512-5z3Z1yIz9CL0o9ADZx1+BRbIsNPcqaVdY/2mKGaVSEyyK8JTtjpFjdUJ+XBJX3VRv3sRLuiKHpOeZt2zqD4g7Q==";
        };
        _bEXmd5py = {
            "id" = "bEXmd5py";
            "file" = "meed-1.21.1-8.1.0.jar";
            "hash" = "sha512-e1k1MW96XId6AbmVPRIX3tcnJHnuuOgUNH5/LgzXc1ea59yT7DlNNWvNFtLnED9xvOWh19zap1bQIASKEM0Z0Q==";
        };
    in {
        "2u67ww0u" = _2u67ww0u;
        "7T3uBAeW" = _7T3uBAeW;
        ...
        "forge-1.20.1" = _AC6PrsIF;
        "forge-1.18.2" = _YE71pvd3;
        "forge-1.20" = _AC6PrsIF;
        "forge-1.20.2" = _AC6PrsIF;
        "forge-1.20.3" = _AC6PrsIF;
        "forge-1.20.4" = _AC6PrsIF;
        "forge-1.20.5" = _AC6PrsIF;
        "forge-1.20.6" = _AC6PrsIF;
        "neoforge-1.20.1" = _AC6PrsIF;
        "neoforge-1.21.1" = _bEXmd5py;
        "neoforge-1.21.2" = _bEXmd5py;
        "neoforge-1.21.3" = _bEXmd5py;
        "neoforge-1.21.4" = _bEXmd5py;
        "neoforge-1.20" = _AC6PrsIF;
        "neoforge-1.20.2" = _AC6PrsIF;
        "neoforge-1.20.3" = _AC6PrsIF;
        "neoforge-1.20.4" = _AC6PrsIF;
        "neoforge-1.20.5" = _AC6PrsIF;
        "neoforge-1.20.6" = _AC6PrsIF;
        "neoforge-1.21" = _bEXmd5py;
        "neoforge-1.21.5" = _bEXmd5py;
        "neoforge-1.21.6" = _bEXmd5py;
        "neoforge-1.21.7" = _bEXmd5py;
        "neoforge-1.21.8" = _bEXmd5py;
        "neoforge-1.21.9" = _bEXmd5py;
        "neoforge-1.21.10" = _bEXmd5py;
        "neoforge-1.21.11" = _bEXmd5py;
        "pkg-2.7.0" = _7T3uBAeW;
        "pkg-2.8.0" = _mlUBN8Fe;
        "pkg-2.9.0" = _mfTbZT7T;
        "pkg-3.0.0" = _HKyAwLl6;
