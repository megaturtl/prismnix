...
let
    versions = (let
        ...
        _AHsYkyUx = {
            "id" = "AHsYkyUx";
            "file" = "elytra_light_blue-1.0.1-mc26.3.zip";
            "hash" = "sha512-zHQ0TvQ6gudqDggsJiJgb2jQS+jbP2jWCDiQperSu3+L6JwmyxFfRmLaxK1wj90Tw3C6fUNDOrmiqdTvj+mvuA==";
        };
    in {
        "4SqlWJJ2" = _4SqlWJJ2;
        "BIMLNNfb" = _BIMLNNfb;
