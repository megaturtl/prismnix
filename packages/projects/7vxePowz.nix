...
let
    versions = (let
        ...
        _4Aqfzbmu = {
            "id" = "4Aqfzbmu";
            "file" = "FarmersDelight-26.3-3.6.21+refabricated.jar";
            "hash" = "sha512-r2ch6UpykDlJXGw/c3TwsabCT16KiJvOepn1jPM1IpSkUwm142kutBaKyzPbJfzE+/+UvAo7O3imLe8JxqWXPg==";
        };
        _qnqwu8kW = {
            "id" = "qnqwu8kW";
            "file" = "FarmersDelight-26.1-3.6.22+refabricated.jar";
            "hash" = "sha512-ebZE8997VzUnLlBLo0upsYn7+2WyQsknrx5E8WPtoICy4tzxE1FpHZJ0Y3SXgyNNirhQB2CBab5Z/4eeUD7jsw==";
        };
        _tLeFs9pK = {
            "id" = "tLeFs9pK";
            "file" = "FarmersDelight-26.2-3.6.22+refabricated.jar";
            "hash" = "sha512-ewJFWcDGVGboXj4AjgMI7j9X1eacyCC1Z5a28pGMJcKqz5qV8Ag69BjMNRr/bTCPrEVuT9tPrauba5CW5bVDMA==";
        };
        _nrmyJVDp = {
            "id" = "nrmyJVDp";
            "file" = "FarmersDelight-26.3-3.6.22+refabricated.jar";
            "hash" = "sha512-7ECJnzllmZ0Kk4crBxI36fs2/B3YORipX19WRLtFvYEhasgKat04PWVNNHm8GpKPWIkpwBlW85VdKH4NYF3w9w==";
        };
        _o8XeLALm = {
            "id" = "o8XeLALm";
            "file" = "FarmersDelight-26.3-3.6.23+refabricated.jar";
            "hash" = "sha512-xmmln4akErT1UZ4qF6nBKE6vtD8NSsuCP8J89doW8OoxaTkQtKDRmJG2UWu1iNjCq8bUckJnAygDL2kIimfeNQ==";
        };
        _bhD5aVXJ = {
            "id" = "bhD5aVXJ";
            "file" = "FarmersDelight-26.3-3.6.24+refabricated.jar";
            "hash" = "sha512-GBeEdWQGvuHR9wb3VpxoMWQSCyDRvch91y9i8gR4gn48FxItcjTEQUygineJbIpYHWapbDTVZtGWEWOfSMi7Wg==";
        };
        _CRBex59s = {
            "id" = "CRBex59s";
            "file" = "FarmersDelight-26.1-3.6.25+refabricated.jar";
            "hash" = "sha512-KZerc0njHng3O0+gVhWbecLuVxZ3YH0keZ+wYUip/8twk/d4WquNswj8hAJgv+UgXM+iPXWRp0iY/ittBNmEJg==";
        };
        _35H2kGP9 = {
            "id" = "35H2kGP9";
            "file" = "FarmersDelight-26.2-3.6.25+refabricated.jar";
            "hash" = "sha512-H7iZtFUNBVJf8XrlC6hO3q3SfqHg/s/GUeX4Nw5zNZWKxJ+P+T1gE7YxeliajeQ/dFo9L+8KdQAtJi7dNt8pIw==";
        };
        _F6GDKwtk = {
            "id" = "F6GDKwtk";
    ...
    in {
        ...
        "pkg-1.20.1-2.0.11" = _ETe2oDvK;
        "pkg-1.20.1-2.0.12" = _FMhV8TQg;
        "pkg-1.20.1-2.0.13" = _X6fzggyI;
        "pkg-1.20.1-2.0.14" = _QzcIQ62s;
        "pkg-1.20.1-2.0.15" = _pnmeqDCQ;
        "pkg-1.20.1-2.0.16" = _6MKCnUff;
        "pkg-1.20.1-2.0.17" = _Qid8WxOf;
        "pkg-1.20.1-2.1.0" = _Ti8scSIz;
        "pkg-1.20.1-2.1.1" = _5dZdVy3m;
        "pkg-1.20.1-2.1.2" = _mCvHYQFv;
        "pkg-1.20.1-2.1.3" = _Z2iib6NT;
        "pkg-1.21-2.1.3" = _Kp7Hr35E;
        "pkg-1.21-2.1.4" = _5LNsuvMj;
        "pkg-1.21-2.1.5" = _OsP4nbQm;
        "pkg-1.21-2.1.6" = _IYa4oL2w;
        "pkg-1.20.1-2.1.4" = _bjqVDyFs;
        "pkg-1.20.1-2.1.5" = _QIJkRFvA;
        "pkg-1.20.1-2.1.6" = _NoioB3or;
        "pkg-1.21-2.1.7" = _deqFhVqB;
        "pkg-1.21-2.1.8" = _cuehxctr;
        "pkg-1.21-2.1.9" = _8Borz3Mf;
        "pkg-1.21-2.1.10" = _Dnpn5CSl;
        "pkg-1.20.1-2.2.0" = _vXPVU0EZ;
        "pkg-1.21.1-2.2.0" = _LPDdZaqG;
        "pkg-1.21.1-2.2.1" = _D4tBF4UA;
        "pkg-1.21.1-2.2.2" = _Q8taIlJV;
        "pkg-1.21.1-2.2.3" = _DwEx2xkD;
        "pkg-1.20.1-2.2.1" = _ZJdGoCSm;
        "pkg-1.20.1-2.2.2" = _RUAJh3GL;
        "pkg-1.21.1-2.2.4" = _GjfJ3kHj;
        "pkg-1.21.1-2.2.5" = _5bfWfN8J;
        "pkg-1.20.1-2.2.3" = _YOcjTOKt;
        "pkg-1.21.1-2.2.6" = _Iipwc8gG;
        "pkg-1.20.1-2.2.4" = _Ms2QOr1b;
        "pkg-1.21.1-2.2.7" = _rBkjjNLZ;
        "pkg-1.20.1-2.2.5" = _iVLPoC2e;
        "pkg-1.21.1-2.2.8" = _Yl0gf0Ym;
        "pkg-1.20.1-2.2.6" = _NWzHJ5wB;
        "pkg-1.21.1-2.2.9" = _KEVwnGyF;
        "pkg-1.21.1-2.3.0" = _5XtFbOaE;
        "pkg-1.20.1-2.3.0" = _ZnoPlYRz;
        "pkg-1.21.1-3.0.0" = _FLqaPSlK;
        "pkg-1.21.1-3.0.1" = _HbIHpuID;
        "pkg-1.21.1-3.0.2" = _gAj0vwgf;
        "pkg-1.21.1-3.0.3" = _bmIUmNCd;
        "pkg-1.21.1-3.0.4" = _WKe1FTgD;
        "pkg-1.21.1-3.0.5" = _edmL8ii2;
        "pkg-1.20.1-2.4.0" = _PB4pwRax;
        "pkg-1.21.1-3.1.0" = _exNqMwTw;
        "pkg-1.21.5-3.1.0" = _3BO3EUZS;
        "pkg-1.21.5-3.1.1" = _t5ZxOUVI;
        "pkg-1.21.5-3.1.2" = _rvgMufzL;
        "pkg-1.21.5-3.1.3" = _kUi6Kgrp;
        "pkg-1.21.5-3.1.4" = _f4q8WV9U;
        "pkg-1.21.5-3.2.0" = _fSXUV4YR;
        "pkg-1.21.1-3.1.1" = _5dis8U7G;
        "pkg-1.21.5-3.2.1" = _WyKK80WQ;
        "pkg-1.21.6-3.2.1" = _1QwiHUIO;
        "pkg-1.21.1-3.1.2" = _sQbPKvBC;
        "pkg-1.21.5-3.2.2" = _ZSbHysJT;
        "pkg-1.21.6-3.2.2" = _NqXkGvEY;
        "pkg-1.21.5-3.2.3" = _qf0b9JLO;
        "pkg-1.21.6-3.2.3" = _ks9dtY6t;
        "pkg-1.21.7-3.2.4" = _sasWUSGU;
        "pkg-1.21.5-3.2.4" = _Vc0kdMUl;
        "pkg-1.21.8-3.2.4" = _IdNE2lH4;
        "pkg-1.21.8-3.2.5" = _iTQF8gZN;
        "pkg-1.21.1-2.4.0" = _aghYX1vG;
        "pkg-1.21.1-3.2.0" = _GHLqISeJ;
        "pkg-1.21.8-3.3.0" = _6spOsqBD;
        "pkg-1.21.8-3.3.1" = _Do1NzCfX;
        "pkg-1.21.10-3.3.1" = _oGVyVhBp;
        "pkg-1.21.10-3.3.2" = _ThiegWhD;
        "pkg-1.21.8-3.3.2" = _kv6KnfiF;
        "pkg-1.21.10-3.3.3" = _OAzjy0MV;
        "pkg-1.21.1-3.2.1" = _4V8vJoXG;
        "pkg-1.20.1-2.4.1" = _Z8UNayLO;
        "pkg-1.21.5-3.2.5" = _GG0AoJ3d;
        "pkg-1.21.8-3.3.3" = _YJ79rjkO;
        "pkg-1.21.1-3.2.2" = _vj4n2BSl;
        "pkg-1.21.10-3.4.0" = _ksAJvW6q;
        "pkg-1.21.10-3.4.1" = _uWzG0tGX;
        "pkg-1.21.11-3.4.1" = _LXqNUdMO;
        "pkg-1.21.11-3.4.2" = _YkvnGAdL;
        "pkg-1.21.10-3.4.2" = _KPW4qVOo;
        "pkg-1.21.11-3.4.3" = _Cj2tYY3L;
        "pkg-1.21.11-3.4.4" = _4k81ekaC;
        "pkg-1.21.11-3.4.5" = _r8cXovUr;
        "pkg-1.21.11-3.4.6" = _anw78HUc;
        "pkg-1.21.11-3.4.7" = _Qi9Z9Zs0;
        "pkg-1.21.11-3.4.8" = _VyHaPl8C;
        "pkg-1.21.1-3.2.3" = _Kvd7dSLJ;
        "pkg-1.21.1-3.2.4" = _tXnMVzA9;
        "pkg-1.21.11-3.4.9" = _ZP4Uof9C;
        "pkg-1.21.1-3.2.5" = _Sddkv0PO;
        "pkg-26.1-3.5.0" = _7OK8HY6e;
        "pkg-26.1-3.5.1" = _Fozl9iYw;
        "pkg-26.1-3.5.2" = _3QWG30GJ;
        "pkg-1.21.1-3.2.7" = _celQx6zP;
        "pkg-1.21.1-3.2.8" = _YEHRH8LC;
        "pkg-26.1-3.5.3" = _7TRNCuq6;
        "pkg-26.1-3.5.4" = _H3DyoNSp;
        "pkg-26.1-3.5.5" = _keZkg0JO;
        "pkg-1.21.1-3.3.0" = _PQs5XhIm;
        "pkg-1.21.1-3.3.1" = _HAn33Pya;
        "pkg-1.21.1-3.3.2" = _pVaiLRWA;
        "pkg-26.1-3.6.0" = _Mf4DFG83;
        "pkg-26.1-3.6.1" = _TAELcSN5;
        "pkg-26.1-3.6.2" = _qDlVXoyk;
        "pkg-26.1-3.6.3" = _l1tHUmog;
        "pkg-26.1-3.6.4" = _PoGjikQA;
        "pkg-1.21.1-3.3.3" = _NCLOIK5z;
        "pkg-26.1-3.6.5" = _fjJnfO0r;
        "pkg-26.1-3.6.6" = _uvsJqmJG;
        "pkg-26.2-3.6.6" = _ClzfHtwu;
        "pkg-26.1-3.6.7" = _5UrcSJDx;
        "pkg-26.2-3.6.7" = _BD1gWJYb;
        "pkg-26.1-3.6.8" = _baJDnuI2;
        "pkg-26.2-3.6.8" = _PR6Lz8x8;
        "pkg-1.21.11-3.6.9" = _WFGXuwG6;
        "pkg-1.21.11-3.6.10" = _IYoHHwiO;
        "pkg-1.21.11-3.6.11" = _HsAFtmK9;
        "pkg-1.20.1-2.5.0" = _JqKVEPM2;
        "pkg-26.1-3.6.12" = _4iW0PO3K;
        "pkg-1.20.1-2.5.1" = _ZGPYdY8K;
        "pkg-1.21.11-3.6.13" = _yXs9snmN;
        "pkg-26.1-3.6.13" = _NFkXMumN;
        "pkg-26.2-3.6.13" = _N215vtk5;
        "pkg-1.20.1-2.5.2" = _GQvv4NDs;
        ...
        "pkg-26.3-3.6.21" = _4Aqfzbmu;
        "pkg-26.1-3.6.22" = _qnqwu8kW;
        "pkg-26.2-3.6.22" = _tLeFs9pK;
        "pkg-26.3-3.6.22" = _nrmyJVDp;
        "pkg-26.3-3.6.23" = _o8XeLALm;
        "pkg-26.3-3.6.24" = _bhD5aVXJ;
