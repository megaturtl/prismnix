...
let
    versions = (let
        ...
        _UnO423CV = {
            "id" = "UnO423CV";
            "file" = "nine_lifes-7.0+26.2.jar";
            "hash" = "sha512-KhtiC8DkJjrLJWywx3jNsVnQ2+OEyzfNpkUEMA4XzBbQLL3A+alQUKCxs6nW6smHALRbKAylzc0AZuXMAdEUAQ==";
        };
        _L4lTf9W2 = {
            "id" = "L4lTf9W2";
            "file" = "nine_lifes-7.0+26.3.jar";
            "hash" = "sha512-2c2V1F8QpAwJEvdmMm0YAszxZdIfsWyruBbJNoFJzUq/OmAxY4AoLO/68bSW3CZ9wc5PO9DrjuTenjSOBLhnHw==";
        };
    in {
        "ElYaGbFV" = _ElYaGbFV;
        "17jElia4" = _17jElia4;
        ...
        "pkg-1.5" = _9dwlEVMr;
        "pkg-1.5.1" = _kUnyOofw;
        "pkg-1.5.1+1.21.5" = _u6G1EANJ;
        "pkg-1.5.2" = _FidWs2Ru;
        "pkg-1.5.2+1.21.5" = _G2Blk0Tj;
        "pkg-1.5.3" = _lI3qqLe3;
        "pkg-1.5.3+1.21.5" = _UFTpYoz2;
        "pkg-1.6" = _oE43wunb;
        "pkg-1.6+1.21.6" = _tyswKhsy;
        "pkg-1.7" = _kuHB2QGq;
        "pkg-1.7+1.21.6" = _4NVokK1N;
        "pkg-1.7.1b+1.21.6" = _hxzD9pqt;
        "pkg-1.7.2" = _SuQn55YJ;
        "pkg-1.7.2+1.21.6" = _JRlEVayu;
        "pkg-1.8.0+1.21.6" = _Vkssp4AF;
        "pkg-1.8.0+1.21.9" = _4ix35pn6;
        "pkg-1.9.0+1.21.6" = _gKKrepT1;
        "pkg-1.9.0+1.21.9" = _IFMU8Tgw;
        "pkg-1.9.1_beta+1.21.6" = _XUtXe6yA;
        "pkg-1.9.1_beta+1.21.9" = _uXJz89E7;
        "pkg-2.0.0+1.21.9" = _H7W9RsYm;
        "pkg-2.0.0+1.21.11" = _qZAUvFwo;
        "pkg-2.0.1+1.21.6" = _LIRtCDDg;
        "pkg-2.0.1+1.21.9" = _x8WYrC8D;
        "pkg-2.0.1+1.21.11" = _sRoTlBPU;
        "pkg-2.0.2+1.21.11" = _NdtDHDrq;
        "pkg-2.0.2+1.21.6" = _tAi6iHIM;
        "pkg-2.0.2+1.21.9" = _i01yFVC9;
        "pkg-2.1+1.21.11" = _JronPLz3;
        "pkg-2.1+1.21.6" = _uCpbk0HC;
        "pkg-2.1+1.21.9" = _EAV8myT4;
        "pkg-3.0+1.21.10" = _HvVm4CjT;
        "pkg-3.0+26.1" = _EGr8QeXu;
        "pkg-3.0+1.21.11" = _kWajAOvK;
        "pkg-3.1+1.21.11" = _pMBcgkCq;
        "pkg-3.1+26.1" = _TNMH9W4o;
        "pkg-3.2+1.21.11" = _RVAl2S6C;
        "pkg-3.2+26.1" = _OYdUU04I;
        "pkg-3.3+1.21.11" = _AvF9Q3Ih;
        "pkg-3.3+26.1" = _udrmQZdp;
        "pkg-3.4+1.21.11" = _csi3j9uH;
        "pkg-3.4+26.1" = _PLWmB4cu;
        "pkg-4.0+1.21.11" = _xHp9xyxx;
        "pkg-4.0+26.1" = _PaNvnOBa;
        "pkg-4.1+1.21.11" = _NK8iGZns;
        "pkg-4.1+26.1.2" = _s1n21qkt;
        "pkg-5.0+1.21.11" = _rLv6DTg3;
        "pkg-5.0+26.2" = _SejqB3B2;
        "pkg-5.0+26.1.2" = _l84vHywW;
        "pkg-5.1+1.21.11" = _gNiKF1XE;
        "pkg-5.1+26.2" = _5d2lQT4G;
        "pkg-5.1+26.1.2" = _a73aEzLr;
        "pkg-5.2+26.1.2" = _qpYd7oib;
        "pkg-5.2+26.2" = _MqrhCybp;
        "pkg-5.2+26.3" = _8bFPsYVE;
        "pkg-6.0+26.1.2" = _hU6nafAN;
        "pkg-6.0+26.2" = _GomxgQO8;
        "pkg-6.0+26.3" = _2gCYyq4P;
        ...
        "pkg-7.0+26.2" = _UnO423CV;
        "pkg-7.0+26.3" = _L4lTf9W2;
        "default" = _L4lTf9W2;
    });
