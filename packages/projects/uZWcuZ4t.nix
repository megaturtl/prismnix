...
let
    ...
    in {
        ...
        "pkg-0.1.2" = _KFELddCC;
        "pkg-0.1.3" = _Bbn2plQe;
        "pkg-0.1.3-1.21.1" = _VfMpcPat;
        "pkg-0.1.4" = _PfoBzLS3;
        "pkg-0.1.4-1.21.1" = _xL6neuTC;
        "pkg-0.2.0" = _nIElh6Nq;
        "pkg-0.2.0-1.21.1" = _JJUPXLAq;
        "pkg-0.2.1" = _uIUZhUpn;
        "pkg-0.2.1-1.21.1" = _Gve4xuwW;
        "pkg-0.2.2" = _zJuehrxq;
        "pkg-0.2.2-1.21.1" = _VVFTtPAi;
        "pkg-0.2.3" = _nVtKBBGc;
        "pkg-0.2.3-1.21.1" = _Z1D3cBQ6;
        "pkg-0.2.4" = _6fjHPaO2;
        "pkg-0.2.4-1.21.1" = _ehp4LENU;
        "pkg-0.2.5" = _qX4QG1Rk;
        "pkg-0.2.5-1.21.1" = _YuJnhLqv;
        "pkg-0.2.6" = _szavddxP;
        "pkg-0.2.6-1.21.1" = _WzaPQQRq;
        "pkg-0.3.0" = _LB0h0bgL;
        "pkg-0.3.0-1.21.1" = _GXVk1k3K;
        "pkg-0.3.1" = _kY6nq6Ce;
        "pkg-0.3.1-1.21.1" = _ZdgsNhaK;
        "pkg-0.3.1-1.21.11" = _YS0KYYOT;
        "pkg-0.3.2" = _sekYfWog;
        "pkg-0.3.2-1.21.1" = _U9lXDPsT;
        "pkg-0.3.2-1.21.11" = _1HMjAUy1;
