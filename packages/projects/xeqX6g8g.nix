...
let
    versions = (let
        ...
        _EBQQC2KB = {
            "id" = "EBQQC2KB";
            "file" = "MPLOCmods_v40.1.zip";
            "hash" = "sha512-ZdxkF9T7X1i5RE44f9lYwlUCXmgjQtUibKIaOwZsnXTs4kQUhlVTN67HpockzwpAjGqlnGZc7RcyQk5r0qO6nA==";
        };
    in {
        "A9TViF37" = _A9TViF37;
        "TvaFKSbR" = _TvaFKSbR;
        ...
        "Nv9yez6K" = _Nv9yez6K;
        "EBQQC2KB" = _EBQQC2KB;
        "minecraft-1.14" = _EBQQC2KB;
        "minecraft-1.14.1" = _EBQQC2KB;
        "minecraft-1.14.2" = _EBQQC2KB;
        "minecraft-1.14.3" = _EBQQC2KB;
        "minecraft-1.14.4" = _EBQQC2KB;
        "minecraft-1.15" = _EBQQC2KB;
        "minecraft-1.15.1" = _EBQQC2KB;
        "minecraft-1.15.2" = _EBQQC2KB;
        "minecraft-1.16" = _EBQQC2KB;
        "minecraft-1.16.1" = _EBQQC2KB;
        "minecraft-1.16.2" = _EBQQC2KB;
        "minecraft-1.16.3" = _EBQQC2KB;
        "minecraft-1.16.4" = _EBQQC2KB;
        "minecraft-1.16.5" = _EBQQC2KB;
        "minecraft-1.17" = _EBQQC2KB;
        "minecraft-1.17.1" = _EBQQC2KB;
        "minecraft-1.18" = _EBQQC2KB;
        "minecraft-1.18.1" = _EBQQC2KB;
        "minecraft-1.18.2" = _EBQQC2KB;
        "minecraft-1.19" = _EBQQC2KB;
        "minecraft-1.19.1" = _EBQQC2KB;
        "minecraft-1.19.2" = _EBQQC2KB;
        "minecraft-1.19.3" = _EBQQC2KB;
        "minecraft-1.19.4" = _EBQQC2KB;
        "minecraft-1.20" = _EBQQC2KB;
        "minecraft-1.20.1" = _EBQQC2KB;
        "minecraft-1.20.2" = _EBQQC2KB;
        "minecraft-1.20.3" = _EBQQC2KB;
        "minecraft-1.20.4" = _EBQQC2KB;
        "minecraft-1.20.5" = _EBQQC2KB;
        "minecraft-1.20.6" = _EBQQC2KB;
        "minecraft-1.21" = _EBQQC2KB;
        "minecraft-1.21.1" = _EBQQC2KB;
        "minecraft-1.21.2" = _EBQQC2KB;
        "minecraft-1.21.3" = _EBQQC2KB;
        "minecraft-1.21.4" = _EBQQC2KB;
        "minecraft-1.21.5" = _EBQQC2KB;
        "minecraft-1.21.6" = _EBQQC2KB;
        "minecraft-1.21.7" = _EBQQC2KB;
        "minecraft-1.21.8" = _EBQQC2KB;
        "minecraft-1.21.9" = _EBQQC2KB;
        "minecraft-1.21.10" = _EBQQC2KB;
        "minecraft-1.21.11" = _EBQQC2KB;
        "minecraft-26.1" = _EBQQC2KB;
        "minecraft-26.1.1" = _EBQQC2KB;
        "minecraft-26.1.2" = _EBQQC2KB;
        "minecraft-26.2" = _EBQQC2KB;
        "pkg-v1.0" = _A9TViF37;
        "pkg-v2.0" = _TvaFKSbR;
        "pkg-v3.0" = _Ct1hkczK;
        "pkg-v4.0" = _MpwV2elk;
