...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _5oxa40QI;
        "pkg-1.1.0-2" = _SebkSMqv;
        "pkg-1.1.1" = _5wRJfCrf;
        "pkg-1.1.1-2" = _CZRq8w3T;
        "pkg-V1.1.3" = _snT7Fp3b;
        "pkg-1.1.3-2" = _DA6fD52X;
        "pkg-V1.1.4-1" = _wBfcAkoJ;
        "pkg-V1.1.4" = _utKpRHG8;
        "pkg-V1.1.5" = _6n0QFy5d;
        "pkg-V1.1.5-2" = _CcMZcUO0;
        "pkg-V1.1.6" = _vaumZJfm;
        "pkg-V1.1.6-2" = _npy3VRNP;
        "pkg-V1.1.7-1" = _WtZlNwfw;
        "pkg-V1.1.7-2" = _L8LIBIOX;
        "pkg-V1.1.8-1" = _4Uw49eAQ;
        "pkg-V1.1.8-2" = _QIJTvZxe;
        "pkg-V1.2.2" = _O7e0p9Nt;
        "pkg-V1.2.3" = _MOgem0MG;
        "pkg-V1.2.3-1" = _xrDhK4ea;
        "pkg-V1.2.4" = _F4rkUt7u;
        "pkg-V1.2.6" = _Va2oKwAM;
        "pkg-V1.2.7" = _WlKihECF;
        "pkg-1.4.0" = _weZZqe3x;
        "pkg-1.4.2" = _sZcC6uEA;
        "pkg-1.3.0" = _GrVwdQyX;
        "pkg-1.4.3" = _pgOu3iGQ;
        ...
        "pkg-2.1.9" = _lGM4EtBF;
        "pkg-2.3.0" = _L29hf3QF;
        "pkg-2.2.1-1.21.1" = _LPgkgflC;
        "pkg-2.2.1r-1.21.1" = _s1PcPdqg;
        "pkg-2.3.1" = _yMJw3wlR;
