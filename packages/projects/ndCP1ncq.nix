...
let
    ...
    in {
        ...
        "pkg-1.1" = _iCNYt0hb;
        "pkg-1.1+mod" = _3iy5JsXm;
        "pkg-1.2" = _owkkYvgU;
        "pkg-1.2+mod" = _QtMcBQOc;
        "pkg-1.2.1" = _mxnFgLG7;
        "pkg-1.2.1+mod" = _G8xW9TPP;
        "pkg-1.3" = _9azYJIQK;
        "pkg-1.3+mod" = _FnjfS5dE;
        "pkg-2.3" = _ZObEkMgq;
        "pkg-2.3+mod" = _jYMU6Dua;
        "pkg-2.4" = _Ic2bfJrg;
        "pkg-2.4+mod" = _HgFxJbBK;
        "pkg-2.5" = _tvIzVTVg;
        "pkg-2.5+mod" = _L7Q3YZ2T;
        "pkg-2.6" = _FCTRAZ8G;
        "pkg-2.6+mod" = _wlXOkxsr;
        "pkg-2.6.1" = _ojZWZlIL;
        "pkg-2.6.1+mod" = _D6oEOu1t;
        "pkg-2.7" = _L6hJFYeD;
        "pkg-2.7+mod" = _Km0iqpLR;
        "pkg-2.8" = _wVQQkNZb;
        "pkg-2.8+mod" = _nIpzn7a9;
        "pkg-2.9" = _zzcaEBV4;
        "pkg-2.9+mod" = _RRPYr8y8;
        "pkg-3.0" = _pKV9d7oV;
        "pkg-3.0+mod" = _PmxgfMvL;
        "pkg-3.1" = _6clUfO7E;
        "pkg-3.1+mod" = _dRQHQYfP;
        "pkg-3.2" = _BLdoqYh9;
        "pkg-3.2-mod" = _vMAqO4PP;
        "pkg-3.3" = _MSrsuv0R;
