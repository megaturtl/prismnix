...
let
    versions = (let
        ...
        _lK5H43pJ = {
            "id" = "lK5H43pJ";
            "file" = "QuickSortX-1.5.jar";
            "hash" = "sha512-TfWCHzO5nBZ+Qb8HXVsgTlEmwfw756NzqWnMzEe4hqYyI3NaMZoFyWFLLN5gArp4girqGmIh8DeqfDwiV4PyVw==";
        };
    in {
        "BbshjfhS" = _BbshjfhS;
        "d3nRIDmB" = _d3nRIDmB;
        ...
        "bukkit-1.21" = _lK5H43pJ;
        "bukkit-1.21.1" = _lK5H43pJ;
        "bukkit-1.21.2" = _lK5H43pJ;
        "bukkit-1.21.3" = _lK5H43pJ;
        "bukkit-1.21.4" = _lK5H43pJ;
        "bukkit-1.21.5" = _lK5H43pJ;
        "bukkit-1.21.6" = _lK5H43pJ;
        "bukkit-1.21.7" = _lK5H43pJ;
        "bukkit-1.21.8" = _lK5H43pJ;
        "bukkit-1.21.9" = _lK5H43pJ;
        "bukkit-1.21.10" = _lK5H43pJ;
        "bukkit-1.21.11" = _lK5H43pJ;
        "bukkit-26.1" = _lK5H43pJ;
        "bukkit-26.1.1" = _lK5H43pJ;
        "bukkit-26.1.2" = _lK5H43pJ;
        "bukkit-26.2" = _lK5H43pJ;
        "bukkit-26.3" = _lK5H43pJ;
        ...
        "paper-1.21" = _lK5H43pJ;
        "paper-1.21.1" = _lK5H43pJ;
        "paper-1.21.2" = _lK5H43pJ;
        "paper-1.21.3" = _lK5H43pJ;
        "paper-1.21.4" = _lK5H43pJ;
        "paper-1.21.5" = _lK5H43pJ;
        "paper-1.21.6" = _lK5H43pJ;
        "paper-1.21.7" = _lK5H43pJ;
        "paper-1.21.8" = _lK5H43pJ;
        "paper-1.21.9" = _lK5H43pJ;
        "paper-1.21.10" = _lK5H43pJ;
        "paper-1.21.11" = _lK5H43pJ;
        "paper-26.1" = _lK5H43pJ;
        "paper-26.1.1" = _lK5H43pJ;
        "paper-26.1.2" = _lK5H43pJ;
        "paper-26.2" = _lK5H43pJ;
        "paper-26.3" = _lK5H43pJ;
        ...
        "spigot-1.21" = _lK5H43pJ;
        "spigot-1.21.1" = _lK5H43pJ;
        "spigot-1.21.2" = _lK5H43pJ;
        "spigot-1.21.3" = _lK5H43pJ;
        "spigot-1.21.4" = _lK5H43pJ;
        "spigot-1.21.5" = _lK5H43pJ;
        "spigot-1.21.6" = _lK5H43pJ;
        "spigot-1.21.7" = _lK5H43pJ;
        "spigot-1.21.8" = _lK5H43pJ;
        "spigot-1.21.9" = _lK5H43pJ;
        "spigot-1.21.10" = _lK5H43pJ;
        "spigot-1.21.11" = _lK5H43pJ;
        "spigot-26.1" = _lK5H43pJ;
        "spigot-26.1.1" = _lK5H43pJ;
        "spigot-26.1.2" = _lK5H43pJ;
        "spigot-26.2" = _lK5H43pJ;
        "spigot-26.3" = _lK5H43pJ;
        ...
        "pkg-1.4" = _2OwvMcA3;
        "pkg-1.5" = _7Bdx0mnY;
        "pkg-1.5-FIX" = _5vgHFPVJ;
        "pkg-1.5-1" = _2HcdfbDB;
        "pkg-1.5-1FIX" = _mRmV3DXZ;
        "pkg-1.5-2" = _lWjxhAd9;
        "pkg-1.5-QOL" = _LCqpGO3L;
        "pkg-1.5-3" = _lK5H43pJ;
        "default" = _lK5H43pJ;
    });
