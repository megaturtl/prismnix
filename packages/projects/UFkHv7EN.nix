...
let
    ...
    in {
        ...
        "pkg-1.2+mc1.20.x" = _3FBSfBMN;
        "pkg-1.2.1+mc1.20.x" = _UtNqiJzq;
        "pkg-1.2.2+mc1.20.x" = _VGgq4oPm;
        "pkg-1.2.3+mc1.20.x" = _G5yv3DAg;
        "pkg-1.2.4+mc1.21" = _Ph1xMmFg;
        "pkg-1.3+mc1.21" = _TgMMijsI;
        "pkg-1.3.1+mc1.21" = _gYCVMMCB;
        "pkg-1.4+mc1.21" = _TLYrDGkt;
        "pkg-1.4.1+mc1.21" = _vCPr9Kdl;
        "pkg-1.4.2+mc1.21.x" = _1UqaYz0o;
        "pkg-1.4.3+mc1.21.3" = _upD1gaqv;
        "pkg-1.4.4+mc1.21.4" = _dq51aiYm;
        "pkg-1.4.5+mc1.21.5" = _y02LxSB1;
        "pkg-1.4.6+mc1.21.6" = _CG25jAfn;
        "pkg-1.4.7+mc1.21.9" = _8UTs4Czi;
        "pkg-1.4.8+mc1.21.11" = _GpTQTgeg;
        "pkg-1.4.9+mc26.1" = _tWGbcHw5;
        "pkg-1.4.10+mc26.2" = _MKs1ejDK;
        "pkg-1.5+mc1.21.1-neoforge" = _9QaFmth7;
        "pkg-1.5+mc1.21.1-fabric" = _OzTUNWOS;
        "pkg-1.5+mc1.21.11-neoforge" = _SkGKOgcY;
        "pkg-1.5+mc1.21.11-fabric" = _N3AgiGYG;
        "pkg-1.5+mc26.1.2-neoforge" = _onw4XIAx;
