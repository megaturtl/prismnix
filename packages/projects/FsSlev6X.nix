...
let
    ...
    in {
        ...
        "pkg-21.11-r1.3" = _nvzgsxl7;
        "pkg-21.11-r1.4" = _yUqT02yS;
        "pkg-21.11-r1.5" = _byWSeUTA;
        "pkg-21.11-r1.6" = _NL79iAgh;
        "pkg-21.11-r1.7" = _OgshQJgt;
        "pkg-21.11-r1.8" = _5ofy9cok;
        "pkg-21.11-r1.9" = _lGcU5DoM;
        "pkg-21.11-r1.10" = _X3jrmzPa;
        "pkg-21.11-r1.11" = _3fh3QcW4;
        "pkg-21.11-r1.12" = _s5oQfoiH;
        "pkg-21.11-r1.13" = _Qy2xJJVn;
        "pkg-21.11-r1.14" = _9mzoLUQS;
        "pkg-21.11-r1.15" = _Lkiof3l1;
        "pkg-21.11-r1.16" = _1aQSbQey;
        "pkg-21.11-r1.17" = _srmNTuEz;
        "pkg-21.11-r1.18" = _MpOyakPC;
        "pkg-21.11-r1.19" = _Wt8Ijzh4;
        "pkg-21.11-r1.20" = _3EwBL978;
        "pkg-21.11-r1.21" = _eYQqMpra;
        "pkg-21.11-r1.22" = _lm9caLVm;
        "pkg-21.11-r1.23" = _flAPhBQQ;
        "pkg-21.11-r1.24" = _TUayC4ki;
        "pkg-26.1-r1.0-neoforge" = _L1gxlTSj;
        "pkg-26.1-r1.0-fabric" = _b9uptAdj;
        "pkg-26.1-r2.0-neoforge" = _B2VFxv95;
        "pkg-26.1-r2.0-fabric" = _27uoS0Z1;
        "pkg-26.1-r2.1-neoforge" = _6jFHdhK2;
        "pkg-26.1-r2.1-fabric" = _6GQtVV22;
        "pkg-26.1-r2.2-neoforge" = _1Sl2tcXc;
        "pkg-26.1-r2.2-fabric" = _nhzXLV1p;
        "pkg-26.1-r2.3-neoforge" = _FKQ48kkp;
        "pkg-26.1-r2.3-fabric" = _fMbYm0pv;
        "pkg-26.1-r2.4-neoforge" = _oP3GRgJg;
        "pkg-26.1-r2.4-fabric" = _WRlkVr9v;
        "pkg-26.1-r2.5-neoforge" = _FMe6AekX;
        "pkg-26.1-r2.5-fabric" = _lcHO4q4a;
        "pkg-26.1-r2.6-neoforge" = _i4IXgFgZ;
        "pkg-26.1-r2.6-fabric" = _AHsSRBSS;
        "pkg-26.1-r2.7-neoforge" = _EfmqZ6G1;
