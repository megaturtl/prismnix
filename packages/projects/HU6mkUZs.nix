...
let
    ...
    in {
        ...
        "pkg-1.0.3" = _3JsCw3Mi;
        "pkg-1.1.0" = _5lcKyUYC;
        "pkg-1.2.0-beta.1+1.6.0" = _6LkFBGX9;
        "pkg-1.1.1" = _c6Mwq1Al;
        "pkg-1.2.0" = _FFSJUywW;
        "pkg-1.1.2" = _hDKFXe3b;
        "pkg-1.2.1" = _xUwGHf7f;
        "pkg-1.1.3" = _8aCGZKAf;
        "pkg-1.2.2" = _LNIfk8wm;
        "pkg-1.2.3+1.5.2" = _lxoPAlgZ;
        "pkg-1.2.3+1.6.0" = _7tXGPwT1;
        "pkg-1.3.0+1.5.2" = _nY1REOqq;
        "pkg-1.3.0+1.6.0" = _FLgAeVlq;
        "pkg-1.4.0+1.5.2" = _aIFWfDvf;
        "pkg-1.4.0+1.6.0" = _tkannHuf;
        "pkg-1.4.1+1.5.2" = _wNkPNsjt;
        "pkg-1.4.1+1.6.0" = _sgtlbJKe;
        "pkg-1.4.2+1.5.2" = _Az6kuLQf;
        "pkg-1.4.2+1.6.0" = _LRIZ75u3;
        "pkg-1.4.3+1.5.2" = _6OQwlZtk;
        "pkg-1.4.3+1.6.0" = _nBxE1Won;
        "pkg-1.4.4+1.5.2" = _NYvkCgcF;
        "pkg-1.4.4+1.6.0" = _dcsR2nxK;
        "pkg-1.4.5+1.5.2" = _Dw3ciBUd;
        "pkg-1.4.5+1.6.0" = _kZLyDqg6;
        "pkg-1.4.5+1.6.1" = _Cz7BULnT;
        "pkg-1.4.6+1.5.2" = _ULTI0W0R;
        "pkg-1.4.6+1.6.1" = _x88jPzBN;
        "pkg-1.4.7+1.5.2" = _NYjpbQiu;
        "pkg-1.4.7+1.6.1" = _bSw8VnRp;
        "pkg-1.4.8+1.5.2" = _vS2hsftD;
        "pkg-1.4.8+1.6.1" = _s1kRUhTJ;
        "pkg-1.4.9+1.5.2" = _3CtBJDdS;
        "pkg-1.4.9+1.6.1" = _2Z1OpNyB;
        "pkg-1.4.10+1.5.2" = _BmINtI27;
        "pkg-1.4.10+1.6.1" = _V9WvegJQ;
        "pkg-1.4.11+1.5.2" = _NJ4I8PXx;
        "pkg-1.4.11+1.6.1" = _aZ0Dkgoo;
        "pkg-1.4.12+1.5.2" = _hwZPmfnQ;
        "pkg-1.4.12+1.6.1" = _w2KzRiZz;
        "pkg-1.4.13+1.5.2" = _XNCJPlW1;
        "pkg-1.4.13+1.6.1" = _QfDQMgIM;
        "pkg-1.4.14+1.5.2" = _CFONud4T;
        "pkg-1.4.14+1.6.1" = _qyLXqU46;
        "pkg-1.4.15+1.5.2" = _i5pzXPuj;
        "pkg-1.4.15+1.6.1" = _M1sP9dQb;
        "pkg-1.4.16+1.5.2" = _ORe6MH6i;
        "pkg-1.4.16+1.7.0" = _9saoipfr;
        "pkg-1.4.16+1.7.1" = _vIesP9ur;
        "pkg-1.4.17+1.5.2" = _IRby9PMn;
        "pkg-1.4.17+1.7.1" = _2EawoyqI;
        "pkg-1.4.18+1.5.2" = _A95ZrOLQ;
