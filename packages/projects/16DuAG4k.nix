...
let
    ...
    in {
        ...
        "pkg-0.0.65" = _v6ZllhUL;
        "pkg-0.0.65+1.20.1" = _GVZdlAuY;
        "pkg-0.0.70" = _j3mfkpAI;
        "pkg-0.0.69+1.20.1" = _nLV2RUYd;
        "pkg-0.0.69B+1.20.1" = _lCeU8YrG;
        "pkg-0.0.70B" = _5Fu7tIeX;
        "pkg-0.0.69C+1.20.1" = _re9aylPu;
        "pkg-0.0.80" = _qlL0udRf;
        "pkg-0.0.80+1.20.1-fabric" = _fzlLNIEc;
        "pkg-0.0.85" = _L6hTXCfY;
        "pkg-0.0.85+1.20.1-fabric" = _oE6DfHdZ;
        "pkg-0.0.86" = _ZAs1p0iT;
        "pkg-0.0.86+1.20.1-fabric" = _odRnaQxT;
        "pkg-1.0" = _wR7c69Rk;
        "pkg-1.0.0" = _2AWyOuRU;
        "pkg-1.0.1" = _OwyfY4ZL;
        "pkg-0.0.87" = _w9m2V5Hz;
        "pkg-0.0.87B" = _UMRGzdWr;
        "pkg-1.0.1B" = _ivGh4e6M;
        "pkg-1.0.2" = _UbcwJDUn;
