...
let
    ...
    in {
        ...
        "pkg-0.5+fabric-1.21.1" = _SLwv4VhR;
        "pkg-0.6+fabric-1.21.1" = _tCsN5zrc;
        "pkg-0.6+neoforge-1.21.1" = _AcGyVXNs;
        "pkg-1.0+fabric-1.21.1" = _Fpoy3oV5;
        "pkg-1.0+neoforge-1.21.1" = _wuIF5Xnc;
        "pkg-1.1+fabric-1.21.1" = _Zn8WPfSW;
