...
let
    versions = (let
        ...
        _EHO3Z4d2 = {
            "id" = "EHO3Z4d2";
            "file" = "Cool Veinminer v1.2.11.zip";
            "hash" = "sha512-O9ie6Rgk7STNMsEZ51GhMSM3JNQ+q5fl/81EhX3AkipKCQwXx0BHdDZcNmJYj/OzWhTzzmCUKGPmeZiqFyi/vQ==";
        };
        _2yxxCZBr = {
            "id" = "2yxxCZBr";
            "file" = "Cool Veinminer v1.2.13.zip";
            "hash" = "sha512-a4ywHk+ypRIQstDhLtVFe07jEn/iZ2vILTa6fBw6g6g+Grrkw35ltsqNXTXyj+bwNhtJcFbEq5bImvUdNMh1Ug==";
        };
        _a2YdbKVj = {
            "id" = "a2YdbKVj";
            "file" = "coconite-cool-veinminer-v1.2.13.jar";
            "hash" = "sha512-37OgwhIQrc59GZWVEeuoyu2iF5mlo9K+fVJcaxpsfULwuZ0rrGE1NogYm2c5yiSxccZ6fCQTmQ7uNGJQXzt2eA==";
        };
    in {
        "idzF5KTE" = _idzF5KTE;
        "6zVuExM4" = _6zVuExM4;
        ...
        "datapack-26.1" = _2yxxCZBr;
        "datapack-26.1.1" = _2yxxCZBr;
        "datapack-26.1.2" = _2yxxCZBr;
        "datapack-1.21.11" = _2yxxCZBr;
        "fabric-1.21.6" = _6zVuExM4;
        "fabric-1.21.7" = _6zVuExM4;
        "fabric-1.21.8" = _6zVuExM4;
        "fabric-1.21.9" = _6zVuExM4;
        "fabric-1.21.10" = _6zVuExM4;
        "fabric-26.1" = _a2YdbKVj;
        "fabric-26.1.1" = _a2YdbKVj;
        "fabric-26.1.2" = _a2YdbKVj;
        "fabric-1.21.11" = _a2YdbKVj;
        "forge-1.21.6" = _6zVuExM4;
        "forge-1.21.7" = _6zVuExM4;
        "forge-1.21.8" = _6zVuExM4;
        "forge-1.21.9" = _6zVuExM4;
        "forge-1.21.10" = _6zVuExM4;
        "forge-26.1" = _a2YdbKVj;
        "forge-26.1.1" = _a2YdbKVj;
        "forge-26.1.2" = _a2YdbKVj;
        "forge-1.21.11" = _a2YdbKVj;
        ...
        "neoforge-26.1" = _a2YdbKVj;
        "neoforge-26.1.1" = _a2YdbKVj;
        "neoforge-26.1.2" = _a2YdbKVj;
        "neoforge-1.21.11" = _a2YdbKVj;
        "quilt-1.21.6" = _6zVuExM4;
        "quilt-1.21.7" = _6zVuExM4;
        "quilt-1.21.8" = _6zVuExM4;
        "quilt-1.21.9" = _6zVuExM4;
        "quilt-1.21.10" = _6zVuExM4;
        "quilt-26.1" = _a2YdbKVj;
        "quilt-26.1.1" = _a2YdbKVj;
        "quilt-26.1.2" = _a2YdbKVj;
        "quilt-1.21.11" = _a2YdbKVj;
        ...
        "pkg-v1.2.11" = _EHO3Z4d2;
        "pkg-v1.2.13" = _2yxxCZBr;
        "pkg-v1.2.13+mod" = _a2YdbKVj;
        "default" = _a2YdbKVj;
    });
