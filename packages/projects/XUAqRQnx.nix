...
let
    versions = (let
        ...
        _s5plTQmE = {
            "id" = "s5plTQmE";
            "file" = "hswf3-1.0.4.jar";
            "hash" = "sha512-ZGOrPx/YV4H2HucollpCh6JaqMA0cGhTO3Dasm+UL0j4ZYI7OCz1kCI1RC+1CXGOpGljV03GBZt2UmVivw3ceA==";
        };
    in {
        "OpGhyPhV" = _OpGhyPhV;
        "nzTddhXI" = _nzTddhXI;
