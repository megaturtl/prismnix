...
let
    versions = (let
        ...
        _AXjqmHXQ = {
            "id" = "AXjqmHXQ";
            "file" = "picturemode-fabric-1.1.7+1.20.1.jar";
            "hash" = "sha512-wDmT4e5Pd/Vk87EVnMHMfjnKzBACLCArNn8kM14ibB7o6rXeMcOEUnN93i8Xyo0KGE+Zgkn2VtYhKdqP0+UrYA==";
        };
        _JEwaLMli = {
            "id" = "JEwaLMli";
            "file" = "picturemode-forge-1.1.7+1.20.1.jar";
            "hash" = "sha512-vK5HBPr53X2KnUs4f5bBn8mDLQScDE61NO6DNGOY7/0cHAnkd02nodqmAquluD2SbHRO56H49NEqzAzspGnhhg==";
        };
        _rGOwxl6s = {
            "id" = "rGOwxl6s";
            "file" = "picturemode-fabric-1.1.7+1.21.1.jar";
            "hash" = "sha512-bCqqpwVE19JBG4RtSEseWpKsHf1P87/0KCHFf8s2lUFOBx2TxmK7RHInXTRh9Bl9SN11WKvrQktUDzgvLdse9w==";
        };
        _LsxOg0qe = {
            "id" = "LsxOg0qe";
            "file" = "picturemode-neoforge-1.1.7+1.21.1.jar";
            "hash" = "sha512-UxZrv2P2rUGnBaigE7/efcekgDBR9O5NQr0utGrO0rgYK4xas0+v4jTCKys4Fdv4zBqOOXcnU6c2gC+DtYlQsg==";
        };
        _ub682kSR = {
            "id" = "ub682kSR";
            "file" = "picturemode-fabric-1.1.7+1.21.11.jar";
            "hash" = "sha512-1bb3CeBJ+YqyfO1rMVwi+s+6+gioIVVm6RtxXJBI5isjv7cggwiMq25++wFJfUEiTZ7W/TTGQsG3OB4oBwUZEQ==";
        };
        _jmArPe0K = {
            "id" = "jmArPe0K";
            "file" = "picturemode-neoforge-1.1.7+1.21.11.jar";
            "hash" = "sha512-LH77L0aB4K4pFXvE43t+pmdvCE1ZUObwCHp/S8ANZOb0Za4Jw2fS6s/dduqsKhts44pddSRq/p+mEN9kAU/4Rw==";
        };
        _2AOivMnd = {
            "id" = "2AOivMnd";
            "file" = "picturemode-fabric-1.1.7+26.1.jar";
            "hash" = "sha512-c7pOUeNN9qfrhsj3PoTNyEjja8GXze+4l7+cVwKysLv9xytbYOK8jxg0PvL0vmX8XssGFh1kucfJdd3HHBtjWw==";
        };
        _kLDG4p5I = {
            "id" = "kLDG4p5I";
            "file" = "picturemode-neoforge-1.1.7+26.1.jar";
            "hash" = "sha512-3NcOHPmxdZrIb+MyRNoBGmxa6Jhk4bp9z8X5Ivfc+y7FUYmNoudgkuPlajBXWuVk+2MjB1a+p7KPOeckM1Rgng==";
        };
        _uch2mUiR = {
            "id" = "uch2mUiR";
            "file" = "picturemode-fabric-1.1.7+26.2.jar";
            "hash" = "sha512-tNNpi873qg3uz3eD2y4ooTDNdpuq1yv/cgsqjalUZX1WM7qMPr6mt/H1mPGQmwKT5dHB2CI1cCaDW2W56Fd/9Q==";
        };
        _eAbLGpcg = {
            "id" = "eAbLGpcg";
            "file" = "picturemode-neoforge-1.1.7+26.2.jar";
            "hash" = "sha512-4428yyYF89wL9s/gz0EsbLokPvb1UtHFDkuSlBCc89NZ1EjZzY/hPaEpTV6kv6w71be049n506/K71Evt7YkLQ==";
        };
        _9ysY6G7e = {
            "id" = "9ysY6G7e";
            "file" = "picturemode-fabric-1.1.7+26.3.jar";
            "hash" = "sha512-qqYvRrjSmXdMxbObC9AAS/X7zZCkFTWP7coXIF9buc+43dvGxPROrHLj2Ep+07vZZvDOsu5bvstPoqJGNjFI2w==";
        };
        _V0jBLnjc = {
            "id" = "V0jBLnjc";
            "file" = "picturemode-neoforge-1.1.7+26.3.jar";
            "hash" = "sha512-6xwc5J4nmYqWuYfEbHQ6klr/Fc9dZqcQbjLzY2tFEh5iPKIqdovjramorWsTICrEkz/OULsJyQiQ2w+NYF/5HQ==";
        };
    in {
        "bLZz1Tug" = _bLZz1Tug;
        "MEGFo3V3" = _MEGFo3V3;
        ...
        "9ysY6G7e" = _9ysY6G7e;
        "V0jBLnjc" = _V0jBLnjc;
        "fabric-1.20" = _AXjqmHXQ;
        "fabric-1.20.1" = _AXjqmHXQ;
        "fabric-1.21.1" = _rGOwxl6s;
        "fabric-1.21.11" = _ub682kSR;
        "fabric-26.1" = _2AOivMnd;
        "fabric-26.1.1" = _2AOivMnd;
        "fabric-26.1.2" = _2AOivMnd;
        "fabric-26.2" = _uch2mUiR;
        "fabric-26.3" = _9ysY6G7e;
        "quilt-1.20" = _AXjqmHXQ;
        "quilt-1.20.1" = _AXjqmHXQ;
        "quilt-1.21.1" = _rGOwxl6s;
        "quilt-1.21.11" = _ub682kSR;
        "quilt-26.1" = _2AOivMnd;
        "quilt-26.1.1" = _2AOivMnd;
        "quilt-26.1.2" = _2AOivMnd;
        "quilt-26.2" = _uch2mUiR;
        "quilt-26.3" = _9ysY6G7e;
        "forge-1.20" = _JEwaLMli;
        "forge-1.20.1" = _JEwaLMli;
        "neoforge-1.21.1" = _LsxOg0qe;
        "neoforge-1.21.11" = _jmArPe0K;
        "neoforge-26.1" = _kLDG4p5I;
        "neoforge-26.1.1" = _kLDG4p5I;
        "neoforge-26.1.2" = _kLDG4p5I;
        "neoforge-26.2" = _eAbLGpcg;
        "neoforge-26.3" = _V0jBLnjc;
        "pkg-1.0.0+1.20.1-fabric" = _bLZz1Tug;
        "pkg-1.0.0+1.20.1-forge" = _MEGFo3V3;
        "pkg-1.0.0+1.21.1-fabric" = _PzdfV0l1;
        "pkg-1.0.0+1.21.1-neoforge" = _HDPArFTC;
        "pkg-1.0.0+1.21.11-fabric" = _WZNUy85b;
        "pkg-1.0.0+1.21.11-neoforge" = _qIoTDgUa;
        "pkg-1.0.1+1.20.1-fabric" = _AR61IOid;
        "pkg-1.0.1+1.20.1-forge" = _7DYaouLQ;
        "pkg-1.0.1+1.21.1-fabric" = _9A7SluuJ;
        "pkg-1.0.1+1.21.1-neoforge" = _fTxpI1Jf;
        "pkg-1.0.1+1.21.11-fabric" = _CdLlE9Su;
        "pkg-1.0.1+1.21.11-neoforge" = _upRy42Vp;
        "pkg-1.0.2+1.20.1-fabric" = _Ug7onFZq;
        "pkg-1.0.2+1.20.1-forge" = _sJrZKzEJ;
        "pkg-1.0.2+1.21.1-fabric" = _FGP3Gr4z;
        "pkg-1.0.2+1.21.1-neoforge" = _NpwCHywi;
        "pkg-1.0.2+1.21.11-fabric" = _zJ0WV3Ph;
        "pkg-1.0.2+1.21.11-neoforge" = _XFnEA5Gv;
        "pkg-1.0.3+1.20.1-fabric" = _DyVJQ5Hr;
        "pkg-1.0.3+1.20.1-forge" = _38npTKDJ;
        "pkg-1.0.3+1.21.1-fabric" = _vE8d5ccA;
        "pkg-1.0.3+1.21.1-neoforge" = _ebeNbzXP;
        "pkg-1.0.3+1.21.11-fabric" = _8Dfxw1nm;
        "pkg-1.0.3+1.21.11-neoforge" = _Deqgb6hF;
        "pkg-1.0.4+1.20.1-fabric" = _dAw9Gida;
        "pkg-1.0.4+1.20.1-forge" = _Sbf9pVlL;
        "pkg-1.0.4+1.21.1-fabric" = _CuusFNOW;
        "pkg-1.0.4+1.21.1-neoforge" = _y3yzyEtS;
        "pkg-1.0.4+1.21.11-fabric" = _dwrUCWLh;
        "pkg-1.0.4+1.21.11-neoforge" = _jhrkFDJ7;
        "pkg-1.0.5+1.20.1-fabric" = _ZdYikDqe;
        "pkg-1.0.5+1.20.1-forge" = _zwDOTesv;
        "pkg-1.0.5+1.21.1-fabric" = _eTuzGLS5;
        "pkg-1.0.5+1.21.1-neoforge" = _CYplzskD;
        "pkg-1.0.5+1.21.11-fabric" = _TmGyMJeN;
        "pkg-1.0.5+1.21.11-neoforge" = _rsk99T4v;
        "pkg-1.0.6+1.20.1-fabric" = _6dqxViO5;
        "pkg-1.0.6+1.20.1-forge" = _ERgzM54q;
        "pkg-1.0.6+1.21.1-fabric" = _zVSYNqJN;
        "pkg-1.0.6+1.21.1-neoforge" = _5WAf3jvu;
        "pkg-1.0.6+1.21.11-fabric" = _vAjNSPpa;
        "pkg-1.0.6+1.21.11-neoforge" = _7CqR2bK6;
        "pkg-1.0.7+1.20.1-fabric" = _NchuAw2W;
        "pkg-1.0.7+1.20.1-forge" = _JKB5cR5B;
        "pkg-1.0.7+1.21.1-fabric" = _1qapWrVz;
        "pkg-1.0.7+1.21.1-neoforge" = _mxRbnSXV;
        "pkg-1.0.7+1.21.11-fabric" = _bJ7SZiLz;
        "pkg-1.0.7+1.21.11-neoforge" = _w4A64n4t;
        "pkg-1.0.8+1.20.1-fabric" = _eAjhPc6I;
        "pkg-1.0.8+1.20.1-forge" = _NhwEsX0U;
        "pkg-1.0.8+1.21.1-fabric" = _eMga66ne;
        "pkg-1.0.8+1.21.1-neoforge" = _4IOCgCY8;
        "pkg-1.0.8+1.21.11-fabric" = _vAcqNNt9;
        "pkg-1.0.8+1.21.11-neoforge" = _YTKFyWgK;
        "pkg-1.1.0+1.20.1-fabric" = _7RhZA2e4;
        "pkg-1.1.0+1.20.1-forge" = _mzAOlP1Z;
        "pkg-1.1.0+1.21.1-fabric" = _TbU74voN;
        "pkg-1.1.0+1.21.1-neoforge" = _wGjseVte;
        "pkg-1.1.0+1.21.11-fabric" = _foAqc58Z;
        "pkg-1.1.0+1.21.11-neoforge" = _qGfihGQa;
        "pkg-1.1.1+1.20.1-fabric" = _EgyqpQtf;
        "pkg-1.1.1+1.20.1-forge" = _XqTV0gYr;
        "pkg-1.1.1+1.21.1-fabric" = _8UZXdW0x;
        "pkg-1.1.1+1.21.1-neoforge" = _oHy7evVV;
        "pkg-1.1.1+1.21.11-fabric" = _MIKxmnYG;
        "pkg-1.1.1+1.21.11-neoforge" = _ORefRXBI;
        "pkg-1.1.2+1.20.1-fabric" = _Lyc68dxi;
        "pkg-1.1.2+1.20.1-forge" = _2HKfewHC;
        "pkg-1.1.2+1.21.1-fabric" = _nkgoWciq;
        "pkg-1.1.2+1.21.1-neoforge" = _e1R6SHYK;
        "pkg-1.1.2+1.21.11-fabric" = _YgDkkFil;
        "pkg-1.1.2+1.21.11-neoforge" = _2BnqDejB;
        "pkg-1.1.3+1.20.1-fabric" = _zrU434SG;
        "pkg-1.1.3+1.20.1-forge" = _Y2WoZrHU;
        "pkg-1.1.3+1.21.1-fabric" = _gAxcrRRP;
        "pkg-1.1.3+1.21.1-neoforge" = _DDrs65Hj;
        "pkg-1.1.3+1.21.11-fabric" = _mcLvO3KQ;
        "pkg-1.1.3+1.21.11-neoforge" = _t8DdS6Vk;
        "pkg-1.1.3+26.1-fabric" = _K3wdu4J2;
        "pkg-1.1.3+26.1-neoforge" = _zS1qwOsV;
        "pkg-1.1.4+1.20.1-fabric" = _F79nBmwU;
        "pkg-1.1.4+1.20.1-forge" = _BkxWhQi0;
        "pkg-1.1.4+1.21.1-fabric" = _ov0DBgsK;
        "pkg-1.1.4+1.21.1-neoforge" = _teUNor4X;
        "pkg-1.1.4+1.21.11-fabric" = _RC4r6zWQ;
        "pkg-1.1.4+1.21.11-neoforge" = _ATTA6kzf;
        "pkg-1.1.4+26.1-fabric" = _KFIzzjqo;
        "pkg-1.1.4+26.1-neoforge" = _fpb5d3zH;
        "pkg-1.1.4+26.2-fabric" = _1ewgQeaV;
        "pkg-1.1.4+26.2-neoforge" = _rk3CDxSR;
        "pkg-1.1.5+1.20.1-fabric" = _ov7MrFtI;
        "pkg-1.1.5+1.20.1-forge" = _ytKZCMTO;
        "pkg-1.1.5+1.21.1-fabric" = _RGAmP6X3;
        "pkg-1.1.5+1.21.1-neoforge" = _N2i3F1SX;
        "pkg-1.1.5+1.21.11-fabric" = _3lfQzJl6;
        "pkg-1.1.5+1.21.11-neoforge" = _XvC8P2us;
        "pkg-1.1.5+26.1-fabric" = _udTsENPY;
        "pkg-1.1.5+26.1-neoforge" = _C9RGgUDq;
        "pkg-1.1.5+26.2-fabric" = _l4oZXsaV;
        "pkg-1.1.5+26.2-neoforge" = _TbejLakW;
        "pkg-1.1.6+1.20.1-forge" = _cg1iQ1bz;
        "pkg-1.1.6+1.20.1-fabric" = _PczvNSXp;
        "pkg-1.1.6+1.21.1-fabric" = _wnX4dFK2;
        "pkg-1.1.6+1.21.1-neoforge" = _taJQ8FZK;
        "pkg-1.1.6+1.21.11-fabric" = _KfYOgEiS;
        "pkg-1.1.6+1.21.11-neoforge" = _CrynH7he;
        "pkg-1.1.6+26.1-fabric" = _KbGUhsCQ;
        "pkg-1.1.6+26.1-neoforge" = _sZjz7URp;
        "pkg-1.1.6+26.2-fabric" = _LTRkccI4;
        "pkg-1.1.6+26.2-neoforge" = _cYRjKNCb;
        "pkg-1.1.7+1.20.1-fabric" = _AXjqmHXQ;
        "pkg-1.1.7+1.20.1-forge" = _JEwaLMli;
        "pkg-1.1.7+1.21.1-fabric" = _rGOwxl6s;
        "pkg-1.1.7+1.21.1-neoforge" = _LsxOg0qe;
        "pkg-1.1.7+1.21.11-fabric" = _ub682kSR;
        "pkg-1.1.7+1.21.11-neoforge" = _jmArPe0K;
        "pkg-1.1.7+26.1-fabric" = _2AOivMnd;
        "pkg-1.1.7+26.1-neoforge" = _kLDG4p5I;
        "pkg-1.1.7+26.2-fabric" = _uch2mUiR;
        "pkg-1.1.7+26.2-neoforge" = _eAbLGpcg;
        "pkg-1.1.7+26.3-fabric" = _9ysY6G7e;
        "pkg-1.1.7+26.3-neoforge" = _V0jBLnjc;
        "default" = _V0jBLnjc;
    });
