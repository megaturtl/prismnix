...
let
    versions = (let
        ...
        _26Mm7uPM = {
            "id" = "26Mm7uPM";
            "file" = "Mizuno Better Flowers Leaves 2.3.zip";
            "hash" = "sha512-E+zqsdJD8PrgJImc+d1UH0iH9uzHEEEfCex3qhsMJV20FGGOqzinah2N2PX3nIry27uBPHbPTkK4bDkKYBXO7w==";
        };
    in {
        "gd7OSnf1" = _gd7OSnf1;
        "JG8uaCqs" = _JG8uaCqs;
        ...
        "nY8TOlRj" = _nY8TOlRj;
        "26Mm7uPM" = _26Mm7uPM;
        "minecraft-1.20" = _26Mm7uPM;
        "minecraft-1.20.1" = _26Mm7uPM;
        "minecraft-1.20.2" = _26Mm7uPM;
        "minecraft-1.20.3" = _26Mm7uPM;
        "minecraft-1.20.4" = _26Mm7uPM;
        "minecraft-1.20.5" = _26Mm7uPM;
        "minecraft-1.20.6" = _26Mm7uPM;
        "minecraft-1.21" = _26Mm7uPM;
        "minecraft-1.21.1" = _26Mm7uPM;
        "minecraft-1.21.2" = _26Mm7uPM;
        "minecraft-1.21.3" = _26Mm7uPM;
        "minecraft-1.21.4" = _26Mm7uPM;
        ...
        "minecraft-1.21.5" = _26Mm7uPM;
        "minecraft-1.21.6" = _26Mm7uPM;
        "minecraft-1.21.7" = _26Mm7uPM;
        "minecraft-1.21.8" = _26Mm7uPM;
        "minecraft-1.21.9" = _26Mm7uPM;
        "minecraft-1.21.10" = _26Mm7uPM;
        "minecraft-1.21.11" = _26Mm7uPM;
        "minecraft-26.1" = _26Mm7uPM;
        "minecraft-26.1.1" = _26Mm7uPM;
        "minecraft-26.1.2" = _26Mm7uPM;
        "minecraft-26.2" = _26Mm7uPM;
        "minecraft-23w31a" = _26Mm7uPM;
        "minecraft-23w32a" = _26Mm7uPM;
        "minecraft-23w33a" = _26Mm7uPM;
        "minecraft-23w35a" = _26Mm7uPM;
        "minecraft-1.20.2-pre1" = _26Mm7uPM;
        "minecraft-23w42a" = _26Mm7uPM;
        "minecraft-23w43a" = _26Mm7uPM;
        "minecraft-23w43b" = _26Mm7uPM;
        "minecraft-23w44a" = _26Mm7uPM;
        "minecraft-23w45a" = _26Mm7uPM;
        "minecraft-23w46a" = _26Mm7uPM;
        "minecraft-24w03a" = _26Mm7uPM;
        "minecraft-24w03b" = _26Mm7uPM;
        "minecraft-24w04a" = _26Mm7uPM;
        "minecraft-24w05a" = _26Mm7uPM;
        "minecraft-24w05b" = _26Mm7uPM;
        "minecraft-24w06a" = _26Mm7uPM;
        "minecraft-24w07a" = _26Mm7uPM;
        "minecraft-24w09a" = _26Mm7uPM;
        "minecraft-24w10a" = _26Mm7uPM;
        "minecraft-24w11a" = _26Mm7uPM;
        "minecraft-24w12a" = _26Mm7uPM;
        "minecraft-24w13a" = _26Mm7uPM;
        "minecraft-24w14potato" = _26Mm7uPM;
        "minecraft-24w14a" = _26Mm7uPM;
        "minecraft-1.20.5-pre1" = _26Mm7uPM;
        "minecraft-1.20.5-pre2" = _26Mm7uPM;
        "minecraft-1.20.5-pre3" = _26Mm7uPM;
        "minecraft-24w18a" = _26Mm7uPM;
        "minecraft-24w19a" = _26Mm7uPM;
        "minecraft-24w19b" = _26Mm7uPM;
        "minecraft-24w20a" = _26Mm7uPM;
        "minecraft-24w33a" = _26Mm7uPM;
        "minecraft-24w34a" = _26Mm7uPM;
        "minecraft-24w35a" = _26Mm7uPM;
        "minecraft-24w36a" = _26Mm7uPM;
        "minecraft-24w37a" = _26Mm7uPM;
        "minecraft-24w38a" = _26Mm7uPM;
        "minecraft-24w39a" = _26Mm7uPM;
        "minecraft-24w40a" = _26Mm7uPM;
        "minecraft-1.21.2-pre1" = _26Mm7uPM;
        "minecraft-1.21.2-pre2" = _26Mm7uPM;
        "minecraft-24w44a" = _26Mm7uPM;
        "minecraft-24w45a" = _26Mm7uPM;
        "minecraft-24w46a" = _26Mm7uPM;
        "pkg-1.0" = _Fv0D68Sg;
        "pkg-1.1" = _XfS7G08e;
        "pkg-1.2" = _xeXbzkiP;
        "pkg-1.3" = _qbHImP2c;
