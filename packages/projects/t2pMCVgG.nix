...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _Fc453AjG;
        "pkg-1.1.0+mod" = _Dko8XMAn;
        "pkg-1.2.0" = _VFDPAS14;
        "pkg-1.2.0+mod" = _dccmF0xZ;
        "pkg-1.3.0" = _NhCHltcy;
        "pkg-1.4.1" = _Ub7K1NBg;
        "pkg-1.4.1+mod" = _YOAA4FNx;
        "pkg-1.5.0" = _1j8ZI0s2;
        "pkg-1.5.0+mod" = _hIQjGO1J;
        "pkg-24w33a" = _O2fN6xb0;
        "pkg-24w35a" = _mqkYQ6el;
        "pkg-1.6.0" = _LHCE9qjw;
        "pkg-1.6.0+mod" = _eXuedcFv;
        "pkg-1.6.2" = _DAq14Fsn;
        "pkg-1.6.2+mod" = _xajo0hQk;
        "pkg-1.6.3+mod" = _dKQbucas;
        "pkg-1.7.0" = _YCOByo1g;
