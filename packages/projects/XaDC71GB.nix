...
let
    versions = (let
        ...
        _8mWKXTUw = {
            "id" = "8mWKXTUw";
            "file" = "lithostitched-1.8.0+beta1-fabric-26.2.jar";
            "hash" = "sha512-2n6WGApKUSVKNXXOwgI3/sxJKumvN5QtgSkyTvI/sMtvT+ut7MdFMKSPyKpOtRFieuOHrOqYcb2qAvy1nQtt1Q==";
        };
        _OcLnkbHd = {
            "id" = "OcLnkbHd";
            "file" = "lithostitched-1.8.0+beta1-neoforge-26.2.jar";
            "hash" = "sha512-dqIGmg6mH5tIpGbsBrhFhxtYwNJNGD7O1ZI72VjG+rIU7b4SjtP76RpBoPufbGLVZd8N6HtBYo2aQ9MV7noxqQ==";
        };
        _Zw1TBhZs = {
            "id" = "Zw1TBhZs";
            "file" = "lithostitched-2.0.0+beta1-fabric-26.3.jar";
            "hash" = "sha512-cTlxdGrBsnEFOEKk0hN3DwsNWu2N7+/B5XFSDBzuSSl1fevjvIIRqik6hnpjCG+JeJDBiREAwv9UdFaILzCRbQ==";
        };
        _szXJ4ACg = {
            "id" = "szXJ4ACg";
            "file" = "lithostitched-1.8.0+beta2-fabric-26.2.jar";
            "hash" = "sha512-hfjB6O0aLYWrSAME92cOzV1xlgt+TPmTxIG/WRcwX3B8CX6HAdwJnEB0dU0Y0ZeHWlT4pAgpBXi/Hq9S7iExFA==";
        };
        _CC3e5VdZ = {
            "id" = "CC3e5VdZ";
            "file" = "lithostitched-1.8.0+beta2-neoforge-26.2.jar";
            "hash" = "sha512-qzN0hoUROpAwEaFcUNAjPHJBBRGSANRFzX6Rg0FnDw/FBRlZ/v8A4jnCRcdeOGfYEqSSIu7l7gdMsFlkgj7fmg==";
        };
        _evE000u9 = {
            "id" = "evE000u9";
            "file" = "lithostitched-1.8.0+beta2-fabric-26.1.jar";
            "hash" = "sha512-cplsq5sqCerbf2cFLNuO5kCOcVNa1HsSZoFbf+1fh32bae4tN1T9LZmL79r9V2CVolSQxZ9q01PaOFlOQpboPQ==";
        };
        _5CxmsL3p = {
            "id" = "5CxmsL3p";
            "file" = "lithostitched-1.8.0+beta2-neoforge-26.1.jar";
            "hash" = "sha512-ZSsZADaE+84ApBW1gkzWIIYz8gpYOQvRup3CNV68Qq4XQqgwIYPSIdgQCNBB0zutZV/JUDfDYqNOj46UkwufVQ==";
        };
        _V3XWhM8r = {
            "id" = "V3XWhM8r";
            "file" = "lithostitched-1.8.0+beta3-fabric-26.2.jar";
            "hash" = "sha512-Mvm3R7gMm1rAHumOFnSR1OpDMVjCJGL4DjAfsyI4weAfXFXd7S+yDgdFcg3n84gZcfId/vA8E1wf7VqK+y6oow==";
        };
        _uJERiR1V = {
            "id" = "uJERiR1V";
            "file" = "lithostitched-1.8.0+beta3-neoforge-26.2.jar";
            "hash" = "sha512-motrOMWAdtYBwlsD7rPzmDhUZ//VAp68e29AMomtFQ/UoLVQ3gvTv6CvSfMIwutjN0NndjCCHBCEkxi0Ln3SKQ==";
        };
        _uEgF6I2f = {
            "id" = "uEgF6I2f";
            "file" = "lithostitched-1.8.0+beta3-fabric-26.1.jar";
            "hash" = "sha512-an5MldUFf+TbhFRkvOCm92Ik7//wg9wfw75Dkszst0MlM54PsqG9l6fzLfRduX7euU/3XgF2BzdeurxCgRZ9+g==";
        };
        _9TXZ6YOv = {
            "id" = "9TXZ6YOv";
            "file" = "lithostitched-1.8.0+beta3-neoforge-26.1.jar";
            "hash" = "sha512-/z9q38u4vSSbu/MbJ7mDoKaTYhgZ1fWW9Qa91Crag5tOY3qJ1f+28XocJ50eaHOWUls+xURAk0BpKdPzuLjsfA==";
        };
        _IaX8gH5c = {
            "id" = "IaX8gH5c";
            "file" = "lithostitched-1.8.0+beta4-fabric-26.1.jar";
            "hash" = "sha512-CeDgnvj7ato36fiO71Bv/p0nF5DZBYQ9c5MmLp0676hvWvWqqsA7p5WGVy9Kys50O9I7OXW/QnAE2M8/eGjKLw==";
        };
        _UCYxoy7M = {
            "id" = "UCYxoy7M";
            "file" = "lithostitched-1.8.0+beta4-neoforge-26.1.jar";
            "hash" = "sha512-7ghTIqAAxoHDw7UoBdKfjTMo+m9bccnryNAsoyT8yd5e1UqeNCrOdORKfnRkLBfS5fYyZzHKuQDlHp41aIh91w==";
        };
        _nGdaID4W = {
            "id" = "nGdaID4W";
            "file" = "lithostitched-1.8.0+beta4-fabric-21.1.jar";
            "hash" = "sha512-w5nTBVSfd1VL22WgoKsNbf2DWFZrVs2ILnrPBq+QCKDTdT/82H4dhQatbJw0g7o3i+Lq8sSG54U9KzyAYNXlHQ==";
        };
        _81DDKTGJ = {
            "id" = "81DDKTGJ";
            "file" = "lithostitched-1.8.0+beta4-neoforge-21.1.jar";
            "hash" = "sha512-8r291mLQLUNXYWp0T4DtwUrm74ZpIK1sF366Z2plkQJtO88iQaBUJPCExL2tOivQAFXa7eWMXQYmXQOt1ydpsw==";
        };
        _vPyJwd70 = {
            "id" = "vPyJwd70";
            "file" = "lithostitched-1.8.0+beta5-fabric-21.1.jar";
            "hash" = "sha512-rwg4lLXHawsHK/y1YFVJZTV1lydDalokN9R5QdJ2azMSpslF2amd3Bdp9+0+d5umAqMHKhyGTjvkCCfWSRZb4g==";
        };
        _1WYHzavq = {
            "id" = "1WYHzavq";
            "file" = "lithostitched-2.0.0+beta2-fabric-26.3.jar";
            "hash" = "sha512-rye215VTpGrMU/6e51KiX1+Qvpytqje7oDMZ24keqTgCcgbqPa6bvgx/kxXNWsY+CnG1wkBPCwC4TzJ9VhJBjA==";
        };
        _LC0qLyud = {
            "id" = "LC0qLyud";
            "file" = "lithostitched-1.8.0+beta6-fabric-21.1.jar";
            "hash" = "sha512-2XFZzzVCmu6P5T2RAVfWosXLG5M5BwLXJ+XvgP8DOxmNXaaYAwE3ol0eov2NsMpMZ+Oc3ot6n5nrqFDZLrwWSg==";
        };
        _xDAotknu = {
            "id" = "xDAotknu";
            "file" = "lithostitched-1.8.0+beta6-neoforge-21.1.jar";
            "hash" = "sha512-02VP2rlcpbkpd4oh+zDCEk9vZuPGBnryNZUwGADXl/WE3Qmc4Eb4riiKYITpLEahYagjjRmseTvTv6zis7Lu+A==";
        };
        _tIwH2apP = {
            "id" = "tIwH2apP";
            "file" = "lithostitched-1.8.0+beta6-fabric-26.1.jar";
            "hash" = "sha512-30WXv2LqDfV3rDR3P7mIMx52vtSRNyawN1g104eM8Qs8YGncrH5BKClIoCvmbn43rfcBaCkLpTXTyhGybBCmdg==";
        };
        _dLNTbDcf = {
            "id" = "dLNTbDcf";
            "file" = "lithostitched-1.8.0+beta6-neoforge-26.1.jar";
            "hash" = "sha512-xIOBKLy+GQG9Q2aOfd/ivRuQVk6WyAv9ZwsqtKx20gm+uuAHvSQ4pArkMaR6m7c3dbvfQStQCq7EM90wPMnX9w==";
        };
        _3MjBSbla = {
            "id" = "3MjBSbla";
            "file" = "lithostitched-1.8.0+beta6-fabric-26.2.jar";
            "hash" = "sha512-hj6o0rB9BBXEmGecaCNyKFEsyirDa16lf4g0t+rV9AOD8ASgziUdA3z7e4GqcnpGnmrRw+qAemzox3v72/z5Pg==";
        };
        _I3wYsfr2 = {
            "id" = "I3wYsfr2";
    ...
    in {
        ...
        "pkg-1.1.0" = _lSEqJCDB;
        "pkg-1.1.1" = _XEx1V1hn;
        "pkg-1.1.1a" = _y49el8x8;
        "pkg-1.1.2" = _THwW3NlU;
        "pkg-1.1.3" = _BqlZtg2R;
        "pkg-1.1.4" = _1qkHiTdN;
        "pkg-1.1.4a" = _uU1zP8Xq;
        "pkg-1.1.5" = _aw2MztJz;
        "pkg-1.1.6" = _M9bgOO4Z;
        "pkg-1.1.7" = _ZeoIH2iV;
        "pkg-1.1.7a" = _yl71RvCO;
        "pkg-1.1.7b" = _il99xVpN;
        "pkg-1.2.0" = _i8IfVyvr;
        "pkg-1.2.1" = _UlXj63sO;
        "pkg-1.2.2" = _3o9iOcAT;
        "pkg-1.2.3" = _Mk3pndkm;
        ...
        "pkg-1.2.5" = _6PZ4jxK5;
        "pkg-1.1.8" = _Lhb8AZxY;
        "pkg-1.2.5a" = _yK0ChVxe;
        "pkg-1.2.6" = _1ifn2416;
        "pkg-1.3.0" = _9eH187Bd;
        "pkg-1.3.1" = _X5v9j1X1;
        "pkg-1.3.1a" = _67Uxbhc6;
        "pkg-1.3.1b" = _Bl43XrQ6;
        "pkg-1.3.2" = _deAmWZXP;
        "pkg-1.3.3" = _B7lT1iMp;
        "pkg-1.3.4" = _wHZ4Skp8;
        "pkg-1.3.5" = _4bkoJo29;
        ...
        "pkg-1.3.8" = _W941TUQ6;
        "pkg-1.3.9" = _KSbGuaNO;
        "pkg-1.3.10" = _2U6vToGD;
        "pkg-1.4" = _PxDlrVW2;
        "pkg-1.4.1" = _GwhILiJf;
        "pkg-1.4.2" = _73Oigiov;
        "pkg-1.4.3" = _AVzJAkCU;
        "pkg-1.4.4-forge-1.20" = _4ooXso77;
        "pkg-1.4.4-fabric-1.20" = _fFfu2FPH;
        "pkg-1.4.4-neoforge-1.21" = _9eV0Gw8j;
        "pkg-1.4.4-fabric-1.21" = _9vC8BP1Y;
        "pkg-1.4.4-fabric-1.21.4" = _qudfWIOD;
        "pkg-1.4.4-neoforge-1.21.4" = _5gtSAuUE;
        "pkg-1.4.5-neoforge-1.21.4" = _sidG8iZo;
        "pkg-1.4.5-fabric-1.21.4" = _n1TiLJEh;
        "pkg-1.4.5-fabric-1.21" = _GyOXVW9s;
        "pkg-1.4.5-neoforge-1.21" = _1nTTeEvq;
        "pkg-1.4.6+beta-neoforge-1.21.5" = _El3s64kH;
        "pkg-1.4.6+beta-fabric-1.21.5" = _3ujVE3vK;
        "pkg-1.4.6-neoforge-1.21.5" = _rJIa3tih;
        "pkg-1.4.6-fabric-1.21.5" = _47OkCgjv;
        "pkg-1.4.7-neoforge-1.21.5" = _egww3dtk;
        "pkg-1.4.7-fabric-1.21.5" = _KrpeNXfE;
        "pkg-1.4.7-forge-1.20" = _Pb1EulAd;
        "pkg-1.4.7-fabric-1.21" = _bkx5QyZD;
        "pkg-1.4.7-neoforge-1.21" = _fJ9j38WC;
        "pkg-1.4.7-fabric-1.20" = _YVcDAFIj;
        "pkg-1.4.8-forge-1.20" = _GlnFzC0w;
        "pkg-1.4.8-fabric-1.20" = _aQ7zXkNj;
        "pkg-1.4.8-neoforge-1.21.5" = _ZgKQ5gKA;
        "pkg-1.4.8-fabric-1.21.5" = _wupt6y4U;
        "pkg-1.4.8-neoforge-1.21" = _tqkhEU8J;
        "pkg-1.4.8-fabric-1.21" = _ZkxZEzOO;
        "pkg-1.4.9-neoforge-1.21.6" = _10V7mRXp;
        "pkg-1.4.9-fabric-1.21.6" = _pUosRaxD;
        "pkg-1.4.9-fabric-1.20" = _Sm5aDOhQ;
        "pkg-1.4.9-forge-1.20" = _tPdM2HEI;
        "pkg-1.4.9-fabric-1.21" = _9JxdHKwd;
        "pkg-1.4.9-neoforge-1.21" = _SMyZBK8W;
        "pkg-1.4.10-neoforge-1.21" = _EyQwt9dC;
        "pkg-1.4.10-fabric-1.21" = _vLnN5pWC;
        "pkg-1.4.10-forge-1.20" = _jlXvKth9;
        "pkg-1.4.10-fabric-1.20" = _owa0e2tu;
        "pkg-1.4.10-neoforge-1.21.6" = _N2BR3RIj;
        "pkg-1.4.10-fabric-1.21.6" = _YYlpIm9Y;
        "pkg-1.4.11-neoforge-1.21.6" = _iR8K35Nc;
        "pkg-1.4.11-fabric-1.21.6" = _ROo8a9VV;
        "pkg-1.4.11-forge-1.20" = _srPoHKt8;
        "pkg-1.4.11-fabric-1.20" = _9bbVphAR;
        "pkg-1.4.11-fabric-1.21" = _6CQBDLeo;
        "pkg-1.4.11-neoforge-1.21" = _r3TO8PWe;
        "pkg-1.5.0+beta2" = _jThjvk79;
        "pkg-1.5.0+beta3" = _3E8yuakf;
        "pkg-1.5.0+beta4" = _43oTdIaO;
        "pkg-1.5.0+beta5" = _AYjLTgnZ;
        "pkg-1.5.0-beta6-fabric-1.21.1" = _CD0tXkXN;
        "pkg-1.5.0-beta6-neoforge-1.21.1" = _4YkDhFjR;
        "pkg-1.5.0-beta6-fabric-1.21.9" = _5zV4yxgE;
        "pkg-1.5.0-beta6-neoforge-1.21.9" = _NqxuZmvR;
        "pkg-1.5.0-fabric-1.21.1" = _7FWLrZRG;
        "pkg-1.5.0-neoforge-1.21.1" = _LB6vOkpN;
        "pkg-1.5.0-fabric-1.21.9" = _xJFiGgq5;
        "pkg-1.5.0-neoforge-1.21.9" = _muQreCQd;
        "pkg-1.5.1-fabric-1.21.9" = _OHVYggvo;
        "pkg-1.5.1-neoforge-1.21.9" = _sfzhADx6;
        "pkg-1.5.2-fabric-1.21.1" = _W5lr8Dq8;
        "pkg-1.5.2-neoforge-1.21.1" = _dGZOQXkv;
        "pkg-1.5.2-fabric-1.21.9" = _wOA5KvR7;
        "pkg-1.5.2-neoforge-1.21.9" = _qH7PeRGc;
        "pkg-1.5.2+beta-fabric-1.21.11" = _bazvfYZx;
        "pkg-1.5.2+beta2-fabric-1.21.11" = _q0yQv0hJ;
        "pkg-1.5.2+beta3-fabric-1.21.11" = _nSdrLuzi;
        "pkg-1.5.3-fabric-1.21.1" = _4tCWNzRs;
        "pkg-1.5.3-neoforge-1.21.1" = _ltnBesQ4;
        "pkg-1.5.3-fabric-1.21.11" = _3RS9RCdM;
        "pkg-1.5.4-fabric-1.21.1" = _8ejFEAN1;
        "pkg-1.5.4-neoforge-1.21.1" = _8FDhXGkE;
        "pkg-1.5.4-fabric-1.21.11" = _4AditOOw;
        "pkg-1.5.5-fabric-1.21.11" = _R8tzGJEg;
        "pkg-1.5.5-neoforge-1.21.11" = _tlUB88cR;
        "pkg-1.5.6-fabric-1.21.1" = _7juk2sFy;
        "pkg-1.5.6-neoforge-1.21.1" = _oqWcDEXt;
        "pkg-1.5.6-fabric-1.21.11" = _5XPoyN41;
        "pkg-1.5.6-neoforge-1.21.11" = _VOWOZ70H;
        "pkg-1.5.7-fabric-1.21.1" = _hnDvNHU5;
        "pkg-1.5.7-neoforge-1.21.1" = _HsoCbRc0;
        "pkg-1.5.7-fabric-1.21.11" = _FPDWwi24;
        "pkg-1.5.7-neoforge-1.21.11" = _j0YAyhw5;
        "pkg-1.5.2+patched-fabric-1.21.9" = _pqqSPaU1;
        "pkg-1.5.2+patched-neoforge-1.21.9" = _5oukMAVM;
        "pkg-1.5.8+beta1-fabric-1.21.11" = _IjBnDq5M;
        "pkg-1.5.8+beta1-neoforge-1.21.11" = _PwQDHzKh;
        "pkg-1.6.0-fabric-1.21.1" = _C9AlqLDr;
        "pkg-1.6.0-neoforge-1.21.1" = _u0UUKAE1;
        "pkg-1.6.0-neoforge-1.21.11" = _MUjzy4r6;
        "pkg-1.6.0-fabric-1.21.11" = _DvzY3V1N;
        "pkg-1.6.1-fabric-1.21.1" = _uGT59zm8;
        "pkg-1.6.1-neoforge-1.21.1" = _bVdEj2PN;
        "pkg-1.6.1-fabric-1.21.11" = _s47RpVwc;
        "pkg-1.6.1-neoforge-1.21.11" = _uGuXv4mf;
        "pkg-1.6.1-fabric-26.1" = _iPgB29cQ;
        "pkg-1.6.2-fabric-26.1" = _c8naK58f;
        "pkg-1.6.3-fabric-21.1" = _3FYJ1BM0;
        "pkg-1.6.3-neoforge-21.1" = _W21CcpMS;
        "pkg-1.6.3-fabric-26.1" = _RB4mRKiW;
        "pkg-1.6.3-neoforge-26.1" = _8lrcr7D5;
        "pkg-1.6.4-fabric-26.1" = _VRT5Kd0J;
        "pkg-1.6.5-neoforge-21.1" = _keVceya0;
        "pkg-1.6.6-fabric-21.1" = _orpD4CtS;
        "pkg-1.6.6-neoforge-21.1" = _Ny5JYVK8;
        "pkg-1.6.6-fabric-26.1" = _uTBNgYlX;
        "pkg-1.6.6-neoforge-26.1" = _SVfupF3y;
        "pkg-1.6.8-fabric-21.1" = _Awf91DUj;
        "pkg-1.6.8-neoforge-21.1" = _nWAodGqn;
        "pkg-1.6.8-fabric-26.1" = _cpx9Z91F;
        "pkg-1.6.8-neoforge-26.1" = _EdboZN0P;
        "pkg-1.7.0-fabric-21.1" = _DqSiUObM;
        "pkg-1.7.0-neoforge-21.1" = _29zrKXCQ;
        "pkg-1.7.0-fabric-26.1" = _lHeQvxBP;
        "pkg-1.7.0-neoforge-26.1" = _AR4k6eKl;
        "pkg-1.7.1-fabric-21.1" = _s3lXDw5k;
        "pkg-1.7.1-neoforge-21.1" = _zilMIERn;
        "pkg-1.7.1-fabric-26.1" = _lX6mmu1r;
        "pkg-1.7.1-neoforge-26.1" = _2lxRsZ38;
        "pkg-1.7.1-fabric-21.11" = _DcOA0Kr8;
        "pkg-1.7.1-neoforge-21.11" = _vfSegGQj;
        "pkg-1.7.2-fabric-21.1" = _fC8zqqCw;
        "pkg-1.7.2-neoforge-21.1" = _IONexlgI;
        "pkg-1.7.2-fabric-21.11" = _pLbQKCOo;
        "pkg-1.7.2-neoforge-21.11" = _GXKf1eIb;
        "pkg-1.7.2-fabric-26.1" = _cHH1mPJL;
        "pkg-1.7.2-neoforge-26.1" = _38blSvuj;
        "pkg-1.7.3-fabric-21.1" = _k6rZFn8O;
        "pkg-1.7.3-neoforge-21.1" = _3yrFEAmj;
        "pkg-1.7.3-fabric-26.1" = _c15SCJb4;
        "pkg-1.7.3-neoforge-26.1" = _J126Y1Qn;
        "pkg-1.7.4-fabric-26.1" = _9nDhxdpJ;
        "pkg-1.7.4-neoforge-26.1" = _9vlju9iP;
        "pkg-1.7.5-fabric-21.1" = _eGXtrbjv;
        "pkg-1.7.5-neoforge-21.1" = _2L1EEQuD;
        "pkg-1.7.5-fabric-26.1" = _e8OW6FmT;
        "pkg-1.7.5-neoforge-26.1" = _jnxUqllz;
        "pkg-1.7.6-fabric-21.1" = _VlrjQMuR;
        "pkg-1.7.6-neoforge-21.1" = _rs8lbH3l;
        "pkg-1.7.6-fabric-26.1" = _9ffY9XYq;
        "pkg-1.7.6-neoforge-26.1" = _G5ChnMvB;
        "pkg-1.7.7-fabric-21.1" = _UrEAYvpA;
        "pkg-1.7.7-neoforge-21.1" = _Nf30FMLg;
        "pkg-1.7.7-fabric-26.1" = _dUL7i4Qf;
        "pkg-1.7.7-neoforge-26.1" = _Rt3kP2eG;
        "pkg-1.7.8-fabric-21.1" = _aHB4JwVm;
        "pkg-1.7.8-neoforge-21.1" = _vIIBwaTC;
        "pkg-1.7.8-fabric-26.1" = _lXabpVUu;
        "pkg-1.7.8-neoforge-26.1" = _Vu5IprSX;
        "pkg-1.7.9-fabric-21.1" = _ZjFsh9FY;
        "pkg-1.7.9-neoforge-21.1" = _wiffJSbz;
        "pkg-1.7.9-fabric-26.1" = _BpryyUmm;
        "pkg-1.7.9-neoforge-26.1" = _8dph4uud;
        "pkg-1.7.10+beta1-fabric-26.2" = _yGSoko4W;
        "pkg-1.7.10+beta2-fabric-26.2" = _ajoSD1bp;
        "pkg-1.7.10+beta3-fabric-21.1" = _rDSTrJc3;
        "pkg-1.7.10+beta3-neoforge-21.1" = _cSWf6M1G;
        "pkg-1.7.10+beta3-fabric-26.1" = _zApqlwEz;
        "pkg-1.7.10+beta3-neoforge-26.1" = _PKylDqH5;
        "pkg-1.7.10+beta3-fabric-26.2" = _9IkvyOry;
        "pkg-1.7.10+beta4-fabric-21.1" = _i8FWtMyK;
        "pkg-1.7.10+beta4-neoforge-21.1" = _4mhJgBQx;
        "pkg-1.7.10+beta4-fabric-26.1" = _ePXn1Tua;
        "pkg-1.7.10+beta4-neoforge-26.1" = _a3s1jQXv;
        "pkg-1.7.10+beta4-fabric-26.2" = _UOU7MTZm;
        "pkg-1.7.10-fabric-26.2" = _eVgvp3rW;
        "pkg-1.7.10-neoforge-26.2" = _jIOUQsem;
        "pkg-1.7.11-fabric-21.1" = _W6NUEdBO;
        "pkg-1.7.11-neoforge-21.1" = _a9fuYUVh;
        "pkg-1.7.11-fabric-26.1" = _4gLn3Ghy;
        "pkg-1.7.11-neoforge-26.1" = _r2BIuJ7B;
        "pkg-1.7.11-fabric-26.2" = _dfKVlHQ4;
        "pkg-1.7.11-neoforge-26.2" = _o69T0SUo;
        "pkg-1.7.12-fabric-21.1" = _xziCgMIU;
        "pkg-1.7.12-neoforge-21.1" = _vioNV2Gt;
        "pkg-1.7.12-fabric-26.1" = _7gxI2iZP;
        "pkg-1.7.12-neoforge-26.1" = _TTFc5DdC;
        "pkg-1.7.12-fabric-26.2" = _v0V661Hk;
        "pkg-1.7.12-neoforge-26.2" = _9PGolVgp;
        "pkg-1.7.13-fabric-21.1" = _JWtSqSeY;
        "pkg-1.7.13-neoforge-21.1" = _qPASucBM;
        "pkg-1.7.13-fabric-26.1" = _ynxuBCd2;
        "pkg-1.7.13-neoforge-26.1" = _84kuUpr4;
        "pkg-1.7.13-fabric-26.2" = _vVFCOh7u;
        "pkg-1.7.13-neoforge-26.2" = _6MLzMiOP;
        "pkg-1.8.0+beta1-fabric-26.2" = _8mWKXTUw;
        "pkg-1.8.0+beta1-neoforge-26.2" = _OcLnkbHd;
        "pkg-2.0.0+beta1-fabric-26.3" = _Zw1TBhZs;
        "pkg-1.8.0+beta2-fabric-26.2" = _szXJ4ACg;
        "pkg-1.8.0+beta2-neoforge-26.2" = _CC3e5VdZ;
        "pkg-1.8.0+beta2-fabric-26.1" = _evE000u9;
        "pkg-1.8.0+beta2-neoforge-26.1" = _5CxmsL3p;
        "pkg-1.8.0+beta3-fabric-26.2" = _V3XWhM8r;
        "pkg-1.8.0+beta3-neoforge-26.2" = _uJERiR1V;
        "pkg-1.8.0+beta3-fabric-26.1" = _uEgF6I2f;
        "pkg-1.8.0+beta3-neoforge-26.1" = _9TXZ6YOv;
        "pkg-1.8.0+beta4-fabric-26.1" = _IaX8gH5c;
        "pkg-1.8.0+beta4-neoforge-26.1" = _UCYxoy7M;
        "pkg-1.8.0+beta4-fabric-21.1" = _nGdaID4W;
        "pkg-1.8.0+beta4-neoforge-21.1" = _81DDKTGJ;
        "pkg-1.8.0+beta5-fabric-21.1" = _vPyJwd70;
        "pkg-2.0.0+beta2-fabric-26.3" = _1WYHzavq;
        "pkg-1.8.0+beta6-fabric-21.1" = _LC0qLyud;
        "pkg-1.8.0+beta6-neoforge-21.1" = _xDAotknu;
        "pkg-1.8.0+beta6-fabric-26.1" = _tIwH2apP;
