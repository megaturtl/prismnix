...
let
    ...
    in {
        ...
        "pkg-2.0.1+1.18" = _XwMi4hpK;
        "pkg-2.1.0+1.19" = _Ki8F4vCn;
        "pkg-2.1.0+1.18" = _Saucd4KM;
        "pkg-2.2.0+1.18" = _daDnWogS;
        "pkg-2.2.0+1.19" = _CtZ4HYD4;
        "pkg-2.3.0+1.18" = _FNog9kK9;
        "pkg-2.3.0+1.19" = _4cMHc0xX;
        "pkg-2.3.1" = _FbzWPUmP;
        "pkg-2.3.1+1.19.3" = _PBxoF9LW;
        "pkg-2.4.0" = _HRv8PhOY;
        "pkg-2.5.0" = _NZzKd7EZ;
        "pkg-2.6.0" = _e9Az4uaX;
        "pkg-2.6.1" = _Cm1VPyWo;
        "pkg-1.20-6.0.14" = _mwgtkaCk;
        "pkg-1.20-6.0.15" = _3s1tB38E;
        "pkg-fabric_1.21-6.1.0" = _ZNAoh75E;
        "pkg-fabric_1.21-6.1.1" = _9oLZUtNj;
        "pkg-fabric_1.21-6.1.2" = _wTEPA0Cr;
        "pkg-fabric_1.21-6.1.3" = _5yoC2TBC;
        "pkg-fabric_1.21-6.1.4" = _MqTCg9ot;
        "pkg-fabric_1.21-6.1.5" = _DY2DSNpm;
        "pkg-fabric_1.21-6.1.6" = _hkA9HUwV;
        "pkg-fabric_1.21-6.2.0" = _Thnzf0wz;
        "pkg-fabric_1.21-6.2.1" = _g6IGsyeC;
        "pkg-fabric_1.21-6.3.0" = _PKamYAKN;
        "pkg-fabric_1.21-6.3.1" = _Lm6tWvaf;
        "pkg-fabric_1.21-6.3.2" = _T0Sp0lGp;
        "pkg-fabric_1.21-6.3.3" = _AQg4YfQp;
        "pkg-1.20-6.0.16" = _X3yDvO9E;
        "pkg-fabric_1.21-6.3.4" = _OkJRnfuT;
        "pkg-fabric_1.21-6.3.5" = _IMzmW6VE;
        "pkg-fabric_1.21-6.3.6" = _uJh1lvoP;
        "pkg-1.20-6.0.17" = _S2h4T3Nu;
        "pkg-1.20-6.0.18" = _vmeMJ6HU;
        "pkg-fabric_1.21-6.4.0" = _taR0BJQT;
        "pkg-1.21-6.5.0-fabric" = _U7DI0cms;
        "pkg-1.21-6.5.1-fabric" = _gMYXmWb8;
        "pkg-1.20-6.0.19" = _whOM14jo;
        "pkg-1.21-6.5.2-fabric" = _pjeFqYiJ;
        "pkg-1.21-6.5.3-fabric" = _KCOcD2Se;
        "pkg-1.21-6.6.0" = _4UFBdsdn;
        "pkg-1.21-6.6.1" = _IEekEVUp;
