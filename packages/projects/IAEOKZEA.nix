...
let
    versions = (let
        ...
        _I4FvgmCu = {
            "id" = "I4FvgmCu";
            "file" = "Bare Bones PBR.zip";
            "hash" = "sha512-6XsfJJIxkL2EsJCWsSHrK2B5b5CcHGyX0++FSbzLPHd5Yl0w1p6sgfJ5kXRYKpdJaVfkyLJTJ0KNYw7JHV5fFw==";
        };
        _mfXsrE4e = {
            "id" = "mfXsrE4e";
            "file" = "Bare Bones PBR.zip";
            "hash" = "sha512-yt93StKmuSiUpJKtcXRe9DTb+b8VKYmOTsclzjlKeALYok1v947tG1QExfP7xRWtDHEhmHzUQ53Eh4fAVAmcHg==";
        };
        _jUJVsAVS = {
            "id" = "jUJVsAVS";
            "file" = "Bare Bones PBR.zip";
            "hash" = "sha512-Zuo+8J+diFx81VlOJF0tdbF4mbeoWBy6WMkm9W04LYjA+/rewYuuEqFQyWE3V/4ElNP9LkICy36d6/hHyqId0A==";
        };
    in {
        "zcdrKJTR" = _zcdrKJTR;
        "FakJtsse" = _FakJtsse;
        ...
        "mfXsrE4e" = _mfXsrE4e;
        "jUJVsAVS" = _jUJVsAVS;
        "minecraft-1.21" = _jUJVsAVS;
        "minecraft-1.21.1" = _jUJVsAVS;
        "minecraft-1.21.2" = _jUJVsAVS;
        "minecraft-1.21.3" = _jUJVsAVS;
        "minecraft-1.21.4" = _jUJVsAVS;
        "minecraft-1.21.5" = _jUJVsAVS;
        "minecraft-1.21.6" = _jUJVsAVS;
        "minecraft-1.21.7" = _jUJVsAVS;
        "minecraft-1.21.8" = _jUJVsAVS;
        "minecraft-1.17" = _jUJVsAVS;
        "minecraft-1.17.1" = _jUJVsAVS;
        "minecraft-1.18" = _jUJVsAVS;
        "minecraft-1.18.1" = _jUJVsAVS;
        "minecraft-1.18.2" = _jUJVsAVS;
        "minecraft-1.19" = _jUJVsAVS;
        "minecraft-1.19.1" = _jUJVsAVS;
        "minecraft-1.19.2" = _jUJVsAVS;
        "minecraft-1.19.3" = _jUJVsAVS;
        "minecraft-1.19.4" = _jUJVsAVS;
        "minecraft-1.20" = _jUJVsAVS;
        "minecraft-1.20.1" = _jUJVsAVS;
        "minecraft-1.20.2" = _jUJVsAVS;
        "minecraft-1.20.3" = _jUJVsAVS;
        "minecraft-1.20.4" = _jUJVsAVS;
        "minecraft-1.20.5" = _jUJVsAVS;
        "minecraft-1.20.6" = _jUJVsAVS;
        "minecraft-1.21.9" = _jUJVsAVS;
        "minecraft-1.21.10" = _jUJVsAVS;
        "minecraft-1.21.11" = _jUJVsAVS;
        ...
        "minecraft-1.16.5" = _jUJVsAVS;
        "minecraft-26.1" = _jUJVsAVS;
        "minecraft-26.1.1" = _jUJVsAVS;
        "minecraft-26.1.2" = _jUJVsAVS;
        "minecraft-26.2" = _jUJVsAVS;
        "minecraft-26.3" = _jUJVsAVS;
        "pkg-1.0" = _zcdrKJTR;
        "pkg-1.1" = _FakJtsse;
        "pkg-1.2" = _30PnP2VM;
        "pkg-1.3" = _EokWwehR;
