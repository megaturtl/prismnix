...
let
    versions = (let
        ...
        _nj4Qvfcl = {
            "id" = "nj4Qvfcl";
            "file" = "fullbrightnesstoggle-fabric-1.0.3+mc1.21.11.jar";
            "hash" = "sha512-ga44Pn+7fhMaBIIXQKxVv3TH6V2+mt7kuxrBnOpEKIvh/B44UoveNnY+IxKZMC+cTp1hxTuc6NxtsJ1gJvnOUQ==";
        };
        _u7g3o7s4 = {
            "id" = "u7g3o7s4";
    ...
    in {
        ...
        "pkg-1.0.0-1.21.4" = _KEXlreOc;
        "pkg-1.0.0-1.21.5" = _xyk4F2w9;
        "pkg-1.0.0-1.21.6" = _UZ10q0p1;
        "pkg-1.0.1-1.21.10" = _fj3iNab8;
        "pkg-1.0.0-1.21" = _S0kp35BO;
        "pkg-1.0.1-1.21" = _uc7Zlt8G;
        "pkg-1.0.1-1.21.1" = _3YGBDNEU;
        "pkg-1.0.1-1.21.2" = _FGzvXTMZ;
        "pkg-1.0.1-1.21.3" = _D8LXFuhD;
        "pkg-1.0.1-1.21.4" = _zVqfzYVA;
        "pkg-1.0.1-1.21.5" = _sc6XymIv;
        "pkg-1.0.1-1.21.6" = _x6e3bnyd;
        "pkg-1.0.1-1.21.7" = _KRisT0Ff;
        "pkg-1.0.2-1.21.10" = _QQ74zJvj;
        "pkg-1.0.3-1.21.9" = _t5q0Ovbl;
        "pkg-1.0.3-1.21.10" = _wlRq15DQ;
        "pkg-1.0.1-1.21.8" = _vvdjuyIh;
        "pkg-1.0.1-1.20" = _pDXQ1qjQ;
        "pkg-1.0.1-1.20.1" = _ame28DrF;
        "pkg-1.0.1-1.20.2" = _1GloLIW6;
        "pkg-1.0.1-1.20.3" = _iQqn0Fvz;
        "pkg-1.0.1-1.20.4" = _GNrd0vIr;
        "pkg-1.0.1-1.20.5" = _wJ6bWoof;
        "pkg-1.0.1-1.20.6" = _5lKTBOGW;
        "pkg-1.0.2-1.19" = _unRgvUuz;
        "pkg-1.0.2-1.19.1" = _R5m7wEAk;
        "pkg-1.0.2-1.19.2" = _8Nr82DVx;
        "pkg-1.0.2-1.19.3" = _JSg5AfYj;
        "pkg-1.0.2-1.19.4" = _nXMy2wvi;
        "pkg-1.0.2-1.18" = _cpbMcZ37;
        "pkg-1.0.2-1.18.1" = _Nfo5wTAU;
