...
let
    versions = (let
        ...
        _cVh7IiR1 = {
            "id" = "cVh7IiR1";
            "file" = "simply-no-shading-8.0.0-alpha.6+mc26.3-rc-2.jar";
            "hash" = "sha512-XFcKRbPqsOcvJuXZqIuXL6skm7AzWjoFtcyfOXhPoz2Sx9niDs04VB0QKNhaOKg+yKbJVUDO/M0u4BUrPp6p1w==";
        };
    in {
        "GtvlePOY" = _GtvlePOY;
        "EWbgdQrw" = _EWbgdQrw;
        ...
        "fabric-26.3-rc-2" = _cVh7IiR1;
        "pkg-1.0.0+mc1.17.1" = _GtvlePOY;
        "pkg-1.0.0+mc1.18" = _EWbgdQrw;
        "pkg-3.0.0+mc1.18.x" = _OkuExFfg;
        "pkg-4.0.0+mc1.18.x" = _6RUVkPQp;
        "pkg-4.1.0+mc1.18.x" = _idvWNTrM;
        "pkg-4.1.0+1.18.x-build.70-alpha-alpha" = _tojiexDI;
        "pkg-4.1.0+1.18.x-build.71-alpha" = _WKC9XE9r;
        "pkg-4.1.0+1.18.x-build.72-alpha" = _IYAqikjU;
        "pkg-4.1.0+-build.74-alpha" = _W4ro0uVE;
        "pkg-4.1.0-build.75-alpha" = _gfji2Rk7;
        "pkg-4.1.0" = _G5mYFpWe;
        "pkg-4.1.0-build.78-alpha" = _rZSox6Mh;
        "pkg-4.1.0-build.79-alpha" = _uiWLlFtv;
        "pkg-4.1.0-build.80-alpha" = _yyC02EDv;
        "pkg-4.1.0-build.81-alpha" = _Jb9jVdtz;
        "pkg-4.1.0-build.82-alpha" = _yDniz48s;
        "pkg-4.1.0-build.83-alpha" = _bhQnUABT;
        "pkg-4.1.0-build.85-alpha" = _qCr3cfNt;
        "pkg-4.1.0-build.1-alpha" = _aN7jCPc1;
        "pkg-4.1.0-build.86-alpha" = _KsZE5gOi;
        "pkg-4.1.0-build.87-alpha" = _lZuok1gD;
        "pkg-4.1.0-build.88-alpha" = _AovDeC2p;
        "pkg-4.1.1" = _ahW7cxfN;
        "pkg-4.1.2" = _y5DsAwxb;
        "pkg-4.1.4" = _NJdD0Oim;
        "pkg-4.1.5" = _GWtKA66m;
        ...
        "pkg-4.1.8" = _NXS2aNkT;
        "pkg-4.1.9" = _BpxhRiHF;
        "pkg-4.1.10" = _eIeAHwob;
        "pkg-4.1.11" = _blLu1oYY;
        "pkg-4.1.12" = _tqgEKqbR;
        "pkg-4.1.13" = _B9o07VJJ;
        "pkg-4.1.14" = _aD56Wct6;
        "pkg-4.1.15" = _pMtIbJlr;
        "pkg-4.1.17" = _vql9U092;
        "pkg-4.1.18" = _u36Mhptk;
        "pkg-4.2.0" = _41Fwz6vI;
        "pkg-4.2.1" = _7uOmO9p5;
        "pkg-4.2.2" = _HGVE7ijA;
        "pkg-4.2.4" = _97oDUSte;
        ...
        "pkg-4.2.7" = _cMCrG1cg;
        "pkg-4.2.9" = _E1O60tWI;
        "pkg-4.2.10" = _k0WuTaIv;
        "pkg-4.2.11" = _kVVXSdqU;
        "pkg-4.2.12" = _XNUIFF65;
        "pkg-4.2.13" = _bAMDtgcC;
        "pkg-4.2.14" = _FsxgIUhP;
        "pkg-4.2.15" = _tuhTMWOd;
        "pkg-4.2.16" = _ulzxIAs9;
        "pkg-4.2.17" = _9nmaCywP;
        "pkg-4.2.18" = _zjlCOW4D;
        "pkg-4.2.19" = _5epfX1hV;
        "pkg-4.2.20" = _ElSuuP76;
        "pkg-4.2.21" = _uLTl2OLu;
        "pkg-4.2.22" = _7VbUNNbT;
        "pkg-4.2.23" = _j0ojkSL2;
        "pkg-4.2.24" = _DIWKi7Q1;
        "pkg-4.2.25" = _IpaemPCR;
        "pkg-4.2.26" = _BZgC2TQ6;
        "pkg-4.2.27" = _AmTXju4J;
        "pkg-4.3.0" = _UsA4SCJo;
        "pkg-4.3.1" = _QlGYZvNc;
        "pkg-4.3.2" = _rk4a0KxB;
        "pkg-4.3.3" = _XbV1FcJv;
        ...
        "pkg-4.5.8" = _l88ivvoA;
        "pkg-4.5.9" = _R9BYXbhH;
        "pkg-mc1.18.2-5.0.0-snapshot1" = _IHXq38ad;
        "pkg-1.18.2-5.0.0-snapshot.2" = _n1wxjEqp;
        "pkg-5.0.0-snapshot.3+mc1.18.2" = _LATCjiVC;
        "pkg-5.0.0-snapshot.4+mc1.18.2" = _ckOT8jcq;
        "pkg-5.0.0-snapshot.5+mc1.18.2" = _KG1rdkGK;
        "pkg-fabric-mc1.18.2-5.0.0-snapshot.6" = _7kyVlHnK;
        "pkg-fabric-mc1.19-5.0.0-snapshot.6" = _Mc2r8ORZ;
        "pkg-fabric-mc1.18.2-5.0.0-snapshot.7" = _3ZHbDL0f;
        "pkg-fabric-mc1.19-5.0.0-snapshot.7" = _BzNsMqwP;
        "pkg-5.0.0-snapshot.8+1.18.2" = _SMpN9V80;
        "pkg-5.0.0.snapshot.8+1.19" = _x3yWN5Ds;
        "pkg-5.0.0-pre.1+1.19" = _ACKij8bS;
        "pkg-5.0.0-pre.1+1.18.2" = _ACU5lYXB;
        "pkg-5.0.0+1.18.2" = _jlcyT6vM;
        "pkg-5.0.0+1.19" = _DgjB0btr;
        "pkg-5.0.1+1.18.2" = _fsLVVdYT;
        "pkg-5.0.1+1.19" = _Mq2eInGX;
        "pkg-5.0.2-snapshot.1+1.18.2" = _KTlAUIZb;
        "pkg-5.0.2-snapshot.2+1.18.2" = _sPDhSqRV;
        "pkg-5.0.3-snapshot.2+1.18.2" = _YFFhOZUR;
        "pkg-5.0.3-pre.4+1.18.2" = _7loGjLTW;
        "pkg-5.0.3+1.19" = _AOwCDjtH;
        "pkg-5.0.3+1.18.2" = _UvQQR7W9;
        "pkg-5.0.3+1.19.2" = _GfbGrdnB;
        "pkg-5.0.4+1.18.2" = _hG4pGsxM;
        "pkg-5.0.4+1.19.2" = _XG7mnIW3;
        "pkg-5.0.4+1.19" = _LgQgMhBO;
        "pkg-5.1.0-pre.1+1.19.2" = _LDoVaLiU;
        "pkg-5.1.0-pre.2+1.19.2" = _pyITlugw;
        "pkg-5.1.0-pre.2+1.19.3" = _iSH3zBxy;
        "pkg-5.1.0-snapshot.1+1.19.2" = _rezoACDI;
        "pkg-5.1.0-snapshot.1+1.19.3" = _YAVBv5y9;
        "pkg-6.0.0-snapshot.2+1.19.3" = _Ay0QYSd2;
        "pkg-6.0.0-snapshot.3+1.19.3" = _ldn9L9De;
        "pkg-6.0.0-pre.4+1.19.3" = _VYjngEEt;
        "pkg-6.0.0-rc.1+1.19.3" = _VA6s8IBu;
        "pkg-6.0.0+1.19.3" = _JSyfbBc2;
        "pkg-6.0.1+1.19.4" = _5ncTVPCZ;
        "pkg-6.0.2+23w12a" = _wSRQYCrj;
        "pkg-6.0.3+1.19.4" = _q99Y99yT;
        "pkg-6.0.3+23w12a" = _kxgU2i4c;
        "pkg-6.0.3+1.19.3" = _1uElSJoA;
        "pkg-6.0.3+23w13a" = _P9ZgyZjM;
        "pkg-6.0.3+1.19.2" = _SYrJtSiB;
        "pkg-6.0.4+1.19.3" = _BMn7RD0p;
        "pkg-6.0.4+1.19.4" = _8kjIdhjj;
        "pkg-6.0.4+23w13a" = _BViaH6LP;
        "pkg-6.0.5+1.19.3" = _zQEc3W0p;
        "pkg-6.0.5+1.19.4" = _91jyni8T;
        "pkg-6.0.5+23w13a" = _1xJgG3Uw;
        "pkg-6.0.5+23w13a_or_b" = _2QIjWogL;
        "pkg-6.0.5+1.19.1" = _1tf5dGyE;
        "pkg-6.0.5+23w14a" = _PPlkZtYC;
        "pkg-6.0.6+1.19.2" = _1D9D08sm;
        "pkg-6.0.6+1.19.3" = _EqHJLhcJ;
        "pkg-6.0.6+1.19.1" = _uuKhMN51;
        "pkg-6.0.6+1.19.4" = _r6crfZUN;
        "pkg-6.0.6+23w14a" = _U8Ba87TX;
        "pkg-6.0.6+1.19" = _IMMpp5yV;
        "pkg-6.0.6+1.18.2" = _kBGPFl7U;
        "pkg-6.0.6+23w16a" = _uZjT3yYg;
        "pkg-6.0.6+23w17a" = _QH70l1Ub;
        "pkg-6.0.6+23w18a" = _F8V5fRjA;
        "pkg-6.0.6+1.20-pre1" = _7mF4jVXK;
        "pkg-6.0.6+1.20-pre2" = _2fFzY9WN;
        "pkg-6.0.6+1.20-pre4" = _9HEqATPG;
        "pkg-6.0.7+1.18.2" = _JrhK5Ekc;
        "pkg-6.0.7+1.19.1" = _vCWPVB55;
        "pkg-6.0.7+1.19" = _1tKHFM9Y;
        "pkg-6.0.7+1.19.4" = _qmv0elLC;
        "pkg-6.0.7+1.19.2" = _NTIVdoTJ;
        "pkg-6.0.7+1.19.3" = _cJgsuldO;
        "pkg-6.0.7+1.20-pre4" = _MC05rqn4;
        "pkg-6.0.7+1.20-pre5" = _53W9jpyH;
        "pkg-6.0.7+1.20-pre6" = _3ThUWz3K;
        "pkg-6.0.7+1.20-pre7" = _gWf16i2f;
        "pkg-6.0.7+1.20-rc1" = _mUuAblqn;
        "pkg-6.0.7+1.20" = _AbyAJReX;
        "pkg-6.0.7+1.20.1-rc1" = _zLGOKyoH;
        "pkg-6.0.7+1.20.1" = _J6o2cCid;
        "pkg-6.0.8+1.20.1" = _5G5k0jk2;
        "pkg-6.0.8+1.20.2" = _Z4nW3Lgk;
        "pkg-6.1.0+1.20.2" = _z8ZDK1Dq;
        "pkg-6.1.0+23w43b" = _w9umrRKk;
        "pkg-6.1.0+1.20.1" = _8lkIPvG4;
        "pkg-6.1.0+1.20" = _yRNlKr5b;
        "pkg-6.1.0+1.19.4" = _Si5yLALv;
        "pkg-6.1.0+1.18.2" = _5zX54gfc;
        "pkg-6.1.0+1.17.1" = _9GUO738O;
        "pkg-6.1.0+23w44a" = _fozKPs7A;
        "pkg-6.0.9+1.16.5" = _QSxGHFr8;
        "pkg-6.0.9+1.15.2" = _JFlKE6Kc;
        "pkg-6.0.9+1.14.4" = _wwNvUnYJ;
        "pkg-6.0.10+1.14.4" = _JmZQq1Yo;
        "pkg-6.1.0+23w13a_or_b" = _RflQjIo6;
        "pkg-6.1.0+22w13oneblockatatime" = _2ovrYKeE;
        "pkg-6.0.9+20w14infinite" = _FTC56DaB;
        "pkg-6.1.0+23w45a" = _PJmoHrCt;
        "pkg-6.1.1-alpha.publish.14-mc1.20.2" = _VQJmzhFK;
        "pkg-6.1.4-beta.1-mc23w46a" = _1fBbih3F;
        "pkg-6.1.4-mc23w46a" = _qE2bxmxK;
        "pkg-6.1.4-mc1.20.3-pre1" = _X8iw8vcg;
        "pkg-6.1.4-mc1.20.3-pre2" = _Cu0OfWAU;
        "pkg-6.1.4-mc1.20" = _Ua5pWc1F;
        "pkg-6.1.4-mc1.20.2" = _XKyA6eUN;
        "pkg-6.1.4-mc1.20.3-pre3" = _jzuayHMA;
        "pkg-6.1.4-mc1.20.3-pre4" = _MIYLr8xo;
        "pkg-6.1.4-mc1.20.3-rc1" = _ZnwbFmc8;
        "pkg-6.1.4-mc1.16.5" = _MmIqm5IH;
        "pkg-6.1.4-mc1.20.3" = _8uEk0hnW;
        "pkg-6.1.4-mc1.20.4-rc1" = _CuZP7gBY;
        "pkg-6.1.4-mc1.15.2" = _iUHhK0Or;
        "pkg-6.1.4-mc1.20.4" = _7CcZhpuN;
        "pkg-6.1.4-mc20w14infinite" = _NmHKtVAk;
        "pkg-6.1.4-mc1.14.4" = _yl4qkxWr;
        "pkg-6.1.5+mc1.17.1" = _qj0otmOp;
        "pkg-6.1.4-mc23w51b" = _3DDMTEHx;
        "pkg-6.1.6-mc1.20.4" = _V5tkzYup;
        "pkg-6.1.6-mc23w51b" = _5lGIt45o;
        "pkg-6.1.6-mc1.20.3" = _3lRTHs3t;
        "pkg-6.1.6-mc1.20.1" = _umJCBrDs;
        "pkg-6.1.6-mc1.20" = _bcNQxdXR;
        "pkg-6.1.6-mc1.20.2" = _E9s0aEg8;
        "pkg-6.1.6-mc1.16.5" = _RPjPlOol;
        "pkg-6.1.6-mc1.18.2" = _wZwNUG4D;
        "pkg-6.1.6-mc1.15.2" = _cg1KG2kU;
        "pkg-6.1.6-mc1.19.4" = _J9CkpyP1;
        "pkg-6.1.6-mc20w14infinite" = _8xXYKv22;
        "pkg-6.1.6-mc22w13oneblockatatime" = _Xrew94d1;
        "pkg-6.1.6-mc1.14.4" = _brshXeco;
        "pkg-6.1.6-mc23w13a_or_b" = _kUGakia8;
        "pkg-6.1.6-mc1.17.1" = _kRghqj3V;
        "pkg-6.1.6+mc24w03a" = _i4bvMrIj;
        "pkg-6.1.6+mc24w03b" = _fZhLdGuy;
        "pkg-6.1.6+mc24w04a" = _1poUKMj0;
        "pkg-6.1.6+mc24w05a" = _WuCoiOMC;
        "pkg-6.1.6+mc24w05b" = _H7de8vK8;
        "pkg-6.1.6+mc24w06a" = _ifMXIOAU;
        "pkg-6.1.6+mc24w07a" = _fxSpw1cz;
        "pkg-6.1.6+mc24w09a" = _84czm2JH;
        "pkg-6.1.6+mc24w10a" = _7FfZR23h;
        "pkg-7.0.0+mc24w11a" = _XwFgIFTB;
        "pkg-7.0.0+mc24w12a" = _es51q8HS;
        "pkg-7.0.0+mc24w13a" = _btGgzICw;
        "pkg-7.1.0+mc24w14a" = _yClt384n;
        "pkg-7.2.0+mc1.20.5-pre1" = _DPaoqasa;
        "pkg-7.1.0+mc24w14potato" = _GunWkFDI;
        "pkg-7.2.0+mc1.20.5-pre2" = _Hfrm8S8g;
        "pkg-7.2.0+mc1.20.5-pre3" = _waHxUaru;
        "pkg-7.2.0+mc1.20.5-pre4" = _JQUAEYCR;
        "pkg-7.2.0+mc1.20.5-rc1" = _v7mzd1He;
        "pkg-7.2.0+mc1.20.5-rc2" = _haI3HVok;
        "pkg-7.2.0+mc1.20.5-rc3" = _8Tsxu1zA;
        "pkg-7.2.0+mc1.20.5" = _wpeIw6gu;
        "pkg-7.2.0+mc1.20.6-rc1" = _mgyEma97;
        "pkg-7.2.1+mc1.20.6" = _iAddzx6L;
        "pkg-7.2.1+mc24w18a" = _7Z2llixK;
        "pkg-7.2.1+mc24w19a" = _qRwjyieX;
        "pkg-7.2.1+mc24w19b" = _aV3Fkxti;
        "pkg-7.2.1+mc24w20a" = _CWNpiEzM;
        "pkg-7.2.1+mc24w21a" = _UcBMh3Iw;
        "pkg-7.3.0+mc24w21b" = _KFVc4Mtm;
        "pkg-7.3.0+mc1.21-pre1" = _DC7985Tr;
        "pkg-7.3.0+mc1.21-pre2" = _BTrU0Ywd;
        "pkg-7.3.0+mc1.21-pre3" = _zAIxJmc0;
        "pkg-7.3.0+mc1.21-pre4" = _A0GizwFZ;
        "pkg-7.3.0+mc1.21-rc1" = _rOwrs1pA;
        "pkg-7.3.1+mc1.21" = _j1jWFKjO;
        "pkg-7.4.0+mc1.21" = _yZvmHlrk;
        "pkg-7.4.0+mc1.20.6" = _ZvVk6mAo;
        "pkg-7.4.0+mc1.20.1" = _mPo5KcmQ;
        "pkg-7.4.0+mc1.21.1-rc1" = _NQhFkbfP;
        "pkg-7.4.0+mc1.19.4" = _IIIulUsH;
        "pkg-7.4.0+mc1.21.1" = _OCsjzlBN;
        "pkg-7.4.0+mc24w33a" = _KiqH3qBA;
        "pkg-7.5.0+mc1.21" = _a1kqPDsa;
        "pkg-7.5.0+mc1.21.1" = _7dRBpE8T;
        "pkg-7.5.0+mc24w34a" = _MKmMVzKQ;
        "pkg-7.4.0+mc24w14potato" = _aIbACQQy;
        "pkg-7.4.0+mc1.18.2" = _HdSPEgBH;
        "pkg-7.4.0+mc23w13a_or_b" = _WxTyR1N3;
        "pkg-7.4.0+mc22w13oneblockatatime" = _QP7DUGmI;
        "pkg-7.4.0+mc1.17.1" = _jrkG1UVC;
        "pkg-7.5.0+mc24w35a" = _mcEWJzVK;
        "pkg-7.5.0+mc24w36a" = _CInbuxDf;
        "pkg-7.5.0+mc24w37a" = _JRFu4njO;
        "pkg-7.6.0+mc1.17.1" = _Jp99SyRk;
        "pkg-7.6.0+mc22w13oneblockatatime" = _kWVjRMRd;
        "pkg-7.6.0+mc1.19.4" = _Yj6RxLYW;
        "pkg-7.6.0+mc1.20.1" = _b6EMKtZk;
        "pkg-7.6.0+mc1.18.2" = _NSuNha9s;
        "pkg-7.6.0+mc23w13a_or_b" = _znzZu4jQ;
        "pkg-7.6.0+mc1.21.1" = _pib2RsV4;
        "pkg-7.6.0+mc24w14potato" = _63WhhAin;
        "pkg-7.6.0+mc1.21" = _moXiBhiz;
        "pkg-7.6.0+mc1.20.6" = _Mf2qr4a7;
        "pkg-7.6.0+mc24w38a" = _QJYa7qGA;
        "pkg-7.6.0+mc24w39a" = _95VDTzkk;
        "pkg-7.6.0+mc24w40a" = _Rcopxr7R;
        "pkg-7.6.0+mc1.21.2-pre1" = _urWOkGoB;
        "pkg-7.6.0+mc1.21.2-pre2" = _mOfPPuym;
        "pkg-7.6.0+mc1.21.2-pre3" = _r6dV80it;
        "pkg-7.6.1+mc1.17.1" = _SlFXImnb;
        "pkg-7.6.1+mc1.18.2" = _xsukGaBS;
        "pkg-7.6.1+mc22w13oneblockatatime" = _G2UrMw8A;
        "pkg-7.6.1+mc1.19.4" = _yQ0vqudp;
        "pkg-7.6.1+mc23w13a_or_b" = _UBrdDAcz;
        "pkg-7.6.1+mc1.20.1" = _ZNnZu7z1;
        "pkg-7.6.1+mc24w14potato" = _gwLswPBF;
        "pkg-7.6.1+mc1.20.6" = _fsAWpsZR;
        "pkg-7.6.1+mc1.21" = _5t1n8jBV;
        "pkg-7.6.1+mc1.21.1" = _KfLTVO1C;
        "pkg-7.6.1+mc1.21.2-pre4" = _4D2Q2kUn;
        "pkg-7.6.1+mc1.21.2-pre5" = _ezZoDb59;
        "pkg-7.6.2-alpha.3+mc1.21.2-pre5" = _iie1Z4Lw;
        "pkg-7.6.1+mc1.21.2-rc1" = _VK79ZSQ1;
        "pkg-7.6.1+mc1.21.2-rc2" = _jRRfXQqv;
        "pkg-7.6.1+mc1.21.2" = _ebvaVAXB;
        "pkg-7.6.1+mc1.21.3" = _kRNa0veu;
        "pkg-7.6.1+mc24w44a" = _Jpfx6m57;
        "pkg-7.6.1+mc24w45a" = _83n3L0Mp;
        "pkg-7.6.1+mc24w46a" = _FQUhdo4F;
        "pkg-7.6.2+mc1.21" = _qB7zKwlO;
        "pkg-7.6.2+mc1.21.1" = _rndiOKqx;
        "pkg-7.6.2+mc1.21.2" = _kF9iyXbk;
        "pkg-7.6.2+mc1.21.3" = _YuG0lF13;
        "pkg-7.6.2+mc1.21.4-pre1" = _pIe7k3Vz;
        "pkg-7.6.2+mc1.21.4-pre2" = _7ebwEyda;
        "pkg-7.6.2+mc1.21.4-pre3" = _saAm5P1W;
        "pkg-7.6.2+mc1.21.4-rc1" = _PFIdJnL5;
        "pkg-7.6.2+mc1.21.4-rc2" = _KNqtYazW;
        "pkg-7.6.2+mc1.21.4-rc3" = _gncR2l9s;
        "pkg-7.6.2+mc1.21.4" = _92ylnHoo;
        "pkg-7.6.3+mc1.21" = _63TNHGH4;
        "pkg-7.6.3+mc1.21.1" = _lf3iBrWi;
        "pkg-7.6.3+mc1.21.2" = _7GXWpmZf;
        "pkg-7.6.3+mc1.21.3" = _HaPX46ve;
        "pkg-7.6.1+mc1.16.5" = _MIZTFLul;
        "pkg-7.6.1+mc20w14infinite" = _L3iJW9dQ;
        "pkg-7.6.1+mc1.15.2" = _cAipFVeK;
        "pkg-7.6.2+mc20w14infinite" = _5XoCCmH8;
        "pkg-7.6.1+mc1.14.4" = _ksDR9fpd;
        "pkg-7.6.2+mc1.16.5" = _jRZ7vA1T;
        "pkg-7.6.2+mc1.15.2" = _BnA9Fr4b;
        "pkg-7.6.3+mc20w14infinite" = _5GDZEAF5;
        "pkg-7.6.2+mc25w02a" = _IamidL5E;
        "pkg-7.6.2+mc25w03a" = _7eKuvCnH;
        "pkg-7.6.2+mc25w04a" = _yiiXD4EA;
        "pkg-7.6.2+mc25w05a" = _5a6oe3As;
        "pkg-7.6.2+mc25w06a" = _T4v4MxDX;
        "pkg-7.6.2+mc25w07a" = _rEk16iFz;
        "pkg-7.6.2+mc25w08a" = _koWLEDdh;
        "pkg-7.6.2+mc25w09b" = _ULvHFvMO;
        "pkg-7.6.2+mc25w10a" = _QpDe6omi;
        "pkg-7.6.2+mc1.21.5-pre1" = _B7HucSTx;
        "pkg-7.6.2+mc1.21.5-pre2" = _b8ZZQmOc;
        "pkg-7.6.2+mc1.21.5-pre3" = _MrhQhSXL;
        "pkg-7.6.2+mc1.21.5-rc1" = _k6zYZEMB;
        "pkg-7.6.2+mc1.21.5-rc2" = _aqjnEjWk;
        "pkg-7.6.2+mc1.21.5" = _7YfMFt3G;
        "pkg-7.6.2+mc25w14craftmine" = _d45qZCal;
        "pkg-7.6.2+mc25w15a" = _Bisd0P9P;
        "pkg-7.6.2+mc25w16a" = _Tp187eeY;
        "pkg-7.6.2+mc25w17a" = _6YE1VFuo;
        "pkg-7.6.2+mc25w18a" = _7Kzy4n02;
        "pkg-7.6.2+mc25w20a" = _6pN0SWeX;
        "pkg-7.6.2+mc25w21a" = _WnULd1QR;
        "pkg-7.6.2+mc1.21.6-pre1" = _3dk1xwAn;
        "pkg-7.6.2+mc25w19a" = _HzzhOEnE;
        "pkg-7.6.2+mc1.21.6-pre3" = _IMDAMMUG;
        "pkg-7.6.2+mc1.21.6-pre2" = _eIYxrocL;
        "pkg-7.6.2+mc1.21.6-pre4" = _xgo1G6AC;
        "pkg-7.6.2+mc1.21.6-rc1" = _fMC1rmA8;
        "pkg-7.6.2+mc1.21.6" = _HKENjT4x;
        "pkg-7.6.2+mc1.21.7-rc1" = _BBAj5ypI;
        "pkg-7.6.4+mc1.21.1" = _8xJ4vprU;
        "pkg-7.6.4+mc1.21.2" = _66Sq16rk;
        "pkg-7.6.4+mc1.21.3" = _RyOasM6n;
        "pkg-7.6.4+mc1.21.4" = _G1JAJwkR;
        "pkg-7.6.4+mc1.21.5" = _UUdpK1dL;
        "pkg-7.6.4+mc1.21" = _WFOTfHYd;
        "pkg-7.6.4+mc25w14craftmine" = _UdSkvI9l;
        "pkg-7.6.4+mc1.20.6" = _6cPlASlc;
        "pkg-7.6.4+mc24w14potato" = _tGNlkqaw;
        "pkg-7.6.4+mc1.20.1" = _Vu6uVZW9;
        "pkg-7.6.4+mc23w13a_or_b" = _AMP79nlZ;
        "pkg-7.6.4+mc1.19.4" = _zvFA3djT;
        "pkg-7.6.4+mc22w13oneblockatatime" = _uUjTbfVr;
        "pkg-7.6.4+mc1.18.2" = _yGsfQwWI;
        "pkg-7.6.4+mc1.17.1" = _B1a1n4rY;
        "pkg-7.6.4+mc1.16.5" = _Ie7ZUnZv;
        "pkg-7.6.4+mc20w14infinite" = _dvJzHGb2;
        "pkg-7.6.4+mc1.15.2" = _J8IRTlB2;
        "pkg-7.6.4+mc1.14.4" = _o0Ho03cX;
        "pkg-7.6.4+mc1.21.6" = _HCbsOop6;
        "pkg-7.6.4+mc1.21.7-rc2" = _Z99UoMqX;
        "pkg-7.6.4+mc1.21.7" = _2dF0kJpB;
        "pkg-7.6.4+mc1.21.8-rc1" = _rK0yRQy1;
        "pkg-7.6.4+mc1.21.8" = _wVUT5znl;
        "pkg-7.6.4+mc25w31a" = _f9Zjergu;
        "pkg-7.6.4+mc25w32a" = _d0wTfsD9;
        "pkg-7.6.4+mc25w33a" = _9WCjPbQD;
        "pkg-7.6.4+mc25w34a" = _lqHdlBCW;
        "pkg-7.6.4+mc25w34b" = _2zLnZ93z;
        "pkg-7.6.4+mc25w35a" = _18YR7exc;
        "pkg-7.6.4+mc25w36a" = _v5cEGEU6;
        "pkg-7.6.4+mc25w36b" = _pfeW8GYX;
        "pkg-7.6.4+mc25w37a" = _pPm6tXhE;
        "pkg-7.6.4+mc1.21.9-pre1" = _fWF4RcLu;
        "pkg-7.6.5+mc1.21.9-pre2" = _ALKuKtWW;
        "pkg-7.6.5+mc1.21.9-pre3" = _2TGMBHpC;
        "pkg-7.6.5+mc1.21.9-pre4" = _2GdWo62c;
        "pkg-7.6.6+mc1.21.9-rc1" = _1gKBLXvU;
        "pkg-7.6.6+mc1.21.9" = _c2yPSvKF;
        "pkg-7.6.6+mc1.21.10-rc1" = _vv8FMe8r;
        "pkg-7.6.6+mc1.21.10" = _3f1QT5lO;
        "pkg-7.6.6+mc25w41a" = _2O53AaXL;
        "pkg-7.6.6+mc25w42a" = _QoySLnsP;
        "pkg-8.0.0-alpha.1+mc25w43a" = _DbEJdLZ5;
        "pkg-8.0.0-alpha.1+mc1.21.10" = _kU0fSbjH;
        "pkg-8.0.0-alpha.1+mc25w44a" = _VL7tL0Qp;
        "pkg-8.0.0-alpha.1+mc25w45a" = _bZM7Sco2;
        "pkg-8.0.0-alpha.1+mc25w46a" = _FmOoe9dm;
        "pkg-8.0.0-alpha.1+mc1.21.11-pre1" = _4gldvlxZ;
        "pkg-8.0.0-alpha.1+mc1.21.11-pre2" = _PA2ddIMe;
        "pkg-8.0.0-alpha.1+mc1.21.11-pre3" = _epWFMh35;
        "pkg-8.0.0-alpha.1+mc1.21.11-pre4" = _YuGmE4NK;
        "pkg-8.0.0-alpha.1+mc1.21.11-pre5" = _CYgVJew8;
        "pkg-8.0.0-alpha.1+mc1.21.11-rc1" = _wveez0z6;
        "pkg-8.0.0-alpha.1+mc1.21.11-rc2" = _F9lUFxop;
        "pkg-8.0.0-alpha.1+mc1.21.11-rc3" = _RG0iJmtc;
        "pkg-8.0.0-alpha.2+mc1.21.11" = _Y1VCRQiD;
        "pkg-8.0.0-alpha.2+mc1.21.10" = _t0REFPgN;
        "pkg-8.0.0-alpha.2+mc26.1-snapshot-1" = _ZQY2uNOD;
        "pkg-8.0.0-alpha.2+mc26.1-snapshot-2" = _EdA6f62o;
        "pkg-8.0.0-alpha.3+mc26.1-snapshot-2" = _NalsCJPm;
        "pkg-8.0.0-alpha.3+mc1.21.11" = _DflmmcPF;
        "pkg-8.0.0-alpha.3+mc26.1-snapshot-3" = _u0qMFBEn;
        "pkg-8.0.0-alpha.3+mc26.1-snapshot-4" = _V7wDN0Cs;
        "pkg-8.0.0-alpha.3+mc26.1-snapshot-5" = _RIfZeMhO;
        "pkg-8.0.0-alpha.3+mc26.1-snapshot-6" = _SIUicIu5;
        "pkg-8.0.0-alpha.3+mc26.1-snapshot-7" = _3Zc0LXtp;
        "pkg-8.0.0-alpha.3+mc26.1-snapshot-8" = _aQioDcDF;
        "pkg-8.0.0-alpha.3+mc26.1-snapshot-9" = _BzFU9brG;
        "pkg-8.0.0-alpha.3+mc26.1-snapshot-10" = _NP1XGEbO;
        "pkg-8.0.0-alpha.3+mc26.1-snapshot-11" = _OKCjiHxh;
        "pkg-8.0.0-alpha.4+mc26.1-pre-1" = _2P3fYWf8;
        "pkg-8.0.0-alpha.4+mc26.1-pre-3" = _bfubx6vy;
        "pkg-8.0.0-alpha.4+mc26.1-rc-1" = _lJIi4Nsi;
        "pkg-8.0.0-alpha.4+mc26.1-rc-2" = _7WpTsRMg;
        "pkg-8.0.0-alpha.4+mc26.1-rc-3" = _WQqfupfi;
        "pkg-8.0.0-alpha.4+mc26.1" = _mEZPVdQs;
        "pkg-8.0.0-alpha.4+mc1.21.11" = _GLsi1C10;
        "pkg-8.0.0-alpha.4+mc26.1.1-rc-1" = _jgb52odR;
        "pkg-8.0.0-alpha.4+mc26.1.1" = _tWwJr5Vf;
        "pkg-8.0.0-alpha.4+mc26.1.2-rc-1" = _whMUA8bz;
        "pkg-8.0.0-alpha.4+mc26.1.2" = _htkc7bxJ;
        "pkg-8.0.0-alpha.4+mc26.2-snapshot-1" = _ee4Qr3ZG;
        "pkg-8.0.0-alpha.4+mc26.2-snapshot-2" = _4ZUif0Zi;
        "pkg-8.0.0-alpha.5+mc26.2-snapshot-3" = _sTnoi0BN;
        "pkg-8.0.0-alpha.5+mc26.2-snapshot-4" = _m24LeMq5;
        "pkg-8.0.0-alpha.5+mc26.2-snapshot-5" = _Kgu28D56;
        "pkg-8.0.0-alpha.5+mc26.2-snapshot-6" = _DSxfYb5o;
        "pkg-8.0.0-alpha.5+mc26.2-snapshot-7" = _mIcET2gM;
        "pkg-8.0.0-alpha.5+mc26.2-snapshot-8" = _h9htHSOP;
        "pkg-8.0.0-alpha.5+mc26.2-pre-1" = _mAEnzqyL;
        "pkg-8.0.0-alpha.5+mc26.2-pre-2" = _qB2HIuIx;
        "pkg-8.0.0-alpha.5+mc26.1.2" = _FFE1jRuj;
        "pkg-8.0.0-alpha.6+mc26.1.2" = _tC318952;
        "pkg-8.0.0-alpha.5+mc1.21.11" = _2KfpDiZd;
        "pkg-8.0.0-alpha.5+mc26.2-pre-3" = _SH2uMptl;
        "pkg-8.0.0-alpha.5+mc26.2-pre-4" = _yc34WqgI;
        "pkg-8.0.0-alpha.5+mc26.2-pre-5" = _GKj5ze2P;
        "pkg-8.0.0-alpha.5+mc26.2-pre-6" = _viRKucPu;
        "pkg-8.0.0-alpha.5+mc26.2-rc-1" = _NrTQ8x1r;
        "pkg-8.0.0-alpha.5+mc26.2-rc-2" = _mBcdOr4A;
        "pkg-8.0.0-alpha.5+mc26.2" = _BarZW3Es;
        "pkg-8.0.0-alpha.6+mc26.3-rc-2" = _cVh7IiR1;
        "default" = _cVh7IiR1;
    });
