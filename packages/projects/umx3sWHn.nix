...
let
    ...
    in {
        ...
        "pkg-1.0.4-forge-mc1.16" = _nI0PKX6Y;
        "pkg-1.0.4-forge-mc1.17" = _xYOz116h;
        "pkg-1.0.4-forge-mc1.18" = _pGQ94atW;
        "pkg-1.0.4b-forge-mc1.19" = _ozlBdhGA;
        "pkg-1.0.5-forge-mc1.12" = _Av9dnf4k;
        "pkg-1.0.5-forge-mc1.14" = _LeYvHrbY;
        "pkg-1.0.5-forge-mc1.15" = _GrdKhSt2;
        "pkg-1.0.5-forge-mc1.16" = _DfKyDok3;
        "pkg-1.0.5-forge-mc1.17" = _EC1e7mnj;
        "pkg-1.0.5-forge-mc1.18" = _yc2HaIRG;
        "pkg-1.0.5-forge-mc1.19" = _VIDi67Fu;
        "pkg-1.0.6-forge-mc1.12" = _nwoYtBm5;
        "pkg-1.0.6-forge-mc1.14" = _tq4840sD;
        "pkg-1.0.6-forge-mc1.15" = _eR1SQ0ww;
        "pkg-1.0.6-forge-mc1.16" = _YT4emT4n;
        "pkg-1.0.6-forge-mc1.17" = _yQzha0mK;
        "pkg-1.0.6-forge-mc1.18" = _yeQ6zIt6;
        "pkg-1.0.6-forge-mc1.19" = _XWm4lCpn;
        "pkg-1.0.6-forge-mc1.19.3" = _R3Rwgrjh;
        "pkg-1.0.6-fabric-mc1.18" = _KrEjOv6M;
        "pkg-1.0.6-fabric-mc1.19" = _DymRj6Vf;
        "pkg-1.0.6-fabric-mc1.19.2" = _dYdkKNPW;
        "pkg-1.0.6-forge-mc1.20" = _SLMiWg0w;
        "pkg-1.0.6-fabric-mc1.19.4" = _MKF1UKfQ;
        "pkg-1.0.6-fabric-mc1.20" = _IF6VTfxj;
        "pkg-1.0.7-forge-mc1.12" = _W6O5hPvz;
        "pkg-1.0.7-forge-mc1.14" = _x94Uk8f6;
        "pkg-1.0.7-forge-mc1.15" = _oYISwVQL;
        "pkg-1.0.7-forge-mc1.16" = _1of6pnSm;
        "pkg-1.0.7-forge-mc1.17" = _txLO0SPK;
        "pkg-1.0.7-forge-mc1.18" = _jTo16NDu;
        "pkg-1.0.7-forge-mc1.19" = _HDeSm6Cb;
        "pkg-1.0.7-forge-mc1.19.3" = _nC3WB99N;
        "pkg-1.0.7-forge-mc1.20" = _8MrwFDgi;
        "pkg-1.0.7-fabric-mc1.18" = _rhWzhtFv;
        "pkg-1.0.7-fabric-mc1.19.2" = _rdhmg8zK;
        "pkg-1.0.7-fabric-mc1.19.4" = _UX7NWaVJ;
        "pkg-1.0.7-fabric-mc1.20" = _isNyrgrv;
        "pkg-1.0.7a-fabric-mc1.19.4" = _WkfXaMNx;
        "pkg-1.0.7a-fabric-mc1.20" = _ClGPbySn;
        "pkg-1.0.7-neoforge-mc1.20.4" = _zXdv9y31;
        "pkg-1.0.7-forge-mc1.20.6" = _3hWSWBFG;
        "pkg-1.0.7-forge-mc1.21" = _XDU8rByC;
        "pkg-1.0.7-fabric-mc1.20.6" = _5OkR3r5u;
        "pkg-1.0.7-fabric-mc1.21" = _bw8aN0zA;
        "pkg-1.0.7-neoforge-mc1.20.6" = _b1ri76r4;
        "pkg-1.0.7-neoforge-mc1.21" = _O0N0Gzup;
        "pkg-1.0.7-fabric-mc1.21.2" = _ck5un4bj;
        "pkg-1.0.7-neoforge-mc1.21.3" = _JnDbfTZM;
        "pkg-1.0.7-forge-mc1.21.3" = _Ta747D2y;
        "pkg-1.0.7-forge-mc1.21.4" = _e1k91JTP;
        "pkg-1.0.7-fabric-mc1.21.4" = _P1FUqASU;
        "pkg-1.0.7-neoforge-mc1.21.4" = _kr0i8uh0;
        "pkg-1.0.7-forge-mc1.21.5" = _7o7LTVwi;
        "pkg-1.0.7-forge-mc1.21.6" = _754EJViM;
        "pkg-1.0.7-fabric-mc1.21.5" = _aPJerz9v;
        "pkg-1.0.7-fabric-mc1.21.6" = _b0T0Irho;
        "pkg-1.0.7-neoforge-mc1.21.5" = _eHRkGJ8B;
        "pkg-1.0.7-neoforge-mc1.21.6" = _D7ijppAc;
        "pkg-1.0.7-forge-mc1.21.10" = _dmGPGa38;
        "pkg-1.0.7-fabric-mc1.21.10" = _qYlh5Rap;
        "pkg-1.0.7-neoforge-mc1.21.10" = _SqyMe0F8;
        "pkg-1.0.7-forge-mc1.21.11" = _WTrFB7ey;
        "pkg-1.0.7-fabric-mc1.21.11" = _SoEv7sWm;
        "pkg-1.0.7-neoforge-mc1.21.11" = _LFdQgbEP;
        "pkg-1.0.7-forge-mc26.1" = _VGoDUzr1;
        "pkg-1.0.7-fabric-mc26.1" = _IXoq0EHx;
        "pkg-1.0.7-neoforge-mc26.1" = _3PdcIftf;
