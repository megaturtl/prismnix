...
let
    ...
    in {
        ...
        "pkg-1.1-1.17" = _YQ5sJfDC;
        "pkg-1.1.1-1.16 " = _C3mzZAKW;
        "pkg-1.1.1-1.17 " = _kKAa2oW9;
        "pkg-1.1.1-1.18" = _WtqGFVMW;
        "pkg-1.2-beta+1.18" = _eAxzeVBY;
        "pkg-1.2-1.18" = _uK1KlUqk;
        "pkg-1.2-1.19" = _6fT1WmjK;
        "pkg-1.3-1.19.3" = _RrvEgSMh;
        "pkg-1.4-1.19.4" = _9r62k2fF;
        "pkg-1.4-1.20" = _pSa8Uxup;
        "pkg-1.4-1.20.2" = _su24dAyS;
        "pkg-1.4.1-1.20.2" = _LANAyVNY;
        "pkg-1.4.1-1.20.6" = _TVkttU4r;
        "pkg-1.4.1" = _dFMKfIAO;
        "pkg-1.5.0" = _itKs8XJD;
        "pkg-1.6.0" = _uSeotorT;
        "pkg-1.7.0" = _cFEKodQE;
