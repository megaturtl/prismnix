...
let
    versions = (let
        ...
        _ho6APkHr = {
            "id" = "ho6APkHr";
            "file" = "Rappenem's Reforge v1.15.zip";
            "hash" = "sha512-2SodcIuFZBcbVK6twyAMfFAUWfNBVT6q48eyet213Bw7feJa2y/bYDun/qoFcQw1k7LAmhLu52TWFbDeN1ip+A==";
        };
    in {
        "ID6Oyg4M" = _ID6Oyg4M;
        "oYuX6fRe" = _oYuX6fRe;
        ...
        "ydClzwbK" = _ydClzwbK;
        "ho6APkHr" = _ho6APkHr;
        "minecraft-1.20" = _ho6APkHr;
        "minecraft-1.21" = _ho6APkHr;
        "minecraft-1.21.1" = _ho6APkHr;
        "minecraft-1.21.2" = _ho6APkHr;
        "minecraft-1.21.3" = _ho6APkHr;
        "minecraft-1.21.4" = _ho6APkHr;
        "minecraft-1.21.5" = _ho6APkHr;
        "minecraft-1.21.6" = _ho6APkHr;
        "minecraft-1.21.7" = _ho6APkHr;
        "minecraft-1.21.8" = _ho6APkHr;
        "minecraft-1.21.9" = _ho6APkHr;
        "minecraft-1.21.10" = _ho6APkHr;
        "minecraft-1.21.11" = _ho6APkHr;
        "minecraft-23w31a" = _ho6APkHr;
        "minecraft-23w32a" = _ho6APkHr;
        "minecraft-23w33a" = _ho6APkHr;
        "minecraft-23w35a" = _ho6APkHr;
        "minecraft-1.20.2-pre1" = _ho6APkHr;
        "minecraft-23w42a" = _ho6APkHr;
        "minecraft-23w43a" = _ho6APkHr;
        "minecraft-23w43b" = _ho6APkHr;
        "minecraft-23w44a" = _ho6APkHr;
        "minecraft-23w45a" = _ho6APkHr;
        "minecraft-23w46a" = _ho6APkHr;
        "minecraft-24w03a" = _ho6APkHr;
        "minecraft-24w03b" = _ho6APkHr;
        "minecraft-24w04a" = _ho6APkHr;
        "minecraft-24w05a" = _ho6APkHr;
        "minecraft-24w05b" = _ho6APkHr;
        "minecraft-24w06a" = _ho6APkHr;
        "minecraft-24w07a" = _ho6APkHr;
        "minecraft-24w09a" = _ho6APkHr;
        "minecraft-24w10a" = _ho6APkHr;
        "minecraft-24w11a" = _ho6APkHr;
        "minecraft-24w12a" = _ho6APkHr;
        "minecraft-24w13a" = _ho6APkHr;
        "minecraft-24w14potato" = _ho6APkHr;
        "minecraft-24w14a" = _ho6APkHr;
        "minecraft-1.20.5-pre1" = _ho6APkHr;
        "minecraft-1.20.5-pre2" = _ho6APkHr;
        "minecraft-1.20.5-pre3" = _ho6APkHr;
        "minecraft-24w18a" = _ho6APkHr;
        "minecraft-24w19a" = _ho6APkHr;
        "minecraft-24w19b" = _ho6APkHr;
        "minecraft-24w20a" = _ho6APkHr;
        "minecraft-24w33a" = _ho6APkHr;
        "minecraft-24w34a" = _ho6APkHr;
        "minecraft-24w35a" = _ho6APkHr;
        "minecraft-24w36a" = _ho6APkHr;
        "minecraft-24w37a" = _ho6APkHr;
        "minecraft-24w38a" = _ho6APkHr;
        "minecraft-24w39a" = _ho6APkHr;
        "minecraft-24w40a" = _ho6APkHr;
        "minecraft-1.21.2-pre1" = _ho6APkHr;
        "minecraft-1.21.2-pre2" = _ho6APkHr;
        "minecraft-24w44a" = _ho6APkHr;
        "minecraft-24w45a" = _ho6APkHr;
        "minecraft-24w46a" = _ho6APkHr;
        "minecraft-1.19.4" = _ho6APkHr;
        "minecraft-1.20.1" = _ho6APkHr;
        "minecraft-1.20.2" = _ho6APkHr;
        "minecraft-1.20.3" = _ho6APkHr;
        "minecraft-1.20.4" = _ho6APkHr;
        "minecraft-26.1" = _ho6APkHr;
        "minecraft-26.1.1" = _ho6APkHr;
        "minecraft-26.1.2" = _ho6APkHr;
        "minecraft-1.19" = _ho6APkHr;
        "minecraft-1.19.1" = _ho6APkHr;
        "minecraft-1.19.2" = _ho6APkHr;
        "minecraft-1.19.3" = _ho6APkHr;
        "minecraft-26.2" = _ho6APkHr;
        "minecraft-1.18" = _ho6APkHr;
        "minecraft-1.18.1" = _ho6APkHr;
        "minecraft-1.18.2" = _ho6APkHr;
        "pkg-1.0" = _ID6Oyg4M;
        "pkg-1.1" = _oYuX6fRe;
        "pkg-1.2" = _vDhYvn4y;
        "pkg-1.3" = _pvQyqpM6;
