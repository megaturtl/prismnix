...
let
    versions = (let
        ...
        _Bp4fTyPT = {
            "id" = "Bp4fTyPT";
            "file" = "Companion-mc26.1-Fabric-26.0.7.jar";
            "hash" = "sha512-idzy/pLb1pw+yjSVKotUI2avrNgvPBejeLiZviwyvqwumYuJ/hbfbF/3wJTufe7G9OOUoFpxVeuFDZYZZQ7MTw==";
        };
        _ZfoZODFg = {
            "id" = "ZfoZODFg";
            "file" = "Companion-mc26.1-Fabric-26.0.7.jar";
        ...
        _L9xjNE7p = {
            "id" = "L9xjNE7p";
            "file" = "Companion-mc26.1-NeoForge-26.0.7.jar";
            "hash" = "sha512-jNr/0FDJq0JcAKyOUUvfWTLoL+yHKwn0/lvVdYMzGrzLoVyZVxFNfBIZ4jNNjrR0ans0okpfBwVKD1y1dXWeiA==";
        };
        _PfXPQBGy = {
            "id" = "PfXPQBGy";
            "file" = "Companion-1.21.1-NeoForge-6.3.0.jar";
            "hash" = "sha512-vcO50Zw2UDZkBKbE4JWbGc6XWaCGG13wUmLq+a865rDtkx3+YrnPYf4rkvIb2eoyCCJRKvjNJ2Nu3MABCy3cfA==";
        };
    in {
        "ow4aP87c" = _ow4aP87c;
        "nVb4BhsV" = _nVb4BhsV;
        ...
        "fabric-26.1" = _ZfoZODFg;
        "fabric-26.1.1" = _ZfoZODFg;
        "fabric-26.1.2" = _ZfoZODFg;
        "quilt-1.20" = _gqjOYbM8;
        "quilt-1.20.1" = _h9OKCOHX;
        "quilt-1.21.1" = _q1lABhXI;
        "quilt-26.1" = _ZfoZODFg;
        "quilt-26.1.1" = _ZfoZODFg;
        "quilt-26.1.2" = _ZfoZODFg;
        "neoforge-1.20.1" = _O9wod42p;
        "neoforge-1.21.1" = _PfXPQBGy;
        "neoforge-26.1.2" = _L9xjNE7p;
        "neoforge-26.1" = _L9xjNE7p;
        "neoforge-26.1.1" = _L9xjNE7p;
        "pkg-2.2.0" = _ow4aP87c;
        "pkg-2.0.1" = _nVb4BhsV;
        "pkg-3.1.2" = _6UDLDwOP;
        "pkg-3.1.1" = _SkR84j5T;
        ...
        "pkg-5.1.0" = _gqjOYbM8;
        "pkg-5.2.0" = _8TD76y1j;
        "pkg-5.2.0+forge" = _Shfpdcwi;
        "pkg-5.2.1" = _9brvHbXW;
        "pkg-5.2.1+forge" = _b6AjkVeU;
        "pkg-5.2.2+forge" = _kto11H3W;
        "pkg-5.2.2+fabric" = _SPXivNuG;
        "pkg-6.0.0+fabric" = _EjnMGH53;
        "pkg-6.0.0+neoforge" = _4vFSkqtd;
        "pkg-6.1.0+neoforge" = _ee69mjdo;
        "pkg-6.1.1+neoforge" = _eOB43rJ0;
        "pkg-6.1.1+fabric" = _teUiLoO3;
        "pkg-5.3.0+fabric" = _HuGX8FsU;
        "pkg-5.3.0+forge" = _IREsC8rP;
        "pkg-5.3.1+fabric" = _i29UD4vR;
        "pkg-5.3.1+forge" = _gOLcgv0z;
        "pkg-26.0.1+fabric" = _HbrsiKnr;
        "pkg-6.2.0+neoforge" = _xotWY5Gs;
        "pkg-6.2.0+fabric" = _KdfSNJS7;
        "pkg-26.0.1+neoforge" = _jEIuqJBB;
        "pkg-26.0.2+neoforge" = _1z7g6uE1;
        "pkg-26.0.2+fabric" = _5CjcHSOj;
        "pkg-6.2.1+fabric" = _N5oZrhu4;
        "pkg-6.2.1+neoforge" = _6xRYHfEK;
        "pkg-5.4.1+forge" = _O9wod42p;
        "pkg-5.4.1+fabric" = _h9OKCOHX;
        "pkg-26.0.3+neoforge" = _XhcxI9c8;
        "pkg-26.0.3+fabric" = _N8477GZu;
        "pkg-26.0.4+fabric" = _aPPLX3bQ;
        "pkg-26.0.4+neoforge" = _zksW2hYl;
        "pkg-26.0.5+fabric" = _AyneEWob;
        "pkg-26.0.5+neoforge" = _xDsTPka3;
        "pkg-26.0.6+neoforge" = _SH9ibwJs;
        "pkg-26.0.6+fabric" = _YuV5s1E9;
        "pkg-6.2.2+fabric" = _q1lABhXI;
        "pkg-6.2.2+neoforge" = _c5W5UXNu;
        "pkg-26.0.7+fabric" = _ZfoZODFg;
        "pkg-26.0.7+neoforge" = _L9xjNE7p;
        "pkg-6.3.0+neoforge" = _PfXPQBGy;
        "default" = _PfXPQBGy;
    });
