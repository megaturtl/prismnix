...
let
    versions = (let
        ...
        _Amsi0PmJ = {
            "id" = "Amsi0PmJ";
            "file" = "rewithered-neoforge-1.0.14+26.1.2.jar";
            "hash" = "sha512-5rN4KeQKL3HvYo9FMpJqDQkorr16L4omH0b85T4qTN4PbMrH4KLoO4gi7YrknNvppk8GkqvphUfV24DpX+ULDQ==";
        };
        _O79HqsML = {
            "id" = "O79HqsML";
            "file" = "rewithered-fabric-1.0.14+26.2.jar";
            "hash" = "sha512-vdrG+97vj5KSYtUvwmi5owWT0O4jQHgp5CSxWhWkKv/wHdxxgCq1oe5v7YcjetjE+YFAOJiJh/fBW7yOnM5uXg==";
        };
        _RZj9wgcl = {
            "id" = "RZj9wgcl";
            "file" = "rewithered-fabric-1.0.14+1.21.1.jar";
            "hash" = "sha512-0pQI2sD6PK5etP5ki8Kp1oTziKGRYi2m1YmuUu4BI1xAqSlym3vLPTgNLAT++I21oZTEzqMpN9yzP1nN+ASSug==";
        };
        _VpL8qU64 = {
            "id" = "VpL8qU64";
            "file" = "rewithered-neoforge-1.0.14+1.21.1.jar";
            "hash" = "sha512-8U0qPGe0CJM2El7mMS0VPGrIKozhGDBVo1eOMHdidVE0aZmtlDmwlx9r9ZTKmuxI0zRxhgc9k5O1Q1gV5A90+Q==";
        };
        _v08jh0fq = {
            "id" = "v08jh0fq";
            "file" = "rewithered-fabric-1.0.14+26.1.2.jar";
            "hash" = "sha512-9jvhlrVgbfW81t0tFqXMbXOpM4Yd1rDTk6oVv4MefUhpVucBWSvUt4C9/tRpm9ILPW0K4bJZYUxAbYUJe0uW3g==";
        };
        _nj2JTMmr = {
            "id" = "nj2JTMmr";
    ...
    in {
        ...
        "pkg-1.0.1+1.21.1" = _3A2efgGw;
        "pkg-1.0.1+1.21.10" = _EwIxJECr;
        "pkg-1.0.2+1.21.1" = _6A73keu9;
        "pkg-1.0.2+1.21.10" = _Tow8bUtj;
        "pkg-1.0.3+1.21.10-neoforge" = _YuQXuqO2;
        "pkg-1.0.3+1.21.1-neoforge" = _VuqNlzOT;
        "pkg-1.0.3+1.21.1-fabric" = _yscCCwmN;
        "pkg-1.0.3+1.21.10-fabric" = _2Cq1ZEMM;
        "pkg-1.0.4+1.21.10-neoforge" = _1XIamyAT;
        "pkg-1.0.4+1.21.1-neoforge" = _WbjFEKUP;
        "pkg-1.0.4+1.21.1-fabric" = _vSTiqrJT;
        "pkg-1.0.4+1.21.10-fabric" = _4LfE3d6C;
        "pkg-1.0.5+1.21.11-neoforge" = _1fsbFm8e;
        "pkg-1.0.5+1.21.11-fabric" = _QWgT37NC;
        "pkg-1.0.6+1.21.1-neoforge" = _kPKe6aDJ;
        "pkg-1.0.6+1.21.10-neoforge" = _rUea2FpY;
        "pkg-1.0.6+1.21.11-neoforge" = _wzjIgif8;
        "pkg-1.0.6+1.21.11-fabric" = _k011AGqP;
        "pkg-1.0.6+1.21.10-fabric" = _39xKYNUP;
        "pkg-1.0.6+1.21.1-fabric" = _e0MEudMS;
        "pkg-1.0.7+1.21.11-neoforge" = _ZzZ96cQw;
        "pkg-1.0.7+1.21.1-neoforge" = _yLORCy64;
        "pkg-1.0.7+1.21.10-neoforge" = _mTXP2xRq;
        "pkg-1.0.7+1.21.11-fabric" = _hPgmypCG;
        "pkg-1.0.7+1.21.1-fabric" = _YKcCpzV2;
        "pkg-1.0.7+1.21.10-fabric" = _rBqZHRHw;
        "pkg-1.0.8+1.21.1-neoforge" = _Fu0EuZC9;
        "pkg-1.0.8+1.21.11-fabric" = _3cS6i7cg;
        "pkg-1.0.8+1.21.1-fabric" = _GfWlBbZE;
        "pkg-1.0.8+1.21.11-neoforge" = _4j2oqvvd;
        "pkg-1.0.9+26.1-neoforge" = _vSZdd6D0;
        "pkg-1.0.9+26.1-fabric" = _vkkyoFF4;
        "pkg-1.0.10+26.1-neoforge" = _ZnWeXpZU;
        "pkg-1.0.10+26.1-fabric" = _dDCANr1C;
        "pkg-1.0.11+26.1-neoforge" = _kDbAunBJ;
        "pkg-1.0.11+26.1-fabric" = _isyPhFwq;
        "pkg-1.0.12+26.1-fabric" = _qAVZvxC2;
        "pkg-1.0.12+26.1-neoforge" = _9ndpvd9e;
        "pkg-1.0.13+26.2-fabric" = _2vuYUOJe;
