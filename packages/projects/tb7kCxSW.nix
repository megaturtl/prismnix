...
let
    versions = (let
        ...
        _x1RgKN9p = {
            "id" = "x1RgKN9p";
            "file" = "extshape-fabric-3.1.6-beta.8+mc26.3-snapshot-7.jar";
            "hash" = "sha512-p5qBGRTYl19FN2zIOZXgjqa8jurfnK7qLgdoRDdM/tN0QYUMlVSKXQJMgRQzMUug/gfNDQUJEO84PhG7Stq3og==";
        };
        _gm4jpnS2 = {
            "id" = "gm4jpnS2";
            "file" = "extshape-fabric-3.1.6-beta.9+mc26.3-snapshot-8.jar";
            "hash" = "sha512-cCPLCFdVi78ooLHCGse17Dpiq5FCQL1PQYQEncEWosWxR1opwjsH4bkmbWKnQMHAEbAarj0SGBLza4doiAkTsg==";
        };
        _jxKKIo2x = {
            "id" = "jxKKIo2x";
            "file" = "extshape-fabric-3.1.6-beta.10+mc26.3-snapshot-9.jar";
            "hash" = "sha512-l6V24iWRPRhoC1taXlRQPqPz+FyEqzNwDS8G1T6Jf29Bo/BcyYZcY2dOoWC6acKqri3ilAtHfYbqyLtW5rcnFw==";
        };
        _tpLWYAbp = {
            "id" = "tpLWYAbp";
            "file" = "extshape-fabric-3.1.6-beta.11+mc26.3-snapshot-10.jar";
            "hash" = "sha512-2DFkdabar2LjQZkZEhSM5tCJDKtKiENxJ2DmKMJRtR9TkNf016ZN1uVxvUlqJBvqPick1SmCm405Z032Pht6Yg==";
        };
        _jjOlAgQn = {
            "id" = "jjOlAgQn";
            "file" = "extshape-fabric-3.1.6-beta.12+mc26.3-pre-1.jar";
            "hash" = "sha512-PhY1FnFkYiUzpiuVaJiYTqL2j2uxG+ZSYniKlggdDHzj6lu9Iny5OHj4ZtUBEMG6CJsTZdUzPqvj8mQpl4qR5Q==";
        };
        _imqIAjp7 = {
            "id" = "imqIAjp7";
            "file" = "extshape-fabric-3.1.6-rc.1+mc26.3-rc-2.jar";
            "hash" = "sha512-GuL1jApggYjlOrKTaBhaIzq9nfd0XGx15QpL3BGxac8iTjuaRySVOQcDHPrKgZufN/rBVGUzpG2Pt+sQYGj2ig==";
        };
        _6Xl00rKe = {
            "id" = "6Xl00rKe";
    ...
    in {
        ...
        "fabric-26.3-snapshot-7" = _x1RgKN9p;
        "fabric-26.3-snapshot-8" = _gm4jpnS2;
        "fabric-26.3-snapshot-9" = _jxKKIo2x;
        "fabric-26.3-snapshot-10" = _tpLWYAbp;
        "fabric-26.3-pre-1" = _jjOlAgQn;
        "fabric-26.3-rc-2" = _imqIAjp7;
        "fabric-26.3" = _6Xl00rKe;
        ...
        "pkg-1.5.1" = _Cm6WTbUN;
        "pkg-1.5.2" = _roC64Mqr;
        "pkg-1.5.2-forge" = _4u5Xugs7;
        "pkg-1.6.0-fabric-1.16.5" = _FfH3qeL9;
        "pkg-1.6.0-fabric-1.17.1" = _xpBTjbno;
        "pkg-1.6.0-fabric-1.18.1" = _4LjBSUU8;
        "pkg-1.6.0-fabric-1.18.2" = _rQHr8LyP;
        "pkg-1.6.0-fabric-1.19" = _31kipbRd;
        "pkg-1.6.0-forge-1.16.5" = _mq8wYqMw;
        "pkg-1.6.0-forge-1.17.1" = _zNOPRpbj;
        "pkg-1.6.0-forge-1.18.1" = _DRThYbm7;
        "pkg-1.6.0-forge-1.18.2" = _f6ljCwx3;
        "pkg-1.6.0" = _1UpmbFT3;
        "pkg-1.6.1-forge-1.16.5" = _yYhJb3xW;
        "pkg-1.6.1-forge-1.17.1" = _tkhIFwh7;
        "pkg-1.6.1-forge-1.18.1" = _3AAdO7I7;
        "pkg-1.6.1-forge-1.18.2" = _LZUn5bmP;
        "pkg-1.6.1-forge-1.19" = _SPR3xqwO;
        "pkg-1.7.0-fabric-1.16.5" = _fV2p32MH;
        "pkg-1.7.0-fabric-1.17.1" = _JDpe8BUz;
        "pkg-1.7.0-fabric-1.18.1" = _umqL4CYF;
        "pkg-1.7.0-fabric-1.18.2" = _rLMWY3GT;
        "pkg-1.7.0-fabric-1.19.2" = _65OX8Llf;
        "pkg-1.7.0-fabric-22w43a" = _GBiMOL1g;
        "pkg-1.7.1-fabric-1.16.5" = _FUL1dFhO;
        "pkg-1.7.1-fabric-1.17.1" = _4u8w4GmZ;
        "pkg-1.7.1-fabric-1.18.1" = _lUjUEx6q;
        "pkg-1.7.1-fabric-1.18.2" = _YgJ2fwuM;
        "pkg-1.7.1-fabric-1.19.2" = _7SsxnRCb;
        "pkg-1.7.1-forge-1.16.5" = _Y0P99wX3;
        "pkg-1.7.1-forge-1.17.1" = _pyEaI33U;
        "pkg-1.7.1-forge-1.18.1" = _tdgTgR2f;
        "pkg-1.7.1-forge-1.18.2" = _LX5AxHFd;
        "pkg-1.7.1-forge-1.19.2" = _IGJCPnK3;
        "pkg-1.7.1-build.1-fabric-22w45a" = _u5z8eMR1;
        "pkg-1.7.2-build.1-fabric-22w45a" = _Iwn0pC5V;
        "pkg-1.7.2-fabric-1.19.2" = _GOJfq0Wg;
        "pkg-1.7.2-build.1-fabric-1.19.3-pre2" = _HJcHOlhv;
        "pkg-1.7.2-fabric-1.19.3" = _GVqRHGNd;
        "pkg-1.8.0-fabric-1.19.3" = _ACgcWu80;
        "pkg-1.8.0-fabric-1.19.2" = _q1wx0qoE;
        "pkg-1.8.0-fabric-1.18.2" = _j9nkjfjm;
        "pkg-1.8.0-fabric-1.18.1" = _P3Z9KA1F;
        "pkg-1.8.0-fabric-1.17.1" = _9z8n93vL;
        "pkg-1.8.0-fabric-1.16.5" = _2uvSQYAc;
        "pkg-1.8.0-forge-1.19.3" = _w963hnRm;
        "pkg-1.8.0-forge-1.18.2" = _6AFAMGRb;
        "pkg-1.8.0-forge-1.18.1" = _3EqgkDDr;
        "pkg-1.8.0-forge-1.17.1" = _zuVIRVAg;
        "pkg-1.8.0-forge-1.16.5" = _qHarRyUx;
        "pkg-1.8.0-forge-1.19.2" = _capMSWkY;
        "pkg-1.8.1-build.1-fabric-23w07a" = _bKlVtoUa;
        "pkg-1.8.1-fabric-1.19.4" = _SQwh1f8Y;
        "pkg-1.9.0-beta.1-fabric-1.19.4" = _DhXeCjlg;
        "pkg-1.9.0-fabric-1.19.4" = _rsbIQ5s9;
        "pkg-2.0.0-fabric-1.16.5" = _nLuFmPkW;
        "pkg-2.0.0-fabric-1.17.1" = _mcZD6Kjh;
        "pkg-2.0.0-fabric-1.18.1" = _Qc5AnjkA;
        "pkg-2.0.0-fabric-1.18.2" = _z6vmj0u0;
        "pkg-2.0.0-fabric-1.19.2" = _7X3yl6Id;
        "pkg-2.0.0-fabric-1.19.3" = _fPrsnvYK;
        "pkg-2.0.0-fabric-1.19.4" = _hpyCSrwd;
        "pkg-2.0.0-forge-1.16.5" = _tQapphHA;
        "pkg-2.0.0-forge-1.17.1" = _cOuOnKVY;
        "pkg-2.0.0-forge-1.18.1" = _CJZzuZ39;
        "pkg-2.0.0-forge-1.18.2" = _C0vdq2a1;
        "pkg-2.0.0-forge-1.19.2" = _YozJ6bCx;
        "pkg-2.0.0-forge-1.19.3" = _Gukos7r5;
        "pkg-2.0.0-forge-1.19.4" = _9yiO4VkV;
        "pkg-2.0.0-beta.1-fabric-1.20-pre1" = _hpkegzIE;
        "pkg-2.0.0-beta.2-fabric-1.20-pre4" = _bNr1Khp3;
        "pkg-2.0.0-fabric-1.20" = _Fy4OB9gO;
        "pkg-2.0.1-fabric-1.20.1" = _QUyyCEud;
        "pkg-2.0.2-fabric-1.20.1" = _rPjbQwG3;
        "pkg-2.0.2-fabric-1.19.4" = _kC0XgZ32;
        "pkg-2.0.2-fabric-1.19.3" = _cfdFa2vV;
        "pkg-2.0.2-fabric-1.19.2" = _sFqYijgW;
        "pkg-2.0.2-fabric-1.18.2" = _qYaHfkOQ;
        "pkg-2.0.3-fabric-1.20.1" = _wo5AJrSO;
        "pkg-2.0.3-fabric-1.19.4" = _Il7XutuH;
        "pkg-2.0.3-fabric-1.19.3" = _J5wlVzY5;
        "pkg-2.0.3-fabric-1.19.2" = _s699n8Jo;
        "pkg-2.0.3-fabric-1.18.2" = _InVbAgSi;
        "pkg-2.0.3-beta.1-fabric-1.20.2-pre4" = _bsVBhLsR;
        "pkg-2.0.3-fabric-1.20.2" = _mJ8EOtQk;
        "pkg-2.0.5-fabric-1.18.2" = _aO5wAYxW;
        "pkg-2.0.5-fabric-1.19.2" = _NeQ5NPs8;
        "pkg-2.0.5-fabric-1.19.4" = _JCKYacSK;
        "pkg-2.0.5-fabric-1.20.1" = _bvvTOUYo;
        "pkg-2.0.5-fabric-1.20.2" = _inClrSnK;
        "pkg-2.0.6-beta.1-fabric-1.20.4" = _gRl5ZSo1;
        "pkg-2.0.7-fabric-1.20.4" = _HfEWkv8q;
        "pkg-2.0.7-fabric-1.20.2" = _NXbKR0hn;
        "pkg-2.0.7-fabric-1.20.1" = _Xg2KVU8J;
        "pkg-2.0.5-forge-1.19.2" = _BKKNnM8u;
        "pkg-2.0.8-fabric-1.20.4" = _ZyHNo3tq;
        "pkg-2.0.8-fabric-1.20.2" = _rVu50eTh;
        "pkg-2.0.8-fabric-1.20.1" = _lhOjVgQz;
        "pkg-2.0.5-forge-1.19.4" = _oFpQTRI3;
        "pkg-2.0.5-forge-1.19.3" = _PFrQRjfU;
        "pkg-2.0.9-fabric-1.20.4" = _iB4XUaHS;
        "pkg-2.0.9-fabric-1.20.2" = _CU1qE7vB;
        "pkg-2.0.9-fabric-1.20.1" = _GFPMmAWs;
        "pkg-2.1.0-fabric-1.20.4" = _KHAJ102z;
        "pkg-2.1.0-fabric-1.20.2" = _sfO4QO8E;
        "pkg-2.1.0-fabric-1.20.1" = _BFfgfMnI;
        "pkg-2.1.0-fabric-1.19.4" = _M59wP5mi;
        "pkg-2.1.0-fabric-1.19.3" = _mjUteqDc;
        "pkg-2.1.0-fabric-1.19.2" = _Y0LXqj1u;
        "pkg-2.1.0-fabric-1.18.2" = _nX0yXhoe;
        "pkg-2.1.1-fabric-1.20.4" = _Uk8K8O01;
        "pkg-2.1.1-fabric-1.20.2" = _YuoufTIc;
        "pkg-2.1.1-fabric-1.20.1" = _3N2kwRV6;
        "pkg-2.1.1-fabric-1.19.4" = _XkQ1EQr8;
        "pkg-2.1.1-fabric-1.19.3" = _9WMC7yFF;
        "pkg-2.1.1-fabric-1.19.2" = _cPofw3bQ;
        "pkg-2.1.1-fabric-1.18.2" = _q1gWsttN;
        "pkg-2.1.2-fabric-1.20.4" = _hb7LVyKf;
        "pkg-2.1.2-fabric-1.20.2" = _ABBGoxj3;
        "pkg-2.1.2-fabric-1.20.1" = _pKlS3DgB;
        "pkg-2.1.2-fabric-1.18.2" = _VykQ5sth;
        "pkg-2.1.2-fabric-1.19.2" = _j2RYbFjx;
        "pkg-2.1.2-fabric-1.19.3" = _RhPRPmi3;
        "pkg-2.1.2-fabric-1.19.4" = _8LTKsZCq;
        "pkg-2.1.2-alpha.1-fabric-24w10a" = _zMKYasGJ;
        "pkg-2.1.3-fabric-1.20.6" = _7olDB2JS;
        "pkg-2.1.4-fabric-1.21" = _amFwS7eS;
        "pkg-2.1.4-fabric-1.20.6" = _rbyvQmGZ;
        "pkg-2.1.4-fabric-1.20.4" = _9V3GLPuQ;
        "pkg-2.1.4-fabric-1.20.2" = _RukR9g2r;
        "pkg-2.1.4-fabric-1.20.1" = _uUwUrHwn;
        "pkg-2.1.5-fabric-1.20.6" = _xnfaeLfs;
        "pkg-2.2.0-fabric-1.21" = _SqdXyWoe;
        "pkg-2.2.0-fabric-1.20.6" = _YNi7aqv2;
        "pkg-2.2.0-fabric-1.20.4" = _kWS6ERcG;
        "pkg-2.2.0-fabric-1.20.2" = _BOeFMfpg;
        "pkg-2.2.0-fabric-1.20.1" = _gWVWao3a;
        "pkg-2.2.0-fabric-1.19.4" = _vueJ31qf;
        "pkg-2.2.0-fabric-1.19.3" = _pSBw8tcm;
        "pkg-2.2.0-fabric-1.19.2" = _HxNLQ1BD;
        "pkg-2.2.0-fabric-1.18.2" = _U8uiusqt;
        "pkg-2.2.1-fabric-1.21" = _IoJDKioR;
        "pkg-2.2.1-fabric-1.20.6" = _VlhFHlRQ;
        "pkg-2.2.1-fabric-1.20.4" = _PwWB06OE;
        "pkg-2.2.1-fabric-1.20.2" = _KJBZVabO;
        "pkg-2.2.1-fabric-1.20.1" = _wwZSuY99;
        "pkg-2.2.1-fabric-1.19.4" = _1l66ZAYW;
        "pkg-2.2.1-fabric-1.19.3" = _LGn5C5LQ;
        "pkg-2.2.1-fabric-1.19.2" = _t0A0n04r;
        "pkg-2.2.1-fabric-1.18.2" = _cN4X2mAb;
        "pkg-2.2.2-fabric-1.21.1" = _2gfQOKtm;
        "pkg-2.2.2-fabric-1.20.6" = _3zax0102;
        "pkg-3.0.0-beta.1-fabric-1.21.1" = _PQDiNy7S;
        "pkg-3.0.0-beta.9-fabric-1.19.4" = _55u3QPsZ;
        "pkg-3.0.0-beta.10-fabric-1.21.1" = _k9I9ZBwT;
        "pkg-3.0.0-beta.10-fabric-1.20.6" = _vLOpLxt5;
        "pkg-3.0.0-beta.10-fabric-1.20.4" = _VsUd4XjM;
        "pkg-3.0.0-beta.10-fabric-1.20.2" = _5f0VEfxt;
        "pkg-3.0.0-beta.11-fabric-1.20.1" = _NBPmV83g;
        "pkg-3.0.0-fabric-1.21.1" = _QM1p0foX;
        "pkg-3.0.0-fabric-1.20.6" = _N1YUxbhG;
        "pkg-3.0.0-fabric-1.20.4" = _xMfqlaNM;
        "pkg-3.0.0-fabric-1.20.2" = _CMolXpw9;
        "pkg-3.0.0-fabric-1.20.1" = _1FIDmdfC;
        "pkg-3.0.0-fabric-1.19.4" = _nEGkInDB;
        "pkg-3.0.0-beta.1-fabric-24w40a" = _hffpvYqP;
        "pkg-3.0.1-fabric-1.21.1" = _JKxYBVMT;
        "pkg-3.0.1-fabric-1.20.6" = _3U665vwx;
        "pkg-3.0.1-fabric-1.20.4" = _2hCapSSJ;
        "pkg-3.0.1-fabric-1.20.2" = _dxQTOUKC;
        "pkg-3.0.1-fabric-1.20.1" = _4t8N7Feb;
        "pkg-3.0.1-fabric-1.19.4" = _gLP7vabx;
        "pkg-3.0.1-beta.1-fabric-1.21.2-pre1" = _cMtPlHbq;
        "pkg-3.0.2-fabric-1.21.1" = _VqquRqz1;
        "pkg-3.0.2-beta.1-fabric-1.21.2-pre5" = _d2Ts8FEY;
        "pkg-3.0.2-fabric-1.20.6" = _dBiBBuP1;
        "pkg-3.0.2-fabric-1.20.4" = _9YcY6vTv;
        "pkg-3.0.2-fabric-1.20.2" = _bv8QSnvT;
        "pkg-3.0.2-fabric-1.20.1" = _cR4tVkTZ;
        "pkg-3.0.3-fabric-1.19.4" = _THclVCvv;
        "pkg-3.0.3-fabric-1.21.1" = _ROASDn0t;
        "pkg-3.0.3-fabric-1.20.6" = _4hutYrCE;
        "pkg-3.0.3-fabric-1.20.4" = _xinPtgM2;
        "pkg-3.0.3-fabric-1.20.2" = _oLAqoRKJ;
        "pkg-3.0.3-fabric-1.20.1" = _6sHLRt4w;
        "pkg-3.0.4-fabric-1.19.4" = _XK2auMUT;
        "pkg-3.0.4-fabric-1.20.1" = _slGeQnjX;
        "pkg-3.0.4-fabric-1.20.2" = _4Z4F1jWL;
        "pkg-3.0.4-fabric-1.20.4" = _N72Yx5r4;
        "pkg-3.0.4-fabric-1.20.6" = _uKysXS19;
        "pkg-3.0.4-fabric-1.21.1" = _iY5DnFGq;
        "pkg-3.0.4-fabric-1.21.3" = _SFnYMIxQ;
        "pkg-3.0.4-beta.1-fabric-24w44a" = _eiUiBVO6;
        "pkg-3.0.4-beta.2-fabric-1.21.4-pre1" = _RKhSR92q;
        "pkg-3.0.5-beta.1-fabric-1.21.4-pre1" = _lkXRk1BW;
        "pkg-3.0.5-beta.1-fabric-1.21.3" = _H62syYfT;
        "pkg-3.0.5-beta.1-fabric-1.21.4-pre2" = _Gx0r5PVH;
        "pkg-3.0.5-fabric-1.21.3" = _ABrQS4iP;
        "pkg-3.0.6-beta.1-fabric-1.21.4" = _sB5v6GXL;
        "pkg-3.0.6-fabric-1.21.1" = _6uTPr1yq;
        "pkg-3.0.6-fabric-1.21.3" = _n0jwpHaj;
        "pkg-3.0.6-fabric-1.21.4" = _133QxsM3;
        "pkg-3.0.6-fabric-1.20.6" = _tvuUUg89;
        "pkg-3.0.6-fabric-1.20.2" = _5kUWHkRH;
        "pkg-3.0.6-fabric-1.20.4" = _T3jGWOni;
        "pkg-3.0.6-fabric-1.20.1" = _JEgF5m9d;
        "pkg-3.0.6-fabric-1.19.4" = _BhtrpP5X;
        "pkg-3.1.0-fabric-1.21.4" = _iyrHCUmX;
        "pkg-3.1.0-fabric-1.21.3" = _HSjqMyAX;
        "pkg-3.1.0-fabric-1.21.1" = _bNFbdOMC;
        "pkg-3.1.0-fabric-1.20.6" = _pVB5pl09;
        "pkg-3.1.0-fabric-1.20.4" = _pxXGpEHE;
        "pkg-3.1.0-fabric-1.20.2" = _maYbuMsw;
        "pkg-3.1.0-fabric-1.20.1" = _kgRVLRDg;
        "pkg-3.1.0-beta.1-fabric-1.21.5-rc1" = _5xeNGFZi;
        "pkg-3.1.0-fabric-1.21.5" = _bKdcOtaH;
        "pkg-3.1.1-fabric-1.21.1" = _UXRUyVtY;
        "pkg-3.1.0-beta.1-fabric-1.21.6-rc1" = _suEy5hy8;
        "pkg-3.1.1-fabric-1.21.8" = _GPlW1xaS;
        "pkg-3.1.1-fabric-25w34b" = _PJADiiUm;
        "pkg-3.1.1-fabric-1.21.10" = _RmYsnqyV;
        "pkg-3.1.2-fabric-1.21.11" = _LHYwohkw;
        "pkg-3.1.2-fabric-1.21.10" = _38zGhMcf;
        "pkg-3.1.2-fabric-1.21.8" = _9Q92cgyN;
        "pkg-3.1.2-fabric-1.21.5" = _WBoc85OJ;
        "pkg-3.1.2-fabric-1.21.4" = _kjILe8nh;
        "pkg-3.1.2-fabric-1.21.3" = _AnSvLst0;
        "pkg-3.1.2-fabric-1.21.1" = _z6RWqo2T;
        "pkg-2.2.1.9-rc.1-fabric-1.19.2" = _RUcTH1zK;
        "pkg-2.2.1.9-fabric-1.19.2" = _ebpXpu09;
        "pkg-3.1.3-beta.1-fabric-26.1" = _OCxvIaM1;
        "pkg-3.1.3-fabric-1.21.11" = _IkjtbFfw;
        "pkg-3.1.3-fabric-26.1" = _7eBtFARl;
        "pkg-3.1.4.1-beta.1-fabric" = _vYb4hlQE;
        "pkg-3.1.5-fabric-26.2" = _f8MdC7H2;
        "pkg-3.1.5-fabric-26.1.2" = _4NZxHdaz;
        "pkg-3.1.5-fabric-1.21.11" = _zAArLq1O;
        "pkg-3.1.6-beta.1+mc26.3-snapshot-1" = _1u8xRYaN;
        "pkg-3.1.6-beta.3-fabric-26.2" = _cQDWA7oD;
        "pkg-3.1.6-beta.4+mc26.3-snapshot-2" = _k5EbydQ6;
        "pkg-3.1.6-beta.5+mc26.3-snapshot-3" = _2TtCGfBz;
        "pkg-3.1.6-fabric-26.1.2" = _793fgHD3;
        "pkg-3.1.6-fabric-26.2" = _Prib5pxt;
        "pkg-3.1.6-beta.6+mc26.3-snapshot-5" = _D1UF2FpJ;
        "pkg-3.1.6-beta.7+mc26.3-snapshot-6" = _2jdLSiHV;
        "pkg-3.1.6-beta.8+mc26.3-snapshot-7" = _x1RgKN9p;
        "pkg-3.1.6-beta.9+mc26.3-snapshot-8" = _gm4jpnS2;
        "pkg-3.1.6-beta.10+mc26.3-snapshot-9" = _jxKKIo2x;
        "pkg-3.1.6-beta.11+mc26.3-snapshot-10" = _tpLWYAbp;
