...
let
    ...
    in {
        ...
        "pkg-0.8.0" = _rV3fZVqm;
        "pkg-0.8.1" = _n4gstHkA;
        "pkg-0.8.1+1.19" = _R0O7j3v0;
        "pkg-0.9.0" = _U835Vrzt;
        "pkg-0.9.0+1.19" = _bgoDBhxb;
        "pkg-0.9.1" = _9nfmYmfw;
        "pkg-0.9.1+1.19" = _gO6KYXwT;
        "pkg-1.0.0" = _uqEgN9Up;
        "pkg-1.0.0+1.19" = _JE9TvW14;
        "pkg-1.1.0" = _lwlZHNoH;
        "pkg-1.1.0+1.19" = _C9qUJgKR;
        "pkg-1.1.1" = _VmGlgqjl;
        "pkg-1.1.1+1.19.3" = _MEcb2aaw;
        "pkg-1.1.2" = _sCsk5fXb;
        "pkg-1.1.2+1.19.3" = _KVODAUu2;
        "pkg-1.2.0" = _jlZQaJLl;
        "pkg-1.2.0+1.19.2" = _MdRrRAPN;
        "pkg-1.2.0+1.19.3" = _pCM8zI29;
        "pkg-1.2.1+1.19.2" = _1Wp5bR6h;
        "pkg-1.2.1+1.19.3" = _fb6Nzid3;
        "pkg-1.2.2+1.20" = _KyNRG66R;
        "pkg-1.2.3" = _diYStB01;
        "pkg-1.2.3+1.19.2" = _1NP0gBcL;
        "pkg-1.2.3+1.19.3" = _bSyfHTig;
        "pkg-1.2.3+1.20" = _D95yzRU4;
        "pkg-1.3.0" = _dwEZ4XjS;
        "pkg-1.3.1" = _PUNtds04;
        "pkg-1.3.1+1.19.2" = _cVXifsUV;
        "pkg-1.3.1+1.19.3" = _6CD1D59S;
        "pkg-1.3.1+1.20.1" = _xkzr1l79;
        "pkg-1.3.2" = _xWBDwK6d;
        "pkg-1.3.2-1.19.2" = _PSQgpneS;
        "pkg-1.3.2-1.19.3" = _Lw3p2Uke;
        "pkg-1.3.2-1.20.1" = _1g0S2AZu;
        "pkg-1.3.3" = _3zXmBERo;
        "pkg-1.3.3-1.19.2" = _bUydHJAH;
        "pkg-1.3.3-1.19.3" = _rO6mUnbb;
        "pkg-1.3.3-1.20.1" = _zIj5S3MI;
        "pkg-1.3.4-1.19.2" = _P53hpMIV;
        "pkg-1.3.4-1.19.4" = _GlTDRSUf;
        "pkg-1.3.4-1.20.1" = _IQzbczjG;
        "pkg-1.3.4-1.20.5" = _pZvBgnbl;
        "pkg-1.3.4-1.21" = _su06W1DI;
        "pkg-1.3.5-1.16.5" = _V8xtKmCW;
        "pkg-1.3.5-1.18.2" = _TJrxtQiq;
        "pkg-1.3.5-1.19.2" = _QcmqHtaR;
        "pkg-1.3.5-1.19.4" = _mbA5hxqC;
        "pkg-1.3.5-1.20.1" = _w1YuFieR;
        "pkg-1.3.5-1.20.6" = _udE05K3o;
        "pkg-1.3.5-1.21" = _OziU6pF1;
        "pkg-1.4.0-1.16.5" = _hzWHRB3V;
        "pkg-1.4.0-1.18.2" = _WsTLCjYH;
        "pkg-1.4.0-1.19.2" = _k7vG9DEe;
        "pkg-1.4.0-1.19.4" = _x6KPH8dP;
        "pkg-1.4.0-1.20.1" = _yQYSmENE;
        "pkg-1.4.0-1.20.6" = _WAw2aZVf;
        "pkg-1.4.0-1.21" = _vpL7XjEN;
        "pkg-1.4.1-1.16.5" = _gxQcD98m;
        "pkg-1.4.1-1.18.2" = _pAZvKPFP;
        "pkg-1.4.1-1.19.2" = _cdmaOBKF;
        "pkg-1.4.1-1.19.4" = _K0R6SKva;
        "pkg-1.4.1-1.20.1" = _xR7Oeh7t;
        "pkg-1.4.1-1.20.6" = _My6mKTWy;
        "pkg-1.4.1-1.21" = _xyV39TUk;
        "pkg-1.4.2-1.16.5" = _zPK6lwwz;
        "pkg-1.4.2-1.18.2" = _V7r5wJxt;
        "pkg-1.4.2-1.19.2" = _Ywn4AKQ6;
        "pkg-1.4.2-1.19.4" = _aYdzjQHo;
        "pkg-1.4.2-1.20.1" = _YoF5nXoK;
        "pkg-1.4.2-1.20.6" = _gRPOmTnE;
        "pkg-1.4.2-1.21" = _KP5nNwzc;
        "pkg-1.4.3-1.16.5" = _TbCC16Eg;
        "pkg-1.4.3-1.18.2" = _qwvPmGXp;
        "pkg-1.4.3-1.19.2" = _Kt9hum0N;
        "pkg-1.4.3-1.19.4" = _JzYxV6lU;
        "pkg-1.4.3-1.20.1" = _wQS4nP6B;
        "pkg-1.4.3-1.20.6" = _5j4TxoB7;
        "pkg-1.4.3-1.21" = _GNq5nrYn;
        "pkg-1.4.3-1.21.3" = _jM5VWD8S;
        "pkg-1.4.4-1.21.4" = _3Ea5oRLK;
        "pkg-1.4.5-1.19.2" = _e4vJnpyM;
        "pkg-1.4.5-1.20.1" = _QxDgAkxb;
        "pkg-1.4.6-1.21.5" = _q1TD7v1U;
        "pkg-1.4.6-1.21.4" = _EBwWcYgf;
        "pkg-1.4.6-1.21.3" = _cKpZmK6O;
        "pkg-1.4.6-1.21" = _i1YWFoMF;
        "pkg-1.4.6-1.20.6" = _jMmC59rj;
        "pkg-1.4.6-1.20.1" = _8rWMPqKi;
        "pkg-1.4.6-1.19.4" = _ChW3UOJm;
        "pkg-1.4.6-1.19.2" = _3YfpI6un;
        "pkg-1.4.6-1.18.2" = _FLndTH7d;
        "pkg-1.4.6-1.17.1" = _9smMR82u;
        "pkg-1.4.6-1.16.5" = _4ezI3TUm;
        "pkg-1.4.7-1.16.5" = _hIYiZVSX;
        "pkg-1.4.7-1.17.1" = _nBOz2K6C;
        "pkg-1.4.7-1.18.2" = _31sxXWTd;
        "pkg-1.4.7-1.19.2" = _ZPEpNvyj;
        "pkg-1.4.7-1.19.4" = _r2HTTFit;
        "pkg-1.4.7-1.20.1" = _cYWX1aNG;
        "pkg-1.4.7-1.20.6" = _9biDsh3q;
        "pkg-1.4.7-1.21" = _HOjegS8s;
        "pkg-1.4.7-1.21.3" = _NUPhEFRt;
        "pkg-1.4.7-1.21.4" = _9thOqLy1;
        "pkg-1.4.7-1.21.5" = _jgwiLb6u;
        "pkg-1.4.8-1.21.6" = _xQAyzgT3;
        "pkg-1.4.9-1.21.9" = _YeXlKFea;
        "pkg-1.4.10-1.21" = _WuJvBoBV;
        "pkg-1.4.10-1.21.3" = _W51SsH8B;
        "pkg-1.4.10-1.21.4" = _d4oGyFRi;
        "pkg-1.4.10-1.21.5" = _QqzmaQHJ;
        "pkg-1.4.10-1.21.6" = _4mBQzcy9;
        "pkg-1.4.10-1.21.9" = _Rc1Z1vQ7;
        "pkg-1.4.11-1.16.5" = _A2X4yp95;
        "pkg-1.4.11-1.17.1" = _ZQN01aMT;
        "pkg-1.4.11-1.18.2" = _eL77CYxB;
        "pkg-1.4.11-1.19.2" = _WmbRKNkW;
        "pkg-1.4.11-1.19.4" = _PHK9ZzGw;
        "pkg-1.4.11-1.20.1" = _IK5DFa2H;
        "pkg-1.4.11-1.20.6" = _qa9XYu9h;
        "pkg-1.4.11-1.21" = _osYLORm3;
        "pkg-1.4.11-1.21.3" = _e2iJqIAH;
        "pkg-1.4.11-1.21.4" = _tbsMzgHu;
        "pkg-1.4.11-1.21.5" = _bk5vKxJM;
        "pkg-1.4.11-1.21.6" = _PyAu544L;
        "pkg-1.4.11-1.21.9" = _eKR8crdW;
        "pkg-1.4.12-1.16.5" = _bxgYoA4f;
        "pkg-1.4.12-1.17.1" = _jb11rqKX;
        "pkg-1.4.12-1.18.2" = _PlY7iHZA;
        "pkg-1.4.12-1.19.2" = _dMlcqxQg;
        "pkg-1.4.12-1.19.4" = _3KtHmeHU;
        "pkg-1.4.12-1.20.1" = _Wo8C0uFO;
        "pkg-1.4.12-1.20.6" = _9ehkPE4H;
        "pkg-1.4.12-1.21" = _XBlPyKyb;
        "pkg-1.4.12-1.21.3" = _mKnn2SRe;
        "pkg-1.4.12-1.21.4" = _TkxajiPp;
        "pkg-1.4.12-1.21.5" = _ACEwZEYU;
        "pkg-1.4.12-1.21.6" = _1iTB3bvZ;
        "pkg-1.4.12-1.21.9" = _rUWS5YRQ;
        "pkg-1.5.0-1.21.9" = _aTPmC0Pm;
        "pkg-1.5.1-1.21.9" = _EUEzyDHJ;
        "pkg-1.5.2-26.1.1" = _dmezx7Ef;
        "pkg-1.5.3-26.1.1" = _XLhTJaPD;
        "pkg-1.5.4-26.2" = _U0oMicWb;
        "pkg-1.4.13-1.16.5" = _w24Diizi;
        "pkg-1.4.13-1.17.1" = _pcvP6lLt;
        "pkg-1.4.13-1.18.2" = _t4OAhosJ;
        "pkg-1.4.13-1.19.2" = _iwzEV47M;
        "pkg-1.4.13-1.19.4" = _5Wj3y368;
        "pkg-1.4.13-1.20.1" = _hzXzfMba;
        "pkg-1.4.13-1.20.6" = _7Dzh8X2R;
        "pkg-1.4.13-1.21" = _yAkfP4oI;
        "pkg-1.4.13-1.21.3" = _xRGDMKBo;
        "pkg-1.4.13-1.21.4" = _G3O626M0;
        "pkg-1.4.13-1.21.5" = _szwwP70C;
        "pkg-1.4.13-1.21.6" = _qUJQPwXB;
