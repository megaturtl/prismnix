...
let
    versions = (let
        ...
        _BRkk8RIu = {
            "id" = "BRkk8RIu";
            "file" = "Whimscape_1.20.2-1.21.11_r6.zip";
            "hash" = "sha512-Uzire67nktiQnHfne9chYTNSl365f3kvc11mPEwiPbWePCwLulG2nC0bZ4++4xXyyIJ8Xa+S3XYLsHXGeberOA==";
        };
        _yaX35qnW = {
            "id" = "yaX35qnW";
            "file" = "Whimscape_26.1-26.3_r1.zip";
            "hash" = "sha512-+/m4AwP4muknaBom8gLUfD5EZox0VXHiCY+ssWlXnJumGUL7tqO0cR43FGVCiwKx3IJy6Na4eqnkv0k4mK+kpw==";
        };
        _qQLsDTnE = {
            "id" = "qQLsDTnE";
            "file" = "Whimscape_1.20-1.20.1_r10.zip";
            "hash" = "sha512-3cENK97SxmPx1cJUlL0Qjof1lCBLDRya0nFuZWqahV28g0SNLOJ6akYoYswIRWFzeaxK62XxYhkUZcxo8qkGgw==";
        };
        _MZrgxKQu = {
            "id" = "MZrgxKQu";
            "file" = "Whimscape_26.1-26.3_r2.zip";
            "hash" = "sha512-x9Vtktic7ojNY3TtoovqIUKI04LvzLeUh04vUK+SfFO5vBU0uJW4fvTFnMVBqr/7Lzo1LrTzsFP1/+3AMargJw==";
        };
    in {
        "Z8VKmfWB" = _Z8VKmfWB;
        "7JffzAFU" = _7JffzAFU;
        ...
        "minecraft-1.20" = _qQLsDTnE;
        "minecraft-1.20.1" = _qQLsDTnE;
        "minecraft-1.20.2" = _BRkk8RIu;
        "minecraft-1.20.3" = _BRkk8RIu;
        "minecraft-1.20.4" = _BRkk8RIu;
        "minecraft-1.20.5" = _BRkk8RIu;
        "minecraft-1.20.6" = _BRkk8RIu;
        "minecraft-1.21" = _BRkk8RIu;
        "minecraft-1.21.1" = _BRkk8RIu;
        "minecraft-1.21.2" = _BRkk8RIu;
        "minecraft-1.21.3" = _BRkk8RIu;
        "minecraft-1.21.4" = _BRkk8RIu;
        "minecraft-1.21.5" = _BRkk8RIu;
        "minecraft-1.16.2" = _B6KFzH4D;
        "minecraft-1.16.3" = _B6KFzH4D;
        "minecraft-1.16.4" = _B6KFzH4D;
        "minecraft-1.16.5" = _B6KFzH4D;
        "minecraft-1.21.6" = _BRkk8RIu;
        "minecraft-1.21.7" = _BRkk8RIu;
        "minecraft-1.21.8" = _BRkk8RIu;
        "minecraft-1.21.9" = _BRkk8RIu;
        "minecraft-1.21.10" = _BRkk8RIu;
        "minecraft-1.21.11" = _BRkk8RIu;
        "minecraft-26.1" = _MZrgxKQu;
        "minecraft-26.1.1" = _MZrgxKQu;
        "minecraft-26.1.2" = _MZrgxKQu;
        "minecraft-26.2" = _MZrgxKQu;
        "minecraft-26.3" = _MZrgxKQu;
        ...
        "pkg-1.20.2-1.21.11_r6" = _BRkk8RIu;
        "pkg-26.1-26.3_r1" = _yaX35qnW;
        "pkg-1.20-1.20.1_r10" = _qQLsDTnE;
        "pkg-26.1-26.3_r2" = _MZrgxKQu;
        "default" = _MZrgxKQu;
    });
