...
let
    versions = (let
        ...
        _Xl8OqIeD = {
            "id" = "Xl8OqIeD";
            "file" = "photon-neoforge-26.1-26.1.2.0.jar";
            "hash" = "sha512-Qnk65bW2QSJM9DZYTmEBUryB3CfYONiR40tUA7A8/kSDajQP+cPiiB+ooBUx7EIUhjdIHFjm9H0c7TYa3r2Tfg==";
        };
        _xBpjGNkJ = {
            "id" = "xBpjGNkJ";
            "file" = "photon-neoforge-1.21.1-2.2.3-all.jar";
            "hash" = "sha512-ktamMSMVwnh4zbVt36IJUHWQjht9DnN2pNhxuJtH+buOfbY1mCOzgaZ1fxuSOUPvk6i4fp374YUy4NUh/ko3vA==";
        };
        _I6VMwI6x = {
            "id" = "I6VMwI6x";
            "file" = "photon-neoforge-1.21.1-2.2.4-all.jar";
            "hash" = "sha512-xm6woc/LHAS09XhMMx0bP7ayiltr/BYBHWr0k/9t7V+QrokmeG11Cc65le5wpdabxjvSnLqOAEteaf3bJ6rMLg==";
        };
        _XflihBxE = {
            "id" = "XflihBxE";
            "file" = "photon-neoforge-26.1-26.1.2.1.jar";
            "hash" = "sha512-XdIXOoMcKLJuLd0AbsjM47k7gLZ2Z+iYryfiM3A1vkBdKEYH1fEjkoQ0zoBCUj15NPxSNJb5EiqvEk34/zrctQ==";
        };
        _RGRKZRt7 = {
            "id" = "RGRKZRt7";
            "file" = "photon-neoforge-1.21.1-2.2.5-all.jar";
            "hash" = "sha512-u6s+oCY/x9k+8MBXZEmra4F8DiqE3YeI8Kp/m01sTdZBNmDj1r6hFHzEDQtJRelEMFXPlqYy/+tuDKWWTWqqUA==";
        };
        _glu8ipw7 = {
            "id" = "glu8ipw7";
            "file" = "photon-neoforge-1.21.1-2.2.6-all.jar";
            "hash" = "sha512-+Osohs5vjKBP+3/wv209l08SHUBciuPE7muZKzOQXc9dAuSDblNf99Ob5xx3Jqp0rOYYq767nynhE9ds2wlcIA==";
        };
        _QnNHvquk = {
            "id" = "QnNHvquk";
    ...
    in {
        ...
        "pkg-1.0.1" = _1XZanT4W;
        "pkg-1.0.2" = _rabRGLmh;
        "pkg-mc1.19.4-fabric-1.0.2" = _TMJ8jB77;
        "pkg-mc1.19.4-forge-1.0.2" = _aGpsDBJ1;
        "pkg-mc1.20-fabric-1.0.2" = _AYshrlLo;
        "pkg-mc1.20-forge-1.0.2" = _oWICEloV;
        "pkg-mc1.19.2-fabric-1.0.3.a" = _GOqQtZsw;
        "pkg-mc1.19.2-forge-1.0.3.a" = _n9iT6kHd;
        "pkg-mc1.20-fabric-1.0.3.a" = _R6jDCjUl;
        "pkg-mc1.20-forge-1.0.3.a" = _CO04qHkp;
        "pkg-mc1.19.4-fabric-1.0.3.a" = _mxe5bspX;
        "pkg-mc1.19.4-forge-1.0.3.a" = _mZpIZfrr;
        "pkg-mc1.19.2-fabric-1.0.3.b" = _KHeMu8g0;
        "pkg-mc1.19.2-forge-1.0.3.b" = _ufzvzDAY;
        "pkg-mc1.19.4-fabric-1.0.3.b" = _oSUXhYwl;
        "pkg-mc1.19.4-forge-1.0.3.b" = _QthU10bT;
        "pkg-mc1.20-fabric-1.0.3.b" = _HAw2UM58;
        "pkg-mc1.20-forge-1.0.3.b" = _dUmEHUBm;
        "pkg-mc1.19.2-1.0.3.c-fabric" = _OqYlGAEF;
        "pkg-mc1.19.2-1.0.3.c-forge" = _Oz1TRMYF;
        "pkg-mc1.19.4-1.0.3.c-fabric" = _fvArRshh;
        "pkg-mc1.19.4-1.0.3.c-forge" = _w7SSZRnd;
        "pkg-mc1.20-1.0.3.c-fabric" = _BeG5uiJH;
        "pkg-mc1.20-1.0.3.c-forge" = _fVD9EBeB;
        "pkg-mc1.19.2-1.0.4-fabric" = _OMpB50YQ;
        "pkg-mc1.19.2-1.0.4-forge" = _OPrcuqrR;
        "pkg-mc1.20-1.0.4-fabric" = _fYpssdii;
        "pkg-mc1.20-1.0.4-forge" = _i0aFbYuK;
        "pkg-mc1.19.4-1.0.4-fabric" = _Y6Q3K62I;
        "pkg-mc1.19.4-1.0.4-forge" = _tAfISoGT;
        "pkg-mc1.20.1-1.0.4-fabric" = _fn4D7sSp;
        "pkg-mc1.20.1-1.0.4-forge" = _ccCdQ0a2;
        "pkg-mc1.19.2-1.0.4.a-fabric" = _NEtveqOy;
        "pkg-mc1.19.2-1.0.4.a-forge" = _jgIpNzLX;
        "pkg-mc1.20-1.0.4.a-fabric" = _yg4hmRa2;
        "pkg-mc1.20-1.0.4.a-forge" = _kX4BPI2Z;
        "pkg-mc1.20.1-1.0.4.a-fabric" = _umq1Sapg;
        "pkg-mc1.20.1-1.0.4.a-forge" = _L3dK99d9;
        "pkg-mc1.19.4-1.0.4.a-fabric" = _JjT5PFxs;
        "pkg-mc1.19.4-1.0.4.a-forge" = _a3hiraEK;
        "pkg-mc1.19.2-1.0.4.b-fabric" = _vmUmXVP1;
        "pkg-mc1.19.2-1.0.4.b-forge" = _9FqFitaO;
        "pkg-mc1.20.1-1.0.4.b-fabric" = _uQLERdfQ;
        "pkg-mc1.20.1-1.0.4.b-forge" = _CvSa6yS1;
        "pkg-mc1.20-1.0.4.b-fabric" = _htQR5pOB;
        "pkg-mc1.20-1.0.4.b-forge" = _e2Lu2JDE;
        "pkg-mc1.19.4-1.0.4.b-fabric" = _Pl7T8ggq;
        "pkg-mc1.19.4-1.0.4.b-forge" = _XAMUBRgx;
        "pkg-mc1.20.1-1.0.5-fabric" = _NNVSjTfO;
        "pkg-mc1.20-1.0.5-fabric" = _BRYoOoZK;
        "pkg-mc1.20.1-1.0.5-forge" = _FPALYLgL;
        "pkg-mc1.20-1.0.5-forge" = _2U9ouggL;
        "pkg-mc1.19.2-1.0.5-fabric" = _4gozEEC1;
        "pkg-mc1.19.2-1.0.5-forge" = _q2igQJoa;
        "pkg-mc1.19.4-1.0.5-fabric" = _EONlDMwk;
        "pkg-mc1.19.4-1.0.5-forge" = _hFCJMspl;
        "pkg-mc1.20.1-1.0.5.a-fabric" = _IuVRn7wY;
        "pkg-mc1.20.1-1.0.5.a-forge" = _Z1iqry89;
        "pkg-mc1.19.2-1.0.5.a-fabric" = _r7Gzde1B;
        "pkg-mc1.19.2-1.0.5.a-forge" = _IUxPWZS4;
        "pkg-mc1.19.2-1.0.5.b-forge" = _O4HJxuny;
        "pkg-mc1.20.1-1.0.6-fabric" = _aOvKJZxW;
        "pkg-mc1.20.1-1.0.6-forge" = _lsMMOmdH;
        "pkg-mc1.19.2-1.0.6-fabric" = _YiHakqX8;
        "pkg-mc1.19.2-1.0.6-forge" = _YU1hIn6r;
        "pkg-mc1.19.2-1.0.7-fabric" = _jf6MrcE3;
        "pkg-mc1.19.2-1.0.7-forge" = _fa9Ke0mn;
        "pkg-mc1.20.1-1.0.7-fabric" = _wn5OEla8;
        "pkg-mc1.20.1-1.0.7-forge" = _wcV7BeNn;
        "pkg-mc1.19.2-1.0.7.a-fabric" = _WhImODOk;
        "pkg-mc1.19.2-1.0.7.a-forge" = _eKScTE0u;
        "pkg-mc1.20.1-1.0.7.a-fabric" = _lOAk7648;
        "pkg-mc1.20.1-1.0.7.a-forge" = _Nqqr6UDw;
        "pkg-mc1.20.1-1.0.7.b-fabric" = _qiJtJhXB;
        "pkg-mc1.20.1-1.0.7.b-forge" = _mlWIiq24;
        "pkg-mc1.20.1-1.1.0-fabric" = _x7T9gLYw;
        "pkg-mc1.20.1-1.1.0-forge" = _QMpCACei;
        "pkg-mc1.20.1-1.1.1-fabric" = _Oagn5OCd;
        "pkg-mc1.20.1-1.1.1-forge" = _8TmUiZKt;
        "pkg-mc1.20.1-1.1.2-fabric" = _2aQFgkNg;
        "pkg-mc1.20.1-1.1.2-forge" = _luAINcT3;
        "pkg-mc1.20.1-1.1.3-fabric" = _JKtAxhSC;
        "pkg-mc1.20.1-1.1.3-forge" = _1ZDSnSDI;
        "pkg-mc1.20.1-1.1.4-fabric" = _XwLLWqPG;
        "pkg-mc1.20.1-1.1.4-forge" = _gTGQcJWq;
        "pkg-mc1.20.1-1.1.5-fabric" = _btTi8oMU;
        "pkg-mc1.20.1-1.1.5-forge" = _FrJsjRb0;
        "pkg-mc1.20.1-1.1.6-fabric" = _hfAxkEIm;
        "pkg-mc1.20.1-1.1.6-forge" = _Gvuvt632;
        "pkg-mc1.20.1-1.1.7-fabric" = _8dzm7BPJ;
        "pkg-mc1.20.1-1.1.7-forge" = _S3zuPzb9;
        "pkg-mc1.20.1-1.1.8-fabric" = _3DIAAp6Y;
        "pkg-mc1.20.1-1.1.8-forge" = _Irivwcqa;
        "pkg-mc1.20.1-1.1.9-fabric" = _pnhRR1LC;
        "pkg-mc1.20.1-1.1.9-forge" = _ITpPubro;
        "pkg-mc1.20.1-1.1.10-fabric" = _2ajRjZp9;
        "pkg-mc1.20.1-1.1.10-forge" = _92OTZeL4;
        "pkg-mc1.20.1-1.1.11-fabric" = _9oSmTWxZ;
        "pkg-mc1.20.1-1.1.11-forge" = _RbMGrvqW;
        "pkg-mc1.20.1-1.1.12-fabric" = _qFNZzBEr;
        "pkg-mc1.20.1-1.1.12-forge" = _8LXUuNHx;
        "pkg-mc1.21.1-2.0.0-neoforge" = _jYKO4Vfq;
        "pkg-mc1.21.1-2.0.1-neoforge" = _oKLpJutJ;
        "pkg-mc1.21.1-2.0.2-neoforge" = _pGDifwFQ;
        "pkg-mc1.21.1-2.0.3-neoforge" = _c3EgGWo9;
        "pkg-mc1.21.1-2.0.3.a-neoforge" = _ya8E3LFU;
        "pkg-mc1.20.1-1.1.13-fabric" = _fEPDPC6Y;
        "pkg-mc1.20.1-1.1.13-forge" = _FRlfqynW;
        "pkg-mc1.21.1-2.0.3.b-neoforge" = _ZzghRyK8;
        "pkg-mc1.20.1-1.1.14-fabric" = _KvxsCC6u;
        "pkg-mc1.20.1-1.1.14-forge" = _sqJo8vbj;
        "pkg-mc1.21.1-2.0.4-neoforge" = _PeUeYnIt;
        "pkg-mc1.21.1-2.0.5-neoforge" = _k4XRgkjf;
        "pkg-mc1.21.1-2.0.6-neoforge" = _qeLoEZGR;
        "pkg-mc1.21.1-2.1.0-neoforge" = _JJKGl6vr;
        "pkg-mc1.20.1-1.1.15-fabric" = _QWaPaSqh;
        "pkg-mc1.20.1-1.1.15-forge" = _GIqc8EYR;
        "pkg-mc1.21.1-2.1.1-neoforge" = _eDsf5orF;
        "pkg-mc1.20.1-1.1.16-fabric" = _nac0xgnI;
        "pkg-mc1.20.1-1.1.16-forge" = _hwdKdBjC;
        "pkg-mc1.21.1-2.1.2-neoforge" = _GRTOFUab;
        "pkg-mc1.21.1-2.1.3-neoforge" = _WyLNt5NI;
        "pkg-mc1.21.1-2.1.3.a-neoforge" = _W4SK6TF6;
        "pkg-mc1.20.1-1.1.17-fabric" = _Fh02Gr1l;
        "pkg-mc1.20.1-1.1.17-forge" = _a7chTVuf;
        "pkg-mc1.21.1-2.1.4-neoforge" = _BfedmtpL;
        "pkg-mc1.21.1-2.1.5-neoforge" = _IFprsmvR;
        "pkg-mc1.21.1-2.2.0-neoforge" = _VbcODCcs;
        "pkg-mc1.21.1-2.2.1-neoforge" = _BNrxtjkV;
        "pkg-mc1.21.1-2.2.2-neoforge" = _VCgl0IQF;
        "pkg-mc26.1.x-26.1.2.0-neoforge" = _Xl8OqIeD;
        "pkg-mc1.21.1-2.2.3-neoforge" = _xBpjGNkJ;
        "pkg-mc1.21.1-2.2.4-neoforge" = _I6VMwI6x;
        "pkg-mc26.1.x-26.1.2.1-neoforge" = _XflihBxE;
