...
let
    ...
    in {
        ...
        "pkg-2.0.4.2" = _ADC1jV9Z;
        "pkg-2.0.4.1" = _IjQfajnS;
        "pkg-2.0.4" = _pt4llt8J;
        "pkg-2.0.4.0" = _qioQdLVM;
        "pkg-3.0.2" = _2lqsofLr;
        "pkg-3.0.3" = _WcCSHpZx;
        "pkg-3.0.3a" = _SukXVjPx;
        "pkg-3.0.3b" = _pj0sE4fF;
        "pkg-3.0.4" = _jL0k9JPh;
        "pkg-3.0.5" = _UQdUCk69;
        "pkg-3.1.0" = _iEwELpQ7;
        "pkg-3.1.01" = _YKhZ1Nx6;
        "pkg-3.1.02" = _Y4B8dJL1;
        "pkg-4.0.0" = _Q2iW7kJw;
        "pkg-4.0.01" = _5ouBXjgf;
        "pkg-4.0.02" = _ml4OgcW1;
        "pkg-4.1.0" = _p2KSTyc0;
        "pkg-4.2.0" = _9yMXuYo3;
        "pkg-4.0.03" = _HQwNDY5e;
        "pkg-4.0.04" = _OOm8mZ9o;
        "pkg-4.3.0" = _RCXRjrj5;
        "pkg-4.3.01" = _18ltmwZC;
        "pkg-4.0.05" = _P1ihBxIm;
