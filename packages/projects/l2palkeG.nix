...
let
    versions = (let
        ...
        _AMtghtuG = {
            "id" = "AMtghtuG";
            "file" = "Solstice-v2.zip";
            "hash" = "sha512-HrqKZmLjlCbjQoh/MbAlNCekyk4hQ8F2FWw+xw4bxXxfbmQ+7TK5oc4OE4P9iXb2aIb+nsXVWQJ5lOVPVC6s/w==";
        };
    in {
        "ApJvZIDw" = _ApJvZIDw;
        "8MgAlPLk" = _8MgAlPLk;
        ...
        "AMtghtuG" = _AMtghtuG;
        "iris-1.21" = _AMtghtuG;
        "iris-1.21.1" = _AMtghtuG;
        "iris-1.21.2" = _AMtghtuG;
        "iris-1.21.3" = _AMtghtuG;
        "iris-1.21.4" = _AMtghtuG;
        "iris-1.21.5" = _AMtghtuG;
        "iris-1.21.6" = _AMtghtuG;
        "iris-1.21.7" = _AMtghtuG;
        "iris-1.21.8" = _AMtghtuG;
        "iris-1.21.9" = _AMtghtuG;
        "iris-1.21.10" = _AMtghtuG;
        "iris-1.21.11" = _AMtghtuG;
        "iris-26.1" = _AMtghtuG;
        "iris-26.1.1" = _AMtghtuG;
        "iris-26.1.2" = _AMtghtuG;
        "iris-26.2" = _AMtghtuG;
        "iris-1.20" = _ltbdsf7H;
        ...
        "optifine-1.21" = _AMtghtuG;
        "optifine-1.21.1" = _AMtghtuG;
        "optifine-1.21.2" = _AMtghtuG;
        "optifine-1.21.3" = _AMtghtuG;
        "optifine-1.21.4" = _AMtghtuG;
        "optifine-1.21.5" = _AMtghtuG;
        "optifine-1.21.6" = _AMtghtuG;
        "optifine-1.21.7" = _AMtghtuG;
        "optifine-1.21.8" = _AMtghtuG;
        "optifine-1.21.9" = _AMtghtuG;
        "optifine-1.21.10" = _AMtghtuG;
        "optifine-1.21.11" = _AMtghtuG;
        "optifine-26.1" = _AMtghtuG;
        "optifine-26.1.1" = _AMtghtuG;
        "optifine-26.1.2" = _AMtghtuG;
        "optifine-26.2" = _AMtghtuG;
