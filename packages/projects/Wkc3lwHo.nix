...
let
    versions = (let
        ...
        _lczU4EJv = {
            "id" = "lczU4EJv";
            "file" = "more_rpg_classes-1.2.20-1.20.1.jar";
            "hash" = "sha512-NZafDKEyPJnDaZzgo+S1s8btG7e1pBFfIzCpWZ3E8521pu1BmMMZDAIwsycyfhfnh0fH3dqWYZsHwqeuzG/PAA==";
        };
        _7f6CEki5 = {
            "id" = "7f6CEki5";
            "file" = "more_rpg_library-neoforge-2.6.3+1.21.1.jar";
            "hash" = "sha512-EdCcrzQ5o4Px/nxFn/aP8YRniw57+VWyMdu2mdeh9a6q7qDfugxYUZd7pmezSPempv0p7rFKiXrNiDgV/xIqlw==";
        };
        _dTwcarMi = {
            "id" = "dTwcarMi";
            "file" = "more_rpg_library-fabric-2.6.3+1.21.1.jar";
            "hash" = "sha512-IsLvbpM201qCfQgJ1r1/TkQQBW2b+xgBvn0seWypIr9f8FFzvx9bIXDepdokfK05k0iLXVM5McMxKkCEb6AixA==";
        };
        _EbwrUPdc = {
            "id" = "EbwrUPdc";
            "file" = "more_rpg_classes-1.2.21-1.20.1.jar";
            "hash" = "sha512-9TLq5brhCfxC15brUuaQGUrGTXIbcGERs6yokHV58XZmULryCb1sh+bMJvb6cZtr+4eh+R8mQYWPrDDaWSMIMw==";
        };
        _lmMRWC2t = {
            "id" = "lmMRWC2t";
            "file" = "more_rpg_classes-1.2.22-1.20.1.jar";
            "hash" = "sha512-o5utHkn6rjyuqCAvROUFZ2H1Lsu5LFqFs9Y0YQTZ897DMliE6OJz6K61ZdLeKwdsRL+gYpRXbu6Xrd6ZCnIXZg==";
        };
        _ImYvJali = {
            "id" = "ImYvJali";
            "file" = "more_rpg_library-fabric-2.6.4+1.21.1.jar";
            "hash" = "sha512-gU2snjdd4ew5hhd/UdH3jF7mPI0KDO2Qm0IGZq/dB6Sv/nb1pJOdKwuDEuWjZgQbYORKzGtedOA1mnwmlytfNg==";
        };
        _KeAtvQH6 = {
            "id" = "KeAtvQH6";
            "file" = "more_rpg_library-neoforge-2.6.4+1.21.1.jar";
            "hash" = "sha512-27BueliTP8amROvGrkabj9AxSYFZYar6qEFwE8dfGcTJm9NGoS/OH0nf7bQLzicwHzfSEF+zH55E5KKZwtOIFQ==";
        };
        _qGYnbzZh = {
            "id" = "qGYnbzZh";
            "file" = "more_rpg_library-fabric-2.6.5+1.21.1.jar";
            "hash" = "sha512-q8gaD/3VUyUDokm8DkXRuS5STa6c7Z3cylw+MwGjx4PeX4x+GQ/8d6g3S3OzYAlh67CiIGb/+qNTa7h9ciPmtQ==";
        };
        _AUZS9LcX = {
            "id" = "AUZS9LcX";
            "file" = "more_rpg_library-neoforge-2.6.5+1.21.1.jar";
            "hash" = "sha512-pEjK4pvWOGTwZhs3+a5wzKj/O8JelPy5LoJZhs4oxHBfSK7KgFInpStFOi2DX3dHFtPEMMm3l/zEyha0NgzAbw==";
        };
        _mtjDAONw = {
            "id" = "mtjDAONw";
            "file" = "more_rpg_library-fabric-2.7.0+1.21.1.jar";
            "hash" = "sha512-1Z2sd8HGTvz+X3fHHZWmKzpfd81WeM5GN3XcgbN996P8wQNrQmx1FMciR/DZK73doHDIhetTfwFCqH6XAlA9yw==";
        };
        _u3Hm3TQK = {
            "id" = "u3Hm3TQK";
            "file" = "more_rpg_library-neoforge-2.7.0+1.21.1.jar";
            "hash" = "sha512-K4XFFWJY/dMgKgW2pyt2wLcUv7O1/4b5g9EGZ6M+GzDUL3FWEjQqNOS3+mte3gsBIq5VymVMz8oMYJWB74iLzA==";
        };
        _gNz2m4hS = {
            "id" = "gNz2m4hS";
            "file" = "more_rpg_library-neoforge-2.7.1+1.21.1.jar";
            "hash" = "sha512-w7tLni2eZFcvG+gz4T0tPWI4SsL8Juj1pkSxAs0xsiiGV6oUcwxQEZ3fyPhLcP6vcUxbAyeBHTMKrzwEnrXV9g==";
        };
        _2b7Juuc5 = {
            "id" = "2b7Juuc5";
            "file" = "more_rpg_library-fabric-2.7.1+1.21.1.jar";
            "hash" = "sha512-Xxgl5T3BMcxtJAnS1UQzYg0gKdI9gE2zHilkk5OSw7mVXkThbToYe9Q3b/fWzwyf7U2q5vFVcvJkdj4KtvExUg==";
        };
        _MgvccMxK = {
            "id" = "MgvccMxK";
            "file" = "more_rpg_library-fabric-2.7.2+1.21.1.jar";
            "hash" = "sha512-VxtneEc3Wn9OxA2jBDgB/qhxlDo0xWSTMunRgYXt+jfCs+l9HlRbbPcfBUCo5RKPU4WEiuiu8Mpov8Puh4VPDw==";
        };
        _aYw4LYyV = {
            "id" = "aYw4LYyV";
    ...
    in {
        ...
        "pkg-1.0-1.20.1" = _AqHQrrRw;
        "pkg-1.1-1.20.1" = _1dJqDcT7;
        "pkg-1.1.1-1.20.1" = _NvRQn7Ei;
        "pkg-1.1.2-1.20.1" = _gsztr1Ww;
        "pkg-1.1.3-1.20.1" = _mswS6i4q;
        "pkg-1.1.4-1.20.1" = _rItZNLpZ;
        "pkg-1.1.5-1.20.1" = _dtPlMxvh;
        "pkg-1.1.6-1.20.1" = _kXgHiqof;
        "pkg-1.1.7-1.20.1" = _qPhOSav1;
        "pkg-1.1.8-1.20.1" = _2gr9jrW3;
        "pkg-1.1.9-1.20.1" = _oNXwpluw;
        "pkg-1.1.10-1.20.1" = _pNoHf5pE;
        "pkg-1.2.0-1.20.1" = _70nMSjKy;
        "pkg-2.0.0-1.21.1" = _sskUat7Q;
        "pkg-2.0.1-1.21.1" = _cCyPxpva;
        "pkg-2.0.2-1.21" = _wU1RpT55;
        "pkg-2.0.3-1.21.1" = _Lh3qX5vL;
        "pkg-2.0.4-1.21.1" = _GAwz98S0;
        "pkg-2.0.5-1.21.1" = _a35CwFpO;
        "pkg-1.2.1-1.20.1" = _rN4GQMI2;
        "pkg-1.2.2-1.20.1" = _X0maUYDB;
        "pkg-1.2.3-1.20.1" = _n9ofbqwu;
        "pkg-2.0.6-1.21.1" = _TaI8QoKV;
        "pkg-2.0.7-1.21.1" = _USJrHbmA;
        "pkg-2.0.8-1.21.1" = _YhB6D6il;
        "pkg-1.2.4-1.20.1" = _k0umddfD;
        "pkg-1.2.5-1.20.1" = _p0y0OYvo;
        "pkg-1.2.6-1.20.1" = _pLyrbjks;
        "pkg-2.0.9-1.21.1" = _4xkHE8cQ;
        "pkg-2.0.10-1.21.1" = _V3G0OCUl;
        "pkg-2.0.11-1.21.1" = _tmES4l0u;
        "pkg-2.0.12-1.21.1" = _d8odbaE9;
        "pkg-2.0.13-1.21.1" = _WUWndEDj;
        "pkg-2.0.14-1.21.1" = _ANT2YlnJ;
        "pkg-1.2.7-1.20.1" = _R4Em4MRf;
        "pkg-2.0.15-1.21.1" = _cI7kQt3O;
        "pkg-1.2.8-1.20.1" = _GbejX4yV;
        "pkg-1.2.9-1.20.1" = _TaokMqSL;
        "pkg-2.1.0-1.21.1" = _QJ7aZVQY;
        "pkg-2.1.1-1.21.1" = _D7SuBUdz;
        "pkg-2.2.0-1.21.1" = _dFSZmQwQ;
        "pkg-1.2.10-1.20.1" = _9dKN8Y7o;
        "pkg-1.2.11-1.20.1" = _UpcEB1h0;
        "pkg-1.2.12-1.20.1" = _rtOwdO0Y;
        "pkg-1.2.13-1.20.1" = _68lCKpa3;
        "pkg-2.2.1-1.21.1" = _Drlkr1IE;
        "pkg-2.2.2-1.21.1" = _67z2B8Am;
        "pkg-2.2.3-1.21.1" = _UrtcEr5w;
        "pkg-2.2.4-1.21.1" = _RrKJkoOl;
        "pkg-2.2.5-1.21.1" = _MkmUMWlI;
        "pkg-1.2.14-1.20.1" = _WZ6TqRuz;
        "pkg-1.2.15-1.20.1" = _O9V2z6zO;
        "pkg-2.2.6-1.21.1" = _2QxmJnhC;
        "pkg-1.2.16-1.20.1" = _CBJ3yxG7;
        "pkg-2.2.7-1.21.1" = _F5op8jE1;
        "pkg-2.2.8-1.21.1" = _Phq5es7G;
        "pkg-1.2.17-1.20.1" = _3H5gwfsN;
        "pkg-1.2.18-1.20.1" = _X9kJHcNI;
        "pkg-2.3.0-1.21.1" = _XTafCK0Z;
        "pkg-2.3.1-1.21.1" = _ht5Db3XK;
        "pkg-2.3.2-1.21.1" = _JTEDC09u;
        "pkg-2.3.3-1.21.1" = _8pRX8Rcw;
        "pkg-2.3.4-1.21.1" = _yUJxjfvW;
        "pkg-2.3.5-1.21.1" = _AKD18NMP;
        "pkg-2.4.0-1.21.1" = _zB0W9TZ2;
        "pkg-2.4.1-1.21.1" = _gVatE46r;
        "pkg-2.4.2-1.21.1" = _FMnO0Y2l;
        "pkg-2.4.3-1.21.1" = _tNReJq7d;
        "pkg-2.5.0+1.21.1-neoforge" = _UVByHbwU;
        "pkg-2.5.0+1.21.1-fabric" = _fYWcr92F;
        "pkg-2.5.1+1.21.1-fabric" = _ngywkynA;
        "pkg-2.5.1+1.21.1-neoforge" = _kDmmxaNX;
        "pkg-2.5.2+1.21.1-neoforge" = _u6rCifO4;
        "pkg-2.5.2+1.21.1-fabric" = _ZZLgqY2b;
        "pkg-2.5.3+1.21.1-neoforge" = _ccCs4lzJ;
        "pkg-2.5.3+1.21.1-fabric" = _B1cw2Q3v;
        "pkg-2.5.4+1.21.1-fabric" = _DuJcaUVW;
        "pkg-2.5.4+1.21.1-neoforge" = _3DgA8uHi;
        "pkg-2.5.5+1.21.1-neoforge" = _m4i2lQ0T;
        "pkg-2.5.5+1.21.1-fabric" = _dUG1p8od;
        "pkg-2.5.6+1.21.1-fabric" = _sAouilza;
        "pkg-2.5.6+1.21.1-neoforge" = _MWUr7naI;
        "pkg-2.5.7+1.21.1-neoforge" = _cSJm1RYg;
        "pkg-2.5.7+1.21.1-fabric" = _Izgj99Uf;
        "pkg-2.5.8+1.21.1-neoforge" = _WaOG8gWW;
        "pkg-2.5.8+1.21.1-fabric" = _ew5LFt93;
        "pkg-2.5.9+1.21.1-fabric" = _ifk2rGrr;
        "pkg-2.5.9+1.21.1-neoforge" = _QyvMWJZI;
        "pkg-2.5.10+1.21.1-fabric" = _ktEE6BEs;
        "pkg-2.5.10+1.21.1-neoforge" = _H55l2yYw;
        "pkg-2.5.11+1.21.1-neoforge" = _5VV5CPf3;
        "pkg-2.5.11+1.21.1-fabric" = _zPS6r9m0;
        "pkg-2.5.12+1.21.1-fabric" = _Hyl3aYZq;
        "pkg-2.5.12+1.21.1-neoforge" = _FkgQSBsO;
        "pkg-2.5.13+1.21.1-fabric" = _PuQPZOi6;
        "pkg-2.5.13+1.21.1-neoforge" = _16oeHdt0;
        "pkg-2.5.14+1.21.1-neoforge" = _w55Uxban;
        "pkg-2.5.14+1.21.1-fabric" = _4pkSjRSb;
        "pkg-2.5.15+1.21.1-neoforge" = _GLijTO4p;
        "pkg-2.5.15+1.21.1-fabric" = _QUnz9qhi;
        "pkg-2.5.16+1.21.1-fabric" = _7UvEBgY3;
        "pkg-2.5.16+1.21.1-neoforge" = _UZChQdLz;
        "pkg-2.5.17+1.21.1-neoforge" = _QneksfGf;
        "pkg-2.5.17+1.21.1-fabric" = _K5OjjW5F;
        "pkg-2.5.18+1.21.1-neoforge" = _gCGEyyGC;
        "pkg-2.5.18+1.21.1-fabric" = _iWKnAW4F;
        "pkg-2.5.19+1.21.1-neoforge" = _7mjgQApX;
        "pkg-2.5.19+1.21.1-fabric" = _Omd3YTBU;
        "pkg-2.5.20+1.21.1-neoforge" = _7t5zoNBU;
        "pkg-2.5.20+1.21.1-fabric" = _ARRitNpP;
        "pkg-2.5.21+1.21.1-fabric" = _4jeSjKRW;
        "pkg-2.5.21+1.21.1-neoforge" = _ZnOxP4n7;
        "pkg-2.5.22+1.21.1-neoforge" = _KoqF4MwN;
        "pkg-2.5.22+1.21.1-fabric" = _s2OLnyJW;
        "pkg-2.5.23+1.21.1-neoforge" = _eBxP7HUJ;
        "pkg-2.5.23+1.21.1-fabric" = _MUpFiglJ;
        "pkg-2.5.24+1.21.1-fabric" = _eknmOB4N;
        "pkg-2.5.24+1.21.1-neoforge" = _idVXRBCu;
        "pkg-2.5.25+1.21.1-fabric" = _6v4Sy7jh;
        "pkg-2.5.25+1.21.1-neoforge" = _HaC19HsJ;
        "pkg-2.5.26+1.21.1-fabric" = _ywOdQ3cH;
        "pkg-2.5.26+1.21.1-neoforge" = _SwiqCc8z;
        "pkg-2.5.27+1.21.1-fabric" = _kd2cglCR;
        "pkg-2.5.27+1.21.1-neoforge" = _6rHq4Exa;
        "pkg-2.5.28+1.21.1-fabric" = _eY66clh3;
        "pkg-2.5.28+1.21.1-neoforge" = _6VGSSZ42;
        "pkg-2.5.29+1.21.1-neoforge" = _xQUUhWwH;
        "pkg-2.5.29+1.21.1-fabric" = _TD2Y8AiY;
        "pkg-1.2.19-1.20.1" = _ey2fHRu5;
        "pkg-2.5.30+1.21.1-fabric" = _uLm4Zdqt;
        "pkg-2.5.30+1.21.1-neoforge" = _q5ner7CA;
        "pkg-2.6.0+1.21.1-fabric" = _AQcN8WA5;
        "pkg-2.6.0+1.21.1-neoforge" = _8EAanGb4;
        "pkg-2.6.2+1.21.1-fabric" = _8mrNDEwN;
        "pkg-2.6.2+1.21.1-neoforge" = _JDMLNqC9;
        "pkg-1.2.20-1.20.1" = _lczU4EJv;
        "pkg-2.6.3+1.21.1-neoforge" = _7f6CEki5;
        "pkg-2.6.3+1.21.1-fabric" = _dTwcarMi;
        "pkg-1.2.21-1.20.1" = _EbwrUPdc;
        "pkg-1.2.22-1.20.1" = _lmMRWC2t;
        "pkg-2.6.4+1.21.1-fabric" = _ImYvJali;
        "pkg-2.6.4+1.21.1-neoforge" = _KeAtvQH6;
        "pkg-2.6.5+1.21.1-fabric" = _qGYnbzZh;
        "pkg-2.6.5+1.21.1-neoforge" = _AUZS9LcX;
        "pkg-2.7.0+1.21.1-fabric" = _mtjDAONw;
        "pkg-2.7.0+1.21.1-neoforge" = _u3Hm3TQK;
        "pkg-2.7.1+1.21.1-neoforge" = _gNz2m4hS;
