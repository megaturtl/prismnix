...
let
    ...
    in {
        ...
        "pkg-0.7+1.20.1" = _NlS1t85w;
        "pkg-0.7+1.19.2" = _irGsbkKK;
        "pkg-0.7+1.18.2" = _d9nv4Izr;
        "pkg-0.7+infinite" = _S4g67DjT;
        "pkg-0.8-infinite" = _uYtN2hur;
        "pkg-0.8+1.19.2" = _2AspCyM2;
        "pkg-0.8+1.20.1" = _CLWC6D1D;
        "pkg-0.8+1.20.5" = _bbsJUxZs;
        "pkg-0.9+1.20.1" = _Sdh4YlKZ;
        "pkg-0.9+1.20.5" = _PYDILhfQ;
        "pkg-0.9+1.19.2" = _hq66RqCM;
        "pkg-0.10-1.20.1" = _nKtO0gaL;
        "pkg-0.10+1.20.6" = _KT98B2kD;
        "pkg-0.11-1.20.1" = _dCfOK0ZA;
        "pkg-0.11+1.20.6" = _3tdw5cQn;
        "pkg-0.12+1.20.1" = _v1WDy7fw;
        "pkg-0.12+1.20.6" = _YTdr6h7S;
        "pkg-0.12-1.20.6" = _UIBZm5jd;
        "pkg-0.13+1.19.2" = _sS4DS55s;
        "pkg-0.13+1.20.1" = _8AodhuUK;
        "pkg-0.13-1.20.6" = _L7iKJvNq;
        "pkg-0.14+1.19.2" = _PbWWF1tT;
        "pkg-0.14+1.20.1" = _tKVMG9fY;
        "pkg-0.14+1.20.6" = _CJHpPycC;
        "pkg-0.14.1+1.19.2" = _RWC6B9jv;
        "pkg-0.14.1+1.20.1" = _4exq3Ka6;
        "pkg-0.14.1+1.20.6" = _4Hun0P0l;
        "pkg-0.14.1+1.21" = _qGeZPHRy;
        "pkg-0.14.1+24w33a" = _E2n4f32q;
        "pkg-0.14.1+24w34a" = _SXHUrVMV;
        "pkg-0.14.2+1.19.2" = _cAfTgscS;
        "pkg-0.14.2+1.20.1" = _ghlmtnGv;
        "pkg-0.14.2+1.20.6" = _BKRamM5m;
        "pkg-0.14.2+1.21.1" = _nQmcyh25;
        "pkg-0.14.2+24w34a" = _AVBzlJJH;
        "pkg-0.14.2+24w35a" = _9TITkAzn;
        "pkg-0.14.3+1.21.1" = _rSEzeqqB;
        "pkg-0.14.3+24w36a" = _sCjEwOYC;
        "pkg-0.14.4+1.19.2" = _NMlS0z5q;
        "pkg-0.14.4+1.20.1" = _ohATyVcj;
        "pkg-0.14.4+1.21.1" = _Xkk7M04r;
        "pkg-0.14.5+24w38a" = _Xz6XWRoN;
        "pkg-0.14.5+1.19.2" = _roLnst3M;
        "pkg-0.14.5+1.20.1" = _8NvDzhhq;
        "pkg-0.14.5+24w40a" = _wHlMdxX7;
        "pkg-0.14.6+1.20.1" = _MbrHm3Yd;
        "pkg-0.14.6+1.19.2" = _GIfHqe5H;
        "pkg-0.15.0+1.21.1" = _vfPYn1uE;
        "pkg-0.15.0+1.21.3" = _QYMhyjiL;
        "pkg-0.15.1+1.20.1" = _z1Tl4wuM;
        "pkg-0.15.2+1.20.1" = _8E50N83Q;
        "pkg-0.15.2+1.21.1" = _XTner4tt;
        "pkg-0.15.2+1.21.3" = _L61UAQry;
        "pkg-0.15.3+1.20.1" = _4bPHpl0O;
        "pkg-0.15.3+1.21.1" = _KeVHWno1;
        "pkg-0.15.3+1.21.3" = _W5lLHuD9;
        "pkg-0.15.3+1.21.4-rc3" = _KmtLkNzZ;
        "pkg-0.15.3+1.21.4" = _9SqW6AJd;
        "pkg-0.15.4+1.20.1" = _KIEyI3kq;
        "pkg-0.15.4+1.21.1" = _1LHoyvaL;
        "pkg-0.15.4+1.21.3" = _OUJD9qRk;
        "pkg-0.15.4+1.21.4" = _7oEzT00Y;
        "pkg-0.15.5+1.20.1" = _WdGppHp2;
        "pkg-0.15.6+1.21.1" = _o70a2GuG;
        "pkg-0.15.6+1.21.3" = _24E0MZYn;
        "pkg-0.15.6+1.21.4" = _hsKh24j8;
        "pkg-0.15.7+1.21.1" = _Uxac4WHe;
        "pkg-0.15.7+1.21.3" = _Hs4Kx3hb;
        "pkg-0.15.7+1.21.4" = _yLaiyp3U;
        "pkg-0.15.8+1.21.1" = _bhAEdtKE;
        "pkg-0.15.8+1.21.3" = _yyrGi3kW;
        "pkg-0.15.8+1.21.4" = _mfg9lvXa;
        "pkg-0.15.9+1.21.1" = _LEwsBHcY;
        "pkg-0.15.9+1.21.3" = _lNCLoiwu;
        "pkg-0.15.9+1.21.4" = _qBLjXEmH;
        "pkg-0.15.9+1.20.1" = _k2cELs2X;
        "pkg-0.15.10+1.20.1" = _gSLFaoDx;
        "pkg-0.16.0+1.21.1" = _dUj3xDol;
        "pkg-0.16.0+1.21.4" = _IVIVSW4x;
        "pkg-0.16.0+1.21.6-pre3" = _NdeUJ6yq;
        "pkg-0.16.1+1.21.8" = _x7jxWGXu;
        "pkg-0.16.1+1.21.9-rc1" = _szTzdud9;
        "pkg-0.16.1+1.21.9" = _rOZv7bYR;
        "pkg-0.17.0+1.21.1-fabric" = _W9BoWZtK;
        "pkg-0.17.0+1.21.11-fabric" = _Y4Xq9yDo;
        "pkg-0.17.0+1.21.11-neoforge" = _jvrVsGRH;
        "pkg-0.17.0+26.1-fabric" = _hrAglbpg;
        "pkg-0.17.0+26.1-pre-3-neoforge" = _OGEyEP5d;
        "pkg-0.17.1+26.1.1-neoforge" = _NTBXs2jG;
        "pkg-0.17.2+26.1.2-fabric" = _PyyW4XdX;
        "pkg-0.17.2+26.1.2-neoforge" = _JpbrO79g;
        "pkg-0.17.2+1.21.1-fabric" = _LdyYXqBB;
        "pkg-0.18.0+1.21.1-fabric" = _rzsCtwxM;
        "pkg-0.18.0+1.21.1-neoforge" = _WKs3evdT;
        "pkg-0.18.0+26.1.2-fabric" = _ufH5b6pS;
        "pkg-0.18.0+26.1.2-neoforge" = _EFDu7yAl;
        "pkg-0.18.0+26.2-fabric" = _aW4hvp63;
        "pkg-0.18.0+26.2-neoforge" = _unfsXQoG;
        "pkg-0.18.1+26.1.2-fabric" = _b6DjzjKJ;
        "pkg-0.18.1+26.1.2-neoforge" = _pFiQzGzm;
        "pkg-0.18.1+26.2-fabric" = _MxcS7k0h;
        "pkg-0.18.1+26.2-neoforge" = _YaTVTSg6;
        "pkg-0.18.2+26.1.2-fabric" = _Kx1fyfPC;
        "pkg-0.18.2+26.1.2-neoforge" = _U63agomd;
        "pkg-0.18.2+26.2-fabric" = _I7SNpqMF;
        "pkg-0.18.2+26.2-neoforge" = _kYMpS1xt;
        "pkg-0.18.3+26.1.2-fabric" = _OjenJjgO;
