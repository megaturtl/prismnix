...
let
    ...
    in {
        ...
        "pkg-1.18.2-forge-1.0.1" = _oeVDYOIl;
        "pkg-1.19.4-fabric-1.0.1" = _jOT5oC21;
        "pkg-1.19.4-forge-1.0.1" = _aw6U5QYx;
        "pkg-1.20.1-fabric-1.0.1" = _6alvrP01;
        "pkg-1.20.1-forge-1.0.1" = _xOC1PUwX;
        "pkg-1.20.2-fabric-1.0.1" = _ju5TPUur;
        "pkg-1.0.1" = _TP7reuzi;
        "pkg-1.19.4-fabric-1.1" = _UIwn5Xi8;
        "pkg-1.19.4-forge-1.1" = _krZ9dcvB;
        "pkg-1.20.1-fabric-1.1" = _HzcmiUVm;
        "pkg-1.20.1-forge-1.1" = _BOs04aPq;
        "pkg-1.20.2-fabric-1.1" = _kdtrv2Ri;
        "pkg-1.20.2-forge-1.1" = _cKCk9lod;
        "pkg-1.18.2-forge-1.1" = _P4YoKEZU;
        "pkg-1.18.2-fabric-1.1" = _38pcWK3W;
        "pkg-1.20.2-neoforge-1.1" = _DJ5umiYT;
        "pkg-2.0+fabric" = _yiJyi8rl;
        "pkg-2.0+forge" = _C3nWG3BF;
        "pkg-2.0+neoforge" = _GaIei3xH;
        "pkg-3.0+fabric" = _r2qLzMLh;
        "pkg-3.0+forge" = _tXMwed22;
        "pkg-3.0+neoforge" = _caqNguh5;
        "pkg-3.1+fabric" = _PbtExru6;
        "pkg-3.1+forge" = _AfukPXa3;
        "pkg-3.1+neoforge" = _iwUa2vVP;
        "pkg-3.2+fabric" = _DzH2zVN9;
        "pkg-3.2+forge" = _LfKnP6db;
        "pkg-3.2+neoforge" = _20WSX7xd;
        "pkg-1.20.2-fabric-3.3" = _FeF5YWzk;
        "pkg-1.20.2-forge-3.3" = _MlMoI6s0;
        "pkg-1.20.2-neoforge-3.3" = _McBhKnZD;
        "pkg-1.20.1-fabric-3.3" = _7vciZ1cR;
        "pkg-1.20.1-forge-3.3" = _uMEjDUAM;
        "pkg-1.19.4-fabric-3.3" = _pm1LUwzM;
        "pkg-1.19.4-forge-3.3" = _2UtyjGIT;
        "pkg-1.18.2-fabric-3.3" = _75xlemBg;
        "pkg-1.18.2-forge-3.3" = _Pp5Qa6Xg;
        "pkg-1.20.2-fabric-3.4" = _TwcRmKVy;
        "pkg-1.20.2-forge-3.4" = _ZQ9Et2jI;
        "pkg-1.20.2-neoforge-3.4" = _8D5JC9PW;
        "pkg-1.19.4-fabric-3.4" = _weVKH4eb;
        "pkg-1.19.4-forge-3.4" = _Z1TL3f4x;
        "pkg-1.20.1-fabric-3.4" = _LRRYVPv4;
        "pkg-1.20.1-forge-3.4" = _MvAWRBIp;
        "pkg-1.18.2-fabric-3.4" = _OcWQgtBQ;
        "pkg-1.18.2-forge-3.4" = _xJOpySrF;
        "pkg-1.20.2-fabric-3.5" = _9LH1c5VM;
        "pkg-1.20.2-forge-3.5" = _fdePjtUg;
        "pkg-1.20.2-neoforge-3.5" = _h4JYVIGr;
        "pkg-1.20.1-fabric-3.5" = _cDcHpvCY;
        "pkg-1.20.1-forge-3.5" = _Tqg7md0V;
        "pkg-1.18.2-fabric-3.5" = _Em3p38Am;
        "pkg-1.19.4-fabric-3.5" = _8o43Hu6z;
        "pkg-1.18.2-forge-3.5" = _OJekebkm;
        "pkg-1.19.4-forge-3.5" = _jNIzItmt;
        "pkg-1.20.2-fabric-3.6" = _IiX6Loxf;
        "pkg-1.20.2-forge-3.6" = _ULNOacYB;
        "pkg-1.20.2-neoforge-3.6" = _MK1QJadk;
        "pkg-1.20.1-fabric-3.6" = _IQJ2nkHG;
        "pkg-1.20.1-forge-3.6" = _zwtSYpDn;
        "pkg-1.19.4-fabric-3.6" = _2fowIN7i;
        "pkg-1.19.4-forge-3.6" = _RUtr4Fq1;
        "pkg-1.18.2-fabric-3.6" = _jib5bF0o;
        "pkg-1.18.2-forge-3.6" = _hyTrBm5d;
        "pkg-1.20.2-fabric-3.6.1" = _kHishnVP;
        "pkg-1.20.2-forge-3.6.1" = _i2Dief6m;
        "pkg-1.20.2-neoforge-3.6.1" = _2v7OM0TU;
        "pkg-1.20.1-fabric-3.6.1" = _Q6tjMFG8;
        "pkg-1.20.1-forge-3.6.1" = _yRPd7NzB;
        "pkg-1.19.4-fabric-3.6.1" = _puyphLpm;
        "pkg-1.19.4-forge-3.6.1" = _xGZDY3I7;
        "pkg-1.18.2-fabric-3.6.1" = _kvzWkTPP;
        "pkg-1.18.2-forge-3.6.1" = _AyXJR1mA;
        "pkg-1.19.4-fabric-3.6.2" = _1XudG6H3;
        "pkg-1.19.4-forge-3.6.2" = _BoFqzOjQ;
        "pkg-1.20.6-fabric-3.6.2" = _sVh21cT6;
        "pkg-1.20.6-neoforge-3.6.2" = _WJVU7ois;
        "pkg-1.18.2-fabric-3.6.2" = _hHpxCj4U;
        "pkg-1.18.2-forge-3.6.2" = _JTuPmBrv;
        "pkg-1.20.2-fabric-3.6.2" = _vhoZgmNf;
        "pkg-1.20.2-forge-3.6.2" = _7wpV1A2l;
        "pkg-1.20.2-neoforge-3.6.2" = _zYIyr1Yq;
        "pkg-1.20.1-fabric-3.6.2" = _4V5I7MNp;
        "pkg-1.20.1-forge-3.6.2" = _959PGFe3;
        "pkg-1.20.6-fabric-3.6.3" = _Cph1eO9e;
        "pkg-1.20.6-neoforge-3.6.3" = _i6sQE8P8;
        "pkg-1.20.2-fabric-3.6.3" = _1K8MpJdo;
        "pkg-1.20.2-forge-3.6.3" = _3UONqeEd;
        "pkg-1.20.2-neoforge-3.6.3" = _tbkTrFxq;
        "pkg-1.20.1-fabric-3.6.3" = _KBXCvzog;
        "pkg-1.20.1-forge-3.6.3" = _5p8si3cT;
        "pkg-1.19.4-fabric-3.6.3" = _WsrzT4Tt;
        "pkg-1.19.4-forge-3.6.3" = _X1t9CLq1;
        "pkg-1.18.2-fabric-3.6.3" = _88N5rzE7;
        "pkg-1.18.2-forge-3.6.3" = _fdo3wvAn;
        "pkg-1.18.2-fabric-4.0" = _2tmE21uc;
        "pkg-1.18.2-forge-4.0" = _woMGsUFG;
        "pkg-1.19.4-fabric-4.0" = _sZrxbUXk;
        "pkg-1.19.4-forge-4.0" = _KMmjgzqO;
        "pkg-1.20.1-fabric-4.0" = _XQ2yYSJv;
        "pkg-1.20.1-forge-4.0" = _PU58r2f2;
        "pkg-1.20.2-fabric-4.0" = _6WVgorXA;
        "pkg-1.20.2-forge-4.0" = _nmEsSkFz;
        "pkg-1.20.2-neoforge-4.0" = _oq3MYXtI;
        "pkg-1.20.4-fabric-4.0" = _X2CCvUTf;
        "pkg-1.20.4-forge-4.0" = _KjWbWdtG;
        "pkg-1.20.4-neoforge-4.0" = _XHnMexW2;
        "pkg-1.20.6-fabric-4.0" = _JGHKLLIA;
        "pkg-1.20.6-neoforge-4.0" = _hrqXC1Ek;
        "pkg-1.21-fabric-4.0" = _UIbawloU;
        "pkg-1.21-neoforge-4.0" = _dRoP9txC;
        "pkg-1.18.2-fabric-4.1" = _QCdzWmhI;
        "pkg-1.18.2-forge-4.1" = _8SOC6dnk;
        "pkg-1.19.4-fabric-4.1" = _xdArTODb;
        "pkg-1.19.4-forge-4.1" = _hKqeP9Zg;
        "pkg-1.20.1-fabric-4.1" = _u109qhZU;
        "pkg-1.20.1-forge-4.1" = _eGJcxWl3;
        "pkg-1.20.2-fabric-4.1" = _kiVuaQd1;
        "pkg-1.20.2-forge-4.1" = _fFJ1XL57;
        "pkg-1.20.2-neoforge-4.1" = _MBmSKfwZ;
        "pkg-1.20.4-fabric-4.1" = _9jYra4eM;
        "pkg-1.20.4-forge-4.1" = _DFLRRHeF;
        "pkg-1.20.4-neoforge-4.1" = _Ii9GsWv4;
        "pkg-1.20.6-fabric-4.1" = _FFolZVpp;
        "pkg-1.20.6-neoforge-4.1" = _Le6YsDzJ;
        "pkg-1.21-fabric-4.1" = _PfICvwSg;
        "pkg-1.21-neoforge-4.1" = _urdBSy9b;
        "pkg-1.18.2-fabric-4.2" = _TJHb3rrm;
        "pkg-1.18.2-forge-4.2" = _26j6V71G;
        "pkg-1.19.4-fabric-4.2" = _fEaClXwu;
        "pkg-1.19.4-forge-4.2" = _ZgAhBQ0O;
        "pkg-1.20.1-fabric-4.2" = _HhkqhWqV;
        "pkg-1.20.1-forge-4.2" = _P9UUDAQ4;
        "pkg-1.20.2-fabric-4.2" = _x6PTV46Z;
        "pkg-1.20.2-forge-4.2" = _zvKnGxj1;
        "pkg-1.20.2-neoforge-4.2" = _BqDmeefW;
        "pkg-1.20.4-fabric-4.2" = _d8JA3Dus;
        "pkg-1.20.4-forge-4.2" = _uJcjA3XW;
        "pkg-1.20.4-neoforge-4.2" = _SeGlciec;
        "pkg-1.20.6-fabric-4.2" = _tkt17M8G;
        "pkg-1.20.6-neoforge-4.2" = _VuGap4Qh;
        "pkg-1.21-neoforge-4.2" = _JcEPAMP3;
        "pkg-1.21-fabric-4.2" = _XDK1R9x8;
        "pkg-1.21.2-fabric-5.0" = _J2cXN850;
        "pkg-1.21.2-neoforge-5.0" = _bcqtZwYS;
        "pkg-1.21.2-fabric-6.0" = _6BnzVIDZ;
        "pkg-1.21.2-neoforge-6.0" = _z0LQKude;
        "pkg-1.21.4-fabric-6.0" = _IxDTyE7P;
        "pkg-1.21.4-neoforge-6.0" = _OoBDcVy9;
        "pkg-1.21.2-fabric-6.1" = _BjtBMtJY;
        "pkg-1.21.2-neoforge-6.1" = _PWU6tt32;
        "pkg-1.21.4-neoforge-6.1" = _MmZweyon;
        "pkg-1.21.4-fabric-6.1" = _zkfU9VmD;
        "pkg-1.21.5-neoforge-6.2" = _yyKi4bVA;
        "pkg-1.21.5-fabric-6.2" = _4bgeRAmC;
        "pkg-fabric-6.2" = _DGJxmCoP;
        "pkg-neoforge-6.2" = _CrMjlQNM;
        "pkg-fabric-7.1.0" = _x6GDq7gi;
        "pkg-neoforge-7.1.0" = _WLWZUFmA;
        "pkg-fabric-7.1.1" = _lSLuvEWD;
