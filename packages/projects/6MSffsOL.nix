...
let
    versions = (let
        ...
        _w1s7y97R = {
            "id" = "w1s7y97R";
            "file" = "moonlightcore-neoforge-26.1.2.1-beta.jar";
            "hash" = "sha512-SPeoMX4Fo+wbZewhKae9PPJrtLZFsMom4eo+ORoCvM4eUYhS/2ZV/pOjPPUFda5eaUxae4RzRoeT3jX/1qztzw==";
        };
        _DH1UDsOU = {
            "id" = "DH1UDsOU";
            "file" = "moonlightcore-fabric-26.1.2.1-beta.jar";
            "hash" = "sha512-QOJtdlz+sDwpNkl8GYlSeR7K6non1vc/uiFnKxvGaWPdrc5pIBYhMWxb3PJgzBL9vhHCkettLncdgxhpGK2ONA==";
        };
        _Y8olLJgb = {
            "id" = "Y8olLJgb";
            "file" = "moonlightcore-fabric-26.1.2.2-beta.jar";
            "hash" = "sha512-6ZVNkAIUXcERXSSncqOZaJUQQxnCl10a2OfYVjmPX83U8PyZBfsnvMUcpsuYcghzwQD3YCBjoHw+xdG501FAcQ==";
        };
        _zj4Q5qh9 = {
            "id" = "zj4Q5qh9";
            "file" = "moonlightcore-neoforge-26.1.2.2-beta.jar";
            "hash" = "sha512-kplD1LUCsZIjducXtZ4HFKE4sVav6FC4Ofde5MUoFu79gfONBc4EHOh3WcIGmMNZR1MDGLRQcNLQYLkXwo4n5g==";
        };
        _lXHG3T8B = {
            "id" = "lXHG3T8B";
            "file" = "moonlightcore-neoforge-26.1.2.3-beta.jar";
            "hash" = "sha512-NWW9DYS7bdf+5o4C9SJoQlSelwXiUi/pQSz+6iQyDSwDivoMwjsMzznJM05A5s0HgVmvSWuFujiLvN6mxL/Wbw==";
        };
        _qToq9MIa = {
            "id" = "qToq9MIa";
    ...
    in {
        ...
        "pkg-1.21.1-2.1.9" = _7yvDSG2b;
        "pkg-1.21.1-2.2.12" = _GudZ48P2;
        "pkg-1.21.2-2.2.12" = _zscKE4mh;
        "pkg-1.21.1-2.2.13" = _CVjDHwRW;
        "pkg-1.21.1-2.2.18" = _zaMiHPWG;
        "pkg-3.0.0" = _CJ8c1OS5;
        "pkg-1.20.1-3.1.0-beta" = _ECcuhMXx;
        "pkg-1.20.1-3.1.1-beta" = _z9TVby32;
        "pkg-1.20.1-3.2.9-beta" = _WWrGifJh;
        "pkg-1.20.1-3.2.10" = _W4gsjcX9;
        "pkg-1.20.1-4.0.0" = _jjup6ZiF;
        "pkg-1.20.1-4.1.0" = _XOmFFtza;
        "pkg-1.20.1-4.1.1" = _9kn4Yyff;
        "pkg-1.20.1-4.1.2" = _tjjJszdL;
        "pkg-1.20.1-4.1.3" = _DkyCg82j;
        "pkg-1.20.1-4.1.4" = _t4biOZu5;
        "pkg-1.20.1-4.2.4" = _zqJ62Uip;
        "pkg-1.20.1-4.3.4" = _bE38Okjj;
        "pkg-1.20.1-4.3.5" = _KUndZIB8;
        "pkg-1.20.1-4.3.6" = _5U1baDhy;
        "pkg-1.20.1-4.3.7" = _BOvZvGek;
        "pkg-1.20.1-4.3.8" = _pRoXaFIU;
        "pkg-1.20.1-4.4.8" = _YDwz5sD0;
        "pkg-1.20.1-4.4.9" = _eyTwBHxL;
        "pkg-1.20.1-4.5.9" = _3PkeOVym;
        "pkg-1.20.1-5.0.0" = _V3vX6k04;
        "pkg-1.20.1-5.0.1" = _QZcVCI8s;
        "pkg-1.20.1-5.0.2" = _oWpK8i7F;
        "pkg-1.20.1-5.0.3.fabric" = _FT4fPOJP;
        "pkg-1.20.1-5.0.3.forge" = _O7hVnkQt;
        "pkg-5.0.5" = _jm5OHrHq;
        "pkg-5.0.6" = _pWK8FHp9;
        "pkg-5.0.7" = _nOLviHpk;
        "pkg-5.1.8" = _kE9scHkB;
        "pkg-5.1.9" = _4oRDpT9T;
        "pkg-5.2.10" = _UVAvCB6P;
        "pkg-5.2.11" = _3c395GwW;
        "pkg-5.2.12" = _uNpshtH1;
        "pkg-5.2.13" = _vFtxy6fp;
