...
let
    ...
    in {
        ...
        "pkg-1.20.1-2.1.0" = _SFg7yU9A;
        "pkg-1.20.1-2.1.1" = _YznbGnc8;
        "pkg-1.19.4-1.1.1" = _VYEi9zXZ;
        "pkg-1.21-3.0.0" = _Dh57DH4K;
        "pkg-1.21.3-3.1.0" = _U2BcgZI2;
        "pkg-1.21.3-3.1.1" = _qbFaUA3w;
        "pkg-1.21.3-3.1.2" = _9Ackt5w0;
        "pkg-21.11.0" = _c8OXNnVL;
        "pkg-1.21.3-3.1.3" = _ZZWBAwrX;
        "pkg-21.11.1" = _KL0tI46v;
        "pkg-1.21-3.0.1" = _l1Q5Iku3;
        "pkg-1.20.1-2.1.2" = _vyX81R3R;
        "pkg-1.21-3.0.2" = _bQjwh9c4;
        "pkg-1.21.3-3.1.4" = _9xpWxxRE;
        "pkg-21.11.2" = _ZWIKooIR;
        "pkg-1.20.1-2.1.3" = _QjKpbhAr;
        "pkg-1.21-3.0.3" = _9v7K5FZz;
        "pkg-1.21.3-3.1.5" = _CCe148yR;
