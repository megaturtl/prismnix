...
let
    ...
    in {
        ...
        "pkg-1.9.1" = _LdtrjDL5;
        "pkg-1.10" = _tifNCUFN;
        "pkg-1.13-1.21.1" = _Kt8owOWP;
        "pkg-1.13.1-1.21.1" = _EAEEXEF7;
        "pkg-1.13.2-1.21.5" = _fuAYWWr7;
        "pkg-1.13.3-1.21.5" = _ugOKAN0o;
        "pkg-1.13.3-1.21.6" = _NkAIcuHs;
        "pkg-1.13.3-1.21.7" = _wbOnhig6;
        "pkg-1.13.3-1.21.9" = _Dao0pY1c;
        "pkg-1.13.4-1.21.9" = _ig3cPveZ;
        "pkg-1.13.5-1.21.11" = _N0u8UMye;
        "pkg-1.13.6-1.21.11" = _8WjkBiFT;
        "pkg-1.13.6-26.1.1" = _AHp78HyS;
        "pkg-1.13.7-26.1.1" = _lBpvRZvv;
        "pkg-1.13.8-26.1.2" = _1d8uBwJH;
        "pkg-1.13.9-26.1.2" = _hR35jKdp;
