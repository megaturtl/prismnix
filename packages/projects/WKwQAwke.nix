...
let
    versions = (let
        ...
        _kCSwQJ9C = {
            "id" = "kCSwQJ9C";
            "file" = "libjf-3.17.7+forge.jar";
            "hash" = "sha512-plqgKVq616m4951aqPWRpMgHP/w6DtztG0i7jBzGdA8jPElkkBUiracVO/K1Yv8etf7p5gQZ45Nl5lgdQAntow==";
        };
        _OjH9Jj4a = {
            "id" = "OjH9Jj4a";
            "file" = "libjf-26.1.4+forge.jar";
            "hash" = "sha512-02j+QHwuhCAaeu8z3icBey9/yFAEiUroFsLSDMrfIssJCZnGB/9av7YHVvn63Npwa3jRRz/L83cyHo5FGEleUg==";
        };
        _X6T6G2ad = {
            "id" = "X6T6G2ad";
            "file" = "libjf-26.1.4.jar";
            "hash" = "sha512-a1RYzVANtiCvx8+H/3eL87RX+8MyfDYHuep3oZGdjzUFXj0YdcWYpNxCZeRNlQaCZmh24VOZtfYtZpeSB1tP2g==";
        };
        _I5brbhNh = {
            "id" = "I5brbhNh";
            "file" = "libjf-26.2.2.jar";
            "hash" = "sha512-g4henXPuVGKdyw5fD3ygC/RhaxYlzdta0PmmUAhft/MMzMwFnleJqYUClssu06iQ0c5cU2EUnROBraEc9wOcOA==";
        };
        _51jIV9lt = {
            "id" = "51jIV9lt";
    ...
    in {
        ...
        "pkg-3.9.1" = _qfLQVqyv;
        "pkg-3.9.2" = _hzEgGNBI;
        "pkg-3.10.0" = _uyRrRMrH;
        "pkg-3.10.1" = _MCLYATe6;
        "pkg-3.10.2" = _JXCsSuCl;
        "pkg-3.11.0" = _G3WMIwZA;
        "pkg-3.12.0" = _dZ75946f;
        "pkg-3.12.1" = _PKICveYn;
        "pkg-3.12.2" = _ssbEEo76;
        "pkg-3.12.3" = _INsCbBKZ;
        "pkg-3.12.4" = _TJ3PQe1y;
        "pkg-3.12.5" = _ARDN1LWN;
        "pkg-3.13.0" = _eIFPlwp2;
        "pkg-3.13.1" = _12Nbf4BH;
        "pkg-3.14.0" = _29brjVoz;
        "pkg-3.14.1" = _6cPif4QV;
        "pkg-3.14.2" = _UabgAApJ;
        "pkg-3.14.3" = _ZMOELGJg;
        "pkg-3.15.0" = _s9nKdiEA;
        "pkg-3.15.1" = _WaqHnEmo;
        "pkg-3.15.2" = _ZaRRWa72;
        "pkg-3.15.3" = _SWKaG5n5;
        "pkg-3.15.4" = _pdoUvxNC;
        "pkg-3.15.5" = _V42W4SCh;
        "pkg-3.15.6" = _LAYNtsyE;
        "pkg-3.15.7" = _7qIjIAHp;
        "pkg-3.15.8" = _ls4estKU;
        "pkg-3.15.9" = _UTnV5cSs;
        "pkg-3.16.0" = _XwcowfLc;
        "pkg-3.17.0" = _jbD51aHO;
        "pkg-3.17.1" = _y4QLVZyH;
        "pkg-3.17.2-beta+forge" = _gK03SqlK;
        "pkg-3.17.3" = _FOFo5tY4;
        "pkg-3.17.3+forge" = _JsGpM1Rs;
        "pkg-3.17.4+forge" = _4d6O6XlB;
        "pkg-3.18.0" = _rAxUQ8i3;
        "pkg-3.18.0+forge" = _xWuoybvr;
        "pkg-3.18.1+forge" = _97WBNq2F;
        "pkg-3.18.2" = _vsbpw04g;
        "pkg-3.18.2+forge" = _jyPo0pwK;
        "pkg-3.18.3" = _6wy6ArUZ;
        "pkg-3.18.3+forge" = _ajq2g5mQ;
        "pkg-3.18.4+forge" = _3RAR4Rzx;
        "pkg-3.18.5" = _5LXil8kr;
        "pkg-3.18.5+forge" = _MXSsGmTt;
        "pkg-3.18.6" = _aMJtpy2a;
        "pkg-3.18.7" = _oLPpckZb;
        "pkg-3.18.7+forge" = _4bilwQHq;
        "pkg-3.19.0" = _DAyEx90Q;
        "pkg-3.19.0+forge" = _qd9WTrBT;
        "pkg-3.19.1+forge" = _99YzLnDQ;
        "pkg-3.19.2" = _flb44Yhj;
        "pkg-3.19.2+forge" = _mb0SYHAo;
        "pkg-3.19.3" = _ju7tZaHJ;
        "pkg-3.19.3+forge" = _ptmoRTWg;
        "pkg-3.19.4" = _6hs6vrtr;
        "pkg-3.19.4+forge" = _wL2tCcIm;
        "pkg-3.19.5" = _2Lzw0Of6;
        "pkg-3.19.5+forge" = _5wCUerxX;
        "pkg-3.19.6" = _2FxXTUgp;
        "pkg-3.19.6+forge" = _Jj9C0uYl;
        "pkg-3.19.7" = _XgieyIrM;
        "pkg-3.19.7+forge" = _VpbnnaoM;
        "pkg-3.19.8" = _yJFNooXC;
        "pkg-3.19.8+forge" = _OGuzaAG5;
        "pkg-3.19.4+backport" = _sMCcYngo;
        "pkg-3.19.4+backport.forge" = _dyMXSYR8;
        "pkg-3.19.3+backport.forge" = _1p99qtqq;
        "pkg-3.19.3+backport" = _PJ7MPEJJ;
        "pkg-3.17.5" = _WRFFw4eh;
        "pkg-3.17.5+forge" = _V5JCqigQ;
        "pkg-3.19.10" = _UtNxlYMj;
        "pkg-3.19.10+forge" = _uyi9f8Aq;
        "pkg-3.17.6+forge" = _U2XgYJpS;
        "pkg-26.1.0" = _7A0a9BVH;
        "pkg-26.1.0+forge" = _jLx7lBLg;
        "pkg-3.19.11" = _mXXN9lwE;
        "pkg-3.19.11+forge" = _vsT3DCmm;
        "pkg-26.1.1" = _iJfkeXDD;
        "pkg-26.1.1+forge" = _uGnaJ4bw;
        "pkg-3.19.12" = _nrxuA7sO;
        "pkg-26.1.2" = _Icy7xbUM;
        "pkg-26.2.0" = _2OUaNmBO;
        "pkg-26.2.0+forge" = _Ps3UXfT8;
        "pkg-26.2.1" = _s1CMnlwk;
        "pkg-26.2.1+forge" = _6H1DdYfT;
        "pkg-26.1.3" = _pYX1Mhkj;
        "pkg-26.1.3+forge" = _yCbYMb8S;
        "pkg-3.17.7+forge" = _kCSwQJ9C;
        "pkg-26.1.4+forge" = _OjH9Jj4a;
