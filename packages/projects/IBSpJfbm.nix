...
let
    versions = (let
        ...
        _eMWbHyr4 = {
            "id" = "eMWbHyr4";
            "file" = "PluginUpdater-paper-4.3.2.jar";
            "hash" = "sha512-t13e/PTcRzU6frc+FcTjmGy3fh7qBYYQeKSi0tKocOeBGiAKmKU9qLKKs3R7PBua0LfPxHg6Y7n0iF/rVR7Lhg==";
        };
        _SPp4c74d = {
            "id" = "SPp4c74d";
            "file" = "PluginUpdater-paper-4.3.2.jar";
            "hash" = "sha512-cplykZrtrg7NR+6+FAafMCbytDAQDwvggLKF+6tJCUclXafWvmB++yxp1asK/ofH7JK+WlXxHV+iCxbw+p7W4w==";
        };
        _OxTIFJQt = {
            "id" = "OxTIFJQt";
            "file" = "PluginUpdater-paper-4.3.2.jar";
            "hash" = "sha512-a+OkyrNnJTgqOSBPe1LGCRBwn1jnpxYLO+42wo/4z4KExQJtAXddjuW2O+j9MxAtb8z/Zo42ixnhAv19fT8n4w==";
        };
    in {
        "31ipNODi" = _31ipNODi;
        "4c3Z95uy" = _4c3Z95uy;
        ...
        "paper-1.21.4" = _OxTIFJQt;
        "paper-1.21.5" = _OxTIFJQt;
        "paper-1.21.6" = _OxTIFJQt;
        "paper-1.21.7" = _OxTIFJQt;
        "paper-1.21.8" = _OxTIFJQt;
        "paper-1.21.9" = _OxTIFJQt;
        "paper-1.21.10" = _OxTIFJQt;
        "paper-1.21.11" = _OxTIFJQt;
        "paper-26.1" = _OxTIFJQt;
        "paper-26.1.1" = _OxTIFJQt;
        "paper-26.1.2" = _OxTIFJQt;
        "paper-26.2" = _OxTIFJQt;
        ...
        "purpur-1.21.4" = _OxTIFJQt;
        "purpur-1.21.5" = _OxTIFJQt;
        "purpur-1.21.6" = _OxTIFJQt;
        "purpur-1.21.7" = _OxTIFJQt;
        "purpur-1.21.8" = _OxTIFJQt;
        "purpur-1.21.9" = _OxTIFJQt;
        "purpur-1.21.10" = _OxTIFJQt;
        "purpur-1.21.11" = _OxTIFJQt;
        "purpur-26.1" = _OxTIFJQt;
        "purpur-26.1.1" = _OxTIFJQt;
        "purpur-26.1.2" = _OxTIFJQt;
        "purpur-26.2" = _OxTIFJQt;
        ...
        "folia-1.21.4" = _OxTIFJQt;
        "folia-1.21.5" = _OxTIFJQt;
        "folia-1.21.6" = _OxTIFJQt;
        "folia-1.21.7" = _OxTIFJQt;
        "folia-1.21.8" = _OxTIFJQt;
        "folia-1.21.9" = _OxTIFJQt;
        "folia-1.21.10" = _OxTIFJQt;
        "folia-1.21.11" = _OxTIFJQt;
        "folia-26.1" = _OxTIFJQt;
        "folia-26.1.1" = _OxTIFJQt;
        "folia-26.1.2" = _OxTIFJQt;
        "folia-26.2" = _OxTIFJQt;
        "pkg-1.0.1" = _31ipNODi;
        "pkg-1.0.1-b9e8ded" = _4c3Z95uy;
        "pkg-1.0.1-5a2fdaf" = _4YqVMRnb;
        "pkg-1.0.1-9226e65" = _EdJjL4wG;
        "pkg-1.0.2" = _Ldto219R;
        "pkg-1.0.2-c541d31" = _OsnlshGZ;
        "pkg-1.0.3" = _GETpISEQ;
        "pkg-1.0.3-1159859" = _Ea9erLs6;
        "pkg-1.0.3-ec0ddb5" = _HxIUuQRO;
        "pkg-1.0.3-3bc6eac" = _AjI6QWfB;
        "pkg-1.0.3-a62caad" = _fBREeyO4;
        "pkg-1.0.3-74f681a" = _QQ0MdR1a;
        "pkg-1.0.3-6a53fa2" = _Lx5XiuA0;
        "pkg-1.0.3-f4de9f4" = _XzRrQ44F;
        "pkg-1.0.3-96e84c0" = _rDnLfQsC;
        "pkg-1.0.4-alpha-3e45538" = _ag558Q3q;
        "pkg-1.0.4-alpha-a980da4" = _QLqo0pmQ;
        "pkg-1.0.4-alpha-ce840ce" = _mJWmbJpF;
        "pkg-1.0.4-alpha-12bf6a7" = _IWXOFYhv;
        "pkg-1.0.4-alpha-79ea117" = _f5VpekTY;
        "pkg-1.0.4-alpha-92ccf67" = _ZxliXqEn;
        "pkg-1.0.4-alpha-ce7340c" = _jeJFznWN;
        "pkg-1.0.4-a7a4346" = _dxDr9Og0;
        "pkg-1.0.5-0d0325d" = _DSaEpKLW;
        "pkg-1.0.6-a8505e5" = _UiVS9mG6;
        "pkg-1.0.7-alpha-70adadb" = _jcJERI4Y;
        "pkg-1.0.7" = _pdAW30C2;
        "pkg-1.0.7-00138d5" = _wUEsORgB;
        "pkg-1.0.7-63c9611" = _Xsp7PysY;
        "pkg-1.0.7-2784efc" = _vB8ASpHM;
        "pkg-1.0.7-7264c36" = _1MevRJ7k;
        "pkg-1.0.8-alpha-845b2d6" = _XlZ79V59;
        "pkg-1.0.8" = _EPkT32H9;
        "pkg-1.0.8-3c91f24" = _VTmvY2z0;
        "pkg-1.0.8-dfcc4ca" = _EhNc22K0;
        "pkg-1.0.8-49c1cb3" = _4RBczhPr;
        "pkg-1.0.9" = _ZMZ7vMnH;
        "pkg-1.0.9-7edf8a6" = _lNqsZhcG;
        "pkg-1.0.9-04392ee" = _wxxxCcQW;
        "pkg-1.0.9-a467083" = _j91AC1Wr;
        "pkg-1.0.10" = _nx9oteut;
        "pkg-1.0.10-2bc900d" = _3nML1YM9;
        "pkg-1.0.10-7a556de" = _mVhEOCBy;
        "pkg-1.0.10-b3f616c" = _BB2YLad9;
        "pkg-1.0.10-246a670" = _gi2DtxGY;
        "pkg-1.0.10-968c9ec" = _wrfaZEGI;
        "pkg-1.0.10-77b334e" = _GcXLecwZ;
        "pkg-1.0.10-6173d48" = _ZLoqNz9v;
        "pkg-1.0.10-64f9332" = _uj75N3po;
        "pkg-1.0.10-3f22229" = _NDf8N3BI;
        "pkg-1.0.10-34e9786" = _kTqk7wjm;
        "pkg-1.0.11" = _swIVPehb;
        "pkg-1.0.11-2cffb31" = _DbgQmgBb;
        "pkg-1.0.11-fdb4aa6" = _63pCUQrx;
        "pkg-1.0.11-ceae123" = _dkVt0Lfp;
        "pkg-1.0.11-5b16511" = _bXA1zhe8;
        "pkg-1.0.11-5e067b6" = _SmuwUzKm;
        "pkg-1.0.11-294debd" = _k5ZlyRNd;
        "pkg-1.0.11-297a3c9" = _LhOvpHMT;
        "pkg-1.0.12-9f0dd9d" = _QLNgUuZK;
        "pkg-1.0.12-e56eae3" = _wkhAKDKl;
        "pkg-1.0.12-5126da8" = _1nFRI1VT;
        "pkg-1.0.12-304f19d" = _8gAFACPw;
        "pkg-1.0.12-fd91b38" = _xcWNEE3g;
        "pkg-1.0.12-d293650" = _wxPAJtwG;
        "pkg-1.0.12-8c9fc9c" = _r5OFZIqY;
        "pkg-1.0.12-24c592e" = _GSHut1J8;
        "pkg-1.0.12-94b6791" = _YQtX5Vnk;
        "pkg-1.0.12-bf63848" = _50OpqKhg;
        "pkg-1.0.12-f55273b" = _wQDkSlF0;
        "pkg-1.0.13" = _Yp8kBT2A;
        "pkg-1.0.13-29ad25f" = _X1iAbyI9;
        "pkg-1.0.13-72c14db" = _RgLY1ydB;
        "pkg-1.0.13-434f835" = _rNyN0DLv;
        "pkg-1.0.13-0a81381" = _HHFcqcNX;
        "pkg-1.0.14" = _8kns6Xzf;
        "pkg-1.0.14-5186fbf" = _EMz9ID5r;
        "pkg-1.0.14-2ed8152" = _VBjULxha;
        "pkg-1.0.14-849d3ff" = _6e0zpXYZ;
        "pkg-1.0.14-fc61d56" = _MEkEdij6;
        "pkg-1.0.14-4200853" = _W66nCJGS;
        "pkg-1.0.15" = _IDSsbJDx;
        "pkg-1.0.15-f6c0eba" = _hRaSiy4r;
        "pkg-1.0.15-93670bd" = _JieQRRE2;
        "pkg-1.0.15-9df922b" = _eYhsLeHt;
        "pkg-1.0.15-5f6d2c0" = _ePs9P6j3;
        "pkg-1.0.16" = _qioCOcF7;
        "pkg-1.0.16-111d5f0" = _MfSjsXoh;
        "pkg-1.0.16-69d41bc" = _yMQcFubS;
        "pkg-1.0.16-98006e0" = _pejk95O5;
        "pkg-1.0.16-26dbfe7" = _ZMojjYCj;
        "pkg-1.0.16-5d207bf" = _LRykDayn;
        "pkg-1.0.16-ce01f20" = _5Rwqp1lY;
        "pkg-1.0.16-3f10c7c" = _gRZA6HMt;
        "pkg-1.0.17" = _LIFRJkXA;
        "pkg-1.0.17-b470307" = _XisPMAP9;
        "pkg-1.0.17-c858f09" = _tNzB7XcV;
        "pkg-1.0.18" = _iypExp7H;
        "pkg-1.0.18-e81811d" = _75HO2AqC;
        "pkg-1.0.18-91dcd15" = _Dv5MDaVC;
        "pkg-1.0.18-1eb6b0a" = _o2n0jUyj;
        "pkg-1.0.18-a8be656" = _OyeLaxwL;
        "pkg-1.0.18-ef18e22" = _uUnmYIFr;
        "pkg-1.0.18-b046dbb" = _k5ijQUGv;
        "pkg-1.0.18-a77cc91" = _qiBMRWTU;
        "pkg-1.0.18-20cd7b5" = _y5W64mCU;
        "pkg-1.0.18-a8de82d" = _SUqE4Jgl;
        "pkg-1.0.18-ea80fa5" = _BaaQlJmv;
        "pkg-1.0.18-01d0cc6" = _mu6wSqA1;
        "pkg-1.0.18-e5bdf23" = _QvNIY7wB;
        "pkg-1.0.18-af2a8f6" = _vYVqxtqi;
        "pkg-1.0.18-93d74ba" = _g4aaGYXW;
        "pkg-1.0.19" = _s5pHhg7u;
        "pkg-2.0.0" = _t0gy7FSj;
        "pkg-2.0.0-d5c9c37" = _9uUMWyxJ;
        "pkg-2.0.1" = _36abxCtl;
        "pkg-2.0.1-39e06b1" = _U6Tj41jI;
        "pkg-2.0.1-2718c47" = _6KPpnq7M;
        "pkg-2.0.2" = _MFpouYJp;
        "pkg-2.0.3" = _psuhG7BA;
        "pkg-2.0.3-646f751" = _bl08NV16;
        "pkg-2.0.3-e3e9908" = _17u6ODXR;
        "pkg-2.0.3-d019d7a" = _M2pA3nUI;
        "pkg-2.0.3-ed426e7" = _ZqXDbnFG;
        "pkg-2.0.3-5b8228a" = _TS75tjNO;
        "pkg-2.1.0" = _wubnoLRO;
        "pkg-2.1.0-937de33" = _YwNOjtCh;
        "pkg-2.1.0-8295854" = _8FWv3tgS;
        "pkg-2.2.0" = _W0jHKBd8;
        "pkg-2.2.0-ed7f3c0" = _Vb3aNn8k;
        "pkg-2.2.0-fa53f1c" = _RiH8rmrG;
        "pkg-2.2.0-992c509" = _VfwYmHqD;
        "pkg-2.2.0-fe21509" = _WLOQvGmE;
        "pkg-2.2.0-1af8a68" = _CJMLWopc;
        "pkg-3.0.0" = _3vfzXQca;
        "pkg-3.0.0-20fc2aa" = _kRewaYpy;
        "pkg-3.0.0-8b0e9bd" = _7kHPFiHp;
        "pkg-3.0.0-9922324" = _CWvz8Csq;
        "pkg-3.0.0-e6b81e6" = _s0KBcNvU;
        "pkg-3.0.0-13ebb18" = _ntqG1xP5;
        "pkg-3.0.0-3176c43" = _mHh6pWEn;
        "pkg-3.0.0-8b3c5bd" = _Ioh7XXng;
        "pkg-3.0.0-2fccd20" = _L9Wg1DqC;
        "pkg-3.0.1" = _mXJQHrVm;
        "pkg-3.0.1-7216516" = _qsStIatJ;
        "pkg-3.0.1-ddf7011" = _MtbDw7RU;
        "pkg-3.0.1-74dcce0" = _503SDhrN;
        "pkg-3.0.2" = _dlZsmEWm;
        "pkg-3.0.2-f0623bd" = _x6EcBwJo;
        "pkg-3.0.2-7c1735d" = _1eHSS36m;
        "pkg-3.0.2-81335c4" = _IrgGqF87;
        "pkg-3.0.3" = _datlEiYQ;
        "pkg-3.0.3-13b1619" = _r7cOzm4U;
        "pkg-3.0.3-3c7b752" = _wLnJpLJR;
        "pkg-3.0.3-f0ba259" = _OuW7mPTs;
        "pkg-3.0.3-e36cc43" = _IG8A3Ifn;
        "pkg-3.0.3-bb8b872" = _z9K6ilzI;
        "pkg-3.0.3-adc2acc" = _9K9ahWd5;
        "pkg-3.0.3-356abb8" = _lfmpfnts;
        "pkg-3.0.3-6f10193" = _hchtLohx;
        "pkg-3.0.3-1077e9a" = _IqzEAsAy;
        "pkg-3.0.3-d6a6111" = _EL2r2nPK;
        "pkg-3.0.3-d4b8700" = _FFqEiMeX;
        "pkg-3.0.4" = _UW5gOYwJ;
        "pkg-3.0.4-30fdbf3" = _C5ymShde;
        "pkg-3.0.4-5f06be1" = _KCq7lcJI;
        "pkg-3.0.5" = _e6QN7i0w;
        "pkg-3.0.5-6638296" = _Wn7n1cRD;
        "pkg-3.0.5-2eca932" = _TLlcVUJd;
        "pkg-3.0.6" = _Ik8a8yYN;
        "pkg-3.0.6-28c3b5a" = _orJhJyf3;
        "pkg-3.0.7" = _5nFZn0F1;
        "pkg-3.0.8" = _BEs4uPyZ;
        "pkg-3.0.8-8d34f12" = _Q4fj34st;
        "pkg-3.0.9" = _yRvYO1CI;
        "pkg-3.0.10" = _QFmN0PBr;
        "pkg-3.0.10-3f222a6" = _RGKegXk6;
        "pkg-3.0.10-7be3f5d" = _UksPkSk7;
        "pkg-3.0.10-5152aa3" = _G1Ak4tKV;
        "pkg-3.0.11" = _68kbuqvT;
        "pkg-3.1.0" = _fh1AyC4N;
        "pkg-3.1.0-1233032" = _bWYaG7zw;
        "pkg-3.1.0-0c473b9" = _fAncXCrj;
        "pkg-3.1.0-484fc6a" = _vVrx1PKb;
        "pkg-3.1.0-6ceff0c" = _GV83mVk5;
        "pkg-3.1.0-a273c4d" = _Uqp58vSu;
        "pkg-3.1.0-4a371e9" = _EeuyNjWP;
        "pkg-3.1.0-344c484" = _ZP36nI6W;
        "pkg-3.1.0-69c18f9" = _RgBt2dBS;
        "pkg-3.1.0-695a143" = _rzPwARKG;
        "pkg-3.1.0-76533cb" = _ZLN2WOHU;
        "pkg-3.1.0-88768a2" = _1hwNEo4T;
        "pkg-3.1.0-ca1b1e8" = _62xrclga;
        "pkg-4.0.0" = _W2yKZhVk;
        "pkg-4.0.0-c7b91de" = _UC1ULKGv;
        "pkg-4.0.0-c4abae1" = _1HYMJjon;
        "pkg-4.0.1" = _KqGi58Ie;
        "pkg-4.0.1-a678725" = _ycfb7r6Q;
        "pkg-4.0.1+25bdec2" = _sS8ICtha;
        "pkg-4.0.1+202785a" = _BBxMlLWC;
        "pkg-4.0.1+aa3d2f1" = _QQHGroxt;
        "pkg-4.1.0" = _nVKJWVPV;
        "pkg-4.1.1" = _NP1Qx5xJ;
        "pkg-4.1.2" = _nlay9zAj;
        "pkg-4.1.2+36d0cbf" = _mEqevhwX;
        "pkg-4.1.3" = _8OurHROK;
        "pkg-4.1.3+c3d516a" = _uGgrWSYn;
        "pkg-4.1.3+6bbcda3" = _ZuoTPJf5;
        "pkg-4.1.4" = _IkcZorWj;
        "pkg-4.1.4+7d97cdb" = _l4H4cqO1;
        "pkg-4.1.4+2ae104a" = _abQ2TsbM;
        "pkg-4.1.4+8b54506" = _O2G8w6yL;
        "pkg-4.1.4+9d25f68" = _nSHzJeXm;
        "pkg-4.1.4+d00bdcd" = _QnFMH6iQ;
        "pkg-4.1.4+53df08c" = _IlLrFOUW;
        "pkg-4.2.0" = _xUYHxfWu;
        "pkg-4.2.0+052332a" = _nIXzr7gj;
        "pkg-4.2.0+fe4bbc7" = _TyLFXkOq;
        "pkg-4.2.1" = _pMYyS3Jj;
        "pkg-4.2.1+b861855" = _USseVMXG;
        "pkg-4.2.1+b6cb0ec" = _R8yvoBQ8;
        "pkg-4.2.2" = _KjVwBU1Q;
        "pkg-4.2.2+0f91222" = _ZLkxxl5Z;
        "pkg-4.2.2+dd901a0" = _kvY2KxJ3;
        "pkg-4.2.2+5bcb536" = _ikfRu4Jp;
        "pkg-4.2.2+e804f43" = _bdwF1bQq;
        "pkg-4.2.2+3cd9d25" = _VuJJBBRK;
        "pkg-4.2.2+15b6214" = _YXwOqnWg;
        "pkg-4.2.2+50543cd" = _yVXC1kDG;
        "pkg-4.2.2+46cb616" = _MyLkkKNg;
        "pkg-4.3.0" = _NpKtC0XP;
        ...
        "pkg-4.3.2+99b1359" = _eMWbHyr4;
        "pkg-4.3.2+137a95c" = _SPp4c74d;
        "pkg-4.3.2+12535dd" = _OxTIFJQt;
        "default" = _OxTIFJQt;
    });
