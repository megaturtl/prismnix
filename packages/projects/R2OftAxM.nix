...
let
    ...
    in {
        ...
        "pkg-1.2.0-1.19" = _huqohPcW;
        "pkg-1.18.2-1.2.1" = _yE9Uj2ud;
        "pkg-1.19-1.2.1" = _vKnBI3zc;
        "pkg-1.18.2-1.2.2" = _uRQmgrHj;
        "pkg-1.19.2-1.2.2" = _N1aLfuNT;
        "pkg-1.20.1-1.2.2" = _p5bkNiw0;
        "pkg-1.20.1-1.2.2a" = _9N99D1CJ;
        "pkg-1.18.2-1.2.3" = _tKCwnbTN;
        "pkg-1.19.2-1.2.3" = _umpztmTl;
        "pkg-1.20.1-1.2.3" = _k7RoRFPF;
        "pkg-1.19.2-1.2.4" = _rFTKVUtq;
        "pkg-1.20.1-1.2.4" = _AxgOboGq;
        "pkg-1.21-1.2.4" = _ovSzG9pc;
        "pkg-1.21.1-1.2.4a" = _gXxUKCWt;
        "pkg-1.20.1-1.2.5" = _5tKbefI6;
        "pkg-1.21.1-1.2.5" = _1gwNWS77;
        "pkg-1.20.1-1.2.6" = _MG1Xuspn;
        "pkg-1.21.1-1.2.6" = _clpgpAoc;
        "pkg-1.20.1-1.2.7" = _NcRp00OO;
        "pkg-1.21.1-1.2.7" = _XhhT3PXv;
        "pkg-1.20.1-1.2.8" = _YWFFrKk6;
        "pkg-1.21.1-1.2.8" = _yCkges3O;
        "pkg-1.20.1-1.2.9" = _8rPF1pFi;
        "pkg-1.21.1-1.2.9" = _opCbq7uB;
        "pkg-1.20.1-1.2.10" = _igQdwIqn;
        "pkg-1.21.1-1.2.10" = _EVaDSbPj;
        "pkg-1.20.1-1.2.11" = _bCtijHxU;
        "pkg-1.21.1-1.2.11" = _cYqC3svy;
        "pkg-1.20.1-1.2.11a" = _RLMY4UKM;
        "pkg-1.21.1-1.2.11a" = _rOESN0jP;
        "pkg-1.20.1-1.3.0" = _aKcbt91p;
        "pkg-1.21.1-1.3.0" = _XJKk7DgU;
        "pkg-1.20.1-1.3.1" = _ugqnwJ4j;
