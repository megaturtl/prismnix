...
let
    versions = (let
        ...
        _SGFJBL5q = {
            "id" = "SGFJBL5q";
            "file" = "MyNethersDelight-1.21.1-1.10.4.1.jar";
            "hash" = "sha512-Nt8UaXTXD+X3ySxK7vYT0eAZLvu1UPqojvqoFwISwH+fxZOJYdG42kiTVVeZEOlf6izVrnFLYUzhfxuONS8Lvw==";
        };
    in {
        "kgHvIUs2" = _kgHvIUs2;
        "TowaIAkd" = _TowaIAkd;
        ...
        "neoforge-1.21.1" = _SGFJBL5q;
        "pkg-1.19-1.0" = _kgHvIUs2;
        "pkg-1.20.1-1.0" = _TowaIAkd;
        "pkg-1.20.1-1.1" = _LgjRrOZr;
        "pkg-1.19-1.1" = _QpOM0APe;
        "pkg-1.20.1-1.6" = _4Dt3pl7s;
        "pkg-1.20.1-1.7" = _8fXEzTUt;
        "pkg-1.20.1-1.7.4" = _TGGzLEMg;
        "pkg-1.20.1-1.7.5" = _40IiyEgJ;
        "pkg-1.20.1-1.7.5.1" = _NQ7LWtbM;
        "pkg-1.20.1-1.7.5.2" = _NaSrmfwh;
        "pkg-1.20.1-1.7.5.3" = _rgOKgDB6;
        "pkg-1.19-1.7.5" = _U5OCImuN;
        "pkg-1.19-1.7.6" = _u8pJaV2E;
        "pkg-1.20.1-1.7.6" = _yIOVSvSr;
        "pkg-1.7.6" = _IiZH6bhe;
        "pkg-1.7.7" = _30Kgx0Wp;
        "pkg-1.7.8" = _G2jsuoAA;
        "pkg-1.8" = _XZlkMc8h;
        "pkg-1.20.1-1.8" = _Y0doU8aW;
        "pkg-1.9" = _n2vJCdff;
        "pkg-1.10" = _lvTo8T38;
        "pkg-1.10.1" = _YZae6njR;
        "pkg-1.10.2" = _qBUSJw5Z;
        "pkg-1.10.4" = _OdH19ieD;
        "pkg-1.20.1-1.10.4" = _DKcTbOE3;
        "pkg-1.20.1-1.10.4-backport.1" = _pOBasFQT;
        "pkg-1.10.4.1" = _SGFJBL5q;
        "default" = _SGFJBL5q;
    });
