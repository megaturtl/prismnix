...
let
    ...
    in {
        ...
        "pkg-1.20-1.1.1" = _QqUJ27NX;
        "pkg-1.20-1.2.0" = _onXWmFfM;
        "pkg-1.20-1.2.1" = _hZHvEL3g;
        "pkg-1.20-1.3.0" = _qLUEqfx3;
        "pkg-1.20-1.3.1" = _6uEW165h;
        "pkg-1.20-1.3.2" = _42l5byXP;
        "pkg-1.20-1.4.0" = _70emrVgd;
        "pkg-1.20-1.4.1" = _laQU6Usy;
        "pkg-1.20-1.4.2" = _y6OMWXZg;
        "pkg-1.20-1.5.0" = _KjBlo7Go;
        "pkg-1.20-1.6.0" = _fUEd6RcG;
        "pkg-1.20-1.6.1" = _PwvUdIYH;
        "pkg-1.20-1.6.2" = _UdWr3syd;
        "pkg-1.20-1.6.3" = _7TJtKNWV;
        "pkg-1.20-1.6.4" = _c9aQvEX9;
        "pkg-1.20-1.7.0" = _yhWBbmAi;
        "pkg-1.20-1.8.0" = _Yi2jkoyt;
