...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.21.1-neoforge" = _7qVfrv6E;
        "pkg-1.0.0-1.21.4-fabric" = _r8bN3lJC;
        "pkg-1.0.0-1.21.4-neoforge" = _GsqCN6MI;
        "pkg-1.0.1-1.20.1-fabric" = _MZoSOr3q;
        "pkg-1.0.1-1.20.1-forge" = _Ek9zni8y;
        "pkg-1.0.1-1.21.1-fabric" = _BDAaHYS9;
        "pkg-1.0.1-1.21.1-neoforge" = _Ji0vYlAE;
        "pkg-1.0.1-1.21.4-fabric" = _Zqx90EzD;
        "pkg-1.0.1-1.21.4-neoforge" = _szSiwgEm;
        "pkg-1.0.2-1.20.1-fabric" = _Kskkr7o7;
        "pkg-1.0.2-1.20.1-forge" = _DFBBypAy;
        "pkg-1.0.2-1.21.1-fabric" = _xXLJQCe1;
        "pkg-1.0.2-1.21.1-neoforge" = _dOs4QDxm;
        "pkg-1.0.2-1.21.4-fabric" = _2KvxKQgY;
        "pkg-1.0.2-1.21.4-neoforge" = _pwXMA70d;
        "pkg-1.0.3-1.20.1-fabric" = _aIwv1PBR;
        "pkg-1.0.3-1.20.1-forge" = _TcdpmCUC;
        "pkg-1.0.3-1.21.1-fabric" = _K1u3o0CL;
        "pkg-1.0.3-1.21.1-neoforge" = _jRiJWiJl;
        "pkg-1.0.3-1.21.4-fabric" = _yySH7u7K;
        "pkg-1.0.3-1.21.4-neoforge" = _PO475bcq;
        "pkg-1.0.4-1.20.1-fabric" = _jv9Dyp1L;
        "pkg-1.0.4-1.20.1-forge" = _h7q6s7zN;
        "pkg-1.0.4-1.21.1-fabric" = _n4u2wQRN;
        "pkg-1.0.4-1.21.1-neoforge" = _7Fnul3kG;
        "pkg-1.0.4-1.21.4-fabric" = _IOsbokPF;
        "pkg-1.0.4-1.21.4-neoforge" = _vSZwV5TS;
        "pkg-1.0.5-1.20.1-fabric" = _MmnrB2sC;
        "pkg-1.0.5-1.20.1-forge" = _eJbDceP3;
        "pkg-1.0.5-1.21.4-fabric" = _z2NQ2xgR;
        "pkg-1.0.5-1.21.4-neoforge" = _va02KV8V;
        "pkg-1.0.5-1.21.1-fabric" = _5m1tFn3C;
        "pkg-1.0.5-1.21.1-neoforge" = _GPWjmm16;
        "pkg-1.0.5-1.21.5-fabric" = _2pm5dPXX;
        "pkg-1.0.5-1.21.5-neoforge" = _dgy6Bl6G;
        "pkg-1.0.5-1.21.9-fabric" = _18Qarrol;
        "pkg-1.0.5-1.21.9-neoforge" = _iAFMUm6A;
        "pkg-1.0.5-1.21.11-fabric" = _7wUuMLEu;
        "pkg-1.0.5-1.21.11-neoforge" = _P6tkdxE8;
        "pkg-2.0.0+1.21.1-neoforge" = _ac5UUizz;
        "pkg-2.0.0+1.21.1-fabric" = _iLsHA0im;
        "pkg-2.0.0+1.21.11-neoforge" = _wBidnvGr;
        "pkg-2.0.0+1.21.11-fabric" = _jjdepRFM;
        "pkg-2.0.1+1.21.1-neoforge" = _hAARAAxY;
        "pkg-2.0.1+1.21.1-fabric" = _8GMRov7t;
        "pkg-2.0.1+1.21.11-neoforge" = _DHir3ojM;
        "pkg-2.0.1+1.21.11-fabric" = _tADnwn4y;
        "pkg-1.0.6-1.20.1-forge" = _qfFrA4kZ;
        "pkg-1.0.6-1.20.1-fabric" = _zmWPTWSz;
        "pkg-2.0.2+1.21.1-neoforge" = _LDhxOoqS;
        "pkg-2.0.2+1.21.1-fabric" = _3pVaXPfQ;
        "pkg-2.0.2+1.21.11-neoforge" = _bX4keuAM;
        "pkg-2.0.2+1.21.11-fabric" = _rBpov0EM;
        "pkg-2.0.2+26.1-fabric" = _EWNeUq0f;
        "pkg-2.0.2+26.1-neoforge" = _N5JuQd8d;
        "pkg-2.0.3+1.21.1-fabric" = _MJQowd3v;
        "pkg-2.0.3+1.21.1-neoforge" = _r2U557qD;
        "pkg-2.0.3+1.21.11-fabric" = _osfJRnd5;
        "pkg-2.0.3+1.21.11-neoforge" = _Xi363plF;
        "pkg-2.0.3+26.1.2-fabric" = _KR3qAATT;
        "pkg-2.0.3+26.1.2-neoforge" = _4gjDQz3g;
        "pkg-3.0.0+26.2-rc-2" = _7dHK5DXF;
        "pkg-3.0.1+26.2" = _levmvvbV;
        "pkg-2.0.4+1.21.1-fabric" = _gqWuMBDN;
        "pkg-2.0.4+1.21.1-neoforge" = _xhF64IEb;
        "pkg-2.0.4+1.21.11-fabric" = _D90nGOxy;
        "pkg-2.0.4+1.21.11-neoforge" = _k3O5xfl1;
        "pkg-2.0.4+26.1.2-fabric" = _nsIvRYDl;
        "pkg-2.0.4+26.1.2-neoforge" = _wkoHXYq0;
        "pkg-2.0.5+1.21.1-fabric" = _80DxHKLM;
        "pkg-2.0.5+1.21.1-neoforge" = _B5uWMUF6;
        "pkg-2.0.5+1.21.11-fabric" = _TpCKe0o4;
        "pkg-2.0.5+1.21.11-neoforge" = _GpeCWhhH;
        "pkg-2.0.5+26.1.2-fabric" = _yQWIz8JT;
        "pkg-2.0.5+26.1.2-neoforge" = _dKFCZIYQ;
        "pkg-3.0.2+26.2" = _k5JzulfA;
        "pkg-3.0.3+26.2" = _WexoLdPL;
        "pkg-2.0.6+1.21.1-fabric" = _imSYuHhw;
        "pkg-2.0.6+1.21.1-neoforge" = _GPC31bUX;
        "pkg-2.0.6+1.21.11-fabric" = _21kOpSOS;
        "pkg-2.0.6+1.21.11-neoforge" = _H4yphQRf;
