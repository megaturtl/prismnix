...
let
    ...
    in {
        ...
        "pkg-1.19.2-2.1.0.3-forge" = _tiJwR4Q7;
        "pkg-1.19.2-2.1.0.4-fabric" = _imb3h2AD;
        "pkg-1.19.2-2.1.0.4-forge" = _eyVlrzln;
        "pkg-1.19.2-2.1.0.5-forge" = _oPYsFTI6;
        "pkg-1.19.2-2.1.0.5-fabric" = _dl7OR28k;
        "pkg-1.19.3-3.0.0.0-fabric" = _d7L2OfuI;
        "pkg-1.19.3-3.0.0.0-forge" = _RNXmq4SP;
        "pkg-1.19.4-4.0.0.0-fabric" = _GFjdsHSJ;
        "pkg-1.19.4-4.0.0.0-forge" = _AAgh5uLd;
        "pkg-1.20.1-5.0.0.0-fabric" = _w38HWflm;
        "pkg-1.20.1-5.0.0.0-forge" = _tAGfctbS;
        "pkg-1.19.2-2.1.0.6-forge" = _OsNYDQZP;
        "pkg-1.19.2-2.1.0.6-fabric" = _4NxrnxgW;
        "pkg-1.20.1-5.0.0.1-fabric" = _f6ErcVR1;
        "pkg-1.20.1-5.0.0.1-forge" = _rQD5qcWQ;
        "pkg-1.19.3-3.0.0.1-fabric" = _x5X9neMO;
        "pkg-1.19.3-3.0.0.1-forge" = _T40uQ3iI;
        "pkg-1.19.4-4.0.0.1-forge" = _jt4mCMD3;
        "pkg-1.19.4-4.0.0.1-fabric" = _gpmlV23Y;
        "pkg-1.20.1-5.0.0.2-fabric" = _OUQLyS9b;
        "pkg-1.20.1-5.0.0.2-forge" = _rctvvrAu;
        "pkg-1.20.1-5.0.0.3-fabric" = _V6RaR5sq;
        "pkg-1.20.1-5.0.0.3-forge" = _5j4UlfXj;
        "pkg-1.20.1-5.0.0.4-fabric" = _xWlBB0zm;
        "pkg-1.20.1-5.0.0.4-forge" = _el9b4SHV;
        "pkg-1.20.1-5.0.1.0-fabric" = _PBk4PKui;
        "pkg-1.20.1-5.0.1.0-forge" = _1xSRBbRW;
        "pkg-6.0.0.0-fabric" = _be5drNp8;
        "pkg-6.0.0.0-forge" = _wT5EMLDb;
        "pkg-6.0.0.0-neoforge" = _fHqUbRA5;
        "pkg-6.0.1.0-fabric" = _EkmTjvbt;
        "pkg-6.0.1.0-forge" = _FfcS9mTv;
        "pkg-6.0.1.0-neoforge" = _ktvaNNv7;
        "pkg-1.20.1-5.0.2.0-fabric" = _2g6WNiug;
        "pkg-1.20.1-5.0.2.0-forge" = _9Ut5KQ1Z;
        "pkg-6.0.1.1-fabric" = _YWi1K7Cq;
        "pkg-6.0.1.1-forge" = _ozTYtn7Y;
        "pkg-6.0.1.1-neoforge" = _NZL02djL;
        "pkg-1.20.1-5.0.2.1-fabric" = _s7ptVSWX;
        "pkg-1.20.1-5.0.2.1-forge" = _jX9mBdEY;
        "pkg-1.20.1-5.0.2.2-fabric" = _z3AMS9sH;
        "pkg-1.20.1-5.0.2.2-forge" = _y1xCYgVh;
        "pkg-6.0.1.2-fabric" = _Us2AiVqV;
        "pkg-6.0.1.2-forge" = _HGcNp5JS;
        "pkg-6.0.1.2-neoforge" = _NGB3MWct;
        "pkg-1.20.1-5.0.2.3-fabric" = _N84yYvmy;
        "pkg-1.20.1-5.0.2.3-forge" = _NnLZsxmO;
        "pkg-6.0.1.3-fabric" = _gd1YaZ8w;
        "pkg-6.0.1.3-forge" = _ANS1jcAZ;
        "pkg-6.0.1.3-neoforge" = _IEE0ZwQF;
        "pkg-1.20.1-5.0.3.0-fabric" = _CqSSYaQA;
        "pkg-1.20.1-5.0.3.0-forge" = _AYYrKFgT;
        "pkg-6.0.2.0-fabric" = _boM0THhL;
        "pkg-6.0.2.0-forge" = _xIFaVSgm;
        "pkg-6.0.2.0-neoforge" = _CJiTDt1r;
        "pkg-1.20.1-5.0.3.1-fabric" = _bGoMMYXA;
        "pkg-1.20.1-5.0.3.1-forge" = _HTji7Upc;
        "pkg-6.0.2.1-fabric" = _ImlTMFTK;
        "pkg-6.0.2.1-forge" = _ZDUKeAeg;
        "pkg-6.0.2.1-neoforge" = _VkBT2hJa;
        "pkg-6.0.2.2-fabric" = _e7eDKQPD;
        "pkg-6.0.2.2-forge" = _R72xu6ry;
        "pkg-6.0.2.2-neoforge" = _4tB53wE9;
        "pkg-6.0.2.3-fabric" = _xzRGcV0f;
        "pkg-6.0.2.3-forge" = _GgLE7157;
        "pkg-6.0.2.3-neoforge" = _7BD8JEhF;
        "pkg-6.0.2.4-fabric" = _iQhJg3Qz;
        "pkg-6.0.2.4-forge" = _DdBMNCVV;
        "pkg-6.0.2.4-neoforge" = _AL0vBiQJ;
        "pkg-6.0.2.5-fabric" = _WU6cJeLI;
        "pkg-6.0.2.5-forge" = _MeRHW6wX;
