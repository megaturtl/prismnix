...
let
    ...
    in {
        ...
        "pkg-0.9.4" = _3nnsZ14r;
        "pkg-0.9.5" = _6bYJl4jj;
        "pkg-0.10.0" = _mSpGbtOJ;
        "pkg-0.10.1" = _Ws7ZIt3q;
        "pkg-0.10.2" = _fGWLooWq;
        "pkg-0.10.3" = _lKgoTfgm;
        "pkg-0.10.4" = _nCcQjTJq;
        "pkg-0.10.5" = _Dd4I9rvb;
        "pkg-b1.7.3-2.0.0" = _WVLTBIeM;
        "pkg-0.10.6" = _3N2EXvH2;
        "pkg-0.10.7" = _6HtIqsuT;
        "pkg-0.10.8" = _sHhesK4j;
        "pkg-1.16.5-0.10.9" = _ikTDXTE9;
        "pkg-1.16.5-0.10.10" = _vyeWK5li;
        "pkg-1.20.1-0.11.0" = _jHYUMpCx;
        "pkg-1.20.1-0.11.1" = _zLa1QtDT;
        "pkg-1.16.5-0.10.11" = _5K6FLhTh;
