...
let
    ...
    in {
        ...
        "pkg-1.19.x-v1.0" = _URIXGtn2;
        "pkg-1.17.1-v1.1-fabric" = _MZDwGxlQ;
        "pkg-1.17.1-v1.1-forge" = _yYu84voy;
        "pkg-1.18.1-v1.1-fabric" = _DT15NozJ;
        "pkg-1.18.1-v1.1-forge" = _KDbDC8dJ;
        "pkg-1.18.2-v1.1-fabric" = _1SaaEmv1;
        "pkg-1.19.x-v1.1-fabric" = _4GF3fQgv;
        "pkg-1.19.x-v1.1-forge" = _xuP6iEYZ;
        "pkg-1.18.2-v1.1-forge" = _Apw4e6R8;
        "pkg-1.17.1-v1.1.1-forge" = _jQtaAuPj;
        "pkg-1.17.1-v1.1.1-fabric" = _qManDNVe;
        "pkg-1.18.1-v1.1.1-forge" = _y3rsFVRs;
        "pkg-1.18.1-v1.1.1-fabric" = _yjjF7XXP;
        "pkg-1.18.2-v1.1.1-forge" = _KJJXF0JV;
        "pkg-1.18.2-v1.1.1-fabric" = _2SGYzIr0;
        "pkg-1.19.x-v1.1.1-forge" = _42zCzC8e;
        "pkg-1.19.x-v1.1.1-fabric" = _v4hDp1AI;
        "pkg-1.16.5-v1.1.1-fabric" = _87ubwU9w;
        "pkg-1.16.5-v1.1.1-forge" = _4Znbj0O3;
        "pkg-1.19.3-v1.1.2-fabric" = _Lay51Q06;
        "pkg-1.19.3-v1.1.2-forge" = _JilM7wch;
        "pkg-1.19.4-v1.1.2-fabric" = _gfRR5bCd;
        "pkg-1.19.4-v1.1.2-forge" = _aGCAfiVy;
        "pkg-1.19.3-v1.1.3-fabric" = _9zWyvzVI;
        "pkg-1.19.3-v1.1.3-forge" = _fySnLPQI;
        "pkg-1.19.4-v1.1.3-fabric" = _s0mEu4JE;
        "pkg-1.19.4-v1.1.3-forge" = _fGEIgLqb;
        "pkg-1.19.3-v1.1.4-forge" = _h5DEOSTK;
        "pkg-1.19.4-v1.1.4-forge" = _ukdmCvQN;
        "pkg-1.16.5-v1.2-fabric" = _S9iF1dgO;
        "pkg-1.16.5-v1.2-forge" = _m9x4slKu;
        "pkg-1.17.1-v1.2-fabric" = _WfpNgJe0;
        "pkg-1.17.1-v1.2-forge" = _53GaDmIk;
        "pkg-1.18.1-v1.2-fabric" = _zRXeyJYv;
        "pkg-1.18.1-v1.2-forge" = _967kUUVV;
        "pkg-1.18.2-v1.2-fabric" = _vvDJPo5G;
        "pkg-1.18.2-v1.2-forge" = _SqluBS3W;
        "pkg-1.19.x-v1.2-fabric" = _z1ytTctY;
        "pkg-1.19.x-v1.2-forge" = _SAFc02Mo;
        "pkg-1.19.3-v1.2-fabric" = _uTCVLKZs;
        "pkg-1.19.3-v1.2-forge" = _K41W7a6M;
        "pkg-1.19.4-v1.2-fabric" = _gqZSUKCF;
        "pkg-1.19.4-v1.2-forge" = _v0AFn99s;
        "pkg-1.20.1-v1.2-fabric" = _oJWAOGbw;
        "pkg-1.20.1-v1.2-forge" = _m3Vpfk4i;
        "pkg-1.20.2-v1.2-fabric" = _z7KNfU3n;
        "pkg-1.20.2-v1.2-forge" = _7bR1hMaa;
        "pkg-1.16.5-v1.2.1-forge" = _AbxMsDWJ;
        "pkg-1.16.5-v1.2.1-fabric" = _bnI43EGw;
        "pkg-1.17.1-v1.2.1-forge" = _zRRVG4xE;
        "pkg-1.17.1-v1.2.1-fabric" = _hRWEqNvT;
        "pkg-1.18.1-v1.2.1-forge" = _NeVpbpOj;
        "pkg-1.18.1-v1.2.1-fabric" = _noPTfHpW;
        "pkg-1.18.2-v1.2.1-forge" = _h8m4zvj1;
        "pkg-1.18.2-v1.2.1-fabric" = _UtRaDX8d;
        "pkg-1.19.x-v1.2.1-forge" = _GmNrVttR;
        "pkg-1.19.x-v1.2.1-fabric" = _5IS1nI23;
        "pkg-1.19.3-v1.2.1-forge" = _3s0y7pwX;
        "pkg-1.19.4-v1.2.1-forge" = _9wFgyIkH;
        "pkg-1.19.4-v1.2.1-fabric" = _a8t8K7Kq;
        "pkg-1.20.1-v1.2.1-forge" = _xVZBZ4ol;
        "pkg-1.20.1-v1.2.1-fabric" = _8INz2oX5;
        "pkg-1.20.2-v1.2.1-minecraftforge" = _mVzdeRKD;
        "pkg-1.20.2-v1.2.1-neoforge" = _a3XpXX9e;
        "pkg-1.20.2-v1.2.1-fabric" = _JU84Y28v;
        "pkg-1.20.4-v1.2.1-minecraftforge" = _j6FahFmd;
        "pkg-1.20.4-v1.2.1-neoforge" = _aNxqK3yl;
        "pkg-1.20.4-v1.2.1-fabric" = _N4InVRK9;
        "pkg-1.16.5-v1.3-fabric" = _SE4FJQh0;
        "pkg-1.16.5-v1.3-forge" = _hWarWUH9;
        "pkg-1.17.1-v1.3-fabric" = _tuUibYm9;
        "pkg-1.17.1-v1.3-forge" = _MqnN6aAC;
        "pkg-1.18.1-v1.3-fabric" = _jOreiLxg;
        "pkg-1.18.1-v1.3-forge" = _jhHxA9aX;
        "pkg-1.18.2-v1.3-fabric" = _C1CUoYwh;
        "pkg-1.18.2-v1.3-forge" = _oWwdVuXN;
        "pkg-1.19.x-v1.3-fabric" = _Z8Q3HK6w;
        "pkg-1.19.x-v1.3-forge" = _COvgtLXp;
        "pkg-1.19.3-v1.3-fabric" = _QTKBHzcN;
        "pkg-1.19.3-v1.3-forge" = _Pj1Ko1Xz;
        "pkg-1.19.4-v1.3-fabric" = _odYQhvEF;
        "pkg-1.19.4-v1.3-forge" = _K7VMA9CZ;
        "pkg-1.20.1-v1.3-fabric" = _E0I9zNUV;
        "pkg-1.20.1-v1.3-forge" = _pi4xWSjq;
        "pkg-1.20.2-v1.3-fabric" = _ZUTNHfAN;
        "pkg-1.20.2-v1.3-minecraftforge" = _93agUALG;
        "pkg-1.20.2-v1.3-neoforge" = _i8N1fBew;
        "pkg-1.20.4-v1.3-fabric" = _v84jo7Sl;
        "pkg-1.20.4-v1.3-minecraftforge" = _Oaza1iop;
        "pkg-1.20.4-v1.3-neoforge" = _utJIShce;
        "pkg-1.20.6-v1.3-fabric" = _apmunCsD;
        "pkg-1.20.6-v1.3-minecraftforge" = _OMEqwFBR;
        "pkg-1.20.6-v1.3-neoforge" = _AO0jVFzh;
        "pkg-1.21.1-v1.3-fabric" = _xLhhZ6WR;
        "pkg-1.21.1-v1.3-minecraftforge" = _hiyzBDUC;
        "pkg-1.21.1-v1.3-neoforge" = _ZpJGg54I;
        "pkg-1.21.3-v1.3-fabric" = _MQtjMEao;
        "pkg-1.21.3-v1.3-minecraftforge" = _XHu9ZWaR;
        "pkg-1.21.3-v1.3-neoforge" = _rdUapGEP;
        "pkg-1.21.4-v1.3-fabric" = _dLyeAJis;
        "pkg-1.21.4-v1.3-minecraftforge" = _6PHtISNL;
        "pkg-1.21.4-v1.3-neoforge" = _QXe0f2bF;
        "pkg-1.21.4-v1.3.1-neoforge" = _ZmTNGRth;
        "pkg-1.21.4-v1.3.1-minecraftforge" = _Bv8J3CCU;
        "pkg-1.21.4-v1.3.1-fabric" = _xjDp3bZx;
        "pkg-1.16.5-v1.4-minecraftforge" = _2vdwIZpF;
        "pkg-1.16.5-v1.4-fabric" = _h1RBk5cI;
        "pkg-1.17.1-v1.4-minecraftforge" = _MxWB5pvb;
        "pkg-1.17.1-v1.4-fabric" = _9zczoTcb;
        "pkg-1.18.1-v1.4-minecraftforge" = _EuyYUiqW;
        "pkg-1.18.1-v1.4-fabric" = _mI2iGjN0;
        "pkg-1.18.2-v1.4-minecraftforge" = _s8rNjz0o;
        "pkg-1.18.2-v1.4-fabric" = _qJilC8vH;
        "pkg-1.19.2-v1.4-minecraftforge" = _zqF8XrmS;
        "pkg-1.19.2-v1.4-fabric" = _RTG9fw61;
        "pkg-1.19.3-v1.4-minecraftforge" = _o1oz3za4;
        "pkg-1.19.3-v1.4-fabric" = _8cRsckkP;
        "pkg-1.19.4-v1.4-minecraftforge" = _SiAM0EYU;
        "pkg-1.19.4-v1.4-fabric" = _iumBMHQH;
        "pkg-1.20-v1.4-minecraftforge" = _AN5osy84;
        "pkg-1.20-v1.4-fabric" = _3yaui8HB;
        "pkg-1.20.4-v1.4-minecraftforge" = _r9TbCtA7;
        "pkg-1.20.4-v1.4-fabric" = _LwFkCr7s;
        "pkg-1.20.4-v1.4-neoforge" = _rBNbuxv7;
        "pkg-1.20.2-v1.4-minecraftforge" = _ihwrNGRW;
        "pkg-1.20.2-v1.4-fabric" = _xahIdwgj;
        "pkg-1.20.2-v1.4-neoforge" = _kOUN90EX;
        "pkg-1.20.6-v1.4-minecraftforge" = _ymPeWWYy;
        "pkg-1.21-v1.4-minecraftforge" = _eSDcIRK1;
        "pkg-1.20.6-v1.4-fabric" = _c3OPz2Rx;
        "pkg-1.21-v1.4-fabric" = _twplj2d5;
        "pkg-1.20.6-v1.4-neoforge" = _k8sKvQOm;
        "pkg-1.21-v1.4-neoforge" = _GaJ268ea;
        "pkg-1.21.4-v1.4-minecraftforge" = _pEAqwNUu;
        "pkg-1.21.4-v1.4-fabric" = _7H10Bqrb;
        "pkg-1.21.4-v1.4-neoforge" = _Ik3Y7XAn;
        "pkg-1.21.3-v1.4-minecraftforge" = _kMYJTyP5;
        "pkg-1.21.3-v1.4-fabric" = _sXOGbY9g;
        "pkg-1.21.3-v1.4-neoforge" = _rceLGVE3;
        "pkg-1.21-v1.4.1-minecraftforge" = _8Cs2jmNz;
        "pkg-1.21-v1.4.1-fabric" = _wdSNmQGh;
        "pkg-1.21-v1.4.1-neoforge" = _DOL5usg6;
        "pkg-1.16.5-v1.4.2-minecraftforge" = _qOxYwWdP;
        "pkg-1.16.5-v1.4.2-fabric" = _dXe7JAFV;
        "pkg-1.17.1-v1.4.2-minecraftforge" = _uLrNzzDi;
        "pkg-1.17.1-v1.4.2-fabric" = _KocumNuL;
        "pkg-1.18.1-v1.4.2-minecraftforge" = _8EMWUeBP;
        "pkg-1.18.1-v1.4.2-fabric" = _ZKtFGAsl;
        "pkg-1.18.2-v1.4.2-minecraftforge" = _ysiIlZow;
        "pkg-1.18.2-v1.4.2-fabric" = _ZszkvMMI;
        "pkg-1.19.2-v1.4.2-minecraftforge" = _FjBfPDRR;
        "pkg-1.19.2-v1.4.2-fabric" = _aCmHcQCQ;
        "pkg-1.19.3-v1.4.2-minecraftforge" = _9J5KwyTt;
        "pkg-1.19.3-v1.4.2-fabric" = _g2hUONVY;
        "pkg-1.19.4-v1.4.2-minecraftforge" = _78wGe6JA;
        "pkg-1.20-v1.4.2-minecraftforge" = _cCr5h4KB;
        "pkg-1.19.4-v1.4.2-fabric" = _m0TnOyrA;
        "pkg-1.20-v1.4.2-fabric" = _JvzO4olj;
        "pkg-1.20.4-v1.4.2-minecraftforge" = _Tm743O9M;
        "pkg-1.20.4-v1.4.2-fabric" = _s62GCmSh;
        "pkg-1.20.2-v1.4.2-minecraftforge" = _AMSWc3dg;
        "pkg-1.20.4-v1.4.2-neoforge" = _PTbAJsVB;
        "pkg-1.20.2-v1.4.2-fabric" = _UhRddeze;
        "pkg-1.20.2-v1.4.2-neoforge" = _Aotd2HF8;
        "pkg-1.20.6-v1.4.2-minecraftforge" = _cBf0l0CX;
        "pkg-1.20.6-v1.4.2-fabric" = _LFN7Bb8m;
        "pkg-1.20.6-v1.4.2-neoforge" = _veyUBxs7;
        "pkg-1.21.3-v1.4.2-minecraftforge" = _CumV5rnO;
        "pkg-1.21.4-v1.4.2-minecraftforge" = _X8ulFMzK;
        "pkg-1.21.3-v1.4.2-fabric" = _dH9YHCOf;
        "pkg-1.21.4-v1.4.2-fabric" = _3ksIPiI7;
        "pkg-1.21.3-v1.4.2-neoforge" = _HEpV5bRp;
        "pkg-1.21.4-v1.4.2-neoforge" = _ZjuknRR8;
        "pkg-1.21-v1.4.2-minecraftforge" = _ZQkuulRY;
        "pkg-1.21-v1.4.2-fabric" = _Y8wCxRSb;
        "pkg-1.21-v1.4.2-neoforge" = _xGt9CPTS;
        "pkg-1.21-v1.4.3-minecraftforge" = _oGslTiv7;
        "pkg-1.21-v1.4.3-fabric" = _qh3D1rjU;
        "pkg-1.21-v1.4.3-neoforge" = _oyT0Ztjt;
        "pkg-1.17.1-v1.4.4-minecraftforge" = _nzMiTeMO;
        "pkg-1.17.1-v1.4.4-fabric" = _U3H7vT7n;
        "pkg-1.16.5-v1.4.4-minecraftforge" = _Cjp9qOPH;
        "pkg-1.16.5-v1.4.4-fabric" = _akokuRVh;
        "pkg-1.18.1-v1.4.4-minecraftforge" = _2LbSx3xH;
        "pkg-1.18.1-v1.4.4-fabric" = _jMbbtfVh;
        "pkg-1.19.3-v1.4.4-minecraftforge" = _kmXvaqVB;
        "pkg-1.19.3-v1.4.4-fabric" = _yp5xDxtE;
        "pkg-1.20-v1.4.4-minecraftforge" = _6gh4O0eI;
        "pkg-1.20-v1.4.4-fabric" = _Fbn1VrCm;
        "pkg-1.18.2-v1.4.4-minecraftforge" = _mhZxTj3F;
        "pkg-1.18.2-v1.4.4-fabric" = _mdnlPg8J;
        "pkg-1.19.2-v1.4.4-minecraftforge" = _vY0dcUtF;
        "pkg-1.19.4-v1.4.4-minecraftforge" = _XvY0Miu2;
        "pkg-1.19.2-v1.4.4-fabric" = _g2nR6tqC;
        "pkg-1.19.4-v1.4.4-fabric" = _WrlpE5JR;
        "pkg-1.21-v1.4.4-minecraftforge" = _ec9ijcaw;
        "pkg-1.21.3-v1.4.4-minecraftforge" = _vGwUKlxn;
        "pkg-1.21-v1.4.4-fabric" = _3HoQhnBR;
        "pkg-1.21.3-v1.4.4-fabric" = _7kON1Yp1;
        "pkg-1.21-v1.4.4-neoforge" = _U9HjuVCQ;
        "pkg-1.21.3-v1.4.4-neoforge" = _2367qIwW;
        "pkg-1.21.4-v1.4.4-minecraftforge" = _bgxlhq2A;
        "pkg-1.21.5-v1.4.4-minecraftforge" = _LPJ5q2op;
        "pkg-1.21.8-v1.4.4-minecraftforge" = _Rnzma2Ef;
        "pkg-1.21.4-v1.4.4-fabric" = _epq47Mpf;
        "pkg-1.21.5-v1.4.4-fabric" = _3gIlaei3;
        "pkg-1.21.8-v1.4.4-fabric" = _kFfiBmg2;
        "pkg-1.21.4-v1.4.4-neoforge" = _jE6pG4lz;
        "pkg-1.21.5-v1.4.4-neoforge" = _iI6NDy0C;
        "pkg-1.21.8-v1.4.4-neoforge" = _BLGEoU3y;
        "pkg-1.20.4-v1.4.4-minecraftforge" = _CwupWbgF;
        "pkg-1.20.4-v1.4.4-fabric" = _kH3TdDSq;
        "pkg-1.20.6-v1.4.4-minecraftforge" = _pmsehbM9;
        "pkg-1.20.4-v1.4.4-neoforge" = _dG56ct6J;
        "pkg-1.20.2-v1.4.4-minecraftforge" = _aAcyOlsf;
        "pkg-1.20.6-v1.4.4-fabric" = _mKoClw82;
