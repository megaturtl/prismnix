...
let
    versions = (let
        ...
        _NJ8yat4P = {
            "id" = "NJ8yat4P";
            "file" = "Epic Villages 2.0.0.zip";
            "hash" = "sha512-FzJbVYKXFSM42SuVfUJAiuf1Ux9k7ToyLMvdzIibOpSmD6rPdGwj3a+yxXFtiPlsTwRNKoQ7ueOL/Ii3ikTviw==";
        };
        _hCRa4eFr = {
            "id" = "hCRa4eFr";
            "file" = "epic-structures-villages-2.0.0.jar";
            "hash" = "sha512-8cn5B7Y+ZE0RBrYUgKRYwGvGhSeiJ4sEB6mL+/r74+bz/Re/VrDHqu3Wm/CFx26GeXFeeTf0G947cqUMHC4XiQ==";
        };
    in {
        "ile7E6i0" = _ile7E6i0;
        "vyCvgPyZ" = _vyCvgPyZ;
        ...
        "NJ8yat4P" = _NJ8yat4P;
        "hCRa4eFr" = _hCRa4eFr;
        "datapack-1.21" = _NJ8yat4P;
        "datapack-1.21.1" = _NJ8yat4P;
        "datapack-1.21.2" = _NJ8yat4P;
        "datapack-1.21.3" = _NJ8yat4P;
        "datapack-1.21.4" = _NJ8yat4P;
        "datapack-1.21.5" = _NJ8yat4P;
        "datapack-1.21.6" = _NJ8yat4P;
        "datapack-1.21.7" = _NJ8yat4P;
        "datapack-1.21.8" = _NJ8yat4P;
        "datapack-1.19" = _NJ8yat4P;
        "datapack-1.19.1" = _NJ8yat4P;
        "datapack-1.19.2" = _NJ8yat4P;
        "datapack-1.19.3" = _NJ8yat4P;
        "datapack-1.19.4" = _NJ8yat4P;
        "datapack-1.20" = _NJ8yat4P;
        "datapack-1.20.1" = _NJ8yat4P;
        "datapack-1.20.2" = _NJ8yat4P;
        "datapack-1.20.3" = _NJ8yat4P;
        "datapack-1.20.4" = _NJ8yat4P;
        "datapack-1.20.5" = _ZrDfS4iz;
        "datapack-1.20.6" = _ZrDfS4iz;
        "datapack-1.21.9" = _NJ8yat4P;
        "datapack-1.21.10" = _NJ8yat4P;
        "datapack-1.21.11" = _NJ8yat4P;
        "datapack-26.1" = _NJ8yat4P;
        ...
        "fabric-1.21.3" = _hCRa4eFr;
        "fabric-1.21.4" = _hCRa4eFr;
        "fabric-1.21.5" = _hCRa4eFr;
        "fabric-1.21.6" = _hCRa4eFr;
        "fabric-1.21.7" = _hCRa4eFr;
        "fabric-1.21.8" = _hCRa4eFr;
        "fabric-1.19" = _hCRa4eFr;
        "fabric-1.19.1" = _hCRa4eFr;
        "fabric-1.19.2" = _hCRa4eFr;
        "fabric-1.19.3" = _hCRa4eFr;
        "fabric-1.19.4" = _hCRa4eFr;
        "fabric-1.20" = _hCRa4eFr;
        "fabric-1.20.1" = _hCRa4eFr;
        "fabric-1.20.2" = _hCRa4eFr;
        "fabric-1.20.3" = _hCRa4eFr;
        "fabric-1.20.4" = _hCRa4eFr;
        "fabric-1.20.5" = _ZooRt1FQ;
        "fabric-1.20.6" = _ZooRt1FQ;
        "fabric-1.21.9" = _hCRa4eFr;
        "fabric-1.21.10" = _hCRa4eFr;
        "fabric-1.21.11" = _hCRa4eFr;
        "fabric-26.1" = _hCRa4eFr;
        ...
        "forge-1.21.3" = _hCRa4eFr;
        "forge-1.21.4" = _hCRa4eFr;
        "forge-1.21.5" = _hCRa4eFr;
        "forge-1.21.6" = _hCRa4eFr;
        "forge-1.21.7" = _hCRa4eFr;
        "forge-1.21.8" = _hCRa4eFr;
        "forge-1.19" = _hCRa4eFr;
        "forge-1.19.1" = _hCRa4eFr;
        "forge-1.19.2" = _hCRa4eFr;
        "forge-1.19.3" = _hCRa4eFr;
        "forge-1.19.4" = _hCRa4eFr;
        "forge-1.20" = _hCRa4eFr;
        "forge-1.20.1" = _hCRa4eFr;
        "forge-1.20.2" = _hCRa4eFr;
        "forge-1.20.3" = _hCRa4eFr;
        "forge-1.20.4" = _hCRa4eFr;
        "forge-1.20.5" = _ZooRt1FQ;
        "forge-1.20.6" = _ZooRt1FQ;
        "forge-1.21.9" = _hCRa4eFr;
        "forge-1.21.10" = _hCRa4eFr;
        "forge-1.21.11" = _hCRa4eFr;
        "forge-26.1" = _hCRa4eFr;
        ...
        "neoforge-1.21.3" = _hCRa4eFr;
        "neoforge-1.21.4" = _hCRa4eFr;
        "neoforge-1.21.5" = _hCRa4eFr;
        "neoforge-1.21.6" = _hCRa4eFr;
        "neoforge-1.21.7" = _hCRa4eFr;
        "neoforge-1.21.8" = _hCRa4eFr;
        "neoforge-1.19" = _hCRa4eFr;
        "neoforge-1.19.1" = _hCRa4eFr;
        "neoforge-1.19.2" = _hCRa4eFr;
        "neoforge-1.19.3" = _hCRa4eFr;
        "neoforge-1.19.4" = _hCRa4eFr;
        "neoforge-1.20" = _hCRa4eFr;
        "neoforge-1.20.1" = _hCRa4eFr;
        "neoforge-1.20.2" = _hCRa4eFr;
        "neoforge-1.20.3" = _hCRa4eFr;
        "neoforge-1.20.4" = _hCRa4eFr;
        "neoforge-1.20.5" = _ZooRt1FQ;
        "neoforge-1.20.6" = _ZooRt1FQ;
        "neoforge-1.21.9" = _hCRa4eFr;
        "neoforge-1.21.10" = _hCRa4eFr;
        "neoforge-1.21.11" = _hCRa4eFr;
        "neoforge-26.1" = _hCRa4eFr;
        ...
        "quilt-1.21.3" = _hCRa4eFr;
        "quilt-1.21.4" = _hCRa4eFr;
        "quilt-1.21.5" = _hCRa4eFr;
        "quilt-1.21.6" = _hCRa4eFr;
        "quilt-1.21.7" = _hCRa4eFr;
        "quilt-1.21.8" = _hCRa4eFr;
        "quilt-1.19" = _hCRa4eFr;
        "quilt-1.19.1" = _hCRa4eFr;
        "quilt-1.19.2" = _hCRa4eFr;
        "quilt-1.19.3" = _hCRa4eFr;
        "quilt-1.19.4" = _hCRa4eFr;
        "quilt-1.20" = _hCRa4eFr;
        "quilt-1.20.1" = _hCRa4eFr;
        "quilt-1.20.2" = _hCRa4eFr;
        "quilt-1.20.3" = _hCRa4eFr;
        "quilt-1.20.4" = _hCRa4eFr;
        "quilt-1.20.5" = _ZooRt1FQ;
        "quilt-1.20.6" = _ZooRt1FQ;
        "quilt-1.21.9" = _hCRa4eFr;
        "quilt-1.21.10" = _hCRa4eFr;
        "quilt-1.21.11" = _hCRa4eFr;
        "quilt-26.1" = _hCRa4eFr;
