...
let
    versions = (let
        ...
        _m6vw9Wa3 = {
            "id" = "m6vw9Wa3";
            "file" = "OPItems.jar";
            "hash" = "sha512-bbDqNuQDI293IUz174WqrALVeij5MyStyFueeHqH/DjEpE9u1JW6tOfN1uU4dRVYbi2zJ1MVPM+7KRHpLlf73w==";
        };
    in {
        "mVog6XrI" = _mVog6XrI;
        "hLMJAEpr" = _hLMJAEpr;
        ...
        "paper-1.20.6" = _m6vw9Wa3;
        "paper-1.21" = _m6vw9Wa3;
        "paper-1.21.1" = _m6vw9Wa3;
        "paper-1.21.2" = _m6vw9Wa3;
        "paper-1.21.3" = _m6vw9Wa3;
        "paper-1.21.4" = _m6vw9Wa3;
        "paper-1.21.5" = _m6vw9Wa3;
        "paper-1.21.6" = _m6vw9Wa3;
        "paper-1.21.7" = _m6vw9Wa3;
        "paper-1.21.8" = _m6vw9Wa3;
        "paper-1.21.9" = _m6vw9Wa3;
        "paper-1.21.10" = _m6vw9Wa3;
        "paper-1.21.11" = _m6vw9Wa3;
        "paper-26.1" = _m6vw9Wa3;
        ...
        "purpur-1.20.6" = _m6vw9Wa3;
        "purpur-1.21" = _m6vw9Wa3;
        "purpur-1.21.1" = _m6vw9Wa3;
        "purpur-1.21.2" = _m6vw9Wa3;
        "purpur-1.21.3" = _m6vw9Wa3;
        "purpur-1.21.4" = _m6vw9Wa3;
        "purpur-1.21.5" = _m6vw9Wa3;
        "purpur-1.21.6" = _m6vw9Wa3;
        "purpur-1.21.7" = _m6vw9Wa3;
        "purpur-1.21.8" = _m6vw9Wa3;
        "purpur-1.21.9" = _m6vw9Wa3;
        "purpur-1.21.10" = _m6vw9Wa3;
        "purpur-1.21.11" = _m6vw9Wa3;
        "purpur-26.1" = _m6vw9Wa3;
        ...
        "pkg-1.9.7" = _ICv0nv8b;
        "pkg-1.9.8" = _J93uRQ0t;
        "pkg-1.9.10" = _LWFVobpb;
        "pkg-1.9.11" = _yr0oLNq4;
        "pkg-1.9.12" = _q9wccneS;
        "pkg-1.9.13" = _VF6P3g0u;
        "pkg-1.9.14" = _ccATc3HQ;
        "pkg-1.10.0" = _zmfa9DTx;
        "pkg-1.10.1" = _j0Evz8Hj;
        "pkg-1.10.2" = _nzMophCN;
        "pkg-1.10.3" = _WBdv1O5j;
        "pkg-1.11.0" = _1XbzTREt;
        "pkg-1.11.1" = _dxOlbU9b;
        "pkg-1.11.2" = _nyfwJBqd;
        "pkg-1.12.0" = _2S0WcvoQ;
        "pkg-1.12.1" = _O5Sw1je9;
        "pkg-1.12.2" = _m6vw9Wa3;
        "default" = _m6vw9Wa3;
    });
