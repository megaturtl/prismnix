...
let
    ...
    in {
        ...
        "pkg-0.8" = _tjy6ixQK;
        "pkg-0.8.1" = _uxzBTPkG;
        "pkg-0.8.2-alpha" = _hDmK5e3u;
        "pkg-0.8.2-beta.1" = _7j6dxksL;
        "pkg-0.8.2" = _Fy9H3TUl;
        "pkg-0.8.3" = _bD6V1hdK;
        "pkg-0.8.4" = _TN1rkaME;
        "pkg-0.8.5" = _4MZCLvG4;
        "pkg-0.4.1-patch.1" = _d60OZdqy;
        "pkg-0.9" = _vBorCBGT;
        "pkg-0.9.1" = _upV2WiyX;
        "pkg-0.9.2+26.1-snapshot-4-fabric" = _7EB5VVZX;
        "pkg-0.9.3+26.1-snapshot-6-fabric" = _Q8uZqdwQ;
        "pkg-0.9.4+26.1-snapshot-6-fabric" = _UZG525lt;
        "pkg-0.9.5+26.1-fabric" = _uUlAZ0Od;
        "pkg-0.9.5+26.1-neoforge" = _QPuXcRwJ;
        "pkg-0.10.0-alpha.1+26.1.2-fabric" = _Vu5Bl3eb;
        "pkg-0.10.0-alpha.1+26.1.2-neoforge" = _qmpuMtcX;
        "pkg-0.10.0-alpha.1+26.2-fabric" = _ME6dww5f;
        "pkg-0.10.0-alpha.1+26.2-neoforge" = _PanbIfdQ;
        "pkg-0.10.0-alpha.2+26.1.2-fabric" = _fqXje2lK;
        "pkg-0.10.0-alpha.2+26.1.2-neoforge" = _j89g93rC;
        "pkg-0.10.0-alpha.2+26.2-fabric" = _3PXSQMVq;
        "pkg-0.10.0-alpha.2+26.2-neoforge" = _JrcjDDfW;
        "pkg-0.10.0+26.1.2-fabric" = _8Fjjeppf;
        "pkg-0.10.0+26.1.2-neoforge" = _FsDd2XCL;
        "pkg-0.10.0+26.2-fabric" = _YDcTOWSB;
        "pkg-0.10.0+26.2-neoforge" = _MCXwfZZQ;
        "pkg-0.10.1+26.1.2-fabric" = _QlP8B8ck;
