...
let
    ...
    in {
        ...
        "pkg-1.2.7" = _oQV9WZJ1;
        "pkg-1.2.8" = _TRzYn9aH;
        "pkg-1.2.9-1.18.1" = _7UHKWvv3;
        "pkg-1.2.10-1.18.1-midgame11" = _KcbdJjxw;
        "pkg-1.2.15" = _HYBdfvhk;
        "pkg-1.3.0" = _k3XzTMVx;
        "pkg-1.4.0" = _3qqBqjBj;
        "pkg-1.4.1" = _zXPQnRo0;
        "pkg-1.4.2" = _vyHMKxIV;
        ...
        "pkg-1.5.1" = _k0K0JzBp;
        "pkg-1.5.2" = _mnXppCd1;
        "pkg-1.5.2+1.19.2" = _XBfvgCFi;
        "pkg-1.5.4+1.19.2" = _rgiAlQAJ;
        "pkg-1.5.5+1.19.2" = _bN2tz9uB;
        "pkg-1.5.7+1.18.2" = _kTZb0MBv;
        "pkg-1.5.7+1.19.2" = _ZJGInuxk;
        "pkg-1.6.0" = _yzQgJDP7;
        "pkg-1.6.1" = _Q7L9W1Nm;
        "pkg-1.6.2" = _ZMbGtCqa;
        "pkg-1.6.3" = _YFmcNhOm;
        "pkg-1.6.4" = _NhZzxblZ;
        "pkg-1.6.5-1.19.2" = _661zun2v;
        "pkg-1.6.6-1.19.2" = _JgDlcik2;
        "pkg-1.6.7-1.19.2-leisure_time" = _SvMfw2KW;
        "pkg-1.6.8-1.19.2-leisure_time" = _YLaZv5Fa;
        "pkg-1.6.9-1.19.2-leisure_time" = _oPBO8nIY;
        "pkg-1.6.9-1.18.2-leisure_time" = _7YmKE57s;
        "pkg-1.6.10-1.19.2-leisure_time" = _3GcJXR2g;
        "pkg-1.7.0-deeper-down-alpha10" = _K4abiaUH;
        "pkg-1.7.0-deeper-down-alpha11" = _FWOzYQav;
        "pkg-1.7.0-deeper-down-alpha13" = _JacTBYNp;
        "pkg-1.7.0-deeper-down-alpha14" = _ehboAjd6;
        "pkg-1.7.0-deeper-down-alpha15" = _A27RP4E7;
        "pkg-1.6.11-1.19.2-leisure_time" = _A8YLB9vX;
        "pkg-1.7.0" = _5O9OsRUh;
        "pkg-1.6.12-1.19.2-leisure_time" = _IqR6iuSS;
        "pkg-1.7.1" = _2CN6Qj4S;
        "pkg-1.7.2" = _E2ivC8mh;
        "pkg-1.7.3" = _TW6h8GJ1;
        "pkg-1.7.4" = _Pg5efHEv;
        ...
        "pkg-1.7.8" = _5BpbBBgv;
        "pkg-1.7.9" = _kA4X49XL;
        "pkg-1.7.10" = _WRy5rVCt;
        "pkg-1.7.11" = _bkeScaQT;
        "pkg-1.7.12" = _cZcvzTh4;
        "pkg-1.7.13" = _W5hqOrTM;
        "pkg-1.7.14" = _IPJtxgRC;
        "pkg-1.7.15" = _gz6VKRql;
        "pkg-1.8.0-alpha1" = _RH5XEpHw;
        "pkg-1.7.16" = _8Ri3sl6F;
        "pkg-1.8.0-alpha2" = _BzQA6KhA;
        "pkg-1.8.0-alpha3" = _5jm0Ug3h;
        "pkg-1.8.0-alpha4" = _nFBZyU2U;
        "pkg-1.8.0" = _AYY5Cckg;
        "pkg-1.8.1" = _hI7YxxcZ;
        "pkg-1.8.2" = _lXBai2l4;
        "pkg-1.8.3" = _uaqSt7Ze;
        ...
        "pkg-1.8.8" = _LISEhPJH;
        "pkg-1.8.9" = _kr5nzyJP;
        "pkg-1.10.0" = _a8mQtcOJ;
        "pkg-1.8.10" = _UgZrCtKP;
        "pkg-1.10.1" = _euqc2mSn;
        "pkg-1.10.2" = _EhmjHQFq;
        "pkg-1.8.11" = _XUbJjzng;
        "pkg-1.8.12" = _AOD8GFlh;
        "pkg-1.9.0-1.21.1-neo" = _3GhWtvGt;
        "pkg-1.9.1-1.21.1-neo" = _r1OHf3PH;
        "pkg-1.9.2-1.21.1-neo" = _vbGJdzml;
        "pkg-1.9.3-1.21.1-neo" = _D6CPeFDb;
        "pkg-1.8.13" = _mDJAjTuc;
        "pkg-1.11.0-1.21.1-neo" = _iAeLc8SJ;
        "pkg-1.11.1-1.21.1-neo" = _p2DjIm0N;
        "pkg-1.10.4-1.21.1-fabric" = _rjQtgDKT;
        "pkg-1.11.2-1.21.1-neo" = _LSuF5NfC;
        "pkg-1.11.3-1.21.1-neo" = _k1IF73LQ;
        "pkg-1.11.4-1.21.1-neo" = _iUIMnMbo;
        "pkg-1.11.6-1.21.1-neo" = _T32MtgeB;
