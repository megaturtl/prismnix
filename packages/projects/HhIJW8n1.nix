...
let
    ...
    in {
        ...
        "pkg-2.0.1" = _Hd3WJWEm;
        "pkg-3.0.0" = _VrMqkD2O;
        "pkg-3.0.0+1.20.1" = _conpMIZf;
        "pkg-3.0.1+1.20.1" = _ZVsWk2AQ;
        "pkg-3.0.2+1.18.2" = _yo4LDRdP;
        "pkg-3.0.2+1.19.2" = _wKCEW46K;
        "pkg-3.0.2+1.20.1" = _H3CObYgy;
        "pkg-3.0.3+1.18.2" = _v9kIUa69;
        "pkg-3.0.3+1.19.2" = _9G9RyFd6;
        "pkg-3.0.3+1.20.1" = _h0aqwKbo;
        "pkg-3.0.4+1.20.1" = _JTf9Uidx;
        "pkg-4.0.0-alpha.1-fabric" = _MtyEKoKC;
        "pkg-4.0.0-alpha.1-forge" = _i27JcO06;
        "pkg-4.0.0-alpha.2-fabric" = _gyzHbM9v;
        "pkg-4.0.0-alpha.2-forge" = _iXEW6lCD;
        "pkg-4.0.0-alpha.3-fabric" = _qsfUuysV;
        "pkg-4.0.0-alpha.3-forge" = _V8sE2haO;
        "pkg-4.0.0-alpha.4-fabric" = _CiOUJSAf;
        "pkg-4.0.0-alpha.4-forge" = _xylycDIk;
        "pkg-4.0.0-fabric" = _WUkX6RzC;
        "pkg-4.0.0-forge" = _7TUvfgjk;
        "pkg-4.0.1-fabric" = _ElfsjoE3;
        "pkg-4.0.1-forge" = _R2CZa3ZF;
        "pkg-4.0.2-forge" = _dWl5Km4H;
        "pkg-4.0.2-fabric" = _goCaR7X9;
        "pkg-4.0.3" = _aAVqmomR;
        "pkg-4.0.4" = _ws8qtjTI;
        "pkg-4.0.5-forge" = _XPptgOfy;
        "pkg-4.0.5-fabric" = _w7bGma3s;
        "pkg-4.0.5+1.19.2-forge" = _L7MMcOEv;
        "pkg-4.0.5+1.19.2-fabric" = _FItJ0wEy;
        "pkg-4.0.6+1.20.1-forge" = _ZTGE4BW7;
        "pkg-4.0.6+1.20.1-fabric" = _67ir8Rbq;
        "pkg-4.0.6+1.19.2-fabric" = _lpiWX3RS;
        "pkg-4.0.6+1.19.2-forge" = _i1JQiNRf;
        "pkg-4.1.0+1.20.1-fabric" = _dirYsSEz;
        "pkg-4.1.0+1.20.1-forge" = _NfspI6vP;
        "pkg-4.1.0+1.19.2-forge" = _Fum50x3H;
        "pkg-4.1.0+1.19.2-fabric" = _2USJJpaU;
        "pkg-4.2.0+1.20.1-fabric" = _MFmixfal;
        "pkg-4.2.0+1.20.1-forge" = _oBUpVu6Q;
        "pkg-4.2.1+1.20.1-fabric" = _lMNW2Jq5;
        "pkg-4.2.1+1.20.1-forge" = _lF3WdqGp;
        "pkg-4.2.2+1.20.1-fabric" = _HRuUMq7Y;
        "pkg-4.2.2+1.20.1-forge" = _c9J5zXAQ;
        "pkg-4.2.3+1.20.1-fabric" = _D2fDvPvC;
        "pkg-4.2.3+1.20.1-forge" = _R0Xo2Jgw;
        "pkg-4.2.4+1.20.1-forge" = _linMEaC2;
        "pkg-4.2.4+1.20.1-fabric" = _qVT2ABwJ;
        "pkg-4.2.5+1.20.1-fabric" = _YOr5738F;
        "pkg-4.2.5+1.20.1-forge" = _Euehofvq;
        "pkg-4.2.6+1.20.1-fabric" = _t5mwAE37;
        "pkg-4.2.6+1.20.1-forge" = _NzIAcWG2;
        "pkg-4.2.7+1.20.1-fabric" = _Fbz77g1I;
        "pkg-4.2.7+1.20.1-forge" = _u2QpfJ2b;
        "pkg-4.1.0+1.18.2-fabric" = _4zTNCX2c;
        "pkg-4.2.8+1.20.1-fabric" = _yZqWGmdK;
        "pkg-4.2.8+1.20.1-forge" = _Mza9hyj6;
        "pkg-4.2.9+1.20.1-fabric" = _aJqveBxn;
        "pkg-4.2.9+1.20.1-forge" = _FpqUqPE5;
        "pkg-4.2.10+1.20.1-fabric" = _o7yAKWiG;
        "pkg-4.2.10+1.20.1-forge" = _Qq8V7UXD;
        "pkg-4.1.1+1.19.2-fabric" = _GJN8ZhKs;
        "pkg-4.1.1+1.19.2-forge" = _egocrArd;
        "pkg-4.3.0+1.20.1-fabric" = _zMRp7AEJ;
        "pkg-4.3.0+1.20.1-forge" = _LLkuQIBV;
        "pkg-4.3.1+1.20.1-forge" = _9xcyrA02;
        "pkg-4.3.1+1.20.1-fabric" = _PiahYau4;
        "pkg-4.3.2+1.20.1-forge" = _kx1pkxTk;
        "pkg-4.3.2+1.20.1-fabric" = _8X8vv8S6;
        "pkg-4.3.3+1.20.1-forge" = _26W88XQu;
        "pkg-4.3.3+1.20.1-fabric" = _UFjPcudt;
        "pkg-4.3.3b+1.20.1-forge" = _avKmOOg9;
        "pkg-4.3.3b+1.20.1-fabric" = _6p1dscxa;
        "pkg-4.3.4+1.20.1-forge" = _z4yGaF0O;
        "pkg-4.3.4+1.20.1-fabric" = _MCFB20q2;
        "pkg-5.0.0+1.20.1-forge" = _oxt46Sdk;
        "pkg-5.0.0+1.20.1-fabric" = _N63uWhDl;
        "pkg-5.0.1+1.20.1-forge" = _JCJxBnHu;
        "pkg-5.0.1+1.20.1-fabric" = _f5ZeBRAy;
        "pkg-5.0.4+1.20.1-forge" = _DPZtyPwg;
        "pkg-5.0.4+1.20.1-fabric" = _dpTstnRo;
        "pkg-5.0.5+1.20.1-fabric" = _2J7DuoD3;
        "pkg-5.0.5+1.20.1-forge" = _OVE7wgtI;
        "pkg-5.0.6+1.20.1-forge" = _V2so5N4d;
        "pkg-5.0.6+1.20.1-fabric" = _65qpanZi;
        "pkg-5.0.7+1.20.1-fabric" = _KscoJFeb;
