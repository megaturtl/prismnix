...
let
    ...
    in {
        ...
        "pkg-1.4.8" = _Wt0gvihd;
        "pkg-1.4.9" = _sNkjpkCf;
        "pkg-1.4.10" = _4TaX2Tva;
        "pkg-1.4.11" = _yKwoTaT7;
        "pkg-1.4.12" = _z3RZbwZc;
        "pkg-1.4.13" = _FrycFrhb;
        "pkg-1.4.14" = _3WQJT5yT;
        "pkg-1.4.15" = _zt1AXBzI;
        "pkg-1.4.16" = _paGjMkk2;
        "pkg-1.4.17" = _M878lbOl;
