...
let
    ...
    in {
        ...
        "pkg-1+mod" = _yiN1vsml;
        "pkg-b2" = _jL5JZYhM;
        "pkg-b2+mod" = _hmABhIBS;
        "pkg-1.1" = _r5qF87k8;
        "pkg-1.1+mod" = _u2drdtkA;
        "pkg-pre3" = _vIgxGhZA;
        "pkg-pre3+mod" = _XwrAIL6p;
        "pkg-1.0" = _2miNsQ5l;
        "pkg-1.0+mod" = _VC0EkKNQ;
        "pkg-1.2" = _HORCiUCM;
        "pkg-1.2+mod" = _ynZ76dD2;
        "pkg-1.3" = _1QUpsjQI;
        "pkg-1.3+mod" = _owlHepId;
        "pkg-1.3a" = _S8zDS38f;
        "pkg-1.3a+mod" = _n96Farcr;
        "pkg-1.4" = _DaCwavNj;
        "pkg-1.4+mod" = _wkgb8XP1;
        "pkg-1.4a" = _LHU0KUuW;
        "pkg-1.4a+mod" = _5KCD45aL;
        "pkg-1.4b" = _EEoPQw7Q;
        "pkg-1.4b+mod" = _yjdNOCZb;
        "pkg-1.5" = _OETjEiGS;
        "pkg-1.5+mod" = _Wudq2k0k;
        "pkg-v1.6" = _ZZ79DrCD;
        "pkg-v1.6+mod" = _LZQCBZUJ;
        "pkg-1.7" = _3oDHzXAT;
        "pkg-1.7+mod" = _6mRE7VI5;
        "pkg-1.7a" = _jk9wCY6A;
        "pkg-1.7a+mod" = _70dNCyGp;
        "pkg-1.7b" = _4Y4HkBjG;
        "pkg-1.7b+mod" = _GQ1HGJXt;
        "pkg-1.7c" = _CFECsE5V;
        "pkg-1.7c+mod" = _IkTyXvfd;
        "pkg-1.8" = _vs86ps9j;
        "pkg-1.8+mod" = _M16tR46G;
        "pkg-1.9" = _HwK4xP6Q;
        "pkg-1.9+mod" = _YAHCRjyV;
        "pkg-1.9a" = _5FlGi18M;
        "pkg-1.9a+mod" = _FzWKrepE;
        "pkg-1.9b" = _C15v0yPI;
        "pkg-1.9b+mod" = _3z0vAOsL;
        "pkg-2.0" = _1LihKIlc;
        "pkg-2.0+mod" = _lflcC5WE;
        "pkg-2.1" = _84W4bUSX;
        "pkg-2.1+mod" = _prdeCgx3;
        "pkg-2.2" = _J151oEbJ;
        "pkg-2.2+mod" = _tZZigHoz;
        "pkg-2.3" = _Ew6DZJ7b;
        "pkg-2.3+mod" = _3EBa8J6B;
        "pkg-2.4" = _e8UOxN4O;
        "pkg-2.4+mod" = _lLUPqGbj;
        "pkg-2.5" = _9prDwUds;
        "pkg-2.5+mod" = _1oSyBDay;
        "pkg-2.5.1" = _fDlkOBFj;
        "pkg-2.5.1+mod" = _f9prGn7k;
        "pkg-2.6" = _tOerbPUh;
        "pkg-2.6+mod" = _8nFepS09;
        "pkg-2.7" = _fR2hXWd2;
        "pkg-2.7+mod" = _g9hA35vU;
        "pkg-2.8" = _v6z6kwJx;
        "pkg-2.8+mod" = _KRB0DqlE;
        "pkg-v2.9" = _VQqhM50f;
        "pkg-v2.9+mod" = _9U7KucXx;
        "pkg-3.0" = _8JvQOX8b;
        "pkg-3.0+mod" = _P9bUK75e;
        "pkg-3.01" = _XKubl8Gz;
        "pkg-3.01+mod" = _RRV8xl1l;
        "pkg-3.02" = _Sx1ECCrR;
        "pkg-3.02+mod" = _OiiZ2sM7;
        "pkg-3.1" = _uUs8zz4g;
        "pkg-3.1+mod" = _n9LMiQUp;
        "pkg-3.2" = _rjjCS2nK;
        "pkg-3.2+mod" = _iZha3HbV;
        "pkg-3.3" = _PThFQm2x;
        "pkg-3.3+mod" = _HoVJYZyp;
        "pkg-3.3.1" = _zDOacwNW;
        "pkg-3.3.1+mod" = _ll3o5opc;
        "pkg-3.4" = _k9EF3FA3;
        "pkg-3.4+mod" = _q14trdX8;
        "pkg-3.5" = _8wd3lVHw;
