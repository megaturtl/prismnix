...
let
    versions = (let
        ...
        _vY4YJ5JA = {
            "id" = "vY4YJ5JA";
            "file" = "CraftableTotemOfUndying.zip";
            "hash" = "sha512-++X8WPp+NLebo3QjWqh1vmyz3lKXZ+ySXOgVB7DcU2HnlknKmX5knqOGvC9yJ2aGaDukRgwfb0kWBR0LMW+1nA==";
        };
    in {
        "HmhtuMrm" = _HmhtuMrm;
        "pRHk7fpV" = _pRHk7fpV;
        ...
        "datapack-1.19" = _vY4YJ5JA;
        "datapack-1.19.1" = _vY4YJ5JA;
        "datapack-1.19.2" = _vY4YJ5JA;
        "datapack-1.19.3" = _vY4YJ5JA;
        "datapack-1.19.4" = _vY4YJ5JA;
        "datapack-1.20" = _vY4YJ5JA;
        "datapack-1.20.1" = _vY4YJ5JA;
        "datapack-1.20.2" = _vY4YJ5JA;
        "datapack-1.18" = _vY4YJ5JA;
        "datapack-1.18.1" = _vY4YJ5JA;
        "datapack-1.18.2" = _vY4YJ5JA;
        "datapack-1.20.3" = _vY4YJ5JA;
        "datapack-1.20.4" = _vY4YJ5JA;
        "datapack-1.21.2" = _vY4YJ5JA;
        "datapack-1.21.3" = _vY4YJ5JA;
        "datapack-1.21.4" = _vY4YJ5JA;
        "datapack-1.21.5" = _vY4YJ5JA;
        "datapack-1.21.6" = _vY4YJ5JA;
        "datapack-1.21.7" = _vY4YJ5JA;
        "datapack-1.21.8" = _vY4YJ5JA;
        "datapack-1.20.5" = _vY4YJ5JA;
        "datapack-1.20.6" = _vY4YJ5JA;
        "datapack-1.21" = _vY4YJ5JA;
        "datapack-1.21.1" = _vY4YJ5JA;
        "datapack-1.21.9" = _vY4YJ5JA;
        "datapack-1.21.10" = _vY4YJ5JA;
        "datapack-1.21.11" = _vY4YJ5JA;
        "datapack-26.1" = _vY4YJ5JA;
        "datapack-26.1.1" = _vY4YJ5JA;
        "datapack-26.1.2" = _vY4YJ5JA;
        "datapack-26.2" = _vY4YJ5JA;
        ...
        "pkg-1.19-0.1" = _FtF1QXno;
        "pkg-1.19.1-0.1" = _N06Ya0Uk;
        "pkg-1.19.2-0.1" = _FlunYJAu;
        "pkg-1.19.3-0.1" = _M40HDidf;
        "pkg-1.19.4-0.1" = _7lMG8fwL;
        "pkg-1.20-0.1" = _HKGLUwHP;
        "pkg-1.20.1-0.1" = _3qB0QUGX;
        "pkg-1.20.2-0.1" = _EyOloJc5;
        "pkg-0.1" = _PjOvmlJz;
        "pkg-0.2" = _kxNrydiA;
        "pkg-1.20.3-0.1" = _mx3NAhOT;
        "pkg-1.20.4-0.1" = _3Hs0cH3Y;
        "pkg-1.20.6-0.1" = _HhZBMGlL;
        "pkg-1.21-0.1" = _YpAtbAlJ;
        "pkg-1.20.6-0.2" = _l4TNmgES;
        "pkg-1.21-0.3" = _HdPH9j66;
        "pkg-1.21.1-0.1" = _KiOZclD5;
        "pkg-1.21.3-0.1" = _3P1YsVNG;
        "pkg-1.21.4-0.1" = _ncUEICd3;
        "pkg-1.21.5-0.1" = _e7m59Vob;
        "pkg-1.21.5-0.2" = _GCYfzLIY;
        "pkg-1.21.6-0.1" = _QlVWKvj7;
        "pkg-1.21.7-0.1" = _KspV8ByS;
        "pkg-1.21.8-0.1" = _A9ENydoT;
        "pkg-1.21.9-0.1" = _sTDZSv9R;
        "pkg-1.21.10-0.1" = _qMnmZq8U;
        "pkg-1.21.11-0.1" = _j1tWx88z;
        "pkg-26.1-0.1" = _uKdYDfjR;
        "pkg-26.1.1-0.1" = _XtlyVdaQ;
        "pkg-26.1.2-0.1" = _LlGdSTs6;
        "pkg-0.3" = _3TsJpUmz;
        "pkg-26.2-0.1" = _id79sJcc;
        "pkg-0.4" = _vY4YJ5JA;
        "default" = _vY4YJ5JA;
    });
