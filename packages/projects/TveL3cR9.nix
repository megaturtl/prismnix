...
let
    versions = (let
        ...
        _fINh4F6z = {
            "id" = "fINh4F6z";
            "file" = "§d§lDifferent Double Slabs §r§73.2.zip";
            "hash" = "sha512-em5JFBHKdkyGnfvKKIlwZV3PLS7sCpqKhxNoAJQju5wx/nH3AEL6PfO2Ea9DFbPtzDuehfXy8bv4Z71MfGyjAA==";
        };
    in {
        "QV7tYbLo" = _QV7tYbLo;
        "VVuW0fU0" = _VVuW0fU0;
        ...
        "euHDNxn7" = _euHDNxn7;
        "fINh4F6z" = _fINh4F6z;
        "minecraft-1.19.3" = _fINh4F6z;
        "minecraft-1.19.4" = _fINh4F6z;
        "minecraft-1.20" = _fINh4F6z;
        "minecraft-1.20.1" = _fINh4F6z;
        "minecraft-1.20.2" = _fINh4F6z;
        "minecraft-1.20.3" = _fINh4F6z;
        "minecraft-1.20.4" = _fINh4F6z;
        "minecraft-1.20.5-rc2" = _XIvNTlxq;
        "minecraft-1.20.5" = _fINh4F6z;
        "minecraft-1.20.6" = _fINh4F6z;
        "minecraft-1.21" = _fINh4F6z;
        "minecraft-1.21.1" = _fINh4F6z;
        "minecraft-1.13" = _fINh4F6z;
        "minecraft-1.13.1" = _fINh4F6z;
        "minecraft-1.13.2" = _fINh4F6z;
        "minecraft-1.14" = _fINh4F6z;
        "minecraft-1.14.1" = _fINh4F6z;
        "minecraft-1.14.2" = _fINh4F6z;
        "minecraft-1.14.3" = _fINh4F6z;
        "minecraft-1.14.4" = _fINh4F6z;
        "minecraft-1.15" = _fINh4F6z;
        "minecraft-1.15.1" = _fINh4F6z;
        "minecraft-1.15.2" = _fINh4F6z;
        "minecraft-1.16" = _fINh4F6z;
        "minecraft-1.16.1" = _fINh4F6z;
        "minecraft-1.16.2" = _fINh4F6z;
        "minecraft-1.16.3" = _fINh4F6z;
        "minecraft-1.16.4" = _fINh4F6z;
        "minecraft-1.16.5" = _fINh4F6z;
        "minecraft-1.17" = _fINh4F6z;
        "minecraft-1.17.1" = _fINh4F6z;
        "minecraft-1.18" = _fINh4F6z;
        "minecraft-1.18.1" = _fINh4F6z;
        "minecraft-1.18.2" = _fINh4F6z;
        "minecraft-1.19" = _fINh4F6z;
        "minecraft-1.19.1" = _fINh4F6z;
        "minecraft-1.19.2" = _fINh4F6z;
        "minecraft-1.21.2" = _fINh4F6z;
        "minecraft-1.21.3" = _fINh4F6z;
        "minecraft-1.21.4" = _fINh4F6z;
        "minecraft-1.21.5" = _fINh4F6z;
        "minecraft-1.21.6" = _fINh4F6z;
        "minecraft-1.21.7" = _fINh4F6z;
        "minecraft-1.21.8" = _fINh4F6z;
        "minecraft-1.21.9" = _fINh4F6z;
        "minecraft-1.21.10" = _fINh4F6z;
        "minecraft-1.21.11" = _fINh4F6z;
        "minecraft-26.1" = _fINh4F6z;
        "minecraft-26.1.1" = _fINh4F6z;
        "minecraft-26.1.2" = _fINh4F6z;
        "minecraft-26.2" = _fINh4F6z;
        "minecraft-1.10" = _euHDNxn7;
        "minecraft-1.10.1" = _euHDNxn7;
        "minecraft-1.10.2" = _euHDNxn7;
        "minecraft-1.11" = _fINh4F6z;
        "minecraft-1.11.1" = _fINh4F6z;
        "minecraft-1.11.2" = _fINh4F6z;
        "minecraft-1.12" = _fINh4F6z;
        "minecraft-1.12.1" = _fINh4F6z;
        "minecraft-1.12.2" = _fINh4F6z;
