...
let
    versions = (let
        ...
        _ZP4460xK = {
            "id" = "ZP4460xK";
            "file" = "farmingforblockheads-fabric-26.1.2-26.1.2.4.jar";
            "hash" = "sha512-KoqVIWS+hBQrHO89EoPHErX3+MLuzRf2cvjSgr9mTA4wjRUWf+7UGEYIVk4rO7YZ1vSYq8ERd0Wn1SNA6Ic2JA==";
        };
        _6zhL7Vix = {
            "id" = "6zhL7Vix";
            "file" = "farmingforblockheads-neoforge-26.1.2-26.1.2.4.jar";
            "hash" = "sha512-tcUq4FkPL37dYy1DBzlAGGX+899h+GGCHEU1/Q9YH2iLPuTiJDHssr1X00wdnFMPuQbY5wEOyQ/HcusNei8bpQ==";
        };
        _pYMVKfIF = {
            "id" = "pYMVKfIF";
            "file" = "farmingforblockheads-fabric-26.2-26.2.0.4.jar";
            "hash" = "sha512-GNEigF74W3K/Q9foQ5jajTP9u0oAkRtFUxi1awE56Q/S0aI22oNT5ITGAn6hmToDVwghxGAc+fe51NAXq4MIzw==";
        };
        _e89ouzl8 = {
            "id" = "e89ouzl8";
    ...
    in {
        ...
        "pkg-11.0.1+forge-1.19" = _8J8xcIM8;
        "pkg-11.1.0+fabric-1.19" = _Dt6z4d71;
        "pkg-11.1.0+forge-1.19" = _QictgZaw;
        "pkg-12.0.1+forge-1.19.3" = _9N5d06yj;
        "pkg-12.0.1+fabric-1.19.3" = _Y0YCd1g3;
        "pkg-10.0.2+forge-1.18.2" = _XNKtDVzw;
        "pkg-10.0.2+fabric-1.18.2" = _mRjr0dkJ;
        "pkg-12.1.0+forge-1.19.3" = _3THUNGrx;
        "pkg-12.1.0+fabric-1.19.3" = _AuLUFZYK;
        "pkg-11.2.0+forge-1.19.2" = _8xW5TOXK;
        "pkg-11.2.0+fabric-1.19.2" = _f4soBmXh;
        "pkg-13.0.1+forge-1.19.4" = _kcW7xWQD;
        "pkg-13.0.1+fabric-1.19.4" = _L4uYRtXF;
        "pkg-13.1.0+forge-1.19.4" = _7O1dVxnn;
        "pkg-11.3.0+fabric-1.19.2" = _8geq54qE;
        "pkg-13.1.0+fabric-1.19.4" = _xDJ4jWwl;
        "pkg-11.3.0+forge-1.19.2" = _d3v4wBqp;
        "pkg-14.0.0+fabric-1.20" = _njbA2FFm;
        "pkg-14.0.0+forge-1.20" = _a5qZ1TYK;
        "pkg-11.3.1+forge-1.19.2" = _v2Jnqdo3;
        "pkg-11.3.1+fabric-1.19.2" = _rTYpelkX;
        "pkg-14.0.1+forge-1.20" = _jV04YpGN;
        "pkg-14.0.1+fabric-1.20" = _xwi1gDNI;
        "pkg-14.0.2+fabric-1.20.1" = _lioGfZlz;
        "pkg-14.0.2+forge-1.20.1" = _d1MqlvJt;
        "pkg-11.3.5+forge-1.19.2" = _R6kcqg01;
        "pkg-11.3.5+fabric-1.19.2" = _iMKkndt7;
        "pkg-15.0.0+fabric-1.20.2" = _bbf60vqa;
        "pkg-15.0.0+forge-1.20.2" = _64NQTiRP;
        "pkg-15.0.1+fabric-1.20.2" = _BLiv0LyR;
        "pkg-15.0.1+neoforge-1.20.2" = _QvAgWK8W;
        "pkg-15.0.1+forge-1.20.2" = _xuNxn66y;
        "pkg-16.0.1+fabric-1.20.4" = _lld162FQ;
        "pkg-16.0.1+forge-1.20.4" = _R8J01tQ3;
        "pkg-16.0.1+neoforge-1.20.4" = _rVpPQCh0;
        "pkg-17.0.1+fabric-1.20.6" = _YB1vb9Os;
        "pkg-17.0.1+forge-1.20.6" = _rnKex0rw;
        "pkg-17.0.1+neoforge-1.20.6" = _SYW5G8OB;
        "pkg-21.0.1+fabric-1.21" = _cQcOM4NB;
        "pkg-21.0.1+forge-1.21" = _19vfSf0I;
        "pkg-21.0.1+neoforge-1.21" = _eEOUMOGO;
        "pkg-21.0.2+fabric-1.21" = _af0GkzOK;
        "pkg-21.0.2+forge-1.21" = _6my3M90c;
        "pkg-21.0.2+neoforge-1.21" = _UtQx0tFh;
        "pkg-21.0.3+fabric-1.21" = _yi5ThqNv;
        "pkg-21.0.3+forge-1.21" = _IlOpHz0P;
        "pkg-21.0.3+neoforge-1.21" = _eqtPH62U;
        "pkg-21.0.4+fabric-1.21" = _ROS5CAWn;
        "pkg-21.0.4+forge-1.21" = _lXrxnJKQ;
        "pkg-21.0.4+neoforge-1.21" = _JjxwbvgI;
        "pkg-21.1.1+fabric-1.21.1" = _OUdqtfoy;
        "pkg-21.1.1+neoforge-1.21.1" = _8PeD1uMg;
        "pkg-21.1.1+forge-1.21.1" = _pBtXSuZM;
        "pkg-21.1.2+fabric-1.21.1" = _oi4TJbgc;
        "pkg-21.1.2+forge-1.21.1" = _5tu47RFN;
        "pkg-21.1.2+neoforge-1.21.1" = _Cznkzj1O;
        "pkg-21.3.1+fabric-1.21.3" = _VXzhO24s;
        "pkg-21.3.1+neoforge-1.21.3" = _zT536TtU;
        "pkg-21.3.2+fabric-1.21.3" = _bqxXbPIG;
        "pkg-21.3.2+neoforge-1.21.3" = _33SvQUOh;
        "pkg-21.4.1+fabric-1.21.4" = _6mWgbF0Q;
        "pkg-21.4.1+neoforge-1.21.4" = _RoEGZLy7;
        "pkg-21.4.2+forge-1.21.4" = _QicZL3qZ;
        "pkg-21.4.3+neoforge-1.21.4" = _UuNwt4Rj;
        "pkg-21.4.3+forge-1.21.4" = _a6038sC4;
        "pkg-21.4.3+fabric-1.21.4" = _itTBaN7E;
        "pkg-21.4.4+neoforge-1.21.4" = _ADfv0VgR;
        "pkg-21.1.4+fabric-1.21.1" = _22pRpc4K;
        "pkg-21.1.4+forge-1.21.1" = _eMAPBJ0t;
        "pkg-21.1.4+neoforge-1.21.1" = _ucWkyGdp;
        "pkg-21.4.5+fabric-1.21.4" = _33zdd4Q0;
        "pkg-21.4.5+forge-1.21.4" = _rCXy0GQr;
        "pkg-21.4.5+neoforge-1.21.4" = _2dlr3GyW;
        "pkg-21.1.7+fabric-1.21.1" = _1mZQZiWs;
        "pkg-21.1.7+neoforge-1.21.1" = _WZ74CvGo;
        "pkg-21.1.7+forge-1.21.1" = _rzajqHHO;
        "pkg-21.5.1+neoforge-1.21.5" = _IgYiEiT3;
        "pkg-21.5.1+fabric-1.21.5" = _AFETzZIu;
        "pkg-21.5.2+forge-1.21.5" = _Xk6R03Jf;
        "pkg-21.1.8+fabric-1.21.1" = _qRnuQJZu;
        "pkg-21.1.8+neoforge-1.21.1" = _xhMNkpHa;
        "pkg-21.1.8+forge-1.21.1" = _MPDuRhJi;
        "pkg-21.6.1+fabric-1.21.6" = _LpKVErJo;
        "pkg-21.6.1+neoforge-1.21.6" = _DRa8KTrk;
        "pkg-21.6.2+forge-1.21.6" = _UrmxjQNv;
        "pkg-21.7.1+forge-1.21.7" = _AlRNs9Pj;
        "pkg-21.7.1+fabric-1.21.7" = _RCi0nbiQ;
        "pkg-21.7.1+neoforge-1.21.7" = _T6f2XoYx;
        "pkg-21.8.1+neoforge-1.21.8" = _NlmCx5ih;
        "pkg-21.8.1+fabric-1.21.8" = _65ORKSjC;
        "pkg-21.8.1+forge-1.21.8" = _LQgbjRdl;
        "pkg-21.8.2+fabric-1.21.8" = _D9n616AT;
        "pkg-21.8.2+forge-1.21.8" = _dR0YLa87;
        "pkg-21.8.2+neoforge-1.21.8" = _FYR8FuaH;
        "pkg-14.0.3+fabric-1.20.1" = _7w0aFgNk;
        "pkg-14.0.3+forge-1.20.1" = _qaNoU2K7;
        "pkg-14.0.4+fabric-1.20.1" = _NXk5RySI;
        "pkg-14.0.4+forge-1.20.1" = _xPw564r6;
        "pkg-21.1.9+fabric-1.21.1" = _ZqHLd7D1;
        "pkg-21.1.9+neoforge-1.21.1" = _wFi2ecFL;
        "pkg-21.1.9+forge-1.21.1" = _FKhudbMe;
        "pkg-21.9.1+fabric-1.21.9" = _Umu44mrQ;
        "pkg-21.9.1+neoforge-1.21.9" = _qD15e44y;
        "pkg-21.10.1+forge-1.21.10" = _p1YlH8W9;
        "pkg-21.10.1+neoforge-1.21.10" = _YtEZg8gS;
        "pkg-21.10.1+fabric-1.21.10" = _bUL1l2Os;
        "pkg-21.1.10+neoforge-1.21.1" = _RKHOUl83;
        "pkg-21.1.10+fabric-1.21.1" = _gAgxk4i2;
        "pkg-21.1.10+forge-1.21.1" = _3LgIoh9B;
        "pkg-21.11.1+fabric-1.21.11" = _kOXiNkeu;
        "pkg-21.11.1+neoforge-1.21.11" = _BB7ifL3d;
        "pkg-21.1.11+fabric-1.21.1" = _RcF3SwaR;
        "pkg-21.1.11+forge-1.21.1" = _w9uVa3x2;
        "pkg-21.1.11+neoforge-1.21.1" = _J5Eap2fE;
        "pkg-21.11.3+fabric-1.21.11" = _CZ7N92aO;
        "pkg-21.11.3+forge-1.21.11" = _yn4e5AQI;
        "pkg-21.11.3+neoforge-1.21.11" = _DQQn02I2;
        "pkg-21.1.12+fabric-1.21.1" = _KsfMwoEI;
        "pkg-21.1.12+forge-1.21.1" = _x5WtWrJw;
        "pkg-21.1.12+neoforge-1.21.1" = _J0QsQLJa;
        "pkg-21.11.4+fabric-1.21.11" = _nkJT6WUD;
        "pkg-21.11.4+forge-1.21.11" = _iJsH3l2y;
        "pkg-21.11.4+neoforge-1.21.11" = _hwrpeyzu;
        "pkg-21.11.5+fabric-1.21.11" = _SxzXKjMO;
        "pkg-21.11.5+forge-1.21.11" = _5dvbJkIc;
        "pkg-21.11.5+neoforge-1.21.11" = _Jr3wtpwS;
        "pkg-26.1.0.1+fabric-26.1" = _kq54jSN1;
        "pkg-26.1.0.1+neoforge-26.1" = _T40TpRdW;
        "pkg-26.1.0.2+fabric-26.1.1" = _9jAeAuYO;
        "pkg-26.1.0.2+neoforge-26.1.1" = _vLoTXhbZ;
        "pkg-21.1.13+fabric-1.21.1" = _lzoQ1Cie;
        "pkg-21.1.13+neoforge-1.21.1" = _xGwKlLcS;
        "pkg-21.1.13+forge-1.21.1" = _iV5VebvF;
        "pkg-26.1.2.1+fabric-26.1.2" = _lo7GY7Sk;
        "pkg-26.1.2.1+neoforge-26.1.2" = _9VQXxYve;
        "pkg-26.2.0.1+fabric-26.2" = _PU7a0GIp;
        "pkg-26.2.0.1+neoforge-26.2" = _GMKFbCM6;
        "pkg-26.1.2.2+fabric-26.1.2" = _kNcKXJtk;
        "pkg-26.1.2.2+neoforge-26.1.2" = _l9vs5xwU;
        "pkg-26.2.0.2+fabric-26.2" = _H4XztHWX;
        "pkg-26.2.0.2+neoforge-26.2" = _eUnZnm2R;
        "pkg-26.1.2.3+fabric-26.1.2" = _H8Q8JmwV;
        "pkg-26.1.2.3+neoforge-26.1.2" = _M8IOagTb;
        "pkg-26.2.0.3+fabric-26.2" = _7PHUqfpu;
        "pkg-26.2.0.3+neoforge-26.2" = _sYS7OQgC;
        "pkg-26.1.2.4+fabric-26.1.2" = _ZP4460xK;
