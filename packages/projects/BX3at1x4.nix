...
let
    versions = (let
        ...
        _x9DfTJZK = {
            "id" = "x9DfTJZK";
            "file" = "technomodel-1.0.11.jar";
            "hash" = "sha512-9XuKk+ir43n2D7HEHMvqUAbWKC45lGLBUxro/HGQ0U9M42NKYMzfOW6UXrjyuED2DEqzDzEjsPtM3yUJ5MCFcA==";
        };
    in {
        "Vb2E2om1" = _Vb2E2om1;
        "qNZe8hz5" = _qNZe8hz5;
        ...
        "pkg-v1.0.1" = _Vb2E2om1;
        "pkg-v1.0.2" = _qNZe8hz5;
        "pkg-v1.0.3" = _UnoyaGkH;
        "pkg-1.0.4" = _vJxDhOqb;
        "pkg-1.0.5" = _6PYWydLJ;
        "pkg-1.0.6" = _Fw3H8iYI;
        "pkg-1.0.7" = _sna6rFQm;
        "pkg-1.0.8" = _oFBF5lB8;
        "pkg-1.0.9" = _6aVmZdHM;
        "pkg-1.0.10" = _vxTF6h5f;
        "pkg-1.0.11" = _x9DfTJZK;
        "default" = _x9DfTJZK;
    });
