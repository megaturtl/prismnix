...
let
    ...
    in {
        ...
        "pkg-1.8.2" = _SikVxcU4;
        "pkg-1.9.0" = _isHDA6eh;
        "pkg-1.10.0" = _Xoqfn3RA;
        "pkg-1.10.1" = _H3GGq9LS;
        "pkg-1.11.0" = _eS9rf2i8;
        "pkg-1.12.0" = _aEWlgD5j;
        "pkg-1.13.0" = _W1kV4Cbq;
        "pkg-1.13.1" = _mQod9FzT;
        "pkg-1.14.0" = _8qOSFgO1;
        "pkg-1.15.0" = _HCGED7ST;
        "pkg-1.16.0" = _gngejKpk;
        "pkg-1.16.1" = _bEbAWeeR;
        "pkg-1.16.2" = _dELNXKhp;
        "pkg-1.16.3" = _ndoZ0P5Z;
        "pkg-1.16.4" = _ZD9kC5wy;
        "pkg-1.16.5" = _JA96CA58;
        "pkg-1.16.6" = _amOvwFFn;
        "pkg-1.17.0" = _hQ6FcHHP;
        "pkg-1.18.0" = _bZn4G0xF;
        "pkg-1.18.1" = _tlPApPvT;
