...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _PjzFljhh;
        "pkg-1.0.9" = _ZcloA7YE;
        "pkg-1.0.10" = _f1hEtrwG;
        "pkg-1.4.0" = _Xs67jAXw;
        "pkg-1.5.0" = _J36GT20y;
        "pkg-1.5.1" = _9UWTsBP6;
        "pkg-1.5.1-1.18.2" = _QX1l4DK4;
        "pkg-1.5.1-1.19.0" = _rwn8dIze;
        "pkg-2.0.0" = _DqkBmriV;
        "pkg-2.1.0" = _m04T7znZ;
        "pkg-2.2.0" = _KCEC7iNe;
        "pkg-2.2.0-1.18.2" = _mrmZ3lhM;
        "pkg-2.2.1-1.19.2" = _2CmfCaVw;
        "pkg-2.2.1-1.19.3" = _roh6H7S8;
        "pkg-2.2.1" = _A22HWwme;
        "pkg-2.3.0" = _qZbpkRxS;
        "pkg-2.2.2" = _McCqUl5g;
        "pkg-2.4.0" = _lmpgqbgI;
        "pkg-3.0.0+1.21.1" = _HVxaT845;
        "pkg-3.0.1+1.21.1" = _ezijAhsu;
        "pkg-3.1.0+1.21.4" = _UHN4kapl;
