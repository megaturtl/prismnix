...
let
    versions = (let
        ...
        _wS8eahan = {
            "id" = "wS8eahan";
            "file" = "AntiRedstoneClock-Remastered-2.9.0.jar";
            "hash" = "sha512-WOuuKq+63nw5EQR4UsGqbssv/tImnl5ZsWoiKY5ht8vv9arrHELxDgeLRLI2BJK8Up7j7M2pHsxrC9/0Lc1xFQ==";
        };
        _qFMufTcA = {
            "id" = "qFMufTcA";
            "file" = "AntiRedstoneClock-Remastered-2.9.1.jar";
            "hash" = "sha512-lk5Qy/PAxTBtfjYcyLlD6y7rjfX7Vr9p8NJ2xKuiTGBwi9yYXDVbTAB4qajaXY6dtIDbEnE1OkeFogjxazPWuw==";
        };
        _DRvMTRbY = {
            "id" = "DRvMTRbY";
            "file" = "AntiRedstoneClock-Remastered-2.10.0.jar";
            "hash" = "sha512-T2+whTWg8/O5gXFfbzKsdvz7lNsMNZZLFKkI+Bj7Ee1OgecQMvp90EF5y+86BzhiHzLdvmue/CDa1v0jCk1cVQ==";
        };
    in {
        "iyGUtfWG" = _iyGUtfWG;
        "YyMSBvws" = _YyMSBvws;
        ...
        "bukkit-1.20.6" = _DRvMTRbY;
        "bukkit-1.21" = _DRvMTRbY;
        "bukkit-1.21.8" = _DRvMTRbY;
        "bukkit-1.21.1" = _DRvMTRbY;
        "bukkit-1.21.2" = _DRvMTRbY;
        "bukkit-1.21.3" = _DRvMTRbY;
        "bukkit-1.21.4" = _DRvMTRbY;
        "bukkit-1.21.5" = _DRvMTRbY;
        "bukkit-1.21.6" = _DRvMTRbY;
        "bukkit-1.21.7" = _DRvMTRbY;
        "bukkit-1.21.9" = _DRvMTRbY;
        "bukkit-1.21.10" = _DRvMTRbY;
        "bukkit-1.21.11" = _DRvMTRbY;
        "bukkit-26.1" = _DRvMTRbY;
        "bukkit-26.1.1" = _DRvMTRbY;
        "bukkit-26.1.2" = _DRvMTRbY;
        "bukkit-26.2" = _DRvMTRbY;
        ...
        "paper-1.20.6" = _DRvMTRbY;
        "paper-1.21" = _DRvMTRbY;
        "paper-1.21.8" = _DRvMTRbY;
        "paper-1.21.1" = _DRvMTRbY;
        "paper-1.21.2" = _DRvMTRbY;
        "paper-1.21.3" = _DRvMTRbY;
        "paper-1.21.4" = _DRvMTRbY;
        "paper-1.21.5" = _DRvMTRbY;
        "paper-1.21.6" = _DRvMTRbY;
        "paper-1.21.7" = _DRvMTRbY;
        "paper-1.21.9" = _DRvMTRbY;
        "paper-1.21.10" = _DRvMTRbY;
        "paper-1.21.11" = _DRvMTRbY;
        "paper-26.1" = _DRvMTRbY;
        "paper-26.1.1" = _DRvMTRbY;
        "paper-26.1.2" = _DRvMTRbY;
        "paper-26.2" = _DRvMTRbY;
        "folia-1.20.6" = _DRvMTRbY;
        "folia-1.21" = _DRvMTRbY;
        "folia-1.21.1" = _DRvMTRbY;
        "folia-1.21.2" = _DRvMTRbY;
        "folia-1.21.3" = _DRvMTRbY;
        "folia-1.21.4" = _DRvMTRbY;
        "folia-1.21.5" = _DRvMTRbY;
        "folia-1.21.6" = _DRvMTRbY;
        "folia-1.21.7" = _DRvMTRbY;
        "folia-1.21.8" = _DRvMTRbY;
        "folia-1.21.9" = _DRvMTRbY;
        "folia-1.21.10" = _DRvMTRbY;
        "folia-1.21.11" = _DRvMTRbY;
        "folia-26.1" = _DRvMTRbY;
        "folia-26.1.1" = _DRvMTRbY;
        "folia-26.1.2" = _DRvMTRbY;
        "folia-26.2" = _DRvMTRbY;
