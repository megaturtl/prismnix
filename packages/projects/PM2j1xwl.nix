...
let
    versions = (let
        ...
        _2epQN5h2 = {
            "id" = "2epQN5h2";
            "file" = "fastjson4yacl-1.0.8-fabric+1.20.1.jar";
            "hash" = "sha512-zavGVuKjOy3/IaWGrg1SvQThlObk/s5tN4/zle1Kvwu4mcJ+JTmCGXE3HZ8aiDPyAQHfEn1mMY+mIewL3r/uww==";
        };
        _x4NdheuQ = {
            "id" = "x4NdheuQ";
            "file" = "fastjson4yacl-1.0.8-forge+1.20.1.jar";
            "hash" = "sha512-F6Ft8w+XCBNaCQgg/nn/QTKNPHmwLqIVbNbXXz25/+eW0FoWocxg2ifpNokW+ISEJCRZd2eq4dPm5TBopHSFdw==";
        };
        _mWV449ao = {
            "id" = "mWV449ao";
            "file" = "fastjson4yacl-1.0.8-neoforge+1.21.1.jar";
            "hash" = "sha512-+rSkedhRuj2k9FZY+jOb3RwvbRA7qugTF/n1CRWowT5k9dhGHQ+DIVyEoaxPOfmBbvmy7dKLQNTviIIiRXM8vA==";
        };
        _Zdo2uTxe = {
            "id" = "Zdo2uTxe";
            "file" = "fastjson4yacl-1.0.8-fabric+1.21.1.jar";
            "hash" = "sha512-75eEZlZlEIg4qvCOESUwJCqGnWKGz0G7BeKPog/zEOmFE8UvlTVWDQUfeHQ8/iQ3s5KB0emofj4jZKStMagLxQ==";
        };
        _nBU9CPCu = {
            "id" = "nBU9CPCu";
            "file" = "fastjson4yacl-1.0.8-neoforge+1.21.5.jar";
            "hash" = "sha512-pL4LsiZiZMTDCBnJLlGULeatUKCPA18ZvODSxNanVwvVgYHvoFUQCKwXSTmI4fzgspiUx3hH95pAPsM/odKENA==";
        };
        _Unv0C1IJ = {
            "id" = "Unv0C1IJ";
            "file" = "fastjson4yacl-1.0.8-fabric+1.21.5.jar";
            "hash" = "sha512-RPerYW5y8Ndxs9d81X+Zyt5aeWJeLkWSbhmmOmUn+/6tSSCH0dLEvSbe7xaiQqUxdkNtREf5RykJ3O4Fkq/1ZA==";
        };
        _ugbdijxA = {
            "id" = "ugbdijxA";
            "file" = "fastjson4yacl-1.0.8-neoforge+26.1.jar";
            "hash" = "sha512-puiWe2AXRZhc3GFF9wojuFNX4ajI+gUgbO82cX5RpSipmXpSoivUv/JM9br0EKZhKCvyizam2cKIzIUmxeKc1g==";
        };
        _Xbr3NH0Y = {
            "id" = "Xbr3NH0Y";
            "file" = "fastjson4yacl-1.0.8-fabric+26.1.jar";
            "hash" = "sha512-qmiEy3rdeV48jCFiuGVoHnJCSTYFJZ6QF7wA0H/R3ny7y6vG+go0zfOs7bVmWwRMBXwG9bJ5SXDBSiFCWpByOg==";
        };
    in {
        "3an0T8B4" = _3an0T8B4;
        "cqypVCHT" = _cqypVCHT;
        ...
        "ugbdijxA" = _ugbdijxA;
        "Xbr3NH0Y" = _Xbr3NH0Y;
        "fabric-1.20.1" = _2epQN5h2;
        "fabric-1.21.1" = _Zdo2uTxe;
        "fabric-1.21.2" = _Zdo2uTxe;
        "fabric-1.21.3" = _Zdo2uTxe;
        "fabric-1.21.4" = _Zdo2uTxe;
        "fabric-1.21.5" = _Unv0C1IJ;
        "fabric-1.21.6" = _Unv0C1IJ;
        "fabric-1.21.7" = _Unv0C1IJ;
        "fabric-1.21.8" = _Unv0C1IJ;
        "fabric-1.21.9" = _Unv0C1IJ;
        "fabric-1.21.10" = _Unv0C1IJ;
        "fabric-1.21.11" = _Unv0C1IJ;
        "fabric-26.1" = _Xbr3NH0Y;
        "fabric-26.1.1" = _Xbr3NH0Y;
        "fabric-26.1.2" = _Xbr3NH0Y;
        "fabric-26.2" = _Xbr3NH0Y;
        "fabric-26.3-pre-2" = _48jzp815;
        "fabric-26.3" = _Xbr3NH0Y;
        "quilt-1.20.1" = _ImmSJ3KF;
        "quilt-1.21.1" = _ed0Pb5nQ;
        "quilt-1.21.2" = _ed0Pb5nQ;
        "quilt-1.21.3" = _ed0Pb5nQ;
        "quilt-1.21.4" = _ed0Pb5nQ;
        "neoforge-1.21.1" = _mWV449ao;
        "neoforge-1.21.2" = _mWV449ao;
        "neoforge-1.21.3" = _mWV449ao;
        "neoforge-1.21.4" = _mWV449ao;
        "neoforge-1.21.5" = _nBU9CPCu;
        "neoforge-1.21.6" = _nBU9CPCu;
        "neoforge-1.21.7" = _nBU9CPCu;
        "neoforge-1.21.8" = _nBU9CPCu;
        "neoforge-1.21.9" = _nBU9CPCu;
        "neoforge-1.21.10" = _nBU9CPCu;
        "neoforge-1.21.11" = _nBU9CPCu;
        "neoforge-26.1" = _ugbdijxA;
        "neoforge-26.1.1" = _ugbdijxA;
        "neoforge-26.1.2" = _ugbdijxA;
        "neoforge-26.2" = _ugbdijxA;
        "neoforge-26.3" = _ugbdijxA;
        "forge-1.20.1" = _x4NdheuQ;
        ...
        "pkg-1.0.8-fabric+1.20.1" = _2epQN5h2;
        "pkg-1.0.8-forge+1.20.1" = _x4NdheuQ;
        "pkg-1.0.8-neoforge+1.21.1" = _mWV449ao;
        "pkg-1.0.8-fabric+1.21.1" = _Zdo2uTxe;
        "pkg-1.0.8-neoforge+1.21.5" = _nBU9CPCu;
        "pkg-1.0.8-fabric+1.21.5" = _Unv0C1IJ;
        "pkg-1.0.8-neoforge+26.1" = _ugbdijxA;
        "pkg-1.0.8-fabric+26.1" = _Xbr3NH0Y;
        "default" = _Xbr3NH0Y;
    });
