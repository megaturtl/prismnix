...
let
    ...
    in {
        ...
        "pkg-1.1.0-1.20" = _nLIknlfA;
        "pkg-2.0.0b1-1.20+" = _ipXb44TN;
        "pkg-2.0.0b2-1.20+" = _RQ8OHbvL;
        "pkg-2.0.0b3-1.20+" = _crxY0GZV;
        "pkg-2.0.0b4-1.20+" = _qFU2fFoI;
        "pkg-2.0.0b5-1.20+" = _3WyEcIV7;
        "pkg-2.0.0b6-1.20+" = _QnyREKXO;
        "pkg-2.0.0b6-1.20.2+" = _pvBsWbLd;
        "pkg-2.0.0b7-1.20+" = _AN7oi0Fh;
        "pkg-2.0.0b7-1.20.2+" = _vuC7TmNr;
        "pkg-2.0.0b7-1.20.3+" = _vO0ewW0V;
        "pkg-2.0.0beta8-1.20+" = _ahmFhf3L;
        "pkg-2.0.0beta8-1.20.2+" = _rmduJL3d;
        "pkg-2.0.0beta8-1.20.3+" = _mOB6xT7E;
        "pkg-2.0.0beta9-1.20+" = _RHq5tmue;
        "pkg-2.0.0beta9-1.20.2+" = _JejvZPZw;
        "pkg-2.0.0beta9-1.20.3+" = _pI9wNrFf;
        "pkg-2.0.0beta10-1.20+" = _jDNZONo9;
        "pkg-2.0.0beta10-1.20.2+" = _5Kf7Z544;
        "pkg-2.0.0beta10-1.20.3+" = _mYmSWbhK;
        "pkg-3.0.0-1.20+" = _Bmhdm2dN;
        "pkg-3.0.0-1.20.2+" = _VqX0m7Lt;
        "pkg-3.0.0-1.20.5+" = _OPea0gVs;
        "pkg-3.0.0-1.21.0" = _Y7tFoi6N;
        "pkg-3.0.1-1.20.5+" = _3vvDQ6GT;
        "pkg-3.0.1-1.21.0" = _YwGCcqEf;
        "pkg-3.0.2-1.21.0" = _p8aUcurp;
        "pkg-3.1.0-1.21.2" = _3PMrLaCI;
        "pkg-3.1.1-1.21.4" = _Dvw3bCDG;
        "pkg-3.1.2-1.21.5" = _2usChGf5;
        "pkg-3.2.0-1.21.6" = _BtIrk11R;
