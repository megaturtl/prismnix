...
let
    versions = (let
        ...
        _bjpanX2y = {
            "id" = "bjpanX2y";
            "file" = "crosshair_plus_square_dot-1.0.1-mc26.3.zip";
            "hash" = "sha512-K9uDUBeDaUEziY46Lp9DbQWSYb04KXbjaY2ifbh2oC0J2fiztGeyjv8GPFyWMUZL236KWK0/6eh084AsI97bzA==";
        };
    in {
        "WHq8i0gj" = _WHq8i0gj;
        "dKmcqFmt" = _dKmcqFmt;
