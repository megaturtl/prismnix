...
let
    ...
    in {
        ...
        "pkg-1.8.4" = _vkgceA9o;
        "pkg-1.9.0" = _fIPsChiC;
        "pkg-1.10.0" = _IUKQDJ99;
        "pkg-1.11.0" = _SmczNKjd;
        "pkg-1.12.0" = _m7ZmGRaM;
        "pkg-1.12.1" = _vgMbPE1t;
        "pkg-1.13.0" = _zIbnUAGY;
        "pkg-1.13.1" = _mYNQcuHA;
        "pkg-1.14.0" = _WdZoEdFt;
        "pkg-1.14.1" = _WYVga1Uc;
        "pkg-1.18.2-1.14.2" = _CExqMChq;
        "pkg-1.14.3+1.19.0" = _9kZtJVTt;
        "pkg-1.14.4+1.19.0" = _fkorJ5LU;
        "pkg-1.14.4+1.19.1" = _CryFBohn;
        "pkg-1.14.4+1.19.2" = _r7Q6fu0h;
        "pkg-1.14.5+1.19.3" = _gaNepZpi;
        "pkg-1.14.6+1.19.4" = _73ztlz1d;
        "pkg-1.15.0+1.20.1" = _IeovgcT2;
        "pkg-1.15.1+1.20.2" = _x6ACrf2t;
        "pkg-1.10.1+1.16.5" = _tOe5YjcZ;
        "pkg-1.15.2+1.20.2" = _2peT8knG;
        "pkg-1.15.1+1.20.1" = _TZQ1wgkO;
        "pkg-1.15.2+1.20.1" = _swtTy8lU;
        "pkg-1.10.2+1.16.5" = _kZjfTc6R;
        "pkg-1.14.1+1.18.1" = _PNOTl2Nu;
        "pkg-1.14.7+1.19.4" = _cQVT8Msf;
        "pkg-1.15.3+1.20.2" = _MhbzJlqp;
        "pkg-1.15.4+1.20.4" = _MXnozXBd;
        "pkg-1.15.5+1.20.4" = _v6pw9KLe;
