...
let
    versions = (let
        ...
        _kMe8XwU1 = {
            "id" = "kMe8XwU1";
            "file" = "everycomp-1.20-2.9.25-fabric.jar";
            "hash" = "sha512-t8adC4ArT2nfZaXMVEgUsOHUn8MbVhH71uLOjZ08Ll6Nhgh45/J2hHFo97BFIjHFM6iHGwtmCdE0UZ+7dEGj3w==";
        };
        _irqS2aze = {
            "id" = "irqS2aze";
            "file" = "everycomp-1.20-2.9.25-forge.jar";
            "hash" = "sha512-1u0bWlSw9bWhSSzE/UVB1Iuy1ZVAzdqECx/huwHM0WB4AqWppUu6vv6UeuKXpidWzgCYeGa7gemEnmyMH3WNgg==";
        };
        _K1Pqyarw = {
            "id" = "K1Pqyarw";
            "file" = "everycomp-1.20-2.9.26-fabric.jar";
            "hash" = "sha512-OZgvc4aZfqzdNBKM03HZD07FQAOCc5VxejW08/NV/njqijDB6n3ZgRnl8oBw+6vmLwofBIamC/w94DiIkMIp1A==";
        };
        _zGp4qGn5 = {
            "id" = "zGp4qGn5";
            "file" = "everycomp-1.20-2.9.26-forge.jar";
            "hash" = "sha512-UB16XwQZs1VxCqghMsCry8X/MC06uv7q+bW0mmcJ/TKMiFTHXkaNyVhLddmVXkf7zCW7BVj0asfR01Y1Xp1rdQ==";
        };
        _qk8iZzft = {
            "id" = "qk8iZzft";
            "file" = "everycomp-1.21-2.11.51-fabric.jar";
            "hash" = "sha512-8ZaBbxvq7P16KSBAeRFty96tANM0haIuAAn+lp5zT9JkDhfoe6kiqP5KzM+B7wT06W1Ur7tK7Y/L4CiGTz5guw==";
        };
        _o0n9IWBr = {
            "id" = "o0n9IWBr";
    ...
    in {
        ...
        "pkg-54" = _pm57oLza;
        "pkg-55" = _b1XioTmg;
        "pkg-1.19.2-2.3.0" = _J7lg1K7k;
        "pkg-1.19.2-2.3.1" = _vkRGMaIX;
        "pkg-1.19.2-2.3.2" = _k7nOi16B;
        "pkg-1.19.2-2.3.3" = _tlyfp3t7;
        "pkg-1.19.2-2.3.4" = _O7akdZF8;
        "pkg-1.19.2-2.4.0" = _4ZW2ogjY;
        "pkg-1.19.2-2.4.1" = _rYaW8PzA;
        "pkg-1.19.2-2.4.2" = _8H2xRxbw;
        "pkg-1.19.2-2.4.3" = _ntCGZKJd;
        "pkg-1.19.2-2.4.4" = _Op50EjXA;
        "pkg-1.19.2-2.4.5" = _GKeJ69tQ;
        "pkg-1.19.2-2.4.6" = _8DEbe8Q1;
        "pkg-1.19.2-2.4.7" = _Nk6h7dR5;
        "pkg-1.19.2-2.4.8" = _xpTpZdup;
        "pkg-1.19.2-2.4.9" = _R5asDCGn;
        "pkg-1.19.2-2.4.10" = _HjwF2uzD;
        "pkg-1.19.2-2.4.11" = _wfURtgr2;
        "pkg-1.18.2-1.5.18" = _yjfsvOEU;
        "pkg-1.19.2-2.4.12" = _ZigaPu9g;
        "pkg-1.19.2-2.5.1" = _B5NZYmIo;
        "pkg-1.20-2.6.0" = _CTKMQabD;
        "pkg-1.20-2.6.1" = _aw4uWq4J;
        "pkg-1.20-2.6.2" = _IMnwtO4l;
        "pkg-1.19.2-2.5.3" = _6JGqieGf;
        "pkg-1.19.2-2.5.4" = _UaasGELI;
        "pkg-1.19.2-2.5.5" = _fonTBpMG;
        "pkg-1.20-2.6.3" = _mdv7FQAL;
        "pkg-1.20-2.6.5" = _baAnhD6X;
        "pkg-1.18.2-1.6.4" = _NPU1uAHO;
        "pkg-1.19.2-2.5.7" = _pXcrVm65;
        "pkg-1.20-2.6.7" = _K9M75Rrf;
        "pkg-1.19.2-2.5.9" = _YBbTZDSQ;
        "pkg-1.19.2-2.5.10" = _nTK7eL9O;
        "pkg-1.20-2.6.8" = _dANk5Waj;
        "pkg-1.19.2-2.5.11" = _KwABZa9P;
        "pkg-1.20-2.6.9" = _f1XOAifz;
        "pkg-1.20-2.6.12" = _vgmQHTpq;
        "pkg-1.18.2-1.6.5" = _AspsTEeS;
        "pkg-1.20-2.6.13" = _FC9GcX2p;
        "pkg-1.20-2.6.14" = _LLWhlyl0;
        "pkg-1.20-2.6.15" = _xVfmCFJT;
        "pkg-1.19.2-2.5.12" = _P6stZ50D;
        "pkg-1.19.2-2.5.13" = _NUWjEve0;
        "pkg-1.20-2.6.16" = _3Q0FEm21;
        "pkg-1.19.2-2.5.14" = _nnLT9wRE;
        "pkg-1.18.2-1.6.6" = _NVkX4NC2;
        "pkg-1.20-2.6.17" = _9tv8Ftdz;
        "pkg-1.20-2.6.18" = _WWgDJm0m;
        "pkg-1.19.2-2.5.15" = _ZTwqUtKg;
        "pkg-1.18.2-1.6.7" = _cJvuEiZo;
        "pkg-1.20-2.6.19" = _EeTYYxit;
        "pkg-1.20-2.6.20" = _sEU8dzWc;
        "pkg-1.20-2.6.21" = _LxYtwcQo;
        "pkg-1.19.2-2.5.16" = _nWOyVEvK;
        "pkg-1.20-2.6.23" = _fNq1QkBh;
        "pkg-1.20-2.6.24" = _LpOnyXBn;
        "pkg-1.20-2.6.25" = _phRuBALr;
        "pkg-1.20-2.6.26" = _74VaNZst;
        "pkg-1.18.2-1.6.8" = _27gIHRrt;
        "pkg-1.18.2-1.6.9" = _493IjPAj;
        "pkg-1.20-2.6.27" = _U2qUl1Zo;
        "pkg-1.19.2-2.5.17" = _nDb0cb9l;
        "pkg-1.20-2.6.28" = _Zdh22Uw0;
        "pkg-1.20-2.6.29" = _aiKLEzv2;
        "pkg-1.20-2.6.30" = _LXSnZXAo;
        "pkg-1.20-2.6.31" = _KjEt5MHe;
        "pkg-1.20-2.6.32" = _z53lZ3Ci;
        "pkg-1.20-2.6.33" = _75M9otRZ;
        "pkg-1.19.2-2.5.18" = _dBvnAShv;
        "pkg-1.20-2.6.34" = _BH60TVlM;
        "pkg-1.19.2-2.5.19" = _FTJsWaLV;
        "pkg-1.20-2.6.35" = _bfDP5bAm;
        "pkg-1.20-2.6.36" = _ydNKERa2;
        "pkg-1.20-2.6.37" = _JNIYHmnq;
        "pkg-1.20-2.6.38" = _ZRJh4ixT;
        "pkg-1.20-2.6.39" = _1yhdaMcm;
        "pkg-1.20-2.6.40" = _elQjYiON;
        "pkg-1.20-2.6.41" = _nliBLrOD;
        "pkg-1.20-2.6.42" = _QplzfO1v;
        "pkg-1.20-2.6.43" = _TQxAaLwn;
        "pkg-1.20-2.6.44" = _GYiUb1ym;
        "pkg-1.19.2-2.5.20" = _rpmOEeHP;
        "pkg-1.20-2.6.45" = _P4cHzWL5;
        "pkg-1.19.2-2.5.21" = _GZIizJzC;
        "pkg-1.20-2.6.46" = _JpDrSY16;
        "pkg-1.20-2.6.47" = _TktBVGCU;
        "pkg-1.20-2.6.48" = _cpMcBby0;
        "pkg-1.20-2.6.49" = _AdMHFjMo;
        "pkg-1.20-2.6.50" = _1DR19zdq;
        "pkg-1.20-2.6.51" = _Yt80TYzk;
        "pkg-1.18.2-1.6.10" = _uQGwteWY;
        "pkg-1.18.2-1.6.11" = _5wIkLMZO;
        "pkg-1.20-2.6.52" = _tSQrWiPj;
        "pkg-1.20-2.6.53" = _KBIqp9v7;
        "pkg-1.20-2.6.54" = _LsAqszuM;
        "pkg-1.20-2.6.55" = _R56fvaaw;
        "pkg-1.19.2-2.5.22" = _HBNuf5vW;
        "pkg-1.20-2.6.56" = _cR9zm4gj;
        "pkg-1.20-2.6.57" = _dvarqhtY;
        "pkg-1.20-2.6.58" = _Z4SIQfB8;
        "pkg-1.20-2.6.59" = _VIlY6R1f;
        "pkg-1.20-2.6.60" = _hXPgxIBC;
        "pkg-1.20-2.6.61" = _wuCIcohP;
        "pkg-1.20-2.6.62" = _Cn46zTH2;
        "pkg-1.20-2.6.63" = _XL6DaT67;
        "pkg-1.20-2.6.64" = _thNKgxIn;
        "pkg-1.20-2.6.65" = _KebhYHtG;
        "pkg-1.19.2-2.5.23" = _bERqOkFX;
        "pkg-1.18.2-1.6.12" = _ls71g31A;
        "pkg-1.19.2-2.5.24" = _NieADfwl;
        "pkg-1.18.2-1.6.13" = _zPwOkG1I;
        "pkg-1.20-2.6.66" = _M1B7lyV7;
        "pkg-1.18.2-1.6.14" = _nWjn764k;
        "pkg-1.20-2.6.67" = _76Bk6xHw;
        "pkg-1.20-2.6.68" = _YP3jL2J4;
        "pkg-1.19.2-2.5.25" = _qVh0FxGm;
        "pkg-1.20-2.6.69" = _W5WTStpp;
        "pkg-1.19.2-2.5.26" = _ZsYx7YJO;
        "pkg-1.20-2.6.70" = _8WIQXgHC;
        "pkg-1.20-2.6.71" = _8KVGEGlH;
        "pkg-1.21-2.6.72" = _FA9p5nCM;
        "pkg-1.18.2-1.6.15" = _cPzC69b3;
        "pkg-1.18.2-1.6.16" = _WccYxEpj;
        "pkg-1.20-2.6.73" = _zCxLLB45;
        "pkg-1.20-2.6.74" = _BRepSscU;
        "pkg-1.20-2.6.75" = _lI2LpZGT;
        "pkg-1.19.2-2.5.27" = _C3DRd5Vc;
        "pkg-1.20-2.6.76" = _WZGJUdgD;
        "pkg-1.19.2-2.5.28" = _gq59syP7;
        "pkg-1.20-2.6.77" = _JUHAPeFz;
        "pkg-1.20-2.6.78" = _YyJMAVp3;
        "pkg-1.20-2.6.79" = _JhMZMEsH;
        "pkg-1.20-2.6.80" = _AzVyjKIT;
        "pkg-1.20-2.6.81" = _XzWttf5l;
        "pkg-1.20-2.6.82" = _XOTsE93B;
        "pkg-1.20-2.6.83" = _t5rla5Pg;
        "pkg-1.20-2.6.84" = _s2BuNwqr;
        "pkg-1.20-2.6.84H" = _N9PNJLJp;
        "pkg-1.19.2-2.5.29" = _HzYZnTFB;
        "pkg-1.20-2.6.85" = _UQRJEwI4;
        "pkg-1.20-2.6.86" = _cso8qMUl;
        "pkg-1.20-2.6.87" = _IKKkD7Pc;
        "pkg-neoforge_1.21-2.7.0" = _fQaRl4Yw;
        "pkg-fabric_1.21-2.7.0" = _Jat6rj5t;
        "pkg-fabric_1.21-2.7.1" = _tq9Qpsu4;
        "pkg-neoforge_1.21-2.7.1" = _PLPS8oGv;
        "pkg-fabric_1.21-2.7.2" = _mS2wDeQp;
        "pkg-neoforge_1.21-2.7.2" = _ALf0fZU0;
        "pkg-1.20-2.6.88" = _YeMAq4Zh;
        "pkg-fabric_1.21-2.7.3" = _byZLs6Li;
        "pkg-neoforge_1.21-2.7.3" = _H2xjDtQb;
        "pkg-1.20-2.6.89" = _3g8Ld5Yc;
        "pkg-1.20-2.6.90" = _robn2JQU;
        "pkg-fabric_1.21-2.7.4" = _Vpuoe6Id;
        "pkg-neoforge_1.21-2.7.4" = _iYv97teh;
        "pkg-1.18.2-1.6.17" = _vAPTr1BS;
        "pkg-1.20-2.6.91" = _AtYgIVmS;
        "pkg-1.20-2.6.92" = _MLIs9orQ;
        "pkg-fabric_1.21-2.7.5" = _dGFt3y2d;
        "pkg-neoforge_1.21-2.7.5" = _pJ4ghpwb;
        "pkg-1.20-2.6.93" = _EmFek31o;
        "pkg-1.20-2.6.94" = _iHLD17Me;
        "pkg-fabric_1.21-2.7.6" = _bZ3QgXIO;
        "pkg-neoforge_1.21-2.7.6" = _me5YtblJ;
        "pkg-1.20-2.7.0" = _FUWtFK4j;
        "pkg-1.20-2.7.1" = _3lPHBJY4;
        "pkg-1.19.2-2.5.30" = _AZzNispE;
        "pkg-1.20-2.7.2" = _1nCN6xew;
        "pkg-1.20-2.7.3" = _uKkaEZXj;
        "pkg-1.19.2-2.5.31" = _XF0zzhPP;
        "pkg-fabric_1.21-2.8.0" = _msvLBj5E;
        "pkg-neoforge_1.21-2.8.0" = _pLoAKVhz;
        "pkg-fabric_1.21-2.8.1" = _NipWx7Lh;
        "pkg-neoforge_1.21-2.8.1" = _MoJlf2Vk;
        "pkg-1.20-2.7.4" = _iYZz7y5s;
        "pkg-1.20-2.7.5" = _sqIWhXha;
        "pkg-fabric_1.21-2.8.2" = _njHlGV5J;
        "pkg-neoforge_1.21-2.8.2" = _v9Ttfm7R;
        "pkg-1.20-2.7.6" = _mJY2qVp8;
        "pkg-1.20-2.7.7" = _zfXoMmXn;
        "pkg-1.20-2.7.8" = _7VAp8ErR;
        "pkg-fabric_1.21-2.8.3" = _vuEdVbrU;
        "pkg-neoforge_1.21-2.8.3" = _9sxJ1jhg;
        "pkg-fabric_1.21-2.8.4" = _NT0IdLCd;
        "pkg-neoforge_1.21-2.8.4" = _KhGzGnz3;
        "pkg-1.20-2.7.9" = _Tihfu5nd;
        "pkg-1.20-2.7.10" = _dg5PGOp5;
        "pkg-1.18.2-1.6.18" = _J5e2M2ee;
        "pkg-1.18.2-1.6.19" = _pcmts5Mg;
        "pkg-fabric_1.21-2.8.5" = _prJ9spxW;
        "pkg-neoforge_1.21-2.8.5" = _ETV1SzfB;
        "pkg-1.20-2.7.11" = _luybhneG;
        "pkg-1.20-2.7.12" = _fJRRPDux;
        "pkg-fabric_1.21-2.9.0" = _4QnXxoRZ;
        "pkg-neoforge_1.21-2.9.0" = _Oo4l6QKT;
        "pkg-1.20-2.7.13" = _lpaCplcP;
        "pkg-neoforge_1.21-2.9.1" = _TlbUwAGV;
        "pkg-fabric_1.21-2.9.1" = _1bw1bGHC;
        "pkg-fabric_1.21-2.9.2" = _xuRWo2WY;
        "pkg-neoforge_1.21-2.9.2" = _axPGwxK5;
        "pkg-1.20-2.7.14" = _WlYM6HDN;
        "pkg-fabric_1.21-2.9.3" = _k2bQcxK8;
        "pkg-neoforge_1.21-2.9.3" = _9HVQbO9R;
        "pkg-1.20-2.7.15" = _9zhikaZ0;
        "pkg-1.20-2.7.16" = _12zLBWAQ;
        "pkg-1.20-2.7.17" = _gyg7v7zM;
        "pkg-1.19.2-2.5.32" = _O89qVnL5;
        "pkg-1.20-2.7.18" = _R7eYBpWw;
        "pkg-1.20-2.7.19" = _MLaMHTqJ;
        "pkg-1.19.2-2.5.33" = _m3fbAaxV;
        "pkg-1.20-2.7.20" = _KRUbrQJs;
        "pkg-fabric_1.21-2.9.4" = _OOwLtOF5;
        "pkg-neoforge_1.21-2.9.4" = _EgHgby9t;
        "pkg-1.20-2.7.21" = _rKRx3tgZ;
        "pkg-fabric_1.21-2.9.5" = _ioA9amD2;
        "pkg-neoforge_1.21-2.9.5" = _WYLmjQKt;
        "pkg-1.20-2.7.22" = _EvwN2rAy;
        "pkg-1.20-2.7.23" = _PW9leTdV;
        "pkg-1.20-2.7.24" = _wDpe7Rpe;
        "pkg-fabric_1.21-2.9.6" = _BRNzJ4De;
        "pkg-neoforge_1.21-2.9.6" = _lenHbtLC;
        "pkg-fabric_1.21-2.9.7" = _2mR0mmoo;
        "pkg-neoforge_1.21-2.9.7" = _RQW0SkWr;
        "pkg-1.20-2.7.25" = _9TXJwBTz;
        "pkg-fabric_1.21-2.9.8" = _OpYDbqEp;
        "pkg-neoforge_1.21-2.9.8" = _UhQXx3QJ;
        "pkg-1.20-2.7.26" = _EtvyKvrX;
        "pkg-fabric_1.21-2.9.9" = _ETVfpwdq;
        "pkg-neoforge_1.21-2.9.9" = _9JCwqsF9;
        "pkg-fabric_1.21-2.9.10" = _4ce2ZEWG;
        "pkg-neoforge_1.21-2.9.10" = _OA1qCzkH;
        "pkg-1.18.2-1.6.20" = _kP7dyuvZ;
        "pkg-1.21-2.10.0-fabric" = _8t5nTN3U;
        "pkg-1.21-2.10.0-neoforge" = _m7cxs5d8;
        "pkg-1.21-2.10.1-fabric" = _E4gk71GI;
        "pkg-1.21-2.10.1-neoforge" = _AKpMdSg4;
        "pkg-1.21-2.10.2-fabric" = _G8Ytbmk1;
        "pkg-1.21-2.10.2-neoforge" = _FDiApwT7;
        "pkg-1.20-2.7.27" = _GdCpkM6q;
        "pkg-1.20-2.7.28-forge" = _QTkFXKTQ;
        "pkg-1.20-2.7.28-fabric" = _xyEEoj0Y;
        "pkg-1.20-2.7.29-forge" = _1AgqMBxi;
        "pkg-1.20-2.7.29-fabric" = _zvG13JvM;
        "pkg-1.21-2.10.3-fabric" = _kSiTxa68;
        "pkg-1.21-2.10.3-neoforge" = _ObmM7T08;
        "pkg-1.20-2.7.30-forge" = _hRPDg3uv;
        "pkg-1.20-2.7.30-fabric" = _1hl3pYXe;
        "pkg-1.21-2.10.4-fabric" = _iFxCqSdM;
        "pkg-1.21-2.10.4-neoforge" = _XAhiwQDv;
        "pkg-1.20-2.8.0-forge" = _zXdehjud;
        "pkg-1.20-2.8.0-fabric" = _wDn00rHE;
        "pkg-1.20-2.8.1-forge" = _PrPlLP1R;
        "pkg-1.20-2.8.1-fabric" = _Ud57v5vA;
        "pkg-1.21-2.10.5-fabric" = _19nHn9rk;
        "pkg-1.21-2.10.5-neoforge" = _DaKvhqox;
        "pkg-1.20-2.8.2-forge" = _KD86zKco;
        "pkg-1.20-2.8.2-fabric" = _GIB0gMU5;
        "pkg-1.20-2.8.3-forge" = _ATfmMrCQ;
        "pkg-1.20-2.8.3-fabric" = _757tfaqM;
        "pkg-1.20-2.8.4-forge" = _kinjVPZH;
        "pkg-1.20-2.8.4-fabric" = _eb2ddQrq;
        "pkg-1.21-2.10.6-fabric" = _WroP4jYa;
        "pkg-1.21-2.10.6-neoforge" = _JDRgr6Fo;
        "pkg-1.20-2.8.5-forge" = _bPWOXgFm;
        "pkg-1.20-2.8.5-fabric" = _BxgjdFDM;
        "pkg-1.21-2.10.7-fabric" = _cebttURx;
        "pkg-1.21-2.10.7-neoforge" = _fdFysmm7;
        "pkg-1.20-2.8.6-forge" = _aRv9f9Xq;
        "pkg-1.20-2.8.6-fabric" = _MVMIeGzn;
        "pkg-1.19.2-2.5.34" = _ZzcLJTkz;
        "pkg-1.19.2-2.5.35" = _pRt2y2dn;
        "pkg-1.20-2.8.7-forge" = _3GrTn4ZO;
        "pkg-1.20-2.8.7-fabric" = _lbPug0HE;
        "pkg-1.21-2.10.8-fabric" = _HjRpCA99;
        "pkg-1.21-2.10.8-neoforge" = _6Gs2YhVR;
        "pkg-1.20-2.8.8-forge" = _w8avvHid;
        "pkg-1.20-2.8.8-fabric" = _TQ2yMP05;
        "pkg-1.20-2.8.9-forge" = _JhBXej7p;
        "pkg-1.20-2.8.9-fabric" = _TZze9TNn;
        "pkg-1.21-2.10.9-fabric" = _L5y5djHe;
        "pkg-1.21-2.10.9-neoforge" = _HjZGh3Mj;
        "pkg-1.20-2.8.10-forge" = _tpbXu6CX;
        "pkg-1.20-2.8.10-fabric" = _JrPXHUPk;
        "pkg-1.21-2.10.10-fabric" = _vuMF8yxA;
        "pkg-1.21-2.10.10-neoforge" = _qU8qsl9S;
        "pkg-1.21-2.10.11-fabric" = _arZ30lQc;
        "pkg-1.21-2.10.11-neoforge" = _MvcbkZih;
        "pkg-1.20-2.8.11-forge" = _cDyX4etc;
        "pkg-1.20-2.8.11-fabric" = _MLONRrT4;
        "pkg-1.20-2.8.12-forge" = _lFpsGBy6;
        "pkg-1.20-2.8.12-fabric" = _EUAJoPDa;
        "pkg-1.21-2.10.12-fabric" = _BsON6ITE;
        "pkg-1.21-2.10.12-neoforge" = _cuvEuGJI;
        "pkg-1.21-2.10.13-fabric" = _bljqMYeI;
        "pkg-1.21-2.10.13-neoforge" = _mZrQhjQO;
        "pkg-1.21-2.10.14-fabric" = _rYb3apwj;
        "pkg-1.21-2.10.14-neoforge" = _vNXXgNzK;
        "pkg-1.20-2.8.13-forge" = _OApRuFlY;
        "pkg-1.20-2.8.13-fabric" = _eI8Zu9tN;
        "pkg-1.20-2.8.14-forge" = _DgGDPbl9;
        "pkg-1.20-2.8.14-fabric" = _62tj8YF7;
        "pkg-1.20-2.8.15-forge" = _oIyvoBy6;
        "pkg-1.20-2.8.15-fabric" = _OTRoSWtP;
        "pkg-1.20-2.8.16-forge" = _32wANBo6;
        "pkg-1.20-2.8.16-fabric" = _r5wvBOQY;
        "pkg-1.20-2.8.17-forge" = _pztPAx2c;
        "pkg-1.20-2.8.17-fabric" = _ii51orkq;
        "pkg-1.20-2.9.0-forge" = _QeAScqwj;
        "pkg-1.20-2.9.0-fabric" = _Ke0rugJQ;
        "pkg-1.20-2.9.1-forge" = _ZmTNauR4;
        "pkg-1.20-2.9.1-fabric" = _dbVfeP6i;
        "pkg-1.20-2.9.2-forge" = _JNTDe4wV;
        "pkg-1.20-2.9.2-fabric" = _91eaWDrq;
        "pkg-1.21-2.11.1-neoforge" = _nzxva8Ax;
        "pkg-1.21-2.11.1-fabric" = _lF1VmG3x;
        "pkg-1.21-2.11.2-fabric" = _ZPHu46An;
        "pkg-1.21-2.11.2-neoforge" = _99895aRg;
        "pkg-1.21-2.11.3-fabric" = _lGagqcf3;
        "pkg-1.21-2.11.3-neoforge" = _5FI6vyKW;
        "pkg-1.20-2.9.3-forge" = _meShfX8q;
        "pkg-1.20-2.9.3-fabric" = _uypbXclS;
        "pkg-1.21-2.11.4-fabric" = _U4J2SIGO;
        "pkg-1.21-2.11.4-neoforge" = _jUq5MG3r;
        "pkg-1.20-2.9.4-forge" = _rSyyVia5;
        "pkg-1.20-2.9.4-fabric" = _Gv4PPaDw;
        "pkg-1.21-2.11.5-fabric" = _WfmoeAH2;
        "pkg-1.21-2.11.5-neoforge" = _iBHSmYWl;
        "pkg-1.21-2.11.6-fabric" = _UWBb07nL;
        "pkg-1.21-2.11.6-neoforge" = _suYS2tsa;
        "pkg-1.21-2.11.7-fabric" = _yVyAWR52;
        "pkg-1.21-2.11.7-neoforge" = _W3v6fmDi;
        "pkg-1.20-2.9.5-forge" = _ETLY8Wfe;
        "pkg-1.20-2.9.5-fabric" = _RDeq5v1x;
        "pkg-1.21-2.11.8-fabric" = _ADX8GnEV;
        "pkg-1.21-2.11.8-neoforge" = _R1nN1AKW;
        "pkg-1.21-2.11.9-fabric" = _CThEiJbs;
        "pkg-1.21-2.11.9-neoforge" = _R5ztj8ut;
        "pkg-1.20-2.9.6-forge" = _IYlmfSi7;
        "pkg-1.20-2.9.6-fabric" = _NYY3CLMB;
        "pkg-1.20-2.9.7-forge" = _HFNIbc5b;
        "pkg-1.20-2.9.7-fabric" = _FDxEf4VP;
        "pkg-1.20-2.9.8-forge" = _euwlwydU;
        "pkg-1.20-2.9.8-fabric" = _74p9Q2eG;
        "pkg-1.21-2.11.10-fabric" = _Aq8IeLYn;
        "pkg-1.21-2.11.10-neoforge" = _1iRMPaxJ;
        "pkg-1.21-2.11.11-fabric" = _yHvbg0Zu;
        "pkg-1.21-2.11.11-neoforge" = _KG3sGQtr;
        "pkg-1.21-2.11.12-fabric" = _6MCa43Mu;
        "pkg-1.21-2.11.12-neoforge" = _757BxVNK;
        "pkg-1.21-2.11.13-fabric" = _tJFd6Pko;
        "pkg-1.21-2.11.13-neoforge" = _OCj4KEwO;
        "pkg-1.19.2-2.5.36" = _PjUdiB5P;
        "pkg-1.20-2.9.9-forge" = _S6PhzmO8;
        "pkg-1.20-2.9.9-fabric" = _wzEYDoXP;
        "pkg-1.21-2.11.14-fabric" = _QY9zi8b0;
        "pkg-1.21-2.11.14-neoforge" = _gHLMRGIy;
        "pkg-1.21-2.11.15-fabric" = _fs8aDavv;
        "pkg-1.21-2.11.15-neoforge" = _7HWxLtLr;
        "pkg-1.21-2.11.16-fabric" = _Ct3TIDxV;
        "pkg-1.21-2.11.16-neoforge" = _g8y8NizH;
        "pkg-1.21-2.11.17-fabric" = _ElB149if;
        "pkg-1.21-2.11.17-neoforge" = _BF6WzhOX;
        "pkg-1.20-2.9.10-forge" = _GKpjrcTH;
        "pkg-1.20-2.9.10-fabric" = _supAJPmV;
        "pkg-1.20-2.9.11-forge" = _povHb769;
        "pkg-1.20-2.9.11-fabric" = _FheoZs6r;
        "pkg-1.20-2.9.12-forge" = _Wa7DK8Yb;
        "pkg-1.20-2.9.12-fabric" = _aUZ3gVKy;
        "pkg-1.21-2.11.18-fabric" = _aumzMYpM;
        "pkg-1.21-2.11.18-neoforge" = _yOyByPAg;
        "pkg-1.21-2.11.19-fabric" = _nP4AcNfs;
        "pkg-1.21-2.11.19-neoforge" = _TPL29ZMk;
        "pkg-1.21-2.11.20-fabric" = _iQ46j29j;
        "pkg-1.21-2.11.20-neoforge" = _7Nfu5pAk;
        "pkg-1.21-2.11.21-fabric" = _upBcRS1I;
        "pkg-1.21-2.11.21-neoforge" = _2LzN1Ef9;
        "pkg-1.21-2.11.22-fabric" = _cBXXYZu9;
        "pkg-1.21-2.11.22-neoforge" = _w1IUNI4F;
        "pkg-1.20-2.9.13-forge" = _QHk3kJYC;
        "pkg-1.20-2.9.13-fabric" = _rRPEmhmf;
        "pkg-1.21-2.11.23-fabric" = _kmmvtMsL;
        "pkg-1.21-2.11.23-neoforge" = _tTI0Msfm;
        "pkg-1.20-2.9.14-forge" = _1NKRJyBB;
        "pkg-1.20-2.9.14-fabric" = _7I6zWep0;
        "pkg-1.21-2.11.24-fabric" = _2EAUe49X;
        "pkg-1.21-2.11.24-neoforge" = _uc8dsG0Y;
        "pkg-1.20-2.9.15-fabric" = _eiKzZKPN;
        "pkg-1.20-2.9.15-forge" = _tkWAtsse;
        "pkg-1.21-2.11.25-neoforge" = _FoUM5LzL;
        "pkg-1.21-2.11.25-fabric" = _E54qnYOF;
        "pkg-1.21-2.11.26-fabric" = _stnPcKfY;
        "pkg-1.21-2.11.26-neoforge" = _V8IPXavG;
        "pkg-1.20-2.9.16-fabric" = _4zSpaqxY;
        "pkg-1.20-2.9.16-forge" = _PzLUDEeR;
        "pkg-1.20-2.9.17-fabric" = _wG2XYdpH;
        "pkg-1.20-2.9.17-forge" = _VfyRmElC;
        "pkg-1.21-2.11.27-fabric" = _BdvCrKzt;
        "pkg-1.21-2.11.27-neoforge" = _MgmTy7is;
        "pkg-1.21-2.11.28-fabric" = _vCRfrX4m;
        "pkg-1.21-2.11.28-neoforge" = _kh933o4T;
        "pkg-1.21-2.11.29-fabric" = _56HEHmGg;
        "pkg-1.21-2.11.29-neoforge" = _u6PmiTvJ;
        "pkg-1.21-2.11.30-fabric" = _D4HiJVUD;
        "pkg-1.21-2.11.30-neoforge" = _uvJ8XuwL;
        "pkg-1.21-2.11.31-fabric" = _zqLSAGCs;
        "pkg-1.21-2.11.31-neoforge" = _tl0cvKFe;
        "pkg-1.21-2.11.32-fabric" = _36gtxgtE;
        "pkg-1.21-2.11.32-neoforge" = _GBjVkH56;
        "pkg-1.20-2.9.18-fabric" = _Fk5BV3UA;
        "pkg-1.20-2.9.18-forge" = _FFHgFkhq;
        "pkg-1.21-2.11.33-fabric" = _z18yao9D;
        "pkg-1.21-2.11.33-neoforge" = _rwPQrt4O;
        "pkg-1.21-2.11.34-fabric" = _SOJszVlX;
        "pkg-1.21-2.11.34-neoforge" = _b2tEQWFF;
        "pkg-1.21-2.11.35-fabric" = _tfsHBicK;
        "pkg-1.21-2.11.35-neoforge" = _x5lJs0no;
        "pkg-1.21-2.11.36-fabric" = _GqiAPCgW;
        "pkg-1.21-2.11.36-neoforge" = _bL6BEDji;
        "pkg-1.20-2.9.19-fabric" = _E2jhPX76;
        "pkg-1.20-2.9.19-forge" = _dmuRUpun;
        "pkg-1.21-2.11.37-fabric" = _9GwYmlbd;
        "pkg-1.21-2.11.37-neoforge" = _RLxJkuOK;
        "pkg-1.20-2.9.20-fabric" = _eKKOPxRC;
        "pkg-1.20-2.9.20-forge" = _FcoqvoEO;
        "pkg-1.21-2.11.38-fabric" = _hYXinluH;
        "pkg-1.21-2.11.38-neoforge" = _JRLLH4as;
        "pkg-1.18.2-1.6.21" = _LziH2w1e;
        "pkg-1.21-2.11.39-fabric" = _yRwx9VSs;
        "pkg-1.21-2.11.39-neoforge" = _G05dfIMf;
        "pkg-1.21-2.11.40-fabric" = _6FpiZzNn;
        "pkg-1.21-2.11.40-neoforge" = _YqUPN8JN;
        "pkg-1.21-2.11.41-fabric" = _zUG2d8n7;
        "pkg-1.21-2.11.41-neoforge" = _TEwFP3Ii;
        "pkg-1.21-2.11.42-fabric" = _J32dLBfo;
        "pkg-1.21-2.11.42-neoforge" = _pVEFhHJv;
        "pkg-1.21-2.11.43-fabric" = _WCjsV8JI;
        "pkg-1.21-2.11.43-neoforge" = _4MRebU1s;
        "pkg-1.20-2.9.21-fabric" = _9v919U6l;
        "pkg-1.20-2.9.21-forge" = _OIajpwzU;
        "pkg-1.20-2.9.22-fabric" = _HiAKSSrF;
        "pkg-1.20-2.9.22-forge" = _tkbNIXga;
        "pkg-1.20-2.9.23-fabric" = _rh0HPyEB;
        "pkg-1.20-2.9.23-forge" = _6szn3OmY;
        "pkg-1.21-2.11.44-neoforge" = _Poj6Ne1U;
        "pkg-1.21-2.11.44-fabric" = _TwpLqgAC;
        "pkg-1.21-2.11.45" = _l4v4FcWO;
        "pkg-1.21-2.11.46" = _Q0sVyRBb;
        "pkg-1.20-2.9.24-fabric" = _wJfnAofM;
        ...
        "pkg-1.20-2.9.25-fabric" = _kMe8XwU1;
        "pkg-1.20-2.9.25-forge" = _irqS2aze;
