...
let
    ...
    in {
        ...
        "pkg-2.0" = _Jx2bA8fW;
        "pkg-2.0.1" = _wX0EkxBG;
        "pkg-2.1+1.18.2" = _UIPy4N6Y;
        "pkg-2.1+1.19" = _u6oZjWMI;
        "pkg-2.2+1.19" = _fwgB6xzq;
        "pkg-2.2+1.18.2" = _rbuG9j4d;
        "pkg-2.3+1.19" = _42x8E1l2;
        "pkg-2.3+1.18.2" = _I3ozSAMN;
        "pkg-2.4+1.18.2" = _UsI5wvVJ;
        "pkg-2.4+1.19" = _Ex7R0pvH;
        "pkg-2.5+1.18.2" = _bevKbyCT;
        "pkg-2.5+1.19" = _C9PPMB8n;
        "pkg-3.0+1.18.2" = _PUz7ZA69;
        "pkg-3.0+1.19" = _DnIkKSEu;
        "pkg-3.0.1+1.19" = _pKw86PFV;
        "pkg-3.0.1+1.18.2" = _L1X78OCz;
        "pkg-3.1+1.18.2" = _piwY5EqP;
        "pkg-3.1+1.19" = _KdZ4nnQf;
        "pkg-3.1.1+1.18" = _KCnkG2JM;
        "pkg-3.2+1.18.2" = _vOx5xdxw;
        "pkg-3.2+1.19" = _8cW3fCjp;
        "pkg-3.3+1.18.2" = _OojuYcAm;
        "pkg-3.3+1.19" = _SoTS6lF5;
        "pkg-3.3.1+1.18.2" = _JZoNSBuy;
        "pkg-3.3.1+1.19" = _N8iKshJP;
        "pkg-3.4+1.18.2" = _vOMoMaOE;
        "pkg-3.4+1.19" = _dSEqWeht;
        "pkg-3.5+1.18.2" = _6x22u0T1;
        "pkg-3.5+1.19" = _N3ze65Pu;
        "pkg-3.5.1+1.18.2" = _8npnkOAY;
        "pkg-3.5.1+1.19" = _JCXboA43;
        "pkg-3.6+1.19" = _GwfJ6OPL;
        "pkg-3.7+1.19" = _Q5W9seuT;
        "pkg-3.8+1.19" = _MDMciNGY;
        "pkg-3.9+1.19" = _DOxF1Usr;
        "pkg-3.10+1.19.2" = _kVzqYdl5;
        "pkg-3.11+1.19.2" = _hBz2RX9S;
        "pkg-3.5.2+1.18.2" = _mqjafYwh;
        "pkg-4.0+1.19.2" = _4XF7aDYQ;
        "pkg-4.0.1+1.19.3" = _PDcGuAk3;
        "pkg-4.1+1.19.2" = _dB2WXccw;
        "pkg-4.1+1.19.3" = _oE6ADLJm;
        "pkg-3.6+1.18.2" = _kBkiCSXP;
        "pkg-5.0b+1.19.2" = _KdRiHgim;
        "pkg-5.0b2+1.19.2" = _p8mFGtnA;
        "pkg-5.0+1.18.2" = _7pIz7Bqe;
        "pkg-5.0+1.19.2" = _HQNnNcTz;
        "pkg-5.0+1.19.3" = _b1MI0lNn;
        "pkg-5.1+1.18.2" = _XXp55Fwj;
        "pkg-5.1+1.19.2" = _aDXQGAnW;
        "pkg-5.1+1.19.3" = _7LySfCZd;
        "pkg-5.2+1.19.4" = _3Rj2xiej;
        "pkg-5.3+1.19.2" = _jdd7O6I5;
        "pkg-5.3+1.19.3" = _Bgo2WQoz;
        "pkg-5.3+1.19.4" = _1HKz8pDD;
        "pkg-5.3.1+1.19.2" = _zma0Z88N;
        "pkg-5.3.1+1.19.3" = _SnHjacoX;
        "pkg-5.3.1+1.19.4" = _XxwoXEjt;
        "pkg-5.4+1.19.2" = _oGBybcWG;
        "pkg-5.4+1.19.3" = _qSS7rxZG;
        "pkg-5.4+1.19.4" = _nhu2REPZ;
        "pkg-5.5+1.19.2" = _kgZyjYD0;
        "pkg-6.0+1.19.4" = _Q7LLoEz8;
        "pkg-6.1+1.19.4" = _VlilX4g3;
        "pkg-5.6+1.19.2" = _siGvzEkG;
        "pkg-6.2+1.19.4" = _pnStFlrz;
        "pkg-5.6.1+1.19.2" = _cR2jSKNv;
        "pkg-6.2.1+1.19.4" = _UwrH9Wmp;
        "pkg-7.0+1.20" = _5ABRCqrl;
        "pkg-7.0.1+1.20" = _wlHubjbx;
        "pkg-7.0.2+1.20" = _GaDrUzLS;
        "pkg-5.6.2+1.19.2" = _B8uyNMAs;
        "pkg-6.2.2+1.19.4" = _AF6KCHFM;
        "pkg-7.0.3+1.20" = _xMsvqe7U;
        "pkg-7.0.4+1.20" = _kV3gDaO6;
        "pkg-5.2+1.18.2" = _Afi523uo;
        "pkg-7.1+1.20" = _hUj6v5bw;
        "pkg-7.1+1.20.2" = _7POTmnEb;
        "pkg-7.2+1.20" = _BfvDyEpZ;
        "pkg-7.2+1.20.2-fabric" = _B3fvmlGz;
        "pkg-7.2+1.20.2-forge" = _N4UrisV7;
        "pkg-7.3+1.20.2-fabric" = _d5kHzOKy;
        "pkg-7.3+1.20.2-forge" = _ONH6Kqie;
        "pkg-7.3+1.20-fabric" = _YZEVRL4i;
        "pkg-7.3+1.20-forge" = _J6uJYksd;
        "pkg-5.7+1.19.2" = _ggoGe2EL;
        "pkg-5.7+1.19.3" = _1A4txeh8;
        "pkg-6.3+1.19.4" = _PlUmODOj;
        "pkg-7.4+1.20-fabric" = _OvVeBAYa;
        "pkg-7.4+1.20-forge" = _RqouYFCA;
        "pkg-7.4+1.20.2-fabric" = _yl7hdLYl;
        "pkg-7.4+1.20.2-forge" = _SgFUFMUD;
        "pkg-5.7.1+1.19.2" = _8x7iVA0A;
        "pkg-7.4.1+1.20-fabric" = _DLtLuMzW;
        "pkg-7.4.1+1.20-forge" = _Vk1E4s8i;
        "pkg-7.4.1+1.20.2-fabric" = _P70fS7oo;
        "pkg-7.4.1+1.20.2-forge" = _I1X42LQO;
        "pkg-7.5+1.20.2-fabric" = _GxY44U4X;
        "pkg-7.5+1.20.2-forge" = _vW2z45Qw;
        "pkg-7.6+1.20.2-fabric" = _gTjxflCI;
        "pkg-7.6+1.20.2-forge" = _8TADH0x4;
        "pkg-7.6+1.20.2-neoforge" = _nqnapHoW;
        "pkg-7.6+1.20.3-fabric" = _4Oy7MCbK;
        "pkg-7.6+1.20.3-forge" = _j6JI3Ye5;
        "pkg-7.6+1.20.3-neoforge" = _AKd5ifeI;
        "pkg-7.4.2+1.20-fabric" = _yI2M7Yw8;
        "pkg-7.4.2+1.20-forge" = _plDJhPkU;
        "pkg-7.6.1+1.20.2-fabric" = _TBUQvVSc;
        "pkg-7.6.1+1.20.2-forge" = _wrKCukUs;
        "pkg-7.6.1+1.20.2-neoforge" = _ob3ideD4;
        "pkg-7.6.2+1.20.4-fabric" = _1Cz6IyIk;
        "pkg-7.6.2+1.20.4-forge" = _z2n9Rh5O;
        "pkg-7.6.2+1.20.4-neoforge" = _83ZByaiI;
        "pkg-7.6.3+1.20.4-forge" = _vNnu7BoP;
        "pkg-7.4.4+1.20-fabric" = _9TBX0qkD;
        "pkg-7.4.4+1.20-forge" = _U4QPyiFl;
        "pkg-7.6.2+1.20.2-fabric" = _MneD8ExX;
        "pkg-7.6.2+1.20.2-forge" = _rp8sdu78;
        "pkg-7.6.2+1.20.2-neoforge" = _eCPSnqOy;
        "pkg-7.6.4+1.20.4-fabric" = _eRIHItNH;
        "pkg-7.6.4+1.20.4-forge" = _6W6aaYaB;
        "pkg-7.6.4+1.20.4-neoforge" = _qumfSFz3;
        "pkg-7.7+1.20.4-fabric" = _UrOG4IKT;
        "pkg-7.7+1.20.4-forge" = _PhOrxa0w;
        "pkg-7.7+1.20.4-neoforge" = _c7j11R0M;
        "pkg-7.8+1.20.5-fabric" = _5OHmUXr7;
        "pkg-7.8.1+1.20.6-fabric" = _dpEeHhG0;
        "pkg-8.0+1.21-fabric" = _f5ZXlx3Q;
        "pkg-8.0+1.21-neoforge" = _CPQFd6yO;
        "pkg-8.0.1+1.21-fabric" = _8QA0JAbA;
        "pkg-8.0.1+1.21-neoforge" = _E7hrxyB5;
        "pkg-8.0.2+1.21-fabric" = _AjOd8bzj;
        "pkg-8.0.2+1.21-neoforge" = _cUGjuUBN;
        "pkg-8.0.3+1.21-fabric" = _tvgAGEoG;
        "pkg-8.0.3+1.21-neoforge" = _1endrUCg;
        "pkg-8.1+1.21-fabric" = _pTukRirl;
        "pkg-8.1+1.21-neoforge" = _ok5RvpkL;
        "pkg-8.2+1.21.2-neoforge" = _M5VDZni4;
        "pkg-8.2+1.21.2-fabric" = _IYCvdwkL;
        "pkg-9.0+1.21.3-neoforge" = _wg3HCot6;
        "pkg-9.0+1.21.1-neoforge" = _Hhfv30vX;
        "pkg-9.0+1.20.6-neoforge" = _9GX3kMkT;
        "pkg-9.0+1.20.4-neoforge" = _vB8pWdIQ;
        "pkg-9.0+1.21.3-forge" = _dPXxp0VC;
        "pkg-9.0+1.21.1-forge" = _hVkKY3GS;
        "pkg-9.0+1.20.6-forge" = _IXE5ghQM;
        "pkg-9.0+1.20.6-fabric" = _y4OcxlHF;
        "pkg-9.0+1.20.4-forge" = _6NqYRrsf;
        "pkg-9.0+1.21.3-fabric" = _FyEBYYXl;
        "pkg-9.0+1.21.1-fabric" = _yxZN7vf3;
        "pkg-9.0+1.20.4-fabric" = _dfVak683;
        "pkg-9.0+1.20.1-forge" = _frs15ASP;
        "pkg-9.0+1.20.1-fabric" = _gjl7hdD3;
        "pkg-9.1+1.20.4-neoforge" = _4i3eCxEu;
        "pkg-9.1+1.21.3-forge" = _inVPhi3G;
        "pkg-9.1+1.21.1-forge" = _bjowxqA0;
        "pkg-9.1+1.20.6-forge" = _lJPKZ9xV;
        "pkg-9.1+1.20.4-forge" = _qTrUZMqg;
        "pkg-9.1+1.20.1-forge" = _wyyq8wFt;
        "pkg-9.2+1.21.3-forge" = _9GFDdReh;
        "pkg-9.2+1.21.1-forge" = _chcQgv2X;
        "pkg-9.2+1.21.3-neoforge" = _NWtNRtGl;
        "pkg-9.2+1.21.1-neoforge" = _m5Xm5uBr;
        "pkg-9.2+1.20.6-neoforge" = _CunpNlL0;
        "pkg-9.2+1.20.6-forge" = _ZJ5Blcwy;
        "pkg-9.2+1.20.4-neoforge" = _oJPUbiv4;
        "pkg-9.2+1.20.1-forge" = _I6nsd3Dl;
        "pkg-9.2+1.20.4-forge" = _lWjG25lJ;
        "pkg-9.2+1.21.3-fabric" = _e974mC6T;
        "pkg-9.2+1.21.1-fabric" = _jKgj2lfQ;
        "pkg-9.2+1.20.6-fabric" = _O0zgjTWB;
        "pkg-9.2+1.20.4-fabric" = _efyKPiRu;
        "pkg-9.2+1.20.1-fabric" = _eXWbHEwt;
        "pkg-9.3+1.20.4-neoforge" = _oX9VSQRM;
        "pkg-9.3+1.21.3-neoforge" = _G9copH9h;
        "pkg-9.3+1.21.1-neoforge" = _j86Sf3h1;
        "pkg-9.3+1.21.3-forge" = _JJUBgi31;
        "pkg-9.3+1.20.6-neoforge" = _cphXOZdI;
        "pkg-9.3+1.20.1-forge" = _JHnOGkEy;
        "pkg-9.3+1.21.1-forge" = _WkDp6Y2n;
        "pkg-9.3+1.20.6-forge" = _Qu5QJm7M;
        "pkg-9.3+1.21.1-fabric" = _90veqqHz;
        "pkg-9.3+1.20.6-fabric" = _2LUmKBiG;
        "pkg-9.3+1.21.3-fabric" = _CpaeqowJ;
        "pkg-9.3+1.20.4-forge" = _yBXIdgI8;
        "pkg-9.3+1.20.1-fabric" = _jwS20yNo;
        "pkg-9.3+1.20.4-fabric" = _UGcTe0js;
        "pkg-9.4+1.21.5-fabric" = _VsVDZkpZ;
        "pkg-9.5+1.21.6-fabric" = _PQqfGd1s;
        "pkg-9.5+1.21.6-neoforge" = _SrPzKTR0;
        "pkg-9.6+1.21.1-fabric" = _RoDZEags;
        "pkg-9.6+1.20.1-fabric" = _oUEx3cFy;
        "pkg-9.6+1.21.3-fabric" = _XAXG1U4q;
        "pkg-9.6+1.21.1-neoforge" = _ZpZwrXPn;
        "pkg-9.6+1.21.1-forge" = _2AFvptP8;
        "pkg-9.6+1.20.1-forge" = _Y8V8ugtm;
        "pkg-9.6+1.21.6-fabric" = _dSPRONS8;
        "pkg-9.6+1.21.5-neoforge" = _nA8JIpi7;
        "pkg-9.6+1.21.3-neoforge" = _XBpEZ28o;
        "pkg-9.6+1.21.3-forge" = _8pLi3qeP;
        "pkg-9.6+1.21.6-neoforge" = _jH14WyFU;
        "pkg-9.6+1.21.6-forge" = _vsyY2uvx;
        "pkg-9.6+1.21.5-fabric" = _eyuiovgD;
        "pkg-9.7.1+1.21.1-neoforge" = _SoaoXAAt;
        "pkg-9.7.1+1.21.3-neoforge" = _8Vlm0kCf;
        "pkg-9.7.1+1.21.6-neoforge" = _BFWLQUTS;
        "pkg-9.7.1+1.21.5-neoforge" = _OSi0HSM1;
        "pkg-9.8+1.21.1-forge" = _s89tG7MW;
        "pkg-9.8+1.21.1-fabric" = _k1nO7rw2;
        "pkg-9.8+1.21.3-fabric" = _hp9aDrqo;
        "pkg-9.8+1.21.1-neoforge" = _A0S30Mxk;
        "pkg-9.8+1.21.3-neoforge" = _Ii2ewatk;
        "pkg-9.8+1.20.1-fabric" = _ZaxWuWyl;
        "pkg-9.8+1.21.3-forge" = _oSNEFYWB;
        "pkg-9.8+1.21.5-fabric" = _Ymf4vAGW;
        "pkg-9.8+1.21.5-neoforge" = _igoMMW5E;
        "pkg-9.8+1.21.6-fabric" = _b821t23w;
        "pkg-9.8+1.20.1-forge" = _K6X4guC9;
        "pkg-9.8+1.21.6-forge" = _fpojWPrv;
        "pkg-9.8+1.21.6-neoforge" = _wCfDY8gQ;
        "pkg-9.9+1.21.9-fabric" = _EQ744WU3;
        "pkg-9.9+1.21.9-neoforge" = _Y3Vygzls;
        "pkg-9.9+1.21.9-forge" = _FQSH73ws;
        "pkg-9.10+1.20.1-fabric" = _kiEtbqAW;
        "pkg-9.10+1.21.1-fabric" = _79wERqfk;
        "pkg-9.10+1.21.3-fabric" = _VnZHh5LV;
        "pkg-9.10+1.21.1-neoforge" = _FUpfKswj;
        "pkg-9.10+1.21.1-forge" = _GMoSXPJa;
        "pkg-9.10+1.20.1-forge" = _zK3mtR2I;
        "pkg-9.10+1.21.3-neoforge" = _OwJHJG8W;
        "pkg-9.10+1.21.3-forge" = _eLn6vquR;
        "pkg-9.10+1.21.5-fabric" = _ZtpHL0d2;
        "pkg-9.10+1.21.6-fabric" = _vjjl8mqq;
        "pkg-9.10+1.21.5-neoforge" = _5CgTxJZw;
        "pkg-9.10+1.21.6-forge" = _4FJLhD1E;
        "pkg-9.10+1.21.6-neoforge" = _vEJ5I6kb;
        "pkg-9.10+1.21.9-fabric" = _mzF4DLVO;
        "pkg-9.10+1.21.9-neoforge" = _i1ljcudb;
        "pkg-9.10+1.21.9-forge" = _TnrW9XMJ;
        "pkg-9.11+1.21.3-fabric" = _SeOckiLH;
        "pkg-9.11+1.21.1-fabric" = _ubTNYZuL;
        "pkg-9.11+1.21.11-neoforge" = _2EOxsCPp;
        "pkg-9.11+1.21.11-fabric" = _9p0w9Gon;
        "pkg-9.11+1.21.3-neoforge" = _vUhTtwV6;
        "pkg-9.11+1.21.1-neoforge" = _RShcBQz5;
        "pkg-9.11+1.21.6-fabric" = _wtGWgeFI;
        "pkg-9.11+1.21.9-neoforge" = _uWpIqbC1;
        "pkg-9.11+1.21.5-fabric" = _xEzxrd5o;
        "pkg-9.11+1.21.5-neoforge" = _50P0a0Wp;
        "pkg-9.11+1.21.6-neoforge" = _htXlAO5f;
        "pkg-9.11+1.21.9-fabric" = _RgrSldiN;
