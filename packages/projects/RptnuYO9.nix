...
let
    ...
    in {
        ...
        "pkg-0.9.2" = _7bQo0bZy;
        "pkg-0.9.3" = _9wDCqMDL;
        "pkg-0.10.0" = _aIQjnvXc;
        "pkg-0.10.1" = _TFvrXxBF;
        "pkg-0.10.2" = _hH7QbFfa;
        "pkg-0.10.3" = _8p6tmTKQ;
        "pkg-0.10.4" = _YHTCgKV9;
        "pkg-0.11.0" = _vI2EaxgL;
        "pkg-0.12.0" = _ZxzzIpJk;
        "pkg-0.12.1" = _wnlT5kM4;
        "pkg-0.12.2" = _y5MLcM1X;
        "pkg-0.13.0" = _eHndByqs;
        "pkg-0.13.1" = _jmWYLwgF;
        "pkg-0.13.2" = _JIXWKcxH;
        "pkg-0.14.0" = _6h9HU167;
        "pkg-0.14.1" = _an8MCTug;
        "pkg-0.14.2" = _bnsYAwsj;
        "pkg-0.14.3" = _aVk5DPy5;
        "pkg-0.14.4" = _o2EDQHwc;
        "pkg-0.15.0" = _joiwk2OK;
        "pkg-0.16.0" = _uBcvHkRR;
        "pkg-0.16.1" = _3wftdchk;
        "pkg-0.17.0" = _czCl5X1F;
        "pkg-0.18.0" = _exvvYhfZ;
        "pkg-0.19.0" = _CRv0i3Y0;
        "pkg-0.19.1" = _mrufNvji;
        "pkg-0.19.2" = _e2gwSkyk;
        "pkg-0.19.3" = _JpRbESG6;
        "pkg-0.20.0" = _xmopbXpU;
        "pkg-0.20.1" = _vJcb6TCf;
