...
let
    versions = (let
        ...
        _4KHBHToB = {
            "id" = "4KHBHToB";
            "file" = "versiont-library-1.3.1.jar";
            "hash" = "sha512-C2oj5E6sf8SanWyL55n3+xH5IQ8Bwh8YyLKt9zuEtiDwzgrzdzwiwvW3lwHlEnsaOuTIKv48ocZhFIOS5RbK7Q==";
        };
        _HMgMHJIG = {
            "id" = "HMgMHJIG";
            "file" = "versiont-library-1.3.2.jar";
            "hash" = "sha512-Q88sTmkgUVESO+9HaXNeOiJZJV4PVSp4BMN9t7W9IiDBikMW8/d8jBtPKFAST8Qufv0sKSIs3InLFJz4G2Mmag==";
        };
    in {
        "iED1knzW" = _iED1knzW;
        "AVkZUF86" = _AVkZUF86;
        ...
        "4KHBHToB" = _4KHBHToB;
        "HMgMHJIG" = _HMgMHJIG;
        "fabric-1.17" = _HMgMHJIG;
        "fabric-1.17.1" = _HMgMHJIG;
        "fabric-1.18" = _HMgMHJIG;
        "fabric-1.18.1" = _HMgMHJIG;
        "fabric-1.18.2" = _HMgMHJIG;
        "fabric-1.19" = _HMgMHJIG;
        "fabric-1.19.1" = _HMgMHJIG;
        "fabric-1.19.2" = _HMgMHJIG;
        "fabric-1.19.3" = _HMgMHJIG;
        "fabric-1.19.4" = _HMgMHJIG;
        "fabric-1.20" = _HMgMHJIG;
        "fabric-1.20.1" = _HMgMHJIG;
        "fabric-1.20.2" = _HMgMHJIG;
        "fabric-1.20.3" = _HMgMHJIG;
        "fabric-1.20.4" = _HMgMHJIG;
        "fabric-1.20.5" = _HMgMHJIG;
        "fabric-1.20.6" = _HMgMHJIG;
        "fabric-1.21" = _HMgMHJIG;
        "fabric-1.21.1" = _HMgMHJIG;
        "fabric-1.21.2" = _HMgMHJIG;
        "fabric-1.21.3" = _HMgMHJIG;
        "fabric-1.21.4" = _HMgMHJIG;
        "fabric-1.21.5" = _HMgMHJIG;
        "fabric-1.21.6" = _HMgMHJIG;
        "fabric-1.21.7" = _HMgMHJIG;
        "fabric-1.21.8" = _HMgMHJIG;
        "fabric-1.21.9" = _HMgMHJIG;
        "fabric-1.21.10" = _HMgMHJIG;
        "fabric-1.21.11" = _HMgMHJIG;
        "fabric-26.1" = _HMgMHJIG;
        "fabric-26.1.1" = _HMgMHJIG;
        "fabric-26.1.2" = _HMgMHJIG;
        "fabric-26.2" = _HMgMHJIG;
        "pkg-0.0.1" = _iED1knzW;
        "pkg-0.0.2" = _AVkZUF86;
        "pkg-0.0.3" = _wlHOT4an;
        "pkg-0.0.4" = _O6z5NpZH;
