...
let
    ...
    in {
        ...
        "fabric-1.20" = _U6Xm07Qz;
        "fabric-1.20.1" = _U6Xm07Qz;
        "fabric-1.20.2" = _U6Xm07Qz;
        "fabric-1.20.3" = _U6Xm07Qz;
        "fabric-1.20.4" = _U6Xm07Qz;
        "fabric-1.20.5" = _U6Xm07Qz;
        "fabric-1.20.6" = _U6Xm07Qz;
        ...
        "fabric-26.2" = _U6Xm07Qz;
        "pkg-1.0.0" = _t1wncVNW;
        "pkg-1.2-SNAPSHOT" = _SJno1aBj;
        "pkg-1.3-SNAPSHOT" = _MOceFPKy;
        "pkg-2.0-RELEASE" = _rxtG0Dbi;
        "pkg-2.2-RELEASE" = _kCZcb5J9;
        "pkg-2.3-RELEASE-1.21.4" = _qCtc8oU8;
        "pkg-3.0-RELEASE-1.21.4" = _rTktXsIB;
        "pkg-3.1-RELEASE-1.21.4" = _jKUxZIjJ;
        "pkg-3.4-RELEASE-1.21.4" = _naa19Co7;
        "pkg-3.5-RELEASE-1.21.4" = _NjiQsx8Y;
        "pkg-3.7-RELEASE-1.21.4" = _BbvzBszY;
        "pkg-3.8-RELEASE-1.21.4" = _WaGWccRh;
        "pkg-4.0-RELEASE-1.21.4" = _vKjsVBoq;
        "pkg-4.3-RELEASE-1.21.4" = _OVlSDp4Y;
        "pkg-4.4-RELEASE-1.21.4" = _2mVSCuht;
        "pkg-4.5-RELEASE-1.21.4" = _L6kn8Sas;
        "pkg-4.67-RELEASE-1.21.4" = _NtgnAV3f;
        "pkg-4.7-RELEASE-1.21.4" = _3iG3Fvme;
        "pkg-4.8-RELEASE-1.21.4" = _XeBCq325;
        "pkg-4.9-RELEASE-1.21.4" = _oJKdchbP;
        "pkg-5.0-RELEASE-1.21.4" = _jZXF9pj4;
        "pkg-5.1-RELEASE-1.21.4" = _FtY9NYcP;
        "pkg-5.2-RELEASE-1.21.4" = _T6doEKWm;
        "pkg-5.3-RELEASE-1.21.4" = _rKBt4PPg;
        "pkg-5.4-RELEASE-1.21.4" = _OFAJH4Nf;
        "pkg-5.6-RELEASE" = _CdZZBMRW;
        "pkg-5.7-RELEASE" = _U6Xm07Qz;
        "default" = _U6Xm07Qz;
    });
