...
let
    ...
    in {
        ...
        "pkg-1.15.2-v1.29.1" = _2XZThkfm;
        "pkg-1.12.2-v1.19.54" = _mJSyAcOt;
        "pkg-1.18.2-v1.34.15" = _YONhO2yU;
        "pkg-1.16.5-v1.34.15" = _v7WaAN6v;
        "pkg-1.18.2-v1.34.17" = _wvRrIQGu;
        "pkg-1.16.5-v1.34.17" = _S31vvsdt;
        "pkg-1.19.0-v1.34.22" = _IFX4juXB;
        "pkg-1.18.2-v1.34.21" = _z4C6jeAt;
        "pkg-1.16.5-v1.34.20" = _DbrQFysz;
        "pkg-1.19.0-v1.34.23" = _ug5fb6Vy;
        "pkg-1.19.1-v1.34.33" = _r9aCjCG7;
        "pkg-1.18.2-v1.34.33" = _k3znWhCl;
        "pkg-1.16.5-v1.34.33" = _PMUMGSpF;
        "pkg-1.16.5-v1.34.38" = _AJnbTCcD;
        "pkg-1.18.2-v1.34.38" = _QFqx5Lno;
        "pkg-1.19.3-v1.34.38" = _TS1q6FYf;
        "pkg-1.16.5-v1.34.41" = _4X7867uy;
        "pkg-1.18.2-v1.34.41" = _OnZR4NP8;
        "pkg-1.19.2-v1.34.41" = _cZRE8dQk;
        "pkg-1.19.3-v1.34.41" = _VDBbxgFq;
        "pkg-1.19.3-v1.34.42" = _ngqUiNmW;
        "pkg-1.19.2-v1.34.42" = _9P4w7NqC;
        "pkg-1.18.2-v1.34.42" = _Ib4dHcOb;
        "pkg-1.16.5-v1.34.42" = _9Cs9DFq9;
        "pkg-1.34.43" = _aqqhLbqz;
        "pkg-1.19.4-v1.34.44" = _EQNJzcPk;
        "pkg-1.20.0-v1.34.44" = _9Vg2GnLb;
        "pkg-1.16.5-v1.34.45" = _SA3KKLTM;
        "pkg-1.18.2-v1.34.45" = _KShyPQc8;
        "pkg-1.19.2-v1.34.45" = _pg2MTu4p;
        "pkg-1.20.0-v1.34.45" = _1T8792bh;
        "pkg-1.16.5-v1.34.51" = _eUoyJ4xi;
        "pkg-1.18.2-v1.34.51" = _nAnVaopd;
        "pkg-1.19.2-v1.34.51" = _m64kmrqu;
        "pkg-1.20.1-v1.34.51" = _v42mwbDW;
        "pkg-1.16.5-v1.34.54" = _mEPCKMdV;
        "pkg-1.18.2-v1.34.54" = _W0K3QjOi;
        "pkg-1.19.2-v1.34.54" = _331zZRAH;
        "pkg-1.20.1-v1.34.54" = _ruHhx0p1;
        "pkg-1.34.63" = _nLM9c6l2;
        "pkg-1.34.64" = _dHPjrb7b;
        "pkg-1.35.3" = _RjHhNOQ2;
        "pkg-1.35.12" = _nQ1eUjfc;
        "pkg-1.35.16" = _lwhZ1vKs;
        "pkg-1.35.18" = _4GW1iS63;
        "pkg-1.20.1-v1.34.74" = _iP9fAEwX;
        "pkg-1.36.0" = _U3OazJJs;
        "pkg-1.36.5" = _K16otFn9;
