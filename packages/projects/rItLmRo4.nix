...
let
    versions = (let
        ...
        _CD4JW0P6 = {
            "id" = "CD4JW0P6";
            "file" = "mishanguc-1.6.5-alpha.1-1.20.1.jar";
            "hash" = "sha512-nX8EyldR+LP+nNzlwnKxx3t2Vl2LcEEjxu6XwZAIsF7ZtETfUcKVvgsW87rcFHRr4/KYQO2v6wAaeZINjMDePw==";
        };
        _NAygnnFq = {
            "id" = "NAygnnFq";
            "file" = "mishanguc-1.6.5-alpha.1-1.21.1.jar";
            "hash" = "sha512-x1V8YDMJbtRtW4cmjss2K/mOR1Mtt1h/Lpm429Jw09CDrqtJUTHCUXcbLXugiejI6TncpDqops9VQjRSCjLhPA==";
        };
        _Aktk8HcD = {
            "id" = "Aktk8HcD";
            "file" = "mishanguc-1.6.5-alpha.2-1.21.1.jar";
            "hash" = "sha512-EvIBIBrpAkRva+6kQUltTRvbRImYg8S+9FcVm/VkX2LGjUsBoKtcnxklzqY8qYmMQqFA9/HGFG72qybYaCe2Tg==";
        };
        _Mi5kuVeq = {
            "id" = "Mi5kuVeq";
            "file" = "mishanguc-1.6.5+mc26.1.2.jar";
            "hash" = "sha512-Z2ot9M2JAcQFX3VJmEWbI/RYISrN/CxU4dMrj8opSfuMAB+iu3Uo58bNzU0IIHTUZF4r2awkDs5oiJTWukykuA==";
        };
        _Yxtx8MSz = {
            "id" = "Yxtx8MSz";
            "file" = "mishanguc-1.6.5+mc1.21.11.jar";
            "hash" = "sha512-7cprABQg7BHOQStwdzmTg/8EF+79F1czzl81jxnJZzxvPMimJqFM9lOq+jWuxuFRIEEPHQ+5F/SLyT8DxiDMyA==";
        };
        _hUSqBx9l = {
            "id" = "hUSqBx9l";
            "file" = "mishanguc-1.6.5+mc1.21.10.jar";
            "hash" = "sha512-efAydKHUmCeofBDzUbxdBbP2NniTYmuI3toGve2J9C55MbQd9qu4PY2D9ekA4dygvrONLyKX8BLrGPiZzpiA4A==";
        };
        _KwienPrt = {
            "id" = "KwienPrt";
            "file" = "mishanguc-1.6.5+mc1.21.8.jar";
            "hash" = "sha512-JYYAbxVq9I2ksrrzzxGnOMbNaU+xPsoKUtrmatPf6EnM2092Lv+fuREubb9cLKUItRG4QLgVKlvYMjkmTujDbQ==";
        };
        _72Bf74FQ = {
            "id" = "72Bf74FQ";
            "file" = "mishanguc-1.6.5+mc1.21.5.jar";
            "hash" = "sha512-93eNoc/4d3N9rsvmDZRrf8H2Q2Qsyz1aDAGS1vP07sNCpi4x8mj42w+EAh1wgowPsCdvHtb3ufs9r+GxoG7Oiw==";
        };
        _e273ZZes = {
            "id" = "e273ZZes";
            "file" = "mishanguc-1.6.5+mc1.21.4.jar";
            "hash" = "sha512-kbl8QEUTAEuxIK4/I+ynjnqpzuQ2/ZGMidXi32glbtb8gXmpuBXh7TVaL1yuE7d61wMquFunMEEEpJTXAcLPIg==";
        };
        _Ma3OqBsD = {
            "id" = "Ma3OqBsD";
            "file" = "mishanguc-1.6.5+mc1.21.3.jar";
            "hash" = "sha512-LQUw4BQGOZGopl/c04s1bzVyc6qeR13TtxBAxg9fBhiln83YpzDaZk59Zllft/07J1Wt0r0gq1cxUt5zzF8cjg==";
        };
        _lXQ4OQpH = {
            "id" = "lXQ4OQpH";
            "file" = "mishanguc-1.6.5+mc1.21.1.jar";
            "hash" = "sha512-vbOniLcuEEGZLs4jSb554xn6FO2jULfdAZ6e0GNKg3BhPTJcWZCjdXnJHFQN7GvLWOS41c+/nHqGPRROyLQtOw==";
        };
        _O2gqVaaH = {
            "id" = "O2gqVaaH";
            "file" = "mishanguc-1.6.5+mc1.20.1.jar";
            "hash" = "sha512-US1mpqMM//hnUbdobAd3Sm5ByEvKrdlIjMCsHu0qY6yzYisXmIIv5nv22Z2ioxxJXxJNAtk8sBVu6x9baNqm1w==";
        };
    in {
        "7XAAuCEs" = _7XAAuCEs;
        "eNd8jYRK" = _eNd8jYRK;
        ...
        "fabric-1.20" = _O2gqVaaH;
        "fabric-1.20.1" = _O2gqVaaH;
        ...
        "fabric-1.21.1" = _lXQ4OQpH;
        "fabric-1.21.2" = _Ma3OqBsD;
        "fabric-1.21.3" = _Ma3OqBsD;
        "fabric-1.21.4" = _e273ZZes;
        "fabric-1.21.5-rc1" = _u8RdcdsG;
        "fabric-1.21.5" = _72Bf74FQ;
        "fabric-1.21.6-rc1" = _4zG7IjuC;
        "fabric-1.21.6" = _qACFiUFG;
        "fabric-1.21.7" = _KwienPrt;
        "fabric-1.21.8" = _KwienPrt;
        "fabric-1.21.9" = _hUSqBx9l;
        "fabric-1.21.10" = _hUSqBx9l;
        "fabric-1.21.11" = _Yxtx8MSz;
        "fabric-26.1.1" = _Mi5kuVeq;
        "fabric-26.1" = _Mi5kuVeq;
        "fabric-26.1.2" = _Mi5kuVeq;
        "pkg-0.1.4" = _7XAAuCEs;
        "pkg-0.1.5" = _eNd8jYRK;
        "pkg-0.1.6" = _doqvVenn;
        "pkg-0.1.7" = _ZMKSfGGx;
        "pkg-0.2.0" = _szIivTHc;
        "pkg-0.2.1" = _1VeQk2C0;
        "pkg-0.2.1-1.19.1" = _gCb5G1A5;
        "pkg-0.2.3-1.19.2" = _KfbuSmrf;
        "pkg-0.2.3-1.19" = _OPnF0I8F;
        "pkg-0.2.3-1.18.2" = _xqkd2Co4;
        "pkg-0.2.3-1.18.1" = _tqqkJ2wl;
        "pkg-0.2.3-1.17.1" = _ZxHbcAEG;
        "pkg-0.2.3-1.16.5" = _MSCsRtmO;
        "pkg-0.2.4-1.19.2" = _iSH5u1zG;
        "pkg-0.2.4-1.19" = _rYNeosoT;
        "pkg-0.2.4-1.18.2" = _WZttHppC;
        "pkg-0.2.4-1.18.1" = _r94J5DfB;
        "pkg-0.2.4-1.17.1" = _GKWT68wT;
        "pkg-0.2.4-1.16.5" = _sxlkhKsE;
        "pkg-1.0.0-1.19.2" = _EW0Wb8pV;
        "pkg-1.0.0-1.19" = _oeeNwADn;
        "pkg-1.0.0-1.18.2" = _Jg2SXR2n;
        "pkg-1.0.0-1.18.1" = _NZbl0ezE;
        "pkg-1.0.0-1.17.1" = _NLoLPfNa;
        "pkg-1.0.0-1.16.5" = _Mz7hIRaF;
        "pkg-1.0.1-1.16.5" = _WbmqsdFj;
        "pkg-1.0.1-1.17.1" = _AGlsplQo;
        "pkg-1.0.1-1.18.1" = _2hq1WVtI;
        "pkg-1.0.1-1.18.2" = _AjVxKMR4;
        "pkg-1.0.1-1.19" = _FOaz0eW6;
        "pkg-1.0.1-1.19.2" = _pHGZzYzg;
        "pkg-1.0.2-1.16.5" = _TQtT1m1K;
        "pkg-1.0.2-1.17.1" = _faj3MMbY;
        "pkg-1.0.2-1.18.1" = _NOjJ1vRw;
        "pkg-1.0.2-1.18.2" = _PVVRyhEG;
        "pkg-1.0.2-1.19" = _rRDCAbSa;
        "pkg-1.0.2-1.19.2" = _B5jT2Xi3;
        "pkg-1.0.3-1.19.2" = _YF2UPK2e;
        "pkg-1.0.3-1.19" = _dtA4WWjo;
        "pkg-1.0.3-1.18.2" = _tGo5V9aw;
        "pkg-1.0.3-1.18.1" = _8lw4lb74;
        "pkg-1.0.3-1.17.1" = _tI3HRV3z;
        "pkg-1.0.3-1.16.5" = _PjkqDD14;
        "pkg-1.0.4-build.2-1.19.3-rc1" = _cwbm53AQ;
        "pkg-1.0.4-1.16.5" = _eflY1rhk;
        "pkg-1.0.4-1.17.1" = _1qpc3rRO;
        "pkg-1.0.4-1.18.1" = _NG36rWnD;
        "pkg-1.0.4-1.18.2" = _10Aa3CMs;
        "pkg-1.0.4-1.19" = _bVnNwqcN;
        "pkg-1.0.4-1.19.2" = _yFwLpeco;
        "pkg-1.0.4-build.3-1.19.3-rc1" = _3UYXHcAm;
        "pkg-1.0.4-1.19.3" = _1OyOvvWK;
        "pkg-1.1.0-1.16.5" = _wQGzNIhP;
        "pkg-1.1.0-1.17.1" = _fXf1Bc2H;
        "pkg-1.1.0-1.18.1" = _kP25Hcmq;
        "pkg-1.1.0-1.18.2" = _qcg8Xr4j;
        "pkg-1.1.0-1.19" = _E4I4fUe1;
        "pkg-1.1.0-1.19.2" = _FWnVF90S;
        "pkg-1.1.0-1.19.3" = _7ac6zesV;
        "pkg-1.1.1-1.17.1" = _CGmX5ufa;
        "pkg-1.1.1-1.16.5" = _KMaRlwge;
        "pkg-1.1.1-1.18.1" = _H9uH9LtC;
        "pkg-1.1.1-1.18.2" = _dICacPCx;
        "pkg-1.1.1-1.19" = _LUcYlKgZ;
        "pkg-1.1.1-1.19.2" = _ABvpHNfi;
        "pkg-1.1.1-1.19.3" = _98iliPV4;
        "pkg-1.1.1-build.1-23w07a" = _2OuBNtYq;
        "pkg-1.1.1-build.4-1.19.4-rc2" = _1nL4pL2S;
        "pkg-1.1.1-build.5-1.19.4" = _Dul1suQD;
        "pkg-1.2.0-build.2-1.16.5" = _nz4rk88O;
        "pkg-1.2.0-build.2-1.17.1" = _pCZaKnmM;
        "pkg-1.2.0-build.2-1.18.1" = _E8w4S11Q;
        "pkg-1.2.0-build.2-1.18.2" = _RwLQvykm;
        "pkg-1.2.0-build.2-1.19.2" = _7J0Obpph;
        "pkg-1.2.0-build.2-1.19.3" = _yFU7t90V;
        "pkg-1.2.0-build.2-1.19.4" = _viVnhO20;
        "pkg-1.2.0-1.19.4" = _fO30XSFJ;
        "pkg-1.2.0-1.19.3" = _1AWExGG7;
        "pkg-1.2.0-1.19.2" = _2co3V9dY;
        "pkg-1.2.0-1.18.2" = _C4JIi6u4;
        "pkg-1.2.0-1.18.1" = _289OD83s;
        "pkg-1.2.0-1.17.1" = _kyJZWDd3;
        "pkg-1.2.0-1.16.5" = _M8DRNWje;
        "pkg-1.2.1-1.18.2" = _GiBw0tD7;
        "pkg-1.2.1-1.19.2" = _qEV4DQxU;
        "pkg-1.2.1-1.19.3" = _MapBBO4d;
        "pkg-1.2.1-1.19.4" = _8rvvOzlN;
        "pkg-1.2.1-1.18.1" = _wY3ASevW;
        "pkg-1.2.1-1.17.1" = _B8fwovbI;
        "pkg-1.2.1-1.16.5" = _ApcKMiNW;
        "pkg-1.2.1-beta.1-1.20-pre1" = _5Q7PRYbr;
        "pkg-1.2.2-beta.2-1.20-pre4" = _WRWrxzsU;
        "pkg-1.2.2-1.20" = _vBehHHa3;
        "pkg-1.2.2-1.20.1" = _CVC3NPHh;
        "pkg-1.2.3-1.20.1" = _tPz7rmPW;
        "pkg-1.2.3-1.19.4" = _oQX76age;
        "pkg-1.2.3-1.19.3" = _TwHFPZFi;
        "pkg-1.2.3-1.19.2" = _eWRtv0iQ;
        "pkg-1.2.3-1.18.2" = _Vq8LcItU;
        "pkg-1.2.4-1.20.1" = _xl6QeNOd;
        "pkg-1.2.4-1.19.4" = _iGJwSw5Q;
        "pkg-1.2.4-1.19.3" = _4QDqbcyg;
        "pkg-1.2.4-1.19.2" = _FHqxf9Ut;
        "pkg-1.2.4-1.18.2" = _XHUUc0cA;
        "pkg-1.2.5-1.20.1" = _AqDKP8x6;
        "pkg-1.2.5-1.19.4" = _QZqLutrM;
        "pkg-1.2.5-1.19.3" = _FKIx2Nla;
        "pkg-1.2.5-1.19.2" = _RYfMxmp1;
        "pkg-1.2.5-1.18.2" = _aTdZ8gzb;
        "pkg-1.2.5-beta.1-1.20.2-pre4" = _ap6LFSAW;
        "pkg-1.2.5-1.20.2" = _T3eOxTzO;
        "pkg-1.2.6-1.20.2" = _n0iNRR7b;
        "pkg-1.2.6-beta.1-1.20.4" = _x54JNLC7;
        "pkg-1.2.7-1.20.4" = _E2oKMSQ3;
        "pkg-1.2.7-1.20.2" = _hGo2IpdR;
        "pkg-1.2.7-1.20.1" = _NdF2vB2l;
        "pkg-1.2.7-1.19.4" = _6TRAqmfm;
        "pkg-1.2.7-1.19.3" = _QDvn9R0C;
        "pkg-1.2.7-1.19.2" = _qYOSXGeH;
        "pkg-1.2.7-1.18.2" = _buYJBqiR;
        "pkg-1.3.0-1.20.1" = _ROaYXjl9;
        "pkg-1.3.0-1.20.2" = _EAYhYQay;
        "pkg-1.3.0-1.20.4" = _p3k7F6GG;
        "pkg-1.3.1-alpha.1-1.20.5" = _cnqUfylu;
        "pkg-1.3.1-beta.1-1.20.6" = _WM9cRXPk;
        "pkg-1.3.1-beta.2-1.21" = _MtGrYCm3;
        "pkg-1.3.1-1.21" = _Hy6aD8cu;
        "pkg-1.3.1-1.20.6" = _JRVdOmUg;
        "pkg-1.3.2-1.20.6" = _boMIvk6R;
        "pkg-1.3.2-1.21" = _3ricZEjs;
        "pkg-1.3.2-1.20.4" = _1qdBF3Sc;
        "pkg-1.3.2-1.20.2" = _gOlpzehR;
        "pkg-1.3.2-1.20.1" = _747Nrwdb;
        "pkg-1.3.2-1.19.4" = _6sG61Mcz;
        "pkg-1.3.2-1.19.3" = _IWbPYpUU;
        "pkg-1.3.2-1.19.2" = _32hfuH7D;
        "pkg-1.3.2-1.18.2" = _Lf2Ka8Ae;
        "pkg-1.3.3-1.20.4" = _Re0VeLhr;
        "pkg-1.3.3-1.20.2" = _CEyPpffZ;
        "pkg-1.3.3-1.20.1" = _q8MEWrZW;
        "pkg-1.3.3-1.20.6" = _J7C30lnD;
        "pkg-1.3.3-1.21" = _Z4yNzXce;
        "pkg-1.3.3-1.19.4" = _bY6PqGyv;
        "pkg-1.3.3-1.19.3" = _ye6N88QI;
        "pkg-1.3.3-1.19.2" = _wBeUcU0F;
        "pkg-1.3.3-1.18.2" = _c4s07vi6;
        "pkg-1.3.4-1.21.1" = _7UUkBfUd;
        "pkg-1.3.4-1.20.6" = _Cbhj1Kb1;
        "pkg-1.3.5-beta.1-1.21.1" = _5KmLkFy7;
        "pkg-1.3.5-beta.2-1.21.1" = _VKTt66A2;
        "pkg-1.4.0-beta.4-1.21.1" = _JdzSNMiP;
        "pkg-1.4.0-beta.5-1.21.1" = _o2DqNW67;
        "pkg-1.4.0-beta.6-1.20.1" = _zA44Kysf;
        "pkg-1.4.0-beta.6-1.21.1" = _LQFOGXR3;
        "pkg-1.4.0-beta.6-1.20.6" = _bs4jDuf8;
        "pkg-1.4.0-beta.6-1.20.4" = _VcVqYqe9;
        "pkg-1.4.0-beta.6-1.20.2" = _sxQ8MxDA;
        "pkg-1.4.0-1.21.1" = _7ZtBc0AX;
        "pkg-1.4.0-1.20.6" = _vtGn0wBW;
        "pkg-1.4.0-1.20.4" = _EeuPwycG;
        "pkg-1.4.0-1.20.2" = _p0JfMBaV;
        "pkg-1.4.0-1.20.1" = _R87ULvPK;
        "pkg-1.4.1-1.19.4" = _QpuulIfl;
        "pkg-1.4.1-1.20.1" = _4fKfqLFc;
        "pkg-1.4.1-1.20.2" = _CyhwKqEL;
        "pkg-1.4.1-1.20.4" = _NDmHBcWO;
        "pkg-1.4.1-1.20.6" = _LhU6aCXU;
        "pkg-1.4.1-1.21.1" = _18QT5JYT;
        "pkg-1.4.2-alpha.1-1.21.3" = _AOCKYesZ;
        "pkg-1.4.2-beta.1-1.21.3" = _ax4hsVs1;
        "pkg-1.4.2-1.19.4" = _ZWtu6M87;
        "pkg-1.4.2-1.20.1" = _QDLnFsNB;
        "pkg-1.4.2-1.20.2" = _6OQNHomd;
        "pkg-1.4.2-1.20.4" = _tbZHhfTF;
        "pkg-1.4.2-1.20.6" = _87nyuwX4;
        "pkg-1.4.2-1.21.1" = _qr0QcQ5A;
        "pkg-1.4.2-1.21.3" = _eiqSlOmb;
        "pkg-1.4.3-beta.1-1.21.4" = _XQ2nBCsr;
        "pkg-1.4.3-beta.1-1.21.3" = _i0f7SV4p;
        "pkg-1.4.3-beta.1-1.21.1" = _R4zZl7bA;
        "pkg-1.4.3-beta.1-1.20.6" = _xgXKJRC6;
        "pkg-1.4.3-beta.1-1.20.4" = _MyWndzkO;
        "pkg-1.4.3-beta.1-1.20.2" = _foIVXP49;
        "pkg-1.4.3-beta.1-1.20.1" = _ZWss3cPd;
        "pkg-1.4.3-beta.1-1.19.4" = _q7H6EWvh;
        "pkg-1.4.3-1.19.4" = _HQ15M7rx;
        "pkg-1.4.3-1.20.1" = _zvcY87Qb;
        "pkg-1.4.3-1.20.2" = _Vsrqna1q;
        "pkg-1.4.3-1.20.4" = _KjUdNthH;
        "pkg-1.4.3-1.20.6" = _u0ik1nFh;
        "pkg-1.4.3-1.21.1" = _9vwiqVz2;
        "pkg-1.4.3-1.21.3" = _MJELRftJ;
        "pkg-1.4.3-1.21.4" = _yT0lsP06;
        "pkg-1.4.4-1.21.1" = _2d32sh8S;
        "pkg-1.4.5-1.21.4" = _pY2aIhB3;
        "pkg-1.4.5-1.21.3" = _Mn4ek73A;
        "pkg-1.4.5-1.21.1" = _nAPsnIRE;
        "pkg-1.4.5-1.20.6" = _ppXIAbbw;
        "pkg-1.4.5-1.20.4" = _iRKvmWbt;
        "pkg-1.4.5-1.20.2" = _WbjZBg4D;
        "pkg-1.4.5-1.20.1" = _91YGHK45;
        "pkg-1.4.6-beta.1-1.21.5-rc1" = _u8RdcdsG;
        "pkg-1.4.6-1.21.4" = _yTW70cE9;
        "pkg-1.4.7-1.21.5" = _ylFrceI4;
        "pkg-1.4.7-1.21.4" = _vtBCTOtx;
        "pkg-1.4.8-1.21.1" = _t0Q8AMBd;
        "pkg-1.4.9-1.21.5" = _SCrQQKZD;
        "pkg-1.4.9-1.21.4" = _phievYUM;
        "pkg-1.4.9-1.21.3" = _o7a1ETlW;
        "pkg-1.4.9-1.21.1" = _jdKIC8jg;
        "pkg-1.4.9-1.20.6" = _kGwFU3WJ;
        "pkg-1.4.9-1.20.4" = _IfEfBjI8;
        "pkg-1.4.9-1.20.2" = _Eg8lX8TF;
        "pkg-1.4.9-1.20.1" = _HvRXXkx4;
        "pkg-1.4.9.1-1.21.3" = _kFofdCei;
        "pkg-1.4.9.1-1.21.4" = _kzSdfVFY;
        "pkg-1.5.0-beta.1-1.21.6-rc1" = _4zG7IjuC;
        "pkg-1.5.0-1.21.5" = _ls6dXEsH;
        "pkg-1.5.1-1.21.7" = _qACFiUFG;
        "pkg-1.5.1-1.21.5" = _HmupTaod;
        "pkg-1.5.1-1.21.4" = _sxAc9Cc8;
        "pkg-1.5.3-1.20.1" = _W8UYjABx;
        "pkg-1.5.3-1.20.2" = _we4gw449;
        "pkg-1.5.3-1.20.4" = _558v19j3;
        "pkg-1.5.3-1.20.6" = _dPctsTQ1;
        "pkg-1.5.3-1.21.1" = _wUfLcbuq;
        "pkg-1.5.3-1.21.3" = _A939ou8g;
        "pkg-1.5.3-1.21.4" = _MsWrRbRo;
        "pkg-1.5.3-1.21.5" = _prK68h89;
        "pkg-1.5.3-1.21.8" = _m0DJaRlA;
        "pkg-1.6.0-beta.1-1.21.10" = _1Q0GEX6h;
        "pkg-1.6.0-beta.1-1.21.11" = _bMMPAeyJ;
        "pkg-1.6.0-beta.2-1.21.10" = _9ti0ZO7Q;
        "pkg-1.6.0-beta.2-1.21.11" = _v2cRT76g;
        "pkg-1.6.0-beta.3-1.21.11" = _Lujw37NN;
        "pkg-1.6.0-beta.4-1.21.11" = _8dSfsQpt;
        "pkg-1.6.0-1.21.11" = _WYC7OD6L;
        "pkg-1.6.0-1.21.10" = _Q6pjzWni;
        "pkg-1.6.0-1.21.8" = _1gGlG95E;
        "pkg-1.6.0-1.21.5" = _jRA1wpOq;
        "pkg-1.6.0-1.21.4" = _jVwIrru2;
        "pkg-1.6.0-1.21.3" = _ISyPCCfx;
        "pkg-1.6.0-1.21.1" = _WIALb9Dj;
        "pkg-1.6.0-1.20.1" = _IQ1Styo8;
        "pkg-1.4.3.1-1.19.4" = _iwxCjnr4;
        "pkg-1.3.3.1-beta.1-1.19.2" = _AzAygHfd;
        "pkg-1.6.1-1.21.1" = _G4z7N14G;
        "pkg-1.6.1-1.20.1" = _qnJmsdl5;
        "pkg-1.6.1-1.21.3" = _5amQwNP4;
        "pkg-1.6.1-1.21.4" = _D61cpubr;
        "pkg-1.6.1-1.21.5" = _wmF20vQ3;
        "pkg-1.6.1-1.21.8" = _8cuqFgLv;
        "pkg-1.6.1-1.21.10" = _PO7ZryxV;
        "pkg-1.6.1-1.21.11" = _uyEMgshD;
        "pkg-1.6.2-beta.1-26.1.1" = _NDyRx2IK;
        "pkg-1.6.2-1.21.11" = _PJBsTOOX;
        "pkg-1.6.3-beta.1+mc26.1.2" = _Tr06TLlm;
        "pkg-1.6.3-beta.2+mc1.21.11" = _CEOAWrel;
        "pkg-1.6.3-beta.2+mc26.1.2" = _QoRdhlSs;
        "pkg-1.6.3-beta.3+mc1.21.10" = _YTtwxLua;
        "pkg-1.6.3-beta.3+mc1.21.11" = _RKdwL0Ys;
        "pkg-1.6.3-beta.3+mc26.1.2" = _eBNq5mVl;
        "pkg-1.6.3-beta.4+mc1.21.10" = _gtLrhMEn;
        "pkg-1.6.3-beta.4+mc26.1.2" = _2sSCHoND;
        "pkg-1.6.3-beta.4+mc1.21.11" = _I8yfNIoc;
        "pkg-1.6.3-beta.5+mc26.1.2" = _JL45Twfk;
        "pkg-1.6.3-beta.5+mc1.21.11" = _Ey6iCed3;
        "pkg-1.6.4-beta.1+mc26.1.2" = _yGWQXFcN;
        "pkg-1.6.4+mc1.21.11" = _HbLREGwU;
        "pkg-1.6.4+mc1.21.10" = _F3tDNeiO;
        "pkg-1.6.4-1.21.8" = _XS0QT5Ga;
        "pkg-1.6.4-1.21.5" = _GMc29ruA;
        "pkg-1.6.5-alpha.1-1.20.1" = _CD4JW0P6;
        "pkg-1.6.5-alpha.1-1.21.1" = _NAygnnFq;
        "pkg-1.6.5-alpha.2-1.21.1" = _Aktk8HcD;
        "pkg-1.6.5+mc26.1.2" = _Mi5kuVeq;
        "pkg-1.6.5+mc1.21.11" = _Yxtx8MSz;
        "pkg-1.6.5+mc1.21.10" = _hUSqBx9l;
        "pkg-1.6.5+mc1.21.8" = _KwienPrt;
        "pkg-1.6.5+mc1.21.5" = _72Bf74FQ;
        "pkg-1.6.5+mc1.21.4" = _e273ZZes;
        "pkg-1.6.5+mc1.21.3" = _Ma3OqBsD;
        "pkg-1.6.5+mc1.21.1" = _lXQ4OQpH;
        "pkg-1.6.5+mc1.20.1" = _O2gqVaaH;
        "default" = _O2gqVaaH;
    });
