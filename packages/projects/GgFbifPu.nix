...
let
    versions = (let
        ...
        _1l4H7vXX = {
            "id" = "1l4H7vXX";
            "file" = "AuctionHousePlus-3.6.jar";
            "hash" = "sha512-YRnQuOoEoXpCJJ23zsmiBoRv5mJufi9cXxSzn38W+XM6BnhZSNt1ybKrgky1zfdx58JHI80devHGvFGMYBNALA==";
        };
        _Bo4v4O2J = {
            "id" = "Bo4v4O2J";
            "file" = "AuctionHousePlus-3.6.jar";
            "hash" = "sha512-2eH3Xi51HQ/0hewyTKKfw9oQDGhNnvEArvO4Y2MpU6GkylQqMazgaH+eaRa1khJK5q3OUOR8yjCirTX3UR2n/Q==";
        };
        _FViTaVNu = {
            "id" = "FViTaVNu";
            "file" = "AuctionHousePlus-3.7.jar";
            "hash" = "sha512-BIDC/8ZynNROiSgTQuh5G7d87fTjljpWpEGJ7r6D228ijlVOwe/bsm1IwcXzlGVDyqpOWan1Imybxy+IinCB8w==";
        };
        _Z9832HwY = {
            "id" = "Z9832HwY";
            "file" = "AuctionHousePlus-3.7.jar";
            "hash" = "sha512-SkUQ3ky9wB5O4sqeSVvDtYFvJpBYfOUR9kzCNTn2EkTxpOU8BcFoVxKUHRcSU8+Tjv5TIF6oonIH4yq1rHqdiw==";
        };
        _EMqw3iNk = {
            "id" = "EMqw3iNk";
            "file" = "auctionHousePlus-3.7.jar";
            "hash" = "sha512-Qz4fhWu/7zko864Z5RkiI3w2ATDqFB4BEbdW9Em0dmZFB75mHwftHiIIJEAO2i++cOBrE48ni7bMXEf4Cbd5bA==";
        };
    in {
        "hGzZxj7W" = _hGzZxj7W;
        "ZPfd4ugQ" = _ZPfd4ugQ;
        ...
        "bukkit-1.21" = _EMqw3iNk;
        "bukkit-1.21.1" = _EMqw3iNk;
        "bukkit-1.21.2" = _EMqw3iNk;
        "bukkit-1.21.3" = _EMqw3iNk;
        "bukkit-1.21.4" = _EMqw3iNk;
        "bukkit-1.21.5" = _EMqw3iNk;
        "bukkit-1.21.6" = _EMqw3iNk;
        "bukkit-1.21.7" = _EMqw3iNk;
        "bukkit-1.21.8" = _EMqw3iNk;
        "bukkit-1.21.9" = _EMqw3iNk;
        "bukkit-1.21.10" = _EMqw3iNk;
        "bukkit-1.21.11" = _EMqw3iNk;
        "bukkit-26.1" = _EMqw3iNk;
        "bukkit-26.1.1" = _EMqw3iNk;
        "bukkit-26.1.2" = _EMqw3iNk;
        "bukkit-26.2" = _EMqw3iNk;
        "bukkit-26.3" = _EMqw3iNk;
        ...
        "paper-1.21" = _EMqw3iNk;
        "paper-1.21.1" = _EMqw3iNk;
        "paper-1.21.2" = _EMqw3iNk;
        "paper-1.21.3" = _EMqw3iNk;
        "paper-1.21.4" = _EMqw3iNk;
        "paper-1.21.5" = _EMqw3iNk;
        "paper-1.21.6" = _EMqw3iNk;
        "paper-1.21.7" = _EMqw3iNk;
        "paper-1.21.8" = _EMqw3iNk;
        "paper-1.21.9" = _EMqw3iNk;
        "paper-1.21.10" = _EMqw3iNk;
        "paper-1.21.11" = _EMqw3iNk;
        "paper-26.1" = _EMqw3iNk;
        "paper-26.1.1" = _EMqw3iNk;
        "paper-26.1.2" = _EMqw3iNk;
        "paper-26.2" = _EMqw3iNk;
        "paper-26.3" = _EMqw3iNk;
        ...
        "spigot-1.21" = _EMqw3iNk;
        "spigot-1.21.1" = _EMqw3iNk;
        "spigot-1.21.2" = _EMqw3iNk;
        "spigot-1.21.3" = _EMqw3iNk;
        "spigot-1.21.4" = _EMqw3iNk;
        "spigot-1.21.5" = _EMqw3iNk;
        "spigot-1.21.6" = _EMqw3iNk;
        "spigot-1.21.7" = _EMqw3iNk;
        "spigot-1.21.8" = _EMqw3iNk;
        "spigot-1.21.9" = _EMqw3iNk;
        "spigot-1.21.10" = _EMqw3iNk;
        "spigot-1.21.11" = _EMqw3iNk;
        "spigot-26.1" = _EMqw3iNk;
        "spigot-26.1.1" = _EMqw3iNk;
        "spigot-26.1.2" = _EMqw3iNk;
        "spigot-26.2" = _EMqw3iNk;
        "spigot-26.3" = _EMqw3iNk;
        ...
        "purpur-1.21" = _Z9832HwY;
        "purpur-1.21.1" = _Z9832HwY;
        "purpur-1.21.2" = _Z9832HwY;
        "purpur-1.21.3" = _Z9832HwY;
        "purpur-1.21.4" = _Z9832HwY;
        "purpur-1.21.5" = _Z9832HwY;
        "purpur-1.21.6" = _Z9832HwY;
        "purpur-1.21.7" = _Z9832HwY;
        "purpur-1.21.8" = _Z9832HwY;
        "purpur-1.21.9" = _Z9832HwY;
        "purpur-1.21.10" = _Z9832HwY;
        "purpur-1.21.11" = _Z9832HwY;
        "purpur-26.1" = _Z9832HwY;
        "purpur-26.1.1" = _Z9832HwY;
        "purpur-26.1.2" = _Z9832HwY;
        "purpur-26.2" = _Z9832HwY;
        "velocity-1.21" = _Z9832HwY;
        "velocity-1.21.1" = _Z9832HwY;
        "velocity-1.21.2" = _Z9832HwY;
        "velocity-1.21.3" = _Z9832HwY;
        "velocity-1.21.4" = _Z9832HwY;
        "velocity-1.21.5" = _Z9832HwY;
        "velocity-1.21.6" = _Z9832HwY;
        "velocity-1.21.7" = _Z9832HwY;
        "velocity-1.21.8" = _Z9832HwY;
        "velocity-1.21.9" = _Z9832HwY;
        "velocity-1.21.10" = _Z9832HwY;
        "velocity-1.21.11" = _Z9832HwY;
        "velocity-26.1" = _Z9832HwY;
        "velocity-26.1.1" = _Z9832HwY;
        "velocity-26.1.2" = _Z9832HwY;
        "velocity-26.2" = _Z9832HwY;
        "pkg-1.0.0" = _hGzZxj7W;
        "pkg-1.0.1" = _TCXRW5PC;
        "pkg-1.1" = _tiVVih4k;
        "pkg-1.1-1" = _yqjNNWe6;
        ...
        "pkg-3.3" = _V0KGSftN;
        "pkg-3.4" = _NwrCMR6o;
        "pkg-3.4-FIX" = _1iskjSKh;
        "pkg-3.5" = _7D4lweup;
        "pkg-3.5-1" = _HkiL5dpc;
        "pkg-3.5-2" = _km9XnBSW;
        "pkg-3.5-FIX" = _Z3IP28U0;
        "pkg-3.5-3" = _kZB4GEtU;
        "pkg-3.6" = _3wrTVp93;
        "pkg-3.6-FIX" = _1l4H7vXX;
        "pkg-3.6-FIX2" = _Bo4v4O2J;
        "pkg-3.7" = _FViTaVNu;
        "pkg-3.7-2" = _Z9832HwY;
        "pkg-3.7-1" = _EMqw3iNk;
        "default" = _EMqw3iNk;
