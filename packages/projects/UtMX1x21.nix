...
let
    ...
    in {
        ...
        "pkg-1.1" = _pe6DgDXX;
        "pkg-1.1.1+mod" = _G3eEtKQK;
        "pkg-1.2" = _uiGh7gbb;
        "pkg-1.2.1+mod" = _4oVUWfy8;
        "pkg-1.3" = _v7B5GP8I;
        "pkg-1.3.1+mod" = _xAu4vqef;
        "pkg-1.4" = _6xecmy7D;
        "pkg-1.4.1+mod" = _tmd2dp0o;
        "pkg-1.5" = _OSOK8KF8;
        "pkg-1.5.1+mod" = _ybd5tMbX;
        "pkg-1.6" = _yTXTCrfw;
        "pkg-1.6.1+mod" = _zdrSLoIA;
        "pkg-1.7" = _6dQp2JXw;
        "pkg-1.7.1+mod" = _vAqsFovU;
        "pkg-1.8" = _l1tLwZoq;
        "pkg-1.8.1+mod" = _G4GpGxEf;
        "pkg-1.9" = _6iAdivOR;
