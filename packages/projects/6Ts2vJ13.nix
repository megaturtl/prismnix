...
let
    ...
    in {
        ...
        "fabric-1.17" = _JIzV9iSQ;
        "fabric-1.17.1" = _JIzV9iSQ;
        "fabric-1.18" = _JIzV9iSQ;
        "fabric-1.18.1" = _JIzV9iSQ;
        "fabric-1.18.2" = _JIzV9iSQ;
        "fabric-1.19" = _JIzV9iSQ;
        "fabric-1.19.1" = _JIzV9iSQ;
        "fabric-1.19.2" = _JIzV9iSQ;
        "fabric-1.19.3" = _JIzV9iSQ;
        "fabric-1.19.4" = _JIzV9iSQ;
        "fabric-1.20" = _JIzV9iSQ;
        "fabric-1.20.1" = _JIzV9iSQ;
        "fabric-1.20.2" = _JIzV9iSQ;
        "fabric-1.20.3" = _JIzV9iSQ;
        "fabric-1.20.4" = _JIzV9iSQ;
        "fabric-1.20.5" = _JIzV9iSQ;
        "fabric-1.20.6" = _JIzV9iSQ;
        "fabric-1.21" = _JIzV9iSQ;
        "fabric-1.21.1" = _JIzV9iSQ;
        "fabric-1.21.2" = _JIzV9iSQ;
        "fabric-1.21.3" = _JIzV9iSQ;
        "fabric-1.21.4" = _JIzV9iSQ;
        "fabric-1.21.5" = _JIzV9iSQ;
        "fabric-1.21.6" = _JIzV9iSQ;
        "fabric-1.21.7" = _JIzV9iSQ;
        "fabric-1.21.8" = _JIzV9iSQ;
        "fabric-1.21.9" = _JIzV9iSQ;
        "fabric-1.21.10" = _JIzV9iSQ;
        "fabric-1.21.11" = _JIzV9iSQ;
        "fabric-26.1" = _JIzV9iSQ;
        "fabric-26.1.1" = _JIzV9iSQ;
        "fabric-26.1.2" = _JIzV9iSQ;
        "fabric-26.2" = _JIzV9iSQ;
        "pkg-2.0.0" = _5FgNT4mO;
        "pkg-2.0.1" = _RNlFkP7T;
        "pkg-2.0.2" = _AxQFEz94;
        "pkg-2.1.0" = _p4qhk2Eq;
