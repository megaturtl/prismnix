...
let
    versions = (let
        ...
        _JIzV9iSQ = {
            "id" = "JIzV9iSQ";
            "file" = "librgetter-4.0.0.jar";
            "hash" = "sha512-5HMbyyerk5iTjgpjZYhblD3GweIcV7byT+NmMQ6CK/OyqqyjL++A5jJaJhBq+Op/OfMaYz97o9gtBD8OGr96gQ==";
        };
        _D6SerDD8 = {
            "id" = "D6SerDD8";
            "file" = "librgetter-4.0.1.jar";
            "hash" = "sha512-SsycU/NHNYsVHSAbM9o0u0O87Aewz9xbtd6Jf0TbF6bMfyqZgiTRfPLzQXeoEd9MPdEnc34vbdMO+2R12H17DA==";
        };
    in {
        "5FgNT4mO" = _5FgNT4mO;
        "RNlFkP7T" = _RNlFkP7T;
        ...
        "fabric-1.17" = _D6SerDD8;
        "fabric-1.17.1" = _D6SerDD8;
        "fabric-1.18" = _D6SerDD8;
        "fabric-1.18.1" = _D6SerDD8;
        "fabric-1.18.2" = _D6SerDD8;
        "fabric-1.19" = _D6SerDD8;
        "fabric-1.19.1" = _D6SerDD8;
        "fabric-1.19.2" = _D6SerDD8;
        "fabric-1.19.3" = _D6SerDD8;
        "fabric-1.19.4" = _D6SerDD8;
        "fabric-1.20" = _D6SerDD8;
        "fabric-1.20.1" = _D6SerDD8;
        "fabric-1.20.2" = _D6SerDD8;
        "fabric-1.20.3" = _D6SerDD8;
        "fabric-1.20.4" = _D6SerDD8;
        "fabric-1.20.5" = _D6SerDD8;
        "fabric-1.20.6" = _D6SerDD8;
        "fabric-1.21" = _D6SerDD8;
        "fabric-1.21.1" = _D6SerDD8;
        "fabric-1.21.2" = _D6SerDD8;
        "fabric-1.21.3" = _D6SerDD8;
        "fabric-1.21.4" = _D6SerDD8;
        "fabric-1.21.5" = _D6SerDD8;
        "fabric-1.21.6" = _D6SerDD8;
        "fabric-1.21.7" = _D6SerDD8;
        "fabric-1.21.8" = _D6SerDD8;
        "fabric-1.21.9" = _D6SerDD8;
        "fabric-1.21.10" = _D6SerDD8;
        "fabric-1.21.11" = _D6SerDD8;
        "fabric-26.1" = _D6SerDD8;
        "fabric-26.1.1" = _D6SerDD8;
        "fabric-26.1.2" = _D6SerDD8;
        "fabric-26.2" = _D6SerDD8;
        "fabric-26.3" = _D6SerDD8;
        "pkg-2.0.0" = _5FgNT4mO;
        "pkg-2.0.1" = _RNlFkP7T;
        "pkg-2.0.2" = _AxQFEz94;
        "pkg-2.1.0" = _p4qhk2Eq;
