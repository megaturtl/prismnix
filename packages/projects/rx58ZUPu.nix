...
let
    versions = (let
        ...
        _6BqWe1la = {
            "id" = "6BqWe1la";
            "file" = "Modernity-f1-3.10.3.zip";
            "hash" = "sha512-cmRcPKgaNR2ad3Cz1iJWTkhLqXG4atRBFSWpSGELHFTvxJ40jH8ByDGCvMT9tmL6P7Wi1pXMcrL/Dr36AdjcZg==";
        };
        _i8BuRkTV = {
            "id" = "i8BuRkTV";
            "file" = "Modernity-f2-3.10.3.zip";
            "hash" = "sha512-hCVbeDROPfjQfq2rgTZbA/wkV4OpRtbktIS/Pf0EFfDdHogpAopWFZp70WbwTrOaNnSUHbX5cUjH+vd430BEvQ==";
        };
        _NLIuHI3b = {
            "id" = "NLIuHI3b";
            "file" = "Modernity-f3-3.10.3.zip";
            "hash" = "sha512-38n/GS/bp8qcIbysor/qSu+2maSc0hWO+iYpXnCQ8GKIcOXhEP/qEarqjZrdSqx/yojDlUskN2zqahR/zrNDJw==";
        };
        _zb57cHJj = {
            "id" = "zb57cHJj";
            "file" = "Modernity-f1-3.10.3.1.zip";
            "hash" = "sha512-JcanIROywgmli/jbt63Sw5WLOD/E61O76DQrZC2I+PRKmW3YRr7etR5mRqaGgYSWHwOYFC3+3jAz0+5AQ2oXQg==";
        };
    in {
        "7QqIgX3H" = _7QqIgX3H;
        "pPRIJvE1" = _pPRIJvE1;
        ...
        "NLIuHI3b" = _NLIuHI3b;
        "zb57cHJj" = _zb57cHJj;
        "minecraft-1.6.4" = _zb57cHJj;
        "minecraft-1.7.10" = _zb57cHJj;
        "minecraft-1.8.9" = _zb57cHJj;
        "minecraft-1.9.4" = _i8BuRkTV;
        "minecraft-1.10.2" = _i8BuRkTV;
        "minecraft-1.11.2" = _NLIuHI3b;
        "minecraft-1.12.2" = _NLIuHI3b;
        "minecraft-1.6.1" = _zb57cHJj;
        "minecraft-1.6.2" = _zb57cHJj;
        "minecraft-1.7.2" = _zb57cHJj;
        "minecraft-1.7.3" = _zb57cHJj;
        "minecraft-1.7.4" = _zb57cHJj;
        "minecraft-1.7.5" = _zb57cHJj;
        "minecraft-1.7.6" = _zb57cHJj;
        "minecraft-1.7.7" = _zb57cHJj;
        "minecraft-1.7.8" = _zb57cHJj;
        "minecraft-1.7.9" = _zb57cHJj;
        "minecraft-1.8" = _zb57cHJj;
        "minecraft-1.8.1" = _zb57cHJj;
        "minecraft-1.8.2" = _zb57cHJj;
        "minecraft-1.8.3" = _zb57cHJj;
        "minecraft-1.8.4" = _zb57cHJj;
        "minecraft-1.8.5" = _zb57cHJj;
        "minecraft-1.8.6" = _zb57cHJj;
        "minecraft-1.8.7" = _zb57cHJj;
        "minecraft-1.8.8" = _zb57cHJj;
        "minecraft-1.9" = _i8BuRkTV;
        "minecraft-1.9.1" = _i8BuRkTV;
        "minecraft-1.9.2" = _i8BuRkTV;
        "minecraft-1.9.3" = _i8BuRkTV;
        "minecraft-1.10" = _i8BuRkTV;
        "minecraft-1.10.1" = _i8BuRkTV;
        "minecraft-1.11" = _NLIuHI3b;
        "minecraft-1.11.1" = _NLIuHI3b;
        "minecraft-1.12" = _NLIuHI3b;
        "minecraft-1.12.1" = _NLIuHI3b;
        "pkg-3.7.0-format1" = _7QqIgX3H;
        "pkg-3.7.0-format2" = _pPRIJvE1;
        "pkg-3.7.0-format3" = _Sqowo64F;
        "pkg-3.7.1-format1" = _NCxFMjoV;
        "pkg-3.7.1-format2" = _fl7gbfqS;
        "pkg-3.7.1-format3" = _l5DWI5T7;
        "pkg-3.8.0-format1" = _1nIxmcwg;
        "pkg-3.8.0-format2" = _vCNavCir;
        "pkg-3.8.0-format3" = _cWr7j8Rw;
        "pkg-3.8.1-f1" = _m3b7ZRaj;
        "pkg-3.8.1-f2" = _OMv0X08Z;
        "pkg-3.8.1-f3" = _KGNHi7wQ;
        "pkg-3.8.2-f1" = _4AqwKg2z;
        "pkg-3.8.2-f2" = _MTqLGjyx;
        "pkg-3.8.2-f3" = _4TnpuApe;
        "pkg-3.9.0-f1" = _4aMY0PyQ;
        "pkg-3.9.0-f2" = _z85ODHNT;
        "pkg-3.9.0-f3" = _t03c8IHS;
        "pkg-f1-3.10.0" = _aGyu9kIK;
        "pkg-f2-3.10.0" = _zwSZMP4c;
        "pkg-f3-3.10.0" = _dICvdT4P;
        "pkg-f1-3.10.1" = _Miw9VtlY;
        "pkg-f2-3.10.1" = _DVwbOTZs;
        "pkg-f3-3.10.1" = _KQlhuzsr;
        "pkg-f1-3.10.2" = _dhu2n1os;
        "pkg-f2-3.10.2" = _TNHGHZXL;
        "pkg-f3-3.10.2" = _qn52HWf6;
        "pkg-f1-3.10.3" = _6BqWe1la;
        "pkg-f2-3.10.3" = _i8BuRkTV;
        "pkg-f3-3.10.3" = _NLIuHI3b;
        "pkg-f1-3.10.3.1" = _zb57cHJj;
        "default" = _zb57cHJj;
    });
