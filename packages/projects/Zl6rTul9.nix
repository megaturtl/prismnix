...
let
    versions = (let
        ...
        _EBlDItKb = {
            "id" = "EBlDItKb";
            "file" = "lne_archers-fabric-1.1.3+1.21.1.jar";
            "hash" = "sha512-awEr9+3uNiqz4G/fOxMHKxWmd6WXD0c+5DtHxmVEVox2qCN7eXV5afaEEjRQyvzwk2pF4VzdaHEKWACM+104EQ==";
        };
        _X6QMMu6Y = {
            "id" = "X6QMMu6Y";
            "file" = "lne_archers-neoforge-1.1.3+1.21.1.jar";
            "hash" = "sha512-yxeylhD4IJIx2h8/8DJLiok3a8UMJp9kBeP06PqAwHjF/T//GpYu4JnpDwV5yad3Ee8ubFaRErJMgWclqUj2Gw==";
        };
        _q4xF28nA = {
            "id" = "q4xF28nA";
            "file" = "lne_archers-neoforge-1.2.0+1.21.1.jar";
            "hash" = "sha512-5kJmZqiDfQaQ5J9xV9JKcdp1pz7zQk7vlz3FLfQulPo6pS+oRorm1Hyw5axY20/Pa8DfjMbVHNjAYNPU6VVmyg==";
        };
        _NG8jDhT6 = {
            "id" = "NG8jDhT6";
    ...
    in {
        ...
        "pkg-0.1.3-1.20.1" = _9fZiRzr4;
        "pkg-0.1.4-1.20.1" = _soYEmuiv;
        "pkg-0.1.5-1.20.1" = _guVi7041;
        "pkg-0.1.6-1.20.1" = _alntEIfS;
        "pkg-0.1.7-1.20.1" = _waaq9p7a;
        "pkg-1.0.0-1.21.1" = _aGVVrq1y;
        "pkg-1.0.1-1.21.1" = _QJraniYo;
        "pkg-1.0.2-1.21.1" = _dZ9BaLvk;
        "pkg-1.0.3-1.21.1" = _Z18CioxT;
        "pkg-0.1.8-1.20.1" = _K9OcM7Kw;
        "pkg-1.0.4-1.21.1" = _P0xApW5T;
        "pkg-1.0.5-1.21.1" = _aZjBFP1i;
        "pkg-0.1.9-1.20.1" = _zU7tcXoT;
        "pkg-1.0.6-1.21.1" = _El04fN3a;
        "pkg-1.0.7-1.21.1" = _SNcj1AOk;
        "pkg-1.0.8+1.21.1-neoforge" = _I4fQViim;
        "pkg-1.0.8+1.21.1-fabric" = _NhJR24Iy;
        "pkg-1.1.0+1.21.1-neoforge" = _LnM7hxxY;
        "pkg-1.1.0+1.21.1-fabric" = _gC7uXyu1;
        "pkg-1.1.1+1.21.1-fabric" = _McU34Cks;
        "pkg-1.1.1+1.21.1-neoforge" = _57UBLDns;
        "pkg-1.1.2+1.21.1-neoforge" = _EgG8XjN6;
