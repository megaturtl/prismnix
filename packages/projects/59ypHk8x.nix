...
let
    versions = (let
        ...
        _IjSX8Uet = {
            "id" = "IjSX8Uet";
            "file" = "clifftree-3.3-fabric-26.2.jar";
            "hash" = "sha512-A+tgiYtQqXtZqecsqr4HMiYOqePVenezarQvGyxbvrg/exR4BMyv1U975uSSF5VyGVKgWrpNiFAJx6CFN+4WWg==";
        };
        _fANniPNt = {
            "id" = "fANniPNt";
            "file" = "clifftree-3.3-neoforge-26.2.jar";
            "hash" = "sha512-uyBvJAoNTYgArBQfyLORy9q3WbOOKm4vpW5JlkXnMaZ0Iv1UzSs+IZyKndYfnQk8LGwh61eS2yuh6kRDR+oX0w==";
        };
        _7dJz6Ueu = {
            "id" = "7dJz6Ueu";
            "file" = "clifftree-3.3-datapack-26.2.zip";
            "hash" = "sha512-ywWHy1h/By5DFdPSEooOXI91U8mN86U/Zr1LEzxIn3k2WkPZhZzGAmhB7EPsR85lllpPn6P4QWNNuelZSSeT4w==";
        };
        _98ZAHkEw = {
            "id" = "98ZAHkEw";
            "file" = "clifftree-3.3-datapack-1.21.1-backport.zip";
            "hash" = "sha512-iJsK3R+Hry1+v9NRxX1/A6teE+siRxVOwwRJuvDvgEjKX7tK5UdRtcRd+wPhk7+k79aAOoGt6efguFm8L50L6A==";
        };
        _GQBWQdu4 = {
            "id" = "GQBWQdu4";
            "file" = "clifftree-3.3-fabric-1.21.1-backport.jar";
            "hash" = "sha512-gY10trzYWA5Wfur+aLufn3aZVqAvx8Wg+rhNboQfze90TwotIactkhZyoMbZh6orSgw89quIVLe1YTzyrdrBoQ==";
        };
        _ihoJ0oCq = {
            "id" = "ihoJ0oCq";
            "file" = "clifftree-3.3-neoforge-1.21.1-backport.jar";
            "hash" = "sha512-CxXEHAdboVioYcpf0vJE/i4wtnr+hJfHtRfFr0zy3MbxHDy0lto9vbnuz78yyLQYmEdKDuSWME2XoF74SJL3Tw==";
        };
    in {
        "1BnsKjXx" = _1BnsKjXx;
        "5QJa1kbV" = _5QJa1kbV;
        ...
        "neoforge-26.2" = _fANniPNt;
        "pkg-1.0" = _1BnsKjXx;
        "pkg-1.0+mod" = _yTPFuAqm;
        "pkg-1.1" = _Xcd6n37V;
        "pkg-1.1+mod" = _eS5xqjmc;
        "pkg-1.2" = _exm6CAGo;
        "pkg-1.2+mod" = _VmsLPYlu;
        "pkg-1.3" = _lAJQuNn9;
        "pkg-1.3+mod" = _cFL3p1jg;
        "pkg-1.4" = _ZR9UzsB3;
        "pkg-1.4+mod" = _GyyU85kL;
        "pkg-1.5" = _eOOD7Usc;
        "pkg-1.5+mod" = _pDjjC0GB;
        "pkg-1.6" = _8TAVr2Px;
        "pkg-1.6+mod" = _KmUEvFBE;
        "pkg-1.6.1" = _Hck5tyFu;
        "pkg-1.6.1+mod" = _ONAFwuuJ;
        "pkg-1.7" = _tunM4khR;
        "pkg-1.7+mod" = _3qqFq49T;
        "pkg-1.7.1" = _Md8He7V7;
        "pkg-1.7.1+mod" = _gXCqCFu7;
        "pkg-1.7.2" = _kDV5kK34;
        "pkg-1.7.2+mod" = _G0nfW069;
        "pkg-1.8" = _duae4Ono;
        "pkg-1.8+mod" = _zvUdKGnQ;
        "pkg-2.0" = _sfZuBCv1;
        "pkg-2.0+mod" = _IVp7glXz;
        "pkg-2.0.1" = _Od9gkvEi;
        "pkg-2.0.1+mod" = _tKrr4oPS;
        "pkg-2.1" = _QXK2sYnv;
        "pkg-2.1+mod" = _ssT9VRbQ;
        "pkg-2.0.3" = _K620mag0;
        "pkg-2.0.3+mod" = _BRBO59Qq;
        "pkg-2.1.1" = _ojXFFLGv;
        "pkg-2.1.1+mod" = _xLjrh3K0;
        "pkg-2.2" = _AoVXedT0;
        "pkg-2.2+mod" = _qpY1zrZd;
        "pkg-2.2.1" = _8xssElj3;
        "pkg-2.2.1+mod" = _rIY9qvky;
        "pkg-2.2.2" = _QeX8iTFN;
        "pkg-2.2.2+mod" = _6uYbVID9;
        "pkg-2.2.3" = _9sc5kPEB;
        "pkg-2.2.3+mod" = _zCWxW5vJ;
        "pkg-2.2.4" = _UlS2eCM9;
        "pkg-2.2.4+mod" = _xizKDVXJ;
        "pkg-3.0" = _1GrZcgeS;
        "pkg-3.0+mod" = _tNl2a2zi;
        "pkg-3.0.1" = _dXqfPNfE;
        "pkg-3.0.1+mod" = _WD5F1koQ;
        "pkg-3.0.2" = _FJKjLww0;
        "pkg-3.0.2+mod" = _f4NXnmNu;
        "pkg-3.1.0" = _1vc3EVkT;
        "pkg-3.1.1" = _Dvofnfet;
        "pkg-3.1.2" = _5mZnRZA9;
        "pkg-3.1.3" = _orAIWPZI;
        "pkg-3.1.4-backport" = _OwWTPQhS;
        "pkg-3.1.4" = _lK0I3IBh;
        "pkg-3.1.4-mom" = _hpxgCy7k;
        "pkg-3.1.4b-backport" = _QZJ9k1J3;
        "pkg-3.1.5" = _dp8bndSW;
        "pkg-6.6.6" = _wixm5LTj;
        "pkg-3.2.0" = _BHLcOgxy;
        "pkg-3.2.1" = _XsHNvuCq;
        "pkg-3.3-fabric-26.2" = _IjSX8Uet;
        "pkg-3.3-neoforge-26.2" = _fANniPNt;
        "pkg-3.3-datapack-26.2" = _7dJz6Ueu;
        "pkg-3.3-datapack-1.21.1-backport" = _98ZAHkEw;
        "pkg-3.3-fabric-1.21.1-backport" = _GQBWQdu4;
        "pkg-3.3-neoforge-1.21.1-backport" = _ihoJ0oCq;
        "default" = _ihoJ0oCq;
    });
