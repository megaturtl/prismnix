...
let
    versions = (let
        ...
        _KcCe0rZz = {
            "id" = "KcCe0rZz";
            "file" = "fabric-language-kotlin-1.13.14+kotlin.2.4.20.jar";
            "hash" = "sha512-PmmDRBgF1ZPrD4/s5dz6PzinJrwBCmgLWsthqvblG2jUt6ToaEoSz81vcgSso1Riak7ucr8oyGXRBZUxfW3slA==";
        };
        _BKnpByHl = {
            "id" = "BKnpByHl";
            "file" = "fabric-language-kotlin-1.14.0+kotlin.2.4.20.jar";
            "hash" = "sha512-byiQRI2tAFR7EeCwFBYJ/Uodc/pfwhJklec9Hr5VyCKLbmqYpb0Z88DaQXzm0XZcBGg5hyK0uccxQOVs/fNbkA==";
        };
        _eRRZzGMc = {
            "id" = "eRRZzGMc";
            "file" = "fabric-language-kotlin-1.14.1+kotlin.2.4.20.jar";
    ...
    in {
        ...
        "BKnpByHl" = _BKnpByHl;
        "eRRZzGMc" = _eRRZzGMc;
        "fabric-1.14.4" = _eRRZzGMc;
        "fabric-1.15.2" = _eRRZzGMc;
        "fabric-1.16.2" = _eRRZzGMc;
        "fabric-1.16.5" = _eRRZzGMc;
        "fabric-1.17" = _eRRZzGMc;
        "fabric-1.17.1" = _eRRZzGMc;
        "fabric-1.14" = _eRRZzGMc;
        "fabric-1.14.1" = _eRRZzGMc;
        "fabric-1.14.2" = _eRRZzGMc;
        "fabric-1.14.3" = _eRRZzGMc;
        "fabric-1.15" = _eRRZzGMc;
        "fabric-1.15.1" = _eRRZzGMc;
        "fabric-1.16" = _eRRZzGMc;
        "fabric-1.16.1" = _eRRZzGMc;
        "fabric-1.16.3" = _eRRZzGMc;
        "fabric-1.16.4" = _eRRZzGMc;
        "fabric-1.18" = _eRRZzGMc;
        "fabric-1.18.1" = _eRRZzGMc;
        "fabric-1.18.2" = _eRRZzGMc;
        ...
        "fabric-1.19" = _eRRZzGMc;
        "fabric-1.19.1" = _eRRZzGMc;
        "fabric-1.19.2" = _eRRZzGMc;
        "fabric-1.19.3" = _eRRZzGMc;
        "fabric-1.19.4" = _eRRZzGMc;
        "fabric-1.20" = _eRRZzGMc;
        "fabric-1.20.1" = _eRRZzGMc;
        "fabric-1.20.2" = _eRRZzGMc;
        "fabric-1.20.3" = _eRRZzGMc;
        "fabric-1.20.4" = _eRRZzGMc;
        "fabric-1.20.5" = _eRRZzGMc;
        "fabric-1.20.6" = _eRRZzGMc;
        "fabric-1.21" = _eRRZzGMc;
        "fabric-1.21.1" = _eRRZzGMc;
        "fabric-1.21.2" = _eRRZzGMc;
        "fabric-1.21.3" = _eRRZzGMc;
        "fabric-1.21.4" = _eRRZzGMc;
        "fabric-1.21.5" = _eRRZzGMc;
        "fabric-1.21.6" = _eRRZzGMc;
        "fabric-1.21.7" = _eRRZzGMc;
        "fabric-1.21.8" = _eRRZzGMc;
        "fabric-1.21.9" = _eRRZzGMc;
        "fabric-1.21.10" = _eRRZzGMc;
        "fabric-1.21.11" = _eRRZzGMc;
        "fabric-26.1" = _eRRZzGMc;
        "fabric-26.1.1" = _eRRZzGMc;
        "fabric-26.1.2" = _eRRZzGMc;
        "fabric-26.2" = _eRRZzGMc;
        "fabric-26.3" = _eRRZzGMc;
        "pkg-1.6.3+kotlin.1.5.21" = _wdRa3g1U;
        "pkg-1.6.4+kotlin.1.5.30" = _1qsZV7U7;
        "pkg-1.7.1+kotlin.1.6.10" = _nrHxebpS;
        "pkg-1.7.2+kotlin.1.6.20" = _5VOQ5nq2;
        "pkg-1.7.4+kotlin.1.6.21" = _iAzZrqan;
        "pkg-1.8.0+kotlin.1.7.0" = _tmzNRXlM;
        "pkg-1.8.1+kotlin.1.7.0" = _D2Y5G2KO;
        "pkg-1.8.2+kotlin.1.7.10" = _5Aq3SFbi;
        "pkg-1.8.3+kotlin.1.7.10" = _MrMwCJlh;
        "pkg-1.8.4+kotlin.1.7.20" = _allNCj2E;
        "pkg-1.8.5+kotlin.1.7.20" = _FrvEFBGt;
        "pkg-1.8.6+kotlin.1.7.21" = _UJQzC6Jw;
        "pkg-1.8.7+kotlin.1.7.22" = _yLIAMDzv;
        "pkg-1.9.0+kotlin.1.8.0" = _esSFbyFg;
        "pkg-1.9.1+kotlin.1.8.10" = _lgFl3olb;
        "pkg-1.9.2+kotlin.1.8.10" = _Ibros2FW;
        "pkg-1.9.3+kotlin.1.8.20" = _MkcO8aQ0;
        "pkg-1.9.4+kotlin.1.8.21" = _qgTQJrUS;
        "pkg-1.9.5+kotlin.1.8.22" = _ADg3gvlr;
        "pkg-1.9.6+kotlin.1.8.22" = _5J7lguFF;
        "pkg-1.10.0+kotlin.1.9.0" = _65oEzjEs;
        "pkg-1.10.8+kotlin.1.9.0" = _s10JMAtS;
        "pkg-1.10.9+kotlin.1.9.0" = _Cqe2URk8;
        "pkg-1.10.10+kotlin.1.9.10" = _48ri5y9r;
        "pkg-1.10.11+kotlin.1.9.20" = _D8aag9dT;
        "pkg-1.10.12+kotlin.1.9.20" = _DmCixAtU;
        "pkg-1.10.13+kotlin.1.9.20" = _atZwzPrT;
        "pkg-1.10.14+kotlin.1.9.20" = _vnTAITh8;
        "pkg-1.10.15+kotlin.1.9.21" = _psNjlsLR;
        "pkg-1.10.16+kotlin.1.9.21" = _VJUqKopR;
        "pkg-1.10.17+kotlin.1.9.22" = _JjrWZ7m8;
        "pkg-1.10.18+kotlin.1.9.22" = _vlhvI5Li;
        "pkg-1.10.19+kotlin.1.9.23" = _ZMokinzs;
        "pkg-1.10.20+kotlin.1.9.24" = _a7MqDLdC;
        "pkg-1.11.0+kotlin.2.0.0" = _afsFajDC;
        "pkg-1.12.0+kotlin.2.0.10" = _kdDGGNEt;
        "pkg-1.12.1+kotlin.2.0.20" = _FayzGq0c;
        "pkg-1.12.2+kotlin.2.0.20" = _o0V8mlNz;
        "pkg-1.12.3+kotlin.2.0.21" = _B0fZidZi;
        "pkg-1.13.0+kotlin.2.1.0" = _csX9r2wS;
        "pkg-1.13.1+kotlin.2.1.10" = _476dzMG5;
        "pkg-1.13.2+kotlin.2.1.20" = _E4WyjCxJ;
        "pkg-1.13.3+kotlin.2.1.21" = _iqWDz8qt;
        "pkg-1.13.4+kotlin.2.2.0" = _mccDBWqV;
        "pkg-1.13.5+kotlin.2.2.10" = _Y91MRWtG;
        "pkg-1.13.6+kotlin.2.2.20" = _i6MmXDwA;
        "pkg-1.13.7+kotlin.2.2.21" = _LcgnDDmT;
        "pkg-1.13.8+kotlin.2.3.0" = _N6D3uiZF;
        "pkg-1.13.9+kotlin.2.3.10" = _ViT4gucI;
        "pkg-1.13.10+kotlin.2.3.20" = _21TRTKmh;
        "pkg-1.13.11+kotlin.2.3.21" = _2i87JpYj;
        "pkg-1.13.12+kotlin.2.4.0" = _Pd0xrHCw;
        "pkg-1.13.13+kotlin.2.4.10" = _bdhiINYC;
        "pkg-1.13.14+kotlin.2.4.20" = _KcCe0rZz;
        "pkg-1.14.0+kotlin.2.4.20" = _BKnpByHl;
        "pkg-1.14.1+kotlin.2.4.20" = _eRRZzGMc;
        "default" = _eRRZzGMc;
    });
