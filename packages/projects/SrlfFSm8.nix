...
let
    ...
    in {
        ...
        "pkg-1.11.2-forge-1.2.0" = _GI8rC4So;
        "pkg-1.12.2-forge-1.2.0" = _99tn0TP7;
        "pkg-1.14.4-forge-1.2.0" = _MrpUormm;
        "pkg-1.15.2-forge-1.2.0" = _O11dydv8;
        "pkg-1.16.5-forge-1.2.0" = _vf34FSQU;
        "pkg-1.7.10-forge-1.2.1" = _vZuVgKAo;
        "pkg-1.10.2-forge-1.2.1" = _g3xoVlVZ;
        "pkg-1.11.2-forge-1.2.1" = _4ri8IiqR;
        "pkg-1.12.2-forge-1.2.1" = _RS6e8aF1;
        "pkg-1.14.4-forge-1.2.1" = _3fiwOyvR;
        "pkg-1.15.2-forge-1.2.1" = _lk6JtwJD;
        "pkg-1.16.5-forge-1.2.1" = _LTEkkUBM;
        "pkg-1.7.10-forge-1.2.2" = _K12pB2yw;
        "pkg-1.10.2-forge-1.2.2" = _9OUfzcRU;
        "pkg-1.11.2-forge-1.2.2" = _q8d2HkQr;
        "pkg-1.12.2-forge-1.2.2" = _FeaNDEBf;
        "pkg-1.14.4-forge-1.2.2" = _o3cHsKZT;
        "pkg-1.15.2-forge-1.2.2" = _OjIL17zL;
        "pkg-1.16.5-forge-1.2.2" = _mJQbXG9O;
        "pkg-1.7.10-forge-1.3.0" = _QRxKZwAh;
        "pkg-1.10.2-forge-1.3.0" = _Jo8yCExl;
        "pkg-1.11.2-forge-1.3.0" = _sv2tqqWQ;
        "pkg-1.12.2-forge-1.3.0" = _BLvDSJB3;
        "pkg-1.14.4-forge-1.3.0" = _NfoCwlNn;
        "pkg-1.15.2-forge-1.3.0" = _7Gtu9bKC;
        "pkg-1.16.5-forge-1.3.0" = _jPodepB2;
        "pkg-1.17.1-forge-1.3.0" = _dPcZItKU;
        "pkg-1.18.2-forge-1.3.0" = _V0Ko2CPQ;
        "pkg-1.19.4-forge-1.3.0" = _qGWwRTfm;
        "pkg-1.20.1-forge-1.3.0" = _fReyyqrN;
        "pkg-1.21.1-neoforge-1.3.0" = _y0g7wsMS;
        "pkg-1.21.1-neoforge-1.3.0-hotfix1" = _wdIwmUJs;
        "pkg-1.7.10-forge-1.3.0-hotfix2" = _B92eT5L6;
        "pkg-1.10.2-forge-1.3.0-hotfix2" = _2lNEjPps;
        "pkg-1.11.2-forge-1.3.0-hotfix2" = _WXkaeAdV;
        "pkg-1.12.2-forge-1.3.0-hotfix2" = _ktHqwXTb;
        "pkg-1.14.4-forge-1.3.0-hotfix2" = _HqzA6K1G;
        "pkg-1.15.2-forge-1.3.0-hotfix2" = _6DumYFHX;
