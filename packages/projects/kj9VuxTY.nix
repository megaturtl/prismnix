...
let
    versions = (let
        ...
        _QZ7JTGEe = {
            "id" = "QZ7JTGEe";
            "file" = "Serendipity v0.2.4.zip";
            "hash" = "sha512-L30B/9T4JVTJr9Puvz9HLTR6xip7eoY5An4nH8T3ssF6i/3ByQINi81rU94HzlxdlAOnFxJbXY7hVyTMe9DiWg==";
        };
    in {
        "arfH5JaK" = _arfH5JaK;
        "co4CDnxQ" = _co4CDnxQ;
        ...
        "QZ7JTGEe" = _QZ7JTGEe;
        "iris-1.20" = _QZ7JTGEe;
        "iris-1.20.1" = _QZ7JTGEe;
        "iris-1.20.2" = _QZ7JTGEe;
        "iris-1.20.3" = _QZ7JTGEe;
        "iris-1.20.4" = _QZ7JTGEe;
        "iris-1.20.5" = _QZ7JTGEe;
        "iris-1.20.6" = _QZ7JTGEe;
        "iris-1.21" = _QZ7JTGEe;
        "iris-1.21.1" = _QZ7JTGEe;
        "iris-1.21.2" = _QZ7JTGEe;
        "iris-1.21.3" = _QZ7JTGEe;
        "iris-1.21.4" = _QZ7JTGEe;
        "iris-1.21.5" = _QZ7JTGEe;
        "iris-1.21.6" = _QZ7JTGEe;
        "iris-1.21.7" = _QZ7JTGEe;
        "iris-1.21.8" = _QZ7JTGEe;
        "iris-1.21.9" = _QZ7JTGEe;
        "iris-1.21.10" = _QZ7JTGEe;
        "iris-1.21.11" = _QZ7JTGEe;
        "iris-26.1" = _QZ7JTGEe;
        "iris-26.1.1" = _QZ7JTGEe;
        "iris-26.1.2" = _QZ7JTGEe;
        "iris-26.2" = _QZ7JTGEe;
