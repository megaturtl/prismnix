...
let
    versions = (let
        ...
        _Jt2sCWTQ = {
            "id" = "Jt2sCWTQ";
            "file" = "continuity-3.0.1+26.3.jar";
            "hash" = "sha512-HsHjsvc8JrGURdZkgiqJNukHb02IVaLtX6wZeG2qjaQtqP3JUmxKU8InqCgZqHrY5z1bT8AD9lGcUEVMMwFPBA==";
        };
    in {
        "Xn8QzMB9" = _Xn8QzMB9;
        "6JEV45oM" = _6JEV45oM;
        ...
        "pkg-1.0.0+1.17" = _Xn8QzMB9;
        "pkg-1.0.1+1.17" = _6JEV45oM;
        "pkg-1.0.2+1.17" = _i0ccQghD;
        "pkg-1.0.3+1.17" = _27YRAXEt;
        "pkg-1.0.3+1.18" = _SffGs8Ro;
        "pkg-1.1.0+1.17" = _yiOF0F2t;
        "pkg-1.1.0+1.18" = _sD3iTKbB;
        "pkg-1.1.0+1.18.2" = _gOxkykhO;
        "pkg-2.0.0+1.18.2" = _Bl7pOAQf;
        "pkg-2.0.0+1.19" = _zcqSiVI3;
        "pkg-2.0.1+1.18.2" = _jjpzIZoY;
        "pkg-2.0.1+1.19" = _xTtULC68;
        "pkg-2.0.2+1.18.2" = _YEKdScFW;
        "pkg-2.0.2+1.19" = _Ql3Ho9eR;
        "pkg-3.0.0-beta.2+1.19.3" = _4h5IIa7B;
        "pkg-3.0.0-beta.2+1.20" = _ImUFj5Gl;
        "pkg-3.0.0-beta.3+1.19.3" = _G2qoxVmV;
        "pkg-3.0.0-beta.3+1.19.4" = _OOpbpU2z;
        "pkg-3.0.0-beta.3+1.20.1" = _xy2co4Rh;
        "pkg-3.0.0-beta.4+1.19.4" = _JYaO3lPe;
        "pkg-3.0.0-beta.4+1.20.1" = _Z9FJWLMt;
        "pkg-3.0.0-beta.4+1.20.2" = _JXhQlDZl;
        "pkg-3.0.0-beta.5+1.19.3" = _Fc7h8MWD;
        "pkg-3.0.0-beta.5+1.19.4" = _MfBeYvQa;
        "pkg-3.0.0-beta.5+1.20.1" = _84Zs6tNo;
        "pkg-3.0.0-beta.5+1.20.2" = _Ox1racg8;
        "pkg-3.0.0-beta.5+1.20.5" = _hI13Vg85;
        "pkg-3.0.0-beta.5+1.21" = _NksUpFjf;
        "pkg-3.0.0+1.19.3" = _mvRzsvHc;
        "pkg-3.0.0+1.19.4" = _kHdjiepB;
        "pkg-3.0.0+1.20.1" = _qGTDcjHM;
        "pkg-3.0.0+1.20.2" = _WMwDkIY8;
        "pkg-3.0.0+1.20.5" = _RXCRb59j;
        "pkg-3.0.0+1.21" = _kSPJ4hQv;
        "pkg-3.0.0+1.21.3" = _kwuHTVHC;
        "pkg-3.0.0+1.20.1.forge" = _9KbAcWSO;
        "pkg-3.0.0+1.21.neoforge" = _eXGUs5sy;
        "pkg-3.0.0+1.21.4" = _esC1Vejm;
        "pkg-3.0.1-test.4+1.21.5" = _kravz06U;
        "pkg-3.0.1-beta.1+1.21.6" = _m0cvWhzT;
        "pkg-3.0.1-beta.2+1.21.10" = _7JbPpQnu;
        "pkg-3.0.1-beta.1+1.21.11" = _mX1iknM1;
        "pkg-3.0.1-beta.1+26.1" = _fiZzqnYz;
        "pkg-3.0.1-beta.2+26.1" = _l1mM6Ov7;
        "pkg-3.0.1+26.2" = _mgUN5Xz2;
        "pkg-3.0.1+26.3" = _Jt2sCWTQ;
        "default" = _Jt2sCWTQ;
    });
