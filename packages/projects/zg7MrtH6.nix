...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.21.6-1.21.8" = _qB1s5NUV;
        "pkg-1.0.1+1.21.6-1.21.8" = _4oSYgxuC;
        "pkg-1.0.1+1.21.9-1.21.10" = _AWjuIx7T;
        "pkg-1.0.1+1.21.11" = _wGZAo6EF;
        "pkg-1.0.1+1.21.2-1.21.5" = _wPACQR52;
