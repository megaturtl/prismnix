...
let
    versions = (let
        ...
        _jrrgNdn2 = {
            "id" = "jrrgNdn2";
            "file" = "crosshair_arrow-1.0.1-mc26.3.zip";
            "hash" = "sha512-Rx0PnTeSoONlgx6MZDsIHxm/gLfAGnezKuTov24lVWPQgLV8ZZ+l9zZuxBW/ZQW5FC+GSA3X9I3KkWFBk4qYew==";
        };
    in {
        "jaZB0jER" = _jaZB0jER;
        "6ihzShYl" = _6ihzShYl;
