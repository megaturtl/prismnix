...
let
    versions = (let
        ...
        _aZH7p1sk = {
            "id" = "aZH7p1sk";
            "file" = "rechiseled-1.2.5a-neoforge-mc26.2.jar";
            "hash" = "sha512-9CKDctRYgUZ950ixMuNxAaF30X6oBdpH/F5GucgcphOjFGbOv0hr3N/7VMulXDLAtC19VXzG0JiWNIPDIvVtMg==";
        };
        _j7NBe6kO = {
            "id" = "j7NBe6kO";
            "file" = "rechiseled-1.2.6-forge-mc1.12.jar";
            "hash" = "sha512-WeNOGgfFYdaDvbvsUQM0wNeKvFJH5MsG/3zhcfnTnG8hZCYr6oQfL4DXF8bI92Gop+qOa2ibXXSYhrvTE/R8/g==";
        };
        _MJF3R8YM = {
            "id" = "MJF3R8YM";
            "file" = "rechiseled-1.2.6-forge-mc1.15.jar";
            "hash" = "sha512-ujrlyAwYhPvE3nlmey3KQiFum9inCShC7xrNon4lI9NLdnyc8pT2dRroDWmPZ+DUZM7OK8rE0lK14YCpM5zE5g==";
        };
        _t3yH4ZOv = {
            "id" = "t3yH4ZOv";
            "file" = "rechiseled-1.2.6-forge-mc1.16.jar";
            "hash" = "sha512-gU5ndvn9qvgF5GJHIiQHyVWBema60vM8jrS/vMchZmi0oW3M+tnrNeDxBd99ZkLwHqNkxivYOrtmCiwY8b97qQ==";
        };
        _RPOuGJ3Q = {
            "id" = "RPOuGJ3Q";
            "file" = "rechiseled-1.2.6-forge-mc1.17.jar";
            "hash" = "sha512-JFf6TK3xd9xiTFTCDIO/Lc33rjFIWyihqFfNdHXeKqPuO9SRRVrCAf5aSM55XECIvE5H2G5Fz/YbA/UGk6GDfg==";
        };
        _4BgMapVA = {
            "id" = "4BgMapVA";
            "file" = "rechiseled-1.2.6-forge-mc1.18.jar";
            "hash" = "sha512-IAL5Qf8jLKGpTcsNrNLgj5D+JB9zKfkYW/CODdrr2jl/uc5KKuNA0aGR2fIR2G19FM4iV4EQu90RzkjDPUrdgw==";
        };
        _uxAMJdgj = {
            "id" = "uxAMJdgj";
            "file" = "rechiseled-1.2.6-forge-mc1.19.2.jar";
            "hash" = "sha512-643zQzw2w4Jj4csNye20Lh2SfRc8eJWbsj92IDbjzysaXJJtGCI6ig/i94aIXLhdDkMrvxUiNH1zqwciljD0jQ==";
        };
        _LiP4Or6X = {
            "id" = "LiP4Or6X";
            "file" = "rechiseled-1.2.6-forge-mc1.19.3.jar";
            "hash" = "sha512-vUZK/HYPRERT9yHR1PGGlhhjG+/9ChQyz5ln0CoVSly9GEw0f7Lv7bC1sn6NUBdzXjMdQ0O8ZbdAxRIyKJ55Nw==";
        };
        _brfCN7Om = {
            "id" = "brfCN7Om";
            "file" = "rechiseled-1.2.6-forge-mc1.19.4.jar";
            "hash" = "sha512-e+kWElQtnxAstHdT+D15suy3Sl9Tg8zXtxOSrJ9AbZBsJwh3XzrQIvZTu19xv6BpTYw3zqijyxFICrfNQlYnsA==";
        };
        _H9XQzWIp = {
            "id" = "H9XQzWIp";
            "file" = "rechiseled-1.2.6-forge-mc1.20.1.jar";
            "hash" = "sha512-1i+eqrrcBtE1TVujY7aCIL0TrFKLMNyMeOr3iCM8AiH49cQAbgC7sKD5dIyq57pvTHviGxSLZWY1tASf5VPNDQ==";
        };
        _DJaK0pfP = {
            "id" = "DJaK0pfP";
            "file" = "rechiseled-1.2.6-forge-mc1.20.4.jar";
            "hash" = "sha512-dQSlwpAe2gzD0ZXTycGiDQvdV8sf1qd9E4ykzj5f7x3NHzts9ppIoC3LWSD0QYNqDlRnUniykm+I+wOdGFoy1Q==";
        };
        _gI9mW8YR = {
            "id" = "gI9mW8YR";
            "file" = "rechiseled-1.2.6-forge-mc1.20.6.jar";
            "hash" = "sha512-ayxT7tZyzCsUBNU8GjHPoEBFtMND7I0OJTs7W0mHmP56i6E6vufWhnEQndPizOMRWS/Btx4ukuVbCSIisN7INQ==";
        };
        _TSsMl0Jq = {
            "id" = "TSsMl0Jq";
            "file" = "rechiseled-1.2.6-forge-mc1.21.jar";
            "hash" = "sha512-gal8Oe2SV8eWZHHAGzBTueAQwub1U1UEPNn+YU1USEXIRVHK44YrM7rJ3UNV/afVSzgx2ljfZ87P6Bng4dzAOw==";
        };
        _Jo86Z83I = {
            "id" = "Jo86Z83I";
            "file" = "rechiseled-1.2.6-forge-mc1.21.3.jar";
            "hash" = "sha512-zuLS7Cd8PvUlBGftsLgSEXbFxm33cY/cHENaz5+hPIliFEpOe6D9ipLAxbpxQfkPanwziGzgkQYqy45eIbRUOw==";
        };
        _T3JqUFJk = {
            "id" = "T3JqUFJk";
            "file" = "rechiseled-1.2.6-forge-mc1.21.4.jar";
            "hash" = "sha512-bQEVib5hnJefCY9CvCZNbol8GpoUeLHeq7U68czU+MISWlDBflI6bLg6ytUa7zL53qSEvzZjT0HSQGzCyveeEA==";
        };
        _tnelsmKk = {
            "id" = "tnelsmKk";
            "file" = "rechiseled-1.2.6-forge-mc1.21.5.jar";
            "hash" = "sha512-EKWhTSr5F7DKLLzUjNez96WPKa9t4Vl7P823iyUEcl/lMgLDv6dP6HvEU9ZdHxlAXg+lkEG1ZJxRFyoCNtpkWA==";
        };
        _kgBEJ1gS = {
            "id" = "kgBEJ1gS";
            "file" = "rechiseled-1.2.6-forge-mc1.21.8.jar";
            "hash" = "sha512-QATi2d0rH/6tqrJZkd2DG/QYjAZ1rlcIKlsNY2Q+jA3lsR4XKzb7vY9GCMHh0VPHBXQCMys6h2QhPbjgVBKuug==";
        };
        _rGCIJ0AW = {
            "id" = "rGCIJ0AW";
            "file" = "rechiseled-1.2.6-forge-mc1.21.10.jar";
            "hash" = "sha512-+resVmEdO5gZAdIooDxdxBwYgjN49NWNPLGuGtH6M6xJk8FzhL5+76GDpZ+FOcOO03ztxnCY8IUuapp9s0+rpw==";
        };
        _vQLr7K5k = {
            "id" = "vQLr7K5k";
            "file" = "rechiseled-1.2.6-forge-mc1.21.11.jar";
            "hash" = "sha512-65oCjbRiN9MWsxLWTxv6EvYSGRukemQLthTbyRMnF0mk7DOUmX3f0wniImZGUNA2wEDWLvs8D6PWP6E8uIG0kQ==";
        };
        _A5oBpT0L = {
            "id" = "A5oBpT0L";
            "file" = "rechiseled-1.2.6-forge-mc26.1.jar";
            "hash" = "sha512-5RhEqLi86IF6vG380/7Z3nBlmupfn1M9Mom0ODGFThEtSL0OuSzvfvixSP5xffwJzoJ5m1BT3toLjA2fq/BgjA==";
        };
        _tKxSA6zX = {
            "id" = "tKxSA6zX";
            "file" = "rechiseled-1.2.6-forge-mc26.2.jar";
            "hash" = "sha512-bOopPgVtYqkbgFgs8EcqTdA8tvSQ9ytvtFnZ010BQkhd+ILAp7xO9UsuSqWqFVeOOlZfmhIVpUeiTuPl4rBJ5w==";
        };
        _OEAXYdep = {
            "id" = "OEAXYdep";
            "file" = "rechiseled-1.2.6-fabric-mc1.18.jar";
            "hash" = "sha512-pWt7uSb8yQ5DHRbHqcmmzOpg77QUD0tQbhYxtwmJlr+WqXH9fOkov6AUOhVqv2pJRV1Ob5kRCOaURFTHN4bBqw==";
        };
        _DRWJtNYm = {
            "id" = "DRWJtNYm";
            "file" = "rechiseled-1.2.6-fabric-mc1.19.2.jar";
            "hash" = "sha512-xtU+9vgxofHHmRlRbOg9WrP4eF3TCXMFYS65eSOUgNWWsB3VHwU9lwd28MOyWaTKBS3q30gXa9U3ohkO7Qk9qQ==";
        };
        _PuK9OAyQ = {
            "id" = "PuK9OAyQ";
            "file" = "rechiseled-1.2.6-fabric-mc1.19.4.jar";
            "hash" = "sha512-EX3c9bMV9Lp/6dxfGiqoJIAPBSdZmzPRWDovumPieiqXBw+cEOw+4xvu3YV82J7e5nltKG7wcq7fIa+KtrAjaA==";
        };
        _CzSrE0Do = {
            "id" = "CzSrE0Do";
            "file" = "rechiseled-1.2.6-fabric-mc1.20.1.jar";
            "hash" = "sha512-8j5rmE4tuRtuvWqwcltB7oH4JQe4V+iDp/+tEkOwPuGZ6HzP2Supd96WEVIHFqugrTvuVFMJ/6pF5yx1v6sIpA==";
        };
        _oeKwgb3e = {
            "id" = "oeKwgb3e";
            "file" = "rechiseled-1.2.6-fabric-mc1.20.4.jar";
            "hash" = "sha512-hsG4uNNo1fxdRgIjpK8svpNgLzrcqcfmrVnsXvMumIZXHv+Ij8b4cuY53VqS7R0Bw2TKvAFKqQnaqpQIs7sP9Q==";
        };
        _td85pWRy = {
            "id" = "td85pWRy";
            "file" = "rechiseled-1.2.6-fabric-mc1.20.6.jar";
            "hash" = "sha512-pPIxQ2SuLhKAADGX6LYSgHwg0Wup+3y9LUEPDh2CQB4vCBbfLyy1uv0CHoxgjCPViYWwNANyUuKoRtyEWg/hUg==";
        };
        _7411ZFAs = {
            "id" = "7411ZFAs";
            "file" = "rechiseled-1.2.6-fabric-mc1.21.jar";
            "hash" = "sha512-VUHAamI2Ts8wEY0OMkbQpM4761v4Nf7IasR0mmrD5DLqCmAaiLOnGUqzvy1bqVKaNxSJi5YMuGxTJWHyKLL3Cg==";
        };
        _NhjW3iRg = {
            "id" = "NhjW3iRg";
            "file" = "rechiseled-1.2.6-fabric-mc1.21.3.jar";
            "hash" = "sha512-kp3VdLwuvLlOiAtHqnz5L9ZO9BnyXRoh238c5vyunfFP360x+e1v7nmhLdx/Ithu3vW8KCdNLrG0FBa/6hHGBg==";
        };
        _GujuqOia = {
            "id" = "GujuqOia";
            "file" = "rechiseled-1.2.6-fabric-mc1.21.4.jar";
            "hash" = "sha512-TYYM01sttpcBC4ImXD1GWv6NMjsAB6yl2haaQ+DtighPPOzPp6mzeLB+d5MFixtQTRyvrFSX1Z2x2xI5p0HsCg==";
        };
        _9CXrmaGk = {
            "id" = "9CXrmaGk";
            "file" = "rechiseled-1.2.6-fabric-mc1.21.5.jar";
            "hash" = "sha512-8Rjh4cK5jRDQVMAR300JOJ8BNZMRzyYMuPCtTnRni05XD4botBNxBXqkSVgju3aE5tJhFlVZtPb0WXN5AmbtOQ==";
        };
        _vwSWXO9Q = {
            "id" = "vwSWXO9Q";
            "file" = "rechiseled-1.2.6-fabric-mc1.21.8.jar";
            "hash" = "sha512-NsvMbAiWWEmcm1FpGoUUqK6FF2zFZOnh5FOeqWQR45AlkswpDvH0Wiw4dDngSnEjutMNL8gg4Oqmw8OiizPJFQ==";
        };
        _o6S0fbd6 = {
            "id" = "o6S0fbd6";
            "file" = "rechiseled-1.2.6-fabric-mc1.21.10.jar";
            "hash" = "sha512-hohb7Yy0c/duN7U54B08pL0avQ+3jvkjurYuvO7d71j7CngFZlG6HlouQ1UlewDmE0nhFoig1gJgieaopL+S2A==";
        };
        _cR1nk2sH = {
            "id" = "cR1nk2sH";
            "file" = "rechiseled-1.2.6-fabric-mc1.21.11.jar";
            "hash" = "sha512-lQATPnxx5UANKMkt+yOENzsJuJ66BqFZhfIqX853d//CJwpoj4MEVqqnDEvpjGtu7efphott8Uo6PFZOe+kBpg==";
        };
        _MSyzZAAt = {
            "id" = "MSyzZAAt";
            "file" = "rechiseled-1.2.6-fabric-mc26.1.jar";
            "hash" = "sha512-gSZ1X76q4kKDZDx3tCEa5jVmSesXefxyCJhSHzRiGR718P41Bf+omSwFyDAH7lrV0RihTm5hrZ+nYACsUBXH5Q==";
        };
        _u535HhZe = {
            "id" = "u535HhZe";
            "file" = "rechiseled-1.2.6-fabric-mc26.2.jar";
            "hash" = "sha512-scz28etAMbFDhwnNx0094KvnDbCnDnX/uYvVAgYtnrUSxgFvHUWYOMCbEfzruf/64oxpRQqMH6iyzf6M+PlwsA==";
        };
        _wsAcYWT2 = {
            "id" = "wsAcYWT2";
            "file" = "rechiseled-1.2.6-neoforge-mc1.20.4.jar";
            "hash" = "sha512-YDb8sAAJ5JmLV3WKM8aOKJGKGnYc6/SJuXRYE90W7t7h2RZETAkyywY8tYoIsgsS6yXjfeXRXdsORSRxAosyGg==";
        };
        _lNE4VTJ0 = {
            "id" = "lNE4VTJ0";
            "file" = "rechiseled-1.2.6-neoforge-mc1.20.6.jar";
            "hash" = "sha512-O9MXB56VhrJKfg24DkpxnzTKubTIoBmZlZw1m7ZltVQrGoeXi7iDyo/AMBH26W1KhqctAlj01ZlUob2cb/+gZA==";
        };
        _6muGRqvu = {
            "id" = "6muGRqvu";
            "file" = "rechiseled-1.2.6-neoforge-mc1.21.jar";
            "hash" = "sha512-/HVW5CQ55Sbt3a/b3hCM0TJv1XQtda5z/pUZ9Xrxi3XNKGEFMke2X6Os2cWOGGvFQEltHnCVoyBrQB2UWZWONA==";
        };
        _TIYU6TeP = {
            "id" = "TIYU6TeP";
            "file" = "rechiseled-1.2.6-neoforge-mc1.21.3.jar";
            "hash" = "sha512-DKvSUBdN9UFBQ6or1IOX45PgFBCI09aPosUCAgjI/JCIz71fzh69k3FWvltYruzUvfRxpNOhqhMbSNJBk1nDGQ==";
        };
        _yOJBlzBQ = {
            "id" = "yOJBlzBQ";
            "file" = "rechiseled-1.2.6-neoforge-mc1.21.4.jar";
            "hash" = "sha512-Tw4u34GC0h9leZMcu2UyR2c4QUle/aB+OY2zvjF8vvCP/05uuahtcQgb1V9HqNnoWIm3J41On5SHS3aS9nvXtg==";
        };
        _38vnaCJz = {
            "id" = "38vnaCJz";
            "file" = "rechiseled-1.2.6-neoforge-mc1.21.5.jar";
            "hash" = "sha512-pQNcqau3Dd89AhqqbsIxUI1c2NgTOYNEjbUZ5Xym9xVSAOxZX7AiIkm5rsePzAoSkP3cvVlaLjpRw9QE94P11A==";
        };
        _Acm5y3eo = {
            "id" = "Acm5y3eo";
            "file" = "rechiseled-1.2.6-neoforge-mc1.21.8.jar";
            "hash" = "sha512-lZrRZdRHqOBXnQcYJhsJDti7jFSaCWIQw185v911/pow3cPCJz0nyGihclzakghmEfUHP7RjCUEPcaTrpeh99g==";
        };
        _PsgHmriz = {
            "id" = "PsgHmriz";
            "file" = "rechiseled-1.2.6-neoforge-mc1.21.10.jar";
            "hash" = "sha512-5XYvFiIPjmLnkFl0oLa/31gYPEocZQ+Sq2+4sWdmYFOJn+Fjg6XG9SWeRyxoVtKB8RZGqPrafRhT4SUtS5kBOw==";
        };
        _lgi9TbKk = {
            "id" = "lgi9TbKk";
            "file" = "rechiseled-1.2.6-neoforge-mc1.21.11.jar";
            "hash" = "sha512-a0B6IP4wK8c0LjcgpUlpggDVyqdtZoeRzYXK+HRJSXKH+bqq2S+hsQtuhQy4xOkn8IOEM46CmuW4wUQmT6KwIw==";
        };
        _V6Edgo0h = {
            "id" = "V6Edgo0h";
            "file" = "rechiseled-1.2.6-neoforge-mc26.1.jar";
            "hash" = "sha512-V8Dk7EynhH3p+dGqketp9oUsUiFnN0RUAnitQs5SX42YESeM/SAXIJ6dhZo08LGIRWY0PDzGZxJToDJtJxrEKA==";
        };
        _1skiNH4v = {
            "id" = "1skiNH4v";
            "file" = "rechiseled-1.2.6-neoforge-mc26.2.jar";
            "hash" = "sha512-YNep/G0T7DBWUHGIweLq93Vbkf8Zg4K7/AfXJfhVrLUUJ5CpdTOby7ZcONK2x8e4RBOnfvR5GE51/atnG3rWFg==";
        };
        _88095LbC = {
            "id" = "88095LbC";
            "file" = "rechiseled-1.2.6-fabric-mc26.3.jar";
            "hash" = "sha512-Sth+RHVfFUqkggXsvvV48d4YsQ9YPNaN12jHNU4YbX9yY6kBq2z5iqDZEQ0Kvwz+ntBLJmJco76JG/Fsz2KtYw==";
        };
        _5Kwa4rlC = {
            "id" = "5Kwa4rlC";
    ...
    in {
        ...
        "forge-1.15" = _MJF3R8YM;
        "forge-1.15.1" = _MJF3R8YM;
        "forge-1.15.2" = _MJF3R8YM;
        "forge-1.16" = _t3yH4ZOv;
        "forge-1.16.1" = _t3yH4ZOv;
        "forge-1.16.2" = _t3yH4ZOv;
        "forge-1.16.3" = _t3yH4ZOv;
        "forge-1.16.4" = _t3yH4ZOv;
        "forge-1.16.5" = _t3yH4ZOv;
        "forge-1.17" = _RPOuGJ3Q;
        "forge-1.17.1" = _RPOuGJ3Q;
        "forge-1.18" = _4BgMapVA;
        "forge-1.18.1" = _4BgMapVA;
        "forge-1.18.2" = _4BgMapVA;
        "forge-1.19" = _uxAMJdgj;
        "forge-1.19.1" = _uxAMJdgj;
        "forge-1.19.2" = _uxAMJdgj;
        "forge-1.19.3" = _LiP4Or6X;
        "forge-1.19.4" = _brfCN7Om;
        "forge-1.20" = _H9XQzWIp;
        "forge-1.20.1" = _H9XQzWIp;
        "forge-1.20.2" = _DJaK0pfP;
        "forge-1.20.3" = _DJaK0pfP;
        "forge-1.20.4" = _DJaK0pfP;
        "forge-1.20.5" = _gI9mW8YR;
        "forge-1.20.6" = _gI9mW8YR;
        "forge-1.21" = _TSsMl0Jq;
        "forge-1.21.1" = _TSsMl0Jq;
        "forge-1.21.2" = _Jo86Z83I;
        "forge-1.21.3" = _Jo86Z83I;
        "forge-1.21.4" = _T3JqUFJk;
        "forge-1.21.5" = _tnelsmKk;
        "forge-1.21.6" = _kgBEJ1gS;
        "forge-1.21.7" = _kgBEJ1gS;
        "forge-1.21.8" = _kgBEJ1gS;
        "forge-1.21.9" = _rGCIJ0AW;
        "forge-1.21.10" = _rGCIJ0AW;
        "forge-1.21.11" = _vQLr7K5k;
        "forge-26.1" = _A5oBpT0L;
        "forge-26.1.1" = _A5oBpT0L;
        "forge-26.1.2" = _A5oBpT0L;
        "forge-26.2" = _tKxSA6zX;
        "fabric-1.19.4" = _PuK9OAyQ;
        "fabric-1.18" = _OEAXYdep;
        "fabric-1.18.1" = _OEAXYdep;
        "fabric-1.18.2" = _OEAXYdep;
        "fabric-1.19.2" = _DRWJtNYm;
        "fabric-1.20" = _CzSrE0Do;
        "fabric-1.20.1" = _CzSrE0Do;
        "fabric-1.20.2" = _oeKwgb3e;
        "fabric-1.20.3" = _oeKwgb3e;
        "fabric-1.20.4" = _oeKwgb3e;
        "fabric-1.20.5" = _td85pWRy;
        "fabric-1.20.6" = _td85pWRy;
        "fabric-1.21" = _7411ZFAs;
        "fabric-1.21.1" = _7411ZFAs;
        "fabric-1.21.2" = _NhjW3iRg;
        "fabric-1.21.3" = _NhjW3iRg;
        "fabric-1.21.4" = _GujuqOia;
        "fabric-1.21.5" = _9CXrmaGk;
        "fabric-1.21.6" = _vwSWXO9Q;
        "fabric-1.21.7" = _vwSWXO9Q;
        "fabric-1.21.8" = _vwSWXO9Q;
        "fabric-1.21.9" = _o6S0fbd6;
        "fabric-1.21.10" = _o6S0fbd6;
        "fabric-1.21.11" = _cR1nk2sH;
        "fabric-26.1" = _MSyzZAAt;
        ...
        "neoforge-1.20.3" = _wsAcYWT2;
        "neoforge-1.20.4" = _wsAcYWT2;
        "neoforge-1.20.5" = _lNE4VTJ0;
        "neoforge-1.20.6" = _lNE4VTJ0;
        "neoforge-1.21" = _6muGRqvu;
        "neoforge-1.21.1" = _6muGRqvu;
        "neoforge-1.21.2" = _TIYU6TeP;
        "neoforge-1.21.3" = _TIYU6TeP;
        "neoforge-1.21.4" = _yOJBlzBQ;
        "neoforge-1.21.5" = _38vnaCJz;
        "neoforge-1.21.6" = _Acm5y3eo;
        "neoforge-1.21.7" = _Acm5y3eo;
        "neoforge-1.21.8" = _Acm5y3eo;
        "neoforge-1.21.9" = _PsgHmriz;
        "neoforge-1.21.10" = _PsgHmriz;
        "neoforge-1.21.11" = _lgi9TbKk;
        "neoforge-26.1" = _V6Edgo0h;
        ...
        "quilt-1.19.2" = _DRWJtNYm;
        "quilt-1.19.4" = _PuK9OAyQ;
        "quilt-1.20" = _CzSrE0Do;
        "quilt-1.20.1" = _CzSrE0Do;
        "quilt-1.20.2" = _oeKwgb3e;
        "quilt-1.20.3" = _oeKwgb3e;
        "quilt-1.20.4" = _oeKwgb3e;
        "quilt-1.20.5" = _td85pWRy;
        "quilt-1.20.6" = _td85pWRy;
        "quilt-1.21" = _7411ZFAs;
        "quilt-1.21.1" = _7411ZFAs;
        "quilt-1.21.2" = _NhjW3iRg;
        "quilt-1.21.3" = _NhjW3iRg;
        "quilt-1.21.4" = _GujuqOia;
        "quilt-1.21.5" = _9CXrmaGk;
        "quilt-1.21.6" = _vwSWXO9Q;
        "quilt-1.21.7" = _vwSWXO9Q;
        "quilt-1.21.8" = _vwSWXO9Q;
        "quilt-1.21.9" = _o6S0fbd6;
        "quilt-1.21.10" = _o6S0fbd6;
        "quilt-1.21.11" = _cR1nk2sH;
        "quilt-26.1" = _MSyzZAAt;
        ...
        "pkg-1.0.10-forge-mc1.16" = _uyQrkiIS;
        "pkg-1.0.10-forge-mc1.17" = _6u8YH0ps;
        "pkg-1.0.10a-forge-mc1.18" = _Wm7cKAyO;
        "pkg-1.0.10c-forge-mc1.19" = _TlrgENQF;
        "pkg-1.0.10a-forge-mc1.14" = _kdffY39U;
        "pkg-1.0.11-forge-mc1.12" = _SqsDGTYo;
        "pkg-1.0.11-forge-mc1.14" = _mvcF8xmR;
        "pkg-1.0.11-forge-mc1.15" = _5B71uHnv;
        "pkg-1.0.11-forge-mc1.16" = _NUjhuqyW;
        "pkg-1.0.11-forge-mc1.18" = _L5lXuvm9;
        "pkg-1.0.11-forge-mc1.19" = _jgFbbqBv;
        "pkg-1.0.11-forge-mc1.17" = _RAnVgobl;
        "pkg-1.0.12-forge-mc1.12" = _omojdPXK;
        "pkg-1.0.12-forge-mc1.14" = _C97ptc3r;
        "pkg-1.0.12-forge-mc1.15" = _5SOjjlNm;
        "pkg-1.0.12-forge-mc1.16" = _qMcBYMcd;
        "pkg-1.0.12-forge-mc1.17" = _enreenTO;
        "pkg-1.0.12-forge-mc1.18" = _8uGPCx88;
        "pkg-1.0.12-forge-mc1.19" = _QH2Ok2VA;
        "pkg-1.0.12-forge-mc1.19.3" = _2WLFAsiE;
        "pkg-1.0.12a-forge-mc1.15" = _5JIFCwUO;
        "pkg-1.0.12a-forge-mc1.16" = _lXliKbyL;
        "pkg-1.0.12a-forge-mc1.17" = _MayH6oF7;
        "pkg-1.0.12a-forge-mc1.18" = _ttx4Hb91;
        "pkg-1.0.12a-forge-mc1.19" = _735Iixib;
        "pkg-1.0.12a-forge-mc1.19.3" = _AlQs9v0P;
        "pkg-1.0.12-forge-mc1.19.4" = _eakMeqnL;
        "pkg-1.0.12-fabric-mc1.19" = _Q6EyUwAB;
        "pkg-1.0.12-fabric-mc1.18" = _rsLMIFjz;
        "pkg-1.0.13-forge-mc1.12" = _NjRf7pzZ;
        "pkg-1.0.13-forge-mc1.14" = _O0dfKhzx;
        "pkg-1.0.13-forge-mc1.15" = _JMxrhqsZ;
        "pkg-1.0.13-forge-mc1.16" = _rGxnFfy7;
        "pkg-1.0.13-forge-mc1.17" = _gu531JiA;
        "pkg-1.0.13-forge-mc1.18" = _pJl823Bp;
        "pkg-1.0.13-forge-mc1.19" = _Sg19MkqZ;
        "pkg-1.0.13-forge-mc1.19.3" = _mdciX1yn;
        "pkg-1.0.13-forge-mc1.19.4" = _PUVgb1Ud;
        "pkg-1.0.13-fabric-mc1.18" = _l4syt2By;
        "pkg-1.0.13-fabric-mc1.19" = _LZ77dOgW;
        "pkg-1.0.13-fabric-mc1.19.2" = _ssmAZSoX;
        "pkg-1.1.0-forge-mc1.12" = _WkRNq7mr;
        "pkg-1.1.0-forge-mc1.14" = _eUK3XCcY;
        "pkg-1.1.0-forge-mc1.15" = _StnJk6Bl;
        "pkg-1.1.0-forge-mc1.16" = _fKfbfQHm;
        "pkg-1.1.0-forge-mc1.17" = _XiBMNRlB;
        "pkg-1.1.0-forge-mc1.18" = _g4MXcTYO;
        "pkg-1.1.0-forge-mc1.19.2" = _QpIcMP7Y;
        "pkg-1.1.0-forge-mc1.19.3" = _yB2HxAlb;
        "pkg-1.1.0-forge-mc1.19.4" = _J3Rz7Pjl;
        "pkg-1.1.0-forge-mc1.20" = _pCE5nvk5;
        "pkg-1.1.0-fabric-mc1.18" = _1PPxNviG;
        "pkg-1.1.0-fabric-mc1.19.2" = _26BhXOo4;
        "pkg-1.1.0-fabric-mc1.19.4" = _BRIWkued;
        "pkg-1.1.0-fabric-mc1.20" = _UFnwVQ04;
        "pkg-1.1.0a-forge-mc1.17" = _JzoptYY7;
        "pkg-1.1.0a-forge-mc1.18" = _x8pEz5YX;
        "pkg-1.1.0a-forge-mc1.19.2" = _zJaUBN57;
        "pkg-1.1.0a-forge-mc1.19.3" = _hm7x40V2;
        "pkg-1.1.0a-forge-mc1.19.4" = _hvTG0lLe;
        "pkg-1.1.0a-forge-mc1.20" = _KvERfJei;
        "pkg-1.1.0a-fabric-mc1.18" = _xIETpDpX;
        "pkg-1.1.0a-fabric-mc1.19.2" = _2gQydJoM;
        "pkg-1.1.0a-fabric-mc1.19.4" = _d7RnJW26;
        "pkg-1.1.0a-fabric-mc1.20" = _cv85a79c;
        "pkg-1.1.0b-fabric-mc1.19.2" = _K5ERP8ZO;
        "pkg-1.1.1-forge-mc1.12" = _F0n1vR5B;
        "pkg-1.1.1-forge-mc1.14" = _RuzRui4e;
        "pkg-1.1.1-forge-mc1.15" = _zAiLi5xl;
        "pkg-1.1.1-forge-mc1.16" = _dxQY8hSM;
        "pkg-1.1.1-forge-mc1.17" = _hEHCGl4A;
        "pkg-1.1.1-forge-mc1.18" = _ehR7bEyb;
        "pkg-1.1.1-forge-mc1.19.2" = _YpkNAWxe;
        "pkg-1.1.1-forge-mc1.19.3" = _Gx9CWpau;
        "pkg-1.1.1-forge-mc1.19.4" = _x3JXrinh;
        "pkg-1.1.1-forge-mc1.20" = _MuUVDVpP;
        "pkg-1.1.1-fabric-mc1.18" = _40yaTxqw;
        "pkg-1.1.1-fabric-mc1.19.2" = _apuCogMm;
        "pkg-1.1.1-fabric-mc1.19.4" = _wwOgF6P1;
        "pkg-1.1.1-fabric-mc1.20" = _wOMZrzBj;
        "pkg-1.1.1a-forge-mc1.12" = _ng61P0Wo;
        "pkg-1.1.1b-forge-mc1.12" = _khTSyZ78;
        "pkg-1.1.2-forge-mc1.12" = _QpjOkwqv;
        "pkg-1.1.2-forge-mc1.14" = _PJJ7WKDK;
        "pkg-1.1.2-forge-mc1.15" = _eF0SW9GJ;
        "pkg-1.1.2-forge-mc1.16" = _ECF4iYBP;
        "pkg-1.1.2-forge-mc1.17" = _Id3ghkgH;
        "pkg-1.1.2-forge-mc1.18" = _uHfeMb7l;
        "pkg-1.1.2-forge-mc1.19.2" = _5ti1JgRV;
        "pkg-1.1.2-forge-mc1.19.3" = _S1ypIKow;
        "pkg-1.1.2-forge-mc1.19.4" = _XELtWO7e;
        "pkg-1.1.2-forge-mc1.20" = _EAGSgSY2;
        "pkg-1.1.2-fabric-mc1.18" = _b6pE9t5g;
        "pkg-1.1.2-fabric-mc1.19.2" = _3UmeXyDO;
        "pkg-1.1.2-fabric-mc1.19.4" = _1kvaQP88;
        "pkg-1.1.2-fabric-mc1.20" = _voq1n4cH;
        "pkg-1.1.2a-forge-mc1.19.4" = _URdxIhlC;
        "pkg-1.1.2a-forge-mc1.20" = _6ekVFmmF;
        "pkg-1.1.2a-fabric-mc1.18" = _TIJoLZUS;
        "pkg-1.1.2a-fabric-mc1.19.2" = _BTxwYp6M;
        "pkg-1.1.2a-fabric-mc1.19.4" = _JDo8jovy;
        "pkg-1.1.2a-fabric-mc1.20" = _z2HhUKdO;
        "pkg-1.1.3-forge-mc1.12" = _frbyZ86N;
        "pkg-1.1.3-forge-mc1.14" = _pERmvjRv;
        "pkg-1.1.3-forge-mc1.15" = _9CWoIWQy;
        "pkg-1.1.3-forge-mc1.16" = _mFMesmnY;
        "pkg-1.1.3-forge-mc1.17" = _mAXdH7Tv;
        "pkg-1.1.3-forge-mc1.18" = _mdesxsXk;
        "pkg-1.1.3-forge-mc1.19.2" = _lIJJwjz6;
        "pkg-1.1.3-forge-mc1.19.3" = _B0LZuNDa;
        "pkg-1.1.3-forge-mc1.19.4" = _UEBkxuLZ;
        "pkg-1.1.3-forge-mc1.20" = _4pj8E261;
        "pkg-1.1.3-fabric-mc1.18" = _Js0kJvBJ;
        "pkg-1.1.3-fabric-mc1.19.2" = _Co4gIoW4;
        "pkg-1.1.3-fabric-mc1.19.4" = _pt2BUjRg;
        "pkg-1.1.3-fabric-mc1.20" = _ZNbWAdEH;
        "pkg-1.1.4-forge-mc1.12" = _yWPOpDwm;
        "pkg-1.1.4-forge-mc1.14" = _eXVhu8WT;
        "pkg-1.1.4-forge-mc1.15" = _khlzwxgX;
        "pkg-1.1.4-forge-mc1.16" = _238QgO79;
        "pkg-1.1.4-forge-mc1.17" = _oo6H4ZBa;
        "pkg-1.1.4-forge-mc1.18" = _J15tHUzB;
        "pkg-1.1.4-forge-mc1.19.2" = _k5fqqzU1;
        "pkg-1.1.4-forge-mc1.19.3" = _kFElVUic;
        "pkg-1.1.4-forge-mc1.19.4" = _mjaKf2Xl;
        "pkg-1.1.4-forge-mc1.20" = _uyJtsTpx;
        "pkg-1.1.4-fabric-mc1.18" = _tnYBaP0z;
        "pkg-1.1.4-fabric-mc1.19.2" = _K1IbUbot;
        "pkg-1.1.4-fabric-mc1.19.4" = _g70x9gPa;
        "pkg-1.1.4-fabric-mc1.20" = _IsITwGmS;
        "pkg-1.1.4a-fabric-mc1.18" = _vVBIfnO0;
        "pkg-1.1.4a-fabric-mc1.19.2" = _CtHNKbhE;
        "pkg-1.1.4a-fabric-mc1.19.4" = _2wvT44sT;
        "pkg-1.1.4a-fabric-mc1.20" = _v6ncxcxu;
        "pkg-1.1.4a-forge-mc1.17" = _KFoVnJIG;
        "pkg-1.1.4a-forge-mc1.18" = _3Nat2AdB;
        "pkg-1.1.4a-forge-mc1.19.2" = _ZXeEHTwH;
        "pkg-1.1.4a-forge-mc1.19.3" = _1bfhrQbl;
        "pkg-1.1.4a-forge-mc1.19.4" = _qsP4jSAF;
        "pkg-1.1.4a-forge-mc1.20" = _PC5rqFmL;
        "pkg-1.1.5-forge-mc1.12" = _1Zl4WaSe;
        "pkg-1.1.5-forge-mc1.14" = _l6Y9RNlO;
        "pkg-1.1.5-forge-mc1.15" = _Br2vWwlR;
        "pkg-1.1.5-forge-mc1.16" = _kxoJbPKw;
        "pkg-1.1.5-forge-mc1.17" = _sCJ4dtds;
        "pkg-1.1.5-forge-mc1.18" = _kWl1NUCg;
        "pkg-1.1.5-forge-mc1.19.2" = _OtlduN35;
        "pkg-1.1.5-forge-mc1.19.3" = _2QWdoB1q;
        "pkg-1.1.5-forge-mc1.19.4" = _FS3eFKhZ;
        "pkg-1.1.5-forge-mc1.20" = _jwZ0inkb;
        "pkg-1.1.5-fabric-mc1.18" = _6r6qC8tF;
        "pkg-1.1.5-fabric-mc1.19.2" = _p4WA0Stj;
        "pkg-1.1.5-fabric-mc1.19.4" = _Ex9aPrt2;
        "pkg-1.1.5-fabric-mc1.20" = _AY2LLl5W;
        "pkg-1.1.5a-forge-mc1.18" = _Bd1gzuRo;
        "pkg-1.1.5a-forge-mc1.19.2" = _VWPIE8uM;
        "pkg-1.1.5a-forge-mc1.19.3" = _thRQ89L6;
        "pkg-1.1.5a-forge-mc1.19.4" = _9ui7hH9L;
        "pkg-1.1.5a-forge-mc1.20" = _tm4a38bP;
        "pkg-1.1.5a-fabric-mc1.18" = _kBZcUHDo;
        "pkg-1.1.5a-fabric-mc1.19.4" = _OP50fqrZ;
        "pkg-1.1.5a-fabric-mc1.20" = _4IFAUrC2;
        "pkg-1.1.5a-forge-mc1.16" = _8XgS3Oiy;
        "pkg-1.1.5a-forge-mc1.17" = _YFL1fmeK;
        "pkg-1.1.5b-forge-mc1.18" = _KiUI1bTz;
        "pkg-1.1.5b-forge-mc1.19.2" = _y2V3yYO0;
        "pkg-1.1.5b-forge-mc1.19.3" = _SppGs5k2;
        "pkg-1.1.5b-forge-mc1.19.4" = _WZWzcBCg;
        "pkg-1.1.5b-forge-mc1.20" = _zO7RPAX5;
        "pkg-1.1.5b-fabric-mc1.18" = _x2P4H5uD;
        "pkg-1.1.5b-fabric-mc1.19.2" = _i867HqW4;
        "pkg-1.1.5b-fabric-mc1.19.4" = _AY9lziyO;
        "pkg-1.1.5b-fabric-mc1.20" = _9RrwNTgN;
        "pkg-1.1.5a-forge-mc1.12" = _eQhEislk;
        "pkg-1.1.5c-forge-mc1.19.2" = _MHninPVS;
        "pkg-1.1.5c-forge-mc1.19.3" = _BgN8sFYB;
        "pkg-1.1.5c-forge-mc1.19.4" = _LArnBqB8;
        "pkg-1.1.5c-forge-mc1.20" = _ChrMlKQC;
        "pkg-1.1.5-neoforge-mc1.20.4" = _bazfWKTz;
        "pkg-1.1.5b-forge-mc1.12" = _dYPQbhDI;
        "pkg-1.1.6-forge-mc1.12" = _CkduFmKC;
        "pkg-1.1.6-forge-mc1.14" = _vAIQjNC6;
        "pkg-1.1.6-forge-mc1.15" = _S6Yg0mmj;
        "pkg-1.1.6-forge-mc1.16" = _tDX6MDe5;
        "pkg-1.1.6-forge-mc1.17" = _3GpVqntu;
        "pkg-1.1.6-forge-mc1.18" = _qwQKMksu;
        "pkg-1.1.6-forge-mc1.19.2" = _MqJJHr9Y;
        "pkg-1.1.6-forge-mc1.19.3" = _KRfoYc3i;
        "pkg-1.1.6-forge-mc1.19.4" = _6FhRgZlQ;
        "pkg-1.1.6-forge-mc1.20" = _C384ujVf;
        "pkg-1.1.6-fabric-mc1.18" = _t8J9uljl;
        "pkg-1.1.6-fabric-mc1.19.2" = _9TtNuPtE;
        "pkg-1.1.6-fabric-mc1.19.4" = _IdoWBFqX;
        "pkg-1.1.6-fabric-mc1.20" = _UG6Mfv39;
        "pkg-1.1.6-neoforge-mc1.20.4" = _5q2ewK5k;
        "pkg-1.1.6-forge-mc1.20.6" = _hOkNYQsi;
        "pkg-1.1.6-forge-mc1.21" = _mjLz2liu;
        "pkg-1.1.6-fabric-mc1.20.6" = _WmpGAal1;
        "pkg-1.1.6-fabric-mc1.21" = _uCjU878l;
        "pkg-1.1.6-neoforge-mc1.20.6" = _HJNmBCOA;
        "pkg-1.1.6-neoforge-mc1.21" = _HeGVozuh;
        "pkg-1.1.6a-fabric-mc1.20.6" = _H9VzvLhR;
        "pkg-1.1.6a-fabric-mc1.21" = _R8Uj2vqZ;
        "pkg-1.1.6a-forge-mc1.21" = _jmIsAPwj;
        "pkg-1.1.6b-fabric-mc1.21" = _X8UhAfDk;
        "pkg-1.1.6a-neoforge-mc1.21" = _UZPjD9WH;
        "pkg-1.1.6-forge-mc1.21.3" = _RuDpzU3E;
        "pkg-1.1.6-forge-mc1.21.4" = _6gg7ERaG;
        "pkg-1.1.6-fabric-mc1.21.3" = _W5jcoG22;
        "pkg-1.1.6-fabric-mc1.21.4" = _gmJlgj6Q;
        "pkg-1.1.6-neoforge-mc1.21.3" = _kYjTxYOf;
        "pkg-1.1.6-neoforge-mc1.21.4" = _QwiflodS;
        "pkg-1.1.6a-neoforge-mc1.21.4" = _JbiZbhtr;
        "pkg-1.1.6a-forge-mc1.21.4" = _g0xFMM8g;
        "pkg-1.1.6a-fabric-mc1.21.4" = _CujNsdef;
        "pkg-1.1.6b-neoforge-mc1.21.4" = _sTx79wsC;
        "pkg-1.1.6-forge-mc1.21.5" = _JTjrrpag;
        "pkg-1.1.6-forge-mc1.21.6" = _h4ERoQGF;
        "pkg-1.1.6-fabric-mc1.21.5" = _ZGQhN1Tq;
        "pkg-1.1.6-fabric-mc1.21.6" = _iJr78tXj;
        "pkg-1.1.6-neoforge-mc1.21.5" = _EivCLxnw;
        "pkg-1.1.6-neoforge-mc1.21.6" = _ZnNnk48C;
        "pkg-1.1.6a-forge-mc1.21.6" = _XjNWfAqu;
        "pkg-1.1.6a-fabric-mc1.21.6" = _RJWLgkg2;
        "pkg-1.1.6a-neoforge-mc1.21.6" = _xHjSLyLN;
        "pkg-1.1.6b-forge-mc1.21.8" = _jmZnbYcD;
        "pkg-1.1.6b-fabric-mc1.21.8" = _9ehXCkmw;
        "pkg-1.1.6b-neoforge-mc1.21.8" = _PuNnYYfp;
        "pkg-1.1.6-forge-mc1.21.10" = _WdNQrXWU;
        "pkg-1.1.6-fabric-mc1.21.10" = _7H5pUOzZ;
        "pkg-1.1.6-neoforge-mc1.21.10" = _vrnpA2Kt;
        "pkg-1.1.6-forge-mc1.21.11" = _H1hxtNkZ;
        "pkg-1.1.6-fabric-mc1.21.11" = _JDY5u2VM;
        "pkg-1.1.6-neoforge-mc1.21.11" = _28nq9iWN;
        "pkg-1.2.0-forge-mc1.12" = _yVHsGhke;
        "pkg-1.2.0-forge-mc1.15" = _TO6fCs1o;
        "pkg-1.2.0-forge-mc1.16" = _ljpSSRXA;
        "pkg-1.2.0-forge-mc1.17" = _VR4lrmEw;
        "pkg-1.2.0-forge-mc1.18" = _Zzogrum7;
        "pkg-1.2.0-forge-mc1.19.2" = _bgNimEfk;
        "pkg-1.2.0-forge-mc1.19.3" = _RvrSvlnv;
        "pkg-1.2.0-forge-mc1.19.4" = _K5GqHSBD;
        "pkg-1.2.0-forge-mc1.20.1" = _dgPt2sBq;
        "pkg-1.2.0-forge-mc1.20.4" = _RuP79ezj;
        "pkg-1.2.0-forge-mc1.20.6" = _unP83zcy;
        "pkg-1.2.0-forge-mc1.21" = _b4z5BLHO;
        "pkg-1.2.0-forge-mc1.21.3" = _ZNSxe6EX;
        "pkg-1.2.0-forge-mc1.21.4" = _RUBb36Qn;
        "pkg-1.2.0-forge-mc1.21.5" = _zZkH3RED;
        "pkg-1.2.0-forge-mc1.21.8" = _rLLql1tu;
        "pkg-1.2.0-forge-mc1.21.10" = _TQ6yVAR3;
        "pkg-1.2.0-forge-mc1.21.11" = _DxZVMSl8;
        "pkg-1.2.0-fabric-mc1.18" = _tnh42MUX;
        "pkg-1.2.0-fabric-mc1.19.2" = _GzTls14R;
        "pkg-1.2.0-fabric-mc1.19.4" = _mMMahKlJ;
        "pkg-1.2.0-fabric-mc1.20.1" = _sb55Vn86;
        "pkg-1.2.0-fabric-mc1.20.4" = _h3mek0RP;
        "pkg-1.2.0-fabric-mc1.20.6" = _Y8mfEL5w;
        "pkg-1.2.0-fabric-mc1.21" = _wUdSnWVm;
        "pkg-1.2.0-fabric-mc1.21.3" = _1EPXNI01;
        "pkg-1.2.0-fabric-mc1.21.4" = _SkKrPxFl;
        "pkg-1.2.0-fabric-mc1.21.5" = _GIfgTASu;
        "pkg-1.2.0-fabric-mc1.21.8" = _LzSjraJ6;
        "pkg-1.2.0-fabric-mc1.21.10" = _r4PdZVDg;
        "pkg-1.2.0-fabric-mc1.21.11" = _i40jfj1r;
        "pkg-1.2.0-neoforge-mc1.20.4" = _2ZBqJIJi;
        "pkg-1.2.0-neoforge-mc1.20.6" = _n4cQLVUb;
        "pkg-1.2.0-neoforge-mc1.21" = _6mt8uo8G;
        "pkg-1.2.0-neoforge-mc1.21.3" = _QRxa8J7H;
        "pkg-1.2.0-neoforge-mc1.21.4" = _d21C2vSo;
        "pkg-1.2.0-neoforge-mc1.21.5" = _ILkOuYh0;
        "pkg-1.2.0-neoforge-mc1.21.8" = _gmtYmWdd;
        "pkg-1.2.0-neoforge-mc1.21.10" = _NMVnA5Pj;
        "pkg-1.2.0-neoforge-mc1.21.11" = _DkXMBPYn;
        "pkg-1.2.1-forge-mc1.12" = _rS4yDAqT;
        "pkg-1.2.1-forge-mc1.15" = _nddxbmKx;
        "pkg-1.2.1-forge-mc1.16" = _u0DmCqgN;
        "pkg-1.2.1-forge-mc1.17" = _c4nHjkhZ;
        "pkg-1.2.1-forge-mc1.18" = _6RlGl8mA;
        "pkg-1.2.1-forge-mc1.19.2" = _TrRShyMH;
        "pkg-1.2.1-forge-mc1.19.3" = _sZILO9EK;
        "pkg-1.2.1-forge-mc1.19.4" = _jS6RUHVm;
        "pkg-1.2.1-forge-mc1.20.1" = _h7IUX01a;
        "pkg-1.2.1-forge-mc1.20.4" = _KSBtTake;
        "pkg-1.2.1-forge-mc1.20.6" = _9DBRWGyH;
        "pkg-1.2.1-forge-mc1.21" = _dkKhtvs8;
        "pkg-1.2.1-forge-mc1.21.3" = _liyaxuj5;
        "pkg-1.2.1-forge-mc1.21.4" = _ACyRI9ae;
        "pkg-1.2.1-forge-mc1.21.5" = _tlqTI9ZI;
        "pkg-1.2.1-forge-mc1.21.8" = _mBfJwG3A;
        "pkg-1.2.1-forge-mc1.21.10" = _ApKQM9rN;
        "pkg-1.2.1-forge-mc1.21.11" = _sxNhfS6p;
        "pkg-1.2.1-fabric-mc1.18" = _Yq3etV7e;
        "pkg-1.2.1-fabric-mc1.19.2" = _2IzLJLnW;
        "pkg-1.2.1-fabric-mc1.19.4" = _KynWvWka;
        "pkg-1.2.1-fabric-mc1.20.1" = _C8tx6eHS;
        "pkg-1.2.1-fabric-mc1.20.4" = _kSW48y8B;
        "pkg-1.2.1-fabric-mc1.20.6" = _Sncck4Kx;
        "pkg-1.2.1-fabric-mc1.21" = _cADRkUdQ;
        "pkg-1.2.1-fabric-mc1.21.3" = _wUjLa9hF;
        "pkg-1.2.1-fabric-mc1.21.4" = _sMWP98ox;
        "pkg-1.2.1-fabric-mc1.21.5" = _5Xp0m0yT;
        "pkg-1.2.1-fabric-mc1.21.8" = _FyHIcvyz;
        "pkg-1.2.1-fabric-mc1.21.10" = _Su5VHxZJ;
        "pkg-1.2.1-fabric-mc1.21.11" = _z9ok21BW;
        "pkg-1.2.1-neoforge-mc1.20.4" = _b0zPoshT;
        "pkg-1.2.1-neoforge-mc1.20.6" = _gUfGNTFR;
        "pkg-1.2.1-neoforge-mc1.21" = _L3VzIZ2O;
        "pkg-1.2.1-neoforge-mc1.21.3" = _WGZKfjiZ;
        "pkg-1.2.1-neoforge-mc1.21.4" = _U4dqCNUq;
        "pkg-1.2.1-neoforge-mc1.21.5" = _XSiMR26Q;
        "pkg-1.2.1-neoforge-mc1.21.8" = _OYRorZ4i;
        "pkg-1.2.1-neoforge-mc1.21.10" = _eHU0XrZb;
        "pkg-1.2.1-neoforge-mc1.21.11" = _ZoUxtAef;
        "pkg-1.2.2-forge-mc1.12" = _6ub6YzYF;
        "pkg-1.2.2-forge-mc1.15" = _iPntiIo5;
        "pkg-1.2.2-forge-mc1.16" = _MXhX2aHO;
        "pkg-1.2.2-forge-mc1.17" = _gWPVn3G0;
        "pkg-1.2.2-forge-mc1.18" = _fnKsOJOh;
        "pkg-1.2.2-forge-mc1.19.2" = _NbCjWmG7;
        "pkg-1.2.2-forge-mc1.19.3" = _R8FA0Cwp;
        "pkg-1.2.2-forge-mc1.19.4" = _fFkrAOWk;
        "pkg-1.2.2-forge-mc1.20.1" = _tePFrBGu;
        "pkg-1.2.2-forge-mc1.20.4" = _6rJh0UVH;
        "pkg-1.2.2-forge-mc1.20.6" = _7fwdDSOZ;
        "pkg-1.2.2-forge-mc1.21" = _vskaSaeE;
        "pkg-1.2.2-forge-mc1.21.3" = _a0ZzCqCr;
        "pkg-1.2.2-forge-mc1.21.4" = _2Rz1J9eC;
        "pkg-1.2.2-forge-mc1.21.5" = _c5dl8QUO;
        "pkg-1.2.2-forge-mc1.21.8" = _XHqAS1fk;
        "pkg-1.2.2-forge-mc1.21.10" = _5odd1FXO;
        "pkg-1.2.2-forge-mc1.21.11" = _truSbqCT;
        "pkg-1.2.2-fabric-mc1.18" = _WJGEWWGF;
        "pkg-1.2.2-fabric-mc1.19.2" = _rvw2MQPt;
        "pkg-1.2.2-fabric-mc1.19.4" = _ua3vnz08;
        "pkg-1.2.2-fabric-mc1.20.1" = _J9vz8Rx5;
        "pkg-1.2.2-fabric-mc1.20.4" = _U3Ps6sOM;
        "pkg-1.2.2-fabric-mc1.20.6" = _f7VxpLLo;
        "pkg-1.2.2-fabric-mc1.21" = _KXb4v5sD;
        "pkg-1.2.2-fabric-mc1.21.3" = _dS6W7AAA;
        "pkg-1.2.2-fabric-mc1.21.4" = _oQmrrkwf;
        "pkg-1.2.2-fabric-mc1.21.5" = _BwpN9UIq;
        "pkg-1.2.2-fabric-mc1.21.8" = _v0YM5F0r;
        "pkg-1.2.2-fabric-mc1.21.10" = _juiO06kL;
        "pkg-1.2.2-fabric-mc1.21.11" = _Qw1OVOyP;
        "pkg-1.2.2-neoforge-mc1.20.4" = _z2gIZemj;
        "pkg-1.2.2-neoforge-mc1.20.6" = _60aGFh62;
        "pkg-1.2.2-neoforge-mc1.21" = _FRKjOzBv;
        "pkg-1.2.2-neoforge-mc1.21.3" = _yidED2To;
        "pkg-1.2.2-neoforge-mc1.21.4" = _7z0yP0YK;
        "pkg-1.2.2-neoforge-mc1.21.5" = _YBk52750;
        "pkg-1.2.2-neoforge-mc1.21.8" = _WOkcuKaJ;
        "pkg-1.2.2-neoforge-mc1.21.10" = _7RdXiHgU;
        "pkg-1.2.2-neoforge-mc1.21.11" = _qmngAgYd;
        "pkg-1.2.3-forge-mc1.12" = _mJfr6syl;
        "pkg-1.2.3-forge-mc1.15" = _Fc9iZLLZ;
        "pkg-1.2.3-forge-mc1.16" = _Ew8f0bo0;
        "pkg-1.2.3-forge-mc1.17" = _X7OtPGTX;
        "pkg-1.2.3-forge-mc1.18" = _zNgJRO5a;
        "pkg-1.2.3-forge-mc1.19.2" = _3RkDybxK;
        "pkg-1.2.3-forge-mc1.19.3" = _XCNwABXN;
        "pkg-1.2.3-forge-mc1.19.4" = _VHNcWEi5;
        "pkg-1.2.3-forge-mc1.20.1" = _LkmLA8Wu;
        "pkg-1.2.3-forge-mc1.20.4" = _4vxYkJEJ;
        "pkg-1.2.3-forge-mc1.20.6" = _JTFb1YgF;
        "pkg-1.2.3-forge-mc1.21" = _AXkpXuMs;
        "pkg-1.2.3-forge-mc1.21.3" = _ljnhVw8t;
        "pkg-1.2.3-forge-mc1.21.4" = _c2YCAsOC;
        "pkg-1.2.3-forge-mc1.21.5" = _XPSXFKZU;
        "pkg-1.2.3-forge-mc1.21.8" = _LLFtryug;
        "pkg-1.2.3-forge-mc1.21.10" = _djZcZBWZ;
        "pkg-1.2.3-forge-mc1.21.11" = _xSkU672x;
        "pkg-1.2.3-fabric-mc1.18" = _EZcKvzZk;
        "pkg-1.2.3-fabric-mc1.19.2" = _O3iQJkvT;
        "pkg-1.2.3-fabric-mc1.19.4" = _iAWics5Y;
        "pkg-1.2.3-fabric-mc1.20.1" = _H3AIYXq3;
        "pkg-1.2.3-fabric-mc1.20.4" = _wzoRcWAy;
        "pkg-1.2.3-fabric-mc1.20.6" = _VuzyJdCU;
        "pkg-1.2.3-fabric-mc1.21" = _OwCOXqgz;
        "pkg-1.2.3-fabric-mc1.21.3" = _Iy02LI0J;
        "pkg-1.2.3-fabric-mc1.21.4" = _b5aQ5JxY;
        "pkg-1.2.3-fabric-mc1.21.5" = _k4q2Il2l;
        "pkg-1.2.3-fabric-mc1.21.8" = _ULqkchoC;
        "pkg-1.2.3-fabric-mc1.21.10" = _HkLyjWEg;
        "pkg-1.2.3-fabric-mc1.21.11" = _tir8luGz;
        "pkg-1.2.3-neoforge-mc1.20.4" = _xmTmzTG3;
        "pkg-1.2.3-neoforge-mc1.20.6" = _iAMzNoT8;
        "pkg-1.2.3-neoforge-mc1.21" = _zz0F2CnK;
        "pkg-1.2.3-neoforge-mc1.21.3" = _HXxIlXgo;
        "pkg-1.2.3-neoforge-mc1.21.4" = _yz3szmmC;
        "pkg-1.2.3-neoforge-mc1.21.5" = _pgFi4dvn;
        "pkg-1.2.3-neoforge-mc1.21.8" = _qsjWlb2f;
        "pkg-1.2.3-neoforge-mc1.21.10" = _ZTuiFYJ3;
        "pkg-1.2.3-neoforge-mc1.21.11" = _HmauCSH2;
        "pkg-1.2.4-forge-mc1.12" = _Ro1P0YHE;
        "pkg-1.2.4-forge-mc1.15" = _N7yl7gG7;
        "pkg-1.2.4-forge-mc1.16" = _RU32ycst;
        "pkg-1.2.4-forge-mc1.17" = _G4VaRwAS;
        "pkg-1.2.4-forge-mc1.18" = _MjUhOX5E;
        "pkg-1.2.4-forge-mc1.19.2" = _FkNyZJRy;
        "pkg-1.2.4-forge-mc1.19.3" = _4MIaLXf5;
        "pkg-1.2.4-forge-mc1.19.4" = _Jv90l7CL;
        "pkg-1.2.4-forge-mc1.20.1" = _ZZTYn1VH;
        "pkg-1.2.4-forge-mc1.20.4" = _yFUy3CNF;
        "pkg-1.2.4-forge-mc1.20.6" = _ia2aJrHa;
        "pkg-1.2.4-forge-mc1.21" = _84asbDVS;
        "pkg-1.2.4-forge-mc1.21.3" = _xv1GWeR4;
        "pkg-1.2.4-forge-mc1.21.4" = _5sTqbHLj;
        "pkg-1.2.4-forge-mc1.21.5" = _LELv2nKb;
        "pkg-1.2.4-forge-mc1.21.8" = _JDkP0BW0;
        "pkg-1.2.4-forge-mc1.21.10" = _E8kCCMvK;
        "pkg-1.2.4-forge-mc1.21.11" = _FKdXhC5w;
        "pkg-1.2.4-fabric-mc1.18" = _CtP5RQyJ;
        "pkg-1.2.4-fabric-mc1.19.2" = _WTax00fd;
        "pkg-1.2.4-fabric-mc1.19.4" = _OLc0AbRp;
        "pkg-1.2.4-fabric-mc1.20.1" = _kxASWLSw;
        "pkg-1.2.4-fabric-mc1.20.4" = _lJHnOFsP;
        "pkg-1.2.4-fabric-mc1.20.6" = _NHwcm3Oi;
        "pkg-1.2.4-fabric-mc1.21" = _Whwd5n82;
        "pkg-1.2.4-fabric-mc1.21.3" = _JKPq73FF;
        "pkg-1.2.4-fabric-mc1.21.4" = _cpzNw3eu;
        "pkg-1.2.4-fabric-mc1.21.5" = _Olg6bW7h;
        "pkg-1.2.4-fabric-mc1.21.8" = _7QdMVz6K;
        "pkg-1.2.4-fabric-mc1.21.10" = _kDrVLRka;
        "pkg-1.2.4-fabric-mc1.21.11" = _eP9mxrCl;
        "pkg-1.2.4-neoforge-mc1.20.4" = _nvxbUY4l;
        "pkg-1.2.4-neoforge-mc1.20.6" = _FjYLUdQZ;
        "pkg-1.2.4-neoforge-mc1.21" = _b3uurWWs;
        "pkg-1.2.4-neoforge-mc1.21.3" = _JiAszR2V;
        "pkg-1.2.4-neoforge-mc1.21.4" = _gMv84zPV;
        "pkg-1.2.4-neoforge-mc1.21.5" = _3PBwQ59I;
        "pkg-1.2.4-neoforge-mc1.21.8" = _T9vmBo1o;
        "pkg-1.2.4-neoforge-mc1.21.10" = _W5rMcgeh;
        "pkg-1.2.4-neoforge-mc1.21.11" = _U9WvxLmd;
        "pkg-1.2.4a-forge-mc1.15" = _ua6NKR86;
        "pkg-1.2.4a-forge-mc1.16" = _qg8ChLCD;
        "pkg-1.2.4a-forge-mc1.17" = _CMym0EIU;
        "pkg-1.2.4a-fabric-mc1.18" = _wsLkb34T;
        "pkg-1.2.4a-fabric-mc1.19.2" = _MHzLRvJ5;
        "pkg-1.2.5-forge-mc1.12" = _Aohll2kR;
        "pkg-1.2.5-forge-mc1.15" = _Kc4iWxS9;
        "pkg-1.2.5-forge-mc1.16" = _4yHCJZ5s;
        "pkg-1.2.5-forge-mc1.17" = _BZWx9vME;
        "pkg-1.2.5-forge-mc1.18" = _lIaV8F7H;
        "pkg-1.2.5-forge-mc1.19.2" = _RE0X4SfI;
        "pkg-1.2.5-forge-mc1.19.3" = _zSYUq3Ap;
        "pkg-1.2.5-forge-mc1.19.4" = _9c2dDfIM;
        "pkg-1.2.5-forge-mc1.20.1" = _yM2eLjQ4;
        "pkg-1.2.5-forge-mc1.20.4" = _DbenMO0I;
        "pkg-1.2.5-forge-mc1.20.6" = _uvDhq059;
        "pkg-1.2.5-forge-mc1.21" = _sNTNx4jg;
        "pkg-1.2.5-forge-mc1.21.3" = _t7JvnOwk;
        "pkg-1.2.5-forge-mc1.21.4" = _IpG7vFer;
        "pkg-1.2.5-forge-mc1.21.5" = _VFRi0X00;
        "pkg-1.2.5-forge-mc1.21.8" = _qT5yPasD;
        "pkg-1.2.5-forge-mc1.21.10" = _FZmfMjMb;
        "pkg-1.2.5-forge-mc1.21.11" = _SoQljrjI;
        "pkg-1.2.5-fabric-mc1.18" = _FlIDOGZy;
        "pkg-1.2.5-fabric-mc1.19.2" = _v8TAU2Mg;
        "pkg-1.2.5-fabric-mc1.19.4" = _jJpXRJd6;
        "pkg-1.2.5-fabric-mc1.20.1" = _uBQ9cb0y;
        "pkg-1.2.5-fabric-mc1.20.4" = _H4YTGQ1N;
        "pkg-1.2.5-fabric-mc1.20.6" = _JBpcwH3Q;
        "pkg-1.2.5-fabric-mc1.21" = _v3CzX4a3;
        "pkg-1.2.5-fabric-mc1.21.3" = _Dwae1H0W;
        "pkg-1.2.5-fabric-mc1.21.4" = _2aidHgME;
        "pkg-1.2.5-fabric-mc1.21.5" = _96Uen0aK;
        "pkg-1.2.5-fabric-mc1.21.8" = _loDhqPui;
        "pkg-1.2.5-fabric-mc1.21.10" = _fJ9dtuPt;
        "pkg-1.2.5-fabric-mc1.21.11" = _xRYTe1dn;
        "pkg-1.2.5-neoforge-mc1.20.4" = _vRlCi6oL;
        "pkg-1.2.5-neoforge-mc1.20.6" = _mot3Buua;
        "pkg-1.2.5-neoforge-mc1.21" = _S5FnErRw;
        "pkg-1.2.5-neoforge-mc1.21.3" = _YHeHyOh2;
        "pkg-1.2.5-neoforge-mc1.21.4" = _QWuAJonf;
        "pkg-1.2.5-neoforge-mc1.21.5" = _tbY82DfN;
        "pkg-1.2.5-neoforge-mc1.21.8" = _hgFyMPBo;
        "pkg-1.2.5-neoforge-mc1.21.10" = _a3zQC9Pr;
        "pkg-1.2.5-neoforge-mc1.21.11" = _7ZeiItMx;
        "pkg-1.2.5-forge-mc26.1" = _EgcmNlvr;
        "pkg-1.2.5-fabric-mc26.1" = _3V0PTCGv;
        "pkg-1.2.5-neoforge-mc26.1" = _bhoIwLZm;
        "pkg-1.2.5-forge-mc26.2" = _s04BBHHs;
        "pkg-1.2.5-fabric-mc26.2" = _NxJGKz5b;
        "pkg-1.2.5-neoforge-mc26.2" = _JABdGFXO;
        "pkg-1.2.5a-neoforge-mc26.2" = _aZH7p1sk;
        "pkg-1.2.6-forge-mc1.12" = _j7NBe6kO;
        "pkg-1.2.6-forge-mc1.15" = _MJF3R8YM;
        "pkg-1.2.6-forge-mc1.16" = _t3yH4ZOv;
        "pkg-1.2.6-forge-mc1.17" = _RPOuGJ3Q;
        "pkg-1.2.6-forge-mc1.18" = _4BgMapVA;
        "pkg-1.2.6-forge-mc1.19.2" = _uxAMJdgj;
        "pkg-1.2.6-forge-mc1.19.3" = _LiP4Or6X;
        "pkg-1.2.6-forge-mc1.19.4" = _brfCN7Om;
        "pkg-1.2.6-forge-mc1.20.1" = _H9XQzWIp;
        "pkg-1.2.6-forge-mc1.20.4" = _DJaK0pfP;
        "pkg-1.2.6-forge-mc1.20.6" = _gI9mW8YR;
        "pkg-1.2.6-forge-mc1.21" = _TSsMl0Jq;
        "pkg-1.2.6-forge-mc1.21.3" = _Jo86Z83I;
        "pkg-1.2.6-forge-mc1.21.4" = _T3JqUFJk;
        "pkg-1.2.6-forge-mc1.21.5" = _tnelsmKk;
        "pkg-1.2.6-forge-mc1.21.8" = _kgBEJ1gS;
        "pkg-1.2.6-forge-mc1.21.10" = _rGCIJ0AW;
        "pkg-1.2.6-forge-mc1.21.11" = _vQLr7K5k;
        "pkg-1.2.6-forge-mc26.1" = _A5oBpT0L;
        "pkg-1.2.6-forge-mc26.2" = _tKxSA6zX;
        "pkg-1.2.6-fabric-mc1.18" = _OEAXYdep;
        "pkg-1.2.6-fabric-mc1.19.2" = _DRWJtNYm;
        "pkg-1.2.6-fabric-mc1.19.4" = _PuK9OAyQ;
        "pkg-1.2.6-fabric-mc1.20.1" = _CzSrE0Do;
        "pkg-1.2.6-fabric-mc1.20.4" = _oeKwgb3e;
        "pkg-1.2.6-fabric-mc1.20.6" = _td85pWRy;
        "pkg-1.2.6-fabric-mc1.21" = _7411ZFAs;
        "pkg-1.2.6-fabric-mc1.21.3" = _NhjW3iRg;
        "pkg-1.2.6-fabric-mc1.21.4" = _GujuqOia;
        "pkg-1.2.6-fabric-mc1.21.5" = _9CXrmaGk;
        "pkg-1.2.6-fabric-mc1.21.8" = _vwSWXO9Q;
        "pkg-1.2.6-fabric-mc1.21.10" = _o6S0fbd6;
        "pkg-1.2.6-fabric-mc1.21.11" = _cR1nk2sH;
        "pkg-1.2.6-fabric-mc26.1" = _MSyzZAAt;
        "pkg-1.2.6-fabric-mc26.2" = _u535HhZe;
        "pkg-1.2.6-neoforge-mc1.20.4" = _wsAcYWT2;
        "pkg-1.2.6-neoforge-mc1.20.6" = _lNE4VTJ0;
        "pkg-1.2.6-neoforge-mc1.21" = _6muGRqvu;
        "pkg-1.2.6-neoforge-mc1.21.3" = _TIYU6TeP;
        "pkg-1.2.6-neoforge-mc1.21.4" = _yOJBlzBQ;
        "pkg-1.2.6-neoforge-mc1.21.5" = _38vnaCJz;
        "pkg-1.2.6-neoforge-mc1.21.8" = _Acm5y3eo;
        "pkg-1.2.6-neoforge-mc1.21.10" = _PsgHmriz;
        "pkg-1.2.6-neoforge-mc1.21.11" = _lgi9TbKk;
        "pkg-1.2.6-neoforge-mc26.1" = _V6Edgo0h;
