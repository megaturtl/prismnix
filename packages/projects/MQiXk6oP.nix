...
let
    ...
    in {
        ...
        "pkg-1.0.0+mc1.20.2" = _QFhVHsui;
        "pkg-1.0.1+mc1.20.4" = _5q1zck8P;
        "pkg-1.0.0+mc1.20.3" = _QIhGCysV;
        "pkg-1.0.2+mc1.20.4" = _vbNUgjS2;
        "pkg-1.0.3+mc1.20.4" = _pgImXyGQ;
        "pkg-1.0.3+mc1.20.3" = _1xzOKYET;
        "pkg-1.0.3+mc1.20.2" = _fP1MWV9U;
        "pkg-1.0.4+mc1.20.2" = _LhdAe40m;
        "pkg-1.0.4+mc1.20.3" = _nbAZdEOi;
        "pkg-1.0.4+mc1.20.4" = _kBVifpN2;
        "pkg-1.0.5+mc1.20.4" = _2zNTGRs1;
        "pkg-1.0.5+mc1.20.5" = _LtFbOtId;
        "pkg-1.0.5+mc1.20.6" = _pBM2Rxkr;
        "pkg-1.0.5+mc1.21" = _OZDyUHpr;
        "pkg-1.0.5+mc1.21.1" = _fbGE9aAy;
        "pkg-1.0.5+mc1.21.2" = _loYJBzR5;
        "pkg-1.0.5+mc1.21.3" = _VLTh6cn9;
        "pkg-1.0.5+mc1.21.4" = _Ipg6RkvP;
        "pkg-1.0.6+mc1.21.5" = _q89vsibk;
        "pkg-1.0.6+mc1.21.4" = _gOawQC40;
        "pkg-1.0.7+mc1.21.5" = _HkUknWhp;
        "pkg-1.0.8+fabric+mc1.21.5" = _8gdquWaC;
        "pkg-1.0.8+neo+mc1.21.5" = _dg8Kc6k4;
        "pkg-1.1.0+fabric+mc1.21.5" = _pYqjMLxg;
        "pkg-1.1.1+fabric+mc1.21.5" = _CUrIRZKB;
        "pkg-1.1.1+neo+mc1.21.5" = _6kQTs3eG;
        "pkg-1.1.2+fabric+mc1.21.5" = _Gh4ADMqT;
        "pkg-1.1.2+neo+mc1.21.5" = _z0V1ctFQ;
        "pkg-1.1.2+fabric+mc1.21.6" = _dDIiMx6w;
        "pkg-1.1.2+neo+mc1.21.6" = _UEGPeUHH;
        "pkg-1.1.2+fabric+mc1.21.7" = _QJ7G2Djm;
        "pkg-1.1.2+neo+mc1.21.7" = _rmrJWOOt;
        "pkg-1.1.2+fabric+mc1.21.8" = _vB702pAN;
        "pkg-1.1.2+neo+mc1.21.8" = _nSxJgz5P;
        "pkg-1.1.2+fabric+mc1.21.9" = _sFdZe7Re;
        "pkg-1.1.2+neo+mc1.21.9" = _DnoxNdjG;
        "pkg-1.1.2+fabric+mc1.21.10" = _521Ah9TX;
        "pkg-1.1.2+neo+mc1.21.10" = _udgGvpdh;
        "pkg-1.1.3-beta+fabric+mc1.21.11" = _jiiu3euv;
        "pkg-1.1.3+neo+mc1.21.11" = _dndeVCH1;
        "pkg-1.1.4+fabric+mc1.21.11" = _kdop41af;
        "pkg-1.1.4+neo+mc1.21.11" = _kVSOysAW;
        "pkg-1.1.5+fabric+mc1.21.11" = _p3mx3exH;
        "pkg-1.1.5+neo+mc1.21.11" = _zVQ6D032;
        "pkg-1.1.6+neo+mc1.21.11" = _CEiXmA32;
        "pkg-1.1.6+fabric+mc26.1.1" = _rXU895zz;
        "pkg-1.1.6+neo+mc26.1.1" = _wszEgJRT;
        "pkg-1.1.7+fabric+mc26.1.1" = _BkFBft2U;
        "pkg-1.1.8+fabric+mc26.1.2" = _PM8Gyctm;
        "pkg-1.2.0+fabric+mc26.2" = _e00a9W7U;
        "pkg-1.1.7+neo+mc26.1.1" = _esn3Z0QR;
        "pkg-1.1.7+neo+mc26.1.2" = _CfpXU8Qv;
