...
let
    versions = (let
        ...
        _qeFyv8yy = {
            "id" = "qeFyv8yy";
            "file" = "ExecutableCrafting-1.26.8.9.jar";
            "hash" = "sha512-2NC+jCcb+FbDzlfeQ00gkewAXTYaCM0gm2KkkBdJ533u7KQtY+ERy9ZfpkTlgxQ3LlNLu7lK5Kqdw5OgiA+9xQ==";
        };
        _j7ObLEcS = {
            "id" = "j7ObLEcS";
            "file" = "ExecutableCrafting-1.26.8.10.jar";
            "hash" = "sha512-os+kow9iFQx39ssq4Ne6bRLZJDEqK10dBLvU0HOIhbgyKQTdxhAgeyTsmDcgWb4x1H6bO5RHzhPAkHXD/aFzQg==";
        };
        _8nCzZFea = {
            "id" = "8nCzZFea";
            "file" = "ExecutableCrafting-1.26.8.30.jar";
            "hash" = "sha512-A9rKkRd6K8rVHoIojvL8vzYXXrvNyanC6wOY1eMVatR3kKCrmI5Of6g2Q9XgYEO+fLyLorguPWLav/VB56J9CQ==";
        };
        _MU8KVsZK = {
            "id" = "MU8KVsZK";
            "file" = "ExecutableCrafting-1.26.9.1.jar";
            "hash" = "sha512-xf3E7EA6xIYeyYkMcjJmhr2EfcHWmUHtLWSJk4jTyTP0qSvBtb2Txc/64Kx5O+IZRe2biUD36IDcVDK9/nGYNg==";
        };
        _s6Kr25M1 = {
            "id" = "s6Kr25M1";
            "file" = "ExecutableCrafting-1.26.9.6.jar";
            "hash" = "sha512-XnsPxkpD6CiehxYjCMjSIN5MQkF2QNPI6dgyrurKxO2c/yC7TATAHw3i4Bhd8KYLMcpnWQOsygfvzh27J6kPnQ==";
        };
        _pP9bYq6r = {
            "id" = "pP9bYq6r";
            "file" = "ExecutableCrafting-1.26.9.9.jar";
            "hash" = "sha512-5onA2B5ZE6MdbJ0vAT1ddRyjKdp1YwHulxoRbzwo+qJJftQPqKG4Qe8L+Z63/vlFVjXvitJM1F+dyfdIOzX9RA==";
        };
        _xWSZzEHh = {
            "id" = "xWSZzEHh";
            "file" = "ExecutableCrafting-1.26.9.13.jar";
            "hash" = "sha512-+XWBVBxuWZww/ZDyKNRpbhT4S9swCjMjyUeayRBbUV3u7nw3zzL9Jodnj+wx1Uxoc91V6jDRmfx1W9lQ1NqSLA==";
        };
        _jUTrgGSa = {
            "id" = "jUTrgGSa";
            "file" = "ExecutableCrafting-1.26.9.14.jar";
            "hash" = "sha512-mZFRZDuUHno+1g0P5njHVa7izrJbTHJPdP/iruEU8HdKnUuLS+hbU/3jO6nc2KuuAJmSLzm6iTVb0uyWL+yX5w==";
        };
    in {
        "EP3S7B82" = _EP3S7B82;
        "kU42PaPM" = _kU42PaPM;
        ...
        "xWSZzEHh" = _xWSZzEHh;
        "jUTrgGSa" = _jUTrgGSa;
        "bukkit-1.19" = _jUTrgGSa;
        "bukkit-1.19.1" = _jUTrgGSa;
        "bukkit-1.19.2" = _jUTrgGSa;
        "bukkit-1.19.3" = _jUTrgGSa;
        "bukkit-1.19.4" = _jUTrgGSa;
        "bukkit-1.20" = _jUTrgGSa;
        "bukkit-1.20.1" = _jUTrgGSa;
        "bukkit-1.20.2" = _jUTrgGSa;
        "bukkit-1.20.3" = _jUTrgGSa;
        "bukkit-1.20.4" = _jUTrgGSa;
        "bukkit-1.20.5" = _jUTrgGSa;
        "bukkit-1.20.6" = _jUTrgGSa;
        "bukkit-1.21" = _jUTrgGSa;
        "bukkit-1.21.1" = _jUTrgGSa;
        "bukkit-1.21.2" = _jUTrgGSa;
        "bukkit-1.21.3" = _jUTrgGSa;
        "bukkit-1.21.4" = _jUTrgGSa;
        "bukkit-1.21.5" = _jUTrgGSa;
        "bukkit-1.21.6" = _jUTrgGSa;
        "bukkit-1.21.7" = _jUTrgGSa;
        "bukkit-1.21.8" = _jUTrgGSa;
        "bukkit-1.21.9" = _jUTrgGSa;
        "bukkit-1.21.10" = _jUTrgGSa;
        "bukkit-1.21.11" = _jUTrgGSa;
        "bukkit-26.1" = _jUTrgGSa;
        "bukkit-26.2" = _jUTrgGSa;
        "folia-1.19" = _jUTrgGSa;
        "folia-1.19.1" = _jUTrgGSa;
        "folia-1.19.2" = _jUTrgGSa;
        "folia-1.19.3" = _jUTrgGSa;
        "folia-1.19.4" = _jUTrgGSa;
        "folia-1.20" = _jUTrgGSa;
        "folia-1.20.1" = _jUTrgGSa;
        "folia-1.20.2" = _jUTrgGSa;
        "folia-1.20.3" = _jUTrgGSa;
        "folia-1.20.4" = _jUTrgGSa;
        "folia-1.20.5" = _jUTrgGSa;
        "folia-1.20.6" = _jUTrgGSa;
        "folia-1.21" = _jUTrgGSa;
        "folia-1.21.1" = _jUTrgGSa;
        "folia-1.21.2" = _jUTrgGSa;
        "folia-1.21.3" = _jUTrgGSa;
        "folia-1.21.4" = _jUTrgGSa;
        "folia-1.21.5" = _jUTrgGSa;
        "folia-1.21.6" = _jUTrgGSa;
        "folia-1.21.7" = _jUTrgGSa;
        "folia-1.21.8" = _jUTrgGSa;
        "folia-1.21.9" = _jUTrgGSa;
        "folia-1.21.10" = _jUTrgGSa;
        "folia-1.21.11" = _jUTrgGSa;
        "folia-26.1" = _jUTrgGSa;
        "folia-26.2" = _jUTrgGSa;
        "paper-1.19" = _jUTrgGSa;
        "paper-1.19.1" = _jUTrgGSa;
        "paper-1.19.2" = _jUTrgGSa;
        "paper-1.19.3" = _jUTrgGSa;
        "paper-1.19.4" = _jUTrgGSa;
        "paper-1.20" = _jUTrgGSa;
        "paper-1.20.1" = _jUTrgGSa;
        "paper-1.20.2" = _jUTrgGSa;
        "paper-1.20.3" = _jUTrgGSa;
        "paper-1.20.4" = _jUTrgGSa;
        "paper-1.20.5" = _jUTrgGSa;
        "paper-1.20.6" = _jUTrgGSa;
        "paper-1.21" = _jUTrgGSa;
        "paper-1.21.1" = _jUTrgGSa;
        "paper-1.21.2" = _jUTrgGSa;
        "paper-1.21.3" = _jUTrgGSa;
        "paper-1.21.4" = _jUTrgGSa;
        "paper-1.21.5" = _jUTrgGSa;
        "paper-1.21.6" = _jUTrgGSa;
        "paper-1.21.7" = _jUTrgGSa;
        "paper-1.21.8" = _jUTrgGSa;
        "paper-1.21.9" = _jUTrgGSa;
        "paper-1.21.10" = _jUTrgGSa;
        "paper-1.21.11" = _jUTrgGSa;
        "paper-26.1" = _jUTrgGSa;
        "paper-26.2" = _jUTrgGSa;
        "purpur-1.19" = _jUTrgGSa;
        "purpur-1.19.1" = _jUTrgGSa;
        "purpur-1.19.2" = _jUTrgGSa;
        "purpur-1.19.3" = _jUTrgGSa;
        "purpur-1.19.4" = _jUTrgGSa;
        "purpur-1.20" = _jUTrgGSa;
        "purpur-1.20.1" = _jUTrgGSa;
        "purpur-1.20.2" = _jUTrgGSa;
        "purpur-1.20.3" = _jUTrgGSa;
        "purpur-1.20.4" = _jUTrgGSa;
        "purpur-1.20.5" = _jUTrgGSa;
        "purpur-1.20.6" = _jUTrgGSa;
        "purpur-1.21" = _jUTrgGSa;
        "purpur-1.21.1" = _jUTrgGSa;
        "purpur-1.21.2" = _jUTrgGSa;
        "purpur-1.21.3" = _jUTrgGSa;
        "purpur-1.21.4" = _jUTrgGSa;
        "purpur-1.21.5" = _jUTrgGSa;
        "purpur-1.21.6" = _jUTrgGSa;
        "purpur-1.21.7" = _jUTrgGSa;
        "purpur-1.21.8" = _jUTrgGSa;
        "purpur-1.21.9" = _jUTrgGSa;
        "purpur-1.21.10" = _jUTrgGSa;
        "purpur-1.21.11" = _jUTrgGSa;
        "purpur-26.1" = _jUTrgGSa;
        "purpur-26.2" = _jUTrgGSa;
        "spigot-1.19" = _jUTrgGSa;
        "spigot-1.19.1" = _jUTrgGSa;
        "spigot-1.19.2" = _jUTrgGSa;
        "spigot-1.19.3" = _jUTrgGSa;
        "spigot-1.19.4" = _jUTrgGSa;
        "spigot-1.20" = _jUTrgGSa;
        "spigot-1.20.1" = _jUTrgGSa;
        "spigot-1.20.2" = _jUTrgGSa;
        "spigot-1.20.3" = _jUTrgGSa;
        "spigot-1.20.4" = _jUTrgGSa;
        "spigot-1.20.5" = _jUTrgGSa;
        "spigot-1.20.6" = _jUTrgGSa;
        "spigot-1.21" = _jUTrgGSa;
        "spigot-1.21.1" = _jUTrgGSa;
        "spigot-1.21.2" = _jUTrgGSa;
        "spigot-1.21.3" = _jUTrgGSa;
        "spigot-1.21.4" = _jUTrgGSa;
        "spigot-1.21.5" = _jUTrgGSa;
        "spigot-1.21.6" = _jUTrgGSa;
        "spigot-1.21.7" = _jUTrgGSa;
        "spigot-1.21.8" = _jUTrgGSa;
        "spigot-1.21.9" = _jUTrgGSa;
        "spigot-1.21.10" = _jUTrgGSa;
        "spigot-1.21.11" = _jUTrgGSa;
        "spigot-26.1" = _jUTrgGSa;
        "spigot-26.2" = _jUTrgGSa;
        "pkg-1.25.5.11" = _EP3S7B82;
        "pkg-1.25.5.12" = _kU42PaPM;
        "pkg-1.25.5.13" = _db2QCZgF;
        "pkg-1.25.5.14" = _jJt9HqTj;
        "pkg-1.25.5.15" = _bHh3hLSW;
        "pkg-1.25.5.21" = _vqFoTVys;
        "pkg-1.25.5.22" = _W4mj6nFp;
        "pkg-1.25.5.24" = _QLDBzght;
        "pkg-1.25.5.27" = _je4nHnJ5;
        "pkg-1.25.5.28" = _Oh4pmjJa;
        "pkg-1.25.6.1" = _HWgkWY86;
        "pkg-1.25.6.9" = _IHcLriUD;
        "pkg-1.25.6.14" = _3I2sMrsg;
        "pkg-1.25.6.15" = _Tf8KgqcV;
        "pkg-1.25.6.21" = _Pc9yGajo;
        "pkg-1.25.6.22" = _1JQnCEqt;
        "pkg-1.25.6.24" = _14ythcRn;
        "pkg-1.25.6.29" = _kHvTFM82;
        "pkg-1.25.6.30" = _aSMkkBfp;
        "pkg-1.25.7.5" = _idv3tDfe;
        "pkg-1.25.7.8" = _uOwo2EMG;
        "pkg-1.25.7.12" = _fxbaNdkl;
        "pkg-1.25.7.18" = _1V52R2Ol;
        "pkg-1.25.7.19" = _CDdKKuKK;
        "pkg-1.25.7.26" = _ErWOn4tO;
        "pkg-1.25.7.28" = _OMN3QWe5;
        "pkg-1.25.7.31" = _okRiFOgx;
        "pkg-1.25.8.7" = _Lubw3bxg;
        "pkg-1.25.8.13" = _2c5MNItJ;
        "pkg-1.25.8.15" = _1PvEzO1l;
        "pkg-1.25.8.17" = _jUjStjL8;
        "pkg-1.25.8.20" = _Yhlr1HB7;
        "pkg-1.25.8.25" = _UURZovNZ;
        "pkg-1.25.8.26" = _RgH8ixzm;
        "pkg-1.25.8.27" = _poXXIJW4;
        "pkg-1.25.8.31" = _ecOJldQ1;
        "pkg-1.25.9.7" = _1Za8RJKq;
        "pkg-1.25.9.13" = _27UFIwKD;
        "pkg-1.25.9.14" = _kuOYdmkT;
        "pkg-1.25.9.18" = _z4KLYXOY;
        "pkg-1.25.9.21" = _OPcv8X4G;
        "pkg-1.25.9.24" = _Hlrqwiod;
        "pkg-1.25.9.28" = _ETHOzvIh;
        "pkg-1.25.9.30" = _17c51MAA;
        "pkg-1.25.10.5" = _AdQDgEsU;
        "pkg-1.25.10.9" = _Ss0dF59J;
        "pkg-1.25.10.12" = _PwuRzZnB;
        "pkg-1.25.10.16" = _dRBaESYv;
        "pkg-1.25.10.26" = _3cpIkGOb;
        "pkg-1.25.10.27" = _jzHzwTPO;
        "pkg-1.25.10.30" = _2ibQ9UoI;
        "pkg-1.25.11.2" = _ZFPTGvEd;
        "pkg-1.25.11.4" = _4MWZOmmM;
        "pkg-1.25.11.12" = _MXO7TL4U;
        "pkg-1.25.11.16" = _bZREIdrO;
        "pkg-1.25.11.17" = _19SuAQJx;
        "pkg-1.25.11.20" = _KRl4YFTQ;
        "pkg-1.25.11.22" = _MsXnKZ4R;
        "pkg-1.25.11.26" = _FWJNZ91n;
        "pkg-1.25.11.29" = _tPtBe7B9;
        "pkg-1.25.11.30" = _O6t0vcvh;
        "pkg-1.25.12.7" = _Incre8n0;
        "pkg-1.25.12.8" = _7T5nZnJf;
        "pkg-1.25.12.10" = _dk4Gy3vh;
        "pkg-1.25.12.14" = _oe12pRe8;
        "pkg-1.25.12.20" = _eBY8elhn;
        "pkg-1.25.12.24" = _CVkye3aZ;
        "pkg-1.26.1.2" = _pNL3BPZ5;
        "pkg-1.26.1.4" = _qlMHxLLy;
        "pkg-1.25.1.6" = _zVVmuL9g;
        "pkg-1.25.1.11" = _WZ04xbCN;
        "pkg-1.26.1.15" = _Iu68X1dc;
        "pkg-1.26.1.18" = _sdOQH7Ff;
        "pkg-1.26.1.24" = _lvwAT97N;
        "pkg-1.26.1.25" = _c3kQ5LjI;
        "pkg-1.26.1.29" = _iyaOTa6a;
        "pkg-1.26.2.2" = _zceEIXjw;
        "pkg-1.26.2.3" = _j5g7645K;
        "pkg-1.26.2.4" = _SNOf2fQP;
        "pkg-1.26.2.5" = _CswkmCSA;
        "pkg-1.26.2.8" = _atbmV9Iz;
        "pkg-1.26.2.15" = _DmavM8ev;
        "pkg-1.26.2.25" = _psmwYJbU;
        "pkg-1.26.3.2" = _f5L92TPN;
        "pkg-1.26.3.8" = _b5SEhc7M;
        "pkg-1.26.9.3" = _FHo1oZEF;
        "pkg-1.26.10.3" = _LjwvKen5;
        "pkg-1.26.3.11" = _Jeu1JDel;
        "pkg-1.26.3.15" = _cMBVfzK8;
        "pkg-1.26.3.29" = _vtlnzezv;
        "pkg-1.26.4.5" = _kuztBkcr;
        "pkg-1.26.4.14" = _82S81gti;
        "pkg-1.26.4.26" = _8RltAC5k;
        "pkg-1.26.5.17" = _ybVWRnqf;
        "pkg-1.26.5.31" = _HaGoky48;
        "pkg-1.26.6.2" = _SabllsKN;
        "pkg-1.26.6.3" = _kkhH5dto;
        "pkg-1.26.6.7" = _V0CVvXCj;
        "pkg-1.26.6.13" = _yvOpEd4T;
        "pkg-1.26.6.22" = _OFqcThGs;
        "pkg-1.26.7.5" = _Q1gsJitK;
        "pkg-1.26.7.17" = _rbMSamvl;
        "pkg-1.26.7.26" = _9qmgmWcq;
        "pkg-1.26.8.9" = _qeFyv8yy;
        "pkg-1.26.8.10" = _j7ObLEcS;
        "pkg-1.26.8.30" = _8nCzZFea;
        "pkg-1.26.9.1" = _MU8KVsZK;
        "pkg-1.26.9.6" = _s6Kr25M1;
        "pkg-1.26.9.9" = _pP9bYq6r;
        "pkg-1.26.9.13" = _xWSZzEHh;
        "pkg-1.26.9.14" = _jUTrgGSa;
        "default" = _jUTrgGSa;
    });
