...
let
    ...
    in {
        ...
        "pkg-1.3.8" = _ZUJLu6gn;
        "pkg-1.3.9" = _kVmhxDoc;
        "pkg-1.3.10" = _EDkxiW2e;
        "pkg-1.3.11" = _Cl8sKOlU;
        "pkg-1.3.12" = _UvkCrV3s;
        "pkg-1.3.13" = _Rqjt1iLu;
        "pkg-1.3.14" = _NXBcxrHf;
        "pkg-1.4.0" = _vHodIvFr;
        "pkg-1.4.1" = _bavFmU5y;
        "pkg-1.4.2" = _9LAzzD19;
        "pkg-1.4.3" = _TYXSE2dq;
        ...
        "pkg-1.4.8" = _qbdL0wge;
        "pkg-1.4.9" = _TIxEcui0;
        "pkg-1.4.10" = _9FrbRmq4;
        "pkg-1.4.11" = _2kqVyJhF;
        "pkg-1.4.12" = _VRcTIXB7;
        "pkg-1.4.13" = _g8aSTtM9;
        "pkg-1.4.14" = _BEotkwAw;
        "pkg-1.4.15" = _FH0pTulm;
        "pkg-1.4.16" = _RHFLRR3X;
        "pkg-1.5.0" = _bXEZioT7;
        "pkg-1.5.1" = _mUxFctLq;
        "pkg-1.5.2" = _N1VoJR2B;
        "pkg-1.5.3" = _ScXSWwTH;
        ...
        "pkg-1.5.8" = _xqoaTeQP;
        "pkg-1.5.9" = _KSKXqt1j;
        "pkg-1.5.10" = _wJjEz1j1;
        "pkg-1.5.11" = _bMavrbZm;
        "pkg-1.5.12" = _hCMYtfLK;
        "pkg-1.5.13" = _CXskGm40;
        "pkg-1.5.14" = _oaOhGv5R;
        "pkg-1.5.15" = _BmofP9Cc;
        "pkg-1.5.16" = _aKNL1Dse;
        "pkg-1.5.17" = _f2Laemun;
        "pkg-1.5.18" = _htqDbpGS;
        "pkg-1.6.0" = _GgUCXR4j;
        "pkg-1.6.1" = _T3rQRp5c;
        "pkg-1.6.2" = _ARusKfsY;
        "pkg-1.6.3" = _Arp28iWu;
        "pkg-1.20.1-1.6.4" = _hV2mJr8m;
        "pkg-1.20.1-1.6.5" = _SCzyA6HD;
        "pkg-1.20.1-1.6.6" = _ScljaXvy;
        "pkg-1.20.1-1.6.7" = _UfJLTCMM;
        "pkg-1.21.1-1.6.0-beta-v2" = _51SZ0u5t;
        "pkg-1.20.1-1.6.8" = _mFNn7iZx;
        "pkg-1.20.1-1.6.9" = _L2fLdD6l;
        "pkg-1.21.1-1.6.0-beta-v4" = _MHVaLw6x;
        "pkg-1.20.1-1.6.10" = _68Kj4nh9;
        "pkg-1.20.1-1.6.11" = _dHZT1Ixe;
        "pkg-1.20.1-1.6.12" = _Lt8RqH8a;
        "pkg-1.21.1-1.6.0-beta-v5" = _Nfm80mof;
        "pkg-1.20.1-1.6.13" = _eVex1jz7;
        "pkg-1.20.1-1.6.14" = _JvOLcJ0Y;
        "pkg-1.20.1-1.6.15" = _OqsbTqpO;
        "pkg-1.20.1-1.6.16" = _QySth8QS;
        "pkg-1.20.1-1.6.17" = _oYI4Bs82;
        "pkg-1.21.1-1.6.0-beta-v6" = _QsNm83rf;
        "pkg-1.21.1-1.6.0-beta-v7" = _AOkl5T64;
        "pkg-1.20.1-1.6.18" = _sWr6zsPz;
        "pkg-1.21.1-1.6.0-beta-v8" = _566Ih97p;
        "pkg-1.20.1-1.6.19" = _jl9zXiQv;
        "pkg-1.20.1-1.6.20" = _WTYKzmNO;
        "pkg-1.20.1-1.6.21" = _b2ZezF1T;
        "pkg-1.21.1-1.6.0-beta-v9" = _xYqD3qJz;
        "pkg-1.20.1-1.6.22" = _Nme0rD8j;
        "pkg-1.21.1-1.6.0-beta-v9.1" = _TpBhYIBL;
        "pkg-1.20.1-1.6.23" = _FxJi7v5r;
        "pkg-1.20.1-1.6.24" = _PAMLP1lE;
        "pkg-1.21.1-1.6.0-beta-v10" = _GHfdGi5A;
        "pkg-1.20.1-1.6.25" = _J5uzM7bv;
        "pkg-1.21.1-1.6.0-beta-v11" = _v4swlzgY;
        "pkg-1.20.1-1.6.26" = _zFUENmgD;
        "pkg-1.20.1-1.6.27" = _L9rkyCXk;
        "pkg-1.21.1-1.6.0-beta-v12" = _KcRYZyU7;
        "pkg-1.20.1-1.6.28" = _Npi1DcJY;
        "pkg-1.20.1-1.6.29" = _NQX9Y2ng;
        "pkg-1.21.1-1.6.13" = _1p8TjNSE;
        "pkg-1.21.1-1.6.14" = _rBaLtSNX;
        "pkg-1.20.1-1.6.30" = _p9y5uPia;
        "pkg-1.21.1-1.6.15" = _x1btjC6a;
