...
let
    versions = (let
        ...
        _ltY0torm = {
            "id" = "ltY0torm";
            "file" = "theurgy-26.1.2-neoforge-1.115.0.jar";
            "hash" = "sha512-w7oASrpTtzLplc7QKcYZ5Zn9L3jV4nX9nYoSg3jm2UPiV4zRIroKY1OSDx1HZDYWNcO2bo0/oyJJTlc0G/j7hw==";
        };
        _F2nl4LsR = {
            "id" = "F2nl4LsR";
            "file" = "theurgy-26.2-neoforge-1.117.0.jar";
            "hash" = "sha512-UA+dEI67+F5HB4GE8AGsqFaWTA7oueogkc9TtxbXCIzpYXpsTdoW+HeRIOA3IFHSOL2xk3LVgpDY5/A++1UvUA==";
        };
        _9SDr4yoB = {
            "id" = "9SDr4yoB";
            "file" = "theurgy-26.2-neoforge-1.118.0.jar";
            "hash" = "sha512-QH+tCXbbg9wxo6nnwQNefyZxz4POHjpncCu86pYAXzMspFFX3DIEp4GtkjktEJw00R36FWZmDogVbiwDJVzn9A==";
        };
        _yfHcc2Lc = {
            "id" = "yfHcc2Lc";
            "file" = "theurgy-26.1.2-neoforge-1.115.1.jar";
            "hash" = "sha512-zlhBV65vEGFg7uOVubwfXZDjIzF3xIaqASw49rdC2JbxLxik6DXdNDHJRUfk77T/Fwrc3rkN9MHSBnI6zKrcbw==";
        };
        _O4tOwkRB = {
            "id" = "O4tOwkRB";
            "file" = "theurgy-26.2-neoforge-1.118.1.jar";
            "hash" = "sha512-bz85DEdbJnSmi6qSvEfy2057g7tWJI/hURYU9xtd4kmNXyunRyFMm/kWYb2zneLdhwwFP6YtQu6yQw3wAbfOAQ==";
        };
        _R5jRgLze = {
            "id" = "R5jRgLze";
    ...
    in {
        ...
        "pkg-1.19.4-1.3.7" = _APpDTnzd;
        "pkg-1.19.2-1.3.6" = _2ytgTZjo;
        "pkg-1.20.1-1.3.8" = _bMrLzuN4;
        "pkg-1.20.1-1.3.9" = _9RoHfnEI;
        "pkg-1.20.1-1.3.10" = _st8zrbNB;
        "pkg-1.20.1-1.4.2" = _gxvMCOoT;
        "pkg-1.20.1-1.4.3" = _fFwBhMWS;
        "pkg-1.20.1-1.4.4" = _iYSukxEN;
        "pkg-1.20.1-1.4.5" = _CFQn9xvs;
        "pkg-1.20.1-1.4.6" = _qZSKCdBc;
        "pkg-1.20.1-1.4.7" = _GfTmiGxF;
        "pkg-1.20.1-1.4.8" = _ysADZR7E;
        "pkg-1.20.1-1.4.9" = _bmtpnSWf;
        "pkg-1.20.1-1.4.10" = _db2bRHP3;
        "pkg-1.20.1-1.4.11" = _mTBHAaZg;
        "pkg-1.20.1-1.5.0" = _gwwohKMO;
        "pkg-1.20.1-1.6.0" = _ATGdcRds;
        "pkg-1.20.1-1.6.1" = _KwmZVho8;
        "pkg-1.20.1-1.6.2" = _O5pWVBmQ;
        "pkg-1.20.1-1.6.3" = _KFBY2oZZ;
        "pkg-1.20.1-1.6.4" = _6GBXoSR6;
        "pkg-1.20.1-1.7.0" = _wnTv8Nnl;
        "pkg-1.20.1-1.7.1" = _bd4YwTzI;
        "pkg-1.20.1-1.8.0" = _w934jcU7;
        "pkg-1.20.1-1.9.0" = _1cFtYukJ;
        "pkg-1.20.1-1.9.1" = _hOeHtbdN;
        "pkg-1.20.1-1.10.0" = _NTwCRqYT;
        "pkg-1.20.1-1.10.1" = _NCPIU4uG;
        "pkg-1.20.1-1.11.0" = _dvcpyAW7;
        "pkg-1.20.1-1.11.1" = _wZPTH1Rb;
        "pkg-1.20.1-1.12.1" = _zEv0uaaK;
        "pkg-1.20.4-neoforge-1.12.1" = _osMFruir;
        "pkg-1.20.4-neoforge-1.12.2" = _iRvXH0iC;
        "pkg-1.20.4-neoforge-1.12.3" = _qlgFpNmR;
        "pkg-1.20.1-1.12.2" = _lF7nptyU;
        "pkg-1.20.4-neoforge-1.13.0" = _eP7oaOv0;
        "pkg-1.20.4-neoforge-1.14.0" = _tiEp59Vf;
        "pkg-1.20.1-1.14.1" = _j4Yc2J93;
        "pkg-1.20.1-1.15.0" = _zV25uzRp;
        "pkg-1.20.4-neoforge-1.15.0" = _I43GnwWX;
        "pkg-1.20.1-1.16.0" = _1GhBtpCA;
        "pkg-1.20.1-1.16.1" = _laYXXzQk;
        "pkg-1.20.4-neoforge-1.16.1" = _5HSRTaLD;
        "pkg-1.20.4-neoforge-1.16.2" = _Je7jA5KE;
        "pkg-1.20.1-1.17.0" = _TBxk7NyF;
        "pkg-1.20.1-1.17.1" = _agVaUbT1;
        "pkg-1.20.4-neoforge-1.17.1" = _fckkIZn0;
        "pkg-1.20.4-neoforge-1.17.2" = _6Pliv4wg;
        "pkg-1.20.1-1.17.4" = _b8U86AUY;
        "pkg-1.20.4-neoforge-1.18.0" = _rs74SxsY;
        "pkg-1.20.4-neoforge-1.18.1" = _G5IhTDDv;
        "pkg-1.20.1-1.17.5" = _Hmx0yT9W;
        "pkg-1.20.4-neoforge-1.18.2" = _QsZaywM7;
        "pkg-1.20.6-neoforge-1.18.2" = _OmRlfETa;
        "pkg-1.20.6-neoforge-1.19.0" = _cmeHwUUu;
        "pkg-1.20.4-neoforge-1.19.0" = _nec6vsQf;
        "pkg-1.20.1-1.19.0" = _3NJiEIDy;
        "pkg-1.20.6-neoforge-1.19.1" = _g4EZNBMG;
        "pkg-1.20.6-neoforge-1.19.2" = _PdobY9wl;
        "pkg-1.20.6-neoforge-1.19.3" = _FaPWB8PD;
        "pkg-1.20.6-neoforge-1.19.4" = _siy5NCvl;
        "pkg-1.20.4-neoforge-1.19.1" = _sGykSWXf;
        "pkg-1.20.6-neoforge-1.19.6" = _ltjQxtGT;
        "pkg-1.20.1-1.19.1" = _atoDgpyB;
        "pkg-1.20.4-neoforge-1.19.2" = _2qE5glvp;
        "pkg-1.21-neoforge-1.20.0" = _sfgmIaLw;
        "pkg-1.21-neoforge-1.20.1" = _ZcykDr14;
        "pkg-1.21-neoforge-1.20.2" = _yf49OrFO;
        "pkg-1.21-neoforge-1.21.0" = _pjN3tNSB;
        "pkg-1.21-neoforge-1.21.1" = _lVckC2Zr;
        "pkg-1.21-neoforge-1.22.0" = _iNI80Pqs;
        "pkg-1.21-neoforge-1.22.1" = _Vs2HO4Je;
        "pkg-1.21-neoforge-1.22.2" = _44MCxyBf;
        "pkg-1.20.1-1.19.2" = _GOtqrHIM;
        "pkg-1.20.4-neoforge-1.19.3" = _g1n7Lbhz;
        "pkg-1.21-neoforge-1.22.3" = _XyRsJXcZ;
        "pkg-1.21-neoforge-1.22.4" = _fIAGWzR2;
        "pkg-1.21-neoforge-1.22.5" = _PorLxFHT;
        "pkg-1.21-neoforge-1.23.0" = _z7H7JzWN;
        "pkg-1.21-neoforge-1.23.1" = _l8Zpexim;
        "pkg-1.21-neoforge-1.24.0" = _WsYPJsSc;
        "pkg-1.20.1-1.19.3" = _npl6pTm7;
        "pkg-1.21-neoforge-1.24.1" = _t1mMcODl;
        "pkg-1.20.4-neoforge-1.19.4" = _gPUoTqXH;
        "pkg-1.21-neoforge-1.24.2" = _6FK5ghSX;
        "pkg-1.21-neoforge-1.24.3" = _5htukGRf;
        "pkg-1.21-neoforge-1.24.4" = _yBC545Bc;
        "pkg-1.21-neoforge-1.25.0" = _J2feDWCJ;
        "pkg-1.21-neoforge-1.25.1" = _vBSMyMGe;
        "pkg-1.21-neoforge-1.26.0" = _zicplsC8;
        "pkg-1.21-neoforge-1.26.1" = _5aPlTzqf;
        "pkg-1.21-neoforge-1.27.0" = _EpMlcade;
        "pkg-1.21-neoforge-1.27.1" = _L1Su20zc;
        "pkg-1.21-neoforge-1.27.2" = _WwaW2VPV;
        "pkg-1.21-neoforge-1.27.3" = _9gkeysg5;
        "pkg-1.21-neoforge-1.28.0" = _6pfa0sPf;
        "pkg-1.21-neoforge-1.29.0" = _EKEnBsjp;
        "pkg-1.21-neoforge-1.30.0" = _4DcIJdKr;
        "pkg-1.21-neoforge-1.30.1" = _m7WNzrOy;
        "pkg-1.21-neoforge-1.30.2" = _5r4JsPNC;
        "pkg-1.21-neoforge-1.31.0" = _KmXoXsD9;
        "pkg-1.21-neoforge-1.32.0" = _eUD1ds05;
        "pkg-1.21-neoforge-1.33.0" = _kjaaM8w4;
        "pkg-1.21-neoforge-1.34.0" = _RX8E8fWn;
        "pkg-1.21-neoforge-1.34.1" = _cyw6lttT;
        "pkg-1.20.1-1.20.0" = _93F9B2yO;
        "pkg-1.21-neoforge-1.35.0" = _NCBdTKDk;
        "pkg-1.21-neoforge-1.35.1" = _Gn61lgDI;
        "pkg-1.21-neoforge-1.35.2" = _Rsuecy3w;
        "pkg-1.21-neoforge-1.36.0" = _eU5ajx2P;
        "pkg-1.21-neoforge-1.36.1" = _HEmmoZ6w;
        "pkg-1.21-neoforge-1.37.0" = _JkSs9M6n;
        "pkg-1.21-neoforge-1.38.0" = _tYVMkqbd;
        "pkg-1.21-neoforge-1.38.1" = _RqdstaPz;
        "pkg-1.21-neoforge-1.38.2" = _a0jaLSFs;
        "pkg-1.20.1-1.20.1" = _9De0Dr43;
        "pkg-1.21-neoforge-1.38.3" = _5l1ljZwf;
        "pkg-1.21-neoforge-1.38.4" = _zpkACIiw;
        "pkg-1.21-neoforge-1.39.0" = _9xC7UP6w;
        "pkg-1.21-neoforge-1.40.0" = _ygtdY7zq;
        "pkg-1.21-neoforge-1.40.1" = _GzxmyHMn;
        "pkg-1.21-neoforge-1.40.2" = _F0KJyOka;
        "pkg-1.21-neoforge-1.40.3" = _TaKwjrWL;
        "pkg-1.21-neoforge-1.41.0" = _8pSgR7tK;
        "pkg-1.21-neoforge-1.42.0" = _XbRqhqwj;
        "pkg-1.21-neoforge-1.42.1" = _oDgUn6K9;
        "pkg-1.21-neoforge-1.43.0" = _XRTaaBbC;
        "pkg-1.21-neoforge-1.44.0" = _7V3DYFKo;
        "pkg-1.21-neoforge-1.44.1" = _mlnfMJWQ;
        "pkg-1.20.1-1.21.0" = _56mXxv91;
        "pkg-1.21-neoforge-1.45.0" = _RACdLHZY;
        "pkg-1.21-neoforge-1.45.1" = _2CtvRd4m;
        "pkg-1.20.1-1.21.1" = _t2Kxts5E;
        "pkg-1.21.1-neoforge-1.46.0" = _oJrUzR4h;
        "pkg-1.21.1-neoforge-1.47.0" = _ugzOo1aM;
        "pkg-1.21.1-neoforge-1.47.1" = _LxFb4XQ1;
        "pkg-1.21.1-neoforge-1.48.0" = _RtB68IhN;
        "pkg-1.21.1-neoforge-1.49.0" = _h6g8JaZL;
        "pkg-1.21.1-neoforge-1.49.1" = _zSuVAmor;
        "pkg-1.21.1-neoforge-1.49.2" = _hZF7kMOb;
        "pkg-1.21.1-neoforge-1.50.0" = _HPZ0NVM5;
        "pkg-1.21.1-neoforge-1.50.1" = _hwBC9Pt6;
        "pkg-1.21.1-neoforge-1.51.0" = _GMdy9EvP;
        "pkg-1.21.1-neoforge-1.51.1" = _hHTutCJG;
        "pkg-1.21.1-neoforge-1.51.2" = _xGEiV2DC;
        "pkg-1.21.1-neoforge-1.51.3" = _peiw1vtY;
        "pkg-1.21.1-neoforge-1.52.0" = _mcSaqVmM;
        "pkg-1.21.1-neoforge-1.52.1" = _9ga0w6og;
        "pkg-1.21.1-neoforge-1.53.0" = _rg0r8QYK;
        "pkg-1.21.1-neoforge-1.53.1" = _eqy2bp0O;
        "pkg-1.21.1-neoforge-1.54.0" = _E1YHr39W;
        "pkg-1.21.1-neoforge-1.55.0" = _3kcSxAue;
        "pkg-1.21.1-neoforge-1.55.1" = _oTaGqunB;
        "pkg-1.21.1-neoforge-1.56.0" = _3zSL9pEh;
        "pkg-1.20.1-1.21.2" = _H7y1apEm;
        "pkg-1.21.1-neoforge-1.56.1" = _vaKERCpo;
        "pkg-1.20.1-1.21.3" = _UzsIWjJL;
        "pkg-1.21.1-neoforge-1.56.2" = _wNZDU0kZ;
        "pkg-1.20.1-1.22.0" = _9Z3sH5xv;
        "pkg-1.21.1-neoforge-1.57.0" = _lrWlquuz;
        "pkg-1.20.1-1.23.0" = _dwkt0VDL;
        "pkg-1.21.1-neoforge-1.58.0" = _YHnwJT1k;
        "pkg-1.21.1-neoforge-1.58.1" = _7C0FBC0k;
        "pkg-1.20.1-1.23.1" = _iyKpJmjG;
        "pkg-1.21.1-neoforge-1.58.2" = _lVVpqBqc;
        "pkg-1.20.1-1.23.2" = _f2Hi8w9T;
        "pkg-1.20.1-1.23.3" = _bZy2ELwG;
        "pkg-1.20.1-1.23.4" = _S2zk9FAW;
        "pkg-1.21.1-neoforge-1.58.5" = _vpf3LTke;
        "pkg-1.21.1-neoforge-1.59.0" = _unsoXr7E;
        "pkg-1.21.1-neoforge-1.60.0" = _GgjcRjQA;
        "pkg-1.21.1-neoforge-1.61.1" = _aAv3fnVX;
        "pkg-1.21.1-neoforge-1.61.2" = _UE1Nzq4K;
        "pkg-1.21.1-neoforge-1.61.3" = _gO0QncTf;
        "pkg-1.21.1-neoforge-1.62.0" = _tV2XDIpU;
        "pkg-1.21.1-neoforge-1.63.0" = _MJhYcDEW;
        "pkg-1.21.1-neoforge-1.63.1" = _TlrIxUd9;
        "pkg-1.20.1-1.24.0" = _BmMcR5BT;
        "pkg-1.20.1-1.25.0" = _H9bKyiWt;
        "pkg-1.21.1-neoforge-1.65.0" = _AuGZV5gy;
        "pkg-1.21.1-neoforge-1.66.0" = _T5umGzKA;
        "pkg-1.21.1-neoforge-1.67.0" = _zORVIlNe;
        "pkg-1.21.1-neoforge-1.68.0" = _GoNqS6RW;
        "pkg-1.21.3-neoforge-1.70.0" = _Dyuz8HLN;
        "pkg-1.20.1-1.26.0" = _6qwRc7bV;
        "pkg-1.20.1-1.27.0" = _b7wGkZnb;
        "pkg-26.1-neoforge-1.71.0" = _Y864tAjs;
        "pkg-26.1-neoforge-1.72.0" = _t39gTfmk;
        "pkg-1.20.1-1.28.0" = _aE4xAiSM;
        "pkg-26.1-neoforge-1.73.0" = _7OWfYJTT;
        "pkg-1.21.1-neoforge-1.70.0" = _f39Opxuj;
        "pkg-26.1-neoforge-1.74.0" = _ZYfSyfG5;
        "pkg-26.1-neoforge-1.75.0" = _ugb5gSAu;
        "pkg-26.1-neoforge-1.76.0" = _n8U4hN8A;
        "pkg-1.21.1-neoforge-1.71.0" = _vsSLhaGj;
        "pkg-26.1-neoforge-1.77.0" = _oJrilpPV;
        "pkg-26.1-neoforge-1.78.0" = _TJIu1lsC;
        "pkg-26.1-neoforge-1.79.0" = _p774uHh5;
        "pkg-26.1-neoforge-1.79.1" = _MUO6jhSD;
        "pkg-26.1-neoforge-1.80.0" = _KI22CbJS;
        "pkg-26.1.1-neoforge-1.81.0" = _AQUaXOJB;
        "pkg-26.1.1-neoforge-1.81.1" = _5JdPaaNS;
        "pkg-26.1.2-neoforge-1.82.0" = _SXFuoVVf;
        "pkg-26.1.2-neoforge-1.82.1" = _q4RADBpx;
        "pkg-26.1.2-neoforge-1.83.0" = _BMMPU5v8;
        "pkg-26.1.2-neoforge-1.84.0" = _589zMPFj;
        "pkg-26.1.2-neoforge-1.85.0" = _5XCEAwzl;
        "pkg-1.21.1-neoforge-1.72.0" = _ZZXFs7ih;
        "pkg-26.1.2-neoforge-1.86.0" = _64RR12zd;
        "pkg-26.1.2-neoforge-1.87.0" = _n04cWCm1;
        "pkg-26.1.2-neoforge-1.88.0" = _viOch1lV;
        "pkg-26.1.2-neoforge-1.89.0" = _6VzHm3kp;
        "pkg-26.1.2-neoforge-1.90.0" = _Bfj8v0LA;
        "pkg-26.1.2-neoforge-1.91.0" = _hujsWTz6;
        "pkg-1.21.1-neoforge-1.73.0" = _UDQPVvZA;
        "pkg-26.1.2-neoforge-1.91.1" = _quYqDVsb;
        "pkg-1.21.1-neoforge-1.73.1" = _KvM1ocNj;
        "pkg-26.1.2-neoforge-1.91.2" = _lZVBmM0A;
        "pkg-26.1.2-neoforge-1.92.0" = _NlIbInMM;
        "pkg-26.1.2-neoforge-1.93.0" = _dP9u3hzr;
        "pkg-26.1.2-neoforge-1.94.0" = _pb791t3b;
        "pkg-26.1.2-neoforge-1.95.0" = _bVrgQPSu;
        "pkg-26.1.2-neoforge-1.96.0" = _nZwSSpie;
        "pkg-26.1.2-neoforge-1.97.0" = _ENbsA6gc;
        "pkg-26.1.2-neoforge-1.98.0" = _PJgr1zXu;
        "pkg-26.1.2-neoforge-1.98.1" = _PwpmPPNB;
        "pkg-26.1.2-neoforge-1.100.0" = _3uRTLYa2;
        "pkg-26.1.2-neoforge-1.101.0" = _hkJhzV9u;
        "pkg-26.1.2-neoforge-1.102.0" = _yTeqczfZ;
        "pkg-26.1.2-neoforge-1.103.0" = _IhF01dyG;
        "pkg-26.1.2-neoforge-1.104.0" = _X6cAd5CD;
        "pkg-26.1.2-neoforge-1.105.0" = _DfJegLuK;
        "pkg-26.1.2-neoforge-1.106.0" = _6ivwMVXo;
        "pkg-26.1.2-neoforge-1.107.0" = _2JIGiMec;
        "pkg-26.1.2-neoforge-1.108.0" = _3Bcdz7Jb;
        "pkg-26.1.2-neoforge-1.109.0" = _lRYJlIP4;
        "pkg-26.1.2-neoforge-1.110.0" = _nNLcVXjC;
        "pkg-26.1.2-neoforge-1.111.0" = _DbdbnXk9;
        "pkg-26.1.2-neoforge-1.112.1" = _Mj1Phr5D;
        "pkg-26.1.2-neoforge-1.112.2" = _4XPnqhNu;
        "pkg-1.21.1-neoforge-1.74.0" = _CMhGBeUA;
        "pkg-1.20.1-1.29.0" = _WDyGRRZt;
        "pkg-26.1.2-neoforge-1.113.0" = _DoeXvqTT;
        "pkg-1.21.1-neoforge-1.75.1" = _EhhTr0Hz;
        ...
        "pkg-26.1.2-neoforge-1.115.0" = _ltY0torm;
        "pkg-26.2-neoforge-1.117.0" = _F2nl4LsR;
        "pkg-26.2-neoforge-1.118.0" = _9SDr4yoB;
