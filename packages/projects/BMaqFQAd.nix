...
let
    ...
    in {
        ...
        "pkg-1.0.0-alpha.4" = _1PUznNFL;
        "pkg-1.0.0-alpha.5+1.20.1" = _MtA9tDny;
        "pkg-1.0.0-alpha.5+1.19.4" = _l6FToN2u;
        "pkg-1.0.0-alpha.6" = _3L71SuCO;
        "pkg-1.0.0-alpha.7" = _vX8rbGKv;
        "pkg-1.0.0-alpha.8" = _MnN9VJk7;
        "pkg-1.0.0-alpha.9" = _PDEO2LFN;
        "pkg-1.0.0-alpha.10" = _iwFNDSeQ;
        "pkg-1.0.0+1.20.4-beta.1" = _HG3iOlx2;
        "pkg-1.0.0+1.20.2-beta.1" = _nWILospP;
        "pkg-1.0.0+1.20.1-beta.1" = _kNuphvBw;
        "pkg-1.0.0+1.19.4-beta.1" = _vySIMF18;
        "pkg-1.0.0+1.19.2-beta.1" = _rIo2I2Ga;
        "pkg-1.0.0+1.18.2-beta.1" = _KMe1xC1X;
        "pkg-1.0.0+1.18.1-beta.1" = _ZGtgM32i;
        "pkg-1.0.0+1.18-beta.1" = _QY4DNrcO;
        "pkg-1.0.0+1.20.5-beta.2" = _rp6ritus;
        "pkg-1.0.0+1.20.4-beta.2" = _DogYc4PJ;
        "pkg-1.0.0+1.20.2-beta.2" = _Yyabsc1s;
        "pkg-1.0.0+1.20.1-beta.2" = _cWqT07o3;
        "pkg-1.0.0+1.19.4-beta.2" = _XWjtTlCW;
        "pkg-1.0.0+1.19.2-beta.2" = _etOHddhJ;
        "pkg-1.0.0+1.18.2-beta.2" = _BKmPTTj2;
        "pkg-1.0.0+1.18.1-beta.2" = _AWJZxB98;
        "pkg-1.0.0+1.18-beta.2" = _4aUXv7Q5;
        "pkg-1.0.0-beta.3+1.21-pre2" = _D5x2n3yG;
        "pkg-1.0.0-beta.3+1.20.5" = _kWxlHtU3;
        "pkg-1.0.0-beta.3+1.20.3" = _R7Vr4nh0;
        "pkg-1.0.0-beta.3+1.20.2" = _Et2Szhra;
        "pkg-1.0.0-beta.3+1.20" = _h1FJ0udd;
        "pkg-1.0.0-beta.3+1.19.4" = _YYuA0zIj;
        "pkg-1.0.0-beta.3+1.19" = _dOO2dwuJ;
        "pkg-1.0.0-beta.3+1.18.2" = _oMlyRymg;
        "pkg-1.0.0-beta.3+1.18" = _AyfLzJOU;
        "pkg-1.0.0-beta.4+1.21" = _x7pcwUor;
        "pkg-1.0.0-beta.4+1.20.5" = _88BOF0Cg;
        "pkg-1.0.0-beta.4+1.20.3" = _ICYdxPUF;
        "pkg-1.0.0-beta.4+1.20.2" = _YUswdoUT;
        "pkg-1.0.0-beta.4+1.19" = _VzMTaHzc;
        "pkg-1.0.0-beta.4+1.20" = _fCAVPpNA;
        "pkg-1.0.0-beta.4+1.18.2" = _16YLws3Z;
        "pkg-1.0.0-beta.4+1.19.4" = _qB2gc8Yn;
        "pkg-1.0.0-beta.4+1.18" = _htgWWmBL;
        "pkg-1.0.0-beta.5+1.21" = _QM3J5FES;
        "pkg-1.0.0-beta.5+1.20.5" = _54CY5Aye;
        "pkg-1.0.0-beta.5+1.20.3" = _HWgl5Qwy;
        "pkg-1.0.0-beta.5+1.20.2" = _uQc6PSfh;
        "pkg-1.0.0-beta.5+1.20" = _ssBWBIa0;
        "pkg-1.0.0-beta.5+1.19.4" = _3pchdSw1;
        "pkg-1.0.0-beta.5+1.19" = _HN4wBMVO;
        "pkg-1.0.0-beta.5+1.18.2" = _VLku6kOC;
        "pkg-1.0.0-beta.5+1.18" = _JVxFLUsO;
        "pkg-1.0.0-beta.6+1.21" = _VunRCMLS;
        "pkg-1.0.0-beta.6+1.20.5" = _txotjADb;
        "pkg-1.0.0-beta.6+1.20.3" = _pekUmICD;
        "pkg-1.0.0-beta.6+1.20.2" = _6sh33pAW;
        "pkg-1.0.0-beta.6+1.20" = _ToIxSkeK;
        "pkg-1.0.0-beta.6+1.19.4" = _R9wMRiwy;
        "pkg-1.0.0-beta.6+1.19" = _yMoK4wSk;
        "pkg-1.0.0-beta.6+1.18.2" = _6ObsGidD;
        "pkg-1.0.0-beta.6+1.18" = _PDg3LhG3;
        "pkg-1.0.0-beta.7+1.21" = _DqqvWE6i;
        "pkg-1.0.0-beta.7+1.20.5" = _OTNk9l82;
        "pkg-1.0.0-beta.7+1.20.3" = _ToCIZwar;
        "pkg-1.0.0-beta.7+1.20.2" = _iQNuthRE;
        "pkg-1.0.0-beta.7+1.20" = _UbnshFh6;
        "pkg-1.0.0-beta.7+1.19.4" = _nQ6soGZL;
        "pkg-1.0.0-beta.7+1.19" = _AGEAUT5P;
        "pkg-1.0.0-beta.7+1.18.2" = _lWqmkLka;
        "pkg-1.0.0-beta.7+1.18" = _ImQ29re7;
        "pkg-1.0.0-beta.8+1.20.3" = _nyigSqrb;
        "pkg-1.0.0-beta.8+1.20.2" = _hAhCo45M;
        "pkg-1.0.0-beta.8+1.21" = _9M4OMTns;
        "pkg-1.0.0-beta.8+1.18" = _pzZOBosF;
        "pkg-1.0.0-beta.8+1.19" = _5IpGDZl3;
        "pkg-1.0.0-beta.8+1.18.2" = _VEBSwMMG;
        "pkg-1.0.0-beta.8+1.20.5" = _WqLrRJf2;
        "pkg-1.0.0-beta.8+1.19.4" = _GjLsOZ70;
        "pkg-1.0.0-beta.8+1.21.4" = _nXGseGem;
        "pkg-1.0.0-beta.8+1.20" = _ycImWH3G;
        "pkg-1.0.0-beta.9+1.21.4" = _7TtQPehs;
        "pkg-1.0.0-beta.9+1.20.5" = _uyEZUyJU;
        "pkg-1.0.0-beta.9+1.21" = _CbFAUKA8;
        "pkg-1.0.0-beta.9+1.20.3" = _KxafnMDe;
        "pkg-1.0.0-beta.9+1.20.2" = _Q36Fz3X2;
        "pkg-1.0.0-beta.9+1.20" = _BrYOMFTc;
        "pkg-1.0.0-beta.9+1.19.4" = _I30hLAC1;
        "pkg-1.0.0-beta.9+1.19" = _s1hvwVd6;
        "pkg-1.0.0-beta.9+1.18.2" = _KHpBPqnY;
        "pkg-1.0.0-beta.9+1.18" = _uSmj8tvu;
        "pkg-1.0.0-beta.10+1.21.4" = _EnuCuZIi;
        "pkg-1.0.0-beta.10+1.21" = _6Q1DICqd;
        "pkg-1.0.0-beta.10+1.20.5" = _BLjAkTUp;
        "pkg-1.0.0-beta.10+1.20.3" = _LwTEIyA8;
        "pkg-1.0.0-beta.10+1.20.2" = _I7JMUBty;
        "pkg-1.0.0-beta.10+1.20" = _ufhYAMsl;
        "pkg-1.0.0-beta.10+1.19.4" = _v1nkAKvF;
        "pkg-1.0.0-beta.10+1.19" = _LxhSe7WC;
        "pkg-1.0.0-beta.10+1.18.2" = _VTuPXOe5;
        "pkg-1.0.0-beta.10+1.18" = _Rypwhgo2;
        "pkg-1.0.0+1.20.5" = _AUtJQdTp;
        "pkg-1.0.0+1.20.3" = _EY5JyAMn;
        "pkg-1.0.0+1.20" = _e8jfy64u;
        "pkg-1.0.0+1.20.2" = _6Qvt2Evz;
        "pkg-1.0.0+1.21.2" = _nW48013e;
        "pkg-1.0.0+1.21" = _VnGTuhtN;
        "pkg-1.1.0+1.21" = _zkJgf8Z7;
        "pkg-1.1.0+1.21.2" = _N9vuOVEF;
        "pkg-1.1.0+1.20" = _3ngByDms;
        "pkg-1.2.0-beta.1+1.21.2" = _LKiruSTk;
        "pkg-1.2.0-beta.1+1.21" = _2QwtYmZp;
        "pkg-1.2.0-beta.1+1.20" = _XQ1oNikZ;
        "pkg-1.2.0-beta.2+1.21.2" = _KMMbGA62;
        "pkg-1.2.0-beta.2+1.21" = _IHY0GH1b;
        "pkg-1.2.0-beta.2+1.20" = _tMvRPPyG;
        "pkg-1.2.0-beta.3+1.21.5" = _rTMWjZib;
        "pkg-1.2.0-beta.3+1.21" = _uNBUT6de;
        "pkg-1.2.0-beta.3+1.21.2" = _tfp7ZUSk;
        "pkg-1.2.0-beta.3+1.20" = _hsDy2XLL;
        "pkg-1.2.0+1.21.5" = _nTHMyzcg;
        "pkg-1.2.0+1.21.2" = _ZOugk763;
        "pkg-1.2.0+1.21" = _qkycuPoE;
        "pkg-1.2.0+1.20" = _c41hHQYK;
        "pkg-1.2.1+1.21.2" = _SApWsBMs;
        "pkg-1.2.1+1.21.5" = _N2XlopEy;
        "pkg-1.2.1+1.21" = _iuy05sBz;
        "pkg-1.2.1+1.20" = _5ciBeWos;
        "pkg-1.2.2-beta.1+1.21.5" = _dKdC7jIp;
        "pkg-1.2.2-beta.1+1.21.2" = _UM5B6aeP;
        "pkg-1.2.2-beta.1+1.20" = _9KEMG1c4;
        "pkg-1.2.2-beta.1+1.21" = _xYZZn1lO;
        "pkg-1.2.2+1.21.5" = _RdRGJOYn;
        "pkg-1.2.2+1.21" = _5KiOlNek;
        "pkg-1.2.2+1.21.6" = _6iOMPXFk;
        "pkg-1.2.2+1.20" = _ESQ6ZeyH;
        "pkg-1.2.2+1.21.2" = _y22n5EVn;
        "pkg-1.2.3+1.21.5" = _keAwgBrV;
        "pkg-1.2.3+1.21.2" = _8putkifA;
        "pkg-1.2.3+1.21" = _TVaXwb8V;
        "pkg-1.2.3+1.21.6" = _uMT4olk0;
        "pkg-1.2.3+1.20" = _EKZcXG1c;
        "pkg-1.2.4+1.21.5" = _pu6rMz84;
        "pkg-1.2.4+1.21" = _lmoIarOK;
        "pkg-1.2.4+1.21.2" = _ycf353Mv;
        "pkg-1.2.4+1.20" = _ks0zWTma;
        "pkg-1.2.4+1.21.6" = _PIJ4HDyR;
        "pkg-1.3.0+1.21.6" = _QgqJ71rc;
        "pkg-1.3.0+1.21.2" = _ShW39Enn;
        "pkg-1.3.0+1.20" = _l2FEhrNc;
        "pkg-1.3.0+1.21" = _dYFJWFHT;
        "pkg-1.3.0+1.21.9" = _louiAmfv;
        "pkg-1.3.0+1.21.5" = _MURoKHeL;
        "pkg-1.3.1+1.20" = _oertE7dC;
        "pkg-1.3.1+1.21.6" = _o1gdg1Dt;
        "pkg-1.3.1+1.21" = _5kSDdL5I;
        "pkg-1.3.1+1.21.5" = _TnVf6t0Z;
        "pkg-1.3.1+1.21.9" = _X3gTy84D;
        "pkg-1.3.1+1.21.2" = _JexQfxoE;
        "pkg-1.3.2+1.21.5" = _oeVVXEQ1;
        "pkg-1.3.2+1.20" = _YoBciXqG;
        "pkg-1.3.2+1.21" = _1dtgNXYd;
        "pkg-1.3.2+1.21.2" = _vCjdNi32;
        "pkg-1.3.2+1.21.6" = _pBDHgkTZ;
        "pkg-1.3.2+1.21.9" = _FZV5HdvY;
        "pkg-1.3.3+1.20" = _NV3WzqCp;
        "pkg-1.3.3+1.21.11" = _4Qc4Z6Wi;
        "pkg-1.3.3+1.21" = _Su9DpdLY;
        "pkg-1.3.3+1.21.2" = _omuZFXR8;
        "pkg-1.3.3+1.21.5" = _XeQw8FYr;
