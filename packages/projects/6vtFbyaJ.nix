...
let
    versions = (let
        ...
        _o1qw8ej3 = {
            "id" = "o1qw8ej3";
            "file" = "sophisticatedstorageinmotion-26.2-0.10.34.343.jar";
            "hash" = "sha512-uHsMyDi7ukeQLYbmuZ9uN9LOaRLh1fX8vlOsEB8HfsE8Jlf2nq51NyEVHPwkLy2iJjZhuKnwpa927tee7uQacQ==";
        };
        _O2jwVwAL = {
            "id" = "O2jwVwAL";
            "file" = "sophisticatedstorageinmotion-1.20.1-0.10.36.344.jar";
            "hash" = "sha512-/DFeI9d3TmIkLdI03ZnZ2+22BiluXgjTPfk69Q1teJcF5CRZ4ROiGcx10jow677i32U3ktkFvi2KE9ttI1cQOw==";
        };
        _Dado3KNy = {
            "id" = "Dado3KNy";
            "file" = "sophisticatedstorageinmotion-26.2-0.10.35.353.jar";
            "hash" = "sha512-5QKBr/NoFrfR0hxgsMLHP1RKxwn5h8rX3bnRshqdaZ2bgHLdeV1XWTrdwinNBucLHmOZO3uxVjYg/BJvMcqvuA==";
        };
        _fM3bRNfp = {
            "id" = "fM3bRNfp";
            "file" = "sophisticatedstorageinmotion-26.1.2-0.10.34.354.jar";
            "hash" = "sha512-nJhnmtBfav0DcLVz56QTX29vHiA66QXlCJwYcF4eYiDMN711/Oyu7tdMMMqMDaldQa9pxcTkUNP6/5GfB3ZuNw==";
        };
        _cGv0Kbf7 = {
            "id" = "cGv0Kbf7";
            "file" = "sophisticatedstorageinmotion-1.20.1-0.10.37.355.jar";
            "hash" = "sha512-T2/Z2WdtfUr+gmALmqWOS57xQvG7AEP2YUSB58sKC1TJZFpr0bcaV+i9yXPUW4CsR/CjUWzt7AdJnIZ1djhqMg==";
        };
        _cIoKhzcY = {
            "id" = "cIoKhzcY";
            "file" = "sophisticatedstorageinmotion-1.21.5-0.10.33.356.jar";
            "hash" = "sha512-7iu2aKgp2ugAqudfa2/whi3kAbKjpg+7Mdz2iun0T1JPuszqoeDSYN+8H9UTpXEyEkJ03MhTyIMYs4ie0DiSSA==";
        };
        _euhLyZRU = {
            "id" = "euhLyZRU";
            "file" = "sophisticatedstorageinmotion-1.21.4-0.10.34.357.jar";
            "hash" = "sha512-Z85oI7B5ihf64h+s9JXu6stRoFZfiIQq0Uveivgkboc2nDLDt++9rz16Jqjowf4MfevPobNBzPVKuVoXyzZo4A==";
        };
        _4YupqHfZ = {
            "id" = "4YupqHfZ";
            "file" = "sophisticatedstorageinmotion-1.21.1-0.10.34.358.jar";
            "hash" = "sha512-wxpzssb+cTsdo/HuflYvGJxUABnAc6HVTnBbJ1kZxvOsXTf/tFVyS2GdMAAHCUiiYeg6aJs8JhxobIgpdd8SqQ==";
        };
        _JR5dXv90 = {
            "id" = "JR5dXv90";
            "file" = "sophisticatedstorageinmotion-1.21.8-0.10.33.360.jar";
            "hash" = "sha512-U6t3MPG/CMkrlXXDNUW7ZgxJ/Xiwr2EXvE99fFVIzJ51olxOmiYOc7Ot+cGcVXGq4vLdC7PN69U3Y2E1By0jbQ==";
        };
        _3Ui8f9bW = {
            "id" = "3Ui8f9bW";
            "file" = "sophisticatedstorageinmotion-1.21.10-0.10.31.359.jar";
            "hash" = "sha512-QI4gW18cs/yo1EfPg87DVyPw2L9S2wbf20PcNcT2u7FlDYm8dTUhFUIKKEeHWHEoCT4dvpzkXMzOFGv2X1a6Yg==";
        };
        _HS2feubD = {
            "id" = "HS2feubD";
            "file" = "sophisticatedstorageinmotion-1.21.11-0.10.32.361.jar";
            "hash" = "sha512-VdfUS13vkGk7P1Q0oTvvVHLD+o0Y+Y3wKtKoKrTSiXJQll1IcMRgiHodvy+eqB3wA+I1yj5dDTA2GgKAg/zJeg==";
        };
        _bPdSPO61 = {
            "id" = "bPdSPO61";
    ...
    in {
        ...
        "pkg-1.20.1-0.0.2.9" = _pLI1JXhj;
        "pkg-1.21.1-0.0.2.10" = _X5x96lAG;
        "pkg-1.20.1-0.0.2.11" = _ZqKwKsoj;
        "pkg-1.21.1-0.1.0.12" = _P4aODjxn;
        "pkg-1.20.1-0.1.0.13" = _aBYDCdWq;
        "pkg-1.21.1-0.1.1.14" = _DLmXLTjh;
        "pkg-1.21.1-0.1.2.15" = _kkTXCrh2;
        "pkg-1.20.1-0.1.1.16" = _RWA4nkHV;
        "pkg-1.21.1-0.2.0.19" = _Q5U3fF0j;
        "pkg-1.20.1-0.2.0.20" = _4MVxvoe0;
        "pkg-1.21.1-0.3.0.21" = _BUJMfs9f;
        "pkg-1.20.1-0.3.0.22" = _23wazg9F;
        "pkg-1.21.1-0.4.0.23" = _lBhhYmZh;
        "pkg-1.20.1-0.4.0.24" = _v0l5h5AX;
        "pkg-1.21.1-0.5.0.25" = _91buPqmY;
        "pkg-1.20.1-0.5.0.26" = _jknd4P9q;
        "pkg-1.21.1-0.5.1.27" = _4WZhWSkU;
        "pkg-1.20.1-0.5.1.28" = _o34PRV30;
        "pkg-1.21.1-0.6.0.30" = _GIUjvng0;
        "pkg-1.20.1-0.6.0.31" = _3kPvf9Hr;
        "pkg-1.20.1-0.6.1.32" = _Cddm7JTW;
        "pkg-1.21.1-0.6.0.33" = _uNkiU8u0;
        "pkg-1.20.1-0.6.1.34" = _I9Ac9ZT9;
        "pkg-1.21.1-0.6.1.35" = _4r0xM8BC;
        "pkg-1.21.1-0.7.0.36" = _Z1r95H8Q;
        "pkg-1.20.1-0.7.0.37" = _a1BHgfkS;
        "pkg-1.21.1-0.7.1.38" = _MEEwFbyl;
        "pkg-1.20.1-0.7.1.39" = _RCHtnzAD;
        "pkg-1.21.1-0.7.2.40" = _V5wDpaYA;
        "pkg-1.21.1-0.7.3.41" = _QSH7ClZK;
        "pkg-1.20.1-0.7.2.42" = _IJ17jnPr;
        "pkg-1.21.1-0.7.4.43" = _CUHR5J8C;
        "pkg-1.20.1-0.7.3.44" = _HHroarPg;
        "pkg-1.20.1-0.7.4.45" = _13Hrp0Bj;
        "pkg-1.21.1-0.7.5.47" = _u3bbyI5V;
        "pkg-1.21.1-0.8.0.48" = _7DFjM2gf;
        "pkg-1.20.1-0.8.0.49" = _F81kHutu;
        "pkg-1.21.1-0.9.0.50" = _2NytQVOi;
        "pkg-1.20.1-0.9.0.51" = _KTpo0swb;
        "pkg-1.21.1-0.10.0.56" = _CHANkowu;
        "pkg-1.20.1-0.10.0.57" = _C48PPBHY;
        "pkg-1.21.1-0.10.1.58" = _CJ4PNaPe;
        "pkg-1.20.1-0.10.1.59" = _e6QLLteG;
        "pkg-1.20.1-0.10.3.62" = _h3P2y5jM;
        "pkg-1.21.1-0.10.3.63" = _MZtXncYH;
        "pkg-1.20.1-0.10.4.64" = _nsKDRlNH;
        "pkg-1.21.1-0.10.4.65" = _G7aTspFk;
        "pkg-1.20.1-0.10.5.66" = _WVPwf3Tr;
        "pkg-1.21.1-0.10.5.67" = _De0xd6uf;
        "pkg-1.21.1-0.10.5.70" = _rkRVRObc;
        "pkg-1.20.1-0.10.5.71" = _Ovn70VxF;
        "pkg-1.21.1-0.10.5.72" = _bh2eL1Kb;
        "pkg-1.20.1-0.10.5.73" = _9irs2ggf;
        "pkg-1.21.1-0.10.6.74" = _bS4t2C9B;
        "pkg-1.20.1-0.10.6.75" = _5wYnkx0A;
        "pkg-1.21.1-0.10.6.76" = _WQUeKEWD;
        "pkg-1.20.1-0.10.7.77" = _z0UCkoDc;
        "pkg-1.21.1-0.10.6.78" = _QioJ7VbU;
        "pkg-1.20.1-0.10.8.79" = _AgCtf8JH;
        "pkg-1.21.1-0.10.7.80" = _5zCa0z4V;
        "pkg-1.20.1-0.10.9.81" = _nEfORtSv;
        "pkg-1.21.1-0.10.8.82" = _1T0XOlfe;
        "pkg-1.21.1-0.10.9.84" = _c2mBgf37;
        "pkg-1.20.1-0.10.10.85" = _1LCerAX3;
        "pkg-1.21.1-0.10.10.86" = _u3G9CGPS;
        "pkg-1.20.1-0.10.11.87" = _zxZ9GFpd;
        "pkg-1.21.1-0.10.11.88" = _MKEb0Yg8;
        "pkg-1.20.1-0.10.12.89" = _vOdVVLYy;
        "pkg-1.21.1-0.10.12.90" = _bWzUiDtg;
        "pkg-1.20.1-0.10.13.91" = _LtvBnUva;
        "pkg-1.21.1-0.10.13.92" = _gmqft8YN;
        "pkg-1.20.1-0.10.14.93" = _LX5WwKmQ;
        "pkg-1.21.1-0.10.14.94" = _hotrWVNc;
        "pkg-1.20.1-0.10.15.95" = _yBO21epy;
        "pkg-1.21.1-0.10.15.96" = _VkkJbcqY;
        "pkg-1.20.1-0.10.16.97" = _hxXODHwn;
        "pkg-1.21.1-0.10.16.99" = _iOe5YRdJ;
        "pkg-1.20.1-0.10.17.100" = _Guw99kSG;
        "pkg-1.21.1-0.10.17.101" = _gwVrzHtQ;
        "pkg-1.20.1-0.10.18.102" = _FBGRt8yO;
        "pkg-1.20.1-0.10.19.104" = _4s66lOkd;
        "pkg-1.21.1-0.10.18.105" = _PY7xiquN;
        "pkg-1.21.4-0.10.19.107" = _n6IWqauT;
        "pkg-1.21.5-0.10.19.114" = _tcD4o4e3;
        "pkg-1.21.1-0.10.18.115" = _PXer1kPM;
        "pkg-1.20.1-0.10.19.116" = _Y5xLRHk8;
        "pkg-1.21.5-0.10.19.118" = _fOECibAE;
        "pkg-1.21.4-0.10.19.117" = _XyCFeQiJ;
        "pkg-1.21.1-0.10.18.119" = _q7Ps3ooA;
        "pkg-1.21.4-0.10.19.121" = _rORrDqHL;
        "pkg-1.20.1-0.10.19.120" = _S19ifqIF;
        "pkg-1.21.5-0.10.19.122" = _YfWHs6pH;
        "pkg-1.21.8-0.10.19.123" = _CTI8aAK2;
        "pkg-1.21.1-0.10.19.124" = _fhkkK3b6;
        "pkg-1.21.4-0.10.19.125" = _JnmJ5DRw;
        "pkg-1.20.1-0.10.20.126" = _bq1JXIAf;
        "pkg-1.21.5-0.10.19.127" = _zL823q46;
        "pkg-1.21.8-0.10.19.128" = _7LpxXUok;
        "pkg-1.21.1-0.10.20.129" = _irSJnOq1;
        "pkg-1.20.1-0.10.21.130" = _iuvZl32u;
        "pkg-1.21.4-0.10.20.131" = _24QAvpNX;
        "pkg-1.21.5-0.10.20.132" = _7eBEWctt;
        "pkg-1.21.8-0.10.20.133" = _jDPmhiwA;
        "pkg-1.21.1-0.10.21.134" = _xBJ4h7sl;
        "pkg-1.20.1-0.10.22.135" = _Y2Zqg56D;
        "pkg-1.21.4-0.10.21.136" = _gCo3kkWG;
        "pkg-1.21.5-0.10.21.137" = _jzhfHZzh;
        "pkg-1.21.8-0.10.21.138" = _YMWRKOoU;
        "pkg-1.21.1-0.10.22.139" = _SWf8a3wr;
        "pkg-1.21.4-0.10.22.141" = _ieZ5myfQ;
        "pkg-1.21.5-0.10.22.142" = _IMCcRRR9;
        "pkg-1.20.1-0.10.23.140" = _IxiR2BTw;
        "pkg-1.21.8-0.10.22.143" = _A9P4h43y;
        "pkg-1.21.1-0.10.22.144" = _NzEssUw2;
        "pkg-1.20.1-0.10.23.145" = _tUdW9bOW;
        "pkg-1.21.4-0.10.22.146" = _P3HFzwYb;
        "pkg-1.21.5-0.10.22.147" = _jTlk0JRe;
        "pkg-1.21.8-0.10.22.148" = _Qhs8ylnu;
        "pkg-1.21.1-0.10.23.149" = _qRlFaJhs;
        "pkg-1.21.4-0.10.23.150" = _y7ArUxhg;
        "pkg-1.21.5-0.10.23.151" = _SFIlh0o9;
        "pkg-1.21.8-0.10.23.152" = _L9pZaGHG;
        "pkg-1.20.1-0.10.24.153" = _z8CFDRaE;
        "pkg-1.21.1-0.10.24.155" = _O3nNftGu;
        "pkg-1.21.4-0.10.24.157" = _EXSyab7G;
        "pkg-1.21.5-0.10.24.158" = _ffonbMId;
        "pkg-1.20.1-0.10.25.156" = _D4hB9yM7;
        "pkg-1.21.8-0.10.24.159" = _ktLmbgSS;
        "pkg-1.21.10-0.10.23.160" = _1B00tKe4;
        "pkg-1.21.11-0.10.23.161" = _7iuz5Zl6;
        "pkg-1.21.11-0.10.24.162" = _IF28AnDL;
        "pkg-1.20.1-0.10.26.163" = _j0Y88SSf;
        "pkg-1.21.1-0.10.25.164" = _YulaXzGq;
        "pkg-1.20.1-0.10.27.165" = _vTml4PmD;
        "pkg-1.21.4-0.10.25.166" = _rj1SR2Xp;
        "pkg-1.21.5-0.10.25.167" = _A0V0vBU7;
        "pkg-1.21.8-0.10.25.168" = _reQZC8Y3;
        "pkg-1.21.10-0.10.24.169" = _cfZMllqQ;
        "pkg-1.21.11-0.10.25.170" = _bOoessTw;
        "pkg-1.21.1-0.10.26.181" = _M93ViVlI;
        "pkg-1.20.1-0.10.28.182" = _Ar0uiQ2H;
        "pkg-1.21.4-0.10.26.183" = _neTBmgLv;
        "pkg-1.21.5-0.10.26.184" = _GtddpDlL;
        "pkg-1.21.8-0.10.26.185" = _Bzu0eUc3;
        "pkg-1.21.10-0.10.25.186" = _7nkf0B6b;
        "pkg-1.21.11-0.10.26.187" = _hUCowAgp;
        "pkg-1.21.10-0.10.25.188" = _dd68pmRj;
        "pkg-1.21.11-0.10.26.189" = _CnIDbLXm;
        "pkg-1.21.1-0.10.26.197" = _WOLdywkm;
        "pkg-1.20.1-0.10.28.198" = _rfJ5pLW6;
        "pkg-1.21.8-0.10.26.199" = _djSrt6zs;
        "pkg-1.21.10-0.10.25.202" = _OQNX3ZRb;
        "pkg-1.21.4-0.10.26.200" = _83lyl0fi;
        "pkg-1.21.11-0.10.26.201" = _W1gdocHF;
        "pkg-1.21.5-0.10.26.203" = _OLncF3uY;
        "pkg-26.1-0.10.26.205" = _qEJzFn3M;
        "pkg-1.21.4-0.10.27.209" = _cHZpF7Sr;
        "pkg-1.21.5-0.10.27.210" = _u4jJKFeX;
        "pkg-1.21.1-0.10.27.208" = _feTe7lA2;
        "pkg-1.21.8-0.10.27.211" = _aE6bhAvS;
        "pkg-1.21.10-0.10.26.212" = _1q0ztCd6;
        "pkg-1.21.11-0.10.27.213" = _WaL2m8OH;
        "pkg-26.1-0.10.27.215" = _ekbg0gZV;
        "pkg-26.1-0.10.28.224" = _OX10J6LC;
        "pkg-26.1-0.10.28.225" = _mZJ7GcP9;
        "pkg-26.1.2-0.10.29.243" = _ytRP5L6o;
        "pkg-1.21.1-0.10.28.244" = _UJNea5EF;
        "pkg-1.21.4-0.10.28.246" = _5NF9x6Dm;
        "pkg-1.20.1-0.10.31.247" = _5kQYibkY;
        "pkg-1.21.1-0.10.29.248" = _Gf494TtO;
        "pkg-1.21.4-0.10.29.249" = _x6z2UQ4F;
        "pkg-1.21.5-0.10.28.250" = _grKZnfEJ;
        "pkg-1.21.8-0.10.28.251" = _H7x8jPxF;
        "pkg-1.21.10-0.10.27.253" = _6uBsNGTW;
        "pkg-1.21.11-0.10.28.252" = _jX0K8zmV;
        "pkg-26.1.2-0.10.30.254" = _18oo9oxn;
        "pkg-1.21.5-0.10.29.256" = _e0lCg9hv;
        "pkg-1.21.8-0.10.29.255" = _Yfw1x8F4;
        "pkg-1.21.4-0.10.30.257" = _RTocJhAT;
        "pkg-1.21.1-0.10.30.258" = _HhnAxjhe;
        "pkg-1.20.1-0.10.32.259" = _lxBpHbE9;
        "pkg-26.1.2-0.10.30.260" = _B0Ut7Yg1;
        "pkg-1.21.1-0.10.30.261" = _jr9WFjdH;
        "pkg-1.21.10-0.10.27.266" = _Aymgydkr;
        "pkg-1.21.5-0.10.29.263" = _b6WkooQ4;
        "pkg-1.21.11-0.10.28.267" = _yVE80BVh;
        "pkg-1.21.8-0.10.29.265" = _kqnUndPT;
        "pkg-1.21.4-0.10.30.264" = _JHH39kfR;
        "pkg-1.20.1-0.10.32.262" = _QzVIRIgt;
        "pkg-1.21.1-0.10.30.276" = _DRzHGbgT;
        "pkg-26.1.2-0.10.30.283" = _NMvZuCAc;
        "pkg-1.20.1-0.10.32.277" = _EfsWL8mi;
        "pkg-1.21.4-0.10.30.278" = _45Ibinjk;
        "pkg-1.21.5-0.10.29.279" = _zA2Utlli;
        "pkg-1.21.8-0.10.29.280" = _A3VAxRLm;
        "pkg-1.21.10-0.10.27.281" = _NjwQuDna;
        "pkg-1.21.11-0.10.28.282" = _xdYsNSwL;
        "pkg-1.20.1-0.10.33.288" = _9qRI0gsv;
        "pkg-26.2-0.10.30.289" = _zraR50IK;
        "pkg-1.20.1-0.10.34.299" = _adOei19y;
        "pkg-1.21.1-0.10.31.300" = _EHdP5Iqy;
        "pkg-26.1.2-0.10.31.301" = _S5lSFXGc;
        "pkg-26.2-0.10.31.302" = _1g0eZ8Q8;
        "pkg-1.21.4-0.10.31.303" = _f4Hbxjmo;
        "pkg-1.21.5-0.10.30.304" = _af55HVKA;
        "pkg-1.21.8-0.10.30.305" = _orX0uuEf;
        "pkg-1.21.10-0.10.28.306" = _JI87vP0V;
        "pkg-1.21.11-0.10.29.307" = _TqD6S7Pl;
        "pkg-26.2-0.10.32.308" = _2LKPg27w;
        "pkg-26.1.2-0.10.32.309" = _uEtXEA1q;
        "pkg-1.21.4-0.10.32.310" = _Dqr2Xrge;
        "pkg-1.21.5-0.10.31.311" = _F4lE776T;
        "pkg-1.21.8-0.10.31.313" = _mHDPeZ5t;
        "pkg-1.21.10-0.10.29.312" = _2KTjfdOh;
        "pkg-1.21.11-0.10.30.314" = _2VwWk6Cc;
        "pkg-1.21.1-0.10.32.317" = _kcrBC1oy;
        "pkg-26.2-0.10.33.319" = _QoHyjS2I;
        "pkg-26.1.2-0.10.33.320" = _Zy6xdYDg;
        "pkg-1.21.8-0.10.32.322" = _ZyWcsYiu;
        "pkg-1.21.4-0.10.33.323" = _l9mh01NA;
        "pkg-1.21.1-0.10.33.324" = _P4YXMpns;
        "pkg-1.21.5-0.10.32.326" = _4tiQUYYP;
        "pkg-1.21.10-0.10.30.325" = _lBCEdqDO;
        "pkg-1.21.11-0.10.31.327" = _z2BqTjeI;
        "pkg-1.20.1-0.10.35.321" = _rwn1peGU;
        "pkg-26.2-0.10.34.343" = _o1qw8ej3;
        "pkg-1.20.1-0.10.36.344" = _O2jwVwAL;
        "pkg-26.2-0.10.35.353" = _Dado3KNy;
        "pkg-26.1.2-0.10.34.354" = _fM3bRNfp;
        "pkg-1.20.1-0.10.37.355" = _cGv0Kbf7;
        "pkg-1.21.5-0.10.33.356" = _cIoKhzcY;
        "pkg-1.21.4-0.10.34.357" = _euhLyZRU;
        "pkg-1.21.1-0.10.34.358" = _4YupqHfZ;
        "pkg-1.21.8-0.10.33.360" = _JR5dXv90;
