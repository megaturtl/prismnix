...
let
    versions = (let
        ...
        _WDPYVMpA = {
            "id" = "WDPYVMpA";
            "file" = "ismah-6.0.0-fabric+1.20.1.jar";
            "hash" = "sha512-39GqLWfp+MTM/3FUsehELnOHsX3V3d161VUbWdqjvAT0d3060kZ/1SRo6q5J7NrzZPnaXSEE6qfpTvI0AuG23A==";
        };
        _phjVyCiz = {
            "id" = "phjVyCiz";
            "file" = "ismah-6.0.0-forge+1.20.1.jar";
            "hash" = "sha512-qcQatQDTM79CUACYzbnuIrgM78kZ/ygUswNqHbmgkgNG/spaJXEJpjzIyazgmJ3tjYBo4yeAFGJWP0ofqerIZg==";
        };
        _UVRma3Fj = {
            "id" = "UVRma3Fj";
            "file" = "ismah-6.0.0-fabric+1.21.1.jar";
            "hash" = "sha512-fXnOQi285RUW0thQehgTLg1Wq68sHpilpom9yjDvzAIsfQnw7bYDJUl2xRTwZJmUxgLEwvu2o89rLdTMOIAR9A==";
        };
        _JdBP9GPk = {
            "id" = "JdBP9GPk";
            "file" = "ismah-6.0.0-neoforge+1.21.1.jar";
            "hash" = "sha512-gczDhyNbgPVh7fGeNPiS7Ok8e5mK+72nnAEQ93dRbQFpqqDuG9GxPnJQ8ilN5LR1mX0dK8KJBYpcqOynuiQgnQ==";
        };
        _VCCCfME7 = {
            "id" = "VCCCfME7";
            "file" = "ismah-6.0.0-fabric+1.21.7.jar";
            "hash" = "sha512-kjxXdiXbS6Hwa11/sjcCEn2NSkiOdRMIzNfJ3hl+cr75CzXhn2rclL1ZqEaqWUhthtKgbpGzdwFOZYivp74Urw==";
        };
        _5cIFIpLg = {
            "id" = "5cIFIpLg";
            "file" = "ismah-6.0.0-neoforge+1.21.7.jar";
            "hash" = "sha512-U/JHJaufejjUCvEut/r2rVfNE5iU7kj+1AMWQIv02MNNaUKTa3En73NBHyYehmrqWojDv/TX3GdfrBLOzPzzqA==";
        };
        _NcO5V3On = {
            "id" = "NcO5V3On";
            "file" = "ismah-6.0.0-fabric+1.21.11.jar";
            "hash" = "sha512-TT/yMEW7oGRz04sbEs9jj4lLiVFbfNTVCUNa8aLGWEXqtAG9kydbLjRLUrMKi1jYfVG8GnyCckvU/imNaWNzlg==";
        };
        _M2SDCbyq = {
            "id" = "M2SDCbyq";
            "file" = "ismah-6.0.0-neoforge+1.21.11.jar";
            "hash" = "sha512-53F7d4fuPqMtVeWyrInlIQLhEtX/IOTggMKW47YaDUGdEdAvteazl5cO9tegQiAJpoatJN8AQGdEI1cftowdmQ==";
        };
        _psuh0WOV = {
            "id" = "psuh0WOV";
            "file" = "ismah-6.0.0-fabric+26.1.2.jar";
            "hash" = "sha512-8IvIOr+33wsyXxPW7Sjnwo4LEFNtwMCbK/NT7ubUZgoDHEk1yPqXznZE/p0YiSISXiuGNyhVzaInNlP74MiRrQ==";
        };
        _kAgYhgrY = {
            "id" = "kAgYhgrY";
            "file" = "ismah-6.0.0-neoforge+26.1.2.jar";
            "hash" = "sha512-GO/W+xu3Io8zSlr11rspr+byumXQ51DjlV1nT7KEAmQ6RwGEU4YQpSH9f6tmzMar/UMv4F5JNouejHPGs+hC7w==";
        };
        _ur77Su1t = {
            "id" = "ur77Su1t";
            "file" = "ismah-6.0.0-fabric+26.2.jar";
            "hash" = "sha512-Ha9tF7zi2OOpg5ODpVaiiz31Dt6JoTM+ij2RhaS8A4uOzRlaPnHCLJIZGmNY2OLv3Xl5dG/GQbPSdhjy21sxUw==";
        };
        _EsgmU3P1 = {
            "id" = "EsgmU3P1";
    ...
    in {
        ...
        "pkg-1.0.0" = _7mWE0Dev;
        "pkg-1.0.0-1.20" = _p7jOPUOn;
        "pkg-1.1.0-1.20" = _hgQ9GAi8;
        "pkg-1.1.0-1.21.1" = _DVAbMbvZ;
        "pkg-1.5.0" = _xvedWN5q;
        "pkg-1.8.0" = _284yMSHi;
        "pkg-2.0.0" = _qVsR3Cdq;
        "pkg-2.2.0-1.21(.1)" = _tqtybBKD;
        "pkg-2.2.0-1.21.(5)" = _OKGcFsQQ;
        "pkg-2.2.0-1.21.(6,7)" = _wUxo9QmM;
        "pkg-2.2.1-1.21.5(7)" = _VuVtSTqk;
        "pkg-3.0.1" = _agoXg5Rb;
        "pkg-3.0.2" = _UgAQQjEw;
        "pkg-3.1.0" = _uNtEiOcf;
        "pkg-3.1.1" = _ZxcoKRgZ;
        ...
        "pkg-4.0.1" = _92BETg2R;
        "pkg-4.1.0" = _bRxPfXT0;
        "pkg-5.0.0+1.21.11-neoforge" = _dIT2GD5K;
        "pkg-5.0.0+1.21.10-neoforge" = _TCQ0hLvS;
        "pkg-5.0.0+1.21.10-fabric" = _h9XxdJVo;
        "pkg-5.0.0+1.21.11-fabric" = _QWu81tI2;
        "pkg-5.1.0+1.21.11-neoforge" = _9WNC3m1V;
        "pkg-5.1.0+1.21.10-neoforge" = _2avYe4lG;
        "pkg-5.1.0+1.21.10-fabric" = _xNay4n2n;
        "pkg-5.1.0+1.21.11-fabric" = _10D20dOe;
        "pkg-5.1.0+1.21.8-fabric" = _EPNqfdQ7;
        "pkg-5.1.0+1.21.8-neoforge" = _EamMGqAf;
        "pkg-5.1.1+1.21.10-neoforge" = _gjPQidet;
        "pkg-5.1.1+1.21.11-fabric" = _zj0MEAE5;
        "pkg-5.1.1+1.21.10-fabric" = _tNhc39eQ;
        "pkg-5.1.1+1.21.11-neoforge" = _AaYLDqiU;
        "pkg-5.1.1+1.21.5-fabric" = _cO7C7Tlw;
        "pkg-5.1.1+1.21.5-neoforge" = _mRtpHWIq;
        "pkg-5.1.1+1.21.6-neoforge" = _IgQusRNu;
        "pkg-5.1.1+1.21.6-fabric" = _zJScZkuU;
        "pkg-5.1.1+1.21.7-neoforge" = _UuT4P38W;
        "pkg-5.1.1+1.21.8-neoforge" = _Kk5nyzue;
        "pkg-5.1.1+1.21.7-fabric" = _KMUKkEQF;
        "pkg-5.1.1+1.21.8-fabric" = _i2eHJTTz;
        "pkg-5.1.2+1.21.11-fabric" = _DB2HPYHy;
        "pkg-5.1.2+1.21.10-neoforge" = _9jatVIZN;
        "pkg-5.1.2+1.21.10-fabric" = _ONFGBqRN;
        "pkg-5.1.2+1.21.11-neoforge" = _6xpckpvk;
        "pkg-5.1.2+1.21.6-neoforge" = _CmWDDq67;
        "pkg-5.1.2+1.21.5-neoforge" = _ofSQ7r2q;
        "pkg-5.1.2+1.21.5-fabric" = _VqNLgIhb;
        "pkg-5.1.2+1.21.6-fabric" = _DXNwAPdv;
        "pkg-5.1.2+1.21.7-neoforge" = _Rj4IdGtT;
        "pkg-5.1.2+1.21.7-fabric" = _QrNJhLid;
        "pkg-5.1.2+1.21.8-neoforge" = _wR258bzw;
        "pkg-5.1.2+1.21.8-fabric" = _7GKKBemm;
        "pkg-5.2.0+1.21.11-fabric" = _LfvftzKr;
        "pkg-5.2.0+1.21.10-neoforge" = _Aa3REpdv;
        "pkg-5.2.0+1.21.10-fabric" = _wfUioc3T;
        "pkg-5.2.0+1.21.11-neoforge" = _7k9wyZFG;
        "pkg-5.2.0+1.21.5-neoforge" = _hMqvTWVl;
        "pkg-5.2.0+1.21.5-fabric" = _fTmV3iiZ;
        "pkg-5.2.0+1.21.6-fabric" = _7EloVSmR;
        "pkg-5.2.0+1.21.6-neoforge" = _84R6aAeH;
        "pkg-5.2.0+1.21.8-neoforge" = _yoTA0G0v;
        "pkg-5.2.0+1.21.7-neoforge" = _rfEWOFIx;
        "pkg-5.2.0+1.21.7-fabric" = _qKfidtzy;
        "pkg-5.2.0+1.21.8-fabric" = _YCUtWrCA;
        "pkg-5.3.0+1.21.11-neoforge" = _vWfG3hbJ;
        "pkg-5.3.0+1.21.10-neoforge" = _MvBeWH1H;
        "pkg-5.3.0+1.21.10-fabric" = _RgsWr5j4;
        "pkg-5.3.0+1.21.11-fabric" = _kDuLsUCl;
        "pkg-5.3.0+1.21.5-fabric" = _jrzqtQjh;
        "pkg-5.3.0+1.21.5-neoforge" = _40tBzhuG;
        "pkg-5.3.0+1.21.6-neoforge" = _XOAqxfeN;
        "pkg-5.3.0+1.21.6-fabric" = _CvPZMa9G;
        "pkg-5.3.0+1.21.7-fabric" = _eAaSYgnu;
        "pkg-5.3.0+1.21.7-neoforge" = _wBMOr6jT;
        "pkg-5.3.0+1.21.8-neoforge" = _HWirl5ql;
        "pkg-5.3.0+1.21.8-fabric" = _eZ249IEJ;
        "pkg-5.4.0+1.21.1-fabric" = _QlSPqWb1;
        "pkg-5.4.0+1.20.1-fabric" = _XnSXkEOB;
        "pkg-5.4.0+1.20.1-forge" = _We1uo8cL;
        "pkg-5.4.0+1.21.10-fabric" = _r6vIjcMH;
        "pkg-5.4.0+1.21.11-fabric" = _mpq5MrvZ;
        "pkg-5.4.0+1.21.10-neoforge" = _ghYcOrf1;
        "pkg-5.4.0+1.21.5-neoforge" = _WAaRQdkH;
        "pkg-5.4.0+1.21.6-neoforge" = _dHua5kPS;
        "pkg-5.4.0+1.21.8-neoforge" = _SLbR3yqS;
        "pkg-5.4.0+1.21.7-fabric" = _D39B8byB;
        "pkg-5.4.0+1.21.11-neoforge" = _eVrYM13D;
        "pkg-5.4.0+1.21.5-fabric" = _cTYUnIuK;
        "pkg-5.4.0+1.21.6-fabric" = _euvLgK0m;
        "pkg-5.4.0+1.21.7-neoforge" = _upFWxjPr;
        "pkg-5.4.0+1.21.8-fabric" = _fnUPJmfS;
        "pkg-5.4.1+1.21.10-neoforge" = _xYSz5Sgv;
        "pkg-5.4.1+1.21.10-fabric" = _qWA0NBBe;
        "pkg-5.4.1+1.21.11-neoforge" = _U7x8yz99;
        "pkg-5.4.1+1.20.1-fabric" = _qaI2jpMO;
        "pkg-5.4.1+1.21.11-fabric" = _civnttut;
        "pkg-5.4.1+1.21.6-fabric" = _6X4IHqTi;
        "pkg-5.4.1+1.21.1-fabric" = _SjyOx8WQ;
        "pkg-5.4.1+1.21.5-neoforge" = _evU3bgHC;
        "pkg-5.4.1+1.20.1-forge" = _S9GMWrIA;
        "pkg-5.4.1+1.21.5-fabric" = _rbWltnae;
        "pkg-5.4.1+1.21.8-neoforge" = _82g072wC;
        "pkg-5.4.1+1.21.7-fabric" = _qcV4Df2r;
        "pkg-5.4.1+1.21.6-neoforge" = _j8oiJxSp;
        "pkg-5.4.1+1.21.7-neoforge" = _aqcEsH8y;
        "pkg-5.4.1+1.21.8-fabric" = _ngrW4P9d;
        "pkg-5.4.1" = _LNqCzkAL;
        "pkg-5.4.2" = _klANsIGl;
        "pkg-5.5.0+1.21.1-neoforge" = _BfySDyak;
        "pkg-5.5.0+1.21.10-fabric" = _4QElLnlC;
        "pkg-5.5.0+1.21.1-fabric" = _sPYDapGe;
        "pkg-5.5.0+1.20.1-fabric" = _C2Sc0zK5;
        "pkg-5.5.0+1.21.10-neoforge" = _WHVGorEZ;
        "pkg-5.5.0+1.21.11-neoforge" = _RmirSCJv;
        "pkg-5.5.0+1.21.11-fabric" = _PHHaeKWr;
        "pkg-5.5.0+1.20.1-forge" = _U729JWOu;
        "pkg-5.5.0+1.21.5-fabric" = _yhZbPdAh;
        "pkg-5.5.0+1.21.5-neoforge" = _w4CRzCUf;
        "pkg-5.5.0+1.21.6-fabric" = _D2jef7Hl;
        "pkg-5.5.0+1.21.6-neoforge" = _xGsu5DJ8;
        "pkg-5.5.0+1.21.7-neoforge" = _DsrMySGn;
        "pkg-5.5.0+1.21.7-fabric" = _98baPcrb;
        "pkg-5.5.0+1.21.8-fabric" = _f3mXaPOe;
        "pkg-5.5.0+1.21.8-neoforge" = _XYKxF0qa;
        "pkg-5.5.0+26.1-neoforge" = _OrgP2SQu;
        "pkg-5.5.0+26.1-fabric" = _uyiTAvsb;
        "pkg-5.5.1+1.21.1-neoforge" = _in3PkRSC;
        "pkg-5.5.1+1.20.1-fabric" = _WcARZDxi;
        "pkg-5.5.1+1.21.1-fabric" = _p8F2oVpi;
        "pkg-5.5.1+1.21.10-fabric" = _55wBYcnN;
        "pkg-5.5.1+1.21.10-neoforge" = _U9rcFW0B;
        "pkg-5.5.1+1.21.11-neoforge" = _ogAOx4Ky;
        "pkg-5.5.1+1.21.11-fabric" = _17HJyiRJ;
        "pkg-5.5.1+1.20.1-forge" = _BqUVHrmT;
        "pkg-5.5.1+1.21.5-neoforge" = _1cykT7Rk;
        "pkg-5.5.1+1.21.5-fabric" = _8X4Yusfe;
        "pkg-5.5.1+1.21.6-neoforge" = _w6UVe3hZ;
        "pkg-5.5.1+1.21.7-neoforge" = _1iPnJJr6;
        "pkg-5.5.1+1.21.6-fabric" = _Np1FWDl8;
        "pkg-5.5.1+1.21.7-fabric" = _gl4A6IGw;
        "pkg-5.5.1+1.21.8-fabric" = _Wyk9IJa5;
        "pkg-5.5.1+1.21.8-neoforge" = _k2pkmdhT;
        "pkg-5.5.1+26.1-fabric" = _bHKPWEL1;
        "pkg-5.5.1+26.1-neoforge" = _dGeXIzEb;
        "pkg-5.5.2+1.21.11-fabric" = _RANI6Hub;
        "pkg-5.5.2+1.21.1-neoforge" = _w6j9GF6L;
        "pkg-5.5.2+1.20.1-fabric" = _omxCr8z4;
        "pkg-5.5.2+1.21.10-neoforge" = _Agyyw3hM;
        "pkg-5.5.2+1.21.1-fabric" = _4AO1gQzK;
        "pkg-5.5.2+1.20.1-forge" = _GpEIintF;
        "pkg-5.5.2+1.21.10-fabric" = _9CECDsmj;
        "pkg-5.5.2+1.21.11-neoforge" = _296012IX;
        "pkg-5.5.2+1.21.5-neoforge" = _k6swLQUs;
        "pkg-5.5.2+1.21.6-neoforge" = _3hNgCtub;
        "pkg-5.5.2+1.21.7-neoforge" = _ckmUEV0v;
        "pkg-5.5.2+1.21.8-neoforge" = _PJEwnnOU;
        "pkg-5.5.2+1.21.6-fabric" = _MqAIznIe;
        "pkg-5.5.2+1.21.7-fabric" = _HKlDJB7P;
        "pkg-5.5.2+1.21.8-fabric" = _PEsHNWeM;
        "pkg-5.5.2+1.21.5-fabric" = _ybQR6CyC;
        "pkg-5.5.2+26.1-neoforge" = _E3GIXvBV;
        "pkg-5.5.2+26.1-fabric" = _ByK6S32Z;
        "pkg-5.5.3+1.20.1-forge" = _AgLBr8yI;
        "pkg-5.5.3+1.21.1-neoforge" = _ggtC77uu;
        "pkg-5.5.3+1.21.10-neoforge" = _jCsqJ5Bx;
        "pkg-5.5.3+1.20.1-fabric" = _WfMlgxLZ;
        "pkg-5.5.3+1.21.1-fabric" = _7uOwPUbH;
        "pkg-5.5.3+1.21.10-fabric" = _w13c5sDy;
        "pkg-5.5.3+1.21.11-neoforge" = _yPvyzI8H;
        "pkg-5.5.3+1.21.11-fabric" = _Bhmo62q5;
        "pkg-5.5.3+1.21.5-fabric" = _OOO4Ii9O;
        "pkg-5.5.3+1.21.5-neoforge" = _FSLkwqoG;
        "pkg-5.5.3+1.21.7-neoforge" = _Lr5E6pkg;
        "pkg-5.5.3+1.21.6-neoforge" = _p4WJjLTB;
        "pkg-5.5.3+1.21.6-fabric" = _x78JbfCQ;
        "pkg-5.5.3+1.21.8-fabric" = _Bdb5tR0o;
        "pkg-5.5.3+1.21.8-neoforge" = _T3KiNsRb;
        "pkg-5.5.3+26.1-fabric" = _ngY9SzpV;
        "pkg-5.5.3+1.21.7-fabric" = _IMIk89vS;
        "pkg-5.5.3+26.1-neoforge" = _yThtdt3p;
        "pkg-5.5.4+1.20.1-fabric" = _I0ZGd5dy;
        "pkg-5.5.4+1.21.11-fabric" = _BU0UkmCL;
        "pkg-5.5.4+1.21.1-fabric" = _mpRdx38V;
        "pkg-5.5.4+1.21.10-fabric" = _VLL1xQrt;
        "pkg-5.5.4+1.21.1-neoforge" = _2rttmNeD;
        "pkg-5.5.4+1.21.10-neoforge" = _gAZ8mQrk;
        "pkg-5.5.4+1.20.1-forge" = _mzh9tD4J;
        "pkg-5.5.4+1.21.11-neoforge" = _9nQJoofg;
        "pkg-5.5.4+1.21.5-neoforge" = _Bi2RgWjS;
        "pkg-5.5.4+1.21.6-fabric" = _Z8T5Zr0l;
        "pkg-5.5.4+1.21.5-fabric" = _ejLyCFPE;
        "pkg-5.5.4+1.21.6-neoforge" = _2PmFImaD;
        "pkg-5.5.5+1.21.1-neoforge" = _KdEqfLQ8;
        "pkg-5.5.5+1.20.1-forge" = _OmoAAL7V;
        "pkg-5.5.5+1.20.1-fabric" = _6cvUBwmm;
        "pkg-5.5.5+1.21.1-fabric" = _KZU513BT;
        "pkg-5.5.5+1.21.10-fabric" = _VB9dexpB;
        "pkg-5.5.5+1.21.10-neoforge" = _cJR1ewG5;
        "pkg-5.5.5+1.21.11-neoforge" = _cVAiBVGK;
        "pkg-5.5.5+1.21.11-fabric" = _6XjyvLiO;
        "pkg-5.5.5+1.21.6-fabric" = _Kaz8Gixz;
        "pkg-5.5.5+1.21.5-neoforge" = _JjfDa2M8;
        "pkg-5.5.5+1.21.5-fabric" = _lF3CQx6k;
        "pkg-5.5.5+1.21.6-neoforge" = _E97V0Or1;
        "pkg-5.5.5+1.21.7-neoforge" = _j5sMCK5o;
        "pkg-5.5.5+1.21.7-fabric" = _Dg3V7Inl;
        "pkg-5.5.5+1.21.8-neoforge" = _fH9TlG6R;
        "pkg-5.5.5+1.21.8-fabric" = _QWsoQ4h3;
        "pkg-5.5.5+26.1-fabric" = _h9sdOuJB;
        "pkg-5.5.5+26.1-neoforge" = _36zpzjXC;
        "pkg-5.5.6+1.21.1-neoforge" = _bI6gCzxR;
        "pkg-5.5.6+1.21.1-fabric" = _8lbJRpbu;
        "pkg-5.5.6+1.20.1-fabric" = _XHq8lNnL;
        "pkg-5.5.6+1.21.10-neoforge" = _8JTUBoOT;
        "pkg-5.5.6+1.21.10-fabric" = _qxUdI4i7;
        "pkg-5.5.6+1.21.11-fabric" = _59JraWAN;
        "pkg-5.5.6+1.20.1-forge" = _YypPbV9F;
        "pkg-5.5.6+1.21.11-neoforge" = _YHAZTXbW;
        "pkg-5.5.6+1.21.5-neoforge" = _6RTHWkjr;
        "pkg-5.5.6+1.21.6-neoforge" = _rcMPOBE6;
        "pkg-5.5.6+1.21.5-fabric" = _8ERO2ZjL;
        "pkg-5.5.6+1.21.7-fabric" = _45drMv41;
        "pkg-5.5.6+1.21.8-fabric" = _9gIHx0Us;
        "pkg-5.5.6+1.21.7-neoforge" = _pqTJ8jHB;
        "pkg-5.5.6+1.21.6-fabric" = _Y7wDD39e;
        "pkg-5.5.6+1.21.8-neoforge" = _czXocHmx;
        "pkg-5.5.6+26.1-fabric" = _X3EsCK2s;
        "pkg-5.5.6+26.1-neoforge" = _vdLpl0b5;
        "pkg-5.5.7-neoforge+1.21.1" = _8ucU4Wp5;
        "pkg-5.5.7-forge+1.20.1" = _Dqq0DEFl;
        "pkg-5.5.7-fabric+1.21.1" = _UASpMhc7;
        "pkg-5.5.7-fabric+1.20.1" = _yUntsHWl;
        "pkg-5.5.7-fabric+1.21.11" = _O9srWroE;
        "pkg-5.5.7-fabric+1.21.7" = _fsg5zGFY;
        "pkg-5.5.7-neoforge+1.21.7" = _nZqtKlII;
        "pkg-5.5.7-neoforge+1.21.11" = _u66tjhkE;
        "pkg-5.5.8-forge+1.20.1" = _bfN7SdL7;
        "pkg-5.5.8-neoforge+1.21.1" = _xdig7Fuc;
        "pkg-5.5.8-fabric+1.20.1" = _o0pwgWRs;
        "pkg-5.5.8-fabric+1.21.1" = _BKi737MT;
        "pkg-5.5.8-neoforge+1.21.11" = _MzG5aIfh;
        "pkg-5.5.8-fabric+1.21.11" = _xInNV1lB;
        "pkg-5.5.8-neoforge+1.21.7" = _xQxwUaG2;
        "pkg-5.5.8-fabric+1.21.7" = _uCLmADpO;
        "pkg-5.5.8-fabric+26.1.2" = _zP0opUHw;
        "pkg-5.5.8-neoforge+26.1.2" = _xV3Y85FJ;
        "pkg-5.5.9-neoforge+1.21.1" = _xbcRMKkA;
        "pkg-5.5.9-fabric+1.20.1" = _KYoRAjOS;
        "pkg-5.5.9-forge+1.20.1" = _njsiRpc9;
        "pkg-5.5.9-fabric+1.21.1" = _4Rz8PZTT;
        "pkg-5.5.9-neoforge+1.21.11" = _fEE9U4zz;
        "pkg-5.5.9-fabric+1.21.11" = _raRsDnCb;
        "pkg-5.5.9-neoforge+1.21.7" = _ibFRKpbs;
        "pkg-5.5.9-fabric+1.21.7" = _LLZCOAfs;
        "pkg-5.5.9-fabric+26.1.2" = _Q1gUwni4;
        "pkg-5.5.9-neoforge+26.1.2" = _hlGOnkDb;
        "pkg-5.5.10-fabric+1.20.1" = _4xspbKE8;
        "pkg-5.5.10-forge+1.20.1" = _qnuPcO0i;
        "pkg-5.5.10-fabric+1.21.1" = _2UvX7itQ;
        "pkg-5.5.10-neoforge+1.21.1" = _Mj0yzLol;
        "pkg-5.5.10-neoforge+1.21.11" = _62K1Pcql;
        "pkg-5.5.10-neoforge+1.21.7" = _e2oFb4PM;
        "pkg-5.5.10-fabric+1.21.7" = _WlRz5py5;
        "pkg-5.5.10-fabric+1.21.11" = _CXqmPrJ3;
        "pkg-5.5.10-fabric+26.1.2" = _tFoYLNpz;
        "pkg-5.5.10-neoforge+26.1.2" = _DM8t5tRm;
        "pkg-5.5.11-forge+1.20.1" = _Egeaix1D;
        "pkg-5.5.11-fabric+1.20.1" = _FyPrse9K;
        "pkg-5.5.11-neoforge+1.21.1" = _dj4URyg1;
        "pkg-5.5.11-fabric+1.21.1" = _EGHmpSOn;
        "pkg-5.5.11-neoforge+1.21.11" = _6ZMR1wuI;
        "pkg-5.5.11-fabric+1.21.11" = _6aU3QRY9;
        "pkg-5.5.11-fabric+1.21.7" = _nCpWVXAp;
        "pkg-5.5.11-neoforge+1.21.7" = _sYfU5MB1;
        "pkg-5.5.11-fabric+26.1.2" = _JT0AnYpk;
        "pkg-5.5.11-neoforge+26.1.2" = _225It52D;
        "pkg-5.6.0-neoforge+1.21.1" = _Rr57X6AU;
        "pkg-5.6.0-forge+1.20.1" = _wMbAj7GS;
        "pkg-5.6.0-fabric+1.20.1" = _RGyR8Sxy;
        "pkg-5.6.0-fabric+1.21.1" = _QBUob50e;
        "pkg-5.6.0-neoforge+1.21.11" = _imKbed6I;
        "pkg-5.6.0-fabric+1.21.11" = _M342qUAE;
        "pkg-5.6.0-fabric+1.21.7" = _X4VHgowy;
        "pkg-5.6.0-neoforge+1.21.7" = _TE1RTkMK;
        "pkg-5.6.0-fabric+26.1.2" = _RrZ02kGj;
        "pkg-5.6.0-neoforge+26.1.2" = _KcfH2tlW;
        "pkg-5.6.1-forge+1.20.1" = _IUdJsESh;
        "pkg-5.6.1-fabric+1.20.1" = _O5RevKh0;
        "pkg-5.6.1-fabric+1.21.1" = _QWbG2rEU;
        "pkg-5.6.1-neoforge+1.21.1" = _X6sjVVCp;
        "pkg-5.6.1-neoforge+1.21.11" = _Amjg7xnb;
        "pkg-5.6.1-fabric+1.21.11" = _1xrKxUtd;
        "pkg-5.6.1-fabric+1.21.7" = _uBjOTdDJ;
        "pkg-5.6.1-neoforge+1.21.7" = _ekBkmhu2;
        "pkg-5.6.1-fabric+26.1.2" = _gALboDMk;
        "pkg-5.6.1-neoforge+26.1.2" = _Vtb9B9QE;
        "pkg-5.6.2-fabric+1.20.1" = _Q3TP9RAM;
        "pkg-5.6.2-forge+1.20.1" = _rRjcR7ML;
        "pkg-5.6.2-fabric+1.21.1" = _kFZ6GBPK;
        "pkg-5.6.2-neoforge+1.21.1" = _YeA17QYY;
        "pkg-5.6.2-neoforge+1.21.11" = _gTeCsbgR;
        "pkg-5.6.2-fabric+1.21.11" = _VP1Bijnr;
        "pkg-5.6.2-fabric+1.21.7" = _zqGi6Xe6;
        "pkg-5.6.2-neoforge+1.21.7" = _byBB99B3;
        "pkg-5.6.2-fabric+26.1.2" = _9NrGmRnz;
        "pkg-5.6.2-neoforge+26.1.2" = _i6KmnCEM;
        "pkg-5.6.3-fabric+1.20.1" = _HM3mNOIi;
        "pkg-5.6.3-forge+1.20.1" = _7Upu1OD8;
        "pkg-5.6.3-fabric+1.21.1" = _p8YnQHOM;
        "pkg-5.6.3-neoforge+1.21.1" = _urjR23xu;
        "pkg-5.6.3-neoforge+1.21.11" = _fN8BNES8;
        "pkg-5.6.3-neoforge+1.21.7" = _zXrDqpDN;
        "pkg-5.6.3-fabric+1.21.11" = _1GBYz6QO;
        "pkg-5.6.3-fabric+1.21.7" = _FUiRUL8w;
        "pkg-5.6.3-fabric+26.1.2" = _8Ql9m6Hl;
        "pkg-5.6.3-neoforge+26.1.2" = _tkSphNfF;
        "pkg-5.7.0" = _6ZG2VaG4;
        "pkg-6.0.0-fabric+1.20.1" = _WDPYVMpA;
        "pkg-6.0.0-forge+1.20.1" = _phjVyCiz;
        "pkg-6.0.0-fabric+1.21.1" = _UVRma3Fj;
        "pkg-6.0.0-neoforge+1.21.1" = _JdBP9GPk;
        "pkg-6.0.0-fabric+1.21.7" = _VCCCfME7;
        "pkg-6.0.0-neoforge+1.21.7" = _5cIFIpLg;
        "pkg-6.0.0-fabric+1.21.11" = _NcO5V3On;
        "pkg-6.0.0-neoforge+1.21.11" = _M2SDCbyq;
        "pkg-6.0.0-fabric+26.1.2" = _psuh0WOV;
