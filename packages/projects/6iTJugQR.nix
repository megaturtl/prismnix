...
let
    versions = (let
        ...
        _Rk9Vg3PM = {
            "id" = "Rk9Vg3PM";
            "file" = "amendments-1.20-2.2.6-fabric.jar";
            "hash" = "sha512-NvcNWBLYeMeFfWSN5ATwlJP3WWobL1MvOwQWb2B66gFyPMsmhylnFBHGsC64Z3PLFADGA9Z/GuHLAkRLHmBwQQ==";
        };
        _nJORWvdh = {
            "id" = "nJORWvdh";
            "file" = "amendments-1.20-2.2.6.jar";
            "hash" = "sha512-fTXifGXXIQEc+dG0LjdjDku47d+H2k1DROyxzIZZauj3+4yUKjJ8evDyxNHYpvd+pVqT2HMSlc74N+Vai9uFAw==";
        };
        _vcAHAxqO = {
            "id" = "vcAHAxqO";
            "file" = "amendments-1.21-2.1.8-neoforge.jar";
            "hash" = "sha512-12FBSJyoRjp93eE8aOvq9r8FLVz6YA19osxmelwY7nPmc8YH+/9sLeChAztuNKNjhOWnND3ufIs5uJC5zAtABw==";
        };
        _YXEsUkGq = {
            "id" = "YXEsUkGq";
            "file" = "amendments-1.21-2.1.8-fabric.jar";
            "hash" = "sha512-jfviFvs8snAFX5BH5wJ7lLqTIx0Y7z3pdh3sKr1UE2QI0eteyoQdyvrgg8Owm9A9tWoUloDw8e2V6E70r4hZgg==";
        };
        _O8U6IzEM = {
            "id" = "O8U6IzEM";
            "file" = "amendments-1.21-2.1.9-fabric.jar";
            "hash" = "sha512-gZoOSrsTa/ZVVCwFUig4rNGJRJ+TCqD22fQ817DIxF/d1iiacIukCUJqPrF/0gaNsOUScQGOs3u6reyhxYVi7Q==";
        };
        _MwOPXSiF = {
            "id" = "MwOPXSiF";
            "file" = "amendments-1.21-2.1.9-neoforge.jar";
            "hash" = "sha512-TwxjDwFTKzjZwvJico8pI+O9/iLfoJlP86kEGZ3QCaOwNlHtuFanGmHDq2MTPHQQTtbsHvfFnyLaL9LHmfGU/A==";
        };
        _OYfMeeUK = {
            "id" = "OYfMeeUK";
            "file" = "amendments-1.21-2.1.10-neoforge.jar";
            "hash" = "sha512-m6HM7FE+k9usYVkBiFvezvgJiUlPPnRdr0GAmkUi5AYJ/NMP2udFaMiumPUqgWnS+smKJj0tO/3lXjrDJy8g6Q==";
        };
        _TuWUel70 = {
            "id" = "TuWUel70";
            "file" = "amendments-1.21-2.1.10-fabric.jar";
            "hash" = "sha512-K5eMhX6apq8GRxE3+0bGrfCPmrYXdz3aDsSZcWoZVJ5p504AeLadjB84TLhVd3CXTUPvslWmzY0drNj4mxSuMw==";
        };
    in {
        "piHq4eFz" = _piHq4eFz;
        "fRPMs6Kn" = _fRPMs6Kn;
        ...
        "forge-1.20.1" = _nJORWvdh;
        "forge-1.20.2" = _piHq4eFz;
        "forge-1.20.3" = _piHq4eFz;
        "forge-1.20.4" = _piHq4eFz;
        "fabric-1.20.1" = _Rk9Vg3PM;
        "fabric-1.21" = _4XziKHCP;
        "fabric-1.21.1" = _TuWUel70;
        "neoforge-1.21" = _8xf6Wpxs;
        "neoforge-1.21.1" = _OYfMeeUK;
        "pkg-1.20-1.0.6" = _piHq4eFz;
        "pkg-1.20-1.0.7" = _El6SZ8Ko;
        "pkg-1.20-1.0.8" = _LHa1Xl0X;
        "pkg-1.20-1.0.9" = _SRB8se29;
        "pkg-1.20-1.0.10" = _VwOzhEF3;
        "pkg-1.20-1.0.11" = _cy7saNlp;
        "pkg-1.20-1.0.12" = _AQ4TZYH4;
        "pkg-1.20-1.0.13" = _P0bgoivk;
        "pkg-1.20-1.0.14" = _UwvYypTr;
        "pkg-1.20-1.0.15" = _kpLUhE8n;
        "pkg-1.20-1.0.16" = _Yu2fHO4B;
        "pkg-1.20-1.0.17" = _hz304SRq;
        "pkg-1.20-1.1.0" = _9RlUOM3B;
        "pkg-1.20-1.1.1" = _fBkzWy9q;
        "pkg-1.20-1.1.3" = _N19Z42sv;
        "pkg-1.20-1.1.4" = _1o0Ya9zt;
        "pkg-1.20-1.1.5" = _5F4LP6mG;
        "pkg-1.20-1.1.6" = _xwjmBfiw;
        "pkg-1.20-1.1.7" = _9fYtRlWA;
        "pkg-1.20-1.1.8" = _MGBsppFD;
        "pkg-1.20-1.1.9" = _UEuteL0v;
        "pkg-1.20-1.1.10" = _y5UCiOzn;
        "pkg-1.20-1.1.11" = _gnp2tG07;
        "pkg-1.20-1.1.12" = _AaUYvmDY;
        "pkg-1.20-1.1.13" = _LCFdiwMX;
        "pkg-1.20-1.1.14" = _7WBMPKVL;
        "pkg-1.20-1.1.15" = _CQd7fxW3;
        "pkg-1.20-1.1.16" = _lOJvu1J6;
        "pkg-1.20-1.1.17" = _VIVqZDCs;
        "pkg-1.20-1.1.18" = _WOyMgawh;
        "pkg-1.20-1.1.19" = _5bKTv2XF;
        "pkg-1.20-1.1.20" = _xs0WjSqL;
        "pkg-1.20-1.1.21" = _jKiS5Dag;
        "pkg-1.20-1.1.22" = _aC0mHxqh;
        "pkg-1.20-1.1.23" = _Jnk4wCbm;
        "pkg-1.20-1.1.24" = _CgoXM8hy;
        "pkg-1.20-1.1.25" = _5G02SAkX;
        "pkg-1.20-1.1.26" = _DAjFbSa3;
        "pkg-1.20-1.1.27" = _VP4eAvpQ;
        "pkg-1.20-1.1.28" = _3w6XnW32;
        "pkg-1.20-1.1.29" = _E6f0dSTM;
        "pkg-1.20-1.1.30" = _5feDKrP4;
        "pkg-1.20-1.1.31" = _iFucsSea;
        "pkg-1.20-1.2.0" = _7ofOdu1X;
        "pkg-1.20-1.2.1" = _ubYg3yaX;
        "pkg-1.20-1.2.2" = _ygOSQ2qS;
        "pkg-1.20-1.2.3" = _QfmflHLE;
        "pkg-1.20-1.2.4" = _Bn6pXTB5;
        "pkg-1.20-1.2.5" = _t9cTGwLm;
        "pkg-1.20-1.2.6" = _TpZcYGgP;
        "pkg-1.20-1.2.7" = _AjjkDCjM;
        "pkg-1.20-1.2.8" = _rygiK2go;
        "pkg-1.20-1.2.9" = _4TKjbzcw;
        "pkg-1.20-1.2.10" = _ei9fVtIJ;
        "pkg-1.20-1.2.11" = _i0hLI4bR;
        "pkg-neoforge_1.21-1.2.10" = _Ph3wEIFM;
        "pkg-fabric_1.21-1.2.10" = _EceAXh1l;
        "pkg-fabric_1.21-1.2.11" = _TOrZSIA1;
        "pkg-neoforge_1.21-1.2.11" = _gaN7i5Qx;
        "pkg-fabric_1.21-1.2.12" = _Y18GqHEP;
        "pkg-neoforge_1.21-1.2.12" = _iwXc2Rxq;
        "pkg-fabric_1.21-1.2.14" = _4oFAlmeB;
        "pkg-neoforge_1.21-1.2.17" = _XN2eEJn1;
        "pkg-fabric_1.21-1.2.17" = _4k0IvKdm;
        "pkg-neoforge_1.21-1.2.18" = _fyi1rnvU;
        "pkg-fabric_1.21-1.2.18" = _RXEMeD71;
        "pkg-neoforge_1.21-1.2.19" = _Lnqify4R;
        "pkg-fabric_1.21-1.2.19" = _p6Jaq99z;
        "pkg-1.20-1.2.12" = _qE7sokDv;
        "pkg-1.20-1.2.14" = _1g60gHDB;
        "pkg-fabric_1.21-1.2.22" = _TI2xD2hw;
        "pkg-neoforge_1.21-1.2.22" = _dc5mf2fp;
        "pkg-1.20-1.2.16" = _ATt8FCvn;
        "pkg-1.20-1.2.17" = _SoFnwbSW;
        "pkg-1.20-1.2.18" = _zMu0Lu83;
        "pkg-neoforge_1.21-1.2.23" = _QwAJULPO;
        "pkg-fabric_1.21-1.2.23" = _nCY2LhbF;
        "pkg-neoforge_1.21-1.2.24" = _lbqEyGoA;
        "pkg-fabric_1.21-1.2.24" = _uSU0iJNb;
        "pkg-1.20-1.2.19" = _luR9kOmm;
        "pkg-1.20-2.0.0" = _io8Q0LQA;
        "pkg-1.20-2.0.1" = _wlEy1o9X;
        "pkg-1.20-2.0.2" = _T7jLFoGp;
        "pkg-1.20-2.0.3" = _QTkUx304;
        "pkg-1.20-2.0.4" = _rKgUOgkU;
        "pkg-1.20-2.0.5" = _aBFxXrqG;
        "pkg-1.20-2.0.6" = _FiZjjka3;
        "pkg-1.20-2.0.7" = _4v5cJnjh;
        "pkg-1.20-2.1.0" = _uRepeLV3;
        "pkg-1.20-2.1.1" = _kMDT4Uhw;
        "pkg-1.20-2.1.2" = _JUheh4Nk;
        "pkg-1.20-2.2.0" = _2XFOB4zg;
        "pkg-neoforge_1.21-2.0.0" = _KtQeZeOo;
        "pkg-fabric_1.21-2.0.0" = _3Cs5spw2;
        "pkg-fabric_1.21-2.0.1" = _4oZ3c1Vu;
        "pkg-neoforge_1.21-2.0.1" = _A20BuiXA;
        "pkg-neoforge_1.21-2.0.2" = _jPs2bg4k;
        "pkg-fabric_1.21-2.0.2" = _n23kKPO7;
        "pkg-neoforge_1.21-2.0.3" = _Y45eNLcU;
        "pkg-fabric_1.21-2.0.3" = _hOI5gFXl;
        "pkg-1.20-2.2.1" = _3iFSTYky;
        "pkg-fabric_1.21-2.0.4" = _1SThxKG6;
        "pkg-neoforge_1.21-2.0.4" = _Rha4iy6l;
        "pkg-fabric_1.21-2.0.5" = _dOqhEUGl;
        "pkg-neoforge_1.21-2.0.5" = _uZJvAxU7;
        "pkg-neoforge_1.21-2.0.6" = _IrriGxjH;
        "pkg-fabric_1.21-2.0.6" = _WOclo32w;
        "pkg-1.20-2.2.2" = _NCs7sRuH;
        "pkg-1.20-2.2.3" = _1J6dresa;
        "pkg-neoforge_1.21-2.0.7" = _N5pgrmrK;
        "pkg-fabric_1.21-2.0.7" = _Wq6a4SpE;
        "pkg-neoforge_1.21-2.0.8" = _i7GV5VYK;
        "pkg-fabric_1.21-2.0.8" = _OHFHFVWm;
        "pkg-1.21-2.0.9-neoforge" = _1sGIeJE4;
        "pkg-1.21-2.0.9-fabric" = _kd8d3xZQ;
        "pkg-1.21-2.0.10-neoforge" = _ngl76OWn;
        "pkg-1.21-2.0.10-fabric" = _MEehwcCk;
        "pkg-1.21-2.0.11-neoforge" = _LjQCXqBE;
        "pkg-1.21-2.0.11-fabric" = _xjFqNfUA;
        "pkg-1.21-2.0.12-neoforge" = _QRLArD2U;
        "pkg-1.21-2.0.12-fabric" = _TWCBnagJ;
        "pkg-1.21-2.0.13-fabric" = _74FJtGcV;
        "pkg-1.21-2.0.13-neoforge" = _uo2aSjsU;
        "pkg-1.21-2.0.14-neoforge" = _UluDQqs7;
        "pkg-1.21-2.0.14-fabric" = _JLF2RKGY;
        "pkg-1.20-2.2.4" = _hXdIFgoI;
        "pkg-1.21-2.0.15-neoforge" = _8xf6Wpxs;
        "pkg-1.21-2.0.15-fabric" = _4XziKHCP;
        "pkg-1.20-2.2.5" = _73W8UHX3;
        "pkg-1.21-2.1.1" = _BFwghM1f;
        "pkg-1.21-2.1.2" = _VgntmqM8;
        "pkg-1.21-2.1.3" = _vRJnsmaG;
        "pkg-1.21-2.1.4" = _7ASmn54d;
        "pkg-1.21-2.1.5" = _EQ3Bxbvq;
        "pkg-1.21-2.1.6" = _1RN3V13p;
        "pkg-1.21-2.1.7" = _eDkdvpvV;
        "pkg-1.20-2.2.6" = _nJORWvdh;
        "pkg-1.21-2.1.8" = _YXEsUkGq;
        "pkg-1.21-2.1.9" = _MwOPXSiF;
        "pkg-1.21-2.1.10" = _TuWUel70;
        "default" = _TuWUel70;
    });
