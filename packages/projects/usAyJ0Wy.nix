...
let
    ...
    in {
        ...
        "pkg-1.03-SNAPSHOT" = _XMx5UY58;
        "pkg-1.04-SNAPSHOT" = _ZjEdOQN7;
        "pkg-1.21-1.21.3" = _gVP13Ivl;
        "pkg-1.21.4" = _KLtMREBE;
        "pkg-1.21-1.21.3_1" = _bMUFi7ut;
        "pkg-1.21-1.21.3_2" = _PBuPs4Hv;
        "pkg-1.21.4_1" = _9iSUXVmc;
        "pkg-1.1-1.21.5" = _avF9cy6t;
        "pkg-1.1.1-1.21.5" = _D0s83i4Q;
        "pkg-1.1.2-1.21.5" = _AKBSCRps;
        "pkg-1.1.3-1.21.4" = _YBxED4Ff;
        "pkg-1.1.3-1.21.5" = _T6hVDGng;
        "pkg-1.1.4-1.21.4" = _8x2aLpDR;
        "pkg-1.1.4-1.21.5" = _s97LswzZ;
        "pkg-1.1.4-1.21.6" = _OdiPSeld;
        "pkg-1.1.4-1.21.7" = _cVBCdf4N;
        "pkg-1.1.5-1.21.4" = _a4KoKvah;
        "pkg-1.1.5-1.21.5" = _olRRJhrd;
        "pkg-1.1.5-1.21.6" = _iM1jQfwV;
        "pkg-1.1.5-1.21.7" = _gmEVR6RN;
        "pkg-1.1.5-1.21.8" = _eAKH9Qbs;
        "pkg-1.1.6-1.21.7" = _or0nfrmD;
        "pkg-1.1.5-1.21-1.21.3" = _4alRDE65;
        "pkg-1.1.7-1.21.8" = _SlWIjUaD;
        "pkg-1.1.8-1.21.8" = _QJAmfzFo;
        "pkg-1.1.8-1.21.10" = _T6aBGu7u;
        "pkg-1.1.8-1.21.9-10" = _OOVxLBdh;
        "pkg-1.1.9-1.21.8" = _TWhNfTJd;
        "pkg-1.1.9-1.21.9-10" = _YZDiydpp;
        "pkg-1.1.9-1.20.6" = _kuR6ncxH;
        "pkg-1.1.9-1.21-1.21.3" = _BCyBD77F;
        "pkg-1.1.9-1.20.1" = _H7M101jP;
        "pkg-1.1.9-1.21.11" = _Kxo2Alcw;
        "pkg-1.1.10-1.21.11" = _y9FR5xbd;
        "pkg-1.1.10-26.1" = _Uadj3HkW;
        "pkg-1.1.11-26.1.1" = _d5sekyQX;
        "pkg-1.1.12-1.21.11" = _Z8hfmkOU;
        "pkg-1.02" = _GOj8aQMu;
        "pkg-1.1.12-26.1.1" = _j4mv2VjM;
        "pkg-1.1.14-1.21.11" = _M3KKo1yj;
        "pkg-1.1.15-1.21.11" = _ANHZBeDQ;
        "pkg-1.1.15-26.1.2" = _xghH92Sa;
        "pkg-1.1.16-1.21.11" = _iAFCOhgd;
        "pkg-1.1.16-26.1.2" = _Q6GIqfW8;
        "pkg-1.1.17-1.21.11" = _RgDXBHYf;
        "pkg-1.1.17-26.1.2" = _qpCJIYnA;
        "pkg-1.03" = _Fj0d5GnA;
        "pkg-1.1.18-1.21.11" = _VzqPMRzd;
        "pkg-1.1.18-26.1.2" = _MXYURnHl;
        "pkg-1.04" = _kaJT9mkS;
        "pkg-1.1.19-1.21.11" = _BjyRL80b;
        "pkg-1.1.19-26.1.2" = _Td9Ke5ZU;
        "pkg-1.05" = _YrgZ1XQL;
        "pkg-1.06" = _8EAbclgh;
        "pkg-1.1.20-26.1.2" = _zjesWQRt;
        "pkg-1.1.21-26.1.2" = _skskrB5N;
        "pkg-1.07" = _ovkGsb01;
        "pkg-1.08" = _3e9rZ3Xy;
        "pkg-1.1.22-26.1.2" = _YIxPWgqt;
        "pkg-1.09" = _K17iaV0A;
        "pkg-1.1.23-26.1.2" = _ccrisq2U;
        "pkg-1.10" = _QaK7guqr;
        "pkg-1.1.24-26.1.2" = _19iH6m55;
        "pkg-1.11" = _FxQTEYWh;
        "pkg-1.1.25-26.1.2" = _TDPS2kvT;
        "pkg-1.12" = _YK45ojIO;
        "pkg-1.1.25-26.2" = _5WOYTJ3l;
        "pkg-1.1.26-26.2" = _IYB4LpUL;
        "pkg-1.1.26-26.1.2" = _ufTHiPN6;
        "pkg-1.14" = _VbFECFj3;
        "pkg-1.1.26-1.21.4" = _KEvBaXvy;
        "pkg-1.1.26-1.21.11" = _ZiNGRbGE;
        "pkg-1.1.26-1.21.1" = _jZPbqO89;
        "pkg-1.1.26-1.20.6" = _PQckarK1;
        "pkg-1.1.26-1.20.1" = _djegYX5v;
        "pkg-1.1.26-1.21.11-neoforge" = _HPVDemiY;
