...
let
    versions = (let
        ...
        _YBpSpXQU = {
            "id" = "YBpSpXQU";
            "file" = "immersiveores-1.21.3-1.1.9.jar";
            "hash" = "sha512-lXH/xuzEwgWo5xyaempkjV7h2k/IWFWA16b9MqwHTSI0JGwTdkutYzming7uLuz0Ozpkwievt9j5fai92kuuLg==";
        };
        _M35HMjJG = {
            "id" = "M35HMjJG";
            "file" = "immersiveores-1.21.1-1.1.9.jar";
            "hash" = "sha512-dD37UTb2/qs3JQdWUBgYP2v6Lrc7YOGEQzVfTh1Tshi4Gtgj9UPacdS9CK18RNuNq8qT0XxI1CciqLdf3k4tKA==";
        };
        _taT1vlsu = {
            "id" = "taT1vlsu";
            "file" = "immersiveores-1.21-1.1.9.jar";
            "hash" = "sha512-w9vwfauavRoVe3j0z+9E7eMnWb4m67g8gAVL+T5eOo7h3ZIqCVkwxJ0SZ+JNRcyipjFElVm4Rd7MC0dPsMONUA==";
        };
        _wDveNc11 = {
            "id" = "wDveNc11";
            "file" = "immersiveores-1.21-1.2.0.jar";
            "hash" = "sha512-8aN0gStynDxnmjKMreRRCBki6iH/5uaETJku4GZsz7oEUNmlSBNdQRnOTpCwE3yC0tX4KS0JKxan0Jcfhr98KA==";
        };
        _BjFlGZx7 = {
            "id" = "BjFlGZx7";
            "file" = "immersiveores-1.20.1-1.0.1.jar";
            "hash" = "sha512-XFqe94iRGUjBTRYUQknJEeEnUKikfC1BpgzjEhOKPeQ1Ti39ZtstfnurkvxUWwPQ4YAIH0J4FVWdsh0L/6qVJQ==";
        };
        _U0yQjltb = {
            "id" = "U0yQjltb";
            "file" = "immersiveores-1.21.1-1.2.0.jar";
            "hash" = "sha512-zdDkxY7kp4Fej6A1faA8WzP9amf8EFePdBdeOwW+SCVnXRp+qKWYNm7R3cXo7GhslE1EJAER0+nX1aIe6W7a6g==";
        };
        _lbOAg6Ia = {
            "id" = "lbOAg6Ia";
    ...
    in {
        ...
        "pkg-1.19.3-0.6" = _Mgkorxbt;
        "pkg-1.19.4-0.6" = _k8FZaDwi;
        "pkg-1.20-0.6" = _3oAMANQ7;
        "pkg-1.20.1-0.6" = _NaQRTM6Q;
        "pkg-1.20.2-0.3" = _qqYGCEKA;
        "pkg-1.19-0.3" = _Kc4ucId7;
        "pkg-1.19.1-0.3" = _5rW6U1sU;
        "pkg-1.19.2-0.3" = _aTJ8oglO;
        "pkg-1.19.3-0.3" = _v612WI1i;
        "pkg-1.19.4-0.3" = _MFMcK8KT;
        "pkg-1.20-0.3" = _9iD7uFNr;
        "pkg-1.20.1-0.3" = _be2sp2AR;
        "pkg-1.19-0.7" = _En8TPmMM;
        "pkg-1.19.1-0.7" = _lI7jIcqh;
        "pkg-1.19.2-0.7" = _3EnmhQri;
        "pkg-1.19.3-0.7" = _vs7GP411;
        "pkg-1.19.4-0.7" = _P3dwj2Df;
        "pkg-1.20-0.7" = _Z0HNWlF1;
        "pkg-1.20.1-0.7" = _NwEAtX5A;
        "pkg-1.20.2-0.7" = _kYUq8j2m;
        "pkg-1.19-0.4" = _TSlv5ypK;
        "pkg-1.19.1-0.4" = _UgsJuRoG;
        "pkg-1.19.2-0.4" = _Tzrl2wJD;
        "pkg-1.19.3-0.4" = _ercHIiDD;
        "pkg-1.19.4-0.4" = _1AbcQPx7;
        "pkg-1.20-0.4" = _SWQd5TnY;
        "pkg-1.20.1-0.4" = _D5dOzBrD;
        "pkg-1.20.2-0.4" = _kzSuwHk0;
        "pkg-1.19-0.5" = _48BHEiL3;
        "pkg-1.19.1-0.5" = _fVLyrVse;
        "pkg-1.19.2-0.5" = _QC0MsgKP;
        "pkg-1.19.3-0.5" = _kbHN75ZO;
        "pkg-1.19.4-0.5" = _e4TpBHg0;
        "pkg-1.20-0.5" = _DEXxlXNl;
        "pkg-1.20.1-0.5" = _WGWe6U54;
        "pkg-1.20.2-0.5" = _9tu7N8Jb;
        "pkg-1.21-0.1" = _xwcjKf0f;
        "pkg-1.21.1-0.1" = _O9e2BZMp;
        "pkg-1.21-0.2" = _hvxjV749;
        "pkg-1.21.1-0.2" = _yuIV3jw2;
        "pkg-1.21.3-0.1" = _FEelURx9;
        "pkg-1.21.4-0.1" = _MqesBXVe;
        "pkg-1.21.3-0.2" = _FlUp0Mk5;
        "pkg-1.21.4-0.2" = _l8DPiLv6;
        "pkg-1.21.3-0.3" = _hsQU0z23;
        "pkg-1.21.4-0.3" = _MaMuHBbL;
        "pkg-1.21.1-0.3" = _mCpP4oFu;
        "pkg-1.21-0.3" = _88AOqw4X;
        "pkg-1.21.4-0.4" = _rKdPB0VN;
        "pkg-1.21.3-0.4" = _FBasE0qD;
        "pkg-1.21.1-0.4" = _Un8hTT27;
        "pkg-1.21-0.4" = _wlLLlrFd;
        "pkg-1.21-0.5" = _HXUUXUez;
        "pkg-1.21.1-0.5" = _2VFWWkXX;
        "pkg-1.21.3-0.5" = _eoNKKT5t;
        "pkg-1.21.4-0.5" = _YBprQwel;
        "pkg-1.21-0.6" = _zaeBo4gt;
        "pkg-1.21.1-0.6" = _RtEOwZ0c;
        "pkg-1.21.3-0.6" = _YpH27Cgc;
        "pkg-1.21.4-0.6" = _XzRR2j4a;
        "pkg-1.21.3-0.7" = _gHYAuwHC;
        "pkg-1.21-0.7" = _Ss96ko59;
        "pkg-1.21.1-0.7" = _6heoo97R;
        "pkg-1.21.3-0.8" = _YdreEMxM;
        "pkg-1.21.4-0.7" = _hbT5GlcW;
        "pkg-1.21-0.8" = _IEmQ8CRi;
        "pkg-1.21.1-0.8" = _ylgqoZfN;
        "pkg-1.21.3-0.9" = _HsoYljgU;
        "pkg-1.21.4-0.8" = _BSQPt5nF;
        "pkg-1.21-0.9" = _FJgFjwlS;
        "pkg-1.21.1-0.9" = _zeDyNLML;
        "pkg-1.21.3-1.0" = _hyzLBVtd;
        "pkg-1.21.4-0.9" = _PqSI9Yvb;
        "pkg-1.21-1.0.0" = _CadWaiw0;
        "pkg-1.21.1-1.0.0" = _bSSJ133K;
        "pkg-1.21.3-1.0.1" = _nDm2Csyh;
        "pkg-1.21.4-1.0.0" = _c7VhZdaQ;
        "pkg-1.21.4-1.0.1" = _vRmiOroS;
        "pkg-1.21.3-1.0.0" = _WplXdcbI;
        "pkg-1.21.4-1.0.2" = _2JrCPxkR;
        "pkg-1.21.3-1.0.2" = _4LiSfuAD;
        "pkg-1.21.1-1.0.1" = _MLDAc3kt;
        "pkg-1.21-1.0.1" = _H5IHa4BV;
        "pkg-1.21.5-0.1" = _JF5DFbRG;
        "pkg-1.21.5-0.2" = _TAxf9qON;
        "pkg-1.21.5-0.3" = _OYChwRqf;
        "pkg-1.21.1-1.0.2" = _OYtfvlI7;
        "pkg-1.21-1.0.2" = _pkF9GK1F;
        "pkg-1.21.4-1.0.3" = _MJ17syzM;
        "pkg-1.21.3-1.0.3" = _ZQj5C1hq;
        "pkg-1.21.5-0.4" = _l6Fcy8Ep;
        "pkg-1.21.4-1.0.4" = _St3cpJ0g;
        "pkg-1.21.3-1.0.4" = _vVyvxEh4;
        "pkg-1.21.1-1.0.3" = _iKBbxpAP;
        "pkg-1.21-1.0.3" = _utFn4Z2C;
        "pkg-1.21-1.0.4" = _xJnvC3xj;
        "pkg-1.21.1-1.0.4" = _O6sNGUgI;
        "pkg-1.21.3-1.0.5" = _MleCrLH7;
        "pkg-1.21.4-1.0.5" = _Trx2hijw;
        "pkg-1.21.5-0.5" = _RJ5sTsuF;
        "pkg-1.21.3-1.0.6" = _wCY5oMJk;
        "pkg-1.21.1-1.0.5" = _HbJIuT4P;
        "pkg-1.21-1.0.5" = _RYAaLOgN;
        "pkg-1.21.5-0.6" = _rsDKWNoq;
        "pkg-1.21.4-1.0.6" = _a0qx9Qh3;
        "pkg-1.21.3-1.0.7" = _j5KkPadv;
        "pkg-1.21.1-1.0.6" = _tQpYdXFB;
        "pkg-1.21-1.0.6" = _FR2VRM5L;
        "pkg-1.21.5-0.7" = _C9LvoRSR;
        "pkg-1.21.4-1.0.7" = _5msSz9MK;
        "pkg-1.21.3-1.0.8" = _MbSRaXuC;
        "pkg-1.21.1-1.0.7" = _a4N7J5nZ;
        "pkg-1.21-1.0.7" = _O12LWHan;
        "pkg-1.21.5-0.8" = _ik0BOGhf;
        "pkg-1.21.5-0.9" = _UNLlqV1x;
        "pkg-1.21.1-1.0." = _BZJTm9z1;
        "pkg-1.21.4-1.0.8" = _HR0HAmU7;
        "pkg-1.21.3-1.0.9" = _6IwYQ0TY;
        "pkg-1.21.1-1.0.8" = _WfMNcWyH;
        "pkg-1.21-1.0.8" = _MvQK7AsI;
        "pkg-1.21.7-0.1" = _a0JG1oJS;
        "pkg-1.21.6-0.1" = _VOD2929p;
        "pkg-1.21.5-1.0.0" = _3CP6IDE6;
        "pkg-1.21.4-1.0.9" = _eGUvAFoA;
        "pkg-1.21.3-1.1.0" = _SJu6z9kv;
        "pkg-1.21.1-1.0.9" = _6VrcYjyI;
        "pkg-1.21-1.0.9" = _CJnmHqAO;
        "pkg-1.21.7-0.2" = _TjpHg1Nq;
        "pkg-1.21.6-0.2" = _X0UkyaCf;
        "pkg-1.21.5-1.0.1" = _IBqoEjms;
        "pkg-1.21.4-1.1.0" = _5FvVAWzM;
        "pkg-1.21.3-1.1.1" = _pYDefNwz;
        "pkg-1.21.1-1.1.0" = _Cksn7nDv;
        "pkg-1.21-1.1.0" = _6pDMb2WR;
        "pkg-1.21.7-0.3" = _wxYu5Gb9;
        "pkg-1.21.6-0.3" = _Cobcm6en;
        "pkg-1.21.5-1.0.2" = _dCVX6GLe;
        "pkg-1.21.4-1.1.1" = _gRVRBODD;
        "pkg-1.21.3-1.1.2" = _3takvJJd;
        "pkg-1.21.1-1.1.1" = _XY3cRMtm;
        "pkg-1.21-1.1.1" = _zNPbEDra;
        "pkg-1.21.7-0.4" = _PpogBlI9;
        "pkg-1.21.6-0.4" = _5Mvn6yNl;
        "pkg-1.21.5-1.0.3" = _e5iYDFiQ;
        "pkg-1.21.4-1.1.2" = _DRqyy14P;
        "pkg-1.21.3-1.1.3" = _G5Ajmpea;
        "pkg-1.21.1-1.1.2" = _fndmqGci;
        "pkg-1.21-1.1.2" = _HekPY6J2;
        "pkg-1.21.8-0.1" = _1ZLSxscB;
        "pkg-1.21.8-0.2" = _DrvtNBWi;
        "pkg-1.21.7-0.5" = _U3U02VOv;
        "pkg-1.21.6-0.5" = _TsQZBQP4;
        "pkg-1.21.5-1.0.4" = _9rBZjjUm;
        "pkg-1.21.8-0.3" = _EfwD4KQ2;
        "pkg-1.21.7-0.6" = _wUZWz7Rt;
        "pkg-1.21.6-0.6" = _qz432YeY;
        "pkg-1.21.5-1.0.5" = _dzy70VYt;
        "pkg-1.21.4-1.1.3" = _qvGj8qqU;
        "pkg-1.21.3-1.1.4" = _blRkjCBV;
        "pkg-1.21.1-1.1.3" = _FsaJqRK5;
        "pkg-1.21-1.1.3" = _AG9ZtFyv;
        "pkg-1.21.8-0.4" = _fnOPHhtU;
        "pkg-1.21.7-0.7" = _hAECGgCs;
        "pkg-1.21.6-0.7" = _7qPvHZBC;
        "pkg-1.21.5-1.0.6" = _b4dJZCRG;
        "pkg-1.21.3-1.1." = _CfWFY8VP;
        "pkg-1.21.4-1.1.4" = _iUO1V2Ol;
        "pkg-1.21.3-1.1.5" = _HlwNVa7E;
        "pkg-1.21.1-1.1.4" = _NhmYewzY;
        "pkg-1.21-1.1.4" = _4MuAEXda;
        "pkg-1.21.5-1.0.7" = _ELhh2Ypx;
        "pkg-1.21.6-0.8" = _7tTbqQx6;
        "pkg-1.21.7-0.8" = _pexXT2DT;
        "pkg-1.21.8-0.5" = _oZE6lpAb;
        "pkg-1.21.4-1.1.5" = _8IjRFHqf;
        "pkg-1.21.5-1.0.8" = _OVKUVFtG;
        "pkg-1.21.6-0.9" = _SJqe6dFS;
        "pkg-1.21.7-0.9" = _jWG3PKvD;
        "pkg-1.21.8-0.6" = _1DbiakIB;
        "pkg-1.21-1.1.5" = _y8KlYOzj;
        "pkg-1.21.1-1.1.5" = _fILIGRnj;
        "pkg-1.21.3-1.1.6" = _KLrkOBEc;
        "pkg-1.21.4-1.1.6" = _pl0ka3RL;
        "pkg-1.21.5-1.0.9" = _E5zLj87F;
        "pkg-1.21.6-1.0.0" = _QJlAzfKV;
        "pkg-1.21.7-1.0.0" = _FWvcMCfg;
        "pkg-1.21.8-0.7" = _jl9M9GWS;
        "pkg-1.21-1.1.6" = _pzf07AMu;
        "pkg-1.21.1-1.1.6" = _X2ROHCXK;
        "pkg-1.21.3-1.1.7" = _sOqsuuqX;
        "pkg-1.21.9-0.1" = _fyUR8r29;
        "pkg-1.21.10-0.1" = _GQknkEXX;
        "pkg-1.21.4-1.1.7" = _1pDqmkPS;
        "pkg-1.21.5-1.1.0" = _k5f08unY;
        "pkg-1.21.6-1.0.1" = _cebMh6XQ;
        "pkg-1.21.7-1.0.1" = _DlBwKX7O;
        "pkg-1.21.8-0.8" = _QN3RkPC2;
        "pkg-1.21.9-0.2" = _JIroS7Nk;
        ...
        "pkg-1.21.9-0.3" = _f8zNqwLV;
        "pkg-1.21.10-0.3" = _lG55l0fS;
        "pkg-1.20.1-0.9" = _GJZFA2wK;
        "pkg-1.21-1.1.8" = _PpnTZH69;
        "pkg-1.21.1-1.1.8" = _1fS38LY4;
        "pkg-1.21.3-1.1.9" = _YBpSpXQU;
        "pkg-1.21.11-0.1" = _rL9vSUR1;
        "pkg-26.1.2-0.1" = _Bj1VJRuc;
        "pkg-26.1.1-0.1" = _nYn6KnK6;
        "pkg-26.1-0.1" = _GJ1hRIgp;
