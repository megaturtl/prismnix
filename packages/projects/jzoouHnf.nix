...
let
    versions = (let
        ...
        _M8oNDZN3 = {
            "id" = "M8oNDZN3";
            "file" = "Player Corpses 3.7 [1.21.9+].zip";
            "hash" = "sha512-Qw5zPz9c+wONxZbBK1eeMsK+kHUEJl/gundMBt3fe8TPPdk/h+RQ/VEI/fb3biyBaATFbJmbzGcK7z0xhJ5RNw==";
        };
        _bEAcbslS = {
            "id" = "bEAcbslS";
            "file" = "player-death-corpses-3.7.jar";
            "hash" = "sha512-Edt5hjFuS2C/3LOlFkIkC4VsqmZgyhjkjKdhVErZm5a7keo1RRUugkpWEDt+Vo2zg6ZDNwLBUZ9K5BsyfuyCow==";
        };
    in {
        "cDdJOYc2" = _cDdJOYc2;
        "yfhz0UMu" = _yfhz0UMu;
        ...
        "datapack-1.21.9" = _M8oNDZN3;
        "datapack-1.21.10" = _M8oNDZN3;
        "datapack-25w42a" = _4hQaj0X3;
        "datapack-1.21.11" = _M8oNDZN3;
        "datapack-26.1" = _M8oNDZN3;
        "datapack-26.1.1" = _M8oNDZN3;
        "datapack-26.1.2" = _M8oNDZN3;
        "datapack-26.2" = _M8oNDZN3;
        "datapack-26.3" = _M8oNDZN3;
        "fabric-1.21.9" = _bEAcbslS;
        "fabric-1.21.10" = _bEAcbslS;
        "fabric-25w42a" = _onFbI4i3;
        "fabric-1.21.11" = _bEAcbslS;
        "fabric-26.1" = _bEAcbslS;
        "fabric-26.1.1" = _bEAcbslS;
        "fabric-26.1.2" = _bEAcbslS;
        "fabric-26.2" = _bEAcbslS;
        "fabric-26.3" = _bEAcbslS;
        "forge-1.21.9" = _bEAcbslS;
        "forge-1.21.10" = _bEAcbslS;
        "forge-25w42a" = _onFbI4i3;
        "forge-1.21.11" = _bEAcbslS;
        "forge-26.1" = _bEAcbslS;
        "forge-26.1.1" = _bEAcbslS;
        "forge-26.1.2" = _bEAcbslS;
        "forge-26.2" = _bEAcbslS;
        "forge-26.3" = _bEAcbslS;
        "neoforge-1.21.9" = _bEAcbslS;
        "neoforge-1.21.10" = _bEAcbslS;
        "neoforge-25w42a" = _onFbI4i3;
        "neoforge-1.21.11" = _bEAcbslS;
        "neoforge-26.1" = _bEAcbslS;
        "neoforge-26.1.1" = _bEAcbslS;
        "neoforge-26.1.2" = _bEAcbslS;
        "neoforge-26.2" = _bEAcbslS;
        "neoforge-26.3" = _bEAcbslS;
        "quilt-1.21.9" = _bEAcbslS;
        "quilt-1.21.10" = _bEAcbslS;
        "quilt-25w42a" = _onFbI4i3;
        "quilt-1.21.11" = _bEAcbslS;
        "quilt-26.1" = _bEAcbslS;
        "quilt-26.1.1" = _bEAcbslS;
        "quilt-26.1.2" = _bEAcbslS;
        "quilt-26.2" = _bEAcbslS;
        "quilt-26.3" = _bEAcbslS;
        "pkg-0.1" = _cDdJOYc2;
        "pkg-0.2" = _yfhz0UMu;
        "pkg-0.3" = _rj7bjEhK;
        "pkg-1.0" = _kuOSFi6D;
        ...
        "pkg-1.5" = _Ntw7p7Ij;
        "pkg-1.6" = _4hQaj0X3;
        "pkg-1.6+mod" = _mKYqswA3;
        "pkg-1.7" = _13J8qWyq;
        "pkg-1.7+mod" = _onFbI4i3;
        "pkg-1.8" = _dOAATZ6D;
        "pkg-1.8+mod" = _t18BmOSS;
        "pkg-1.9" = _oIOOGwp9;
        "pkg-1.9+mod" = _GLzRT9aF;
        "pkg-2.0" = _9k41uUzi;
        "pkg-2.0+mod" = _JiSxxUpl;
        "pkg-2.1" = _zjERNVwN;
        "pkg-2.1+mod" = _IrBGU6Fs;
        "pkg-2.2" = _PF1iATGY;
        "pkg-2.2+mod" = _JDiugYr2;
        "pkg-2.3" = _bp09dDUK;
        "pkg-2.3+mod" = _pl6oHFsr;
        "pkg-2.4" = _g6DB9htt;
        "pkg-2.4+mod" = _BBpkbqJ4;
        "pkg-2.5" = _FYQ2VNUC;
        "pkg-2.5+mod" = _JMlh1iJp;
        "pkg-2.6" = _8KGLGmVr;
        "pkg-2.6+mod" = _TRbmhGi9;
        "pkg-2.7" = _jKuojkUe;
        "pkg-2.7+mod" = _lBCJ2Toj;
        "pkg-2.8" = _IahYorE9;
        "pkg-2.8+mod" = _qgB6fI5E;
        "pkg-2.9" = _DrPxghp5;
        "pkg-2.9+mod" = _Ifm3QzMT;
        "pkg-3.0" = _uG8G3e1D;
        "pkg-3.0+mod" = _22dn7oeX;
        "pkg-3.1" = _p9A7eTPw;
        "pkg-3.1+mod" = _6RN885dj;
        "pkg-3.2" = _anFpAUqI;
        "pkg-3.2+mod" = _mtI9hOkO;
        "pkg-3.3" = _6Am4z9e0;
        "pkg-3.3+mod" = _aeNYcKf7;
        "pkg-3.4" = _MkhF4u4l;
        "pkg-3.4+mod" = _SSCUE0uk;
        "pkg-3.5" = _3BpQBWIx;
        "pkg-3.5+mod" = _bArECTps;
        "pkg-3.6" = _rKu5XKsr;
        "pkg-3.6+mod" = _z4aCQAVz;
        "pkg-3.7" = _M8oNDZN3;
        "pkg-3.7+mod" = _bEAcbslS;
        "default" = _bEAcbslS;
    });
