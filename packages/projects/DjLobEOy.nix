...
let
    ...
    in {
        ...
        "pkg-1.8.2" = _NpbTlN8o;
        "pkg-1.9.0" = _Fo2NkTLy;
        "pkg-1.9.0.1" = _5uzwIKXQ;
        "pkg-1.10.0" = _Lq5Fh7pd;
        "pkg-1.10.0.a" = _29tnv5Dv;
        "pkg-1.10.0.1" = _HkbknuHF;
        "pkg-1.10.2" = _qVV7t5bU;
        "pkg-1.11" = _ESRfqjkz;
        "pkg-1.11.1" = _avrYXbs7;
        "pkg-1.12" = _7ZwnSrVW;
        "pkg-1.12.0" = _rEz4FYC2;
        "pkg-1.12.1" = _e5a9WzpA;
        "pkg-1.12.1.1" = _bwfVhUnU;
        "pkg-1.12.2" = _EP09dj1p;
        "pkg-1.13.1" = _vZlrPBae;
        "pkg-1.13.2" = _MntMLupc;
        "pkg-1.13.3" = _wF6xyXMX;
        "pkg-1.13.5" = _HEqgNPcC;
        "pkg-1.13.6" = _xnrWcaYL;
