...
let
    versions = (let
        ...
        _V7e6CI1s = {
            "id" = "V7e6CI1s";
            "file" = "vinurl-2.6.0+mc26.2.jar";
            "hash" = "sha512-YYvG0sG184+PFZAnW9KOUjZhPocdR78VhrAAPDvJnMyY/l1ZEGXvPjxm1yANXydDS/p4H2MgEszZPWz9T9JXtA==";
        };
    in {
        "Tg1dAWiP" = _Tg1dAWiP;
        "ug7EjrZu" = _ug7EjrZu;
        ...
        "pkg-1.2.1" = _E2yyEAIs;
        "pkg-1.2.2" = _ZZJ4nBZ8;
        "pkg-1.2.3+1.21.1-fabric" = _YuK8nUKE;
        "pkg-1.2.3+1.21.1-neoforge" = _tCFMxnMh;
        "pkg-1.2.3+1.21.4-fabric" = _hwVwujv8;
        "pkg-1.3.0+1.21.1-fabric" = _9XGBGXsS;
        "pkg-1.3.0+1.21.1-neoforge" = _Hmcq2ofh;
        "pkg-1.3.0+1.21.4-fabric" = _fszyfiow;
        "pkg-1.4.0+1.21.1-fabric" = _ZOl7DzDT;
        "pkg-1.4.0+1.21.1-neoforge" = _mK52JIUN;
        "pkg-1.4.0+1.21.4-fabric" = _WjxWxn0M;
        "pkg-1.5.0+1.21.1-fabric" = _6ctfJoqh;
        "pkg-1.5.0+1.21.1-neoforge" = _NcYqStfY;
        "pkg-1.6.0+1.21.1-fabric" = _J2lgFu1o;
        "pkg-1.6.0+1.21.1-neoforge" = _d6jrvet5;
        "pkg-1.6.0+1.21.4-fabric" = _fIKHuYbP;
        "pkg-1.6.1+1.21.1-fabric" = _3C8DhCnm;
        "pkg-1.6.1+1.21.1-neoforge" = _mPkvlZML;
        "pkg-1.6.1+1.21.4-fabric" = _7G6rIPF2;
        "pkg-1.6.2+1.21.1-fabric" = _MlADMbRs;
        "pkg-1.6.2+1.21.1-neoforge" = _LmrMrpZj;
        "pkg-1.6.2+1.21.4-fabric" = _fKezvnmj;
        "pkg-1.7.0+1.21.1-fabric" = _DBUby4Wx;
        "pkg-1.7.0+1.21.1-neoforge" = _gf67hh7d;
        "pkg-1.7.0+1.21.4-fabric" = _Afm7pxtC;
        "pkg-1.7.1+1.21.1-fabric" = _zxdhjWoR;
        "pkg-1.7.1+1.21.1-neoforge" = _tsQSnctK;
        "pkg-1.7.1+1.21.4-fabric" = _Al6xBI25;
        "pkg-1.8.0+1.21.1-fabric" = _J86PHczM;
        "pkg-1.8.0+1.21.1-neoforge" = _tBxY2E3H;
        "pkg-1.8.0+1.21.4-fabric" = _TMPfosal;
        "pkg-1.8.0+1.20.1-fabric" = _OuphPxEM;
        "pkg-2.0.0+1.21.1-fabric" = _FMDZ57nG;
        "pkg-2.0.0+1.21.1-neoforge" = _pd2tiGUd;
        "pkg-2.0.0+1.21.4-fabric" = _lu6zQrYC;
        "pkg-2.0.0+1.20.1-fabric" = _ktBAns9r;
        "pkg-2.1.0+1.21.1-fabric" = _DlxIv2HM;
        "pkg-2.1.0+1.21.1-neoforge" = _Bo4ULso9;
        "pkg-2.1.0+1.21.4-fabric" = _NRB89h4i;
        "pkg-2.1.0+1.20.1-fabric" = _j7Tovi6b;
        "pkg-2.1.1+1.21.1-fabric" = _slqUOOx2;
        "pkg-2.1.1+1.21.1-neoforge" = _iduxdbsK;
        "pkg-2.1.1+1.21.4-fabric" = _uCywAXvm;
        "pkg-2.1.1+1.20.1-fabric" = _OYIJyBR1;
        "pkg-2.2.0+1.21.1-fabric" = _aIGyu92a;
        "pkg-2.2.0+1.21.1-neoforge" = _YHJcHvb1;
        "pkg-2.2.0+1.21.3-fabric" = _FUghYznv;
        "pkg-2.2.0+1.21.4-fabric" = _Opj4EzNV;
        "pkg-2.2.0+1.21.5-fabric" = _PFOGXyXX;
        "pkg-2.2.0+1.21.8-fabric" = _yyIVwwRX;
        "pkg-2.2.0+1.21.10-fabric" = _86BUVtYe;
        "pkg-2.2.1+1.21.1-fabric" = _mEgzUGes;
        "pkg-2.2.1+1.21.1-neoforge" = _Z0aQfjJW;
        "pkg-2.2.1+1.21.3-fabric" = _qDpDAO7n;
        "pkg-2.2.1+1.21.4-fabric" = _KR2O3QH6;
        "pkg-2.2.1+1.21.5-fabric" = _9SnFTkv4;
        "pkg-2.2.1+1.21.8-fabric" = _mnZB7Nu8;
        "pkg-2.2.1+1.21.10-fabric" = _8rs5eNdx;
        "pkg-2.2.1+1.21.11-fabric" = _Nd1yX9ep;
        "pkg-2.3.0+1.21.1-fabric" = _7miV5XPm;
        "pkg-2.3.0+1.21.1-neoforge" = _5NlvMz3w;
        "pkg-2.3.0+1.21.3-fabric" = _CbfNRRiz;
        "pkg-2.3.0+1.21.5-fabric" = _F3PURi9W;
        "pkg-2.3.0+1.21.4-fabric" = _6OoG5ddL;
        "pkg-2.3.0+1.21.8-fabric" = _jBXgbTuG;
        "pkg-2.3.0+1.21.10-fabric" = _pYV624bq;
        "pkg-2.3.0+1.21.11-fabric" = _2fqfxH7T;
        "pkg-2.3.0+26.1-fabric" = _AinwJJKy;
        "pkg-2.4.0+1.21.1-fabric" = _wSmU8NVx;
        "pkg-2.4.0+1.21.1-neoforge" = _imWigm0o;
        "pkg-2.4.0+1.21.3-fabric" = _2vExxlkG;
        "pkg-2.4.0+1.21.4-fabric" = _DZyq3WgQ;
        "pkg-2.4.0+1.21.5-fabric" = _iDc72Nu7;
        "pkg-2.4.0+1.21.8-fabric" = _R4Tdpluf;
        "pkg-2.4.0+1.21.10-fabric" = _ck23WO8a;
        "pkg-2.4.0+1.21.11-fabric" = _qHKe23jk;
        "pkg-2.4.0+26.1-fabric" = _Vz8duIDg;
        "pkg-2.5.0+1.21.1-fabric" = _qZjLHIOw;
        "pkg-2.5.0+1.21.1-neoforge" = _ACAibUG6;
        "pkg-2.5.0+1.21.3-fabric" = _5LPMohTx;
        "pkg-2.5.0+1.21.4-fabric" = _MqH88663;
        "pkg-2.5.0+1.21.5-fabric" = _MYuKnHSO;
        "pkg-2.5.0+1.21.8-fabric" = _qEGXikSm;
        "pkg-2.5.0+1.21.10-fabric" = _3XMxcGlq;
        "pkg-2.5.0+1.21.11-fabric" = _QXmbuS1n;
        "pkg-2.5.0+26.1-fabric" = _nUenVku3;
        "pkg-2.6.0+1.21.1-fabric" = _LzyNim32;
        "pkg-2.6.0+1.21.1-neoforge" = _VPrh5CCo;
        "pkg-2.6.0+1.21.3-fabric" = _LjKKPrAk;
        "pkg-2.6.0+1.21.4-fabric" = _ciFaEUh9;
        "pkg-2.6.0+1.21.5-fabric" = _jzuL6mlm;
        "pkg-2.6.0+1.21.8-fabric" = _oUA22jOF;
        "pkg-2.6.0+1.21.10-fabric" = _je1B5r0L;
        "pkg-2.6.0+1.21.11-fabric" = _brBqeAvG;
        "pkg-2.6.0+26.1-fabric" = _myqNwplT;
        "pkg-2.6.0+26.2-fabric" = _V7e6CI1s;
        "default" = _V7e6CI1s;
    });
