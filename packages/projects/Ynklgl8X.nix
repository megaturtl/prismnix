...
let
    ...
    in {
        ...
        "pkg-fabric-1.20.1-2.0" = _m76NCAPn;
        "pkg-neo-1.21.1-2.0" = _8M2THcqj;
        "pkg-fabric-1.21.1-2.0" = _6YdJDzeT;
        "pkg-forge-1.20.1-2.1" = _fWYmFaLP;
        "pkg-fabric-1.20.1-2.1" = _dQlSrpNF;
        "pkg-neo-1.21.1-2.1" = _HeLJatY7;
        "pkg-fabric-1.21.1-2.1" = _Ce8aMg1I;
        "pkg-forge-1.20.1-2.2" = _1Pm583M8;
        "pkg-fabric-1.20.1-2.2" = _3nJuFalT;
        "pkg-neo-1.21.1-2.2" = _PIvzWRSY;
        "pkg-fabric-1.21.1-2.2" = _foiDmltn;
        "pkg-forge-1.20.1-3.0" = _cb2kheNB;
        "pkg-fabric-1.20.1-3.0" = _dRPpNh9e;
        "pkg-neo-1.21.1-3.0" = _NkkOYu2b;
        "pkg-fabric-1.21.1-3.0" = _KxgEPdAW;
        "pkg-forge-1.20.1-3.1" = _WknSCFcC;
        "pkg-fabric-1.20.1-3.1" = _htVgl9r8;
        "pkg-neo-1.21.1-3.1" = _CruEsz6X;
        "pkg-fabric-1.21.1-3.1" = _q80nwFy8;
        "pkg-neo-1.21.11-3.1" = _Dkl241i7;
        "pkg-fabric-1.21.11-3.1" = _coqlCYox;
        "pkg-neo-26.1-3.1" = _1B4kxZrb;
        "pkg-fabric-26.1-3.1" = _7YbwfaAK;
        "pkg-fabric-1.20.1-3.1.1" = _KUpQ093u;
        "pkg-fabric-1.21.1-3.1.1" = _1IGRoArx;
        "pkg-forge-1.20.1-3.2.0" = _OdMT2LO9;
        "pkg-fabric-1.20.1-3.2.0" = _xUv5csJp;
        "pkg-neo-1.21.1-3.2.0" = _gbRIPDRZ;
        "pkg-fabric-1.21.1-3.2.0" = _zRE9vUJ7;
