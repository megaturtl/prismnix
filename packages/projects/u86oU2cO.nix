...
let
    ...
    in {
        ...
        "pkg-1.18.1-1.0.3" = _lfqJwVoL;
        "pkg-1.18.1-1.0.4" = _RZAPn3qH;
        "pkg-1.18.1-1.0.5" = _EMGuxl9B;
        "pkg-1.16.5-1.0.0" = _PuBJ084Y;
        "pkg-1.17.1-1.0.0" = _zwpzy5Hm;
        "pkg-1.18.1-1.0.6" = _aLBIhUiQ;
        "pkg-1.18.1-1.1.0" = _L8ptRBRw;
        "pkg-1.18.1-1.1.1" = _vbZV1LRx;
        "pkg-1.18.1-1.2.0" = _TxXgesdt;
        "pkg-1.18.1-1.2.1" = _lBiIDbvI;
        "pkg-1.18.1-1.2.2" = _c8ttTE7X;
        "pkg-1.18.2-1.3.0" = _UEgMHtSG;
        "pkg-1.18.2-1.4.0" = _dkAuX6yz;
        "pkg-1.18.2-1.4.1" = _GkScgDzM;
        "pkg-1.18.2-1.4.2" = _Z5eQbmam;
        "pkg-1.19-2.0.0" = _vT88NtPc;
        "pkg-1.19-2.0.1" = _yqIU41uc;
        "pkg-1.19-2.0.2" = _Jm4XHg9Y;
        "pkg-1.19.1-2.1.0" = _YQFPV3Eb;
        "pkg-1.19.1-2.1.1" = _U9isj08v;
        "pkg-1.19.1-2.1.2" = _7NF9teJO;
        "pkg-1.19.4-2.2.0" = _R9XjhMob;
        "pkg-1.20.1-3.1.0" = _2ejA8Afh;
        "pkg-1.20.1-3.1.1" = _GZ9QNR3i;
        "pkg-1.21-4.0.0" = _J0WWSgK7;
        "pkg-1.20.1-3.1.2" = _xscXZ320;
        "pkg-1.21-4.0.1" = _b4004voS;
        "pkg-1.20.1-3.1.3" = _5PZQ49Vu;
        "pkg-1.21-4.0.2" = _Yc9Rdxn9;
        "pkg-1.21-4.0.3" = _B7Q1t8Z1;
        "pkg-1.20.1-3.1.4" = _dfpVs0VT;
        "pkg-1.21.3-4.1.0" = _afA5IoNK;
        "pkg-1.21-4.0.4" = _uhc65BTg;
        "pkg-21.7.0" = _4gLYgV8g;
        "pkg-21.9.0" = _pIqVZrPi;
        "pkg-21.9.1" = _M3MvZkTg;
        "pkg-21.7.1" = _nru7aKPd;
        "pkg-21.9.2" = _7L5NUBdL;
        "pkg-1.21.3-4.1.3" = _y21SKf7C;
        "pkg-1.21-4.0.5" = _eZZHHpvd;
        "pkg-1.21.3-4.1.4" = _2N3qPspf;
        "pkg-21.7.2" = _HNwMOdSQ;
        "pkg-21.9.3" = _zCWrtuXy;
        "pkg-1.21-4.0.6" = _FkPLDOAf;
        "pkg-1.21.3-4.1.5" = _TTKVa91f;
        "pkg-21.7.3" = _Jpf02E8Q;
        "pkg-21.9.4" = _8AItd6cK;
        "pkg-21.11.0" = _Ar5T32pb;
        "pkg-1.21-4.0.7" = _1eG2G9Qc;
        "pkg-1.21.3-4.1.6" = _ZyHsE7rj;
        "pkg-21.7.4" = _ZMwVOiUP;
        "pkg-21.11.1" = _XqLCdDUq;
        "pkg-21.9.5" = _Ay9HWBUa;
        "pkg-1.21-4.0.8" = _RbmCtKi2;
        "pkg-1.21.3-4.1.7" = _YmnylO6t;
        "pkg-1.20.1-3.1.5" = _O3wgNyjZ;
        "pkg-21.7.5" = _E64cvsZi;
        "pkg-21.9.6" = _MiacD1PQ;
        "pkg-21.11.2" = _ZuoSrRti;
        "pkg-26.1.0" = _bwxdStru;
        "pkg-26.1.1" = _xpr1D48y;
