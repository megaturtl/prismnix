...
let
    versions = (let
        ...
        _8Ph4OFyN = {
            "id" = "8Ph4OFyN";
            "file" = "inventoryessentials-fabric-1.20.1-8.2.19.jar";
            "hash" = "sha512-TtSAdS/KD+xz4u4SS5XsJV5/1UmmRFnorA5F5XcGMW3ouAhXtb62N1tuVrzp7B/lrV7QbRfPG6xxmoih4G2AAQ==";
        };
        _ydMbZRv1 = {
            "id" = "ydMbZRv1";
            "file" = "inventoryessentials-fabric-26.1.2-26.1.2.5.jar";
            "hash" = "sha512-XO794E32WF6vgV7p1cPX3EDz7gyQgITqtMC92rJh8/dCZGu7IavSjE72X5bMh/a1CFL1EkCARTCKrkqRcivVnQ==";
        };
        _MofH1nU6 = {
            "id" = "MofH1nU6";
            "file" = "inventoryessentials-fabric-26.2-26.2.0.4.jar";
            "hash" = "sha512-50zdLyYAHd887CnTEeel6VVBIKwu/qFK/6PMJpDhjscT2dYeFgBMPJ6oxKQZrK8EHV2uMdse+rTe/Q3K3eA/nQ==";
        };
        _ziSJxtpV = {
            "id" = "ziSJxtpV";
            "file" = "inventoryessentials-neoforge-26.1.2-26.1.2.5.jar";
            "hash" = "sha512-LvdW92lPG9upSS7e8GOi0Jk1u96Q97IV3sMPpzxNzVTp1eygIfxT6WrXY0UojAfJPezPfpJpjkA3sTLoGAPpfQ==";
        };
        _uxCrp3LR = {
            "id" = "uxCrp3LR";
            "file" = "inventoryessentials-neoforge-26.2-26.2.0.4.jar";
            "hash" = "sha512-/5Br9m5EC0Brxao17I51PgEcCA1jGS+kaE8seB43bXcZ+351LqvW0XwfHtRJyDikyU6ROrv8sRoU3Y2KHnNr8w==";
        };
        _ZFRf70mt = {
            "id" = "ZFRf70mt";
            "file" = "inventoryessentials-fabric-1.21.1-21.1.18.jar";
            "hash" = "sha512-gAfq8TjvdsNywVoQoQ65WGZ+Cz/8OWCzF2ut4TC9BCbeatGH0M7CcQ7/f2Qbz8XE0KP/qvSWks3UH8zAOBqmuw==";
        };
        _yXrTheEG = {
            "id" = "yXrTheEG";
            "file" = "inventoryessentials-forge-1.21.1-21.1.18.jar";
            "hash" = "sha512-x0BhuqjkztYiPYGvRIO9Pg/iohpGcX32ABLeYQVV55k/Iir5d4iEcMZq1iw4fNVVEBse1XyCgJR1WIhgJBsjPQ==";
        };
        _kSYg2mEh = {
            "id" = "kSYg2mEh";
            "file" = "inventoryessentials-neoforge-1.21.1-21.1.18.jar";
            "hash" = "sha512-fA4buCuyjqMQ6yjivwH7RLNR2FbmyfXKpE1Q5vimYl6SgY9oGRcUx2ckTML0j0pHifnd8ylUILu+5C2RSNboTQ==";
        };
        _BhuVHyaA = {
            "id" = "BhuVHyaA";
    ...
    in {
        ...
        "fabric-1.20" = _8Ph4OFyN;
        "fabric-1.20.1" = _8Ph4OFyN;
        ...
        "pkg-4.0.2+fabric-1.18.2" = _Mb2H5kiP;
        "pkg-6.0.0+fabric-1.19.3" = _GgboLVZ1;
        "pkg-6.0.0+forge-1.19.3" = _5bBK4kBC;
        "pkg-5.0.1+fabric-1.19" = _T1xppYnd;
        "pkg-5.0.1+forge-1.19" = _U04ihNtQ;
        "pkg-4.0.3+fabric-1.18.2" = _MuIEKp2S;
        "pkg-4.0.3+forge-1.18.2" = _QGAiEYcR;
        "pkg-5.0.2+forge-1.19" = _xDvKbEhw;
        "pkg-5.0.2+fabric-1.19" = _affoRKoi;
        "pkg-6.0.1+fabric-1.19.3" = _X1eYdTbT;
        "pkg-6.0.1+forge-1.19.3" = _aOZpEPpI;
        "pkg-7.0.1+forge-1.19.4" = _Hp5PybJZ;
        "pkg-7.0.1+fabric-1.19.4" = _Xn6HIl5u;
        "pkg-8.0.0+fabric-1.20" = _zjHwasp6;
        "pkg-8.0.0+forge-1.20" = _xtvEA1dN;
        "pkg-8.1.0+fabric-1.20.1" = _jrXiJQMT;
        "pkg-8.1.0+forge-1.20.1" = _HC3nUQaZ;
        "pkg-5.4.0+forge-1.19.2" = _cRTkO1l6;
        "pkg-5.4.0+fabric-1.19.2" = _P1zemQtN;
        "pkg-8.2.0+fabric-1.20.1" = _sKaQolsQ;
        "pkg-8.2.0+forge-1.20.1" = _tTL1tO3G;
        "pkg-8.2.1+fabric-1.20.1" = _KN08crcd;
        "pkg-8.2.1+forge-1.20.1" = _qRfRBQBE;
        "pkg-9.0.0+fabric-1.20.2" = _K81SThl2;
        "pkg-9.0.0+forge-1.20.2" = _KOhB5E94;
        "pkg-9.0.1+fabric-1.20.2" = _2NqKT97A;
        "pkg-9.0.1+forge-1.20.2" = _gr1uM5Xg;
        "pkg-9.0.1+neoforge-1.20.2" = _dGEvlIEE;
        "pkg-10.0.1+fabric-1.20.4" = _UvLpxuXQ;
        "pkg-10.0.1+forge-1.20.4" = _fiZQxe27;
        "pkg-10.0.1+neoforge-1.20.4" = _KT706vCn;
        "pkg-10.0.2+forge-1.20.4" = _uTkW6wWg;
        "pkg-10.0.2+fabric-1.20.4" = _TVwLfr96;
        "pkg-10.0.2+neoforge-1.20.4" = _NTD0SqrT;
        "pkg-10.0.3+fabric-1.20.4" = _hH1zmqdy;
        "pkg-10.0.3+forge-1.20.4" = _qRQ8lMGw;
        "pkg-10.0.3+neoforge-1.20.4" = _UAIKsYwb;
        "pkg-8.2.3+fabric-1.20.1" = _CrBrnf2c;
        "pkg-8.2.3+forge-1.20.1" = _4z2MZiJq;
        "pkg-10.0.4+fabric-1.20.4" = _81glPVsY;
        "pkg-10.0.4+forge-1.20.4" = _72A5bYdd;
        "pkg-10.0.4+neoforge-1.20.4" = _zCCNL9Wk;
        "pkg-11.0.1+fabric-1.20.6" = _4r2F7fr5;
        "pkg-11.0.1+forge-1.20.6" = _1dic4UyQ;
        "pkg-11.0.1+neoforge-1.20.6" = _ZMGwwh8W;
        "pkg-11.0.2+fabric-1.20.6" = _sPDULn2H;
        "pkg-11.0.2+forge-1.20.6" = _gDyWQiSS;
        "pkg-11.0.2+neoforge-1.20.6" = _J7SlRr9U;
        "pkg-8.2.5+fabric-1.20.1" = _oEhOEqmF;
        "pkg-8.2.5+forge-1.20.1" = _VjIf6FLq;
        "pkg-11.0.3+fabric-1.20.6" = _5NVPu65K;
        "pkg-8.2.6+fabric-1.20.1" = _x8WdvVS5;
        "pkg-11.0.3+forge-1.20.6" = _SO2CRy39;
        "pkg-8.2.6+forge-1.20.1" = _GPre26r4;
        "pkg-11.0.3+neoforge-1.20.6" = _medGEIyd;
        "pkg-21.0.1+fabric-1.21" = _Ga1bCtMN;
        "pkg-21.0.1+forge-1.21" = _eAahffca;
        "pkg-21.0.1+neoforge-1.21" = _7MqHxOuV;
        "pkg-21.0.2+fabric-1.21" = _gt8qbYFq;
        "pkg-21.0.2+forge-1.21" = _uI1BgZVB;
        "pkg-21.0.2+neoforge-1.21" = _Hv4nzjGG;
        "pkg-21.1.1+fabric-1.21.1" = _eLighWTI;
        "pkg-21.1.1+forge-1.21.1" = _LYBXEJgE;
        "pkg-21.1.1+neoforge-1.21.1" = _xlKgFkAZ;
        "pkg-21.3.1+fabric-1.21.3" = _bOQW1avi;
        "pkg-21.3.1+neoforge-1.21.3" = _LitMIL1T;
        "pkg-21.3.2+fabric-1.21.3" = _6InL8l3Z;
        "pkg-21.4.1+fabric-1.21.4" = _hDg8NyPb;
        "pkg-21.4.1+neoforge-1.21.4" = _fZbakLFQ;
        "pkg-21.4.2+forge-1.21.4" = _QkSkOEgH;
        "pkg-8.2.7+fabric-1.20.1" = _O2l5Il01;
        "pkg-8.2.7+forge-1.20.1" = _wDu3YDC6;
        "pkg-21.1.2+fabric-1.21.1" = _P9P9R5jy;
        "pkg-21.4.3+fabric-1.21.4" = _ZI6QIfgg;
        "pkg-21.1.2+forge-1.21.1" = _lKwKodWJ;
        "pkg-21.4.3+neoforge-1.21.4" = _mShojq9m;
        "pkg-21.1.2+neoforge-1.21.1" = _wfZHdNT1;
        "pkg-21.4.3+forge-1.21.4" = _OAiBIsOQ;
        "pkg-21.5.1+neoforge-1.21.5" = _rrAZIvRg;
        "pkg-21.5.1+fabric-1.21.5" = _W1W11TcO;
        "pkg-21.5.2+forge-1.21.5" = _mefzQinz;
        "pkg-21.6.1+fabric-1.21.6" = _8e4eQiV5;
        "pkg-21.6.1+neoforge-1.21.6" = _X9fYXW9U;
        "pkg-21.6.2+forge-1.21.6" = _1tXOKibS;
        "pkg-21.7.1+neoforge-1.21.7" = _OPvEukcQ;
        "pkg-21.7.1+fabric-1.21.7" = _gJt3ru8V;
        "pkg-21.7.1+forge-1.21.7" = _ie0ajE2U;
        "pkg-21.1.3+fabric-1.21.1" = _mmRKNRlW;
        "pkg-21.1.3+neoforge-1.21.1" = _UM7tCzZg;
        "pkg-8.2.8+fabric-1.20.1" = _PlThrkVQ;
        "pkg-21.1.3+forge-1.21.1" = _mGaQ2jDY;
        "pkg-8.2.8+forge-1.20.1" = _cTEq5KLy;
        "pkg-21.4.4+fabric-1.21.4" = _p1WyF5bj;
        "pkg-21.4.4+forge-1.21.4" = _HHIlLAk7;
        "pkg-21.7.2+fabric-1.21.7" = _gFLpQPG3;
        "pkg-21.4.4+neoforge-1.21.4" = _u32i1EGi;
        "pkg-21.7.2+forge-1.21.7" = _s8To0rHz;
        "pkg-21.5.3+fabric-1.21.5" = _ri2gKn1w;
        "pkg-21.5.3+forge-1.21.5" = _99NPb6nk;
        "pkg-21.7.2+neoforge-1.21.7" = _73y2fenX;
        "pkg-21.5.3+neoforge-1.21.5" = _mqsa8GU3;
        "pkg-21.8.1+fabric-1.21.8" = _7dBpQRGY;
        "pkg-21.8.1+forge-1.21.8" = _3GEooXiq;
        "pkg-21.8.1+neoforge-1.21.8" = _FMvLKNpJ;
        "pkg-21.1.4+fabric-1.21.1" = _Vw1PKmjW;
        "pkg-8.2.9+fabric-1.20.1" = _gpCMmu3Z;
        "pkg-21.1.4+forge-1.21.1" = _mdnk6ACg;
        "pkg-21.1.4+neoforge-1.21.1" = _ySoA0qVT;
        "pkg-8.2.9+forge-1.20.1" = _JZ0TmTUd;
        "pkg-21.4.5+forge-1.21.4" = _aSEdHNog;
        "pkg-21.4.5+fabric-1.21.4" = _QQtpAYuC;
        "pkg-21.5.4+forge-1.21.5" = _3jHZRKUv;
        "pkg-21.4.5+neoforge-1.21.4" = _4hwbNdmU;
        "pkg-21.5.4+fabric-1.21.5" = _yZo18QP4;
        "pkg-21.5.4+neoforge-1.21.5" = _chduiQyG;
        "pkg-21.8.2+fabric-1.21.8" = _RebPtUPU;
        "pkg-21.8.2+forge-1.21.8" = _9JuglUpn;
        "pkg-21.8.2+neoforge-1.21.8" = _gF0a2V1J;
        "pkg-21.1.5+fabric-1.21.1" = _YKGYvp3m;
        "pkg-21.1.5+forge-1.21.1" = _DGCw8Vrz;
        "pkg-21.1.5+neoforge-1.21.1" = _3vF5fNBC;
        "pkg-21.8.3+fabric-1.21.8" = _tVVXMzvy;
        "pkg-21.8.3+forge-1.21.8" = _k0iM9WTF;
        "pkg-21.4.6+fabric-1.21.4" = _DaleySzF;
        "pkg-21.4.6+forge-1.21.4" = _gjj9yE9L;
        "pkg-21.8.3+neoforge-1.21.8" = _PgBPNZgv;
        "pkg-21.4.6+neoforge-1.21.4" = _DNNc2YGs;
        "pkg-21.5.5+fabric-1.21.5" = _8DUgmVIh;
        "pkg-21.5.5+forge-1.21.5" = _XNMwfQkX;
        "pkg-21.5.5+neoforge-1.21.5" = _VJJ0if6a;
        "pkg-8.2.10+fabric-1.20.1" = _GsXG3AZQ;
        "pkg-8.2.10+forge-1.20.1" = _q55VTkY6;
        "pkg-21.1.6+forge-1.21.1" = _PSflTJxr;
        "pkg-21.1.6+fabric-1.21.1" = _KizUsMIW;
        "pkg-21.8.4+forge-1.21.8" = _wa8Kfavh;
        "pkg-21.8.4+fabric-1.21.8" = _wWFlP8Pw;
        "pkg-21.1.6+neoforge-1.21.1" = _Z5Q4xccV;
        "pkg-21.8.4+neoforge-1.21.8" = _CDDy7TgX;
        "pkg-8.2.11+fabric-1.20.1" = _bljQ1uTq;
        "pkg-8.2.11+forge-1.20.1" = _cxh1q73q;
        "pkg-8.2.12+fabric-1.20.1" = _Dw5MpfbC;
        "pkg-21.1.7+fabric-1.21.1" = _srh0ccMG;
        "pkg-21.1.7+forge-1.21.1" = _uzrXEirI;
        "pkg-21.1.7+neoforge-1.21.1" = _jwhkbA0s;
        "pkg-8.2.12+forge-1.20.1" = _w32qwykm;
        "pkg-21.8.5+fabric-1.21.8" = _4jQ68obL;
        "pkg-21.8.5+forge-1.21.8" = _HbuZTmV1;
        "pkg-21.8.5+neoforge-1.21.8" = _HgOsz4UN;
        "pkg-21.9.1+neoforge-1.21.9" = _ISDLeu62;
        "pkg-21.9.1+fabric-1.21.9" = _vP8bL6Ud;
        "pkg-21.9.2+fabric-1.21.9" = _Gfo0jNRO;
        "pkg-21.9.2+neoforge-1.21.9" = _jPw4UHwm;
        "pkg-21.10.1+fabric-1.21.10" = _akTDOlpD;
        "pkg-21.10.1+neoforge-1.21.10" = _YAnO4kX9;
        "pkg-21.10.1+forge-1.21.10" = _e1LPrEEH;
        "pkg-21.10.2+fabric-1.21.10" = _rUcvmBIg;
        "pkg-21.10.2+neoforge-1.21.10" = _jIVCDjcH;
        "pkg-8.2.13+fabric-1.20.1" = _7coHAD57;
        "pkg-8.2.13+forge-1.20.1" = _2C5GL0ow;
        "pkg-21.10.2+forge-1.21.10" = _X3bsyKtM;
        "pkg-21.1.8+neoforge-1.21.1" = _KX42TncH;
        "pkg-21.1.8+forge-1.21.1" = _p2zet50p;
        "pkg-21.1.8+fabric-1.21.1" = _yxdMEKHs;
        "pkg-21.1.9+fabric-1.21.1" = _nqoIrt9D;
        "pkg-21.1.9+neoforge-1.21.1" = _NaLfKNRB;
        "pkg-21.1.9+forge-1.21.1" = _DnNitEJL;
        "pkg-8.2.14+fabric-1.20.1" = _d1SkxFX3;
        "pkg-21.10.3+fabric-1.21.10" = _uHseJiGy;
        "pkg-8.2.14+forge-1.20.1" = _DONY3Y4W;
        "pkg-21.10.3+neoforge-1.21.10" = _gnTYbpRf;
        "pkg-21.10.3+forge-1.21.10" = _BL3T2J7I;
        "pkg-21.10.4+fabric-1.21.10" = _pSNZxXbK;
        "pkg-21.10.4+forge-1.21.10" = _9M40FSls;
        "pkg-21.10.4+neoforge-1.21.10" = _E7O832pl;
        "pkg-21.1.10+fabric-1.21.1" = _FduKfxOn;
        "pkg-21.1.10+neoforge-1.21.1" = _57AeBwoL;
        "pkg-21.1.10+forge-1.21.1" = _cTLhyfOE;
        "pkg-21.11.1+neoforge-1.21.11" = _ThVe0qjx;
        "pkg-21.11.1+fabric-1.21.11" = _Izex9tkz;
        "pkg-21.10.5+fabric-1.21.10" = _BnDmwHX3;
        "pkg-21.10.5+forge-1.21.10" = _WDXoDgWr;
        "pkg-21.10.5+neoforge-1.21.10" = _WpvNLS0v;
        "pkg-21.1.12+fabric-1.21.1" = _KsH499zo;
        "pkg-21.1.12+forge-1.21.1" = _c2dPIp0R;
        "pkg-21.1.12+neoforge-1.21.1" = _wGMyQg0Q;
        "pkg-21.11.3+fabric-1.21.11" = _faTkVRfB;
        "pkg-21.11.3+forge-1.21.11" = _bLtX1MWR;
        "pkg-21.11.3+neoforge-1.21.11" = _Ps5V0K36;
        "pkg-21.11.4+fabric-1.21.11" = _jASHw0No;
        "pkg-21.11.4+neoforge-1.21.11" = _O1zd2C8Y;
        "pkg-21.11.4+forge-1.21.11" = _Tvx1GlzZ;
        "pkg-21.1.13+fabric-1.21.1" = _ikvRPieS;
        "pkg-21.1.13+neoforge-1.21.1" = _8x3l5ykM;
        "pkg-21.1.13+forge-1.21.1" = _GaznmKde;
        "pkg-21.11.5+fabric-1.21.11" = _9VYHFaRj;
        "pkg-21.11.5+forge-1.21.11" = _LBmH8dCn;
        "pkg-21.11.5+neoforge-1.21.11" = _mdpNXmB2;
        "pkg-26.1.0.1+fabric-26.1" = _BijwElJg;
        "pkg-26.1.0.1+neoforge-26.1" = _qydJnB5L;
        "pkg-26.1.0.2+neoforge-26.1" = _pom8g4yX;
        "pkg-26.1.0.2+fabric-26.1" = _2D07qlwJ;
        "pkg-21.1.14+fabric-1.21.1" = _VlYIHGnU;
        "pkg-21.1.14+neoforge-1.21.1" = _MVsaPKmO;
        "pkg-21.1.14+forge-1.21.1" = _sobSAxv7;
        "pkg-8.2.15+fabric-1.20.1" = _1nQDbsSZ;
        "pkg-8.2.15+forge-1.20.1" = _xdHmO10R;
        "pkg-26.1.2.1+fabric-26.1.2" = _kXwGDlvc;
        "pkg-26.1.2.1+neoforge-26.1.2" = _tGdXW2U8;
        "pkg-26.1.2.2+fabric-26.1.2" = _8sx6gfD5;
        "pkg-26.1.2.2+neoforge-26.1.2" = _SNvXaQVm;
        "pkg-8.2.16+fabric-1.20.1" = _lUyPBRLS;
        "pkg-21.1.15+fabric-1.21.1" = _AJaxRrDp;
        "pkg-8.2.16+forge-1.20.1" = _nueoaqGL;
        "pkg-21.1.15+neoforge-1.21.1" = _u2c95ldv;
        "pkg-21.1.15+forge-1.21.1" = _JZ3D2CBv;
        "pkg-26.2.0.1+fabric-26.2" = _KEbliJ73;
        "pkg-26.2.0.1+neoforge-26.2" = _K15khsI8;
        "pkg-8.2.17+fabric-1.20.1" = _7tKVZQf3;
        "pkg-26.2.0.2+fabric-26.2" = _IihazjQS;
        "pkg-26.2.0.2+neoforge-26.2" = _nr86wKh0;
        "pkg-26.1.2.3+fabric-26.1.2" = _8YAhMN1V;
        "pkg-26.1.2.3+neoforge-26.1.2" = _uUms3wpC;
        "pkg-8.2.17+forge-1.20.1" = _gAwAxBNT;
        "pkg-21.1.16+fabric-1.21.1" = _uO6cIlIP;
        "pkg-21.1.16+neoforge-1.21.1" = _xvtHxBJD;
        "pkg-21.1.16+forge-1.21.1" = _MsS6XX6Z;
        "pkg-8.2.18+fabric-1.20.1" = _ov8TTAwC;
        "pkg-8.2.18+forge-1.20.1" = _lymlfcUI;
        "pkg-21.1.17+fabric-1.21.1" = _eBm7B7uF;
        "pkg-21.1.17+neoforge-1.21.1" = _7oG8uNtJ;
        "pkg-21.1.17+forge-1.21.1" = _VHp5U2q2;
        "pkg-26.1.2.4+fabric-26.1.2" = _aIrdPgeW;
        "pkg-26.1.2.4+neoforge-26.1.2" = _yIg4QTS4;
        "pkg-26.2.0.3+neoforge-26.2" = _nRC6iNZP;
        "pkg-26.2.0.3+fabric-26.2" = _wKop0ZCj;
        "pkg-8.2.19+fabric-1.20.1" = _8Ph4OFyN;
        "pkg-26.1.2.5+fabric-26.1.2" = _ydMbZRv1;
        "pkg-26.2.0.4+fabric-26.2" = _MofH1nU6;
        "pkg-26.1.2.5+neoforge-26.1.2" = _ziSJxtpV;
        "pkg-26.2.0.4+neoforge-26.2" = _uxCrp3LR;
        "pkg-21.1.18+fabric-1.21.1" = _ZFRf70mt;
