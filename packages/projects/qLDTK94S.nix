...
let
    ...
    in {
        ...
        "pkg-forge-1.19.1-1.0.0" = _jhNzlZbj;
        "pkg-forge-1.19.2-1.0.0" = _IknHd3Ju;
        "pkg-forge-1.19.2-1.0.1" = _qDhFrePV;
        "pkg-forge-1.19.3-1.0.1" = _6CXVFCiK;
        "pkg-forge-1.19.3-1.0.2" = _uaASH6MQ;
        "pkg-forge-1.19.3-1.0.3" = _khKDQTil;
        "pkg-forge-1.19.4-1.0.3" = _cGTuNaU6;
        "pkg-forge-1.20.1-1.0.4" = _tEdNDaf4;
        "pkg-forge-1.20.1-1.0.5" = _jL88s5dJ;
        "pkg-forge-1.20.1-1.0.6" = _NGC53fhI;
        "pkg-forge-1.20.2-1.0.6" = _TDLTUzP5;
        "pkg-neoforge-1.20.2-1.0.6" = _q4F7UYpS;
        "pkg-neoforge-1.20.2-1.0.7" = _uDNAcJVK;
        "pkg-neoforge-1.20.3-1.0.7" = _VoLzSuQq;
        "pkg-neoforge-1.20.4-1.0.7" = _tYiPNKU9;
        "pkg-forge-1.19.2-1.0.8" = _kZTOPQPY;
        "pkg-forge-1.20.1-1.0.8" = _NIIYR3S8;
        "pkg-neoforge-1.20.4-1.0.8" = _L1MHDHAO;
        "pkg-neoforge-1.20.5-1.0.8" = _5Bk6vQEA;
        "pkg-neoforge-1.20.6-1.0.8" = _ajJsNii7;
        "pkg-neoforge-1.21-1.0.8" = _Jj1EtgKP;
        "pkg-neoforge-1.21-1.0.9" = _UaFGsjoz;
        "pkg-neoforge-1.21.1-1.0.9" = _on4BF8L9;
        "pkg-neoforge-1.21.1-1.0.10" = _cBje7QZ8;
        "pkg-neoforge-1.21.1-1.1.0" = _OUf1KvMp;
        "pkg-neoforge-1.21.1-1.2.0" = _WWDNqwzD;
        "pkg-neoforge-1.21.1-1.2.1" = _V1kUfEdn;
        "pkg-neoforge-1.21.1-1.2.2" = _wk2o4xzJ;
        "pkg-neoforge-1.21.1-1.3.0" = _MNwC9PcQ;
        "pkg-neoforge-1.21.1-1.3.1" = _rRt4b13U;
        "pkg-neoforge-1.21.1-1.3.2" = _clb2MfWC;
        "pkg-neoforge-1.21.1-1.3.3" = _q849az8R;
        "pkg-neoforge-1.21.1-1.4.0" = _uN9ORVp0;
        "pkg-neoforge-1.21.1-1.4.1" = _soJVbUQg;
        "pkg-neoforge-1.21.1-1.4.2" = _oTiFVkEi;
        "pkg-neoforge-1.21.1-1.4.3" = _Jm7mZHPD;
        "pkg-neoforge-1.21.1-1.5.0" = _FGD8VFq8;
        "pkg-neoforge-1.21.1-1.5.1" = _LeK15Rpq;
        "pkg-neoforge-1.21.1-1.5.2" = _tow3EHbF;
        "pkg-neoforge-1.21.1-1.5.3" = _mjKWBADD;
        "pkg-neoforge-1.21.1-1.5.4" = _k0udM00P;
        "pkg-neoforge-1.21.1-1.5.5" = _r9cNkxGw;
        "pkg-neoforge-1.21.2-1.5.5" = _PkXUm4SC;
        "pkg-neoforge-1.21.3-1.5.5" = _BSTvat2o;
        "pkg-neoforge-1.21.4-1.5.5" = _f65hcQTc;
        "pkg-neoforge-1.21.5-1.5.5" = _qSsukePk;
        "pkg-neoforge-1.21.6-1.5.5" = _N2en8A5o;
        "pkg-neoforge-1.21.6-1.5.6" = _woC4XlIX;
        "pkg-neoforge-1.21.6-1.5.7" = _oOf8zV8M;
        "pkg-neoforge-1.21.7-1.5.7" = _5Y6hP92I;
        "pkg-neoforge-1.21.7-1.5.8" = _ekI31Aj7;
        "pkg-neoforge-1.21.8-1.5.8" = _sHC0kRUU;
        "pkg-neoforge-1.21.9-1.5.8" = _BnnasxOt;
        "pkg-neoforge-1.21.10-1.5.8" = _utPLhVaR;
        "pkg-neoforge-1.21.11-1.5.8" = _XpM221OB;
        "pkg-neoforge-1.5.8+26.1" = _gZlXLjGF;
