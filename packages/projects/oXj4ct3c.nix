...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.19.2" = _yXHOAb2B;
        "pkg-1.0.0+1.19.4" = _Nrq3d2wj;
        "pkg-1.0.0+1.20.1" = _OuBRHkGW;
        "pkg-1.0.1+1.18.2" = _gAYvwJhr;
        "pkg-1.0.1+1.19.2" = _RBwPuOqf;
        "pkg-1.0.1+1.20.1" = _T9unEpCo;
        "pkg-1.0.1+1.16.5" = _o1uprXYH;
        "pkg-1.0.1-1+1.17.1" = _e3wziQCs;
        "pkg-1.1.0+1.19.2" = _KqviPrp8;
        "pkg-1.1.0+1.20.1" = _y3QV65P8;
        "pkg-1.1.1+1.19.2" = _PfqNZLu7;
        "pkg-1.1.1" = _bIKkiyNB;
        "pkg-1.2.0" = _S4nb99nw;
        "pkg-1.2.0+1.20.1" = _ABw58pbC;
        "pkg-1.3.0" = _YkNahinx;
        "pkg-1.1.2+1.17.1" = _ZcNCtpsE;
        "pkg-1.1.2+1.18.2" = _tq5oazCP;
        "pkg-1.3.0+1.19.2" = _vKMDckEX;
        "pkg-1.1.2+1.16.x" = _tMha3gkK;
        "pkg-1.4.0" = _y7sysHXC;
        "pkg-1.5.0" = _5spMoysu;
        "pkg-1.5.0+1.21.3" = _cXDApUiF;
        "pkg-1.5.0+1.21.5" = _utSa8NIc;
        "pkg-1.5.0-beta.1+neo" = _mCiZLWg4;
