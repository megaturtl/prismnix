...
let
    ...
    in {
        ...
        "pkg-1.8.2" = _jxsFtML2;
        "pkg-1.9.0" = _FMF3yzCR;
        "pkg-1.9.0+1.20.2" = _KrTss88l;
        "pkg-1.9.1" = _pOCYcZUF;
        "pkg-1.9.0+1.20.4" = _giebTOyU;
        "pkg-1.9.1+1.20.3" = _teGodXxG;
        "pkg-1.9.1+1.20.2" = _Vt7ls0pO;
        "pkg-1.1.0" = _3JQQCViD;
        "pkg-1.0.0+b" = _douonZQK;
        "pkg-0.8.0+f" = _WswrXhsm;
        "pkg-0.5.0+c" = _LIWEWgbC;
        "pkg-1.9.2+1.20.1" = _KAmTaDGR;
        "pkg-1.9.2+1.20.2" = _EvZkNyaK;
        "pkg-1.9.2+1.20.4" = _ji7wRvVK;
        "pkg-1.9.3" = _HwGHderf;
        "pkg-1.9.4+1.20.1" = _LjDXTyEn;
        "pkg-1.9.4+1.20.2" = _skZ5rNJe;
        "pkg-1.9.4+1.20.4" = _HcfMgmXT;
        "pkg-1.9.5+1.20.5" = _378nQU71;
        "pkg-1.10.0+1.21" = _4CjXUG8M;
        "pkg-1.10.1+1.21" = _8epcb6KE;
        "pkg-1.10.0+1.20.1" = _iJgIcrpM;
        "pkg-1.10.0+1.20.2" = _bVrDz2ZC;
        "pkg-1.10.0+1.20.4" = _pxOy3RA2;
        "pkg-1.10.0+1.20.5" = _gKWHIy4U;
        "pkg-1.10.1+1.21.3" = _bSDlSTqh;
        "pkg-1.10.1+1.20.1" = _k0t6DSmw;
        "pkg-1.10.1+1.20.2" = _Wv7IH5i0;
        "pkg-1.10.1+1.20.4" = _xEANmLMj;
        "pkg-1.10.1+1.20.5" = _aMMNePbZ;
        "pkg-1.10.2+1.21" = _O1zeCf5e;
        "pkg-1.10.2+1.21.3" = _vmAQCAgU;
        "pkg-1.10.3+1.21.4" = _ulqahyBw;
        "pkg-1.10.3+1.21.3" = _Hnq6cK9z;
        "pkg-1.10.3+1.21" = _wn088QdG;
        "pkg-1.10.4+1.21.4" = _W2ejzkCE;
        "pkg-1.11.0+1.21" = _VgtNc4Rg;
        "pkg-1.11.0+1.21.3" = _ksuZqKfh;
        "pkg-1.11.0+1.21.4" = _Oxj0KnG2;
        "pkg-1.11.0+1.21.5" = _goZ9pCqI;
        "pkg-1.11.0+1.21.7" = _nlktqbhs;
        "pkg-1.11.1+1.21.7" = _8pjCeA4P;
        "pkg-1.12.0+1.21.10" = _u11Ud0Wp;
        "pkg-1.12.1+1.21.10" = _GbhhJVlg;
        "pkg-1.12.2+1.21.10" = _kF47yag9;
        "pkg-1.11.1+1.21" = _cCWAPoWg;
        "pkg-1.11.1+1.21.3" = _olFEgaep;
        "pkg-1.11.1+1.21.4" = _G3JDSfxM;
        "pkg-1.11.1+1.21.5" = _OFt3Whk2;
        "pkg-1.11.2+1.21.7" = _r7czIunL;
        "pkg-1.12.3-beta.1+1.21.11" = _anBMyD22;
        "pkg-1.12.3+1.21.11" = _eEkO3jAC;
        "pkg-1.13.0-beta.1+26.1" = _8Ljz633l;
        "pkg-1.13.0+26.1" = _vHpNM3O1;
        "pkg-1.13.1+26.1" = _9yM7N4pQ;
        "pkg-1.13.2+26.1" = _cGYasuau;
        "pkg-1.13.3+26.2" = _8TkGmrgl;
        "pkg-1.13.3+26.1" = _wpMVyDNf;
        "pkg-1.11.2+1.21" = _CrvsDgLW;
        "pkg-1.11.2+1.21.3" = _n7vQoJyx;
