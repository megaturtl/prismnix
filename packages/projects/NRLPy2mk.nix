...
let
    versions = (let
        ...
        _N0M0VgNy = {
            "id" = "N0M0VgNy";
            "file" = "globalpacks-neoforge-26.3-26.3.1.jar";
            "hash" = "sha512-4i2lO4Nv5Ql4iS3SVsl0GINiNnBu7u/NpqujESJ4NhnXCSBSOhzycZoOlzYDkRJxnCdsiUJxn7whUY2gZUxsTg==";
        };
        _YlmosWaf = {
            "id" = "YlmosWaf";
            "file" = "globalpacks-fabric-26.3-26.3.1.jar";
            "hash" = "sha512-Pnod/4n24+U9eMTK9V91l79pHImiT2bpxK4mfmspu1AB/b5ndmcmE6TIc1SyPceaI4UNIRXya0yr/PzTP4WVhQ==";
        };
    in {
        "cMpUD7s0" = _cMpUD7s0;
        "2excvX5H" = _2excvX5H;
        ...
        "neoforge-26.3" = _N0M0VgNy;
        "pkg-1.12.2+forge" = _cMpUD7s0;
        "pkg-1.12.2.1_quilt" = _2excvX5H;
        "pkg-1.12.2.1_fabric" = _YbcIVI4A;
        "pkg-1.13_quilt" = _jWjIsFVG;
        "pkg-1.13_fabric" = _yj7VcE8L;
        "pkg-1.13_forge" = _RMZuNEoF;
        "pkg-1.13.1_forge" = _tnzTYLu0;
        "pkg-1.14_fabric" = _jaHQPkNE;
        "pkg-1.14_quilt" = _TMDw7JnU;
        "pkg-1.14_forge" = _VLGQilbn;
        "pkg-1.14.1_fabric" = _nQoecrl5;
        "pkg-1.14.1_quilt" = _3fpqlbqs;
        "pkg-1.14.1_forge" = _L2Zu3Wwx;
        "pkg-1.12.2.2_fabric" = _GOS17kxb;
        "pkg-1.12.2.2_quilt" = _hre6LvhR;
        "pkg-1.12.2.2_forge" = _jLPAXiha;
        "pkg-1.14.2_fabric" = _eq60ZCOB;
        "pkg-1.14.2_quilt" = _WgYpoYxI;
        "pkg-1.14.2_forge" = _LJa7xibr;
        "pkg-1.12.3_fabric" = _4MkNWArr;
        "pkg-1.12.3_quilt" = _9jSxCZur;
        "pkg-1.12.3_forge" = _80ZfHhEH;
        "pkg-1.14.3_fabric" = _ZOgwGl7J;
        "pkg-1.14.3.1_fabric" = _S4SALf7m;
        "pkg-1.15_fabric" = _pIhEx0e3;
        "pkg-1.15_quilt" = _LanF7JuO;
        "pkg-1.15_forge" = _c1gILgvf;
        "pkg-1.15.1_forge" = _acP7sOfy;
        "pkg-1.15.2_fabric" = _1AE1EPaJ;
        "pkg-1.15.2_quilt" = _FMHVUOdh;
        "pkg-1.15.2_forge" = _D7Mhv0c0;
        "pkg-1.15.3_fabric" = _9tzkgjbs;
        "pkg-1.15.3_quilt" = _YZujeei9;
        "pkg-1.15.3_forge" = _p3N2UaNs;
        "pkg-1.16_fabric" = _NcBxQrvH;
        "pkg-1.16_quilt" = _7v28EidW;
        "pkg-1.16_forge" = _4BEqdzxK;
        "pkg-1.10.2" = _dMSQ1LFG;
        "pkg-1.14.4_fabric" = _a0YGu2iA;
        "pkg-1.14.4_quilt" = _sYNheXLB;
        "pkg-1.14.4_forge" = _9SpoX7E0;
        "pkg-1.12.4_fabric" = _ReG4aGW6;
        "pkg-1.12.4_quilt" = _rWNp8SZO;
        "pkg-1.12.4_forge" = _ktGh7bz0;
        "pkg-1.14.5_fabric" = _Q67gzc2j;
        "pkg-1.14.5_quilt" = _Gn0AWzFj;
        "pkg-1.14.5_forge" = _BVJe6xwO;
        "pkg-1.15.4_fabric" = _WO9ujAWa;
        "pkg-1.15.4_quilt" = _oXInUAsd;
        "pkg-1.15.4_forge" = _S86SciGR;
        "pkg-1.16.1_fabric" = _9so0FT8s;
        "pkg-1.16.1_quilt" = _WjtRRTw9;
        "pkg-1.16.1_forge" = _50JPIDVA;
        "pkg-1.16.2_forge" = _u8mx7daJ;
        "pkg-1.20.1-1.16.3" = _UJTeymhg;
        "pkg-1.20.2-1.16.4" = _72ait9oo;
        "pkg-1.20.2-1.16.5" = _8uAx1lf9;
        "pkg-20.3.0" = _xlLbiJgo;
        "pkg-20.3.1" = _WJg17npf;
        "pkg-21.0.0" = _4DGCC9Z2;
        "pkg-21.0.1" = _NQw9qmLn;
        "pkg-21.0.3" = _5wMcXS1b;
        "pkg-21.0.4" = _9ze7ZRJI;
        "pkg-21.0.5" = _nSRctOMo;
        "pkg-19.3.1" = _HS1UY8Tz;
        "pkg-19.3.4" = _jqOOgDNV;
        "pkg-19.3.5" = _TbR0FAFL;
        "pkg-21.0.6" = _ErTctr3A;
        "pkg-19.3.6" = _punDkQTd;
        "pkg-19.3.7" = _FvJKocea;
        "pkg-26.1.0" = _bdqlFvg9;
        "pkg-26.2.0" = _DqrPrUMp;
        "pkg-26.2.1" = _WeB9yfXc;
        "pkg-26.3.1" = _YlmosWaf;
        "default" = _YlmosWaf;
    });
