...
let
    ...
    in {
        ...
        "pkg-2.0" = _ijYI7DSe;
        "pkg-2.0+mod-beta" = _3PJfQEtj;
        "pkg-2.1-beta" = _XFLdhyGD;
        "pkg-2.2-beta" = _2K9mtcPB;
        "pkg-2.3-beta" = _yQIg5m48;
        "pkg-2.3" = _mes9Gtsr;
        "pkg-2.3+mod" = _T2xXCIg0;
        "pkg-2.4" = _mPZMTTlB;
        "pkg-2.4+mod" = _ZiG5ib9a;
        "pkg-2.5" = _bFNymmAp;
        "pkg-2.5+mod" = _I9e0dW8K;
        "pkg-2.6" = _GtuCodg9;
        "pkg-2.6+mod" = _Dz4klts7;
        "pkg-2.7" = _6FucNWZ7;
        "pkg-2.7+mod" = _LIyMEUeX;
        "pkg-3.0-beta" = _GwQdTRhj;
        "pkg-3.0-beta+mod" = _nn0pjsij;
        "pkg-3.2" = _rd1oBIwk;
        "pkg-3.2+mod" = _fApHkAUs;
        "pkg-3.3" = _arPK0wlb;
        "pkg-3.3+mod" = _YGdN0kNt;
        "pkg-3.4" = _kZ9cl2t4;
        "pkg-3.4+mod" = _x7OWxTz3;
        "pkg-3.5" = _SY3IaqLn;
        "pkg-3.5+mod" = _FJfJbG80;
        "pkg-3.6" = _3sJc1jUW;
        "pkg-3.6+mod" = _Y9ByoVA1;
        "pkg-4.0" = _NYGm3005;
        "pkg-4.0+mod" = _LFVCcPgB;
        "pkg-4.1" = _TvN2DEXL;
        "pkg-4.1+mod" = _DxINSoOY;
        "pkg-4.2" = _gBx8ZOYp;
