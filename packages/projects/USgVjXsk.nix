...
let
    ...
    in {
        ...
        "pkg-0.8.0" = _flflKMIs;
        "pkg-0.8.0b" = _DaZCuACN;
        "pkg-0.9.0" = _szRnroLy;
        "pkg-0.9.0c" = _Mk9klrXn;
        "pkg-0.9.0d" = _mz1cbiFh;
        "pkg-0.9.1" = _yYYYr8yI;
        "pkg-0.9.1b-1.20.1" = _xWAEWXOv;
        "pkg-0.9.1b-1.19.2" = _uZYKvC9U;
        "pkg-0.9.1c-1.20.1" = _qBc7nHJY;
        "pkg-0.9.1c-1.19.2" = _pgKAXeHa;
        "pkg-0.9.2-1.19.2" = _WnrydYjl;
        "pkg-0.9.2-1.20.1" = _AbYallsC;
        "pkg-0.9.3-1.19.2" = _PqEqgepQ;
        "pkg-0.9.3-1.20.1" = _VwFfpSSM;
        "pkg-1.0e" = _b7jH9N2j;
        "pkg-1.0.2c" = _dnJCGvvx;
        "pkg-1.0.2" = _ZjYnau7P;
        "pkg-1.0.2b" = _MBJJHu0Y;
        "pkg-1.0.2d" = _wMVwm8Y8;
        "pkg-1.0.2e" = _OIrDvVJc;
        "pkg-1.0.2f" = _ZNOx0jhg;
        "pkg-1.1.0" = _EnkOpykO;
        "pkg-1.1.0b" = _aJOqzLci;
        "pkg-1.1.0c" = _4VjjDOtF;
        "pkg-1.1.0e" = _Rl2zoLXU;
        "pkg-1.1.1" = _DnTu7afj;
        "pkg-1.2.0" = _uDi14nbt;
        "default" = _uDi14nbt;
    });
