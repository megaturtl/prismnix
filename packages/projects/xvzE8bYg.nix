...
let
    versions = (let
        ...
        _DH56sDwJ = {
            "id" = "DH56sDwJ";
            "file" = "fauction-2.0.1.jar";
            "hash" = "sha512-Dsf7HKKF+zmjg5b++yrjen85kQGRAqN263iQ0R1PRUx6jhjd82BReQJEdAKqzEmjcrXpD4pV/TWyNeg90duVGQ==";
        };
        _QIsL3BTB = {
            "id" = "QIsL3BTB";
            "file" = "fauction-2.0.2.jar";
            "hash" = "sha512-VgQd3Jh0bpPPvDKF6yoigCIifJYnMtcczgMTf/iG1KHuo6Af4Fm2CL6GLzpoc/PUFcvVuYE+/kUJ/Z6/xUWsdg==";
        };
        _4mwvjo3n = {
            "id" = "4mwvjo3n";
            "file" = "fauction-2.1.0.jar";
            "hash" = "sha512-FJ+ZkJ0RCEqL3KOEH8h3bj7x0OTegNfd98aDNMVA8AWaPEYIFg6yVHUBGfIKD5hWDoFdVrRM8BPQUgb8T4UPsA==";
        };
        _siKI9U70 = {
            "id" = "siKI9U70";
            "file" = "fauction-2.2.0.jar";
            "hash" = "sha512-gsYjSo3o0s2grTd1RGcn2JvnjC0gPEP8X+KdqjxzCb/iSUBkObY1CszcQnaJmz7elP7nEc8K8DpHevdE/Fz0LA==";
        };
        _EpAwPwKW = {
            "id" = "EpAwPwKW";
            "file" = "fauction-2.2.1.jar";
            "hash" = "sha512-ERHyWqXl5ytc7sLT8JiPDdeNpSdwf3h1VIYWU35d/f99WZX6KK3CJLPjmM+szwY6KL7GSsgOq9xd/RG8F6jlGw==";
        };
    in {
        "d6LWLONO" = _d6LWLONO;
        "NOlbQppB" = _NOlbQppB;
        ...
        "bukkit-1.16" = _EpAwPwKW;
        "bukkit-1.16.1" = _EpAwPwKW;
        "bukkit-1.16.2" = _EpAwPwKW;
        "bukkit-1.16.3" = _EpAwPwKW;
        "bukkit-1.16.4" = _EpAwPwKW;
        "bukkit-1.16.5" = _EpAwPwKW;
        "bukkit-1.17" = _EpAwPwKW;
        "bukkit-1.17.1" = _EpAwPwKW;
        "bukkit-1.18" = _EpAwPwKW;
        "bukkit-1.18.1" = _EpAwPwKW;
        "bukkit-1.18.2" = _EpAwPwKW;
        "bukkit-1.19" = _EpAwPwKW;
        "bukkit-1.19.1" = _EpAwPwKW;
        "bukkit-1.19.2" = _EpAwPwKW;
        "bukkit-1.19.3" = _EpAwPwKW;
        "bukkit-1.19.4" = _EpAwPwKW;
        "bukkit-1.20" = _EpAwPwKW;
        "bukkit-1.20.1" = _EpAwPwKW;
        "bukkit-1.20.2" = _EpAwPwKW;
        "bukkit-1.20.3" = _EpAwPwKW;
        "bukkit-1.20.4" = _EpAwPwKW;
        "bukkit-1.20.5" = _EpAwPwKW;
        "bukkit-1.20.6" = _EpAwPwKW;
        "bukkit-1.21" = _EpAwPwKW;
        "bukkit-1.21.1" = _EpAwPwKW;
        "bukkit-1.21.2" = _EpAwPwKW;
        "bukkit-1.21.3" = _EpAwPwKW;
        "bukkit-1.21.4" = _EpAwPwKW;
        "bukkit-1.21.5" = _EpAwPwKW;
        "bukkit-1.21.6" = _EpAwPwKW;
        "bukkit-1.21.7" = _EpAwPwKW;
        "bukkit-1.21.8" = _EpAwPwKW;
        "bukkit-1.21.9" = _EpAwPwKW;
        "bukkit-1.21.10" = _EpAwPwKW;
        "bukkit-1.21.11" = _EpAwPwKW;
        "bukkit-26.1" = _EpAwPwKW;
        "bukkit-26.1.1" = _EpAwPwKW;
        "bukkit-26.1.2" = _EpAwPwKW;
        "bukkit-26.2" = _EpAwPwKW;
        ...
        "paper-1.16" = _EpAwPwKW;
        "paper-1.16.1" = _EpAwPwKW;
        "paper-1.16.2" = _EpAwPwKW;
        "paper-1.16.3" = _EpAwPwKW;
        "paper-1.16.4" = _EpAwPwKW;
        "paper-1.16.5" = _EpAwPwKW;
        "paper-1.17" = _EpAwPwKW;
        "paper-1.17.1" = _EpAwPwKW;
        "paper-1.18" = _EpAwPwKW;
        "paper-1.18.1" = _EpAwPwKW;
        "paper-1.18.2" = _EpAwPwKW;
        "paper-1.19" = _EpAwPwKW;
        "paper-1.19.1" = _EpAwPwKW;
        "paper-1.19.2" = _EpAwPwKW;
        "paper-1.19.3" = _EpAwPwKW;
        "paper-1.19.4" = _EpAwPwKW;
        "paper-1.20" = _EpAwPwKW;
        "paper-1.20.1" = _EpAwPwKW;
        "paper-1.20.2" = _EpAwPwKW;
        "paper-1.20.3" = _EpAwPwKW;
        "paper-1.20.4" = _EpAwPwKW;
        "paper-1.20.5" = _EpAwPwKW;
        "paper-1.20.6" = _EpAwPwKW;
        "paper-1.21" = _EpAwPwKW;
        "paper-1.21.1" = _EpAwPwKW;
        "paper-1.21.2" = _EpAwPwKW;
        "paper-1.21.3" = _EpAwPwKW;
        "paper-1.21.4" = _EpAwPwKW;
        "paper-1.21.5" = _EpAwPwKW;
        "paper-1.21.6" = _EpAwPwKW;
        "paper-1.21.7" = _EpAwPwKW;
        "paper-1.21.8" = _EpAwPwKW;
        "paper-1.21.9" = _EpAwPwKW;
        "paper-1.21.10" = _EpAwPwKW;
        "paper-1.21.11" = _EpAwPwKW;
        "paper-26.1" = _EpAwPwKW;
        "paper-26.1.1" = _EpAwPwKW;
        "paper-26.1.2" = _EpAwPwKW;
        "paper-26.2" = _EpAwPwKW;
        ...
        "spigot-1.16" = _EpAwPwKW;
        "spigot-1.16.1" = _EpAwPwKW;
        "spigot-1.16.2" = _EpAwPwKW;
        "spigot-1.16.3" = _EpAwPwKW;
        "spigot-1.16.4" = _EpAwPwKW;
        "spigot-1.16.5" = _EpAwPwKW;
        "spigot-1.17" = _EpAwPwKW;
        "spigot-1.17.1" = _EpAwPwKW;
        "spigot-1.18" = _EpAwPwKW;
        "spigot-1.18.1" = _EpAwPwKW;
        "spigot-1.18.2" = _EpAwPwKW;
        "spigot-1.19" = _EpAwPwKW;
        "spigot-1.19.1" = _EpAwPwKW;
        "spigot-1.19.2" = _EpAwPwKW;
        "spigot-1.19.3" = _EpAwPwKW;
        "spigot-1.19.4" = _EpAwPwKW;
        "spigot-1.20" = _EpAwPwKW;
        "spigot-1.20.1" = _EpAwPwKW;
        "spigot-1.20.2" = _EpAwPwKW;
        "spigot-1.20.3" = _EpAwPwKW;
        "spigot-1.20.4" = _EpAwPwKW;
        "spigot-1.20.5" = _EpAwPwKW;
        "spigot-1.20.6" = _EpAwPwKW;
        "spigot-1.21" = _EpAwPwKW;
        "spigot-1.21.1" = _EpAwPwKW;
        "spigot-1.21.2" = _EpAwPwKW;
        "spigot-1.21.3" = _EpAwPwKW;
        "spigot-1.21.4" = _EpAwPwKW;
        "spigot-1.21.5" = _EpAwPwKW;
        "spigot-1.21.6" = _EpAwPwKW;
        "spigot-1.21.7" = _EpAwPwKW;
        "spigot-1.21.8" = _EpAwPwKW;
        "spigot-1.21.9" = _EpAwPwKW;
        "spigot-1.21.10" = _EpAwPwKW;
        "spigot-1.21.11" = _EpAwPwKW;
        "spigot-26.1" = _EpAwPwKW;
        "spigot-26.1.1" = _EpAwPwKW;
        "spigot-26.1.2" = _EpAwPwKW;
        "spigot-26.2" = _EpAwPwKW;
        ...
        "purpur-1.16" = _EpAwPwKW;
        "purpur-1.16.1" = _EpAwPwKW;
        "purpur-1.16.2" = _EpAwPwKW;
        "purpur-1.16.3" = _EpAwPwKW;
        "purpur-1.16.4" = _EpAwPwKW;
        "purpur-1.16.5" = _EpAwPwKW;
        "purpur-1.17" = _EpAwPwKW;
        "purpur-1.17.1" = _EpAwPwKW;
        "purpur-1.18" = _EpAwPwKW;
        "purpur-1.18.1" = _EpAwPwKW;
        "purpur-1.18.2" = _EpAwPwKW;
        "purpur-1.19" = _EpAwPwKW;
        "purpur-1.19.1" = _EpAwPwKW;
        "purpur-1.19.2" = _EpAwPwKW;
        "purpur-1.19.3" = _EpAwPwKW;
        "purpur-1.19.4" = _EpAwPwKW;
        "purpur-1.20" = _EpAwPwKW;
        "purpur-1.20.1" = _EpAwPwKW;
        "purpur-1.20.2" = _EpAwPwKW;
        "purpur-1.20.3" = _EpAwPwKW;
        "purpur-1.20.4" = _EpAwPwKW;
        "purpur-1.20.5" = _EpAwPwKW;
        "purpur-1.20.6" = _EpAwPwKW;
        "purpur-1.21" = _EpAwPwKW;
        "purpur-1.21.1" = _EpAwPwKW;
        "purpur-1.21.2" = _EpAwPwKW;
        "purpur-1.21.3" = _EpAwPwKW;
        "purpur-1.21.4" = _EpAwPwKW;
        "purpur-1.21.5" = _EpAwPwKW;
        "purpur-1.21.6" = _EpAwPwKW;
        "purpur-1.21.7" = _EpAwPwKW;
        "purpur-1.21.8" = _EpAwPwKW;
        "purpur-1.21.9" = _EpAwPwKW;
        "purpur-1.21.10" = _EpAwPwKW;
        "purpur-1.21.11" = _EpAwPwKW;
        "purpur-26.1" = _EpAwPwKW;
        "purpur-26.1.1" = _EpAwPwKW;
        "purpur-26.1.2" = _EpAwPwKW;
        "purpur-26.2" = _EpAwPwKW;
        "folia-1.16" = _EpAwPwKW;
        "folia-1.16.1" = _EpAwPwKW;
        "folia-1.16.2" = _EpAwPwKW;
        "folia-1.16.3" = _EpAwPwKW;
        "folia-1.16.4" = _EpAwPwKW;
        "folia-1.16.5" = _EpAwPwKW;
        "folia-1.17" = _EpAwPwKW;
        "folia-1.17.1" = _EpAwPwKW;
        "folia-1.18" = _EpAwPwKW;
        "folia-1.18.1" = _EpAwPwKW;
        "folia-1.18.2" = _EpAwPwKW;
        "folia-1.19" = _EpAwPwKW;
        "folia-1.19.1" = _EpAwPwKW;
        "folia-1.19.2" = _EpAwPwKW;
        "folia-1.19.3" = _EpAwPwKW;
        "folia-1.19.4" = _EpAwPwKW;
        "folia-1.20" = _EpAwPwKW;
        "folia-1.20.1" = _EpAwPwKW;
        "folia-1.20.2" = _EpAwPwKW;
        "folia-1.20.3" = _EpAwPwKW;
        "folia-1.20.4" = _EpAwPwKW;
        "folia-1.20.5" = _EpAwPwKW;
        "folia-1.20.6" = _EpAwPwKW;
        "folia-1.21" = _EpAwPwKW;
        "folia-1.21.1" = _EpAwPwKW;
        "folia-1.21.2" = _EpAwPwKW;
        "folia-1.21.3" = _EpAwPwKW;
        "folia-1.21.4" = _EpAwPwKW;
        "folia-1.21.5" = _EpAwPwKW;
        "folia-1.21.6" = _EpAwPwKW;
        "folia-1.21.7" = _EpAwPwKW;
        "folia-1.21.8" = _EpAwPwKW;
        "folia-1.21.9" = _EpAwPwKW;
        "folia-1.21.10" = _EpAwPwKW;
        "folia-1.21.11" = _EpAwPwKW;
        "folia-26.1" = _EpAwPwKW;
        "folia-26.1.1" = _EpAwPwKW;
        "folia-26.1.2" = _EpAwPwKW;
        "folia-26.2" = _EpAwPwKW;
        "pkg-V1.5.9.3" = _d6LWLONO;
        "pkg-V1.6.0" = _NOlbQppB;
        "pkg-V1.6.1" = _X4BDFv1R;
        "pkg-V1.6.2" = _Ll7TKv5z;
        "pkg-V1.6.2.1" = _ikooCqMU;
        "pkg-V1.6.3" = _SyzPTYYP;
        "pkg-V1.6.4" = _JGHL8EZz;
        "pkg-V1.6.5" = _ix55eDcB;
        "pkg-V1.6.6" = _kvSRNUEF;
        "pkg-V1.6.7" = _hyCt0pdY;
        "pkg-V1.6.8" = _6CcYuASY;
        "pkg-V1.6.9" = _R7TzUp0Y;
        "pkg-V1.6.10" = _viw4raXN;
        "pkg-V1.6.11" = _Q5Q9BN29;
        "pkg-V1.6.12" = _jo1XMU22;
        "pkg-V1.6.13" = _p23mJre4;
        "pkg-V1.7.0" = _75kCd21R;
        "pkg-V1.7.1" = _c6xskakI;
        "pkg-V1.7.2" = _6HtedM5X;
        "pkg-V1.7.3" = _afAP82FO;
        "pkg-V1.7.4" = _Dl0JMI95;
        "pkg-1.7.5" = _R25lLS2h;
        "pkg-V1.7.6" = _BJ2JXXv7;
        "pkg-V1.7.7" = _r1k1F2DM;
        "pkg-V1.7.7.1" = _heGuWcPj;
        "pkg-V1.7.8" = _Y4e4PTNs;
        "pkg-V1.7.9" = _ictLq92v;
        "pkg-V1.7.9.1" = _pP0zFI4y;
        "pkg-V1.7.9.2" = _JtqnImcs;
        "pkg-V1.7.9.3" = _mHcQ0lV2;
        "pkg-V1.7.9.4" = _Az21uiPf;
        "pkg-V1.8.0" = _fdLZrR1a;
        "pkg-V1.8.0.1" = _f0Qzio3O;
        "pkg-V1.8.0.2" = _Arg1Jm7S;
        "pkg-V1.8.1" = _TJeBrG0C;
        "pkg-V1.8.2" = _zXc0QBzw;
        "pkg-V1.8.3" = _RuNxRz6M;
        "pkg-V1.8.4" = _Kxqb5IPQ;
        "pkg-V1.8.5" = _p5eSorzN;
        "pkg-V1.8.6" = _tHVUyuIi;
        "pkg-V1.8.7" = _C9OoFdoA;
        "pkg-V1.8.8" = _5rcGBM4m;
        "pkg-V1.8.9" = _r8hox00H;
        "pkg-V1.8.10" = _gcwH7yRM;
        "pkg-V1.8.11" = _Dd8mVQvB;
        "pkg-V1.8.12" = _Vrk9mQbc;
        "pkg-V1.8.13" = _MKzWICtK;
        "pkg-V1.8.14" = _NsU5oNKq;
        "pkg-V1.8.15" = _dQIPG3Pr;
        "pkg-V1.8.16" = _QCgDede4;
        "pkg-V1.8.17" = _vKaLKsUW;
        "pkg-V1.8.18" = _F4EtElsJ;
        "pkg-V1.8.19" = _hHwEzILJ;
        "pkg-V1.8.20" = _2pVyUu2d;
        "pkg-V1.8.21" = _cBrxwjIJ;
        "pkg-V1.8.22" = _B3BJERJ5;
        "pkg-V1.8.23" = _UEPVwDPn;
        "pkg-V1.8.24" = _t4g00n59;
        "pkg-V1.8.25" = _BY4LuCY3;
        "pkg-V1.9.0" = _DRqtqKD8;
        "pkg-V1.9.1" = _adGcfuYR;
        "pkg-V1.9.2" = _4G4wYQoU;
        "pkg-V1.9.3" = _l4jCiO4b;
        "pkg-V1.9.4" = _BkHoMARc;
        "pkg-V1.9.5" = _ng39zfqo;
        "pkg-V1.9.6" = _kEQXkERh;
        "pkg-V1.9.7" = _rcF26nx8;
        "pkg-V1.9.8" = _MkwPJ0Ph;
        "pkg-V1.9.9" = _E1LXu8yK;
        "pkg-1.9.10" = _ikypJ0oL;
        "pkg-2.0.0" = _kkeIZSh4;
        "pkg-V2.0.1" = _DH56sDwJ;
        "pkg-V2.0.2" = _QIsL3BTB;
        "pkg-V2.1.0" = _4mwvjo3n;
        "pkg-V2.2.0" = _siKI9U70;
        "pkg-V2.2.1" = _EpAwPwKW;
        "default" = _EpAwPwKW;
    });
