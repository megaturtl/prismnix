...
let
    versions = (let
        ...
        _TvIVqOOX = {
            "id" = "TvIVqOOX";
            "file" = "Kenui's Default [1.20+] v6.0.zip";
            "hash" = "sha512-lX4+rjJiSgdJHumTzAlWLXo+AaucLt/vNGpOLBAjdPYYnPndabrU8kxql22IeLlJ6IGHC2t0E6uAqJ+NDgq8YQ==";
        };
        _wBiJyj24 = {
            "id" = "wBiJyj24";
            "file" = "Kenui's Default [1.20+] v6.0.zip";
            "hash" = "sha512-EXqjr+GvioFIMi5O5qjE+XFBxz+Ryc7A8VV/b2m7rwv+ojUgITiFkbeo28sFTWVOL6qViioCxvxbFNuH/DUj4g==";
        };
    in {
        "IrQiOPAW" = _IrQiOPAW;
        "1KODvNt3" = _1KODvNt3;
        ...
        "TvIVqOOX" = _TvIVqOOX;
        "wBiJyj24" = _wBiJyj24;
        "minecraft-1.20" = _wBiJyj24;
        "minecraft-1.20.1" = _wBiJyj24;
        "minecraft-1.20.2" = _wBiJyj24;
        "minecraft-1.20.3" = _wBiJyj24;
        "minecraft-1.20.4" = _wBiJyj24;
        "minecraft-1.20.5" = _wBiJyj24;
        "minecraft-1.20.6" = _wBiJyj24;
        "minecraft-1.21" = _wBiJyj24;
        "minecraft-1.21.1" = _wBiJyj24;
        "minecraft-1.21.2" = _wBiJyj24;
        "minecraft-1.21.3" = _wBiJyj24;
        "minecraft-1.21.4" = _wBiJyj24;
        "minecraft-1.21.5" = _wBiJyj24;
        "minecraft-1.21.6" = _wBiJyj24;
        "minecraft-1.21.7" = _wBiJyj24;
        "minecraft-1.21.8" = _wBiJyj24;
        "minecraft-1.21.9" = _wBiJyj24;
        "minecraft-1.21.10" = _wBiJyj24;
        "minecraft-1.21.11" = _wBiJyj24;
        ...
        "minecraft-1.16" = _wBiJyj24;
        "minecraft-1.16.1" = _wBiJyj24;
        "minecraft-1.16.2" = _wBiJyj24;
        "minecraft-1.16.3" = _wBiJyj24;
        "minecraft-1.16.4" = _wBiJyj24;
        "minecraft-1.16.5" = _wBiJyj24;
        "minecraft-1.17" = _wBiJyj24;
        "minecraft-1.17.1" = _wBiJyj24;
        "minecraft-1.18" = _wBiJyj24;
        "minecraft-1.18.1" = _wBiJyj24;
        "minecraft-1.18.2" = _wBiJyj24;
        "minecraft-1.19" = _wBiJyj24;
        "minecraft-1.19.1" = _wBiJyj24;
        "minecraft-1.19.2" = _wBiJyj24;
        "minecraft-1.19.3" = _wBiJyj24;
        "minecraft-1.19.4" = _wBiJyj24;
        "minecraft-1.14" = _wBiJyj24;
        "minecraft-1.14.1" = _wBiJyj24;
        "minecraft-1.14.2" = _wBiJyj24;
        "minecraft-1.14.3" = _wBiJyj24;
        "minecraft-1.14.4" = _wBiJyj24;
        "minecraft-1.15" = _wBiJyj24;
        "minecraft-1.15.1" = _wBiJyj24;
        "minecraft-1.15.2" = _wBiJyj24;
        "minecraft-26.1" = _wBiJyj24;
        "minecraft-26.1.1" = _wBiJyj24;
        "minecraft-26.1.2" = _wBiJyj24;
        "minecraft-26.2" = _wBiJyj24;
        "minecraft-1.13" = _wBiJyj24;
        "minecraft-1.13.1" = _wBiJyj24;
        "minecraft-1.13.2" = _wBiJyj24;
        "minecraft-1.12" = _wBiJyj24;
        "minecraft-1.12.1" = _wBiJyj24;
        "minecraft-1.12.2" = _wBiJyj24;
        "minecraft-26.3" = _wBiJyj24;
        "pkg-1.0" = _IrQiOPAW;
        "pkg-1.2" = _1KODvNt3;
        "pkg-1.3" = _HBrfeCWq;
        "pkg-1.4" = _4QCrYiel;
