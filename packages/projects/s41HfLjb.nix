...
let
    ...
    in {
        ...
        "pkg-0.5.4" = _sczSESfR;
        "pkg-0.5.5" = _t61ssyjO;
        "pkg-0.5.51" = _W2DcjBSW;
        "pkg-0.5.6" = _oOo9XV1V;
        "pkg-0.5.61" = _otyxXdE0;
        "pkg-0.5.62" = _5yUWStPm;
        "pkg-0.5.63" = _THpUjT1j;
        "pkg-0.5.65" = _T2c6ceSm;
        "pkg-0.5.66" = _eG08WSlR;
        "pkg-0.5.7" = _SBDV3hld;
        "pkg-0.5.75" = _3NkfCgJa;
        "pkg-0.5.8" = _l95KKWd0;
        "pkg-0.5.9" = _MlDNUYJq;
        "pkg-0.5.92" = _sLlc49i9;
        "pkg-0.5.97" = _jDNl4h64;
        "pkg-0.5.98" = _UT65VzcL;
        "pkg-0.5.985" = _N55RCYL3;
        "pkg-0.5.987" = _YHS69lMi;
        "pkg-0.5.988" = _nPCYjgaZ;
        "pkg-0.5.989" = _IUHROMtX;
        "pkg-0.5.9891" = _zbJ2DlD0;
        "pkg-0.5.9900" = _adnPl7XU;
        "pkg-0.5.9905" = _POozRaCV;
        "pkg-0.5.9910" = _ufxwOKTl;
        "pkg-0.5.9915" = _tOvO18VH;
        "pkg-0.5.9920" = _k12cJRg4;
        "pkg-0.5.9930" = _Dz2QGmtt;
        "pkg-0.5.9935" = _bPIAA0iU;
        "pkg-0.5.9940" = _sYvb131R;
        "pkg-0.5.9945" = _z9RTf33P;
        "pkg-0.6.0" = _lIEXXV3C;
        "pkg-0.6.01" = _gelwR9HL;
        "pkg-0.6.05" = _ff8y7EOJ;
        "pkg-0.6.07" = _z4N6fk6X;
        "pkg-0.6.08" = _LnWsJZs3;
        "pkg-0.6.10" = _89LyEuHf;
        "pkg-0.6.13" = _E7tCqFEG;
        "pkg-0.6.14" = _MYmEPwcn;
        "pkg-0.6.17" = _rREW4isl;
        "pkg-0.6.18" = _gtzbrEKu;
        "pkg-0.6.19" = _lLpzNUZ7;
        "pkg-0.6.195" = _BW5b3Px5;
        "pkg-0.6.20" = _kETqJqly;
        "pkg-0.6.205" = _2RSghrrF;
        "pkg-0.6.23" = _FPa6CaN1;
        "pkg-0.6.25" = _e5rNEn6A;
        "pkg-0.6.26" = _sReAttLH;
        "pkg-0.6.3" = _Kfp5iZWn;
        "pkg-0.6.35" = _dC2UrnL6;
        "pkg-0.6.40" = _N0TH73z5;
        "pkg-0.6.43" = _lkT5ZaxL;
        "pkg-0.6.45" = _brn14JcD;
        "pkg-0.6.50" = _tZMupqfc;
        "pkg-0.6.51" = _K7R6dZ0X;
        "pkg-0.6.54" = _lLoqVFXB;
        "pkg-0.6.55" = _vQTlMa6q;
        "pkg-0.6.57" = _byqBPnsd;
        "pkg-0.6.6" = _35lRRBcv;
        "pkg-0.6.65" = _Et7Y3rmT;
        "pkg-0.6.67" = _F0ArFYIv;
        "pkg-0.6.70" = _s45VA8uJ;
        "pkg-0.6.75" = _GKsWTCur;
        "pkg-0.6.77" = _GtmM1Ffu;
        "pkg-0.6.80" = _kjUSUdFR;
        "pkg-0.6.82" = _xBno0olB;
        "pkg-0.6.85" = _sJIzcESC;
        "pkg-0.6.86" = _kFeA5kNv;
        "pkg-0.6.87" = _513Yn5qO;
        "pkg-0.6.875" = _1S5DPggU;
        "pkg-0.6.876" = _CNDHZIsq;
        "pkg-0.6.88" = _ljPkp5CF;
        "pkg-0.6.885" = _Nzh99xS8;
        "pkg-0.6.886" = _N9SFhWB8;
        "pkg-0.6.889" = _7mrj9059;
        "pkg-0.6.900" = _jWcnLKCd;
        "pkg-0.6.901" = _xQJJTE4J;
        "pkg-0.6.903" = _vy7NX1U9;
        "pkg-0.6.906" = _WnVP03gD;
        "pkg-0.6.910" = _G36IbT9a;
        "pkg-0.6.911" = _CysILjbg;
        "pkg-0.6.912" = _myRnEVq7;
        "pkg-0.6.913" = _3lE6glAk;
        "pkg-0.6.914" = _jIAE59RR;
        "pkg-0.6.915" = _1YnsmeAZ;
        "pkg-0.6.918" = _hJWZUeOn;
