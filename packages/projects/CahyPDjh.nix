...
let
    versions = (let
        ...
        _8Ae30koG = {
            "id" = "8Ae30koG";
            "file" = "netherwartblock-26.1.2-fabric-8.jar";
            "hash" = "sha512-qvBmpn1s9WBtN/qYmubgZzeYOSt4HcBJ8mMUDYbqj/T8w45g88jkZfkLDbtBlfeby8nlc14+fPGrY8FodDt4NQ==";
        };
        _ET5TLhgA = {
            "id" = "ET5TLhgA";
            "file" = "netherwartblock-26.1.2-forge-8.jar";
            "hash" = "sha512-Yznoc5OSNnh1wBM8mdbTjO7q6ooM0rHBVj/R9T6sSuQjkY7ivLVcTZgNyEI6xWo9ceQyHEt3jmv5PHkuOSFaOA==";
        };
        _gEsrcCmI = {
            "id" = "gEsrcCmI";
            "file" = "netherwartblock-26.1.2-neoforge-8.jar";
            "hash" = "sha512-8SM7NI2jlPMiAZinXMmsH/W89lNlUxIFEr8IOumHuaSlz4R+wOfGiKgurzLSxSPFH7qg9NF998Ro4NNQZQPE2w==";
        };
        _5ee7uCG9 = {
            "id" = "5ee7uCG9";
            "file" = "netherwartblock-26.2-fabric-8.jar";
            "hash" = "sha512-k4bMaOuV4Ekx7kjliJya9rpciWpQ8W5RZpjhmFs5DyrocQe/WjvnmxzcWVrr/OPnygnpCkfnYvhCrTXRsPR9Yg==";
        };
        _HskGLZfr = {
            "id" = "HskGLZfr";
            "file" = "netherwartblock-26.2-forge-8.jar";
            "hash" = "sha512-WsvGIQ3DtCpQHeVheNcTHyP6QxodhXP4TKT/oZxU52YRt6EvDHj8ThSguVsD/sUci0IZY/Tj4QQ3DfaEPswXCw==";
        };
        _X0gvVhpX = {
            "id" = "X0gvVhpX";
            "file" = "netherwartblock-26.2-neoforge-8.jar";
            "hash" = "sha512-nLN9E4GN8N7fj1K9oGwmZ234IRNgKP7qC2DQWdaPQFPiKbagBp9ajADvnI0wCmyk11mczDEunleh30zNYd59hA==";
        };
        _qu3QKidV = {
            "id" = "qu3QKidV";
            "file" = "netherwartblock-fabric-1.18.2-8.jar";
            "hash" = "sha512-AFX8CUQP+s0WIzq1GYzsxpYfuzefaiLZpXWshF05wlb2kbg9koo4zv9g2vcXkejFKUi9elRXB3Zeh5sdD7z2zQ==";
        };
        _CuwT9A57 = {
            "id" = "CuwT9A57";
            "file" = "netherwartblock-fabric-1.19.2-8.jar";
            "hash" = "sha512-NaMw4IvKEB/KJj0JQpAQpe3w/gPzEyQKcKJKNb+qWXu8VYxb/e9u2fT4FQdVoY6Ycyr/Iiphs280bf5YvcnzRQ==";
        };
        _8hQP3zOi = {
            "id" = "8hQP3zOi";
            "file" = "netherwartblock-fabric-1.21.1-8.jar";
            "hash" = "sha512-9j/CAh42LWwgGOmg0vix1m0Mlrt2sbXhj8spxkIHOgru91DcP4V3gzzWqtcmMo1Ad5ECpgeckuaVOqwc+1wgHA==";
        };
        _efXdcMGD = {
            "id" = "efXdcMGD";
            "file" = "netherwartblock-forge-1.18.2-8.jar";
            "hash" = "sha512-jnwoSK4rUuNRW2COz3UR260evYwTDUnYJ9QIYG6DnnICNLOJ+yGy2HPJOoaMEoSd0ClT+ZSCsOP8haFfy0dYHQ==";
        };
        _juK4FDnq = {
            "id" = "juK4FDnq";
            "file" = "netherwartblock-forge-1.19.2-8.jar";
            "hash" = "sha512-+njtEcvUedIMLg1M11t2Uff2/V54zGGvc4wmfozi0w5gL8zGoyTh5CTNJX1olVut9T6wS9yqNJkSP+KS9ouaGg==";
        };
        _Bo0F5eqc = {
            "id" = "Bo0F5eqc";
            "file" = "netherwartblock-forge-1.21.1-8.jar";
            "hash" = "sha512-Ql8n27uR7YrjEry3b0J5jEBALy/AJymQc0ddhhf/mWgGa3Vae4+GkVw+5VbhRi9BCct/ZmHl56XekrWL9opxuQ==";
        };
        _LsRpiepA = {
            "id" = "LsRpiepA";
            "file" = "netherwartblock-neoforge-1.21.1-8.jar";
            "hash" = "sha512-vcPuPgb3XeqKSeCP2kpe/Dbq95oot5vaZvYwj5f7voTxoLypzyWoxSmhuMyAumJDeOAzOrCmc9KRlrsYgsYczA==";
        };
    in {
        "Vnp4s6Rr" = _Vnp4s6Rr;
        "tWtcwVDq" = _tWtcwVDq;
        ...
        "Bo0F5eqc" = _Bo0F5eqc;
        "LsRpiepA" = _LsRpiepA;
        "fabric-1.19.2" = _CuwT9A57;
        "fabric-1.19.1" = _CuwT9A57;
        "fabric-1.19" = _CuwT9A57;
        "fabric-1.18.2" = _qu3QKidV;
        "fabric-1.18.1" = _qu3QKidV;
        ...
        "fabric-26.1" = _8Ae30koG;
        "fabric-26.1.1" = _8Ae30koG;
        "fabric-26.1.2" = _8Ae30koG;
        "fabric-26.2" = _5ee7uCG9;
        "quilt-1.19.2" = _CuwT9A57;
        "quilt-1.19.1" = _CuwT9A57;
        "quilt-1.19" = _CuwT9A57;
        "quilt-1.18.2" = _qu3QKidV;
        "quilt-1.18.1" = _qu3QKidV;
        ...
        "quilt-26.1" = _8Ae30koG;
        "quilt-26.1.1" = _8Ae30koG;
        "quilt-26.1.2" = _8Ae30koG;
        "quilt-26.2" = _5ee7uCG9;
        "forge-1.16.5" = _YKNSkAJi;
        "forge-1.17.1" = _i95zfxOh;
        "forge-1.18" = _efXdcMGD;
        "forge-1.18.1" = _efXdcMGD;
        "forge-1.18.2" = _efXdcMGD;
        "forge-1.19" = _juK4FDnq;
        "forge-1.19.1" = _juK4FDnq;
        "forge-1.19.2" = _juK4FDnq;
        ...
        "forge-1.21" = _Bo0F5eqc;
        "forge-1.21.1" = _Bo0F5eqc;
        ...
        "forge-26.1" = _ET5TLhgA;
        "forge-26.1.1" = _ET5TLhgA;
        "forge-26.1.2" = _ET5TLhgA;
        "forge-26.2" = _HskGLZfr;
        "neoforge-1.20.4" = _59cd0Yvv;
        "neoforge-1.20.6" = _kQ8Gsx7y;
        "neoforge-1.21" = _LsRpiepA;
        "neoforge-1.21.1" = _LsRpiepA;
        ...
        "neoforge-26.1" = _gEsrcCmI;
        "neoforge-26.1.1" = _gEsrcCmI;
        "neoforge-26.1.2" = _gEsrcCmI;
        "neoforge-26.2" = _X0gvVhpX;
        "pkg-1.19.2-6" = _Vnp4s6Rr;
        "pkg-1.19.1-5" = _tWtcwVDq;
        "pkg-1.19-4" = _9GeryvLu;
        "pkg-1.18.2-3" = _DIZuVJOw;
        "pkg-1.18.1-2" = _jrEZcNmb;
        "pkg-1.16.5-1" = _GblFlbxo;
        "pkg-1.19.3-6" = _caZBR7A0;
        "pkg-1.16.5-6-forge" = _YKNSkAJi;
        "pkg-1.17.1-6-forge" = _i95zfxOh;
        "pkg-1.18-6-forge" = _ePS10Zcc;
        "pkg-1.18.1-6-forge" = _hBf2w2zw;
        "pkg-1.18.2-6-forge" = _QHGGNBrJ;
        "pkg-1.19-6-forge" = _CTHUK2bq;
        "pkg-1.19.1-6-forge" = _E6yIoyMq;
        "pkg-1.19.2-6-forge" = _Bf9jdtps;
        "pkg-1.19.3-6-forge" = _yUzHVMjI;
        "pkg-1.19.4-6" = _1elAOska;
        "pkg-1.19.4-6-forge" = _MTU99dui;
        "pkg-1.20-6" = _2zW548zy;
        "pkg-1.20-6-forge" = _osNiG0Rv;
        "pkg-1.20.1-6-fabric" = _Hjw0gNEK;
        "pkg-1.20.1-6-forge" = _FdzNTcmA;
        "pkg-1.20.2-6-fabric" = _UUAqXtSQ;
        "pkg-1.20.2-6-forge" = _8BqW1vps;
        "pkg-1.20.3-6-fabric" = _NqdKJukP;
        "pkg-1.20.3-6-forge" = _d2AmZGAH;
        "pkg-1.20.4-6-forge" = _C7l6GEaC;
        "pkg-1.20.4-6-fabric" = _iFim0vJl;
        "pkg-1.20.4-0-neoforge" = _59cd0Yvv;
        "pkg-1.20.5-6-fabric" = _DCdQ7K10;
        "pkg-1.20.6-6-fabric" = _ZMe4mzHI;
        "pkg-1.20.6-0-neoforge" = _8hZFLWP3;
        "pkg-1.20.6-6-forge" = _QOfhgkYX;
        "pkg-1.21-6-fabric" = _U6jVbADi;
        "pkg-1.21-6-forge" = _byB6bsVQ;
        "pkg-1.21-0-neoforge" = _dEdYGYtd;
        "pkg-1.21.1-0-neoforge" = _M0gdhtJG;
        "pkg-1.21.1-6-fabric" = _3lmMSzF3;
        "pkg-1.21.1-6-forge" = _pRqFyqyQ;
        "pkg-1.21.2-6-fabric" = _sCxQmNRH;
        "pkg-1.21.3-6-forge" = _ON0DOYes;
        "pkg-1.21.3-0-neoforge" = _YWJIuJ6E;
        "pkg-1.21.4-6-fabric" = _pBEiETjE;
        "pkg-1.21.4-0-neoforge" = _dsO1bG1b;
        "pkg-1.21.4-6-forge" = _I9ITQQaP;
        "pkg-forge-1.18.2-7" = _roD5vVYM;
        "pkg-fabric-1.19.2-7.jar" = _8Dc1TuPN;
        "pkg-forge-1.19.2-7.jar" = _JffrIhzt;
        "pkg-forge-1.19.4-7.jar" = _pH7rbq0M;
        "pkg-fabric-1.19.4-7.jar" = _iUwDqJui;
        "pkg-fabric-1.20.1-7.jar" = _l6TMxoku;
        "pkg-forge-1.20.1-7.jar" = _zxkEIS35;
        "pkg-fabric-1.20.2-7.jar" = _L6zSZyCK;
        "pkg-fabric-1.20.4-7.jar" = _OPY2ox4b;
        "pkg-fabric-1.20.6-7.jar" = _ylEnSg5G;
        "pkg-fabric-1.21.1-7.jar" = _c7UK71Bh;
        "pkg-fabric-1.21.3-7.jar" = _Q3kNRGCC;
        "pkg-fabric-1.21.4-7.jar" = _qblQmlWQ;
        "pkg-forge-1.20.2-7.jar" = _FwU3KB0L;
        "pkg-forge-1.20.4-7.jar" = _1a1rn7Sj;
        "pkg-forge-1.20.6-7.jar" = _6N3Y7H36;
        "pkg-forge-1.21.1-7.jar" = _DAFaLbpD;
        "pkg-forge-1.21.3-7.jar" = _HHQGuJT1;
        "pkg-forge-1.21.4-7.jar" = _cBA0qQbF;
        "pkg-neoforge-1.20.6-7.jar" = _IpcXGpo6;
        "pkg-neoforge-1.21.1-7.jar" = _IQ6YukK6;
        "pkg-neoforge-1.21.3-7.jar" = _JIMHf5Cf;
        "pkg-neoforge-1.21.4-7.jar" = _wiWA1w8a;
        "pkg-fabric-1.18.2-7.1" = _9jRDAGER;
        "pkg-fabric-1.18.2-7.2" = _r7uuUPbj;
        "pkg-fabric-1.19.2-7.2" = _g1WHJ6sZ;
        "pkg-fabric-1.19.4-7.2" = _wYWRcVFH;
        "pkg-fabric-1.20.1-7.2" = _5jy3FqEk;
        "pkg-fabric-1.20.2-7.2" = _CF5BTkli;
        "pkg-fabric-1.20.4-7.2" = _NDICupp7;
        "pkg-fabric-1.20.6-7.2" = _qjKafJtS;
        "pkg-fabric-1.21.1-7.2" = _uRWaz1fD;
        "pkg-fabric-1.21.3-7.2" = _V1XhZwfP;
        "pkg-fabric-1.21.4-7.2" = _lOyGUPBR;
        "pkg-forge-1.18.2-7.2" = _AYWGq1lB;
        "pkg-forge-1.19.2-7.2" = _bnn3ka62;
        "pkg-forge-1.19.4-7.2" = _F1zINGtj;
        "pkg-forge-1.20.1-7.2" = _RPF3lvQo;
        "pkg-forge-1.20.2-7.2" = _6ZLZavXo;
        "pkg-forge-1.20.4-7.2" = _5TlmiVBD;
        "pkg-forge-1.20.6-7.2" = _9tcPGl1c;
        "pkg-forge-1.21.1-7.2" = _7RWweHpI;
        "pkg-forge-1.21.3-7.2" = _G1XSkm2n;
        "pkg-forge-1.21.4-7.2" = _hNpvuuSF;
        "pkg-neoforge-1.20.6-7.2" = _kQ8Gsx7y;
        "pkg-neoforge-1.21.1-7.2" = _ORpf8FL0;
        "pkg-neoforge-1.21.3-7.2" = _3wVrLs3G;
        "pkg-neoforge-1.21.4-7.2" = _bZBm00pD;
        "pkg-fabric-1.21.5-7.2" = _WzaSoSBd;
        "pkg-forge-1.21.5-7.2" = _PpXW58ff;
        "pkg-neoforge-1.21.5-7.2" = _reWtBCY0;
        "pkg-fabric-1.21.7-7.2" = _Nec6TOQN;
        "pkg-forge-1.21.7-7.2" = _leqspafy;
        "pkg-neoforge-1.21.7-7.2" = _udHuSNWM;
        "pkg-1.21.7-fabric-7.3" = _mA5Z1aVV;
        "pkg-1.21.7-forge-7.3" = _FTpDqwv2;
        "pkg-1.21.7-neoforge-7.3" = _BGwMfUZQ;
        "pkg-1.21.8-fabric-7.3" = _vvzXtaFm;
        "pkg-1.21.8-forge-7.3" = _hdX6Iv8y;
        "pkg-1.21.8-neoforge-7.3" = _FDKXALI0;
        "pkg-1.21.9-fabric-7.3" = _pDlctasD;
        "pkg-1.21.9-forge-7.3" = _JoxTxGON;
        "pkg-1.21.9-neoforge-7.3" = _tg5lQ4B3;
        "pkg-1.21.10-fabric-7.3" = _qTf4Bhor;
        "pkg-1.21.10-forge-7.3" = _QOnqV6yE;
        "pkg-1.21.10-neoforge-7.3" = _i3l3VxsS;
        "pkg-1.21.11-fabric-7.3" = _8ubSUeXd;
        "pkg-1.21.11-forge-7.3" = _1Ze1C0Im;
        "pkg-1.21.11-neoforge-7.3" = _zTt4EKXs;
        "pkg-26.1.1-fabric-7.3" = _uZDrlNAr;
        "pkg-26.1.1-forge-7.3" = _Q6xlqfYT;
        "pkg-26.1.1-neoforge-7.3" = _utyxinSp;
        "pkg-26.1.2-fabric-7.3" = _zBVu8FXm;
        "pkg-26.1.2-forge-7.3" = _RMwymN0R;
        "pkg-26.1.2-neoforge-7.3" = _7Dxjsn2i;
        "pkg-26.1.2-fabric-8" = _8Ae30koG;
        "pkg-26.1.2-forge-8" = _ET5TLhgA;
        "pkg-26.1.2-neoforge-8" = _gEsrcCmI;
        "pkg-26.2-fabric-8" = _5ee7uCG9;
        "pkg-26.2-forge-8" = _HskGLZfr;
        "pkg-26.2-neoforge-8" = _X0gvVhpX;
        "pkg-fabric-1.18.2-8" = _qu3QKidV;
        "pkg-fabric-1.19.2-8" = _CuwT9A57;
        "pkg-fabric-1.21.1-8" = _8hQP3zOi;
        "pkg-forge-1.18.2-8" = _efXdcMGD;
        "pkg-forge-1.19.2-8" = _juK4FDnq;
        "pkg-forge-1.21.1-8" = _Bo0F5eqc;
        "pkg-neoforge-1.21.1-8" = _LsRpiepA;
        "default" = _LsRpiepA;
    });
