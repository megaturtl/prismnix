...
let
    versions = (let
        ...
        _vvVxsdeA = {
            "id" = "vvVxsdeA";
            "file" = "AuroraCollections-1.6.0-b115.jar";
            "hash" = "sha512-6EL9DlT/mNMwnOuzQqUpOON8Jtju7pdWH7Ko5r+sRQdBnPUQdPclkwCL6bIXoumuUsFldQGbXkBu4uChEOp2jw==";
        };
    in {
        "Xl4afTze" = _Xl4afTze;
        "HaqgVbW5" = _HaqgVbW5;
        ...
        "pkg-1.4.8" = _b6e8QHxp;
        "pkg-1.4.9" = _N005HIq4;
        "pkg-1.4.10" = _qrEDk09I;
        "pkg-1.5.1" = _IMpqVDF1;
        "pkg-1.5.3" = _jgDjYd0E;
        "pkg-1.5.5" = _cLLM1pl4;
        "pkg-1.5.7" = _W5S1z1yg;
        "pkg-1.6.0-b115" = _vvVxsdeA;
        "default" = _vvVxsdeA;
    });
