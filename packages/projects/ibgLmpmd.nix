...
let
    ...
    in {
        ...
        "pkg-2.4.1" = _ObXklGC4;
        "pkg-4.9.2" = _y5fgqSqY;
        "pkg-4.10.0" = _25W0yFN0;
        "pkg-4.10.1" = _8nxgpbVW;
        "pkg-4.11.0" = _OHqveTtq;
        "pkg-4.11.1" = _G9fE0pc8;
        "pkg-4.11.2" = _lIuqyKRh;
        "pkg-4.11.3" = _WpCHv6SK;
        "pkg-4.11.4" = _LhaqVRFU;
        "pkg-4.11.5" = _4QJVc0e7;
        "pkg-4.11.6" = _6VfwWi7B;
        "pkg-4.11.7" = _s9noOURJ;
        "pkg-4.11.8" = _QHz9MY4S;
        "pkg-4.11.9" = _Nu14riA3;
        "pkg-4.11.10" = _XQFbS0SS;
        "pkg-4.11.11" = _hVT8vvzs;
        "pkg-4.11.12" = _OTsDFJip;
        "pkg-4.11.13" = _7gETlMlY;
        "pkg-4.11.14" = _Lny7gKAG;
