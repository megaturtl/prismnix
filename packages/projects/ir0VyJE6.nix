...
let
    versions = (let
        ...
        _O0vonIOi = {
            "id" = "O0vonIOi";
            "file" = "elytra_black-1.0.1-mc26.3.zip";
            "hash" = "sha512-YITQivVa/wKzUFAQYmhsi/MBJWGuKoo3/HF4lEwQwWeVYn0GG+V9ibeac6BjmTwccb346EgqOwJ7LUcZWBkLXg==";
        };
    in {
        "oTtypC7a" = _oTtypC7a;
        "eFBfg7TP" = _eFBfg7TP;
