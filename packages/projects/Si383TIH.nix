...
let
    ...
    in {
        ...
        "pkg-1.19.4-1.8.6" = _YYxoHNs5;
        "pkg-1.20.1-1.8.6" = _U8gk0aHv;
        "pkg-1.18.2-1.8.7" = _hn9M6qJQ;
        "pkg-1.19.4-1.8.7" = _9PWYP9KM;
        "pkg-1.20.1-1.8.7" = _74JRz5zG;
        "pkg-1.18.2-1.8.8" = _y4M88lpJ;
        "pkg-1.19.4-1.8.8" = _QPdfjbRI;
        "pkg-1.20.1-1.8.8" = _jKZyiRlK;
        "pkg-1.18.2-1.8.9" = _aXW8kxEt;
        "pkg-1.19.4-1.8.9" = _fHyRW6OC;
        "pkg-1.20.1-1.8.9" = _kDpeBhNS;
        "pkg-1.18.2-1.8.10" = _puqANM98;
        "pkg-1.19.4-1.8.10" = _hD1ApL7b;
        "pkg-1.20.1-1.8.10" = _PHh86EaH;
        "pkg-1.18.2-1.8.11" = _NttYBiLH;
        "pkg-1.19.4-1.8.11" = _tw6K2tYX;
        "pkg-1.20.1-1.8.11" = _XVGSmt5Q;
        "pkg-1.20.2-1.8.11" = _n2m9w9jB;
        "pkg-1.18.2-1.9.0" = _OrR5y4Wo;
        "pkg-1.20.1-1.9.0" = _ik1X2XSq;
        "pkg-1.20.2-1.9.0" = _45EwMBgu;
        "pkg-1.18.2-1.9.1" = _dr3rp0gp;
        "pkg-1.20.1-1.9.1" = _Qt0nm50n;
        "pkg-1.18.2-1.10.0" = _gVC5uS0R;
        "pkg-1.20.1-1.10.0" = _KlIv1hoc;
        "pkg-1.20.5-1.10.0" = _GeA4CJrj;
        "pkg-1.20.5-1.10.1" = _vMVspo7o;
        "pkg-1.20.5-1.10.2" = _zrbF20Su;
        "pkg-1.20.6-1.10.3" = _aGUcynpR;
        "pkg-1.18.2-1.10.4" = _qVjwCvxf;
        "pkg-1.20.1-1.10.4" = _GqlmBoUl;
        "pkg-1.20.6-1.10.4" = _yBsANDz6;
        "pkg-1.18.2-1.10.5" = _JGBXL9Sn;
        "pkg-1.20.1-1.10.5" = _ISztyN6L;
        "pkg-1.20.6-1.10.5" = _3weCEAdq;
        "pkg-1.21-1.10.5" = _QuNULDgb;
        "pkg-1.18.2-1.10.6" = _UnOfhjMT;
        "pkg-1.20.1-1.10.6" = _1hNeFAo9;
        "pkg-1.21-1.10.6" = _q4evVWFH;
        "pkg-1.18.2-1.10.7" = _XbfkPSuT;
        "pkg-1.20.1-1.10.7" = _sZ8LRqWU;
        "pkg-1.21-1.10.7" = _kAXJr6DF;
        "pkg-1.18.2-1.10.8" = _OYjpIwR0;
        "pkg-1.20.1-1.10.8" = _P3Yfd9aZ;
        "pkg-1.21.1-1.10.8" = _j9iJEX2p;
        "pkg-1.18.2-1.10.9" = _bhEOJpXv;
        "pkg-1.20.1-1.10.9" = _R6bcKng3;
        "pkg-1.21.1-1.10.9" = _sCayzFsM;
        "pkg-1.18.2-1.10.10" = _p1ESsA2Z;
        "pkg-1.20.1-1.10.10" = _1y9f1Q67;
        "pkg-1.21.1-1.10.10" = _a9bawfJG;
        "pkg-1.18.2-1.11.0" = _pMla9rYq;
        "pkg-1.20.1-1.11.0" = _lyu8uypx;
        "pkg-1.21.1-1.11.0" = _pZrwR1Ay;
        "pkg-1.18.2-1.11.1" = _guLg1lNq;
        "pkg-1.20.1-1.11.1" = _9Txevxuh;
        "pkg-1.21.1-1.11.1" = _7bAxvcER;
        "pkg-1.18.2-1.11.2" = _6VJuLR2a;
        "pkg-1.20.1-1.11.2" = _q3QG5RpY;
        "pkg-1.21.1-1.11.2" = _6dCljeQj;
        "pkg-1.20.1-1.11.3" = _Cq2iK7SX;
        "pkg-1.21.1-1.11.3" = _am8GVbpO;
        "pkg-1.18.2-1.11.4" = _slPdp3cP;
        "pkg-1.20.1-1.11.4" = _1Chg4h7M;
        "pkg-1.21.1-1.11.4" = _aKeG3Equ;
        "pkg-1.18.2-1.11.5-fabric" = _k7ALdDmi;
        "pkg-1.18.2-1.11.5-forge" = _DAdPWcS2;
        "pkg-1.20.1-1.11.5-fabric" = _arllPSf9;
        "pkg-1.20.1-1.11.5-forge" = _qWD5qfqa;
        "pkg-1.21.1-1.11.5-fabric" = _rECtdkPy;
        "pkg-1.21.1-1.11.5-neoforge" = _QH4XiOn4;
        "pkg-1.18.2-1.11.6-fabric" = _grUbtv8I;
        "pkg-1.18.2-1.11.6-forge" = _3Yj8G2OK;
        "pkg-1.20.1-1.11.6-fabric" = _w5enlPbd;
        "pkg-1.20.1-1.11.6-forge" = _nKvAoe0a;
        "pkg-1.21.1-1.11.6-fabric" = _fc1KF6p8;
        "pkg-1.21.1-1.11.6-neoforge" = _Vdv5WUlA;
        "pkg-1.18.2-1.11.7-fabric" = _lbmek3mi;
        "pkg-1.18.2-1.11.7-forge" = _vsQOzCz4;
        "pkg-1.20.1-1.11.7-fabric" = _PniGlCy3;
        "pkg-1.20.1-1.11.7-forge" = _cqA297hM;
        "pkg-1.21.1-1.11.7-fabric" = _LE9LFviv;
        "pkg-1.21.1-1.11.7-neoforge" = _497DgI8m;
        "pkg-1.18.2-1.11.7.b-fabric" = _tOj5efoT;
        "pkg-1.20.1-1.11.7.b-fabric" = _ozki0QaU;
        "pkg-1.21.1-1.11.7.b-fabric" = _QsJdYgZ1;
        "pkg-1.18.2-1.11.8-fabric" = _meewgHyK;
        "pkg-1.18.2-1.11.8-forge" = _O5NxPxIR;
        "pkg-1.20.1-1.11.8-fabric" = _cKRHv563;
        "pkg-1.20.1-1.11.8-forge" = _VluC4gGH;
        "pkg-1.21.4-1.11.7.b-fabric" = _9EC25rAV;
        "pkg-1.21.4-1.11.7.b-neoforge" = _mvodm3Kb;
        "pkg-1.18.2-1.11.9-fabric" = _22UlyM3j;
        "pkg-1.18.2-1.11.9-forge" = _s6eSPmQi;
        "pkg-1.20.1-1.11.9-fabric" = _luZpDc7x;
        "pkg-1.20.1-1.11.9-forge" = _aE3QgTep;
        "pkg-1.21.1-1.11.9-fabric" = _6UnsDxum;
        "pkg-1.21.1-1.11.9-neoforge" = _uh5it2U0;
        "pkg-1.21.1-1.11.10-fabric" = _jempGRZH;
        "pkg-1.21.1-1.11.10-neoforge" = _IkdlRyJP;
        "pkg-1.21.1-1.11.11-fabric" = _PiRYNSbp;
        "pkg-1.21.1-1.11.11-neoforge" = _yAGepV68;
        "pkg-1.21.5-1.11.11-fabric" = _jRG5SIkh;
        "pkg-1.21.5-1.11.11-neoforge" = _cS5Ix1Z5;
        "pkg-1.20.1-1.11.12-fabric" = _D2dGWNoN;
        "pkg-1.20.1-1.11.12-forge" = _sRvGVM1f;
        "pkg-1.21.1-1.11.12-fabric" = _8xVBcgvR;
        "pkg-1.21.1-1.11.12-neoforge" = _TEDWRAHw;
        "pkg-1.21.5-1.11.12-fabric" = _gmih3WQ0;
        "pkg-1.21.5-1.11.12-neoforge" = _MoKlr7ce;
        "pkg-1.20.1-1.11.13-fabric" = _e4fJqTth;
        "pkg-1.20.1-1.11.13-forge" = _Xb6xO0gU;
        "pkg-1.21.1-1.11.13-fabric" = _AGTSVerX;
        "pkg-1.21.1-1.11.13-neoforge" = _yk9qWcZo;
        "pkg-1.21.5-1.11.13-fabric" = _WDYbT5JZ;
        "pkg-1.21.5-1.11.13-neoforge" = _2f8k4r0d;
        "pkg-1.20.1-1.11.14-fabric" = _jRgFger1;
        "pkg-1.20.1-1.11.14-forge" = _V7B11Tv6;
        "pkg-1.21.1-1.11.14-fabric" = _ZBOxOhJW;
        "pkg-1.21.1-1.11.14-neoforge" = _IFT5oiv5;
        "pkg-1.21.5-1.11.14-fabric" = _aSVQ0Cvt;
        "pkg-1.21.5-1.11.14-neoforge" = _6foU0OG9;
        "pkg-1.21.1-1.11.15-fabric" = _nKHTR7JT;
        "pkg-1.21.1-1.11.15-neoforge" = _VU79CeKv;
        "pkg-1.21.5-1.11.15-fabric" = _wyArUDUU;
        "pkg-1.21.5-1.11.15-neoforge" = _Dir0yhlL;
        "pkg-1.21.8-1.11.15-fabric" = _g9SHShkG;
        "pkg-1.21.8-1.11.15-neoforge" = _ZOC6p58O;
        "pkg-1.21.1-1.12.0-fabric" = _sJrDauE3;
        "pkg-1.21.1-1.12.0-neoforge" = _v7t3XRcB;
        "pkg-1.21.5-1.12.0-fabric" = _Xi75GjpP;
        "pkg-1.21.5-1.12.0-neoforge" = _757ezL1Z;
        "pkg-1.21.8-1.12.0-fabric" = _QYQuQVjC;
        "pkg-1.21.8-1.12.0-neoforge" = _F2Hoafg8;
        "pkg-1.20.1-1.11.15-fabric" = _JXtLUvZh;
        "pkg-1.20.1-1.11.15-forge" = _21tMHcQr;
        "pkg-1.21.1-1.12.1-fabric" = _OrDcCAju;
        "pkg-1.21.1-1.12.1-neoforge" = _9ZR9DNN3;
        "pkg-1.21.8-1.12.1-fabric" = _qnMicRmc;
        "pkg-1.21.8-1.12.1-neoforge" = _JcYIiPmD;
        "pkg-1.21.1-1.12.2-neoforge" = _2vBM7bqd;
        "pkg-1.21.1-1.12.2-fabric" = _X2BdRhgA;
        "pkg-1.21.8-1.12.2-neoforge" = _kNOH8BbJ;
        "pkg-1.21.8-1.12.2-fabric" = _b7ZPdbMm;
        "pkg-1.21.8-1.12.3-neoforge" = _uElHVbvo;
        "pkg-1.21.8-1.12.3-fabric" = _NB9Ojm8P;
        "pkg-1.21.1-1.12.3-neoforge" = _mqh2qOkr;
        "pkg-1.21.1-1.12.3-fabric" = _ehtAASE3;
        "pkg-1.21.1-1.12.4-neoforge" = _pYenTixP;
        "pkg-1.21.1-1.12.4-fabric" = _SYLx8FOz;
        "pkg-1.21.8-1.12.4-neoforge" = _LqvRphAx;
        "pkg-1.21.8-1.12.4-fabric" = _3CH7e15a;
        "pkg-1.21.1-1.12.5-neoforge" = _ieFiWFwd;
        "pkg-1.21.1-1.12.5-fabric" = _b5UMLaHO;
        "pkg-1.21.8-1.12.5-neoforge" = _yGL4XM4r;
        "pkg-1.21.8-1.12.5-fabric" = _zDemKokA;
        "pkg-1.21.10-1.12.5-fabric" = _Tp7svqko;
        "pkg-1.21.10-1.12.5-neoforge" = _joDxvzKU;
        "pkg-1.21.11-1.12.5-fabric" = _S3VCCsE6;
        "pkg-1.21.11-1.12.5-neoforge" = _gXI9wyee;
        "pkg-1.20.1-1.11.16-fabric" = _Tc08lTqp;
        "pkg-1.20.1-1.11.16-forge" = _Gh42Sknw;
        "pkg-1.21.1-1.12.6-fabric" = _jbWQb1U8;
        "pkg-1.21.1-1.12.6-neoforge" = _1Fm1glFi;
        "pkg-1.21.11-1.12.6-fabric" = _ziiNDTDh;
        "pkg-1.21.11-1.12.6-neoforge" = _iormSy2b;
        "pkg-26.1.2-1.12.6-neoforge" = _5LhPIpro;
        "pkg-26.1.2-1.12.6-fabric" = _RukLXWeW;
        "pkg-1.21.1-1.12.7-fabric" = _Dozjx0xr;
        "pkg-1.21.1-1.12.7-neoforge" = _2PanOvza;
        "pkg-1.21.11-1.12.7-fabric" = _5Kz9KVo2;
