...
let
    versions = (let
        ...
        _lqOk72SG = {
            "id" = "lqOk72SG";
            "file" = "NewLogin-4.0.2.jar";
            "hash" = "sha512-WwyLKdp3K4W9x4Td2F4fgquRno4ixgkIG/YK7JSyV7sgqZmygYHsruVPKGMWcADEI9D3DRP2z2OBgkMsrborUQ==";
        };
    in {
        "BiHUQFpd" = _BiHUQFpd;
        "LkEbVvj4" = _LkEbVvj4;
        ...
        "paper-1.21" = _lqOk72SG;
        "paper-1.21.1" = _lqOk72SG;
        "paper-1.21.2" = _lqOk72SG;
        "paper-1.21.3" = _lqOk72SG;
        "paper-1.21.4" = _lqOk72SG;
        "paper-1.21.5" = _lqOk72SG;
        "paper-1.21.6" = _lqOk72SG;
        "paper-1.21.7" = _lqOk72SG;
        "paper-1.21.8" = _lqOk72SG;
        "paper-1.21.9" = _lqOk72SG;
        "paper-1.21.10" = _lqOk72SG;
        "paper-1.21.11" = _lqOk72SG;
        "pkg-1.0-SNAPSHOT" = _BiHUQFpd;
        "pkg-2.0" = _LkEbVvj4;
        "pkg-3.0" = _Vxkgl4Cb;
        "pkg-4.0" = _IoIw5Krq;
        "pkg-4.0.1" = _8HoHvWlB;
