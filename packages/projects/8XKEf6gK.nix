...
let
    versions = (let
        ...
        _hmR4BJfU = {
            "id" = "hmR4BJfU";
            "file" = "LagCleanerX-1.2.jar";
            "hash" = "sha512-LsHoHJAm6LN/85ZNP4x37EEbotONnSDDk5y66eylnfHhuaAkjz9HejBsq6K9ZlPvZOktJCqbDruBMPM6SRsdqg==";
        };
    in {
        "M4iYr36j" = _M4iYr36j;
        "h2i3rRqA" = _h2i3rRqA;
        ...
        "bukkit-1.21" = _hmR4BJfU;
        "bukkit-1.21.1" = _hmR4BJfU;
        "bukkit-1.21.2" = _hmR4BJfU;
        "bukkit-1.21.3" = _hmR4BJfU;
        "bukkit-1.21.4" = _hmR4BJfU;
        "bukkit-1.21.5" = _hmR4BJfU;
        "bukkit-1.21.6" = _hmR4BJfU;
        "bukkit-1.21.7" = _hmR4BJfU;
        "bukkit-1.21.8" = _hmR4BJfU;
        "bukkit-1.21.9" = _hmR4BJfU;
        "bukkit-1.21.10" = _hmR4BJfU;
        "bukkit-1.21.11" = _hmR4BJfU;
        "bukkit-26.1" = _hmR4BJfU;
        "bukkit-26.1.1" = _hmR4BJfU;
        "bukkit-26.1.2" = _hmR4BJfU;
        "bukkit-26.2" = _hmR4BJfU;
        "bukkit-26.3" = _hmR4BJfU;
        ...
        "paper-1.21" = _hmR4BJfU;
        "paper-1.21.1" = _hmR4BJfU;
        "paper-1.21.2" = _hmR4BJfU;
        "paper-1.21.3" = _hmR4BJfU;
        "paper-1.21.4" = _hmR4BJfU;
        "paper-1.21.5" = _hmR4BJfU;
        "paper-1.21.6" = _hmR4BJfU;
        "paper-1.21.7" = _hmR4BJfU;
        "paper-1.21.8" = _hmR4BJfU;
        "paper-1.21.9" = _hmR4BJfU;
        "paper-1.21.10" = _hmR4BJfU;
        "paper-1.21.11" = _hmR4BJfU;
        "paper-26.1" = _hmR4BJfU;
        "paper-26.1.1" = _hmR4BJfU;
        "paper-26.1.2" = _hmR4BJfU;
        "paper-26.2" = _hmR4BJfU;
        "paper-26.3" = _hmR4BJfU;
        ...
        "spigot-1.21" = _hmR4BJfU;
        "spigot-1.21.1" = _hmR4BJfU;
        "spigot-1.21.2" = _hmR4BJfU;
        "spigot-1.21.3" = _hmR4BJfU;
        "spigot-1.21.4" = _hmR4BJfU;
        "spigot-1.21.5" = _hmR4BJfU;
        "spigot-1.21.6" = _hmR4BJfU;
        "spigot-1.21.7" = _hmR4BJfU;
        "spigot-1.21.8" = _hmR4BJfU;
        "spigot-1.21.9" = _hmR4BJfU;
        "spigot-1.21.10" = _hmR4BJfU;
        "spigot-1.21.11" = _hmR4BJfU;
        "spigot-26.1" = _hmR4BJfU;
        "spigot-26.1.1" = _hmR4BJfU;
        "spigot-26.1.2" = _hmR4BJfU;
        "spigot-26.2" = _hmR4BJfU;
        "spigot-26.3" = _hmR4BJfU;
        "pkg-1.0" = _h2i3rRqA;
        "pkg-1.1" = _hFCilJKl;
        "pkg-1.1-Special" = _LtpdrZHl;
        "pkg-1.2" = _auYabCZ1;
        "pkg-1.2-1" = _q8HAwPd3;
        "pkg-1.2-2" = _yfluTdR4;
        "pkg-1.2-3" = _FxEGkizq;
