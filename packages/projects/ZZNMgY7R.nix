...
let
    ...
    in {
        ...
        "pkg-1.1" = _8ZFi5m2x;
        "pkg-1.1.1+mod" = _VUp1fcw0;
        "pkg-1.2" = _B7n4X3Hu;
        "pkg-1.2.1+mod" = _vXNuUOeV;
        "pkg-1.3" = _3mkKB1mR;
        "pkg-1.3.1+mod" = _t0wI5oP2;
        "pkg-1.4" = _e7KhGp3n;
        "pkg-1.4.1+mod" = _riG6Jvo1;
        "pkg-1.5" = _N4ztqACk;
        "pkg-1.5.1+mod" = _EtcdQ2DD;
        "pkg-1.6" = _7UJRBdY0;
        "pkg-1.6.1+mod" = _LjGUOHkw;
        "pkg-1.7" = _gHP2E3KE;
        "pkg-1.7.1+mod" = _p6s5DOgD;
        "pkg-1.8" = _Y7IXtdQ4;
        "pkg-1.8.1+mod" = _BhHCiQex;
        "pkg-1.9" = _gMI1N0Ib;
