...
let
    ...
    in {
        ...
        "pkg-1.1.0+1.21.1+fabric" = _LGUV3Iqf;
        "pkg-1.2.0+1.21.1" = _LghMDisA;
        "pkg-1.2.1+1.21.1" = _tb8Gqhxr;
        "pkg-1.2.2+1.21.1" = _5HwJA1zV;
        "pkg-1.2.3+1.21.1" = _Kmiwtpbf;
        "pkg-1.2.4+1.21.1" = _vkLSCw0Q;
        "pkg-1.2.5+1.21.1" = _nqZ7d2u4;
        "pkg-1.3.0+1.21.8-fabric" = _5WgrrqEd;
        "pkg-1.3.0+1.21.8-neoforge" = _GwawbkQ2;
        "pkg-1.3.1+1.21.8-fabric" = _dglgL4X6;
        "pkg-1.3.1+1.21.8-neoforge" = _lFtapLIR;
        "pkg-1.3.2+1.21.8-fabric" = _OeTCtHfN;
        "pkg-1.3.2+1.21.8-neoforge" = _QzvW9DvZ;
        "pkg-1.3.3+1.21.8-neoforge" = _oJFNMwkw;
        "pkg-1.3.3+1.21.8-fabric" = _V0BVRuVn;
        "pkg-1.3.4+1.21.8-neoforge" = _dcTXOyhb;
        "pkg-1.3.4+1.21.8-fabric" = _BgcaMAUa;
        "pkg-1.4.0+26.1-fabric" = _stN9maSz;
        "pkg-1.4.1+26.1-neoforge" = _RoIMkrRI;
        "pkg-1.4.1+26.1-fabric" = _e5vvECo5;
