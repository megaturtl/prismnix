...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.21.3" = _ZuKNKqIF;
        "pkg-1.1-1.21.1" = _D7Bpl7tO;
        "pkg-1.1-1.21.3" = _sohgk9d4;
        "pkg-1.21.4-1.1" = _ny7aVhIZ;
        "pkg-1.21.4-1.2" = _ig3kb6vx;
        "pkg-1.21.4-1.3" = _DrhfolyI;
        "pkg-1.21.5-1.3" = _mn7aQa18;
        "pkg-1.21.5-1.4" = _xwdgEe01;
        "pkg-1.21.5-1.4.1" = _vmBxnFT6;
        "pkg-1.21.1-1.4.1" = _3mPjBGgz;
        "pkg-1.21.5-1.4.2" = _iUx9IX4Z;
        "pkg-1.21.5-1.5" = _TdYMskre;
        "pkg-1.21.5-1.5.0.1" = _IzlMPfhg;
        "pkg-1.21.7-1.5.0.1" = _qrr0tUho;
        "pkg-1.21.8-1.6" = _1gXakaGn;
        "pkg-1.21.8-1.7" = _k249otVJ;
        "pkg-1.21.8-1.7.1" = _NKTltE4n;
        "pkg-1.21.8-1.7.2" = _hlI2MzWo;
        "pkg-1.21.10-1.7.2" = _Ncq4LgPl;
        "pkg-1.21.10-1.7.3" = _si4Cr96l;
