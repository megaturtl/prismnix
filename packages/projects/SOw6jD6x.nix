...
let
    ...
    in {
        ...
        "pkg-1.16.5-0.7.3r" = _vZ5t9aEr;
        "pkg-1.17.1-0.7.3r" = _m4pmHX90;
        "pkg-1.16.5-0.7.4r" = _po7z9YiW;
        "pkg-1.16.5-0.7.4.1b" = _zHDx1BoQ;
        "pkg-1.16.5-0.7.5r" = _c7FDbzd0;
        "pkg-1.17.1-0.7.5r" = _nI9G7kTz;
        "pkg-1.17.1-0.7.5.1r" = _Gp0LDrxn;
        "pkg-1.17.1-0.7.6r" = _IT66x7qg;
        "pkg-1.18-0.7.7r" = _MbVZHpt4;
        "pkg-1.18-0.7.7.1r" = _IfNYAe8a;
        "pkg-1.16.5-0.7.6r" = _U83hdaZU;
        "pkg-1.18.1-0.7.8r" = _gmgIeoeS;
        "pkg-1.18.1-0.7.8.1r" = _qgGnbBUN;
        "pkg-1.16.5-0.7.7r" = _JmsCEsZU;
        "pkg-1.18.1-0.7.9r" = _WjxXJMup;
        "pkg-1.18.1-0.7.10b" = _E7yMRKxy;
        "pkg-1.18.1-0.7.11b" = _LdQaWXic;
        "pkg-1.18.1-0.7.12b" = _VrIdXGcQ;
        "pkg-1.18.2-0.7.13a" = _BbgwUmgf;
        "pkg-1.18.2-0.7.14b" = _HDQXZ9Dr;
        "pkg-1.16.5-0.7.8r" = _hMR6MpaQ;
        "pkg-1.16.5-0.7.9r" = _ynNPTVbq;
        "pkg-1.16.5-0.7.10r" = _neYxvc4A;
        "pkg-1.18.2-0.7.15b" = _7rUajEKy;
        "pkg-1.18.2-0.7.16b" = _QvR5lHfY;
        "pkg-1.18.2-0.7.17r" = _eQSy1P94;
        "pkg-1.18.2-0.7.19r" = _rrTXiAxC;
        "pkg-1.19.2-1.19.2-0.7.19a" = _JnzmAR9m;
        "pkg-1.19.2-0.7.20a" = _zlAcuf8u;
        "pkg-1.19.2-0.7.21b" = _8xZWHFlj;
        "pkg-1.18.2-0.7.20r" = _bzjkEzGX;
        "pkg-1.19.2-0.7.22b" = _3fLpNP9J;
        "pkg-1.18.2-0.7.21r" = _NqqaUEgo;
        "pkg-1.18.2-0.7.22r" = _clKkMp9x;
        "pkg-1.18.2-0.7.23r" = _7KnBCRhd;
        "pkg-1.18.2-0.7.24r" = _BPffeGth;
        "pkg-1.19.3-0.7.23b" = _55i1jYkA;
        "pkg-1.18.2-0.7.25r" = _v36LZWQi;
        "pkg-1.19.3-0.7.24b" = _jmfYKT7a;
        "pkg-1.18.2-0.7.26r" = _huPY4ULt;
        "pkg-1.19.3-0.7.25b" = _sIyxEqOP;
        "pkg-1.19.2-0.7.24b" = _Nk9vo2wT;
        "pkg-1.18.2-0.7.27r" = _1jfxbtfk;
        "pkg-1.19.2-0.7.25r" = _LcWI2PJY;
        "pkg-1.19.3-0.7.26r" = _gv47d4uw;
        "pkg-1.19.2-0.7.26r" = _mLykJTDl;
        "pkg-1.18.2-0.7.28r" = _4zeiegTI;
        "pkg-1.19.3-0.7.27r" = _iPF1bvoI;
        "pkg-1.18.2-0.7.29r" = _pkgxuXf5;
        "pkg-1.19.2-0.7.27r" = _RWOKaY7u;
        "pkg-1.19.3-0.7.28r" = _fjwjqZIC;
        "pkg-1.19.3-0.7.29r" = _zpmKxdAR;
        "pkg-1.19.2-0.7.28r" = _9Xc7VgV1;
        "pkg-1.20.1-0.7.30a" = _z2D203Y4;
        "pkg-1.18.2-0.7.30r" = _674pcMYk;
        "pkg-1.20.1-0.7.31a" = _WeJYWoW8;
        "pkg-1.19.2-0.7.29r" = _80TlMsnq;
        "pkg-1.18.2-0.7.31r" = _bdjbZpsR;
        "pkg-1.19.2-0.7.30r" = _qxxMz7df;
        "pkg-1.20.1-0.7.32b" = _2awIKK1f;
        "pkg-1.19.2-0.7.31r" = _uWk04Ehm;
        "pkg-1.20.1-0.7.33b" = _qY9WO1OJ;
        "pkg-1.20.1-0.7.34b" = _B3tpfT5Z;
        "pkg-1.19.2-0.7.32r" = _cKgd9PB2;
        "pkg-1.20.1-0.7.35b" = _pu3tqHwr;
        "pkg-1.20.1-0.7.36r" = _xmRykeCl;
        "pkg-1.19.2-0.7.33r" = _Rmz2ZFWs;
        "pkg-1.20.1-0.7.37r" = _nBfuxwmY;
        "pkg-1.20.1-0.7.38r" = _ptFMzRpp;
        "pkg-1.19.2-0.7.34r" = _ydS3y44I;
        "pkg-1.19.2-0.7.36r" = _RvfiETvk;
        "pkg-1.20.1-0.7.40r" = _79TFdBOE;
        "pkg-1.19.2-0.7.37r" = _tyq5TAqM;
        "pkg-1.20.1-0.7.41r" = _n4Npq89k;
        "pkg-1.20.4-0.7.43a" = _y560A8Ti;
        "pkg-1.21.1-0.7.45a" = _pTQyroKP;
        "pkg-1.21.1-0.7.46a" = _VTkvR2Dr;
        "pkg-1.21.1-0.7.47a" = _oCWUq6qU;
        "pkg-1.21.1-0.7.48a" = _JP7yeVkK;
        "pkg-1.21.1-0.7.49a" = _UVWcaeN6;
        "pkg-1.20.1-0.7.42r" = _2OF7mkUC;
        "pkg-1.20.1-0.7.43r" = _fhj2MzwF;
        "pkg-1.20.1-0.7.44r" = _toqbt6Np;
        "pkg-1.21.1-0.7.50b" = _mJI1inYM;
        "pkg-1.21.1-0.7.51b" = _rNtm8dlS;
        "pkg-1.21.1-0.7.52b" = _DXHDNHuX;
        "pkg-1.21.1-0.7.53b" = _XJCfUkvi;
        "pkg-1.21.1-0.7.54b" = _y3BteqHP;
        "pkg-1.21.1-0.7.55b" = _3BVowKOD;
        "pkg-1.20.1-0.7.45r" = _MIJ2rMf2;
        "pkg-1.21.1-0.7.56b" = _J7d95n1v;
        "pkg-1.21.1-0.7.57b" = _z6vQt0Qv;
        "pkg-1.20.1-0.7.46r" = _h2HTYvNe;
        "pkg-1.21.1-0.7.58b" = _aKTbrv4u;
        "pkg-1.21.1-0.7.59b" = _Oo1gJHz0;
        "pkg-1.21.1-0.7.60b" = _6dWv7pgB;
        "pkg-1.21.1-0.7.61b" = _Q4pvAMQj;
