...
let
    versions = (let
        ...
        _FzKDA24C = {
            "id" = "FzKDA24C";
            "file" = "EFA_1.10.4 Hotfix 3.zip";
            "hash" = "sha512-ggosNzKe547OWLovM0cjJxFQ00tA5KHblvLAr5Ty1P56dK4xq7fPx3gvgq5Pb8hp0XiKwOTRNEAhXxtts4o9BQ==";
        };
        _UmkPWet8 = {
            "id" = "UmkPWet8";
            "file" = "EFA_1.10.5 Hotfix 1.zip";
            "hash" = "sha512-X6TFXKGBGSzThKmOcrwFsS3C2yFGVdn1cCT0VlQsuVH3te+b7jER2Rl6PtIZQ2p37cJsdYd5t+wSTIhNKwaCqQ==";
        };
    in {
        "G8mYH66b" = _G8mYH66b;
        "BI7JTsP2" = _BI7JTsP2;
        ...
        "FzKDA24C" = _FzKDA24C;
        "UmkPWet8" = _UmkPWet8;
        "minecraft-1.20" = _FzKDA24C;
        "minecraft-1.20.1" = _FzKDA24C;
        "minecraft-1.20.2" = _FzKDA24C;
        "minecraft-1.19.3" = _QqXmhaey;
        "minecraft-1.19.4" = _QqXmhaey;
        "minecraft-1.20.3" = _FzKDA24C;
        "minecraft-1.20.4" = _FzKDA24C;
        "minecraft-1.20.5" = _FzKDA24C;
        "minecraft-1.20.6" = _FzKDA24C;
        "minecraft-1.21" = _FzKDA24C;
        "minecraft-1.21.1" = _FzKDA24C;
        "minecraft-1.21.2" = _FzKDA24C;
        "minecraft-1.21.3" = _FzKDA24C;
        "minecraft-1.21.4" = _FzKDA24C;
        "minecraft-1.21.5" = _FzKDA24C;
        "minecraft-1.21.6" = _FzKDA24C;
        "minecraft-1.21.7" = _FzKDA24C;
        "minecraft-1.21.8" = _FzKDA24C;
        "minecraft-1.21.9" = _FzKDA24C;
        "minecraft-1.21.10" = _FzKDA24C;
        "minecraft-1.21.11" = _FzKDA24C;
        "minecraft-26.1" = _UmkPWet8;
        "minecraft-26.1.1" = _UmkPWet8;
        "minecraft-26.1.2" = _UmkPWet8;
        "minecraft-26.2" = _UmkPWet8;
        "minecraft-23w31a" = _FzKDA24C;
        "minecraft-23w32a" = _FzKDA24C;
        "minecraft-23w33a" = _FzKDA24C;
        "minecraft-23w35a" = _FzKDA24C;
        "minecraft-1.20.2-pre1" = _FzKDA24C;
        "minecraft-23w42a" = _FzKDA24C;
        "minecraft-23w43a" = _FzKDA24C;
        "minecraft-23w43b" = _FzKDA24C;
        "minecraft-23w44a" = _FzKDA24C;
        "minecraft-23w45a" = _FzKDA24C;
        "minecraft-23w46a" = _FzKDA24C;
        "minecraft-24w03a" = _FzKDA24C;
        "minecraft-24w03b" = _FzKDA24C;
        "minecraft-24w04a" = _FzKDA24C;
        "minecraft-24w05a" = _FzKDA24C;
        "minecraft-24w05b" = _FzKDA24C;
        "minecraft-24w06a" = _FzKDA24C;
        "minecraft-24w07a" = _FzKDA24C;
        "minecraft-24w09a" = _FzKDA24C;
        "minecraft-24w10a" = _FzKDA24C;
        "minecraft-24w11a" = _FzKDA24C;
        "minecraft-24w12a" = _FzKDA24C;
        "minecraft-24w13a" = _FzKDA24C;
        "minecraft-24w14potato" = _FzKDA24C;
        "minecraft-24w14a" = _FzKDA24C;
        "minecraft-1.20.5-pre1" = _FzKDA24C;
        "minecraft-1.20.5-pre2" = _FzKDA24C;
        "minecraft-1.20.5-pre3" = _FzKDA24C;
        "minecraft-24w18a" = _FzKDA24C;
        "minecraft-24w19a" = _FzKDA24C;
        "minecraft-24w19b" = _FzKDA24C;
        "minecraft-24w20a" = _FzKDA24C;
        "minecraft-24w33a" = _FzKDA24C;
        "minecraft-24w34a" = _FzKDA24C;
        "minecraft-24w35a" = _FzKDA24C;
        "minecraft-24w36a" = _FzKDA24C;
        "minecraft-24w37a" = _FzKDA24C;
        "minecraft-24w38a" = _FzKDA24C;
        "minecraft-24w39a" = _FzKDA24C;
        "minecraft-24w40a" = _FzKDA24C;
        "minecraft-1.21.2-pre1" = _FzKDA24C;
        "minecraft-1.21.2-pre2" = _FzKDA24C;
        "minecraft-24w44a" = _FzKDA24C;
        "minecraft-24w45a" = _FzKDA24C;
        "minecraft-24w46a" = _FzKDA24C;
        "pkg-1" = _G8mYH66b;
        "pkg-3" = _BI7JTsP2;
        "pkg-5" = _dCfPM0zc;
        "pkg-6" = _7mLC6X8r;
        ...
        "pkg-9" = _UuGfiAjh;
        "pkg-10" = _KV2UpLU0;
        "pkg-215.1.a" = _w3QQKdq1;
        "pkg-215.1.b" = _zrL21REA;
        "pkg-215.3.a" = _6WD8e4Wl;
        "pkg-215.3.b" = _xhPypw8U;
        "pkg-215.4.a" = _sLPhYOEK;
        "pkg-215.4.b" = _mnFrY3gF;
        "pkg-1.10.3" = _cPOk11si;
        "pkg-1.10.3_1" = _g2ApEAj5;
        "pkg-1.10.4" = _SqBZVEws;
        "pkg-1.10.4_1" = _jwrJHzL3;
        "pkg-1.10.4_2" = _jiXWu7yt;
        "pkg-1.10.5" = _ielVMJns;
        "pkg-1.10.4_3" = _FzKDA24C;
        "pkg-1.10.5_1" = _UmkPWet8;
        "default" = _UmkPWet8;
    });
