...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _qyvH7jHI;
        "pkg-1.1.1" = _UceR7xAs;
        "pkg-0.0.1-forge-beta" = _mvk0zApe;
        "pkg-0.0.2-forge-beta" = _p7Evwja6;
        "pkg-1.1.2" = _NipXupke;
        "pkg-1.1.3" = _8bg6KBnU;
        "pkg-1.1.4" = _f0otsOhE;
        "pkg-1.1.5" = _iPcOEhWL;
        ...
        "pkg-1.1.7" = _6NvJ1FGY;
        "pkg-1.1.8" = _cPYiWF8A;
        "pkg-1.1.9-forge" = _h0afgRfD;
        "pkg-1.1.9" = _7foxbKvr;
        "pkg-1.1.10-forge" = _wzfyAIgJ;
        "pkg-1.1.11-fabric" = _2wqGkVWL;
        "pkg-1.1.11-forge" = _nGxXnnas;
        "pkg-2.0.0-beta" = _sBwwH8Pe;
        "pkg-2.0.0-beta-2" = _Yi94q3cX;
        "pkg-2.0.0-beta-3" = _Sd9pbQKb;
        "pkg-1.1.12" = _gNbuzq2k;
        "pkg-2.0.0" = _7AGKMTam;
        "pkg-2.0.0a" = _ggrcrZ0n;
        "pkg-2.1.0" = _RV6uu9bj;
        "pkg-1.1.13" = _WvPgVfPl;
        "pkg-2.2.0" = _6Pg4WHRF;
        "pkg-2.2.0a" = _txCTwiim;
        "pkg-1.1.13a-forge" = _YqkJYicf;
        "pkg-2.3.0" = _OViKhK8K;
        "pkg-2.4.0" = _9kslwM0m;
        "pkg-2.5.0" = _9BNZ9n3q;
        "pkg-2.6.0" = _xUypaq2u;
