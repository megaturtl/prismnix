...
let
    versions = (let
        ...
        _TrNE47Zo = {
            "id" = "TrNE47Zo";
            "file" = "structurify-fabric-2.0.32+mc1.20.1.jar";
            "hash" = "sha512-lK/QROUr59or+h+OtTfnIjw1+rgMFRMPDV2ucjmwCHlK6lAB74q/3NFKvesUes8A5aIrW1ZWs3l86+EYRFAl2g==";
        };
        _ZhgVsF2f = {
            "id" = "ZhgVsF2f";
            "file" = "structurify-fabric-2.0.32+mc1.21.3.jar";
            "hash" = "sha512-8lDvz7UhCGtB+eCwkN1XdHbfqWRPlmSe8DDhmgBLi1UFXCiV1FF0fF4vjPkvLzelXF5PxidppERedNceO+IpMg==";
        };
        _fpUS4Rlr = {
            "id" = "fpUS4Rlr";
            "file" = "structurify-fabric-2.0.32+mc1.21.1.jar";
            "hash" = "sha512-6h4jJAOjejMWziLXJLWu9wkVnB8DNk2kinOTB9CPHf/fm6L1GO6k1+p+jWUZOgTWrcd1ET3/JcZp/NoWgQ9pWw==";
        };
        _cOpTps4Y = {
            "id" = "cOpTps4Y";
            "file" = "structurify-fabric-2.0.32+mc1.21.4.jar";
            "hash" = "sha512-NLtehCnIlKELRb+UkUtksHSNDbHptU7tZe8mYpp/XhYViHANrq+QoRfB6Mc2Kr6MrXiMSYaveQc4NKI8Qb7zAQ==";
        };
        _vvNbRQKp = {
            "id" = "vvNbRQKp";
            "file" = "structurify-fabric-2.0.32+mc1.21.10.jar";
            "hash" = "sha512-/po1/nWNOIWm9ajW5nR8mMS5PVaWFcg9SHLLVmNzDNZt95nHSaUGY7rHHvn++6UNsOvB7iNszwQBh9QA0ModKA==";
        };
        _x9LXDrtk = {
            "id" = "x9LXDrtk";
            "file" = "structurify-fabric-2.0.32+mc1.21.5.jar";
            "hash" = "sha512-Y6ckInjKmpjf6tT8Svl4N/wghmV03mlGa35AEYKFn3L7kzHuAeTBN20KKi0pi+skRwczgd8fdzIxAS9K6Oa2Rw==";
        };
        _X4EMsGax = {
            "id" = "X4EMsGax";
            "file" = "structurify-fabric-2.0.32+mc1.21.8.jar";
            "hash" = "sha512-YrMgaTIT1Zyshkx1HivDFuI4kOeydaxaaOKI8IcY14BaHcjE73ZcRJ1JgWPvF8do6DTOzIMtsHnDG++Iu7CSlg==";
        };
        _pf7ezSGO = {
            "id" = "pf7ezSGO";
            "file" = "structurify-fabric-2.0.32+mc1.21.11.jar";
            "hash" = "sha512-RGv0IgaYRpHX8bFXVCweSgjAEwROpJDErkmDZyOj1e1cldibkrkmS66JW5BOUpic/Al3egnFjDZ2wxPY7rG2/g==";
        };
        _k9aNBk7v = {
            "id" = "k9aNBk7v";
            "file" = "structurify-fabric-2.0.32+mc26.1.2.jar";
            "hash" = "sha512-JOXA6/Ey7Or8CEgYpk6sEWbExhCdIVv5J1Lt/6BEzZYTFv9yrR1THQTTffJAVAtTS8NXS+I8I7ycLadi2CgyOw==";
        };
        _ZR4auc54 = {
            "id" = "ZR4auc54";
            "file" = "structurify-fabric-2.0.32+mc26.2.jar";
            "hash" = "sha512-GetYjtjjuVIWCSr79Dp/OuKCxV320XPhbt+8o5ET9+JOtZ0T0KVYhrOCDikflrBdY2Eb5B21YgNcEG/4HUBVTA==";
        };
        _b5VYk0Rb = {
            "id" = "b5VYk0Rb";
            "file" = "structurify-neoforge-2.0.32+mc1.21.3.jar";
            "hash" = "sha512-Kiu5H9gjiNtsqHMbbW81NzU3gmAEt7KqzVAHFpM6t3Bl2Yd5tQoWHb9db8R4UxiraU2BKt6KOxMJw7BBVCFa3w==";
        };
        _p5Engpdh = {
            "id" = "p5Engpdh";
            "file" = "structurify-neoforge-2.0.32+mc1.21.1.jar";
            "hash" = "sha512-u40yPqipUZj9T78hGBQU/F9yjfauKGkj+CMNzyd3UXVck8zcYFeN4/zKhSEiGLuXAsVQ65Kil4Hz8z+qSQ71cg==";
        };
        _vFjST2Ro = {
            "id" = "vFjST2Ro";
            "file" = "structurify-neoforge-2.0.32+mc1.21.4.jar";
            "hash" = "sha512-rGCq7r0oK3qem4UZ/EEYHdf1OvYqBOp7gUNHtPLjCiIpO813r92qzln0Erhq76txZJS5CJU61KoCLls/8q7CVQ==";
        };
        _HpoIgtmb = {
            "id" = "HpoIgtmb";
            "file" = "structurify-neoforge-2.0.32+mc1.21.5.jar";
            "hash" = "sha512-jfM6RecVlTuui97a1SI5j/iTe3JojsAb8cC8PZbKjUNAQngGPGzQKoQCvkj1uSRwgktgoD8A6w+IajnIzBoPrQ==";
        };
        _hA37mO3C = {
            "id" = "hA37mO3C";
            "file" = "structurify-neoforge-2.0.32+mc1.21.8.jar";
            "hash" = "sha512-/WeeCna1QOooayyFE4ga9fAa3P/zJiCff61WNqoTpLW1Qrw0SWocEFsX1EMTE8HrPMsp5j7/XuexGgwmTWz+ww==";
        };
        _CRn9IgmF = {
            "id" = "CRn9IgmF";
            "file" = "structurify-neoforge-2.0.32+mc1.21.10.jar";
            "hash" = "sha512-cKS6yG6IpaMBK5bMZBe6HV9dMZacXm5EilP3vadmZ+2nzx3oytsuHizN3sqgsHEO5ql/L+5p2GzIstoNMbrCuA==";
        };
        _R3wjdTvG = {
            "id" = "R3wjdTvG";
            "file" = "structurify-neoforge-2.0.32+mc26.1.2.jar";
            "hash" = "sha512-scpb5t+bvK1eBbG4AEw9R0iaZYHOHG0QQGoGGj+dHDDMUv9217D0Z7VqBYk1floMmNj1dZxl9YuppgjQQYBzgg==";
        };
        _AHPn11rb = {
            "id" = "AHPn11rb";
            "file" = "structurify-neoforge-2.0.32+mc1.21.11.jar";
            "hash" = "sha512-LGoeIQsNM6W6PLrNMfR9Ejp54zgRxKUBZLZ6058k/aWnofEGNTXGbuQYv84YvzAmt/Rb/MFI7VGhP/LiQXpnJg==";
        };
        _prjWdOAr = {
            "id" = "prjWdOAr";
            "file" = "structurify-neoforge-2.0.32+mc26.2.jar";
            "hash" = "sha512-FFko4vJN56kdxZ+UuUK0USnTgEUkhtFgcd0iEQb5G+tlLDHIm43PlzRUak2EInDuwllyYjeNmMEV/Cd/4dCA1Q==";
        };
        _a7xBByM3 = {
            "id" = "a7xBByM3";
            "file" = "structurify-forge-2.0.32+mc1.20.1.jar";
            "hash" = "sha512-PtSrRtKWj9XRYVs21OYRoARhHMKwPqbEJm/vj9pjuZ18aNvGCB8U+qK8kjgSvU9x+w97YSfY1ACfZbZhO0Y0pA==";
        };
        _GFlSJMqJ = {
            "id" = "GFlSJMqJ";
            "file" = "structurify-fabric-2.0.33+mc1.21.3.jar";
            "hash" = "sha512-7EG0swu2Lq0dVXH3fEPmVvtZC2iF1PdK+/Zvs73hm2kVFHfl5tYR8/0zQ43Q71OS6L47yeyGed5WExuBb2zXuA==";
        };
        _bGE1xExV = {
            "id" = "bGE1xExV";
            "file" = "structurify-fabric-2.0.33+mc1.20.1.jar";
            "hash" = "sha512-Gf0lQ6TS1S9h8D3KiFA7iWrvqLEXPx0Hu/vNYmuD2ATnRsnPbvXjSgZuah7uuLgE7CcEav33V5dQ/gCKXsW32w==";
        };
        _u0O9EU1P = {
            "id" = "u0O9EU1P";
            "file" = "structurify-fabric-2.0.33+mc1.21.1.jar";
            "hash" = "sha512-L/JqUy8WhUxSQiIHj+r0B+r7MH5UVO9mDyj+NqD5RUkDncLi2Snf6dRmrnTioob1LmPAN730WUtnYJsEZxDrTA==";
        };
        _ig88Gew2 = {
            "id" = "ig88Gew2";
            "file" = "structurify-fabric-2.0.33+mc1.21.8.jar";
            "hash" = "sha512-vF4uQaahKXilgIjxHXFybBMtoKHx2WeJJdRgzsoUPRcRIGvcsGDIQGuRS/dEBKxF8GNx3/L/D36tSFUhmEQLsw==";
        };
        _TSXKJxDo = {
            "id" = "TSXKJxDo";
            "file" = "structurify-fabric-2.0.33+mc1.21.4.jar";
            "hash" = "sha512-MQDyrj2C4n2UsGn+VV5EnuLw1RPjCa17kTMcNPKXNLEfsFX7IG+fcSpaSnA9WbdHakCNS0W5//dIxkko7fnjdw==";
        };
        _FSjQpFME = {
            "id" = "FSjQpFME";
            "file" = "structurify-fabric-2.0.33+mc1.21.5.jar";
            "hash" = "sha512-sbTVCg5pPTN2ybJO/HS0+HjSkBwfnRDDot301M5PX+/QYgcbFBYtMr3oNBJLrUH9fNMJ2Ck9a136F0MBMYFZpQ==";
        };
        _PSkw0LA8 = {
            "id" = "PSkw0LA8";
            "file" = "structurify-fabric-2.0.33+mc1.21.10.jar";
            "hash" = "sha512-QjityNVR/14mTnpDe9/Pr6iQa8c3cJOqOqeFEBeHpHNr+7R/qFqKEjZykrsATQRFex6D1R8dr4qQBOiylFcEGg==";
        };
        _4dXJuvXu = {
            "id" = "4dXJuvXu";
            "file" = "structurify-fabric-2.0.33+mc1.21.11.jar";
            "hash" = "sha512-lcdzgmUtFU1FomUxmhWpgX8aTmAMFdImdKJOK+D9oL3cLO08WUK7AxQxsynr8Q1+GW/LuQ+nqXrg8IVvsVO5hQ==";
        };
        _XAbVfsJS = {
            "id" = "XAbVfsJS";
            "file" = "structurify-fabric-2.0.33+mc26.1.2.jar";
            "hash" = "sha512-ud/KuaDl94Q7+V/1oFWG/Arr1ql4pPR5lufZ/mIfDDe/KEM4J6Au/hxarPpy1kvdp+jlVN2B0sfy4kGYgGybVA==";
        };
        _7u0YpjAk = {
            "id" = "7u0YpjAk";
            "file" = "structurify-fabric-2.0.33+mc26.2.jar";
            "hash" = "sha512-AkuWECsfsFPyLYf4R9fTa0cMpGfQOc98cGYfYXrVH68Z0OIbJNvtLUbayOpFhoCuoc0JY1xuSomdNrxhgm0nMw==";
        };
        _6AItkCQI = {
            "id" = "6AItkCQI";
            "file" = "structurify-neoforge-2.0.33+mc1.21.3.jar";
            "hash" = "sha512-t3LKBpCMtwBqDdPY88zpvyOwAyN0I4X7OSPbjq096vFANgQld9b0ilfA7U/FOWG8n5GNasZF5FbtxcGpmNWAag==";
        };
        _5ZFXdRz4 = {
            "id" = "5ZFXdRz4";
            "file" = "structurify-neoforge-2.0.33+mc1.21.1.jar";
            "hash" = "sha512-4pB+ZX3nlV+M4wfZQEi6tD1+P6G8g417QvjhZy+hVlrMdV+nG/lhnppddRpfjwbZhCAcwFjWFoBL5p/CVEojuQ==";
        };
        _e4YB2WyC = {
            "id" = "e4YB2WyC";
            "file" = "structurify-neoforge-2.0.33+mc1.21.4.jar";
            "hash" = "sha512-ms+clqLeRMDtjMbaO4cXUenLLrOLDw8qHxLaFJZw79dcXi5Tba4pX1XhkZNh2br6QX8juE+lQjZABP9rGlEyjA==";
        };
        _t9bdLsvK = {
            "id" = "t9bdLsvK";
            "file" = "structurify-neoforge-2.0.33+mc1.21.8.jar";
            "hash" = "sha512-yDSMUGZ1hiIjP623yTUUJEgdgn2da8sygRVtdTdYYn9XWKK6PSo/Rt2j+j1Rifs34wZngwQNkeqh3vDO9xP0Jg==";
        };
        _tc0v75dg = {
            "id" = "tc0v75dg";
            "file" = "structurify-neoforge-2.0.33+mc1.21.5.jar";
            "hash" = "sha512-rzZl0py/N6/cQk1hhlt7MJAjC1sKNlcymyIMsCm5nrdZesKc/reEIU2Xzrh/WGiku5ZYsJzxupWlrzfAY/0CrQ==";
        };
        _864fKCoC = {
            "id" = "864fKCoC";
            "file" = "structurify-neoforge-2.0.33+mc1.21.10.jar";
            "hash" = "sha512-hdt1T4ZVQhDPDNZZSzDhH9EFwH3a+3YfqkKcBZ5Mw+3NJrbS62NTdTXlUiX9tpX6yljWzQN+Uyub0Wuj9qYv+A==";
        };
        _QXOcllI0 = {
            "id" = "QXOcllI0";
            "file" = "structurify-neoforge-2.0.33+mc26.1.2.jar";
            "hash" = "sha512-zYi4NU0W27WzUQEiBGHIThhSvO/JsZLx1pGYRTYAR8/xkDvNNfXULTekKPdIcKv0j9HapjmMDaaktc/AR5mbIA==";
        };
        _SG3KdLft = {
            "id" = "SG3KdLft";
            "file" = "structurify-neoforge-2.0.33+mc1.21.11.jar";
            "hash" = "sha512-svjBS2JDAXNyl9v2LvSFDaRgEPorzZ3psF+fE/S/iZ+udg7xzJgqUBfGCoCO3RXLNF5GW+PPJsD4+cdNWiD2vg==";
        };
        _9OUiifDA = {
            "id" = "9OUiifDA";
            "file" = "structurify-neoforge-2.0.33+mc26.2.jar";
            "hash" = "sha512-tEaEeKplOst4VghYJpcBvVmmPCacu/UqR3djJHDUTlbrsWxmqPtSQ+d89dpW4exoVZWEZhdaPfksPHYAS48mjQ==";
        };
        _x0hH5Y0z = {
            "id" = "x0hH5Y0z";
            "file" = "structurify-forge-2.0.33+mc1.20.1.jar";
            "hash" = "sha512-WXI5CzLvo7CA+pEcVuNQa7UfXN19SYpcFovDXs082FQcS6cyGVPatQfeaB/OPPfD7tcAB5UOlhakiF03A/+dMA==";
        };
        _7ATeFihc = {
            "id" = "7ATeFihc";
            "file" = "structurify-fabric-2.0.34+mc1.21.3.jar";
            "hash" = "sha512-dpuWwebvzeCIVV0T6GzUgq3RSmHnmYpyJKuF/TnReGbIyTQT465YXNOAW0JhLywxJMiMSVr52BvauUUZc9U9ZQ==";
        };
        _l6yfL0Oq = {
            "id" = "l6yfL0Oq";
            "file" = "structurify-fabric-2.0.34+mc1.21.1.jar";
            "hash" = "sha512-FNzQWS/8R1LtwyGSQoIWTXQWXfPFgkgyNy1tYgViA5I9HE0dVF5kB7xaVUmjemESjWNVoWZGnbx7unhn/sh26w==";
        };
        _PAqaNVUl = {
            "id" = "PAqaNVUl";
            "file" = "structurify-fabric-2.0.34+mc1.20.1.jar";
            "hash" = "sha512-1jHwG2SkBEoj2PAy9bonzSPrH03+YUu5XpLKjogdsQi9A35RGtaapKoot82vNQ7RYTrXNrZrmGKMMXMsHQ+7cA==";
        };
        _WhzRtsoQ = {
            "id" = "WhzRtsoQ";
            "file" = "structurify-fabric-2.0.34+mc1.21.4.jar";
            "hash" = "sha512-Wh0ytncnnSujFLT7D0t1Ynwo9N65sI5X59mkNaphMjjJSRkX+GJ3RlQQQspf2G4PcgIB2cd99OPqutZxqtxecA==";
        };
        _LHEYqn5Y = {
            "id" = "LHEYqn5Y";
            "file" = "structurify-fabric-2.0.34+mc1.21.8.jar";
            "hash" = "sha512-VDsg6GkFBub5m1erYV9bf3Br8VrDmFYWMDqAdnZWWnVOCQp9OVfCyMFuzC5UMHvLJOKkv4X34OW1JL1/v8M0nA==";
        };
        _yinaVPDh = {
            "id" = "yinaVPDh";
            "file" = "structurify-fabric-2.0.34+mc1.21.5.jar";
            "hash" = "sha512-/nySauCEzwlf596qWH8Eu9NGnjVMhd0zbbIsiulJq9fTRE0E2JnFMZ7eNcewyE8Ql3QP2bKbZqR0iOTokqs3dw==";
        };
        _vdmzxGHh = {
            "id" = "vdmzxGHh";
            "file" = "structurify-fabric-2.0.34+mc1.21.11.jar";
            "hash" = "sha512-yNODa8fYK474pVFmYoGKYj5TCy2AuQVB8Q7pYUP3sliZ13X2XC68vXy6pIx5JQH981EuOe8iQTurxJioeq3QKQ==";
        };
        _lKIvvrIj = {
            "id" = "lKIvvrIj";
            "file" = "structurify-fabric-2.0.34+mc1.21.10.jar";
            "hash" = "sha512-/KqFtLq3Kz5g1OkJPPMM6E5IwPl6iYzkB5jTBFLQbciWGuyee1SxDszxTDcZYzkkGnJyAGTiBt6qHm7+/INSwg==";
        };
        _IErKoJHu = {
            "id" = "IErKoJHu";
            "file" = "structurify-fabric-2.0.34+mc26.1.2.jar";
            "hash" = "sha512-Hf8eMKq2sugJXOs5HhkfYjYN9YM4JQJgk7Aro9MVSQ3yCJUcr0rNFnihbBZRfKGeCoOYi5zu1u+Z9i/de7KIdQ==";
        };
        _u302AlWj = {
            "id" = "u302AlWj";
            "file" = "structurify-fabric-2.0.34+mc26.2.jar";
            "hash" = "sha512-S7kcuwyHTK8ZCW2ISS4mNXrgcXpW/h/Z5+0e7UV5zlQLj15j+bnSUVqFjW5mZC2Ty0hlSfTsGx1z/2oWZmH5Ag==";
        };
        _p4OuueNU = {
            "id" = "p4OuueNU";
            "file" = "structurify-neoforge-2.0.34+mc1.21.1.jar";
            "hash" = "sha512-HfZNlGtqk63NM22IATMiJkfxk6xdHirkBr99ywoxdC0CaPbODSM642g8St+q+uI9ErAF3qe6GpE/4I9rXpB0AA==";
        };
        _7IKyXUzF = {
            "id" = "7IKyXUzF";
            "file" = "structurify-neoforge-2.0.34+mc1.21.3.jar";
            "hash" = "sha512-yIkme/nL22RN0iZ5B4/BuBMcYRYocQFhrdrMIb4eY7DFOXZthhPElpKLSTYBvlmFmLSsTB4fJO0Aiisluhmfzw==";
        };
        _Jgbgjw7X = {
            "id" = "Jgbgjw7X";
            "file" = "structurify-neoforge-2.0.34+mc1.21.4.jar";
            "hash" = "sha512-xE1nLa+xdUmYH8cNgPyXTDBxrDDWtPKY7C8aoIdThbFivW5Uq+ohsWp3lKD+6xemtMpoYBFl7sqPtkgRR0x94g==";
        };
        _1vnIElvg = {
            "id" = "1vnIElvg";
            "file" = "structurify-neoforge-2.0.34+mc1.21.8.jar";
            "hash" = "sha512-VIaxROMWT/rBVBkgtX0Ybi3PTUs+pukYy7axpNkfY2uYnpJn2A7GlMhT6YkCXXX+T8Orq2f7LUTdOQAqhbL5vw==";
        };
        _PwVDFnVh = {
            "id" = "PwVDFnVh";
            "file" = "structurify-neoforge-2.0.34+mc1.21.5.jar";
            "hash" = "sha512-iS6Dlu6HWhrKQCoHA66zNFCyUnc4a3hkNwAs0vf1SLJFFAac8ybVIt6f9CpOomGfHOOCCWm0icti/LPOjmoe8Q==";
        };
        _a46585Si = {
            "id" = "a46585Si";
            "file" = "structurify-neoforge-2.0.34+mc1.21.10.jar";
            "hash" = "sha512-Asu/+XMwpynhKnIi/M+/49kiRBYkEasWz1a34LlIonH/8s1KkIu44bUD/S53U0T2ny5SsfChyegzXvPRTRcI5A==";
        };
        _s3HHHWUD = {
            "id" = "s3HHHWUD";
            "file" = "structurify-neoforge-2.0.34+mc26.1.2.jar";
            "hash" = "sha512-YoWhxz2Ul+OGVOuP67NagafhWzYXvErGGNSZLNonSt0YuSNV/P9Bx46Li6yeDf4lhq9+B0Ccp0/QGFWuZVCZ5A==";
        };
        _rS7mkawN = {
            "id" = "rS7mkawN";
            "file" = "structurify-neoforge-2.0.34+mc1.21.11.jar";
            "hash" = "sha512-j1GTAl0YRUj0oWEC58VGvnNqnYKkD5MiwMWJGDycdNiZ0pFyrqHT4n13HdDk3VZGNazlsTsYxk8rnlTHx3mPJg==";
        };
        _Ev7mLjuF = {
            "id" = "Ev7mLjuF";
            "file" = "structurify-neoforge-2.0.34+mc26.2.jar";
            "hash" = "sha512-gLK+3z2iOW93cJW9jOtmQueeeBH9wJ8gE333brjf4eRGyY18CTYhMBEbYsCCRAoT3XxBEGvMe3tCV7tRhSVFaw==";
        };
        _hgq4F5J8 = {
            "id" = "hgq4F5J8";
            "file" = "structurify-forge-2.0.34+mc1.20.1.jar";
            "hash" = "sha512-hoeFnHnro0lx+UiZU/Potahnu07/VX/burX18m8xdeQdv/6qZT96GCKGwAudZPdHi7AlILqa6a4QpdTq3GUrqQ==";
        };
        _MYYrfpQW = {
            "id" = "MYYrfpQW";
            "file" = "structurify-fabric-2.0.35+mc1.20.1.jar";
            "hash" = "sha512-kh6DtRnCYiR39owm310/yLAEJCUY+2NYJCtUPMux0+VSvguibURu0xsF/MCZp9dcGIPGOnKhGt0ij4uiNchyFg==";
        };
        _bdB9IxuJ = {
            "id" = "bdB9IxuJ";
            "file" = "structurify-fabric-2.0.35+mc1.21.3.jar";
            "hash" = "sha512-jAiL8FgJZUpDzS2I9SdhVHAP15kT5J8m4QcJtrV0ns/QcnojFtqsg5FrVz+2Jm0BREIpbzxZiDtmzvnn+FLcog==";
        };
        _5rpJyffw = {
            "id" = "5rpJyffw";
            "file" = "structurify-fabric-2.0.35+mc1.21.1.jar";
            "hash" = "sha512-slD7+FDg2uL1g8Vh+Kwq6lr6iF29sPqlf1z0m1NR98Zy+3bqwEH+7TurSNw4pGFjs1nY2P02OOdWtnM/1MnTog==";
        };
        _BRc7B0qD = {
            "id" = "BRc7B0qD";
            "file" = "structurify-fabric-2.0.35+mc1.21.4.jar";
            "hash" = "sha512-Ad0fz8JPrxAe0FuzWuaNYonZ3xzwtS66A9P+3YzfTvL9znVCMQgdsLNMfBb6R5LOzA6EmSvMAMwTUqqVlljVoA==";
        };
        _FLtMA4pV = {
            "id" = "FLtMA4pV";
            "file" = "structurify-fabric-2.0.35+mc1.21.5.jar";
            "hash" = "sha512-oB7iFx9JAvYFILPI1BVP1vt+MkD1AYxVfH8KtiQ2jN0gaecg5RuNkYG9OfAyEI3iGvPO7rJygAow9Ybam1T3cA==";
        };
        _2bt7jex9 = {
            "id" = "2bt7jex9";
            "file" = "structurify-fabric-2.0.35+mc1.21.8.jar";
            "hash" = "sha512-iaFHpsOECaVeZU7rs6srWoRP8zuAH/OVJQiQ/CETEY/Lm0hIj0Zf4egQtQlK6qKvSGpf82erCSoJ8/U1UZFyAQ==";
        };
        _lF3TcBlp = {
            "id" = "lF3TcBlp";
            "file" = "structurify-fabric-2.0.35+mc1.21.11.jar";
            "hash" = "sha512-TxIkncTOZCYfhEESxlcAO43e+wJKMeAK7EIvMbAXIeUeHZ0UKFrO9r8Zcb6pTELtwSa7HacPmjHtpXVlVSGJCg==";
        };
        _N6NVyzzP = {
            "id" = "N6NVyzzP";
            "file" = "structurify-fabric-2.0.35+mc1.21.10.jar";
            "hash" = "sha512-8icmvFyAsYgr6nMbfAgOMUF4sKjszflUwMZfybTwFcy9uR6eHT0NuDhewgfTCzqXHEGQabFeJ7jHZ2br4QpXvA==";
        };
        _n5AR2RcC = {
            "id" = "n5AR2RcC";
            "file" = "structurify-fabric-2.0.35+mc26.1.2.jar";
            "hash" = "sha512-dLA/x9IBzBSyZZ/wDm1u+m8PNXl8OuY+m31uMw9K8rVyzF+cbWFGMMpqGt+5j4XSdRnj2lrjjZsigBC3wG72xQ==";
        };
        _s6XTgUna = {
            "id" = "s6XTgUna";
            "file" = "structurify-fabric-2.0.35+mc26.2.jar";
            "hash" = "sha512-vbKLsobjdS0SVUOz2RVw33lU+UtladHr0glKDHt3/ptFnCBgmkjuSkz9n2Vhc+e5y7vm1KVJ2+O7eIEwYmf1gw==";
        };
        _NO7PrIeU = {
            "id" = "NO7PrIeU";
            "file" = "structurify-neoforge-2.0.35+mc1.21.3.jar";
            "hash" = "sha512-RmP9gpdsMN5i/6tiPjCT33F3A+ZH9eUEcOpykZ0vDO5pSUhiA98HZhHQW6svju5v8wVmaiTEvqqTRxn77/etTQ==";
        };
        _MRevPZqC = {
            "id" = "MRevPZqC";
            "file" = "structurify-neoforge-2.0.35+mc1.21.4.jar";
            "hash" = "sha512-lbpSoEZSQ+r37v4V6eUJbZ6nFI+++Of2t/8puSOhMkQ7kgiV4Fyh+iYyep7oSjiZ55t6vH01CZLL7z7mP/mlIA==";
        };
        _xjI3j7S7 = {
            "id" = "xjI3j7S7";
            "file" = "structurify-neoforge-2.0.35+mc1.21.1.jar";
            "hash" = "sha512-KWVcbOZWqx5b3pndKka8EJSKMa0pd5uGh/qDX0f/sl8mcpE7uDDBh2uyyn2F1gyF2V7v12MFn/Kz9MiE8AekkQ==";
        };
        _BqmryCjH = {
            "id" = "BqmryCjH";
            "file" = "structurify-neoforge-2.0.35+mc1.21.5.jar";
            "hash" = "sha512-QqwecHN0bMB6KkQGkaL7E/LxoyApbPNYx4cZVYBY2JC0PV3ASv4J2e9I4We6ihwHXhW9UsAVznVFbfEaUhVLfQ==";
        };
        _2KeyPHDW = {
            "id" = "2KeyPHDW";
            "file" = "structurify-neoforge-2.0.35+mc1.21.10.jar";
            "hash" = "sha512-OUAfM8Og3RWs/zfJi0295GM2vWbt4aPQa/HKF6caw8iIWSz7ZsHc5YNWfN3zea2fkjr6GRGNBBwuaov2m2T7lw==";
        };
        _zrhD8eIE = {
            "id" = "zrhD8eIE";
            "file" = "structurify-neoforge-2.0.35+mc1.21.8.jar";
            "hash" = "sha512-nE0dSYMBgHWzIXCIFePh8JOb3aCiionUDlISxo11SdSlU6LL75d580ze2AoWVvOC+gMxPxboWT80DJWBnlyFAQ==";
        };
        _v90qyMai = {
            "id" = "v90qyMai";
            "file" = "structurify-neoforge-2.0.35+mc26.1.2.jar";
            "hash" = "sha512-k2lmzl5nFg14yJWlS71c7r6iqEnFrEpueBVVZE0U6qfu7anDGy8PRUZRzwfUq11TCgiiEYyTqA+clyw1ryGUkQ==";
        };
        _TEUvkZAl = {
            "id" = "TEUvkZAl";
            "file" = "structurify-neoforge-2.0.35+mc26.2.jar";
            "hash" = "sha512-7ynpH5gezRtXW5jEe/xKgT00MtLdwY2lL82XeHyKSKrR8jmai1gPcCGmM54hVddrT3maQKSEnMTVP/E06nrbbg==";
        };
        _i0HKnVQq = {
            "id" = "i0HKnVQq";
            "file" = "structurify-neoforge-2.0.35+mc1.21.11.jar";
            "hash" = "sha512-+cn9iC21YF1I37K3KthtwvVYp1KNpxjRNWbNqITBn+8QcDNBvj2vKzqKkz2+nJVlkiC/xiYjXwB5cMrrQziMbQ==";
        };
        _PwYZliaI = {
            "id" = "PwYZliaI";
            "file" = "structurify-forge-2.0.35+mc1.20.1.jar";
            "hash" = "sha512-gAWWkVZi36fdIcIO6x58ZyD3PYua0qdSK8cWG9onimwwFjL+YYhLYftri8XQNl7+yN9loxfBXmM/cFpL5lzUKg==";
        };
        _FMvtlPMI = {
            "id" = "FMvtlPMI";
            "file" = "structurify-fabric-2.0.36+mc1.20.1.jar";
            "hash" = "sha512-8PqScobwLa6WyiwVkQASs3ylX7hWcjgdYgcW+sBY+gJhzopzRxhC3cOXBhufZuZQVrD7CGpuIL7LupGQGL0x3Q==";
        };
        _VOnkUmtg = {
            "id" = "VOnkUmtg";
            "file" = "structurify-fabric-2.0.36+mc1.21.3.jar";
            "hash" = "sha512-E7g//1EC58BZKlaMxJoR39xhhqItuB6/4DTT16G4tN3zBJ5Wx+Gtio5RXpvF8DwBwxs1uTSifrmv4CUd8JrmGw==";
        };
        _RDGepoT5 = {
            "id" = "RDGepoT5";
            "file" = "structurify-fabric-2.0.36+mc1.21.1.jar";
            "hash" = "sha512-4uzj80s6h9BMk/6PA5arlSGJ/QY+n5f9W7nMBy7JNjALR/pCqVowBZviwr/A28ueS9z10aXAjq/mFwKw1DHUMQ==";
        };
        _xmM5O4LD = {
            "id" = "xmM5O4LD";
            "file" = "structurify-fabric-2.0.36+mc1.21.4.jar";
            "hash" = "sha512-Ej9jx+PqQYahhwFhRXvniF5ud2wlYRwBv3aY6O7najj8+pG/1vrK49kiXnpJTA3Ws+9me3BgSKu7O27kgUn1sQ==";
        };
        _iIgvPsnj = {
            "id" = "iIgvPsnj";
            "file" = "structurify-fabric-2.0.36+mc1.21.8.jar";
            "hash" = "sha512-fAXiE1aSsGyKTNy/+wRinYJ8V0qeZcbbrjs7ZH0qvXo8qcl3deK+gHj74JRmBWcgE7wRq4QasGHpmHw7bR1weA==";
        };
        _t7AOZpxE = {
            "id" = "t7AOZpxE";
            "file" = "structurify-fabric-2.0.36+mc1.21.5.jar";
            "hash" = "sha512-06OKpGdBRvveddmxe/CwaBLi3/iIkfZQMoTe5nf0ojJ97/swVFG+K1pLM77JniRh3QSntOeJYL+AaneaGQmCNg==";
        };
        _92k8QZTP = {
            "id" = "92k8QZTP";
            "file" = "structurify-fabric-2.0.36+mc1.21.10.jar";
            "hash" = "sha512-TmobMBgC5seON2u4wji+M+WtJGiPihqnwZyhzpPizRdifKgwPubu+Q5VBwZGIfospzkDR3U7lLKZJJahXhJLgg==";
        };
        _PDlzSXg3 = {
            "id" = "PDlzSXg3";
            "file" = "structurify-fabric-2.0.36+mc26.1.2.jar";
            "hash" = "sha512-XodL7qbHpaC2mHpgZJgIcyTt9tD/J3MCSsGqa2UcBPAjqzcr0MgQVMF7+bzbJn/02vm5cW+RdQVxckQ8hbxkBQ==";
        };
        _JMKW8uxP = {
            "id" = "JMKW8uxP";
            "file" = "structurify-fabric-2.0.36+mc1.21.11.jar";
            "hash" = "sha512-Tw7hbLidkDGt7CDkmQIlAmsOLW7FC0tr11EOHb4GYqgcveLjoRNR5X3pac5ZnPMZaeCsdEBFz9241ZTGa3RMrQ==";
        };
        _yBMmlmqw = {
            "id" = "yBMmlmqw";
            "file" = "structurify-fabric-2.0.36+mc26.2.jar";
            "hash" = "sha512-BTJymJJZvVb38wUqjIygeyisTOsVg6Pm2wZJuaMOIshn2PS+TtMhOQPNrGmhlQiMdaiTvv+BVUotUNI5/hvwMA==";
        };
        _W8ILA1Vl = {
            "id" = "W8ILA1Vl";
            "file" = "structurify-neoforge-2.0.36+mc1.21.1.jar";
            "hash" = "sha512-GlfYq+Yl7Fj5uQXwdN0G3hYR5DCEqkImBT0wP6XbzWAWGu/1uLKNVXRCb4jlfU3XevHyvrc1FUYEFYJYal2HUg==";
        };
        _DvG6SiRs = {
            "id" = "DvG6SiRs";
            "file" = "structurify-neoforge-2.0.36+mc1.21.3.jar";
            "hash" = "sha512-UvxrFZSmzCn/D/os2RTay50grtkUa4rgj2JdNd5dgwekXbt5vsrh18jaWkDB/MUzk9AbODmjuAnNxUyFTce/9A==";
        };
        _WtfTc7Dy = {
            "id" = "WtfTc7Dy";
            "file" = "structurify-neoforge-2.0.36+mc1.21.4.jar";
            "hash" = "sha512-aVM1jj232g2dBkGWxmvoAv0s67L/aB97Rx53NDU2Lsrz9RQ07mnSw4qFAzywTG38On0gmpWAfSrp511puptUPg==";
        };
        _jZB65WSz = {
            "id" = "jZB65WSz";
            "file" = "structurify-neoforge-2.0.36+mc1.21.5.jar";
            "hash" = "sha512-sWR1Eg2D2+hVL2u7/mZKjiszuvsFu14ezkzuofYSNoS5ati9rTz2x0yY473jy+o3x4mcGwKi4qDHGm24RS3qjw==";
        };
        _kyOfVHuD = {
            "id" = "kyOfVHuD";
            "file" = "structurify-neoforge-2.0.36+mc1.21.8.jar";
            "hash" = "sha512-4rrkVqzcmKZxVVOowvWQFx7xo/iFONzaiRMp7mpby3MCFy0oiGjhO79svVCBzdNX7rOaEZb6HKwSwxki/xUV6g==";
        };
        _MOGCYHSn = {
            "id" = "MOGCYHSn";
            "file" = "structurify-neoforge-2.0.36+mc1.21.10.jar";
            "hash" = "sha512-Aj24YbRMavradG5zNNa6GuXuSEKQgKTFBD6aQbRl1FJKo93khH/YoIjtssY6qd3Ji+AgWxH21CN1WYV/nyQxnw==";
        };
        _r1lXTJyU = {
            "id" = "r1lXTJyU";
            "file" = "structurify-neoforge-2.0.36+mc26.1.2.jar";
            "hash" = "sha512-MeUyWB3/b9JpDb8yeWdlrt6akrwOF1i3j45kOKLO+RpXBvjz6VV4q7jooz0/xH3TRvz2Vk2pIhzhSN7B4Z3DXQ==";
        };
        _Dj98FGq2 = {
            "id" = "Dj98FGq2";
            "file" = "structurify-neoforge-2.0.36+mc26.2.jar";
            "hash" = "sha512-bCxhsp7cSol46Eft2jBWgGffMtNE9MOPm3TLZkMU/UuceYCNwPWvp53/NTPwfOZM2Sh3S/w05PkI0zV9dtnaKA==";
        };
        _5C0DWEI0 = {
            "id" = "5C0DWEI0";
            "file" = "structurify-neoforge-2.0.36+mc1.21.11.jar";
            "hash" = "sha512-C3Gk0xgNgDZQcaEGuk359qm7ViGgfrAaxilGxDTmCSvybpMFKcQofF6PmqkxeVDXxychq9UJ11/p3o5ayK9Xgw==";
        };
        _LpwMthRk = {
            "id" = "LpwMthRk";
            "file" = "structurify-forge-2.0.36+mc1.20.1.jar";
            "hash" = "sha512-2Arx2Hi0ulZZPniynE984AdhB6dtPLywxAX0AFLj9fZqZNLOaod8nwMPQOMzBUbQft5vyXs2nQrjT71bZjcdzA==";
        };
        _5jv1xD3H = {
            "id" = "5jv1xD3H";
            "file" = "structurify-fabric-2.0.37+mc1.21.3.jar";
            "hash" = "sha512-eUGIyUM/9fzEDjl976dfqU5lEA4MlZvkGINHHIgwqaLlKinsD3fRRd22A00o5s0fsBQThfaBO+MXBzWYHpQ4Zw==";
        };
        _m4Kt5HBM = {
            "id" = "m4Kt5HBM";
            "file" = "structurify-fabric-2.0.37+mc1.21.4.jar";
            "hash" = "sha512-2rp+6aVqM/ovIGS1xjOojRWyqiY8gIACnmK9Uucp7Dpo4Zc7HTJrYfvZE1N2xu3cf5q/4yc0z8xR0rLo91i/dQ==";
        };
        _ZElpxOJA = {
            "id" = "ZElpxOJA";
            "file" = "structurify-fabric-2.0.37+mc1.20.1.jar";
            "hash" = "sha512-yxsS9MhRHmrmOeivpfLmJD7NyAvIwTPYCISjHhYNJ2XI0iAH8AcIII4GNc0ATMe+HCFCIydLLlGGPV/jeGyY3A==";
        };
        _EJeeapcY = {
            "id" = "EJeeapcY";
            "file" = "structurify-fabric-2.0.37+mc1.21.1.jar";
            "hash" = "sha512-2lLAa79OYMmp0kQgiNIb7C1U+cPjaqGrQlV+6rfAzuV5XQRBvTzn95ZcvNtv8Wn+lU9NUSuXSq5Ty1Gkre4kDw==";
        };
        _3Tya8kwm = {
            "id" = "3Tya8kwm";
            "file" = "structurify-fabric-2.0.37+mc1.21.5.jar";
            "hash" = "sha512-Z1p5o9R1VSViGDPjpgJ5v1mnhP+FqfkmhDe/0imf/5/TgF9uq6XQwvMN/y4FctD3anYVi/J1xtjYqH3PQK7lzA==";
        };
        _aut3S7Ee = {
            "id" = "aut3S7Ee";
            "file" = "structurify-fabric-2.0.37+mc1.21.8.jar";
            "hash" = "sha512-cNX6GHXHuqE4Vxj9fe3A88Cqj1cW7AVQ41psLQfveX/SVOqKVCF35+v+md2gLbmT+W1wlwfIMRImBJsbdALQrg==";
        };
        _hVEYjiP3 = {
            "id" = "hVEYjiP3";
            "file" = "structurify-fabric-2.0.37+mc1.21.10.jar";
            "hash" = "sha512-0P44lQw6aloCAf12m1vWyrGl3BX6A3/BfHKALjt3QtfxtpisXj7mdIrPTLcNGRqd0rhMk0TuKM3AMcN42XSQlg==";
        };
        _TZrSp2RU = {
            "id" = "TZrSp2RU";
            "file" = "structurify-fabric-2.0.37+mc26.2.jar";
            "hash" = "sha512-b86Ti9+A5QwdcIwjulkYCaWJFpEAQutTNmIierHdATvZgVKtI8boYgSWk7jSQSHAaZopmcW1PxvoXBHOYvsUXg==";
        };
        _ZkKmCXs2 = {
            "id" = "ZkKmCXs2";
            "file" = "structurify-fabric-2.0.37+mc26.1.2.jar";
            "hash" = "sha512-mDTtBpxnUpluCic1jiQofcvvO24pu5wAVp9MDMu0u9TOubbFMp5TBTocZi+QJrh7DjBiEJ9/uc2eT+aYxkIAFg==";
        };
        _hHBROmLr = {
            "id" = "hHBROmLr";
            "file" = "structurify-fabric-2.0.37+mc1.21.11.jar";
            "hash" = "sha512-eL/X9BAT9BlxIrBDJhmJbA+yviCe00+xMl7aBumvKTm3+DlWIh9IkwBQUCpvHsFw3tPqvLhfQS6Q5MpYfK0Bng==";
        };
        _lYocU07r = {
            "id" = "lYocU07r";
            "file" = "structurify-neoforge-2.0.37+mc1.21.1.jar";
            "hash" = "sha512-piYjE37NSAxYB/Gpf3VPbpL6zrCYB5UDMKaRhbOEni0nUN0xzounBelM8TjyWy9a1r9e8cXCkfSvkjAHJWECAA==";
        };
        _mH5AEVIY = {
            "id" = "mH5AEVIY";
            "file" = "structurify-neoforge-2.0.37+mc1.21.3.jar";
            "hash" = "sha512-kV7yfN+m2jj4cubmABrWuAQxzyzDJXzf8mA8bcuoL+5tBE7CB/lmbu+H/Xkls5BM9VZ8dqwzCoA+G9AcouCgtA==";
        };
        _WdSGGe9k = {
            "id" = "WdSGGe9k";
            "file" = "structurify-neoforge-2.0.37+mc1.21.4.jar";
            "hash" = "sha512-DYquO/STk0EtpsAa5+KNQ9XzIFCU65dl/rjxBkUoQc0i9qBV0LsOWUJKwo9v9NXTUSocK4ngevvLUyiccr2rRQ==";
        };
        _iAjB8dW3 = {
            "id" = "iAjB8dW3";
            "file" = "structurify-neoforge-2.0.37+mc1.21.5.jar";
            "hash" = "sha512-xio/fkQquWXbC4qhsOFbq4du0UJgpiJmPYgcAcPZH2+4i6AIRWQP05BM+DFFs/12P5q9dVoQ071qR3AXfw+zcw==";
        };
        _1iqyrD3T = {
            "id" = "1iqyrD3T";
            "file" = "structurify-neoforge-2.0.37+mc1.21.8.jar";
            "hash" = "sha512-ilTMLbWz7a/+/FgwbHpg0vIdbCibJ426eQxNT0vo8qwUM7IsXya5azCk52k7tFkBPnajzNFv55sFi3tZj2LmMw==";
        };
        _HHbsh0bO = {
            "id" = "HHbsh0bO";
            "file" = "structurify-neoforge-2.0.37+mc1.21.10.jar";
            "hash" = "sha512-rd2qGjJY57Rn2Ej+r6Qd/67xTJ55wbzzWdcALTG1wU5dbm/MrhRHlu/cQZnvSaHlQMUhvr/Q7EoO70QhjmOfmQ==";
        };
        _SNqXgL0x = {
            "id" = "SNqXgL0x";
            "file" = "structurify-neoforge-2.0.37+mc1.21.11.jar";
            "hash" = "sha512-2VQfWZCRSdhnbLQ26eeC1ZDoZiTG1pywqkpe7zmW45CBH6uKnyi2+fgzD3ozY4tP8GubhBEpo8wLwX/9peOr+Q==";
        };
        _kzzGnetM = {
            "id" = "kzzGnetM";
            "file" = "structurify-neoforge-2.0.37+mc26.1.2.jar";
            "hash" = "sha512-8uQ8k6+X3PFwCookSh7md54+ds+bnBhVPHf8vgtz/vErAMeoKRSaGRBRCqnvXNWKE5qbG9ItYRzrdTqJkDc6uQ==";
        };
        _XH99sLAO = {
            "id" = "XH99sLAO";
            "file" = "structurify-neoforge-2.0.37+mc26.2.jar";
            "hash" = "sha512-JHL5Zsw06BWWUf08iam2FtzDZ040i8/koMsUSSIr6hM0bM4raiqxSpA9rEQ4ZdvyUk33lb6mXzYdngYdv3zu+Q==";
        };
        _FMlB4OQ1 = {
            "id" = "FMlB4OQ1";
            "file" = "structurify-forge-2.0.37+mc1.20.1.jar";
            "hash" = "sha512-UCMqQNlSYwab/9BzpRgUnFffsrug2YGYdjwpPodUSBRHD/+tq3SoaKVbF/xms/5r1V8PH4NtY3nxVkfRTYnEVw==";
        };
        _hS8jcU1j = {
            "id" = "hS8jcU1j";
            "file" = "structurify-fabric-2.0.38+mc1.21.1.jar";
            "hash" = "sha512-boG8HjBmIcxhyUvhydhGgpR7j8ITWX20kuV8VlF//jP80Xhaf4ZTc7srnGt9IN/pZgO2V03JBCpxUEF/8sbyrw==";
        };
        _zZCTMDU2 = {
            "id" = "zZCTMDU2";
            "file" = "structurify-fabric-2.0.38+mc1.21.3.jar";
            "hash" = "sha512-IvNpiH/GKgVKXOA+Jmd3q3h8tXq7RNhDrkJ1P/PVUwqtA2tSbPT+ieSXDnAP3eBfuH/IjRybcdpaqS6kUlWmNQ==";
        };
        _AM4fTiJY = {
            "id" = "AM4fTiJY";
            "file" = "structurify-fabric-2.0.38+mc1.20.1.jar";
            "hash" = "sha512-yCN3wLeCZLtN6L8MFnTaDNJW3MfxwpyOGsraS2+bVcEKmEazrwzgGBefpkG2m4wnhwUtdzmEwyOwM1BOMJxfNw==";
        };
        _wTfCgmTQ = {
            "id" = "wTfCgmTQ";
            "file" = "structurify-fabric-2.0.38+mc1.21.4.jar";
            "hash" = "sha512-B2z3tyHi8b7HhC6qYfv880tEt0Y8VpmvkXj6hDk+2rbwFFkifSy/Qm1Hl/llvHUZnRYRAdNC7k9KdDt4vV9l3A==";
        };
        _jwinfwE6 = {
            "id" = "jwinfwE6";
            "file" = "structurify-fabric-2.0.38+mc1.21.5.jar";
            "hash" = "sha512-dFSxo1zpKNmx+aH0s0H+4zAZjvXW+RxVuOTTVdpUkovCm8SStw9rRrw+dtYDG76J/LrBvtdQOlX49VMobophmA==";
        };
        _fQGH5apE = {
            "id" = "fQGH5apE";
            "file" = "structurify-fabric-2.0.38+mc1.21.8.jar";
            "hash" = "sha512-XWqjheZwvkTR5+yyx+Og4xUFoXUAKO9NwPNaoD8u3ZER8ZQTdBGfyRVtdPy45TTY/hUWveOhEHEGv1a3b9W1AQ==";
        };
        _3ACyDKF1 = {
            "id" = "3ACyDKF1";
            "file" = "structurify-fabric-2.0.38+mc1.21.10.jar";
            "hash" = "sha512-edo6U0lg0DS94bihjVkWQf/gTr384MCnMtxt0EYW00kUMZBVV+V6jPyyomgHbRiqwDzH/NOdQSBCHiEGxSc9BA==";
        };
        _nvHmwWPq = {
            "id" = "nvHmwWPq";
            "file" = "structurify-fabric-2.0.38+mc26.1.2.jar";
            "hash" = "sha512-khoUdMxatUWXEJyLpOplspm3MwU0fOOtVAsBIywZaW0MkNKGtlnOofXv2KNyAk4lWqZWmkTED3+YFv1wNWmxcw==";
        };
        _FjtEbo6N = {
            "id" = "FjtEbo6N";
            "file" = "structurify-fabric-2.0.38+mc1.21.11.jar";
            "hash" = "sha512-y+35LufkjRdZzS3ADCF1NL83mDoNvRReI+ocfZLjb1pX96v2YDlkiEq/ZtYA1nepuoiERsCthpEWWt9A4QTy+g==";
        };
        _RFSWQtGK = {
            "id" = "RFSWQtGK";
            "file" = "structurify-neoforge-2.0.38+mc1.21.1.jar";
            "hash" = "sha512-9AmkXjxK9lNGwrgjmA+JRNu4JbsMjDrV5GfngMF6l4IySVB3nL3nqaugzHUSAdV44+IFZdS4hngOitBnSg/npw==";
        };
        _tIopeTJr = {
            "id" = "tIopeTJr";
            "file" = "structurify-fabric-2.0.38+mc26.2.jar";
            "hash" = "sha512-tY7TZNhpw8WqIg/dx6EIGQ881ZJ5obQegM2+B5zA/K3LAeCKmi3hONhBxFQkzPd1slridFQibNLUpEEbPz6QyQ==";
        };
        _5EFjDvja = {
            "id" = "5EFjDvja";
            "file" = "structurify-neoforge-2.0.38+mc1.21.3.jar";
            "hash" = "sha512-jHZXAPgD7b5shUSx3gmy6z2u7gUT/WiZI+ppFH0dS8wZwtlQQHOeXqb70HyaxIEJvfBIkevtzGKVcs/F0ukuUQ==";
        };
        _qr7dlOi8 = {
            "id" = "qr7dlOi8";
            "file" = "structurify-neoforge-2.0.38+mc1.21.4.jar";
            "hash" = "sha512-K38SHQQ1xMnMAZhdbSjeRUZD0G3q86AXCs/UtBRFA2mJ0HwOCdLITPQz/ejJXY63t6XkWkqsMTmJYh+DLSyMWA==";
        };
        _uf2FWjIz = {
            "id" = "uf2FWjIz";
            "file" = "structurify-neoforge-2.0.38+mc1.21.5.jar";
            "hash" = "sha512-HuuEUPZEPzffPu/fp4wzWPtJmo60ab0O0Cc4KPW8bAQNbzD92dcbya7ZDClDCA7/FkyWx81a3bQkyvuDgZSO5A==";
        };
        _6crU3Qvi = {
            "id" = "6crU3Qvi";
            "file" = "structurify-neoforge-2.0.38+mc1.21.8.jar";
            "hash" = "sha512-ZXYM/nkJ4UIifeR+SJq8Jkv5BKO1Qfrx3LwnJjMhTj+tpknWHS+WV5bX0gGd6IFncSu4Y9/CQX/nOOxNe0gOfw==";
        };
        _XCW02pXy = {
            "id" = "XCW02pXy";
            "file" = "structurify-neoforge-2.0.38+mc1.21.10.jar";
            "hash" = "sha512-bV5UiFmKeBxqLi45JWwWUJbwNnzPE1AvSGUDIM1vATTLXXVi6MwHvRpbQg/jRdjnnkVZbM2wm3JjGHJeqQn72Q==";
        };
        _GCCr7Ily = {
            "id" = "GCCr7Ily";
            "file" = "structurify-neoforge-2.0.38+mc1.21.11.jar";
            "hash" = "sha512-lRdmNsEVI+Z1fMPso6KbljlKx1eAwnAxJ9PjMIqjG6ai0Qxdk3ZAdB5/aaaEtf6iqgViuHG1B8meNnzIJr1YTw==";
        };
        _ZKWF6dC4 = {
            "id" = "ZKWF6dC4";
            "file" = "structurify-neoforge-2.0.38+mc26.1.2.jar";
            "hash" = "sha512-He5G0jEXGRrMH+MzLlR/xZ/fmT3RkC0fSowcoEdKZ8vxcpr2DcyQbroKTcfJhbCicfwI3U9HOnY6TH7YM+ImbQ==";
        };
        _zrYRyJVh = {
            "id" = "zrYRyJVh";
            "file" = "structurify-neoforge-2.0.38+mc26.2.jar";
            "hash" = "sha512-43O+xHF+JEnPmBEoGqZcbu/Bsiqm1Kk1v4hAFfJUfvT2wBU+4z8oyALYOKgye20vlwKRvjUZQHGg1RgJjCVDpA==";
        };
        _J0nvhron = {
            "id" = "J0nvhron";
    ...
    in {
        ...
        "pkg-forge-mc1.20.1-1.0.1" = _r8yQ442X;
        "pkg-forge-mc1.20.1-1.0.2" = _LJNqkfDP;
        "pkg-fabric-mc1.21.1-1.0.2" = _XjKzYwdW;
        "pkg-fabric-mc1.20.1-1.0.2" = _qXboyMEo;
        "pkg-neoforge-mc1.21.1-1.0.2" = _JwCeZfWX;
        "pkg-forge-mc1.20.1-1.0.3" = _yGugM6P1;
        "pkg-fabric-mc1.21.1-1.0.3" = _OQX4b9nV;
        "pkg-fabric-mc1.20.1-1.0.3" = _O4oXWcG3;
        "pkg-neoforge-mc1.21.1-1.0.3" = _WZK8CtqP;
        "pkg-fabric-mc1.20.1-1.0.4" = _nHDXnqpt;
        "pkg-forge-mc1.20.1-1.0.4" = _iV9nZvHE;
        "pkg-fabric-mc1.21.1-1.0.4" = _GFweLEUb;
        "pkg-neoforge-mc1.21.1-1.0.4" = _BSAccUcS;
        "pkg-forge-mc1.20.1-1.0.5" = _D6qR4U7G;
        "pkg-fabric-mc1.20.1-1.0.5" = _Iy8eiwFj;
        "pkg-fabric-mc1.21.1-1.0.5" = _X967tuDT;
        "pkg-neoforge-mc1.21.1-1.0.5" = _QltWx2t4;
        "pkg-forge-mc1.20.1-1.0.6" = _za3votl0;
        "pkg-fabric-mc1.20.1-1.0.6" = _lneOZIxh;
        "pkg-fabric-mc1.21.1-1.0.6" = _EthKkRrK;
        "pkg-neoforge-mc1.21.1-1.0.6" = _XS71PPHD;
        "pkg-fabric-mc1.20.1-1.0.7" = _M839q0rZ;
        "pkg-forge-mc1.20.1-1.0.7" = _r4dnSLcb;
        "pkg-fabric-mc1.21.1-1.0.7" = _itbBUSYy;
        "pkg-neoforge-mc1.21.1-1.0.7" = _eFexO3Uj;
        "pkg-fabric-mc1.20.1-1.0.8" = _zWWAGMAs;
        "pkg-forge-mc1.20.1-1.0.8" = _M6UfrQs2;
        "pkg-fabric-mc1.21.1-1.0.8" = _2sQMnIo2;
        "pkg-neoforge-mc1.21.1-1.0.8" = _pHkqhHNT;
        "pkg-fabric-mc1.21.3-1.0.9" = _1yDI6eAe;
        "pkg-fabric-mc1.21.1-1.0.9" = _GOvm5hvs;
        "pkg-fabric-mc1.20.1-1.0.9" = _HOdRqgAA;
        "pkg-forge-mc1.20.1-1.0.9" = _VPVG1sfF;
        "pkg-fabric-mc1.21.4-1.0.9" = _Ku5tBPam;
        "pkg-neoforge-mc1.21.1-1.0.9" = _iml2KNEl;
        "pkg-neoforge-mc1.21.3-1.0.9" = _SJ9mOGEZ;
        "pkg-neoforge-mc1.21.4-1.0.9" = _QqxZKmzH;
        "pkg-fabric-mc1.21.3-1.0.10" = _zLaC167A;
        "pkg-fabric-mc1.20.1-1.0.10" = _IFgKVQPN;
        "pkg-fabric-mc1.21.1-1.0.10" = _xUhiBXXH;
        "pkg-forge-mc1.20.1-1.0.10" = _bo0L3yxW;
        "pkg-neoforge-mc1.21.1-1.0.10" = _ECKf2b3P;
        "pkg-fabric-mc1.21.4-1.0.10" = _LsbBiEVg;
        "pkg-neoforge-mc1.21.3-1.0.10" = _3kFfDtxS;
        "pkg-neoforge-mc1.21.4-1.0.10" = _AGIlOQCv;
        "pkg-fabric-mc1.20.1-1.0.11" = _YRjXNbrZ;
        "pkg-fabric-mc1.21.1-1.0.11" = _SN9MLn0z;
        "pkg-fabric-mc1.21.3-1.0.11" = _qKZYQhmf;
        "pkg-fabric-mc1.21.4-1.0.11" = _kmldrA1G;
        "pkg-neoforge-mc1.21.1-1.0.11" = _9yexOIkK;
        "pkg-forge-mc1.20.1-1.0.11" = _HdSQGqdH;
        "pkg-neoforge-mc1.21.3-1.0.11" = _PafCk4qP;
        "pkg-neoforge-mc1.21.4-1.0.11" = _CFFcKELZ;
        "pkg-forge-mc1.20.1-1.0.12" = _UmVlDzra;
        "pkg-fabric-mc1.21.1-1.0.12" = _AUsTvXBC;
        "pkg-fabric-mc1.20.1-1.0.12" = _IUZqbV3a;
        "pkg-fabric-mc1.21.3-1.0.12" = _WVwHKoYM;
        "pkg-fabric-mc1.21.4-1.0.12" = _pqsAahPB;
        "pkg-fabric-mc1.21.5-1.0.12" = _cVbmfi8C;
        "pkg-neoforge-mc1.21.1-1.0.12" = _3FU0QDrZ;
        "pkg-neoforge-mc1.21.5-1.0.12" = _tOxERVzw;
        "pkg-neoforge-mc1.21.4-1.0.12" = _sYEnGfmr;
        "pkg-neoforge-mc1.21.3-1.0.12" = _E1XVQDnM;
        "pkg-fabric-mc1.21.1-1.0.13" = _QiEjY2yv;
        "pkg-fabric-mc1.20.1-1.0.13" = _64rSqGIm;
        "pkg-fabric-mc1.21.3-1.0.13" = _WokU8rgO;
        "pkg-fabric-mc1.21.4-1.0.13" = _y0byhcAD;
        "pkg-fabric-mc1.21.5-1.0.13" = _Qey8Ke9C;
        "pkg-neoforge-mc1.21.1-1.0.13" = _LsNcXIhq;
        "pkg-neoforge-mc1.21.3-1.0.13" = _1hg6BQOD;
        "pkg-neoforge-mc1.21.5-1.0.13" = _DqZ65xgG;
        "pkg-neoforge-mc1.21.4-1.0.13" = _Tj4GcMXK;
        "pkg-forge-mc1.20.1-1.0.13" = _FLi6YiU1;
        "pkg-fabric-mc1.21.1-1.0.14" = _iYS8Tn5C;
        "pkg-fabric-mc1.20.1-1.0.14" = _jKt7PDzI;
        "pkg-fabric-mc1.21.3-1.0.14" = _dFMmBGy8;
        "pkg-fabric-mc1.21.4-1.0.14" = _NDtiN8Fu;
        "pkg-fabric-mc1.21.5-1.0.14" = _KxBhg3WV;
        "pkg-neoforge-mc1.21.1-1.0.14" = _QdDcQ71j;
        "pkg-neoforge-mc1.21.5-1.0.14" = _jco4cbRn;
        "pkg-neoforge-mc1.21.4-1.0.14" = _g4QS1x2f;
        "pkg-neoforge-mc1.21.3-1.0.14" = _Gae7awmF;
        "pkg-forge-mc1.20.1-1.0.14" = _aUIk8pc9;
        "pkg-fabric-mc1.21.3-1.0.15" = _AuasO68E;
        "pkg-fabric-mc1.21.1-1.0.15" = _jZMrvyob;
        "pkg-fabric-mc1.20.1-1.0.15" = _llQCgNIU;
        "pkg-fabric-mc1.21.5-1.0.15" = _9kI4rLIJ;
        "pkg-fabric-mc1.21.4-1.0.15" = _4moFUf3R;
        "pkg-neoforge-mc1.21.1-1.0.15" = _xwlrk7Gp;
        "pkg-neoforge-mc1.21.3-1.0.15" = _A7tZz8q3;
        "pkg-neoforge-mc1.21.4-1.0.15" = _ecxWzf2O;
        "pkg-neoforge-mc1.21.5-1.0.15" = _HHVRuUYI;
        "pkg-forge-mc1.20.1-1.0.15" = _K9CLK1tq;
        "pkg-fabric-mc1.21.1-1.0.16" = _WYAowWPp;
        "pkg-fabric-mc1.21.3-1.0.16" = _tEezKR9J;
        "pkg-fabric-mc1.20.1-1.0.16" = _DJ7RS6I7;
        "pkg-fabric-mc1.21.5-1.0.16" = _eZiqVbRr;
        "pkg-fabric-mc1.21.6-1.0.16" = _Qq4w1qM7;
        "pkg-fabric-mc1.21.4-1.0.16" = _I2J4ZjwK;
        "pkg-neoforge-mc1.21.1-1.0.16" = _3UBnnF8e;
        "pkg-neoforge-mc1.21.3-1.0.16" = _l2Zboo10;
        "pkg-neoforge-mc1.21.4-1.0.16" = _N6A1kc3w;
        "pkg-neoforge-mc1.21.5-1.0.16" = _xfVJr5VD;
        "pkg-neoforge-mc1.21.6-1.0.16" = _Zo2ZuDxL;
        "pkg-forge-mc1.20.1-1.0.16" = _4rqrFuBF;
        "pkg-fabric-mc1.21.1-1.0.17" = _ejySYueJ;
        "pkg-fabric-mc1.20.1-1.0.17" = _azWgXUcj;
        "pkg-fabric-mc1.21.3-1.0.17" = _RkKHzEA1;
        "pkg-fabric-mc1.21.4-1.0.17" = _1jzFNSkx;
        "pkg-fabric-mc1.21.5-1.0.17" = _pOVlWEi7;
        "pkg-fabric-mc1.21.6-1.0.17" = _IWktG1ao;
        "pkg-neoforge-mc1.21.1-1.0.17" = _8yTNoRj2;
        "pkg-neoforge-mc1.21.3-1.0.17" = _pZ4zOjak;
        "pkg-neoforge-mc1.21.4-1.0.17" = _vWEhUfto;
        "pkg-neoforge-mc1.21.5-1.0.17" = _oeM4TfVn;
        "pkg-neoforge-mc1.21.6-1.0.17" = _ra5qEJlY;
        "pkg-forge-mc1.20.1-1.0.17" = _NvHel6XX;
        "pkg-fabric-mc1.21.3-1.0.18" = _Bv8SyQb4;
        "pkg-fabric-mc1.21.1-1.0.18" = _WfBDKvoI;
        "pkg-fabric-mc1.20.1-1.0.18" = _28XYrzHm;
        "pkg-fabric-mc1.21.4-1.0.18" = _yfhxwcRE;
        "pkg-fabric-mc1.21.5-1.0.18" = _OpvVF1Vk;
        "pkg-fabric-mc1.21.6-1.0.18" = _67Nf9MRg;
        "pkg-neoforge-mc1.21.1-1.0.18" = _IPLMFOfd;
        "pkg-neoforge-mc1.21.3-1.0.18" = _n5svkLWQ;
        "pkg-neoforge-mc1.21.4-1.0.18" = _ayjIwHTP;
        "pkg-neoforge-mc1.21.5-1.0.18" = _dlBwyYjp;
        "pkg-neoforge-mc1.21.6-1.0.18" = _mVnn5gLb;
        "pkg-forge-mc1.20.1-1.0.18" = _mlBbW1KJ;
        "pkg-fabric-mc1.21.1-1.0.19" = _suMsiCcK;
        "pkg-fabric-mc1.20.1-1.0.19" = _GkRjGLoI;
        "pkg-fabric-mc1.21.3-1.0.19" = _oU99XD9f;
        "pkg-fabric-mc1.21.4-1.0.19" = _VBS7eTKJ;
        "pkg-fabric-mc1.21.5-1.0.19" = _ivitrjzN;
        "pkg-fabric-mc1.21.6-1.0.19" = _LMCPgyiB;
        "pkg-neoforge-mc1.21.1-1.0.19" = _tmaRYpEI;
        "pkg-neoforge-mc1.21.4-1.0.19" = _rkYAqrdJ;
        "pkg-neoforge-mc1.21.3-1.0.19" = _NvgFxmax;
        "pkg-neoforge-mc1.21.5-1.0.19" = _b7frAWwg;
        "pkg-neoforge-mc1.21.6-1.0.19" = _D0t51sN9;
        "pkg-forge-mc1.20.1-1.0.19" = _C1STKyUp;
        "pkg-fabric-mc1.21.3-1.0.20" = _IJcXsyNn;
        "pkg-fabric-mc1.21.1-1.0.20" = _2kPRPwZ9;
        "pkg-fabric-mc1.20.1-1.0.20" = _YhQwo1VX;
        "pkg-fabric-mc1.21.4-1.0.20" = _WH581JeX;
        "pkg-fabric-mc1.21.5-1.0.20" = _LI824Zvg;
        "pkg-fabric-mc1.21.6-1.0.20" = _bqLNFcfH;
        "pkg-neoforge-mc1.21.1-1.0.20" = _FGEFkG9S;
        "pkg-neoforge-mc1.21.4-1.0.20" = _kvNyYZWB;
        "pkg-neoforge-mc1.21.3-1.0.20" = _magN0xHP;
        "pkg-neoforge-mc1.21.5-1.0.20" = _WP8g4IcG;
        "pkg-neoforge-mc1.21.6-1.0.20" = _htH1GSjR;
        "pkg-forge-mc1.20.1-1.0.20" = _U0qJhWdM;
        "pkg-fabric-mc1.21.3-1.0.21" = _LDd4kymH;
        "pkg-fabric-mc1.21.1-1.0.21" = _JXRULocF;
        "pkg-fabric-mc1.20.1-1.0.21" = _au4VQUuG;
        "pkg-fabric-mc1.21.5-1.0.21" = _c7BcidUG;
        "pkg-fabric-mc1.21.4-1.0.21" = _uTd1oIpy;
        "pkg-fabric-mc1.21.8-1.0.21" = _klggIdDg;
        "pkg-neoforge-mc1.21.3-1.0.21" = _3hjjqRot;
        "pkg-neoforge-mc1.21.1-1.0.21" = _Z1NVSjmI;
        "pkg-neoforge-mc1.21.4-1.0.21" = _AQBrnhfu;
        "pkg-neoforge-mc1.21.5-1.0.21" = _nJQctNXe;
        "pkg-neoforge-mc1.21.8-1.0.21" = _37xDZHxp;
        "pkg-forge-mc1.20.1-1.0.21" = _cdeRYWMq;
        "pkg-fabric-2.0.0a+mc1.20.1" = _f0pK8tIn;
        "pkg-fabric-2.0.0a+mc1.21.1" = _wxE3apHb;
        "pkg-fabric-2.0.0a+mc1.21.3" = _d7SoNAIJ;
        "pkg-fabric-2.0.0a+mc1.21.5" = _TkazUQ6s;
        "pkg-fabric-2.0.0a+mc1.21.8" = _pIG2VKY0;
        "pkg-fabric-2.0.0a+mc1.21.10" = _zw0HuqlR;
        "pkg-neoforge-2.0.0a+mc1.21.3" = _4INjGngB;
        "pkg-neoforge-2.0.0a+mc1.21.1" = _OqAxNEci;
        "pkg-neoforge-2.0.0a+mc1.21.5" = _27ahwOWA;
        "pkg-forge-2.0.0a+mc1.20.1" = _NlPFbn1u;
        "pkg-neoforge-2.0.0a+mc1.21.8" = _EUAjMhwB;
        "pkg-neoforge-2.0.0a+mc1.21.10" = _ExqkrKAH;
        "pkg-fabric-2.0.1a+mc1.20.1" = _nsm3Kgbo;
        "pkg-fabric-2.0.1a+mc1.21.3" = _xEUxl7F0;
        "pkg-fabric-2.0.1a+mc1.21.1" = _ci6LXZzD;
        "pkg-fabric-2.0.1a+mc1.21.10" = _OEZCJjNE;
        "pkg-fabric-2.0.1a+mc1.21.5" = _hLh05DOQ;
        "pkg-fabric-2.0.1a+mc1.21.8" = _DxjEhD03;
        "pkg-neoforge-2.0.1a+mc1.21.1" = _Y18skDWq;
        "pkg-neoforge-2.0.1a+mc1.21.3" = _PISO4WwC;
        "pkg-neoforge-2.0.1a+mc1.21.5" = _yEgGJYUs;
        "pkg-neoforge-2.0.1a+mc1.21.8" = _qfPy6jH0;
        "pkg-neoforge-2.0.1a+mc1.21.10" = _PealM1C2;
        "pkg-forge-2.0.1a+mc1.20.1" = _U31DvZkR;
        "pkg-fabric-2.0.2a+mc1.21.1" = _xP52gfas;
        "pkg-fabric-2.0.2a+mc1.21.3" = _aER6FY19;
        "pkg-fabric-2.0.2a+mc1.20.1" = _MnHYD5xZ;
        "pkg-fabric-2.0.2a+mc1.21.5" = _vc7eReuH;
        "pkg-fabric-2.0.2a+mc1.21.10" = _aJpPMs0z;
        "pkg-fabric-2.0.2a+mc1.21.8" = _9IRIh2MO;
        "pkg-neoforge-2.0.2a+mc1.21.1" = _4P20BC9E;
        "pkg-neoforge-2.0.2a+mc1.21.5" = _9qbUBryf;
        "pkg-neoforge-2.0.2a+mc1.21.3" = _RNoTEdhh;
        "pkg-neoforge-2.0.2a+mc1.21.8" = _rAY56Yvh;
        "pkg-neoforge-2.0.2a+mc1.21.10" = _1eLkvxQ1;
        "pkg-forge-2.0.2a+mc1.20.1" = _lakA9SDS;
        "pkg-fabric-2.0.3a+mc1.21.1" = _gts7bcdd;
        "pkg-fabric-2.0.3a+mc1.21.3" = _MD88u0fE;
        "pkg-fabric-2.0.3a+mc1.20.1" = _IyM0hyV7;
        "pkg-fabric-2.0.3a+mc1.21.5" = _CU3LtAtx;
        "pkg-fabric-2.0.3a+mc1.21.8" = _Jkod2bf0;
        "pkg-fabric-2.0.3a+mc1.21.10" = _98hCgq6A;
        "pkg-neoforge-2.0.3a+mc1.21.1" = _GeLuum5s;
        "pkg-neoforge-2.0.3a+mc1.21.3" = _cIiKHmj5;
        "pkg-neoforge-2.0.3a+mc1.21.5" = _PR40SCCW;
        "pkg-neoforge-2.0.3a+mc1.21.10" = _7oVAbMln;
        "pkg-neoforge-2.0.3a+mc1.21.8" = _9oHbgIb0;
        "pkg-forge-2.0.3a+mc1.20.1" = _8wTGvhxn;
        "pkg-fabric-2.0.4a+mc1.21.1" = _Kc8jvEoW;
        "pkg-fabric-2.0.4a+mc1.20.1" = _dJMrWrSg;
        "pkg-fabric-2.0.4a+mc1.21.3" = _PvOoblRc;
        "pkg-fabric-2.0.4a+mc1.21.10" = _rLYVpiGE;
        "pkg-fabric-2.0.4a+mc1.21.5" = _QjrkeJiB;
        "pkg-fabric-2.0.4a+mc1.21.8" = _pDBh6IO8;
        "pkg-neoforge-2.0.4a+mc1.21.1" = _uD9hQhW2;
        "pkg-neoforge-2.0.4a+mc1.21.3" = _R2q8PyEm;
        "pkg-neoforge-2.0.4a+mc1.21.5" = _mNAda03h;
        "pkg-neoforge-2.0.4a+mc1.21.10" = _wOjKgZiW;
        "pkg-neoforge-2.0.4a+mc1.21.8" = _9HbZ4cMZ;
        "pkg-forge-2.0.4a+mc1.20.1" = _xAkelxej;
        "pkg-fabric-2.0.5a+mc1.21.10" = _Y5jamXLa;
        "pkg-fabric-2.0.5a+mc1.21.5" = _QIuIprjU;
        "pkg-fabric-2.0.5a+mc1.21.8" = _sxG393Bx;
        "pkg-neoforge-2.0.5a+mc1.21.1" = _fuI6xhjW;
        "pkg-neoforge-2.0.5a+mc1.21.3" = _hOFhLHnQ;
        "pkg-neoforge-2.0.5a+mc1.21.5" = _iUPWzoQ4;
        "pkg-neoforge-2.0.5a+mc1.21.8" = _EaiXVlpa;
        "pkg-neoforge-2.0.5a+mc1.21.10" = _BdtJRwqH;
        "pkg-forge-2.0.5a+mc1.20.1" = _7fIhE53I;
        "pkg-fabric-2.0.5a+mc1.21.1" = _1SrPO0tG;
        "pkg-fabric-2.0.5a+mc1.21.3" = _PBb55cDP;
        "pkg-fabric-2.0.5a+mc1.20.1" = _awrWLn0n;
        "pkg-fabric-2.0.6a+mc1.20.1" = _Zim0XSNa;
        "pkg-fabric-2.0.6a+mc1.21.1" = _CePyMUgO;
        "pkg-fabric-2.0.6a+mc1.21.3" = _QM1sCOsH;
        "pkg-fabric-2.0.6a+mc1.21.5" = _BHdyrm2I;
        "pkg-fabric-2.0.6a+mc1.21.8" = _nHiDkUpc;
        "pkg-fabric-2.0.6a+mc1.21.10" = _QkE971ba;
        "pkg-neoforge-2.0.6a+mc1.21.3" = _YPVAYRsY;
        "pkg-neoforge-2.0.6a+mc1.21.1" = _fhchsmLe;
        "pkg-neoforge-2.0.6a+mc1.21.5" = _nI79PWg2;
        "pkg-forge-2.0.6a+mc1.20.1" = _TcHS16hS;
        "pkg-neoforge-2.0.6a+mc1.21.10" = _U9IrwApq;
        "pkg-neoforge-2.0.6a+mc1.21.8" = _Hj6b9BNa;
        "pkg-fabric-2.0.7b+mc1.21.1" = _x4jaB9UV;
        "pkg-fabric-2.0.7b+mc1.21.3" = _lO0auYO6;
        "pkg-fabric-2.0.7b+mc1.20.1" = _1BHK2hb9;
        "pkg-fabric-2.0.7b+mc1.21.5" = _lVF6ogNt;
        "pkg-fabric-2.0.7b+mc1.21.10" = _29BgZIvk;
        "pkg-fabric-2.0.7b+mc1.21.8" = _WrQ47M79;
        "pkg-neoforge-2.0.7b+mc1.21.3" = _qpBNvjK0;
        "pkg-neoforge-2.0.7b+mc1.21.1" = _z7cunSEf;
        "pkg-neoforge-2.0.7b+mc1.21.5" = _vdkAsM4Z;
        "pkg-neoforge-2.0.7b+mc1.21.8" = _t7ruvVcz;
        "pkg-forge-2.0.7b+mc1.20.1" = _Vt5m7HEd;
        "pkg-neoforge-2.0.7b+mc1.21.10" = _PaGFH4rd;
        "pkg-fabric-2.0.8b+mc1.21.3" = _pSwc0tUX;
        "pkg-fabric-2.0.8b+mc1.20.1" = _k7QAxqBw;
        "pkg-fabric-2.0.8b+mc1.21.1" = _aJmmce2H;
        "pkg-fabric-2.0.8b+mc1.21.8" = _ZdOElzHg;
        "pkg-fabric-2.0.8b+mc1.21.5" = _G5piS1CV;
        "pkg-fabric-2.0.8b+mc1.21.10" = _Hz8Cvpg1;
        "pkg-neoforge-2.0.8b+mc1.21.3" = _j1nCTkvE;
        "pkg-neoforge-2.0.8b+mc1.21.8" = _B3ACvi4c;
        "pkg-neoforge-2.0.8b+mc1.21.1" = _UvTLMHjq;
        "pkg-neoforge-2.0.8b+mc1.21.5" = _QwFjsxpp;
        "pkg-forge-2.0.8b+mc1.20.1" = _wDhSCXxB;
        "pkg-neoforge-2.0.8b+mc1.21.10" = _A0lwLJUb;
        "pkg-fabric-2.0.9b+mc1.20.1" = _XOBgADvO;
        "pkg-fabric-2.0.9b+mc1.21.1" = _TTiUwGzE;
        "pkg-fabric-2.0.9b+mc1.21.3" = _cK8MCLrK;
        "pkg-fabric-2.0.9b+mc1.21.5" = _ARFae5Dr;
        "pkg-fabric-2.0.9b+mc1.21.10" = _Lwdq5kNp;
        "pkg-fabric-2.0.9b+mc1.21.8" = _M7qN6snB;
        "pkg-neoforge-2.0.9b+mc1.21.1" = _kdixH3q3;
        "pkg-neoforge-2.0.9b+mc1.21.3" = _3OeRG5iC;
        "pkg-neoforge-2.0.9b+mc1.21.8" = _i6rLQ2zS;
        "pkg-neoforge-2.0.9b+mc1.21.5" = _DG4xNZNO;
        "pkg-neoforge-2.0.9b+mc1.21.10" = _nL8gfRnt;
        "pkg-forge-2.0.9b+mc1.20.1" = _1W7bVnqG;
        "pkg-fabric-2.0.10+mc1.20.1" = _DK7a1Css;
        "pkg-fabric-2.0.10+mc1.21.3" = _hzVgvgWs;
        "pkg-fabric-2.0.10+mc1.21.1" = _nVbnXxwe;
        "pkg-fabric-2.0.10+mc1.21.4" = _uycnG3Yt;
        "pkg-fabric-2.0.10+mc1.21.5" = _2Ve2KKFG;
        "pkg-fabric-2.0.10+mc1.21.8" = _YG4ntl93;
        "pkg-fabric-2.0.10+mc1.21.11" = _jlC5U82S;
        "pkg-neoforge-2.0.10+mc1.21.1" = _HSnhTbrf;
        "pkg-fabric-2.0.10+mc1.21.10" = _28NfwKFV;
        "pkg-neoforge-2.0.10+mc1.21.3" = _nsVAcqDZ;
        "pkg-neoforge-2.0.10+mc1.21.4" = _dOgD5ggN;
        "pkg-neoforge-2.0.10+mc1.21.5" = _qlu7L6rt;
        "pkg-neoforge-2.0.10+mc1.21.11" = _K4s0I3HD;
        "pkg-neoforge-2.0.10+mc1.21.8" = _YFs8QcYI;
        "pkg-neoforge-2.0.10+mc1.21.10" = _hLYuPj6N;
        "pkg-forge-2.0.10+mc1.20.1" = _UoJyfXZe;
        "pkg-fabric-2.0.11+mc1.21.1" = _t8PTKCfs;
        "pkg-fabric-2.0.11+mc1.20.1" = _yAuZ0hzw;
        "pkg-fabric-2.0.11+mc1.21.8" = _LdrOvR1d;
        "pkg-fabric-2.0.11+mc1.21.5" = _yPdgIKFC;
        "pkg-fabric-2.0.11+mc1.21.4" = _YzcH3bUS;
        "pkg-fabric-2.0.11+mc1.21.11" = _Gf4fhbac;
        "pkg-fabric-2.0.11+mc1.21.10" = _XA6KHCzN;
        "pkg-neoforge-2.0.11+mc1.21.1" = _zsnxLT3j;
        "pkg-neoforge-2.0.11+mc1.21.3" = _nVtytloE;
        "pkg-neoforge-2.0.11+mc1.21.4" = _Ubw6BGwN;
        "pkg-neoforge-2.0.11+mc1.21.5" = _3WXa8r9n;
        "pkg-neoforge-2.0.11+mc1.21.11" = _DO9NC5F4;
        "pkg-neoforge-2.0.11+mc1.21.8" = _fXy6tw2t;
        "pkg-neoforge-2.0.11+mc1.21.10" = _W12bTvvj;
        "pkg-forge-2.0.11+mc1.20.1" = _BC0L0fye;
        "pkg-fabric-2.0.12+mc1.21.1" = _6Jk8Zm0G;
        "pkg-fabric-2.0.12+mc1.20.1" = _iPKGgJGk;
        "pkg-fabric-2.0.12+mc1.21.3" = _unV7xJBe;
        "pkg-fabric-2.0.12+mc1.21.4" = _Q9L1cjvQ;
        "pkg-fabric-2.0.12+mc1.21.5" = _MTnoIkPX;
        "pkg-fabric-2.0.12+mc1.21.8" = _aucCPI5D;
        "pkg-fabric-2.0.12+mc1.21.10" = _xusjHmYk;
        "pkg-fabric-2.0.12+mc1.21.11" = _lfXEHDRs;
        "pkg-neoforge-2.0.12+mc1.21.1" = _Y50DnCNH;
        "pkg-neoforge-2.0.12+mc1.21.3" = _9hhul5J0;
        "pkg-neoforge-2.0.12+mc1.21.4" = _pltOs02q;
        "pkg-neoforge-2.0.12+mc1.21.5" = _9ldcmpKu;
        "pkg-neoforge-2.0.12+mc1.21.8" = _ddUmyDl1;
        "pkg-neoforge-2.0.12+mc1.21.10" = _H4PUMcgk;
        "pkg-neoforge-2.0.12+mc1.21.11" = _n1gzZdUJ;
        "pkg-forge-2.0.12+mc1.20.1" = _ta3VFHd9;
        "pkg-fabric-2.0.13+mc1.21.1" = _Vk2j3gwQ;
        "pkg-fabric-2.0.13+mc1.20.1" = _3LtL3BZZ;
        "pkg-fabric-2.0.13+mc1.21.3" = _ZpefNPBO;
        "pkg-fabric-2.0.13+mc1.21.4" = _dR3FTejj;
        "pkg-fabric-2.0.13+mc1.21.5" = _8CBim6Fm;
        "pkg-fabric-2.0.13+mc1.21.8" = _drtNClch;
        "pkg-fabric-2.0.13+mc1.21.10" = _qJEQEU4p;
        "pkg-neoforge-2.0.13+mc1.21.1" = _G2q3lVm6;
        "pkg-fabric-2.0.13+mc1.21.11" = _IS3FifNY;
        "pkg-neoforge-2.0.13+mc1.21.3" = _m7YV7OEe;
        "pkg-neoforge-2.0.13+mc1.21.4" = _ljRXL6Sw;
        "pkg-neoforge-2.0.13+mc1.21.5" = _WMSo7nDv;
        "pkg-neoforge-2.0.13+mc1.21.8" = _j8yv8OpK;
        "pkg-neoforge-2.0.13+mc1.21.10" = _eSV82cq7;
        "pkg-neoforge-2.0.13+mc1.21.11" = _iuFKOUa2;
        "pkg-forge-2.0.13+mc1.20.1" = _jbR0pRu4;
        "pkg-fabric-2.0.14+mc1.21.3" = _lrYRprVY;
        "pkg-fabric-2.0.14+mc1.21.4" = _1Op2ZVq4;
        "pkg-fabric-2.0.14+mc1.21.8" = _r82PUhCG;
        "pkg-neoforge-2.0.14+mc1.21.3" = _qGa9bRu6;
        "pkg-neoforge-2.0.14+mc1.21.4" = _k1eoRwrV;
        "pkg-neoforge-2.0.14+mc1.21.5" = _XrxpmMdj;
        "pkg-fabric-2.0.14+mc1.21.5" = _lj0NlJ6Y;
        "pkg-fabric-2.0.14+mc1.21.10" = _LmKNQEJ8;
        "pkg-fabric-2.0.14+mc1.20.1" = _yvdR2zxy;
        "pkg-neoforge-2.0.14+mc1.21.10" = _bgwEhFIn;
        "pkg-neoforge-2.0.14+mc1.21.8" = _nRXzK1cr;
        "pkg-neoforge-2.0.14+mc1.21.1" = _BatXRIVe;
        "pkg-forge-2.0.14+mc1.20.1" = _Tw3A1Wxm;
        "pkg-fabric-2.0.14+mc1.21.11" = _8jI9NCBt;
        "pkg-fabric-2.0.14+mc1.21.1" = _ebBTR6hU;
        "pkg-neoforge-2.0.14+mc1.21.11" = _pXnG6uTY;
        "pkg-fabric-2.0.15+mc1.21.1" = _ttdIiHk0;
        "pkg-fabric-2.0.15+mc1.20.1" = _ozwPkzZF;
        "pkg-fabric-2.0.15+mc1.21.3" = _wvnJ5jvF;
        "pkg-fabric-2.0.15+mc1.21.4" = _QzCjQmBn;
        "pkg-fabric-2.0.15+mc1.21.5" = _eBOno2WO;
        "pkg-fabric-2.0.15+mc1.21.8" = _8nj02ByC;
        "pkg-fabric-2.0.15+mc1.21.10" = _GvfDLbFI;
        "pkg-fabric-2.0.15+mc1.21.11" = _olJiob4P;
        "pkg-neoforge-2.0.15+mc1.21.1" = _5nmO3kjK;
        "pkg-neoforge-2.0.15+mc1.21.3" = _7SLTeDlo;
        "pkg-neoforge-2.0.15+mc1.21.4" = _HYYNuEWI;
        "pkg-neoforge-2.0.15+mc1.21.5" = _7hXznjdP;
        "pkg-neoforge-2.0.15+mc1.21.8" = _LR4N3gcO;
        "pkg-neoforge-2.0.15+mc1.21.10" = _CtNhNIlX;
        "pkg-neoforge-2.0.15+mc1.21.11" = _kcAXTYoo;
        "pkg-forge-2.0.15+mc1.20.1" = _iobsSN4o;
        "pkg-fabric-2.0.16+mc1.21.1" = _q1rptMWX;
        "pkg-fabric-2.0.16+mc1.20.1" = _8ZOwzGYO;
        "pkg-fabric-2.0.16+mc1.21.3" = _moWlGpm2;
        "pkg-fabric-2.0.16+mc1.21.4" = _ajYwm2hz;
        "pkg-fabric-2.0.16+mc1.21.5" = _GAIXrVUM;
        "pkg-fabric-2.0.16+mc1.21.8" = _e799UZfF;
        "pkg-fabric-2.0.16+mc1.21.10" = _3XNPzppC;
        "pkg-fabric-2.0.16+mc1.21.11" = _fwFuVerj;
        "pkg-neoforge-2.0.16+mc1.21.1" = _BcPWU96u;
        "pkg-neoforge-2.0.16+mc1.21.4" = _94Q9bZne;
        "pkg-neoforge-2.0.16+mc1.21.5" = _drJhFYP6;
        "pkg-neoforge-2.0.16+mc1.21.3" = _4PzocxsQ;
        "pkg-neoforge-2.0.16+mc1.21.11" = _IUhzHuSn;
        "pkg-neoforge-2.0.16+mc1.21.10" = _ZXtTGY7P;
        "pkg-neoforge-2.0.16+mc1.21.8" = _fOXxbeUH;
        "pkg-forge-2.0.16+mc1.20.1" = _vlDUIGCh;
        "pkg-fabric-2.0.17+mc1.21.1" = _vNEI9u7F;
        "pkg-fabric-2.0.17+mc1.20.1" = _RebFCi35;
        "pkg-fabric-2.0.17+mc1.21.3" = _IC37VbEn;
        "pkg-fabric-2.0.17+mc1.21.4" = _rNzTYSPN;
        "pkg-fabric-2.0.17+mc1.21.5" = _mQi4uAjm;
        "pkg-fabric-2.0.17+mc1.21.8" = _Y13b3L2g;
        "pkg-neoforge-2.0.17+mc1.21.1" = _kJAv0FdB;
        "pkg-fabric-2.0.17+mc1.21.10" = _TdF9idHJ;
        "pkg-neoforge-2.0.17+mc1.21.4" = _yhvLEgsV;
        "pkg-neoforge-2.0.17+mc1.21.3" = _Fn2Npgpb;
        "pkg-neoforge-2.0.17+mc1.21.5" = _WHv8eFEj;
        "pkg-neoforge-2.0.17+mc1.21.8" = _j3MLQCKN;
        "pkg-neoforge-2.0.17+mc1.21.11" = _kZCo6ojU;
        "pkg-fabric-2.0.17+mc1.21.11" = _hNo0FSHD;
        "pkg-neoforge-2.0.17+mc1.21.10" = _KAFv1Rhf;
        "pkg-forge-2.0.17+mc1.20.1" = _hHbgVGke;
        "pkg-fabric-2.0.18+mc1.21.1" = _6KE9COfO;
        "pkg-fabric-2.0.18+mc1.21.3" = _5Gtq2yw2;
        "pkg-fabric-2.0.18+mc1.20.1" = _yvznJpEB;
        "pkg-fabric-2.0.18+mc1.21.4" = _FOBEEUr6;
        "pkg-fabric-2.0.18+mc1.21.8" = _Gg1ILHSw;
        "pkg-fabric-2.0.18+mc1.21.5" = _SZdbBFbK;
        "pkg-neoforge-2.0.18+mc1.21.1" = _zVQAhM7g;
        "pkg-fabric-2.0.18+mc1.21.10" = _WZ2pcWpx;
        "pkg-fabric-2.0.18+mc1.21.11" = _mtSDKeiF;
        "pkg-neoforge-2.0.18+mc1.21.4" = _Qqj26V2D;
        "pkg-neoforge-2.0.18+mc1.21.3" = _PdN0rOUx;
        "pkg-neoforge-2.0.18+mc1.21.5" = _aa4sfKgK;
        "pkg-neoforge-2.0.18+mc1.21.8" = _HHu5EIUB;
        "pkg-neoforge-2.0.18+mc1.21.10" = _wOwthPWh;
        "pkg-neoforge-2.0.18+mc1.21.11" = _B1EJw6tY;
        "pkg-forge-2.0.18+mc1.20.1" = _i8uzm7Nj;
        "pkg-fabric-2.0.19+mc1.21.1" = _x0Tsel2I;
        "pkg-fabric-2.0.19+mc1.21.3" = _ecQ58J9h;
        "pkg-fabric-2.0.19+mc1.20.1" = _qMxVNfOy;
        "pkg-fabric-2.0.19+mc1.21.4" = _5ZxwZCV7;
        "pkg-fabric-2.0.19+mc1.21.5" = _Werk0hhp;
        "pkg-fabric-2.0.19+mc1.21.8" = _LQzSUsCv;
        "pkg-fabric-2.0.19+mc1.21.10" = _LYsoiy37;
        "pkg-fabric-2.0.19+mc1.21.11" = _DEmaw4qP;
        "pkg-neoforge-2.0.19+mc1.21.1" = _iEIjC4H7;
        "pkg-neoforge-2.0.19+mc1.21.3" = _vET6w60t;
        "pkg-neoforge-2.0.19+mc1.21.4" = _1LGs7Sxx;
        "pkg-neoforge-2.0.19+mc1.21.5" = _IL1OTFOq;
        "pkg-neoforge-2.0.19+mc1.21.8" = _TbTDCcJp;
        "pkg-neoforge-2.0.19+mc1.21.10" = _UnVF0cMf;
        "pkg-neoforge-2.0.19+mc1.21.11" = _pM2GTSUD;
        "pkg-forge-2.0.19+mc1.20.1" = _gm8iveHl;
        "pkg-fabric-2.0.20+mc1.21.3" = _H9ToFPAD;
        "pkg-fabric-2.0.20+mc1.21.4" = _SOkrR5sj;
        "pkg-fabric-2.0.20+mc1.21.1" = _oNM7C6i6;
        "pkg-fabric-2.0.20+mc1.20.1" = _buuVmv04;
        "pkg-fabric-2.0.20+mc1.21.5" = _ySduWxbP;
        "pkg-fabric-2.0.20+mc1.21.8" = _sJHx2e5s;
        "pkg-fabric-2.0.20+mc1.21.10" = _oj7qhMUs;
        "pkg-fabric-2.0.20+mc26.1" = _dVsBQv67;
        "pkg-fabric-2.0.20+mc1.21.11" = _mvON1Dwa;
        "pkg-neoforge-2.0.20+mc1.21.1" = _ZhgTxxg2;
        "pkg-neoforge-2.0.20+mc1.21.3" = _9x1QLqsP;
        "pkg-neoforge-2.0.20+mc1.21.4" = _zRO88OOy;
        "pkg-neoforge-2.0.20+mc1.21.5" = _TQUdTnNh;
        "pkg-neoforge-2.0.20+mc1.21.8" = _4Jc7kYiT;
        "pkg-neoforge-2.0.20+mc26.1" = _sx9X9yIX;
        "pkg-neoforge-2.0.20+mc1.21.10" = _dBnEc73W;
        "pkg-neoforge-2.0.20+mc1.21.11" = _LzjhUcd3;
        "pkg-forge-2.0.20+mc1.20.1" = _v0tLYIN9;
        "pkg-fabric-2.0.22+mc1.20.1" = _22tTVPqL;
        "pkg-fabric-2.0.22+mc1.21.1" = _4tq3Zjol;
        "pkg-fabric-2.0.22+mc1.21.3" = _Vk2RnBOd;
        "pkg-fabric-2.0.22+mc1.21.4" = _UzzriLDn;
        "pkg-fabric-2.0.22+mc1.21.8" = _KCpDbn3j;
        "pkg-fabric-2.0.22+mc1.21.5" = _zVpn9U45;
        "pkg-fabric-2.0.22+mc26.1" = _M9s2dNka;
        "pkg-fabric-2.0.22+mc1.21.10" = _Tn7hUssf;
        "pkg-neoforge-2.0.22+mc1.21.1" = _YmkYhsGj;
        "pkg-fabric-2.0.22+mc1.21.11" = _bgBwDOHs;
        "pkg-neoforge-2.0.22+mc1.21.3" = _ZasKH3LU;
        "pkg-neoforge-2.0.22+mc1.21.4" = _zXCy4YPX;
        "pkg-neoforge-2.0.22+mc1.21.8" = _PYJwDSyq;
        "pkg-neoforge-2.0.22+mc1.21.5" = _hNci0TPE;
        "pkg-neoforge-2.0.22+mc26.1" = _tO1JoNgA;
        "pkg-neoforge-2.0.22+mc1.21.10" = _7MLZeQE2;
        "pkg-forge-2.0.22+mc1.20.1" = _xmyyHiHM;
        "pkg-neoforge-2.0.22+mc1.21.11" = _nu1Pvi4Y;
        "pkg-fabric-2.0.23+mc1.21.1" = _wPunVePC;
        "pkg-fabric-2.0.23+mc1.21.3" = _E5B2Kg0C;
        "pkg-fabric-2.0.23+mc1.21.4" = _Yp9uq1aU;
        "pkg-fabric-2.0.23+mc1.20.1" = _4ogzS17O;
        "pkg-fabric-2.0.23+mc1.21.5" = _S6LRvJER;
        "pkg-fabric-2.0.23+mc1.21.8" = _3Y36i0ec;
        "pkg-fabric-2.0.23+mc1.21.10" = _xotke5Ry;
        "pkg-fabric-2.0.23+mc26.1.2" = _t6gaxeCI;
        "pkg-fabric-2.0.23+mc1.21.11" = _ltdkASNY;
        "pkg-neoforge-2.0.23+mc1.21.1" = _y2qFQhHW;
        "pkg-neoforge-2.0.23+mc1.21.3" = _qBZvFbst;
        "pkg-neoforge-2.0.23+mc1.21.5" = _TgXwPqGT;
        "pkg-neoforge-2.0.23+mc1.21.4" = _mwbVXf73;
        "pkg-neoforge-2.0.23+mc1.21.8" = _jwQv2B9p;
        "pkg-neoforge-2.0.23+mc1.21.10" = _Er5sB9kb;
        "pkg-neoforge-2.0.23+mc26.1.2" = _fn7utNDc;
        "pkg-neoforge-2.0.23+mc1.21.11" = _WAoPnOVX;
        "pkg-forge-2.0.23+mc1.20.1" = _ZpbmyVaW;
        "pkg-fabric-2.0.24+mc1.21.3" = _XDVCdxgN;
        "pkg-fabric-2.0.24+mc1.21.1" = _U068Q3ID;
        "pkg-fabric-2.0.24+mc1.21.4" = _PVkDIra7;
        "pkg-fabric-2.0.24+mc1.21.5" = _NIso7g3M;
        "pkg-fabric-2.0.24+mc1.20.1" = _1OPAc7CQ;
        "pkg-fabric-2.0.24+mc1.21.8" = _QiGkAZaz;
        "pkg-fabric-2.0.24+mc1.21.10" = _RKODgrbT;
        "pkg-fabric-2.0.24+mc26.1.2" = _hm4Vyurm;
        "pkg-fabric-2.0.24+mc1.21.11" = _XM0YFYLG;
        "pkg-neoforge-2.0.24+mc1.21.1" = _8e3OCnCd;
        "pkg-neoforge-2.0.24+mc1.21.3" = _EjEeHaJZ;
        "pkg-neoforge-2.0.24+mc1.21.4" = _6n6mw7HF;
        "pkg-neoforge-2.0.24+mc1.21.10" = _DHSoW7SX;
        "pkg-neoforge-2.0.24+mc1.21.8" = _ePNFkva1;
        "pkg-neoforge-2.0.24+mc1.21.5" = _dZUKgT0A;
        "pkg-neoforge-2.0.24+mc26.1.2" = _39FuhjN0;
        "pkg-neoforge-2.0.24+mc1.21.11" = _KxiZH4gr;
        "pkg-forge-2.0.24+mc1.20.1" = _vevEEqOE;
        "pkg-fabric-2.0.25+mc1.20.1" = _pEb3w6K2;
        "pkg-fabric-2.0.25+mc1.21.1" = _YwmsTLpw;
        "pkg-fabric-2.0.25+mc1.21.3" = _cJmpvU9C;
        "pkg-fabric-2.0.25+mc1.21.4" = _NT9Nz6sN;
        "pkg-fabric-2.0.25+mc1.21.5" = _X0J7jRjc;
        "pkg-fabric-2.0.25+mc1.21.8" = _ACaoriiP;
        "pkg-fabric-2.0.25+mc1.21.10" = _dL5xxZyr;
        "pkg-fabric-2.0.25+mc1.21.11" = _Qsda3ubF;
        "pkg-fabric-2.0.25+mc26.1.2" = _KLXvSaPx;
        "pkg-neoforge-2.0.25+mc1.21.1" = _nKCdwUbt;
        "pkg-neoforge-2.0.25+mc1.21.3" = _cMKfi7Yd;
        "pkg-neoforge-2.0.25+mc1.21.4" = _qCPU0gig;
        "pkg-neoforge-2.0.25+mc1.21.5" = _mBpbro5a;
        "pkg-neoforge-2.0.25+mc1.21.8" = _rIo7rDuc;
        "pkg-neoforge-2.0.25+mc1.21.10" = _7T18k14N;
        "pkg-neoforge-2.0.25+mc1.21.11" = _1dsTuyro;
        "pkg-neoforge-2.0.25+mc26.1.2" = _IiqyxqOg;
        "pkg-forge-2.0.25+mc1.20.1" = _2FqxMOIp;
        "pkg-neoforge-2.0.25+mc26.2" = _qznwo6fL;
        "pkg-fabric-2.0.25+mc26.2" = _B1OiEfs8;
        "pkg-fabric-2.0.27+mc1.21.1" = _o5IFyT6F;
        "pkg-fabric-2.0.27+mc1.21.3" = _oUcCdHJm;
        "pkg-fabric-2.0.27+mc1.21.4" = _1PycAcb5;
        "pkg-fabric-2.0.27+mc1.20.1" = _bHTY7woQ;
        "pkg-fabric-2.0.27+mc1.21.5" = _CAwwOqjn;
        "pkg-fabric-2.0.27+mc1.21.8" = _QpiYw2Nv;
        "pkg-fabric-2.0.27+mc1.21.10" = _59VaPkPN;
        "pkg-fabric-2.0.27+mc1.21.11" = _FLvdPbzk;
        "pkg-fabric-2.0.27+mc26.2" = _R4lWTsR8;
        "pkg-fabric-2.0.27+mc26.1.2" = _8yaZtMcG;
        "pkg-neoforge-2.0.27+mc1.21.4" = _PVBvzZj1;
        "pkg-neoforge-2.0.27+mc1.21.3" = _FsYcKOvB;
        "pkg-neoforge-2.0.27+mc1.21.1" = _AODT6RnT;
        "pkg-neoforge-2.0.27+mc1.21.8" = _GI4dhCd3;
        "pkg-neoforge-2.0.27+mc1.21.5" = _Q4uobgdb;
        "pkg-neoforge-2.0.27+mc1.21.10" = _idi2xEc5;
        "pkg-neoforge-2.0.27+mc1.21.11" = _PFY7MbFZ;
        "pkg-neoforge-2.0.27+mc26.1.2" = _D91WQzWX;
        "pkg-neoforge-2.0.27+mc26.2" = _gvPUGKRN;
        "pkg-forge-2.0.27+mc1.20.1" = _OxUqQB14;
        "pkg-fabric-2.0.28+mc1.21.3" = _Vyo8XUdS;
        "pkg-fabric-2.0.28+mc1.21.1" = _TDuvxIFf;
        "pkg-fabric-2.0.28+mc1.20.1" = _gtKnEu9k;
        "pkg-fabric-2.0.28+mc1.21.8" = _fJHC1Z7o;
        "pkg-fabric-2.0.28+mc1.21.4" = _zFJa05tI;
        "pkg-fabric-2.0.28+mc1.21.5" = _38vhYmrs;
        "pkg-fabric-2.0.28+mc1.21.11" = _OsYNg1Vu;
        "pkg-fabric-2.0.28+mc1.21.10" = _2kHvgDgI;
        "pkg-fabric-2.0.28+mc26.1.2" = _SBKkgJSJ;
        "pkg-fabric-2.0.28+mc26.2" = _9XfOwaK8;
        "pkg-neoforge-2.0.28+mc1.21.3" = _h6e0kb4S;
        "pkg-neoforge-2.0.28+mc1.21.1" = _6R0fmNEx;
        "pkg-neoforge-2.0.28+mc1.21.4" = _2FHVhG5k;
        "pkg-neoforge-2.0.28+mc1.21.8" = _HPAaqXLC;
        "pkg-neoforge-2.0.28+mc1.21.5" = _jtA5tDeX;
        "pkg-neoforge-2.0.28+mc1.21.10" = _cYFqKWLw;
        "pkg-neoforge-2.0.28+mc1.21.11" = _6PriK2on;
        "pkg-neoforge-2.0.28+mc26.1.2" = _9KcvLngC;
        "pkg-neoforge-2.0.28+mc26.2" = _FAYEtGLn;
        "pkg-forge-2.0.28+mc1.20.1" = _ZMccP80G;
        "pkg-fabric-2.0.29+mc1.21.3" = _7YTIuKYV;
        "pkg-fabric-2.0.29+mc1.20.1" = _ErEh2GQX;
        "pkg-fabric-2.0.29+mc1.21.1" = _kl6TR2tG;
        "pkg-fabric-2.0.29+mc1.21.4" = _4BsQLx5L;
        "pkg-fabric-2.0.29+mc1.21.8" = _c0gvvo2p;
        "pkg-fabric-2.0.29+mc1.21.5" = _4SJ9bZbf;
        "pkg-fabric-2.0.29+mc1.21.11" = _XEFydreK;
        "pkg-fabric-2.0.29+mc1.21.10" = _AljIzyHA;
        "pkg-fabric-2.0.29+mc26.1.2" = _hu0ICebg;
        "pkg-fabric-2.0.29+mc26.2" = _s5TwUyYN;
        "pkg-neoforge-2.0.29+mc1.21.1" = _8MYYHlNi;
        "pkg-neoforge-2.0.29+mc1.21.3" = _kpwGd8ae;
        "pkg-neoforge-2.0.29+mc1.21.8" = _jmBBWFaO;
        "pkg-neoforge-2.0.29+mc1.21.4" = _SinCDpIW;
        "pkg-neoforge-2.0.29+mc1.21.5" = _acctZC7f;
        "pkg-neoforge-2.0.29+mc1.21.10" = _B1x1dInT;
        "pkg-neoforge-2.0.29+mc1.21.11" = _V9Hjyyjs;
        "pkg-neoforge-2.0.29+mc26.1.2" = _gphFIIp0;
        "pkg-neoforge-2.0.29+mc26.2" = _9IPs34SY;
        "pkg-forge-2.0.29+mc1.20.1" = _XPO7O3yr;
        "pkg-fabric-2.0.30+mc1.20.1" = _JywxZSe2;
        "pkg-fabric-2.0.30+mc1.21.3" = _Gv11GvsH;
        "pkg-fabric-2.0.30+mc1.21.1" = _GjPwtyHh;
        "pkg-fabric-2.0.30+mc1.21.4" = _Rknu7VNj;
        "pkg-fabric-2.0.30+mc1.21.5" = _EWYm4nB4;
        "pkg-fabric-2.0.30+mc1.21.8" = _91bXTOHA;
        "pkg-fabric-2.0.30+mc1.21.10" = _ijnNgwql;
        "pkg-fabric-2.0.30+mc26.1.2" = _kUjD0h15;
        "pkg-fabric-2.0.30+mc1.21.11" = _G0V7ObjN;
        "pkg-fabric-2.0.30+mc26.2" = _JSBLIMRO;
        "pkg-neoforge-2.0.30+mc1.21.3" = _DBlMxyz7;
        "pkg-neoforge-2.0.30+mc1.21.1" = _aV5lNYVM;
        "pkg-neoforge-2.0.30+mc1.21.4" = _kausjBQp;
        "pkg-neoforge-2.0.30+mc1.21.5" = _rldIg126;
        "pkg-neoforge-2.0.30+mc1.21.10" = _fGbajdsq;
        "pkg-neoforge-2.0.30+mc1.21.8" = _47JBCJFL;
        "pkg-neoforge-2.0.30+mc26.2" = _Yc4L5kt0;
        "pkg-neoforge-2.0.30+mc26.1.2" = _zmjp9Hlc;
        "pkg-neoforge-2.0.30+mc1.21.11" = _IsuEes5P;
        "pkg-forge-2.0.30+mc1.20.1" = _5t4WQjoG;
        "pkg-fabric-2.0.32+mc1.20.1" = _TrNE47Zo;
        "pkg-fabric-2.0.32+mc1.21.3" = _ZhgVsF2f;
        "pkg-fabric-2.0.32+mc1.21.1" = _fpUS4Rlr;
        "pkg-fabric-2.0.32+mc1.21.4" = _cOpTps4Y;
        "pkg-fabric-2.0.32+mc1.21.10" = _vvNbRQKp;
        "pkg-fabric-2.0.32+mc1.21.5" = _x9LXDrtk;
        "pkg-fabric-2.0.32+mc1.21.8" = _X4EMsGax;
        "pkg-fabric-2.0.32+mc1.21.11" = _pf7ezSGO;
        "pkg-fabric-2.0.32+mc26.1.2" = _k9aNBk7v;
        "pkg-fabric-2.0.32+mc26.2" = _ZR4auc54;
        "pkg-neoforge-2.0.32+mc1.21.3" = _b5VYk0Rb;
        "pkg-neoforge-2.0.32+mc1.21.1" = _p5Engpdh;
        "pkg-neoforge-2.0.32+mc1.21.4" = _vFjST2Ro;
        "pkg-neoforge-2.0.32+mc1.21.5" = _HpoIgtmb;
        "pkg-neoforge-2.0.32+mc1.21.8" = _hA37mO3C;
        "pkg-neoforge-2.0.32+mc1.21.10" = _CRn9IgmF;
        "pkg-neoforge-2.0.32+mc26.1.2" = _R3wjdTvG;
        "pkg-neoforge-2.0.32+mc1.21.11" = _AHPn11rb;
        "pkg-neoforge-2.0.32+mc26.2" = _prjWdOAr;
        "pkg-forge-2.0.32+mc1.20.1" = _a7xBByM3;
        "pkg-fabric-2.0.33+mc1.21.3" = _GFlSJMqJ;
        "pkg-fabric-2.0.33+mc1.20.1" = _bGE1xExV;
        "pkg-fabric-2.0.33+mc1.21.1" = _u0O9EU1P;
        "pkg-fabric-2.0.33+mc1.21.8" = _ig88Gew2;
        "pkg-fabric-2.0.33+mc1.21.4" = _TSXKJxDo;
        "pkg-fabric-2.0.33+mc1.21.5" = _FSjQpFME;
        "pkg-fabric-2.0.33+mc1.21.10" = _PSkw0LA8;
        "pkg-fabric-2.0.33+mc1.21.11" = _4dXJuvXu;
        "pkg-fabric-2.0.33+mc26.1.2" = _XAbVfsJS;
        "pkg-fabric-2.0.33+mc26.2" = _7u0YpjAk;
        "pkg-neoforge-2.0.33+mc1.21.3" = _6AItkCQI;
        "pkg-neoforge-2.0.33+mc1.21.1" = _5ZFXdRz4;
        "pkg-neoforge-2.0.33+mc1.21.4" = _e4YB2WyC;
        "pkg-neoforge-2.0.33+mc1.21.8" = _t9bdLsvK;
        "pkg-neoforge-2.0.33+mc1.21.5" = _tc0v75dg;
        "pkg-neoforge-2.0.33+mc1.21.10" = _864fKCoC;
        "pkg-neoforge-2.0.33+mc26.1.2" = _QXOcllI0;
        "pkg-neoforge-2.0.33+mc1.21.11" = _SG3KdLft;
        "pkg-neoforge-2.0.33+mc26.2" = _9OUiifDA;
        "pkg-forge-2.0.33+mc1.20.1" = _x0hH5Y0z;
        "pkg-fabric-2.0.34+mc1.21.3" = _7ATeFihc;
        "pkg-fabric-2.0.34+mc1.21.1" = _l6yfL0Oq;
        "pkg-fabric-2.0.34+mc1.20.1" = _PAqaNVUl;
        "pkg-fabric-2.0.34+mc1.21.4" = _WhzRtsoQ;
        "pkg-fabric-2.0.34+mc1.21.8" = _LHEYqn5Y;
        "pkg-fabric-2.0.34+mc1.21.5" = _yinaVPDh;
        "pkg-fabric-2.0.34+mc1.21.11" = _vdmzxGHh;
        "pkg-fabric-2.0.34+mc1.21.10" = _lKIvvrIj;
        "pkg-fabric-2.0.34+mc26.1.2" = _IErKoJHu;
        "pkg-fabric-2.0.34+mc26.2" = _u302AlWj;
        "pkg-neoforge-2.0.34+mc1.21.1" = _p4OuueNU;
        "pkg-neoforge-2.0.34+mc1.21.3" = _7IKyXUzF;
        "pkg-neoforge-2.0.34+mc1.21.4" = _Jgbgjw7X;
        "pkg-neoforge-2.0.34+mc1.21.8" = _1vnIElvg;
        "pkg-neoforge-2.0.34+mc1.21.5" = _PwVDFnVh;
        "pkg-neoforge-2.0.34+mc1.21.10" = _a46585Si;
        "pkg-neoforge-2.0.34+mc26.1.2" = _s3HHHWUD;
        "pkg-neoforge-2.0.34+mc1.21.11" = _rS7mkawN;
        "pkg-neoforge-2.0.34+mc26.2" = _Ev7mLjuF;
        "pkg-forge-2.0.34+mc1.20.1" = _hgq4F5J8;
        "pkg-fabric-2.0.35+mc1.20.1" = _MYYrfpQW;
        "pkg-fabric-2.0.35+mc1.21.3" = _bdB9IxuJ;
        "pkg-fabric-2.0.35+mc1.21.1" = _5rpJyffw;
        "pkg-fabric-2.0.35+mc1.21.4" = _BRc7B0qD;
        "pkg-fabric-2.0.35+mc1.21.5" = _FLtMA4pV;
        "pkg-fabric-2.0.35+mc1.21.8" = _2bt7jex9;
        "pkg-fabric-2.0.35+mc1.21.11" = _lF3TcBlp;
        "pkg-fabric-2.0.35+mc1.21.10" = _N6NVyzzP;
        "pkg-fabric-2.0.35+mc26.1.2" = _n5AR2RcC;
        "pkg-fabric-2.0.35+mc26.2" = _s6XTgUna;
        "pkg-neoforge-2.0.35+mc1.21.3" = _NO7PrIeU;
        "pkg-neoforge-2.0.35+mc1.21.4" = _MRevPZqC;
        "pkg-neoforge-2.0.35+mc1.21.1" = _xjI3j7S7;
        "pkg-neoforge-2.0.35+mc1.21.5" = _BqmryCjH;
        "pkg-neoforge-2.0.35+mc1.21.10" = _2KeyPHDW;
        "pkg-neoforge-2.0.35+mc1.21.8" = _zrhD8eIE;
        "pkg-neoforge-2.0.35+mc26.1.2" = _v90qyMai;
        "pkg-neoforge-2.0.35+mc26.2" = _TEUvkZAl;
        "pkg-neoforge-2.0.35+mc1.21.11" = _i0HKnVQq;
        "pkg-forge-2.0.35+mc1.20.1" = _PwYZliaI;
        "pkg-fabric-2.0.36+mc1.20.1" = _FMvtlPMI;
        "pkg-fabric-2.0.36+mc1.21.3" = _VOnkUmtg;
        "pkg-fabric-2.0.36+mc1.21.1" = _RDGepoT5;
        "pkg-fabric-2.0.36+mc1.21.4" = _xmM5O4LD;
        "pkg-fabric-2.0.36+mc1.21.8" = _iIgvPsnj;
        "pkg-fabric-2.0.36+mc1.21.5" = _t7AOZpxE;
        "pkg-fabric-2.0.36+mc1.21.10" = _92k8QZTP;
        "pkg-fabric-2.0.36+mc26.1.2" = _PDlzSXg3;
        "pkg-fabric-2.0.36+mc1.21.11" = _JMKW8uxP;
        "pkg-fabric-2.0.36+mc26.2" = _yBMmlmqw;
        "pkg-neoforge-2.0.36+mc1.21.1" = _W8ILA1Vl;
        "pkg-neoforge-2.0.36+mc1.21.3" = _DvG6SiRs;
        "pkg-neoforge-2.0.36+mc1.21.4" = _WtfTc7Dy;
        "pkg-neoforge-2.0.36+mc1.21.5" = _jZB65WSz;
        "pkg-neoforge-2.0.36+mc1.21.8" = _kyOfVHuD;
        "pkg-neoforge-2.0.36+mc1.21.10" = _MOGCYHSn;
        "pkg-neoforge-2.0.36+mc26.1.2" = _r1lXTJyU;
        "pkg-neoforge-2.0.36+mc26.2" = _Dj98FGq2;
        "pkg-neoforge-2.0.36+mc1.21.11" = _5C0DWEI0;
        "pkg-forge-2.0.36+mc1.20.1" = _LpwMthRk;
        "pkg-fabric-2.0.37+mc1.21.3" = _5jv1xD3H;
        "pkg-fabric-2.0.37+mc1.21.4" = _m4Kt5HBM;
        "pkg-fabric-2.0.37+mc1.20.1" = _ZElpxOJA;
        "pkg-fabric-2.0.37+mc1.21.1" = _EJeeapcY;
        "pkg-fabric-2.0.37+mc1.21.5" = _3Tya8kwm;
        "pkg-fabric-2.0.37+mc1.21.8" = _aut3S7Ee;
        "pkg-fabric-2.0.37+mc1.21.10" = _hVEYjiP3;
        "pkg-fabric-2.0.37+mc26.2" = _TZrSp2RU;
        "pkg-fabric-2.0.37+mc26.1.2" = _ZkKmCXs2;
        "pkg-fabric-2.0.37+mc1.21.11" = _hHBROmLr;
        "pkg-neoforge-2.0.37+mc1.21.1" = _lYocU07r;
        "pkg-neoforge-2.0.37+mc1.21.3" = _mH5AEVIY;
        "pkg-neoforge-2.0.37+mc1.21.4" = _WdSGGe9k;
        "pkg-neoforge-2.0.37+mc1.21.5" = _iAjB8dW3;
        "pkg-neoforge-2.0.37+mc1.21.8" = _1iqyrD3T;
        "pkg-neoforge-2.0.37+mc1.21.10" = _HHbsh0bO;
        "pkg-neoforge-2.0.37+mc1.21.11" = _SNqXgL0x;
        "pkg-neoforge-2.0.37+mc26.1.2" = _kzzGnetM;
        "pkg-neoforge-2.0.37+mc26.2" = _XH99sLAO;
        "pkg-forge-2.0.37+mc1.20.1" = _FMlB4OQ1;
        "pkg-fabric-2.0.38+mc1.21.1" = _hS8jcU1j;
        "pkg-fabric-2.0.38+mc1.21.3" = _zZCTMDU2;
        "pkg-fabric-2.0.38+mc1.20.1" = _AM4fTiJY;
        "pkg-fabric-2.0.38+mc1.21.4" = _wTfCgmTQ;
        "pkg-fabric-2.0.38+mc1.21.5" = _jwinfwE6;
        "pkg-fabric-2.0.38+mc1.21.8" = _fQGH5apE;
        "pkg-fabric-2.0.38+mc1.21.10" = _3ACyDKF1;
        "pkg-fabric-2.0.38+mc26.1.2" = _nvHmwWPq;
        "pkg-fabric-2.0.38+mc1.21.11" = _FjtEbo6N;
        "pkg-neoforge-2.0.38+mc1.21.1" = _RFSWQtGK;
        "pkg-fabric-2.0.38+mc26.2" = _tIopeTJr;
        "pkg-neoforge-2.0.38+mc1.21.3" = _5EFjDvja;
        "pkg-neoforge-2.0.38+mc1.21.4" = _qr7dlOi8;
        "pkg-neoforge-2.0.38+mc1.21.5" = _uf2FWjIz;
        "pkg-neoforge-2.0.38+mc1.21.8" = _6crU3Qvi;
        "pkg-neoforge-2.0.38+mc1.21.10" = _XCW02pXy;
        "pkg-neoforge-2.0.38+mc1.21.11" = _GCCr7Ily;
