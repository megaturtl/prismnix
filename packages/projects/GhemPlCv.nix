...
let
    versions = (let
        ...
        _ugJAk5J7 = {
            "id" = "ugJAk5J7";
            "file" = "blastingsand-fabric-1.18.2-13.jar";
            "hash" = "sha512-72f5sLKV37C+CJfXJjTror66C978GC5rhFGKck4++BNalKQmsaGCujLlqsjfAvg7GFTdjFutcjznEXWxUD5/Ww==";
        };
        _gofvWx2s = {
            "id" = "gofvWx2s";
            "file" = "blastingsand-fabric-1.19.2-13.jar";
            "hash" = "sha512-3+5a4vz1SVMJo+CBtGrgoVObLTMB9AZSS4E7M7JQLx+7O5p0ZSJLFSpQJRfs2bxsEizgWL1aWizE/euW+DxyqA==";
        };
        _2ow3HWpK = {
            "id" = "2ow3HWpK";
            "file" = "blastingsand-fabric-1.20.1-13.jar";
            "hash" = "sha512-31LtyKYotlE75FAS1mc4hmdMNEcs83i2p9p3JrFOMALwuOqqeJlGcHHZmmVgsyEjoJnEQvF2Us+O6DuRjNuvxg==";
        };
        _oXMTpKFZ = {
            "id" = "oXMTpKFZ";
            "file" = "blastingsand-fabric-1.21.1-13.jar";
            "hash" = "sha512-jcWhaM73KsdQNHqbeS/VC2aBvAlMXR/KkjTH1rivitE+iqR+o8MJcD8b0Ynu6v9aXBrxiRpIpTx6rv+POwNixA==";
        };
        _b2dRIYjB = {
            "id" = "b2dRIYjB";
            "file" = "blastingsand-fabric-26.1.2-13.jar";
            "hash" = "sha512-D6noFrmtc0Dh0cBSsE98Bp9zvX5p/yxxA7EGRSvWO/mxaChx3fAcakbxI/YVXiROat8s9cmvXT+eEOJg2fEPaw==";
        };
        _y6Fqlr6R = {
            "id" = "y6Fqlr6R";
            "file" = "blastingsand-fabric-26.2-13.jar";
            "hash" = "sha512-k7VaUGvIUPjNJ0avU2bz0X1Uh9e2X+nP70fC06iCPsMngV+32ZF9M2YgImxCeSSO24hiOGt6uZCradRqApGXQA==";
        };
        _qKb0vO6V = {
            "id" = "qKb0vO6V";
            "file" = "blastingsand-forge-1.18.2-13.jar";
            "hash" = "sha512-t1/X7un8YHqgstdqUzAYmyso2BAogJx1EB4T5I5N0RnJNv43X6FEJYlip8P8lm6iU+lNxXDKsb/9zeGVdTGheg==";
        };
        _rfEvnbKZ = {
            "id" = "rfEvnbKZ";
            "file" = "blastingsand-forge-1.19.2-13.jar";
            "hash" = "sha512-hYWhF1v6GFGou/peg7jCjzUlhbgzkn/qYgvQf8dQ+AkzXI0itLWGTvrHaWxtpcVINBIExr9oC1y/Uf4Z+WYE4A==";
        };
        _2QeYmpOf = {
            "id" = "2QeYmpOf";
            "file" = "blastingsand-forge-1.20.1-13.jar";
            "hash" = "sha512-P+wOShTW2alpAOoSbbUONKIUOp/zKmiOzDj9MPRiCwtaJyzWP5arNNF6C5bsXuxyvp9694VtH3iw7xABZBEFvw==";
        };
        _aBI7rjxq = {
            "id" = "aBI7rjxq";
            "file" = "blastingsand-forge-1.21.1-13.jar";
            "hash" = "sha512-gCB/E84x50Mp9gLKYf8HoTJw6MhZSMs0w3MbpMLBXjkeJRRQ+NEcGzet7NhxBqMzY0Lc5aMgpLxkorjSSHZYXg==";
        };
        _N8vlLUnN = {
            "id" = "N8vlLUnN";
            "file" = "blastingsand-forge-26.1.2-13.jar";
            "hash" = "sha512-Kmmt140IfFJfSYkuQ4Gueb/aSbOLOFkxUOs4toN/gTPIHRN2BQh/vJQOKuICRPLAkTrTALiSopNG9xl/xjM+1A==";
        };
        _GcDQRHe0 = {
            "id" = "GcDQRHe0";
            "file" = "blastingsand-forge-26.2-13.jar";
            "hash" = "sha512-pYL9VJYDJOWN8D3VtStKU+Ahf585z1cxo0sM146qgKAd6W0Sxp+2hOPsXmtDFR5ugXzuxGzSt/UX6x+24rX5Ow==";
        };
        _UB5KATTI = {
            "id" = "UB5KATTI";
            "file" = "blastingsand-neoforge-1.21.1-13.jar";
            "hash" = "sha512-3EIQJqhKgi9wn/4wrlkcehi7r9k5dMsy3SaeGtuyvlZcXnmAunZ4wbBlMefyoQXrhtWL7Z0WGJWI0Balk7hyUQ==";
        };
        _StA7R4Xn = {
            "id" = "StA7R4Xn";
            "file" = "blastingsand-neoforge-26.1.2-13.jar";
            "hash" = "sha512-QAjYDNcwFbM0+V/bkhXY2Zm+DiVDCbsj0zLTSumV+Drif5UiTTh0Wb+c8XpJGzWdgK9TCRsgk3wz4R0QhRFf5A==";
        };
        _hbtRv0Gr = {
            "id" = "hbtRv0Gr";
            "file" = "blastingsand-neoforge-26.2-13.jar";
            "hash" = "sha512-TyfawR1PZ8+7i+mp5FhVUokAMj3E7vnYPK3TLDaWVuvjtl96Wjr6JacYN4JvrZbW2UHwzEkDkGhs1qw/kDhFNw==";
        };
    in {
        "fSNoV09T" = _fSNoV09T;
        "C7aQf1A5" = _C7aQf1A5;
        ...
        "fabric-26.1" = _b2dRIYjB;
        "fabric-26.1.1" = _b2dRIYjB;
        "fabric-26.1.2" = _b2dRIYjB;
        "fabric-1.21.11" = _QAouCnnJ;
        "fabric-26.2" = _y6Fqlr6R;
        "quilt-1.19.2" = _gofvWx2s;
        "quilt-1.19.1" = _gofvWx2s;
        "quilt-1.19" = _gofvWx2s;
        "quilt-1.18.2" = _ugJAk5J7;
        "quilt-1.18.1" = _ugJAk5J7;
        "quilt-1.16.5" = _KXqEn1to;
        "quilt-1.19.3" = _6pe6lsAi;
        "quilt-1.19.4" = _uUvWLPNA;
        "quilt-1.20" = _2ow3HWpK;
        "quilt-1.20.1" = _2ow3HWpK;
        "quilt-1.20.2" = _r9Oa2gR7;
        "quilt-1.20.3" = _oB4TdBwW;
        "quilt-1.20.4" = _oB4TdBwW;
        "quilt-1.20.5" = _HX45PBID;
        "quilt-1.20.6" = _HX45PBID;
        "quilt-1.21" = _oXMTpKFZ;
        "quilt-1.21.1" = _oXMTpKFZ;
        "quilt-1.21.2" = _d28HIeM0;
        "quilt-1.21.3" = _d28HIeM0;
        "quilt-1.21.4" = _sTBcLfKj;
        "quilt-1.18" = _ugJAk5J7;
        ...
        "quilt-26.1" = _b2dRIYjB;
        "quilt-26.1.1" = _b2dRIYjB;
        "quilt-26.1.2" = _b2dRIYjB;
        "quilt-1.21.11" = _QAouCnnJ;
        "quilt-26.2" = _y6Fqlr6R;
        "forge-1.16.5" = _u7vVk2iB;
        "forge-1.17.1" = _XcJE4XQP;
        "forge-1.18" = _qKb0vO6V;
        "forge-1.18.1" = _qKb0vO6V;
        "forge-1.18.2" = _qKb0vO6V;
        "forge-1.19" = _rfEvnbKZ;
        "forge-1.19.1" = _rfEvnbKZ;
        "forge-1.19.2" = _rfEvnbKZ;
        "forge-1.19.3" = _zODlkoqJ;
        "forge-1.19.4" = _dU5p3lmK;
        "forge-1.20" = _2QeYmpOf;
        "forge-1.20.1" = _2QeYmpOf;
        "forge-1.20.2" = _M1wJx7eA;
        "forge-1.20.3" = _lHeZUd3f;
        "forge-1.20.4" = _lHeZUd3f;
        "forge-1.20.6" = _QH38T2UK;
        "forge-1.21" = _aBI7rjxq;
        "forge-1.21.1" = _aBI7rjxq;
        ...
        "forge-26.1" = _N8vlLUnN;
        "forge-26.1.1" = _N8vlLUnN;
        "forge-26.1.2" = _N8vlLUnN;
        "forge-1.21.11" = _2nZhPraE;
        "forge-26.2" = _GcDQRHe0;
        "neoforge-1.20.4" = _O0VNjkPe;
        "neoforge-1.20.6" = _Rf6ogzVt;
        "neoforge-1.21" = _UB5KATTI;
        "neoforge-1.21.1" = _UB5KATTI;
        "neoforge-1.21.2" = _dkW12yH9;
        "neoforge-1.21.3" = _dkW12yH9;
        "neoforge-1.21.4" = _BrSh97E5;
        "neoforge-1.20" = _2QeYmpOf;
        "neoforge-1.20.1" = _2QeYmpOf;
        ...
        "neoforge-26.1" = _StA7R4Xn;
        "neoforge-26.1.1" = _StA7R4Xn;
        "neoforge-26.1.2" = _StA7R4Xn;
        "neoforge-1.21.11" = _XYoGZrG3;
        "neoforge-26.2" = _hbtRv0Gr;
        "pkg-1.19.2-11" = _fSNoV09T;
        "pkg-1.19.1-10" = _C7aQf1A5;
        "pkg-1.19-9" = _XoQ8wmRl;
        "pkg-1.18.2-8" = _j6DX21Go;
        "pkg-1.18.1-7" = _QgOsxbZx;
        "pkg-1.16.5-5" = _KXqEn1to;
        "pkg-1.19.3-11" = _6pe6lsAi;
        "pkg-1.16.5-11-forge" = _u7vVk2iB;
        "pkg-1.17.1-11-forge" = _XcJE4XQP;
        "pkg-1.18-11-forge" = _TmCEwGOL;
        "pkg-1.18.1-11-forge" = _bbJPZihr;
        "pkg-1.18.2-11-forge" = _CfeGbqIH;
        "pkg-1.19-11-forge" = _5q5luW94;
        "pkg-1.19.1-11-forge" = _bFOxHuSG;
        "pkg-1.19.2-11-forge" = _6sqRjFDP;
        "pkg-1.19.3-11-forge" = _zODlkoqJ;
        "pkg-1.19.4-11" = _V3QjxxCE;
        "pkg-1.19.4-11-forge" = _liweMCjK;
        "pkg-1.20-11" = _I0xfiHwf;
        "pkg-1.20-11-forge" = _yEGFIae4;
        "pkg-1.20.1-11-fabric" = _BQIXGzyZ;
        "pkg-1.20.1-11-forge" = _TkhPgm7n;
        "pkg-1.20.2-11-fabric" = _EyvrkvDm;
        "pkg-1.20.2-11-forge" = _Vd4Zg4wS;
        "pkg-1.20.3-11-fabric" = _NEuYo6vU;
        "pkg-1.20.3-0-forge" = _AbDhWf7x;
        "pkg-1.20.4-11-forge" = _w35AtZVo;
        "pkg-1.20.4-11-fabric" = _OedxxxTw;
        "pkg-1.20.4-0-neoforge" = _O0VNjkPe;
        "pkg-1.20.5-11-fabric" = _mrv5EdVX;
        "pkg-1.20.6-11-fabric" = _rkkBoCOB;
        "pkg-1.20.6-0-neoforge" = _1WHsuucZ;
        "pkg-1.20.6-11-forge" = _JDtLPIuP;
        "pkg-1.21-11-fabric" = _WVw4MpMj;
        "pkg-1.21-11-forge" = _eC3PFIHc;
        "pkg-1.21-0-neoforge" = _DhCIxpnv;
        "pkg-1.21.1-0-neoforge" = _Xoq3vxAB;
        "pkg-1.21.1-11-fabric" = _dNm0jBLf;
        "pkg-1.21.1-11-forge" = _PTn7rYOv;
        "pkg-1.21.2-11-fabric" = _yXTK3sY1;
        "pkg-1.21.3-11-forge" = _uI24YWql;
        "pkg-1.21.3-0-neoforge" = _2tRjJxV2;
        "pkg-1.21.4-11-fabric" = _pMnXw459;
        "pkg-1.21.4-0-neoforge" = _VN84iocc;
        "pkg-1.21.4-11-forge" = _Krj12fBf;
        "pkg-fabric-1.18.2-12.jar" = _v69d7w2k;
        "pkg-fabric-1.19.2-12.jar" = _FPLe3ZTi;
        "pkg-fabric-1.19.4-12.jar" = _APMw1OIK;
        "pkg-fabric-1.20.1-12.jar" = _I4OtNttc;
        "pkg-fabric-1.20.2-12.jar" = _VaPrPNu0;
        "pkg-fabric-1.20.4-12.jar" = _XAXUsIGw;
        "pkg-fabric-1.20.6-12.jar" = _JfQK4hdh;
        "pkg-fabric-1.21.1-12.jar" = _mgueHsXB;
        "pkg-fabric-1.21.3-12.jar" = _IJ5xZAp4;
        "pkg-fabric-1.21.4-12.jar" = _lKiKvZdD;
        "pkg-forge-1.18.2-12.jar" = _Bcu2bPyN;
        "pkg-forge-1.19.2-12.jar" = _hiMHm1Qf;
        "pkg-forge-1.19.4-12.jar" = _4VvAIY4L;
        "pkg-forge-1.20.1-12.jar" = _wNqY2pyV;
        "pkg-forge-1.20.2-12.jar" = _e1IjvB0V;
        "pkg-forge-1.20.4-12.jar" = _F3z2CI8a;
        "pkg-forge-1.20.6-12.jar" = _FY5xPktI;
        "pkg-forge-1.21.1-12.jar" = _l5WOZKtz;
        "pkg-forge-1.21.3-12.jar" = _QZvLp9Zn;
        "pkg-forge-1.21.4-12.jar" = _i5YhAJqI;
        "pkg-neoforge-1.20.6-12.jar" = _JqVrxX1R;
        "pkg-neoforge-1.21.1-12.jar" = _NRLk8K8I;
        "pkg-neoforge-1.21.3-12.jar" = _SXXF5jvK;
        "pkg-neoforge-1.21.4-12.jar" = _8vMITGEv;
        "pkg-fabric-1.18.2-12.1" = _ArCt2HNi;
        "pkg-fabric-1.18.2-12.2" = _HKeqTaZN;
        "pkg-fabric-1.18.2-12.3" = _f4oPMY6E;
        "pkg-fabric-1.19.2-12.3" = _4r5Z93FC;
        "pkg-fabric-1.19.4-12.3" = _uUvWLPNA;
        "pkg-fabric-1.20.1-12.3" = _6qZAEqrP;
        "pkg-fabric-1.20.2-12.3" = _r9Oa2gR7;
        "pkg-fabric-1.20.4-12.3" = _oB4TdBwW;
        "pkg-fabric-1.20.6-12.3" = _HX45PBID;
        "pkg-fabric-1.21.1-12.3" = _C5Ko11Do;
        "pkg-fabric-1.21.3-12.3" = _d28HIeM0;
        "pkg-fabric-1.21.4-12.3" = _sTBcLfKj;
        "pkg-forge-1.18.2-12.3" = _RZD5OBnZ;
        "pkg-forge-1.19.2-12.3" = _VUhiNxu9;
        "pkg-forge-1.19.4-12.3" = _dU5p3lmK;
        "pkg-forge-1.20.1-12.3" = _iJgKJHtE;
        "pkg-forge-1.20.2-12.3" = _M1wJx7eA;
        "pkg-forge-1.20.4-12.3" = _lHeZUd3f;
        "pkg-forge-1.20.6-12.3" = _QH38T2UK;
        "pkg-forge-1.21.1-12.3" = _t9jf9En7;
        "pkg-forge-1.21.3-12.3" = _D9JSVEAC;
        "pkg-forge-1.21.4-12.3" = _oR5HU7xn;
        "pkg-neoforge-1.20.6-12.3" = _Rf6ogzVt;
        "pkg-neoforge-1.21.1-12.3" = _RGLCvlDG;
        "pkg-neoforge-1.21.3-12.3" = _dkW12yH9;
        "pkg-neoforge-1.21.4-12.3" = _BrSh97E5;
        "pkg-fabric-1.21.5-12.3" = _TxVqucWg;
        "pkg-forge-1.21.5-12.3" = _P7hpHO0Y;
        "pkg-neoforge-1.21.5-12.3" = _xlxrNPWE;
        "pkg-fabric-1.21.6-12.3" = _YvXzYzQl;
        "pkg-forge-1.21.6-12.3" = _nK2bSO1D;
        "pkg-neoforge-1.21.6-12.3" = _5QkGwR45;
        "pkg-forge-1.21.7-12.3" = _ODjnIk7o;
        "pkg-neoforge-1.21.7-12.3" = _fOW7n19w;
        "pkg-fabric-1.21.7-12.4" = _OHQvK81m;
        "pkg-forge-1.21.7-12.4" = _W5bNxDPX;
        "pkg-neoforge-1.21.7-12.4" = _nl15Dbxm;
        "pkg-fabric-1.21.8-12.4" = _UmKmWa6U;
        "pkg-forge-1.21.8-12.4" = _GUdAlnCy;
        "pkg-neoforge-1.21.8-12.4" = _phAvLvwV;
        "pkg-fabric-1.21.9-12.4" = _xiUu3QCi;
        "pkg-forge-1.21.9-12.4" = _GLhCqOkU;
        "pkg-neoforge-1.21.9-12.4" = _JFGvDHVS;
        "pkg-fabric-1.21.10-12.4" = _GxPOIvEM;
        "pkg-forge-1.21.10-12.4" = _haoCLKGg;
        "pkg-neoforge-1.21.10-12.4" = _xKdecInl;
        "pkg-fabric-26.1.1-12.4" = _ZREWoGcu;
        "pkg-forge-26.1.1-12.4" = _xafjIADY;
        "pkg-neoforge-26.1.1-12.4" = _LK5cMhSW;
        "pkg-fabric-26.1.2-12.4" = _ryhX8wqB;
        "pkg-forge-26.1.2-12.4" = _e4nDu3cI;
        "pkg-neoforge-26.1.2-12.4" = _hOt6clP5;
        "pkg-fabric-1.21.11-12.4" = _QAouCnnJ;
        "pkg-forge-1.21.11-12.4" = _2nZhPraE;
        "pkg-neoforge-1.21.11-12.4" = _XYoGZrG3;
        "pkg-fabric-1.18.2-13" = _ugJAk5J7;
        "pkg-fabric-1.19.2-13" = _gofvWx2s;
        "pkg-fabric-1.20.1-13" = _2ow3HWpK;
        "pkg-fabric-1.21.1-13" = _oXMTpKFZ;
        "pkg-fabric-26.1.2-13" = _b2dRIYjB;
        "pkg-fabric-26.2-13" = _y6Fqlr6R;
        "pkg-forge-1.18.2-13" = _qKb0vO6V;
        "pkg-forge-1.19.2-13" = _rfEvnbKZ;
        "pkg-forge-1.20.1-13" = _2QeYmpOf;
        "pkg-forge-1.21.1-13" = _aBI7rjxq;
        "pkg-forge-26.1.2-13" = _N8vlLUnN;
        "pkg-forge-26.2-13" = _GcDQRHe0;
        "pkg-neoforge-1.21.1-13" = _UB5KATTI;
        "pkg-neoforge-26.1.2-13" = _StA7R4Xn;
        "pkg-neoforge-26.2-13" = _hbtRv0Gr;
        "default" = _hbtRv0Gr;
    });
