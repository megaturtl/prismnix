...
let
    versions = (let
        ...
        _xmwfj8le = {
            "id" = "xmwfj8le";
            "file" = "ColdSweat-2.4.3.jar";
            "hash" = "sha512-wEJEKFyvjhNQk9MGeFuw1eDMgFfynwa+/uW4S6CJ2h97Dic4kps7HioNjrLA+IJqHMEYVQywXiriXP0ZHM/syw==";
        };
        _RVaTeFux = {
            "id" = "RVaTeFux";
            "file" = "ColdSweat-2.4.3.jar";
            "hash" = "sha512-592YrlU0oKgI7DK9F3Ex5lSRrFN/Jb6SVdX6jOtqJzLwgPQnkBR2+CuqlcWezJ37e5YQPzvoI1/1mg3GWP88tg==";
        };
        _YeDAa4JT = {
            "id" = "YeDAa4JT";
            "file" = "ColdSweat-2.4.3.jar";
            "hash" = "sha512-/4wpQ6BTxBapd+7XI19eAqQ8N7VSpP2Q/1ko1N00/yrQnuyFY5eyCZAnKakttBoKEuDErKmG2Yj+gRryyRsNzQ==";
        };
        _YNEOXChH = {
            "id" = "YNEOXChH";
            "file" = "ColdSweat-2.4.3.jar";
            "hash" = "sha512-3J+4s5jsr0zDab7cTOqZ/u5o+vrB3ax3OeAT3nZAQVTl8SCjqTnAQph7LKysg/WUG0hEIMgtFfVgMdwphYnmkw==";
        };
        _tTFQxyBz = {
            "id" = "tTFQxyBz";
            "file" = "ColdSweat-2.4.3.jar";
            "hash" = "sha512-g1iHlxAhma8S7qYEEKmkXavZm+T7citl7MaeKSVRCfaZVte3Rg6q6/ZjQ+d4KoZjaDUgi3nxQSSinBYVHsMJ2Q==";
        };
        _r2cD4Llq = {
            "id" = "r2cD4Llq";
            "file" = "ColdSweat-2.4.3.1.jar";
            "hash" = "sha512-W4LIQZPRQz9Gv3fJIgfY8YrHmrKdogCrGdebidi9mNPNmPhRLzi4ebHdwGw+A7wZcnDWb0xki/Q+QwgHlRVP8w==";
        };
        _ngCUm7il = {
            "id" = "ngCUm7il";
            "file" = "ColdSweat-2.4.3.1.jar";
    ...
    in {
        ...
        "pkg-2.3.8" = _g4bHC9N4;
        "pkg-2.3.9" = _ktZWQ5h9;
        "pkg-2.3.10e" = _KMk1wH3Z;
        "pkg-2.3.10" = _AsBIyezV;
        "pkg-2.3.11" = _msoI4wto;
        "pkg-2.3.12" = _t0LlWTAP;
        "pkg-2.3.12a" = _sBoEkrD4;
        "pkg-2.4-b01a" = _Msp73o3K;
        "pkg-2.4-b02a" = _qNJonbnO;
        "pkg-2.4-b02b" = _kMW1SC2n;
        "pkg-2.4-b02c" = _CuMtijUj;
        "pkg-2.4-b02d" = _kwqXxZJd;
        "pkg-2.3.13" = _vxXQPl0G;
        "pkg-2.4-b03a" = _BI1fyncw;
        "pkg-2.4-b03b" = _fPTXPVWB;
        "pkg-2.4-b03c" = _UjsbvVeE;
        "pkg-2.4-b03d" = _qLW9DBr7;
        "pkg-2.4-b04a" = _SfaWQXyj;
        "pkg-2.4-b04b" = _eZy6deYD;
        "pkg-2.4-b04d" = _VKMjmPBU;
        "pkg-2.4-b05a" = _8vrOSrdK;
        "pkg-2.4-b05b" = _mOtVP7Up;
        "pkg-2.4-b05c" = _VrJFVKm6;
        "pkg-2.4-b05d" = _xSiEPg9r;
        "pkg-2.4-b05e" = _sXzW52sS;
        "pkg-2.4-b06a" = _61KmHTvR;
        "pkg-2.4-b06b" = _OCW3ivHr;
        "pkg-2.4-b06c" = _2rTmdT1h;
        "pkg-2.4-b06d" = _e1tJvS1d;
        "pkg-2.4-b06e" = _Sq7hWQZE;
        "pkg-2.4-b06f" = _CwZ2alY6;
        "pkg-2.4-b06g" = _mwrLcRKl;
        "pkg-2.4" = _Hx2FM8dR;
        "pkg-2.4.1" = _UHW6gtom;
        "pkg-2.4.2" = _QcRCkOrF;
        "pkg-2.4.3" = _tTFQxyBz;
