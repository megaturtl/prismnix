...
let
    ...
    in {
        ...
        "pkg-1.0.5" = _ZmLSry2o;
        "pkg-1.0.6" = _XzGs4vE4;
        "pkg-1.0.7-1.15.2" = _AqIKFRPb;
        "pkg-1.0.7-1.16.5" = _ujzfiX1N;
        "pkg-1.0.7-1.17.1" = _ce9ACQ6A;
        "pkg-1.0.7-1.18.2" = _ysAVqBEk;
        "pkg-1.0.7-1.19.3" = _UyCVTPpp;
        "pkg-1.0.7" = _ZMbV7iJx;
        "pkg-1.0.8-1.15.x" = _6OPG3AV9;
        "pkg-1.0.8-1.16.x" = _RRw3dwRY;
        "pkg-1.0.8-1.17.x" = _20MjzfDT;
        "pkg-1.0.8-1.18.x" = _F5jTIyvu;
        "pkg-1.0.8-1.19.x" = _lMOrjT68;
        "pkg-1.0.9-1.15.x" = _SxbVTgCQ;
        "pkg-1.0.9-1.16.x" = _c3qAXNpi;
        "pkg-1.0.9-1.17.x" = _AnLM61ML;
        "pkg-1.0.9-1.18.x" = _9v7LQvXO;
        "pkg-1.0.9-1.19.x" = _kN3zkQD6;
        "pkg-1.0.9-1.20.x" = _i3HXV5Bt;
        "pkg-1.1.0" = _QYg6igKu;
        "pkg-1.1.1" = _oLepBk3r;
        "pkg-1.1.2" = _dDOH3KWN;
        "pkg-1.1.3" = _AqnK2Diz;
