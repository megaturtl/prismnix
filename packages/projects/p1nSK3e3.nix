...
let
    versions = (let
        ...
        _ttvpyAPg = {
            "id" = "ttvpyAPg";
            "file" = "koreanify-fabric-0.1.10+mc26.1.2.jar";
            "hash" = "sha512-JbucOTYpmcgWE/o+cdZaCC8oNpM4hrZcNt4XwmBVCrQAZk+GgIibE3pFx84rAHi/5nG8KJQ08VRwMcC9xbP0iw==";
        };
        _OSjkHZcM = {
            "id" = "OSjkHZcM";
            "file" = "koreanify-neoforge-0.1.10+mc26.1.2.jar";
            "hash" = "sha512-VLyv0FQqQ4x/SfZbmaH2V3keA8aXormSGc/lmTlER/xixwwuhFTkjm1UM4AYpKszo1mHoAW0AOPHhgFcvN+IsQ==";
        };
        _MANeXC8J = {
            "id" = "MANeXC8J";
            "file" = "koreanify-fabric-0.1.11+mc26.1.2.jar";
            "hash" = "sha512-Z3nppObMGl/pMu5vNl+5reUMzVJ5D7ARNJslvEOcdQMOgO3Op2NJXg7i9gLp+gDd8hgvbZJVqBuxxgDSEuLuUg==";
        };
        _1CkHwD9o = {
            "id" = "1CkHwD9o";
            "file" = "koreanify-neoforge-0.1.11+mc26.1.2.jar";
            "hash" = "sha512-T7x2On/Dy0x/gbJcpHrQaqrz+iLie/2W1ma7T4/kY9HRH0JcFavOqZjnBv4mv5tbC5zXMNIFWtMzNCIjAJFGXQ==";
        };
        _LxqbWek1 = {
            "id" = "LxqbWek1";
            "file" = "koreanify-fabric-0.1.12+mc26.1.2.jar";
            "hash" = "sha512-YEOTqO1y55n8EBV1X1VdDP5RIn0+jEzXSN7+gmFhkZnbH+KFKadNsPRvq2NkF8ULVmLW1ujGKMpcXZIyntGy2Q==";
        };
        _EVm1h2QE = {
            "id" = "EVm1h2QE";
            "file" = "koreanify-neoforge-0.1.12+mc26.1.2.jar";
            "hash" = "sha512-/gF9aKBrIOQs5esKxnayCMs5PTXvwv0OT3qoNgok+SOTm1ps8ktTKzekR+IYnB81UIe4DYw5Xtw9eMgG+OM3jQ==";
        };
        _5i1HhMdF = {
            "id" = "5i1HhMdF";
            "file" = "koreanify-fabric-0.2.0+mc26.3.jar";
            "hash" = "sha512-xrKXNwVs3CcauMb1nDeRHFV6/EknwEZR2pcyIvAsUKfszUL970+NoGEPtCmV9T4HIgFGRqFYgMAWQc2i+AjkmA==";
        };
        _Iyh8YX2l = {
            "id" = "Iyh8YX2l";
            "file" = "koreanify-neoforge-0.2.0+mc26.3.jar";
            "hash" = "sha512-O9pUq5lkde+oItfVXRgbRl1sPyRiNNdsOC7WxVNGhW7wg2jD1EasHDH/PccKV7a/J7vOVDVbps0jSx1EYuimUQ==";
        };
    in {
        "TRzjMaO1" = _TRzjMaO1;
        "8THmvqdc" = _8THmvqdc;
        ...
        "fabric-26.1" = _LxqbWek1;
        "fabric-26.1.1" = _LxqbWek1;
        "fabric-26.1.2" = _LxqbWek1;
        "fabric-26.2" = _LxqbWek1;
        "fabric-26.3" = _5i1HhMdF;
        ...
        "neoforge-26.1" = _EVm1h2QE;
        "neoforge-26.1.1" = _EVm1h2QE;
        "neoforge-26.1.2" = _EVm1h2QE;
        "neoforge-26.2" = _EVm1h2QE;
        "neoforge-26.3" = _Iyh8YX2l;
        "quilt-26.1" = _LxqbWek1;
        "quilt-26.1.1" = _LxqbWek1;
        "quilt-26.1.2" = _LxqbWek1;
        "quilt-26.2" = _LxqbWek1;
        "quilt-26.3" = _5i1HhMdF;
        "pkg-mc26.1-0.1.0-alpha.1" = _TRzjMaO1;
        "pkg-mc26.1-0.1.0-alpha.2" = _8THmvqdc;
        "pkg-mc26.1-0.1.0-alpha.3" = _NjayHqfC;
        "pkg-mc26.1-0.1.0-alpha.4-fabric" = _Bj4zOkh5;
        "pkg-mc26.1-0.1.0-alpha.4-neoforge" = _syseA96F;
        "pkg-mc26.1-0.1.0-alpha.5-fabric" = _IHLUFlcO;
        "pkg-mc26.1-0.1.0-alpha.6-fabric" = _ZKr9ETYt;
        "pkg-mc26.1-0.1.0-alpha.7-fabric" = _1VtdJeir;
        "pkg-mc26.1-0.1.0-alpha.8-fabric" = _Gp0pYfKO;
        "pkg-mc26.1-0.1.0-beta.1-fabric" = _p7OV7HBl;
        "pkg-mc26.1-0.1.0-beta.1-neoforge" = _XdcPD5H7;
        "pkg-mc26.1-0.1.0-fabric" = _P8jbvYrp;
        "pkg-mc26.1-0.1.0-neoforge" = _rUJb1YqO;
        "pkg-mc26.1-0.1.1-fabric" = _oNOhEit9;
        "pkg-mc26.1-0.1.1-neoforge" = _BadW5iQc;
        "pkg-mc26.1-0.1.2-neoforge" = _KiRlgP49;
        "pkg-mc26.1-0.1.2-fabric" = _IpcJgkip;
        "pkg-mc26.1-0.1.3-fabric" = _csGKoOTa;
        "pkg-mc26.1-0.1.3-neoforge" = _FS0BIbAc;
        "pkg-mc26.1.2-0.1.4-fabric" = _vC9aU7sF;
        "pkg-mc26.1.2-0.1.4-neoforge" = _P2BReBFf;
        "pkg-mc26.1.2-0.1.5-fabric" = _fdoGoTSu;
        "pkg-mc26.1.2-0.1.5-neoforge" = _whknqlsT;
        "pkg-mc26.1.2-0.1.6-fabric" = _WF8YJz45;
        "pkg-mc26.1.2-0.1.6-neoforge" = _Y65r9Ez2;
        "pkg-mc26.1.2-0.1.7-fabric" = _Cc4U7bld;
        "pkg-mc26.1.2-0.1.7-neoforge" = _AyqoDfJV;
        "pkg-mc26.1.2-0.1.8-fabric" = _2CId7SuL;
        "pkg-mc26.1.2-0.1.8-neoforge" = _qc8Rgvny;
        "pkg-mc26.1.2-0.1.9-fabric" = _1Amud8EZ;
        "pkg-mc26.1.2-0.1.9-neoforge" = _JP2fZWtH;
        "pkg-mc26.1.2-0.1.10-fabric" = _ttvpyAPg;
        "pkg-mc26.1.2-0.1.10-neoforge" = _OSjkHZcM;
        "pkg-mc26.1.2-0.1.11-fabric" = _MANeXC8J;
        "pkg-mc26.1.2-0.1.11-neoforge" = _1CkHwD9o;
        "pkg-mc26.1.2-0.1.12-fabric" = _LxqbWek1;
        "pkg-mc26.1.2-0.1.12-neoforge" = _EVm1h2QE;
        "pkg-mc26.3-0.2.0-fabric" = _5i1HhMdF;
        "pkg-mc26.3-0.2.0-neoforge" = _Iyh8YX2l;
        "default" = _Iyh8YX2l;
    });
