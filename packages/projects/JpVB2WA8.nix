...
let
    ...
    in {
        ...
        "pkg-1.19.3-2.0-forge" = _e6iFZNgj;
        "pkg-1.18.2-3.0-forge+fabric" = _4roj8k6Y;
        "pkg-1.19.2-3.0-forge+fabric" = _3ZkYl7rm;
        "pkg-1.19.3-3.0-forge+fabric" = _9DhgsnWV;
        "pkg-1.18.2-3.1-forge+fabric" = _zcYodOEU;
        "pkg-1.19.2-3.1-forge+fabric" = _o560q1Ai;
        "pkg-1.19.3-3.1-forge+fabric" = _LuimUKfV;
        "pkg-1.18.2-3.2-forge+fabric" = _MZ4n7HYR;
        "pkg-1.19.2-3.2-forge+fabric" = _SDGvtZ7n;
        "pkg-1.19.3-3.2-forge+fabric" = _OeSJcznR;
        "pkg-1.19.4-3.2-forge+fabric" = _hiSwLAuZ;
        "pkg-1.20-3.2-forge+fabric" = _sFwojM1a;
        "pkg-1.20.1-3.2-forge+fabric" = _qjB8U92q;
        "pkg-1.20.2-3.2-forge+fabric" = _CAOmXMyB;
        "pkg-1.18.2-3.3-forge+fabric" = _pXxFOt7P;
        "pkg-1.19.2-3.3-forge+fabric" = _zZvgiiHJ;
        "pkg-1.20.1-3.3-forge+fabric" = _vYzCOpwx;
        "pkg-1.20.2-3.3-forge+fabric" = _Kj5FKo0P;
        "pkg-1.20.3-3.3-fabric+forge+neo" = _g7PnUuMK;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _vEayCKy1;
        "pkg-1.19.2-3.4-fabric+forge+neo" = _p2I9cmqL;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _kbxGToGX;
        "pkg-1.20.2-3.4-fabric+forge+neo" = _5lSvMIcx;
        "pkg-1.20.4-3.4-fabric+forge+neo" = _DCQYfQNf;
        "pkg-1.20.5-3.4-fabric+neo" = _G49TnYgf;
        "pkg-1.20.5-3.5-fabric+neo" = _ItFpYobS;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _8lAfLzju;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _tMZ8SMmT;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _5yVJ5umR;
        "pkg-1.20.6-3.6-fabric+forge+neo" = _6KkR0Eeu;
        "pkg-1.21.0-3.6-fabric+forge+neo" = _ZVvvNGBK;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _9YqfkULm;
        "pkg-1.21.2-3.6-fabric+neo" = _dEU7NaI4;
        "pkg-1.21.3-3.6-fabric+forge+neo" = _mN4shh0H;
        "pkg-1.21.4-3.6-fabric+forge+neo" = _d4CuZx60;
        "pkg-1.20.1-3.7-fabric+forge+neo" = _jZwaX4rS;
        "pkg-1.21.1-3.7-fabric+forge+neo" = _9dnD65RR;
        "pkg-1.21.4-3.7-fabric+forge+neo" = _td1uH8kC;
        "pkg-1.21.5-3.7-fabric+forge+neo" = _uI5IUwm8;
        "pkg-1.21.6-3.7-fabric+forge+neo" = _QQsPOq8x;
        "pkg-1.21.7-3.7-fabric+forge+neo" = _7Vmj7Ecs;
        "pkg-1.21.8-3.7-fabric+forge+neo" = _72sXV6qs;
        "pkg-1.21.9-3.7-fabric+forge+neo" = _xudKWKcQ;
        "pkg-1.21.9-3.8-fabric+forge+neo" = _PlQ7ehvm;
        "pkg-1.21.10-3.8-fabric+forge+neo" = _rbBl97ex;
        "pkg-1.21.11-3.8-fabric+forge+neo" = _Jmv30Vbf;
        "pkg-26.1.0-3.8-fabric+forge+neo" = _391BxqnT;
