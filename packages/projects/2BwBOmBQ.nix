...
let
    ...
    in {
        ...
        "pkg-1.19.2-Fabric-1.0" = _61MlZk1C;
        "pkg-1.19.4-Forge-1.1" = _2o3Fyh1D;
        "pkg-1.19.2-Forge-1.0" = _AX0UDNyo;
        "pkg-1.18.2-Fabric-1.0" = _mId4Tfc1;
        "pkg-1.18.2-Forge-1.0" = _rykIEAMG;
        "pkg-1.20-Forge-2.0.2" = _5u2gcMh9;
        "pkg-1.20-Fabric-2.0.2" = _3aGqQrO1;
        "pkg-1.20-Forge-2.0.3" = _25MjVFVn;
        "pkg-1.20-Fabric-2.0.3" = _7JaIbxzK;
        "pkg-1.20-Forge-2.0.4" = _J2sdehqA;
        "pkg-1.20-Fabric-2.0.4" = _AlE4iEnJ;
        "pkg-1.20-Forge-2.0.5" = _weh531it;
        "pkg-1.20-Fabric-2.0.5" = _KMWjIKnN;
        "pkg-1.20.4-Forge-2.4.0" = _x7KJ0qFZ;
        "pkg-1.20.4-Fabric-2.4.0" = _mRCm0pL5;
        "pkg-1.20.4-Forge-2.4.1" = _mjcajOXu;
        "pkg-1.20.4-Fabric-2.4.1" = _sPWRtsih;
        "pkg-1.20-Forge-2.0.6" = _Izqhg3Va;
        "pkg-1.20-Fabric-2.0.6" = _qJTsmyiE;
        "pkg-1.20.4-Forge-2.4.2" = _LjMYk6mH;
        "pkg-1.20.4-NeoForge-2.4.2" = _PWvhCArM;
        "pkg-1.20.4-Fabric-2.4.2" = _C69Ea0wV;
        "pkg-1.20.4-Forge-2.4.3" = _ZyoUJFuE;
        "pkg-1.20.4-NeoForge-2.4.3" = _MFm60Cd1;
        "pkg-1.20.4-Fabric-2.4.3" = _xAXIqv7e;
        "pkg-1.21.1-Fabric-3.1.0" = _CnwudsVN;
        "pkg-1.21.1-Forge-3.1.0" = _Sh0L6V6J;
        "pkg-1.21.1-NeoForge-3.1.0" = _HlXbROrl;
        "pkg-1.21.1-Forge-3.1.1" = _Lly4sHe1;
        "pkg-1.21.1-NeoForge-3.1.1" = _IEU6pSYq;
        "pkg-1.21.1-Fabric-3.1.1" = _HTRZl5K6;
        "pkg-1.21.1-Fabric-3.1.2" = _zpUYcjIg;
        "pkg-1.21.1-Forge-3.1.2" = _1KrElURK;
