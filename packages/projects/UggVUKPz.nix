...
let
    versions = (let
        ...
        _gEaFZWJN = {
            "id" = "gEaFZWJN";
            "file" = "SlashBlade-Refabricated-1.21.1-1.4.5-Resharped-1.9.65.jar";
            "hash" = "sha512-FojxE1z6Ty9nv9N4pd3u956Irswp0lI+CmpewID3e5qxNCcieQ4L/aiM+uauc8IC7ALVbTcPVwC00Rs9TCf4Kw==";
        };
        _4MfK9GWD = {
            "id" = "4MfK9GWD";
            "file" = "SlashBlade-Refabricated-26.1.2-1.0.1-Resharped-1.9.65.jar";
            "hash" = "sha512-knEuD6w9zvF69njLOxSBUDWUDv14RoBllv3AaCcgVO1uNR4Fh/LVx5WdT8SSTyIzz5Jh7IjoA3AH8+TSNWk0DQ==";
        };
        _XHGRjahS = {
            "id" = "XHGRjahS";
            "file" = "SlashBlade-Refabricated-26.1.2-1.0.2-Resharped-1.9.65.jar";
            "hash" = "sha512-E9AjsZxjoZZb+1yePYtxViOesHpxSEBH+/XjeuinMHP93tFGPx4XwrT9wr4ufR9grm4XvCTIVevK8Bb/t5FUfQ==";
        };
        _36gR3DXV = {
            "id" = "36gR3DXV";
            "file" = "SlashBlade-Refabricated-1.21.1-1.5.0-Resharped-2.0.5.jar";
            "hash" = "sha512-sqo1WTMV++XUxdkB/0B4KREZCO+NaI0FSgQgcNmO2CXgn2yfYVBIyvLL6aqb6C6pCl+PzQk1fc+uF2WMMjkceA==";
        };
        _Hi6Zslva = {
            "id" = "Hi6Zslva";
            "file" = "SlashBlade-Refabricated-26.1.2-1.5.0-Resharped-2.0.5.jar";
            "hash" = "sha512-W43jJAsDZLWxch56oD7wwceqnX3U91AEivKNIpDzXDflXEpZev0tHZtIx3RuinXAvNligHW1fiE2+pj6PRGIbA==";
        };
        _PO0ZyaGl = {
            "id" = "PO0ZyaGl";
            "file" = "SlashBlade-Refabricated-1.21.1-1.5.1-Resharped-2.0.5.jar";
            "hash" = "sha512-bKZ63OIpwfHDUyb3mge0b+LoIgnOcKTJ7ReK6UKc7RNPN7F3+zT5+yUBAYbTt6wLVQXWpd98padubwLmGSwLrg==";
        };
        _nmkteODm = {
            "id" = "nmkteODm";
            "file" = "SlashBlade-Refabricated-26.1.2-1.5.1-Resharped-2.0.5.jar";
            "hash" = "sha512-d+mC6rL8OHwiYNUIP/0zqCYBpP3GpyKCwDohmZ9RlzSPZRwVXU2xJIMf6QQA6ZhRR1hnULSBx1Sm7bh1N5ioIg==";
        };
    in {
        "67fqVGOb" = _67fqVGOb;
        "57oGh4Is" = _57oGh4Is;
        ...
        "fabric-1.21.1" = _PO0ZyaGl;
        "fabric-26.1.2" = _nmkteODm;
        "pkg-0.0.1-Resharped-1.4.44" = _67fqVGOb;
        "pkg-0.0.2-Resharped-1.4.44" = _57oGh4Is;
        "pkg-0.0.3-Resharped-1.4.46" = _lmSV7582;
        "pkg-0.0.4-Resharped-1.4.46" = _UWParwjF;
        "pkg-0.0.5-Resharped-1.5.47" = _ZFI88K8W;
        "pkg-0.0.6-Resharped-1.5.47" = _9k0DA4Ay;
        "pkg-0.0.7-Resharped-1.5.49" = _MyOrEkxL;
        "pkg-0.0.8-Resharped-1.6.54" = _AQqqbJQ4;
        "pkg-0.0.9-Resharped-1.6.54" = _WjUw5mTs;
        "pkg-1.20.1-1.0.0-Resharped-1.7.55" = _9bWik4Zc;
        "pkg-1.20.1-1.0.1-Resharped-1.7.55" = _KM7TTEHg;
        "pkg-1.20.1-1.0.2-Resharped-1.7.55" = _sIkvtOqh;
        "pkg-1.21.1-1.0.0-Resharped-1.7.55" = _Mg9lATfZ;
        "pkg-1.21.1-1.0.1-Resharped-1.7.55" = _Vf3wzwCs;
        "pkg-1.20.1-1.1.0-Resharped-1.8.57" = _m0iHzeZi;
        "pkg-1.21.1-1.1.0-Resharped-1.8.57" = _SvhmSVNa;
        "pkg-1.20.1-1.1.1-Resharped-1.8.57" = _Qy7DNSLQ;
        "pkg-1.21.1-1.1.1-Resharped-1.8.57" = _vq5TXOZk;
        "pkg-1.20.1-1.1.2-Resharped-1.8.57" = _tIFdVIzP;
        "pkg-1.21.1-1.1.2-Resharped-1.8.57" = _nSVdAHOU;
        "pkg-1.20.1-1.1.3-Resharped-1.8.60" = _e10cI9kg;
        "pkg-1.21.1-1.1.3-Resharped-1.8.60" = _Spjdc7eL;
        "pkg-1.21.1-1.1.4-Resharped-1.8.60" = _uTdSA2dW;
        "pkg-1.20.1-1.1.5-Resharped-1.8.60" = _uAnTQaIE;
        "pkg-1.21.1-1.1.5-Resharped-1.8.60" = _rNbeu1B5;
        "pkg-1.21.1-1.1.6-Resharped-1.8.60" = _8ppgsKMP;
        "pkg-1.20.1-1.2.0-Resharped-1.8.61" = _V4MHzV3v;
        "pkg-1.21.1-1.2.0-Resharped-1.8.61" = _hRsaAJLJ;
        "pkg-1.20.1-1.3.0-Resharped-1.8.61" = _Cxaic4Ev;
        "pkg-1.21.1-1.3.0-Resharped-1.8.61" = _OO1OsJgO;
        "pkg-1.21.1-1.3.1-Resharped-1.8.61" = _edcr8AKX;
        "pkg-1.21.1-1.3.2-Resharped-1.8.61" = _jvfbnHbb;
        "pkg-1.20.1-1.3.3-Resharped-1.8.61" = _yNz7vfMU;
        "pkg-1.21.1-1.3.3-Resharped-1.8.61" = _YD7sErEr;
        "pkg-1.20.1-1.3.4-Resharped-1.8.61" = _8vHT4QOe;
        "pkg-1.21.1-1.3.4-Resharped-1.8.61" = _easyAExz;
        "pkg-1.21.1-1.3.5-Resharped-1.8.61" = _aFtPMF3l;
        "pkg-1.20.1-1.4.0-Resharped-1.9.65" = _a7m4w2ic;
        "pkg-1.21.1-1.4.0-Resharped-1.9.65" = _q7jF9JiU;
        "pkg-1.21.1-1.4.1-Resharped-1.9.65" = _ucnc6yR5;
        "pkg-1.21.1-1.4.2-Resharped-1.9.65" = _GuVDByoe;
        "pkg-1.21.1-1.4.3-Resharped-1.9.65" = _HbcCWNXe;
        "pkg-1.21.1-1.4.4-Resharped-1.9.65" = _S2zePbPZ;
        "pkg-26.1.2-1.0.0-Resharped-1.9.65" = _MHWtJ28M;
        "pkg-1.21.1-1.4.5-Resharped-1.9.65" = _gEaFZWJN;
        "pkg-26.1.2-1.0.1-Resharped-1.9.65" = _4MfK9GWD;
        "pkg-26.1.2-1.0.2-Resharped-1.9.65" = _XHGRjahS;
        "pkg-1.21.1-1.5.0-Resharped-2.0.5" = _36gR3DXV;
        "pkg-26.1.2-1.5.0-Resharped-2.0.5" = _Hi6Zslva;
        "pkg-1.21.1-1.5.1-Resharped-2.0.5" = _PO0ZyaGl;
        "pkg-26.1.2-1.5.1-Resharped-2.0.5" = _nmkteODm;
        "default" = _nmkteODm;
    });
