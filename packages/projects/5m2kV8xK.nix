...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.0.0" = _GteVpaAr;
        "pkg-1.20.1-1.0.2" = _R95eSkak;
        "pkg-1.20.1-1.0.3" = _WNuNl9It;
        "pkg-1.19.2-1.0.3" = _s11iyCfq;
        "pkg-1.18.2-1.0.3" = _m3sQyajJ;
        "pkg-1.20.1-1.0.4" = _eLxnyO6C;
        "pkg-1.18.2-1.0.4" = _zDlw3hzc;
        "pkg-1.19.2-1.0.4" = _rPrWWHVn;
        "pkg-1.20.1-1.1.0" = _89NoSdRS;
        "pkg-1.20.1-1.2.0" = _BvN2y7nc;
        "pkg-1.20.1-1.2.1" = _91B3xAnF;
        "pkg-1.20.1-1.2.2" = _QMmmD6Ys;
        "pkg-1.20.1-1.3.0" = _FlZmynKx;
        "pkg-1.20.1-1.3.1" = _v6MPdkeX;
        "pkg-1.20.1-1.4.0" = _vniuBhl0;
        "pkg-1.20.1-1.5.0" = _nKz08mV1;
        "pkg-1.20.1-1.5.1" = _T7BSkawd;
        "pkg-1.20.1-1.5.2" = _77usZX9h;
        "pkg-1.20.1-1.5.4" = _o2K3R6Np;
        "pkg-1.20.1-1.6.0" = _1Z1mLUXT;
        "pkg-1.20.1-1.6.1" = _pW4MT5oF;
        "pkg-1.20.1-1.6.2" = _nctQWcGp;
        "pkg-1.20.1-1.6.3" = _8BCn5XGu;
        "pkg-1.20.1-1.6.4" = _cq9IieFQ;
        "pkg-1.20.1-1.6.5" = _FHWcMABm;
        "pkg-1.20.1-1.7.0" = _CceOk3Jb;
        "pkg-1.20.1-1.7.1" = _5RoFgqj8;
        "pkg-1.20.1-1.8.0" = _zwZdQRPh;
        "pkg-1.20.1-1.8.1" = _FztCaztu;
        "pkg-1.20.1-1.9.0" = _fNh4beQn;
        "pkg-1.20.1-1.9.1" = _CEX9udqe;
        "pkg-1.20.1-1.9.2" = _A5kSXkbT;
        "pkg-1.20.1-1.9.3" = _JXwdU3of;
        "pkg-1.20.1-1.10.0" = _4yTvBj39;
        "pkg-1.20.1-1.10.1" = _ubA8Ebnd;
        "pkg-1.20.1-2.0.0" = _rbjmIog1;
        "pkg-1.20.1-2.0.1" = _GK0088wX;
        "pkg-1.20.1-2.0.2" = _Rdv43w0M;
        "pkg-1.20.1-2.1.0" = _E22kUKfC;
        "pkg-1.20.1-2.1.1" = _8R0KDIQj;
        "pkg-3.0.0" = _nksghP1f;
        "pkg-3.0.1" = _KdPudxor;
        "pkg-3.0.2" = _ShXlfVnu;
        "pkg-3.0.3" = _y7Hhqgdh;
