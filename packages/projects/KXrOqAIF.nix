...
let
    versions = (let
        ...
        _am1qdypQ = {
            "id" = "am1qdypQ";
            "file" = "SnapshotXBR-26.3-snapshot-8.zip";
            "hash" = "sha512-/OLteNgvzRu8rqhb9EhgLk7S4K7w3Yn4YCQSWfVpqLS957CrvkCAkHbfKNnNZBfTSJnL8jOvhDpKdz24MZAheg==";
        };
        _Fgs1wimW = {
            "id" = "Fgs1wimW";
            "file" = "SnapshotXBR-26.3-snapshot-10.zip";
            "hash" = "sha512-a8Bcx1VuDmV+9HzIDWxBJVJOdJ9tTxbrzxMledRo6vQU/jAuiqHC7CPDYW7vat8E6TWEUbXUnPs2RDRqb4vRaQ==";
        };
    in {
        "JPgLqBNh" = _JPgLqBNh;
        "sUwvQH3v" = _sUwvQH3v;
        ...
        "minecraft-26.3-snapshot-8" = _am1qdypQ;
        "minecraft-26.3-snapshot-10" = _Fgs1wimW;
        "pkg-1.21.4" = _JPgLqBNh;
        "pkg-1.21.5" = _sUwvQH3v;
        "pkg-1.21.6" = _Y6g2dnM3;
        "pkg-1.21.7" = _wiPHCOBK;
        "pkg-1.21.9" = _nMEtcA4q;
        "pkg-25w41a" = _fNEb3WAb;
        "pkg-25w44a" = _REtn2zUR;
        "pkg-25w45a" = _XE2cofYo;
        "pkg-1.21.11" = _7Pu6wIze;
        "pkg-26.1-snapshot-4" = _sFM2Tfit;
        "pkg-26.1-snapshot-5" = _VxEknbFQ;
        "pkg-26.1-snapshot-6" = _9E6XUT1w;
        "pkg-26.1-snapshot-7" = _le1EbWjn;
        "pkg-26.1-snapshot-8" = _StKfTSnT;
        "pkg-26.1-snapshot-10" = _JXZBEi7w;
        "pkg-26.1" = _EJT2NRpI;
        "pkg-26.2-snapshot-1" = _bGibo8ag;
        "pkg-26.2-snapshot-3" = _kYFMygKo;
        "pkg-26.2-snapshot-4" = _WVRryHDY;
        "pkg-26.2-snapshot-7" = _uobvCTQl;
        "pkg-26.2-snapshot-8" = _24KKqkuW;
        "pkg-26.2-pre-1" = _B27Ma96T;
        "pkg-26.3-snapshot-1" = _sICTpeNf;
        "pkg-26.3-snapshot-3" = _CCDswY4w;
        "pkg-26.3-snapshot-4" = _LLQLs4kR;
        "pkg-26.3-snapshot-8" = _am1qdypQ;
        "pkg-26.3-snapshot-10" = _Fgs1wimW;
        "default" = _Fgs1wimW;
    });
