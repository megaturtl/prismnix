...
let
    ...
    in {
        ...
        "pkg-1.3.2" = _YjdtAF9W;
        "pkg-1.4.0" = _nwtmrsZe;
        "pkg-1.4.1-1.21" = _hrzg1UD0;
        "pkg-1.4.1-1.20.4" = _pA3m8fIM;
        "pkg-1.5.0-1.20.4" = _Wgq75RlU;
        "pkg-1.5.0-1.21" = _tK14MLTG;
        "pkg-1.6.0-1.21" = _sMRFYGR7;
        "pkg-2.0.0-1.21-beta1" = _2aNPBOXQ;
        "pkg-2.0.0" = _uza0fjFW;
        "pkg-2.1.0" = _PO1QYtut;
        "pkg-2.1.0-1.21.6" = _KK9dm0mj;
        "pkg-2.2.0-1.21.6" = _DqtIxCdf;
        "pkg-2.2.0-1.21.4" = _82CPhq2Z;
        "pkg-2.2.0-1.21.1" = _jXjxH2WV;
        "pkg-2.2.1-1.21.6" = _ghFL257s;
        "pkg-2.2.1-1.21.4" = _1LuKOdt9;
        "pkg-2.2.1-1.21.1" = _h4DWY8yp;
        "pkg-2.2.2-1.21.6" = _QgRB05aV;
        "pkg-2.2.2-1.21.4" = _7Xf8mNL1;
        "pkg-2.2.2-1.21.1" = _tdzuTqQl;
        "pkg-2.3.0-1.21.6" = _iSlQVi0V;
        "pkg-2.3.0-1.21.4" = _XXqIzzSM;
        "pkg-2.3.0-1.21.1" = _tplbCy5F;
        "pkg-2.4.0-1.21.1" = _nzSFKCZq;
        "pkg-2.4.0-1.21.4" = _VBB2LLGK;
        "pkg-2.4.0-1.21.6" = _8v5Bbx0z;
        "pkg-2.4.0-1.21.9" = _mnjvaip5;
        "pkg-2.5.0-1.21.1" = _TwXa4F8B;
        "pkg-2.5.0-1.21.6" = _5vhQFEuL;
        "pkg-2.5.0-1.21.9" = _wz3iYnB3;
        "pkg-2.5.0-1.21.11" = _aoO42TZG;
        "pkg-2.5.1-1.21.1" = _Oa4jf7GH;
        "pkg-2.5.1-1.21.6" = _YVBxOuVp;
        "pkg-2.5.1-1.21.9" = _h7hycZXt;
        "pkg-2.5.1-1.21.11" = _5KF4Bqkm;
        "pkg-2.6.0-1.21.1" = _bgZvTRAs;
        "pkg-2.6.0-1.21.9" = _9jcLNy55;
        "pkg-2.6.0-1.21.11" = _V2Vm0LV3;
        "pkg-2.6.0-26.1" = _7bMgpivx;
        "pkg-2.7.0-1.21.1" = _DXvK22VK;
