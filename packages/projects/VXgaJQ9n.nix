...
let
    ...
    in {
        ...
        "pkg-1.19.3-2.3.7" = _6ewHKor7;
        "pkg-2.3.8" = _HJ5W0sWK;
        "pkg-1.9.8.77959" = _jv8hD9mM;
        "pkg-2.1.2.89938" = _knCab7Oc;
        "pkg-2.3.81" = _Z46fGX3e;
        "pkg-2.1.2.89939" = _Jcts2haV;
        "pkg-1.9.8.7796" = _zLxIyLzV;
        "pkg-2.3.9" = _TZ1qseHX;
        "pkg-2.4.0" = _fxTCZ41b;
        "pkg-2.4.1" = _OkKNesiS;
        "pkg-2.1.2.8994" = _CSdNl4y3;
        "pkg-1.9.8.77961" = _tmqJPzq7;
        "pkg-2.4.2" = _U7qbcyKi;
        "pkg-1.9.8.77962" = _Ff1svC3z;
        "pkg-2.1.2.89941" = _67Sy8OHb;
        "pkg-2.4.21" = _7TfMfvgf;
        "pkg-1.9.8.77963" = _kNtR3qeg;
        "pkg-2.1.2.89942" = _8pOF24tJ;
        "pkg-2.4.3" = _5hmeXrv3;
        "pkg-2.1.2.89943" = _z9eX6iyR;
        "pkg-1.9.8.77964" = _cT1t2mvJ;
        "pkg-2.4.4" = _FZODGvc4;
        "pkg-1.9.8.77965" = _R20RHrXz;
        "pkg-2.1.2.89944" = _981RsyQ1;
        "pkg-2.4.5" = _BRKTu5XQ;
        "pkg-1.9.8.77966" = _LbWGh9K4;
        "pkg-2.1.2.89945" = _TrZuL4Gw;
        "pkg-2.4.6" = _l4hZQeLg;
        "pkg-2.5.0" = _aBQXt50q;
        "pkg-2.5.1" = _DXGmsjzL;
        "pkg-2.1.2.89946" = _CIIuWeoz;
        "pkg-1.9.8.77967" = _rdjWtFLf;
        "pkg-2.5.11" = _LA0AyIso;
        "pkg-2.4.61" = _saaWplNp;
        "pkg-1.9.8.77968" = _xMgshlj9;
        "pkg-2.1.2.89947" = _6uiRVYm7;
        "pkg-2.5.2" = _ONt3lVAk;
        "pkg-2.1.2.89948" = _j4Z6Hgo3;
        "pkg-1.9.8.77969" = _g1ZY9tWA;
        "pkg-2.4.63" = _WTEF0bAv;
        "pkg-2.5.3" = _A7Eg30Jl;
        "pkg-2.5.4" = _AWjOkiNF;
        "pkg-2.5.5" = _AZk0IIng;
        "pkg-1.9.8.77970" = _4wSnNfLp;
        "pkg-2.1.2.89949" = _HUWVOwfc;
        "pkg-2.5.6" = _hmV2q9dU;
        "pkg-2.1.2.89950" = _5drqE7Nc;
        "pkg-1.9.8.77971" = _I7jkZSV5;
        "pkg-2.5.7" = _1mvHIn3h;
        "pkg-2.4.64" = _VsSvtghX;
        "pkg-2.5.8" = _gH4otmO1;
        "pkg-2.5.9" = _5TN6n1QM;
        "pkg-2.6.0" = _DkQZYEFR;
        "pkg-2.6.1" = _vBoyNDT4;
        "pkg-2.6.2" = _HjwoYzaQ;
        "pkg-2.6.21" = _Enr0x0mx;
        "pkg-2.6.22" = _BiAy8wnJ;
        "pkg-2.6.231" = _FAUZ4SdH;
        "pkg-2.6.24" = _p0R80Vn3;
        "pkg-2.6.3" = _g1HlBbaA;
        "pkg-2.6.4" = _fVb8UMhP;
        "pkg-2.6.5" = _mr6Zom7A;
        "pkg-2.6.51" = _1ok4wsHT;
        "pkg-2.6.6" = _sroEJt8z;
        "pkg-2.6.7" = _GpNq7gmB;
        "pkg-2.6.61" = _Sq6oYJZG;
        "pkg-2.6.71" = _RGo8H05k;
        "pkg-2.6.62" = _I8Z0qYMP;
        "pkg-2.6.72" = _8012GJea;
        "pkg-2.6.73" = _AQrJcxuI;
        "pkg-2.6.74" = _XwdRZpfb;
        "pkg-2.6.75" = _o6ucixdm;
        "pkg-2.6.76" = _IGcarEIh;
        "pkg-2.6.761" = _Kr6dXPbn;
        "pkg-2.6.762" = _PElIW3mu;
        "pkg-2.6.77" = _1jzdFD0J;
        "pkg-2.6.8" = _ze7h0Qx0;
        "pkg-2.6.81" = _nlZP3J81;
        "pkg-2.6.9" = _8pYlExh9;
        "pkg-2.7.0" = _eu4lDKUl;
        "pkg-2.7.1" = _XbC0DRHZ;
        "pkg-2.7.2" = _uMHxTbLb;
        "pkg-2.7.3" = _vn1B2WCi;
        "pkg-2.7.31" = _w4pubWO8;
        "pkg-2.7.4" = _jkBIj1bK;
        "pkg-2.7.41" = _O3kdSNbo;
        "pkg-2.7.5" = _uzcDIeNX;
        "pkg-2.7.51" = _nncr7Fll;
        "pkg-2.7.6" = _z9km4tZm;
        "pkg-2.7.7" = _i3nXtpJD;
        "pkg-2.7.71" = _uqL57VEF;
        "pkg-2.7.72" = _8zKUjM1N;
        "pkg-2.8.0" = _vwrAFgAq;
        "pkg-1.9.8.77972" = _gCr4w7hO;
        "pkg-2.8.1" = _Wuhi4uDf;
        "pkg-2.5.91" = _ZKOCnrGq;
        "pkg-2.8.2" = _k4yxVHWI;
        "pkg-2.8.3" = _PwCxiYFz;
        "pkg-2.9" = _JGQnAnMY;
        "pkg-2.9.1" = _icwqqFTO;
