...
let
    versions = (let
        ...
        _NmDR4Xr3 = {
            "id" = "NmDR4Xr3";
            "file" = "§lC418 §rSongs Only.zip";
            "hash" = "sha512-c4zTim59cGMwwbQONpuzemBzwZacva2O8wx3Dg2k+k0dxAKSHCcSs34omNuyOE36rl6L2sAEjZeT9cqBNcobYw==";
        };
        _6g0lPrq8 = {
            "id" = "6g0lPrq8";
            "file" = "§lC418 §rSongs Only.zip";
            "hash" = "sha512-iNd3xe7iym4l0iDaNu0oyro/hgDqDSxThK9/k/snCtkq9EwzXi+J8pWNxsf66sIXE7bj/UFWeMIIskWNEQlIVA==";
        };
        _xkCRrVC3 = {
            "id" = "xkCRrVC3";
            "file" = "§lC418 §rSongs Only.zip";
            "hash" = "sha512-eW0/WqhrtM7W0hG8TMHD2EGedjz5mHIAP0fLTKTOkrbuRAs+J/KlPK03hfCtJkL2GbUMpXra5dn0jS80emp7Ow==";
        };
    in {
        "Sa7EKx9l" = _Sa7EKx9l;
        "dagsiw21" = _dagsiw21;
        ...
        "6g0lPrq8" = _6g0lPrq8;
        "xkCRrVC3" = _xkCRrVC3;
        "minecraft-1.20" = _6g0lPrq8;
        "minecraft-1.20.1" = _6g0lPrq8;
        "minecraft-1.19.4" = _6g0lPrq8;
        "minecraft-1.19.3" = _6g0lPrq8;
        "minecraft-1.19" = _6g0lPrq8;
        "minecraft-1.19.1" = _6g0lPrq8;
        "minecraft-1.19.2" = _6g0lPrq8;
        "minecraft-1.18" = _6g0lPrq8;
        "minecraft-1.18.1" = _6g0lPrq8;
        "minecraft-1.18.2" = _6g0lPrq8;
        "minecraft-1.17" = _6g0lPrq8;
        "minecraft-1.17.1" = _6g0lPrq8;
        "minecraft-1.16.2" = _6g0lPrq8;
        "minecraft-1.16.3" = _6g0lPrq8;
        "minecraft-1.16.4" = _6g0lPrq8;
        "minecraft-1.16.5" = _6g0lPrq8;
        "minecraft-1.16" = _6g0lPrq8;
        "minecraft-1.16.1" = _6g0lPrq8;
        "minecraft-1.20.2" = _6g0lPrq8;
        "minecraft-1.20.3" = _xkCRrVC3;
        "minecraft-1.20.4" = _xkCRrVC3;
        "minecraft-1.20.5" = _xkCRrVC3;
        "minecraft-1.20.6" = _xkCRrVC3;
        "minecraft-1.21" = _xkCRrVC3;
        "minecraft-1.21.1" = _xkCRrVC3;
        "minecraft-1.21.2" = _xkCRrVC3;
        "minecraft-1.21.3" = _xkCRrVC3;
        "minecraft-1.21.4" = _xkCRrVC3;
        "minecraft-1.21.5" = _xkCRrVC3;
        "minecraft-1.21.6" = _xkCRrVC3;
        "minecraft-1.21.7" = _xkCRrVC3;
        "minecraft-1.21.8" = _xkCRrVC3;
        "minecraft-1.21.9" = _xkCRrVC3;
        "minecraft-1.21.10" = _xkCRrVC3;
        "minecraft-1.21.11" = _xkCRrVC3;
        "minecraft-24w03a" = _xkCRrVC3;
        "minecraft-24w03b" = _xkCRrVC3;
        "minecraft-24w04a" = _xkCRrVC3;
        "minecraft-24w05a" = _xkCRrVC3;
        "minecraft-24w05b" = _xkCRrVC3;
        "minecraft-24w06a" = _xkCRrVC3;
        "minecraft-24w07a" = _xkCRrVC3;
        "minecraft-24w09a" = _xkCRrVC3;
        "minecraft-24w10a" = _xkCRrVC3;
        "minecraft-24w11a" = _xkCRrVC3;
        "minecraft-24w12a" = _xkCRrVC3;
        "minecraft-24w13a" = _xkCRrVC3;
        "minecraft-24w14potato" = _xkCRrVC3;
        "minecraft-24w14a" = _xkCRrVC3;
        "minecraft-1.20.5-pre1" = _xkCRrVC3;
        "minecraft-1.20.5-pre2" = _xkCRrVC3;
        "minecraft-1.20.5-pre3" = _xkCRrVC3;
        "minecraft-24w18a" = _xkCRrVC3;
        "minecraft-24w19a" = _xkCRrVC3;
        "minecraft-24w19b" = _xkCRrVC3;
        "minecraft-24w20a" = _xkCRrVC3;
        "minecraft-24w33a" = _xkCRrVC3;
        "minecraft-24w34a" = _xkCRrVC3;
        "minecraft-24w35a" = _xkCRrVC3;
        "minecraft-24w36a" = _xkCRrVC3;
        "minecraft-24w37a" = _xkCRrVC3;
        "minecraft-24w38a" = _xkCRrVC3;
        "minecraft-24w39a" = _xkCRrVC3;
        "minecraft-24w40a" = _xkCRrVC3;
        "minecraft-1.21.2-pre1" = _xkCRrVC3;
        "minecraft-1.21.2-pre2" = _xkCRrVC3;
        "minecraft-24w44a" = _xkCRrVC3;
        "minecraft-24w45a" = _xkCRrVC3;
        "minecraft-24w46a" = _xkCRrVC3;
        "minecraft-26.1" = _xkCRrVC3;
        "minecraft-26.1.1" = _xkCRrVC3;
        "minecraft-26.1.2" = _xkCRrVC3;
        "minecraft-26.2" = _xkCRrVC3;
        "minecraft-22w42a" = _6g0lPrq8;
        "minecraft-22w43a" = _6g0lPrq8;
        "minecraft-22w44a" = _6g0lPrq8;
        "minecraft-23w14a" = _6g0lPrq8;
        "minecraft-23w16a" = _6g0lPrq8;
        "minecraft-23w31a" = _6g0lPrq8;
        "minecraft-23w32a" = _6g0lPrq8;
        "minecraft-23w33a" = _6g0lPrq8;
        "minecraft-23w35a" = _6g0lPrq8;
        "minecraft-1.20.2-pre1" = _6g0lPrq8;
        "minecraft-26.3" = _xkCRrVC3;
        "pkg-1" = _iZ3PZ02C;
        "pkg-2" = _e9L0W86C;
        "pkg-2-av.0" = _iE600VJo;
        "pkg-2-av.1" = _DXXP0dF8;
        "pkg-2-av.2" = _mX3r0gvZ;
        "pkg-2-av.3" = _gwktAn2y;
        "pkg-2-av.4" = _31Q3N0xw;
        "pkg-2-av.5" = _79QgD42d;
        "pkg-2-av.6" = _mHlNnmbv;
        "pkg-2-av.7" = _q90f4KI0;
        "pkg-3-pre.0" = _u2GzG3Tz;
        "pkg-3-post.0" = _6c4bETOc;
        "pkg-3-post.1" = _Six5duQ0;
        "pkg-3-post.2" = _Mff6aykx;
        "pkg-3-post.3" = _H0pVGFqx;
        "pkg-3-post.3a" = _jKZoVfXq;
        "pkg-4-post.0" = _NmDR4Xr3;
        "pkg-4-pre.0" = _6g0lPrq8;
        "pkg-4-post.1" = _xkCRrVC3;
        "default" = _xkCRrVC3;
    });
