...
let
    versions = (let
        ...
        _dRH41OQE = {
            "id" = "dRH41OQE";
            "file" = "nachoneko PVP Textured sword 1.7 Beta2.zip";
            "hash" = "sha512-C5Vp1L/7YazvJCxOnI1WNg1xJPp1VfiPO9ExKWNtQEYziQiUFHGUGlZ3ZdhgaVhXjFxmQ4Tq2FqV9Lgg4nBrkA==";
        };
        _upMTosRU = {
            "id" = "upMTosRU";
            "file" = "nachoneko PVP 1.7.zip";
            "hash" = "sha512-1UC7bTr2Yv1Vo1t2tsihStIn1/Rx2qUfQZ96t/tsFEVYPgYcgjkl2NfxJkYogWBrMGqTWpR4VJ5GYiiRQ7T0nA==";
        };
        _bcR7pxVL = {
            "id" = "bcR7pxVL";
            "file" = "nachoneko PVP Textured sword 1.7.zip";
            "hash" = "sha512-C5Vp1L/7YazvJCxOnI1WNg1xJPp1VfiPO9ExKWNtQEYziQiUFHGUGlZ3ZdhgaVhXjFxmQ4Tq2FqV9Lgg4nBrkA==";
        };
    in {
        "MMRhhDLn" = _MMRhhDLn;
        ...
        "upMTosRU" = _upMTosRU;
        "bcR7pxVL" = _bcR7pxVL;
        "minecraft-1.20" = _bcR7pxVL;
        "minecraft-1.20.1" = _bcR7pxVL;
        "minecraft-1.20.2" = _bcR7pxVL;
        "minecraft-1.20.3" = _bcR7pxVL;
        "minecraft-1.20.4" = _bcR7pxVL;
        "minecraft-1.20.5" = _bcR7pxVL;
        "minecraft-1.20.6" = _bcR7pxVL;
        "minecraft-1.21" = _bcR7pxVL;
        "minecraft-1.21.1" = _bcR7pxVL;
        "minecraft-1.21.2" = _bcR7pxVL;
        "minecraft-1.21.3" = _bcR7pxVL;
        "minecraft-1.21.4" = _bcR7pxVL;
        "minecraft-1.21.5" = _bcR7pxVL;
        "minecraft-1.21.6" = _bcR7pxVL;
        "minecraft-1.21.7" = _bcR7pxVL;
        "minecraft-1.21.8" = _bcR7pxVL;
        "minecraft-1.21.9" = _bcR7pxVL;
        "minecraft-1.21.10" = _bcR7pxVL;
        "minecraft-1.21.11" = _bcR7pxVL;
        "minecraft-26.1" = _bcR7pxVL;
        "minecraft-26.1.1" = _bcR7pxVL;
        "minecraft-26.1.2" = _bcR7pxVL;
        "minecraft-23w31a" = _bcR7pxVL;
        "minecraft-23w32a" = _bcR7pxVL;
        "minecraft-23w33a" = _bcR7pxVL;
        "minecraft-23w35a" = _bcR7pxVL;
        "minecraft-1.20.2-pre1" = _bcR7pxVL;
        "minecraft-23w42a" = _bcR7pxVL;
        "minecraft-23w43a" = _bcR7pxVL;
        "minecraft-23w43b" = _bcR7pxVL;
        "minecraft-23w44a" = _bcR7pxVL;
        "minecraft-23w45a" = _bcR7pxVL;
        "minecraft-23w46a" = _bcR7pxVL;
        "minecraft-24w03a" = _bcR7pxVL;
        "minecraft-24w03b" = _bcR7pxVL;
        "minecraft-24w04a" = _bcR7pxVL;
        "minecraft-24w05a" = _bcR7pxVL;
        "minecraft-24w05b" = _bcR7pxVL;
        "minecraft-24w06a" = _bcR7pxVL;
        "minecraft-24w07a" = _bcR7pxVL;
        "minecraft-24w09a" = _bcR7pxVL;
        "minecraft-24w10a" = _bcR7pxVL;
        "minecraft-24w11a" = _bcR7pxVL;
        "minecraft-24w12a" = _bcR7pxVL;
        "minecraft-24w13a" = _bcR7pxVL;
        "minecraft-24w14potato" = _bcR7pxVL;
        "minecraft-24w14a" = _bcR7pxVL;
        "minecraft-1.20.5-pre1" = _bcR7pxVL;
        "minecraft-1.20.5-pre2" = _bcR7pxVL;
        "minecraft-1.20.5-pre3" = _bcR7pxVL;
        "minecraft-24w18a" = _bcR7pxVL;
        "minecraft-24w19a" = _bcR7pxVL;
        "minecraft-24w19b" = _bcR7pxVL;
        "minecraft-24w20a" = _bcR7pxVL;
        "minecraft-24w33a" = _bcR7pxVL;
        "minecraft-24w34a" = _bcR7pxVL;
        "minecraft-24w35a" = _bcR7pxVL;
        "minecraft-24w36a" = _bcR7pxVL;
        "minecraft-24w37a" = _bcR7pxVL;
        "minecraft-24w38a" = _bcR7pxVL;
        "minecraft-24w39a" = _bcR7pxVL;
        "minecraft-24w40a" = _bcR7pxVL;
        "minecraft-1.21.2-pre1" = _bcR7pxVL;
        "minecraft-1.21.2-pre2" = _bcR7pxVL;
        "minecraft-24w44a" = _bcR7pxVL;
        "minecraft-24w45a" = _bcR7pxVL;
        "minecraft-24w46a" = _bcR7pxVL;
        "minecraft-26.2" = _bcR7pxVL;
        "pkg-1.0.0" = _NGlPq1oV;
        "pkg-1.1.0" = _VhTybeBF;
        "pkg-1.1.1" = _ovWjIiXv;
        "pkg-1.1.2" = _EVjaVfLU;
