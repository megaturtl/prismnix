...
let
    ...
    in {
        ...
        "pkg-9.0.4" = _nTWwIqPK;
        "pkg-9.0.5" = _dB3JqT5q;
        "pkg-10.0.0" = _aQTOpWkN;
        "pkg-21.4.18" = _bKui9Bj5;
        "pkg-21.5.0" = _HykZoinp;
        "pkg-21.5.1" = _I36MUcst;
        "pkg-21.5.6" = _YtcfpAXT;
        "pkg-21.5.10" = _Uufgioi7;
        "pkg-21.6.0" = _q2PZrcOe;
        "pkg-21.7.0" = _5IoZYpHU;
        "pkg-21.10.0" = _iDZYkzjw;
        "pkg-21.11.0" = _hdgDXvPn;
