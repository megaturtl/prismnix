...
let
    versions = (let
        ...
        _ENkiVcE9 = {
            "id" = "ENkiVcE9";
            "file" = "wood plus-4.0.1.jar";
            "hash" = "sha512-LrCK9Z5AIKYaPqeYHkDfWStM4LlIsM5gFTFI2qydg3tksIFYIoO2HIKIPVWuCb4FCXyzlGrT6GWQa/IE35mHzg==";
        };
        _6h08hrao = {
            "id" = "6h08hrao";
            "file" = "wood plus-4.0.1.jar";
    ...
    in {
        ...
        "fabric-26.3-pre-1" = _ENkiVcE9;
        "fabric-26.3-pre-2" = _ENkiVcE9;
        "fabric-26.3-pre-3" = _ENkiVcE9;
        ...
        "pkg-3.0.1" = _IVsLCnmq;
        "pkg-3.0.2" = _FYTNAXs3;
        "pkg-3.0.3-26.1-snapshot4" = _GYYLbZxZ;
        "pkg-3.0.3" = _mGdmK59r;
        "pkg-3.0.3.0" = _Dhp3ZKFo;
        "pkg-3.0.3-26.1snapshot6" = _tI25dp3A;
        "pkg-3.0.3-26.1-snapshot9" = _Wnipu54e;
        "pkg-3.0.3-26.1pre1" = _lMNTEtL9;
        "pkg-3.0.3-26.1rc2" = _5u89rYj6;
        "pkg-3.0.3-26.1" = _bYkHt3Ch;
        "pkg-3.0.3-26.2snapshot2" = _aE3yYs2K;
        "pkg-3.0.3-26.2-snapshot5" = _OOiPJVrH;
        "pkg-3.0.3-26.2-snapshot7" = _NcaOpimC;
        "pkg-3.0.3-26.2-snapshot8" = _mrv37Ivp;
        "pkg-4.0.0-26.2-pre4" = _kPdsOFd6;
        "pkg-4.0.0-26.2rc2" = _s2ixf6B0;
        ...
        "pkg-4.0.1-26.3-pre2" = _ENkiVcE9;
        "pkg-4.0.1-26.3-broken1" = _6h08hrao;
        "default" = _6h08hrao;
    });
