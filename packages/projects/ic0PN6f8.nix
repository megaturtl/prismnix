...
let
    versions = (let
        ...
        _XN8ZLcWf = {
            "id" = "XN8ZLcWf";
            "file" = "remoteresourcepack-fabric-3.0.0-rc.1+1.20.1.jar";
            "hash" = "sha512-CntE+MPnSxnXd+kdRys9EPQYR1mqXAzXv2x2ZuFT+yW7JQm4YKBjCo7ovVi1n5j65rAPC0Pe5hjQxJf6R0cjgw==";
        };
        _wNgeTiLy = {
            "id" = "wNgeTiLy";
            "file" = "remoteresourcepack-forge-3.0.0-rc.1+1.20.1.jar";
            "hash" = "sha512-r+k/ehHBUCjd/cpPY0HlQpTYnC59QxOypboR37JI0HmkEtvQOjrW0ZsFGYwbtgS6YPnh8ldlty8pzFOaehh3AQ==";
        };
        _lxS7IBGf = {
            "id" = "lxS7IBGf";
            "file" = "remoteresourcepack-fabric-3.0.0-rc.1+1.21.1.jar";
            "hash" = "sha512-v/GEcZNXkBgAjLq+3/lsQUXAIt+P8pe/yh01bvQ7Lwh2S0leGeVY4n+umVlKG3yMx9LsXLvZElGQu4eQzqpHnQ==";
        };
        _wHzMuDtM = {
            "id" = "wHzMuDtM";
            "file" = "remoteresourcepack-forge-3.0.0-rc.1+1.21.1.jar";
            "hash" = "sha512-Xi9o+JGizrAr/MJa166FL8FVpfsspvuLttaS9Roxgi2sXZK+ghA8tisP4JkzlWi5Up5Zor4J5pUCyIjJoGBXOQ==";
        };
        _FuzVTuKK = {
            "id" = "FuzVTuKK";
            "file" = "remoteresourcepack-neoforge-3.0.0-rc.1+1.21.1.jar";
            "hash" = "sha512-kAIYDYRLYA5g3LIXCuyfUwFVXqK0MsvL46ElO8iHsJbeP95CSJL66GiB4YeipqgYPlTOGm2CX0BkdzQatwmRAA==";
        };
        _fz3W6vPy = {
            "id" = "fz3W6vPy";
            "file" = "remoteresourcepack-fabric-3.0.0-rc.1+1.21.11.jar";
            "hash" = "sha512-DsO2K2cA3mVzZHbKoouzfAWuSjS4q7Jczgc6yrVfOhkWzC1kiWyo6eO6CxjyJcQiLCaDmd9Pf9Uy/oSyP4ggZA==";
        };
        _TSYcDAia = {
            "id" = "TSYcDAia";
            "file" = "remoteresourcepack-forge-3.0.0-rc.1+1.21.11.jar";
            "hash" = "sha512-YOqt31c5DLo1ezRQEm4gsciQ+MDddS7kotVTEDhKltraq+LevVW6MDKFTpp/Fh6uMnyb+LzJrutd1RJiAPIDOw==";
        };
        _rlLioQUo = {
            "id" = "rlLioQUo";
            "file" = "remoteresourcepack-neoforge-3.0.0-rc.1+1.21.11.jar";
            "hash" = "sha512-VuirrH/m4dThypOuEWKCkrghL7na+D3JkdLH99uyk6+7PDl+n+Q3LsG05rq9hVgIPHn9vlwjxz/blswC+Ns68w==";
        };
        _UzcsrnHd = {
            "id" = "UzcsrnHd";
            "file" = "remoteresourcepack-fabric-3.0.0-rc.1+26.2.jar";
            "hash" = "sha512-3H0j5jOygmjgY4Nt66t8KksHxIyac/FTu6x+3mxpIUsP24kMlSKmhjYlcuxlayGFCvcd10/cFkX7skLs0AiDbQ==";
        };
        _JPDIb1rp = {
            "id" = "JPDIb1rp";
            "file" = "remoteresourcepack-forge-3.0.0-rc.1+26.2.jar";
            "hash" = "sha512-s9ZMavx3aM5h/Iv0tW3LHzGOBIzt+hvvPfsfajj8hE/3Gc4h+WO73+FxJeyY6DQ0lrCx1cKOQak+KKePlcRqRw==";
        };
        _w0oOPSza = {
            "id" = "w0oOPSza";
            "file" = "remoteresourcepack-neoforge-3.0.0-rc.1+26.2.jar";
            "hash" = "sha512-9waQkdk6QgaiwTv985ZBuLpOwdocgL7OvQoL61mj5PUc5Mj1AFJb0W8EgNbos5F/AuGkZjG7VGQdhT1hfHRfqQ==";
        };
    in {
        "tFY2DR6X" = _tFY2DR6X;
        "c2y5UpKD" = _c2y5UpKD;
        ...
        "fabric-26.1" = _UzcsrnHd;
        "fabric-26.1.1" = _UzcsrnHd;
        "fabric-26.1.2" = _UzcsrnHd;
        "fabric-26.2" = _UzcsrnHd;
        "fabric-26.3" = _UzcsrnHd;
        ...
        "quilt-1.21.11" = _fz3W6vPy;
        "quilt-26.1" = _UzcsrnHd;
        "quilt-26.1.1" = _UzcsrnHd;
        "quilt-26.1.2" = _UzcsrnHd;
        "quilt-26.2" = _UzcsrnHd;
        "quilt-26.3" = _UzcsrnHd;
        "forge-1.18.2" = _c2y5UpKD;
        "forge-1.19.3" = _BuJX24aK;
        "forge-1.19.4" = _3YHyavdi;
        "forge-1.20" = _wNgeTiLy;
        "forge-1.20.1" = _wNgeTiLy;
        "forge-1.20.2" = _GgvhmfJR;
        "forge-1.20.3" = _GgvhmfJR;
        "forge-1.20.4" = _GgvhmfJR;
        "forge-1.20.5" = _osQOLwYC;
        "forge-1.20.6" = _osQOLwYC;
        "forge-1.21" = _wHzMuDtM;
        "forge-1.21.1" = _wHzMuDtM;
        ...
        "forge-26.1" = _JPDIb1rp;
        "forge-26.1.1" = _JPDIb1rp;
        "forge-26.1.2" = _JPDIb1rp;
        "forge-26.2" = _JPDIb1rp;
        "forge-26.3" = _JPDIb1rp;
        ...
        "neoforge-1.21" = _FuzVTuKK;
        "neoforge-1.21.1" = _FuzVTuKK;
        ...
        "neoforge-26.1" = _w0oOPSza;
        "neoforge-26.1.1" = _w0oOPSza;
        "neoforge-26.1.2" = _w0oOPSza;
        "neoforge-26.2" = _w0oOPSza;
        "neoforge-26.3" = _w0oOPSza;
        "pkg-1.0.6-fabric" = _tFY2DR6X;
        "pkg-1.0.6-forge" = _c2y5UpKD;
        "pkg-1.1.1+1.18-fabric" = _SwlBi4sN;
        "pkg-1.1.2+1.19-fabric" = _z7PAElxm;
        "pkg-1.1.2+1.19-forge" = _BuJX24aK;
        "pkg-1.1.2+1.20-fabric" = _VeenKZGz;
        "pkg-1.1.2+1.20-forge" = _3YHyavdi;
        "pkg-1.1.2+1.20.2-fabric" = _lE8A6Y4R;
        "pkg-1.1.2+1.20.2-forge" = _UaqTGJ9Z;
        "pkg-1.1.2+1.20.2-neo" = _2Xg5PKNb;
        "pkg-1.1.3+1.20.2-forge" = _GgvhmfJR;
        "pkg-1.1.3+1.20.2-fabric" = _k0u1KQI3;
        "pkg-1.1.3+1.20.2-neo" = _mLLfAWMN;
        "pkg-1.2.1+1.21-fabric" = _KRpMThPp;
        "pkg-1.2.1+1.21-forge" = _Ic8EFXhd;
        "pkg-1.2.1+1.21-neoforge" = _yFIM50sN;
        "pkg-1.2.2+1.21-fabric" = _6FvHkuDJ;
        "pkg-1.2.2+1.21-forge" = _at8fI1Cx;
        "pkg-1.2.2+1.21-neoforge" = _UfD1kuKk;
        "pkg-1.2.3+1.21-fabric" = _xiEDsnqQ;
        "pkg-1.2.3+1.21-neoforge" = _soE26ira;
        "pkg-1.2.6+1.21-fabric" = _isCFMNGm;
        "pkg-1.2.6+1.21-forge" = _b5VQKTTP;
        "pkg-1.2.6+1.21-neoforge" = _Dy9YzMK8;
        "pkg-1.2.7+1.21-fabric" = _dJFkp453;
        "pkg-1.2.7+1.21-forge" = _JE4ayw8x;
        "pkg-1.2.7+1.21-neoforge" = _4QaA9WIh;
        "pkg-2.0.0+1.21-fabric" = _XvrCfkqg;
        "pkg-2.0.0+1.21-forge" = _kE252DWt;
        "pkg-2.0.0+1.21-neoforge" = _naIqgVbk;
        "pkg-2.2.0-alpha.1+1.21-fabric" = _SgMX6GMD;
        "pkg-2.2.0-alpha.1+1.21-neoforge" = _ovV3lwch;
        "pkg-2.2.0+1.21-fabric" = _mDBhD20B;
        "pkg-2.2.0+1.21.9-forge" = _muQjqrHb;
        "pkg-2.2.0+1.21.9-neoforge" = _CqS6zrjj;
        "pkg-2.2.1+1.21.9-fabric" = _BjaHn4cH;
        "pkg-2.2.1+1.21.9-forge" = _2rVv1vN8;
        "pkg-2.2.1+1.21.9-neoforge" = _g4kyFEeq;
        "pkg-2.2.0+1.21-forge" = _osQOLwYC;
        "pkg-2.2.0+1.21-neo" = _Ryi6I0ge;
        "pkg-2.2.3+1.21.9-fabric" = _nVt8Yr29;
        "pkg-2.2.3+1.21.9-forge" = _82QRMD4v;
        "pkg-2.2.3+1.21.9-neoforge" = _p3u89Ax9;
        "pkg-2.2.3+26.1-universal" = _mqni9LR2;
        "pkg-2.2.4+26.1-universal" = _ZwBI1rXD;
        "pkg-2.2.5+26.1-universal" = _vX0QiUmI;
        "pkg-3.0.0-alpha.1+1.20.1-fabric" = _pYtZAf4i;
        "pkg-3.0.0-alpha.1+1.20.1-forge" = _9noFSxJU;
        "pkg-3.0.0-alpha.1+1.21.1-fabric" = _47T0NDea;
        "pkg-3.0.0-alpha.1+1.21.1-forge" = _jOb7CRC4;
        "pkg-3.0.0-alpha.1+1.21.1-neoforge" = _FmgfjZ4m;
        "pkg-3.0.0-alpha.1+1.21.11-fabric" = _wHP1QCwv;
        "pkg-3.0.0-alpha.1+1.21.11-forge" = _9Fv62Rpt;
        "pkg-3.0.0-alpha.1+1.21.11-neoforge" = _AuGGmmqq;
        "pkg-3.0.0-alpha.1+26.2-fabric" = _bLnYengL;
        "pkg-3.0.0-alpha.1+26.2-forge" = _5Y5ckhZB;
        "pkg-3.0.0-alpha.1+26.2-neoforge" = _ku5h0UkZ;
        "pkg-3.0.0-beta.1+1.20.1-fabric" = _YJPzpAjS;
        "pkg-3.0.0-beta.1+1.20.1-forge" = _qtP17iZM;
        "pkg-3.0.0-beta.1+1.21.1-fabric" = _u5ILA7VT;
        "pkg-3.0.0-beta.1+1.21.1-forge" = _3ofImxur;
        "pkg-3.0.0-beta.1+1.21.1-neoforge" = _TsSO6lhc;
        "pkg-3.0.0-beta.1+1.21.11-fabric" = _qk17x9Lc;
        "pkg-3.0.0-beta.1+1.21.11-forge" = _I5G5xWab;
        "pkg-3.0.0-beta.1+1.21.11-neoforge" = _q6D2nZdL;
        "pkg-3.0.0-beta.1+26.2-fabric" = _emlieIG4;
        "pkg-3.0.0-beta.1+26.2-forge" = _NiPQryVP;
        "pkg-3.0.0-beta.1+26.2-neoforge" = _hjdyUv8y;
        "pkg-3.0.0-beta.4+1.20.1-fabric" = _OL8Gnh8M;
        "pkg-3.0.0-beta.4+1.20.1-forge" = _d3vVxBNe;
        "pkg-3.0.0-beta.4+1.21.1-fabric" = _hvucXNzi;
        "pkg-3.0.0-beta.4+1.21.1-forge" = _5qI4NnO5;
        "pkg-3.0.0-beta.4+1.21.1-neoforge" = _Kx0m1OXB;
        "pkg-3.0.0-beta.4+1.21.11-fabric" = _4nAWLWcm;
        "pkg-3.0.0-beta.4+1.21.11-forge" = _2T5X0JJX;
        "pkg-3.0.0-beta.4+1.21.11-neoforge" = _HGHSpstY;
        "pkg-3.0.0-beta.4+26.2-fabric" = _HEKc9CXq;
        "pkg-3.0.0-beta.4+26.2-forge" = _B2Cb3CoB;
        "pkg-3.0.0-beta.4+26.2-neoforge" = _emIPLw4k;
        "pkg-3.0.0-beta.5+1.20.1-fabric" = _NrGWMDir;
        "pkg-3.0.0-beta.5+1.20.1-forge" = _2yreNcO0;
        "pkg-3.0.0-beta.5+1.21.1-fabric" = _frF82LrK;
        "pkg-3.0.0-beta.5+1.21.1-forge" = _Ye8RIBo9;
        "pkg-3.0.0-beta.5+1.21.1-neoforge" = _UshJ37Wu;
        "pkg-3.0.0-beta.5+1.21.11-fabric" = _pRRWtN4P;
        "pkg-3.0.0-beta.5+1.21.11-forge" = _E4CeqcaI;
        "pkg-3.0.0-beta.5+1.21.11-neoforge" = _92988ijh;
        "pkg-3.0.0-beta.5+26.2-fabric" = _w8lPbKAZ;
        "pkg-3.0.0-beta.5+26.2-forge" = _dmm01kDr;
        "pkg-3.0.0-beta.5+26.2-neoforge" = _JkbZbwIT;
        "pkg-3.0.0-beta.8+1.20.1-fabric" = _HdEISUFM;
        "pkg-3.0.0-beta.8+1.20.1-forge" = _auxgZKqF;
        "pkg-3.0.0-beta.8+1.21.1-fabric" = _SfsWwgwF;
        "pkg-3.0.0-beta.8+1.21.1-forge" = _EJpWW8cm;
        "pkg-3.0.0-beta.8+1.21.1-neoforge" = _zGCrchLW;
        "pkg-3.0.0-beta.8+1.21.11-fabric" = _3Fo8RcuY;
        "pkg-3.0.0-beta.8+1.21.11-forge" = _mKPimZzW;
        "pkg-3.0.0-beta.8+1.21.11-neoforge" = _3KoRWQ8O;
        "pkg-3.0.0-beta.8+26.2-fabric" = _pYpSSzGY;
        "pkg-3.0.0-beta.8+26.2-forge" = _bGNUcNpA;
        "pkg-3.0.0-beta.8+26.2-neoforge" = _rUEu8PMW;
        "pkg-3.0.0-rc.1+1.20.1-fabric" = _XN8ZLcWf;
        "pkg-3.0.0-rc.1+1.20.1-forge" = _wNgeTiLy;
        "pkg-3.0.0-rc.1+1.21.1-fabric" = _lxS7IBGf;
        "pkg-3.0.0-rc.1+1.21.1-forge" = _wHzMuDtM;
        "pkg-3.0.0-rc.1+1.21.1-neoforge" = _FuzVTuKK;
        "pkg-3.0.0-rc.1+1.21.11-fabric" = _fz3W6vPy;
        "pkg-3.0.0-rc.1+1.21.11-forge" = _TSYcDAia;
        "pkg-3.0.0-rc.1+1.21.11-neoforge" = _rlLioQUo;
        "pkg-3.0.0-rc.1+26.2-fabric" = _UzcsrnHd;
        "pkg-3.0.0-rc.1+26.2-forge" = _JPDIb1rp;
        "pkg-3.0.0-rc.1+26.2-neoforge" = _w0oOPSza;
        "default" = _w0oOPSza;
    });
