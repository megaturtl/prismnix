...
let
    ...
    in {
        ...
        "pkg-1.1.1" = _xKV8JiBJ;
        "pkg-1.1.7" = _INdAdxKL;
        "pkg-v1.1.9+1.21.11" = _X3AyZj4K;
        "pkg-v1.2.0-beta+1.21.11" = _FTXPV5AS;
        "pkg-v1.2.0+1.21.11" = _dbE32DNb;
        "pkg-v1.2.5-beta+1.21.11" = _sEjfdnbs;
        "pkg-v1.2.5+1.21.11" = _c7BSRHlV;
        "pkg-v1.2.5+1.21.1" = _g1zhiLWR;
