...
let
    ...
    in {
        ...
        "pkg-1.3.8" = _LMCsp1do;
        "pkg-1.3.9" = _vdBpcH9E;
        "pkg-1.3.10" = _N58QszRX;
        "pkg-1.4.0" = _STwd8Bla;
        "pkg-1.4.1" = _IM4563Ei;
        "pkg-1.4.2" = _4DuBbTzI;
        "pkg-1.4.3" = _FFzLsW9B;
        "pkg-1.4.3.1" = _zNS8a9P5;
        "pkg-1.4.4" = _lxN1fKeI;
        "pkg-1.4.5" = _yO7gN2xN;
        "pkg-1.5.0" = _X4Fj7oAc;
        "pkg-1.3.11" = _WGA5JUXC;
        "pkg-1.5.1" = _may7s1yt;
        "pkg-1.5.1.1" = _t0XUC9mj;
        "pkg-1.5.2" = _ZGbJfj18;
        "pkg-1.5.2.1" = _ZhLXN1Pt;
        "pkg-1.5.3" = _XueNZji5;
        "pkg-1.5.4" = _fsDXmcO8;
        "pkg-1.3.12" = _aQ2gMURJ;
        "pkg-1.3.13" = _Zt0dAOba;
        "pkg-1.5.5" = _HiNxB1HM;
        "pkg-1.3.14" = _s8CK8qoR;
        "pkg-1.5.6" = _fUjQPlXV;
        "pkg-1.5.7" = _Dgz8KJlM;
        "pkg-1.5.8" = _ONkLHZGB;
        "pkg-1.6.0" = _CcOch62I;
        ...
        "pkg-1.7.1" = _O0wsW4so;
        "pkg-1.7.2" = _OSOGeOnH;
        "pkg-1.3.15" = _Z11QwqVo;
        "pkg-1.7.3" = _OILNS3Hf;
        "pkg-1.5.10" = _jLaASGOx;
        "pkg-1.5.11" = _iO4xnVoY;
        "pkg-1.3.16" = _XcbCnLW5;
