...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _B7JKgNAp;
        "pkg-1.0.9" = _NVTNkhIV;
        "pkg-1.0.10" = _gmI6MvdI;
        "pkg-1.0.11" = _AyPrkblM;
        "pkg-1.0.12" = _zv6s1nYx;
        "pkg-1.0.13" = _651AyuCp;
        "pkg-1.0.14" = _RxxPTEJd;
        "pkg-1.0.15" = _BBedOJhE;
        "pkg-1.0.16" = _eGTCsUCJ;
        "pkg-1.0.17" = _7j5T8hyQ;
        "pkg-1.0.18" = _Om23VGSR;
        "pkg-1.0.19" = _8ZNo9OSy;
        "pkg-1.0.20" = _6t7uyZvq;
