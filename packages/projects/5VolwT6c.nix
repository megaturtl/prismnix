...
let
    versions = (let
        ...
        _PBAqNQRi = {
            "id" = "PBAqNQRi";
            "file" = "reliable-recipe-viewer-8.10.4+1.21.11-fabric.jar";
            "hash" = "sha512-z8JrZXKLUpwZtLqQnEc1jXMusOxij+DcaeVLYL1DASgd1E0rNxtXQXOXY9BQnpycQzsdL2kxOA56wYGOcZvVOg==";
        };
        _VAcMdGOf = {
            "id" = "VAcMdGOf";
            "file" = "reliable-recipe-viewer-8.10.4+1.21.11-neoforge.jar";
            "hash" = "sha512-jQa65xh1N5bhorE4jpT5T3s3vnq5rPMi6DYGkMpiDUDuabz1icExKM6QdDqeYCH3ygHKhs68tY8MbnDQHMf4DQ==";
        };
        _Pwofj04I = {
            "id" = "Pwofj04I";
            "file" = "reliable-recipe-viewer-8.10.4+26.1.2-fabric.jar";
            "hash" = "sha512-P2AJJFtDnW/+QAAjV7bOo4j0BSp1w+3jKIpJ4txrHpIYJag+bP4Uq4z6bjiDAaG5P8VS7Sgs639gWK+ItQfDSQ==";
        };
        _jKHPlaX1 = {
            "id" = "jKHPlaX1";
            "file" = "reliable-recipe-viewer-8.10.4+26.1.2-neoforge.jar";
            "hash" = "sha512-OA18w1ZmIQinZX0Eyq4T/6RHbCcdRsE3UHgrQ9exihgdk1tsM33N0jx5ZznvOcL8fsJjHJmfxEVX6jQrFfJJVQ==";
        };
        _BV2HIAQl = {
            "id" = "BV2HIAQl";
            "file" = "reliable-recipe-viewer-8.10.4+26.2-fabric.jar";
            "hash" = "sha512-fa2t2rEFh8TKKBcL1AxF/Yby6/vXypRgtju+cJCfp1yWlpTEQ1JuxycIV0Yd5ecJniohLuzcSrFCsCAF2733wA==";
        };
        _rEkIjh0E = {
            "id" = "rEkIjh0E";
            "file" = "reliable-recipe-viewer-8.10.4+26.2-neoforge.jar";
            "hash" = "sha512-PrAXRVABWmSxfWo8lj69gdGhP9G9GeB0YLo+9vohy2flaXNAoOtWhC57DwyNVXFsxEyowznZzF2lPahSmkhm6w==";
        };
        _dR0Zd6iZ = {
            "id" = "dR0Zd6iZ";
            "file" = "reliable-recipe-viewer-8.10.4+26.3-pre-1-fabric.jar";
            "hash" = "sha512-v7Oj10Pr+NeSto60VX6H90l5avAMDCJN9ly1HzzlgET2rHxyNFvQHvSg/x/Z87QDjosunD1c5qIsulYAs8pLaA==";
        };
        _R5Pf57dt = {
            "id" = "R5Pf57dt";
            "file" = "reliable-recipe-viewer-8.10.5+1.21.11-fabric.jar";
            "hash" = "sha512-gVCu7TKwd0cMWFc2XY0cVEt2J4FB1OxY3nQ5xN9yLcdk1YeET3tKaIgBES2IlLn7+431kPiCo+Orfyc9RCjGUQ==";
        };
        _Q7erL8am = {
            "id" = "Q7erL8am";
            "file" = "reliable-recipe-viewer-8.10.5+1.21.11-neoforge.jar";
            "hash" = "sha512-RzyxcxVaut6+KiTyc+tCQRtlo2CfkNIpfxQzALBBaNYpmWI4vDhYSphjQ1sPFlzaLqtIGQoYRiI3NFmoO8dI1w==";
        };
        _2rq6nLtV = {
            "id" = "2rq6nLtV";
            "file" = "reliable-recipe-viewer-8.10.5+26.1.2-fabric.jar";
            "hash" = "sha512-MTuFpYxunVI6BP35/opWEm7aTbsb0Q2fkk9qL8FGbBai4a3fmWHssdl4IqfbPWIKi/7R7Aopuuj/n040ktl3uA==";
        };
        _DAkmgOL2 = {
            "id" = "DAkmgOL2";
            "file" = "reliable-recipe-viewer-8.10.5+26.1.2-neoforge.jar";
            "hash" = "sha512-5Y1W52EeEdcISRIkmMKkA8ZCQQ3oymTIFO6vGHFjRORkcBoazyeDOTv+81AUZUcN3cuaNBpk9iKdPN3QVAMwOA==";
        };
        _oNWwPKuf = {
            "id" = "oNWwPKuf";
            "file" = "reliable-recipe-viewer-8.10.5+26.2-fabric.jar";
            "hash" = "sha512-IcHtaL+PxZAdniqo9j3DK9RaPzUDQMjlqsrGl3XArlKMpuRC1vDJxxkpUyJCekn5Ylt1NJzRicnBvjIibkX3Gg==";
        };
        _dvt5LYjy = {
            "id" = "dvt5LYjy";
            "file" = "reliable-recipe-viewer-8.10.5+26.2-neoforge.jar";
            "hash" = "sha512-hN+1/wrtXeJ+hT3FaV42xFbagpUBmZZ1GKsNOS5LIc4k4P8UzicHlviOxp6sqTRzUIU1F/li1rL0VfV9XgtqqQ==";
        };
        _zTzUSzvz = {
            "id" = "zTzUSzvz";
            "file" = "reliable-recipe-viewer-8.10.5+26.3-fabric.jar";
            "hash" = "sha512-X7KAjU7Z6EgesylvBXWHb3zmkRMPtm0bmIJs5UZG405LVBW8QYUf4bnprP6vrGVsTQ5TnuWb2FEeQLoR3H1b3Q==";
        };
        _28VhV3VX = {
            "id" = "28VhV3VX";
    ...
    in {
        ...
        "fabric-26.3-pre-1" = _dR0Zd6iZ;
        "fabric-26.3-pre-2" = _dR0Zd6iZ;
        "fabric-26.3-pre-3" = _dR0Zd6iZ;
        ...
        "pkg-6.2.1+1.21.8-neoforge" = _9Br7ijn7;
        "pkg-6.2.1+1.21.10-fabric" = _fdGSts9t;
        "pkg-6.2.1+1.21.11-fabric" = _kAHSlKlc;
        "pkg-6.2.1+1.21.11-neoforge" = _OoYwIyyq;
        "pkg-6.2.1+26.1-snapshot-2-fabric" = _CeFjUCPT;
        "pkg-6.2.1+26.1-snapshot-2-neoforge" = _LYGBfW7P;
        "pkg-6.3.0+1.21.8-fabric" = _24PBFZOy;
        "pkg-6.3.0+1.21.8-neoforge" = _xdtB1DeE;
        "pkg-6.3.0+1.21.11-fabric" = _paJ2Qy2j;
        "pkg-6.3.0+1.21.11-neoforge" = _F9HRLVZr;
        "pkg-6.3.0+26.1-snapshot-3-fabric" = _5rGts6Yf;
        "pkg-6.3.1+1.21.11-fabric" = _7XLltURK;
        "pkg-6.3.1+1.21.11-neoforge" = _cgjVMQV4;
        "pkg-6.3.1+26.1-snapshot-3-fabric" = _6nB9lACN;
        "pkg-6.3.1+26.1-snapshot-3-neoforge" = _zKUDEvH2;
        "pkg-6.3.2+1.21.8-fabric" = _Pj2v6AG9;
        "pkg-6.3.2+1.21.8-neoforge" = _QP1wPj7m;
        "pkg-6.3.2+1.21.11-fabric" = _7rYQtn8r;
        "pkg-6.3.2+1.21.11-neoforge" = _6pT5bq1V;
        "pkg-6.3.2+26.1-snapshot-4-fabric" = _hb9LFTYO;
        "pkg-6.3.2+26.1-snapshot-4-neoforge" = _Z22YQV8a;
        "pkg-6.3.3+1.21.8-fabric" = _iY1ZtJdv;
        "pkg-6.3.3+1.21.8-neoforge" = _yXTULYOs;
        "pkg-6.3.3+1.21.11-fabric" = _g4oZScWS;
        "pkg-6.3.3+1.21.11-neoforge" = _s7drKCoX;
        "pkg-6.3.3+26.1-snapshot-5-fabric" = _7anAQpDj;
        "pkg-6.3.3+26.1-snapshot-4-neoforge" = _VzNPeVCQ;
        "pkg-6.4.0+1.21.8-fabric" = _3hlMHA5r;
        "pkg-6.4.0+1.21.8-neoforge" = _1NbARqmL;
        "pkg-6.4.0+1.21.11-fabric" = _1XacUBAw;
        "pkg-6.4.0+1.21.11-neoforge" = _4TauEGUc;
        "pkg-6.4.0+26.1-snapshot-7-fabric" = _8J56judg;
        "pkg-6.4.0+26.1-snapshot-6-neoforge" = _ahADJZkX;
        "pkg-6.4.1+1.21.8-fabric" = _uzlSFHAP;
        "pkg-6.4.1+1.21.8-neoforge" = _tkfBy5fj;
        "pkg-6.4.1+1.21.11-fabric" = _LB107dbS;
        "pkg-6.4.1+1.21.11-neoforge" = _n8jKAb9Q;
        "pkg-6.4.1+26.1-snapshot-8-fabric" = _NSPy30MP;
        "pkg-6.4.1+26.1-snapshot-6-neoforge" = _3xOhiucq;
        "pkg-6.4.1+26.1-snapshot-7-neoforge" = _AEtB9kKc;
        "pkg-6.4.2+1.21.8-fabric" = _FgGLTUpN;
        "pkg-6.4.2+1.21.8-neoforge" = _kNwfhFNL;
        "pkg-6.4.2+1.21.11-fabric" = _2nOijQ8b;
        "pkg-6.4.2+1.21.11-neoforge" = _yfy6FCsX;
        "pkg-6.4.2+26.1-snapshot-9-fabric" = _yAhFuyJf;
        "pkg-6.4.2+26.1-snapshot-7-neoforge" = _8bOyOHne;
        "pkg-6.4.3+1.21.11-fabric" = _nzM6cumf;
        "pkg-6.4.3+1.21.11-neoforge" = _tpEcZuNH;
        "pkg-6.4.3+26.1-snapshot-9-fabric" = _OOZUT0fG;
        "pkg-6.4.3+26.1-snapshot-7-neoforge" = _hpRawFL9;
        "pkg-6.4.3+26.1-snapshot-10-fabric" = _briPanKd;
        "pkg-6.5.0+1.21.8-fabric" = _bgh6TfiW;
        "pkg-6.5.0+1.21.8-neoforge" = _vF0S7fMe;
        "pkg-6.5.0+1.21.10-fabric" = _OHuBSEvi;
        "pkg-6.5.0+1.21.11-fabric" = _nx56FIL6;
        "pkg-6.5.0+1.21.11-neoforge" = _g2nZweh0;
        "pkg-6.5.0+26.1-snapshot-10-fabric" = _3B8IhPpq;
        "pkg-6.6.0+25w14craftmine-fabric" = _JruB9am9;
        "pkg-6.6.0+1.21.8-fabric" = _gQBCEKAs;
        "pkg-6.6.0+1.21.8-neoforge" = _lQWcvEeO;
        "pkg-6.6.0+1.21.10-fabric" = _b7KwnsPA;
        "pkg-6.6.0+1.21.11-fabric" = _sNSydpjC;
        "pkg-6.6.0+1.21.11-neoforge" = _ofnTGKmD;
        "pkg-6.6.0+26.1-snapshot-11-fabric" = _VcW9qfyh;
        "pkg-6.6.1+25w14craftmine-fabric" = _3cTmHQOk;
        "pkg-6.6.1+1.21.8-fabric" = _Wqmrljtc;
        "pkg-6.6.1+1.21.8-neoforge" = _JHGrW5Ih;
        "pkg-6.6.1+1.21.10-fabric" = _NKkFo9qO;
        "pkg-6.6.1+1.21.11-fabric" = _fLH9Pcef;
        "pkg-6.6.1+1.21.11-neoforge" = _oyHTgDHb;
        "pkg-6.6.1+26.1-snapshot-11-fabric" = _V8M4hNEQ;
        "pkg-6.6.2+1.21.10-fabric" = _Y1ro4B4Y;
        "pkg-6.6.2+1.21.11-fabric" = _5rHKvHSm;
        "pkg-6.6.2+1.21.11-neoforge" = _cDkCpUhg;
        "pkg-6.6.2+26.1-snapshot-11-fabric" = _CUwgIEGq;
        "pkg-7.0.0+26.1-rc-3-fabric" = _DMJcw7o3;
        "pkg-7.0.0+26.1-pre-3-neoforge" = _cumLQ1iC;
        "pkg-7.0.0+26.1-fabric" = _VvHsr2qC;
        "pkg-7.0.0+26.1-neoforge" = _ciEYY3Dk;
        "pkg-7.0.2+26.1-fabric" = _SczyuzgF;
        "pkg-7.0.2+26.1-neoforge" = _D7TjBwLf;
        "pkg-7.0.3+26.1-fabric" = _q1jPOkVf;
        "pkg-7.0.3+26.1-neoforge" = _ZV5ZKt32;
        "pkg-7.0.4+26.1.1-fabric" = _yjdbvZBs;
        "pkg-7.0.4+26.1.1-neoforge" = _f2ASLLuG;
        "pkg-6.6.2+25w14craftmine" = _XTJHyrEj;
        "pkg-6.6.3+25w14craftmine" = _1HsWHdC7;
        "pkg-7.1.0+26.1.1-fabric" = _fFBI3yKi;
        "pkg-7.1.0+26.1.1-neoforge" = _TX3IVvcx;
        "pkg-7.1.0+26.2-snapshot-1-fabric" = _HiMJuiB9;
        "pkg-7.1.1+26.1.1-fabric" = _5GbeFI9Q;
        "pkg-7.1.1+26.1.1-neoforge" = _kMDUPdrr;
        "pkg-7.1.1+26.2-snapshot-1-fabric" = _uozebEO7;
        "pkg-7.1.2+26.1.1-fabric" = _T6u6SuRU;
        "pkg-7.1.2+26.1.1-neoforge" = _qVi9vzCZ;
        "pkg-7.1.2+26.2-snapshot-1-fabric" = _SvS68rT6;
        "pkg-7.1.3+26.1.1-fabric" = _80z4ddVz;
        "pkg-7.1.3+26.1.1-neoforge" = _tu1hFG1m;
        "pkg-7.1.3+26.2-snapshot-1-fabric" = _DVuhC10H;
        "pkg-7.1.4+26.1.1-fabric" = _Rv0Ax2cS;
        "pkg-7.1.4+26.1.1-neoforge" = _MW11VTle;
        "pkg-7.1.4+26.2-snapshot-1-fabric" = _U44sue6F;
        "pkg-8.0.0+26.1.2-fabric" = _CPkMnbhR;
        "pkg-8.0.0+26.1.2-neoforge" = _3j0Y4RJk;
        "pkg-8.0.0+26.2-snapshot-4-fabric" = _r6MRWMr7;
        "pkg-8.0.1+26.1.2-fabric" = _Za40B2SW;
        "pkg-8.0.1+26.1.2-neoforge" = _flZcVu6e;
        "pkg-8.0.1+26.2-snapshot-5-fabric" = _G6HjJASh;
        "pkg-8.0.2+26.1.2-fabric" = _t13IKSZc;
        "pkg-8.0.2+26.1.2-neoforge" = _pBZp6ZrM;
        "pkg-8.0.2+26.2-snapshot-5-fabric" = _vtzfl43N;
        "pkg-8.0.3+26.1.2-fabric" = _310GVx5t;
        "pkg-8.0.3+26.1.2-neoforge" = _P24UGCcD;
        "pkg-8.0.3+26.2-snapshot-5-fabric" = _bNdeX81i;
        "pkg-8.1.0+26.1.2-fabric" = _WbwOYfhW;
        "pkg-8.1.0+26.1.2-neoforge" = _rmvbnGUw;
        "pkg-8.1.0+26.2-snapshot-5-fabric" = _JXHTY655;
        "pkg-8.1.1+26.1.2-fabric" = _EnfHZppz;
        "pkg-8.1.1+26.1.2-neoforge" = _QFOuweld;
        "pkg-8.1.1+26.2-snapshot-5-fabric" = _QCJ7fiCx;
        "pkg-8.1.2+26.1.2-fabric" = _xcC7REOy;
        "pkg-8.1.2+26.1.2-neoforge" = _UO88VvJi;
        "pkg-8.1.2+26.2-snapshot-5-fabric" = _uTekJ2vt;
        "pkg-8.1.3+26.1.2-fabric" = _YJHoLuXM;
        "pkg-8.1.3+26.1.2-neoforge" = _yai6vg44;
        "pkg-8.1.3+26.2-snapshot-5-fabric" = _HovGDpMt;
        "pkg-8.2.0+26.1.2-fabric" = _SqqQg8SJ;
        "pkg-8.2.0+26.1.2-neoforge" = _bBlMXrLI;
        "pkg-8.2.0+26.2-snapshot-7-fabric" = _AvJ4aD82;
        "pkg-8.2.1+26.1.2-fabric" = _W8HsLDkL;
        "pkg-8.2.1+26.1.2-neoforge" = _3qvizumN;
        "pkg-8.2.1+26.2-pre-2-fabric" = _G58IcELW;
        "pkg-8.3.0+26.1.2-fabric" = _4YCGS6bK;
        "pkg-8.3.0+26.1.2-neoforge" = _x0msx4a6;
        "pkg-8.3.0+26.2-pre-4-fabric" = _6e2wQ4pG;
        "pkg-8.3.1+26.1.2-fabric" = _I8qVbHEn;
        "pkg-8.3.1+26.1.2-neoforge" = _IYQO82qH;
        "pkg-8.3.1+26.2-pre-5-fabric" = _3GnOuVrl;
        "pkg-8.4.0+26.1.2-fabric" = _BVjYjU2u;
        "pkg-8.4.0+26.1.2-neoforge" = _nYH70lqj;
        "pkg-8.4.0+26.2-fabric" = _UncpoZEE;
        "pkg-8.4.0+26.2-neoforge" = _BxNY47cD;
        "pkg-8.4.0+26.3-snapshot-1-fabric" = _Hxu1OseP;
        "pkg-8.4.1+26.1.2-fabric" = _aR1LBJSr;
        "pkg-8.4.1+26.1.2-neoforge" = _sMYb7bmJ;
        "pkg-8.4.1+26.2-fabric" = _EUSwXKqW;
        "pkg-8.4.1+26.2-neoforge" = _ShsXW9VX;
        "pkg-8.4.1+26.3-snapshot-1-fabric" = _CFsrtm1P;
        "pkg-8.4.2+26.1.2-fabric" = _D9yYdoPt;
        "pkg-8.4.2+26.1.2-neoforge" = _bQyAjMws;
        "pkg-8.4.2+26.2-fabric" = _qOjkwQ0a;
        "pkg-8.4.2+26.2-neoforge" = _6kBHJKio;
        "pkg-8.4.2+26.3-snapshot-1-fabric" = _JpC5Rg2b;
        "pkg-8.4.2+26.3-snapshot-2-fabric" = _aq2M97P1;
        "pkg-8.5.0+26.1.2-fabric" = _8Xwd53bY;
        "pkg-8.5.0+26.1.2-neoforge" = _wfvJZapV;
        "pkg-8.5.0+26.2-fabric" = _nBeYFCA0;
        "pkg-8.5.0+26.2-neoforge" = _IXbsy0wz;
        "pkg-8.5.0+26.3-snapshot-3-fabric" = _dtN0JXYs;
        "pkg-8.6.0+26.1.2-fabric" = _cHSUPqf6;
        "pkg-8.6.0+26.1.2-neoforge" = _Tm3ZMsql;
        "pkg-8.6.0+26.2-fabric" = _o3E6Rl0N;
        "pkg-8.6.0+26.2-neoforge" = _95Rv90bq;
        "pkg-8.6.0+26.3-snapshot-3-fabric" = _wuj7Tbe0;
        "pkg-8.6.1+26.1.2-fabric" = _j1ZwQKQU;
        "pkg-8.6.1+26.1.2-neoforge" = _RWOIiYXu;
        "pkg-8.6.1+26.2-fabric" = _iRXlHcvP;
        "pkg-8.6.1+26.2-neoforge" = _VGJzYn9c;
        "pkg-8.6.1+26.3-snapshot-3-fabric" = _ObIJl9kc;
        "pkg-8.6.2+26.1.2-fabric" = _NFTakiEM;
        "pkg-8.6.2+26.1.2-neoforge" = _41pW5ksW;
        "pkg-8.6.2+26.2-fabric" = _31nk77wF;
        "pkg-8.6.2+26.2-neoforge" = _NKQjROuz;
        "pkg-8.6.2+26.3-snapshot-3-fabric" = _1OSjkRj3;
        "pkg-8.6.3+26.1.2-fabric" = _g2FIL589;
        "pkg-8.6.3+26.1.2-neoforge" = _EMtcM8Op;
        "pkg-8.6.3+26.2-fabric" = _2tB40iL8;
        "pkg-8.6.3+26.2-neoforge" = _74ybvVaZ;
        "pkg-8.6.3+26.3-snapshot-3-fabric" = _PTGhoLTl;
        "pkg-8.6.4+26.1.2-fabric" = _bnkrJjDn;
        "pkg-8.6.4+26.1.2-neoforge" = _LGmqMyhR;
        ...
        "pkg-8.10.4+1.21.11-fabric" = _PBAqNQRi;
        "pkg-8.10.4+1.21.11-neoforge" = _VAcMdGOf;
        "pkg-8.10.4+26.1.2-fabric" = _Pwofj04I;
        "pkg-8.10.4+26.1.2-neoforge" = _jKHPlaX1;
        "pkg-8.10.4+26.2-fabric" = _BV2HIAQl;
        "pkg-8.10.4+26.2-neoforge" = _rEkIjh0E;
        "pkg-8.10.4+26.3-pre-1-fabric" = _dR0Zd6iZ;
        "pkg-8.10.5+1.21.11-fabric" = _R5Pf57dt;
        "pkg-8.10.5+1.21.11-neoforge" = _Q7erL8am;
        "pkg-8.10.5+26.1.2-fabric" = _2rq6nLtV;
        "pkg-8.10.5+26.1.2-neoforge" = _DAkmgOL2;
        "pkg-8.10.5+26.2-fabric" = _oNWwPKuf;
