...
let
    versions = (let
        ...
        _5BCpNfSr = {
            "id" = "5BCpNfSr";
            "file" = "veinminer-paper-2.12.0.jar";
            "hash" = "sha512-0vS2zfhwcSen5spbabCo57OblyURyoxcAoIaDrsVMnITZdbmR321JSD7tnBE18fxDfiHyU0afZD3Kv4b7ojWSQ==";
        };
        _NdMuTUZ7 = {
            "id" = "NdMuTUZ7";
            "file" = "veinminer-fabric-2.12.0.jar";
            "hash" = "sha512-+WbQ56s7U462Mt0M+9oZRInt1y9Qdc54gwHQAyVlfoNeld/9ZDvgblXAN08RrmjZGcecHSpOTuLs3rdPcyJO/w==";
        };
        _TdoBHcyB = {
            "id" = "TdoBHcyB";
            "file" = "veinminer-neoforge-2.12.0.jar";
            "hash" = "sha512-g4mynd5e8FeyN6r3/q6TnJWlmE4b2kk/CDUb+3sCYxmNWAncrR7LiaOxlV5P1prIBOC4ALe59nryYbs/Tv0mQw==";
        };
        _qztdh63o = {
            "id" = "qztdh63o";
            "file" = "veinminer-paper-2.12.1.jar";
            "hash" = "sha512-SzZ4Bntmr4EuNz8CJQiVIb6r3INVcXKP26/btAXpv/ch5ReogE8+gi4B+NgtUtRGe6izhCL8xaNX7MIbxc13dA==";
        };
        _InpIvPQ1 = {
            "id" = "InpIvPQ1";
            "file" = "veinminer-fabric-2.12.1.jar";
            "hash" = "sha512-3bIO6fBT4ojFkS3qmr/ipER3l+p35n+AOI/tc5Nbl6tRFmA3R85pn4v/ll4JZdEJlEbfH/kO49hSen/AF1hZdw==";
        };
        _bOPIAGfo = {
            "id" = "bOPIAGfo";
    ...
    in {
        ...
        "pkg-1.2.0" = _L1c7vUXc;
        "pkg-1.2.0+mod" = _zbvyFm1f;
        "pkg-1.2.0+plugin" = _KpfjqRyd;
        "pkg-1.2.1" = _qKU2WT6U;
        "pkg-1.2.1+mod" = _bHmDs51u;
        "pkg-2.0.0" = _VN4KhfyJ;
        "pkg-2.0.1" = _512jfu3Y;
        "pkg-2.0.2" = _tlozt8mH;
        "pkg-2.0.3" = _DCSFfJF9;
        "pkg-2.0.4" = _KTrObKTw;
        "pkg-2.0.5" = _aEIcjoEO;
        "pkg-2.0.5+mod" = _sW4G5QUE;
        "pkg-2.0.6" = _nxn7XLQe;
        "pkg-2.0.7+fabric" = _TiXmHQqU;
        "pkg-2.0.7" = _ZfbzlDz0;
        "pkg-2.0.7+1.20.1" = _PSctVdKm;
        "pkg-1.2.2+DP" = _d5goCfMd;
        "pkg-2.1.0+fabric" = _KTJOR6a7;
        "pkg-2.1.0" = _ZagGoo3r;
        "pkg-2.1.1+fabric" = _6SgR9oJl;
        "pkg-2.1.1" = _9yOjz8VV;
        "pkg-2.1.2" = _hLoq8S2U;
        "pkg-2.1.2+fabric" = _ANgXxQU1;
        "pkg-2.1.3+fabric" = _oiBotUcy;
        "pkg-2.1.3" = _Sogh3qHz;
        "pkg-2.1.4" = _kRnc41MB;
        "pkg-1.2.3" = _gDBf7TeG;
        "pkg-2.1.5" = _JTRAemaW;
        ...
        "pkg-2.9.1" = _BNYZn0FT;
        "pkg-2.9.2" = _PbWdSrpE;
        "pkg-2.10.0" = _gY6e4FFT;
        "pkg-2.10.1" = _zeUreJUo;
        "pkg-2.10.3" = _w8UcFzN6;
        "pkg-2.10.4" = _3YNFQWBt;
        "pkg-1.3.5" = _4klb3qNE;
