...
let
    versions = (let
        ...
        _INhNmhKm = {
            "id" = "INhNmhKm";
            "file" = "draftout-1.15.0.jar";
            "hash" = "sha512-2IG6baPpv+258I8lGicHW2LlRBKy9t2OeDo814ouvCcpEjPjq+JrdoZAt5Be/wsIRODL42DJGA5W9mu18dCpkg==";
        };
        _OUHPEOss = {
            "id" = "OUHPEOss";
            "file" = "draftout-1.15.1.jar";
            "hash" = "sha512-WJPoexeFpq9XuUS/Sfa2DX9TE6UBrot7+nhXxPsWsJqvIRc+zxzSNjCF1LCJxLkiEIEr5Bw/7aKw70PfJkNT/A==";
        };
        _7dQG329C = {
            "id" = "7dQG329C";
            "file" = "draftout-1.16.0.jar";
            "hash" = "sha512-4N92gu22eg9LfQGE8QynEw4j4VhlAHfnWfWFoU3EfCBVxML9rjPgw/UD6v77tmuukj6j5wWdeccMLLQj0KnnCw==";
        };
        _elEFtZSP = {
            "id" = "elEFtZSP";
    ...
    in {
        ...
        "pkg-1.9.2" = _ptul95OK;
        "pkg-1.9.3" = _2b1a4yW5;
        "pkg-1.10.0" = _XozT2ffD;
        "pkg-1.10.1" = _8r7yBEci;
        "pkg-1.10.2" = _tcQ4XTcz;
        "pkg-1.10.3" = _o3vkF5j0;
        "pkg-1.11.0" = _ecSTYs69;
        "pkg-1.11.1" = _lFayxEQC;
        "pkg-1.12.0" = _9QuMMt17;
        "pkg-1.12.1" = _5Z4MPZC2;
        "pkg-1.13.0" = _8MTt0PhR;
        "pkg-1.13.1" = _w3kFYlxY;
        "pkg-1.14.0" = _KscVf6Ib;
        "pkg-1.15.0" = _INhNmhKm;
