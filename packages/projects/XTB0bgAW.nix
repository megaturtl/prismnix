...
let
    ...
    in {
        ...
        "pkg-0.16.4" = _NdU5labl;
        "pkg-0.16.5" = _qiTeHg4V;
        "pkg-0.16.7" = _XCWDwbJ2;
        "pkg-0.17.0" = _Dq6yhrgh;
        "pkg-1.0.0" = _eXnW3EM6;
        "pkg-1.0.1" = _woG2LIyE;
        "pkg-1.1.0" = _ejZ5Redk;
        "pkg-1.2.1" = _kwFwOWej;
        ...
        "pkg-1.3.2" = _IX4K5Iwq;
        "pkg-1.3.3" = _MP7cQhft;
        "pkg-1.3.4+1.21.9" = _9Hk5cCSH;
        "pkg-1.3.4+1.21.10" = _jZTg5pCd;
        "pkg-1.3.4+1.21.11" = _RdkBeP84;
        "pkg-2.0.0" = _NAd77xyP;
        "pkg-2.0.1" = _VpVk5fPM;
        "pkg-2.0.2" = _KhM1GLQN;
        "pkg-2.1.0" = _pRji0VKY;
        "pkg-2.1.1" = _uue2ayyA;
        "pkg-2.1.2+1.21.10" = _IgoDqrz5;
        "pkg-2.1.2+1.21.11" = _KoP0KdOW;
        "pkg-2.1.3+1.21.10" = _1mQrclb5;
        "pkg-2.1.3+1.21.11" = _zigxJSHS;
        "pkg-2.2.0+26.1" = _FLbsrzI3;
        "pkg-2.2.1+26.1" = _PiGgkGzG;
        "pkg-2.2.1+1.21.10" = _GME3taIy;
        "pkg-2.2.1+1.21.11" = _4PmDGzVb;
        "pkg-2.3.0+1.21.10" = _Ao4Xj1RV;
        "pkg-2.3.0+1.21.11" = _OlSgx9CB;
        "pkg-2.3.1+1.21.10" = _bnRWSeyO;
        "pkg-2.3.1+1.21.11" = _OqBkowVe;
        "pkg-2.3.2+1.21.10" = _CPovQEuQ;
        "pkg-2.3.2+1.21.11" = _HNXjjGW5;
        "pkg-2.3.2+26.1" = _5FOJzLxN;
        "pkg-2.3.2+26.1.1" = _UMEiC5Di;
        "pkg-2.3.2+26.1.2" = _zMaOQrxh;
        "pkg-2.3.3+26.1.2" = _fgwOovL0;
        "pkg-2.3.3+1.21.10" = _bykr7KWd;
        "pkg-2.3.3+1.21.11" = _qE7XV3Y8;
        "pkg-2.3.4+1.21.10" = _6HJGagPX;
        "pkg-2.3.4+1.21.11" = _Eq7ckLZz;
        "pkg-2.3.4+26.1.2" = _E6kfjzk5;
        "pkg-2.4.0+1.21.10" = _kc2UT58j;
        "pkg-2.4.0+1.21.11" = _367JibM8;
        "pkg-2.4.0+26.1.2" = _77CIppi5;
        "pkg-2.4.1+1.21.10" = _NvbzEy6l;
        "pkg-2.4.1+1.21.11" = _wRL2TnCm;
        "pkg-2.4.1+26.1.2" = _ORtAVUHD;
        "pkg-2.4.2+1.21.10" = _novOnXGp;
        "pkg-2.4.2+1.21.11" = _6lK8XMeE;
        "pkg-2.4.2+26.1.2" = _KjZUugYx;
        "pkg-2.4.3+1.21.10" = _dSKeTMsA;
        "pkg-2.4.3+1.21.11" = _iTUn2dud;
        "pkg-2.4.3+26.1.2" = _AhCuX8Y6;
        "pkg-2.5.0+26.1.2" = _LUgVC2fo;
        "pkg-2.5.1+26.1.2" = _qBhUQ5LG;
