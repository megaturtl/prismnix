...
let
    ...
    in {
        ...
        "pkg-1.1" = _9YvwShyR;
        "pkg-1.1.1+mod" = _MfOchnik;
        "pkg-1.2" = _vN6Wq0QF;
        "pkg-1.2.1+mod" = _modJn4AL;
        "pkg-1.3" = _x9YVA5Pv;
        "pkg-1.3.1+mod" = _MZRKiBq1;
        "pkg-1.4" = _Q7mTRDZS;
        "pkg-1.4.1+mod" = _jMcKheYS;
        "pkg-1.5" = _MbfpKqwZ;
        "pkg-1.5.1+mod" = _2aVKNB5L;
        "pkg-1.6" = _xwWlV7F7;
        "pkg-1.6.1+mod" = _EFGaCua2;
        "pkg-1.7" = _wTNveiVb;
        "pkg-1.7.1+mod" = _TVnhv1EW;
        "pkg-1.8" = _o8foHm9I;
        "pkg-1.8.1+mod" = _AzxLQr1H;
        "pkg-1.9" = _Qq750iHh;
