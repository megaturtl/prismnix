...
let
    versions = (let
        ...
        _9ERMwgnZ = {
            "id" = "9ERMwgnZ";
            "file" = "IntegratedCrafting-1.20.1-1.4.7.jar";
            "hash" = "sha512-QY3hupb7dFTqwBAYwYWCEmwz8giydzM7dcNkQQwuy79i8fbOttQEfmWsTGS1Xojmg4YHg10JISh2a52HZFa2Tg==";
        };
        _LSQdklg6 = {
            "id" = "LSQdklg6";
            "file" = "integratedcrafting-26.2-neoforge-1.4.7-614.jar";
            "hash" = "sha512-+A6uFUx4J0pQAYo/w1/RVLKpw2xtvPXsk7+jp9McE8JwzP3D/g0JKQi9wOUVFQIqCM3eQaPures9foITbqPIEw==";
        };
        _J3Xqccvk = {
            "id" = "J3Xqccvk";
            "file" = "integratedcrafting-26.1.2-neoforge-1.4.8.jar";
            "hash" = "sha512-r4YjiOAHUc73/OrUUONh6bgZCxBJinYmvvPxVIN9ZZapzC7iNThcx9aEyuDETggUVbtf1x+dJS8cuHK5OzwKUg==";
        };
        _UfIUAffF = {
            "id" = "UfIUAffF";
            "file" = "integratedcrafting-1.21.1-neoforge-1.4.7.jar";
            "hash" = "sha512-kcUr3KxIWLU4BOjuSOqKo0QHgxrUz1sc8vmPKW2fMU5DPbLaM1TeSGmjG0VYlKlC0tVRxp243DWF5whJHFqhig==";
        };
        _g3OaBULn = {
            "id" = "g3OaBULn";
            "file" = "integratedcrafting-1.21.1-neoforge-1.4.7-615.jar";
            "hash" = "sha512-ssDiRqbIOsl8A93DY7FBPzkhg9dOjDTP1WSMsqQe99OdLk5uLH/rgwLvtk6MM7fp3fqmqEVDXVX29gBc1IwdJg==";
        };
        _vaw8Y2wl = {
            "id" = "vaw8Y2wl";
            "file" = "integratedcrafting-26.1.2-neoforge-1.4.8-616.jar";
            "hash" = "sha512-iY49Bm2F9BHdtrNF28fwSllU8ZK10+LHpFoHzNxY4ikTy2xVy1oa9zwTfhlI7dzVJnvyb33e3nFbqf8OuwCMdA==";
        };
        _VBG4Utnl = {
            "id" = "VBG4Utnl";
            "file" = "integratedcrafting-26.2-neoforge-1.4.7-617.jar";
            "hash" = "sha512-6FGX7reKyO/QKZ710lchMorGhimaSCol2rGLvEUVnjjZDDK8dh/2wtCDCuizD16xfKKdFNOH55oB0CbmIjTH+w==";
        };
        _QZB2FfHI = {
            "id" = "QZB2FfHI";
            "file" = "integratedcrafting-1.21.1-neoforge-1.4.7-619.jar";
            "hash" = "sha512-nhx7QXadVaCnNjqEUJbMVw7bYWPriFtcYAYxxNTUw3b4Wj2Pb7cE62ZMvViIfLSlzj35JdkiEtkBV3XeI3F7aw==";
        };
        _8T06nV1Z = {
            "id" = "8T06nV1Z";
            "file" = "integratedcrafting-1.21.1-neoforge-1.4.7-620.jar";
            "hash" = "sha512-8CxJ91X4QACbIrb1TEOvkLfZtFaArGMIZk7sMRYBJU3WFQhuH8ChApmEqYslPlEJfb7qebISAu4qEoQrgBuxsg==";
        };
        _ZG1mOB4o = {
            "id" = "ZG1mOB4o";
            "file" = "integratedcrafting-26.2-neoforge-1.4.7-622.jar";
            "hash" = "sha512-M+WDHUU/c6GqPDfroQOqGmhWLnAv+r+N4D9ep1ls5K4u4LelTRee22fRPbZynb/gSnUJaP+vaGfyscfR8SFLQQ==";
        };
        _7ZQDihZT = {
            "id" = "7ZQDihZT";
            "file" = "integratedcrafting-26.1.2-neoforge-1.4.8-621.jar";
            "hash" = "sha512-5wxITWDbeIourGagd3weSRdMa3uOxfqOfdKMJidcpeMnqAM+r+TJDYjMLkoo8VUYHh9aGd/9LbxmW/zyXz7WVw==";
        };
        _aVxWo8xS = {
            "id" = "aVxWo8xS";
            "file" = "integratedcrafting-1.21.1-neoforge-1.4.7-629.jar";
            "hash" = "sha512-r4VHtE90HcPC4aT/cvS12CsPhyOjHr0yP7sHa89A+08VujN2oH2F8g3WqlwFESkDCsN37kejb4UKq1JKEsNewQ==";
        };
        _7ul6jOpt = {
            "id" = "7ul6jOpt";
            "file" = "integratedcrafting-1.21.1-neoforge-1.5.0.jar";
            "hash" = "sha512-HFqcY2vY/mzWTtjGptFOXzo/b6ztDpzcytGmIKwU3PwfMVKbL1V1TSZ/8eZZ37WEYk2+OA0qT7Mp/a/c3WBf4g==";
        };
        _rm3pILVb = {
            "id" = "rm3pILVb";
            "file" = "integratedcrafting-26.1.2-neoforge-1.5.0.jar";
            "hash" = "sha512-fZZE1efeExJsMEbn7H2cM+XM6imt+yEPzM8qkkoBzQHd2qdMkbJjObhUCHn44rxobOwRNgWM3o7mfqyjCjh0Bg==";
        };
        _4fcVWqhW = {
            "id" = "4fcVWqhW";
            "file" = "integratedcrafting-26.2-neoforge-1.4.7-634.jar";
            "hash" = "sha512-O3AQia6eX6LV8d1eSSCmZgyqu3eNHN4hrXrBG/8D7XvZsYRhSsHwp9YYUoJ5hk05nr6XX0Pkl+m93yHG0wjkBA==";
        };
        _Yg7oXSd1 = {
            "id" = "Yg7oXSd1";
            "file" = "integratedcrafting-1.21.1-neoforge-1.5.0-638.jar";
            "hash" = "sha512-ekiu0N+lv6EENjqAU/L9l25v10TdMSlF64rdvlJEFMGLRi0BVNQFxV8lQjOM/2amPAnzZw4uchPt42hkrjQ2zg==";
        };
        _lPgx2ox4 = {
            "id" = "lPgx2ox4";
            "file" = "integratedcrafting-26.2-neoforge-1.4.7-639.jar";
            "hash" = "sha512-LZC04HmSLxLTwywLjSeSqO+mjFy24AgaiHWG3eOlt0PZXhx7jqnRCU3Uai+nDz4r6GDOk+BKlp1wvcgFXf4kAQ==";
        };
        _2gMek88j = {
            "id" = "2gMek88j";
            "file" = "integratedcrafting-26.1.2-neoforge-1.5.0-640.jar";
            "hash" = "sha512-JGsj/qNspLJPkUaUeFD+HYihoxTQOtsa8Fm6CQiHxXDmkFuGsmM2wt+APwwSRNZUgtmnPC1T9zXD9LO0HowW1Q==";
        };
        _JRmY6Tyf = {
            "id" = "JRmY6Tyf";
            "file" = "integratedcrafting-1.21.1-neoforge-1.5.0-646.jar";
            "hash" = "sha512-QPVEy0k1JqfljdT6zP60UC1ZjZieLqIBRajayaCXlyouACzAHfwmeLbaTkqn4aDrmML4tqTrWIMvf3cvZ6RTtw==";
        };
        _afjXtcoZ = {
            "id" = "afjXtcoZ";
            "file" = "integratedcrafting-1.21.1-neoforge-1.5.0-671.jar";
            "hash" = "sha512-DPXSFxNTCWlMZbmoXTpvymp/KcZnUbFpVSmvUVUUoQmD7MT98YPe7DrRRQANt9/TBTTLiZQVtweSflWwWdVAnw==";
        };
        _apREXigx = {
            "id" = "apREXigx";
            "file" = "integratedcrafting-26.1.2-neoforge-1.5.0-672.jar";
            "hash" = "sha512-zdW17q2dr0f55UF0KSWgyJkPPJrgV0ktA4VGB+gq3DuFXP8g4nARigSLfzfcuB7BmLNiWkFv/I0Hs81k28H1uQ==";
        };
        _ikOAO90c = {
            "id" = "ikOAO90c";
            "file" = "integratedcrafting-26.2-neoforge-1.4.7-673.jar";
            "hash" = "sha512-LzgfofnDVEy1FYkmc3Uzo0dEy6jmqRSlMtEm+8QatTo8oPZ0kwXJ9Rinn3bogS/y3/3OIt/Fve5BwcxYV2GAOQ==";
        };
        _EAQwDP5N = {
            "id" = "EAQwDP5N";
            "file" = "integratedcrafting-1.21.1-neoforge-1.5.0-678.jar";
            "hash" = "sha512-mldKt8DG4dew/xeCs/dQ7/2UiI2JqJEhkvexMtfBS1Ea/8mNdxKlBp28i7Ggc12c9FwmvqeDhFO9pn5M9lKcsg==";
        };
        _Xs7EWq8Z = {
            "id" = "Xs7EWq8Z";
            "file" = "integratedcrafting-1.21.1-neoforge-1.5.0-681.jar";
            "hash" = "sha512-LkkmtLhNh+b30gq1boT3lSRNnxOiX9nIpwb4YTve1Oc2+Agfo/j/hZ2mmOcVeKHla0F2t7i3tx3Vy9BoYlG+fQ==";
        };
        _7XrBAzEF = {
            "id" = "7XrBAzEF";
            "file" = "integratedcrafting-1.21.1-neoforge-1.5.0-689.jar";
            "hash" = "sha512-0WuxpHP/mszrRu5vzqsaE/a+QudvD6dMNA+es/Ytp1pscCKEKvCedO2gAhBKXbI8MdpPssDUFCVlPdhLTU++Ig==";
        };
        _hNgLKlri = {
            "id" = "hNgLKlri";
            "file" = "integratedcrafting-1.21.1-neoforge-1.5.0-694.jar";
            "hash" = "sha512-EI0PCyIvCb4Rjz2hOE8GwFdvQA1UmRUcP0XNmGojRL0p51IuFOI54kAAWDv8dE2N0Bi+stlWQZvlxdCwY80QTQ==";
        };
        _rT3YFgqS = {
            "id" = "rT3YFgqS";
            "file" = "integratedcrafting-1.21.1-neoforge-1.6.0.jar";
            "hash" = "sha512-hbox3cgjC7q2+o1OpokK4FATt3ZN4A6yst7o4L6GBhXJwsd5iYq6RFSqi8S5pPc6gXlE3BmMR4Gm1Fir4tt0iA==";
        };
        _1c0Qmyw6 = {
            "id" = "1c0Qmyw6";
            "file" = "integratedcrafting-26.2-neoforge-1.4.7-711.jar";
            "hash" = "sha512-NseEZ5/q6NSTPdZBUC2lq/fCptNUsqVHnzl3U9a46iSazOp4HEk8L7ZoZESHMMCS1NG+WONA04UBmBh1NuFgmg==";
        };
        _wyZ92ofW = {
            "id" = "wyZ92ofW";
            "file" = "integratedcrafting-1.21.1-neoforge-1.6.0-712.jar";
            "hash" = "sha512-ZEVIg+tB7qn9zHvO0XxZPXQHV61dwunyXkZd8L6z2AtCSUIeYH9MEI700bcX/dZN2v3PTyOgf/Tt9UDOd53Taw==";
        };
        _Gfv9wdxE = {
            "id" = "Gfv9wdxE";
            "file" = "integratedcrafting-1.21.1-neoforge-1.6.0-715.jar";
            "hash" = "sha512-FCiS8zZbySzRANu/XS1pt+0hQYxuFjWhnmb3TQPTpKlofn4AtPvqrzJfHOUtGwjocXhHNbdZtTJhF08h6Xg4xw==";
        };
        _qbZBo620 = {
            "id" = "qbZBo620";
            "file" = "integratedcrafting-1.21.1-neoforge-1.6.0-726.jar";
            "hash" = "sha512-e6aXpnklYMkojKsJGyUaCi9TjdOFbOoqw4qqz0zpyP0OAUKNhneeNFe3bs99KK/guSR81LF7nADWEpfGjyj+cg==";
        };
        _pXR0BipG = {
            "id" = "pXR0BipG";
            "file" = "integratedcrafting-1.21.1-neoforge-1.6.0-729.jar";
            "hash" = "sha512-p74HpbROUQ8fbDdYICMxE10jZCecVS+EFFGm8MqW7eUVgbgY7B5sRw1gsyaMrraLDDl3c8sF9G1sZwIF/GU/JQ==";
        };
        _ybRiY9bA = {
            "id" = "ybRiY9bA";
            "file" = "integratedcrafting-26.1.2-neoforge-1.6.0-739.jar";
            "hash" = "sha512-1aJAPTw18kNW1mdTanPLnPbIgcgSsXU7TaBLlY7vARAsYDx08YPdyHaPzaAM0lVHEJkYwrkpjhh2h0OGczIPdA==";
        };
        _OEtZF3HA = {
            "id" = "OEtZF3HA";
            "file" = "integratedcrafting-1.21.1-neoforge-1.6.0-749.jar";
            "hash" = "sha512-BOBpG5Dallh8724te6CK5vGVLnUgB4zvWNIIbOSWw32OR7KwRixoTSmYvOmYWv6Gu43ZW33uqIcRlFGkQgdeOA==";
        };
        _kcYA3XPI = {
            "id" = "kcYA3XPI";
            "file" = "integratedcrafting-1.21.1-neoforge-1.6.0-751.jar";
            "hash" = "sha512-BgVr/thdj0SCzsiwgePvyLL0XkKn/pjwjXireAjDPa4Ko+HNTLI5C3wyxdX+avfxYSkISv72Sq5CMC8yJuGdVQ==";
        };
        _9pRZRqH8 = {
            "id" = "9pRZRqH8";
            "file" = "integratedcrafting-1.21.1-neoforge-1.6.0-754.jar";
            "hash" = "sha512-alFlAU+G7rHsA6T6f65oYZhIunTUvKK09gGnJ+3kzdeoHW68Pkzl7BFeSWIcek3Mbs50cLAix4rNyKE5Gw7Xig==";
        };
        _cLNppM99 = {
            "id" = "cLNppM99";
            "file" = "integratedcrafting-26.1.2-neoforge-1.6.0-756.jar";
            "hash" = "sha512-FhfIOe5RKEjFQ5UebjD5y+ETAz2+ZeiBw2o88Lq4lpzVfyLVjm0ThvL8Udq2aXz+oXpRnCTW0c/TFF4XL/kszA==";
        };
        _8dBAzfqn = {
            "id" = "8dBAzfqn";
            "file" = "integratedcrafting-26.1.2-neoforge-1.6.0-758.jar";
            "hash" = "sha512-5QLtvZyiOEs96vN88sM0aaSPqyFzk/dPXd+ommHIJyKjlYCzyPzing9++xZ+51RywYCuqd/WMyb/iYPsCTaEgA==";
        };
        _iw4uV6sA = {
            "id" = "iw4uV6sA";
            "file" = "integratedcrafting-26.1.2-neoforge-1.6.0-759.jar";
            "hash" = "sha512-98PjB6lfeJrnHYE0rqA6sNtunKDUCVY4rwZj3ZUg5RT3Rf3t0MMmeOk66LPWoYP0qalSBA6KxmN9L+2o+9ZV+g==";
        };
        _lbTjNin5 = {
            "id" = "lbTjNin5";
            "file" = "IntegratedCrafting-1.20.1-1.4.8.jar";
            "hash" = "sha512-fDX5zllCKJmw5aDfkWzJcokdcbOsANTiqAzpFy+xsnJK2ygyyoUpeXHzqIdiEXcH/N67Fofl4U0MnA8StOqmFg==";
        };
        _CuX8ODwg = {
            "id" = "CuX8ODwg";
            "file" = "integratedcrafting-1.21.1-neoforge-1.7.1.jar";
            "hash" = "sha512-MyFa6uxyMY2JUFECcNpOlJijJJSWQ9tTO7UAHjQ7xi328u4fivmcZrLTsJXK1C9jOdimbPVmBnt0sqamDDzWWA==";
        };
        _O5qUxxNs = {
            "id" = "O5qUxxNs";
            "file" = "integratedcrafting-26.1.2-neoforge-1.7.0.jar";
            "hash" = "sha512-Lwxnhd7xzEOrluSk+yOb84NIImcnZjbe05Q/b9tghFfhnJkhdiPM0Attxwil7jniTva5JBJ+1VJNTeOGMt+7Hw==";
        };
        _cpfLAIeZ = {
            "id" = "cpfLAIeZ";
            "file" = "integratedcrafting-26.2-neoforge-1.4.7-768.jar";
            "hash" = "sha512-dt8lh04xt1nVOBcJs1/ko1/Lhv+LNy9cg5abYHbhuQWsbvzFQJeSG6sId/742EpaClqaY1AVs9+qk78Wh7VE8g==";
        };
        _LtXZREpC = {
            "id" = "LtXZREpC";
            "file" = "integratedcrafting-1.21.1-neoforge-1.7.0.jar";
            "hash" = "sha512-K4KnKO4JaI0Uw7FkuGzYTztz5VZvZN9SZswzcijWfHMivuCDITEHSqr4Gft6fudOlcINjphZ2NrHVwLFALQtFA==";
        };
        _CLa33tFT = {
            "id" = "CLa33tFT";
    ...
    in {
        ...
        "pkg-1.19.2-1.0.24" = _gE6wCLwk;
        "pkg-1.18.2-1.0.24" = _IvYddkNE;
        "pkg-1.19.2-1.0.25" = _xGZDMTlG;
        "pkg-1.19.2-1.0.26" = _QpIEaXQH;
        "pkg-1.18.2-1.0.25" = _MDGB52nb;
        "pkg-1.19.3-1.0.26" = _fSkK3QDs;
        "pkg-1.18.2-1.1.0" = _ZblVa9jl;
        "pkg-1.19.2-1.1.0" = _UMsf4nG7;
        "pkg-1.19.3-1.1.0" = _RGmyZJZU;
        "pkg-1.18.2-1.1.1" = _38POUXSY;
        "pkg-1.19.2-1.1.1" = _3ql6I3vh;
        "pkg-1.19.4-1.1.1" = _J6kjkBW8;
        "pkg-1.19.4-1.1.2" = _5tCZUvgs;
        "pkg-1.18.2-1.1.2" = _3jIP8qKz;
        "pkg-1.19.2-1.1.2" = _MxmJ8L0A;
        "pkg-1.19.4-1.1.3" = _bZvFyzvm;
        "pkg-1.20.1-1.1.3" = _2zYYsOTr;
        "pkg-1.18.2-1.1.3" = _teej6AZA;
        "pkg-1.19.2-1.1.3" = _XGIZZYvg;
        "pkg-1.20.1-1.1.4" = _AZnEyrkk;
        "pkg-1.18.2-1.1.4" = _OY52wsa7;
        "pkg-1.19.2-1.1.4" = _XfgHaDAa;
        "pkg-1.20.1-1.1.5" = _mlJAn1yT;
        "pkg-1.18.2-1.1.5" = _gpnhfrvk;
        "pkg-1.19.2-1.1.5" = _a4qsGuDi;
        "pkg-1.20.1-1.1.6" = _f8VflshP;
        "pkg-1.18.2-1.1.6" = _TpaFBmZD;
        "pkg-1.19.2-1.1.6" = _Cj5ODLzp;
        "pkg-1.20.1-1.1.7" = _lVNokfA4;
        "pkg-1.20.4-1.1.7" = _bNPZQyun;
        "pkg-1.21-1.1.7" = _oU7mMYJA;
        "pkg-1.21-1.1.8" = _puykYXfI;
        "pkg-1.21.1-1.1.9" = _3pRnUZpN;
        "pkg-1.19.2-1.1.7" = _HgH2Wa5a;
        "pkg-1.20.1-1.1.8" = _qIe9ou2a;
        "pkg-1.21.1-1.1.10" = _RxLDYIw9;
        "pkg-1.19.2-1.1.8" = _jDi2ik4Q;
        "pkg-1.20.1-1.1.9" = _sSoTtRmx;
        "pkg-1.21.1-1.1.11" = _xfkvP3Ed;
        "pkg-1.21.1-1.1.12" = _2ohsSLcc;
        "pkg-1.21.1-1.1.13" = _xVvN5mPD;
        "pkg-1.21.1-1.1.13-256" = _72qAuOn5;
        "pkg-1.21.1-1.1.13-257" = _IXOppOdM;
        "pkg-1.21.1-1.1.13-258" = _po6tTeBW;
        "pkg-1.21.1-1.1.13-259" = _emUWdU5n;
        "pkg-1.21.1-1.1.13-261" = _rXQ7ZQ8r;
        "pkg-1.21.1-1.1.13-262" = _b4YjxMGL;
        "pkg-1.21.1-1.1.13-264" = _XG3VmYCP;
        "pkg-1.21.1-1.1.13-265" = _JzQsXlRf;
        "pkg-1.21.1-1.1.13-267" = _rZT8cOAW;
        "pkg-1.21.1-1.1.13-269" = _xOBL4iKR;
        "pkg-1.21.1-1.1.13-271" = _U3ZSHGDi;
        "pkg-1.19.2-1.1.9" = _gH4NIKcv;
        "pkg-1.20.1-1.1.10" = _5Lqz33qB;
        "pkg-1.21.1-1.1.14-277" = _tepxZ6bJ;
        "pkg-1.21.1-1.1.14" = _lUug7RZb;
        "pkg-1.21.1-1.1.14-281" = _h0GLHgLw;
        "pkg-1.21.1-1.1.15" = _SIYjId2T;
        "pkg-1.19.2-1.1.10" = _XiB89DWE;
        "pkg-1.21.4-1.1.13-289" = _IwePsLsw;
        "pkg-1.21.1-1.1.15-290" = _pXqUxsik;
        "pkg-1.21.1-1.1.16" = _LESmbTQ1;
        "pkg-1.21.1-1.1.16-294" = _C4Zg1ZRE;
        "pkg-1.21.4-1.1.13-296" = _RCnwdITo;
        "pkg-1.21.4-1.1.13-297" = _GFeWctz9;
        "pkg-1.21.1-1.1.16-298" = _kmfaVad7;
        "pkg-1.21.1-1.1.16-300" = _gSe7Vl68;
        "pkg-1.21.4-1.1.13-301" = _z9IsvUgG;
        "pkg-1.21.1-1.1.16-305" = _jiZvsfON;
        "pkg-1.21.4-1.1.13-308" = _1wpDUVnQ;
        "pkg-1.21.1-1.1.16-309" = _ulKg0WHk;
        "pkg-1.20.1-1.2.0" = _qCrU4fQP;
        "pkg-1.21.4-1.1.13-313" = _hH1vbOfp;
        "pkg-1.21.1-1.2.0" = _92vNOtNc;
        "pkg-1.21.1-1.2.1" = _xZ5WyYMG;
        "pkg-1.21.4-1.1.13-318" = _nZ5msvRC;
        "pkg-1.19.2-1.1.11" = _nHKhOjfS;
        "pkg-1.20.1-1.2.2" = _KyaQmWdu;
        "pkg-1.21.1-1.2.2" = _R21jP19Q;
        "pkg-1.21.1-1.2.2-328" = _XOwYJWSp;
        "pkg-1.21.4-1.1.13-329" = _i9qa1G48;
        "pkg-1.21.1-1.2.2-331" = _hpyVu3Yy;
        "pkg-1.21.1-1.2.2-333" = _cKG3ZdGu;
        "pkg-1.21.1-1.2.2-335" = _fZ3Ql70D;
        "pkg-1.21.1-1.2.2-337" = _kyHqNCAN;
        "pkg-1.21.1-1.2.2-338" = _O1rC6Apz;
        "pkg-1.19.2-1.1.12" = _xaR1wjdV;
        "pkg-1.20.1-1.2.3" = _aZ9OL8kd;
        "pkg-1.21.1-1.2.3" = _ylliiDlO;
        "pkg-1.21.8-1.1.13-346" = _ttPpNpH9;
        "pkg-1.21.8-1.1.13-347" = _SMFtyuUc;
        "pkg-1.21.1-1.2.3-348" = _GWqcUJ4Y;
        "pkg-1.21.1-1.2.3-349" = _rdWPDq9D;
        "pkg-1.21.1-1.2.3-353" = _WeDzZfrs;
        "pkg-1.21.1-1.2.3-357" = _SWKf6DJ9;
        "pkg-1.21.1-1.3.0" = _LSqqhFMg;
        "pkg-1.20.1-1.3.0" = _uIx6Sb91;
        "pkg-1.21.8-1.1.13-365" = _a3jVaVzX;
        "pkg-1.21.1-1.3.0-367" = _GgK3DZdX;
        "pkg-1.21.1-1.3.1" = _bvSYyNiq;
        "pkg-1.21.1-1.3.1-370" = _5M71iyP8;
        "pkg-1.20.1-1.3.1" = _sE3h6jLV;
        "pkg-1.21.1-1.3.2" = _unePrZEl;
        "pkg-1.21.8-1.1.13-378" = _ZJdw0sp3;
        "pkg-1.21.1-1.3.2-381" = _Q6XBJLgD;
        "pkg-1.21.1-1.3.3" = _Jhy0KlOc;
        "pkg-1.20.1-1.3.2" = _EARk4ttH;
        "pkg-1.21.8-1.1.13-388" = _cYB4NVhH;
        "pkg-1.21.1-1.3.3-391" = _5rht89fQ;
        "pkg-1.21.1-1.3.3-393" = _smnYpePo;
        "pkg-1.21.8-1.1.13-394" = _jRj7cSsJ;
        "pkg-1.21.1-1.3.4" = _TgNoWjR3;
        "pkg-1.20.1-1.3.3" = _nNKxZ0sR;
        "pkg-1.21.8-1.1.13-404" = _RmsRDiIR;
        "pkg-1.21.8-1.1.13-405" = _VkLEIhHs;
        "pkg-1.21.10-1.1.13-407" = _RipPP6Cz;
        "pkg-1.21.10-1.1.13-408" = _hEzFb3bC;
        "pkg-1.21.10-1.1.13-409" = _vTW1FXPA;
        "pkg-1.21.10-1.1.13-410" = _9M6JtNKM;
        "pkg-1.21.11-1.1.13-412" = _Rs0rUoqD;
        "pkg-1.21.1-1.4.0" = _x2vLsDff;
        "pkg-1.20.1-1.4.0" = _8NSWilkX;
        "pkg-1.21.11-1.1.13-430" = _Zn6wxLH2;
        "pkg-1.21.1-1.4.0-433" = _YSLSuSlo;
        "pkg-1.20.1-1.4.1" = _y4XLYfIE;
        "pkg-1.21.1-1.4.1" = _lYM2QoBL;
        "pkg-1.21.1-1.4.1-442" = _4UDOlQgs;
        "pkg-1.21.11-1.1.13-443" = _XK1xMfpu;
        "pkg-1.21.11-1.1.13-444" = _Xm4D7pA7;
        "pkg-1.21.1-1.4.1-446" = _w1dNLX1F;
        "pkg-1.20.1-1.4.2" = _m7onY2TM;
        "pkg-1.21.1-1.4.2" = _FoxzUWTC;
        "pkg-1.21.11-1.1.13-453" = _CBYkhtL4;
        "pkg-1.21.1-1.4.2-454" = _RjeKj3op;
        "pkg-1.20.1-1.4.3" = _qkylV5rs;
        "pkg-1.21.1-1.4.3" = _3Kmlc1xf;
        "pkg-1.21.11-1.1.13-459" = _Jy2JDXD9;
        "pkg-1.20.1-1.4.4" = _9JJnQssN;
        "pkg-1.21.1-1.4.4" = _RY8rTugn;
        "pkg-1.21.11-1.1.13-470" = _wQJCn8OZ;
        "pkg-1.21.1-1.4.4-471" = _PGD6ePPU;
        "pkg-1.21.1-1.4.4-472" = _vkgWp66c;
        "pkg-1.21.1-1.4.4-476" = _4pe1f80i;
        "pkg-1.21.11-1.1.13-477" = _Z3lkINLY;
        "pkg-1.21.1-1.4.4-479" = _tLwGi7ZP;
        "pkg-1.21.1-1.4.4-494" = _EntMUP1X;
        "pkg-1.21.1-1.4.4-500" = _PyQRu0Or;
        "pkg-1.21.1-1.4.4-506" = _Nap0xE2G;
        "pkg-1.21.1-1.4.4-513" = _oMxTnEjE;
        "pkg-1.21.1-1.4.4-514" = _bcYvhelL;
        "pkg-1.21.1-1.4.4-526" = _8bLIy0op;
        "pkg-1.21.11-1.1.13-533" = _KegHrPMG;
        "pkg-1.20.1-1.4.5" = _JwlEa3vT;
        "pkg-1.21.1-1.4.5" = _yQ9OebyE;
        "pkg-1.21.1-1.4.5-539" = _jqahSGYU;
        "pkg-1.21.11-1.1.13-540" = _7Tdfl103;
        "pkg-1.21.11-1.1.13-541" = _qniotvNy;
        "pkg-1.21.11-1.1.13-544" = _sSekbHRg;
        "pkg-26.1.1-1.1.13-545" = _1NBDQYUX;
        "pkg-26.1.1-1.4.5-547" = _gFffsuYi;
        "pkg-26.1.1-1.4.5" = _QiDZz6CC;
        "pkg-26.1.1-1.4.5-554" = _DiQzzBM8;
        "pkg-26.1.1-1.4.5-556" = _kTYPbm7M;
        "pkg-26.1.2-1.4.5" = _hFawpktc;
        "pkg-26.1.2-1.4.5-561" = _3FH7103j;
        "pkg-26.1.2-1.4.5-562" = _OsyCHcYr;
        "pkg-1.20.1-1.4.6" = _E800mvMk;
        "pkg-26.1.2-1.4.6" = _ueR3ZaLK;
        "pkg-1.21.1-1.4.6" = _se5g7ewq;
        "pkg-26.1.2-1.4.7" = _wK7xrQNJ;
        "pkg-26.1.2-1.4.7-572" = _9nlZ5vzk;
        "pkg-26.1.2-1.4.7-579" = _wzQlXpkp;
        "pkg-26.1.2-1.4.7-584" = _ma3wP7mN;
        "pkg-26.1.2-1.4.7-585" = _9VzrssNY;
        "pkg-26.2-1.4.7-586" = _t9KnfQGc;
        "pkg-1.21.11-1.1.13-588" = _TGxcOT4Y;
        "pkg-26.2-1.4.7-595" = _lebRPJLe;
        "pkg-26.1.2-1.4.7-600" = _D3HYIIxr;
        "pkg-26.2-1.4.7-601" = _lolumpPi;
        "pkg-1.21.1-1.4.6-599" = _Zo36O1Pk;
        "pkg-26.2-1.4.7-604" = _N7RY1iLs;
        "pkg-1.21.1-1.4.6-602" = _TNeacnqN;
        "pkg-26.1.2-1.4.7-603" = _rGUMvqun;
        "pkg-26.2-1.4.7-607" = _BxUBFK94;
        "pkg-26.1.2-1.4.7-606" = _lA9Z191J;
        "pkg-1.21.1-1.4.6-605" = _m1UH23s4;
        "pkg-1.20.1-1.4.7" = _9ERMwgnZ;
        "pkg-26.2-1.4.7-614" = _LSQdklg6;
        "pkg-26.1.2-1.4.8" = _J3Xqccvk;
        "pkg-1.21.1-1.4.7" = _UfIUAffF;
        "pkg-1.21.1-1.4.7-615" = _g3OaBULn;
        "pkg-26.1.2-1.4.8-616" = _vaw8Y2wl;
        "pkg-26.2-1.4.7-617" = _VBG4Utnl;
        "pkg-1.21.1-1.4.7-619" = _QZB2FfHI;
        "pkg-1.21.1-1.4.7-620" = _8T06nV1Z;
        "pkg-26.2-1.4.7-622" = _ZG1mOB4o;
        "pkg-26.1.2-1.4.8-621" = _7ZQDihZT;
        "pkg-1.21.1-1.4.7-629" = _aVxWo8xS;
        "pkg-1.21.1-1.5.0" = _7ul6jOpt;
        "pkg-26.1.2-1.5.0" = _rm3pILVb;
        "pkg-26.2-1.4.7-634" = _4fcVWqhW;
        "pkg-1.21.1-1.5.0-638" = _Yg7oXSd1;
        "pkg-26.2-1.4.7-639" = _lPgx2ox4;
        "pkg-26.1.2-1.5.0-640" = _2gMek88j;
        "pkg-1.21.1-1.5.0-646" = _JRmY6Tyf;
        "pkg-1.21.1-1.5.0-671" = _afjXtcoZ;
        "pkg-26.1.2-1.5.0-672" = _apREXigx;
        "pkg-26.2-1.4.7-673" = _ikOAO90c;
        "pkg-1.21.1-1.5.0-678" = _EAQwDP5N;
        "pkg-1.21.1-1.5.0-681" = _Xs7EWq8Z;
        "pkg-1.21.1-1.5.0-689" = _7XrBAzEF;
        "pkg-1.21.1-1.5.0-694" = _hNgLKlri;
        "pkg-1.21.1-1.6.0" = _rT3YFgqS;
        "pkg-26.2-1.4.7-711" = _1c0Qmyw6;
        "pkg-1.21.1-1.6.0-712" = _wyZ92ofW;
        "pkg-1.21.1-1.6.0-715" = _Gfv9wdxE;
        "pkg-1.21.1-1.6.0-726" = _qbZBo620;
        "pkg-1.21.1-1.6.0-729" = _pXR0BipG;
        "pkg-26.1.2-1.6.0-739" = _ybRiY9bA;
        "pkg-1.21.1-1.6.0-749" = _OEtZF3HA;
        "pkg-1.21.1-1.6.0-751" = _kcYA3XPI;
        "pkg-1.21.1-1.6.0-754" = _9pRZRqH8;
        "pkg-26.1.2-1.6.0-756" = _cLNppM99;
        "pkg-26.1.2-1.6.0-758" = _8dBAzfqn;
        "pkg-26.1.2-1.6.0-759" = _iw4uV6sA;
        "pkg-1.20.1-1.4.8" = _lbTjNin5;
        "pkg-1.21.1-1.7.1" = _CuX8ODwg;
        "pkg-26.1.2-1.7.0" = _O5qUxxNs;
