...
let
    versions = (let
        ...
        _ppKsfQLD = {
            "id" = "ppKsfQLD";
            "file" = "wynnmod-2.3.5.jar";
            "hash" = "sha512-hCdhZkE7N/zv6R48xirakA+ydf9KI8NvBYVjlnGK25cPBJ3mhEf9Fqfk5epNmByHJO8Z5v2KGuvNvkaNoI8t+A==";
        };
        _FqBjmaRA = {
            "id" = "FqBjmaRA";
    ...
    in {
        ...
        "pkg-1.13.3" = _dMZPmAYG;
        "pkg-1.13.4" = _ofmSbueg;
        "pkg-1.13.5" = _70WxtXax;
        "pkg-1.14.0" = _8YtIPv4O;
        "pkg-1.14.1" = _cYrKdBf0;
        "pkg-1.14.2" = _a3ldFyc0;
        "pkg-1.14.3" = _ealYjRUD;
        "pkg-1.15.0" = _8IUhBzQM;
        "pkg-1.15.1" = _fP6CjwAm;
        "pkg-1.15.2" = _ROIGLxzZ;
        "pkg-1.16.0" = _vu9X7xq8;
        "pkg-1.16.1" = _RWKXYtFk;
        "pkg-2.0.0-BETA-1" = _dDvb4qcj;
        "pkg-2.0.0-BETA-2" = _z8kDKCqJ;
        "pkg-2.0.0-BETA-3" = _vHVZl8fy;
        "pkg-2.0.0-BETA-4" = _Ckf9jLDs;
        "pkg-2.0.0-BETA-5" = _VGsfQKi1;
        "pkg-2.0.0" = _R6ULusta;
        "pkg-2.1.0-BETA-1" = _zDMtOwww;
        "pkg-2.0.1" = _V06XCpea;
        "pkg-2.1.0-BETA-2" = _2vpEjSc6;
        "pkg-2.0.2" = _i6h2o100;
        "pkg-2.0.3" = _YYC1TShO;
        "pkg-2.1.0-BETA-3" = _bdm5nSgn;
        "pkg-2.0.4" = _m1EKOscX;
        "pkg-2.0.5" = _DLx78l2X;
        "pkg-2.0.6" = _5z2RpYlp;
        "pkg-2.1.0" = _3zzvvD7H;
