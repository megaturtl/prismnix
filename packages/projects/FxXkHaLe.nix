...
let
    ...
    in {
        ...
        "pkg-0.9.4+1.19.2-fabric" = _lhD9HRTX;
        "pkg-0.9.5+1.19.2-fabric" = _AXqCaqsw;
        "pkg-0.9.6+1.19.2-fabric" = _o1PnMrIN;
        "pkg-0.9.7+1.20.1-fabric" = _HEWsdEap;
        "pkg-0.9.8+1.20.1-fabric" = _oBiF9Q7J;
        "pkg-0.9.9+1.20.1-fabric" = _qePeuSz8;
        "pkg-0.9.10+1.20.1-fabric" = _cDkH9PyA;
        "pkg-1.0.0+1.20.1-fabric" = _vPOIKUug;
        "pkg-1.0.1+1.20.1-fabric" = _1YmpeDaT;
        "pkg-1.0.2+1.20.1-fabric" = _uqsa542h;
        "pkg-1.0.3+1.20.1-fabric" = _OL7gRLMQ;
        "pkg-1.0.4+1.20.1-fabric" = _pUiX493b;
        "pkg-1.0.5+1.20.1-fabric" = _zCnhTp58;
        "pkg-1.1.0+1.20.1-fabric" = _U0NVFI7E;
        "pkg-1.1.1+1.20.1-fabric" = _FXxePdAs;
        "pkg-1.1.2+1.20.1-fabric" = _4VqFqNaz;
        "pkg-1.1.3+1.20.1-fabric" = _vlhPTPNo;
        "pkg-1.2.0+1.20.1-fabric" = _Kk8X9z55;
        "pkg-1.2.1+1.20.1-fabric" = _JJbsnIhi;
        "pkg-1.2.2+1.20.1-fabric" = _Yre7Qv03;
        "pkg-1.2.3+1.20.1-fabric" = _r64hEfek;
        "pkg-1.2.4+1.20.1-fabric" = _pfmb6sqN;
        "pkg-1.2.6+1.20.1-fabric" = _MFqlocQN;
        "pkg-1.3.0+1.20.1-fabric" = _C1rl8sGU;
        "pkg-1.3.1+1.20.1-fabric" = _9FbzwRpY;
        "pkg-2.0.0+1.21.1-fabric" = _N276hJ6u;
        "pkg-2.0.1+1.21.1-fabric" = _W66uY9HB;
        "pkg-2.0.2+1.21.1-fabric" = _CC5ciYf6;
        "pkg-2.0.3+1.21.1-fabric" = _2dwv4RJE;
        "pkg-2.0.4+1.21.1-fabric" = _Bfs2v348;
        "pkg-2.0.5+1.21.1-fabric" = _9deP0w2H;
        "pkg-2.1.0+1.21.1-fabric" = _o2SpXbaW;
        "pkg-2.1.1+1.21.1-fabric" = _vxPwoQ0X;
        "pkg-2.2.0+1.21.1-fabric" = _PSqVzCby;
        "pkg-2.2.1+1.21.1-fabric" = _Q3pZbWuH;
        "pkg-2.2.2+1.21.1-fabric" = _il5x5GZn;
        "pkg-2.2.3+1.21.1-fabric" = _67zdI1FI;
        "pkg-2.2.4+1.21.1-fabric" = _V1CQdflY;
        "pkg-1.4.0+1.20.1-fabric" = _jdQ0FXvF;
        "pkg-2.3.0+1.21.1-fabric" = _RYbHQDhM;
        "pkg-2.3.1+1.21.1-fabric" = _R5h11rTE;
        "pkg-2.4.2+1.21.1-fabric" = _QZf1DJQI;
        "pkg-2.4.3+1.21.1-fabric" = _owcpDFCw;
        "pkg-2.4.4+1.21.1-fabric" = _Jofa8Nnc;
        "pkg-2.4.5+1.21.1-fabric" = _6Nl6joiW;
        "pkg-2.4.6+1.21.1-fabric" = _wnZpLmlB;
        "pkg-2.4.7+1.21.1-fabric" = _s7TMX446;
        "pkg-2.4.8+1.21.1-fabric" = _cp0MfVIO;
        "pkg-2.4.9+1.21.1-fabric" = _XVTBJcvW;
        "pkg-2.4.10+1.21.1-fabric" = _rqfqamJj;
        "pkg-2.4.11+1.21.1-fabric" = _YSHg9mnj;
        "pkg-2.4.12+1.21.1-fabric" = _vud7AFzE;
        "pkg-2.4.13+1.21.1-fabric" = _xNvcnnJH;
        "pkg-2.4.14+1.21.1-fabric" = _Br6hHWpQ;
        "pkg-2.5.0+1.21.1-fabric" = _qc6WzFUA;
        "pkg-2.5.1+1.21.1-fabric" = _z5VPgfJr;
        "pkg-2.5.2+1.21.1-fabric" = _jASxoHSW;
        "pkg-2.5.3+1.21.1-fabric" = _RglVGCp3;
        "pkg-2.6.0+1.21.1-fabric" = _aluT2gMW;
        "pkg-2.6.0+1.21.1-neoforge" = _kGvpJ7dV;
        "pkg-2.6.2+1.21.1-fabric" = _zYikOLAJ;
        "pkg-2.6.2+1.21.1-neoforge" = _BDPxi0mo;
        "pkg-2.6.3+1.21.1-neoforge" = _Gm471ING;
        "pkg-2.6.3+1.21.1-fabric" = _uheWk6th;
        "pkg-2.6.4+1.21.1-fabric" = _uzAvtQmY;
        "pkg-2.6.4+1.21.1-neoforge" = _RWrztPGW;
        "pkg-2.7.0+1.21.1-fabric" = _TuaGwGAA;
        "pkg-2.7.0+1.21.1-neoforge" = _ruuuheWa;
        "pkg-2.7.1+1.21.1-neoforge" = _hHVG6WsO;
        "pkg-3.0.0+1.21.1-neoforge" = _Hd5K0IPZ;
        "pkg-3.0.0+1.21.1-fabric" = _g8eaCi1n;
        "pkg-3.0.1+1.21.1-fabric" = _iu0WOjcZ;
        "pkg-3.0.1+1.21.1-neoforge" = _MGvT26de;
        "pkg-3.0.2+1.21.1-neoforge" = _cLzhfxiC;
        "pkg-3.0.2+1.21.1-fabric" = _nZfYfhIg;
        "pkg-3.0.3+1.21.1-neoforge" = _Imtni6lW;
        "pkg-3.0.3+1.21.1-fabric" = _KtJ9NbNn;
        "pkg-3.0.4+1.21.1-neoforge" = _M6qL9h56;
