...
let
    ...
    in {
        ...
        "pkg-1.3-1.20.2" = _bLHDrebO;
        "pkg-1.4-1.20.3" = _tBkISdKZ;
        "pkg-1.5-1.20.5" = _xmTfjMi8;
        "pkg-1.6-1.21" = _5ddOPqgR;
        "pkg-1.7-1.21.3" = _SNA4dye5;
        "pkg-1.8-1.21.5" = _CEJSc93h;
        "pkg-1.8.1-1.21.6" = _oJK5XLlp;
        "pkg-1.8.2-1.21.9" = _wiedCy7A;
