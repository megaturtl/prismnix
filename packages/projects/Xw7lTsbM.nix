...
let
    versions = (let
        ...
        _BEMYFwoI = {
            "id" = "BEMYFwoI";
            "file" = "blossom-lib-2.6.1+26.3.jar";
            "hash" = "sha512-IfTB8aNyY8h6kJfyoYjKZED2n0+nuhP5YNm2RLHhTL/LSnqhApXCo2yxEvTEOb4ZEmn8s+uQUVZBX9CTkrZKBQ==";
        };
    in {
        "7JMkgFcp" = _7JMkgFcp;
        "QCbHoj36" = _QCbHoj36;
        ...
        "quilt-26.3" = _BEMYFwoI;
        "pkg-2.3.0+1.19" = _7JMkgFcp;
        "pkg-2.3.1+1.19" = _QCbHoj36;
        "pkg-2.3.2+1.19" = _AcgVwx9c;
        "pkg-2.3.3+1.18.2" = _nW8U03Jf;
        "pkg-2.3.3+1.19" = _3xnjT7U6;
        "pkg-2.4.0+1.19" = _N2qbwgYa;
        "pkg-2.4.1+1.19" = _EzQmWC0O;
        "pkg-2.5.0+1.19" = _i55UoiCo;
        "pkg-2.5.0+1.19.3" = _kqobeY1v;
        "pkg-2.5.0+1.19.4" = _lNoqGUeF;
        "pkg-2.5.1+1.19.4" = _E4kGJ1to;
        "pkg-2.5.1+1.19" = _DTJ2qnKj;
        "pkg-2.5.1+1.20" = _DndMbiAf;
        "pkg-2.5.1-fix.1+1.20" = _evBtyS1l;
        "pkg-2.5.2+1.20" = _2ya0HsZX;
        "pkg-2.5.3+1.20" = _bQf30LQ5;
        "pkg-2.5.4+1.20" = _9FCuKhG5;
        "pkg-2.5.4+1.19.4" = _1feDcnLO;
        "pkg-2.5.5+1.20.2" = _ZDNpf0YM;
        "pkg-2.5.6+1.20.4" = _IkVwdZuJ;
        "pkg-2.5.7+1.20.6" = _ujUN5jLW;
        "pkg-2.5.8+1.21" = _8iU3tQhG;
        "pkg-2.5.9+1.21" = _pGBxzJgQ;
        "pkg-2.5.10+1.21.3" = _YGtN3yOr;
        "pkg-2.5.11+1.21.4" = _3mC9QSRE;
        "pkg-2.5.12+1.21.5" = _hOeSU0K9;
        "pkg-2.5.13+1.21.5" = _Kst7g15Z;
        "pkg-2.5.14+1.21.5" = _SgIlV2Rc;
        "pkg-2.5.15+1.21.5" = _di76WFmV;
        "pkg-2.5.16+1.21.9" = _FajlgE11;
        "pkg-2.5.17+1.21.9" = _UhnLDUIB;
        "pkg-2.5.18+1.21.11" = _ud4jEwcZ;
        "pkg-2.5.19+26.1" = _ZgkSPNwO;
        "pkg-2.5.20+26.1" = _kABerboJ;
        "pkg-2.6.0+26.2" = _hhddMuBF;
        "pkg-2.6.0+1.21.11" = _2DfPVrk7;
        "pkg-2.6.0+1.21" = _USjYnQNL;
        "pkg-2.6.1+1.21" = _rq5YQV0f;
        "pkg-2.6.1+26.3" = _BEMYFwoI;
        "default" = _BEMYFwoI;
    });
