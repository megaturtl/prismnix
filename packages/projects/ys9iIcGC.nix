...
let
    ...
    in {
        ...
        "pkg-1.8" = _hiCEz3TO;
        "pkg-1.8+mod" = _imZQbicI;
        "pkg-1.8.1" = _W4CN7j2u;
        "pkg-1.8.1+mod" = _Gxsh9FiF;
        "pkg-1.9" = _guY5UDhC;
        "pkg-1.9+mod" = _CONIijtO;
        "pkg-1.10" = _IrJ5vaoU;
        "pkg-1.10+mod" = _HHtBphIC;
        "pkg-1.10a" = _ifq3V5rM;
        "pkg-1.10a+mod" = _hAVxR0Mf;
        "pkg-2.0" = _WQcJ0PVb;
        "pkg-2.0+mod" = _Uxokq1Az;
        "pkg-2.1" = _g3fy5fyv;
        "pkg-2.1+mod" = _ealrpT96;
        "pkg-2.1b" = _AFrHproq;
        "pkg-2.1b+mod" = _wqoTtRhh;
        "pkg-2.1c" = _KXTL08ll;
        "pkg-2.1c+mod" = _VbAxUhIv;
        "pkg-2.2" = _oaR7Onim;
        "pkg-2.2+mod" = _Nzy0dTQ3;
        "pkg-2.2.1" = _GhIPlFwO;
        "pkg-2.2.1+mod" = _fv2yuosy;
        "pkg-2.2.2a" = _kGNXUq94;
        "pkg-2.2.2a+mod" = _oG3ixBOH;
        "pkg-2.3" = _C9iFFw77;
        "pkg-2.3+mod" = _iq8xIJKd;
        "pkg-2.3a" = _rzE7aGOV;
        "pkg-2.3a+mod" = _AfcVWc8m;
        "pkg-2.3.1" = _O7fMwDpf;
        "pkg-2.3.1+mod" = _AXLoAuNR;
        "pkg-2.4" = _yB2rqt4K;
