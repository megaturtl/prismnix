...
let
    versions = (let
        ...
        _cCxWFdmb = {
            "id" = "cCxWFdmb";
            "file" = "tgbridge-0.9.12-fabric.jar";
            "hash" = "sha512-dxaz32zhsZWa1fycnKS7Zi4Rz/hdBG56d/dcVbgMih+Lfm15Rm+MnHNFEPEswswv3UwFwuL3Hp5GTnlB774dlw==";
        };
        _Ao4Pf5vI = {
            "id" = "Ao4Pf5vI";
            "file" = "tgbridge-0.9.13-fabric.jar";
            "hash" = "sha512-NHYPF6yvTdLaM2YmEWTRnz/7ASYrMQ8nLMErhKxfcyDUOHFpNfrjpiXlTf3gWMk7XmkQEce/gPJx1DKNzos+Pg==";
        };
        _HQJkBAvR = {
            "id" = "HQJkBAvR";
            "file" = "tgbridge-0.9.13-fabric-obf.jar";
            "hash" = "sha512-T9rEkFkgKtYrvWQXl59Nm5wKVw1X3He7wv5rU8u4e4IaS1Z7Yzk0cjBWHtH6iPZU5FtoMUjRL3GRnR6Ps4uHsA==";
        };
        _ciBIa68z = {
            "id" = "ciBIa68z";
            "file" = "tgbridge-0.9.13-paper.jar";
            "hash" = "sha512-AuvV3cpmP6L8WTE3QJusFNH/KVFCfX+X17ql6oA4QlYU2DY1ysipb3tsENYH80mCGLfXWBoHmecGn4n8oWR1gw==";
        };
        _DNmIrDO9 = {
            "id" = "DNmIrDO9";
            "file" = "tgbridge-0.9.13-forge-1.16.5.jar";
            "hash" = "sha512-pkKWPLr1o1rOOs7TLZpsgrezfpYqLHg1UoZoDM0JV4De9HpZrnQcu3yg7VQ4P7JQCEFCOklJWju54cvxAKx+Fg==";
        };
        _Wz9EkZYj = {
            "id" = "Wz9EkZYj";
            "file" = "tgbridge-0.9.13-neoforge-1.21.jar";
            "hash" = "sha512-9rE4GPemr3oBmsNY39Ww0TwrEeqN6kZ7j6UrqWutGaICqgVWnpyX35dPktxAMyrMO/FS1ZyC4ORFmTVMHdOeZw==";
        };
        _iUMYrXbk = {
            "id" = "iUMYrXbk";
            "file" = "tgbridge-0.9.13-forge-1.20.1.jar";
            "hash" = "sha512-awAGAbfcsczAhCiCd41LD07Qc8j9NcNZ/gSUm2NuLoZ6Oq6MDBLiS4MzE/DU9Xw7fvyQr79b117olbrZzKJzug==";
        };
        _b3o6Za0k = {
            "id" = "b3o6Za0k";
            "file" = "tgbridge-0.9.13-forge-1.19.2.jar";
            "hash" = "sha512-VOvDYaNJnUMXqvnyVg1+RvTJUbk+GTc/WdkqxWcj1Sd+Sqo4ZaVA5P1CdwkqFclsKhjPDzAol8fCQuapJP3W5g==";
        };
    in {
        "hAOngPlw" = _hAOngPlw;
        "cP0LqRhL" = _cP0LqRhL;
        ...
        "iUMYrXbk" = _iUMYrXbk;
        "b3o6Za0k" = _b3o6Za0k;
        "fabric-1.19.2" = _HQJkBAvR;
        "fabric-1.20.1" = _HQJkBAvR;
        "fabric-1.20.2" = _HQJkBAvR;
        "fabric-1.20.4" = _HQJkBAvR;
        "fabric-1.20.6" = _HQJkBAvR;
        "fabric-1.21" = _HQJkBAvR;
        "fabric-1.20.3" = _HQJkBAvR;
        "fabric-1.21.1" = _HQJkBAvR;
        "fabric-1.21.2" = _HQJkBAvR;
        "fabric-1.21.3" = _HQJkBAvR;
        "fabric-1.19" = _HQJkBAvR;
        "fabric-1.19.1" = _HQJkBAvR;
        "fabric-1.19.3" = _HQJkBAvR;
        "fabric-1.19.4" = _HQJkBAvR;
        "fabric-1.20" = _HQJkBAvR;
        "fabric-1.20.5" = _HQJkBAvR;
        "fabric-1.21.4" = _HQJkBAvR;
        "fabric-1.21.5" = _HQJkBAvR;
        "fabric-1.21.6" = _HQJkBAvR;
        "fabric-1.21.7" = _HQJkBAvR;
        "fabric-1.21.8" = _HQJkBAvR;
        "fabric-1.21.9" = _HQJkBAvR;
        "fabric-1.21.10" = _HQJkBAvR;
        "fabric-1.21.11" = _HQJkBAvR;
        "fabric-26.1" = _Ao4Pf5vI;
        "fabric-26.1.1" = _Ao4Pf5vI;
        "fabric-26.1.2" = _Ao4Pf5vI;
        "fabric-26.2" = _Ao4Pf5vI;
        "forge-1.19.2" = _b3o6Za0k;
        "forge-1.20.1" = _iUMYrXbk;
        "forge-1.16.5" = _DNmIrDO9;
        "neoforge-1.20.1" = _iUMYrXbk;
        "neoforge-1.21" = _Wz9EkZYj;
        "neoforge-1.21.1" = _Wz9EkZYj;
        "neoforge-1.21.2" = _Wz9EkZYj;
        "neoforge-1.21.3" = _Wz9EkZYj;
        "neoforge-1.21.4" = _Wz9EkZYj;
        "neoforge-1.21.5" = _Wz9EkZYj;
        "paper-1.19.2" = _ciBIa68z;
        "paper-1.20.1" = _ciBIa68z;
        "paper-1.20.4" = _ciBIa68z;
        "paper-1.20.6" = _ciBIa68z;
        "paper-1.19.3" = _ciBIa68z;
        "paper-1.19.4" = _ciBIa68z;
        "paper-1.20" = _ciBIa68z;
        "paper-1.20.2" = _ciBIa68z;
        "paper-1.20.3" = _ciBIa68z;
        "paper-1.20.5" = _ciBIa68z;
        "paper-1.21" = _ciBIa68z;
        "paper-1.21.1" = _ciBIa68z;
        "paper-1.21.2" = _ciBIa68z;
        "paper-1.21.3" = _ciBIa68z;
        "paper-1.19" = _ciBIa68z;
        "paper-1.19.1" = _ciBIa68z;
        "paper-1.21.4" = _ciBIa68z;
        "paper-1.21.5" = _ciBIa68z;
        "paper-1.21.6" = _ciBIa68z;
        "paper-1.21.7" = _ciBIa68z;
        "paper-1.21.8" = _ciBIa68z;
        "paper-1.21.9" = _ciBIa68z;
        "paper-1.21.10" = _ciBIa68z;
        "paper-1.21.11" = _ciBIa68z;
        "paper-26.1" = _ciBIa68z;
        "paper-26.1.1" = _ciBIa68z;
        "paper-26.1.2" = _ciBIa68z;
        "paper-26.2" = _ciBIa68z;
        "folia-1.19.2" = _ciBIa68z;
        "folia-1.19.3" = _ciBIa68z;
        "folia-1.19.4" = _ciBIa68z;
        "folia-1.20" = _ciBIa68z;
        "folia-1.20.1" = _ciBIa68z;
        "folia-1.20.2" = _ciBIa68z;
        "folia-1.20.3" = _ciBIa68z;
        "folia-1.20.4" = _ciBIa68z;
        "folia-1.20.5" = _ciBIa68z;
        "folia-1.20.6" = _ciBIa68z;
        "folia-1.21" = _ciBIa68z;
        "folia-1.21.1" = _ciBIa68z;
        "folia-1.21.2" = _ciBIa68z;
        "folia-1.21.3" = _ciBIa68z;
        "folia-1.19" = _ciBIa68z;
        "folia-1.19.1" = _ciBIa68z;
        "folia-1.21.4" = _ciBIa68z;
        "folia-1.21.5" = _ciBIa68z;
        "folia-1.21.6" = _ciBIa68z;
        "folia-1.21.7" = _ciBIa68z;
        "folia-1.21.8" = _ciBIa68z;
        "folia-1.21.9" = _ciBIa68z;
        "folia-1.21.10" = _ciBIa68z;
        "folia-1.21.11" = _ciBIa68z;
        "folia-26.1" = _ciBIa68z;
        "folia-26.1.1" = _ciBIa68z;
        "folia-26.1.2" = _ciBIa68z;
        "folia-26.2" = _ciBIa68z;
        "purpur-1.19.2" = _ciBIa68z;
        "purpur-1.19.3" = _ciBIa68z;
        "purpur-1.19.4" = _ciBIa68z;
        "purpur-1.20" = _ciBIa68z;
        "purpur-1.20.1" = _ciBIa68z;
        "purpur-1.20.2" = _ciBIa68z;
        "purpur-1.20.3" = _ciBIa68z;
        "purpur-1.20.4" = _ciBIa68z;
        "purpur-1.20.5" = _ciBIa68z;
        "purpur-1.20.6" = _ciBIa68z;
        "purpur-1.21" = _ciBIa68z;
        "purpur-1.21.1" = _ciBIa68z;
        "purpur-1.21.2" = _ciBIa68z;
        "purpur-1.21.3" = _ciBIa68z;
        "purpur-1.19" = _ciBIa68z;
        "purpur-1.19.1" = _ciBIa68z;
        "purpur-1.21.4" = _ciBIa68z;
        "purpur-1.21.5" = _ciBIa68z;
        "purpur-1.21.6" = _ciBIa68z;
        "purpur-1.21.7" = _ciBIa68z;
        "purpur-1.21.8" = _ciBIa68z;
        "purpur-1.21.9" = _ciBIa68z;
        "purpur-1.21.10" = _ciBIa68z;
        "purpur-1.21.11" = _ciBIa68z;
        "purpur-26.1" = _ciBIa68z;
        "purpur-26.1.1" = _ciBIa68z;
        "purpur-26.1.2" = _ciBIa68z;
        "purpur-26.2" = _ciBIa68z;
        "pkg-0.3" = _MPRZkVl3;
        "pkg-0.4" = _iBweuuZF;
        "pkg-0.4.1" = _xRaeil0C;
        "pkg-0.4.2" = _1UtaHIa3;
        ...
        "pkg-0.9.8" = _e8Sa0L23;
        "pkg-0.9.9" = _SJOiTevb;
        "pkg-0.9.10" = _oYYh4vXp;
        "pkg-0.9.11" = _eWFxeV0m;
        "pkg-0.9.12" = _cCxWFdmb;
        "pkg-0.9.13" = _b3o6Za0k;
        "default" = _b3o6Za0k;
    });
