...
let
    versions = (let
        ...
        _UFBNAOCt = {
            "id" = "UFBNAOCt";
            "file" = "balm-forge-1.21.1-21.0.65-all.jar";
            "hash" = "sha512-NVStpoG/Jbm8SamENa8CBa07KHWjcuAfJuT0DlZO3KEuOKZM6BuOcGrWe8UXk5OMQb8oBFBkbo2p7djunbPmUg==";
        };
        _KgypwTqX = {
            "id" = "KgypwTqX";
            "file" = "balm-neoforge-1.21.1-21.0.65.jar";
            "hash" = "sha512-d5tPnpc4rm8BDof3Gy7VoRTrmxs9W1XPQq1TgJTlsGSh0/T/AAZKrJDaHIQaFERk1HN42b/8RIpx2HEyy5VBAQ==";
        };
        _VynBiUHt = {
            "id" = "VynBiUHt";
            "file" = "balm-fabric-1.21.1-21.0.65.jar";
            "hash" = "sha512-jhzBLTV+CfjpQBRoq1ZVpYEj/VYCtztq+otiMVHqHnBNA8GUNk9Pu493ikeDjROasZe53Okz4Kw3G4kkH9T+Hg==";
        };
        _hT8Zt2uD = {
            "id" = "hT8Zt2uD";
            "file" = "balm-fabric-26.2-26.2.0.6.jar";
            "hash" = "sha512-CgtLcfKHer0jTPhTAhZbsFsssOPAt8VD+gwS5a4nHch58wDstvHbsAxqi/XkLkVNTxaKlwoPSmTEqCEivyqPxg==";
        };
        _MKVIBhNe = {
            "id" = "MKVIBhNe";
            "file" = "balm-neoforge-26.2-26.2.0.6.jar";
            "hash" = "sha512-8Ndnrbgqm7zJJ+qcymJ7DC+olJMhNPsu4wio5Sf5mAqxGRTkE0mCWRadYn58pAMclMZXSzjqzcbKwpQ/SkGn5w==";
        };
        _ghVkj8jW = {
            "id" = "ghVkj8jW";
            "file" = "balm-fabric-26.1.2-26.1.2.12.jar";
            "hash" = "sha512-vNZsKfMlnCsrCpm4pA3AHQ4xqLCAi1ZX5ExGJcoRYp5SvapXOwU4RfMZ2oGtplFv+xpuZx1ZaHhxwKAECTRSgA==";
        };
        _Xji7Vn8z = {
            "id" = "Xji7Vn8z";
            "file" = "balm-forge-26.1.2-26.1.2.12.jar";
            "hash" = "sha512-HDv14UF28ZAyyPdZvO6K6sLHQdj8EB+9NyV6QWkFB/3RIDazrpOSsTsCfOJnbxb8K/razkAQs0FdH3B4OB6hlA==";
        };
        _GdCaUVWR = {
            "id" = "GdCaUVWR";
            "file" = "balm-neoforge-26.1.2-26.1.2.12.jar";
            "hash" = "sha512-hq7FYLJT+LMD7zDO7ECx5rlSjzoMHVfEPIyMUH/XEa4WCRTWRL/67o7NY1B7CcMHRkNrAoyYsOZd/vrW7cZh8Q==";
        };
        _tYnUhVmF = {
            "id" = "tYnUhVmF";
            "file" = "balm-fabric-26.2-26.2.0.7.jar";
            "hash" = "sha512-JIvdI0wn3SAwrNskg3jnEVCQFavUXhx7hqEBSvyNPTn2peAaiKNcTY0iPH1swny4Ke737JF1iWaCWQM6n7V3wA==";
        };
        _UnO3FAKK = {
            "id" = "UnO3FAKK";
            "file" = "balm-neoforge-26.2-26.2.0.7.jar";
            "hash" = "sha512-EUUANziJCizQydUkaWbpU8gdF9gR8k1pwkovFAl2t+FP/2TGRnHfTrfTcRimqNl8bTzLXrsO8Lb4OnDlJCwh/A==";
        };
        _zRQbKVJu = {
            "id" = "zRQbKVJu";
            "file" = "balm-fabric-26.1.2-26.1.2.13.jar";
            "hash" = "sha512-T924eyg7YDCEX0PZL50rVpGIU1OMdeZpTkBFWgp5iLHgDg8qgqK/PbHhH9CDKGSY8y/bcXHDCKnXt+Ds1XmKbw==";
        };
        _WCoRyIiq = {
            "id" = "WCoRyIiq";
            "file" = "balm-forge-26.1.2-26.1.2.13.jar";
            "hash" = "sha512-mCswt53idXPu6lfJikxrihDf6C9IR9OsXyXG6NcXuAPRvZoCo1YBGWF/bqzfntWE4+yMwqsNRhUhZDSuI7E9gg==";
        };
        _Az2h3CI2 = {
            "id" = "Az2h3CI2";
            "file" = "balm-neoforge-26.1.2-26.1.2.13.jar";
            "hash" = "sha512-JE/vinX3Rnh/f2esm9oIuixttePBN4LaEjMwGHXklrYiMaCsnI80Jo2sK2kO9hIhtmFi8ZWDGAysp/l/Vu1nnQ==";
        };
        _LcKC6Cxw = {
            "id" = "LcKC6Cxw";
            "file" = "balm-fabric-26.2-26.2.0.8.jar";
            "hash" = "sha512-JDSmZ6eiMA0tHivKGTFn1hsjqVEusaHF5VNohOUsnl6TfeaOwEkrjE88bEyOqyvZiKIxBbtJSGdFjgDnVrI1fw==";
        };
        _lGba52SO = {
            "id" = "lGba52SO";
            "file" = "balm-neoforge-26.2-26.2.0.8.jar";
            "hash" = "sha512-4xgxqPuUxVmo5Q4SOyf34Q2PGWoFPKyC546iyt6ndgM7+bNR4tt9IfAtugzdjwXGDWckv9Jw8RD3TO9gXKXMxg==";
        };
        _UWcOVkf7 = {
            "id" = "UWcOVkf7";
            "file" = "balm-fabric-26.1.2-26.1.2.14.jar";
            "hash" = "sha512-uil7JUqC27EJpL33HmK+dKNz5b2WgWkV0uXoXgbMtDI53k5Ys9ZzqCuaQ+Khj7FYTsLEsgsQ0r08b+Yu1br1MQ==";
        };
        _uKBl6URU = {
            "id" = "uKBl6URU";
            "file" = "balm-forge-26.1.2-26.1.2.14.jar";
            "hash" = "sha512-vPi1l7+fvKNtGFx2PFSs6XLoTTb3id+jZt0arOW4VjglYnSh8ljAlk3N8Qy7cM6gbzMqX6SDw9dNDUkbR9w52A==";
        };
        _XfUUh0yW = {
            "id" = "XfUUh0yW";
            "file" = "balm-neoforge-26.1.2-26.1.2.14.jar";
            "hash" = "sha512-+tME1Zp0VUCLq9o+MHMeR91BBTHXHFQDV6nIHet49ynWxlOGKjUWkusdkIjeLbGkJBQYoSHJIsxg0PXhlMdkUg==";
        };
        _wIUUe8by = {
            "id" = "wIUUe8by";
            "file" = "balm-fabric-1.20.1-7.3.43.jar";
            "hash" = "sha512-XTh2CsqsdpUsl4EdiyWgljBN1/gdn3yPslYVWWtIr9VXHxplxuc0rn9WxnQSsRZ1UX5aNFfs/wRo01WjKqDAUw==";
        };
        _1VlYVa3k = {
            "id" = "1VlYVa3k";
            "file" = "balm-forge-1.20.1-7.3.43.jar";
            "hash" = "sha512-n3aPNbDlbhqqoLn2kMNJDlLjulS/X1KXQsB/k/mRpM22h5s2MDgmhOu3W4GV/hrInXDEXX2Tl7CW8BQXLA85AQ==";
        };
        _gbPO54rd = {
            "id" = "gbPO54rd";
            "file" = "balm-neoforge-26.3-26.3.0.1.jar";
            "hash" = "sha512-9aZEC8heWSq5Br/L99JCl79NkWe5CK8XD8q0iI2fyS74f4BzxdahdlyxVRP0341crwf0ej1QoF5Icwxze6e+1A==";
        };
        _fPwhz0pb = {
            "id" = "fPwhz0pb";
    ...
    in {
        ...
        "pkg-4.1.0+forge-1.19" = _DIjNWWDQ;
        "pkg-4.2.0+0+fabric-1.19" = _3FaeA4B3;
        "pkg-4.2.0+forge-1.19" = _pLCLIILr;
        "pkg-4.3.0+0+fabric-1.19" = _KHoU8dQ1;
        "pkg-4.3.0+forge-1.19" = _U6WiexwY;
        "pkg-4.4.0+forge-1.19" = _KGco8pn9;
        "pkg-4.5.0+forge-1.19" = _3gG05xht;
        "pkg-4.5.2+forge-1.19" = _yCm0MvD8;
        "pkg-4.5.2+0+fabric-1.19" = _bv4c7vz6;
        "pkg-4.5.3+forge-1.19" = _HaskpkVN;
        "pkg-3.2.0+forge-1.8.2" = _rLFLPShY;
        "pkg-3.2.0+fabric-1.8.2" = _vtPaYjej;
        "pkg-5.0.0+forge-1.19.3" = _jLBnf4l1;
        "pkg-5.0.1+forge-1.19.3" = _i5Q1d7Pr;
        "pkg-5.0.1+fabric-1.19.3" = _TQMftlzA;
        "pkg-5.0.2+forge-1.19.3" = _ZI4feWbU;
        "pkg-5.0.2+fabric-1.19.3" = _SLR7Xv0p;
        "pkg-3.2.2+forge-1.18.2" = _AhzvhBQj;
        "pkg-3.2.2+fabric-1.18.2" = _oqGuqpwK;
        "pkg-3.2.3+forge-1.18.2" = _DENsCzBf;
        "pkg-4.5.4+forge-1.19.2" = _nErKcTp9;
        "pkg-4.5.4+fabric-1.19.2" = _xAQtenTo;
        "pkg-3.2.3+fabric-1.18.2" = _1pxcbuZv;
        "pkg-5.0.3+forge-1.19.3" = _840UhUoL;
        "pkg-5.0.3+fabric-1.19.3" = _9XoBRgjV;
        "pkg-3.2.5+fabric-1.18.2" = _6X6csbpx;
        "pkg-3.2.5+forge-1.18.2" = _nFs2ZvOR;
        "pkg-4.5.6+forge-1.19.2" = _NhlpDRNn;
        "pkg-4.5.6+fabric-1.19.2" = _zq3nXKQW;
        "pkg-6.0.1+forge-1.19.4" = _TbFmWuAA;
        "pkg-6.0.1+fabric-1.19.4" = _O2nbMbp5;
        "pkg-4.5.7+forge-1.19.2" = _C60k8eYK;
        "pkg-4.5.7+fabric-1.19.2" = _XYqAzGqP;
        "pkg-6.0.2+forge-1.19.4" = _XNus763a;
        "pkg-6.0.2+fabric-1.19.4" = _qUWyGBdD;
        "pkg-3.2.6+forge-1.18.2" = _RAATKbAN;
        "pkg-3.2.6+fabric-1.18.2" = _uATqqu4e;
        "pkg-5.0.4+forge-1.19.3" = _lRKNKP0w;
        "pkg-5.0.4+fabric-1.19.3" = _ONL5pq9r;
        "pkg-7.0.1+fabric-1.20" = _FDkt1ohj;
        "pkg-7.0.1+forge-1.20" = _o7IqP6Td;
        "pkg-7.0.2+fabric-1.20" = _DAOUt1Jg;
        "pkg-7.0.2+forge-1.20" = _VYTPVkW0;
        "pkg-7.0.3+fabric-1.20" = _RXK9iX99;
        "pkg-7.0.3+forge-1.20" = _wiayzjLV;
        "pkg-7.0.4+fabric-1.20" = _rbUpGzGA;
        "pkg-7.0.4+forge-1.20" = _i8CwYuCi;
        "pkg-7.0.7+fabric-1.20" = _I5betUED;
        "pkg-7.0.7+forge-1.20" = _NRF4uKO7;
        "pkg-4.6.0+fabric-1.19.2" = _c1GjX2k1;
        "pkg-7.1.0+fabric-1.20" = _Zq0Ko2UQ;
        "pkg-4.6.0+forge-1.19.2" = _d7a0S3hj;
        "pkg-7.1.0+forge-1.20" = _l551HLmO;
        "pkg-7.1.1+fabric-1.20" = _BLkvfQ2x;
        "pkg-7.1.1+forge-1.20" = _CO57SmJl;
        "pkg-7.1.2+forge-1.20.1" = _ffUlrjOr;
        "pkg-7.1.2+fabric-1.20.1" = _jdk8u9nq;
        "pkg-7.1.3+fabric-1.20.1" = _x70MCuv3;
        "pkg-7.1.3+forge-1.20.1" = _sBs7NeXN;
        "pkg-7.1.4+fabric-1.20.1" = _BJ0Uk3Di;
        "pkg-7.1.4+forge-1.20.1" = _fFosgnEu;
        "pkg-8.0.1+fabric-1.20.2" = _qHXzOzUv;
        "pkg-8.0.1+forge-1.20.2" = _YL5MVHnr;
        "pkg-8.0.2+fabric-1.20.2" = _N4NxIVYC;
        "pkg-8.0.2+forge-1.20.2" = _jPAtAJcJ;
        "pkg-8.0.2+neoforge-1.20.2" = _RYxPLFUw;
        "pkg-8.0.3+neoforge-1.20.2" = _NMOJStju;
        "pkg-7.2.1+fabric-1.20.1" = _qIAY6mKt;
        "pkg-7.2.1+forge-1.20.1" = _JUrMdJP1;
        "pkg-8.0.4+neoforge-1.20.2" = _VIE9sG8O;
        "pkg-8.0.5+fabric-1.20.2" = _f6LbzxNL;
        "pkg-8.0.5+forge-1.20.2" = _TGc6wvHK;
        "pkg-8.0.5+neoforge-1.20.2" = _lt2lEcIY;
        "pkg-9.0.1+fabric-1.20.4" = _1hau5QwF;
        "pkg-9.0.1+forge-1.20.4" = _VH4LTqFp;
        "pkg-9.0.1+neoforge-1.20.4" = _H0a9rBTV;
        "pkg-9.0.2+fabric-1.20.4" = _6ryA9MPE;
        "pkg-9.0.2+forge-1.20.4" = _Q0xpW61Y;
        "pkg-9.0.2+neoforge-1.20.4" = _hDWb6gW2;
        "pkg-9.0.3+fabric-1.20.4" = _7rTXTEe7;
        "pkg-9.0.3+forge-1.20.4" = _uZyJkfxk;
        "pkg-9.0.3+neoforge-1.20.4" = _SLbLamWu;
        "pkg-9.0.4+forge-1.20.4" = _ZuihLitZ;
        "pkg-9.0.4+fabric-1.20.4" = _C95JH5YK;
        "pkg-9.0.4+neoforge-1.20.4" = _zXq0pj5R;
        "pkg-9.0.5+fabric-1.20.4" = _VhfHxcat;
        "pkg-9.0.5+forge-1.20.4" = _2OHf9GyZ;
        "pkg-9.0.5+neoforge-1.20.4" = _QiuQRA7s;
        "pkg-9.0.6+fabric-1.20.4" = _kjIgNYGA;
        "pkg-9.0.6+forge-1.20.4" = _tC2vMFuQ;
        "pkg-9.0.6+neoforge-1.20.4" = _AUJXa9xo;
        "pkg-7.2.2+fabric-1.20.1" = _v1tAteat;
        "pkg-7.2.2+forge-1.20.1" = _fzqus8s0;
        "pkg-9.0.7+fabric-1.20.4" = _U79V1VMr;
        "pkg-9.0.7+forge-1.20.4" = _OjHYTM4n;
        "pkg-9.0.7+neoforge-1.20.4" = _z5z8sM4m;
        "pkg-9.0.8+fabric-1.20.4" = _ctu48FWB;
        "pkg-9.0.8+forge-1.20.4" = _StgsQbVh;
        "pkg-9.0.8+neoforge-1.20.4" = _vFLrqKU8;
        "pkg-9.0.9+fabric-1.20.4" = _2e2nF2M9;
        "pkg-9.0.9+forge-1.20.4" = _WYvcCUer;
        "pkg-9.0.9+neoforge-1.20.4" = _Rr2heMKC;
        "pkg-10.0.1+1.20.6+fabric-1.20.6" = _GAFne6x4;
        "pkg-10.0.1+1.20.6+forge-1.20.6" = _huCbvMtN;
        "pkg-10.0.1+1.20.6+neoforge-1.20.6" = _vDreKB60;
        "pkg-10.0.2+fabric-1.20.6" = _nw61Pdsu;
        "pkg-10.0.2+forge-1.20.6" = _OYyizALG;
        "pkg-10.0.2+neoforge-1.20.6" = _8wgOo6Ga;
        "pkg-10.1.1+fabric-1.20.6" = _Bb8wmAjY;
        "pkg-10.1.1+forge-1.20.6" = _JWCXyAFI;
        "pkg-10.1.1+neoforge-1.20.6" = _ui9UH4JU;
        "pkg-10.2.1+forge-1.20.6" = _mFgQD0wf;
        "pkg-10.2.1+fabric-1.20.6" = _oNCXVrO2;
        "pkg-10.2.1+neoforge-1.20.6" = _NcO6IJys;
        "pkg-10.3.2+fabric-1.20.6" = _hmjqCs6P;
        "pkg-10.3.2+forge-1.20.6" = _Kqi0IFWL;
        "pkg-10.3.2+neoforge-1.20.6" = _uWfkL77n;
        "pkg-7.3.3+fabric-1.20.1" = _8W86abn7;
        "pkg-7.3.3+forge-1.20.1" = _PlicZHtx;
        "pkg-7.3.4+fabric-1.20.1" = _de1sItvo;
        "pkg-7.3.4+forge-1.20.1" = _sMLLTEoG;
        "pkg-21.0.1+fabric-1.21" = _HbJsYDug;
        "pkg-21.0.1+forge-1.21" = _gkaYm86D;
        "pkg-21.0.1+neoforge-1.21" = _3gqKHTeW;
        "pkg-21.0.4+fabric-1.21" = _vCTOJkNm;
        "pkg-21.0.4+forge-1.21" = _hAD7vTyA;
        "pkg-21.0.4+neoforge-1.21" = _7caOiXka;
        "pkg-21.0.5+forge-1.21" = _RV5SSz4D;
        "pkg-21.0.5+fabric-1.21" = _nEvbheGT;
        "pkg-21.0.5+neoforge-1.21" = _pOkJbXvW;
        "pkg-21.0.6+fabric-1.21" = _CefwKYLr;
        "pkg-21.0.6+forge-1.21" = _zWTNqB6D;
        "pkg-21.0.6+neoforge-1.21" = _k2kcNYeQ;
        "pkg-21.0.7+fabric-1.21" = _DJFGAs9Y;
        "pkg-10.3.3+fabric-1.20.6" = _RJLjsEUW;
        "pkg-21.0.7+forge-1.21" = _wxmX5QHo;
        "pkg-10.3.3+forge-1.20.6" = _KGIMKUgn;
        "pkg-21.0.7+neoforge-1.21" = _wuxxrMPw;
        "pkg-10.3.3+neoforge-1.20.6" = _Td8Oo2Gu;
        "pkg-10.3.4+fabric-1.20.6" = _e2H9OL5X;
        "pkg-10.3.4+forge-1.20.6" = _s29lt6Zh;
        "pkg-10.3.4+neoforge-1.20.6" = _oQBUrm9F;
        "pkg-21.0.8+fabric-1.21" = _b7Q7HRZD;
        "pkg-7.3.6+fabric-1.20.1" = _YGxMJ2Hv;
        "pkg-21.0.8+forge-1.21" = _tM8zF89C;
        "pkg-7.3.6+forge-1.20.1" = _WyhvCQj3;
        "pkg-10.3.5+fabric-1.20.6" = _8RGUWLPR;
        "pkg-21.0.8+neoforge-1.21" = _XglmmWsG;
        "pkg-10.3.5+forge-1.20.6" = _jLxcayMK;
        "pkg-10.3.5+neoforge-1.20.6" = _te3dfDiN;
        "pkg-21.0.9+fabric-1.21" = _1PZPYo6D;
        "pkg-21.0.9+forge-1.21" = _w3go4VXD;
        "pkg-21.0.9+neoforge-1.21" = _rGJbXEKn;
        "pkg-21.0.10+fabric-1.21" = _yWclRdjf;
        "pkg-21.0.10+forge-1.21" = _mzFmDC1Y;
        "pkg-21.0.10+neoforge-1.21" = _JyUWCsbN;
        "pkg-10.3.6+fabric-1.20.6" = _A65ALFtK;
        "pkg-21.0.11+forge-1.21" = _2LJ9NkXc;
        "pkg-21.0.11+fabric-1.21" = _ryOwjzmq;
        "pkg-10.3.6+forge-1.20.6" = _22lhs0MW;
        "pkg-21.0.11+neoforge-1.21" = _InVQrh0j;
        "pkg-10.3.6+neoforge-1.20.6" = _lRDrMehk;
        "pkg-21.0.12+fabric-1.21" = _m9c4BAuv;
        "pkg-21.0.12+forge-1.21" = _s798wETE;
        "pkg-21.0.12+neoforge-1.21" = _G14DerBs;
        "pkg-21.0.13+fabric-1.21" = _NelcQPdv;
        "pkg-21.0.13+forge-1.21" = _QEbBVP8S;
        "pkg-21.0.13+neoforge-1.21" = _VCJs63iY;
        "pkg-21.0.14+fabric-1.21" = _6wqJaTSm;
        "pkg-21.0.14+forge-1.21" = _d0QFp1oD;
        "pkg-21.0.14+neoforge-1.21" = _l0EC6aJQ;
        "pkg-7.3.7+fabric-1.20.1" = _mQSYta9T;
        "pkg-7.3.7+forge-1.20.1" = _Lj3KLOAy;
        "pkg-21.0.15+forge-1.21.1" = _wy39J2LP;
        "pkg-21.0.15+fabric-1.21.1" = _Pz0YXByM;
        "pkg-21.0.15+neoforge-1.21.1" = _a1y9YTA2;
        "pkg-7.3.8+forge-1.20.1" = _Bt3mpBBN;
        "pkg-7.3.8+fabric-1.20.1" = _mJ8wCA3K;
        "pkg-21.0.16+fabric-1.21.1" = _21IOe1WR;
        "pkg-21.0.16+forge-1.21.1" = _fyKFyLbS;
        "pkg-21.0.16+neoforge-1.21.1" = _Ax2lQmwv;
        "pkg-21.0.17+neoforge-1.21.1" = _9VcpqJGP;
        "pkg-21.0.17+forge-1.21.1" = _q5TNAWDr;
        "pkg-21.0.17+fabric-1.21.1" = _YYlBLgFe;
        "pkg-7.3.9+fabric-1.20.1" = _5sowswPx;
        "pkg-7.3.9+forge-1.20.1" = _UTwD7ASf;
        "pkg-21.0.18+fabric-1.21.1" = _6dSXSX49;
        "pkg-21.0.18+forge-1.21.1" = _pUoGSV6e;
        "pkg-21.0.18+neoforge-1.21.1" = _u4mvGZe4;
        "pkg-21.0.19+fabric-1.21.1" = _jVeu9BFB;
        "pkg-21.0.19+neoforge-1.21.1" = _m94H9ubB;
        "pkg-21.0.19+forge-1.21.1" = _Yft7GUiY;
        "pkg-21.0.20+fabric-1.21.1" = _8y2siHEz;
        "pkg-21.0.20+forge-1.21.1" = _efVD2zO8;
        "pkg-21.0.20+neoforge-1.21.1" = _PRTR6jqR;
        "pkg-21.3.1+fabric-1.21.3" = _I6Z4xbGW;
        "pkg-21.3.1+neoforge-1.21.3" = _Gwh9k2rH;
        "pkg-21.3.2+fabric-1.21.3" = _SzmffAxL;
        "pkg-21.3.2+neoforge-1.21.3" = _Wfapcg9h;
        "pkg-21.3.3+fabric-1.21.3" = _Kv7y936M;
        "pkg-21.3.3+neoforge-1.21.3" = _YjFiCJTj;
        "pkg-21.4.1+fabric-1.21.4" = _2vXqBYtG;
        "pkg-21.4.1+neoforge-1.21.4" = _wa5ZBotq;
        "pkg-7.3.10+fabric-1.20.1" = _SdRZPngG;
        "pkg-7.3.10+forge-1.20.1" = _9hXDXsUQ;
        "pkg-21.4.3+fabric-1.21.4" = _IgyIRodd;
        "pkg-21.4.3+neoforge-1.21.4" = _9qmu2VdG;
        "pkg-21.0.21+fabric-1.21.1" = _BfCRlMSL;
        "pkg-21.0.21+neoforge-1.21.1" = _RFczRjWV;
        "pkg-21.0.21+forge-1.21.1" = _ns9gZzza;
        "pkg-21.3.4+fabric-1.21.3" = _qKUbajyo;
        "pkg-21.4.4+fabric-1.21.4" = _DcbUobDA;
        "pkg-21.4.4+neoforge-1.21.4" = _QvdBjX7A;
        "pkg-21.3.4+neoforge-1.21.3" = _w3OL8sOS;
        "pkg-21.0.22+fabric-1.21.1" = _duZve3P5;
        "pkg-21.0.22+forge-1.21.1" = _vuUfOo0h;
        "pkg-21.0.22+neoforge-1.21.1" = _Ugl92Mbv;
        "pkg-21.4.5+fabric-1.21.4" = _9pTQ0wCu;
        "pkg-21.4.5+neoforge-1.21.4" = _DRp6Tdey;
        "pkg-21.3.5+fabric-1.21.3" = _qlXJq5D1;
        "pkg-21.3.5+neoforge-1.21.3" = _BlvtUP6m;
        "pkg-7.3.11+forge-1.20.1" = _YTL0DSNu;
        "pkg-7.3.11+fabric-1.20.1" = _n7vxIoYf;
        "pkg-21.0.23+fabric-1.21.1" = _G5ueMpLg;
        "pkg-21.0.23+neoforge-1.21.1" = _hnyIvGtR;
        "pkg-21.0.23+forge-1.21.1" = _FgVATrlS;
        "pkg-21.4.6+fabric-1.21.4" = _6yIBlv3N;
        "pkg-21.4.6+neoforge-1.21.4" = _KEqsHz3O;
        "pkg-21.4.7+forge-1.21.4" = _JoLSySp3;
        "pkg-21.4.8+forge-1.21.4" = _sgU61YPe;
        "pkg-7.3.13+forge-1.20.1" = _zR3RKvQH;
        "pkg-7.3.13+fabric-1.20.1" = _AzJ3ukdS;
        "pkg-21.0.25+fabric-1.21.1" = _uyooFvZR;
        "pkg-21.4.10+fabric-1.21.4" = _t7U8f4LJ;
        "pkg-21.0.25+forge-1.21.1" = _K138QoP3;
        "pkg-21.4.10+forge-1.21.4" = _SlEm6vao;
        "pkg-21.4.10+neoforge-1.21.4" = _fHcHUZMG;
        "pkg-21.0.25+neoforge-1.21.1" = _9QEaEl5P;
        "pkg-7.3.14+forge-1.20.1" = _CxydJE3Z;
        "pkg-7.3.14+fabric-1.20.1" = _bCtueaUE;
        "pkg-21.0.26+fabric-1.21.1" = _lHwKr8gq;
        "pkg-21.0.26+forge-1.21.1" = _vbiK1a97;
        "pkg-21.0.26+neoforge-1.21.1" = _6LqdViPR;
        "pkg-21.4.11+fabric-1.21.4" = _hXpwACDW;
        "pkg-21.4.11+forge-1.21.4" = _baTlhMdK;
        "pkg-21.4.11+neoforge-1.21.4" = _3TCLTB4c;
        "pkg-7.3.15+fabric-1.20.1" = _r4g4uBoU;
        "pkg-7.3.15+forge-1.20.1" = _3qfHtqyO;
        "pkg-21.0.27+neoforge-1.21.1" = _8EUFs9c1;
        "pkg-21.0.27+forge-1.21.1" = _ATifF9w8;
        "pkg-21.0.27+fabric-1.21.1" = _iLXgPdTf;
        "pkg-21.4.12+fabric-1.21.4" = _VHEiQbKP;
        "pkg-21.4.12+forge-1.21.4" = _sUYeI49r;
        "pkg-21.4.12+neoforge-1.21.4" = _VMPyGpPb;
        "pkg-7.3.16+forge-1.20.1" = _Xr2dC1pl;
        "pkg-7.3.16+fabric-1.20.1" = _WtPIs8I7;
        "pkg-21.0.28+fabric-1.21.1" = _oVlRAOcv;
        "pkg-21.0.28+forge-1.21.1" = _W8GSmdIU;
        "pkg-21.0.28+neoforge-1.21.1" = _cFE7IoYL;
        "pkg-21.4.13+fabric-1.21.4" = _zYgpZYpw;
        "pkg-21.4.13+forge-1.21.4" = _i2EwAoxm;
        "pkg-21.4.13+neoforge-1.21.4" = _RSh734TO;
        "pkg-7.3.17+fabric-1.20.1" = _5kZFe7Nq;
        "pkg-7.3.17+forge-1.20.1" = _DJNCH0k5;
        "pkg-21.0.30+fabric-1.21.1" = _KOgHXlRS;
        "pkg-21.0.30+forge-1.21.1" = _EFm77EXv;
        "pkg-21.0.30+neoforge-1.21.1" = _uzofnSSx;
        "pkg-21.4.15+fabric-1.21.4" = _kjfAvob0;
        "pkg-21.4.15+forge-1.21.4" = _uqwT4Spw;
        "pkg-21.4.15+neoforge-1.21.4" = _R3gsGBLP;
        "pkg-21.4.16+forge-1.21.4" = _3s1HLpiH;
        "pkg-21.4.16+fabric-1.21.4" = _EbQ2YzPi;
        "pkg-21.4.16+neoforge-1.21.4" = _ouZ8513O;
        "pkg-7.3.18+fabric-1.20.1" = _OLj7g6Pc;
        "pkg-7.3.18+forge-1.20.1" = _za1mJSJs;
        "pkg-21.0.31+fabric-1.21.1" = _TAOBvHf7;
        "pkg-21.4.17+fabric-1.21.4" = _NODTCLrs;
        "pkg-21.0.31+neoforge-1.21.1" = _Cp67Kb0j;
        "pkg-21.4.17+forge-1.21.4" = _ZbMIClz9;
        "pkg-21.4.17+neoforge-1.21.4" = _MpaTF7vw;
        "pkg-21.0.31+forge-1.21.1" = _kTf5YlPI;
        "pkg-7.3.19+fabric-1.20.1" = _b7GNN6oY;
        "pkg-7.3.19+forge-1.20.1" = _LGk00XTM;
        "pkg-21.0.32+fabric-1.21.1" = _KDJT1qkf;
        "pkg-21.0.32+neoforge-1.21.1" = _5kR9KELE;
        "pkg-21.0.32+forge-1.21.1" = _rvFfLkjw;
        "pkg-21.4.18+fabric-1.21.4" = _8JcYtZGE;
        "pkg-21.4.18+forge-1.21.4" = _B7EgsHZI;
        "pkg-21.4.18+neoforge-1.21.4" = _x8v84eqq;
        "pkg-7.3.20+fabric-1.20.1" = _JmgR9jSx;
        "pkg-21.0.33+forge-1.21.1" = _f1WyeGsb;
        "pkg-7.3.20+forge-1.20.1" = _m4NlBwVG;
        "pkg-21.0.33+neoforge-1.21.1" = _MNDed3BG;
        "pkg-21.4.19+fabric-1.21.4" = _SA7C57o4;
        "pkg-21.4.19+forge-1.21.4" = _zMBxbYcz;
        "pkg-21.4.19+neoforge-1.21.4" = _fJzeSrvw;
        "pkg-21.0.33+fabric-1.21.1" = _uwr5s6Sk;
        "pkg-7.3.24+fabric-1.20.1" = _A7H7pSdx;
        "pkg-21.0.35+fabric-1.21.1" = _qhyCHmSE;
        "pkg-7.3.24+forge-1.20.1" = _r5y3H4Qm;
        "pkg-21.4.21+fabric-1.21.4" = _OKSM5l4q;
        "pkg-21.0.35+forge-1.21.1" = _hYjfJlgy;
        "pkg-21.0.35+neoforge-1.21.1" = _bO9nqqGb;
        "pkg-21.4.21+forge-1.21.4" = _V1jQpnCc;
        "pkg-21.4.21+neoforge-1.21.4" = _kwxgBqpz;
        "pkg-7.3.25+fabric-1.20.1" = _1yrwFXVG;
        "pkg-7.3.25+forge-1.20.1" = _hk6Zuxrh;
        "pkg-21.0.36+fabric-1.21.1" = _iL0lkmWx;
        "pkg-21.4.22+forge-1.21.4" = _oIAab3Pm;
        "pkg-21.4.22+neoforge-1.21.4" = _JmituuoG;
        "pkg-21.4.22+fabric-1.21.4" = _x4uPXWNU;
        "pkg-21.0.36+neoforge-1.21.1" = _NGTcsYW5;
        "pkg-21.0.36+forge-1.21.1" = _sVpV7JJG;
        "pkg-21.5.1+fabric-1.21.5-rc2" = _gaFcNISh;
        "pkg-21.5.3+fabric-1.21.5" = _R2PflFrF;
        "pkg-21.5.3+neoforge-1.21.5" = _DZ6RZTck;
        "pkg-21.5.4+fabric-1.21.5" = _i5Ohfqrj;
        "pkg-21.5.4+neoforge-1.21.5" = _GJ33no0w;
        "pkg-21.4.23+fabric-1.21.4" = _rHuOL8Ai;
        "pkg-21.0.37+fabric-1.21.1" = _MntVeQ7Y;
        "pkg-21.4.23+forge-1.21.4" = _XcdA7WZl;
        "pkg-21.0.37+neoforge-1.21.1" = _8YoOUj00;
        "pkg-21.0.37+forge-1.21.1" = _87QazKmi;
        "pkg-7.3.26+fabric-1.20.1" = _U5Vkg6U1;
        "pkg-21.4.23+neoforge-1.21.4" = _IMVOUwdb;
        "pkg-7.3.26+forge-1.20.1" = _v2b8ksFI;
        "pkg-21.5.5+fabric-1.21.5" = _vEkSFpmx;
        "pkg-21.5.5+neoforge-1.21.5" = _ZRfbZoSl;
        "pkg-21.5.6+forge-1.21.5" = _zUWBYHnz;
        "pkg-21.5.7+forge-1.21.5" = _3UGYADRL;
        "pkg-7.3.27+fabric-1.20.1" = _UqThQVCU;
        "pkg-7.3.27+forge-1.20.1" = _GmMJVPH4;
        "pkg-21.0.38+fabric-1.21.1" = _k3wTsSyM;
        "pkg-21.4.24+fabric-1.21.4" = _jK8VR0pE;
        "pkg-21.5.8+fabric-1.21.5" = _JwhBL8Nb;
        "pkg-21.5.8+forge-1.21.5" = _RcE04OxH;
        "pkg-21.5.8+neoforge-1.21.5" = _obSWlJaV;
        "pkg-21.0.38+neoforge-1.21.1" = _lKZ9zlPP;
        "pkg-21.0.38+forge-1.21.1" = _U9WkDvEP;
        "pkg-21.4.24+forge-1.21.4" = _f2YlhVaX;
        "pkg-21.4.24+neoforge-1.21.4" = _ftHMNGBi;
        "pkg-21.4.25+forge-1.21.4" = _r7VBmOQp;
        "pkg-21.4.25+fabric-1.21.4" = _44OTpWlP;
        "pkg-21.4.25+neoforge-1.21.4" = _UkuvV37H;
        "pkg-21.5.9+fabric-1.21.5" = _GsLZWhdZ;
        "pkg-21.5.9+forge-1.21.5" = _UVpDqyLI;
        "pkg-21.5.9+neoforge-1.21.5" = _HyElm8TP;
        "pkg-21.5.10+forge-1.21.5" = _WU7VLtPQ;
        "pkg-21.5.10+neoforge-1.21.5" = _T7jkPmAx;
        "pkg-21.4.26+neoforge-1.21.4" = _LQNvc5wE;
        "pkg-21.4.26+forge-1.21.4" = _7qRrIS2m;
        "pkg-21.4.27+forge-1.21.4" = _WVVScfJl;
        "pkg-21.5.11+forge-1.21.5" = _ymnsbgDR;
        "pkg-21.4.28+fabric-1.21.4" = _OtvlX1P9;
        "pkg-21.0.39+fabric-1.21.1" = _zHMzPRdK;
        "pkg-21.0.39+neoforge-1.21.1" = _PNowGfMx;
        "pkg-21.0.39+forge-1.21.1" = _7M2fnZoU;
        "pkg-21.4.29+fabric-1.21.4" = _gghh7M8P;
        "pkg-21.4.29+forge-1.21.4" = _vkIFyMAo;
        "pkg-21.4.29+neoforge-1.21.4" = _6cwvnrA8;
        "pkg-21.0.40+fabric-1.21.1" = _JKkHl8YO;
        "pkg-21.0.40+forge-1.21.1" = _sJZN7hCg;
        "pkg-21.0.40+neoforge-1.21.1" = _cAw1KTfb;
        "pkg-21.5.12+fabric-1.21.5" = _NtxWhyZm;
        "pkg-21.5.12+forge-1.21.5" = _ap9F234J;
        "pkg-21.5.12+neoforge-1.21.5" = _FpUYc3zI;
        "pkg-21.4.30+fabric-1.21.4" = _4eNQ5bAt;
        "pkg-21.0.41+forge-1.21.1" = _AbDJ4A1e;
        "pkg-21.0.41+neoforge-1.21.1" = _RDQPXjgQ;
        "pkg-21.4.30+neoforge-1.21.4" = _6RwwetVT;
        "pkg-21.4.30+forge-1.21.4" = _anGH2Cky;
        "pkg-21.0.41+fabric-1.21.1" = _yylFzYuh;
        "pkg-21.5.13+fabric-1.21.5" = _bfXDPcw2;
        "pkg-21.5.13+forge-1.21.5" = _cxHNlOPp;
        "pkg-21.5.13+neoforge-1.21.5" = _W4E98a8A;
        "pkg-21.5.14+fabric-1.21.5" = _FWEgPSgs;
        "pkg-21.5.14+forge-1.21.5" = _gNKhG9zo;
        "pkg-21.5.14+neoforge-1.21.5" = _hpdkniHH;
        "pkg-21.5.15+fabric-1.21.5" = _xkrW9GOS;
        "pkg-21.5.15+forge-1.21.5" = _mY3G9pHO;
        "pkg-21.5.15+neoforge-1.21.5" = _gknCKod9;
        "pkg-21.4.31+fabric-1.21.4" = _Ps54lG7P;
        "pkg-21.4.31+forge-1.21.4" = _Bm6LqEdn;
        "pkg-21.4.31+neoforge-1.21.4" = _PSgd182t;
        "pkg-21.0.42+neoforge-1.21.1" = _oksaxo5x;
        "pkg-21.0.42+fabric-1.21.1" = _TyrSLdpr;
        "pkg-21.0.43+forge-1.21.1" = _jcBu8Z9e;
        "pkg-7.3.28+fabric-1.20.1" = _tXBMGkPW;
        "pkg-7.3.28+forge-1.20.1" = _KFWVY8Qv;
        "pkg-7.3.29+fabric-1.20.1" = _yGYOecut;
        "pkg-7.3.29+forge-1.20.1" = _VSVCZFqo;
        "pkg-21.5.16+fabric-1.21.5" = _EfvDjSgk;
        "pkg-21.0.44+fabric-1.21.1" = _KNh0OFys;
        "pkg-21.5.16+forge-1.21.5" = _z6SNuQTd;
        "pkg-21.5.16+neoforge-1.21.5" = _4kQAPDJG;
        "pkg-21.0.44+neoforge-1.21.1" = _zCq436dh;
        "pkg-21.0.44+forge-1.21.1" = _YIv7i5xk;
        "pkg-21.4.32+fabric-1.21.4" = _3PsNXCbV;
        "pkg-21.4.32+forge-1.21.4" = _x3CmlMdD;
        "pkg-21.4.32+neoforge-1.21.4" = _XwuBwvmp;
        "pkg-7.3.30+fabric-1.20.1" = _MvT9HWg0;
        "pkg-7.3.30+forge-1.20.1" = _KQwDHwmX;
        "pkg-21.0.45+fabric-1.21.1" = _oMDgFhLP;
        "pkg-21.0.45+forge-1.21.1" = _LISerNaJ;
        "pkg-21.0.45+neoforge-1.21.1" = _xypGjGf7;
        "pkg-21.4.33+fabric-1.21.4" = _urF0zb9k;
        "pkg-21.4.33+forge-1.21.4" = _ld9AfLoF;
        "pkg-21.4.33+neoforge-1.21.4" = _ROMoAHyb;
        "pkg-7.3.31+fabric-1.20.1" = _x05ZVyBJ;
        "pkg-7.3.31+forge-1.20.1" = _jxGSAI51;
        "pkg-21.5.17+fabric-1.21.5" = _KHiNGdha;
        "pkg-21.0.46+fabric-1.21.1" = _CuNotPQG;
        "pkg-21.0.46+neoforge-1.21.1" = _YgPFqhlP;
        "pkg-21.5.17+forge-1.21.5" = _hNtRDhce;
        "pkg-21.0.46+forge-1.21.1" = _DxqYNJVW;
        "pkg-21.5.17+neoforge-1.21.5" = _zadIcX9S;
        "pkg-21.4.34+fabric-1.21.4" = _ZuiU8cLR;
        "pkg-21.4.34+forge-1.21.4" = _CE8m0uiC;
        "pkg-21.4.34+neoforge-1.21.4" = _tNtzcb8d;
        "pkg-21.6.1+fabric-1.21.6" = _4arCr13S;
        "pkg-21.6.1+neoforge-1.21.6" = _BK2eFWOA;
        "pkg-21.6.2+forge-1.21.6" = _a67xetjY;
        "pkg-21.6.3+neoforge-1.21.6" = _euC5n4mT;
        "pkg-21.7.2+fabric-1.21.7" = _l2DAvB9Q;
        "pkg-21.7.2+forge-1.21.7" = _uEOxakJ3;
        "pkg-21.7.2+neoforge-1.21.7" = _RZHWDntO;
        "pkg-7.3.32+forge-1.20.1" = _LP848Yrz;
        "pkg-7.3.32+fabric-1.20.1" = _DIMtxeK0;
        "pkg-21.4.35+fabric-1.21.4" = _v7KfFBrV;
        "pkg-21.4.35+forge-1.21.4" = _YTdFftw9;
        "pkg-21.5.18+fabric-1.21.5" = _fGnhJqX1;
        "pkg-21.4.35+neoforge-1.21.4" = _oOJ7tkG5;
        "pkg-21.5.18+forge-1.21.5" = _fKF4Dfza;
        "pkg-21.5.18+neoforge-1.21.5" = _W4HJlMiJ;
        "pkg-21.0.47+fabric-1.21.1" = _lhwS3YFx;
        "pkg-21.7.3+fabric-1.21.7" = _UBRW8R38;
        "pkg-21.0.47+forge-1.21.1" = _v8hHeUf3;
        "pkg-21.0.47+neoforge-1.21.1" = _N6BB7pOQ;
        "pkg-21.7.3+forge-1.21.7" = _yULFHm7H;
        "pkg-21.7.3+neoforge-1.21.7" = _SbQx4QsD;
        "pkg-21.8.1+fabric-1.21.8" = _e1Ttsfe7;
        "pkg-21.8.1+neoforge-1.21.8" = _L2zZyC1v;
        "pkg-21.8.2+forge-1.21.8" = _4sJC2PT2;
        "pkg-21.5.19+fabric-1.21.5" = _ANKx7jvk;
        "pkg-21.8.3+fabric-1.21.8" = _mgy5DP0m;
        "pkg-21.8.3+forge-1.21.8" = _Lu6EZ99w;
        "pkg-21.5.19+forge-1.21.5" = _OcjToEp0;
        "pkg-21.5.19+neoforge-1.21.5" = _5i4vpl82;
        "pkg-21.8.3+neoforge-1.21.8" = _PxJVTMXv;
        "pkg-21.4.36+fabric-1.21.4" = _RMBKhF0u;
        "pkg-7.3.33+fabric-1.20.1" = _wF767h1L;
        "pkg-21.0.48+forge-1.21.1" = _EdgG47fD;
        "pkg-21.0.48+fabric-1.21.1" = _FgOdleKT;
        "pkg-21.4.36+neoforge-1.21.4" = _NHKzJURt;
        "pkg-7.3.33+forge-1.20.1" = _Et3eoKPd;
        "pkg-21.0.48+neoforge-1.21.1" = _flSytBwz;
        "pkg-21.4.36+forge-1.21.4" = _RiTmbUzy;
        "pkg-21.5.20+fabric-1.21.5" = _48GNRNhg;
        "pkg-21.5.20+neoforge-1.21.5" = _SBEtjfoS;
        "pkg-21.8.4+fabric-1.21.8" = _VY97Mtm9;
        "pkg-21.5.20+forge-1.21.5" = _PCzYlF3X;
        "pkg-21.8.4+forge-1.21.8" = _pJEwtR1m;
        "pkg-21.8.4+neoforge-1.21.8" = _KFbL49Ka;
        "pkg-7.3.34+fabric-1.20.1" = _bZcdZaMf;
        "pkg-7.3.34+forge-1.20.1" = _2CQDRhU6;
        "pkg-21.0.49+fabric-1.21.1" = _gAqyWsf3;
        "pkg-21.0.49+forge-1.21.1" = _dtCG5BP6;
        "pkg-21.5.21+fabric-1.21.5" = _l4FQJdPV;
        "pkg-21.0.49+neoforge-1.21.1" = _EBGKvOX4;
        "pkg-21.5.21+forge-1.21.5" = _ktcFVh8b;
        "pkg-21.5.21+neoforge-1.21.5" = _J5uA9bkg;
        "pkg-21.8.5+forge-1.21.8" = _lqVUjECW;
        "pkg-21.8.5+fabric-1.21.8" = _NlcJ0pFb;
        "pkg-21.4.37+fabric-1.21.4" = _m7eIqKUf;
        "pkg-21.4.37+forge-1.21.4" = _FOiedgmh;
        "pkg-21.4.37+neoforge-1.21.4" = _BEOxRQ4y;
        "pkg-21.8.5+neoforge-1.21.8" = _Nz5F6W50;
        "pkg-21.0.50+fabric-1.21.1" = _jWsqS2aH;
        "pkg-21.5.22+fabric-1.21.5" = _LWDB3V6h;
        "pkg-21.0.50+neoforge-1.21.1" = _2J65WRWM;
        "pkg-21.0.50+forge-1.21.1" = _yPl5bcS5;
        "pkg-21.5.22+forge-1.21.5" = _EuygzFzV;
        "pkg-21.5.22+neoforge-1.21.5" = _jFbz1zuP;
        "pkg-21.4.38+forge-1.21.4" = _I5D1SIdP;
        "pkg-21.4.38+neoforge-1.21.4" = _3gzD14MP;
        "pkg-21.4.38+fabric-1.21.4" = _KAq55hrY;
        "pkg-21.8.6+fabric-1.21.8" = _LMHybkhC;
        "pkg-21.8.6+forge-1.21.8" = _HyNpzWdU;
        "pkg-21.8.6+neoforge-1.21.8" = _rryvwjoA;
        "pkg-21.8.7+neoforge-1.21.8" = _PcluwQM1;
        "pkg-21.0.51+neoforge-1.21.1" = _KSt3hDez;
        "pkg-21.5.23+neoforge-1.21.5" = _A7zAaKBP;
        "pkg-21.4.39+neoforge-1.21.4" = _od83QjgB;
        "pkg-7.3.35+fabric-1.20.1" = _5mqluZjb;
        "pkg-7.3.35+forge-1.20.1" = _1OQBd8YF;
        "pkg-21.8.8+fabric-1.21.8" = _c8Bb5uUc;
        "pkg-21.8.8+neoforge-1.21.8" = _PJbNDIO4;
        "pkg-21.8.8+forge-1.21.8" = _8CiIXe21;
        "pkg-7.3.36+fabric-1.20.1" = _iy0jwbPB;
        "pkg-7.3.36+forge-1.20.1" = _tX9xZml9;
        "pkg-21.0.52+fabric-1.21.1" = _8uU5bOdS;
        "pkg-21.0.52+neoforge-1.21.1" = _qMe583RA;
        "pkg-21.0.52+forge-1.21.1" = _zB92fnH2;
        "pkg-21.8.9+fabric-1.21.8" = _qnl3WCMj;
        "pkg-21.4.40+fabric-1.21.4" = _poPh2IEJ;
        "pkg-21.8.9+neoforge-1.21.8" = _QSteICp4;
        "pkg-21.4.40+neoforge-1.21.4" = _7xnbcAFt;
        "pkg-21.8.9+forge-1.21.8" = _CIlKwv5d;
        "pkg-21.4.40+forge-1.21.4" = _OE2NaXZq;
        "pkg-21.5.24+fabric-1.21.5" = _4oQTzCZA;
        "pkg-21.5.24+forge-1.21.5" = _iin9OTWM;
        "pkg-21.5.24+neoforge-1.21.5" = _lqiuB1Od;
        "pkg-21.9.1+fabric-1.21.9" = _S4Ok09lm;
        "pkg-21.9.1+neoforge-1.21.9" = _UFwSiwqR;
        "pkg-21.9.2+fabric-1.21.9" = _hWwKhtQw;
        "pkg-21.9.2+neoforge-1.21.9" = _qWYNxost;
        "pkg-21.9.3+fabric-1.21.9" = _FLclXYZa;
        "pkg-21.9.3+neoforge-1.21.9" = _wCvFheOn;
        "pkg-21.9.4+fabric-1.21.9" = _7TxO9j9o;
        "pkg-21.9.4+neoforge-1.21.9" = _WHqkTxC0;
        "pkg-21.10.1+fabric-1.21.10" = _vETkRPgG;
        "pkg-21.10.1+neoforge-1.21.10" = _RLF9epzN;
        "pkg-21.10.2+forge-1.21.10" = _xwKBm8Kn;
        "pkg-7.3.37+fabric-1.20.1" = _qCk04klC;
        "pkg-7.3.37+forge-1.20.1" = _Ue8C6cKq;
        "pkg-21.5.25+fabric-1.21.5" = _YixoEDEO;
        "pkg-21.0.53+fabric-1.21.1" = _hCOOmlbI;
        "pkg-21.5.25+forge-1.21.5" = _uSHUhWFx;
        "pkg-21.5.25+neoforge-1.21.5" = _lBz8auN9;
        "pkg-21.0.53+forge-1.21.1" = _EgVSSK89;
        "pkg-21.0.53+neoforge-1.21.1" = _cdU0qRxi;
        "pkg-21.4.41+fabric-1.21.4" = _WumOR3k0;
        "pkg-21.4.41+neoforge-1.21.4" = _TzT0AxJR;
        "pkg-21.4.41+forge-1.21.4" = _21Zk8ppT;
        "pkg-21.4.42+neoforge-1.21.4" = _1C3tVoOk;
        "pkg-21.10.3+neoforge-1.21.10" = _3Q3g6z0G;
        "pkg-21.0.54+neoforge-1.21.1" = _Yiybaaus;
        "pkg-21.5.26+neoforge-1.21.5" = _GsCibamk;
        "pkg-21.8.10+fabric-1.21.8" = _6STx1UB9;
        "pkg-21.8.10+forge-1.21.8" = _JNR5WexW;
        "pkg-21.8.10+neoforge-1.21.8" = _vTRPWdzg;
        "pkg-21.10.4+forge-1.21.10" = _mlID7l8Y;
        "pkg-21.10.5+neoforge-1.21.10" = _ywdR8fRr;
        "pkg-21.10.6+fabric-1.21.10" = _FrHkeMAL;
        "pkg-21.10.6+forge-1.21.10" = _P5AfCep0;
        "pkg-21.10.6+neoforge-1.21.10" = _vfmBLb3H;
        "pkg-21.10.7+fabric-1.21.10" = _yJmabsVx;
        "pkg-21.10.7+forge-1.21.10" = _FXNYPDLx;
        "pkg-21.10.7+neoforge-1.21.10" = _xMr0z5Vv;
        "pkg-21.10.8+fabric-1.21.10" = _cU1Vn9qw;
        "pkg-21.10.8+forge-1.21.10" = _7fj60aGI;
        "pkg-21.10.8+neoforge-1.21.10" = _IrlUugiY;
        "pkg-21.0.55+fabric-1.21.1" = _jiTpUYmp;
        "pkg-21.0.55+neoforge-1.21.1" = _rrxxIYvJ;
        "pkg-21.0.55+forge-1.21.1" = _kerOhVlh;
        "pkg-21.11.1+neoforge-1.21.11" = _zWaZBLS1;
        "pkg-21.11.2+fabric-1.21.11" = _B70bHBzu;
        "pkg-21.11.2+neoforge-1.21.11" = _dIgG1EOR;
        "pkg-21.11.3+fabric-1.21.11" = _RNhvPwjz;
        "pkg-21.11.3+neoforge-1.21.11" = _mhhQ6Ke1;
        "pkg-21.11.3+forge-1.21.11" = _tWMqyz3p;
        "pkg-21.11.5+fabric-1.21.11" = _ZJWr2IS3;
        "pkg-21.11.5+neoforge-1.21.11" = _mZ461M3N;
        "pkg-21.11.5+forge-1.21.11" = _jbrQjXkN;
        "pkg-7.3.38+fabric-1.20.1" = _TSihd8MJ;
        "pkg-7.3.38+forge-1.20.1" = _8rz04Kha;
        "pkg-21.10.10+fabric-1.21.10" = _YQB6scYL;
        "pkg-21.10.10+neoforge-1.21.10" = _YrIJi2P8;
        "pkg-21.10.10+forge-1.21.10" = _Iow8IMjw;
        "pkg-21.0.56+fabric-1.21.1" = _x4SzggaK;
        "pkg-21.0.56+neoforge-1.21.1" = _Yoii3Xj6;
        "pkg-21.0.56+forge-1.21.1" = _hK64LSCc;
        "pkg-21.11.6+fabric-1.21.11" = _sbE6e5Gh;
        "pkg-21.11.6+forge-1.21.11" = _ZurKJFAF;
        "pkg-21.11.6+neoforge-1.21.11" = _A1uiiGfb;
        "pkg-21.10.11+fabric-1.21.10" = _9HjDG5Uj;
        "pkg-21.10.11+forge-1.21.10" = _cBpkYXHr;
        "pkg-21.10.11+neoforge-1.21.10" = _PE3ktPuX;
        "pkg-21.11.7+fabric-1.21.11" = _6h7RAm0u;
        "pkg-21.11.7+forge-1.21.11" = _gU4wWnPl;
        "pkg-21.11.7+neoforge-1.21.11" = _Ap2u2Ra5;
        "pkg-21.11.8+fabric-1.21.11" = _IYfoTfMp;
        "pkg-21.11.8+neoforge-1.21.11" = _V6W1VJgc;
        "pkg-21.11.8+forge-1.21.11" = _onAU0NkE;
        "pkg-26.1.0.1+fabric-26.1" = _rjgtEenJ;
        "pkg-26.1.0.1+neoforge-26.1" = _5VdS76Le;
        "pkg-26.1.0.2+fabric-26.1" = _dnLVBEFq;
        "pkg-26.1.0.2+neoforge-26.1" = _MHSGYpGJ;
        "pkg-26.1.0.2+forge-26.1" = _PiuvxyRP;
        "pkg-26.1.0.3+fabric-26.1" = _4y0bFqzm;
        "pkg-26.1.0.3+forge-26.1" = _mmkEmk55;
        "pkg-26.1.0.3+neoforge-26.1" = _v3rUaYtw;
        "pkg-26.1.0.4+fabric-26.1" = _n8Q1RqV3;
        "pkg-26.1.0.4+forge-26.1" = _eHkoEBNX;
        "pkg-26.1.0.4+neoforge-26.1" = _gW8blRNq;
        "pkg-26.1.0.5+fabric-26.1" = _w0WRFRca;
        "pkg-26.1.0.5+forge-26.1" = _7ZTEA3Cw;
        "pkg-26.1.0.5+neoforge-26.1" = _I4aY9zI2;
        "pkg-26.1.0.6+fabric-26.1" = _9GKnh8vV;
        "pkg-26.1.0.6+neoforge-26.1" = _Z5WHR59H;
        "pkg-26.1.0.6+forge-26.1" = _kdWhpGLY;
        "pkg-26.1.0.7+forge-26.1.1" = _PCcWdedM;
        "pkg-26.1.0.7+fabric-26.1.1" = _I9GF44A2;
        "pkg-26.1.0.7+neoforge-26.1.1" = _4q61ySlS;
        "pkg-26.1.1.1+fabric-26.1.1" = _1ygzNuzg;
        "pkg-26.1.1.1+neoforge-26.1.1" = _Epo3g9xO;
        "pkg-26.1.1.1+forge-26.1.1" = _j7glNmBx;
        "pkg-26.1.1.2+fabric-26.1.1" = _7p4WvO0u;
        "pkg-26.1.1.2+forge-26.1.1" = _b7TZwQrh;
        "pkg-26.1.1.2+neoforge-26.1.1" = _a4bAZg9p;
        "pkg-21.11.9+neoforge-1.21.11" = _rQiSqwip;
        "pkg-21.11.9+forge-1.21.11" = _WJKKTkIM;
        "pkg-21.11.9+fabric-1.21.11" = _wk8IL07y;
        "pkg-26.1.2.1+fabric-26.1.2" = _CXPaGqRl;
        "pkg-26.1.2.1+forge-26.1.2" = _kFLR7TQL;
        "pkg-26.1.2.1+neoforge-26.1.2" = _hXYkZPkS;
        "pkg-26.1.2.2+fabric-26.1.2" = _QNdlITcY;
        "pkg-26.1.2.2+neoforge-26.1.2" = _b8nRp1us;
        "pkg-26.1.2.2+forge-26.1.2" = _zl5HEQq5;
        "pkg-26.1.2.3+fabric-26.1.2" = _sLkrkm9i;
        "pkg-26.1.2.3+neoforge-26.1.2" = _lgVBxfMg;
        "pkg-26.1.2.3+forge-26.1.2" = _NFrYXjH4;
        "pkg-26.1.2.4+fabric-26.1.2" = _CRLU4xOJ;
        "pkg-26.1.2.4+neoforge-26.1.2" = _mYqeYXW4;
        "pkg-26.1.2.4+forge-26.1.2" = _Ke32V4bt;
        "pkg-21.0.57+fabric-1.21.1" = _kUyAERgX;
        "pkg-21.0.57+neoforge-1.21.1" = _XC1JUHmA;
        "pkg-21.0.57+forge-1.21.1" = _5YmbZj30;
        "pkg-26.1.2.5+fabric-26.1.2" = _NSzL3cs6;
        "pkg-26.1.2.5+forge-26.1.2" = _tFbblN41;
        "pkg-26.1.2.5+neoforge-26.1.2" = _xOTEitEb;
        "pkg-21.0.58+fabric-1.21.1" = _p7lNrqW8;
        "pkg-21.0.58+forge-1.21.1" = _Nm7yTwr2;
        "pkg-21.0.58+neoforge-1.21.1" = _3XiinKbh;
        "pkg-26.1.2.6+forge-26.1.2" = _4DiDCpni;
        "pkg-26.1.2.6+neoforge-26.1.2" = _e7sQFfFK;
        "pkg-26.1.2.6+fabric-26.1.2" = _ySr8K68c;
        "pkg-26.1.2.7+fabric-26.1.2" = _3lOxOstM;
        "pkg-26.1.2.7+forge-26.1.2" = _JXlZTP0I;
        "pkg-26.1.2.7+neoforge-26.1.2" = _wMzlsgW9;
        "pkg-21.0.59+fabric-1.21.1" = _HpG2iLwB;
        "pkg-21.0.59+forge-1.21.1" = _WXyHVL40;
        "pkg-21.0.59+neoforge-1.21.1" = _QXfHYVcw;
        "pkg-21.11.9.1+fabric-1.21.11" = _5POKgjJn;
        "pkg-21.11.9.1+forge-1.21.11" = _rxqCeXZU;
        "pkg-21.11.9.1+neoforge-1.21.11" = _tKWaiIeW;
        "pkg-26.2.0.1+fabric-26.2" = _GgdgLPVd;
        "pkg-26.2.0.1+neoforge-26.2" = _GdkDnjBR;
        "pkg-7.3.39+fabric-1.20.1" = _rOmEvw5t;
        "pkg-7.3.39+forge-1.20.1" = _bki2V9A7;
        "pkg-26.2.0.2+fabric-26.2" = _Gl7L60Mm;
        "pkg-26.2.0.2+neoforge-26.2" = _GrabZ8p6;
        "pkg-21.0.60+fabric-1.21.1" = _jR9x1yws;
        "pkg-21.0.60+forge-1.21.1" = _LAkveQQc;
        "pkg-21.0.60+neoforge-1.21.1" = _GW3cqbdN;
        "pkg-26.1.2.8+fabric-26.1.2" = _YiXiNS2S;
        "pkg-26.1.2.8+forge-26.1.2" = _JjDpvOS7;
        "pkg-26.1.2.8+neoforge-26.1.2" = _dkZaVApl;
        "pkg-21.0.61+forge-1.21.1" = _hVxXz97c;
        "pkg-21.0.61+neoforge-1.21.1" = _RAbFSmOV;
        "pkg-7.3.40+forge-1.20.1" = _EoDY9EMt;
        "pkg-7.3.41+fabric-1.20.1" = _sWBQARQL;
        "pkg-21.0.62+fabric-1.21.1" = _zzOzQ5Kw;
        "pkg-7.3.41+forge-1.20.1" = _47ZbZoOg;
        "pkg-21.0.62+neoforge-1.21.1" = _FVAybmGx;
        "pkg-21.0.62+forge-1.21.1" = _Ho8L90jS;
        "pkg-21.0.63+fabric-1.21.1" = _R6U3hZRZ;
        "pkg-21.0.63+neoforge-1.21.1" = _Yl3tIBea;
        "pkg-21.0.63+forge-1.21.1" = _c2bhsWLV;
        "pkg-26.2.0.3+fabric-26.2" = _ZLn74Oar;
        "pkg-26.2.0.3+neoforge-26.2" = _l5LcttiY;
        "pkg-26.1.2.9+fabric-26.1.2" = _8qWb80a2;
        "pkg-26.1.2.9+forge-26.1.2" = _G8n88j2s;
        "pkg-26.1.2.9+neoforge-26.1.2" = _OIEASN32;
        "pkg-26.1.2.10+fabric-26.1.2" = _u130G6gO;
        "pkg-26.2.0.4+fabric-26.2" = _L6soNs6H;
        "pkg-26.1.2.10+neoforge-26.1.2" = _FAvYxD39;
        "pkg-26.2.0.4+neoforge-26.2" = _joHDpNpK;
        "pkg-26.1.2.10+forge-26.1.2" = _JCEXd3ku;
        "pkg-7.3.42+fabric-1.20.1" = _cKovWgE1;
        "pkg-7.3.42+forge-1.20.1" = _PtvPxXii;
        "pkg-21.0.64+forge-1.21.1" = _1e7eSw8t;
        "pkg-21.0.64+neoforge-1.21.1" = _AMOGoVGH;
        "pkg-21.0.64+fabric-1.21.1" = _sNjWt502;
        "pkg-26.2.0.5+fabric-26.2" = _ln6vafmE;
        "pkg-26.2.0.5+neoforge-26.2" = _cI1IuHIS;
        "pkg-26.1.2.11+fabric-26.1.2" = _KHPL2b7c;
        "pkg-26.1.2.11+neoforge-26.1.2" = _aL65cBEV;
        "pkg-26.1.2.11+forge-26.1.2" = _GPEB1eoC;
        "pkg-21.0.65+forge-1.21.1" = _UFBNAOCt;
        "pkg-21.0.65+neoforge-1.21.1" = _KgypwTqX;
        "pkg-21.0.65+fabric-1.21.1" = _VynBiUHt;
        "pkg-26.2.0.6+fabric-26.2" = _hT8Zt2uD;
        "pkg-26.2.0.6+neoforge-26.2" = _MKVIBhNe;
        "pkg-26.1.2.12+fabric-26.1.2" = _ghVkj8jW;
        "pkg-26.1.2.12+forge-26.1.2" = _Xji7Vn8z;
        "pkg-26.1.2.12+neoforge-26.1.2" = _GdCaUVWR;
        "pkg-26.2.0.7+fabric-26.2" = _tYnUhVmF;
        "pkg-26.2.0.7+neoforge-26.2" = _UnO3FAKK;
        "pkg-26.1.2.13+fabric-26.1.2" = _zRQbKVJu;
        "pkg-26.1.2.13+forge-26.1.2" = _WCoRyIiq;
        "pkg-26.1.2.13+neoforge-26.1.2" = _Az2h3CI2;
        "pkg-26.2.0.8+fabric-26.2" = _LcKC6Cxw;
        "pkg-26.2.0.8+neoforge-26.2" = _lGba52SO;
        "pkg-26.1.2.14+fabric-26.1.2" = _UWcOVkf7;
        "pkg-26.1.2.14+forge-26.1.2" = _uKBl6URU;
        "pkg-26.1.2.14+neoforge-26.1.2" = _XfUUh0yW;
        "pkg-7.3.43+fabric-1.20.1" = _wIUUe8by;
