...
let
    versions = (let
        ...
        _Ii3H1pwD = {
            "id" = "Ii3H1pwD";
            "file" = "Freshly Modded 3.0.4.zip";
            "hash" = "sha512-2sPqEYiGo3FUyfEUUAlEzOFadEF3lb81eg2NTeN54A4324A5cjPQTJr7cqNeCjlU1y4wuZBVd6gLa2pppPyKMA==";
        };
    in {
        "WEuiM61L" = _WEuiM61L;
        "FWvDuiYT" = _FWvDuiYT;
        ...
        "minecraft-1.20" = _Ii3H1pwD;
        "minecraft-1.20.1" = _Ii3H1pwD;
        "minecraft-1.20.2" = _Ii3H1pwD;
        "minecraft-1.20.3" = _Ii3H1pwD;
        "minecraft-1.20.4" = _Ii3H1pwD;
        "minecraft-1.18" = _AAPAURNV;
        "minecraft-1.18.1" = _AAPAURNV;
        "minecraft-1.18.2" = _AAPAURNV;
        "minecraft-1.20.5" = _Ii3H1pwD;
        "minecraft-1.20.6" = _Ii3H1pwD;
        "minecraft-1.21" = _Ii3H1pwD;
        "minecraft-1.21.1" = _Ii3H1pwD;
        "minecraft-1.17" = _AAPAURNV;
        "minecraft-1.17.1" = _AAPAURNV;
        "minecraft-1.21.2" = _Ii3H1pwD;
        "minecraft-1.21.3" = _Ii3H1pwD;
        "minecraft-1.21.4" = _Ii3H1pwD;
        "minecraft-1.21.5" = _Ii3H1pwD;
        "minecraft-23w31a" = _Ii3H1pwD;
        "minecraft-1.21.6" = _Ii3H1pwD;
        "minecraft-1.21.7" = _Ii3H1pwD;
        "minecraft-1.21.8" = _Ii3H1pwD;
        "minecraft-1.21.9" = _Ii3H1pwD;
        "minecraft-1.21.10" = _Ii3H1pwD;
        "minecraft-1.21.11" = _Ii3H1pwD;
        "minecraft-26.1" = _Ii3H1pwD;
        "minecraft-23w32a" = _Ii3H1pwD;
        "minecraft-23w33a" = _Ii3H1pwD;
        "minecraft-23w35a" = _Ii3H1pwD;
        "minecraft-1.20.2-pre1" = _Ii3H1pwD;
        "minecraft-23w42a" = _Ii3H1pwD;
        "minecraft-23w43a" = _Ii3H1pwD;
        "minecraft-23w43b" = _Ii3H1pwD;
        "minecraft-23w44a" = _Ii3H1pwD;
        "minecraft-23w45a" = _Ii3H1pwD;
        "minecraft-23w46a" = _Ii3H1pwD;
        "minecraft-24w03a" = _Ii3H1pwD;
        "minecraft-24w03b" = _Ii3H1pwD;
        "minecraft-24w04a" = _Ii3H1pwD;
        "minecraft-24w05a" = _Ii3H1pwD;
        "minecraft-24w05b" = _Ii3H1pwD;
        "minecraft-24w06a" = _Ii3H1pwD;
        "minecraft-24w07a" = _Ii3H1pwD;
        "minecraft-24w09a" = _Ii3H1pwD;
        "minecraft-24w10a" = _Ii3H1pwD;
        "minecraft-24w11a" = _Ii3H1pwD;
        "minecraft-24w12a" = _Ii3H1pwD;
        "minecraft-24w13a" = _Ii3H1pwD;
        "minecraft-24w14potato" = _Ii3H1pwD;
        "minecraft-24w14a" = _Ii3H1pwD;
        "minecraft-1.20.5-pre1" = _Ii3H1pwD;
        "minecraft-1.20.5-pre2" = _Ii3H1pwD;
        "minecraft-1.20.5-pre3" = _Ii3H1pwD;
        "minecraft-24w18a" = _Ii3H1pwD;
        "minecraft-24w19a" = _Ii3H1pwD;
        "minecraft-24w19b" = _Ii3H1pwD;
        "minecraft-24w20a" = _Ii3H1pwD;
        "minecraft-24w33a" = _Ii3H1pwD;
        "minecraft-24w34a" = _Ii3H1pwD;
        "minecraft-24w35a" = _Ii3H1pwD;
        "minecraft-24w36a" = _Ii3H1pwD;
        "minecraft-24w37a" = _Ii3H1pwD;
        "minecraft-24w38a" = _Ii3H1pwD;
        "minecraft-24w39a" = _Ii3H1pwD;
        "minecraft-24w40a" = _Ii3H1pwD;
        "minecraft-1.21.2-pre1" = _Ii3H1pwD;
        "minecraft-1.21.2-pre2" = _Ii3H1pwD;
        "minecraft-24w44a" = _Ii3H1pwD;
        "minecraft-24w45a" = _Ii3H1pwD;
        "minecraft-24w46a" = _Ii3H1pwD;
        "minecraft-26.1.1" = _Ii3H1pwD;
        "minecraft-26.1.2" = _Ii3H1pwD;
        "minecraft-26.2" = _Ii3H1pwD;
        "pkg-1.5" = _WEuiM61L;
        "pkg-1.5.1" = _FWvDuiYT;
        "pkg-1.5.2" = _ViH4yBCG;
        "pkg-1.5.3" = _Huh4tiZn;
