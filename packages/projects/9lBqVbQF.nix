...
let
    ...
    in {
        ...
        "pkg-beta0.0.4" = _dpNHtzr6;
        "pkg-beta0.0.5" = _PFdhimYm;
        "pkg-beta0.0.6-1.21.5" = _F8QoZxDL;
        "pkg-beta0.0.6-1.21.7-8" = _5inXatLR;
        "pkg-beta0.0.7-1.21.5" = _XCAxYZ9V;
        "pkg-beta0.0.7-1.21.7-8" = _abgwxbQ3;
        "pkg-beta0.0.8-1.21.5" = _yvoVA7Qp;
        "pkg-beta0.0.8-1.21.7-8" = _56iH1e79;
        "pkg-beta0.0.9-1.21.5" = _kEhHIEbr;
        "pkg-beta0.0.9-1.21.7-8" = _Q6CVlSob;
        "pkg-beta0.1.0-1.21.5" = _9kPviYne;
        "pkg-beta0.1.0-1.21.7-8" = _tzXYe4FG;
        "pkg-beta0.1.1-1.21.5" = _Ofqhv5ci;
        "pkg-beta0.1.1-1.21.7-8" = _n6vCO3m2;
        "pkg-beta0.1.2-1.21.5" = _t26Wo2cj;
        "pkg-beta0.1.2-1.21.7-8" = _yvoHkIQx;
        "pkg-beta0.1.3-1.21.5" = _V1s2QcXy;
        "pkg-beta0.1.3-1.21.7-8" = _CfQMbeBS;
        "pkg-0.1.4-beta" = _qEgt9goG;
        "pkg-0.1.5-beta" = _2cMDdPQL;
        "pkg-0.1.5-beta-1.21.10" = _HpMu2t2X;
        "pkg-0.1.6-beta-1.21.5" = _mlQ8ekKf;
        "pkg-0.1.6-beta-1.21.7-8" = _eV23n2xM;
        "pkg-0.1.6-beta-1.21.10" = _zXo1lMHe;
        "pkg-0.1.7-beta-1.21.5" = _CLyxZydg;
        "pkg-0.1.7-beta-1.21.7-8" = _ljoZjeTh;
        "pkg-0.1.7-beta-1.21.10" = _4IL4s7ov;
        "pkg-0.1.8-beta-1.21.5" = _GpiaqitF;
        "pkg-0.1.8-beta-1.21.7-8" = _BBBHmsal;
        "pkg-0.1.8-beta-1.21.10" = _b0qBd6lB;
        "pkg-0.1.9-beta-1.21.5" = _7Vl7fxgw;
        "pkg-0.1.9-beta-1.21.7-8" = _P3ouDFef;
        "pkg-0.1.9-beta-1.21.10" = _6FbBbRxG;
        "pkg-0.2.0-beta-1.21.10" = _mKdPXhvf;
        "pkg-0.2.0-beta-1.21.5" = _aqgOE9q4;
        "pkg-0.2.0-beta-1.21.7-8" = _a4L52wAT;
        "pkg-0.2.1-beta-1.21.10" = _yvVohaQN;
        "pkg-0.2.1-beta-1.21.11" = _hVc8Dsnd;
        "pkg-0.3.0-beta-26.1.X" = _GmvelbTm;
        "pkg-0.3.0-beta-1.21.11" = _InwNdzOw;
        "pkg-0.3.0-beta-1.21.10" = _9PH6dAsU;
        "pkg-0.4.0-26.1.2" = _uKJdbyfQ;
        "pkg-0.4.0-21.11" = _pJ9SEQo6;
        "pkg-0.4.1-1.21.11" = _o9RzxiPj;
        "pkg-0.4.1-26.1.2" = _bu0IzLW9;
        "pkg-0.4.2-1.21.11" = _btkLE22F;
