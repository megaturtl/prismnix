...
let
    versions = (let
        ...
        _WMyMpstF = {
            "id" = "WMyMpstF";
            "file" = "The-Hordes-1.20.1-1.6.3i-all.jar";
            "hash" = "sha512-prrzY6OVofhInyV9yezL5LwEdzJ2OIE29ChjJLsHJrAU+IkKM9zg9J/DwYmhZvq71Co71xPr91pjl91OYv2nFg==";
        };
        _Q6XVVcGq = {
            "id" = "Q6XVVcGq";
            "file" = "The-Hordes-1.12.2-1.6.3e.jar";
            "hash" = "sha512-ilBoOyMZlH4/wdryzra5ZGFHD0PAEPZ5mZWJHmIEyTh6ACHmMd1+ptYs0qe2koTf6AICFPkFFajM7HwC5/yiQg==";
        };
        _gdHByusK = {
            "id" = "gdHByusK";
            "file" = "The-Hordes-1.21.1-1.6.3f.jar";
            "hash" = "sha512-r1wXgvjTpgUyK/n2X9v/qAgLPScv6qkd12CcfUhciagfLO+0bPmVAqFzcr9upKTPwqBgqLUrKafEWNFmllNEcQ==";
        };
    in {
        "AgiwtzPU" = _AgiwtzPU;
        "t6mUHsW0" = _t6mUHsW0;
        ...
        "forge-1.20.1" = _WMyMpstF;
        "forge-1.19.1" = _PuNfSH42;
        "neoforge-1.20" = _kMUMzeKQ;
        "neoforge-1.20.1" = _ub3i6wio;
        "neoforge-1.21" = _df1yBAui;
        "neoforge-1.21.1" = _gdHByusK;
        "pkg-1.12.2-1.1.5a" = _AgiwtzPU;
        "pkg-1.16.5-1.1.5c" = _t6mUHsW0;
        "pkg-1.18.2-1.1.5e" = _XWCd0YXV;
        "pkg-1.19.2-1.1.5c" = _SQuNwz6m;
        "pkg-1.19.2-1.1.5d" = _cyWJGpLO;
        "pkg-1.19.3-1.1.5e" = _EZNie4Qb;
        "pkg-1.1.5f" = _IHK2QM4e;
        "pkg-1.1.6a" = _nL9ocqm3;
        "pkg-1.1.6b" = _AcNl3l6u;
        "pkg-1.1.6" = _PfkSHXij;
        "pkg-1.2.1" = _WZLL6K6e;
        "pkg-1.3.0a" = _L7bfbaAe;
        "pkg-1.2.1a" = _GPrwvzKT;
        "pkg-1.3.0b" = _tuiGyEYl;
        "pkg-1.3.1" = _Uh0nzWT4;
        "pkg-1.20.1-1.3.2" = _Aafghgx6;
        "pkg-1.20.1-1.3.2a" = _PrVf6stT;
        "pkg-1.12.2-1.1.7" = _RpzmpK3h;
        "pkg-1.18.2-1.2.2" = _6AoT5Qce;
        "pkg-1.19.2-1.2.2" = _QdaG65nv;
        "pkg-1.19.4-1.2.2" = _cD9n9jQk;
        "pkg-1.20.1-1.3.2b" = _wLTpygfW;
        "pkg-1.19.4-1.2.3" = _82q7gYgc;
        "pkg-1.2.3" = _k3jO3ymf;
        "pkg-1.18.2-1.2.3" = _uh4cB7bc;
        "pkg-1.20.1-1.4.0" = _QVG0mqlM;
        "pkg-1.20.1-1.5.0" = _kMUMzeKQ;
        "pkg-1.21-1.6.1" = _Dp5uqGLB;
        "pkg-1.20.1-1.5.4" = _aRBPMdFj;
        "pkg-1.19.2-1.5.4" = _PuNfSH42;
        "pkg-1.19.4-1.5.4" = _BOwEyY2u;
        "pkg-1.18.2-1.5.4" = _pqQoFurC;
        "pkg-1.12.2-1.5.3a" = _D56qjibb;
        "pkg-1.21-1.6.1a" = _k1eRMiz3;
        "pkg-1.21-1.6.1b" = _df1yBAui;
        "pkg-1.21.1-1.6.3" = _tiZics2U;
        "pkg-1.20.1-1.6.3" = _uAUtqkRL;
        "pkg-1.20.1-1.6.3a" = _tJdLcVBL;
        "pkg-1.20.1-1.6.3b" = _ffFnhpeY;
        "pkg-1.20.1-1.6.3c" = _HlxyPZyQ;
        "pkg-1.20.1-1.6.3d" = _sjlLvO6D;
        "pkg-1.21.1-1.6.3a" = _LfywkbDN;
        "pkg-1.20.1-1.6.3e" = _UTdoKqJO;
        "pkg-1.21.1-1.6.3b" = _aynBLsko;
        "pkg-1.20.1-1.6.3f" = _Y9ER59oU;
        "pkg-1.21.1-1.6.3c" = _VMzDavrc;
        "pkg-1.12.2-1.6.3" = _f0ZpMdXQ;
        "pkg-1.20.1-1.6.3g" = _WMyMpstF;
        ...
        "pkg-1.12.2-1.6.3e" = _Q6XVVcGq;
        "pkg-1.21.1-1.6.3f" = _gdHByusK;
        "default" = _gdHByusK;
    });
