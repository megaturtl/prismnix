...
let
    versions = (let
        ...
        _YYuzE4xQ = {
            "id" = "YYuzE4xQ";
            "file" = "CraftableEnchantedGoldenApple.zip";
            "hash" = "sha512-C/hPiIxCRTTy3ZrGtYpxY2hBZcpc042JSwwnxztMHeUHOr2riCOL+xwP4qYUL1HaoC5rO7RBc5czH+IbuZP1uQ==";
        };
    in {
        "rwmEZUEN" = _rwmEZUEN;
        "7ZzNlOH7" = _7ZzNlOH7;
        ...
        "datapack-1.19" = _YYuzE4xQ;
        "datapack-1.19.1" = _YYuzE4xQ;
        "datapack-1.19.2" = _YYuzE4xQ;
        "datapack-1.19.3" = _YYuzE4xQ;
        "datapack-1.19.4" = _YYuzE4xQ;
        "datapack-1.20" = _YYuzE4xQ;
        "datapack-1.20.1" = _YYuzE4xQ;
        "datapack-1.20.2" = _YYuzE4xQ;
        "datapack-1.18" = _YYuzE4xQ;
        "datapack-1.18.1" = _YYuzE4xQ;
        "datapack-1.18.2" = _YYuzE4xQ;
        "datapack-1.20.3" = _YYuzE4xQ;
        "datapack-1.20.4" = _YYuzE4xQ;
        "datapack-1.21.2" = _YYuzE4xQ;
        "datapack-1.21.3" = _YYuzE4xQ;
        "datapack-1.21.4" = _YYuzE4xQ;
        "datapack-1.21.5" = _YYuzE4xQ;
        "datapack-1.21.6" = _YYuzE4xQ;
        "datapack-1.21.7" = _YYuzE4xQ;
        "datapack-1.21.8" = _YYuzE4xQ;
        "datapack-1.20.5" = _YYuzE4xQ;
        "datapack-1.20.6" = _YYuzE4xQ;
        "datapack-1.21" = _YYuzE4xQ;
        "datapack-1.21.1" = _YYuzE4xQ;
        "datapack-1.21.9" = _YYuzE4xQ;
        "datapack-1.21.10" = _YYuzE4xQ;
        "datapack-1.21.11" = _YYuzE4xQ;
        "datapack-26.1" = _YYuzE4xQ;
        "datapack-26.1.1" = _YYuzE4xQ;
        "datapack-26.1.2" = _YYuzE4xQ;
        "datapack-26.2" = _YYuzE4xQ;
        ...
        "pkg-1.19-0.1" = _fv5xsR1S;
        "pkg-1.19.1-0.1" = _7h57nqkH;
        "pkg-1.19.2-0.1" = _Mgeq4FLi;
        "pkg-1.19.3-0.1" = _uGyskCqn;
        "pkg-1.19.4-0.1" = _8DN4SR2q;
        "pkg-1.20-0.1" = _A9ntQIqO;
        "pkg-1.20.1-0.1" = _5fhst45E;
        "pkg-1.20.2-0.1" = _Yr7KrDDG;
        "pkg-0.1" = _2KKIurBY;
        "pkg-0.2" = _YUYyFD69;
        "pkg-1.20.4-0.1" = _cpJKkMB0;
        "pkg-1.20.3-0.1" = _tLnKPP28;
        "pkg-1.20.5-0.1" = _eqqDFu3W;
        "pkg-1.20.6-0.1" = _HIdUrXMq;
        "pkg-1.21-0.1" = _X6eRzanc;
        "pkg-1.20.6-0.2" = _23QRBUsh;
        "pkg-1.21-0.2" = _pzCsyls2;
        "pkg-1.21-0.3" = _3qybQsbb;
        "pkg-1.21.1-0.1" = _XSjySg8c;
        "pkg-1.21-0.4" = _olHni7nD;
        "pkg-1.21.3-0.1" = _WY2HfQBI;
        "pkg-1.21.4-0.1" = _yBBmAwDJ;
        "pkg-1.21.5-0.1" = _Jiwt56dB;
        "pkg-1.21.5-0.2" = _9NWi90oy;
        "pkg-1.21.6-0.1" = _KzqKALLm;
        "pkg-1.21.7-0.1" = _FZvpqWj4;
        "pkg-1.21.8-0.1" = _gIL3tNdz;
        "pkg-1.21.9-0.1" = _f0qo66E1;
        "pkg-1.21.10-0.1" = _EOj8h4fx;
        "pkg-1.21.11-0.1" = _zu04KEPw;
        "pkg-26.1-0.1" = _fc3YuHfg;
        "pkg-26.1.1-0.1" = _aFlMoJRl;
        "pkg-26.1.2-0.1" = _j5zPoOI1;
        "pkg-CraftableEnchantedGoldenApple" = _vz1us4ms;
        "pkg-26.2-0.1" = _QvzsOXOF;
        "pkg-0.4" = _YYuzE4xQ;
        "default" = _YYuzE4xQ;
    });
