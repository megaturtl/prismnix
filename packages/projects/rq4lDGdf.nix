...
let
    versions = (let
        ...
        _APe3foiI = {
            "id" = "APe3foiI";
            "file" = "Squareful方纹v26.3.0.zip";
            "hash" = "sha512-NWC+2KuyVdwoTKF/4bVtiAxMg9i3P2rHKLez4iQvRtCbSZ2M/CwH/wFv6MemENDVVc80fvYqAA2udQTxGJ89eQ==";
        };
    in {
        "nMNmr00J" = _nMNmr00J;
        "ezvLQCrZ" = _ezvLQCrZ;
        ...
        "minecraft-1.20.3" = _APe3foiI;
        "minecraft-1.20.4" = _APe3foiI;
        "minecraft-1.20.5" = _APe3foiI;
        "minecraft-1.20.6" = _APe3foiI;
        "minecraft-1.21-pre1" = _6vEOgnEd;
        "minecraft-1.21-pre2" = _6vEOgnEd;
        "minecraft-1.21-pre3" = _6vEOgnEd;
        "minecraft-1.21-pre4" = _6vEOgnEd;
        "minecraft-1.21" = _APe3foiI;
        "minecraft-1.21.1" = _APe3foiI;
        "minecraft-1.21.2" = _APe3foiI;
        "minecraft-1.21.3" = _APe3foiI;
        "minecraft-1.21.4" = _APe3foiI;
        "minecraft-1.21.5" = _APe3foiI;
        ...
        "minecraft-1.21.6" = _APe3foiI;
        "minecraft-1.21.7-rc1" = _lTnFw8Ip;
        "minecraft-1.21.7-rc2" = _lTnFw8Ip;
        "minecraft-1.21.7" = _APe3foiI;
        "minecraft-1.21.8" = _APe3foiI;
        "minecraft-1.21.9" = _APe3foiI;
        "minecraft-1.21.10" = _APe3foiI;
        "minecraft-1.21.11" = _APe3foiI;
        "minecraft-26.1" = _APe3foiI;
        "minecraft-26.1.1" = _APe3foiI;
        "minecraft-26.1.2" = _APe3foiI;
        ...
        "minecraft-26.2" = _APe3foiI;
        "minecraft-26.3-snapshot-1" = _APe3foiI;
        "minecraft-26.3-snapshot-2" = _APe3foiI;
        "minecraft-26.3-snapshot-3" = _APe3foiI;
        "minecraft-26.3-snapshot-4" = _APe3foiI;
        "minecraft-26.3-snapshot-5" = _APe3foiI;
        "minecraft-26.3-snapshot-6" = _APe3foiI;
        "minecraft-26.3-snapshot-7" = _APe3foiI;
        "minecraft-26.3-snapshot-8" = _APe3foiI;
        "minecraft-26.3-snapshot-9" = _APe3foiI;
        "pkg-3.0" = _4TwX8gX5;
        "pkg-3.13" = _YmnyQqQx;
        "pkg-3.14" = _FGl5MHcQ;
        "pkg-3.15" = _8kSJyr01;
        ...
        "pkg-3.8" = _SbOQeT4B;
        "pkg-v26.0" = _gCrejaq6;
        "pkg-v26.0.1" = _SgkCv96E;
        "pkg-v26.0.2" = _5nlxLyb8;
        "pkg-v26.0.3" = _MRrPergM;
        "pkg-v26.0.4" = _x6Ai4SdM;
        "pkg-v26.0.5" = _8ZptoSaE;
        "pkg-v26.0.6" = _Oh5pG42o;
        "pkg-v26.2.0" = _XksKQtX6;
        "pkg-v26.2.1" = _YHAiojgg;
        "pkg-v26.3.0" = _APe3foiI;
        "default" = _APe3foiI;
    });
