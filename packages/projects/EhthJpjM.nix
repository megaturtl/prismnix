...
let
    versions = (let
        ...
        _Pa4gdWud = {
            "id" = "Pa4gdWud";
            "file" = "cpa-5.9.7-neoforge+1.21.1.jar";
            "hash" = "sha512-qYEPRNq/Qwzo1Kv+9CY0wcp4PUSD/D6e+L6EJx1mR9Z8HsNSTNX3llkEnPGREKikqMObXa+tnj1uTt6IjGfDBw==";
        };
        _q6YWhI8l = {
            "id" = "q6YWhI8l";
            "file" = "cpa-5.9.7-forge+1.20.1.jar";
            "hash" = "sha512-jpGrSNLwdED6HfgvJLlgGeF1BKGX+7a2KIFd8rEAF6hWHSWfykaCsCxko4Zy4T+CQH8Cq9inWVpoEZUdIHh0ZA==";
        };
        _ABUkY3Hd = {
            "id" = "ABUkY3Hd";
            "file" = "cpa-5.9.7-fabric+1.20.1.jar";
            "hash" = "sha512-4/0ad0euzVxs5tHeXeVTYE9x4bppQ8mTF1nH0aMthxMYd4LPWp9f1cXaDsOm0VJi4dmIroXEH6ppl66dc8hsHQ==";
        };
        _rRGCY4tK = {
            "id" = "rRGCY4tK";
            "file" = "cpa-5.9.7-fabric+1.21.1.jar";
            "hash" = "sha512-SmUpPPJa6BhDf95HheRYFdShx3TqX43XrnLichlNAym3sFLq90Jc+r0dVEP5E5Y9Qhci7Z6yJT2nIffj5Cm9xw==";
        };
        _3rFEXicW = {
            "id" = "3rFEXicW";
            "file" = "cpa-5.9.7-fabric+26.1.2.jar";
            "hash" = "sha512-XONwAhxCIqltc4cG7Z8jcPe271FW5eiMDDhZzrZvinELYMj9f2XQoUSXVoVesuXZAmsok938ySUyAJQd76yu3g==";
        };
        _dpQRDOUj = {
            "id" = "dpQRDOUj";
            "file" = "cpa-5.9.7-neoforge+1.21.11.jar";
            "hash" = "sha512-I1WbghHAQyrjaYBorrIFyYM8UCy40ef6VxK70eunmWpQpJC2Rv2raFzzrk+hhDae4pvzjtJuZMkUWenhltnsUA==";
        };
        _BaUUhssx = {
            "id" = "BaUUhssx";
            "file" = "cpa-5.9.7-neoforge+26.1.2.jar";
            "hash" = "sha512-m06WArP2atwwoZqT612zdXloUK+H7u0O7qXupn5qxdeO3El61Lzg6cuWTCzfdQcJPWBxKLmaNYcX1OI7/njxXg==";
        };
        _DhZEHVTr = {
            "id" = "DhZEHVTr";
            "file" = "cpa-5.9.7-fabric+1.21.11.jar";
            "hash" = "sha512-2uJ9vpylIKedhvKtnJBIVFpbklvMgTigSr5VhUEJ5D05bZCWN7yURlBCNt1C64VeUfWaja4ZqJwr/+SiNvRotQ==";
        };
        _M4xHWPd4 = {
            "id" = "M4xHWPd4";
            "file" = "cpa-5.9.7-fabric+26.2.jar";
            "hash" = "sha512-2OXSeXfG4RDh+imU8FPbc3G7nNRJvc6MswpDunLO+++DNv12anMiBXlWv4SMrpiSdmQYJ95h8YdajWP0kD49PA==";
        };
        _EVpi8jT3 = {
            "id" = "EVpi8jT3";
            "file" = "cpa-5.9.7-neoforge+26.2.jar";
            "hash" = "sha512-eCnN2j2x1IlZ5h+IZdaAo5FkyShNWFW+if+1P9jqlT3T+UU8WcvU9txQ1Aml7K4MK4HjQLT1L3fjY5WWwA5uqQ==";
        };
        _BkFJRsxM = {
            "id" = "BkFJRsxM";
            "file" = "cpa-5.9.8-neoforge+1.21.1.jar";
            "hash" = "sha512-3stbCneAYhz2Ky3XU1DzA9a2l5+K5sj08qAKxJnls6xV10k133geH3nvIS2B1YUQSoS9QRKLdfKEjyLlpzwTIQ==";
        };
        _yleU6W85 = {
            "id" = "yleU6W85";
            "file" = "cpa-5.9.8-forge+1.20.1.jar";
            "hash" = "sha512-b7Y3a48B93opf3cQ1ExXUnQE1Yxnq+kAZEAJnH1wMCHstOM0gur/wb72vzST5ccbz2XFfOuOo/rQmLjUG+SWWw==";
        };
        _KyrlnuOn = {
            "id" = "KyrlnuOn";
            "file" = "cpa-5.9.8-fabric+1.20.1.jar";
            "hash" = "sha512-pkaKchdRb5u3WSTkcbFyeRCIb0C2ZidlveaogJy1AvaxRNAo1+ztris4/MT87L/r6GrJcA5DN0Mj/rmLtEfXJA==";
        };
        _osKz6z5S = {
            "id" = "osKz6z5S";
            "file" = "cpa-5.9.8-fabric+1.21.1.jar";
            "hash" = "sha512-x94i7pEty6sViumzVBgAU9jWhYqNLbemu8jN++IPmEQrqEaDYOwKe4cLe5AuvkDvGK+gsD0j5K/ua9ZC2t03lw==";
        };
        _rV6xGQu1 = {
            "id" = "rV6xGQu1";
            "file" = "cpa-5.9.8-neoforge+1.21.11.jar";
            "hash" = "sha512-15SwquuZbJdM6s2JX8XMX7V1KP+x/nKT4FiwDhz+o/FNrRZWQC/gWxszq0jajAQJLfME3GqvA0TAJtddvAdzEA==";
        };
        _FsyXuHsg = {
            "id" = "FsyXuHsg";
            "file" = "cpa-5.9.8-fabric+26.1.2.jar";
            "hash" = "sha512-lqolnFnmIVYNgjAeyR+OJKT/v3WSHvgdHM6hKm8dW8u34fLvfrelfr64b/uORU6PzMAYKjCot3SsRnbb9hqDhw==";
        };
        _EHhn6oMr = {
            "id" = "EHhn6oMr";
            "file" = "cpa-5.9.8-neoforge+26.1.2.jar";
            "hash" = "sha512-jUyn/geqw3uxJ/+txbvXDiDBGMB3CEvngGfva04YQy5phSHFpA9vqroQpk11iVY0hH+Q89eJfkkMJZ4daucBDw==";
        };
        _vAt7UGEx = {
            "id" = "vAt7UGEx";
            "file" = "cpa-5.9.8-fabric+1.21.11.jar";
            "hash" = "sha512-l+pRDHNxKbIJORou/8SqU7sPMaFc7pyRVVRAjqBXecV6ycZ1UcsIA/WJP9y2bUSrhz2eXFGFRFCZ16hvw67Sbw==";
        };
        _diJgzV1y = {
            "id" = "diJgzV1y";
            "file" = "cpa-5.9.8-fabric+26.2.jar";
            "hash" = "sha512-yTH5GDcLnJSEUtANOTAAUIPxV4AR+rQFq09o3cDAiCGVUod4hShp6OHx/KG80zotujDbEB4MFUimN4mLAUKzJg==";
        };
        _zPHyYPoT = {
            "id" = "zPHyYPoT";
    ...
    in {
        ...
        "pkg-4.1.6-1.21.9" = _25xxthHl;
        "pkg-4.2.1-1.21.9" = _GCXIKsiy;
        "pkg-4.2.2-1.21.9" = _VRtgKrk4;
        "pkg-4.2.2-1.21.8" = _Phh2kgqY;
        "pkg-5.0.0-alpha.0+1.21.10-fabric" = _BnaOzZ5J;
        "pkg-5.0.0-alpha.0+1.21.10-neoforge" = _2Ef4dTQH;
        "pkg-5.0.0-alpha.0+1.21.9-fabric" = _eRSdD1VD;
        "pkg-5.0.0-alpha.0+1.21.8-fabric" = _a7Ff9IWW;
        "pkg-5.0.0-alpha.0+1.21.8-neoforge" = _7Dko7uDZ;
        "pkg-5.0.0-alpha.0+1.21.9-neoforge" = _4XnFACbn;
        "pkg-5.0.0-beta.0+1.21.9-fabric" = _1Knd94op;
        "pkg-5.0.0-beta.0+1.21.10-fabric" = _Sbcewzlh;
        "pkg-5.0.0-beta.0+1.21.10-neoforge" = _Nq1bZ1JL;
        "pkg-5.0.0-beta.0+1.21.8-fabric" = _2aOnzKru;
        "pkg-5.0.0-beta.0+1.21.8-neoforge" = _WFL5Bo32;
        "pkg-5.0.0-beta.0+1.21.9-neoforge" = _dZ4bR0k4;
        "pkg-5.0.0-beta.2+1.21.10-neoforge" = _5c65VS26;
        "pkg-5.0.0-beta.2+1.21.8-fabric" = _s9VzyvZF;
        "pkg-5.0.0-beta.2+1.21.10-fabric" = _CatmadLo;
        "pkg-5.0.0-beta.2+1.21.8-neoforge" = _PkjfiG9E;
        "pkg-5.0.0-beta.2+1.21.9-neoforge" = _EDkPS4Rg;
        "pkg-5.0.0-beta.2+1.21.9-fabric" = _oPqH55dd;
        "pkg-5.0.0-beta.4+1.21.10-neoforge" = _hF1hKSPw;
        "pkg-5.0.0-beta.4+1.21.10-fabric" = _GKfkcrGi;
        "pkg-5.0.0-beta.4+1.21.8-neoforge" = _Xx18q4ZR;
        "pkg-5.0.0-beta.4+1.21.9-fabric" = _zBYQMrGS;
        "pkg-5.0.0-beta.4+1.21.8-fabric" = _PBIqhUTx;
        "pkg-5.0.0-beta.4+1.21.9-neoforge" = _s5Y8ehr2;
        "pkg-5.0.0-beta.6+1.21.8-fabric" = _FuGk6KZn;
        "pkg-5.0.0-beta.6+1.21.10-fabric" = _7d76b0R4;
        "pkg-5.0.0-beta.6+1.21.10-neoforge" = _pkdHiU5a;
        "pkg-5.0.0-beta.6+1.21.8-neoforge" = _3NKUgmyl;
        "pkg-5.0.0-beta.6+1.21.9-neoforge" = _49ejcHrI;
        "pkg-5.0.0-beta.6+1.21.9-fabric" = _FRDVOnE8;
        "pkg-5.0.0-beta.7+1.21.9-fabric" = _dTTBHC2A;
        "pkg-5.0.0-beta.7+1.21.10-fabric" = _sdObAl9a;
        "pkg-5.0.0-beta.7+1.21.10-neoforge" = _hbLa6hcM;
        "pkg-5.0.0-beta.7+1.21.8-fabric" = _Va1VdJZ9;
        "pkg-5.0.0-beta.7+1.21.9-neoforge" = _DUaln8Qi;
        "pkg-5.0.0-beta.7+1.21.8-neoforge" = _RCUv6bRP;
        "pkg-5.0.0+1.21.8-fabric" = _scwaNV1r;
        "pkg-5.0.0+1.21.10-neoforge" = _ALSy34q3;
        "pkg-5.0.0+1.21.10-fabric" = _78ckS7T9;
        "pkg-5.0.0+1.21.8-neoforge" = _GAWMxnof;
        "pkg-5.0.0+1.21.9-neoforge" = _NKizRyRI;
        "pkg-5.0.0+1.21.9-fabric" = _UIwSxEQk;
        "pkg-5.1.0+1.21.10-neoforge" = _VqTmgEUA;
        "pkg-5.1.0+1.21.8-fabric" = _ChcbWusQ;
        "pkg-5.1.0+1.21.1-fabric" = _3jJuG5DN;
        "pkg-5.1.0+1.21.10-fabric" = _EZloY0Eq;
        "pkg-5.1.0+1.21.8-neoforge" = _MflFAk6u;
        "pkg-5.1.0+1.21.9-fabric" = _p4dr6dnX;
        "pkg-5.1.0+1.21.9-neoforge" = _Rgx9w5Yr;
        "pkg-5.2.0-beta.1+1.21.11-neoforge" = _7YTIhGDC;
        "pkg-5.2.0-beta.1+1.21.11-fabric" = _h27dsxG5;
        "pkg-5.2.0+1.21.10-neoforge" = _oJ7COezD;
        "pkg-5.2.0+1.21.10-fabric" = _na1NMdX5;
        "pkg-5.2.0+1.21.1-fabric" = _AhrQZKX9;
        "pkg-5.2.0+1.21.11-fabric" = _lMAG8Jus;
        "pkg-5.2.0+1.21.11-neoforge" = _S8YeamSG;
        "pkg-5.2.0+1.21.8-fabric" = _vsWn5mPM;
        "pkg-5.2.0+1.21.8-neoforge" = _OMxWLGeY;
        "pkg-5.2.0+1.21.9-neoforge" = _KcH1bAfc;
        "pkg-5.2.0+1.21.9-fabric" = _iFgvBRwM;
        "pkg-5.2.1+1.21.10-neoforge" = _PCShkKcI;
        "pkg-5.2.1+1.21.1-fabric" = _86OJ4yZa;
        "pkg-5.2.1+1.21.10-fabric" = _g7cAkSuy;
        "pkg-5.2.1+1.21.11-fabric" = _KWa0ShOV;
        "pkg-5.2.1+1.21.8-fabric" = _aH8g853F;
        "pkg-5.2.1+1.21.11-neoforge" = _i7bL9Gk3;
        "pkg-5.2.1+1.21.8-neoforge" = _fBeZYKnF;
        "pkg-5.2.1+1.21.9-neoforge" = _FzbSIGRD;
        "pkg-5.2.1+1.21.9-fabric" = _2Ygt5Ufb;
        "pkg-5.3.0+1.21.10-fabric" = _pCbIU9Ek;
        "pkg-5.3.0+1.21.10-neoforge" = _7jNfg8Qp;
        "pkg-5.3.0+1.21.1-fabric" = _5zY9bYXp;
        "pkg-5.3.0+1.21.11-neoforge" = _LLC1IcHQ;
        "pkg-5.3.0+1.21.11-fabric" = _fqZOSLRz;
        "pkg-5.3.0+1.21.8-fabric" = _k6NTK1h0;
        "pkg-5.3.0+1.21.8-neoforge" = _fo4E72oT;
        "pkg-5.3.0+1.21.9-fabric" = _aAf4O2tb;
        "pkg-5.3.0+1.21.9-neoforge" = _wOeTuZNm;
        "pkg-5.3.1+1.21.10-fabric" = _ix4qo641;
        "pkg-5.3.1+1.21.1-fabric" = _2eWZ3KG7;
        "pkg-5.3.1+1.21.10-neoforge" = _inqiC7xt;
        "pkg-5.4.0+1.21.10-neoforge" = _BHic5dJv;
        "pkg-5.4.0+1.21.10-fabric" = _Udql1dSI;
        "pkg-5.4.0+1.21.1-fabric" = _hvj9fAZB;
        "pkg-5.4.0+1.21.11-fabric" = _STdFOdvJ;
        "pkg-5.4.0+1.21.11-neoforge" = _gxs1I17C;
        "pkg-5.4.0+1.21.8-fabric" = _7I3bxxW0;
        "pkg-5.4.0+1.21.8-neoforge" = _QucHr7jw;
        "pkg-5.4.0+1.21.9-fabric" = _UGDDzUq3;
        "pkg-5.4.0+1.21.9-neoforge" = _my0w7LjC;
        "pkg-5.5.0+1.21.1-fabric" = _xob1qe8F;
        "pkg-5.5.0+1.21.11-fabric" = _CCYHQNPy;
        "pkg-5.5.0+1.21.10-fabric" = _6f8lajmK;
        "pkg-5.5.0+1.21.10-neoforge" = _GiphE5w9;
        "pkg-5.5.0+1.21.11-neoforge" = _CH03pFE5;
        "pkg-5.5.0+1.21.8-fabric" = _9CNUpNqF;
        "pkg-5.5.0+1.21.8-neoforge" = _XXNuHbSx;
        "pkg-5.5.0+1.21.9-neoforge" = _dmQYrx3T;
        "pkg-5.5.0+1.21.9-fabric" = _BrHbvFma;
        "pkg-5.6.0+1.21.10-neoforge" = _Q0d55Xdv;
        "pkg-5.6.0+1.21.10-fabric" = _ldrnyC3X;
        "pkg-5.6.0+1.21.11-fabric" = _U9Nv5edU;
        "pkg-5.6.0+1.21.1-fabric" = _xjrCAHe2;
        "pkg-5.6.1+1.21.11-fabric" = _pnleTuXl;
        "pkg-5.6.1+1.21.10-neoforge" = _yChwytvd;
        "pkg-5.6.1+1.21.11-neoforge" = _YJVKmFBK;
        "pkg-5.6.1+1.21.8-neoforge" = _MRDjGXkx;
        "pkg-5.6.1+1.21.1-fabric" = _ohlCgC5D;
        "pkg-5.6.1+1.21.10-fabric" = _ypL95ASF;
        "pkg-5.6.1+1.21.8-fabric" = _MapGdHA3;
        "pkg-5.6.1+1.21.9-neoforge" = _aPrrXgrx;
        "pkg-5.6.1+1.21.9-fabric" = _YD8fbjBz;
        "pkg-5.6.1" = _AU7JmVc3;
        "pkg-5.7.0+1.21.1-fabric" = _qipjQLi5;
        "pkg-5.7.0+26.1-neoforge" = _s4u15GKe;
        "pkg-5.7.0+26.1-fabric" = _JS3hL8Pg;
        "pkg-5.7.0+1.21.11-neoforge" = _yuKBqyuh;
        "pkg-5.7.0+1.21.11-fabric" = _e6WWjY2C;
        "pkg-5.7.0+1.21.1-neoforge" = _wiULgFBt;
        "pkg-5.8.1+1.21.11-fabric" = _QLsdYY5Y;
        "pkg-5.8.1+26.1-fabric" = _kwqOhrx9;
        "pkg-5.8.1+1.20.1-fabric" = _oTjFQ5MX;
        "pkg-5.8.1+1.21.1-fabric" = _42e8KPCu;
        "pkg-5.8.1+1.21.11-neoforge" = _yg3DgGpN;
        "pkg-5.8.1+1.21.1-neoforge" = _jY30LG8o;
        "pkg-5.8.1+26.1-neoforge" = _VENAEzDP;
        "pkg-5.8.1+1.20.1-forge" = _OBrYcYZK;
        "pkg-5.8.2+1.20.1-fabric" = _QWn7ZDZe;
        "pkg-5.8.2+26.1-fabric" = _R2u2ceXd;
        "pkg-5.8.2+26.1-neoforge" = _9nIneDDt;
        "pkg-5.8.2+1.21.1-fabric" = _GndDIrsd;
        "pkg-5.8.2+1.21.11-fabric" = _93ZMuHpB;
        "pkg-5.8.2+1.21.1-neoforge" = _R2PBS3DA;
        "pkg-5.8.2+1.20.1-forge" = _Yx2Eflj2;
        "pkg-5.8.2+1.21.11-neoforge" = _60LlGJEs;
        "pkg-5.9.0+1.20.1-fabric" = _5zpKIMbN;
        "pkg-5.9.0+1.21.1-fabric" = _2biF6hgU;
        "pkg-5.9.0+1.21.1-neoforge" = _D9RoTDdN;
        "pkg-5.9.0+1.21.11-fabric" = _3RA9e9zn;
        "pkg-5.9.0+1.21.11-neoforge" = _kVLEl3cr;
        "pkg-5.9.0+26.1-fabric" = _ZemctT7K;
        "pkg-5.9.0+26.1-neoforge" = _ofbm6JPR;
        "pkg-5.9.0+1.20.1-forge" = _grxwr5IE;
        "pkg-5.9.1+1.20.1-fabric" = _3oEw88Rd;
        "pkg-5.9.1+1.21.1-fabric" = _p2cVIDzc;
        "pkg-5.9.1+1.21.1-neoforge" = _qIQbtSwh;
        "pkg-5.9.1+1.20.1-forge" = _PPMsnV3A;
        "pkg-5.9.1+1.21.11-neoforge" = _d6BMHgsC;
        "pkg-5.9.1+1.21.11-fabric" = _EkIaqiPb;
        "pkg-5.9.1+26.1-fabric" = _DjLeWYtW;
        "pkg-5.9.1+26.1-neoforge" = _4QvNgNgL;
        "pkg-5.9.2+1.21.1-neoforge" = _RAl1HTmF;
        "pkg-5.9.2+1.21.1-fabric" = _g7XSp3HR;
        "pkg-5.9.2+1.21.11-fabric" = _qT9FS6MA;
        "pkg-5.9.2+1.20.1-fabric" = _VNc9yZ1D;
        "pkg-5.9.2+1.21.11-neoforge" = _PhTfnAqZ;
        "pkg-5.9.2+26.1-fabric" = _clAyQNVJ;
        "pkg-5.9.2+26.1-neoforge" = _EIMDytZq;
        "pkg-5.9.2+1.20.1-forge" = _3SzReeat;
        "pkg-5.9.2+26.2-fabric" = _KkDVwb8X;
        "pkg-5.9.2+26.2-neoforge" = _KDBA9p69;
        "pkg-5.9.3-forge+1.20.1" = _ckxAHRd1;
        "pkg-5.9.3-neoforge+1.21.1" = _3KS5QvoB;
        "pkg-5.9.3-fabric+1.20.1" = _H9wdZtt5;
        "pkg-5.9.3-fabric+1.21.1" = _ZoWiWdpT;
        "pkg-5.9.3-neoforge+1.21.11" = _1p0zkNAf;
        "pkg-5.9.3-fabric+26.1.2" = _RKm8I57y;
        "pkg-5.9.3-neoforge+26.1.2" = _xqlSZREb;
        "pkg-5.9.3-fabric+1.21.11" = _QZi0I0Fb;
        "pkg-5.9.3-fabric+26.2" = _ZgUR0bS3;
        "pkg-5.9.3-neoforge+26.2" = _ktgwTSZn;
        "pkg-5.9.4-forge+1.20.1" = _dSICi7sk;
        "pkg-5.9.4-neoforge+1.21.1" = _NjJKTcf9;
        "pkg-5.9.4-fabric+1.20.1" = _g5k7LLxT;
        "pkg-5.9.4-fabric+1.21.1" = _ahZbWfc5;
        "pkg-5.9.4-neoforge+1.21.11" = _igO7BMVK;
        "pkg-5.9.4-fabric+26.1.2" = _CAtDYfyN;
        "pkg-5.9.4-fabric+1.21.11" = _eyYarPFx;
        "pkg-5.9.4-neoforge+26.1.2" = _D7b5g6Oh;
        "pkg-5.9.4-fabric+26.2" = _D1ywEcVV;
        "pkg-5.9.4-neoforge+26.2" = _u5np1j2P;
        "pkg-5.9.7-neoforge+1.21.1" = _Pa4gdWud;
        "pkg-5.9.7-forge+1.20.1" = _q6YWhI8l;
        "pkg-5.9.7-fabric+1.20.1" = _ABUkY3Hd;
        "pkg-5.9.7-fabric+1.21.1" = _rRGCY4tK;
        "pkg-5.9.7-fabric+26.1.2" = _3rFEXicW;
        "pkg-5.9.7-neoforge+1.21.11" = _dpQRDOUj;
        "pkg-5.9.7-neoforge+26.1.2" = _BaUUhssx;
        "pkg-5.9.7-fabric+1.21.11" = _DhZEHVTr;
        "pkg-5.9.7-fabric+26.2" = _M4xHWPd4;
        "pkg-5.9.7-neoforge+26.2" = _EVpi8jT3;
        "pkg-5.9.8-neoforge+1.21.1" = _BkFJRsxM;
        "pkg-5.9.8-forge+1.20.1" = _yleU6W85;
        "pkg-5.9.8-fabric+1.20.1" = _KyrlnuOn;
        "pkg-5.9.8-fabric+1.21.1" = _osKz6z5S;
        "pkg-5.9.8-neoforge+1.21.11" = _rV6xGQu1;
        "pkg-5.9.8-fabric+26.1.2" = _FsyXuHsg;
        "pkg-5.9.8-neoforge+26.1.2" = _EHhn6oMr;
