...
let
    ...
    in {
        ...
        "pkg-1.19.2-1.6.3" = _UIuZFMNl;
        "pkg-1.19.4-1.6.4" = _5L99xvsG;
        "pkg-1.19.2-1.6.4" = _JiMPZhDm;
        "pkg-1.19.2-1.6.5" = _Wc12g0b0;
        "pkg-1.19.4-1.6.5" = _etavgqn0;
        "pkg-1.20-1.7.0" = _jpBzAlTQ;
        "pkg-1.19.4-1.6.6" = _WtX2IvSC;
        "pkg-1.20-1.7.1" = _HIFLDZFf;
        "pkg-1.19.4-1.6.7" = _XormA9WB;
        "pkg-1.20-1.7.2" = _TdceP8aO;
        "pkg-1.19.4-1.6.8" = _sht5OISr;
        "pkg-1.19.2-1.6.6" = _dzamfWLf;
        "pkg-1.19.2-1.6.7" = _V8DzQK8V;
        "pkg-1.20-1.7.3" = _cvYvOC2G;
        "pkg-1.20.2-1.7.5" = _4VWzUMjR;
        "pkg-2.2.0" = _mqZgtnnf;
        "pkg-1.20.1-1.7.4" = _beG1ZivX;
        "pkg-1.20-1.7.4-neoforge-compatible" = _fV66An0U;
        "pkg-2.2.1" = _3DaaEqCZ;
        "pkg-2.2.2" = _htWiJNrK;
        "pkg-2.2.3" = _89YBePbE;
        "pkg-2.2.4" = _hSOJkjzm;
        "pkg-2.2.5" = _zaOLQ3fu;
        "pkg-1.20.1-1.7.5" = _wpMMpQZA;
        "pkg-1.7.6" = _daDr4qm0;
        "pkg-2.2.6" = _YlFouAv4;
        "pkg-1.7.7" = _FoBE5l9H;
        "pkg-2.2.7" = _BMezbCaG;
