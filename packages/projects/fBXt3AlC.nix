...
let
    ...
    in {
        ...
        "7NRH9JpE" = _7NRH9JpE;
        "xeEm4i1L" = _xeEm4i1L;
        "fabric-26.1" = _7NRH9JpE;
        "fabric-26.1.1" = _7NRH9JpE;
        "fabric-26.1.2" = _7NRH9JpE;
        "fabric-26.2" = _xeEm4i1L;
        "fabric-1.21.10" = _SXuaODum;
        "fabric-1.21.11" = _dZLPACDP;
        "fabric-1.21" = _elt7WPw1;
        "fabric-1.21.1" = _elt7WPw1;
