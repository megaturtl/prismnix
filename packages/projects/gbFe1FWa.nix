...
let
    ...
    in {
        ...
        "pkg-1.16.5-2" = _bjdE61mQ;
        "pkg-1.17-5" = _zSGnj5Sz;
        "pkg-1.18-4" = _ubXbccxW;
        "pkg-1.19-2" = _hsUOaUFN;
        "pkg-1.19-3" = _a4AK5ZNQ;
        "pkg-1.19-4" = _yTazv9fD;
        "pkg-1.20-1" = _Q5VMPADX;
        "pkg-1.20.6-r1" = _lGqKZtCA;
        "pkg-1.21-r1" = _nM4gmHE6;
        "pkg-1.21-r2" = _DxDhy0br;
        "pkg-1.21.2-r1" = _wL29alkF;
        "pkg-1.21.4-r1" = _9Keoy2BR;
        "pkg-1.21.5-r1" = _3Vf07y1s;
        "pkg-1.21.5-r2" = _Lfqf7zcG;
        "pkg-1.21.6-r1" = _ExTCaBkj;
        "pkg-1.21.9-r1" = _8XuCPnzH;
        "pkg-1.21.10-r1" = _bHIS3Lvj;
        "pkg-1.21.10-r2" = _forZ3bO6;
        "pkg-1.21.11-r1" = _vebVQvV8;
        "pkg-1.21.11-r2" = _sX4NjBZI;
        "pkg-1.21.11-r3" = _XZKqAd1N;
        "pkg-26.1-r1" = _LvmgVDK6;
