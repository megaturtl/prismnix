...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _20RsqQKW;
        "pkg-1.0.9" = _njwhJHUw;
        "pkg-1.0.10" = _Ul4k8Rcs;
        "pkg-1.0.11" = _A021n2Jg;
        "pkg-1.0.12" = _wPWOm9P1;
        "pkg-1.0.13" = _blsvS9Qz;
        "pkg-5.8.2.423" = _ZE0J9o49;
        "pkg-1.0.14" = _DJuElgXb;
        "pkg-5.8.2.424" = _HgY1dW7s;
        "pkg-2.0.0" = _P3Gzbif3;
        "pkg-2.0.1" = _IsgpWrtW;
        "pkg-2.0.2" = _VZ4SYNgj;
        "pkg-2.0.3" = _waGRbT2d;
        "pkg-1.0.15" = _TnSGtGB1;
        "pkg-2.0.4" = _Kic9tPEq;
        "pkg-1.0.16" = _q98RKZEA;
        "pkg-2.1.0" = _Qw6BPY4P;
        "pkg-2.1.1" = _efyYlTXL;
        "pkg-2.1.2" = _1WDx8G7C;
        "pkg-2.1.3" = _YVjQgEuT;
