...
let
    versions = (let
        ...
        _zpvgwUNq = {
            "id" = "zpvgwUNq";
            "file" = "chunkmanager-1.3.7.jar";
            "hash" = "sha512-vKJ09hqsp/sc/VjO9INOA5nmqDplvC1Dtzuyjt/hxlFCWTGsaz1Sa21+RGMmucVxLB/UFe3HUFx2BPfH2RZIgA==";
        };
        _AAV2Mv7m = {
            "id" = "AAV2Mv7m";
            "file" = "chunkmanager-1.3.8.jar";
            "hash" = "sha512-MtMcCbho6J1RmceDw4vCQ0L3I7CSw3BDVeTdxXqLRTJJdTs9yBJMxgXpfa335OsOILZ/4qjHMygP52zbwdKWZg==";
        };
    in {
        "7WeCgbua" = _7WeCgbua;
        "vecEemLH" = _vecEemLH;
        ...
        "zpvgwUNq" = _zpvgwUNq;
        "AAV2Mv7m" = _AAV2Mv7m;
        "bukkit-1.20" = _AAV2Mv7m;
        "bukkit-1.20.1" = _AAV2Mv7m;
        "bukkit-1.20.2" = _AAV2Mv7m;
        "bukkit-1.20.3" = _AAV2Mv7m;
        "bukkit-1.20.4" = _AAV2Mv7m;
        "bukkit-1.20.5" = _AAV2Mv7m;
        "bukkit-1.20.6" = _AAV2Mv7m;
        "bukkit-1.21" = _AAV2Mv7m;
        "bukkit-1.21.1" = _AAV2Mv7m;
        "bukkit-1.21.2" = _AAV2Mv7m;
        "bukkit-1.21.3" = _AAV2Mv7m;
        "bukkit-1.21.4" = _AAV2Mv7m;
        "bukkit-1.21.5" = _AAV2Mv7m;
        "bukkit-1.21.6" = _AAV2Mv7m;
        "bukkit-1.21.7" = _AAV2Mv7m;
        "bukkit-1.21.8" = _AAV2Mv7m;
        "bukkit-1.21.9" = _AAV2Mv7m;
        "bukkit-1.21.10" = _AAV2Mv7m;
        "bukkit-1.21.11" = _AAV2Mv7m;
        "bukkit-26.1" = _AAV2Mv7m;
        "bukkit-26.1.1" = _AAV2Mv7m;
        "bukkit-26.1.2" = _AAV2Mv7m;
        "bukkit-26.2" = _AAV2Mv7m;
        "paper-1.20" = _AAV2Mv7m;
        "paper-1.20.1" = _AAV2Mv7m;
        "paper-1.20.2" = _AAV2Mv7m;
        "paper-1.20.3" = _AAV2Mv7m;
        "paper-1.20.4" = _AAV2Mv7m;
        "paper-1.20.5" = _AAV2Mv7m;
        "paper-1.20.6" = _AAV2Mv7m;
        "paper-1.21" = _AAV2Mv7m;
        "paper-1.21.1" = _AAV2Mv7m;
        "paper-1.21.2" = _AAV2Mv7m;
        "paper-1.21.3" = _AAV2Mv7m;
        "paper-1.21.4" = _AAV2Mv7m;
        "paper-1.21.5" = _AAV2Mv7m;
        "paper-1.21.6" = _AAV2Mv7m;
        "paper-1.21.7" = _AAV2Mv7m;
        "paper-1.21.8" = _AAV2Mv7m;
        "paper-1.21.9" = _AAV2Mv7m;
        "paper-1.21.10" = _AAV2Mv7m;
        "paper-1.21.11" = _AAV2Mv7m;
        "paper-26.1" = _AAV2Mv7m;
        "paper-26.1.1" = _AAV2Mv7m;
        "paper-26.1.2" = _AAV2Mv7m;
        "paper-26.2" = _AAV2Mv7m;
        "spigot-1.20" = _AAV2Mv7m;
        "spigot-1.20.1" = _AAV2Mv7m;
        "spigot-1.20.2" = _AAV2Mv7m;
        "spigot-1.20.3" = _AAV2Mv7m;
        "spigot-1.20.4" = _AAV2Mv7m;
        "spigot-1.20.5" = _AAV2Mv7m;
        "spigot-1.20.6" = _AAV2Mv7m;
        "spigot-1.21" = _AAV2Mv7m;
        "spigot-1.21.1" = _AAV2Mv7m;
        "spigot-1.21.2" = _AAV2Mv7m;
        "spigot-1.21.3" = _AAV2Mv7m;
        "spigot-1.21.4" = _AAV2Mv7m;
        "spigot-1.21.5" = _AAV2Mv7m;
        "spigot-1.21.6" = _AAV2Mv7m;
        "spigot-1.21.7" = _AAV2Mv7m;
        "spigot-1.21.8" = _AAV2Mv7m;
        "spigot-1.21.9" = _AAV2Mv7m;
        "spigot-1.21.10" = _AAV2Mv7m;
        "spigot-1.21.11" = _AAV2Mv7m;
        "spigot-26.1" = _AAV2Mv7m;
        "spigot-26.1.1" = _AAV2Mv7m;
        "spigot-26.1.2" = _AAV2Mv7m;
        "spigot-26.2" = _AAV2Mv7m;
        ...
        "folia-1.21" = _AAV2Mv7m;
        "folia-1.21.1" = _AAV2Mv7m;
        "folia-1.21.2" = _AAV2Mv7m;
        "folia-1.21.3" = _AAV2Mv7m;
        "folia-1.21.4" = _AAV2Mv7m;
        "folia-1.21.5" = _AAV2Mv7m;
        "folia-1.21.6" = _AAV2Mv7m;
        "folia-1.21.7" = _AAV2Mv7m;
        "folia-1.21.8" = _AAV2Mv7m;
        "folia-1.21.9" = _AAV2Mv7m;
        "folia-1.21.10" = _AAV2Mv7m;
        "folia-1.21.11" = _AAV2Mv7m;
        "folia-26.1" = _AAV2Mv7m;
        "folia-26.1.1" = _AAV2Mv7m;
        "folia-26.1.2" = _AAV2Mv7m;
        "folia-1.20" = _AAV2Mv7m;
        "folia-1.20.1" = _AAV2Mv7m;
        "folia-1.20.2" = _AAV2Mv7m;
        "folia-1.20.3" = _AAV2Mv7m;
        "folia-1.20.4" = _AAV2Mv7m;
        "folia-1.20.5" = _AAV2Mv7m;
        "folia-1.20.6" = _AAV2Mv7m;
        "folia-26.2" = _AAV2Mv7m;
        "pkg-1.0.4" = _7WeCgbua;
        "pkg-1.0.5" = _vecEemLH;
        "pkg-1.0.8" = _LwEzPJtK;
        "pkg-1.0.9" = _znp7RvAQ;
