...
let
    ...
    in {
        ...
        "pkg-1.1.1+1.21.2-pre1" = _WckNqEyz;
        "pkg-1.1.1+1.21.2-rc2" = _m1RQ5HdO;
        "pkg-1.2.0+24w44a" = _h7SkLELT;
        "pkg-1.2.0+1.21.4" = _qbaJDvSM;
        "pkg-1.2.1+1.21.4" = _52vZHIEF;
        "pkg-1.3.0+1.21.4" = _tlOkzxHN;
        "pkg-1.4.0+1.21.4" = _LAR01y9W;
        "pkg-1.5.0+1.21.4" = _LJZEvEsC;
        "pkg-1.5.1+1.21.4" = _banuZYXZ;
        "pkg-1.5.2+1.21.4" = _8rZj6oqu;
        "pkg-1.5.3+1.21.4" = _SXjkqjK0;
        "pkg-1.5.3+1.21.5-rc1" = _78C19EBz;
        "pkg-2.0.0+1.21.5" = _DeNmuCMP;
        "pkg-2.1.0+1.21.6-pre1" = _LnyV0yb3;
        "pkg-2.1.0+1.21.9" = _jqyUzAOt;
        "pkg-3.0.0+1.21.10" = _IwB45aUe;
        "pkg-3.0.1+1.21.10" = _p5YeTpbh;
        "pkg-3.0.1+1.21.11-rc2" = _OSPMZg8N;
        "pkg-3.1.0+1.21.11" = _BSsb9IYL;
