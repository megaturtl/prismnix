...
let
    versions = (let
        ...
        _1WloiFuy = {
            "id" = "1WloiFuy";
            "file" = "mcpitanlib-3.7.2-fix.1-26.2-fabric.jar";
            "hash" = "sha512-IXzhZtwrYH9KeUg9gYq3jf7c2GDlP6p3+iO4u2smxaJh6HB0Ewarsf862yobkG0oORF/QDF/VtCWOS6htpsWaA==";
        };
        _zQKUkXwC = {
            "id" = "zQKUkXwC";
            "file" = "mcpitanlib-3.7.2-fix.1-26.2-neoforge.jar";
            "hash" = "sha512-P+q2BAeAGw19j07Htminnw7ElIpVvqS4JOVbDqzfeI3xOzj3YknkzvDfsPSLpp4qtnUdXlP8lav9lqrJvlxAPw==";
        };
        _r6KNrJJ4 = {
            "id" = "r6KNrJJ4";
            "file" = "mcpitanlib-3.7.2-fix.2-26.1-neoforge.jar";
            "hash" = "sha512-zw46XG+xIwcermlHtA0xL6fzkaF3HgeNCr5aHFBPW8A+eyF6iScXeq7hEqT4roVmhCC6DSMdF+tImvq18IWtwg==";
        };
        _C8It9aFM = {
            "id" = "C8It9aFM";
            "file" = "mcpitanlib-3.7.2-fix.2-26.1-fabric.jar";
            "hash" = "sha512-Qru6EPmuZRlygZMhsHSK7DA3R10HgM8CH+F6xNiGa2DMNktij2MrHPiMivr//4UMjIOoonEKfzv89ToTbZkp/g==";
        };
        _WDFEFCYp = {
            "id" = "WDFEFCYp";
            "file" = "mcpitanlib-3.7.2-fix.2-26.2-fabric.jar";
            "hash" = "sha512-rSsJj+euv1dFL57e92IByW3rW8ZjV7UxLreGzKSek96PbuH4nPu+NX8enj/wtkyYCfVsm5/vDwOFruzrHFxdLg==";
        };
        _5kbatlma = {
            "id" = "5kbatlma";
            "file" = "mcpitanlib-3.7.2-fix.2-26.2-neoforge.jar";
            "hash" = "sha512-c37XmrupJF+/lzV0t6Wt/a/uUpOls2QOSp6QgJvhO+AjEtaBTFoCJBpUGkoyMdMhftsc7zt+5/sbw6M2whBbxA==";
        };
        _19s6DeUp = {
            "id" = "19s6DeUp";
            "file" = "mcpitanlib-3.7.2-fix.3-26.2-fabric.jar";
            "hash" = "sha512-tHCCpLL7aGY76xELqoA1LwqGoZ4FDh8tkBSGUsvR74r6wNxONn2+S9L0U1dIHPZxaCZ0Eddgb0e5/nH1iTepgQ==";
        };
        _PATH2FhG = {
            "id" = "PATH2FhG";
            "file" = "mcpitanlib-3.7.2-fix.3-26.2-neoforge.jar";
            "hash" = "sha512-KVryj0jWfWZUhCrkv3HO1FZDTIcnes5195fHUMEuoQEbcdThOECcVpt4UN99EIGxte7Og6cKGONZSOt1PtXABg==";
        };
        _MA8EfJs0 = {
            "id" = "MA8EfJs0";
            "file" = "mcpitanlib-3.7.2-fix.3-26.1-neoforge.jar";
            "hash" = "sha512-5slWzhI9LSljpy3EQdjuziyamw48c7udeo/tnOs2ADiyglWjzF58CFNrMKCaUg6z69zo8Lu6Luvzge8c41hkTA==";
        };
        _5khNCQoV = {
            "id" = "5khNCQoV";
            "file" = "mcpitanlib-3.7.2-fix.3-26.1-fabric.jar";
            "hash" = "sha512-ThjDqLf7rjZ49BzmjCXyHl9R2umg0uS45kDjTSlmWQtthtVsWEKAYs2mAISrK4O7rOG+Wya8umcsnu6a8Jr9Zw==";
        };
        _jG8Drhi7 = {
            "id" = "jG8Drhi7";
            "file" = "mcpitanlib-4.0.0-1.20.4-forge.jar";
            "hash" = "sha512-Gp0siGh4mx5JDsuh7qcTeFS/QI3EPEepxd1i97RoMRoc+Q62n1YX/SPC3fCvkCZ4cm6GwwZyZJvNmr4xrlzs3g==";
        };
        _5aaYMMbZ = {
            "id" = "5aaYMMbZ";
            "file" = "mcpitanlib-4.0.0-1.20.4-fabric.jar";
            "hash" = "sha512-t0mv9dO/gJOJNZ2ckCTLCrtWAduV35pTKjFfa7Ik+H421neUD9tpHFl/wX3y4JtYmg8V7/PUP6nLV7FoJ9ZZVQ==";
        };
        _4pRKReyi = {
            "id" = "4pRKReyi";
            "file" = "mcpitanlib-4.0.0-1.20.4-neoforge.jar";
            "hash" = "sha512-rc+CsiWDjFL64pxuxlrTJ2YVRySKbC80utXJBZs6TXOdNn2qeTbeIVYS0GY2z7PspTRe75LbpAbFMylG5WgzHQ==";
        };
        _zmgCqaKv = {
            "id" = "zmgCqaKv";
            "file" = "mcpitanlib-4.0.0-1.18.2-forge.jar";
            "hash" = "sha512-aMpmYVnJ7+Ya3ge28WniWuJJfcTEc2dsETMv7L7M7uLF1lBp1Mrfobzyx1hstjs7VQwxzZztUjebCYhF+S+dJg==";
        };
        _PmTVpXzI = {
            "id" = "PmTVpXzI";
            "file" = "mcpitanlib-4.0.0-1.18.2-fabric.jar";
            "hash" = "sha512-2ChDF9viPf59ekBTGhiPWsFab2Elmr1qGiABi1J8i6tvGEsM9wbTzk5mVWF3wOuuMYDUWiRWxLrHc5DMFzcQdw==";
        };
        _cBc3Toim = {
            "id" = "cBc3Toim";
            "file" = "mcpitanlib-4.0.0-1.20.1-forge.jar";
            "hash" = "sha512-srzjwvESjlPu1gH7ZLQDTZWgu4+tsqEnhkKl89XqlC5N97cfyHwSMk+m0m5rFXtJtrksX/GMgVnUavISysoyTQ==";
        };
        _4333rmAa = {
            "id" = "4333rmAa";
            "file" = "mcpitanlib-4.0.0-1.16.5-forge.jar";
            "hash" = "sha512-aO/MN6A5uWN0KAX3D7kJrg/b5vm/nBrsTmEHSiedTPMgnO/yFMQr6/kXg7WY7sJqwDZ/YqQ34vBxb4ZJC9CD3Q==";
        };
        _ZIpYJAA1 = {
            "id" = "ZIpYJAA1";
            "file" = "mcpitanlib-4.0.0-1.16.5-fabric.jar";
            "hash" = "sha512-UPC448xwdXbaaIIEp02zX7SgnVto7avJnaRnOTI8a9juN1Fu4vCx58MBuuyeYe4S9BRe8CZ4UQoc6gxTBfQpyg==";
        };
        _nuFISbnK = {
            "id" = "nuFISbnK";
            "file" = "mcpitanlib-4.0.0-1.19.2-forge.jar";
            "hash" = "sha512-2O0HMy9mkfpVzlChStL+aWBgL9CFmEjxgxyx4OMQFlOH+gnL1IY4cpNbOsT/hiO0SleIFWO5i7J4ojnOb8rZDg==";
        };
        _cveXdIlz = {
            "id" = "cveXdIlz";
            "file" = "mcpitanlib-4.0.0-1.19.2-fabric.jar";
            "hash" = "sha512-h8CdOfib5jC7uXV586WG/BJc1a+6Od7WodMrGsNeAJ72wPSCqHFRp0hcRJw3kX1N3xj7Bmu0GdYPTGHbf2CbgQ==";
        };
        _M6ilxKoz = {
            "id" = "M6ilxKoz";
            "file" = "mcpitanlib-4.0.0-1.21.1-fabric.jar";
            "hash" = "sha512-Vq6CiyDrUsEscedlo6CIhU/W8sU/BY/ZK8b6y+xu9XwcCNLWO2AyVCD9gD1QCcSJq+BbPPZXn50qERbb8kuvog==";
        };
        _YX1LbN6O = {
            "id" = "YX1LbN6O";
            "file" = "mcpitanlib-4.0.0-1.21.1-neoforge.jar";
            "hash" = "sha512-NnjPUYHJOzjxtH1lMWza0caayah488VIgYMAOJ7ntZSRYFnDDAFyiSPavAauuoT6bpMaYyWbpiZD07Qaex/WiA==";
        };
        _bIB7awq5 = {
            "id" = "bIB7awq5";
            "file" = "mcpitanlib-4.0.0-1.20.1-fabric.jar";
            "hash" = "sha512-CnXVouJjheSvg5oULx1AiJDALP2tlzHcPiVMwwNLyuJLbCbfMddqP4oDweO69oBRgdbyfVOZPyTVFLnOEMhW1Q==";
        };
        _wK7Qog9W = {
            "id" = "wK7Qog9W";
            "file" = "mcpitanlib-4.0.0-1.21.3-neoforge.jar";
            "hash" = "sha512-+rXeu6VCilrjrvSQ8bWj6IdxoyF0BSA9r9xGgtE7+QuBlQ3jqNY8SQC6y1NH9lNho3vn+6arlYpjz+taEFjtdQ==";
        };
        _zpCkQXEL = {
            "id" = "zpCkQXEL";
            "file" = "mcpitanlib-4.0.0-1.21.3-fabric.jar";
            "hash" = "sha512-z+dTmsOPjCWxrXAU6FT1a9uEuajMF1XC1gpz0WS6LbvYNjppXWNHaOM1xwpcLEZK6UzuKg/tsw7CnDaXyIM7MQ==";
        };
        _ams0KVwf = {
            "id" = "ams0KVwf";
            "file" = "mcpitanlib-4.0.0-1.21.4-neoforge.jar";
            "hash" = "sha512-wPWhVaEwclwTgXhf5/n3Ts/pTpbk5xgRV9LBrmwLI/vjRmGB2sJZ8P9OZDVuXlPlqP8j7xT8vKRIkJxz3wDUyg==";
        };
        _zNjC8RdF = {
            "id" = "zNjC8RdF";
            "file" = "mcpitanlib-4.0.0-1.21.4-fabric.jar";
            "hash" = "sha512-hzC290j5FQMYMvEhJR5P84FzrylkK2oG9IvywsI2U8eIeIx6qCIxRp/7am3jxQTob1UCN3hIVV5N/fsre6gHog==";
        };
        _S97PlC8V = {
            "id" = "S97PlC8V";
            "file" = "mcpitanlib-4.0.0-1.21.5-neoforge.jar";
            "hash" = "sha512-bUmYWzHG/1BIaAKWiv84/e1pKlt7RLNMrfLD5cY4BFmstpXiH2/9L3GzLaQpPsAc5dqTvC+DTSAXPgRylPTZSQ==";
        };
        _RLEg8zVp = {
            "id" = "RLEg8zVp";
            "file" = "mcpitanlib-4.0.0-1.21.5-fabric.jar";
            "hash" = "sha512-rLZYU2G3lwjXniQX0B/bWzLAjbIjiK+ASj8WNLOu/Zf7MR2ULf+/ROvxBfUKRUUAb0gaKVXSS9wd+cjhmbhcZg==";
        };
        _ln0Uh12F = {
            "id" = "ln0Uh12F";
            "file" = "mcpitanlib-4.0.0-1.21.6-fabric.jar";
            "hash" = "sha512-u4Scjs/OqAtCmv1L1yTRmS80K3vk9YlIxy6VCQQ/WBgG1ngaI2QmFKqwbYmBZoE2NgslncYt4HNjVPnoVi8New==";
        };
        _a2SLXeJ3 = {
            "id" = "a2SLXeJ3";
            "file" = "mcpitanlib-4.0.0-1.21.6-neoforge.jar";
            "hash" = "sha512-PP339KZC/+rVbrz4wy4Pt/g7y46+vXXTV0ILV1s/QniZgAMImN25/grzdLgeX21T8ckymjyldE5pDjoK89rrBw==";
        };
        _7nA0DbUX = {
            "id" = "7nA0DbUX";
            "file" = "mcpitanlib-4.0.0-1.21.9-neoforge.jar";
            "hash" = "sha512-D+G42GOVEPUc14QYgTHhLp4niaUoST/DRoVuVF4iFMNC0z1wwW0L6Z4Ud8PaPOuyJ6XUeRCgMjuMysHcwelSeQ==";
        };
        _AsWdwPKW = {
            "id" = "AsWdwPKW";
            "file" = "mcpitanlib-4.0.0-1.21.9-fabric.jar";
            "hash" = "sha512-G86AnNeeuueir0s10wxDgqp1+PY47bKGsE0iC+kL8M4bSi2ZaQ8mFhyMPR+0uVMzoM6SoyMRvT7B+hHpD3/BUw==";
        };
        _BT5rsiwQ = {
            "id" = "BT5rsiwQ";
            "file" = "mcpitanlib-4.0.0-1.21.11-fabric.jar";
            "hash" = "sha512-yMXWGDerZW64DuEe1r39kOmI9gzo3aMdld51MZrH9WNSwNVQ5WhdiaXTSg3JZA6sGDeqdqgpb1VbPbJZZS9PfA==";
        };
        _EFrUygwh = {
            "id" = "EFrUygwh";
            "file" = "mcpitanlib-4.0.0-1.21.11-neoforge.jar";
            "hash" = "sha512-vMZo8L5JKZFYyEpxe4x3l0EojYqjy5/qNIvRVuoSHaBHBi3RqY/SUi5YJhGOl9RheuPY7tXJIiAEpfA43iL46w==";
        };
        _UtRdmCan = {
            "id" = "UtRdmCan";
            "file" = "mcpitanlib-4.0.0-26.1-neoforge.jar";
            "hash" = "sha512-/38doIcaRI9BFK31QhF2/gJ/V/ThyNVizPhRFF2Gd8L3D1BgFw8Nul2Aj7eE2TulO9WiDq+m4q/FX6kMgXVYaQ==";
        };
        _d9EK7IzU = {
            "id" = "d9EK7IzU";
            "file" = "mcpitanlib-4.0.0-26.1-fabric.jar";
            "hash" = "sha512-l/k7vlpdF/8/0eJV3Kb3+pZZeIqm4rkXycPrKG745t4KTBv3hq7xeeNys6bJejAMYR5VUMXLC6ph810nkCewcw==";
        };
        _mpbqLKk7 = {
            "id" = "mpbqLKk7";
            "file" = "mcpitanlib-4.0.0-26.2-neoforge.jar";
            "hash" = "sha512-JuDGl3pyL/vncYorcqwVa9sxwxUT7XbA66dGWI4G0u69NzucAZCPzhM3i6Hf32tcTn7eQZ9mrAgbO+oOi+SF4A==";
        };
        _WbR1KNZW = {
            "id" = "WbR1KNZW";
            "file" = "mcpitanlib-4.0.0-26.2-fabric.jar";
            "hash" = "sha512-1FS0hqN2S0aZ4yzvIB0catSxk7WLjxatwBvB7wY8zyTMS3MkxVGQUjEjtx2ww6CC8ZPxCkiEH1xIG7XEtKft9g==";
        };
        _qOtc5IAI = {
            "id" = "qOtc5IAI";
            "file" = "mcpitanlib-4.0.0-fix.1-1.20.4-forge.jar";
            "hash" = "sha512-Z6AdirH88c5Ol85AfCK59ex8Qh+RwS9hgXc4scRpMUUf/HsSmO6lmiYbQg8E0dMKUyJ1sTLeMKWuaOhFH8xLHg==";
        };
        _JjxBnW2d = {
            "id" = "JjxBnW2d";
            "file" = "mcpitanlib-4.0.1-1.20.4-forge.jar";
            "hash" = "sha512-wxjz3UajJLP4E1wA03tArIKf0TDBI+uLgqR4G/ytpcR5iUYYEkaASUHGdZyzLuNBTXL7A7/LIDBe9QKQCVDSRA==";
        };
        _Tw59cSty = {
            "id" = "Tw59cSty";
            "file" = "mcpitanlib-4.0.1-1.20.4-fabric.jar";
            "hash" = "sha512-E2Yzo96Af1CzFsxTIeXvqx4qMl5zXStOn6edahRXAJZezT4SD59JInkaPiuV3xnz4h1muizmmXJ62VncuOs7hg==";
        };
        _n8BwBZ2i = {
            "id" = "n8BwBZ2i";
            "file" = "mcpitanlib-4.0.1-1.20.4-neoforge.jar";
            "hash" = "sha512-szcwnxr1/LbVwfJbCxdEDsdaIF19fWNd6L19yMWLB5Ikokqr8tETFb5sIPplhA5kFKPmTwRPDjXYfAnySLaznQ==";
        };
        _fG6XW2kB = {
            "id" = "fG6XW2kB";
            "file" = "mcpitanlib-4.0.1-1.18.2-forge.jar";
            "hash" = "sha512-/OY6uBayIgSRXrxiHrypZWpncvBNCsro5c3UoQr8RKcMw0ABFCrbUlYzH1QHIa9NhuQqOICOUkp0rbNXBdFutQ==";
        };
        _samtQsbr = {
            "id" = "samtQsbr";
            "file" = "mcpitanlib-4.0.1-1.18.2-fabric.jar";
            "hash" = "sha512-hc77K8wrFs9DUL0LxX64/zmLNx7wdBkI5ZTGg5CpE5MZX9tGV2V6KDEidtYVMDloYbDeENKB5S5si6XoqJm2EQ==";
        };
        _42ym7tsW = {
            "id" = "42ym7tsW";
            "file" = "mcpitanlib-4.0.1-1.20.1-forge.jar";
            "hash" = "sha512-mcO+LbKJVhWT5MWkdmQyckpKLpPwLnz6wiLMqrPoCVAfSG/Rdg6QaHLK2VcasB4jW0k8OKHS8tk5bsvPQnn/Cg==";
        };
        _OPYojGuW = {
            "id" = "OPYojGuW";
            "file" = "mcpitanlib-4.0.1-1.20.1-fabric.jar";
            "hash" = "sha512-WiUTOIYKck+Mcns8ECWqKLZyONapygrMsmzE/SiVzOjwrdJeVXa5gyRfNvdkZY3XFiKOVHyXzE8YvqFpkERvZQ==";
        };
        _Igjhp8m9 = {
            "id" = "Igjhp8m9";
            "file" = "mcpitanlib-4.0.1-1.16.5-forge.jar";
            "hash" = "sha512-tNoik/vUvGjFQVAwQKr4YsTSGqCwsxEdFnW10agZtphWD7//6Im0jjDONWwWncuI38TWN+3kUacWoZ4kmlEb1g==";
        };
        _s9sO6MAH = {
            "id" = "s9sO6MAH";
            "file" = "mcpitanlib-4.0.1-1.16.5-fabric.jar";
            "hash" = "sha512-yJ5QKfZWYe8p9hlqMZa2wTqx65Ut+ffL2Lpzp5QXZMQa1DiY89Gvk8xNBykL6uL1+pSBR2eD+JQ+qLpIWoeRow==";
        };
        _a1Dh9Pyk = {
            "id" = "a1Dh9Pyk";
            "file" = "mcpitanlib-4.0.1-1.19.2-forge.jar";
            "hash" = "sha512-48GUChyuhhwMeEvQP/Pz2bShOuikLJkr8F8nQFmriFMZKicdRGh5GTGOgY/0y9l5YHKAiTaMr0sbqIYgZi/k3w==";
        };
        _bOFsFA2d = {
            "id" = "bOFsFA2d";
            "file" = "mcpitanlib-4.0.1-1.19.2-fabric.jar";
            "hash" = "sha512-HTyud3AWBa4mY0cYQC9jsGwazSiy876K3b7o7sdy52ZoduOe0SHJlxRVU3wBr5qJMV8sqLq/KIHIpOp53idZQA==";
        };
        _lX6qEF0v = {
            "id" = "lX6qEF0v";
            "file" = "mcpitanlib-4.0.1-1.21.1-neoforge.jar";
            "hash" = "sha512-C6U2l+SNI1UYcwVvSxjVF5ZVhKkD8Ixs9Hq5vItTtpiBIzlSjcNM9b+MbXZ6Xv2HTJG35UZriCU+AyvQMb9aOw==";
        };
        _OPl0XmaP = {
            "id" = "OPl0XmaP";
            "file" = "mcpitanlib-4.0.1-1.21.1-fabric.jar";
            "hash" = "sha512-UM40mBas4qDu5ONuXO4KlvMl97tOLZygjdM+ZYuzV93TiywJbCzs9rCgK05rGxh0Xr1QtIKjvhgEetmUaGjCjg==";
        };
        _jbpQKnjW = {
            "id" = "jbpQKnjW";
            "file" = "mcpitanlib-4.0.1-1.21.3-fabric.jar";
            "hash" = "sha512-bbLmYf7tUkh763Eq/YXp7aipqYsu+Imkxyk58xRedJ2Htu6hEaO+QJVT+VOf9mWdjeMNPXTMr3gialCrixvPnQ==";
        };
        _szM54zVs = {
            "id" = "szM54zVs";
            "file" = "mcpitanlib-4.0.1-1.21.3-neoforge.jar";
            "hash" = "sha512-8F88ugnFfeo1Azb2jZ6iga5ut9KnwYIzqoPmOcCJf1ywVuE4OVctfLtZk2uwscy20Z3QxuvG4scQpgIvaBYW9w==";
        };
        _H0fB67tc = {
            "id" = "H0fB67tc";
            "file" = "mcpitanlib-4.0.1-1.21.4-fabric.jar";
            "hash" = "sha512-+3fKGvdNmizNLoKXbj3Tagc9UL+PKueScAVWQcs1zdxIDGa1VsRC+o9vM0iw/ef1QOSe/FdeAiscKWr2Z14H3w==";
        };
        _nx6u4ziG = {
            "id" = "nx6u4ziG";
            "file" = "mcpitanlib-4.0.1-1.21.4-neoforge.jar";
            "hash" = "sha512-eZhS+Iv1sdcYYmWguOVpBqnrbD0u/qWDrf0pdl/02v6zHt88PzaWqq5TwFEygTuINfGDixfCFL3ftNKkwwgJVQ==";
        };
        _avAxnDvg = {
            "id" = "avAxnDvg";
            "file" = "mcpitanlib-4.0.1-1.21.5-fabric.jar";
            "hash" = "sha512-WnNDj8TmfeSVgBjSycVBrOKi2636hkeNOEWe8a/Fc8huS/9JcXjh0Et1t5eMHYTURyqyaHzn4kyWuD0oNRmFbw==";
        };
        _2DURAjaY = {
            "id" = "2DURAjaY";
            "file" = "mcpitanlib-4.0.1-1.21.5-neoforge.jar";
            "hash" = "sha512-J7GmlQZpr12aC1KDuuoMN9gwnbwSQmqxEhf1AjwTAvUE3Pu28RqX2zCZrbMuWWbAkw9LTQ+yRuV84ag84o+/Rg==";
        };
        _GPgKJ38a = {
            "id" = "GPgKJ38a";
            "file" = "mcpitanlib-4.0.1-1.21.6-neoforge.jar";
            "hash" = "sha512-+uzOrlRmMRzcFzpxTTCpbJ33otXAXizvQsuW4WwXmQyYe4312mgld2ksPm3v6GEeOtEXyn40JkgwJS0BsD94EA==";
        };
        _cUmmzdfY = {
            "id" = "cUmmzdfY";
            "file" = "mcpitanlib-4.0.1-1.21.6-fabric.jar";
            "hash" = "sha512-fXiZgeodTvCMptyqKL+wqwp6PCTdt+DXEabMWiRTc9wV8xvn0ck7x1TiYhKxyOukSN3siB/+vTmNyks1e+FV0A==";
        };
        _BzdZtxbl = {
            "id" = "BzdZtxbl";
            "file" = "mcpitanlib-4.0.1-1.21.9-neoforge.jar";
            "hash" = "sha512-9I5Cl/jFaXO3lRRCB1W9fEkR9amimnZ135ZpoAFut4dw6t7ajIQrYM/u9uf+NNUC3XmC9ZRfMMUsQuG+cF5YQg==";
        };
        _8f1PGaOp = {
            "id" = "8f1PGaOp";
            "file" = "mcpitanlib-4.0.1-1.21.9-fabric.jar";
            "hash" = "sha512-DBwJxqIPIDshgCgNjV3leKx/UmevNp5eJS795copsiVmAJvBigJmH93tZIsnO3f1HMgaVEW63pieLRzahhA4Hg==";
        };
        _8B1QqweC = {
            "id" = "8B1QqweC";
            "file" = "mcpitanlib-4.0.1-1.21.11-neoforge.jar";
            "hash" = "sha512-tQ6JIrjc4NCDnBS69DZsyQOv58Jm0mDz1Ch5eMBfzX/WO+/mMluNJoOlwX3u97dwPNwBL4kKeQmyEhgIqcHNLA==";
        };
        _3ENM6fZF = {
            "id" = "3ENM6fZF";
            "file" = "mcpitanlib-4.0.1-1.21.11-fabric.jar";
            "hash" = "sha512-AuaBxjRCI+gxCnH/f3HK5ni9TtA2iSswxbkM4dXrcUXsDJFtGOZzvRfW4dpqfrknf85GC/Z+0KIDskrymTLIFg==";
        };
        _krmBrDK7 = {
            "id" = "krmBrDK7";
            "file" = "mcpitanlib-4.0.1-26.1-neoforge.jar";
            "hash" = "sha512-bDr2DA781ccvFGreM+zPuoxw6W8lhIYfiCmCcObGUY+8RJjXJYuJEDwYjxXoaiaLFUC4TmM+eSAiMXsAoEetgA==";
        };
        _imQE1ku1 = {
            "id" = "imQE1ku1";
            "file" = "mcpitanlib-4.0.1-26.1-fabric.jar";
            "hash" = "sha512-r7q9OYZmMem7/EotE2LGvjxRaRDwGZLYEceM3V2yFtlv2wx2EaHeF6CuSQfLDKYJvWgAhp4wN8eQaY8WcdtA7A==";
        };
        _uwfFmFhU = {
            "id" = "uwfFmFhU";
            "file" = "mcpitanlib-4.0.1-26.2-neoforge.jar";
            "hash" = "sha512-DYArgp0i/0MbhzN/Kb6jEIHSibw1SByrsjSL3a0nNxAq5WbLdTTRKweOpYVTLEGO89LcNek7YJB5xYhFBDoGYQ==";
        };
        _dYPwtOSt = {
            "id" = "dYPwtOSt";
            "file" = "mcpitanlib-4.0.1-26.2-fabric.jar";
            "hash" = "sha512-XqfXnkliYFeSaH36CmB0DK2rFZ8VtKHRWOLuiddOFs0hHaM8q+M3ZG9gihh8j0mv873L2tqHDKluj643SCg1FA==";
        };
        _Id7OVrjV = {
            "id" = "Id7OVrjV";
            "file" = "mcpitanlib-4.0.1-fix.1-26.2-neoforge.jar";
            "hash" = "sha512-AgsRsS5rESb1S8Z624jIO0vEUtztr8UKPkZbTiaLUItMG8ih7OiSK0ihUNxuhOkuGKPQDYOehwslNLV6SGD1fQ==";
        };
        _6VfJ0BWj = {
            "id" = "6VfJ0BWj";
            "file" = "mcpitanlib-4.0.1-fix.1-26.1-neoforge.jar";
            "hash" = "sha512-YcnKiv3IRE0mYbbHUHzn7kodwXW5R5tqD3XTxtPc6RHauAN+hrfgjz6IzTeR2Cfs9nhXzLEvMSt2pNYkRDSjug==";
        };
        _dAZK5yp8 = {
            "id" = "dAZK5yp8";
            "file" = "mcpitanlib-4.0.1-fix.1-26.2-fabric.jar";
            "hash" = "sha512-tnuTdSe8EOqdyvXssBhF7m3eZdRwsO/s7kxNJjDM8A5wUqPl86RRtmtCUaigFmHc4+bG5J/0xjrV39+d00S/sQ==";
        };
        _HWM52UfK = {
            "id" = "HWM52UfK";
            "file" = "mcpitanlib-4.0.2-26.2-fabric.jar";
            "hash" = "sha512-vyrUrHcaI9tCUX6cdmMvmP7TtbUYiYdINZLnVikWlHcEbx8i3b+9izmD3kgBHh/EoIZkLGQOrzL1i5SIsiXYqw==";
        };
        _rJO5NPdt = {
            "id" = "rJO5NPdt";
            "file" = "mcpitanlib-4.0.2-26.2-neoforge.jar";
            "hash" = "sha512-63njrh8sSKpc3DuOnIe7QnNJN2QmiHYkeIfUqcT/qJd1EXV3cAnfI1NjYYM9SplevEv7T+6maniQKW3t5XuprQ==";
        };
        _1q1Qcdze = {
            "id" = "1q1Qcdze";
            "file" = "mcpitanlib-4.0.2-26.1-neoforge.jar";
            "hash" = "sha512-m4vK9CSev9sKDXyrAAsyer0FaQiBpsmUBo5UxSQj3Xn5Mj1Fvsmirt9LPlbZADCplCAc5Ns/a/ug5L4TyeZ+Rg==";
        };
        _mulwkn3S = {
            "id" = "mulwkn3S";
            "file" = "mcpitanlib-4.0.2-26.1-fabric.jar";
            "hash" = "sha512-kJuj2x6E+oBrf8wp6zNZpYtWIMODaR/luvPZpEUwIv/MXClMfqWAI1djUPgxvOIZdVHLNxQVZck3Qp10FoN1lQ==";
        };
        _OjgDSxuj = {
            "id" = "OjgDSxuj";
            "file" = "mcpitanlib-4.0.2-1.20.4-fabric.jar";
            "hash" = "sha512-OkFfWkFusre7j1StZRQzhDMnk8U4iA5e8EYgZTuyEfLY/Z9fgpLDEJsqQnnXxUOr5Y8U9reVcGZW7lwbahwPWA==";
        };
        _uiQykX8x = {
            "id" = "uiQykX8x";
            "file" = "mcpitanlib-4.0.2-1.20.4-forge.jar";
            "hash" = "sha512-8WuMoxNt0aa7LneDt2ABDuia5sZpJnkP7dBCGGUOYTpMRv6gvGK2OGPeU1C+SUw2rw1lIB627+C1j11Ev6L05Q==";
        };
        _1ob8zM5r = {
            "id" = "1ob8zM5r";
            "file" = "mcpitanlib-4.0.2-1.20.4-neoforge.jar";
            "hash" = "sha512-L14jiycs/S9cMJWWDspFyBm/BAiTVcUgSvriR5vzPRuKz7mywFm8Z5RtSFRXJXLi3leAEzJ13wTS7+NnoeSh5g==";
        };
        _hR0yXf23 = {
            "id" = "hR0yXf23";
            "file" = "mcpitanlib-4.0.2-1.18.2-forge.jar";
            "hash" = "sha512-VYu5IH1u7o8y7w+Mekso3mlUn5DZsGHZJ0Zoe5jRHOL3uVe+rXq7UG5xewuwbtg0sL0Y6ILZVvoT2T3e/Y/Btw==";
        };
        _iWsJEYPx = {
            "id" = "iWsJEYPx";
            "file" = "mcpitanlib-4.0.2-1.18.2-fabric.jar";
            "hash" = "sha512-dNWDE3Y0qSSdyDcegSJSpKpzJUs5qq/Gye6VMP8w31enN1oCcrLrVoKP4Ze/rBlXn38/acQm/7b07LVHYXRDtg==";
        };
        _mSWuOLiy = {
            "id" = "mSWuOLiy";
            "file" = "mcpitanlib-4.0.2-1.20.1-forge.jar";
            "hash" = "sha512-8fPhVQhCK67EvYcfLWd4z1OOn0IsAeWhx3foF1FTb/BPBZYUNEi89AXZCiKGcYfXhK4R0/l0gI0gd+TYWCKHBg==";
        };
        _h1bvdA5b = {
            "id" = "h1bvdA5b";
            "file" = "mcpitanlib-4.0.2-1.20.1-fabric.jar";
            "hash" = "sha512-/XEdsPuQiPAuUuFd1LLOc0MqElAqTbnDVqBvnzRggOx91Z6btt5WqbPun9nDUfjsH7aN3nKRRNQWYMwXQZD3BQ==";
        };
        _46qAwRZz = {
            "id" = "46qAwRZz";
            "file" = "mcpitanlib-4.0.2-1.16.5-forge.jar";
            "hash" = "sha512-xIQkLGSpleSc3z02aZwDkjxH3y6iozGsUKOGNCN8yPPscxZJU8FOT8gEYjaZAwrF/2wbkrUrHYdFJD2gqYs1xg==";
        };
        _BLKMN6V9 = {
            "id" = "BLKMN6V9";
            "file" = "mcpitanlib-4.0.2-1.16.5-fabric.jar";
            "hash" = "sha512-Y7xqjw+5MgyW2BSliAqSS9kBpZ0ilwOngWmzs7Mn3xwSTm0sD3W6TB89dDYMpXOzJnydj0PtUYIy9B3sPuux8g==";
        };
        _BxfXX2Yk = {
            "id" = "BxfXX2Yk";
            "file" = "mcpitanlib-4.0.2-1.19.2-fabric.jar";
            "hash" = "sha512-v0jOumELoEM3du4TkQbVKLhSa1ifqc0VJXwH77dXCNFow/6v+rUWEIgWK2RxD0c/J4yf5N5Q9/gbDV1OY3djVQ==";
        };
        _1PyLPBVH = {
            "id" = "1PyLPBVH";
            "file" = "mcpitanlib-4.0.2-1.21.1-fabric.jar";
            "hash" = "sha512-pC+k9gsdcZi8kUQ2yRBDMq2Kpe9fWHSRTtiLj+wqVdPxBDhWY9BKuhpV5mZeBYEuMH7KoTCNhC0GwSWpFcaBjA==";
        };
        _Btu4rN0G = {
            "id" = "Btu4rN0G";
            "file" = "mcpitanlib-4.0.3-1.20.4-forge.jar";
            "hash" = "sha512-li9xjFvKEzo3gU2XyTsXuuoaTvLVEmQ6Bvz4jviti2okVMo3YItHON1pgTBFSQBLod7zYSvZySFUrNzgtuEqPA==";
        };
        _oPBgeMrC = {
            "id" = "oPBgeMrC";
            "file" = "mcpitanlib-4.0.3-1.20.4-fabric.jar";
            "hash" = "sha512-gjYkyIoZ7pHkKR2vD6VlneADYu2+dolW6j34E2kTkalAmXUIbr0mYFpWR+nmQnnzGbBOL/0p45jLd9Zt1png+g==";
        };
        _vIv1YRTx = {
            "id" = "vIv1YRTx";
            "file" = "mcpitanlib-4.0.3-1.20.4-neoforge.jar";
            "hash" = "sha512-RyBZ6JpxikCehZ+IfArvSaH09pVEhENLZ1jht9IviSSLnlCjwuvl51RPkkeCrqNPDlpx37iYSaMzYtSThzCK9Q==";
        };
        _tA9n9cDO = {
            "id" = "tA9n9cDO";
            "file" = "mcpitanlib-4.0.3-1.18.2-forge.jar";
            "hash" = "sha512-UxoTsdaiOcQFODoVbTakuXO++gN0FJl3GHyUm0VG0E0+VS5ab/kcUYwnXobVoFtL3gbRFoAjdgUKol2sJxvT2g==";
        };
        _CBlWNHwV = {
            "id" = "CBlWNHwV";
            "file" = "mcpitanlib-4.0.3-1.18.2-fabric.jar";
            "hash" = "sha512-pbb4DtuzhGByrKVZBu4k632Oom/1G/0XtTo5qd61h+Q/SRtVRr0N8Dgpt0kEmMuplHOvg9hMr+wAk3hsQayBQg==";
        };
        _l9oolDsb = {
            "id" = "l9oolDsb";
            "file" = "mcpitanlib-4.0.3-1.20.1-forge.jar";
            "hash" = "sha512-KVaoQvz4lGqxbS85D7bkk6w3txpS5D7nd/Kzya9TeRMYcAqKKpAIp/9LNzGoLHmgYbz/4x7xTl9odWl+yB299Q==";
        };
        _m6SKRhiF = {
            "id" = "m6SKRhiF";
            "file" = "mcpitanlib-4.0.3-1.20.1-fabric.jar";
            "hash" = "sha512-LQCrA1kkWFaikzGIZJvjrYJdLIZRXBMildCHZKISeRKbmehVnWemMClzKGHVdl8EVdTrC2MU00SCshOh0k1rrg==";
        };
        _WHk2PI5t = {
            "id" = "WHk2PI5t";
            "file" = "mcpitanlib-4.0.3-1.16.5-forge.jar";
            "hash" = "sha512-q63hn+PqosX/FByd0LAVgkQBTSQOXAhSdqgGo9BSZmQTLPYaCztL4YA6eeF64+TdjN0+tFPp2RYcV6+L3eA+gA==";
        };
        _TSZkF92V = {
            "id" = "TSZkF92V";
            "file" = "mcpitanlib-4.0.3-1.16.5-fabric.jar";
            "hash" = "sha512-+chLm1TkeP/cqvQAoFB9V3V1OkqV/KL6LFl7mqn9KRkWtpAwyoG5Cy7E6PtbD5pW3Boa00dgls9VxVQqxh+Q7g==";
        };
        _7zmdQb51 = {
            "id" = "7zmdQb51";
            "file" = "mcpitanlib-4.0.3-1.19.2-forge.jar";
            "hash" = "sha512-mtRy8DIkmkKXVKmkkTMb6+cX+nNMwDm1HUae4Hqji7qgENUY2PHLCH5y8rsw1bto1tcZjaq5SWCwy6PBhkQXnQ==";
        };
        _52fg14IC = {
            "id" = "52fg14IC";
            "file" = "mcpitanlib-4.0.3-1.19.2-fabric.jar";
            "hash" = "sha512-eh86gUdl98tmzrFOUbDI5cvCJscKonSeO4G+QlqkKLWdW0Nf/hXANv2ZxKxsqHKSCZUeHSBDyWN/HOFgsFL1YQ==";
        };
        _P44yU9tC = {
            "id" = "P44yU9tC";
            "file" = "mcpitanlib-4.0.3-1.21.1-neoforge.jar";
            "hash" = "sha512-GUfJzZhxPAaTRm59D5vW5Nm60GBtwc77qjNMrzNe31R1CYukMXf2aT5//Nb37402yzy35Pw1b6EagHzHJB8wFg==";
        };
        _pi0mXsb8 = {
            "id" = "pi0mXsb8";
            "file" = "mcpitanlib-4.0.3-1.21.1-fabric.jar";
            "hash" = "sha512-q4bRihJlexfVDopNlpTyTt+J4wVPiRy/0LsssbOCXl+F/7PO0u7Yb6Iq6kTu1jMfMMnSFEGKfLGLuvrlm6Wklg==";
        };
        _8vLCzQRL = {
            "id" = "8vLCzQRL";
            "file" = "mcpitanlib-4.0.3-1.21.3-neoforge.jar";
            "hash" = "sha512-V0pv92o8Uf4U7TDVlAhjZ15uaxvm5Eo6TsWJEtXRKimHJImVLtJ3wEWmere7rLgm/8907JVvezUXTIvG0Ei3rw==";
        };
        _C4fUykdQ = {
            "id" = "C4fUykdQ";
            "file" = "mcpitanlib-4.0.3-1.21.3-fabric.jar";
            "hash" = "sha512-X+h9QkFH2YPNxeo1Nf0IRt0wAjHBXZ7JiH+eXQlXqOZnop+azXcFzRpQmOabr9JrDgYx8a1rEMRp38S8kp9cPA==";
        };
        _7biUXW5L = {
            "id" = "7biUXW5L";
            "file" = "mcpitanlib-4.0.3-1.21.4-fabric.jar";
            "hash" = "sha512-W+ppbRSSj2hgkdmTy6n/Vz68uvAEj49lfOH5HS2vVh5jS+yoKwCIU4n3jLu7FWfmuiAyGvRg/9WcKBkAgzx1Rg==";
        };
        _1uEYlVmk = {
            "id" = "1uEYlVmk";
            "file" = "mcpitanlib-4.0.3-1.21.4-neoforge.jar";
            "hash" = "sha512-qkapA1KTFiywDyYPmbs+pbrekFyY7OUs5LtnDshnw7SD27b0v1VjlYd4hL2lB7HpMHzGAEfbihg0SclUAcJm7A==";
        };
        _ihVtt8kk = {
            "id" = "ihVtt8kk";
            "file" = "mcpitanlib-4.0.3-1.21.5-neoforge.jar";
            "hash" = "sha512-r0Ej+gwzCMyS/MuLUSAfZucAyzQ6M39BUK3ToSGlQ0nTtrp7uJpYT5+q0n91E8IEyeMzP1YNjAJVuhjp0DNRAA==";
        };
        _fxfqe3QB = {
            "id" = "fxfqe3QB";
            "file" = "mcpitanlib-4.0.3-1.21.5-fabric.jar";
            "hash" = "sha512-U5unAjLCs6jG+F3TCAIowoTPAHLEqQZOzn2K7VA9yTvC9fLKMui7y68qMVrBr50AIKN02ovPfQATAZotfFwm9g==";
        };
        _CP3cw1o6 = {
            "id" = "CP3cw1o6";
            "file" = "mcpitanlib-4.0.3-1.21.6-neoforge.jar";
            "hash" = "sha512-QgFSQ1jJxq7BjnmkFzJbrmL1v6gT5WkLDlx54zbTPdbMSG4rqAN9sFpOlpO9d/cOz8wNhi46Xru+mDm8Chb8XA==";
        };
        _ByD6bhxn = {
            "id" = "ByD6bhxn";
            "file" = "mcpitanlib-4.0.3-1.21.6-fabric.jar";
            "hash" = "sha512-2Up5v3300isGlbxbNLUsM286GvgjhgexhBvxOiDoCw37p4ADJo9J+hrmMfwqUVOJs+JWFkU+2wEHybbEl72DGw==";
        };
        _gVebJ5H7 = {
            "id" = "gVebJ5H7";
            "file" = "mcpitanlib-4.0.3-1.21.9-neoforge.jar";
            "hash" = "sha512-l+bEiwj4EuVk6dMMNJUItDZ/mP7/AjUhwLrE9kZXDoIkDOv7tO4qGev9MjxX40u9vjRhuq+FStyEVxtK1MUE+w==";
        };
        _Hp5MQUWj = {
            "id" = "Hp5MQUWj";
            "file" = "mcpitanlib-4.0.3-1.21.9-fabric.jar";
            "hash" = "sha512-B1cEAuFWpr1qnQMymZUCfWqXpKF69Hci4jX1bOj6KflWt1zSwcGuwOKIZAmqcSz+z7u3JSdHlWCJZ1fGJX5Dtg==";
        };
        _fxPew9Jo = {
            "id" = "fxPew9Jo";
            "file" = "mcpitanlib-4.0.3-1.21.11-fabric.jar";
            "hash" = "sha512-tgqC9KWdlQNqp6zQQLOezldx/9TlahpGEFB11ZOUGgeE0FadcyS2wVeT68xUi5GhguSybkqis6ZLUKele0+VNQ==";
        };
        _4k8hKQUO = {
            "id" = "4k8hKQUO";
            "file" = "mcpitanlib-4.0.3-1.21.11-neoforge.jar";
            "hash" = "sha512-foh2E4ldC/ZwlXvdf1J+dxeouUMchAoxrY0bot20uFGQGavRDk469orGlp1aW11EpDx4BJAAQWp6yfwEjBju1g==";
        };
        _ZfCTTBzS = {
            "id" = "ZfCTTBzS";
            "file" = "mcpitanlib-4.0.3-26.1-fabric.jar";
            "hash" = "sha512-JNPL1crTKg+Y/R/hGQUiCyeezEpr6R0EIbiPoj1MoLzpXp/lGJBpsK1sBdyTSEZrZOkEkwTNGuBac9tiBXhSgQ==";
        };
        _7iRjBlcU = {
            "id" = "7iRjBlcU";
            "file" = "mcpitanlib-4.0.3-26.1-neoforge.jar";
            "hash" = "sha512-GhqaTzkFxhj7YIGqO0U2r1N1360i3mDzMYHEB6LAAxp1y55S1gqZxTQqQWv1WtRUMJN0nJ1r2cKPAzwp4OCy3g==";
        };
        _WoynAMxe = {
            "id" = "WoynAMxe";
            "file" = "mcpitanlib-4.0.3-26.2-fabric.jar";
            "hash" = "sha512-xn8OEdBRubLC8Yed3m/mszZX/vo+5b5bIv3VzvvpXam/LWNgV4Vgx2x+4N5ogqyDZl9F/36ptkgmiitIp9HRFg==";
        };
        _AjYDNc2q = {
            "id" = "AjYDNc2q";
            "file" = "mcpitanlib-4.0.3-26.2-neoforge.jar";
            "hash" = "sha512-xZ8KCboest4fjxK15JdOsnIFHtJpFrpq3/ZPGc47VGmmRWmh6AuZ09hCTTU55/WFtXJREL2JWFoamrMdAvEY1w==";
        };
        _v2SWxVKb = {
            "id" = "v2SWxVKb";
            "file" = "mcpitanlib-4.0.3-fix.1-26.2-neoforge.jar";
            "hash" = "sha512-OdEJZ2snmn34ybusXVuCE8uLHW0XW+UoArQJ0viGZB6/cUctOnax3bKy35GE5C/D4y278DXM6PtSqGQoSggOnA==";
        };
        _MEWwTlcJ = {
            "id" = "MEWwTlcJ";
            "file" = "mcpitanlib-4.0.3-fix.1-26.1-neoforge.jar";
            "hash" = "sha512-N7FiSFoZR6MtGjiC6JXFoPwycDnimUF3dc3D+SI6Xi0DYleM1urBo+YuTCSg93Da9/SkW6JE44Ld8Y6VCVjGyQ==";
        };
        _Sgeb5NHo = {
            "id" = "Sgeb5NHo";
            "file" = "mcpitanlib-4.0.4-1.20.4-forge.jar";
            "hash" = "sha512-IT8G2rKPoRhIHlY4qOrBtgNV3TypsWqXOuw28vT7ROfOumSi55eBXXwdR1mNLO/FbayZU7M6CyH/YO2NeU1u5w==";
        };
        _I5U1KlOu = {
            "id" = "I5U1KlOu";
            "file" = "mcpitanlib-4.0.4-1.20.4-fabric.jar";
            "hash" = "sha512-5aAeNlVxECwQv7NsbuQKGmEq2DugxZAnLh8WyCMeQIFfXS5aOa2sfeH2zeZTJ6WKR4IYnj+qzkfM4oMEPmpVfg==";
        };
        _S3kHvv3t = {
            "id" = "S3kHvv3t";
            "file" = "mcpitanlib-4.0.4-1.20.4-neoforge.jar";
            "hash" = "sha512-UVeimUI9c7MvEgbsnbIJqkIwCFkK7DtQkCaPlLnsHAJBnlNYk8Pnot9uKlmc1tVL1mh7yoWml56cRKPKuhXsUw==";
        };
        _UPsOhn5z = {
            "id" = "UPsOhn5z";
            "file" = "mcpitanlib-4.0.4-1.18.2-forge.jar";
            "hash" = "sha512-Q6AJVLae47YS2Zs0/bVanzqb4ZOWpSh+K/vQtxzP7G92tTfWcOB+h+Lb531ti7vweM2+Z/FZG1Vp4oDqZUROyQ==";
        };
        _Bht2p2Hw = {
            "id" = "Bht2p2Hw";
            "file" = "mcpitanlib-4.0.4-1.18.2-fabric.jar";
            "hash" = "sha512-OMLX8LVCRnuXJyJh5J7kMuEM1ffR8MRTK8G335J019pwFn/yPT1x+Pbny29EHSWx+sr6entS7NjtTiWdEJBgZw==";
        };
        _2GDdABST = {
            "id" = "2GDdABST";
            "file" = "mcpitanlib-4.0.4-1.20.1-forge.jar";
            "hash" = "sha512-552R44T20mKgojh0/5NVZ0osNSs3rSYXKl7qlCokl2MISPwFYxS+IdBgzRmj8l+8HIthjAR5NpAw6ISjr+biVQ==";
        };
        _WztC76VR = {
            "id" = "WztC76VR";
            "file" = "mcpitanlib-4.0.4-1.20.1-fabric.jar";
            "hash" = "sha512-jROLUNj1T2ql6A0dopYy6DheTNq+YmGANwNvEE7YrbsFmLrAH8OLDLAYX+ITcMZ6J/Ns6TPh+gP4mcHvcLgT3A==";
        };
        _Dt3QaRPy = {
            "id" = "Dt3QaRPy";
            "file" = "mcpitanlib-4.0.4-1.16.5-forge.jar";
            "hash" = "sha512-zYBxXjkHIwKZ4A2AdPUtyhRwMF60Ifpc8mPe3YzFlN28Iut5zSwwQ/7xj2xkhKyp6QWGsx9DspKqqbEBiZ1vJw==";
        };
        _QwjiFwIx = {
            "id" = "QwjiFwIx";
            "file" = "mcpitanlib-4.0.4-1.16.5-fabric.jar";
            "hash" = "sha512-By8kI/7au8is+GRCVrO+uOJJE8TiUHQHw56wmbZntIOFH9+U+23dd8nF2ce8vPRiZOxb5HWrA2mClVSzhqTGIg==";
        };
        _yKq7ZISc = {
            "id" = "yKq7ZISc";
            "file" = "mcpitanlib-4.0.4-1.19.2-forge.jar";
            "hash" = "sha512-UFNqyWQ/xVxUZV8XwZw5WAoNJ6a9MpSC16GOhtw33Rtq9Al3BVU5PfFe+Z+GfNdToLWYRFQfGZvRrKHCyF0Gmg==";
        };
        _REJhIatw = {
            "id" = "REJhIatw";
            "file" = "mcpitanlib-4.0.4-1.19.2-fabric.jar";
            "hash" = "sha512-VV1tO7xH3hpW3HQSIE+tDvMDn0uCJ95/cgBwGUloek4OJ8D30bvc7VXbKtEr0AF8429WaNww4oBuy9IpalTLvw==";
        };
        _wDXxoP2J = {
            "id" = "wDXxoP2J";
            "file" = "mcpitanlib-4.0.4-1.21.1-neoforge.jar";
            "hash" = "sha512-+VZefpD7iDZ/txXwwHOVQj4OzIsdaTkjukmRr3k9k2Y2Mtit6SYYdhKc/P6+cRDyUjelt6IkSqJmz9Ym6FjgeA==";
        };
        _gy90UvhI = {
            "id" = "gy90UvhI";
            "file" = "mcpitanlib-4.0.4-1.21.1-fabric.jar";
            "hash" = "sha512-pMTvNpY9hXciY1eczHHmmU4qow8/7QQK9aueL41dvb72YwGX3cuktlMBOWk7t0h64zPI9SrxIMfQlO9Vn72kZQ==";
        };
        _Y3Cn3hA6 = {
            "id" = "Y3Cn3hA6";
            "file" = "mcpitanlib-4.0.4-1.21.1-neoforge.jar";
        ...
        _zanG7AsZ = {
            "id" = "zanG7AsZ";
            "file" = "mcpitanlib-4.0.4-1.21.4-neoforge.jar";
            "hash" = "sha512-K5F6+ksH7x3T0hpwMnrYV7soW7LPxFU9P7PS6k+PcXBn5Rgt1f6aGADuFgUVl+9qILlERYb/bFxnetTCP8b7ZQ==";
        };
        _4wlhtcWw = {
            "id" = "4wlhtcWw";
            "file" = "mcpitanlib-4.0.4-1.21.4-fabric.jar";
            "hash" = "sha512-ob13XZTvxJf5iI43J5SDLGtJEq0aPRKYgYRMNQbBWDKRdw+1YzxFZtKQPmZ9qc6RAK9bz3YvhjR1vOCaAFFsYg==";
        };
        _c7EVACC4 = {
            "id" = "c7EVACC4";
            "file" = "mcpitanlib-4.0.4-1.21.4-fabric.jar";
        ...
        _FLk6AVut = {
            "id" = "FLk6AVut";
            "file" = "mcpitanlib-4.0.4-1.21.9-neoforge.jar";
            "hash" = "sha512-soVGAgRALz1I9QBy3AhnZA0WJDJtDbWKSEz3AFyp8jjcKqpfVtL5FWL021IxkL+sdKdpAJH6uGIg+9euP4rnMQ==";
        };
        _r6fN3Xjk = {
            "id" = "r6fN3Xjk";
            "file" = "mcpitanlib-4.0.4-1.21.9-fabric.jar";
            "hash" = "sha512-yS/WPsBUQbwBW1mzqCfZrfG2ien8yjJdK/gt1T3QdcKtSJ5lq8Cc2ApPd2bkbFzit14vUPQAR+NUevrkJYNXbg==";
        };
        _y7uQF09s = {
            "id" = "y7uQF09s";
            "file" = "mcpitanlib-4.0.4-1.21.11-neoforge.jar";
            "hash" = "sha512-hzaxhWCrVLP4ImSyi3nDJc/Ei4PlXWkAwYhLScDO32IVbDSsc9FRu9tSF9p+bmAUTamWoOXBtvF0ry7MSp8gyA==";
        };
        _NRWnGbPh = {
            "id" = "NRWnGbPh";
            "file" = "mcpitanlib-4.0.4-1.21.11-fabric.jar";
            "hash" = "sha512-lwax87qvLNt12d0oTvjoc76hYk/xPOUEc7Xa9DwAxr1obPOtw9n1MpQXaOZyCfA7kpbEBDkotobyEW1RHjD5Xw==";
        };
        _Zo2LJFvG = {
            "id" = "Zo2LJFvG";
            "file" = "mcpitanlib-4.0.4-26.1-fabric.jar";
            "hash" = "sha512-7sZCocvM7Nhw9v4fSgL8BXD1EPQi3k8Wd7xEHG0xf5z4S5rNMvCTAJnoD1J4b5QsPBYarklWInAodVhvFnjLAQ==";
        };
        _nqTpcfhP = {
            "id" = "nqTpcfhP";
            "file" = "mcpitanlib-4.0.4-26.1-neoforge.jar";
            "hash" = "sha512-hHbpSotHrInwb9khy6dJdekUTxMzozX+C/05tenTQPrGloGJ63yxK7ytF2sXxYNWkNgqOCOPDrigvhVS/ia8Rg==";
        };
        _mord2MSC = {
            "id" = "mord2MSC";
            "file" = "mcpitanlib-4.0.4-26.2-fabric.jar";
            "hash" = "sha512-xIS8D/Sl0xD+ZeCM1oMwljxrxJbgRna3SP5oj3x/AfuWGikUkmAUahBOjq2qkavcvqykrQiwueTi0g1+V0OyIA==";
        };
        _9F317sMK = {
            "id" = "9F317sMK";
            "file" = "mcpitanlib-4.0.4-26.2-neoforge.jar";
            "hash" = "sha512-8WbrugxYDQXbop/grNyUgaioYcY8SU4/f9Oj3PdTYCsC4Cmfmke71VkxC+cu8/P7CS1jfeFMGXriJ/BeOnqMsQ==";
        };
        _ghUFgBsv = {
            "id" = "ghUFgBsv";
            "file" = "mcpitanlib-4.0.4-fix.1-26.2-fabric.jar";
            "hash" = "sha512-LRnRsT/DIL+hbzu4CrwaYqAWhp26I0/ZfBQZtdLPrG81p2U7v12HSG4WX6tJjli1cSEDwZ0/RpVuUdQyK2KOBA==";
        };
        _QpR1HDzQ = {
            "id" = "QpR1HDzQ";
            "file" = "mcpitanlib-4.0.4-fix.1-26.2-neoforge.jar";
            "hash" = "sha512-eH+uHOcSbcwp9tTwSuqcBzRxeq0vddQpr0e2RSBb/Msc2Mb71PAzH/sbI+q13KJFxMuVqLa1i0jDgV71y0UmSw==";
        };
        _DR5ebrPR = {
            "id" = "DR5ebrPR";
            "file" = "mcpitanlib-4.0.4-fix.1-26.1-neoforge.jar";
            "hash" = "sha512-DueBCmNPtc43TXyVmOw8wNbkGb/o4LaYL6HLJRW2CKkFL5kWkEEPxXu42rxJlWyTBaUuJEyzJoMD8Dm0KOYy7g==";
        };
        _il6rr11l = {
            "id" = "il6rr11l";
            "file" = "mcpitanlib-4.0.4-fix.1-26.1-fabric.jar";
            "hash" = "sha512-qHCh363JY7OuBn3ogjeEE/frdFZE9bpPsGTMMt4hWWc82o3/tdFwn2uJzY702jDdmtKEc7jpgNKw714RdyfX+g==";
        };
        _G6FftWwY = {
            "id" = "G6FftWwY";
            "file" = "mcpitanlib-4.0.5-26.1-neoforge.jar";
            "hash" = "sha512-Z+n8AVkFYqJA9WgXkLECfAOh6clZFZENPxTxt0IezbMnfHJELnnownu/0golT6rqX8IV2xeLCpSmh48K+dMDUQ==";
        };
        _pPpU7u7F = {
            "id" = "pPpU7u7F";
            "file" = "mcpitanlib-4.0.5-26.1-fabric.jar";
            "hash" = "sha512-d3ab0H5tNhlxIEra4/BO1m7DOdpbql2f4GXcqy/YIAM2e3fH1Cj3iaH5F/U8Vbj9ivjAZ4kngAyZ/Bzvu7hwdg==";
        };
        _Yjxw4yYe = {
            "id" = "Yjxw4yYe";
            "file" = "mcpitanlib-4.0.5-26.2-fabric.jar";
            "hash" = "sha512-Or6c5HXC1Sp0766khwaZbA8hJrJtXiOKdhfkABxS80v7BiCGNJj6orpe7UPWT51JwxJnWZ/xVvv5kv4Ef8CgIw==";
        };
        _BA0PULge = {
            "id" = "BA0PULge";
            "file" = "mcpitanlib-4.0.5-26.2-neoforge.jar";
            "hash" = "sha512-bH0VErwhSBYBEYsfnhTnhrzheeiL6MvQIZ3BhgIESim80l6LUAnV+prNjs7zE2IW7WXph1C/XGPb7itYB3vlag==";
        };
        _w0zo9TzD = {
            "id" = "w0zo9TzD";
            "file" = "mcpitanlib-4.0.5-1.21.11-neoforge.jar";
            "hash" = "sha512-Tpa4pDmNfcsxcS9f4c/I51bn5lxVFk2gUFmsXBnoE85j9Rtmg+HORzSTx/nY4AgMU8U9plJYpAQFCsyp2QjQmQ==";
        };
        _gATgqiR5 = {
            "id" = "gATgqiR5";
            "file" = "mcpitanlib-4.0.5-1.21.11-fabric.jar";
            "hash" = "sha512-UQYBc0KpCLwyHCm9d7JBzTtgz52FmA+nME1qJ8pFHqHKcLVHCdMbqhmCZ2Mtx3/L8l5ZqExWSus94S6rKEVXkw==";
        };
        _LsR32bhT = {
            "id" = "LsR32bhT";
            "file" = "mcpitanlib-4.0.5-1.21.9-fabric.jar";
            "hash" = "sha512-Tl1x3QedS5mILhhTX/vYFd3ylShaTaD5RKyxvJi1FNNvq/7E1pK4Cb3j2lGt6QBUDBw/FNXFLSioaHTzFw2eUQ==";
        };
        _dVBT1B4s = {
            "id" = "dVBT1B4s";
            "file" = "mcpitanlib-4.0.5-1.21.9-neoforge.jar";
            "hash" = "sha512-NwqGdGY4JFgFa40npOXnLPT37beO0+onfJrsFVshxZY/4wZsK0l9Gu+fmdIZqcgYwcTVa9OMZnD8VCKo19v9wg==";
        };
        _cfAl4zHX = {
            "id" = "cfAl4zHX";
            "file" = "mcpitanlib-4.0.5-1.21.1-fabric.jar";
            "hash" = "sha512-fhGVGVlzc2DNF/VQqhCPqz9/h8estL2ObGeEkUHd0v7XlAD0dH7fd4ILOeWqt1kNo+TaLCTyqKJF3CPry9LK2A==";
        };
        _JYwTNbi2 = {
            "id" = "JYwTNbi2";
            "file" = "mcpitanlib-4.0.5-1.21.1-neoforge.jar";
            "hash" = "sha512-1cyxKcYGumyjuAUAordjfJbCcqcSpjkMSGhn2K3eSpUB4AeaYIozJkwVfwizcxHdDNFpeyuieqGDFuAPSz8Rkg==";
        };
        _sRTgiRSK = {
            "id" = "sRTgiRSK";
            "file" = "mcpitanlib-4.0.5-1.20.1-forge.jar";
            "hash" = "sha512-wyJgwyLbQu0l5seXKFVNHPaDaPOOOBlh9hHZiLqOETIb6aArNX+CrjbEJ9BhNI9NljSSgbf0XQnmSaz+KXBr7Q==";
        };
        _apZDfruB = {
            "id" = "apZDfruB";
            "file" = "mcpitanlib-4.0.5-1.20.1-fabric.jar";
            "hash" = "sha512-9JYYlzdxgOoMzWFhPOOtHRko1nynDtH8ZU9PNx5jLROzYqhoITbm9MZU7chsyjN7GqYuaMzUUUVJUs/YkRt70Q==";
        };
        _TgwqOerh = {
            "id" = "TgwqOerh";
            "file" = "mcpitanlib-4.0.5-1.21.4-neoforge.jar";
            "hash" = "sha512-X8XJfxmyu9qdupsfRQ69fTWmklAoXw4hxwBLbWeE5r/T0QaswpEnsPbg5bT6dvesSfAjlQGxKanV859qU9ZOuQ==";
        };
        _fAd4XN1v = {
            "id" = "fAd4XN1v";
            "file" = "mcpitanlib-4.0.5-1.21.4-fabric.jar";
            "hash" = "sha512-aIJp4WFDsX1J3caYsANO1R9eFpSAq+PzoMSiQ0Yava6Vmwfd+Ly8uXFnQRHf9i2WWnWP29GWLFhTAVlleP7qcQ==";
        };
        _92hFycqb = {
            "id" = "92hFycqb";
            "file" = "mcpitanlib-4.0.5-1.20.4-forge.jar";
            "hash" = "sha512-+AoG4wf/H0rx+zoJbEWEm1qctgqMeGFTkYMiOPsNP0mPZBLuE1S80wOwfpLjAIxQltvG3KcT3Jmu6yHAketlvA==";
        };
        _JsZdQS2J = {
            "id" = "JsZdQS2J";
            "file" = "mcpitanlib-4.0.5-1.20.4-fabric.jar";
            "hash" = "sha512-hGfyJDQKDxkYLCjGQcKEXa8uzkUdYbGH4A+pYXcbaI6snrXYuQ5Ci+N0tkxiTD/KvtfTiQdSUIXHDwFfJpOgeg==";
        };
        _gWihFGcj = {
            "id" = "gWihFGcj";
            "file" = "mcpitanlib-4.0.5-1.20.4-neoforge.jar";
            "hash" = "sha512-67fKnVEsITzQS1bGL1jsTCKdZpphBxWfUd9cbru9vEaM5yHA3L09519SKIXggVviB53rpbpsPOCsrEMwBLk5tA==";
        };
        _wCFF23Wu = {
            "id" = "wCFF23Wu";
            "file" = "mcpitanlib-4.0.5-1.16.5-forge.jar";
            "hash" = "sha512-VUeg2xi0injRUeSdJX5AJkcN72Sz59Eq2D/cfkzCkOSCKG5nb1XHTZ6DPDOFp+GZpaSqDxTw1W48NThvthoN6A==";
        };
        _B8WYiLVZ = {
            "id" = "B8WYiLVZ";
            "file" = "mcpitanlib-4.0.5-1.16.5-fabric.jar";
            "hash" = "sha512-pwWUm01UQHKmWt2WxmgMYfudE4ialobzsSQCxLLYPjf4CdjX1Zo/LShWRTroXAoBUIgvrRzfxOMxuXzFWtIzIQ==";
        };
        _y7NKOa1F = {
            "id" = "y7NKOa1F";
            "file" = "mcpitanlib-4.0.5-1.18.2-forge.jar";
            "hash" = "sha512-lC9hdoGmqbt0oEZmB2+0dEJeaQB88+MEhoTmZCDn3UKqio88BQKcO6fUjrZrqHmh7o0/JmG46za6nwzmcQqLBQ==";
        };
        _VqhB9t1K = {
            "id" = "VqhB9t1K";
            "file" = "mcpitanlib-4.0.5-1.18.2-fabric.jar";
            "hash" = "sha512-15e5vzd+ingCpW8pHcZOJEu4mWcL7S1zdRk5wvjxtjAJTIE1e24R7QHLxqSiHjG0RRpcnRWebq8T197pGE2MQA==";
        };
        _xxQNmjwB = {
            "id" = "xxQNmjwB";
            "file" = "mcpitanlib-4.0.5-1.19.2-fabric.jar";
            "hash" = "sha512-rCzQpDsp4eTUUyzd1ngw9dai13bHoQe6RhMGT9LayN8Q5lOSuHHOCK/S3INkLBSW/3sx0CNVwNd8W2uJHwyfqw==";
        };
        _oaC1tHXi = {
            "id" = "oaC1tHXi";
            "file" = "mcpitanlib-4.0.5-1.19.2-forge.jar";
            "hash" = "sha512-2s5jlNuqyFn2ROLJVD84/ZoNKC7KaeWU+AymOiVJHhPbnZbHKYM1YUOJuAUGI1KMrg6jNesbhH8b5E/LOyevzw==";
        };
        _kTcx7cHx = {
            "id" = "kTcx7cHx";
            "file" = "mcpitanlib-4.0.6-26.1-neoforge.jar";
            "hash" = "sha512-5lXX5lBPJl+tpq03eV/bf1bVJNrG0gD/Vf3vuauaMh7UN4rVYMWYbhLZU7uj6/9+tZFl9pauZlmufT6OsE1zMA==";
        };
        _vqddtDxJ = {
            "id" = "vqddtDxJ";
            "file" = "mcpitanlib-4.0.6-26.1-fabric.jar";
            "hash" = "sha512-4RvhRrUXPFbGk/hht88nzhR63plW5Bx+RYXVlCt3e8gi9q1r1QBIw9M8VNpf264Jgk+Xi7nTHaTfY0mjhDr24g==";
        };
        _2X9Fo5yI = {
            "id" = "2X9Fo5yI";
            "file" = "mcpitanlib-4.0.6-26.2-neoforge.jar";
            "hash" = "sha512-GtVHNHQLHSzo77MiYQaPLJwfMc6BeTLBoWttyQnm1VdtFeO/NVjeKqHNlHI+OrLt/VcaQNYsUlqTxsF3DsJ6pQ==";
        };
        _jLs2Q2oM = {
            "id" = "jLs2Q2oM";
            "file" = "mcpitanlib-4.0.6-26.2-fabric.jar";
            "hash" = "sha512-GdOspHx+LBcSOxScpISXqDd8ciLzcGWSlSWUAX6G9GZDI/6IBL3q55IavNjiMje538XPGOSEzkegl5/slv5iLQ==";
        };
        _e1h9JKlq = {
            "id" = "e1h9JKlq";
            "file" = "mcpitanlib-4.0.6-1.21.11-fabric.jar";
            "hash" = "sha512-X7Uubkc0l3Chu/Zn2RlKcGX8AEl5MNH5TsDN69sh23wKro3lrwQlVXljoG+bXGStnZnWzrTS7lnp/s7otwbhkQ==";
        };
        _6s4KnGUR = {
            "id" = "6s4KnGUR";
            "file" = "mcpitanlib-4.0.6-1.21.11-neoforge.jar";
            "hash" = "sha512-UMu9+6X+C7mzU/Cpq+YnD+2Nrka36fSYUJ9/nSMLBxz0H0eo4+2pkRa+tRziv795iOxStUZJekm4wT11hlYtcA==";
        };
        _VnBhZtKZ = {
            "id" = "VnBhZtKZ";
            "file" = "mcpitanlib-4.0.6-1.21.9-neoforge.jar";
            "hash" = "sha512-wRBRGXOitIKEqEAD6yXy+6lzZ2ZHc8X0H5lSBWBMN2WFttDduh5RK4LI649TDpjElaS+sMkZ3Lm+Y06RKir0wg==";
        };
        _wcukWVR2 = {
            "id" = "wcukWVR2";
            "file" = "mcpitanlib-4.0.6-1.21.9-fabric.jar";
            "hash" = "sha512-lK1sOlUqVsZBbGSv3yecUtB3FTWOl8RnFTZziQdDYQ1EZVNuiFGc0/nA1TJZcUYZUv3iFqu6FYzqy8Xs+hEYLQ==";
        };
        _Y74LCHuK = {
            "id" = "Y74LCHuK";
            "file" = "mcpitanlib-4.0.6-1.21.4-fabric.jar";
            "hash" = "sha512-1evpx83FBbVxI567sV6ZVzFIUnaqXaDHOODxIMRb4+wrs0b3ZsYAXOZD435P1dCbBNt/ihxnN0MoGM9H7/9wSw==";
        };
        _cvbxd9O3 = {
            "id" = "cvbxd9O3";
            "file" = "mcpitanlib-4.0.6-1.21.4-neoforge.jar";
            "hash" = "sha512-xXOXBeIfaO93BDL3Jk6Y979D74VSdT7DEmkUcjK1KkbtGArP4lvbr+MHDkV0wPw+dVpGGPmhQ3lUz4ynqFd20A==";
        };
        _2qubY15B = {
            "id" = "2qubY15B";
            "file" = "mcpitanlib-4.0.6-1.21.1-neoforge.jar";
            "hash" = "sha512-A1Gdwi8vbd6hs6JZpKrgJla9IszinSDDnEIQt/7hRi0tkdyy3ek7AIc8/+gSmj8XAaTwJHv8PXL6j7477/IJuw==";
        };
        _kyjBRJO9 = {
            "id" = "kyjBRJO9";
            "file" = "mcpitanlib-4.0.6-1.21.1-fabric.jar";
            "hash" = "sha512-1Sdd6AdapvZVJSpZVwVdv4yc/MMj+PCgwFgLlGLSRFpc22XqNc2TTimsNGUTxg3kw8Hbj1+vR+lPUZz/7RO2sQ==";
        };
        _FD3Qxmyj = {
            "id" = "FD3Qxmyj";
            "file" = "mcpitanlib-4.0.6-1.20.1-fabric.jar";
            "hash" = "sha512-ustl64EdbD2BoyeI9CgERAmbvfVKUJcaA7puPX7hrUcZQ3QuvDlNzNKIxEf6Ej7jynTj1iY7EHFGzsQSFNCBBA==";
        };
        _gfZVmTNo = {
            "id" = "gfZVmTNo";
            "file" = "mcpitanlib-4.0.6-1.20.1-forge.jar";
            "hash" = "sha512-tOkNmayDizSp8NHEQZpzCsYHK19pUNesO/Hrz1g1tZiFgcJJ6Y3pzolO/H6Y/X6vA5tQmBl4t0QqprmuWDkeTw==";
        };
        _ZYiKqeGj = {
            "id" = "ZYiKqeGj";
            "file" = "mcpitanlib-4.0.6-1.20.4-forge.jar";
            "hash" = "sha512-mJx8rvuPchEmNrGgdIsCc2sAMkMkeNnwKN0zTwrA5eslEHxRZFKyoZIQg9nAFIvT5mTWeyPfFmdhnHnIT8c7jA==";
        };
        _aGdXSw50 = {
            "id" = "aGdXSw50";
            "file" = "mcpitanlib-4.0.6-1.20.4-fabric.jar";
            "hash" = "sha512-Ne+Rwr2pXt7UgOwZ2VoUvTZX/+R8Hu4Fz/mzqCAxY14LfA7y/I3xpJC47/uod/rn4GnqKSyVCEaJuqwwehYS6g==";
        };
        _cZNSwOEI = {
            "id" = "cZNSwOEI";
            "file" = "mcpitanlib-4.0.6-1.20.4-neoforge.jar";
            "hash" = "sha512-k6SuKpFD+pjxDqDUem2RWMHAQ7n39S3YaTL7Qz6ihbopUpX9gxQYgIzQf9+R7R8eGeamuqwrKxjizbZaHodPdA==";
        };
        _lbWvgP8g = {
            "id" = "lbWvgP8g";
            "file" = "mcpitanlib-4.0.6-1.19.2-fabric.jar";
            "hash" = "sha512-X/Ha4XU97fcZI230Q1e2nopDWeUsfUocR3czCMYAjy0LSIcE0x+OZ5uid0Y9YKeqwsQeiyYS/+gbOUjMJaDdjg==";
        };
        _efaZLjq9 = {
            "id" = "efaZLjq9";
            "file" = "mcpitanlib-4.0.6-1.19.2-forge.jar";
            "hash" = "sha512-Zuxkz2jNdi6pv5R8lBdFU0J4smZ9heB7H44S7xYHae3PQfrqXN2/58rz1/dqGX3BhSQ7/38kdJkprRaQ0aIVXg==";
        };
        _4y7T7NUY = {
            "id" = "4y7T7NUY";
            "file" = "mcpitanlib-4.0.6-1.16.5-forge.jar";
            "hash" = "sha512-TiGdXk1oGe4lz+DBiRX6GZii8gPjtAqXG7JnA36xe3FY4FToqpYUuh8yMEK5wggyfMGssEvXC6twyMiTUfhIkQ==";
        };
        _7Q4nyDZH = {
            "id" = "7Q4nyDZH";
            "file" = "mcpitanlib-4.0.6-1.16.5-fabric.jar";
            "hash" = "sha512-CZ7xeiL3wzOdHsULEgQfWdfva/3ZnC44fPUJDlMunWtlmR/FROjrjx/pPdlbq6VitrCacLDDnCqjIm2n1UDgvg==";
        };
        _rgG2lLWU = {
            "id" = "rgG2lLWU";
            "file" = "mcpitanlib-4.0.6-1.18.2-fabric.jar";
            "hash" = "sha512-KdhDthGjuFrOTiPpMtF7LEsnVdS/lSlZpNgxLGoQFZMeIzTrsgmHxsBmRIGjcJXxXsHm++C1Y/CcBF2v8HY3bQ==";
        };
        _aJCuYQrL = {
            "id" = "aJCuYQrL";
            "file" = "mcpitanlib-4.0.6-1.18.2-forge.jar";
            "hash" = "sha512-KT18T85Z5aA9MQYLV5M0bqIT1Tl4ALTo1kkZZLIgt/cc9cz208CdeQPVrbsbouKZUXdJ+0epalf9PaU+q/chGQ==";
        };
        _5pGalUQP = {
            "id" = "5pGalUQP";
            "file" = "mcpitanlib-4.0.7-26.2-fabric.jar";
            "hash" = "sha512-qOS/f5C3SNZHMa0Jo3OAVzK5/us6X3zyM2t0JzDMT8yDyM5mt7av2PlCrJpgMs1IopY4uJXDG7y9e1WBary+vQ==";
        };
        _TcXINHwW = {
            "id" = "TcXINHwW";
            "file" = "mcpitanlib-4.0.7-26.2-neoforge.jar";
            "hash" = "sha512-USdLeRQYZnDYQ4YKsMB3eF4764Qnf9ABkZXtghqc2Y495fkKoviyttZkWGAAU5a2grG2CAcScgu7u/qJRf1ELw==";
        };
        _cYHGC5or = {
            "id" = "cYHGC5or";
            "file" = "mcpitanlib-4.0.7-26.1-fabric.jar";
            "hash" = "sha512-P5jCdp6sAtpDWPE5g7Us1va5KZvBzBA0MAsuUbF03YKngGesm+02+2egVkzhzuDKJsflHmUIWM8ZyWFdHuLKug==";
        };
        _vEABPabG = {
            "id" = "vEABPabG";
            "file" = "mcpitanlib-4.0.7-26.1-neoforge.jar";
            "hash" = "sha512-pxeGzxbx6bxl/oXa1qB6HJy3bePk5/xdCm+O/nRhV+O74VY71Qq/LOP4aZurPRXa+dXBocNAKp9NsLZO39LEcQ==";
        };
        _YWCgMMdU = {
            "id" = "YWCgMMdU";
            "file" = "mcpitanlib-4.0.7-1.21.9-fabric.jar";
            "hash" = "sha512-CANjBhMZxhKNBZRiqjizmGPhSpaWRQK+HyX1CjZjmC1hO8LSm5Xk7BhK8VictjJFKJM0zyBVVhIBfCbH7a04ow==";
        };
        _wVXci5FF = {
            "id" = "wVXci5FF";
            "file" = "mcpitanlib-4.0.7-1.21.9-neoforge.jar";
            "hash" = "sha512-MGRG7G69zHfd0QowXzuGFqstYfNN1cr9V3LoG/DVz8iNjuz3AuwgjDKmGTkmrZ8ipsJLwOg/EG4faaB41SXzTw==";
        };
        _EBwV0nvc = {
            "id" = "EBwV0nvc";
            "file" = "mcpitanlib-4.0.7-1.21.11-fabric.jar";
            "hash" = "sha512-y/u0tbRvB5qMlLPQ7cDWO/yHTY9kDHAW7wXC42X5QNQpeAJn0XDZUeUsiBlD57SZr1wGeyO+t9Ip3o0rtWmaWQ==";
        };
        _kwjWsjcV = {
            "id" = "kwjWsjcV";
            "file" = "mcpitanlib-4.0.7-1.21.11-neoforge.jar";
            "hash" = "sha512-yb4hXCXKrY/Uxr+cHgwAoO2eBKlkwWx7U6qnl/rns/vfhfrc7ttj+98g+Ehm0poDr92inv+l/s2SB55Hut73eg==";
        };
        _1AfjWvTE = {
            "id" = "1AfjWvTE";
            "file" = "mcpitanlib-4.0.7-1.21.4-fabric.jar";
            "hash" = "sha512-mkhnr1OoNYiC4WZxLhgVCSI3Qm3Pq8GOZv10gsF35yUjjsQUFAY5qkpKsIA/FaRYhSaOj9lseU8oFVuJI7irCg==";
        };
        _OKXyIvf8 = {
            "id" = "OKXyIvf8";
            "file" = "mcpitanlib-4.0.7-1.21.4-neoforge.jar";
            "hash" = "sha512-ENWhCV6G4fjIxMgXCzrpf7a/oisl1AK4QUowZQJX8Bt57L5mu3CV/EuijyXNiJ3ZvQhcPLuhBSBgArH5LCgWeA==";
        };
        _qxG6kSZO = {
            "id" = "qxG6kSZO";
            "file" = "mcpitanlib-4.0.7-1.21.1-neoforge.jar";
            "hash" = "sha512-dB2Q9Hb4u9y38KOxmh3tdkYheTUnBZe5aJk5n+7QJELtqTa0sWsy/XR4wT07FV7vxMjfnum3uTAfQE29Te1iAw==";
        };
        _PMfGDjEq = {
            "id" = "PMfGDjEq";
            "file" = "mcpitanlib-4.0.7-1.21.1-fabric.jar";
            "hash" = "sha512-DyOqDK1+NdfU59vdH7IVV1qtPb08ab9z5VUoXoVjjEpGZFVwdmEheGf4Uuz7XT9otzAivsbTyjSX+ON9ogdlYA==";
        };
        _yJjlbqBN = {
            "id" = "yJjlbqBN";
            "file" = "mcpitanlib-4.0.7-1.20.1-fabric.jar";
            "hash" = "sha512-qdxoCxc1O3EZT6YplGZ/+1nOC3M8PgMg4rZkcGx5VGwF4GCMicGmmDC1lV5wdIzkabUT+fB62hOCor3XGq2ZCg==";
        };
        _m5fmzE1m = {
            "id" = "m5fmzE1m";
            "file" = "mcpitanlib-4.0.7-1.20.1-forge.jar";
            "hash" = "sha512-X1Lg9+LIAoYExU9MWtcDWqoPoObsOukIK6ibWPpqdt0f8ixCOfRWAiIBgJsC9TzA+iwRN86Au0N6e3skBTHFEw==";
        };
        _BsLqjyTX = {
            "id" = "BsLqjyTX";
            "file" = "mcpitanlib-4.0.7-1.20.4-forge.jar";
            "hash" = "sha512-7LM4jK18vSMHOhx49Z37GGkryhEigJMt2F49tJLuLfB5zgZgQ8ozsMZRDdkK1Q0gC+/0TOu676gFsIHwfllZVQ==";
        };
        _cVCnaoa3 = {
            "id" = "cVCnaoa3";
            "file" = "mcpitanlib-4.0.7-1.20.4-fabric.jar";
            "hash" = "sha512-vlRvudmkpnSFQZFi4kA0etgVygpbfZYqd9L+eXmit/Uqka2X7kr012xYj2nXKrhZzguATLhsoEg1y/3bmX6qgw==";
        };
        _eFVBRJ4C = {
            "id" = "eFVBRJ4C";
            "file" = "mcpitanlib-4.0.7-1.20.4-neoforge.jar";
            "hash" = "sha512-4FCf4fIJIca1ElWJZxS3v8M6ZEH7nUAuBxxEusZNLrVofGrxwl3dcOwRCUTAgms8e4HYKM5Gur4zSH5PeOZYVA==";
        };
        _mhGayNIV = {
            "id" = "mhGayNIV";
            "file" = "mcpitanlib-4.0.7-1.19.2-forge.jar";
            "hash" = "sha512-Hwi4qY4XV68vTN+Hnl6sdUh9HDcZ94MuJheiDwPGJAJ2izuCqex9N6IdlQeFel8yeiUD2O7HhhvOqVipE9CRkQ==";
        };
        _FP7ViF5n = {
            "id" = "FP7ViF5n";
            "file" = "mcpitanlib-4.0.7-1.19.2-fabric.jar";
            "hash" = "sha512-/HcHIndp44mWvPyB4XX3F5NOhprqNTu9ey/i5vv5G07FqGOV8ZL06Ekd1S402VdgcM3EmwHmFZjHf+fw6X+lGw==";
        };
        _Gg3k4bmo = {
            "id" = "Gg3k4bmo";
            "file" = "mcpitanlib-4.0.7-1.18.2-forge.jar";
            "hash" = "sha512-0TmdLkn522iPgSnvKbOWS+W3OIXeX4fr1nP9pxT0fhnbhOn6jBIpnJoC89+09bF7vq6kPglcOBVnnRu0Q+w2lg==";
        };
        _PYyLV5gL = {
            "id" = "PYyLV5gL";
            "file" = "mcpitanlib-4.0.7-1.18.2-fabric.jar";
            "hash" = "sha512-dqCCJyc0k16ZWbIT1jWSLXWjholjjX7TNFUoBViMOFE8VxZdnLhhtE+1FoykdDFEppKYF26MLgtapYwQGfk3uA==";
        };
        _vlpWM7as = {
            "id" = "vlpWM7as";
            "file" = "mcpitanlib-4.0.7-1.16.5-forge.jar";
            "hash" = "sha512-A5zr35itUBC3y7lHsjY8gPaBfXsktOqbZyD8+vYQZHfWqCvM0pXiKfSXsx819nQfhxvb/PRvKy2Qhr64YNxs4w==";
        };
        _PXLDOz5E = {
            "id" = "PXLDOz5E";
            "file" = "mcpitanlib-4.0.7-1.16.5-fabric.jar";
            "hash" = "sha512-7SHrR7z6w0T1NoJ5R3uRvS/eoBwudCLwXh1Clp/2KUcR2dBuX3DMFCm81I+e0H6B6GMp/5ug1h4v9gstk/ewLQ==";
        };
        _9smEhWRt = {
            "id" = "9smEhWRt";
            "file" = "mcpitanlib-4.0.7-fix.1-26.1-fabric.jar";
            "hash" = "sha512-VYkpFYpbwdG0YVLebMv4puMqzGSr4oMPkoCsQlNT7JF++aco9fl9+Yg6RZOlHrx/25iyOMkTqMhqvUE6HFjYpA==";
        };
        _jgLYJ2Oc = {
            "id" = "jgLYJ2Oc";
    ...
    in {
        ...
        "pkg-1.1.5+1.16.5-forge" = _NjavRcaN;
        "pkg-1.1.5+1.17-forge" = _ticDeW0e;
        "pkg-1.1.5+1.18-forge" = _8sVp75a9;
        "pkg-1.1.6+1.16.5-fabric" = _r0GRm26l;
        "pkg-1.1.6+1.17-fabric" = _nviqOir5;
        "pkg-1.1.6+1.18-fabric" = _kjagVikt;
        "pkg-1.1.6+1.16.5-forge" = _Wp4xyxzc;
        "pkg-1.1.6+1.17-forge" = _AEAbNdG1;
        "pkg-1.1.6+1.18-forge" = _47bhCvPe;
        "pkg-1.1.7+1.16.5-fabric" = _O6CCCxT2;
        "pkg-1.1.7+1.17-fabric" = _PChIknVl;
        "pkg-1.1.7+1.18-fabric" = _K7IuEWaO;
        "pkg-1.1.7+1.16.5-forge" = _jug7JIVS;
        "pkg-1.1.7+1.17-forge" = _xIFQDmCC;
        "pkg-1.1.7+1.18-forge" = _qmzcBTuf;
        "pkg-1.1.7+1.19-fabric" = _ni5aJ7BJ;
        "pkg-1.1.7+1.19-forge" = _7pQCONE5;
        "pkg-1.1.8+1.16.5-fabric" = _WjJfoRFj;
        "pkg-1.1.8+1.17-fabric" = _F1eLrBWJ;
        "pkg-1.1.8+1.18-fabric" = _yMg6QFfP;
        "pkg-1.1.8+1.19-fabric" = _RZRnlvLd;
        "pkg-1.1.8+1.16.5-forge" = _vrJu1VbZ;
        "pkg-1.1.8+1.17-forge" = _t6fAuBRA;
        "pkg-1.1.8+1.18-forge" = _ux3107kC;
        "pkg-1.1.8+1.19-forge" = _ifbrZsEE;
        "pkg-1.2.0+1.16.5-fabric" = _LPRvidtr;
        "pkg-1.2.0+1.17-fabric" = _2dx2fD7m;
        "pkg-1.2.0+1.18-fabric" = _D2Q6oY5S;
        "pkg-1.2.0+1.19-fabric" = _qutW1vdx;
        "pkg-1.2.0+1.19.3-fabric" = _TvZWxRpv;
        "pkg-1.2.0+1.16.5-forge" = _81TTJTLn;
        "pkg-1.2.0+1.17-forge" = _UQloxRNc;
        "pkg-1.2.0+1.18-forge" = _WkKdttef;
        "pkg-1.2.0+1.19-forge" = _jkgNeuvI;
        "pkg-1.2.1+1.16.5-fabric" = _L1FUkYP3;
        "pkg-1.2.1+1.17-fabric" = _YY9u0YKB;
        "pkg-1.2.1+1.18-fabric" = _pS4dPIBq;
        "pkg-1.2.1+1.19-fabric" = _5Kg8siBO;
        "pkg-1.2.1+1.19.3-fabric" = _J1c3Xz9x;
        "pkg-1.2.1+1.16.5-forge" = _sYcKHJLV;
        "pkg-1.2.1+1.17-forge" = _mtGhOcTn;
        "pkg-1.2.1+1.18-forge" = _9xSAb93L;
        "pkg-1.2.1+1.19-forge" = _9vIcNBZf;
        "pkg-1.2.1+1.19.3-forge" = _rVGQMiJ6;
        "pkg-1.2.2+1.16.5-fabric" = _GYK96WoT;
        "pkg-1.2.2+1.17-fabric" = _KjmIqBXf;
        "pkg-1.2.2+1.18-fabric" = _aXIj88LT;
        "pkg-1.2.2+1.19-fabric" = _CF1fetjQ;
        "pkg-1.2.2+1.19.3-fabric" = _absu2dDV;
        "pkg-1.2.2+1.16.5-forge" = _Zy1yS2i2;
        "pkg-1.2.2+1.17-forge" = _B3bSP0zv;
        "pkg-1.2.2+1.18-forge" = _5biklqwK;
        "pkg-1.2.2+1.19-forge" = _80NOx4Pi;
        "pkg-1.2.2+1.19.3-forge" = _TFHBc9Cx;
        "pkg-1.2.3+1.16.5-fabric" = _TAo31IvH;
        "pkg-1.2.3+1.17-fabric" = _1pXyVYUn;
        "pkg-1.2.3+1.18-fabric" = _t35eBYxQ;
        "pkg-1.2.3+1.19-fabric" = _ykJ2p5iG;
        "pkg-1.2.3+1.19.3-fabric" = _stGPwcus;
        "pkg-1.2.3+1.16.5-forge" = _bgnCiXxS;
        "pkg-1.2.3+1.17-forge" = _oayGCV8d;
        "pkg-1.2.3+1.18-forge" = _XyE7Bn5u;
        "pkg-1.2.3+1.19-forge" = _9pw0i7nF;
        "pkg-1.2.3+1.19.3-forge" = _CDxEQwAt;
        "pkg-1.2.4+1.16.5-fabric" = _46V1Pl8J;
        "pkg-1.2.4+1.17-fabric" = _bvvjbxPs;
        "pkg-1.2.4+1.18-fabric" = _HJfhWZCi;
        "pkg-1.2.4+1.19-fabric" = _tt88dSsD;
        "pkg-1.2.4+1.19.3-fabric" = _H3Y3kTaY;
        "pkg-1.2.4+1.16.5-forge" = _bH4MY6B3;
        "pkg-1.2.4+1.17-forge" = _zvUIVXqy;
        "pkg-1.2.4+1.18-forge" = _S3dWRrej;
        "pkg-1.2.4+1.19-forge" = _ShaXxP9k;
        "pkg-1.2.4+1.19.3-forge" = _Q0QuRqoq;
        "pkg-1.2.5+1.16.5-fabric" = _viVLVweD;
        "pkg-1.2.5+1.17-fabric" = _W2Wkwk9t;
        "pkg-1.2.5+1.18-fabric" = _nSSxAgqH;
        "pkg-1.2.5+1.19-fabric" = _R7IhBmAX;
        "pkg-1.2.5+1.19.3-fabric" = _okVfYzji;
        "pkg-1.2.5+1.16.5-forge" = _dPNg3mTu;
        "pkg-1.2.5+1.17-forge" = _77vWVHJp;
        "pkg-1.2.5+1.18-forge" = _QCQn8ulT;
        "pkg-1.2.5+1.19-forge" = _smjwQAAM;
        "pkg-1.2.5+1.19.3-forge" = _x6sAFp43;
        "pkg-1.2.6+1.16.5-fabric" = _iU2znmzi;
        "pkg-1.2.6+1.17-fabric" = _wo0zlUVz;
        "pkg-1.2.6+1.18-fabric" = _W4xx12rt;
        "pkg-1.2.6+1.19-fabric" = _KCsqQ8w9;
        "pkg-1.2.6+1.19.3-fabric" = _QolwtqEI;
        "pkg-1.2.6+1.16.5-forge" = _LOplaru7;
        "pkg-1.2.6+1.17-forge" = _4kK39QUV;
        "pkg-1.2.6+1.18-forge" = _EWz7pqe2;
        "pkg-1.2.6+1.19-forge" = _gM0PCvcn;
        "pkg-1.2.6+1.19.3-forge" = _W1X2lWXr;
        "pkg-1.2.7+1.19-fabric" = _jPTcXRPB;
        "pkg-1.2.7+1.19.3-fabric" = _XPNUWEc9;
        "pkg-1.2.7+1.19-forge" = _yYtmyopx;
        "pkg-1.2.7+1.19.3-forge" = _81Q1Ckd2;
        "pkg-1.2.8+1.16.5-fabric" = _HvS2y0qU;
        "pkg-1.2.8+1.17-fabric" = _3kIGkIoA;
        "pkg-1.2.8+1.18-fabric" = _GmTBM63d;
        "pkg-1.2.8+1.19-fabric" = _gNJskWjA;
        "pkg-1.2.8+1.19.3-fabric" = _sDUSvmxT;
        "pkg-1.2.8+1.16.5-forge" = _M0bkiLey;
        "pkg-1.2.8+1.17-forge" = _a53arrIH;
        "pkg-1.2.8+1.18-forge" = _fiEZrO1U;
        "pkg-1.2.8+1.19-forge" = _ijjNWtDn;
        "pkg-1.2.8+1.19.3-forge" = _Zdzfb4zg;
        "pkg-1.2.9+1.16.5-fabric" = _sm58OgHG;
        "pkg-1.2.9+1.17-fabric" = _OntOT9m5;
        "pkg-1.2.9+1.18-fabric" = _1FHmhHl3;
        "pkg-1.2.9+1.19-fabric" = _IOHaGzOg;
        "pkg-1.2.9+1.19.3-fabric" = _fHcUrN4t;
        "pkg-1.2.9+1.16.5-forge" = _ENKGTrUL;
        "pkg-1.2.9+1.17-forge" = _hlKoAwq2;
        "pkg-1.2.9+1.18-forge" = _7blgVfxa;
        "pkg-1.2.9+1.19-forge" = _7Ve8OLmn;
        "pkg-1.2.9+1.19.3-forge" = _8UwxfonJ;
        "pkg-1.3.0+1.16.5-fabric" = _ceEOLOti;
        "pkg-1.3.0+1.17-fabric" = _MQM70qRY;
        "pkg-1.3.0+1.18-fabric" = _FJ2zSyjV;
        "pkg-1.3.0+1.19-fabric" = _PjQ4mQOM;
        "pkg-1.3.0+1.19.3-fabric" = _OcVlsYFo;
        "pkg-1.3.0+1.16.5-forge" = _rAqLPRcY;
        "pkg-1.3.0+1.17-forge" = _kRgXy2vE;
        "pkg-1.3.0+1.18-forge" = _1VYiGOMl;
        "pkg-1.3.0+1.19-forge" = _QvKlW5Km;
        "pkg-1.3.0+1.19.3-forge" = _p3xEn1EA;
        "pkg-1.3.2+1.16.5-fabric" = _pJnEI8Vw;
        "pkg-1.3.2+1.17-fabric" = _flFBAAox;
        "pkg-1.3.2+1.18-fabric" = _Zk4VxZyK;
        "pkg-1.3.2+1.19-fabric" = _Jqy7zXDo;
        "pkg-1.3.2+1.19.3-fabric" = _bHYw7khM;
        "pkg-1.3.2+1.16.5-forge" = _aOxh4LsT;
        "pkg-1.3.2+1.17-forge" = _IpLS5LEt;
        "pkg-1.3.2+1.18-forge" = _QmxaHPwP;
        "pkg-1.3.2+1.19-forge" = _cAfAInqw;
        "pkg-1.3.2+1.19.3-forge" = _UAkVDcbW;
        "pkg-1.3.3+1.16.5-fabric" = _6UNTQhOw;
        "pkg-1.3.3+1.17-fabric" = _a8fmiEP7;
        "pkg-1.3.3+1.18-fabric" = _xOT0QnHN;
        "pkg-1.3.3+1.19-fabric" = _pIl7nY6O;
        "pkg-1.3.3+1.19.3-fabric" = _a8WSzGYZ;
        "pkg-1.3.3+1.16.5-forge" = _DXYacvBz;
        "pkg-1.3.3+1.17-forge" = _iXJwJDWa;
        "pkg-1.3.3+1.18-forge" = _yGMT5sm9;
        "pkg-1.3.3+1.19-forge" = _sJoVmpZ8;
        "pkg-1.3.3+1.19.3-forge" = _fvVI5clg;
        "pkg-1.3.4+1.16.5-fabric" = _K9EvLy7M;
        "pkg-1.3.4+1.17-fabric" = _jy7ZB5Hl;
        "pkg-1.3.4+1.18-fabric" = _sZ1X0qQt;
        "pkg-1.3.4+1.19-fabric" = _5JKMIjBD;
        "pkg-1.3.4+1.19.3-fabric" = _BeRoT69x;
        "pkg-1.3.4+1.16.5-forge" = _lLkPPMpm;
        "pkg-1.3.4+1.17-forge" = _GTajQ9A4;
        "pkg-1.3.4+1.18-forge" = _kxJkV5yi;
        "pkg-1.3.4+1.19-forge" = _YIx53qw3;
        "pkg-1.3.4+1.19.3-forge" = _Zbp2W8mH;
        "pkg-1.3.5+1.16.5-fabric" = _fiT9wOkH;
        "pkg-1.3.5+1.17-fabric" = _KEkXMCt8;
        "pkg-1.3.5+1.18-fabric" = _DQTNpC6r;
        "pkg-1.3.5+1.19-fabric" = _VjKzMSRT;
        "pkg-1.3.5+1.19.3-fabric" = _crABvKpP;
        "pkg-1.3.5+1.16.5-forge" = _oG3TjpSj;
        "pkg-1.3.5+1.17-forge" = _8PvQiYHt;
        "pkg-1.3.5+1.18-forge" = _ZvuzpvpA;
        "pkg-1.3.5+1.19-forge" = _vGSkzYwG;
        "pkg-1.3.5+1.19.3-forge" = _9rLn6Yy0;
        "pkg-1.3.6+1.16.5-fabric" = _UclCdh3E;
        "pkg-1.3.6+1.17-fabric" = _g3LxEDcO;
        "pkg-1.3.6+1.18-fabric" = _mjGF7KGM;
        "pkg-1.3.6+1.19-fabric" = _Ow8kW8na;
        "pkg-1.3.6+1.19.3-fabric" = _OfNzyzyq;
        "pkg-1.3.6+1.16.5-forge" = _ykbRwnbI;
        "pkg-1.3.6+1.17-forge" = _WZiS8ZYh;
        "pkg-1.3.6+1.18-forge" = _YbMiY6Oe;
        "pkg-1.3.6+1.19-forge" = _QSbLG0mO;
        "pkg-1.3.6+1.19.3-forge" = _69SEZo3m;
        "pkg-1.3.7+1.16.5-fabric" = _zLXhtQld;
        "pkg-1.3.7+1.17-fabric" = _QgakmHI8;
        "pkg-1.3.7+1.18-fabric" = _1sscV5fB;
        "pkg-1.3.7+1.19-fabric" = _ZEl7hLKQ;
        "pkg-1.3.7+1.19.3-fabric" = _azO4Xs7J;
        "pkg-1.3.7+1.16.5-forge" = _VlmquMsr;
        "pkg-1.3.7+1.17-forge" = _NxddPfVe;
        "pkg-1.3.7+1.18-forge" = _LDfBAuje;
        "pkg-1.3.7+1.19-forge" = _Znu8iuKh;
        "pkg-1.3.7+1.19.3-forge" = _SHQkiFLx;
        "pkg-1.4.0+1.16.5-fabric" = _EgAEBJbL;
        "pkg-1.4.0+1.17-fabric" = _UvBlPmnW;
        "pkg-1.4.0+1.18-fabric" = _PB2t3UMJ;
        "pkg-1.4.0+1.19-fabric" = _lVggOLkZ;
        "pkg-1.4.0+1.19.3-fabric" = _Yn2STgAA;
        "pkg-1.4.0+1.16.5-forge" = _nbegBeyQ;
        "pkg-1.4.0+1.17-forge" = _7dwm3mlX;
        "pkg-1.4.0+1.18-forge" = _57rQPaGi;
        "pkg-1.4.0+1.19-forge" = _W7FBLutY;
        "pkg-1.4.0+1.19.3-forge" = _Imo0TTEj;
        "pkg-1.4.1+1.16.5-fabric" = _bFzBeKRW;
        "pkg-1.4.1+1.17-fabric" = _uzaeEffO;
        "pkg-1.4.1+1.18-fabric" = _d7si3eiu;
        "pkg-1.4.1+1.19-fabric" = _hcQOxLla;
        "pkg-1.4.1+1.19.3-fabric" = _xa4Oerhr;
        "pkg-1.4.1+1.16.5-forge" = _97jacAai;
        "pkg-1.4.1+1.17-forge" = _VA2CUzfb;
        "pkg-1.4.1+1.18-forge" = _jUMdpOtl;
        "pkg-1.4.1+1.19-forge" = _LexqvdpC;
        "pkg-1.4.1+1.19.3-forge" = _ljEB2fmZ;
        "pkg-1.4.2+1.16.5-fabric" = _dwzOZk8X;
        "pkg-1.4.2+1.17-fabric" = _ZLLagpH3;
        "pkg-1.4.2+1.18-fabric" = _N7z5hS8G;
        "pkg-1.4.2+1.19-fabric" = _gfS50SHJ;
        "pkg-1.4.2+1.19.3-fabric" = _Y7f1dkba;
        "pkg-1.4.2+1.16.5-forge" = _SPpTHa4s;
        "pkg-1.4.2+1.17-forge" = _F3rMdVGx;
        "pkg-1.4.2+1.18-forge" = _KUEnyk77;
        "pkg-1.4.2+1.19-forge" = _oFworEVh;
        "pkg-1.4.2+1.19.3-forge" = _ExJpgG18;
        "pkg-1.4.3+1.16.5-fabric" = _XqGzwcay;
        "pkg-1.4.3+1.17-fabric" = _du3ugZco;
        "pkg-1.4.3+1.18-fabric" = _vQkXCxDa;
        "pkg-1.4.3+1.19-fabric" = _Zx4SMBXJ;
        "pkg-1.4.3+1.19.3-fabric" = _veHZ3yip;
        "pkg-1.4.3+1.16.5-forge" = _kyMzxL11;
        "pkg-1.4.3+1.17-forge" = _L1q5tvzV;
        "pkg-1.4.3+1.18-forge" = _WB5c7Ssf;
        "pkg-1.4.3+1.19-forge" = _WK5NIvYS;
        "pkg-1.4.3+1.19.3-forge" = _OF1Ue6p3;
        "pkg-1.4.4+1.16.5-fabric" = _zR4ycEyk;
        "pkg-1.4.4+1.17-fabric" = _k9g9B3qU;
        "pkg-1.4.4+1.18-fabric" = _YwIGa0Xo;
        "pkg-1.4.4+1.19-fabric" = _LqeiTI8V;
        "pkg-1.4.4+1.19.3-fabric" = _TIflHkE4;
        "pkg-1.4.4+1.16.5-forge" = _fpgqGUsJ;
        "pkg-1.4.4+1.17-forge" = _1qoYUXLf;
        "pkg-1.4.4+1.18-forge" = _ziXyEnm7;
        "pkg-1.4.4+1.19-forge" = _bqBziEj9;
        "pkg-1.4.4+1.19.3-forge" = _I0iFzIEx;
        "pkg-1.4.5+1.16.5-fabric" = _hAKcFRXt;
        "pkg-1.4.5+1.17-fabric" = _Ggp8B7XP;
        "pkg-1.4.5+1.18-fabric" = _xjVJYoiA;
        "pkg-1.4.5+1.19-fabric" = _snyQfqj1;
        "pkg-1.4.5+1.19.3-fabric" = _J7cgB9Qh;
        "pkg-1.4.5+1.16.5-forge" = _JLuRrmsQ;
        "pkg-1.4.5+1.17-forge" = _dSm3Q0VA;
        "pkg-1.4.5+1.18-forge" = _ucGWArRB;
        "pkg-1.4.5+1.19-forge" = _Y5eA7EYZ;
        "pkg-1.4.5+1.19.3-forge" = _P8vALnI7;
        "pkg-1.4.6+1.16.5-fabric" = _GYsZpqiz;
        "pkg-1.4.6+1.17-fabric" = _2d4VkpgQ;
        "pkg-1.4.6+1.18-fabric" = _7maBmF9u;
        "pkg-1.4.6+1.19-fabric" = _2LpNG2S1;
        "pkg-1.4.6+1.19.3-fabric" = _xmMyhkqR;
        "pkg-1.4.6+1.16.5-forge" = _bN12W5VJ;
        "pkg-1.4.6+1.17-forge" = _h0qcHezY;
        "pkg-1.4.6+1.18-forge" = _3mZNPVZQ;
        "pkg-1.4.6+1.19-forge" = _blLc6AYo;
        "pkg-1.4.6+1.19.3-forge" = _Vpt9na3j;
        "pkg-1.4.7+1.16.5-fabric" = _V6Sucj0P;
        "pkg-1.4.7+1.17-fabric" = _boUtPAan;
        "pkg-1.4.7+1.18-fabric" = _W7fuemW4;
        "pkg-1.4.7+1.19-fabric" = _xksTYPvO;
        "pkg-1.4.7+1.19.3-fabric" = _DhCtZpfd;
        "pkg-1.4.7+1.16.5-forge" = _6QO3jPuD;
        "pkg-1.4.7+1.17-forge" = _krJcp937;
        "pkg-1.4.7+1.18-forge" = _6vghXiYa;
        "pkg-1.4.7+1.19-forge" = _ZfMlOy1S;
        "pkg-1.4.7+1.19.3-forge" = _8Y5MH4nE;
        "pkg-1.4.8+1.16.5-fabric" = _xi7ZZ5lW;
        "pkg-1.4.8+1.17-fabric" = _kX8yj75O;
        "pkg-1.4.8+1.18-fabric" = _biPDiroz;
        "pkg-1.4.8+1.19-fabric" = _xLZLy3pm;
        "pkg-1.4.8+1.19.3-fabric" = _cshR63qG;
        "pkg-1.4.8+1.16.5-forge" = _gmkY46VL;
        "pkg-1.4.8+1.17-forge" = _mDg9eCWu;
        "pkg-1.4.8+1.18-forge" = _FGT8YhMP;
        "pkg-1.4.8+1.19-forge" = _53oweOo4;
        "pkg-1.4.8+1.19.3-forge" = _lIn2gvx4;
        "pkg-1.4.9+1.16.5-fabric" = _pltf8KYi;
        "pkg-1.4.9+1.17-fabric" = _bekVHTxz;
        "pkg-1.4.9+1.18-fabric" = _hXcOPU6t;
        "pkg-1.4.9+1.19-fabric" = _Yg7G8dtA;
        "pkg-1.4.9+1.19.3-fabric" = _I3HgHUNZ;
        "pkg-1.4.9+1.16.5-forge" = _rOycu7dw;
        "pkg-1.4.9+1.17-forge" = _KAsFcmjJ;
        "pkg-1.4.9+1.18-forge" = _2OUbVBY5;
        "pkg-1.4.9+1.19-forge" = _e6Un2fFU;
        "pkg-1.4.9+1.19.3-forge" = _2dS1YXeT;
        "pkg-1.5.0+1.16.5-fabric" = _thgWT49u;
        "pkg-1.5.0+1.17-fabric" = _yjyCF4BH;
        "pkg-1.5.0+1.18-fabric" = _U5cNyp80;
        "pkg-1.5.0+1.19-fabric" = _PXL2RJY4;
        "pkg-1.5.0+1.19.3-fabric" = _MjqkJ1Rb;
        "pkg-1.5.0+1.19.4-fabric" = _T7VjA5oQ;
        "pkg-1.5.0+1.16.5-forge" = _JQ6rA6BF;
        "pkg-1.5.0+1.17-forge" = _nGDKKtJ3;
        "pkg-1.5.0+1.18-forge" = _RnHum0LN;
        "pkg-1.5.0+1.19-forge" = _ody8LQZu;
        "pkg-1.5.0+1.19.3-forge" = _hHTcqilp;
        "pkg-1.5.0+1.19.4-forge" = _rRNyaw06;
        "pkg-1.5.1+1.16.5-fabric" = _eNoFr4wL;
        "pkg-1.5.1+1.17-fabric" = _nFo14whC;
        "pkg-1.5.1+1.18-fabric" = _AuzeSLOC;
        "pkg-1.5.1+1.19-fabric" = _u0vvoy4Y;
        "pkg-1.5.1+1.19.3-fabric" = _vyARFIjR;
        "pkg-1.5.1+1.19.4-fabric" = _GAaWYSnL;
        "pkg-1.5.1+1.16.5-forge" = _Oqsfr7V6;
        "pkg-1.5.1+1.17-forge" = _iSgE70PW;
        "pkg-1.5.1+1.18-forge" = _nZ8pAeMj;
        "pkg-1.5.1+1.19-forge" = _lxT3PZr5;
        "pkg-1.5.1+1.19.3-forge" = _WOfOQnNr;
        "pkg-1.5.1+1.19.4-forge" = _zkvpZn1B;
        "pkg-1.5.2+1.16.5-fabric" = _u2b5c1jc;
        "pkg-1.5.2+1.17-fabric" = _l1M2UY1n;
        "pkg-1.5.2+1.18-fabric" = _wBWp5JtL;
        "pkg-1.5.2+1.19-fabric" = _unKlTz1n;
        "pkg-1.5.2+1.19.3-fabric" = _3b6vDPSr;
        "pkg-1.5.2+1.19.4-fabric" = _ymvJ8hoU;
        "pkg-1.5.2+1.16.5-forge" = _mVUTJYTq;
        "pkg-1.5.2+1.17-forge" = _6dJR2UuN;
        "pkg-1.5.2+1.18-forge" = _Q9mlLH9e;
        "pkg-1.5.2+1.19-forge" = _MMnvvl6F;
        "pkg-1.5.2+1.19.3-forge" = _LhcTiTbh;
        "pkg-1.5.2+1.19.4-forge" = _ngHidTk4;
        "pkg-1.5.3+1.16.5-fabric" = _a662dLPL;
        "pkg-1.5.3+1.17-fabric" = _tLVtbmvf;
        "pkg-1.5.3+1.18-fabric" = _jXCNhn5C;
        "pkg-1.5.3+1.19-fabric" = _pH8Tlbem;
        "pkg-1.5.3+1.19.3-fabric" = _24PM4dfn;
        "pkg-1.5.3+1.19.4-fabric" = _TFpoaGy4;
        "pkg-1.5.3+1.16.5-forge" = _GBCj4cj0;
        "pkg-1.5.3+1.17-forge" = _hPzdYPSr;
        "pkg-1.5.3+1.18-forge" = _LVNTJkvu;
        "pkg-1.5.3+1.19-forge" = _jRcsEK0N;
        "pkg-1.5.3+1.19.3-forge" = _zhGU18X1;
        "pkg-1.5.3+1.19.4-forge" = _O1GW50IZ;
        "pkg-1.5.4+1.16.5-fabric" = _tbXqaKTM;
        "pkg-1.5.4+1.17-fabric" = _25mKAyop;
        "pkg-1.5.4+1.18-fabric" = _XUwbgNBI;
        "pkg-1.5.4+1.19-fabric" = _TAc5Gbhr;
        "pkg-1.5.4+1.19.3-fabric" = _mXO33ZAo;
        "pkg-1.5.4+1.19.4-fabric" = _WgcNEMMx;
        "pkg-1.5.4+1.16.5-forge" = _51HnAkAX;
        "pkg-1.5.4+1.17-forge" = _D3eCC93O;
        "pkg-1.5.4+1.18-forge" = _Z69h1lEN;
        "pkg-1.5.4+1.19-forge" = _sc1SuIxr;
        "pkg-1.5.4+1.19.3-forge" = _YykxHmmY;
        "pkg-1.5.4+1.19.4-forge" = _ELbbSnFN;
        "pkg-1.5.5+1.16.5-fabric" = _ING3sI6s;
        "pkg-1.5.5+1.17-fabric" = _2mFzCYYk;
        "pkg-1.5.5+1.18-fabric" = _RunCwmMR;
        "pkg-1.5.5+1.19-fabric" = _zaumv3dq;
        "pkg-1.5.5+1.19.3-fabric" = _Ytl1k3iw;
        "pkg-1.5.5+1.19.4-fabric" = _ETnidibB;
        "pkg-1.5.5+1.16.5-forge" = _fNaZYhTB;
        "pkg-1.5.5+1.17-forge" = _NLeNQNFz;
        "pkg-1.5.5+1.18-forge" = _5kISuhcC;
        "pkg-1.5.5+1.19-forge" = _UZlFpQSU;
        "pkg-1.5.5+1.19.3-forge" = _pZQT7ueP;
        "pkg-1.5.5+1.19.4-forge" = _V0ZLXTEn;
        "pkg-1.5.6+1.16.5-fabric" = _1YbFIThU;
        "pkg-1.5.6+1.17-fabric" = _6zYPaTnu;
        "pkg-1.5.6+1.18-fabric" = _KbqhrRev;
        "pkg-1.5.6+1.19-fabric" = _dEiW82VF;
        "pkg-1.5.6+1.19.3-fabric" = _mWvQllPM;
        "pkg-1.5.6+1.19.4-fabric" = _euC6QaJy;
        "pkg-1.5.6+1.16.5-forge" = _84ZhJdVS;
        "pkg-1.5.6+1.17-forge" = _9c37KLIA;
        "pkg-1.5.6+1.18-forge" = _O68EsaQK;
        "pkg-1.5.6+1.19-forge" = _AdAzh4K2;
        "pkg-1.5.6+1.19.3-forge" = _vUtZOm7F;
        "pkg-1.5.6+1.19.4-forge" = _EYhGQA6C;
        "pkg-1.5.7+1.16.5-fabric" = _j5JiTafU;
        "pkg-1.5.7+1.17-fabric" = _gjZB8jYs;
        "pkg-1.5.7+1.18-fabric" = _bwKNg0qn;
        "pkg-1.5.7+1.19-fabric" = _zcK1ckgr;
        "pkg-1.5.7+1.19.3-fabric" = _I5VDwMl1;
        "pkg-1.5.7+1.19.4-fabric" = _GnV9tXSx;
        "pkg-1.5.7+1.16.5-forge" = _vpoKjiOe;
        "pkg-1.5.7+1.17-forge" = _8U8pDsAF;
        "pkg-1.5.7+1.18-forge" = _Qu4WiW8o;
        "pkg-1.5.7+1.19-forge" = _tDDtggrX;
        "pkg-1.5.7+1.19.3-forge" = _n1yIRo0m;
        "pkg-1.5.7+1.19.4-forge" = _bKdl0Y9O;
        "pkg-1.5.8+1.16.5-fabric" = _31NAgwRW;
        "pkg-1.5.8+1.17-fabric" = _VqnKSDRi;
        "pkg-1.5.8+1.18-fabric" = _g8eIrnZ6;
        "pkg-1.5.8+1.19-fabric" = _zOURaTAs;
        "pkg-1.5.8+1.19.3-fabric" = _7zz47eCj;
        "pkg-1.5.8+1.19.4-fabric" = _ml8ZflwT;
        "pkg-1.5.8+1.16.5-forge" = _18LD68NV;
        "pkg-1.5.8+1.17-forge" = _Q22IhK5D;
        "pkg-1.5.8+1.18-forge" = _35uYSjcb;
        "pkg-1.5.8+1.19-forge" = _qRAdLbSx;
        "pkg-1.5.8+1.19.3-forge" = _T49gLDM8;
        "pkg-1.5.8+1.19.4-forge" = _Sm9BOwfx;
        "pkg-1.5.9+1.16.5-fabric" = _CE0TDq45;
        "pkg-1.5.9+1.17-fabric" = _QLeEg84L;
        "pkg-1.5.9+1.18-fabric" = _hltU7KNB;
        "pkg-1.5.9+1.19-fabric" = _sdrsD7uE;
        "pkg-1.5.9+1.19.3-fabric" = _tPJac8RO;
        "pkg-1.5.9+1.19.4-fabric" = _qkgGloOD;
        "pkg-1.5.9+1.16.5-forge" = _vrYMfrnv;
        "pkg-1.5.9+1.17-forge" = _nmyfKWGb;
        "pkg-1.5.9+1.18-forge" = _gB8OKEr2;
        "pkg-1.5.9+1.19-forge" = _5oJkV4oR;
        "pkg-1.5.9+1.19.3-forge" = _sTnjCnRa;
        "pkg-1.5.9+1.19.4-forge" = _U6NkZJIQ;
        "pkg-1.6.0+1.16.5-fabric" = _obyL1W3V;
        "pkg-1.6.0+1.17.1-fabric" = _pA3rV9Tn;
        "pkg-1.6.0+1.18.2-fabric" = _rCzV7GKF;
        "pkg-1.6.0+1.19.2-fabric" = _z1cBWGP3;
        "pkg-1.6.0+1.19.3-fabric" = _3qzWuqBM;
        "pkg-1.6.0+1.19.4-fabric" = _6LZdOwYf;
        "pkg-1.6.0+1.16.5-forge" = _CFg5dgSf;
        "pkg-1.6.0+1.17.1-forge" = _bnOjQ9lI;
        "pkg-1.6.0+1.18.2-forge" = _LeICdsf3;
        "pkg-1.6.0+1.19.2-forge" = _1ofLz3qK;
        "pkg-1.6.0+1.19.3-forge" = _6tOHlOJs;
        "pkg-1.6.0+1.19.4-forge" = _IENCa1KI;
        "pkg-1.6.1+1.16.5-fabric" = _KU5xZDSD;
        "pkg-1.6.1+1.17.1-fabric" = _4NcJwIoJ;
        "pkg-1.6.1+1.18.2-fabric" = _bAVifTYM;
        "pkg-1.6.1+1.19.2-fabric" = _dGYpIKz5;
        "pkg-1.6.1+1.19.3-fabric" = _HY1B3gXc;
        "pkg-1.6.1+1.19.4-fabric" = _3XJobYr1;
        "pkg-1.6.1+1.16.5-forge" = _8xC2A0lQ;
        "pkg-1.6.1+1.17.1-forge" = _ihraak1D;
        "pkg-1.6.1+1.18.2-forge" = _Fvog6qSF;
        "pkg-1.6.1+1.19.2-forge" = _48BIs3CW;
        "pkg-1.6.1+1.19.3-forge" = _Cm0TBmVB;
        "pkg-1.6.1+1.19.4-forge" = _VuRhYxDW;
        "pkg-1.6.2+1.16.5-fabric" = _UDiz2iLJ;
        "pkg-1.6.2+1.17.1-fabric" = _Y3bEI5og;
        "pkg-1.6.2+1.18.2-fabric" = _UKAR0WkP;
        "pkg-1.6.2+1.19.2-fabric" = _5HWI4ZjE;
        "pkg-1.6.2+1.19.3-fabric" = _JCo3IiWN;
        "pkg-1.6.2+1.19.4-fabric" = _QO6V1fdy;
        "pkg-1.6.2+1.16.5-forge" = _4fXxRML2;
        "pkg-1.6.2+1.17.1-forge" = _OVhksiaq;
        "pkg-1.6.2+1.18.2-forge" = _6jngCCTv;
        "pkg-1.6.2+1.19.2-forge" = _5BZ4mXcn;
        "pkg-1.6.2+1.19.3-forge" = _anLMisD2;
        "pkg-1.6.2+1.19.4-forge" = _gTrEXZcJ;
        "pkg-1.6.3+1.16.5-fabric" = _8CfaKD9q;
        "pkg-1.6.3+1.17.1-fabric" = _n5Kixxw5;
        "pkg-1.6.3+1.18.2-fabric" = _QcRlHJEw;
        "pkg-1.6.3+1.19.2-fabric" = _TimNdi2K;
        "pkg-1.6.3+1.19.3-fabric" = _tI6UjAln;
        "pkg-1.6.3+1.19.4-fabric" = _cCiTbQXX;
        "pkg-1.6.3+1.16.5-forge" = _tRpiM9SA;
        "pkg-1.6.3+1.17.1-forge" = _h9lBv2y6;
        "pkg-1.6.3+1.18.2-forge" = _yP4ECTIi;
        "pkg-1.6.3+1.19.2-forge" = _hqS3848X;
        "pkg-1.6.3+1.19.3-forge" = _Aq5cb1CI;
        "pkg-1.6.3+1.19.4-forge" = _kWix5gmQ;
        "pkg-1.6.4+1.16.5-fabric" = _g8CAnhS0;
        "pkg-1.6.4+1.17.1-fabric" = _JW1FRpMg;
        "pkg-1.6.4+1.18.2-fabric" = _yjJrhfRc;
        "pkg-1.6.4+1.19.2-fabric" = _dMAELtQP;
        "pkg-1.6.4+1.19.3-fabric" = _MUfpus6A;
        "pkg-1.6.4+1.19.4-fabric" = _l8AjhNUz;
        "pkg-1.6.4+1.20-fabric" = _zrfM7VaD;
        "pkg-1.6.4+1.16.5-forge" = _gmLOBxXs;
        "pkg-1.6.4+1.17.1-forge" = _WYXgGGmJ;
        "pkg-1.6.4+1.18.2-forge" = _kio9HPwb;
        "pkg-1.6.4+1.19.2-forge" = _GSSwUZ6h;
        "pkg-1.6.4+1.19.3-forge" = _NLecP7xu;
        "pkg-1.6.4+1.19.4-forge" = _HDnkA5F9;
        "pkg-1.6.4+1.20-forge" = _QBtKmGzj;
        "pkg-1.6.5+1.16.5-fabric" = _lntqzkGP;
        "pkg-1.6.5+1.17.1-fabric" = _ui2JzpK0;
        "pkg-1.6.5+1.18.2-fabric" = _yypqyYqQ;
        "pkg-1.6.5+1.19.2-fabric" = _R3lMOZGT;
        "pkg-1.6.5+1.19.3-fabric" = _ZO5V6iD2;
        "pkg-1.6.5+1.19.4-fabric" = _ROOvWzJy;
        "pkg-1.6.5+1.20-fabric" = _N4Iu2RLR;
        "pkg-1.6.5+1.16.5-forge" = _5Njkh1Og;
        "pkg-1.6.5+1.17.1-forge" = _nkl5WCgr;
        "pkg-1.6.5+1.18.2-forge" = _JaGIyu5K;
        "pkg-1.6.5+1.19.2-forge" = _GlNoovgG;
        "pkg-1.6.5+1.19.3-forge" = _ScRjF0AX;
        "pkg-1.6.5+1.19.4-forge" = _vmpXhkkc;
        "pkg-1.6.5+1.20-forge" = _d4fYuu0p;
        "pkg-1.6.6+1.16.5-fabric" = _OR3jebHo;
        "pkg-1.6.6+1.17.1-fabric" = _2AlUlZ6c;
        "pkg-1.6.6+1.18.2-fabric" = _DND2s0jo;
        "pkg-1.6.6+1.19.2-fabric" = _qwJCwsjl;
        "pkg-1.6.6+1.19.3-fabric" = _emqcrJJB;
        "pkg-1.6.6+1.19.4-fabric" = _LUcmMydr;
        "pkg-1.6.6+1.20-fabric" = _HFyPCQNa;
        "pkg-1.6.6+1.16.5-forge" = _SsrX0lfn;
        "pkg-1.6.6+1.17.1-forge" = _5t5tVmRj;
        "pkg-1.6.6+1.18.2-forge" = _6lX1kGg9;
        "pkg-1.6.6+1.19.2-forge" = _bRIW4GQD;
        "pkg-1.6.6+1.19.3-forge" = _nGSl2lO6;
        "pkg-1.6.6+1.19.4-forge" = _33CsfnS3;
        "pkg-1.6.6+1.20-forge" = _HzSPxH2X;
        "pkg-1.6.7+1.16.5-fabric" = _V3sJ5ZWQ;
        "pkg-1.6.7+1.17.1-fabric" = _XgJMqTVu;
        "pkg-1.6.7+1.18.2-fabric" = _T879Hiah;
        "pkg-1.6.7+1.19.2-fabric" = _bB21OuDx;
        "pkg-1.6.7+1.19.3-fabric" = _DMoYp28d;
        "pkg-1.6.7+1.19.4-fabric" = _XOVdQELM;
        "pkg-1.6.7+1.20-fabric" = _gy0yCdi9;
        "pkg-1.6.7+1.20-forge" = _O1xxiKAx;
        "pkg-1.6.10+1.16.5-fabric" = _U05Z6LYq;
        "pkg-1.6.10+1.17.1-fabric" = _o4UP8gmc;
        "pkg-1.6.10+1.18.2-fabric" = _WgIqlbAr;
        "pkg-1.6.10+1.19.2-fabric" = _4E75Vui8;
        "pkg-1.6.10+1.19.3-fabric" = _54Wydk9I;
        "pkg-1.6.10+1.19.4-fabric" = _LJYHZxiY;
        "pkg-1.6.10+1.20.1-fabric" = _W7UhcULh;
        "pkg-1.6.10+1.16.5-forge" = _ZvQeNCP5;
        "pkg-1.6.10+1.17.1-forge" = _hKTghvjk;
        "pkg-1.6.10+1.18.2-forge" = _qGvYYUjb;
        "pkg-1.6.10+1.19.2-forge" = _GB3Rq00l;
        "pkg-1.6.10+1.19.3-forge" = _FgKx1DXx;
        "pkg-1.6.10+1.19.4-forge" = _kWbjcCrm;
        "pkg-1.6.10+1.20.1-forge" = _oO96T71N;
        "pkg-1.7.1+1.16.5-fabric" = _IICBP8ee;
        "pkg-1.7.1+1.17.1-fabric" = _7FE6yb80;
        "pkg-1.7.1+1.18.2-fabric" = _LUv0bFH4;
        "pkg-1.7.1+1.19.2-fabric" = _VEfP6VeL;
        "pkg-1.7.1+1.19.3-fabric" = _mlUBmpdH;
        "pkg-1.7.1+1.19.4-fabric" = _cZ1eovX5;
        "pkg-1.7.1+1.20.1-fabric" = _4bwJYy9D;
        "pkg-1.7.1+1.16.5-forge" = _uYzKOi9G;
        "pkg-1.7.1+1.17.1-forge" = _pqwr9eGa;
        "pkg-1.7.1+1.18.2-forge" = _UI8ZE65w;
        "pkg-1.7.1+1.19.2-forge" = _dxs12yau;
        "pkg-1.7.1+1.19.3-forge" = _RYqnHEPN;
        "pkg-1.7.1+1.19.4-forge" = _95HQbVzx;
        "pkg-1.7.1+1.20.1-forge" = _Z6ieqrP9;
        "pkg-1.7.2+1.16.5-fabric" = _2H21HMWM;
        "pkg-1.7.2+1.17.1-fabric" = _YwWjOMkI;
        "pkg-1.7.2+1.18.2-fabric" = _UOoSoeii;
        "pkg-1.7.2+1.19.2-fabric" = _7xcmu1cq;
        "pkg-1.7.2+1.19.3-fabric" = _ltcBYojp;
        "pkg-1.7.2+1.19.4-fabric" = _DZpJi4fd;
        "pkg-1.7.2+1.20.1-fabric" = _PyOQ7GSp;
        "pkg-1.7.2+1.16.5-forge" = _nbsoH2Pd;
        "pkg-1.7.2+1.17.1-forge" = _JSE69VPT;
        "pkg-1.7.2+1.18.2-forge" = _ogRCZMx2;
        "pkg-1.7.2+1.19.2-forge" = _t7o1OTOb;
        "pkg-1.7.2+1.19.3-forge" = _DYF478F5;
        "pkg-1.7.2+1.19.4-forge" = _dK1rGYUY;
        "pkg-1.7.2+1.20.1-forge" = _qBs4Rq4H;
        "pkg-1.7.3+1.16.5-fabric" = _bASZuQFg;
        "pkg-1.7.3+1.17.1-fabric" = _P3xHA4a5;
        "pkg-1.7.3+1.18.2-fabric" = _pceNKwlH;
        "pkg-1.7.3+1.19.2-fabric" = _c9eIgQ90;
        "pkg-1.7.3+1.19.3-fabric" = _zfkpy8hK;
        "pkg-1.7.3+1.19.4-fabric" = _OgSlEMpA;
        "pkg-1.7.3+1.20.1-fabric" = _FnHqhNJJ;
        "pkg-1.7.3+1.16.5-forge" = _QZYGggpt;
        "pkg-1.7.3+1.17.1-forge" = _Bkfa124C;
        "pkg-1.7.3+1.18.2-forge" = _CiIWTRSt;
        "pkg-1.7.3+1.19.2-forge" = _WMIVRZs6;
        "pkg-1.7.3+1.19.3-forge" = _2qgsrR0f;
        "pkg-1.7.3+1.19.4-forge" = _Qaz9juqo;
        "pkg-1.7.3+1.20.1-forge" = _A6JbrXjE;
        "pkg-1.7.4+1.16.5-fabric" = _R5oPnAcq;
        "pkg-1.7.4+1.17.1-fabric" = _gMGi2Acw;
        "pkg-1.7.4+1.18.2-fabric" = _NHuxG8nk;
        "pkg-1.7.4+1.19.2-fabric" = _6tQcl0Ti;
        "pkg-1.7.4+1.19.3-fabric" = _xvsq4GkR;
        "pkg-1.7.4+1.19.4-fabric" = _GnPqPOSj;
        "pkg-1.7.4+1.20.1-fabric" = _TeTrHhfY;
        "pkg-1.7.4+1.16.5-forge" = _PysupO1K;
        "pkg-1.7.4+1.17.1-forge" = _AAZIejRp;
        "pkg-1.7.4+1.18.2-forge" = _SJhmfYuG;
        "pkg-1.7.4+1.19.2-forge" = _i5mlbFkg;
        "pkg-1.7.4+1.19.3-forge" = _YjPxiSUD;
        "pkg-1.7.4+1.19.4-forge" = _DzNw5oCC;
        "pkg-1.7.4+1.20.1-forge" = _JQuf2MJW;
        "pkg-1.7.5+1.16.5-fabric" = _Eh4Zg1Gk;
        "pkg-1.7.5+1.17.1-fabric" = _PXPuYB0C;
        "pkg-1.7.5+1.18.2-fabric" = _qazal5qt;
        "pkg-1.7.5+1.19.2-fabric" = _2IGtVx9n;
        "pkg-1.7.5+1.19.3-fabric" = _WeCfnkZi;
        "pkg-1.7.5+1.19.4-fabric" = _jYlbUeJd;
        "pkg-1.7.5+1.20.1-fabric" = _8RxR45TS;
        "pkg-1.7.5+1.16.5-forge" = _tiCkszrd;
        "pkg-1.7.5+1.17.1-forge" = _2JTxpnPu;
        "pkg-1.7.5+1.18.2-forge" = _AoMqBaK9;
        "pkg-1.7.5+1.19.2-forge" = _qKWzskce;
        "pkg-1.7.5+1.19.3-forge" = _Dhz0RoOD;
        "pkg-1.7.5+1.19.4-forge" = _CYWRJ5uq;
        "pkg-1.7.5+1.20.1-forge" = _MB1tO9oY;
        "pkg-1.7.6+1.16.5-fabric" = _GGZpCXf2;
        "pkg-1.7.6+1.17.1-fabric" = _DWgjRgPe;
        "pkg-1.7.6+1.18.2-fabric" = _urvF5EaT;
        "pkg-1.7.6+1.19.2-fabric" = _Kw9We3Om;
        "pkg-1.7.6+1.19.3-fabric" = _Dzs5tg7e;
        "pkg-1.7.6+1.19.4-fabric" = _eS39JlNZ;
        "pkg-1.7.6+1.20.1-fabric" = _eOoJiqxX;
        "pkg-1.7.6+1.16.5-forge" = _sFW1Bynz;
        "pkg-1.7.6+1.17.1-forge" = _Exlm5obs;
        "pkg-1.7.6+1.18.2-forge" = _FHR8Vgld;
        "pkg-1.7.6+1.19.2-forge" = _N5K5ggmU;
        "pkg-1.7.6+1.19.3-forge" = _jkePlmR5;
        "pkg-1.7.6+1.19.4-forge" = _W7vllqEi;
        "pkg-1.7.6+1.20.1-forge" = _l2YnkXYs;
        "pkg-1.7.7+1.16.5-fabric" = _P2VrYG1k;
        "pkg-1.7.7+1.17.1-fabric" = _wALk1jt2;
        "pkg-1.7.7+1.18.2-fabric" = _t8jBuMYq;
        "pkg-1.7.7+1.19.2-fabric" = _nl2I4xb0;
        "pkg-1.7.7+1.19.3-fabric" = _9YaiYar4;
        "pkg-1.7.7+1.19.4-fabric" = _gGA0rQJC;
        "pkg-1.7.7+1.20.1-fabric" = _S9dreLq9;
        "pkg-1.7.7+1.16.5-forge" = _TK4OmyaS;
        "pkg-1.7.7+1.17.1-forge" = _TveGkUR4;
        "pkg-1.7.7+1.18.2-forge" = _FTcKo3H3;
        "pkg-1.7.7+1.19.2-forge" = _AUvxlidm;
        "pkg-1.7.7+1.19.3-forge" = _ksHgJsTm;
        "pkg-1.7.7+1.19.4-forge" = _cfKtjhdV;
        "pkg-1.7.7+1.20.1-forge" = _dJXJR6Rr;
        "pkg-1.7.8+1.16.5-fabric" = _Iwm01uEu;
        "pkg-1.7.8+1.17.1-fabric" = _povB836e;
        "pkg-1.7.8+1.18.2-fabric" = _YoQ4HMAV;
        "pkg-1.7.8+1.19.2-fabric" = _JUVD0Vsk;
        "pkg-1.7.8+1.19.3-fabric" = _z0z4z4OM;
        "pkg-1.7.8+1.19.4-fabric" = _Z7ilNS5f;
        "pkg-1.7.8+1.20.1-fabric" = _TyiJ9gL8;
        "pkg-1.7.8+1.16.5-forge" = _Lm0lhGeP;
        "pkg-1.7.8+1.17.1-forge" = _5j8K3UzZ;
        "pkg-1.7.8+1.18.2-forge" = _kO6ggi6k;
        "pkg-1.7.8+1.19.2-forge" = _HUpn34tQ;
        "pkg-1.7.8+1.19.3-forge" = _rJZVLmSo;
        "pkg-1.7.8+1.19.4-forge" = _IxNhsR28;
        "pkg-1.7.8+1.20.1-forge" = _w8J7SDxv;
        "pkg-1.7.9+1.16.5-fabric" = _5oDhI2Xk;
        "pkg-1.7.9+1.17.1-fabric" = _z4hS20IH;
        "pkg-1.7.9+1.18.2-fabric" = _6Hxa66sn;
        "pkg-1.7.9+1.19.2-fabric" = _qNvYcMuV;
        "pkg-1.7.9+1.19.3-fabric" = _hypZLkQ1;
        "pkg-1.7.9+1.19.4-fabric" = _JH35EHyA;
        "pkg-1.7.9+1.20.1-fabric" = _rh0CnGbq;
        "pkg-1.7.9+1.20.2-fabric" = _QMliMHHF;
        "pkg-1.7.9+1.16.5-forge" = _iqVspevJ;
        "pkg-1.7.9+1.17.1-forge" = _6IWJ8zYb;
        "pkg-1.7.9+1.18.2-forge" = _SzsmOjrO;
        "pkg-1.7.9+1.19.2-forge" = _iuVnUHlW;
        "pkg-1.7.9+1.19.3-forge" = _Yw605uEF;
        "pkg-1.7.9+1.19.4-forge" = _6Erxi3mx;
        "pkg-1.7.9+1.20.1-forge" = _qh2VKYCS;
        "pkg-1.7.9+1.20.2-forge" = _rutWAyR8;
        "pkg-1.8.0+1.16.5-fabric" = _lp5qRMV7;
        "pkg-1.8.0+1.17.1-fabric" = _PL4o0mjA;
        "pkg-1.8.0+1.18.2-fabric" = _wEojo62n;
        "pkg-1.8.0+1.19.2-fabric" = _ItiExPqf;
        "pkg-1.8.0+1.19.3-fabric" = _scoMOH1j;
        "pkg-1.8.0+1.19.4-fabric" = _sHQcA4gw;
        "pkg-1.8.0+1.20.1-fabric" = _TJHBHESp;
        "pkg-1.8.0+1.20.2-fabric" = _5hHb5P1e;
        "pkg-1.8.0+1.16.5-forge" = _AbRlJEUj;
        "pkg-1.8.0+1.17.1-forge" = _7PAApKZf;
        "pkg-1.8.0+1.18.2-forge" = _CL0NcP1T;
        "pkg-1.8.0+1.19.2-forge" = _gyIRBFDU;
        "pkg-1.8.0+1.19.3-forge" = _DEOSd3hc;
        "pkg-1.8.0+1.19.4-forge" = _TK8kzuHV;
        "pkg-1.8.0+1.20.1-forge" = _Kj20XwwU;
        "pkg-1.8.0+1.20.2-forge" = _lWhfsSzd;
        "pkg-1.8.1+1.16.5-fabric" = _TOlzlTPh;
        "pkg-1.8.1+1.17.1-fabric" = _RzXUJ8Pi;
        "pkg-1.8.1+1.18.2-fabric" = _h4wcd4f6;
        "pkg-1.8.1+1.19.2-fabric" = _EOpntJKw;
        "pkg-1.8.1+1.19.3-fabric" = _mArihALC;
        "pkg-1.8.1+1.19.4-fabric" = _xC609HO1;
        "pkg-1.8.1+1.20.1-fabric" = _Mjhdv4l0;
        "pkg-1.8.1+1.20.2-fabric" = _DibLVIYn;
        "pkg-1.8.1+1.16.5-forge" = _mFGyM57A;
        "pkg-1.8.1+1.17.1-forge" = _TRfgE7LQ;
        "pkg-1.8.1+1.18.2-forge" = _jp5Yt0qI;
        "pkg-1.8.1+1.19.2-forge" = _hTlb1yBA;
        "pkg-1.8.1+1.19.3-forge" = _PlMjiAx5;
        "pkg-1.8.1+1.19.4-forge" = _vlirtLNs;
        "pkg-1.8.1+1.20.1-forge" = _3IEbB4nx;
        "pkg-1.8.1+1.20.2-forge" = _aBZbLSl9;
        "pkg-1.8.2+1.16.5-fabric" = _QAOiL5nc;
        "pkg-1.8.2+1.17.1-fabric" = _OrETMlrl;
        "pkg-1.8.2+1.18.2-fabric" = _9cHS1XvY;
        "pkg-1.8.2+1.19.2-fabric" = _F5yosnQJ;
        "pkg-1.8.2+1.19.3-fabric" = _OlkAR1Rb;
        "pkg-1.8.2+1.19.4-fabric" = _v8Jb2beW;
        "pkg-1.8.2+1.20.1-fabric" = _CuYPZVFJ;
        "pkg-1.8.2+1.20.2-fabric" = _SyoR1SpJ;
        "pkg-1.8.2+1.16.5-forge" = _ckjrQnxn;
        "pkg-1.8.2+1.17.1-forge" = _3ZeTuqjX;
        "pkg-1.8.2+1.18.2-forge" = _vcfKPLHp;
        "pkg-1.8.2+1.19.2-forge" = _zpUrMa02;
        "pkg-1.8.2+1.19.3-forge" = _aSfXnXXB;
        "pkg-1.8.2+1.19.4-forge" = _PgyhrcWn;
        "pkg-1.8.2+1.20.1-forge" = _Uf8M0zpZ;
        "pkg-1.8.2+1.20.2-forge" = _6DCiuMxu;
        "pkg-1.8.3+1.16.5-fabric" = _58qZLZQQ;
        "pkg-1.8.3+1.17.1-fabric" = _ymRJJ4lK;
        "pkg-1.8.3+1.18.2-fabric" = _2KkfOJ3p;
        "pkg-1.8.3+1.19.2-fabric" = _xAg8p0FB;
        "pkg-1.8.3+1.19.3-fabric" = _nDXs550Y;
        "pkg-1.8.3+1.19.4-fabric" = _jrovEhao;
        "pkg-1.8.3+1.20.1-fabric" = _wEzCY2Ge;
        "pkg-1.8.3+1.20.2-fabric" = _YtWJETdR;
        "pkg-1.8.3+1.16.5-forge" = _h4PUyG79;
        "pkg-1.8.3+1.17.1-forge" = _h5LKta4d;
        "pkg-1.8.3+1.18.2-forge" = _brZwlrQe;
        "pkg-1.8.3+1.19.2-forge" = _AYilq4jk;
        "pkg-1.8.3+1.19.3-forge" = _wo68h1wg;
        "pkg-1.8.3+1.19.4-forge" = _EoAbL1x9;
        "pkg-1.8.3+1.20.1-forge" = _slYyr4PL;
        "pkg-1.8.3+1.20.2-forge" = _sZILbiW3;
        "pkg-1.8.4+1.16.5-fabric" = _faHqTBED;
        "pkg-1.8.4+1.17.1-fabric" = _ZWgGLmOw;
        "pkg-1.8.4+1.18.2-fabric" = _4p1rHxR9;
        "pkg-1.8.4+1.19.2-fabric" = _d63xgGeY;
        "pkg-1.8.4+1.19.3-fabric" = _OFfjpmhh;
        "pkg-1.8.4+1.19.4-fabric" = _IbddskNa;
        "pkg-1.8.4+1.20.1-fabric" = _F1QoQZKN;
        "pkg-1.8.4+1.20.2-fabric" = _NEJELKJN;
        "pkg-1.8.4+1.16.5-forge" = _l2u7AT1E;
        "pkg-1.8.4+1.17.1-forge" = _OkloRySK;
        "pkg-1.8.4+1.18.2-forge" = _vCWBj62C;
        "pkg-1.8.4+1.19.2-forge" = _LAwV9YiU;
        "pkg-1.8.4+1.19.3-forge" = _7u0BWtxJ;
        "pkg-1.8.4+1.19.4-forge" = _XnBfNt63;
        "pkg-1.8.4+1.20.1-forge" = _D52UcFH4;
        "pkg-1.8.4+1.20.2-forge" = _mdBBW5sL;
        "pkg-1.8.5+1.16.5-fabric" = _dlKIpLIr;
        "pkg-1.8.5+1.17.1-fabric" = _Mr9aowsT;
        "pkg-1.8.5+1.18.2-fabric" = _M5mQP1yl;
        "pkg-1.8.5+1.19.2-fabric" = _DBMjrdCa;
        "pkg-1.8.5+1.19.3-fabric" = _zL3YH1Vy;
        "pkg-1.8.5+1.19.4-fabric" = _1XRMowl8;
        "pkg-1.8.5+1.20.1-fabric" = _1FpUaWQe;
        "pkg-1.8.5+1.20.2-fabric" = _8mPgP76P;
        "pkg-1.8.5+1.20.4-fabric" = _NTndwgxo;
        "pkg-1.8.5+1.16.5-forge" = _98lxwmvK;
        "pkg-1.8.5+1.17.1-forge" = _bm6HZCfV;
        "pkg-1.8.5+1.18.2-forge" = _a3brnyXB;
        "pkg-1.8.5+1.19.2-forge" = _kxbmmLZn;
        "pkg-1.8.5+1.19.3-forge" = _cRUYysDN;
        "pkg-1.8.5+1.19.4-forge" = _GppM41xs;
        "pkg-1.8.5+1.20.1-forge" = _q3loaoO7;
        "pkg-1.8.5+1.20.2-forge" = _zyljPUjK;
        "pkg-1.8.5+1.20.4-forge" = _OrI2r82E;
        "pkg-1.8.5+1.20.2-neoforge" = _owGlDmXa;
        "pkg-1.8.5+1.20.4-neoforge" = _GMI2emNn;
        "pkg-1.8.6+1.16.5-fabric" = _axjM9jnH;
        "pkg-1.8.6+1.17.1-fabric" = _8mf4VTMO;
        "pkg-1.8.6+1.18.2-fabric" = _OyHGIF8j;
        "pkg-1.8.6+1.19.2-fabric" = _iZEn1tQp;
        "pkg-1.8.6+1.19.3-fabric" = _scfu5CtL;
        "pkg-1.8.6+1.19.4-fabric" = _AL83NfLP;
        "pkg-1.8.6+1.20.1-fabric" = _iWhOogLu;
        "pkg-1.8.6+1.20.2-fabric" = _BedUD8MM;
        "pkg-1.8.6+1.20.4-fabric" = _ZM3QZEf2;
        "pkg-1.8.6+1.16.5-forge" = _LVqR8Une;
        "pkg-1.8.6+1.17.1-forge" = _9VyAZisr;
        "pkg-1.8.6+1.18.2-forge" = _5R68aoTk;
        "pkg-1.8.6+1.19.2-forge" = _EtQKSN2U;
        "pkg-1.8.6+1.19.3-forge" = _TyJgmQyF;
        "pkg-1.8.6+1.19.4-forge" = _QzJEN2xt;
        "pkg-1.8.6+1.20.1-forge" = _lE184oAF;
        "pkg-1.8.6+1.20.2-forge" = _NR2ZclgE;
        "pkg-1.8.6+1.20.4-forge" = _bitJusTe;
        "pkg-1.8.6+1.20.2-neoforge" = _wzmyD5qs;
        "pkg-1.8.6+1.20.4-neoforge" = _LgETu799;
        "pkg-1.8.7+1.16.5-fabric" = _Dqo55QbL;
        "pkg-1.8.7+1.17.1-fabric" = _2NsCdpXe;
        "pkg-1.8.7+1.18.2-fabric" = _ilo0BGUL;
        "pkg-1.8.7+1.19.2-fabric" = _aYANoT18;
        "pkg-1.8.7+1.19.3-fabric" = _Fsh72Veh;
        "pkg-1.8.7+1.19.4-fabric" = _Bc7EBQsY;
        "pkg-1.8.7+1.20.1-fabric" = _Woge1ux9;
        "pkg-1.8.7+1.20.2-fabric" = _2hkROkUx;
        "pkg-1.8.7+1.20.4-fabric" = _LZ8WEJP0;
        "pkg-1.8.7+1.16.5-forge" = _sGcODUQv;
        "pkg-1.8.7+1.17.1-forge" = _rIa462iz;
        "pkg-1.8.7+1.18.2-forge" = _56tsghg0;
        "pkg-1.8.7+1.19.2-forge" = _T6SvprGZ;
        "pkg-1.8.7+1.19.3-forge" = _2Fu8dWQu;
        "pkg-1.8.7+1.19.4-forge" = _1gak3ytK;
        "pkg-1.8.7+1.20.1-forge" = _FlVQmYcx;
        "pkg-1.8.7+1.20.2-forge" = _19AzLJj2;
        "pkg-1.8.7+1.20.4-forge" = _QpoHM9bE;
        "pkg-1.8.7+1.20.2-neoforge" = _mzYdgX6j;
        "pkg-1.8.7+1.20.4-neoforge" = _mzyL3ciJ;
        "pkg-1.8.8+1.16.5-fabric" = _uRPLlxv2;
        "pkg-1.8.8+1.17.1-fabric" = _8nhnjdng;
        "pkg-1.8.8+1.18.2-fabric" = _ujjiuS4h;
        "pkg-1.8.8+1.19.2-fabric" = _6INhfMrr;
        "pkg-1.8.8+1.19.3-fabric" = _bp4UAN9H;
        "pkg-1.8.8+1.19.4-fabric" = _VrYGGpfa;
        "pkg-1.8.8+1.20.1-fabric" = _2JfEBxuQ;
        "pkg-1.8.8+1.20.2-fabric" = _yLWGVpmG;
        "pkg-1.8.8+1.20.4-fabric" = _HY0SuhUs;
        "pkg-1.8.8+1.16.5-forge" = _hWcqh7rF;
        "pkg-1.8.8+1.17.1-forge" = _R0lfFogY;
        "pkg-1.8.8+1.18.2-forge" = _rXMIxbvx;
        "pkg-1.8.8+1.19.2-forge" = _CXerCjrR;
        "pkg-1.8.8+1.19.3-forge" = _qTIRfkSQ;
        "pkg-1.8.8+1.19.4-forge" = _cJrd7IC0;
        "pkg-1.8.8+1.20.1-forge" = _3qCQoMYw;
        "pkg-1.8.8+1.20.2-forge" = _gIS59V8p;
        "pkg-1.8.8+1.20.4-forge" = _HaQqPqJX;
        "pkg-1.8.8+1.20.2-neoforge" = _6ZJESKXm;
        "pkg-1.8.8+1.20.4-neoforge" = _C5CedAlw;
        "pkg-1.8.9+1.16.5-fabric" = _CHBHwjoC;
        "pkg-1.8.9+1.17.1-fabric" = _bsOoj3E1;
        "pkg-1.8.9+1.18.2-fabric" = _dS2PX1VB;
        "pkg-1.8.9+1.19.2-fabric" = _I0G8N228;
        "pkg-1.8.9+1.19.3-fabric" = _nVEpfkq3;
        "pkg-1.8.9+1.19.4-fabric" = _RSpfdbzb;
        "pkg-1.8.9+1.20.1-fabric" = _19KBfq55;
        "pkg-1.8.9+1.20.2-fabric" = _6PKdV5l9;
        "pkg-1.8.9+1.20.4-fabric" = _DMCQKsEf;
        "pkg-1.8.9+1.16.5-forge" = _KWknANHZ;
        "pkg-1.8.9+1.17.1-forge" = _ZCxlEZfg;
        "pkg-1.8.9+1.18.2-forge" = _k6v8ftVw;
        "pkg-1.8.9+1.19.2-forge" = _StBfoG1K;
        "pkg-1.8.9+1.19.3-forge" = _7DVZvXiv;
        "pkg-1.8.9+1.19.4-forge" = _z5B28msm;
        "pkg-1.8.9+1.20.1-forge" = _GiLC4Mat;
        "pkg-1.8.9+1.20.2-forge" = _rUNZ01hE;
        "pkg-1.8.9+1.20.4-forge" = _mTBHoyKt;
        "pkg-1.8.9+1.20.2-neoforge" = _LlzHOYpI;
        "pkg-1.8.9+1.20.4-neoforge" = _zX4ttkYO;
        "pkg-1.9.0+1.16.5-fabric" = _VDHd3mp0;
        "pkg-1.9.0+1.17.1-fabric" = _3S3VzIZ2;
        "pkg-1.9.0+1.18.2-fabric" = _b9NmDZbU;
        "pkg-1.9.0+1.19.2-fabric" = _49oIRdWo;
        "pkg-1.9.0+1.19.3-fabric" = _BkTibWTW;
        "pkg-1.9.0+1.19.4-fabric" = _wyqp4fDR;
        "pkg-1.9.0+1.20.1-fabric" = _hfhkRLsY;
        "pkg-1.9.0+1.20.2-fabric" = _ohrCzigJ;
        "pkg-1.9.0+1.20.4-fabric" = _T9GmzLcE;
        "pkg-1.9.0+1.16.5-forge" = _hYeJu21V;
        "pkg-1.9.0+1.17.1-forge" = _99Az8pAA;
        "pkg-1.9.0+1.18.2-forge" = _LpumYDCV;
        "pkg-1.9.0+1.19.2-forge" = _Q9DOFCtz;
        "pkg-1.9.0+1.19.3-forge" = _oIUHGQjH;
        "pkg-1.9.0+1.19.4-forge" = _UqyJ8xnN;
        "pkg-1.9.0+1.20.1-forge" = _Sa99wt6N;
        "pkg-1.9.0+1.20.2-forge" = _b0CBoIjU;
        "pkg-1.9.0+1.20.4-forge" = _RKOXSpgr;
        "pkg-1.9.0+1.20.2-neoforge" = _Z8154dyF;
        "pkg-1.9.0+1.20.4-neoforge" = _b93jPZpN;
        "pkg-1.9.1+1.16.5-fabric" = _O2oEeSFq;
        "pkg-1.9.1+1.17.1-fabric" = _yN2gpDGV;
        "pkg-1.9.1+1.18.2-fabric" = _aZtWmjCA;
        "pkg-1.9.1+1.19.2-fabric" = _7Ae9xEFt;
        "pkg-1.9.1+1.19.3-fabric" = _lHbgbMMX;
        "pkg-1.9.1+1.19.4-fabric" = _c7gplw7c;
        "pkg-1.9.1+1.20.1-fabric" = _Rd3eNzki;
        "pkg-1.9.1+1.20.2-fabric" = _MbLHU4Ch;
        "pkg-1.9.1+1.20.4-fabric" = _U1S7MGiO;
        "pkg-1.9.1+1.16.5-forge" = _3n29Aqk8;
        "pkg-1.9.1+1.17.1-forge" = _CbVBtKFo;
        "pkg-1.9.1+1.18.2-forge" = _PZsD3rQ1;
        "pkg-1.9.1+1.19.2-forge" = _PWi3o0rN;
        "pkg-1.9.1+1.19.3-forge" = _dLQkFKO6;
        "pkg-1.9.1+1.19.4-forge" = _NtqzMKVw;
        "pkg-1.9.1+1.20.1-forge" = _gSpYmY9T;
        "pkg-1.9.1+1.20.2-forge" = _a5ifPdOz;
        "pkg-1.9.1+1.20.4-forge" = _N87Kvzpf;
        "pkg-1.9.1+1.20.2-neoforge" = _5IRbsQzb;
        "pkg-1.9.1+1.20.4-neoforge" = _eVX8xiT2;
        "pkg-1.9.2+1.16.5-fabric" = _sL7ef5AK;
        "pkg-1.9.2+1.17.1-fabric" = _IRk9nELa;
        "pkg-1.9.2+1.18.2-fabric" = _riK2Ekvu;
        "pkg-1.9.2+1.19.2-fabric" = _AA8PBy3F;
        "pkg-1.9.2+1.19.3-fabric" = _WB5PX3Pn;
        "pkg-1.9.2+1.19.4-fabric" = _8Pc3SoZo;
        "pkg-1.9.2+1.20.1-fabric" = _efh8D9sR;
        "pkg-1.9.2+1.20.2-fabric" = _Fusg2G4t;
        "pkg-1.9.2+1.20.4-fabric" = _DtrmaZB5;
        "pkg-1.9.2+1.16.5-forge" = _uOhgNQhS;
        "pkg-1.9.2+1.17.1-forge" = _PAQnboxp;
        "pkg-1.9.2+1.18.2-forge" = _nCcG9V8e;
        "pkg-1.9.2+1.19.2-forge" = _VekL8DkY;
        "pkg-1.9.2+1.19.3-forge" = _5qu79yht;
        "pkg-1.9.2+1.19.4-forge" = _wapgF7kR;
        "pkg-1.9.2+1.20.1-forge" = _OVrmzEkW;
        "pkg-1.9.2+1.20.2-forge" = _siX15nl3;
        "pkg-1.9.2+1.20.4-forge" = _IFFdU8kV;
        "pkg-1.9.2+1.20.2-neoforge" = _hNQbRMOO;
        "pkg-1.9.2+1.20.4-neoforge" = _IaRqVMuB;
        "pkg-1.9.3+1.16.5-fabric" = _DHkS0qho;
        "pkg-1.9.3+1.17.1-fabric" = _OiuBySgD;
        "pkg-1.9.3+1.18.2-fabric" = _fLr3S5Ln;
        "pkg-1.9.3+1.19.2-fabric" = _Hyl2MmNc;
        "pkg-1.9.3+1.19.3-fabric" = _Iq5pU8po;
        "pkg-1.9.3+1.19.4-fabric" = _Kjg9Wg7o;
        "pkg-1.9.3+1.20.1-fabric" = _E3vxQ5eJ;
        "pkg-1.9.3+1.20.2-fabric" = _EpEbaDc9;
        "pkg-1.9.3+1.20.4-fabric" = _jlHxOLya;
        "pkg-1.9.3+1.16.5-forge" = _KjKjPzMM;
        "pkg-1.9.3+1.17.1-forge" = _dKL7i6oW;
        "pkg-1.9.3+1.18.2-forge" = _9H6LKoOC;
        "pkg-1.9.3+1.19.2-forge" = _kmpsxybe;
        "pkg-1.9.3+1.19.3-forge" = _NiCOJIxS;
        "pkg-1.9.3+1.19.4-forge" = _dwGnhraI;
        "pkg-1.9.3+1.20.1-forge" = _h3lSyJ1N;
        "pkg-1.9.3+1.20.2-forge" = _Obsj8REu;
        "pkg-1.9.3+1.20.4-forge" = _ilJS53r7;
        "pkg-1.9.3+1.20.2-neoforge" = _NKv6opNx;
        "pkg-1.9.3+1.20.4-neoforge" = _ogRZUghK;
        "pkg-1.9.4+1.16.5-fabric" = _9WhcAvGQ;
        "pkg-1.9.4+1.17.1-fabric" = _CXTwL2PZ;
        "pkg-1.9.4+1.18.2-fabric" = _bGKpf7rz;
        "pkg-1.9.4+1.19.2-fabric" = _V2eRjXdx;
        "pkg-1.9.4+1.19.3-fabric" = _rg7cP17s;
        "pkg-1.9.4+1.19.4-fabric" = _sCYLq8Ns;
        "pkg-1.9.4+1.20.1-fabric" = _S59VwKIi;
        "pkg-1.9.4+1.20.2-fabric" = _QobJVSEG;
        "pkg-1.9.4+1.20.4-fabric" = _fxI1GzBE;
        "pkg-1.9.4+1.16.5-forge" = _JTrCjG3S;
        "pkg-1.9.4+1.17.1-forge" = _qUWo1GLi;
        "pkg-1.9.4+1.18.2-forge" = _Ga4JHtlC;
        "pkg-1.9.4+1.19.2-forge" = _sQsWSvCi;
        "pkg-1.9.4+1.19.3-forge" = _aoBycbWR;
        "pkg-1.9.4+1.19.4-forge" = _uojSnlRv;
        "pkg-1.9.4+1.20.1-forge" = _lCqD7EDt;
        "pkg-1.9.4+1.20.2-forge" = _1VGwqhz9;
        "pkg-1.9.4+1.20.4-forge" = _O6U62SZW;
        "pkg-1.9.4+1.20.2-neoforge" = _eL3kF37U;
        "pkg-1.9.4+1.20.4-neoforge" = _b1Jlf3KT;
        "pkg-1.9.5+1.16.5-fabric" = _TPKF1kTw;
        "pkg-1.9.5+1.17.1-fabric" = _mHxZAw98;
        "pkg-1.9.5+1.18.2-fabric" = _zW7Yb5eT;
        "pkg-1.9.5+1.19.2-fabric" = _lBb5enyi;
        "pkg-1.9.5+1.19.3-fabric" = _DtCKQE9J;
        "pkg-1.9.5+1.19.4-fabric" = _QZ0RUeUz;
        "pkg-1.9.5+1.20.1-fabric" = _z5c1RvhW;
        "pkg-1.9.5+1.20.2-fabric" = _K2H4oJ5X;
        "pkg-1.9.5+1.20.4-fabric" = _78pQVcRt;
        "pkg-1.9.5+1.16.5-forge" = _P3qJs0Fx;
        "pkg-1.9.5+1.17.1-forge" = _tIvlFnHt;
        "pkg-1.9.5+1.18.2-forge" = _UYaH5dco;
        "pkg-1.9.5+1.19.2-forge" = _BsAu5oBp;
        "pkg-1.9.5+1.19.3-forge" = _HdTz3qQk;
        "pkg-1.9.5+1.19.4-forge" = _WjzSQxuc;
        "pkg-1.9.5+1.20.1-forge" = _KxjjtDe4;
        "pkg-1.9.5+1.20.2-forge" = _4fJ4NFje;
        "pkg-1.9.5+1.20.4-forge" = _cIJLxKw8;
        "pkg-1.9.5+1.20.2-neoforge" = _JWZNrSGL;
        "pkg-1.9.5+1.20.4-neoforge" = _ryTgNdTw;
        "pkg-1.9.6+1.16.5-fabric" = _poGU8TDR;
        "pkg-1.9.6+1.17.1-fabric" = _j6LVWEV2;
        "pkg-1.9.6+1.18.2-fabric" = _NvlIPv75;
        "pkg-1.9.6+1.19.2-fabric" = _240zfqYH;
        "pkg-1.9.6+1.19.3-fabric" = _L70kIpNJ;
        "pkg-1.9.6+1.19.4-fabric" = _Pvq3kSMY;
        "pkg-1.9.6+1.20.1-fabric" = _7MMz2TRN;
        "pkg-1.9.6+1.20.2-fabric" = _QbeksZo4;
        "pkg-1.9.6+1.20.4-fabric" = _IN8Q62va;
        "pkg-1.9.6+1.16.5-forge" = _lxumJthq;
        "pkg-1.9.6+1.17.1-forge" = _RWNeQUML;
        "pkg-1.9.6+1.18.2-forge" = _BmL0Qjwr;
        "pkg-1.9.6+1.19.2-forge" = _ezfQbuaa;
        "pkg-1.9.6+1.19.4-forge" = _renGjmA4;
        "pkg-1.9.6+1.20.1-forge" = _qskKtGK4;
        "pkg-1.9.6+1.20.2-forge" = _yWd1ziXP;
        "pkg-1.9.6+1.20.4-forge" = _afKN18xd;
        "pkg-1.9.6+1.20.2-neoforge" = _kpPzmkD9;
        "pkg-1.9.6+1.20.4-neoforge" = _qOdICldQ;
        "pkg-2.0.0+1.16.5-fabric" = _tyadVatA;
        "pkg-2.0.0+1.18.2-fabric" = _10gGE5Ld;
        "pkg-2.0.0+1.19.2-fabric" = _InL5IUT6;
        "pkg-2.0.0+1.20.4-fabric" = _gNIqfHRS;
        "pkg-2.0.0+1.16.5-forge" = _XPsL1qmW;
        "pkg-2.0.0+1.18.2-forge" = _V3OhhTw9;
        "pkg-2.0.0+1.19.2-forge" = _DR6ljeA2;
        "pkg-2.0.0+1.20.1-forge" = _5r62uBw3;
        "pkg-2.0.0+1.20.4-forge" = _nbar2nVD;
        "pkg-2.0.1+1.16.5-fabric" = _d17CPJqZ;
        "pkg-2.0.1+1.18.2-fabric" = _aGQi4YrY;
        "pkg-2.0.1+1.19.2-fabric" = _O23SI7Ja;
        "pkg-2.0.1+1.20.1-fabric" = _rAxeA0kr;
        "pkg-2.0.1+1.20.4-fabric" = _2i63VaPY;
        "pkg-2.0.1+1.16.5-forge" = _UMgO2X1S;
        "pkg-2.0.1+1.18.2-forge" = _ys2EfaZy;
        "pkg-2.0.1+1.19.2-forge" = _5QQikAdR;
        "pkg-2.0.1+1.20.1-forge" = _c9ZAbOCT;
        "pkg-2.0.1+1.20.4-forge" = _MqZy3k9d;
        "pkg-2.0.1+1.20.4-neoforge" = _itnD4DYk;
        "pkg-2.0.2+1.16.5-fabric" = _1P2orpMg;
        "pkg-2.0.2+1.18.2-fabric" = _ORo7dMet;
        "pkg-2.0.2+1.19.2-fabric" = _wnM60Df4;
        "pkg-2.0.2+1.20.1-fabric" = _Z3s5YPce;
        "pkg-2.0.2+1.16.5-forge" = _51oBVqsP;
        "pkg-2.0.2+1.18.2-forge" = _K9vbICgq;
        "pkg-2.0.2+1.19.2-forge" = _DLTNrCyb;
        "pkg-2.0.2+1.20.1-forge" = _kSbnnqnN;
        "pkg-2.0.3+1.16.5-fabric" = _Jmp5QS2q;
        "pkg-2.0.3+1.18.2-fabric" = _xcKUBcqR;
        "pkg-2.0.3+1.19.2-fabric" = _lUvMwiI9;
        "pkg-2.0.3+1.20.1-fabric" = _4ubnMDha;
        "pkg-2.0.3+1.20.4-fabric" = _KNayGgOR;
        "pkg-2.0.3+1.16.5-forge" = _p7TXHsGj;
        "pkg-2.0.3+1.18.2-forge" = _cgHtQXZQ;
        "pkg-2.0.3+1.19.2-forge" = _EE8h07lR;
        "pkg-2.0.3+1.20.1-forge" = _ItbXcezM;
        "pkg-2.0.3+1.20.4-forge" = _uL8gPifF;
        "pkg-2.0.3+1.20.4-neoforge" = _TvHDXQkv;
        "pkg-2.0.4+1.16.5-fabric" = _zXvh33wi;
        "pkg-2.0.4+1.18.2-fabric" = _3hHTzBwF;
        "pkg-2.0.4+1.19.2-fabric" = _GgT7AeV6;
        "pkg-2.0.4+1.20.1-fabric" = _B648z70d;
        "pkg-2.0.4+1.20.4-fabric" = _DjK3FJev;
        "pkg-2.0.4+1.16.5-forge" = _7qPfJChs;
        "pkg-2.0.4+1.18.2-forge" = _KSZpPRCj;
        "pkg-2.0.4+1.19.2-forge" = _7mwud5Lk;
        "pkg-2.0.4+1.20.1-forge" = _nQNnJeY5;
        "pkg-2.0.4+1.20.4-forge" = _E9AgpX3N;
        "pkg-2.0.4+1.20.4-neoforge" = _tPbaLHJ8;
        "pkg-2.0.5+1.16.5-fabric" = _ejWgwad1;
        "pkg-2.0.5+1.18.2-fabric" = _66UknM83;
        "pkg-2.0.5+1.19.2-fabric" = _CCr8tWlh;
        "pkg-2.0.5+1.20.1-fabric" = _R9PQImTw;
        "pkg-2.0.5+1.20.4-fabric" = _mbXnHfMJ;
        "pkg-2.0.5+1.16.5-forge" = _k5SXDDdY;
        "pkg-2.0.5+1.18.2-forge" = _YmGuUWNT;
        "pkg-2.0.5+1.19.2-forge" = _UXJg0Ies;
        "pkg-2.0.5+1.20.1-forge" = _F5xjghhm;
        "pkg-2.0.5+1.20.4-forge" = _ABGBwPqa;
        "pkg-2.0.5+1.20.4-neoforge" = _i5GTBB5m;
        "pkg-2.0.6+1.16.5-fabric" = _gl3e3EId;
        "pkg-2.0.6+1.18.2-fabric" = _BJW7dykL;
        "pkg-2.0.6+1.19.2-fabric" = _DS5c5XX0;
        "pkg-2.0.6+1.20.1-fabric" = _oFjEKF7a;
        "pkg-2.0.6+1.20.4-fabric" = _W7glHuil;
        "pkg-2.0.6+1.16.5-forge" = _axy1XnDv;
        "pkg-2.0.6+1.18.2-forge" = _XkBzZPgG;
        "pkg-2.0.6+1.19.2-forge" = _bCq0JST7;
        "pkg-2.0.6+1.20.1-forge" = _CwD2ATRL;
        "pkg-2.0.6+1.20.4-forge" = _DlZMKTNe;
        "pkg-2.0.6+1.20.4-neoforge" = _Qz083JJu;
        "pkg-2.0.7+1.16.5-fabric" = _lX7RuAuz;
        "pkg-2.0.7+1.18.2-fabric" = _zl9LJY4q;
        "pkg-2.0.7+1.19.2-fabric" = _jCkP8BqW;
        "pkg-2.0.7+1.20.1-fabric" = _GbtdOWyu;
        "pkg-2.0.7+1.20.4-fabric" = _vSslPqBR;
        "pkg-2.0.7+1.16.5-forge" = _A1WG575T;
        "pkg-2.0.7+1.18.2-forge" = _NLrhxnaH;
        "pkg-2.0.7+1.19.2-forge" = _3JbYH35y;
        "pkg-2.0.7+1.20.1-forge" = _rABoncTa;
        "pkg-2.0.7+1.20.4-forge" = _oOs5Gy6e;
        "pkg-2.0.7+1.20.4-neoforge" = _bsFCXnul;
        "pkg-2.0.8+1.18.2-fabric" = _urgGlyMP;
        "pkg-2.0.8+1.19.2-fabric" = _j997x41G;
        "pkg-2.0.8+1.20.1-fabric" = _Sq1JlImv;
        "pkg-2.0.8+1.20.4-fabric" = _MhqU9eaN;
        "pkg-2.0.8+1.18.2-forge" = _pSviEwfl;
        "pkg-2.0.8+1.19.2-forge" = _mMDkM03B;
        "pkg-2.0.8+1.20.1-forge" = _vy58CdT5;
        "pkg-2.0.8+1.20.4-forge" = _ynI8RDUs;
        "pkg-2.0.8+1.20.4-neoforge" = _cad6d6xO;
        "pkg-2.0.8+1.16.5-fabric" = _2sQFSyRL;
        "pkg-2.0.8+1.16.5-forge" = _HW0WmVzc;
        "pkg-2.0.9+1.16.5-fabric" = _nY0PvQ2H;
        "pkg-2.0.9+1.18.2-fabric" = _fLwK9SWq;
        "pkg-2.0.9+1.19.2-fabric" = _cX3hwqyt;
        "pkg-2.0.9+1.20.1-fabric" = _7JqMSykB;
        "pkg-2.0.9+1.20.4-fabric" = _DCG6Wens;
        "pkg-2.0.9+1.16.5-forge" = _fJUwPaIm;
        "pkg-2.0.9+1.18.2-forge" = _hZahfgb5;
        "pkg-2.0.9+1.19.2-forge" = _BfqD85gE;
        "pkg-2.0.9+1.20.1-forge" = _Xupc5Dr0;
        "pkg-2.0.9+1.20.4-forge" = _obePNpkp;
        "pkg-2.0.9+1.20.4-neoforge" = _mEx27sJt;
        "pkg-2.1.0+1.16.5-fabric" = _8iVCaNNQ;
        "pkg-2.1.0+1.18.2-fabric" = _HQ9oo14g;
        "pkg-2.1.0+1.19.2-fabric" = _ONoAFfM4;
        "pkg-2.1.0+1.20.1-fabric" = _GxBIJklv;
        "pkg-2.1.0+1.20.4-fabric" = _6pI7LFdN;
        "pkg-2.1.0+1.16.5-forge" = _POrmSr6A;
        "pkg-2.1.0+1.18.2-forge" = _SF3RAmhj;
        "pkg-2.1.0+1.19.2-forge" = _rQutPiK8;
        "pkg-2.1.0+1.20.1-forge" = _nbET6eKQ;
        "pkg-2.1.0+1.20.4-forge" = _i5zZ01cH;
        "pkg-2.1.0+1.20.4-neoforge" = _5V81SS4v;
        "pkg-2.1.1+1.16.5-fabric" = _i7H8I0Eq;
        "pkg-2.1.1+1.18.2-fabric" = _Ug1SyprP;
        "pkg-2.1.1+1.19.2-fabric" = _hWg1usgI;
        "pkg-2.1.1+1.20.1-fabric" = _7J1nzYhP;
        "pkg-2.1.1+1.20.4-fabric" = _dyGEwMFl;
        "pkg-2.1.1+1.16.5-forge" = _p5CC5MV0;
        "pkg-2.1.1+1.18.2-forge" = _v47m13ZW;
        "pkg-2.1.1+1.19.2-forge" = _lTdB23ep;
        "pkg-2.1.1+1.20.1-forge" = _3Gdzemkd;
        "pkg-2.1.1+1.20.4-forge" = _gZnNKIER;
        "pkg-2.1.1+1.20.4-neoforge" = _o5QO5gtV;
        "pkg-2.1.2+1.16.5-fabric" = _SR1XMDKE;
        "pkg-2.1.2+1.18.2-fabric" = _cZ2iMXIT;
        "pkg-2.1.2+1.19.2-fabric" = _5US6g3ms;
        "pkg-2.1.2+1.20.1-fabric" = _FGYvWGVS;
        "pkg-2.1.2+1.20.4-fabric" = _FApIzAuU;
        "pkg-2.1.2+1.16.5-forge" = _rPpI3rwQ;
        "pkg-2.1.2+1.18.2-forge" = _7pZRcdPA;
        "pkg-2.1.2+1.19.2-forge" = _TS4ROd4P;
        "pkg-2.1.2+1.20.1-forge" = _qv9srdMQ;
        "pkg-2.1.2+1.20.4-forge" = _mvjmY5eL;
        "pkg-2.1.2+1.20.4-neoforge" = _zQxAZBZH;
        "pkg-2.1.3+1.18.2-fabric" = _3hloGu6A;
        "pkg-2.1.3+1.19.2-fabric" = _zFxYuI4P;
        "pkg-2.1.3+1.20.1-fabric" = _HPDyQD1K;
        "pkg-2.1.3+1.20.4-fabric" = _s0tKz88F;
        "pkg-2.1.3+1.16.5-forge" = _bhRssWUl;
        "pkg-2.1.3+1.18.2-forge" = _HgXgNYcq;
        "pkg-2.1.3+1.19.2-forge" = _Msgd8au7;
        "pkg-2.1.3+1.20.1-forge" = _4B0c4s9h;
        "pkg-2.1.3+1.20.4-forge" = _hMz3Xegq;
        "pkg-2.1.3+1.20.4-neoforge" = _1A69nK6B;
        "pkg-2.1.4+1.16.5-fabric" = _umISTsWi;
        "pkg-2.1.4+1.18.2-fabric" = _VJGo2VmK;
        "pkg-2.1.4+1.19.2-fabric" = _cOMdHlV3;
        "pkg-2.1.4+1.20.1-fabric" = _kIYxwJaN;
        "pkg-2.1.4+1.20.4-fabric" = _zPtnot0b;
        "pkg-2.1.4+1.16.5-forge" = _pvP8kUeK;
        "pkg-2.1.4+1.18.2-forge" = _BifSCSF1;
        "pkg-2.1.4+1.19.2-forge" = _6niynV8N;
        "pkg-2.1.4+1.20.1-forge" = _juFYhJz5;
        "pkg-2.1.4+1.20.4-forge" = _KtK096AO;
        "pkg-2.1.4+1.20.4-neoforge" = _zg2WBQQn;
        "pkg-2.1.5+1.16.5-fabric" = _wERPbL0R;
        "pkg-2.1.5+1.18.2-fabric" = _2JlBD4AH;
        "pkg-2.1.5+1.19.2-fabric" = _fWC9qHQT;
        "pkg-2.1.5+1.20.1-fabric" = _CshH8Y6t;
        "pkg-2.1.5+1.20.4-fabric" = _i9i0DcE6;
        "pkg-2.1.5+1.16.5-forge" = _ti85SqXc;
        "pkg-2.1.5+1.18.2-forge" = _OjI7qSdH;
        "pkg-2.1.5+1.19.2-forge" = _DemkjYxW;
        "pkg-2.1.5+1.20.1-forge" = _JiTmgy30;
        "pkg-2.1.5+1.20.4-forge" = _C3L9EpVX;
        "pkg-2.1.5+1.20.4-neoforge" = _Us39OENM;
        "pkg-2.1.6+1.16.5-fabric" = _M40NNMPc;
        "pkg-2.1.6+1.18.2-fabric" = _je44IjbG;
        "pkg-2.1.6+1.19.2-fabric" = _7kUMGxsa;
        "pkg-2.1.6+1.20.1-fabric" = _bsI8bt3R;
        "pkg-2.1.6+1.20.4-fabric" = _MD4JkrAM;
        "pkg-2.1.6+1.16.5-forge" = _Fa303TpU;
        "pkg-2.1.6+1.18.2-forge" = _ASBj2QMQ;
        "pkg-2.1.6+1.19.2-forge" = _yGRRG1EB;
        "pkg-2.1.6+1.20.1-forge" = _wWME7VU1;
        "pkg-2.1.6+1.20.4-forge" = _npgeg2Ey;
        "pkg-2.1.6+1.20.4-neoforge" = _jGUQjJB6;
        "pkg-2.1.7+1.16.5-fabric" = _z5O2XxpJ;
        "pkg-2.1.7+1.18.2-fabric" = _rUsjz0Q4;
        "pkg-2.1.7+1.19.2-fabric" = _B3ds6oPV;
        "pkg-2.1.7+1.20.1-fabric" = _U2O41tFc;
        "pkg-2.1.7+1.20.4-fabric" = _AbKkEugS;
        "pkg-2.1.7+1.16.5-forge" = _1G9Xwepx;
        "pkg-2.1.7+1.18.2-forge" = _iRv69Q7q;
        "pkg-2.1.7+1.19.2-forge" = _bmJa1hML;
        "pkg-2.1.7+1.20.1-forge" = _pNd1siHH;
        "pkg-2.1.7+1.20.4-forge" = _uaqw121P;
        "pkg-2.1.7+1.20.4-neoforge" = _INxmEH95;
        "pkg-2.1.8+1.18.2-fabric" = _rUvgpxIu;
        "pkg-2.1.8+1.19.2-fabric" = _YjjhYjBU;
        "pkg-2.1.8+1.20.1-fabric" = _nqtGeItg;
        "pkg-2.1.8+1.20.4-fabric" = _x7Pl7OAq;
        "pkg-2.1.8+1.18.2-forge" = _rYm0Oh19;
        "pkg-2.1.8+1.19.2-forge" = _vtAe1mig;
        "pkg-2.1.8+1.20.1-forge" = _539yk94j;
        "pkg-2.1.8+1.20.4-forge" = _m7WRMX6l;
        "pkg-2.1.8+1.20.4-neoforge" = _Ux1eBraD;
        "pkg-2.1.8+1.16.5-fabric" = _r4P2ONFW;
        "pkg-2.1.8+1.16.5-forge" = _9f09Acvm;
        "pkg-2.1.9+1.16.5-fabric" = _izj1700T;
        "pkg-2.1.9+1.18.2-fabric" = _d4Wo54jX;
        "pkg-2.1.9+1.19.2-fabric" = _Uch2N075;
        "pkg-2.1.9+1.20.1-fabric" = _Y4UV79ra;
        "pkg-2.1.9+1.20.4-fabric" = _8e6Chymb;
        "pkg-2.1.9+1.16.5-forge" = _X8kmjYY4;
        "pkg-2.1.9+1.18.2-forge" = _IMinLbhF;
        "pkg-2.1.9+1.19.2-forge" = _2pdPIUGT;
        "pkg-2.1.9+1.20.1-forge" = _7ZFKlyrf;
        "pkg-2.1.9+1.20.4-forge" = _Uz1qRaWc;
        "pkg-2.1.9+1.20.4-neoforge" = _QsQpy0AZ;
        "pkg-2.2.0+1.16.5-fabric" = _bwSlJ9SC;
        "pkg-2.2.0+1.18.2-fabric" = _Tr2hZW3t;
        "pkg-2.2.0+1.19.2-fabric" = _8j660mwF;
        "pkg-2.2.0+1.20.1-fabric" = _X2umCEsn;
        "pkg-2.2.0+1.20.4-fabric" = _VOQ5yC7p;
        "pkg-2.2.0+1.16.5-forge" = _qF9B037z;
        "pkg-2.2.0+1.18.2-forge" = _ujwn9rBs;
        "pkg-2.2.0+1.19.2-forge" = _HjloW9Up;
        "pkg-2.2.0+1.20.1-forge" = _P0PsYcbN;
        "pkg-2.2.0+1.20.4-forge" = _RMFZQoHF;
        "pkg-2.2.0+1.20.4-neoforge" = _72QzOGVs;
        "pkg-2.2.1+1.16.5-fabric" = _sDdoK5mC;
        "pkg-2.2.1+1.18.2-fabric" = _5Y8HZqOy;
        "pkg-2.2.1+1.19.2-fabric" = _CJLxAClU;
        "pkg-2.2.1+1.20.1-fabric" = _AJNoCvn5;
        "pkg-2.2.1+1.20.4-fabric" = _vGzA4s3h;
        "pkg-2.2.1+1.16.5-forge" = _PdYUGe8d;
        "pkg-2.2.1+1.18.2-forge" = _5kYnc2Sv;
        "pkg-2.2.1+1.19.2-forge" = _h9rn2Z37;
        "pkg-2.2.1+1.20.1-forge" = _3yXlJ2Ko;
        "pkg-2.2.1+1.20.4-forge" = _tuog2jf4;
        "pkg-2.2.1+1.20.4-neoforge" = _vEMCM7zu;
        "pkg-2.2.2+1.16.5-fabric" = _8Un9SgzG;
        "pkg-2.2.2+1.18.2-fabric" = _3ny4NsXX;
        "pkg-2.2.2+1.19.2-fabric" = _1hDk6SbT;
        "pkg-2.2.2+1.20.1-fabric" = _Ll3VhzMf;
        "pkg-2.2.2+1.20.4-fabric" = _IrEhehnV;
        "pkg-2.2.2+1.16.5-forge" = _ItLi5MyZ;
        "pkg-2.2.2+1.18.2-forge" = _cEqF5Vfg;
        "pkg-2.2.2+1.19.2-forge" = _nRr4j4rv;
        "pkg-2.2.2+1.20.1-forge" = _7K1V958P;
        "pkg-2.2.2+1.20.4-forge" = _OZNSeL3Y;
        "pkg-2.2.2+1.20.4-neoforge" = _6yE6pkmn;
        "pkg-2.2.3+1.16.5-fabric" = _YZiXbVsS;
        "pkg-2.2.3+1.19.2-fabric" = _Qqpzp1eT;
        "pkg-2.2.3+1.20.1-fabric" = _ol68t1bd;
        "pkg-2.2.3+1.20.4-fabric" = _nkUvVHY6;
        "pkg-2.2.3+1.16.5-forge" = _PAyAULE0;
        "pkg-2.2.3+1.19.2-forge" = _8s2S2xa5;
        "pkg-2.2.3+1.20.1-forge" = _vaa3AhZq;
        "pkg-2.2.3+1.20.4-forge" = _2AhybMrJ;
        "pkg-2.2.3+1.20.4-neoforge" = _QtBUDb5f;
        "pkg-2.2.3+1.18.2-fabric" = _X0aBoS13;
        "pkg-2.2.3+1.18.2-forge" = _Ud8VPqJ8;
        "pkg-2.2.4+1.16.5-fabric" = _a09miyPG;
        "pkg-2.2.4+1.18.2-fabric" = _IwBk7xla;
        "pkg-2.2.4+1.19.2-fabric" = _LRODhqZK;
        "pkg-2.2.4+1.20.1-fabric" = _Qv2qr9J9;
        "pkg-2.2.4+1.20.4-fabric" = _mcuUawwb;
        "pkg-2.2.4+1.16.5-forge" = _nVi7adfq;
        "pkg-2.2.4+1.18.2-forge" = _XFkStaNp;
        "pkg-2.2.4+1.19.2-forge" = _GtgwlKrj;
        "pkg-2.2.4+1.20.1-forge" = _idzrMFkv;
        "pkg-2.2.4+1.20.4-forge" = _HCEAdBRt;
        "pkg-2.2.4+1.20.4-neoforge" = _kzKCRq3j;
        "pkg-2.2.7+1.16.5-fabric" = _chbyc9lk;
        "pkg-2.2.7+1.18.2-fabric" = _lHCEoKLG;
        "pkg-2.2.7+1.19.2-fabric" = _1jN6F3qb;
        "pkg-2.2.7+1.20.1-fabric" = _lV32L8UL;
        "pkg-2.2.7+1.20.6-fabric" = _Hwu6YKOK;
        "pkg-2.2.7+1.21-fabric" = _VbFSQmFi;
        "pkg-2.2.7+1.16.5-forge" = _h3oaRAAz;
        "pkg-2.2.7+1.18.2-forge" = _OTze7I7Q;
        "pkg-2.2.7+1.19.2-forge" = _VrWtEehe;
        "pkg-2.2.7+1.20.1-forge" = _9G0SBshm;
        "pkg-2.2.8+1.16.5-fabric" = _2zYOtvub;
        "pkg-2.2.8+1.18.2-fabric" = _1mphgVB3;
        "pkg-2.2.8+1.19.2-fabric" = _qtZynb49;
        "pkg-2.2.8+1.20.1-fabric" = _8ZSQFx0K;
        "pkg-2.2.8+1.20.4-fabric" = _KJCBYxjV;
        "pkg-2.2.8+1.20.6-fabric" = _tYujFffg;
        "pkg-2.2.8+1.21-fabric" = _FbLk9pt0;
        "pkg-2.2.8+1.16.5-forge" = _VZzbYrPx;
        "pkg-2.2.8+1.18.2-forge" = _jqEtDBzV;
        "pkg-2.2.8+1.19.2-forge" = _6JbTCB3X;
        "pkg-2.2.8+1.20.1-forge" = _cPG7J8bM;
        "pkg-2.2.8+1.20.4-forge" = _LiGuFwBc;
        "pkg-2.2.8+1.20.4-neoforge" = _9BqiGmn3;
        "pkg-2.2.9+1.16.5-fabric" = _AH1Den07;
        "pkg-2.2.9+1.18.2-fabric" = _PPiDkNW1;
        "pkg-2.2.9+1.19.2-fabric" = _EDq4354U;
        "pkg-2.2.9+1.20.1-fabric" = _ToFcg7au;
        "pkg-2.2.9+1.20.4-fabric" = _zktGztmJ;
        "pkg-2.2.9+1.20.6-fabric" = _WB5Izolo;
        "pkg-2.2.9+1.21-fabric" = _JAbOnhun;
        "pkg-2.2.9+1.16.5-forge" = _Ea9T02aq;
        "pkg-2.2.9+1.18.2-forge" = _xWHdnhC7;
        "pkg-2.2.9+1.19.2-forge" = _alLOlYbM;
        "pkg-2.2.9+1.20.1-forge" = _nyxzMmQW;
        "pkg-2.2.9+1.20.4-forge" = _NKJmtLpJ;
        "pkg-2.2.9+1.20.4-neoforge" = _9oC0FgDi;
        "pkg-2.2.9+1.21-neoforge" = _i0iBc1DZ;
        "pkg-2.3.0+1.20.4-fabric" = _QiuqmAcA;
        "pkg-2.3.0+1.20.6-fabric" = _S3P5jj7E;
        "pkg-2.3.0+1.21-fabric" = _2o6N0kl4;
        "pkg-2.3.0+1.20.4-forge" = _wiLovsnc;
        "pkg-2.3.0+1.20.4-neoforge" = _IdkynbB5;
        "pkg-2.3.0+1.20.6-neoforge" = _31lHwbPf;
        "pkg-2.3.0+1.21-neoforge" = _VUJN3JXQ;
        "pkg-2.3.1+1.16.5-fabric" = _yVHOmsKk;
        "pkg-2.3.1+1.18.2-fabric" = _O053kFiw;
        "pkg-2.3.1+1.20.1-fabric" = _zlLN9nwA;
        "pkg-2.3.1+1.20.4-fabric" = _e6nOe4vu;
        "pkg-2.3.1+1.20.6-fabric" = _Aa1PQqZ8;
        "pkg-2.3.1+1.21-fabric" = _QPI9raPp;
        "pkg-2.3.1+1.16.5-forge" = _BACAZsup;
        "pkg-2.3.1+1.18.2-forge" = _EBf4ayOd;
        "pkg-2.3.1+1.20.1-forge" = _p5ZnspQc;
        "pkg-2.3.1+1.20.4-forge" = _4bPMg2jO;
        "pkg-2.3.1+1.20.4-neoforge" = _ew6R7LmC;
        "pkg-2.3.1+1.20.6-neoforge" = _eIuKxbm6;
        "pkg-2.3.1+1.21-neoforge" = _JjCNkgb9;
        "pkg-2.3.2+1.16.5-fabric" = _nye9LFc0;
        "pkg-2.3.2+1.18.2-fabric" = _XXycgCaC;
        "pkg-2.3.2+1.20.1-fabric" = _LnNkinbm;
        "pkg-2.3.2+1.20.4-fabric" = _M7Ksstvc;
        "pkg-2.3.2+1.20.6-fabric" = _SMjcW6uQ;
        "pkg-2.3.2+1.21-fabric" = _GGYA9oGy;
        "pkg-2.3.2+1.16.5-forge" = _4HDcAZyS;
        "pkg-2.3.2+1.18.2-forge" = _ZzW1rJwj;
        "pkg-2.3.2+1.20.1-forge" = _aqYNdkEC;
        "pkg-2.3.2+1.20.4-forge" = _MKETijei;
        "pkg-2.3.2+1.20.4-neoforge" = _B0p9QY6g;
        "pkg-2.3.2+1.20.6-neoforge" = _Cu6sTi62;
        "pkg-2.3.2+1.21-neoforge" = _VFCGPCuH;
        "pkg-2.3.2+1.19.2-fabric" = _Rfv3RDzc;
        "pkg-2.3.2+1.19.2-forge" = _Kd7E19np;
        "pkg-2.3.2-fix.1+1.16.5-fabric" = _ARSqzQBU;
        "pkg-2.3.2-fix.1+1.18.2-fabric" = _Lkssi4c0;
        "pkg-2.3.2-fix.1+1.19.2-fabric" = _sD82yhq5;
        "pkg-2.3.2-fix.1+1.20.1-fabric" = _ndQG05qU;
        "pkg-2.3.2-fix.1+1.20.4-fabric" = _QQPidkCK;
        "pkg-2.3.2-fix.1+1.16.5-forge" = _nVqk3Q7B;
        "pkg-2.3.2-fix.1+1.18.2-forge" = _Gi9RWFRv;
        "pkg-2.3.2-fix.1+1.19.2-forge" = _6FX55082;
        "pkg-2.3.2-fix.1+1.20.1-forge" = _JD2yoKIS;
        "pkg-2.3.2-fix.1+1.20.4-forge" = _bhXoTePG;
        "pkg-2.3.2-fix.1+1.20.4-neoforge" = _sWPcAFP2;
        "pkg-2.3.2-fix.1+1.21-fabric" = _rkav4uxO;
        "pkg-2.3.2-fix.1+1.21-neoforge" = _xrUJLo9Z;
        "pkg-2.3.2-fix.1+1.20.6-fabric" = _Wko1UUzk;
        "pkg-2.3.2-fix.1+1.20.6-neoforge" = _z1inWKQi;
        "pkg-2.3.3+1.16.5-fabric" = _6riC1g61;
        "pkg-2.3.3+1.18.2-fabric" = _EtNvYbtb;
        "pkg-2.3.3+1.19.2-fabric" = _9mdOL3vJ;
        "pkg-2.3.3+1.20.1-fabric" = _T3C6gZIa;
        "pkg-2.3.3+1.20.4-fabric" = _9BLv7Jio;
        "pkg-2.3.3+1.21-fabric" = _EHeuE0nu;
        "pkg-2.3.3+1.16.5-forge" = _lu7R4bOi;
        "pkg-2.3.3+1.18.2-forge" = _n0k1fcLV;
        "pkg-2.3.3+1.19.2-forge" = _xPh1ZAg6;
        "pkg-2.3.3+1.20.1-forge" = _36B8gfdJ;
        "pkg-2.3.3+1.20.4-forge" = _yOpPoZOw;
        "pkg-2.3.3+1.20.4-neoforge" = _F8PyFoyL;
        "pkg-2.3.3+1.21-neoforge" = _q0ufM5cv;
        "pkg-2.3.3-fix.1+1.21-fabric" = _nEvPn6MD;
        "pkg-2.3.3-fix.1+1.21-neoforge" = _tiE5wppP;
        "pkg-2.3.4+1.16.5-fabric" = _xo5nL9oA;
        "pkg-2.3.4+1.18.2-fabric" = _F4APl6Gq;
        "pkg-2.3.4+1.19.2-fabric" = _Xc56g1lO;
        "pkg-2.3.4+1.20.1-fabric" = _CPAUtCyn;
        "pkg-2.3.4+1.20.4-fabric" = _rds05QYD;
        "pkg-2.3.4+1.21-fabric" = _yeCNzU6P;
        "pkg-2.3.4+1.16.5-forge" = _NiHuehyH;
        "pkg-2.3.4+1.18.2-forge" = _8OZ0x77a;
        "pkg-2.3.4+1.19.2-forge" = _BC39m9Ot;
        "pkg-2.3.4+1.20.1-forge" = _Moyp9C8n;
        "pkg-2.3.4+1.20.4-forge" = _EBoleZbc;
        "pkg-2.3.4+1.20.4-neoforge" = _G16fl3sr;
        "pkg-2.3.4+1.21-neoforge" = _ppwsXjOl;
        "pkg-2.3.5+1.16.5-fabric" = _GjvZk8BE;
        "pkg-2.3.5+1.18.2-fabric" = _UNaCH7Bn;
        "pkg-2.3.5+1.19.2-fabric" = _lKpNXgHx;
        "pkg-2.3.5+1.20.1-fabric" = _xC6zQjjr;
        "pkg-2.3.5+1.20.4-fabric" = _f5OkJWhK;
        "pkg-2.3.5+1.21-fabric" = _jHH6SUkK;
        "pkg-2.3.5+1.16.5-forge" = _JafiLaLh;
        "pkg-2.3.5+1.18.2-forge" = _zJZgwdUs;
        "pkg-2.3.5+1.19.2-forge" = _FR6Knyhu;
        "pkg-2.3.5+1.20.1-forge" = _OUAffi3t;
        "pkg-2.3.5+1.20.4-forge" = _VY5Tclkg;
        "pkg-2.3.5+1.20.4-neoforge" = _zWLguhB0;
        "pkg-2.3.5+1.21-neoforge" = _68zmsYF0;
        "pkg-2.3.6+1.16.5-fabric" = _xwAArgfU;
        "pkg-2.3.6+1.18.2-fabric" = _f8WHuBcs;
        "pkg-2.3.6+1.19.2-fabric" = _Ti3UHUo9;
        "pkg-2.3.6+1.20.1-fabric" = _tV8Daitb;
        "pkg-2.3.6+1.20.4-fabric" = _b9fnQcGO;
        "pkg-2.3.6+1.21-fabric" = _rAIBnCrz;
        "pkg-2.3.6+1.16.5-forge" = _XEekhsv8;
        "pkg-2.3.6+1.18.2-forge" = _yM06hd5H;
        "pkg-2.3.6+1.19.2-forge" = _v7FTGlKh;
        "pkg-2.3.6+1.20.1-forge" = _1diCJwPk;
        "pkg-2.3.6+1.20.4-forge" = _sLRiUBDw;
        "pkg-2.3.6+1.20.4-neoforge" = _k4CeEyFN;
        "pkg-2.3.6+1.21-neoforge" = _tLKdQFtV;
        "pkg-2.3.7+1.16.5-fabric" = _Ng3ZA6o0;
        "pkg-2.3.7+1.18.2-fabric" = _yvaZkK1P;
        "pkg-2.3.7+1.19.2-fabric" = _QYY305Q8;
        "pkg-2.3.7+1.20.1-fabric" = _N8vpnlYX;
        "pkg-2.3.7+1.20.4-fabric" = _kaBuKXwc;
        "pkg-2.3.7+1.21-fabric" = _YTTr7NeS;
        "pkg-2.3.7+1.16.5-forge" = _agZ0TTfn;
        "pkg-2.3.7+1.18.2-forge" = _ilnlUNeD;
        "pkg-2.3.7+1.19.2-forge" = _cUJs1s2l;
        "pkg-2.3.7+1.20.1-forge" = _ncEY4G66;
        "pkg-2.3.7+1.20.4-forge" = _y6rgQx91;
        "pkg-2.3.7+1.20.4-neoforge" = _EZv2jPbJ;
        "pkg-2.3.7+1.21-neoforge" = _cFqJO0T6;
        "pkg-2.3.8+1.16.5-fabric" = _wmvvSSaG;
        "pkg-2.3.8+1.18.2-fabric" = _iUVLRc7A;
        "pkg-2.3.8+1.19.2-fabric" = _BRL4gnMt;
        "pkg-2.3.8+1.20.1-fabric" = _ZXrX6Lk3;
        "pkg-2.3.8+1.20.4-fabric" = _Q1SVuHSK;
        "pkg-2.3.8+1.21-fabric" = _S680JxUZ;
        "pkg-2.3.8+1.16.5-forge" = _YOPptDIX;
        "pkg-2.3.8+1.18.2-forge" = _zFIiIrxn;
        "pkg-2.3.8+1.19.2-forge" = _Vhn2BjRr;
        "pkg-2.3.8+1.20.1-forge" = _nyVTa08q;
        "pkg-2.3.8+1.20.4-forge" = _adrKqixT;
        "pkg-2.3.8+1.20.4-neoforge" = _UtbHHVIo;
        "pkg-2.3.8+1.21-neoforge" = _7NMGjDie;
        "pkg-2.3.8-fix.1+1.21-fabric" = _20W9a6NC;
        "pkg-2.3.8-fix.1+1.21-neoforge" = _YvPXhgAI;
        "pkg-2.3.9+1.16.5-fabric" = _PReZu4HU;
        "pkg-2.3.9+1.18.2-fabric" = _GZliTgbJ;
        "pkg-2.3.9+1.19.2-fabric" = _btR1ylsK;
        "pkg-2.3.9+1.20.1-fabric" = _47UbBQVe;
        "pkg-2.3.9+1.20.4-fabric" = _bGDeyGQo;
        "pkg-2.3.9+1.21-fabric" = _1l1tofeE;
        "pkg-2.3.9+1.16.5-forge" = _Tpu59dOO;
        "pkg-2.3.9+1.18.2-forge" = _txxybQvM;
        "pkg-2.3.9+1.19.2-forge" = _LvxTE1Qw;
        "pkg-2.3.9+1.20.1-forge" = _CjnIkYH3;
        "pkg-2.3.9+1.20.4-forge" = _WfwcNnlQ;
        "pkg-2.3.9+1.20.4-neoforge" = _yQ6XoqBj;
        "pkg-2.3.9+1.21-neoforge" = _94OLMLza;
        "pkg-2.4.0+1.16.5-fabric" = _yBCm9wlQ;
        "pkg-2.4.0+1.18.2-fabric" = _iO3iPXuR;
        "pkg-2.4.0+1.19.2-fabric" = _BZG00MMW;
        "pkg-2.4.0+1.20.1-fabric" = _wRrj0AV1;
        "pkg-2.4.0+1.20.4-fabric" = _oTngWd2r;
        "pkg-2.4.0+1.21-fabric" = _1EDYYC1O;
        "pkg-2.4.0+1.16.5-forge" = _Wuo7ndHg;
        "pkg-2.4.0+1.18.2-forge" = _1VK8JXUH;
        "pkg-2.4.0+1.19.2-forge" = _MKOuHeDf;
        "pkg-2.4.0+1.20.1-forge" = _QI2sAVNy;
        "pkg-2.4.0+1.20.4-forge" = _f3PnNfNF;
        "pkg-2.4.0+1.20.4-neoforge" = _UKPpm40O;
        "pkg-2.4.0+1.21-neoforge" = _KY748rOv;
        "pkg-2.4.1+1.16.5-fabric" = _xkIAO7en;
        "pkg-2.4.1+1.18.2-fabric" = _KEkepRpc;
        "pkg-2.4.1+1.19.2-fabric" = _AWxEH9r5;
        "pkg-2.4.1+1.20.1-fabric" = _ShHOWYcs;
        "pkg-2.4.1+1.20.4-fabric" = _ATn09YSK;
        "pkg-2.4.1+1.21-fabric" = _83dZ4Juh;
        "pkg-2.4.1+1.16.5-forge" = _WhXwcCzv;
        "pkg-2.4.1+1.18.2-forge" = _5qXLUdXA;
        "pkg-2.4.1+1.19.2-forge" = _3z19mtMC;
        "pkg-2.4.1+1.20.1-forge" = _fvRlLiRF;
        "pkg-2.4.1+1.20.4-forge" = _DNBAeK5A;
        "pkg-2.4.1+1.20.4-neoforge" = _Q8ZTKZD6;
        "pkg-2.4.1+1.21-neoforge" = _jvcuhDJw;
        "pkg-2.4.2+1.16.5-fabric" = _3XdBA6Am;
        "pkg-2.4.2+1.18.2-fabric" = _H5EvcC0Y;
        "pkg-2.4.2+1.19.2-fabric" = _wVDNC1Z6;
        "pkg-2.4.2+1.20.1-fabric" = _LgjYRsAQ;
        "pkg-2.4.2+1.20.4-fabric" = _Pz5aD40Z;
        "pkg-2.4.2+1.21-fabric" = _c9qhC5K0;
        "pkg-2.4.2+1.16.5-forge" = _6h7a29ng;
        "pkg-2.4.2+1.18.2-forge" = _FBLT8DUD;
        "pkg-2.4.2+1.19.2-forge" = _dLfVM2cI;
        "pkg-2.4.2+1.20.1-forge" = _gOEqZOMl;
        "pkg-2.4.2+1.20.4-forge" = _UGQBvCZA;
        "pkg-2.4.2+1.20.4-neoforge" = _HZPsuvEB;
        "pkg-2.4.2+1.21-neoforge" = _4yXfBwsc;
        "pkg-2.4.3+1.16.5-fabric" = _vOFvzl3v;
        "pkg-2.4.3+1.18.2-fabric" = _mR2RSYJj;
        "pkg-2.4.3+1.19.2-fabric" = _3sHjm8Mn;
        "pkg-2.4.3+1.20.1-fabric" = _S948ZSH5;
        "pkg-2.4.3+1.20.4-fabric" = _R8Wbksl5;
        "pkg-2.4.3+1.21-fabric" = _5g6PkCx1;
        "pkg-2.4.3+1.16.5-forge" = _Y4D77wgP;
        "pkg-2.4.3+1.18.2-forge" = _vRLbtxAe;
        "pkg-2.4.3+1.19.2-forge" = _eospS4le;
        "pkg-2.4.3+1.20.1-forge" = _c0bUgFeA;
        "pkg-2.4.3+1.20.4-forge" = _k4ScEmEf;
        "pkg-2.4.3+1.20.4-neoforge" = _JK8ZPJfJ;
        "pkg-2.4.3+1.21-neoforge" = _DfxHjcVi;
        "pkg-2.4.4+1.16.5-fabric" = _1iqgMpYw;
        "pkg-2.4.4+1.18.2-fabric" = _mFXv8qjF;
        "pkg-2.4.4+1.19.2-fabric" = _EUOt0W0j;
        "pkg-2.4.4+1.20.1-fabric" = _QWUpPyEo;
        "pkg-2.4.4+1.20.4-fabric" = _U3W8mvom;
        "pkg-2.4.4+1.21-fabric" = _RrWE2L0J;
        "pkg-2.4.4+1.16.5-forge" = _E4Ir3Wnd;
        "pkg-2.4.4+1.18.2-forge" = _f38NnKv5;
        "pkg-2.4.4+1.19.2-forge" = _MEhIsxXF;
        "pkg-2.4.4+1.20.1-forge" = _jMKyTdLR;
        "pkg-2.4.4+1.20.4-forge" = _zAJaLH5u;
        "pkg-2.4.4+1.20.4-neoforge" = _mdtOUyA8;
        "pkg-2.4.4+1.21-neoforge" = _GjoNLpoR;
        "pkg-2.4.5+1.16.5-fabric" = _t9bpUODz;
        "pkg-2.4.5+1.18.2-fabric" = _LUgVM0dX;
        "pkg-2.4.5+1.19.2-fabric" = _9lAclZVA;
        "pkg-2.4.5+1.20.1-fabric" = _Da6txDgT;
        "pkg-2.4.5+1.20.4-fabric" = _xU71ezjT;
        "pkg-2.4.5+1.21-fabric" = _81hFh2Ub;
        "pkg-2.4.5+1.16.5-forge" = _iaQSKGJa;
        "pkg-2.4.5+1.18.2-forge" = _FSDVqc8Q;
        "pkg-2.4.5+1.19.2-forge" = _p2HdDiYd;
        "pkg-2.4.5+1.20.1-forge" = _IHUjb3Wt;
        "pkg-2.4.5+1.20.4-forge" = _4iaW9XkS;
        "pkg-2.4.5+1.20.4-neoforge" = _c0L6Zckr;
        "pkg-2.4.5+1.21-neoforge" = _nV7EDc1g;
        "pkg-2.4.5-fix.1+1.20.1-fabric" = _miyBMQLN;
        "pkg-2.4.5-fix.1+1.20.4-fabric" = _H1Bn2MfT;
        "pkg-2.4.5-fix.1+1.21-fabric" = _JVSbLApT;
        "pkg-2.4.5-fix.1+1.20.1-forge" = _pS1A3aVZ;
        "pkg-2.4.5-fix.1+1.20.4-forge" = _735KqjcC;
        "pkg-2.4.5-fix.1+1.20.4-neoforge" = _r1gu1soG;
        "pkg-2.4.5-fix.1+1.21-neoforge" = _XMB0cvzz;
        "pkg-2.4.6+1.16.5-fabric" = _u8EztPYn;
        "pkg-2.4.6+1.18.2-fabric" = _JFYo3wZ0;
        "pkg-2.4.6+1.19.2-fabric" = _WoTx5T71;
        "pkg-2.4.6+1.20.1-fabric" = _rKPvGV0J;
        "pkg-2.4.6+1.20.4-fabric" = _7ZZ69cfW;
        "pkg-2.4.6+1.21-fabric" = _pXyFalog;
        "pkg-2.4.6+1.16.5-forge" = _PQGz9R9o;
        "pkg-2.4.6+1.18.2-forge" = _adb5pFS1;
        "pkg-2.4.6+1.19.2-forge" = _K1ahy5Yx;
        "pkg-2.4.6+1.20.1-forge" = _upMHNZoR;
        "pkg-2.4.6+1.20.4-forge" = _8CatYD1a;
        "pkg-2.4.6+1.20.4-neoforge" = _o1nveu5I;
        "pkg-2.4.6+1.21-neoforge" = _chgajtX8;
        "pkg-2.4.7+1.16.5-fabric" = _LqpuTpLo;
        "pkg-2.4.7+1.18.2-fabric" = _zgRxDmo5;
        "pkg-2.4.7+1.19.2-fabric" = _1h6zjwJu;
        "pkg-2.4.7+1.20.1-fabric" = _kY8STzIZ;
        "pkg-2.4.7+1.20.4-fabric" = _2KhGkhAC;
        "pkg-2.4.7+1.21-fabric" = _KdOHkPr0;
        "pkg-2.4.7+1.16.5-forge" = _EbMJ0TJf;
        "pkg-2.4.7+1.18.2-forge" = _yf8aTCcG;
        "pkg-2.4.7+1.19.2-forge" = _oJaO6ZI7;
        "pkg-2.4.7+1.20.1-forge" = _JkzuPZ6O;
        "pkg-2.4.7+1.20.4-forge" = _J0Vv1AOD;
        "pkg-2.4.7+1.20.4-neoforge" = _NTMfs2QJ;
        "pkg-2.4.7+1.21-neoforge" = _sXlqdyyT;
        "pkg-2.4.8+1.16.5-fabric" = _sWIMoXrt;
        "pkg-2.4.8+1.18.2-fabric" = _Nyc1X4n5;
        "pkg-2.4.8+1.19.2-fabric" = _kfpCvUiK;
        "pkg-2.4.8+1.20.1-fabric" = _cxUIgfvk;
        "pkg-2.4.8+1.20.4-fabric" = _pIjvfgis;
        "pkg-2.4.8+1.21-fabric" = _LzhOLidv;
        "pkg-2.4.8+1.16.5-forge" = _tZchR9oU;
        "pkg-2.4.8+1.18.2-forge" = _JUrvV0to;
        "pkg-2.4.8+1.19.2-forge" = _MbXMGGkP;
        "pkg-2.4.8+1.20.1-forge" = _U52QR38B;
        "pkg-2.4.8+1.20.4-forge" = _nW4kta2N;
        "pkg-2.4.8+1.20.4-neoforge" = _bwelP3xQ;
        "pkg-2.4.8+1.21-neoforge" = _nUKQf0h2;
        "pkg-2.4.8-fix.1+1.20.1-fabric" = _nSbkZstb;
        "pkg-2.4.8-fix.1+1.20.4-fabric" = _M8mrkktM;
        "pkg-2.4.8-fix.1+1.21-fabric" = _rdX8YhBw;
        "pkg-2.4.8-fix.1+1.20.1-forge" = _10Rt7EBv;
        "pkg-2.4.8-fix.1+1.20.4-forge" = _fzVU0I11;
        "pkg-2.4.8-fix.1+1.20.4-neoforge" = _wUbTJOUX;
        "pkg-2.4.8-fix.1+1.21-neoforge" = _RjpHCALL;
        "pkg-2.4.8-fix.2+1.21-neoforge" = _NzKpxgoC;
        "pkg-2.4.9+1.16.5-fabric" = _Qxu46Wd3;
        "pkg-2.4.9+1.18.2-fabric" = _ZuoUHHhp;
        "pkg-2.4.9+1.19.2-fabric" = _ct36aqrD;
        "pkg-2.4.9+1.20.1-fabric" = _OqitzYzO;
        "pkg-2.4.9+1.20.4-fabric" = _EFb6NTEs;
        "pkg-2.4.9+1.21-fabric" = _t5iU1iQE;
        "pkg-2.4.9+1.16.5-forge" = _DSb0y7SE;
        "pkg-2.4.9+1.18.2-forge" = _X3WqNsGY;
        "pkg-2.4.9+1.19.2-forge" = _lGXdvOY8;
        "pkg-2.4.9+1.20.1-forge" = _AIEgRyos;
        "pkg-2.4.9+1.20.4-forge" = _sfknJcM4;
        "pkg-2.4.9+1.20.4-neoforge" = _7UBd263K;
        "pkg-2.4.9+1.21-neoforge" = _6XOg1BHv;
        "pkg-2.5.0+1.16.5-fabric" = _VEA2P6Rw;
        "pkg-2.5.0+1.18.2-fabric" = _3tVLTCta;
        "pkg-2.5.0+1.19.2-fabric" = _VC68cWh1;
        "pkg-2.5.0+1.20.1-fabric" = _FppqwVa7;
        "pkg-2.5.0+1.20.4-fabric" = _6oUkz7rh;
        "pkg-2.5.0+1.21-fabric" = _ucuD4TLT;
        "pkg-2.5.0+1.16.5-forge" = _GpnoeYgr;
        "pkg-2.5.0+1.18.2-forge" = _8vwnD07T;
        "pkg-2.5.0+1.19.2-forge" = _KyFiYykC;
        "pkg-2.5.0+1.20.1-forge" = _vHr4Ue0P;
        "pkg-2.5.0+1.20.4-forge" = _NjilUMtB;
        "pkg-2.5.0+1.20.4-neoforge" = _5ByA56hD;
        "pkg-2.5.0+1.21-neoforge" = _y88N7gc7;
        "pkg-2.5.1+1.16.5-fabric" = _yWizxmTV;
        "pkg-2.5.1+1.18.2-fabric" = _U2RFBQlI;
        "pkg-2.5.1+1.19.2-fabric" = _274oVXwC;
        "pkg-2.5.1+1.20.1-fabric" = _NpIYYbbH;
        "pkg-2.5.1+1.20.4-fabric" = _dnyVO4RX;
        "pkg-2.5.1+1.21-fabric" = _TwwHVrfc;
        "pkg-2.5.1+1.16.5-forge" = _ymOR9omJ;
        "pkg-2.5.1+1.18.2-forge" = _FXXgFSwW;
        "pkg-2.5.1+1.19.2-forge" = _vM2OX6jJ;
        "pkg-2.5.1+1.20.1-forge" = _TLzHi6bL;
        "pkg-2.5.1+1.20.4-forge" = _vJcfLVno;
        "pkg-2.5.1+1.20.4-neoforge" = _nhVKCzVF;
        "pkg-2.5.1+1.21-neoforge" = _iK4ZfuyI;
        "pkg-2.5.2-fabric" = _nFOuE7Q0;
        "pkg-2.5.2-forge" = _JCxggKeq;
        "pkg-2.5.2-neoforge" = _jxUWqidR;
        "pkg-3.0.0-fabric" = _UBnWZlNY;
        "pkg-3.0.0-forge" = _SK7w9jq1;
        "pkg-3.0.0-neoforge" = _Khv10X0m;
        "pkg-3.0.1-fabric" = _L1Nb1F7z;
        "pkg-3.0.1-forge" = _aobhg7n7;
        "pkg-3.0.1-neoforge" = _SzuSdvNz;
        "pkg-3.0.2-fabric" = _8zZQzXwN;
        "pkg-3.0.2-forge" = _SIwAfv6j;
        "pkg-3.0.2-neoforge" = _BEcjWfbk;
        "pkg-3.0.3-fabric" = _FG5mDVf8;
        "pkg-3.0.3-forge" = _QxoQKO6V;
        "pkg-3.0.3-neoforge" = _nMgxF7Vx;
        "pkg-3.0.4-fabric" = _Jn6wkuMy;
        "pkg-3.0.4-forge" = _nTFezuqF;
        "pkg-3.0.4-neoforge" = _5QNIoCs7;
        "pkg-3.0.5-fabric" = _nOeItwLT;
        "pkg-3.0.5-forge" = _LLbQxdnk;
        "pkg-3.0.5-neoforge" = _4UYCH6WA;
        "pkg-3.0.7-fabric" = _9aTWYCrD;
        "pkg-3.0.7-forge" = _mbpToxJu;
        "pkg-3.0.7-neoforge" = _KKGfuggm;
        "pkg-3.0.8-fabric" = _R0HDAORO;
        "pkg-3.0.8-forge" = _H11hJDvW;
        "pkg-3.0.8-neoforge" = _3okeF8lV;
        "pkg-3.0.9-fabric" = _skQkotLb;
        "pkg-3.0.9-forge" = _gN8NnRjB;
        "pkg-3.0.9-neoforge" = _Fc36L7Nm;
        "pkg-3.0.9-fix.1-fabric" = _P7zp5u0H;
        "pkg-3.0.9-fix.1-neoforge" = _GLXGBDFw;
        "pkg-3.1.0-fabric" = _v9B9Pq5B;
        "pkg-3.1.0-forge" = _pkQyJVPh;
        "pkg-3.1.0-neoforge" = _qoqCKp8h;
        "pkg-3.1.1-fabric" = _Y0j5TGK4;
        "pkg-3.1.1-forge" = _wVCBSR1H;
        "pkg-3.1.1-neoforge" = _UNyZ911L;
        "pkg-3.1.2-fabric" = _kCGEIhjS;
        "pkg-3.1.2-forge" = _XOBvJGWG;
        "pkg-3.1.2-neoforge" = _Zlh9cOk7;
        "pkg-3.1.3-fabric" = _GI9f3eDG;
        "pkg-3.1.3-forge" = _gqxkAd4B;
        "pkg-3.1.3-neoforge" = _5eDMU3GC;
        "pkg-3.1.4+1.16.5-fabric" = _XPzF61cY;
        "pkg-3.1.4+1.18.2-fabric" = _guxIACj5;
        "pkg-3.1.4+1.19.2-fabric" = _TIVvDz7T;
        "pkg-3.1.4+1.20.1-fabric" = _3OzSvRq8;
        "pkg-3.1.4+1.20.4-fabric" = _scvSGNCd;
        "pkg-3.1.4+1.21.1-fabric" = _Nc7VHzUt;
        "pkg-3.1.4+1.21.3-fabric" = _X6mQT5eg;
        "pkg-3.1.4+1.16.5-forge" = _cEfoosI2;
        "pkg-3.1.4+1.18.2-forge" = _MdG4Gbrz;
        "pkg-3.1.4+1.19.2-forge" = _xvL6CtLN;
        "pkg-3.1.4+1.20.1-forge" = _8jz2LuA2;
        "pkg-3.1.4+1.20.4-forge" = _BmFQuGU6;
        "pkg-3.1.4+1.20.4-neoforge" = _gPnjzfK6;
        "pkg-3.1.4+1.21.1-neoforge" = _sL44200c;
        "pkg-3.1.4+1.21.3-neoforge" = _ugbM9QLX;
        "pkg-3.1.5+1.16.5-fabric" = _gJSaWALR;
        "pkg-3.1.5+1.18.2-fabric" = _BWhg4h5Q;
        "pkg-3.1.5+1.19.2-fabric" = _h6Xtpw70;
        "pkg-3.1.5+1.20.1-fabric" = _zvy6EG6a;
        "pkg-3.1.5+1.20.4-fabric" = _IBQTMT7U;
        "pkg-3.1.5+1.21.1-fabric" = _4P3KMVtM;
        "pkg-3.1.5+1.21.3-fabric" = _X5vAUeA8;
        "pkg-3.1.5+1.16.5-forge" = _uzg09bHI;
        "pkg-3.1.5+1.18.2-forge" = _5zOzIj1r;
        "pkg-3.1.5+1.19.2-forge" = _zyJutRF6;
        "pkg-3.1.5+1.20.1-forge" = _iGV7imVf;
        "pkg-3.1.5+1.20.4-forge" = _nXbTbQLY;
        "pkg-3.1.5+1.20.4-neoforge" = _yxfTCjo0;
        "pkg-3.1.5+1.21.1-neoforge" = _UZl0HeiE;
        "pkg-3.1.5+1.21.3-neoforge" = _toPNuuNr;
        "pkg-3.1.6-fabric" = _DlU0FwhS;
        "pkg-3.1.6-forge" = _NKED4TWR;
        "pkg-3.1.6-neoforge" = _bBfyiyZe;
        "pkg-3.1.7-fabric" = _86gC06Yn;
        "pkg-3.1.7-forge" = _CokSJHxB;
        "pkg-3.1.7-neoforge" = _pVCXEyNa;
        "pkg-3.1.8-forge" = _CEbZAex2;
        "pkg-3.1.8-fabric" = _Rb2TW7g5;
        "pkg-3.1.8-neoforge" = _tmsso2XF;
        "pkg-3.2.0-fabric" = _Fncxs6WC;
        "pkg-3.2.0-forge" = _xA1oKAhz;
        "pkg-3.2.0-neoforge" = _9KLBHmfq;
        "pkg-3.2.1-fabric" = _SBiesGWH;
        "pkg-3.2.1-forge" = _mVTVUTH9;
        "pkg-3.2.1-neoforge" = _W5Plwoaf;
        "pkg-3.2.2-fabric" = _1FPQibnb;
        "pkg-3.2.2-forge" = _Xwz70IrS;
        "pkg-3.2.2-neoforge" = _CyU1CDo1;
        "pkg-3.2.3-fabric" = _53wdnrwh;
        "pkg-3.2.3-forge" = _xFWPPODr;
        "pkg-3.2.3-neoforge" = _XRV8lIyv;
        "pkg-3.2.4-fabric" = _Un76eMXN;
        "pkg-3.2.4-forge" = _GWrQOypk;
        "pkg-3.2.4-neoforge" = _aq5aHt6k;
        "pkg-3.2.5-fabric" = _a7tN54Sh;
        "pkg-3.2.5-forge" = _A6MM2l0s;
        "pkg-3.2.5-neoforge" = _9ZNwShJN;
        "pkg-3.2.6-fabric" = _VnVPFvp9;
        "pkg-3.2.6-forge" = _IjSiP6wD;
        "pkg-3.2.6-neoforge" = _q6E05Axc;
        "pkg-3.2.7-fabric" = _DFyhnj0a;
        "pkg-3.2.7-forge" = _wYlB7oAt;
        "pkg-3.2.7-neoforge" = _P3YXkKbD;
        "pkg-3.2.8-fabric" = _xMLfBrjI;
        "pkg-3.2.8-forge" = _4SRGIrhk;
        "pkg-3.2.8-neoforge" = _Ly4OMIrk;
        "pkg-3.2.9-fabric" = _O9rtDGgP;
        "pkg-3.2.9-forge" = _F0Cfajtx;
        "pkg-3.2.9-neoforge" = _e5I4z3bu;
        "pkg-3.3.0-forge" = _FMFUbBIj;
        "pkg-3.3.0-fabric" = _xy9o4y0I;
        "pkg-3.3.0-neoforge" = _ayiQkUJa;
        "pkg-3.3.1-fabric" = _DWmIEv5g;
        "pkg-3.3.1-forge" = _CgTyoeb7;
        "pkg-3.3.1-neoforge" = _lIN2ze1X;
        "pkg-3.3.2-fabric" = _aqJTcylG;
        "pkg-3.3.2-forge" = _1usKav7a;
        "pkg-3.3.2-neoforge" = _5Vs2x5lz;
        "pkg-3.3.2-alpha-fabric" = _UnE6ldFr;
        "pkg-3.3.2-alpha-neoforge" = _fKhJeyii;
        "pkg-3.3.3-fabric" = _mOcCu3wM;
        "pkg-3.3.3-forge" = _WEbwk18O;
        "pkg-3.3.3-neoforge" = _eKsMoTTA;
        "pkg-3.3.4-fabric" = _RffRAMG3;
        "pkg-3.3.4-forge" = _K3neMHZz;
        "pkg-3.3.4-neoforge" = _NMPwutdT;
        "pkg-3.3.5-fabric" = _Y7GGP41Y;
        "pkg-3.3.5-neoforge" = _e4HiIwoL;
        "pkg-3.3.6-fabric" = _v0dMg840;
        "pkg-3.3.6-neoforge" = _aaUcqN7I;
        "pkg-3.3.6-forge" = _yxzmlkIv;
        "pkg-3.3.7-fabric" = _KEWcZO9e;
        "pkg-3.3.7-forge" = _O6KkQV4w;
        "pkg-3.3.7-neoforge" = _G6RUDwwZ;
        "pkg-3.3.8-fabric" = _SuoWujHG;
        "pkg-3.3.8-forge" = _TeKNKqsH;
        "pkg-3.3.8-neoforge" = _M1zuiuwq;
        "pkg-3.3.8-fix.1-neoforge" = _iW6NwGb6;
        "pkg-3.3.8-fix.1-forge" = _Z1l6ewPE;
        "pkg-3.3.9-fabric" = _UGxP4G5y;
        "pkg-3.3.9-forge" = _cN5yhBMz;
        "pkg-3.3.9-neoforge" = _b6isBhHz;
        "pkg-3.3.9-fix.1-fabric" = _XUYDp3Po;
        "pkg-3.3.9-fix.1-neoforge" = _MGIBh6NZ;
        "pkg-3.3.9-fix.3-neoforge" = _RlV3e5lr;
        "pkg-3.4.1-fabric" = _9s11nPbR;
        "pkg-3.4.1-forge" = _oCyqZiaP;
        "pkg-3.4.1-neoforge" = _fQCLs0a3;
        "pkg-3.4.2-fabric" = _h3PgVbi3;
        "pkg-3.4.2-forge" = _5WPN0roM;
        "pkg-3.4.2-neoforge" = _mRsVbWwS;
        "pkg-3.4.3-fabric" = _NvYJRT62;
        "pkg-3.4.3-forge" = _6NgMpg7d;
        "pkg-3.4.3-neoforge" = _gLOGTxbp;
        "pkg-3.4.3-fix.1-fabric" = _ZmKdHvoD;
        "pkg-3.4.3-fix.1-neoforge" = _b1pXUlTO;
        "pkg-3.4.4-fabric" = _nOfsMEJZ;
        "pkg-3.4.4-neoforge" = _n3YDUuAA;
        "pkg-3.4.4-forge" = _2AMSnE3L;
        "pkg-3.4.5-fabric" = _hWerCjQG;
        "pkg-3.4.5-neoforge" = _XaICSiSv;
        "pkg-3.4.6-fabric" = _cYfocHRZ;
        "pkg-3.4.6-neoforge" = _8Mj25ylu;
        "pkg-3.4.6-fix.1-neoforge" = _Xh54TBTZ;
        "pkg-3.4.7-fabric" = _EFjymwNL;
        "pkg-3.4.7-forge" = _lzpkBXog;
        "pkg-3.4.7-neoforge" = _KYpUW79B;
        "pkg-3.4.8-fabric" = _pWqvMDuo;
        "pkg-3.4.8-forge" = _dXnk4UB4;
        "pkg-3.4.8-neoforge" = _HB2IpaVK;
        "pkg-3.4.9-neoforge" = _V7MGGvhi;
        "pkg-3.4.9-fabric" = _oeeFAQhU;
        "pkg-3.4.9-forge" = _x0tArNWX;
        "pkg-3.5.0-fabric" = _A4DV4NiN;
        "pkg-3.5.0-forge" = _34Ya8CiC;
        "pkg-3.5.0-neoforge" = _If0vlXb5;
        "pkg-3.5.1-fabric" = _H38xPuzD;
        "pkg-3.5.1-forge" = _wOmV07Tc;
        "pkg-3.5.1-neoforge" = _s9jEjhWk;
        "pkg-3.5.2-fabric-26.1" = _XVdP5qRs;
        "pkg-3.5.2-fabric" = _8VjsTkfS;
        "pkg-3.5.2-forge" = _r1pGM41r;
        "pkg-3.5.2-neoforge" = _C0Giuix0;
        "pkg-3.6.0-fabric-26.1" = _OgdQe5DL;
        "pkg-3.5.3-fabric" = _70qrAeYF;
        "pkg-3.5.3-forge" = _v5Dm8CKc;
        "pkg-3.5.3-neoforge" = _hNgQmKoh;
        "pkg-3.6.2-fabric-26.1" = _FapRWcIR;
        "pkg-3.6.2-fabric" = _O38UF7uR;
        "pkg-3.6.2-forge" = _YacKA5WM;
        "pkg-3.6.2-neoforge" = _DPJzarfC;
        "pkg-3.6.3-fabric-26.1" = _3MZLH8OV;
        "pkg-3.6.3-fabric" = _iaP7QL06;
        "pkg-3.6.3-forge" = _zpSX9EjN;
        "pkg-3.6.3-neoforge" = _1MpAnUUh;
        "pkg-3.6.3-fix.1-fabric-26.1" = _GiC20lAK;
        "pkg-3.6.3-fix.2-fabric-26.1" = _4Jtbc9AH;
        "pkg-3.6.3-fix.3-fabric-26.1" = _7ARPhssJ;
        "pkg-3.6.3-fix.4-fabric-26.1" = _K54Mr1xw;
        "pkg-3.6.4-fabric-26.1" = _4y6hoQ31;
        "pkg-3.6.4-fix.1-fabric-26.1" = _WFL7gnUB;
        "pkg-3.6.4-fabric" = _2Qgt2EQH;
        "pkg-3.6.4-forge" = _eKgGVoJv;
        "pkg-3.6.4-neoforge" = _iBbHRcUD;
        "pkg-3.6.5-fabric-26.1" = _oRmVkGel;
        "pkg-3.6.5-fix.1-fabric-26.1" = _pyh9gj5h;
        "pkg-3.6.5-fabric" = _V6NRy1nZ;
        "pkg-3.6.5-forge" = _65V9JHEC;
        "pkg-3.6.5-neoforge" = _3lN1ZcUk;
        "pkg-3.6.5-fix.2-fabric-26.1" = _6Us4EoBz;
        "pkg-3.6.5-fix.3-fabric-26.1" = _6OTaqwcV;
        "pkg-3.6.5-fix.4-fabric-26.1" = _RYDlUn3u;
        "pkg-3.6.5-fix.5-fabric-26.1" = _SgcRn7wA;
        "pkg-3.6.5-fix.6-fabric-26.1" = _eadui5qM;
        "pkg-3.6.6-fabric" = _UkwPD5tT;
        "pkg-3.6.6-forge" = _fo9wATmv;
        "pkg-3.6.6-neoforge" = _h3KOt8mQ;
        "pkg-3.6.6-fabric-26.1" = _4XAon9Yv;
        "pkg-3.6.6-neoforge-26.1" = _1flsphXq;
        "pkg-3.6.7-fabric-26.1" = _xFRAz6BM;
        "pkg-3.6.7-neoforge-26.1" = _p7u7EAUf;
        "pkg-3.6.7-fabric" = _Qfx9EEUC;
        "pkg-3.6.7-forge" = _blpCOFfA;
        "pkg-3.6.7-neoforge" = _Io7aNt8w;
        "pkg-3.6.8-fabric" = _7STa0LMu;
        "pkg-3.6.8-forge" = _uCetNaAs;
        "pkg-3.6.8-neoforge" = _kE0i4sc8;
        "pkg-3.6.8-fabric-26.1" = _VLVuR4i1;
        "pkg-3.6.8-neoforge-26.1" = _X2DvE9Qu;
        "pkg-3.7.0-fabric" = _ZsskpLlI;
        "pkg-3.7.0-forge" = _P1Xet63o;
        "pkg-3.7.0-neoforge" = _F5hRdYyw;
        "pkg-3.7.0-fabric-26.1" = _eDKl2bSh;
        "pkg-3.7.0-neoforge-26.1" = _svKwPLID;
        "pkg-3.7.1-fabric-26.1" = _682hEBJE;
        "pkg-3.7.1-neoforge-26.1" = _Q1LNA6XW;
        "pkg-3.7.1-fabric" = _HNxZ6YKj;
        "pkg-3.7.1-forge" = _E5zRZcHk;
        "pkg-3.7.1-neoforge" = _QOldPssJ;
        "pkg-3.7.2-neoforge-26.1" = _55X36IWd;
        "pkg-3.7.2-fabric-26.1" = _fZj006RC;
        "pkg-3.7.2-fix.1-neoforge-26.1" = _ns6AstDx;
        "pkg-3.7.2-fix.1-fabric-26.1" = _92GfBgcb;
        "pkg-3.7.2-fix.1-fabric-26.2" = _1WloiFuy;
        "pkg-3.7.2-fix.1-neoforge-26.2" = _zQKUkXwC;
        "pkg-3.7.2-fix.2-neoforge-26.1" = _r6KNrJJ4;
        "pkg-3.7.2-fix.2-fabric-26.1" = _C8It9aFM;
        "pkg-3.7.2-fix.2-fabric-26.2" = _WDFEFCYp;
        "pkg-3.7.2-fix.2-neoforge-26.2" = _5kbatlma;
        "pkg-3.7.2-fix.3-fabric-26.2" = _19s6DeUp;
        "pkg-3.7.2-fix.3-neoforge-26.2" = _PATH2FhG;
        "pkg-3.7.2-fix.3-neoforge-26.1" = _MA8EfJs0;
        "pkg-3.7.2-fix.3-fabric-26.1" = _5khNCQoV;
        "pkg-4.0.0-forge-1.20.4" = _jG8Drhi7;
        "pkg-4.0.0-fabric-1.20.4" = _5aaYMMbZ;
        "pkg-4.0.0-neoforge-1.20.4" = _4pRKReyi;
        "pkg-4.0.0-forge-1.18.2" = _zmgCqaKv;
        "pkg-4.0.0-fabric-1.18.2" = _PmTVpXzI;
        "pkg-4.0.0-forge-1.20.1" = _cBc3Toim;
        "pkg-4.0.0-forge-1.16.5" = _4333rmAa;
        "pkg-4.0.0-fabric-1.16.5" = _ZIpYJAA1;
        "pkg-4.0.0-forge-1.19.2" = _nuFISbnK;
        "pkg-4.0.0-fabric-1.19.2" = _cveXdIlz;
        "pkg-4.0.0-fabric-1.21.1" = _M6ilxKoz;
        "pkg-4.0.0-neoforge-1.21.1" = _YX1LbN6O;
        "pkg-4.0.0-fabric-1.20.1" = _bIB7awq5;
        "pkg-4.0.0-neoforge-1.21.3" = _wK7Qog9W;
        "pkg-4.0.0-fabric-1.21.3" = _zpCkQXEL;
        "pkg-4.0.0-neoforge-1.21.4" = _ams0KVwf;
        "pkg-4.0.0-fabric-1.21.4" = _zNjC8RdF;
        "pkg-4.0.0-neoforge-1.21.5" = _S97PlC8V;
        "pkg-4.0.0-fabric-1.21.5" = _RLEg8zVp;
        "pkg-4.0.0-fabric-1.21.6" = _ln0Uh12F;
        "pkg-4.0.0-neoforge-1.21.6" = _a2SLXeJ3;
        "pkg-4.0.0-neoforge-1.21.9" = _7nA0DbUX;
        "pkg-4.0.0-fabric-1.21.9" = _AsWdwPKW;
        "pkg-4.0.0-fabric-1.21.11" = _BT5rsiwQ;
        "pkg-4.0.0-neoforge-1.21.11" = _EFrUygwh;
        "pkg-4.0.0-neoforge-26.1" = _UtRdmCan;
        "pkg-4.0.0-fabric-26.1" = _d9EK7IzU;
        "pkg-4.0.0-neoforge-26.2" = _mpbqLKk7;
        "pkg-4.0.0-fabric-26.2" = _WbR1KNZW;
        "pkg-4.0.0-fix.1-forge-1.20.4" = _qOtc5IAI;
        "pkg-4.0.1-forge-1.20.4" = _JjxBnW2d;
        "pkg-4.0.1-fabric-1.20.4" = _Tw59cSty;
        "pkg-4.0.1-neoforge-1.20.4" = _n8BwBZ2i;
        "pkg-4.0.1-forge-1.18.2" = _fG6XW2kB;
        "pkg-4.0.1-fabric-1.18.2" = _samtQsbr;
        "pkg-4.0.1-forge-1.20.1" = _42ym7tsW;
        "pkg-4.0.1-fabric-1.20.1" = _OPYojGuW;
        "pkg-4.0.1-forge-1.16.5" = _Igjhp8m9;
        "pkg-4.0.1-fabric-1.16.5" = _s9sO6MAH;
        "pkg-4.0.1-forge-1.19.2" = _a1Dh9Pyk;
        "pkg-4.0.1-fabric-1.19.2" = _bOFsFA2d;
        "pkg-4.0.1-neoforge-1.21.1" = _lX6qEF0v;
        "pkg-4.0.1-fabric-1.21.1" = _OPl0XmaP;
        "pkg-4.0.1-fabric-1.21.3" = _jbpQKnjW;
        "pkg-4.0.1-neoforge-1.21.3" = _szM54zVs;
        "pkg-4.0.1-fabric-1.21.4" = _H0fB67tc;
        "pkg-4.0.1-neoforge-1.21.4" = _nx6u4ziG;
        "pkg-4.0.1-fabric-1.21.5" = _avAxnDvg;
        "pkg-4.0.1-neoforge-1.21.5" = _2DURAjaY;
        "pkg-4.0.1-neoforge-1.21.6" = _GPgKJ38a;
        "pkg-4.0.1-fabric-1.21.6" = _cUmmzdfY;
        "pkg-4.0.1-neoforge-1.21.9" = _BzdZtxbl;
        "pkg-4.0.1-fabric-1.21.9" = _8f1PGaOp;
        "pkg-4.0.1-neoforge-1.21.11" = _8B1QqweC;
        "pkg-4.0.1-fabric-1.21.11" = _3ENM6fZF;
        "pkg-4.0.1-neoforge-26.1" = _krmBrDK7;
        "pkg-4.0.1-fabric-26.1" = _imQE1ku1;
        "pkg-4.0.1-neoforge-26.2" = _uwfFmFhU;
        "pkg-4.0.1-fabric-26.2" = _dYPwtOSt;
        "pkg-4.0.1-fix.1-neoforge-26.2" = _Id7OVrjV;
        "pkg-4.0.1-fix.1-neoforge-26.1" = _6VfJ0BWj;
        "pkg-4.0.1-fix.1-fabric-26.2" = _dAZK5yp8;
        "pkg-4.0.2-fabric-26.2" = _HWM52UfK;
        "pkg-4.0.2-neoforge-26.2" = _rJO5NPdt;
        "pkg-4.0.2-neoforge-26.1" = _1q1Qcdze;
        "pkg-4.0.2-fabric-26.1" = _mulwkn3S;
        "pkg-4.0.2-fabric-1.20.4" = _OjgDSxuj;
        "pkg-4.0.2-forge-1.20.4" = _uiQykX8x;
        "pkg-4.0.2-neoforge-1.20.4" = _1ob8zM5r;
        "pkg-4.0.2-forge-1.18.2" = _hR0yXf23;
        "pkg-4.0.2-fabric-1.18.2" = _iWsJEYPx;
        "pkg-4.0.2-forge-1.20.1" = _mSWuOLiy;
        "pkg-4.0.2-fabric-1.20.1" = _h1bvdA5b;
        "pkg-4.0.2-forge-1.16.5" = _46qAwRZz;
        "pkg-4.0.2-fabric-1.16.5" = _BLKMN6V9;
        "pkg-4.0.2-fabric-1.19.2" = _BxfXX2Yk;
        "pkg-4.0.2-fabric-1.21.1" = _1PyLPBVH;
        "pkg-4.0.3-forge-1.20.4" = _Btu4rN0G;
        "pkg-4.0.3-fabric-1.20.4" = _oPBgeMrC;
        "pkg-4.0.3-neoforge-1.20.4" = _vIv1YRTx;
        "pkg-4.0.3-forge-1.18.2" = _tA9n9cDO;
        "pkg-4.0.3-fabric-1.18.2" = _CBlWNHwV;
        "pkg-4.0.3-forge-1.20.1" = _l9oolDsb;
        "pkg-4.0.3-fabric-1.20.1" = _m6SKRhiF;
        "pkg-4.0.3-forge-1.16.5" = _WHk2PI5t;
        "pkg-4.0.3-fabric-1.16.5" = _TSZkF92V;
        "pkg-4.0.3-forge-1.19.2" = _7zmdQb51;
        "pkg-4.0.3-fabric-1.19.2" = _52fg14IC;
        "pkg-4.0.3-neoforge-1.21.1" = _P44yU9tC;
        "pkg-4.0.3-fabric-1.21.1" = _pi0mXsb8;
        "pkg-4.0.3-neoforge-1.21.3" = _8vLCzQRL;
        "pkg-4.0.3-fabric-1.21.3" = _C4fUykdQ;
        "pkg-4.0.3-fabric-1.21.4" = _7biUXW5L;
        "pkg-4.0.3-neoforge-1.21.4" = _1uEYlVmk;
        "pkg-4.0.3-neoforge-1.21.5" = _ihVtt8kk;
        "pkg-4.0.3-fabric-1.21.5" = _fxfqe3QB;
        "pkg-4.0.3-neoforge-1.21.6" = _CP3cw1o6;
        "pkg-4.0.3-fabric-1.21.6" = _ByD6bhxn;
        "pkg-4.0.3-neoforge-1.21.9" = _gVebJ5H7;
        "pkg-4.0.3-fabric-1.21.9" = _Hp5MQUWj;
        "pkg-4.0.3-fabric-1.21.11" = _fxPew9Jo;
        "pkg-4.0.3-neoforge-1.21.11" = _4k8hKQUO;
        "pkg-4.0.3-fabric-26.1" = _ZfCTTBzS;
        "pkg-4.0.3-neoforge-26.1" = _7iRjBlcU;
        "pkg-4.0.3-fabric-26.2" = _WoynAMxe;
        "pkg-4.0.3-neoforge-26.2" = _AjYDNc2q;
        "pkg-4.0.3-fix.1-neoforge-26.2" = _v2SWxVKb;
        "pkg-4.0.3-fix.1-neoforge-26.1" = _MEWwTlcJ;
        "pkg-4.0.4-forge-1.20.4" = _Sgeb5NHo;
        "pkg-4.0.4-fabric-1.20.4" = _I5U1KlOu;
        "pkg-4.0.4-neoforge-1.20.4" = _S3kHvv3t;
        "pkg-4.0.4-forge-1.18.2" = _UPsOhn5z;
        "pkg-4.0.4-fabric-1.18.2" = _Bht2p2Hw;
        "pkg-4.0.4-forge-1.20.1" = _2GDdABST;
        "pkg-4.0.4-fabric-1.20.1" = _WztC76VR;
        "pkg-4.0.4-forge-1.16.5" = _Dt3QaRPy;
        "pkg-4.0.4-fabric-1.16.5" = _QwjiFwIx;
        "pkg-4.0.4-forge-1.19.2" = _yKq7ZISc;
        "pkg-4.0.4-fabric-1.19.2" = _REJhIatw;
        "pkg-4.0.4-neoforge-1.21.1" = _Y3Cn3hA6;
        "pkg-4.0.4-fabric-1.21.1" = _VdvQZlhy;
        "pkg-4.0.4-neoforge-1.21.4" = _NZfQCwXP;
        "pkg-4.0.4-fabric-1.21.4" = _8A6bm5hS;
        "pkg-4.0.4-neoforge-1.21.9" = _FLk6AVut;
        "pkg-4.0.4-fabric-1.21.9" = _r6fN3Xjk;
        "pkg-4.0.4-neoforge-1.21.11" = _y7uQF09s;
        "pkg-4.0.4-fabric-1.21.11" = _NRWnGbPh;
        "pkg-4.0.4-fabric-26.1" = _Zo2LJFvG;
        "pkg-4.0.4-neoforge-26.1" = _nqTpcfhP;
        "pkg-4.0.4-fabric-26.2" = _mord2MSC;
        "pkg-4.0.4-neoforge-26.2" = _9F317sMK;
        "pkg-4.0.4-fix.1-fabric-26.2" = _ghUFgBsv;
        "pkg-4.0.4-fix.1-neoforge-26.2" = _QpR1HDzQ;
        "pkg-4.0.4-fix.1-neoforge-26.1" = _DR5ebrPR;
        "pkg-4.0.4-fix.1-fabric-26.1" = _il6rr11l;
        "pkg-4.0.5-neoforge-26.1" = _G6FftWwY;
        "pkg-4.0.5-fabric-26.1" = _pPpU7u7F;
        "pkg-4.0.5-fabric-26.2" = _Yjxw4yYe;
        "pkg-4.0.5-neoforge-26.2" = _BA0PULge;
        "pkg-4.0.5-neoforge-1.21.11" = _w0zo9TzD;
        "pkg-4.0.5-fabric-1.21.11" = _gATgqiR5;
        "pkg-4.0.5-fabric-1.21.9" = _LsR32bhT;
        "pkg-4.0.5-neoforge-1.21.9" = _dVBT1B4s;
        "pkg-4.0.5-fabric-1.21.1" = _cfAl4zHX;
        "pkg-4.0.5-neoforge-1.21.1" = _JYwTNbi2;
        "pkg-4.0.5-forge-1.20.1" = _sRTgiRSK;
        "pkg-4.0.5-fabric-1.20.1" = _apZDfruB;
        "pkg-4.0.5-neoforge-1.21.4" = _TgwqOerh;
        "pkg-4.0.5-fabric-1.21.4" = _fAd4XN1v;
        "pkg-4.0.5-forge-1.20.4" = _92hFycqb;
        "pkg-4.0.5-fabric-1.20.4" = _JsZdQS2J;
        "pkg-4.0.5-neoforge-1.20.4" = _gWihFGcj;
        "pkg-4.0.5-forge-1.16.5" = _wCFF23Wu;
        "pkg-4.0.5-fabric-1.16.5" = _B8WYiLVZ;
        "pkg-4.0.5-forge-1.18.2" = _y7NKOa1F;
        "pkg-4.0.5-fabric-1.18.2" = _VqhB9t1K;
        "pkg-4.0.5-fabric-1.19.2" = _xxQNmjwB;
        "pkg-4.0.5-forge-1.19.2" = _oaC1tHXi;
        "pkg-4.0.6-neoforge-26.1" = _kTcx7cHx;
        "pkg-4.0.6-fabric-26.1" = _vqddtDxJ;
        "pkg-4.0.6-neoforge-26.2" = _2X9Fo5yI;
        "pkg-4.0.6-fabric-26.2" = _jLs2Q2oM;
        "pkg-4.0.6-fabric-1.21.11" = _e1h9JKlq;
        "pkg-4.0.6-neoforge-1.21.11" = _6s4KnGUR;
        "pkg-4.0.6-neoforge-1.21.9" = _VnBhZtKZ;
        "pkg-4.0.6-fabric-1.21.9" = _wcukWVR2;
        "pkg-4.0.6-fabric-1.21.4" = _Y74LCHuK;
        "pkg-4.0.6-neoforge-1.21.4" = _cvbxd9O3;
        "pkg-4.0.6-neoforge-1.21.1" = _2qubY15B;
        "pkg-4.0.6-fabric-1.21.1" = _kyjBRJO9;
        "pkg-4.0.6-fabric-1.20.1" = _FD3Qxmyj;
        "pkg-4.0.6-forge-1.20.1" = _gfZVmTNo;
        "pkg-4.0.6-forge-1.20.4" = _ZYiKqeGj;
        "pkg-4.0.6-fabric-1.20.4" = _aGdXSw50;
        "pkg-4.0.6-neoforge-1.20.4" = _cZNSwOEI;
        "pkg-4.0.6-fabric-1.19.2" = _lbWvgP8g;
        "pkg-4.0.6-forge-1.19.2" = _efaZLjq9;
        "pkg-4.0.6-forge-1.16.5" = _4y7T7NUY;
        "pkg-4.0.6-fabric-1.16.5" = _7Q4nyDZH;
        "pkg-4.0.6-fabric-1.18.2" = _rgG2lLWU;
        "pkg-4.0.6-forge-1.18.2" = _aJCuYQrL;
        "pkg-4.0.7-fabric-26.2" = _5pGalUQP;
        "pkg-4.0.7-neoforge-26.2" = _TcXINHwW;
        "pkg-4.0.7-fabric-26.1" = _cYHGC5or;
        "pkg-4.0.7-neoforge-26.1" = _vEABPabG;
        "pkg-4.0.7-fabric-1.21.9" = _YWCgMMdU;
        "pkg-4.0.7-neoforge-1.21.9" = _wVXci5FF;
        "pkg-4.0.7-fabric-1.21.11" = _EBwV0nvc;
        "pkg-4.0.7-neoforge-1.21.11" = _kwjWsjcV;
        "pkg-4.0.7-fabric-1.21.4" = _1AfjWvTE;
        "pkg-4.0.7-neoforge-1.21.4" = _OKXyIvf8;
        "pkg-4.0.7-neoforge-1.21.1" = _qxG6kSZO;
        "pkg-4.0.7-fabric-1.21.1" = _PMfGDjEq;
        "pkg-4.0.7-fabric-1.20.1" = _yJjlbqBN;
        "pkg-4.0.7-forge-1.20.1" = _m5fmzE1m;
        "pkg-4.0.7-forge-1.20.4" = _BsLqjyTX;
        "pkg-4.0.7-fabric-1.20.4" = _cVCnaoa3;
        "pkg-4.0.7-neoforge-1.20.4" = _eFVBRJ4C;
        "pkg-4.0.7-forge-1.19.2" = _mhGayNIV;
        "pkg-4.0.7-fabric-1.19.2" = _FP7ViF5n;
        "pkg-4.0.7-forge-1.18.2" = _Gg3k4bmo;
        "pkg-4.0.7-fabric-1.18.2" = _PYyLV5gL;
        "pkg-4.0.7-forge-1.16.5" = _vlpWM7as;
