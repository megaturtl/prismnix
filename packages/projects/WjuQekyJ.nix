...
let
    ...
    in {
        ...
        "minecraft-1.19" = _mdHAIszF;
        "minecraft-1.19.1" = _mdHAIszF;
        "minecraft-1.19.2" = _mdHAIszF;
        "minecraft-1.19.3" = _mdHAIszF;
        "minecraft-1.19.4" = _mdHAIszF;
        "minecraft-1.20.3" = _mdHAIszF;
        "minecraft-1.20.4" = _mdHAIszF;
        "minecraft-1.20.5" = _mdHAIszF;
        "minecraft-1.20.6" = _mdHAIszF;
        "minecraft-26.1" = _mdHAIszF;
        "minecraft-26.1.1" = _mdHAIszF;
        "minecraft-26.1.2" = _mdHAIszF;
        "minecraft-26.2" = _mdHAIszF;
        "pkg-1.0" = _GSflICGV;
        "pkg-1.1" = _mdHAIszF;
        "default" = _mdHAIszF;
    });
