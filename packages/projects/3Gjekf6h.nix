...
let
    versions = (let
        ...
        _n5P4b1Vk = {
            "id" = "n5P4b1Vk";
            "file" = "LifeSteal_datapack.zip";
            "hash" = "sha512-opI+GMkjmXb8jSuInfgbofASKHJQwFzdS0YyGFzvNFCj2GOj+oHU/mbp8TcKe0P12fgkp1yKxmYDXAKc+y9Gmw==";
        };
        _SOtfvf9Y = {
            "id" = "SOtfvf9Y";
            "file" = "LifeSteal_fabric_mod.jar";
            "hash" = "sha512-b7Zd+AWVp/hw1AwVjtDGK9yTLLmawtS/iFtht65URVcGZg3y0cWlZ7xU045a/izmUHVoaTiLV3SaOS1Bm0V/VQ==";
        };
        _pPGm5aKe = {
            "id" = "pPGm5aKe";
            "file" = "LifeSteal_forge_mod.jar";
            "hash" = "sha512-du8jKudW9V6eshNAQaiQ+Sdo0Hc2CsUwd5WlnwhR+wJ3fav8BGfp3NFj58JkftInKroTpiP+Ohpv+WzeXwBblw==";
        };
        _Pg5LZbG4 = {
            "id" = "Pg5LZbG4";
            "file" = "LifeSteal_neoforge_mod.jar";
            "hash" = "sha512-/pMhYBcgWjHI1yrgDlT5TmBFXS0GP8IC5O2N3ewIRIFLRGhnqzF0eNN8kY+XywwejuX0WzO9SC9Cjvqh3teDbQ==";
        };
        _XudpKRPD = {
            "id" = "XudpKRPD";
            "file" = "LifeSteal_quilt_mod.jar";
            "hash" = "sha512-QYCSIxhxqlwpglEPE3ONNfGlKyj4/xy4QAG/CpT0W2BnHjtLnuY9h4uq4+gyH0nOVpYWE64nVHm8LgqUmNcP5A==";
        };
        _HrDHcbUa = {
            "id" = "HrDHcbUa";
            "file" = "LifeSteal_datapack.zip";
            "hash" = "sha512-CXFhEZuMKvcOTuHRNwiR4RoWRJszj57KNcRVke7uYmZn8s+63/MNG9Dhku8jm2OlTXjUHqOX77lSSYKz2Cp3Ew==";
        };
        _d72dbRUo = {
            "id" = "d72dbRUo";
            "file" = "LifeSteal_fabric_mod.jar";
            "hash" = "sha512-oEC/gb9W5ynWfe2b0IKGqnu/ELWxBhI0Zu8YFXobzUqx61jo354ltrLZ1nBxaPesJ2lDJzN1N20zrdOTT+Y1HQ==";
        };
        _vfReCdfJ = {
            "id" = "vfReCdfJ";
            "file" = "LifeSteal_forge_mod.jar";
            "hash" = "sha512-SVtP6buDMh4F9T0QDnSz6Gp0yg7ntAdp7MHC+cx4LA+XxNdvWnGrJIEJsi5atssk3b9UrVz4xblg8VLSNnmnAw==";
        };
        _aEuTpzFm = {
            "id" = "aEuTpzFm";
            "file" = "LifeSteal_neoforge_mod.jar";
            "hash" = "sha512-t3UlnibCJ3nS/2VeBzAPaIEMrK/NU4NilLNpMYLBTgrJStK7G804A2SRq8b+Lav6TYOPqrEUNzvgCgCeghBDrA==";
        };
        _sg5OSRiD = {
            "id" = "sg5OSRiD";
            "file" = "LifeSteal_quilt_mod.jar";
            "hash" = "sha512-kY57bLDrIPvb9z99Mu2hAaiVdcs+h/hboQWOcl+4Spz4Iz3Os3J9mD3IOCk1xtzVqpxVbzn9oFWt+l48hOkmQA==";
        };
    in {
        "ZuM0TMXn" = _ZuM0TMXn;
        "XT6b2Fa3" = _XT6b2Fa3;
        ...
        "datapack-1.21.5" = _n5P4b1Vk;
        "datapack-25w15a" = _oqK2hynB;
        "datapack-25w16a" = _oqK2hynB;
        "datapack-25w21a" = _Ew1Vysto;
        "datapack-1.21.6-pre3" = _GTCMbIbS;
        "datapack-1.21.6" = _n5P4b1Vk;
        "datapack-1.21.7" = _n5P4b1Vk;
        "datapack-1.21.8" = _n5P4b1Vk;
        "datapack-1.21.9" = _n5P4b1Vk;
        "datapack-1.21.10" = _n5P4b1Vk;
        ...
        "datapack-26.1" = _n5P4b1Vk;
        "datapack-26.1.1" = _n5P4b1Vk;
        "datapack-26.1.2" = _n5P4b1Vk;
        "datapack-26.2" = _n5P4b1Vk;
        "datapack-26.3-snapshot-1" = _n5P4b1Vk;
        "datapack-26.3-snapshot-2" = _n5P4b1Vk;
        "datapack-26.3-snapshot-3" = _n5P4b1Vk;
        "datapack-26.3-snapshot-4" = _n5P4b1Vk;
        "datapack-26.3-snapshot-5" = _n5P4b1Vk;
        "datapack-26.3-snapshot-6" = _n5P4b1Vk;
        "datapack-26.3-snapshot-7" = _n5P4b1Vk;
        "datapack-26.3-snapshot-8" = _n5P4b1Vk;
        "datapack-26.3" = _HrDHcbUa;
        "fabric-1.21" = _XT6b2Fa3;
        "fabric-1.21.4" = _VuzznycG;
        "fabric-1.21.5" = _SOtfvf9Y;
        "fabric-25w21a" = _IJxEXfLq;
        "fabric-1.21.6-pre3" = _5kGDKmUS;
        "fabric-1.21.6" = _SOtfvf9Y;
        "fabric-1.21.7" = _SOtfvf9Y;
        "fabric-1.21.8" = _SOtfvf9Y;
        "fabric-1.21.9" = _SOtfvf9Y;
        "fabric-1.21.10" = _SOtfvf9Y;
        ...
        "fabric-1.21.11" = _SOtfvf9Y;
        "fabric-26.1-snapshot-1" = _QUJ7vYJZ;
        "fabric-26.1-snapshot-2" = _QUJ7vYJZ;
        "fabric-26.1-pre-1" = _uihVYpFV;
        "fabric-26.1-pre-2" = _uihVYpFV;
        "fabric-26.1" = _SOtfvf9Y;
        "fabric-26.1.1" = _SOtfvf9Y;
        "fabric-26.1.2" = _SOtfvf9Y;
        "fabric-26.2" = _SOtfvf9Y;
        "fabric-26.3-snapshot-1" = _SOtfvf9Y;
        "fabric-26.3-snapshot-2" = _SOtfvf9Y;
        "fabric-26.3-snapshot-3" = _SOtfvf9Y;
        "fabric-26.3-snapshot-4" = _SOtfvf9Y;
        "fabric-26.3-snapshot-5" = _SOtfvf9Y;
        "fabric-26.3-snapshot-6" = _SOtfvf9Y;
        "fabric-26.3-snapshot-7" = _SOtfvf9Y;
        "fabric-26.3-snapshot-8" = _SOtfvf9Y;
        "fabric-26.3" = _d72dbRUo;
        "forge-1.21" = _XT6b2Fa3;
        "forge-1.21.4" = _VuzznycG;
        "forge-1.21.5" = _pPGm5aKe;
        "forge-25w21a" = _IJxEXfLq;
        "forge-1.21.6-pre3" = _5kGDKmUS;
        "forge-1.21.6" = _pPGm5aKe;
        "forge-1.21.7" = _pPGm5aKe;
        "forge-1.21.8" = _pPGm5aKe;
        "forge-1.21.9" = _pPGm5aKe;
        "forge-1.21.10" = _pPGm5aKe;
        ...
        "forge-1.21.11" = _pPGm5aKe;
        "forge-26.1-snapshot-1" = _XFmquIaQ;
        "forge-26.1-snapshot-2" = _XFmquIaQ;
        "forge-26.1-pre-1" = _RRpIBPBk;
        "forge-26.1-pre-2" = _RRpIBPBk;
        "forge-26.1" = _pPGm5aKe;
        "forge-26.1.1" = _pPGm5aKe;
        "forge-26.1.2" = _pPGm5aKe;
        "forge-26.2" = _pPGm5aKe;
        "forge-26.3-snapshot-1" = _pPGm5aKe;
        "forge-26.3-snapshot-2" = _pPGm5aKe;
        "forge-26.3-snapshot-3" = _pPGm5aKe;
        "forge-26.3-snapshot-4" = _pPGm5aKe;
        "forge-26.3-snapshot-5" = _pPGm5aKe;
        "forge-26.3-snapshot-6" = _pPGm5aKe;
        "forge-26.3-snapshot-7" = _pPGm5aKe;
        "forge-26.3-snapshot-8" = _pPGm5aKe;
        "forge-26.3" = _vfReCdfJ;
        "quilt-1.21" = _XT6b2Fa3;
        "quilt-1.21.4" = _VuzznycG;
        "quilt-1.21.5" = _XudpKRPD;
        "quilt-25w21a" = _IJxEXfLq;
        "quilt-1.21.6-pre3" = _5kGDKmUS;
        "quilt-1.21.6" = _XudpKRPD;
        "quilt-1.21.7" = _XudpKRPD;
        "quilt-1.21.8" = _XudpKRPD;
        "quilt-1.21.9" = _XudpKRPD;
        "quilt-1.21.10" = _XudpKRPD;
        ...
        "quilt-1.21.11" = _XudpKRPD;
        "quilt-26.1-snapshot-1" = _KRkcxSXb;
        "quilt-26.1-snapshot-2" = _KRkcxSXb;
        "quilt-26.1-pre-1" = _glhxC2CJ;
        "quilt-26.1-pre-2" = _glhxC2CJ;
        "quilt-26.1" = _XudpKRPD;
        "quilt-26.1.1" = _XudpKRPD;
        "quilt-26.1.2" = _XudpKRPD;
        "quilt-26.2" = _XudpKRPD;
        "quilt-26.3-snapshot-1" = _XudpKRPD;
        "quilt-26.3-snapshot-2" = _XudpKRPD;
        "quilt-26.3-snapshot-3" = _XudpKRPD;
        "quilt-26.3-snapshot-4" = _XudpKRPD;
        "quilt-26.3-snapshot-5" = _XudpKRPD;
        "quilt-26.3-snapshot-6" = _XudpKRPD;
        "quilt-26.3-snapshot-7" = _XudpKRPD;
        "quilt-26.3-snapshot-8" = _XudpKRPD;
        "quilt-26.3" = _sg5OSRiD;
        "neoforge-1.21.4" = _VuzznycG;
        "neoforge-1.21.5" = _Pg5LZbG4;
        "neoforge-25w21a" = _IJxEXfLq;
        "neoforge-1.21.6-pre3" = _5kGDKmUS;
        "neoforge-1.21.6" = _Pg5LZbG4;
        "neoforge-1.21.7" = _Pg5LZbG4;
        "neoforge-1.21.8" = _Pg5LZbG4;
        "neoforge-1.21.9" = _Pg5LZbG4;
        "neoforge-1.21.10" = _Pg5LZbG4;
        ...
        "neoforge-26.1" = _Pg5LZbG4;
        "neoforge-26.1.1" = _Pg5LZbG4;
        "neoforge-26.1.2" = _Pg5LZbG4;
        "neoforge-26.2" = _Pg5LZbG4;
        "neoforge-26.3-snapshot-1" = _Pg5LZbG4;
        "neoforge-26.3-snapshot-2" = _Pg5LZbG4;
        "neoforge-26.3-snapshot-3" = _Pg5LZbG4;
        "neoforge-26.3-snapshot-4" = _Pg5LZbG4;
        "neoforge-26.3-snapshot-5" = _Pg5LZbG4;
        "neoforge-26.3-snapshot-6" = _Pg5LZbG4;
        "neoforge-26.3-snapshot-7" = _Pg5LZbG4;
        "neoforge-26.3-snapshot-8" = _Pg5LZbG4;
        "neoforge-26.3" = _aEuTpzFm;
        "pkg-1.0.0" = _ZuM0TMXn;
        "pkg-1.0.0+mod" = _XT6b2Fa3;
        "pkg-1.1.0" = _G1wAOMe4;
        "pkg-1.1.1" = _sJT8iwpL;
        "pkg-1.1.1+mod" = _VuzznycG;
        "pkg-1.2.1" = _EM5wbNWE;
        "pkg-1.2.1+mod" = _eM5Pusz1;
        "pkg-1.2.2" = _wkNtthJR;
        "pkg-1.2.2+mod" = _sDPdHSkc;
        "pkg-1.2.3" = _oqK2hynB;
        "pkg-1.2.3+mod" = _sCCk0V6F;
        "pkg-1.2.4" = _Ew1Vysto;
        "pkg-1.2.4+mod" = _IJxEXfLq;
        "pkg-1.2.5" = _GTCMbIbS;
        "pkg-1.2.5+mod" = _5kGDKmUS;
        "pkg-1.2.6" = _ShRAnYYY;
        "pkg-1.2.6+mod" = _1XbajQa3;
        "pkg-1.2.7" = _Mo1ZBrFu;
        "pkg-1.2.7+mod" = _bHGwIPSk;
        "pkg-1.2.8" = _hG4kFjJS;
        "pkg-1.2.8+mod" = _mrOUKF8n;
        "pkg-1.2.9" = _Isz5D2He;
        "pkg-1.2.9+mod" = _aZ7SD8ga;
        "pkg-1.2.10" = _qsKpj7Xp;
        "pkg-1.2.10+mod" = _w8J7uEpC;
        "pkg-1.2.11" = _m8xNpWWj;
        "pkg-1.2.11+mod" = _WWM5YjWX;
        "pkg-1.3.0" = _GX9rRUoE;
        "pkg-1.3.0+mod" = _3wYuASKd;
        "pkg-1.3.1" = _tj6HdFvS;
        "pkg-1.3.1+mod" = _ojelZu1e;
        "pkg-1.3.2" = _8wiK80M1;
        "pkg-1.3.2+fabric" = _M8icRYwJ;
        "pkg-1.3.2+forge" = _qYEb5GEI;
        "pkg-1.3.2+neoforge" = _2sQ4DacE;
        "pkg-1.3.2+quilt" = _BOuoLj44;
        "pkg-1.3.3" = _1AMpU2E8;
        "pkg-1.3.3+fabric" = _3KNaXeLV;
        "pkg-1.3.3+forge" = _nLsJ5eWC;
        "pkg-1.3.3+neoforge" = _ZCqrHNeL;
        "pkg-1.3.3+quilt" = _OuJqRz0j;
        "pkg-1.3.4" = _hNKdJuqg;
        "pkg-1.3.4+fabric" = _BwlPVOJb;
        "pkg-1.3.4+forge" = _TFgrGwdh;
        "pkg-1.3.4+neoforge" = _2sYgbTeB;
        "pkg-1.3.4+quilt" = _7vZfP5Ns;
        "pkg-1.3.5" = _uATyVJjq;
        "pkg-1.3.5+fabric" = _jpBYZWTj;
        "pkg-1.3.5+forge" = _JDexjMPA;
        "pkg-1.3.5+neoforge" = _HRF1k9xL;
        "pkg-1.3.5+quilt" = _rgy1ljsE;
        "pkg-1.4.0" = _zwZTsiIJ;
        "pkg-1.4.0+fabric" = _iZcmpV4I;
        "pkg-1.4.0+forge" = _bxzTtIVo;
        "pkg-1.4.0+neoforge" = _jS355Fxr;
        "pkg-1.4.0+quilt" = _NZSwln02;
        "pkg-1.4.1" = _d8Pc60QK;
        "pkg-1.4.1+fabric" = _GZ9sH5mn;
        "pkg-1.4.1+forge" = _YdTnjwtG;
        "pkg-1.4.1+neoforge" = _D0ATF2Wd;
        "pkg-1.4.1+quilt" = _l6ZDGZKF;
        "pkg-1.5.0" = _mr2SRwwy;
        "pkg-1.5.0+fabric" = _1B5OMlGH;
        "pkg-1.5.0+forge" = _ZVfdaZXJ;
        "pkg-1.5.0+neoforge" = _C23YzZvm;
        "pkg-1.5.0+quilt" = _5OL4ow03;
        "pkg-1.5.1" = _DFsQ4Bjr;
        "pkg-1.5.1+fabric" = _2g0wvUDb;
        "pkg-1.5.1+forge" = _IAQ724cL;
        "pkg-1.5.1+neoforge" = _mnlcN5ZK;
        "pkg-1.5.1+quilt" = _4QjDk6rK;
        "pkg-1.6.0" = _C4qHIlHC;
        "pkg-1.6.0+fabric" = _be58KIzI;
        "pkg-1.6.0+forge" = _sEif2ncb;
        "pkg-1.6.0+neoforge" = _9p7jYAtr;
        "pkg-1.6.0+quilt" = _naPTVazy;
        "pkg-1.7.0" = _TN7Goacb;
        "pkg-1.7.0+fabric" = _uBeEqd9K;
        "pkg-1.7.0+forge" = _DNKdrc9I;
        "pkg-1.7.0+neoforge" = _F76S2L5Z;
        "pkg-1.7.0+quilt" = _bHsN2vHr;
        "pkg-1.7.1" = _Y69QOUDW;
        "pkg-1.7.1+fabric" = _qhOWtEIg;
        "pkg-1.7.1+forge" = _rS4olnJK;
        "pkg-1.7.1+neoforge" = _2RIK7hEM;
        "pkg-1.7.1+quilt" = _79cyZOsa;
        "pkg-1.7.2" = _dZSB8EsC;
        "pkg-1.7.2+fabric" = _SDKHRmNq;
        "pkg-1.7.2+forge" = _hiinCDHs;
        "pkg-1.7.2+neoforge" = _QqVnnCp9;
        "pkg-1.7.2+quilt" = _RNkbkZ3I;
        "pkg-1.7.3" = _b4TidROR;
        "pkg-1.7.3+fabric" = _bi225K0H;
        "pkg-1.7.3+forge" = _qcueYx7k;
        "pkg-1.7.3+neoforge" = _mEUbcV8Z;
        "pkg-1.7.3+quilt" = _Q0gK5GiY;
        "pkg-1.8.0" = _D4tQGDOc;
        "pkg-1.8.0+fabric" = _lOgoSiyI;
        "pkg-1.8.0+forge" = _tQeeFP85;
        "pkg-1.8.0+neoforge" = _7o3eTYIx;
        "pkg-1.8.0+quilt" = _eR5EqPKM;
        "pkg-1.9.0" = _4AyOpITu;
        "pkg-1.9.0+fabric" = _RwZuPfw7;
        "pkg-1.9.0+forge" = _sOODvlEq;
        "pkg-1.9.0+neoforge" = _bZPdPyNl;
        "pkg-1.9.0+quilt" = _D4XsJpXy;
        "pkg-2.0.0" = _zbFXEl0X;
        "pkg-2.0.0+fabric" = _ThnT1iTZ;
        "pkg-2.0.0+forge" = _TjMHmzY0;
        "pkg-2.0.0+neoforge" = _l2YTRVPq;
        "pkg-2.0.0+quilt" = _TKwbFqqT;
        "pkg-2.0.1" = _yuTh4srk;
        "pkg-2.0.1+fabric" = _QUJ7vYJZ;
        "pkg-2.0.1+forge" = _XFmquIaQ;
        "pkg-2.0.1+neoforge" = _DjyAbP4z;
        "pkg-2.0.1+quilt" = _KRkcxSXb;
        "pkg-2.0.2" = _jBItjGVA;
        "pkg-2.0.2+fabric" = _uihVYpFV;
        "pkg-2.0.2+forge" = _RRpIBPBk;
        "pkg-2.0.2+neoforge" = _vXvFMHPI;
        "pkg-2.0.2+quilt" = _glhxC2CJ;
        "pkg-2.1.0" = _LsWN9wm0;
        "pkg-2.1.0+fabric" = _AyAEaJ9W;
        "pkg-2.1.0+forge" = _GJptJqPP;
        "pkg-2.1.0+neoforge" = _vckEj4rO;
        "pkg-2.1.0+quilt" = _lfwkyqo7;
        "pkg-2.1.1" = _VUMxfCw1;
        "pkg-2.1.1+fabric" = _5S1nNKup;
        "pkg-2.1.1+forge" = _JKat8p68;
        "pkg-2.1.1+neoforge" = _zZQ9w8Vs;
        "pkg-2.1.1+quilt" = _1BM1sSLU;
        "pkg-2.1.2" = _ClrppcYJ;
        "pkg-2.1.2+fabric" = _QmwTpp1w;
        "pkg-2.1.2+forge" = _5NPEjHur;
        "pkg-2.1.2+neoforge" = _R6LrwgxI;
        "pkg-2.1.2+quilt" = _pJV5GJ9w;
        "pkg-2.2.0" = _8b0qy5zy;
        "pkg-2.2.0+fabric" = _InOwxqI3;
        "pkg-2.2.0+forge" = _Cy6aETdO;
        "pkg-2.2.0+neoforge" = _QaJgCGzC;
        "pkg-2.2.0+quilt" = _8R8zlMel;
        "pkg-2.2.1" = _pcIeSI98;
        "pkg-2.2.1+fabric" = _UjemHLGr;
        "pkg-2.2.1+forge" = _ikVVdVOR;
        "pkg-2.2.1+neoforge" = _rHz9kvrL;
        "pkg-2.2.1+quilt" = _MWQj8TvK;
        "pkg-2.2.2" = _SmrqGCEe;
        "pkg-2.2.2+fabric" = _zqrYKdt5;
        "pkg-2.2.2+forge" = _Uj7q0opu;
        "pkg-2.2.2+neoforge" = _2rzgLB4g;
        "pkg-2.2.2+quilt" = _dpLYCOlS;
        "pkg-2.3.0" = _qjCS4pSd;
        "pkg-2.3.0+fabric" = _JkO5mXwO;
        "pkg-2.3.0+forge" = _DHiFHIt9;
        "pkg-2.3.0+neoforge" = _LdWFzmM0;
        "pkg-2.3.0+quilt" = _o6b5gbnp;
        "pkg-2.3.1" = _tGMPTBLc;
        "pkg-2.3.1+fabric" = _F3Iymjzu;
        "pkg-2.3.1+forge" = _cj6kFPNy;
        "pkg-2.3.1+neoforge" = _zJ0j4U9O;
        "pkg-2.3.1+quilt" = _NfLywKqe;
        "pkg-2.4.0" = _50OATD39;
        "pkg-2.4.0+fabric" = _WZu9pCNp;
        "pkg-2.4.0+forge" = _glbHbbBr;
        "pkg-2.4.0+neoforge" = _oPMaoDXW;
        "pkg-2.4.0+quilt" = _a8kpQ5AW;
        "pkg-2.5.0" = _n5P4b1Vk;
        "pkg-2.5.0+fabric" = _SOtfvf9Y;
        "pkg-2.5.0+forge" = _pPGm5aKe;
        "pkg-2.5.0+neoforge" = _Pg5LZbG4;
        "pkg-2.5.0+quilt" = _XudpKRPD;
        "pkg-2.5.1" = _HrDHcbUa;
        "pkg-2.5.1+fabric" = _d72dbRUo;
        "pkg-2.5.1+forge" = _vfReCdfJ;
        "pkg-2.5.1+neoforge" = _aEuTpzFm;
        "pkg-2.5.1+quilt" = _sg5OSRiD;
        "default" = _sg5OSRiD;
    });
