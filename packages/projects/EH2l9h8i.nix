...
let
    versions = (let
        ...
        _shwFNFs2 = {
            "id" = "shwFNFs2";
            "file" = "Orderium-2.3.0.jar";
            "hash" = "sha512-x8LH13tLS0nqGPfHH4884tTtSPu6hz/TxlCU9FXkUY+zK8HdqjuqqXGzBKBOUmdPK7xddTauPR69DAvmlOlDCw==";
        };
    in {
        "jiBYbWQb" = _jiBYbWQb;
        "aj52ytUq" = _aj52ytUq;
        ...
        "gvBQ1agy" = _gvBQ1agy;
        "shwFNFs2" = _shwFNFs2;
        "folia-1.21.7" = _shwFNFs2;
        "folia-1.21.8" = _shwFNFs2;
        "folia-1.21.9" = _shwFNFs2;
        "folia-1.21.10" = _shwFNFs2;
        "folia-1.21.11" = _shwFNFs2;
        "folia-26.1" = _shwFNFs2;
        "folia-26.1.1" = _shwFNFs2;
        "folia-26.1.2" = _shwFNFs2;
        "folia-26.2" = _shwFNFs2;
        "paper-1.21.7" = _shwFNFs2;
        "paper-1.21.8" = _shwFNFs2;
        "paper-1.21.9" = _shwFNFs2;
        "paper-1.21.10" = _shwFNFs2;
        "paper-1.21.11" = _shwFNFs2;
        "paper-26.1" = _shwFNFs2;
        "paper-26.1.1" = _shwFNFs2;
        "paper-26.1.2" = _shwFNFs2;
        "paper-26.2" = _shwFNFs2;
        "purpur-1.21.7" = _shwFNFs2;
        "purpur-1.21.8" = _shwFNFs2;
        "purpur-1.21.9" = _shwFNFs2;
        "purpur-1.21.10" = _shwFNFs2;
        "purpur-1.21.11" = _shwFNFs2;
        "purpur-26.1" = _shwFNFs2;
        "purpur-26.1.1" = _shwFNFs2;
        "purpur-26.1.2" = _shwFNFs2;
        "purpur-26.2" = _shwFNFs2;
        "pkg-1.3.0.rc-2" = _jiBYbWQb;
        "pkg-1.3.0" = _aj52ytUq;
        "pkg-1.3.1" = _mY0uAKJ6;
        "pkg-1.3.2" = _HZZmiA0s;
        "pkg-1.3.3" = _mLNlcjdL;
        "pkg-1.3.5" = _KSckkb68;
        "pkg-1.3.5+1" = _iMa0Fj1M;
        "pkg-1.3.5+2" = _sbp3bXsk;
        "pkg-1.3.6" = _hLK2XMXz;
        "pkg-1.3.7" = _pAKGFJK5;
        "pkg-1.3.7+1" = _Z57OGUL6;
        "pkg-1.4.0" = _7f3OKM5k;
        "pkg-1.5.0" = _BoPFMvdm;
        "pkg-1.6.0" = _ohxxds1k;
        "pkg-1.6.1" = _yJ2560Fn;
