...
let
    versions = (let
        ...
        _SFPRPNRa = {
            "id" = "SFPRPNRa";
            "file" = "toolstats-2.0.7.jar";
            "hash" = "sha512-qMWgWTf8H6RM2TELkLR2HI0mEDYt5oOSXpg9cHcwJV4WtsfqBgaMXUNEAy/h20UIrDsruWHs0T6VNeDt1OXSjg==";
        };
    in {
        "qafvXqMU" = _qafvXqMU;
        "LET9IhdO" = _LET9IhdO;
        ...
        "paper-1.21.2" = _SFPRPNRa;
        "paper-1.21.3" = _SFPRPNRa;
        "paper-1.21.4" = _SFPRPNRa;
        "paper-1.21.5" = _SFPRPNRa;
        "paper-1.21.6" = _SFPRPNRa;
        "paper-1.21.7" = _SFPRPNRa;
        "paper-1.21.8" = _SFPRPNRa;
        "paper-1.21.9" = _SFPRPNRa;
        "paper-1.21.10" = _SFPRPNRa;
        "paper-1.21.11" = _SFPRPNRa;
        "paper-26.1" = _SFPRPNRa;
        "paper-26.1.1" = _SFPRPNRa;
        "paper-26.1.2" = _SFPRPNRa;
        "paper-26.2" = _SFPRPNRa;
        ...
        "purpur-1.21.2" = _SFPRPNRa;
        "purpur-1.21.3" = _SFPRPNRa;
        "purpur-1.21.4" = _SFPRPNRa;
        "purpur-1.21.5" = _SFPRPNRa;
        "purpur-1.21.6" = _SFPRPNRa;
        "purpur-1.21.7" = _SFPRPNRa;
        "purpur-1.21.8" = _SFPRPNRa;
        "purpur-1.21.9" = _SFPRPNRa;
        "purpur-1.21.10" = _SFPRPNRa;
        "purpur-1.21.11" = _SFPRPNRa;
        "purpur-26.1" = _SFPRPNRa;
        "purpur-26.1.1" = _SFPRPNRa;
        "purpur-26.1.2" = _SFPRPNRa;
        "purpur-26.2" = _SFPRPNRa;
        ...
        "folia-1.21.2" = _SFPRPNRa;
        "folia-1.21.3" = _SFPRPNRa;
        "folia-1.21.4" = _SFPRPNRa;
        "folia-1.21.5" = _SFPRPNRa;
        "folia-1.21.6" = _SFPRPNRa;
        "folia-1.21.7" = _SFPRPNRa;
        "folia-1.21.8" = _SFPRPNRa;
        "folia-1.21.9" = _SFPRPNRa;
        "folia-1.21.10" = _SFPRPNRa;
        "folia-1.21.11" = _SFPRPNRa;
        "folia-26.1" = _SFPRPNRa;
        "folia-26.1.1" = _SFPRPNRa;
        "folia-26.1.2" = _SFPRPNRa;
        "folia-26.2" = _SFPRPNRa;
        "pkg-1.4.4" = _qafvXqMU;
        "pkg-1.4.5" = _LET9IhdO;
        "pkg-1.5" = _uKU0mHG0;
        "pkg-1.6" = _RdC1v8J9;
        ...
        "pkg-1.9" = _JmdGM9Om;
        "pkg-1.9.1" = _69uP8umj;
        "pkg-1.9.2-hotfix" = _TDu8afuM;
        "pkg-1.9.2-hotfix-2" = _745h8oRS;
        "pkg-1.9.3" = _SjchxMCC;
        "pkg-1.9.4" = _OsGj5Cj7;
        "pkg-1.9.5" = _qF0PeTJ5;
        "pkg-1.9.6" = _B4q75DQ7;
        ...
        "pkg-1.9.8" = _ZwRzmY79;
        "pkg-1.9.9" = _BBTtnFnQ;
        "pkg-1.9.10" = _PkJPqmkC;
        "pkg-1.9.11" = _17US5e8F;
        "pkg-2.0" = _O7e654ku;
        "pkg-2.0.1" = _Srl4g368;
        "pkg-2.0.2" = _NXTVhbOa;
        "pkg-2.0.3" = _H6XxEees;
