...
let
    ...
    in {
        ...
        "pkg-1.1" = _iQGzdVQ7;
        "pkg-1.1.1+mod" = _bOyyg1bO;
        "pkg-1.2" = _z5XU0K7G;
        "pkg-1.2.1+mod" = _fLNiknAj;
        "pkg-1.3" = _D7WRDjFd;
        "pkg-1.3.1+mod" = _V4oXlIME;
        "pkg-1.4" = _78WB0I15;
        "pkg-1.4.1+mod" = _ILjt9nwH;
        "pkg-1.5" = _lEwa4f8I;
        "pkg-1.5.1+mod" = _NcHMKcL4;
        "pkg-1.6" = _bVN64fBX;
        "pkg-1.6.1+mod" = _QLQURsn3;
        "pkg-1.7" = _sVzOpPyz;
        "pkg-1.7.1+mod" = _eR2Ujxjw;
        "pkg-1.8" = _U33arZjE;
        "pkg-1.8.1+mod" = _lClvyrX9;
        "pkg-1.9" = _smKzDw0h;
