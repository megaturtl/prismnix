...
let
    ...
    in {
        ...
        "pkg-3.0.1" = _ecK3nPM9;
        "pkg-3.0.2" = _I7ynoiGK;
        "pkg-3.0.2-26.1-snpashot4" = _o522dSbb;
        "pkg-3.0.2-26.1-snapshot6" = _L4zTKzSU;
        "pkg-3.0.0-26.1-snapshot7" = _1qYEEWsg;
        "pkg-3.0.3" = _9jd7HKUY;
        "pkg-3.0.3-26.1" = _TmO3TgVY;
        "pkg-3.0.3-26.2snapsho2" = _YX8eCNvt;
        "pkg-3.0.5-26.2-snapshot6" = _IiL925y0;
        "pkg-3.0.3-26.2-snapshot7" = _lYb1YIk3;
        "pkg-3.0.3-26.2-snapshot8" = _YZRd32lD;
        "pkg-4.0.0-26.2-pre3" = _WdQDMVye;
        "pkg-4.0.0-26.2rc2" = _RoMraXEH;
        "pkg-4.0.0-26.2" = _MCSNwXe8;
