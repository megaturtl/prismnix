...
let
    ...
    in {
        ...
        "pkg-1.1" = _ZciJk8nY;
        "pkg-1.1+mod" = _hzEACvXG;
        "pkg-1.2" = _qpORZOZE;
        "pkg-1.2+mod" = _sxRPhYrW;
        "pkg-1.3" = _MPFCIhWw;
        "pkg-1.3+mod" = _t71nzmdJ;
        "pkg-1.4" = _UG1mUH77;
        "pkg-1.4+mod" = _bavLaoqA;
        "pkg-1.5" = _Jaroa2b2;
        "pkg-1.5+mod" = _59UwEgoY;
        "pkg-1.6" = _QSxrva1t;
        "pkg-1.6+mod" = _aYMiRvrx;
        "pkg-1.7" = _C8Vm8ZPu;
        "pkg-1.7+mod" = _9b0ew6sF;
        "pkg-1.8" = _oDYlTrF5;
        "pkg-1.8+mod" = _f9yXMdYp;
        "pkg-1.9" = _hGG1sr7z;
        "pkg-1.9+mod" = _4vzfhPVa;
        "pkg-2.0" = _sCyj9ReB;
