...
let
    versions = (let
        ...
        _G7EwzOUX = {
            "id" = "G7EwzOUX";
            "file" = "wormhole-1.1.16a-forge-mc26.2.jar";
            "hash" = "sha512-oJp1MaokbCY+UErfWF/dU2gMGP08PtHUYyvyy+ucZcwDTzue7rDFLm1ZX3aR0TmFh9hID3k4FMwHIFFr3zaIqg==";
        };
        _u8Hue0QR = {
            "id" = "u8Hue0QR";
            "file" = "wormhole-1.1.17-forge-mc1.12.jar";
            "hash" = "sha512-9wqllvO3+0k90j4tl5h/hzuampfQuax9131ilC4hvStUjEJ8uhZe6+jxNK+GBWTWg4mGe6tLALoOR06TeiKZDg==";
        };
        _tBOfnztI = {
            "id" = "tBOfnztI";
            "file" = "wormhole-1.1.17-forge-mc1.14.jar";
            "hash" = "sha512-o92/jCext+MRqqZTEYq3CkbFSM4czNkII8IZ2Mos8m//mt2OKWpGDLyEm+gZiLzWm+Q+7lE8Lp4+mYb6fzpWGg==";
        };
        _KasPkv44 = {
            "id" = "KasPkv44";
            "file" = "wormhole-1.1.17-forge-mc1.15.jar";
            "hash" = "sha512-hb+ehWdDObZ9KUCCgKDJAvkBWDe0HetzIaHmK8OHaBS44Uctsg1lFgHM2KkmZqE3CQJLqwqTBVZXRw25HmqO3g==";
        };
        _8vZ2Egna = {
            "id" = "8vZ2Egna";
            "file" = "wormhole-1.1.17-forge-mc1.16.jar";
            "hash" = "sha512-2LfDQ4+IhfitTHRzWOMqLHmaeAUC5wdjlNNoBw9hG2/of1adUvHI03Ws6rtUPBERpCLxhpRyPJLQ3AFiTehRhw==";
        };
        _ZpnHibeq = {
            "id" = "ZpnHibeq";
            "file" = "wormhole-1.1.17-forge-mc1.17.jar";
            "hash" = "sha512-LPfFOA20QpBkDDB/X4cFbU+zRx+YBw1Z8R9MIU8EVl7wfN55Yd9/33xSzcRBggqKRakyMPYe3qFEGxJeZscmXA==";
        };
        _Ep52LiSv = {
            "id" = "Ep52LiSv";
            "file" = "wormhole-1.1.17-forge-mc1.18.jar";
            "hash" = "sha512-FirbzDb78SZBineU/NKGEPbjrl9jPtAPzFeot/yQH5UdgY4AaOA246wtL/lVPeoXlTb7VJnCP2ndO0Xi0Fqvnw==";
        };
        _eXQ3tQDQ = {
            "id" = "eXQ3tQDQ";
            "file" = "wormhole-1.1.17-forge-mc1.19.2.jar";
            "hash" = "sha512-2PEegRRtNZKJaxDxqLkJa87gs0EsoUkwt3Wt6iOLsEREgq6ZuXp9pEV4DAuu+dwbVc+P6a84GFvCgFxmA34fIw==";
        };
        _S6VazavR = {
            "id" = "S6VazavR";
            "file" = "wormhole-1.1.17-forge-mc1.19.3.jar";
            "hash" = "sha512-xGA84OEoTOaY8zGahICaXVjWJLqvwR9R8bHrqMLuhRRVvyRfm6GX2EsLGgq07JoS1NdmnVR6MUFuQNYwQLDVhg==";
        };
        _cHT0O53k = {
            "id" = "cHT0O53k";
            "file" = "wormhole-1.1.17-forge-mc1.19.4.jar";
            "hash" = "sha512-joCj2lFDrmEiWSzBkmYE1Q1glHgCRmr6VvoX2S+EFRH+BwDbzCmgF6LdMmXBuMsfeWU9stI9cn95gPB7lAyDUw==";
        };
        _CUsu6Cib = {
            "id" = "CUsu6Cib";
            "file" = "wormhole-1.1.17-forge-mc1.20.1.jar";
            "hash" = "sha512-XGxH6t3ouMrw1J+AhlVQ4+TPBmieq1QDB+n2B9GZoozy32d9Hl1BgUg2C3Xke4Ghu5ULtwtBuA28NVNvhZ40Tw==";
        };
        _WtnQyo8w = {
            "id" = "WtnQyo8w";
            "file" = "wormhole-1.1.17-forge-mc1.20.2.jar";
            "hash" = "sha512-bMRLYUQifj+AD9YCaLJ7nw1lrbqgl+ApBPgf92awAm0Kw1/x60+zIMeHMv3r0ZSNt5A5OxCy1UkURB7IUq+28Q==";
        };
        _MZqhxotO = {
            "id" = "MZqhxotO";
            "file" = "wormhole-1.1.17-forge-mc1.20.4.jar";
            "hash" = "sha512-Tf86YrqRtRmsFxw3xUFsJoRDEEXM56HvscuLfer6D+Vw2kkajCiwDEgaLdawuE/lX+z1m4yWlwyDHRMfByLihw==";
        };
        _VD97BrVn = {
            "id" = "VD97BrVn";
            "file" = "wormhole-1.1.17-forge-mc1.20.6.jar";
            "hash" = "sha512-po3b5BUit2K24Xt18a4QX2/h4fmQk/4UYdzAJ52QBYxKtSs/ZT+mY2XP6IzhHhm6uYE/k4boHZiikVr1RleijA==";
        };
        _hk5KToMY = {
            "id" = "hk5KToMY";
            "file" = "wormhole-1.1.17-forge-mc1.21.jar";
            "hash" = "sha512-D/ifF59KZXergfeVyJC82rZ9tz3vTY0C9WWPG8iq/t971g6Q+XTU0pUNBjVybkswAngdLFD66U/TyamGgDY2WQ==";
        };
        _AXaPw2Zd = {
            "id" = "AXaPw2Zd";
            "file" = "wormhole-1.1.17-forge-mc1.21.3.jar";
            "hash" = "sha512-1eDWXMb9/2JdQtJ1L8AP8y6nxmAh3zuX3QthYbHhZ03FfFq+EL5svwuRMVfh331qvib1gFXWENJQUd8VqENcVg==";
        };
        _9Yc1HHIL = {
            "id" = "9Yc1HHIL";
            "file" = "wormhole-1.1.17-forge-mc1.21.4.jar";
            "hash" = "sha512-0/zfQc163PW85tvA8gZP6YcvV/ycVCHRs5+lM1NnEMqlN5cHjaM+NR21jsVsWOAtj+8xrwjQYvCNd17TmDimrQ==";
        };
        _cSlkyNAs = {
            "id" = "cSlkyNAs";
            "file" = "wormhole-1.1.17-forge-mc1.21.5.jar";
            "hash" = "sha512-DoMhs6K/TL9RK9iWcNj7vIA7axRfxKvlTPe0s+D3XHzGTNPcUrw0CQNKBo4rGcxqXks3sX+u1nR+AVsEk3ZDPA==";
        };
        _OL9IZvGF = {
            "id" = "OL9IZvGF";
            "file" = "wormhole-1.1.17-forge-mc1.21.8.jar";
            "hash" = "sha512-KGka4LIU1C5bZ22SAr/PgIl7vv6GesfWC8R+qtpUYss9V639Xxk3LjFimAaEMhyxEIPVSpuGKm+BCfQSfxfW6A==";
        };
        _sCnS6yLb = {
            "id" = "sCnS6yLb";
            "file" = "wormhole-1.1.17-forge-mc1.21.10.jar";
            "hash" = "sha512-F+ibWHADz/sJMcC8q7X7gEnjWLal/j5nCY25QNJUVYfEz8At7euV2OcmrSlXMU7HSt1nlbKCZGBDrvwKDuQCmA==";
        };
        _NhLUEsIb = {
            "id" = "NhLUEsIb";
            "file" = "wormhole-1.1.17-forge-mc1.21.11.jar";
            "hash" = "sha512-sqTJghCa4wschjXlPybfFbpTE+nc3aZhRvfRhu9eLCry3i0ZKEfDncM0mvLXCzXf3doAzRKHs75OncnAZNACbQ==";
        };
        _5zGbhZbH = {
            "id" = "5zGbhZbH";
            "file" = "wormhole-1.1.17-forge-mc26.1.jar";
            "hash" = "sha512-KjxeDw5xPJ8J2FXY3g5V0v0rGUlUD0j3+4zm8n31D0cawOM4jhOpSK19BsqseJcg95meeJTC1bof2uieRmGGLA==";
        };
        _vBBMJMmB = {
            "id" = "vBBMJMmB";
            "file" = "wormhole-1.1.17-forge-mc26.2.jar";
            "hash" = "sha512-wtXpvZR30dbSunwK0v61DgQlJlmJB//oijKCLmU4+l9HFNGlWXrpLBMedNyQTC3SExAQVdGnjZbp+WH8w2bjkA==";
        };
        _QeT7KnjS = {
            "id" = "QeT7KnjS";
            "file" = "wormhole-1.1.17-fabric-mc1.18.jar";
            "hash" = "sha512-RtzbWQwEkA47NBOV8q0D9Th9wCrM3n1pLxLv8U5s3gN4pQYAJcp6LvDK7a/Ar6TZG6uSSNaHC00g6TNpgdGZTg==";
        };
        _9vkY3dyD = {
            "id" = "9vkY3dyD";
            "file" = "wormhole-1.1.17-fabric-mc1.19.2.jar";
            "hash" = "sha512-KC6jHW4WUmozD7h7Cbgzksi5drdR2SyoJMC2ADhNdhClJy5YUooPQzuyZS6VKT0JVp/1tNUeCEoTJqhdgisREQ==";
        };
        _qwz4Ttfi = {
            "id" = "qwz4Ttfi";
            "file" = "wormhole-1.1.17-fabric-mc1.19.4.jar";
            "hash" = "sha512-+LH8LPzFDpGvbxUDJbZPKVpfEhVpvhicCs8blswr5jLWAN7KtKAuktckDGGA3hviAMNfCkFhJRSuI72RJDTKLw==";
        };
        _IppbRuFl = {
            "id" = "IppbRuFl";
            "file" = "wormhole-1.1.17-fabric-mc1.20.1.jar";
            "hash" = "sha512-QdBg49A67lbT1o2DnpbD7VVgRmC6J5JX0K68OzqXgvcRZHpaVqNFqE75YHT+8GC7IK6m7xW1wGvNJuRvFP+Jow==";
        };
        _BBjfomkZ = {
            "id" = "BBjfomkZ";
            "file" = "wormhole-1.1.17-fabric-mc1.20.2.jar";
            "hash" = "sha512-fTjKmgp/hSLgi7zH/7LRCwqY319FOO26W5vsom0lO2OjBNCyyMPMRQVXApTVb8SBEC599VmXWNGIouqfqvnBxQ==";
        };
        _lMvPLr7y = {
            "id" = "lMvPLr7y";
            "file" = "wormhole-1.1.17-fabric-mc1.20.4.jar";
            "hash" = "sha512-2/B8Q6hF0GnjkFfuOEnJJCXNBka2mnJ7FTOFJdjfRuVkUG8wl3QZAGJCJq/HrFkMMi6X02q1S62JeTde4uvyOg==";
        };
        _5zgANduj = {
            "id" = "5zgANduj";
            "file" = "wormhole-1.1.17-fabric-mc1.20.6.jar";
            "hash" = "sha512-87zhJA61/ki4VYMcJ+kNHGUQODnczM3mh+0HyqdqNLzcN1uLqFLTM+SNWZR/ftJBsoFZ4OdNuU4xxIYfv++TXw==";
        };
        _YAEtcWOv = {
            "id" = "YAEtcWOv";
            "file" = "wormhole-1.1.17-fabric-mc1.21.jar";
            "hash" = "sha512-jRm8OLqY0J8i00M078it37UjV/HZSVsOxwjXGr6TNPmjCbvGI4Hm2maSvxaxbmX/XxUHlFgXFlXyKxbtyMGqcQ==";
        };
        _UgYWfxmW = {
            "id" = "UgYWfxmW";
            "file" = "wormhole-1.1.17-fabric-mc1.21.3.jar";
            "hash" = "sha512-ZbB67PS3SmuyYk93T4orwaGrX1qZq0icKaXPX0cbb6r2bLNRM71CqxUiYTJTteGZkGoO02e5hfJ41qQ/cvbE/Q==";
        };
        _GRxajXPC = {
            "id" = "GRxajXPC";
            "file" = "wormhole-1.1.17-fabric-mc1.21.4.jar";
            "hash" = "sha512-ck/TCbRMMrwqD/FvigUpP/U7hooSue7U1wy5e3I2LtmUqQzGYX0GozsxKc9IUpr/buy0L15O/t+pqVW4JMGhIg==";
        };
        _SDDbm3im = {
            "id" = "SDDbm3im";
            "file" = "wormhole-1.1.17-fabric-mc1.21.5.jar";
            "hash" = "sha512-Mjb2K40Pw7bZ4kyKka+7pA2AC6x4C/aE8amen+I4Bxoi1bUbDldFARX+QopUjEDeAaPG7c/4ZnvmXgRf/7tZvQ==";
        };
        _bOzLFLEm = {
            "id" = "bOzLFLEm";
            "file" = "wormhole-1.1.17-fabric-mc1.21.8.jar";
            "hash" = "sha512-tNwxmMW4BOVOVM/Dh8T3CAfw5Y3sJpynKP3Rmw2WmoW19uDEVOAg6oFIL8EgEtBn07M0hWvjFri3iZrUz6boig==";
        };
        _YYVEXjJF = {
            "id" = "YYVEXjJF";
            "file" = "wormhole-1.1.17-fabric-mc1.21.10.jar";
            "hash" = "sha512-owrjcmGVQf/VqAgBZ4nKASOM1zkh1GJ/AaXzlOwxngjjpnnBEpSHf8j9PazzRa5yhmaIFwqV/Exr0pINeWV0Yg==";
        };
        _EB2PApJt = {
            "id" = "EB2PApJt";
            "file" = "wormhole-1.1.17-fabric-mc1.21.11.jar";
            "hash" = "sha512-HlS7CIyD7QcPAyaQ5ZRl1bcrjxJ2KtPQ3MAdZyJVZSi2wh2L57iBtu1Nry7p511S+s4GYqgc6tnJMzW+CBLWRQ==";
        };
        _1PNYIVWf = {
            "id" = "1PNYIVWf";
            "file" = "wormhole-1.1.17-fabric-mc26.1.jar";
            "hash" = "sha512-zJKi7HU3n8Tjvj9hWU5n0bXEyvI8zynQ41XlenS8RBOf9MqOlqhPXinwIOUPtt8qauOGolr94repj0NmuFOGqA==";
        };
        _WzcAUP7V = {
            "id" = "WzcAUP7V";
            "file" = "wormhole-1.1.17-fabric-mc26.2.jar";
            "hash" = "sha512-WSINnL27tYLb2uTsvIvJBYqtc2/6ixQaYVJd9Wn4QrydUSzeBrkK5yomv8+mVFjjXcBy+MqFE60EBo9UBN6nGA==";
        };
        _meLK2uV3 = {
            "id" = "meLK2uV3";
            "file" = "wormhole-1.1.17-neoforge-mc1.20.4.jar";
            "hash" = "sha512-8PLFH/Z09k1L7hbeCDi3dgJEUXhymdUNuYh/YSZlqNBiYvhIblXYYFoSq+02mi6fMZVXC8pva7tFh916crYeNw==";
        };
        _WvKzRjSA = {
            "id" = "WvKzRjSA";
            "file" = "wormhole-1.1.17-neoforge-mc1.20.6.jar";
            "hash" = "sha512-oEIYnABnJ1RiJqktZpzpqAi3tQKyKNsYOcTd0ysnTuRArtnjVn0+Gd4b7M/M2SdjNg51F59jVfJGWMAlfScHNg==";
        };
        _lQ1KBXuy = {
            "id" = "lQ1KBXuy";
            "file" = "wormhole-1.1.17-neoforge-mc1.21.jar";
            "hash" = "sha512-tzveS4KImuf/h1QdxsD1R+lIPxFPWdsAYgfZVCThucv0QA5fLlrbQESjIXc4ENhCXtPoO5UjiL3seOoitJh2hA==";
        };
        _jxq4IPLi = {
            "id" = "jxq4IPLi";
            "file" = "wormhole-1.1.17-neoforge-mc1.21.3.jar";
            "hash" = "sha512-jzzac0O+AFvC4TZRSyfh2FbvcPbqoQj04uP1qYVOZl6m57au43AJvrRp6VW2XqJqrNskAmgBDKuNxRahqXlXag==";
        };
        _My5Dr3Ta = {
            "id" = "My5Dr3Ta";
            "file" = "wormhole-1.1.17-neoforge-mc1.21.4.jar";
            "hash" = "sha512-HR3w2oo0Bo9IDRRJ2lcPidSbboj2NJ4leqRvnQS4dCdIGJJC6nK6a9gkOsjoznjB7YfqsA4LmfDNFIR5jXo1ag==";
        };
        _AESZgzdd = {
            "id" = "AESZgzdd";
            "file" = "wormhole-1.1.17-neoforge-mc1.21.5.jar";
            "hash" = "sha512-5YlWat9NdsJ5wic8aKYwp4kGEssdBU1Wh9kVMR+7H/zOVu7njkb9CTMUCqKaKZ84Vv/bK1ZUehapJmIYBM297A==";
        };
        _xz79Urdj = {
            "id" = "xz79Urdj";
            "file" = "wormhole-1.1.17-neoforge-mc1.21.8.jar";
            "hash" = "sha512-BbgC26Y/RWUf7xIRc7r7jcgcaMSB74Bgpsbsu/K4u43Wn6cSb7VxzNsF35dETOJb+6Qlv3iGSOj/ICP2C909jg==";
        };
        _m9zUDpMn = {
            "id" = "m9zUDpMn";
            "file" = "wormhole-1.1.17-neoforge-mc1.21.10.jar";
            "hash" = "sha512-0JtE6Y/wbQW6wLmraAXPLME29jNeg6yFv+ELFDQU1pAtyKBj5F4sCE9NLT6sMfcayMR1hmSupiqLtTPSBwlvDA==";
        };
        _NSKbe2Ps = {
            "id" = "NSKbe2Ps";
            "file" = "wormhole-1.1.17-neoforge-mc1.21.11.jar";
            "hash" = "sha512-FZIpynCS44piDZu8gxY257NKQPuuINWPY0iMR6IsVYkKXlW1hBx8XSCRiuaYRc8If+/6OfSKk20Tc/QMGXqO+Q==";
        };
        _U8R58dhk = {
            "id" = "U8R58dhk";
            "file" = "wormhole-1.1.17-neoforge-mc26.1.jar";
            "hash" = "sha512-NGm8DPCycmPvjgSzCiglMo/oEYefMzsFa2yUlycMU43V9CuHiCNCkqMDfm+qFC7skLP2egabBWgpgfGeKr7KmA==";
        };
        _cqmwrnqK = {
            "id" = "cqmwrnqK";
    ...
    in {
        ...
        "forge-1.14" = _tBOfnztI;
        "forge-1.14.1" = _tBOfnztI;
        "forge-1.14.2" = _tBOfnztI;
        "forge-1.14.3" = _tBOfnztI;
        "forge-1.14.4" = _tBOfnztI;
        "forge-1.15" = _KasPkv44;
        "forge-1.15.1" = _KasPkv44;
        "forge-1.15.2" = _KasPkv44;
        "forge-1.16" = _8vZ2Egna;
        "forge-1.16.1" = _8vZ2Egna;
        "forge-1.16.2" = _8vZ2Egna;
        "forge-1.16.3" = _8vZ2Egna;
        "forge-1.16.4" = _8vZ2Egna;
        "forge-1.16.5" = _8vZ2Egna;
        "forge-1.17" = _ZpnHibeq;
        "forge-1.17.1" = _ZpnHibeq;
        "forge-1.18" = _Ep52LiSv;
        "forge-1.18.1" = _Ep52LiSv;
        "forge-1.18.2" = _Ep52LiSv;
        "forge-1.19" = _eXQ3tQDQ;
        "forge-1.19.1" = _eXQ3tQDQ;
        "forge-1.19.2" = _eXQ3tQDQ;
        "forge-1.19.3" = _S6VazavR;
        "forge-1.19.4" = _cHT0O53k;
        "forge-1.20" = _CUsu6Cib;
        "forge-1.20.1" = _CUsu6Cib;
        "forge-1.20.2" = _WtnQyo8w;
        "forge-1.20.3" = _MZqhxotO;
        "forge-1.20.4" = _MZqhxotO;
        "forge-1.20.5" = _VD97BrVn;
        "forge-1.20.6" = _VD97BrVn;
        "forge-1.21" = _hk5KToMY;
        "forge-1.21.1" = _hk5KToMY;
        "forge-1.21.2" = _AXaPw2Zd;
        "forge-1.21.3" = _AXaPw2Zd;
        "forge-1.21.4" = _9Yc1HHIL;
        "forge-1.21.5" = _cSlkyNAs;
        "forge-1.21.6" = _OL9IZvGF;
        "forge-1.21.7" = _OL9IZvGF;
        "forge-1.21.8" = _OL9IZvGF;
        "forge-1.21.9" = _sCnS6yLb;
        "forge-1.21.10" = _sCnS6yLb;
        "forge-1.21.11" = _NhLUEsIb;
        "forge-26.1" = _5zGbhZbH;
        "forge-26.1.1" = _5zGbhZbH;
        "forge-26.1.2" = _5zGbhZbH;
        "forge-26.2" = _vBBMJMmB;
        "fabric-1.18" = _QeT7KnjS;
        "fabric-1.18.1" = _QeT7KnjS;
        "fabric-1.18.2" = _QeT7KnjS;
        "fabric-1.19.4" = _qwz4Ttfi;
        "fabric-1.19.2" = _9vkY3dyD;
        "fabric-1.20" = _IppbRuFl;
        "fabric-1.20.1" = _IppbRuFl;
        "fabric-1.20.2" = _BBjfomkZ;
        "fabric-1.20.3" = _lMvPLr7y;
        "fabric-1.20.4" = _lMvPLr7y;
        "fabric-1.20.5" = _5zgANduj;
        "fabric-1.20.6" = _5zgANduj;
        "fabric-1.21" = _YAEtcWOv;
        "fabric-1.21.1" = _YAEtcWOv;
        "fabric-1.21.2" = _UgYWfxmW;
        "fabric-1.21.3" = _UgYWfxmW;
        "fabric-1.21.4" = _GRxajXPC;
        "fabric-1.21.5" = _SDDbm3im;
        "fabric-1.21.6" = _bOzLFLEm;
        "fabric-1.21.7" = _bOzLFLEm;
        "fabric-1.21.8" = _bOzLFLEm;
        "fabric-1.21.9" = _YYVEXjJF;
        "fabric-1.21.10" = _YYVEXjJF;
        "fabric-1.21.11" = _EB2PApJt;
        "fabric-26.1" = _1PNYIVWf;
        ...
        "neoforge-1.20.3" = _meLK2uV3;
        "neoforge-1.20.4" = _meLK2uV3;
        "neoforge-1.20.2" = _Knzdeumx;
        "neoforge-1.20.5" = _WvKzRjSA;
        "neoforge-1.20.6" = _WvKzRjSA;
        "neoforge-1.21" = _lQ1KBXuy;
        "neoforge-1.21.1" = _lQ1KBXuy;
        "neoforge-1.21.2" = _jxq4IPLi;
        "neoforge-1.21.3" = _jxq4IPLi;
        "neoforge-1.21.4" = _My5Dr3Ta;
        "neoforge-1.21.5" = _AESZgzdd;
        "neoforge-1.21.6" = _xz79Urdj;
        "neoforge-1.21.7" = _xz79Urdj;
        "neoforge-1.21.8" = _xz79Urdj;
        "neoforge-1.21.9" = _m9zUDpMn;
        "neoforge-1.21.10" = _m9zUDpMn;
        "neoforge-1.21.11" = _NSKbe2Ps;
        ...
        "quilt-1.19.2" = _9vkY3dyD;
        "quilt-1.19.4" = _qwz4Ttfi;
        "quilt-1.20" = _IppbRuFl;
        "quilt-1.20.1" = _IppbRuFl;
        "quilt-1.20.2" = _BBjfomkZ;
        "quilt-1.20.3" = _lMvPLr7y;
        "quilt-1.20.4" = _lMvPLr7y;
        "quilt-1.20.5" = _5zgANduj;
        "quilt-1.20.6" = _5zgANduj;
        "quilt-1.21" = _YAEtcWOv;
        "quilt-1.21.1" = _YAEtcWOv;
        "quilt-1.21.2" = _UgYWfxmW;
        "quilt-1.21.3" = _UgYWfxmW;
        "quilt-1.21.4" = _GRxajXPC;
        "quilt-1.21.5" = _SDDbm3im;
        "quilt-1.21.6" = _bOzLFLEm;
        "quilt-1.21.7" = _bOzLFLEm;
        "quilt-1.21.8" = _bOzLFLEm;
        "quilt-1.21.9" = _YYVEXjJF;
        "quilt-1.21.10" = _YYVEXjJF;
        "quilt-1.21.11" = _EB2PApJt;
        "quilt-26.1" = _1PNYIVWf;
        ...
        "pkg-1.1.10-forge-mc1.16" = _FGzO2YZz;
        "pkg-1.1.10-forge-mc1.17" = _SVcT8XZp;
        "pkg-1.1.10-forge-mc1.18" = _YkTMB2xe;
        "pkg-1.1.10-forge-mc1.19" = _e0OilCdy;
        "pkg-1.1.11-forge-mc1.12" = _6335lbAE;
        "pkg-1.1.11-forge-mc1.14" = _LHjeWLV4;
        "pkg-1.1.11-forge-mc1.15" = _B7Zoeewc;
        "pkg-1.1.11-forge-mc1.16" = _7woM0aTb;
        "pkg-1.1.11-forge-mc1.17" = _9VVw5fKV;
        "pkg-1.1.11-forge-mc1.18" = _PyTRFiZw;
        "pkg-1.1.11-forge-mc1.19" = _UsxHhKiX;
        "pkg-1.1.11a-forge-mc1.12" = _CjC4hzOC;
        "pkg-1.1.11-forge-mc1.19.3" = _1lHJ5mc4;
        "pkg-1.1.12-forge-mc1.12" = _9gHA9iIT;
        "pkg-1.1.12-forge-mc1.14" = _EKbuOzY2;
        "pkg-1.1.12-forge-mc1.15" = _BzUSb4yk;
        "pkg-1.1.12-forge-mc1.16" = _xUUfPzHf;
        "pkg-1.1.12-forge-mc1.17" = _QD8EkDt8;
        "pkg-1.1.12-forge-mc1.18" = _yChmWQGh;
        "pkg-1.1.12-forge-mc1.19" = _KyVjtCuA;
        "pkg-1.1.12-forge-mc1.19.3" = _2udHmzKP;
        "pkg-1.1.12-forge-mc1.19.4" = _4XYo9WBk;
        "pkg-1.1.12-fabric-mc1.18" = _zyfrZ3R5;
        "pkg-1.1.12-fabric-mc1.19" = _sPVKREx5;
        "pkg-1.1.12a-fabric-mc1.18" = _8eT7qsMR;
        "pkg-1.1.12a-fabric-mc1.19" = _bLLErsq4;
        "pkg-1.1.12b-fabric-mc1.18" = _ysF6WTb9;
        "pkg-1.1.12b-fabric-mc1.19" = _9sPOzA5i;
        "pkg-1.1.12b-fabric-mc1.19.2" = _UNhpZECI;
        "pkg-1.1.12-forge-mc1.20" = _8lLEvJSb;
        "pkg-1.1.12-fabric-mc1.20" = _eI0BCX1W;
        "pkg-1.1.13-forge-mc1.12" = _zG6r8xxB;
        "pkg-1.1.13-forge-mc1.14" = _qCgHjo7d;
        "pkg-1.1.13-forge-mc1.15" = _Dxnm5gTE;
        "pkg-1.1.13-forge-mc1.16" = _HGdwDU3X;
        "pkg-1.1.13-forge-mc1.17" = _XEzH7Rrr;
        "pkg-1.1.13-forge-mc1.18" = _nNkfdArz;
        "pkg-1.1.13-forge-mc1.19" = _kHPObOgc;
        "pkg-1.1.13-forge-mc1.19.3" = _TupmjZwe;
        "pkg-1.1.13-forge-mc1.19.4" = _H6Scx8TQ;
        "pkg-1.1.13-forge-mc1.20" = _rpvGA06I;
        "pkg-1.1.13-fabric-mc1.18" = _CvSKhKSJ;
        "pkg-1.1.13-fabric-mc1.19.2" = _Il4PImXT;
        "pkg-1.1.13-fabric-mc1.19.4" = _AVpJ3DF6;
        "pkg-1.1.13-fabric-mc1.20" = _AKYL5wrk;
        "pkg-1.1.13a-forge-mc1.12" = _Yfu5OXxA;
        "pkg-1.1.13a-fabric-mc1.18" = _XTiNG43n;
        "pkg-1.1.13a-fabric-mc1.19.2" = _UZ2TQkil;
        "pkg-1.1.13a-fabric-mc1.19.4" = _fknrhTOu;
        "pkg-1.1.13a-fabric-mc1.20" = _kq4Zws7w;
        "pkg-1.1.13a-forge-mc1.16" = _bIzF5R7p;
        "pkg-1.1.13a-forge-mc1.17" = _uXcJ9kHD;
        "pkg-1.1.13a-forge-mc1.18" = _NnPJWb0M;
        "pkg-1.1.13a-forge-mc1.19" = _fhsXzJVp;
        "pkg-1.1.13a-forge-mc1.19.3" = _SDRgbZhr;
        "pkg-1.1.13a-forge-mc1.19.4" = _BnqcQy7u;
        "pkg-1.1.13a-forge-mc1.20" = _MaFANaF8;
        "pkg-1.1.13b-fabric-mc1.18" = _SxOPKBOI;
        "pkg-1.1.13b-fabric-mc1.19.2" = _ISUD3Auq;
        "pkg-1.1.13b-fabric-mc1.19.4" = _xI3fvGqg;
        "pkg-1.1.13b-fabric-mc1.20" = _dbdURA6C;
        "pkg-1.1.14-forge-mc1.12" = _LbS6PMsK;
        "pkg-1.1.14-forge-mc1.14" = _sTMcGxyF;
        "pkg-1.1.14-forge-mc1.15" = _iypcIopB;
        "pkg-1.1.14-forge-mc1.16" = _hlWZ3Pi3;
        "pkg-1.1.14-forge-mc1.17" = _JOdbPSVs;
        "pkg-1.1.14-forge-mc1.18" = _5YVolEav;
        "pkg-1.1.14-forge-mc1.19" = _DD66Pr7i;
        "pkg-1.1.14-forge-mc1.19.3" = _tD921fd8;
        "pkg-1.1.14-forge-mc1.19.4" = _hPEi8fWG;
        "pkg-1.1.14-forge-mc1.20" = _Fv1vkcYp;
        "pkg-1.1.14-fabric-mc1.18" = _tGRhrGbp;
        "pkg-1.1.14-fabric-mc1.19.2" = _vGwIA26W;
        "pkg-1.1.14-fabric-mc1.19.4" = _ijMAHf8i;
        "pkg-1.1.14-fabric-mc1.20" = _ht29nUmU;
        "pkg-1.1.15-forge-mc1.12" = _MybFurEW;
        "pkg-1.1.15-forge-mc1.14" = _iL873iFk;
        "pkg-1.1.15-forge-mc1.15" = _Dn1bBR7Z;
        "pkg-1.1.15-forge-mc1.16" = _8DbPqzs4;
        "pkg-1.1.15-forge-mc1.17" = _NQjI7JiP;
        "pkg-1.1.15-forge-mc1.18" = _xjQXm4yd;
        "pkg-1.1.15-forge-mc1.19" = _9jtfYk4X;
        "pkg-1.1.15-forge-mc1.19.3" = _kAlxkKqp;
        "pkg-1.1.15-forge-mc1.19.4" = _6r9UxISs;
        "pkg-1.1.15-fabric-mc1.18" = _CQSZ8fsM;
        "pkg-1.1.15-fabric-mc1.19.2" = _7kadLtTj;
        "pkg-1.1.15-fabric-mc1.19.4" = _EKGf5wlO;
        "pkg-1.1.15-fabric-mc1.20" = _HcAU8JlI;
        "pkg-1.1.15-forge-mc1.20" = _GLHdCyWJ;
        "pkg-1.1.15-forge-mc1.20.2" = _H6NP2Yfr;
        "pkg-1.1.15-fabric-mc1.20.2" = _NKHsOQ4L;
        "pkg-1.1.15-neoforge-mc1.20.4" = _ReKyMLLa;
        "pkg-1.1.15a-forge-mc1.20.4" = _uGVm2Rvs;
        "pkg-1.1.15a-fabric-mc1.20.4" = _FFiQ3WjT;
        "pkg-1.1.16-forge-mc1.12" = _evN0kwLv;
        "pkg-1.1.16-forge-mc1.14" = _mYwuJ7zR;
        "pkg-1.1.16-forge-mc1.15" = _BBw9kkc9;
        "pkg-1.1.16-forge-mc1.16" = _IMuPJjbv;
        "pkg-1.1.16-forge-mc1.17" = _wA3Vf4P3;
        "pkg-1.1.16-forge-mc1.18" = _7xpFheGG;
        "pkg-1.1.16-forge-mc1.19" = _TF1REKM1;
        "pkg-1.1.16-forge-mc1.19.3" = _FAzTMPoI;
        "pkg-1.1.16-forge-mc1.19.4" = _51dfZSWN;
        "pkg-1.1.16-forge-mc1.20" = _qTnVesOt;
        "pkg-1.1.16-forge-mc1.20.2" = _Knzdeumx;
        "pkg-1.1.16-forge-mc1.20.4" = _6bx9H8sv;
        "pkg-1.1.16-fabric-mc1.18" = _PT6WFpkH;
        "pkg-1.1.16-fabric-mc1.19.2" = _vSHpkUJL;
        "pkg-1.1.16-fabric-mc1.19.4" = _aFMXNRys;
        "pkg-1.1.16-fabric-mc1.20" = _YU4PFhk1;
        "pkg-1.1.16-fabric-mc1.20.2" = _WiwZxfHi;
        "pkg-1.1.16-fabric-mc1.20.4" = _bCrTQEEc;
        "pkg-1.1.16-neoforge-mc1.20.4" = _VHjRZEYL;
        "pkg-1.1.16-forge-mc1.20.6" = _q7iCXxKV;
        "pkg-1.1.16-forge-mc1.21" = _3FBVVnJs;
        "pkg-1.1.16-fabric-mc1.20.6" = _MWvccMQI;
        "pkg-1.1.16-fabric-mc1.21" = _xhubN5q0;
        "pkg-1.1.16-neoforge-mc1.20.6" = _skPTPU48;
        "pkg-1.1.16-neoforge-mc1.21" = _LXDo4pov;
        "pkg-1.1.16-fabric-mc1.21.2" = _tJPTsJQE;
        "pkg-1.1.16-neoforge-mc1.21.3" = _j5Oyq7Md;
        "pkg-1.1.16-forge-mc1.21.3" = _k5cjefHd;
        "pkg-1.1.16-forge-mc1.21.4" = _dlgf764C;
        "pkg-1.1.16-fabric-mc1.21.4" = _zzL5jfu0;
        "pkg-1.1.16-neoforge-mc1.21.4" = _ZkSyNDyU;
        "pkg-1.1.16a-forge-mc1.21.3" = _atz7sQbM;
        "pkg-1.1.16a-forge-mc1.21.4" = _3T2aSEjP;
        "pkg-1.1.16-forge-mc1.21.5" = _l7udHSFZ;
        "pkg-1.1.16-forge-mc1.21.6" = _HcOT87Wg;
        "pkg-1.1.16-fabric-mc1.21.5" = _V3eJYZuP;
        "pkg-1.1.16-fabric-mc1.21.6" = _Rl5sWnG2;
        "pkg-1.1.16-neoforge-mc1.21.5" = _6csOVsVf;
        "pkg-1.1.16-neoforge-mc1.21.6" = _lOIojkFZ;
        "pkg-1.1.16-forge-mc1.21.10" = _LLI6CLXY;
        "pkg-1.1.16-fabric-mc1.21.10" = _xpOl8OFB;
        "pkg-1.1.16-neoforge-mc1.21.10" = _vnRvVyXj;
        "pkg-1.1.16-forge-mc1.21.11" = _iJd6yHtG;
        "pkg-1.1.16-fabric-mc1.21.11" = _JIK5A7ZN;
        "pkg-1.1.16-neoforge-mc1.21.11" = _TNP60zq2;
        "pkg-1.1.16a-fabric-mc1.21.10" = _kNuuQGp7;
        "pkg-1.1.16a-fabric-mc1.21.11" = _XhK9wVMu;
        "pkg-1.1.16-forge-mc26.1" = _zyLRVXut;
        "pkg-1.1.16a-fabric-mc26.1" = _iqHD2XaD;
        "pkg-1.1.16-neoforge-mc26.1" = _52jWP8Tl;
        "pkg-1.1.16-forge-mc26.2" = _1PeQg67D;
        "pkg-1.1.16a-fabric-mc26.2" = _a9n05U7o;
        "pkg-1.1.16-neoforge-mc26.2" = _tuUWbcsc;
        "pkg-1.1.16a-forge-mc26.2" = _G7EwzOUX;
        "pkg-1.1.17-forge-mc1.12" = _u8Hue0QR;
        "pkg-1.1.17-forge-mc1.14" = _tBOfnztI;
        "pkg-1.1.17-forge-mc1.15" = _KasPkv44;
        "pkg-1.1.17-forge-mc1.16" = _8vZ2Egna;
        "pkg-1.1.17-forge-mc1.17" = _ZpnHibeq;
        "pkg-1.1.17-forge-mc1.18" = _Ep52LiSv;
        "pkg-1.1.17-forge-mc1.19.2" = _eXQ3tQDQ;
        "pkg-1.1.17-forge-mc1.19.3" = _S6VazavR;
        "pkg-1.1.17-forge-mc1.19.4" = _cHT0O53k;
        "pkg-1.1.17-forge-mc1.20.1" = _CUsu6Cib;
        "pkg-1.1.17-forge-mc1.20.2" = _WtnQyo8w;
        "pkg-1.1.17-forge-mc1.20.4" = _MZqhxotO;
        "pkg-1.1.17-forge-mc1.20.6" = _VD97BrVn;
        "pkg-1.1.17-forge-mc1.21" = _hk5KToMY;
        "pkg-1.1.17-forge-mc1.21.3" = _AXaPw2Zd;
        "pkg-1.1.17-forge-mc1.21.4" = _9Yc1HHIL;
        "pkg-1.1.17-forge-mc1.21.5" = _cSlkyNAs;
        "pkg-1.1.17-forge-mc1.21.8" = _OL9IZvGF;
        "pkg-1.1.17-forge-mc1.21.10" = _sCnS6yLb;
        "pkg-1.1.17-forge-mc1.21.11" = _NhLUEsIb;
        "pkg-1.1.17-forge-mc26.1" = _5zGbhZbH;
        "pkg-1.1.17-forge-mc26.2" = _vBBMJMmB;
        "pkg-1.1.17-fabric-mc1.18" = _QeT7KnjS;
        "pkg-1.1.17-fabric-mc1.19.2" = _9vkY3dyD;
        "pkg-1.1.17-fabric-mc1.19.4" = _qwz4Ttfi;
        "pkg-1.1.17-fabric-mc1.20.1" = _IppbRuFl;
        "pkg-1.1.17-fabric-mc1.20.2" = _BBjfomkZ;
        "pkg-1.1.17-fabric-mc1.20.4" = _lMvPLr7y;
        "pkg-1.1.17-fabric-mc1.20.6" = _5zgANduj;
        "pkg-1.1.17-fabric-mc1.21" = _YAEtcWOv;
        "pkg-1.1.17-fabric-mc1.21.3" = _UgYWfxmW;
        "pkg-1.1.17-fabric-mc1.21.4" = _GRxajXPC;
        "pkg-1.1.17-fabric-mc1.21.5" = _SDDbm3im;
        "pkg-1.1.17-fabric-mc1.21.8" = _bOzLFLEm;
        "pkg-1.1.17-fabric-mc1.21.10" = _YYVEXjJF;
        "pkg-1.1.17-fabric-mc1.21.11" = _EB2PApJt;
        "pkg-1.1.17-fabric-mc26.1" = _1PNYIVWf;
        "pkg-1.1.17-fabric-mc26.2" = _WzcAUP7V;
        "pkg-1.1.17-neoforge-mc1.20.4" = _meLK2uV3;
        "pkg-1.1.17-neoforge-mc1.20.6" = _WvKzRjSA;
        "pkg-1.1.17-neoforge-mc1.21" = _lQ1KBXuy;
        "pkg-1.1.17-neoforge-mc1.21.3" = _jxq4IPLi;
        "pkg-1.1.17-neoforge-mc1.21.4" = _My5Dr3Ta;
        "pkg-1.1.17-neoforge-mc1.21.5" = _AESZgzdd;
        "pkg-1.1.17-neoforge-mc1.21.8" = _xz79Urdj;
        "pkg-1.1.17-neoforge-mc1.21.10" = _m9zUDpMn;
