...
let
    versions = (let
        ...
        _M0cd6zmQ = {
            "id" = "M0cd6zmQ";
            "file" = "createvintageneoforged-1.21.1-1.3.8.jar";
            "hash" = "sha512-7MKpiKNcWT6uo35tJfxPmSxTN37dEyt3Jif9+pFXXj6Rye2LhlFwcjhfF7st/RPCtcBh0HBN/8JCCe4dpkxLkQ==";
        };
        _bZWn4Ukr = {
            "id" = "bZWn4Ukr";
    ...
    in {
        ...
        "pkg-1.20.1-1.2.6" = _HUcz2Qgv;
        "pkg-1.20.1-1.3.0" = _rvNJBK2H;
        "pkg-1.20.1-1.3.5" = _DI9zZAWT;
        "pkg-1.20.1-1.4.0" = _WCVHK5sQ;
        "pkg-1.20.1-1.4.5" = _v7NmC9DW;
        "pkg-1.21.1-1.0.0" = _ClSELKIl;
        "pkg-1.21.1-1.0.1" = _a2iLqAFO;
        "pkg-1.21.1-1.1.0" = _OvlGbtT0;
        "pkg-1.21.1-1.1.5" = _tm8RfPap;
        "pkg-1.21.1-1.2.0" = _fDl68Rz5;
        "pkg-1.21.1-1.2.1" = _aceUS2JA;
        "pkg-1.20.1-1.5.0" = _L0okXshn;
        "pkg-1.20.1-1.5.1" = _DqqlkVTe;
        "pkg-1.21.1-1.2.2" = _J1d7BZDg;
        "pkg-1.20.1-1.5.2" = _29HxmO7h;
        "pkg-1.20.1-1.5.3" = _wpuTuqMm;
        "pkg-1.20.1-1.5.5" = _KvqHcM17;
        "pkg-1.20.1-1.5.6" = _KQcTQAGV;
        "pkg-1.21.1-1.2.3" = _G83qXySK;
        "pkg-1.20.1-1.5.7" = _qorcknEh;
        "pkg-1.20.1-1.5.8" = _KqAdHSHN;
        "pkg-1.21.1-1.3.0" = _JYjSryrE;
        "pkg-1.20.1-1.5.9" = _BsyW1KWC;
        "pkg-1.21.1-1.3.1" = _nAMmnqrs;
        "pkg-1.21.1-1.3.2" = _T0eBjorx;
        "pkg-1.21.1-1.3.3" = _8Z61iJy1;
        "pkg-1.20.1-1.6.0" = _bbr9sOo4;
        "pkg-1.21.1-1.3.4" = _TCb8QfkM;
        "pkg-1.21.1-1.3.5" = _f3HPDufN;
        "pkg-1.21.1-1.3.6" = _JsCs8dZ7;
