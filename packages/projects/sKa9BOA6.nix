...
let
    ...
    in {
        ...
        "pkg-1.0.0b+mod" = _66W4Jlcx;
        "pkg-1.1.0" = _ikcyQYKK;
        "pkg-1.1.0+mod" = _cXIjy5jk;
        "pkg-1.3.0" = _ImiQrAiL;
        "pkg-1.3.0+mod" = _M9Uz1A5j;
        "pkg-1.3.1" = _buQlmSLK;
        "pkg-1.3.1+mod" = _TOvgIbsP;
        "pkg-1.3.2" = _3z3Ne5L2;
        "pkg-1.3.2+mod" = _ebiPX9Kf;
        "pkg-1.3.3" = _6ZzaQGcM;
        "pkg-1.3.3+mod" = _WOgaoQYi;
        "pkg-1.3.4" = _HzIHOdWL;
        "pkg-1.3.4+fabric" = _MH23UZyq;
        "pkg-1.3.4+forge" = _uIkXZdKs;
        "pkg-1.3.4+neoforge" = _FaxpsxpP;
        "pkg-1.3.4+quilt" = _dRUczHh5;
        "pkg-1.4.0" = _RRVjezBF;
        "pkg-1.4.0+fabric" = _DRnuk3Iv;
        "pkg-1.4.0+forge" = _2S8xWSyA;
        "pkg-1.4.0+neoforge" = _m9kkH5xW;
        "pkg-1.4.0+quilt" = _LW1Dwr26;
        "pkg-1.5.0" = _RNZ78SIP;
        "pkg-1.5.0+fabric" = _nY2mrtya;
        "pkg-1.5.0+forge" = _yQmDe2FB;
        "pkg-1.5.0+neoforge" = _hopoayey;
        "pkg-1.5.0+quilt" = _adY9L5M8;
        "pkg-1.5.1" = _GzHymTgn;
        "pkg-1.5.1+fabric" = _MfD6J3en;
        "pkg-1.5.1+forge" = _W7lAoNgM;
        "pkg-1.5.1+neoforge" = _yUwOVbTd;
        "pkg-1.5.1+quilt" = _Q4FIcPlr;
        "pkg-1.5.2" = _pfitfs39;
        "pkg-1.5.2+fabric" = _WrsT6urh;
        "pkg-1.5.2+forge" = _wleA4fxY;
        "pkg-1.5.2+neoforge" = _TUFu4Nhm;
        "pkg-1.5.2+quilt" = _qObRC2AX;
        "pkg-1.5.3" = _ztoPaANv;
        "pkg-1.5.3+fabric" = _GFfht8Yt;
