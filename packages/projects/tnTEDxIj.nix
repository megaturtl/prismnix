...
let
    ...
    in {
        ...
        "pkg-1.21.8-b4" = _j6k1kLcP;
        "pkg-1.21.9-b1" = _zoJH6Od1;
        "pkg-1.21.10-b1" = _phFBo7Xg;
        "pkg-1.21.10-b2" = _jCUVxeOv;
        "pkg-1.21.10-b3" = _40wMmmuq;
        "pkg-1.21.10-b4" = _7Ky8998d;
        "pkg-1.21.10-b5" = _wg7Fng7z;
        "pkg-1.21.10-b6" = _XYGr6M06;
        "pkg-1.21.10-b7" = _R77w6jda;
        "pkg-1.21.10-b8" = _bk4exkd6;
        "pkg-1.21.11-b1" = _DGlLt8cE;
        "pkg-1.21.11-b2" = _AteLKa2a;
        "pkg-1.21.11-b3" = _7mIrijoQ;
        "pkg-1.21.11-b4" = _4KRYXmEE;
        "pkg-1.21.11-b5" = _k4NY85Tk;
        "pkg-1.21.11-b6" = _BNddWeeC;
        "pkg-1.21.11-b7" = _ejwBt1f7;
        "pkg-26.1-b1" = _AdzniXGE;
        "pkg-26.1-b2" = _6b0Jj3JS;
        "pkg-26.1-b3" = _IOXtxNTh;
        "pkg-26.1-b4" = _xfEE55Pn;
        "pkg-26.1-b5" = _5JASfm0k;
        "pkg-26.1-b6" = _SQv6PwFO;
        "pkg-26.1-b7" = _eDvb7XLy;
        "pkg-26.1-b8" = _muUiq0su;
        "pkg-26.1-b9" = _8DRY5vc8;
        "pkg-26.1-b10" = _PBpQqHak;
        "pkg-26.1-b11" = _57sdGb4J;
        "pkg-26.2-b1" = _T1CyZtwt;
        "pkg-26.1-b12" = _l9YjFg79;
