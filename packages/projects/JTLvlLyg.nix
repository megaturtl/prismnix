...
let
    ...
    in {
        ...
        "pkg-1.2.4" = _XHzsv9uU;
        "pkg-1.2.5" = _6n9iM0Aq;
        "pkg-b1.2.5-1.20.1" = _XO3suzgO;
        "pkg-b1.2.51-1.20.1" = _fwXwUtSP;
        "pkg-r1.2.6-1.20.1" = _y5ZvGYP4;
        "pkg-r1.2.7-1.20.1" = _vOYcAsbO;
        "pkg-r1.2.8-1.20.1" = _Q15c9PXm;
        "pkg-1.2.8" = _WoXM8PkJ;
        "pkg-1.2.8-aimfix" = _2mbJx7md;
        "pkg-1.2.8-hotfix-1" = _rVBNm3L9;
        "pkg-1.3.0b" = _krpuIRfD;
        "pkg-1.3.1b" = _aUUQ8yHM;
        "pkg-1.3.2" = _lDEMLMqd;
        "pkg-r1.2.9-1.20.1" = _jMLKfQgu;
        "pkg-1.2.9-hotfix-1-1.20.1" = _xDGhOLYr;
        "pkg-1.3.2-hotfix-1" = _ZsadgWJw;
        "pkg-1.3.3" = _TOXaZPZe;
        "pkg-1.2.9.10-1.20.1" = _68xx14PQ;
        "pkg-1.2.9.20-1.20.1" = _hM1KXixC;
        "pkg-1.3.4" = _D4QCQq1I;
        "pkg-1.3.5" = _oWLA9RvE;
        "pkg-1.3.5-hotfix-1" = _fen89jts;
        "pkg-1.3.5-hotfix-2" = _bz1Cd1yc;
        "pkg-1.2.10-1.20.1" = _qxDgq7Kh;
        "pkg-1.3.6" = _rO97in1x;
        "pkg-1.4.0b" = _t9ZVi2sx;
        "pkg-1.4.1b" = _mXXkyqXL;
        "pkg-1.4.2b" = _GG6vOwIb;
        "pkg-1.4.3b" = _vFSau5Ge;
        "pkg-1.4.4" = _tTLYm0G0;
        "pkg-1.4.5" = _kfxMMtto;
        "pkg-1.4.6" = _EiACFZEd;
        "pkg-1.4.7" = _bM1srUgW;
