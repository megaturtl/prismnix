...
let
    versions = (let
        ...
        _YH2tq2fR = {
            "id" = "YH2tq2fR";
            "file" = "dimore-fabric-1.6.0+mc1.21.1.jar";
            "hash" = "sha512-4RETYbZ/4AxofXfge+jRCS3MozQtLwpbxYzHH8+KDOHMbabz0X+iLLL88cQEC3vHUqP+9+erhPrGB3diJiWfvQ==";
        };
        _uv3V78RU = {
            "id" = "uv3V78RU";
            "file" = "dimore-neoforge-1.6.0+mc1.21.1.jar";
            "hash" = "sha512-CJZO3KmBtboxAfrNRnnOJLfwF1HOoe+4g3wpven7Ehv5Q9YM4g5N/AbjM7h542URIPS6ep2Z4bdiLJLXa3ahLg==";
        };
        _KwIlcbqX = {
            "id" = "KwIlcbqX";
            "file" = "dimore-neoforge-1.6.0+mc1.21.11.jar";
            "hash" = "sha512-KTRPZUfc7QRgGcqhJlVYyaMRWSradp0Ub95j/sdC3e4TVVqrqBmTmevP/UgAXD30RNJcBctue0aIfynvHgv3mg==";
        };
        _a4NGk5zR = {
            "id" = "a4NGk5zR";
            "file" = "dimore-fabric-1.6.0+mc1.21.11.jar";
            "hash" = "sha512-1OOLkUrrbqcI4bAtDacMqxhxsJ+kxwrdgqkSg12yq4DxJxHi8cfH5CpMlqUSnpRDFndrjjlHJZE0xaQsxhZgTw==";
        };
        _SZOJLkEC = {
            "id" = "SZOJLkEC";
            "file" = "dimore-fabric-1.6.0+mc26.1.jar";
            "hash" = "sha512-z/MbDHO2z7q+Z1UuyNuwKJKU2RibRwKkx3T4t3tKCagLhzdil5/Hbn4FetJDryOJBJ3r2bDz9p6ikUnQKFRtuA==";
        };
        _3Y02sgcO = {
            "id" = "3Y02sgcO";
            "file" = "dimore-neoforge-1.6.0+mc26.1.jar";
            "hash" = "sha512-zQ9pm+NcoI7TrHOczOhgcVPfg5tzHM7w/Z/WKFSvmF7BST1TN19zxrRFFw2u7mRkSfRr0AO+eCu3tOlC6RSTeg==";
        };
        _yjQKI4Qt = {
            "id" = "yjQKI4Qt";
            "file" = "dimore-fabric-1.6.0+mc26.2.jar";
            "hash" = "sha512-AzzqWkIXKBVg9PsjbENa0Nn5OY1oTiyjPEINDgNSm2qnQDf6RkR4MR2vsTniO+ANYUzlNJTkc77vgcueRa6uOg==";
        };
        _lYnfqvMx = {
            "id" = "lYnfqvMx";
    ...
    in {
        ...
        "neoforge-1.21.11" = _KwIlcbqX;
        "neoforge-26.1" = _3Y02sgcO;
        ...
        "fabric-1.21.11" = _a4NGk5zR;
        "fabric-26.1-snapshot-5" = _zDOlr0jz;
        "fabric-26.1" = _SZOJLkEC;
        ...
        "pkg-forge-1.19.2_v.1.0.1-B" = _pe3xRyq5;
        "pkg-forge-1.19.3_v.1.1-B" = _uUj1Z3ir;
        "pkg-forge-1.19.4_v.1.2-B" = _AmEASkAf;
        "pkg-forge-1.20.1_v.1.2" = _Oiukdsiw;
        "pkg-neoforge-1.21.1_v.1.3" = _aIUPgcVq;
        "pkg-fabric-1.21.10_v.1.3" = _JU0xjMXF;
        "pkg-fabric-1.21.1_v.1.3" = _jU14EsgV;
        "pkg-neoforge-1.21.10_v.1.3" = _VVdmVnuf;
        "pkg-fabric-1.21.2_v.1.3" = _Vpae09e3;
        "pkg-neoforge-1.21.2_v.1.3" = _sQoZTDJz;
        "pkg-fabric-1.21.3_v.1.3" = _nKCg47yE;
        "pkg-neoforge-1.21.3_v.1.3" = _n27lxXjb;
        "pkg-neoforge-1.21.4_v.1.3" = _fGJTZDSj;
        "pkg-fabric-1.21.5_v.1.3" = _vLLnwLFm;
        "pkg-fabric-1.21.4_v.1.3" = _xqYyHHTn;
        "pkg-fabric-1.21.6_v.1.3" = _oiGcqxPx;
        "pkg-fabric-1.21.7_v.1.3" = _b5zvaCkC;
        "pkg-neoforge-1.21.5_v.1.3" = _jtWluaZV;
        "pkg-neoforge-1.21.6_v.1.3" = _EQHbsFE8;
        "pkg-neoforge-1.21.7_v.1.3" = _9OP2TR7q;
        "pkg-fabric-1.21.8_v.1.3" = _ZnZ7VXfx;
        "pkg-fabric-1.21.9_v.1.3" = _gwt4jFxj;
        "pkg-neoforge-1.21.8_v.1.3" = _hYo4gU48;
        "pkg-neoforge-1.21.9_v.1.3" = _SO3pelkX;
        "pkg-fabric-1.21.1_v.1.3.1" = _mXieuDTb;
        "pkg-fabric-1.21.10_v.1.3.1" = _yHxFj3xf;
        "pkg-neoforge-1.21.1_v.1.3.1" = _jDrvF6UE;
        "pkg-neoforge-1.21.10_v.1.3.1" = _jrbxyG70;
        "pkg-fabric-1.21.2_v.1.3.1" = _FCsGMK32;
        "pkg-neoforge-1.21.3_v.1.3.1" = _DuXX6BZF;
        "pkg-fabric-1.21.3_v.1.3.1" = _SQRClo8Y;
        "pkg-neoforge-1.21.2_v.1.3.1" = _tsKbHoba;
        "pkg-fabric-1.21.4_v.1.3.1" = _OvsJG9Sx;
        "pkg-fabric-1.21.5_v.1.3.1" = _pyPGx3T5;
        "pkg-neoforge-1.21.4_v.1.3.1" = _Vr0LuwQi;
        "pkg-neoforge-1.21.5_v.1.3.1" = _e23pQa4H;
        "pkg-fabric-1.21.6_v.1.3.1" = _oJ646OiC;
        "pkg-neoforge-1.21.6_v.1.3.1" = _R8lcyv8S;
        "pkg-fabric-1.21.7_v.1.3.1" = _satZXAy6;
        "pkg-neoforge-1.21.7_v.1.3.1" = _Z84UHcnQ;
        "pkg-fabric-1.21.8_v.1.3.1" = _uQIcPXhW;
        "pkg-neoforge-1.21.8_v.1.3.1" = _4hHbDUqr;
        "pkg-neoforge-1.21.9_v.1.3.1" = _axv1VU0N;
        "pkg-fabric-1.21.9_v.1.3.1" = _tdRTBB2E;
        "pkg-fabric-1.21.11_v.1.3.1" = _JimsSR1q;
        "pkg-neoforge-1.21.11_v.1.3.1" = _gRJvD7jh;
        "pkg-fabric-1.21.10_v.1.3.2" = _OgfMOHJs;
        "pkg-neoforge-1.21.10_v.1.3.2" = _hLEVTEFi;
        "pkg-fabric-1.21.1_v.1.3.2" = _LAy0mQEK;
        "pkg-neoforge-1.21.1_v.1.3.2" = _6tUao9i0;
        "pkg-neoforge-1.21.11_v.1.3.2" = _1b2TZU6O;
        "pkg-fabric-1.21.11_v.1.3.2" = _StbspFRt;
        "pkg-fabric-1.21.2_v.1.3.2" = _YU5j9Eg7;
        "pkg-neoforge-1.21.2_v.1.3.2" = _w22SBDyZ;
        "pkg-fabric-1.21.3_v.1.3.2" = _5eZpqh8L;
        "pkg-fabric-1.21.4_v.1.3.2" = _k50RKOO4;
        "pkg-neoforge-1.21.3_v.1.3.2" = _zw4i7QJy;
        "pkg-neoforge-1.21.4_v.1.3.2" = _Hjf7gCCn;
        "pkg-fabric-1.21.5_v.1.3.2" = _SoHtio2n;
        "pkg-neoforge-1.21.5_v.1.3.2" = _VK5ywhJo;
        "pkg-fabric-1.21.6_v.1.3.2" = _hNOu0SaG;
        "pkg-neoforge-1.21.6_v.1.3.2" = _58T7Em55;
        "pkg-fabric-1.21.7_v.1.3.2" = _FdfgGNy7;
        "pkg-neoforge-1.21.7_v.1.3.2" = _jDDQb140;
        "pkg-fabric-1.21.8_v.1.3.2" = _ymy6jn1c;
        "pkg-neoforge-1.21.8_v.1.3.2" = _B64Bip8j;
        "pkg-fabric-1.21.9_v.1.3.2" = _GlvoMJ5L;
        "pkg-neoforge-1.21.9_v.1.3.2" = _aio7WIMC;
        "pkg-neoforge-1.21.10_v.1.4.0" = _sv5VH1YL;
        "pkg-neoforge-1.21.1_v.1.4.0" = _lalXKIRw;
        "pkg-fabric-1.21.1_v.1.4.0" = _8SDAVWdV;
        "pkg-fabric-1.21.10_v.1.4.0" = _XXHb3UwM;
        "pkg-fabric-1.21.2_v.1.4.0" = _Tf4UCQGT;
        "pkg-neoforge-1.21.2_v.1.4.0" = _tOgmQJ9E;
        "pkg-neoforge-1.21.11_v.1.4.0" = _36xQbcj0;
        "pkg-fabric-1.21.11_v.1.4.0" = _Bdyw1nyj;
        "pkg-fabric-1.21.3_v.1.4.0" = _nHGztpVO;
        "pkg-neoforge-1.21.3_v.1.4.0" = _Z3qNg2rJ;
        "pkg-neoforge-1.21.4_v.1.4.0" = _j8x4ZHJb;
        "pkg-fabric-1.21.4_v.1.4.0" = _VPjCidTE;
        "pkg-fabric-1.21.5_v.1.4.0" = _Flzn0BL8;
        "pkg-neoforge-1.21.6_v.1.4.0" = _jYlhZ5A3;
        "pkg-neoforge-1.21.5_v.1.4.0" = _bmKOBG6Q;
        "pkg-fabric-1.21.6_v.1.4.0" = _gMylJoPX;
        "pkg-fabric-1.21.7_v.1.4.0" = _ZjhPDnfr;
        "pkg-neoforge-1.21.8_v.1.4.0" = _TMFQonaC;
        "pkg-fabric-1.21.8_v.1.4.0" = _1068lHAX;
        "pkg-neoforge-1.21.7_v.1.4.0" = _YJmzOYRg;
        "pkg-fabric-1.21.9_v.1.4.0" = _KtXfBnUQ;
        "pkg-neoforge-1.21.9_v.1.4.0" = _xE7nZOBz;
        "pkg-neoforge-1.21.1_v.1.4.1" = _wUOdgwzd;
        "pkg-neoforge-1.21.10_v.1.4.1" = _CYof9wpQ;
        "pkg-fabric-1.21.10_v.1.4.1" = _DkdQ9uIK;
        "pkg-fabric-1.21.1_v.1.4.1" = _2dUqVwRc;
        "pkg-fabric-1.21.2_v.1.4.1" = _neDA5xhC;
        "pkg-fabric-1.21.11_v.1.4.1" = _c8Wa6xJa;
        "pkg-neoforge-1.21.11_v.1.4.1" = _lMw6kbb9;
        "pkg-neoforge-1.21.2_v.1.4.1" = _XG85GrBi;
        "pkg-fabric-1.21.3_v.1.4.1" = _Lhb4bEZD;
        "pkg-neoforge-1.21.3_v.1.4.1" = _Z6Qp9FCJ;
        "pkg-neoforge-1.21.4_v.1.4.1" = _8WZIPAns;
        "pkg-fabric-1.21.4_v.1.4.1" = _ZZHGorCa;
        "pkg-neoforge-1.21.5_v.1.4.1" = _HUpRrCJM;
        "pkg-fabric-1.21.5_v.1.4.1" = _TTCFpOFk;
        "pkg-fabric-1.21.6_v.1.4.1" = _wM5KAwSx;
        "pkg-neoforge-1.21.6_v.1.4.1" = _biwmmYRB;
        "pkg-fabric-1.21.7_v.1.4.1" = _sxwSSBx3;
        "pkg-neoforge-1.21.8_v.1.4.1" = _iwPWqCH5;
        "pkg-fabric-1.21.8_v.1.4.1" = _fRpVIb62;
        "pkg-neoforge-1.21.7_v.1.4.1" = _ckkt7Pwm;
        "pkg-fabric-1.21.9_v.1.4.1" = _poGdVEf7;
        "pkg-neoforge-1.21.9_v.1.4.1" = _NQRhrboc;
        "pkg-fabric-26.1-snapshot-5-1.4.1-B" = _zDOlr0jz;
        "pkg-1.4.2" = _MeSiO3Vb;
        "pkg-1.4.3" = _cmJ9ZV1p;
        "pkg-fabric-1.5.0+mc1.21.1" = _2sQim4bz;
        "pkg-fabric-1.5.0+mc1.21.11" = _IBuyWKYz;
        "pkg-fabric-1.5.0+mc26.1" = _LIT6WB9F;
        "pkg-neoforge-1.5.0+mc1.21.1" = _PCZHPJ5I;
        "pkg-neoforge-1.5.0+mc1.21.11" = _LgmOLioT;
        "pkg-neoforge-1.5.0+mc26.1" = _iMEH3osb;
        "pkg-neoforge-1.5.0.1+mc1.21.1" = _TSEBWgeM;
        "pkg-neoforge-1.5.0.1+mc1.12.11" = _XY2Zdukc;
        "pkg-neoforge-1.5.0.1+m26.1" = _HumASc6S;
        "pkg-neoforge-1.5.0.1+m26.2" = _PGQpzaZB;
        "pkg-fabric-1.5.0.1+m26.2" = _9BGBXJvy;
        "pkg-fabric-1.6.0+mc1.21.1" = _YH2tq2fR;
        "pkg-neoforge-1.6.0+mc1.21.1" = _uv3V78RU;
        "pkg-neoforge-1.6.0+mc1.21.11" = _KwIlcbqX;
        "pkg-fabric-1.6.0+mc1.21.11" = _a4NGk5zR;
        "pkg-fabric-1.6.0+mc26.1" = _SZOJLkEC;
