...
let
    ...
    in {
        ...
        "pkg-2.3.2" = _pw8oM6ix;
        "pkg-2.3.3" = _BXnm8Mfk;
        "pkg-1.32.0" = _AiKtvE0W;
        "pkg-2.3.4" = _2j4ipHPc;
        "pkg-2.3.5" = _DVdYwrMF;
        "pkg-1.32.1" = _4OB8QlwY;
        "pkg-2.4.0" = _QX9y7cAH;
        "pkg-2.4.1" = _VfVD8WDC;
        "pkg-1.32.2" = _yVZL8Xe4;
        "pkg-2.5.0" = _KvEtqnPD;
        "pkg-1.32.3" = _ucsRAVYm;
        "pkg-2.6.0" = _QIbBwAiE;
        "pkg-1.33.0" = _ubuSSJ33;
        "pkg-2.7.0" = _DKvZcSTS;
        "pkg-2.7.1" = _QHRd31pn;
        "pkg-2.8.0" = _1eUHD2Lt;
        "pkg-2.8.1" = _L7qw7jUt;
        "pkg-1.33.1" = _grDVFgyI;
        "pkg-2.8.2" = _AiX0A13U;
        "pkg-2.9.0" = _uQXh4IQT;
        "pkg-1.34.0" = _kiolV3UR;
        "pkg-2.9.1" = _urHMuPkw;
        "pkg-1.34.1" = _w7XE9ihB;
        "pkg-2.10.0" = _IQbXcRnA;
        "pkg-2.10.1" = _WU0AOF4M;
        "pkg-2.10.2" = _nP4EanFz;
        "pkg-2.10.3" = _JdzWy7CR;
        "pkg-2.11.0" = _LFGZ0hbV;
        "pkg-2.12.0" = _g7lOlWAN;
        "pkg-2.12.1" = _Yfwc2Dt1;
        "pkg-2.12.2" = _F2QshjWa;
        "pkg-2.12.3" = _tYPBFCfx;
        "pkg-2.12.4" = _UbYL6Vo6;
        "pkg-1.35.0" = _Qvth2DIg;
        "pkg-1.35.1" = _BIKkeUok;
        "pkg-2.13.0" = _MFACCW84;
        "pkg-2.13.1" = _SKpj2446;
        "pkg-2.13.2" = _NkoN6PnT;
        "pkg-2.13.3" = _RBBxKLwS;
        "pkg-2.14.0" = _99UCE8sm;
        "pkg-2.14.1" = _UkiRxiKf;
        "pkg-2.15.0" = _Ev5ecWHb;
        "pkg-2.15.1" = _gR3nOgnZ;
        "pkg-2.16.0" = _g5KyAwkg;
        "pkg-2.16.1" = _JGyq2uKI;
        "pkg-2.16.2" = _mEl31Rbe;
        "pkg-1.35.2" = _QmAhRLg0;
        "pkg-2.16.3" = _jK3HkTT2;
        "pkg-2.16.4" = _3mCY7Fg4;
        "pkg-2.16.5" = _RPbP7wJZ;
        "pkg-2.17.0" = _9vLXz4gD;
        "pkg-2.17.1" = _5ZaPkzYk;
        "pkg-2.17.2" = _h2VjTz6A;
        "pkg-2.18.0" = _4HEHNmBY;
        "pkg-2.18.1" = _mrZU63EE;
        "pkg-1.36.0" = _9Fg3n0nW;
        "pkg-2.18.2" = _6GWglGuw;
        "pkg-1.36.1" = _DkzAroAa;
        "pkg-2.18.3" = _7a3lgh53;
        "pkg-2.18.4" = _p51rN750;
        "pkg-2.18.5" = _6fZcmLdP;
        "pkg-2.19.0" = _D2N273wW;
        "pkg-2.19.1" = _n8bCReek;
        "pkg-2.19.2" = _VlI4hJay;
        "pkg-2.19.3" = _YVrw0kmp;
        "pkg-2.5.0.0" = _c7fBjeoU;
        "pkg-2.20.0" = _A4rNAlUn;
        "pkg-2.5.1.0" = _A2cd9Yt1;
        "pkg-2.20.1" = _7wgJB0YL;
        "pkg-2.5.1.1" = _UCINlafp;
        "pkg-2.20.2" = _mRDdPIBy;
        "pkg-2.5.1.2" = _MGvc7BEy;
        "pkg-2.20.3" = _lUjgbFYh;
        "pkg-2.5.1.3" = _5GpDPSs1;
        "pkg-2.20.4" = _RVsl0zfw;
        "pkg-2.5.1.4" = _3YylOtlv;
        "pkg-2.20.5" = _pp2aanQ8;
        "pkg-2.5.1.5" = _xVlWplMy;
        "pkg-2.21.0" = _S7yZ69Qe;
        "pkg-2.5.2.0" = _vSXxZNrn;
        "pkg-2.21.1" = _cY3u709y;
        "pkg-2.5.2.1" = _yWMeHp19;
        "pkg-2.22.0" = _WGNCwDSm;
        "pkg-2.5.3.0" = _MssCg0Qh;
        "pkg-2.22.1" = _yBfAqOsb;
        "pkg-2.5.3.1" = _3jHBTdnv;
        "pkg-2.23.0" = _QTQIYJ84;
        "pkg-2.5.4.0" = _Bxxx6hSQ;
        "pkg-2.23.1" = _QwIomqjl;
        "pkg-2.5.4.1" = _KlhRzKfg;
        "pkg-2.23.2" = _Bnyc88Mw;
        "pkg-2.5.4.2" = _mzRtTbPj;
        "pkg-2.23.3" = _TtxJGqeS;
        "pkg-2.5.4.3" = _rMrmYh5H;
        "pkg-2.23.4" = _6uBAplgN;
        "pkg-2.5.4.4" = _Y8UuCqcw;
        "pkg-2.24.0" = _uaMs1BYq;
        "pkg-2.5.5.0" = _GAZBOGu9;
        "pkg-2.25.0" = _oTnZavrC;
        "pkg-2.5.6.0" = _FSf4PCZZ;
        "pkg-2.25.1" = _H3UZkqV6;
        "pkg-2.5.6.1" = _5xMiodjj;
        "pkg-2.25.2" = _63mCjOuU;
        "pkg-2.5.6.2" = _buR8HA1o;
        "pkg-2.26.0" = _xh6MLKKB;
        "pkg-2.5.7.0" = _RGYMetjG;
        "pkg-1.37.0" = _nSsAx9u3;
        "pkg-2.26.1" = _aEDDqnwU;
        "pkg-2.5.7.1" = _e2hp0DWE;
        "pkg-2.27.0" = _chiPlCbi;
        "pkg-2.5.8.0" = _qpDjWPpE;
        "pkg-2.27.1" = _P4qpNirT;
        "pkg-2.5.8.1" = _jufJaaJo;
        "pkg-2.28.0" = _rvpRbnYO;
        "pkg-2.5.9.0" = _AzOnNDg0;
        "pkg-2.29.0" = _MnQxxcTh;
        "pkg-2.5.10.0" = _cMGMdxep;
        "pkg-2.29.1" = _jF3KAyjj;
        "pkg-2.5.10.1" = _rN82GTJr;
        "pkg-2.30.0" = _uQkxE626;
        "pkg-2.5.11.0" = _HyQ0kgAP;
        "pkg-2.30.1" = _IDTfUyZ7;
        "pkg-2.5.11.1" = _x56KTHtj;
        "pkg-2.31.0" = _qM1oHT6n;
        "pkg-2.5.12.0" = _fA7Q3P4X;
        "pkg-2.31.1" = _QQw6OxAY;
        "pkg-2.5.12.1" = _soxGKb0w;
        "pkg-2.31.2" = _hkEKsoVA;
        "pkg-2.5.12.2" = _Molhp0ds;
        "pkg-2.31.3" = _EJ8diTHT;
        "pkg-2.5.12.3" = _J0Rmb9JX;
        "pkg-2.31.4" = _pbf250Pm;
        "pkg-2.5.12.4" = _nhW5UFtc;
        "pkg-2.32.0" = _JZjkmLHU;
        "pkg-2.5.13.0" = _3pUamuX0;
        "pkg-2.33.0" = _63Hz56NJ;
        "pkg-2.5.14.0" = _THfL1zfN;
        "pkg-2.33.1" = _5tsh3GA4;
        "pkg-2.5.14.1" = _UMaA8EgJ;
        "pkg-2.33.2" = _at0QduHC;
        "pkg-2.5.14.2" = _zv0bLY7Y;
        "pkg-2.34.0" = _qHsCgDpr;
        "pkg-2.5.15.0" = _sk2CBEEy;
        "pkg-2.34.1" = _MrYER69m;
        "pkg-2.5.15.1" = _LnZLHhuH;
        "pkg-2.34.2" = _tbJ3HiYL;
        "pkg-2.5.15.2" = _EihVWwDW;
        "pkg-2.35.0" = _wCujvZT6;
        "pkg-2.5.16.0" = _SQuNnDjZ;
        "pkg-2.35.1" = _NS5n3EM0;
        "pkg-2.5.16.1" = _YOk5A5Nb;
        "pkg-2.35.2" = _PUi8LozY;
        "pkg-2.5.16.2" = _v6XQFNSW;
        "pkg-2.35.3" = _g9iZDKHB;
        "pkg-2.5.16.3" = _XSDW3JfX;
        "pkg-2.35.4" = _dJoe4njt;
        "pkg-2.5.16.4" = _pjXlplJY;
        "pkg-2.35.5" = _BSLG4EpW;
        "pkg-2.5.16.5" = _qFBdvPbY;
        "pkg-2.36.0" = _2XDySfAN;
        "pkg-2.5.17.0" = _529c8FqC;
        "pkg-2.36.1" = _hFRmxxuD;
        "pkg-2.5.17.1" = _HihnnVRW;
        "pkg-2.36.2" = _uFP5vcc0;
        "pkg-2.5.17.2" = _Cdk9kFZq;
        "pkg-2.37.0" = _gEKPdLWt;
        "pkg-2.5.18.0" = _axXcpkhv;
        "pkg-2.38.0" = _rhK2zI1k;
        "pkg-2.5.19.0" = _KXUwZZl6;
        "pkg-2.38.1" = _1oRiPuB1;
        "pkg-2.5.19.1" = _ow4lBxlj;
        "pkg-2.38.2" = _XqSEgMtU;
        "pkg-2.5.19.2" = _JDsdcZ5b;
        "pkg-2.39.0" = _kJMC1inS;
        "pkg-2.5.20.0" = _vJaER96u;
        "pkg-2.39.1" = _3tXV4MvX;
        "pkg-2.5.20.1" = _XZ0DrTts;
        "pkg-2.39.2" = _n0isVfGS;
        "pkg-2.5.20.2" = _QKa2ThOf;
        "pkg-2.39.3" = _dnWSYkUX;
        "pkg-2.5.20.3" = _g8UfBMq6;
        "pkg-2.39.4" = _4N657f2L;
        "pkg-2.5.20.4" = _7GurN6kd;
        "pkg-2.40.0" = _xwr0QOAN;
        "pkg-2.5.21.0" = _FBjcPOkg;
        "pkg-2.40.1" = _mWDaaE3A;
        "pkg-2.5.21.1" = _p5snijs1;
        "pkg-2.40.2" = _78ZoWCAi;
        "pkg-2.5.21.2" = _BrqpN7qo;
        "pkg-2.41.0" = _z0DK62wt;
        "pkg-2.5.22.0" = _B8ewtEoj;
        "pkg-2.42.0" = _jbGdxURg;
        "pkg-2.5.23.0" = _YTzDq3r4;
        "pkg-2.42.1" = _NVSp0ram;
        "pkg-2.5.23.1" = _mVxHafTU;
        "pkg-2.43.0" = _PD22lmJt;
        "pkg-2.5.24.0" = _rlMk0TEB;
        "pkg-2.43.1" = _P53aA5BL;
        "pkg-2.5.25.0" = _HVKLdDod;
        "pkg-2.5.26.0" = _3GmGog01;
        "pkg-2.5.26.1" = _djuYUS5F;
        "pkg-2.5.26.2" = _Wny1m0RY;
        "pkg-2.5.26.3" = _p6J8eQaU;
        "pkg-2.5.27.0" = _dUegMskG;
        "pkg-2.5.27.1" = _VutQiWZ6;
        "pkg-2.5.27.2" = _5uLm3bc4;
        "pkg-2.5.27.3" = _jYTyMsXk;
        "pkg-2.5.27.4" = _syOLFQgu;
        "pkg-2.5.28.0" = _updvJJfE;
        "pkg-2.5.28.1" = _briZqq4I;
        "pkg-2.5.28.2" = _PgT7gvNP;
        "pkg-2.5.28.3" = _l3evI404;
        "pkg-2.5.29.0" = _SGu5vncp;
        "pkg-2.5.29.1" = _f76FvTd3;
        "pkg-2.5.29.2" = _AG2FjfQB;
        "pkg-2.5.29.3" = _Yd9VGW6z;
        "pkg-2.5.29.4" = _hKDAXlqB;
        "pkg-2.5.30.0" = _LxwjDTg5;
        "pkg-2.5.30.1" = _IyxdyEDv;
        "pkg-2.5.31.0" = _cBSzcI4P;
        "pkg-2.5.31.1" = _i9Yo7zWU;
        "pkg-2.5.31.2" = _nIMpW97U;
        "pkg-2.5.31.3" = _Z2Olbrpu;
        "pkg-2.5.31.4" = _78hBF2ts;
        "pkg-2.5.31.5" = _ErGhEO0e;
        "pkg-2.5.32.0" = _fEA41ewx;
        "pkg-2.5.32.1" = _dhF7SZgH;
        "pkg-2.5.33.0" = _4pCHJEMP;
        "pkg-2.5.33.1" = _1yTdAoo9;
        "pkg-2.5.33.2" = _5FqWJrEo;
        "pkg-2.5.33.3" = _2Yx822m9;
        "pkg-2.5.34.0" = _gErMB5Ij;
        "pkg-2.5.34.1" = _G9eNj1Lk;
        "pkg-2.5.34.2" = _B2cpREEQ;
        "pkg-2.5.34.3" = _KQBNYnbs;
        "pkg-2.5.34.4" = _7XJFsCuX;
        "pkg-2.5.35.0" = _TnIyTebN;
        "pkg-2.5.35.1" = _oMeQH3vn;
        "pkg-2.5.36.0" = _My3aeIVN;
        "pkg-2.5.36.1" = _cl01jYWo;
        "pkg-2.5.37.0" = _QqgSvnur;
        "pkg-2.5.37.1" = _Qhn8U8ZV;
        "pkg-2.5.37.2" = _7zkpRHvD;
        "pkg-2.5.37.3" = _QFggd3ep;
        "pkg-2.5.37.4" = _UQmttH0F;
        "pkg-2.5.37.5" = _G7EoaIQN;
        "pkg-2.5.38.0" = _BjgcMLJ5;
        "pkg-2.5.38.1" = _gxzOpwTN;
        "pkg-2.5.38.2" = _oRSi3Fta;
        "pkg-2.5.38.3" = _TGQaGBOT;
        "pkg-2.5.38.4" = _QyFpD7hD;
        "pkg-2.5.39.0" = _srZEZK1s;
        "pkg-2.5.39.1" = _BsVk3f2o;
        "pkg-2.5.39.2" = _vKlazrcK;
        "pkg-2.5.39.3" = _9z1KIyWF;
        "pkg-2.5.39.4" = _yUQsrMPs;
        "pkg-2.5.39.5" = _l75aQ3Sd;
        "pkg-2.5.40.0" = _vJKex7Ow;
        "pkg-2.5.40.1" = _cLyzRVjf;
        "pkg-2.5.41.0" = _5nO5vPX3;
        "pkg-2.5.41.1" = _NhgFFGVI;
        "pkg-2.5.41.2" = _NWGoPGYo;
        "pkg-2.5.42.0" = _Hg9bxPGk;
        "pkg-2.5.43.0" = _wvp11HAL;
        "pkg-2.5.43.1" = _HkvwrcD8;
        "pkg-2.5.43.2" = _W5e03aWo;
        "pkg-2.5.43.3" = _uLnFB7DP;
        "pkg-2.5.43.4" = _JKySlD77;
        "pkg-2.5.44.0" = _4Cm2xPfI;
        "pkg-2.5.44.1" = _rrRsGUwl;
        "pkg-2.5.45.0" = _hwHP7luW;
        "pkg-2.5.45.1" = _GAANwa7K;
        "pkg-2.5.45.2" = _wU3cwjdW;
        "pkg-2.5.46.0" = _MRRiFgG6;
        "pkg-2.5.46.1" = _w6F1pIO1;
        "pkg-2.5.46.2" = _C2E6wpvZ;
        "pkg-2.5.46.3" = _6u4yKN1Z;
        "pkg-2.5.47.0" = _nMhPLfAS;
        "pkg-2.5.47.1" = _M8LXy6qa;
        "pkg-2.5.47.2" = _mXwedqmO;
        "pkg-2.5.48.0" = _cWYNgSjl;
        "pkg-2.5.48.1" = _4cWKXdo4;
        "pkg-2.5.48.2" = _yzYMoYX6;
        "pkg-2.5.48.3" = _HchliC1X;
        "pkg-2.5.48.4" = _XZ7NLsgu;
        "pkg-2.5.49.0" = _jkpV6sUb;
        "pkg-2.5.49.1" = _37ASFWsc;
        "pkg-2.5.49.2" = _MumJavPb;
        "pkg-2.5.49.3" = _5289im3x;
        "pkg-2.5.50.0" = _UvQLPOzt;
        "pkg-2.5.50.1" = _Q2UjE9ET;
        "pkg-2.5.50.2" = _g5aY08Lp;
        "pkg-2.5.51.0" = _ZrhJ3Hm4;
        "pkg-2.5.52.0" = _1PRTnEvw;
        "pkg-2.5.52.1" = _25Q3LG8k;
        "pkg-2.5.52.2" = _9ZQT26U1;
        "pkg-2.5.52.3" = _7fXS87u7;
        "pkg-2.5.52.4" = _kS1GO2fA;
        "pkg-2.5.53.0" = _W0lGk96C;
        "pkg-2.5.53.1" = _ydkyueT7;
        "pkg-2.5.54.0" = _ruXFQ9Gm;
        "pkg-2.5.54.1" = _eiwizr62;
        "pkg-2.5.54.2" = _TRWrGOav;
        "pkg-2.5.54.3" = _dYXZbTM8;
        "pkg-2.5.54.4" = _tZAY4m1g;
        "pkg-2.5.54.5" = _wND13pJ5;
        "pkg-2.5.55.0" = _SKugHaaN;
        "pkg-2.5.55.1" = _EY8lEJAJ;
        "pkg-2.5.55.2" = _GvKHXGAb;
        "pkg-3.0.0" = _BCmr54FS;
        "pkg-3.0.1" = _5tSvK4yL;
        "pkg-3.0.2" = _MyMJdNQw;
        "pkg-2.5.55.3" = _YFpg7D6L;
        "pkg-3.0.3" = _htZ6FvwC;
        "pkg-2.5.55.4" = _c2DZj7Ib;
        "pkg-3.0.4" = _AA5BQ2v4;
        "pkg-3.0.5" = _gJJUnw2b;
        "pkg-3.0.6" = _iLiWW8SB;
        "pkg-3.0.7" = _4F21shjN;
