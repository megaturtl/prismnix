...
let
    versions = (let
        ...
        _1OffjBPL = {
            "id" = "1OffjBPL";
            "file" = "enchantmentdisabler-neoforge-3.4.8+1.21.1.jar";
            "hash" = "sha512-4kdqspk0A7tZ8pbwx1CU0jtqjFkjCs7lIv2vGJzRnH/xd0lrPZW3+/hlpXD1q4VhvXcIizXZVjwtfmoX4qA4Pg==";
        };
        _MMTidj3D = {
            "id" = "MMTidj3D";
            "file" = "enchantmentdisabler-neoforge-3.4.8+26.1.2.jar";
            "hash" = "sha512-idWLDln//IXaUa7t/kxJb8bRMcLCKnCBrRLzQHH4KnCG7IQyYIPsBYZPF6tAIV0+Y8OG5+hQtPlcJKDezZhJQA==";
        };
        _u0UmTHqA = {
            "id" = "u0UmTHqA";
            "file" = "enchantmentdisabler-neoforge-3.4.8+26.2.jar";
            "hash" = "sha512-v6/gUzJDq6kx1mxRCdd24gOhA3sRGX3z2uYvPypVCoTRE6rNSUDEszjgyvbsE00VbZZPUJJ3nsSctBNT/dJqcw==";
        };
        _2sCQjGW4 = {
            "id" = "2sCQjGW4";
            "file" = "enchantmentdisabler-fabric-3.4.8+1.21.1.jar";
            "hash" = "sha512-aZhmHHxA6Lbd9wj3sQpSJnNyLQQjMrz4ix+g1ad+36Y6n7JQ1Nsw5+M3pK6KUmAoMdQyPr3iNKlC8uNntoaM+A==";
        };
        _KWjwQJc8 = {
            "id" = "KWjwQJc8";
            "file" = "enchantmentdisabler-fabric-3.4.8+26.2.jar";
            "hash" = "sha512-wLzsNMurZrPBh8Z22OnPjntWDuKyjkX5/bYyI+l8GOm6+17GaZoIjDnuS3NiWfpFl/n4O5N+HGkErF+CX4ZLpA==";
        };
        _EkcLPXMo = {
            "id" = "EkcLPXMo";
            "file" = "enchantmentdisabler-fabric-3.4.8+26.1.2.jar";
            "hash" = "sha512-zllNBjYr+aqCv0uNAOuvzANsof+OzaXOG6+2EmmSbOtr565KuNvSX7BmVbr2mKps9GhAkv/s7p7mPGAMz9x3rQ==";
        };
        _V19y4lZF = {
            "id" = "V19y4lZF";
            "file" = "enchantmentdisabler-neoforge-3.4.9+26.1.2.jar";
            "hash" = "sha512-CrmfcQFnzuVh65FvF5gjNgM0VBCsXbGTD5PFcatkcbolBOaHsW4KBNTS5NJdRWMu/eTy8cvwobmoLXjQmiBjqg==";
        };
        _jZhP4oVk = {
            "id" = "jZhP4oVk";
            "file" = "enchantmentdisabler-neoforge-3.4.9+26.2.jar";
            "hash" = "sha512-yWKTgO+uujH0y1E8R1jLaGu/JQxOprqxTQL4Tc+M2ZN46iKnh3EwsWmuuGbSxUVbh3T3EbNedEbMHItuX/m+Eg==";
        };
        _IJlGWodG = {
            "id" = "IJlGWodG";
            "file" = "enchantmentdisabler-neoforge-3.4.9+1.21.1.jar";
            "hash" = "sha512-bl08NTSmzWHtcTCirHE3QpDzJ2EK87hoXkAGMNzIeebQqXT+Piy9bm4LKF2Kd5ljbsxVqpDZ6Gl/CRfznWiB8Q==";
        };
        _arLcmNjp = {
            "id" = "arLcmNjp";
            "file" = "enchantmentdisabler-fabric-3.4.9+26.2.jar";
            "hash" = "sha512-2UMHrvkTpqT0YwaLGuRUzY/n6MwhiN4tY5F2nByOVWtUIViHMLzugAKbbZ7CXKiWAdYAv0vPs7qCVh9/V0Ax2A==";
        };
        _UbzgfxNT = {
            "id" = "UbzgfxNT";
            "file" = "enchantmentdisabler-fabric-3.4.9+26.1.2.jar";
            "hash" = "sha512-4rQatNKczL0eQ7fuK8SckCXYkFGWnzQJ1gD0ubNACoj9NNyCuzlWefFos7q6rkJBlolZFSfMcOJA+XcKwvAm9Q==";
        };
        _yQEKMupT = {
            "id" = "yQEKMupT";
    ...
    in {
        ...
        "fabric-1.21" = _yQEKMupT;
        "fabric-1.21.1" = _yQEKMupT;
        ...
        "neoforge-26.1" = _V19y4lZF;
        "neoforge-26.1.1" = _V19y4lZF;
        "neoforge-26.1.2" = _V19y4lZF;
        "neoforge-26.2" = _jZhP4oVk;
        "pkg-0.1.0" = _yxcYoDi3;
        "pkg-0.1.1" = _mODLjtuE;
        "pkg-0.1.2" = _gl4IqzJX;
        "pkg-0.2.0" = _yRTCq9xT;
        ...
        "pkg-0.1.4" = _qRYj9TBl;
        "pkg-0.2.2" = _jc1ZAoH6;
        "pkg-1.0.0+1.19" = _dcGYBM2V;
        "pkg-1.0.0+1.19.3" = _pJ60xb1I;
        "pkg-1.0.0+1.20.2" = _Fw5gGp2Y;
        "pkg-1.0.0+1.20.6" = _xz0KbjDn;
        "pkg-2.0.0+1.21" = _ZzLWuBed;
        "pkg-2.1.0+1.21" = _Z70SQ2aT;
        "pkg-2.1.1+1.21" = _uVdp2RBQ;
        "pkg-2.1.2+1.21" = _OEZmSzTm;
        "pkg-2.2.0+1.21" = _h8zsPi1P;
        "pkg-2.3.0+1.21" = _DUIDNKax;
        "pkg-2.3.1+1.21" = _wqqhnG9w;
        "pkg-2.3.2+1.21" = _Sr1L2fuF;
        "pkg-2.3.3+1.21.1" = _u2nDuStO;
        "pkg-2.3.3+1.21" = _M4pDfPtL;
        "pkg-2.4.0+1.21" = _PkkbF4BN;
        "pkg-2.4.0+1.21.1" = _mtR0HYTv;
        "pkg-2.4.1+1.21.1" = _1yi18Z8Q;
        "pkg-2.4.1+1.21" = _wIywUFnC;
        "pkg-2.5.0+1.21" = _pFtTDWFd;
        "pkg-2.5.0+1.21.1" = _iE3X6lAx;
        "pkg-3.0.0+1.21.1" = _HVM06Qa8;
        "pkg-3.0.0+1.21.4" = _qFpBThGV;
        "pkg-3.0.1+1.21.1" = _4yaOFVBD;
        "pkg-3.0.1+1.21.4" = _2FEHjEIT;
        "pkg-3.0.2+1.21.1" = _BHrrRcGI;
        "pkg-3.0.2+1.21.4" = _z5V721Qk;
        "pkg-3.1.0+1.21.1" = _1dq7kCZE;
        "pkg-3.1.0+1.21.4" = _5VmbxVM6;
        "pkg-3.1.1+1.21.1" = _ykSyAold;
        "pkg-3.1.1+1.21.4" = _XfK7b2ZK;
        "pkg-3.2.0+1.21.1" = _P9LQc9zv;
        "pkg-3.2.0+1.21.4" = _gl3sL6JE;
        "pkg-3.2.1+1.21.1" = _ft0XWg3E;
        "pkg-3.2.1+1.21.4" = _BuHuTyIY;
        "pkg-3.2.2+1.21.5" = _YzMewSE9;
        "pkg-3.2.2+1.21.4" = _4EAiB6vt;
        "pkg-3.2.2+1.21.1" = _hxCibR2i;
        "pkg-3.2.3+1.21.1" = _6vb5UsTT;
        "pkg-3.2.3+1.21.4" = _nqZq27sT;
        "pkg-3.2.3+1.21.5" = _Z93YC7g8;
        "pkg-3.2.4+1.21.1" = _N1qII6H9;
        "pkg-3.3.0+1.21.7" = _aANjJFQ9;
        "pkg-3.3.0+1.21.1" = _x4hoJLoU;
        "pkg-3.3.0+1.21.4" = _jg5rKWyB;
        "pkg-3.3.1+1.21.7" = _SL9tRsvm;
        "pkg-3.3.1+1.21.1" = _6PHL4vVp;
        "pkg-3.3.1+1.21.4" = _qbqItIb0;
        "pkg-3.3.2+1.21.7" = _wgYkiC8l;
        "pkg-3.3.2+1.21.1" = _8SpDlXs5;
        "pkg-3.3.2+1.21.4" = _82ykvwoj;
        "pkg-3.3.3+1.21.7" = _nSyLAUWP;
        "pkg-3.3.3+1.21.1" = _XLWSn771;
        "pkg-3.3.3+1.21.4" = _GVNot4Dk;
        "pkg-3.3.3+1.21.8" = _9KG8TnG6;
        "pkg-3.3.3+1.21.10" = _bA1UU5hB;
        "pkg-3.4.0+1.21.11-neoforge" = _9Oz5zpT5;
        "pkg-3.4.0+1.21.1-neoforge" = _TpZXAn9W;
        "pkg-3.4.0+1.21.11-fabric" = _iKXek1Sc;
        "pkg-3.4.0+1.21.1-fabric" = _ro8ntsAh;
        "pkg-3.4.1+1.21.10-neoforge" = _P1hpilFX;
        "pkg-3.4.1+1.21.10-fabric" = _CmlPLoKO;
        "pkg-3.4.1+1.21.1-neoforge" = _Uxs8QN2P;
        "pkg-3.4.1+1.21.1-fabric" = _8KlScplA;
        "pkg-3.4.1+1.21.11-neoforge" = _qz0eiuug;
        "pkg-3.4.1+1.21.11-fabric" = _NsJS7SvC;
        "pkg-3.4.2+1.21.10-neoforge" = _gvfe5ywL;
        "pkg-3.4.2+1.21.1-neoforge" = _bOcqish5;
        "pkg-3.4.2+1.21.11-neoforge" = _QESZ2OML;
        "pkg-3.4.2+1.21.1-fabric" = _qPomAkV6;
        "pkg-3.4.2+1.21.10-fabric" = _NzeXO7ny;
        "pkg-3.4.2+1.21.11-fabric" = _MqquhQFE;
        "pkg-3.4.3+1.21.1-neoforge" = _ynDd2uXi;
        "pkg-3.4.3+1.21.11-neoforge" = _tJJbUCp7;
        "pkg-3.4.3+1.21.10-neoforge" = _5AAosb9P;
        "pkg-3.4.3+1.21.1-fabric" = _IyKMJyzv;
        "pkg-3.4.3+1.21.10-fabric" = _NzmVtaFG;
        "pkg-3.4.3+1.21.11-fabric" = _R8ehDxOx;
        "pkg-3.4.4+1.21.11-neoforge" = _UoLhLezm;
        "pkg-3.4.4+1.21.11-fabric" = _ig5kGUhr;
        "pkg-3.4.5+26.1-fabric" = _cPqgDtvG;
        "pkg-3.4.5+26.1-neoforge" = _4x3A9pHg;
        "pkg-3.4.6+26.1-neoforge" = _jTzbtGuE;
        "pkg-3.4.6+26.1-fabric" = _RlVmXRai;
        "pkg-3.4.7+26.1-neoforge" = _89rmYW8E;
        "pkg-3.4.7+26.1-fabric" = _x5YzhlGb;
        "pkg-3.4.7+26.2-fabric" = _GvxuF7Y2;
        "pkg-3.4.8+1.21.1" = _2sCQjGW4;
        "pkg-3.4.8+26.1.2" = _EkcLPXMo;
        "pkg-3.4.8+26.2" = _KWjwQJc8;
