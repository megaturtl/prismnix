...
let
    versions = (let
        ...
        _2PUR02R5 = {
            "id" = "2PUR02R5";
            "file" = "Mini-Stuff-0.2.4+mc1.13-26.3.zip";
            "hash" = "sha512-8p/eD20tSfrQUAf+iZbwKFIvdYZdERkSmTB7Phj2YOctmhOjWstYZQozV4326X+8NJ9Nq0/sqc6m+S2KV/Ir+Q==";
        };
    in {
        "SRT2fyVF" = _SRT2fyVF;
        "DUsbGvP7" = _DUsbGvP7;
        ...
        "minecraft-1.20" = _2PUR02R5;
        "minecraft-1.20.1" = _2PUR02R5;
        "minecraft-1.20.2" = _2PUR02R5;
        "minecraft-1.20.3" = _2PUR02R5;
        "minecraft-1.20.4" = _2PUR02R5;
        "minecraft-1.20.5" = _2PUR02R5;
        "minecraft-1.20.6" = _2PUR02R5;
        "minecraft-1.12" = _S7IM1hg2;
        "minecraft-1.12.1" = _S7IM1hg2;
        "minecraft-1.21" = _2PUR02R5;
        "minecraft-1.21.1" = _2PUR02R5;
        "minecraft-1.21.2" = _2PUR02R5;
        "minecraft-1.21.3" = _2PUR02R5;
        "minecraft-1.21.4" = _2PUR02R5;
        "minecraft-1.21.5" = _2PUR02R5;
        "minecraft-1.21.6" = _2PUR02R5;
        "minecraft-1.21.7" = _2PUR02R5;
        "minecraft-1.21.8" = _2PUR02R5;
        "minecraft-1.21.9" = _2PUR02R5;
        "minecraft-1.21.10" = _2PUR02R5;
        "minecraft-1.21.11" = _2PUR02R5;
        "minecraft-23w31a" = _2PUR02R5;
        "minecraft-23w32a" = _2PUR02R5;
        "minecraft-23w33a" = _2PUR02R5;
        "minecraft-23w35a" = _2PUR02R5;
        "minecraft-1.20.2-pre1" = _2PUR02R5;
        "minecraft-23w42a" = _2PUR02R5;
        "minecraft-23w43a" = _2PUR02R5;
        "minecraft-23w43b" = _2PUR02R5;
        "minecraft-23w44a" = _2PUR02R5;
        "minecraft-23w45a" = _2PUR02R5;
        "minecraft-23w46a" = _2PUR02R5;
        "minecraft-24w03a" = _2PUR02R5;
        "minecraft-24w03b" = _2PUR02R5;
        "minecraft-24w04a" = _2PUR02R5;
        "minecraft-24w05a" = _2PUR02R5;
        "minecraft-24w05b" = _2PUR02R5;
        "minecraft-24w06a" = _2PUR02R5;
        "minecraft-24w07a" = _2PUR02R5;
        "minecraft-24w09a" = _2PUR02R5;
        "minecraft-24w10a" = _2PUR02R5;
        "minecraft-24w11a" = _2PUR02R5;
        "minecraft-24w12a" = _2PUR02R5;
        "minecraft-24w13a" = _2PUR02R5;
        "minecraft-24w14potato" = _2PUR02R5;
        "minecraft-24w14a" = _2PUR02R5;
        "minecraft-1.20.5-pre1" = _2PUR02R5;
        "minecraft-1.20.5-pre2" = _2PUR02R5;
        "minecraft-1.20.5-pre3" = _2PUR02R5;
        "minecraft-24w18a" = _2PUR02R5;
        "minecraft-24w19a" = _2PUR02R5;
        "minecraft-24w19b" = _2PUR02R5;
        "minecraft-24w20a" = _2PUR02R5;
        "minecraft-24w33a" = _2PUR02R5;
        "minecraft-24w34a" = _2PUR02R5;
        "minecraft-24w35a" = _2PUR02R5;
        "minecraft-24w36a" = _2PUR02R5;
        "minecraft-24w37a" = _2PUR02R5;
        "minecraft-24w38a" = _2PUR02R5;
        "minecraft-24w39a" = _2PUR02R5;
        "minecraft-24w40a" = _2PUR02R5;
        "minecraft-1.21.2-pre1" = _2PUR02R5;
        "minecraft-1.21.2-pre2" = _2PUR02R5;
        "minecraft-24w44a" = _2PUR02R5;
        "minecraft-24w45a" = _2PUR02R5;
        "minecraft-24w46a" = _2PUR02R5;
        "minecraft-26.1" = _2PUR02R5;
        "minecraft-26.1.1" = _2PUR02R5;
        "minecraft-26.1.2" = _2PUR02R5;
        "minecraft-26.2" = _2PUR02R5;
        "minecraft-26.3" = _2PUR02R5;
        "pkg-0.1.0+mc1.12.2" = _SRT2fyVF;
        "pkg-0.1.0+mc1.13-1.20.6" = _DUsbGvP7;
        "pkg-0.1.1+mc1.12.2" = _XOpdGiyB;
        "pkg-0.1.1+mc1.13-1.20.6" = _27sWItVX;
        "pkg-0.1.2" = _S7IM1hg2;
        "pkg-0.1.3+mc1.13-1.21" = _ayBUFHzA;
        "pkg-0.1.4" = _8nq8pC9B;
        "pkg-0.1.5" = _wDlCzvdV;
        "pkg-0.1.6" = _263kdcKz;
        "pkg-0.1.7" = _OtqrUWdd;
