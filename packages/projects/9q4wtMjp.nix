...
let
    ...
    in {
        ...
        "pkg-0.1.3-1.18.2" = _kfKHKesu;
        "pkg-1.0.0-1.20.1" = _hcnbNR2c;
        "pkg-1.0.1-1.20.1" = _cMZvC7B2;
        "pkg-1.0.2-1.20.1" = _TxUcIrrx;
        "pkg-1.0.3-1.20.1" = _MaEirTjY;
        "pkg-1.0.4-1.20.1" = _EIkweZ9Y;
        "pkg-1.0.5-1.20.1" = _CRNVZEyD;
        "pkg-1.0.6-1.20.1" = _mu9hX8at;
        "pkg-1.0.7-1.20.1" = _U72TIVvZ;
        "pkg-1.0.8-1.20.1" = _tJUwsSF7;
        "pkg-1.0.9-1.20.1" = _Kwe39uRL;
        "pkg-1.0.10-1.20.1" = _bXp6GfYo;
        "pkg-1.0.11-1.20.1" = _Wr46iB4L;
        "pkg-1.0.12-1.20.1" = _m93V0Xja;
        "pkg-1.0.13-1.20.1" = _yZ9b2MTz;
        "pkg-1.0.14-1.20.1" = _1gtiOOBp;
        "pkg-1.0.15-1.20.1" = _WTlvl3a2;
        "pkg-1.0.16-1.20.1" = _rJShZA3K;
        "pkg-1.0.17-1.20.1" = _qBw2teLa;
        "pkg-1.0.18-1.20.1" = _2LnBYYOD;
        "pkg-1.0.19-1.20.1" = _cFxHfQdz;
        "pkg-1.0.20-1.20.1" = _pn3lpkuA;
        "pkg-2.0.0-1.21" = _GJUeGggL;
        "pkg-2.0.1-1.21" = _Y77x58tp;
        "pkg-2.0.2-1.21" = _8tdqMt6I;
        "pkg-2.0.3-1.21" = _HDotEyCb;
        "pkg-2.0.4-1.21" = _74CTK9cw;
        "pkg-2.0.5-1.21" = _Lxi5YKaF;
        "pkg-2.0.6-1.21" = _6xeAEnM3;
        "pkg-2.0.7-1.21" = _SN5muSXv;
        "pkg-2.0.8-1.21" = _TiLR7vmc;
        "pkg-1.0.21-1.20.1" = _a71z7lSx;
        "pkg-1.0.22-1.20.1" = _Tnswfgx5;
        "pkg-2.0.9-1.21" = _tEc7dkAb;
        "pkg-2.0.10-1.21" = _kBMWtvKo;
        "pkg-2.0.11-1.21" = _qn8cGPBC;
