...
let
    versions = (let
        ...
        _mxKmJvNM = {
            "id" = "mxKmJvNM";
            "file" = "crosshair_heart-1.0.1-mc26.3.zip";
            "hash" = "sha512-rK2uWtvIm+KD+BiLwaXgd38NZyRL88ILvi6yBo55GyNRwWSDzts/zlFnK/q1NtnTnFyhzWRyKf7z9q0HPcSShw==";
        };
    in {
        "oqgwykZ1" = _oqgwykZ1;
        "hFzZ4fcL" = _hFzZ4fcL;
