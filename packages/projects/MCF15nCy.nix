...
let
    versions = (let
        ...
        _cmXXxqLy = {
            "id" = "cmXXxqLy";
            "file" = "weaponmod-neoforge-26.1.2-1.25.1.jar";
            "hash" = "sha512-DBp5O+J/JYo3RxWjsaRBvo04nhRZcHIY6x862ZPM/kqlU9BJRK+A97Ehca27Dd/Wh1ZjFE1TYlVqfHe8599B1Q==";
        };
        _XgKKfsWz = {
            "id" = "XgKKfsWz";
            "file" = "weaponmod-fabric-26.1.2-1.25.1.jar";
            "hash" = "sha512-ESvFW+lT//3Vct1zyFlx9D+oFmnl3MUbTXKH4QCPjcBiLaHSZ3Df6SCI2D7kN4DPBfb2TFtkfnVZzZS8W5YH2A==";
        };
        _IhfFnm0S = {
            "id" = "IhfFnm0S";
            "file" = "weaponmod-neoforge-26.2-1.25.1.jar";
            "hash" = "sha512-b1EFIRCpcl05RyvAzCLVOzwNVsxfABy37eAIqcCb2P/gLewFCT/IvJaa+p4+WRdBaM5QzT59Lz4uGJrvfOuuRg==";
        };
        _L98fqeHO = {
            "id" = "L98fqeHO";
            "file" = "weaponmod-fabric-26.2-1.25.1.jar";
            "hash" = "sha512-Jr0LotGuLLBzPYJIoRQx+w21JUAJ1THdnjzNzm2tyI4NaAAVI2oVXCTsHbV3cOogkWOFy2NzkEzRUwkHHTC1+w==";
        };
        _siULRRUR = {
            "id" = "siULRRUR";
            "file" = "weaponmod-neoforge-26.3-1.25.1.jar";
            "hash" = "sha512-asLgcLhUYF282U6TGTI+DE7Sj79etdlcb6JWtPPNY5rqp6bVUeOk9/NNW/5v6Z+Locm/GZRQ5eoh+0PnKcORuQ==";
        };
        _YfFKpBDC = {
            "id" = "YfFKpBDC";
            "file" = "weaponmod-fabric-26.3-1.25.1.jar";
            "hash" = "sha512-wctSPqwLNKCxfdfSn+WKTZrFqz8h2ctWwsRt67JgV8MmyrlyORsqvAiUjcFGJYsYO/olMWYvOJuIyOO3ZxNm6g==";
        };
    in {
        "HTWmAr5K" = _HTWmAr5K;
        "IhDU2tyE" = _IhDU2tyE;
        ...
        "fabric-26.1.2" = _XgKKfsWz;
        "fabric-26.2" = _L98fqeHO;
        "fabric-26.3" = _YfFKpBDC;
        ...
        "neoforge-26.1.2" = _cmXXxqLy;
        "neoforge-26.2" = _IhfFnm0S;
        "neoforge-26.3" = _siULRRUR;
        "pkg-1.12.2-1.20.0" = _HTWmAr5K;
        "pkg-1.13.2-1.20.0" = _IhDU2tyE;
        "pkg-1.14.4-1.20.0" = _ApzzWvMN;
        "pkg-1.15.2-1.20.0" = _EhL2qxro;
        "pkg-1.20.0" = _aSfbvNS5;
        "pkg-Fabric-1.16.5-1.20.0" = _xMEsv9BR;
        "pkg-Forge-1.17.1-1.20.0" = _XAW3CiWN;
        "pkg-Fabric-1.17.1-1.20.0" = _Cqnllow6;
        "pkg-Forge-1.18.2-1.20.0" = _A9CzMnXS;
        "pkg-Fabric-1.18.2-1.20.0" = _K4VdCxD2;
        "pkg-Forge-1.19.4-1.20.0" = _OwNx5acp;
        "pkg-Fabric-1.19.4-1.20.0" = _5oQ15BvF;
        "pkg-NeoForge-1.20.6-1.20.0" = _fMQU2XsL;
        "pkg-Fabric-1.20.6-1.20.0" = _41PqQxFh;
        "pkg-NeoForge-1.21-1.20.0" = _FZCVmTFZ;
        "pkg-Fabric-1.21-1.20.0" = _FLgruogi;
        "pkg-Forge-1.7.10-1.21.0" = _eO5b2aoX;
        "pkg-Forge-1.8.9-1.21.0" = _dYUAexQf;
        "pkg-Forge-1.9.4-1.21.0" = _wXbL80bN;
        "pkg-Forge-1.10.2-1.21.0" = _vabN46cZ;
        "pkg-Forge-1.11.2-1.21.0" = _8qGIJPAp;
        "pkg-Forge-1.12.2-1.21.0" = _GYKQhZtf;
        "pkg-Forge-1.13.2-1.21.0" = _SGzO41ne;
        "pkg-Forge-1.14.4-1.21.0" = _ihZOQMCI;
        "pkg-Forge-1.15.2-1.21.0" = _RIexrymW;
        "pkg-Forge-1.16.5-1.21.0" = _ElQMSSu9;
        "pkg-Fabric-1.16.5-1.21.0" = _Obh98C30;
        "pkg-Forge-1.17.1-1.21.0" = _4X9XN7Ey;
        "pkg-Fabric-1.17.1-1.21.0" = _yCzgQU8Q;
        "pkg-Forge-1.18.2-1.21.0" = _5DnTe8oT;
        "pkg-Fabric-1.18.2-1.21.0" = _UoMBPLTP;
        "pkg-Forge-1.19.2-1.21.0" = _Qgnhq3us;
        "pkg-Fabric-1.19.2-1.21.0" = _DERwsjFB;
        "pkg-Forge-1.19.4-1.21.0" = _54V6iEpL;
        "pkg-Fabric-1.19.4-1.21.0" = _cjlRURBZ;
        "pkg-Forge-1.20.1-1.21.0" = _fMbtmsBQ;
        "pkg-Fabric-1.20.1-1.21.0" = _afT1vFY1;
        "pkg-NeoForge-1.20.6-1.21.0" = _12FuqPB3;
        "pkg-Fabric-1.20.6-1.21.0" = _bxpeM2Sc;
        "pkg-NeoForge-1.21-1.21.0" = _9VWZpzb6;
        "pkg-Fabric-1.21-1.21.0" = _f3R4WpGJ;
        "pkg-Forge-1.7.10-1.21.1" = _3fktHWvA;
        "pkg-Forge-1.8.9-1.21.1" = _k4EEOK0i;
        "pkg-Forge-1.9.4-1.21.1" = _ZSXMJyP2;
        "pkg-Forge-1.10.2-1.21.1" = _yLa2vuAF;
        "pkg-Forge-1.11.2-1.21.1" = _dM27y5Ac;
        "pkg-Forge-1.12.2-1.21.1" = _UhE6q3HT;
        "pkg-Forge-1.13.2-1.21.1" = _Zzz7pNjY;
        "pkg-Forge-1.14.4-1.21.1" = _hLGkTpMN;
        "pkg-Forge-1.15.2-1.21.1" = _LJxjeDh8;
        "pkg-Forge-1.16.5-1.21.1" = _TXxfqI8s;
        "pkg-Fabric-1.16.5-1.21.1" = _6TfP7Zz4;
        "pkg-Forge-1.17.1-1.21.1" = _SI3u717s;
        "pkg-Fabric-1.17.1-1.21.1" = _2Nfkqbs5;
        "pkg-Forge-1.18.2-1.21.1" = _uwtP84N3;
        "pkg-Fabric-1.18.2-1.21.1" = _giH3xhnR;
        "pkg-Forge-1.19.2-1.21.1" = _qLGhDHyB;
        "pkg-Fabric-1.19.2-1.21.1" = _H2i9D1U0;
        "pkg-Forge-1.19.4-1.21.1" = _HoX07hOz;
        "pkg-Fabric-1.19.4-1.21.1" = _pPPHhdvl;
        "pkg-Forge-1.20.1-1.21.1" = _4KqXkJqG;
        "pkg-Fabric-1.20.1-1.21.1" = _dKHNt5kt;
        "pkg-NeoForge-1.20.6-1.21.1" = _QqIpru3N;
        "pkg-Fabric-1.20.6-1.21.1" = _9jqWV9nL;
        "pkg-NeoForge-1.21-1.21.1" = _w2flRXdL;
        "pkg-Fabric-1.21-1.21.1" = _5NjvKJUr;
        "pkg-Forge-1.7.10-1.21.2" = _gQZUvy96;
        "pkg-Forge-1.8.9-1.21.2" = _rw68G7S6;
        "pkg-Forge-1.9.4-1.21.2" = _5iLvkQwd;
        "pkg-Forge-1.10.2-1.21.2" = _P260x9ia;
        "pkg-Forge-1.11.2-1.21.2" = _wU7z9fdu;
        "pkg-Forge-1.12.2-1.21.2" = _O9a8zw2T;
        "pkg-Forge-1.13.2-1.21.2" = _7J4LzXsY;
        "pkg-Forge-1.14.4-1.21.2" = _fPWfG6u0;
        "pkg-Forge-1.15.2-1.21.2" = _MEubZKIV;
        "pkg-Forge-1.16.5-1.21.2" = _9MyG61ws;
        "pkg-Fabric-1.16.5-1.21.2" = _46NO52qL;
        "pkg-Forge-1.17.1-1.21.2" = _GoxaSNde;
        "pkg-Fabric-1.17.1-1.21.2" = _QYipX8sW;
        "pkg-Forge-1.18.2-1.21.2" = _Njw5WVoM;
        "pkg-Fabric-1.18.2-1.21.2" = _GZ5DOVCc;
        "pkg-Forge-1.19.2-1.21.2" = _s8HVnAUK;
        "pkg-Fabric-1.19.2-1.21.2" = _G4PbbU4O;
        "pkg-Forge-1.19.4-1.21.2" = _i53IioGO;
        "pkg-Fabric-1.19.4-1.21.2" = _AonWwNGP;
        "pkg-Forge-1.20.1-1.21.2" = _zCZQpFYA;
        "pkg-Fabric-1.20.1-1.21.2" = _aD1zvcc5;
        "pkg-NeoForge-1.20.6-1.21.2" = _Pyr07ucS;
        "pkg-Fabric-1.20.6-1.21.2" = _vuhzwTH0;
        "pkg-NeoForge-1.21-1.21.2" = _QoqEx572;
        "pkg-Fabric-1.21-1.21.2" = _QW6w7hih;
        "pkg-Forge-1.7.10-1.21.3" = _sQXOd5jA;
        "pkg-Forge-1.8.9-1.21.3" = _xdhPQ3lt;
        "pkg-Forge-1.9.4-1.21.3" = _bICxxLJf;
        "pkg-Forge-1.10.2-1.21.3" = _KASqlE8S;
        "pkg-Forge-1.11.2-1.21.3" = _15EWO9N3;
        "pkg-Forge-1.12.2-1.21.3" = _9tFqD412;
        "pkg-Forge-1.13.2-1.21.3" = _AMf0y5O5;
        "pkg-Forge-1.14.4-1.21.3" = _RHayKe3E;
        "pkg-Forge-1.15.2-1.21.3" = _FnhiXY5r;
        "pkg-Forge-1.16.5-1.21.3" = _hH9PxJG0;
        "pkg-Fabric-1.16.5-1.21.3" = _ZIvsak5z;
        "pkg-Forge-1.17.1-1.21.3" = _dAx4OmUO;
        "pkg-Fabric-1.17.1-1.21.3" = _3SSKwLlh;
        "pkg-Forge-1.18.2-1.21.3" = _ub8NDZ2S;
        "pkg-Fabric-1.18.2-1.21.3" = _x6gGydjk;
        "pkg-Forge-1.19.2-1.21.3" = _AlkLxG8h;
        "pkg-Fabric-1.19.2-1.21.3" = _7ThvNTtR;
        "pkg-Forge-1.19.4-1.21.3" = _Dy4PSf7p;
        "pkg-Fabric-1.19.4-1.21.3" = _KMuc1gFd;
        "pkg-Forge-1.20.1-1.21.3" = _b0NqBxgv;
        "pkg-Fabric-1.20.1-1.21.3" = _BhxEojlR;
        "pkg-NeoForge-1.20.6-1.21.3" = _TJ4DYt3Q;
        "pkg-Fabric-1.20.6-1.21.3" = _icRgHp31;
        "pkg-NeoForge-1.21-1.21.3" = _nJytmJXv;
        "pkg-Fabric-1.21-1.21.3" = _H1BoWDLV;
        "pkg-NeoForge-1.21-1.21.4" = _wLGl9sS9;
        "pkg-Fabric-1.21-1.21.4" = _Pd0Xh5gt;
        "pkg-Forge-1.7.10-1.22.0" = _Oag305xW;
        "pkg-Forge-1.8.9-1.22.0" = _Y5em6ClK;
        "pkg-Forge-1.9.4-1.22.0" = _Q4xY0G1z;
        "pkg-Forge-1.10.2-1.22.0" = _AiJjKE5v;
        "pkg-Forge-1.11.2-1.22.0" = _S0Ite7xZ;
        "pkg-Forge-1.12.2-1.22.0" = _XPd8VlfD;
        "pkg-Forge-1.13.2-1.22.0" = _pgQbeJJd;
        "pkg-Forge-1.14.4-1.22.0" = _DPrSrvbV;
        "pkg-Forge-1.15.2-1.22.0" = _EkNOqBzn;
        "pkg-Forge-1.16.5-1.22.0" = _L9FKnN5X;
        "pkg-Fabric-1.16.5-1.22.0" = _M5yWPlbH;
        "pkg-Forge-1.17.1-1.22.0" = _osQWFQzI;
        "pkg-Fabric-1.17.1-1.22.0" = _Af3huwHa;
        "pkg-Forge-1.18.2-1.22.0" = _Xzj7Wv3p;
        "pkg-Fabric-1.18.2-1.22.0" = _eIhOGGLM;
        "pkg-Forge-1.19.2-1.22.0" = _MNWYpspL;
        "pkg-Fabric-1.19.2-1.22.0" = _IaqraqOy;
        "pkg-Forge-1.19.4-1.22.0" = _FBVwpv7E;
        "pkg-Fabric-1.19.4-1.22.0" = _JtSDE4Rg;
        "pkg-Forge-1.20.1-1.22.0" = _mbJHl3hE;
        "pkg-Fabric-1.20.1-1.22.0" = _FAceoTIL;
        "pkg-NeoForge-1.20.6-1.22.0" = _vMiGXxT7;
        "pkg-Fabric-1.20.6-1.22.0" = _6BN03KrV;
        "pkg-NeoForge-1.21-1.22.0" = _vGFua5fA;
        "pkg-Fabric-1.21-1.22.0" = _e7XJckEI;
        "pkg-Forge-1.7.10-1.22.1" = _lBDkZcJ5;
        "pkg-Forge-1.8.9-1.22.1" = _w0kxsIYV;
        "pkg-Forge-1.9.4-1.22.1" = _JsUHSMEN;
        "pkg-Forge-1.10.2-1.22.1" = _yEiNcbAa;
        "pkg-Forge-1.11.2-1.22.1" = _tJ8KSNMf;
        "pkg-Forge-1.12.2-1.22.1" = _pdvfmZO4;
        "pkg-Forge-1.13.2-1.22.1" = _WNEdX3sx;
        "pkg-Forge-1.14.4-1.22.1" = _yedYU6Gq;
        "pkg-Forge-1.15.2-1.22.1" = _KjfZhSnM;
        "pkg-Forge-1.16.5-1.22.1" = _q8FtS49m;
        "pkg-Fabric-1.16.5-1.22.1" = _N0cQo4Au;
        "pkg-Forge-1.17.1-1.22.1" = _ggaHWjY7;
        "pkg-Fabric-1.17.1-1.22.1" = _YduC1GNq;
        "pkg-Forge-1.18.2-1.22.1" = _A42n1b42;
        "pkg-Fabric-1.18.2-1.22.1" = _pzsymHqy;
        "pkg-Forge-1.19.2-1.22.1" = _hpO28Zk5;
        "pkg-Fabric-1.19.2-1.22.1" = _XQ9v2vpj;
        "pkg-Forge-1.19.4-1.22.1" = _jOabnf4A;
        "pkg-Fabric-1.19.4-1.22.1" = _vnsVeciF;
        "pkg-Forge-1.20.1-1.22.1" = _UQQJg7Nj;
        "pkg-Fabric-1.20.1-1.22.1" = _9aaH6t8O;
        "pkg-NeoForge-1.20.6-1.22.1" = _2DZQHEGj;
        "pkg-Fabric-1.20.6-1.22.1" = _fMBJqXia;
        "pkg-NeoForge-1.21-1.22.1" = _OJB9Wksl;
        "pkg-Fabric-1.21-1.22.1" = _QafgRnqe;
        "pkg-Forge-1.7.10-1.22.2" = _qaQL1yMY;
        "pkg-Forge-1.8.9-1.22.2" = _NWzHarsM;
        "pkg-Forge-1.9.4-1.22.2" = _q9eRsbnn;
        "pkg-Forge-1.10.2-1.22.2" = _uhmBSg8q;
        "pkg-Forge-1.11.2-1.22.2" = _wWddjRrr;
        "pkg-Forge-1.12.2-1.22.2" = _gsJCQTrf;
        "pkg-Forge-1.13.2-1.22.2" = _ppP1bceT;
        "pkg-Forge-1.14.4-1.22.2" = _YfljiFAz;
        "pkg-Forge-1.15.2-1.22.2" = _eD6TwNNU;
        "pkg-Forge-1.16.5-1.22.2" = _j4RgLLHu;
        "pkg-Fabric-1.16.5-1.22.2" = _4vBM3juJ;
        "pkg-Forge-1.17.1-1.22.2" = _9bjRGqDn;
        "pkg-Fabric-1.17.1-1.22.2" = _eoQjYryC;
        "pkg-Forge-1.18.2-1.22.2" = _15gF0cO5;
        "pkg-Fabric-1.18.2-1.22.2" = _22YKlZnM;
        "pkg-Forge-1.19.2-1.22.2" = _9e4wPO0l;
        "pkg-Fabric-1.19.2-1.22.2" = _unz0IFpa;
        "pkg-Forge-1.19.4-1.22.2" = _DRFC0XH3;
        "pkg-Fabric-1.19.4-1.22.2" = _eiZsShLH;
        "pkg-Forge-1.20.1-1.22.2" = _5PmNME55;
        "pkg-Fabric-1.20.1-1.22.2" = _4VhSNJOu;
        "pkg-NeoForge-1.20.6-1.22.2" = _8XjJ83P3;
        "pkg-Fabric-1.20.6-1.22.2" = _Lv9tMbrq;
        "pkg-NeoForge-1.21-1.22.2" = _IMMH8a3A;
        "pkg-Fabric-1.21-1.22.2" = _f57cnn0m;
        "pkg-Forge-1.7.10-1.22.3" = _Rg5a0Iir;
        "pkg-Forge-1.8.9-1.22.3" = _jELpJTTq;
        "pkg-Forge-1.9.4-1.22.3" = _T4P9r9Y9;
        "pkg-Forge-1.10.2-1.22.3" = _qeQOkcD8;
        "pkg-Forge-1.11.2-1.22.3" = _h9zTAZPY;
        "pkg-Forge-1.12.2-1.22.3" = _neTwgNwN;
        "pkg-Forge-1.13.2-1.22.3" = _LvtFbd3u;
        "pkg-Forge-1.14.4-1.22.3" = _NTq6rPti;
        "pkg-Forge-1.15.2-1.22.3" = _Wom2iNLa;
        "pkg-Forge-1.16.5-1.22.3" = _eJaFS7Wk;
        "pkg-Fabric-1.16.5-1.22.3" = _gd91J9H1;
        "pkg-Forge-1.17.1-1.22.3" = _bDTSPhO8;
        "pkg-Fabric-1.17.1-1.22.3" = _hpxuRfdE;
        "pkg-Forge-1.18.2-1.22.3" = _8OMPPf2F;
        "pkg-Fabric-1.18.2-1.22.3" = _o09W6Seu;
        "pkg-Forge-1.19.2-1.22.3" = _ZDakfZ64;
        "pkg-Fabric-1.19.2-1.22.3" = _OB7AYHye;
        "pkg-Forge-1.19.4-1.22.3" = _cKQTiz8o;
        "pkg-Fabric-1.19.4-1.22.3" = _bvUTz3LZ;
        "pkg-Forge-1.20.1-1.22.3" = _4nbgqKEW;
        "pkg-Fabric-1.20.1-1.22.3" = _usWO0zvh;
        "pkg-NeoForge-1.20.6-1.22.3" = _txORFxIZ;
        "pkg-Fabric-1.20.6-1.22.3" = _vkL2kJkE;
        "pkg-NeoForge-1.21-1.22.3" = _oPEmJzGN;
        "pkg-Fabric-1.21-1.22.3" = _I43dXSHK;
        "pkg-Forge-1.7.10-1.22.4" = _GIujEMC2;
        "pkg-Forge-1.8.9-1.22.4" = _VUZx2aTn;
        "pkg-Forge-1.9.4-1.22.4" = _7rTMoQoX;
        "pkg-Forge-1.10.2-1.22.4" = _rBtljSD6;
        "pkg-Forge-1.11.2-1.22.4" = _zOcDYZ1I;
        "pkg-Forge-1.12.2-1.22.4" = _G2Oe6Gl4;
        "pkg-Forge-1.13.2-1.22.4" = _PraIxmzg;
        "pkg-Forge-1.14.4-1.22.4" = _kpe025QH;
        "pkg-Forge-1.15.2-1.22.4" = _XA4HstNO;
        "pkg-Forge-1.16.5-1.22.4" = _1rioLdMg;
        "pkg-Fabric-1.16.5-1.22.4" = _l9Rm9XA2;
        "pkg-Forge-1.17.1-1.22.4" = _YETwjYpV;
        "pkg-Fabric-1.17.1-1.22.4" = _ht0bCmJm;
        "pkg-Forge-1.18.2-1.22.4" = _X5bqMWL3;
        "pkg-Fabric-1.18.2-1.22.4" = _JwdIjrC4;
        "pkg-Forge-1.19.2-1.22.4" = _R6bpfZRG;
        "pkg-Fabric-1.19.2-1.22.4" = _Kb8uAYsG;
        "pkg-Forge-1.19.4-1.22.4" = _UpFrx8Ix;
        "pkg-Fabric-1.19.4-1.22.4" = _L0R2lpHy;
        "pkg-Forge-1.20.1-1.22.4" = _uCxmhrOL;
        "pkg-Fabric-1.20.1-1.22.4" = _VTPZd0Tr;
        "pkg-NeoForge-1.20.6-1.22.4" = _83vVB4en;
        "pkg-Fabric-1.20.6-1.22.4" = _Y19aGlXt;
        "pkg-NeoForge-1.21-1.22.4" = _qRlHXhoz;
        "pkg-Fabric-1.21-1.22.4" = _tsFxaaBC;
        "pkg-NeoForge-1.21.3-1.22.4" = _7SNUEeB7;
        "pkg-Fabric-1.21.3-1.22.4" = _p1VmwSQ9;
        "pkg-NeoForge-1.21.4-1.22.4" = _ipK0xgWZ;
        "pkg-Fabric-1.21.4-1.22.4" = _JmWnb4Yz;
        "pkg-Forge-1.7.10-1.23.0" = _t0ce1w9r;
        "pkg-Forge-1.8.9-1.23.0" = _qQd9Luwh;
        "pkg-Forge-1.9.4-1.23.0" = _kLyuPCA8;
        "pkg-Forge-1.10.2-1.23.0" = _51E3N9pk;
        "pkg-Forge-1.11.2-1.23.0" = _4sasOV6I;
        "pkg-Forge-1.12.2-1.23.0" = _JdbyPUai;
        "pkg-Forge-1.13.2-1.23.0" = _JdzyMbb6;
        "pkg-Forge-1.14.4-1.23.0" = _7i89UMVN;
        "pkg-Forge-1.15.2-1.23.0" = _XAZPTrbp;
        "pkg-Forge-1.16.5-1.23.0" = _mijJVXMK;
        "pkg-Fabric-1.16.5-1.23.0" = _Hn2wDbWR;
        "pkg-Forge-1.17.1-1.23.0" = _lqBty4xD;
        "pkg-Fabric-1.17.1-1.23.0" = _FWA0Xjn0;
        "pkg-Forge-1.18.2-1.23.0" = _CShTSi9r;
        "pkg-Fabric-1.18.2-1.23.0" = _QPengxN0;
        "pkg-Forge-1.19.2-1.23.0" = _p39Dl7Pe;
        "pkg-Fabric-1.19.2-1.23.0" = _2BRCd6v4;
        "pkg-Forge-1.19.4-1.23.0" = _JZdRZHf3;
        "pkg-Fabric-1.19.4-1.23.0" = _m9lSZXhm;
        "pkg-Forge-1.20.1-1.23.0" = _lIOGIoC2;
        "pkg-Fabric-1.20.1-1.23.0" = _JAXjPLKl;
        "pkg-NeoForge-1.20.6-1.23.0" = _hzG9zZNE;
        "pkg-Fabric-1.20.6-1.23.0" = _ywfPmNKq;
        "pkg-NeoForge-1.21-1.23.0" = _VPVnHnkz;
        "pkg-Fabric-1.21-1.23.0" = _TUAnumjs;
        "pkg-NeoForge-1.21.3-1.23.0" = _NPbEW7os;
        "pkg-Fabric-1.21.3-1.23.0" = _ESbyBXNw;
        "pkg-NeoForge-1.21.4-1.23.0" = _Z00Tg1OB;
        "pkg-Fabric-1.21.4-1.23.0" = _fyBAbNEd;
        "pkg-Forge-1.7.10-1.23.1" = _RpMMBBgf;
        "pkg-Forge-1.8.9-1.23.1" = _UnaPai29;
        "pkg-Forge-1.9.4-1.23.1" = _XXTtTSHi;
        "pkg-Forge-1.10.2-1.23.1" = _zmoGs7Et;
        "pkg-Forge-1.11.2-1.23.1" = _Uyio7nag;
        "pkg-Forge-1.12.2-1.23.1" = _qu4Tj6HB;
        "pkg-Forge-1.13.2-1.23.1" = _3jwTBU9T;
        "pkg-Forge-1.14.4-1.23.1" = _zue2XnKw;
        "pkg-Forge-1.15.2-1.23.1" = _KxOWlGFX;
        "pkg-Forge-1.16.5-1.23.1" = _H3laK5oF;
        "pkg-Fabric-1.16.5-1.23.1" = _3g55uo1V;
        "pkg-Forge-1.17.1-1.23.1" = _Ot3ykLq6;
        "pkg-Fabric-1.17.1-1.23.1" = _brmx3OKT;
        "pkg-Forge-1.18.2-1.23.1" = _fwp9IBAq;
        "pkg-Fabric-1.18.2-1.23.1" = _FmjnI4a0;
        "pkg-Forge-1.19.2-1.23.1" = _baPB0ql1;
        "pkg-Fabric-1.19.2-1.23.1" = _96Kalhmx;
        "pkg-Forge-1.19.4-1.23.1" = _6gaHZUoJ;
        "pkg-Fabric-1.19.4-1.23.1" = _brqFff5s;
        "pkg-Forge-1.20.1-1.23.1" = _6k5x0rzH;
        "pkg-Fabric-1.20.1-1.23.1" = _SRhAk1jo;
        "pkg-NeoForge-1.20.6-1.23.1" = _o0Zs36pr;
        "pkg-Fabric-1.20.6-1.23.1" = _lh5DOTkl;
        "pkg-NeoForge-1.21-1.23.1" = _RON0HOB4;
        "pkg-Fabric-1.21-1.23.1" = _tbunFypG;
        "pkg-NeoForge-1.21.3-1.23.1" = _9fC7P9UG;
        "pkg-Fabric-1.21.3-1.23.1" = _dBeJNaQs;
        "pkg-NeoForge-1.21.4-1.23.1" = _rJ9NYp8L;
        "pkg-Fabric-1.21.4-1.23.1" = _4pbWSKyQ;
        "pkg-Forge-1.7.10-1.23.2" = _9iCLa2jO;
        "pkg-Forge-1.8.9-1.23.2" = _kpEKPxH7;
        "pkg-Forge-1.9.4-1.23.2" = _baJNHGvo;
        "pkg-Forge-1.10.2-1.23.2" = _XB4GSz8L;
        "pkg-Forge-1.11.2-1.23.2" = _1Ux7midy;
        "pkg-Forge-1.12.2-1.23.2" = _vt5Qc8UL;
        "pkg-Forge-1.13.2-1.23.2" = _NdUGiFLU;
        "pkg-Forge-1.14.4-1.23.2" = _ZyfVmexd;
        "pkg-Forge-1.15.2-1.23.2" = _raDvRCgs;
        "pkg-Forge-1.16.5-1.23.2" = _CIUhBeiw;
        "pkg-Fabric-1.16.5-1.23.2" = _y5i2WGjN;
        "pkg-Forge-1.17.1-1.23.2" = _I9vonUAg;
        "pkg-Fabric-1.17.1-1.23.2" = _A6mXZBFq;
        "pkg-Forge-1.18.2-1.23.2" = _NQ3CDyQG;
        "pkg-Fabric-1.18.2-1.23.2" = _NTned8TS;
        "pkg-Forge-1.19.2-1.23.2" = _gYeqe8ZM;
        "pkg-Fabric-1.19.2-1.23.2" = _iu9LNlFA;
        "pkg-Forge-1.19.4-1.23.2" = _hfxVKbSX;
        "pkg-Fabric-1.19.4-1.23.2" = _aPGtuole;
        "pkg-Forge-1.20.1-1.23.2" = _UCScZQW5;
        "pkg-Fabric-1.20.1-1.23.2" = _Tcn8xUeE;
        "pkg-NeoForge-1.20.6-1.23.2" = _ngzx2PaD;
        "pkg-Fabric-1.20.6-1.23.2" = _6uR6nYrZ;
        "pkg-NeoForge-1.21-1.23.2" = _kEt2f9Aj;
        "pkg-Fabric-1.21-1.23.2" = _oRXT9ufD;
        "pkg-NeoForge-1.21.3-1.23.2" = _fpLLays2;
        "pkg-Fabric-1.21.3-1.23.2" = _Q3NcS0ps;
        "pkg-NeoForge-1.21.4-1.23.2" = _EuaBR9Eo;
        "pkg-Fabric-1.21.4-1.23.2" = _TwtbppkI;
        "pkg-NeoForge-1.21.5-1.23.2" = _er605CVR;
        "pkg-Fabric-1.21.5-1.23.2" = _L4wN6vyU;
        "pkg-Forge-1.7.10-1.23.3" = _MpniY6AM;
        "pkg-Forge-1.8.9-1.23.3" = _iWrG96QK;
        "pkg-Forge-1.9.4-1.23.3" = _c6gaMa2s;
        "pkg-Forge-1.10.2-1.23.3" = _G3ZKABOV;
        "pkg-Forge-1.11.2-1.23.3" = _MKDRa2vu;
        "pkg-Forge-1.12.2-1.23.3" = _cDRln1Sl;
        "pkg-Forge-1.13.2-1.23.3" = _akjQjz1l;
        "pkg-Forge-1.14.4-1.23.3" = _k099GpIA;
        "pkg-Forge-1.15.2-1.23.3" = _HxXV1Xuo;
        "pkg-Forge-1.16.5-1.23.3" = _cG2TUalL;
        "pkg-Fabric-1.16.5-1.23.3" = _VD7yOzVq;
        "pkg-Forge-1.17.1-1.23.3" = _Tfxamkqm;
        "pkg-Fabric-1.17.1-1.23.3" = _XXQSwhT0;
        "pkg-Forge-1.18.2-1.23.3" = _CCcfw5oG;
        "pkg-Fabric-1.18.2-1.23.3" = _70LVPK8m;
        "pkg-Forge-1.19.2-1.23.3" = _ewOFz6SF;
        "pkg-Fabric-1.19.2-1.23.3" = _DrmmXycS;
        "pkg-Forge-1.19.4-1.23.3" = _4saA0oLf;
        "pkg-Fabric-1.19.4-1.23.3" = _GI23KXuN;
        "pkg-Forge-1.20.1-1.23.3" = _qYTimMMb;
        "pkg-Fabric-1.20.1-1.23.3" = _Rv1PJ4wn;
        "pkg-NeoForge-1.20.6-1.23.3" = _L4DgKEDW;
        "pkg-Fabric-1.20.6-1.23.3" = _SbzY6qnh;
        "pkg-NeoForge-1.21-1.23.3" = _GXeLog15;
        "pkg-Fabric-1.21-1.23.3" = _45Tnry1z;
        "pkg-NeoForge-1.21.3-1.23.3" = _sn7k2nji;
        "pkg-Fabric-1.21.3-1.23.3" = _gyCs3Q7e;
        "pkg-NeoForge-1.21.4-1.23.3" = _HRYXoBxE;
        "pkg-Fabric-1.21.4-1.23.3" = _oA5np4vC;
        "pkg-NeoForge-1.21.5-1.23.3" = _BkEdNLyW;
        "pkg-Fabric-1.21.5-1.23.3" = _7OF62z8C;
        "pkg-NeoForge-1.21.6-1.23.3" = _BpKHjBsQ;
        "pkg-Fabric-1.21.6-1.23.3" = _l1nF0Itk;
        "pkg-Forge-1.7.10-1.23.4" = _LGmdSn3V;
        "pkg-Forge-1.8.9-1.23.4" = _bTmotjTK;
        "pkg-Forge-1.9.4-1.23.4" = _QauRLPk6;
        "pkg-Forge-1.10.2-1.23.4" = _QdNuIShC;
        "pkg-Forge-1.11.2-1.23.4" = _9OWnRYjZ;
        "pkg-Forge-1.12.2-1.23.4" = _Ikv9tCAL;
        "pkg-Forge-1.13.2-1.23.4" = _nu0GVOI0;
        "pkg-Forge-1.14.4-1.23.4" = _ARZUOBAD;
        "pkg-Forge-1.15.2-1.23.4" = _lxQp10mn;
        "pkg-Forge-1.16.5-1.23.4" = _7HQOBfFp;
        "pkg-Fabric-1.16.5-1.23.4" = _7pRo8u0E;
        "pkg-Forge-1.17.1-1.23.4" = _BFCiOzWc;
        "pkg-Fabric-1.17.1-1.23.4" = _ZdNgbSfM;
        "pkg-Forge-1.18.2-1.23.4" = _erm5ZTbo;
        "pkg-Fabric-1.18.2-1.23.4" = _U1Gdm4QY;
        "pkg-Forge-1.19.2-1.23.4" = _6PbbfXCf;
        "pkg-Fabric-1.19.2-1.23.4" = _TKLPSa2M;
        "pkg-Forge-1.19.4-1.23.4" = _ZFMokV2k;
        "pkg-Fabric-1.19.4-1.23.4" = _K8EBSkyw;
        "pkg-Forge-1.20.1-1.23.4" = _Z4AnbA4F;
        "pkg-Fabric-1.20.1-1.23.4" = _qOdXH7t0;
        "pkg-NeoForge-1.20.6-1.23.4" = _QcoYmYIc;
        "pkg-Fabric-1.20.6-1.23.4" = _NuarXGGo;
        "pkg-NeoForge-1.21-1.23.4" = _105APPi1;
        "pkg-Fabric-1.21-1.23.4" = _ZiENST1K;
        "pkg-NeoForge-1.21.3-1.23.4" = _ndAMI30w;
        "pkg-Fabric-1.21.3-1.23.4" = _BdHaIkYx;
        "pkg-NeoForge-1.21.4-1.23.4" = _NFfDBXKa;
        "pkg-Fabric-1.21.4-1.23.4" = _HcdX8YD9;
        "pkg-NeoForge-1.21.5-1.23.4" = _6uTrE9Wk;
        "pkg-Fabric-1.21.5-1.23.4" = _AQJHczZi;
        "pkg-NeoForge-1.21.6-1.23.4" = _zcUeeTLx;
        "pkg-Fabric-1.21.6-1.23.4" = _3YHaiamL;
        "pkg-Forge-1.7.10-1.24.0" = _24d9OU1d;
        "pkg-Forge-1.8.9-1.24.0" = _yINEzYQe;
        "pkg-Forge-1.9.4-1.24.0" = _uo673Ej0;
        "pkg-Forge-1.10.2-1.24.0" = _4fdOFom8;
        "pkg-Forge-1.11.2-1.24.0" = _atcuSIBJ;
        "pkg-Forge-1.12.2-1.24.0" = _QgDYb9b7;
        "pkg-Forge-1.13.2-1.24.0" = _JrEeBB89;
        "pkg-Forge-1.14.4-1.24.0" = _oO8SBFu9;
        "pkg-Forge-1.15.2-1.24.0" = _s6YunmOM;
        "pkg-Forge-1.16.5-1.24.0" = _iQPuMFij;
        "pkg-Fabric-1.16.5-1.24.0" = _uANzi6vT;
        "pkg-Forge-1.17.1-1.24.0" = _3fDiVSoA;
        "pkg-Fabric-1.17.1-1.24.0" = _gtYJOr1a;
        "pkg-Forge-1.18.2-1.24.0" = _luIsMqgt;
        "pkg-Fabric-1.18.2-1.24.0" = _BUMqjuVr;
        "pkg-Forge-1.19.2-1.24.0" = _4OXkhVgt;
        "pkg-Fabric-1.19.2-1.24.0" = _wr2WqfaI;
        "pkg-Forge-1.19.4-1.24.0" = _Yqk5fHh4;
        "pkg-Fabric-1.19.4-1.24.0" = _lN9FNhAf;
        "pkg-Forge-1.20.1-1.24.0" = _pLmWk61O;
        "pkg-Fabric-1.20.1-1.24.0" = _A99kTwrS;
        "pkg-NeoForge-1.20.6-1.24.0" = _eb8MPjg9;
        "pkg-Fabric-1.20.6-1.24.0" = _sqxRw4Rd;
        "pkg-NeoForge-1.21-1.24.0" = _8VgIpCBw;
        "pkg-Fabric-1.21-1.24.0" = _qriR40s6;
        "pkg-NeoForge-1.21.3-1.24.0" = _s9XGCSS6;
        "pkg-Fabric-1.21.3-1.24.0" = _G3qGFKXz;
        "pkg-NeoForge-1.21.4-1.24.0" = _TpVGCdHs;
        "pkg-Fabric-1.21.4-1.24.0" = _3gYhdJEg;
        "pkg-NeoForge-1.21.5-1.24.0" = _BpNu1zh3;
        "pkg-Fabric-1.21.5-1.24.0" = _o5Wa5k8p;
        "pkg-NeoForge-1.21.6-1.24.0" = _z8Yek75u;
        "pkg-Fabric-1.21.6-1.24.0" = _VP30nLLH;
        "pkg-Forge-1.7.10-1.24.1" = _tEKb1NzN;
        "pkg-Forge-1.8.9-1.24.1" = _UQamQrpe;
        "pkg-Forge-1.9.4-1.24.1" = _ePfB7S9J;
        "pkg-Forge-1.10.2-1.24.1" = _E8U4oOlt;
        "pkg-Forge-1.11.2-1.24.1" = _CyzQ5Ipt;
        "pkg-Forge-1.12.2-1.24.1" = _nb5vSRCE;
        "pkg-Forge-1.13.2-1.24.1" = _AuFhcBGZ;
        "pkg-Forge-1.14.4-1.24.1" = _G0hJ6haJ;
        "pkg-Forge-1.15.2-1.24.1" = _nmGgEAV6;
        "pkg-Forge-1.16.5-1.24.1" = _am3Ayk5d;
        "pkg-Fabric-1.16.5-1.24.1" = _kpi5QeAm;
        "pkg-Forge-1.17.1-1.24.1" = _tAaRIeqF;
        "pkg-Fabric-1.17.1-1.24.1" = _wZJwoZOM;
        "pkg-Forge-1.18.2-1.24.1" = _Fi5Pqs37;
        "pkg-Fabric-1.18.2-1.24.1" = _ebtIkgBu;
        "pkg-Forge-1.19.2-1.24.1" = _AQyq7sOd;
        "pkg-Fabric-1.19.2-1.24.1" = _ETjiTMXr;
        "pkg-Forge-1.19.4-1.24.1" = _Fu3W55mX;
        "pkg-Fabric-1.19.4-1.24.1" = _eW1uPlWf;
        "pkg-Forge-1.20.1-1.24.1" = _BGZHIo6k;
        "pkg-Fabric-1.20.1-1.24.1" = _lAQFZ7jL;
        "pkg-NeoForge-1.20.6-1.24.1" = _CqJa1CMH;
        "pkg-Fabric-1.20.6-1.24.1" = _S51nILF0;
        "pkg-NeoForge-1.21-1.24.1" = _tCj4RpRj;
        "pkg-Fabric-1.21-1.24.1" = _Lrf6vnzy;
        "pkg-NeoForge-1.21.3-1.24.1" = _oWG4uSgY;
        "pkg-Fabric-1.21.3-1.24.1" = _X34JKbP0;
        "pkg-NeoForge-1.21.4-1.24.1" = _R8C91CmD;
        "pkg-Fabric-1.21.4-1.24.1" = _6Ve0ECWo;
        "pkg-NeoForge-1.21.5-1.24.1" = _PF35Huil;
        "pkg-Fabric-1.21.5-1.24.1" = _xt2deMJr;
        "pkg-NeoForge-1.21.6-1.24.1" = _hNAezsJj;
        "pkg-Fabric-1.21.6-1.24.1" = _DhhKklYA;
        "pkg-Forge-1.7.10-1.24.2" = _M63HOj8W;
        "pkg-Forge-1.8.9-1.24.2" = _MVy0gvF3;
        "pkg-Forge-1.9.4-1.24.2" = _vfPOHa1L;
        "pkg-Forge-1.10.2-1.24.2" = _8CscNZ6A;
        "pkg-Forge-1.11.2-1.24.2" = _2fhagkdE;
        "pkg-Forge-1.12.2-1.24.2" = _O4gOKTqX;
        "pkg-Forge-1.13.2-1.24.2" = _g61JnrPF;
        "pkg-Forge-1.14.4-1.24.2" = _5a6DL4M9;
        "pkg-Forge-1.15.2-1.24.2" = _uiYwUCnL;
        "pkg-Forge-1.16.5-1.24.2" = _lFE6TvtE;
        "pkg-Fabric-1.16.5-1.24.2" = _nIT4xqVI;
        "pkg-Forge-1.17.1-1.24.2" = _xJpfC3s8;
        "pkg-Fabric-1.17.1-1.24.2" = _kKcaPc22;
        "pkg-Forge-1.18.2-1.24.2" = _jx1vcnZA;
        "pkg-Fabric-1.18.2-1.24.2" = _ooN5JyVH;
        "pkg-Forge-1.19.2-1.24.2" = _oq2od2il;
        "pkg-Fabric-1.19.2-1.24.2" = _AqqjOyTv;
        "pkg-Forge-1.19.4-1.24.2" = _yECqYFHx;
        "pkg-Fabric-1.19.4-1.24.2" = _5hKEU3w6;
        "pkg-Forge-1.20.1-1.24.2" = _ApCDtf3t;
        "pkg-Fabric-1.20.1-1.24.2" = _hgRIMXOL;
        "pkg-NeoForge-1.20.6-1.24.2" = _EMW7cfJh;
        "pkg-Fabric-1.20.6-1.24.2" = _CylDFmAH;
        "pkg-NeoForge-1.21-1.24.2" = _LtHARMvF;
        "pkg-Fabric-1.21-1.24.2" = _5KffEoIu;
        "pkg-NeoForge-1.21.3-1.24.2" = _p2UmFaWg;
        "pkg-Fabric-1.21.3-1.24.2" = _mVTj7SCv;
        "pkg-NeoForge-1.21.4-1.24.2" = _1iLGwhGr;
        "pkg-Fabric-1.21.4-1.24.2" = _8QpHeRC5;
        "pkg-NeoForge-1.21.5-1.24.2" = _mpYgqiUN;
        "pkg-Fabric-1.21.5-1.24.2" = _Ewyq1XW8;
        "pkg-NeoForge-1.21.6-1.24.2" = _Z9yepXoi;
        "pkg-Fabric-1.21.6-1.24.2" = _uD2SmEfd;
        "pkg-NeoForge-1.21.9-1.24.2" = _MmPsb98i;
        "pkg-Fabric-1.21.9-1.24.2" = _xNNWZqWU;
        "pkg-NeoForge-1.21.10-1.24.2" = _dRXmzAU0;
        "pkg-Fabric-1.21.10-1.24.2" = _gjAoL4ZU;
        "pkg-Forge-1.7.10-1.24.3" = _BKDM8xo7;
        "pkg-Forge-1.8.9-1.24.3" = _rf8pVaF6;
        "pkg-Forge-1.9.4-1.24.3" = _RAV4G3HV;
        "pkg-Forge-1.10.2-1.24.3" = _nbAq1l8V;
        "pkg-Forge-1.11.2-1.24.3" = _35FyBrDD;
        "pkg-Forge-1.12.2-1.24.3" = _9R0uAKHl;
        "pkg-Forge-1.13.2-1.24.3" = _1Lx9TnMw;
        "pkg-Forge-1.14.4-1.24.3" = _HliZCIAZ;
        "pkg-Forge-1.15.2-1.24.3" = _D7Ct1RFG;
        "pkg-Forge-1.16.5-1.24.3" = _WBn5BWnN;
        "pkg-Fabric-1.16.5-1.24.3" = _sT28KA1P;
        "pkg-Forge-1.17.1-1.24.3" = _NMEZtWCE;
        "pkg-Fabric-1.17.1-1.24.3" = _Zp7VPnus;
        "pkg-Forge-1.18.2-1.24.3" = _eEBOEozS;
        "pkg-Fabric-1.18.2-1.24.3" = _6uwKEZZp;
        "pkg-Forge-1.19.2-1.24.3" = _ikY63S6v;
        "pkg-Fabric-1.19.2-1.24.3" = _cFszMCGY;
        "pkg-Forge-1.19.4-1.24.3" = _vnVdYOym;
        "pkg-Fabric-1.19.4-1.24.3" = _akhYyddX;
        "pkg-Forge-1.20.1-1.24.3" = _G76i4A2J;
        "pkg-Fabric-1.20.1-1.24.3" = _R8hsMDiD;
        "pkg-NeoForge-1.20.6-1.24.3" = _At2wmbj5;
        "pkg-Fabric-1.20.6-1.24.3" = _oxRD02aQ;
        "pkg-NeoForge-1.21-1.24.3" = _AMDOwnHt;
        "pkg-Fabric-1.21-1.24.3" = _SQs8vOCe;
        "pkg-NeoForge-1.21.3-1.24.3" = _fhKPdRCV;
        "pkg-Fabric-1.21.3-1.24.3" = _WEVcoLFC;
        "pkg-NeoForge-1.21.4-1.24.3" = _kiJmTFB8;
        "pkg-Fabric-1.21.4-1.24.3" = _lcjOnbCW;
        "pkg-NeoForge-1.21.5-1.24.3" = _FLJFyoPv;
        "pkg-Fabric-1.21.5-1.24.3" = _oa9MbaKw;
        "pkg-NeoForge-1.21.6-1.24.3" = _6iS9SI0R;
        "pkg-Fabric-1.21.6-1.24.3" = _2VziB6hN;
        "pkg-NeoForge-1.21.10-1.24.3" = _ihKLZ3Nm;
        "pkg-Fabric-1.21.10-1.24.3" = _Pea8NQvd;
        "pkg-NeoForge-1.21.11-1.24.3" = _Ll4gXVYc;
        "pkg-Fabric-1.21.11-1.24.3" = _oibqN81b;
        "pkg-Forge-1.7.10-1.24.4" = _745u0UPn;
        "pkg-Forge-1.8.9-1.24.4" = _kHnC4kvd;
        "pkg-Forge-1.9.4-1.24.4" = _r7jA7EZT;
        "pkg-Forge-1.10.2-1.24.4" = _kmk8QGGT;
        "pkg-Forge-1.11.2-1.24.4" = _94YSdYav;
        "pkg-Forge-1.12.2-1.24.4" = _HzIvaqBe;
        "pkg-Forge-1.13.2-1.24.4" = _srFTpXyF;
        "pkg-Forge-1.14.4-1.24.4" = _HbGY5eCk;
        "pkg-Forge-1.15.2-1.24.4" = _Rg3Xm3hJ;
        "pkg-Forge-1.16.5-1.24.4" = _C5FSiY4D;
        "pkg-Fabric-1.16.5-1.24.4" = _jnKQ7TA3;
        "pkg-Forge-1.17.1-1.24.4" = _tLwfWYIv;
        "pkg-Fabric-1.17.1-1.24.4" = _W72SJhPR;
        "pkg-Forge-1.18.2-1.24.4" = _HAgPFyxP;
        "pkg-Fabric-1.18.2-1.24.4" = _cSVajERI;
        "pkg-Forge-1.19.2-1.24.4" = _z0BQK4Qw;
        "pkg-Fabric-1.19.2-1.24.4" = _H7JavBbJ;
        "pkg-Forge-1.19.4-1.24.4" = _qdPoeT0Y;
        "pkg-Fabric-1.19.4-1.24.4" = _suuo8lrl;
        "pkg-Forge-1.20.1-1.24.4" = _gpfbESrq;
        "pkg-Fabric-1.20.1-1.24.4" = _HKwZ315z;
        "pkg-NeoForge-1.20.6-1.24.4" = _gTnZPYWw;
        "pkg-Fabric-1.20.6-1.24.4" = _vIHfLMVf;
        "pkg-NeoForge-1.21-1.24.4" = _SUBoDFp4;
        "pkg-Fabric-1.21-1.24.4" = _h8iOguPE;
        "pkg-NeoForge-1.21.3-1.24.4" = _A0CB56Kw;
        "pkg-Fabric-1.21.3-1.24.4" = _7bumDYmU;
        "pkg-NeoForge-1.21.4-1.24.4" = _tbkDzC90;
        "pkg-Fabric-1.21.4-1.24.4" = _4ZtEt4vm;
        "pkg-NeoForge-1.21.5-1.24.4" = _TCkEPNsj;
        "pkg-Fabric-1.21.5-1.24.4" = _O8mYIW74;
        "pkg-NeoForge-1.21.6-1.24.4" = _4tT7DnPY;
        "pkg-Fabric-1.21.6-1.24.4" = _K6uyzT6K;
        "pkg-NeoForge-1.21.10-1.24.4" = _fe4NbcJD;
        "pkg-Fabric-1.21.10-1.24.4" = _fidhXzmg;
        "pkg-NeoForge-1.21.11-1.24.4" = _X5W2fOS4;
        "pkg-Fabric-1.21.11-1.24.4" = _Ytm3L8cf;
        "pkg-Forge-1.7.10-1.24.5" = _zQaGRuI1;
        "pkg-Forge-1.8.9-1.24.5" = _DTfhTcNa;
        "pkg-Forge-1.9.4-1.24.5" = _8zywaP2Y;
        "pkg-Forge-1.10.2-1.24.5" = _V2RI96mW;
        "pkg-Forge-1.11.2-1.24.5" = _iXMcoHPb;
        "pkg-Forge-1.12.2-1.24.5" = _WqpXbFQ6;
        "pkg-Forge-1.13.2-1.24.5" = _eypYmKL3;
        "pkg-Forge-1.14.4-1.24.5" = _homZXoET;
        "pkg-Forge-1.15.2-1.24.5" = _s7SVunc2;
        "pkg-Forge-1.16.5-1.24.5" = _qgstty7c;
        "pkg-Fabric-1.16.5-1.24.5" = _wpwCOiMh;
        "pkg-Forge-1.17.1-1.24.5" = _I2tEKISV;
        "pkg-Fabric-1.17.1-1.24.5" = _4Yb5qoLM;
        "pkg-Forge-1.18.2-1.24.5" = _FJel4pJn;
        "pkg-Fabric-1.18.2-1.24.5" = _Y3XTDu3l;
        "pkg-Forge-1.19.2-1.24.5" = _pZG0JYiu;
        "pkg-Fabric-1.19.2-1.24.5" = _wwEnp32E;
        "pkg-Forge-1.19.4-1.24.5" = _xarmAV5n;
        "pkg-Fabric-1.19.4-1.24.5" = _F5RXLmE8;
        "pkg-Forge-1.20.1-1.24.5" = _fKbgzGye;
        "pkg-Fabric-1.20.1-1.24.5" = _dLdgJqaZ;
        "pkg-NeoForge-1.20.6-1.24.5" = _PQ3TtuAT;
        "pkg-Fabric-1.20.6-1.24.5" = _wUBWbNk3;
        "pkg-NeoForge-1.21-1.24.5" = _4mDAhH2y;
        "pkg-Fabric-1.21-1.24.5" = _l2IhnhKk;
        "pkg-NeoForge-1.21.3-1.24.5" = _PIPezZDX;
        "pkg-Fabric-1.21.3-1.24.5" = _bhwEnH3G;
        "pkg-NeoForge-1.21.4-1.24.5" = _CVzNM9tV;
        "pkg-Fabric-1.21.4-1.24.5" = _kNSg6WUj;
        "pkg-NeoForge-1.21.5-1.24.5" = _HlubypQU;
        "pkg-Fabric-1.21.5-1.24.5" = _6w5DvYz1;
        "pkg-NeoForge-1.21.6-1.24.5" = _l5aRlGO4;
        "pkg-Fabric-1.21.6-1.24.5" = _bdawzrKY;
        "pkg-NeoForge-1.21.10-1.24.5" = _6naaaqZH;
        "pkg-Fabric-1.21.10-1.24.5" = _ViOfC7Cw;
        "pkg-NeoForge-1.21.11-1.24.5" = _TOyygnii;
        "pkg-Fabric-1.21.11-1.24.5" = _9fZaLP5v;
        "pkg-NeoForge-26.1-1.24.5" = _RQ6lex7d;
        "pkg-Fabric-26.1-1.24.5" = _b7fDeNx7;
        "pkg-Forge-1.7.10-1.24.6" = _acUmMsUx;
        "pkg-Forge-1.8.9-1.24.6" = _gyZVp6g7;
        "pkg-Forge-1.9.4-1.24.6" = _MG4ygYhC;
        "pkg-Forge-1.10.2-1.24.6" = _ApgLCews;
        "pkg-Forge-1.11.2-1.24.6" = _lz9XPw13;
        "pkg-Forge-1.12.2-1.24.6" = _AHl1EPZX;
        "pkg-Forge-1.13.2-1.24.6" = _9Vsv80Y3;
        "pkg-Forge-1.14.4-1.24.6" = _fNgF3hP3;
        "pkg-Forge-1.15.2-1.24.6" = _FrpqTXmm;
        "pkg-Forge-1.16.5-1.24.6" = _fiXJgoLQ;
        "pkg-Fabric-1.16.5-1.24.6" = _MSAVD9nj;
        "pkg-Forge-1.17.1-1.24.6" = _MtXh2CEF;
        "pkg-Fabric-1.17.1-1.24.6" = _mM6yJPKp;
        "pkg-Forge-1.18.2-1.24.6" = _LonRcAJh;
        "pkg-Fabric-1.18.2-1.24.6" = _iGqmqWVC;
        "pkg-Forge-1.19.2-1.24.6" = _iNLWbOAe;
        "pkg-Fabric-1.19.2-1.24.6" = _hC3ApUf4;
        "pkg-Forge-1.19.4-1.24.6" = _owAhDrZ5;
        "pkg-Fabric-1.19.4-1.24.6" = _2EIfPzrF;
        "pkg-Forge-1.20.1-1.24.6" = _faVGy6nY;
        "pkg-Fabric-1.20.1-1.24.6" = _XQbVfV3d;
        "pkg-NeoForge-1.20.6-1.24.6" = _CH6C8xaj;
        "pkg-Fabric-1.20.6-1.24.6" = _aIyK7Jll;
        "pkg-NeoForge-1.21-1.24.6" = _su7ScazH;
        "pkg-Fabric-1.21-1.24.6" = _q0mUGRJj;
        "pkg-NeoForge-1.21.3-1.24.6" = _Oru1nT6d;
        "pkg-Fabric-1.21.3-1.24.6" = _YlygBf7W;
        "pkg-NeoForge-1.21.4-1.24.6" = _ZujGOuNp;
        "pkg-Fabric-1.21.4-1.24.6" = _AOx2g5Qs;
        "pkg-NeoForge-1.21.5-1.24.6" = _SmDSqx1R;
        "pkg-Fabric-1.21.5-1.24.6" = _cWc33GPa;
        "pkg-NeoForge-1.21.6-1.24.6" = _w6ikLGg4;
        "pkg-Fabric-1.21.6-1.24.6" = _TTerED3B;
        "pkg-NeoForge-1.21.10-1.24.6" = _ZUHoiK1L;
        "pkg-Fabric-1.21.10-1.24.6" = _MjPNgIII;
        "pkg-NeoForge-1.21.11-1.24.6" = _2dhGZH1k;
        "pkg-Fabric-1.21.11-1.24.6" = _anH7ZySK;
        "pkg-NeoForge-26.1-1.24.6" = _woNcah2N;
        "pkg-Fabric-26.1-1.24.6" = _SDxckHBT;
        "pkg-NeoForge-26.2-1.24.6" = _IICcFCqx;
        "pkg-Fabric-26.2-1.24.6" = _CF7RLJOO;
        "pkg-Forge-1.7.10-1.25.0" = _otrKSHvE;
        "pkg-Forge-1.8.9-1.25.0" = _aoVruj2P;
        "pkg-Forge-1.9.4-1.25.0" = _jyopoP5F;
        "pkg-Forge-1.10.2-1.25.0" = _2vQHQ5N8;
        "pkg-Forge-1.11.2-1.25.0" = _AktnDIQZ;
        "pkg-Forge-1.12.2-1.25.0" = _7wumXhAF;
        "pkg-Forge-1.13.2-1.25.0" = _BZjy5mN3;
        "pkg-Forge-1.14.4-1.25.0" = _GCxIlPfO;
        "pkg-Forge-1.15.2-1.25.0" = _EYvYfQat;
        "pkg-Forge-1.16.5-1.25.0" = _fcOFsFvC;
        "pkg-Fabric-1.16.5-1.25.0" = _iNbOHZcC;
        "pkg-Forge-1.17.1-1.25.0" = _OAmwFMSA;
        "pkg-Fabric-1.17.1-1.25.0" = _etWOUPV4;
        "pkg-Forge-1.18.2-1.25.0" = _zt2O8iNx;
        "pkg-Fabric-1.18.2-1.25.0" = _MYWJkrab;
        "pkg-Forge-1.19.2-1.25.0" = _N2ptDwfu;
        "pkg-Fabric-1.19.2-1.25.0" = _ZI3vAbR0;
        "pkg-Forge-1.19.4-1.25.0" = _eOiHSMV7;
        "pkg-Fabric-1.19.4-1.25.0" = _NnaNHoM6;
        "pkg-Forge-1.20.1-1.25.0" = _XtR7w9e0;
        "pkg-Fabric-1.20.1-1.25.0" = _QhFKaomm;
        "pkg-NeoForge-1.20.6-1.25.0" = _uBY9j1lt;
        "pkg-Fabric-1.20.6-1.25.0" = _cA68OMio;
        "pkg-NeoForge-1.21.1-1.25.0" = _TWEOWXgw;
        "pkg-Fabric-1.21.1-1.25.0" = _MAnZ7id0;
        "pkg-NeoForge-1.21.3-1.25.0" = _oiZzlDvZ;
        "pkg-Fabric-1.21.3-1.25.0" = _nyi42KPL;
        "pkg-NeoForge-1.21.4-1.25.0" = _TCOwKGEr;
        "pkg-Fabric-1.21.4-1.25.0" = _c9sZdT9k;
        "pkg-NeoForge-1.21.5-1.25.0" = _72ucylfD;
        "pkg-Fabric-1.21.5-1.25.0" = _rtjZpJCS;
        "pkg-NeoForge-1.21.6-1.25.0" = _idlCjYur;
        "pkg-Fabric-1.21.6-1.25.0" = _FrVMEV8U;
        "pkg-NeoForge-1.21.10-1.25.0" = _10jygozf;
        "pkg-Fabric-1.21.10-1.25.0" = _AzYh85QE;
        "pkg-NeoForge-1.21.11-1.25.0" = _v6qkoFQo;
        "pkg-Fabric-1.21.11-1.25.0" = _twt9opdF;
        "pkg-NeoForge-26.1.2-1.25.0" = _wMeNumZS;
        "pkg-Fabric-26.1.2-1.25.0" = _QBH0oqaH;
        "pkg-NeoForge-26.2-1.25.0" = _lECT3umk;
        "pkg-Fabric-26.2-1.25.0" = _fzUcQTjE;
        "pkg-NeoForge-26.1.2-1.25.1" = _cmXXxqLy;
        "pkg-Fabric-26.1.2-1.25.1" = _XgKKfsWz;
        "pkg-NeoForge-26.2-1.25.1" = _IhfFnm0S;
        "pkg-Fabric-26.2-1.25.1" = _L98fqeHO;
        "pkg-NeoForge-26.3-1.25.1" = _siULRRUR;
        "pkg-Fabric-26.3-1.25.1" = _YfFKpBDC;
        "default" = _YfFKpBDC;
    });
