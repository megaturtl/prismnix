...
let
    ...
    in {
        ...
        "pkg-4.1.0" = _G0Pzpi84;
        "pkg-5.1.0" = _I0ZdGtgZ;
        "pkg-5.1.1+1.21" = _tM28PsJ6;
        "pkg-6.0.0+1.21.2-pre1" = _a2uqAawl;
        "pkg-6.0.1+1.21.2-pre1" = _VX9bNPpT;
        "pkg-6.0.1+1.21.2" = _6NsL4ACl;
        "pkg-1.1.1+1.20" = _g2Gja0nn;
        "pkg-2.1.1+1.20.2" = _lfqVxLIx;
        "pkg-3.1.1+1.20.3" = _wQ3SFa0R;
        "pkg-4.1.1+1.21" = _RbxATDLD;
        "pkg-6.0.2+1.21.2" = _TgBzlvPm;
        "pkg-1.1.2+1.20" = _owpYSCSf;
        "pkg-2.1.2+1.20.2" = _PLlfvj7c;
        "pkg-3.1.2+1.20.3" = _Z6hqbMYF;
        "pkg-1.2.0+1.20" = _SlWraqad;
        "pkg-2.2.0+1.20.2" = _HNHm3Duj;
        "pkg-3.2.0+1.20.3" = _tQ6MMoS9;
