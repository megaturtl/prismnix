...
let
    ...
    in {
        ...
        "pkg-1.4.6" = _nssrCAUZ;
        "pkg-1.5.6" = _ITWUiOtM;
        "pkg-1.6.6-beta" = _SYNCS55Z;
        "pkg-1.6.6-beta2.1" = _YgEl63eN;
        "pkg-1.6.6-beta3" = _K4fF0P0i;
        "pkg-1.6.6-beta4" = _LLwQJhBL;
        "pkg-1.3.7" = _cXqWVQ2g;
        "pkg-1.4.7" = _gy7xADp4;
        "pkg-1.5.7" = _RbmGOv5u;
        "pkg-1.6.7-beta" = _HmfupCiU;
        "pkg-1.6.7-beta2" = _EANsDqLQ;
        "pkg-1.6.8-beta" = _QCd2ZQVb;
        "pkg-1.3.8" = _mfPduW4W;
        "pkg-1.4.8" = _3ojHvM2b;
        "pkg-1.5.8" = _MhWTvIyt;
        "pkg-1.6.8" = _asuG8Tao;
        "pkg-1.6.9" = _onouWDKb;
        "pkg-1.6.10" = _EmO5RuT7;
        "pkg-1.6.11-beta" = _3RBWyXGL;
        "pkg-1.6.12" = _hZ0WMtAH;
        "pkg-1.6.13" = _81WZj9NK;
        "pkg-1.6.14-beta" = _3ZqJ4HqC;
        "pkg-1.6.14" = _7puMNTDK;
        "pkg-1.7.14-beta" = _sitYp9U3;
        "pkg-1.7.14" = _GsTM5nP9;
        "pkg-1.6.15" = _5iugCDy0;
        "pkg-1.7.15" = _oy7ROzBx;
        "pkg-1.7.16" = _qCrk9Btw;
        "pkg-1.7.17-beta" = _Z5hCoyFS;
        "pkg-1.7.17" = _DiYKxwHj;
        "pkg-1.7.18" = _jVlG1ygl;
        "pkg-1.7.19" = _rNWb9ncY;
        "pkg-1.8.19-beta" = _5A29as1f;
        "pkg-1.8.20-beta" = _oMVd3ve4;
        "pkg-1.8.20" = _IT4jDwCA;
        "pkg-1.9.20" = _Nl43K1A6;
        "pkg-2.0.0" = _4JhyDk1b;
        "pkg-2.1.0" = _ZgCUl9IE;
        "pkg-2.0.1" = _j9zf3oGu;
        "pkg-2.1.1" = _w5DT7jTj;
        ...
        "pkg-2.4.9" = _QA7Jdm3C;
        "pkg-2.5.9" = _BXITh1kt;
        "pkg-2.5.10" = _aVJkWMQl;
        "pkg-3.0.0+Fabric" = _HhjXbCFQ;
        "pkg-3.0.0+NeoForge" = _g2mhuCpO;
        "pkg-3.0.1+NeoForge" = _6EJ7q37u;
        "pkg-3.1.0+NeoForge" = _lneIGLdL;
        "pkg-3.1.0+Fabric" = _Xf7Jh1bL;
        "pkg-2.1.3" = _GweB3zZk;
