...
let
    ...
    in {
        ...
        "pkg-1.20.2-v1.2.8" = _ITptvaIC;
        "pkg-1.20.2-v1.2.9" = _BMPf1oUB;
        "pkg-1.20.5-v1.2.10" = _GeiKIC3S;
        "pkg-1.21-v1.2.11" = _pvEPjXHi;
        "pkg-1.21.2-v1.2.12" = _2ewKd3Ts;
        "pkg-1.21.5-v1.2.13" = _c2NhCyUs;
        "pkg-1.21.6-v1.2.14" = _7oboXWl0;
