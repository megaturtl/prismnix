...
let
    ...
    in {
        ...
        "pkg-mc1.17.1-1.2.3" = _2ZjwMMUs;
        "pkg-mc1.18-1.2.3" = _qVGm8D0z;
        "pkg-mc1.18.1-1.2.4" = _eXMuwKVY;
        "pkg-mc1.16.5-1.3.0" = _mQFJNJdc;
        "pkg-mc1.17.1-1.3.0" = _Xup8BecQ;
        "pkg-mc1.18.1-1.3.0" = _63pLryH1;
        "pkg-mc1.16.5-1.4.0" = _IHJm9Anb;
        "pkg-mc1.18.1-1.4.0" = _pvHWVfI5;
        "pkg-mc1.17.1-1.4.0" = _7VjHd5G5;
        "pkg-mc1.16.5-1.4.1" = _5Ye5HBHX;
        "pkg-mc1.17.1-1.4.1" = _Q2edyr4h;
        "pkg-mc1.18.2-1.4.1" = _agsp1ZPm;
        "pkg-mc1.16.5-1.4.2" = _1kLQm4zM;
        "pkg-mc1.17.1-1.4.2" = _9upqY209;
        "pkg-mc1.18.2-1.4.2" = _IUZ9L8mF;
        "pkg-mc1.16.5-1.4.3" = _geYxi0x3;
        "pkg-mc1.17.1-1.4.3" = _WCmiuPiu;
        "pkg-mc1.18.2-1.4.3" = _iQMF2ssl;
        "pkg-mc1.19-1.4.3" = _uBfzWM0b;
        "pkg-mc1.16.5-1.4.4" = _9xauu4l3;
        "pkg-mc1.17.1-1.4.4" = _3eWUqOWU;
        "pkg-mc1.18.2-1.4.4" = _KpKZPkUm;
        "pkg-mc1.19-1.4.4" = _qxGDgtuW;
        "pkg-mc1.16.5-1.4.5" = _9o3aDwBf;
        "pkg-mc1.17.1-1.4.5" = _kAEEtATR;
        "pkg-mc1.18.2-1.4.5" = _J13Rvx8y;
        "pkg-mc1.19.2-1.4.5" = _FVGA2EtE;
        "pkg-mc1.16.5-1.4.6" = _NbRhhyuv;
        "pkg-mc1.17.1-1.4.6" = _UepHJf2v;
        "pkg-mc1.18.2-1.4.6" = _tBapWg9r;
        "pkg-mc1.19.2-1.4.6" = _nkmHfZcl;
        "pkg-mc1.16.5-1.4.7" = _ggmMQ6HU;
        "pkg-mc1.17.1-1.4.7" = _9cT6EFPB;
        "pkg-mc1.18.2-1.4.7" = _74LitD6T;
        "pkg-mc1.19.2-1.4.7" = _Iusxhlyd;
        "pkg-mc1.16.5-1.4.8" = _8hbfyCZ5;
        "pkg-mc1.17.1-1.4.8" = _PBNLJeaC;
        "pkg-mc1.18.2-1.4.8" = _IgfpiuvV;
        "pkg-mc1.19.2-1.4.8" = _UFoHPsH6;
        "pkg-mc1.16.5-1.4.9" = _RVUmt1Lx;
        "pkg-mc1.17.1-1.4.9" = _nrlpP9Lt;
        "pkg-mc1.18.2-1.4.9" = _hl16W0ql;
        "pkg-mc1.19.2-1.4.9" = _hkSQ9RqT;
        "pkg-mc1.16.5-1.5.0" = _292StcfY;
        "pkg-mc1.17.1-1.5.0" = _r2sBtu0R;
        "pkg-mc1.18.2-1.5.0" = _pvsKP7OO;
        "pkg-mc1.19.4-1.5.0" = _aO0hSGlL;
        "pkg-mc1.20-1.5.1" = _SgSIhHQO;
        "pkg-mc1.16.5-1.6.0" = _e1AFi9mm;
        "pkg-mc1.17.1-1.6.0" = _PK0yIs6a;
        "pkg-mc1.18.2-1.6.0" = _ZoTRkwNn;
        "pkg-mc1.19.2-1.6.0" = _8CKyqPyU;
        "pkg-mc1.20.1-1.6.0" = _FaJcaG39;
        "pkg-mc1.19.4-1.6.0" = _1PqmtuUf;
        "pkg-mc1.19.4-1.6.1" = _uzl1V5xt;
        "pkg-mc1.20.1-1.6.1" = _EcAN49cK;
        "pkg-mc1.19.4-1.6.2" = _hHK7EdJe;
        "pkg-mc1.20.1-1.6.2" = _jU0aA0l6;
        "pkg-mc1.16.5-1.6.3" = _Em4mC86n;
        "pkg-mc1.17.1-1.6.3" = _g7GMB1UL;
        "pkg-mc1.18.2-1.6.3" = _BZU4WdR5;
        "pkg-mc1.19.2-1.6.3" = _fS8c2e54;
        "pkg-mc1.19.4-1.6.3" = _vjKE54Zq;
        "pkg-mc1.20.1-1.6.3" = _PCctWHcc;
        "pkg-mc1.19.2-1.6.4" = _uCsFu5xs;
        "pkg-mc1.20.1-1.6.4" = _JB3vAAoX;
        "pkg-mc1.20.1-1.6.5" = _hCsMUZLa;
        "pkg-mc1.20.2-1.6.5" = _UpKbnidp;
        "pkg-mc1.20.2-1.7.0" = _YxKBGhki;
        "pkg-mc1.20.1-1.7.1" = _uOsvGIgy;
        "pkg-mc1.20.4-1.7.1" = _Iukh1sNN;
        "pkg-mc1.20.1-1.7.2" = _Rc9pkPug;
        "pkg-mc1.20.4-1.7.2" = _fkLiGoHs;
        "pkg-mc1.20.5-1.7.2" = _JKZokbpT;
        "pkg-mc1.21-1.7.2" = _DNJFe2me;
        "pkg-mc1.20.6-1.7.3" = _eVQOh2ku;
        "pkg-mc1.21-1.7.3" = _6gZ19wc6;
        "pkg-mc1.21.1-1.8.0-beta.1+fabric" = _H5Nu8zIm;
        "pkg-mc1.21.1-1.8.0-beta.1+neoforge" = _mEkSOCYW;
        "pkg-mc1.21.1-1.8.0-beta.2+fabric" = _YFHMOEkE;
        "pkg-mc1.21.1-1.8.0-beta.2+neoforge" = _pRWqnC7z;
        "pkg-mc1.21.1-1.8.0-beta.3+fabric" = _wnRbkR4U;
        "pkg-mc1.21.1-1.8.0-beta.3+neoforge" = _CfK2T1jj;
        "pkg-mc1.21.1-1.8.0-beta.4+fabric" = _DSxKPh7H;
        "pkg-mc1.21.1-1.8.0-beta.4+neoforge" = _orx6Yu4G;
        "pkg-mc1.21.3-1.8.0-beta.5+fabric" = _WeqF4XuB;
        "pkg-mc1.21.3-1.8.0-beta.5+neoforge" = _icTy71Cf;
        "pkg-mc1.21.3-1.8.0+fabric" = _4sugrjBi;
        "pkg-mc1.21.3-1.8.0+neoforge" = _zFB5NVXk;
        "pkg-mc1.21.4-1.8.1+fabric" = _PxI5NDgM;
        "pkg-mc1.21.4-1.8.1+neoforge" = _r722WRxp;
        "pkg-mc1.21.4-1.8.2+fabric" = _FK8MhLvJ;
        "pkg-mc1.21.4-1.8.2+neoforge" = _e4jCLNKA;
        "pkg-mc1.21.4-1.8.3+fabric" = _KoUrx3jJ;
        "pkg-mc1.21.4-1.8.3+neoforge" = _xAiCe6w8;
        "pkg-mc1.21.6-1.8.4+fabric" = _AgGRyydH;
        "pkg-mc1.21.6-1.8.4+neoforge" = _ABFHNC13;
        "pkg-mc1.21.9-1.8.5+fabric" = _Wd3HgdUs;
        "pkg-mc1.21.10-1.8.6+neoforge" = _rulHktXe;
        "pkg-mc1.21.10-1.8.6+fabric" = _nUGhyPwZ;
        "pkg-mc1.21.11-2.0.0+neoforge" = _h0nZC2aA;
        "pkg-mc1.21.11-2.0.0+fabric" = _CrZeGtHF;
        "pkg-mc1.21.11-2.0.1+neoforge" = _1BGeGrqI;
        "pkg-mc1.21.11-2.0.1+fabric" = _PmJQ2RSc;
        "pkg-mc1.21.11-2.0.2+neoforge" = _ZbUQLHxT;
        "pkg-mc1.21.11-2.0.2+fabric" = _gmIM6uan;
        "pkg-mc1.21.11-2.0.3+neoforge" = _q3Qk2F1D;
        "pkg-mc1.21.11-2.0.3+fabric" = _yIgAFMna;
        "pkg-mc26.1-2.0.4+fabric" = _Egm4ZKcS;
        "pkg-mc26.1.1-2.0.5+neoforge" = _bR0Zk8xR;
        "pkg-mc26.1.1-2.0.5+fabric" = _p88Tf9YM;
        "pkg-mc1.21.1-2.0.5+neoforge" = _Pv76GJbN;
        "pkg-mc1.21.1-2.0.5+fabric" = _24WhugSw;
        "pkg-mc26.2-2.0.5+neoforge" = _eWnglTHU;
        "pkg-mc26.2-2.0.5+fabric" = _iB6Zl5QS;
        "pkg-mc1.21.1-2.1.0+neoforge" = _lpqpNsXx;
        "pkg-mc1.21.1-2.1.0+fabric" = _3sJ9XmcU;
        "pkg-mc1.21.11-2.1.0+neoforge" = _z68MWp7u;
        "pkg-mc1.21.11-2.1.0+fabric" = _nBl8LONA;
        "pkg-mc26.1.2-2.1.0+neoforge" = _6uDeIhtx;
        "pkg-mc26.1.2-2.1.0+fabric" = _TJXsgWQx;
        "pkg-mc26.2-2.1.0+neoforge" = _MOvWTgIF;
        "pkg-mc26.2-2.1.0+fabric" = _S84VZdDL;
        "pkg-mc1.21.1-2.2.0+neoforge" = _trc55l6y;
        "pkg-mc1.21.1-2.2.0+fabric" = _2Q7Wqn0r;
        "pkg-mc1.21.11-2.2.0+neoforge" = _CyAdZA0Q;
        "pkg-mc1.21.11-2.2.0+fabric" = _4uImxGp5;
        "pkg-mc26.1.2-2.2.0+neoforge" = _VGmoYGDc;
        "pkg-mc26.1.2-2.2.0+fabric" = _wkblahhj;
        "pkg-mc26.2-2.2.0+neoforge" = _1m9aACiA;
        "pkg-mc26.2-2.2.0+fabric" = _zD41FWKT;
        "pkg-mc26.2-2.2.1+neoforge" = _rsAMSHPp;
        "pkg-mc26.2-2.2.1+fabric" = _6VjxIDOa;
        "pkg-mc1.21.1-2.2.2+neoforge" = _O9s4eNST;
        "pkg-mc1.21.1-2.2.2+fabric" = _7SzHt9zR;
        "pkg-mc1.21.11-2.2.2+neoforge" = _G2OW6u57;
        "pkg-mc1.21.11-2.2.2+fabric" = _a0OPChhe;
        "pkg-mc26.1.2-2.2.2+neoforge" = _bYekfprR;
        "pkg-mc26.1.2-2.2.2+fabric" = _RHcE6mx4;
        "pkg-mc26.2-2.2.2+neoforge" = _As8glfh6;
        "pkg-mc26.2-2.2.2+fabric" = _6in8I1ms;
        "pkg-mc1.21.1-2.2.3+neoforge" = _KYgu9tXl;
        "pkg-mc1.21.1-2.2.3+fabric" = _jDOK2MQs;
        "pkg-mc1.21.11-2.2.3+neoforge" = _TYp16Xjp;
        "pkg-mc1.21.11-2.2.3+fabric" = _P0MH4cn0;
        "pkg-mc26.1.2-2.2.3+neoforge" = _Ki8SKVeM;
