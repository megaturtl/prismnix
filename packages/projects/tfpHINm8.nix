...
let
    ...
    in {
        ...
        "pkg-1.21-1.0.70" = _LMmDsNCO;
        "pkg-1.21-1.0.71" = _7zSeSG9l;
        "pkg-1.21-1.0.72" = _pUi8WNfY;
        "pkg-1.21-1.0.73" = _hR4sb9Ho;
        "pkg-1.21-1.0.74" = _qxbfORno;
        "pkg-1.21-1.0.84" = _63IvMefY;
        "pkg-1.21-1.0.85" = _ZdeBTmVp;
        "pkg-1.21-1.0.86" = _BWikMujH;
        "pkg-1.21-1.0.87" = _UUJih5Tw;
        "pkg-1.21-1.0.88" = _P4UUPffo;
        "pkg-1.21-1.0.89" = _LexSfoHE;
        "pkg-1.21-1.0.90" = _wIRUdsQg;
        "pkg-1.21-1.0.91" = _flRrjUyK;
        "pkg-1.21-1.0.92" = _Io2AKA0s;
        "pkg-1.21-1.0.93" = _xHYodVCE;
        "pkg-1.21-1.0.94" = _d33MTcDq;
        "pkg-1.21-1.0.95" = _qROKIdxe;
        "pkg-1.21-1.0.96" = _XimIh7Ex;
        "pkg-1.21-1.0.97" = _QvIiPLdQ;
        "pkg-1.21-1.0.98" = _CgNi0evm;
        "pkg-1.21-1.0.99" = _9LIzVNgc;
        "pkg-1.21-1.1.0" = _dWyH54qK;
        "pkg-1.21-1.1.1" = _VFMGRzEW;
        "pkg-1.21-1.1.2" = _FNAToXaE;
        "pkg-1.21-1.1.3" = _HOcunyDL;
        "pkg-1.21-1.1.4" = _RI1jyVu5;
        "pkg-1.21-1.1.5" = _1W5SPM4A;
        "pkg-1.21-1.1.7" = _99mbotUJ;
        "pkg-1.21-1.1.9" = _r95jqFEK;
        "pkg-1.21-1.1.10" = _TNvFoOIe;
        "pkg-1.21-1.1.11" = _jW61wu72;
        "pkg-1.21-1.1.12" = _XT18H2Q6;
        "pkg-1.21-1.1.13" = _fI36LoAj;
        "pkg-1.21-1.1.14" = _ivE9JU2P;
        "pkg-1.21-1.1.15" = _y0NU3IMI;
        "pkg-1.21-1.1.16" = _Bpg6r2sd;
        "pkg-1.21-1.1.17" = _Eenn2iql;
        "pkg-1.21-1.1.18" = _uH46uJna;
        "pkg-1.21-1.1.19" = _UBaPOben;
        "pkg-1.21-1.1.20" = _a1uoimEg;
        "pkg-1.21-1.1.21" = _iHZGV0hz;
        "pkg-1.21-1.1.22" = _HWopfClr;
        "pkg-1.21-1.1.23" = _8BQLBh9P;
        "pkg-1.21-1.1.24" = _uLFZFpvO;
        "pkg-1.21-1.1.25" = _UMtmDNuS;
        "pkg-1.21-1.1.26" = _Wu6fCJOz;
        "pkg-1.21-1.1.27" = _45Bttxr2;
        "pkg-1.21-1.1.28" = _myAddcoJ;
        "pkg-1.21-1.1.30" = _dPYXUyzt;
        "pkg-1.21-1.1.32" = _kVASgoun;
        "pkg-1.21-1.1.33" = _eeiTvdQj;
        "pkg-1.21-1.1.34" = _4oDbIeWS;
        "pkg-1.21-1.1.35" = _NZ5oehTK;
        "pkg-1.21-1.1.36" = _Ah1RgoDe;
        "pkg-1.21-1.1.37" = _JWxL6rPA;
        "pkg-1.21-1.1.39" = _RKqxy0hQ;
        "pkg-1.21-1.1.40" = _9UWRfoqQ;
        "pkg-1.21-1.1.41" = _SqEfE5Zw;
        "pkg-1.21-1.1.43" = _DSSRvQeK;
        "pkg-1.21-1.1.44" = _sLNUeD7Z;
        "pkg-1.21-1.1.45" = _G2IL9CYu;
        "pkg-1.21-1.1.46" = _a2ZJ14VW;
        "pkg-1.21-1.1.47" = _ygqa5zxr;
        "pkg-1.21-1.1.48" = _lnrsXXHV;
        "pkg-1.21-1.1.50" = _jiy86oe2;
        "pkg-1.21-1.1.51" = _grUwDH23;
        "pkg-1.21-1.1.52" = _98iQJ0uZ;
        "pkg-1.21-1.1.53" = _kqR2SXN7;
        "pkg-1.21-1.1.54" = _neR5ruQO;
        "pkg-1.21-1.1.55" = _KYqwXZia;
        "pkg-1.21-1.1.56" = _us1NHj2G;
        "pkg-1.21-1.1.57" = _G9CvnbLm;
        "pkg-1.21-1.1.58" = _gFnpJfrQ;
        "pkg-1.21-1.1.59" = _QFb9ZI6q;
        "pkg-1.21-1.1.60" = _F7QKYIfZ;
        "pkg-1.21-1.1.61" = _hDYnIVye;
        "pkg-1.21-1.1.62" = _Xfc5Ek3B;
        "pkg-1.21-1.1.63" = _qsP4CU4u;
        "pkg-1.21-1.1.64" = _WYDPDCx3;
        "pkg-1.21-1.1.65" = _L4Xk9dGg;
        "pkg-1.21-1.1.66" = _iywGA85q;
        "pkg-1.21-1.1.67" = _TLmX6fwr;
        "pkg-1.21-1.1.68" = _8EgDrsNc;
        "pkg-1.21-1.1.74" = _bQYUuBV1;
        "pkg-1.21-1.1.75" = _1FuLLPw7;
        "pkg-1.21-1.1.76" = _a19mGWVL;
        "pkg-1.21-1.1.77" = _LtVkhlJp;
        "pkg-1.21-1.2.3" = _CcT07V6D;
        "pkg-1.21-1.2.6" = _WYzwLtm0;
        "pkg-1.21-1.2.7" = _6rhZ9Ezr;
        "pkg-1.21-1.2.10" = _cAHmjQ0F;
        "pkg-1.21-1.2.11" = _ei7XBDcZ;
        "pkg-1.21-1.2.15" = _pW0GQ8dV;
        "pkg-1.21-1.2.16" = _uC3qQjI4;
        "pkg-1.21-1.2.17" = _QKpfUhbS;
        "pkg-1.21-1.2.18" = _IbAtIU2t;
        "pkg-1.21-1.2.20" = _kvz3BlBK;
        "pkg-1.21-1.2.21" = _cFdmHlRy;
        "pkg-1.21-1.2.22" = _SgqUbbtV;
        "pkg-1.21-1.2.23" = _AMl0yd4i;
        "pkg-1.21-1.2.24" = _I3003bch;
        "pkg-1.21-1.2.28" = _PBlJUOMv;
        "pkg-1.21-1.2.29" = _jOoxy9sK;
        "pkg-1.21-1.2.30" = _YyfFnHUC;
        "pkg-1.21-1.2.31" = _7ZmrAx0a;
        "pkg-1.21-1.2.32" = _DLXPFlXZ;
        "pkg-1.21-1.2.33" = _wG4tXmcP;
        "pkg-1.21-1.2.34" = _JXLwgf8L;
        "pkg-1.21-1.2.35" = _zju7QGre;
        "pkg-1.21-1.2.36" = _j5Wnwy7d;
        "pkg-1.21-1.2.37" = _YL7j6W4p;
        "pkg-1.21-1.2.38" = _J5iv2R6C;
        "pkg-1.21.5-1.3.0" = _fDRhcQOs;
        "pkg-1.21.5-1.3.2" = _dAjEDw2W;
        "pkg-1.21.6-1.4.0" = _A6mgpFK3;
        "pkg-1.21.6-1.4.1" = _kHoCDMZL;
        "pkg-1.21.6-1.4.4" = _4p4oCNbJ;
        "pkg-1.21.6-1.4.5" = _Ug9Uxav3;
        "pkg-1.21-1.3.0" = _slpHQ2qY;
        "pkg-1.21.7-1.5.0" = _8VafFNhZ;
        "pkg-1.21-1.3.1" = _Fq7uPgVp;
        "pkg-1.21-1.3.2" = _7eDMawr2;
        "pkg-1.21.7-1.5.1" = _2mTsDtvc;
        "pkg-1.21.7-1.5.2" = _s4Ap11mp;
        "pkg-1.21-1.3.3" = _dwQd2OZb;
        "pkg-1.21-1.3.4" = _eZ2qctjA;
        "pkg-1.21-1.3.5" = _esWroyVx;
        "pkg-1.21-1.3.6" = _GpDp7KMZ;
        "pkg-1.21-1.3.10" = _DlJKlKrP;
        "pkg-1.21-1.3.11" = _QDpsQ2gv;
        "pkg-1.21-1.3.12" = _sn47NZkh;
        "pkg-1.21-1.3.14" = _d3essMy2;
        "pkg-1.21-1.3.15" = _PmOb49yq;
        "pkg-1.21-1.3.16" = _Rj1Gxgqg;
        "pkg-1.21-1.3.17" = _ktkJaF6v;
        "pkg-1.21-1.3.19" = _sB5Mu1AE;
        "pkg-1.21-1.3.20" = _BQtVuunR;
        "pkg-1.21.10-1.10.1" = _KXz2PjCS;
        "pkg-1.21.10-1.10.2" = _D9R1ziEa;
        "pkg-1.21.11-1.11.0" = _ncRk4o7f;
        "pkg-1.21.11-1.11.7" = _8aGitQ2D;
        "pkg-1.21.11-1.11.13" = _BNw8QDVB;
        "pkg-1.21.11-1.11.19" = _jB5Pi4ZU;
        "pkg-26.1-12.1.0" = _Ys4Agt0s;
        "pkg-26.1-12.1.2" = _bN4TjMtr;
        "pkg-26.1-12.1.3" = _Tw14HCJk;
        "pkg-26.1-12.1.5" = _E4dlaPZ2;
        "pkg-26.1-12.1.6" = _SDTGkhm7;
        "pkg-26.1-12.1.9" = _4XzUvcpa;
        "pkg-26.1-12.1.10" = _WdLXjqsS;
        "pkg-26.1-12.1.11" = _lERkBBhb;
        "pkg-26.1-12.1.12" = _f26U9Zyd;
        "pkg-26.1.1-12.2.0" = _rIkgj4wC;
        "pkg-26.1.2-12.3.1" = _MAJ0cOEP;
        "pkg-26.1.2-12.3.2" = _I21cv8N7;
        "pkg-26.1.2-12.3.3" = _A38DA2Yr;
        "pkg-26.1.2-12.3.4" = _cH0NBIWX;
        "pkg-26.1.2-12.4.0" = _DnP5J0ro;
        "pkg-26.1.2-12.5.0" = _ZuON5MDP;
        "pkg-26.1.2-12.5.1" = _yG7RrJRA;
        "pkg-26.1.2-12.5.2" = _yFdjqiGZ;
        "pkg-26.1.2-12.5.3" = _GDBjZPKw;
        "pkg-26.1.2-12.5.4" = _oV9V3TqW;
        "pkg-26.1.2-12.5.5" = _SnV6r9GU;
        "pkg-26.1.2-12.5.6" = _pJR8RnXv;
        "pkg-26.1.2-12.5.7" = _CbA7YnQv;
        "pkg-26.1.2-12.5.8" = _7ppHJmxA;
        "pkg-26.1.2-12.5.9" = _5s9e8VT6;
        "pkg-26.1.2-12.5.10" = _Uyx0nnrr;
        "pkg-26.1.2-12.5.11" = _Wqt7WihT;
        "pkg-26.1.2-12.6.1" = _mG4vtaHl;
