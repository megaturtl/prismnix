...
let
    ...
    in {
        ...
        "pkg-v1.0-mod" = _rNOho2i2;
        "pkg-v1.0-datapack" = _npafvXEs;
        "pkg-v1.1-datapack" = _bPT8t3iq;
        "pkg-v1.1-mod" = _EQVmAHr8;
        "pkg-v1.2-datapack" = _yjrsyUEc;
        "pkg-v1.2-mod" = _Nkno3dF2;
        "pkg-v1.3-datapack" = _Z7c9wGcQ;
        "pkg-v1.3-mod" = _TpJTlAOZ;
