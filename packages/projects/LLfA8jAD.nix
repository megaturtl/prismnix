...
let
    versions = (let
        ...
        _wKeteL6k = {
            "id" = "wKeteL6k";
            "file" = "magnetic-3.14.0-26.1+paper.jar";
            "hash" = "sha512-Hl17Rg9t4nIsyNaBYXNMphzEE5FwqQRTr3UiyG8H9346wFVAuz1wnxiObz1rGejgsqojU6jKq+wrKBhkK7FFsg==";
        };
        _tBbHk4mZ = {
            "id" = "tBbHk4mZ";
            "file" = "magnetic-3.14.0-1.21.1+fabric.jar";
            "hash" = "sha512-8qvTdWl7s2pM1sSPZ1+aXg9WryZZwErzukudDa2IKa4ktaZ4S0IGkIV9vFElOt3k9VLQyaFTJNDZn3iTAsikLw==";
        };
        _71L00rLT = {
            "id" = "71L00rLT";
            "file" = "magnetic-3.14.0-1.21.1+neoforge.jar";
            "hash" = "sha512-G8aYJODGhFj9o70W0WHqRlRxhsP5KzAasnx2iRLFNmPH5uYM1Dl+NUb4f/4aXTZFmZRWLePxH8LFMK0OQFhrAQ==";
        };
        _6dG1HAwM = {
            "id" = "6dG1HAwM";
            "file" = "magnetic-3.14.0-1.21.11+fabric.jar";
            "hash" = "sha512-rsgeO++bWO32L6/0pN2eTa8hF7J7tu4d3aB2XtEzORMCzzN14Kqh43KOejjPgP649khMSCFH4QHrJyPH6rNI3w==";
        };
        _VkL993Pj = {
            "id" = "VkL993Pj";
            "file" = "magnetic-3.14.0-1.21.11+neoforge.jar";
            "hash" = "sha512-yR2j3WdP20E4zgOjjXzyyoWrsqhoIyeSrjD/Xij5XO0j3hrMl3bCrNaeWMzP9HMTRUSAav4gL7R0IzLMRQCUMA==";
        };
        _14hHf173 = {
            "id" = "14hHf173";
            "file" = "magnetic-3.14.0-26.1.2+fabric.jar";
            "hash" = "sha512-jLz9lbVRVR37iGcM/eXEB1sqAn+JFAH9A7V0wW1L0abvt/iYHf0ZCcYo+dOvilsofyXcmMJnNgZwyPkbEEJKtw==";
        };
        _zMFPyeDX = {
            "id" = "zMFPyeDX";
            "file" = "magnetic-3.14.0-26.1.2+neoforge.jar";
            "hash" = "sha512-GjDGIHcSGODnA3ObBoNBhgmo4A3yyJXoBFaqp3cDH6ub8yqDqxYEGWmjm3241eZ5ghHzy9aecuTD3BwVqK4Zlg==";
        };
        _aYIaURLl = {
            "id" = "aYIaURLl";
            "file" = "magnetic-3.14.0-26.2+fabric.jar";
            "hash" = "sha512-mmUjo4MgtuxMqVsZU5hYpMMQKOB+tntcpCVFyiTAqb6bA4Echu9WBpmdy+1JNjBothMTaSZACw5lxSGxeHmW+g==";
        };
        _W3Ux0FX4 = {
            "id" = "W3Ux0FX4";
            "file" = "magnetic-3.14.0-26.2+neoforge.jar";
            "hash" = "sha512-Qms5iqCfzbV/fiwsbqDfrOzlIHjN5sMw5srEt0XwMIZYYYcxW7z8Pl5F0fUlIKWVFqre7NtR4rbk8aju29e+eA==";
        };
        _UlWb7CQw = {
            "id" = "UlWb7CQw";
            "file" = "magnetic-3.14.1-26.1+paper.jar";
            "hash" = "sha512-xdoNwGKeXBcDBVdBa1xX1A1PkhHy5TV0jHZqJyxNUFRITXwNrYRuPpyXzcbsbZzb8mm1H0frEw7h7E4myp/hSA==";
        };
        _oriCdABX = {
            "id" = "oriCdABX";
            "file" = "magnetic-3.14.1-1.21.1+fabric.jar";
            "hash" = "sha512-/k5d0QWDdYpDffsqR6lLCaUIecGY3mogGN9LQ1BQlSPylNDp0sp/aQVzGqdcJHL1QIjOzYOcHwxZwj+oeRrA6Q==";
        };
        _wOwpiwAi = {
            "id" = "wOwpiwAi";
            "file" = "magnetic-3.14.1-1.21.1+neoforge.jar";
            "hash" = "sha512-6QPSLmGUeT0OREC3M4UZv9HyQIqDMVXmah+jzZEPpqIo4oWZYCqJrRItXKCZGiZzG6g8QhORoMBjejKx73mDxQ==";
        };
        _LhO7tVQL = {
            "id" = "LhO7tVQL";
            "file" = "magnetic-3.14.1-1.21.11+fabric.jar";
            "hash" = "sha512-nKZdiKk6k4alqT6vjTfJGM3/3l+jNAyyRjVb1jZY3vGCNFmEBaERswJi6QJVyD1Vucc+MY9EgTv2A9CEUVjHHQ==";
        };
        _9YqkzHvz = {
            "id" = "9YqkzHvz";
            "file" = "magnetic-3.14.1-1.21.11+neoforge.jar";
            "hash" = "sha512-f/AWXwOVU+psmfE0DKpjbqiI+TQ3Fv1IQ9UhwpAu7dJYvAsw06RKOljQRroecxyUanC0HXK1INZtUAp0RDNo1w==";
        };
        _2Oh7exCW = {
            "id" = "2Oh7exCW";
            "file" = "magnetic-3.14.1-26.1.2+fabric.jar";
            "hash" = "sha512-6nvhoGYk0qkr6FxUcOKlICGvwbdHiq+z6WWq24BLjpg3neWURwulNl+2e4MXzRSCcf5OlumwnPo9QWBKHRNwCQ==";
        };
        _L4thf9UL = {
            "id" = "L4thf9UL";
            "file" = "magnetic-3.14.1-26.1.2+neoforge.jar";
            "hash" = "sha512-E8JcYC3hALbUlGq7RsVCntKKgXl8IU0OJPV7Ij4fqGpbi4eHpi0yLCoO/6fueKeSwdEh+l6EFIOkvS+DvtyuFg==";
        };
        _32IXgANa = {
            "id" = "32IXgANa";
            "file" = "magnetic-3.14.1-26.2+fabric.jar";
            "hash" = "sha512-CJ9lX2hy8RxkJ8hfWabdzAo3XJuoVun72Cjdy9ONgnh+9J3c4fyp96v/ek4WCJ1z9KsqzR7un23Z00aQVR3LOQ==";
        };
        _JqwM6eRW = {
            "id" = "JqwM6eRW";
            "file" = "magnetic-3.14.1-26.2+neoforge.jar";
            "hash" = "sha512-Gt+SX/BBHM0XL2/5UYm4D+SOvjVPPjpcCm0EE0n0p2uoGrJwr0wzsSKpCZ8nn97bipxDhe+SzPsoEqWPAkshSg==";
        };
        _jhxWvrQf = {
            "id" = "jhxWvrQf";
            "file" = "magnetic-3.14.2-26.1+paper.jar";
            "hash" = "sha512-aVusfykLsxc8c6uVFpkQ7jldNQgGt0+5dEDD/b/ewNE6pA54R0zc9vtYf6G32LChbK28VC5q8EIDuhunvs9pVw==";
        };
        _clwkM9RF = {
            "id" = "clwkM9RF";
            "file" = "magnetic-3.14.2-1.21.1+fabric.jar";
            "hash" = "sha512-mMsKllr6b3/6GPZlCmVpKkgW+Zr+uI1hkVzD3Fbu6h5vD1+GEp98+qRyMj/u6zyngQ6KucUpemcY7Vedb7hsfQ==";
        };
        _Yp5rAFHJ = {
            "id" = "Yp5rAFHJ";
            "file" = "magnetic-3.14.2-1.21.1+neoforge.jar";
            "hash" = "sha512-DnRgSHdWdHkP4BONrR43CxuAofiSk7h4qYUQfOgoxQ96lFIvantgJUk2DM/8bf8tIbmYgivwS6oy0MYPWxD2uA==";
        };
        _zWaBS7op = {
            "id" = "zWaBS7op";
            "file" = "magnetic-3.14.2-1.21.11+fabric.jar";
            "hash" = "sha512-E5RXKHhJhgZ1ApuFqb9r5YphSFRDI2J5dePq/ToMsGt5cBxTvtPWpaQb1A88O6457kvIB35hBWZ1RMmHJPgpeg==";
        };
        _eyNvH1s2 = {
            "id" = "eyNvH1s2";
            "file" = "magnetic-3.14.2-1.21.11+neoforge.jar";
            "hash" = "sha512-+R99ppQO5uETc0GkIWf9TFAImgDG31cO7xtYa62ijmb1X96NmkTF8mp9ao68Tv2v7UG2q2UHg7MoJM2WPZx8Xw==";
        };
        _fnGow0DM = {
            "id" = "fnGow0DM";
            "file" = "magnetic-3.14.2-26.1.2+fabric.jar";
            "hash" = "sha512-vvTLdd7tPZshMaesyn081P9uBz9tY3cQ0z8EV0Np3AVzVrUKjqB8CzHD26k3wE51UfdpffN0sAvH5jC3ldYU1A==";
        };
        _7S7slQP3 = {
            "id" = "7S7slQP3";
            "file" = "magnetic-3.14.2-26.1.2+neoforge.jar";
            "hash" = "sha512-FtrBFeML49WcoWFzVVXmM5Hx8805CCa5p5lGGaXMxwaUWHgZnYvl8uOb2Deq3iFIotU/bk/4CF1z52g8FBB/nA==";
        };
        _BiJnddTS = {
            "id" = "BiJnddTS";
            "file" = "magnetic-3.14.2-26.2+fabric.jar";
            "hash" = "sha512-3CmjtGzWuK6WZZwvS7k8OWJOUoXTz7twS58ORYF7qUQt4g+P8q9GIJ7h+cZd8tzH/VzEakrOVa36NLwJ7quK2Q==";
        };
        _CBtIqbNP = {
            "id" = "CBtIqbNP";
            "file" = "magnetic-3.14.2-26.2+neoforge.jar";
            "hash" = "sha512-lKI83c+l+w4DlDuU7O2RduCrd1tGZLzKYmW3RsRVHL2UTD0O6sZIBtATczfdBUd1t9x/mWEKwuIZyCPRy2nuyg==";
        };
        _OslmTSPJ = {
            "id" = "OslmTSPJ";
            "file" = "magnetic-3.15.0-26.1+paper.jar";
            "hash" = "sha512-VPJv5LMlTYfhfN6Rfa/Vveuj0bCw+2GcIKeJA0BZRf151vjMbXvPNW0D1TyLGFrzcVmY03gSsyuXkxIfviHB1A==";
        };
        _sg4JnkZJ = {
            "id" = "sg4JnkZJ";
            "file" = "magnetic-3.15.0-1.21.1+fabric.jar";
            "hash" = "sha512-EatFadajRyKftE7JB1tjJ6Rs/I6WpFFCIy0DHMZpPGBm53B+jel7NGXKBpZDtQyoTfMv3K5xc/jYfNzASfzXqg==";
        };
        _QKVTLVag = {
            "id" = "QKVTLVag";
            "file" = "magnetic-3.15.0-1.21.1+neoforge.jar";
            "hash" = "sha512-CjLHFkg43onuNoEVbWqTeHw6199n9wpae89/e1+qiTdFhamx3HBOMM9HMHFES9SWV3bN/sMDDUMCRZHyxJojVQ==";
        };
        _txtqbogw = {
            "id" = "txtqbogw";
            "file" = "magnetic-3.15.0-1.21.11+fabric.jar";
            "hash" = "sha512-jjk6NbLtj1m4Ic8Td5havKQIX/n2Tr9Ev+5FJZivO1ZvFuG5ZvwSzopqrEu4D/2uo7mhR0YHdfCFDlR0ef2D5Q==";
        };
        _tSkODUUe = {
            "id" = "tSkODUUe";
            "file" = "magnetic-3.15.0-1.21.11+neoforge.jar";
            "hash" = "sha512-FwtqkfXozwk6VIXda1qGSA3xeDurnojcegVjgjDHwYD6MAVrcmqBVQNmtHyIpoT8EJCoKxsHGTnvxVqbo30Tmw==";
        };
        _12MKo0GO = {
            "id" = "12MKo0GO";
            "file" = "magnetic-3.15.0-26.1.2+fabric.jar";
            "hash" = "sha512-2utw5LFZpLsAkQBrUp4MfB4slLj3jZTbm1W9rjybmpVeVC2GBs0U5ZjxEsNGp92EJ41Fc5q5SCsvMujuhxRjSw==";
        };
        _u7u1dVYN = {
            "id" = "u7u1dVYN";
            "file" = "magnetic-3.15.0-26.1.2+neoforge.jar";
            "hash" = "sha512-k1JvrdDHCo+vVPkCUeeahCZvnosPpE7QU2xcYIIMEAxEBUXMfgS/72MZVHvX5071cyqth70p2ntkRt7b5zMZNQ==";
        };
        _s7Ohwz2v = {
            "id" = "s7Ohwz2v";
            "file" = "magnetic-3.15.0-26.2+fabric.jar";
            "hash" = "sha512-ogIMKuAFga5zdLxs5Eef5r7NFpROI5hvAlBCtXJ4RvGH3cQkVSmr/kg1c6VY8SYCHzCukmBzvNaicxohiGsp1w==";
        };
        _VaVmqnSL = {
            "id" = "VaVmqnSL";
            "file" = "magnetic-3.15.0-26.2+neoforge.jar";
            "hash" = "sha512-hWi3GRTr6RSIh47i5pRX5WYUX6l6SWDnTGNGtI8bYVz3ajZj6j/3Kh/KGrizJeRMx+5d2wfGYQroo2TGsEOEcQ==";
        };
        _gwvTTLIG = {
            "id" = "gwvTTLIG";
            "file" = "magnetic-3.15.0-26.3+fabric.jar";
            "hash" = "sha512-BYIF/JG0FSAeBnF8Rt7v4/gPscVcoW3sINBaG0cQWoOJUq7JJ+oHq7VvSve4z5ZdCCHRuP+2CKRb79tDK7uqiw==";
        };
        _QubhGbJk = {
            "id" = "QubhGbJk";
            "file" = "magnetic-3.15.1-26.1+paper.jar";
            "hash" = "sha512-77xEuW6cL7B2tVSUUtP4QQ2+TgaJAnW0lyPRI5Y80GVqnAYISaMOgSUCZvaS+4iD6GXDDeI/E+X3xwUrPMg/qQ==";
        };
        _BJs8DBxB = {
            "id" = "BJs8DBxB";
            "file" = "magnetic-3.15.1-1.21.1+fabric.jar";
            "hash" = "sha512-PV0/NP+pTPPSfsacgAdjDM6qmOJBqDSLcR9NP3rnR2FKGhVUF/RCqjb4iajLaUTKp/eprwPmH1eHL+azFuwmrg==";
        };
        _iB5aajvU = {
            "id" = "iB5aajvU";
            "file" = "magnetic-3.15.1-1.21.1+neoforge.jar";
            "hash" = "sha512-26Gwb2wwfrM1JtwrtOtZHcXw3zwKpWf6obBKrAICRFE9/ys8lfUy53Ua0ofGYyjfG2aRDqkPr4XNRm7B3Am5SQ==";
        };
        _UIgZIoL0 = {
            "id" = "UIgZIoL0";
            "file" = "magnetic-3.15.1-1.21.11+fabric.jar";
            "hash" = "sha512-MuMGRh0ji397gw69ZxF1IvU5vRTYrFToHGa7reDAgS3rn7+/jw/eFAo0I3IQRl1KdaLBY+aZvaZ4C6HRhq8dyw==";
        };
        _u7CIeZSF = {
            "id" = "u7CIeZSF";
            "file" = "magnetic-3.15.1-1.21.11+neoforge.jar";
            "hash" = "sha512-b3jUqsjGiAWn9SWeN0WNV471m/+N2PYmbY12i9xP+rTvjCJdBFb3kfZwxV1n1ZPPPKLljKrguLcuwXje/wUtsg==";
        };
        _Idk5SQ3F = {
            "id" = "Idk5SQ3F";
            "file" = "magnetic-3.15.1-26.1.2+fabric.jar";
            "hash" = "sha512-qU+kdMVU3vvUQvNaC1CsN8intEjLYvzc37Cugc6uGfvwZ/h37EHVWB4Uy00rcriojfl4dbzmU/FSEpAaF9V3ZA==";
        };
        _WbKUmd0k = {
            "id" = "WbKUmd0k";
            "file" = "magnetic-3.15.1-26.1.2+neoforge.jar";
            "hash" = "sha512-z//0yIc7/5sXjgAzxZuFjoWB027EXwQBIu3YjcyUnoSsbbpcMTJdNw5ITfPNpm8QUhgVuht8rFsnnHsMIlzE8g==";
        };
        _ITLEjNX1 = {
            "id" = "ITLEjNX1";
            "file" = "magnetic-3.15.1-26.2+fabric.jar";
            "hash" = "sha512-9/pVlkWhdx5Ut8g2L3dta4xeOpItulRvPi3Z7qtT3VK+Nb+1cDMNvvXocj5LAEOXGq+epmxRwzJ/F4w6OkUZaA==";
        };
        _TA1yYPGH = {
            "id" = "TA1yYPGH";
            "file" = "magnetic-3.15.1-26.2+neoforge.jar";
            "hash" = "sha512-OB9VUDmIM12sQdJNUUQ8yK+XjF7KnNrDlnIBEn+5bznDxX60hU6AsRhtnLysW6meshQ1Vijn49kA+r1FdNHLHg==";
        };
        _31GCV0Cs = {
            "id" = "31GCV0Cs";
            "file" = "magnetic-3.15.1-26.3+fabric.jar";
            "hash" = "sha512-sdH9ph9SdDJ+5KnDI7Ql7DqWWgDFf4qBAYMOuL0jmXX/zfErLIQ0EUZyfJuY8tTZxu3QNNvk9YkSD41bCZaR0Q==";
        };
        _r1FmVC8Z = {
            "id" = "r1FmVC8Z";
            "file" = "magnetic-3.15.1-26.3+neoforge.jar";
            "hash" = "sha512-mqmi6U4o8miGyx2QELW3fwgoVdpDhAr96o0wPPbKzBJgKhLgYK/xmrGLe2YsiKndyA82CZ65TZH2f2JeZ54lkg==";
        };
    in {
        "lDXy8YBU" = _lDXy8YBU;
        "AJH0Idbn" = _AJH0Idbn;
        ...
        "paper-26.1" = _QubhGbJk;
        "paper-26.1.1" = _QubhGbJk;
        "paper-26.1.2" = _QubhGbJk;
        "paper-26.2-pre-4" = _y1J9iXmD;
        "paper-26.2" = _QubhGbJk;
        "paper-26.3" = _QubhGbJk;
        ...
        "folia-26.1" = _QubhGbJk;
        "folia-26.1.1" = _QubhGbJk;
        "folia-26.1.2" = _QubhGbJk;
        "folia-26.2-pre-4" = _y1J9iXmD;
        "folia-26.2" = _QubhGbJk;
        "folia-26.3" = _QubhGbJk;
        ...
        "purpur-26.1" = _QubhGbJk;
        "purpur-26.1.1" = _QubhGbJk;
        "purpur-26.1.2" = _QubhGbJk;
        "purpur-26.2-pre-4" = _y1J9iXmD;
        "purpur-26.2" = _QubhGbJk;
        "purpur-26.3" = _QubhGbJk;
        "neoforge-1.21.1" = _iB5aajvU;
        "neoforge-1.21.11" = _u7CIeZSF;
        "neoforge-26.1.1" = _WbKUmd0k;
        "neoforge-26.1.2" = _WbKUmd0k;
        "neoforge-26.2" = _TA1yYPGH;
        "neoforge-26.3" = _r1FmVC8Z;
        "pkg-1.0.0" = _lDXy8YBU;
        "pkg-1.0.1" = _AJH0Idbn;
        "pkg-1.1.0" = _foCHsmBe;
        "pkg-1.1.1" = _jXJbOsLJ;
        "pkg-1.1.2" = _91LIZ4hD;
        "pkg-1.0.1-extra" = _MjrckZY6;
        "pkg-1.1.3-1.19.2" = _RUe4qHPz;
        "pkg-1.1.3-22w44a" = _3xPq5Bg6;
        "pkg-1.1.4-1.19.2" = _Dv6lXwa1;
        "pkg-1.1.5-1.19.2" = _IYxS6KgT;
        "pkg-1.1.5-22w44a" = _EqAoxqMN;
        "pkg-1.1.5-22w45a" = _YJXxJj8Q;
        "pkg-1.1.6-22w45a" = _ywPgggGV;
        "pkg-1.1.6-1.19.2" = _PzishYB7;
        "pkg-1.1.6-1.19.3-rc1" = _y2tqw5cB;
        "pkg-1.1.6-1.19.3" = _66IDlTSU;
        "pkg-2.0.0-1.19.4" = _1gvsDzFS;
        "pkg-2.0.0-1.19.3" = _Rl7pD1Mn;
        "pkg-paper-2.0.0-1.19.4" = _DfeBHknG;
        "pkg-paper-2.1.0-1.19.4" = _tk1w9L1K;
        "pkg-fabric-2.1.0-1.20" = _E9CFkdfR;
        "pkg-paper-2.1.0-1.20" = _RMe2pQjY;
        "pkg-fabric-2.1.1-1.20" = _iOSLnDtm;
        "pkg-2.2.0-1.20" = _AyLpnFzg;
        "pkg-v2.2.1-1.20.1" = _xxULWimo;
        "pkg-v2.2.0-1.20.1" = _TI27rK7p;
        "pkg-v2.2.2-1.20.1" = _DUIIUsnW;
        "pkg-v2.3.0-1.20.1" = _rSgC8e7o;
        "pkg-fabric-2.3.0-1.20.1" = _y7DT7utt;
        "pkg-paper-2.3.1-1.20.1" = _zWYHemE9;
        "pkg-paper-2.3.2-1.20.1" = _OPjJa09N;
        "pkg-fabric-2.3.1-1.20.1" = _sdFHUt8K;
        "pkg-fabric-2.3.1-1.20" = _dzP3Uz4M;
        "pkg-fabric-2.3.2-1.20" = _bF81MGka;
        "pkg-fabric-2.3.3-1.20" = _4ZbV0Coq;
        "pkg-fabric-2.3.3-1.20.3" = _JCcNEAF4;
        "pkg-fabric-2.3.3-1.20.4" = _gz0ViaRy;
        "pkg-fabric-2.3.4-1.20.4" = _FOv3fB5v;
        "pkg-fabric-2.3.5-1.20.4" = _3ylMlY0a;
        "pkg-fabric-2.4.0-1.20.4" = _DKdxljaI;
        "pkg-v2.4.0-24w13a" = _DxbYJhzK;
        "pkg-2.4.1-1.20.6" = _faBuNEoq;
        "pkg-2.4.1-1.20.4" = _TIAfkNW7;
        "pkg-2.4.1-1.20.1" = _gHlSPDyN;
        "pkg-3.0.0-beta1-1.21" = _DCKkwpFN;
        "pkg-3.0.0-beta1-1.20.6" = _1ryqw50B;
        "pkg-3.0.0-beta1-1.20.4" = _6EEII4Cm;
        "pkg-3.0.0-beta1-1.20.1" = _cpXmYmpk;
        "pkg-3.0.0-beta2-1.21" = _7JLHbFgd;
        "pkg-3.0.0-beta2-1.20.6" = _v3zNJQm9;
        "pkg-3.0.0-beta2-1.20.4" = _GG73SsI1;
        "pkg-3.0.0-beta2-1.20.1" = _USVQ7JG9;
        "pkg-3.0.0-beta3-1.21" = _m3ZZQvNp;
        "pkg-3.0.0-beta3-1.20.6" = _ylcpl5QL;
        "pkg-3.0.0-beta3-1.20.4" = _v6jsQXsf;
        "pkg-3.0.0-beta3-1.20.1" = _5zThhlVR;
        "pkg-3.0.0-beta4-1.21" = _YzJcwOP0;
        "pkg-3.0.0-beta4-1.20.6" = _hVlzBKPk;
        "pkg-3.0.0-beta4-1.20.4" = _tFXW2lNW;
        "pkg-3.0.0-beta4-1.20.1" = _aYQ60Zir;
        "pkg-3.0.0-beta5-1.21" = _J1nkVuwl;
        "pkg-3.0.0-beta5-1.20.6" = _TzmHMB1t;
        "pkg-3.0.0-beta5-1.20.4" = _3H1wEkiZ;
        "pkg-3.0.0-beta5-1.20.1" = _lvZamK0A;
        "pkg-3.0.0-beta6-1.21" = _6UzWOfsq;
        "pkg-3.0.0-beta6-1.20.6" = _QTyItYMM;
        "pkg-3.0.0-beta6-1.20.4" = _MY7bpTsh;
        "pkg-3.0.0-beta6-1.20.1" = _uOrQFkwq;
        "pkg-3.0.0-1.21" = _6TGpJkqp;
        "pkg-3.0.0-1.20.6" = _bRMJrqRB;
        "pkg-3.0.0-1.20.4" = _8pFGC49c;
        "pkg-3.0.0-1.20.1" = _aLygKs8s;
        "pkg-3.0.1-1.21" = _xm1bsP7U;
        "pkg-3.0.1-1.20.6" = _lltJOKg3;
        "pkg-3.0.1-1.20.4" = _CslebW5w;
        "pkg-3.0.1-1.20.1" = _OIkwFes1;
        "pkg-3.0.2-1.21" = _DPeOKM2O;
        "pkg-3.0.2-1.20.6" = _kNMjj9Br;
        "pkg-3.0.2-1.20.4" = _TGMCuiDe;
        "pkg-3.0.2-1.20.1" = _rMscCBXJ;
        "pkg-3.0.3-1.21" = _K9t1In5S;
        "pkg-3.0.3-1.20.6" = _QiYjVVcz;
        "pkg-3.0.3-1.20.4" = _OvU7s9gD;
        "pkg-3.0.3-1.20.1" = _oadvQ8Ka;
        "pkg-3.0.4-1.21" = _cwN4Wp2w;
        "pkg-3.0.4-1.20.6" = _T2rWCBlG;
        "pkg-3.0.4-1.20.4" = _o55RgLtG;
        "pkg-3.0.4-1.20.1" = _4mo7iijZ;
        "pkg-3.0.5-1.21" = _62qj8bdy;
        "pkg-3.0.5-1.20.6" = _SUu6slg8;
        "pkg-3.0.5-1.20.4" = _gutkG7Ci;
        "pkg-3.0.5-1.20.1" = _ZSVyA6tw;
        "pkg-3.0.6-1.21.2-rc1" = _cTacLfv0;
        "pkg-3.0.6-1.21" = _aTIScTQ0;
        "pkg-3.0.6-1.20.6" = _XMB7n2Pj;
        "pkg-3.0.6-1.20.4" = _JsThgJJ5;
        "pkg-3.0.6-1.20.1" = _30ATRYtc;
        "pkg-3.0.7-1.21.2-rc1" = _x90rtqqe;
        "pkg-3.0.7-1.21" = _jwNRbkbC;
        "pkg-3.0.7-1.20.6" = _GKuu65NJ;
        "pkg-3.0.7-1.20.4" = _xPHrpo76;
        "pkg-3.0.7-1.20.1" = _a5kBJhF5;
        "pkg-3.1.0-1.21.2" = _uytA99SE;
        "pkg-3.1.0-1.21" = _o2QsiA2q;
        "pkg-3.1.0-1.20.6" = _59fmKakq;
        "pkg-3.1.0-1.20.4" = _YX6fPJxT;
        "pkg-3.1.0-1.20.1" = _qrqiZOEi;
        "pkg-3.2.0-1.21.2" = _wns7BIXu;
        "pkg-3.2.0-1.21" = _Y11WxDOc;
        "pkg-3.2.0-1.20.6" = _iODgOjTq;
        "pkg-3.2.0-1.20.4" = _XzBvfQeQ;
        "pkg-3.2.0-1.20.1" = _y7Wn3RQn;
        "pkg-3.3.0-1.21.2" = _gZ4fuusk;
        "pkg-3.4.0-1.21.2+fabric" = _OTxFhYpx;
        "pkg-3.4.0-1.21.4+paper" = _C6PE7pG6;
        "pkg-3.4.1-1.21.2+fabric" = _dVPRFzgR;
        "pkg-3.4.1-1.21.4+paper" = _FFRi0HN2;
        "pkg-3.4.2-1.21.2+fabric" = _RS9vBQwH;
        "pkg-3.4.2-1.21.4+paper" = _yI5Jnuyq;
        "pkg-3.4.3-1.21.5+fabric" = _eQXZMSLF;
        "pkg-3.4.3-1.21.4+paper" = _wsoUeQ3A;
        "pkg-3.4.4-1.21.5+fabric" = _oFNIka4N;
        "pkg-3.4.4-1.21.4+paper" = _FeRroQm5;
        "pkg-3.5.0-1.21.6+fabric" = _IiLveI9e;
        "pkg-3.5.0-1.21.4+paper" = _iWywAPPD;
        "pkg-3.5.1-1.21.6+fabric" = _31rMH1cL;
        "pkg-3.5.1-1.21.6+paper" = _wr9vlw9H;
        "pkg-3.6.0-1.21.6+paper" = _AuJmC4Bs;
        "pkg-3.6.0-1.21.6+fabric" = _7uwu7udm;
        "pkg-3.6.1-1.21.6+fabric" = _I56SRuHO;
        "pkg-3.6.1-1.21.6+paper" = _kvVG1QP9;
        "pkg-3.6.2-1.21.6+fabric" = _bt0CCWWG;
        "pkg-3.6.2-1.21.6+paper" = _rtJSwsRN;
        "pkg-3.6.3-1.21.6+fabric" = _9wYL0HR4;
        "pkg-3.6.3-1.21.6+paper" = _ZZXrMwTa;
        "pkg-3.7.0-1.21.6+fabric" = _imLIKfH8;
        "pkg-3.7.0-1.21.6+paper" = _HDAlGjYm;
        "pkg-3.7.1-1.21.6+fabric" = _evOFJdvN;
        "pkg-3.7.1-1.21.6+paper" = _Er9V5qKj;
        "pkg-3.7.2-1.21.6+fabric" = _lViiGsVJ;
        "pkg-3.7.2-1.21.6+paper" = _1ynMRw7z;
        "pkg-3.8.0-1.21.6+fabric" = _hDBS1piS;
        "pkg-3.8.0-1.21.6+paper" = _44BWacLO;
        "pkg-3.8.0-1.21.9+fabric" = _DwgKgCW7;
        "pkg-3.8.1-1.21.9+fabric" = _Ezgm5Ob0;
        "pkg-3.8.1-1.21.6+paper" = _6xggziO0;
        "pkg-3.9.0-1.21.9+fabric" = _MAHYLx7D;
        "pkg-3.9.0-1.21.6+paper" = _Q3xTnlHA;
        "pkg-3.9.1-1.21.11+fabric" = _Vt6ZiiAY;
        "pkg-3.9.1-1.21.6+paper" = _rVUftm9W;
        "pkg-3.10.0-1.21.11+fabric" = _UhRo1nfO;
        "pkg-3.10.0-1.21.6+paper" = _CNf3DsPq;
        "pkg-3.11.0-1.21.11+fabric" = _CV0J6sTk;
        "pkg-3.11.0-1.21.6+paper" = _8PjwaJZT;
        "pkg-3.11.1-1.21.11+fabric" = _OmTAhYpx;
        "pkg-3.11.1-1.21.6+paper" = _NB7j1QwO;
        "pkg-3.12.0-beta1-26.1+fabric" = _jmdFsZOD;
        "pkg-3.12.0-26.1+fabric" = _x5ZxfIHJ;
        "pkg-3.12.0-26.1+paper" = _y1J9iXmD;
        "pkg-3.12.1-26.1+fabric" = _oyDoN7z9;
        "pkg-3.12.1-26.1+paper" = _G4RpL9JD;
        "pkg-3.12.1-26.2+fabric" = _glM5b3XP;
        "pkg-3.13.0-26.1+paper" = _DKU9aK0p;
        "pkg-3.13.0-1.21.1+fabric" = _M7O4Qiym;
        "pkg-3.13.0-1.21.1+neoforge" = _WO9OO7ZD;
        "pkg-3.13.0-1.21.11+fabric" = _zyoa9RB2;
        "pkg-3.13.0-1.21.11+neoforge" = _xUgYvbQi;
        "pkg-3.13.0-26.1.2+fabric" = _5rX6Pb1B;
        "pkg-3.13.0-26.1.2+neoforge" = _pKS25AEE;
        "pkg-3.13.0-26.2+fabric" = _I0cBzg0f;
        "pkg-3.13.0-26.2+neoforge" = _Mg5qmUZH;
        "pkg-3.14.0-26.1+paper" = _wKeteL6k;
        "pkg-3.14.0-1.21.1+fabric" = _tBbHk4mZ;
        "pkg-3.14.0-1.21.1+neoforge" = _71L00rLT;
        "pkg-3.14.0-1.21.11+fabric" = _6dG1HAwM;
        "pkg-3.14.0-1.21.11+neoforge" = _VkL993Pj;
        "pkg-3.14.0-26.1.2+fabric" = _14hHf173;
        "pkg-3.14.0-26.1.2+neoforge" = _zMFPyeDX;
        "pkg-3.14.0-26.2+fabric" = _aYIaURLl;
        "pkg-3.14.0-26.2+neoforge" = _W3Ux0FX4;
        "pkg-3.14.1-26.1+paper" = _UlWb7CQw;
        "pkg-3.14.1-1.21.1+fabric" = _oriCdABX;
        "pkg-3.14.1-1.21.1+neoforge" = _wOwpiwAi;
        "pkg-3.14.1-1.21.11+fabric" = _LhO7tVQL;
        "pkg-3.14.1-1.21.11+neoforge" = _9YqkzHvz;
        "pkg-3.14.1-26.1.2+fabric" = _2Oh7exCW;
        "pkg-3.14.1-26.1.2+neoforge" = _L4thf9UL;
        "pkg-3.14.1-26.2+fabric" = _32IXgANa;
        "pkg-3.14.1-26.2+neoforge" = _JqwM6eRW;
        "pkg-3.14.2-26.1+paper" = _jhxWvrQf;
        "pkg-3.14.2-1.21.1+fabric" = _clwkM9RF;
        "pkg-3.14.2-1.21.1+neoforge" = _Yp5rAFHJ;
        "pkg-3.14.2-1.21.11+fabric" = _zWaBS7op;
        "pkg-3.14.2-1.21.11+neoforge" = _eyNvH1s2;
        "pkg-3.14.2-26.1.2+fabric" = _fnGow0DM;
        "pkg-3.14.2-26.1.2+neoforge" = _7S7slQP3;
        "pkg-3.14.2-26.2+fabric" = _BiJnddTS;
        "pkg-3.14.2-26.2+neoforge" = _CBtIqbNP;
        "pkg-3.15.0-26.1+paper" = _OslmTSPJ;
        "pkg-3.15.0-1.21.1+fabric" = _sg4JnkZJ;
        "pkg-3.15.0-1.21.1+neoforge" = _QKVTLVag;
        "pkg-3.15.0-1.21.11+fabric" = _txtqbogw;
        "pkg-3.15.0-1.21.11+neoforge" = _tSkODUUe;
        "pkg-3.15.0-26.1.2+fabric" = _12MKo0GO;
        "pkg-3.15.0-26.1.2+neoforge" = _u7u1dVYN;
        "pkg-3.15.0-26.2+fabric" = _s7Ohwz2v;
        "pkg-3.15.0-26.2+neoforge" = _VaVmqnSL;
        "pkg-3.15.0-26.3+fabric" = _gwvTTLIG;
        "pkg-3.15.1-26.1+paper" = _QubhGbJk;
        "pkg-3.15.1-1.21.1+fabric" = _BJs8DBxB;
        "pkg-3.15.1-1.21.1+neoforge" = _iB5aajvU;
        "pkg-3.15.1-1.21.11+fabric" = _UIgZIoL0;
        "pkg-3.15.1-1.21.11+neoforge" = _u7CIeZSF;
        "pkg-3.15.1-26.1.2+fabric" = _Idk5SQ3F;
        "pkg-3.15.1-26.1.2+neoforge" = _WbKUmd0k;
        "pkg-3.15.1-26.2+fabric" = _ITLEjNX1;
        "pkg-3.15.1-26.2+neoforge" = _TA1yYPGH;
        "pkg-3.15.1-26.3+fabric" = _31GCV0Cs;
        "pkg-3.15.1-26.3+neoforge" = _r1FmVC8Z;
        "default" = _r1FmVC8Z;
    });
