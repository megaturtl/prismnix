...
let
    ...
    in {
        ...
        "pkg-1.0.3-1.21.4" = _pa854C0j;
        "pkg-1.0.3-1.21.5" = _fg0ibJq9;
        "pkg-1.0.4-1.21.6" = _G6ZfXypn;
        "pkg-1.0.4-1.21.9" = _Bb8JOnIT;
        "pkg-1.1-1.21.11" = _V7zQoVLl;
        "pkg-1.2-1.21.11" = _7uBajjn9;
        "pkg-1.3-1.21.11" = _JHev4RcM;
