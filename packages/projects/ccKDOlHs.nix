...
let
    ...
    in {
        ...
        "pkg-0.3.0" = _ERFRuuW5;
        "pkg-0.3.1" = _IPVeGmcd;
        "pkg-0.3.0+1.18" = _LmWOyXVW;
        "pkg-0.3.2+1.17" = _flVS3RS0;
        "pkg-0.3.5+1.18" = _PptbPV7y;
        "pkg-0.3.6+1.18" = _1WqSpJvo;
        "pkg-0.3.7+1.18" = _F6DR79FV;
        "pkg-0.3.8+1.18" = _1E69wiMJ;
        "pkg-0.3.10+1.18" = _eAlYR8cf;
        "pkg-0.3.11+1.18" = _Jfd8qbEF;
        "pkg-0.3.12+1.18" = _3Qzf5TkU;
        "pkg-0.3.13+1.18" = _lT5Mm5fS;
        "pkg-0.3.14+1.18" = _6LkUrYRt;
        "pkg-0.4.0+1.18" = _vnSwwEYV;
        "pkg-0.5.0+1.18" = _2QnmkZKc;
        "pkg-0.5.1+1.18" = _q3Sxg4SA;
        "pkg-0.5.2+1.18" = _i8cpzMnQ;
        "pkg-0.5.4+1.18" = _GqwSx15g;
        "pkg-0.6.0+1.18" = _aWqxWaL7;
        "pkg-0.7.0+1.18" = _zVhs4uLj;
        "pkg-0.7.1+1.18" = _WJsP5KWE;
        "pkg-0.7.2+1.18" = _F4LqV8lu;
        "pkg-0.7.3+1.19" = _aXMVV7gj;
        "pkg-0.7.2-no-cme+1.18" = _uAXx21D1;
        "pkg-0.8.0+1.19" = _C46ht027;
        "pkg-0.8.1+1.19" = _HqAtE0un;
        "pkg-0.8.2+1.19" = _NzQ8iAeC;
        "pkg-0.8.3+1.19" = _RV8F1iab;
        "pkg-0.8.4+1.19" = _Dmqb8GqA;
        "pkg-0.8.5+1.19" = _bJtMgK25;
        "pkg-0.9.0+1.19" = _lEVNuJ3B;
        "pkg-0.9.1+1.19" = _fr6mJFIx;
        "pkg-0.9.2+1.19" = _JX2OM2ED;
        "pkg-0.9.3+1.19.3" = _2yMO9WGE;
        "pkg-0.9.3+1.19" = _yGLYmVnT;
        "pkg-0.10.0+1.19.3" = _gsbvHClE;
        "pkg-0.10.1+1.19.3" = _LI7k719Y;
        "pkg-0.10.2+1.19.3" = _KMwbSA7v;
        "pkg-0.10.3+1.19.3" = _gmwB5dLB;
        "pkg-0.10.3+1.19.4" = _ORA8RfoA;
        "pkg-0.10.4+1.19.4" = _T8DsELMD;
        "pkg-0.10.5+1.19.4" = _5QgPEzLH;
        "pkg-0.10.6+1.19.4" = _beTZr7PG;
        "pkg-0.11.0+1.20" = _DgIYuFEF;
        "pkg-0.11.1+1.20" = _m23n3uIM;
        "pkg-0.11.2+1.20" = _zyOBB7J4;
        "pkg-0.11.3+1.20.2" = _oLoJCrky;
        "pkg-0.11.4+1.20.2" = _DYgDdRtg;
        "pkg-0.12.0+1.20.3" = _rGwQL6vN;
        "pkg-0.12.1+1.20.3" = _9NFjhCIH;
        "pkg-0.12.2+1.20.3" = _LWhxwhvI;
        "pkg-0.12.3+1.20.3" = _HYGIKGSR;
        "pkg-0.12.4+1.20.3" = _HEZ55HbJ;
        "pkg-0.12.5+1.20.3" = _CJ29u2GJ;
        "pkg-0.12.6+1.20.3" = _Her7Z3CG;
        "pkg-0.12.6+1.20.5" = _ueejHgQH;
        "pkg-0.12.7+1.20.5" = _cFeG2MJS;
        "pkg-0.12.8+1.20.5" = _5qH0boef;
        "pkg-0.12.9+1.20.5" = _gizS7nlP;
        "pkg-0.12.10+1.21" = _1fKeD2p9;
        "pkg-0.12.11+1.21" = _AVkXApBi;
        "pkg-0.12.12+1.21" = _7F2C3HCI;
        "pkg-0.12.13+1.21" = _8emxtz6T;
        "pkg-0.12.14+1.21" = _HegQGu0K;
        "pkg-0.12.15+1.21" = _vCCHsvEa;
        "pkg-0.12.15-beta.4+1.21" = _etV6oiTP;
        "pkg-0.12.15-beta.5+1.21" = _W20aY40r;
        "pkg-0.12.16+1.21.2" = _j81y0n5S;
        "pkg-0.12.15-beta.6+1.21" = _EitNCRux;
        "pkg-0.12.17+1.21.2" = _Doig2v73;
        "pkg-0.12.15-beta.9+1.21" = _afVTNeT0;
        "pkg-0.12.18+1.21.2" = _3Q7oLImc;
        "pkg-0.12.15-beta.10+1.21" = _nQeQz7rx;
        "pkg-0.12.15-beta.11+1.21" = _nu1XnBPU;
        "pkg-0.12.18-beta.4+1.21.2" = _HIysrC5H;
        "pkg-0.12.15-beta.12+1.21" = _qm96mQBh;
        "pkg-0.12.18-beta.5+1.21.2" = _DQKZGF41;
        "pkg-0.12.18-beta.6+1.21.2" = _tqu96AJU;
        "pkg-0.12.19+1.21.4" = _u6nBP9Dt;
        "pkg-0.12.19-beta.1+1.21.4" = _hKuP4ZWy;
        "pkg-0.12.20+1.21.4" = _kNCPPFb2;
        "pkg-0.12.19-beta.2+1.21.4" = _p9vm8HDx;
        "pkg-0.12.15.1+1.21" = _WMGDnJhl;
        "pkg-0.12.15.1-beta.1+1.21" = _ZHGf6RkT;
        "pkg-0.12.15.1-beta.2+1.21" = _xGZcfBtJ;
        "pkg-0.12.15.1-beta.3+1.21" = _HD3e3YKK;
        "pkg-0.12.15.2+1.21" = _MufQflLZ;
        "pkg-0.12.20+1.21.5" = _bXKMgjI3;
        "pkg-0.12.15.4+1.21" = _JB1fLQnc;
        "pkg-0.12.21+1.21.5" = _xQbRMeoS;
        "pkg-0.12.21-beta.1+1.21.5" = _FpKmEpQ5;
        "pkg-0.12.21+1.21.6" = _j6tLZX6U;
        "pkg-0.12.15.1-beta.6+1.21" = _aDarc4xa;
        "pkg-0.12.15.5-beta.1+1.21" = _NMCHU6DZ;
        "pkg-0.12.22+1.21.8" = _fboVuDvC;
        "pkg-0.12.23+1.21.8" = _mfHtm034;
        "pkg-0.12.24+1.21.8" = _dKNIWbIw;
        "pkg-0.12.25+1.21.8" = _dyH7Voub;
        "pkg-0.12.22+1.21.9" = _rg0wuHQL;
        "pkg-0.12.25+1.21.9" = _DiZPjfYn;
        "pkg-0.12.24+1.21.9" = _dZPuIa4j;
        "pkg-0.12.26+1.21.9" = _U1h2fIEv;
        "pkg-0.12.27+1.21.10" = _XSNbU0Ye;
        "pkg-0.12.28+1.21.10" = _TY022mTW;
