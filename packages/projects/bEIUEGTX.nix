...
let
    versions = (let
        ...
        _kAjQXc4f = {
            "id" = "kAjQXc4f";
            "file" = "PAPIProxyBridge-Bukkit-1.8.4-1959e64.jar";
            "hash" = "sha512-bLZi/pl5Xse4fS5c3fPwfYCPFdiIEaTjxHyVih1i4ydS6+TKG2U0ew5OawuEof4t44D0gjV+sBN1P7NM9gxdSA==";
        };
        _EJFHm9jp = {
            "id" = "EJFHm9jp";
            "file" = "PAPIProxyBridge-Fabric-1.8.4-1959e64+mc.1.20.1.jar";
            "hash" = "sha512-xVi1zUgHe9+SIFqt83bJyGWSufwigk+ptYOH8z+TtoBq4o/qhwq++qE3kJpQ2s9Nopes7/3qgYxnX2O5j/T4Uw==";
        };
        _Kg8cryWF = {
            "id" = "Kg8cryWF";
            "file" = "PAPIProxyBridge-Fabric-1.8.4-1959e64+mc.1.21.1.jar";
            "hash" = "sha512-Ibe33vnBsazQ/6nxd1t3VGzf4uhDHE8LKNgPY74FDNdjeHvTlfM8omGZtY6G4CrRTNvej6FAfny+z6ognqSgZw==";
        };
        _M9uXDLiz = {
            "id" = "M9uXDLiz";
            "file" = "PAPIProxyBridge-Fabric-1.8.4-1959e64+mc.1.21.4.jar";
            "hash" = "sha512-xMDpzxrbtm5AhjlQ0RJRPibAjIj9mr1JXsFCjodGn1Pjebjs6ZZKBFyVGTuCYWYkBuxaLuY8uSoBJ6GMHeHVCA==";
        };
        _g1FYqKih = {
            "id" = "g1FYqKih";
            "file" = "PAPIProxyBridge-Fabric-1.8.4-1959e64+mc.1.21.5.jar";
            "hash" = "sha512-TawVAORc9ruFgu2OrCsMH8Qyp3bsKIAAyMIUWx1Svc+S2QgnKs8/v4USnUwftF7swWyWf6TuvNzEvjZyrQcIHA==";
        };
        _9ibxdqtZ = {
            "id" = "9ibxdqtZ";
            "file" = "PAPIProxyBridge-Fabric-1.8.4-1959e64+mc.1.21.8.jar";
            "hash" = "sha512-k56+jN/YLzbntnQf4wY6vizf4DHb2WSId3i2XoGh15DWgvdjCIwKOUT+qxy+PtC26R/81wA165Y6+RM+yF36pg==";
        };
        _be4eJTro = {
            "id" = "be4eJTro";
            "file" = "PAPIProxyBridge-Bungee-1.8.4-1959e64.jar";
            "hash" = "sha512-z2JOCxuBrHE8UMUOb/dTyowXCk/+8mdDpzBRex6TIZGxZR90hERh01wH2eg1UojauWh5GMuY4303Bxu09Lt33A==";
        };
        _TCNySb5Z = {
            "id" = "TCNySb5Z";
            "file" = "PAPIProxyBridge-Velocity-1.8.4-1959e64.jar";
            "hash" = "sha512-is3jjS8NogvtH2fHWqEzjlgNhihhTNGIGJcUgnN9BQGe9r4s0w1YNowRY8y+wwOQZDkABij1OhbNPEASYKlGBg==";
        };
    in {
        "MnjWkYsU" = _MnjWkYsU;
        "4p9XfrMo" = _4p9XfrMo;
        ...
        "bungeecord-1.17.1" = _be4eJTro;
        "bungeecord-1.18.2" = _be4eJTro;
        "bungeecord-1.19.3" = _be4eJTro;
        "bungeecord-1.19.4" = _be4eJTro;
        "bungeecord-1.20" = _be4eJTro;
        "bungeecord-1.20.1" = _be4eJTro;
        "bungeecord-1.20.4" = _be4eJTro;
        "bungeecord-1.18" = _be4eJTro;
        "bungeecord-1.18.1" = _be4eJTro;
        "bungeecord-1.19" = _be4eJTro;
        "bungeecord-1.19.1" = _be4eJTro;
        "bungeecord-1.19.2" = _be4eJTro;
        "bungeecord-1.20.2" = _be4eJTro;
        "bungeecord-1.20.3" = _be4eJTro;
        "bungeecord-1.20.5" = _be4eJTro;
        "bungeecord-1.20.6" = _be4eJTro;
        "bungeecord-1.21" = _be4eJTro;
        "bungeecord-1.21.1" = _be4eJTro;
        "bungeecord-1.21.2" = _be4eJTro;
        "bungeecord-1.21.3" = _be4eJTro;
        "bungeecord-1.21.4" = _be4eJTro;
        "bungeecord-1.21.5" = _be4eJTro;
        "bungeecord-1.21.6" = _be4eJTro;
        "bungeecord-1.21.7" = _be4eJTro;
        "bungeecord-1.21.8" = _be4eJTro;
        "spigot-1.16.5" = _AFkVl2oy;
        "spigot-1.17.1" = _kAjQXc4f;
        "spigot-1.18.2" = _kAjQXc4f;
        "spigot-1.19.3" = _kAjQXc4f;
        "spigot-1.19.4" = _kAjQXc4f;
        "spigot-1.20" = _kAjQXc4f;
        "spigot-1.20.1" = _kAjQXc4f;
        "spigot-1.20.4" = _kAjQXc4f;
        "spigot-1.18" = _kAjQXc4f;
        "spigot-1.18.1" = _kAjQXc4f;
        "spigot-1.19" = _kAjQXc4f;
        "spigot-1.19.1" = _kAjQXc4f;
        "spigot-1.19.2" = _kAjQXc4f;
        "spigot-1.20.2" = _kAjQXc4f;
        "spigot-1.20.3" = _kAjQXc4f;
        "spigot-1.20.5" = _kAjQXc4f;
        "spigot-1.20.6" = _kAjQXc4f;
        "spigot-1.21" = _kAjQXc4f;
        "spigot-1.21.1" = _kAjQXc4f;
        "spigot-1.21.2" = _kAjQXc4f;
        "spigot-1.21.3" = _kAjQXc4f;
        "spigot-1.21.4" = _kAjQXc4f;
        "spigot-1.21.5" = _kAjQXc4f;
        "spigot-1.21.6" = _kAjQXc4f;
        "spigot-1.21.7" = _kAjQXc4f;
        "spigot-1.21.8" = _kAjQXc4f;
        "velocity-1.16.5" = _AFkVl2oy;
        "velocity-1.17.1" = _TCNySb5Z;
        "velocity-1.18.2" = _TCNySb5Z;
        "velocity-1.19.3" = _TCNySb5Z;
        "velocity-1.19.4" = _TCNySb5Z;
        "velocity-1.20" = _TCNySb5Z;
        "velocity-1.20.1" = _TCNySb5Z;
        "velocity-1.20.4" = _TCNySb5Z;
        "velocity-1.18" = _TCNySb5Z;
        "velocity-1.18.1" = _TCNySb5Z;
        "velocity-1.19" = _TCNySb5Z;
        "velocity-1.19.1" = _TCNySb5Z;
        "velocity-1.19.2" = _TCNySb5Z;
        "velocity-1.20.2" = _TCNySb5Z;
        "velocity-1.20.3" = _TCNySb5Z;
        "velocity-1.20.5" = _TCNySb5Z;
        "velocity-1.20.6" = _TCNySb5Z;
        "velocity-1.21" = _TCNySb5Z;
        "velocity-1.21.1" = _TCNySb5Z;
        "velocity-1.21.2" = _TCNySb5Z;
        "velocity-1.21.3" = _TCNySb5Z;
        "velocity-1.21.4" = _TCNySb5Z;
        "velocity-1.21.5" = _TCNySb5Z;
        "velocity-1.21.6" = _TCNySb5Z;
        "velocity-1.21.7" = _TCNySb5Z;
        "velocity-1.21.8" = _TCNySb5Z;
        "fabric-1.16.5" = _AFkVl2oy;
        "fabric-1.17.1" = _qMxjLxIR;
        "fabric-1.18.2" = _qMxjLxIR;
        "fabric-1.19.4" = _qMxjLxIR;
        "fabric-1.20" = _qMxjLxIR;
        "fabric-1.20.1" = _EJFHm9jp;
        ...
        "fabric-1.21.1" = _Kg8cryWF;
        "fabric-1.21.2" = _7dxDfO1m;
        "fabric-1.21.3" = _FRulASKg;
        "fabric-1.21.4" = _M9uXDLiz;
        "fabric-1.21.5" = _g1FYqKih;
        "fabric-1.21.7" = _p1MK9ceI;
        "fabric-1.21.8" = _9ibxdqtZ;
        "folia-1.17.1" = _kAjQXc4f;
        "folia-1.18" = _kAjQXc4f;
        "folia-1.18.1" = _kAjQXc4f;
        "folia-1.18.2" = _kAjQXc4f;
        "folia-1.19" = _kAjQXc4f;
        "folia-1.19.1" = _kAjQXc4f;
        "folia-1.19.2" = _kAjQXc4f;
        "folia-1.19.3" = _kAjQXc4f;
        "folia-1.19.4" = _kAjQXc4f;
        "folia-1.20" = _kAjQXc4f;
        "folia-1.20.1" = _kAjQXc4f;
        "folia-1.20.2" = _kAjQXc4f;
        "folia-1.20.3" = _kAjQXc4f;
        "folia-1.20.4" = _kAjQXc4f;
        "folia-1.20.5" = _kAjQXc4f;
        "folia-1.20.6" = _kAjQXc4f;
        "folia-1.21" = _kAjQXc4f;
        "folia-1.21.1" = _kAjQXc4f;
        "folia-1.21.2" = _kAjQXc4f;
        "folia-1.21.3" = _kAjQXc4f;
        "folia-1.21.4" = _kAjQXc4f;
        "folia-1.21.5" = _kAjQXc4f;
        "folia-1.21.6" = _kAjQXc4f;
        "folia-1.21.7" = _kAjQXc4f;
        "folia-1.21.8" = _kAjQXc4f;
        "paper-1.17.1" = _kAjQXc4f;
        "paper-1.18" = _kAjQXc4f;
        "paper-1.18.1" = _kAjQXc4f;
        "paper-1.18.2" = _kAjQXc4f;
        "paper-1.19" = _kAjQXc4f;
        "paper-1.19.1" = _kAjQXc4f;
        "paper-1.19.2" = _kAjQXc4f;
        "paper-1.19.3" = _kAjQXc4f;
        "paper-1.19.4" = _kAjQXc4f;
        "paper-1.20" = _kAjQXc4f;
        "paper-1.20.1" = _kAjQXc4f;
        "paper-1.20.2" = _kAjQXc4f;
        "paper-1.20.3" = _kAjQXc4f;
        "paper-1.20.4" = _kAjQXc4f;
        "paper-1.20.5" = _kAjQXc4f;
        "paper-1.20.6" = _kAjQXc4f;
        "paper-1.21" = _kAjQXc4f;
        "paper-1.21.1" = _kAjQXc4f;
        "paper-1.21.2" = _kAjQXc4f;
        "paper-1.21.3" = _kAjQXc4f;
        "paper-1.21.4" = _kAjQXc4f;
        "paper-1.21.5" = _kAjQXc4f;
        "paper-1.21.6" = _kAjQXc4f;
        "paper-1.21.7" = _kAjQXc4f;
        "paper-1.21.8" = _kAjQXc4f;
        "waterfall-1.17.1" = _be4eJTro;
        "waterfall-1.18" = _be4eJTro;
        "waterfall-1.18.1" = _be4eJTro;
        "waterfall-1.18.2" = _be4eJTro;
        "waterfall-1.19" = _be4eJTro;
        "waterfall-1.19.1" = _be4eJTro;
        "waterfall-1.19.2" = _be4eJTro;
        "waterfall-1.19.3" = _be4eJTro;
        "waterfall-1.19.4" = _be4eJTro;
        "waterfall-1.20" = _be4eJTro;
        "waterfall-1.20.1" = _be4eJTro;
        "waterfall-1.20.2" = _be4eJTro;
        "waterfall-1.20.3" = _be4eJTro;
        "waterfall-1.20.4" = _be4eJTro;
        "waterfall-1.20.5" = _be4eJTro;
        "waterfall-1.20.6" = _be4eJTro;
        "waterfall-1.21" = _be4eJTro;
        "waterfall-1.21.1" = _be4eJTro;
        "waterfall-1.21.2" = _be4eJTro;
        "waterfall-1.21.3" = _be4eJTro;
        "waterfall-1.21.4" = _be4eJTro;
        "waterfall-1.21.5" = _be4eJTro;
        "waterfall-1.21.6" = _be4eJTro;
        "waterfall-1.21.7" = _be4eJTro;
        "waterfall-1.21.8" = _be4eJTro;
        "pkg-1.0" = _MnjWkYsU;
        "pkg-1.1" = _4p9XfrMo;
        "pkg-1.2" = _8LB5moMU;
        "pkg-1.2.1" = _TDaZjdRP;
        ...
        "pkg-1.6.1" = _RXXUN9SA;
        "pkg-1.6.2" = _qMxjLxIR;
        "pkg-1.7-a848a92" = _SJwkohIw;
        "pkg-1.7-90b9440" = _LkTitu2e;
        "pkg-1.7-aed418b" = _OXAULF6c;
        "pkg-1.7-140e297" = _XgwsCYZI;
        "pkg-1.7" = _GPw0ig1e;
        "pkg-1.7-4a21fd0" = _aikG7ePY;
        "pkg-1.7-4eac250" = _bjcOMFD0;
        "pkg-1.7-1f20b4c" = _ZBJg6vu2;
        "pkg-1.7.1-9a61467" = _4Q5Hc14y;
        "pkg-1.7.1" = _5qNNm6Up;
        "pkg-1.7.1-6bd7ffb" = _9ybR1Fum;
        "pkg-1.7.2-6a6d376" = _ppGIvLvd;
        "pkg-1.7.2-5cf7d01" = _akecnUKA;
        "pkg-1.7.2" = _V1u4V031;
        "pkg-1.8-f6df2c9" = _WInNORUv;
        "pkg-1.8-e81754b" = _X2TnCUKC;
        "pkg-1.8-bd95bd9" = _mmRGLn8T;
        "pkg-1.8-7db6146" = _IvryNb80;
        "pkg-1.8-50a1d93" = _t4dSNJnZ;
        "pkg-1.8-3af9c32" = _eXFQK2Re;
        "pkg-1.8-259a5a2" = _LHUjTN6i;
        "pkg-1.8-50ebc6e" = _ulsqrzqZ;
        "pkg-1.8-d6b49bf" = _CVOcj72C;
        "pkg-1.8-b26c3d1" = _Jf0NX1pg;
        "pkg-1.8-43ff61d" = _l4gTC7M9;
        "pkg-1.8-df6f671" = _JF2zXeXB;
        "pkg-1.8-451e15f" = _hM9YjW3T;
        "pkg-1.8-31a49d7" = _q9YTpHVq;
        "pkg-1.8-e8fb961" = _FcTf1YGL;
        "pkg-1.8" = _ZCFeILgx;
        "pkg-1.8-f978e8f" = _L4XSROfX;
        "pkg-1.8-5a793f4" = _ULOzRqii;
        "pkg-1.8.1-9fa9eb3" = _ZmGLAtbv;
        "pkg-1.8.1" = _mL4j52EA;
        "pkg-1.8.1-3ca29f3" = _FOoqqwR8;
        "pkg-1.8.2-9cbc8e4" = _Cq8DweAt;
        "pkg-1.8.2" = _L5e9CcP9;
        "pkg-1.8.2-d5a8f17" = _28VNl3Ig;
        "pkg-1.8.3-ab4910e" = _2iNZIbTX;
        "pkg-1.8.3" = _Zuh0dZ4M;
        "pkg-1.8.4-9dbe32d" = _sdlDOLKH;
        "pkg-1.8.4-2c82fef" = _qvv5ecZU;
        "pkg-1.8.4-8783487" = _qEtVyfpF;
        "pkg-1.8.4-52bdeba" = _3rvIC8ER;
        "pkg-1.8.4" = _jR1s02Y5;
        "pkg-1.8.4-d479e5c" = _EoZAMV65;
        "pkg-1.8.4-c4d2079" = _BZENMkKV;
        "pkg-1.8.4-72367f6" = _NyPXRlze;
        "pkg-1.8.4-1959e64" = _TCNySb5Z;
        "default" = _TCNySb5Z;
    });
