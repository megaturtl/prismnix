...
let
    versions = (let
        ...
        _TP5KqyI0 = {
            "id" = "TP5KqyI0";
            "file" = "RT Tutorial (part 1) .zip";
            "hash" = "sha512-rOOjZvEtY6obxJok6nvZnGXaqghtEozXhKjLsh99IBEHyfb2ddH8rVEtsDK11br59E1mHt73xwSlVB5ZLbbBug==";
        };
        _iUWeMCvR = {
            "id" = "iUWeMCvR";
            "file" = "RT Tutorial (part 2).zip";
            "hash" = "sha512-LOGU2bc/b7Y+HAsNdFTMxecucHyh1LcI9XzVCDp4syiIFusrzWXTYYh9Fp4jo9A5fkyk+Qf0GHui1oqeniIOWQ==";
        };
        _30mKV6nO = {
            "id" = "30mKV6nO";
            "file" = "RT Tutorial (part 3).zip";
            "hash" = "sha512-NQsFaKwZZVmPZtSI9JIvWnBNkgCxbbydklFCm4JLo+QpZDHrupcgXYDn2T3bqR8yRee2lbijxis8a9/2C9W52g==";
        };
    in {
        "uD8FVQ4b" = _uD8FVQ4b;
        "JhqsPPR5" = _JhqsPPR5;
        ...
        "iUWeMCvR" = _iUWeMCvR;
        "30mKV6nO" = _30mKV6nO;
        "iris-1.19.2" = _30mKV6nO;
        "iris-1.19.3" = _30mKV6nO;
        "iris-1.19.4" = _30mKV6nO;
        "iris-1.20" = _30mKV6nO;
        "iris-1.20.1" = _30mKV6nO;
        "iris-1.20.2" = _30mKV6nO;
        "iris-1.20.3" = _30mKV6nO;
        "iris-1.20.4" = _30mKV6nO;
        "iris-1.20.5" = _30mKV6nO;
        "iris-1.20.6" = _30mKV6nO;
        "iris-1.21" = _30mKV6nO;
        "iris-1.21.1" = _30mKV6nO;
        "iris-1.21.2" = _30mKV6nO;
        "iris-1.21.3" = _30mKV6nO;
        "iris-1.21.4" = _30mKV6nO;
        "iris-1.21.5" = _30mKV6nO;
        "iris-1.21.6" = _30mKV6nO;
        "iris-1.21.7" = _30mKV6nO;
        "iris-1.21.8" = _30mKV6nO;
        "iris-1.21.9" = _30mKV6nO;
        "iris-1.21.10" = _30mKV6nO;
        "iris-1.21.11" = _30mKV6nO;
        "iris-1.19" = _30mKV6nO;
        "iris-1.19.1" = _30mKV6nO;
        "iris-26.1" = _30mKV6nO;
        "iris-26.1.1" = _30mKV6nO;
        "iris-26.1.2" = _30mKV6nO;
        "iris-26.2" = _30mKV6nO;
        "pkg-1" = _uD8FVQ4b;
        "pkg-2" = _JhqsPPR5;
        "pkg-3" = _pkB4HgEF;
