...
let
    versions = (let
        ...
        _ii4vkhQ0 = {
            "id" = "ii4vkhQ0";
            "file" = "3D Default 1.20+ v1.16.0.zip";
            "hash" = "sha512-cpwJc8vnCGlwd125Q4IbmWJCtfyQoxbKWOwa4FUU7L1+j6jGqgz0RFARp4Ql1aWVrHZeNMBm21lPKqAszqgLvA==";
        };
        _3Z2r4oP7 = {
            "id" = "3Z2r4oP7";
            "file" = "3D Default 1.21.2+ v1.16.0.zip";
            "hash" = "sha512-N5yB9hvI3GA+2G8vVMg1djgt9GkIuv9LofX6uHVe6GFHXfp9jpmHT1DQJWncihJovjlDSk2hgnOOIQA4+LTTrA==";
        };
    in {
        "mbGiKsH9" = _mbGiKsH9;
        "auIqPhoC" = _auIqPhoC;
        ...
        "minecraft-1.20" = _ii4vkhQ0;
        "minecraft-1.20.1" = _ii4vkhQ0;
        "minecraft-1.20.2" = _ii4vkhQ0;
        "minecraft-1.20.3" = _ii4vkhQ0;
        "minecraft-1.20.4" = _ii4vkhQ0;
        "minecraft-1.20.5" = _ii4vkhQ0;
        "minecraft-1.20.6" = _ii4vkhQ0;
        "minecraft-1.21" = _ii4vkhQ0;
        "minecraft-1.21.1" = _ii4vkhQ0;
        "minecraft-1.21.2" = _3Z2r4oP7;
        "minecraft-1.21.3" = _3Z2r4oP7;
        "minecraft-1.21.4" = _3Z2r4oP7;
        "minecraft-1.21.5" = _3Z2r4oP7;
        "minecraft-1.21.6" = _3Z2r4oP7;
        "minecraft-1.21.7" = _3Z2r4oP7;
        "minecraft-1.21.8" = _3Z2r4oP7;
        "minecraft-1.21.9" = _3Z2r4oP7;
        "minecraft-1.21.10" = _3Z2r4oP7;
        "minecraft-1.21.11" = _3Z2r4oP7;
        "minecraft-26.1" = _3Z2r4oP7;
        "minecraft-26.1.1" = _3Z2r4oP7;
        "minecraft-26.1.2" = _3Z2r4oP7;
        "minecraft-26.2" = _3Z2r4oP7;
        "minecraft-26.3" = _3Z2r4oP7;
        "pkg-1.6.0-mc1.14" = _mbGiKsH9;
        "pkg-1.6.0-mc1.15-1.16.1" = _auIqPhoC;
        "pkg-1.6.0-mc1.16.2+" = _ytk6UH6F;
        "pkg-1.6.0-mc1.17" = _w4Nn8uC0;
        "pkg-1.6.0-mc1.18" = _bQTgj6tY;
        "pkg-1.6.0-mc1.19-1.19.2" = _DcjUzhhQ;
        "pkg-1.7.0-mc1.19.3" = _KM9p3q4f;
        "pkg-1.7.0-mc1.19.4" = _6t4n6tZI;
        "pkg-1.8.0" = _Pqm5jmEx;
        "pkg-1.8.1" = _PwpWqDhI;
        "pkg-1.9.0" = _XDe3agk1;
        "pkg-1.10.0" = _ya4fHTXv;
        "pkg-1.10.1" = _2r23GJX2;
        "pkg-1.10.2" = _H2ccvlo4;
        "pkg-1.11.0" = _1xh3urYS;
        "pkg-1.11.1" = _VC5ts6il;
        "pkg-1.11.2" = _D6G8bGpg;
        "pkg-1.12.0" = _cGdc5J31;
        "pkg-1.12.1" = _TclOfUqX;
        "pkg-1.13.0" = _Ihzlnu5N;
        "pkg-1.13.1" = _vcKuCyeQ;
        "pkg-1.14.0" = _IR01Wc03;
        "pkg-1.15.0" = _Xs7Vngsn;
        "pkg-1.16.0" = _3Z2r4oP7;
        "default" = _3Z2r4oP7;
    });
