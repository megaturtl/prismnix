...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.0.4" = _ajlTOmRS;
        "pkg-1.20.1-1.0.4" = _bb1nvmju;
        "pkg-1.18.2-1.0.5" = _A0WvBW2D;
        "pkg-1.20.1-1.0.5" = _Tr2n6OzX;
        "pkg-1.20.6-1.0.5" = _arclSOXD;
        "pkg-1.20.6-1.0.5.b" = _4HftLzcW;
        "pkg-1.21-1.0.5.b" = _lYRlfZis;
        "pkg-1.20.6-1.0.6" = _nwbOWqF1;
        "pkg-1.21-1.0.6" = _TvU10aNN;
        "pkg-1.21.1-1.0.6.b-fabric" = _ByX7LotC;
        "pkg-1.21.4-1.0.7-fabric" = _MlKTVNzE;
        "pkg-1.21.4-1.0.7-neoforge" = _c05oauwg;
        "pkg-1.21.1-1.0.7-fabric" = _bbTdqZep;
        "pkg-1.21.1-1.0.7-neoforge" = _6hSkauwl;
        "pkg-1.21.5-1.0.7-fabric" = _VTiLRi1a;
        "pkg-1.21.5-1.0.7-neoforge" = _ArmO6mUx;
        "pkg-1.21.1-1.0.8-fabric" = _orWCov4b;
        "pkg-1.21.1-1.0.8-neoforge" = _Qsq7ekrX;
        "pkg-1.21.5-1.0.8-fabric" = _1OCk4XbH;
        "pkg-1.21.5-1.0.8-neoforge" = _fe0oDC4J;
        "pkg-1.21.1-1.0.9-fabric" = _C2cbpAJt;
        "pkg-1.21.1-1.0.9-neoforge" = _GlCTL0rQ;
        "pkg-1.21.5-1.0.9-fabric" = _1z3oBL0p;
        "pkg-1.21.5-1.0.9-neoforge" = _eG1Ctm7y;
        "pkg-1.21.8-1.0.9-fabric" = _vLGNN19k;
        "pkg-1.21.8-1.0.9-neoforge" = _9tFMBfuz;
        "pkg-1.21.9-1.0.9-fabric" = _Q6UIoMHm;
        "pkg-1.21.9-1.0.9-neoforge" = _Oi4ZVi2q;
        "pkg-1.21.11-1.0.9-fabric" = _sTshGcWc;
