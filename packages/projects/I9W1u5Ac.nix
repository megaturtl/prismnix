...
let
    versions = (let
        ...
        _1Y3tWJOO = {
            "id" = "1Y3tWJOO";
            "file" = "mcsrranked-5.8.13.jar";
            "hash" = "sha512-PVu5P7YsBjlMrmv4/c5/uD3ceLr1jhkepKbtH0JYWKvCUhwDE14AbogVg30zFkw4X+QfA58wkZi0EmUUfKVivQ==";
        };
        _ESvNXD6B = {
            "id" = "ESvNXD6B";
            "file" = "mcsrranked-5.8.14.jar";
            "hash" = "sha512-ehID7owsJRrvtuPr4z4NsUVs8Iqhf/loCZp0yDmuglz8c90wn6dCY2ZluDanamfBQ3ZwyQDvQrBxjFBDJX90ng==";
        };
        _7tckWGJR = {
            "id" = "7tckWGJR";
            "file" = "mcsrranked-5.8.15.jar";
            "hash" = "sha512-OqokpQk8Zrgv66Csrvcg6pCkJi+TFS58hOZ6YI/Mog3oL1RsbtHlXTx2Nnk1PdnsZQ9tyykiQ719ughuepstAg==";
        };
        _tdeqAlPv = {
            "id" = "tdeqAlPv";
            "file" = "mcsrranked-5.8.16.jar";
            "hash" = "sha512-+4tvGoPVKVJna5ulPC6BcWVB9llXuIOBVceacVVC9lzEluIWZyKcLX5aDCkATK85zI2bE1AFXkSLvXXnyx2rTQ==";
        };
        _tmjMjQoX = {
            "id" = "tmjMjQoX";
            "file" = "mcsrranked-5.8.17.jar";
            "hash" = "sha512-SNcdWhXyiQJDPKQWXUoKG8Eq10hTJ5N1ehfm4ILUe56YRNB0RNgxu8f8PIve6IedxLlprbQ1SNhtEOU9I8haWg==";
        };
        _wvlNsT7L = {
            "id" = "wvlNsT7L";
            "file" = "mcsrranked-5.8.18.jar";
            "hash" = "sha512-0v85vsZUoyeWdQ4PHPBMvwNGUUAFXePwgKYdMszWn7mzfQgn2f8zsj8p9s8EYkgbLw8op3VWp+kS0YuouJLdZg==";
        };
        _HDnsgGOI = {
            "id" = "HDnsgGOI";
            "file" = "mcsrranked-5.8.19.jar";
            "hash" = "sha512-sNUpR531GrYRzgg4C++jAN2nkabgBGkWtfmVi32Iucj8msVJEz1r+iFHgl/ku6a8MVPvdG4EQW/FZ/DI8akxkQ==";
        };
        _vLgFb3QA = {
            "id" = "vLgFb3QA";
            "file" = "mcsrranked-5.8.20.jar";
            "hash" = "sha512-JavNQgNff7fx4pwRVxmo+IYx8ziwUc7aq3QsyEbz7O6+eyaXn3B7vRMYOv1hOlKLi0ujLg+7enDgLhgAOTcWdQ==";
        };
        _exWE7zve = {
            "id" = "exWE7zve";
            "file" = "mcsrranked-5.8.21.jar";
            "hash" = "sha512-EsKOPsIPBsQFOTf4oa3pz6TLk9FVmiZ6qCTJexvXBIz2kf10pcNCF36rjsMYtWH7XL4SwgDzE7+Jrq6hC9HqJg==";
        };
    in {
        "r17vLIlI" = _r17vLIlI;
        "Pr8911G1" = _Pr8911G1;
        ...
        "vLgFb3QA" = _vLgFb3QA;
        "exWE7zve" = _exWE7zve;
        "fabric-1.16.1" = _exWE7zve;
        "pkg-1.1.8" = _r17vLIlI;
        "pkg-1.1.9" = _Pr8911G1;
        "pkg-1.1.10" = _XZVqLLbz;
        "pkg-1.1.11" = _D9R04Ud8;
        "pkg-1.1.12" = _VWxoBGfr;
        "pkg-1.2" = _GlRYCpWB;
        "pkg-1.2.1" = _dwiBgBL8;
        "pkg-1.2.1.2" = _9zlJ2oFW;
        "pkg-1.2.2" = _MAzgwPzK;
        "pkg-1.2.3" = _TuoS3HOm;
        "pkg-1.2.3.1" = _abidryjw;
        "pkg-1.2.3.2" = _S2cCkSxv;
        "pkg-1.2.3.3" = _ei9AwXND;
        "pkg-1.3.1" = _yjOq96LC;
        "pkg-1.3.2" = _C8qvACjf;
        "pkg-1.3.2.1" = _Ss4jXpqh;
        "pkg-1.3.2.2" = _aCEDBhgn;
        "pkg-1.4.1" = _MdTOXBB7;
        "pkg-1.4.1.1" = _dOR20PrA;
        "pkg-1.4.1.2" = _ebVN2wfi;
        "pkg-1.5" = _dyJBeXgC;
        "pkg-1.5.0.1" = _YLyRk8Ne;
        "pkg-1.5.0.2" = _5RN8l4gF;
        "pkg-1.5.0.3" = _lCn85k3J;
        "pkg-1.5.1" = _V2M3QLyE;
        "pkg-1.5.2.1" = _DC7X9fMF;
        "pkg-1.5.3" = _Z2O17cfD;
        "pkg-1.5.4" = _19no7uKm;
        "pkg-1.5.4.1" = _tm6XxQl8;
        "pkg-1.5.5" = _Fi6BRzxT;
        "pkg-1.5.6" = _9GV73xTt;
        "pkg-1.5.7" = _1ArWDn5E;
        "pkg-1.5.8" = _3sXDq5jT;
        "pkg-1.5.8.1" = _3wclh83l;
        "pkg-1.5.8.2" = _y8pwML6d;
        "pkg-1.5.9" = _HlFJAWJw;
        "pkg-1.5.10" = _2FVWelc4;
        "pkg-1.6.0.2" = _zVAt3t3Y;
        "pkg-1.6.0.5" = _DByuQVkc;
        "pkg-1.6.0.6" = _BhbjtaVi;
        "pkg-1.6.0.7" = _LsqRnUp9;
        "pkg-1.6.1" = _5qeOY4DS;
        "pkg-1.6.1.1" = _P9zwUYjG;
        "pkg-1.6.2" = _cagOOu6d;
        "pkg-1.6.3.1" = _dVSHCXuQ;
        "pkg-1.6.4" = _UK4JUbpF;
        "pkg-1.6.4.1" = _InPSCmWA;
        "pkg-1.6.4.2" = _zqbDsCir;
        "pkg-1.6.5" = _SK23X8PE;
        "pkg-1.6.5.1" = _gHoc2ANj;
        "pkg-1.6.5.2" = _bcnJyCDD;
        "pkg-2.0" = _8G9Yb4aP;
        "pkg-2.0.1" = _qY2BigOB;
        "pkg-2.0.2" = _jBxl6Aaw;
        "pkg-2.0.3" = _RCQZcq3f;
        ...
        "pkg-2.2.3" = _Qrw6vYCS;
        "pkg-2.2.4" = _c0CQZlZY;
        "pkg-2.2.4.1" = _iFxrW1Gi;
        "pkg-2.2.4.2" = _GclvmTLT;
        "pkg-2.2.4.3" = _cBvPWc9H;
        "pkg-2.2.4.4" = _NIia9uHh;
        "pkg-2.2.4.5" = _qNGC6jre;
        "pkg-2.2.5" = _99WZbN8l;
        "pkg-3.0" = _NLVrwZvh;
        "pkg-3.0.1" = _AbAw9noQ;
        "pkg-3.0.2" = _1SFaolel;
        ...
        "pkg-3.0.8" = _mSpXZnLu;
        "pkg-3.0.9" = _7u5tuHP2;
        "pkg-3.0.10" = _mSNWftNj;
        "pkg-3.0.11" = _H6furZaB;
        "pkg-3.0.12" = _HixDW5eQ;
        "pkg-3.0.13" = _ix6hLk06;
        "pkg-3.1" = _UfwkMjeG;
        "pkg-3.1.1" = _AcfEJT1M;
        "pkg-3.1.2" = _ILvzJgmR;
        "pkg-3.1.3" = _UeATP8HQ;
        ...
        "pkg-3.2.8" = _4JZwf8qE;
        "pkg-3.2.9" = _LJmlt7vc;
        "pkg-3.2.10" = _svVDSnQK;
        "pkg-3.2.11" = _KIBLSZPp;
        "pkg-3.2.13" = _vX6lCiBU;
        "pkg-3.2.14" = _4jwV9V1m;
        "pkg-3.2.15" = _fMLNg9J3;
        "pkg-3.2.16" = _6wyFMUTP;
        "pkg-3.2.17" = _Gz063Suu;
        "pkg-3.2.18" = _Q2UANG9d;
        "pkg-3.3" = _PWyu1Kup;
        "pkg-3.3.1" = _ymTNH3VB;
        "pkg-4.0" = _4GhDTb0f;
        "pkg-4.0.1" = _5DcTzdPZ;
        ...
        "pkg-5.0.8" = _17E5TPtO;
        "pkg-5.0.9" = _9Fx9AqnE;
        "pkg-5.0.10" = _maqroPB5;
        "pkg-5.0.11" = _gcrraukz;
        "pkg-5.0.12" = _u0DJhH1R;
        "pkg-5.0.13" = _q6jghj5F;
        "pkg-5.0.14" = _Djl2Hwh7;
        "pkg-5.0.15" = _FUewlhKe;
        "pkg-5.0.16" = _qEcyEhmj;
        "pkg-5.0.17" = _WtXuUogT;
        "pkg-5.0.18" = _twXmMI3q;
        "pkg-5.1" = _6OZAXFJW;
        "pkg-5.1.1" = _9zI9qJ0J;
        "pkg-5.1.2" = _dDIqUzxk;
        "pkg-5.1.3" = _YmCvxam7;
        ...
        "pkg-5.1.7" = _V6SzR70X;
        "pkg-5.1.8" = _H0ZMSB9E;
        "pkg-5.1.10" = _HfF5zXgB;
        "pkg-5.1.11" = _KVNcW1DL;
        "pkg-5.1.12" = _9VS2hEoq;
        "pkg-5.1.13" = _M7nf2PZ8;
        "pkg-5.2" = _gT7xWIHb;
        "pkg-5.2.1" = _WnNZpVpl;
        "pkg-5.3" = _hocAZcxS;
        "pkg-5.3.1" = _CaVdPXVc;
        ...
        "pkg-5.6.8" = _hbmy4ubl;
        "pkg-5.6.9" = _XvjTQvWg;
        "pkg-5.6.10" = _hFPU1FvF;
        "pkg-5.6.12" = _gm7zUSIY;
        "pkg-5.6.13" = _IW8YWwsX;
        "pkg-5.7.0" = _HOkSHhAu;
        "pkg-5.7.1" = _RyeEV2bj;
        "pkg-5.7.2" = _AqfzjVgU;
        "pkg-5.7.3" = _asMBwe7w;
        ...
        "pkg-5.7.6" = _gAwAb5gb;
        "pkg-5.7.7" = _3pfl8D5P;
        "pkg-5.7.11" = _cvYUACWK;
        "pkg-5.7.12" = _tTmkva0l;
        "pkg-5.7.13" = _Ia1Ji9JS;
        "pkg-5.8.0" = _l4mLgpnf;
        "pkg-5.8.1" = _k83cbnOa;
        "pkg-5.8.3" = _rFDQhoWw;
        "pkg-5.8.5" = _d4BwT1Bu;
        ...
        "pkg-5.8.8" = _tphutHxH;
        "pkg-5.8.9" = _fmrnZNcf;
        "pkg-5.8.11" = _vHRzDKx0;
        "pkg-5.8.13" = _1Y3tWJOO;
        "pkg-5.8.14" = _ESvNXD6B;
        "pkg-5.8.15" = _7tckWGJR;
        "pkg-5.8.16" = _tdeqAlPv;
        "pkg-5.8.17" = _tmjMjQoX;
        "pkg-5.8.18" = _wvlNsT7L;
        "pkg-5.8.19" = _HDnsgGOI;
