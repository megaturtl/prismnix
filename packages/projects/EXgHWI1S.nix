...
let
    ...
    in {
        ...
        "pkg-1.12.2-1.0.3" = _yRNiH03x;
        "pkg-1.12.2-1.0.4" = _BOPiTdtB;
        "pkg-1.12.2-1.1.0" = _YbXarMYz;
        "pkg-1.12.2-1.1.1" = _TntllPbW;
        "pkg-1.12.2-1.2.0" = _FFaF2T4k;
        "pkg-1.12.2-1.2.1" = _e7F8zsVX;
        "pkg-1.12.2-1.2.2" = _2rUy4d1I;
        "pkg-1.12.2-1.2.3" = _uypN7bO4;
        "pkg-1.14.3-2.0.9" = _FTknbfIC;
        "pkg-1.14.3-2.0.10" = _dYyNJRbt;
        "pkg-1.14.3-2.0.11" = _sSJtsWi5;
        "pkg-1.14.4-2.0.12" = _O0B5JwLx;
        "pkg-1.14.4-2.0.13" = _DvW2ESfH;
        "pkg-1.14.4-2.0.14" = _azuhHbnH;
        "pkg-1.14.4-2.0.0" = _ZIiie4pY;
        "pkg-1.14.4-2.0.4" = _VVj3hDst;
        "pkg-1.15.1-2.1.0" = _dHXwH7JN;
        "pkg-1.15.1-2.1.1" = _fKCto0Dm;
        "pkg-1.15.2-2.1.2" = _aOFkIiZ1;
        "pkg-1.16.1-3.0.0" = _EzaIEvrn;
        "pkg-1.16.1-3.0.1" = _1CpIPKIs;
        "pkg-1.16.1-3.1.0" = _bUNRPPBg;
        "pkg-1.16.3-3.1.1" = _28TCndhu;
        "pkg-1.16.4-3.2.0" = _LLcR5oAj;
        "pkg-1.16.4-3.2.1" = _iaf8oVWG;
        "pkg-1.16.4-3.2.2" = _EKfP9cDL;
        "pkg-1.16.5-3.2.3" = _Q0A1MHcx;
        "pkg-1.16.5-3.2.4" = _5CzwmYyJ;
        "pkg-1.16.5-3.2.5" = _KoEKG6mk;
        "pkg-1.18.1-3.3.1" = _bCbKRtof;
        "pkg-1.18.1-3.3.2" = _9I7MfAdY;
