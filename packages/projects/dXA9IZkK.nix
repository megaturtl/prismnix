...
let
    versions = (let
        ...
        _BfBpim5e = {
            "id" = "BfBpim5e";
            "file" = "FreeMinecraftModels.jar";
            "hash" = "sha512-gFqT8nSqGwFLiMZ9Qu7KjeRAq9Ic8ZMkNqOe5aXaxjQweL0AJ4VGtphDx+6rv4i7dtSdDkjm+mrGm926dFiaxw==";
        };
        _KkDbkTXJ = {
            "id" = "KkDbkTXJ";
            "file" = "FreeMinecraftModels.jar";
            "hash" = "sha512-9j88NtDwx4L6i0vR8zI+oum6krGMGZ1XdL0EB2vbTlY+A1EY7yVz/GePa9DyGpCmzmIZ4MSUK8GjSbucPN9bjQ==";
        };
        _mHvXeBwW = {
            "id" = "mHvXeBwW";
            "file" = "FreeMinecraftModels.jar";
            "hash" = "sha512-qPkyBjrQpG1Ue2K0fBj3RnX0yHpwLt/CnUmqbns8wLHBKiLziq2TD/aumPPB0c9oaQjqPEJ0u3t9SeggPIHhSA==";
        };
        _Y3JHMGV2 = {
            "id" = "Y3JHMGV2";
            "file" = "FreeMinecraftModels.jar";
            "hash" = "sha512-qgeCScLdzu1Lu7yEFk5vnkM2fizD1/Uwe/1VdbPO/EgXl5D7RaLpjgmYJm/HBc+JfQV0VsMHMNS/k5FNK+R2yw==";
        };
        _YDCR11Wy = {
            "id" = "YDCR11Wy";
            "file" = "FreeMinecraftModels.jar";
            "hash" = "sha512-cXKNyiLdx1OP0nsNmeq/9u4SlhhQu9/BNHEFMzaNdPSZNcHKZgWdJ33f79sQ6L2O3I2NBCCMuQDni5mLNhJsCw==";
        };
        _tDsDoCHC = {
            "id" = "tDsDoCHC";
            "file" = "FreeMinecraftModels.jar";
            "hash" = "sha512-hV4nNNqmvPh4JSzEQyD7vZ2jzNkhYEFVBuhPqepJuDNa9QiQ1VBtBz4XhcUjVay+9A0sv32BsY8wVP3MZmWIFw==";
        };
        _4iEiUfqv = {
            "id" = "4iEiUfqv";
            "file" = "FreeMinecraftModels.jar";
            "hash" = "sha512-o4XItfWBDYNsUrVB8HNDA7mGmy05+yax1/iD3SFSJS7kO8IoXohmQ59twNNWRaRalAMmNJTvVjSp2CpiQ0aohA==";
        };
    in {
        "zriFAxKo" = _zriFAxKo;
        "LRdf4AW1" = _LRdf4AW1;
        ...
        "paper-1.21.4" = _4iEiUfqv;
        "paper-1.21.5" = _4iEiUfqv;
        "paper-1.21.6" = _4iEiUfqv;
        "paper-1.21.7" = _4iEiUfqv;
        "paper-1.21.8" = _4iEiUfqv;
        ...
        "paper-1.21.9" = _4iEiUfqv;
        "paper-1.21.10" = _4iEiUfqv;
        "paper-1.21.11" = _4iEiUfqv;
        "paper-26.1" = _4iEiUfqv;
        "paper-26.1.1" = _4iEiUfqv;
        "paper-26.1.2" = _4iEiUfqv;
        "paper-26.2" = _4iEiUfqv;
        "paper-26.3" = _4iEiUfqv;
        ...
        "purpur-1.21.4" = _4iEiUfqv;
        "purpur-1.21.5" = _4iEiUfqv;
        "purpur-1.21.6" = _4iEiUfqv;
        "purpur-1.21.7" = _4iEiUfqv;
        "purpur-1.21.8" = _4iEiUfqv;
        ...
        "purpur-1.21.9" = _4iEiUfqv;
        "purpur-1.21.10" = _4iEiUfqv;
        "purpur-1.21.11" = _4iEiUfqv;
        "purpur-26.1" = _4iEiUfqv;
        "purpur-26.1.1" = _4iEiUfqv;
        "purpur-26.1.2" = _4iEiUfqv;
        "purpur-26.2" = _4iEiUfqv;
        "purpur-26.3" = _4iEiUfqv;
        ...
        "spigot-1.21.4" = _4iEiUfqv;
        "spigot-1.21.5" = _4iEiUfqv;
        "spigot-1.21.6" = _4iEiUfqv;
        "spigot-1.21.7" = _4iEiUfqv;
        "spigot-1.21.8" = _4iEiUfqv;
        ...
        "spigot-1.21.9" = _4iEiUfqv;
        "spigot-1.21.10" = _4iEiUfqv;
        "spigot-1.21.11" = _4iEiUfqv;
        "spigot-26.1" = _4iEiUfqv;
        "spigot-26.1.1" = _4iEiUfqv;
        "spigot-26.1.2" = _4iEiUfqv;
        "spigot-26.2" = _4iEiUfqv;
        "spigot-26.3" = _4iEiUfqv;
        ...
        "pkg-2.3.8" = _775l5W3A;
        "pkg-2.3.9" = _5540VrJp;
        "pkg-2.3.10" = _ovqcbANE;
        "pkg-2.3.11" = _d3Bv6rG7;
        "pkg-2.3.12" = _QbCo8oi4;
        "pkg-2.3.13" = _CL0wgxbG;
        "pkg-2.3.14" = _R9bSQoAq;
        "pkg-2.3.15" = _HoPoDqhR;
        "pkg-2.3.16" = _OPVeUACb;
        "pkg-2.3.17" = _zowwaHSE;
        "pkg-2.3.18" = _uK4iBXmD;
        "pkg-2.4.0" = _qdFcipQ8;
        "pkg-2.5.0" = _ChAN52qk;
        "pkg-2.5.2" = _7tOyAQuk;
        "pkg-2.6.0" = _hZ6W5eiK;
        ...
        "pkg-2.9.0" = _CVRV5N8n;
        "pkg-2.9.1" = _XM4L6qCh;
        "pkg-2.10.1" = _AECTt0TU;
        "pkg-2.10.2" = _sQDrL88L;
        "pkg-2.11.0" = _BfBpim5e;
        "pkg-2.11.1" = _KkDbkTXJ;
        "pkg-2.11.2" = _mHvXeBwW;
        "pkg-2.12.0" = _Y3JHMGV2;
        "pkg-2.12.1" = _YDCR11Wy;
        "pkg-2.12.2" = _tDsDoCHC;
        "pkg-2.12.3" = _4iEiUfqv;
        "default" = _4iEiUfqv;
    });
