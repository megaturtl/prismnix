...
let
    versions = (let
        ...
        _bDPrmYPC = {
            "id" = "bDPrmYPC";
            "file" = "Magic_Sorting_System_Reworked_26.3.zip";
            "hash" = "sha512-wQNOLU6VnU2/eYlBXUym25/TNdnHn2V/ekcfleJYmmTzufxB1A+PtjMu21uLC8bn2Hx+t+E1F3j7v0r+gAiJOQ==";
        };
        _jkX2sK3i = {
            "id" = "jkX2sK3i";
            "file" = "magic-sorting-system-reworked-1.20-26.3.jar";
            "hash" = "sha512-ZKkjRQ9HPIDBthU9vCJpl8wGWZCpfjrQoPeSrQKzP+D4i4dI22V0N4QurCo+5IcXeDIiuElSaVmlzDdB02qz8A==";
        };
    in {
        "KxjoXdIV" = _KxjoXdIV;
        "zn8HA4KU" = _zn8HA4KU;
        ...
        "datapack-1.21.9" = _bDPrmYPC;
        "datapack-1.21.11" = _bDPrmYPC;
        "datapack-1.21.1" = _cDgbzuVm;
        "datapack-1.21.3" = _cDgbzuVm;
        "datapack-1.21.10" = _bDPrmYPC;
        "datapack-26.1" = _bDPrmYPC;
        "datapack-26.1.1" = _bDPrmYPC;
        "datapack-26.1.2" = _bDPrmYPC;
        "datapack-26.2" = _bDPrmYPC;
        "datapack-26.3" = _bDPrmYPC;
        ...
        "fabric-1.21.9" = _jkX2sK3i;
        "fabric-1.21.11" = _jkX2sK3i;
        "fabric-1.21.10" = _jkX2sK3i;
        "fabric-26.1" = _jkX2sK3i;
        "fabric-26.1.1" = _jkX2sK3i;
        "fabric-26.1.2" = _jkX2sK3i;
        "fabric-26.2" = _jkX2sK3i;
        "fabric-26.3" = _jkX2sK3i;
        ...
        "quilt-1.21.9" = _jkX2sK3i;
        "quilt-1.21.11" = _jkX2sK3i;
        "quilt-1.21.10" = _jkX2sK3i;
        "quilt-26.1" = _jkX2sK3i;
        "quilt-26.1.1" = _jkX2sK3i;
        "quilt-26.1.2" = _jkX2sK3i;
        "quilt-26.2" = _jkX2sK3i;
        "quilt-26.3" = _jkX2sK3i;
        "forge-1.21.4" = _bInH4ehP;
        "forge-1.21.5" = _lki0CCvj;
        "forge-1.21.6" = _MnoNgBKh;
        "forge-1.21.7" = _sDEkDMCa;
        "forge-1.21.9" = _jkX2sK3i;
        "forge-1.21.11" = _jkX2sK3i;
        "forge-1.21.10" = _jkX2sK3i;
        "forge-26.1" = _jkX2sK3i;
        "forge-26.1.1" = _jkX2sK3i;
        "forge-26.1.2" = _jkX2sK3i;
        "forge-26.2" = _jkX2sK3i;
        "forge-26.3" = _jkX2sK3i;
        "neoforge-1.21.4" = _bInH4ehP;
        "neoforge-1.21.5" = _lki0CCvj;
        "neoforge-1.21.6" = _MnoNgBKh;
        "neoforge-1.21.7" = _sDEkDMCa;
        "neoforge-1.21.9" = _jkX2sK3i;
        "neoforge-1.21.11" = _jkX2sK3i;
        "neoforge-1.21.10" = _jkX2sK3i;
        "neoforge-26.1" = _jkX2sK3i;
        "neoforge-26.1.1" = _jkX2sK3i;
        "neoforge-26.1.2" = _jkX2sK3i;
        "neoforge-26.2" = _jkX2sK3i;
        "neoforge-26.3" = _jkX2sK3i;
        "pkg-1.20" = _KxjoXdIV;
        "pkg-1.20-1" = _zn8HA4KU;
        "pkg-1.20-2" = _CYOCB8Xf;
        "pkg-1.20-2+mod" = _aGF5RyaD;
        "pkg-1.20.3" = _iZpRNeeD;
        "pkg-1.20.3+mod" = _HYQjYKDD;
        "pkg-1.20.5" = _wKhIyNe1;
        "pkg-1.21_experimental" = _vyFfBnGP;
        "pkg-1.20.5+mod" = _TI2V5Hcf;
        "pkg-1.21" = _qEQgp3H0;
        "pkg-1.21+mod" = _cAlDzHUC;
        "pkg-1.21-v2" = _nWZUadI3;
        "pkg-1.21-v2+mod" = _kAqeNPxO;
        "pkg-1.21.2" = _a7aBBniF;
        "pkg-1.21.2+mod" = _fugr3HsZ;
        "pkg-1.21.4" = _p5CuaSrL;
        "pkg-1.21.4+mod" = _bInH4ehP;
        "pkg-1.21.5" = _l5U52tqJ;
        "pkg-1.21.5+mod" = _lki0CCvj;
        "pkg-1.21.6" = _PBggIcFr;
        "pkg-1.21.6+mod" = _MnoNgBKh;
        "pkg-1.21.7" = _BzRmBaV1;
        "pkg-1.21.7+mod" = _sDEkDMCa;
        "pkg-1.21.9" = _WQ3veMps;
        "pkg-1.21.9+mod" = _SI2lc1gu;
        "pkg-1.21.11" = _uvAuGf0w;
        "pkg-1.21.11+mod" = _QCmsui1X;
        "pkg-26.1" = _cDgbzuVm;
        "pkg-26.2" = _oi8Sh51o;
        "pkg-26.3" = _bDPrmYPC;
        "pkg-26.3+mod" = _jkX2sK3i;
        "default" = _jkX2sK3i;
    });
