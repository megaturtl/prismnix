...
let
    versions = (let
        ...
        _bkcjXHsZ = {
            "id" = "bkcjXHsZ";
            "file" = "elytra_green-1.0.1-mc26.3.zip";
            "hash" = "sha512-2SeI91x3Pk+BYwoGk8FTZFMAgqCCXBWlSe6lecf0jxVllAxg3TXX84vzK4vZQKcU7odmnKfG8ax2SrcQrPyUpQ==";
        };
    in {
        "7oqogVRo" = _7oqogVRo;
        "xyqsI3tS" = _xyqsI3tS;
