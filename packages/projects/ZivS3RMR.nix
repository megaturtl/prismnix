...
let
    ...
    in {
        ...
        "pkg-4.0.0-SNAPSHOT-4" = _Bkp4mI9h;
        "pkg-4.0.0-SNAPSHOT-6" = _vYCtra7I;
        "pkg-4.0.0-SNAPSHOT-7" = _F1q2xez6;
        "pkg-4.0.0-SNAPSHOT-8" = _nlSzo0a0;
        "pkg-4.0.0-SNAPSHOT-9" = _K7D9ES5s;
        "pkg-4.0.0-SNAPSHOT-10" = _ncgmkBd5;
        "pkg-4.0.0-SNAPSHOT-11" = _FFznxOhe;
        "pkg-4.0.0-SNAPSHOT-12" = _y97wrXcX;
        "pkg-4.0.0-SNAPSHOT-13" = _YlqfCUG3;
        "pkg-4.0.0-SNAPSHOT-14" = _urCD8Of2;
        "pkg-4.0.0-SNAPSHOT-15" = _ZpEYx1d2;
        "pkg-4.0.0-SNAPSHOT-16" = _3x0QJyas;
        "pkg-4.0.0-SNAPSHOT-17" = _syY7ZgGL;
        "pkg-4.0.0-SNAPSHOT-18" = _xLnaFR0k;
        "pkg-4.0.0-SNAPSHOT-19" = _QjV2IqdY;
        "pkg-4.0.0-SNAPSHOT-20" = _c0iFmeVH;
        "pkg-4.0.0-SNAPSHOT-21" = _YR909Ky0;
        "pkg-4.0.0-SNAPSHOT-22" = _uxO5VJG5;
        "pkg-4.0.0-SNAPSHOT-23" = _SOxNscfW;
        "pkg-4.0.0-SNAPSHOT-24" = _7uXLe2yp;
        "pkg-4.0.0-SNAPSHOT-25" = _mct7yZCo;
        "pkg-4.0.0-SNAPSHOT-26" = _ffvTPSfa;
        "pkg-4.0.0-SNAPSHOT-27" = _n7mBEqrl;
        "pkg-4.0.0-SNAPSHOT-28" = _5zZZ3M6Q;
        "pkg-4.0.0-SNAPSHOT-29" = _Md5Cqx60;
        "pkg-4.0.0-SNAPSHOT-30" = _oaXLQ7ij;
        "pkg-4.0.0-SNAPSHOT-31" = _AGlPmkaq;
        "pkg-4.0.0-SNAPSHOT-32" = _Pd1hmjBU;
        "pkg-4.0.0-SNAPSHOT-33" = _8QhtcsZo;
        "pkg-4.0.0-SNAPSHOT-34" = _UCE78zDj;
        "pkg-4.0.0-SNAPSHOT-35" = _PgCkyrjY;
        "pkg-4.0.0-SNAPSHOT-37" = _EINsG1Pu;
        "pkg-4.0.0-SNAPSHOT-38" = _UXkV9ejW;
        "pkg-4.0.0-SNAPSHOT-39" = _XSqktym8;
        "pkg-4.0.0-SNAPSHOT-40" = _whUpgZN7;
        "pkg-4.0.0-SNAPSHOT-41" = _6MSw4sb1;
        "pkg-4.0.0-SNAPSHOT-42" = _BYAHoIMi;
        "pkg-4.0.0-SNAPSHOT-43" = _sJM3nqCU;
        "pkg-4.0.0-SNAPSHOT-44" = _gpZOUHcF;
        "pkg-4.0.0-SNAPSHOT-45" = _z5KAQDzR;
        "pkg-4.0.0-SNAPSHOT-46" = _q9B2JGCI;
        "pkg-4.0.0-SNAPSHOT-47" = _HXfyYsqb;
        "pkg-4.0.0-SNAPSHOT-48" = _tdHUqZSe;
        "pkg-4.0.0-SNAPSHOT-49" = _FA5NMjlo;
        "pkg-4.0.0-SNAPSHOT-50" = _lwbJSx04;
        "pkg-4.0.0-SNAPSHOT-51" = _X8HvYhUJ;
        "pkg-4.0.0-SNAPSHOT-52" = _mu9CnCFa;
        "pkg-4.0.0-SNAPSHOT-53" = _VpvtzBkF;
        "pkg-4.0.0-SNAPSHOT-54" = _EeUd7rI7;
        "pkg-4.0.0-SNAPSHOT-55" = _PfV7BRo0;
        "pkg-4.0.0-SNAPSHOT-56" = _a7JYhOqo;
        "pkg-4.0.0-SNAPSHOT-57" = _4s9khU32;
        "pkg-4.0.0-SNAPSHOT-58" = _Bp4x3RUH;
        "pkg-4.0.0-SNAPSHOT-59" = _QMmSCff0;
        "pkg-4.0.0-SNAPSHOT-60" = _3ZoQ7qgu;
        "pkg-4.0.0-SNAPSHOT-61" = _vYyAF5Be;
        "pkg-4.0.0-SNAPSHOT-62" = _A3peguCX;
        "pkg-4.0.0-SNAPSHOT-63" = _l33z0HQ8;
        "pkg-4.0.0-SNAPSHOT-64" = _KlvhiEoF;
        "pkg-4.0.0-SNAPSHOT-65" = _PXK5BRcg;
        "pkg-4.0.0-SNAPSHOT-66" = _SjjneOyY;
        "pkg-4.0.0-SNAPSHOT-67" = _DCZ0S1S7;
        "pkg-4.0.0-SNAPSHOT-68" = _OVpvKuzB;
        "pkg-4.0.0-SNAPSHOT-69" = _HHZqHSEp;
        "pkg-4.0.0-SNAPSHOT-70" = _GS3gOjVD;
        "pkg-4.0.0-SNAPSHOT-71" = _J67Ayeag;
        "pkg-4.0.0" = _mcXVZWkX;
        "pkg-4.0.1-SNAPSHOT-73" = _NaswyIFG;
        "pkg-4.0.1-SNAPSHOT-74" = _OsHhj0uV;
        "pkg-4.0.1-SNAPSHOT-75" = _cTkt06Nb;
        "pkg-4.0.1-SNAPSHOT-76" = _2pPN7qBb;
        "pkg-4.0.1" = _dzhLzsfd;
        "pkg-4.0.2-SNAPSHOT-78" = _8QZ9vkQm;
        "pkg-4.0.2-SNAPSHOT-79" = _tumPgu6b;
        "pkg-4.0.2-SNAPSHOT-80" = _YCq98bsI;
        "pkg-4.0.2-SNAPSHOT-81" = _TnBoVzC0;
        "pkg-4.0.2-SNAPSHOT-82" = _egC4avCl;
        "pkg-4.0.2" = _p5G2Yowf;
        "pkg-4.0.3-SNAPSHOT-84" = _oO28Dnuc;
        "pkg-4.0.3-SNAPSHOT-86" = _bcyqPFJJ;
        "pkg-4.0.3-SNAPSHOT-87" = _bsRMWnTk;
        "pkg-4.0.3-SNAPSHOT-88" = _VGN6SYo8;
        "pkg-4.0.3-SNAPSHOT-89" = _qIDvEFLO;
        "pkg-4.0.3-SNAPSHOT-90" = _yUkmDvSF;
        "pkg-4.0.3-SNAPSHOT-91" = _ygdaYoMY;
        "pkg-4.0.3-SNAPSHOT-94" = _DIYwstU1;
        "pkg-4.0.3-SNAPSHOT-95" = _9ysQQ8XK;
        "pkg-4.0.3" = _zO1SIw5U;
        "pkg-4.0.4-SNAPSHOT-98" = _qTP3xA8l;
        "pkg-4.0.4-SNAPSHOT-99" = _sBolnbGW;
