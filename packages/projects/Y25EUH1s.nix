...
let
    versions = (let
        ...
        _iOzIRqSt = {
            "id" = "iOzIRqSt";
            "file" = "blossom-tpa-2.2.15+26.3.jar";
            "hash" = "sha512-WgGDaj4rXl1+6vhJ526f0UgSmQ+9WFsx29H0k1lCGT/P57HJ8BoriXmHcYHaH3LEcW+hKH+nADM2srw8ZozJjA==";
        };
    in {
        "seFgFW16" = _seFgFW16;
        "jsvA4CVf" = _jsvA4CVf;
