...
let
    versions = (let
        ...
        _CM45YxeH = {
            "id" = "CM45YxeH";
            "file" = "first-steps-neoforge-2.10.jar";
            "hash" = "sha512-ctpGiiEjaGItFLT5//AzQ8WSIDMA5Oerswimc1Xq0NsR3ryhGtSXb5JJbvlyvTYh6X9ieHxRedypFKiz2Sd6bQ==";
        };
        _mklUDbw5 = {
            "id" = "mklUDbw5";
            "file" = "first-steps-2.25.jar";
            "hash" = "sha512-KRweLVtEWim0PwdBq2MHzcK8hFDAfsms3TT48YpZr8/MzpAG7fAqQNkGRfStlDK7jFlUCC7z2Jf3gzbkgeF+2Q==";
        };
        _oBaH5iAs = {
            "id" = "oBaH5iAs";
            "file" = "firststeps-forge-1.20-2.25.jar";
            "hash" = "sha512-WbgRF4oAeneEr6AdOvmO14OpYS13tsurRPOCJ1lFnGnJtTLPP+RRf2qot10tBjyWSQcQjqWlRtHBPklAH/a0Fg==";
        };
        _Et2Zv38r = {
            "id" = "Et2Zv38r";
            "file" = "first-steps-2.25.jar";
            "hash" = "sha512-+iQCfWxyqt8vkHh8cWRhlmcKAFIZWhNQv5oEBJv96MzZH3S5ZRfQvZcXOszY2D/sn+jMwEAd2X1Oaj6QvZc4pg==";
        };
        _EvmT36so = {
            "id" = "EvmT36so";
    ...
    in {
        ...
        "fabric-26.3-snapshot-4" = _EvmT36so;
        "fabric-26.3-snapshot-5" = _EvmT36so;
        "fabric-26.3-snapshot-6" = _EvmT36so;
        "fabric-26.3-snapshot-7" = _EvmT36so;
        ...
        "neoforge-1.21" = _CM45YxeH;
        "neoforge-1.21.1" = _CM45YxeH;
        "neoforge-1.21.2" = _CM45YxeH;
        "neoforge-1.21.3" = _CM45YxeH;
        "neoforge-1.21.4" = _CM45YxeH;
        "pkg-0.01" = _aUmXKtjQ;
        "pkg-0.08" = _JV7GwuNz;
        "pkg-0.40" = _cm2U5HHd;
        "pkg-0.50" = _FSlaRA9y;
