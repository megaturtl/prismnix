...
let
    versions = (let
        ...
        _qVMyo8c3 = {
            "id" = "qVMyo8c3";
            "file" = "ctn-2.3.0+26.3.jar";
            "hash" = "sha512-ICqUhuRsWyGbNaVHWt8FrVpGNhhJK7C6OTOblJheJhatyB7H4xh/be4jyM/RYWGiWsgpadzKmrMQednQFPl7Gg==";
        };
    in {
        "FTim4HpC" = _FTim4HpC;
        "oVqg8QgI" = _oVqg8QgI;
        ...
        "fabric-26.3" = _qVMyo8c3;
        "quilt-26.3" = _qVMyo8c3;
