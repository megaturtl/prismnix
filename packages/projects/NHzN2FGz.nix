...
let
    versions = (let
        ...
        _IMv80szS = {
            "id" = "IMv80szS";
            "file" = "rearm-neoforge-2.5.6+1.21.1.jar";
            "hash" = "sha512-nrOIAD6v5h6XNd+tX9gRWm5V/B1ChSFYFP5T2+uut3croRbaRsQ3ORQZaZ8fMwxksqHZFZe1VT+cXFMLtd0PwQ==";
        };
        _35Vu8Fll = {
            "id" = "35Vu8Fll";
            "file" = "rearm-neoforge-2.5.6+26.1.2.jar";
            "hash" = "sha512-ok/RYhmYGy4pmgvicMJELS0JUnVy0Fsh8piw1rWHaRlihyzAHCtBzftQo316ksZY30kFZ7QKJU/1xTPwAtOBMg==";
        };
        _TRhr1myZ = {
            "id" = "TRhr1myZ";
            "file" = "rearm-fabric-2.5.6+1.21.1.jar";
            "hash" = "sha512-8fWoAwZ7V5yjJq17fjQ8JTqkk/e47YBmraW8AloQBwOXA2F0GmryWVDninhSzCL4B8jAqAJeITahgSumWMeTcA==";
        };
        _FVlFGUpH = {
            "id" = "FVlFGUpH";
            "file" = "rearm-neoforge-2.5.6+26.2.jar";
            "hash" = "sha512-vko6Vin1m2XvtUQtlefvxVTyRwYDXZ+DxZj4qvC4f2xwlRTNqp+mSjayr2SpWxqc4Lrhs7Ms9mKtvLwP1GQ99g==";
        };
        _WShSNtBM = {
            "id" = "WShSNtBM";
            "file" = "rearm-fabric-2.5.6+26.1.2.jar";
            "hash" = "sha512-htdhBIWHDWSw7FddLjlHaVrZHXqfFdwvaquZ4KBj4/bCyIygptvAxHZtaApHG77/LWlJO+jTUC5B0Z6jupaSzg==";
        };
        _XAKUgSmq = {
            "id" = "XAKUgSmq";
    ...
    in {
        ...
        "pkg-1.1.2" = _PatryBf0;
        "pkg-1.1.3" = _grcyU2Sz;
        "pkg-2.0.0+1.21.1" = _I7IHZQoG;
        "pkg-2.0.1+1.21.1" = _I9xN38hi;
        "pkg-2.0.2+1.21.1" = _bSLMtw1i;
        "pkg-2.0.3+1.21.1" = _nVLlcN3w;
        "pkg-2.0.4+1.21.1" = _UXIvpFCw;
        "pkg-2.0.5+1.21.1" = _TNxfp90B;
        "pkg-2.0.6+1.21.1" = _hdc6LSNO;
        "pkg-2.0.7+1.21.1" = _HICY2O0r;
        "pkg-2.0.8+1.21.1" = _kbA40LDn;
        "pkg-2.0.9+1.21.1" = _gohda2NR;
        "pkg-2.0.10+1.21.1" = _nlpZqHVG;
        "pkg-2.0.11+1.21.1" = _jEwJHeQx;
        "pkg-2.0.12+1.21.1" = _lcEtJ5lO;
        "pkg-2.1.0+1.21.1" = _mYrdCqus;
        "pkg-2.1.1+1.21.1" = _2dj9Twu5;
        "pkg-2.2.0+1.21.7" = _Wz6e4MpZ;
        "pkg-2.2.0+1.21.1" = _IfCN99ra;
        "pkg-2.2.0+1.21.8" = _g4K2IMB3;
        "pkg-2.2.1+1.21.8" = _EUSdEYJp;
        "pkg-2.2.1+1.21.1" = _gOxxOsUn;
        "pkg-2.2.2+1.21.1" = _RxlHTQUe;
        "pkg-2.2.2+1.21.8" = _JeVDRAWq;
        "pkg-2.2.2+1.21.7" = _rArTwJHu;
        "pkg-2.3.0+1.21.1" = _4PZ4SgJa;
        "pkg-2.3.0+1.21.8" = _dhF4Wtf2;
        "pkg-2.3.1+1.21.1" = _evGU3lha;
        "pkg-2.3.1+1.21.8" = _2WCVhuc5;
        "pkg-2.3.2+1.21.8" = _RDhPnY17;
        "pkg-2.3.2+1.21.1" = _w4xPw1qu;
        "pkg-2.3.3+1.21.8" = _F2TmryKa;
        "pkg-2.3.3+1.21.1" = _TrFHGxFG;
        "pkg-2.3.4+1.21.10" = _R91Ty2ub;
        "pkg-2.3.5+1.21.10" = _4LNkkDHd;
        "pkg-2.3.5+1.21.1" = _c8vkSxmO;
        "pkg-2.4.0+1.21.10" = _A3PzIviU;
        "pkg-2.4.0+1.21.1" = _lRA5vbPY;
        "pkg-2.4.1+1.21.10" = _g2N1st0W;
        "pkg-2.4.1+1.21.1" = _arg8awnn;
        "pkg-2.4.2+1.21.10" = _rwq2vSDy;
        "pkg-2.4.2+1.21.1" = _yLuYtXrq;
        "pkg-2.4.3+1.21.10" = _hOzCYqPq;
        "pkg-2.4.3+1.21.1" = _q15UOClp;
        "pkg-2.4.4+1.21.10" = _IYGD8Z4H;
        "pkg-2.4.4+1.21.1" = _5DtSkOnR;
        "pkg-2.4.5+1.21.1" = _xW9ix66A;
        "pkg-2.4.6+1.21.1" = _2zofuibO;
        "pkg-2.4.6+1.21.10" = _qxas3dd8;
        "pkg-2.4.7+1.21.10" = _QaZGU7Hy;
        "pkg-2.4.8+1.21.1" = _U2UXFiW8;
        "pkg-2.4.8+1.21.10" = _d1Il2b2D;
        "pkg-2.4.9+1.21.10-neoforge" = _ddGW4LCO;
        "pkg-2.4.9+1.21.1-neoforge" = _ZNtGejws;
        "pkg-2.4.9+1.21.1-fabric" = _Nrgatwyo;
        "pkg-2.4.9+1.21.10-fabric" = _dXRXLD2F;
        "pkg-2.4.10+1.21.10-fabric" = _mPPuL7M2;
        "pkg-2.4.10+1.21.1-neoforge" = _pqi7q3Fe;
        "pkg-2.4.11+1.21.1-neoforge" = _4aWikXQ9;
        "pkg-2.4.11+1.21.1-fabric" = _8lgCyJXP;
        "pkg-2.4.11+1.21.10-neoforge" = _f2yv1qDa;
        "pkg-2.4.11+1.21.10-fabric" = _gbY5qkwl;
        "pkg-2.4.12+1.21.10-neoforge" = _Pzh9SLgB;
        "pkg-2.4.12+1.21.11-neoforge" = _Q4bxSqxW;
        "pkg-2.4.12+1.21.1-fabric" = _uOImyZhO;
        "pkg-2.4.12+1.21.1-neoforge" = _JFE2yxSy;
        "pkg-2.4.12+1.21.11-fabric" = _bmQkqhjY;
        "pkg-2.4.12+1.21.10-fabric" = _8O50UCsr;
        "pkg-2.4.13+1.21.1-neoforge" = _aUGTDZfr;
        "pkg-2.4.13+1.21.11-neoforge" = _LvSlRXGZ;
        "pkg-2.4.13+1.21.1-fabric" = _UfeE1Bkk;
        "pkg-2.4.13+1.21.10-fabric" = _TtRar1TR;
        "pkg-2.4.13+1.21.10-neoforge" = _4p4qNuAq;
        "pkg-2.4.13+1.21.11-fabric" = _ia1GxDd0;
        "pkg-2.4.14+1.21.1-neoforge" = _FzTWT74f;
        "pkg-2.4.14+1.21.10-fabric" = _w1zcKxf5;
        "pkg-2.4.14+1.21.1-fabric" = _FB7J6Gxt;
        "pkg-2.4.14+1.21.10-neoforge" = _ro4kAPoL;
        "pkg-2.4.14+1.21.11-neoforge" = _OMIWzUk3;
        "pkg-2.4.14+1.21.11-fabric" = _m0IV4gV7;
        "pkg-2.4.15+1.21.1-neoforge" = _lRj3szCb;
        "pkg-2.4.15+1.21.11-neoforge" = _SyakF6gA;
        "pkg-2.4.15+1.21.1-fabric" = _XicjYIBB;
        "pkg-2.4.15+1.21.11-fabric" = _P8C8w52C;
        "pkg-2.4.16+1.21.11-neoforge" = _IHUgToku;
        "pkg-2.4.16+1.21.11-fabric" = _fQj9JvT2;
        "pkg-2.4.16+1.21.1-fabric" = _HMedWwet;
        "pkg-2.4.16+1.21.1-neoforge" = _Qe8zKm0M;
        "pkg-2.4.17+26.1-neoforge" = _UMYDlXPI;
        "pkg-2.4.17+26.1-fabric" = _1jM9mE8Q;
        "pkg-2.4.18+26.1-fabric" = _uHlOf0GJ;
        "pkg-2.4.18+26.1-neoforge" = _PH8mZMAn;
        "pkg-2.4.19+26.1-neoforge" = _Gr7UJlJf;
        "pkg-2.4.19+26.1-fabric" = _cvGGradq;
        "pkg-2.4.20+26.1-neoforge" = _ItIVI3I0;
        "pkg-2.4.20+26.1-fabric" = _Ql6fP0Rf;
        "pkg-2.5.0+26.1.2-neoforge" = _rO9lwmtp;
        "pkg-2.5.0+26.1.2-fabric" = _DpMIPf7p;
        "pkg-2.5.1+26.2-fabric" = _Nj3wBMme;
        "pkg-2.5.1+26.1.2-neoforge" = _EODGGnOR;
        "pkg-2.5.1+26.1.2-fabric" = _9g2FDA0e;
        "pkg-2.5.2+26.1.2-fabric" = _m5wNvpnD;
        "pkg-2.5.2+26.2-fabric" = _OMp4POyt;
        "pkg-2.5.3+26.1.2-fabric" = _SfnfyUV5;
        "pkg-2.5.3+26.1.2-neoforge" = _FuhtcArm;
        "pkg-2.5.3+26.2-fabric" = _v6rrTOXd;
        "pkg-2.5.4+26.1.2-fabric" = _jJd6n9gC;
        "pkg-2.5.4+26.2-fabric" = _zQvM0roo;
        "pkg-2.5.4+26.1.2-neoforge" = _d16UW9Kw;
        "pkg-2.5.5+26.1.2-neoforge" = _ORCkvyDe;
        "pkg-2.5.5+26.1.2-fabric" = _gJXE9l5s;
        "pkg-2.5.5+26.2-fabric" = _SrLRpGGB;
