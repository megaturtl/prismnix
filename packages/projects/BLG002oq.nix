...
let
    versions = (let
        ...
        _o0cKdDES = {
            "id" = "o0cKdDES";
            "file" = "BetterCraftables_v8.0.0-beta.5_mc26.3snap7.zip";
            "hash" = "sha512-kpJpoBjQoUuDmF6ujsjwe6CEp81AjvpGSd/+08vnbVUs2p6CuSOcwI1NJEjZWi9g9Dq2VcZasjtJV9IhYc/3vw==";
        };
        _2TVngZUM = {
            "id" = "2TVngZUM";
            "file" = "BetterCraftables_v8.0.0-beta6_mc26.3snap7.zip";
            "hash" = "sha512-3yQ7DUaYVymiEMe1Y4fKMCvsXVFahNq4744alsOAeYWoxeQ5FB/d+LKN5vnbAj6DilWlCqY25QRYUmbfkKjMCw==";
        };
        _dT4q7EAx = {
            "id" = "dT4q7EAx";
            "file" = "BetterCraftables_v8.0.0-pre.1_mc26.3snap7-8.zip";
            "hash" = "sha512-UIqF6N+18839GoHURlfNON33JJyHZdU33q4EDqq3zHITF0fxBkSHhkdm7PmCx4OXcHvGSkah3ikKsNZVQQObKg==";
        };
        _rdxf1EiE = {
            "id" = "rdxf1EiE";
            "file" = "BetterCraftables_v8.0.0-pre.2_mc26.3snap7-9.zip";
            "hash" = "sha512-P28WgtX14aPmpRf0Okp1/wteTb0lRcid6qdHQzOtnuGpM3boY47CXCmkPZ6ujbUfBcXQssEuUjnFlzBnohpGbA==";
        };
        _4DXrVirP = {
            "id" = "4DXrVirP";
            "file" = "BetterCraftables_v8.0.0-pre.3_mc26.3snap7-10.zip";
            "hash" = "sha512-0vR6sOmeAqrBJKuPhxU1TUBthGEod0nBwz0LwJfjLRMfSo64wmO0JCO2HrCi321Qwsf1WfOYw4jkHPMwqODfKQ==";
        };
        _vx5haiNv = {
            "id" = "vx5haiNv";
            "file" = "BetterCraftables_v8.0.0-pre.4_mc26.3pre1.zip";
            "hash" = "sha512-wOH/IkOgVYKfRKz/jiIDR4+WtH+rH308JBzJENT/Wmp6e75RlkaieVljkiSxa5+uK8a5q9cGxtneEwkkfY2gSg==";
        };
        _uD1gpiXx = {
            "id" = "uD1gpiXx";
            "file" = "BetterCraftables_v8.0.0-pre.5_mc26pre1-2.zip";
            "hash" = "sha512-THsSiANRE6JX5RqUD4o18HRu6fElFd6amFu8gVREY71TLctGgYInAQ9H1A55OvvpdC0xviIsUow3B+6RjRqNMQ==";
        };
        _hZmtKBOH = {
            "id" = "hZmtKBOH";
            "file" = "BetterCraftables_v8.0.0-pre.6_mc26.3pre1-3.zip";
            "hash" = "sha512-0q2IKySki0U2p5EnZkw3YbsVlVxHZnL+ADMKPk1NIBIpDYEv4xI9PwA1ACb7MKJEAh6NKoOzLahuzkLi0fK6zQ==";
        };
        _ENalpFwf = {
            "id" = "ENalpFwf";
            "file" = "BetterCraftables_v8.0.0-rc.1_mc26.3pre3-rc1.zip";
            "hash" = "sha512-qazLSJgHzkdQEZK1NAiQOn9dbLWgQeywVy5CEjO8NwoFCa0EirnRuTHg+/Q+minLWEOFzv/STdZcwgm3L5y3PQ==";
        };
        _8cqDG4py = {
            "id" = "8cqDG4py";
            "file" = "BetterCraftables_v8.0.0_mc26.3.zip";
            "hash" = "sha512-RTOWLX1Y0WveiXK3HLUdeJSu/erhckyrkZLVwvLVWvS4ltXvpb3KNUTYHbbAQXXHSh1Xb2VMGRqaZEpJp420Pg==";
        };
        _2UkGDTXL = {
            "id" = "2UkGDTXL";
    ...
    in {
        ...
        "datapack-26.3-snapshot-7" = _4DXrVirP;
        "datapack-26.3-snapshot-8" = _4DXrVirP;
        "datapack-26.3-snapshot-9" = _4DXrVirP;
        "datapack-26.3-snapshot-10" = _4DXrVirP;
        "datapack-26.3-pre-1" = _hZmtKBOH;
        "datapack-26.3-pre-2" = _hZmtKBOH;
        "datapack-26.3-pre-3" = _ENalpFwf;
        ...
        "neoforge-26.3" = _2UkGDTXL;
        "pkg-v1.0.0" = _8dyWXSld;
        "pkg-v1.0.1" = _zp2cl57n;
        "pkg-v1.1.0" = _IFKPCplh;
        "pkg-v1.2.0" = _s1Gbrj3A;
        "pkg-v1.2.1" = _aAyVR38Q;
        "pkg-v1.2.2-beta2" = _YwdP07mG;
        "pkg-v1.2.2-beta3" = _MK2LxsUE;
        "pkg-v1.2.2-beta4" = _hco91gr3;
        "pkg-v1.2.2-beta5" = _9mhK91Sv;
        "pkg-v1.2.2" = _HJ038AL7;
        "pkg-v1.2.3" = _lWjnHE6k;
        "pkg-v1.3.0" = _X1Y7xQ80;
        "pkg-v1.3.1-beta1" = _JfsvJVAw;
        "pkg-v1.3.1-beta2" = _KCAxIXl2;
        "pkg-v1.3.0+mod" = _gzNwrXUg;
        "pkg-v1.3.1-beta3" = _umtr8Zag;
        "pkg-v1.3.1-beta4" = _W5nVFzRc;
        "pkg-v1.3.1" = _i6lcODMg;
        "pkg-v1.3.1+mod" = _l96CbrBO;
        "pkg-v1.3.2-beta1" = _BKqHxtLm;
        "pkg-v1.3.2-beta2" = _hiHCaeDY;
        "pkg-v1.3.2-beta3" = _cBV7JmG4;
        "pkg-v1.3.2-beta4" = _ETGLjrr2;
        "pkg-v1.3.2-beta5" = _xbzUXDKv;
        "pkg-v1.3.2-beta6" = _tBn910gh;
        "pkg-v1.3.2-beta7" = _rDqBkuCs;
        "pkg-v1.3.2-beta8" = _gZUikReg;
        "pkg-v1.3.2" = _oVKNbBPK;
        "pkg-v1.3.2+mod" = _Gq66Oc4q;
        "pkg-v1.3.3-beta1" = _qp951R36;
        "pkg-v1.4.0" = _dHHXZCDY;
        "pkg-v1.4.0+mod" = _52SzIfTy;
        "pkg-v1.5.0-beta1" = _yRlC2qey;
        "pkg-v1.5.0-beta2" = _bs1fOVPQ;
        "pkg-v1.5.0-beta3" = _hXm7fzB8;
        "pkg-v1.5.0-beta4" = _FVTGeBJU;
        "pkg-v1.5.0-beta5" = _9BLusguj;
        "pkg-v1.5.0-beta6" = _Axhyufyb;
        "pkg-v1.5.0-beta7" = _cNPHuhen;
        "pkg-v1.5.0-beta8" = _D4pb5Ykr;
        "pkg-v1.5.0-beta9" = _vpSy72Qf;
        "pkg-v1.5.0-beta10" = _AiIwJNpL;
        "pkg-v1.5.0-beta11" = _hCRPw2nc;
        "pkg-v1.5.0-beta12" = _HKtwgor1;
        "pkg-v1.5.0-beta13" = _K5de9SQk;
        "pkg-v1.5.0-beta14" = _Fxjme1kg;
        "pkg-v1.5.0-beta15" = _EFru8DpC;
        "pkg-v1.5.0-beta16" = _UTdLyvJQ;
        "pkg-v1.5.0-beta17" = _cvoRSl75;
        "pkg-v1.5.0" = _4BQ0FuiO;
        "pkg-v1.5.0+mod" = _1EC8lYk5;
        "pkg-v1.5.1" = _jMIxk4HV;
        "pkg-v1.5.1+mod" = _kAhhMD1B;
        "pkg-v1.6.0-beta1" = _sHpFhJdn;
        "pkg-v1.6.0-beta2" = _9Fk2fMeI;
        "pkg-v1.6.0-beta3" = _PIItUzxY;
        "pkg-v1.6.0-beta4" = _K718EC1Z;
        "pkg-v1.6.0-beta5" = _FfLpNkL5;
        "pkg-v1.6.0-beta6" = _44DfZQvw;
        "pkg-v1.6.0-beta7" = _Ej2SaekX;
        "pkg-v1.6.0" = _1OYlqR5R;
        "pkg-v1.6.0+mod" = _dEnb6Omp;
        "pkg-v2.0.0-alpha1" = _WP5L8KNX;
        "pkg-v2.0.0-alpha2" = _Wc8KGPDF;
        "pkg-v2.0.0-alpha3" = _3F8nck3q;
        "pkg-v2.0.0-alpha4" = _H9rIz9Pn;
        "pkg-v2.0.0" = _FA7m92F4;
        "pkg-v2.0.0+mod" = _yuBEsSXw;
        "pkg-v2.1.0-beta1" = _FWvBeWAQ;
        "pkg-v2.1.0-beta2" = _L9OuWhgP;
        "pkg-v2.1.0-beta3" = _UOAgMi9N;
        "pkg-v2.1.0-beta4" = _ZTaigLKB;
        "pkg-v2.1.0-beta5" = _BimewlKB;
        "pkg-v2.1.0-beta6" = _UDK1btyo;
        "pkg-v2.1.0-beta7" = _PX4OOs7r;
        "pkg-v2.1.0-beta8" = _oLYAwqI9;
        "pkg-v2.1.0-beta9" = _p6VDcLrZ;
        "pkg-v2.1.0" = _EoX34Wvk;
        "pkg-v2.1.0+mod" = _MmAQItOF;
        "pkg-v3.0.0-beta1" = _Az7WvwcJ;
        "pkg-v3.0.0" = _lyNdfIZ3;
        "pkg-v3.0.0+mod" = _wkkgPCAm;
        "pkg-v3.1.0-beta1" = _A2551U1a;
        "pkg-v3.1.0-beta2" = _TkpsbXGY;
        "pkg-v3.1.0-beta3" = _5rRmhOSW;
        "pkg-v3.1.0-beta4" = _AVTFYdaM;
        "pkg-v3.1.0-beta5" = _8U73JDsq;
        "pkg-v3.1.0" = _kRkrhars;
        "pkg-v3.1.0+mod" = _JxaUrsvj;
        "pkg-v3.2.0-beta1" = _pj55Emxn;
        "pkg-v3.2.0-beta2" = _a1QP0NcU;
        "pkg-v3.2.0-beta3" = _L1r2RkiB;
        "pkg-v3.2.0-beta4" = _LRzALBxo;
        "pkg-v3.2.0-beta5" = _JyIsK4id;
        "pkg-v3.2.0-beta6" = _TAXY3VJA;
        "pkg-v3.2.0-beta7" = _2mOMBHy5;
        "pkg-v3.2.0-beta8" = _5FbI9BPq;
        "pkg-v3.2.0-beta9" = _A2dnaBCX;
        "pkg-v3.2.0-pre1" = _ZBtadHO2;
        "pkg-v3.2.0-pre2" = _r8zzzdHm;
        "pkg-v4.0.0-pre1" = _JrDbrQLc;
        "pkg-v4.0.0" = _eWLTK0hk;
        "pkg-v4.0.0+mod" = _jEDYwXld;
        "pkg-v4.1.0-beta1" = _teKiUfZT;
        "pkg-v4.1.0-beta2" = _AxTTwQuX;
        "pkg-v4.0.1" = _ZdoqfCgM;
        "pkg-v4.0.1+mod" = _Y2wAKvhd;
        "pkg-v4.1.0-beta3" = _mBExKf75;
        "pkg-v4.1.0-beta4" = _SbMwYfgr;
        "pkg-v4.1.0-beta5" = _84lGMyCz;
        "pkg-v4.0.1+forge" = _18CgVPnY;
        "pkg-v4.1.0-pre1" = _7p6FlRPF;
        "pkg-v4.1.0" = _lrwZsHr9;
        "pkg-v4.1.0+mod" = _UjG6MMCr;
        "pkg-v5.0.0-beta1" = _56Q4MERw;
        "pkg-v5.0.0-beta2" = _dz6YCJJ0;
        "pkg-v5.0.0-pre1" = _a7RZyUEW;
        "pkg-v5.0.0-pre2" = _607RDL69;
        "pkg-v5.0.0" = _XFV7J1MF;
        "pkg-v5.0.0+mod" = _RwWo0WlN;
        "pkg-v5.1.0-beta1" = _dUXAfeQK;
        "pkg-v5.1.0-pre1" = _zJVt2WOr;
        "pkg-v5.1.0" = _2gTxhUGf;
        "pkg-v5.1.0+mod" = _uU4OzXc3;
        "pkg-v5.2.0-beta1" = _zXIM0TvT;
        "pkg-v5.2.0" = _5UyC2MzE;
        "pkg-v5.2.0+mod" = _JQWBkjcm;
        "pkg-v5.3.0-beta1" = _gXmAPN24;
        "pkg-v5.3.0-beta2" = _JsgzsHNQ;
        "pkg-v5.3.0-pre1" = _vYaSN7gN;
        "pkg-v5.3.0" = _gfPji9kc;
        "pkg-v5.3.0+mod" = _qc1jvaLm;
        "pkg-v5.4.0-beta1" = _hsLTeRS1;
        "pkg-v5.4.0-beta2" = _wRxqdVBx;
        "pkg-v5.4.0" = _jefKs79o;
        "pkg-v5.4.0+mod" = _p0MxMOwx;
        "pkg-v6.0.0-beta1" = _PE8buADs;
        "pkg-v6.0.0-beta2" = _z5M1lMae;
        "pkg-v6.0.0-beta3" = _CL8MWVTl;
        "pkg-v6.0.0-beta4" = _niIh3dzT;
        "pkg-v6.0.0-beta5" = _AtsJj8OT;
        "pkg-v6.0.0-beta6" = _HzfmVujC;
        "pkg-v6.0.0-pre1" = _VBa2Hd7C;
        "pkg-v6.0.0-pre2" = _kQACpeLA;
        "pkg-v6.0.0-pre3" = _AU0nHzjL;
        "pkg-v6.0.0" = _1Bt3gNTk;
        "pkg-v6.0.0+mod" = _ktebCoMX;
        "pkg-v6.0.1+mod" = _SQ1jDZAY;
        "pkg-v6.1.0-beta1" = _wULuFERg;
        "pkg-v6.1.0-beta2" = _y01mjQVs;
        "pkg-v6.1.0-beta3" = _RZtXzKgL;
        "pkg-v6.1.0-beta4" = _3kHqS4MO;
        "pkg-v6.1.0-beta5" = _IKD010GK;
        "pkg-v6.1.0-beta6" = _lsfDYi7p;
        "pkg-v6.1.0-beta7" = _1ss9Tugi;
        "pkg-v6.1.0-beta8" = _TpOV32DY;
        "pkg-v6.1.0-pre1" = _Mn1WgSzb;
        "pkg-v6.1.0" = _N2SGJXj4;
        "pkg-v6.1.0+mod" = _Lv4DYNIf;
        "pkg-v6.2.0-beta1" = _PKDKjekm;
        "pkg-v6.2.0" = _NTFQxi1j;
        "pkg-v6.2.0+mod" = _F1Zml3ji;
        "pkg-v6.3.0-beta1" = _F56Y6YP3;
        "pkg-v6.3.0-beta2" = _UAM7obQd;
        "pkg-v6.3.0" = _ztHeiwCK;
        "pkg-v6.3.0+mod" = _XIxMaw0w;
        "pkg-v7.0.0-beta1" = _HMxCx5eo;
        "pkg-v7.0.0-beta2" = _R7Pa1CdZ;
        "pkg-v7.0.0-beta3" = _3CLbrbAX;
        "pkg-v6.3.1" = _GALa3ftH;
        "pkg-v6.3.1+mod" = _yvkEHWcc;
        "pkg-v7.0.0-beta4" = _xqLiouWW;
        "pkg-v7.0.0-beta5" = _6Hx3ehxb;
        "pkg-v7.0.0-pre1" = _LAPqqP8x;
        "pkg-v7.0.0-pre2" = _LRGfRVHJ;
        "pkg-v7.0.0-pre3" = _67qyzT2m;
        "pkg-v7.0.0" = _FeQBY46U;
        "pkg-v7.0.0+mod" = _dtM1rmPM;
        "pkg-v7.0.1+mod" = _jTx2rvSB;
        "pkg-v7.1.0-beta.1" = _otGPlQks;
        "pkg-v7.0.2" = _5XD8dMxh;
        "pkg-v7.0.2+mod" = _kHMuSrsi;
        "pkg-v7.1.0-beta.2" = _cRGmbDWj;
        "pkg-v7.1.0-beta.3" = _D9aowOJm;
        "pkg-v7.1.0-beta.4" = _ZBz2erpa;
        "pkg-v7.1.0-beta.5" = _mwi4c7tS;
        "pkg-v7.1.0-beta.6" = _qCyiAzzH;
        "pkg-v7.1.0-pre.1" = _MyaeGUr5;
        "pkg-v7.1.0-pre.2" = _d70pAMAm;
        "pkg-v7.1.0-pre.3" = _7XP8fv2t;
        "pkg-v7.1.0" = _FdAmyxo3;
        "pkg-v7.1.0+mod" = _FI4OjctA;
        "pkg-v7.2.0-beta.1" = _uuJOIE4H;
        "pkg-v7.2.0-beta.2" = _jUIrx5eQ;
        "pkg-v7.2.0" = _ozXOJdxy;
        "pkg-v7.2.0+mod" = _hLDnMwCs;
        "pkg-v7.3.0-beta.1" = _K2f6FgWd;
        "pkg-v7.3.0-beta.2" = _nV7Fax7x;
        "pkg-v7.3.0-beta.3" = _1ZEF9tZb;
        "pkg-v7.3.0-beta.4" = _aV3Lpxf1;
        "pkg-v7.3.0-beta.5" = _qAhT5LAt;
        "pkg-v7.3.0" = _9Mtmvxw8;
        "pkg-v7.3.0+mod" = _a7mcP0OU;
        "pkg-v8.0.0-beta.1" = _7PBAbJNW;
        "pkg-v8.0.0-beta.2" = _vXf1mrGk;
        "pkg-v7.4.0-pre.1" = _OPnNKcUS;
        "pkg-v8.0.0-beta.3" = _LAFUhvAB;
        "pkg-v7.4.0" = _pkC8ZQ1X;
        "pkg-v7.4.0+mod" = _tZTZRcZo;
        "pkg-v8.0.0-beta.4" = _f564oVJb;
        "pkg-v8.0.0-beta.5" = _o0cKdDES;
        "pkg-v8.0.0-beta.6" = _2TVngZUM;
        "pkg-v8.0.0-pre.1" = _dT4q7EAx;
        "pkg-v8.0.0-pre.2" = _rdxf1EiE;
        "pkg-v8.0.0-pre.3" = _4DXrVirP;
        "pkg-v8.0.0-pre.4" = _vx5haiNv;
        "pkg-v8.0.0-pre.5" = _uD1gpiXx;
        "pkg-v8.0.0-pre.6" = _hZmtKBOH;
