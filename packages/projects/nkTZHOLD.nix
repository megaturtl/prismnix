...
let
    versions = (let
        ...
        _nBiAgIKy = {
            "id" = "nBiAgIKy";
            "file" = "FactoryAPI-1.20.1-2.2.9-forge.jar";
            "hash" = "sha512-EFGD1aPylhhNBlSo5u7V4MhXoTC+nnMJvvVf0unhX+sHNrvbQqvj9acpnHPZpJ2XIx3kTfXdCPz6+gHfYfIOQA==";
        };
        _reTxWo6c = {
            "id" = "reTxWo6c";
            "file" = "FactoryAPI-1.20.1-2.2.9-fabric.jar";
            "hash" = "sha512-ml2dZJYxa8ibbQyuSX2pQHdp9B3N5AM9Jboen5qALCvAX4dCo3jCt7D5ROxOB/ZTMVKFvEPU1gWLHHkxUEkPGw==";
        };
        _pEqi45FF = {
            "id" = "pEqi45FF";
            "file" = "FactoryAPI-1.20.4-2.2.9-fabric.jar";
            "hash" = "sha512-iZ2RSXfcT7Pe+obAuzv2cY+GSkF1+rWFcJCIq+/0QjBRMAgwxYiciiwcUWofwaqSNytJGHdqA18i/vrHEbu3tQ==";
        };
        _UiPY0Zsz = {
            "id" = "UiPY0Zsz";
            "file" = "FactoryAPI-1.20.4-2.2.9-forge.jar";
            "hash" = "sha512-rQ7kW2Fdh0xE4WEtnWjZvfCM6N7imbsRe0VL6p6ll0t8Zw51fMxJhhtTtVn6AaC0ns3VF3R378OGGjz01DmaOA==";
        };
        _BDMEva1F = {
            "id" = "BDMEva1F";
            "file" = "FactoryAPI-1.20.4-2.2.9-neoforge.jar";
            "hash" = "sha512-CCuqu4F/yHioSxDI9yOgMrvvp3DmitTYy0NuUgMtYv6FRq4fY9pBGEYD17+NTWnT2bskT8XLWPvk7cS5ES92WA==";
        };
        _Shu42hae = {
            "id" = "Shu42hae";
            "file" = "FactoryAPI-1.21.1-2.2.9-neoforge.jar";
            "hash" = "sha512-IN5eInhDlas//g+Lzo51+l7K4V5KFxc36vklXGHmyzhypw2489gloPsMB+26uqMZgOc/WcxVWDOMCB6tpb2MRg==";
        };
        _Lbt5eiov = {
            "id" = "Lbt5eiov";
            "file" = "FactoryAPI-1.21.1-2.2.9-forge.jar";
            "hash" = "sha512-0wd5lGsteTtPgxxxgoNNoUW5YQZbF2vTOhufePhSARo4UCb16fmorlRAJPi3dAsBdBR9mL1pXRGZqp6bLpM/ng==";
        };
        _xzTMasRE = {
            "id" = "xzTMasRE";
            "file" = "FactoryAPI-1.21.1-2.2.9-fabric.jar";
            "hash" = "sha512-6AnQkfduW2P7+pY1sPCoRCwL6i7XE+p/mFFuF6nHkea43eSp80l+neGseXqLG0t3+prDKuqjAS80Qu9b++FazQ==";
        };
        _lurtUvkI = {
            "id" = "lurtUvkI";
            "file" = "FactoryAPI-1.21.10-2.2.9-neoforge.jar";
            "hash" = "sha512-UalnI77pGs1dWgTx3yWZvyu4NwVFEESsMO2iSGHL73VS7tW4PphCkA5eR+Pp8zKXR49FwAcGFiZtDiQ44F1BkA==";
        };
        _F9wHyaRK = {
            "id" = "F9wHyaRK";
            "file" = "FactoryAPI-1.21.10-2.2.9-forge.jar";
            "hash" = "sha512-BN8yNIz3MA7Uq5l7KD4gSzqI8jce0lhBt5QKiDOUbBkSs0lawgiq2WNuy8PsZPihxB+u9OK6vFc5flI+VA6VeQ==";
        };
        _fyLEr9pq = {
            "id" = "fyLEr9pq";
            "file" = "FactoryAPI-1.21.10-2.2.9-fabric.jar";
            "hash" = "sha512-GyOK7R+qKrVIEtnRuY+l1MPp0hfnFN7vApnH97rBFLeq2H+wvx3fP/LNs/Giz88Oks8vBSaGx5r4Gahwqmy8Sw==";
        };
        _Ehh3QSSE = {
            "id" = "Ehh3QSSE";
            "file" = "FactoryAPI-1.21.11-2.2.9-forge.jar";
            "hash" = "sha512-DWGQP0wi0NC3/1j0RNBGS7l6WC+ot33zMSpfP9roXk8xDdQ0e2xIxrJoi60yOa+lF1gxzOcwYUPMOhLQG/gTBg==";
        };
        _DzDNKcAm = {
            "id" = "DzDNKcAm";
            "file" = "FactoryAPI-1.21.11-2.2.9-fabric.jar";
            "hash" = "sha512-qZ5NV2NkFa2yzue+AVpQUovHaRis2Rndsj7eJ32WfR+U9u3E3km77RoGD7S5QYJX/i3ZkmklZtrz2OtMiBHyiA==";
        };
        _yT1lwPeT = {
            "id" = "yT1lwPeT";
            "file" = "FactoryAPI-1.21.11-2.2.9-neoforge.jar";
            "hash" = "sha512-jsn2ace4ZUuWLVzB8RUZ5vwYh2/VvEkDENJ/g9wj6EvVd7UX4AyB5wIiNEOJJeO2KZ6vIMGqs5GTPuNNoANkCg==";
        };
        _9u1pJHcR = {
            "id" = "9u1pJHcR";
            "file" = "FactoryAPI-1.21.3-2.2.9-forge.jar";
            "hash" = "sha512-oozB3XxJF5quq2UvRs8ccqJ10RRF0gQ58WW0MMPqfUz4HE4/VWnHMdiO3Agicp9jO8yKa+STmMFesDLD+lyyog==";
        };
        _K7LTsmQC = {
            "id" = "K7LTsmQC";
            "file" = "FactoryAPI-1.21.3-2.2.9-fabric.jar";
            "hash" = "sha512-cNHhohXz7xggNTc7FlIwJBwrW6l8I2S+YNy1LwTw3TwZ6u4GnaMFZ1rescCgCnBfalJHGz04SGmszme/7EPWXg==";
        };
        _ZJ2V7ppR = {
            "id" = "ZJ2V7ppR";
            "file" = "FactoryAPI-1.21.3-2.2.9-neoforge.jar";
            "hash" = "sha512-I1a/a1X/6NadYtiDGYb+4l98q0fQ81oc0XTNdDo1/8nQbM9m8/yENQTAkJMon7mK1bNFMJ6g3rwTx+n1oGKrLQ==";
        };
        _jPzflav1 = {
            "id" = "jPzflav1";
            "file" = "FactoryAPI-1.21.4-2.2.9-fabric.jar";
            "hash" = "sha512-uMDLwgtSFt4Hbcba+IxXHNvGt/iSb1D2f5hHjOzl9F1wGZfXGEoWIlZjdOARkfKFLE44ZXP/dYN0JnuAudpXbQ==";
        };
        _TSdVz8t8 = {
            "id" = "TSdVz8t8";
            "file" = "FactoryAPI-1.21.4-2.2.9-forge.jar";
            "hash" = "sha512-Bv/Z3L4XDYi7YLeYZP2vqZu7fGSQdt7rNgAEpV0SM2zc/UvPNT/aB7rowoG92nH8xsKgEwbWljRGzs7VbFHuXg==";
        };
        _2SUZ7BkK = {
            "id" = "2SUZ7BkK";
            "file" = "FactoryAPI-1.21.4-2.2.9-neoforge.jar";
            "hash" = "sha512-Q1nY3XWx/J4YODHuEKlwQ07fqnUIYzdFR4xSj8Em9M2o5S82TY2FtvKeUqxDrfOlX5MmyrOOiYgFaw/mAADRwQ==";
        };
        _wSUR4S2l = {
            "id" = "wSUR4S2l";
            "file" = "FactoryAPI-1.21.5-2.2.9-neoforge.jar";
            "hash" = "sha512-+dszuBg37b2HVbQZDpEbOo+qupq1LJacBwdKQBAq5W8s5q7QEUEIK8n6q4237ui+CeEydb0PPFozUbZiV8zfzg==";
        };
        _bG9VjEld = {
            "id" = "bG9VjEld";
            "file" = "FactoryAPI-1.21.5-2.2.9-forge.jar";
            "hash" = "sha512-54cfNGP+z6pwoodbWdbtlq8fGt+8GOuZwc7MOwEECG2rExWEVJpInMLrmE/B0SfRzyCtVIGjhPOS9gaXcvFz4A==";
        };
        _WX8x6gDR = {
            "id" = "WX8x6gDR";
            "file" = "FactoryAPI-1.21.5-2.2.9-fabric.jar";
            "hash" = "sha512-IjaIKe66awZdjEao3ziMS3Y4hbKcDnpGPSDDL5wKY9ik8WCWE3jLlvplaSF00WkwTxbBZCEw9aBvPM5xD+x3Ig==";
        };
        _GXRfAaC1 = {
            "id" = "GXRfAaC1";
            "file" = "FactoryAPI-1.21.8-2.2.9-forge.jar";
            "hash" = "sha512-A8OFPXC5xDMsxjdtHfVY4XrR4vHdHu/VPL9nd6r+VkjChvi9mu6uS5cKWO/PDzNS8N0HaANCSlE5/QzPQEIuyQ==";
        };
        _2gJ5sAAe = {
            "id" = "2gJ5sAAe";
            "file" = "FactoryAPI-1.21.8-2.2.9-neoforge.jar";
            "hash" = "sha512-KtXwVn/syEY6dbRfNlqznVYF+AuXSUQLxdKhDozaHXZcD+8uLGIZSILhmXoo9eT9Jb6HCxUZo5+HSqMrv0e1Zg==";
        };
        _fnfvs4Cw = {
            "id" = "fnfvs4Cw";
            "file" = "FactoryAPI-1.21.8-2.2.9-fabric.jar";
            "hash" = "sha512-JLaocxVjIDptdPp5jm6Zo5XTyyPCe/PEvwgsevkFiG3yCvCZ8xkbtC90eAbeyf48a+DML7+vrHxuBFjKSY3E7A==";
        };
        _ej8ERYhM = {
            "id" = "ej8ERYhM";
            "file" = "FactoryAPI-26.1.2-2.2.9-forge.jar";
            "hash" = "sha512-t1ccQCnU5i4QmyYBWwG6qSMGQCF4RENh8AavqjegairYqAIfMJPITeg8/KPSz7yZ5EZqvAymqjohr8z8WIuFSQ==";
        };
        _JFmQIKph = {
            "id" = "JFmQIKph";
            "file" = "FactoryAPI-26.1.2-2.2.9-fabric.jar";
            "hash" = "sha512-4PVLA724ymeUb3ph+5N1IaRC8qDewQOWhHXNxI+h37HG0bWkNw8HkiJ1w8FUuO+cGTfJ/HAPOErjUII37c27eQ==";
        };
        _QDU81S2S = {
            "id" = "QDU81S2S";
            "file" = "FactoryAPI-26.1.2-2.2.9-neoforge.jar";
            "hash" = "sha512-PLpXSZRVX1vpWliFAf6jUbh3ex9z3A+U1l6uFvBjoT0tL0Pek6J/Bu4VQanT4lLCFHfFPZ6amjNl/u6XRSIosg==";
        };
    in {
        "9Hj6cXa2" = _9Hj6cXa2;
        "TZmcX7Qo" = _TZmcX7Qo;
        ...
        "fabric-1.20.1" = _reTxWo6c;
        "fabric-1.16.5" = _CQnMvMMd;
        "fabric-1.20.2" = _p4HCPtmq;
        "fabric-1.18.2" = _H9nc4ktF;
        "fabric-1.20.3" = _GeOFWRoP;
        "fabric-1.20.4" = _pEqi45FF;
        "fabric-1.21.4" = _jPzflav1;
        "fabric-1.21.2" = _8YcuDGoO;
        "fabric-1.21.3" = _K7LTsmQC;
        "fabric-1.21" = _pzPZS6oB;
        "fabric-1.21.1" = _xzTMasRE;
        "fabric-1.20" = _xMa7vJgz;
        "fabric-1.21.5" = _WX8x6gDR;
        "fabric-1.21.6" = _2bbmGllK;
        "fabric-1.21.7" = _2bbmGllK;
        "fabric-1.21.8" = _fnfvs4Cw;
        "fabric-1.21.10" = _fyLEr9pq;
        "fabric-1.21.11" = _DzDNKcAm;
        "fabric-26.1.2" = _JFmQIKph;
        "forge-1.19.2" = _6aY3veBm;
        "forge-1.19.3" = _zEN8LIG3;
        "forge-1.19.4" = _hNX4fLZe;
        "forge-1.20.1" = _nBiAgIKy;
        "forge-1.16.5" = _d43uq2TC;
        "forge-1.20.2" = _3yrpbMnX;
        "forge-1.18.2" = _Tln7LprK;
        "forge-1.20.3" = _RE2jpA74;
        "forge-1.20.4" = _UiPY0Zsz;
        "forge-1.21.4" = _TSdVz8t8;
        "forge-1.21.3" = _9u1pJHcR;
        "forge-1.21" = _3VAHB9Oe;
        "forge-1.21.1" = _Lbt5eiov;
        "forge-1.20" = _TbUA8M2q;
        "forge-1.21.5" = _bG9VjEld;
        "forge-1.21.8" = _GXRfAaC1;
        "forge-1.21.10" = _F9wHyaRK;
        "forge-1.21.11" = _Ehh3QSSE;
        "forge-26.1.2" = _ej8ERYhM;
        ...
        "neoforge-1.21.4" = _2SUZ7BkK;
        "neoforge-1.21.2" = _CuPAGqk7;
        "neoforge-1.21.3" = _ZJ2V7ppR;
        "neoforge-1.21" = _4D1JD0Km;
        "neoforge-1.21.1" = _Shu42hae;
        "neoforge-1.20.3" = _x8wzC5Gu;
        "neoforge-1.20.4" = _BDMEva1F;
        "neoforge-1.21.5" = _wSUR4S2l;
        "neoforge-1.21.6" = _de6ZSY5M;
        "neoforge-1.21.7" = _de6ZSY5M;
        "neoforge-1.21.8" = _2gJ5sAAe;
        "neoforge-1.21.10" = _lurtUvkI;
        "neoforge-1.21.11" = _yT1lwPeT;
        "neoforge-26.1.2" = _QDU81S2S;
        "pkg-0.0.1-forge" = _9Hj6cXa2;
        "pkg-0.0.1-fabric" = _TZmcX7Qo;
        "pkg-0.0.1-quilt" = _CiOR9KKq;
        "pkg-0.0.1-common" = _STMoHiEt;
        "pkg-0.0.2" = _HyIeX58L;
        "pkg-0.0.3" = _Q6DWZ5yj;
        "pkg-0.0.4" = _wOZ6SsBV;
        "pkg-0.0.5" = _3FPEajRS;
        ...
        "pkg-0.1.0" = _MGfDH7Nl;
        "pkg-0.1.1" = _xc1xZyrW;
        "pkg-0.1.2-forge" = _1Ec4JP9A;
        "pkg-0.1.2-common" = _wdqoV8Ok;
        "pkg-0.1.2-fabric" = _G7ZiuxDu;
        "pkg-0.1.2-quilt" = _gQWIGi0z;
        "pkg-0.1.3-common" = _7CNs9v3f;
        "pkg-0.1.3-forge" = _dFAZFLZ0;
        "pkg-0.1.3-fabric" = _4CzL5aR1;
        "pkg-0.1.3-quilt" = _efQW8C4T;
        "pkg-0.1.4-common" = _QeC2IYH3;
        "pkg-0.1.4-forge" = _uuuyyOns;
        "pkg-0.1.4-quilt" = _pCidqxrM;
        "pkg-0.1.4-fabric" = _7JCeJMom;
        "pkg-1.19.3-0.1.6-forge" = _zEN8LIG3;
        "pkg-1.19.3-0.1.6-quilt" = _xEssDtt6;
        "pkg-1.19.3-0.1.6-fabric" = _cUQFMtOq;
        "pkg-1.19.2-0.1.6.1-forge" = _G3aYjHfi;
        "pkg-1.19.2-0.1.6.1-fabric" = _ZHxz6hy0;
        "pkg-1.19.2-0.1.6.1-quilt" = _ygDmuh4Q;
        "pkg-1.19.4-0.1.6.1" = _wxPR4X4O;
        "pkg-1.20.1-0.1.7+fabric" = _FZzmLkJD;
        "pkg-1.20.1-0.1.7+forge" = _1PHBhtrv;
        "pkg-1.19.4-0.1.7+fabric" = _YiK08AHg;
        "pkg-1.19.4-0.1.7+forge" = _jsfOjZOL;
        "pkg-1.16.5-0.1.7+fabric" = _772t9UgX;
        "pkg-1.16.5-0.1.7+forge" = _NfPuvOAD;
        "pkg-1.16.5-0.1.8+forge" = _PTpomNX4;
        "pkg-1.16.5-0.1.8+fabric" = _a7S1XRe7;
        "pkg-1.20.1-0.1.8+fabric" = _y9FaOw36;
        "pkg-1.20.1-0.1.8+forge" = _doner2oa;
        "pkg-1.19.4-0.1.8+fabric" = _qiyAMWQG;
        "pkg-1.19.4-0.1.8+forge" = _wCumJ5S3;
        "pkg-1.19.2-0.1.8+forge" = _IqXwnMQB;
        "pkg-1.19.2-0.1.8+fabric" = _Oow6aE1c;
        "pkg-1.20.1-0.1.9+forge" = _QeyrZkU0;
        "pkg-1.20.1-0.1.9+fabric" = _had6ZxkA;
        "pkg-1.20.1-1.0+forge" = _icDEuv8V;
        "pkg-1.20.1-1.0+fabric" = _uumIQfwk;
        "pkg-1.20.1-1.1+forge" = _RXBhENT4;
        "pkg-1.20.1-1.1+fabric" = _b4IPhDQj;
        "pkg-1.20.1-1.1.1+fabric" = _fNXaaioB;
        "pkg-1.20.1-1.1.1+forge" = _AsDrQXCp;
        "pkg-1.20.1-1.1.2+fabric" = _ih8dFHoH;
        "pkg-1.20.1-1.1.2+forge" = _iJzeuFSD;
        "pkg-1.20.1-1.1.3+forge" = _Ju5E16sG;
        "pkg-1.20.1-2.0+fabric" = _lG2pcG2F;
        "pkg-1.20.1-2.0+forge" = _j030JMh1;
        "pkg-1.20.1-2.0.1+fabric" = _e60j5w59;
        "pkg-1.20.1-2.0.1+forge" = _v3nXE3UL;
        "pkg-1.16.5-2.0+fabric" = _CQnMvMMd;
        "pkg-1.16.5-2.0+forge" = _d43uq2TC;
        "pkg-1.19.4-2.0+fabric" = _8FVvG6eN;
        "pkg-1.19.4-2.0+forge" = _hNX4fLZe;
        "pkg-1.19.2-2.0+fabric" = _v6fyPN4z;
        "pkg-1.19.2-2.0+forge" = _6aY3veBm;
        "pkg-1.20.2-2.0+fabric" = _d0h01avK;
        "pkg-1.20.2-2.0+forge" = _69q1rvXM;
        "pkg-1.18.2-2.0+fabric" = _H9nc4ktF;
        "pkg-1.18.2-2.0+forge" = _Tln7LprK;
        "pkg-1.20.2-2.0.1+fabric" = _OmlEqDLh;
        "pkg-1.20.2-2.0.1+forge" = _c0BYVUMW;
        "pkg-1.20.1-2.0.2+fabric" = _WtJfQ3QJ;
        "pkg-1.20.1-2.0.2+forge" = _LOYbA7BG;
        "pkg-1.20.2-2.1+fabric" = _Qf6iIJsk;
        "pkg-1.20.2-2.1+forge" = _pZLmzaHk;
        "pkg-1.20.1-2.1+fabric" = _S6UKWUu4;
        "pkg-1.20.1-2.1+forge" = _UwXQKoUI;
        "pkg-1.20.4-2.1+fabric" = _RdiH9iH0;
        "pkg-1.20.4-2.1+forge" = _upmNeOht;
        "pkg-1.20.2-2.1.1+forge" = _3yrpbMnX;
        "pkg-1.20.2-2.1.1+fabric" = _p4HCPtmq;
        "pkg-1.20.1-2.1.1+forge" = _Ps4idDdx;
        "pkg-1.20.1-2.1.1+fabric" = _D60pZUut;
        "pkg-1.20.4-2.1.1+fabric" = _mKXYfFQl;
        "pkg-1.20.1-2.1.2+fabric" = _fDrIeNA6;
        "pkg-1.20.1-2.1.2+forge" = _FYSWYJaT;
        "pkg-1.20.4-2.1.1+forge" = _l0Fy0CRl;
        "pkg-1.20.4-2.1.2+forge" = _LGxfEMDt;
        "pkg-1.20.4-2.1.2+fabric" = _nIUH8JM9;
        "pkg-1.20.1-2.1.3+fabric" = _wBl3sIAK;
        "pkg-1.20.1-2.1.3+forge" = _cC2Csmbg;
        "pkg-1.20.4-2.1.3+fabric" = _XhfQLEzI;
        "pkg-1.20.4-2.1.3+forge" = _mMmLmoqF;
        "pkg-1.20.1-2.1.4+forge" = _74eJMYgR;
        "pkg-1.20.1-2.1.4+fabric" = _Z9jBmGZS;
        "pkg-1.21.4-2.2+neoforge" = _8Pt1ZLuk;
        "pkg-1.21.4-2.2+forge" = _bZ8T2Q0n;
        "pkg-1.21.4-2.2+fabric" = _dyG3AcfU;
        "pkg-1.21.3-2.2+neoforge" = _eKBsJvf3;
        "pkg-1.21.3-2.2+forge" = _E7NDLgcz;
        "pkg-1.21.3-2.2+fabric" = _xDSWBBrZ;
        "pkg-1.21.1-2.2+fabric" = _cme0I8wW;
        "pkg-1.21.1-2.2+neoforge" = _zUsyQBfs;
        "pkg-1.21.1-2.2+forge" = _uhOea5pw;
        "pkg-1.20.4-2.2+fabric" = _T3Tpesse;
        "pkg-1.20.4-2.2+forge" = _h7o58ces;
        "pkg-1.20.4-2.2+neoforge" = _OBCd5gl8;
        "pkg-1.20.1-2.2+forge" = _Tso9P3qO;
        "pkg-1.20.1-2.2+fabric" = _KpmZS8S4;
        "pkg-1.21.3-2.2.3+forge" = _tZayf2Ff;
        "pkg-1.21.4-2.2.3+forge" = _GUCjksW7;
        "pkg-1.21.3-2.2.3+neoforge" = _UcnumodH;
        "pkg-1.21.3-2.2.3+fabric" = _LC56dTkx;
        "pkg-1.21.4-2.2.3+fabric" = _2b1snlZU;
        "pkg-1.21.1-2.2.3+neoforge" = _qvElsf0x;
        "pkg-1.21.4-2.2.3+neoforge" = _bf4TKVWS;
        "pkg-1.21.1-2.2.3+forge" = _sAh5z8th;
        "pkg-1.20.4-2.2.3+forge" = _sV9oZkJ2;
        "pkg-1.21.1-2.2.3+fabric" = _bh9LuTSY;
        "pkg-1.20.4-2.2.3+neoforge" = _BeT428lw;
        "pkg-1.20.4-2.2.3+fabric" = _WhRb71Aj;
        "pkg-1.20.1-2.2.3+forge" = _HLCK8Z99;
        "pkg-1.20.1-2.2.3+fabric" = _deiUxOvt;
        "pkg-1.21.4-2.2.3.2510.0+neoforge" = _hmvy4CjP;
        "pkg-1.21.3-2.2.3.2510.0+neoforge" = _V7vVFOkz;
        "pkg-1.21.5-2.2.3.2514.0+neoforge" = _oSS17jGJ;
        "pkg-1.21.5-2.2.3.2514.0+forge" = _rcjCBHif;
        "pkg-1.21.5-2.2.3.2514.0+fabric" = _NmyWDHww;
        "pkg-1.21.4-2.2.3.2514.0+neoforge" = _1DnqpNok;
        "pkg-1.21.4-2.2.3.2514.0+forge" = _S8GQivSG;
        "pkg-1.21.4-2.2.3.2514.0+fabric" = _LVQsvczj;
        "pkg-1.21.3-2.2.3.2514.0+neoforge" = _wkJYsYnl;
        "pkg-1.21.3-2.2.3.2514.0+forge" = _2j3PnLJu;
        "pkg-1.21.3-2.2.3.2514.0+fabric" = _7fBhToJo;
        "pkg-1.21.1-2.2.3.2514.0+neoforge" = _MsKlcDFP;
        "pkg-1.21.1-2.2.3.2514.0+forge" = _1alnrED9;
        "pkg-1.21.1-2.2.3.2514.0+fabric" = _qgnxJwEd;
        "pkg-1.20.4-2.2.3.2514.0+neoforge" = _I3sW18P3;
        "pkg-1.20.4-2.2.3.2514.0+fabric" = _BIHb0r46;
        "pkg-1.20.4-2.2.3.2514.0+forge" = _Je4YDlxa;
        "pkg-1.20.1-2.2.3.2514.0+forge" = _1WmlhZfr;
        "pkg-1.20.1-2.2.3.2514.0+fabric" = _tXC5OTbY;
        "pkg-1.21.3-2.2.3.2514.1+neoforge" = _8m3T67iN;
        "pkg-1.21.5-2.2.3.2514.1+neoforge" = _anaOIb9v;
        "pkg-1.21.4-2.2.3.2514.1+neoforge" = _48nSUp7u;
        "pkg-1.21.5-2.2.3.2514.1+fabric" = _48genjZO;
        "pkg-1.21.5-2.2.3.2514.1+forge" = _OOOjFt0b;
        "pkg-1.21.4-2.2.3.2514.1+fabric" = _vxYmxAYc;
        "pkg-1.21.3-2.2.3.2514.1+forge" = _WJcazDU2;
        "pkg-1.21.4-2.2.3.2514.1+forge" = _6UAvdNTL;
        "pkg-1.21.1-2.2.3.2514.1+neoforge" = _MkKyo8zl;
        "pkg-1.21.3-2.2.3.2514.1+fabric" = _LbTOvTJx;
        "pkg-1.21.1-2.2.3.2514.1+forge" = _wEQbiUr8;
        "pkg-1.21.1-2.2.3.2514.1+fabric" = _IoGISuR4;
        "pkg-1.20.4-2.2.3.2514.1+forge" = _H1IUZLnQ;
        "pkg-1.20.4-2.2.3.2514.1+neoforge" = _d9uirM1C;
        "pkg-1.20.4-2.2.3.2514.1+fabric" = _mfck0Plt;
        "pkg-1.20.1-2.2.3.2514.1+fabric" = _UcL7sBEc;
        "pkg-1.20.1-2.2.3.2514.1+forge" = _4lJzN4oR;
        "pkg-1.21.5-2.2.3.2514.2+forge" = _e5b6PTG4;
        "pkg-1.21.5-2.2.3.2514.2+neoforge" = _HWOv4NgA;
        "pkg-1.21.4-2.2.3.2514.2+neoforge" = _9I9JFV2c;
        "pkg-1.21.5-2.2.3.2514.2+fabric" = _ptUHne9F;
        "pkg-1.21.3-2.2.3.2514.2+neoforge" = _EVKnQyLU;
        "pkg-1.21.4-2.2.3.2514.2+fabric" = _8ck5Opp6;
        "pkg-1.21.4-2.2.3.2514.2+forge" = _EmyICn88;
        "pkg-1.21.3-2.2.3.2514.2+forge" = _2iYZLLqQ;
        "pkg-1.21.1-2.2.3.2514.2+neoforge" = _D5g7o9X5;
        "pkg-1.21.3-2.2.3.2514.2+fabric" = _4DWo6ZUE;
        "pkg-1.21.1-2.2.3.2514.2+forge" = _rXopLii8;
        "pkg-1.21.1-2.2.3.2514.2+fabric" = _zvV6BuDZ;
        "pkg-1.20.4-2.2.3.2514.2+forge" = _VIIXCu3H;
        "pkg-1.20.4-2.2.3.2514.2+neoforge" = _LWDgjHMA;
        "pkg-1.20.4-2.2.3.2514.2+fabric" = _9lf5XYXS;
        "pkg-1.20.1-2.2.3.2514.2+fabric" = _2gd00wwY;
        "pkg-1.20.1-2.2.3.2514.2+forge" = _c8p657Ut;
        "pkg-1.21.5-2.2.3.2515.2+neoforge" = _sTAJFpIg;
        "pkg-1.21.5-2.2.3.2515.2+forge" = _KmID5pHh;
        "pkg-1.21.4-2.2.3.2515.2+neoforge" = _z8ZRBT8o;
        "pkg-1.21.4-2.2.3.2515.2+forge" = _X6U8Iv0A;
        "pkg-1.21.3-2.2.3.2515.2+neoforge" = _xrmv009E;
        "pkg-1.21.4-2.2.3.2515.2+fabric" = _fjlLvMpN;
        "pkg-1.21.5-2.2.3.2515.2+fabric" = _OtgpnWET;
        "pkg-1.21.3-2.2.3.2515.2+forge" = _w6WurW3E;
        "pkg-1.21.3-2.2.3.2515.2+fabric" = _kwDzc4oL;
        "pkg-1.21.1-2.2.3.2515.2+neoforge" = _EH0qSp2t;
        "pkg-1.21.1-2.2.3.2515.2+forge" = _sc4pa32h;
        "pkg-1.21.1-2.2.3.2515.2+fabric" = _W8Ya2a4M;
        "pkg-1.20.4-2.2.3.2515.2+neoforge" = _kfOfqabn;
        "pkg-1.20.4-2.2.3.2515.2+forge" = _Mzzl5397;
        "pkg-1.20.4-2.2.3.2515.2+fabric" = _eWFLWEpR;
        "pkg-1.20.1-2.2.3.2515.2+fabric" = _wcfKGkSd;
        "pkg-1.20.1-2.2.3.2515.2+forge" = _9hL2LpIt;
        "pkg-1.21.5-2.2.3.2516.0+forge" = _c3Nq8Jsn;
        "pkg-1.21.5-2.2.3.2516.0+neoforge" = _SbBZGVoH;
        "pkg-1.21.4-2.2.3.2516.0+neoforge" = _x5PfS21K;
        "pkg-1.21.5-2.2.3.2516.0+fabric" = _ERNqQXAt;
        "pkg-1.21.3-2.2.3.2516.0+neoforge" = _67VF4Tl3;
        "pkg-1.21.3-2.2.3.2516.0+forge" = _VLMus6yf;
        "pkg-1.21.4-2.2.3.2516.0+fabric" = _wDQp6Gt3;
        "pkg-1.21.3-2.2.3.2516.0+fabric" = _LnWDocSj;
        "pkg-1.20.4-2.2.3.2516.0+neoforge" = _z0kXGQ2R;
        "pkg-1.21.1-2.2.3.2516.0+fabric" = _A3GQ5Y2p;
        "pkg-1.21.4-2.2.3.2516.0+forge" = _fG7L5d2O;
        "pkg-1.20.4-2.2.3.2516.0+fabric" = _ztWlniHA;
        "pkg-1.20.1-2.2.3.2516.0+forge" = _2xNJsoOu;
        "pkg-1.21.1-2.2.3.2516.0+neoforge" = _L9wno99C;
        "pkg-1.21.1-2.2.3.2516.0+forge" = _gMHVFcvG;
        "pkg-1.20.4-2.2.3.2516.0+forge" = _DT5wjIcx;
        "pkg-1.20.1-2.2.3.2516.0+fabric" = _eymTMZJc;
        "pkg-1.21.4-2.2.3.2516.1+neoforge" = _6RQsc5mq;
        "pkg-1.21.5-2.2.3.2516.1+neoforge" = _eFQPE2uS;
        "pkg-1.21.5-2.2.3.2516.1+forge" = _GpybMZsQ;
        "pkg-1.21.4-2.2.3.2516.1+forge" = _g7HU2a2s;
        "pkg-1.21.3-2.2.3.2516.1+neoforge" = _GGxbWndh;
        "pkg-1.21.4-2.2.3.2516.1+fabric" = _L6KbxSH1;
        "pkg-1.21.3-2.2.3.2516.1+forge" = _vGW7fgNV;
        "pkg-1.21.5-2.2.3.2516.1+fabric" = _MyvPeY61;
        "pkg-1.21.1-2.2.3.2516.1+forge" = _HmpcwkKh;
        "pkg-1.21.1-2.2.3.2516.1+neoforge" = _DCgqMai0;
        "pkg-1.21.3-2.2.3.2516.1+fabric" = _TSKxZtve;
        "pkg-1.21.1-2.2.3.2516.1+fabric" = _4IInZ81F;
        "pkg-1.20.4-2.2.3.2516.1+neoforge" = _nQwS9yNd;
        "pkg-1.20.1-2.2.3.2516.1+forge" = _zQpQ8X28;
        "pkg-1.20.1-2.2.3.2516.1+fabric" = _5eY8b5rQ;
        "pkg-1.20.4-2.2.3.2516.1+forge" = _QFBE5SEA;
        "pkg-1.20.4-2.2.3.2516.1+fabric" = _87R2l9Pe;
        "pkg-1.21.5-2.2.3.2516.2+neoforge" = _yTmIurdh;
        "pkg-1.21.5-2.2.3.2516.2+fabric" = _621xcqbo;
        "pkg-1.21.5-2.2.3.2516.2+forge" = _MiowHduT;
        "pkg-1.21.4-2.2.3.2516.2+neoforge" = _zScsSam3;
        "pkg-1.21.4-2.2.3.2516.2+forge" = _DUMkEb1G;
        "pkg-1.21.4-2.2.3.2516.2+fabric" = _WEGBVqF4;
        "pkg-1.21.3-2.2.3.2516.2+neoforge" = _AiupIzAs;
        "pkg-1.21.3-2.2.3.2516.2+forge" = _MawML4RW;
        "pkg-1.21.3-2.2.3.2516.2+fabric" = _upejMApZ;
        "pkg-1.21.1-2.2.3.2516.2+neoforge" = _AwE6QIaQ;
        "pkg-1.21.1-2.2.3.2516.2+forge" = _XM2qlf6H;
        "pkg-1.20.4-2.2.3.2516.2+neoforge" = _QK01Jz0y;
        "pkg-1.20.4-2.2.3.2516.2+fabric" = _gjl2D1i4;
        "pkg-1.21.1-2.2.3.2516.2+fabric" = _alX6Ah5v;
        "pkg-1.20.1-2.2.3.2516.2+forge" = _g9nn5GWr;
        "pkg-1.20.4-2.2.3.2516.2+forge" = _cpoSkV7M;
        "pkg-1.20.1-2.2.3.2516.2+fabric" = _ON00oe9B;
        "pkg-1.21.3-2.2.3.2516.5+neoforge" = _Zfu0dSzz;
        "pkg-1.21.5-2.2.3.2516.5+forge" = _gF7TujiU;
        "pkg-1.21.4-2.2.3.2516.5+neoforge" = _jf0JPhU9;
        "pkg-1.21.5-2.2.3.2516.5+neoforge" = _OlV9V7gV;
        "pkg-1.21.4-2.2.3.2516.5+forge" = _avOj8Q9n;
        "pkg-1.21.4-2.2.3.2516.5+fabric" = _ZDjtDvbO;
        "pkg-1.21.3-2.2.3.2516.5+forge" = _MlnZZkH5;
        "pkg-1.21.5-2.2.3.2516.5+fabric" = _YtqFKPxV;
        "pkg-1.21.3-2.2.3.2516.5+fabric" = _HFQuQZYH;
        "pkg-1.21.1-2.2.3.2516.5+forge" = _hd6xTS54;
        "pkg-1.21.1-2.2.3.2516.5+neoforge" = _7uYtHQ4e;
        "pkg-1.21.1-2.2.3.2516.5+fabric" = _cCqWkUbk;
        "pkg-1.20.4-2.2.3.2516.5+neoforge" = _GIDMFLtJ;
        "pkg-1.20.4-2.2.3.2516.5+fabric" = _IcOJptkF;
        "pkg-1.20.1-2.2.3.2516.5+forge" = _XPC6rKzk;
        "pkg-1.20.4-2.2.3.2516.5+forge" = _KYCu7Ffr;
        "pkg-1.20.1-2.2.3.2516.5+fabric" = _LitCejzC;
        "pkg-1.21.5-2.2.3.2516.6+neoforge" = _vGLGNzGi;
        "pkg-1.21.5-2.2.3.2516.6+forge" = _8ViSe6kX;
        "pkg-1.21.4-2.2.3.2516.6+neoforge" = _eEUnnQn0;
        "pkg-1.21.5-2.2.3.2516.6+fabric" = _7C6WoaJ7;
        "pkg-1.21.4-2.2.3.2516.6+forge" = _1tzxrWHZ;
        "pkg-1.21.3-2.2.3.2516.6+neoforge" = _niIX4a7u;
        "pkg-1.21.4-2.2.3.2516.6+fabric" = _g4p4IjHY;
        "pkg-1.21.3-2.2.3.2516.6+forge" = _NIm8x1Wh;
        "pkg-1.21.1-2.2.3.2516.6+neoforge" = _671KU2JP;
        "pkg-1.21.3-2.2.3.2516.6+fabric" = _E1CpBN4c;
        "pkg-1.21.1-2.2.3.2516.6+forge" = _PJLPHV1H;
        "pkg-1.20.4-2.2.3.2516.6+forge" = _cQaY0UYd;
        "pkg-1.21.1-2.2.3.2516.6+fabric" = _b7qRpvkw;
        "pkg-1.20.4-2.2.3.2516.6+neoforge" = _nBstNJyU;
        "pkg-1.20.4-2.2.3.2516.6+fabric" = _SxkU8FnA;
        "pkg-1.20.1-2.2.3.2516.6+fabric" = _koVW3r3V;
        "pkg-1.20.1-2.2.3.2516.6+forge" = _2wGLetmH;
        "pkg-1.21.4-2.2.3.2517.0+neoforge" = _sxEx66CQ;
        "pkg-1.21.5-2.2.3.2517.0+neoforge" = _eCCVQHpN;
        "pkg-1.21.5-2.2.3.2517.0+forge" = _yVgumgp0;
        "pkg-1.21.3-2.2.3.2517.0+neoforge" = _norWnQMT;
        "pkg-1.21.4-2.2.3.2517.0+fabric" = _JuAzOBcb;
        "pkg-1.21.5-2.2.3.2517.0+fabric" = _xXqUL2Zr;
        "pkg-1.21.4-2.2.3.2517.0+forge" = _qAdtfsyf;
        "pkg-1.21.3-2.2.3.2517.0+forge" = _FSMnJTZy;
        "pkg-1.21.1-2.2.3.2517.0+neoforge" = _zuW3K8rb;
        "pkg-1.21.1-2.2.3.2517.0+fabric" = _wd4smyNK;
        "pkg-1.20.4-2.2.3.2517.0+neoforge" = _kDM8bSNZ;
        "pkg-1.21.3-2.2.3.2517.0+fabric" = _TTA9t5vA;
        "pkg-1.21.1-2.2.3.2517.0+forge" = _RnX4RCLH;
        "pkg-1.20.4-2.2.3.2517.0+forge" = _AFKeNbsu;
        "pkg-1.20.1-2.2.3.2517.0+fabric" = _eypDI9Mk;
        "pkg-1.20.4-2.2.3.2517.0+fabric" = _fL6C2SCE;
        "pkg-1.20.1-2.2.3.2517.0+forge" = _gZDEzuYJ;
        "pkg-1.21.5-2.2.3.2518.0+neoforge" = _F8nazx6q;
        "pkg-1.21.5-2.2.3.2518.0+forge" = _MEPoSDG4;
        "pkg-1.21.4-2.2.3.2518.0+neoforge" = _lLLxv4DA;
        "pkg-1.21.5-2.2.3.2518.0+fabric" = _wXuUOwBf;
        "pkg-1.21.4-2.2.3.2518.0+forge" = _4rjuroI1;
        "pkg-1.21.4-2.2.3.2518.0+fabric" = _AjnEV7Qr;
        "pkg-1.21.3-2.2.3.2518.0+neoforge" = _QOkFJm0L;
        "pkg-1.21.3-2.2.3.2518.0+forge" = _kq86vKGj;
        "pkg-1.21.1-2.2.3.2518.0+forge" = _BMRfQIDv;
        "pkg-1.20.4-2.2.3.2518.0+neoforge" = _3j9eCRq1;
        "pkg-1.20.4-2.2.3.2518.0+forge" = _Xb2oAQTz;
        "pkg-1.21.1-2.2.3.2518.0+fabric" = _XzRajsqF;
        "pkg-1.20.1-2.2.3.2518.0+forge" = _1vZEjoDH;
        "pkg-1.20.4-2.2.3.2518.0+fabric" = _PjPsfJ0n;
        "pkg-1.20.1-2.2.3.2518.0+fabric" = _euJwdkZw;
        "pkg-1.21.3-2.2.3.2518.0+fabric" = _l8LRXBOo;
        "pkg-1.21.1-2.2.3.2518.0+neoforge" = _JfonaxLh;
        "pkg-1.21.5-2.2.4+neoforge" = _Xgdntkwk;
        "pkg-1.21.4-2.2.4+neoforge" = _cZpamQ6F;
        "pkg-1.21.5-2.2.4+forge" = _lyrFLRGs;
        "pkg-1.21.5-2.2.4+fabric" = _723CDw41;
        "pkg-1.21.4-2.2.4+forge" = _m1p5Om22;
        "pkg-1.21.3-2.2.4+forge" = _jYPhyilB;
        "pkg-1.21.3-2.2.4+neoforge" = _H0sUYj9S;
        "pkg-1.21.4-2.2.4+fabric" = _RNtxFepr;
        "pkg-1.21.3-2.2.4+fabric" = _uSVFTti0;
        "pkg-1.21.1-2.2.4+forge" = _cfeCPVtd;
        "pkg-1.21.1-2.2.4+neoforge" = _6zNuU7MM;
        "pkg-1.21.1-2.2.4+fabric" = _FqwKDKuS;
        "pkg-1.20.4-2.2.4+neoforge" = _3rJyQMt4;
        "pkg-1.20.4-2.2.4+forge" = _6wU1Qydy;
        "pkg-1.20.4-2.2.4+fabric" = _S7ejyYoN;
        "pkg-1.20.1-2.2.4+forge" = _XkW8BT0k;
        "pkg-1.20.1-2.2.4+fabric" = _4OKIKTdb;
        "pkg-1.21.5-2.2.5+forge" = _OIzercSQ;
        "pkg-1.21.5-2.2.5+neoforge" = _Sjx2sFIy;
        "pkg-1.21.4-2.2.5+neoforge" = _QiFdLxdY;
        "pkg-1.21.5-2.2.5+fabric" = _JycD38nU;
        "pkg-1.21.4-2.2.5+forge" = _t02Uiyp9;
        "pkg-1.21.3-2.2.5+neoforge" = _7ba9dMFb;
        "pkg-1.21.3-2.2.5+forge" = _dRvFDmQz;
        "pkg-1.21.4-2.2.5+fabric" = _NZWq21nS;
        "pkg-1.21.3-2.2.5+fabric" = _kbkTQGpW;
        "pkg-1.21.1-2.2.5+neoforge" = _apmISdpV;
        "pkg-1.21.1-2.2.5+forge" = _Kfvret6P;
        "pkg-1.21.1-2.2.5+fabric" = _fT3o5Hoh;
        "pkg-1.20.4-2.2.5+neoforge" = _s7lFHZ0c;
        "pkg-1.20.4-2.2.5+forge" = _DOj9Rtj0;
        "pkg-1.20.4-2.2.5+fabric" = _PWq2U7zt;
        "pkg-1.20.1-2.2.5+fabric" = _5auJcBKx;
        "pkg-1.20.1-2.2.5+forge" = _4qFxGwJq;
        "pkg-1.20.4-2.2.6+fabric" = _cl2esqgI;
        "pkg-1.20.4-2.2.6+forge" = _AMgHZ41O;
        "pkg-1.20.1-2.2.6+forge" = _jCriSoUS;
        "pkg-1.21.1-2.2.6+fabric" = _ezoVnOZM;
        "pkg-1.20.1-2.2.6+fabric" = _13Uw3GnI;
        "pkg-1.20.4-2.2.6+neoforge" = _8GwF8jwv;
        "pkg-1.21.1-2.2.6+forge" = _JvsrQq4d;
        "pkg-1.21.1-2.2.6+neoforge" = _5qxIuIw7;
        "pkg-1.21.3-2.2.6+neoforge" = _JJORUlUS;
        "pkg-1.21.4-2.2.6+forge" = _Mj5Zz6HG;
        "pkg-1.21.3-2.2.6+forge" = _2YAvwTsG;
        "pkg-1.21.3-2.2.6+fabric" = _oMIm1a51;
        "pkg-1.21.4-2.2.6+fabric" = _wL7MF4Bv;
        "pkg-1.21.4-2.2.6+neoforge" = _d5ruv4Of;
        "pkg-1.21.5-2.2.6+forge" = _L76r1guM;
        "pkg-1.21.5-2.2.6+fabric" = _xdiw83Vu;
        "pkg-1.21.5-2.2.6+neoforge" = _4pBkAvA0;
        "pkg-1.21.8-2.2.6+forge" = _Ixrk6ayW;
        "pkg-1.21.8-2.2.6+neoforge" = _de6ZSY5M;
        "pkg-1.21.8-2.2.6+fabric" = _2bbmGllK;
        "pkg-1.20.4-2.2.6.2545.0+neoforge" = _X6hXBi6W;
        "pkg-1.20.1-2.2.6.2545.0+forge" = _UZOjSooV;
        "pkg-1.20.4-2.2.6.2545.0+forge" = _iy7ou23T;
        "pkg-1.20.1-2.2.6.2545.0+fabric" = _VO7JnLqL;
        "pkg-1.20.4-2.2.6.2545.0+fabric" = _8533V1Vf;
        "pkg-1.21.1-2.2.6.2545.0+neoforge" = _gkouCl1X;
        "pkg-1.21.1-2.2.6.2545.0+forge" = _c6Yf5fr2;
        "pkg-1.21.1-2.2.6.2545.0+fabric" = _l4DIE7D8;
        "pkg-1.21.10-2.2.6.2545.0+neoforge" = _jkepn6cB;
        "pkg-1.21.10-2.2.6.2545.0+fabric" = _ARJBpDat;
        "pkg-1.21.10-2.2.6.2545.0+forge" = _hdB5rARh;
        "pkg-1.21.3-2.2.6.2545.0+fabric" = _2etg64jB;
        "pkg-1.21.3-2.2.6.2545.0+forge" = _wp30cQ8s;
        "pkg-1.21.3-2.2.6.2545.0+neoforge" = _yDpfTy43;
        "pkg-1.21.4-2.2.6.2545.0+forge" = _4VIA1PB5;
        "pkg-1.21.4-2.2.6.2545.0+fabric" = _zmDdtc3A;
        "pkg-1.21.4-2.2.6.2545.0+neoforge" = _ewDGMX1w;
        "pkg-1.21.5-2.2.6.2545.0+neoforge" = _BDu3zSsu;
        "pkg-1.21.5-2.2.6.2545.0+fabric" = _q2H3SDui;
        "pkg-1.21.5-2.2.6.2545.0+forge" = _BGR7rONE;
        "pkg-1.21.8-2.2.6.2545.0+fabric" = _7ZKwu57t;
        "pkg-1.21.8-2.2.6.2545.0+forge" = _QPrQfx9i;
        "pkg-1.21.8-2.2.6.2545.0+neoforge" = _VH0At6k9;
        "pkg-1.20.1-2.2.6.2545.1+forge" = _Lpg7FVzd;
        "pkg-1.20.1-2.2.6.2545.1+fabric" = _qYVSuIP0;
        "pkg-1.20.4-2.2.6.2545.1+fabric" = _gBORhtCi;
        "pkg-1.20.4-2.2.6.2545.1+forge" = _JRbSbOGi;
        "pkg-1.20.4-2.2.6.2545.1+neoforge" = _lhKz2alW;
        "pkg-1.21.1-2.2.6.2545.1+fabric" = _w5S353Is;
        "pkg-1.21.1-2.2.6.2545.1+forge" = _okzqW1ZL;
        "pkg-1.21.1-2.2.6.2545.1+neoforge" = _TTCOSlD4;
        "pkg-1.21.10-2.2.6.2545.1+fabric" = _yW82cF2C;
        "pkg-1.21.10-2.2.6.2545.1+forge" = _ksWd1VLs;
        "pkg-1.21.10-2.2.6.2545.1+neoforge" = _AYDj2FQi;
        "pkg-1.21.3-2.2.6.2545.1+fabric" = _RSVx15rH;
        "pkg-1.21.3-2.2.6.2545.1+forge" = _rh3rED9Z;
        "pkg-1.21.3-2.2.6.2545.1+neoforge" = _BoEsgTDO;
        "pkg-1.21.4-2.2.6.2545.1+fabric" = _g9Y7X4Ad;
        "pkg-1.21.4-2.2.6.2545.1+forge" = _DkIpA5PZ;
        "pkg-1.21.4-2.2.6.2545.1+neoforge" = _SrRp74az;
        "pkg-1.21.5-2.2.6.2545.1+fabric" = _8DekJAQi;
        "pkg-1.21.5-2.2.6.2545.1+forge" = _IDx6uf2e;
        "pkg-1.21.5-2.2.6.2545.1+neoforge" = _yWGd8VDJ;
        "pkg-1.21.8-2.2.6.2545.1+fabric" = _TsN0JYLS;
        "pkg-1.21.8-2.2.6.2545.1+forge" = _SN8PzZ3O;
        "pkg-1.21.8-2.2.6.2545.1+neoforge" = _qJB2I2Dx;
        "pkg-1.20.1-2.2.7+forge" = _TbUA8M2q;
        "pkg-1.20.4-2.2.7+neoforge" = _x8wzC5Gu;
        "pkg-1.20.1-2.2.7+fabric" = _xMa7vJgz;
        "pkg-1.20.4-2.2.7+forge" = _RE2jpA74;
        "pkg-1.20.4-2.2.7+fabric" = _GeOFWRoP;
        "pkg-1.21.1-2.2.7+forge" = _3VAHB9Oe;
        "pkg-1.21.1-2.2.7+fabric" = _pzPZS6oB;
        "pkg-1.21.1-2.2.7+neoforge" = _4D1JD0Km;
        "pkg-1.21.10-2.2.7+fabric" = _D3A6INgt;
        "pkg-1.21.10-2.2.7+neoforge" = _sErLybIg;
        "pkg-1.21.10-2.2.7+forge" = _9ZPJeMVJ;
        "pkg-1.21.3-2.2.7+fabric" = _8YcuDGoO;
        "pkg-1.21.3-2.2.7+forge" = _u8zVeZIZ;
        "pkg-1.21.3-2.2.7+neoforge" = _CuPAGqk7;
        "pkg-1.21.4-2.2.7+forge" = _AheabUMC;
        "pkg-1.21.4-2.2.7+neoforge" = _eJwYoWJo;
        "pkg-1.21.4-2.2.7+fabric" = _RSEEci3v;
        "pkg-1.21.5-2.2.7+forge" = _Lk8VtYNj;
        "pkg-1.21.5-2.2.7+neoforge" = _CR7ke2NS;
        "pkg-1.21.5-2.2.7+fabric" = _RrqI2zTk;
        "pkg-1.21.8-2.2.7+fabric" = _sb14QXXP;
        "pkg-1.21.8-2.2.7+forge" = _UTtgOCoj;
        "pkg-1.21.8-2.2.7+neoforge" = _ObAIjGGo;
        "pkg-1.20.1-2.2.8-fabric" = _bRTwQ6ow;
        "pkg-1.20.1-2.2.8-forge" = _4SyHS2Wh;
        "pkg-1.20.4-2.2.8-fabric" = _Ny6kvY54;
        "pkg-1.20.4-2.2.8-forge" = _tduhAJc7;
        "pkg-1.20.4-2.2.8-neoforge" = _F64PoPh7;
        "pkg-1.21.1-2.2.8-forge" = _1E5SUARE;
        "pkg-1.21.1-2.2.8-fabric" = _9gwGUMTT;
        "pkg-1.21.1-2.2.8-neoforge" = _3ouDx4yH;
        "pkg-1.21.10-2.2.8-fabric" = _dKWk1RrI;
        "pkg-1.21.10-2.2.8-forge" = _trymTuY4;
        "pkg-1.21.10-2.2.8-neoforge" = _ClTTDbFh;
        "pkg-1.21.11-2.2.8-fabric" = _8MJ4hjj2;
        "pkg-1.21.11-2.2.8-forge" = _S8dWk03T;
        "pkg-1.21.11-2.2.8-neoforge" = _bFBVbXQ6;
        "pkg-1.21.3-2.2.8-forge" = _j9aLungD;
        "pkg-1.21.3-2.2.8-fabric" = _dnkSl8Ri;
        "pkg-1.21.3-2.2.8-neoforge" = _14qrWgHj;
        "pkg-1.21.4-2.2.8-fabric" = _jGejMre8;
        "pkg-1.21.4-2.2.8-forge" = _tJMpgFHp;
        "pkg-1.21.4-2.2.8-neoforge" = _Y74LTZ3x;
        "pkg-1.21.5-2.2.8-fabric" = _ZuF1dZxJ;
        "pkg-1.21.5-2.2.8-forge" = _6O7iAUhS;
        "pkg-1.21.5-2.2.8-neoforge" = _mW0mJxmT;
        "pkg-1.21.8-2.2.8-fabric" = _qt569I5g;
        "pkg-1.21.8-2.2.8-forge" = _q8dykpFE;
        "pkg-1.21.8-2.2.8-neoforge" = _CfDJlkt4;
        "pkg-26.1.2-2.2.8-fabric" = _WPmPigj8;
        "pkg-26.1.2-2.2.8-forge" = _3rlC64H6;
        "pkg-26.1.2-2.2.8-neoforge" = _N8my7ZFt;
        "pkg-1.20.1-2.2.9-forge" = _nBiAgIKy;
        "pkg-1.20.1-2.2.9-fabric" = _reTxWo6c;
        "pkg-1.20.4-2.2.9-fabric" = _pEqi45FF;
        "pkg-1.20.4-2.2.9-forge" = _UiPY0Zsz;
        "pkg-1.20.4-2.2.9-neoforge" = _BDMEva1F;
        "pkg-1.21.1-2.2.9-neoforge" = _Shu42hae;
        "pkg-1.21.1-2.2.9-forge" = _Lbt5eiov;
        "pkg-1.21.1-2.2.9-fabric" = _xzTMasRE;
        "pkg-1.21.10-2.2.9-neoforge" = _lurtUvkI;
        "pkg-1.21.10-2.2.9-forge" = _F9wHyaRK;
        "pkg-1.21.10-2.2.9-fabric" = _fyLEr9pq;
        "pkg-1.21.11-2.2.9-forge" = _Ehh3QSSE;
        "pkg-1.21.11-2.2.9-fabric" = _DzDNKcAm;
        "pkg-1.21.11-2.2.9-neoforge" = _yT1lwPeT;
        "pkg-1.21.3-2.2.9-forge" = _9u1pJHcR;
        "pkg-1.21.3-2.2.9-fabric" = _K7LTsmQC;
        "pkg-1.21.3-2.2.9-neoforge" = _ZJ2V7ppR;
        "pkg-1.21.4-2.2.9-fabric" = _jPzflav1;
        "pkg-1.21.4-2.2.9-forge" = _TSdVz8t8;
        "pkg-1.21.4-2.2.9-neoforge" = _2SUZ7BkK;
        "pkg-1.21.5-2.2.9-neoforge" = _wSUR4S2l;
        "pkg-1.21.5-2.2.9-forge" = _bG9VjEld;
        "pkg-1.21.5-2.2.9-fabric" = _WX8x6gDR;
        "pkg-1.21.8-2.2.9-forge" = _GXRfAaC1;
        "pkg-1.21.8-2.2.9-neoforge" = _2gJ5sAAe;
        "pkg-1.21.8-2.2.9-fabric" = _fnfvs4Cw;
        "pkg-26.1.2-2.2.9-forge" = _ej8ERYhM;
        "pkg-26.1.2-2.2.9-fabric" = _JFmQIKph;
        "pkg-26.1.2-2.2.9-neoforge" = _QDU81S2S;
        "default" = _QDU81S2S;
    });
