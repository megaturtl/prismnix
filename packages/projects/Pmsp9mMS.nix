...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _3ki0KpB5;
        "pkg-1.0.9" = _jpvbGu6Z;
        "pkg-1.0.10" = _zJKOzYj0;
        "pkg-1.0.11" = _OKTYAqhH;
        "pkg-1.0.12" = _kKKg0Qgw;
        "pkg-1.0.13" = _mZb96puT;
        "pkg-1.0.14" = _yDT3tbZZ;
        "pkg-1.0.15" = _HCiksGMy;
        "pkg-1.0.16" = _kM14eLQ0;
        "pkg-1.0.17" = _Yyr9NoLD;
        "pkg-1.0.18" = _B4lOeAgs;
        "pkg-1.0.19" = _ZpbaraCU;
