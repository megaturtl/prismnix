...
let
    ...
    in {
        ...
        "pkg-2.9.3" = _61F5faTv;
        "pkg-2.9.4" = _TlQofYZD;
        "pkg-2.12.5" = _xbLVKFlE;
        "pkg-3.0.8" = _HZlTcTEm;
        "pkg-3.0.8a" = _o3PHJTVF;
        "pkg-3.0.8b" = _YOV7VrXF;
        "pkg-3.0.9" = _70dOX1SU;
        "pkg-3.0.9a" = _JsdZwzbx;
        "pkg-3.0.10" = _TyTGZG8R;
        "pkg-3.0.11" = _mskW2YWa;
        "pkg-3.0.12" = _QwqRZtKl;
        "pkg-3.0.13" = _xlcaznxa;
        "pkg-3.0.14" = _w7mYSpVI;
        "pkg-3.0.15" = _PiSgN5Mk;
        "pkg-3.0.16" = _rBhVL9Je;
        "pkg-3.0.17" = _QOvQVzc0;
        "pkg-3.0.18" = _jxnVGAFr;
        "pkg-3.0.19" = _BBeFW9FL;
        "pkg-3.0.20" = _4SfnWAub;
        "pkg-3.0.21" = _9G8WjfvX;
        "pkg-3.0.22" = _7Vh1EsQU;
        "pkg-3.0.23" = _W6xWq9WM;
        "pkg-3.0.24" = _R3aluipj;
        "pkg-3.0.25" = _RAYIiweC;
        "pkg-3.0.26" = _di4A1Lqo;
        "pkg-3.0.27" = _MzOr8TpX;
        "pkg-3.0.28" = _3UQmVfq2;
        "pkg-3.1.1" = _Yn5i5Tdg;
        "pkg-3.1.2" = _QkNddm0g;
        "pkg-3.1.3" = _1HvRBvLZ;
        "pkg-3.1.4" = _uOwpvOA9;
        ...
        "pkg-3.1.8" = _NyZh9rpa;
        "pkg-3.1.9" = _jBUgieBh;
        "pkg-3.1.10" = _PCZJN7t2;
        "pkg-3.1.11" = _t0nxmrZq;
        "pkg-3.1.12" = _awNNviLn;
        "pkg-3.1.13" = _draJHzQA;
        "pkg-3.1.14" = _U8tKEmXH;
        "pkg-3.1.15" = _LaxkbPDS;
        "pkg-3.1.16" = _AEoxJqFa;
        "pkg-3.1.17" = _B8cxZ3hn;
        "pkg-3.1.18" = _gzc56ihz;
        "pkg-3.1.19" = _e2E1YYjM;
        "pkg-3.1.20" = _SjDx8hZi;
        "pkg-3.1.21" = _bfn31SRg;
        "pkg-3.1.22" = _7onxTE5k;
        "pkg-3.1.23" = _ZdKNtwFP;
        "pkg-3.1.24" = _XZJg0nso;
        "pkg-3.1.25" = _8NMItxRm;
        "pkg-3.1.26" = _6G6uiFEa;
        "pkg-3.1.27" = _WzPggVtf;
        "pkg-3.1.28" = _jjSv0jk4;
        "pkg-3.1.29" = _ORj3ioNv;
        "pkg-3.1.30" = _6NpIHb5B;
        "pkg-3.1.31" = _xzmgrYyQ;
        "pkg-3.1.32" = _ut1ncAbN;
        "pkg-3.1.33" = _syC0zwAb;
        "pkg-3.1.34" = _q1pESfzT;
        "pkg-3.1.35" = _GCRVFIfl;
        "pkg-3.1.36" = _8yA3i7lH;
        "pkg-3.1.37" = _KE65y2M8;
