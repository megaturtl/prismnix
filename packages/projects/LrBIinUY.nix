...
let
    versions = (let
        ...
        _Q2jVDA9q = {
            "id" = "Q2jVDA9q";
            "file" = "self-sustainable-0.7-1.21.1.jar";
            "hash" = "sha512-OBmT6Rpfml7PCyzKs0ClG4bH8B2mVw/GtzFgC6yPGhWNB2pHB9grMPjDtiOzUeMe0BldWxw39Pm5fM15gLkINA==";
        };
    in {
        "4QrWg5A1" = _4QrWg5A1;
        "LeqzHXc3" = _LeqzHXc3;
