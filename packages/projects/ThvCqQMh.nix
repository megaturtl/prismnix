...
let
    ...
    in {
        ...
        "pkg-1.20-5.0.3" = _imdueWC9;
        "pkg-1.21.1-6.1.1" = _gNukAFnF;
        "pkg-26.1-7.0.0" = _ER8eyhVB;
        "pkg-26.1-7.0.1" = _4wP1MiVK;
        "pkg-26.1-7.0.3" = _i8KImUrE;
        "pkg-1.21.1-6.1.3" = _ESelEykG;
        "pkg-1.21.1-6.1.4" = _aIpBs9dG;
