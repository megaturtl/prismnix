...
let
    versions = (let
        ...
        _dfvxgiBO = {
            "id" = "dfvxgiBO";
            "file" = "utility-26.1-2.2.0.jar";
            "hash" = "sha512-59TuIlc2+vuFDh1Pcw36/ZHjCHTDXKjeBhzs3vqdcdzo2S9tGnJNVJzjFk9OvxITS9kKMaSc2F3VdFwxir4t9A==";
        };
        _ErZoVqQY = {
            "id" = "ErZoVqQY";
    ...
    in {
        ...
        "pkg-1.20.1-2.0.1" = _5LziSNHr;
        "pkg-1.21-4.6.6" = _WZEzeHp5;
        "pkg-1.21-4.6.7" = _cA0wuckT;
        "pkg-1.21-4.7.0" = _CVGDyOet;
        "pkg-1.21-4.8.0" = _aTBvCTDd;
        "pkg-1.21-4.8.1" = _bmjMWnVD;
        "pkg-1.21-4.8.2" = _kv0dZBm3;
        "pkg-1.21-4.8.3" = _OwZTVGWN;
        "pkg-1.21-4.9.0" = _iaBhQD7T;
        "pkg-1.21-4.9.1" = _FVJtJI2u;
        "pkg-1.21-4.9.2" = _fNvHNxsN;
        "pkg-1.21-4.10.0" = _SwYl3XmR;
        "pkg-1.21-4.10.1" = _niiQS5La;
        "pkg-1.21-4.10.2" = _7GQGOIDK;
        "pkg-1.21-4.10.3" = _4oxsrelt;
        "pkg-1.21-4.10.4" = _xAG4HyBQ;
        "pkg-1.21-4.10.5" = _wWCXcCL5;
        "pkg-1.21-4.10.6" = _rROOGZ88;
        "pkg-1.21-4.10.7" = _EaiPHu1h;
        "pkg-1.21-4.10.8" = _VZA0hD95;
        "pkg-1.21-4.10.9" = _zqRgHhrG;
        "pkg-1.21-4.11.0" = _FJn3WQwr;
        "pkg-1.21-4.11.1" = _61AnIC9o;
        "pkg-1.21-4.11.2" = _wuIo7Tz9;
        "pkg-1.21-4.11.3" = _uNdhbRfm;
        "pkg-1.21-4.11.4" = _NLKamxcp;
        "pkg-1.21.1-4.11.5" = _cJrh9BGp;
        "pkg-1.21.1-4.11.6" = _W4rWX6ag;
        "pkg-1.21.1-4.11.8" = _zPl92Z8y;
        "pkg-1.21.1-4.11.10" = _elOGptaA;
        "pkg-1.21.1-4.12.0" = _uElOwIlZ;
        "pkg-1.21.1-4.12.1" = _sDp4TsX2;
        "pkg-1.21.1-4.12.2" = _cROu2U1X;
        "pkg-1.21.1-4.12.3" = _dPsGeKHN;
        "pkg-1.21.1-4.12.5" = _IZUy2kuP;
        "pkg-1.21.9-1.2.0" = _Na1SB86J;
        "pkg-1.21.11-1.11.0" = _M3LkkNcP;
        "pkg-1.21.11-1.4.0" = _QDMAAUdH;
        "pkg-1.21.11-1.4.1" = _KzLSQM8j;
        "pkg-1.21.11-1.4.2" = _jpkaYFOs;
        "pkg-1.21.11-1.5.0" = _a6QAiesw;
        "pkg-26.1-pre-3-2.0.1" = _sDU3LlYb;
        "pkg-26.1-pre-3-2.1.1" = _qf1fbfN9;
        "pkg-26.1-2.2.0" = _dfvxgiBO;
        "pkg-26.1.1-2.3.0" = _xx4uRusV;
        "pkg-26.1.2-2.4.0" = _izScMw5q;
        "pkg-26.1.2-2.4.1" = _L82fHNs8;
        "pkg-26.1.2-2.4.3" = _3OpL96X0;
        "pkg-26.1.2-2.4.4" = _TYt5mbfm;
        "pkg-26.1.2-2.4.5" = _2oXg5vw6;
        "pkg-26.1.2-2.5.0" = _IJsaMi1t;
        "pkg-26.1.2-2.5.1" = _ySU2mqmC;
        "pkg-26.1.2-2.5.2" = _mPt91r1U;
        "pkg-26.1.2-2.5.3" = _B5T6PgiQ;
        "pkg-26.1.2-2.6.0" = _aw5Ij7GS;
        "pkg-26.1.2-2.6.1" = _Q0zJLmP7;
        "pkg-26.1.2-2.7.0" = _RxA7cbqE;
        "pkg-26.1.2-2.7.1" = _kmHVRIen;
        "pkg-26.1.2-2.7.2" = _nSQUtXk1;
        "pkg-26.1.2-2.7.3" = _FKaBP72N;
        "pkg-26.1.2-2.7.4" = _dpF6dVZo;
        "pkg-26.1.2-2.7.5" = _3iOvSLN5;
        "pkg-26.1.2-2.7.6" = _9HBgukXi;
        "pkg-26.1.2-2.7.7" = _fQgSou5L;
        "pkg-26.1.2-2.7.8" = _vFs2deQQ;
        "pkg-26.1.2-2.7.9" = _wc8MJWFH;
        "pkg-26.1.2-2.7.10" = _aroka1Qk;
        "pkg-26.1.2-2.7.11" = _MJykjhsg;
        "pkg-26.1.2-2.7.12" = _i6ACBtmh;
