...
let
    ...
    in {
        ...
        "pkg-1.9" = _rsQvFtO8;
        "pkg-1.10" = _zvUwIdaT;
        "pkg-1.10.1" = _nm8hezHP;
        "pkg-1.11" = _4uaPgPF6;
        "pkg-1.12" = _Kz22g2cu;
        "pkg-1.13" = _mbx6yswK;
        "pkg-1.13-1.21" = _nmWpX3Pj;
        "pkg-1.13.1" = _aytcks6H;
        "pkg-1.13.1-1.21" = _4ue3Jct2;
        "pkg-1.13.2" = _glte25TN;
        "pkg-1.13.2-1.21" = _FeH9l5Re;
        "pkg-1.14" = _iGXBFyuq;
        "pkg-1.14-1.21" = _PEqDzFop;
        "pkg-1.15" = _pElULD1Q;
        "pkg-1.15-1.21" = _BR3oqZ3M;
        "pkg-1.16" = _iVCI17b9;
        "pkg-1.16-1.21" = _pzPrxOgf;
