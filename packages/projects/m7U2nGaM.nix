...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.6.2" = _qCE7XFLm;
        "pkg-1.18.2-1.7.0" = _zIW2kzgA;
        "pkg-1.18.2-1.8.0" = _tDTxQAXA;
        "pkg-1.18.2-1.8.1" = _DIzAdDe3;
        "pkg-1.18.2-1.8.2" = _qND8liRS;
        "pkg-1.18.2-1.8.3" = _P2Zmf6mI;
        "pkg-1.18.2-1.8.4" = _cCeqdwBP;
        "pkg-1.18.2-1.9.0" = _rfcZOzt3;
        "pkg-1.18.2-1.9.1" = _UMVIMtZv;
        "pkg-1.18.2-1.9.2" = _IAUHAhSq;
        "pkg-1.18.2-1.9.3" = _eh8jdpOR;
        "pkg-1.18.2-1.9.4" = _4eccFqdE;
        "pkg-1.18.2-1.9.5" = _LCkdrz4k;
        "pkg-1.18.2-1.9.6" = _GKXOiGLo;
        "pkg-1.18.2-1.10.0" = _7vMsk3pt;
        "pkg-1.18.2-1.10.1" = _pOFmN1N0;
        "pkg-1.18.2-1.10.2" = _T9Bbsqnp;
        "pkg-1.18.2-1.10.3" = _QVKtvBzQ;
        "pkg-1.18.2-1.10.4" = _dktQfyJu;
        "pkg-1.18.2-1.11.0-fabric" = _BqGcBwoC;
        "pkg-1.18.2-1.11.0-forge" = _sPjxG0fq;
        "pkg-1.18.2-1.11.1-fabric" = _a4tOHbgs;
        "pkg-1.18.2-1.11.1-forge" = _Z41GiaMP;
        "pkg-1.21.1-2.0.0-beta-fabric" = _eXJ1aEE7;
        "pkg-1.21.1-2.0.0-beta-neoforge" = _VG68ekTF;
        "pkg-1.18.2-1.11.2-fabric" = _tAvFoTQF;
        "pkg-1.18.2-1.11.2-forge" = _zuyqEjpx;
        "pkg-1.21.1-2.0.1-beta-fabric" = _Bt6hu6jp;
        "pkg-1.21.1-2.0.1-beta-neoforge" = _9O4B3K9C;
        "pkg-1.21.1-2.1.0-fabric" = _nNfE25XU;
        "pkg-1.21.1-2.1.0-neoforge" = _RsDcJbot;
        "pkg-1.21.1-2.1.1-fabric" = _P11svjqa;
        "pkg-1.21.1-2.1.1-neoforge" = _HgbEljm6;
        "pkg-1.21.1-2.1.2-fabric" = _ypJ0neVB;
        "pkg-1.21.1-2.1.2-neoforge" = _xwpOCDGs;
        "pkg-1.21.1-2.1.3-fabric" = _p7QYi8OG;
