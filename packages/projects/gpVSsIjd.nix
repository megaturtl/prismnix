...
let
    versions = (let
        ...
        _13RQq9g5 = {
            "id" = "13RQq9g5";
            "file" = "H1-Hidename(New) (26.x-26.2).jar";
            "hash" = "sha512-OcpN0ngqhHq4ThwTFqZH78AdGkE0+rnp/ZS6wgu6vx4h1baP7vCLkBi0T3dBgDuIWQSSDEBotK6ZT5EjguaKPQ==";
        };
        _xD3dxdXJ = {
            "id" = "xD3dxdXJ";
            "file" = "H1-Hidename(New) (1.21.11).jar";
            "hash" = "sha512-YVmXvHnYWV+hQJdjHjsxXoa1GnG/bk8cvHiLxt+rhUyacm6WZ2FNWfYpBm/SocTzDJGHBf8AWnFZuERm+h4JIA==";
        };
        _RPkC2xDN = {
            "id" = "RPkC2xDN";
            "file" = "H1-Hidename(New) (1.21.10).jar";
            "hash" = "sha512-VgQann0LcWPVXOraZWHad+QVxD2NSuq7ENfOWuWlAgt77whmjtQvNQq/O12s5HzyKA6wGlNoGPXVYrGDMzR+fA==";
        };
        _Dr4FT8R8 = {
            "id" = "Dr4FT8R8";
            "file" = "H1-Hidename(New) (1.21.9).jar";
            "hash" = "sha512-aZ64HhrrnGenKtFwIpfSyuz5/TPsXh+nVTqv5Up5Jh0MvxujAmfn8G2g1CNHYXxuwuBdOz984Ei5VRsRDMZySA==";
        };
        _dSvN4Jbd = {
            "id" = "dSvN4Jbd";
            "file" = "H1-Hidename(New) (1.21.8).jar";
            "hash" = "sha512-Nb6FflHNLDdbRu+f80b6yLwVXOXCJQ0O9nFGCc0v/HRgeF3QOpkSJxKxMUCjNwW3eAB7gFS0EHaG+pe9LsQj5Q==";
        };
        _ZXblh24y = {
            "id" = "ZXblh24y";
            "file" = "H1-Hidename(New) (1.21.7).jar";
            "hash" = "sha512-csioxWqFd/c2PpwfziO1AkUoeY7GZuDrubZkHkEUMuNwDux8h7EmIDgGSP3S6q1PPGwYkfavIJa0SkZrbNDlCw==";
        };
        _IPoGRtVz = {
            "id" = "IPoGRtVz";
            "file" = "H1-Hidename(New) (1.21.6).jar";
            "hash" = "sha512-tVH/t/CC6RQKTiY89lyP/YCixV01+XYjCFUv29fO2sC9q0ecv/It+VzxipZ2fl1j4Eb2KwXrVvx76pYNHuZkfg==";
        };
        _NVHnXVwA = {
            "id" = "NVHnXVwA";
            "file" = "H1-Hidename(New) (1.21.5).jar";
            "hash" = "sha512-KeGX3AtGY3MWUlmDcawyj9UaOoWniB+15/g+r5wN9bzHMJiQN/vcK3A/8ujQagqs9ObER/4+XsuqV7n2x15yAw==";
        };
        _itT1Exr6 = {
            "id" = "itT1Exr6";
            "file" = "H1-Hidename(New) (1.21.4).jar";
            "hash" = "sha512-VTtxcTLiP6zOZ/6XvIHvXlInAFwWz6Fqrf4aFm0tw8XZyOTrUzvvOpewFJBYd+uW548H7QMs58EFVUX6mTY75w==";
        };
        _8vVCnHhU = {
            "id" = "8vVCnHhU";
            "file" = "H1-Hidename(New) (1.21.3).jar";
            "hash" = "sha512-XNF/pgFqNt336bPLmKnkIpPiVfKR5Riwp2QdoQUS6HLT18aWXFYLbEdPqp3DBmtU5Dl7KV69kpnQbb2pHEeiwQ==";
        };
        _Ur04v8a4 = {
            "id" = "Ur04v8a4";
    ...
    in {
        ...
        "forge-1.21.7" = _ZXblh24y;
        "forge-1.21.8" = _dSvN4Jbd;
        "forge-26.1" = _13RQq9g5;
        "forge-26.1.1" = _13RQq9g5;
        "forge-26.1.2" = _13RQq9g5;
        "forge-26.2" = _13RQq9g5;
        "forge-1.21.11" = _xD3dxdXJ;
        "forge-1.21.10" = _RPkC2xDN;
        "forge-1.21.9" = _Dr4FT8R8;
        ...
        "pkg-H1" = _EqSt6Bvv;
        "pkg-H1-hidename(1.16.5)" = _g7k9Bi9b;
        "pkg-H1-Hidename(1.18.2)" = _Ammb7T5H;
        "pkg-H2" = _xoSzsPw9;
        "pkg-H3" = _lFbMsek1;
        "pkg-H4-tagname1.19.2" = _X0QsDoFp;
        "pkg-H4-tagname" = _4amdd9wC;
        "pkg-H5-keyhide" = _IfK3ulX6;
        "pkg-H6-healthname" = _iOPe3fab;
        "pkg-T1.5-showitem" = _kGh6dfiu;
        "pkg-T1-showitem" = _9IBwm4Wq;
        "pkg-T1-showite" = _aRYC5N0N;
        "pkg-H2-blockhide" = _eBIxXvkC;
        "pkg-H3-hidename" = _IEVsm35C;
        "pkg-H1-hidename" = _dZksG5CA;
        "pkg-H1-hidename(fabric)" = _GW1Obbig;
        "pkg-H2-blockhide(fabric)" = _4nh6p2jo;
        "pkg-H3-teamhide(fabric)" = _ttwVJYR7;
        "pkg-H4-nickchange(fabric)" = _k2YgMQwW;
        "pkg-H5-keyhide(fabric" = _unnOrE3X;
        "pkg-H1-hidename(fabric" = _a01nt3ri;
        "pkg-H6-healthname(fabric)" = _r8OFsGL2;
        "pkg-H5-keyhide(fabric)" = _VffxZMUd;
        "pkg-H5-keyhide(fabric)1.21.4" = _6TEuSGvU;
        "pkg-H2-blockhide(fabric" = _b2vd38LH;
        "pkg-H1-hidename(fabric)1.16.5" = _DgrrPOD8;
        "pkg-H2-blockhide(fabric)1.16.5" = _t3GiQRzx;
        "pkg-H5-keyhide(fabric)1.16.5" = _X5opkjmv;
        "pkg-H3-teamhide(fabric)1.18.2" = _pYf4lfsB;
        "pkg-H3-teamhide(fabric)1.16.5" = _ha38gHRz;
        "pkg-T1.5(fabric)1.20.1" = _YKUVkaeh;
        "pkg-T1.5(fabric)1.19.2" = _ia9hU3un;
        "pkg-T1-showitem(fabric)1.19.2" = _PBJ7Uldf;
        "pkg-T1.5(fabric)1.18.2" = _KWSZUT8H;
        "pkg-T1.5(fabric)1.16.5" = _ZBrMtBYE;
        "pkg-T1-showitem(fabric).18." = _kNTBkVXq;
        "pkg-T1-showitem(fabric)1.20.1" = _PAfXWjbm;
        "pkg-T1-showitem(fabric)1.16.5" = _h0SCoNtG;
        "pkg-H1-hidenamesv1.19.1" = _NSFnMT6G;
        "pkg-H1-hidenamesv1.19" = _iCdFw50B;
        "pkg-H1-hidenamesv-1.19.4" = _Xp216b3y;
        "pkg-H1-hideforge1.21.3" = _umiiaogZ;
        "pkg-H1-hidenameforge1.10." = _9pXQc3kO;
        "pkg-H1-hidenamesv1.19.3" = _dJPymbxX;
        "pkg-H2-versionforge1.21.3" = _vNG6AfVE;
        "pkg-1.0.0" = _1UWD42vg;
        "pkg-H2-neoforge1.20.5" = _nH0ZcgFU;
        "pkg-H2-neoforge1.20.6" = _ZDO3n0XA;
        "pkg-H2-neoforge1.21.1" = _txJR5cqb;
        "pkg-H2-neoforge1.21.2" = _1j5wWnct;
        "pkg-H2-neoforge1.21.3" = _CJjYDahk;
        "pkg-H2-neoforge1.21.4" = _6fsED73y;
        "pkg-H2neoforge1.21.5" = _Hrqz9fBl;
        "pkg-H2neoforge1.21" = _vHemNRnQ;
        "pkg-H2-forge.19" = _TH9Nzk9W;
        "pkg-H2forge1.17.1." = _S9XWDX9m;
        "pkg-H2forge1.18.1." = _7aihRczb;
        "pkg-H2forge1.18.2" = _PpNzSIHr;
        "pkg-H2-forge1.18" = _CqxO3FJm;
        "pkg-H2-forge1.19.1" = _vxKvLxNI;
        "pkg-H2forge1.19.3" = _2zHTiFDA;
        "pkg-H2-forge1.19.4" = _bQMlt5db;
        "pkg-H2-forge1.20.1" = _bjlC7Vbl;
        "pkg-H2-forge1.20.2" = _LHWCYr1D;
        "pkg-H2-forge1.20.3" = _ZWo5eSoq;
        "pkg-H2-forge1.20.4" = _tFuj2DKa;
        "pkg-H2-forge1.20.6" = _N7yy2kql;
        "pkg-H2-forge1.20" = _miI6wrA8;
        "pkg-H2-forge1.21.1" = _GDfrplhh;
        "pkg-H2-forge1.21" = _Vx87zyUv;
        "pkg-H3-hidename1.17.1" = _gZ2hurg4;
        "pkg-H3-hidename1.18.1" = _5yJUTkWk;
        "pkg-H3-hidename1.18.2" = _g4UC70bz;
        "pkg-H3-hidename1.18" = _ybJFJo43;
        "pkg-H3-hidename1.19.1" = _gBNMlwYV;
        "pkg-H3-hidename1.19.2" = _K6llwosg;
        "pkg-H3-hidename1.19.4" = _IlwPUXQO;
        "pkg-H3-hidename1.19.3" = _Y37Zn4NW;
        "pkg-H3-hidename1.19" = _dqmLdleu;
        "pkg-H3-hidename1.20.1." = _95gS7Ew3;
        "pkg-H1-1.21.6" = _kBN3SeQk;
        "pkg-H1-hidename1.21.6" = _V3Ijpona;
        "pkg-H1-hidename1.21.7" = _Yyw37blJ;
        "pkg-H3-1.20.1" = _yZSDwqkT;
        "pkg-H3-1.20.2" = _z1nzmelJ;
        "pkg-H3-1.21" = _BSYjB9w8;
        "pkg-H3-forge1.20.3" = _Kigro5m7;
        "pkg-H3-forge1.20.4" = _wcVXLG0j;
        "pkg-H3-forge1.20.6" = _oucIDgkx;
        "pkg-H3-forge1.20" = _OzOH7Kwu;
        "pkg-H3-forge1.21.1" = _UVIkhjMe;
        "pkg-H3-forge1.21.3" = _LDvzHHPD;
        "pkg-H3-forge1.21.4" = _jkArG8TI;
        "pkg-H3-forge1.21.5" = _pqjqS4St;
        "pkg-H3-forge1.21.6" = _v313rIn9;
        "pkg-H3-forge1.21.7" = _tc6ZAY76;
        "pkg-H3-forge1.21.8" = _ygKF7gTh;
        "pkg-H4-1.20.1" = _kub7VC2r;
        "pkg-H4-tagname1.19" = _4ZafloOL;
        "pkg-H4-tagname1.19.4" = _7DuTvpbm;
        "pkg-H4-tagname1.19.3" = _Kfua7fNz;
        "pkg-H1-Hidename(New)(26.x-26.2)" = _13RQq9g5;
        "pkg-H1-Hidename(New)(1.21.11)" = _xD3dxdXJ;
        "pkg-H1-Hidename(New)(1.21.10)" = _RPkC2xDN;
        "pkg-H1-Hidename(New)(1.21.9)" = _Dr4FT8R8;
        "pkg-H1-Hidename(New)(1.21.8)" = _dSvN4Jbd;
        "pkg-H1-Hidename(New)(1.21.7)" = _ZXblh24y;
        "pkg-H1-Hidename(New)(1.21.6)" = _IPoGRtVz;
        "pkg-H1-Hidename(New)(1.21.5)" = _NVHnXVwA;
