...
let
    versions = (let
        ...
        _5DqiyIQc = {
            "id" = "5DqiyIQc";
            "file" = "coordinatelist-2.0.0-26.1.jar";
            "hash" = "sha512-7UbFTZpSz68CP8289PT0WuIPurRoPllDvZ6eXsTOD/b5ZOPZzOXl0GB9cmOHHh9OmH/HwSpJQ3KODBgMISawEQ==";
        };
    in {
        "QLQ9BAHY" = _QLQ9BAHY;
        "NQI5lcA0" = _NQI5lcA0;
        ...
        "fabric-26.1" = _5DqiyIQc;
        "fabric-26.1.1" = _5DqiyIQc;
        "fabric-26.1.2" = _5DqiyIQc;
        "pkg-1.0.0-1.19.3" = _QLQ9BAHY;
        "pkg-1.1.0-1.19.3" = _NQI5lcA0;
        "pkg-1.1.0-1.19.4" = _BalNgUDJ;
        "pkg-1.2.0-1.19.3" = _hdmPfGxb;
        "pkg-1.2.0-1.19.4" = _7pfMnLdj;
        "pkg-1.3.0-1.20" = _8CU9giH3;
        "pkg-1.4.0-1.20" = _XZKm5299;
        "pkg-1.4.1-1.20" = _bCk5AZmS;
        "pkg-1.5.0-1.20" = _IGywM3wu;
        "pkg-1.6.0-1.20.2" = _vRY3PiXC;
        "pkg-1.6.0-1.20.4" = _t9R6wcmQ;
        "pkg-1.6.1-1.20.6" = _TPoMleZY;
        "pkg-1.6.2-1.20.6" = _vbF4BvKj;
        "pkg-1.7.0-1.21" = _zeLY43oY;
        "pkg-1.7.1-1.21" = _TK19fNUE;
        "pkg-1.7.2-1.21.3" = _mCFnjLcB;
        "pkg-1.7.2-1.21.4" = _5KBTvFu4;
        "pkg-1.7.2-1.21.5" = _pdjJSZl7;
        "pkg-1.8.0-1.21.5" = _8PfqQT3g;
        "pkg-1.8.1-1.21.5" = _XNS4ES5E;
        "pkg-1.8.1-1.21.6" = _OBvKSSMl;
        "pkg-1.8.1-1.21.9" = _88m7AkNC;
        "pkg-1.8.2-1.21.11" = _Zq0IunV0;
        "pkg-2.0.0-26.1" = _5DqiyIQc;
        "default" = _5DqiyIQc;
    });
