...
let
    versions = (let
        ...
        _AJz2nLxd = {
            "id" = "AJz2nLxd";
            "file" = "daycounterplus-1.3.2-mc26.3.jar";
            "hash" = "sha512-qUHBeob3yipoKpAxBy/YD5MaArBA9fs2C7VcRwXHRT3DvYV9ka1IYi2MzTsYaavDFIblmu5591YRgE7X2w7iSw==";
        };
    in {
        "2msefEwM" = _2msefEwM;
        "z4Ep2xGB" = _z4Ep2xGB;
