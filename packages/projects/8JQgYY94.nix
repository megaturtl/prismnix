...
let
    versions = (let
        ...
        _NxLxRwsS = {
            "id" = "NxLxRwsS";
            "file" = "TerraformGenerator-27.1.0.jar";
            "hash" = "sha512-+xREdp+SJHJkY7UPt8DpT5jTV7/JfFBgPMv/W4/DBWup8LerjLEeiODD2bucRVtR5hTpdAO2TVkgu57XlVok7g==";
        };
        _STy4X0iK = {
            "id" = "STy4X0iK";
            "file" = "TerraformGenerator-27.1.1.jar";
            "hash" = "sha512-T/5g/JNR6ffSLDO0NICKgV2Vvu/N4wwrF1mzfdYylzluJu1yUEYBQcULVEcZnazVJt1bMExeIaA6vj8S5ft+pQ==";
        };
        _FiBP0bOf = {
            "id" = "FiBP0bOf";
            "file" = "TerraformGenerator-27.2.0.jar";
            "hash" = "sha512-9du9cvJ6tS5XU3NyFbdoQcfQVANEwpLzqUpVuqfoEdfRbPuZWULz+/hqbbOKesEKGNFRjknTCMwE8kRFxrZNdg==";
        };
        _N082Kn0X = {
            "id" = "N082Kn0X";
    ...
    in {
        ...
        "paper-1.20.1" = _N082Kn0X;
        "paper-1.20.2" = _N082Kn0X;
        "paper-1.20.3" = _N082Kn0X;
        "paper-1.20.4" = _N082Kn0X;
        "paper-1.20.5" = _N082Kn0X;
        "paper-1.20.6" = _N082Kn0X;
        "paper-1.21" = _N082Kn0X;
        "paper-1.21.1" = _N082Kn0X;
        "paper-1.21.2" = _N082Kn0X;
        "paper-1.21.3" = _N082Kn0X;
        "paper-1.21.4" = _N082Kn0X;
        "paper-1.21.5" = _N082Kn0X;
        "paper-1.18" = _YwK17sJ8;
        "paper-1.18.1" = _YwK17sJ8;
        "paper-1.21.6" = _N082Kn0X;
        ...
        "spigot-1.20.1" = _N082Kn0X;
        "spigot-1.20.2" = _N082Kn0X;
        "spigot-1.20.3" = _N082Kn0X;
        "spigot-1.20.4" = _N082Kn0X;
        "spigot-1.20.5" = _N082Kn0X;
        "spigot-1.20.6" = _N082Kn0X;
        "spigot-1.21" = _N082Kn0X;
        "spigot-1.21.1" = _N082Kn0X;
        "spigot-1.21.2" = _N082Kn0X;
        "spigot-1.21.3" = _N082Kn0X;
        "spigot-1.21.4" = _N082Kn0X;
        "spigot-1.21.5" = _N082Kn0X;
        "spigot-1.18" = _YwK17sJ8;
        "spigot-1.18.1" = _YwK17sJ8;
        "spigot-1.21.6" = _N082Kn0X;
        ...
        "folia-1.20.1" = _N082Kn0X;
        "folia-1.20.2" = _N082Kn0X;
        "folia-1.20.3" = _N082Kn0X;
        "folia-1.20.4" = _N082Kn0X;
        "folia-1.20.5" = _N082Kn0X;
        "folia-1.20.6" = _N082Kn0X;
        "folia-1.21" = _N082Kn0X;
        "folia-1.21.1" = _N082Kn0X;
        "folia-1.21.2" = _N082Kn0X;
        "folia-1.21.3" = _N082Kn0X;
        "folia-1.21.4" = _N082Kn0X;
        "folia-1.21.5" = _N082Kn0X;
        "folia-1.21.6" = _N082Kn0X;
