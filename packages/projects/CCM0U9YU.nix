...
let
    ...
    in {
        ...
        "pkg-1.1.2+1.20.4" = _3MXqoUfr;
        "pkg-1.1.3+1.20.4" = _bh0naWYl;
        "pkg-1.2.0+1.21" = _oyDRFQPB;
        "pkg-1.2.1+1.21" = _469J0y2U;
        "pkg-1.3.0+1.21" = _fDDOul4x;
        "pkg-1.4.0+1.21" = _xrOTeEZz;
        "pkg-1.4.1+1.21" = _RDkNcJPX;
        "pkg-1.4.2+1.21" = _yrun2aYy;
        "pkg-1.4.3+1.21" = _VM1RI4J4;
        "pkg-1.4.4+1.21" = _VMKzxK9m;
        "pkg-1.1.4+1.20.4" = _LC9Mjdd8;
        "pkg-1.5.0+1.21" = _m66AFBfq;
        "pkg-1.1.5+1.20.4" = _nkfyzH4O;
        "pkg-1.5.1+1.21" = _XkDoxAjU;
        "pkg-1.5.2+1.21" = _7lZ5SHy9;
        "pkg-1.5.3+1.21" = _ybL5NoZ1;
        "pkg-1.5.4+1.21" = _I7zNAaAJ;
        "pkg-1.5.5+1.21" = _aHje5qKe;
        "pkg-1.5.6+1.21" = _uuYRVDdA;
        "pkg-1.5.7+1.21" = _JFrYKBMw;
        "pkg-1.5.8+1.21" = _hXUXKme8;
        "pkg-1.6.0+1.21" = _cw4eHJKW;
        "pkg-1.7.0+1.21" = _fgZGVlfn;
        "pkg-1.7.1+1.21" = _U1dGD8rv;
        "pkg-1.7.2+1.21" = _DjcYCPqv;
        "pkg-1.8.0-beta-1.21" = _QhhbqcvL;
        "pkg-1.9.0-beta-1.21.1" = _iIC33dl1;
        "pkg-1.9.1-beta-1.21.1" = _slVemiGw;
        "pkg-1.9.2-beta-1.21.1" = _uXsb65im;
        "pkg-1.9.3-beta-1.21.1" = _iiyZcOAf;
        "pkg-1.9.4-beta-1.21.1" = _JqmDj95q;
        "pkg-1.1.6" = _VFOSrHf3;
        "pkg-1.10.0-beta-1.21.1" = _wIrKD3zx;
        "pkg-1.10.1-beta-1.21.1" = _VdXZr9vf;
        "pkg-1.10.2-beta-1.21.1" = _XcqwER6n;
        "pkg-1.10.3-beta-1.21.1" = _WP0tMIRG;
        "pkg-1.10.4-beta-1.21.1" = _mlQqAJZj;
        "pkg-1.10.5-beta-1.21.1" = _2G8169Cs;
        "pkg-1.11.0-beta-1.21.1" = _cHghVKbs;
        "pkg-1.11.1-beta-1.21.1" = _6D2D2fwY;
        "pkg-1.11.2-beta-1.21.1" = _jSWcDydV;
        "pkg-1.11.3-beta-1.21.1" = _D93lJflM;
        "pkg-1.11.4-beta-1.21.1" = _KVSvoqJe;
        "pkg-1.11.5-beta-1.21.1" = _8qTTFGIb;
        "pkg-1.12.0-1.21.1" = _9RUhkCXu;
        "pkg-1.13.0-1.21.1" = _Y4xy9wWf;
        "pkg-1.13.1-1.21.1" = _Z7EfLnwq;
        "pkg-1.13.2-1.21.1" = _JOkrzQqS;
        "pkg-1.13.3-1.21.1" = _RAutzLGw;
        "pkg-1.13.4-1.21.1" = _jTCTIpBj;
        "pkg-1.13.5-1.21.1" = _zzNjheVV;
        "pkg-1.13.6-1.21.1" = _EEPXlNKT;
        "pkg-1.14.0-1.21.1" = _8mcalloV;
        "pkg-1.14.1-1.21.1" = _PrS9UyHt;
        "pkg-1.14.2-1.21.1" = _HPfiGOZQ;
        "pkg-1.14.3-1.21.1" = _7WnvjHDA;
        "pkg-1.14.4-1.21.1" = _iPJr9AVr;
        "pkg-1.14.5-1.21.1" = _BCpqnlKx;
        "pkg-1.14.6-1.21.1" = _sJnL1jSy;
        "pkg-1.14.7-1.21.1" = _ciRDthUF;
        "pkg-1.14.8-1.21.1" = _xVLdhSwe;
        "pkg-1.14.9-1.21.1" = _J1KBGTu1;
        "pkg-1.14.10-1.21.1" = _1qmanZSw;
        "pkg-1.14.11-1.21.1" = _VnKikGGF;
        "pkg-1.14.12-1.21.1" = _VHfQzu3q;
        "pkg-1.14.13-1.21.1" = _qSaSrhif;
        "pkg-1.14.14-1.21.1" = _tmt2g3OA;
        "pkg-1.14.15-1.21.1" = _BDEyXyBX;
        "pkg-1.15.0-1.21.1" = _DyLX120V;
        "pkg-1.15.1-1.21.1" = _RoX7QSgc;
        "pkg-1.15.2-1.21.1" = _S9pmCOyG;
        "pkg-1.15.3-1.21.1" = _DyeSWg2J;
        "pkg-1.15.4-1.21.1" = _1qvkn4YD;
        "pkg-1.15.5-1.21.1" = _khypQjGy;
        "pkg-1.15.6-1.21.1" = _1VNrGmuT;
        "pkg-1.15.7-1.21.1" = _rprdtdH7;
        "pkg-1.15.8-1.21.1" = _1Dp9JJKx;
        "pkg-1.15.9-1.21.1" = _ggS9iaiq;
        "pkg-1.15.10-1.21.1" = _voDaxnvE;
        "pkg-1.15.11-1.21.1" = _GSXpIvFQ;
        "pkg-1.15.12-1.21.1" = _HyPTgwYa;
        "pkg-1.15.13-1.21.1" = _N6kCXBy6;
        "pkg-1.15.14-1.21.1" = _K0TVdcJL;
        "pkg-1.15.15-1.21.1" = _ZvGF5cDE;
        "pkg-1.15.16-1.21.1" = _fgy6n4S7;
        "pkg-1.15.17-1.21.1" = _ZRw3wKPw;
        "pkg-1.15.18-1.21.1" = _t34EvQua;
        "pkg-1.15.19-1.21.1" = _sXaLTJt1;
        "pkg-1.15.20-1.21.1" = _tn8uLZK1;
        "pkg-1.15.21-1.21.1" = _rY2RLQAu;
        "pkg-1.15.22-1.21.1" = _exGWu2bf;
        "pkg-1.15.23-1.21.1" = _9jvz72WU;
        "pkg-1.15.24-1.21.1" = _eOAYIRcB;
        "pkg-1.15.25-1.21.1" = _v23vHcKs;
        "pkg-1.15.26-1.21.1" = _BvfisMlm;
        "pkg-1.15.27-1.21.1" = _pbnGeA7B;
        "pkg-1.15.28-1.21.1" = _6ITv76PK;
        "pkg-1.15.29-1.21.1" = _iajGbIIJ;
        "pkg-1.15.30-1.21.1" = _VpDQgVLb;
        "pkg-1.15.31-1.21.1" = _gfbpddsx;
        "pkg-1.15.32-1.21.1" = _ZiSlAQ8k;
        "pkg-1.15.33-1.21.1" = _gmBd7u9i;
        "pkg-1.15.34-1.21.1" = _zXInCVH3;
        "pkg-1.15.35-1.21.1" = _jRWP7MlH;
        "pkg-1.15.36-1.21.1" = _f0fmMWek;
        "pkg-1.15.37-1.21.1" = _R64UTD9z;
        "pkg-1.15.38-1.21.1" = _VnY7MfRl;
        "pkg-1.15.39-1.21.1" = _5l7JBCrY;
        "pkg-1.15.40-1.21.1" = _KaPKC239;
        "pkg-1.15.41-1.21.1" = _Eozy5pbz;
        "pkg-1.15.42-1.21.1" = _A8sZDlDf;
