...
let
    versions = (let
        ...
        _om5TEzB9 = {
            "id" = "om5TEzB9";
            "file" = "projectsentinel-frame-dropped-version2-forge-1.20.1.jar";
            "hash" = "sha512-9CGjHimyBFmC/wLoaUCVsMCOuPO+uc+SAzhzEbAfPNktDKFtFWRra0jdXSxcaBvQ0Hmees1zPkS3WRBnBI0b0g==";
        };
        _EKURqqyH = {
            "id" = "EKURqqyH";
