...
let
    versions = (let
        ...
        _2jqdD1c5 = {
            "id" = "2jqdD1c5";
            "file" = "snow_lower-1.0.1-mc26.3.zip";
            "hash" = "sha512-ZZuYVabEjrw05bFapX+xaV6j/HUo7VZ4AepVFBns7bliV/bz2MyyHRU93iBz1xa7QQjSGAwuZXmdaWRYkOGiDg==";
        };
    in {
        "I9Nd8F1v" = _I9Nd8F1v;
        "r9A6vqVa" = _r9A6vqVa;
