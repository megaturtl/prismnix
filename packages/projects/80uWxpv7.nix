...
let
    ...
    in {
        ...
        "pkg-1.1.0-alpha-snapshot5" = _lLVIpw1E;
        "pkg-1.2.0-alpha" = _7ZHbB6YE;
        "pkg-1.2.1-beta" = _CcHJ8jpY;
        "pkg-1.2.1-beta-hotfix1" = _K7m40Iwz;
        "pkg-1.2.2-beta" = _cjEpcvK4;
        "pkg-1.3.0-beta+1.21.1" = _k6vdg1cz;
