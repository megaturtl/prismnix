...
let
    ...
    in {
        ...
        "pkg-v1.2.3-release" = _vohLuFXD;
        "pkg-v1.2.4-release" = _Z5jhGdBO;
        "pkg-v1.2.5-release" = _ZtGWqviA;
        "pkg-v1.3.0-release" = _xTaVdTqa;
        "pkg-v1.3.1-release" = _SjXWTeAw;
        "pkg-v1.3.2-release" = _yVnGMj1n;
        "pkg-v1.3.3-release" = _fIU0G68e;
        "pkg-v1.3.4-release" = _CHR5sEk6;
        "pkg-v1.3.5-release" = _JLY1OhII;
        "pkg-v1.3.6-release" = _Yxsdu5fT;
        "pkg-v1.3.7-release" = _h5waagMw;
        "pkg-v1.4.0-release" = _r59eG06w;
        "pkg-v1.4.1-release" = _5lnifgFN;
        "pkg-v1.4.2-1.12.2-release" = _m6rMqUd1;
        "pkg-v1.0.0-1.7.10-betta" = _Fu96Lepq;
        "pkg-v1.4.3-1.12.2-release" = _rejw2481;
        "pkg-v1.4.4-1.12.2-release" = _teZdgMTY;
        "pkg-v1.1.0-1.7.10-betta" = _MIGO1N7u;
        "pkg-v1.1.1-1.7.10-betta" = _9d6scy1D;
        "pkg-v1.1.2-1.7.10-betta" = _nBoDO5XW;
        "pkg-v1.1.3-1.7.10-betta" = _K33ewANk;
        "pkg-v1.1.4-1.7.10-betta" = _LfvejXkF;
        "pkg-v1.2.0-1.7.10-release" = _2krIYx9R;
        "pkg-v1.0.0-1.20.1-f+neof-betta" = _UXJndpkI;
        "pkg-v1.0.1-1.20.1-f+neof-betta" = _eWB1bvVp;
        "pkg-v1.0.2-1.20.1-f+neof-betta" = _yt8Fe4mG;
        "pkg-v1.0.3-1.20.1-f+neof-betta" = _yLoCwDHO;
        "pkg-v1.0.4-1.20.1-f+neof-betta" = _dYlsQCMk;
        "pkg-v1.4.5-1.12.2-release" = _s6DnFVSh;
        "pkg-v1.1.0-1.20.1-f+neof-release" = _78gI9T9n;
        "pkg-v1.4.6-1.12.2-release" = _RTLu1FJK;
        "pkg-v1.2.1-1.7.10-release" = _vJQk0cfG;
        "pkg-v1.4.7-1.12.2-release" = _Gex4SvBz;
        "pkg-v1.1.1-1.20.1-f+neof-release" = _rKet9BbK;
        "pkg-v1.1.2-1.20.1-f+neof-release" = _50TYPCra;
        "pkg-v1.5.0-1.12.2-betta" = _XwNpIi9q;
        "pkg-v1.2.0-1.20.1-f+neof-release" = _sFyr42kC;
        "pkg-v1.5.1-1.12.2-release" = _qG32DVUR;
        "pkg-v1.3.0-1.7.10-release" = _RKk6bGGp;
        "pkg-v1.3.1-1.7.10-release" = _qqbrw7Hm;
        "pkg-v1.3.2-1.7.10-release" = _lwnZia1G;
        "pkg-v1.3.3-1.7.10-release" = _gCsdG2vr;
        "pkg-1.2.0.1-1.20.1-f+neof-release" = _KSQ1AAqX;
        "pkg-v1.3.4-1.7.10-release" = _tf57syRW;
        "pkg-v1.3.5-1.7.10-release" = _iPtQmqme;
        "pkg-v1.2.1-1.20.1-f+neof-release" = _UVmBeXwB;
        "pkg-v1.3.6-1.7.10-release" = _WJZUgvuS;
        "pkg-v1.3.7-1.7.10-release" = _k6VGJ15v;
