...
let
    ...
    in {
        ...
        "pkg-1.0.10+MC1.18" = _LVUkQz8N;
        "pkg-1.0.11+MC1.18-1.18.1" = _UGtl88WH;
        "pkg-1.0.12+MC1.18-1.18.2" = _cdNqPQqv;
        "pkg-1.0.13+MC1.19" = _txvYPXDy;
        "pkg-1.0.14+MC1.19-1.19.1" = _QAmia3Ds;
        "pkg-1.0.15+MC1.19-1.19.2" = _IbzTntPL;
        "pkg-1.0.16+MC1.19-1.19.4" = _vQP5t4RJ;
        "pkg-1.0.17+MC1.20-1.20.1" = _ilbnBrdP;
        "pkg-1.0.18+MC1.20-1.20.2" = _rtFhvprI;
        "pkg-1.0.19+MC1.20-1.20.4" = _ovw7DDCi;
        "pkg-1.0.20+MC1.20-1.20.5" = _vSs3IDkg;
        "pkg-1.0.21+MC1.20-1.20.6" = _4CsQDieG;
        "pkg-1.0.22+MC1.20-1.21" = _XZtx3Apx;
        "pkg-1.0.23+MC1.20-1.21.1" = _VnqLy3a4;
        "pkg-1.1.0+MC1.21.2-1.21.3" = _ouAgXpQJ;
        "pkg-1.1.1+MC1.21.2-1.21.4" = _Ddujt4dI;
        "pkg-1.2.0+MC1.21.5" = _weIJlSA6;
        "pkg-1.3.0+MC1.21.6" = _MDgmv6BY;
        "pkg-1.3.1+MC1.21.6-1.21.7" = _E7oAWuEX;
        "pkg-1.3.2+MC1.21.6-1.21.8" = _hfLXtQ8w;
        "pkg-1.4.0+MC1.21.9-1.21.10" = _xPOknTND;
