...
let
    versions = (let
        ...
        _fMxF0Tus = {
            "id" = "fMxF0Tus";
            "file" = "tiers-0.8.4+26.2.jar";
            "hash" = "sha512-K2e43gi6z/yJDMC5PKWWZTIDq5f14UtfC/QpsQBshKrrF+nM+2yPgrrE6znHNM7i8QZ61Ay87bRZE+J3LeQKuw==";
        };
        _2FhPa2uT = {
            "id" = "2FhPa2uT";
            "file" = "tiers-0.8.4+26.1.2.jar";
            "hash" = "sha512-fV7rTuYBZAm4Bgalia2UXcSfOq7qNWpZa5B9JiMhPNUCOrw/4V+OIqJ2prjB4bPgTTXOGgPNA2H5Uq26coHSSQ==";
        };
        _JHCxjdxy = {
            "id" = "JHCxjdxy";
            "file" = "tiers-0.8.4+26.1.1.jar";
            "hash" = "sha512-Vj8+RtAOifO6YUQknhkV3fUStNr3HOwtB1UBfNisDm9bKid8JUnhZR5lnZcCdCHzvdK5mrDXgceejzF2FE1G4g==";
        };
        _SqA7lA98 = {
            "id" = "SqA7lA98";
            "file" = "tiers-0.8.4+26.1.jar";
            "hash" = "sha512-lVpfrDmPcoRB7Q08r+bNvKQBwQssmFaiey9MGVd2P4Dmovob+QPFSDonenZpaDhVFfJesDFWnzUXgOJzCaw8Jg==";
        };
        _dDJ7wOUg = {
            "id" = "dDJ7wOUg";
            "file" = "tiers-0.8.4+1.21.11.jar";
            "hash" = "sha512-FL5HPsco8kjm8AcfsS/83yxIp1B6TzN9UmGzFZLM2Ntg8O+S8HUyLa0JyeeACbFp1K5M46oGOqa7gKrPpppbdw==";
        };
        _wBlVDwhm = {
            "id" = "wBlVDwhm";
            "file" = "tiers-0.8.4+1.21.10.jar";
            "hash" = "sha512-iUldJ93wesb2NGNHyK4tohRLr5Ks7aeXwu3NE4bWxFeYVvzQ/eVnEooYuzEekWB9PMZ+JRF6KraPi7jaaA9lbQ==";
        };
        _Iv5XUYgU = {
            "id" = "Iv5XUYgU";
            "file" = "tiers-0.8.4+1.21.9.jar";
            "hash" = "sha512-E/2gFO76vMUUzR0xlEHNfPdGbglAbehWbL1cgeZftBqw/w6XcpslGKq6SyQly47Nh5z+vRWXq9vrnDm0ZCPlZA==";
        };
        _AGf8XLVR = {
            "id" = "AGf8XLVR";
            "file" = "tiers-0.8.4+1.21.8.jar";
            "hash" = "sha512-qc6nAAlsJbRr5K3u77OfTpuntTtY9JjNehmaWcS677rwlBANr9t4PzumzIujOvhvuQYLGZravahmIkhz9GbrHg==";
        };
        _Ml8hYZjE = {
            "id" = "Ml8hYZjE";
            "file" = "tiers-0.8.4+1.21.7.jar";
            "hash" = "sha512-PR7HnncJojMzxNJcvFZ8xN+mxX5KUEi03SYyfCxyemV3peljnbuYRSASQtWiaX38E9IB8pY0RfzMvMGbtlcv7A==";
        };
        _bKMP8TcW = {
            "id" = "bKMP8TcW";
            "file" = "tiers-0.8.4+1.21.6.jar";
            "hash" = "sha512-MsL3rpAelAz1ykptfxvFWOQIl4GYHfKpmHiHKQZ0Kr2AVmvENVQ0NN5JiwjAqwlOOwg09tAerqyesH5Z5IEkLQ==";
        };
        _t4ImE4DA = {
            "id" = "t4ImE4DA";
            "file" = "tiers-0.8.4+1.21.5.jar";
            "hash" = "sha512-kjb+JGi1r7Q+vNM7QctF7Tc31Lv8jwZgsLZgI37spOc/eWdetmb9zJaJpTcMfjfr5TBfat5OTQqWx7fpBZ+9dw==";
        };
        _F0HOoWPU = {
            "id" = "F0HOoWPU";
            "file" = "tiers-0.8.4+1.21.4.jar";
            "hash" = "sha512-C+gWNnf0y+BDBDEEy10eYh11gBv9yik3KtawcT/3qkb4S2ilIb6siqK+prb/OapVoS5JtGTDMdCu+n1CZNx36g==";
        };
        _uxcBbbgm = {
            "id" = "uxcBbbgm";
            "file" = "tiers-0.8.4+1.21.3.jar";
            "hash" = "sha512-wJTCei7ks0BKSVZmJKpkmk3zadiVqjeafLXgx1eyU7VEZ2Ajs18vbPLcpTvlwp9cMDuKivQkcMw1HYcXLmukcg==";
        };
        _VHQjvfRy = {
            "id" = "VHQjvfRy";
            "file" = "tiers-0.8.4+1.21.2.jar";
            "hash" = "sha512-H6WfPKlAoK0WoZmyFYkituGm0zyIpAhFuH8pWCMuBxwCm/cWrqPHHvicAAlGeJwb5LFh0xmTDhATHTJo3oH1Gw==";
        };
        _5YfL7VfR = {
            "id" = "5YfL7VfR";
            "file" = "tiers-0.8.4+1.21.1.jar";
            "hash" = "sha512-PrZHqNPIbmVuhYTWxxL9nRqdwFI9b7xge6TQ4baMTUWIGheCny/nuRC4VgTOwFe2at3NLMkxzVuoZ4fWLCfxOA==";
        };
        _Wvp0nGNp = {
            "id" = "Wvp0nGNp";
            "file" = "tiers-0.8.4+1.21.jar";
            "hash" = "sha512-HgPJMNB9C3vPIi249XztMShUdJPNwqBIPbiO/RD4fz/y0gArFHUA+JBfmtR/Z6TwSbQ+1Ey9GWO1Tx86I/HWKQ==";
        };
        _6TDcDJ2S = {
            "id" = "6TDcDJ2S";
            "file" = "tiers-0.9.0+26.3.jar";
            "hash" = "sha512-BtGxYKR4Cwuq9WNdNqi6wXw/WhQUzL4C32FOeygr50inXNSSMhg5N+C4B5h/oqOiclQuKNVUlpjHgIw7TSBb+Q==";
        };
    in {
        "G2EnnStX" = _G2EnnStX;
        "IeD2aRgm" = _IeD2aRgm;
        ...
        "Wvp0nGNp" = _Wvp0nGNp;
        "6TDcDJ2S" = _6TDcDJ2S;
        "fabric-1.21" = _Wvp0nGNp;
        "fabric-1.21.1" = _5YfL7VfR;
        "fabric-1.21.2" = _VHQjvfRy;
        "fabric-1.21.3" = _uxcBbbgm;
        "fabric-1.21.4" = _F0HOoWPU;
        "fabric-1.21.5" = _t4ImE4DA;
        ...
        "fabric-1.21.6" = _bKMP8TcW;
        "fabric-1.21.7" = _Ml8hYZjE;
        "fabric-1.21.8" = _AGf8XLVR;
        "fabric-1.21.9" = _Iv5XUYgU;
        "fabric-1.21.10" = _wBlVDwhm;
        "fabric-1.21.11" = _dDJ7wOUg;
        "fabric-26.1" = _SqA7lA98;
        "fabric-26.1.1" = _JHCxjdxy;
        "fabric-26.1.2" = _2FhPa2uT;
        "fabric-26.2" = _fMxF0Tus;
        "fabric-26.3" = _6TDcDJ2S;
        "quilt-1.21" = _Wvp0nGNp;
        "quilt-1.21.1" = _5YfL7VfR;
        "quilt-1.21.2" = _VHQjvfRy;
        "quilt-1.21.3" = _uxcBbbgm;
        "quilt-1.21.4" = _F0HOoWPU;
        "quilt-1.21.5" = _t4ImE4DA;
        ...
        "quilt-1.21.6" = _bKMP8TcW;
        "quilt-1.21.7" = _Ml8hYZjE;
        "quilt-1.21.8" = _AGf8XLVR;
        "quilt-1.21.9" = _Iv5XUYgU;
        "quilt-1.21.10" = _wBlVDwhm;
        "quilt-1.21.11" = _dDJ7wOUg;
        "quilt-26.1" = _SqA7lA98;
        "quilt-26.1.1" = _JHCxjdxy;
        "quilt-26.1.2" = _2FhPa2uT;
        "quilt-26.2" = _fMxF0Tus;
        "quilt-26.3" = _6TDcDJ2S;
        "pkg-0.1.0" = _G2EnnStX;
        "pkg-0.2.0" = _IeD2aRgm;
        "pkg-0.2.1" = _Pn8UVlv6;
        "pkg-0.2.2" = _qYJy98in;
        "pkg-0.2.2_1.21-1.21.1" = _MWWMQqLW;
        "pkg-0.3.0_1.21.5" = _vgPLNHEF;
        "pkg-0.3.0_1.21-1.21.1" = _QpjhQyt8;
        "pkg-0.3.0_1.21.2-1.21.4" = _fMGrRrkt;
        "pkg-0.3.0_1.20.1-1.20.2" = _bkTlO0OO;
        "pkg-0.3.0_1.20.3-1.20.4" = _mXHnTTQn;
        "pkg-0.3.1_1.21-1.21.1" = _vdmz3MXy;
        "pkg-0.3.1_1.21.2-1.21.4" = _zxsMNovV;
        "pkg-0.3.2_1.21.2-1.21.4" = _rvXuB77n;
        "pkg-0.3.2_1.21-1.21.1" = _15QmfGd2;
        "pkg-0.3.2_1.20.1-1.20.2" = _zCxzSmwS;
        "pkg-0.3.2_1.20.3-1.20.4" = _HHciTxGL;
        "pkg-0.3.2_1.21.5" = _kYnO81OV;
        "pkg-0.3.3_1.20.1-1.20.2" = _qRMj5oou;
        "pkg-0.3.3_1.20.3-1.20.4" = _oXklLXVc;
        "pkg-0.3.3_1.21-1.21.1" = _72yZCNpq;
        "pkg-0.3.3_1.21.2-1.21.4" = _p5J8LgCI;
        "pkg-0.3.3_1.21.5" = _8thmY0XS;
        "pkg-0.3.3_1.19-1.19.4" = _cTlZ4sMA;
        "pkg-0.3.4_1.20.1-1.20.2" = _ngHEkraw;
        "pkg-0.3.4_1.20.3-1.20.4" = _fABu94zX;
        "pkg-0.3.4_1.21-1.21.1" = _Rjt2h9IR;
        "pkg-0.3.4_1.21.2-1.21.4" = _qjHTQaY5;
        "pkg-0.3.4_1.21.5" = _V7Fhu45b;
        "pkg-0.3.3.1_1.19-1.19.4" = _N0YPGj2c;
        "pkg-0.3.5_1.20.1-1.20.2" = _4MCBUPXV;
        "pkg-0.3.5_1.20.3-1.20.4" = _VXfOP0Rz;
        "pkg-0.3.5_1.21-1.21.1" = _3IXfQDHZ;
        "pkg-0.3.5_1.21.2-1.21.4" = _JJ8lgsCx;
        "pkg-0.4.0_1.19-1.19.4" = _lUF5T7BL;
        "pkg-0.4.0_1.20.1" = _1KRkrwxi;
        "pkg-0.4.0_1.20.3-1.20.4" = _relYINBU;
        "pkg-0.4.0_1.21-1.21.1" = _c3lGvIeR;
        "pkg-0.4.0_1.21.2-1.21.4" = _TveldFfV;
        "pkg-0.4.0_1.21.5" = _3DG71PpO;
        "pkg-0.4.1_1.19-1.19.4" = _bONgSric;
        "pkg-0.4.1_1.20.1" = _DGjpRgb9;
        "pkg-0.4.1_1.20.3-1.20.4" = _JUtgu80f;
        "pkg-0.4.1_1.21-1.21.1" = _do5XK9rK;
        "pkg-0.4.1_1.21.2-1.21.4" = _Aq1LGMLg;
        "pkg-0.4.1_1.21.6-1.21.8" = _xyMIbDvJ;
        "pkg-0.4.2_1.20.1" = _ItzywpZz;
        "pkg-0.4.2_1.20.3-1.20.4" = _3P6wudQV;
        "pkg-0.4.2_1.21-1.21.1" = _XunvmRCZ;
        "pkg-0.4.2_1.21.2-1.21.4" = _KL1cLUbB;
        "pkg-0.4.2_1.21.6-1.21.8" = _1493B2sm;
        "pkg-0.4.2_1.21.5" = _L9Zkqkm7;
        "pkg-0.5.0+1.21.6-1.21.8" = _9YHlQkON;
        "pkg-0.5.0+1.21.5" = _GU0cP2GT;
        "pkg-0.5.0+1.21.2-1.21.4" = _3gihGlKm;
        "pkg-0.5.0+1.21-1.21.1" = _AOqTnYaE;
        "pkg-0.5.0+1.20.3-1.20.4" = _TfAXkPGs;
        "pkg-0.5.0+1.20.1" = _5JQWJznz;
        "pkg-0.6.0+1.21-1.21.1" = _MwEx7J4b;
        "pkg-0.6.0+1.21.2-1.21.4" = _6BWl42zK;
        "pkg-0.6.0+1.21.5" = _U6qo1SCK;
        "pkg-0.6.0+1.21.6-1.21.8" = _64qYXqkV;
        "pkg-0.6.0+1.20.1" = _rdmJyCsn;
        "pkg-0.6.0+1.20.3-1.20.4" = _OjCTEsjL;
        "pkg-0.6.1+1.20.1" = _2BkAJCQx;
        "pkg-0.6.1+1.20.3-1.20.4" = _FAUzsBlp;
        "pkg-0.6.1+1.21-1.21.1" = _cWoEljh7;
        "pkg-0.6.1+1.21.2-1.21.4" = _DmfvP51i;
        "pkg-0.6.1+1.21.5" = _UB6DxAK1;
        "pkg-0.6.1+1.21.6-1.21.8" = _xJb3uPlF;
        "pkg-0.6.2+1.20.1" = _TzSXe2Tx;
        "pkg-0.6.2+1.20.3-1.20.4" = _gIVUFZn6;
        "pkg-0.6.2+1.21-1.21.1" = _dzq9GDp9;
        "pkg-0.6.2+1.21.2-1.21.4" = _SafFUJEc;
        "pkg-0.6.2+1.21.5" = _XWMe8Se8;
        "pkg-0.6.2+1.21.6-1.21.8" = _GRY4Sui2;
        "pkg-0.6.2+1.21.9-1.21.10" = _UfSgIL2F;
        "pkg-0.6.3+1.21.2-1.21.4" = _bbRDyHWY;
        "pkg-0.6.3+1.21.5" = _6LK8rYQH;
        "pkg-0.6.3+1.21.6-1.21.8" = _DCxbX4IC;
        "pkg-0.6.3+1.21.9-1.21.10" = _RglndL3Q;
        "pkg-0.6.3+1.21-1.21.1" = _rW0eMVAx;
        "pkg-0.6.3+1.20.1" = _i2cxQrM2;
        "pkg-0.6.3+1.20.3-1.20.4" = _Cu09qJm8;
        "pkg-0.6.4+1.21.9-1.21.11" = _Sivs4cAh;
        "pkg-0.6.4+1.21.6-1.21.8" = _qRIhz3mm;
        "pkg-0.6.4+1.21.5" = _XUsEqGJC;
        "pkg-0.6.4+1.21.2-1.21.4" = _paN6QqkE;
        "pkg-0.6.4+1.21-1.21.1" = _HEYJ5KtT;
        "pkg-0.7.1+1.21.9" = _zI5Ou10e;
        "pkg-0.7.1+1.21.10" = _g47F3kjs;
        "pkg-0.7.1+1.21.11" = _BiJwGrJV;
        "pkg-0.7.1+1.21.8" = _sNXNh3Pv;
        "pkg-0.7.1+1.21.7" = _iaolbAoM;
        "pkg-0.7.1+1.21.6" = _8x822fmP;
        "pkg-0.7.1+1.21.5" = _FPqYA3ki;
        "pkg-0.7.1+1.21.4" = _hJifdF8l;
        "pkg-0.7.1+1.21.3" = _lHS7dhlc;
        "pkg-0.7.1+1.21.2" = _Dn8JiKRo;
        "pkg-0.7.1+1.21.1" = _LxpXUGQF;
        "pkg-0.7.1+1.21" = _Jw2WuNU1;
        "pkg-0.7.2+1.21.11" = _ORNiBZ5M;
        "pkg-0.7.2+1.21.10" = _cbyFlUxN;
        "pkg-0.7.2+1.21.9" = _Ej9Poykt;
        "pkg-0.7.2+1.21.8" = _3hSjrXD8;
        "pkg-0.7.2+1.21.7" = _qqWA0EFk;
        "pkg-0.7.2+1.21.6" = _suDvLccT;
        "pkg-0.7.2+1.21.5" = _6SDAH0vn;
        "pkg-0.7.2+1.21.4" = _9oeU1EQO;
        "pkg-0.7.2+1.21.3" = _E7br0IOs;
        "pkg-0.7.2+1.21.2" = _PotPv2db;
        "pkg-0.7.2+1.21.1" = _e6814qFb;
        "pkg-0.7.2+1.21" = _nOg18ITz;
        "pkg-0.7.3+1.21.11" = _byR8mJsT;
        "pkg-0.7.3+1.21.10" = _aEMlKx4I;
        "pkg-0.7.3+1.21.9" = _q21QVPI0;
        "pkg-0.7.3+1.21.8" = _KkdWdmIm;
        "pkg-0.7.3+1.21.7" = _VVouR3nW;
        "pkg-0.7.3+1.21.6" = _8T6YM3lQ;
        "pkg-0.7.3+1.21.5" = _8cGHIFsY;
        "pkg-0.7.3+1.21.4" = _e37tuMxt;
        "pkg-0.7.3+1.21.3" = _Iyr5WKIz;
        "pkg-0.7.3+1.21.2" = _aAmCf6in;
        "pkg-0.7.3+1.21.1" = _PrLHtn2V;
        "pkg-0.7.3+1.21" = _g0GRp34y;
        "pkg-0.7.4+26.1+alpha" = _RllsZisU;
        "pkg-0.8.0+1.21.11" = _BtqlQP7B;
        "pkg-0.8.0+1.21.10" = _5elbC8xT;
        "pkg-0.8.0+1.21.9" = _pldaILgi;
        "pkg-0.8.0+1.21.8" = _pb6kdUxp;
        "pkg-0.8.0+1.21.7" = _nHcE5zLY;
        "pkg-0.8.0+1.21.6" = _yuiq0Pno;
        "pkg-0.8.0+1.21.5" = _G18A8owg;
        "pkg-0.8.0+1.21.4" = _BPKOYV6i;
        "pkg-0.8.0+1.21.3" = _uat0HG45;
        "pkg-0.8.0+1.21.2" = _orl9FNzS;
        "pkg-0.8.0+1.21.1" = _G2bu4yDI;
        "pkg-0.8.0+1.21" = _4YwHNSMT;
        "pkg-0.8.0+26.1" = _1BOiOKHh;
        "pkg-0.8.0+26.1.1" = _iOu0hpxP;
        "pkg-0.8.0+26.1.2" = _t5IVuMnP;
        "pkg-0.8.1+26.1.2" = _z15ejeNF;
        "pkg-0.8.1+26.1.1" = _eyOpGlcw;
        "pkg-0.8.1+26.1" = _alv4H8Og;
        "pkg-0.8.1+1.21.11" = _NKwlD6Bf;
        "pkg-0.8.1+1.21.10" = _T6R0NotO;
        "pkg-0.8.1+1.21.9" = _jzu7BD4w;
        "pkg-0.8.1+1.21.8" = _otPPUMyO;
        "pkg-0.8.1+1.21.7" = _RcM9xkAS;
        "pkg-0.8.1+1.21.6" = _Fixgcd5l;
        "pkg-0.8.1+1.21.5" = _phFFqaq3;
        "pkg-0.8.1+1.21.4" = _jmAzSxQR;
        "pkg-0.8.1+1.21.3" = _2Rco5QHm;
        "pkg-0.8.1+1.21.2" = _bnARPQRL;
        "pkg-0.8.1+1.21.1" = _uyiLCuCD;
        "pkg-0.8.1+1.21" = _BWhoHPJB;
        "pkg-0.8.2+26.2" = _WE03eWoq;
        "pkg-0.8.2+26.1.2" = _lVQ5XTpK;
        "pkg-0.8.2+26.1.1" = _ymfJ8RdL;
        "pkg-0.8.2+26.1" = _BggNgaw2;
        "pkg-0.8.2+1.21.11" = _fpvMsKOP;
        "pkg-0.8.2+1.21.10" = _33S8pdml;
        "pkg-0.8.2+1.21.9" = _KgODxj60;
        "pkg-0.8.2+1.21.8" = _BaF1OFJg;
        "pkg-0.8.2+1.21.7" = _je1mYF0d;
        "pkg-0.8.2+1.21.6" = _ETdhkqpq;
        "pkg-0.8.2+1.21.5" = _FsKJsP9Z;
        "pkg-0.8.2+1.21.4" = _O2lh5HEE;
        "pkg-0.8.2+1.21.3" = _eYy4KCqs;
        "pkg-0.8.2+1.21.2" = _Qc9eyw7w;
        "pkg-0.8.2+1.21.1" = _dC7Xwzvh;
        "pkg-0.8.2+1.21" = _8Ymxy1Iz;
        "pkg-0.8.3+26.2" = _XLgXLbg6;
        "pkg-0.8.3+26.1.2" = _NTLSJhSX;
        "pkg-0.8.3+26.1.1" = _YAe7OnHO;
        "pkg-0.8.3+26.1" = _DIR9ETtA;
        "pkg-0.8.3+1.21.11" = _ihm5H2T0;
        "pkg-0.8.3+1.21.10" = _qnymb6bL;
        "pkg-0.8.3+1.21.9" = _lqa4namn;
        "pkg-0.8.3+1.21.8" = _GQccJbnk;
        "pkg-0.8.3+1.21.7" = _tYSHEDnL;
        "pkg-0.8.3+1.21.6" = _DH0p09oo;
        "pkg-0.8.3+1.21.5" = _XqP9S25u;
        "pkg-0.8.3+1.21.4" = _zJXuNs10;
        "pkg-0.8.3+1.21.3" = _DJzFLZD3;
        "pkg-0.8.3+1.21.2" = _3HxsXB2r;
        "pkg-0.8.3+1.21.1" = _LMDJzIdX;
        "pkg-0.8.3+1.21" = _JNvtjkDj;
        "pkg-0.8.4+26.2" = _fMxF0Tus;
        "pkg-0.8.4+26.1.2" = _2FhPa2uT;
        "pkg-0.8.4+26.1.1" = _JHCxjdxy;
        "pkg-0.8.4+26.1" = _SqA7lA98;
        "pkg-0.8.4+1.21.11" = _dDJ7wOUg;
        "pkg-0.8.4+1.21.10" = _wBlVDwhm;
        "pkg-0.8.4+1.21.9" = _Iv5XUYgU;
        "pkg-0.8.4+1.21.8" = _AGf8XLVR;
        "pkg-0.8.4+1.21.7" = _Ml8hYZjE;
        "pkg-0.8.4+1.21.6" = _bKMP8TcW;
        "pkg-0.8.4+1.21.5" = _t4ImE4DA;
        "pkg-0.8.4+1.21.4" = _F0HOoWPU;
        "pkg-0.8.4+1.21.3" = _uxcBbbgm;
        "pkg-0.8.4+1.21.2" = _VHQjvfRy;
        "pkg-0.8.4+1.21.1" = _5YfL7VfR;
        "pkg-0.8.4+1.21" = _Wvp0nGNp;
        "pkg-0.9.0+26.3" = _6TDcDJ2S;
        "default" = _6TDcDJ2S;
    });
