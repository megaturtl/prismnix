...
let
    ...
    in {
        ...
        "pkg-1.0.5+1.20.1" = _WjNh1wdr;
        "pkg-1.0.5+1.20.2" = _sNwaoY7U;
        "pkg-1.0.5+1.19.4" = _FHEwRGsk;
        "pkg-1.1.0+1.20.1" = _wIiP9iZC;
        "pkg-1.1.0+1.20.2" = _CM3UxiPf;
        "pkg-2.0.0+1.20.1" = _hOdv1dPn;
        "pkg-2.1.0+1.20.2" = _3cb2lkzj;
        "pkg-2.1.1+1.20.2" = _Sy1MKDNj;
        "pkg-2.2.0+1.20.5" = _gYe36xbi;
        "pkg-2.2.1+1.20.5" = _AqLO2Olm;
        "pkg-2.2.1+1.21" = _RPG4JKVp;
        "pkg-2.1.2+1.20.2" = _zQg0NK7w;
        "pkg-2.2.2+1.20.5" = _EQGiiiHR;
        "pkg-2.2.2+1.21" = _Q7j4e2dP;
        "pkg-2.2.3+1.21" = _38nzGfng;
        "pkg-2.2.3+1.21.3" = _GKUibTa1;
        "pkg-3.0.0+1.21.3" = _vTKX13k3;
        "pkg-3.1.0+1.21.3" = _kVngO5xt;
        "pkg-3.1.1+1.21.3" = _wU2XBQbM;
        "pkg-3.1.1+1.21.5" = _NKIMr4kG;
        "pkg-3.1.1+1.20.2" = _FDCm5zcS;
        "pkg-3.1.2+1.21.5" = _OYqgZkSe;
        "pkg-3.1.2+1.21.9" = _tYD010Bt;
        "pkg-3.1.3+1.21.9" = _Prl4HY7z;
        "pkg-3.2.0+1.21.11" = _XDaU3PNZ;
