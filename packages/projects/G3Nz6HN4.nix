...
let
    ...
    in {
        ...
        "pkg-1.0.5+MC1.18-1.18.1" = _gHuD3XrQ;
        "pkg-1.0.6+MC1.18-1.18.2" = _ioEkTiNz;
        "pkg-1.0.7+MC1.19" = _Tk5jg8aP;
        "pkg-1.0.8+MC1.19-1.19.1" = _xi4ZgTs0;
        "pkg-1.0.9+MC1.19-1.19.2" = _7UXnsuWW;
        "pkg-1.0.10+MC1.19-1.19.4" = _lr5cM6m0;
        "pkg-1.0.11+MC1.19-1.20.1" = _IH8vI09k;
        "pkg-1.0.12+MC1.19-1.20.2" = _8yY78J9d;
        "pkg-1.0.13+MC1.19-1.20.4" = _A1SuJChn;
        "pkg-1.0.14+MC1.19-1.20.5" = _rDmQYGb4;
        "pkg-1.0.15+MC1.19-1.20.6" = _xEFLXNFg;
        "pkg-1.1.0+MC1.21" = _2Bm6OgYH;
        "pkg-1.1.1+MC1.21-1.21.1" = _rISAJ5Qs;
        "pkg-1.2.0+MC1.21.2-1.21.3" = _vE0t0mUo;
        "pkg-1.2.1+MC1.21.2-1.21.4" = _OjasvHUK;
        "pkg-1.2.2+MC1.21.2-1.21.5" = _kR705dSG;
        "pkg-1.2.3+MC1.21.2-1.21.6" = _SZKbBBep;
        "pkg-1.2.4+MC1.21.2-1.21.7" = _O89YXW91;
        "pkg-1.2.5+MC1.21.2-1.21.8" = _Bj7s17ze;
        "pkg-1.2.6+MC1.21.2-1.21.10" = _QT4cPV46;
