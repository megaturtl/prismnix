...
let
    versions = (let
        ...
        _joVq46dk = {
            "id" = "joVq46dk";
            "file" = "Bare Bones x Mods.zip";
            "hash" = "sha512-XJZnY6HbNnZjfOfMrmV+80Uj/TE4CqGIWjtNWRi+gx7HMwbyjAn8pBfmC49Q61UKIUSCJMdcdk4zMzLgxA6zSg==";
        };
        _2ClJtciE = {
            "id" = "2ClJtciE";
            "file" = "Bare Bones x Mods.zip";
            "hash" = "sha512-JCbZrP9ZK0hsCNGNQU1NNnJEufeHv3ruHSDdtqf2EgIFJ1Wkh8koxXqgZkmSgC/4zgFHNuWxVkJTQiB5MgK+Eg==";
        };
        _Zk6xoq1c = {
            "id" = "Zk6xoq1c";
            "file" = "Bare Bones x Mods.zip";
            "hash" = "sha512-kDeJXMTD9qKIdcWrFj5zI1RNQtkFsW0ygUj4jdM57+h7c5uUNrDxZfll5aCjsrzDyZJYRHnQNjPryvweTGn9wg==";
        };
        _X0na2JOO = {
            "id" = "X0na2JOO";
            "file" = "Bare Bones x Mods.zip";
            "hash" = "sha512-orQ86g+qfMBFfv/6wEwJI01xRSgouOclp/PmoAjfWp6KqNx/VoJuNK662mpsn1SA4Am3AYjDVgb8v+ZtI8CAsA==";
        };
        _3bmzPxY9 = {
            "id" = "3bmzPxY9";
            "file" = "Bare Bones x Mods.zip";
            "hash" = "sha512-OoVTR8Rbc+pjC/9d/7KLxW8f2zMKKIm45vE07m4yLQFZHOeCJzrUMmel5mmLdi4WgGWrvhTDHqG6IpURmTabJA==";
        };
        _s5nUag7f = {
            "id" = "s5nUag7f";
            "file" = "Bare Bones x Mods.zip";
            "hash" = "sha512-U3l6GoVYccUa0np3gsFS6QKE1s+2b+nWhuNgTlR0Wja39DTkmzWWKhryU8kMX39deSK7FIcj4J0wFdAqHIqWFA==";
        };
        _c1sUfx5r = {
            "id" = "c1sUfx5r";
            "file" = "Bare Bones x Mods.zip";
            "hash" = "sha512-o3oAiZAFfMIOvwlqykz2OB1hDKjkkWxuNr9JTaKA69EdET/riveGfVbdT3kHM/vh7lrRTm+VRYc89lF/edYv5g==";
        };
        _7nrASAVm = {
            "id" = "7nrASAVm";
            "file" = "Bare Bones x Mods.zip";
            "hash" = "sha512-t4gY5dtaHWmMKzNxvlc4FK4QtOvrM2Muiux+0OBzkmVSJEXFcVhmakdThK4fuwoOMb+rDbnEqRG1sAyoWP9Eaw==";
        };
    in {
        "nRzUgtNP" = _nRzUgtNP;
        "oO4vRDKs" = _oO4vRDKs;
        ...
        "c1sUfx5r" = _c1sUfx5r;
        "7nrASAVm" = _7nrASAVm;
        "minecraft-1.16.5" = _7nrASAVm;
        "minecraft-1.17" = _7nrASAVm;
        "minecraft-1.17.1" = _7nrASAVm;
        "minecraft-1.18" = _7nrASAVm;
        "minecraft-1.18.1" = _7nrASAVm;
        "minecraft-1.18.2" = _7nrASAVm;
        "minecraft-1.19" = _7nrASAVm;
        "minecraft-1.19.1" = _7nrASAVm;
        "minecraft-1.19.2" = _7nrASAVm;
        "minecraft-1.19.3" = _7nrASAVm;
        "minecraft-1.19.4" = _7nrASAVm;
        "minecraft-1.20" = _7nrASAVm;
        "minecraft-1.20.1" = _7nrASAVm;
        "minecraft-1.20.2" = _7nrASAVm;
        "minecraft-1.20.3" = _7nrASAVm;
        "minecraft-1.20.4" = _7nrASAVm;
        "minecraft-1.20.5" = _7nrASAVm;
        "minecraft-1.20.6" = _7nrASAVm;
        "minecraft-1.21" = _7nrASAVm;
        "minecraft-1.21.1" = _7nrASAVm;
        "minecraft-1.21.2" = _7nrASAVm;
        "minecraft-1.21.3" = _7nrASAVm;
        "minecraft-1.21.4" = _7nrASAVm;
        "minecraft-1.21.5" = _7nrASAVm;
        "minecraft-1.21.6" = _7nrASAVm;
        "minecraft-1.21.7" = _7nrASAVm;
        "minecraft-1.21.8" = _7nrASAVm;
        "minecraft-1.21.9" = _7nrASAVm;
        "minecraft-1.21.10" = _7nrASAVm;
        "minecraft-1.21.11" = _7nrASAVm;
        "minecraft-26.1" = _7nrASAVm;
        "minecraft-26.1.1" = _7nrASAVm;
        "minecraft-26.1.2" = _7nrASAVm;
        "minecraft-26.2" = _7nrASAVm;
        "minecraft-26.3" = _7nrASAVm;
        "pkg-1.0" = _nRzUgtNP;
        "pkg-1.1" = _oO4vRDKs;
        "pkg-1.2" = _YjJayZ3N;
        "pkg-1.3" = _LxE2JHJD;
        ...
        "pkg-1.4.9" = _RNnHSFXu;
        "pkg-1.5.0" = _rmi8AurC;
        "pkg-1.5.0a" = _4SR8GvcH;
        "pkg-1.5.1" = _AlHZeINX;
        "pkg-1.5.1a" = _loybsJ09;
        "pkg-1.5.2" = _Qe8JBPAV;
        "pkg-1.5.3" = _PfZiAiTk;
        "pkg-1.5.4" = _FcECYlYd;
        "pkg-1.5.5" = _Ve10J16a;
