...
let
    ...
    in {
        ...
        "pkg-1.2.1" = _srCjbSnV;
        "pkg-v1.2.1" = _XpKnOCjz;
        "pkg-1.18.2-1.2.2" = _N954G0Uf;
        "pkg-1.20.1-1.2.2" = _YNaZMSZc;
        "pkg-1.17.1-1.2.2" = _dU6VT5wt;
        "pkg-1.19.4-1.2.2" = _QlluSyFz;
        "pkg-1.19.2-1.2.2" = _FRrKSs8q;
        "pkg-1.20.2-1.3.0" = _ppmg37Y6;
        "pkg-1.20.4-1.3.1" = _20e5tC13;
        "pkg-1.20.4-1.3.2" = _7KC16Txt;
        "pkg-1.20.4-1.3.3" = _J3a1WQpf;
        "pkg-1.4.0+mc1.20.5" = _zXh0viO9;
        "pkg-1.4.1+mc1.20.5" = _v6MlJUke;
        "pkg-1.4.2+mc1.21" = _ScZjKxnQ;
        "pkg-1.4.3+mc1.21" = _7939etCO;
        "pkg-1.4.4+mc1.21.3" = _znp5ZUwP;
        "pkg-1.4.5+mc1.21.4" = _p1GwNCFi;
        "pkg-1.4.6+mc1.21.5" = _G7al6vTb;
        "pkg-2.0.0+1.21.5" = _FOVGYZRM;
        "pkg-2.0.1+1.21.6" = _e6z3i4gv;
        "pkg-2.0.2+1.21.6" = _JAzWu7w0;
        "pkg-2.1.0+1.21.8" = _wZXCg9wH;
        "pkg-2.2.0+1.21.9" = _CXMAO559;
        "pkg-1.4.4+1.21" = _rlFTqTqV;
        "pkg-2.2.1+1.21.9" = _FVdSeIvh;
        "pkg-2.2.2+1.21.9" = _4Vv8wUwE;
        "pkg-2.2.3+1.21.9" = _1ejeQyT3;
        "pkg-2.3.0+1.21.11" = _bXtsxqbP;
        "pkg-2.3.1+1.21.11" = _ZCMoFMMc;
        "pkg-2.3.3+1.21.11" = _eyBsqaVU;
        "pkg-2.3.4+1.21.11" = _VB8qluZh;
        "pkg-2.4.0+26.1" = _ucpE8bLS;
        "pkg-2.4.1+26.1" = _Sfd99168;
