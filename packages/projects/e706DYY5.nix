...
let
    versions = (let
        ...
        _zrBx6mE0 = {
            "id" = "zrBx6mE0";
            "file" = "modifyplayerdata-neoforge-0.4.3-26.3.jar";
            "hash" = "sha512-NKYGlV260qOhEn/nIPM/KHFuYI8eub4rOEcQMlKyfmlnMEf7pg7CMhjui7rSfr5VWBlmDXWSv9CzCGVdGC8OKw==";
        };
        _ytv8qzEW = {
            "id" = "ytv8qzEW";
            "file" = "modifyplayerdata-fabric-0.4.3-26.3.jar";
            "hash" = "sha512-SkQ9wL/dOKsOx6E8FL7KnnNU0TnPFZao6Zz4az0u0RQTKjSb+83qlNMV/Iud7wFEkv/DzFae/npVv8v/OzCFzQ==";
        };
    in {
        "XAVgh7ij" = _XAVgh7ij;
        "wdJFLREm" = _wdJFLREm;
        ...
        "neoforge-26.3" = _zrBx6mE0;
        "pkg-0.1.0-1.20.4" = _XAVgh7ij;
        "pkg-0.1.1-1.20.4" = _wdJFLREm;
        "pkg-0.2.0-1.20.4" = _GqgvIbOM;
        "pkg-0.2.1-1.20.4" = _uoimNzhx;
        "pkg-0.2.2-1.20.4" = _852zP0ox;
        "pkg-0.2.2-1.20.5" = _D1IPYEE7;
        "pkg-0.2.2-1.20.5+6" = _xaEO78xH;
        "pkg-0.2.2-1.21" = _obcgtBWf;
        "pkg-0.2.2-1.21.1" = _kMkpY14I;
        "pkg-0.2.2-24w38a" = _eZXUaouQ;
        "pkg-0.2.2-24w39a" = _R5PRyikU;
        "pkg-0.2.2-24w40a" = _OBkYEdvL;
        "pkg-0.2.2-1.21.2-pre1" = _M0x2NFZu;
        "pkg-0.2.2-1.21.2" = _y6Ss1qU0;
        "pkg-0.2.3-1.21.3" = _8wR3Fw6T;
        "pkg-0.2.3-1.21.4" = _Yw1ntWsW;
        "pkg-0.2.3-25w02a" = _5lWOS5U0;
        "pkg-0.2.2-1.20.1" = _bqIDMh63;
        "pkg-0.2.3-25w03a" = _FF5I6jSQ;
        "pkg-0.3.0-1.21.5" = _lc6pg5PF;
        "pkg-0.3.1-1.21.5" = _3pwIO2Vk;
        "pkg-0.3.1-1.21.6" = _isT5chp5;
        "pkg-0.3.1-1.21.7" = _l3GqhXni;
        "pkg-0.3.1-1.21.8" = _blBPnt6Y;
        "pkg-0.3.1-1.21.9" = _iY7dfdVX;
        "pkg-0.3.1-1.21.10" = _razu8xzN;
        "pkg-0.3.2-1.21.10" = _pSRchvZU;
        "pkg-0.3.2-1.21.11" = _jOZLiGHt;
        "pkg-0.4.0-26.1-snapshot-1" = _JWvcjP6b;
        "pkg-0.4.1-26.1-snapshot-10" = _9T8ZVyhJ;
        "pkg-0.4.1-26.1" = _OpS7CNOE;
        "pkg-0.4.1-26.1.1" = _OMh9HS8l;
        "pkg-0.4.1-26.2" = _TREHwjlM;
        "pkg-0.4.2-26.2" = _S892xqUY;
        "pkg-0.4.3-26.3" = _ytv8qzEW;
        "default" = _ytv8qzEW;
    });
