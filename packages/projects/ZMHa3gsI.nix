...
let
    versions = (let
        ...
        _ejTxzmKk = {
            "id" = "ejTxzmKk";
            "file" = "annihilation-recreated-r1.1.3_mc1.20.1.zip";
            "hash" = "sha512-HtX782wKXOwM63CNp2FcuSxoQXT9xs6IQHYhBmCout8ijgtohbpf0EHSY5txFVK/UO6xWH467G/XboN/7Hqp0Q==";
        };
        _aw8LyW18 = {
            "id" = "aw8LyW18";
            "file" = "annihilation-recreated-r1.1.3_mc1.20.1.jar";
            "hash" = "sha512-xWBjciWzq90Zp5QDsFjnXWqz8xt3khRlTrr5TTJ+a5i/RlfOrrNhv7o+4TM7VTRRIyHbx0ZbbTLpoFX/fcWsbg==";
        };
        _w6jzcQUX = {
            "id" = "w6jzcQUX";
            "file" = "annihilation-recreated-r1.1.3_mc1.20.4.zip";
            "hash" = "sha512-AKwJ1wsbkbJnh+/641OnSpPcHCZgrUfY7xU2dp7CdpetGl8tER5DdR/U/i4QwoqLa8B0O8bQkhsGz8Y9usKrSQ==";
        };
        _BzSto2At = {
            "id" = "BzSto2At";
            "file" = "annihilation-recreated-r1.1.3_mc1.20.4.jar";
            "hash" = "sha512-DVxOLMVFVCeCaDWlpMLQTo0pT5bxN4HwQqTz/LW+IiFtBU52PIUYRpsMzrLWiRXwu2NIVWRETJRETpquHU7FAQ==";
        };
        _8Auvgxn7 = {
            "id" = "8Auvgxn7";
            "file" = "annihilation-recreated-r1.2.5_mc1.21.1.zip";
            "hash" = "sha512-ZxYGm79oFBxXwZWBNRnepy7WILfpuQ11dEzGsdWowiyikExg2UTqBCs8ymN41Efo6GmzLs9rWwSVS0xn8/XEUQ==";
        };
        _STb1Qgv6 = {
            "id" = "STb1Qgv6";
            "file" = "annihilation-recreated-r1.2.5_mc1.21.1.jar";
            "hash" = "sha512-mQ9/PKjWQBanz+ApQDbjzac4IvJbki4yRmBxgRm5HdDoG2pD7TsV9MlwBUi9csyFLy9fgyD5iLW0arLeC8kmDA==";
        };
    in {
        "A6jZO1Ba" = _A6jZO1Ba;
        "rLPl1BSh" = _rLPl1BSh;
        ...
        "8Auvgxn7" = _8Auvgxn7;
        "STb1Qgv6" = _STb1Qgv6;
        "datapack-1.20.1" = _ejTxzmKk;
        "datapack-1.20" = _ejTxzmKk;
        "datapack-1.20.2" = _w6jzcQUX;
        "datapack-1.20.3" = _w6jzcQUX;
        "datapack-1.20.4" = _w6jzcQUX;
        "datapack-1.21" = _8Auvgxn7;
        "datapack-1.21.1" = _8Auvgxn7;
        "fabric-1.20.1" = _aw8LyW18;
        "fabric-1.20" = _aw8LyW18;
        "fabric-1.20.2" = _BzSto2At;
        "fabric-1.20.3" = _BzSto2At;
        "fabric-1.20.4" = _BzSto2At;
        "fabric-1.21" = _STb1Qgv6;
        "fabric-1.21.1" = _STb1Qgv6;
        "forge-1.20.1" = _aw8LyW18;
        "forge-1.20" = _aw8LyW18;
        "forge-1.20.2" = _BzSto2At;
        "forge-1.20.3" = _BzSto2At;
        "forge-1.20.4" = _BzSto2At;
        "forge-1.21" = _STb1Qgv6;
        "forge-1.21.1" = _STb1Qgv6;
        "neoforge-1.20.1" = _aw8LyW18;
        "neoforge-1.20" = _aw8LyW18;
        "neoforge-1.20.2" = _BzSto2At;
        "neoforge-1.20.3" = _BzSto2At;
        "neoforge-1.20.4" = _BzSto2At;
        "neoforge-1.21" = _STb1Qgv6;
        "neoforge-1.21.1" = _STb1Qgv6;
        "quilt-1.20.1" = _aw8LyW18;
        "quilt-1.20" = _aw8LyW18;
        "quilt-1.20.2" = _BzSto2At;
        "quilt-1.20.3" = _BzSto2At;
        "quilt-1.20.4" = _BzSto2At;
        "quilt-1.21" = _STb1Qgv6;
        "quilt-1.21.1" = _STb1Qgv6;
        "pkg-1.0" = _A6jZO1Ba;
        "pkg-1.0+mod" = _rLPl1BSh;
        "pkg-b1.1" = _wfzhK0kf;
        "pkg-b1.1+mod" = _UXV0MBy3;
        "pkg-b1.2" = _XEMS0UZF;
        "pkg-b1.2+mod" = _cujZks89;
        "pkg-b1.3" = _eCwaEHql;
        "pkg-b1.3+mod" = _K7FOmoM6;
        "pkg-b1.4" = _V8Wdbji5;
        "pkg-b1.4+mod" = _dBtClWih;
        "pkg-b1.5" = _tMGYiIbZ;
        "pkg-b1.5+mod" = _jKcBRfSe;
        "pkg-1.6" = _FAytKuct;
        "pkg-1.6+mod" = _o2pM9NfN;
        "pkg-b1.7" = _hAHhZNaa;
        "pkg-b1.7+mod" = _yKGVLsxE;
        "pkg-b1.7.1" = _S9elvObF;
        "pkg-b1.7.1+mod" = _piYIiyKS;
        "pkg-b1.8" = _S1bjhGJt;
        "pkg-b1.8+mod" = _BqwZ05Uy;
        "pkg-b1.8.1" = _73sfZB5b;
        "pkg-b1.8.1+mod" = _rI2DSy7X;
        "pkg-b2.0" = _mSbrSFhq;
        "pkg-b2.0+mod" = _HQ5PwPqN;
        "pkg-r1.0.0_mc1.20.1" = _RGnBcjHb;
        "pkg-r1.0.0_mc1.20.1+mod" = _tLUixAMD;
        "pkg-r1.0.0_mc1.20.4" = _G1SD8Tlc;
        "pkg-r1.0.0_mc1.20.4+mod" = _NoaC76mx;
        "pkg-r1.1_mc1.20.1" = _nAr36QUE;
        "pkg-r1.1_mc1.20.1+mod" = _Daj7y6Mc;
        "pkg-r1.1_mc1.20.4" = _aqQg0lxD;
        "pkg-r1.1_mc1.20.4+mod" = _5I4Cqn01;
        "pkg-r1.1.1_mc1.20.1" = _1KeC3lOj;
        "pkg-r1.1.1_mc1.20.1+mod" = _2c913Wun;
        "pkg-r1.1.1_mc1.20.4" = _OZ9Fz11u;
        "pkg-r1.1.1_mc1.20.4+mod" = _ZJhPocYA;
        "pkg-b2-1_mc1.21.1" = _ECAcYM5M;
        "pkg-b2-1_mc1.21.1+mod" = _e8jU93s9;
        "pkg-b2-2_mc1.21.1" = _4B3Bdo0L;
        "pkg-b2-2_mc1.21.1+mod" = _RR1BLQEh;
        "pkg-b2-3_mc1.21.1" = _IHWjNqOn;
        "pkg-b2-3_mc1.21.1+mod" = _otC88vH3;
        "pkg-r1.2_mc1.21.1" = _ciRl03Qu;
        "pkg-r1.2_mc1.21.1+mod" = _8QOcu21g;
        "pkg-r1.2.1_mc1.21.1" = _aXaHm5OA;
        "pkg-r1.2.1_mc1.21.1+mod" = _6o2bxII5;
        "pkg-r1.2.2_mc1.21.1" = _dgC1Q5xh;
        "pkg-r1.2.2_mc1.21.1+mod" = _l8pUH2eN;
        "pkg-r1.2.3_mc1.21.1" = _qcofPoFv;
        "pkg-r1.2.3_mc1.21.1+mod" = _EOBVxSYB;
        "pkg-r1.2.4_mc1.21.1" = _Ta9jCvzP;
        "pkg-r1.2.4_mc1.21.1+mod" = _IPCvKtUR;
        "pkg-r1.1.2_mc1.20.1" = _3aTTkKnT;
        "pkg-r1.1.2_mc1.20.1+mod" = _77k90SnW;
        "pkg-r1.1.2_mc1.20.4" = _FNt4utKH;
        "pkg-r1.1.2_mc1.20.4+mod" = _obJ9s9iL;
        "pkg-r1.1.3_mc1.20.1" = _ejTxzmKk;
        "pkg-r1.1.3_mc1.20.1+mod" = _aw8LyW18;
        "pkg-r1.1.3_mc1.20.4" = _w6jzcQUX;
        "pkg-r1.1.3_mc1.20.4+mod" = _BzSto2At;
        "pkg-r1.2.5_mc1.21.1" = _8Auvgxn7;
        "pkg-r1.2.5_mc1.21.1+mod" = _STb1Qgv6;
        "default" = _STb1Qgv6;
    });
