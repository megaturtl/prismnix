...
let
    ...
    in {
        ...
        "pkg-1.0.0+mc1.20.1" = _WRtppsyl;
        "pkg-1.0.0+mc1.20.2" = _dw2LtBRK;
        "pkg-1.0.0+mc1.20.3" = _iYQEalwv;
        "pkg-1.0.0+mc1.20.5" = _g5mJViXy;
        "pkg-1.0.0+mc1.21" = _RnJUNpQE;
        "pkg-1.0.0+mc1.21.2" = _3uCApgA9;
        "pkg-1.0.1+mc1.20.1" = _BY5I6poO;
        "pkg-1.0.1+mc1.21" = _gMjMiQCv;
        "pkg-1.0.1+mc1.21.4" = _BIlrkLwc;
        "pkg-1.0.2+mc1.21.4" = _I3yUbLmF;
        "pkg-1.0.2+mc1.21.5" = _iGJC1jAX;
        "pkg-1.1.0+mc1.20.1" = _scwcAaKL;
        "pkg-1.1.0+mc1.21.1" = _KNoz7gHy;
        "pkg-1.1.0+mc1.21.5" = _4P5lMxB5;
        "pkg-1.1.1+mc1.21.1" = _Lt87sO2x;
        "pkg-1.1.1+mc1.21.5" = _2mO37ElS;
        "pkg-1.1.2+mc1.21.1" = _KFHWoXX9;
        "pkg-1.1.2+mc1.21.5" = _newPWNZx;
        "pkg-1.1.3+mc1.21.1" = _TNwTpsFr;
        "pkg-1.1.3+mc1.21.7" = _xw9MoLbf;
        "pkg-1.2.0+mc1.21.1" = _9BqsPxqW;
        "pkg-1.2.0+mc1.21.8" = _AhSkx0hK;
        "pkg-1.2.0+mc1.21.9+beta" = _t4Ix9jGX;
        "pkg-1.3.0+mc1.21.1" = _xZ77zR0D;
        "pkg-1.3.0+mc1.21.9" = _mQfyz2Qv;
        "pkg-1.3.0+mc1.21.11-pre3" = _kWHzBccW;
        "pkg-1.3.0+mc1.21.11-beta1" = _eLXE7Uxv;
        "pkg-1.3.0+mc26.1-snapshot-7" = _PA08wIEz;
        "pkg-1.3.0+mc26.1" = _tgBnOllE;
        "pkg-1.4.0+mc26.1" = _D8oLuL3J;
        "pkg-2.0.0+tt3.0.x+mc26.1.2" = _oo4Jp6nD;
        "pkg-2.0.0+tt3.0.x+mc26.2" = _NZF171kc;
        "pkg-2.0.1+tt3.0.x+mc26.1.2" = _m1m5WAbE;
        "pkg-2.0.1+tt3.0.x+mc26.2" = _8XWSNWql;
        "pkg-2.0.2+tt3.0.x+mc26.1.2" = _Qxxx6C4f;
        "pkg-2.0.2+tt3.0.x+mc26.2" = _sgtHZmt7;
        "pkg-2.0.3+tt3.0.x+mc26.1.2" = _Knh3PCxS;
        "pkg-2.0.3+tt3.0.x+mc26.2" = _fPkga2Wa;
        "pkg-2.0.4+tt3.0.x+mc26.1.2" = _LBn1B2xF;
        "pkg-2.0.4+tt3.0.x+mc26.2" = _DcjgM4hb;
        "pkg-2.0.5+tt3.0.x+mc26.2" = _NUBgIOZm;
