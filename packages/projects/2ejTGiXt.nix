...
let
    versions = (let
        ...
        _2djtoBli = {
            "id" = "2djtoBli";
            "file" = "AxSellwands-1.16.3.jar";
            "hash" = "sha512-1QSMmGYSVtnNdGPI1GSyiReWsD/75dll8bxv0OJF2rLewsulk1pDdLF9zv7v7Nxv+rJBn1iiN31jJsE5loL2ug==";
        };
        _5RCz3KpS = {
            "id" = "5RCz3KpS";
            "file" = "AxSellwands-1.16.4.jar";
            "hash" = "sha512-d68XHkrPD3u7PRKWCLlz6F6DKsMoOZKa93wc2WzHob2NpINCIAd8JtBKNbXo3oHg6eS3X2Rnns3vOZ4cWfUTXA==";
        };
        _iQ2wCAck = {
            "id" = "iQ2wCAck";
            "file" = "AxSellwands-1.17.0.jar";
            "hash" = "sha512-l4fzJVeIG4DRGJzElem52qxFVAaeu2nUAr2xeyF0mYg9W94RCLLWfPSpiDhjgmo1QzKNeA5MbhfnuFy/plRwkQ==";
        };
        _DAm0WTvN = {
            "id" = "DAm0WTvN";
            "file" = "AxSellwands-1.17.1.jar";
            "hash" = "sha512-bS/bN40OsxOEPs0kEqz2v9OF0w16nYI37UBvJZdLYF9QwrJ+wuIWsOV1RljxdonCQ1+xjEyiaYNqtHrv0oXZwg==";
        };
        _kDZVVZXz = {
            "id" = "kDZVVZXz";
            "file" = "AxSellwands-1.17.2.jar";
            "hash" = "sha512-tHKoJ9pWh91ImcV57TA/F56lmpDKs/TpX8e7xl287mAOqPZeirFz4IC6rUVRENutioei3PZbY5FyyR5UUgecBA==";
        };
    in {
        "5jGsZ9cU" = _5jGsZ9cU;
        "YjeKovbG" = _YjeKovbG;
        ...
        "bukkit-1.20.2" = _kDZVVZXz;
        "bukkit-1.20.3" = _kDZVVZXz;
        "bukkit-1.20.4" = _kDZVVZXz;
        "bukkit-1.20.5" = _kDZVVZXz;
        "bukkit-1.20.6" = _kDZVVZXz;
        "bukkit-1.21" = _kDZVVZXz;
        "bukkit-1.21.1" = _kDZVVZXz;
        "bukkit-1.21.2" = _kDZVVZXz;
        "bukkit-1.21.3" = _kDZVVZXz;
        "bukkit-1.21.4" = _kDZVVZXz;
        "bukkit-1.21.5" = _kDZVVZXz;
        "bukkit-1.21.6" = _kDZVVZXz;
        "bukkit-1.21.7" = _kDZVVZXz;
        "bukkit-1.21.8" = _kDZVVZXz;
        "bukkit-1.21.9" = _kDZVVZXz;
        "bukkit-1.21.10" = _kDZVVZXz;
        "bukkit-1.21.11" = _kDZVVZXz;
        "bukkit-26.1" = _kDZVVZXz;
        "bukkit-26.1.1" = _kDZVVZXz;
        "bukkit-26.1.2" = _kDZVVZXz;
        "bukkit-26.2" = _kDZVVZXz;
        ...
        "folia-1.20.2" = _kDZVVZXz;
        "folia-1.20.3" = _kDZVVZXz;
        "folia-1.20.4" = _kDZVVZXz;
        "folia-1.20.5" = _kDZVVZXz;
        "folia-1.20.6" = _kDZVVZXz;
        "folia-1.21" = _kDZVVZXz;
        "folia-1.21.1" = _kDZVVZXz;
        "folia-1.21.2" = _kDZVVZXz;
        "folia-1.21.3" = _kDZVVZXz;
        "folia-1.21.4" = _kDZVVZXz;
        "folia-1.21.5" = _kDZVVZXz;
        "folia-1.21.6" = _kDZVVZXz;
        "folia-1.21.7" = _kDZVVZXz;
        "folia-1.21.8" = _kDZVVZXz;
        "folia-1.21.9" = _kDZVVZXz;
        "folia-1.21.10" = _kDZVVZXz;
        "folia-1.21.11" = _kDZVVZXz;
        "folia-26.1" = _kDZVVZXz;
        "folia-26.1.1" = _kDZVVZXz;
        "folia-26.1.2" = _kDZVVZXz;
        "folia-26.2" = _kDZVVZXz;
        ...
        "paper-1.20.2" = _kDZVVZXz;
        "paper-1.20.3" = _kDZVVZXz;
        "paper-1.20.4" = _kDZVVZXz;
        "paper-1.20.5" = _kDZVVZXz;
        "paper-1.20.6" = _kDZVVZXz;
        "paper-1.21" = _kDZVVZXz;
        "paper-1.21.1" = _kDZVVZXz;
        "paper-1.21.2" = _kDZVVZXz;
        "paper-1.21.3" = _kDZVVZXz;
        "paper-1.21.4" = _kDZVVZXz;
        "paper-1.21.5" = _kDZVVZXz;
        "paper-1.21.6" = _kDZVVZXz;
        "paper-1.21.7" = _kDZVVZXz;
        "paper-1.21.8" = _kDZVVZXz;
        "paper-1.21.9" = _kDZVVZXz;
        "paper-1.21.10" = _kDZVVZXz;
        "paper-1.21.11" = _kDZVVZXz;
        "paper-26.1" = _kDZVVZXz;
        "paper-26.1.1" = _kDZVVZXz;
        "paper-26.1.2" = _kDZVVZXz;
        "paper-26.2" = _kDZVVZXz;
        ...
        "purpur-1.20.2" = _kDZVVZXz;
        "purpur-1.20.3" = _kDZVVZXz;
        "purpur-1.20.4" = _kDZVVZXz;
        "purpur-1.20.5" = _kDZVVZXz;
        "purpur-1.20.6" = _kDZVVZXz;
        "purpur-1.21" = _kDZVVZXz;
        "purpur-1.21.1" = _kDZVVZXz;
        "purpur-1.21.2" = _kDZVVZXz;
        "purpur-1.21.3" = _kDZVVZXz;
        "purpur-1.21.4" = _kDZVVZXz;
        "purpur-1.21.5" = _kDZVVZXz;
        "purpur-1.21.6" = _kDZVVZXz;
        "purpur-1.21.7" = _kDZVVZXz;
        "purpur-1.21.8" = _kDZVVZXz;
        "purpur-1.21.9" = _kDZVVZXz;
        "purpur-1.21.10" = _kDZVVZXz;
        "purpur-1.21.11" = _kDZVVZXz;
        "purpur-26.1" = _kDZVVZXz;
        "purpur-26.1.1" = _kDZVVZXz;
        "purpur-26.1.2" = _kDZVVZXz;
        "purpur-26.2" = _kDZVVZXz;
        ...
        "spigot-1.20.2" = _kDZVVZXz;
        "spigot-1.20.3" = _kDZVVZXz;
        "spigot-1.20.4" = _kDZVVZXz;
        "spigot-1.20.5" = _kDZVVZXz;
        "spigot-1.20.6" = _kDZVVZXz;
        "spigot-1.21" = _kDZVVZXz;
        "spigot-1.21.1" = _kDZVVZXz;
        "spigot-1.21.2" = _kDZVVZXz;
        "spigot-1.21.3" = _kDZVVZXz;
        "spigot-1.21.4" = _kDZVVZXz;
        "spigot-1.21.5" = _kDZVVZXz;
        "spigot-1.21.6" = _kDZVVZXz;
        "spigot-1.21.7" = _kDZVVZXz;
        "spigot-1.21.8" = _kDZVVZXz;
        "spigot-1.21.9" = _kDZVVZXz;
        "spigot-1.21.10" = _kDZVVZXz;
        "spigot-1.21.11" = _kDZVVZXz;
        "spigot-26.1" = _kDZVVZXz;
        "spigot-26.1.1" = _kDZVVZXz;
        "spigot-26.1.2" = _kDZVVZXz;
        "spigot-26.2" = _kDZVVZXz;
        "pkg-1.0.0" = _5jGsZ9cU;
        "pkg-1.0.1" = _YjeKovbG;
        "pkg-1.0.2" = _3niMwS3S;
        "pkg-1.0.3" = _CL8m0vOb;
        ...
        "pkg-1.9.4" = _zzPPsTOc;
        "pkg-1.9.5" = _6j63H7Vh;
        "pkg-1.10.0" = _l6i73w2i;
        "pkg-1.10.1" = _CvpowVwn;
        "pkg-1.10.2" = _R62mpzEu;
        "pkg-1.10.3" = _E3BttsFJ;
        "pkg-1.11.0" = _bTkJ9Kdq;
        "pkg-1.11.1" = _PJ8SEgRH;
        "pkg-1.12.0" = _jzlPpZ3E;
        "pkg-1.13.0" = _hfVCsS1o;
        "pkg-1.14.0" = _aGHyj2Vp;
        "pkg-1.14.1" = _vFLjBqGZ;
        "pkg-1.14.2" = _WJrjYMvM;
        "pkg-1.15.0" = _BLo6nF6M;
        "pkg-1.16.0" = _P9rdbtcS;
        "pkg-1.16.1" = _GVav164m;
        "pkg-1.16.2" = _K8EtyjV6;
        "pkg-1.16.3" = _2djtoBli;
        "pkg-1.16.4" = _5RCz3KpS;
        "pkg-1.17.0" = _iQ2wCAck;
        "pkg-1.17.1" = _DAm0WTvN;
        "pkg-1.17.2" = _kDZVVZXz;
        "default" = _kDZVVZXz;
    });
