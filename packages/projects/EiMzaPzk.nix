...
let
    ...
    in {
        ...
        "pkg-1.20.6Fa" = _yeCXKLtc;
        "pkg-1.20.4Fo" = _qtLKo0bG;
        "pkg-1.19.2Fo" = _Ai4nDswP;
        "pkg-1.21.11Fa" = _ZIBn50PC;
        "pkg-1.21.11Fo" = _bDEcNKfH;
        "pkg-1.21.11NF" = _bTxy6q6N;
        "pkg-1.21.2Fa" = _HxKHU6Th;
        "pkg-1.21.3Fa" = _xGB3wbcD;
        "pkg-1.21.4Fa" = _BG53gJu8;
        "pkg-1.21.5Fa" = _oxYjrtDk;
        "pkg-1.21.6Fa" = _4kKzU7HE;
        "pkg-1.21.7Fa" = _aCsSCKCt;
        "pkg-1.21.8Fa" = _xmRo59ou;
        "pkg-1.21.9Fa" = _Oacw3sop;
        "pkg-1.21.10Fa" = _HYgBuns7;
        "pkg-1.21.1Fo" = _hvob7dS1;
        "pkg-1.21.9Fo" = _B1JppQPx;
        "pkg-1.21.10Fo" = _IB9KEdUR;
        "pkg-1.21.1NF" = _rN0lM5S8;
        "pkg-1.21.2NF" = _UND91glG;
        "pkg-1.21.3NF" = _SPCfMzfv;
        "pkg-1.21.4NF" = _XMuwcla5;
        "pkg-1.21.5NF" = _mRfIayvJ;
        "pkg-1.21.6NF" = _PSUTTxvT;
        "pkg-1.21.7NF" = _TO3x0ZnK;
        "pkg-1.21.8NF" = _bJPyQbjj;
        "pkg-1.21.9NF" = _6NrplcKU;
        "pkg-1.21.10NF" = _jiiX024J;
        "pkg-1.20.5Fa" = _33mzIblw;
        "pkg-1.20.4Fa" = _32FOI3ZG;
        "pkg-1.20.3Fa" = _nBSZyej8;
        "pkg-1.20.2Fa" = _dvKAegK8;
        "pkg-1.20.1" = _MSj1ucBf;
        "pkg-1.20Fa" = _LKmuT2Bo;
        "pkg-1.19.4Fa" = _t2VTOGXR;
        "pkg-1.19.3Fa" = _rIUwFr9t;
        "pkg-1.19.2Fa" = _IEmXW5ue;
        "pkg-1.19.1Fa" = _VXQ0zARZ;
        "pkg-1.19Fa" = _i6qAvyzA;
        "pkg-1.21.3Fo" = _EF6fgPPP;
        "pkg-1.21.4Fo" = _83mayo6H;
        "pkg-1.21.5Fo" = _zk8GSeki;
        "pkg-1.21.6Fo" = _HM6GKt53;
        "pkg-1.21.7Fo" = _4sxnoDOp;
        "pkg-1.21.8Fo" = _uskOYWng;
        "pkg-1.19Fo" = _bSdGkAv4;
        "pkg-1.19.1Fo" = _MabXtF9c;
        "pkg-1.19.3Fo" = _EXDvjmIr;
        "pkg-1.19.4Fo" = _PQElejRJ;
        "pkg-1.20Fo" = _hYzy371a;
        "pkg-1.20.1Fo" = _naSceLWo;
        "pkg-1.20.2Fo" = _9TXY9f6I;
        "pkg-1.20.3Fo" = _n0yKXRAB;
        "pkg-1.20.1NF" = _k5ZNKJK0;
        "pkg-1.20.2NF" = _9MFxFe4T;
        "pkg-1.20.3NF" = _aSOe01X0;
        "pkg-1.20.4NF" = _EdMYEEl6;
        "pkg-1.20.5NF" = _UH45wBur;
        "pkg-1.20.6NF" = _7DdIh2h9;
        "pkg-1.21NF" = _PiajdItK;
        "pkg-26.1Fa" = _RkyYs0oe;
        "pkg-26.1Fo" = _r0fRP8W5;
        "pkg-26.1NF" = _PO5MfPK2;
