...
let
    ...
    in {
        ...
        "pkg-0.23.2" = _Wwr94ypG;
        "pkg-0.24" = _m6KkaXya;
        "pkg-0.25" = _O4uMr4Z7;
        "pkg-0.25.1" = _sijucEZB;
        "pkg-0.25.2" = _Cf41reLT;
        "pkg-0.25.3" = _vqv9oLMS;
        "pkg-0.26" = _yEoZ64o3;
        "pkg-0.26.1" = _rxLb7TwQ;
        "pkg-0.27" = _K58oH5FP;
        "pkg-0.28" = _fTSs7Kho;
        "pkg-0.28.1" = _tST5M9dk;
        "pkg-0.28.2" = _80DGIhZK;
        "pkg-0.29" = _IBHb6RCi;
        "pkg-0.30" = _1tM9g0Ap;
        "pkg-0.30.1" = _Zi0dT4aF;
        "pkg-0.31" = _qDQXRiNV;
        "pkg-0.31.1" = _dCvTxcCl;
        "pkg-0.31.2" = _HWHEj8Qm;
        "pkg-0.31.3" = _Jq77JTDT;
        "pkg-0.31.4" = _8ga1Shju;
        "pkg-0.32" = _My9VRClc;
        "pkg-0.33" = _yTGOoxpJ;
        "pkg-0.33.1" = _2zn1VXHg;
        "pkg-0.33.2" = _a35zb2HP;
        "pkg-0.33.3" = _aQZnww6H;
        "pkg-0.33.4" = _lBksQFIC;
