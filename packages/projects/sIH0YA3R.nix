...
let
    versions = (let
        ...
        _lOofmkS4 = {
            "id" = "lOofmkS4";
            "file" = "SilkTouchSpawnerZ-1.2.jar";
            "hash" = "sha512-gjPFK4CNSp8JKx4fx7+2X2V9M+ZF3bow8l+4ggsbOKUF+qfpn3zbIklpmJXXFw5M8/1BkcDGkWULzmRUXBv9Fg==";
        };
    in {
        "qbooZndI" = _qbooZndI;
        "EW0fSvHR" = _EW0fSvHR;
        ...
        "bukkit-1.21" = _lOofmkS4;
        "bukkit-1.21.1" = _lOofmkS4;
        "bukkit-1.21.2" = _lOofmkS4;
        "bukkit-1.21.3" = _lOofmkS4;
        "bukkit-1.21.4" = _lOofmkS4;
        "bukkit-1.21.5" = _lOofmkS4;
        "bukkit-1.21.6" = _lOofmkS4;
        "bukkit-1.21.7" = _lOofmkS4;
        "bukkit-1.21.8" = _lOofmkS4;
        "bukkit-1.21.9" = _lOofmkS4;
        "bukkit-1.21.10" = _lOofmkS4;
        "bukkit-1.21.11" = _lOofmkS4;
        "bukkit-26.1" = _lOofmkS4;
        "bukkit-26.1.1" = _lOofmkS4;
        "bukkit-26.1.2" = _lOofmkS4;
        "bukkit-26.2" = _lOofmkS4;
        "bukkit-26.3" = _lOofmkS4;
        ...
        "paper-1.21" = _lOofmkS4;
        "paper-1.21.1" = _lOofmkS4;
        "paper-1.21.2" = _lOofmkS4;
        "paper-1.21.3" = _lOofmkS4;
        "paper-1.21.4" = _lOofmkS4;
        "paper-1.21.5" = _lOofmkS4;
        "paper-1.21.6" = _lOofmkS4;
        "paper-1.21.7" = _lOofmkS4;
        "paper-1.21.8" = _lOofmkS4;
        "paper-1.21.9" = _lOofmkS4;
        "paper-1.21.10" = _lOofmkS4;
        "paper-1.21.11" = _lOofmkS4;
        "paper-26.1" = _lOofmkS4;
        "paper-26.1.1" = _lOofmkS4;
        "paper-26.1.2" = _lOofmkS4;
        "paper-26.2" = _lOofmkS4;
        "paper-26.3" = _lOofmkS4;
        ...
        "spigot-1.21" = _lOofmkS4;
        "spigot-1.21.1" = _lOofmkS4;
        "spigot-1.21.2" = _lOofmkS4;
        "spigot-1.21.3" = _lOofmkS4;
        "spigot-1.21.4" = _lOofmkS4;
        "spigot-1.21.5" = _lOofmkS4;
        "spigot-1.21.6" = _lOofmkS4;
        "spigot-1.21.7" = _lOofmkS4;
        "spigot-1.21.8" = _lOofmkS4;
        "spigot-1.21.9" = _lOofmkS4;
        "spigot-1.21.10" = _lOofmkS4;
        "spigot-1.21.11" = _lOofmkS4;
        "spigot-26.1" = _lOofmkS4;
        "spigot-26.1.1" = _lOofmkS4;
        "spigot-26.1.2" = _lOofmkS4;
        "spigot-26.2" = _lOofmkS4;
        "spigot-26.3" = _lOofmkS4;
