...
let
    ...
    in {
        ...
        "pkg-1.19.2-0.12.7" = _3XdYaRFJ;
        "pkg-1.18.2-0.12.7" = _Amk0xOCH;
        "pkg-1.19.2-0.12.8" = _ZYw9xb1Q;
        "pkg-1.18.2-0.12.8" = _9FpLgVpT;
        "pkg-1.19.2-0.12.9" = _g27f9d68;
        "pkg-1.18.2-0.12.9" = _NtB1DYfI;
        "pkg-1.20.4-0.12.9" = _1DqglBqY;
        "pkg-1.19.2-0.12.10" = _p9cjm5X0;
        "pkg-1.20.4-0.12.10" = _MTJnV0eE;
        "pkg-1.20.1-0.12.10" = _T8XiXY5G;
        "pkg-1.19.2-0.12.11" = _GyyN0IXC;
        "pkg-1.20.1-0.12.11" = _ppu9B4VH;
        "pkg-1.20.4-0.12.11" = _bLEfBEOb;
        "pkg-1.20.4-0.12.11.1" = _VfHXIIAv;
        "pkg-1.20.1-0.12.12" = _kfyqj6GW;
        "pkg-1.20.4-0.12.12" = _SQtxa6Fc;
        "pkg-1.19.2-0.12.12" = _SXWeaLpL;
        "pkg-1.20.1-0.12.12.1" = _loeP1lOA;
        "pkg-1.20.4-0.12.12.1" = _mQMQMBjM;
        "pkg-1.18.2-0.12.9.1" = _w2NW6gjt;
        "pkg-1.19.2-0.12.13" = _RzTIUkxP;
        "pkg-1.20.1-0.12.13" = _uGwPeVuG;
        "pkg-1.20.4-0.12.13" = _gH9Qp62p;
        "pkg-1.21-0.12.13" = _5jHaakYc;
        "pkg-1.21.1-0.12.14" = _eGEjyO3i;
        "pkg-1.20.1-0.12.14" = _ecUt6mSf;
        "pkg-1.21.1-0.12.15" = _b03KUtmo;
        "pkg-1.20.1-0.12.15" = _z15BvWT8;
        "pkg-1.21.1-0.12.16" = _CBooXA60;
        "pkg-1.20.1-0.12.16" = _NtneQip3;
        "pkg-1.21.1-0.12.17" = _bbSJEmW9;
        "pkg-1.20.1-0.12.17" = _X6lts6ef;
        "pkg-1.21.1-0.12.18" = _6Vny8MoL;
