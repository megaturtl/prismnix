...
let
    versions = (let
        ...
        _WfwwgBGX = {
            "id" = "WfwwgBGX";
            "file" = "BetterHotbar+ Dark 1.1.zip";
            "hash" = "sha512-J0n3qHPGdE/07z6ru3jKHL2H0YhdfV/qSpTBpoGs7lNJ/Io5tI+B3DZbPwdOSuhTcgkBfJhO0r2F6Vg5V3ISVA==";
        };
        _few8Sxnl = {
            "id" = "few8Sxnl";
    ...
    in {
        ...
        "minecraft-1.20" = _few8Sxnl;
        "minecraft-1.20.1-rc1" = _hqjlUduz;
        "minecraft-1.20.1" = _few8Sxnl;
        "minecraft-22w42a" = _few8Sxnl;
        "minecraft-22w43a" = _few8Sxnl;
        "minecraft-22w44a" = _few8Sxnl;
        ...
        "minecraft-23w14a" = _few8Sxnl;
        "minecraft-23w16a" = _few8Sxnl;
        "minecraft-23w17a" = _hqjlUduz;
        "minecraft-23w18a" = _hqjlUduz;
        "minecraft-23w31a" = _few8Sxnl;
        "minecraft-23w32a" = _few8Sxnl;
        "minecraft-23w33a" = _few8Sxnl;
        "minecraft-1.20.2" = _few8Sxnl;
        "minecraft-23w40a" = _eaX6xtGL;
        "minecraft-23w41a" = _eaX6xtGL;
        "minecraft-23w42a" = _few8Sxnl;
        "minecraft-23w43a" = _few8Sxnl;
        "minecraft-23w43b" = _few8Sxnl;
        "minecraft-23w44a" = _few8Sxnl;
        "minecraft-23w45a" = _few8Sxnl;
        "minecraft-23w46a" = _few8Sxnl;
        "minecraft-1.20.3-pre1" = _eaX6xtGL;
        "minecraft-1.20.3-pre2" = _eaX6xtGL;
        "minecraft-1.20.3-pre3" = _eaX6xtGL;
        "minecraft-1.20.3" = _few8Sxnl;
        "minecraft-1.20.4" = _few8Sxnl;
        "minecraft-24w14potato" = _few8Sxnl;
        "minecraft-1.20.5-pre1" = _few8Sxnl;
        "minecraft-1.20.5-pre2" = _few8Sxnl;
        "minecraft-1.20.5-pre3" = _few8Sxnl;
        ...
        "minecraft-1.9.2" = _few8Sxnl;
        "minecraft-1.9.3" = _few8Sxnl;
        "minecraft-1.9.4" = _few8Sxnl;
        "minecraft-1.10" = _few8Sxnl;
        "minecraft-1.10.1" = _few8Sxnl;
        "minecraft-1.10.2" = _few8Sxnl;
        "minecraft-1.11" = _few8Sxnl;
        "minecraft-1.11.1" = _few8Sxnl;
        "minecraft-1.11.2" = _few8Sxnl;
        "minecraft-1.12" = _few8Sxnl;
        "minecraft-1.12.1" = _few8Sxnl;
        "minecraft-1.12.2" = _few8Sxnl;
        "minecraft-1.13" = _few8Sxnl;
        "minecraft-1.13.1" = _few8Sxnl;
        "minecraft-1.13.2" = _few8Sxnl;
        "minecraft-1.14" = _few8Sxnl;
        "minecraft-1.14.1" = _few8Sxnl;
        "minecraft-1.14.2" = _few8Sxnl;
        "minecraft-1.14.3" = _few8Sxnl;
        "minecraft-1.14.4" = _few8Sxnl;
        "minecraft-1.15" = _few8Sxnl;
        "minecraft-1.15.1" = _few8Sxnl;
        "minecraft-1.15.2" = _few8Sxnl;
        "minecraft-1.16" = _few8Sxnl;
        "minecraft-1.16.1" = _few8Sxnl;
        "minecraft-1.16.2" = _few8Sxnl;
        "minecraft-1.16.3" = _few8Sxnl;
        "minecraft-1.16.4" = _few8Sxnl;
        "minecraft-1.16.5" = _few8Sxnl;
        "minecraft-1.17" = _few8Sxnl;
        "minecraft-1.17.1" = _few8Sxnl;
        "minecraft-1.18" = _few8Sxnl;
        "minecraft-1.18.1" = _few8Sxnl;
        "minecraft-1.18.2" = _few8Sxnl;
        ...
        "minecraft-1.7.2" = _few8Sxnl;
        "minecraft-1.7.3" = _few8Sxnl;
        "minecraft-1.7.4" = _few8Sxnl;
        "minecraft-1.7.5" = _few8Sxnl;
        "minecraft-1.7.6" = _few8Sxnl;
        "minecraft-1.7.7" = _few8Sxnl;
        "minecraft-1.7.8" = _few8Sxnl;
        "minecraft-1.7.9" = _few8Sxnl;
        "minecraft-1.7.10" = _few8Sxnl;
        "minecraft-1.8" = _few8Sxnl;
        "minecraft-1.8.1" = _few8Sxnl;
        "minecraft-1.8.2" = _few8Sxnl;
        "minecraft-1.8.3" = _few8Sxnl;
        "minecraft-1.8.4" = _few8Sxnl;
        "minecraft-1.8.5" = _few8Sxnl;
        "minecraft-1.8.6" = _few8Sxnl;
        "minecraft-1.8.7" = _few8Sxnl;
        "minecraft-1.8.8" = _few8Sxnl;
        "minecraft-23w35a" = _few8Sxnl;
        "minecraft-1.20.2-pre1" = _few8Sxnl;
        "minecraft-24w03a" = _few8Sxnl;
        "minecraft-24w03b" = _few8Sxnl;
        "minecraft-24w04a" = _few8Sxnl;
        "minecraft-24w05a" = _few8Sxnl;
        "minecraft-24w05b" = _few8Sxnl;
        "minecraft-24w06a" = _few8Sxnl;
        "minecraft-24w07a" = _few8Sxnl;
        "minecraft-24w09a" = _few8Sxnl;
        "minecraft-24w10a" = _few8Sxnl;
        "minecraft-24w11a" = _few8Sxnl;
        "minecraft-24w12a" = _few8Sxnl;
        "minecraft-24w13a" = _few8Sxnl;
        "minecraft-24w14a" = _few8Sxnl;
        "minecraft-24w19a" = _few8Sxnl;
        "minecraft-24w19b" = _few8Sxnl;
        "minecraft-24w20a" = _few8Sxnl;
        "minecraft-24w40a" = _few8Sxnl;
        "minecraft-1.21.2-pre1" = _few8Sxnl;
        "minecraft-1.21.2-pre2" = _few8Sxnl;
        ...
        "pkg-0.1.3" = _eqTldcTf;
        "pkg-0.1.4" = _KCz4Dw3O;
        "pkg-0.1.5+dark" = _CIiX6x5E;
        "pkg-0.1.5+default" = _Cf6GCHRN;
        "pkg-0.1.8+dark" = _cybzzcNC;
        "pkg-0.1.8+default" = _qE8NTA2d;
        "pkg-0.1.8.1+default" = _FOBiTcVh;
        "pkg-0.1.9+dark" = _WRWtQSfG;
        "pkg-0.1.9+default" = _jTgndFLJ;
        "pkg-0.2.1+dark" = _dAeS1b1K;
        "pkg-0.2.1+default" = _a05ImVhp;
        "pkg-0.2.2+dark" = _GlZg7tQS;
        "pkg-0.2.2+default" = _pKr9mcQq;
        "pkg-1.0" = _5RS5rFKc;
