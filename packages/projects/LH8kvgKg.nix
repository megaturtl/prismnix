...
let
    versions = (let
        ...
        _RJ0K709d = {
            "id" = "RJ0K709d";
            "file" = "Marin_Kitagawa_Pack.zip";
            "hash" = "sha512-VuWLCyEHsZLl700RsHMySuOiI3N5wcNtqgiFBjalZ/m74kHgvTx/mwb4RyDeAOCC6q8IOClRRw1VbfhVOPsK0w==";
        };
    in {
        "yHOS9NgQ" = _yHOS9NgQ;
        "SZOSQzdP" = _SZOSQzdP;
        ...
        "r1112rfA" = _r1112rfA;
        "RJ0K709d" = _RJ0K709d;
        "minecraft-1.21.1" = _RJ0K709d;
        "minecraft-1.21" = _RJ0K709d;
        "minecraft-1.21.2" = _RJ0K709d;
        "minecraft-1.21.3" = _RJ0K709d;
        "minecraft-1.21.4" = _RJ0K709d;
        "minecraft-1.21.5" = _RJ0K709d;
        "minecraft-1.21.6" = _RJ0K709d;
        "minecraft-1.21.7" = _RJ0K709d;
        "minecraft-1.21.8" = _RJ0K709d;
        "minecraft-1.21.9" = _RJ0K709d;
        "minecraft-1.21.10" = _RJ0K709d;
        "minecraft-1.21.11" = _RJ0K709d;
        "minecraft-1.20" = _RJ0K709d;
        "minecraft-1.20.1" = _RJ0K709d;
        "minecraft-1.20.2" = _RJ0K709d;
        "minecraft-1.20.3" = _RJ0K709d;
        "minecraft-1.20.4" = _RJ0K709d;
        "minecraft-1.20.5" = _RJ0K709d;
        "minecraft-1.20.6" = _RJ0K709d;
        "minecraft-26.1" = _RJ0K709d;
        "minecraft-26.1.1" = _RJ0K709d;
        "minecraft-26.1.2" = _RJ0K709d;
        "minecraft-26.2" = _RJ0K709d;
        "pkg-0.3" = _yHOS9NgQ;
        "pkg-0.5" = _SZOSQzdP;
        "pkg-0.14" = _OV0Lh4Fw;
        "pkg-0.50" = _1rxfaOlv;
