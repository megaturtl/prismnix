...
let
    versions = (let
        ...
        _qo4uV9Ga = {
            "id" = "qo4uV9Ga";
            "file" = "Doku's RPG.zip";
            "hash" = "sha512-9SOwAFNQygQHrmlrsJD46OFoF2ShPm0xBN+qQz7db5vgE2Bp5Kk6PG4+5CmAnTCV+45lPs0BOa1r6S7FkIWVLw==";
        };
        _Vkx1CuhL = {
            "id" = "Vkx1CuhL";
            "file" = "Doku's RPG b1.4 - b1.6.6.zip";
            "hash" = "sha512-eWehCOM461dN5XUH1gnJs3tkKDsdzhus5ffsnofaq01wXtPpjSlAfoW4/SNDfZBP59ct9lcHqqGxHYzsXA3RNA==";
        };
        _8eSf6AnR = {
            "id" = "8eSf6AnR";
            "file" = "Doku's RPG b1.7 - b1.7.3.zip";
            "hash" = "sha512-NumSl9G7SZRADKeo21FPSXBW1HO4U1e8ufRsWI9/iTrtzLxGf3EwQUUQrFGvi5Qwi9aEUEec84xeRmd6NlDEcA==";
        };
        _tshjw1ZF = {
            "id" = "tshjw1ZF";
            "file" = "Doku's RPG 1.0 - 1.3.2.zip";
            "hash" = "sha512-g6lJbflMegS0+a/GdeVdpTQFGI5Zk+0qKoTeCb7zFudIuTT45SNeWcfOlle/MRHyq7e7c+un1uqSgiFVcjNxdA==";
        };
        _adqlnyQc = {
            "id" = "adqlnyQc";
            "file" = "Doku's RPG 1.4 - 1.4.7.zip";
            "hash" = "sha512-aSFoGBUE/lSWA0V+FCHvBEXo6EIUXMb2ywXtQCtGYFj11Os9xc8NPG7taf2bjoilTdj7raReCB2DXwrQOloX1w==";
        };
        _da6ZJJE5 = {
            "id" = "da6ZJJE5";
            "file" = "Doku's RPG 1.5 - 1.5.2.zip";
            "hash" = "sha512-Yk5hUzqajbSkpweHO7bj/ErYxpMbjzHUWu1bLr0e0CGQufEVL4k7ihEB68GrTw9pAjuMrWy6DVhI24I8zsclLg==";
        };
        _e6BmbtDs = {
            "id" = "e6BmbtDs";
            "file" = "Doku's RPG 1.6 - 1.8.9.zip";
            "hash" = "sha512-yvoFCCgaOHrdFaAjx2WkEPNTf6maN5Xvimsi/WuQFwsfC7Jm/60mVB99DNtgpAoIw+0DwXhj1BjSuG5cjZWWOA==";
        };
        _j8rVmD4r = {
            "id" = "j8rVmD4r";
            "file" = "Doku's RPG 1.9 - 1.9.4.zip";
            "hash" = "sha512-2KbSyl1N0LdIlEukf4zlZtHL19QhTDMlAOx0pWGxO76n4eWpmmYL4vzOUlvbMVXwn8kS+EOKGrtifgIcmuNyfA==";
        };
        _hJJrSsbX = {
            "id" = "hJJrSsbX";
            "file" = "Doku's RPG 1.10 - 1.12.2.zip";
            "hash" = "sha512-2zCFHDZ1SxArvtPCqKlw3O8ozpK0OU195dC6gkdjTDO6HE+1fbdQUCBaqjSuqmerVCbvsrAuac/WVfKmHUs2RA==";
        };
        _UEVbDnBw = {
            "id" = "UEVbDnBw";
            "file" = "Doku's RPG 1.13 - 1.14.4.zip";
            "hash" = "sha512-6yZRyaN9WETYWFjSaqdx8h6okfy2GAOKIgyMziCRtV2muMzOg5+QYr7aBQoLPCN7AMXOh3qSEvnyhzAxEOBMvA==";
        };
        _cgVMbpoc = {
            "id" = "cgVMbpoc";
            "file" = "Doku's RPG 1.15 - 1.16.1.zip";
            "hash" = "sha512-m3IqsRVEieRzmChRCntBmVz2Gro+//uF15Ljcg9XCz3UXER7pkwCFH8y2KxoqZiJAZ+iBc5vmLPLR87KLUqm5g==";
        };
        _EwpUNAWz = {
            "id" = "EwpUNAWz";
            "file" = "Doku's RPG 1.16.2 - 1.19.2.zip";
            "hash" = "sha512-gIMmkSJ8Gq77Z1W74hgTe0UEnI7djiXa4WB6ZxjB8ryS7f6W/4dt1NZyGfczrCmxU5V6Q68fNja5N0BKvd6iFA==";
        };
        _i4gFlAVK = {
            "id" = "i4gFlAVK";
            "file" = "Doku's RPG 1.19.3 - 1.20.1.zip";
            "hash" = "sha512-SPPD2JyErDrCsMqo0CfQZYmVOCKiFQxyIPoH93ce8oarhR7EH4XoZzHII4zibwF3dU9icU47w+Iobr2Agwr5yg==";
        };
        _SNO8Txwf = {
            "id" = "SNO8Txwf";
            "file" = "Doku's RPG 1.20.2 - 1.21.11.zip";
            "hash" = "sha512-HN9zABwTujvi88JMztK9nt2QGyjt9JXahQkHNix2XUjwCwWu/7Hab1ggvu3xBO4lFQE+7EyjoBaeb/klSuR+UQ==";
        };
        _aKSBOCBX = {
            "id" = "aKSBOCBX";
            "file" = "Doku's RPG 26.1 - 26.2.zip";
            "hash" = "sha512-t+cDIwE7RHfvF5sIhp3VIIz/e9kgPUttA0FmRoQH03RoHgu8Nin2EDio98SuNET2J6qcZ6tOGPgEbdo38sGW0A==";
        };
        _yZnsAczt = {
            "id" = "yZnsAczt";
            "file" = "Doku's RPG.zip";
            "hash" = "sha512-EOgOSnM15VJgfsdoJKy2c5K7FVqVESO9vJtma2d2eEr2xvdXGSt2Dou2s5jDR4+2vZZSqnrTBTllsqeU7/coZg==";
        };
        _uPaOOygS = {
            "id" = "uPaOOygS";
            "file" = "Doku's RPG.zip";
            "hash" = "sha512-WKBbBY5HBgvh7064BDKZ+6BWTrwt0pafVJn8uk4xxRI0Tb4imc6KMKssYC81+QlhKMQR31FBPP/xY37FAjZLVA==";
        };
    in {
        "2iXLUq8j" = _2iXLUq8j;
        "eRA0HyEr" = _eRA0HyEr;
        ...
        "yZnsAczt" = _yZnsAczt;
        "uPaOOygS" = _uPaOOygS;
        "minecraft-b1.4" = _Vkx1CuhL;
        "minecraft-b1.4_01" = _kdaaPFkT;
        "minecraft-b1.5" = _Vkx1CuhL;
        "minecraft-b1.5_01" = _kdaaPFkT;
        "minecraft-b1.6" = _Vkx1CuhL;
        "minecraft-b1.6.1" = _Vkx1CuhL;
        "minecraft-b1.6.2" = _Vkx1CuhL;
        "minecraft-b1.6.3" = _Vkx1CuhL;
        "minecraft-b1.6.4" = _Vkx1CuhL;
        "minecraft-b1.6.5" = _Vkx1CuhL;
        "minecraft-b1.6.6" = _Vkx1CuhL;
        "minecraft-b1.7" = _8eSf6AnR;
        "minecraft-b1.7.2" = _8eSf6AnR;
        "minecraft-b1.7.3" = _8eSf6AnR;
        "minecraft-b1.8" = _tshjw1ZF;
        "minecraft-b1.8.1" = _tshjw1ZF;
        "minecraft-1.0" = _tshjw1ZF;
        "minecraft-1.1" = _tshjw1ZF;
        "minecraft-1.2.1" = _tshjw1ZF;
        "minecraft-1.2.2" = _tshjw1ZF;
        "minecraft-1.2.3" = _tshjw1ZF;
        "minecraft-1.2.4" = _tshjw1ZF;
        "minecraft-1.2.5" = _tshjw1ZF;
        "minecraft-1.3.1" = _tshjw1ZF;
        "minecraft-1.3.2" = _tshjw1ZF;
        "minecraft-1.4.2" = _adqlnyQc;
        "minecraft-1.4.4" = _adqlnyQc;
        "minecraft-1.4.5" = _adqlnyQc;
        "minecraft-1.4.6" = _adqlnyQc;
        "minecraft-1.4.7" = _adqlnyQc;
        "minecraft-1.5.1" = _da6ZJJE5;
        "minecraft-1.5.2" = _da6ZJJE5;
        "minecraft-1.6.1" = _e6BmbtDs;
        "minecraft-1.6.2" = _e6BmbtDs;
        "minecraft-1.6.4" = _e6BmbtDs;
        "minecraft-1.7.2" = _e6BmbtDs;
        "minecraft-1.7.3" = _e6BmbtDs;
        "minecraft-1.7.4" = _e6BmbtDs;
        "minecraft-1.7.5" = _e6BmbtDs;
        "minecraft-1.7.6" = _e6BmbtDs;
        "minecraft-1.7.7" = _e6BmbtDs;
        "minecraft-1.7.8" = _e6BmbtDs;
        "minecraft-1.7.9" = _e6BmbtDs;
        "minecraft-1.7.10" = _e6BmbtDs;
        "minecraft-1.8" = _e6BmbtDs;
        "minecraft-1.8.1" = _e6BmbtDs;
        "minecraft-1.8.2" = _e6BmbtDs;
        "minecraft-1.8.3" = _e6BmbtDs;
        "minecraft-1.8.4" = _e6BmbtDs;
        "minecraft-1.8.5" = _e6BmbtDs;
        "minecraft-1.8.6" = _e6BmbtDs;
        "minecraft-1.8.7" = _e6BmbtDs;
        "minecraft-1.8.8" = _e6BmbtDs;
        "minecraft-1.8.9" = _e6BmbtDs;
        "minecraft-1.9" = _j8rVmD4r;
        "minecraft-1.9.1" = _j8rVmD4r;
        "minecraft-1.9.2" = _j8rVmD4r;
        "minecraft-1.9.3" = _j8rVmD4r;
        "minecraft-1.9.4" = _j8rVmD4r;
        "minecraft-1.10" = _hJJrSsbX;
        "minecraft-1.10.1" = _hJJrSsbX;
        "minecraft-1.10.2" = _hJJrSsbX;
        "minecraft-1.11" = _hJJrSsbX;
        "minecraft-1.11.1" = _hJJrSsbX;
        "minecraft-1.11.2" = _hJJrSsbX;
        "minecraft-1.12" = _hJJrSsbX;
        "minecraft-1.12.1" = _hJJrSsbX;
        "minecraft-1.12.2" = _hJJrSsbX;
        "minecraft-1.13" = _UEVbDnBw;
        "minecraft-1.13.1" = _UEVbDnBw;
        "minecraft-1.13.2" = _UEVbDnBw;
        "minecraft-1.14" = _UEVbDnBw;
        "minecraft-1.14.1" = _UEVbDnBw;
        "minecraft-1.14.2" = _UEVbDnBw;
        "minecraft-1.14.3" = _UEVbDnBw;
        "minecraft-1.14.4" = _UEVbDnBw;
        "minecraft-1.15" = _cgVMbpoc;
        "minecraft-1.15.1" = _cgVMbpoc;
        "minecraft-1.15.2" = _cgVMbpoc;
        "minecraft-1.16" = _cgVMbpoc;
        "minecraft-1.16.1" = _cgVMbpoc;
        "minecraft-1.16.2" = _EwpUNAWz;
        "minecraft-1.16.3" = _EwpUNAWz;
        "minecraft-1.16.4" = _EwpUNAWz;
        "minecraft-1.16.5" = _EwpUNAWz;
        "minecraft-1.17" = _EwpUNAWz;
        "minecraft-1.17.1" = _EwpUNAWz;
        "minecraft-1.18" = _EwpUNAWz;
        "minecraft-1.18.1" = _EwpUNAWz;
        "minecraft-1.18.2" = _EwpUNAWz;
        "minecraft-1.19" = _EwpUNAWz;
        "minecraft-1.19.1" = _EwpUNAWz;
        "minecraft-1.19.2" = _EwpUNAWz;
        "minecraft-1.20.3" = _SNO8Txwf;
        "minecraft-1.20.4" = _SNO8Txwf;
        "minecraft-1.20.5" = _SNO8Txwf;
        "minecraft-1.20.6" = _SNO8Txwf;
        "minecraft-1.21" = _SNO8Txwf;
        "minecraft-1.21.1" = _SNO8Txwf;
        ...
        "minecraft-1.21.2" = _SNO8Txwf;
        "minecraft-1.21.3" = _SNO8Txwf;
        ...
        "minecraft-1.21.6" = _SNO8Txwf;
        "minecraft-1.21.7" = _SNO8Txwf;
        "minecraft-1.21.8" = _SNO8Txwf;
        ...
        "minecraft-1.21.9" = _SNO8Txwf;
        "minecraft-1.21.10-rc1" = _GhdiX9JX;
        "minecraft-1.21.10" = _SNO8Txwf;
        ...
        "minecraft-1.21.11" = _SNO8Txwf;
        "minecraft-26.1-snapshot-1" = _wqISqzPC;
        "minecraft-26.1-snapshot-10" = _tmfnLwFI;
        "minecraft-26.1-snapshot-11" = _vNvLirAp;
        "minecraft-1.3" = _tshjw1ZF;
        "minecraft-1.4" = _adqlnyQc;
        "minecraft-1.4.1" = _adqlnyQc;
        "minecraft-1.4.3" = _adqlnyQc;
        "minecraft-1.5" = _da6ZJJE5;
        "minecraft-1.19.3" = _i4gFlAVK;
        "minecraft-1.19.4" = _i4gFlAVK;
        "minecraft-1.20" = _i4gFlAVK;
        "minecraft-1.20.1" = _i4gFlAVK;
        ...
        "minecraft-26.1" = _aKSBOCBX;
        "minecraft-26.1.1-rc-1" = _bD777qbb;
        "minecraft-26.1.1" = _aKSBOCBX;
        "minecraft-26.1.2" = _aKSBOCBX;
        ...
        "minecraft-26.2" = _aKSBOCBX;
        "minecraft-26.3-snapshot-6" = _qo4uV9Ga;
        "minecraft-26.3-snapshot-7" = _qo4uV9Ga;
        "minecraft-1.6" = _e6BmbtDs;
        "minecraft-1.6.3" = _e6BmbtDs;
        "minecraft-26.3-snapshot-8" = _yZnsAczt;
        "minecraft-26.3-snapshot-9" = _yZnsAczt;
        "minecraft-26.3-pre-1" = _uPaOOygS;
        "minecraft-26.3-pre-2" = _uPaOOygS;
        "pkg-1.0" = _oxe4vqc1;
        "pkg-1.1" = _YyvGe1uD;
        "pkg-1.2" = _O8lpQ79U;
        "pkg-1.3" = _aKSBOCBX;
