...
let
    versions = (let
        ...
        _u4NlZVSL = {
            "id" = "u4NlZVSL";
            "file" = "GreatCombat-2.0.6.jar";
            "hash" = "sha512-Zwtaj3/XCDLKf1adEGhRd60+rVwImjYxtsf5Kie/sfhlrFlMRwM8dRj/tTJqjbsw5mUs6YqA60GrGuNiUJ63fQ==";
        };
    in {
        "67a2PY6g" = _67a2PY6g;
        "Z1jydyJd" = _Z1jydyJd;
        ...
        "aqITBbv3" = _aqITBbv3;
        "u4NlZVSL" = _u4NlZVSL;
        "paper-1.16" = _u4NlZVSL;
        "paper-1.16.1" = _u4NlZVSL;
        "paper-1.16.2" = _u4NlZVSL;
        "paper-1.16.3" = _u4NlZVSL;
        "paper-1.16.4" = _u4NlZVSL;
        "paper-1.16.5" = _u4NlZVSL;
        "paper-1.17" = _u4NlZVSL;
        "paper-1.17.1" = _u4NlZVSL;
        "paper-1.18" = _u4NlZVSL;
        "paper-1.18.1" = _u4NlZVSL;
        "paper-1.18.2" = _u4NlZVSL;
        "paper-1.19" = _u4NlZVSL;
        "paper-1.19.1" = _u4NlZVSL;
        "paper-1.19.2" = _u4NlZVSL;
        "paper-1.19.3" = _u4NlZVSL;
        "paper-1.19.4" = _u4NlZVSL;
        "paper-1.20" = _u4NlZVSL;
        "paper-1.20.1" = _u4NlZVSL;
        "paper-1.20.2" = _u4NlZVSL;
        "paper-1.20.3" = _u4NlZVSL;
        "paper-1.20.4" = _u4NlZVSL;
        "paper-1.20.5" = _u4NlZVSL;
        "paper-1.20.6" = _u4NlZVSL;
        "paper-1.21" = _u4NlZVSL;
        "paper-1.21.1" = _u4NlZVSL;
        "paper-1.21.2" = _u4NlZVSL;
        "paper-1.21.3" = _u4NlZVSL;
        "paper-1.21.4" = _u4NlZVSL;
        "paper-1.21.5" = _u4NlZVSL;
        "paper-1.21.6" = _u4NlZVSL;
        "paper-1.21.7" = _u4NlZVSL;
        "paper-1.21.8" = _u4NlZVSL;
        "paper-1.21.9" = _u4NlZVSL;
        "paper-1.21.10" = _u4NlZVSL;
        "paper-1.21.11" = _u4NlZVSL;
        "paper-26.1" = _u4NlZVSL;
        "paper-26.1.1" = _u4NlZVSL;
        "paper-26.1.2" = _u4NlZVSL;
        "paper-26.2" = _u4NlZVSL;
        "purpur-1.16" = _u4NlZVSL;
        "purpur-1.16.1" = _u4NlZVSL;
        "purpur-1.16.2" = _u4NlZVSL;
        "purpur-1.16.3" = _u4NlZVSL;
        "purpur-1.16.4" = _u4NlZVSL;
        "purpur-1.16.5" = _u4NlZVSL;
        "purpur-1.17" = _u4NlZVSL;
        "purpur-1.17.1" = _u4NlZVSL;
        "purpur-1.18" = _u4NlZVSL;
        "purpur-1.18.1" = _u4NlZVSL;
        "purpur-1.18.2" = _u4NlZVSL;
        "purpur-1.19" = _u4NlZVSL;
        "purpur-1.19.1" = _u4NlZVSL;
        "purpur-1.19.2" = _u4NlZVSL;
        "purpur-1.19.3" = _u4NlZVSL;
        "purpur-1.19.4" = _u4NlZVSL;
        "purpur-1.20" = _u4NlZVSL;
        "purpur-1.20.1" = _u4NlZVSL;
        "purpur-1.20.2" = _u4NlZVSL;
        "purpur-1.20.3" = _u4NlZVSL;
        "purpur-1.20.4" = _u4NlZVSL;
        "purpur-1.20.5" = _u4NlZVSL;
        "purpur-1.20.6" = _u4NlZVSL;
        "purpur-1.21" = _u4NlZVSL;
        "purpur-1.21.1" = _u4NlZVSL;
        "purpur-1.21.2" = _u4NlZVSL;
        "purpur-1.21.3" = _u4NlZVSL;
        "purpur-1.21.4" = _u4NlZVSL;
        "purpur-1.21.5" = _u4NlZVSL;
        "purpur-1.21.6" = _u4NlZVSL;
        "purpur-1.21.7" = _u4NlZVSL;
        "purpur-1.21.8" = _u4NlZVSL;
        "purpur-1.21.9" = _u4NlZVSL;
        "purpur-1.21.10" = _u4NlZVSL;
        "purpur-1.21.11" = _u4NlZVSL;
        "purpur-26.1" = _u4NlZVSL;
        "purpur-26.1.1" = _u4NlZVSL;
        "purpur-26.1.2" = _u4NlZVSL;
        "purpur-26.2" = _u4NlZVSL;
        "folia-1.16" = _u4NlZVSL;
        "folia-1.16.1" = _u4NlZVSL;
        "folia-1.16.2" = _u4NlZVSL;
        "folia-1.16.3" = _u4NlZVSL;
        "folia-1.16.4" = _u4NlZVSL;
        "folia-1.16.5" = _u4NlZVSL;
        "folia-1.17" = _u4NlZVSL;
        "folia-1.17.1" = _u4NlZVSL;
        "folia-1.18" = _u4NlZVSL;
        "folia-1.18.1" = _u4NlZVSL;
        "folia-1.18.2" = _u4NlZVSL;
        "folia-1.19" = _u4NlZVSL;
        "folia-1.19.1" = _u4NlZVSL;
        "folia-1.19.2" = _u4NlZVSL;
        "folia-1.19.3" = _u4NlZVSL;
        "folia-1.19.4" = _u4NlZVSL;
        "folia-1.20" = _u4NlZVSL;
        "folia-1.20.1" = _u4NlZVSL;
        "folia-1.20.2" = _u4NlZVSL;
        "folia-1.20.3" = _u4NlZVSL;
        "folia-1.20.4" = _u4NlZVSL;
        "folia-1.20.5" = _u4NlZVSL;
        "folia-1.20.6" = _u4NlZVSL;
        "folia-1.21" = _u4NlZVSL;
        "folia-1.21.1" = _u4NlZVSL;
        "folia-1.21.2" = _u4NlZVSL;
        "folia-1.21.3" = _u4NlZVSL;
        "folia-1.21.4" = _u4NlZVSL;
        "folia-1.21.5" = _u4NlZVSL;
        "folia-1.21.6" = _u4NlZVSL;
        "folia-1.21.7" = _u4NlZVSL;
        "folia-1.21.8" = _u4NlZVSL;
        "folia-1.21.9" = _u4NlZVSL;
        "folia-1.21.10" = _u4NlZVSL;
        "folia-1.21.11" = _u4NlZVSL;
        "folia-26.1" = _u4NlZVSL;
        "folia-26.1.1" = _u4NlZVSL;
        "folia-26.1.2" = _u4NlZVSL;
        "folia-26.2" = _u4NlZVSL;
        "pkg-1.7.0" = _67a2PY6g;
        "pkg-1.7.1" = _Z1jydyJd;
        "pkg-1.7.2" = _nxqPbutV;
        "pkg-1.7.3" = _dklx69Ut;
        "pkg-1.7.4" = _vZ0EMK1L;
        "pkg-1.8" = _q9MWMt4D;
        "pkg-1.8-beta3" = _dLr1xKvh;
        "pkg-1.8-release" = _Zpp7U3zo;
        "pkg-1.8.1" = _PeHK3Yt9;
        "pkg-1.8.2" = _wG9Z9osx;
        "pkg-1.8.3" = _VDSWpVGG;
        "pkg-1.8.4" = _JHY18U42;
