...
let
    ...
    in {
        ...
        "pkg-1.19.20039" = _DhBm2mpb;
        "pkg-1.19.20041" = _pSq95HsW;
        "pkg-1.19.20042" = _ykzAtJuE;
        "pkg-1.19.20043" = _zFfmRZcE;
        "pkg-1.19.20045" = _a1fVblvy;
        "pkg-1.19.3" = _Ucw6YlCF;
        "pkg-1.19.0" = _5qbf8xne;
        "pkg-1.18.2090" = _QDktXYtw;
        "pkg-15a2.4" = _Qb9eScDh;
        "pkg-1.19.4" = _LAyebLfr;
        "pkg-1.19.4.001" = _buERUKaO;
        "pkg-1.19.4.1" = _EySm9IWZ;
        "pkg-1.19.5" = _GQJlPJ1y;
        "pkg-1.20.002" = _nlL6ln6d;
        "pkg-1.20.03" = _OKbaDbk2;
        "pkg-1.20.04" = _PmB7im4p;
        "pkg-1.20.05" = _LaQI33QT;
        "pkg-1.20.06" = _KanYSsmt;
        "pkg-1.20.07" = _giPWbYnL;
        "pkg-1.20.08" = _1Apc618H;
        "pkg-1.20.09" = _z86dOVe7;
        "pkg-1.20.010" = _sUYnXsWA;
        "pkg-1.20.011" = _d0QGVTG5;
        "pkg-1.20.012" = _nxC1WZlx;
        "pkg-1.20.013" = _GpIzvoE1;
        "pkg-1.20.014" = _ZsIgsLTR;
        "pkg-1.20.015" = _5biFVjUx;
        "pkg-1.20.016" = _cTIgtcF2;
        "pkg-1.20.017" = _234uswd4;
        "pkg-1.20.017a" = _xNkbaa1k;
        "pkg-1.20.020" = _XZ5LOrXn;
        "pkg-1.20.021" = _VOGlIXPS;
        "pkg-1.20.022" = _lqvpuGpN;
        "pkg-1.20.023" = _vuQbftVn;
        "pkg-1.20.024" = _FFQVSJn9;
        "pkg-1.20.025" = _AqHC7vkT;
        "pkg-1.20.026.1" = _W5dDt626;
        "pkg-1.20.026.2" = _mio10JY2;
        "pkg-1.20.027" = _eNSH7awP;
        "pkg-1.20.028" = _FUZQBt82;
        "pkg-1.20.028.1" = _mbIVisnb;
        "pkg-1.20.028.2" = _eHSc3hc5;
        "pkg-1.20.029" = _L4wJALpo;
        "pkg-1.20.030" = _7uVUeD6G;
        "pkg-1.20.031" = _Qk8tH6iY;
        "pkg-1.20.032" = _bkkjvBDd;
        "pkg-1.20.033" = _CpGwwtwm;
        "pkg-1.20.034" = _2U5Wzfyn;
        "pkg-1.20.035" = _5ODIXOEJ;
        "pkg-1.20.036" = _eg1mE3SK;
        "pkg-1.20.037" = _pb1rjiDG;
        "pkg-1.20.038" = _yM1p6cu2;
        "pkg-1.20.039" = _MDia98SG;
        "pkg-1.20.040" = _ngqILpvN;
        "pkg-1.20.040.2" = _sLGvkVoo;
        "pkg-1.20.040.3" = _PXSYDRyG;
        "pkg-1.20.040.4" = _dqJ9bLJ5;
        "pkg-1.20.040.5" = _BWfkJq1p;
        "pkg-1.20.040.6" = _PTUzZxVC;
        "pkg-1.20.041" = _Xw7soBiH;
        "pkg-1.20.041.1" = _rsyRgX8X;
        "pkg-1.20.043" = _U9ss548d;
        "pkg-1.20.044" = _CpMwO9Ub;
        "pkg-1.20.044.1" = _AwmPmmqY;
        "pkg-1.20.045" = _j7ENtmzc;
        "pkg-1.20.046" = _46ojoZIu;
        "pkg-1.20.047" = _WKYJEXpH;
        "pkg-1.20.048.1" = _6z2cQNUh;
        "pkg-1.20.048.3" = _IR7FcdYg;
        "pkg-1.20.048.4" = _Va6LYI6Y;
        "pkg-1.20.049" = _oXUJrmek;
        "pkg-1.20.049.1" = _Na8noQSa;
        "pkg-1.20.049.2" = _4To05dUj;
        "pkg-1.20.049.3" = _zgD9Tn9u;
        "pkg-1.20.049.4" = _XsqtPcsL;
        "pkg-1.20.050" = _P7WMqLqw;
        "pkg-1.20.051" = _jo8AeYRm;
        "pkg-1.20.052" = _NMJZ8tbF;
        "pkg-1.20.053" = _ysaYKpNT;
        "pkg-1.20.054" = _bT7l8OtY;
        "pkg-1.20.055" = _n3eqKeoQ;
        "pkg-1.20.055.1" = _DwVpBq3A;
        "pkg-1.20.056" = _UplYd1jc;
        "pkg-1.20.056.1" = _PyIMBEMT;
        "pkg-1.20.056.2" = _OyVriBEJ;
        "pkg-1.20.057" = _2q8HlrEV;
        "pkg-1.20.057.1" = _ctvJ0OhP;
        "pkg-1.20.057.2" = _Xe7ut0MK;
        "pkg-1.20.057.3" = _hmqvo1zZ;
        "pkg-1.20.058" = _WhvB7gYK;
        "pkg-1.20.058.1" = _oPuUJhDI;
        "pkg-1.20.058.2" = _zv6MRDlE;
        "pkg-1.20.058.2.1" = _rwaSmxCL;
        "pkg-1.20.059" = _XmuUV1fn;
        "pkg-1.20.060.001" = _SgU6Ljm1;
        "pkg-1.20.060" = _Ql0zV7Hc;
        "pkg-1.20.060.1" = _nPdQThRq;
        "pkg-1.20.061" = _AolIdlC6;
        "pkg-1.20.061b" = _bOMNo3No;
        "pkg-1.20.062" = _M74282vf;
        "pkg-1.20.063" = _OmnX5FmD;
        "pkg-1.20.064" = _3svPh8Ch;
        "pkg-1.20.065" = _DRG1nLNd;
        "pkg-1.20.065.1" = _U8IvzDz0;
        "pkg-1.20.066" = _xOEEWV6N;
        "pkg-1.21" = _CrnGEA2k;
        "pkg-1.21.1.02" = _FguTFzr6;
        "pkg-1.21.1.04" = _PTzHfDoA;
