...
let
    ...
    in {
        ...
        "pkg-0.0.4+mc.1.21" = _YBFUEBaw;
        "pkg-0.0.5+mc.1.21.1" = _lFgpHZQd;
        "pkg-0.0.6+mc.1.21.3" = _5VtKfZ7M;
        "pkg-0.0.6+mc.1.21.1" = _o4fyQKNQ;
        "pkg-0.0.7+mc.1.21.4" = _ljylhaX1;
        "pkg-0.0.8+mc.1.21.4" = _7FFe24rS;
        "pkg-0.0.9+mc.1.21.4" = _mq6kEOJu;
        "pkg-0.0.10" = _3PJgb6DO;
        "pkg-0.0.11" = _3FfZLcBX;
        "pkg-0.0.12" = _y8n4cp3g;
        "pkg-0.0.13" = _eI6moDYQ;
        "pkg-0.0.14" = _7JTRjh0r;
        "pkg-0.0.15.beta0" = _N7cpxJ84;
        "pkg-0.0.15.beta1" = _9Jp6WcIs;
        "pkg-0.0.16.beta0" = _EYtj3wHD;
        "pkg-0.0.17.beta0" = _7s0rDqM4;
