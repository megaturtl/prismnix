...
let
    versions = (let
        ...
        _K8u72qQp = {
            "id" = "K8u72qQp";
            "file" = "BrutalNightmare-v6.8.509_DATAPACK.zip";
            "hash" = "sha512-58iZJCaiyUGjg/ShF6EUw5/SWwaUmMeXvHNFHsxqf68oxd5DFc0fjPdEQvJ2COrUEwOHIfCOy6cKdCfs60hUoA==";
        };
        _vwcQx31P = {
            "id" = "vwcQx31P";
            "file" = "BrutalNightmare-v6.8.509_MOD.jar";
            "hash" = "sha512-epEvSivnOh3ZYAiyzmO+CUr363IQzsmd1PW3tS2dmGR1+WkJRKh0pajAvOnB0zcpzwZ/hy+E7NdgI6dnhFND6Q==";
        };
        _FymX0Aqu = {
            "id" = "FymX0Aqu";
            "file" = "Brutal_Nightmare_-_Insane_Difficulty-6.8.509.jar";
            "hash" = "sha512-7CnUP+4qBHg4SBcz7s847b231w0QSRS2ajkNl8um/giebeWO4QZPcejdltUaQ9MSZiUZ8ns/8jikfZwfMxCD3w==";
        };
        _D67Nq2qx = {
            "id" = "D67Nq2qx";
            "file" = "BrutalNightmare-v6.9_DATAPACK.zip";
            "hash" = "sha512-2U6hsTZQqXAi1zm/NfFQfpMY3LpQXfmVBnQo/Vv49IOwu96CQlowtZJBpKdBB1UHvUoDxQjCllQwuxGvagTe2g==";
        };
        _UtNz9jlG = {
            "id" = "UtNz9jlG";
            "file" = "BrutalNightmare-v6.9_MOD.jar";
            "hash" = "sha512-4zYaAC80zw5DBH4LDM+wf9oyp8uKvabYUdz7EwH1lxkrjzaSG+y6EVstNcH6s5hpsCv4SgSUAX/cc/hax59vLA==";
        };
        _B6v2uDW1 = {
            "id" = "B6v2uDW1";
            "file" = "Brutal_Nightmare_-_Insane_Difficulty-6.9.jar";
            "hash" = "sha512-ebpKiWLwr7bToBFB3LYymK9xrBPb5N+yp6Jyc51NAosA4E/OjQ1nnK+zgEtWzoGyHFDSunnV6cGMxqV80gnJNg==";
        };
        _HrBatEMU = {
            "id" = "HrBatEMU";
            "file" = "BrutalNightmare-v6.9.3_DATAPACK.zip";
            "hash" = "sha512-oOhKLI89EtNoBJIbNvYqVuXx6tVY1DviMRQ1dPgyjnesiXnqGXVDZ8yi40FsR48SKReZVcnPKxX56ZNGn0Gc9g==";
        };
        _FO5eGNpL = {
            "id" = "FO5eGNpL";
            "file" = "BrutalNightmare-v6.9.3_MOD.jar";
            "hash" = "sha512-hXjbnOUDl2w5fqpmdOPPjMNsieEAd5BwjC2NntrLkmiU4+aS1yYtrOdRi5wLe7m6hYW8hAS5g9FgA5n4+mNAbg==";
        };
        _hyAMYiqc = {
            "id" = "hyAMYiqc";
            "file" = "BrutalNightmare-v6.9.5_DATAPACK.zip";
            "hash" = "sha512-UcmDlVpPTOgXI5bQum7m3R/TAteFbOk4rZEbqkjVJi0fijTO87lLBOSkSpZPwoHV5znrmh1ZDMIVrdPQk4kPzQ==";
        };
        _66RISQ73 = {
            "id" = "66RISQ73";
            "file" = "BrutalNightmare-v6.9.5_MOD.jar";
            "hash" = "sha512-HimoJM2kjZECyHNhQZszB1AHSRH1xw2rkr59Cr8wiqtFzfbqNVwcntOaXUFU8iltnJeS+PBbOudiLw3rTEv2Hg==";
        };
        _NhXmp0pM = {
            "id" = "NhXmp0pM";
            "file" = "Brutal_Nightmare_-_Insane_Difficulty-6.9.5.jar";
            "hash" = "sha512-EKM2OJzwszFcghnTKTkCZNeOKLzUn0mS+T3zeTJ5fty+63ioj+Y27P8fwG+Lt9RsLDM0/r9ZtrSx3Vdhiq8OqQ==";
        };
        _r1iALvcz = {
            "id" = "r1iALvcz";
            "file" = "BrutalNightmare-v6.9.8_DATAPACK.zip";
            "hash" = "sha512-3QPyBbkNjpuNm3hNGOM3nIQUkneC3UcGsKdMREgCwCimXFGQsGh0UO4qjgOLJ8L0UqRO0oVdOR2J+7ACm6vlaw==";
        };
        _op7bEZvy = {
            "id" = "op7bEZvy";
            "file" = "BrutalNightmare-v6.9.8_MOD.jar";
            "hash" = "sha512-dgjLZPcO0Ez4nXN+DH2eRfhbPjWCTSaeGp2PKTx/Pbwcjh0Y3JuzbSL+JOAO0BfpEEbsN5YrXedxeAjtzcuUBQ==";
        };
    in {
        "NyAbZeFD" = _NyAbZeFD;
        "FejIFORy" = _FejIFORy;
        ...
        "r1iALvcz" = _r1iALvcz;
        "op7bEZvy" = _op7bEZvy;
        "datapack-1.16" = _r1iALvcz;
        "datapack-1.16.1" = _r1iALvcz;
        "datapack-1.16.2" = _r1iALvcz;
        "datapack-1.16.3" = _r1iALvcz;
        "datapack-1.16.4" = _r1iALvcz;
        "datapack-1.16.5" = _r1iALvcz;
        "datapack-1.17" = _r1iALvcz;
        "datapack-1.17.1" = _r1iALvcz;
        "datapack-1.18" = _r1iALvcz;
        "datapack-1.18.1" = _r1iALvcz;
        "datapack-1.18.2" = _r1iALvcz;
        "datapack-1.19" = _r1iALvcz;
        "datapack-1.19.1" = _r1iALvcz;
        "datapack-1.19.2" = _r1iALvcz;
        "datapack-1.19.3" = _r1iALvcz;
        "datapack-1.19.4" = _r1iALvcz;
        "datapack-1.20" = _r1iALvcz;
        "datapack-1.20.1" = _r1iALvcz;
        "datapack-1.20.2" = _r1iALvcz;
        "datapack-1.20.3" = _r1iALvcz;
        "datapack-1.20.4" = _r1iALvcz;
        "datapack-1.20.5" = _r1iALvcz;
        "datapack-1.20.6" = _r1iALvcz;
        "datapack-1.21" = _r1iALvcz;
        "datapack-1.21.1" = _r1iALvcz;
        "datapack-1.21.2" = _r1iALvcz;
        "datapack-1.21.3" = _r1iALvcz;
        "datapack-1.21.4" = _r1iALvcz;
        "datapack-1.21.5" = _r1iALvcz;
        "datapack-1.21.6" = _r1iALvcz;
        "datapack-1.21.7" = _r1iALvcz;
        "datapack-1.21.8" = _r1iALvcz;
        "datapack-1.21.9" = _r1iALvcz;
        "datapack-1.21.10" = _r1iALvcz;
        "datapack-1.21.11" = _r1iALvcz;
        "datapack-26.1" = _r1iALvcz;
        "datapack-26.1.1" = _r1iALvcz;
        "datapack-26.1.2" = _r1iALvcz;
        "datapack-26.2" = _r1iALvcz;
        "fabric-1.16" = _op7bEZvy;
        "fabric-1.16.1" = _op7bEZvy;
        "fabric-1.16.2" = _op7bEZvy;
        "fabric-1.16.3" = _op7bEZvy;
        "fabric-1.16.4" = _op7bEZvy;
        "fabric-1.16.5" = _op7bEZvy;
        "fabric-1.17" = _op7bEZvy;
        "fabric-1.17.1" = _op7bEZvy;
        "fabric-1.18" = _op7bEZvy;
        "fabric-1.18.1" = _op7bEZvy;
        "fabric-1.18.2" = _op7bEZvy;
        "fabric-1.19" = _op7bEZvy;
        "fabric-1.19.1" = _op7bEZvy;
        "fabric-1.19.2" = _op7bEZvy;
        "fabric-1.19.3" = _op7bEZvy;
        "fabric-1.19.4" = _op7bEZvy;
        "fabric-1.20" = _op7bEZvy;
        "fabric-1.20.1" = _op7bEZvy;
        "fabric-1.20.2" = _op7bEZvy;
        "fabric-1.20.3" = _op7bEZvy;
        "fabric-1.20.4" = _op7bEZvy;
        "fabric-1.20.5" = _op7bEZvy;
        "fabric-1.20.6" = _op7bEZvy;
        "fabric-1.21" = _op7bEZvy;
        "fabric-1.21.1" = _op7bEZvy;
        "fabric-1.21.2" = _op7bEZvy;
        "fabric-1.21.3" = _op7bEZvy;
        "fabric-1.21.4" = _op7bEZvy;
        "fabric-1.21.5" = _op7bEZvy;
        "fabric-1.21.6" = _op7bEZvy;
        "fabric-1.21.7" = _op7bEZvy;
        "fabric-1.21.8" = _op7bEZvy;
        "fabric-1.21.9" = _op7bEZvy;
        "fabric-1.21.10" = _op7bEZvy;
        "fabric-1.21.11" = _op7bEZvy;
        "fabric-26.1" = _op7bEZvy;
        "fabric-26.1.1" = _op7bEZvy;
        "fabric-26.1.2" = _op7bEZvy;
        "fabric-26.2" = _op7bEZvy;
        "forge-1.16" = _op7bEZvy;
        "forge-1.16.1" = _op7bEZvy;
        "forge-1.16.2" = _op7bEZvy;
        "forge-1.16.3" = _op7bEZvy;
        "forge-1.16.4" = _op7bEZvy;
        "forge-1.16.5" = _op7bEZvy;
        "forge-1.17" = _op7bEZvy;
        "forge-1.17.1" = _op7bEZvy;
        "forge-1.18" = _op7bEZvy;
        "forge-1.18.1" = _op7bEZvy;
        "forge-1.18.2" = _op7bEZvy;
        "forge-1.19" = _op7bEZvy;
        "forge-1.19.1" = _op7bEZvy;
        "forge-1.19.2" = _op7bEZvy;
        "forge-1.19.3" = _op7bEZvy;
        "forge-1.19.4" = _op7bEZvy;
        "forge-1.20" = _op7bEZvy;
        "forge-1.20.1" = _op7bEZvy;
        "forge-1.20.2" = _op7bEZvy;
        "forge-1.20.3" = _op7bEZvy;
        "forge-1.20.4" = _op7bEZvy;
        "forge-1.20.5" = _op7bEZvy;
        "forge-1.20.6" = _op7bEZvy;
        "forge-1.21" = _op7bEZvy;
        "forge-1.21.1" = _op7bEZvy;
        "forge-1.21.2" = _op7bEZvy;
        "forge-1.21.3" = _op7bEZvy;
        "forge-1.21.4" = _op7bEZvy;
        "forge-1.21.5" = _op7bEZvy;
        "forge-1.21.6" = _op7bEZvy;
        "forge-1.21.7" = _op7bEZvy;
        "forge-1.21.8" = _op7bEZvy;
        "forge-1.21.9" = _op7bEZvy;
        "forge-1.21.10" = _op7bEZvy;
        "forge-1.21.11" = _op7bEZvy;
        "forge-26.1" = _op7bEZvy;
        "forge-26.1.1" = _op7bEZvy;
        "forge-26.1.2" = _op7bEZvy;
        "forge-26.2" = _op7bEZvy;
        "neoforge-1.16" = _op7bEZvy;
        "neoforge-1.16.1" = _op7bEZvy;
        "neoforge-1.16.2" = _op7bEZvy;
        "neoforge-1.16.3" = _op7bEZvy;
        "neoforge-1.16.4" = _op7bEZvy;
        "neoforge-1.16.5" = _op7bEZvy;
        "neoforge-1.17" = _op7bEZvy;
        "neoforge-1.17.1" = _op7bEZvy;
        "neoforge-1.18" = _op7bEZvy;
        "neoforge-1.18.1" = _op7bEZvy;
        "neoforge-1.18.2" = _op7bEZvy;
        "neoforge-1.19" = _op7bEZvy;
        "neoforge-1.19.1" = _op7bEZvy;
        "neoforge-1.19.2" = _op7bEZvy;
        "neoforge-1.19.3" = _op7bEZvy;
        "neoforge-1.19.4" = _op7bEZvy;
        "neoforge-1.20" = _op7bEZvy;
        "neoforge-1.20.1" = _op7bEZvy;
        "neoforge-1.20.2" = _op7bEZvy;
        "neoforge-1.20.3" = _op7bEZvy;
        "neoforge-1.20.4" = _op7bEZvy;
        "neoforge-1.20.5" = _op7bEZvy;
        "neoforge-1.20.6" = _op7bEZvy;
        "neoforge-1.21" = _op7bEZvy;
        "neoforge-1.21.1" = _op7bEZvy;
        "neoforge-1.21.2" = _op7bEZvy;
        "neoforge-1.21.3" = _op7bEZvy;
        "neoforge-1.21.4" = _op7bEZvy;
        "neoforge-1.21.5" = _op7bEZvy;
        "neoforge-1.21.6" = _op7bEZvy;
        "neoforge-1.21.7" = _op7bEZvy;
        "neoforge-1.21.8" = _op7bEZvy;
        "neoforge-1.21.9" = _op7bEZvy;
        "neoforge-1.21.10" = _op7bEZvy;
        "neoforge-1.21.11" = _op7bEZvy;
        "neoforge-26.1" = _op7bEZvy;
        "neoforge-26.1.1" = _op7bEZvy;
        "neoforge-26.1.2" = _op7bEZvy;
        "neoforge-26.2" = _op7bEZvy;
        "quilt-1.16" = _op7bEZvy;
        "quilt-1.16.1" = _op7bEZvy;
        "quilt-1.16.2" = _op7bEZvy;
        "quilt-1.16.3" = _op7bEZvy;
        "quilt-1.16.4" = _op7bEZvy;
        "quilt-1.16.5" = _op7bEZvy;
        "quilt-1.17" = _op7bEZvy;
        "quilt-1.17.1" = _op7bEZvy;
        "quilt-1.18" = _op7bEZvy;
        "quilt-1.18.1" = _op7bEZvy;
        "quilt-1.18.2" = _op7bEZvy;
        "quilt-1.19" = _op7bEZvy;
        "quilt-1.19.1" = _op7bEZvy;
        "quilt-1.19.2" = _op7bEZvy;
        "quilt-1.19.3" = _op7bEZvy;
        "quilt-1.19.4" = _op7bEZvy;
        "quilt-1.20" = _op7bEZvy;
        "quilt-1.20.1" = _op7bEZvy;
        "quilt-1.20.2" = _op7bEZvy;
        "quilt-1.20.3" = _op7bEZvy;
        "quilt-1.20.4" = _op7bEZvy;
        "quilt-1.20.5" = _op7bEZvy;
        "quilt-1.20.6" = _op7bEZvy;
        "quilt-1.21" = _op7bEZvy;
        "quilt-1.21.1" = _op7bEZvy;
        "quilt-1.21.2" = _op7bEZvy;
        "quilt-1.21.3" = _op7bEZvy;
        "quilt-1.21.4" = _op7bEZvy;
        "quilt-1.21.5" = _op7bEZvy;
        "quilt-1.21.6" = _op7bEZvy;
        "quilt-1.21.7" = _op7bEZvy;
        "quilt-1.21.8" = _op7bEZvy;
        "quilt-1.21.9" = _op7bEZvy;
        "quilt-1.21.10" = _op7bEZvy;
        "quilt-1.21.11" = _op7bEZvy;
        "quilt-26.1" = _op7bEZvy;
        "quilt-26.1.1" = _op7bEZvy;
        "quilt-26.1.2" = _op7bEZvy;
        "quilt-26.2" = _op7bEZvy;
        "bukkit-1.16" = _NhXmp0pM;
        "bukkit-1.16.1" = _NhXmp0pM;
        "bukkit-1.16.2" = _NhXmp0pM;
        "bukkit-1.16.3" = _NhXmp0pM;
        "bukkit-1.16.4" = _NhXmp0pM;
        "bukkit-1.16.5" = _NhXmp0pM;
        "bukkit-1.17" = _NhXmp0pM;
        "bukkit-1.17.1" = _NhXmp0pM;
        "bukkit-1.18" = _NhXmp0pM;
        "bukkit-1.18.1" = _NhXmp0pM;
        "bukkit-1.18.2" = _NhXmp0pM;
        "bukkit-1.19" = _NhXmp0pM;
        "bukkit-1.19.1" = _NhXmp0pM;
        "bukkit-1.19.2" = _NhXmp0pM;
        "bukkit-1.19.3" = _NhXmp0pM;
        "bukkit-1.19.4" = _NhXmp0pM;
        "bukkit-1.20" = _NhXmp0pM;
        "bukkit-1.20.1" = _NhXmp0pM;
        "bukkit-1.20.2" = _NhXmp0pM;
        "bukkit-1.20.3" = _NhXmp0pM;
        "bukkit-1.20.4" = _NhXmp0pM;
        "bukkit-1.20.5" = _NhXmp0pM;
        "bukkit-1.20.6" = _NhXmp0pM;
        "bukkit-1.21" = _NhXmp0pM;
        "bukkit-1.21.1" = _NhXmp0pM;
        "bukkit-1.21.2" = _NhXmp0pM;
        "bukkit-1.21.3" = _NhXmp0pM;
        "bukkit-1.21.4" = _NhXmp0pM;
        "bukkit-1.21.5" = _NhXmp0pM;
        "bukkit-1.21.6" = _NhXmp0pM;
        "bukkit-1.21.7" = _NhXmp0pM;
        "bukkit-1.21.8" = _NhXmp0pM;
        "bukkit-1.21.9" = _NhXmp0pM;
        "bukkit-1.21.10" = _NhXmp0pM;
        "bukkit-1.21.11" = _NhXmp0pM;
        "bukkit-26.1" = _NhXmp0pM;
        "bukkit-26.1.1" = _NhXmp0pM;
        "bukkit-26.1.2" = _NhXmp0pM;
        "bukkit-26.2" = _NhXmp0pM;
        "paper-1.16" = _NhXmp0pM;
        "paper-1.16.1" = _NhXmp0pM;
        "paper-1.16.2" = _NhXmp0pM;
        "paper-1.16.3" = _NhXmp0pM;
        "paper-1.16.4" = _NhXmp0pM;
        "paper-1.16.5" = _NhXmp0pM;
        "paper-1.17" = _NhXmp0pM;
        "paper-1.17.1" = _NhXmp0pM;
        "paper-1.18" = _NhXmp0pM;
        "paper-1.18.1" = _NhXmp0pM;
        "paper-1.18.2" = _NhXmp0pM;
        "paper-1.19" = _NhXmp0pM;
        "paper-1.19.1" = _NhXmp0pM;
        "paper-1.19.2" = _NhXmp0pM;
        "paper-1.19.3" = _NhXmp0pM;
        "paper-1.19.4" = _NhXmp0pM;
        "paper-1.20" = _NhXmp0pM;
        "paper-1.20.1" = _NhXmp0pM;
        "paper-1.20.2" = _NhXmp0pM;
        "paper-1.20.3" = _NhXmp0pM;
        "paper-1.20.4" = _NhXmp0pM;
        "paper-1.20.5" = _NhXmp0pM;
        "paper-1.20.6" = _NhXmp0pM;
        "paper-1.21" = _NhXmp0pM;
        "paper-1.21.1" = _NhXmp0pM;
        "paper-1.21.2" = _NhXmp0pM;
        "paper-1.21.3" = _NhXmp0pM;
        "paper-1.21.4" = _NhXmp0pM;
        "paper-1.21.5" = _NhXmp0pM;
        "paper-1.21.6" = _NhXmp0pM;
        "paper-1.21.7" = _NhXmp0pM;
        "paper-1.21.8" = _NhXmp0pM;
        "paper-1.21.9" = _NhXmp0pM;
        "paper-1.21.10" = _NhXmp0pM;
        "paper-1.21.11" = _NhXmp0pM;
        "paper-26.1" = _NhXmp0pM;
        "paper-26.1.1" = _NhXmp0pM;
        "paper-26.1.2" = _NhXmp0pM;
        "paper-26.2" = _NhXmp0pM;
        "purpur-1.16" = _NhXmp0pM;
        "purpur-1.16.1" = _NhXmp0pM;
        "purpur-1.16.2" = _NhXmp0pM;
        "purpur-1.16.3" = _NhXmp0pM;
        "purpur-1.16.4" = _NhXmp0pM;
        "purpur-1.16.5" = _NhXmp0pM;
        "purpur-1.17" = _NhXmp0pM;
        "purpur-1.17.1" = _NhXmp0pM;
        "purpur-1.18" = _NhXmp0pM;
        "purpur-1.18.1" = _NhXmp0pM;
        "purpur-1.18.2" = _NhXmp0pM;
        "purpur-1.19" = _NhXmp0pM;
        "purpur-1.19.1" = _NhXmp0pM;
        "purpur-1.19.2" = _NhXmp0pM;
        "purpur-1.19.3" = _NhXmp0pM;
        "purpur-1.19.4" = _NhXmp0pM;
        "purpur-1.20" = _NhXmp0pM;
        "purpur-1.20.1" = _NhXmp0pM;
        "purpur-1.20.2" = _NhXmp0pM;
        "purpur-1.20.3" = _NhXmp0pM;
        "purpur-1.20.4" = _NhXmp0pM;
        "purpur-1.20.5" = _NhXmp0pM;
        "purpur-1.20.6" = _NhXmp0pM;
        "purpur-1.21" = _NhXmp0pM;
        "purpur-1.21.1" = _NhXmp0pM;
        "purpur-1.21.2" = _NhXmp0pM;
        "purpur-1.21.3" = _NhXmp0pM;
        "purpur-1.21.4" = _NhXmp0pM;
        "purpur-1.21.5" = _NhXmp0pM;
        "purpur-1.21.6" = _NhXmp0pM;
        "purpur-1.21.7" = _NhXmp0pM;
        "purpur-1.21.8" = _NhXmp0pM;
        "purpur-1.21.9" = _NhXmp0pM;
        "purpur-1.21.10" = _NhXmp0pM;
        "purpur-1.21.11" = _NhXmp0pM;
        "purpur-26.1" = _NhXmp0pM;
        "purpur-26.1.1" = _NhXmp0pM;
        "purpur-26.1.2" = _NhXmp0pM;
        "purpur-26.2" = _NhXmp0pM;
        "spigot-1.16" = _NhXmp0pM;
        "spigot-1.16.1" = _NhXmp0pM;
        "spigot-1.16.2" = _NhXmp0pM;
        "spigot-1.16.3" = _NhXmp0pM;
        "spigot-1.16.4" = _NhXmp0pM;
        "spigot-1.16.5" = _NhXmp0pM;
        "spigot-1.17" = _NhXmp0pM;
        "spigot-1.17.1" = _NhXmp0pM;
        "spigot-1.18" = _NhXmp0pM;
        "spigot-1.18.1" = _NhXmp0pM;
        "spigot-1.18.2" = _NhXmp0pM;
        "spigot-1.19" = _NhXmp0pM;
        "spigot-1.19.1" = _NhXmp0pM;
        "spigot-1.19.2" = _NhXmp0pM;
        "spigot-1.19.3" = _NhXmp0pM;
        "spigot-1.19.4" = _NhXmp0pM;
        "spigot-1.20" = _NhXmp0pM;
        "spigot-1.20.1" = _NhXmp0pM;
        "spigot-1.20.2" = _NhXmp0pM;
        "spigot-1.20.3" = _NhXmp0pM;
        "spigot-1.20.4" = _NhXmp0pM;
        "spigot-1.20.5" = _NhXmp0pM;
        "spigot-1.20.6" = _NhXmp0pM;
        "spigot-1.21" = _NhXmp0pM;
        "spigot-1.21.1" = _NhXmp0pM;
        "spigot-1.21.2" = _NhXmp0pM;
        "spigot-1.21.3" = _NhXmp0pM;
        "spigot-1.21.4" = _NhXmp0pM;
        "spigot-1.21.5" = _NhXmp0pM;
        "spigot-1.21.6" = _NhXmp0pM;
        "spigot-1.21.7" = _NhXmp0pM;
        "spigot-1.21.8" = _NhXmp0pM;
        "spigot-1.21.9" = _NhXmp0pM;
        "spigot-1.21.10" = _NhXmp0pM;
        "spigot-1.21.11" = _NhXmp0pM;
        "spigot-26.1" = _NhXmp0pM;
        "spigot-26.1.1" = _NhXmp0pM;
        "spigot-26.1.2" = _NhXmp0pM;
        "spigot-26.2" = _NhXmp0pM;
        "pkg-1.0" = _NyAbZeFD;
        "pkg-1.0+mod" = _FejIFORy;
        "pkg-1.0.1" = _qxLBRs3h;
        "pkg-1.0.1+mod" = _7bttaN0t;
        "pkg-1.0.2" = _MaI61UTD;
        "pkg-1.0.2+mod" = _FrbjIamv;
        "pkg-1.0.3" = _7Tz6dGWw;
        "pkg-1.0.3+mod" = _2c71OpHE;
        "pkg-2.0" = _vb5wuBYS;
        "pkg-2.0+mod" = _3jSO4PtH;
        "pkg-2.1" = _jgFJMgW3;
        "pkg-2.1+mod" = _iWWZQnoP;
        "pkg-2.1.1" = _YJBfbDqo;
        "pkg-2.1.1+mod" = _z3TVz9wF;
        "pkg-3.0" = _Z7VVHSS6;
        "pkg-3.0+mod" = _sGbvWv4O;
        "pkg-3.0.1" = _1S1pflBh;
        "pkg-3.0.1+mod" = _OTxwalML;
        "pkg-3.0.2" = _1WGQiIid;
        "pkg-3.0.2+mod" = _k5gmbwnQ;
        "pkg-3.0.3" = _NF2OfVZ9;
        "pkg-3.0.3+mod" = _WdF8Ju4q;
        "pkg-3.0.4.1" = _9fc7Okg8;
        "pkg-3.0.4.1+mod" = _7ws7PqfS;
        "pkg-4.0" = _Yx3hTOZC;
        "pkg-4.0+mod" = _vnC7NPI6;
        "pkg-4.1" = _TRCEme5h;
        "pkg-4.1+mod" = _UXyCfdhz;
        "pkg-4.2" = _BgS4Zqlf;
        "pkg-4.2+mod" = _PwVK7BB6;
        "pkg-4.3" = _2QmK3mCY;
        "pkg-4.3+mod" = _6tGoAnHY;
        "pkg-4.4" = _5MhvZYF0;
        "pkg-4.4+mod" = _c5D8DT11;
        "pkg-4.5" = _j1PC16Wq;
        "pkg-4.5+mod" = _SSKfbYkX;
        "pkg-4.6" = _6lHWuBL0;
        "pkg-4.6-plugin" = _E4IoZVk0;
        "pkg-4.6.1" = _EYWamflU;
        "pkg-4.6.2" = _DoFvg22j;
        "pkg-4.6.3" = _GfIWAc3A;
        "pkg-4.6.4" = _tVQzNoDP;
        "pkg-4.6.4.0.1" = _SbWlojBn;
        "pkg-4.6.5" = _fhckrZzo;
        "pkg-4.6.5.1" = _9mBAAcmg;
        "pkg-4.6.5.2" = _4ZSovWOI;
        "pkg-4.7" = _OPNOUIoo;
        "pkg-4.7+mod" = _BO6xGyN3;
        "pkg-4.8" = _GoFMN5vb;
        "pkg-4.9" = _OT9Hsm6e;
        "pkg-5.0" = _BT0dTcWC;
        "pkg-5.1" = _nO3LLKrK;
        ...
        "pkg-6.6" = _Zg0RoLfc;
        "pkg-6.8" = _fTaPyXAI;
        "pkg-6.8.402" = _X0apMa5N;
        "pkg-6.8.481" = _orKgzLsl;
        "pkg-6.8.509" = _FymX0Aqu;
        "pkg-6.9" = _B6v2uDW1;
        "pkg-6.9.3" = _FO5eGNpL;
        "pkg-6.9.5" = _NhXmp0pM;
        "pkg-6.9.8" = _op7bEZvy;
