...
let
    versions = (let
        ...
        _wX2qtgas = {
            "id" = "wX2qtgas";
            "file" = "magitech-2.1.0.jar";
            "hash" = "sha512-JZ48i7xiBKnuH2JpNx8PFj8A7mxno04Y7z6BBtAieRF09/PGMLrn2qW0Hlt/E9a0t6zqZTNZhbbmUag4jq+QOA==";
        };
        _OUeUkJRh = {
            "id" = "OUeUkJRh";
            "file" = "magitech-2.2.0.jar";
            "hash" = "sha512-H9jp/rk/PpEKQUzwEaorNq7PFMAcmQ9lg4O7jLD3jcHBcF97nsPZxOFZlhweROYKS4PiMbdE5LIkNfmvq6NKpg==";
        };
        _Hwf0Rs7o = {
            "id" = "Hwf0Rs7o";
    ...
    in {
        ...
        "pkg-0.9.1" = _hyLi3qrD;
        "pkg-0.9.2" = _29iXcO07;
        "pkg-0.10.0" = _JWkc1KbZ;
        "pkg-0.10.1" = _vXfSK3Uh;
        "pkg-0.10.2" = _1eeqLyIa;
        "pkg-0.11.0" = _kz4Qyjke;
        "pkg-0.11.1" = _RCMzzIBG;
        "pkg-0.12.0" = _xAzfTAbZ;
        "pkg-0.12.1" = _UkTL4or7;
        "pkg-1.0.0-beta" = _L62okdSj;
        "pkg-1.0.0-beta-2" = _sNH7VprN;
        "pkg-1.0.1" = _6afpgVws;
        "pkg-1.0.2" = _XOGmvGOf;
        "pkg-1.1.0" = _tmS7AlCZ;
        "pkg-1.1.1" = _1iX1nlRI;
