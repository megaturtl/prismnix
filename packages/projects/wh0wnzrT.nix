...
let
    ...
    in {
        ...
        "pkg-1.3-fabric-1.1.1" = _6AMLxePe;
        "pkg-1.3-fabric-1.1.2" = _kIEt0t3s;
        "pkg-1.4-fabric-1.0.0" = _KbcdcvVF;
        "pkg-1.4-fabric-1.0.1" = _5tgbkysZ;
        "pkg-1.4-forge-1.0.0" = _vee4pLXJ;
        "pkg-1.3-fabric-1.1.3" = _hNKTzzwP;
        "pkg-1.4-fabric-1.0.2" = _D0mvhf2R;
        "pkg-1.4-forge-1.0.1" = _rFshgLzD;
        "pkg-1.4-fabric-1.0.3" = _bzOAONEm;
        "pkg-1.5-fabric-1.0.0" = _UYb34enN;
        "pkg-1.5-forge-1.0.0" = _3qoALweY;
        "pkg-1.5-forge-1.0.1" = _H2jqJ6iw;
        "pkg-1.5-fabric-1.0.1" = _F4mKBOBK;
        "pkg-1.6-fabric-1.0.0" = _CdGL0J1R;
        "pkg-1.6-fabric-1.0.1" = _yqyJSngh;
        "pkg-1.6-neoforge-1.0.1" = _rCKA0U9H;
        "pkg-1.6-neoforge-1.0.2" = _GmcnVyXE;
        "pkg-1.6-fabric-1.1.0" = _MmZt1RWB;
        "pkg-1.6-neoforge-1.1.0" = _3igbSEnc;
        "pkg-1.6-fabric-1.2.0" = _xdVsYMBV;
        "pkg-1.6-neoforge-1.2.0" = _ZqCHi0yc;
        "pkg-1.6-fabric-1.2.1" = _9DQtuwLO;
        "pkg-1.6-neoforge-1.2.1" = _NZ3yExwf;
        "pkg-1.6-neoforge-1.2.2" = _BtKm0WzS;
        "pkg-1.6-neoforge-1.2.3" = _SLb2aN0u;
        "pkg-1.6-fabric-1.2.3" = _avTfbHbN;
        "pkg-1.6-neoforge-1.3.0" = _CtDdOnR5;
        "pkg-1.6-fabric-1.3.0" = _Dq1Vwc9N;
        "pkg-1.6.1-fabric-1.4.0" = _HnYtqC9H;
        "pkg-1.6.1-neoforge-1.4.0" = _pKRQ6sBJ;
        "pkg-1.6.1-fabric-1.5.0" = _w8kUR0vn;
        "pkg-1.6.1-neoforge-1.5.0" = _zHVxGpjo;
        "pkg-1.6.1-fabric-1.5.1" = _MKadbjTP;
        "pkg-1.6.1-neoforge-1.5.1" = _S3tbatSB;
        "pkg-1.6.1-fabric-1.5.2" = _loS5XVHf;
        "pkg-1.6.1-neoforge-1.5.2" = _8j3GqLwU;
        "pkg-1.6.1-fabric-1.5.3" = _j9JZbeZB;
        "pkg-1.6.1-neoforge-1.5.3" = _uSEwDOqP;
        "pkg-1.7.0-fabric-1.6.0" = _e8j1jIDn;
        "pkg-1.7.0-neoforge-1.6.0" = _RKzAp4YG;
        "pkg-1.7.1-fabric-1.7.0" = _b6xt0TCy;
        "pkg-1.7.1-neoforge-1.7.0" = _NljQpW7o;
        "pkg-1.7.1-fabric-1.7.1" = _hRkOU329;
        "pkg-1.7.1-neoforge-1.7.1" = _KmQqCLAh;
        "pkg-1.7.2-fabric-1.7.1" = _uXT0K1PK;
