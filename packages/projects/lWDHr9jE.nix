...
let
    versions = (let
        ...
        _WdDiEKMn = {
            "id" = "WdDiEKMn";
            "file" = "tectonic-3.0.28-fabric-21.1.jar";
            "hash" = "sha512-oVqF+1xtE00JZ/o8zWeX+ig0i2mTe2Wyo7zWFzYJ6Erpe9hADrAQExZ87KNDS/lyFuh51LAnfAB/be2nqgdq/Q==";
        };
        _n4iyW7aB = {
            "id" = "n4iyW7aB";
            "file" = "tectonic-3.0.28-neoforge-21.1.jar";
            "hash" = "sha512-4HuctU8Hi3v3TJJcXOvWZD8LTCELj5RHTmhlm2lGjs59YUMvcOr+erqh36eY5GOKrSl5h8Eh3BJ1iMJiO396gQ==";
        };
        _5v9Cz8zS = {
            "id" = "5v9Cz8zS";
            "file" = "tectonic-3.0.28-fabric-26.1.jar";
            "hash" = "sha512-d4YxyTl/tQ0RSUnEH8QkA/8adECsf0Kk1ZGyao2runrinBYt64PCXiQWB24LeB7XTJDWUWzNJ4zlbfHLohhrmw==";
        };
        _RNLd3nvP = {
            "id" = "RNLd3nvP";
            "file" = "tectonic-3.0.28-neoforge-26.1.jar";
            "hash" = "sha512-7e7/oG/XXUV418ZJCiKbVpTexgKtPxZKh1e51IlFcK13ejPr88cSqX0JCUYnhBxFCjLK5AIZx00TG4CTzz/e/w==";
        };
        _tGbplDzo = {
            "id" = "tGbplDzo";
            "file" = "tectonic-3.0.28-fabric-26.2.jar";
            "hash" = "sha512-xlPuQv5Iwb6VEvp3kehJUJWuActgdVUgJxS7uVy0naJyEouylej4wmK2Nznnyi3ku6kZbhc4sGAStJjSILVazw==";
        };
        _c7tXsFY6 = {
            "id" = "c7tXsFY6";
    ...
    in {
        ...
        "pkg-0.1" = _5GAlwGt0;
        "pkg-1.0.3" = _VrJPesuB;
        "pkg-1.0.3a" = _E5XyYJFU;
        "pkg-1.1" = _WHCoQSwq;
        "pkg-1.1.1" = _hexdXndT;
        "pkg-1.1.2+1.19+MOD" = _LfqeFzal;
        "pkg-1.1.2+1.18.2+MOD" = _Sk2Wj54u;
        "pkg-1.1.2+1.19+DP" = _jEweyNSr;
        "pkg-1.1.2+1.18.2+DP" = _8DvETEcQ;
        "pkg-1.1.3+1.19+mod" = _kyOyZ959;
        "pkg-1.1.3+1.18.2+mod" = _CrJgVhRz;
        "pkg-1.1.3+1.19+dp" = _4FmsVRER;
        "pkg-1.1.3+1.18.2+dp" = _o79iZuLn;
        "pkg-1.1.4+1.18.2+mod" = _nCfuFGUJ;
        "pkg-1.1.4+1.19+mod" = _kD3ERzAU;
        "pkg-1.1.4+1.18.2+dp" = _YQW6UEha;
        "pkg-1.1.4+1.19+dp" = _iXsm0qYv;
        "pkg-1.1.5+1.18.2+mod" = _Xp7KZG02;
        "pkg-1.1.5+1.19+mod" = _31L9TtHa;
        "pkg-1.1.5+1.18.2+dp" = _IKoGJPng;
        "pkg-1.1.5+1.19+dp" = _VUDM6p8V;
        "pkg-1.1.6+1.19+mod" = _ikU2p37z;
        "pkg-1.1.6+1.19.3+mod" = _E1Z5e43T;
        "pkg-1.1.7+1.18.2+mod" = _T8MN0KIq;
        "pkg-1.1.7+1.18.2+dp" = _kBneO6ki;
        "pkg-1.1.7+1.19+mod" = _q8U9JFXx;
        "pkg-1.1.7+1.19.3+mod" = _5xZAjOFp;
        "pkg-1.1.7+1.19+dp" = _RffiLNDg;
        "pkg-1.1.7a" = _iUOBzhHD;
        "pkg-1.1.8+1.19+mod" = _VUseyTDe;
        "pkg-1.1.8+1.19.3+mod" = _TROmHrN8;
        "pkg-1.1.8a+1.19+mod" = _zTGbIDfc;
        "pkg-1.1.8a+1.19.3+mod" = _NqBsgux4;
        "pkg-1.1.9+1.19+dp" = _9tb4XPoV;
        "pkg-1.1.9+1.19+mod" = _xH89dtCn;
        "pkg-1.1.9+1.19.3+mod" = _tx6rLdUA;
        "pkg-1.1.9a+1.19+dp" = _xmaHuY49;
        "pkg-1.1.9+1.19.4+mod" = _5TxvYf3R;
        "pkg-1.1.9a+1.19.4+dp" = _N2QHzPke;
        "pkg-1.1.9b+1.19+mod" = _65V8fhDb;
        "pkg-1.1.9b+1.19.3+mod" = _mBxJOCQy;
        "pkg-1.1.10" = _rnuM9oqV;
        "pkg-1.1.10a" = _VLm89jvQ;
        "pkg-2.0" = _VpCClpZj;
        "pkg-2.0.1" = _jNMP7968;
        "pkg-2.0-beta1" = _gY8cl3L6;
        "pkg-2.1" = _Ojy7D0Vt;
        "pkg-2.1a" = _xGrrU4rl;
        "pkg-2.1.1" = _clI4wc2M;
        "pkg-2.1.1a" = _ZiVAiJjF;
        "pkg-2.1.1b" = _i48vQzPC;
        "pkg-2.1.2" = _jQaYKWuK;
        "pkg-2.1.2a" = _LhqG2XwP;
        "pkg-2.2" = _auHmdzit;
        "pkg-2.2.1" = _nRre3gJp;
        "pkg-2.2.1a" = _AMObzXjg;
        "pkg-2.3" = _ZuiWuO36;
        "pkg-2.3a" = _QdOMRCHu;
        "pkg-2.3.1" = _7Eyu3u3m;
        "pkg-2.3.1a" = _8xjEBuem;
        "pkg-2.3.2" = _Vi3BzpLx;
        "pkg-2.3.3" = _puGAWnTo;
        "pkg-2.3.4" = _8WO5E0R9;
        "pkg-2.3.4a" = _5BXZ6HSM;
        "pkg-2.2.2" = _stwi8gQ3;
        "pkg-2.3.5" = _WRfNGCWk;
        "pkg-2.3.5a" = _FxnYII7v;
        "pkg-2.3.5b" = _GxY5oM7Y;
        "pkg-2.4.0" = _NypAubyx;
        "pkg-2.4.0a" = _J5CxwkWM;
        "pkg-2.4.1" = _APO6bJT8;
        "pkg-2.4.1a" = _3puAlKOm;
        "pkg-2.4.1b" = _8JhzXwo0;
        "pkg-2.4.2" = _aLQ1otmd;
        "pkg-2.4.3" = _FOOSlG8w;
        "pkg-2.4.4" = _w19S52ln;
        "pkg-3.0.0+beta1" = _jBh7Wwtd;
        "pkg-3.0.0+beta2" = _TmDm0aIN;
        "pkg-3.0.0+beta3" = _yT1iVfhj;
        "pkg-3.0.0+beta4" = _bkR7KE8l;
        "pkg-3.0+beta4" = _SWDOp7uu;
        "pkg-3.0-fabric-1.20.1" = _pTxQUuRr;
        "pkg-3.0-fabric-1.21.1" = _p7Jg7y7L;
        "pkg-3.0-fabric-1.21.5" = _QV0yVRaW;
        "pkg-3.0-neoforge-1.21.1" = _2v0qIjyc;
        "pkg-3.0-neoforge-1.21.5" = _GZOnE8nS;
        "pkg-3.0-datapack" = _Pbx7Zbf2;
        "pkg-3.0.1-datapack" = _Si3GLmkL;
        "pkg-3.0.1-fabric-1.20.1" = _sPAY67Vk;
        "pkg-3.0.1-fabric-1.21.1" = _WDwMnQJ5;
        "pkg-3.0.1-fabric-1.21.5" = _96BO8leD;
        "pkg-3.0.1-neoforge-1.21.1" = _6yg3Vohy;
        "pkg-3.0.1-neoforge-1.21.5" = _gif5423q;
        "pkg-3.0.2" = _EioHMBUQ;
        "pkg-3.0.3-fabric-1.21.6" = _GraxbWKG;
        "pkg-3.0.3-neoforge-1.21.6" = _bOuHDNX2;
        "pkg-3.0.4" = _8hpdumd3;
        "pkg-3.0.5" = _vGAlADzb;
        "pkg-3.0.6" = _rPf6mMAn;
        "pkg-3.0.7" = _OgTObW1t;
        "pkg-3.0.8" = _oc1yvQrs;
        "pkg-3.0.9" = _DStHerDE;
        "pkg-3.0.10" = _paEFwjBi;
        "pkg-3.0.11" = _Ox9cET5b;
        "pkg-3.0.12" = _1UqnWQlV;
        "pkg-3.0.13" = _TF1Nfcyy;
        "pkg-3.0.13-datapack" = _8yP0B193;
        "pkg-3.0.14" = _3eRSTOtX;
        "pkg-3.0.15" = _cu5vef3c;
        "pkg-3.0.16" = _nDKHmR3K;
        "pkg-3.0.17" = _P0EM1LYB;
        "pkg-3.0.18" = _VfuqmXvF;
        "pkg-3.0.19" = _d9ImOHBG;
        "pkg-3.0.20" = _WLiadfmY;
        "pkg-3.0.21" = _BOA1DWFI;
        "pkg-3.0.22-fabric-21.1" = _cXSQRWNy;
        "pkg-3.0.22-neoforge-21.1" = _iCGkqnnx;
        "pkg-3.0.22-fabric-26.1" = _jL2ZsTzx;
        "pkg-3.0.22-neoforge-26.1" = _yk0mdkhx;
        "pkg-3.0.22-datapack" = _dRHdgYqL;
        "pkg-3.0.23-fabric-26.1" = _rCKdFZ9R;
        "pkg-3.0.23-neoforge-26.1" = _BYPegRad;
        "pkg-3.0.23-fabric-26.2" = _8uabRqIQ;
        "pkg-3.0.23-neoforge-26.2" = _XGultkRt;
        "pkg-3.0.24-fabric-26.2" = _ORccJXi7;
        "pkg-3.0.24-neoforge-26.2" = _SSR1hZBt;
        "pkg-3.0.25-fabric-26.1" = _SlA5rCvn;
        "pkg-3.0.25-neoforge-26.1" = _pZcw33by;
        "pkg-3.0.25-fabric-26.2" = _d99VUqqA;
        "pkg-3.0.25-neoforge-26.2" = _6LzTWkMf;
        "pkg-3.0.25-datapack" = _CmzMQNDL;
        "pkg-3.0.26-fabric-26.1" = _m8kKbg6R;
        "pkg-3.0.26-neoforge-26.1" = _qA6fuBpr;
        "pkg-3.0.26-fabric-26.2" = _rc4JXlpP;
        "pkg-3.0.26-neoforge-26.2" = _80oiGLPz;
        "pkg-3.0.26-fabric-21.1" = _L87Phsbl;
        "pkg-3.0.26-neoforge-21.1" = _vNrkxC3z;
        "pkg-3.0.27-neoforge-26.1" = _P0lQdPA9;
        "pkg-3.0.27-neoforge-26.2" = _E17asqTn;
        "pkg-3.0.28-fabric-21.1" = _WdDiEKMn;
        "pkg-3.0.28-neoforge-21.1" = _n4iyW7aB;
        "pkg-3.0.28-fabric-26.1" = _5v9Cz8zS;
