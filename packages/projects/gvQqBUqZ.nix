...
let
    ...
    in {
        ...
        "pkg-mc1.16.5-0.6.4" = _igqdFUYG;
        "pkg-mc1.16.5-0.6.5" = _pGhOMdTm;
        "pkg-mc1.17-0.7.0" = _Le0tKjFX;
        "pkg-mc1.16.5-0.6.6" = _rvsW1zhb;
        "pkg-mc1.17-0.7.1" = _7jxErppe;
        "pkg-mc1.17-0.7.2" = _aZ0JFf08;
        "pkg-mc1.17.1-0.7.3" = _cTZv31gu;
        "pkg-mc1.17.1-0.7.4" = _nVR7Q63z;
        "pkg-mc1.17.1-0.7.5" = _FHFKMKeu;
        "pkg-mc1.18-0.7.6-rc1" = _2w527DB2;
        "pkg-mc1.18.1-0.7.6" = _2CbyxeU0;
        "pkg-mc1.18.1-0.7.7" = _2aoHIXuK;
        "pkg-mc1.18.1-0.7.8" = _Ehsd7YUl;
        "pkg-mc1.18.2-0.7.9" = _MoF1cn6g;
        "pkg-mc1.18.2-0.7.10" = _pHl1Vi6k;
        "pkg-mc1.19-0.8.0" = _pXdccFQf;
        "pkg-mc1.19-0.8.1" = _sIKhU9s4;
        "pkg-mc1.19.1-0.8.3" = _ZRR9yqHD;
        "pkg-mc1.19.2-0.8.3" = _Zs3sdHjK;
        "pkg-mc1.19.2-0.9.0" = _Nba2vozh;
        "pkg-mc1.19.2-0.9.1" = _2ysRxhIL;
        "pkg-mc1.19.2-0.10.0" = _ySBrfN8N;
        "pkg-mc1.19.2-0.10.1" = _xVm1caOt;
        "pkg-mc1.19.2-0.10.2" = _IQxlSIiw;
        "pkg-mc1.18.2-0.10.2" = _FXG2XqRP;
        "pkg-mc1.18.2-0.10.3" = _ALnv7Npy;
        "pkg-mc1.19.2-0.10.3" = _OKrb9xMn;
        "pkg-mc1.19.3-0.10.3" = _3Gq9H7R9;
        "pkg-mc1.19.2-0.10.4" = _7scJ9RTg;
        "pkg-mc1.19.3-0.10.4" = _XS6vJwop;
        "pkg-mc1.19.3-0.11.0" = _sMWkk4VU;
        "pkg-mc1.19.2-0.11.0" = _GYl3zwgt;
        "pkg-mc1.19.2-0.11.1" = _m6sVgAi6;
        "pkg-mc1.19.3-0.11.1" = _53cwYYb1;
        "pkg-mc1.19.4-0.11.1" = _14hWYkog;
        "pkg-mc1.20-0.11.2" = _2KMrj5c1;
        "pkg-mc1.20.1-0.11.2" = _ZSNsJrPI;
        "pkg-mc1.20.2-0.12.0" = _qdzL5Hkg;
        "pkg-mc1.20.3-0.12.1" = _WzQmxYRa;
        "pkg-mc1.20.4-0.12.1" = _nMhjKWVE;
        "pkg-mc1.20.5-0.12.2" = _tDFVQpHO;
        "pkg-mc1.20.6-0.12.3" = _bAbb09VF;
        "pkg-mc1.20.5-0.12.4" = _g2qXxjsR;
        "pkg-mc1.20.6-0.12.4" = _fsK2ycFx;
        "pkg-mc1.21-0.12.5" = _OC4JOVBe;
        "pkg-mc1.21-0.12.7" = _my7uONjU;
        "pkg-mc1.20.5-0.12.5" = _p25IJhj0;
        "pkg-mc1.20.6-0.12.5" = _5a3sPIH2;
        "pkg-mc1.21-0.13.0" = _NTZCh7rb;
        "pkg-mc1.21.1-0.13.0" = _5szYtenV;
        "pkg-mc1.21-0.13.1" = _M7RXiitG;
        "pkg-mc1.21.1-0.13.1" = _9x0igjLz;
        "pkg-mc1.21.1-0.14.0-beta.1-fabric" = _2mbrKlX3;
        "pkg-mc1.21.1-0.14.0-beta.1-neoforge" = _BrMIoIMv;
        "pkg-mc1.21.3-0.14.1-neoforge" = _dq8Il4FW;
        "pkg-mc1.21.3-0.14.1-fabric" = _2Ea7RMWZ;
        "pkg-mc1.21.1-0.14.2-neoforge" = _KhdehJ6l;
        "pkg-mc1.21.1-0.14.2-fabric" = _frXUdgvL;
        "pkg-mc1.21.3-0.14.2-fabric" = _QhCwdt4l;
        "pkg-mc1.21.3-0.14.2-neoforge" = _wDD955sb;
        "pkg-mc1.21.1-0.14.3-fabric" = _9xfJi96s;
        "pkg-mc1.21.1-0.14.3-neoforge" = _dQrmTeoA;
        "pkg-mc1.21.3-0.14.3-neoforge" = _Yt6Jc9QP;
        "pkg-mc1.21.3-0.14.3-fabric" = _pZRO3EKX;
        "pkg-mc1.21.4-0.14.3-neoforge" = _iDqQi66g;
        "pkg-mc1.21.4-0.14.3-fabric" = _t1FlWYl9;
        "pkg-mc1.21.3-0.14.4-neoforge" = _Jjn7sFGq;
        "pkg-mc1.21.4-0.14.4-neoforge" = _mhrxIJQX;
        "pkg-mc1.21.1-0.14.5-fabric" = _GGl8GkvX;
        "pkg-mc1.21.1-0.14.5-neoforge" = _rzC1olaY;
        "pkg-mc1.21.3-0.14.5-fabric" = _SantNRs5;
        "pkg-mc1.21.3-0.14.5-neoforge" = _IwD5UGmX;
        "pkg-mc1.21.4-0.14.5-fabric" = _6SB2ZRPm;
        "pkg-mc1.21.4-0.14.5-neoforge" = _5WuQHJvU;
        "pkg-mc1.21.4-0.14.6-neoforge" = _CfXh2ZF6;
        "pkg-mc1.21.4-0.14.6-fabric" = _zVOQw7YU;
        "pkg-mc1.20.1-0.11.3-fabric" = _vuuAe7ZA;
        "pkg-mc1.21.3-0.14.6-neoforge" = _M43775k8;
        "pkg-mc1.21.3-0.14.6-fabric" = _W0Cc7ZVd;
        "pkg-mc1.21.1-0.14.6-neoforge" = _fyVzZaMa;
        "pkg-mc1.21.1-0.14.6-fabric" = _GtRRmh9W;
        "pkg-mc1.21.4-0.14.7-neoforge" = _OUCV8IgS;
        "pkg-mc1.21.4-0.14.7-fabric" = _QCuodIia;
        "pkg-mc1.21.1-0.14.7-neoforge" = _cU1Q9UWL;
        "pkg-mc1.21.1-0.14.7-fabric" = _NHA11tBg;
        "pkg-mc1.21.4-0.14.8-fabric" = _kLc5Oxr4;
        "pkg-mc1.21.4-0.14.8-neoforge" = _cHlCOaEl;
        "pkg-mc1.21.1-0.14.8-fabric" = _3HMQZXbw;
        "pkg-mc1.21.1-0.14.8-neoforge" = _ccgnTSUG;
        "pkg-mc1.21.1-0.15.0-fabric" = _MM5BBBOK;
        "pkg-mc1.21.1-0.15.0-neoforge" = _xYxpXTIt;
        "pkg-mc1.21.4-0.15.0-fabric" = _HtiXknlD;
        "pkg-mc1.21.4-0.15.0-neoforge" = _UMEOToAx;
        "pkg-mc1.21.4-0.15.1-neoforge" = _Mj9fgz9N;
        "pkg-mc1.21.4-0.15.1-fabric" = _969795RH;
        "pkg-mc1.21.5-0.16.0-fabric" = _nhc57Td2;
        "pkg-mc1.21.5-0.16.0-neoforge" = _P5VT33Jo;
        "pkg-mc1.21.4-0.15.2-neoforge" = _7ORhyYm2;
        "pkg-mc1.21.4-0.15.2-fabric" = _RuLfpULS;
        "pkg-mc1.21.5-0.16.1-fabric" = _5YInGgMN;
        "pkg-mc1.21.5-0.16.1-neoforge" = _gBOUQzN7;
        "pkg-mc1.21.4-0.15.3-fabric" = _u8pHPXJl;
        "pkg-mc1.21.4-0.15.3-neoforge" = _lP2Expzz;
        "pkg-mc1.21.5-0.16.2-neoforge" = _2xAqic6O;
        "pkg-mc1.21.5-0.16.2-fabric" = _VWYoZjBF;
        "pkg-mc1.21.5-0.16.3-neoforge" = _WlbbqV1o;
        "pkg-mc1.21.5-0.16.3-fabric" = _xcELvp6R;
        "pkg-mc1.21.6-0.17.0-fabric" = _XWGBHYcB;
        "pkg-mc1.21.6-0.17.0-neoforge" = _IXjXNvAW;
        "pkg-mc1.21.7-0.18.0-neoforge" = _t3Lhx7nL;
        "pkg-mc1.21.7-0.18.0-fabric" = _77EtzYFA;
        "pkg-mc1.21.8-0.18.0-fabric" = _pDfTqezk;
        "pkg-mc1.21.8-0.18.0-neoforge" = _qV99i9jE;
        "pkg-mc1.21.8-0.18.1-fabric" = _qxIL7Kb8;
        "pkg-mc1.21.8-0.18.1-neoforge" = _TSzQRFtn;
        "pkg-mc1.21.9-0.19.0-neoforge" = _uu31dpmq;
        "pkg-mc1.21.9-0.19.0-fabric" = _YxOQ6mdT;
        "pkg-mc1.21.9-0.19.1-neoforge" = _LGakFQ7r;
        "pkg-mc1.21.9-0.19.1-fabric" = _iMuOZwcu;
        "pkg-mc1.21.10-0.20.0-neoforge" = _JbdyCWex;
        "pkg-mc1.21.10-0.20.0-fabric" = _oGKQMdyZ;
        "pkg-mc1.21.9-0.19.2-fabric" = _L1sSIxFm;
        "pkg-mc1.21.9-0.19.2-neoforge" = _MntErhV2;
        "pkg-mc1.21.10-0.20.1-neoforge" = _HADn4LHe;
        "pkg-mc1.21.10-0.20.1-fabric" = _NsswKiwi;
        "pkg-mc1.21.1-0.15.1-neoforge" = _G5SDYehn;
        "pkg-mc1.21.1-0.15.1-fabric" = _E5eJVp4O;
        "pkg-mc1.20.1-0.11.4-fabric" = _iEcXOkz4;
        "pkg-mc1.21.11-0.21.0-neoforge" = _YUjPQTpk;
        "pkg-mc1.21.11-0.21.0-fabric" = _P4cz15Hh;
        "pkg-mc1.21.11-0.21.1-neoforge" = _uOsX53iR;
        "pkg-mc1.21.11-0.21.1-fabric" = _4DdLmtyz;
        "pkg-mc1.21.11-0.21.2-fabric" = _gl30uZvp;
        "pkg-mc1.21.11-0.21.2-neoforge" = _D3MEJqPt;
        "pkg-mc1.21.1-0.15.2-fabric" = _Yu6L8EnD;
        "pkg-mc1.21.1-0.15.2-neoforge" = _OLpCvF3o;
        "pkg-mc1.21.11-0.21.3-fabric" = _qvNsoO3l;
        "pkg-mc1.21.11-0.21.3-neoforge" = _ZsWAHkOs;
        "pkg-mc1.21.1-0.15.3-neoforge" = _RXHf27Wv;
        "pkg-mc1.21.1-0.15.3-fabric" = _XQJtuOTA;
        "pkg-mc1.21.11-0.21.4-neoforge" = _M93zf1Gr;
        "pkg-mc1.21.11-0.21.4-fabric" = _Ow7wA0kG;
        "pkg-mc26.1-0.22.0-neoforge" = _dOUqHXWf;
        "pkg-mc26.1-0.22.0-fabric" = _NYjDY08s;
        "pkg-mc26.1-0.22.1-fabric" = _W0ZXKJy9;
        "pkg-mc26.1-0.22.1-neoforge" = _E4Em26Ye;
        "pkg-mc26.1.1-0.23.0-fabric" = _kHXOBNih;
        "pkg-mc26.1.1-0.23.0-neoforge" = _eY2cB9ct;
        "pkg-mc26.1.2-0.24.0-fabric" = _5vmGhyue;
        "pkg-mc26.1.2-0.24.1-fabric" = _v2xoRvRP;
        "pkg-mc26.1.2-0.24.1-neoforge" = _Q8n3OtlQ;
        "pkg-mc26.1.2-0.24.2-fabric" = _R7MxYvuW;
        "pkg-mc26.1.2-0.24.2-neoforge" = _ZVNWRJdi;
        "pkg-mc26.1.2-0.24.3-fabric" = _Nt50x0fz;
        "pkg-mc26.1.2-0.24.3-neoforge" = _m0P57xKC;
        "pkg-mc26.1.2-0.24.4-fabric" = _rzrH7czY;
        "pkg-mc26.1.2-0.24.4-neoforge" = _eZuSeoPj;
        "pkg-mc26.1.2-0.24.5-neoforge" = _333T8Q8i;
        "pkg-mc26.1.2-0.24.5-fabric" = _GiCfpS6V;
        "pkg-mc26.1.2-0.24.6-fabric" = _fQBdPR1m;
        "pkg-mc26.1.2-0.24.6-neoforge" = _RDS7tsC9;
        "pkg-mc26.2-0.25.0-neoforge" = _QeEyF9xT;
        "pkg-mc26.2-0.25.0-fabric" = _x1OEDMlF;
        "pkg-mc1.21.1-0.15.4-neoforge" = _DDUrRVCA;
        "pkg-mc1.21.1-0.15.4-fabric" = _N08Z8wog;
        "pkg-mc26.2-0.25.1-neoforge" = _7vSbBOOl;
        "pkg-mc26.2-0.25.1-fabric" = _vy3clWg7;
        "pkg-mc26.2-0.25.2-fabric" = _UPNexAfy;
        "pkg-mc26.2-0.25.2-neoforge" = _a2HnpazH;
        "pkg-mc26.1.2-0.24.7-fabric" = _Oqq8TOAV;
