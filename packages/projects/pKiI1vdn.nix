...
let
    versions = (let
        ...
        _dRq4yoz5 = {
            "id" = "dRq4yoz5";
            "file" = "ExcavatorEnchant-1.5.1.0.jar";
            "hash" = "sha512-MUZF4iZ8ahmue2mxTwv4V+vESV7mlscRONUIcdK29uI8KUk8jmO4RhsZOsdMESwFeY7trEPdNWs2/k2Z+eOy6g==";
        };
        _gpoFFJBM = {
            "id" = "gpoFFJBM";
            "file" = "ExcavatorEnchant-1.6.0.0.jar";
            "hash" = "sha512-oX9tG47xIS5MpoXjB3KycMXzk6xUTsQhv8SbvQd5ztixhO84r2OtSTIAC+QiKeaoVrdavfCAm1BxvQAjf/XmRQ==";
        };
    in {
        "vHstuCwD" = _vHstuCwD;
        "duHvYxdR" = _duHvYxdR;
        ...
        "paper-1.21" = _gpoFFJBM;
        "paper-1.21.1" = _gpoFFJBM;
        "paper-1.21.2" = _gpoFFJBM;
        "paper-1.21.3" = _gpoFFJBM;
        "paper-1.21.4" = _gpoFFJBM;
        "paper-1.21.5" = _gpoFFJBM;
        "paper-1.21.6" = _gpoFFJBM;
        "paper-1.21.7" = _gpoFFJBM;
        "paper-1.21.8" = _gpoFFJBM;
        "paper-1.21.9" = _gpoFFJBM;
        "paper-1.21.10" = _gpoFFJBM;
        "paper-1.21.11" = _gpoFFJBM;
        "paper-26.1" = _gpoFFJBM;
        "paper-26.1.1" = _gpoFFJBM;
        "paper-26.1.2" = _gpoFFJBM;
        "paper-26.2" = _gpoFFJBM;
        "purpur-1.21" = _gpoFFJBM;
        "purpur-1.21.1" = _gpoFFJBM;
        "purpur-1.21.2" = _gpoFFJBM;
        "purpur-1.21.3" = _gpoFFJBM;
        "purpur-1.21.4" = _gpoFFJBM;
        "purpur-1.21.5" = _gpoFFJBM;
        "purpur-1.21.6" = _gpoFFJBM;
        "purpur-1.21.7" = _gpoFFJBM;
        "purpur-1.21.8" = _gpoFFJBM;
        "purpur-1.21.9" = _gpoFFJBM;
        "purpur-1.21.10" = _gpoFFJBM;
        "purpur-1.21.11" = _gpoFFJBM;
        "purpur-26.1" = _gpoFFJBM;
        "purpur-26.1.1" = _gpoFFJBM;
        "purpur-26.1.2" = _gpoFFJBM;
        "purpur-26.2" = _gpoFFJBM;
        ...
        "pkg-1.0.0.0" = _vHstuCwD;
        "pkg-1.0.0.2" = _duHvYxdR;
        "pkg-1.0.1.0" = _jFPqTnKV;
        "pkg-1.0.2.0" = _DqSM98qh;
        "pkg-1.0.2.2" = _mDpZxqFH;
        "pkg-1.0.3.0" = _UrZj95Dl;
        "pkg-1.0.3.2" = _sqlJQVIt;
        "pkg-1.0.3.3" = _6Arlqggf;
        "pkg-1.0.4.0" = _mIgSdoAl;
        "pkg-1.5.0.0" = _1ZPRAUKy;
        "pkg-1.5.1.0" = _dRq4yoz5;
        "pkg-1.6.0.0" = _gpoFFJBM;
        "default" = _gpoFFJBM;
    });
