...
let
    ...
    in {
        ...
        "pkg-0.3.2" = _rrMfZqua;
        "pkg-0.3.3" = _S4VTFnDi;
        "pkg-0.3.4+1.21.7+alpha" = _xKJ5AROc;
        "pkg-0.3.4+1.21.7+alpha.hotfix.1" = _VreSrcdJ;
        "pkg-0.3.4+1.21.7+beta" = _o6N0MS0T;
        "pkg-0.3.5+1.21.7+beta" = _XKLDG2i6;
        "pkg-0.3.6+1.21.7+beta" = _9So00jDI;
        "pkg-0.3.7+1.21.7+beta" = _YbAkPWrQ;
        "pkg-0.3.8+1.21.7+beta" = _UFm8W408;
        "pkg-0.4.0+1.21.7+beta" = _4Pjkh1T5;
        "pkg-0.4.1+1.21.7+beta" = _FxBcpF8f;
        "pkg-0.4.2+1.21.7+beta" = _AdyXsSfF;
        "pkg-0.4.3+1.21.7+beta" = _FycXbxU7;
        "pkg-0.4.4+1.21.7+beta" = _Rqwcs4YX;
        "pkg-0.4.5+1.21.7+beta" = _7VknJSjM;
        "pkg-0.4.6+1.21.7+beta" = _AblQrNtI;
        "pkg-0.4.7+1.21.7+beta" = _7S7z2Xce;
        "pkg-0.4.8+1.21.7+beta" = _r75Lbn9b;
        "pkg-0.4.9+1.21.7+lts" = _ZV28pA5G;
        "pkg-0.4.10+1.21.10+alpha" = _A7PN82GW;
        "pkg-0.4.10+1.21.10+beta" = _zxf8EIdM;
        "pkg-0.4.10+1.21.7+lts" = _ilhvskfS;
        "pkg-0.4.11+1.21.10+beta" = _2ytL3a81;
        "pkg-0.4.10+1.21.4+lts" = _PPNmVSyk;
        "pkg-0.4.11+1.21.11+beta" = _6fnfk272;
        "pkg-0.4.12+1.21.10+beta" = _chjRxTGu;
        "pkg-0.4.13+1.21.10+beta" = _6ap9JCrK;
        "pkg-0.4.13+1.21.11+beta" = _JXwMYvRm;
        "pkg-0.4.14+1.21.10+beta" = _nxcO7MgT;
        "pkg-0.4.14+1.21.11+beta" = _SNsgP5xk;
        "pkg-0.4.15+1.21.11+beta" = _Kf86enuk;
        "pkg-0.4.16+1.21.11+beta" = _f9p92E3T;
        "pkg-0.4.17+1.21.11+beta" = _Q4cI7WXY;
        "pkg-0.4.18+1.21.11+beta" = _TG2e8P3B;
        "pkg-0.4.19+1.21.11" = _tc6q6OBg;
        "pkg-0.5.0+26.1.2+beta" = _SQgORGC5;
        "pkg-0.4.20+1.21.11" = _8hMWXVh7;
        "pkg-0.5.1+26.1.2+beta" = _HcwvKhJF;
        "pkg-0.4.21+1.21.11" = _KX3x5iJw;
        "pkg-0.5.2+26.1.2+beta" = _ihfI2Dyp;
        "pkg-0.4.22+1.21.11" = _tmwO32kd;
        "pkg-0.5.3+26.1.2+beta" = _YkhzNOT1;
        "pkg-0.4.23+1.21.11" = _Ul8ZptkA;
        "pkg-0.5.4+26.1.2+Beta" = _jMus9uiQ;
        "pkg-0.4.24+1.21.11" = _e0v87TPh;
        "pkg-0.5.5+26.1.2+beta" = _Hc2Kv8hD;
        "pkg-0.5.6+26.1.2+beta" = _nvEQdESC;
        "pkg-0.4.25+1.21.11" = _3qmn0rMG;
        "pkg-0.5.7+26.1.2+beta" = _8A37TJFe;
        "pkg-0.5.8+26.1.2+beta" = _vsh0ZrR3;
        "pkg-0.5.9+26.1.2+beta" = _6mHEAUSt;
