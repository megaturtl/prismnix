...
let
    ...
    in {
        ...
        "pkg-0.2.1+mc1.21.1" = _3xxS3y1y;
        "pkg-0.2.2+mc1.20.1" = _1alKlaL0;
        "pkg-0.2.2+mc1.21.1" = _cDfJ6r1L;
        "pkg-0.2.3+mc1.20.1" = _59lj2KRw;
        "pkg-0.2.3+mc1.21.1" = _8eIalikQ;
        "pkg-1.0.0+mc1.20.1" = _uemxWhvV;
        "pkg-1.0.0+mc1.21.1" = _ujBOF2W7;
        "pkg-1.1.0+mc1.20.1" = _7NzM5o0V;
        "pkg-1.1.0+mc1.21.1" = _TgXu1ZyH;
        "pkg-1.1.1+mc1.20.1" = _X6DowH3e;
        "pkg-1.1.1+mc1.21.1" = _2VaQzS9X;
        "pkg-1.1.2+mc1.20.1" = _JxjWeQlq;
        "pkg-1.1.2+mc1.21.1" = _Lv6avvhL;
        "pkg-1.2.0+mc1.20.1" = _CHxzfFgv;
        "pkg-1.2.0+mc1.21.1" = _ddDj2cfQ;
        "pkg-1.2.1+mc1.20.1" = _UGEPiYlo;
        "pkg-1.2.1+mc1.21.1" = _ukdtOqUc;
        "pkg-1.2.2+mc1.20.1" = _dFYsjLIu;
        "pkg-1.2.2+mc1.21.1" = _JwDFI3aj;
        "pkg-1.2.3+mc1.20.1" = _D1JEGUGi;
        "pkg-1.2.3+mc1.21.1" = _Aytj9SDt;
        "pkg-1.2.4+mc1.20.1" = _D0stH5f3;
        "pkg-1.2.4+mc1.21.1" = _7gIvnCcX;
        "pkg-1.2.5+mc1.20.1" = _4uq1IaMQ;
        "pkg-1.2.5+mc1.21.1" = _qIo72EWB;
        "pkg-1.2.6+mc1.20.1" = _CepvYHic;
        "pkg-1.2.6+mc1.21.1" = _gxz6jfV9;
        "pkg-1.2.7+mc1.20.1" = _DqQTiL26;
        "pkg-1.2.7+mc1.21.1" = _Khgr5l7P;
        "pkg-1.2.8+mc1.20.1" = _dF25PH5C;
