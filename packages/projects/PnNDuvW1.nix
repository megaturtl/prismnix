...
let
    ...
    in {
        ...
        "minecraft-26.2-snapshot-3" = _BqxiaFYF;
        "minecraft-26.2-snapshot-4" = _BqxiaFYF;
        "minecraft-26.2-snapshot-5" = _BqxiaFYF;
        "minecraft-26.2-snapshot-6" = _BqxiaFYF;
        "minecraft-26.2-snapshot-7" = _BqxiaFYF;
        "minecraft-26.2-snapshot-8" = _BqxiaFYF;
        "minecraft-26.2-pre-1" = _BqxiaFYF;
        "minecraft-26.2-pre-2" = _BqxiaFYF;
        "minecraft-26.2-pre-3" = _BqxiaFYF;
        "minecraft-26.2-pre-4" = _BqxiaFYF;
        "minecraft-26.2-pre-5" = _BqxiaFYF;
        "minecraft-26.2-pre-6" = _BqxiaFYF;
        "minecraft-26.2-rc-1" = _BqxiaFYF;
        "minecraft-26.2-rc-2" = _BqxiaFYF;
        "minecraft-26.2" = _BqxiaFYF;
        "minecraft-26.3-snapshot-1" = _BqxiaFYF;
        "minecraft-26.3-snapshot-2" = _BqxiaFYF;
        "minecraft-26.3-snapshot-3" = _BqxiaFYF;
        "minecraft-26.3-snapshot-4" = _BqxiaFYF;
        "minecraft-26.3-snapshot-5" = _BqxiaFYF;
        "minecraft-26.3-snapshot-6" = _BqxiaFYF;
        "minecraft-26.3-snapshot-7" = _BqxiaFYF;
        "minecraft-26.3-snapshot-8" = _BqxiaFYF;
        "minecraft-26.3-snapshot-9" = _BqxiaFYF;
        "pkg-1.0" = _FNJ3ulzj;
        "pkg-2.0" = _BqxiaFYF;
        "default" = _BqxiaFYF;
    });
