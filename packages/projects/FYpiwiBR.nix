...
let
    ...
    in {
        ...
        "pkg-1.1.1+1.20.1" = _FcWJSX70;
        "pkg-1.2.0+1.20.1" = _zKvd5tEq;
        "pkg-1.3.0+1.20.1" = _y4B16Gw3;
        "pkg-1.3.1+1.20.1" = _VWaY4qvr;
        "pkg-1.4.0+1.20.1" = _bOKT1DOR;
        "pkg-1.4.1+1.20.1" = _wRF0UGwQ;
        "pkg-1.5.0+1.20.1" = _8s16VZsE;
        "pkg-1.5.1+1.20.1" = _rFCOVTpD;
        "pkg-1.6.0+1.20.1" = _ZWVYzp3C;
        "pkg-1.6.1+1.20.1" = _2fhYf9HK;
        "pkg-1.7.0+1.20.1" = _jhxMthr7;
        "pkg-1.8.0+1.20.1" = _D4hGQD7g;
        "pkg-1.9.0+1.20.1" = _sm2F9kcf;
        "pkg-1.9.2+1.20.1" = _3jLavA1z;
        "pkg-1.9.3+1.20.1" = _ozzQ9zl7;
        "pkg-1.10.0+1.20.1" = _bWPRSm4H;
        "pkg-1.10.1+1.20.1" = _7d8ZiTAO;
        "pkg-1.11.0+1.20.1" = _NAvmgp8I;
        "pkg-1.11.1+1.20.1" = _OoUDmJIb;
        "pkg-1.11.2+1.20.1" = _d28gpPn6;
        "pkg-1.12.0+1.21" = _WUktoh8L;
