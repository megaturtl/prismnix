...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.11.2" = _SDVTG1wT;
        "pkg-1.18.0-1-1.10.19" = _Sl8KOrml;
        "pkg-1.17.1-1.10.16" = _hlDa5xcJ;
        "pkg-23w07a-1.12.1" = _lGEo73t8;
        "pkg-1.19.4-pre1-1.12.1" = _32HlDKN7;
        "pkg-1.19.4-pre2-1.12.2" = _idL27wRi;
        "pkg-1.19.4-pre3-1.12.2" = _IfDZb9uR;
        "pkg-1.19.4-rc2-1.12.2" = _ajaVd5PZ;
        "pkg-1.19.4-1.12.2" = _MmmDGjfJ;
        "pkg-1.19.4-1.12.3" = _PSze7ibJ;
        "pkg-23w12a-1.12.3" = _NaW2Xvih;
        "pkg-23w13a-1.12.3" = _fvip20Pi;
        "pkg-23w13a_or_b-1.12.4" = _DF0IyTxC;
        "pkg-1.19.4-1.12.3_2" = _Sok57LMh;
        "pkg-23w14a-1.12.3" = _HNq0wtof;
        "pkg-23w17a-1.12.4" = _paRyGRfe;
        "pkg-23w17a-1.12.5" = _J76cicVz;
        "pkg-23w17a-1.12.6" = _sPF4vFxX;
        "pkg-1.19.4-1.12.5" = _ffnWrNvk;
        "pkg-23w18a-1.12.6" = _LG3KrB7D;
        "pkg-23w17a-1.12.7" = _9rLCpd9H;
        "pkg-1.19.4-1.12.7" = _AL1qKAXV;
        "pkg-1.20-pre1-1.12.7" = _tjFTrXMh;
        "pkg-1.20-pre2-1.12.7" = _4EnzeIoe;
        "pkg-1.19.3-1.12.2" = _vQC7KfEO;
        "pkg-1.19.4-1.12.8" = _Ez42HqNo;
        "pkg-1.20-pre3-1.12.7" = _yEa8eZAm;
        "pkg-1.20-pre5-1.12.7" = _Yz6ooZa7;
        "pkg-1.20-pre6-1.12.7" = _bJq63h9M;
        "pkg-1.20-rc1-1.12.7" = _5S2rtRC3;
        "pkg-1.20-1.12.7" = _1509tiOh;
        "pkg-1.20-1.12.8" = _SbjZiErB;
        "pkg-1.20.1-1.12.8" = _TKAMLJ6G;
        "pkg-1.20.1-1.12.9" = _q3uVj3Kc;
        "pkg-1.20.1-1.12.10" = _N3Y3Bpmt;
        "pkg-1.20.1-1.12.11" = _X7TbsgWX;
        "pkg-1.20.1-1.12.12" = _82Ga10ml;
        "pkg-1.20.1-1.12.13" = _uDfYW2uw;
        "pkg-1.20.2-pre4-1.12.13" = _l9mA2bV0;
        "pkg-1.20.2-rc2-1.12.13" = _EM8qzJpF;
        "pkg-1.20.2-1.12.14" = _CiN9qIpt;
        "pkg-1.20.2-1.12.15" = _ULcMnYb5;
        "pkg-23w43b-1.12.15" = _LasxkR89;
        "pkg-23w45a-1.12.15" = _Y50ehYCa;
        "pkg-1.20.4-1.12.16" = _c9qCEEWT;
        "pkg-1.20.4-1.12.17" = _VYowiAJp;
        "pkg-1.20.5,6-1.12.18" = _NttRS2Dz;
        "pkg-1.20.6-1.12.19" = _yfOx8RrC;
        "pkg-1.21-1.12.20" = _rJ0VLidp;
        "pkg-1.21-1.12.21" = _xFhIFVyI;
        "pkg-1.21-1.12.22" = _VIQPutle;
        "pkg-1.21-1.13" = _PWY9bYCp;
        "pkg-1.21-1.13.1" = _QZuVdvFR;
        "pkg-1.21.2-1.14-beta.1" = _URApHxUE;
        "pkg-1.21.2-1.14" = _CFNBT6Yk;
        "pkg-1.21.3-1.14.1" = _r2yHZTfk;
        "pkg-1.21.3-1.14.2" = _r31PJJ8Y;
        "pkg-1.21.3-1.14.3" = _DHNZyECS;
        "pkg-1.21.4-1.14.5" = _XxniXCAy;
        "pkg-1.21.4-1.14.6" = _Q7JquiiY;
        "pkg-1.21.4-1.14.7" = _P764Uz4H;
        "pkg-1.21.4-1.14.8" = _9GMuLPHh;
        "pkg-1.21.4-1.14.9" = _9q5Io7BF;
        "pkg-1.21.5-1.15.0" = _B4EFqmGX;
        "pkg-1.21.5-1.15.1" = _C69H1JIU;
        "pkg-1.21.5-1.15.3" = _tmjVF7vf;
        "pkg-1.21.6-1.15.4" = _u4XKpU6e;
        "pkg-1.21.7-1.15.5" = _aVPHWOc5;
        "pkg-1.21.8-1.15.6" = _rR77DKKU;
        "pkg-1.21.8-1.15.7" = _mE2JtUtN;
        "pkg-1.21.9-1.15.8" = _cQc3TN2b;
        "pkg-25w14craftmine-1.15.3" = _n5bFYQus;
        "pkg-1.21.10-1.15.9" = _n380aWVE;
        "pkg-1.21.11-1.15.10" = _zGLl3eR9;
        "pkg-1.21.11-1.15.11" = _O7wDCQi4;
        "pkg-1.21.11-1.15.12" = _N5ZvYjYv;
        "pkg-1.21.11-1.15.13" = _tflOS1as;
        "pkg-1.21.11-1.16.0" = _ReAoaWtd;
        "pkg-1.21.11-1.16.1" = _mhZP9NDK;
        "pkg-1.21.11-1.16.2" = _At2wqJfr;
        "pkg-1.21.11-1.16.3" = _KgOVU4rn;
        "pkg-1.21.11-1.16.4" = _5LzUIY82;
        "pkg-1.21.11-1.16.5" = _dIXgRAXa;
        "pkg-26.1-1.16.5" = _48wBzmPk;
        "pkg-1.21.11-1.16.6" = _oL15yOzL;
        "pkg-26.1-1.16.6" = _NfOUNBHc;
