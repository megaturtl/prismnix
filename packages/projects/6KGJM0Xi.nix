...
let
    versions = (let
        ...
        _yttw9wSA = {
            "id" = "yttw9wSA";
            "file" = "AeternumSeasons-4.7.jar";
            "hash" = "sha512-F9MNzVnQItjev8U2Z9DQuvhZIZpx37KBFmY/1pALbDF0z+UxzVKpBYzA+P4C65Sp7HGbPVlRs2k2Xx20bUdCaQ==";
        };
    in {
        "C9YCWF8p" = _C9YCWF8p;
        "nrBsd8Vp" = _nrBsd8Vp;
        ...
        "lVIg3YeE" = _lVIg3YeE;
        "yttw9wSA" = _yttw9wSA;
        "paper-1.21.3" = _yttw9wSA;
        "paper-1.21.4" = _yttw9wSA;
        "paper-1.21.5" = _yttw9wSA;
        "paper-1.21.6" = _yttw9wSA;
        "paper-1.21.7" = _yttw9wSA;
        "paper-1.21.8" = _yttw9wSA;
        "paper-1.21.9" = _yttw9wSA;
        "paper-1.21.10" = _yttw9wSA;
        "paper-1.21" = _yttw9wSA;
        "paper-1.21.1" = _yttw9wSA;
        "paper-1.21.2" = _yttw9wSA;
        "paper-1.21.11" = _yttw9wSA;
        "paper-26.1" = _yttw9wSA;
        "paper-26.1.1" = _yttw9wSA;
        "paper-26.1.2" = _yttw9wSA;
        "paper-26.2" = _yttw9wSA;
        "spigot-1.21.3" = _yttw9wSA;
        "spigot-1.21.4" = _yttw9wSA;
        "spigot-1.21.5" = _yttw9wSA;
        "spigot-1.21.6" = _yttw9wSA;
        "spigot-1.21.7" = _yttw9wSA;
        "spigot-1.21.8" = _yttw9wSA;
        "spigot-1.21.9" = _yttw9wSA;
        "spigot-1.21.10" = _yttw9wSA;
        "spigot-1.21" = _yttw9wSA;
        "spigot-1.21.1" = _yttw9wSA;
        "spigot-1.21.2" = _yttw9wSA;
        "spigot-1.21.11" = _yttw9wSA;
        "spigot-26.1" = _yttw9wSA;
        "spigot-26.1.1" = _yttw9wSA;
        "spigot-26.1.2" = _yttw9wSA;
        "spigot-26.2" = _yttw9wSA;
        "purpur-1.21" = _yttw9wSA;
        "purpur-1.21.1" = _yttw9wSA;
        "purpur-1.21.2" = _yttw9wSA;
        "purpur-1.21.3" = _yttw9wSA;
        "purpur-1.21.4" = _yttw9wSA;
        "purpur-1.21.5" = _yttw9wSA;
        "purpur-1.21.6" = _yttw9wSA;
        "purpur-1.21.7" = _yttw9wSA;
        "purpur-1.21.8" = _yttw9wSA;
        "purpur-1.21.9" = _yttw9wSA;
        "purpur-1.21.10" = _yttw9wSA;
        "purpur-1.21.11" = _yttw9wSA;
        "purpur-26.1" = _yttw9wSA;
        "purpur-26.1.1" = _yttw9wSA;
        "purpur-26.1.2" = _yttw9wSA;
        "purpur-26.2" = _yttw9wSA;
