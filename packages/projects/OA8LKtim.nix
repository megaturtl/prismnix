...
let
    versions = (let
        ...
        _oYwHAw1s = {
            "id" = "oYwHAw1s";
            "file" = "banco-modern-1.4.2.jar";
            "hash" = "sha512-saQqVOzPKbfXv2HYSF3wEl9RwAEeyrHPiXxnEDJ1fYC8oB7QPdztKsrkPHfrvKKEyghqFS4xMr244vHRXxZizA==";
        };
    in {
        "cMtGBoGx" = _cMtGBoGx;
        "x8o4KPT3" = _x8o4KPT3;
        ...
        "paper-1.21.7" = _oYwHAw1s;
        "paper-1.21.8" = _oYwHAw1s;
        "paper-1.21.9" = _oYwHAw1s;
        "paper-1.21.10" = _oYwHAw1s;
        "paper-1.21.11" = _oYwHAw1s;
        "paper-26.1" = _oYwHAw1s;
        "paper-26.1.1" = _oYwHAw1s;
        "paper-26.1.2" = _oYwHAw1s;
        "paper-26.2" = _oYwHAw1s;
        ...
        "purpur-1.21.7" = _oYwHAw1s;
        "purpur-1.21.8" = _oYwHAw1s;
        "purpur-1.21.9" = _oYwHAw1s;
        "purpur-1.21.10" = _oYwHAw1s;
        "purpur-1.21.11" = _oYwHAw1s;
        "purpur-26.1" = _oYwHAw1s;
        "purpur-26.1.1" = _oYwHAw1s;
        "purpur-26.1.2" = _oYwHAw1s;
        "purpur-26.2" = _oYwHAw1s;
        ...
        "folia-1.21.7" = _oYwHAw1s;
        "folia-1.21.8" = _oYwHAw1s;
        "folia-1.21.9" = _oYwHAw1s;
        "folia-1.21.10" = _oYwHAw1s;
        "folia-1.21.11" = _oYwHAw1s;
        "folia-26.1" = _oYwHAw1s;
        "folia-26.1.1" = _oYwHAw1s;
        "folia-26.1.2" = _oYwHAw1s;
        "folia-26.2" = _oYwHAw1s;
        "pkg-0.2.0" = _cMtGBoGx;
        "pkg-0.2.1" = _ieJBGDK7;
        "pkg-0.3.0" = _ISkz4qZg;
        "pkg-0.3.1" = _Qx5x3T4X;
