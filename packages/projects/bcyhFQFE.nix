...
let
    ...
    in {
        ...
        "pkg-1.1.3-h1.2.6" = _xRyzZCt6;
        "pkg-1.2-h1.2.6" = _UrS9DNwW;
        "pkg-1.2.1-h1.2.6" = _hoJ5S7bf;
        "pkg-1.2.2-h1.2.6" = _YopgxdAT;
        "pkg-1.2.3-h1.2.6" = _gqo7ZKXK;
        "pkg-1.3-h1.2.6" = _I2CcN0GT;
        "pkg-1.4-h1.2.6" = _RtNYiZNk;
        "pkg-1.4.1-h1.2.6" = _mmvUdZAy;
        "pkg-1.4.2-h1.2.6" = _Z5T091ZT;
        "pkg-1.4.2.1-h1.2.6" = _wBUftb3N;
        "pkg-1.4.3-h1.2.6" = _FWrs2bOA;
        "pkg-1.4.4-h1.2.6" = _c3ghGPxz;
        "pkg-1.5-h1.2.6" = _2WFrn7YX;
        "pkg-1.5.1-h1.3" = _a9N7BFNk;
        "pkg-1.5.2-h1.3" = _YKUhge3P;
        "pkg-1.5.3-h1.3" = _ohl86MTJ;
        "pkg-1.5.4-h1.3" = _MTn5tGbI;
        "pkg-1.6-h1.3" = _VYk502Sn;
        "pkg-1.6.1-h1.3" = _ff7Oetct;
        "pkg-1.6.2-h1.3" = _72i3eoXa;
        "pkg-1.6.3-h1.3" = _3fveY0Fp;
