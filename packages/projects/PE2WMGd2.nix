...
let
    ...
    in {
        ...
        "pkg-1.2.7" = _MnJ0alQu;
        "pkg-1.2.9" = _Q4q2utmH;
        "pkg-1.0.12" = _869NmhfZ;
        "pkg-1.2.10" = _ZTuZU65t;
        "pkg-1.2.11" = _ku95bf29;
        "pkg-1.2.12" = _ywTgb2ET;
        "pkg-1.2.13" = _EyH5z3nc;
        "pkg-1.2.14" = _mCvImLB9;
        "pkg-1.2.15" = _mwNyZWeG;
        "pkg-1.2.16" = _4JvSq0cM;
        "pkg-1.2.17" = _xUDZohEN;
        "pkg-1.3.0" = _KvQy5kH8;
        "pkg-1.3.1" = _Kgre1PBh;
        "pkg-1.3.2" = _hvbbRQqO;
        "pkg-1.3.3" = _69eYqhbE;
        ...
        "pkg-1.3.8" = _UrEA7Dok;
        "pkg-1.3.9" = _Nbz2EK9O;
        "pkg-1.3.10" = _cMcO9Q9r;
        "pkg-1.3.11" = _NOPRbrFb;
        "pkg-1.3.12" = _CLmjseTJ;
        "pkg-1.3.13" = _4AAKM0hb;
        "pkg-1.3.14" = _te0WNhqA;
        "pkg-1.3.15" = _87W1DqOy;
        "pkg-1.0.14" = _5c0bRpm6;
        "pkg-1.0.15" = _B32M3HxU;
        "pkg-1.19-v1.0.16" = _6667i36L;
        "pkg-1.20-v1.3.16" = _lWk37qwO;
        "pkg-1.21.4-v1.4.0" = _85DGtK0e;
        "pkg-1.21.4-v1.4.1" = _6nLvSdMz;
        "pkg-1.21.4-v1.4.2" = _JEBDXc9h;
        "pkg-1.21.4-v1.4.3" = _N3yjEj7m;
        "pkg-1.21.4-v1.4.4" = _CrWbAkbO;
        "pkg-1.21.4-v1.4.5" = _D7GE0BKD;
        "pkg-1.21.4-v1.4.6" = _Xp4OSURC;
        "pkg-1.21.4-v1.4.7" = _DXNep1qz;
        "pkg-1.21.4-v1.4.8" = _lu3x2ZrP;
        "pkg-1.21.4-v1.4.9" = _FRxfqp4A;
        "pkg-1.21.4-v1.4.10" = _aeFvg6YJ;
        "pkg-1.21.4-v1.4.11" = _rRL0z15R;
        "pkg-1.21.4-v1.4.12" = _e7vHpDOF;
        "pkg-1.21.4-v1.5.0" = _IMsofqU8;
        "pkg-1.21.4-v1.5.1" = _kjLsRrsO;
        "pkg-1.21.4-v1.5.2" = _oBZTQkup;
        "pkg-1.21.4-v1.5.3" = _I7Jj4aJ7;
        "pkg-1.21.4-v1.5.4" = _gLJ2Z7Sd;
        "pkg-1.21.4-v1.5.5" = _GZppiije;
        "pkg-1.21.4-v1.5.6" = _KE8pbF3K;
        "pkg-1.21.1-v1.5.7" = _6mZEEOfG;
        "pkg-1.21.4-v1.5.7" = _sBuhemRs;
        "pkg-1.21.5-v1.5.7" = _J02sg8qq;
        "pkg-1.21.5-v1.5.8" = _FVV4j9B9;
        "pkg-1.21.1-v1.5.8" = _wtLy7lTp;
        "pkg-1.21.1-v1.5.9" = _I0ljFO5K;
        "pkg-1.21.5-v1.6.0" = _H3XiExtv;
        "pkg-1.21.5-v1.6.1b" = _D57RHe5I;
        "pkg-1.21.5-v1.6.2" = _FvNxPDi1;
        "pkg-1.21.1-v1.5.10" = _q4PA3WB6;
        "pkg-1.21.5-v1.6.3" = _bBigrTqa;
        "pkg-1.21.4-v1.5.9" = _35CcBCkv;
        "pkg-1.21.5-v1.6.4" = _3t1ozxI6;
        "pkg-1.21.5-v1.6.5" = _YYbf0dG1;
        "pkg-1.21.5-v1.6.6" = _lKG4EGa9;
        "pkg-1.21.5-v1.6.7" = _BwnVI2SR;
        "pkg-1.21.11-v1.7.0" = _XBpvfLNT;
        "pkg-1.21.11-v1.7.1" = _XtmAob5m;
        "pkg-1.21.11-v1.7.2" = _XQWspfcc;
        "pkg-1.21.11-v1.7.3" = _cSftGmDJ;
        "pkg-1.21.11-v1.7.4" = _IIFcYzcV;
        "pkg-1.21.11-v1.7.5" = _XuyuP6y0;
        "pkg-1.21.11-v1.7.6" = _6WCgLJWi;
        "pkg-1.21.11-v1.7.7" = _W2RDH6nX;
        "pkg-1.21.11-v1.7.8" = _Vdh8fvpj;
        "pkg-1.21.11-v1.7.9" = _AZqeZFqv;
        "pkg-1.21.11-v1.7.10" = _RgTqrofA;
        "pkg-1.21.11-v1.7.11" = _QZPpSwXj;
        "pkg-1.21.11-v1.7.12" = _KFVSDqjK;
        "pkg-1.21.11-v1.7.13" = _CmkPPqw7;
        "pkg-1.21.1-v1.5.11" = _ymAsozbk;
        "pkg-1.21.4-v1.5.10" = _laKCDIso;
        "pkg-1.21.5-v1.6.8" = _onwrpWYL;
        "pkg-1.21.11-v1.7.14" = _XXitfdR6;
        "pkg-1.21.11-v1.7.15" = _w6IaXuOc;
        "pkg-1.21.11-v1.7.16" = _yOSkgqXE;
        "pkg-1.21.11-v1.7.17" = _yf6nsLzw;
        "pkg-1.21.11-v1.7.18" = _DS0JmtsD;
        "pkg-26.1-r1.0-neoforge" = _bFCqrSNY;
        "pkg-26.1-r1.0-fabric" = _LjqsOPx3;
        "pkg-26.1-r1.1-neoforge" = _pTgPPDW4;
        "pkg-26.1-r1.1-fabric" = _iCZwsY62;
        "pkg-1.20.1-v1.5.12" = _hEg2x5o8;
        "pkg-26.1-r1.2-neoforge" = _MgTUD9yJ;
