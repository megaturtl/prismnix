...
let
    ...
    in {
        ...
        "pkg-3.1.1-1.19.2" = _4vBIcLl5;
        "pkg-2.0.3-1.18.2" = _OjVDLhp8;
        "pkg-2.0.1-1.16.5" = _cvV73NZf;
        "pkg-3.1.3-1.20" = _OfDY0j6J;
        "pkg-3.1.3-1.19.2" = _P2YDt9Vr;
        "pkg-fabric-3.1.3-1.20" = _tx2xqxt4;
        "pkg-fabric-3.1.3-1.19.2" = _j7pCRI2o;
        "pkg-3.1.4-1.19.2" = _pQxWZBvX;
        "pkg-3.1.4-1.20" = _uJyKtcLC;
        "pkg-fabric-3.1.4-1.19.2" = _Khk9jNAc;
        "pkg-fabric-3.1.4-1.20" = _yQebXZkw;
        "pkg-fabric-3.1.5-1.19.2" = _nzxNHa9C;
        "pkg-fabric-3.1.5-1.20" = _4BBCXAgd;
        "pkg-3.1.5-1.20" = _BFX1CDJ6;
        "pkg-fabric-3.1.6-1.20" = _CdgX1NKy;
        "pkg-3.1.5-1.21" = _E87UdR7u;
        "pkg-3.1.6-1.21" = _X90OBeWR;
        "pkg-3.1.6" = _GaMdNhQQ;
        "pkg-fabric-3.1.7-1.21" = _I8SCEtOo;
        "pkg-fabric-3.1.8-1.21" = _Ms80KqaO;
        "pkg-3.1.7" = _A9Ri2gYl;
        "pkg-3.1.8" = _otPmhdts;
