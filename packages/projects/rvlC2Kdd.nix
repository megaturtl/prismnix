...
let
    ...
    in {
        ...
        "pkg-1.2.8" = _ipubvvYi;
        "pkg-1.2.9" = _xdJ29keo;
        "pkg-1.2.10" = _eMKbGLrQ;
        "pkg-1.2.11" = _CV8VhVT3;
        "pkg-1.2.12" = _ucEoYYdA;
        "pkg-1.2.13" = _saPR9nbM;
        "pkg-1.2.14" = _2aRVCNi6;
        "pkg-1.2.15" = _8fTXR6P3;
        "pkg-1.2.16" = _ncrF5DOf;
        "pkg-1.2.17" = _Km8avXe2;
        "pkg-1.2.18" = _yQlss7EJ;
        "pkg-1.2.19" = _ycsiIBvT;
