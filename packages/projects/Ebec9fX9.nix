...
let
    ...
    in {
        ...
        "pkg-0.5.4-beta-mc1.20.5" = _ZebNinH9;
        "pkg-0.5.4-beta-mc1.20.6" = _g1ZiRhkJ;
        "pkg-0.5.4-beta-mc1.21" = _B6WIOW04;
        "pkg-0.5.5-beta-mc1.20.6" = _wdiRak7S;
        "pkg-0.5.5-beta-mc1.21.2" = _5F51d2ny;
        "pkg-0.5.5-beta-mc1.21.3" = _bLYjkSI7;
        "pkg-0.5.7-beta-mc1.20.6" = _8By514WV;
        "pkg-0.5.7-beta-mc1.21.4" = _t2RFr6TL;
        "pkg-0.5.7-beta-mc1.21.3" = _YmnYuB3l;
        "pkg-0.5.7-beta-mc1.20.4" = _UIt2iWPq;
        "pkg-0.5.8-beta-mc1.20.6" = _5EY4Qfm5;
        "pkg-0.5.8-beta-mc1.21.5" = _Oz3TfIOe;
        "pkg-0.5.8-beta-mc1.21.6" = _MPOVZryp;
        "pkg-0.5.8-beta-mc1.21.7" = _iFTs3iAX;
        "pkg-0.5.8-beta-mc1.21.8" = _JMt40R0f;
        "pkg-0.5.8-beta-mc1.21.9" = _KSuLji0m;
        "pkg-0.5.8-beta-mc1.21.10" = _iCcM36LA;
        "pkg-0.6.0-beta-mc1.20.6" = _cxEmUTWp;
        "pkg-0.6.0-beta-mc1.21.10" = _gB7Pdv0G;
        "pkg-0.6.0-beta-mc1.21.11" = _F8E5MIpL;
