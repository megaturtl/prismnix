...
let
    versions = (let
        ...
        _5fWQnym4 = {
            "id" = "5fWQnym4";
            "file" = "sparklogin-3.0.0.jar";
            "hash" = "sha512-3G6E9D5cy9N5/86H3qmjRbTW1Pus8rOca0rXAvTQBJqv1t5HT9YjvO+AkwPr80M8qjCAw/WeMnQYvQP6u+Se6Q==";
        };
    in {
        "89bWSkew" = _89bWSkew;
        "2ceoepwh" = _2ceoepwh;
        ...
        "paper-1.21.6" = _5fWQnym4;
        "paper-1.21.7" = _5fWQnym4;
        "paper-1.21.8" = _5fWQnym4;
        "paper-1.21.9" = _5fWQnym4;
        "paper-1.21.10" = _5fWQnym4;
        "paper-1.21.11" = _5fWQnym4;
        "paper-26.1" = _5fWQnym4;
        "paper-26.1.1" = _5fWQnym4;
        "paper-26.1.2" = _5fWQnym4;
        "paper-26.2" = _5fWQnym4;
        ...
        "spigot-1.21.6" = _5fWQnym4;
        "spigot-1.21.7" = _5fWQnym4;
        "spigot-1.21.8" = _5fWQnym4;
        "spigot-1.21.9" = _5fWQnym4;
        "spigot-1.21.10" = _5fWQnym4;
        "spigot-1.21.11" = _5fWQnym4;
        "spigot-26.1" = _5fWQnym4;
        "spigot-26.1.1" = _5fWQnym4;
        "spigot-26.1.2" = _5fWQnym4;
        "spigot-26.2" = _5fWQnym4;
        "purpur-1.21.11" = _5fWQnym4;
        "purpur-1.21.6" = _5fWQnym4;
        "purpur-1.21.7" = _5fWQnym4;
        "purpur-1.21.8" = _5fWQnym4;
        "purpur-1.21.9" = _5fWQnym4;
        "purpur-1.21.10" = _5fWQnym4;
        "purpur-26.1" = _5fWQnym4;
        "purpur-26.1.1" = _5fWQnym4;
        "purpur-26.1.2" = _5fWQnym4;
        "purpur-26.2" = _5fWQnym4;
        "pkg-1.0.0" = _89bWSkew;
        "pkg-1.1.0" = _2ceoepwh;
        "pkg-1.2.0" = _t4hR5tLB;
        "pkg-2.0.0" = _e6FBDihp;
