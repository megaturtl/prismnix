...
let
    versions = (let
        ...
        _1hd8A6OR = {
            "id" = "1hd8A6OR";
            "file" = "ServerLens_fabric_26.2.x_2.1.0.jar";
            "hash" = "sha512-4UkBieoZYX0AP/GoskLSlH4RUP/nLPuvwNWV/MBEMnyDH3N4P5jxxuKbuoVnDvAlCi74Y8Pq5ziClmK12zHKoA==";
        };
    in {
        "lueMw8ZM" = _lueMw8ZM;
        "NgqdUsVE" = _NgqdUsVE;
