...
let
    versions = (let
        ...
        _NkKJnwWq = {
            "id" = "NkKJnwWq";
            "file" = "legacy-display-1.1.24.jar";
            "hash" = "sha512-WMD5FRkUpGOS890HcdOCk0gk6czn0G8phhYbEuhKcPkZib3tx7MOBkpwIJrHcVuAa53zPqD7nUNINLikx/Lcdg==";
        };
    in {
        "3FRFQGkK" = _3FRFQGkK;
        "9uTeW2h5" = _9uTeW2h5;
        ...
        "pkg-1.1.8" = _dBKfbLoB;
        "pkg-1.1.9" = _y97UqW03;
        "pkg-1.1.10" = _UQ1No82W;
        "pkg-1.1.11" = _x52V24zb;
        "pkg-1.1.12" = _CYxA0WHp;
        "pkg-1.1.13" = _Trd7FsmN;
        "pkg-1.1.14" = _6UXcS5by;
        "pkg-1.1.15" = _cVSUJgCv;
        "pkg-1.1.16" = _2tIPO2rJ;
        "pkg-1.1.17" = _erMgDN33;
        "pkg-1.1.18" = _Jf9Ic3N6;
        "pkg-1.1.19" = _zZwgpHdI;
        "pkg-1.1.20" = _XotW69D4;
        "pkg-1.1.21" = _UtWSZl8G;
        "pkg-1.1.22" = _J85iaA7g;
        "pkg-1.1.23" = _wXJXl5wR;
        "pkg-1.1.24" = _NkKJnwWq;
        "default" = _NkKJnwWq;
    });
