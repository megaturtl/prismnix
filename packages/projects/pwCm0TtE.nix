...
let
    versions = (let
        ...
        _OfHlWl85 = {
            "id" = "OfHlWl85";
            "file" = "AutoTreeChop-1.7.5-alpha+35d3ee7.jar";
            "hash" = "sha512-Gb6MLP0f6m/t7gO7Pu1xSOD8dMqWlvp37uiAmi9nNDR0suQnasKnx2YgdvMqD3yspBCisrGNTXQmHfI4/h4dOg==";
        };
        _2csXoOmv = {
            "id" = "2csXoOmv";
            "file" = "AutoTreeChop-1.7.5-alpha+d444db3.jar";
            "hash" = "sha512-h4qFzeFKdIoNj9k7aFARi6ANDIuZXsXcckp6ux4cusJpsqXwYgFUdRXQAkX7OtDgPKuKyRLYy2Q1y+EE1Z8TZQ==";
        };
        _ynQBjDSV = {
            "id" = "ynQBjDSV";
            "file" = "AutoTreeChop-1.7.5-alpha+8ebfaf6.jar";
            "hash" = "sha512-LGDeio89JqxCj1/Lx7GKLKE+kdYudRMcsWUZiErUEKxm1vUAagXsKKo/oOOOMw/JK9x1HjQIGS2/xAiTpo99VQ==";
        };
        _o9SdPqFP = {
            "id" = "o9SdPqFP";
            "file" = "AutoTreeChop-1.7.5.jar";
            "hash" = "sha512-5AR8Wn9GX6F0H25skfPasUiW3IVz9LUQI3TzPm5s3B9noRPowRghPoR9HRE9XvoGAnhakRhRgLAu07dcfBVNvQ==";
        };
    in {
        "lHvH2NXY" = _lHvH2NXY;
        "Ts0YCBA0" = _Ts0YCBA0;
        ...
        "ynQBjDSV" = _ynQBjDSV;
        "o9SdPqFP" = _o9SdPqFP;
        "paper-1.17" = _o9SdPqFP;
        "paper-1.17.1" = _o9SdPqFP;
        "paper-1.18" = _o9SdPqFP;
        "paper-1.18.1" = _o9SdPqFP;
        "paper-1.18.2" = _o9SdPqFP;
        "paper-1.19" = _o9SdPqFP;
        "paper-1.19.1" = _o9SdPqFP;
        "paper-1.19.2" = _o9SdPqFP;
        "paper-1.19.3" = _o9SdPqFP;
        "paper-1.19.4" = _o9SdPqFP;
        "paper-1.20" = _o9SdPqFP;
        "paper-1.20.1" = _o9SdPqFP;
        "paper-1.20.2" = _o9SdPqFP;
        "paper-1.20.3" = _o9SdPqFP;
        "paper-1.20.4" = _o9SdPqFP;
        "paper-1.20.5" = _o9SdPqFP;
        "paper-1.20.6" = _o9SdPqFP;
        "paper-1.21" = _o9SdPqFP;
        "paper-1.21.1" = _o9SdPqFP;
        "paper-1.21.2" = _o9SdPqFP;
        "paper-1.21.3" = _o9SdPqFP;
        "paper-1.21.4" = _o9SdPqFP;
        "paper-1.21.5" = _o9SdPqFP;
        "paper-1.21.6" = _o9SdPqFP;
        "paper-1.21.7" = _o9SdPqFP;
        "paper-1.21.8" = _o9SdPqFP;
        "paper-1.21.9" = _o9SdPqFP;
        "paper-1.21.10" = _o9SdPqFP;
        "paper-1.21.11" = _o9SdPqFP;
        "paper-26.1" = _o9SdPqFP;
        "paper-26.1.1" = _o9SdPqFP;
        "paper-26.1.2" = _o9SdPqFP;
        "paper-26.2" = _o9SdPqFP;
        "paper-26.3" = _o9SdPqFP;
        "purpur-1.17" = _o9SdPqFP;
        "purpur-1.17.1" = _o9SdPqFP;
        "purpur-1.18" = _o9SdPqFP;
        "purpur-1.18.1" = _o9SdPqFP;
        "purpur-1.18.2" = _o9SdPqFP;
        "purpur-1.19" = _o9SdPqFP;
        "purpur-1.19.1" = _o9SdPqFP;
        "purpur-1.19.2" = _o9SdPqFP;
        "purpur-1.19.3" = _o9SdPqFP;
        "purpur-1.19.4" = _o9SdPqFP;
        "purpur-1.20" = _o9SdPqFP;
        "purpur-1.20.1" = _o9SdPqFP;
        "purpur-1.20.2" = _o9SdPqFP;
        "purpur-1.20.3" = _o9SdPqFP;
        "purpur-1.20.4" = _o9SdPqFP;
        "purpur-1.20.5" = _o9SdPqFP;
        "purpur-1.20.6" = _o9SdPqFP;
        "purpur-1.21" = _o9SdPqFP;
        "purpur-1.21.1" = _o9SdPqFP;
        "purpur-1.21.2" = _o9SdPqFP;
        "purpur-1.21.3" = _o9SdPqFP;
        "purpur-1.21.4" = _o9SdPqFP;
        "purpur-1.21.5" = _o9SdPqFP;
        "purpur-1.21.6" = _o9SdPqFP;
        "purpur-1.21.7" = _o9SdPqFP;
        "purpur-1.21.8" = _o9SdPqFP;
        "purpur-1.21.9" = _o9SdPqFP;
        "purpur-1.21.10" = _o9SdPqFP;
        "purpur-1.21.11" = _o9SdPqFP;
        "purpur-26.1" = _o9SdPqFP;
        "purpur-26.1.1" = _o9SdPqFP;
        "purpur-26.1.2" = _o9SdPqFP;
        "purpur-26.2" = _o9SdPqFP;
        "purpur-26.3" = _o9SdPqFP;
        "spigot-1.17" = _o9SdPqFP;
        "spigot-1.17.1" = _o9SdPqFP;
        "spigot-1.18" = _o9SdPqFP;
        "spigot-1.18.1" = _o9SdPqFP;
        "spigot-1.18.2" = _o9SdPqFP;
        "spigot-1.19" = _o9SdPqFP;
        "spigot-1.19.1" = _o9SdPqFP;
        "spigot-1.19.2" = _o9SdPqFP;
        "spigot-1.19.3" = _o9SdPqFP;
        "spigot-1.19.4" = _o9SdPqFP;
        "spigot-1.20" = _o9SdPqFP;
        "spigot-1.20.1" = _o9SdPqFP;
        "spigot-1.20.2" = _o9SdPqFP;
        "spigot-1.20.3" = _o9SdPqFP;
        "spigot-1.20.4" = _o9SdPqFP;
        "spigot-1.20.5" = _o9SdPqFP;
        "spigot-1.20.6" = _o9SdPqFP;
        "spigot-1.21" = _o9SdPqFP;
        "spigot-1.21.1" = _o9SdPqFP;
        "spigot-1.21.2" = _o9SdPqFP;
        "spigot-1.21.3" = _o9SdPqFP;
        "spigot-1.21.4" = _o9SdPqFP;
        "spigot-1.21.5" = _o9SdPqFP;
        "spigot-1.21.6" = _o9SdPqFP;
        "spigot-1.21.7" = _o9SdPqFP;
        "spigot-1.21.8" = _o9SdPqFP;
        "spigot-1.21.9" = _o9SdPqFP;
        "spigot-1.21.10" = _o9SdPqFP;
        "spigot-1.21.11" = _o9SdPqFP;
        "spigot-26.1" = _o9SdPqFP;
        "spigot-26.1.1" = _o9SdPqFP;
        "spigot-26.1.2" = _o9SdPqFP;
        "spigot-26.2" = _o9SdPqFP;
        "spigot-26.3" = _o9SdPqFP;
        "folia-1.17" = _o9SdPqFP;
        "folia-1.17.1" = _o9SdPqFP;
        "folia-1.18" = _o9SdPqFP;
        "folia-1.18.1" = _o9SdPqFP;
        "folia-1.18.2" = _o9SdPqFP;
        "folia-1.19" = _o9SdPqFP;
        "folia-1.19.1" = _o9SdPqFP;
        "folia-1.19.2" = _o9SdPqFP;
        "folia-1.19.3" = _o9SdPqFP;
        "folia-1.19.4" = _o9SdPqFP;
        "folia-1.20" = _o9SdPqFP;
        "folia-1.20.1" = _o9SdPqFP;
        "folia-1.20.2" = _o9SdPqFP;
        "folia-1.20.3" = _o9SdPqFP;
        "folia-1.20.4" = _o9SdPqFP;
        "folia-1.20.5" = _o9SdPqFP;
        "folia-1.20.6" = _o9SdPqFP;
        "folia-1.21" = _o9SdPqFP;
        "folia-1.21.1" = _o9SdPqFP;
        "folia-1.21.2" = _o9SdPqFP;
        "folia-1.21.3" = _o9SdPqFP;
        "folia-1.21.4" = _o9SdPqFP;
        "folia-1.21.5" = _o9SdPqFP;
        "folia-1.21.6" = _o9SdPqFP;
        "folia-1.21.7" = _o9SdPqFP;
        "folia-1.21.8" = _o9SdPqFP;
        "folia-1.21.9" = _o9SdPqFP;
        "folia-1.21.10" = _o9SdPqFP;
        "folia-1.21.11" = _o9SdPqFP;
        "folia-26.1" = _o9SdPqFP;
        "folia-26.1.1" = _o9SdPqFP;
        "folia-26.1.2" = _o9SdPqFP;
        "folia-26.2" = _o9SdPqFP;
        "folia-26.3" = _o9SdPqFP;
        "pkg-1.1.0" = _lHvH2NXY;
        "pkg-1.2.0-beta1" = _Ts0YCBA0;
        "pkg-1.2.0" = _nowOR8RL;
        "pkg-1.2.1" = _o0S6aqiy;
        "pkg-1.3.0-beta.1" = _4n4E9RuD;
        "pkg-1.3.0" = _jXwKc7Xs;
        "pkg-1.4.0" = _YfR8gWyD;
        "pkg-1.5.0" = _RTSIYO31;
        "pkg-1.5.1" = _NRjmvmSO;
        ...
        "pkg-1.6.1" = _lb5XC3dt;
        "pkg-1.6.2" = _V5e8Crv0;
        "pkg-1.6.3-SNAPSHOT" = _bDiWupqf;
        "pkg-1.7.0" = _SUeTsvQA;
        "pkg-1.7.1-SNAPSHOT" = _6KTUAP4j;
        "pkg-1.7.1-SNAPSHOT-307e598" = _ffhrn1mO;
        "pkg-1.7.1-SNAPSHOT-a48720c" = _HPfRf0OB;
        "pkg-1.7.1" = _dPa2g4z4;
        "pkg-1.7.2-SNAPSHOT-4d4e427" = _UF1tJVxe;
        "pkg-1.7.2-SNAPSHOT-b0b7cef" = _q0mCt7V5;
        "pkg-1.7.2-alpha+5f4ef92" = _o8ekNOpS;
        "pkg-1.7.2-alpha+e17a283" = _yR5OMzfO;
        "pkg-1.7.2-alpha+770743b" = _51w8LCXR;
        "pkg-1.7.2-alpha+f8a862c" = _L9SvYVgT;
        "pkg-1.7.2-alpha+d09d6fe" = _WpiS87Kn;
        "pkg-1.7.2-alpha+8c2879f" = _ju5AWzeW;
        "pkg-1.7.2-alpha+749de47" = _PNVDa8x3;
        "pkg-1.7.2-alpha+111dfec" = _XHcvjyok;
        "pkg-1.7.2" = _XfsqYx10;
        "pkg-1.7.3-alpha+d98ecdf" = _cPe44x0q;
        "pkg-1.7.3-alpha+bcdd4d4" = _HjNcYvbc;
        "pkg-1.7.3-alpha+fedcf89" = _oEXiZt5I;
        "pkg-1.7.3-alpha+eb825f3" = _QJffqD6G;
        "pkg-1.7.3-alpha+63bdda3" = _wrAQXxqv;
        "pkg-1.7.3" = _4DjimssT;
        "pkg-1.7.4-alpha+45cd9f0" = _FnNZOqzw;
        "pkg-1.7.4-alpha+9ea5b41" = _i6nxQbSt;
        "pkg-1.7.4-alpha+8a1ccf9" = _TL3jUSbR;
        "pkg-1.7.4-alpha+d004f08" = _Ir6VkX2S;
        "pkg-1.7.4-alpha+ee745af" = _7urMMsNx;
        "pkg-1.7.4-alpha+e53d9f0" = _TrIcv6vJ;
        "pkg-1.7.4" = _E60WrrG4;
        "pkg-1.7.5-alpha+71682a2" = _brwTVBNH;
        "pkg-1.7.5-alpha+5a4baa5" = _L4QJw531;
        "pkg-1.7.5-alpha+e963a24" = _CEWoVR1S;
        "pkg-1.7.5-alpha+35d3ee7" = _OfHlWl85;
        "pkg-1.7.5-alpha+d444db3" = _2csXoOmv;
        "pkg-1.7.5-alpha+8ebfaf6" = _ynQBjDSV;
        "pkg-1.7.5" = _o9SdPqFP;
        "default" = _o9SdPqFP;
    });
