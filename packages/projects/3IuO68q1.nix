...
let
    ...
    in {
        ...
        "pkg-1.3.2" = _M2gHjpvJ;
        "pkg-1.3.3" = _AdaUUZFO;
        "pkg-1.3.4-1.18" = _BwPisc5I;
        "pkg-1.3.4" = _fHyQwCW4;
        "pkg-1.4.0-1.18" = _R9FfGWqP;
        "pkg-1.4.0-1.19" = _TM6dpuQ9;
        "pkg-1.4.1-1.18" = _EZrDjvh2;
        "pkg-1.4.2-1.19.3" = _Bi6mh1Yb;
        "pkg-1.4.2-1.19.2" = _NwemUTyO;
        "pkg-1.5.0+1.19.4" = _6X1Tk01Y;
        "pkg-1.5.1+1.20" = _SyDRZGtj;
        "pkg-1.5.2+1.20" = _F5UKlslF;
        "pkg-1.6.0+1.20.2" = _832Mh47P;
        "pkg-1.6.1+1.20.4" = _1srBlHhv;
        "pkg-1.6.2+1.20.6" = _foWdRKRT;
        "pkg-1.6.3+1.21-Puzzle" = _2pBwdDy2;
        "pkg-2.0.0-fabric" = _eeYIIdGh;
        "pkg-2.0.0-neoforge" = _tklDcfwJ;
        "pkg-2.0.1-neoforge" = _A1G9Ub0t;
        "pkg-2.0.1-fabric" = _TMFxzCSV;
        "pkg-2.0.2-fabric" = _5ENjAnxM;
        "pkg-2.0.2-neoforge" = _bvbDdP4R;
        "pkg-2.0.3-neoforge" = _tpQQi2ar;
        "pkg-2.0.3-fabric" = _2g8EnqTl;
        "pkg-2.0.4-fabric" = _6iheLyWa;
        "pkg-2.0.4-neoforge" = _jRGfRYuI;
        "pkg-2.0.5-fabric" = _ETBSXbar;
        "pkg-2.0.5-neoforge" = _YZwQf2sk;
        "pkg-2.1.0-fabric" = _JyVlkrSf;
        "pkg-2.1.0-neoforge" = _gdnxBN9L;
        "pkg-2.1.1-fabric" = _EfTbdnT6;
        "pkg-2.1.1-neoforge" = _fFrfftNd;
        "pkg-2.0.1.1-fabric" = _lqKTswvP;
        "pkg-2.0.1.1-neoforge" = _rwJQkaY5;
        "pkg-2.1.2-fabric" = _9EpmlvYD;
        "pkg-2.1.2-neoforge" = _nkN5KZ7s;
        "pkg-2.2.0+1.21.5-neoforge" = _a5cDb7Li;
        "pkg-2.2.0+1.21.1-fabric" = _DUS6Ho2a;
        "pkg-2.2.0+1.20.1-fabric" = _cG5QV3Tj;
        "pkg-2.2.0+1.21.1-neoforge" = _hC76gvAj;
        "pkg-2.2.0+1.21.8-fabric" = _9FhjB3hc;
        "pkg-2.2.0+1.21.5-fabric" = _Y13XchsW;
        "pkg-2.2.0+1.21.10-neoforge" = _UkDtVQc9;
        "pkg-2.2.0+1.21.10-fabric" = _W6M0w3m4;
        "pkg-2.2.1+1.20.1-fabric" = _8qlnRMi7;
        "pkg-2.2.1+1.21.1-fabric" = _8vDyDviM;
        "pkg-2.2.1+1.21.1-neoforge" = _p5WWRIWB;
        "pkg-2.2.1+1.21.11-fabric" = _WFIcYgeD;
        "pkg-2.2.1+1.21.10-fabric" = _xLpx8hab;
        "pkg-2.2.1+1.21.10-neoforge" = _PVthhfEF;
        "pkg-2.2.1+1.21.11-neoforge" = _2gNhmSRC;
        "pkg-2.2.1+1.21.4-fabric" = _WdqmZSBc;
        "pkg-2.2.1+1.21.5-fabric" = _zUd9jTgM;
        "pkg-2.2.1+1.21.5-neoforge" = _pOaShhhh;
        "pkg-2.2.1+1.21.4-neoforge" = _lA6VAl5I;
        "pkg-2.2.1+1.21.8-fabric" = _xnOQLcDf;
        "pkg-2.2.1+1.21.8-neoforge" = _X3OhjS7O;
        "pkg-2.3.0+1.20.1-fabric" = _iDnrnpRl;
        "pkg-2.3.0+1.21.1-fabric" = _DuV4z8Sp;
        "pkg-2.3.0+1.21.10-neoforge" = _S8odfYOq;
        "pkg-2.3.0+1.21.11-neoforge" = _IQIMirRI;
        "pkg-2.3.0+1.21.10-fabric" = _cCPOJCl5;
        "pkg-2.3.0+1.21.1-neoforge" = _bZNDTLHq;
        "pkg-2.3.0+1.21.11-fabric" = _Y9KybGCk;
        "pkg-2.3.0+1.21.4-fabric" = _YGEnr37E;
        "pkg-2.3.0+1.21.4-neoforge" = _N1QLfcVF;
        "pkg-2.3.0+1.21.5-fabric" = _QVq7m4OR;
        "pkg-2.3.0+1.21.8-fabric" = _HUt5RNu0;
        "pkg-2.3.0+1.21.8-neoforge" = _vln44MVn;
        "pkg-2.3.0+1.21.5-neoforge" = _UzLAfRdR;
        "pkg-2.3.1+26.1-fabric" = _M6In6JRO;
