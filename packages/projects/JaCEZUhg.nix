...
let
    ...
    in {
        ...
        "pkg-2.2.30" = _wxzQQoCD;
        "pkg-2.2.31" = _ogsviHMP;
        "pkg-2.2.32" = _4AiMxiP8;
        "pkg-3.0.0-beta" = _QZ6ko64x;
        "pkg-3.0.1-beta" = _VBRtY4ND;
        "pkg-3.0.2-beta" = _EgndFSjS;
        "pkg-3.0.3-beta" = _p1EcE9ZP;
        "pkg-3.1.0-beta" = _viNQ7p0F;
        "pkg-3.1.1-beta" = _xyZcPhZN;
        "pkg-3.1.2-beta" = _I8AepT5Q;
        "pkg-3.1.3-beta" = _m5kJFzy1;
        "pkg-3.1.4-beta" = _i8FDEwl6;
        "pkg-3.1.5-beta" = _qrdy2320;
        "pkg-3.1.6" = _GZfbliaP;
        "pkg-2.2.33" = _gGitRm7b;
        "pkg-3.1.7" = _cj6J609Z;
        "pkg-3.1.8" = _T3mxAR4V;
        "pkg-3.1.9" = _9jMTzfup;
        "pkg-3.2.0" = _ANiZ4K5y;
        ...
        "pkg-3.2.8" = _jsB5S4WC;
        "pkg-3.2.9" = _CqK646gI;
        "pkg-3.2.10" = _sv4FrDFN;
        "pkg-3.2.11" = _RZBqTL7z;
        "pkg-3.2.12" = _HXHhJbc4;
        "pkg-3.2.13" = _R1EF5bAS;
        "pkg-3.2.14" = _YO1EaEWV;
        "pkg-3.2.15" = _fyidRM2Q;
        "pkg-3.2.16" = _9KLbGimV;
        "pkg-3.2.17" = _oNT75sXU;
        "pkg-3.2.18" = _Gu29xenE;
        "pkg-3.2.19" = _tzI7ngJN;
        "pkg-4.0.0-beta" = _my5baOc5;
        "pkg-4.0.1-beta" = _6CvZRuH9;
        "pkg-4.0.2-beta" = _DNYd9sc1;
        "pkg-4.0.3-beta" = _PqM8fmcA;
        "pkg-4.0.4-beta" = _giuFMulu;
        "pkg-4.0.5-beta" = _JCusAJHn;
        "pkg-4.0.6-beta" = _XbU5aNgb;
        "pkg-4.0.7-beta" = _iGgU61na;
        "pkg-4.0.8-beta" = _odKP6nb4;
        "pkg-4.0.9-beta" = _rrlsalYy;
        "pkg-4.0.10-beta" = _Qkikzfjg;
        "pkg-4.0.11-beta" = _5iBylePW;
        "pkg-4.0.12-beta" = _pqLcG0pW;
        "pkg-4.0.13-beta" = _5sK4nCjO;
        "pkg-4.0.14-beta" = _N5s0fDvU;
        "pkg-4.0.15-beta" = _dXsQMz7I;
        "pkg-4.0.16-beta" = _zEmvfZLt;
        "pkg-3.2.20" = _pH3a8Xt2;
        "pkg-4.0.17-beta" = _2tZU2V6U;
        "pkg-4.0.18-beta" = _mvwsjqMc;
        "pkg-4.0.19-beta" = _exuWZWNi;
        "pkg-3.2.21" = _YOWlaJch;
        "pkg-4.1.0" = _lv9gSYg1;
        "pkg-4.1.1" = _3FO3as07;
        "pkg-3.2.22" = _oa33yuzy;
        "pkg-4.1.2" = _h1Db2uRD;
        "pkg-3.2.23" = _aXa5OyYQ;
        "pkg-4.1.3" = _HjUho0IR;
        "pkg-4.1.4" = _75sEnnMd;
        "pkg-4.2.0" = _oZydrhFc;
        "pkg-4.2.1" = _nVpFoMp5;
