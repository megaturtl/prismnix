...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.1" = _J7Hi2CFm;
        "pkg-1.21-1.21.1-1.3" = _wGwdLVOx;
        "pkg-1.21.2-1.21.3-1.1" = _s3YmRx5E;
        "pkg-1.21.5-1.0" = _hiAlnfw1;
        "pkg-1.16.5-1.0" = _zeRO9m0m;
        "pkg-1.21.6-1.0" = _adP0lAnx;
        "pkg-1.21.9-1.0" = _rQ8fvDgh;
