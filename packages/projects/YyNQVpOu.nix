...
let
    ...
    in {
        ...
        "pkg-1.1.8-forge-mc1.16" = _IXXJdaPz;
        "pkg-1.1.8-forge-mc1.17" = _zjwzqY6b;
        "pkg-1.1.8-forge-mc1.18" = _7dFAlMeC;
        "pkg-1.1.8b-forge-mc1.19" = _KFQg85Sf;
        "pkg-1.1.9-forge-mc1.12" = _ILrD1s0p;
        "pkg-1.1.9-forge-mc1.15" = _ggjnuh5H;
        "pkg-1.1.9-forge-mc1.16" = _wdJEnuui;
        "pkg-1.1.9-forge-mc1.17" = _ILPsG98Y;
        "pkg-1.1.9-forge-mc1.18" = _RIr7NFBa;
        "pkg-1.1.9-forge-mc1.19" = _IibeK5lN;
        "pkg-1.1.9-forge-mc1.14" = _yWhCC2Tp;
        "pkg-1.1.9-forge-mc1.19.3" = _zAXn20jn;
        "pkg-1.1.9-forge-mc1.19.4" = _sANI9Kfw;
        "pkg-1.1.9-fabric-mc1.18" = _z2b3knyd;
        "pkg-1.1.9-fabric-mc1.19" = _FjOnRC24;
        "pkg-1.1.9-fabric-mc1.19.2" = _YlHAIFmW;
        "pkg-1.1.9-forge-mc1.20" = _8eHwFX3j;
        "pkg-1.1.9-fabric-mc1.20" = _ZzQ3TaqZ;
        "pkg-1.1.10-forge-mc1.12" = _1TGi273L;
        "pkg-1.1.10-forge-mc1.14" = _uE4Gcaig;
        "pkg-1.1.10-forge-mc1.15" = _3ZRrYoMA;
        "pkg-1.1.10-forge-mc1.16" = _xZDLXMYD;
        "pkg-1.1.10-forge-mc1.17" = _r8uKtdCo;
        "pkg-1.1.10-forge-mc1.18" = _Ue15hTZV;
        "pkg-1.1.10-forge-mc1.19" = _jArqyYEj;
        "pkg-1.1.10-forge-mc1.19.3" = _vb1ouyrX;
        "pkg-1.1.10-forge-mc1.19.4" = _uYFCaCXi;
        "pkg-1.1.10-forge-mc1.20" = _g2LOrLm2;
        "pkg-1.1.10-fabric-mc1.18" = _mAkr9mmY;
        "pkg-1.1.10-fabric-mc1.19.2" = _sWmz72Q7;
        "pkg-1.1.10-fabric-mc1.19.4" = _IEjf0FH1;
        "pkg-1.1.10-fabric-mc1.20" = _wnRRvAet;
        "pkg-1.1.10-fabric-mc1.20.4" = _8cCxyQpt;
        "pkg-1.1.10-forge-mc1.20.4" = _5xbc3g1K;
        "pkg-1.1.10-neoforge-mc1.20.4" = _x3KXhIbM;
        "pkg-1.1.11-forge-mc1.12" = _fxVldpqD;
        "pkg-1.1.11-forge-mc1.14" = _VVpYnEw3;
        "pkg-1.1.11-forge-mc1.15" = _uF9JvUUZ;
        "pkg-1.1.11-forge-mc1.16" = _VNcX9t0q;
        "pkg-1.1.11-forge-mc1.17" = _9YOBHGZh;
        "pkg-1.1.11-forge-mc1.18" = _Dp49vfgV;
        "pkg-1.1.11-forge-mc1.19" = _hKNXdVob;
        "pkg-1.1.11-forge-mc1.19.3" = _ThFYTOBa;
        "pkg-1.1.11-forge-mc1.19.4" = _hhNJru6F;
        "pkg-1.1.11-forge-mc1.20" = _ekp4JN5S;
        "pkg-1.1.11-forge-mc1.20.4" = _IhjPg4go;
        "pkg-1.1.11-fabric-mc1.18" = _MIZNFyM4;
        "pkg-1.1.11-fabric-mc1.19.2" = _odp11wvP;
        "pkg-1.1.11-fabric-mc1.19.4" = _PCNZXV4f;
        "pkg-1.1.11-fabric-mc1.20" = _ZiwUDHyo;
        "pkg-1.1.11-fabric-mc1.20.4" = _9DOceFcn;
        "pkg-1.1.11-neoforge-mc1.20.4" = _UgYW5NOt;
        "pkg-1.1.11-forge-mc1.20.6" = _wD9UEwGY;
        "pkg-1.1.11-forge-mc1.21" = _Z8WYol1I;
        "pkg-1.1.11-fabric-mc1.20.6" = _RH63zE3l;
        "pkg-1.1.11-fabric-mc1.21" = _Pf4RXgx6;
        "pkg-1.1.11-neoforge-mc1.20.6" = _ihn9dzpA;
        "pkg-1.1.11-neoforge-mc1.21" = _LMgq1iru;
        "pkg-1.1.11a-fabric-mc1.20.6" = _RIIWipIf;
        "pkg-1.1.11a-fabric-mc1.21" = _QiCGRaDy;
        "pkg-1.1.11a-neoforge-mc1.20.6" = _kGKQzk7m;
        "pkg-1.1.11a-neoforge-mc1.21" = _l5IQrovw;
        "pkg-1.1.11b-neoforge-mc1.21" = _QVBMyLyE;
        "pkg-1.1.11a-forge-mc1.21" = _rvwJyudD;
        "pkg-1.1.11b-fabric-mc1.21" = _fsccu9BS;
        "pkg-1.1.12-forge-mc1.12" = _jvqx9L3y;
        "pkg-1.1.12-forge-mc1.14" = _pFsHogNH;
        "pkg-1.1.12-forge-mc1.15" = _c96ESUi5;
        "pkg-1.1.12-forge-mc1.16" = _Ay11J1nH;
        "pkg-1.1.12-forge-mc1.17" = _SSX3MtyL;
        "pkg-1.1.12-forge-mc1.18" = _NXm33Kje;
        "pkg-1.1.12-forge-mc1.19.2" = _3kgrSkNM;
        "pkg-1.1.12-forge-mc1.19.3" = _7X0Qr4Zm;
        "pkg-1.1.12-forge-mc1.19.4" = _zybXwBxB;
        "pkg-1.1.12-forge-mc1.20.2" = _BpvjT7dt;
        "pkg-1.1.12-forge-mc1.20.4" = _U0Eji2ih;
        "pkg-1.1.12-forge-mc1.20.6" = _iXTppNFC;
        "pkg-1.1.12-forge-mc1.21" = _KKf9trE9;
        "pkg-1.1.12-fabric-mc1.18" = _gXRdca83;
        "pkg-1.1.12-fabric-mc1.19.2" = _L2o4HLpp;
        "pkg-1.1.12-fabric-mc1.19.4" = _xgHv8Lhj;
        "pkg-1.1.12-fabric-mc1.20.2" = _Up6Adjfn;
        "pkg-1.1.12-fabric-mc1.20.4" = _qa0av7gd;
        "pkg-1.1.12-fabric-mc1.20.6" = _j4VoTaQY;
        "pkg-1.1.12-fabric-mc1.21" = _HvTCgQ5d;
        "pkg-1.1.12-neoforge-mc1.20.4" = _5tlJCEvI;
        "pkg-1.1.12-neoforge-mc1.20.6" = _C0CBj45A;
        "pkg-1.1.12-neoforge-mc1.21" = _9GDp1QbG;
        "pkg-1.1.12-forge-mc1.20.1" = _Sg3Svl6F;
        "pkg-1.1.12-fabric-mc1.20.1" = _Kh9ezZdR;
        "pkg-1.1.12-fabric-mc1.21.2" = _eG8Nk9eF;
        "pkg-1.1.12-neoforge-mc1.21.3" = _bXg5tFwl;
        "pkg-1.1.12a-forge-mc1.20.6" = _LehgIF98;
        "pkg-1.1.12a-forge-mc1.21" = _XCFQMneU;
        "pkg-1.1.12a-fabric-mc1.20.6" = _tRcQVzLT;
        "pkg-1.1.12a-fabric-mc1.21" = _3Z77q6hB;
        "pkg-1.1.12a-fabric-mc1.21.2" = _xuv8cZhR;
        "pkg-1.1.12a-neoforge-mc1.20.6" = _usVoVO35;
        "pkg-1.1.12a-neoforge-mc1.21" = _yVXBq9sW;
        "pkg-1.1.12a-neoforge-mc1.21.3" = _uyqqrCzt;
        "pkg-1.1.12b-forge-mc1.20.6" = _LVqU4Rce;
        "pkg-1.1.12b-forge-mc1.21" = _oHSfPoYQ;
        "pkg-1.1.12b-fabric-mc1.20.6" = _ip511z83;
        "pkg-1.1.12b-fabric-mc1.21" = _HaMfERxD;
        "pkg-1.1.12b-fabric-mc1.21.2" = _a2ax9X5I;
        "pkg-1.1.12b-neoforge-mc1.20.6" = _D3mfAuWf;
        "pkg-1.1.12b-neoforge-mc1.21" = _2vqCunQ7;
        "pkg-1.1.12b-neoforge-mc1.21.3" = _RiyDGg67;
        "pkg-1.1.12-forge-mc1.21.3" = _hPcMD1vc;
        "pkg-1.1.12-forge-mc1.21.4" = _ZUyRRyt6;
        "pkg-1.1.12-fabric-mc1.21.4" = _avnyu8or;
        "pkg-1.1.12-neoforge-mc1.21.4" = _F6kIthe3;
        "pkg-1.1.12c-neoforge-mc1.20.6" = _zr9f5sqY;
        "pkg-1.1.12c-neoforge-mc1.21" = _Rh4OaF2U;
        "pkg-1.1.12-forge-mc1.21.5" = _nhi2rRGN;
        "pkg-1.1.12-forge-mc1.21.6" = _ZuMPVV2B;
        "pkg-1.1.12-fabric-mc1.21.5" = _RAFtXgw7;
        "pkg-1.1.12-fabric-mc1.21.6" = _Ww0zytsO;
        "pkg-1.1.12-neoforge-mc1.21.5" = _zNtcIl9W;
        "pkg-1.1.12-neoforge-mc1.21.6" = _1HdnvWQF;
        "pkg-1.1.12-forge-mc1.21.10" = _p4K1ae7G;
        "pkg-1.1.12-fabric-mc1.21.10" = _f0t2BCL1;
        "pkg-1.1.12-neoforge-mc1.21.10" = _H2WcZMzz;
        "pkg-1.1.12-forge-mc1.21.11" = _7uOJFByS;
        "pkg-1.1.12-fabric-mc1.21.11" = _leDmMZVu;
        "pkg-1.1.12-neoforge-mc1.21.11" = _3FoVwlFt;
        "pkg-1.1.12-forge-mc26.1" = _Ljn60WAP;
        "pkg-1.1.12-fabric-mc26.1" = _jETe23eT;
        "pkg-1.1.12-neoforge-mc26.1" = _AqWJ6KVd;
