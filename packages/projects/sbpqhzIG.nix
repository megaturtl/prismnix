...
let
    ...
    in {
        ...
        "pkg-0.1.7" = _IcgEtYtg;
        "pkg-1.1.8" = _uY9xuOdL;
        "pkg-2.0.0-beta.1" = _xplec3XC;
        "pkg-0.1.8" = _vmyRpXox;
        "pkg-1.1.9" = _7GS8LHIM;
        "pkg-2.0.0-beta.2" = _dihJmCzh;
        "pkg-0.1.9" = _f3zEV3aq;
        "pkg-1.1.10" = _V74dOvWr;
        "pkg-1.1.11" = _2tAuP2WL;
        "pkg-0.1.10" = _P6c64K0g;
        "pkg-1.1.12" = _sCjaUNqV;
        "pkg-2.0.0-beta.3" = _QACQ7MWv;
        "pkg-0.1.11" = _E1rQWKCa;
        "pkg-1.1.13" = _ZH696zKS;
        "pkg-2.0.0-beta.4" = _YqPzpd7n;
        "pkg-2.0.0-beta.5" = _R6JsD98g;
        "pkg-1.1.14" = _hYcUGD4i;
        "pkg-1.1.15" = _3VslGY2x;
        "pkg-1.1.16" = _3LNL2Mhi;
        "pkg-0.1.12" = _HzKiDbcz;
        "pkg-1.1.17" = _E0K9WtmQ;
        "pkg-2.0.0-beta.6" = _imCSDnYR;
        "pkg-1.1.18" = _brgIaAS3;
        "pkg-1.1.19" = _nOxWzx1Z;
        "pkg-2.0.0-beta.7" = _frdd3nLi;
        "pkg-0.1.13" = _Y0p90MaY;
        "pkg-1.1.20" = _ZoMlh59X;
        "pkg-2.0.0-beta.8" = _x2vdaIQl;
        "pkg-0.1.14" = _dZhdGmMx;
        "pkg-0.1.15" = _LhqllPrs;
        "pkg-1.1.21" = _GiLH27s1;
        "pkg-2.0.0-beta.9" = _ciUPRuTc;
        "pkg-1.1.22" = _XlCN7NWa;
        "pkg-26.1.0" = _a8t2vvmW;
        "pkg-26.1.1" = _QnXIoEhM;
        "pkg-26.1.2" = _pw3rZOiO;
        "pkg-26.2.0" = _LJPYSNL2;
        "pkg-26.1.3" = _2Rg5B0wa;
        "pkg-20.1.0" = _5eWe3VRZ;
