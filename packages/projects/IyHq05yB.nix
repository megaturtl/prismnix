...
let
    ...
    in {
        ...
        "pkg-2.4.1-1.21.2+" = _WW236N8u;
        "pkg-2.4.1-1.21+" = _CpbsvGLt;
        "pkg-2.4.1-1.20.1+" = _1BMAYvH7;
        "pkg-fabric-1.21.1-2.5.1" = _hXfBOSFB;
        "pkg-forge-1.21.1-2.5.1" = _1gnS6pD8;
        "pkg-neoforge-1.21.1-2.5.1" = _ZW6KipjH;
        "pkg-fabric-1.21.2-2.5.1" = _YtmWc0k2;
        "pkg-neoforge-1.21.2-2.5.1" = _hrrwiyBZ;
        "pkg-neoforge-1.21.3+1.21.4-2.5.1" = _A6OGSsxZ;
        "pkg-forge-1.21.3+1.21.4-2.5.1" = _27UGZAjV;
        "pkg-fabric-1.21.3+1.21.4-2.5.1" = _Rum2KGHi;
        "pkg-fabric-1.21.5-2.5.1" = _s6ivVa1Q;
        "pkg-forge-1.21.5-2.5.1" = _2FQHI8jg;
        "pkg-neoforge-1.21.5-2.5.1" = _n9NZVhhW;
        "pkg-fabric-1.21.6+1.21.7-2.5.2" = _KZ6Yhm9C;
        "pkg-forge-1.21.6+1.21.7-2.5.2" = _XEGbuJEs;
        "pkg-neoforge-1.21.6+1.21.7-2.5.2" = _txuJm0b6;
        "pkg-fabric-1.21.8-2.5.2" = _QQFaaqTq;
        "pkg-forge-1.21.8-2.5.2" = _pzTzfpob;
        "pkg-neoforge-1.21.8-2.5.2" = _8xMFfbMD;
        "pkg-fabric-1.21.9+1.21.10-2.5.2" = _FbDsJvWQ;
        "pkg-forge-1.21.9+1.21.10-2.5.2" = _PT0i9V98;
        "pkg-neoforge-1.21.9+1.21.10-2.5.2" = _lmGJZ725;
        "pkg-fabric-1.21.11-2.5.2" = _kFzyLo04;
        "pkg-forge-1.21.11-2.5.2" = _3YK84zgq;
        "pkg-neoforge-1.21.11-2.5.2" = _DGmI7FEe;
        "pkg-fabric-1.21+1.21.1-2.5.2" = _tfLhKtiO;
        "pkg-forge-1.21+1.21.1-2.5.2" = _KcGPbIsK;
        "pkg-neoforge-1.21+1.21.1-2.5.2" = _OGpCiExr;
        "pkg-fabric-1.20-2.5.2" = _o6jeEmMv;
        "pkg-forge-1.20-2.5.2" = _s77AHxpu;
        "pkg-fabric-1.20.1-2.5.2" = _8b1727pa;
        "pkg-forge-1.20.1-2.5.2" = _y7eK1nv4;
        "pkg-neoforge-1.20.1-2.5.2" = _2CbP3WSs;
        "pkg-fabric-1.21+1.21.1-2.5.3" = _Yl66HsGP;
        "pkg-forge-1.21+1.21.1-2.5.3" = _rWuHrPFx;
        "pkg-neoforge-1.21+1.21.1-2.5.3" = _Lw02ZJke;
        "pkg-fabric-1.21.2-2.5.3" = _ALXyrxNM;
        "pkg-neoforge-1.21.2-2.5.3" = _E82jRLMN;
        "pkg-fabric-1.21.3+1.21.4-2.5.3" = _fxfVMDdW;
        "pkg-forge-1.21.3+1.21.4-2.5.3" = _daYu7hHW;
        "pkg-neoforge-1.21.3+1.21.4-2.5.3" = _uKNOOZpG;
        "pkg-fabric-1.21.5-2.5.4" = _WRerPyU1;
        "pkg-forge-1.21.5-2.5.4" = _Sq2r93vo;
        "pkg-neoforge-1.21.5-2.5.4" = _tFle5G3y;
        "pkg-fabric-1.21.11-2.5.4" = _tfL2Lja7;
        "pkg-forge-1.21.11-2.5.4" = _ov1vsmxT;
        "pkg-neoforge-1.21.11-2.5.4" = _j5ZHy1O7;
        "pkg-fabric-1.21.11-2.6.1" = _HJU20wD8;
        "pkg-forge-1.21.11-2.6.1" = _GOdLNQsM;
        "pkg-neoforge-1.21.11-2.6.1" = _oKtBo19d;
        "pkg-fabric-26.1-2.6.1" = _SFAVfS8K;
        "pkg-forge-26.1-2.6.1" = _uQDbV2og;
        "pkg-neoforge-26.1-2.6.1" = _PwRNYQj1;
        "pkg-fabric-1.21.11-2.6.2" = _bcFqtn4m;
        "pkg-forge-1.21.11-2.6.2" = _GrfuC8SI;
        "pkg-neoforge-1.21.11-2.6.2" = _IRZ91HDG;
