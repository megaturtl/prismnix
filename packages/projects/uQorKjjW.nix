...
let
    ...
    in {
        ...
        "pkg-0.0.3_3" = _jlaSNzbw;
        "pkg-0.0.4_4" = _3HUPy0C1;
        "pkg-0.0.5_5" = _qfJzqa91;
        "pkg-0.0.6_6" = _IQ50sCxy;
        "pkg-0.0.7" = _YE7xprvM;
        "pkg-0.1.0" = _nAXIZbG3;
        "pkg-0.1.1" = _Y0IItwIN;
        "pkg-0.1.2" = _XGC1WzPq;
        ...
        "pkg-0.2.0" = _cCNCNPBf;
        "pkg-0.2.1" = _Vjx8iNBP;
        "pkg-0.2.2.1" = _WEIvj86O;
        "pkg-0.2.2.2" = _wltdSvnP;
        "pkg-0.0.8.1" = _9bj16aPi;
        "pkg-0.2.3.0" = _7f5JlxbA;
        "pkg-0.2.3.1" = _rmLDCYr3;
        "pkg-0.2.3.2" = _gmCLjc4Y;
        "pkg-0.2.3.3" = _8EZjFVVe;
        "pkg-0.2.3.4" = _pT5rGKu7;
        "pkg-0.2.3.5" = _pD9j7FI3;
        "pkg-0.2.3.6" = _kM6uHMXM;
        "pkg-0.2.3.7" = _XqFrWydL;
        "pkg-mc1.20.1-0.2.3.8-fabric" = _ognxeOh9;
        "pkg-mc1.20.1-0.2.4-forge" = _J4ZEsbP3;
        "pkg-mc1.21.1-0.2.4-neoforge" = _3Xcxoew3;
        "pkg-mc1.20.1-0.2.5-forge" = _Dxn6javG;
        "pkg-mc1.21.1-0.2.5-neoforge" = _VQUMhDsh;
        "pkg-mc1.21.1-0.2.6-neoforge" = _fVj51oZB;
        "pkg-mc1.20.1-0.2.6-forge" = _LPnpk59z;
        "pkg-mc1.21.1-0.2.7-neoforge" = _ejKd8ej7;
        "pkg-mc1.20.1-0.2.7-forge" = _BPAkmlnD;
        "pkg-mc1.20.1-0.2.7-fabric" = _iZzKWfUC;
        "pkg-mc1.21.1-0.3.0-neoforge" = _YNUCiRWY;
        "pkg-mc1.20.1-0.3.0-forge" = _sEagDWhH;
        "pkg-mc1.21.4-0.3.0-neoforge" = _xXiGFelA;
        "pkg-mc1.21.4-0.4.0-neoforge" = _9F1eQoL5;
        "pkg-mc1.21.1-0.4.0-neoforge" = _CoLFOrUt;
        "pkg-mc1.20.1-0.4.0-forge" = _1bPAtM3b;
        "pkg-mc1.20.1-1.0.0-forge" = _TrTrev2z;
        "pkg-mc1.21.1-1.0.0-neoforge" = _27z2l7Bl;
        "pkg-mc1.20.1-1.1.0-forge" = _nvTbf2k1;
        "pkg-mc1.21.1-1.1.0-neoforge" = _BxAYspK9;
