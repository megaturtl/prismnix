...
let
    versions = (let
        ...
        _oLcOW55b = {
            "id" = "oLcOW55b";
            "file" = "NewDefault+v1.82[MC1.20-26.3].zip";
            "hash" = "sha512-FWT2mWdbHtJ/SI2R+O6wyEajGzL+9ysMH1Ag27r8XPKYJc0PGopmi0t1pv8Xyj/qYsA5bT3C7ZeBRRj/nerfDw==";
        };
    in {
        "CwSjy5FZ" = _CwSjy5FZ;
        "5URcGcb2" = _5URcGcb2;
        ...
        "minecraft-1.20" = _oLcOW55b;
        "minecraft-1.20.1" = _oLcOW55b;
        "minecraft-1.20.2" = _oLcOW55b;
        "minecraft-1.20.3" = _oLcOW55b;
        "minecraft-1.20.4" = _oLcOW55b;
        "minecraft-1.20.5" = _oLcOW55b;
        "minecraft-1.20.6" = _oLcOW55b;
        "minecraft-1.21" = _oLcOW55b;
        "minecraft-1.21.1" = _oLcOW55b;
        "minecraft-1.21.2" = _oLcOW55b;
        "minecraft-1.21.3" = _oLcOW55b;
        "minecraft-1.21.4" = _oLcOW55b;
        "minecraft-1.21.5" = _oLcOW55b;
        "minecraft-1.21.6" = _oLcOW55b;
        "minecraft-1.21.7" = _oLcOW55b;
        "minecraft-1.21.8" = _oLcOW55b;
        "minecraft-1.21.9" = _oLcOW55b;
        "minecraft-1.21.10" = _oLcOW55b;
        "minecraft-1.21.11" = _oLcOW55b;
        "minecraft-26.1" = _oLcOW55b;
        "minecraft-26.1.1" = _oLcOW55b;
        "minecraft-26.1.2" = _oLcOW55b;
        "minecraft-26.2" = _oLcOW55b;
        "minecraft-26.3" = _oLcOW55b;
        "pkg-v1.79--MC1.6.1-1.8.9" = _CwSjy5FZ;
        "pkg-v1.79--MC1.9-1.12.2" = _5URcGcb2;
        "pkg-v1.79--MC1.15-1.17.1" = _et9pC2A2;
        "pkg-v1.79--MC1.18-1.18.2" = _RH1sYhsi;
        "pkg-v1.79--MC1.19-1.19.2" = _I9EA11lP;
        "pkg-v1.79--MC1.19.4" = _QOADBBs5;
        "pkg-v1.79--MC1.20-1.21.6" = _WjtPlq0W;
        "pkg-v1.80--MC1.6.1-1.8.9" = _UY4VNfK5;
        "pkg-v1.80--MC1.9-1.12.2" = _Vqrcm3LY;
        "pkg-v1.80--MC1.15-1.17.1" = _JNvsnr9T;
        "pkg-v1.80--MC1.18-1.18.2" = _gZufYwJB;
        "pkg-v1.80--MC1.19-1.19.2" = _miTBFQA2;
        "pkg-v1.80--MC1.19.4" = _eSuiUfaL;
        "pkg-v1.80--MC1.20-1.21.9" = _4NxXAuza;
        "pkg-v1.81--MC1.6.1-1.8.9" = _Bu8F7rdg;
        "pkg-v1.81--MC1.9-1.12.2" = _5Frm0dN6;
        "pkg-v1.81--MC1.15-1.17.1" = _GraKN79X;
        "pkg-v1.81--MC1.18-1.18.2" = _S5dPgDwL;
        "pkg-v1.81--MC1.19-1.19.2" = _rmdg6M9a;
        "pkg-v1.81--MC1.19.4" = _Xvsw1UwS;
        "pkg-v1.81--MC1.20-1.21.10" = _jNS2s3q7;
        "pkg-v1.81--MC1.20-1.21.11" = _Hl7RMO5D;
        "pkg-v1.82--MC1.6.1-1.8.9" = _FYaCXNB9;
        "pkg-v1.82--MC1.9-1.12.2" = _nvrSL1GE;
        "pkg-v1.82--MC1.15-1.17.1" = _smoynWJx;
        "pkg-v1.82--MC1.18-1.18.2" = _egmUjawm;
        "pkg-v1.82--MC1.19-1.19.2" = _VHXbZfCD;
        "pkg-v1.82--MC1.19.4" = _i6AXn5P5;
        "pkg-v1.82--MC1.20-1.21.11" = _2jAfvEL9;
        "pkg-v1.82--MC1.20-26.1" = _HObIu6cO;
        "pkg-v1.82--MC1.20-26.2" = _uNHx5R2B;
        "pkg-v1.82--MC1.20-26.3" = _oLcOW55b;
        "default" = _oLcOW55b;
    });
