...
let
    ...
    in {
        ...
        "pkg-1.20.1-0.4.2" = _fptBp5rG;
        "pkg-1.20.1-0.4.3" = _VkBBgCUV;
        "pkg-1.21.1-0.1.1" = _3VqzwqBE;
        "pkg-1.20.1-0.4.4" = _gRZWV74e;
        "pkg-1.20.1-0.5.0" = _nOPmdesy;
        "pkg-1.21.1-0.2.0" = _FBYChbGt;
