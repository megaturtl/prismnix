...
let
    versions = (let
        ...
        _fbOlDHaz = {
            "id" = "fbOlDHaz";
            "file" = "transmog-forge-1.8.1+26.2.jar";
            "hash" = "sha512-08ql6iM9CYrwCf0+HsalL20YinokYGEVQp1mCmTrSerFVL88e9w+/oVHvy7F8bPUt822oz49pHIDOh7CI2OMzA==";
        };
        _JPRhSVqy = {
            "id" = "JPRhSVqy";
            "file" = "transmog-neoforge-1.8.1+26.2.jar";
            "hash" = "sha512-/OsWnESWhcdoljNH63O2Tjf1BxMiY2wFzBsFK2fAAzDBy9L1ORRJ9MJNIZoDayzKTnKxbjAhLo1KIybSBTQqRA==";
        };
        _tkCBxHGW = {
            "id" = "tkCBxHGW";
            "file" = "transmog-fabric-1.8.1+26.2.jar";
            "hash" = "sha512-SsicpnWbYkqZqUt205SUwX45A1qLVh5+0h/qTvsq81J64mgQ9l6RA5uahffXTdDThGOp4/h9ZyjQqcJov4rpSQ==";
        };
    in {
        "yKCc365L" = _yKCc365L;
        "aF78R4o9" = _aF78R4o9;
        ...
        "neoforge-26.2" = _JPRhSVqy;
        "pkg-fabric-1.0.0+1.19.4" = _yKCc365L;
        "pkg-forge-1.0.0+1.19.4" = _aF78R4o9;
        "pkg-quilt-1.0.0+1.19.4" = _ifgFMpIb;
        "pkg-fabric-1.1.0+1.19.4" = _bid0jiWY;
        "pkg-forge-1.1.0+1.19.4" = _cu8PEWlI;
        "pkg-quilt-1.1.0+1.19.4" = _9isMP1kw;
        "pkg-fabric-1.1.1+1.19.4" = _kPV0KZTd;
        "pkg-forge-1.1.1+1.19.4" = _PpEhBUX2;
        "pkg-quilt-1.1.1+1.19.4" = _jlNJzljW;
        "pkg-fabric-1.1.1+1.19.2" = _MilbCCyJ;
        "pkg-forge-1.1.1+1.19.2" = _nJ2cYlry;
        "pkg-quilt-1.1.1+1.19.2" = _qusR8aHG;
        "pkg-fabric-1.1.1+1.18.2" = _XwimLYcn;
        "pkg-forge-1.1.1+1.18.2" = _cStpOQTb;
        "pkg-quilt-1.1.1+1.18.2" = _7wQWCEIQ;
        "pkg-fabric-1.2.0+1.18.2" = _A9APKYIJ;
        "pkg-forge-1.2.0+1.18.2" = _3lbYNEV3;
        "pkg-quilt-1.2.0+1.18.2" = _UGHuOpOE;
        "pkg-fabric-1.2.0+1.19.2" = _NaFk4SHL;
        "pkg-forge-1.2.0+1.19.2" = _c73tt3vl;
        "pkg-quilt-1.2.0+1.19.2" = _BR2ktdLM;
        "pkg-fabric-1.2.0+1.19.4" = _rkhxlt2L;
        "pkg-forge-1.2.0+1.19.4" = _MMJQgtGv;
        "pkg-quilt-1.2.0+1.19.4" = _mS2hTKDJ;
        "pkg-fabric-1.2.1+1.18.2" = _5AOOOQnY;
        "pkg-forge-1.2.1+1.18.2" = _GX4RzD4l;
        "pkg-quilt-1.2.1+1.18.2" = _pDIJBsgw;
        "pkg-fabric-1.2.1+1.19.4" = _sCcR85Pu;
        "pkg-forge-1.2.1+1.19.4" = _q3YMCes5;
        "pkg-quilt-1.2.1+1.19.4" = _PmGuZCie;
        "pkg-fabric-1.2.1+1.19.2" = _M1fHhKf9;
        "pkg-forge-1.2.1+1.19.2" = _r5mXVGCe;
        "pkg-quilt-1.2.1+1.19.2" = _CrZmvhnF;
        "pkg-fabric-1.2.2+1.18.2" = _XUMb4DWn;
        "pkg-forge-1.2.2+1.18.2" = _zzpyOwF7;
        "pkg-quilt-1.2.2+1.18.2" = _vKMrsPwr;
        "pkg-fabric-1.2.2+1.19.2" = _aKA5yNds;
        "pkg-forge-1.2.2+1.19.2" = _kEVK2G9s;
        "pkg-quilt-1.2.2+1.19.2" = _wOYVrUXx;
        "pkg-fabric-1.2.2+1.19.4" = _9d0w47Mi;
        "pkg-forge-1.2.2+1.19.4" = _5Tvw1FI7;
        "pkg-quilt-1.2.2+1.19.4" = _eUXCBRmg;
        "pkg-fabric-1.2.2+1.20" = _DL4CRIEv;
        "pkg-forge-1.2.2+1.20" = _ekxdePBJ;
        "pkg-quilt-1.2.2+1.20" = _BgnRTgBt;
        "pkg-fabric-1.2.3+1.20" = _IMguMubk;
        "pkg-forge-1.2.3+1.20" = _SlMnnF0y;
        "pkg-quilt-1.2.3+1.20" = _gUqDD6Um;
        "pkg-fabric-1.2.4+1.20" = _U6ZQkxUn;
        "pkg-forge-1.2.4+1.20" = _Wjt17Bmi;
        "pkg-quilt-1.2.4+1.20" = _QyajOql3;
        "pkg-fabric-1.3.0+1.20.2" = _BfpXHEBc;
        "pkg-forge-1.3.0+1.20.2" = _tDdiGnk6;
        "pkg-neoforge-1.3.0+1.20.2" = _jhptCOn8;
        "pkg-fabric-1.3.0+1.20.4" = _85T4gavx;
        "pkg-neoforge-1.3.0+1.20.4" = _xQne2dPr;
        "pkg-fabric-1.3.1+1.20.4" = _CSiMUwa3;
        "pkg-forge-1.3.1+1.20.4" = _Bf6Pu1MF;
        "pkg-neoforge-1.3.1+1.20.4" = _fjbt3wQ0;
        "pkg-forge-1.4.0+1.20.4" = _vNJvWKUw;
        "pkg-neoforge-1.4.0+1.20.4" = _dDGpXtbM;
        "pkg-fabric-1.4.0+1.20.4" = _X8GVjZvh;
        "pkg-fabric-1.4.0+1.20.2" = _J0dYmUdF;
        "pkg-forge-1.4.0+1.20.2" = _n1NhujAf;
        "pkg-neoforge-1.4.0+1.20.2" = _oCA0IAsT;
        "pkg-fabric-1.3.0+1.20" = _UnYsgubm;
        "pkg-forge-1.3.0+1.20" = _m4flMQ8W;
        "pkg-quilt-1.3.0+1.20" = _ZqiJgB3A;
        "pkg-fabric-1.4.0+1.20.6" = _6b90baXb;
        "pkg-forge-1.4.0+1.20.6" = _CrSpoPwF;
        "pkg-neoforge-1.4.0+1.20.6" = _cZ8FbeOH;
        "pkg-fabric-1.4.0+1.21" = _rjZoQgTn;
        "pkg-forge-1.4.0+1.21" = _Jm7qpETT;
        "pkg-neoforge-1.4.0+1.21" = _yxJOoizA;
        "pkg-fabric-1.4.1+1.20.6" = _wvezaAxT;
        "pkg-forge-1.4.1+1.20.6" = _KfwOsZkK;
        "pkg-neoforge-1.4.1+1.20.6" = _T0cBc9YZ;
        "pkg-forge-1.4.1+1.21" = _qPc48bHD;
        "pkg-neoforge-1.4.1+1.21" = _2bhOTeR4;
        "pkg-fabric-1.4.1+1.21" = _E6Eqi7sh;
        "pkg-fabric-1.4.2+1.21" = _kqXLI5ZF;
        "pkg-forge-1.4.2+1.21" = _7QOrZBGP;
        "pkg-neoforge-1.4.2+1.21" = _hD4aK1CW;
        "pkg-fabric-1.5.0+1.21" = _Hm1VJ8TD;
        "pkg-forge-1.5.0+1.21" = _Vw9A8xAQ;
        "pkg-neoforge-1.5.0+1.21" = _dLueog0P;
        "pkg-fabric-1.6.0+1.21.1" = _BTTDqIbq;
        "pkg-forge-1.6.0+1.21.1" = _LnBl7oAG;
        "pkg-neoforge-1.6.0+1.21.1" = _E3JkRJnV;
        "pkg-fabric-1.6.0+1.21.3" = _AqWLYZva;
        "pkg-forge-1.6.0+1.21.3" = _MNmgF5ui;
        "pkg-neoforge-1.6.0+1.21.3" = _G3gOviEx;
        "pkg-fabric-1.6.0+1.21.4" = _nFKMLKgT;
        "pkg-forge-1.6.0+1.21.4" = _Sfn8nn1u;
        "pkg-neoforge-1.6.0+1.21.4" = _Sh3uBCNY;
        "pkg-fabric-1.7.0+1.21.5" = _PsE1K52M;
        "pkg-forge-1.7.0+1.21.5" = _9T3y1Gsd;
        "pkg-neoforge-1.7.0+1.21.5" = _kBTO2TCp;
        "pkg-forge-1.7.0+1.21.8" = _L7pjEg4F;
        "pkg-neoforge-1.7.0+1.21.8" = _GNxdqKaZ;
        "pkg-fabric-1.7.0+1.21.8" = _xa9n9h5J;
        "pkg-forge-1.7.0+1.21.10" = _klz3eSQ4;
        "pkg-neoforge-1.7.0+1.21.10" = _R4TMi7w6;
        "pkg-fabric-1.7.0+1.21.10" = _mG9AyDAs;
        "pkg-forge-1.7.2+1.21.10" = _WgzBNcG8;
        "pkg-neoforge-1.7.2+1.21.10" = _7Yszd7DO;
        "pkg-fabric-1.7.2+1.21.10" = _qZdpDLAQ;
        "pkg-forge-1.7.2+1.21.8" = _KO8VgPPY;
        "pkg-neoforge-1.7.2+1.21.8" = _cfgv3nX3;
        "pkg-fabric-1.7.2+1.21.8" = _AsbFE7RM;
        "pkg-fabric-1.7.2+1.21.11" = _TNTSgHBI;
        "pkg-forge-1.7.2+1.21.11" = _jivmWFi7;
        "pkg-neoforge-1.7.2+1.21.11" = _H5eBnbWa;
        ...
        "pkg-forge-1.8.1+26.2" = _fbOlDHaz;
        "pkg-neoforge-1.8.1+26.2" = _JPRhSVqy;
        "pkg-fabric-1.8.1+26.2" = _tkCBxHGW;
        "default" = _tkCBxHGW;
    });
