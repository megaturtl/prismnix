...
let
    ...
    in {
        ...
        "pkg-2.0.0-alpha.4-1.21.1" = _D0I9cTx3;
        "pkg-2.0.0-alpha.5-1.20.1" = _cdWLrIJA;
        "pkg-2.0.0-alpha.6-1.20.1" = _iryOzoch;
        "pkg-2.0.0-alpha.6-1.21.1" = _R5W4Bvfq;
        "pkg-2.0.0-1.20.1" = _JLsgPBWv;
        "pkg-2.0.0-1.21.1" = _g8x1aCuD;
        "pkg-2.0.1-1.21.1" = _kzywMqUW;
        "pkg-2.0.2-1.21.1" = _lhbHAoau;
        "pkg-2.0.3-1.21.1" = _MrlQa4pG;
        "pkg-2.0.4-1.21.1" = _wb43fBLM;
        "pkg-2.1.0-1.20.1" = _k7iKGf5I;
        "pkg-2.1.0-1.21.1" = _EyNHXQyp;
        "pkg-2.2.0-1.20.1" = _1lc4xNqH;
        "pkg-2.2.0-1.21.1" = _xnI4KTxo;
        "pkg-2.3.0-1.20.1" = _w0EkXwQv;
        "pkg-2.3.0-1.21.1" = _2S0DKN49;
        "pkg-2.3.1-1.20.1" = _WiTyNPn1;
        "pkg-2.3.1-1.21.1" = _y9SNskCg;
        "pkg-2.3.2-1.20.1" = _QVcsc86f;
        "pkg-2.3.2-1.21.1" = _DXYU7XU9;
        "pkg-2.4.0-1.20.1" = _p51he4lf;
