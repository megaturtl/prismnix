...
let
    ...
    in {
        ...
        "pkg-1.2.1-1.20.1+" = _opxNfH7f;
        "pkg-1.2.2-1.20.1+" = _QjW7YXyu;
        "pkg-1.3.0-1.20.5+" = _Bv8K8rj2;
        "pkg-1.3.0-1.21.0" = _3nFvq6nZ;
        "pkg-3.0.0-1.26.1" = _S63LTNGm;
        "pkg-3.1.0-1.26.1" = _FEEFfPxb;
