...
let
    ...
    in {
        ...
        "pkg-0.6.0" = _s2fTj4LM;
        "pkg-0.6.1" = _WjT0Llfm;
        "pkg-0.6.1+22w43a" = _EAWVPebu;
        "pkg-1.0.0-fabric" = _p0LjncVW;
        "pkg-1.0.0-forge" = _r9djZ2iR;
        "pkg-1.0.0-quilt" = _hxPiYWhh;
        "pkg-1.1.0-fabric" = _61U935Ys;
        "pkg-1.1.0-forge" = _UmJ7FJgm;
        "pkg-1.1.0-quilt" = _e50cGA1L;
        "pkg-1.1.0+23w06a-fabric" = _eFAHLL8n;
        "pkg-1.2.0-fabric" = _DmWy11sa;
        "pkg-1.2.1-fabric" = _Atr5M7ky;
        "pkg-1.3.0-forge" = _CQcP4Q8L;
        "pkg-1.3.0-fabric" = _lalsp8PT;
        "pkg-1.3.0-quilt" = _kJmuqGbh;
        "pkg-1.4.0-fabric" = _WQMjF7Uk;
        "pkg-1.4.1-quilt" = _3YykTkmJ;
        "pkg-1.4.1-forge" = _MsATpcA9;
        "pkg-1.4.1-fabric" = _YXz8kIQl;
        "pkg-1.5.0-fabric" = _Ozm1zl15;
        "pkg-1.5.0-forge" = _9JfOZ2yZ;
        "pkg-1.5.1-fabric" = _ckM1ja0p;
        "pkg-1.5.2-neoforge" = _JlgGEOUe;
        "pkg-1.5.2-fabric" = _HgbzM3Ki;
        "pkg-1.5.3-fabric" = _EQNuBJf5;
        "pkg-1.4.2-forge" = _UhRAdyzr;
        "pkg-1.5.4-fabric" = _D5jKfbBO;
        "pkg-1.5.5-fabric" = _LwEV24Yy;
        "pkg-1.5.5-neoforge" = _GPdvliBl;
        "pkg-1.5.6-fabric" = _bcK30neJ;
        "pkg-1.5.7-fabric" = _HVILSMf5;
        "pkg-1.5.7-neoforge" = _VlFgEwid;
        "pkg-1.5.8-fabric" = _onYewt68;
        "pkg-1.5.8-neoforge" = _TZkAGgu9;
        "pkg-1.6.0-fabric" = _UDwJZBeV;
        "pkg-1.6.0-neoforge" = _6rfNftcH;
        "pkg-1.6.1-fabric" = _UEiXGqx9;
        "pkg-1.6.1-neoforge" = _bReXyO7l;
        "pkg-1.6.2-fabric" = _CtLJXKCX;
        "pkg-1.6.2-neoforge" = _hLnMon8I;
        "pkg-1.6.3-fabric" = _Ct1rAic5;
        "pkg-1.6.3-neoforge" = _YeePowOJ;
        "pkg-1.6.4-fabric" = _PWJbf1AX;
        "pkg-1.6.4-neoforge" = _MZpDlC1M;
        "pkg-1.6.5-fabric" = _G5MIzhHU;
        "pkg-1.6.6-neoforge" = _wBTWrEi8;
        "pkg-1.6.6-fabric" = _TEo961AO;
        "pkg-1.6.7-fabric" = _XVrBN1IF;
        "pkg-1.6.7-neoforge" = _41UyjAI8;
        "pkg-1.6.7+1.21.1-neoforge" = _qXqRShFU;
        "pkg-1.6.7+1.21.1-fabric" = _OUhvjIL1;
        "pkg-1.6.8+1.21.4-fabric" = _EqPCzrCa;
        "pkg-1.6.8+1.21.4-neoforge" = _SUgLQLTE;
        "pkg-1.6.8+1.21.1-fabric" = _C7ZgPvfU;
        "pkg-1.6.8+1.21.1-neoforge" = _9aYHVfeN;
        "pkg-1.6.9+1.21.4-fabric" = _R3G85eBr;
        "pkg-1.6.9+1.21.4-neoforge" = _GZYsm5Wq;
        "pkg-1.6.9+1.21-fabric" = _49HhVYoZ;
        "pkg-1.6.9+1.21-neoforge" = _tUbl6MZ4;
        "pkg-1.6.10+1.21.4-fabric" = _5h4CzZKs;
        "pkg-1.6.10+1.21.4-neoforge" = _AvHnQ0lE;
        "pkg-1.7.0+1.21.4-fabric" = _F6Wo2W7o;
        "pkg-1.7.0+1.21.4-neoforge" = _MIKrpUpv;
        "pkg-1.7.1+1.21.4-fabric" = _owfXImvq;
        "pkg-1.7.1+1.21.4-neoforge" = _3aEtOV3E;
        "pkg-1.7.2+1.21.4-fabric" = _5mtnhym8;
        "pkg-1.7.2+1.21.4-neoforge" = _ypObMxuM;
        "pkg-1.7.3+1.21.4-fabric" = _BTo6aJAT;
        "pkg-1.7.3+1.21.4-neoforge" = _hknc0FP3;
        "pkg-1.7.4+1.21.6-fabric" = _Hix1F2np;
        "pkg-1.7.4+1.21.6-neoforge" = _GVrI56eZ;
        "pkg-1.7.5+1.21.6-fabric" = _2syNs7py;
        "pkg-1.7.5+1.21.6-neoforge" = _EcKiswnp;
        "pkg-1.7.5+1.21.1-fabric" = _vqqujBpd;
        "pkg-1.7.5+1.21.1-neoforge" = _HIlaYrgj;
        "pkg-1.8.0+1.21.9-rc1-fabric" = _vzP3Z5ze;
        "pkg-1.8.1+1.21.9-fabric" = _31gmyhC9;
        "pkg-1.8.1+1.21.9-neoforge" = _bRuGn0za;
        "pkg-1.8.2+1.21.9-fabric" = _v5LqXLJM;
        "pkg-1.8.2+1.21.9-neoforge" = _M9PGLiYk;
        "pkg-1.8.3+1.21.9-fabric" = _7RbEjTSq;
        "pkg-1.8.3+1.21.9-neoforge" = _nJe8zZbM;
        "pkg-1.9.0+1.21.1-fabric" = _lpu4X5KV;
        "pkg-1.9.0+1.20.1-forge" = _DUXNwHj1;
        "pkg-1.9.0+1.20.1-fabric" = _kS9rwME0;
        "pkg-1.9.0+1.21.1-neoforge" = _RkNiTCxq;
        "pkg-1.9.0+1.21.10-fabric" = _Xm1GcVtD;
        "pkg-1.9.0+1.21.10-neoforge" = _NlOd3t8J;
        "pkg-1.9.0+1.21.5-neoforge" = _JJz2xqaW;
        "pkg-1.9.0+1.21.5-fabric" = _VyB7lE5w;
        "pkg-1.9.0+1.21.8-fabric" = _wLKmX5Ci;
        "pkg-1.9.0+1.21.8-neoforge" = _PsmGhPJJ;
        "pkg-1.9.1+1.21.1-neoforge" = _uGySRC8x;
        "pkg-1.9.1+1.20.1-forge" = _fNBU1ZYk;
        "pkg-1.9.1+1.20.1-fabric" = _H83eN0R5;
        "pkg-1.9.1+1.21.1-fabric" = _gDxRS3a2;
        "pkg-1.9.1+1.21.10-neoforge" = _3D0UWfYv;
        "pkg-1.9.1+1.21.10-fabric" = _EQPKivgz;
        "pkg-1.9.1+1.21.5-neoforge" = _J1xfTzGS;
        "pkg-1.9.1+1.21.5-fabric" = _py38B9OL;
        "pkg-1.9.1+1.21.8-neoforge" = _SgwCUPdL;
        "pkg-1.9.1+1.21.8-fabric" = _OdTASbqw;
        "pkg-1.9.2+1.21.1-neoforge" = _Puk24qHu;
        "pkg-1.9.2+1.21.1-fabric" = _3tCMjbnf;
        "pkg-1.9.2+1.21.10-neoforge" = _FMAryIW6;
        "pkg-1.9.2+1.21.11-neoforge" = _urNcJrg2;
        "pkg-1.9.2+1.20.1-fabric" = _jyowrZ5N;
        "pkg-1.9.2+1.20.1-forge" = _EVVb5nP3;
        "pkg-1.9.2+1.21.10-fabric" = _VoGY1DpA;
        "pkg-1.9.2+1.21.11-fabric" = _OeTayxh3;
        "pkg-1.9.2+1.21.5-neoforge" = _a6cCluD3;
        "pkg-1.9.2+1.21.8-neoforge" = _mw9fIC9b;
        "pkg-1.9.2+1.21.8-fabric" = _R5nMR23e;
        "pkg-1.9.2+1.21.5-fabric" = _7ONhKsis;
        "pkg-1.9.2+26.1-fabric" = _LYhERhb8;
        "pkg-1.9.2+26.1-neoforge" = _qTM4PAv8;
        "pkg-1.9.3+1.21.10-neoforge" = _BrZWsuC8;
        "pkg-1.9.3+1.21.1-neoforge" = _6Gv5jvTB;
        "pkg-1.9.3+1.21.11-neoforge" = _I2SQEogO;
        "pkg-1.9.3+1.21.1-fabric" = _as2ZKoB1;
        "pkg-1.9.3+1.21.10-fabric" = _D3QVorJc;
        "pkg-1.9.3+1.21.11-fabric" = _jkodor79;
        "pkg-1.9.3+1.20.1-fabric" = _rXX4FCV8;
        "pkg-1.9.3+1.21.5-fabric" = _I8pZ9fY0;
        "pkg-1.9.3+1.21.8-neoforge" = _2gn4WKKk;
        "pkg-1.9.3+1.21.8-fabric" = _JBMS9mK4;
        "pkg-1.9.3+1.21.5-neoforge" = _YKE4hfEg;
        "pkg-1.9.3+26.1-fabric" = _jcj4Ev6D;
        "pkg-1.9.3+26.1-neoforge" = _aDODZlso;
