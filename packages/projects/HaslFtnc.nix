...
let
    versions = (let
        ...
        _Iae0k1Qv = {
            "id" = "Iae0k1Qv";
            "file" = "hearts_black-1.1.0-mc26.3.zip";
            "hash" = "sha512-KcgUS1pjWTl1SfKf9zOrFy11DYBCy3I20pmw/iOsKSea30+9TdGmpYKSFfoEQjsY5FpfD5PSQI6S9E4R0Lo1/Q==";
        };
    in {
        "aeIH8fhm" = _aeIH8fhm;
        "u4x7qwx6" = _u4x7qwx6;
