...
let
    ...
    in {
        ...
        "pkg-5.4.4" = _bjlPXq6P;
        "pkg-5.4.6" = _dPVIixcD;
        "pkg-5.4.12" = _P78MhD7R;
        "pkg-5.4.16" = _PCmkPmGg;
        "pkg-5.1.18" = _y5RP1clH;
        "pkg-5.5.1" = _Sw9gX0pY;
        "pkg-5.1.19" = _tVACNfFe;
        "pkg-5.5.2" = _TgdaLwwl;
        "pkg-5.4.17" = _hSzi99IJ;
        "pkg-5.6.0" = _rGhFyavm;
        "pkg-5.6.4" = _anWKTCB1;
        "pkg-5.4.21" = _EeXMKrpR;
        "pkg-5.6.8" = _I0okNMOK;
        "pkg-5.4.25" = _VGz7qzm1;
        "pkg-5.6.12" = _TKx1XD4p;
        "pkg-5.4.27" = _LxWvTKFZ;
        "pkg-5.7.1" = _JWhnA2Ke;
