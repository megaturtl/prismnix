...
let
    ...
    in {
        ...
        "pkg-1.1.0+1.19.3" = _FypaHVFt;
        "pkg-1.1.0+1.19.4" = _X3GeLDV2;
        "pkg-1.1.0+1.20" = _c2a6rdtw;
        "pkg-1.1.1+1.20" = _aoojKDWs;
        "pkg-2.0.0+1.20.2" = _s0bLCWgz;
        "pkg-2.0.0+1.20" = _ZAegPx7p;
        "pkg-2.1.0+1.20.4" = _OPuZaoic;
        "pkg-2.2.0+1.20.4" = _efcGbFlN;
        "pkg-2.2.0+1.20.2" = _x5uqEFsv;
        "pkg-2.2.0+1.20.1" = _aiVMDtzu;
        "pkg-2.3.0+1.20.1" = _UyuF1UsW;
        "pkg-2.3.0+1.20.6" = _jPQ6D8SV;
        "pkg-2.3.0+1.20.4" = _s9c6TDzG;
        "pkg-2.3.0+1.20.2" = _5eCO7yeR;
        "pkg-2.4.0+1.20.6" = _JaPlWD0S;
        "pkg-2.4.0+1.20.4" = _HvS7gm0a;
        "pkg-2.4.0+1.20.1" = _1ndPt7V4;
        "pkg-2.4.0+1.21" = _2nLuXwjq;
        "pkg-2.5.0+1.20.6" = _vNglade6;
        "pkg-2.5.0+1.20.1" = _3Xhagaop;
        "pkg-2.5.0+1.20.4" = _XPU6oeqY;
        "pkg-2.5.0+1.21" = _CeGZrJDa;
        "pkg-2.5.1+1.20.1" = _i2E71Kma;
        "pkg-2.5.1+1.20.4" = _v4EaIDSv;
        "pkg-2.5.1+1.21" = _zwSDP46A;
        "pkg-2.5.1+1.20.6" = _i40WVByg;
        "pkg-2.5.2+1.20.1" = _sWvHP5KU;
        "pkg-2.5.2+1.21" = _UpkCTTEf;
        "pkg-2.5.2+1.20.4" = _valpXW8b;
        "pkg-2.5.2+1.20.6" = _MZ5QQPTf;
        "pkg-2.5.3+1.20.1" = _MoLtS8J7;
        "pkg-2.5.3+1.21" = _1K0J5FYl;
        "pkg-2.5.3+1.20.6" = _Wrc1O0v8;
        "pkg-2.5.3+1.20.4" = _rEBAhJvE;
        "pkg-2.5.4+1.21.1" = _q1SVnUph;
        "pkg-2.5.4+1.20.4" = _yC5dkouK;
        "pkg-2.5.4+1.20.6" = _DQcp7Ogf;
        "pkg-2.5.4+1.20.1" = _Wm7ocjvH;
        "pkg-2.6.0+1.21.3" = _tusruVI1;
        "pkg-2.6.0+1.21.4" = _cuMgw6kW;
        "pkg-2.6.0+1.21.1" = _iwbgDvvc;
        "pkg-2.7.0+1.21.1" = _ECLg3NUT;
        "pkg-2.7.0+1.21.3" = _1RzKQmWr;
        "pkg-2.7.0+1.21.4" = _7tCzrUXe;
        "pkg-2.7.1+1.21.1" = _2XRfQcUl;
        "pkg-2.7.1+1.21.5" = _7PhCVqwn;
        "pkg-2.7.1+1.21.3" = _eOfQiEzj;
        "pkg-2.7.2+1.21.8" = _IUA9CzsD;
        "pkg-2.7.2+1.21.1" = _3CbG904c;
        "pkg-v2.7.3+1.21.9" = _tVRGmTTf;
        "pkg-v2.7.4+1.21.8" = _W2dvbJw2;
        "pkg-v2.7.4+1.21.9" = _zZ2wK01j;
