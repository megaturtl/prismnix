...
let
    versions = (let
        ...
        _sZbVsl2Q = {
            "id" = "sZbVsl2Q";
            "file" = "iris-fabric-1.11.4+mc26.1.2.jar";
            "hash" = "sha512-2ZswnSgu2xJm373+2nkr66H4CDNEiWBIGNaymMMoOT3NfrWyilbOoUyc+OTrnAiMsugLIos0J6g20VSjaLG8uQ==";
        };
        _qE5Y7GrZ = {
            "id" = "qE5Y7GrZ";
            "file" = "iris-neoforge-1.11.4+mc26.1.2.jar";
            "hash" = "sha512-dRzDL7wxniVJdZqo7Sx5j6jjp6MpJKJ/b4D4GqJjSl2dcmgoNIsnHXBEnG0l0f7jUs7JMhhaoGbaEJQU8Kdnjw==";
        };
        _gxZWWnKH = {
            "id" = "gxZWWnKH";
            "file" = "iris-fabric-1.11.4+mc26.2.jar";
            "hash" = "sha512-3ulVWAl2rrySNz9cLYg5itEBmwQ8YlSkH+erimyjpf8p1Y3ysi7EOjEZi+t2noFGWO7wb7+YAGai4sIW7q/TKg==";
        };
        _k55HdONq = {
            "id" = "k55HdONq";
            "file" = "iris-neoforge-1.11.4+mc26.2.jar";
            "hash" = "sha512-0WOuK37OIJ1LVtxOldx4c8B2ogyFG/Yl7G4nkJoH8qc4OKQzYxGvz6hwHXo7woEIruOifUuSb0irkD4lgr1+ag==";
        };
        _2nyTWtzT = {
            "id" = "2nyTWtzT";
            "file" = "iris-fabric-1.11.5+mc26.3.jar";
            "hash" = "sha512-FcrcM3HIsl5RiJn0mEoHtCIexyFY+54gp17DdYxzBb1Y3XjGNPTplAnmRZMAtwhrwBjHyU+ZyloM9xn9r5uAfQ==";
        };
        _bAdKrpw8 = {
            "id" = "bAdKrpw8";
    ...
    in {
        ...
        "pkg-mc1.17-v1.1.1" = _lAEtBzCu;
        "pkg-mc1.16.5-v1.1.1" = _AosvzXCO;
        "pkg-mc1.16.5-1.1.2" = _ZmYHYMB0;
        "pkg-mc1.17.1-1.1.2" = _YwBoFV6P;
        "pkg-mc1.16.5-1.1.3" = _2wf4jsBO;
        "pkg-mc1.17.1-1.1.3" = _RtuAfhnO;
        "pkg-mc1.18.1-1.1.3" = _Hw3w5BnI;
        "pkg-1.16.x-v1.1.4" = _NSpfOv4N;
        "pkg-1.17.x-v1.1.4" = _FlQkLIVP;
        "pkg-1.18.x-v1.1.4" = _zBuHbv6a;
        "pkg-1.17.x-v1.1.5" = _gYVKINAq;
        "pkg-1.18.x-v1.1.5" = _QGPs4R2V;
        "pkg-1.16.x-v1.2.0" = _TzYtPcBt;
        "pkg-1.17.x-v1.2.0" = _bQeFkabl;
        "pkg-1.18.x-v1.2.0" = _I6p5WO3q;
        "pkg-1.16.x-v1.2.1" = _Ys3JxjYh;
        "pkg-1.17.x-v1.2.1" = _zMKAM7mH;
        "pkg-1.18.x-v1.2.1" = _LXMLAG5t;
        "pkg-1.16.x-v1.2.2" = _lFtR0yEB;
        "pkg-1.17.x-v1.2.2" = _7GHcCn6V;
        "pkg-1.18.x-v1.2.2" = _L401QBlK;
        "pkg-1.16.x-v1.2.3" = _yaROAJzO;
        "pkg-1.17.x-v1.2.3" = _nwP12ckH;
        "pkg-1.18.x-v1.2.3" = _XU7Kt1A6;
        "pkg-1.16.x-v1.2.4" = _lIUI5vjD;
        "pkg-1.17.x-v1.2.4" = _gXVJmMNx;
        "pkg-1.18.x-v1.2.4" = _Onlo6jbu;
        "pkg-1.16.x-v1.2.5" = _sWytL469;
        "pkg-1.17.x-v1.2.5" = _IlClEy6H;
        "pkg-1.18.x-v1.2.5" = _M18bSfGf;
        "pkg-1.19.x-v1.2.5" = _B9iwsuD9;
        "pkg-1.16.x-v1.2.6" = _tKYOPll0;
        "pkg-1.17.x-v1.2.6" = _tZs9ixBh;
        "pkg-1.18.x-v1.2.6" = _F92T6Nh1;
        "pkg-1.19.x-v1.2.6" = _q2kq4WQK;
        "pkg-1.16.x-v1.2.7" = _KDxcEpjX;
        "pkg-1.17.x-v1.2.7" = _pkGrlTNQ;
        "pkg-1.18.x-v1.2.7" = _SEOrgwmF;
        "pkg-1.19.x-v1.2.7" = _oubLAbu3;
        "pkg-1.19.x-v1.2.8" = _Si7uxNXL;
        "pkg-1.16.x-v1.3.0" = _fylOAYZi;
        "pkg-1.18.x-v1.3.0" = _gvvRO0WD;
        "pkg-1.19.x-v1.3.0" = _WwSkfJxS;
        "pkg-1.16.x-v1.3.1" = _wEz86aj9;
        "pkg-1.18.x-v1.3.1" = _nnr56Joh;
        "pkg-1.19.x-v1.3.1" = _r8IxC3aO;
        "pkg-1.16.x-v1.4.0" = _3tbkyayi;
        "pkg-1.18.x-v1.4.0" = _1BCkW8RE;
        "pkg-1.4.0+1.19.2" = _RRjXTE6G;
        "pkg-1.16.c-v1.4.1" = _nM05XWOf;
        "pkg-1.18.x-v1.4.1" = _WPiyWv9b;
        "pkg-1.4.1+1.19.2" = _61raaF2M;
        "pkg-1.18.x-v1.4.2" = _RoOgJaef;
        "pkg-1.4.2+1.19.2" = _vujluWvJ;
        "pkg-1.16.x-v1.4.3" = _qLOWxC5n;
        "pkg-1.4.3+1.18.2" = _KlpiaRLV;
        "pkg-1.4.3+1.19.2" = _5Ox2LQ1C;
        "pkg-1.4.4+1.16.5" = _HgbdQHa6;
        "pkg-1.4.4+1.18.2" = _erJnRbFe;
        "pkg-1.4.4+1.19.2" = _unkwzrN7;
        "pkg-1.4.4+1.19.3" = _LGMDKOTZ;
        "pkg-1.4.5+1.16.5" = _1turazSM;
        "pkg-1.4.5+1.18.2" = _zKrz2FCx;
        "pkg-1.4.5+1.19.2" = _j0DONNcY;
        "pkg-1.4.5+1.19.3" = _bhSk1gCX;
        "pkg-1.4.6+1.19.3" = _py8Wa69O;
        "pkg-1.5.0+1.18.2" = _mBwD8Zhm;
        "pkg-1.5.0+1.19.2" = _pMwSdnE7;
        "pkg-1.5.0+1.19.3" = _Fnx41igH;
        "pkg-1.5.1+1.19.3" = _Sg0JZGHa;
        "pkg-1.5.2+1.18.2" = _gcpVAwdy;
        "pkg-1.5.2+1.19.2" = _7cPNddw8;
        "pkg-1.5.2+1.19.3" = _ExtC2pRY;
        "pkg-1.5.2+1.19.4" = _mVGu4Ze2;
        "pkg-1.6.0+1.18.2" = _xRdKiTLA;
        "pkg-1.6.0+1.19.4" = _rKiitlRl;
        "pkg-1.6.0+1.19.2" = _di8i8GvL;
        "pkg-1.6.1+1.18.2" = _su0G9MUF;
        "pkg-1.6.1+1.19.4" = _347HlKZS;
        "pkg-1.6.1+1.19.2" = _1g7raUdU;
        "pkg-1.6.2+1.18.2" = _RpjxjFWm;
        "pkg-1.6.2+1.19.2" = _7MJ26Y79;
        "pkg-1.6.3+1.19.4" = _AQqB1OqQ;
        "pkg-1.6.4+1.18.2" = _5tSr0LHs;
        "pkg-1.6.4+1.19.2" = _9YEwbzW6;
        "pkg-1.6.4+1.19.4" = _4dFzaTaP;
        "pkg-1.6.4+1.20" = _URWeWMAt;
        "pkg-1.6.5+1.18.2" = _4VLJ3QSD;
        "pkg-1.6.5+1.19.2" = _W00rBT3R;
        "pkg-1.6.5+1.19.4" = _IBYlCS75;
        "pkg-1.6.5+1.20.1" = _Sc0OZ0Ze;
        "pkg-1.6.6+1.18.2" = _lBRgIigc;
        "pkg-1.6.6+1.19.2" = _HzhiSGif;
        "pkg-1.6.6+1.19.4" = _ibsBZ9bl;
        "pkg-1.6.7+1.20.1" = _MU0L4OZM;
        "pkg-1.6.8+1.20.1" = _pVNPPrMY;
        "pkg-1.6.9+1.18.2" = _Sqfk9myM;
        "pkg-1.6.9+1.19.2" = _4rtFWyuc;
        "pkg-1.6.9+1.19.4" = _wtbkjLwi;
        "pkg-1.6.9+1.20.1" = _P8R7yx6t;
        "pkg-1.6.9+1.20.2" = _Zra3j4VJ;
        "pkg-1.6.10+1.18.2" = _C7jhLYbl;
        "pkg-1.6.10+1.19.2" = _nfElruJM;
        "pkg-1.6.10+1.20.1" = _DsjYuGMO;
        "pkg-1.6.10+1.19.4" = _9a8qLmTR;
        "pkg-1.6.10+1.20.2" = _O7RZrusV;
        "pkg-1.6.11+1.18.2" = _ogIRhnAJ;
        "pkg-1.6.11+1.19.2" = _LgOJIpIS;
        "pkg-1.6.11+1.19.4" = _wN6PuLPa;
        "pkg-1.6.11+1.20.1" = _ogjxrwGQ;
        "pkg-1.6.11+1.20.2" = _ZKp9SOIC;
        "pkg-1.6.11+1.20.3" = _LBcmOpqU;
        "pkg-1.6.12+1.20.2" = _CXOiI98u;
        "pkg-1.6.12+1.20.3" = _DKiqtWdm;
        "pkg-1.6.13+1.20.2" = _qpkCdX4h;
        "pkg-1.6.13+1.20.4" = _xzCURg7P;
        "pkg-1.6.14+1.20.2" = _Cjwm9s3i;
        "pkg-1.6.14+1.20.4" = _Xl7oywRL;
        "pkg-1.6.17+1.20.4" = _kGdJ11Rt;
        "pkg-1.6.17+1.20.1" = _JHbrO6Zq;
        "pkg-1.7.0+1.20.5" = _JjUWi3Lj;
        "pkg-1.7.0+1.20.4" = _45ETshvT;
        "pkg-1.7.0+1.20.1" = _KHQ2Hnpt;
        "pkg-1.7.0+1.20.6" = _BvVRER1H;
        "pkg-1.7.1+1.20.4" = _gPXdh2Es;
        "pkg-1.7.1+1.21" = _RYnrr5zv;
        "pkg-1.7.1+1.20.1" = _G5dd9TM4;
        "pkg-1.7.1+1.20.6" = _keLlmlCc;
        "pkg-1.7.2+1.20.1" = _1CMVXDHo;
        "pkg-1.7.2+1.20.4" = _hq98tuSS;
        "pkg-1.7.2+1.20.6" = _1bvcmYOc;
        "pkg-1.7.2+1.21" = _C9Tu8Kbn;
        "pkg-1.7.3+1.21" = _kuOV4Ece;
        "pkg-1.8.0-beta.1+1.21-fabric" = _81XVWegK;
        "pkg-1.8.0-beta.1+1.21-neoforge" = _LxHRTZan;
        "pkg-1.8.0-beta.2+1.21-fabric" = _di7sM681;
        "pkg-1.8.0-beta.2+1.21-neoforge" = _CFLzYOBB;
        "pkg-1.8.0-beta.3+1.21-neoforge" = _hfeO55Am;
        "pkg-1.8.0-beta.3+1.21-fabric" = _Kdz76qQt;
        "pkg-1.8.0-beta.4+1.21-fabric" = _u9KvDA4s;
        "pkg-1.8.0-beta.4+1.21-neoforge" = _pXkVHWIr;
        "pkg-1.8.0-beta.5+1.21-neoforge" = _ktN143ZD;
        "pkg-1.7.5+1.20.1" = _Bi9nvICq;
        "pkg-1.8.0-beta.6+1.21.2-fabric" = _XExINvk9;
        "pkg-1.8.0-beta.6+1.21.2-neoforge" = _C15qY9cE;
        "pkg-1.8.0-beta.7+1.21.1-neoforge" = _Wla8rJYn;
        "pkg-1.8.0-beta.7+1.21.1-fabric" = _RyzH5mIp;
        "pkg-1.8.0-beta.7+1.21.3-neoforge" = _GXh6E3im;
        "pkg-1.8.0-beta.7+1.21.3-fabric" = _ljIS26gI;
        "pkg-1.8.0-beta.8+1.21.1-fabric" = _NqWJ1KIA;
        "pkg-1.8.0-beta.8+1.21.1-neoforge" = _W51fNmnQ;
        "pkg-1.8.0-beta.8+1.21.3-neoforge" = _jkePzKpI;
        "pkg-1.8.0-beta.8+1.21.3-fabric" = _KRa2Torg;
        "pkg-1.8.0-beta.9+1.21.3-fabric" = _OYXyPwMd;
        "pkg-1.8.0-beta.9+1.21.3-neoforge" = _LZazop7o;
        "pkg-1.8.0+1.21.1-fabric" = _MA2sKKaG;
        "pkg-1.8.0+1.21.1-neoforge" = _S793sibh;
        "pkg-1.8.0+1.21.3-fabric" = _qyGMuaY6;
        "pkg-1.8.0+1.21.3-neoforge" = _zYCRMwJK;
        "pkg-1.8.1+1.21.1-fabric" = _IzngD3Cy;
        "pkg-1.8.1+1.21.1-neoforge" = _QS9F364b;
        "pkg-1.8.1+1.21.3-neoforge" = _mRdVEpVp;
        "pkg-1.8.1+1.21.3-fabric" = _xQYJAYTI;
        "pkg-1.8.2+1.21.4-fabric" = _ZnhzDm36;
        "pkg-1.8.3+1.21.4-fabric" = _1jDkBRQP;
        "pkg-1.8.4+1.21.4-fabric" = _J55HRGSf;
        "pkg-1.8.4+1.21.4-neoforge" = _5OyTT1R6;
        "pkg-1.8.5+1.21.4-fabric" = _LZrmMq4i;
        "pkg-1.8.5+1.21.4-neoforge" = _8l8TrrQz;
        "pkg-1.8.6+1.21.1-neoforge" = _pgeobnib;
        "pkg-1.8.7+1.21.1-fabric" = _A99vfwJc;
        "pkg-1.8.7+1.21.1-neoforge" = _RJ6B9OeB;
        "pkg-1.8.7+1.21.4-fabric" = _fI1GlVsm;
        "pkg-1.8.8+1.21.1-neoforge" = _oXIoDcGE;
        "pkg-1.8.8+1.21.1-fabric" = _zsoi0dso;
        "pkg-1.8.8+1.21.4-fabric" = _Ca054sTe;
        "pkg-1.8.8+1.21.4-neoforge" = _FNc0XYTL;
        "pkg-1.7.6+1.20.1" = _s5eFLITc;
        "pkg-1.8.9+1.21.5-fabric" = _jj2VYAAj;
        "pkg-1.8.10+1.21.5-fabric" = _N0ln8GKQ;
        "pkg-1.8.10+1.21.5-neoforge" = _ikM5BuoC;
        "pkg-1.8.11+1.21.5-fabric" = _U6evbjd0;
        "pkg-1.8.11+1.21.5-neoforge" = _KAopiPos;
        "pkg-1.9.0+1.21.6-fabric" = _Ga9fyDY6;
        "pkg-1.8.12+1.21.1-neoforge" = _t3ruzodq;
        "pkg-1.9.1+1.21.7-fabric" = _l77DAK6U;
        "pkg-1.9.1+1.21.7-neoforge" = _xA5cxBvz;
        "pkg-1.9.2+1.21.9-fabric" = _6qO1bWkq;
        "pkg-1.9.2+1.21.8-fabric" = _x2f4KxP0;
        "pkg-1.9.2+1.21.8-neoforge" = _ND9UkIJN;
        "pkg-1.9.3+1.21.9-fabric" = _2fEZLvCV;
        "pkg-1.9.4+1.21.10-fabric" = _RZp5fR8I;
        "pkg-1.9.4+1.21.8-fabric" = _kqjNIEzi;
        "pkg-1.9.4+1.21.8-neoforge" = _PcvKdCx4;
        "pkg-1.9.5+1.21.8-fabric" = _qyN5KL7v;
        "pkg-1.9.5+1.21.8-neoforge" = _y5EH3qbW;
        "pkg-1.9.6+1.21.8-fabric" = _Rhzf61g1;
        "pkg-1.9.6+1.21.8-neoforge" = _T06etL58;
        "pkg-1.9.6+1.21.10-fabric" = _r1MZ1Bpv;
        "pkg-1.9.6+1.21.10-neoforge" = _QwsZwykw;
        "pkg-1.10.0+1.21.11-fabric" = _PCwCdLCe;
        "pkg-1.10.1+1.21.11-fabric" = _PjHt94CV;
        "pkg-1.10.2+1.21.11-fabric" = _ID2pg4dQ;
        "pkg-1.10.2+1.21.11-neoforge" = _Gbr8rEDk;
        "pkg-1.10.3+1.21.11-fabric" = _CTILw1NK;
        "pkg-1.10.3+1.21.11-neoforge" = _TxI9E3gY;
        "pkg-1.9.7+1.21.10-fabric" = _a98UkgML;
        "pkg-1.9.7+1.21.10-neoforge" = _aBn2niiX;
        "pkg-1.10.4+1.21.11-fabric" = _Q4YiZeCX;
        "pkg-1.10.4+1.21.11-neoforge" = _dzmqQjal;
        "pkg-1.10.5+1.21.11-fabric" = _ZQx4ktUs;
        "pkg-1.10.5+1.21.11-neoforge" = _Z0NAv1JK;
        "pkg-1.10.6+1.21.11-fabric" = _TSXvi2yD;
        "pkg-1.10.6+1.21.11-neoforge" = _k9tHcfnb;
        "pkg-1.10.7+26.1-fabric" = _4cGUAiJ6;
        "pkg-1.10.7+1.21.11-fabric" = _fDpuVzVr;
        "pkg-1.10.7+1.21.11-neoforge" = _v6TgIIUM;
        "pkg-1.10.8+26.1-fabric" = _Yi5E3d2l;
        "pkg-1.10.9+26.1-fabric" = _MwcLS51S;
        "pkg-1.10.9+26.1-neoforge" = _YEGDGnJM;
        "pkg-1.8.14-beta.1+1.21.1-fabric" = _bAo1Qhte;
        "pkg-1.8.14-beta.1+1.21.1-neoforge" = _KduFYu4t;
        "pkg-1.11.0+26.2-fabric" = _1y9HMMC6;
        "pkg-1.11.1+26.2-fabric" = _3uIIps8q;
        "pkg-1.11.2+26.2-fabric" = _oaD6KQls;
        ...
        "pkg-1.11.4+26.1-fabric" = _sZbVsl2Q;
        "pkg-1.11.4+26.1-neoforge" = _qE5Y7GrZ;
        "pkg-1.11.4+26.2-fabric" = _gxZWWnKH;
