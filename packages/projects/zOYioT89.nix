...
let
    versions = (let
        ...
        _acSGO1Xw = {
            "id" = "acSGO1Xw";
            "file" = "elytra_allay-1.0.1-mc26.3.zip";
            "hash" = "sha512-MXwO7LaZnIM17s4UzsjDrcsn6XlmAulpsMIaCh2EawKfEZ9fL9wKtt5zzGTK7rOcqvieZ/m2LnEjg7/MewsDPQ==";
        };
    in {
        "XkKtQhz5" = _XkKtQhz5;
        "fmgmN02Q" = _fmgmN02Q;
