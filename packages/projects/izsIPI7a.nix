...
let
    versions = (let
        ...
        _4hOlA9Ej = {
            "id" = "4hOlA9Ej";
            "file" = "MakeUp-UltraFast-9.5d.zip";
            "hash" = "sha512-cp/paubLuO5JIEyeeApCqlzWNl0Y0Z7afq+vL059/89MUU46Rmci9y0eEO1locbjjKVd7rgeNCuSRa6Y6rhfyQ==";
        };
        _T3EhqZo1 = {
            "id" = "T3EhqZo1";
            "file" = "MakeUp-UltraFast-9.5e.zip";
            "hash" = "sha512-Letr/bkZHjatq6YHtKhzy3QF6TBokD7eRUWKMMKKRYf+xO26H4dy5uE9whWW93SJKbY9wzokz9GY3/CazXIJtg==";
        };
    in {
        "giJQJsir" = _giJQJsir;
        "nq7l7BcV" = _nq7l7BcV;
        ...
        "4hOlA9Ej" = _4hOlA9Ej;
        "T3EhqZo1" = _T3EhqZo1;
        "iris-1.12.2" = _T3EhqZo1;
        "iris-1.13" = _T3EhqZo1;
        "iris-1.13.1" = _T3EhqZo1;
        "iris-1.13.2" = _T3EhqZo1;
        "iris-1.14" = _T3EhqZo1;
        "iris-1.14.1" = _T3EhqZo1;
        "iris-1.14.2" = _T3EhqZo1;
        "iris-1.14.3" = _T3EhqZo1;
        "iris-1.14.4" = _T3EhqZo1;
        "iris-1.15" = _T3EhqZo1;
        "iris-1.15.1" = _T3EhqZo1;
        "iris-1.15.2" = _T3EhqZo1;
        "iris-1.16" = _T3EhqZo1;
        "iris-1.16.1" = _T3EhqZo1;
        "iris-1.16.2" = _T3EhqZo1;
        "iris-1.16.3" = _T3EhqZo1;
        "iris-1.16.4" = _T3EhqZo1;
        "iris-1.16.5" = _T3EhqZo1;
        "iris-1.17" = _T3EhqZo1;
        "iris-1.17.1" = _T3EhqZo1;
        "iris-1.18" = _T3EhqZo1;
        "iris-1.18.1" = _T3EhqZo1;
        "iris-1.18.2" = _T3EhqZo1;
        "iris-1.19" = _T3EhqZo1;
        "iris-1.19.1" = _T3EhqZo1;
        "iris-1.19.2" = _T3EhqZo1;
        "iris-1.19.3" = _T3EhqZo1;
        "iris-1.19.4" = _T3EhqZo1;
        "iris-1.20" = _T3EhqZo1;
        "iris-1.20.1" = _T3EhqZo1;
        "iris-1.20.2" = _T3EhqZo1;
        "iris-1.20.3" = _T3EhqZo1;
        "iris-1.20.4" = _T3EhqZo1;
        "iris-1.20.5" = _T3EhqZo1;
        "iris-1.20.6" = _T3EhqZo1;
        "iris-1.21" = _T3EhqZo1;
        "iris-1.21.1" = _T3EhqZo1;
        "iris-1.21.2" = _T3EhqZo1;
        "iris-1.21.3" = _T3EhqZo1;
        "iris-1.21.4" = _T3EhqZo1;
        "iris-1.21.5" = _T3EhqZo1;
        "iris-1.21.6" = _T3EhqZo1;
        "iris-1.21.7" = _T3EhqZo1;
        "iris-1.21.8" = _T3EhqZo1;
        "iris-1.21.9" = _T3EhqZo1;
        "iris-1.21.10" = _T3EhqZo1;
        "iris-1.21.11" = _T3EhqZo1;
        "iris-26.1" = _T3EhqZo1;
        "iris-26.1.1" = _T3EhqZo1;
        "iris-26.1.2" = _T3EhqZo1;
        "iris-26.2" = _T3EhqZo1;
        "optifine-1.12.2" = _T3EhqZo1;
        "optifine-1.13" = _T3EhqZo1;
        "optifine-1.13.1" = _T3EhqZo1;
        "optifine-1.13.2" = _T3EhqZo1;
        "optifine-1.14" = _T3EhqZo1;
        "optifine-1.14.1" = _T3EhqZo1;
        "optifine-1.14.2" = _T3EhqZo1;
        "optifine-1.14.3" = _T3EhqZo1;
        "optifine-1.14.4" = _T3EhqZo1;
        "optifine-1.15" = _T3EhqZo1;
        "optifine-1.15.1" = _T3EhqZo1;
        "optifine-1.15.2" = _T3EhqZo1;
        "optifine-1.16" = _T3EhqZo1;
        "optifine-1.16.1" = _T3EhqZo1;
        "optifine-1.16.2" = _T3EhqZo1;
        "optifine-1.16.3" = _T3EhqZo1;
        "optifine-1.16.4" = _T3EhqZo1;
        "optifine-1.16.5" = _T3EhqZo1;
        "optifine-1.17" = _T3EhqZo1;
        "optifine-1.17.1" = _T3EhqZo1;
        "optifine-1.18" = _T3EhqZo1;
        "optifine-1.18.1" = _T3EhqZo1;
        "optifine-1.18.2" = _T3EhqZo1;
        "optifine-1.19" = _T3EhqZo1;
        "optifine-1.19.1" = _T3EhqZo1;
        "optifine-1.19.2" = _T3EhqZo1;
        "optifine-1.19.3" = _T3EhqZo1;
        "optifine-1.19.4" = _T3EhqZo1;
        "optifine-1.20" = _T3EhqZo1;
        "optifine-1.20.1" = _T3EhqZo1;
        "optifine-1.20.2" = _T3EhqZo1;
        "optifine-1.20.3" = _T3EhqZo1;
        "optifine-1.20.4" = _T3EhqZo1;
        "optifine-1.20.5" = _T3EhqZo1;
        "optifine-1.20.6" = _T3EhqZo1;
        "optifine-1.21" = _T3EhqZo1;
        "optifine-1.21.1" = _T3EhqZo1;
        "optifine-1.21.2" = _T3EhqZo1;
        "optifine-1.21.3" = _T3EhqZo1;
        "optifine-1.21.4" = _T3EhqZo1;
        "optifine-1.21.5" = _T3EhqZo1;
        "optifine-1.21.6" = _T3EhqZo1;
        "optifine-1.21.7" = _T3EhqZo1;
        "optifine-1.21.8" = _T3EhqZo1;
        "optifine-1.21.9" = _T3EhqZo1;
        "optifine-1.21.10" = _T3EhqZo1;
        "optifine-1.21.11" = _T3EhqZo1;
        "optifine-26.1" = _T3EhqZo1;
        "optifine-26.1.1" = _T3EhqZo1;
        "optifine-26.1.2" = _T3EhqZo1;
        "optifine-26.2" = _T3EhqZo1;
        "pkg-8.6g" = _giJQJsir;
        "pkg-8.7a" = _nq7l7BcV;
        "pkg-8.8" = _Rml9AYAP;
        "pkg-8.8a" = _yt7KFLEm;
