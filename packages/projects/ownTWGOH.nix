...
let
    versions = (let
        ...
        _J3GNoS4u = {
            "id" = "J3GNoS4u";
            "file" = "BetterTrialChambers-2.2.0.jar";
            "hash" = "sha512-RZVFVtzsBGyjo2gizUchehRFatyDFrfsU4iHOv5NUGvhEfFSU34DEivmkZuuXkWS0Yo2012UvBicpv4eiqJEHQ==";
        };
        _xnLb3x3c = {
            "id" = "xnLb3x3c";
            "file" = "BetterTrialChambers-2.2.0-mc26.jar";
            "hash" = "sha512-kRbRB9+5xm2qJGm+R/tuvDadD0w0pLi3lSQd7Dj5IhFhhnPr4Ancj1YS4cxce5OmuxfleWurraWboCDjNWj+zA==";
        };
        _vXLX94KQ = {
            "id" = "vXLX94KQ";
            "file" = "BetterTrialChambers-2.2.0-mc263.jar";
            "hash" = "sha512-x9UojeCVYTMmHz2onIOu4mcL0rFNhgazOX/4hks3CM+MITyhO8AWkV1g+UQqvpGIiD9kcyUuwhF2ZUfN5u+gFw==";
        };
    in {
        "s7gf8QGm" = _s7gf8QGm;
        "Z392MUfo" = _Z392MUfo;
        ...
        "xnLb3x3c" = _xnLb3x3c;
        "vXLX94KQ" = _vXLX94KQ;
        "folia-1.21.1" = _J3GNoS4u;
        "folia-1.21.2" = _J3GNoS4u;
        "folia-1.21.3" = _J3GNoS4u;
        "folia-1.21.4" = _J3GNoS4u;
        "folia-1.21.5" = _J3GNoS4u;
        "folia-1.21.6" = _J3GNoS4u;
        "folia-1.21.7" = _J3GNoS4u;
        "folia-1.21.8" = _J3GNoS4u;
        "folia-1.21.9" = _J3GNoS4u;
        "folia-1.21.10" = _J3GNoS4u;
        "folia-1.21" = _J3GNoS4u;
        "folia-1.21.11" = _J3GNoS4u;
        "folia-26.1" = _xnLb3x3c;
        "folia-26.1.1" = _xnLb3x3c;
        "folia-26.1.2" = _xnLb3x3c;
        "folia-26.2" = _xnLb3x3c;
        "folia-26.3" = _vXLX94KQ;
        "paper-1.21.1" = _J3GNoS4u;
        "paper-1.21.2" = _J3GNoS4u;
        "paper-1.21.3" = _J3GNoS4u;
        "paper-1.21.4" = _J3GNoS4u;
        "paper-1.21.5" = _J3GNoS4u;
        "paper-1.21.6" = _J3GNoS4u;
        "paper-1.21.7" = _J3GNoS4u;
        "paper-1.21.8" = _J3GNoS4u;
        "paper-1.21.9" = _J3GNoS4u;
        "paper-1.21.10" = _J3GNoS4u;
        "paper-1.21" = _J3GNoS4u;
        "paper-1.21.11" = _J3GNoS4u;
        "paper-26.1" = _xnLb3x3c;
        "paper-26.1.1" = _xnLb3x3c;
        "paper-26.1.2" = _xnLb3x3c;
        "paper-26.2" = _xnLb3x3c;
        "paper-26.3" = _vXLX94KQ;
        "purpur-1.21.1" = _J3GNoS4u;
        "purpur-1.21.2" = _J3GNoS4u;
        "purpur-1.21.3" = _J3GNoS4u;
        "purpur-1.21.4" = _J3GNoS4u;
        "purpur-1.21.5" = _J3GNoS4u;
        "purpur-1.21.6" = _J3GNoS4u;
        "purpur-1.21.7" = _J3GNoS4u;
        "purpur-1.21.8" = _J3GNoS4u;
        "purpur-1.21.9" = _J3GNoS4u;
        "purpur-1.21.10" = _J3GNoS4u;
        "purpur-1.21" = _J3GNoS4u;
        "purpur-1.21.11" = _J3GNoS4u;
        "purpur-26.1" = _xnLb3x3c;
        "purpur-26.1.1" = _xnLb3x3c;
        "purpur-26.1.2" = _xnLb3x3c;
        "purpur-26.2" = _xnLb3x3c;
        "purpur-26.3" = _vXLX94KQ;
        "pkg-1.0.0" = _s7gf8QGm;
        "pkg-1.0.1" = _Z392MUfo;
        "pkg-1.0.9" = _oNtgcEGp;
        "pkg-1.1.2" = _TQYrNmpA;
        ...
        "pkg-1.2.8" = _jTseYnuR;
        "pkg-1.2.9" = _DkCyeJXe;
        "pkg-1.2.10" = _tZ07BF0w;
        "pkg-1.2.11" = _kkxft1K0;
        "pkg-1.2.12" = _qWCixu3d;
        "pkg-1.2.13" = _Tr6heKZA;
        "pkg-1.2.14" = _k9LUXDHw;
        "pkg-1.2.15" = _x485GK4C;
        "pkg-1.2.16" = _p440WMEh;
        "pkg-1.2.17" = _j2qQxuhz;
        "pkg-1.2.18" = _p1g2Dh0x;
        "pkg-1.2.19" = _SwWde5zD;
        "pkg-1.2.20" = _KpLrPrqi;
        "pkg-1.2.21" = _GcaxWrAZ;
        "pkg-1.2.22" = _ggglTv9s;
        "pkg-1.2.23" = _zpifVOFP;
        "pkg-1.2.24" = _Ie3xuVbL;
        "pkg-1.2.24-mc26" = _676tDSwC;
        "pkg-1.2.25" = _bOcaQme8;
        "pkg-1.2.25-mc26" = _CxOJYk7x;
        "pkg-1.2.26" = _L4XpMidq;
        "pkg-1.2.26-mc26" = _ZQh0CmOe;
        "pkg-1.2.27" = _7h0sPUku;
        "pkg-1.2.27-mc26" = _uNtmDgyV;
        "pkg-1.2.28" = _wjym5cxr;
        "pkg-1.2.29" = _6nLiYHnF;
        "pkg-1.2.29-mc26" = _ywaalyn5;
        "pkg-1.3.0-beta.1" = _9533LgtK;
        "pkg-1.3.0-beta.1-mc26" = _Wn4vuQvR;
        "pkg-1.3.1" = _Fb7Js2He;
        "pkg-1.3.1-mc26" = _1gojbSZX;
        "pkg-1.3.2" = _HWW589oF;
        "pkg-1.3.2-mc26" = _Dp8c5ONt;
        "pkg-1.3.3" = _zhSEZU8s;
        "pkg-1.3.3-mc26" = _W68FUWjD;
        "pkg-1.4.0" = _ofD4nIf1;
        "pkg-1.4.0-mc26" = _Yk0KqLcl;
        "pkg-1.4.1" = _u3BmfqkR;
        "pkg-1.4.1-mc26" = _2NaGmJcf;
        "pkg-1.4.2" = _Gk1WMXGJ;
        "pkg-1.4.2-mc26" = _VYLMwz24;
        "pkg-1.4.3" = _N5OtFodj;
        "pkg-1.4.3-mc26" = _tHJ9eiPL;
        "pkg-1.4.4" = _IRhHItRC;
        "pkg-1.4.4-mc26" = _NEOeJ1Q8;
        "pkg-1.4.5" = _egqXSyLC;
        "pkg-1.4.5-mc26" = _djT1O3Xp;
        "pkg-1.4.6" = _lqfKlF6z;
        "pkg-1.4.6-mc26" = _GRpcGw00;
        "pkg-1.4.7" = _E1NVASLx;
        "pkg-1.4.7-mc26" = _SxceYb2m;
        "pkg-1.5.0" = _cehiInIn;
        "pkg-1.5.0-mc26" = _oszosGTe;
        "pkg-1.5.1" = _nOyfluRt;
        "pkg-1.5.1-mc26" = _8dPEAlB9;
        "pkg-1.5.2" = _V2e3bdpL;
        "pkg-1.5.2-mc26" = _TO9dB1Fs;
        "pkg-1.5.4" = _o58u7ukf;
        "pkg-1.5.4-mc26" = _TqQqB0y3;
        "pkg-1.5.5" = _rz3WB2hX;
        "pkg-1.5.5-mc26" = _5Z7uzAog;
        "pkg-1.5.6" = _GeYO1tmc;
        "pkg-1.5.6-mc26" = _geCh4djv;
        "pkg-1.5.7" = _O9KakhWg;
        "pkg-1.5.7-mc26" = _HZUCQkAV;
        "pkg-1.5.8" = _aWRQ1ofj;
        "pkg-1.5.8-mc26" = _6ku32fBU;
        "pkg-1.5.9" = _tNWEDPY7;
        "pkg-1.5.9-mc26" = _ZDCou0no;
        "pkg-1.5.10" = _SUQHPaWc;
        "pkg-1.5.10-mc26" = _shUQKMYA;
        "pkg-1.5.11" = _xNxQ1lEf;
        "pkg-1.5.11-mc26" = _bOttqPLj;
        "pkg-1.5.12" = _kevnEwwP;
        "pkg-1.5.12-mc26" = _ICWvymUK;
        "pkg-1.5.13" = _wtdSZr9X;
        "pkg-1.5.13-mc26" = _7DFzC7Kc;
        "pkg-1.5.14" = _jV4DRzBV;
        "pkg-1.5.14-mc26" = _cG6IDea2;
        "pkg-1.5.15" = _2QN2AyQC;
        "pkg-1.5.15-mc26" = _P7gRrClU;
        "pkg-1.5.16" = _w1acvpoK;
        "pkg-1.5.16-mc26" = _uoG2UcB6;
        "pkg-1.5.17" = _hDtnwyUy;
        "pkg-1.5.17-mc26" = _RR4uVzCe;
        "pkg-1.5.18" = _SO4oIXT0;
        "pkg-1.5.18-mc26" = _DCStHb1q;
        "pkg-1.5.19" = _OuitjMlm;
        "pkg-1.5.19-mc26" = _jovy1lzc;
        "pkg-1.5.20" = _Ipmp5jgy;
        "pkg-1.5.20-mc26" = _E7zXLBAN;
        "pkg-1.5.21" = _Qfp9vsdh;
        "pkg-1.5.21-mc26" = _chQvUqh8;
        "pkg-1.5.22" = _zjkPoV65;
        "pkg-1.5.22-mc26" = _FDRejojT;
        "pkg-1.6.0" = _lbQyWpP7;
        "pkg-1.6.0-mc26" = _ZhhirvrH;
        "pkg-1.6.1" = _X8P10SsB;
        "pkg-1.6.1-mc26" = _IrZYU7zC;
        "pkg-1.6.2" = _AAerZraJ;
        "pkg-1.6.2-mc26" = _ezAgzY3W;
        "pkg-1.6.3" = _L7DVTVLp;
        "pkg-1.6.3-mc26" = _rcd1SPym;
        "pkg-1.7.0" = _SBHMSNrD;
        "pkg-1.7.0-mc26" = _6K0zeD88;
        "pkg-1.7.1" = _kf028Iiy;
        "pkg-1.7.1-mc26" = _iohlG49h;
        "pkg-1.7.2" = _jMQDoGdS;
        "pkg-1.7.2-mc26" = _SI76Tl3n;
        "pkg-1.7.3" = _pDgNXgSx;
        "pkg-1.7.3-mc26" = _S1TdU01B;
        "pkg-1.8.0" = _7BDVYBGr;
        "pkg-1.8.0-mc26" = _B1yfZ4MI;
        "pkg-1.8.1" = _VQQCqkV1;
        "pkg-1.8.1-mc26" = _Tocpohsx;
        "pkg-2.0.0" = _PXdJ5p0N;
        "pkg-2.0.0-mc26" = _Ge0NiXMW;
        "pkg-2.0.1" = _N7ELCKKY;
        "pkg-2.0.1-mc26" = _KCn5oqyq;
        "pkg-2.0.2" = _z3d7VKg6;
        "pkg-2.0.2-mc26" = _Gzb7Pj7J;
        "pkg-2.0.3" = _7p2ecFFq;
        "pkg-2.0.3-mc26" = _fk5DC487;
        "pkg-2.0.4" = _jBxRE9rO;
        "pkg-2.0.4-mc26" = _ebPMa59d;
        "pkg-2.0.7" = _n1wpelan;
        "pkg-2.0.7-mc26" = _HTxS6AMV;
        "pkg-2.0.8" = _Z4UzIbXG;
        "pkg-2.0.8-mc26" = _PgTZQngE;
        "pkg-2.0.9" = _OkXnyJET;
        "pkg-2.0.9-mc26" = _kLiZWlPL;
        "pkg-2.0.10" = _mpvYjxOU;
        "pkg-2.0.10-mc26" = _9RiSbQcj;
        "pkg-2.0.11" = _mjYpRRli;
        "pkg-2.0.11-mc26" = _fgYjXDJX;
        "pkg-2.0.12" = _SP19YKsf;
        "pkg-2.0.12-mc26" = _gii7oTA6;
        "pkg-2.1.0" = _AXjkP43P;
        "pkg-2.1.0-mc26" = _A39p4XGu;
        "pkg-2.2.0" = _J3GNoS4u;
        "pkg-2.2.0-mc26" = _xnLb3x3c;
        "pkg-2.2.0-mc263" = _vXLX94KQ;
        "default" = _vXLX94KQ;
    });
