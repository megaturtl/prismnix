...
let
    ...
    in {
        ...
        "datapack-1.21.9" = _GoyU4VdS;
        "datapack-1.21.10" = _GoyU4VdS;
        "datapack-1.21.11" = _GoyU4VdS;
        "datapack-26.1" = _GoyU4VdS;
        "datapack-26.1.1" = _GoyU4VdS;
        "datapack-26.1.2" = _GoyU4VdS;
        "datapack-26.2" = _GoyU4VdS;
        "fabric-1.21.6" = _4oxi8qwp;
        "fabric-1.21.7" = _4oxi8qwp;
        "fabric-1.21.8" = _Y0ex4qCZ;
        "fabric-1.21.9" = _durWWcyi;
        "fabric-1.21.10" = _durWWcyi;
        "fabric-1.21.11" = _durWWcyi;
        "fabric-26.1" = _durWWcyi;
        "fabric-26.1.1" = _durWWcyi;
        "fabric-26.1.2" = _durWWcyi;
        "fabric-26.2" = _durWWcyi;
        "forge-1.21.6" = _4oxi8qwp;
        "forge-1.21.7" = _4oxi8qwp;
        "forge-1.21.8" = _Y0ex4qCZ;
        "forge-1.21.9" = _durWWcyi;
        "forge-1.21.10" = _durWWcyi;
        "forge-1.21.11" = _durWWcyi;
        "forge-26.1" = _durWWcyi;
        "forge-26.1.1" = _durWWcyi;
        "forge-26.1.2" = _durWWcyi;
        "forge-26.2" = _durWWcyi;
        "neoforge-1.21.6" = _4oxi8qwp;
        "neoforge-1.21.7" = _4oxi8qwp;
        "neoforge-1.21.8" = _Y0ex4qCZ;
        "neoforge-1.21.9" = _durWWcyi;
        "neoforge-1.21.10" = _durWWcyi;
        "neoforge-1.21.11" = _durWWcyi;
        "neoforge-26.1" = _durWWcyi;
        "neoforge-26.1.1" = _durWWcyi;
        "neoforge-26.1.2" = _durWWcyi;
        "neoforge-26.2" = _durWWcyi;
        "quilt-1.21.6" = _4oxi8qwp;
        "quilt-1.21.7" = _4oxi8qwp;
        "quilt-1.21.8" = _Y0ex4qCZ;
        "quilt-1.21.9" = _durWWcyi;
        "quilt-1.21.10" = _durWWcyi;
        "quilt-1.21.11" = _durWWcyi;
        "quilt-26.1" = _durWWcyi;
        "quilt-26.1.1" = _durWWcyi;
        "quilt-26.1.2" = _durWWcyi;
        "quilt-26.2" = _durWWcyi;
