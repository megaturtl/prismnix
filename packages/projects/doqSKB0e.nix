...
let
    versions = (let
        ...
        _HQ91YnMY = {
            "id" = "HQ91YnMY";
            "file" = "styled-chat-2.14.0+26.3.jar";
            "hash" = "sha512-w3OqJojiG/UUibjyk0IWYwqpgfwIFq1IB3JUlwXLqyjX6XxO6+5VOCbBDYRrzVB26Y5HWlTS8oqY2itcLBQnHw==";
        };
    in {
        "HwotiUn2" = _HwotiUn2;
        "AsTzH7Oz" = _AsTzH7Oz;
        ...
        "fabric-26.3-rc-1" = _HQ91YnMY;
        "fabric-26.3" = _HQ91YnMY;
        ...
        "pkg-1.1.0" = _a9Rqo8cl;
        "pkg-1.2.0" = _wGVIf3X1;
        "pkg-1.2.1+1.18" = _BU3iHBsn;
        "pkg-1.2.2+1.18" = _3rv0U8rI;
        "pkg-1.2.3+1.18.1" = _6Ar8kSQ4;
        "pkg-1.3.0+1.19" = _XiyDiGXF;
        "pkg-1.3.1+1.19" = _Imh6rj9g;
        "pkg-1.3.2+1.19" = _TomiOF52;
        "pkg-1.3.3+1.19" = _nl6vW6F2;
        "pkg-1.4.0+1.19.1" = _hRwDsZke;
        "pkg-1.4.1+1.19.2" = _iUp0COVy;
        "pkg-2.0.0+1.19.2" = _ShQVp6As;
        "pkg-2.0.1+1.19.2" = _itzoW5yD;
        "pkg-2.0.2+1.19.2" = _K2V8LYPT;
        "pkg-2.1.0+1.19.3" = _aABVYx7R;
        "pkg-2.1.1+1.19.3" = _LRKHMAeS;
        "pkg-2.1.2+1.19.3" = _BriPIjGV;
        "pkg-2.1.3+1.19.3" = _9eDWeAQo;
        "pkg-2.0.3+1.19.2" = _RRZC8TnY;
        "pkg-2.1.4+1.19.3" = _1uSSPGsu;
        "pkg-2.1.5+1.19.4" = _krxsLfUl;
        "pkg-2.1.6+1.19.4" = _WSgVV9CL;
        "pkg-2.2.0+1.20" = _9oVLuNZf;
        "pkg-2.2.1+1.20.1" = _duQRhm80;
        "pkg-2.2.2+1.20.1" = _axLlTgG5;
        "pkg-2.0.4+1.19.2" = _2DkBIhFd;
        "pkg-2.2.3+1.20.1" = _7dmapSQA;
        "pkg-2.3.0+1.20.2" = _J9nCzhiG;
        "pkg-2.4.0+1.20.3" = _hPPTz9OM;
        "pkg-2.5.0+1.20.5" = _OQeEfRIi;
        "pkg-2.6.0+1.21" = _EoTTJkqS;
        "pkg-2.7.0+1.21.2" = _5jN44RUy;
        "pkg-2.7.1+1.21.3" = _b7ivf9W5;
        "pkg-2.2.4+1.20.1" = _pwr7uYCH;
        "pkg-2.6.1+1.21" = _4e1xZSk3;
        "pkg-2.7.2+1.21.3" = _AQ0JW3y8;
        "pkg-2.4.2+1.20.4" = _kLvkSdyR;
        "pkg-2.3.1+1.20.2" = _9k3L1PEs;
        "pkg-2.1.7+1.19.4" = _LIG1Fs95;
        "pkg-2.8.0+1.21.5" = _E1RdcKyb;
        "pkg-2.9.0+1.21.6" = _4iEiOcnO;
        "pkg-2.10.0+1.21.9" = _ub8BCtuy;
        "pkg-2.11.0+1.21.11" = _nW0Cfq7D;
        "pkg-2.12.0-pre.1+26.1" = _V5imDrbM;
        "pkg-2.12.0+26.1.2" = _N8ASEpbM;
        "pkg-2.13.0+26.2" = _A7ihc7ss;
        "pkg-2.14.0+26.3" = _HQ91YnMY;
        "default" = _HQ91YnMY;
    });
