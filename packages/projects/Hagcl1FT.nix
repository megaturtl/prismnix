...
let
    ...
    in {
        ...
        "pkg-0.1.4-alpha" = _LTtw7H1p;
        "pkg-0.1.5-alpha" = _M3qinL5e;
        "pkg-0.1.6-alpha-1.18.2" = _UpyGZDDx;
        "pkg-0.2.0-alpha-1.19.2" = _NyUBWxLH;
        "pkg-0.2.1-alpha-1.19.2" = _OlWrxe7t;
        "pkg-0.2.2-alpha-1.19.2" = _EDBCakT8;
        "pkg-0.2.3-alpha-1.19.2" = _YfoyWoom;
        "pkg-0.2.4-alpha+1.19.2" = _ayyc78da;
        "pkg-0.2.5-alpha+1.19.2" = _4JMPPnXc;
        "pkg-0.2.6-alpha+1.19.2" = _D5Xtlojx;
        "pkg-0.2.7-alpha+1.19.2" = _m2ISXQBA;
        "pkg-0.2.8-alpha+1.19.2" = _xSBQntCx;
        "pkg-0.2.9-alpha+1.19.2" = _hpNxpQhw;
        "pkg-0.2.10-alpha+1.19.2" = _Ruj59vvF;
        "pkg-0.2.11-alpha+1.19.2" = _7hQWpH2Z;
        "pkg-0.2.12-alpha+1.19.2" = _9cjyNvoJ;
        "pkg-0.2.13-alpha+1.19.2" = _3QVnbOet;
        "pkg-0.2.14-alpha+1.19.2" = _HKIXKheM;
        "pkg-0.2.15-beta+1.19.2" = _Pwr6OEuE;
        "pkg-0.2.16-beta+1.19.2" = _7jZxosy2;
        "pkg-0.2.17-beta+1.19.2" = _56UcO0Mq;
        "pkg-0.2.17-alpha+1.20.1" = _KaMRLtmz;
        "pkg-0.2.18-beta+1.20.1" = _xzAO6VX2;
        "pkg-0.2.18-beta+1.19.2" = _Ul7hoyCA;
        "pkg-0.2.19-beta+1.19.2" = _X4nioFVI;
        "pkg-0.2.19-beta+1.20.1" = _HdtWL1BZ;
        "pkg-0.2.20-beta+1.20.1" = _YOlR8lCT;
        "pkg-0.2.20-beta+1.19.2" = _3c3DVwVk;
        "pkg-0.2.21-beta+1.19.2" = _GIQ02wE9;
        "pkg-0.2.21-beta+1.20.1" = _lI1mzAcU;
        "pkg-0.2.22-beta+1.19.2" = _paiDpojA;
        "pkg-0.2.22-beta+1.20.1" = _1DZsoNr1;
        "pkg-0.2.23-beta+1.20.1" = _Dz7PO6mw;
        "pkg-0.2.23-beta+1.19.2" = _F7EOWWuW;
        "pkg-0.2.24-beta+1.20.1" = _EZRfGf0l;
        "pkg-0.2.24-beta+1.19.2" = _FSC3teKp;
        "pkg-0.2.25-beta+1.20.1" = _gRTc2Snl;
        "pkg-0.2.25-beta+1.19.2" = _rI6vjg2i;
        "pkg-0.2.26-beta+1.19.2" = _SeyJuAqd;
        "pkg-0.2.26-beta+1.20.1" = _deqCwHcr;
        "pkg-0.2.28-beta+1.20.1" = _Qf8BRIrG;
        "pkg-0.2.28-beta+1.19.2" = _oBXtquZy;
        "pkg-0.2.29-beta+1.19.2" = _43VIr5b1;
        "pkg-0.2.29-beta+1.20.1" = _SVKBw6d1;
        "pkg-0.2.30-beta+1.19.2" = _3iOTrufE;
        "pkg-0.2.30-beta+1.20.1" = _j2ef7KjG;
        "pkg-0.2.31-beta+1.20.1" = _bkcCpwsw;
        "pkg-0.2.31-beta+1.19.2" = _t2z8W920;
        "pkg-0.2.32-beta+1.20.1" = _HKi92FFl;
        "pkg-0.2.32-beta+1.19.2" = _XxthiYWk;
        "pkg-0.2.33-beta+1.19.2" = _OIf9X93F;
        "pkg-0.2.33-beta+1.20.1" = _EmEclxzx;
        "pkg-0.2.34-beta+1.20.1" = _lG7ucYIX;
        "pkg-0.2.34-beta+1.19.2" = _GZ7rwGQB;
        "pkg-0.2.35-beta+1.20.1" = _v4iRJ5Zb;
        "pkg-0.2.35-beta+1.19.2" = _o3jDVTjI;
        "pkg-0.2.36-beta+1.19.2" = _OLGBwOFY;
        "pkg-0.2.36-beta+1.20.1" = _feeP2ds9;
        "pkg-0.2.37-beta+1.20.1" = _dybDtXNH;
        "pkg-0.2.37-beta+1.19.2" = _Z2Bhxfua;
        "pkg-0.3.0-beta+1.20.1" = _e8phUJku;
        "pkg-0.3.0-beta+1.19.2" = _ACYmZwBN;
        "pkg-0.3.1-beta+1.19.2" = _oQwOdeJQ;
        "pkg-0.4.0-beta+1.20.1" = _rDJmhlDy;
        "pkg-0.4.0-beta+1.19.2" = _DOvcpX3s;
        "pkg-0.5-beta+1.19.2" = _LhyzYQ92;
        "pkg-0.5.0-beta+1.20.1" = _rzi2NSb4;
        "pkg-0.5.1-beta+1.19.2" = _d18LXyrB;
        "pkg-0.5.1-beta+1.20.1" = _vzLioxvO;
        "pkg-0.6.0-beta+1.20.1" = _S9DyPhBu;
        "pkg-0.6.0-beta+1.19.2" = _gGTu9U6B;
        "pkg-0.6.1-beta+1.20.1" = _4knNdicA;
        "pkg-0.6.1-beta+1.19.2" = _vOkX416Z;
        "pkg-0.6.2-beta+1.20.1" = _RZ07w0MM;
        "pkg-0.7.0-beta+1.20.1" = _ESYVFUkO;
        "pkg-0.7.0-beta+1.19.2" = _EnUB2nk6;
        "pkg-0.7.1-beta+1.20.1" = _9cJAVdDp;
        "pkg-0.7.1-beta+1.19.2" = _CBEkQFOw;
        "pkg-0.7.2-beta+1.20.1" = _c2gaabGb;
        "pkg-0.7.2-beta+1.19.2" = _kQccmvgX;
        "pkg-0.8.0-beta+1.20.1" = _zOHbUFpg;
        "pkg-0.8.0-beta+1.19.2" = _7DJeJ4YX;
        "pkg-0.8.1-beta+1.19.2" = _AQJGYSTW;
        "pkg-0.8.1-beta+1.20.1" = _ixAfRVsL;
        "pkg-0.9.0-beta+1.20.1" = _UGL9d98g;
        "pkg-0.9.0-beta+1.19.2" = _gO7BDCkV;
        "pkg-0.9.1-beta+1.19.2" = _pITJWBcS;
        "pkg-0.9.1-beta+1.20.1" = _qpUZfJLa;
        "pkg-0.9.2-beta+1.19.2" = _GwR3RYcP;
        "pkg-0.10.0-beta+1.20.1" = _CYnuRfgw;
        "pkg-0.10.0-beta+1.19.2" = _eoQ8f9yr;
        "pkg-0.10.1-beta+1.20.1" = _mkVA6nNZ;
        "pkg-0.10.1-beta+1.19.2" = _mZUEDhfH;
        "pkg-0.11.1-beta+1.20.1" = _WJFufJaI;
        "pkg-0.11.1-beta+1.19.2" = _jYBxhrxL;
        "pkg-0.11.2-beta+1.20.1" = _YF0ppojU;
        "pkg-0.11.2-beta+1.19.2" = _umYsNljt;
        "pkg-0.11.3-beta+1.20.1" = _PyL6JTUm;
        "pkg-0.11.3-beta+1.19.2" = _8HWqDoGh;
        "pkg-0.11.4-beta+1.19.2" = _o00kcR1K;
        "pkg-0.11.4-beta+1.20.1" = _xTm35zkC;
        "pkg-0.12.0-beta+1.20.1" = _RkoWJ0XE;
        "pkg-0.12.0-beta+1.19.2" = _AXkE3k5j;
        "pkg-0.12.1-alpha+connector+1.20.1" = _XOhcAoKl;
        "pkg-0.12.1-beta+1.19.2" = _j2gnwsbA;
        "pkg-0.12.1-beta+1.20.1" = _wgiv8DsM;
        "pkg-0.13.0-beta+1.20.1" = _LfiimZ8F;
        "pkg-0.13.0-beta+1.19.2" = _XXb7szCr;
        "pkg-0.13.1-beta+1.20.1" = _bdBxRgWR;
        "pkg-0.13.1-beta+1.19.2" = _hww8Rbss;
        "pkg-0.14.0-beta+1.19.2" = _iII9GKK6;
        "pkg-0.14.0-beta+1.20.1" = _v5lsioTf;
        "pkg-0.14.1-beta+1.19.2" = _zsOonZ5s;
        "pkg-0.14.1-beta+1.20.1" = _nwhUGS2R;
        "pkg-0.14.2-beta+1.20.1" = _xy0Te6uN;
        "pkg-0.14.2-beta+1.19.2" = _XUk58ZrK;
        "pkg-0.14.3-beta+1.19.2" = _8XE60qn7;
        "pkg-0.14.3-beta+1.20.1" = _1H1gFBbo;
        "pkg-0.14.5-beta+1.19.2" = _hkGcny6Y;
        "pkg-0.14.5-beta+1.20.1" = _2gukTmmp;
        "pkg-0.14.6-beta+1.20.1" = _keyH6q9r;
        "pkg-0.14.6-beta+1.19.2" = _AD37KXR6;
        "pkg-0.15.0-beta+1.20.1" = _XDCkbF0J;
        "pkg-0.15.0-beta+1.19.2" = _M9ee48XV;
        "pkg-0.15.1-beta+1.20.1" = _urDwztdt;
        "pkg-0.15.1-beta+1.19.2" = _N6TtIeGQ;
        "pkg-0.16.0-beta+1.20.1" = _TvoryWyQ;
        "pkg-0.16.0-beta+1.19.2" = _NOhaGsze;
        "pkg-0.17.0-beta+1.20.1" = _WlbFf9y9;
        "pkg-0.17.1-beta+1.20.1" = _CluXLFUb;
        "pkg-0.17.1-beta+1.19.2" = _o0QsbBZP;
        "pkg-0.17.2-beta+1.20.1" = _lCqOf4K6;
        "pkg-0.17.2-beta+1.19.2" = _8DvtSYU0;
        "pkg-0.18.0-beta+1.19.2" = _gLxJvrRg;
        "pkg-0.18.0-beta+1.20.1" = _tXJWgFNI;
        "pkg-0.19.0-beta+1.20.1" = _UNZo1FJQ;
        "pkg-0.19.0-beta+1.19.2" = _81TRzFkn;
        "pkg-0.19.1-beta+1.20.1" = _Ezh2kfKz;
        "pkg-0.19.1-beta+1.19.2" = _YO7yTqi1;
        "pkg-0.19.3-beta+1.20.1" = _I2DER639;
        "pkg-0.19.3-beta+1.19.2" = _hSGx9Rdv;
        "pkg-0.20.0-beta+1.20.1" = _Vwn4tY84;
        "pkg-0.20.1-beta+1.20.1" = _Wz3Zwkax;
        "pkg-0.20.2-beta+1.20.1" = _YzpHoAo8;
        "pkg-0.20.3-beta+1.20.1" = _2HJ8HaWG;
        "pkg-0.20.4-beta+1.20.1" = _25jNcpxX;
        "pkg-0.20.5-beta+1.20.1" = _J3Tjjvtg;
        "pkg-0.20.6-beta+1.20.1" = _oc2lq4EE;
        "pkg-0.21.0-beta+1.20.1" = _q4KGbGEf;
        "pkg-0.21.1-beta+1.20.1" = _y2hjEjMs;
        "pkg-0.21.2-beta+1.20.1" = _bFeolBsM;
        "pkg-0.21.3-beta+1.20.1" = _sL5Xok8W;
        "pkg-0.22.0-beta+1.20.1" = _E3ItKZPd;
        "pkg-0.22.1-beta+1.20.1" = _SmM12G4G;
        "pkg-0.23.0-beta+1.20.1" = _W7fYJB9C;
        "pkg-0.23.1-beta+1.20.1" = _Ep2PMoKt;
        "pkg-0.23.2-beta+1.20.1" = _9UhUWmtd;
        "pkg-0.24.0-beta+1.20.1" = _OkIF4BWM;
        "pkg-0.25.1-beta+1.20.1" = _yjRvNX8S;
        "pkg-0.25.2-beta+1.20.1" = _LxHL74al;
        "pkg-0.25.3-beta+1.20.1" = _HDC1HODI;
        "pkg-0.26.0-beta+1.20.1" = _rDBuNqKP;
        "pkg-0.26.1-beta+1.20.1" = _982ecQRe;
        "pkg-0.26.2-beta+1.20.1" = _ATurlr8R;
        "pkg-0.26.4-beta+1.20.1" = _Kwq4uHmW;
        "pkg-0.27.0-beta+1.20.1" = _oaVpvLQg;
        "pkg-0.27.1-beta+1.20.1" = _FD72j2D7;
        "pkg-0.27.2-beta+1.20.1" = _mAmFgdSN;
        "pkg-0.27.3-beta+1.20.1" = _wrVRaOTc;
        "pkg-0.27.4-beta+1.20.1" = _fk4XorMW;
        "pkg-0.27.5-beta+1.20.1" = _v6SmrbHX;
        "pkg-0.27.6-beta+1.20.1" = _felU8pq3;
        "pkg-0.28.0-beta+1.20.1" = _8zrMmVv3;
        "pkg-0.28.1-beta+1.20.1" = _ZwIyrEaA;
        "pkg-0.29.0-beta+1.20.1" = _at0KiTVM;
        "pkg-0.29.1-beta+1.20.1" = _fBdeFFIn;
        "pkg-0.29.2-beta+1.20.1" = _eBBWdqho;
        "pkg-0.30.0-beta+1.20.1" = _HR7NrN0r;
        "pkg-0.30.2-beta+1.20.1" = _h9K6kon6;
