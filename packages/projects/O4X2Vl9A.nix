...
let
    ...
    in {
        ...
        "pkg-1.5.25.12" = _DadjdT5b;
        "pkg-1.5.37" = _dhXEJNUw;
        "pkg-1.6.B.2" = _AuGiSX0Y;
        "pkg-1.6" = _r23S9GwJ;
        "pkg-1.6.1" = _t0mUp8ku;
        "pkg-1.5.25.13" = _gdCQddFZ;
        "pkg-1.6.2" = _jIgTSZc3;
        "pkg-1.6.4" = _LiKiubBN;
        "pkg-1.6.5" = _FQBAHI0y;
        "pkg-1.6.5.1" = _sxlSpOou;
        "pkg-1.6.6" = _w2n72qTn;
        "pkg-1.6.5.2" = _DHEfFJav;
        "pkg-1.6.7" = _VIbgLnzo;
        "pkg-1.6.8" = _vtoBJmrB;
        "pkg-1.6.9" = _qzFp6W7D;
        "pkg-1.6.10" = _EAuRSdRV;
        "pkg-1.6.11" = _c4WoCsKQ;
        "pkg-1.6.12" = _VbKnrwDQ;
        "pkg-1.6.13" = _MKo512ZZ;
        "pkg-1.6.5.3" = _ehxWcjMA;
        "pkg-1.6.14" = _Sq7hW5Dv;
        "pkg-1.6.15" = _6kPckq3k;
        "pkg-1.6.16" = _rMA2g3Ul;
        "pkg-1.6.17" = _oJBnTIKg;
        "pkg-1.6.18" = _u0axB9ew;
        "pkg-1.6.19" = _wpJZfXgC;
        "pkg-1.6.20" = _SsYw2bKC;
        "pkg-1.6.21" = _TAW9VVQw;
        "pkg-1.6.22" = _iRSDWTVQ;
        "pkg-1.6.23" = _ESbeJmAI;
        "pkg-1.6.24" = _AdiEMTie;
        "pkg-1.6.25" = _AyE52Ogg;
        "pkg-1.6.26" = _i3KRnoky;
        "pkg-1.6.10.1" = _Eeno6i25;
        "pkg-1.6.27" = _SlGB9Os8;
        "pkg-1.6.28" = _ArtXuK1o;
        "pkg-1.6.5.4" = _AIbgxMci;
        "pkg-1.6.29" = _1lb3KpxD;
        "pkg-1.6.30" = _R7INYdgl;
        "pkg-1.6.31" = _1a13B8HB;
        "pkg-1.6.32" = _KXoaNHAt;
        "pkg-1.6.33" = _5Opiev69;
        "pkg-1.6.34" = _Vy1cjZnU;
        "pkg-1.6.35" = _6VU7uRuy;
        "pkg-1.6.A.1" = _wOXTZexX;
        "pkg-1.6.36" = _a5BLBOLA;
        "pkg-1.6.37" = _NGudAv3e;
        "pkg-1.6.38" = _5fc8eZA5;
        "pkg-1.6.39" = _O00vwQiD;
        "pkg-1.6.40" = _8ICzRTyD;
        "pkg-1.6.41" = _L6HOPCuH;
        "pkg-1.6.42" = _EGPQEKDZ;
        "pkg-1.6.43" = _pO10RLqS;
        "pkg-1.6.44" = _Up1GtOef;
        "pkg-1.6.45" = _skTA5voi;
        "pkg-1.6.46" = _zLmWxV3R;
        "pkg-1.6.47" = _ICR3AYVJ;
        "pkg-1.6.48" = _DR3mflag;
        "pkg-1.6.49" = _VVx4B4tk;
        "pkg-1.6.50" = _83u7OR9t;
        "pkg-1.6.51" = _KAcvnxiQ;
        "pkg-1.6.52" = _hYH2CL2p;
        "pkg-1.7" = _iiAXp0jw;
        "pkg-1.7.1" = _hVfB4Vrq;
        "pkg-1.7.2" = _85V7jrE8;
        "pkg-1.7.3" = _99GLNum5;
        ...
        "pkg-1.7.8" = _5mFdci2z;
        "pkg-1.7.9" = _xK008G7H;
        "pkg-1.7.10" = _YR02LjHj;
        "pkg-1.7.11" = _Rd9WZCEd;
        "pkg-1.7.12" = _KGan8jlc;
        "pkg-1.7.13" = _LYLtkBAe;
        "pkg-1.7.14" = _jeupmQMr;
        "pkg-1.7.15" = _ahfKEIJ5;
        "pkg-1.7.16" = _zYskU9Pv;
        "pkg-1.7.17" = _d8JM3YzL;
        "pkg-1.7.18" = _kvd3V3uo;
        "pkg-1.7.18.1" = _ULb37gY8;
        "pkg-1.7.19" = _mqi3s2ov;
        "pkg-1.7.19.1" = _ZoXIdn3V;
        "pkg-1.7.20" = _j5mQcITz;
        "pkg-1.7.21" = _zhIF0bk7;
        "pkg-1.7.22" = _U3AEZIFZ;
        "pkg-1.7.23" = _gCO1sAOE;
        "pkg-1.7.20.1" = _WSzFxsSN;
        "pkg-1.7.20.2" = _6bwuc6gh;
        "pkg-1.7.23.1" = _yaz9EdKI;
        "pkg-1.7.23.2" = _pknQtnEz;
        "pkg-1.7.20.3" = _MYcsRSLw;
        "pkg-1.7.23.3" = _PQIhsmr4;
        "pkg-1.7.20.4" = _skuuzO1E;
        "pkg-1.7.23.4" = _1evKP65c;
        "pkg-8.0" = _CNPI7x6c;
        "pkg-8.0.1" = _DzJ9yieU;
        "pkg-8.1april" = _REvNPixV;
        "pkg-8.1.1" = _3cv3RYvw;
        "pkg-8.1.2" = _4YSKA6qr;
        "pkg-1.7.20.5" = _aDv9Kk0i;
        "pkg-1.7.20.6" = _w3u7CsUt;
        "pkg-1.7.20.7" = _WYWtKguT;
        "pkg-8.1.3" = _34FvC0RH;
        "pkg-1.7.20.8" = _x0wHXD2W;
        "pkg-1.7.20.9" = _3mD2OyxW;
        "pkg-8.2" = _21fH6H6Z;
