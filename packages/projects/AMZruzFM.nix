...
let
    ...
    in {
        ...
        "pkg-v1.0.0-beta4" = _Rmkcmsz8;
        "pkg-v1.0.0-beta5" = _wB9zYdFT;
        "pkg-v1.0.0" = _EGnP9wxG;
        "pkg-v1.0.0+mod" = _ByWiQLmM;
        "pkg-v1.0.1" = _8VCTZBkl;
        "pkg-v1.0.1+mod" = _tjF7Nvw5;
        "pkg-v1.1.0-beta1" = _wcMVNtF9;
        "pkg-v1.1.0-beta2" = _9w6RdkHU;
        "pkg-v1.0.2" = _mwT3bFAW;
        "pkg-v1.0.2+mod" = _dUNUGIMw;
        "pkg-v1.1.0-beta3" = _ndxQnygj;
        "pkg-v1.1.0-beta4" = _OGWXTGsR;
        "pkg-v1.1.0-beta5" = _8Is7YDcu;
        "pkg-v1.1.0-beta6" = _19Dfit2y;
        "pkg-v1.1.0-beta7" = _zMv3CoBh;
        "pkg-v1.1.0" = _QJKOSoUy;
        "pkg-v1.1.0+mod" = _ZBsc5gCU;
        "pkg-v1.2.0-alpha1" = _94p8fvXW;
        "pkg-v1.2.0-alpha2" = _WGzWkAAa;
        "pkg-v1.2.0" = _cECsACqD;
        "pkg-v1.2.0+mod" = _U6xoWW7U;
        "pkg-v1.3.0-beta1" = _sdyMOX3b;
        "pkg-v1.3.0-beta2" = _TwUTArzn;
        "pkg-v1.3.0-beta3" = _NciLVZsn;
        "pkg-v1.3.0-beta4" = _4J5HJwj8;
        "pkg-v1.3.0-beta5" = _KfjI8ptw;
        "pkg-v1.3.0-beta6" = _NmuHZLR9;
        "pkg-v1.3.0-beta7" = _wevTEgFT;
        "pkg-v1.3.0-beta8" = _H0CRPyTb;
        "pkg-v1.3.0-beta9" = _wihfXmm9;
        "pkg-v1.3.0-beta10" = _cU1sriqs;
        "pkg-v1.3.0-beta11" = _WnlBD5Re;
        "pkg-v1.3.0" = _1cBkIT0E;
        "pkg-v1.3.0+mod" = _8LTTtqdW;
        "pkg-v1.3.1" = _8flWrFpE;
        "pkg-v1.3.1+mod" = _QMt1n9kr;
        "pkg-v2.0.0-beta1" = _PrDz2q4T;
        "pkg-v2.0.0-beta2" = _woZuXEIU;
        "pkg-v2.0.0-beta3" = _dPeISKBs;
        "pkg-v2.0.0-beta4" = _AL6YntOv;
        "pkg-v2.0.0-beta5" = _CPmAB6rO;
        "pkg-v2.0.0" = _anGbNGzD;
        "pkg-v2.0.0+mod" = _8M1Wfqkt;
        "pkg-v2.1.0-beta1" = _jzmuuVfa;
        "pkg-v2.1.0-beta2" = _DSoZWk4t;
        "pkg-v2.1.0-beta3" = _61wu6TXb;
        "pkg-v2.1.0-beta4" = _HicDnTX3;
        "pkg-v2.1.0-beta5" = _O7wwwiS3;
        "pkg-v2.1.0-beta6" = _ZOABUrTn;
        "pkg-v2.1.0-beta7" = _zcbkojyf;
        "pkg-v2.1.0-beta8" = _plpmdW3C;
        "pkg-v2.1.0-beta9" = _eweW7cVv;
        "pkg-v2.1.0-beta10" = _JswRaivM;
        "pkg-v2.1.0-pre1" = _JYARHKT9;
        "pkg-v2.1.0-pre2" = _fRtrE7oY;
        "pkg-v3.0.0-pre1" = _JmVR9pFT;
        "pkg-v3.0.0" = _2QFOHZtH;
        "pkg-v3.0.0+mod" = _g6Lp0fEI;
        "pkg-v3.1.0-beta1" = _rHTX8ggq;
        "pkg-v3.1.0" = _R7sBu1xJ;
        "pkg-v3.1.0+mod" = _exeBXvwS;
        "pkg-v3.2.0-beta1" = _kQG351OF;
        "pkg-v3.2.0-beta2" = _NIqq20es;
        "pkg-v3.2.0-beta3" = _mOaoNJyL;
        "pkg-v3.2.0-beta4" = _clZi4lIl;
        "pkg-v3.1.0+forge" = _u2CtgD72;
        "pkg-v3.2.0-beta5" = _dSdscD5Q;
        "pkg-v3.2.0-pre1" = _4fDJBDgs;
        "pkg-v3.2.0-pre2" = _5T549ZbZ;
        "pkg-v3.2.0-pre3" = _fkLuvFj3;
        "pkg-v3.2.0-pre4" = _oLWrpQ0Y;
        "pkg-v3.2.0" = _SV8dJKdI;
        "pkg-v3.2.0+mod" = _lE42q8Kt;
        "pkg-v3.2.1-pre1" = _c49HHOCC;
        "pkg-v3.2.1" = _BPPLMRxx;
        "pkg-v3.2.1+mod" = _TjFIicZK;
        "pkg-v3.2.2-pre1" = _nYxa81SL;
        "pkg-v3.2.2" = _wbZvm0xT;
        "pkg-v3.2.2+mod" = _G883XuBc;
        "pkg-v3.3.0-beta1" = _bMD4OAUA;
        "pkg-v3.3.0-beta2" = _z2wEHgaL;
        "pkg-v4.0.0-beta1" = _aEwMBwDZ;
        "pkg-v4.0.0-beta2" = _Atuv2nvp;
        "pkg-v4.0.0-beta3" = _jsoGU5RK;
        "pkg-v4.0.0-beta4" = _rTZaSi7V;
        "pkg-v4.0.0-pre1" = _btPkayP0;
        "pkg-v4.0.0-pre2" = _Su3XIENZ;
        "pkg-v4.0.0-pre3" = _v2eHC9e9;
        "pkg-v4.0.0-pre4" = _1nssPiLc;
        "pkg-v4.0.0" = _EjlgQVxY;
        "pkg-v4.0.0+mod" = _hP55kDap;
        "pkg-v4.0.1+mod" = _gMYrBZrk;
        "pkg-v4.1.0-beta1" = _8CFlVSU1;
        "pkg-v4.1.0-beta2" = _dCecelMW;
        "pkg-v4.1.0-beta3" = _P1qUFhLA;
        "pkg-v4.1.0-beta4" = _bUvPEL9a;
        "pkg-v4.1.0-beta5" = _qiJwbDuK;
        "pkg-v4.1.0-beta6" = _nLHB89IV;
        "pkg-v4.1.0-pre1" = _UIxdEXob;
        "pkg-v4.1.0" = _99d2kwry;
        "pkg-v4.1.0+mod" = _HVb5eTYO;
        "pkg-v4.2.0-beta1" = _GyTNj8sF;
        "pkg-v4.2.0-beta2" = _v9bDBIxI;
        "pkg-v4.2.0-beta3" = _4FCEraRX;
        "pkg-v4.2.0-beta4" = _Zfgajoof;
        "pkg-v4.2.0-beta5" = _ELhgYBHh;
        "pkg-v4.2.0-pre1" = _PgXzLP9b;
        "pkg-v4.2.0-pre2" = _u5fWnPus;
        "pkg-v4.2.0-pre3" = _Z3fkafQN;
        "pkg-v4.2.0-pre4" = _Bpxh9fzX;
        "pkg-v4.2.0" = _Lg9N5gVD;
        "pkg-v4.2.0+mod" = _Ew5I5lfh;
        "pkg-v4.2.1+mod" = _uOS7KnKO;
        "pkg-v4.3.0-pre.1" = _aY1Fn0tT;
        "pkg-v4.3.0-pre.2" = _VYYq7L9X;
        "pkg-v4.3.0" = _WTK87Drn;
        "pkg-v4.3.0+mod" = _rxFTRiVs;
        "pkg-v4.3.1" = _lUfA1652;
        "pkg-v4.3.1+mod" = _oVpaJYK7;
