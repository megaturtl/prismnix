...
let
    versions = (let
        ...
        _WpaZr42U = {
            "id" = "WpaZr42U";
            "file" = "CrazyCrates-26.1.2-37fff31.jar";
            "hash" = "sha512-2iRNGykmUxhjzmyCw1i6cZG3zuRTrWpPyVCAFeATNe8z0Y8CXR/fUxq9HYsmXfi3/YBlns6WoHoUAkykhhMx+A==";
        };
        _AXYd6Uhq = {
            "id" = "AXYd6Uhq";
    ...
    in {
        ...
        "pkg-1.14" = _tmR5Jpwg;
        "pkg-1.16" = _LI36nJSP;
        "pkg-1.16.1" = _29fmdaiz;
        "pkg-1.16.2" = _9QcDyLfk;
        "pkg-1.16.3" = _WQ74hclg;
        "pkg-1.16.4" = _lq108RYq;
        "pkg-1.17" = _rHPFSaER;
        "pkg-1.17.1" = _lIe9S4v7;
        "pkg-1.18" = _2WHcQ4Mt;
        "pkg-1.18.1" = _NRmlIbn9;
        "pkg-1.18.2" = _eYoeNDDR;
        "pkg-1.18.3" = _cDPo3PUF;
        "pkg-1.18.4" = _4XskbyQT;
        "pkg-1.18.5" = _IKDMMjgz;
        "pkg-1.19" = _1Vg6K7on;
        "pkg-1.19.1" = _6Pfj1ia6;
        "pkg-1.19.2" = _gF59dDMr;
        "pkg-1.19.3" = _JX1zNzxP;
        "pkg-1.20" = _OeBLLi4s;
        "pkg-1.20.1" = _PNIS23hh;
        "pkg-1.20.2" = _jOjWRL78;
        "pkg-1.21" = _TmodHuZB;
        "pkg-1.22" = _9LNes69Z;
        "pkg-2.0" = _ZwxpAmxR;
        "pkg-2.0.1" = _2q9k3cxC;
        ...
        "pkg-4.9.7" = _LQRMaye1;
        "pkg-4.9.8" = _ynUimABp;
        "pkg-4.10.0" = _n3dx2wA0;
        "pkg-4.10.1" = _ekeRew5R;
        "pkg-4.10.2" = _PvpLPwR2;
        "pkg-4.10.3" = _BrRXIy7y;
        "pkg-4.10.4" = _lSo8cfmB;
        "pkg-4.10.5" = _YoSaCBh4;
        "pkg-1.21.5-b1690a9" = _DOCvcmjQ;
        "pkg-1.21.5-5e4acb6" = _Cig5aEJ1;
        "pkg-1.21.5-d567691" = _72pJVPMv;
        "pkg-1.21.5-fa4ba52" = _mMbDpMGE;
        "pkg-1.21.7-530c60b" = _l8JrdGNi;
        "pkg-1.21.7-5654508" = _Bki80HRO;
        "pkg-1.21.7-31b2b5f" = _onmpA8gJ;
        "pkg-1.21.7-6e8e663" = _RTwZxnAC;
        "pkg-1.21.7-8894d22" = _JvWVCRNv;
        "pkg-1.21.7-7c3b2f2" = _pTdbySvg;
        "pkg-1.21.7-0e139f6" = _MAagv6Fe;
        "pkg-1.21.7-55af5e1" = _BYR25fHC;
        "pkg-1.21.7-4241727" = _EekgNByL;
        "pkg-1.21.7-13968e3" = _ADwI6OgD;
        "pkg-1.21.7-ea710bf" = _faa1qVtl;
        "pkg-1.21.7-e1530d1" = _w0RHLHkR;
        "pkg-1.21.7-a81d617" = _knJW43Hr;
        "pkg-1.21.7-5eec53b" = _hiYUjwzM;
        "pkg-1.21.7-95de41e" = _bihszUWK;
        "pkg-1.21.7-91507b3" = _9ncS7Ffg;
        "pkg-1.21.7-ecef83e" = _DyEcvqTH;
        "pkg-1.21.7-3af2d36" = _Hfd8La5r;
        "pkg-1.21.7-bc92cef" = _JmcVObWv;
        "pkg-1.21.7-68ecd37" = _a1FVNVvT;
        "pkg-1.21.7-1efdceb" = _ZZ58P6L8;
        "pkg-1.21.7-876f3a7" = _b8hK0g4b;
        "pkg-1.21.8-c0b8105" = _53Uw6Ju0;
        "pkg-1.21.8-f2c5fbd" = _nffJWDpT;
        "pkg-1.21.8-f99bb83" = _FgVDnpSg;
        "pkg-1.21.8-6c580b1" = _1vFKnUCO;
        "pkg-1.21.8-e3d85d5" = _8LosDHCB;
        "pkg-1.21.8-496e4d0" = _CskrCxnn;
        "pkg-1.21.8-1ef6553" = _YxoLUHjx;
        "pkg-1.21.8-5cfc069" = _EOTlqIY5;
        "pkg-1.21.8-b92b47f" = _SDrt8OpL;
        "pkg-1.21.8-2e73bce" = _2fwzuiWo;
        "pkg-1.21.8-fde1b0e" = _yspMXBQB;
        "pkg-5.0.0" = _ua0RfxnL;
        "pkg-5.1.0" = _4ZnGU9oe;
        "pkg-5.2.0" = _KIO68I3K;
        "pkg-26.1.2-e58fa51" = _y1PiRVAP;
        "pkg-26.1.2-3fa5077" = _3nwo5Xlx;
        "pkg-26.1.2-1773a7b" = _DtF8Yavv;
        "pkg-26.1.2-98ad8b7" = _RiUVpjI4;
        "pkg-26.1.2-eef5c93" = _gCxf76rQ;
        "pkg-26.1.2-d9188a1" = _NuZ1nNwR;
        "pkg-26.1.2-0339f8a" = _Oz918TLn;
        "pkg-26.1.2-798bebf" = _xa9H6igL;
        "pkg-26.1.2-c409b6f" = _MwSXuomT;
        "pkg-26.1.2-ab23adf" = _vjcajlWp;
        "pkg-26.1.2-ff9a9f1" = _xyE9RiCH;
        "pkg-26.1.2-063f0c3" = _Syubfhb8;
        "pkg-26.1.2-3a11073" = _Qnq8YlAC;
