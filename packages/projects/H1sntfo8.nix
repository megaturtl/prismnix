...
let
    ...
    in {
        ...
        "pkg-1.5.2" = _FDyptF3C;
        "pkg-1.5.3" = _h74EaSxg;
        "pkg-1.19.3-1.5.5" = _tgvSxMbz;
        "pkg-1.19.2-1.5.5" = _m5FPm7qd;
        "pkg-1.5.6" = _VKAaGaUt;
        "pkg-1.19.4-1.5.7" = _8FhU0wlh;
        "pkg-1.19.2-1.5.6" = _CuWQRWRh;
        "pkg-1.20-1.6.0" = _ZkNhijwC;
        "pkg-1.20-1.6.1" = _d6rBM4Cg;
        "pkg-1.19.2-1.5.7" = _FJBvRpmS;
        "pkg-1.19.4-1.5.8" = _cwxNfyOe;
        "pkg-1.19.2-1.5.8" = _F2iGn9UV;
        "pkg-1.20-1.6.2" = _a6unnpep;
        "pkg-1.20.2-1.6.2" = _V3WwPGO0;
        "pkg-1.20.2-1.6.3" = _e2O5TKqU;
        "pkg-1.20.1-1.6.3" = _APAV3nRX;
        "pkg-2.0.0-1.20.2" = _HaGxOuRA;
        "pkg-1.4.4" = _MUAGK1gz;
        "pkg-2.1.0-1.20.4" = _wXjGQwVf;
        "pkg-1.20.1-1.6.4" = _bhwMZR6g;
        "pkg-1.19.2-1.5.9" = _ZXYzy1iR;
        "pkg-1.2.6" = _7XuY8OQc;
        "pkg-1.3.4" = _dYJvXrpF;
        "pkg-2.1.1-1.20.5" = _kKMVQLRQ;
        "pkg-1.20.1-1.6.5" = _C2Kx5KoF;
        "pkg-1.20.1-1.6.6" = _svrJar40;
        "pkg-2.2.0" = _NaRcOcdo;
        "pkg-2.2.1" = _cLa2Yytt;
        "pkg-2.2.2" = _kDn8OMEB;
        "pkg-2.2.3" = _YUTg8nC4;
        ...
        "pkg-2.2.8" = _rocAIuYg;
        "pkg-2.3.0" = _uHliNr9t;
        "pkg-1.20.1-1.6.7" = _gPD6mgz1;
        "pkg-1.20.1-1.6.8" = _G2pTzVgC;
        "pkg-2.3.1" = _1PMs4QzM;
        "pkg-1.20.1-1.6.9" = _ODTISfiX;
        "pkg-2.3.2" = _cXW6pA2s;
        "pkg-1.20.1-1.6.10" = _SPPdFnqa;
        "pkg-1.20.1-1.6.11" = _88t2ts1p;
        "pkg-2.4.0" = _wYVoSIcs;
        "pkg-1.20.1-1.6.12" = _QZFG7iOy;
        "pkg-2.4.1" = _DfutgKjh;
        "pkg-1.20.1-1.6.13" = _7qH0sa3f;
        "pkg-2.4.2" = _gSZutyse;
        "pkg-1.6.14" = _EroqH5tO;
        "pkg-2.4.3" = _eouNG3Jg;
        "pkg-2.4.4" = _Wu0L3vOF;
        "pkg-1.6.15" = _X9vvanaD;
        "pkg-2.4.5" = _Ny0tyzZ5;
        "pkg-1.6.16" = _9FV3nsJb;
        "pkg-2.4.6" = _Ajq2RkBN;
        "pkg-1.6.17" = _ZneIsMJ5;
        "pkg-2.4.7" = _TP9ZaQc3;
        "pkg-3.0.0" = _DQOSFkWL;
        "pkg-3.0.1" = _FIHOh4yU;
        "pkg-3.0.2" = _RHiEDjYe;
