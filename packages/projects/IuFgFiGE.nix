...
let
    ...
    in {
        ...
        "pkg-1.4.1" = _CSXsl6Kd;
        "pkg-1.4.2" = _76PLuGOQ;
        "pkg-1.18.2-2.0.0-forge" = _8MmdTYgx;
        "pkg-1.18.2-2.0.0-fabric" = _IRmNj2S0;
        "pkg-1.18.2-2.0.1-forge" = _pOvFr7tz;
        "pkg-1.18.2-2.0.1-fabric" = _a6H6H42v;
        "pkg-1.18.2-2.0.2-fabric" = _jAk20GTk;
        "pkg-1.18.2-2.0.2-forge" = _KHdnnMtM;
        "pkg-1.19.2-2.0.2-forge" = _2Z9LxNFc;
        "pkg-1.19.2-2.0.2-fabric" = _RrtK5uQm;
        "pkg-1.20.1-2.0.2-forge" = _KiJSOqbI;
        "pkg-1.20.1-2.0.2-fabric" = _l5kHmkHB;
        "pkg-1.18.2-2.1.0-fabric" = _G0gBXIeG;
        "pkg-1.18.2-2.1.0-forge" = _GWCzSbFg;
        "pkg-1.19.2-2.1.0-fabric" = _JiMDQVBY;
        "pkg-1.19.2-2.1.0-forge" = _DSiq2Fxn;
        "pkg-1.20.1-2.1.0-fabric" = _gcrPF6fl;
        "pkg-1.20.1-2.1.0-forge" = _hSQCsbAa;
        "pkg-1.18.2-2.1.1-fabric" = _rSpOXJPM;
        "pkg-1.18.2-2.1.1-forge" = _n4NVuY1j;
        "pkg-1.19.2-2.1.1-fabric" = _9txQnsd6;
        "pkg-1.19.2-2.1.1-forge" = _zkOeTkJz;
        "pkg-1.20.1-2.1.1-fabric" = _WZy6KpUB;
        "pkg-1.20.1-2.1.1-forge" = _WmdsVQef;
        "pkg-1.20.1-2.2.0-fabric" = _LpBLroNf;
        "pkg-1.20.1-2.2.0-forge" = _kXlkiV9T;
        "pkg-1.20.1-2.2.1-fabric" = _2QUXPaME;
        "pkg-1.20.1-2.2.1-forge" = _yuhAt8r6;
        "pkg-1.20.1-2.2.2-fabric" = _DV7y9ZUl;
        "pkg-1.20.1-2.2.2-forge" = _eJJNwguo;
        "pkg-1.20.1-3.0.0-fabric" = _9CQdwBCo;
        "pkg-1.20.1-3.0.0-forge" = _ixXWWGYU;
        "pkg-1.20.1-3.0.1-fabric" = _uDEhPGRa;
        "pkg-1.20.1-3.0.1-forge" = _PO0O1zG3;
        "pkg-1.20.1-3.1.0-forge" = _N4ncWIfP;
