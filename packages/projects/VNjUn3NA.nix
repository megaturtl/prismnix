...
let
    versions = (let
        ...
        _YxscuQ0q = {
            "id" = "YxscuQ0q";
            "file" = "seasonhud-forge-1.16.5-2.0.9.jar";
            "hash" = "sha512-2O2bXq1fDxvw4M5kGlGBuPn6yYe++B+Q/AFq48dQscUJjSJhQ3JQLLFxC1V4wspU6YaBHaoa4HsyhWCgI12GMQ==";
        };
        _5JhT6pSI = {
            "id" = "5JhT6pSI";
            "file" = "seasonhud-forge-1.18.2-2.0.9.jar";
            "hash" = "sha512-6krs3iCkjzPmVhQGCofkXgFO2wiNIbexB+cpvEA6ZJjTjZ0CCx2nq0j7gx9rZbA71YMEGZUuMcid1pXCv/YNoQ==";
        };
        _Sm5cReUn = {
            "id" = "Sm5cReUn";
            "file" = "seasonhud-forge-1.19.2-2.0.9.jar";
            "hash" = "sha512-bRHH869kugCA8uqKhod8Qwz8O6t0Gqvkd/tiQlJja6kDt9yUciuWVWYpU4sswbd7kUQ/wMcBHYAgEcZ9HIlysg==";
        };
        _jJmLpXVl = {
            "id" = "jJmLpXVl";
            "file" = "seasonhud-forge-1.20.1-2.0.9.jar";
            "hash" = "sha512-H6Ees+k07h17juUAtuImD4X7VdBKfiZvfURo/AXw2IbqmldLZi/ItieLVOi+Nx6Azc4X+U0RbAzHlH3ZuGhaMA==";
        };
        _gHe9OMSd = {
            "id" = "gHe9OMSd";
            "file" = "SeasonHud-forge-1.21.1-2.0.9.jar";
            "hash" = "sha512-P0hKPW8gtp/MIaFizcrOA4mkZwtMNMnZhqq6fpasgtkWBJ68CEulBT28A05GQrrZQvpeWqXC9ZKKtmcl9wr+Nw==";
        };
        _ASnbiK9f = {
            "id" = "ASnbiK9f";
            "file" = "seasonhud-neoforge-1.21.1-2.0.9.jar";
            "hash" = "sha512-zykZtxbwfQhLhtqU6L/JFVTCvHSwHGYTMxf0jjc5Cw9mIzkkGA46x2P8RzlxoFl8v/reQqUpAqI4I0JKNRbJ4Q==";
        };
        _B2MayJlr = {
            "id" = "B2MayJlr";
            "file" = "seasonhud-neoforge-26.1.2-2.0.9.jar";
            "hash" = "sha512-B1dF2H1YmV72uQSXf0WsYXFfXCDywCCp0YKph9rOzIhe0/Iz5YhclzfjAKbXqPyPklcKNwgpG3oflS7SIy5UGw==";
        };
        _Zq3ESFLz = {
            "id" = "Zq3ESFLz";
            "file" = "seasonhud-neoforge-26.2-2.0.9.jar";
            "hash" = "sha512-AeADFGUTu3ZtafbatALmzpcFlb8lzdr9nqU55Gtzd5BWiCewCtDXC9Ii2t8QiLfdM49czhcwG2dNsraJIUi4eg==";
        };
        _x4E7l7Kc = {
            "id" = "x4E7l7Kc";
            "file" = "seasonhud-forge-1.16.5-2.0.10.jar";
            "hash" = "sha512-ljyRFhl+j0DG0G67yo5PEIMBlSIgQn+lljhgfpDoh0TtwC4swu6ynybzMXFZ4uYlNlrbhXzaW4w8+yPMQrMp2Q==";
        };
        _QgVZvIOA = {
            "id" = "QgVZvIOA";
            "file" = "seasonhud-forge-1.18.2-2.0.10.jar";
            "hash" = "sha512-Rh00m0B5xmMAHRUqnXSnAWSsXTpdY8vaM2lqdA1QdSu7UERyKDlti3Tv/gSDXtwDtRsozawvyEEPpRiPDODNdg==";
        };
        _XKOn80oE = {
            "id" = "XKOn80oE";
            "file" = "seasonhud-forge-1.19.2-2.0.10.jar";
            "hash" = "sha512-H5uyVJXQPCIpucyiGdgC3m5kovBF+lGi1eIR0U89Im1d7NaWnf+6Wyp7x532XuLaAsuo2bNmOGKqMF2n46IT/w==";
        };
        _Cdu2Rh8P = {
            "id" = "Cdu2Rh8P";
            "file" = "seasonhud-forge-1.20.1-2.0.10.jar";
            "hash" = "sha512-t5YjOKmyVjz+NyhgvQt7L637i1j0kgS8fqYkQVw1HOzzm6iTohZYKeVHicsAkRVbCrv1xsbjnWONw6XWFtZUeg==";
        };
        _9njR3sfa = {
            "id" = "9njR3sfa";
            "file" = "SeasonHud-forge-1.21.1-2.0.10.jar";
            "hash" = "sha512-v6bEoOXIt20nTjS0C+Ad6m2tYugDlKL1SacuRd2VK8MlPYijrvq+1kJ/PgFlmQ7nke6wR97UpSVWpo6lNDUoOA==";
        };
        _2vmfujjt = {
            "id" = "2vmfujjt";
            "file" = "seasonhud-neoforge-1.21.1-2.0.10.jar";
            "hash" = "sha512-k3Wlw6eWugmwilXIsW7jt5pN3gXSzYXY65waxpG+YqcYfScIunN1MkAO4D+8cjXz7+fZUslVTSuF3KHrWZ31Zg==";
        };
        _CiXxtoOU = {
            "id" = "CiXxtoOU";
            "file" = "seasonhud-neoforge-26.1.2-2.0.10.jar";
            "hash" = "sha512-76Vcz7zMjvcxvxW+IY6L1wR2pNdLcKdIR3LZ2b9Ah7ukPSxcWMjEAspJl3kDxAiz93z3cGM4BEHDICC4hsNzDw==";
        };
        _Ul8LQLSQ = {
            "id" = "Ul8LQLSQ";
    ...
    in {
        ...
        "forge-1.19.3" = _XKOn80oE;
        "forge-1.19.4" = _XKOn80oE;
        "forge-1.20" = _Cdu2Rh8P;
        "forge-1.20.1" = _Cdu2Rh8P;
        "forge-1.20.2" = _tWhYW1YV;
        "forge-1.20.4" = _23OmondH;
        "forge-1.20.3" = _tWhYW1YV;
        "forge-1.20.5" = _O4RyaFEc;
        "forge-1.20.6" = _O4RyaFEc;
        "forge-1.21" = _9njR3sfa;
        "forge-1.21.1" = _9njR3sfa;
        ...
        "neoforge-1.20" = _Cdu2Rh8P;
        "neoforge-1.20.1" = _Cdu2Rh8P;
        ...
        "neoforge-1.21" = _2vmfujjt;
        "neoforge-1.21.1" = _2vmfujjt;
        ...
        "pkg-1.19.3-1.4.9" = _5J64JJFJ;
        "pkg-1.16.5-1.4.10" = _fgfeAwkF;
        "pkg-1.18.2-1.4.10" = _S1qLx5xp;
        "pkg-1.19.2-1.4.10" = _rFo2UqMs;
        "pkg-1.19.3-1.4.10" = _8WJfPxGg;
        "pkg-1.19.4-1.4.10" = _tvsKBQke;
        "pkg-1.16.5-1.4.11" = _UdLQsYnB;
        "pkg-1.18.2-1.4.11" = _uPtvl4Jg;
        "pkg-1.19.3-1.4.11" = _F6kYwANx;
        "pkg-1.19.4-1.4.11" = _pVf2M33j;
        "pkg-1.19.2-1.4.11" = _SEG09vUu;
        "pkg-1.16.5-1.4.12" = _A6WJxFP4;
        "pkg-1.19.2-1.4.12" = _ka8gW3Kc;
        "pkg-1.18.2-1.4.12" = _KJ9eEVqP;
        "pkg-1.19.4-1.4.12" = _sCDKCVf5;
        "pkg-1.19.3-1.4.12" = _OKb5zxYw;
        "pkg-1.16.5-1.4.13" = _mYcgmDC8;
        "pkg-1.18.2-1.4.13" = _eVjiJRaO;
        "pkg-1.19.2-1.4.13" = _Jo465uWS;
        "pkg-1.19.4-1.4.13" = _m45kGYOv;
        "pkg-1.19.3-1.4.13" = _jUZ3byyN;
        "pkg-1.16.5-1.4.14" = _zTYste3B;
        "pkg-1.18.2-1.4.14" = _5HzT5Ib0;
        "pkg-1.19.2-1.4.14" = _F8G7ivkA;
        "pkg-1.19.3-1.4.14" = _xbrCgQhC;
        "pkg-1.19.4-1.4.14" = _PGhhCkCw;
        "pkg-1.16.5-1.4.15" = _KAeTpygR;
        "pkg-1.18.2-1.4.15" = _WpM6ahWE;
        "pkg-1.19.2-1.4.15" = _fjhLfQly;
        "pkg-1.19.3-1.4.15" = _uAmqvhqa;
        "pkg-1.19.4-1.4.15" = _HEEEaM5o;
        "pkg-1.16.5-1.4.16" = _lNQiaroc;
        "pkg-1.18.2-1.4.16" = _brUm4jnu;
        "pkg-1.19.3-1.4.16" = _XwyDeTGT;
        "pkg-1.19.2-1.4.16" = _tzik1i7x;
        "pkg-1.19.4-1.4.16" = _8KKEwiIC;
        "pkg-1.16.5-1.4.17" = _J76h2AEz;
        "pkg-1.18.2-1.4.17" = _6HLn7iJ7;
        "pkg-1.19.2-1.4.17" = _wG4ynz65;
        "pkg-1.19.3-1.4.17" = _dnDlQ91J;
        "pkg-1.19.4-1.4.17" = _RFpCykEU;
        "pkg-1.16.5-1.4.18" = _ga1gjC6O;
        "pkg-1.18.2-1.4.18" = _tzErIzEA;
        "pkg-1.19.2-1.4.18" = _KwOClSls;
        "pkg-1.19.4-1.4.18" = _r0Ryw4uc;
        "pkg-1.20-1.4.18" = _3ivfZ71Q;
        "pkg-1.19.2-1.4.19" = _oqviWwqb;
        "pkg-1.20.1-1.4.19" = _a6hebg8b;
        "pkg-1.20.1-1.4.20" = _9YGyBDCz;
        "pkg-1.19.2-1.5.0" = _yF986etu;
        "pkg-1.19.4-1.5.0" = _QmCQSXg7;
        "pkg-1.19.2-1.5.1" = _VVNrAuRU;
        "pkg-1.19.4-1.5.1" = _mVNnMKSq;
        "pkg-forge-1.20.1-1.5.1" = _ZGuS8CvY;
        "pkg-1.19.2-1.5.2" = _xg7aXUD0;
        "pkg-1.19.4-1.5.2" = _uZ0Sofpm;
        "pkg-forge-1.20.1-1.5.2" = _UTTOhP58;
        "pkg-1.19.2-1.5.3" = _kVyzLpuq;
        "pkg-1.19.4-1.5.3" = _bZujuqaF;
        "pkg-forge-1.20.1-1.5.3" = _WNKAM4y0;
        "pkg-1.19.2-1.5.4" = _btvm0J5p;
        "pkg-1.19.4-1.5.4" = _N2Q2M0C3;
        "pkg-forge-1.20.1-1.5.4" = _AGlialKe;
        "pkg-1.19.2-1.5.5" = _avfRnqQH;
        "pkg-1.19.4-1.5.5" = _zOfl4ZZi;
        "pkg-forge-1.20.1-1.5.5" = _CDGPPpVT;
        "pkg-1.19.4-1.5.6" = _2dZ4ZLdP;
        "pkg-1.19.2-1.5.6" = _rRzUJBy6;
        "pkg-forge-1.20.1-1.5.6" = _eVqGBcet;
        "pkg-1.16.5-1.4.19" = _Eb5cXptO;
        "pkg-1.16.5-1.4.20" = _S9UOaY15;
        "pkg-1.20.1-1.5.7" = _6eKfaSHL;
        "pkg-1.19.2-1.5.8" = _jkz5WOSA;
        "pkg-1.19.4-1.5.8" = _jMx5aQNE;
        "pkg-1.20.1-1.5.8" = _NGLlchRT;
        "pkg-1.19.2-1.5.9" = _mB40zW0p;
        "pkg-1.19.4-1.5.9" = _SuMfnCrR;
        "pkg-1.20.1-1.5.9" = _EIUxje3H;
        "pkg-1.20.2-1.5.9" = _oDdgl7TK;
        "pkg-1.19.2-1.5.10" = _h7ECd6yo;
        "pkg-1.19.4-1.5.10" = _UAkXDQ3v;
        "pkg-1.20.1-1.5.10" = _4LX9UbZH;
        "pkg-1.20.2-1.5.10" = _slhVKdGW;
        "pkg-1.19.2-1.5.11" = _5dGYCb0v;
        "pkg-1.19.4-1.5.11" = _9nkJVb3W;
        "pkg-1.20.1-1.5.11" = _T1MQ8euU;
        "pkg-1.20.2-1.5.11" = _1d3ocopb;
        "pkg-1.19.2-1.5.12" = _fGzFKYwP;
        "pkg-1.19.4-1.5.12" = _CZ0MDdqf;
        "pkg-1.20.1-1.5.12" = _UCgIRv0y;
        "pkg-1.20.2-1.5.12" = _5ddeud4a;
        "pkg-1.19.2-1.5.13" = _AjGNdDrL;
        "pkg-1.19.4-1.5.13" = _q3cFWZkp;
        "pkg-1.20.1-1.5.13" = _BuXBxaZh;
        "pkg-1.20.2-1.5.13" = _pU2ulzq4;
        "pkg-1.19.2-1.6.0" = _eiOMYJxo;
        "pkg-1.19.4-1.6.0" = _JhMW78eV;
        "pkg-1.20.1-1.6.0" = _LHWmLZAK;
        "pkg-1.20.2-1.6.0" = _nDDet7eO;
        "pkg-1.19.2-1.6.1" = _RUNkOpMi;
        "pkg-1.19.4-1.6.1" = _PVHk9KsZ;
        "pkg-1.20.1-1.6.1" = _heSRDpZV;
        "pkg-1.20.2-1.6.1" = _zptaOT8X;
        "pkg-1.19.2-1.6.2" = _pvyjeKwz;
        "pkg-1.19.4-1.6.2" = _J1tPQdb0;
        "pkg-1.20.1-1.6.2" = _X62lEskc;
        "pkg-1.20.2-1.6.2" = _c30wfP4R;
        "pkg-1.18.2-1.6.3" = _cuXAsZVL;
        "pkg-1.19.2-1.6.3" = _6cq009HE;
        "pkg-1.20.1-1.6.3" = _RYw8QRAW;
        "pkg-1.20.2-1.6.3" = _DLuDr4Po;
        "pkg-1.18.2-1.6.4" = _h9FVC8mc;
        "pkg-1.19.2-1.6.4" = _S9eMveOO;
        "pkg-1.20.1-1.6.4" = _GOlwo0X9;
        "pkg-1.20.2-1.6.4" = _fFdoqCbm;
        "pkg-1.18.2-1.7.0" = _DTCyveGP;
        "pkg-1.19.2-1.7.0" = _hw8rLpVc;
        "pkg-1.20.1-1.7.0" = _6TCUteJ1;
        "pkg-1.20.2-1.7.0" = _tKSwP2UR;
        "pkg-1.18.2-1.7.1" = _zggF9nkI;
        "pkg-1.19.2-1.7.1" = _HhwfpM0j;
        "pkg-1.20.1-1.7.1" = _t32PPQmB;
        "pkg-1.20.2-1.7.1" = _TZKN5036;
        "pkg-1.18.2-1.7.2" = _E2SAAVW6;
        "pkg-1.19.2-1.7.2" = _6SByvbPF;
        "pkg-1.20.1-1.7.2" = _8taWpey5;
        "pkg-1.20.2-1.7.2" = _pwBcoWs8;
        "pkg-1.18.2-1.7.3" = _Aiy9JWeB;
        "pkg-1.19.2-1.7.3" = _RQDiQfXC;
        "pkg-1.20.1-1.7.3" = _zSi4IIpm;
        "pkg-1.20.2-1.7.3" = _Y2LOW6Hd;
        "pkg-1.18.2-1.7.4" = _CzQBVA1i;
        "pkg-1.19.2-1.7.4" = _UjSoXrw4;
        "pkg-1.20.1-1.7.4" = _ROmRBUpD;
        "pkg-1.20.2-1.7.4" = _39ynAZUn;
        "pkg-1.18.2-1.7.5" = _hEO6Apil;
        "pkg-1.19.2-1.7.5" = _M2tQMikD;
        "pkg-1.20.1-1.7.5" = _nRzJ3Vw9;
        "pkg-1.20.2-1.7.5" = _uGmQS3D3;
        "pkg-1.18.2-1.7.6" = _dFdS5Urc;
        "pkg-1.19.2-1.7.6" = _56asVdON;
        "pkg-1.20.1-1.7.6" = _6tp7Vr4E;
        "pkg-1.20.2-1.7.6" = _vkZarA23;
        "pkg-1.18.2-1.7.7" = _b4Vwh58m;
        "pkg-1.19.2-1.7.7" = _qVkAIW9d;
        "pkg-1.20.1-1.7.7" = _pcOda6qv;
        "pkg-1.20.2-1.7.7" = _GiCly7YQ;
        "pkg-1.18.2-1.7.8" = _BVcfxYI4;
        "pkg-1.19.2-1.7.8" = _TFNTWdEg;
        "pkg-1.20.1-1.7.8" = _K7y6HCI4;
        "pkg-1.20.2-1.7.8" = _CQUJZrlD;
        "pkg-1.18.2-1.7.9" = _6ZRG8kta;
        "pkg-1.19.2-1.7.9" = _ZzQkOvlS;
        "pkg-1.20.1-1.7.9" = _ttQNviOg;
        "pkg-1.20.2-1.7.9" = _sAKMZ47b;
        "pkg-1.18.2-1.7.10" = _QdLZrqIt;
        "pkg-1.19.2-1.7.10" = _ltv1ckNY;
        "pkg-1.20.1-1.7.10" = _jkWKPE4E;
        "pkg-1.20.2-1.7.10" = _POBu8qmf;
        "pkg-1.20.4-1.7.10" = _poCDGCEV;
        "pkg-1.18.2-1.7.11" = _EYkNjzjY;
        "pkg-1.19.2-1.7.11" = _eqDkRkDl;
        "pkg-1.20.1-1.7.11" = _PM347GP7;
        "pkg-1.20.2-1.7.11" = _PDGkFMq4;
        "pkg-1.20.4-1.7.11" = _ZlEv4HJ0;
        "pkg-1.18.2-1.7.12" = _DPC34LJ9;
        "pkg-1.19.2-1.7.12" = _D1KWKsWZ;
        "pkg-1.20.1-1.7.12" = _Dmv5TIOy;
        "pkg-1.20.2-1.7.12" = _vUXuKbHV;
        "pkg-1.20.4-1.7.12" = _1Daai1j8;
        "pkg-1.18.2-1.7.13" = _CQtc6ZM5;
        "pkg-1.19.2-1.7.13" = _ap7NLcH5;
        "pkg-1.20.1-1.7.13" = _u60iKowC;
        "pkg-1.20.2-1.7.13" = _TwuoR2DF;
        "pkg-1.20.4-1.7.13" = _YNWhPOUe;
        "pkg-1.18.2-1.7.14" = _ub6ryWKA;
        "pkg-1.19.2-1.7.14" = _ffsqp15o;
        "pkg-1.20.1-1.7.14" = _V5tszXt6;
        "pkg-1.20.2-1.7.14" = _btwF55bV;
        "pkg-1.20.4-1.7.14" = _5QCC17BT;
        "pkg-1.18.2-1.7.15" = _X726VyVP;
        "pkg-1.19.2-1.7.15" = _YqjT4g1O;
        "pkg-1.20.1-1.7.15" = _Il381WGb;
        "pkg-1.20.2-1.7.15" = _ExwtdQyg;
        "pkg-1.20.4-1.7.15" = _3Ga5YUNh;
        "pkg-1.18.2-1.7.16" = _rwx7DEfx;
        "pkg-1.19.2-1.7.16" = _uBjQVUiW;
        "pkg-1.20.1-1.7.16" = _cEY3bcp3;
        "pkg-1.20.2-1.7.16" = _eoWNPIo5;
        "pkg-1.20.4-1.7.16" = _bCfZAetn;
        "pkg-1.18.2-1.7.17" = _iv20912M;
        "pkg-1.19.2-1.7.17" = _ZIuxpfeb;
        "pkg-1.20.1-1.7.17" = _B3Mzn2uP;
        "pkg-1.20.4-1.7.17" = _20sfnsjt;
        "pkg-1.20.2-1.7.17" = _RJUMpDFz;
        "pkg-1.18.2-1.7.18" = _yybEDQkf;
        "pkg-1.19.2-1.7.18" = _IU5W6Cbz;
        "pkg-1.20.1-1.7.18" = _sUxNha3K;
        "pkg-1.20.2-1.7.18" = _rd9kmzXR;
        "pkg-1.20.4-1.7.18" = _X3baDDLr;
        "pkg-1.18.2-1.7.19" = _KOrvYiNB;
        "pkg-1.19.2-1.7.19" = _zbzqAfGF;
        "pkg-1.20.1-1.7.19" = _r00pD6Ex;
        "pkg-1.20.2-1.7.19" = _NaPAaJw5;
        "pkg-1.20.4-1.7.19" = _sRuOeUjq;
        "pkg-1.20.6-1.7.19" = _Ecg8yEBb;
        "pkg-1.18.2-1.8.0" = _FLtChhZ7;
        "pkg-1.19.2-1.8.0" = _yA4bCGrb;
        "pkg-1.20.1-1.8.0" = _mqqVXnVR;
        "pkg-1.20.2-1.8.0" = _4QLd8dZX;
        "pkg-1.20.4-1.8.0" = _2JZ9Hu6o;
        "pkg-1.20.6-1.8.0" = _eXB0Mp7J;
        "pkg-1.18.2-1.8.1" = _y2D9EyVz;
        "pkg-1.19.2-1.8.1" = _NWhNTT5r;
        "pkg-1.20.1-1.8.1" = _ViCelqnL;
        "pkg-1.20.2-1.8.1" = _awTOF2tr;
        "pkg-1.20.4-1.8.1" = _mCsjeFfy;
        "pkg-1.20.6-1.8.1" = _zyPMvp9y;
        "pkg-1.18.2-1.8.2" = _5psmDA7G;
        "pkg-1.19.2-1.8.2" = _jhNxQRXo;
        "pkg-1.20.1-1.8.2" = _KrTE7jYd;
        "pkg-1.20.2-1.8.2" = _G3aCuDq1;
        "pkg-1.20.4-1.8.2" = _K0vFtM4b;
        "pkg-1.20.6-1.8.2" = _vFYJtBX8;
        "pkg-1.18.2-1.8.3" = _G5PNqEGq;
        "pkg-1.19.2-1.8.3" = _IQItdq0j;
        "pkg-1.20.1-1.8.3" = _jUVlX2DJ;
        "pkg-1.20.2-1.8.3" = _vw2Q2DsE;
        "pkg-1.20.4-1.8.3" = _qmMlg8So;
        "pkg-1.20.6-1.8.3" = _XtzWJJgM;
        "pkg-1.18.2-1.8.4" = _VyJGNZOW;
        "pkg-1.19.2-1.8.4" = _Ca83SQLi;
        "pkg-1.20.1-1.8.4" = _LAoDryAP;
        "pkg-1.20.4-1.8.4" = _K4YYumpo;
        "pkg-1.20.2-1.8.4" = _dYXjxIKO;
        "pkg-1.20.6-1.8.4" = _kq8W0ED6;
        "pkg-1.21-1.8.4" = _4erjzOg5;
        "pkg-1.18.2-1.8.5" = _3wvNbeKV;
        "pkg-1.19.2-1.8.5" = _cUDtd94u;
        "pkg-1.20.1-1.8.5" = _dh5wpqYH;
        "pkg-1.20.2-1.8.5" = _KfO3mojB;
        "pkg-1.20.4-1.8.5" = _JUuC601v;
        "pkg-1.20.6-1.8.5" = _PVuadkIo;
        "pkg-1.21-1.8.5" = _kNuoEPus;
        "pkg-1.18.2-1.8.6" = _Brd5SFXH;
        "pkg-1.19.2-1.8.6" = _e5umsu8m;
        "pkg-1.20.1-1.8.6" = _zCE7Xohg;
        "pkg-1.20.2-1.8.6" = _GY5zDXJA;
        "pkg-1.20.4-1.8.6" = _elGPKTgj;
        "pkg-1.20.6-1.8.6" = _yjhaRoe6;
        "pkg-1.21-1.8.6" = _4STnIQnw;
        "pkg-1.18.2-1.8.7" = _QK7S159c;
        "pkg-1.19.2-1.8.7" = _Gr1krtqO;
        "pkg-1.20.1-1.8.7" = _y2P8E8ML;
        "pkg-1.20.2-1.8.7" = _v61bdyuv;
        "pkg-1.20.4-1.8.7" = _Ai9iZqbb;
        "pkg-1.20.6-1.8.7" = _G2K8v36s;
        "pkg-1.21-1.8.7" = _AuDGBEHe;
        "pkg-1.18.2-1.8.8" = _RJbVkkGy;
        "pkg-1.19.2-1.8.8" = _okCIaDnl;
        "pkg-1.20.1-1.8.8" = _D4CIb93b;
        "pkg-1.20.2-1.8.8" = _sqwL4JTk;
        "pkg-1.20.4-1.8.8" = _57Zng0Rc;
        "pkg-1.20.6-1.8.8" = _jn05A9Ao;
        "pkg-1.21-1.8.8" = _fScAplrr;
        "pkg-1.18.2-1.8.9" = _z6TkR9JQ;
        "pkg-1.19.2-1.8.9" = _bifwT6Ds;
        "pkg-1.20.1-1.8.9" = _LUx9VOJD;
        "pkg-1.20.2-1.8.9" = _z6VrCCPI;
        "pkg-1.20.4-1.8.9" = _6D3exwsK;
        "pkg-1.20.6-1.8.9" = _BpO0SBcj;
        "pkg-1.21-1.8.9" = _zKq4bnkI;
        "pkg-1.18.2-1.9.0" = _IrTfID7Z;
        "pkg-1.19.2-1.9.0" = _9FitOWJz;
        "pkg-1.20.1-1.9.0" = _5QIm1RDf;
        "pkg-1.20.2-1.9.0" = _Q6vLANk7;
        "pkg-1.20.4-1.9.0" = _KA9vYrTH;
        "pkg-1.20.6-1.9.0" = _fe2oKXAl;
        "pkg-1.21-1.9.0" = _IHerKcGp;
        "pkg-1.18.2-1.9.1" = _2qNLXaR6;
        "pkg-1.19.2-1.9.1" = _FzVZQdsD;
        "pkg-1.20.1-1.9.1" = _z5LZSdOQ;
        "pkg-1.20.2-1.9.1" = _sBRUUlrQ;
        "pkg-1.20.4-1.9.1" = _uAvFjJ87;
        "pkg-1.20.6-1.9.1" = _ooYo3fXX;
        "pkg-1.21-1.9.1" = _KsQDtrkF;
        "pkg-1.18.2-1.9.2" = _FJesw5fd;
        "pkg-1.19.2-1.9.2" = _cxchyBSp;
        "pkg-1.20.2-1.9.2" = _BQDcH1bH;
        "pkg-1.20.4-1.9.2" = _cus6xScz;
        "pkg-1.20.6-1.9.2" = _zrFcs1ua;
        "pkg-1.21-1.9.2" = _jHCwKGnd;
        "pkg-1.20.1-1.9.2" = _1SBfQBPn;
        "pkg-1.18.2-1.9.3" = _qPiOYVic;
        "pkg-1.19.2-1.9.3" = _utztOdax;
        "pkg-1.20.1-1.9.3" = _iyDn8r3C;
        "pkg-1.20.2-1.9.3" = _JOrhb484;
        "pkg-1.20.4-1.9.3" = _u61XLvqR;
        "pkg-1.20.6-1.9.3" = _KRLWFTxR;
        "pkg-1.21-1.9.3" = _FfKGAzYX;
        "pkg-1.18.2-1.9.4" = _rdlF5orG;
        "pkg-1.19.2-1.9.4" = _PTzky55n;
        "pkg-1.20.1-1.9.4" = _ERNFwM0M;
        "pkg-1.20.2-1.9.4" = _M1NIQjsN;
        "pkg-1.20.4-1.9.4" = _SebWyue2;
        "pkg-1.20.6-1.9.4" = _3XxXiCoO;
        "pkg-1.21-1.9.4" = _K1JCJ5pv;
        "pkg-1.18.2-1.9.5" = _t6m61NVN;
        "pkg-1.19.2-1.9.5" = _jJhLSjzk;
        "pkg-1.20.1-1.9.5" = _MAoyXjEx;
        "pkg-1.20.2-1.9.5" = _tFgp7eV0;
        "pkg-1.20.4-1.9.5" = _U0HhRCvB;
        "pkg-1.20.6-1.9.5" = _8d8YdG8F;
        "pkg-1.21-1.9.5" = _eiv3bAvu;
        "pkg-1.18.2-1.9.6" = _SnBNBNfe;
        "pkg-1.19.2-1.9.6" = _GzdLQBUG;
        "pkg-1.20.1-1.9.6" = _ZWkzXzDR;
        "pkg-1.20.2-1.9.6" = _NC9V5Ipy;
        "pkg-1.20.4-1.9.6" = _vs8VxCn0;
        "pkg-1.20.6-1.9.6" = _TLbzHXoN;
        "pkg-1.21-1.9.6" = _wMYrd5Kx;
        "pkg-1.18.2-1.9.7" = _HfXCQXTn;
        "pkg-1.19.2-1.9.7" = _tBSy7GIN;
        "pkg-1.20.1-1.9.7" = _skQrkJdc;
        "pkg-1.20.2-1.9.7" = _DJE04MkP;
        "pkg-1.20.4-1.9.7" = _Avo5HIkq;
        "pkg-1.20.6-1.9.7" = _gpKD6bKb;
        "pkg-1.21-1.9.7" = _3QlzyKCf;
        "pkg-1.18.2-1.9.8" = _mS69I1iZ;
        "pkg-1.19.2-1.9.8" = _iQzeN5GB;
        "pkg-1.20.1-1.9.8" = _pg349E3r;
        "pkg-1.20.2-1.9.8" = _tWhYW1YV;
        "pkg-1.20.4-1.9.8" = _zCffy4Tu;
        "pkg-1.20.6-1.9.8" = _t943Blme;
        "pkg-1.21-1.9.8" = _4top46Hw;
        "pkg-1.16.5-1.10.0" = _YgAAObvL;
        "pkg-1.18.2-1.10.0" = _OlZ25t50;
        "pkg-1.19.2-1.10.0" = _6gP5Di83;
        "pkg-1.20.1-1.10.0" = _Piy7MzGU;
        "pkg-1.21.1-1.10.0" = _OhLOsWJ9;
        "pkg-1.16.5-1.10.1" = _v86YD4Vg;
        "pkg-1.18.2-1.10.1" = _jDKIvKs2;
        "pkg-1.19.2-1.10.1" = _ctFOwilW;
        "pkg-1.20.1-1.10.1" = _jGx2IYH3;
        "pkg-1.21.1-1.10.1" = _knhP3bph;
        "pkg-1.16.5-1.10.2" = _5OaByZHe;
        "pkg-1.18.2-1.10.2" = _EnkprtAu;
        "pkg-1.19.2-1.10.2" = _yLShtNzd;
        "pkg-1.20.1-1.10.2" = _ashd1yYs;
        "pkg-1.21.1-1.10.2" = _XcWrvGbI;
        "pkg-1.16.5-1.10.3" = _DuF6U49C;
        "pkg-1.18.2-1.10.3" = _7w9cGBvs;
        "pkg-1.19.2-1.10.3" = _PvOqgaug;
        "pkg-1.20.1-1.10.3" = _iDNfNlzz;
        "pkg-1.21.1-1.10.3" = _dewnu1X8;
        "pkg-1.16.5-1.10.4" = _A9GE3H67;
        "pkg-1.18.2-1.10.4" = _UlFK2ZFC;
        "pkg-1.19.2-1.10.4" = _84wJ78Gj;
        "pkg-1.20.1-1.10.4" = _4hOXzEIZ;
        "pkg-1.21.1-1.10.4" = _r6lKPpLC;
        "pkg-1.16.5-1.10.6" = _J4q82U9B;
        "pkg-1.18.2-1.10.6" = _cx4E4G3m;
        "pkg-1.19.2-1.10.6" = _2brceAmL;
        "pkg-1.20.1-1.10.6" = _wqFk7fpz;
        "pkg-1.21.1-1.10.6" = _Nn6VJZ0D;
        "pkg-1.18.2-1.10.7" = _iYzWabj9;
        "pkg-1.16.5-1.10.7" = _bXQClTJ3;
        "pkg-1.19.2-1.10.7" = _EtDayQjH;
        "pkg-1.20.1-1.10.7" = _psxJNl9M;
        "pkg-1.21.1-1.10.7" = _4ydLvfo3;
        "pkg-1.16.5-1.10.8" = _zpa9El6B;
        "pkg-1.18.2-1.10.8" = _B7IX7Upq;
        "pkg-1.19.2-1.10.8" = _NY2Y41Rr;
        "pkg-1.20.1-1.10.8" = _UD3oWuWs;
        "pkg-1.21.1-1.10.8" = _3EYUYSvG;
        "pkg-1.16.5-1.10.9" = _72DFZFXN;
        "pkg-1.18.2-1.10.9" = _Z5Z17tTI;
        "pkg-1.19.2-1.10.9" = _wYhzJT3R;
        "pkg-1.20.1-1.10.9" = _zWMDrGVk;
        "pkg-1.21.1-1.10.9" = _DvDSEhfS;
        "pkg-1.16.5-1.11.0" = _qSoMDesW;
        "pkg-1.18.2-1.11.0" = _zMbsTtYQ;
        "pkg-1.19.2-1.11.0" = _QZ0mzndi;
        "pkg-1.20.1-1.11.0" = _jHrxdNGg;
        "pkg-1.21.1-1.11.0" = _JTHZdvzJ;
        "pkg-1.16.5-1.11.1" = _J612ETYd;
        "pkg-1.18.2-1.11.1" = _GZ6MiA9Y;
        "pkg-1.19.2-1.11.1" = _juaQRXEG;
        "pkg-1.20.1-1.11.1" = _ftNemOEK;
        "pkg-1.21.1-1.11.1" = _8L9m3bwF;
        "pkg-1.16.5-1.11.2" = _GYPwupzS;
        "pkg-1.18.2-1.11.2" = _1va1G8tn;
        "pkg-1.19.2-1.11.2" = _IbUJ4DHq;
        "pkg-1.20.1-1.11.2" = _oBHJqSAf;
        "pkg-1.21.1-1.11.2" = _WYj4U7fp;
        "pkg-1.16.5-1.11.3" = _jT40ZD5V;
        "pkg-1.18.2-1.11.3" = _SPmtsSY7;
        "pkg-1.19.2-1.11.3" = _92LeBRMX;
        "pkg-1.20.1-1.11.3" = _XyIU1460;
        "pkg-1.21.1-1.11.3" = _BvoID1jZ;
        "pkg-1.16.5-1.11.4" = _6LS1ti28;
        "pkg-1.18.2-1.11.4" = _h8ezEXCk;
        "pkg-1.19.2-1.11.4" = _VVfXo2Es;
        "pkg-1.20.1-1.11.4" = _n7QGcOjt;
        "pkg-1.21.1-1.11.4" = _9k3xVkFo;
        "pkg-1.16.5-1.11.5" = _vAXQvUT1;
        "pkg-1.18.2-1.11.5" = _unwa236r;
        "pkg-1.19.2-1.11.5" = _44Dl32uF;
        "pkg-1.20.1-1.11.5" = _OLxw2HtD;
        "pkg-1.21.1-1.11.5" = _UtQJgky1;
        "pkg-1.16.5-1.11.6" = _2KC7R0Lu;
        "pkg-1.18.2-1.11.6" = _maCpW6DI;
        "pkg-1.19.2-1.11.6" = _lNDG1WNt;
        "pkg-1.20.1-1.11.6" = _QnPsGL72;
        "pkg-1.21.4-1.11.6" = _1TwauIfA;
        "pkg-1.16.5-1.11.7" = _ewiswtrf;
        "pkg-1.18.2-1.11.7" = _zjSW1aam;
        "pkg-1.19.2-1.11.7" = _eNOG9oIX;
        "pkg-1.20.1-1.11.7" = _5I9ZtQO4;
        "pkg-1.21.4-1.11.7" = _OxcpBe0j;
        "pkg-1.16.5-1.12.0" = _qDfxdiCp;
        "pkg-1.18.2-1.12.0" = _WSVCu2rD;
        "pkg-1.19.2-1.12.0" = _kC19NgtR;
        "pkg-1.20.1-1.12.0" = _HT2eRBeo;
        "pkg-1.21.4-1.12.0" = _GHnihCcy;
        "pkg-1.16.5-1.12.1" = _cCCfRG71;
        "pkg-1.18.2-1.12.1" = _uuLsRh9k;
        "pkg-1.19.2-1.12.1" = _1qanUzyE;
        "pkg-1.20.1-1.12.1" = _pJid18A0;
        "pkg-1.21.4-1.12.1" = _tmORH3UD;
        "pkg-1.16.5-1.12.2" = _a9KEOlZf;
        "pkg-1.18.2-1.12.2" = _v13PsLYB;
        "pkg-1.19.2-1.12.2" = _n1zePL7w;
        "pkg-1.20.1-1.12.2" = _pTedQl0p;
        "pkg-1.21.4-1.12.2" = _jmAusRTO;
        "pkg-1.16.5-1.12.3" = _Zg3Fqmw8;
        "pkg-1.18.2-1.12.3" = _jKE4BLu1;
        "pkg-1.19.2-1.12.3" = _NfS5US9t;
        "pkg-1.20.1-1.12.3" = _rToETRhm;
        "pkg-1.21.4-1.12.3" = _NIhvMb2h;
        "pkg-1.16.5-1.12.4" = _jZ6nDvKC;
        "pkg-1.18.2-1.12.4" = _iZKAzjhZ;
        "pkg-1.19.2-1.12.4" = _DXirmpjr;
        "pkg-1.20.1-1.12.4" = _x8kcoq0T;
        "pkg-1.21.4-1.12.4" = _LY0CwXt9;
        "pkg-1.16.5-1.12.5" = _mdwXsm6w;
        "pkg-1.18.2-1.12.5" = _NhUFXpVG;
        "pkg-1.19.2-1.12.5" = _1T7liEKl;
        "pkg-1.20.1-1.12.5" = _ASvGckbV;
        "pkg-1.21.4-1.12.5" = _l8dhp7sM;
        "pkg-1.16.5-1.12.6" = _84LLEdyG;
        "pkg-1.18.2-1.12.6" = _vKvtWVw3;
        "pkg-1.19.2-1.12.6" = _jQyfa2vK;
        "pkg-1.20.1-1.12.6" = _XEglxXd6;
        "pkg-1.21.4-1.12.6" = _VxBHI547;
        "pkg-1.16.5-1.12.7" = _H0xHXABQ;
        "pkg-1.18.2-1.12.7" = _vWSvs5Jh;
        "pkg-1.19.2-1.12.7" = _Im7bosyV;
        "pkg-1.20.1-1.12.7" = _htjvrzl6;
        "pkg-1.21.4-1.12.7" = _OCS5kP4d;
        "pkg-1.16.5-1.13.0" = _H5BE19Jn;
        "pkg-1.18.2-1.13.0" = _t6oHTBuo;
        "pkg-1.19.2-1.13.0" = _BPUPaucX;
        "pkg-1.20.1-1.13.0" = _zXfKFHmT;
        "pkg-1.21.4-1.13.0" = _A7ahluxB;
        "pkg-1.16.5-1.13.1" = _SVRGtOjN;
        "pkg-1.18.2-1.13.1" = _OMNhGLtG;
        "pkg-1.19.2-1.13.1" = _SjKIgtSQ;
        "pkg-1.20.1-1.13.1" = _EeIJYOe2;
        "pkg-1.21.4-1.13.1" = _kOE2iQyZ;
        "pkg-1.16.5-1.13.2" = _nBSorB4l;
        "pkg-1.18.2-1.13.2" = _rgZ0Qvmk;
        "pkg-1.19.2-1.13.2" = _3rhKU2VD;
        "pkg-1.20.1-1.13.2" = _hJY10bpJ;
        "pkg-1.21.4-1.13.2" = _u1iwieCs;
        "pkg-1.16.5-1.13.3" = _UqNBPGvU;
        "pkg-1.18.2-1.13.3" = _DW27xuLZ;
        "pkg-1.19.2-1.13.3" = _V7gysF02;
        "pkg-1.20.1-1.13.3" = _S53UbsOX;
        "pkg-1.21.1-1.13.3" = _SDmPmscE;
        "pkg-1.21.5-1.13.3" = _RKdDQR1e;
        "pkg-1.16.5-1.13.4" = _Krnel5YQ;
        "pkg-1.18.2-1.13.4" = _oDkjQNOP;
        "pkg-1.19.2-1.13.4" = _GqyhLh1B;
        "pkg-1.20.1-1.13.4" = _EpJ5fJ5H;
        "pkg-1.21.1-1.13.4" = _ow8kGCHQ;
        "pkg-1.21.5-1.13.4" = _jXLBckgl;
        "pkg-1.16.5-1.13.5" = _EtDT2c5z;
        "pkg-1.18.2-1.13.5" = _JBfP1SNh;
        "pkg-1.19.2-1.13.5" = _15HIQxRd;
        "pkg-1.20.1-1.13.5" = _jrSMK7F2;
        "pkg-1.21.1-1.13.5" = _iMTAX3Z4;
        "pkg-1.21.5-1.13.5" = _QC4dmiUa;
        "pkg-1.21.6-1.13.5" = _wlQUsc2f;
        "pkg-1.16.5-1.13.6" = _FcvNM1Y3;
        "pkg-1.18.2-1.13.6" = _FSj87RiW;
        "pkg-1.19.2-1.13.6" = _T18kx8DQ;
        "pkg-1.20.1-1.13.6" = _2SSpgQH3;
        "pkg-1.21.1-1.13.6" = _wmbfqI8X;
        "pkg-1.21.5-1.13.6" = _MZ0ZZloa;
        "pkg-1.21.8-1.13.6" = _x9pIVQso;
        "pkg-1.16.5-1.13.7" = _3lEwhRYx;
        "pkg-1.18.2-1.13.7" = _xsmxE012;
        "pkg-1.19.2-1.13.7" = _67Npj4kF;
        "pkg-1.20.1-1.13.7" = _6UgF8lev;
        "pkg-1.21.1-1.13.7" = _PM5mZo8M;
        "pkg-1.21.5-1.13.7" = _j4Pf47pi;
        "pkg-1.21.8-1.13.7" = _iMqeeMdk;
        "pkg-1.16.5-1.13.8" = _x3VO4YcQ;
        "pkg-1.18.2-1.13.8" = _JkDODO9F;
        "pkg-1.19.2-1.13.8" = _C4WqkwtO;
        "pkg-1.20.1-1.13.8" = _NH9y0yvW;
        "pkg-1.21.1-1.13.8" = _BMarFfyf;
        "pkg-1.21.5-1.13.8" = _Q8zgxlo7;
        "pkg-1.21.8-1.13.8" = _ZI9b6v6Y;
        "pkg-1.16.5-1.13.9" = _9y8v6sDD;
        "pkg-1.18.2-1.13.9" = _4j5e6VV0;
        "pkg-1.19.2-1.13.9" = _rUvqutfC;
        "pkg-1.20.1-1.13.9" = _WYj466nR;
        "pkg-1.21.1-1.13.9" = _taTGJGH2;
        "pkg-1.21.5-1.13.9" = _mVHscVwf;
        "pkg-1.21.8-1.13.9" = _uZtRSP9t;
        "pkg-1.16.5-1.13.10" = _cidZnUHV;
        "pkg-1.18.2-1.13.10" = _oP8LyKWP;
        "pkg-1.19.2-1.13.10" = _vWws2Hqe;
        "pkg-1.20.1-1.13.10" = _Zczyc94E;
        "pkg-1.21.1-1.13.10" = _tyMXPL6F;
        "pkg-1.21.5-1.13.10" = _4IyjXGzB;
        "pkg-1.21.8-1.13.10" = _cdzkwYwh;
        "pkg-1.16.5-1.13.11" = _Uy2BgElC;
        "pkg-1.18.2-1.13.11" = _bAlR18Nq;
        "pkg-1.19.2-1.13.11" = _6WTtwGNu;
        "pkg-1.20.1-1.13.11" = _C9T3pI7y;
        "pkg-1.21.1-1.13.11" = _vYkeaiTM;
        "pkg-1.21.5-1.13.11" = _TK8Gmc3i;
        "pkg-1.21.8-1.13.11" = _vJbQCIPf;
        "pkg-1.21.10-1.13.11" = _mUiyO6kb;
        "pkg-1.16.5-1.13.12" = _RubcSnRz;
        "pkg-1.18.2-1.13.12" = _lE9EELtN;
        "pkg-1.19.2-1.13.12" = _5Na4l09D;
        "pkg-1.20.1-1.13.12" = _Y9ZwHJx8;
        "pkg-1.21.1-1.13.12" = _pWBCTIlK;
        "pkg-1.21.5-1.13.12" = _cZ2oGVZC;
        "pkg-1.21.8-1.13.12" = _81z9nZyx;
        "pkg-1.21.10-1.13.12" = _tCzEL2uF;
        "pkg-1.16.5-1.13.13" = _Poyd86r4;
        "pkg-1.18.2-1.13.13" = _FTk8M4Lu;
        "pkg-1.19.2-1.13.13" = _rQVZRFZF;
        "pkg-1.20.1-1.13.13" = _zZNUSZ89;
        "pkg-1.21.1-1.13.13" = _DAN9qeJh;
        "pkg-1.21.5-1.13.13" = _R0Gan1rb;
        "pkg-1.21.8-1.13.13" = _2P1qE7D7;
        "pkg-1.21.10-1.13.13" = _rNxh0Q55;
        "pkg-1.16.5-1.13.14" = _pPkzwd8j;
        "pkg-1.18.2-1.13.14" = _VHaJzUlo;
        "pkg-1.19.2-1.13.14" = _AFOXryoe;
        "pkg-1.20.1-1.13.14" = _GefnlFZk;
        "pkg-1.21.1-1.13.14" = _KEBStjn2;
        "pkg-1.21.5-1.13.14" = _Qbhm6SnA;
        "pkg-1.21.8-1.13.14" = _2a9Zn6o8;
        "pkg-1.21.10-1.13.14" = _XznwBcMd;
        "pkg-1.16.5-1.13.15" = _eUozr0kY;
        "pkg-1.18.2-1.13.15" = _vF8HNkUK;
        "pkg-1.19.2-1.13.15" = _RmH4j97Q;
        "pkg-1.20.1-1.13.15" = _3Oxncrk6;
        "pkg-1.21.1-1.13.15" = _RGKDdnsu;
        "pkg-1.21.5-1.13.15" = _X8BesnkF;
        "pkg-1.21.8-1.13.15" = _2P9Wfpyk;
        "pkg-1.21.10-1.13.15" = _4X7kvKNc;
        "pkg-1.16.5-1.13.16" = _TEdTVWd8;
        "pkg-1.18.2-1.13.16" = _vjZxXIr9;
        "pkg-1.19.2-1.13.16" = _eYk37GNR;
        "pkg-1.20.1-1.13.16" = _MMsDJfa0;
        "pkg-1.21.1-1.13.16" = _I0sgnMDJ;
        "pkg-1.21.5-1.13.16" = _Y0ZJJ12e;
        "pkg-1.21.8-1.13.16" = _RZIWCJ5k;
        "pkg-1.21.10-1.13.16" = _bpvKtg06;
        "pkg-1.16.5-1.13.17" = _M8DMUeJ4;
        "pkg-1.18.2-1.13.17" = _OuEvWOK4;
        "pkg-1.19.2-1.13.17" = _PDdBU4Cn;
        "pkg-1.20.1-1.13.17" = _azP2jEhX;
        "pkg-1.21.1-1.13.17" = _7XWMTf26;
        "pkg-1.21.5-1.13.17" = _u17JVArr;
        "pkg-1.21.8-1.13.17" = _LFQBbgJF;
        "pkg-1.21.10-1.13.17" = _1hj7A7PQ;
        "pkg-1.16.5-2.0.0" = _dzFADZ3F;
        "pkg-1.18.2-2.0.0" = _GY1qRLq2;
        "pkg-1.19.2-2.0.0" = _aZtTofan;
        "pkg-1.20.1-2.0.0" = _S0MYVDVd;
        "pkg-1.21.1-2.0.0" = _HmsqxY0R;
        "pkg-1.21.5-2.0.0" = _w1ArubYi;
        "pkg-1.21.8-2.0.0" = _WnuNvaag;
        "pkg-1.21.10-2.0.0" = _XounyEjt;
        "pkg-1.21.11-2.0.0" = _waFu91y3;
        "pkg-1.16.5-2.0.1" = _4sCCx1WA;
        "pkg-1.18.2-2.0.1" = _qBJm33rK;
        "pkg-1.19.2-2.0.1" = _A7WoYQ4M;
        "pkg-1.20.1-2.0.1" = _e8f1am7X;
        "pkg-1.21.1-2.0.1" = _DwmKPYTI;
        "pkg-1.21.5-2.0.1" = _sYhjp2YC;
        "pkg-1.21.8-2.0.1" = _D7HGJRHY;
        "pkg-1.21.10-2.0.1" = _Kou1P5e2;
        "pkg-1.21.11-2.0.1" = _LkmPQprP;
        "pkg-1.16.5-2.0.2" = _U606oh0E;
        "pkg-1.18.2-2.0.2" = _kjJ5ZHQH;
        "pkg-1.19.2-2.0.2" = _qnrpqQCH;
        "pkg-1.20.1-2.0.2" = _ypoj4DAp;
        "pkg-1.21.1-2.0.2" = _fyZFBllM;
        "pkg-1.21.5-2.0.2" = _qpQQMEbf;
        "pkg-1.21.8-2.0.2" = _WUlJrJVx;
        "pkg-1.21.10-2.0.2" = _h6oxJ5xX;
        "pkg-1.21.11-2.0.2" = _Wii5adJA;
        "pkg-1.16.5-2.0.3" = _WlAiMtSM;
        "pkg-1.18.2-2.0.3" = _9bCKMDXG;
        "pkg-1.19.2-2.0.3" = _so3XgKzQ;
        "pkg-1.20.1-2.0.3" = _zqLOE69x;
        "pkg-1.21.1-2.0.3" = _gE0ybIYz;
        "pkg-1.21.5-2.0.3" = _uSoIC5I6;
        "pkg-1.21.8-2.0.3" = _daUtDHRy;
        "pkg-1.21.10-2.0.3" = _mFbLSP5K;
        "pkg-1.21.11-2.0.3" = _eFY9ldZh;
        "pkg-1.16.5-2.0.4" = _bE4iATvD;
        "pkg-1.18.2-2.0.4" = _YQcnQCGc;
        "pkg-1.19.2-2.0.4" = _6myegVXP;
        "pkg-1.20.1-2.0.4" = _8FIDYn6a;
        "pkg-1.21.1-2.0.4" = _Qja976fJ;
        "pkg-1.21.5-2.0.4" = _AOc9i25x;
        "pkg-1.21.8-2.0.4" = _pE47BgJs;
        "pkg-1.21.10-2.0.4" = _1M3JMwiv;
        "pkg-1.21.11-2.0.4" = _QTypLj6o;
        "pkg-26.1.2-2.0.4" = _9f8RtTbP;
        "pkg-1.16.5-2.0.5" = _tKsdTEc9;
        "pkg-1.18.2-2.0.5" = _tmexQP15;
        "pkg-1.19.2-2.0.5" = _uItLOTHg;
        "pkg-1.20.1-2.0.5" = _Osgd07xm;
        "pkg-1.21.1-2.0.5" = _Q3uiVNfJ;
        "pkg-26.1.2-2.0.5" = _pvAQdwqf;
        "pkg-1.16.5-2.0.6" = _bHCdIhPa;
        "pkg-1.18.2-2.0.6" = _zgAnNpyQ;
        "pkg-1.19.2-2.0.6" = _LmsGUVb3;
        "pkg-1.20.1-2.0.6" = _IP3tyhZr;
        "pkg-1.21.1-2.0.6" = _TXIQJQdC;
        "pkg-26.1.2-2.0.6" = _76qSDLVt;
        "pkg-26.2-2.0.6" = _qMN3lBBp;
        "pkg-1.16.5-2.0.7" = _b1WswZGs;
        "pkg-1.18.2-2.0.7" = _oAFkn0lE;
        "pkg-1.19.2-2.0.7" = _rc17zRy4;
        "pkg-1.20.1-2.0.7" = _6tnxEqUb;
        "pkg-1.21.1-2.0.7" = _OxKyONSA;
        "pkg-26.1.2-2.0.7" = _fpYdvGlp;
        "pkg-26.2-2.0.7" = _jY45z5WD;
        "pkg-1.16.5-2.0.8" = _kDGUoDnX;
        "pkg-1.18.2-2.0.8" = _t2gC8Uk4;
        "pkg-1.19.2-2.0.8" = _2lBrpwW8;
        "pkg-1.20.1-2.0.8" = _ocbnwoWo;
        "pkg-1.21.1-2.0.8" = _ESqfvcM9;
        "pkg-26.1.2-2.0.8" = _nS0UtWHd;
        "pkg-26.2-2.0.8" = _iXSu41ji;
        "pkg-1.16.5-2.0.9" = _YxscuQ0q;
        "pkg-1.18.2-2.0.9" = _5JhT6pSI;
        "pkg-1.19.2-2.0.9" = _Sm5cReUn;
        "pkg-1.20.1-2.0.9" = _jJmLpXVl;
        "pkg-1.21.1-2.0.9" = _ASnbiK9f;
        "pkg-26.1.2-2.0.9" = _B2MayJlr;
        "pkg-26.2-2.0.9" = _Zq3ESFLz;
        "pkg-1.16.5-2.0.10" = _x4E7l7Kc;
        "pkg-1.18.2-2.0.10" = _QgVZvIOA;
        "pkg-1.19.2-2.0.10" = _XKOn80oE;
        "pkg-1.20.1-2.0.10" = _Cdu2Rh8P;
