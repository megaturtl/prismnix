...
let
    ...
    in {
        ...
        "pkg-v1.5.2-mc1.20.1-FML47.3.0" = _N6nw9nf5;
        "pkg-v1.5.5-mc1.20.1-FML47.3.0" = _KLcRlY4p;
        "pkg-v1.6.1-mc1.20.1-FML47.3.0" = _umaWXkfI;
        "pkg-v1.7.0-mc1.20.1-FML47.3.0" = _2qGzqqvC;
        "pkg-v1.9.0-mc1.20.1-FML47.3.0" = _4trw6jH9;
        "pkg-v1.9.1-mc1.20.1-FML47.3.0" = _JwuHBVKQ;
        "pkg-v1.9.2-mc1.20.1-FML47.3.0" = _EBCJqgjt;
        "pkg-v1.9.3-mc1.20.1-FML47.3.0" = _PQNHhlNk;
        "pkg-v1.9.4-mc1.20.1-FML47.3.0" = _WPAxUxmq;
        "pkg-v1.9.5-mc1.20.1-FML47.3.0" = _pS0vvoxu;
        "pkg-v1.9.6-mc1.20.1-FML47.3.0" = _XewHQbJm;
        "pkg-v1.9.7-mc1.20.1-FML47.3.0" = _oc0WAjAa;
        "pkg-v1.9.9-mc1.20.1-FML47.3.0" = _iHHAVHeQ;
        "pkg-v1.10.0-mc1.20.1-FML47.3.0" = _6KRwVoN3;
        "pkg-v1.10.1-mc1.20.1-FML47.3.0" = _yf4P7hPT;
        "pkg-v1.10.2-mc1.20.1-FML47.3.0" = _TMOB34pM;
        "pkg-v1.10.3-mc1.20.1-FML47.3.0" = _SHvEo8hI;
        "pkg-v1.11.0-mc1.20.1-FML47.3.0" = _lhvUZVpH;
        "pkg-v1.12.0-mc1.20.1-FML47.3.0" = _n7RUt1W0;
        "pkg-v1.13.0-mc1.20.1-FML47.3.0" = _593YsTLE;
        "pkg-v1.13.1-mc1.20.1-FML47.3.0" = _ZNJJf9XB;
        "pkg-v1.13.2-mc1.20.1-FML47.3.0" = _AMrhg1rz;
        "pkg-v1.13.3-mc1.20.1-FML47.3.0" = _j3UtYt4K;
        "pkg-v1.13.4-mc1.20.1-FML47.3.0" = _bpPcVYKW;
        "pkg-v1.14.0-mc1.20.1-FML47.3.0" = _8xlduPcy;
        "pkg-v1.15.0-mc1.20.1-FML47.3.0" = _Oxd70ryD;
        "pkg-v1.15.1-mc1.20.1-FML47.3.0" = _bxzKAeJU;
        "pkg-v1.15.2-mc1.20.1-FML47.3.0" = _fS4WnBTk;
        "pkg-v1.15.3-mc1.20.1-FML47.3.0" = _n8qGW5yL;
        "pkg-v1.15.4-mc1.20.1-FML47.3.0" = _awXxHrXl;
        "pkg-v1.16.0-mc1.20.1-FML47.3.0" = _7IGAVobo;
        "pkg-v1.17.0-mc1.20.1-FML47.3.0" = _oqBaBj7a;
        "pkg-v1.18.0-mc1.20.1-FML47.3.0" = _v07GAKBp;
        "pkg-v1.19.0-mc1.20.1-FML47.3.0" = _4r01o9Ga;
        "pkg-v1.19.1-mc1.20.1-FML47.3.0" = _95PfW2JJ;
        "pkg-v1.19.2-mc1.20.1-FML47.3.0" = _vkTTcyoW;
        "pkg-v1.19.3-mc1.20.1-FML47.3.0" = _jFkvukRD;
        "pkg-v1.19.4-mc1.20.1-FML47.3.0" = _5f3rOxsd;
        "pkg-v1.19.5-mc1.20.1-FML47.3.0" = _Rnl4yIph;
        "pkg-v1.19.6-mc1.20.1-FML47.3.0" = _71Etfv6P;
        "pkg-v1.19.7-mc1.20.1-FML47.3.0" = _PHLTGENg;
        "pkg-v1.19.8-mc1.20.1-FML47.3.0" = _mvfKKHQd;
        "pkg-v1.19.9-mc1.20.1-FML47.3.0" = _f1k2WCqm;
        "pkg-v1.19.10-mc1.20.1-FML47.3.0" = _UgwasJyi;
        "pkg-v1.19.11-mc1.20.1-FML47.3.0" = _gkEQTqzQ;
        "pkg-v1.19.12-mc1.20.1-FML47.3.0" = _SHnTfNsP;
        "pkg-v1.19.13-mc1.20.1-FML47.3.0" = _XBHGl60M;
        "pkg-v1.19.14-mc1.20.1-FML47.3.0" = _j57QhnaM;
        "pkg-v1.19.15-mc1.20.1-FML47.3.0" = _3DVpi7XV;
        "pkg-v1.19.16-mc1.20.1-FML47.3.0" = _jNTWHL2t;
        "pkg-v1.20.0-mc1.20.1-FML47.3.0" = _t5V3Ycbn;
        "pkg-v1.20.1-mc1.20.1-FML47.3.0" = _rmTFhUqS;
        "pkg-v1.20.2-mc1.20.1-FML47.3.0" = _gmY77NxE;
        "pkg-v1.20.3-mc1.20.1-FML47.3.0" = _4hC039OY;
        "pkg-v1.20.4-mc1.20.1-FML47.3.0" = _DtWqxAu1;
        "pkg-v1.21.0-mc1.20.1-FML47.3.0" = _oDTJsJL2;
        "pkg-v1.22.0-mc1.20.1-FML47.3.0" = _sDCFRn0u;
        "pkg-v1.22.1-mc1.20.1-FML47.3.0" = _tovxtIOc;
        "pkg-v1.22.2-mc1.20.1-FML47.3.0" = _pG97P7Ck;
        "pkg-v1.22.3-mc1.20.1-FML47.3.0" = _KIiSHSF1;
        "pkg-v1.22.4-mc1.20.1-FML47.3.0" = _C9Nq2snX;
        "pkg-v1.22.5-mc1.20.1-FML47.3.0" = _kcJAbBqU;
        "pkg-v1.22.6-mc1.20.1-FML47.3.0" = _yFHLEjOs;
        "pkg-v1.22.7-mc1.20.1-FML47.3.0" = _E6GQOXfk;
        "pkg-v1.22.8-mc1.20.1-FML47.3.0" = _H6SFpch5;
        "pkg-v1.22.9-mc1.20.1-FML47.3.0" = _OJSrKIH2;
        "pkg-v1.23.0-mc1.20.1-FML47.3.0" = _ZYXrxjjy;
        "pkg-v1.24.0-mc1.20.1-FML47.3.0" = _ZHpyAtas;
        "pkg-v1.24.1-mc1.20.1-FML47.3.0" = _jl9Ym0dy;
        "pkg-v1.24.2-mc1.20.1-FML47.3.0" = _jlcf502J;
        "pkg-v1.24.3-mc1.20.1-FML47.3.0" = _iC4iO0Uh;
        "pkg-v1.24.4-mc1.20.1-FML47.3.0" = _Pq4k696S;
        "pkg-v1.24.5-mc1.20.1-FML47.3.0" = _SvbBhIaH;
        "pkg-v1.24.6-mc1.20.1-FML47.3.0" = _N1JIII2D;
        "pkg-v1.24.7-mc1.20.1-FML47.3.0" = _sD1GtE7a;
        "pkg-v1.24.8-mc1.20.1-FML47.3.0" = _XIJMd0gq;
        "pkg-v1.24.9-mc1.20.1-FML47.3.0" = _uIRFQ5wV;
        "pkg-v1.24.10-mc1.20.1-FML47.3.0" = _BrIZ0xam;
        "pkg-v1.24.11-mc1.20.1-FML47.3.0" = _BcWeEwF2;
        "pkg-v1.25.0-mc1.20.1-FML47.3.0" = _8hpKXHOB;
        "pkg-v1.25.1-mc1.20.1-FML47.3.0" = _dgt0p354;
        "pkg-v1.25.2-mc1.20.1-FML47.3.0" = _dKxvS0Xa;
        "pkg-v1.25.3-mc1.20.1-FML47.3.0" = _OgzqR5V6;
        "pkg-v1.25.4-mc1.20.1-FML47.3.0" = _w05U92Nr;
        "pkg-v1.25.5-mc1.20.1-FML47.3.0" = _5XA2KRue;
        "pkg-v1.25.6-mc1.20.1-FML47.3.0" = _9wnBfXN8;
        "pkg-v1.25.7-mc1.20.1-FML47.3.0" = _X9dd6ZRm;
        "pkg-v1.26.0-mc1.20.1-FML47.3.0" = _iJTJJ1Wb;
        "pkg-v1.26.1-mc1.20.1-FML47.3.0" = _vZnxtUK4;
        "pkg-v1.26.2-mc1.20.1-FML47.3.0" = _Nvfr44Z1;
        "pkg-v1.26.3-mc1.20.1-FML47.3.0" = _6ltdcqiP;
        "pkg-v1.26.4-mc1.20.1-FML47.3.0" = _ANUs7kov;
        "pkg-v1.26.5-mc1.20.1-FML47.3.0" = _67NSAHqE;
        "pkg-v1.26.6-mc1.20.1-FML47.3.0" = _n6DkrNoP;
        "pkg-v1.26.7-mc1.20.1" = _7gupDQth;
        "pkg-v1.27.0-mc1.20.1" = _h3VJdXCt;
        "pkg-v1.27.1-mc1.20.1" = _BGCWQ1HY;
        "pkg-v1.27.0-mc1.21.1" = _nUBCRwAj;
        "pkg-v1.27.1-mc1.21.1" = _bDtouaDo;
        "pkg-v1.27.2-mc1.21.1" = _FitWoi8y;
        "pkg-v1.27.3-mc1.21.1" = _R36M8ujQ;
        "pkg-v1.27.4-mc1.21.1" = _8SwpH1ME;
        "pkg-v1.27.5-mc1.21.1" = _mhZtkUt0;
        "pkg-v1.27.6-mc1.21.1" = _S6RQgiAM;
        "pkg-v1.27.7-mc1.21.1" = _GL8cuSq2;
        "pkg-v1.27.8-mc1.21.1" = _xo2nOA4F;
        "pkg-v1.27.9-mc1.21.1" = _Rwl9CS3O;
        "pkg-v1.28.0-mc1.21.1" = _uRTcgbbG;
        "pkg-v1.28.1-mc1.21.1" = _75A5LqxM;
        "pkg-v1.28.2-mc1.21.1" = _QipybtPx;
        "pkg-v1.28.3-mc1.21.1" = _xu6DNSYa;
        "pkg-v1.28.4-mc1.21.1" = _APolIL8Q;
        "pkg-v1.28.5-mc1.21.1" = _59Dcocro;
        "pkg-v1.28.6-mc1.21.1" = _gQ2jUP4y;
        "pkg-v1.28.7-mc1.21.1" = _v7SmdGRx;
        "pkg-v1.28.8-mc1.21.1" = _sVcRSQ60;
        "pkg-v1.27.2-mc1.20.1" = _v4oSEYuX;
        "pkg-v1.27.3-mc1.20.1" = _gRR6gV7o;
        "pkg-v1.28.9-mc1.21.1" = _OoAacUjy;
        "pkg-v1.28.0-mc1.20.1" = _gbHqbi6E;
        "pkg-v1.28.1-mc1.20.1" = _8Av6oAkf;
        "pkg-v1.28.2-mc1.20.1" = _Tb5SRlpC;
        "pkg-v1.28.3-mc1.20.1" = _vs65XOKq;
        "pkg-v1.28.4-mc1.20.1" = _ddb0kkfe;
        "pkg-v1.29.0-mc1.21.1" = _1usOsCgj;
        "pkg-v1.29.1-mc1.21.1" = _InPmxplB;
        "pkg-v1.29.2-mc1.21.1" = _6l0j2JyW;
        "pkg-v1.29.3-mc1.21.1" = _XciXc7oJ;
        "pkg-v1.29.4-mc1.21.1" = _Pks8mcpG;
        "pkg-v1.29.5-mc1.21.1" = _VVrrBkGy;
        "pkg-v1.29.6-mc1.21.1" = _UiwxNlVC;
        "pkg-v1.29.7-mc1.21.1" = _jZgRbmkd;
        "pkg-v1.29.8-mc1.21.1" = _95gmqihR;
        "pkg-v1.29.9-mc1.21.1" = _V9GUZtyL;
        "pkg-v1.29.10-mc1.21.1" = _fjynD8MX;
        "pkg-v1.29.11-mc1.21.1" = _Y68NATij;
        "pkg-v1.29.12-mc1.21.1" = _FB2JwXRd;
        "pkg-v1.29.14-mc1.21.1" = _kPO19Bk4;
        "pkg-v1.30.0-mc1.21.1" = _5bCdCuoN;
        "pkg-v1.30.1-mc1.21.1" = _LkeOuuvr;
        "pkg-v1.30.2-mc1.21.1" = _PHhCqoJ2;
        "pkg-v1.30.3-mc1.21.1" = _r9r7CKYh;
