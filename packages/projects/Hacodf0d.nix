...
let
    ...
    in {
        ...
        "pkg-0.9.3-1.21" = _32pmdJ8v;
        "pkg-0.9.3-1.20" = _n3pDJzlK;
        "pkg-0.9.3-1.21.3" = _xRAwdN4Q;
        "pkg-0.9.3-1.19.2" = _SZoWTr04;
        "pkg-0.9.3-1.21.4" = _KpjUTuh0;
        "pkg-1.0.0-Fabric-mc1.19.2" = _Ewj66TJU;
        "pkg-1.0.0-Fabric-mc1.20" = _10da9nOu;
        "pkg-1.0.0-Fabric-mc1.21" = _slBTq45X;
        "pkg-1.0.0-Fabric-mc1.21.3" = _HVTMYiw3;
        "pkg-1.0.0-Fabric-mc1.21.4" = _i652ewMB;
        "pkg-1.1.0-Fabric-mc1.19.2" = _ahGWn9DO;
        "pkg-1.1.0-Fabric-mc1.20" = _PLJ4Ikl2;
        "pkg-1.1.0-Fabric-mc1.21" = _2HA3xB0p;
        "pkg-1.1.0-Fabric-mc1.21.3" = _taqhOTer;
        "pkg-1.1.0-Fabric-mc1.21.4" = _wPE5pIjF;
        "pkg-1.1.0-Forge-mc1.20.1" = _CJOX8Zbf;
        "pkg-1.2.0-NeoForge-mc1.21" = _esncE8Go;
        "pkg-1.2.0-NeoForge-mc1.21.3" = _peWrTpM1;
        "pkg-1.2.0-NeoForge-mc1.21.4" = _PdCDqrX4;
        "pkg-1.2.1-Forge-mc1.20.1" = _3kuym47t;
        "pkg-1.2.2-Fabric-mc1.19.2" = _D7dBKe0h;
        "pkg-1.2.2-Fabric-mc1.20" = _6bnDv59a;
        "pkg-1.2.2-Fabric-mc1.21" = _ulga2QtY;
        "pkg-1.2.2-Fabric-mc1.21.3" = _YGByqBCm;
        "pkg-1.2.2-Fabric-mc1.21.4" = _KWgpxVBf;
        "pkg-1.2.2-Forge-mc1.20.1" = _S0gGrG6O;
        "pkg-1.2.2-NeoForge-mc1.21" = _LWnV1VXq;
        "pkg-1.2.2-NeoForge-mc1.21.3" = _SdiYzgVQ;
        "pkg-1.2.2-NeoForge-mc1.21.4" = _OWFK1Zh4;
        "pkg-1.2.3-Fabric-mc1.19.2" = _58YPxGRy;
        "pkg-1.2.3-Fabric-mc1.20" = _rXY58Ly7;
        "pkg-1.2.3-Fabric-mc1.21" = _pux1cQyj;
        "pkg-1.2.3-Fabric-mc1.21.3" = _Ep9YcgJ0;
        "pkg-1.2.3-Fabric-mc1.21.4" = _ayDTZcP7;
        "pkg-1.2.3-Forge-mc1.20.1" = _C0frVFLN;
        "pkg-1.2.3-NeoForge-mc1.21" = _P2sbkrf7;
        "pkg-1.2.3-NeoForge-mc1.21.3" = _AQRzYvj1;
        "pkg-1.2.3-NeoForge-mc1.21.4" = _YdfVjtJf;
        "pkg-1.2.4-Forge-mc1.20.1" = _U1aw9Uxs;
        "pkg-1.2.4-NeoForge-mc1.21" = _Ge6l5NxQ;
        "pkg-1.2.4-NeoForge-mc1.21.3" = _3dcGwqfs;
        "pkg-1.2.4-NeoForge-mc1.21.4" = _VsT62zVz;
        "pkg-1.2.3-Fabric-mc1.21.5" = _QPlGV26W;
        "pkg-1.2.4-NeoForge-mc1.21.5" = _zMUFJsES;
        "pkg-1.2.5-NeoForge-mc1.21" = _dRUbPDAQ;
        "pkg-1.2.5-NeoForge-mc1.21.3" = _TfR4NWtv;
        "pkg-1.2.5-NeoForge-mc1.21.4" = _GKNhK3ry;
        "pkg-1.2.5-NeoForge-mc1.21.5" = _GK0O9SfU;
        "pkg-1.2.6-Fabric-mc1.21.6" = _WjmvI5IM;
        "pkg-1.2.6-NeoForge-mc1.21.6" = _2TQL5L86;
        "pkg-1.2.7-Forge-mc1.20.1" = _u3qG9Ct7;
        "pkg-1.2.7-Forge-mc1.19.2" = _ZZdPpRck;
        "pkg-1.3.0-Forge-mc1.19.2" = _P9A4IaIx;
        "pkg-1.3.0-Forge-mc1.20.1" = _QDyptSMy;
        "pkg-1.3.0-NeoForge-mc1.21" = _mEgZvvHo;
        "pkg-1.3.0-Fabric-mc1.21.9" = _dAjvWVZb;
        "pkg-1.3.0-NeoForge-mc1.21.9" = _XbRca24A;
        "pkg-1.3.0-Fabric-mc1.20" = _gac5pzLV;
        "pkg-1.3.0-NeoForge-mc1.21.11" = _gMeK4fzQ;
        "pkg-1.4.0-Forge-mc1.20.1" = _6ZkYG0Oq;
        "pkg-1.4.0-Forge-mc1.19.2" = _zzQH692K;
        "pkg-1.4.0-Fabric-mc1.20" = _yTKdDays;
        "pkg-1.4.0-Fabric-mc1.21.1" = _GKvTKjWH;
        "pkg-1.4.0-NeoForge-mc1.21" = _HiHvJRnW;
        "pkg-1.4.1-Fabric-mc26.1" = _gwkt2H6h;
        "pkg-1.4.1-NeoForge-mc26.1" = _DoqsskLo;
        "pkg-1.5.0-Fabric-mc26.1" = _Pf3hjvL9;
        "pkg-1.4.5-Forge-mc1.20.1" = _ycyuIRaR;
        "pkg-1.4.5-Fabric-mc1.20" = _QsByh6Zz;
        "pkg-1.4.5-Fabric-mc1.21.1" = _lRG0prKr;
