...
let
    ...
    in {
        ...
        "pkg-juztsys_structure-1.1.0-neoforge" = _CT8ZC5wm;
        "pkg-juztsys_structure-1.2.0-fabric" = _AN6YA7ZI;
        "pkg-juztsys_structure-1.2.0-neoforge" = _aBhnM9m7;
        "pkg-juztsys_structure-1.3.0-fabric" = _rdHG8TMG;
        "pkg-juztsys_structure-1.3.0-neoforge" = _8ma99usA;
        "pkg-juztsys_structure-1.4.0-fabric" = _IJ6Z9Xgw;
        "pkg-juztsys_structure-1.4.0-neoforge" = _iviyG3WJ;
        "pkg-juztsys_structure-1.5.0-fabric" = _S2xB21pI;
        "pkg-juztsys_structure-1.5.0-neoforge" = _LMqv3lnw;
        "pkg-juztsys_structure-1.6.0-fabric" = _LmPLKHhG;
        "pkg-juztsys_structure-1.6.0-neoforge" = _eJJeOSp0;
        "pkg-juztsys_structure-1.7.0-fabric" = _rjHxHcbY;
        "pkg-juztsys_structure-1.7.0-neoforge" = _aP65VveQ;
        "pkg-juztsys_structure-1.8.0-fabric" = _h9pChs0z;
        "pkg-juztsys_structure-1.8.0-neoforge" = _SrVkCdA0;
        "pkg-juztsys_structure-1.9.0-fabric" = _TLijAfnE;
        "pkg-juztsys_structure-1.9.0-neoforge" = _IXJaNPKs;
        "pkg-juztsys_structure-2.0.0-fabric" = _uYXsqTRv;
        "pkg-juztsys_structure-2.0.0-neoforge" = _9a8URNoA;
        "pkg-juztsys_structure-2.1.0-fabric" = _R7qHwXjy;
        "pkg-juztsys_structure-2.1.0-neoforge" = _82GMIyi0;
        "pkg-juztsys_structure-2.2.0-fabric" = _cSNT7bZL;
        "pkg-2.2.0-neoforge" = _qE0lnRNR;
        "pkg-2.2.0-fabric" = _dWoSqnQd;
        "pkg-juztsys_structure-2.3.0-farbic" = _8ZvtIBdY;
        "pkg-juztsys_structure-2.3.0-fabric" = _cE2JGXNv;
