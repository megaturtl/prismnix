...
let
    versions = (let
        ...
        _3HN3NWSX = {
            "id" = "3HN3NWSX";
            "file" = "Backuper-4.1.0.jar";
            "hash" = "sha512-BDtQ3kLgBRuIl/F0fCWdgwq1aFSpqwExTsgLFQrQPnR84PhrS9EZXabmDwvP0zdxId+Mqq1DRVtKR3llfjJGeQ==";
        };
    in {
        "HZE1KTbf" = _HZE1KTbf;
        "2TfT27CV" = _2TfT27CV;
        ...
        "folia-1.20.6" = _3HN3NWSX;
        "folia-1.21" = _3HN3NWSX;
        "folia-1.21.1" = _3HN3NWSX;
        "folia-1.21.2" = _3HN3NWSX;
        "folia-1.21.3" = _3HN3NWSX;
        "folia-1.21.4" = _3HN3NWSX;
        "folia-1.21.5" = _3HN3NWSX;
        "folia-1.21.6" = _3HN3NWSX;
        "folia-1.21.7" = _3HN3NWSX;
        "folia-1.21.8" = _3HN3NWSX;
        "folia-1.21.9" = _3HN3NWSX;
        "folia-1.21.10" = _3HN3NWSX;
        "folia-1.21.11" = _3HN3NWSX;
        "folia-26.1" = _3HN3NWSX;
        "folia-26.1.1" = _3HN3NWSX;
        "folia-26.1.2" = _3HN3NWSX;
        "folia-26.2" = _3HN3NWSX;
        ...
        "paper-1.20.6" = _3HN3NWSX;
        "paper-1.21" = _3HN3NWSX;
        "paper-1.21.1" = _3HN3NWSX;
        "paper-1.21.2" = _3HN3NWSX;
        "paper-1.21.3" = _3HN3NWSX;
        "paper-1.21.4" = _3HN3NWSX;
        "paper-1.21.5" = _3HN3NWSX;
        "paper-1.21.6" = _3HN3NWSX;
        "paper-1.21.7" = _3HN3NWSX;
        "paper-1.21.8" = _3HN3NWSX;
        "paper-1.21.9" = _3HN3NWSX;
        "paper-1.21.10" = _3HN3NWSX;
        "paper-1.21.11" = _3HN3NWSX;
        "paper-26.1" = _3HN3NWSX;
        "paper-26.1.1" = _3HN3NWSX;
        "paper-26.1.2" = _3HN3NWSX;
        "paper-26.2" = _3HN3NWSX;
        ...
        "purpur-1.20.6" = _3HN3NWSX;
        "purpur-1.21" = _3HN3NWSX;
        "purpur-1.21.1" = _3HN3NWSX;
        "purpur-1.21.2" = _3HN3NWSX;
        "purpur-1.21.3" = _3HN3NWSX;
        "purpur-1.21.4" = _3HN3NWSX;
        "purpur-1.21.5" = _3HN3NWSX;
        "purpur-1.21.6" = _3HN3NWSX;
        "purpur-1.21.7" = _3HN3NWSX;
        "purpur-1.21.8" = _3HN3NWSX;
        "purpur-1.21.9" = _3HN3NWSX;
        "purpur-1.21.10" = _3HN3NWSX;
        "purpur-1.21.11" = _3HN3NWSX;
        "purpur-26.1" = _3HN3NWSX;
        "purpur-26.1.1" = _3HN3NWSX;
        "purpur-26.1.2" = _3HN3NWSX;
        "purpur-26.2" = _3HN3NWSX;
        "pkg-1.4.0" = _HZE1KTbf;
        "pkg-1.4.1" = _2TfT27CV;
        "pkg-1.5.0" = _7a3FFxKB;
        "pkg-1.5.1" = _7UdcZbsh;
        ...
        "pkg-1.6.0" = _aSZwNEtM;
        "pkg-1.6.1" = _DaV0Orii;
        "pkg-1.6.1a" = _emd9vQoY;
        "pkg-1.6.1b" = _moQNDSFs;
        "pkg-2.0.0" = _Hjoziakv;
        "pkg-2.0.1" = _8tbwiDXw;
        "pkg-2.0.2" = _UMGDv0pK;
        "pkg-2.0.3" = _U3LjZVPn;
        "pkg-2.0.3a" = _tBbPaXxX;
        "pkg-3.0.0" = _Dr0eYvQm;
        "pkg-3.0.1" = _nkcNIvUw;
        "pkg-3.1.0" = _DqtME18V;
        "pkg-3.1.1" = _iAN0eD5x;
        ...
        "pkg-3.2.0" = _bWgc3cU3;
        "pkg-3.2.1" = _AHhEf5nh;
        "pkg-3.2.1a" = _w0LalkkF;
        "pkg-3.2.1b" = _lohH2GYJ;
        "pkg-3.3.0" = _5k1HYLD7;
        "pkg-3.4.0" = _3fWEyljD;
        "pkg-3.4.1" = _EwMrWdPh;
        "pkg-3.4.2" = _jVbkktpP;
