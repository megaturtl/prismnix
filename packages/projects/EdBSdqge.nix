...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _aUuB0C1I;
        "pkg-1.0.9" = _549FJ0re;
        "pkg-1.0.10" = _4VNDz5WH;
        "pkg-1.0.11" = _VV52KDNg;
        "pkg-1.0.12" = _kZJY3885;
        "pkg-1.0.10.1" = _lUMJvYpW;
        "pkg-1.0.13" = _GByywrgz;
        "pkg-1.0.13-mc1.21.2+" = _eOYf5StL;
        "pkg-1.0.14-mc1.21.2+" = _YqwtEuqd;
        "pkg-1.0.15-mc1.20.1" = _aHHKkRuW;
        "pkg-1.0.15-mc1.21.2+" = _adlolCft;
        "pkg-1.0.15-mc1.21.4" = _t4K5XqfV;
        "pkg-1.0.15-mc1.21.5+" = _C9qVTCYn;
        "pkg-1.0.16-mc1.21.5" = _FBzj7AGo;
        "pkg-1.0.16-mc1.21.6" = _vFrTfXIP;
        "pkg-1.0.17-mc1.21.6" = _Hy5KMujk;
        "pkg-1.0.18-mc1.21.6" = _Jk398Flr;
        "pkg-1.0.19-mc1.21.6" = _ThGRYvcL;
        "pkg-1.0.19-mc1.21.9" = _cUaoU0BA;
        "pkg-1.0.20-mc1.21.9" = _ZzrUxjLd;
        "pkg-1.0.20-mc1.21.11" = _i9pD5L7s;
        "pkg-1.0.20-mc26.1.1" = _DQeZSpcn;
        "pkg-1.0.20-mc26.2" = _TsuUMsTt;
        "pkg-1.0.21-mc26.2" = _K6ZVK766;
        "pkg-1.0.22-mc26.2" = _ulscAFcu;
