...
let
    versions = (let
        ...
        _qt30zlnm = {
            "id" = "qt30zlnm";
            "file" = "multiverse-core-5.8.0-pre.jar";
            "hash" = "sha512-vRXUWaxrR5fihX7RThhR4KS1UwKe62bVooLB2/nGFfDmFxMr1cxXV1PfOCu22wbEFili6dXVJU7I+IC/Tjj9gA==";
        };
        _bzFXz39N = {
            "id" = "bzFXz39N";
            "file" = "multiverse-core-5.8.0.jar";
            "hash" = "sha512-k/7a61pdLZyDQmPajLP5IHnNd+Mm7+cwpcKl4ZQbt3/9nQal9+CnPePhmO+1E46vO0rfeicroz0e1sF0yVrfaQ==";
        };
        _A3Ydrs7Y = {
            "id" = "A3Ydrs7Y";
            "file" = "multiverse-core-5.8.1-pre.jar";
            "hash" = "sha512-CiZ8GU/vszlWFQNlK0owuyeUH7AUqTrhpy86TAsRpyGKoU9kELrXA+6XkCIpayhrfMD8mqBc1XPyjbJRvqxiew==";
        };
        _2aRIRqUg = {
            "id" = "2aRIRqUg";
            "file" = "multiverse-core-5.8.1-pre.1.jar";
            "hash" = "sha512-jnSq6MGhdqeVuIc690CakbEPRKQpL5lyj4N6aDCv4r46pMd54rpgt5BH2ao1YTbUr1ZIhgejx8CqtTMVm9tJ6w==";
        };
        _X5Um2FAO = {
            "id" = "X5Um2FAO";
            "file" = "multiverse-core-5.8.1-pre.2.jar";
            "hash" = "sha512-V/IsDHymEMX9zzkkVZGutsX0EJXW0ee0QyEsArcZGtJOwiD56dWr/6Kkb3QlbzOZqy9wp6d+nXo5BClSOdJyfw==";
        };
        _6a8asKk9 = {
            "id" = "6a8asKk9";
            "file" = "multiverse-core-5.8.1-pre.3.jar";
            "hash" = "sha512-CdwczCVKu3feQxSA7Fxl4+sdXBiR+SVlDwoDl7DMy439ckULL2klu7N+CPhinG2qpBrJ66dNL/ousJ1tMPQO8A==";
        };
        _YZ2Ji4IS = {
            "id" = "YZ2Ji4IS";
            "file" = "multiverse-core-5.8.1.jar";
            "hash" = "sha512-MiwfTcGrzTDg9Vqp83jHAxhG0eWaUVZID5GZBQ3BBMGUaMmJHEe+NeTd5odC7EQg6pdOyIUNtqJZ+X/6GxxR6g==";
        };
    in {
        "FpNE02Yz" = _FpNE02Yz;
        "CjCV7nVu" = _CjCV7nVu;
        ...
        "bukkit-1.18.2" = _YZ2Ji4IS;
        "bukkit-1.19" = _YZ2Ji4IS;
        "bukkit-1.19.1" = _YZ2Ji4IS;
        "bukkit-1.19.2" = _YZ2Ji4IS;
        "bukkit-1.19.3" = _YZ2Ji4IS;
        "bukkit-1.19.4" = _YZ2Ji4IS;
        "bukkit-1.20" = _YZ2Ji4IS;
        "bukkit-1.20.1" = _YZ2Ji4IS;
        "bukkit-1.20.2" = _YZ2Ji4IS;
        "bukkit-1.20.3" = _YZ2Ji4IS;
        "bukkit-1.20.4" = _YZ2Ji4IS;
        "bukkit-1.20.5" = _YZ2Ji4IS;
        "bukkit-1.20.6" = _YZ2Ji4IS;
        "bukkit-1.21" = _YZ2Ji4IS;
        "bukkit-1.21.1" = _YZ2Ji4IS;
        "bukkit-1.21.2" = _YZ2Ji4IS;
        "bukkit-1.21.3" = _YZ2Ji4IS;
        "bukkit-1.21.4" = _YZ2Ji4IS;
        "bukkit-1.21.5" = _YZ2Ji4IS;
        "bukkit-1.21.6" = _YZ2Ji4IS;
        "bukkit-1.21.7" = _YZ2Ji4IS;
        "bukkit-1.21.8" = _YZ2Ji4IS;
        "bukkit-1.21.9" = _YZ2Ji4IS;
        "bukkit-1.21.10" = _YZ2Ji4IS;
        "bukkit-1.21.11" = _YZ2Ji4IS;
        "bukkit-26.1" = _YZ2Ji4IS;
        "bukkit-26.1.1" = _YZ2Ji4IS;
        "bukkit-26.1.2" = _YZ2Ji4IS;
        "bukkit-26.2" = _YZ2Ji4IS;
        ...
        "paper-1.18.2" = _YZ2Ji4IS;
        "paper-1.19" = _YZ2Ji4IS;
        "paper-1.19.1" = _YZ2Ji4IS;
        "paper-1.19.2" = _YZ2Ji4IS;
        "paper-1.19.3" = _YZ2Ji4IS;
        "paper-1.19.4" = _YZ2Ji4IS;
        "paper-1.20" = _YZ2Ji4IS;
        "paper-1.20.1" = _YZ2Ji4IS;
        "paper-1.20.2" = _YZ2Ji4IS;
        "paper-1.20.3" = _YZ2Ji4IS;
        "paper-1.20.4" = _YZ2Ji4IS;
        "paper-1.20.5" = _YZ2Ji4IS;
        "paper-1.20.6" = _YZ2Ji4IS;
        "paper-1.21" = _YZ2Ji4IS;
        "paper-1.21.1" = _YZ2Ji4IS;
        "paper-1.21.2" = _YZ2Ji4IS;
        "paper-1.21.3" = _YZ2Ji4IS;
        "paper-1.21.4" = _YZ2Ji4IS;
        "paper-1.21.5" = _YZ2Ji4IS;
        "paper-1.21.6" = _YZ2Ji4IS;
        "paper-1.21.7" = _YZ2Ji4IS;
        "paper-1.21.8" = _YZ2Ji4IS;
        "paper-1.21.9" = _YZ2Ji4IS;
        "paper-1.21.10" = _YZ2Ji4IS;
        "paper-1.21.11" = _YZ2Ji4IS;
        "paper-26.1" = _YZ2Ji4IS;
        "paper-26.1.1" = _YZ2Ji4IS;
        "paper-26.1.2" = _YZ2Ji4IS;
        "paper-26.2" = _YZ2Ji4IS;
        ...
        "spigot-1.18.2" = _YZ2Ji4IS;
        "spigot-1.19" = _YZ2Ji4IS;
        "spigot-1.19.1" = _YZ2Ji4IS;
        "spigot-1.19.2" = _YZ2Ji4IS;
        "spigot-1.19.3" = _YZ2Ji4IS;
        "spigot-1.19.4" = _YZ2Ji4IS;
        "spigot-1.20" = _YZ2Ji4IS;
        "spigot-1.20.1" = _YZ2Ji4IS;
        "spigot-1.20.2" = _YZ2Ji4IS;
        "spigot-1.20.3" = _YZ2Ji4IS;
        "spigot-1.20.4" = _YZ2Ji4IS;
        "spigot-1.20.5" = _YZ2Ji4IS;
        "spigot-1.20.6" = _YZ2Ji4IS;
        "spigot-1.21" = _YZ2Ji4IS;
        "spigot-1.21.1" = _YZ2Ji4IS;
        "spigot-1.21.2" = _YZ2Ji4IS;
        "spigot-1.21.3" = _YZ2Ji4IS;
        "spigot-1.21.4" = _YZ2Ji4IS;
        "spigot-1.21.5" = _YZ2Ji4IS;
        "spigot-1.21.6" = _YZ2Ji4IS;
        "spigot-1.21.7" = _YZ2Ji4IS;
        "spigot-1.21.8" = _YZ2Ji4IS;
        "spigot-1.21.9" = _YZ2Ji4IS;
        "spigot-1.21.10" = _YZ2Ji4IS;
        "spigot-1.21.11" = _YZ2Ji4IS;
        "spigot-26.1" = _YZ2Ji4IS;
        "spigot-26.1.1" = _YZ2Ji4IS;
        "spigot-26.1.2" = _YZ2Ji4IS;
        "spigot-26.2" = _YZ2Ji4IS;
        "purpur-1.18.2" = _YZ2Ji4IS;
        "purpur-1.19" = _YZ2Ji4IS;
        "purpur-1.19.1" = _YZ2Ji4IS;
        "purpur-1.19.2" = _YZ2Ji4IS;
        "purpur-1.19.3" = _YZ2Ji4IS;
        "purpur-1.19.4" = _YZ2Ji4IS;
        "purpur-1.20" = _YZ2Ji4IS;
        "purpur-1.20.1" = _YZ2Ji4IS;
        "purpur-1.20.2" = _YZ2Ji4IS;
        "purpur-1.20.3" = _YZ2Ji4IS;
        "purpur-1.20.4" = _YZ2Ji4IS;
        "purpur-1.20.5" = _YZ2Ji4IS;
        "purpur-1.20.6" = _YZ2Ji4IS;
        "purpur-1.21" = _YZ2Ji4IS;
        "purpur-1.21.1" = _YZ2Ji4IS;
        "purpur-1.21.2" = _YZ2Ji4IS;
        "purpur-1.21.3" = _YZ2Ji4IS;
        "purpur-1.21.4" = _YZ2Ji4IS;
        "purpur-1.21.5" = _YZ2Ji4IS;
        "purpur-1.21.6" = _YZ2Ji4IS;
        "purpur-1.21.7" = _YZ2Ji4IS;
        "purpur-1.21.8" = _YZ2Ji4IS;
        "purpur-1.21.9" = _YZ2Ji4IS;
        "purpur-1.21.10" = _YZ2Ji4IS;
        "purpur-1.21.11" = _YZ2Ji4IS;
        "purpur-26.1" = _YZ2Ji4IS;
        "purpur-26.1.1" = _YZ2Ji4IS;
        "purpur-26.1.2" = _YZ2Ji4IS;
        "purpur-26.2" = _YZ2Ji4IS;
        ...
        "pkg-5.7.3" = _wvHdu4gu;
        "pkg-5.8.0-pre" = _qt30zlnm;
        "pkg-5.8.0" = _bzFXz39N;
        "pkg-5.8.1-pre" = _A3Ydrs7Y;
        "pkg-5.8.1-pre.1" = _2aRIRqUg;
        "pkg-5.8.1-pre.2" = _X5Um2FAO;
        "pkg-5.8.1-pre.3" = _6a8asKk9;
        "pkg-5.8.1" = _YZ2Ji4IS;
        "default" = _YZ2Ji4IS;
    });
