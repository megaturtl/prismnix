...
let
    ...
    in {
        ...
        "pkg-1.0.0+mc1.19" = _ENWPUhft;
        "pkg-1.0.0+mc1.19.3" = _tdIqcl60;
        "pkg-1.0.1+mc1.18.2" = _cqcyYi9V;
        "pkg-1.0.1+mc1.19.2" = _Qn5eH5DF;
        "pkg-1.0.1+mc1.19.3" = _ELTnYq5J;
        "pkg-1.1.0+mc1.19.3" = _nlkHFwkO;
        "pkg-1.1.0+mc1.18.2" = _yEwqY5z5;
        "pkg-1.1.0+mc1.19.2" = _ryUBMUEN;
        "pkg-1.1.1+mc1.18.2" = _S6c0CVVd;
        "pkg-1.1.1+mc1.19.2" = _4EsXuMPz;
        "pkg-1.1.1+mc1.19.3" = _hyxlnCgm;
        "pkg-1.1.2+mc1.19.3" = _Hp0pXz6r;
        "pkg-1.1.2+mc1.19.2" = _JxelnfZ0;
        "pkg-1.1.2+mc1.18.2" = _2ItpebzX;
        "pkg-1.1.3+mc1.18.2" = _OVP4zIjV;
        "pkg-1.1.3+mc1.19.2" = _gyT9rE7v;
        "pkg-1.1.3+mc1.19.3" = _Jj7Q5qE7;
        "pkg-1.1.3+mc1.16.5" = _wRIBXFKv;
        "pkg-1.2.0+mc1.19.3" = _X6ucvfVC;
        "pkg-1.2.0+mc1.19.2" = _uEim3Xe1;
        "pkg-1.2.0+mc1.18.2" = _n4oV6d21;
        "pkg-1.2.0+mc1.16.5" = _Il8dWUzO;
        "pkg-1.2.1+mc1.19.3" = _RYE4Yrxb;
        "pkg-1.2.1+mc1.19.2" = _W9XzHl4e;
        "pkg-1.2.1+mc1.18.2" = _7T4RbOrc;
        "pkg-1.2.1+mc1.16.5" = _mUrWCmGc;
        "pkg-1.2.2+mc1.18.2" = _7or2sxQm;
        "pkg-1.2.2+mc1.16.5" = _52Q7F2QT;
        "pkg-1.2.3+mc1.16.5" = _UWhVAYwn;
        "pkg-1.2.1+mc1.19.4" = _L7bXY7JO;
        "pkg-1.3.0-beta.1+mc1.19.4" = _jO87IsjZ;
        "pkg-1.3.0-beta.2+mc1.19.4" = _cdANx8Kx;
        "pkg-1.2.4+mc1.19.3" = _GOBNuObS;
        "pkg-1.2.4+mc1.19.2" = _pmkQHWV3;
        "pkg-1.2.4+mc1.18.2" = _xzgMqaDb;
        "pkg-1.2.4+mc1.16.5" = _KNicCGkm;
        "pkg-1.3.0-beta.3+mc23w17a" = _O4p4Rr4u;
        "pkg-1.3.0+mc1.20" = _xSkBJBX7;
        "pkg-1.3.1+mc1.20.2" = _6PFSohwn;
        "pkg-1.4.0+mc1.20.3" = _Q4fDDwII;
        "pkg-1.5.0+mc1.20.6" = _bug0oWRK;
        "pkg-1.6.0+mc1.21" = _EqCJEUaf;
        "pkg-1.3.2+mc1.20" = _r1mSzUK2;
        "pkg-1.3.2+mc1.20.2" = _rCH1lxX8;
        "pkg-1.4.1+mc1.20.3" = _D3581xDA;
        "pkg-1.5.1+mc1.20.6" = _Qf2xGe0D;
        "pkg-1.6.1+mc1.21" = _IKkXFg8J;
        "pkg-1.7.0+mc1.21.2" = _w9gKHBo8;
        "pkg-1.8.0+mc1.21.5" = _LZjAol3d;
        "pkg-1.8.1+mc1.21.5" = _o0ruFQY5;
        "pkg-1.9.0+mc1.21.6" = _yu77gZuS;
        "pkg-1.10.0+mc1.21.9" = _q635mqBA;
        "pkg-1.11.0+mc1.21.11" = _s9zg6J87;
        "pkg-1.11.1+mc1.21.11" = _O1LyNvh0;
        "pkg-1.11.2+mc1.21.11" = _eRAPu7Ge;
        "pkg-1.12.0+mc26.1-neoforge" = _5whq7iO6;
        "pkg-1.12.0+mc26.1-fabric" = _WchKoLLL;
        "pkg-1.12.1+mc26.1-neoforge" = _KNfUGtjK;
