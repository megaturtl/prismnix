...
let
    versions = (let
        ...
        _t7OOopHZ = {
            "id" = "t7OOopHZ";
            "file" = "elytra_pink-1.0.1-mc26.3.zip";
            "hash" = "sha512-nYIFg3wVIdIM33LhL59+93AjbiYnuXBvyrdgYQeiqjQ7vqJqs0EK9A0b8ZGN5qaEfLL+uyw0t62x7f5NvMivqw==";
        };
    in {
        "J8dNKi9L" = _J8dNKi9L;
        "ZbKispev" = _ZbKispev;
