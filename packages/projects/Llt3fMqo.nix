...
let
    ...
    in {
        ...
        "minecraft-26.2-snapshot-3" = _t1NjWlHI;
        "minecraft-26.2-snapshot-4" = _t1NjWlHI;
        "minecraft-26.2-snapshot-5" = _t1NjWlHI;
        "minecraft-26.2-snapshot-6" = _t1NjWlHI;
        "minecraft-26.2-snapshot-7" = _t1NjWlHI;
        "minecraft-26.2-snapshot-8" = _t1NjWlHI;
        "minecraft-26.2-pre-1" = _t1NjWlHI;
        "minecraft-26.2-pre-2" = _t1NjWlHI;
        "minecraft-26.2-pre-3" = _t1NjWlHI;
        "minecraft-26.2-pre-4" = _t1NjWlHI;
        "minecraft-26.2-pre-5" = _t1NjWlHI;
        "minecraft-26.2-pre-6" = _t1NjWlHI;
        "minecraft-26.2-rc-1" = _t1NjWlHI;
        "minecraft-26.2-rc-2" = _t1NjWlHI;
        "minecraft-26.2" = _t1NjWlHI;
        "minecraft-26.3-snapshot-1" = _t1NjWlHI;
        "minecraft-26.3-snapshot-2" = _t1NjWlHI;
        "minecraft-26.3-snapshot-3" = _t1NjWlHI;
        "minecraft-26.3-snapshot-4" = _t1NjWlHI;
        "minecraft-26.3-snapshot-5" = _t1NjWlHI;
        "minecraft-26.3-snapshot-6" = _t1NjWlHI;
        "minecraft-26.3-snapshot-7" = _t1NjWlHI;
        "minecraft-26.3-snapshot-8" = _t1NjWlHI;
        "minecraft-26.3-snapshot-9" = _t1NjWlHI;
        "pkg-1.2" = _sT5tjIMC;
        "pkg-1.1" = _8pr0OD0Y;
        "pkg-1.3" = _ziaRKZA0;
        "pkg-2.0" = _t1NjWlHI;
