...
let
    ...
    in {
        ...
        "pkg-1.0.5" = _Prv2SePV;
        "pkg-1.0.6" = _BZsMQ4z6;
        "pkg-1.0.7-alpha" = _GZiU9pzg;
        "pkg-1.0.7" = _UkKCya9V;
        "pkg-1.0.8-alpha" = _7B95wQ25;
        "pkg-1.1.0-alpha" = _KaimAdMR;
        "pkg-mc1.19.4-v1.1.0" = _B9lniCMR;
        "pkg-mc1.20.1-v1.1.0" = _1hz1l6gO;
        "pkg-mc1.20.4-v1.1.0" = _M4lcMY5S;
        "pkg-mc1.20.1-v1.2.0" = _UllBHHAd;
        "pkg-mc1.20.5-v1.2.0" = _cyFybRQ8;
        "pkg-mc1.19.4-v1.2.0" = _apdigLIk;
        "pkg-mc1.20.6-v1.2.1" = _egbH4BbE;
        "pkg-mc1.20.1-v1.2.2" = _TctWKwlg;
        "pkg-mc1.19.4-v1.2.2" = _t45cqKd2;
        "pkg-mc1.20.6-v1.3.0" = _SBNFSZd9;
        "pkg-mc1.19.4-v1.3.0" = _5aZL0xKQ;
        "pkg-mc1.21-v1.3.0" = _2stppEWf;
        "pkg-mc1.19.4-v1.4.0" = _E3Nic3V2;
        "pkg-mc1.20.6-v1.4.0" = _oiFCpym6;
        "pkg-mc1.21-v1.4.0" = _Yh27T1UW;
        "pkg-mc1.21-v1.4.2" = _36vfD80o;
        "pkg-mc1.21-v1.5.0" = _mUBG0fin;
        "pkg-mc1.20.6-v1.5.0" = _E7mWiN3O;
        "pkg-mc1.19.4-v1.5.0" = _vQ2MO7pk;
        "pkg-mc1.21-v1.6.0" = _ecjGcib8;
        "pkg-mc1.19.4-v1.6.0" = _fLRN5Mz2;
        "pkg-mc1.20.6-v1.6.0" = _IFABwrWa;
        "pkg-mc1.19.4-v1.6.1" = _qZJsoyK5;
        "pkg-mc1.20.1-v1.6.1" = _Q6YU8Jak;
        "pkg-mc1.19.4-v1.7.0" = _Eim3fhfn;
        "pkg-mc1.21-v1.7.0" = _hXLTS5f8;
        "pkg-mc1.20.6-v1.7.0" = _XJKyhhYM;
        "pkg-mc1.20.6-v1.8.0" = _jPPxdkJA;
        "pkg-mc1.19.4-v1.8.0" = _e6LrSPK1;
        "pkg-mc1.21.1-v1.8.0" = _9Gdr6QwW;
        "pkg-mc1.21-v1.8.0" = _jRwoyJ15;
        "pkg-mc1.20.1-v1.6.2" = _BOTA6ONZ;
        "pkg-mc1.21.1-v1.9.0" = _lyf39Ywg;
        "pkg-mc1.19.4-v1.9.0" = _eYaX8WC1;
        "pkg-mc1.20.6-v1.9.0" = _mUOdkjto;
        "pkg-v1.9.1-mc1.21.1" = _4wpX4DYN;
        "pkg-v1.9.1-mc1.21.2" = _llZou5C2;
        "pkg-v1.9.1-mc1.20.6" = _Ul89w9XA;
        "pkg-v1.9.1-mc1.19.4" = _cnklNfwm;
        "pkg-v1.9.2-mc1.21.3" = _sqt9SheK;
        "pkg-v1.10.0-mc1.20.6" = _N1leEnhY;
        "pkg-v1.10.0-mc1.21.4" = _S6yOz6Nm;
        "pkg-v1.10.0-mc1.21.1" = _X8b59DRM;
        "pkg-v1.10.1-mc1.21.4" = _sc4dyMqa;
        "pkg-v1.10.1-mc1.21.1" = _eboI0iQ3;
        "pkg-v1.10.1-mc1.20.6" = _Ts64zzc5;
        "pkg-v1.11.0-mc1.21.1" = _5SbzXjBU;
        "pkg-v1.11.0-mc1.20.6" = _lKRi7hZc;
        "pkg-v1.11.0-mc1.21.4" = _RBhgZVXu;
        "pkg-v1.11.1-mc1.21.4" = _8j4TeEps;
        "pkg-v1.11.1-mc1.20.6" = _Ckc6HOI2;
        "pkg-v1.11.1-mc1.21.1" = _HrvTXk0a;
        "pkg-v1.11.2-mc1.21.4" = _wVrT5UFZ;
        "pkg-v1.11.2-mc1.21.1" = _ml82XVFd;
        "pkg-v1.11.2-mc1.20.6" = _xMS5UZIZ;
        "pkg-v1.11.4-beta-mc1.21.5" = _NoisCJMs;
        "pkg-v1.11.5-mc1.21.5" = _21UbmG7A;
        "pkg-v1.12.2-mc1.21.4" = _Rzie4gC0;
        "pkg-v1.12.2-mc1.21.5" = _ERmkNlT3;
        "pkg-v1.12.3-mc1.21.4" = _rDeEGrrc;
        "pkg-v1.12.3-mc1.21.5" = _kOCwONYV;
        "pkg-v1.12.3-mc1.21.6" = _ybYYYe0p;
        "pkg-v1.12.3-mc1.21.7" = _TJcmVyc3;
        "pkg-v1.12.3-mc1.21.8" = _kixrizgq;
        "pkg-v1.12.4-mc1.21.9" = _YJsDb7BG;
        "pkg-v1.12.4-mc1.21.10" = _A4yNUErT;
        "pkg-v1.12.5-mc1.21.11" = _3dvvAnjp;
