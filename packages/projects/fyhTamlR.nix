...
let
    versions = (let
        ...
        _9EXM2RCe = {
            "id" = "9EXM2RCe";
            "file" = "myluckyblock-fabric-1.21-2.9.0.jar";
            "hash" = "sha512-4gz6AQ9MUiUigrqpZmA9u+14fW5ttLwGGJ5Nozj2IlIVL4+PCox6RgLNycooHyWhmQ+bNErhAWVo14tmzSG4Lw==";
        };
        _PXb6tkzX = {
            "id" = "PXb6tkzX";
            "file" = "myluckyblock-fabric-1.21.2-2.9.0.jar";
            "hash" = "sha512-lhwwqePSD3nkOrcPCUXlUMqPskldBmGuxfPaJ2xJc8mouj9sOaYrngA1f6LvLhnn684cm2cR07zFFqehCfNfWg==";
        };
        _JKdZaSOr = {
            "id" = "JKdZaSOr";
            "file" = "myluckyblock-fabric-1.21.4-2.9.0.jar";
            "hash" = "sha512-5yiwgOPEobbeb5SPKjO5XKLmON31Ft18/SX4wHZHiYdjfNgOFY8yyZbEvlo3sR1PvPG1xe4qc6uCeTPkp8sdLg==";
        };
        _RtcMqBBb = {
            "id" = "RtcMqBBb";
            "file" = "myluckyblock-fabric-1.21.5-2.9.0.jar";
            "hash" = "sha512-QlV7qY4Vd9LgJPLhbqQAotipXmHFEpwGTqHhAKLqUqnNsTQtk3r4DE3O3QZLELezGb+5YFeLnrBe+CwgKe3bZA==";
        };
        _rqjG1asw = {
            "id" = "rqjG1asw";
            "file" = "myluckyblock-fabric-1.21.6-2.9.0.jar";
            "hash" = "sha512-Oww8RT+DvUZiYx/FrTKWrlihbvmGd2Yb3OSYBpGhk3phpUdOUfgvJfRCC2oX0U9APurvL1yoN4VA+2EdX5E5Tg==";
        };
        _qHAFC0OD = {
            "id" = "qHAFC0OD";
            "file" = "myluckyblock-fabric-1.21.11-2.9.0.jar";
            "hash" = "sha512-fn18g7S6r0QK2C2MtN5MrPTELbPkpbj5RLtOWvOr+u5RltISscx5IYK+qRXRsBGcewkVHVMbynwJJTTdtJMqrA==";
        };
        _IeGfu67C = {
            "id" = "IeGfu67C";
            "file" = "myluckyblock-fabric-26.1-2.9.0.jar";
            "hash" = "sha512-T7J49+P2g0V33LUhEaCHUqIVR30sU3gv6a45eYR1G+sV7tewfBGTTswsk1uxvgv1G9lR+gJ7rs7Re+zhrtrRkw==";
        };
        _zajoCXp9 = {
            "id" = "zajoCXp9";
            "file" = "myluckyblock-fabric-26.2-2.9.0.jar";
            "hash" = "sha512-BdJEzrox0n1AicmkUiRxeFzdxfQbHmhlXbAqNHyb5PSlRTdT2a1JvXAHlJ3j5XQk8hNpNKAoMdpONOfoEMH+kQ==";
        };
        _lEiRbmSH = {
            "id" = "lEiRbmSH";
            "file" = "myluckyblock-fabric-26.3-2.9.0.jar";
            "hash" = "sha512-vSUt5z7ixrgGwIUqsvaHE0K6HRXZdoeIL76NDJAG3YkOOruzd5zJDgVNiezR6wu5M/haqiXpHUAk0aUgZts++Q==";
        };
        _QeuUtJgB = {
            "id" = "QeuUtJgB";
            "file" = "myluckyblock-neoforge-1.21-2.9.0.jar";
            "hash" = "sha512-QBhNPGqnk1BMsqXNFhp6pZDNk8Wj2k8K6u9kkNUFzovCLlMD1WCxuXmebD4FAKQIwO46h9tpVxY7GZHyi6vz/g==";
        };
        _d3JtdBzh = {
            "id" = "d3JtdBzh";
            "file" = "myluckyblock-neoforge-1.21.2-2.9.0.jar";
            "hash" = "sha512-+8hKPJ7flYXPLCAk/zRjTRrU/Jj7S9t0VAvCB9saltSaDRIis0cur3qPGUAdJKtMioO+QT6meqFhlYztf1KJBw==";
        };
        _kI84KAwA = {
            "id" = "kI84KAwA";
            "file" = "myluckyblock-neoforge-1.21.4-2.9.0.jar";
            "hash" = "sha512-AmLZYlL8CMGcxtkbQXgkR0F7JnFEshZQrB1+U7vGO3OnBEkei5UkxkNlAl9NR9Ct5/unMuEPN6cXg4WDEHhG2g==";
        };
        _TUUCGzNC = {
            "id" = "TUUCGzNC";
            "file" = "myluckyblock-neoforge-1.21.5-2.9.0.jar";
            "hash" = "sha512-GNIPjgNaMCRcoaG0aMavxIaCFk69/L1+j6ne5WvfgnbYO60CgbA851XOJlDDMzy17SRbgXXDA1mrHIX1YUY6Zw==";
        };
        _JtPQUjwv = {
            "id" = "JtPQUjwv";
            "file" = "myluckyblock-neoforge-1.21.6-2.9.0.jar";
            "hash" = "sha512-VHOErlrXwR9nL8YevWIgv75ZHuG61NvyAVj4GqHQCVz7IdAcDHAJGKjAv3gOXPBi55z6LUSVy6IaWeejHLPkzw==";
        };
        _6jULPf3k = {
            "id" = "6jULPf3k";
            "file" = "myluckyblock-neoforge-1.21.11-2.9.0.jar";
            "hash" = "sha512-gj230cSfbrSTxIq3DwexBwLip6cutOD7PwANijdXltEIlqfmK4iKpY1s1eEGMaR/Nb762IxoyII4QxIGIK0tlQ==";
        };
        _p7YMexUB = {
            "id" = "p7YMexUB";
            "file" = "myluckyblock-neoforge-26.1-2.9.0.jar";
            "hash" = "sha512-dbsSm28eTtntuj+DqlinwKunOq7fFZ/TPddW+Lv28AiIs07FK1E4+0l2QdvzRViYXpB1MecJ53JDYtBpwU10Sg==";
        };
        _u4wuBvgd = {
            "id" = "u4wuBvgd";
            "file" = "myluckyblock-neoforge-26.2-2.9.0.jar";
            "hash" = "sha512-CJ1UWDJpWb8U203IDWR0HhDoYXrwWzUaxa5DFBmgOh6i8vWHkY7eMnBy6Ld1h3VOGcBECvBVOGYoNUNrcJSexQ==";
        };
        _u0M67Auh = {
            "id" = "u0M67Auh";
            "file" = "myluckyblock-neoforge-26.3-2.9.0.jar";
            "hash" = "sha512-aRYGZ9g97xpLuqlXg5IyBxlmNeGnKEKod3/RNmgPJsufYIf/V5UooXfgDXbAC1ODMJKunlh1ypiEVBTXty1kKw==";
        };
    in {
        "p7MIH88D" = _p7MIH88D;
        "ek7i1pd0" = _ek7i1pd0;
        ...
        "u4wuBvgd" = _u4wuBvgd;
        "u0M67Auh" = _u0M67Auh;
        "fabric-1.21" = _9EXM2RCe;
        "fabric-1.21.1" = _9EXM2RCe;
        "fabric-1.21.2" = _PXb6tkzX;
        "fabric-1.21.3" = _PXb6tkzX;
        "fabric-1.21.4" = _JKdZaSOr;
        "fabric-25w05a" = _wL3jul2x;
        "fabric-25w06a" = _wL3jul2x;
        "fabric-1.21.5" = _RtcMqBBb;
        "fabric-1.21.6" = _rqjG1asw;
        "fabric-1.21.7" = _rqjG1asw;
        "fabric-1.21.8" = _rqjG1asw;
        "fabric-1.21.9" = _rqjG1asw;
        "fabric-1.21.10" = _rqjG1asw;
        ...
        "fabric-26.1" = _IeGfu67C;
        "fabric-26.1.1" = _IeGfu67C;
        "fabric-26.1.2" = _IeGfu67C;
        ...
        "fabric-26.2" = _zajoCXp9;
        "fabric-26.3" = _lEiRbmSH;
        "neoforge-1.21" = _QeuUtJgB;
        "neoforge-1.21.1" = _QeuUtJgB;
        "neoforge-1.21.2" = _d3JtdBzh;
        "neoforge-1.21.3" = _d3JtdBzh;
        "neoforge-1.21.4" = _kI84KAwA;
        "neoforge-1.21.5" = _TUUCGzNC;
        "neoforge-1.21.6" = _JtPQUjwv;
        "neoforge-1.21.7" = _JtPQUjwv;
        "neoforge-1.21.8" = _JtPQUjwv;
        "neoforge-1.21.9" = _JtPQUjwv;
        "neoforge-1.21.10" = _JtPQUjwv;
        "neoforge-1.21.11" = _6jULPf3k;
        ...
        "neoforge-26.1" = _p7YMexUB;
        "neoforge-26.1.1" = _p7YMexUB;
        "neoforge-26.1.2" = _p7YMexUB;
        ...
        "neoforge-26.2" = _u4wuBvgd;
        "neoforge-26.3" = _u0M67Auh;
        "pkg-1.2.0-1.21-Fabric" = _p7MIH88D;
        "pkg-1.2.0-1.21.2-Fabric" = _ek7i1pd0;
        "pkg-1.2.0-1.21.4-Fabric" = _buJeZXWI;
        "pkg-1.2.0-25w05a-Fabric" = _wL3jul2x;
        "pkg-1.2.1-1.21-Fabric" = _n3yXj2DU;
        "pkg-2.0.1-1.21-Fabric" = _bLNz19G5;
        "pkg-2.0.1-1.21-NeoForge" = _1ZRPtG5G;
        "pkg-2.0.1-1.21.2-Fabric" = _h3vOWZGg;
        "pkg-2.0.1-1.21.2-NeoForge" = _6Fzcsdb4;
        "pkg-2.0.1-1.21.4-Fabric" = _B4bKx5eg;
        "pkg-2.0.1-1.21.4-NeoForge" = _hb248mYP;
        "pkg-2.1.0-1.21-Fabric" = _EzDYoVKj;
        "pkg-2.1.0-1.21-NeoForge" = _DuypVjA0;
        "pkg-2.1.0-1.21.2-Fabric" = _4vRXXDYN;
        "pkg-2.1.0-1.21.2-NeoForge" = _CIYGv64s;
        "pkg-2.1.0-1.21.4-Fabric" = _9Ef1Umq0;
        "pkg-2.1.0-1.21.4-NeoForge" = _gdoRglYW;
        "pkg-2.1.0-1.21.5-Fabric" = _mCvdw45L;
        "pkg-2.1.0-1.21.5-NeoForge" = _2G4IV6FC;
        "pkg-2.2.1-1.21-Fabric" = _qdTChFN8;
        "pkg-2.2.1-1.21-NeoForge" = _plD1PpNl;
        "pkg-2.2.1-1.21.2-Fabric" = _X6LsWDQi;
        "pkg-2.2.1-1.21.2-NeoForge" = _l5UFxJdS;
        "pkg-2.2.1-1.21.4-Fabric" = _aqgimbmZ;
        "pkg-2.2.1-1.21.4-NeoForge" = _lL0CqrKL;
        "pkg-2.2.1-1.21.5-Fabric" = _FGaVyuuZ;
        "pkg-2.2.1-1.21.5-NeoForge" = _ZbaTD6EG;
        "pkg-2.2.2-1.21.6-Fabric" = _lLydfdyH;
        "pkg-2.2.2-1.21.6-NeoForge" = _pKwiZPyU;
        "pkg-2.2.3-1.21.6-Fabric" = _GcipE9hH;
        "pkg-2.2.3-1.21.6-NeoForge" = _IESHOjBb;
        "pkg-2.3.0-1.21-Fabric" = _S8fIV4JK;
        "pkg-2.3.0-1.21-NeoForge" = _4Tg3sYVD;
        "pkg-2.3.0-1.21.2-Fabric" = _GAgLsiNO;
        "pkg-2.3.0-1.21.2-NeoForge" = _juMTVlum;
        "pkg-2.3.0-1.21.4-Fabric" = _WQ9buyd7;
        "pkg-2.3.0-1.21.4-NeoForge" = _DKJ0EIry;
        "pkg-2.3.0-1.21.5-Fabric" = _Aqb70kDD;
        "pkg-2.3.0-1.21.5-NeoForge" = _JqnWqmOo;
        "pkg-2.3.0-1.21.6-Fabric" = _AcQgWFeG;
        "pkg-2.3.0-1.21.6-NeoForge" = _UeX92sRb;
        "pkg-2.3.1-1.21.6-Fabric" = _YSctjWhG;
        "pkg-2.3.1-1.21.6-NeoForge" = _T8yAfXNt;
        "pkg-2.4.0-1.21-Fabric" = _C4iIN9sL;
        "pkg-2.4.0-1.21-NeoForge" = _vVC9mzh3;
        "pkg-2.4.0-1.21.2-Fabric" = _b9tyWtwR;
        "pkg-2.4.0-1.21.2-NeoForge" = _rLLRGzSd;
        "pkg-2.4.0-1.21.4-Fabric" = _4aVYJfDu;
        "pkg-2.4.0-1.21.4-NeoForge" = _OwdDxpqz;
        "pkg-2.4.0-1.21.5-Fabric" = _Yxpmc8lt;
        "pkg-2.4.0-1.21.5-NeoForge" = _7ibaXMTR;
        "pkg-2.4.0-1.21.6-Fabric" = _XwNBSIte;
        "pkg-2.4.0-1.21.6-NeoForge" = _x5GE42X0;
        "pkg-2.5.0-1.21-Fabric" = _YCFNL5ud;
        "pkg-2.5.0-1.21-NeoForge" = _9TW4VtDi;
        "pkg-2.5.0-1.21.2-Fabric" = _yXXxZm8A;
        "pkg-2.5.0-1.21.2-NeoForge" = _9uDOGi1C;
        "pkg-2.5.0-1.21.4-Fabric" = _BaV38dOa;
        "pkg-2.5.0-1.21.4-NeoForge" = _KlTrcbPb;
        "pkg-2.5.0-1.21.5-Fabric" = _TTu8ac87;
        "pkg-2.5.0-1.21.5-NeoForge" = _Un01GWM8;
        "pkg-2.5.0-1.21.6-Fabric" = _qp75gZrD;
        "pkg-2.5.0-1.21.6-NeoForge" = _ppCeRsWb;
        "pkg-2.6.0-1.21-Fabric" = _ABeHVFXi;
        "pkg-2.6.0-1.21-NeoForge" = _jFebjMEe;
        "pkg-2.6.0-1.21.2-Fabric" = _5amZMryz;
        "pkg-2.6.0-1.21.2-NeoForge" = _Ti2gllVi;
        "pkg-2.6.0-1.21.4-Fabric" = _b0cC8IeJ;
        "pkg-2.6.0-1.21.4-NeoForge" = _uHHMFG2s;
        "pkg-2.6.0-1.21.5-Fabric" = _IHPtNc6e;
        "pkg-2.6.0-1.21.5-NeoForge" = _EkLMJd4v;
        "pkg-2.6.0-1.21.6-Fabric" = _ISUmXgx7;
        "pkg-2.6.0-1.21.6-NeoForge" = _dVARTzQT;
        "pkg-2.6.0-1.21.11-Fabric" = _VSAqHyBn;
        "pkg-2.6.0-1.21.11-NeoForge" = _k2DIkcqF;
        "pkg-2.6.1-26.1-snapshot-2-Fabric" = _2HhuMg7A;
        "pkg-2.6.1-26.1-snapshot-2-NeoForge" = _9cdsA69j;
        "pkg-2.7.1-1.21-Fabric" = _bkiyJsQY;
        "pkg-2.7.1-1.21-NeoForge" = _36tPINEq;
        "pkg-2.7.1-1.21.2-Fabric" = _x4XWhXk5;
        "pkg-2.7.1-1.21.2-NeoForge" = _abtcgFt7;
        "pkg-2.7.1-1.21.4-Fabric" = _JMCYXNFi;
        "pkg-2.7.1-1.21.4-NeoForge" = _EgsZoY4o;
        "pkg-2.7.1-1.21.5-Fabric" = _1meYw2KX;
        "pkg-2.7.1-1.21.5-NeoForge" = _qUQw4U2W;
        "pkg-2.7.1-1.21.6-Fabric" = _8Yrp2fEq;
        "pkg-2.7.1-1.21.6-NeoForge" = _q25xcS0B;
        "pkg-2.7.1-1.21.11-Fabric" = _jYEoHu32;
        "pkg-2.7.1-1.21.11-NeoForge" = _WbsKfEDi;
        "pkg-2.7.1-26.1-Fabric" = _93CeXuBf;
        "pkg-2.7.1-26.1-NeoForge" = _mUK9pvUc;
        "pkg-2.7.2-1.21-Fabric" = _M0hjHKrd;
        "pkg-2.7.2-1.21-NeoForge" = _Ejkdaiqt;
        "pkg-2.7.2-1.21.2-Fabric" = _Vi8fPV61;
        "pkg-2.7.2-1.21.2-NeoForge" = _RSjG2K3V;
        "pkg-2.7.2-1.21.4-Fabric" = _BHBK5Rt6;
        "pkg-2.7.2-1.21.4-NeoForge" = _RiT9ZvZf;
        "pkg-2.7.2-1.21.5-Fabric" = _JBsz91Sq;
        "pkg-2.7.2-1.21.5-NeoForge" = _FbLDM21W;
        "pkg-2.7.2-1.21.6-Fabric" = _V69ZVBub;
        "pkg-2.7.2-1.21.6-NeoForge" = _zgRsQtZM;
        "pkg-2.7.2-1.21.11-Fabric" = _c4HEOHYr;
        "pkg-2.7.2-1.21.11-NeoForge" = _P38MrZZE;
        "pkg-2.7.2-26.1-Fabric" = _4WrcqLME;
        "pkg-2.7.2-26.1-NeoForge" = _2VBe67q2;
        "pkg-2.7.3-26.1-Fabric" = _vCpim2v9;
        "pkg-2.7.3-26.1-NeoForge" = _iy31SYCs;
        "pkg-2.7.4-26.1-NeoForge" = _sijEo968;
        "pkg-2.7.5-26.1-NeoForge" = _3GfnCuEX;
        "pkg-2.8.0-1.21-Fabric" = _1FDuGsHj;
        "pkg-2.8.0-1.21.2-Fabric" = _ABRgpnbN;
        "pkg-2.8.0-1.21.4-Fabric" = _N6RSkZ5C;
        "pkg-2.8.0-1.21.5-Fabric" = _hfeSKthz;
        "pkg-2.8.0-1.21.6-Fabric" = _wTtrKX9W;
        "pkg-2.8.0-1.21.11-Fabric" = _XaHodCFS;
        "pkg-2.8.0-26.1-Fabric" = _Rube20Tn;
        "pkg-2.8.0-26.2-Fabric" = _9qUJCJI7;
        "pkg-2.8.0-1.21-NeoForge" = _sFm4W7Td;
        "pkg-2.8.0-1.21.2-NeoForge" = _mrrkF3Zw;
        "pkg-2.8.0-1.21.4-NeoForge" = _A48dvNya;
        "pkg-2.8.0-1.21.5-NeoForge" = _1vpgHyiC;
        "pkg-2.8.0-1.21.6-NeoForge" = _JcXJu76u;
        "pkg-2.8.0-1.21.11-NeoForge" = _sCXXfCrg;
        "pkg-2.8.0-26.1-NeoForge" = _Wqc6Cc8z;
        "pkg-2.8.0-26.2-NeoForge" = _bkbMN2QI;
        "pkg-2.9.0-1.21-Fabric" = _9EXM2RCe;
        "pkg-2.9.0-1.21.2-Fabric" = _PXb6tkzX;
        "pkg-2.9.0-1.21.4-Fabric" = _JKdZaSOr;
        "pkg-2.9.0-1.21.5-Fabric" = _RtcMqBBb;
        "pkg-2.9.0-1.21.6-Fabric" = _rqjG1asw;
        "pkg-v2.9.0-1.21.11-Fabric" = _qHAFC0OD;
        "pkg-2.9.0-26.1-Fabric" = _IeGfu67C;
        "pkg-2.9.0-26.2-Fabric" = _zajoCXp9;
        "pkg-2.9.0-26.3-Fabric" = _lEiRbmSH;
        "pkg-2.9.0-1.21-NeoForge" = _QeuUtJgB;
        "pkg-2.9.0-1.21.2-NeoForge" = _d3JtdBzh;
        "pkg-2.9.0-1.21.4-NeoForge" = _kI84KAwA;
        "pkg-2.9.0-1.21.5-NeoForge" = _TUUCGzNC;
        "pkg-2.9.0-1.21.6-NeoForge" = _JtPQUjwv;
        "pkg-2.9.0-1.21.11-NeoForge" = _6jULPf3k;
        "pkg-2.9.0-26.1-NeoForge" = _p7YMexUB;
        "pkg-2.9.0-26.2-NeoForge" = _u4wuBvgd;
        "pkg-2.9.0-26.3-NeoForge" = _u0M67Auh;
        "default" = _u0M67Auh;
    });
