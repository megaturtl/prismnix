...
let
    ...
    in {
        ...
        "pkg-14.0.0+forge-1.19.3" = _3px1o1NW;
        "pkg-12.1.1+forge-1.18.2" = _xQXqtOHT;
        "pkg-12.0.0+fabric-1.18.2" = _Z4w0RTb9;
        "pkg-15.0.1+fabric-1.19.4" = _8ff8MGdF;
        "pkg-15.0.1+forge-1.19.4" = _Tuku9Imr;
        "pkg-16.0.1+fabric-1.20" = _tzm0Vhnd;
        "pkg-16.0.1+forge-1.20" = _ucRfAxAR;
        "pkg-16.0.2+fabric-1.20" = _78Nwl67Q;
        "pkg-16.0.2+forge-1.20" = _xAFl7siQ;
        "pkg-17.0.0+fabric-1.20.2" = _i3V1OGw5;
        "pkg-17.0.0+forge-1.20.2" = _iIOAmGQz;
        "pkg-17.0.0+neoforge-1.20.2" = _oFpI6aJS;
        "pkg-18.0.1+fabric-1.20.4" = _JVydDk1b;
        "pkg-18.0.1+forge-1.20.4" = _godPCWei;
        "pkg-18.0.1+neoforge-1.20.4" = _Yd0o7UsX;
        "pkg-19.0.1+fabric-1.20.6" = _Ozar1vAe;
        "pkg-19.0.1+forge-1.20.6" = _sgl8w10x;
        "pkg-19.0.1+neoforge-1.20.6" = _eu2OzQRf;
        "pkg-19.0.2+fabric-1.20.6" = _3CpKWOJi;
        "pkg-19.0.2+forge-1.20.6" = _BRNQi1Ze;
        "pkg-19.0.2+neoforge-1.20.6" = _8Lc9CmFS;
        "pkg-21.0.1+fabric-1.21" = _eYDtoFkI;
        "pkg-21.0.1+forge-1.21" = _TLDIzEHm;
        "pkg-21.0.1+neoforge-1.21" = _UnESvOj6;
        "pkg-21.1.1+fabric-1.21.1" = _xYVP6bnv;
        "pkg-21.1.1+forge-1.21.1" = _vsXaBs7Q;
        "pkg-21.1.1+neoforge-1.21.1" = _SrUuoYhR;
        "pkg-21.3.1+fabric-1.21.3" = _LZbXZLya;
        "pkg-21.3.1+neoforge-1.21.3" = _qQqPeMPm;
        "pkg-21.3.2+fabric-1.21.3" = _WrmFijGh;
        "pkg-21.4.1+fabric-1.21.4" = _HOeaFgIE;
        "pkg-21.4.1+neoforge-1.21.4" = _OczkPV27;
        "pkg-21.4.2+forge-1.21.4" = _8QdPnima;
        "pkg-21.4.3+fabric-1.21.4" = _7vW04R6n;
        "pkg-16.0.3+fabric-1.20" = _ULqC8wYD;
        "pkg-21.1.2+fabric-1.21.1" = _nbKLMNpk;
        "pkg-21.5.2+fabric-1.21.5" = _Soai6Ivz;
        "pkg-21.5.2+neoforge-1.21.5" = _imzBKZLM;
        "pkg-21.5.3+forge-1.21.5" = _iVB8jPZ8;
        "pkg-21.6.1+fabric-1.21.6" = _ffiZfD4W;
        "pkg-21.6.1+neoforge-1.21.6" = _bb30x3w5;
        "pkg-21.6.2+forge-1.21.6" = _UXrVl0GJ;
        "pkg-21.7.1+fabric-1.21.7" = _gfmlFHeR;
        "pkg-21.7.1+forge-1.21.7" = _nGNHW58J;
        "pkg-21.7.1+neoforge-1.21.7" = _zlq4sT87;
        "pkg-21.8.1+forge-1.21.8" = _JZWEzXDP;
        "pkg-21.8.1+neoforge-1.21.8" = _iGWSyJLl;
        "pkg-21.8.1+fabric-1.21.8" = _xnYsYfTk;
        "pkg-21.8.2+fabric-1.21.8" = _yS3FX9ms;
        "pkg-21.8.2+forge-1.21.8" = _vrv7LDcR;
        "pkg-21.8.2+neoforge-1.21.8" = _WeQX4ehr;
        "pkg-21.9.1+fabric-1.21.9" = _Py5qVhRh;
        "pkg-21.9.1+neoforge-1.21.9" = _upCdjNSc;
        "pkg-21.10.1+forge-1.21.10" = _RMGbFCB2;
        "pkg-21.10.1+fabric-1.21.10" = _yvXGxsRe;
        "pkg-21.10.1+neoforge-1.21.10" = _yr9Ir8w9;
        "pkg-21.11.1+neoforge-1.21.11" = _7Md6KCf9;
        "pkg-21.11.1+fabric-1.21.11" = _CzvUfziy;
        "pkg-16.0.4+fabric-1.20" = _W4vIbFgI;
        "pkg-16.0.4+forge-1.20" = _KS3rQjOi;
        "pkg-21.11.3+fabric-1.21.11" = _zbo9BLey;
        "pkg-21.11.3+forge-1.21.11" = _2SLMhdcB;
        "pkg-21.11.3+neoforge-1.21.11" = _OPyNwnuY;
        "pkg-26.1.0.1+neoforge-26.1" = _hRBrw5AT;
        "pkg-26.1.0.1+fabric-26.1" = _sCj7RvLx;
        "pkg-21.1.3+fabric-1.21.1" = _scbQTTCh;
        "pkg-21.1.3+forge-1.21.1" = _DkFPd6PU;
