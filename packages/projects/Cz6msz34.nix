...
let
    versions = (let
        ...
        _nfyIDXIm = {
            "id" = "nfyIDXIm";
            "file" = "AxGraves-1.30.0.jar";
            "hash" = "sha512-1jHB0h19yfNRZnefjIyocCY3OpCzrrOCnkuFoi0XxVhXraZJQp5ABUgI+rF2jZ0WQhKM/rsPfoSd/mlNalNFcg==";
        };
        _R0C3Hs8z = {
            "id" = "R0C3Hs8z";
            "file" = "AxGraves-1.31.0.jar";
            "hash" = "sha512-GQTT1f5GD/9gqgAg7xHB85pM/wHquzwGK1Q9H/4yJ3ktIz46tle0xHjWO7pknfEGnYlz4HtG9IizoKI1QUJufA==";
        };
    in {
        "oobYCmPT" = _oobYCmPT;
        "xQov8Y9h" = _xQov8Y9h;
        ...
        "bukkit-1.20.2" = _R0C3Hs8z;
        "bukkit-1.20.3" = _R0C3Hs8z;
        "bukkit-1.20.4" = _R0C3Hs8z;
        "bukkit-1.20.5" = _R0C3Hs8z;
        "bukkit-1.20.6" = _R0C3Hs8z;
        "bukkit-1.21" = _R0C3Hs8z;
        "bukkit-1.21.1" = _R0C3Hs8z;
        "bukkit-1.21.2" = _R0C3Hs8z;
        "bukkit-1.21.3" = _R0C3Hs8z;
        "bukkit-1.21.4" = _R0C3Hs8z;
        "bukkit-1.21.5" = _R0C3Hs8z;
        "bukkit-1.21.6" = _R0C3Hs8z;
        "bukkit-1.21.7" = _R0C3Hs8z;
        "bukkit-1.21.8" = _R0C3Hs8z;
        "bukkit-1.21.9" = _R0C3Hs8z;
        "bukkit-1.21.10" = _R0C3Hs8z;
        "bukkit-1.21.11" = _R0C3Hs8z;
        "bukkit-26.1" = _R0C3Hs8z;
        "bukkit-26.1.1" = _R0C3Hs8z;
        "bukkit-26.1.2" = _R0C3Hs8z;
        "bukkit-26.2" = _R0C3Hs8z;
        ...
        "folia-1.20.2" = _R0C3Hs8z;
        "folia-1.20.3" = _R0C3Hs8z;
        "folia-1.20.4" = _R0C3Hs8z;
        "folia-1.20.5" = _R0C3Hs8z;
        "folia-1.20.6" = _R0C3Hs8z;
        "folia-1.21" = _R0C3Hs8z;
        "folia-1.21.1" = _R0C3Hs8z;
        "folia-1.21.2" = _R0C3Hs8z;
        "folia-1.21.3" = _R0C3Hs8z;
        "folia-1.21.4" = _R0C3Hs8z;
        "folia-1.21.5" = _R0C3Hs8z;
        "folia-1.21.6" = _R0C3Hs8z;
        "folia-1.21.7" = _R0C3Hs8z;
        "folia-1.21.8" = _R0C3Hs8z;
        "folia-1.21.9" = _R0C3Hs8z;
        "folia-1.21.10" = _R0C3Hs8z;
        "folia-1.21.11" = _R0C3Hs8z;
        "folia-26.1" = _R0C3Hs8z;
        "folia-26.1.1" = _R0C3Hs8z;
        "folia-26.1.2" = _R0C3Hs8z;
        "folia-26.2" = _R0C3Hs8z;
        ...
        "paper-1.20.2" = _R0C3Hs8z;
        "paper-1.20.3" = _R0C3Hs8z;
        "paper-1.20.4" = _R0C3Hs8z;
        "paper-1.20.5" = _R0C3Hs8z;
        "paper-1.20.6" = _R0C3Hs8z;
        "paper-1.21" = _R0C3Hs8z;
        "paper-1.21.1" = _R0C3Hs8z;
        "paper-1.21.2" = _R0C3Hs8z;
        "paper-1.21.3" = _R0C3Hs8z;
        "paper-1.21.4" = _R0C3Hs8z;
        "paper-1.21.5" = _R0C3Hs8z;
        "paper-1.21.6" = _R0C3Hs8z;
        "paper-1.21.7" = _R0C3Hs8z;
        "paper-1.21.8" = _R0C3Hs8z;
        "paper-1.21.9" = _R0C3Hs8z;
        "paper-1.21.10" = _R0C3Hs8z;
        "paper-1.21.11" = _R0C3Hs8z;
        "paper-26.1" = _R0C3Hs8z;
        "paper-26.1.1" = _R0C3Hs8z;
        "paper-26.1.2" = _R0C3Hs8z;
        "paper-26.2" = _R0C3Hs8z;
        ...
        "purpur-1.20.2" = _R0C3Hs8z;
        "purpur-1.20.3" = _R0C3Hs8z;
        "purpur-1.20.4" = _R0C3Hs8z;
        "purpur-1.20.5" = _R0C3Hs8z;
        "purpur-1.20.6" = _R0C3Hs8z;
        "purpur-1.21" = _R0C3Hs8z;
        "purpur-1.21.1" = _R0C3Hs8z;
        "purpur-1.21.2" = _R0C3Hs8z;
        "purpur-1.21.3" = _R0C3Hs8z;
        "purpur-1.21.4" = _R0C3Hs8z;
        "purpur-1.21.5" = _R0C3Hs8z;
        "purpur-1.21.6" = _R0C3Hs8z;
        "purpur-1.21.7" = _R0C3Hs8z;
        "purpur-1.21.8" = _R0C3Hs8z;
        "purpur-1.21.9" = _R0C3Hs8z;
        "purpur-1.21.10" = _R0C3Hs8z;
        "purpur-1.21.11" = _R0C3Hs8z;
        "purpur-26.1" = _R0C3Hs8z;
        "purpur-26.1.1" = _R0C3Hs8z;
        "purpur-26.1.2" = _R0C3Hs8z;
        "purpur-26.2" = _R0C3Hs8z;
        ...
        "spigot-1.20.2" = _R0C3Hs8z;
        "spigot-1.20.3" = _R0C3Hs8z;
        "spigot-1.20.4" = _R0C3Hs8z;
        "spigot-1.20.5" = _R0C3Hs8z;
        "spigot-1.20.6" = _R0C3Hs8z;
        "spigot-1.21" = _R0C3Hs8z;
        "spigot-1.21.1" = _R0C3Hs8z;
        "spigot-1.21.2" = _R0C3Hs8z;
        "spigot-1.21.3" = _R0C3Hs8z;
        "spigot-1.21.4" = _R0C3Hs8z;
        "spigot-1.21.5" = _R0C3Hs8z;
        "spigot-1.21.6" = _R0C3Hs8z;
        "spigot-1.21.7" = _R0C3Hs8z;
        "spigot-1.21.8" = _R0C3Hs8z;
        "spigot-1.21.9" = _R0C3Hs8z;
        "spigot-1.21.10" = _R0C3Hs8z;
        "spigot-1.21.11" = _R0C3Hs8z;
        "spigot-26.1" = _R0C3Hs8z;
        "spigot-26.1.1" = _R0C3Hs8z;
        "spigot-26.1.2" = _R0C3Hs8z;
        "spigot-26.2" = _R0C3Hs8z;
        "pkg-1.1.0" = _oobYCmPT;
        "pkg-1.2.0" = _xQov8Y9h;
        "pkg-1.2.1" = _l3YTAkJt;
        "pkg-1.2.2" = _u9ftY4hd;
        ...
        "pkg-1.8.1" = _I9fwkIGI;
        "pkg-1.9.0" = _f7qoQJ6B;
        "pkg-1.10.0" = _ebbN86F0;
        "pkg-1.11.0" = _d2Ve5BhO;
        "pkg-1.11.1" = _cetxULLl;
        "pkg-1.11.2" = _Mx88vIJV;
        "pkg-1.12.0" = _ApbcvF7D;
        "pkg-1.13.0" = _oj1cuTN7;
        "pkg-1.13.1" = _SDVtN1d6;
        "pkg-1.13.2" = _OnTs8FiU;
        "pkg-1.13.3" = _J1ga8xmp;
        "pkg-1.13.4" = _cItMe5lK;
        "pkg-1.13.5" = _QN9oXa8B;
        "pkg-1.13.6" = _V4lEjrPp;
        "pkg-1.14.0" = _H88YHdWJ;
        "pkg-1.14.2" = _xIQh89e7;
        "pkg-1.14.3" = _6b8zfsFe;
        "pkg-1.14.4" = _Y1OM4Wf7;
        "pkg-1.14.5" = _tXbJxNhC;
        "pkg-1.14.6" = _x4VeldwL;
        "pkg-1.15.0" = _qRO7CGFB;
        "pkg-1.15.1" = _sV5nZBy5;
        "pkg-1.16.0" = _iY1VCliU;
        "pkg-1.17.0" = _wKR8vQqz;
        "pkg-1.17.1" = _12mBIJ2C;
        "pkg-1.18.0" = _8jpMx97k;
        "pkg-1.19.0" = _RqVh3kRl;
        "pkg-1.19.1" = _CThxwFS0;
        "pkg-1.19.2" = _6AlmFEIN;
        "pkg-1.19.3" = _hWkFyQn3;
        "pkg-1.19.4" = _sl8YtUEe;
        "pkg-1.20.0" = _knbPGKcD;
        "pkg-1.20.1" = _cxhRBTrs;
        "pkg-1.21.0" = _5w6hDawk;
        "pkg-1.21.1" = _WxaffmgR;
        "pkg-1.22.0" = _rIhVPCWL;
        "pkg-1.22.1" = _4YHG6A1I;
        "pkg-1.22.2" = _aMpQZpoj;
        "pkg-1.22.3" = _5xGzID0b;
        "pkg-1.22.4" = _2QwNCtGG;
        "pkg-1.22.5" = _WRUUGxPE;
        "pkg-1.23.0" = _tBdXN2Ug;
        "pkg-1.23.1" = _9Z1Mg5rd;
        "pkg-1.24.0" = _eIvFwBxP;
        "pkg-1.25.0" = _BTaIA2b1;
        "pkg-1.25.1" = _LBrwPigg;
        "pkg-1.26.0" = _HGDg5Wpw;
        "pkg-1.26.1" = _a57lqR5L;
        "pkg-1.26.2" = _EzItM8zg;
        "pkg-1.27.0" = _Rysg3fB0;
        "pkg-1.28.0" = _rSHiNcdQ;
        "pkg-1.28.1" = _o9IJPqXH;
        "pkg-1.29.0" = _WDYTwhVj;
        "pkg-1.30.0" = _nfyIDXIm;
        "pkg-1.31.0" = _R0C3Hs8z;
        "default" = _R0C3Hs8z;
    });
