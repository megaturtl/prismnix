...
let
    ...
    in {
        ...
        "pkg-1.14-1.2.7-alpha" = _s0HVdTYJ;
        "pkg-1.14-1.2.8-alpha" = _RrxrrgGS;
        "pkg-1.14-1.2.9-alpha" = _Eh0yQrWa;
        "pkg-1.14-1.2.10-alpha" = _TyIcDOFJ;
        "pkg-1.14-1.2.11-alpha" = _bhrFTShr;
        "pkg-1.14-1.2.12-alpha" = _AXJqL25h;
        "pkg-1.15-2.0.0-alpha" = _mJ2TmIRm;
        "pkg-1.15-2.0.1-alpha" = _Se4ilW3w;
        "pkg-1.15-2.1.0-beta" = _makaLfB7;
        "pkg-1.15-2.1.1-beta" = _boyhvs57;
        "pkg-1.15-2.1.2-beta" = _GWgOaD1t;
        "pkg-1.15-2.1.3-beta" = _E8xRqXKJ;
        "pkg-1.15-2.1.4-beta" = _W0QHO4mz;
        "pkg-1.15-2.1.5-beta" = _Rrrm5Hvt;
        "pkg-1.16-3.0.0-beta" = _LFviWkK5;
        "pkg-1.15-2.1.6" = _1ap1GtGZ;
        "pkg-1.16-3.0.1-beta" = _fx4ue9cL;
        "pkg-1.15-2.1.7" = _jxqtf680;
        "pkg-1.16-3.0.2-beta" = _TWiss0pl;
        "pkg-1.16-3.0.3-beta" = _FgY1Olq8;
        "pkg-1.15-2.1.8" = _LZfWIqbi;
        "pkg-1.16-3.0.4-beta" = _WDCRyZiq;
        "pkg-1.15-2.1.9" = _F0yDdO5V;
        "pkg-1.16-3.0.5" = _oNvs8Rsw;
        "pkg-1.16-3.0.6" = _myPvi63P;
        "pkg-1.15-2.1.10" = _qDjuX94n;
        "pkg-1.15-2.1.11" = _IwjDERwm;
        "pkg-1.16-3.0.7" = _1OPPYvds;
        "pkg-1.15-2.1.12" = _bWTYYXRb;
        "pkg-1.16-3.0.8" = _zcaMCgWj;
        "pkg-1.16-3.0.9" = _FxSlIcgO;
        "pkg-1.15-2.1.13" = _UlRMJkml;
        "pkg-1.16-3.0.10" = _oFMxhNWc;
        "pkg-1.16-3.0.11" = _5p0cODyJ;
        "pkg-1.15-2.1.14" = _HMtWXipa;
        "pkg-1.15-2.1.15" = _bWMpy5om;
        "pkg-1.16-3.0.12" = _vEm0G4oo;
        "pkg-1.15-2.1.16" = _tKoHFoQP;
        "pkg-1.16-3.0.13" = _s16qM24i;
        "pkg-1.16-3.0.14" = _YFjHW7co;
        "pkg-1.16-3.0.15" = _NpUaUJBW;
        "pkg-1.16-3.0.16" = _Ft1aB1J0;
        "pkg-1.16-3.0.17" = _PAIeUHBA;
        "pkg-1.16-3.1.0" = _7zgqBjzE;
        "pkg-1.16-3.1.1" = _GvqCjZQz;
        "pkg-1.16-3.1.2" = _oSfFCWIK;
        "pkg-1.16-3.1.3" = _kA5cTb0M;
        "pkg-1.16-3.1.4" = _pk4lS9hS;
        "pkg-1.18-4.0.0" = _uGRtz6f5;
        "pkg-1.18-4.0.1" = _Xsd9IkjU;
        "pkg-1.18-4.0.2" = _LljPacHE;
        "pkg-1.18-4.0.3" = _5NHmmady;
        "pkg-1.16-3.1.5" = _5oK6bPrl;
        "pkg-1.18-4.0.4" = _iPdjsZ3X;
        "pkg-1.18-4.0.5" = _dpGYpJ4S;
        "pkg-1.16-3.1.6" = _vxFtBBYN;
        "pkg-1.18-4.0.6" = _OnP1cu4e;
        "pkg-1.18-4.0.7" = _NRgFlj1r;
        "pkg-1.16-3.1.7" = _B5uTYO4P;
        "pkg-1.18-4.0.8" = _EPAuw2Fg;
        "pkg-1.16-3.1.8" = _tJnIh853;
        "pkg-1.18-4.0.9" = _4FYYJFMz;
        "pkg-1.16-3.1.9" = _XCD0rhcu;
        "pkg-1.18-4.0.10" = _QYVWiUmy;
        "pkg-1.18-4.0.11" = _7jiM6SZi;
        "pkg-1.16-3.1.10" = _xjFqkCZZ;
        "pkg-1.18-4.0.12" = _ceE5Dpsv;
        "pkg-1.16-3.1.11" = _dkDBeHQw;
        "pkg-1.18-4.0.13" = _IXtt3jJs;
        "pkg-1.19-5.0.0" = _Mj6yS2P4;
        "pkg-1.19.1-5.0.1" = _eRL53nJw;
        "pkg-1.18-4.0.14" = _rySH7T99;
        "pkg-1.19.1-5.0.2" = _amHAH2Cs;
        "pkg-1.19.1-5.0.3" = _JFsO1zZm;
        "pkg-1.18-4.0.15" = _sYGOZth8;
        "pkg-1.19.1-5.0.4" = _USoL28ly;
        "pkg-1.18-4.0.16" = _c2yRYBPr;
        "pkg-1.18-4.1.0" = _preMImgL;
        "pkg-1.19.1-5.1.0" = _Y0Ic8JhY;
        "pkg-1.19.1-5.1.1" = _65iiWieK;
        "pkg-1.18-4.1.1" = _gPFcGlrN;
        "pkg-1.19.1-5.2.0" = _vTmZPOLQ;
        "pkg-1.19.1-5.2.1" = _tabS6zh7;
        "pkg-1.19.1-5.2.2" = _GH6RHL2F;
        "pkg-1.19.1-5.2.3" = _yBF58If0;
        "pkg-1.19-5.2.4" = _OkADCjSM;
        "pkg-1.19-5.2.5" = _9JxlR8PX;
        "pkg-1.19-5.2.6" = _xvaQjfcW;
        "pkg-1.18-4.1.2" = _7gN7yC3i;
        "pkg-1.19-5.2.7" = _WLck9zhP;
        "pkg-1.19-5.2.8" = _wtW5qJ5c;
        "pkg-1.18-4.1.3" = _RPLDKzzz;
        "pkg-1.20-6.0.0" = _QGLsiZ5x;
        "pkg-1.20-6.0.1" = _aWhtf6M4;
        "pkg-1.20-6.0.2" = _NVJuuH21;
        "pkg-1.20-6.0.3" = _3B4cHGfE;
        "pkg-1.20-6.0.4" = _8mIUaono;
        "pkg-1.19-5.2.9" = _37OxTeIo;
        "pkg-1.18-4.1.4" = _zvQ0ybKO;
        "pkg-1.20-6.0.5" = _1TsVpRht;
        "pkg-1.19-5.2.10" = _LyjevT0q;
        "pkg-1.20-6.0.6" = _Z514gN0w;
        "pkg-1.20-6.0.7" = _TENf6kOY;
        "pkg-1.20-6.0.8" = _J3hhQ60U;
        "pkg-1.21-7.0.0" = _Q6zQ5YMK;
        "pkg-1.21-7.0.1" = _3KxwkduF;
        "pkg-1.21-7.0.2" = _qg6cSY8F;
        "pkg-1.21-7.0.3" = _coTWxOwJ;
