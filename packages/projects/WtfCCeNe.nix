...
let
    versions = (let
        ...
        _NNKFUYwW = {
            "id" = "NNKFUYwW";
            "file" = "Greek Mythology Mash-up.zip";
            "hash" = "sha512-rr3WxQcuJXShGirnFDUyua6C+0RVpYcdLVGKdXT90ffcsyzX32RT0e0eebYisL93mrQNmz02aZGSLsBXhEeTdA==";
        };
    in {
        "x1ZTzrM7" = _x1ZTzrM7;
        "pMZ3T8a7" = _pMZ3T8a7;
        ...
        "1KzVMhiP" = _1KzVMhiP;
        "NNKFUYwW" = _NNKFUYwW;
        "minecraft-1.20.4" = _NNKFUYwW;
        "minecraft-1.20.5" = _NNKFUYwW;
        "minecraft-1.20.6" = _NNKFUYwW;
        "minecraft-1.21" = _NNKFUYwW;
        "minecraft-1.21.1" = _NNKFUYwW;
        "minecraft-1.21.4" = _NNKFUYwW;
        "minecraft-1.21.2" = _NNKFUYwW;
        "minecraft-1.21.3" = _NNKFUYwW;
        "minecraft-1.21.5" = _NNKFUYwW;
        "minecraft-1.21.6" = _NNKFUYwW;
        "minecraft-1.21.7" = _NNKFUYwW;
        "minecraft-1.21.8" = _NNKFUYwW;
        "minecraft-1.21.9" = _NNKFUYwW;
        "minecraft-1.21.10" = _NNKFUYwW;
        "minecraft-1.21.11" = _NNKFUYwW;
        "minecraft-1.20.2" = _NNKFUYwW;
        "minecraft-1.20.3" = _NNKFUYwW;
        "minecraft-26.1" = _NNKFUYwW;
        "minecraft-26.1.1" = _NNKFUYwW;
        "minecraft-26.1.2" = _NNKFUYwW;
        "minecraft-26.2" = _NNKFUYwW;
        "pkg-0.1.0" = _x1ZTzrM7;
        "pkg-0.1.1" = _pMZ3T8a7;
        "pkg-1.0.0" = _VeYZ7Wzv;
        "pkg-1.0.1" = _DRZmN1MZ;
