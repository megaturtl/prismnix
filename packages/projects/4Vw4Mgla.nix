...
let
    versions = (let
        ...
        _YMNCYYNO = {
            "id" = "YMNCYYNO";
            "file" = "connection-bungeecord.jar";
            "hash" = "sha512-u7+inyaXV6MHjrL/2HZ0HUASyHUYL/XocZQ9EYARf50Ph/aT/qkAxH8bincmu4Q9sLPWnyiQq0klEWquBI9nVQ==";
        };
        _GCP3jaNw = {
            "id" = "GCP3jaNw";
            "file" = "connection-velocity.jar";
            "hash" = "sha512-BUNsHpNzJEOI1gvyfhIl+wBWQJYq+lxdVEO443NyqSYx7ddYcAnkqLFS5QRFGH4fsT1q6b8MGNDAuIoxhV26QA==";
        };
        _gLJ6sYkb = {
            "id" = "gLJ6sYkb";
            "file" = "connection-bungeecord.jar";
            "hash" = "sha512-n30yPSOwBQSeMxxX/e2M0cS7oJOyBDg3ZB297TP1SSkF6tkVHUPWo0GvtyYMDibNML/v+eOo4qjC4rq+iKSKLw==";
        };
        _ND7yhO21 = {
            "id" = "ND7yhO21";
            "file" = "connection-velocity.jar";
            "hash" = "sha512-bPy0CsZV8p76p+7RJ3GyqMrVPioRzwxG+snpS6dHRjQXYPHifmtsRmVt25ZyhzDzdFfFTYUeXfUSJCPscFOFjQ==";
        };
        _LWMYJGTv = {
            "id" = "LWMYJGTv";
            "file" = "connection-bungeecord.jar";
            "hash" = "sha512-sqxvLYeueFnXsasezXLg1niMoMJqfgHN1kEbAV9C576zeVCAeyPA4am+oOIBeRf6S+mfMR3RGWSrdouzKAMD5A==";
        };
        _NJ3CufY6 = {
            "id" = "NJ3CufY6";
            "file" = "connection-velocity.jar";
            "hash" = "sha512-rCmWGA37PaJ21UTfoyaISXAvrUWx4E+A06+eKjU/HF9YVKP6VYUfguFBXXHPp8newcQBYlJTZzc8wdLYyfoVow==";
        };
    in {
        "jlXYUXSk" = _jlXYUXSk;
        "EtfMc4e7" = _EtfMc4e7;
        ...
        "LWMYJGTv" = _LWMYJGTv;
        "NJ3CufY6" = _NJ3CufY6;
        "bungeecord-1.20" = _LWMYJGTv;
        "bungeecord-1.20.1" = _LWMYJGTv;
        "bungeecord-1.20.2" = _LWMYJGTv;
        "bungeecord-1.20.3" = _LWMYJGTv;
        "bungeecord-1.20.4" = _LWMYJGTv;
        "bungeecord-1.20.5" = _LWMYJGTv;
        "bungeecord-1.20.6" = _LWMYJGTv;
        "bungeecord-1.21" = _LWMYJGTv;
        "bungeecord-1.21.1" = _LWMYJGTv;
        "bungeecord-1.21.2" = _LWMYJGTv;
        "bungeecord-1.21.3" = _LWMYJGTv;
        "bungeecord-1.21.4" = _LWMYJGTv;
        "bungeecord-1.21.5" = _LWMYJGTv;
        "bungeecord-1.21.6" = _LWMYJGTv;
        "bungeecord-1.21.7" = _LWMYJGTv;
        "bungeecord-1.21.8" = _LWMYJGTv;
        "bungeecord-1.21.9" = _LWMYJGTv;
        "bungeecord-1.21.10" = _LWMYJGTv;
        "bungeecord-1.21.11" = _LWMYJGTv;
        "bungeecord-26.1" = _LWMYJGTv;
        "bungeecord-26.1.1" = _LWMYJGTv;
        "bungeecord-26.1.2" = _LWMYJGTv;
        "bungeecord-26.2" = _LWMYJGTv;
        "bungeecord-26.3" = _LWMYJGTv;
        "velocity-1.20" = _NJ3CufY6;
        "velocity-1.20.1" = _NJ3CufY6;
        "velocity-1.20.2" = _NJ3CufY6;
        "velocity-1.20.3" = _NJ3CufY6;
        "velocity-1.20.4" = _NJ3CufY6;
        "velocity-1.20.5" = _NJ3CufY6;
        "velocity-1.20.6" = _NJ3CufY6;
        "velocity-1.21" = _NJ3CufY6;
        "velocity-1.21.1" = _NJ3CufY6;
        "velocity-1.21.2" = _NJ3CufY6;
        "velocity-1.21.3" = _NJ3CufY6;
        "velocity-1.21.4" = _NJ3CufY6;
        "velocity-1.21.5" = _NJ3CufY6;
        "velocity-1.21.6" = _NJ3CufY6;
        "velocity-1.21.7" = _NJ3CufY6;
        "velocity-1.21.8" = _NJ3CufY6;
        "velocity-1.21.9" = _NJ3CufY6;
        "velocity-1.21.10" = _NJ3CufY6;
        "velocity-1.21.11" = _NJ3CufY6;
        "velocity-26.1" = _NJ3CufY6;
        "velocity-26.1.1" = _NJ3CufY6;
        "velocity-26.1.2" = _NJ3CufY6;
        "velocity-26.2" = _NJ3CufY6;
        "velocity-26.3" = _NJ3CufY6;
        "waterfall-1.20" = _LWMYJGTv;
        "waterfall-1.20.1" = _LWMYJGTv;
        "waterfall-1.20.2" = _LWMYJGTv;
        "waterfall-1.20.3" = _LWMYJGTv;
        "waterfall-1.20.4" = _LWMYJGTv;
        "waterfall-1.20.5" = _LWMYJGTv;
        "waterfall-1.20.6" = _LWMYJGTv;
        "waterfall-1.21" = _LWMYJGTv;
        "waterfall-1.21.1" = _LWMYJGTv;
        "waterfall-1.21.2" = _LWMYJGTv;
        "waterfall-1.21.3" = _LWMYJGTv;
        "waterfall-1.21.4" = _LWMYJGTv;
        "waterfall-1.21.5" = _LWMYJGTv;
        "waterfall-1.21.6" = _LWMYJGTv;
        "waterfall-1.21.7" = _LWMYJGTv;
        "waterfall-1.21.8" = _LWMYJGTv;
        "waterfall-1.21.9" = _LWMYJGTv;
        "waterfall-1.21.10" = _LWMYJGTv;
        "waterfall-1.21.11" = _LWMYJGTv;
        "waterfall-26.1" = _LWMYJGTv;
        "waterfall-26.1.1" = _LWMYJGTv;
        "waterfall-26.1.2" = _LWMYJGTv;
        "waterfall-26.2" = _LWMYJGTv;
        "waterfall-26.3" = _LWMYJGTv;
        "pkg-0.0.1-dev.efe7f51" = _EtfMc4e7;
        "pkg-0.0.1-dev.885ec7e" = _MG07haKT;
        "pkg-0.0.1-dev.24f1d13" = _4kM2PLe0;
        "pkg-0.0.1-dev.a7eae85" = _k4kjPi1p;
        "pkg-0.0.1-dev.6c09fd7" = _bhAiW3bs;
        "pkg-0.0.1-dev.7df61f8" = _J0qkeMF4;
        "pkg-0.0.1-dev.72364ab" = _AVmxeaEv;
        "pkg-0.0.1-dev.554d086" = _YJ4llyGj;
        "pkg-0.0.1-dev.9459efb" = _XIy3wpgK;
        "pkg-0.0.1-dev.451f85f" = _TFcnyGTs;
        "pkg-1.0.0" = _EkSmLVtg;
        "pkg-1.0.1" = _oTGHpMUK;
        "pkg-1.0.2" = _rVLDuKvN;
        "pkg-1.0.3" = _GsjwAY5u;
