...
let
    versions = (let
        ...
        _pbJmlUKW = {
            "id" = "pbJmlUKW";
            "file" = "slayersbeasts-fabric-1.20.1-1.6.1.jar";
            "hash" = "sha512-CGfI9NKSvmcXIe7ijq/+cJ2F8sq8ocI/IR2VdlJyyxPp8SHXtn7HnMP6jVwIQa5OguUczv/l0uFPa7lywXYMLA==";
        };
        _e1rA4syw = {
            "id" = "e1rA4syw";
            "file" = "slayersbeasts-forge-1.20.1-1.6.1.jar";
            "hash" = "sha512-tCdD7S9uTwQ2+1AhYMKPLXXsEJ5RRQaPE8dnpNH2Pq3TEBH2tJmawggtXj5MnwMzNb4qRBySLFm4X3WPYGKCwg==";
        };
    in {
        "DoGnE4eD" = _DoGnE4eD;
        "xQrCMXTX" = _xQrCMXTX;
        ...
        "pkg-1.0.8" = _bruLNleU;
        "pkg-1.0.9" = _U9nWUOh0;
        "pkg-1.0.10" = _P76njmO4;
        "pkg-1.0.11" = _B5rGzuzb;
        "pkg-2.0.0" = _Dk9f7coL;
        "pkg-1.0.12" = _3J3UtaRF;
        "pkg-2.0.2" = _Z5atF9R6;
        "pkg-1.0.14" = _orb5pIep;
        "pkg-2.0.3" = _NSgktZ62;
        "pkg-1.0.15" = _bo4xWN8l;
        "pkg-2.1.0" = _Mt6kW90G;
        "pkg-1.1.0" = _ED8xHgN5;
        "pkg-2.1.1" = _VQYNY0wV;
        "pkg-1.1.1" = _iOzNvdDU;
        ...
        "pkg-3.0.7" = _ltpU77V0;
        "pkg-1.1.9" = _FUUeJo08;
        "pkg-2.1.10" = _IO8Q0sKP;
        "pkg-3.0.8" = _ddes5dcL;
        "pkg-1.1.10" = _dFjBL8O1;
        "pkg-2.1.11" = _EzwTYcfa;
        "pkg-3.0.9" = _K3EVN5iH;
        "pkg-1.1.12" = _JEOGSDoR;
        "pkg-2.1.13" = _aapjmnrJ;
        "pkg-3.0.11" = _Dz443NX2;
        "pkg-1.2.0" = _MCsgLjiD;
        "pkg-2.2.0" = _7OCgVJNY;
        "pkg-3.1.0" = _y7FfOoe3;
        "pkg-0.0.2" = _sEp1LHtW;
        ...
        "pkg-5.0.2" = _nlzt2Pno;
        "pkg-6.0.0" = _ARVeuGcC;
        "pkg-6.1.0+fabric" = _9OATGlC7;
        "pkg-6.1.0+neoforge" = _wNySoiBN;
        "pkg-5.1.1+fabric" = _mF6q2GKK;
        "pkg-5.1.1+neoforge" = _qeuvviiR;
        "pkg-4.1.0+fabric" = _5XLCvB9n;
        "pkg-4.1.0+neoforge" = _WWyD9Zag;
        "pkg-3.3.0+fabric" = _uMgwSR3h;
        "pkg-3.3.0+neoforge" = _nedgfFbg;
        "pkg-3.3.0+forge" = _PDC1MzYG;
        "pkg-1.4.0+fabric" = _cDo2zpS4;
        "pkg-1.4.0+forge" = _mKngamaQ;
        "pkg-6.2.0+fabric" = _WMydhxtt;
        "pkg-6.2.0+forge" = _AVwIR0Rl;
        "pkg-6.2.0+neoforge" = _fYZF5eP0;
        "pkg-5.2.0+fabric" = _cCtb5Yqu;
        "pkg-5.2.0+forge" = _CS4Vgstq;
        "pkg-5.2.0+neoforge" = _lfHnyPli;
        "pkg-1.5.0+fabric" = _zCyeGapV;
        "pkg-1.5.0+forge" = _LNyJFUHh;
        "pkg-1.5.1+fabric" = _tsqVnxbE;
        "pkg-1.5.1+forge" = _WllRBakZ;
        "pkg-1.5.2+fabric" = _hagkVKVb;
        "pkg-1.5.2+forge" = _B482HQ05;
        "pkg-1.5.3+fabric" = _pgKLsZoN;
        "pkg-1.5.3+forge" = _115sf28H;
        "pkg-5.2.1+fabric" = _vj3W3mt6;
        "pkg-5.2.1+forge" = _nvZ1x98m;
        "pkg-5.2.1+neoforge" = _KWLimOTr;
        "pkg-1.6.0+fabric" = _vY3zz3LI;
        "pkg-1.6.0+forge" = _6zBG5VdC;
        "pkg-5.3.0+fabric" = _A90ulMVL;
        "pkg-5.3.0+forge" = _sCdnH1Bu;
        "pkg-5.3.0+neoforge" = _5Ac0s60s;
        "pkg-6.3.0+fabric" = _wcwOZgOA;
        "pkg-6.3.0+forge" = _gBWhFuCD;
        "pkg-6.3.0+neoforge" = _j8XnbvO3;
        "pkg-5.3.1+fabric" = _OYBXdWb5;
        "pkg-5.3.1+forge" = _yqsFXD3o;
        "pkg-5.3.1+neoforge" = _XyrsgG1v;
        "pkg-6.3.1+fabric" = _73EVWQmv;
        "pkg-6.3.1+forge" = _kWhljRar;
        "pkg-6.3.1+neoforge" = _Aa6WzRer;
        "pkg-1.6.1+fabric" = _pbJmlUKW;
        "pkg-1.6.1+forge" = _e1rA4syw;
        "default" = _e1rA4syw;
    });
