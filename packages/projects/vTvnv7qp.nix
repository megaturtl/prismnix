...
let
    ...
    in {
        ...
        "pkg-0.2.8" = _HTTLwRV4;
        "pkg-0.2.9" = _1n4Qq3af;
        "pkg-0.2.10" = _LmdgKFYh;
        "pkg-0.2.11" = _2ZDO85Te;
        "pkg-0.3.0" = _chX8kb1u;
        "pkg-0.3.1" = _DK218UJP;
        "pkg-0.3.2" = _xBmHiWS7;
        "pkg-0.3.3" = _bBsvA8Il;
        ...
        "pkg-0.4.1" = _CdN7Hxlb;
        "pkg-0.4.2" = _AWAlA3XU;
        "pkg-0.4.4-pre" = _LwOEkoIw;
        "pkg-0.4.5" = _kat9bJKc;
        "pkg-0.4.6" = _Oztj4ybC;
        "pkg-0.4.7" = _yng7Uml6;
        "pkg-0.4.8" = _7vbZATLt;
        "pkg-0.4.9" = _Y72MZ7pZ;
        "pkg-0.4.10-pre" = _TTCL6CdV;
        "pkg-0.5.0" = _k5ALPKZF;
        "pkg-0.5.1-pre" = _uzGDcHia;
        "pkg-0.5.2-pre" = _awjCwAi7;
        "pkg-0.5.3" = _vumdYxW6;
        "pkg-0.5.4-pre" = _H7WtiQOr;
        "pkg-0.5.5" = _Asncw2xm;
        "pkg-0.5.6-pre" = _HZLqMCFP;
        "pkg-0.5.7-pre" = _LI9D2k0X;
        "pkg-0.5.8" = _O0iyRYaY;
        "pkg-0.5.9" = _HHgrdF84;
        "pkg-0.5.10" = _LVKQGnW8;
        "pkg-0.5.11" = _n9XMBeV2;
        "pkg-0.5.12" = _KTrcMl2w;
        "pkg-0.5.13" = _tSVdOu6z;
        "pkg-0.5.14" = _1yXRFMHt;
        "pkg-0.5.15" = _zyq3lCR6;
        "pkg-0.5.16" = _VIhWHRVf;
        "pkg-0.5.17" = _uKr0rIOM;
        "pkg-0.5.18" = _WWVYB6Gn;
        "pkg-0.5.19" = _NYpUxKMm;
        "pkg-0.5.20" = _ClBJcQnb;
        "pkg-0.5.21" = _Y5FdQYk9;
        "pkg-0.5.22" = _vpQ1LD3f;
        "pkg-0.5.23" = _MTRzO9Gw;
        "pkg-0.6.0" = _JHHRPrIv;
        "pkg-0.6.1" = _R7LhKKnt;
        "pkg-0.6.2" = _cOQzKrVx;
        "pkg-0.6.3" = _4A6Um6SY;
        "pkg-0.6.4-pre" = _aef20tXA;
        "pkg-0.6.5" = _jkrl9YW6;
        "pkg-0.6.6" = _HpMAdiVq;
        "pkg-0.6.7" = _y8cma23v;
        "pkg-0.6.8" = _WkDkpJp7;
        "pkg-0.6.9" = _qwFIb7nH;
        "pkg-0.6.10" = _gS80EQiD;
        "pkg-0.6.11" = _ZOaGymID;
        "pkg-0.6.12" = _N42YUMSO;
        "pkg-0.6.13" = _pdbgLtag;
        "pkg-0.6.14" = _GRC6aiq2;
        "pkg-0.6.15" = _rRpmwPMX;
        "pkg-0.6.16" = _axnc7nwL;
        "pkg-0.6.17" = _TBMMzRVQ;
        "pkg-0.6.18" = _NCsuTtQ1;
        "pkg-0.6.19" = _o3JmXvHH;
        "pkg-0.6.20" = _Jiz0YRjc;
        "pkg-0.6.21" = _vvjGQx5N;
        "pkg-0.6.22" = _AqyCF2ek;
        "pkg-0.6.23" = _e2m2lZhE;
        "pkg-0.6.24" = _oowrizFN;
        "pkg-0.6.25" = _x8xg2w3j;
        "pkg-0.6.26" = _JzH8BJ1N;
        "pkg-0.6.27" = _T9wMW1DJ;
        "pkg-0.6.28" = _83Vl4z7P;
        "pkg-0.6.29" = _lwjzuoqa;
        "pkg-0.6.30" = _NjJxMd0W;
        "pkg-0.6.31" = _ZJu7rC2a;
        "pkg-0.6.32" = _c7f0mByL;
        "pkg-0.6.33" = _On5xQljg;
        "pkg-0.6.34" = _IBq4FjxM;
        "pkg-0.6.35" = _gZjPMQMe;
        "pkg-0.6.36" = _7APqVkfh;
        "pkg-0.6.37" = _zdjtj8g8;
        "pkg-0.6.38" = _CNnqlvMP;
        "pkg-0.6.39" = _UFXLICcw;
        "pkg-0.6.40" = _DuKGtw0Q;
        "pkg-0.7.0" = _hBFUptcd;
        "pkg-0.6.41" = _s0Jft1fZ;
        "pkg-0.7.1" = _Nd16jhLs;
        "pkg-0.7.3" = _FqUUjog9;
        "pkg-0.7.5" = _sGYeI6Np;
        "pkg-0.7.7" = _tAETrCX3;
        ...
        "pkg-0.8.8" = _JHr6VnlT;
        "pkg-0.8.9" = _87G05LYH;
        "pkg-0.8.10" = _oe3tSOb2;
        "pkg-0.8.11" = _VFgDeTTS;
        "pkg-0.8.12" = _wJJkVSoH;
        "pkg-0.8.13" = _PYpiK0dc;
        "pkg-0.8.14" = _2wuBazfk;
        "pkg-0.8.15" = _IaxlgWp3;
        "pkg-0.8.16" = _FXcnEFq9;
        "pkg-0.8.17" = _I3TzFoR7;
        "pkg-0.8.18" = _74ADYozy;
        "pkg-0.8.19" = _MUdn6CuZ;
        "pkg-0.8.20" = _WaJOzW5Y;
        "pkg-0.7.10" = _h88bY7y0;
        "pkg-0.8.21" = _q6vBCaHC;
        "pkg-0.8.22" = _arLd0CEo;
        "pkg-0.8.23" = _wZ0i0qtC;
        "pkg-0.8.25" = _cm5UJizS;
        "pkg-0.8.27" = _PSJlpB1b;
        "pkg-0.8.29" = _yJw7BgeP;
        "pkg-0.8.31" = _9swu9Dza;
        "pkg-0.8.32" = _AlGhFGe6;
        "pkg-0.8.33" = _aiVC0zCV;
        "pkg-0.8.34" = _KBkTih6v;
        "pkg-0.8.38" = _NTHOywRK;
        "pkg-0.8.41" = _1z9sED3P;
        "pkg-0.8.44" = _mUmLDta0;
        "pkg-0.8.45" = _2IULwgVJ;
        "pkg-0.9.0" = _boag2CMO;
        "pkg-0.9.3" = _mNRuhFKD;
        "pkg-0.9.5" = _V3o4UcoQ;
        "pkg-0.9.6" = _18pyYOAy;
        "pkg-0.9.9" = _vGhxuvvR;
        "pkg-0.9.10" = _Lr9dqcsL;
        "pkg-0.9.13" = _9ZVDn6oi;
        "pkg-0.9.15" = _7AyJoSEe;
        "pkg-0.9.16" = _gEcID09l;
        "pkg-0.9.19" = _e1ql1Xf7;
        "pkg-0.9.20" = _oPkAYPtS;
        "pkg-0.9.23" = _aTDPWh6P;
        "pkg-0.9.24" = _5fbbryEo;
        "pkg-0.9.25" = _7EqQ7Lpg;
        "pkg-0.9.26" = _TqGj72Fr;
        "pkg-0.9.27" = _cor4ILIi;
        "pkg-0.9.29" = _uw8KBgGG;
        "pkg-0.9.30" = _LDJMQ3Nc;
        "pkg-0.9.31" = _qadlZGps;
        "pkg-0.9.32" = _p9ZuHBhb;
        "pkg-0.9.33" = _WgubGPiE;
        "pkg-0.9.34" = _IbjTFX3T;
        "pkg-0.9.35" = _FokWR1mH;
        "pkg-0.9.36" = _K0x2dgBp;
        "pkg-0.9.37" = _Z7AJXtd7;
        "pkg-0.9.38" = _BmsecrcV;
        "pkg-0.9.39" = _91yEIlqZ;
        "pkg-0.9.40" = _YlBJQWEG;
        "pkg-0.9.41" = _zZrlZwWz;
        "pkg-0.9.42" = _XNNvZcFe;
        "pkg-0.9.43" = _QnKTOLQZ;
        "pkg-0.9.44" = _XNt6lewN;
        "pkg-0.9.45" = _Pj47nKtV;
        "pkg-0.9.47" = _wXf0jzRo;
        "pkg-0.9.48" = _TQBSHbPv;
        "pkg-0.9.49" = _QouWMC6p;
        "pkg-0.9.50" = _HsuYxZun;
        "pkg-0.9.51" = _lfCCqyXk;
        "pkg-0.9.52" = _gWXNMEIc;
        "pkg-0.9.53" = _FNP93jEr;
        "pkg-0.9.54" = _OfrguwKt;
        "pkg-0.9.55" = _HEaRWtMW;
        "pkg-0.9.56" = _RtAub3fp;
        "pkg-0.9.57" = _vTadgmNn;
        "pkg-0.9.59" = _1Ct9ikGL;
        "pkg-0.9.60" = _PhWCHFjs;
        "pkg-0.9.61" = _3EdMcFly;
        "pkg-0.9.62" = _X6iDKY6j;
        "pkg-0.9.63" = _FgwE8pxx;
        "pkg-0.9.64" = _pnviHYfW;
        "pkg-0.9.65" = _n87eKw92;
        "pkg-0.9.66" = _ZbvQsuHn;
        "pkg-0.9.67" = _V5nsyJb8;
        "pkg-0.9.68" = _ydFyiRws;
        "pkg-0.9.69" = _uSIg6jx8;
        "pkg-0.10.0" = _lKJ0MJaq;
        "pkg-0.10.1" = _MA2LME1m;
        "pkg-0.10.2" = _x5Y0Bcj6;
        "pkg-0.10.3" = _4tuxhAPh;
        "pkg-0.10.6" = _sluQbEUw;
        "pkg-0.10.7" = _g4Iviymm;
        "pkg-0.10.8" = _Ay50ZTBG;
        "pkg-0.10.9" = _cvl5ArR3;
        "pkg-0.11.0" = _m6OUKmC9;
        "pkg-0.11.1" = _HhNusniW;
        "pkg-0.11.2" = _dCT6W8bi;
        "pkg-0.11.3" = _AWU7XEul;
        "pkg-0.11.4" = _kxwBMpWD;
        "pkg-0.11.5" = _M5Id4q6r;
        "pkg-0.11.6" = _8h9Tg5eT;
        "pkg-0.11.7" = _fCiCKMR4;
        "pkg-0.11.8" = _aFHDwAAI;
        "pkg-0.11.9" = _6Vmst2Gp;
        "pkg-0.11.10" = _uMRJhew6;
        "pkg-0.11.11" = _I9bPR1yy;
        "pkg-0.11.12" = _syjoMmLC;
        "pkg-0.11.13" = _XcNHvVbO;
        "pkg-0.11.14" = _RqgK3JtL;
        "pkg-0.11.15" = _7Er1Dkl4;
        "pkg-0.11.16" = _Ov0177eZ;
        "pkg-0.11.17" = _F6DlovJs;
        "pkg-0.11.18" = _8v6CAMqU;
        "pkg-0.11.19" = _F3kVgQIp;
        "pkg-0.11.20" = _jhPTeQFq;
        "pkg-0.11.21" = _mlo9nwXV;
        "pkg-0.11.22" = _nC0BrArL;
        "pkg-0.11.23" = _mtRd16uH;
        "pkg-0.11.25" = _qMmJX31A;
        "pkg-0.11.26" = _apsp6tkN;
        "pkg-0.11.27" = _tZPj6x1s;
        "pkg-0.11.28" = _D4liCRxz;
        "pkg-0.11.29" = _PY2PmyvJ;
        "pkg-0.11.30" = _iEVH8O8F;
        "pkg-0.11.31" = _R5066nhx;
