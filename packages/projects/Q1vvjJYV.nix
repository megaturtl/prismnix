...
let
    versions = (let
        ...
        _ZGOmKKXV = {
            "id" = "ZGOmKKXV";
            "file" = "BSL_v10.1.4.zip";
            "hash" = "sha512-vV2hKPWoKm4ABlDWTEu4nutbrfUd+5ojkptgQ5R8vonGUW5PIMCcH36dkRtmEsKA94r7T5GAn12jq7K2X1oFvg==";
        };
        _yFTiE1Nc = {
            "id" = "yFTiE1Nc";
            "file" = "BSL_v10.1.5.zip";
            "hash" = "sha512-7l9URbEB5qhZQreOnaHUJm1+0nelaoMYmsXcT6s84fjeTGbFLPh8dH+U6HH7KIhoSqZ2OrkH4cXJkmWU0ZllBA==";
        };
    in {
        "OeutbFgD" = _OeutbFgD;
        "lQuSN0ud" = _lQuSN0ud;
        ...
        "ZGOmKKXV" = _ZGOmKKXV;
        "yFTiE1Nc" = _yFTiE1Nc;
        "iris-1.8.9" = _yFTiE1Nc;
        "iris-1.10.2" = _yFTiE1Nc;
        "iris-1.11.2" = _yFTiE1Nc;
        "iris-1.12.2" = _yFTiE1Nc;
        "iris-1.14.4" = _yFTiE1Nc;
        "iris-1.16.5" = _yFTiE1Nc;
        "iris-1.17.1" = _yFTiE1Nc;
        "iris-1.19.3" = _yFTiE1Nc;
        "iris-1.7.10" = _yFTiE1Nc;
        "iris-1.8" = _yFTiE1Nc;
        "iris-1.8.1" = _yFTiE1Nc;
        "iris-1.8.2" = _yFTiE1Nc;
        "iris-1.8.3" = _yFTiE1Nc;
        "iris-1.8.4" = _yFTiE1Nc;
        "iris-1.8.5" = _yFTiE1Nc;
        "iris-1.8.6" = _yFTiE1Nc;
        "iris-1.8.7" = _yFTiE1Nc;
        "iris-1.8.8" = _yFTiE1Nc;
        "iris-1.9" = _yFTiE1Nc;
        "iris-1.9.1" = _yFTiE1Nc;
        "iris-1.9.2" = _yFTiE1Nc;
        "iris-1.9.3" = _yFTiE1Nc;
        "iris-1.9.4" = _yFTiE1Nc;
        "iris-1.10" = _yFTiE1Nc;
        "iris-1.10.1" = _yFTiE1Nc;
        "iris-1.11" = _yFTiE1Nc;
        "iris-1.11.1" = _yFTiE1Nc;
        "iris-1.12" = _yFTiE1Nc;
        "iris-1.12.1" = _yFTiE1Nc;
        "iris-1.13" = _yFTiE1Nc;
        "iris-1.13.1" = _yFTiE1Nc;
        "iris-1.13.2" = _yFTiE1Nc;
        "iris-1.14" = _yFTiE1Nc;
        "iris-1.14.1" = _yFTiE1Nc;
        "iris-1.14.2" = _yFTiE1Nc;
        "iris-1.14.3" = _yFTiE1Nc;
        "iris-1.15" = _yFTiE1Nc;
        "iris-1.15.1" = _yFTiE1Nc;
        "iris-1.15.2" = _yFTiE1Nc;
        "iris-1.16" = _yFTiE1Nc;
        "iris-1.16.1" = _yFTiE1Nc;
        "iris-1.16.2" = _yFTiE1Nc;
        "iris-1.16.3" = _yFTiE1Nc;
        "iris-1.16.4" = _yFTiE1Nc;
        "iris-1.17" = _yFTiE1Nc;
        "iris-1.18" = _yFTiE1Nc;
        "iris-1.18.1" = _yFTiE1Nc;
        "iris-1.18.2" = _yFTiE1Nc;
        "iris-1.19" = _yFTiE1Nc;
        "iris-1.19.1" = _yFTiE1Nc;
        "iris-1.19.2" = _yFTiE1Nc;
        "iris-1.19.4" = _yFTiE1Nc;
        "iris-1.20" = _yFTiE1Nc;
        "iris-1.20.1" = _yFTiE1Nc;
        "iris-1.20.2" = _yFTiE1Nc;
        "iris-1.20.3" = _yFTiE1Nc;
        "iris-1.20.4" = _yFTiE1Nc;
        "iris-1.20.5" = _yFTiE1Nc;
        "iris-1.20.6" = _yFTiE1Nc;
        "iris-1.21" = _yFTiE1Nc;
        "iris-1.21.1" = _yFTiE1Nc;
        "iris-1.21.2" = _yFTiE1Nc;
        "iris-1.21.3" = _yFTiE1Nc;
        "iris-1.21.4" = _yFTiE1Nc;
        "iris-1.21.5" = _yFTiE1Nc;
        "iris-1.21.6" = _yFTiE1Nc;
        "iris-1.21.7" = _yFTiE1Nc;
        "iris-1.21.8" = _yFTiE1Nc;
        "iris-1.21.9" = _yFTiE1Nc;
        "iris-1.21.10" = _yFTiE1Nc;
        "iris-1.21.11" = _yFTiE1Nc;
        "iris-26.1" = _yFTiE1Nc;
        "iris-26.1.1" = _yFTiE1Nc;
        "iris-26.1.2" = _yFTiE1Nc;
        "iris-26.2" = _yFTiE1Nc;
        "optifine-1.8.9" = _yFTiE1Nc;
        "optifine-1.10.2" = _yFTiE1Nc;
        "optifine-1.11.2" = _yFTiE1Nc;
        "optifine-1.12.2" = _yFTiE1Nc;
        "optifine-1.14.4" = _yFTiE1Nc;
        "optifine-1.16.5" = _yFTiE1Nc;
        "optifine-1.17.1" = _yFTiE1Nc;
        "optifine-1.19.3" = _yFTiE1Nc;
        "optifine-1.7.10" = _yFTiE1Nc;
        "optifine-1.8" = _yFTiE1Nc;
        "optifine-1.8.1" = _yFTiE1Nc;
        "optifine-1.8.2" = _yFTiE1Nc;
        "optifine-1.8.3" = _yFTiE1Nc;
        "optifine-1.8.4" = _yFTiE1Nc;
        "optifine-1.8.5" = _yFTiE1Nc;
        "optifine-1.8.6" = _yFTiE1Nc;
        "optifine-1.8.7" = _yFTiE1Nc;
        "optifine-1.8.8" = _yFTiE1Nc;
        "optifine-1.9" = _yFTiE1Nc;
        "optifine-1.9.1" = _yFTiE1Nc;
        "optifine-1.9.2" = _yFTiE1Nc;
        "optifine-1.9.3" = _yFTiE1Nc;
        "optifine-1.9.4" = _yFTiE1Nc;
        "optifine-1.10" = _yFTiE1Nc;
        "optifine-1.10.1" = _yFTiE1Nc;
        "optifine-1.11" = _yFTiE1Nc;
        "optifine-1.11.1" = _yFTiE1Nc;
        "optifine-1.12" = _yFTiE1Nc;
        "optifine-1.12.1" = _yFTiE1Nc;
        "optifine-1.13" = _yFTiE1Nc;
        "optifine-1.13.1" = _yFTiE1Nc;
        "optifine-1.13.2" = _yFTiE1Nc;
        "optifine-1.14" = _yFTiE1Nc;
        "optifine-1.14.1" = _yFTiE1Nc;
        "optifine-1.14.2" = _yFTiE1Nc;
        "optifine-1.14.3" = _yFTiE1Nc;
        "optifine-1.15" = _yFTiE1Nc;
        "optifine-1.15.1" = _yFTiE1Nc;
        "optifine-1.15.2" = _yFTiE1Nc;
        "optifine-1.16" = _yFTiE1Nc;
        "optifine-1.16.1" = _yFTiE1Nc;
        "optifine-1.16.2" = _yFTiE1Nc;
        "optifine-1.16.3" = _yFTiE1Nc;
        "optifine-1.16.4" = _yFTiE1Nc;
        "optifine-1.17" = _yFTiE1Nc;
        "optifine-1.18" = _yFTiE1Nc;
        "optifine-1.18.1" = _yFTiE1Nc;
        "optifine-1.18.2" = _yFTiE1Nc;
        "optifine-1.19" = _yFTiE1Nc;
        "optifine-1.19.1" = _yFTiE1Nc;
        "optifine-1.19.2" = _yFTiE1Nc;
        "optifine-1.19.4" = _yFTiE1Nc;
        "optifine-1.20" = _yFTiE1Nc;
        "optifine-1.20.1" = _yFTiE1Nc;
        "optifine-1.20.2" = _yFTiE1Nc;
        "optifine-1.20.3" = _yFTiE1Nc;
        "optifine-1.20.4" = _yFTiE1Nc;
        "optifine-1.20.5" = _yFTiE1Nc;
        "optifine-1.20.6" = _yFTiE1Nc;
        "optifine-1.21" = _yFTiE1Nc;
        "optifine-1.21.1" = _yFTiE1Nc;
        "optifine-1.21.2" = _yFTiE1Nc;
        "optifine-1.21.3" = _yFTiE1Nc;
        "optifine-1.21.4" = _yFTiE1Nc;
        "optifine-1.21.5" = _yFTiE1Nc;
        "optifine-1.21.6" = _yFTiE1Nc;
        "optifine-1.21.7" = _yFTiE1Nc;
        "optifine-1.21.8" = _yFTiE1Nc;
        "optifine-1.21.9" = _yFTiE1Nc;
        "optifine-1.21.10" = _yFTiE1Nc;
        "optifine-1.21.11" = _yFTiE1Nc;
        "optifine-26.1" = _yFTiE1Nc;
        "optifine-26.1.1" = _yFTiE1Nc;
        "optifine-26.1.2" = _yFTiE1Nc;
        "optifine-26.2" = _yFTiE1Nc;
        "pkg-1.0" = _OeutbFgD;
        "pkg-2.0" = _lQuSN0ud;
        "pkg-3.0" = _FoFIskk5;
        "pkg-3.6" = _U7O5QxWB;
        ...
        "pkg-10.1.4" = _ZGOmKKXV;
        "pkg-10.1.5" = _yFTiE1Nc;
        "default" = _yFTiE1Nc;
    });
