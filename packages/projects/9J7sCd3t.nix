...
let
    ...
    in {
        ...
        "pkg-3.0.2+1.21.1" = _BmFQLK13;
        "pkg-3.0.4+1.21.1" = _yCrHGEjY;
        "pkg-3.0.5+1.21.1" = _y1JxDI6U;
        "pkg-3.1.0+1.21.4" = _yRkzNqit;
        "pkg-3.1.0+1.21.4-HOTFIX.1" = _n7OrrYOl;
        "pkg-3.1.1+1.21.4" = _toNn92RY;
        "pkg-3.1.2+1.21.4" = _3schJOE2;
        "pkg-3.1.3+1.21.4" = _oOjCn4Qb;
        "pkg-3.1.4+1.21.4" = _ou6q19oK;
        "pkg-3.1.5+1.21.4" = _VrlrhHWM;
        "pkg-3.1.6+1.21.4" = _dKBHoLn7;
        "pkg-3.1.7+1.21.4" = _2eWlPbsG;
        "pkg-3.1.8+1.21.4" = _R8IjETps;
        "pkg-3.1.9+1.21.4" = _hSYXycnk;
        "pkg-3.1.10+1.21.4" = _yySCmVAy;
        "pkg-3.1.11+1.21.5" = _xqdrrBco;
        "pkg-3.1.12+1.21.8-HOTFIX.1" = _mfDxLT0X;
        "pkg-3.1.12+1.21.8-HOTFIX.2" = _tPQBf1nt;
        "pkg-3.1.13+1.21.8" = _JPhpqSp4;
        "pkg-3.1.14+1.21.8" = _IDtvlY6k;
        "pkg-3.1.15+1.21.8" = _CDFKpr3O;
        "pkg-3.1.16+1.21.8" = _Mra4VZub;
        "pkg-3.1.16+1.21.10" = _APXNWz3R;
        "pkg-3.1.17+1.21.11" = _GsCja4nK;
        "pkg-4.0.0+1.21.11" = _8TGIPekI;
        "pkg-4.0.0+26.1" = _zuWxXIxs;
        "pkg-4.0.1+26.1" = _X4wNmrLM;
        "pkg-4.0.2+26.1" = _GASjZUwz;
        "pkg-4.0.3+26.1" = _WICKjDiD;
        "pkg-4.0.4+26.1" = _g7ZYWVYg;
        "pkg-4.0.5+26.1" = _QYVNpnMB;
