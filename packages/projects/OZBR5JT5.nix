...
let
    versions = (let
        ...
        _nkznXCKk = {
            "id" = "nkznXCKk";
            "file" = "EasyAnvils-v26.1.4-mc26.1.x-Fabric.jar";
            "hash" = "sha512-vJa8fPXuVgGxyTuY5Uaw0pLTgkUrfKa+1keB4I9qLj2+vacs/plYDyLGadGkZbiQzR+zir/w89Bv+J5c59UfiQ==";
        };
        _LXFiKoIu = {
            "id" = "LXFiKoIu";
            "file" = "EasyAnvils-v26.2.3-mc26.2.x-Fabric.jar";
            "hash" = "sha512-d4JmgM0DEUg0b2pdLYeUEn4z93iol6H06OsXdcSe6z4sGoMgUHLYlH/MTWXlfI/HPYjKbYz3DuAXHfJSpPxy7Q==";
        };
        _haCeCUVX = {
            "id" = "haCeCUVX";
            "file" = "EasyAnvils-v26.1.4-mc26.1.x-NeoForge.jar";
            "hash" = "sha512-P5u123C+NTnFeI5Gtd0HiKtuYX8AvpZQP+hNruCQs+wxPWjd8WuwWOoShlpWo3sYhkyeKBX5EinzEIrCDJHKBw==";
        };
        _SFTxlmII = {
            "id" = "SFTxlmII";
    ...
    in {
        ...
        "pkg-v4.0.1-1.19.2-Fabric" = _5tYVFplv;
        "pkg-v4.0.2-1.19.2-Fabric" = _CEO0ufY9;
        "pkg-v4.0.2-1.19.2-Forge" = _mFskueCT;
        "pkg-v4.0.3-1.19.2-Fabric" = _R4psUPcI;
        "pkg-v4.0.3-1.19.2-Forge" = _HERUlROk;
        "pkg-v4.0.4-1.19.2-Fabric" = _sJphe6U6;
        "pkg-v4.0.4-1.19.2-Forge" = _cJQMCFVL;
        "pkg-v4.0.5-1.19.2-Fabric" = _xQLSkKpO;
        "pkg-v4.0.5-1.19.2-Forge" = _64z7n1xl;
        "pkg-v4.0.6-1.19.2-Fabric" = _sDn7os7x;
        "pkg-v4.0.6-1.19.2-Forge" = _kCZ5b9UE;
        "pkg-v4.0.7-1.19.2-Fabric" = _GhLxNQ9x;
        "pkg-v4.0.7-1.19.2-Forge" = _s3U2qFGi;
        "pkg-v4.0.8-1.19.2-Forge" = _ndUYdEZj;
        "pkg-v4.0.8-1.19.2-Fabric" = _gaTVqSAl;
        "pkg-v4.0.9-1.19.2-Fabric" = _xaueNonM;
        "pkg-v4.0.9-1.19.2-Forge" = _qOEcugLf;
        "pkg-v4.0.10-1.19.2-Fabric" = _nMvj17QX;
        "pkg-v4.0.10-1.19.2-Forge" = _jF0q5KS7;
        "pkg-v5.0.0-1.19.3-Fabric" = _zY4Tvn2Z;
        "pkg-v5.0.0-1.19.3-Forge" = _VWBwwDlK;
        "pkg-v4.0.11-1.19.2-Fabric" = _JtDnifrB;
        "pkg-v4.0.11-1.19.2-Forge" = _iYAQ1oaP;
        "pkg-v5.0.1-1.19.3-Fabric" = _jb7JDOsg;
        "pkg-v5.0.1-1.19.3-Forge" = _BdF7GYlv;
        "pkg-v6.0.0-1.19.4-Fabric" = _yNwfm0bQ;
        "pkg-v6.0.0-1.19.4-Forge" = _NbbGmb9T;
        "pkg-v7.0.0-1.20-Forge" = _u6V7v3d7;
        "pkg-v7.0.0-1.20-Fabric" = _7mJc88hD;
        "pkg-v8.0.0-1.20.1-Forge" = _pcDw1xwF;
        "pkg-v8.0.0-1.20.1-Fabric" = _JqhLEX1W;
        "pkg-v8.0.1-1.20.1-Forge" = _JcQZFne1;
        "pkg-v8.0.1-1.20.1-Fabric" = _aGEBKSjm;
        "pkg-v3.0.0-1.18.2-Fabric" = _AzTwoyPb;
        "pkg-v3.0.0-1.18.2-Forge" = _53Dioiza;
        "pkg-v20.4.0-1.20.4-Fabric" = _N3AVcKUh;
        "pkg-v20.4.0-1.20.4-NeoForge" = _iJfuu0Tb;
        "pkg-v20.4.0-1.20.4-Forge" = _buj4LXK5;
        "pkg-v20.4.1-1.20.4-Fabric" = _7fe8p4SL;
        "pkg-v20.4.1-1.20.4-Forge" = _nIsxlUJH;
        "pkg-v20.4.1-1.20.4-NeoForge" = _wraWegFS;
        "pkg-v20.4.2-1.20.4-Fabric" = _zfO0kNZ9;
        "pkg-v20.4.2-1.20.4-Forge" = _YN3lEJU2;
        "pkg-v20.4.2-1.20.4-NeoForge" = _R9Q7S9Cp;
        "pkg-v8.0.2-1.20.1-Forge" = _4pRdDqEb;
        "pkg-v8.0.2-1.20.1-Fabric" = _pA1enJAS;
        "pkg-v20.4.3-1.20.4-Fabric" = _XLEe4VlA;
        "pkg-v20.4.3-1.20.4-Forge" = _1zRbqqKY;
        "pkg-v20.4.3-1.20.4-NeoForge" = _3pySSjn5;
        "pkg-v20.4.4-1.20.4-Fabric" = _dsfJBr9G;
        "pkg-v20.4.4-1.20.4-Forge" = _FkfMgYJT;
        "pkg-v20.4.4-1.20.4-NeoForge" = _WYntgLIO;
        "pkg-v20.4.5-1.20.4-Fabric" = _S7vB48TK;
        "pkg-v20.4.5-1.20.4-Forge" = _Sx92YEEp;
        "pkg-v20.4.5-1.20.4-NeoForge" = _LfQVhilT;
        "pkg-v20.4.6-1.20.4-Fabric" = _kUBlq4YM;
        "pkg-v20.4.6-1.20.4-Forge" = _pM87zO29;
        "pkg-v20.4.6-1.20.4-NeoForge" = _IxNxYaUz;
        "pkg-v21.0.0-1.21-Fabric" = _hLCdPdnt;
        "pkg-v21.0.0-1.21-NeoForge" = _rAK1COML;
        "pkg-v21.0.1-1.21-Fabric" = _5EgPCAhx;
        "pkg-v21.0.1-1.21-NeoForge" = _Y6ReS4Ma;
        "pkg-v21.0.2-1.21-Fabric" = _aoKqxPcT;
        "pkg-v21.0.2-1.21-NeoForge" = _trjwwMwS;
        "pkg-v21.0.3-1.21-Fabric" = _T0ZXxBFB;
        "pkg-v21.0.3-1.21-NeoForge" = _zbasFe2U;
        "pkg-v21.0.4-1.21-Fabric" = _HF83Li2N;
        "pkg-v21.0.4-1.21-NeoForge" = _yOCz951q;
        "pkg-v21.0.5-1.21-Fabric" = _DwKi5WSQ;
        "pkg-v21.0.5-1.21-NeoForge" = _suaVATrC;
        "pkg-v21.1.0-1.21.1-Fabric" = _znaWBlgU;
        "pkg-v21.1.0-1.21.1-NeoForge" = _fSQSKhdF;
        "pkg-v21.3.0-1.21.3-Fabric" = _ExroCNAj;
        "pkg-v21.3.0-1.21.3-NeoForge" = _me5jv5Na;
        "pkg-v21.3.1-1.21.3-Fabric" = _8VYsDvN0;
        "pkg-v21.3.1-1.21.3-NeoForge" = _eWDGOU0o;
        "pkg-v21.4.0-1.21.4-Fabric" = _iNMQpILY;
        "pkg-v21.4.0-1.21.4-NeoForge" = _9ifzDI3T;
        "pkg-v21.4.1-1.21.4-Fabric" = _cgAd1uKH;
        "pkg-v21.4.1-1.21.4-NeoForge" = _znA9vlFD;
        "pkg-v21.5.0-1.21.5-Fabric" = _DwPjofyR;
        "pkg-v21.5.0-1.21.5-NeoForge" = _Z61Cq22T;
        "pkg-v21.5.1-1.21.5-Fabric" = _qQEqn4hc;
        "pkg-v21.5.1-1.21.5-NeoForge" = _yNKI52pp;
        "pkg-v21.6.0-1.21.6-Fabric" = _OMeWvqru;
        "pkg-v21.6.0-1.21.6-NeoForge" = _iBv3dIfE;
        "pkg-v21.7.0-1.21.7-Fabric" = _RSZINDZM;
        "pkg-v21.7.0-1.21.7-NeoForge" = _TTXCowu2;
        "pkg-v21.8.0-1.21.8-Fabric" = _6YOM0PrU;
        "pkg-v21.8.0-1.21.8-NeoForge" = _uwVSzFMS;
        "pkg-21.9.0" = _e9oR3mBE;
        "pkg-21.10.0" = _RRPRJ01x;
        "pkg-21.11.0" = _Ti2RnQEI;
        "pkg-26.1.0" = _myHEJvmy;
        "pkg-26.1.1" = _vl968dqc;
        "pkg-26.2.0" = _KcJhAXER;
        "pkg-26.2.1" = _lXh7vuZY;
        "pkg-26.1.2" = _bRzBKx8L;
        "pkg-21.11.1" = _Wtivj05n;
        "pkg-26.1.3" = _NZUd2TGk;
