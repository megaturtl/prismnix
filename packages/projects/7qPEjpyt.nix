...
let
    ...
    in {
        ...
        "pkg-1.19.3-2.0-forge" = _p3i61xNn;
        "pkg-1.18.2-3.0-forge+fabric" = _bNsJQ0z1;
        "pkg-1.19.2-3.0-forge+fabric" = _SZIWkhxh;
        "pkg-1.19.3-3.0-forge+fabric" = _VQXJxBcJ;
        "pkg-1.19.4-3.0-forge+fabric" = _AgS05xiZ;
        "pkg-1.20-3.0-forge+fabric" = _FSKTIEzz;
        "pkg-1.20.1-3.0-forge+fabric" = _ZVkYYBYb;
        "pkg-1.20.2-3.0-forge+fabric" = _mpxJrRfn;
        "pkg-1.18.2-3.1-forge+fabric" = _SwvwgVUM;
        "pkg-1.19.2-3.1-forge+fabric" = _QF9pUyJh;
        "pkg-1.20.1-3.1-forge+fabric" = _rSSN0Qys;
        "pkg-1.20.2-3.1-forge+fabric" = _g7nbNgPd;
        "pkg-1.20.3-3.1-fabric+forge+neo" = _IIy6XBsp;
        "pkg-1.20.4-3.1-fabric+forge+neo" = _LxWTEgkx;
        "pkg-1.19.2-3.2-fabric+forge+neo" = _SLnGlTGF;
        "pkg-1.20.1-3.2-fabric+forge+neo" = _b0sG7xXx;
        "pkg-1.20.2-3.2-fabric+forge+neo" = _dJjfjCyV;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _UtmxCqri;
        "pkg-1.20.5-3.2-fabric+neo" = _XcveGqif;
        "pkg-1.20.5-3.3-fabric+neo" = _yzCPKTYx;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _7DgEykUl;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _KgnUOTNw;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _RLfE9Cja;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _aVmxaOxB;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _ASXNXgnZ;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _8WU8gVhX;
        "pkg-1.21.2-3.4-fabric+neo" = _hTvjYcY6;
        "pkg-1.21.3-3.4-fabric+forge+neo" = _2LAi6K5Y;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _poauPp6M;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _rsVVviWH;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _nbdWrSlu;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _WCCcVVvS;
        "pkg-1.21.5-3.5-fabric+forge+neo" = _LqNyex1O;
        "pkg-1.21.6-3.5-fabric+forge+neo" = _EIRMAX6g;
        "pkg-1.21.7-3.5-fabric+forge+neo" = _lTCySJ09;
        "pkg-1.21.8-3.5-fabric+forge+neo" = _FzRM9ZZo;
        "pkg-1.21.9-3.5-fabric+forge+neo" = _jjtty6Rq;
        "pkg-1.21.9-3.6-fabric+forge+neo" = _qe8by3Wo;
        "pkg-1.21.10-3.6-fabric+forge+neo" = _3oUazvOj;
        "pkg-1.21.11-3.6-fabric+forge+neo" = _Poz0mEPc;
        "pkg-26.1.0-3.6-fabric+forge+neo" = _6cZw7ZON;
