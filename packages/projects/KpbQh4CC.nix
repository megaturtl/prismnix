...
let
    ...
    in {
        ...
        "pkg-2.9b" = _Tb6ltZlg;
        "pkg-2.9b+mod" = _udhFdIhm;
        "pkg-2.9.8" = _KLUaGT4Y;
        "pkg-2.9.8+mod" = _xO7963hr;
        "pkg-2.9.8.1" = _YBPkH7dy;
        "pkg-2.9.8.1+mod" = _6iW9puyH;
        "pkg-2.9.8.2" = _CGlHZWO5;
        "pkg-2.9.8.2+mod" = _6qnfC27e;
        "pkg-2.9.8.5" = _UpsM1rUn;
        "pkg-2.9.8.5+mod" = _E5gVovZL;
        "pkg-3.0" = _WWhP4xEc;
        "pkg-3.0+mod" = _CRak7uiF;
        "pkg-3.0-1.21.3" = _rlZRYbJ7;
        "pkg-3.0-1.21.3+mod" = _608c8Rll;
        "pkg-3.0-1.21.1" = _5B83VmGs;
        "pkg-3.0-1.21.1+mod" = _XnUH0oLi;
        "pkg-3.0.1" = _22K2mGyZ;
        "pkg-3.0.1+mod" = _V4tgDXJs;
        "pkg-3.0.1.1.21.3" = _41FzLaJP;
        "pkg-3.0.1.2.21.1" = _REFgH87S;
        "pkg-3.0.1.1.21.3+mod" = _abiizMcV;
        "pkg-3.0.1.2.21.1+mod" = _h8FHr0i4;
        "pkg-3.0.2" = _7MxoE0bU;
        "pkg-3.0.2+mod" = _Wz63LgZW;
        "pkg-3.0.2.1.21.1" = _CCR0xkeW;
        "pkg-3.0.2.1.21.1+mod" = _ipzLkNmD;
        "pkg-3.0.2.1.21.3" = _RFuCM5L3;
        "pkg-3.0.2.1.21.3+mod" = _4NC33Gy7;
        "pkg-3.0.3" = _jV8a8PkW;
        "pkg-3.0.3.1.21.3" = _VH71ODX8;
        "pkg-3.0.3.1.21" = _zCTVkO7i;
        "pkg-3.0.3+mod" = _n6gMUEaf;
        "pkg-3.0.3.1.21.3+mod" = _FJzDIsWN;
        "pkg-3.0.3.1.21+mod" = _JRInCmJ0;
        "pkg-3.0.4" = _3UeY5gil;
        "pkg-3.0.4.+mod" = _C7NGDDAY;
        "pkg-3.0.4.1.21.1" = _IyMVisRP;
        "pkg-3.0.4.1.21.1+mod" = _yAg9KzNd;
        "pkg-3.0.5" = _uDwONrNU;
        "pkg-3.0.5+mod" = _PHeLsIEO;
        "pkg-4.0" = _jISgOUaO;
        "pkg-4.0+mod" = _kxGN9YN0;
        "pkg-4.0-backport" = _EFOBDp0b;
        "pkg-4.0-backport+mod" = _5XpN1tTG;
        "pkg-4.0.1-portal-fix" = _ENl8DXvM;
        "pkg-4.0.1-portal-fix+mod" = _zDzHMRgl;
        "pkg-4.0.1-1.21.9-portal-fix" = _NAjWRWx4;
