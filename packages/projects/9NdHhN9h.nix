...
let
    ...
    in {
        ...
        "pkg-1.2.6" = _gL2uCx1v;
        "pkg-1.2.7" = _r0RG8Xkz;
        "pkg-1.2.7.1" = _W7pI0lVf;
        "pkg-1.2.8" = _tudmyrYJ;
        "pkg-1.2.9" = _SmXue6yy;
        "pkg-1.2.9-fix" = _Ylrcx9eR;
        "pkg-1.3.0" = _ipBci2cT;
        "pkg-1.3.1" = _Dv9dqVON;
        "pkg-1.3.2" = _a5Carl1k;
        "pkg-1.3.2-fix" = _EljNs6Or;
        "pkg-1.3.2-fix2" = _DWZQjPp8;
        "pkg-1.3.3" = _MNHozipq;
        "pkg-1.3.4" = _gPoXJ1Sp;
        "pkg-1.3.4-fix" = _zKSfuYsx;
        "pkg-1.3.5" = _pTZvYBAS;
        "pkg-1.3.5-fix" = _x25AgdM7;
        "pkg-1.3.6" = _OtK7bKLk;
        "pkg-1.3.7" = _6FoTQRR2;
        "pkg-1.3.7-fix" = _iimG3GWo;
        "pkg-1.3.8" = _yB59mmm4;
        "pkg-1.3.8-fix" = _XVrS7JdC;
        "pkg-1.3.9" = _yzvjjpKb;
        "pkg-1.4.0" = _O6uHUMX5;
        "pkg-1.4.1" = _an2HgPq8;
        "pkg-1.4.2" = _Gdp0nvDq;
        "pkg-1.4.2-fix" = _B542HQ8Y;
