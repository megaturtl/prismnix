...
let
    versions = (let
        ...
        _aQwYQ589 = {
            "id" = "aQwYQ589";
            "file" = "Female-Gender-Mod-5.0.0-Beta.5+mc26.1-fabric.jar";
            "hash" = "sha512-tx+ePCzjmRAX9xcx0YzEsoz/JnU+lIwgPerg1J2oLXI/qCDDhTFRlAjqQJd6+H3dbNatvz5yFmZJ8g2oLiM/Mw==";
        };
        _m9z3e56z = {
            "id" = "m9z3e56z";
            "file" = "Female-Gender-Mod-5.0.0-Beta.5+mc26.1-neoforge.jar";
            "hash" = "sha512-LmQeT3y+wO5023t0vZeh0D6tzYo8RBM0vCP5tlnPnq5jzgzTUx0PW2DTt/cKGMtKgrBILwJpJxSap1ODwfgZew==";
        };
        _a98J621N = {
            "id" = "a98J621N";
            "file" = "Female-Gender-Mod-5.0.0-Beta.5+mc26.2-fabric.jar";
            "hash" = "sha512-CgMPs0mDqyKkXPbpqBcMpSj45vAF+Vu5eRm6OvWUOxsZ0Dkhca/HOUuIndNbAfU7ygHwmIEOD8LdYb7fCbvPXA==";
        };
        _4vWWUePM = {
            "id" = "4vWWUePM";
            "file" = "Female-Gender-Mod-5.0.0-Beta.5+mc26.2-neoforge.jar";
            "hash" = "sha512-96wuZuQ3LpGT47pA7V12ldHSqV8fiZsh2sh6YNTEgJZckm0SqnBYCrB5Yo647m39q8UqX/Mfp8as9led9u8Hpg==";
        };
        _OQqLMTt6 = {
            "id" = "OQqLMTt6";
            "file" = "Female-Gender-Mod-5.0.0-Beta.5+mc26.3-fabric.jar";
            "hash" = "sha512-5y7fguNuXVyK09EidPuDudqzWJ4FhlCE2+jYiQKk4THabWqC6MAa2AWqZdetafkystO3Zdm8GW9GhN5+NkwQ1Q==";
        };
        _HFbDcKC2 = {
            "id" = "HFbDcKC2";
    ...
    in {
        ...
        "pkg-2.1" = _xhjvD71q;
        "pkg-2.0.1" = _CzJm74DP;
        "pkg-Fabric 2.4.1" = _WNvoYyLX;
        "pkg-Forge 2.4.1" = _lW6AKp26;
        "pkg-Fabric 2.5.3" = _NRoYoGky;
        "pkg-Forge 2.5.3" = _NHBXvjzQ;
        "pkg-2.8.2" = _JllDC5N2;
        "pkg-2.8.1" = _4NxWNThI;
        "pkg-2.9" = _qx8RhTPG;
        "pkg-2.9-forge" = _xf3R8OcZ;
        "pkg-3.0.0-1.19-forge" = _eyZpCNv5;
        "pkg-3.0.0-1.19-fabric" = _AgkDJuiX;
        "pkg-1.19.3-3.0.1" = _KGbQaWJJ;
        "pkg-1.20-3.0.1" = _nYZ0oktX;
        "pkg-1.20.1-3.0.1" = _R1d8TWqL;
        "pkg-1.20-3.1" = _yWpAgnNY;
        "pkg-1.20.2-3.1" = _f7iAz2uM;
        "pkg-1.20.2-3.2" = _D2jPRfnO;
        "pkg-1.20.2-3.2.1" = _boFXbHzM;
        "pkg-1.20.4-3.2.1" = _aV0Iv9GH;
        "pkg-3.2.1+1.20.6" = _VIDqkPkA;
        "pkg-3.2.0" = _hfCySiEz;
        "pkg-3.2.1+1.21" = _kJmjQvAS;
        "pkg-4.0+1.21.2" = _zetlnn7C;
        "pkg-4.1+1.21.2" = _xfOyRZEU;
        "pkg-4.2+1.21.2" = _ds2SvRp9;
        "pkg-4.2.1+1.21.2" = _Zd2aH2gN;
        "pkg-4.3+1.21.3" = _nlaQL1S7;
        "pkg-4.3+1.21.4" = _ArqNhZiQ;
        "pkg-4.3.1+1.21.4" = _LpGw5e3M;
        "pkg-4.3.2+1.21.4" = _f43T1FTZ;
        "pkg-4.3.3+1.21.4" = _T31mEfNe;
        "pkg-3.2.2" = _kKffHCGl;
        "pkg-4.3.4+1.21.5" = _Z8Fpc7Bt;
        "pkg-4.3.4+1.21.7" = _Z3yx6MPE;
        "pkg-5.0.0-Beta.1+1.21.9" = _PLVJzXdR;
        "pkg-5.0.0-Beta.2+1.21.10" = _wV4whY0G;
        "pkg-5.0.0-Beta.2+1.21.11" = _wxfN7iwN;
        "pkg-5.0.0-Beta.3+1.21.11" = _W7WJBV1r;
        "pkg-5.0.0-Beta.3+26.1" = _YNCzD9UW;
        "pkg-5.0.0-Beta.4+26.2" = _BGSsrIlj;
        "pkg-5.0.0-Beta.4+26.1" = _VI0GA2EF;
        "pkg-5.0.0-Beta.5+mc26.1-fabric" = _aQwYQ589;
        "pkg-5.0.0-Beta.5+mc26.1-neoforge" = _m9z3e56z;
        "pkg-5.0.0-Beta.5+mc26.2-fabric" = _a98J621N;
