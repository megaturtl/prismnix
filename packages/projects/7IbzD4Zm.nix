...
let
    versions = (let
        ...
        _OxMy0xf6 = {
            "id" = "OxMy0xf6";
            "file" = "SignedVelocity-Proxy-1.5.0.jar";
            "hash" = "sha512-+fwLqj3mcwXjdpUfnf6XARVTtvbR/e4cH+dSDMdeZF/1hTqfaeNqK/8B7m19ZBIH2YIDzRwuXIj2khsVkvvM9Q==";
        };
        _RWE2rO0B = {
            "id" = "RWE2rO0B";
            "file" = "SignedVelocity-Sponge-10-1.5.0.jar";
            "hash" = "sha512-KOn3lnIcQVScl+sqDZ+t5XhrGVBJRk+guBb/pWnUSLmmHF4siMbHnG4cMJ4WjlmKjybdNBPBK00lC9tz2gVUOQ==";
        };
        _bAJHkeGR = {
            "id" = "bAJHkeGR";
            "file" = "SignedVelocity-Sponge-12-1.5.0.jar";
            "hash" = "sha512-im6mImPZrGgknck4HnVuW4uoR44CcJCIWYuk4egFdOoE3MvxMBOwXGF0OSZca53YRlYy5mGSzTe08KcoYrKk2Q==";
        };
        _oEqZsNvv = {
            "id" = "oEqZsNvv";
            "file" = "SignedVelocity-Paper-1.5.0.jar";
            "hash" = "sha512-Hn59gs9bZKUE4E0qFhR1PF3PZs0scNW0/rccQYkyYRhrAaeLgvVKsaD20nle22t4BgldItAKmOyBQYd+Pz5ytQ==";
        };
        _MBoj4XJ8 = {
            "id" = "MBoj4XJ8";
            "file" = "SignedVelocity-Fabric-1.5.0.jar";
            "hash" = "sha512-J+S/KXIAzTH9N+Om/J2k8L1tVKQvF0arRkO0diY+Jydcr0wDuxX91tRVsZWiIDLyTmoya2MF82rgNy5/AkjJ0w==";
        };
    in {
        "2qHYs6ts" = _2qHYs6ts;
        "Ym4p1nO4" = _Ym4p1nO4;
        ...
        "folia-26.1" = _oEqZsNvv;
        "folia-26.1.1" = _oEqZsNvv;
        "folia-26.1.2" = _oEqZsNvv;
        "folia-26.2" = _oEqZsNvv;
        ...
        "paper-26.1" = _oEqZsNvv;
        "paper-26.1.1" = _oEqZsNvv;
        "paper-26.1.2" = _oEqZsNvv;
        "paper-26.2" = _oEqZsNvv;
        ...
        "purpur-26.1" = _oEqZsNvv;
        "purpur-26.1.1" = _oEqZsNvv;
        "purpur-26.1.2" = _oEqZsNvv;
        "purpur-26.2" = _oEqZsNvv;
        "velocity-1.7.2" = _OxMy0xf6;
        "velocity-1.7.3" = _OxMy0xf6;
        "velocity-1.7.4" = _OxMy0xf6;
        "velocity-1.7.5" = _OxMy0xf6;
        "velocity-1.7.6" = _OxMy0xf6;
        "velocity-1.7.7" = _OxMy0xf6;
        "velocity-1.7.8" = _OxMy0xf6;
        "velocity-1.7.9" = _OxMy0xf6;
        "velocity-1.7.10" = _OxMy0xf6;
        "velocity-1.8" = _OxMy0xf6;
        "velocity-1.8.1" = _OxMy0xf6;
        "velocity-1.8.2" = _OxMy0xf6;
        "velocity-1.8.3" = _OxMy0xf6;
        "velocity-1.8.4" = _OxMy0xf6;
        "velocity-1.8.5" = _OxMy0xf6;
        "velocity-1.8.6" = _OxMy0xf6;
        "velocity-1.8.7" = _OxMy0xf6;
        "velocity-1.8.8" = _OxMy0xf6;
        "velocity-1.8.9" = _OxMy0xf6;
        "velocity-1.9" = _OxMy0xf6;
        "velocity-1.9.1" = _OxMy0xf6;
        "velocity-1.9.2" = _OxMy0xf6;
        "velocity-1.9.3" = _OxMy0xf6;
        "velocity-1.9.4" = _OxMy0xf6;
        "velocity-1.10" = _OxMy0xf6;
        "velocity-1.10.1" = _OxMy0xf6;
        "velocity-1.10.2" = _OxMy0xf6;
        "velocity-1.11" = _OxMy0xf6;
        "velocity-1.11.1" = _OxMy0xf6;
        "velocity-1.11.2" = _OxMy0xf6;
        "velocity-1.12" = _OxMy0xf6;
        "velocity-1.12.1" = _OxMy0xf6;
        "velocity-1.12.2" = _OxMy0xf6;
        "velocity-1.13" = _OxMy0xf6;
        "velocity-1.13.1" = _OxMy0xf6;
        "velocity-1.13.2" = _OxMy0xf6;
        "velocity-1.14" = _OxMy0xf6;
        "velocity-1.14.1" = _OxMy0xf6;
        "velocity-1.14.2" = _OxMy0xf6;
        "velocity-1.14.3" = _OxMy0xf6;
        "velocity-1.14.4" = _OxMy0xf6;
        "velocity-1.15" = _OxMy0xf6;
        "velocity-1.15.1" = _OxMy0xf6;
        "velocity-1.15.2" = _OxMy0xf6;
        "velocity-1.16" = _OxMy0xf6;
        "velocity-1.16.1" = _OxMy0xf6;
        "velocity-1.16.2" = _OxMy0xf6;
        "velocity-1.16.3" = _OxMy0xf6;
        "velocity-1.16.4" = _OxMy0xf6;
        "velocity-1.16.5" = _OxMy0xf6;
        "velocity-1.17" = _OxMy0xf6;
        "velocity-1.17.1" = _OxMy0xf6;
        "velocity-1.18" = _OxMy0xf6;
        "velocity-1.18.1" = _OxMy0xf6;
        "velocity-1.18.2" = _OxMy0xf6;
        "velocity-1.19" = _OxMy0xf6;
        "velocity-1.19.1" = _OxMy0xf6;
        "velocity-1.19.2" = _OxMy0xf6;
        "velocity-1.19.3" = _OxMy0xf6;
        "velocity-1.19.4" = _OxMy0xf6;
        "velocity-1.20" = _OxMy0xf6;
        "velocity-1.20.1" = _OxMy0xf6;
        "velocity-1.20.2" = _OxMy0xf6;
        "velocity-1.20.3" = _OxMy0xf6;
        "velocity-1.20.4" = _OxMy0xf6;
        "velocity-1.20.5" = _OxMy0xf6;
        "velocity-1.20.6" = _OxMy0xf6;
        "velocity-1.21" = _OxMy0xf6;
        "velocity-1.21.1" = _OxMy0xf6;
        "velocity-1.21.2" = _OxMy0xf6;
        "velocity-1.21.3" = _OxMy0xf6;
        "velocity-1.21.4" = _OxMy0xf6;
        "velocity-1.21.5" = _OxMy0xf6;
        "velocity-1.21.6" = _OxMy0xf6;
        "velocity-1.21.7" = _OxMy0xf6;
        "velocity-1.21.8" = _OxMy0xf6;
        "velocity-1.21.9" = _OxMy0xf6;
        "velocity-1.21.10" = _OxMy0xf6;
        "velocity-1.21.11" = _OxMy0xf6;
        "velocity-26.1" = _OxMy0xf6;
        "velocity-26.1.1" = _OxMy0xf6;
        "velocity-26.1.2" = _OxMy0xf6;
        "velocity-26.2" = _OxMy0xf6;
        ...
        "sponge-1.19" = _RWE2rO0B;
        "sponge-1.19.1" = _RWE2rO0B;
        "sponge-1.19.2" = _RWE2rO0B;
        "sponge-1.19.3" = _RWE2rO0B;
        "sponge-1.19.4" = _RWE2rO0B;
        "sponge-1.20" = _bAJHkeGR;
        "sponge-1.20.1" = _bAJHkeGR;
        "sponge-1.20.2" = _bAJHkeGR;
        "sponge-1.20.3" = _bAJHkeGR;
        "sponge-1.20.4" = _bAJHkeGR;
        "sponge-1.20.5" = _bAJHkeGR;
        "sponge-1.20.6" = _bAJHkeGR;
        "sponge-1.21" = _bAJHkeGR;
        "sponge-1.21.1" = _bAJHkeGR;
        "sponge-1.21.2" = _bAJHkeGR;
        "sponge-1.21.3" = _bAJHkeGR;
        "sponge-1.21.4" = _bAJHkeGR;
        "sponge-1.21.5" = _bAJHkeGR;
        "sponge-1.21.6" = _bAJHkeGR;
        "sponge-1.21.7" = _bAJHkeGR;
        "sponge-1.21.8" = _bAJHkeGR;
        "sponge-1.21.9" = _bAJHkeGR;
        "sponge-1.21.10" = _bAJHkeGR;
        "sponge-1.21.11" = _bAJHkeGR;
        "sponge-26.1" = _bAJHkeGR;
        "sponge-26.1.1" = _bAJHkeGR;
        "sponge-26.1.2" = _bAJHkeGR;
        "sponge-26.2" = _bAJHkeGR;
        ...
        "fabric-26.1" = _MBoj4XJ8;
        "fabric-26.1.1" = _MBoj4XJ8;
        "fabric-26.1.2" = _MBoj4XJ8;
        "fabric-26.2" = _MBoj4XJ8;
