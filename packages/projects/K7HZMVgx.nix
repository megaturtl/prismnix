...
let
    versions = (let
        ...
        _VzgE2Hfp = {
            "id" = "VzgE2Hfp";
            "file" = "EssentialsC-4.2.7-all.jar";
            "hash" = "sha512-tkQf6Qho2I+BXtDGLF4sbn6VPy8Rl25vkQb+7MF2BW4QLD82dtDZStoYPi8luHvwT7+xPq3KOiy8306BdGOmnQ==";
        };
        _kW3DjvqF = {
            "id" = "kW3DjvqF";
            "file" = "EssentialsC-4.2.7.1-all.jar";
            "hash" = "sha512-t9G1CYr5IM2bprPIIQWsmU7z0MaSqyojf//VK23YGRNixQfU7kuchjBS3sCzW11JIHPkT2Uv4B424mCBOB1Q/w==";
        };
        _x9O75ptq = {
            "id" = "x9O75ptq";
            "file" = "EssentialsC-4.2.8-all.jar";
            "hash" = "sha512-S3jcu2E3tJre7ZhyY7BGUMd+4q/ZiztoqPDrlzxCFxWK+EzxlwA1+dl28LTWNzQOrtRlPCpFiAvmRgUswpRa7w==";
        };
        _2WAMWuvT = {
            "id" = "2WAMWuvT";
            "file" = "EssentialsC-4.2.9-all.jar";
            "hash" = "sha512-iSQm9n4mqVzhJHSq/53S2Wodd6/KnZ2to6KE2Y/yy4PcugCiLpv4VCJgjzD86oavy+U0JU2f2SshzOS9HGrY/Q==";
        };
        _2T3awGxV = {
            "id" = "2T3awGxV";
            "file" = "EssentialsC-4.3.0-all.jar";
            "hash" = "sha512-QaO57SLdeI1ghK4khIDaxU9nFGdGeI/1jK80A0q91xq1tNof085HBg22DaLLM0pLcAVT0/CNlwsztpdOxxD2wA==";
        };
    in {
        "cDPYVsQf" = _cDPYVsQf;
        "Lb5JLZIo" = _Lb5JLZIo;
        ...
        "2WAMWuvT" = _2WAMWuvT;
        "2T3awGxV" = _2T3awGxV;
        "bukkit-1.21" = _2T3awGxV;
        "bukkit-1.21.1" = _2T3awGxV;
        "bukkit-1.21.2" = _2T3awGxV;
        "bukkit-1.21.3" = _2T3awGxV;
        "bukkit-1.21.4" = _2T3awGxV;
        "bukkit-1.21.5" = _2T3awGxV;
        ...
        "bukkit-1.20.6" = _2T3awGxV;
        "bukkit-1.21.6" = _2T3awGxV;
        "bukkit-1.21.7" = _2T3awGxV;
        "bukkit-1.21.8" = _2T3awGxV;
        "bukkit-1.2.1" = _5gys2QHn;
        "bukkit-1.2.2" = _5gys2QHn;
        "bukkit-1.2.3" = _5gys2QHn;
        "bukkit-1.2.4" = _5gys2QHn;
        "bukkit-1.2.5" = _5gys2QHn;
        "bukkit-1.21.9" = _2T3awGxV;
        "bukkit-1.21.10" = _2T3awGxV;
        ...
        "bukkit-1.21.11" = _2T3awGxV;
        "bukkit-26.1" = _2T3awGxV;
        "bukkit-26.1.1" = _2T3awGxV;
        "bukkit-26.1.2" = _2T3awGxV;
        "bukkit-26.2" = _2T3awGxV;
        "paper-1.21" = _2T3awGxV;
        "paper-1.21.1" = _2T3awGxV;
        "paper-1.21.2" = _2T3awGxV;
        "paper-1.21.3" = _2T3awGxV;
        "paper-1.21.4" = _2T3awGxV;
        "paper-1.21.5" = _2T3awGxV;
        ...
        "paper-1.20.6" = _2T3awGxV;
        "paper-1.21.6" = _2T3awGxV;
        "paper-1.21.7" = _2T3awGxV;
        "paper-1.21.8" = _2T3awGxV;
        "paper-1.2.1" = _5gys2QHn;
        "paper-1.2.2" = _5gys2QHn;
        "paper-1.2.3" = _5gys2QHn;
        "paper-1.2.4" = _5gys2QHn;
        "paper-1.2.5" = _5gys2QHn;
        "paper-1.21.9" = _2T3awGxV;
        "paper-1.21.10" = _2T3awGxV;
        ...
        "paper-1.21.11" = _2T3awGxV;
        "paper-26.1" = _2T3awGxV;
        "paper-26.1.1" = _2T3awGxV;
        "paper-26.1.2" = _2T3awGxV;
        "paper-26.2" = _2T3awGxV;
        "spigot-1.21" = _2T3awGxV;
        "spigot-1.21.1" = _2T3awGxV;
        "spigot-1.21.2" = _2T3awGxV;
        "spigot-1.21.3" = _2T3awGxV;
        "spigot-1.21.4" = _2T3awGxV;
        "spigot-1.21.5" = _2T3awGxV;
        ...
        "spigot-1.20.6" = _2T3awGxV;
        "spigot-1.21.6" = _2T3awGxV;
        "spigot-1.21.7" = _2T3awGxV;
        "spigot-1.21.8" = _2T3awGxV;
        "spigot-1.2.1" = _5gys2QHn;
        "spigot-1.2.2" = _5gys2QHn;
        "spigot-1.2.3" = _5gys2QHn;
        "spigot-1.2.4" = _5gys2QHn;
        "spigot-1.2.5" = _5gys2QHn;
        "spigot-1.21.9" = _2T3awGxV;
        "spigot-1.21.10" = _2T3awGxV;
        ...
        "spigot-1.21.11" = _2T3awGxV;
        "spigot-26.1" = _2T3awGxV;
        "spigot-26.1.1" = _2T3awGxV;
        "spigot-26.1.2" = _2T3awGxV;
        "spigot-26.2" = _2T3awGxV;
        ...
        "purpur-1.20.6" = _2T3awGxV;
        "purpur-1.21" = _2T3awGxV;
        "purpur-1.21.1" = _2T3awGxV;
        "purpur-1.21.2" = _2T3awGxV;
        "purpur-1.21.3" = _2T3awGxV;
        "purpur-1.21.4" = _2T3awGxV;
        "purpur-1.21.5" = _2T3awGxV;
        "purpur-1.21.6" = _2T3awGxV;
        "purpur-1.21.7" = _2T3awGxV;
        "purpur-1.21.8" = _2T3awGxV;
        "purpur-1.2.1" = _5gys2QHn;
        "purpur-1.2.2" = _5gys2QHn;
        "purpur-1.2.3" = _5gys2QHn;
        "purpur-1.2.4" = _5gys2QHn;
        "purpur-1.2.5" = _5gys2QHn;
        "purpur-1.21.9" = _2T3awGxV;
        "purpur-1.21.10" = _2T3awGxV;
        ...
        "purpur-1.21.11" = _2T3awGxV;
        "purpur-26.1" = _2T3awGxV;
        "purpur-26.1.1" = _2T3awGxV;
        "purpur-26.1.2" = _2T3awGxV;
        "purpur-26.2" = _2T3awGxV;
        ...
        "folia-1.20.6" = _2T3awGxV;
        "folia-1.21" = _2T3awGxV;
        "folia-1.21.1" = _2T3awGxV;
        "folia-1.21.2" = _2T3awGxV;
        "folia-1.21.3" = _2T3awGxV;
        "folia-1.21.4" = _2T3awGxV;
        "folia-1.21.5" = _2T3awGxV;
        "folia-1.21.6" = _2T3awGxV;
        "folia-1.21.7" = _2T3awGxV;
        "folia-1.21.8" = _2T3awGxV;
        "folia-1.21.9" = _2T3awGxV;
        "folia-1.21.10" = _2T3awGxV;
        "folia-1.21.11" = _2T3awGxV;
        "folia-26.1" = _2T3awGxV;
        "folia-26.1.1" = _2T3awGxV;
        "folia-26.1.2" = _2T3awGxV;
        "folia-26.2" = _2T3awGxV;
        "pkg-1.21.x" = _cDPYVsQf;
        "pkg-1.20.x" = _Lb5JLZIo;
        "pkg-1.1" = _P6SbJCdJ;
        "pkg-1.2" = _9ZUI9EpI;
        "pkg-v1.3" = _YKUDUhhP;
        "pkg-1.4" = _ZonJQe33;
        ...
        "pkg-2.0.1" = _sIqc1Gma;
        "pkg-2.0.2" = _fLJI2t1b;
        "pkg-2.0.3.1" = _JZqDFvgY;
        "pkg-2.0.3.2" = _YKd8sOEp;
        "pkg-2.0.4" = _R67m2WcY;
        "pkg-2.0.5" = _5lnc3SLv;
        "pkg-2.0.6" = _PLhEBYcJ;
        "pkg-2.0.7" = _zayYm0k4;
        "pkg-2.0.7.1" = _WqF0gFXn;
        "pkg-2.0.7.2" = _aVeZSEAi;
        "pkg-2.0.7.3" = _q9TD6Mzj;
        "pkg-2.0.7.4" = _gLWnudrE;
        "pkg-2.0.7.5" = _F3eU0JqN;
        "pkg-2.0.7.6" = _xuBpbtla;
        "pkg-2.0.7.7" = _qI0KFvXr;
        "pkg-2.0.7.8" = _Ju4hq5Sr;
        "pkg-2.0.7.9" = _o1FT3TgA;
        "pkg-2.0.8" = _lZU7MvVg;
        "pkg-2.0.8.1" = _zgYUCd0l;
        "pkg-2.0.8.2" = _lhp4iG5R;
        "pkg-2.0.8.3" = _nUdhgUNL;
        "pkg-2.0.8.4" = _5gys2QHn;
        "pkg-3.0.0.0" = _hxASuDgV;
        "pkg-3.0.0.1" = _UXebq92G;
        "pkg-3.0.0.2" = _niIz7cF1;
        "pkg-4.0.0" = _puXUzxQz;
        "pkg-4.0.1" = _baSbRR1J;
        "pkg-4.0.2" = _vJZIvv0c;
        "pkg-4.0.3" = _ECQELUR9;
