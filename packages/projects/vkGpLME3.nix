...
let
    ...
    in {
        ...
        "pkg-1201.2.1" = _XxboJpOp;
        "pkg-1211.2.2" = _v4PGxWG7;
        "pkg-1201.2.2" = _ROYTd2Jj;
        "pkg-1201.2.3" = _J5g4AREv;
        "pkg-1211.2.3" = _eimwwt67;
        "pkg-1201.2.4" = _NXUoAHTB;
        "pkg-1211.2.4" = _mk2lABmF;
        "pkg-1201.2.5" = _43nKYrFg;
        "pkg-1211.2.5" = _j6N7RqpW;
        "pkg-1201.2.6" = _R7lHjTfq;
        "pkg-1211.2.6" = _EwXqW8pq;
        "pkg-1201.2.7" = _s79Gn288;
        "pkg-1211.2.7" = _FbEhFrzb;
        "pkg-1211.2.8" = _5xBIv50o;
        "pkg-1201.2.8" = _zjDaT9EI;
        "pkg-1201.2.9" = _DMYiHijx;
