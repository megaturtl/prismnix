...
let
    versions = (let
        ...
        _2Zcqngx6 = {
            "id" = "2Zcqngx6";
            "file" = "betterstairscrafting-1.18.2-fabric-1.jar";
            "hash" = "sha512-cRm5L6y8mWC2Ts+IqPwYyG02WzxbjuQEcHurc7zM7bpjBhI7t8V/wIrOQI3OIsfvLl8nV5Fwp8Vr/LhRJk0psw==";
        };
        _RQbe87vK = {
            "id" = "RQbe87vK";
            "file" = "betterstairscrafting-1.18.2-forge-1.jar";
            "hash" = "sha512-TGRctLwMhNL9YkqUmvd9amTqPCXH+mtMFYuuIFf1fBG688giMAexko4lZUJ/kfm5pgu3B0WfIZLuknocv2fPRQ==";
        };
        _KwAPtxkE = {
            "id" = "KwAPtxkE";
            "file" = "betterstairscrafting-1.19.2-fabric-1.jar";
            "hash" = "sha512-3hHTWgvPbCqEIUjltHh00fJbewecTZGmLfHJ81dVljVUCTCgUmXDckezzwfq9Pn5W08HclsL2ZgrH+wyvqQFrw==";
        };
        _xWBlmTUA = {
            "id" = "xWBlmTUA";
            "file" = "betterstairscrafting-1.19.2-forge-1.jar";
            "hash" = "sha512-o3FiG4cur5JN8CuNzUSoeontz3yrro4i7ho5BupAK+RYlWXVpz25QenzjCar/y0I+yhu1NusslIAmGARw0ZkiQ==";
        };
        _yvlzd5JP = {
            "id" = "yvlzd5JP";
            "file" = "betterstairscrafting-1.20.1-fabric-1.jar";
            "hash" = "sha512-CVoGCh9iEQtFYYZdMtl3aBTL8rH7vlI1Xa/ene+63l1nKR9a4x0Ml/1u1K4c7qV6vm3M6rP2oeYDU7atmJkwfw==";
        };
        _owhMnbvY = {
            "id" = "owhMnbvY";
            "file" = "betterstairscrafting-1.20.1-forge-1.jar";
            "hash" = "sha512-YEJxFez56AJxNdqN3NuOXNHKExHxQ8aG/5AAvlCb0WpJ54+6F0yonrq1RzfVsEA7TTJTSD1GUAVpwvVx2z5PNQ==";
        };
        _mxHS9rNu = {
            "id" = "mxHS9rNu";
            "file" = "betterstairscrafting-1.21.1-fabric-1.jar";
            "hash" = "sha512-fHOWE1LUC1ahKvl+JPjbRtzGfzO+dRFujGjy0y4U5Xsm4ohULjJHDIfr91mywNrU3szQPQmkbigFcU5MvQBnDg==";
        };
        _Oi8EmH9D = {
            "id" = "Oi8EmH9D";
            "file" = "betterstairscrafting-1.21.1-forge-1.jar";
            "hash" = "sha512-FFYp/jZFZXXSvimrW6fEG8GB4y3eseZqtvXxoAMeTi7od4eheJ6Zxw2BNrqPwcHjxDBI37XAWHPDFzb1f+rg2Q==";
        };
        _WEZq7KW7 = {
            "id" = "WEZq7KW7";
            "file" = "betterstairscrafting-1.21.1-neoforge-1.jar";
            "hash" = "sha512-XH9Mt9D2RgnPCeaMenaCV8Khct2xIH1N/ripTOeQjE+VIaQuXAmbszesnvJKtx0PLiOYQnaOwnUiprrihIwfPA==";
        };
        _ckHUGohA = {
            "id" = "ckHUGohA";
            "file" = "betterstairscrafting-26.1.2-fabric-1.jar";
            "hash" = "sha512-SkMaRuPg7Zm4efnpy0aNADPRMgTXJk1uPnkLIekN6397glyy4hxl1eby8p8nr4yJ3rMpH/nwQQNVjJF7wuhZuA==";
        };
        _XsekEpZd = {
            "id" = "XsekEpZd";
            "file" = "betterstairscrafting-26.1.2-forge-1.jar";
            "hash" = "sha512-Wwe9el+8vcu/oMlf+vyWmU/0azapeLo/4xB6P2ZKkw7//ZhP1Ieu/8Xsy1w8GJgJ0je5+47eZp8Zry9QdATDeA==";
        };
        _SEt1bsOl = {
            "id" = "SEt1bsOl";
            "file" = "betterstairscrafting-26.1.2-neoforge-1.jar";
            "hash" = "sha512-8E9f5l6CfkW4TLTWCPsmeH1pgaCVHPsSVuZyRwW6ZYwWV7lkCEtGIdNkC9KqL0m62haJ4iSw588iY+qzjc8q4A==";
        };
        _UBXEJAgs = {
            "id" = "UBXEJAgs";
            "file" = "betterstairscrafting-26.2-fabric-1.jar";
            "hash" = "sha512-jNudq6lsKKmYZyb2o3jFDicrtQPEW3ewG3gCYXacbqLfMw7kImaJdE2dxHAtCAUyqI+udAxV6VfG9Lp07LXkdA==";
        };
        _vbdHJvDn = {
            "id" = "vbdHJvDn";
            "file" = "betterstairscrafting-26.2-forge-1.jar";
            "hash" = "sha512-Wvj7diNmFKy8MXXcQApDs6BjLlNgr608YBmeNt5Bc8N5USf4w+TYfajEz5KubURdlzQ5dOt4QJAiIO9d1E3O0g==";
        };
        _cIU5vbOl = {
            "id" = "cIU5vbOl";
            "file" = "betterstairscrafting-26.2-neoforge-1.jar";
            "hash" = "sha512-OKRlXX8ie9HgNhbQlM2ILA7OLvYykVDdKuXOpbCQtxU0GlzqYfppmvgd1ALoUGaugKp7sCSG2tgEZF3d/ObMpQ==";
        };
    in {
        "HO5KfXy5" = _HO5KfXy5;
        "BVObYyiR" = _BVObYyiR;
        ...
        "vbdHJvDn" = _vbdHJvDn;
        "cIU5vbOl" = _cIU5vbOl;
        "fabric-1.18" = _2Zcqngx6;
        "fabric-1.18.1" = _2Zcqngx6;
        "fabric-1.18.2" = _2Zcqngx6;
        "fabric-1.19.2" = _KwAPtxkE;
        "fabric-1.19.4" = _ZWhBZFR2;
        "fabric-1.20" = _yvlzd5JP;
        "fabric-1.20.1" = _yvlzd5JP;
        "fabric-1.20.2" = _tPUpocZy;
        "fabric-1.20.3" = _a0rVBEnp;
        "fabric-1.20.4" = _a0rVBEnp;
        "fabric-1.20.5" = _KrmhKkFA;
        "fabric-1.20.6" = _KrmhKkFA;
        "fabric-1.21" = _mxHS9rNu;
        "fabric-1.21.1" = _mxHS9rNu;
        ...
        "fabric-26.1" = _ckHUGohA;
        "fabric-26.1.1" = _ckHUGohA;
        "fabric-26.1.2" = _ckHUGohA;
        "fabric-1.19" = _KwAPtxkE;
        "fabric-1.19.1" = _KwAPtxkE;
        "fabric-26.2" = _UBXEJAgs;
        "quilt-1.18" = _2Zcqngx6;
        "quilt-1.18.1" = _2Zcqngx6;
        "quilt-1.18.2" = _2Zcqngx6;
        "quilt-1.19.2" = _KwAPtxkE;
        "quilt-1.19.4" = _ZWhBZFR2;
        "quilt-1.20" = _yvlzd5JP;
        "quilt-1.20.1" = _yvlzd5JP;
        "quilt-1.20.2" = _tPUpocZy;
        "quilt-1.20.3" = _a0rVBEnp;
        "quilt-1.20.4" = _a0rVBEnp;
        "quilt-1.20.5" = _KrmhKkFA;
        "quilt-1.20.6" = _KrmhKkFA;
        "quilt-1.21" = _mxHS9rNu;
        "quilt-1.21.1" = _mxHS9rNu;
        ...
        "quilt-26.1" = _ckHUGohA;
        "quilt-26.1.1" = _ckHUGohA;
        "quilt-26.1.2" = _ckHUGohA;
        "quilt-1.19" = _KwAPtxkE;
        "quilt-1.19.1" = _KwAPtxkE;
        "quilt-26.2" = _UBXEJAgs;
        "forge-1.18" = _RQbe87vK;
        "forge-1.18.1" = _RQbe87vK;
        "forge-1.18.2" = _RQbe87vK;
        "forge-1.19" = _xWBlmTUA;
        "forge-1.19.1" = _xWBlmTUA;
        "forge-1.19.2" = _xWBlmTUA;
        "forge-1.19.4" = _54MthlJQ;
        "forge-1.20" = _owhMnbvY;
        "forge-1.20.1" = _owhMnbvY;
        "forge-1.20.2" = _Io9f8XXQ;
        "forge-1.20.3" = _nodmWZcb;
        "forge-1.20.4" = _nodmWZcb;
        "forge-1.20.5" = _vFdVGlDK;
        "forge-1.20.6" = _vFdVGlDK;
        "forge-1.21" = _Oi8EmH9D;
        "forge-1.21.1" = _Oi8EmH9D;
        ...
        "forge-26.1" = _XsekEpZd;
        "forge-26.1.1" = _XsekEpZd;
        "forge-26.1.2" = _XsekEpZd;
        "forge-26.2" = _vbdHJvDn;
        "neoforge-1.20" = _owhMnbvY;
        "neoforge-1.20.1" = _owhMnbvY;
        "neoforge-1.20.5" = _VF3EhuG4;
        "neoforge-1.20.6" = _VF3EhuG4;
        "neoforge-1.21" = _WEZq7KW7;
        "neoforge-1.21.1" = _WEZq7KW7;
        ...
        "neoforge-26.1" = _SEt1bsOl;
        "neoforge-26.1.1" = _SEt1bsOl;
        "neoforge-26.1.2" = _SEt1bsOl;
        "neoforge-26.2" = _cIU5vbOl;
        ...
        "pkg-1.18.2-fabric-1" = _2Zcqngx6;
        "pkg-1.18.2-forge-1" = _RQbe87vK;
        "pkg-1.19.2-fabric-1" = _KwAPtxkE;
        "pkg-1.19.2-forge-1" = _xWBlmTUA;
        "pkg-1.20.1-fabric-1" = _yvlzd5JP;
        "pkg-1.20.1-forge-1" = _owhMnbvY;
        "pkg-1.21.1-fabric-1" = _mxHS9rNu;
        "pkg-1.21.1-forge-1" = _Oi8EmH9D;
        "pkg-1.21.1-neoforge-1" = _WEZq7KW7;
        "pkg-26.1.2-fabric-1" = _ckHUGohA;
        "pkg-26.1.2-forge-1" = _XsekEpZd;
        "pkg-26.1.2-neoforge-1" = _SEt1bsOl;
        "pkg-26.2-fabric-1" = _UBXEJAgs;
        "pkg-26.2-forge-1" = _vbdHJvDn;
        "pkg-26.2-neoforge-1" = _cIU5vbOl;
        "default" = _cIU5vbOl;
    });
