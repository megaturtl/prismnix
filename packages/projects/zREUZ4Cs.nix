...
let
    versions = (let
        ...
        _HU6RQlgP = {
            "id" = "HU6RQlgP";
            "file" = "Whimscape_Leaves_1.20-26.3_r1.zip";
            "hash" = "sha512-aabMdnvxbRSLlErNNTntdk4nLUG1uJkPpa8zV36UDJKm/H5STH0f1Vo0hT59v0KfGauuWdMfhyhKEywT9IRwTA==";
        };
    in {
        "6nhx2jAI" = _6nhx2jAI;
        "RBScLxte" = _RBScLxte;
        ...
        "minecraft-1.20" = _HU6RQlgP;
        "minecraft-1.20.1" = _HU6RQlgP;
        "minecraft-1.20.2" = _HU6RQlgP;
        "minecraft-1.20.3" = _HU6RQlgP;
        "minecraft-1.20.4" = _HU6RQlgP;
        "minecraft-1.20.5" = _HU6RQlgP;
        "minecraft-1.20.6" = _HU6RQlgP;
        "minecraft-1.21" = _HU6RQlgP;
        "minecraft-1.21.1" = _HU6RQlgP;
        "minecraft-1.21.2" = _HU6RQlgP;
        "minecraft-1.21.3" = _HU6RQlgP;
        "minecraft-1.21.4" = _HU6RQlgP;
        "minecraft-1.21.5" = _HU6RQlgP;
        "minecraft-1.21.6" = _HU6RQlgP;
        "minecraft-1.21.7" = _HU6RQlgP;
        "minecraft-1.21.8" = _HU6RQlgP;
        "minecraft-1.21.9" = _HU6RQlgP;
        "minecraft-1.21.10" = _HU6RQlgP;
        "minecraft-1.21.11" = _HU6RQlgP;
        "minecraft-26.1" = _HU6RQlgP;
        "minecraft-26.1.1" = _HU6RQlgP;
        "minecraft-26.1.2" = _HU6RQlgP;
        "minecraft-26.2" = _HU6RQlgP;
        "minecraft-26.3" = _HU6RQlgP;
        "pkg-1.19_r2" = _6nhx2jAI;
        "pkg-1.19.3_r2" = _RBScLxte;
        "pkg-1.20_r1" = _Y4xCz4Ps;
        "pkg-1.20.2-1.20.4_r1" = _Zu2KJEmU;
        "pkg-1.20.2-1.21.3_r1" = _si3F5Uy3;
        "pkg-1.20-1.20.1_r1" = _vcgaTLk7;
        "pkg-1.20.2-1.21.5_r1" = _D9LybPkS;
        "pkg-1.20-1.21.10_r1" = _3Y1lhTvD;
        "pkg-1.20-1.21.11_r1" = _kkiypHXs;
        "pkg-1.20-26.1_r1" = _vRWf8x8s;
        "pkg-1.20-26.3_r1" = _HU6RQlgP;
        "default" = _HU6RQlgP;
    });
