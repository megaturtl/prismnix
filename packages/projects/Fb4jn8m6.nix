...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.10.1-Fabric" = _IvWeyNRf;
        "pkg-1.16.5-2.10.2-Forge" = _ecFvHSSj;
        "pkg-1.16.5-2.10.2-Fabric" = _hYRTlWck;
        "pkg-1.16.5-2.11.0-Forge" = _KA0lsBqm;
        "pkg-1.16.5-2.11.0-Fabric" = _frFjp7XE;
        "pkg-1.16.5-2.11.1-Forge" = _Oy2HfoQu;
        "pkg-1.16.5-2.11.1" = _HhiMtvaB;
        "pkg-1.16.5-2.11.2" = _MBqZmh7k;
        "pkg-1.16.5-2.11.3" = _rolL2W5j;
        "pkg-1.16.5-2.11.4" = _VBOnAt36;
        "pkg-1.17-2.11.4" = _fy6OOm9Q;
        "pkg-1.16.5-2.11.5" = _PjU0ylA8;
        "pkg-1.17-2.11.5" = _IjfKe2LK;
        "pkg-1.17-2.12.0" = _BjxlB5ad;
        "pkg-1.17-2.12.1" = _nDc9P6UR;
        "pkg-1.17.1-2.12.1" = _T0QtOBLV;
        "pkg-1.17.1-2.12.2" = _VlJQWF9M;
        "pkg-1.17.1-2.12.3" = _4FktLQ41;
        "pkg-2.13.0" = _QtHstonj;
        "pkg-2.14.0" = _m2oM2Xzb;
        "pkg-2.14.1" = _YBlmxpFC;
        "pkg-2.14.2" = _Bhm08p1U;
        "pkg-2.14.2-snapshot" = _vT2GkHlJ;
        "pkg-2.14.3" = _PCbggfQI;
        "pkg-21w42a-2.14.3" = _8h9olfhO;
        "pkg-1.18-pre2-2.14.3" = _XpnXvmmg;
        "pkg-1.18-2.14.4" = _1HEbx8wR;
        "pkg-1.18-2.15.0" = _O7EzwYaR;
        "pkg-2.14.5" = _k08wKfdA;
        "pkg-1.18-2.15.1" = _K2xDwQMA;
        "pkg-1.18-2.15.2" = _jHljfMeN;
        "pkg-1.18.1-2.16.0" = _izrF4sw0;
        "pkg-1.18.1-2.16.1" = _pM721YNG;
        "pkg-1.18.1-3.0.0" = _48Uga7jj;
        "pkg-1.18.1-3.0.1" = _RhvVV7aI;
        "pkg-1.18.1-3.1.0b1" = _Wll71SI1;
        "pkg-1.18.1-3.1.0b2" = _wm1VgWAh;
        "pkg-1.18.1-3.1.0" = _Ge9TTua8;
        "pkg-1.18.1-3.2.0b1" = _LI0g8wDL;
        "pkg-1.18.1-3.2.0b2" = _UiUNxrl7;
        "pkg-1.18.1-3.2.0" = _XzUcHIz2;
        "pkg-1.18.1-3.2.1" = _MNaOu00H;
        "pkg-22w05a-3.3.0a1" = _EcPbQcBT;
        "pkg-22w06a-3.3.0a2" = _I4HjcOo5;
        "pkg-1.18.2-pre3-3.3.0b3" = _hnXlvYfp;
        "pkg-1.18.2-3.3.0" = _Brv0vjTc;
        "pkg-1.18.2-3.3.1" = _GMOPXKvF;
        "pkg-1.18.2-3.4.0" = _CaTPjokz;
        "pkg-1.18.2-3.4.1" = _aMFJxIHm;
        "pkg-22w13a-3.5.0a1" = _qtfvfhdv;
        "pkg-1.18.2-3.4.2" = _GS7o9NMO;
        "pkg-1.18.2-3.5.0b1" = _1u6nezii;
        "pkg-22w14a-3.6.0a2" = _djHFleaq;
        "pkg-22w14a-3.6.0a3" = _Fn9hSpZQ;
        "pkg-1.18.2-3.5.0" = _2qvQxa1B;
        "pkg-1.18.2-3.5.1" = _ivSkiG78;
        "pkg-22w17a-3.6.0a4" = _TuLQv2oz;
        "pkg-22w19a-3.6.0a5" = _cvdeCtGH;
        "pkg-1.19-pre5-3.6.0a7" = _8GR9mmKD;
        "pkg-1.19-3.6.0" = _zv2J7DYl;
        "pkg-1.19-3.6.1" = _1nneGSqI;
        "pkg-1.19-3.6.2" = _mKpQdYKO;
        "pkg-1.18.2-3.5.2" = _8XmHwXLO;
        "pkg-1.19-3.6.3" = _LoJuqMMZ;
        "pkg-1.18.2-3.5.3" = _9K3tdqQy;
        "pkg-1.19-3.6.4" = _YMLyKqOj;
        "pkg-1.19-3.7.0b1" = _k2geZqGH;
        "pkg-1.19-3.7.0" = _3sdO7qgf;
        "pkg-1.19-3.7.1" = _YlfhOTW2;
        "pkg-1.19-3.7.2" = _iAX7H9LQ;
        "pkg-1.19-3.7.3" = _LTbIi2M1;
        "pkg-1.19-3.7.4" = _kgBh4dSx;
        "pkg-1.19.1-3.8.0" = _bQrEMzOP;
        "pkg-1.19.1-3.8.1" = _KRs7tr5H;
        "pkg-1.19.2-3.9.0" = _dj8wmIBS;
        "pkg-1.19.2-3.9.1" = _PgS4RtQX;
        "pkg-1.19.2-3.9.2" = _Rcuv9i9M;
        "pkg-1.19.2-3.10.0" = _9kSv8gsK;
        "pkg-1.18.2-3.5.4" = _5DSiBB1r;
        "pkg-22w43a-3.11.0a2" = _qrxLiOcL;
        "pkg-1.16.5-2.11.6" = _E4f85gRR;
        "pkg-1.19.3-3.11.0" = _TIoBK1U1;
        "pkg-1.19.3-3.11.1" = _2TNwaTtm;
        "pkg-1.19.3-3.11.2" = _cMkbt0f5;
        "pkg-1.19.4-3.12.0" = _NveCqCkX;
        "pkg-1.19.4-3.12.1" = _BQ6i1U5X;
        "pkg-2.11.7" = _rK4GkUX6;
        "pkg-2.14.6" = _59SG26Fv;
        "pkg-3.5.5" = _1TSCSQ4C;
        "pkg-1.19.4-3.12.2" = _iszfrsgL;
        "pkg-1.20-4.0.0" = _P55fppyL;
        "pkg-1.20.1-4.1.0" = _XrkGy9Ky;
        "pkg-1.20.1-4.1.1" = _reXqEJgT;
        "pkg-1.20.1-4.2.0" = _yRWIgpnS;
        "pkg-1.20.1-4.2.1" = _66mp0b9v;
        "pkg-1.20.1-4.2.2" = _oXRivlMX;
        "pkg-1.20.1-4.2.3" = _6KJqXkV0;
        "pkg-1.20.1-4.2.4" = _frsJrlLk;
        "pkg-1.20.1-4.3.0" = _kPSbFSaC;
        "pkg-3.13.0" = _8q3U34GC;
        "pkg-5.0.0" = _SQSRyVeT;
        "pkg-1.20.2-5.0.1" = _BJ2K7C0J;
        "pkg-23w40a-6.0.0a1" = _NAMMnpkI;
        "pkg-1.20.2-5.0.2" = _HojA8R8T;
        "pkg-1.19.2-3.10.1" = _BdqBwLsv;
        "pkg-3.11.3" = _NF3wLCFV;
        "pkg-3.13.1" = _KW9Dm2r0;
        "pkg-4.0.1" = _7vuduZD7;
        "pkg-1.20.1-4.3.1" = _tOzqGtqB;
        "pkg-1.20.2-5.0.3" = _7PRbBpzE;
        "pkg-4.0.2" = _KRt1RhNH;
        "pkg-1.20.1-4.3.2" = _akjkv5e2;
        "pkg-1.20.2-5.0.4" = _Ua1F3TBl;
        "pkg-1.20.3-1.20.3.1" = _H9oeRV3c;
        "pkg-1.20.3-1.20.3.2" = _t9r6pZcy;
        "pkg-1.20.4-1.20.4.1" = _snIN7mL9;
        "pkg-4.0.3" = _Fi75hN4R;
        "pkg-1.20.1-4.3.3" = _yr3p0Npt;
        "pkg-1.20.2-5.0.5" = _HnH1cLYq;
        "pkg-1.20.3-1.20.3.3" = _2u9Dpwhc;
        "pkg-1.20.4-1.20.4.2" = _Gkt6UcDh;
        "pkg-1.20.1-4.3.4" = _NrtzFkZE;
        "pkg-1.20.2-5.0.6" = _BaMypQ7l;
        "pkg-1.20.3-1.20.3.4" = _nZoL7IuF;
        "pkg-1.20.4-1.20.4.3" = _mb15RrXi;
        "pkg-1.20.5-1.20.5.0" = _2yoOOkuy;
        "pkg-1.20.6-1.20.6.0" = _eEwiTLCR;
        "pkg-1.20.6-1.20.6.1" = _1KVSR1de;
        "pkg-1.20.6-1.20.6.2" = _twGJKI2m;
        "pkg-1.20.6-1.20.6.3" = _l93ivqBS;
        "pkg-1.20.6-1.20.6.4" = _WBPlgiIE;
        "pkg-1.20.6-1.20.6.5" = _QpKTY6aW;
        "pkg-1.20.6-1.20.6.6" = _oHSfaH3b;
        "pkg-1.20.6-1.20.6.7" = _QIna9i7h;
        "pkg-1.21-1.21.0.1" = _2N0TfdG9;
        "pkg-1.21-1.21.0.2" = _kLEJADsa;
        "pkg-1.21-1.21.0.3" = _cFiOvvih;
        "pkg-1.21-1.21.0.4" = _mSIK8OOH;
        "pkg-1.21-1.21.0.5" = _7x1mqvWh;
        "pkg-1.21-1.21.0.6" = _CfGRP162;
        "pkg-1.21-1.21.0.7" = _uni2ZHB8;
        "pkg-1.21-1.21.0.8" = _9n1NLElA;
        "pkg-1.21.1-1.21.1.1" = _bVO1GowF;
        "pkg-1.20.6-1.20.6.8" = _ud1kXOTm;
        "pkg-1.21.1-1.21.1.2" = _c04fsPim;
        "pkg-1.21.2-1.21.2.1" = _FBRYj1Jk;
        "pkg-1.21.2-1.21.2.2" = _gyA1aPLN;
        "pkg-1.21.3-1.21.3.1" = _2OLcb2eP;
        "pkg-1.21.3-1.21.3.2" = _I3nXyGdk;
        "pkg-1.21.3-1.21.3.3" = _atTvTX4k;
        "pkg-1.21.4-1.21.4.1" = _4x7ecSGL;
        "pkg-1.21.4-1.21.4.2" = _8sd5tO2r;
        "pkg-1.21.1-1.21.1.3" = _SG8ZsOic;
        "pkg-1.21.2-1.21.2.3" = _H6jbpIDT;
        "pkg-1.21.3-1.21.3.4" = _BMEmI3I6;
        "pkg-1.21.4-1.21.4.3" = _c0xqcP7a;
        "pkg-1.21.1-1.21.1.4" = _wnYffVts;
        "pkg-1.21.2-1.21.2.4" = _J093wQAU;
        "pkg-1.21.3-1.21.3.5" = _ZBQTNPvu;
        "pkg-1.21.4-1.21.4.4" = _PSp00blL;
        "pkg-1.21.1-1.21.1.5" = _eSNxgJN0;
        "pkg-1.21.2-1.21.2.5" = _y0UABxDc;
        "pkg-1.21.3-1.21.3.6" = _pCLdPHBG;
        "pkg-1.21.4-1.21.4.5" = _obL8ERnB;
        "pkg-1.21.1-1.21.1.6" = _d4Vwh7lX;
        "pkg-1.21.2-1.21.2.6" = _WkmNGTyT;
        "pkg-1.21.3-1.21.3.7" = _5QMBY4pI;
        "pkg-1.21.4-1.21.4.6" = _gn16vhjh;
        "pkg-1.21.1-1.21.1.7" = _JtSM2Voq;
        "pkg-1.21.2-1.21.2.7" = _33bSP4oN;
        "pkg-1.21.3-1.21.3.8" = _qwke4DDS;
        "pkg-1.21.4-1.21.4.7" = _VZaMZN0O;
        "pkg-1.21.4-1.21.4.8" = _CX6uDn8U;
        "pkg-1.21.5-1.21.5.1" = _I9p5DN7f;
        "pkg-1.21.5-1.21.5.2" = _enSGEWts;
        "pkg-1.21.5-1.21.5.3" = _3vd4bfEB;
        "pkg-1.21.5-1.21.5.4" = _xwWIHdET;
        "pkg-1.21.5-1.21.5.5" = _g9sf7J7G;
        "pkg-1.21.5-1.21.5.6" = _4pWpbykH;
        "pkg-1.21.5-1.21.5.7" = _Jd5d7akr;
        "pkg-1.21.5-1.21.5.8" = _POVxLq34;
        "pkg-1.21.1-1.21.1.8" = _pLoQCXwM;
        "pkg-1.21.2-1.21.2.8" = _qKwkuIDP;
        "pkg-1.21.5-1.21.5.9" = _QPpT3u9u;
        "pkg-1.21.3-1.21.3.10" = _F8carDZZ;
        "pkg-1.21.4-1.21.4.10" = _nb1iX9eQ;
        "pkg-1.21.1-1.21.1.9" = _UJFIzvL3;
        "pkg-1.21.2-1.21.2.9" = _yQTHDZAz;
        "pkg-1.21.3-1.21.3.11" = _RBdo4y7C;
        "pkg-1.21.4-1.21.4.11" = _kS9Lujdk;
        "pkg-1.21.5-1.21.5.10" = _WsmJ9juE;
        "pkg-1.21.6-1.21.6.1" = _eCeoNrVw;
        "pkg-1.21.6-1.21.6.2" = _I2aJcaI7;
        "pkg-1.21.6-1.21.6.3" = _aAbmM9El;
        "pkg-1.21.6-1.21.6.4" = _KThKbgqm;
        "pkg-1.21.6-1.21.6.5" = _nun0Wr6l;
        "pkg-1.21.7-1.21.7.1" = _dHRfwO0t;
        "pkg-1.21.1-1.21.1.10" = _kHb8t0xv;
        "pkg-1.21.2-1.21.2.10" = _odzIwhEJ;
        "pkg-1.21.3-1.21.3.12" = _K1ajOZ4E;
        "pkg-1.21.4-1.21.4.12" = _qru1F4oW;
        "pkg-1.21.5-1.21.5.11" = _NoXs9nFL;
        "pkg-1.21.6-1.21.6.6" = _9KB34pi0;
        "pkg-1.21.7-1.21.7.2" = _jeLDE9Vf;
        "pkg-1.21.8-1.21.8.1" = _hB7NfdzA;
        "pkg-1.21.1-1.21.1.11" = _wxGXaJMA;
        "pkg-1.21.2-1.21.2.11" = _PcbkFY1c;
        "pkg-1.21.3-1.21.3.13" = _tPzDKVFk;
        "pkg-1.21.4-1.21.4.13" = _VBmGH8tz;
        "pkg-1.21.5-1.21.5.12" = _ETRofUGd;
        "pkg-1.21.6-1.21.6.7" = _sYbmLoJp;
        "pkg-1.21.7-1.21.7.3" = _CB3Onrej;
        "pkg-1.21.8-1.21.8.2" = _vs4XSgGN;
        "pkg-1.21.8-1.21.8.3" = _IGtob92Q;
        "pkg-1.21.9-1.21.9.1" = _ud87ay0A;
        "pkg-1.21.9-1.21.9.2" = _gSIijzTg;
        "pkg-1.21.9-1.21.9.3" = _ye05npAP;
        "pkg-1.21.10-1.21.10.1" = _hDjB8uAg;
        "pkg-1.21.11-1.21.11.1" = _sloyyzJa;
        "pkg-1.21.11-1.21.11.2" = _s7RpQ7ah;
        "pkg-1.21.11-1.21.11.3" = _Hnj3s9Ez;
        "pkg-26.1-snapshot-6-26.1.1a1" = _r6e6nPT3;
        "pkg-26.1-26.1.0.1" = _jChLP4eI;
        "pkg-26.1-26.1.0.2" = _TBG7DkUw;
        "pkg-26.1-26.1.0.3" = _taabqQmG;
        "pkg-26.1.1-26.1.1.1" = _1t5y4V0E;
        "pkg-26.1.2-26.1.2.1" = _btXdyYgE;
        "pkg-26.1.2-26.1.2.2" = _aTjtwhah;
        "pkg-26.1.2-26.1.2.3" = _ojNqNNkk;
        "pkg-26.1.2-26.1.2.4" = _YpsBfAWL;
