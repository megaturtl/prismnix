...
let
    versions = (let
        ...
        _8faHEzO3 = {
            "id" = "8faHEzO3";
            "file" = "Forgelin-Continuous-2.4.20.0.jar";
            "hash" = "sha512-cBfD1R6yjLaU2nbkTkPB+Rkhd7rsKcSTS2oHGUKAZpbcJuTYyHyd4LqJEDS6VuOtreOja7KWZI7EvPnbrEqj5g==";
        };
    in {
        "rHQ6Wn5t" = _rHQ6Wn5t;
        "EBE3enuc" = _EBE3enuc;
        ...
        "JGhnXO0E" = _JGhnXO0E;
        "8faHEzO3" = _8faHEzO3;
        "forge-1.12" = _8faHEzO3;
        "forge-1.12.1" = _8faHEzO3;
        "forge-1.12.2" = _8faHEzO3;
        "pkg-1.9.22.0" = _rHQ6Wn5t;
        "pkg-1.9.23.0" = _EBE3enuc;
        "pkg-1.9.23.1" = _z6CncHO9;
        "pkg-1.9.23.2" = _fTiIpLvr;
        "pkg-1.9.24.0" = _JSS051va;
        "pkg-2.0.0.0" = _Vcch54bP;
        "pkg-2.0.0.1" = _5wvQO2Ks;
        "pkg-2.0.10.0" = _xNzq0XAv;
        "pkg-2.0.20.0" = _iC1QTSn0;
        "pkg-2.0.21.0" = _1EM4A89J;
        "pkg-2.1.0.0" = _aNTjQKsi;
        "pkg-2.1.10.0" = _d3s7Qwfd;
        "pkg-2.1.20.0" = _zMUUrycc;
        "pkg-2.1.21.0" = _MLI4GVr4;
        "pkg-2.2.0.0" = _CWKmwkAL;
        "pkg-2.2.10.0" = _IHzPBhZx;
        "pkg-2.2.20" = _xeJ3NGAX;
        "pkg-2.2.21.0" = _kQh6qtim;
        "pkg-2.3.0.0" = _TZOesTJK;
        "pkg-2.3.10.0" = _jZ8wTUGW;
        "pkg-2.3.20.0" = _RE3Ayg5T;
        "pkg-2.4.0.0" = _jZIkQLdu;
        "pkg-2.4.10.0" = _JGhnXO0E;
        "pkg-2.4.20.0" = _8faHEzO3;
        "default" = _8faHEzO3;
    });
