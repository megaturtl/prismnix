...
let
    versions = (let
        ...
        _ipPneRGq = {
            "id" = "ipPneRGq";
            "file" = "crosshair_cross_dot-1.0.1-mc26.3.zip";
            "hash" = "sha512-mWHaJ0Z2A43AIGhyQa53ke5L5PXz4VKHQcdXVRNtA1QBL/5uPUGSXybT3i1BFnDbC9z3m+mvlU4WsylB6EK59g==";
        };
    in {
        "QM2BNY9G" = _QM2BNY9G;
        "AgxbvGPh" = _AgxbvGPh;
