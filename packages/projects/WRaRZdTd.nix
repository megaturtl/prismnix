...
let
    ...
    in {
        ...
        "pkg-1.20.4-1.1.3" = _AM9BaAEu;
        "pkg-1.20-1.1.4" = _Erbz59hJ;
        "pkg-1.20.4-1.1.4" = _gflO3xfr;
        "pkg-1.20-1.1.5" = _qeLWHTWP;
        "pkg-1.19-1.1.3" = _QoYVgcbm;
        "pkg-1.20-1.1.6" = _OjNJetKb;
        "pkg-1.20.4-1.1.5" = _30JnRmSH;
        "pkg-1.20.4-1.1.6" = _oNJdGZsJ;
        "pkg-1.20-1.1.7" = _pS4xVfg7;
        "pkg-1.20-1.1.8" = _g5ZVROP0;
        "pkg-1.20.4-1.1.7" = _2tUm3ci3;
        "pkg-1.19-1.1.5" = _dYW7zNps;
        "pkg-1.20-1.1.9" = _XTsBeVmw;
        "pkg-1.20.4-1.1.8" = _HBB9TnmA;
        "pkg-1.19-1.1.6" = _4yGoyWuM;
        "pkg-1.20-1.2.0" = _OFYFcfrC;
        "pkg-1.20.4-1.2.0" = _FgJvAlJn;
        "pkg-1.20-1.2.1" = _1RrtjwLa;
        "pkg-1.20-1.2.2" = _ENyrDiHt;
        "pkg-1.20.4-1.2.2" = _RRSDnTmC;
        "pkg-1.20-1.2.3" = _T41GnKjE;
        "pkg-1.20.4-1.2.4" = _yWCojAia;
        "pkg-1.20-1.2.4" = _yzEER0uQ;
        "pkg-1.20-1.2.5" = _HVhilGHU;
        "pkg-1.20.4-1.2.5" = _hpjOP7bV;
        "pkg-1.20.4-1.2.6" = _KZRzcyMw;
        "pkg-1.20-1.2.6" = _ade0Q0UW;
        "pkg-1.20.4-1.3.0" = _9ktwwgKh;
        "pkg-1.20-1.3.0" = _5HmDWtJr;
        "pkg-1.19-1.2.0" = _ueQ31MJ8;
        "pkg-1.20.4-1.3.1" = _uyqjP8T5;
        "pkg-1.20-1.3.1" = _UerSZmIb;
        "pkg-1.20-1.3.2" = _aBrNl4Ra;
        "pkg-1.20-1.3.3" = _MJIZYuZ4;
        "pkg-1.20-1.3.4" = _XmkBnRuh;
        "pkg-1.20-1.3.5" = _nnV8diF7;
        "pkg-1.20-1.3.6" = _VuWmsYb0;
        "pkg-1.20-1.3.7" = _jAxLPkUL;
        "pkg-1.20-1.3.8" = _Nd5BG6dw;
        "pkg-1.20-1.3.9" = _tVuicHEM;
        "pkg-1.20-1.3.10" = _TX2w4uIo;
        "pkg-1.20-1.3.11" = _6E7tC6D0;
        "pkg-1.20-1.3.12" = _fcpf7d7z;
        "pkg-1.20-1.3.13" = _dS1WWMy4;
        "pkg-1.20-1.3.14" = _LlcWb93H;
        "pkg-1.20-1.3.15" = _O541mAsq;
        "pkg-1.20-1.4.0" = _Mzs4bGTM;
        "pkg-1.20-1.4.1" = _fD7B5a4e;
        "pkg-1.20-1.4.2" = _9pSXwSk4;
        "pkg-1.20-1.4.3" = _t41Z8B1V;
        "pkg-neoforge_1.21-1.5.0" = _E0W8vkh0;
        "pkg-fabric_1.21-1.5.0" = _a1fFisQQ;
        "pkg-neoforge_1.21-1.5.1" = _5PkwHu8O;
        "pkg-neoforge_1.21-1.5.2" = _YA9zfKuy;
        "pkg-neoforge_1.21-1.5.3" = _vMrcjQFC;
        "pkg-fabric_1.21-1.5.3" = _G3GWhf4Z;
        "pkg-neoforge_1.21-1.5.4" = _nzQhtatr;
        "pkg-fabric_1.21-1.5.4" = _2XKZa7kY;
        "pkg-neoforge_1.21-1.5.5" = _Os4yS2eU;
        "pkg-fabric_1.21-1.5.5" = _DhSsNbPK;
        "pkg-neoforge_1.21-1.5.6" = _haRbclpg;
        "pkg-fabric_1.21-1.5.6" = _9Bbniuyi;
        "pkg-neoforge_1.21-1.5.7" = _gvwfbaQY;
        "pkg-fabric_1.21-1.5.7" = _wyRsysjb;
        "pkg-neoforge_1.21-1.5.9" = _R4PD5quG;
        "pkg-fabric_1.21-1.5.9" = _LZN7nKKA;
        "pkg-neoforge_1.21-1.5.10" = _FoLvD0o5;
        "pkg-fabric_1.21-1.5.10" = _R4h6WuyI;
        "pkg-neoforge_1.21-1.5.11" = _zkrRkzdk;
        "pkg-fabric_1.21-1.5.11" = _ENHnroJm;
        "pkg-1.20-1.4.4" = _PLj15z89;
        "pkg-neoforge_1.21-1.5.12" = _eAD8xd13;
        "pkg-fabric_1.21-1.5.12" = _ErhUhIC8;
        "pkg-neoforge_1.21-1.5.13" = _ffqonOsb;
        "pkg-fabric_1.21-1.5.13" = _hkAOMA1L;
        "pkg-neoforge_1.21-1.5.14" = _mbIzXwMB;
        "pkg-fabric_1.21-1.5.14" = _voNDeXGB;
        "pkg-1.20-1.4.6" = _uzhV71sX;
        "pkg-neoforge_1.21-1.5.16" = _qNxlQbZx;
        "pkg-fabric_1.21-1.5.16" = _sbEzaQQh;
        "pkg-neoforge_1.21-1.5.17" = _7QJREtX0;
        "pkg-fabric_1.21-1.5.17" = _t5aBDB0Y;
        "pkg-neoforge_1.21-1.5.18" = _HzFhA6AW;
        "pkg-fabric_1.21-1.5.18" = _WuYIVxqc;
        "pkg-1.20-1.4.7" = _JDkyUwkQ;
        "pkg-neoforge_1.21-1.5.19" = _dyQ8H1lw;
        "pkg-fabric_1.21-1.5.19" = _QPbjiOAY;
        "pkg-neoforge_1.21-1.5.20" = _Xl8sn3fy;
        "pkg-fabric_1.21-1.5.20" = _cYfEjba8;
        "pkg-1.20-1.4.8" = _lEczn4X8;
        "pkg-neoforge_1.21-1.5.21" = _va4Q8rNA;
        "pkg-fabric_1.21-1.5.21" = _BoEn0AU0;
        "pkg-neoforge_1.21-1.5.22" = _zfq0qz4T;
        "pkg-fabric_1.21-1.5.22" = _A33Ty0PJ;
        "pkg-neoforge_1.21-1.5.23" = _Zc0lAsVW;
        "pkg-fabric_1.21-1.5.23" = _SbrqVDKw;
        "pkg-neoforge_1.21-1.5.24" = _KkGi3jsW;
        "pkg-fabric_1.21-1.5.24" = _Ymkm6oB6;
        "pkg-1.20-1.4.9" = _1IIVBMP6;
        "pkg-1.20-1.4.10" = _ULlgpqM0;
        "pkg-neoforge_1.21-1.5.25" = _eyIdXdFD;
        "pkg-fabric_1.21-1.5.25" = _VMM043dU;
        "pkg-neoforge_1.21-1.6.0" = _R89BIEpG;
        "pkg-fabric_1.21-1.6.0" = _zGmcotjL;
        "pkg-neoforge_1.21-1.6.1" = _JkEXsuWP;
        "pkg-fabric_1.21-1.6.1" = _UgFrEfb3;
        "pkg-neoforge_1.21-1.7.0" = _HsQYQb6G;
        "pkg-fabric_1.21-1.7.0" = _OVMXYOxB;
        "pkg-neoforge_1.21-1.7.1" = _tGa7acYs;
        "pkg-fabric_1.21-1.7.1" = _a4yc1lmf;
        "pkg-neoforge_1.21-1.7.2" = _J9bHjnTh;
        "pkg-fabric_1.21-1.7.2" = _Chlvvr2l;
        "pkg-1.21-1.7.5" = _VEufVPX3;
        "pkg-1.21-1.7.6" = _R4xrsxIb;
