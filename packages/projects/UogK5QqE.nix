...
let
    ...
    in {
        ...
        "pkg-1.18.2-0.5.4" = _kkcAJxxV;
        "pkg-1.19.2-0.5.4" = _NJf9AL4b;
        "pkg-1.19.4-0.6.0" = _10aE57kc;
        "pkg-1.19.4-0.6.1" = _6gqwtkPA;
        "pkg-1.19.4-0.6.2" = _uO7NalTH;
        "pkg-1.19.4-0.6.3" = _QiLlh6nO;
        "pkg-1.19.4-0.6.4" = _h0kEtpbd;
        "pkg-1.20-0.7.1" = _HhbCLkcH;
        "pkg-1.20-0.7.2" = _lKSvbiQ9;
        "pkg-1.20.1-0.7.3" = _dNelBRyE;
        "pkg-1.20.1-0.7.4" = _btV6Mdpd;
        "pkg-1.19.4-0.6.5" = _hxbLz5Y3;
        "pkg-1.20.1-1.0.0" = _w39b1mmV;
        "pkg-1.20.1-1.1.0" = _xLoNfNJT;
        "pkg-1.20.1-1.1.1" = _vkQ23ZpX;
        "pkg-1.20.1-1.2.0" = _3nnHHiyU;
        "pkg-1.20.1-1.2.1" = _a0mDeuTx;
        "pkg-1.20.1-1.2.2" = _7uDK4XJS;
        "pkg-1.20.1-1.2.3" = _Y2APrCFe;
        "pkg-1.20.1-1.2.4" = _YGo5NH5X;
        "pkg-1.20.1-1.2.5" = _lHKA6qGJ;
        "pkg-1.20.1-1.2.6" = _LXX6DWrf;
        "pkg-1.19.2-0.6.0" = _40PAKicl;
        "pkg-1.20.1-1.3.0" = _ecYcJbxo;
        "pkg-1.20.1-1.3.1" = _x0biK22T;
        "pkg-1.20.1-1.4.1" = _jYnLY8wN;
        "pkg-1.20.1-1.4.2" = _HDpYqja6;
        "pkg-1.20.1-1.4.3" = _sHw3jRnH;
        "pkg-1.20.1-1.4.4" = _qeslJxxz;
        "pkg-1.20.1-1.4.5" = _RTKps2f9;
        "pkg-1.20.1-1.4.6" = _81LYhk0Y;
