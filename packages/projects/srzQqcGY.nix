...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.21.6-1.21.8-neoforge" = _D896ng1x;
        "pkg-1.0.0-1.20.1-forge" = _h1uHvz8h;
        "pkg-1.0.0-1.20.1-fabric" = _4a5cxYym;
        "pkg-1.0.0-1.21.1-fabric" = _DG4XnPzS;
        "pkg-1.0.0-1.21.4-fabric" = _SL4ujOaB;
        "pkg-1.0.0-1.21.5-fabric" = _VMsD0L8c;
        "pkg-1.0.0-1.21.6-1.21.8-fabric" = _wjuPpXzO;
        "pkg-1.0.0-1.21.1-forge" = _m4d4XpcG;
        "pkg-1.0.0-1.21.4-forge" = _Ls0FzeF4;
        "pkg-1.0.0-1.21.5-forge" = _Jvvk3tlY;
        "pkg-1.0.0-1.21.6-1.21.8-forge" = _qhBTKyjG;
        "pkg-1.0.0+1.21.9-fabric" = _Yx5sdjVe;
        "pkg-1.0.0+1.21.9-neoforge" = _KWaMMulT;
        "pkg-1.0.0-1.21.9-forge" = _2XHLv2Ag;
        "pkg-1.0.0+1.21.10-fabric" = _2yVrdPnK;
        "pkg-1.0.0+1.21.10-neoforge" = _5tj6Ldkc;
        "pkg-1.0.0+1.21.10-forge" = _3vWB0AYu;
        "pkg-2.0.0+1.20.1-fabric" = _HPpWj9nU;
        "pkg-2.0.0+1.20.1-forge" = _J1fnqaZE;
        "pkg-2.0.0+1.21.1-fabric" = _PFtX7UeO;
        "pkg-2.0.0+1.21.1-forge" = _Hkzx5uvK;
        "pkg-2.0.0+1.21.1-neoforge" = _G52MchLw;
        "pkg-2.0.0+1.21.10-fabric" = _75vEBrNt;
        "pkg-2.0.0+1.21.10-forge" = _VVELm6yS;
        "pkg-2.0.0+1.21.10-neoforge" = _5Ky6ZF2M;
        "pkg-3.0.0+1.20.1-forge" = _G4HIlhX3;
        "pkg-3.0.0+1.21.1-neoforge" = _sQV7tgHt;
        "pkg-3.0.0+1.21.10-fabric" = _WzsqK83c;
        "pkg-3.0.0+1.21.10-forge" = _tQK8MorE;
        "pkg-3.0.0+1.21.10-neoforge" = _BvaBSw1a;
        "pkg-3.0.1+1.20.1-forge" = _PwTh2IPS;
        "pkg-3.0.0+1.21.11-neoforge" = _ynHWG55Z;
        "pkg-3.0.0+1.21.11-forge" = _SItqdKfU;
        "pkg-3.0.0+1.21.11-fabric" = _TQPDDULs;
        "pkg-3.1.0+1.21.11-neoforge" = _nQlsBneX;
        "pkg-3.1.0+1.21.10-neoforge" = _kADX2yzy;
        "pkg-3.1.0+1.21.1-neoforge" = _pqIBcyoA;
        "pkg-3.1.0+1.21.11-forge" = _fJmWdj4J;
        "pkg-3.1.0+1.21.10-forge" = _H1Bx1KOV;
        "pkg-3.1.0+1.21.11-fabric" = _tfiQ5VtR;
        "pkg-3.1.0+1.21.10-fabric" = _WyppK4iX;
        "pkg-3.1.0+1.21.1-fabric" = _3VBqpxkC;
        "pkg-3.2.0+1.21.11-neoforge" = _1jkbzNMr;
        "pkg-3.2.0+1.21.10-neoforge" = _8JWbH6Gs;
        "pkg-3.2.0+1.21.1-neoforge" = _UMxtdk8M;
        "pkg-3.2.0+1.21.11-forge" = _ruREhm5X;
        "pkg-3.2.0+1.21.10-forge" = _p2u9t7AL;
        "pkg-3.2.0+1.21.11-fabric" = _RzsUZgzi;
        "pkg-3.2.0+1.21.10-fabric" = _9VIegw50;
        "pkg-3.2.0+1.21.1-fabric" = _qWYW7CD1;
        "pkg-3.2.1+1.21.10-fabric" = _YCnsIwF1;
        "pkg-3.2.1+1.21.11-neoforge" = _Q8rqpYUc;
        "pkg-3.2.1+1.21.10-neoforge" = _wub9Chs9;
        "pkg-3.2.1+1.21.1-neoforge" = _Fprd8hRV;
        "pkg-3.0.2+1.20.1-forge" = _JW87LBE9;
        "pkg-3.2.1+1.21.11-forge" = _yD6IJRdc;
        "pkg-3.2.1+1.21.10-forge" = _KZdbd1Gp;
        "pkg-3.2.1+1.21.11-fabric" = _yfifOdti;
        "pkg-3.2.2+1.21.10-fabric" = _7zu69sym;
        "pkg-3.2.1+1.21.1-fabric" = _Rov8UtL5;
        "pkg-3.2.2+1.21.11-fabric" = _WcbSALO7;
        "pkg-3.2.3+1.21.10-fabric" = _pIkJ2jtW;
        "pkg-3.2.2+1.21.11-neoforge" = _plbdrpil;
        "pkg-3.2.2+1.21.10-neoforge" = _ktVgM0tr;
        "pkg-3.2.2+1.21.11-forge" = _EyQEZQWS;
        "pkg-3.2.2+1.21.10-forge" = _8KMaiUhm;
        "pkg-3.2.2+26.1-snapshot-7-fabric" = _Aebzb6xE;
        "pkg-3.2.2+26.1-snapshot-7-neoforge" = _tLOygx24;
        "pkg-3.3.0+1.21.11-fabric" = _vUEDzHjA;
        "pkg-3.3.1+1.21.11-fabric" = _9U8ey5t7;
        "pkg-3.3.1+1.21.10-fabric" = _wXCyneeW;
        "pkg-3.3.1+26.1-fabric" = _czWnxNo2;
        "pkg-3.2.2+26.1-neoforge" = _sWfDB0sQ;
        "pkg-26.1.2.0" = _f9eGi5eh;
        "pkg-3.3.0+1.21.1-neoforge" = _jzCeua3k;
        "pkg-3.3.1+1.21.1-neoforge" = _zvC9kfjp;
        "pkg-26.1.2.1" = _PP6ihqhc;
        "pkg-4.0.0+1.21.1-neoforge" = _V0Zz9OVp;
        "pkg-26.1.2.100" = _8Yuvf7M3;
        "pkg-4.1.0+1.21.1-neoforge" = _Fh9jV67v;
        "pkg-4.1.1+1.21.1-neoforge" = _vjKFXVPq;
        "pkg-26.1.2.101" = _NG4CmaSc;
        "pkg-4.1.2+1.21.1-neoforge" = _Re7Uk6iJ;
        "pkg-26.1.2.102" = _X23hnPo5;
        "pkg-26.2.0" = _WaXpuNou;
