...
let
    ...
    in {
        ...
        "pkg-1.0.0-beta.4" = _rtbjJdei;
        "pkg-1.0.0-beta.4.1" = _acET8L23;
        "pkg-1.0.0-rc.1" = _y59RVm8b;
        "pkg-1.0.0-rc.2" = _x8DaghDW;
        "pkg-1.0.0" = _lLAtZ6gb;
        "pkg-1.0.1" = _1wmNAyNL;
        "pkg-1.0.2" = _BdYaKNpB;
        "pkg-1.1.0-alpha.1" = _pOKacydz;
        "pkg-1.1.0-alpha.2" = _F8zksIx4;
        "pkg-1.1.0-alpha.2.1" = _km7Xschw;
        "pkg-1.1.0-alpha.3" = _5FplXEZy;
        "pkg-1.1.0-alpha.3.1" = _vahiPgYR;
        "pkg-1.1.0-alpha.3.1.1" = _rLWAdtsl;
        "pkg-1.1.0-alpha.4" = _2nRLiHoR;
        "pkg-1.1.0-alpha.4.1" = _UUNYVnIF;
        "pkg-1.1.0-alpha.5" = _xuTxti7T;
        "pkg-1.1.0-alpha.5.1" = _smGU4Pvz;
        "pkg-1.1.0-alpha.6" = _hO5TIfcy;
        "pkg-1.1.0-beta.1" = _h7WYJJsY;
        "pkg-1.1.0-beta.2" = _EOjw64ib;
        "pkg-1.1.0-beta.3" = _ewMTiO1l;
        "pkg-1.1.0-rc.1" = _WrYZoKnb;
        "pkg-1.1.0-rc.2" = _MJRk3kAI;
        "pkg-1.1.0-rc.3" = _AfpacxBp;
        "pkg-1.1.0" = _P0lZXgvp;
        "pkg-1.1.1" = _u7khmciY;
        "pkg-2.0.0-alpha.1" = _IJqPbsl4;
        "pkg-2.0.0-alpha.2" = _urA1hrx7;
        "pkg-1.1.2" = _qlVVORTH;
        "pkg-2.0.0-alpha.4" = _dogB48dM;
        "pkg-1.1.4" = _pMbEI4kA;
        "pkg-2.0.0-alpha.5" = _bYpYZkRY;
        "pkg-2.0.0-alpha.5.1" = _wBUIesD9;
        "pkg-2.0.0-alpha.5.2" = _UF8GnZMh;
        "pkg-2.0.0-alpha.5.3" = _IbjP9rzr;
        "pkg-2.0.0-alpha.6" = _9oNXeANd;
        "pkg-2.0.0-alpha.7" = _mryc775k;
        "pkg-2.0.0-alpha.7.1" = _uOqpD9nO;
        "pkg-2.0.0-alpha.8" = _JzrabZAM;
        "pkg-2.0.0-alpha.8.1" = _RmnRTcX2;
        "pkg-2.0.0-alpha.8.2" = _AtDhmqmo;
        "pkg-2.0.0-alpha.8.2.1" = _aCd9OFFb;
        "pkg-2.0.0-alpha.8.3" = _5GNcblgs;
        "pkg-2.0.0-alpha.9" = _qaOmebF8;
        "pkg-2.0.0-alpha.10" = _Uyn094As;
        "pkg-2.0.0-alpha.10.1" = _F3CqXdJJ;
        "pkg-2.0.0-alpha.11" = _PC3ofD6Y;
        "pkg-2.0.0-alpha.12" = _e01kupFI;
