...
let
    ...
    in {
        ...
        "pkg-1.1.0+1.18.2" = _YjnTebMY;
        "pkg-1.1.0+1.19.2" = _4qWV0nqk;
        "pkg-1.1.0+1.19.3" = _K0mYtrrI;
        "pkg-1.1.0+1.19.4" = _Ieb53ngP;
        "pkg-1.1.0+1.20.1" = _N1d91WtC;
        "pkg-1.1.0+1.20.2" = _hmC6PLBO;
        "pkg-1.1.0+1.20.4" = _3DMebV1d;
        "pkg-1.1.0+1.20.6" = _QucbNi1L;
        "pkg-1.2.0+1.17.1" = _63SxzSMs;
        "pkg-1.2.0+1.18.2" = _HdaGgb2l;
        "pkg-1.2.0+1.19.2" = _7t4IPEct;
        "pkg-1.2.0+1.19.3" = _PpO6jjKW;
        "pkg-1.2.0+1.19.4" = _ufZ1NMJ4;
        "pkg-1.2.0+1.20.1" = _2pOllThA;
        "pkg-1.2.0+1.20.2" = _uHSVN1z3;
        "pkg-1.2.0+1.20.4" = _AyKjn5Bz;
        "pkg-1.2.0+1.20.6" = _ZlBnG5b8;
        "pkg-1.2.0+1.21" = _lK543Zvz;
        "pkg-1.2.1+1.17.1" = _5ukfnFYk;
        "pkg-1.2.1+1.18.2" = _fOfBsaGm;
        "pkg-1.2.1+1.19.2" = _HN9ODXdG;
        "pkg-1.2.1+1.19.3" = _Y1oLy7PQ;
        "pkg-1.2.1+1.19.4" = _X4MhmMip;
        "pkg-1.2.1+1.20.1" = _1wqg5yfO;
        "pkg-1.2.1+1.20.2" = _OMqzNnLG;
        "pkg-1.2.1+1.20.4" = _OKjVETtw;
        "pkg-1.2.1+1.20.6" = _kngRaMMo;
        "pkg-1.2.1+1.21.1" = _uj9kyXe4;
        "pkg-1.3.0+1.17.1" = _3h1BHILB;
        "pkg-1.3.0+1.18.2" = _usNuT5Jj;
        "pkg-1.3.0+1.19.2" = _ihzznIiP;
        "pkg-1.3.0+1.19.3" = _O7x495mu;
        "pkg-1.3.0+1.19.4" = _7wf0JJ7n;
        "pkg-1.3.0+1.20.1" = _xZ91YOLx;
        "pkg-1.3.0+1.20.2" = _NvAnPLZe;
        "pkg-1.3.0+1.20.4" = _OcQRkE24;
        "pkg-1.3.0+1.20.6" = _O3YZ2Ll7;
        "pkg-1.3.0+1.21.1" = _nXBlTjXj;
        "pkg-1.3.0+1.21.3" = _Nwaf6sD2;
        "pkg-1.4.0" = _uHz3TyS6;
        "pkg-1.5.0" = _oaI2k2oF;
        "pkg-1.5.1" = _C4HGH7dk;
        "pkg-1.6.0" = _Vb0QHEYp;
