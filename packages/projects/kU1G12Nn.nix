...
let
    ...
    in {
        ...
        "pkg-fabric-1.18.2-20230211a" = _gkBBLAPM;
        "pkg-1.19.2-forge-20230426a" = _NWKNHur4;
        "pkg-forge-1.18.2-20230426a" = _zl63eNaF;
        "pkg-forge-1.19.2-20230527a" = _329yaZQY;
        "pkg-forge-1.18.2-20230527a" = _ESYFxtZC;
        "pkg-fabric-1.19.2-20230508b" = _j9xZFkpI;
        "pkg-fabric-1.18.2-20230508b" = _7PnDX55m;
        "pkg-1.18.2-20230704a" = _BwU7P7Cf;
        "pkg-1.19.2-20230723a" = _s1jbxOUy;
        "pkg-1.18.2-1.0.0" = _XNoZrlnx;
        "pkg-1.19.2-1.0.0" = _AYUl0RYU;
        "pkg-1.20.1-1.0.0" = _ur7w515h;
        "pkg-1.20.1-1.0.0b" = _WzzNESVI;
        "pkg-fabric-1.20.1-0.9.0" = _ogRcUOQY;
        "pkg-1.19.2-1.1.0" = _UlAZ30fk;
        "pkg-1.20.1-1.1.0" = _ic57hTDM;
        "pkg-1.19.2-1.1.1" = _73NrUdzO;
        "pkg-1.20.1-1.1.1" = _DVqXwgYF;
        "pkg-1.20.1-1.2.1" = _CkkSyh5V;
        "pkg-1.19.2-1.2.1" = _6C65jpkg;
        "pkg-1.20.1-1.2.2" = _GsWhwScL;
        "pkg-1.19.2-1.2.2" = _AjwN7Aq8;
        "pkg-fabric-1.19.2-1.2.1" = _f4IFhAfl;
        "pkg-fabric-1.20.1-1.2.1" = _RsoAifnm;
        "pkg-fabric-1.19.2-1.2.2" = _vShfmYxZ;
        "pkg-fabric-1.20.1-1.2.1b" = _Emg6aiZC;
        "pkg-fabric-1.20.1-1.2.1c" = _sf4kfWdG;
        "pkg-fabric-1.20.1-1.2.3" = _J3uh8pqe;
        "pkg-fabric-1.19.2-1.2.3" = _sAZf2bij;
        "pkg-1.20.1-1.2.4" = _vV4bZmhm;
        "pkg-1.20.1-1.2.4b" = _PV6XMVrk;
        "pkg-1.20.1-1.2.4c" = _6hnkdvDW;
        "pkg-1.20.1-1.2.4d" = _eh2ccol5;
        "pkg-1.20.1-1.2.4e" = _4DW3pAsX;
        "pkg-1.20.1-1.2.5" = _VTTLcYWM;
        "pkg-1.20.1-1.3.0" = _wD9umcpu;
        "pkg-1.20.1-1.3.1" = _SecVSw22;
        "pkg-neoforge-1.4.0-1.21.1" = _WI7xXjbx;
        "pkg-neoforge-1.21.1-1.4.1" = _94nPrXZX;
        "pkg-neoforge-1.21.1-1.4.2" = _k3vtnT8F;
        "pkg-fabric-1.20.1-1.2.6" = _ybLiaryg;
        "pkg-neoforge-1.21.1-1.5.1" = _zBlHCLs2;
        "pkg-neoforge-1.21.1-1.5.2" = _WrlIVx0v;
        "pkg-neoforge-1.21.1-1.5.3" = _A5IpLV4E;
        "pkg-neoforge-1.21.1-1.5.4" = _kuAQz2AJ;
        "pkg-neoforge-1.21.1-1.5.5" = _Q9CnMDF0;
        "pkg-neoforge-1.21.1-1.5.7" = _5ej8jlzg;
        "pkg-neoforge-1.21.1-1.5.8" = _cKTFwyEF;
        "pkg-fabric-1.20.1-1.3.3" = _Y3djqUGn;
        "pkg-forge-1.20.1-1.3." = _9LgyB6Yb;
        "pkg-neoforge-1.21.1-1.5.9" = _hbhImJGs;
        "pkg-neoforge-1.21.1-1.5.10" = _CP8Lhuwu;
        "pkg-fabric-1.20.1-1.3.4" = _KIAYldwh;
