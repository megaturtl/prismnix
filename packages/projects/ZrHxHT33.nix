...
let
    versions = (let
        ...
        _hcB5vLO6 = {
            "id" = "hcB5vLO6";
            "file" = "Noba-1.2.0+26.1.jar";
            "hash" = "sha512-sQ+H1ifECrhMbB6Hwkc/pejS1a1dSELGdGKTFlBHPbLrdajK4s4JizlMLBAWi5dDuosj+NGDql4GhwgL6SHdWQ==";
        };
        _hrOaPsJK = {
            "id" = "hrOaPsJK";
    ...
    in {
        ...
        "pkg-0.1.0-Alpha.7+1.21" = _rWH7kqED;
        "pkg-0.1.0-Alpha.8+1.21" = _xPnAyamH;
        "pkg-0.1.0-Alpha.8+1.21.3" = _nzBNI34n;
        "pkg-0.1.0-Alpha.8.1+1.21" = _mEvYvFsm;
        "pkg-0.1.0-Alpha.8.1+1.21.3" = _rzyjSKnC;
        "pkg-0.1.0-Alpha.9+1.21.3" = _F3tyTww6;
        "pkg-0.1.0-Alpha.9+1.21" = _XSc8rDCn;
        "pkg-0.1.0-Alpha.10+1.21" = _vbIXj9oV;
        "pkg-0.1.0-Alpha.10+1.21.3" = _gQvrIshh;
        "pkg-0.1.0-Alpha.11+1.21.3" = _k5IQ8voM;
        "pkg-0.1.0-Alpha.11+1.21.4" = _7CrLlLYP;
        "pkg-0.1.0-Alpha.11+1.21" = _BgkOvzQB;
        "pkg-0.1.0-Alpha.12+1.21.4" = _tdbQet9U;
        "pkg-0.1.0-Alpha.12+1.21.3" = _Sy7c1cRS;
        "pkg-0.1.0-Alpha.12+1.21" = _s1EmF0qm;
        "pkg-0.1.0-Alpha.13+1.21.4" = _QJmVwMUL;
        "pkg-0.1.0-Alpha.13+1.21" = _89VfllRV;
        "pkg-0.1.0-Alpha.13+1.21.3" = _ybZK2yJs;
        "pkg-0.1.0-Alpha.13.1+1.21.3" = _Q15R9XCa;
        "pkg-0.1.0-Alpha.13.1+1.21.4" = _rICly4ul;
        "pkg-0.1.0-Alpha.13.1+1.21" = _9HgzapBE;
        "pkg-1.0.0-Beta.1+1.21.3" = _zSxG9K7E;
        "pkg-1.0.0-Beta.1+1.21.4" = _Q4DYjQTP;
        "pkg-1.0.0-Beta.1+1.21" = _KvdFqkSc;
        "pkg-1.0.0-Beta.2+1.21.3" = _t43fPrGX;
        "pkg-1.0.0-Beta.2+1.21.4" = _V93vqxWM;
        "pkg-1.0.0-Beta.2+1.21" = _lB3M2pDa;
        "pkg-1.0.0-Beta.2+1.21.5" = _DnrfPyWj;
        "pkg-1.0.0-Beta.2.1+1.21.4" = _BWwK2Yqp;
        "pkg-1.0.0-Beta.2.1+1.21.3" = _67jPdOGP;
        "pkg-1.0.0-Beta.2.1+1.21.5" = _JLBz277H;
        "pkg-1.0.0-Beta.2.1+1.21" = _LNGGaLUh;
        "pkg-1.0.0-Beta.3+1.21.5" = _SKQu9DEs;
        "pkg-1.0.0-Beta.3+1.21.4" = _T83rgIy0;
        "pkg-1.0.0-Beta.4+1.21.5" = _pdGSD60Y;
        "pkg-1.0.0-Beta.4+1.21.6" = _5UaAeoRi;
        "pkg-1.0.0-Beta.5+1.21.6" = _XehD6Rqg;
        "pkg-1.0.0-Beta.5+1.21.5" = _EYhRe6ug;
        "pkg-1.0.0-Beta.6+1.21.5" = _iB9Y3DDP;
        "pkg-1.0.0-Beta.6+1.21.7" = _ujmSkuhR;
        "pkg-1.0.0-Beta.7+1.21.5" = _EzZtF4u4;
        "pkg-1.0.0-Beta.7+1.21.8" = _XqDTYs6t;
        "pkg-1.0.0-Beta.7.1+1.21.8" = _1UlyX683;
        "pkg-1.0.0-Beta.7.1+1.21.5" = _PQDvQ63l;
        "pkg-1.0.0-Beta.8+1.21.8" = _BLt33ldn;
        "pkg-1.0.0-Beta.8+1.21.5" = _HP8zZSO4;
        "pkg-1.0.0-Beta.9+1.21.8" = _mVelgzol;
        "pkg-1.0.0-Beta.9+1.21.5" = _P7RCLUU3;
        "pkg-1.0.0-Beta.9.1+1.21.8" = _G1U3XkUi;
        "pkg-1.0.0-Beta.9.1+1.21.5" = _vzgVc4hf;
        "pkg-1.0.0-Beta.10+1.21.10" = _MEhgKPEu;
        "pkg-1.0.0-Beta.10+1.21.5" = _XicuC6BO;
        "pkg-1.0.0-Beta.10+1.21.8" = _3RQ1xIvD;
        "pkg-1.0.0-Beta.10.1+1.21.8" = _lPFP1hzz;
        "pkg-1.0.0-Beta.10.1+1.21.5" = _s202UuAq;
        "pkg-1.0.0-Beta.10.1+1.21.10" = _LvBm5twq;
        "pkg-1.0.0-Beta.11+1.21.10" = _GYt20PUI;
        "pkg-1.0.0-Beta.11+1.21.11" = _vAIuWThD;
        "pkg-1.0.0-Beta.11+1.21.8" = _Snv0gVj1;
        "pkg-1.0.0-Beta.11+1.21.5" = _fuULbKhE;
        "pkg-1.0.0+1.21.11" = _hxUGaLKV;
        "pkg-1.0.0+1.21.10" = _3DsK6ZEn;
        "pkg-1.1.0+1.21.11" = _LYQ9ze1B;
        "pkg-1.1.0+26.1" = _YETd34a3;
        "pkg-1.1.1+1.21.11" = _uMTFY4oQ;
