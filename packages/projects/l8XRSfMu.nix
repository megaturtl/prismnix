...
let
    versions = (let
        ...
        _OiCZSeJ2 = {
            "id" = "OiCZSeJ2";
            "file" = "GEO - v1.110.0.zip";
            "hash" = "sha512-Jw83S2bMzAUsdYYz1Sfn9ORc2gdaGFNfonFTS/rCYxuZ0S5i+WXPyW7BgxWPanp2dDdxddHgz2qUJu6itHVZxQ==";
        };
        _1nfohU2a = {
            "id" = "1nfohU2a";
            "file" = "GEO - v1.111.0.zip";
            "hash" = "sha512-BUEopXhJ9VkyhzYZO0gPP4B061Zbt/v1B2NfFdHZ95W7Szvnx2qD4kFLPGOrj0XEB56clVKUFvRu99KdQ82qcA==";
        };
        _iAxwHHla = {
            "id" = "iAxwHHla";
            "file" = "GEO - v1.112.0.zip";
            "hash" = "sha512-U9FzOhxh0htav5VJduqF8n055t9hl2Dem66G6H7oN3k+Qln2XSxtpm0O7/41pdRW8Y4Z0WKI4NKLeUabzS3u1w==";
        };
        _L8jQNWIg = {
            "id" = "L8jQNWIg";
            "file" = "GEO - v1.113.0.zip";
            "hash" = "sha512-fQoJ4u6+pzQYgzSczjhpwdwWEJblbNvl20p99zhWAenjGilL3mWkrmC0El8yUQakg+zwq7BEBCwbhg10Pb21rA==";
        };
    in {
        "3kr7aJ3n" = _3kr7aJ3n;
        "NY0Cw3Cm" = _NY0Cw3Cm;
        ...
        "minecraft-1.18" = _L8jQNWIg;
        "minecraft-1.18.1" = _L8jQNWIg;
        "minecraft-1.18.2" = _L8jQNWIg;
        "minecraft-1.19" = _L8jQNWIg;
        "minecraft-1.19.1" = _L8jQNWIg;
        "minecraft-1.19.2" = _L8jQNWIg;
        "minecraft-1.19.3" = _L8jQNWIg;
        "minecraft-1.19.4" = _L8jQNWIg;
        "minecraft-1.20" = _L8jQNWIg;
        "minecraft-1.20.1" = _L8jQNWIg;
        "minecraft-1.20.2" = _L8jQNWIg;
        "minecraft-1.20.3" = _L8jQNWIg;
        "minecraft-1.20.4" = _L8jQNWIg;
        "minecraft-1.16.5" = _tc9qVi52;
        "minecraft-1.17" = _tc9qVi52;
        "minecraft-1.20.5" = _L8jQNWIg;
        "minecraft-1.20.6" = _L8jQNWIg;
        "minecraft-1.21" = _L8jQNWIg;
        "minecraft-1.21.1" = _L8jQNWIg;
        "minecraft-1.21.2" = _L8jQNWIg;
        "minecraft-1.21.3" = _L8jQNWIg;
        "minecraft-1.21.4" = _L8jQNWIg;
        "minecraft-1.21.5" = _L8jQNWIg;
        "minecraft-1.21.6" = _L8jQNWIg;
        "minecraft-1.21.7" = _L8jQNWIg;
        "minecraft-1.21.8" = _L8jQNWIg;
        "minecraft-1.21.9" = _L8jQNWIg;
        "minecraft-1.21.10" = _L8jQNWIg;
        "minecraft-1.21.11" = _L8jQNWIg;
        "minecraft-23w31a" = _L8jQNWIg;
        "minecraft-23w32a" = _L8jQNWIg;
        "minecraft-23w33a" = _L8jQNWIg;
        "minecraft-23w35a" = _L8jQNWIg;
        "minecraft-1.20.2-pre1" = _L8jQNWIg;
        "minecraft-23w42a" = _L8jQNWIg;
        "minecraft-23w43a" = _L8jQNWIg;
        "minecraft-23w43b" = _L8jQNWIg;
        "minecraft-23w44a" = _L8jQNWIg;
        "minecraft-23w45a" = _L8jQNWIg;
        "minecraft-23w46a" = _L8jQNWIg;
        "minecraft-24w03a" = _L8jQNWIg;
        "minecraft-24w03b" = _L8jQNWIg;
        "minecraft-24w04a" = _L8jQNWIg;
        "minecraft-24w05a" = _L8jQNWIg;
        "minecraft-24w05b" = _L8jQNWIg;
        "minecraft-24w06a" = _L8jQNWIg;
        "minecraft-24w07a" = _L8jQNWIg;
        "minecraft-24w09a" = _L8jQNWIg;
        "minecraft-24w10a" = _L8jQNWIg;
        "minecraft-24w11a" = _L8jQNWIg;
        "minecraft-24w12a" = _L8jQNWIg;
        "minecraft-24w13a" = _L8jQNWIg;
        "minecraft-24w14potato" = _L8jQNWIg;
        "minecraft-24w14a" = _L8jQNWIg;
        "minecraft-1.20.5-pre1" = _L8jQNWIg;
        "minecraft-1.20.5-pre2" = _L8jQNWIg;
        "minecraft-1.20.5-pre3" = _L8jQNWIg;
        "minecraft-24w18a" = _L8jQNWIg;
        "minecraft-24w19a" = _L8jQNWIg;
        "minecraft-24w19b" = _L8jQNWIg;
        "minecraft-24w20a" = _L8jQNWIg;
        "minecraft-24w33a" = _L8jQNWIg;
        "minecraft-24w34a" = _L8jQNWIg;
        "minecraft-24w35a" = _L8jQNWIg;
        "minecraft-24w36a" = _L8jQNWIg;
        "minecraft-24w37a" = _L8jQNWIg;
        "minecraft-24w38a" = _L8jQNWIg;
        "minecraft-24w39a" = _L8jQNWIg;
        "minecraft-24w40a" = _L8jQNWIg;
        "minecraft-1.21.2-pre1" = _L8jQNWIg;
        "minecraft-1.21.2-pre2" = _L8jQNWIg;
        "minecraft-24w44a" = _L8jQNWIg;
        "minecraft-24w45a" = _L8jQNWIg;
        "minecraft-24w46a" = _L8jQNWIg;
        "minecraft-26.1" = _L8jQNWIg;
        "minecraft-26.1.1" = _L8jQNWIg;
        "minecraft-26.1.2" = _L8jQNWIg;
        "minecraft-26.2" = _L8jQNWIg;
        "pkg-v1.0.0" = _3kr7aJ3n;
        "pkg-v1.0.1" = _NY0Cw3Cm;
        "pkg-v1.2.0" = _7jeMgEon;
        "pkg-v1.3.0" = _MGZjkrhy;
        "pkg-v1.4.0" = _pMZcyeen;
        "pkg-v1.5.0" = _kGojROhW;
        "pkg-v1.6.0" = _75pr0Gb9;
        "pkg-v1.7.0" = _xV5clvJR;
        "pkg-v1.8.0" = _jgOs4LEZ;
        "pkg-v1.9.0" = _XtwBiDJn;
        "pkg-v1.10.0" = _QiExO0LE;
        "pkg-v1.11.0" = _elMoSZWN;
        "pkg-v1.12.0" = _bS1iChEj;
        "pkg-v.1.13.0" = _eRn3x59k;
        "pkg-1.14.0" = _lSlnk7m7;
        "pkg-v1.15.0" = _Ju0knDaU;
        "pkg-v1.16.0" = _Q2ns5sW2;
        "pkg-v1.17.0" = _uls9htYC;
        "pkg-v1.17.1" = _ZYhSSAr2;
        "pkg-v1.18.0" = _KFHHh7Xd;
        "pkg-v1.19.0" = _rEVNJ5k5;
        "pkg-v1.20.0" = _IWzbOd5K;
        "pkg-v1.21.0" = _idzvmEWm;
        "pkg-v1.22.0" = _2LqDu1hP;
        "pkg-v1.23.0" = _ajzpNNqd;
        "pkg-v1.24.0" = _lh68rqQP;
        "pkg-v1.25.0" = _qsxEHGkq;
        "pkg-v1.26.0" = _UInkeTEP;
        "pkg-v1.27.0" = _Dl1SduZ2;
        "pkg-v1.28.0" = _f3T330nG;
        "pkg-v1.29.0" = _fEoQjRmz;
        "pkg-v1.30.0" = _qKULH4Gj;
        "pkg-v1.31.0" = _kF6RMouj;
        "pkg-v1.32.0" = _qA93f02S;
        "pkg-v1.33.0" = _FSfgwhcq;
        "pkg-v1.34.0" = _xRtglmyK;
        "pkg-v1.35.0" = _H9pfv9il;
        "pkg-v1.36.0" = _6bUkScIG;
        "pkg-v1.36.1" = _3oDijpx3;
        "pkg-v1.37.0" = _usMhYC3Z;
        "pkg-v1.38.0" = _yxZJh30q;
        "pkg-v1.39.0" = _WWa9xdpX;
        "pkg-v1.40.0" = _4bZqc1ng;
        "pkg-v1.41.0" = _2GuZQmNm;
        "pkg-v1.42.0" = _WiV16J0s;
        "pkg-v1.43.0" = _zljHHpdR;
        "pkg-v1.44.0" = _B2KZl0bV;
        "pkg-v1.45.0" = _gP71EIVa;
        "pkg-v1.46.0" = _6FCmT79u;
        "pkg-v1.47.0" = _rszvjl0Y;
        "pkg-v1.48.0" = _VBPFZDKB;
        "pkg-v1.49.0" = _cDLMwRYS;
        "pkg-v1.50.0" = _UqGA0bJu;
        "pkg-v1.51.0" = _R5kF3Qrv;
        "pkg-v1.52.0" = _xyhjAPcj;
        "pkg-v1.53.0" = _wasezCa8;
        "pkg-v1.54.0" = _1ToxUq8s;
        "pkg-v1.55.0" = _dC2SMPXU;
        "pkg-v1.56.0" = _8Ps6403i;
        "pkg-v1.57.0" = _NGKhAxWN;
        "pkg-v1.58.0" = _90fDKL0b;
        "pkg-v1.59.0" = _9EpWDtfg;
        "pkg-v1.60.0" = _ZqkBcx7g;
        "pkg-v1.60.1" = _VKkQtHoM;
        "pkg-v1.61.0" = _IYolblay;
        "pkg-v1.62.0" = _cTrztsUh;
        "pkg-v1.63.0" = _AGFiXmRg;
        "pkg-v1.63.1" = _oQlWrit4;
        "pkg-v1.63.2" = _Ipayqbfp;
        "pkg-v1.64.0" = _mRX4cmFy;
        "pkg-v1.65.0" = _UcriDpu0;
        "pkg-v1.66.0" = _MnAsmxNm;
        "pkg-v1.67.0" = _sW5DJ2SR;
        "pkg-v1.68.0" = _8grwTz2a;
        "pkg-v1.69.0" = _JgkWuWxt;
        "pkg-v1.70.0" = _fOAnZ5PP;
        "pkg-v1.71.0" = _fNr2lPg6;
        "pkg-v1.72.0" = _FnT4LU5J;
        "pkg-v1.73.0" = _axV6dt6A;
        "pkg-v1.74.0" = _UZmTtgcA;
        "pkg-v1.75.0" = _A7b0ILOw;
        "pkg-v1.76.0" = _qpArxT3H;
        "pkg-v1.77.0" = _7pkn142y;
        "pkg-v1.78.0" = _a2zDswhj;
        "pkg-v1.79.0" = _YmPjGIBO;
        "pkg-v1.80.0" = _QvsT4Wlf;
        "pkg-v1.81.0" = _cQvQ9mn8;
        "pkg-v1.82.0" = _t5B1OdlO;
        "pkg-v1.83.0" = _jvfqnZW8;
        "pkg-v1.84.0" = _z66xAoyX;
        "pkg-v1.85.0" = _HqxUm9Di;
        "pkg-v1.86.0" = _2myaXZJG;
        "pkg-v1.87.0" = _wTOcD2Tb;
        "pkg-v1.87.1" = _7LRlRDm4;
        "pkg-v1.88.0" = _WflIrhzW;
        "pkg-v1.89.0" = _EAIbnZtk;
        "pkg-v1.90.0" = _nzbPGGu2;
        "pkg-v1.91.0" = _OEjejWNk;
        "pkg-v1.92.0" = _NcI8pLlC;
        "pkg-v1.93.0" = _ifDORFnq;
        "pkg-v1.93.1" = _51IFM3I0;
        "pkg-v1.94.0" = _y7Sq91Of;
        "pkg-v1.95.0" = _LAdJr3w6;
        "pkg-v1.96.0" = _MqEqQ7mo;
        "pkg-v1.97.0" = _mwmucqeZ;
        "pkg-v1.98.0" = _s2jDrFrx;
        "pkg-v1.99.0" = _315HbxMY;
        "pkg-v1.100.0" = _OYbFoBzK;
        "pkg-v1.101.0" = _542LWB8D;
        "pkg-v1.102.0" = _tc9qVi52;
        "pkg-v1.103.0" = _2oyaxXbG;
        "pkg-v1.104.0" = _otziVyWY;
        "pkg-v1.105.0" = _ImhuZssZ;
        "pkg-v1.106.0" = _g5kFJXsf;
        "pkg-v1.107.0" = _anAggvmD;
        "pkg-v1.108.0" = _hZMW3Ags;
        "pkg-v1.109.0" = _QJKF44Tc;
        "pkg-v1.110.0" = _OiCZSeJ2;
        "pkg-v1.111.0" = _1nfohU2a;
        "pkg-v1.112.0" = _iAxwHHla;
        "pkg-v1.113.0" = _L8jQNWIg;
        "default" = _L8jQNWIg;
    });
