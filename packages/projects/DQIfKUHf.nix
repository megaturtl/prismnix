...
let
    versions = (let
        ...
        _fVZtsR9U = {
            "id" = "fVZtsR9U";
            "file" = "styledplayerlist-3.13.0+26.3.jar";
            "hash" = "sha512-XgwvIYBEFLF7M8E2auUhtCfaS9+6ohk2ErI29Vonu9rGvNzU245vW+5cCecpq3mcspj/WiWj4USNr3gh7WHcIQ==";
        };
    in {
        "PYRr9MLt" = _PYRr9MLt;
        "FZbuBdVb" = _FZbuBdVb;
        ...
        "fabric-26.3-rc-1" = _fVZtsR9U;
        "fabric-26.3" = _fVZtsR9U;
        ...
        "pkg-1.2.0" = _Ali2BTRh;
        "pkg-1.2.1" = _kPkTOLEi;
        "pkg-2.0.0-pre1" = _WB8M4Z7c;
        "pkg-2.0.0" = _X0dQ5V9f;
        "pkg-2.0.1" = _jmfRBCBN;
        "pkg-2.1.0" = _IRzh45e3;
        "pkg-2.1.1" = _eHhyJCnU;
        "pkg-2.1.2" = _eTkAj4IY;
        "pkg-2.1.3+1.18" = _bzWvUJeE;
        "pkg-2.2.0+1.19" = _8PRH0Uou;
        "pkg-2.2.1+1.19" = _NUx2ux8g;
        "pkg-2.2.2+1.19.1" = _92EZUM0l;
        "pkg-2.3.0+1.19.3" = _cEi0Qx95;
        "pkg-3.0.0+1.19.4" = _nUzVFlRQ;
        "pkg-3.1.0+1.20" = _GCohbJZB;
        "pkg-3.1.1+1.20.1" = _4FqvobxB;
        "pkg-3.2.0+1.20.2" = _8c1ZipKd;
        "pkg-3.3.0+1.20.3" = _jcLxMRaH;
        "pkg-3.4.0+1.20.5" = _YAL4Wlbx;
        "pkg-3.5.0+1.21" = _THfvB4AJ;
        "pkg-3.5.1+1.21" = _Ui7MOgqG;
        "pkg-3.6.0+1.21.2" = _gyvLcVPF;
        "pkg-3.7.0+1.21.5" = _VQ4VhTvm;
        "pkg-3.8.0+1.21.6" = _roni2qRY;
        "pkg-3.9.0+1.21.9" = _2QAJ6cLM;
        "pkg-3.10.0+1.21.11" = _YpJjE4zz;
        "pkg-3.11.0+26.1" = _KG1Y7uJ6;
        "pkg-3.11.1+26.1" = _bzbuSIb1;
        "pkg-3.12.0+26.2" = _dphV3ifd;
        "pkg-3.13.0+26.3" = _fVZtsR9U;
        "default" = _fVZtsR9U;
    });
