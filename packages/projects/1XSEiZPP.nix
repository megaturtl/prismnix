...
let
    ...
    in {
        ...
        "pkg-3.22.0-alpha.7" = _5GQEy398;
        "pkg-3.22.0-rc1" = _qujB7Bso;
        "pkg-3.22.0-1.20.1" = _vzATd1GG;
        "pkg-3.20.1-1.19.2" = _DLC3XULf;
        "pkg-3.23-1.20.1-fabric" = _29srGUwO;
        "pkg-3.23-1.20.1-forge" = _GaCwUqV2;
        "pkg-3.23.1-1.20.1-fabric" = _Tyocw6l6;
        "pkg-3.23.1-1.20.1-forge" = _CPYehdck;
        "pkg-3.20.3-1.19.2" = _hVGs2k6W;
        "pkg-3.23.2-1.20.1-fabric" = _tuLsOmjh;
        "pkg-3.23.2-1.20.1-forge" = _U1aR3Kue;
        "pkg-3.22.4-alpha0-1.21.1-fabric" = _WtZ1CjaZ;
        "pkg-3.23.3-1.20.1-fabric" = _tbRkbkoy;
        "pkg-3.23.3-1.20.1-forge" = _47fNWC79;
        "pkg-3.22.5-1.21.1-alpha1" = _VtQMqdAL;
        "pkg-3.22.5-1.21.1-alpha1-fabric" = _E9SUJiUy;
        "pkg-3.23.1-1.21.1-beta1-fabric" = _RpE5cScQ;
        "pkg-3.23.1-1.21.1-beta1-neoforge" = _pBe3q877;
        "pkg-3.23.1-1.21.1-beta2" = _WlhkEbM0;
        "pkg-3.23.1-1.21.1-beta2-fabric" = _HZmwB2Vo;
        "pkg-3.18.0-1.18.1" = _UO4TNYC9;
        "pkg-3.18.0-1.18.2" = _ziHvVtPl;
        "pkg-3.24.0-1.21.1-alpha1" = _qEjsegOu;
        "pkg-3.24.1-1.21.1-alpha2" = _CTmS3zRN;
        "pkg-4.0.0-1.18.2" = _L7hb0GnZ;
        "pkg-3.24.2-1.21.1-alpha3" = _sqEvFHDT;
