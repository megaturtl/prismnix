...
let
    versions = (let
        ...
        _BkoJUHkT = {
            "id" = "BkoJUHkT";
            "file" = "Better Pets v4.3.4 - 1.21.1.zip";
            "hash" = "sha512-lPZvMIowsiwOpQS3EBzjwal5a3u2eWuNiKyM/hvYlGvbdwmhS2ecpdngg79UG+V04tZgj4dR8sodgmKuVdtKnQ==";
        };
        _ishxM4hM = {
            "id" = "ishxM4hM";
            "file" = "betterpets-v4.3.4.jar";
            "hash" = "sha512-9nlQTM1ucE4KErbmrjkmwKaqg5U1hw5hBBGgD+rDUWF421ci2rca5wMf261hcCTRVb/LaU1SwqfIBq1pYoHZ2Q==";
        };
        _pDKQ5Erw = {
            "id" = "pDKQ5Erw";
            "file" = "Better Pets v4.3.5 - 26.2.zip";
            "hash" = "sha512-DRMzfmMkboecZibVwtqBeJ5hr8UY9tUCEnrytbCbEhPUiYJbrvZikduAPBhkO0lyVzcej5OND3zpLzv4HQOKfA==";
        };
        _mxYAzt8g = {
            "id" = "mxYAzt8g";
    ...
    in {
        ...
        "datapack-1.21" = _BkoJUHkT;
        "datapack-1.21.1" = _BkoJUHkT;
        ...
        "pkg-v2.0.0+mod" = _ehnosAHw;
        "pkg-v2.0.2" = _KFrVeVht;
        "pkg-v2.0.2+mod" = _NMyiF72K;
        "pkg-v3.0" = _OIUx2GRL;
        "pkg-v3.0+mod" = _EZHzx5uj;
        "pkg-v3.1" = _62rElnVS;
        "pkg-v3.2.0" = _erHTgQOA;
        "pkg-v3.2.0+mod" = _SQrroQvK;
        "pkg-v4.0.0" = _A42AFDM9;
        "pkg-v4.0.0+mod" = _oIb6sp14;
        "pkg-v4.0.1" = _7oXLOHOt;
        "pkg-v4.0.1+mod" = _N0uODT4U;
        "pkg-v4.0.2" = _wptEjTwC;
        "pkg-v4.0.2+mod" = _d1jkICMA;
        "pkg-v4.1.0" = _8sH5vxzX;
        "pkg-v4.1.0+mod" = _7raEbi9a;
        "pkg-v4.2.0" = _5I4W9QQp;
        "pkg-v4.2.0+mod" = _SC4ZAuRR;
        "pkg-v4.2.1" = _lx1Z0ymt;
        "pkg-v4.2.1+mod" = _Ex3BDmz1;
        "pkg-v4.2.2" = _vslFEfcM;
        "pkg-v4.2.2+mod" = _eHVkua9B;
        "pkg-v4.2.3" = _stv3RdUD;
        "pkg-v4.2.3+mod" = _b1B0Pfvs;
        "pkg-v4.2.4" = _kqudlyyR;
        "pkg-v4.2.4+mod" = _zKdA9Cvw;
        "pkg-v4.2.5" = _wr7NHqii;
        "pkg-v4.2.5+mod" = _DwnHUnib;
        "pkg-v4.2.6" = _9LqIxquK;
        "pkg-v4.2.6+mod" = _SZ7Edhxn;
        "pkg-v4.2.7" = _rmQN25Ms;
        "pkg-v4.2.7+mod" = _wQsMiDUC;
        "pkg-v4.3.0" = _SY4LulfV;
        "pkg-v4.3.0+mod" = _aLJGkEyn;
        "pkg-v4.3.1" = _F53vbkGg;
        "pkg-v4.3.1+mod" = _u6oNYqLP;
        "pkg-v4.3.2" = _p9fMDFZD;
        "pkg-v4.3.2+mod" = _cB38ds6K;
        "pkg-v.4.3.2" = _XteIJn1X;
        "pkg-v.4.3.2+mod" = _PNEojsNh;
        "pkg-v4.3.3" = _Kd4mNFs4;
