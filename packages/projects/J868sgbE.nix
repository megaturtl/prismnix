...
let
    ...
    in {
        ...
        "pkg-2.0.8" = _afJGthsS;
        "pkg-2.0.9" = _FFixUg4U;
        "pkg-2.0.10" = _oAj51FBz;
        "pkg-2.0.11" = _NGprYQyS;
        "pkg-2.0.12" = _Pi4tLnHK;
        "pkg-2.0.13" = _ZMVI2HBw;
        "pkg-2.0.14" = _NlNvBdio;
        "pkg-2.0.15" = _q4UmOZE0;
        "pkg-2.0.16" = _epC3KVRg;
        "pkg-2.0.17" = _az2FKXcZ;
        "pkg-2.1.0" = _eLQuJiHm;
        "pkg-2.1.1" = _4qldjoeV;
        "pkg-2.1.2" = _Me2uiAaN;
        "pkg-2.1.3" = _DDowRN8b;
