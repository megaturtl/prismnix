...
let
    versions = (let
        ...
        _rnzTcpH7 = {
            "id" = "rnzTcpH7";
            "file" = "polytone-1.21.11-6.1.6-neoforge.jar";
            "hash" = "sha512-DMxrTTIyk56klzXlJe4plvfRNzTKQfKxQ+2cPAAz+orq3X8EyFdPDUW7L3NA/cgcZg7Xux8/hbdmEvbiP+QYJw==";
        };
        _XR90fWV2 = {
            "id" = "XR90fWV2";
            "file" = "polytone-1.21.11-6.1.6-fabric.jar";
            "hash" = "sha512-OwRDsd2pDfPKcyCA4spmsFT9p6atBdjReKYSuK3I2gZj1pn+I5tI6jKOUxzoe+BSG5I7CKaZLWBbfdCbf02GYA==";
        };
        _9nOwOvyN = {
            "id" = "9nOwOvyN";
            "file" = "polytone-26.1.2-6.2.3-fabric.jar";
            "hash" = "sha512-KmDseU/cP2wc3AcZkzNlfmppjmyhYUaz+xQQtoUBx0yI63EeFW21BzpOWPE9amywQ8QvigICajnZSnOHyXlCsA==";
        };
        _P71M2Y5I = {
            "id" = "P71M2Y5I";
            "file" = "polytone-26.1.2-6.2.3-neoforge.jar";
            "hash" = "sha512-MiokfPJLOd0KwdZU2Akbp7bdNIkUgCvudj+AhIEBz53xhv0vcGT3CPa5eimHd7B5Xwrb0fM3wdj25YnGmQOmmw==";
        };
        _QbnoLDyO = {
            "id" = "QbnoLDyO";
            "file" = "polytone-1.21-3.11.1-fabric.jar";
            "hash" = "sha512-n9oPsiHssQLTbCJxT+O2mi4Sv1zymdZ239TLvoSMGa59s10pgm9bqNgnrNJI4+jizNPh7lnUl7/Zt5kV09JHgQ==";
        };
        _qKR5B1RS = {
            "id" = "qKR5B1RS";
            "file" = "polytone-1.21-3.11.1-neoforge.jar";
            "hash" = "sha512-3nRSom4iumMiH9z4oyG3KxeQJnAkgxXfD5VfSoDHmlegh6S6GGZTyCzzBWtNwvX6gSFpmcAAY81g4Ucx4zMulg==";
        };
        _IwY1ikQd = {
            "id" = "IwY1ikQd";
            "file" = "polytone-1.21.11-6.2.0-neoforge.jar";
            "hash" = "sha512-Z9qOuHaMhMFNHqNi5Y8N1n2pVPTe6wH2/OrPOTnNeKH2NRQOqmdOOOXl36Uj0hrtqq0ZxT8SjLbja2Nrq/wm4Q==";
        };
        _Vk6Ekve4 = {
            "id" = "Vk6Ekve4";
            "file" = "polytone-1.21.11-6.2.0-fabric.jar";
            "hash" = "sha512-obqEBzO2oRQSYrY4sFMY6V8r56Yir5XUWnsdgWhV5of6WOR/TuZb8X1++gE3dEYXR2UYz01t2iXhUzthSWtuDA==";
        };
        _tjXYr1aW = {
            "id" = "tjXYr1aW";
            "file" = "polytone-26.1.2-6.2.5-fabric.jar";
            "hash" = "sha512-JN/4/qMF5XW0GXFeOyI+i8z+4PaB7sB37qJMGV4HGY9xpKdQYIbaWDJbnkAPfRjA8YuEb9ahKLGmiHpte+YpZg==";
        };
        _k9iJHtk3 = {
            "id" = "k9iJHtk3";
            "file" = "polytone-26.1.2-6.2.5-neoforge.jar";
            "hash" = "sha512-o6BSHOhnvYBWlnHUb/kIBr+uouTz87mOiECa9fUPpbNT5FMHOhY2r/vdeUPZJTWZ2FdcCB4HdBTbXdxYIkRkKA==";
        };
        _rHnbV29m = {
            "id" = "rHnbV29m";
            "file" = "polytone-26.1.2-6.2.6-fabric.jar";
            "hash" = "sha512-mdRH0oNc8HCIAVfc/b42nROo/fOiEX7v985ytPjAA+8DjsIB/tZU5n7lFLLTF2AKxvSHbXFNHVI6taz5JgADEg==";
        };
        _FkYpCqn0 = {
            "id" = "FkYpCqn0";
            "file" = "polytone-26.1.2-6.2.6-neoforge.jar";
            "hash" = "sha512-mmNLqgbnW7RAnJYJqh9kyVaSN1mbEAgV6BmAS8tI3OijoVBsWygFc04WFR8ag9b0Q6UbMdrmgkBZze+1IYjAwA==";
        };
        _kDnkTURt = {
            "id" = "kDnkTURt";
            "file" = "polytone-26.2-6.3.0-fabric.jar";
            "hash" = "sha512-hDvBVvHobbA3SVwLM/BZ4ud+xRTEZhJCDAS2dfYlVyjCyXiAcJIffrRYCQFs+EU8yjZQG+30CRV4+YUksXQJeg==";
        };
        _8Bsxtm73 = {
            "id" = "8Bsxtm73";
            "file" = "polytone-26.2-6.3.0-neoforge.jar";
            "hash" = "sha512-NmqYETUTScC0lLNQaMPX65xzGDfFNpCKyYqEjtkvL22GAfHJptKieiXu9X3Nz7BuiXwWR/KnQxEoMVnqswKHYQ==";
        };
        _BiQvcrGl = {
            "id" = "BiQvcrGl";
            "file" = "polytone-26.2-6.3.1-fabric.jar";
            "hash" = "sha512-/p5hpXph/oRn/vvXWSE0rxkQ+BYk5V5AO8JOTqLAUb1e28JJ1DxL+qffplMToHpcOUB8q8/vpVSbHkOj6j9gqg==";
        };
        _o23VF3rV = {
            "id" = "o23VF3rV";
            "file" = "polytone-26.2-6.3.1-neoforge.jar";
            "hash" = "sha512-OLmNU6ayrnMpVZaHU0+3nE3TxXCLrA98Wx6xDYbfOXr+YDUMoNOtVhv0QOVQhK7IDHa29zGNilUsFFJIXYAVPQ==";
        };
        _ugcVoYHg = {
            "id" = "ugcVoYHg";
            "file" = "polytone-26.2-6.3.1-neoforge.jar";
            "hash" = "sha512-TbTQS5nnpIvPvljlpqTx4KTEo8/FgOgLn5Uws+UZvT5mYhgVq9Aj62SjbA1f8VwRbeRxCNcEUAMTPVzzVHoCRA==";
        };
        _vcgXOUY8 = {
            "id" = "vcgXOUY8";
            "file" = "polytone-26.2-6.3.1-fabric.jar";
            "hash" = "sha512-7/5Rm5x/gtbDiJC+QvAhF3zP7vrLZq92SHGGxEDlOn39XBqmMAwTZ81WOm9v5O6NlGQFwo0b9pp4Ip53hqB+yw==";
        };
        _3XAFjwPA = {
            "id" = "3XAFjwPA";
            "file" = "polytone-26.2-6.3.2-fabric.jar";
            "hash" = "sha512-Z6DhE+qJ1oONxnqwnlmSsZthApdW0HtahZ91XSetTGM7MEULEVSKhIeccTlPJSgeyAhnkRpmM5M1CdZ9Gjh9hg==";
        };
        _WjvojEPg = {
            "id" = "WjvojEPg";
            "file" = "polytone-26.2-6.3.2-neoforge.jar";
            "hash" = "sha512-RUm1pKZU7Eca3ueaGl7GmCFdD8YlIjDLaCTufd5i9L57uA4sCM1FSQ46R5ryxFel1axqknAqE1dteh1YmA4sRA==";
        };
        _xXv0Xgr6 = {
            "id" = "xXv0Xgr6";
            "file" = "polytone-1.21-3.11.2-fabric.jar";
            "hash" = "sha512-YKY6p8Y7/IR770fmRwLhXy69i4yxyztaAg+XYzRA2EgSP3NemN8KXHBVLb+KfxJMU3QaUnBhhDF/EPOI+PN2YA==";
        };
        _aa25GFeP = {
            "id" = "aa25GFeP";
            "file" = "polytone-1.21-3.11.2-neoforge.jar";
            "hash" = "sha512-iRZv9ygGW6kiYxD6x84znMfyYBv2SxUIDbdWKXX9DV4yVEDPh56auFD1vZ0GDYkyDI41ePpOA6tYu1hs/0j+uQ==";
        };
        _nAbOgJjW = {
            "id" = "nAbOgJjW";
            "file" = "polytone-1.21-3.12.0-fabric.jar";
            "hash" = "sha512-sgrD0NmI4waWLGesR2y+iYov6Ey4Cj4/12InJlZSEfmjV7DaHs5qlj63mocREGXI6lsQlm2S937XXNl1GXlAlA==";
        };
        _shDmiUCV = {
            "id" = "shDmiUCV";
            "file" = "polytone-1.21-3.12.0-neoforge.jar";
            "hash" = "sha512-BNn/FcsVhd+ZqzdLEGksFUid9vRCoESqigmaIMbzvHseKjbuePvcEHQzZ2dXW9IRG4ddZaPPObsGeId+Cim5NA==";
        };
        _wpv1UFxf = {
            "id" = "wpv1UFxf";
            "file" = "polytone-26.1.2-6.2.7-fabric.jar";
            "hash" = "sha512-pta89LOVSw8hJibHtAJ/gGEsT2EaBLhGGqjKjJyo/o9kf39kJ7BZrLbJr/l+YrQRHS68xJzKu4LcxOYFg8MBbg==";
        };
        _8iZxalxX = {
            "id" = "8iZxalxX";
            "file" = "polytone-26.1.2-6.2.7-neoforge.jar";
            "hash" = "sha512-8/D3cJEU3C0zoNrdaCvy+AFvPtZjb6nWzANULWF62iR9skXRiwtdKlwJ7b3kPm/OpZ9kFQg34ljPBy0kSGO7Ag==";
        };
        _rjUAYfKR = {
            "id" = "rjUAYfKR";
            "file" = "polytone-1.21-4.0.0-fabric.jar";
            "hash" = "sha512-vjnzAvcbn+l0dRrOCH7eqWjoGwCJTVelnnYVOMf6fy2zSixDlg+keUei1w94RfpltWw9EafWGixCA5WVJu+dpA==";
        };
        _dIyqL21t = {
            "id" = "dIyqL21t";
            "file" = "polytone-1.21-4.0.0-neoforge.jar";
            "hash" = "sha512-Hi83pfFBIK1lMLNK6MW/qynA7G3YGV2yDxV3wdSOxSpZorzUwmNcsx+aLsq7sAzn1jNgxX4j4Ek2CWVrwHQk8Q==";
        };
        _4M0xEGLf = {
            "id" = "4M0xEGLf";
            "file" = "polytone-1.21.11-6.3.0-neoforge.jar";
            "hash" = "sha512-VQFgVER9AYYgYQD+j7D3WigVLMIoNw0RaQ0I7azIo7ulk0LxwljUCPqStwNn/ih/HG+xVLapcQV2JN5w7rPFVQ==";
        };
        _ZwCAgvrI = {
            "id" = "ZwCAgvrI";
            "file" = "polytone-1.21.11-6.3.0-fabric.jar";
            "hash" = "sha512-wW/dKqErJVpFYPxsFJQi6MHuj2IX/nSC0SEq0s0xHZ8IZllDZHei7mB3MvohhUgkGw/cYCB7p8t8E15xzx8pIw==";
        };
        _VK8xsysS = {
            "id" = "VK8xsysS";
            "file" = "polytone-1.21.11-6.3.1-neoforge.jar";
            "hash" = "sha512-l1OVbNZMJzV9Sk7cWnXxC99AHgEjkju0uI8zDQqkqlF2050h4r5uAZ6bj4Dyg/49zesBufx4xhIsPTy23/FFvA==";
        };
        _6cZ8vBcu = {
            "id" = "6cZ8vBcu";
            "file" = "polytone-1.21.11-6.3.1-fabric.jar";
            "hash" = "sha512-HVrJXgTB91f0/ZhxOpFnH8NddpMT8hW0EVwtm1xzzQLwpQ9JO6c7ZKQ8UfHWQzuztb5OkwZjlhMkMWh5RcAShQ==";
        };
        _OfmWie1v = {
            "id" = "OfmWie1v";
            "file" = "polytone-1.21-4.0.1-neoforge.jar";
            "hash" = "sha512-I0a0XlBDxQqgxm0l1gb27l1tjDkdrnnYSQz4th9Obki1kGD5M8pt0YhVA58SuwG0OHex5CpTzyZu8K4K6TUVtg==";
        };
        _Ap5eOqhP = {
            "id" = "Ap5eOqhP";
            "file" = "polytone-1.21-4.0.1-fabric.jar";
            "hash" = "sha512-CXUVJJsXGp9JLtJcIPPiItDAoqe9TzJyoZiOLjFuZo7LFek+EUbtC3y/6MVWSTR6ls37QVg56tc/+QSqGiJEog==";
        };
        _7utaYURn = {
            "id" = "7utaYURn";
            "file" = "polytone-26.1.2-6.4.0-neoforge.jar";
            "hash" = "sha512-OFG5PIjj2fVPPYUUhTwP7Xq8yRz3wJtW0hcYEI4gxzWnENyIfQGAI35Sn3PJ5+SjuKlAc6q3EW1v9SMJxuuxyw==";
        };
        _V3P3riaO = {
            "id" = "V3P3riaO";
            "file" = "polytone-26.1.2-6.4.0-fabric.jar";
            "hash" = "sha512-yCAluXVPpRuHjLRvoT9PaDeAnwLWfUWF/VDjzZXiDVOlKmMRRgIPvnBpOpj7spJnyMKoRnwLwPLrwfZ5ClrMyg==";
        };
        _TLambu6O = {
            "id" = "TLambu6O";
            "file" = "polytone-26.2-6.4.0-neoforge.jar";
            "hash" = "sha512-a3FTcytlWT5Riw3EDzpOZ1aS/k1PfnCUAZnyjAgVUwUASsGnPRbuavGUYlhuhaLELfUQY0BN+CKi4NWKgJXuJg==";
        };
        _lw6ZMLw7 = {
            "id" = "lw6ZMLw7";
            "file" = "polytone-26.2-6.4.0-fabric.jar";
            "hash" = "sha512-q07vM4iy2o3uDrqcJU5P6/WVx7XYX/2ipuHAjgLjfTHCHdkwmRzw4fYuOeGHirBEv7GI1L0+8fz27lc+lZuwyg==";
        };
        _dy0yvHls = {
            "id" = "dy0yvHls";
            "file" = "polytone-26.2-6.4.1-neoforge.jar";
            "hash" = "sha512-HgcshuzYs6wLg0j6JrZ8LggyCP+gb1ZMQ5j4I99PYoQ3Zfq5LzQAHobHBYY7QnFT8jdDawkGhbYvfL/6/jRi/w==";
        };
        _7PKRlv5W = {
            "id" = "7PKRlv5W";
            "file" = "polytone-26.2-6.4.1-fabric.jar";
            "hash" = "sha512-zjyD2YictuRrizcGuceXTdUi4EHI/fdc/M87U4aVjEHiVfB5HMGpjV87lXsoX7U1WT7UjNnE/fqcGfwSx38bEA==";
        };
        _G7RShIQO = {
            "id" = "G7RShIQO";
            "file" = "polytone-1.21.11-6.3.2-neoforge.jar";
            "hash" = "sha512-DfdSCoUlo8Pi/1dSCKHyQyFs2HtUaNlDDAiichleWVHaNChAzfYcVSUrfW13Gb49XgIZPSMCLESsjoQjwqA6GQ==";
        };
        _S3QD3sLn = {
            "id" = "S3QD3sLn";
            "file" = "polytone-1.21.11-6.3.2-fabric.jar";
            "hash" = "sha512-3DQ1SJiT4+vT0zWNvENS4UEPiQvOJ0t26YtazTpfQgmlwoPyfHzzLNdZQYOl8p7XEcS1ZrIQB9TLrNK1CBgvfA==";
        };
        _fFX4gYdb = {
            "id" = "fFX4gYdb";
            "file" = "polytone-26.1.2-6.4.1-neoforge.jar";
            "hash" = "sha512-yfHHJepk4dNv2JE+D9yBfc0b1yXEmv8Z75nGxk1VQ4kp3sv+KYntX/fcnUXMIupcbjT02SvwsFAxZ7dMVdRWhQ==";
        };
        _sp2lfJhh = {
            "id" = "sp2lfJhh";
            "file" = "polytone-26.1.2-6.4.1-fabric.jar";
            "hash" = "sha512-LyM0gq9UExSWyhzuTvDih2CmSNDUnsabRs+d4BpHJzm5Wk3snS31Gv1/xKB/z/tuxXtixckvCJzLj3s0iyTJMg==";
        };
        _V2OwmM9O = {
            "id" = "V2OwmM9O";
            "file" = "polytone-26.2-6.4.2-fabric.jar";
            "hash" = "sha512-G0IIyFKXpGDNG4qFaYBt27xjkSiCKstPlX9OJIfQH+j6/vdJLz1QjDe8xt2hbAnD2hvgc1YapMviNagVDe2umA==";
        };
        _g9LapGfh = {
            "id" = "g9LapGfh";
            "file" = "polytone-26.2-6.4.2-neoforge.jar";
            "hash" = "sha512-iLoKI7Tq3ABpAGyVWO8X391WusVVNLX39DyQOHybuhAhhb2o5s/n3o+gB/LA8PjPTsjJdZWxjj1/nEd+/T6dpw==";
        };
        _Ym1ajyei = {
            "id" = "Ym1ajyei";
            "file" = "polytone-1.21-4.0.2-neoforge.jar";
            "hash" = "sha512-fSfQ0gYfkaTWSmapJuKWWyLvbgLbBr8DPONuBFFRaatveG0AuTuc5HsF6NScgVYTZyuwuIDz0qrEH+1tuxS32g==";
        };
        _ldHbb4Zn = {
            "id" = "ldHbb4Zn";
            "file" = "polytone-1.21-4.0.2-fabric.jar";
            "hash" = "sha512-WEYWKwedSWhVrBdw2jQWWQHAf9F46xGuP9DFI4N3eatsyHPb1MOHaJhZo9Lc7xgefdy1/MHqdgi+LnneZ8lPfQ==";
        };
        _7CGmrBAk = {
            "id" = "7CGmrBAk";
            "file" = "polytone-1.21-4.1.0-neoforge.jar";
            "hash" = "sha512-0brUl39pta57v1Qja4sBTIkFBC4f/RrZff9G9NSMuCvuBPFVUBHpj0EidLM0+OaMeISwSUzJKn1r1/NiEWf1IA==";
        };
        _JEf5Ypmh = {
            "id" = "JEf5Ypmh";
            "file" = "polytone-1.21-4.1.0-fabric.jar";
            "hash" = "sha512-qdZO0NFqo/uZUm/wkcPa586/5B9aFlc1wCyAZtlHJjKgrhgpExghteLDh0/f40r3TSTxe1l9LankG5qhVDSb5w==";
        };
        _J4W1flAZ = {
            "id" = "J4W1flAZ";
            "file" = "polytone-26.2-6.4.3-fabric.jar";
            "hash" = "sha512-nO9Bv6M3xUdUV0kDxxlNLja8Hu3xrFNXGHP7l1SZ6txZtA8wsFB3ehbgHInlCMH29/2x2jlHzKqHXXuwPMczRw==";
        };
        _77VH6VE7 = {
            "id" = "77VH6VE7";
            "file" = "polytone-26.2-6.4.3-neoforge.jar";
            "hash" = "sha512-ydh+5TRv6YJUMUnk9zPnGaWUi5H5q4XpGO2A91vNbOjzkTd8bSHlMkZ1RD2FVK+qFlmX0eF7sUW76yDymPty/g==";
        };
        _uX34022s = {
            "id" = "uX34022s";
            "file" = "polytone-26.2-6.4.4-neoforge.jar";
            "hash" = "sha512-nt9fXwxdBIDdkpjeM6mVc8+KdIFfid76pJKYB7nWHdaz6tCYzIUgceiXwWcBBG2fWHAX5JD/akPYYr/I86zuWg==";
        };
        _VRdd6m4o = {
            "id" = "VRdd6m4o";
            "file" = "polytone-26.2-6.4.4-fabric.jar";
            "hash" = "sha512-lMK8pu9G9Yh8ajT5ANFA9KM40KdNQHJZ64shi7CQ9j8owETrRFfL4Imyh2EUmZuejve5sgYolsbZAiq+COMJrw==";
        };
        _OzmMJPsm = {
            "id" = "OzmMJPsm";
            "file" = "polytone-26.2-6.4.5-neoforge.jar";
            "hash" = "sha512-/4ffQ0sodVLGCcU29UMmtOONR1d8LThsi85XjNmZd4zeN6aNlSDNnOoy15L3ygxWY/fnvK4Se1qUmhkg/8sS3A==";
        };
        _Yqc0wQyd = {
            "id" = "Yqc0wQyd";
            "file" = "polytone-26.2-6.4.5-fabric.jar";
            "hash" = "sha512-9lbblhZywqpXPWtpqqnzS2dxNFELrn02cbOdCMFJzif62BftAq4vjBqbt4cjTn+6t6WqVVemM3fgFZHOK8aJng==";
        };
        _xvLeKUDF = {
            "id" = "xvLeKUDF";
            "file" = "polytone-1.21-4.2.0-fabric.jar";
            "hash" = "sha512-YVaQCNmGHaMYI6gituideNO0x2Jc/DE1QC/tSC85OKfbcDUTT/xz7DHb7sS0gaEuqxi8xAr+NoDV81PGyyf4HA==";
        };
        _f1xWmwSP = {
            "id" = "f1xWmwSP";
            "file" = "polytone-1.21-4.2.0-neoforge.jar";
            "hash" = "sha512-gLgUomrMObvf9Uu/DmXHmZibEpHJnK/hC7kvq0Zd9bC3vhYO3Nqi5ogDP8sByT0p8I1TKL//Tufv3TE1cjaCow==";
        };
        _ndL2EzUm = {
            "id" = "ndL2EzUm";
            "file" = "polytone-1.21.11-6.4.1-fabric.jar";
            "hash" = "sha512-5xUBpIBj3XaW4k5yewIC5Up+UTY+H6xE3r9gsZ9hNRmo7QWey1dnJjnK0feznhy54ZZrl/OJ5G+d2wobWDexNg==";
        };
        _Xe7h4LV5 = {
            "id" = "Xe7h4LV5";
            "file" = "polytone-1.21.11-6.4.1-neoforge.jar";
            "hash" = "sha512-eDgit2lJdt1mKRsALHD4VpLzzG8VcypEVebwFg4LzF3sQ1eUuQrONjMZ/2/6SO6pwyMTw6HJjKy9bz/W5G+oJA==";
        };
        _9YswnyYB = {
            "id" = "9YswnyYB";
            "file" = "polytone-1.21.11-6.4.2-neoforge.jar";
            "hash" = "sha512-c6MRDi+JYOK+fcQlEecVzM6dkDWJS+E+HsxZBuOyJMG9FoBEKqJvLqjbOk+IhVZ2i3hG1V2X3LqbK16wlU7Q5g==";
        };
        _HJB2aEw8 = {
            "id" = "HJB2aEw8";
            "file" = "polytone-1.21.11-6.4.2-fabric.jar";
            "hash" = "sha512-p0jHuNmEmqJqpEUavP7In4spIxJX7hTK5p3ImVYLUm95WmKZ3xWj9BUqi8JpJ6SWdvPHgd1/DB/Hwro2WRAe6A==";
        };
        _XTxKoo2T = {
            "id" = "XTxKoo2T";
            "file" = "polytone-26.2-6.5.0-neoforge.jar";
            "hash" = "sha512-9aC2rg08q1Oz50xV/FvEI2VOV8OSwAOevhLpAZzCLwdsk3lIwbKrP+HHy+/F63BAtnw3+zoyrf8mVeE0LxEDGQ==";
        };
        _FX4kaRLx = {
            "id" = "FX4kaRLx";
    ...
    in {
        ...
        "pkg-1.9.0" = _wwQwtkqH;
        "pkg-1.9.1" = _CzRcyPjg;
        "pkg-1.10.0" = _cvYi6n0R;
        "pkg-1.10.1" = _bdXzFXrI;
        "pkg-1.20-1.11.0" = _XwGtYaNn;
        "pkg-1.20-1.11.1" = _MQ650jmQ;
        "pkg-1.20-1.11.2" = _f5r9TDid;
        "pkg-1.20-1.11.3" = _WZC9ptjB;
        "pkg-1.20-1.11.4" = _MKdsxutA;
        "pkg-1.20-1.12.0" = _mhK4OxVo;
        "pkg-1.19.2-1.12.0" = _upd65ytS;
        "pkg-1.18.2-1.12.0" = _RF855caz;
        "pkg-1.20.4-1.12.0" = _jYxMIz1w;
        "pkg-1.20-1.12.1" = _JUkagU0h;
        "pkg-1.20-1.12.3" = _1wn4oJPG;
        "pkg-1.19.2-1.12.1" = _95OWcqWZ;
        "pkg-1.18.2-1.12.1" = _53mBAHdw;
        "pkg-1.20-1.12.4" = _U6TzZmN6;
        "pkg-1.20.4-1.12.1" = _ynVFjN1u;
        "pkg-1.20-1.13.0" = _PaC0fWN6;
        "pkg-1.20.4-1.13.0" = _tcOetcnK;
        "pkg-1.19.2-1.13.0" = _ruBpmH3A;
        "pkg-1.20-1.13.1" = _TQNmADvh;
        "pkg-1.20-1.13.2" = _PY927imX;
        "pkg-1.20-1.14.0" = _ZoihN37t;
        "pkg-1.19.2-1.14.0" = _Sze0yn2t;
        "pkg-1.20-1.14.1" = _8yNIdOYt;
        "pkg-1.20.4-1.14.0" = _VYQY1uYs;
        "pkg-1.20.4-1.14.1" = _gIMIqQhA;
        "pkg-1.20-1.14.2" = _oJntM6XQ;
        "pkg-1.20-1.14.3" = _a6pdrj6o;
        "pkg-1.20.4-1.14.2" = _LpBRNSms;
        "pkg-1.20.4-1.14.3" = _KT7nVRt0;
        "pkg-1.20-1.14.4" = _C9XVp6Y4;
        "pkg-1.20-1.14.5" = _AxNFcoEF;
        "pkg-1.20.4-1.14.5" = _JNfNq7L2;
        "pkg-1.20.4-1.14.6" = _p4Tx9dRW;
        "pkg-1.20-1.14.6" = _S2IWllKK;
        "pkg-1.20.4-1.14.7" = _KWmbMQYd;
        "pkg-1.20-1.14.7" = _pHrmGhIE;
        "pkg-1.20-1.14.8" = _vIy8jkp2;
        "pkg-1.20-1.14.9" = _nLHpBty2;
        "pkg-1.20-1.14.10" = _SGPRAFq6;
        "pkg-1.20-1.14.11" = _A6MI4Hke;
        "pkg-1.19.2-1.15.0" = _HCGS7CeV;
        "pkg-1.20-1.14.12" = _hGMVbW9i;
        "pkg-1.20-1.14.13" = _XR8hGzuS;
        "pkg-1.20-1.14.14" = _Ao9Li8zD;
        "pkg-1.19.2-1.15.1" = _oVGa6Ebi;
        "pkg-1.20-1.15.0" = _lgAI4Ukc;
        "pkg-1.20-1.16.0" = _liRyOWv7;
        "pkg-1.20-1.16.1" = _TCdea3yo;
        "pkg-1.20.4-1.15.1" = _PLeg4pF4;
        "pkg-1.20-1.16.2" = _iQvuIUVq;
        "pkg-1.20.4-1.16.2" = _WbcFy3x7;
        "pkg-1.20-1.16.3" = _YKNckM3M;
        "pkg-1.20.4-1.16.3" = _ykvXKqPA;
        "pkg-1.20.4-1.16.4" = _qYg3IRhY;
        "pkg-1.20.4-1.16.5" = _ScR2qgKO;
        "pkg-1.20-1.16.5" = _1SfNOW9A;
        "pkg-1.20.4-1.16.6" = _e0Ly1lE4;
        "pkg-1.20-1.16.6" = _rfXWUcnR;
        "pkg-1.20-1.16.7" = _gcp5dtcX;
        "pkg-1.20-1.16.8" = _mDtCOW5J;
        "pkg-1.20-1.17.0" = _BcbNvv8F;
        "pkg-1.20.4-1.17.0" = _y6EOO0Vq;
        "pkg-1.20-1.17.1" = _aOtmJj3N;
        "pkg-1.20-1.17.2" = _8kteD1eS;
        "pkg-1.20.4-1.17.2" = _6kOuEDdM;
        "pkg-1.20.4-1.17.3" = _nucyc3yh;
        "pkg-1.20.4-1.17.4" = _QesjzJyI;
        "pkg-1.20.4-1.17.5" = _RHd71XW3;
        "pkg-1.20-1.17.5" = _pQYpTNcB;
        "pkg-1.20-1.17.6" = _8AzpNpec;
        "pkg-1.20.4-1.17.6" = _TAZDKkIi;
        "pkg-1.20-1.17.7" = _Ixn4IaUD;
        "pkg-1.20-1.17.8" = _IgXafDzO;
        "pkg-1.20.4-1.17.7" = _k7PMApxf;
        "pkg-1.20.4-1.18.0" = _YGEgFqZX;
        "pkg-1.20.4-1.18.1" = _T09rZZbq;
        "pkg-1.20.4-1.18.2" = _Ms5HHmbK;
        "pkg-1.20.4-1.18.3" = _OwkqEj3I;
        "pkg-1.20.4-1.18.4" = _r73vGgnk;
        "pkg-1.20.4-1.18.5" = _1EbrNltt;
        "pkg-1.20-1.17.9" = _Q6cBmn4x;
        "pkg-1.20.4-1.18.6" = _PViDmMCX;
        "pkg-1.20.4-1.18.7" = _tfSAWwie;
        "pkg-1.20-1.17.10" = _v0dL6Ym8;
        "pkg-1.20-1.17.11" = _hq6aURRn;
        "pkg-1.20-1.17.12" = _fC60v0aQ;
        "pkg-1.20-1.17.13" = _DFnjozXX;
        "pkg-1.20.4-1.18.8" = _9E3hk7Zx;
        "pkg-1.20.6-1.18.8" = _TL61kpbQ;
        "pkg-1.20-1.17.14" = _H74QlKjA;
        "pkg-1.20-1.17.15" = _QtYpuLH6;
        "pkg-1.20.6-1.18.9" = _zzUna1J8;
        "pkg-1.20.6-1.18.10" = _NtsW1MAX;
        "pkg-1.20-1.17.16" = _5YgWbI9c;
        "pkg-1.20.6-1.18.11" = _Lximponj;
        "pkg-1.20-1.17.17" = _m9s5RPeF;
        "pkg-1.20.4-1.18.10" = _J39ptUd8;
        "pkg-1.20-1.17.18" = _zgi75nuH;
        "pkg-1.20-1.17.20" = _SZwhAMcs;
        "pkg-1.20-1.18.0" = _1QaRLNRU;
        "pkg-1.20-1.18.1" = _m1pEbqyj;
        "pkg-1.20.6-1.18.12" = _qjWyKesv;
        "pkg-1.20-1.18.2" = _3BS7j1rX;
        "pkg-1.20-1.18.3" = _qKagUd7T;
        "pkg-1.20-1.19.0" = _uwnTdqPb;
        "pkg-1.20-1.20.0" = _S7sTzKOl;
        "pkg-1.20.6-1.19.0" = _C1rkoAaj;
        "pkg-1.20-1.20.1" = _oi9q0uXh;
        "pkg-1.20-1.20.2" = _gAQOtj1e;
        "pkg-1.20.6-1.19.1" = _hb3mD8AA;
        "pkg-1.20-1.20.3" = _WzT6Ueg0;
        "pkg-1.20.6-1.19.2" = _x7d4YWGz;
        "pkg-1.20-2.0.0" = _fhRh5sIi;
        "pkg-1.20-2.0.1" = _frAZmMEk;
        "pkg-1.20-2.0.2" = _JrM9w0zy;
        "pkg-1.20-2.0.3" = _bcHSCj6l;
        "pkg-1.20.6-2.0.2" = _8FgEzAG8;
        "pkg-1.20-2.0.4" = _6DFYk8wK;
        "pkg-1.21-2.0.3" = _N9vJxRex;
        "pkg-1.20-2.1.0" = _KZ8yWdE6;
        "pkg-1.20-2.1.1" = _ge6uKur6;
        "pkg-1.21-2.1.0" = _6tiZ9dWg;
        "pkg-1.21-2.1.1" = _fwoY0CNc;
        "pkg-1.20-2.1.2" = _aicMStdN;
        "pkg-1.20-2.1.3" = _IjGJR6j9;
        "pkg-1.21-2.1.3" = _S7mFltFy;
        "pkg-1.21-2.1.5" = _aekk57CP;
        "pkg-1.20-2.1.4" = _TWuTKESn;
        "pkg-1.21-2.1.6" = _Q3uKTGcS;
        "pkg-1.20-2.2.0" = _rfgl58FM;
        "pkg-1.21-2.2.0" = _cHiCvP6M;
        "pkg-1.21-2.2.1" = _bDfqQItu;
        "pkg-1.20-2.2.1" = _Ep087DXo;
        "pkg-1.21-2.2.2" = _FxXjR4qJ;
        "pkg-1.21-2.2.3" = _nUT1yKR9;
        "pkg-1.21-2.2.5" = _oaEQylgD;
        "pkg-1.20-2.2.2" = _g3r8MefO;
        "pkg-1.21-2.2.7" = _tWGPei6n;
        "pkg-1.21-2.2.8" = _u9t3V4Ih;
        "pkg-1.21-2.2.9" = _Qtyi506u;
        "pkg-1.21-2.2.10" = _whjNWNC4;
        "pkg-1.21-2.2.11" = _idghq6al;
        "pkg-1.21-2.2.12" = _E6fcTUmj;
        "pkg-1.21-2.2.13" = _s8aqG0A6;
        "pkg-1.21-2.3.0" = _10VaAuXa;
        "pkg-1.20-2.3.0" = _gi6xD764;
        "pkg-1.21-2.3.1" = _t9IQjMod;
        "pkg-1.20-2.3.1" = _YtyajnmT;
        "pkg-1.21-2.3.3" = _XtR5X32R;
        "pkg-1.21-2.3.4" = _zaMBnOdJ;
        "pkg-1.21-2.3.5" = _drddLAPS;
        "pkg-1.21-2.3.7" = _ht3QvwB7;
        "pkg-1.21-2.3.8" = _jnmgvsoH;
        "pkg-1.21-2.3.10" = _5OWOkbp6;
        "pkg-1.21-2.3.12" = _OGtqiuNI;
        "pkg-1.21-2.4.0" = _yVOg48lU;
        "pkg-1.21-2.4.1" = _cU9JgxnW;
        "pkg-1.21-2.4.2" = _j7vgPfEB;
        "pkg-1.21-2.4.4" = _uOyFMXKU;
        "pkg-1.21-2.4.5" = _23STEBmt;
        "pkg-1.21-2.4.6" = _yMs81BGr;
        "pkg-1.21-2.4.7" = _Roxi15Vv;
        "pkg-1.21-2.4.8" = _qH9Ujwsv;
        "pkg-1.21-2.4.9" = _HiNYltr9;
        "pkg-1.21-2.4.10" = _LY7fKPTW;
        "pkg-1.21-2.4.12" = _obFK10UO;
        "pkg-1.20-2.3.2" = _MduvNGno;
        "pkg-1.21-2.4.13" = _GoJoO7WY;
        "pkg-1.21-2.4.14" = _KhX8mgAu;
        "pkg-1.21-2.4.15" = _3Y9QkYGm;
        "pkg-1.21-2.4.16" = _MyvgsqnE;
        "pkg-1.21-2.4.17" = _BnM8RtXX;
        "pkg-1.21-2.4.18" = _qKhwwqrB;
        "pkg-1.21-2.4.19" = _o3HKZeFs;
        "pkg-1.20-2.3.3" = _7MdXV8P5;
        "pkg-1.21-2.4.20" = _puF8azNr;
        "pkg-1.21-2.4.21" = _pQwy03z7;
        "pkg-1.21-2.4.22" = _qts1KKkr;
        "pkg-1.21-2.4.25" = _EMa5nhxt;
        "pkg-1.21-2.4.26" = _C1wUZQy9;
        "pkg-1.21-2.5.0" = _FPbGVYCW;
        "pkg-1.21-2.5.1" = _AxpKR7AW;
        "pkg-1.21-2.5.2" = _gjiYqwB8;
        "pkg-1.20-2.4.0" = _irFasZrU;
        "pkg-1.21-2.5.3" = _vWD6e0Wi;
        "pkg-1.21-2.5.4" = _QGux7jB1;
        "pkg-1.21.3-2.5.5" = _3C4kwsMC;
        "pkg-1.21-2.5.5" = _H7hyuo44;
        "pkg-1.21.3-2.5.6" = _8Aj3faAK;
        "pkg-1.20-2.4.1" = _yCyewZT6;
        "pkg-1.21-2.5.7" = _ZVtJvoLn;
        "pkg-1.21-2.5.8" = _ytfOTPVw;
        "pkg-1.21-2.5.9" = _Lyt5aVCP;
        "pkg-1.21-2.5.10" = _OUFfPjZd;
        "pkg-1.20-2.4.2" = _xI4uTTGR;
        "pkg-1.21-2.5.12" = _Uz1hdXmE;
        "pkg-1.21.3-2.5.7" = _luxkcMrA;
        "pkg-1.21.3-2.5.8" = _xEaNKYMW;
        "pkg-1.21-2.5.13" = _km9rkT1k;
        "pkg-1.20-2.4.3" = _4AQwseGT;
        "pkg-1.21.3-2.5.9" = _ZNhdX9HW;
        "pkg-1.21.3-2.5.10" = _d6h9ZYUC;
        "pkg-1.21-3.0.0" = _2zOaSMTG;
        "pkg-1.20-3.0.0" = _7RqeiG5E;
        "pkg-1.21-3.1.0" = _I9eJOVCv;
        "pkg-1.20-3.1.0" = _bwUf5PuF;
        "pkg-1.21.4-3.1.0" = _skFIepHX;
        "pkg-1.21.4-3.1.1" = _sg1Bew0K;
        "pkg-1.20-3.1.1" = _XEBoTzjm;
        "pkg-1.21.4-3.1.2" = _lzwkoeWq;
        "pkg-1.20-3.1.2" = _5gST0IIX;
        "pkg-1.21.4-3.1.3" = _khH9hlD4;
        "pkg-1.21.4-3.1.5" = _NGYHqrdJ;
        "pkg-1.20-3.1.3" = _BAxbFSYp;
        "pkg-1.21-3.1.1" = _tESWCz1V;
        "pkg-1.21-3.1.3" = _q4a5wHZg;
        "pkg-1.20-3.1.4" = _xx6nCmuY;
        "pkg-1.20-3.1.5" = _XpqyMfn4;
        "pkg-1.21.4-3.1.6" = _Tn5o3whn;
        "pkg-1.21.4-3.2.0" = _hgC2Vco9;
        "pkg-1.21-3.2.0" = _piwZTC7K;
        "pkg-1.20-3.2.0" = _NvqqsYv8;
        "pkg-1.21.4-3.2.1" = _HBAuvmWQ;
        "pkg-1.21-3.2.1" = _m2O9Xt79;
        "pkg-1.21.4-3.2.2" = _mZGwlO0w;
        "pkg-1.21.4-3.2.3" = _bmkVH6GQ;
        "pkg-1.21.4-3.2.4" = _ehj3Kqni;
        "pkg-1.21-3.2.3" = _Gpi2ab76;
        "pkg-1.21.4-3.2.6" = _4UUOAMGg;
        "pkg-1.21-3.2.4" = _f5JiWo1f;
        "pkg-1.21.4-3.2.7" = _RZfxNjod;
        "pkg-1.21-3.2.5" = _8Q1FI1eR;
        "pkg-1.21-3.2.6" = _6C4eYyCx;
        "pkg-1.20-3.2.1" = _VgAZnW6m;
        "pkg-1.20-3.2.2" = _IUPTiYg5;
        "pkg-1.20-3.2.3" = _jdGu24fu;
        "pkg-1.21.4-3.2.8" = _xvILtBnc;
        "pkg-1.20-3.2.4" = _P74XK8Zl;
        "pkg-1.20-3.2.5" = _lcinVKPx;
        "pkg-1.20-3.2.6" = _YQW3MVg1;
        "pkg-1.21.4-3.2.9" = _BgM0Unyf;
        "pkg-1.20-3.2.8" = _x6yCCHte;
        "pkg-1.21-3.2.7" = _UU1qGZi9;
        "pkg-1.21.4-3.2.10" = _oH28dgYt;
        "pkg-1.21.4-3.2.11" = _EPk6YyFg;
        "pkg-1.21-3.2.8" = _Jyk9wVpI;
        "pkg-1.21.4-3.2.12" = _6zDIBv2Z;
        "pkg-1.20-3.2.9" = _wg3QwA7T;
        "pkg-1.21-3.2.9" = _hHxgqsnB;
        "pkg-1.21.4-3.2.13" = _tbRMkt5H;
        "pkg-1.21.4-3.2.14" = _NTb36azM;
        "pkg-1.21-3.2.10" = _ZMpOZ6V2;
        "pkg-1.21-3.2.11" = _Wloh1OEk;
        "pkg-1.21.4-3.2.15" = _BnR8RqPo;
        "pkg-1.21-3.2.12" = _XNa1Se1a;
        "pkg-1.21-3.2.13" = _lNBkDhI2;
        "pkg-1.21.4-3.2.16" = _Ns7t5kAe;
        "pkg-1.21.4-3.2.17" = _5y2yxhGg;
        "pkg-1.21.4-3.3.0" = _Zjoru5bE;
        "pkg-1.20-3.3.0" = _jGoeE4Pm;
        "pkg-1.21-3.3.0" = _bLMgZTG1;
        "pkg-1.20-3.3.1" = _3Xh0xhla;
        "pkg-1.21-3.3.1" = _jejyOnPy;
        "pkg-1.21.4-3.3.1" = _TpTa8cuK;
        "pkg-1.20-3.3.2" = _r9Qkej2I;
        "pkg-1.20-3.3.3" = _lOl9mhsu;
        "pkg-1.21.4-3.3.2" = _RfnIEvDv;
        "pkg-1.20-3.3.4" = _GekVLkRS;
        "pkg-1.21-3.3.2" = _nWR2P4l2;
        "pkg-1.20-3.3.6" = _7dxxP8l9;
        "pkg-1.21-3.3.3" = _pmWZ7rpy;
        "pkg-1.21.4-3.3.4" = _aEQPm8Ko;
        "pkg-1.21.4-3.3.5" = _UgcyeHZN;
        "pkg-1.21.4-3.3.6" = _tY3aLnxO;
        "pkg-1.20-3.3.7" = _XK9gQJFJ;
        "pkg-1.21.4-3.3.7" = _eD0Y4MBI;
        "pkg-1.21-3.3.4" = _RBUV2r7V;
        "pkg-1.21.4-3.3.8" = _hbK2N94g;
        "pkg-1.21.4-3.3.9" = _AXIfp8Xm;
        "pkg-1.20-3.3.8" = _Df52jZG1;
        "pkg-1.21.4-3.3.10" = _oMCMnEmT;
        "pkg-1.21.4-3.3.11" = _ACZiQfcv;
        "pkg-1.21-3.3.5" = _MU3cLk4A;
        "pkg-1.21-3.3.7" = _mXmZmSuZ;
        "pkg-1.21.5-3.4.0" = _WEC2xjan;
        "pkg-1.21-3.3.8" = _hVWVPQhY;
        "pkg-1.21-3.3.9" = _xa3JRcsM;
        "pkg-1.21.4-3.3.13" = _SAjdqIum;
        "pkg-1.21.5-3.4.1" = _Sg5WE19A;
        "pkg-1.21.5-3.4.2" = _S9qJi2yW;
        "pkg-1.21.4-3.3.15" = _61eHCadK;
        "pkg-1.21.4-3.3.16" = _GXp2MBu1;
        "pkg-1.21.4-3.3.17" = _mYEgapib;
        "pkg-1.21.4-3.3.18" = _1vl6rPAs;
        "pkg-1.20-3.3.9" = _zFZPh3Q8;
        "pkg-1.21.4-3.3.19" = _DHWiWWg0;
        "pkg-1.21.4-3.3.20" = _jdRjqOgC;
        "pkg-1.20-3.3.10" = _t9CyuqNn;
        "pkg-1.21.4-3.3.21" = _jc86Q87k;
        "pkg-1.21.4-3.3.22" = _PNZDpzAD;
        "pkg-1.21.5-3.4.4" = _Aykc6TvH;
        "pkg-1.21.4-3.3.23" = _GQ4AXlv2;
        "pkg-1.21-3.3.10" = _MsBiqTE4;
        "pkg-1.21.5-3.4.5" = _THKGLynJ;
        "pkg-1.21-3.3.11" = _9JKkGSXT;
        "pkg-1.21.5-3.4.6" = _vjMOvTLb;
        "pkg-1.20-3.3.11" = _LOGPYqkv;
        "pkg-1.21-3.3.13" = _pjurGbwN;
        "pkg-1.21-3.4.0" = _PnudMGRB;
        "pkg-1.20-3.4.0" = _44at0LBE;
        "pkg-1.21-3.5.0" = _CGFXwD9S;
        "pkg-1.21.5-3.5.0" = _wv1LTr3y;
        "pkg-1.21-3.5.1" = _ZpMq5LzN;
        "pkg-1.21.5-3.5.2" = _NxaIKbPM;
        "pkg-1.21-3.5.2" = _cTZiv89T;
        "pkg-1.21.5-3.5.3" = _qivFCT7s;
        "pkg-1.20-3.5.0" = _YOe0QWCW;
        "pkg-1.20-3.5.1" = _NvQc0QFS;
        "pkg-1.21.5-3.5.4" = _4tfVGhPD;
        "pkg-1.21.5-3.5.5" = _6Wi8Tr7P;
        "pkg-1.21.5-3.5.6" = _WZnAmx8Z;
        "pkg-1.21.5-3.5.7" = _r88DcEEK;
        "pkg-1.21-3.5.3" = _boaMH6Nf;
        "pkg-1.21.7-3.5.1" = _WPoE2bUL;
        "pkg-1.21.7-3.5.2-alpha" = _FWaGUepG;
        "pkg-1.21.5-3.5.8" = _WRQ94MJa;
        "pkg-1.20-3.5.2" = _Nbtig8zp;
        "pkg-1.20-3.5.3" = _dcnQIuMC;
        "pkg-1.21-3.5.4" = _B0109WgG;
        "pkg-1.21-3.5.5" = _jeNTdDVS;
        "pkg-1.20-3.5.4" = _WliDbJp6;
        "pkg-1.21.5-3.5.9" = _e3V2ILZQ;
        "pkg-1.21.5-3.5.10" = _4swMp8R3;
        "pkg-1.21.5-3.5.11" = _oiEHYo7n;
        "pkg-1.21.5-3.5.12" = _SOZLOFpp;
        "pkg-1.21-3.5.6" = _VCg1q62i;
        "pkg-1.20-3.5.5" = _WmxIq5K7;
        "pkg-1.21-3.5.7" = _NewqkiMd;
        "pkg-1.20-3.5.6" = _KDoJ8CHP;
        "pkg-1.21.5-3.5.13" = _41rmfcsu;
        "pkg-1.21.7-3.5.3-alpha" = _wTDKtvYK;
        "pkg-1.20-3.5.7" = _Y8o2IuqE;
        "pkg-1.21.8-3.5.3-alpha" = _4GDReXC6;
        "pkg-1.21.5-3.5.14" = _xU8sahTi;
        "pkg-1.20-3.5.8" = _vNGFK1RJ;
        "pkg-1.20-3.5.9" = _PQr53FIb;
        "pkg-1.21-3.5.9" = _Av3uHCdZ;
        "pkg-1.21.8-3.5.4-alpha" = _7KzQDS4q;
        "pkg-1.21-3.5.10" = _56MYdQnt;
        "pkg-1.21.4-3.3.24" = _7rPD3Q0C;
        "pkg-1.20-3.5.10" = _cWWpTphV;
        "pkg-1.20-3.5.11" = _IMy4h05q;
        "pkg-1.21-3.5.11" = _wtiBTope;
        "pkg-1.21-3.5.12" = _yrAoqp3x;
        "pkg-1.20-3.5.12" = _9AiH6RHf;
        "pkg-1.21-3.5.13" = _E5h4tCDY;
        "pkg-1.20-3.5.14" = _FVg1PB0D;
        "pkg-1.20-3.5.15" = _XTBlK8SH;
        "pkg-1.20-3.5.16" = _zVuPlaWy;
        "pkg-1.20-3.5.17" = _8ZyqCu36;
        "pkg-1.21-3.5.14" = _qSaM5FDu;
        "pkg-1.21-3.5.15-neoforge" = _jWt3KtR4;
        "pkg-1.21-3.5.15-fabric" = _CzF5TTPi;
        "pkg-1.21-3.6.0-fabric" = _4zlSUgnJ;
        "pkg-1.21-3.6.0-neoforge" = _w8WV7n4P;
        "pkg-1.21.5-3.6.0-fabric" = _tlQpFA7N;
        "pkg-1.21.10-3.6.0-fabric" = _fIooCfF5;
        "pkg-1.21.10-3.6.1-fabric" = _wVHJqNoi;
        "pkg-1.21.10-3.6.2-fabric" = _NiYhQaIM;
        "pkg-1.21.10-3.6.2-neoforge" = _4AG3Rkz8;
        "pkg-1.21.10-3.6.3-fabric" = _UQqL5tXd;
        "pkg-1.21-3.6.1-neoforge" = _Huc1qTUT;
        "pkg-1.21-3.6.1-fabric" = _f4mtTpdh;
        "pkg-1.21.11-4.0.0-alpha-fabric" = _S2dfRoQG;
        "pkg-1.21.11-4.0.1-alpha-fabric" = _BUdjkKrU;
        "pkg-1.21.11-4.0.2-alpha-fabric" = _XKXlCCA1;
        "pkg-1.21.11-4.0.3-fabric" = _YcM6T7vU;
        "pkg-1.21.11-4.0.4-fabric" = _OobwDlTj;
        "pkg-1.21.11-4.0.5-fabric" = _OUyCLARa;
        "pkg-1.21.11-4.0.6-fabric" = _TNyZp0Jr;
        "pkg-1.21.11-4.0.7-fabric" = _AOihb0ed;
        "pkg-1.21.11-4.0.7-neoforge" = _qZaGRAwJ;
        "pkg-1.21.11-5.0.0-fabric" = _q4Q0XnnB;
        "pkg-1.21.11-5.0.0-neoforge" = _4wFJNAF5;
        "pkg-1.21.11-5.1.0-fabric" = _A0dPBXpJ;
        "pkg-1.21.11-5.1.0-neoforge" = _hrU5QaVd;
        "pkg-1.20-3.5.18" = _Lv0oRzSN;
        "pkg-1.20-3.5.19" = _hZsdY7mi;
        "pkg-1.21.11-5.2.0-fabric" = _ViZpL3Ry;
        "pkg-1.21.11-5.2.0-neoforge" = _aWDP0ZOH;
        "pkg-1.21.11-5.2.2-fabric" = _irTEXnWw;
        "pkg-1.21.11-5.2.2-neoforge" = _Rp8E992m;
        "pkg-1.21.11-5.2.3-fabric" = _opCmDHwx;
        "pkg-1.21.11-5.2.3-neoforge" = _6BuuC5lv;
        "pkg-1.21.11-5.3.0-fabric" = _72UkHrqc;
        "pkg-1.21.11-5.3.0-neoforge" = _dEcb1oMR;
        "pkg-1.21-3.6.2-neoforge" = _YXxqMMps;
        "pkg-1.21-3.6.2-fabric" = _ltHriQB0;
        "pkg-1.21.11-5.3.1-neoforge" = _cTEDTKRl;
        "pkg-1.21.11-5.3.1-fabric" = _6yLmWf91;
        "pkg-1.21.11-5.3.2-fabric" = _MyrxvwsW;
        "pkg-1.20-3.5.20" = _ALJBDhH8;
        "pkg-1.21.11-5.3.3-fabric" = _xiRrMiz6;
        "pkg-1.21.11-5.3.3-neoforge" = _5HmyPKrq;
        "pkg-1.20-3.5.21" = _6kQNs4QY;
        "pkg-1.21-3.6.3-neoforge" = _1lOeXDli;
        "pkg-1.21-3.6.3-fabric" = _NPB6tgKm;
        "pkg-1.21-3.6.4-neoforge" = _3hubAt33;
        "pkg-1.21-3.6.4-fabric" = _n7wiVAm2;
        "pkg-1.20-3.5.22" = _5DIUTtyE;
        "pkg-1.21.11-5.3.4-fabric" = _G0mfEJhZ;
        "pkg-1.21.11-5.3.4-neoforge" = _fEeBYUeF;
        "pkg-1.21.11-5.3.5-fabric" = _9cdIow4b;
        "pkg-1.21.11-5.3.5-neoforge" = _L49Fd3rX;
        "pkg-1.21.11-5.3.6-neoforge" = _pJR8gdRD;
        "pkg-1.21.11-5.3.6-fabric" = _lsVrjxjT;
        "pkg-1.21.11-5.3.7-fabric" = _iPiC28o8;
        "pkg-1.21.11-5.3.7-neoforge" = _7WEcUenB;
        "pkg-1.21.11-5.3.8-fabric" = _fMYMS2de;
        "pkg-1.21.11-5.3.8-neoforge" = _30mFtrjR;
        "pkg-1.21.11-5.3.10-fabric" = _BEbbKdlW;
        "pkg-1.21.11-5.3.10-neoforge" = _MTG7nQUI;
        "pkg-1.21.11-5.4.0-neoforge" = _SgkpOZFm;
        "pkg-1.21.11-5.4.0-fabric" = _BmUGXx4x;
        "pkg-1.21.11-5.4.1-fabric" = _BW0RE0yG;
        "pkg-1.21.11-5.4.1-neoforge" = _OenqKVBP;
        "pkg-1.21.11-5.4.3-fabric" = _z2tLkjKN;
        "pkg-1.21.11-5.4.3-neoforge" = _9I0ZaItv;
        "pkg-1.21.11-5.4.4-fabric" = _1HZVdqa4;
        "pkg-1.21.11-5.4.4-neoforge" = _ZCVqEq6o;
        "pkg-1.21.11-5.4.5-fabric" = _JYJ2KaEM;
        "pkg-1.21.11-5.4.5-neoforge" = _w11j4e4G;
        "pkg-1.21.11-5.4.6-fabric" = _pbTFTtbW;
        "pkg-1.21.11-5.4.6-neoforge" = _VOJuIHhR;
        "pkg-1.21.11-5.4.7-fabric" = _Uwt1LfdX;
        "pkg-1.21.11-5.4.7-neoforge" = _gc6YuSVI;
        "pkg-1.21.11-5.4.8-fabric" = _1EjU7vHZ;
        "pkg-1.21.11-5.4.8-neoforge" = _D4EFXq4Z;
        "pkg-1.21.11-5.4.9-fabric" = _eWw2c59h;
        "pkg-1.21.11-5.4.9-neoforge" = _8C6smBt3;
        "pkg-1.21.11-5.4.10-fabric" = _XkPbDIYK;
        "pkg-1.21.11-5.4.10-neoforge" = _tyO5LVXs;
        "pkg-1.21.11-5.4.11-neoforge" = _QTXXmrf0;
        "pkg-1.21.11-5.4.11-fabric" = _Odi9MOHG;
        "pkg-1.21.11-5.4.13-neoforge" = _tYjAlQEo;
        "pkg-1.21.11-5.4.13-fabric" = _6kqMwXS4;
        "pkg-1.21.11-5.4.14-neoforge" = _Ky26lrJP;
        "pkg-1.21.11-5.4.14-fabric" = _e9gMok80;
        "pkg-1.21.11-5.4.15-fabric" = _pGgWLCcc;
        "pkg-1.21.11-5.4.15-neoforge" = _apaRlllM;
        "pkg-1.21.11-5.4.16-fabric" = _9k4eyEea;
        "pkg-1.21.11-5.4.16-neoforge" = _sy2MZBtl;
        "pkg-1.21.11-5.4.17-neoforge" = _wzEg4sYy;
        "pkg-1.21.11-5.4.17-fabric" = _F25P7Wsx;
        "pkg-1.21-3.6.5-fabric" = _T8aHZehv;
        "pkg-1.21-3.6.5-neoforge" = _Re4fSru9;
        "pkg-1.21.11-5.4.19-fabric" = _RPVOpO6f;
        "pkg-1.21.11-5.4.19-neoforge" = _HJ3n1vNO;
        "pkg-1.21.11-5.4.20-fabric" = _YjELtoNW;
        "pkg-1.21.11-5.4.20-neoforge" = _FcB1y0iC;
        "pkg-1.21.11-5.5.0-neoforge" = _bQRHmMxP;
        "pkg-1.21.11-5.5.0-fabric" = _fs8VmMcr;
        "pkg-1.21-3.6.6-fabric" = _MrVA4L0j;
        "pkg-1.21-3.6.6-neoforge" = _KxrIyizz;
        "pkg-1.21.11-5.5.1-fabric" = _u01N5yth;
        "pkg-1.21.11-5.5.1-neoforge" = _om0WSeLe;
        "pkg-1.21.11-5.5.2-fabric" = _iR9jQVAU;
        "pkg-1.21.11-5.5.2-neoforge" = _TilDqfKI;
        "pkg-1.21.11-5.5.3-fabric" = _UrqZG02l;
        "pkg-1.21.11-5.5.3-neoforge" = _xbJqb9T8;
        "pkg-1.21.11-5.5.4-fabric" = _HMdlSYim;
        "pkg-1.21.11-5.5.4-neoforge" = _UDCA4laT;
        "pkg-1.20-3.5.23" = _fV8kQtsI;
        "pkg-1.20-3.5.25" = _G8ZfIp5c;
        "pkg-1.21.11-5.5.6" = _JMmhsI6C;
        "pkg-1.21.11-5.6.1" = _AG7SwGHS;
        "pkg-1.20-3.5.26" = _keUL5Iuv;
        "pkg-1.21-3.6.7-neoforge" = _g907ZKM2;
        "pkg-1.21-3.6.7-fabric" = _OmvjAXWl;
        "pkg-1.21.11-5.6.2" = _w2wdTFcK;
        "pkg-1.21.11-5.6.3" = _5234cINN;
        "pkg-1.21.11-5.6.4" = _3Gq5VZzU;
        "pkg-1.21.11-5.7.0" = _xRp1oeYw;
        "pkg-1.21.11-5.7.1" = _QH6Lsnn0;
        "pkg-1.21.11-5.7.2" = _TjXRfnHS;
        "pkg-1.21-3.7.0" = _PU4Q4aXV;
        "pkg-1.21-3.7.1" = _c1LUG0zX;
        "pkg-1.21.11-5.8.0" = _AaVoE6kd;
        "pkg-1.21.11-5.8.1" = _eqmYrURW;
        "pkg-1.21.11-5.9.0" = _qCVgobGN;
        "pkg-1.21.11-5.9.1" = _DvEzUrog;
        "pkg-26.1.2-5.9.2-alpha" = _C4QFJ6bp;
        "pkg-26.1.2-5.9.3" = _ykNZwiv2;
        "pkg-1.21-3.8.0" = _lsAlQXGN;
        "pkg-1.21-3.8.1" = _IsMSxxZ9;
        "pkg-26.1.2-5.9.4" = _rbBl1LSK;
        "pkg-1.21.11-5.9.4" = _8nQwsY2u;
        "pkg-26.2-5.10.0" = _b4yHMjXw;
        "pkg-26.2-5.10.1" = _oy1Jf8Xi;
        "pkg-26.1.2-5.9.5" = _a9JReMvT;
        "pkg-26.2-5.10.2" = _nUAfL3gN;
        "pkg-1.21-3.8.4" = _Yo5giGIA;
        "pkg-1.21-3.8.5" = _KA8WPQVb;
        "pkg-1.21-3.8.6" = _Hi4RkXp7;
        "pkg-1.21-3.8.8" = _LWb7tKC7;
        "pkg-1.21.11-6.0.0" = _IXgiCkQx;
        "pkg-1.21-3.9.0" = _wAK81tZr;
        "pkg-1.21.11-6.0.1" = _iuIxvcKR;
        "pkg-1.21-3.9.1" = _mwCFSHk6;
        "pkg-1.21-3.9.3" = _XcVO565i;
        "pkg-1.21-3.10.0" = _YnB5o2eO;
        "pkg-1.21.11-6.1.0" = _zS74BNN8;
        "pkg-1.21.11-6.1.1" = _rA3Fvh1X;
        "pkg-1.21.11-6.1.2" = _fiEKLKzK;
        "pkg-1.21.11-6.1.3" = _RwSkpjPD;
        "pkg-26.1.2-6.2.0" = _ilSs9fVo;
        "pkg-1.21.11-6.1.4" = _96heocBe;
        "pkg-1.21-3.10.2" = _rSGcv5rh;
        "pkg-26.1.2-6.2.1" = _8jG5PVW9;
        "pkg-26.1.2-6.2.2" = _AtYNBvrp;
        "pkg-1.21.11-6.1.5" = _v8EVUmjl;
        "pkg-1.21-3.10.3" = _vshYp2ly;
        "pkg-1.21-3.11.0" = _nuiQbZ25;
        "pkg-1.21.11-6.1.6" = _XR90fWV2;
        "pkg-26.1.2-6.2.3" = _P71M2Y5I;
        "pkg-1.21-3.11.1" = _qKR5B1RS;
        "pkg-1.21.11-6.2.0" = _Vk6Ekve4;
        "pkg-26.1.2-6.2.5" = _k9iJHtk3;
        "pkg-26.1.2-6.2.6" = _FkYpCqn0;
        "pkg-26.2-6.3.0" = _8Bsxtm73;
        "pkg-26.2-6.3.1" = _vcgXOUY8;
        "pkg-26.2-6.3.2" = _WjvojEPg;
        "pkg-1.21-3.11.2" = _aa25GFeP;
        "pkg-1.21-3.12.0" = _shDmiUCV;
        "pkg-26.1.2-6.2.7" = _8iZxalxX;
        "pkg-1.21-4.0.0" = _dIyqL21t;
        "pkg-1.21.11-6.3.0" = _ZwCAgvrI;
        "pkg-1.21.11-6.3.1" = _6cZ8vBcu;
        "pkg-1.21-4.0.1" = _Ap5eOqhP;
        "pkg-26.1.2-6.4.0" = _V3P3riaO;
        "pkg-26.2-6.4.0" = _lw6ZMLw7;
        "pkg-26.2-6.4.1" = _7PKRlv5W;
        "pkg-1.21.11-6.3.2" = _S3QD3sLn;
        "pkg-26.1.2-6.4.1" = _sp2lfJhh;
        "pkg-26.2-6.4.2" = _g9LapGfh;
        "pkg-1.21-4.0.2" = _ldHbb4Zn;
        "pkg-1.21-4.1.0" = _JEf5Ypmh;
        "pkg-26.2-6.4.3" = _77VH6VE7;
        "pkg-26.2-6.4.4" = _VRdd6m4o;
        "pkg-26.2-6.4.5" = _Yqc0wQyd;
        "pkg-1.21-4.2.0" = _f1xWmwSP;
