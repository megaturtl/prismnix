...
let
    versions = (let
        ...
        _cq2EpoTT = {
            "id" = "cq2EpoTT";
            "file" = "smartbrainlib-neoforge-26.3-2.0.2.jar";
            "hash" = "sha512-LX+UGUEVH7OUECMi2ahHbHbVq0xR7pB7eaUx642KX52Uvdx0hhMBMVzbvFILbTeahL29WSEbUgsYJK4DqRGISw==";
        };
        _i5vOn6hO = {
            "id" = "i5vOn6hO";
            "file" = "smartbrainlib-fabric-26.3-2.0.2.jar";
            "hash" = "sha512-YOYNlkIsnsQUpQKgZYYplf6S8D2QLlxQxjd3vFsBB0/8AGs8niEQdL9eF6XFou5/aggYtYkeezETgof/Vx/iXg==";
        };
        _J42POwBk = {
            "id" = "J42POwBk";
            "file" = "smartbrainlib-fabric-26.2-2.0.2.jar";
            "hash" = "sha512-EPYgn/+kqs0sckUFGIDaaHxnM2aCofVfmJbKi6dyRpfVd7ZQ3/IyorBL2/6AgHb09HWYKkH/wx8m7m8AD7xAtg==";
        };
        _XJv3nLUe = {
            "id" = "XJv3nLUe";
            "file" = "smartbrainlib-forge-26.2-2.0.2-slim.jar";
            "hash" = "sha512-ajQIjU6kHB/tBDXMuUABE1J3VdFzTks2quxytvW+TzeBLwo3Th9Io+cxiFzZp2maBAteM4YF6x2WtGxQmaJOwQ==";
        };
        _2tgPLTNW = {
            "id" = "2tgPLTNW";
    ...
    in {
        ...
        "pkg-1.19.3-1.7.2" = _M7ktWGYQ;
        "pkg-1.19.3-1.7.3" = _mVxYjt2C;
        "pkg-1.19.3-1.7.4" = _7N07DeJa;
        "pkg-1.19.2-1.7.4" = _YtIoSE8Z;
        "pkg-1.18.2-1.7.4" = _nKzUoyO8;
        "pkg-1.18.2-1.8" = _bLpKjCaQ;
        "pkg-1.19.2-1.8" = _j5XWlgk3;
        "pkg-1.19.3-1.8" = _l1gfkZbZ;
        "pkg-1.18.2-1.8.1" = _Okj48Ibk;
        "pkg-1.9" = _RC9fgR3J;
        "pkg-1.11" = _EB0jfrC5;
        "pkg-1.11.1" = _4XxIY1BG;
        "pkg-1.11.2" = _YJrpYN13;
        "pkg-1.12" = _Sf934AXj;
        "pkg-1.13" = _KAMi0Ept;
        "pkg-1.14" = _RLMA7zfB;
        "pkg-1.14.1" = _j5TLOZUR;
        "pkg-1.14.2" = _XsqXgUo1;
        "pkg-1.14.3" = _WPExnI9I;
        "pkg-1.14.4" = _ZLWE52gx;
        "pkg-1.14.5" = _ghHJdLd3;
        "pkg-1.15" = _MgT6lGFk;
        "pkg-1.16" = _YGXoFCMt;
        "pkg-1.16.1" = _NbBnBDuq;
        "pkg-1.16.3" = _WyFKeK3q;
        "pkg-1.16.4" = _RIXYWjSS;
        "pkg-1.16.2" = _C0UKTkbs;
        "pkg-1.16.5" = _DdHrO1nX;
        "pkg-1.16.6" = _MlabTf1z;
        "pkg-1.16.7" = _45Xreirt;
        "pkg-1.16.8" = _bk4X7H5O;
        "pkg-1.16.9" = _s3CO2qge;
        "pkg-1.16.10" = _k5mK199p;
        "pkg-1.16.11" = _5wOE1uXk;
