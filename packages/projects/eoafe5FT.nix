...
let
    versions = (let
        ...
        _Gzd8hICi = {
            "id" = "Gzd8hICi";
            "file" = "CustomModelDataViewer-3.0.2+26.2.jar";
            "hash" = "sha512-j7T7QGM20+FrZm+uuEYYll9+p2Zd1apcUDsYwPIQrJjng7yElrBIWWLx+9toPpwphSK+0SRZ8WMRcRjkm+2gRA==";
        };
        _oAko1NZJ = {
            "id" = "oAko1NZJ";
    ...
    in {
        ...
        "pkg-2.0+1.21.8" = _80aW7dt5;
        "pkg-2.0+1.21.6" = _13NMsvDU;
        "pkg-2.0+1.21.7" = _Kjqr6jM4;
        "pkg-2.1+1.21.4" = _VJYXf6Mi;
        "pkg-2.1+1.21.6" = _ITN17fcM;
        "pkg-2.1+1.21.8" = _rIpwdGoM;
        "pkg-2.1+1.21.7" = _kedYYC4c;
        "pkg-2.2+1.21.4" = _2f23PA6i;
        "pkg-2.2+1.21.6" = _bS7WgXN2;
        "pkg-2.2+1.21.7" = _QvAYk1ED;
        "pkg-2.2+1.21.8" = _90j8LZvc;
        "pkg-2.2.1+1.21.4" = _m9UOsv9p;
        "pkg-2.2.1+1.21.6" = _TqtKrMYo;
        "pkg-2.2.1+1.21.8" = _adb59sX1;
        "pkg-2.2.1+1.21.7" = _lP79DlmC;
        "pkg-2.2.1+1.21.9" = _LLmqpKPE;
        "pkg-2.2.1+1.21.10" = _cskjnhlH;
        "pkg-3.0.0+1.21.11" = _h7acJASh;
        "pkg-3.0.0+26.1.2" = _yxxRg3L4;
        "pkg-3.0.1+26.1.2" = _AbcIluBt;
