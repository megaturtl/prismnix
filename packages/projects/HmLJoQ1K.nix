...
let
    versions = (let
        ...
        _5sw9IAnr = {
            "id" = "5sw9IAnr";
            "file" = "integratedterminals-1.21.1-neoforge-1.9.0-963.jar";
            "hash" = "sha512-BkL3GSYBjjO3ygGEUNcEcG115ooRkNSees8ls+cgkWbgWbiVlOVKk/BsCwNlRHDH0Q4aGBFjIGdrgHpTUiDRfA==";
        };
        _wgVaR2Xo = {
            "id" = "wgVaR2Xo";
            "file" = "integratedterminals-26.1.2-neoforge-1.9.1-973.jar";
            "hash" = "sha512-iNcpyaH+wL3vfY3gzubEWaHS2m1D7h7ajpMRxMcRFCVK3B5THRPz0T3PwqenZ5epJi2Rk05BcQ1jnKpEVBbxfg==";
        };
        _oXfvBtb0 = {
            "id" = "oXfvBtb0";
            "file" = "integratedterminals-1.21.1-neoforge-1.9.0-978.jar";
            "hash" = "sha512-Nddf3UQBr2xymvSGJ6nhniI8MyonQNKHBRZaUB/3UXkZiKIGYBVyAoK9nWZR0sMSGN71lvTx8WA0eWgpMk9q1g==";
        };
        _7uzRNAe0 = {
            "id" = "7uzRNAe0";
            "file" = "integratedterminals-26.1.2-neoforge-1.9.1-981.jar";
            "hash" = "sha512-PjKEs0UcqUEjvy6X5XrLePOkXH8k4IzXZ6ZbGZnXsl/rTmOmxNGhRG1gdj1l0WoNm2AQkpphoCiWxvvX6p/GxA==";
        };
        _vHpH27b4 = {
            "id" = "vHpH27b4";
            "file" = "integratedterminals-1.21.1-neoforge-1.9.0-988.jar";
            "hash" = "sha512-fga5Y+qng4FE+dN904hMqL7Hm5NixtzPw77lXYpn/CNEsaXAu+jYDwwMT0rSw3zWaQR7XoglKMiWcey9EMFpOQ==";
        };
        _IeC9RHPa = {
            "id" = "IeC9RHPa";
            "file" = "integratedterminals-1.21.1-neoforge-1.9.0-997.jar";
            "hash" = "sha512-yflUu3vtWcLhGnJhp+RpA3hJH4Gd187imIKXmts9g7/VvWaYSXqNftFq2mhqXvv5jdTPVZrrR0sQjrqMXY3/nA==";
        };
        _pPn5vlmc = {
            "id" = "pPn5vlmc";
            "file" = "integratedterminals-1.21.1-neoforge-1.9.0-998.jar";
            "hash" = "sha512-paVWQYbS2rtfmUKnI6Jq0vAUTCvB1Xc/kRDPXuSV96Lccm3LusbpKcAU35nYzSTZ57LSpKFDTfkj8v9DGcvPHA==";
        };
        _Ab9fIu7J = {
            "id" = "Ab9fIu7J";
            "file" = "integratedterminals-26.1.2-neoforge-1.9.1-999.jar";
            "hash" = "sha512-sfcp/r3zqgR26nRgReRUu3OXvrXlZ7Wtx4AnDPsi/eJucl3jzPp+w395M923UnK0p0sCewoj84xWNmTzHbjDFw==";
        };
        _lJUDq2aL = {
            "id" = "lJUDq2aL";
            "file" = "integratedterminals-26.1.2-neoforge-1.9.1-1000.jar";
            "hash" = "sha512-fCChBJBwxzArnRjkRBB5GB9JojW3qkZeZZOk3ZgrddiUZx2W9kCCRBh/sJRIfGP1u6fL6u+s29zTKupbZRMRCg==";
        };
        _xAn4UF0i = {
            "id" = "xAn4UF0i";
            "file" = "integratedterminals-26.2-neoforge-1.7.0-1001.jar";
            "hash" = "sha512-XD22J+Y2E+aLIHZVc1wDjQATgkmvS+VZf+HwKp/SZuJoNb0KSMEutBuUxVmMqV0kUI811eJ7o2C+e93biJ2rkw==";
        };
        _L0ErjFoc = {
            "id" = "L0ErjFoc";
            "file" = "integratedterminals-26.1.2-neoforge-1.10.0.jar";
            "hash" = "sha512-n8a6LZvYXo89FRSABmcmurh2Y6ZVgbeEclFg8zuW0dAesFAEibTvwgHMMHbKKFEf9qMhO7CHjXKiYpxBTUU/xg==";
        };
        _NHmJAOGl = {
            "id" = "NHmJAOGl";
            "file" = "integratedterminals-26.2-neoforge-1.7.0-1006.jar";
            "hash" = "sha512-UkkOBmyaQEfXIV3K+APW+icU7tWfcZNUD7XBiJWt+xAZrO1qXEnf2OPlBUkAUnKLCwFgOhfQsPorp5HZsdf5Nw==";
        };
        _UnVN4YWi = {
            "id" = "UnVN4YWi";
    ...
    in {
        ...
        "pkg-1.19-1.3.1" = _rD380a2t;
        "pkg-1.19.2-1.3.1" = _Me1jZOxO;
        "pkg-1.18.2-1.3.1" = _dZrWvKyH;
        "pkg-1.19.2-1.3.2" = _uYryUzb3;
        "pkg-1.18.2-1.3.2" = _g9UM8CxH;
        "pkg-1.19.2-1.3.3" = _ejPqHlPx;
        "pkg-1.19.2-1.4.0" = _5HUKdF5Y;
        "pkg-1.18.2-1.4.0" = _VuBg4KHr;
        "pkg-1.19.2-1.4.1" = _deGe8ca1;
        "pkg-1.18.2-1.4.1" = _s9y7u8fg;
        "pkg-1.18.2-1.4.2" = _I6OIJKOV;
        "pkg-1.18.2-1.4.3" = _MCmFUaoG;
        "pkg-1.19.2-1.4.2" = _yAkBmaD4;
        "pkg-1.19.3-1.4.2" = _HcUHRrd2;
        "pkg-1.19.3-1.4.3" = _Kf8IiZEY;
        "pkg-1.18.2-1.4.4" = _SkCKQbLO;
        "pkg-1.19.2-1.4.3" = _12E8gaI0;
        "pkg-1.19.3-1.4.4" = _Uo2iKToo;
        "pkg-1.19.2-1.4.4" = _hrjVQG6K;
        "pkg-1.19.3-1.4.5" = _IOyzNVlJ;
        "pkg-1.18.2-1.4.5" = _HNCgS7Fn;
        "pkg-1.19.2-1.4.5" = _zcgb8URq;
        "pkg-1.19.3-1.4.6" = _7NixaXCQ;
        "pkg-1.19.2-1.4.6" = _aBaqRJMh;
        "pkg-1.19.4-1.4.6" = _DdRskShk;
        "pkg-1.19.2-1.4.7" = _Xe4waQLd;
        "pkg-1.18.2-1.4.7" = _CxHpXOsh;
        "pkg-1.19.4-1.4.7" = _zwZ9bf0q;
        "pkg-1.19.4-1.4.8" = _IZCjB6Xo;
        "pkg-1.20.1-1.4.8" = _tOzrbnGL;
        "pkg-1.19.2-1.4.8" = _AqvcSeVR;
        "pkg-1.20.1-1.4.9" = _9mpZbEn4;
        "pkg-1.18.2-1.4.8" = _QOyVVNAw;
        "pkg-1.19.2-1.4.9" = _JJiVTpcY;
        "pkg-1.20.1-1.4.10" = _zdkgDcsZ;
        "pkg-1.18.2-1.4.9" = _A9UPRxAS;
        "pkg-1.19.2-1.4.10" = _TBVMcwGb;
        "pkg-1.20.1-1.4.11" = _DLugrivJ;
        "pkg-1.18.2-1.4.10" = _RJ5xJfdP;
        "pkg-1.19.2-1.4.11" = _53Z9pb4q;
        "pkg-1.20.1-1.4.12" = _dKpG1Cq3;
        "pkg-1.18.2-1.4.11" = _4OrJGrPE;
        "pkg-1.19.2-1.4.12" = _1AvqmZbs;
        "pkg-1.20.1-1.4.13" = _7xmxLjci;
        "pkg-1.18.2-1.4.12" = _IBQpAttK;
        "pkg-1.19.2-1.4.13" = _nW59P1MR;
        "pkg-1.20.1-1.4.14" = _Gf0wVITQ;
        "pkg-1.20.4-1.4.12" = _OGhSaweZ;
        "pkg-1.19.2-1.4.14" = _Cuu2OPUt;
        "pkg-1.20.1-1.4.15" = _dbTIXLx6;
        "pkg-1.20.4-1.4.13" = _ppaulrbH;
        "pkg-1.21-1.4.13" = _l9SDpL9R;
        "pkg-1.19.2-1.4.15" = _HwFFgIuL;
        "pkg-1.20.1-1.4.16" = _efGP9Z2n;
        "pkg-1.21-1.4.14" = _93g3EtMB;
        "pkg-1.21-1.4.15" = _PQVgsbhA;
        "pkg-1.19.2-1.5.0" = _cY9cy6fO;
        "pkg-1.20.1-1.5.0" = _sUCoWJIY;
        "pkg-1.21-1.5.0" = _sqLb5rKE;
        "pkg-1.21.1-1.5.1" = _on2wU7u6;
        "pkg-1.19.2-1.5.1" = _rnorI0uU;
        "pkg-1.21.1-1.5.2" = _mlCR5EWl;
        "pkg-1.20.1-1.5.1" = _5fahofPO;
        "pkg-1.21.1-1.6.0" = _89dgzDTd;
        "pkg-1.20.1-1.6.0" = _KPuRPpXU;
        "pkg-1.19.2-1.6.0" = _AcxaHLRH;
        "pkg-1.21.1-1.6.1" = _HD2NYgLU;
        "pkg-1.21.1-1.6.2" = _9ybM2zn8;
        "pkg-1.21.1-1.6.3" = _6f3gB9ow;
        "pkg-1.20.1-1.6.1" = _kuHUPI6u;
        "pkg-1.19.2-1.6.1" = _i8kQOoyC;
        "pkg-1.19.2-1.6.2" = _d2JV9NaC;
        "pkg-1.20.1-1.6.2" = _kJbO8LUo;
        "pkg-1.21.1-1.6.4" = _1P7ktHMr;
        "pkg-1.21.1-1.6.5" = _WHb5psGq;
        "pkg-1.21.1-1.6.6" = _O19IOXSz;
        "pkg-1.19.2-1.6.3" = _YHXHO4aj;
        "pkg-1.20.1-1.6.3" = _aND6fE2M;
        "pkg-1.21.1-1.6.6-435" = _qRjekSAk;
        "pkg-1.21.1-1.6.6-438" = _GCI8xCSd;
        "pkg-1.21.1-1.6.6-439" = _IAMz36F6;
        "pkg-1.21.1-1.6.6-440" = _XJjbXgsT;
        "pkg-1.21.1-1.6.6-442" = _QOxLPrt3;
        "pkg-1.20.1-1.6.4" = _HQMlo3QL;
        "pkg-1.19.2-1.6.4" = _SV4z5Iur;
        "pkg-1.21.1-1.6.7-450" = _HmkLg7YE;
        "pkg-1.21.1-1.6.7" = _KkwIh3Dq;
        "pkg-1.21.1-1.6.7-451" = _2YAL3HPv;
        "pkg-1.21.1-1.6.7-453" = _P2GIlU37;
        "pkg-1.21.1-1.6.7-456" = _ZZGTzovu;
        "pkg-1.19.2-1.6.5" = _c6O8YeUG;
        "pkg-1.20.1-1.6.5" = _OziNOVA1;
        "pkg-1.21.1-1.6.8-464" = _w6sAZDoL;
        "pkg-1.21.1-1.6.8" = _3oWoHHAy;
        "pkg-1.21.4-1.6.6-469" = _Z6V9uGNd;
        "pkg-1.21.1-1.6.9" = _ICnQYGFN;
        "pkg-1.21.1-1.6.9-473" = _gLqmkYkv;
        "pkg-1.21.1-1.6.9-475" = _Qbnc7HcB;
        "pkg-1.21.1-1.6.9-477" = _WIV4ufUd;
        "pkg-1.21.1-1.6.9-479" = _1aKWw87w;
        "pkg-1.21.1-1.6.9-480" = _zFgLB9Bq;
        "pkg-1.21.4-1.6.6-481" = _3OdxnCSh;
        "pkg-1.21.4-1.6.6-482" = _DAb03oxL;
        "pkg-1.21.1-1.6.9-484" = _cDdldkbo;
        "pkg-1.19.2-1.6.6" = _qne5Kn2g;
        "pkg-1.21.1-1.6.10" = _Dt1aMwVQ;
        "pkg-1.20.1-1.6.6" = _S2UAR5w7;
        "pkg-1.21.1-1.6.10-497" = _8XKUr3Sd;
        "pkg-1.21.4-1.6.6-498" = _iPR1slgt;
        "pkg-1.21.4-1.6.6-499" = _NSssgiO7;
        "pkg-1.19.2-1.6.7" = _edMsf29x;
        "pkg-1.20.1-1.6.7" = _MJal7DsV;
        "pkg-1.21.1-1.6.11" = _B9snfWsE;
        "pkg-1.21.4-1.6.6-506" = _UX6lXblO;
        "pkg-1.21.1-1.6.12" = _x5ZwBvDV;
        "pkg-1.21.4-1.6.6-510" = _tI9DyXQG;
        "pkg-1.21.1-1.6.13" = _vcJytbiK;
        "pkg-1.21.4-1.6.6-513" = _HMJkCuNJ;
        "pkg-1.19.2-1.6.8" = _Nfs6bZI2;
        "pkg-1.20.1-1.6.8" = _aTJC5iT9;
        "pkg-1.21.1-1.6.14" = _BVmx4R7C;
        "pkg-1.21.4-1.6.6-520" = _fMBXXVYB;
        "pkg-1.21.1-1.6.14-522" = _UXxFzTfj;
        "pkg-1.21.1-1.6.14-524" = _Yqxj8SuQ;
        "pkg-1.21.1-1.6.14-526" = _6A5wnjVv;
        "pkg-1.21.1-1.6.14-528" = _l3CNyC5Q;
        "pkg-1.21.1-1.6.14-529" = _DyEvKQYg;
        "pkg-1.21.8-1.6.6-534" = _4YTvpstP;
        "pkg-1.21.8-1.6.6-535" = _u1uXbETH;
        "pkg-1.21.1-1.6.14-536" = _rvwgOheI;
        "pkg-1.21.1-1.6.14-537" = _9GBu09uL;
        "pkg-1.21.1-1.6.14-541" = _KDjHnzgd;
        "pkg-1.19.2-1.6.9" = _OucDz2J3;
        "pkg-1.20.1-1.6.9" = _NVLwvRW2;
        "pkg-1.21.1-1.6.15" = _msJXT3za;
        "pkg-1.21.8-1.6.6-548" = _ELYO7a03;
        "pkg-1.21.8-1.6.6-550" = _fO7nXiN4;
        "pkg-1.20.1-1.6.10" = _lJYmpEOA;
        "pkg-1.21.1-1.6.16" = _MMZgj35n;
        "pkg-1.21.8-1.6.6-558" = _PkwKWSOw;
        "pkg-1.21.8-1.6.6-559" = _33An8Fb3;
        "pkg-1.20.1-1.6.11" = _IcaqDjB4;
        "pkg-1.21.1-1.6.17" = _jwzg2ERn;
        "pkg-1.21.8-1.6.6-613" = _c1kBlkaI;
        "pkg-1.21.1-1.6.17-617" = _O55KdOmm;
        "pkg-1.20.1-1.6.12" = _lGIyor80;
        "pkg-1.21.1-1.6.18" = _VG8e37IT;
        "pkg-1.21.8-1.6.6-625" = _yJATrpv8;
        "pkg-1.21.1-1.6.19" = _sxvpeM9t;
        "pkg-1.21.8-1.6.6-628" = _vs2TU7nH;
        "pkg-1.21.1-1.6.19-630" = _w37nWiw8;
        "pkg-1.21.8-1.6.6-631" = _zKsVJzVr;
        "pkg-1.20.1-1.6.13" = _oJFt53dm;
        "pkg-1.21.1-1.6.20" = _nI1CevxS;
        "pkg-1.21.8-1.6.6-639" = _phKkDgZf;
        "pkg-1.21.8-1.6.6-640" = _TyRTujEb;
        "pkg-1.21.8-1.6.6-641" = _cNTsGaUT;
        "pkg-1.20.1-1.6.14" = _H1kosqQA;
        "pkg-1.21.1-1.6.21" = _dEBiIM2G;
        "pkg-1.21.8-1.6.6-648" = _quIemGpB;
        "pkg-1.21.1-1.6.21-649" = _qtPatFAN;
        "pkg-1.21.10-1.6.6-650" = _gx0kU5sd;
        "pkg-1.21.10-1.6.6-651" = _QtDqGHti;
        "pkg-1.21.11-1.6.6-653" = _nunzOJcU;
        "pkg-1.20.1-1.6.15" = _DcPo3fIv;
        "pkg-1.21.1-1.6.22" = _Wj8tjjaS;
        "pkg-1.21.11-1.6.6-658" = _IgGWigMl;
        "pkg-1.21.11-1.6.6-659" = _GoubnTcU;
        "pkg-1.20.1-1.6.16" = _tpnG9B7K;
        "pkg-1.21.1-1.6.23" = _lR3Com6h;
        "pkg-1.21.11-1.6.6-664" = _KI349qSt;
        "pkg-1.20.1-1.6.17" = _QmCmNg6Y;
        "pkg-1.21.11-1.6.6-672" = _494A9Cr9;
        "pkg-1.21.1-1.6.24" = _iTf4azy4;
        "pkg-1.21.1-1.6.24-673" = _ozev0pAG;
        "pkg-1.21.1-1.6.24-674" = _rtOK956O;
        "pkg-1.21.1-1.6.24-677" = _X7b4rUoh;
        "pkg-1.21.11-1.6.6-678" = _QkCaR0NP;
        "pkg-1.21.1-1.6.24-684" = _LvsV0VYN;
        "pkg-1.21.1-1.6.24-687" = _3v4S1rPq;
        "pkg-1.20.1-1.6.18" = _Z3X6sAMp;
        "pkg-1.21.1-1.6.25" = _2DItgiSi;
        "pkg-1.21.11-1.6.6-701" = _GZCMkOHE;
        "pkg-1.21.1-1.6.25-705" = _HR8FcNC1;
        "pkg-1.21.1-1.6.25-706" = _hJ3D7pak;
        "pkg-1.21.1-1.6.25-712" = _5E4CS25l;
        "pkg-1.21.1-1.6.25-716" = _62IppBjc;
        "pkg-1.20.1-1.6.19" = _VD8RALRP;
        "pkg-1.21.1-1.6.26-722" = _c4BUaqZg;
        "pkg-1.21.1-1.6.27" = _BdWfcOAC;
        "pkg-1.21.11-1.6.6-723" = _Qk8uaST1;
        "pkg-1.21.1-1.6.27-727" = _irr228G8;
        "pkg-1.21.11-1.6.6-728" = _3qf90Vp7;
        "pkg-1.21.11-1.6.6-737" = _uuBaHdFQ;
        "pkg-1.21.1-1.6.28" = _kNjGaBcX;
        "pkg-1.20.1-1.6.20" = _tSJtgf9a;
        "pkg-1.21.11-1.6.6-738" = _J9FJuMP7;
        "pkg-1.21.11-1.6.6-745" = _ICD9WkPz;
        "pkg-26.1.1-1.6.6-746" = _yK4jNg6b;
        "pkg-26.1.1-1.6.6-747" = _IYJ56Acm;
        "pkg-26.1.1-1.6.28" = _jfupxgPe;
        "pkg-26.1.1-1.6.28-752" = _rhKcVDba;
        "pkg-26.1.1-1.6.29" = _c21ONJvq;
        "pkg-26.1.1-1.6.29-760" = _6R2tee2R;
        "pkg-26.1.1-1.6.30" = _JBakF2Lj;
        "pkg-26.1.1-1.6.30-763" = _RKpi5R03;
        "pkg-26.1.1-1.6.30-764" = _PBwv6lsR;
        "pkg-26.1.1-1.6.31" = _hB0gwPsi;
        "pkg-26.1.1-1.6.31-769" = _38EU6SEU;
        "pkg-26.1.1-1.6.31-771" = _18Ejos0w;
        "pkg-26.1.1-1.6.31-773" = _ZoyBVSWG;
        "pkg-26.1.2-1.6.31" = _LLbZxwog;
        "pkg-26.1.2-1.6.31-776" = _WNVmTG96;
        "pkg-26.1.2-1.6.31-778" = _mv9mP34M;
        "pkg-1.21.1-1.7.0" = _hMWDjQq8;
        "pkg-26.1.2-1.7.0-784" = _bnTQTAvG;
        "pkg-26.1.2-1.7.0" = _Y71LWLpG;
        "pkg-26.1.2-1.7.0-785" = _gW1XsMNs;
        "pkg-26.2-1.7.0-786" = _ZBVEUBQt;
        "pkg-26.2-1.7.0-787" = _4azWqpLS;
        "pkg-26.2-1.7.0-788" = _eZPDpPMX;
        "pkg-1.21.11-1.6.6-790" = _ML5OjYR9;
        "pkg-26.1.2-1.7.0-792" = _BjU5crh7;
        "pkg-26.2-1.7.0-793" = _kQAfvYhi;
        "pkg-26.1.2-1.7.0-795" = _WBXX9B6m;
        "pkg-1.21.1-1.7.0-797" = _hMhFeg7E;
        "pkg-26.2-1.7.0-799" = _km5PZwLQ;
        "pkg-26.1.2-1.7.0-798" = _jqFBmeDb;
        ...
        "pkg-1.21.1-1.9.0-963" = _5sw9IAnr;
        "pkg-26.1.2-1.9.1-973" = _wgVaR2Xo;
        "pkg-1.21.1-1.9.0-978" = _oXfvBtb0;
        "pkg-26.1.2-1.9.1-981" = _7uzRNAe0;
        "pkg-1.21.1-1.9.0-988" = _vHpH27b4;
        "pkg-1.21.1-1.9.0-997" = _IeC9RHPa;
        "pkg-1.21.1-1.9.0-998" = _pPn5vlmc;
        "pkg-26.1.2-1.9.1-999" = _Ab9fIu7J;
        "pkg-26.1.2-1.9.1-1000" = _lJUDq2aL;
        "pkg-26.2-1.7.0-1001" = _xAn4UF0i;
