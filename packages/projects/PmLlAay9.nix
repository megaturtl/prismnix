...
let
    ...
    in {
        ...
        "pkg-neoforge-1.21.6-1.1.0" = _nYYDyoq2;
        "pkg-neoforge-1.21.4-1.1.0" = _eP0VQY6Q;
        "pkg-fabric-1.21.4-1.1.0" = _uBidqKHy;
        "pkg-forge-1.21.6-1.1.0" = _8qAq6STO;
        "pkg-forge-1.21.9-1.1.1" = _oBLiqi2g;
        "pkg-fabric-1.20.1-1.2.0" = _cYtKTPHi;
        "pkg-forge-1.20.1-1.2.0" = _YA16TExI;
        "pkg-1.6.0" = _qicKGtSJ;
        "pkg-1.7.0" = _CpgNNAaB;
        "pkg-1.7.1" = _fmHqpbkc;
        "pkg-1.7.2" = _bwvFN2ql;
        "pkg-1.8.0-beta.1" = _neqcqE9K;
        "pkg-1.3.0" = _MdMcHoRc;
        "pkg-1.8.0" = _k4C53gNe;
        "pkg-2.0.0" = _ot22Us2A;
        "pkg-1.2.1" = _23c7EDXF;
