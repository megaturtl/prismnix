...
let
    versions = (let
        ...
        _zgF7EnTQ = {
            "id" = "zgF7EnTQ";
            "file" = "BankAccounts-1.11.5.jar";
            "hash" = "sha512-rip9u6zyNazq19Ql5aE0Po+EwZBXnutZjLT0UXS3BT0TJXctFynRVZP2YFsdgiu4vLIMFXrhVgD0NpyHErXu2Q==";
        };
    in {
        "pmM1CEWB" = _pmM1CEWB;
        "vwFq30OR" = _vwFq30OR;
        ...
        "lEdgzoeU" = _lEdgzoeU;
        "zgF7EnTQ" = _zgF7EnTQ;
        "paper-1.20" = _zgF7EnTQ;
        "paper-1.20.1" = _zgF7EnTQ;
        "paper-1.20.2" = _zgF7EnTQ;
        "paper-1.20.3" = _zgF7EnTQ;
        "paper-1.20.4" = _zgF7EnTQ;
        "paper-1.20.5" = _zgF7EnTQ;
        "paper-1.20.6" = _zgF7EnTQ;
        "paper-1.21" = _zgF7EnTQ;
        "paper-1.21.1" = _zgF7EnTQ;
        "paper-1.21.2" = _zgF7EnTQ;
        "paper-1.21.3" = _zgF7EnTQ;
        "paper-1.21.4" = _zgF7EnTQ;
        "paper-1.21.5" = _zgF7EnTQ;
        "paper-1.21.6" = _zgF7EnTQ;
        "paper-1.21.7" = _zgF7EnTQ;
        "paper-1.21.8" = _zgF7EnTQ;
        "paper-1.21.9" = _zgF7EnTQ;
        "paper-1.21.10" = _zgF7EnTQ;
        "paper-1.21.11" = _zgF7EnTQ;
        "paper-26.1" = _zgF7EnTQ;
