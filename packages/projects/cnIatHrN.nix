...
let
    versions = (let
        ...
        _nQOUyX9T = {
            "id" = "nQOUyX9T";
            "file" = "universal_shops-1.16.0+26.3.jar";
            "hash" = "sha512-VhfJABGKs/3JvMY+/B2lTWwUgbXTOT7gESthwiVtjX8Dx7KLu5ldrnvzfeJe+zjs7Clj3vbDvWTmN2I0dB0WXw==";
        };
    in {
        "oLOqUyXY" = _oLOqUyXY;
        "qh0uYnnv" = _qh0uYnnv;
        ...
        "fabric-26.3-rc-1" = _nQOUyX9T;
        "fabric-26.3" = _nQOUyX9T;
        ...
        "pkg-1.0.0+1.19.2" = _oLOqUyXY;
        "pkg-1.0.1+1.19.2" = _qh0uYnnv;
        "pkg-1.1.0+1.19.3" = _HNtYqiwk;
        "pkg-1.1.1+1.19.3" = _spp0sxpv;
        "pkg-1.1.2+1.19.3" = _gLq5ifc6;
        "pkg-1.2.0+1.19.4" = _8QjF9W94;
        "pkg-1.0.2+1.19.2" = _OH2p5QAG;
        "pkg-1.3.0+1.20" = _NFhj22e7;
        "pkg-1.3.1+1.20" = _B7gJKlPd;
        "pkg-1.0.3+1.19.2" = _jZTxOBkJ;
        "pkg-1.3.2+1.20.1" = _OiADoEXn;
        "pkg-1.4.0+1.20.2" = _GuyJDEXQ;
        "pkg-1.5.0+1.20.3" = _1iw0f7sf;
        "pkg-1.6.0+1.20.5" = _Xeif0H6c;
        "pkg-1.7.0+1.21" = _qIZLODKH;
        "pkg-1.7.1+1.21" = _BfXSBkjs;
        "pkg-1.8.0+1.21.2" = _plysV9Kv;
        "pkg-1.8.1+1.21.2" = _9dKdD4Qc;
        "pkg-1.9.0+1.21.4" = _URt0BiPz;
        "pkg-1.10.0+1.21.5" = _qxiUc3h0;
        "pkg-1.10.1+1.21.5" = _PRVd37ep;
        "pkg-1.11.0+1.21.6" = _ghH5MF8V;
        "pkg-1.12.0+1.21.9" = _RPyWQqDJ;
        "pkg-1.13.0+1.21.11" = _M6PTvMlM;
        "pkg-1.14.0+26.1" = _7GUTevWM;
        "pkg-1.15.0+26.2" = _Tj8xg3qF;
        "pkg-1.15.1+26.2" = _5dVsASM6;
        "pkg-1.16.0+26.3" = _nQOUyX9T;
        "default" = _nQOUyX9T;
    });
