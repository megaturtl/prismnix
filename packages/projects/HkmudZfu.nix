...
let
    versions = (let
        ...
        _FY0FrWR6 = {
            "id" = "FY0FrWR6";
            "file" = "Boss Results 1.21(.1) v1.0.57.zip";
            "hash" = "sha512-98VPtU2u98vn4dYri3TAcgR1AzGvdxnLN5FINr0XC5oHiRBgi8p354j79eq5xeFJUj/6VeE0JTNs+KMfba0ZCA==";
        };
        _fM5tf0SN = {
            "id" = "fM5tf0SN";
            "file" = "boss-results-1.0.57.jar";
            "hash" = "sha512-iuaaA2TueTzCB/Ppb9kkG7cLVQq6aT/yLEfb2whZZdaiWqaJifTIQA7ePGy70GcHM+qu/UJHF50r30pSDGMnzg==";
        };
        _TH6fgGCR = {
            "id" = "TH6fgGCR";
            "file" = "Boss Results 1.21(.1) v1.0.58.zip";
            "hash" = "sha512-y0gpYQgYhilnc/ey8h6WPsPKD2GkrJENNnee7to7nmMlQemAi6jy3O+5IUxcISutKd8ffuj25hkZlY1VwRftpw==";
        };
        _Hns3rxDN = {
            "id" = "Hns3rxDN";
            "file" = "boss-results-1.0.58.jar";
            "hash" = "sha512-S5C83pS99K7cJSkUQ5yAZtOCkfFRNe+AUJB0+1vp8M51dFCFgyqN9HlHTecoRVxUvYuiHtau/f5c76AL+fGNaQ==";
        };
        _ac1Orc9n = {
            "id" = "ac1Orc9n";
            "file" = "Boss Results 1.21(.1) v1.0.59.zip";
            "hash" = "sha512-Y20s+CN72HAXwN1tb2DKZzxBjKC0tbr4h9YUp5urMTM6jTXnsrxn6wgazB242EMXAau60GbFBTIiQLUrFXEeZQ==";
        };
        _QEJ4JfNc = {
            "id" = "QEJ4JfNc";
    ...
    in {
        ...
        "pkg-1.0.1" = _vlWJctNZ;
        "pkg-1.0.1+mod" = _1RrVYmN2;
        "pkg-1.0.2" = _z8swDLlV;
        "pkg-1.0.2+mod" = _iDTXUTJv;
        "pkg-1.0.3" = _vfUU5cXn;
        "pkg-1.0.3+mod" = _7Gpp51js;
        "pkg-1.0.4" = _KhIpT0FB;
        "pkg-1.0.4+mod" = _8ldTLhX0;
        "pkg-1.0.5" = _LG7J2FoW;
        "pkg-1.0.5+mod" = _NLdaIvOs;
        "pkg-1.0.6" = _YnrC8Jee;
        "pkg-1.0.6+mod" = _Hvbzo2bY;
        "pkg-1.0.7" = _lK74hpaV;
        "pkg-1.0.7+mod" = _PLRjoRbs;
        "pkg-1.0.8" = _R2bbQsyd;
        "pkg-1.0.8+mod" = _aEDQpPSn;
        "pkg-1.0.9" = _lGCr9740;
        "pkg-1.0.9+mod" = _nbrpwFQU;
        "pkg-1.0.10" = _cEsSLXcs;
        "pkg-1.0.10+mod" = _lyKIV3iz;
        "pkg-1.0.11" = _4QqSHaDh;
        "pkg-1.0.11+mod" = _LtN9kBTM;
        "pkg-1.0.12" = _qFUpSgLr;
        "pkg-1.0.12+mod" = _TzjZ7LTM;
        "pkg-1.0.13" = _8uaABOvw;
        "pkg-1.0.13+mod" = _pWEBhALj;
        "pkg-1.0.14" = _dqZk0vO9;
        "pkg-1.0.14+mod" = _fjLrsjdb;
        "pkg-1.0.15" = _Jrj60ckI;
        "pkg-1.0.15+mod" = _4IpYDqWY;
        "pkg-1.0.16" = _5zq0zLAM;
        "pkg-1.0.16+mod" = _VqXPaoLJ;
        "pkg-1.0.17" = _meQzW4wQ;
        "pkg-1.0.17+mod" = _LbpxuyvV;
        "pkg-1.0.18" = _hhxqABI4;
        "pkg-1.0.18+mod" = _zssdwMyy;
        "pkg-1.0.19" = _QLWVb1KA;
        "pkg-1.0.19+mod" = _v2qpGWgr;
        "pkg-1.0.20" = _2DTGN5cb;
        "pkg-1.0.20+mod" = _bmQvCyhd;
        "pkg-1.0.21" = _jnjYnnTk;
        "pkg-1.0.21+mod" = _O5bL0uQU;
        "pkg-1.0.22" = _Al3olVew;
        "pkg-1.0.22+mod" = _CsRsauyz;
        "pkg-1.0.23" = _M3ScpUAO;
        "pkg-1.0.23+mod" = _MdaM6VfQ;
        "pkg-1.0.24" = _8rpkbGJe;
        "pkg-1.0.24+mod" = _LG5zqMC4;
        "pkg-1.0.25" = _nKDH9FIX;
        "pkg-1.0.25+mod" = _31HVZkbP;
        "pkg-1.0.26" = _7NqKCzms;
        "pkg-1.0.26+mod" = _llJHH7JE;
        "pkg-1.0.27" = _cqHQFnMC;
        "pkg-1.0.27+mod" = _LuZtM2RJ;
        "pkg-1.0.28" = _xfN9B1TC;
        "pkg-1.0.28+mod" = _39q2MMdx;
        "pkg-1.0.29" = _ocZnOijc;
        "pkg-1.0.29+mod" = _Lnk5ABZA;
        "pkg-1.0.30" = _FGa3hF1L;
        "pkg-1.0.30+mod" = _D3WeOcfb;
        "pkg-1.0.31" = _35MUeAxx;
        "pkg-1.0.31+mod" = _dUfxAPCV;
        "pkg-1.0.32" = _qk82mTBN;
        "pkg-1.0.32+mod" = _ojGsISKa;
        "pkg-1.0.33" = _nHUlAUqi;
        "pkg-1.0.33+mod" = _QuzUwYIp;
        "pkg-1.0.34" = _vLBi8LzE;
        "pkg-1.0.34+mod" = _wLEGMckF;
        "pkg-1.0.35" = _ife0PUvq;
        "pkg-1.0.35+mod" = _hCmq8NlE;
        "pkg-1.0.36" = _agFbd5uL;
        "pkg-1.0.36+mod" = _25clB1Oh;
        "pkg-1.0.37" = _GPz6wjWR;
        "pkg-1.0.37+mod" = _V1ogrHe4;
        "pkg-1.0.38" = _i1BXwBUR;
        "pkg-1.0.38+mod" = _mgEjRKMs;
        "pkg-1.0.39" = _kcDnmTiu;
        "pkg-1.0.39+mod" = _sWXtLlxZ;
        "pkg-1.0.40" = _u05jXqwq;
        "pkg-1.0.40+mod" = _j37jVNxo;
        "pkg-1.0.41" = _frhfwUCK;
        "pkg-1.0.41+mod" = _1ISZjTsE;
        "pkg-1.0.42" = _zYTCY6bt;
        "pkg-1.0.42+mod" = _3nlYsxLz;
        "pkg-1.0.43" = _Eb8N3iEw;
        "pkg-1.0.43+mod" = _vNweuRkK;
        "pkg-1.0.44" = _kioJDZ1F;
        "pkg-1.0.44+mod" = _2yX4szFe;
        "pkg-1.0.45" = _meCWRxYX;
        "pkg-1.0.45+mod" = _p6trRtEC;
        "pkg-1.0.46" = _Dp7msu3d;
        "pkg-1.0.46+mod" = _InpVqKJz;
        "pkg-1.0.47" = _zPXq8jfb;
        "pkg-1.0.47+mod" = _nUagkwbI;
        "pkg-1.0.48" = _j5Refvnd;
        "pkg-1.0.48+mod" = _Cg0kbq0M;
        "pkg-1.0.49" = _cZSKlELc;
        "pkg-1.0.49+mod" = _ke7A1LyS;
        "pkg-1.0.50" = _z4zqSPHv;
        "pkg-1.0.50+mod" = _cpWuPjNa;
        "pkg-1.0.51" = _RnewyQrk;
        "pkg-1.0.51+mod" = _lMq6bzY6;
        "pkg-1.0.52" = _GrgWbhTQ;
        "pkg-1.0.52+mod" = _yyKyScef;
        "pkg-1.0.53" = _RCUS2z45;
        "pkg-1.0.53+mod" = _ERrmpEAI;
        "pkg-1.0.54" = _TDdL3imS;
        "pkg-1.0.54+mod" = _Vv9VxnuJ;
        "pkg-1.0.55" = _u5ydAyI2;
        "pkg-1.0.55+mod" = _JgyYXu1E;
        "pkg-1.0.56" = _El0vH5pP;
        "pkg-1.0.56+mod" = _oVfddhOB;
        "pkg-1.0.57" = _FY0FrWR6;
        "pkg-1.0.57+mod" = _fM5tf0SN;
        "pkg-1.0.58" = _TH6fgGCR;
