...
let
    ...
    in {
        ...
        "pkg-1.0.3+MC1.19" = _yDJJUyDw;
        "pkg-1.0.5+MC1.19-1.19.1" = _ZCRN6nC7;
        "pkg-1.1.0-b1+MC1.19-1.19.1" = _bBJtOJKt;
        "pkg-1.1.1+MC1.19-1.19.2" = _LzBRwGpM;
        "pkg-1.1.2+MC1.19.4" = _Dbdlumrw;
        "pkg-1.1.3+MC1.20-1.20.1" = _HWKNuu9H;
        "pkg-1.1.4+MC1.20.2" = _xOoaY3Q3;
        "pkg-1.1.5+MC1.20.2-1.20.4" = _saHWfhgZ;
        "pkg-1.1.6+MC1.20" = _jd0cZhMx;
        "pkg-1.1.7+MC1.20.2-1.20.4" = _MajauwAR;
        "pkg-1.1.8+MC1.20.5-1.20.6" = _jsTDLRru;
        "pkg-1.2.0+MC1.21" = _6xxzeV2D;
        "pkg-1.2.1+MC1.21-1.21.1" = _ZH05thmy;
        "pkg-1.3.0+MC1.21.2-1.21.4" = _DDODfu4k;
        "pkg-1.3.1+MC1.21.2-1.21.5" = _Z2qYrMYc;
        "pkg-1.3.2+MC1.21.2-1.21.6" = _QlrMz2ZR;
        "pkg-1.3.3+MC1.21.2-1.21.7" = _EDsyLhNJ;
        "pkg-1.3.4+MC1.21.2-1.21.8" = _ry01Mb1F;
        "pkg-1.4.0+MC1.21.9-1.21.10" = _ePUjpFVH;
        "pkg-1.3.5+MC1.21.2-1.21.8" = _MS3TZWYp;
