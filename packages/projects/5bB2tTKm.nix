...
let
    versions = (let
        ...
        _uyMEQuZ2 = {
            "id" = "uyMEQuZ2";
            "file" = "MyFurniture-1.26.8.9.jar";
            "hash" = "sha512-g45X/WuDNDroxAEiAtlZMeHoythWHd/CUcdxfq4cKJVrGLmVhCxV2zRV1QdDc4kXKQy/ICMYPlxFTMWw56M/nQ==";
        };
        _RLMDhAkD = {
            "id" = "RLMDhAkD";
            "file" = "MyFurniture-1.26.8.10.jar";
            "hash" = "sha512-X/6x99RWrvcBP/nVra3Y3Kghz0eiKjsR5rImiEzd3p8dMTV8cN1kSNUwz4vKnY/zYR4zsL3DttXq8yBj/CTfpA==";
        };
        _ENpU1R0t = {
            "id" = "ENpU1R0t";
            "file" = "MyFurniture-1.26.8.30.jar";
            "hash" = "sha512-AMsgTE5K3gPSrWtbb+XVkQuus0Qavy3n/OXKA44tbbGwoVTwYNH4ji5N7DJcQBTyVkX0oV+xix5B6GQupO/smw==";
        };
        _9w8Es6Gb = {
            "id" = "9w8Es6Gb";
            "file" = "MyFurniture-1.26.9.1.jar";
            "hash" = "sha512-etGRhYBfYmPib3tdj/NmStZ0/ZV0lW+Ce1TxWND8VTL24ERSB3i3A+yboQdGCJiRrMuTeNYuUIl5ojeBM+eSRg==";
        };
        _i0eTlAQj = {
            "id" = "i0eTlAQj";
            "file" = "MyFurniture-1.26.9.6.jar";
            "hash" = "sha512-MMw1OZe09m4xT+l54DPpxqh4vz+BdsIUGQ0qJjtu8TQSUHE7bZDkrJcKbWCBszyw3fkHmCFoT4I4B/UD0U8D3w==";
        };
        _OUnRST0r = {
            "id" = "OUnRST0r";
            "file" = "MyFurniture-1.26.9.9.jar";
            "hash" = "sha512-2sBPfM8vnSw9u/xJnzhik/fzoHIW1us/c6qGRwAdvptjwBZNrmy12UuHPHi1b9HfgGdWEVBEau7LG7d6TnKSxg==";
        };
        _MUjyqfo0 = {
            "id" = "MUjyqfo0";
            "file" = "MyFurniture-1.26.9.13.jar";
            "hash" = "sha512-dmAlW40/ELS/Yv7SMuwaArY4HtxF8PUFx4iK8klpA+GMeDwk/2aRBZq/LXGSv3LdOhd4+HtFVdXXCxSP9bOETQ==";
        };
        _XD8aIZMo = {
            "id" = "XD8aIZMo";
            "file" = "MyFurniture-1.26.9.14.jar";
            "hash" = "sha512-9jh0IR9sBhxBPZ7yYdSxvBeyPlG3D2NTZS0EGTABE+RtZB3r4b5UQpfIjHARToZ6Ppn0QUoCH3I5OXhu/CACkg==";
        };
    in {
        "u7OE3fOA" = _u7OE3fOA;
        "VC8ucyI3" = _VC8ucyI3;
        ...
        "MUjyqfo0" = _MUjyqfo0;
        "XD8aIZMo" = _XD8aIZMo;
        "bukkit-1.21.4" = _XD8aIZMo;
        "bukkit-1.21.5" = _XD8aIZMo;
        "bukkit-1.21.6" = _XD8aIZMo;
        "bukkit-1.21.7" = _XD8aIZMo;
        "bukkit-1.21.8" = _XD8aIZMo;
        "bukkit-1.21.9" = _XD8aIZMo;
        "bukkit-1.21.10" = _XD8aIZMo;
        "bukkit-1.21.11" = _XD8aIZMo;
        "bukkit-26.1" = _XD8aIZMo;
        "bukkit-26.2" = _XD8aIZMo;
        "folia-1.21.4" = _XD8aIZMo;
        "folia-1.21.5" = _XD8aIZMo;
        "folia-1.21.6" = _XD8aIZMo;
        "folia-1.21.7" = _XD8aIZMo;
        "folia-1.21.8" = _XD8aIZMo;
        "folia-1.21.9" = _XD8aIZMo;
        "folia-1.21.10" = _XD8aIZMo;
        "folia-1.21.11" = _XD8aIZMo;
        "folia-26.1" = _XD8aIZMo;
        "folia-26.2" = _XD8aIZMo;
        "paper-1.21.4" = _XD8aIZMo;
        "paper-1.21.5" = _XD8aIZMo;
        "paper-1.21.6" = _XD8aIZMo;
        "paper-1.21.7" = _XD8aIZMo;
        "paper-1.21.8" = _XD8aIZMo;
        "paper-1.21.9" = _XD8aIZMo;
        "paper-1.21.10" = _XD8aIZMo;
        "paper-1.21.11" = _XD8aIZMo;
        "paper-26.1" = _XD8aIZMo;
        "paper-26.2" = _XD8aIZMo;
        "purpur-1.21.4" = _XD8aIZMo;
        "purpur-1.21.5" = _XD8aIZMo;
        "purpur-1.21.6" = _XD8aIZMo;
        "purpur-1.21.7" = _XD8aIZMo;
        "purpur-1.21.8" = _XD8aIZMo;
        "purpur-1.21.9" = _XD8aIZMo;
        "purpur-1.21.10" = _XD8aIZMo;
        "purpur-1.21.11" = _XD8aIZMo;
        "purpur-26.1" = _XD8aIZMo;
        "purpur-26.2" = _XD8aIZMo;
        "spigot-1.21.4" = _XD8aIZMo;
        "spigot-1.21.5" = _XD8aIZMo;
        "spigot-1.21.6" = _XD8aIZMo;
        "spigot-1.21.7" = _XD8aIZMo;
        "spigot-1.21.8" = _XD8aIZMo;
        "spigot-1.21.9" = _XD8aIZMo;
        "spigot-1.21.10" = _XD8aIZMo;
        "spigot-1.21.11" = _XD8aIZMo;
        "spigot-26.1" = _XD8aIZMo;
        "spigot-26.2" = _XD8aIZMo;
        ...
        "pkg-1.26.8.9" = _uyMEQuZ2;
        "pkg-1.26.8.10" = _RLMDhAkD;
        "pkg-1.26.8.30" = _ENpU1R0t;
        "pkg-1.26.9.1" = _9w8Es6Gb;
        "pkg-1.26.9.6" = _i0eTlAQj;
        "pkg-1.26.9.9" = _OUnRST0r;
        "pkg-1.26.9.13" = _MUjyqfo0;
        "pkg-1.26.9.14" = _XD8aIZMo;
        "default" = _XD8aIZMo;
    });
