...
let
    versions = (let
        ...
        _QtDQN2lZ = {
            "id" = "QtDQN2lZ";
            "file" = "fresh textures_s26-1.4-b1.zip";
            "hash" = "sha512-VAVumRwLlWS4KGPXQ6i5OoPgZ/pToslSTWC7I/3F2+jKfL64yX7RUKSi3WKTb5j5qkJlrnz5hNOQ+i69E7S3rw==";
        };
        _xzKCYswM = {
            "id" = "xzKCYswM";
            "file" = "fresh textures_s26-1.5-b1.zip";
            "hash" = "sha512-wMV+d82pjZxxVSfU22MeoRYIvaVkNzERs1HpfU0z25+WOs7AXWyNTEiloNmT0irkCa9YYhz9Low/m/l4yI0pWg==";
        };
        _dcILeC7h = {
            "id" = "dcILeC7h";
            "file" = "fresh textures s26-1.6-rc.zip";
            "hash" = "sha512-QtQLT5X1CwwJeNNejuIwg4m+FDUgAhY1cO+Y5S9A+OjD7kexVGGU7d6YP0W8YAjPeiPJS8IGwIIascbEVJ9+tQ==";
        };
        _Kv3MvJ5D = {
            "id" = "Kv3MvJ5D";
            "file" = "Fresh Textures v2.0.0.zip";
            "hash" = "sha512-0E0VfwIZ4EvDH0FLIDHPpx1kTvInSdYfJMWvlSdAbTttabKYIOvr0/X0ztTJ+CZQiC5S6EKpIHtaTmfdeLd51w==";
        };
    in {
        "PfSMAINd" = _PfSMAINd;
        "CuKSPEOX" = _CuKSPEOX;
        ...
        "dcILeC7h" = _dcILeC7h;
        "Kv3MvJ5D" = _Kv3MvJ5D;
        "minecraft-1.16" = _Kv3MvJ5D;
        "minecraft-1.16.1" = _Kv3MvJ5D;
        "minecraft-1.16.2" = _Kv3MvJ5D;
        "minecraft-1.16.3" = _Kv3MvJ5D;
        "minecraft-1.16.4" = _Kv3MvJ5D;
        "minecraft-1.16.5" = _Kv3MvJ5D;
        "minecraft-1.17" = _Kv3MvJ5D;
        "minecraft-1.17.1" = _Kv3MvJ5D;
        "minecraft-1.18" = _Kv3MvJ5D;
        "minecraft-1.18.1" = _Kv3MvJ5D;
        "minecraft-1.18.2" = _Kv3MvJ5D;
        "minecraft-1.19" = _Kv3MvJ5D;
        "minecraft-1.19.1" = _Kv3MvJ5D;
        "minecraft-1.19.2" = _Kv3MvJ5D;
        "minecraft-1.19.3" = _Kv3MvJ5D;
        "minecraft-1.19.4" = _Kv3MvJ5D;
        "minecraft-1.20" = _Kv3MvJ5D;
        "minecraft-1.20.1" = _Kv3MvJ5D;
        "minecraft-1.20.2" = _Kv3MvJ5D;
        "minecraft-1.20.3" = _Kv3MvJ5D;
        "minecraft-1.20.4" = _Kv3MvJ5D;
        "minecraft-1.21" = _Kv3MvJ5D;
        "minecraft-1.21.1" = _Kv3MvJ5D;
        "minecraft-1.21.2" = _Kv3MvJ5D;
        "minecraft-1.21.5" = _Kv3MvJ5D;
        "minecraft-1.21.6" = _Kv3MvJ5D;
        "minecraft-1.21.7" = _Kv3MvJ5D;
        "minecraft-1.21.8" = _Kv3MvJ5D;
        "minecraft-1.20.5" = _Kv3MvJ5D;
        "minecraft-1.20.6" = _Kv3MvJ5D;
        "minecraft-1.21.3" = _Kv3MvJ5D;
        "minecraft-1.21.4" = _Kv3MvJ5D;
        "minecraft-1.21.9" = _Kv3MvJ5D;
        "minecraft-1.21.10" = _Kv3MvJ5D;
        "minecraft-25w41a" = _Z60AEiVl;
        "minecraft-1.21.11" = _Kv3MvJ5D;
        ...
        "minecraft-26.1" = _Kv3MvJ5D;
        "minecraft-26.1.1" = _Kv3MvJ5D;
        "minecraft-26.1.2" = _Kv3MvJ5D;
        "minecraft-26.2" = _Kv3MvJ5D;
        "pkg-v1.2.6" = _PfSMAINd;
        "pkg-v1.2.6.1" = _CuKSPEOX;
        "pkg-v1.2.7" = _JR9JVcad;
        "pkg-v1.2.8" = _8uLjtoXR;
        "pkg-v1.2.9" = _8z2wqXng;
        "pkg-v1.2.9.1" = _OsWBKpZV;
        "pkg-v1.3.0" = _hCVuiGvR;
        "pkg-v1.3.1" = _DJTMU0cg;
        "pkg-v1.3.1.1" = _SqmUlhxn;
        "pkg-v1.3.2" = _OzDVkJWt;
        "pkg-v1.3.2.1" = _ToymPFu0;
        "pkg-v1.3.3" = _Z60AEiVl;
        "pkg-v1.3.3.1" = _dnx7V5iS;
        "pkg-v1.3.4" = _xedmYcgq;
        "pkg-v1.3.4.1" = _bYZgC0eb;
        "pkg-v1.3.4.1.1" = _1axyfBCE;
        "pkg-v1.3.5" = _T92H7jRs;
        "pkg-v1.3.6" = _G0YnKdRX;
        "pkg-v1.3.7" = _DISvzDfE;
        "pkg-v1.3.8" = _eVBLkYon;
        "pkg-v1.3.8.1" = _ACeIAbgu;
        "pkg-v1.3.9" = _8eqle8oB;
        "pkg-v1.3.9.1" = _r6gqFbXu;
        "pkg-v1.3.9.2" = _BNjlr1gn;
        "pkg-v1.3.9.3" = _UXAMXh4z;
        "pkg-v1.4.0" = _3WgP2dTx;
        "pkg-v1.4.0.1" = _Ut11YeSK;
        "pkg-1.4.1" = _HvQ9MCXT;
        "pkg-v1.4.1.1" = _UzM3rJDW;
        "pkg-v1.4.1.2" = _oAMKhGUv;
        "pkg-v1.4.2" = _ajmGw3y6;
        "pkg-1.4.3" = _9EnpT0pB;
        "pkg-1.4.4" = _6rMB3Raq;
        "pkg-v1.4.5" = _INLpgkws;
        "pkg-s26-1.0-b" = _mG8Dj6lq;
        "pkg-s26-1.1-b" = _XvZAk2Ps;
        "pkg-s26-1.2-b" = _GashcS0Q;
        "pkg-s26-1.3-b" = _7oqOW5UQ;
        "pkg-s26-1.4-b" = _QtDQN2lZ;
        "pkg-s26-1.5-b" = _xzKCYswM;
        "pkg-s26-1.6-rc" = _dcILeC7h;
        "pkg-v2.0.0" = _Kv3MvJ5D;
        "default" = _Kv3MvJ5D;
    });
