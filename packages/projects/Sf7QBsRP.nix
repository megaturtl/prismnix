...
let
    versions = (let
        ...
        _oRc2FVWm = {
            "id" = "oRc2FVWm";
            "file" = "peripheralworks-forge-1.20.1-1.9.0.jar";
            "hash" = "sha512-3eyO233o/LtbG9DXOABtt0tTlydOEhcAvgIR4oYIBJd0Vg1XOthHUIH6wouRCzYc/xgK1bVVgp/Ji2I6tOXeXA==";
        };
        _GEv8kwsj = {
            "id" = "GEv8kwsj";
            "file" = "peripheralworks-fabric-1.20.1-1.9.0.jar";
            "hash" = "sha512-VQbEEcTty2w+wDf+63bpbZxgOIu5I4+mL6Oo1NhpjGfoYqVhabULdL631/ZZ5oggNG6hLWkCupX/X9EvA3k+5Q==";
        };
        _rTlFyu0e = {
            "id" = "rTlFyu0e";
            "file" = "peripheralworks-forge-1.21.1-1.9.0.jar";
            "hash" = "sha512-5e8iUpzt5izFszDcxMmrH36FfnHjLQqJ/Q7GSKB/w+dGzBVttzYnEuaZB9s+Iz9GhblOunhdMtk6EUEBBlEGjQ==";
        };
        _cCNgJC26 = {
            "id" = "cCNgJC26";
            "file" = "peripheralworks-fabric-1.21.1-1.9.0.jar";
            "hash" = "sha512-fY0HCqWvqBfFVshW/ujQ3ufEC2RVuOWY0JN96nhz49yblLfsdXUnUFjMIJaUH6350wU3vfqJR35KRsiwJF5Qwg==";
        };
        _cgln0qbk = {
            "id" = "cgln0qbk";
            "file" = "peripheralworks-forge-1.20.1-1.9.1.jar";
            "hash" = "sha512-SsulexHnq8HHyUuMQCpqDyzUI8ph/bDkHiqw4ECo9diDOhLQWzDio6cZzo0rOK003qkRgDgi4NY9U0aqJrmK5w==";
        };
        _R3PnHJNi = {
            "id" = "R3PnHJNi";
            "file" = "peripheralworks-fabric-1.20.1-1.9.1.jar";
            "hash" = "sha512-d8FZHv3Xm8aBW1wJkAFaF8zLhGmoNieF0K3enQkIiEmzdsDM5iXSYPgIo8T1r4RyHV0Rx6S0vfWowMcH2DSDuA==";
        };
        _CjBe4q4V = {
            "id" = "CjBe4q4V";
            "file" = "peripheralworks-forge-1.21.1-1.9.1.jar";
            "hash" = "sha512-304XLIT55iv/eXatxqdefMM/PQBF3OXZeyXeSc322KEH3Zi05ahYx3MQUVdJuGt0Aa161iR7yUaorqmUah+3Nw==";
        };
        _EK4Xxsyv = {
            "id" = "EK4Xxsyv";
    ...
    in {
        ...
        "pkg-1.18.2-0.2.4" = _3YGqSRPG;
        "pkg-1.19.2-0.2.4" = _V9edC3sY;
        "pkg-1.19.4-0.3.0" = _giQ6w4hw;
        "pkg-1.19.4-0.4.0" = _9gGrZdYQ;
        "pkg-1.18.2-0.2.5" = _qnCp1WMN;
        "pkg-1.19.2-0.2.5" = _tMr2UdhC;
        "pkg-1.18.2-0.2.6" = _1QCUNNYy;
        "pkg-1.19.2-0.2.6" = _jKmfAVPT;
        "pkg-1.19.4-0.4.1" = _TGKrdRPs;
        "pkg-1.18.2-0.2.7" = _CR6xYXcL;
        "pkg-1.19.2-0.2.7" = _Iqrg5qyA;
        "pkg-1.19.4-0.4.2" = _fMbRWZcV;
        "pkg-1.18.2-0.2.8" = _g5eA4g8I;
        "pkg-1.19.2-0.2.8" = _PTBl1Ozk;
        "pkg-1.19.4-0.4.3" = _9nruKEhO;
        "pkg-1.20-0.5.1" = _MTY8Qp9f;
        "pkg-1.20.1-0.5.2" = _7WMZYQvj;
        "pkg-1.20.1-0.5.3" = _JryaT5pt;
        "pkg-1.20.1-1.0.0" = _qfSWXQ68;
        "pkg-1.20.1-1.1.0" = _knyqGJ2V;
        "pkg-1.20.1-1.1.1" = _oQDx0kbd;
        "pkg-1.20.1-1.2.0" = _cKy51r4p;
        "pkg-1.20.1-1.2.1" = _1lWJ2LrG;
        "pkg-1.18.2-0.2.9" = _EpugKdyM;
        "pkg-1.19.2-0.2.9" = _HnSb69GB;
        "pkg-1.20.1-1.2.2" = _MNDl2tdS;
        "pkg-1.20.1-1.3.0" = _jpfIre3S;
        "pkg-1.20.1-1.3.1" = _FN84xZg4;
        "pkg-1.20.1-1.3.2" = _VTenHOax;
        "pkg-1.20.1-1.3.3" = _DyUDWH4R;
        "pkg-1.19.2-0.2.10" = _OWaKcpXQ;
        "pkg-1.20.1-1.3.4" = _hA9bAblq;
        "pkg-1.20.1-1.4.0" = _1TODXPtd;
        "pkg-1.20.1-1.4.1" = _KVFK54Zh;
        "pkg-1.19.2-0.2.11" = _1qGfphAb;
        "pkg-1.19.2-0.2.12" = _SNNZeec7;
        "pkg-1.20.1-1.4.2" = _xCSOlH4l;
        "pkg-1.20.1-1.4.3" = _llME0vcm;
        "pkg-1.20.1-1.4.4" = _qBbn2uNR;
        "pkg-1.20.1-1.4.5" = _iKyKrwx1;
        "pkg-1.20.1-1.5.1" = _I9HU4uWg;
        "pkg-1.20.1-1.5.2" = _Ru9IEL5U;
        "pkg-1.20.1-1.5.3" = _ZV4kyku8;
        "pkg-1.20.1-1.5.4" = _myIlcCYs;
        "pkg-1.20.1-1.5.5" = _TTF4ZtMl;
        "pkg-1.20.1-1.5.7" = _psOmOl4q;
        "pkg-1.20.1-1.5.8" = _D5cJPuJQ;
        "pkg-1.20.1-1.5.9" = _Bft5R5WH;
        "pkg-1.20.1-1.5.11" = _NAKn57YZ;
        "pkg-1.20.1-1.5.12" = _56fYDZvg;
        "pkg-1.20.1-1.6.0" = _8IKwyEWI;
        "pkg-1.20.1-1.6.1" = _Ejj0192Q;
        "pkg-1.20.1-1.6.2" = _tGcMdLZg;
        "pkg-1.20.1-1.6.3" = _9C8ReF1Y;
        "pkg-1.20.1-1.6.4" = _HbEVOnqa;
        "pkg-1.20.1-1.6.5" = _gw31KDzj;
        "pkg-1.20.1-1.6.6" = _nykqpkFZ;
        "pkg-1.20.1-1.6.7" = _lwCIxRxT;
        "pkg-1.20.1-1.6.8" = _7iK9R5FB;
        "pkg-1.20.1-1.6.9" = _FqDgn4uc;
        "pkg-1.20.1-1.7.0" = _wRC7VRcK;
        "pkg-1.20.1-1.7.1" = _DhPTHP1M;
        "pkg-1.20.1-1.7.2" = _ooxiin05;
        "pkg-1.20.1-1.7.3" = _7HsSZ0xf;
        "pkg-1.20.1-1.7.4" = _BHN3ZMt4;
        "pkg-1.20.1-1.7.5" = _gfjx5mHk;
        "pkg-1.20.1-1.7.6" = _DVwbAtph;
        "pkg-1.20.1-1.7.7" = _w7mgFnCr;
        "pkg-1.20.1-1.7.8" = _8nBPJ2sk;
        "pkg-1.20.1-1.7.9" = _RgiAoAuJ;
        "pkg-1.20.1-1.7.10" = _TPQCOhq2;
        "pkg-1.20.1-1.7.11" = _gQxV6vhC;
        "pkg-1.20.1-1.7.12" = _I5wMXwLn;
        "pkg-1.20.1-1.7.13" = _kNA4PIYG;
        "pkg-1.20.1-1.7.14" = _Od5KXdVx;
