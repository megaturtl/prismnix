...
let
    ...
    in {
        ...
        "pkg-0.1.0+1.20.2" = _gJ6s0U3p;
        "pkg-0.2.0+1.20" = _eM5D6BNh;
        "pkg-0.2.0+1.20.2" = _LcV1fezp;
        "pkg-0.2.1+1.20.2" = _UrHacpS0;
        "pkg-0.2.1+1.20" = _SXHGJOav;
        "pkg-0.3.0+1.20.1" = _uIbJXm30;
        "pkg-0.3.0+1.20.2" = _8hDgmNaa;
        "pkg-0.4.0+1.20.2" = _APoATv8J;
        "pkg-0.4.0+1.20.1" = _KoieAsFw;
        "pkg-0.4.0+1.20.4" = _axpfcbM1;
        "pkg-0.5.0+1.20.2" = _On67J9gx;
        "pkg-0.5.0+1.20.1" = _5i96sTZN;
        "pkg-0.5.0+1.20.4" = _a3ovc6SR;
        "pkg-0.6.1+1.20.2" = _u0gPyoBt;
        "pkg-0.6.1+1.20.1" = _GsvNYoU5;
        "pkg-0.6.1+1.20.4" = _yQQRTwk5;
        "pkg-0.6.2+1.20.1" = _rsnEkgKq;
        "pkg-0.6.2+1.20.4" = _OYVXEqrK;
        "pkg-0.6.2+1.20.2" = _XDvJZDiM;
        "pkg-0.7.0+1.20.4" = _EXAj1XnJ;
        "pkg-0.7.0+1.20.2" = _fsnwR91d;
        "pkg-0.7.0+1.20.1" = _sKBpHx3X;
        "pkg-0.8.0+1.20.4" = _JmTJG8Tu;
        "pkg-0.8.0+1.20.1" = _OUbsXzqc;
        "pkg-0.8.1+1.20.1" = _NVQQ6baF;
        "pkg-0.8.1+1.20.4" = _aQm7OvvJ;
        "pkg-0.8.1+1.20.6" = _sq3z4bpu;
        "pkg-0.9.0+1.20.6" = _FVVoGJgq;
        "pkg-0.9.0+1.20.4" = _icGxtz1j;
        "pkg-0.9.0+1.20.1" = _njHRoLWF;
        "pkg-1.0.0+1.21" = _7sHf5jxH;
        "pkg-1.0.0+1.20.6" = _YFuNnxOy;
        "pkg-1.0.0+1.20.4" = _T0X33J16;
        "pkg-1.0.0+1.20.1" = _zzFKvQk1;
        "pkg-1.0.1+1.21" = _Mg6B68b5;
        "pkg-1.0.1+1.20.1" = _5MMDOc9T;
        "pkg-1.0.1+1.20.6" = _7FsT9weU;
        "pkg-1.0.1+1.20.4" = _QU8UlhwP;
        "pkg-1.1.0+1.20.1" = _IeoTZXLE;
        "pkg-1.1.0+1.20.4" = _JI8EboN9;
        "pkg-1.1.0+1.20.6" = _Y1cm2QLJ;
        "pkg-1.1.0+1.21" = _hqMF4nKp;
        "pkg-1.1.1+1.20.6" = _eWSEvLE1;
        "pkg-1.1.1+1.20.4" = _H71rdBlr;
        "pkg-1.1.1+1.20.1" = _61oYkv3i;
        "pkg-1.1.1+1.21" = _R3qJiNUc;
        "pkg-1.1.2+1.20.4" = _fZ8bIVXJ;
        "pkg-1.1.2+1.20.1" = _xBEdfyY1;
        "pkg-1.1.2+1.21" = _zAjBM59v;
        "pkg-1.1.2+1.20.6" = _iMRsBj43;
        "pkg-1.1.3+1.20.1" = _FpVYxiUS;
        "pkg-1.1.3+1.20.4" = _DKN2waxf;
        "pkg-1.1.3+1.20.6" = _lwGuPuSy;
        "pkg-1.1.3+1.21" = _BXYAMys0;
        "pkg-1.1.4+1.21" = _64VBVGOT;
        "pkg-1.1.4+1.20.4" = _os76U4Qw;
        "pkg-1.1.4+1.20.1" = _BNW5jbkR;
        "pkg-1.1.4+1.20.6" = _rQj2uFf8;
        "pkg-1.1.5+1.21" = _7d8Kwih2;
        "pkg-1.1.5+1.20.6" = _8Bdahw42;
        "pkg-1.1.5+1.20.4" = _ErhZKeu0;
        "pkg-1.1.5+1.20.1" = _ZvLhtpTK;
        "pkg-2.0.0+1.20.1-fabric" = _fFeYII9t;
        "pkg-2.0.0+1.21-neoforge" = _aEqiR1Tw;
        "pkg-2.0.0+1.21-fabric" = _pxpDUdHk;
        "pkg-2.0.1+1.20.1-forge" = _GPN3x4Bq;
        "pkg-2.0.1+1.21-neoforge" = _SI4PjFaC;
        "pkg-2.0.1+1.21-fabric" = _bUHaZ0eT;
        "pkg-2.0.1+1.20.1-fabric" = _gNvCBQnh;
        "pkg-2.0.2+1.20.1-forge" = _YkNpEZi2;
        "pkg-2.0.2+1.21-neoforge" = _kaHaaWXM;
        "pkg-2.0.2+1.21-fabric" = _xf7eoVlv;
        "pkg-2.0.2+1.20.1-fabric" = _A09SuFHD;
        "pkg-2.0.3+1.20.1-forge" = _WhLEujer;
        "pkg-2.0.3+1.21-neoforge" = _EyxqZp5J;
        "pkg-2.0.3+1.21-fabric" = _65zpfHmw;
        "pkg-2.0.3+1.20.1-fabric" = _Iy9aY6R3;
        "pkg-2.0.4+1.20.1-fabric" = _6qJN5w85;
        "pkg-2.0.4+1.21-fabric" = _fFhMi8yC;
        "pkg-2.0.4+1.21-neoforge" = _JI0kJLP3;
        "pkg-2.0.4+1.20.1-forge" = _fIGsYhRw;
        "pkg-2.1.0+1.20.1-forge" = _yHZHCGCx;
        "pkg-2.1.0+1.21-fabric" = _fdPTQsuM;
        "pkg-2.1.0+1.21-neoforge" = _3dMCfPQc;
        "pkg-2.1.0+1.20.1-fabric" = _7Wra4eBi;
        "pkg-2.2.0+1.20.1-fabric" = _GgnyeUEX;
        "pkg-2.2.0+1.21-fabric" = _U7xNYULr;
        "pkg-2.2.0+1.21-neoforge" = _ODhLWDdF;
        "pkg-2.2.0+1.20.1-forge" = _3gE7QEpw;
        "pkg-2.2.0+1.21.3-fabric" = _Uv9xernZ;
        "pkg-2.2.1+1.20.1-forge" = _6vE02T1J;
        "pkg-2.2.1+1.21.3-neoforge" = _4u1AIzUV;
        "pkg-2.2.1+1.21.3-fabric" = _CtNybgnw;
        "pkg-2.2.1+1.21-neoforge" = _97eDpCh2;
        "pkg-2.2.1+1.21-fabric" = _1madb5Gs;
        "pkg-2.2.1+1.20.1-fabric" = _EoAqSkiW;
        "pkg-2.3.0+1.21.3-fabric" = _1IJqIF5H;
        "pkg-2.3.0+1.21-neoforge" = _iLeZqm21;
        "pkg-2.3.0+1.21.4-fabric" = _JDnd6Bzf;
        "pkg-2.3.0+1.21.4-neoforge" = _Pkq00oHS;
        "pkg-2.3.0+1.21-fabric" = _1AvPOGQT;
        "pkg-2.3.0+1.21.3-neoforge" = _NZ2EGj1p;
        "pkg-2.3.1+1.21.4-fabric" = _I2ntSYrL;
        "pkg-2.3.1+1.21.3-neoforge" = _lhkNl5LC;
        "pkg-2.3.1+1.21-neoforge" = _kUx2CTzb;
        "pkg-2.3.1+1.21.3-fabric" = _DHApw2S0;
        "pkg-2.3.1+1.21-fabric" = _UrAlcMbc;
        "pkg-2.3.1+1.21.4-neoforge" = _qmieqGWv;
        "pkg-2.3.2+1.21.3-neoforge" = _JIWEUss1;
        "pkg-2.3.2+1.21-neoforge" = _mluSTufU;
        "pkg-2.3.2+1.21.4-neoforge" = _sn52bNO4;
        "pkg-2.3.2+1.21-fabric" = _mkLnP0Lq;
        "pkg-2.3.2+1.21.3-fabric" = _C3tPZS58;
        "pkg-2.3.2+1.21.4-fabric" = _ztnz9A4L;
        "pkg-2.4.0+1.21.4-neoforge" = _mZjQXWcK;
        "pkg-2.4.0+1.21.3-neoforge" = _u9Mia3QY;
        "pkg-2.4.0+1.21-neoforge" = _T9By9dqr;
        "pkg-2.4.1+1.21.3-neoforge" = _Jz9oYIBp;
        "pkg-2.4.1+1.21-neoforge" = _hsgnNXEo;
        "pkg-2.4.1+1.21.4-neoforge" = _8rUB2OFY;
        "pkg-2.4.2+1.21.4-neoforge" = _m41G13QF;
        "pkg-2.4.2+1.21-fabric" = _63T4RbF4;
        "pkg-2.4.2+1.21.3-neoforge" = _OOxML2Yx;
        "pkg-2.4.2+1.21.3-fabric" = _7DhQ1XUp;
        "pkg-2.4.2+1.21.4-fabric" = _1O0dPLaO;
        "pkg-2.4.2+1.21-neoforge" = _SDyZjrmi;
        "pkg-2.4.3+1.21.3-fabric" = _IyDD0dMi;
        "pkg-2.4.3+1.21.3-neoforge" = _R25DF8ZU;
        "pkg-2.4.3+1.21.4-fabric" = _MSUcOwdx;
        "pkg-2.4.3+1.21-neoforge" = _1ITVNFE9;
        "pkg-2.4.3+1.21.4-neoforge" = _oyMK1D4Y;
        "pkg-2.4.3+1.21-fabric" = _nHe3M4If;
        "pkg-2.4.4+1.21.3-fabric" = _1NnifljU;
        "pkg-2.4.4+1.21-neoforge" = _TIADJzEK;
        "pkg-2.4.4+1.21.4-neoforge" = _lJMfW4bh;
        "pkg-2.4.4+1.21.3-neoforge" = _jlKX62EF;
        "pkg-2.4.4+1.21-fabric" = _1xWqwfWj;
        "pkg-2.4.4+1.21.4-fabric" = _FeZbLJiO;
        "pkg-2.4.5+1.21.4-neoforge" = _o2VqSnWz;
        "pkg-2.4.5+1.21-fabric" = _imyS1dGO;
        "pkg-2.4.5+1.21-neoforge" = _KfcIFMqZ;
        "pkg-2.4.5+1.21.3-fabric" = _C7bMgcLm;
        "pkg-2.4.5+1.21.4-fabric" = _dpD9QFpb;
        "pkg-2.4.5+1.21.3-neoforge" = _hrKcnmhL;
        "pkg-2.4.6+1.21-fabric" = _N7ueNyET;
        "pkg-2.4.6+1.21-neoforge" = _56MPmiFE;
        "pkg-2.4.6+1.21.3-fabric" = _5kVo4Fsp;
        "pkg-2.4.6+1.21.3-neoforge" = _wnZlNZHB;
        "pkg-2.4.6+1.21.4-neoforge" = _SA4nmSxv;
        "pkg-2.4.6+1.21.4-fabric" = _F2JWp7vi;
        "pkg-2.4.7+1.21.3-neoforge" = _TEoxxxdn;
        "pkg-2.4.7+1.21-fabric" = _Rdb9fMck;
        "pkg-2.4.7+1.21.3-fabric" = _yEfIY1OD;
        "pkg-2.4.7+1.21-neoforge" = _ECWWbLjV;
        "pkg-2.4.7+1.21.4-neoforge" = _JwOQv0Za;
        "pkg-2.4.7+1.21.4-fabric" = _rxJp0K7n;
        "pkg-2.4.8+1.21-neoforge" = _URezSHpz;
        "pkg-2.4.8+1.21.4-neoforge" = _2CEJkTj2;
        "pkg-2.4.8+1.21-fabric" = _DPNQQVjx;
        "pkg-2.4.8+1.21.4-fabric" = _KSORNIBf;
        "pkg-2.4.8+1.21.3-fabric" = _aEENJLsd;
        "pkg-2.4.8+1.21.3-neoforge" = _QSjhkmYf;
        "pkg-2.4.9+1.21.4-fabric" = _LXWmLLgO;
        "pkg-2.4.9+1.21.3-neoforge" = _ijoN2X6e;
        "pkg-2.4.9+1.21-fabric" = _5lqqXdL9;
        "pkg-2.4.9+1.21-neoforge" = _ikr7d0Fe;
        "pkg-2.4.9+1.21.4-neoforge" = _TbpITboa;
        "pkg-2.4.9+1.21.5-fabric" = _zQ43kaic;
        "pkg-2.4.9+1.21.3-fabric" = _I7H4ev23;
        "pkg-2.4.9+1.21.5-neoforge" = _sR6HHvSs;
        "pkg-2.4.10+1.21.3-fabric" = _Uyrou2oW;
        "pkg-2.4.10+1.21-fabric" = _DyuoBhyh;
        "pkg-2.4.10+1.21-neoforge" = _Sm5l3Y6j;
        "pkg-2.4.10+1.21.4-fabric" = _vHBog9mt;
        "pkg-2.4.10+1.21.5-neoforge" = _uHtKRfwm;
        "pkg-2.4.10+1.21.5-fabric" = _DaNyYBGm;
        "pkg-2.4.10+1.21.4-neoforge" = _ZW0QJ7Yi;
        "pkg-2.4.10+1.21.3-neoforge" = _32u3PUCn;
        "pkg-2.4.11+1.21-neoforge" = _dbIWcJvs;
        "pkg-2.4.11+1.21.3-neoforge" = _fhALapYh;
        "pkg-2.4.11+1.21.4-neoforge" = _mA4vnAlc;
        "pkg-2.4.11+1.21.4-fabric" = _I4UiUTRG;
        "pkg-2.4.11+1.21-fabric" = _g1GXdXHw;
        "pkg-2.4.11+1.21.5-neoforge" = _8v73o8e2;
        "pkg-2.4.11+1.21.3-fabric" = _fjQ4433K;
        "pkg-2.4.11+1.21.5-fabric" = _hFzJ6Gwl;
        "pkg-2.4.12+1.21.5-fabric" = _CDT2YZT1;
        "pkg-2.4.12+1.21-neoforge" = _KZ4PpXuH;
        "pkg-2.4.12+1.21.4-fabric" = _nRBqYaBN;
        "pkg-2.4.12+1.21-fabric" = _rNmEtip7;
        "pkg-2.4.13+lts+1.21.1-fabric" = _vKwZpIQ3;
        "pkg-2.4.13+lts+1.21.1-neoforge" = _wTAIlkz8;
        "pkg-2.4.14+edge+1.21.8-fabric" = _oMM8XTPu;
        "pkg-2.4.14.1+edge+1.21.8-fabric" = _f1BWlbvB;
        "pkg-2.4.13.1+lts+1.21.1-neoforge" = _oGI3d87a;
        "pkg-2.4.13.1+lts+1.21.1-fabric" = _Q7K8sC4t;
        "pkg-2.4.15+edge+1.21.8-fabric" = _tfuEwYZ2;
        "pkg-2.4.14+lts+1.21.1-fabric" = _FKuZfNZW;
        "pkg-2.4.14+lts+1.21.1-neoforge" = _TFhnGx3b;
        "pkg-2.4.15+lts+1.21.1-neoforge" = _hyVWgYig;
        "pkg-2.4.15+lts+1.21.1-fabric" = _qybfyKev;
        "pkg-2.4.16+edge+1.21.8-fabric" = _A97vuGtI;
        "pkg-2.4.17+edge+1.21.9-fabric" = _sSjn02GQ;
        "pkg-2.4.18+edge+1.21.9-fabric" = _a6P7O9Rw;
        "pkg-2.4.16+lts+1.21.1-neoforge" = _SBX9ZlCK;
        "pkg-2.4.16+lts+1.21.1-fabric" = _J9695kxP;
        "pkg-2.4.19+edge+1.21.9-fabric" = _eS4NGsge;
        "pkg-2.4.17+lts+1.21.1-fabric" = _WSlysnhF;
        "pkg-2.4.17+lts+1.21.1-neoforge" = _TIlzr9Zf;
        "pkg-2.4.20+edge+1.21.9-fabric" = _HE60rITD;
        "pkg-2.4.18+lts+1.21.1-neoforge" = _IliWO68S;
        "pkg-2.4.18+lts+1.21.1-fabric" = _sISP7xdv;
        "pkg-2.4.19+lts+1.21.1-fabric" = _zMuvPsqX;
        "pkg-2.4.19+lts+1.21.1-neoforge" = _UkaOdOBt;
        "pkg-2.4.20+lts+1.21.1-fabric" = _y4nAstqZ;
        "pkg-2.4.20+lts+1.21.1-neoforge" = _svX1K2lk;
        "pkg-2.4.21+edge+1.21.11-fabric" = _mvIXISO5;
        "pkg-2.4.21+lts+1.21.1-neoforge" = _2xpUPoMI;
        "pkg-2.4.21+lts+1.21.1-fabric" = _FYdWqfGP;
        "pkg-2.4.22+lts+1.21.1-fabric" = _ZpG2rY0c;
        "pkg-2.4.22+lts+1.21.1-neoforge" = _kti7i9SG;
        "pkg-2.4.22+edge+1.21.11-fabric" = _Uqu52iU9;
        "pkg-2.4.23+1.21.11-fabric" = _wvhDSvYI;
        "pkg-2.4.24+26.1-fabric" = _7cqIYVLJ;
        "pkg-2.4.25+lts+26.1-neoforge" = _5K8Tax82;
        "pkg-2.4.25+lts+26.1-fabric" = _qlQ0yxKz;
        "pkg-2.5.0+lts+26.1-neoforge" = _z5WcXu53;
        "pkg-2.5.0+lts+26.1-fabric" = _2PDFUz2V;
        "pkg-2.5.0+edge+26.2-fabric" = _ksT9nLib;
