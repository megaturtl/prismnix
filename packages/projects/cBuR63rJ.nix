...
let
    ...
    in {
        ...
        "pkg-1.2+MC1.17-1.17.1" = _P3co19Te;
        "pkg-1.2.1+MC1.17-1.17.1" = _xQ4OiBHV;
        "pkg-1.2.2+MC1.18" = _qWgHBSkl;
        "pkg-1.2.3+MC1.18-1.18.1" = _ATrxihQH;
        "pkg-1.2.7+MC1.19" = _kcACwAJd;
        "pkg-1.2.8+MC1.19-1.19.1" = _wswY018T;
        "pkg-1.2.9+MC1.19-1.19.2" = _zOubdwcj;
        "pkg-1.2.10+MC1.19.4" = _Jm9ZLUKE;
        "pkg-1.2.11+MC1.20-1.20.1" = _XMV4O1AZ;
        "pkg-1.2.12+MC1.20.2" = _yvOA5VXE;
        "pkg-1.2.13+MC1.20.2-1.20.4" = _VIF6Stg1;
        "pkg-1.2.14+MC1.20.5-1.20.6" = _nrePasVE;
        "pkg-1.2.15+MC1.20.5-1.20.6" = _B2uYjhrc;
        "pkg-1.3.0+MC1.21" = _aUz49bwY;
        "pkg-1.3.1+MC1.21-1.21.1" = _SOM1HamL;
        "pkg-1.4.0+MC1.21.2-1.21.3" = _yuNCrSVk;
        "pkg-1.4.1+MC1.21.2-1.21.4" = _gfecmT0E;
        "pkg-1.5.0+MC1.21.5" = _RZtcoNk9;
        "pkg-1.6.0+MC1.21.6" = _r8vhGa1l;
        "pkg-1.6.1+MC1.21.6-1.21.7" = _jt8RDZ30;
        "pkg-1.6.2+MC1.21.6-1.21.8" = _2K1Ji7u5;
        "pkg-1.6.3+MC1.21.6-1.21.8" = _ScdPFOSz;
        "pkg-1.6.4+MC1.21.6-1.21.8" = _qiADaGfF;
        "pkg-1.7.0+MC1.21.10" = _A0UQZmVE;
        "pkg-1.6.5+MC1.21.6-1.21.8" = _eLdzGLH0;
        "pkg-1.7.1+MC1.21.10" = _8rGgbgJQ;
        "pkg-1.8.0+MC1.21.11" = _wnHpQSPT;
        "pkg-1.2.16+MC1.20.1" = _2LncXqzd;
        "pkg-1.2.17+MC1.20.2-1.20.4" = _FYfLrpDq;
