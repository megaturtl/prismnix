...
let
    versions = (let
        ...
        _jAHQFrry = {
            "id" = "jAHQFrry";
            "file" = "async-pack-scan-26.3.0.jar";
            "hash" = "sha512-py2AJtgu8A6jhug4pG8s70WPVK7NckoNGZRDFlPb0OYqyuu1BpW4ZLZr8G2hPTLiDMkrhsI52Vc/oc/fBhYyxw==";
        };
    in {
        "OGoQkYgS" = _OGoQkYgS;
        "5gyQErFL" = _5gyQErFL;
        ...
        "pkg-0.2.8" = _9VQfWBHJ;
        "pkg-0.2.9" = _EkmsPbRu;
        "pkg-0.2.10" = _t9CGUrUk;
        "pkg-0.2.11" = _33wOrApx;
        "pkg-0.2.12" = _MWbUOZLF;
        "pkg-0.2.13" = _tdB6CxTI;
        "pkg-0.2.14" = _R6p1bIrr;
        "pkg-26.1.0" = _JNGWUcCN;
        "pkg-26.2.0" = _pwqjgJdV;
        "pkg-26.2.1" = _tU2mpH7W;
        "pkg-26.3.0" = _jAHQFrry;
        "default" = _jAHQFrry;
    });
