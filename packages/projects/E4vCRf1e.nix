...
let
    versions = (let
        ...
        _VjgVnjOT = {
            "id" = "VjgVnjOT";
            "file" = "DinoBriks Rum - DP V 2.2.zip";
            "hash" = "sha512-Mf01xRkIqtPbvCpiz+3/mP8x1ATZbaSVi6cGLp6DR4GH5ypsNA2/jvmYJSsCz66sPOEkhECQ6Hon3A0bwdy9gA==";
        };
        _URAa7vCz = {
            "id" = "URAa7vCz";
    ...
    in {
        ...
        "pkg-2.0.2" = _yrAj3kQo;
        "pkg-2.0.4" = _y0C25752;
        "pkg-2.0.4+mod" = _UF3kKS0o;
        "pkg-2.0.5" = _akNuuH6U;
        "pkg-2.0.5+mod" = _1ypkFsUd;
        "pkg-2.0.6" = _kINKcqn2;
        "pkg-2.0.7" = _h4j1Su3O;
        "pkg-2.0.8" = _jbm1bcpE;
        "pkg-2.0.9" = _IE6ks2I5;
        "pkg-2.1" = _EjCNSJqp;
        "pkg-2.1+mod" = _8qgF6z04;
        "pkg-2.1.1.1" = _tNuPaPfI;
