...
let
    ...
    in {
        ...
        "pkg-26.1" = _I6FeNK8T;
        "pkg-26.1+mod" = _1ihouqt7;
        "pkg-41.1" = _aSPkfsMV;
        "pkg-41.1+mod" = _fJbcvuPC;
        "pkg-48.1" = _JEhrPvrk;
        "pkg-48.1+mod" = _6uI5erZE;
        "pkg-57.1" = _uSpj1V34;
        "pkg-57.1+mod" = _ov11foCa;
        "pkg-61.1" = _GPjFISGg;
        "pkg-61.1+mod" = _UM0HczTe;
        "pkg-71.1" = _vNNPCZeY;
        "pkg-71.1+mod" = _MS3K59GI;
        "pkg-80" = _ZBNOVA8S;
        "pkg-80+mod" = _PdrXGEoe;
        "pkg-81" = _6nN5C3hD;
        "pkg-81+mod" = _4ARsbcvO;
        "pkg-88.0" = _q4ICejxT;
        "pkg-88.0+mod" = _BG4QRqbf;
        "pkg-94.1" = _erkUkohT;
        "pkg-94.1+mod" = _pljpgmli;
        "pkg-101.1" = _yhLcGyBK;
