...
let
    ...
    in {
        ...
        "pkg-1.1.1" = _NbrzRT5o;
        "pkg-1.2.0" = _MIA8Np3y;
        "pkg-1.3.0+1.5.2" = _D2yMTuyj;
        "pkg-1.3.0+1.6.0" = _6hqbntui;
        "pkg-1.3.0+1.6.1" = _mZnUk4Xf;
        "pkg-1.4.0+1.5.2" = _eOwCrV4C;
        "pkg-1.4.0+1.6.1" = _A4AklQQc;
        "pkg-1.5.0+1.5.2" = _SnPqXXOU;
        "pkg-1.5.0+1.6.1" = _POaY9vrT;
        "pkg-1.5.1+1.5.2" = _NrpRmdyL;
        "pkg-1.5.1+1.6.1" = _2y6TA6WE;
        "pkg-1.5.2+1.5.2" = _sfpzbJ3q;
        "pkg-1.5.2+1.6.1" = _cosb3SW5;
        "pkg-1.5.2+1.7.0" = _Fc4JToWf;
        "pkg-1.5.2+1.7.1" = _24OF1GGY;
        "pkg-1.6.0+1.5.2" = _nHaVpDE4;
        "pkg-1.6.0+1.7.1" = _9N36IfVR;
