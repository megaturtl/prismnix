...
let
    versions = (let
        ...
        _R7JzMeg1 = {
            "id" = "R7JzMeg1";
            "file" = "cursors_extended-fabric-4.2.0-alpha.2+26.3.jar";
            "hash" = "sha512-pOsFLy+4MaI+lYQ5svYgg+Z1Onk7tMUQwuroE+NDGhr9FPsEuOLonx69/yU+03/P5ocqqQR+7vpREyGnrq7mqg==";
        };
        _FppGE7pV = {
            "id" = "FppGE7pV";
    ...
    in {
        ...
        "fabric-26.3-snapshot-4" = _FppGE7pV;
        "fabric-26.3-snapshot-5" = _FppGE7pV;
        "fabric-26.3-snapshot-6" = _FppGE7pV;
        "fabric-26.3-snapshot-7" = _FppGE7pV;
        "fabric-26.3-snapshot-8" = _FppGE7pV;
        ...
        "pkg-1.0.0" = _qn0ZA9bw;
        "pkg-2.0.0-alpha" = _YRMGYIkD;
        "pkg-2.1.0+1.21.2-1.21.4" = _Eh7GEBKb;
        "pkg-2.1.1+1.21.2-1.21.4" = _z1StRVgZ;
        "pkg-2.1.1b+1.21.2-1.21.4" = _2XVqAXND;
        "pkg-2.2.0+1.21.2+" = _fsfUf3LR;
        "pkg-2.2.0+1.21-1.21.1" = _dttw0MVv;
        "pkg-2.3.0+1.21.4" = _iwdhXRAh;
        "pkg-2.3.0+1.21.2-1.21.3" = _en0ckuHd;
        "pkg-2.3.0+1.21-1.21.1" = _hxCAv1KT;
        "pkg-2.4.0+1.21.4" = _aue8Ia0U;
        "pkg-2.4.0+1.21-1.21.1" = _Z08palMR;
        "pkg-2.4.0+1.21.2-1.21.3" = _IQGN1ATE;
        "pkg-2.4.1+1.21.4" = _JZQXNAIk;
        "pkg-2.4.1+1.21-1.21.1" = _xICtCRaG;
        "pkg-2.4.1+1.21.2-1.21.3" = _JJdtrdOR;
        "pkg-2.4.2+1.21.4" = _VDfqBuq3;
        "pkg-2.4.2+1.21-1.21.1" = _cBidfsNM;
        "pkg-2.4.2+1.21.2-1.21.3" = _pIaEVFKP;
        "pkg-2.4.3+1.21.4" = _bvsgrZR5;
        "pkg-2.4.3+1.21.2-1.21.3" = _2sTPfEAn;
        "pkg-2.4.3+1.21-1.21.1" = _oHu3EBG2;
        "pkg-2.4.3+1.20.1" = _t992q7KW;
        "pkg-3.0.0+1.21.4" = _aDQ5uKRa;
        "pkg-3.0.0+1.20.1" = _JJkDkZ6f;
        "pkg-3.0.0+1.21-1.21.1" = _O7Kun8Vn;
        "pkg-3.0.0+1.21.2-1.21.3" = _ots4w9rt;
        "pkg-3.1.0+1.20.1" = _nZNZ9WF0;
        "pkg-3.1.0+1.21-1.21.1" = _m2sp5r7T;
        "pkg-3.1.0+1.21.2-1.21.3" = _XzYpfrb7;
        "pkg-3.1.0+1.21.4" = _XGfcdRmh;
        "pkg-3.1.1+1.21.4" = _HXSf6i3y;
        "pkg-3.1.1+1.20.1" = _yDBjsb0h;
        "pkg-3.1.1+1.21-1.21.1" = _3aMUsZgP;
        "pkg-3.1.1+1.21.2-1.21.3" = _g29yXiBF;
        "pkg-3.2.0-beta.1+1.21.4" = _U6QWSJFS;
        "pkg-3.2.0-beta.1+1.20.1" = _bE4OP5EY;
        "pkg-3.2.0-beta.1+1.21-1.21.1" = _D0bQaTam;
        "pkg-3.2.0-beta.1+1.21.2-1.21.3" = _7vKKZv3H;
        "pkg-3.3.0+1.21.4" = _xrGUJueW;
        "pkg-3.3.0+1.20.1" = _Xfs4TYyM;
        "pkg-3.3.0+1.21.2-1.21.3" = _dKSyv5KT;
        "pkg-3.3.0+1.21-1.21.1" = _if4tORGi;
        "pkg-3.4.0+1.21.4" = _pSeDNOAn;
        "pkg-3.4.0+1.20.1" = _ArDGex9X;
        "pkg-3.4.0+1.21.2-1.21.3" = _YjhBXLXT;
        "pkg-3.4.0+1.21-1.21.1" = _aDHRR8NR;
        "pkg-3.4.1+1.21.4" = _wrWrVa3e;
        "pkg-3.4.1+1.21-1.21.1" = _u0elokkV;
        "pkg-3.4.1+1.21.2-1.21.3" = _IWtmosM8;
        "pkg-3.4.1+1.20.1" = _WOM4Fe6p;
        "pkg-3.5.0+1.20.1" = _N9Eu7HMK;
        "pkg-3.5.0+1.21-1.21.1" = _11l7wuhD;
        "pkg-3.5.0+1.21.2-1.21.3" = _onsqf9lz;
        "pkg-3.5.0+1.21.4" = _ii8ipTsa;
        "pkg-3.5.1+1.20.1" = _PJ9FnFae;
        "pkg-3.5.1+1.21-1.21.1" = _Vkzd4zW0;
        "pkg-3.5.1+1.21.2-1.21.3" = _EKft0iZP;
        "pkg-3.5.1+1.21.4" = _agWv7HLx;
        "pkg-3.6.0+1.20.1" = _szGGgDY8;
        "pkg-3.6.0+1.21.1" = _fcbnUdvc;
        "pkg-3.6.0+1.21.2" = _5g6zNaMa;
        "pkg-3.6.0+1.21.4" = _eHzVXPUr;
        "pkg-3.6.0+1.20.1-fix.1" = _mJULRZlh;
        "pkg-3.6.1+1.20.1" = _lGbMIcVE;
        "pkg-3.6.1+1.21.1" = _pqqEZCqM;
        "pkg-3.6.1+1.21.2" = _1ah6hQND;
        "pkg-3.6.1+1.21.4" = _SZqlHXNk;
        "pkg-3.6.2+1.20.1" = _kQLpIVAa;
        "pkg-3.6.2+1.21.1" = _BllPjWka;
        "pkg-3.6.2+1.21.2" = _j7kSzVTn;
        "pkg-3.6.2+1.21.4" = _CryyQ15I;
        "pkg-3.6.3+1.20.1" = _vprFW7pF;
        "pkg-3.6.3+1.21.1" = _Eue9anKl;
        "pkg-3.6.3+1.21.2" = _HuQYeIMR;
        "pkg-3.6.3+1.21.4" = _8mZEARLI;
        "pkg-3.6.4+1.20.1" = _p4XyJdBD;
        "pkg-3.6.4+1.21.1" = _a34DL7rE;
        "pkg-3.6.4+1.21.2" = _YSzetwBV;
        "pkg-3.6.4+1.21.4" = _a5YxK0Mt;
        "pkg-3.6.5+1.20.1" = _MQ3BYAXi;
        "pkg-3.6.5+1.21.1" = _eKrJFH8u;
        "pkg-3.6.5+1.21.2" = _ZznfZxyq;
        "pkg-3.6.5+1.21.4" = _ioW8YNiL;
        "pkg-3.6.6+1.20.1" = _CcDbE9t8;
        "pkg-3.6.6+1.21.1" = _GF5BMXTI;
        "pkg-3.6.6+1.21.2" = _5bf6E4F7;
        "pkg-3.6.6+1.21.4" = _FB3gsNSR;
        "pkg-3.6.7+1.20.1" = _tPumgnTb;
        "pkg-3.6.7+1.21.1" = _XzfFtgLJ;
        "pkg-3.6.7+1.21.2" = _kTW3IDNX;
        "pkg-3.6.7+1.21.4" = _ZgBGHn0d;
        "pkg-3.7.0+1.20.1" = _igpeK4AE;
        "pkg-3.7.0+1.21.1" = _kXjkMcod;
        "pkg-3.7.0+1.21.2" = _vQyiDLDx;
        "pkg-3.7.0+1.21.4" = _gXW2o6yH;
        "pkg-3.7.1+1.20.1" = _E2cVvf9g;
        "pkg-3.7.1+1.21.1" = _ww5jnCk7;
        "pkg-3.7.1+1.21.2" = _sfgTLzZq;
        "pkg-3.7.1+1.21.4" = _pUIhKNxx;
        "pkg-3.8.0+1.20.1" = _18WTjPi7;
        "pkg-3.8.0+1.21.1" = _KSd3hqqd;
        "pkg-3.8.0+1.21.2" = _vu361CT1;
        "pkg-3.8.0+1.21.4" = _luYXbjG9;
        "pkg-3.9.0+1.20.1" = _ApMEzrnv;
        "pkg-3.9.0+1.21.1" = _62Pt3OLB;
        "pkg-3.9.0+1.21.2" = _VhPaS1cD;
        "pkg-3.9.0+1.21.4" = _iJ768smD;
        "pkg-3.9.1+1.20.1" = _aNBmEoi1;
        "pkg-3.9.1+1.21.1" = _z5NNMsqn;
        "pkg-3.9.1+1.21.2" = _ken1vkLE;
        "pkg-3.9.1+1.21.4" = _m6PKCUFx;
        "pkg-3.9.1+1.21.6" = _u3o7gWwW;
        "pkg-3.9.2+1.20.1" = _fNMBX9xH;
        "pkg-3.9.2+1.21.1" = _fTuLAX4u;
        "pkg-3.9.2+1.21.2" = _8aePZHZf;
        "pkg-3.9.2+1.21.4" = _Bisaqmvz;
        "pkg-3.9.2+1.21.6" = _Ny2AAgGQ;
        "pkg-3.9.2+1.20.1-forge.1" = _PGeHyeqF;
        "pkg-3.9.2+1.20.1-forge.2" = _pomwnQ86;
        "pkg-3.9.2+1.21.1-nf.1" = _sdYGVmEY;
        "pkg-3.10.0+1.20.1" = _bmBVgTPz;
        "pkg-3.10.0+1.21.1" = _jJ1TSliV;
        "pkg-3.10.0+1.21.2" = _BcV1HC2A;
        "pkg-3.10.0+1.21.4" = _NDsSH8zY;
        "pkg-3.10.0+1.21.6" = _67D91zdC;
        "pkg-4.0.0-alpha.1+1.21.9" = _HS655lOp;
        "pkg-4.0.0-alpha.2+1.21.9" = _9CLpbggc;
        "pkg-4.0.0-beta.1+1.21.9" = _3VnYWCkk;
        "pkg-4.0.0+1.21.9" = _lOK2EPr7;
        "pkg-4.0.1+1.21.9" = _IGqPBpVf;
        "pkg-4.0.2+1.21.9" = _F3MkMT55;
        "pkg-3.11.0+1.20.1" = _1amZQcCC;
        "pkg-3.11.0+1.21.1" = _TzRE4pxw;
        "pkg-3.11.0+1.21.2" = _D1VLamV5;
        "pkg-3.11.0+1.21.4" = _csEtDOpy;
        "pkg-3.11.0+1.21.6" = _9MY8mqGO;
        "pkg-4.0.3+1.21.9" = _gAk12kFz;
        "pkg-3.11.1+1.20.1" = _OeXn9qfN;
        "pkg-3.11.1+1.21.1" = _8Wnbpoyg;
        "pkg-3.11.1+1.21.2" = _lKTFwIwI;
        "pkg-3.11.1+1.21.4" = _3NMH94YC;
        "pkg-3.11.1+1.21.6" = _UmBwp8i2;
        "pkg-4.0.4+1.21.9" = _GE1RD6lc;
        "pkg-4.0.5+1.21.9" = _yXfi6KnE;
        "pkg-4.1.0+1.21.9" = _PBVJUP04;
        "pkg-4.1.1+1.21.9" = _Nqk7KkDK;
        "pkg-4.1.2+1.21.9" = _APjCTdTg;
        "pkg-3.11.2+1.20.1" = _kyHDde0l;
        "pkg-3.11.2+1.21.1" = _jCjQWU8Y;
        "pkg-3.11.2+1.21.2" = _VlHO3Ow3;
        "pkg-3.11.2+1.21.4" = _V26RCLnT;
        "pkg-3.11.2+1.21.6" = _l5iiJMaw;
        "pkg-4.1.3+1.21.9" = _WLU5xeXx;
        "pkg-4.1.4+1.21.9" = _YAdqIKU5;
        "pkg-3.11.2+1.20.1-patch.1" = _dnSZFfcF;
        "pkg-3.11.2+1.21.1-patch.1" = _ZF75Hbd0;
        "pkg-3.11.2+1.21.2-patch.1" = _ZKn6cBeK;
        "pkg-4.1.4+1.21.11" = _VVRPV2HD;
        "pkg-4.1.4+1.21.11-patch.1" = _q3U4pZIm;
        "pkg-4.1.5+1.21.9" = _GbfLOy4C;
        "pkg-4.1.5+1.21.11" = _qAGkL02T;
        "pkg-4.1.6+26.1" = _uIMwOyDw;
        "pkg-3.11.3+1.20.1" = _91MD86Br;
        "pkg-3.11.3+1.21.1" = _F7TTv9rc;
        "pkg-3.11.3+1.21.6" = _oSX2TVXC;
        "pkg-4.1.7+26.2" = _QiulgNAP;
