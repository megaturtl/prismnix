...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.0.0" = _Pw51TqNY;
        "pkg-1.21.1-1.0.0" = _8b0yjqGK;
        "pkg-1.21.1-1.1.0" = _yROeenq6;
        "pkg-1.21.1-1.1.5" = _GoEdg7rr;
        "pkg-1.20.1-1.2.5" = _B8xAKwWN;
        "pkg-1.21.1-1.2.0" = _dtGVSlrl;
        "pkg-1.21.1-1.2.1" = _i8ALZcYl;
