...
let
    ...
    in {
        ...
        "pkg-0.100.0" = _EPxLuYBo;
        "pkg-0.100.1" = _TquNjwIq;
        "pkg-0.2.1" = _5Hn9OAGz;
        "pkg-0.2.2" = _eXkHdPzF;
        "pkg-0.100.2" = _QR6ickd3;
        "pkg-0.101.0" = _2vUVix1u;
        "pkg-0.101.1" = _eMvTt0rR;
        "pkg-0.102.0" = _FkicekOh;
        "pkg-0.103.0" = _MpYDiftC;
        "pkg-0.104.0" = _zkPUDY2D;
        "pkg-0.105.0" = _ZuCKowDW;
        "pkg-0.105.1" = _NK0lMwIv;
        "pkg-0.105.2" = _nWx0sBrZ;
        "pkg-0.105.3" = _S4QVK1K7;
        "pkg-0.106.0" = _xNCDpX45;
        "pkg-0.107.0" = _bXl4svd9;
        "pkg-0.107.1" = _lIVeU4W4;
        "pkg-0.107.2" = _NyKiODUI;
        "pkg-0.108.0" = _8xo9khKu;
        "pkg-0.108.1+Quilt" = _9t04yQSI;
        "pkg-0.109.0+Quilt" = _rcHDWNRQ;
        "pkg-0.109.1+Quilt" = _krXopScF;
        "pkg-0.109.2+Quilt" = _SfIylJNc;
        "pkg-0.110.0+Quilt" = _Sba141xC;
        "pkg-0.110.1+Quilt" = _TTob6U8S;
        "pkg-0.110.2+Quilt" = _CMWjFbgl;
        "pkg-0.111.0+Fabric" = _XSphhakM;
        "pkg-0.111.1+Fabric" = _LXXbJlum;
        "pkg-0.111.2+Fabric" = _dXmywO9X;
        "pkg-0.111.3+Fabric" = _mYUwIO8p;
        "pkg-0.111.4+Fabric" = _ZKH68IXw;
        "pkg-0.111.5+Fabric" = _8dSah7OS;
        "pkg-0.112.0+Fabric" = _SDpAsq3f;
        "pkg-0.112.1+Fabric" = _hK4I6c4w;
        "pkg-0.112.2+Fabric" = _PIcozaUG;
        "pkg-0.112.3+Fabric" = _1eYzr4Th;
        "pkg-0.112.4+Fabric" = _n55KoGpb;
        "pkg-0.112.5+Fabric" = _1GZofGzh;
        "pkg-0.112.6+Fabric" = _ZBnevgDe;
        "pkg-0.112.7+Fabric" = _O6EWTjve;
        "pkg-0.112.8+Fabric" = _1kSuGqka;
