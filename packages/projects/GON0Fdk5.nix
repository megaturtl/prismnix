...
let
    ...
    in {
        ...
        "kb7gspsV" = _kb7gspsV;
        "50QJE3mk" = _50QJE3mk;
        "quilt-1.20.2" = _wDOvRU6M;
        "quilt-1.20.3" = _TbYthnjE;
        "quilt-1.20.4" = _TbYthnjE;
        "quilt-1.20.5" = _nDLeq9O4;
        "quilt-1.20.6" = _nDLeq9O4;
        "quilt-1.21" = _mhVeZtES;
        ...
        "quilt-1.21.1" = _mhVeZtES;
        "quilt-1.14.4" = _OlOLzYq0;
        "quilt-1.21.3" = _XgijIz9H;
        "quilt-1.21.4" = _vZUmpotg;
        "quilt-1.21.5-rc2" = _PsXuyISP;
        "quilt-1.21.5" = _t8utiyok;
        "quilt-1.21.6" = _OUwRnohk;
        "quilt-1.21.7" = _OUwRnohk;
        "quilt-1.21.8" = _OUwRnohk;
        "quilt-1.20" = _MoSkKVRg;
        "quilt-1.21.2" = _XgijIz9H;
        "quilt-1.21.9" = _3zUtVXqx;
        "quilt-1.21.10" = _3zUtVXqx;
        "quilt-1.21.11" = _xc2R6HWb;
        "quilt-26.1" = _2vxRYpOE;
        "quilt-26.1.1" = _2vxRYpOE;
        "quilt-26.1.2" = _2vxRYpOE;
        "quilt-26.2" = _kb7gspsV;
        ...
        "fabric-1.20.4" = _TbYthnjE;
        "fabric-1.19.4" = _XkA0ViPT;
        "fabric-1.20.2" = _wDOvRU6M;
        "fabric-1.20.6" = _nDLeq9O4;
        "fabric-1.20.1" = _MoSkKVRg;
        "fabric-1.19.3" = _hEiD0fZs;
        "fabric-1.21" = _mhVeZtES;
        "fabric-1.15.2" = _4uAP1nDj;
        "fabric-1.16.5" = _1OxQveIy;
        "fabric-1.17.1" = _6arRARZc;
        "fabric-1.21.1" = _mhVeZtES;
        "fabric-1.14.4" = _OlOLzYq0;
        "fabric-1.21.3" = _XgijIz9H;
        "fabric-1.21.4" = _vZUmpotg;
        "fabric-1.21.5-rc2" = _PsXuyISP;
        "fabric-1.21.5" = _t8utiyok;
        "fabric-1.21.6" = _OUwRnohk;
        "fabric-1.21.7" = _OUwRnohk;
        "fabric-1.21.8" = _OUwRnohk;
        "fabric-1.20" = _MoSkKVRg;
        "fabric-1.21.2" = _XgijIz9H;
        "fabric-1.21.9" = _3zUtVXqx;
        "fabric-1.21.10" = _3zUtVXqx;
        "fabric-1.20.3" = _TbYthnjE;
        "fabric-1.20.5" = _nDLeq9O4;
        "fabric-1.21.11" = _xc2R6HWb;
        "fabric-26.1" = _2vxRYpOE;
        "fabric-26.1.1" = _2vxRYpOE;
        "fabric-26.1.2" = _2vxRYpOE;
        "fabric-26.2" = _kb7gspsV;
