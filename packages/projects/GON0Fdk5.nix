...
let
    versions = (let
        ...
        _wDOvRU6M = {
            "id" = "wDOvRU6M";
            "file" = "skin_overrides-2.7.0+1.20.2.jar";
            "hash" = "sha512-H463L+nhrJIGZAp0iWXVwHFswuCjdVvLSUZwhfp/tfRAdQZCdujrVrVDTnHdpqmqejCZ1Ey0H0G0HBelMBZdcw==";
        };
        _TbYthnjE = {
            "id" = "TbYthnjE";
            "file" = "skin_overrides-2.7.0+1.20.4.jar";
            "hash" = "sha512-v1ghId4JS8jatY+Y3kmlndSJDaWgjrYld6vf9Ww+obrowVSC+zlKWC3JX3jQdxpg/onU/7rF7DpS7uVwzIU3Ew==";
        };
        _nDLeq9O4 = {
            "id" = "nDLeq9O4";
            "file" = "skin_overrides-2.7.0+1.20.6.jar";
            "hash" = "sha512-ieBqL5a2clHXyoTnaJxqmWsjalD6eBjtbvrfTk76GsWA+w/7dQsBBRhYj6zUW5jHif73Y9BngA0mgBh3eVEH6A==";
        };
        _mhVeZtES = {
            "id" = "mhVeZtES";
            "file" = "skin_overrides-2.7.0+1.21.1.jar";
            "hash" = "sha512-eSXNnvqZ/h8ra/mTKKWan6cq9N2ycJEiwt8dMyEw0Z/d6xL6/soFlo1U8NfdXW1HNprUcJemgpY29+N7+GJALw==";
        };
        _XgijIz9H = {
            "id" = "XgijIz9H";
            "file" = "skin_overrides-2.7.0+1.21.3.jar";
            "hash" = "sha512-ABEh09//ro92aXLiRzWbNAMD+0kYTPEIpWZRYMwcFQZsHeJBs+qeJsUFijuuyt0WyITKFdcLOSHOC5YxPtxXQA==";
        };
        _vZUmpotg = {
            "id" = "vZUmpotg";
            "file" = "skin_overrides-2.7.0+1.21.4.jar";
            "hash" = "sha512-hM+ONt0GnYNtqCT+kAk+nqNRTvplMzaTXZpRBDBdY61+RNWuwYhGTlxmzwixwgGiKqW+saLwciWVuZLKMqimLA==";
        };
        _t8utiyok = {
            "id" = "t8utiyok";
            "file" = "skin_overrides-2.7.0+1.21.5.jar";
            "hash" = "sha512-FkCtW6mBTlraUyBIWLBIB87v5izgXsFjcrvqqg2w+xWnnABUh4xURaWUhDLRtm8VfxfTZ1XSrOd6q9JZyCsZfQ==";
        };
        _OUwRnohk = {
            "id" = "OUwRnohk";
            "file" = "skin_overrides-2.7.0+1.21.8.jar";
            "hash" = "sha512-ZrdE/hFJEgKAeksPtjw3bcbUvhC0L0mgxOF7nExg7LWupPUJXrBDooaDYS6F7giPOzdI1WtmUSl2fVz5FDSvXg==";
        };
        _3zUtVXqx = {
            "id" = "3zUtVXqx";
            "file" = "skin_overrides-2.7.0+1.21.10.jar";
            "hash" = "sha512-bhWwL8BshiGA7SSnDS9GDfS8g8/CYN+Q00gk4JsOnOGr8BKilZC+3PpMlqepmweitDoeswL7EuKSNvULT6LTKA==";
        };
        _xc2R6HWb = {
            "id" = "xc2R6HWb";
            "file" = "skin_overrides-2.7.0+1.21.11.jar";
            "hash" = "sha512-c0LUVj7VHdfGZP+sLAptqOzAksy+m574x/tPM3vAcVGl/cd8E/JzWu7bBcnRxUFCkdcK0AhnNGerh1H3aOzm/A==";
        };
        _2vxRYpOE = {
            "id" = "2vxRYpOE";
            "file" = "skin_overrides-2.7.0+26.1.jar";
            "hash" = "sha512-l0YejI1QvQADYZV+ltds6BlyOzo49pm1eJXDoyH6OshTBgMhJHnXWRGrTY709javomdVnJnkSUfadySuHXRYxA==";
        };
        _kb7gspsV = {
            "id" = "kb7gspsV";
            "file" = "skin_overrides-2.7.0+26.2.jar";
            "hash" = "sha512-F9x8B9udYvCP7giKIAKNsWq+Wxsvx5ines9EpmPrNjx06wTJ+z74uy7daCe5r9DbR5Y76aiquXwr8ThFsGLkAA==";
        };
        _50QJE3mk = {
            "id" = "50QJE3mk";
            "file" = "skin_overrides-2.7.0+26.3.jar";
            "hash" = "sha512-Gwk2RqdYOKCvxCbBuXYB6H+qmREojFaijqTB6jUTehsF7rfneiagepZeQC07pB94h31pNXBC4LfYuATt3O83NQ==";
        };
        _NfULo072 = {
            "id" = "NfULo072";
            "file" = "skin_overrides-2.7.1+1.20.2.jar";
            "hash" = "sha512-H/z/RfRrS/yem6RraYOTmkoL1sAB8ZolCIoRhGmJooXA+UBlNJ5k03oy9hByprDLXyot+V1wXK45Tzctm8FZ8g==";
        };
        _pC2EFfIZ = {
            "id" = "pC2EFfIZ";
            "file" = "skin_overrides-2.7.1+1.20.4.jar";
            "hash" = "sha512-WwrVrWJ1bWnxW/C/BDMQVoRuHf54/yjcnKVv5i706XQkqJHzMNgsq0NDYvKwnNMygrryFxz9KzvAJuzbwsIoOg==";
        };
        _oJtGjLn4 = {
            "id" = "oJtGjLn4";
            "file" = "skin_overrides-2.7.1+1.20.6.jar";
            "hash" = "sha512-nBW0lVuT78oHScYrsw30esvU6Uh0M+MGiOwY9mrYh25WFAf/itOVD3bgB25FlvNz3sa9pWelw2NBVORv2n13iw==";
        };
        _7HDYgLLm = {
            "id" = "7HDYgLLm";
            "file" = "skin_overrides-2.7.1+1.21.1.jar";
            "hash" = "sha512-LI1MBNucZoluszyqP9mmpFX9ReSz8C1yoCIsWHFA/Uz7JZHlNAUdGhdTvKsTCPUHkhsyBaZtVdFGofYNi4u3pQ==";
        };
        _PXHtiOEH = {
            "id" = "PXHtiOEH";
            "file" = "skin_overrides-2.7.1+1.21.3.jar";
            "hash" = "sha512-9/SOo3pWWNqlt9l3RDlPBgN6421Bm4IsKC2TKqG574ihYcQw1jPqkCywu6rnWIjFsA6FoHZt2mgFl6CGxg23gA==";
        };
        _S5pTT5at = {
            "id" = "S5pTT5at";
            "file" = "skin_overrides-2.7.1+1.21.4.jar";
            "hash" = "sha512-EVA7f7txDEnz5qJ3Rkj3MimVRThxheqmXDRN+jUDqerCTRQysPNDMABDePpr57de8I00bIeQUzhv9zQxr55qRg==";
        };
        _98U1fh9T = {
            "id" = "98U1fh9T";
            "file" = "skin_overrides-2.7.1+1.21.5.jar";
            "hash" = "sha512-SSrZht7UA+tz+Lb2EHbjpRgnBi0gFMJdYQiUUDd0qreeXQCwxUGMNJKISOIlTtbW6kOMHivPS+sHfUpA0aSkCg==";
        };
        _pgG9ObUJ = {
            "id" = "pgG9ObUJ";
            "file" = "skin_overrides-2.7.1+1.21.8.jar";
            "hash" = "sha512-UWKKfIkNwLnkDFTmryc92FwzCzzP2k05qjHZXMuNpKMWR61K1/rijMRdDOksxJqpa9NQMIujEoqoqSGq2S6IYA==";
        };
        _gcsLr5Bf = {
            "id" = "gcsLr5Bf";
            "file" = "skin_overrides-2.7.1+1.21.10.jar";
            "hash" = "sha512-J1S+BQUkL016QjV6/wych+MdZJ9tTyD44Wz+XX7yN6GWyCypxJXu6icKXhjB+wK7IGNgJUKXuSCs8kJtyzr94A==";
        };
        _vR12D3t5 = {
            "id" = "vR12D3t5";
            "file" = "skin_overrides-2.7.1+1.21.11.jar";
            "hash" = "sha512-xZaZ9zYIVGtK5hbTxY/bpqiz+DIPwV/Won8LEiaVUxI2COpQKznqxZKtOXf45kgIpLWN1Q8LOTmNwtsP/i4rSQ==";
        };
        _mdDAp2nR = {
            "id" = "mdDAp2nR";
            "file" = "skin_overrides-2.7.1+26.1.jar";
            "hash" = "sha512-DG3om3ysSe9GPQujfSkOuQg+Cup8nRALAuum258TDJ2CN5TGkpOKtmHlZ8qB4634bXsmLtEYPbsLKKQkGRiDEQ==";
        };
        _9gBLUg4f = {
            "id" = "9gBLUg4f";
            "file" = "skin_overrides-2.7.1+26.2.jar";
            "hash" = "sha512-a9Rs4bvl9yVGjlBmricJ2ThAq0loeLbKLN0WTlyYuh3bh+gUEEVt6sDi96ybv8/GnUdRpjWuRNYyiVQ4ENUxiA==";
        };
        _nD41iKaB = {
            "id" = "nD41iKaB";
            "file" = "skin_overrides-2.7.1+26.3.jar";
            "hash" = "sha512-agyvJ6nHFlpLPiDczoSdRPs/UN0ihMI/FcfEOYkTgPsul8vUK2DYzYjNsfaY9KPbrKL3xR3G8OLMoNA7mzz8ig==";
        };
    in {
        "LDfPM3Ot" = _LDfPM3Ot;
        "rTAlG8sC" = _rTAlG8sC;
        ...
        "9gBLUg4f" = _9gBLUg4f;
        "nD41iKaB" = _nD41iKaB;
        "quilt-1.20.2" = _NfULo072;
        "quilt-1.20.3" = _pC2EFfIZ;
        "quilt-1.20.4" = _pC2EFfIZ;
        "quilt-1.20.5" = _oJtGjLn4;
        "quilt-1.20.6" = _oJtGjLn4;
        "quilt-1.21" = _7HDYgLLm;
        ...
        "quilt-1.21.1" = _7HDYgLLm;
        "quilt-1.14.4" = _OlOLzYq0;
        "quilt-1.21.3" = _PXHtiOEH;
        "quilt-1.21.4" = _S5pTT5at;
        "quilt-1.21.5-rc2" = _PsXuyISP;
        "quilt-1.21.5" = _98U1fh9T;
        "quilt-1.21.6" = _pgG9ObUJ;
        "quilt-1.21.7" = _pgG9ObUJ;
        "quilt-1.21.8" = _pgG9ObUJ;
        "quilt-1.20" = _MoSkKVRg;
        "quilt-1.21.2" = _PXHtiOEH;
        "quilt-1.21.9" = _gcsLr5Bf;
        "quilt-1.21.10" = _gcsLr5Bf;
        "quilt-1.21.11" = _vR12D3t5;
        "quilt-26.1" = _mdDAp2nR;
        "quilt-26.1.1" = _mdDAp2nR;
        "quilt-26.1.2" = _mdDAp2nR;
        "quilt-26.2" = _9gBLUg4f;
        "quilt-26.3-snapshot-8" = _50QJE3mk;
        "quilt-26.3" = _nD41iKaB;
        "fabric-1.19" = _RVlUjtF1;
        "fabric-1.19.2" = _jzK3nUm6;
        "fabric-1.18.1" = _6arRARZc;
        "fabric-1.18.2" = _6arRARZc;
        "fabric-1.20.4" = _pC2EFfIZ;
        "fabric-1.19.4" = _XkA0ViPT;
        "fabric-1.20.2" = _NfULo072;
        "fabric-1.20.6" = _oJtGjLn4;
        "fabric-1.20.1" = _MoSkKVRg;
        "fabric-1.19.3" = _hEiD0fZs;
        "fabric-1.21" = _7HDYgLLm;
        "fabric-1.15.2" = _4uAP1nDj;
        "fabric-1.16.5" = _1OxQveIy;
        "fabric-1.17.1" = _6arRARZc;
        "fabric-1.21.1" = _7HDYgLLm;
        "fabric-1.14.4" = _OlOLzYq0;
        "fabric-1.21.3" = _PXHtiOEH;
        "fabric-1.21.4" = _S5pTT5at;
        "fabric-1.21.5-rc2" = _PsXuyISP;
        "fabric-1.21.5" = _98U1fh9T;
        "fabric-1.21.6" = _pgG9ObUJ;
        "fabric-1.21.7" = _pgG9ObUJ;
        "fabric-1.21.8" = _pgG9ObUJ;
        "fabric-1.20" = _MoSkKVRg;
        "fabric-1.21.2" = _PXHtiOEH;
        "fabric-1.21.9" = _gcsLr5Bf;
        "fabric-1.21.10" = _gcsLr5Bf;
        "fabric-1.20.3" = _pC2EFfIZ;
        "fabric-1.20.5" = _oJtGjLn4;
        "fabric-1.21.11" = _vR12D3t5;
        "fabric-26.1" = _mdDAp2nR;
        "fabric-26.1.1" = _mdDAp2nR;
        "fabric-26.1.2" = _mdDAp2nR;
        "fabric-26.2" = _9gBLUg4f;
        "fabric-26.3-snapshot-8" = _50QJE3mk;
        "fabric-26.3" = _nD41iKaB;
        "pkg-1.0.0" = _LDfPM3Ot;
        "pkg-2.0.0" = _rTAlG8sC;
        "pkg-2.1.0+1.19" = _nY4p6FcW;
        "pkg-2.1.0+1.19.2" = _8FRDVr0s;
        "pkg-2.1.0+1.18.1" = _HTHOxkNU;
        "pkg-2.1.0+1.20.4" = _SjBlKgqN;
        "pkg-2.1.0+1.19.4" = _Gbnay1f5;
        "pkg-2.1.0+1.20.2" = _Fod5FmP0;
        "pkg-2.1.0+1.20.6" = _htODCEm8;
        "pkg-2.1.0+1.20.1" = _8PwNIeX8;
        "pkg-2.1.0+1.19.3" = _IffnAN9I;
        "pkg-2.1.0+1.21" = _6TONHpAl;
        "pkg-2.1.1+1.15.2" = _usUPmZs7;
        "pkg-2.1.1+1.19.3" = _xkjIR59G;
        "pkg-2.1.1+1.16.5" = _Yh4le6hR;
        "pkg-2.1.1+1.17.1" = _b7pmOWsw;
        "pkg-2.1.1+1.19.2" = _AIBB6OWf;
        "pkg-2.1.1+1.20.4" = _GnVgjf1Q;
        "pkg-2.1.1+1.19.4" = _i0ss9ocb;
        "pkg-2.1.1+1.20.6" = _f2NW1YAg;
        "pkg-2.1.1+1.20.1" = _M6Wo1wbL;
        "pkg-2.1.1+1.19" = _RVlUjtF1;
        "pkg-2.1.1+1.21" = _7O5ksjjj;
        "pkg-2.1.1+1.20.2" = _nkClwn8M;
        "pkg-2.1.1+1.14.4" = _OlOLzYq0;
        "pkg-2.2.0+1.15.2" = _VwkI0sC4;
        "pkg-2.2.0+1.16.5" = _NPfkuCox;
        "pkg-2.2.0+1.19.2" = _sR8WtqMD;
        "pkg-2.2.0+1.19.3" = _jzbsInUx;
        "pkg-2.2.0+1.20.6" = _n1fCq4Vz;
        "pkg-2.2.0+1.17.1" = _woxZhbUr;
        "pkg-2.2.0+1.21.3" = _A9xYzRNS;
        "pkg-2.2.0+1.20.4" = _Sv20ziPr;
        "pkg-2.2.0+1.19.4" = _FggREbOM;
        "pkg-2.2.0+1.21.1" = _ZaGZch5J;
        "pkg-2.2.0+1.20.1" = _n7iGPhDt;
        "pkg-2.2.0+1.20.2" = _8PQA6OVL;
        "pkg-2.2.1+1.19.3" = _hlTGT5tQ;
        "pkg-2.2.1+1.17.1" = _tZFX3Brx;
        "pkg-2.2.1+1.15.2" = _XNla4x0X;
        "pkg-2.2.1+1.19.4" = _kkhI5nG4;
        "pkg-2.2.1+1.16.5" = _JLHdAfCe;
        "pkg-2.2.1+1.21.3" = _59kYLNhN;
        "pkg-2.2.1+1.20.4" = _pyl5NcCn;
        "pkg-2.2.1+1.21.1" = _a5fkVPDI;
        "pkg-2.2.1+1.19.2" = _xGQnwhE7;
        "pkg-2.2.1+1.20.1" = _qKlvdqiU;
        "pkg-2.2.1+1.20.6" = _12Js48iu;
        "pkg-2.2.1+1.20.2" = _p1HdrdQ8;
        "pkg-2.2.2+1.21.3" = _GSIsMAe4;
        "pkg-2.2.3+1.16.5" = _CoJcJjyi;
        "pkg-2.2.3+1.19.3" = _gFq3LQQL;
        "pkg-2.2.3+1.17.1" = _G2dqsmZ3;
        "pkg-2.2.3+1.20.4" = _Uafoahcu;
        "pkg-2.2.3+1.19.4" = _GG2A7TFa;
        "pkg-2.2.3+1.19.2" = _kHo3p7FR;
        "pkg-2.2.3+1.20.6" = _tVuRMQe6;
        "pkg-2.2.3+1.21.3" = _H9WtNFEO;
        "pkg-2.2.3+1.20.1" = _A84pmDTt;
        "pkg-2.2.3+1.20.2" = _TRdbCk8h;
        "pkg-2.2.3+1.21.4" = _MU0u3ea4;
        "pkg-2.2.3+1.15.2" = _SIFnEyTW;
        "pkg-2.2.3+1.21.1" = _2NVx5bDu;
        "pkg-2.3.0+1.19.2" = _1bVkPzQV;
        "pkg-2.3.0+1.21.1" = _a3FgnvIz;
        "pkg-2.3.0+1.21.4" = _YpQsSCtv;
        "pkg-2.3.0+1.20.6" = _4We6GxWt;
        "pkg-2.3.0+1.20.2" = _jSV0IF4O;
        "pkg-2.3.0+1.21.3" = _ZEedFSfB;
        "pkg-2.3.0+1.20.1" = _9GebyNXA;
        "pkg-2.3.0+1.21.5" = _PsXuyISP;
        "pkg-2.3.0+1.19.3" = _Xwhcayo2;
        "pkg-2.3.0+1.19.4" = _jLCXNEn5;
        "pkg-2.3.0+1.20.4" = _33Zge23H;
        "pkg-2.3.0+1.17.1" = _iE67N81k;
        "pkg-2.3.0+1.16.5" = _8qoxr6x1;
        "pkg-2.3.0+1.15.2" = _Jxc7RC7l;
        "pkg-2.3.1+1.16.5" = _mAdz8UZL;
        "pkg-2.3.1+1.15.2" = _sHaOHW0v;
        "pkg-2.3.1+1.17.1" = _R8LEB7sK;
        "pkg-2.3.1+1.19.2" = _x4IIPKB9;
        "pkg-2.3.1+1.19.3" = _DYv4wSb0;
        "pkg-2.3.1+1.20.1" = _UJldQeYI;
        "pkg-2.3.1+1.19.4" = _Lex229uI;
        "pkg-2.3.2+1.21.1" = _R3nkPIgY;
        "pkg-2.3.2+1.21.4" = _HvzZK9LG;
        "pkg-2.3.2+1.20.1" = _nWZA78wh;
        "pkg-2.3.2+1.20.6" = _5pVAHT7e;
        "pkg-2.3.2+1.21.3" = _X1i0KAcH;
        "pkg-2.3.2+1.20.4" = _QVGPOeIK;
        "pkg-2.3.2+1.19.3" = _hEiD0fZs;
        "pkg-2.3.2+1.20.2" = _bhTdv0rV;
        "pkg-2.3.2+1.16.5" = _1OxQveIy;
        "pkg-2.3.2+1.15.2" = _4uAP1nDj;
        "pkg-2.3.2+1.19.2" = _jzK3nUm6;
        "pkg-2.3.2+1.17.1" = _6arRARZc;
        "pkg-2.3.2+1.21.5" = _pdtPeHIw;
        "pkg-2.3.2+1.19.4" = _gev316ei;
        "pkg-2.4.0-beta.1+1.19.4" = _8GnmOthu;
        "pkg-2.4.0-beta.1+1.21.1" = _j9gvUvEu;
        "pkg-2.4.0-beta.1+1.20.4" = _G5uUyusk;
        "pkg-2.4.0-beta.1+1.21.3" = _QpN1UnnW;
        "pkg-2.4.0-beta.1+1.21.4" = _EPaNW7KI;
        "pkg-2.4.0-beta.1+1.21.5" = _GGw08dKS;
        "pkg-2.4.0-beta.1+1.20.1" = _fbyJB41A;
        "pkg-2.4.0-beta.1+1.20.6" = _wZu7WlWR;
        "pkg-2.4.0-beta.1+1.20.2" = _GI4NA5kP;
        "pkg-2.4.0-beta.1+1.21.6" = _58jkY3t4;
        "pkg-2.4.0-beta.2+1.20.1" = _DaSItEil;
        "pkg-2.4.0-beta.2+1.21.4" = _P8sr4Ven;
        "pkg-2.4.0-beta.2+1.21.3" = _Zuk56JfY;
        "pkg-2.4.0-beta.2+1.21.9" = _HpsLGbkD;
        "pkg-2.4.0-beta.2+1.21.1" = _hIOQNBoO;
        "pkg-2.4.0-beta.2+1.20.2" = _3lBU6Uke;
        "pkg-2.4.0-beta.2+1.21.5" = _PaQvTtjj;
        "pkg-2.4.0-beta.2+1.19.4" = _K4W8JcZa;
        "pkg-2.4.0-beta.2+1.21.8" = _EYz946Sq;
        "pkg-2.4.0-beta.2+1.20.4" = _o3sVt6m2;
        "pkg-2.4.0-beta.2+1.20.6" = _4GZhTkNF;
        "pkg-2.4.0-beta.3+1.21.9" = _AGvQTDxb;
        "pkg-2.4.0-beta.4+1.19.4" = _qJakwg88;
        "pkg-2.4.0-beta.4+1.20.1" = _usAYZmsX;
        "pkg-2.4.0-beta.4+1.20.2" = _bHSmwDcD;
        "pkg-2.4.0-beta.4+1.20.4" = _BJyHFblk;
        "pkg-2.4.0-beta.4+1.20.6" = _nULe20Ny;
        "pkg-2.4.0-beta.4+1.21.1" = _lDVoJ6Qg;
        "pkg-2.4.0-beta.4+1.21.3" = _iTF20i0C;
        "pkg-2.4.0-beta.4+1.21.4" = _4smXRCys;
        "pkg-2.4.0-beta.4+1.21.5" = _EanGSszC;
        "pkg-2.4.0-beta.4+1.21.8" = _IWPaHwNZ;
        "pkg-2.4.0-beta.4+1.21.10" = _RlgCFwjE;
        "pkg-2.4.0-beta.4+1.21.11" = _AC0hQbPW;
        "pkg-2.4.0-rc.1+1.19.4" = _7QEnrh6k;
        "pkg-2.4.0-rc.1+1.20.1" = _oLS487GW;
        "pkg-2.4.0-rc.1+1.20.2" = _RJql3yQh;
        "pkg-2.4.0-rc.1+1.20.4" = _OHDW6eTa;
        "pkg-2.4.0-rc.1+1.20.6" = _PKlss1f1;
        "pkg-2.4.0-rc.1+1.21.1" = _qn3xPrhs;
        "pkg-2.4.0-rc.1+1.21.3" = _kCTyNJe3;
        "pkg-2.4.0-rc.1+1.21.4" = _xgI8wuG9;
        "pkg-2.4.0-rc.1+1.21.5" = _58klLGJt;
        "pkg-2.4.0-rc.1+1.21.8" = _hLOYHVsZ;
        "pkg-2.4.0-rc.1+1.21.10" = _kvl2LZRF;
        "pkg-2.4.0-rc.1+1.21.11" = _r493TqEf;
        "pkg-2.4.0-rc.2+1.19.4" = _gIZv5E2q;
        "pkg-2.4.0-rc.2+1.20.1" = _TVOnxLfH;
        "pkg-2.4.0-rc.2+1.20.2" = _VKK5O6Z7;
        "pkg-2.4.0-rc.2+1.20.4" = _2rqs34iN;
        "pkg-2.4.0-rc.2+1.20.6" = _j0d20RrI;
        "pkg-2.4.0-rc.2+1.21.1" = _ycaOctwm;
        "pkg-2.4.0-rc.2+1.21.3" = _ifcZ90W3;
        "pkg-2.4.0-rc.2+1.21.4" = _1IRmCgBb;
        "pkg-2.4.0-rc.2+1.21.5" = _jFycVbwU;
        "pkg-2.4.0-rc.2+1.21.8" = _jm5lnD1z;
        "pkg-2.4.0-rc.2+1.21.10" = _rpvTLlsW;
        "pkg-2.4.0-rc.2+1.21.11" = _NrtbM0M5;
        "pkg-2.4.0+1.19.4" = _XkA0ViPT;
        "pkg-2.4.0+1.20.1" = _PwSNgDUc;
        "pkg-2.4.0+1.20.2" = _NPcgRenL;
        "pkg-2.4.0+1.20.4" = _pYWMMFOr;
        "pkg-2.4.0+1.20.6" = _mV5JqN4X;
        "pkg-2.4.0+1.21.1" = _bwFgs7wq;
        "pkg-2.4.0+1.21.3" = _Il5YpGyM;
        "pkg-2.4.0+1.21.4" = _fTtr6sMd;
        "pkg-2.4.0+1.21.5" = _SHu5Vmv4;
        "pkg-2.4.0+1.21.8" = _oHmsTPdr;
        "pkg-2.4.0+1.21.10" = _MGF2HuWy;
        "pkg-2.4.0+1.21.11" = _rR7SURwI;
        "pkg-2.5.0+1.20.1" = _fIEhXDSM;
        "pkg-2.5.0+1.20.2" = _R1R4lhoX;
        "pkg-2.5.0+1.20.4" = _mHelrEpn;
        "pkg-2.5.0+1.20.6" = _iwGDFXry;
        "pkg-2.5.0+1.21.1" = _8G6ttscC;
        "pkg-2.5.0+1.21.3" = _hKg8UGYx;
        "pkg-2.5.0+1.21.4" = _Xu06cvMQ;
        "pkg-2.5.0+1.21.5" = _MSsNERqK;
        "pkg-2.5.0+1.21.8" = _Zb5aRdYi;
        "pkg-2.5.0+1.21.10" = _cakYDkzL;
        "pkg-2.5.0+1.21.11" = _t1mG9wL0;
        "pkg-2.5.0+26.1" = _IupAYv2p;
        "pkg-2.5.1+1.20.1" = _MoSkKVRg;
        "pkg-2.5.1+26.1" = _isoWphVO;
        "pkg-2.5.1+1.20.2" = _xD2aQkvL;
        "pkg-2.5.1+1.20.4" = _RmWahKmg;
        "pkg-2.5.1+1.20.6" = _NeDdcULf;
        "pkg-2.5.1+1.21.1" = _JyXQte5n;
        "pkg-2.5.1+1.21.3" = _gJwhc8TG;
        "pkg-2.5.1+1.21.4" = _3uS1gaUv;
        "pkg-2.5.1+1.21.5" = _ffYHRGNg;
        "pkg-2.5.1+1.21.8" = _A00FRKak;
        "pkg-2.5.1+1.21.10" = _UgLrRfv9;
        "pkg-2.5.1+1.21.11" = _4IPWBttJ;
        "pkg-2.6.0+26.1" = _SOU1MKUU;
        "pkg-2.6.0+1.20.2" = _2TpAccEY;
        "pkg-2.6.0+1.20.4" = _oBa6qVN7;
        "pkg-2.6.0+1.20.6" = _2sJzSZDx;
        "pkg-2.6.0+1.21.1" = _Z99ddIuX;
        "pkg-2.6.0+1.21.3" = _2PxD6bIZ;
        "pkg-2.6.0+1.21.4" = _bjohKLny;
        "pkg-2.6.0+1.21.5" = _rHy0w1rF;
        "pkg-2.6.0+1.21.8" = _C2nabNbJ;
        "pkg-2.6.0+1.21.10" = _Gwh8PhjV;
        "pkg-2.6.0+1.21.11" = _khrJoHZx;
        "pkg-2.6.0+26.2" = _OenLGyyB;
        "pkg-2.6.1+26.1" = _SOv4uaJS;
        "pkg-2.6.2+1.21.10" = _fWUpY089;
        "pkg-2.6.2+1.21.11" = _7H5X9emb;
        "pkg-2.6.2+26.1" = _EBpD9zwv;
        "pkg-2.7.0+1.20.2" = _wDOvRU6M;
        "pkg-2.7.0+1.20.4" = _TbYthnjE;
        "pkg-2.7.0+1.20.6" = _nDLeq9O4;
        "pkg-2.7.0+1.21.1" = _mhVeZtES;
        "pkg-2.7.0+1.21.3" = _XgijIz9H;
        "pkg-2.7.0+1.21.4" = _vZUmpotg;
        "pkg-2.7.0+1.21.5" = _t8utiyok;
        "pkg-2.7.0+1.21.8" = _OUwRnohk;
        "pkg-2.7.0+1.21.10" = _3zUtVXqx;
        "pkg-2.7.0+1.21.11" = _xc2R6HWb;
        "pkg-2.7.0+26.1" = _2vxRYpOE;
        "pkg-2.7.0+26.2" = _kb7gspsV;
        "pkg-2.7.0+26.3" = _50QJE3mk;
        "pkg-2.7.1+1.20.2" = _NfULo072;
        "pkg-2.7.1+1.20.4" = _pC2EFfIZ;
        "pkg-2.7.1+1.20.6" = _oJtGjLn4;
        "pkg-2.7.1+1.21.1" = _7HDYgLLm;
        "pkg-2.7.1+1.21.3" = _PXHtiOEH;
        "pkg-2.7.1+1.21.4" = _S5pTT5at;
        "pkg-2.7.1+1.21.5" = _98U1fh9T;
        "pkg-2.7.1+1.21.8" = _pgG9ObUJ;
        "pkg-2.7.1+1.21.10" = _gcsLr5Bf;
        "pkg-2.7.1+1.21.11" = _vR12D3t5;
        "pkg-2.7.1+26.1" = _mdDAp2nR;
        "pkg-2.7.1+26.2" = _9gBLUg4f;
        "pkg-2.7.1+26.3" = _nD41iKaB;
        "default" = _nD41iKaB;
    });
