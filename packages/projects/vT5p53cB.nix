...
let
    ...
    in {
        ...
        "pkg-1.3.8" = _wFwaOve2;
        "pkg-1.3.9" = _C8zn9d6F;
        "pkg-1.3.10" = _o7CdI2v0;
        "pkg-1.3.11" = _Gdn7Bk6j;
        "pkg-1.3.12" = _U2zcqZrI;
        "pkg-1.4.0" = _XkUhviFF;
        "pkg-1.4.1" = _1gwA49NJ;
        "pkg-1.4.2" = _l7Fe5t34;
        "pkg-1.5.0" = _qvD9IBtJ;
        ...
        "pkg-1.9.0" = _avNT3eIc;
        "pkg-1.9.1" = _t0LDXlmY;
        "pkg-1.10.0" = _yd42tkY1;
        "pkg-1.11.0" = _2Zdhw8nm;
        "pkg-1.12.0" = _36X3ikXd;
        "pkg-1.12.1" = _nbrjkZuN;
        "pkg-1.12.2" = _HNf94HC8;
        "pkg-1.13.0" = _hhBXhJ84;
        "pkg-1.13.1" = _qG9lIDaQ;
        "pkg-1.14.0" = _XaIeNp5B;
        "pkg-2.0.0" = _d4hIjf5R;
        "pkg-2.1.0" = _M7vTqnHT;
        "pkg-2.1.1" = _SeDL5UEO;
        "pkg-2.1.2" = _hGeSeATc;
        ...
        "pkg-2.3.5" = _xqUgIJXB;
        "pkg-2.4.0" = _KUYDYh5c;
        "pkg-1.0.0+stapi" = _ArBcWhaU;
        "pkg-1.1.0+stapi" = _pSoteFHq;
        "pkg-1.1.1+stapi" = _157odRN9;
        "pkg-2.5.0" = _cXp3bnuo;
        "pkg-2.6.0" = _mhgc9E9j;
        "pkg-2.6.1" = _UpIHZoHy;
        "pkg-2.7.0" = _Zk2TiWbP;
        ...
        "pkg-2.8.1" = _1mgq0PdI;
        "pkg-2.9.0" = _35sIX8kz;
        "pkg-2.10.0" = _ACHmzPDz;
        "pkg-2.10.1" = _Mc60mKjb;
        "pkg-2.10.2" = _N8RnCBZV;
        "pkg-2.10.3" = _5x5lE1D4;
        "pkg-1.2.0+stapi" = _1F9FAWu5;
        "pkg-1.2.1+stapi" = _zefywsNQ;
        "pkg-2.11.0" = _BrtE7jce;
        "pkg-1.3.0+stapi" = _6GxKDXxQ;
        "pkg-2.12.0" = _PVeorifM;
