...
let
    ...
    in {
        ...
        "pkg-1" = _MipO9nFG;
        "pkg-1.1" = _bYlwc9mu;
        "pkg-1.2+mod" = _TFdMmXDf;
        "pkg-1.2" = _IzgwLSbR;
        "pkg-2.05" = _UyjfPHGj;
        "pkg-2.05+mod" = _cBy3wVCR;
        "pkg-2.1" = _eaVf0DFe;
        "pkg-2.1+mod" = _1EsjFGWa;
        "pkg-2.2" = _p3KqX4Iu;
        "pkg-2.2+mod" = _Wb5YLHaV;
        "pkg-2.25" = _QY2rZSnJ;
        "pkg-2.25+mod" = _ckkR0mi6;
        "pkg-2.3" = _sHQqL9Rm;
        "pkg-2.3+mod" = _TLdw5pxB;
        "pkg-0.1" = _L9UGAjCN;
        "pkg-0.1+mod" = _vCoBkFUc;
        "pkg-2.5" = _oFFjHJSt;
        "pkg-2.5+mod" = _MnRzk9dS;
        "pkg-3.1" = _3YwmM1AO;
        "pkg-3.1+mod" = _NQvUPk55;
        "pkg-3.5" = _ZygihBeU;
        "pkg-3.5+mod" = _R5zR1y4A;
        "pkg-3.65" = _MDIGalFZ;
        "pkg-3.65+mod" = _aFmmm6Cc;
        "pkg-4.0" = _OCvRweL2;
        "pkg-4.0+mod" = _uJMEpzVC;
        "pkg-4.1" = _jkr9ICTS;
        "pkg-4.1+mod" = _8Osclvc7;
        "pkg-4.2" = _JWWiv880;
        "pkg-4.2+mod" = _Hj21gJO3;
        "pkg-4.3" = _4poE4sij;
        "pkg-4.3+mod" = _GN3sK6Xu;
        "pkg-4.4" = _L9hw09ov;
        "pkg-4.4+mod" = _nqkLY3mr;
        "pkg-4.5" = _eN0U9EiJ;
        "pkg-4.5+mod" = _MNUJjM78;
        "pkg-4.7" = _U2MBCRhF;
        "pkg-4.7+mod" = _YOUPmqmi;
        "pkg-4.8" = _elo0Fb7U;
        "pkg-4.8+mod" = _4GLtBfqC;
        "pkg-4.9" = _kRW85Tc0;
        "pkg-4.9+mod" = _iJB6J97Y;
        "pkg-5.0" = _TdtcKVWW;
        "pkg-5.0+mod" = _SeN3Upjn;
        "pkg-5.1" = _FZhTeiYz;
        "pkg-5.1+mod" = _xaM3QvsW;
        "pkg-5.2" = _s6G0VhJc;
        "pkg-5.2+mod" = _lSQmZReD;
        "pkg-5.5" = _92twwbx4;
        "pkg-5.5+mod" = _LkJDhYIn;
        "pkg-5.6" = _ZkipIgRy;
        "pkg-5.6+mod" = _F91DpDyT;
        "pkg-5.7" = _z7YGCn3y;
        "pkg-5.7+mod" = _NQx33nGX;
        "pkg-5.8" = _FMdENXuI;
        "pkg-5.8+mod" = _WnFgZBOq;
        "pkg-6.0" = _W8xtotmv;
        "pkg-6.0+mod" = _PXuVPLSX;
        "pkg-6.1" = _YMlT2yBO;
        "pkg-6.1+mod" = _iAfcAa8z;
        "pkg-6.2" = _d2853BAL;
        "pkg-6.2+mod" = _2IC2P8wM;
        "pkg-6.3" = _6o3csDtB;
        "pkg-6.3+mod" = _oCj0Kw6H;
        "pkg-7.0" = _YNCGlX5h;
        "pkg-7.0+mod" = _wDAvxPU4;
        "pkg-7.1" = _pY096ej5;
        "pkg-7.1+mod" = _Sln8I7nE;
        "pkg-7.2" = _b1tw1wqr;
        "pkg-7.2+mod" = _oOLml7ZZ;
        "pkg-7.3" = _uu7r0ZZ8;
