...
let
    ...
    in {
        ...
        "pkg-0.4.0+1.21.11" = _OuSrDcUe;
        "pkg-0.5.0+1.21.11" = _9bLNcO2N;
        "pkg-0.6.0+1.21.11" = _6yYWuM4Z;
        "pkg-0.7.0+26.1" = _IlHXmPGE;
        "pkg-0.8.0+26.1" = _FVYoUWZU;
        "pkg-0.8.1+26.1" = _VvJQdJUT;
        "pkg-0.9.0+26.1" = _vaDVq0yo;
