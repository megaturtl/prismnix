...
let
    ...
    in {
        ...
        "pkg-1.2.1-1.21.9" = _Xk0Grz6Z;
        "pkg-1.2.1-1.21.9-1.21.10" = _yq3lDlNY;
        "pkg-1.3.0-1.21.9-1.21.10" = _yw6AhCd9;
        "pkg-2.0.0-1.21.9-1.21.10" = _1ZGFitsR;
        "pkg-2.0.1-1.21.9-1.21.10" = _3sONrIx5;
        "pkg-2.1.0-1.21.9-1.21.10" = _i5M1dSjM;
        "pkg-2.1.0-1.21.11" = _BsLZpE2O;
        "pkg-2.1.0-1.21.6-1.21.8" = _AXJyclVl;
        "pkg-2.2.0-1.21.11" = _Sf6tVTWf;
        "pkg-2.3.0-1.21.11" = _tC6ubhWE;
        "pkg-2.4.0-1.21.11" = _pMqbtnBN;
        "pkg-2.4.1-1.21.11" = _8ec70mxF;
        "pkg-2.5.0-1.21.11" = _7pJH0Pzy;
        "pkg-2.5.0-26.1" = _E95s89OS;
        "pkg-2.5.0+26.1" = _vZnWXXdc;
        "pkg-2.6.0+26.1" = _IM1OjpZn;
        "pkg-2.6.1+26.1" = _YlTRMxPC;
        "pkg-2.7.0+26.1" = _TJ2Lhzs1;
        "pkg-2.8.0+26.1" = _ebViihTc;
        "pkg-2.9.0+26.1" = _sZaiRFgm;
        "pkg-2.9.1+26.1" = _BFgp4slK;
        "pkg-2.9.2+26.1" = _Nh5BO6yG;
        "pkg-2.9.2+26.2" = _S3YALc9F;
        "pkg-2.10.0+26.2" = _1xAUZb4O;
