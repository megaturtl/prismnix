...
let
    ...
    in {
        ...
        "pkg-1.0-1.21" = _mfCTaee1;
        "pkg-1.1-1.20.1" = _8ZkonhLS;
        "pkg-1.1-1.20.4" = _XA7xIM6K;
        "pkg-1.1-1.20.6" = _3HVb08AM;
        "pkg-1.1-1.21" = _Fb4FhDeG;
        "pkg-1.1-1.21.1" = _EaiojpHP;
        "pkg-1.1.1-1.21" = _SkJv0BUn;
        "pkg-1.1.1-1.21.1" = _I6uBe4fz;
        "pkg-1.1.2-1.20.1" = _eAOtlhiB;
        "pkg-1.1.2-1.20.4" = _pfNmqizP;
        "pkg-1.1.2-1.20.6" = _Fhin6ODt;
        "pkg-1.1.2-1.21" = _xBs33LGQ;
        "pkg-1.1.2-1.21.1" = _S4AmOjAU;
        "pkg-1.1.3-1.21.1" = _CtKzKOO5;
        "pkg-1.1.3-1.21.2" = _LK4gEJMC;
        "pkg-1.1.3-1.21.3" = _MDW6kVr5;
        "pkg-1.21.4-1.1.3" = _xKbg0OcQ;
        "pkg-1.21.5-1.1.3" = _CxEmzBn9;
        "pkg-1.21.8-1.1.3" = _vvEjnSQp;
        "pkg-1.21.10-1.1.3" = _goTQnXy6;
