...
let
    ...
    in {
        ...
        "pkg-1.5.8" = _lKAYgcf6;
        "pkg-1.5.9" = _n0rmozHt;
        "pkg-1.5.10" = _yZm1LCd9;
        "pkg-1.5.11+1.21" = _mvn6boCj;
        "pkg-1.5.11+1.21.3" = _c9lCbpP5;
        "pkg-1.5.12+1.21" = _tX3iLwnj;
        "pkg-1.5.12+1.21.3" = _KQNg5q9M;
        "pkg-1.5.13-beta.1+1.21" = _Kf9mlH2K;
        "pkg-1.5.13-beta.1+1.21.3" = _y7c7mUQ9;
        "pkg-1.5.13-beta.1+1.21.4" = _2ftjMmu0;
        "pkg-1.5.13+1.21" = _rjY9CLzZ;
        "pkg-1.5.13+1.21.3" = _EYDYAJYJ;
        "pkg-1.5.13+1.21.4" = _pEqY6UF8;
        "pkg-1.5.13+1.20.1" = _3W037w87;
        "pkg-1.5.13+1.21.5" = _UEnvTs5H;
        "pkg-1.5.14+1.20.1" = _w966LEtC;
        "pkg-1.5.14+1.21" = _6rlCEmaP;
        "pkg-1.5.14+1.21.3" = _TUDlrY40;
        "pkg-1.5.14+1.21.4" = _GK9uEE7x;
        "pkg-1.5.14+1.21.5" = _7MSMYuVO;
        "pkg-1.5.15+1.21.5" = _a17BB57U;
        "pkg-1.5.15+1.21.6" = _9txiq0Ox;
        "pkg-1.5.16+1.20.1" = _Zsvnusb1;
        "pkg-1.5.16+1.21" = _dDosnn1I;
        "pkg-1.5.16+1.21.3" = _DvipdAYT;
        "pkg-1.5.16+1.21.4" = _fnq46kii;
        "pkg-1.5.16+1.21.5" = _BqUPmgyN;
        "pkg-1.5.16+1.21.6" = _gcUcz8YG;
        "pkg-1.5.16+1.21.9" = _GZbDnB4i;
        "pkg-1.6.0+1.21.11" = _dWYToGLc;
        "pkg-2.0.0+26.1" = _QYtqydPe;
        "pkg-2.1.0+26.1.1" = _PA16bt5j;
        "pkg-2.2.0+26.1.2" = _9ipoHrl5;
        "pkg-2.3.0-beta.1+26.2-pre-2" = _LJZ1vz3q;
