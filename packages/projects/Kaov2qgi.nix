...
let
    ...
    in {
        ...
        "pkg-forge-1.19-1.0.5" = _KdHKUcMU;
        "pkg-forge-1.19-1.0.6" = _l20TEIUv;
        "pkg-forge-1.19-1.0.7" = _SXzO9Mmg;
        "pkg-forge-1.19.1-1.0.0" = _dZDyMjTA;
        "pkg-forge-1.19.2-1.0.0" = _mnOjj81v;
        "pkg-forge-1.19.3-1.0.0" = _mkYBTGfU;
        "pkg-forge-1.19.3-1.0.1" = _Ixtu0gc9;
        "pkg-forge-1.19.3-1.0.2" = _5stCVfxU;
        "pkg-forge-1.19.3-1.0.3" = _6oSoesIb;
        "pkg-forge-1.19.4-1.0.3" = _cdmYpAri;
        "pkg-forge-1.19.2-1.0.4" = _N4fScTfK;
        "pkg-forge-1.19.4-1.0.4" = _Cry9S5XP;
        "pkg-forge-1.19.2-1.0.5" = _R3HdMHtS;
        "pkg-forge-1.19.4-1.0.5" = _7J5zxHrK;
        "pkg-forge-1.19.2-1.0.6" = _BtFS3Kii;
        "pkg-forge-1.19.4-1.0.6" = _4GeRiiRN;
        "pkg-forge-1.19.2-1.0.7" = _uCU0st0g;
        "pkg-forge-1.19.4-1.0.7" = _yWoMZBY7;
        "pkg-forge-1.19.2-1.0.8" = _ZbIF6jhS;
        "pkg-forge-1.19.4-1.0.8" = _NBqHK8pE;
        "pkg-forge-1.20-1.0.8" = _Up9C0Rlz;
        "pkg-forge-1.20.1-1.0.8" = _5fXTmrA9;
        "pkg-forge-1.20.1-1.0.9" = _8lmw3Wsc;
        "pkg-forge-1.20.1-1.0.10" = _O8ZDMfwN;
        "pkg-forge-1.19.2-1.0.11" = _QbuVsVCb;
        "pkg-forge-1.19.4-1.0.11" = _7WwiRp6Z;
        "pkg-forge-1.20.1-1.0.11" = _ufKxNiHQ;
        "pkg-forge-1.20.1-1.0.12" = _CQPsj2wR;
        "pkg-forge-1.20.2-1.0.12" = _9rmwMcYW;
        "pkg-forge-1.19.2-1.0.13" = _9AhBW5Cs;
        "pkg-forge-1.19.4-1.0.13" = _odiTIERk;
        "pkg-forge-1.20.1-1.0.13" = _Qpo2DfLL;
        "pkg-forge-1.20.2-1.0.13" = _JPAYgpD6;
        "pkg-forge-1.19.2-1.0.14" = _tuYSkMXf;
        "pkg-forge-1.19.4-1.0.14" = _Y6ENKt5t;
        "pkg-forge-1.20.1-1.0.14" = _rX4AwVtf;
        "pkg-forge-1.20.2-1.0.14" = _qEH8XIfC;
        "pkg-neoforge-1.20.2-1.0.14" = _QZJjwirz;
        "pkg-neoforge-1.20.2-1.0.15" = _OBULNTCj;
        "pkg-forge-1.19.2-1.0.16" = _uQa4u8O1;
        "pkg-forge-1.19.4-1.0.16" = _XDnfLMm2;
        "pkg-forge-1.20.1-1.0.16" = _Hqh5BUdN;
        "pkg-forge-1.20.2-1.0.16" = _m6N8hesF;
        "pkg-neoforge-1.20.2-1.0.16" = _QUL6JTwd;
        "pkg-neoforge-1.20.3-1.0.16" = _hbGjBYsb;
        "pkg-neoforge-1.20.4-1.0.16" = _s7011dU4;
        "pkg-forge-1.19.2-1.0.17" = _gAQbfMCn;
        "pkg-forge-1.20.1-1.0.17" = _EYAoByf7;
        "pkg-forge-1.20.2-1.0.17" = _Mp31dqE4;
        "pkg-neoforge-1.20.2-1.0.17" = _jlC3Tbsy;
        "pkg-neoforge-1.20.4-1.0.17" = _gATK1CbE;
        "pkg-neoforge-1.20.4-1.1.0" = _VYHvWRMU;
        "pkg-forge-1.19.2-1.1.1" = _eYGLcnkQ;
        "pkg-forge-1.20.1-1.1.1" = _DaybDNrF;
        "pkg-neoforge-1.20.4-1.1.1" = _TSUSNcPY;
        "pkg-neoforge-1.20.4-1.1.2" = _qBvZNViu;
        "pkg-forge-1.19.2-1.1.3" = _q0OJ6uN0;
        "pkg-forge-1.20.1-1.1.3" = _pCR3FZq1;
        "pkg-neoforge-1.20.4-1.1.3" = _eAVDxoo1;
        "pkg-forge-1.19.2-1.1.4" = _3CeMCQZm;
        "pkg-forge-1.20.1-1.1.4" = _oX1MR2lk;
        "pkg-neoforge-1.20.4-1.1.4" = _i1TeCiAW;
        "pkg-neoforge-1.20.5-1.1.4" = _2LHgibPV;
        "pkg-neoforge-1.20.6-1.1.4" = _DErN1TWg;
        "pkg-neoforge-1.20.6-1.1.5" = _9g8w9u3W;
        "pkg-neoforge-1.20.6-1.1.6" = _GomnJZq2;
        "pkg-neoforge-1.20.6-1.1.7" = _GYBkRs5u;
        "pkg-neoforge-1.21-1.1.7" = _MxfeqJ9C;
        "pkg-neoforge-1.21-1.1.8" = _oLJNibAc;
        "pkg-neoforge-1.21-1.1.9" = _TMP7Yf2K;
        "pkg-neoforge-1.20.6-1.1.10" = _g0VDXwfq;
        "pkg-neoforge-1.21-1.1.10" = _j6Zae1eR;
        "pkg-neoforge-1.21-1.1.11" = _c4GJ6cGz;
        "pkg-neoforge-1.21-1.1.12" = _sC9SiysN;
        "pkg-forge-1.19.2-1.1.13" = _zy0hk1h2;
        "pkg-forge-1.20.1-1.1.13" = _vBhqxHRd;
        "pkg-neoforge-1.20.4-1.1.13" = _jePQtbr7;
        "pkg-neoforge-1.20.6-1.1.13" = _3JrwuBO3;
        "pkg-neoforge-1.21-1.1.13" = _ku3jAbuR;
        "pkg-forge-1.19.2-1.1.14" = _H2NwFsoE;
        "pkg-forge-1.20.1-1.1.14" = _1X2tqE5s;
        "pkg-neoforge-1.21-1.1.14" = _ROmVn9CI;
        "pkg-forge-1.19.2-1.1.15" = _qHnhciVO;
        "pkg-forge-1.20.1-1.1.15" = _iBM2BOA5;
        "pkg-neoforge-1.21-1.1.15" = _nlePRuFo;
        "pkg-neoforge-1.21.1-1.1.15" = _NOTBlz5r;
        "pkg-forge-1.19.2-1.1.16" = _FL6AvyN5;
        "pkg-forge-1.20.1-1.1.16" = _xXcXQ3Xm;
        "pkg-neoforge-1.21.1-1.1.16" = _tBAeDNT0;
        "pkg-forge-1.19.2-1.1.17" = _pBLBSkEp;
        "pkg-forge-1.20.1-1.1.17" = _E6HuDcPM;
        "pkg-neoforge-1.21.1-1.1.17" = _UMu68hLu;
        "pkg-neoforge-1.21.1-1.1.18" = _WyDGxcT1;
        "pkg-neoforge-1.21.1-1.1.19" = _JFcvJ4tL;
        "pkg-neoforge-1.21.1-1.1.20" = _ETfZ02k0;
        "pkg-forge-1.19.2-1.1.21" = _XQpfnu9G;
        "pkg-forge-1.20.1-1.1.21" = _zKUQmw0S;
        "pkg-neoforge-1.21.1-1.1.21" = _rFdcFqGV;
        "pkg-forge-1.19.2-1.1.22" = _w5Wj2rEm;
        "pkg-forge-1.20.1-1.1.22" = _3xW7WcjA;
        "pkg-neoforge-1.21.1-1.1.22" = _oYPOjXUV;
        "pkg-forge-1.19.2-1.1.23" = _fT2nOKrM;
        "pkg-forge-1.20.1-1.1.23" = _YG1zrman;
        "pkg-neoforge-1.21.1-1.1.23" = _uAfv3Z0Z;
        "pkg-neoforge-1.21.2-1.1.23" = _vuIbxmoP;
        "pkg-neoforge-1.21.3-1.1.23" = _OTY2QwLk;
        "pkg-neoforge-1.21.4-1.1.23" = _ZJ5KH5qW;
        "pkg-neoforge-1.21.5-1.1.23" = _45TQRmWn;
        "pkg-neoforge-1.21.4-1.1.24" = _2lwmRiT4;
        "pkg-neoforge-1.21.5-1.1.24" = _ykp7xfRH;
        "pkg-neoforge-1.21.5-1.1.25" = _oENYc53K;
        "pkg-forge-1.20.1-1.1.24" = _qzgjZBbD;
        "pkg-neoforge-1.21.1-1.1.24" = _SJ4xUzy0;
        "pkg-neoforge-1.21.4-1.1.26" = _86OmnOMi;
        "pkg-neoforge-1.21.5-1.1.26" = _6qwgPiFz;
        "pkg-forge-1.20.1-1.1.27" = _8VKoFg6e;
        "pkg-neoforge-1.21.1-1.1.27" = _O3M0Xv8Q;
        "pkg-neoforge-1.21.4-1.1.27" = _zANnRAGY;
        "pkg-neoforge-1.21.5-1.1.27" = _qG6SDq3T;
        "pkg-neoforge-1.21.5-1.1.28" = _xFfL5eWJ;
        "pkg-forge-1.20.1-1.1.29" = _RPrWB1Fw;
        "pkg-neoforge-1.21.1-1.1.29" = _pzZP0BI9;
        "pkg-neoforge-1.21.4-1.1.29" = _cmwoj3TA;
        "pkg-neoforge-1.21.5-1.1.29" = _p3kplLcg;
        "pkg-neoforge-1.21.6-1.1.29" = _jBjyF7dD;
        "pkg-neoforge-1.21.6-1.1.30" = _yDMtDYR6;
        "pkg-neoforge-1.21.6-1.1.31" = _E5cLHwZi;
        "pkg-forge-1.20.1-1.1.33" = _37CmTasi;
        "pkg-neoforge-1.21.1-1.1.33" = _C5dYjxOr;
        "pkg-neoforge-1.21.4-1.1.33" = _EBMOle0W;
        "pkg-neoforge-1.21.5-1.1.33" = _zVB0ziTL;
        "pkg-neoforge-1.21.6-1.1.33" = _4ZFKvrgU;
        "pkg-neoforge-1.21.7-1.1.33" = _c7NgsohB;
        "pkg-neoforge-1.21.7-1.1.34" = _Ll4Cfo2h;
        "pkg-neoforge-1.21.8-1.1.34" = _Q04n4WBO;
        "pkg-forge-1.20.1-1.1.35" = _ECXk2yLR;
        "pkg-neoforge-1.21.1-1.1.35" = _6hf8kDbb;
        "pkg-neoforge-1.21.4-1.1.35" = _nLThgMKa;
        "pkg-neoforge-1.21.5-1.1.35" = _QCNKAkKo;
        "pkg-neoforge-1.21.8-1.1.35" = _Aw8bhd28;
        "pkg-neoforge-1.21.8-1.1.36" = _gYIQrbyO;
        "pkg-neoforge-1.21.8-1.1.37" = _rV4J9iNz;
        "pkg-neoforge-1.21.9-1.1.37" = _hVuWTybp;
        "pkg-neoforge-1.21.9-1.1.38" = _TbT0votX;
        "pkg-neoforge-1.21.10-1.1.38" = _MohoLydk;
        "pkg-forge-1.20.1-1.1.39" = _mmqcSSvf;
        "pkg-neoforge-1.21.1-1.1.39" = _Pdo9pdHy;
        "pkg-neoforge-1.21.4-1.1.39" = _xeccrjo7;
        "pkg-neoforge-1.21.5-1.1.39" = _xRLyYp6Z;
        "pkg-neoforge-1.21.8-1.1.39" = _VZC1ARR7;
        "pkg-neoforge-1.21.10-1.1.39" = _1tdxaKIg;
        "pkg-neoforge-1.21.11-1.1.39" = _ZdxPLciI;
        "pkg-neoforge-1.21.1-1.1.40" = _5MZV66V9;
        "pkg-neoforge-1.21.4-1.1.40" = _DqCOHU4o;
        "pkg-neoforge-1.21.5-1.1.40" = _hUJwHLKq;
        "pkg-neoforge-1.21.8-1.1.40" = _YnOGyNov;
        "pkg-neoforge-1.21.10-1.1.40" = _BIm9PAC5;
        "pkg-neoforge-1.21.11-1.1.40" = _KluJsxEr;
        "pkg-neoforge-1.21.1-1.1.41" = _I5zwUj7m;
        "pkg-neoforge-1.21.4-1.1.41" = _Sw4Mv02f;
        "pkg-neoforge-1.21.5-1.1.41" = _IP6cD3J9;
        "pkg-neoforge-1.21.8-1.1.41" = _2tXNe4PM;
        "pkg-neoforge-1.21.10-1.1.41" = _H97CBEEN;
        "pkg-neoforge-1.21.11-1.1.41" = _IYS5KTHe;
        "pkg-neoforge-1.1.41+26.1" = _6Qh499yB;
        "pkg-neoforge-1.1.41+26.1.1" = _ubKrnEyj;
        "pkg-neoforge-1.1.41+26.1.2" = _M9fjYtGj;
        "pkg-neoforge-1.21.1-1.1.42" = _uXQvvtUt;
        "pkg-neoforge-1.21.4-1.1.42" = _wWHLayOq;
        "pkg-neoforge-1.21.5-1.1.42" = _ZQUx5sc0;
        "pkg-neoforge-1.21.8-1.1.42" = _8Dnal4CE;
        "pkg-neoforge-1.21.10-1.1.42" = _afWgr33h;
        "pkg-neoforge-1.21.11-1.1.42" = _zo0HqrFz;
        "pkg-neoforge-1.1.42+26.1.2" = _y9ACSYrM;
        "pkg-neoforge-1.1.42+26.2" = _T0BANv5x;
