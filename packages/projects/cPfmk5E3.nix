...
let
    ...
    in {
        ...
        "pkg-1+mod" = _vkj0XibE;
        "pkg-1.2" = _VSanOn16;
        "pkg-1.2+mod" = _v3RtXy4z;
        "pkg-1.3" = _OkZlb7rI;
        "pkg-1.3+mod" = _yiOeDQqb;
        "pkg-1.4" = _lNoNGqOE;
        "pkg-1.4+mod" = _buK0vTkX;
        "pkg-1.5" = _gmPlB3SC;
        "pkg-1.5+mod" = _fpeUEy1c;
        "pkg-1.6" = _Vj8CD1g4;
        "pkg-1.6+mod" = _EwGbc6m7;
        "pkg-1.7" = _i3xfvlrm;
        "pkg-1.7+mod" = _Iv48v4cz;
        "pkg-1.8" = _ZQ0K5RTq;
        "pkg-1.8+mod" = _nZGvmMKI;
        "pkg-2.2" = _rJLO49AS;
        "pkg-2.2+mod" = _PtHN9wKV;
        "pkg-2.0.1" = _Ert5Li3M;
        "pkg-2.0.1+mod" = _rqkX42s2;
        "pkg-2.2.1" = _kZu2H6bM;
        "pkg-2.2.1+mod" = _t94MPcdA;
        "pkg-2.3" = _uuQ9Vwxs;
        "pkg-2.3+mod" = _Ikru3U52;
        "pkg-2.4" = _SMJ0O34o;
        "pkg-2.4+mod" = _Smch9jgJ;
        "pkg-2.4.1" = _3NRBFQFs;
        "pkg-2.4.1+mod" = _DpEh8uX3;
        "pkg-2.5" = _9xui5cGL;
        "pkg-2.5+mod" = _Y0I2rO1c;
        "pkg-2.4.2" = _GA1Nh3ov;
