...
let
    versions = (let
        ...
        _7YOC8Es7 = {
            "id" = "7YOC8Es7";
            "file" = "k_multi_threading-1.1.0.3.jar";
            "hash" = "sha512-G32RzwcTA89Reubgl2YYEVNdYIVb/THantzF3jJIB0H/g8DZ4YENLI8Dv/jpo+lswnVl/gs3isI6CqIVDJnEvA==";
        };
        _4YXUv5Mx = {
            "id" = "4YXUv5Mx";
            "file" = "k_multi_threading-NeoForge-1.1.0.3.jar";
            "hash" = "sha512-P4JeVVDjBv/KjMJMH92k+GKYdikYmbs6RIblmxptJ6XsMkHCw0CaNjBLaSJH1sT6C5fzT1S+MQagsBESgj4/zg==";
        };
        _oeVFctHK = {
            "id" = "oeVFctHK";
            "file" = "k_multi_threading-1.1.0.4.jar";
            "hash" = "sha512-3UWBsW3SXFBuxG2dNNv21n9y1WVOYG4bv8rXIkS7Vhw3sdx8YLWPiii/M3Gwk7Dvh0w6kbWEz5vSZvup5tHytA==";
        };
        _4VV0SQ0y = {
            "id" = "4VV0SQ0y";
            "file" = "k_multi_threading-NeoForge-1.1.0.4.jar";
            "hash" = "sha512-Ad505B7UPQWr62SKo8TIAd+Fy10kpsn5CPyqe0sf0er25ds02qkRN0zwZq0gr4AZfUw4NGfX/Ig7UTPygqgeQQ==";
        };
        _aMixRadG = {
            "id" = "aMixRadG";
            "file" = "k_multi_threading-1.1.0.5.jar";
            "hash" = "sha512-exOLV0fokH70bmcF6s+rrgQI3+q+KlMCG5e4+3xJuSIwEDSrazFNEmemIKv/e+hieg3F99G5Bs8OtzfqIVNvug==";
        };
        _jetO4wib = {
            "id" = "jetO4wib";
            "file" = "k_multi_threading-NeoForge-1.1.0.5.jar";
            "hash" = "sha512-cnh0m7cGk8frE7MX1M0psF+N5+dqWLypbIrIF0Laub6D0YhhDx4AEuYPl3l7X1llnHjKRiVeLtygTAIfYEJqXA==";
        };
        _FtDYTDsu = {
            "id" = "FtDYTDsu";
            "file" = "k_multi_threading-1.1.0.6.jar";
            "hash" = "sha512-OB5LFN2g3QrDe/ecX5L3FTrRq+qgxFmE2MUqMVfR3A6TVhiIlu957Xgdsmwtvi0UnmHCbmfmv5eNknNHFkznzg==";
        };
        _1N7mriE6 = {
            "id" = "1N7mriE6";
            "file" = "k_multi_threading-NeoForge-1.1.0.6.jar";
            "hash" = "sha512-Lgi0HGcWRIWf0VHeBZ7Fm+X5e/D/gRlvmIYpcx3vdgn9oMDVgV16TEXzLx2fs9EZNSnQlhyDEKzpD6VSlDyLWg==";
        };
    in {
        "NOZrVrc2" = _NOZrVrc2;
        "5uLutLCu" = _5uLutLCu;
        ...
        "FtDYTDsu" = _FtDYTDsu;
        "1N7mriE6" = _1N7mriE6;
        "forge-1.20.1" = _FtDYTDsu;
        "forge-1.19.2" = _FtDYTDsu;
        "neoforge-1.21" = _1N7mriE6;
        "neoforge-1.21.1" = _1N7mriE6;
        "pkg-1.0.3.10" = _NOZrVrc2;
        "pkg-1.0.3.14" = _5uLutLCu;
        "pkg-1.0.3.15" = _PWs5jPZS;
        "pkg-1.0.3.16" = _ephhDc9h;
        "pkg-1.0.3.17" = _g2wMmVDz;
        "pkg-1.0.3.18" = _mpjNeWgs;
        "pkg-1.0.3.19" = _NTRZJss0;
        "pkg-1.0.3.20" = _16ps8Oc9;
        "pkg-1.0.3.21" = _gnp6LhXE;
        "pkg-1.0.3.22" = _eyGkaAVN;
        "pkg-1.0.3.23" = _vUb3JKsU;
        "pkg-1.0.3.24" = _KQViQ8VT;
        "pkg-1.0.3.25" = _9vWOxqfk;
        "pkg-1.0.3.26" = _NZ1scGN6;
        "pkg-1.0.3.27" = _4JPxaHLd;
        "pkg-1.0.3.28" = _gMVPPAWQ;
        "pkg-1.0.3.29" = _EiZhCjOq;
        "pkg-1.0.3.30" = _1APxjBST;
        "pkg-1.0.3.31" = _NCDje98r;
        "pkg-1.0.3.32" = _VcYMQDXL;
        "pkg-1.0.3.33" = _Y9snImnl;
        "pkg-1.0.3.34" = _W9RG3WXu;
        "pkg-1.0.3.35" = _TTnBobUg;
        "pkg-1.0.3.36" = _QKOUtiyn;
        "pkg-1.0.3.37" = _x15hpjhJ;
        "pkg-1.0.3.38" = _WXilPxci;
        "pkg-1.0.4.0" = _FhlJqxei;
        "pkg-1.0.4.1" = _q7xdCmPA;
        "pkg-1.0.4.2" = _C1mlZvZv;
        "pkg-1.0.4.3" = _7IB4eukq;
        "pkg-1.0.4.4" = _TevDK89L;
        "pkg-1.0.4.5" = _fjSgSrLJ;
        "pkg-1.0.4.6" = _awbXH5Tr;
        "pkg-1.0.4.7" = _9mOa1qTL;
        "pkg-1.0.4.8" = _YDn26zJR;
        "pkg-1.0.4.9" = _Mt1A3EMh;
        "pkg-1.0.5.0" = _Onu7Z9xK;
        "pkg-1.0.5.1" = _25RmZ2tT;
        "pkg-1.0.5.2" = _c1UsOz7x;
        "pkg-1.0.5.3" = _I4AYQxB6;
        "pkg-1.0.5.4" = _CmHWJ1kj;
        "pkg-1.0.5.5" = _655prwAg;
        "pkg-1.0.5.6" = _WruDTpdo;
        "pkg-1.0.5.7" = _Sgd1wqK8;
        "pkg-1.0.5.8" = _OIq6YXlA;
        "pkg-1.0.5.9" = _BBqwOQ61;
        "pkg-1.0.5.10" = _v9R8ZnmN;
        "pkg-1.0.5.11" = _kp05fvNm;
        "pkg-1.0.5.12" = _T4qz2TiK;
        "pkg-1.0.5.13" = _NewJdrsC;
        "pkg-1.0.5.14" = _c4nkiNSl;
        "pkg-1.1.0.0" = _u5oUzt5T;
        "pkg-1.1.0.1" = _lUmyTb9X;
        "pkg-1.1.0.2" = _K6zcRtlE;
        "pkg-1.1.0.3" = _4YXUv5Mx;
        "pkg-1.1.0.4" = _4VV0SQ0y;
        "pkg-1.1.0.5" = _jetO4wib;
        "pkg-1.1.0.6" = _1N7mriE6;
        "default" = _1N7mriE6;
    });
