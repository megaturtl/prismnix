...
let
    versions = (let
        ...
        _Ucnvj39b = {
            "id" = "Ucnvj39b";
            "file" = "viewdistancefix-fabric-1.0.2+26.3.jar";
            "hash" = "sha512-f7aGZblXd29Lex2unCViqRHEmEJo2FvwOgdmY8Yldd6lDto1evMLKUKSp4VnaWxibUFMvq7hRCDuINWNfS3Qdw==";
        };
    in {
        "6YGGQq3R" = _6YGGQq3R;
        "ozuuMRf5" = _ozuuMRf5;
        ...
        "quilt-26.3" = _Ucnvj39b;
        "pkg-fabric-1.19.2-1.0.0" = _6YGGQq3R;
        "pkg-fabric-1.19.3-1.0.0" = _ozuuMRf5;
        "pkg-fabric-1.19.4-1.0.0" = _VRVEB6Hc;
        "pkg-fabric-1.20-1.0.0" = _w7DILeuh;
        "pkg-fabric-1.20.1-1.0.0" = _WFF27Odi;
        "pkg-fabric-1.20.2-1.0.1" = _8MEGR79C;
        "pkg-fabric-1.20.3-1.0.1" = _LQwI2T5U;
        "pkg-fabric-1.20.4-1.0.1" = _rRWSAjzu;
        "pkg-fabric-1.19.2-1.0.2" = _3q3cTdIe;
        "pkg-fabric-1.19.4-1.0.2" = _RBJ3obeB;
        "pkg-fabric-1.20.1-1.0.2" = _EkpvfTep;
        "pkg-fabric-1.20.2-1.0.2" = _dvHtAF0V;
        "pkg-fabric-1.20.4-1.0.2" = _rdunz4mW;
        "pkg-fabric-1.20.5-1.0.2" = _Fybb96WC;
        "pkg-fabric-1.20.6-1.0.2" = _fOrWx2UP;
        "pkg-fabric-1.21-1.0.2" = _jSJ8G6z8;
        "pkg-fabric-1.21.1-1.0.2" = _MYTZEnn2;
        "pkg-fabric-1.21.2-1.0.2" = _UPuTYI8P;
        "pkg-fabric-1.21.3-1.0.2" = _53HYyMU1;
        "pkg-fabric-1.21.4-1.0.2" = _JHg6ZYop;
        "pkg-fabric-1.21.5-1.0.2" = _eodk4JxM;
        "pkg-fabric-1.21.6-1.0.2" = _35oxUh8B;
        "pkg-fabric-1.21.7-1.0.2" = _UQS0dpDe;
        "pkg-fabric-1.21.8-1.0.2" = _FF25PqWK;
        "pkg-fabric-1.21.9-1.0.2" = _GgH1mjPy;
        "pkg-fabric-1.21.10-1.0.2" = _btIJQtGx;
        "pkg-fabric-1.21.11-1.0.2" = _13lPLnFp;
        "pkg-fabric-1.0.2+26.1" = _3QmED644;
        "pkg-fabric-1.0.2+26.1.1" = _tdhw5FWr;
        "pkg-fabric-1.0.2+26.1.2" = _vH4elviA;
        "pkg-fabric-1.0.2+26.2" = _NLZneHzk;
        "pkg-fabric-1.0.2+26.3" = _Ucnvj39b;
        "default" = _Ucnvj39b;
    });
