...
let
    ...
    in {
        ...
        "pkg-1.20.4-1.0.9.5" = _Mz77zUJV;
        "pkg-1.20.6-1.0.9.5" = _SoNpMCbp;
        "pkg-1.21.8-1.0.9.5" = _eewClJgG;
        "pkg-1.21.5-1.0.9.5" = _r0ChTxRJ;
        "pkg-1.20.1-1.1.0" = _xutm048L;
        "pkg-1.20.4-2.0.2" = _ND2FEmaF;
        "pkg-1.20.1-2.0.2" = _Lt30XbB2;
        "pkg-1.20.6-2.0.2" = _HxuWDbqP;
        "pkg-1.20.1-3.0.0" = _sTigbzGG;
        "pkg-1.20.1-3.0.1" = _vTROSuF4;
        "pkg-1.20.1-3.0.2" = _499aUdDn;
        "pkg-1.21.1-3.0.2" = _9DEcOiRO;
        "pkg-1.21.1-3.0.3" = _Tp8hWtU3;
        "pkg-1.20.1-3.0.3" = _NoXg8hN4;
        "pkg-1.20.1-3.0.4" = _lhwKJqES;
        "pkg-3.0.5" = _T8SRyD6Y;
        "pkg-1.20.1-3.0.5" = _v9klpGg2;
        "pkg-1.20.1-3.0.6" = _ckupdIeR;
        "pkg-4.0.0" = _Q4xNXqOo;
        "pkg-1.21.1-4.0.1" = _AnZeAhXn;
        "pkg-1.20.1-4.0.1" = _b0QkcZTH;
        "pkg-Fabric-1.20.1-4.0.2" = _AHGtYVLl;
        "pkg-Forge-1.20.1-4.0.2" = _ioRMWQtv;
        "pkg-Fabric-1.21.1-4.0.2" = _JwaD9sqQ;
        "pkg-NeoForge-1.21.1-4.0.2" = _SzgW9fwB;
        "pkg-Forge-1.20.1-4.0.4" = _brJeTd6L;
        "pkg-Fabric-1.20.1-4.0.4" = _g4SdrcrZ;
        "pkg-Fabric-1.20.1-4.0.5" = _glU5QzM3;
        "pkg-Forge-1.20.1-4.0.5" = _fGRuyyyj;
        "pkg-NeoForge-1.21.1-4.0.5" = _guSh7vN2;
        "pkg-Fabric-1.21.1-4.0.5" = _gVAAcZr0;
        "pkg-NeoForge-1.21.1-4.0.6" = _Rb40Pki7;
        "pkg-Fabric-1.21.1-4.0.6" = _JKzYu0hm;
        "pkg-NeoForge-1.21.1-4.0.7" = _zFTnmOJ5;
        "pkg-Fabric-1.20.1-4.0.7" = _UeAZNzZP;
        "pkg-Forge-1.20.1-4.0.7" = _6rFfWO8O;
        "pkg-Fabric-1.21.1-4.0.7" = _N267fRCf;
        "pkg-NeoForge-1.21.1-4.0.8" = _HdYYf5Sj;
        "pkg-Fabric-1.21.1-4.0.8" = _UtmqLg3b;
        "pkg-Fabric-1.20.1-4.0.8" = _WcOKeRzY;
        "pkg-Forge-1.20.1-4.0.8" = _IfNJoCSU;
        "pkg-NeoForge-1.20.4-4.0.8" = _uMapwMpo;
        "pkg-Fabric-1.20.4-4.0.8" = _oJshB0ni;
        "pkg-Fabric-1.20.6-1.20.6-2.0.2" = _RNoRZ3YZ;
        "pkg-Fabric-1.20.6-4.0.8" = _SwjWMHdf;
        "pkg-NeoForge-1.20.6-4.0.8" = _KVp4Qi2b;
        "pkg-Forge-1.20.1-4.0.9" = _mOa7E95X;
        "pkg-Fabric-1.20.1-4.0.9" = _4T7803wk;
        "pkg-NeoForge-1.20.4-4.0.9" = _niaofgMf;
        "pkg-Fabric-1.20.4-4.0.9" = _nQB4VwwZ;
        "pkg-Fabric-1.20.6-4.0.9" = _ev0h18vp;
        "pkg-NeoForge-1.20.6-4.0.9" = _zZMYQM1W;
        "pkg-NeoForge-1.21.1-4.0.9" = _KGxX8h6U;
        "pkg-Fabric-1.21.1-4.0.9" = _aZkVbaQT;
        "pkg-NeoForge-1.21.5-4.0.9" = _Nb0EJyQ5;
        "pkg-Fabric-1.21.5-4.0.9" = _YBPV7M11;
        "pkg-NeoForge-1.21.8-4.0.9" = _dR3OvJN4;
        "pkg-Fabric-1.21.8-4.0.9" = _p2hIdPBK;
        "pkg-Forge-1.20.1-4.1.0" = _RdMsmTH4;
        "pkg-Fabric-1.20.1-4.1.0" = _ZOUKSln0;
        "pkg-NeoForge-1.21.1-4.1.0" = _evCxkuky;
        "pkg-Fabric-1.21.1-4.1.0" = _TcVoUQFu;
        "pkg-NeoForge-1.21.1-4.1.1" = _oQFdlX2K;
        "pkg-Fabric-1.21.1-4.1.1" = _IruTSypl;
        "pkg-NeoForge-1.21.1-4.1.1.1" = _rUfqJFoh;
        "pkg-Fabric-1.20.1-4.1.1" = _XdhP9OIn;
        "pkg-Forge-1.20.1-4.1.1" = _1kXGSoMV;
        "pkg-Forge-1.20.1-4.1.2" = _V9cWsskM;
        "pkg-Fabric-1.20.1-4.1.2" = _wIJYLqCV;
        "pkg-Forge-1.20.1-4.2.1" = _VyG7R9Ct;
        "pkg-Fabric-1.20.1-4.2.1" = _ZWuoIt97;
        "pkg-NeoForge-1.21.1-4.2.1" = _JQeuTny6;
        "pkg-Fabric-1.21.1-4.2.1" = _nKr71SoO;
        "pkg-Forge-1.20.1-4.2.2" = _oiQhjm0K;
        "pkg-Fabric-1.20.1-4.2.2" = _MYqSxMAs;
        "pkg-NeoForge-1.21.1-4.2.2" = _O5GDaPTP;
        "pkg-Fabric-1.21.1-4.2.2" = _uFGPMiUR;
        "pkg-NeoForge-1.21.11-4.0.9" = _8eUZHEAL;
        "pkg-Fabric-1.21.11-4.0.9" = _B7LQnIxM;
        "pkg-NeoForge-1.21.11-4.2.2" = _Dw8mPj3n;
        "pkg-Fabric-1.21.11-4.2.2" = _ZnlVVmuW;
        "pkg-NeoForge-1.21.1-4.2.3" = _QiOlBGcz;
        "pkg-Fabric-1.21.1-4.2.3" = _eVOcE2LF;
        "pkg-Forge-1.20.1-4.2.3" = _LuqhYBRC;
        "pkg-Fabric-1.20.1-4.2.3" = _bEG3vv0A;
        "pkg-Forge-1.20.1-4.2.4" = _4sU68ll4;
        "pkg-Fabric-1.20.1-4.2.4" = _vAimRXQF;
        "pkg-Forge-1.20.1-pre-5.0.0" = _dhCwM2AE;
        "pkg-Fabric-1.20.1-pre-5.0.0" = _O5Rhv5Z5;
        "pkg-Forge-1.20.1-0.5.0.0" = _MPhKcmwf;
        "pkg-Fabric-1.20.1-0.5.0.0" = _jQEAvK62;
        "pkg-NeoForge-1.21.11-5.1.0" = _srPSNrAj;
        "pkg-Fabric-1.21.11-5.1.0" = _sO5eFFU3;
        "pkg-Forge-1.20.1-0.5.1.0" = _O1kDAtnb;
        "pkg-Fabric-1.20.1-0.5.1.0" = _cYV3BUGG;
        "pkg-NeoForge-1.21.1-5.1.1" = _cl33kVzM;
        "pkg-Fabric-1.21.1-5.1.1" = _D24wW3pw;
        "pkg-Forge-1.20.1-0.5.1.1" = _q3Xus5OT;
