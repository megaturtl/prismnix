...
let
    ...
    in {
        ...
        "pkg-1.0.2" = _8H88KR7w;
        "pkg-1.0.3" = _xPvzrQZ7;
        "pkg-1.1.4-1.20.1" = _9VNBOh2z;
        "pkg-1.1.5-1.20.1" = _ec537AUV;
        "pkg-1.1.6-1.20.1" = _eA5GdI0V;
        "pkg-1.1.7" = _iV7N4xLA;
        "pkg-1.1.8-1.20.1" = _8vGdvJOj;
        "pkg-1.1.9-1.20.1" = _ux4GRaiM;
        "pkg-1.1.10-1.20.1" = _7tF0LGLr;
        "pkg-1.1.11-1.20.1" = _RGhw6xIi;
        "pkg-1.1.13-1.20.1" = _yD7sRSmB;
        "pkg-1.1.14-1.20.1" = _ri7kMUOD;
        "pkg-1.1.15-1.20.1" = _pktPCIBh;
        "pkg-1.1.16-1.20.1" = _wJO7sdEX;
        "pkg-1.1.17-1.20.1" = _LecdPcUI;
        "pkg-1.1.17" = _uNqCCiRE;
        "pkg-1.1.18" = _50H74Sz7;
        "pkg-1.1.20-1.20.1" = _yYhyEnzR;
        "pkg-1.1.21-1.20.1" = _cm52G4bL;
        "pkg-1.1.22-1.20.1" = _q7KeF7vh;
        "pkg-1.1.23-1.20.1" = _Tw1zkz13;
        "pkg-1.1.24" = _QZzaya5U;
        "pkg-1.1.25" = _JKmn5yaD;
        "pkg-1.1.27" = _O5p23Gs2;
        "pkg-1.1.28" = _3cSOjybA;
        "pkg-1.1.29" = _Vl0TFK8m;
        "pkg-1.2.30" = _lv3Qcx17;
        "pkg-1.2.31" = _vFOHOP3k;
        "pkg-1.2.32" = _oMRTKhOS;
        "pkg-1.2.33" = _5lkNsyoi;
        "pkg-1.2.34" = _QbbtJFr4;
        "pkg-1.2.35" = _jCMajcGQ;
        "pkg-1.2.36" = _SCy9mkfH;
        "pkg-1.3.37" = _Ck7N4mp7;
        "pkg-1.3.38" = _z8AfSZsg;
        "pkg-1.3.39" = _numJU33i;
        "pkg-1.3.40" = _FFKMoZMz;
        "pkg-1.3.41" = _uOcC6pTY;
        "pkg-1.3.43" = _JikKfBnv;
        "pkg-1.4.44" = _5NrzjUmX;
        "pkg-1.4.45" = _9fKWShHt;
        "pkg-1.4.46" = _tT7idjMm;
        "pkg-1.5.47" = _1A4OGWCS;
        "pkg-1.5.48" = _ThzEceut;
        "pkg-1.5.49" = _tQOmUPNk;
        "pkg-1.6.50" = _URf5sVEx;
        "pkg-1.6.51" = _KqxK8uV0;
        "pkg-1.6.52" = _TAd3m2Iu;
        "pkg-1.6.53" = _JcfksGFv;
        "pkg-1.6.54" = _kKk9wrq7;
        "pkg-1.7.55" = _8n9CPYPU;
        "pkg-1.7.56" = _Vpjgdv7T;
        "pkg-1.8.57" = _52e7huO1;
        "pkg-1.8.58" = _614EGNHV;
        "pkg-1.8.59" = _6tRaLfNo;
        "pkg-1.8.60" = _KV4ETZwc;
        "pkg-1.8.61" = _hGmXDYwK;
        "pkg-1.8.62" = _TO873z1y;
        "pkg-1.9.63" = _r9zybJFr;
        "pkg-1.9.64" = _w2A4oRAL;
