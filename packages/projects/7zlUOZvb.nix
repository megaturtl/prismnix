...
let
    versions = (let
        ...
        _5Put70yw = {
            "id" = "5Put70yw";
            "file" = "azurelib-neo-26.2-4.0.0.jar";
            "hash" = "sha512-EXzQSfyIV4zIMP0XNhX6NyvtdWpDPFYCvviYmhkIUG0n4f57vQjYGe4CAE7fxuQxnG2Flgkiu0cOooRBVciuVA==";
        };
        _fIjnqpJe = {
            "id" = "fIjnqpJe";
            "file" = "azurelib-fabric-26.2-4.0.0.jar";
            "hash" = "sha512-EeZR2g+knqdqXVfTqhCtLHpDLqeLouwTZDVi45QHTa/QSQHN39CLOYbtm/q1SzP3V1KIwIVkWnQHMSaL7Jsf9A==";
        };
        _9QousT2l = {
            "id" = "9QousT2l";
            "file" = "azurelib-fabric-26.3-4.0.0.jar";
            "hash" = "sha512-cE81GBEHGn0/1dDyGHGDd7N43iPZTXFO4u6zJcwB5cIRqzgl+db5Qou2rmEA8Ofnwp2zEK51zIHcBdzs4d0pag==";
        };
        _fiQrUC6b = {
            "id" = "fiQrUC6b";
    ...
    in {
        ...
        "pkg-1.0.5" = _r3rxtPpU;
        "pkg-1.0.9" = _Se4eU9vv;
        "pkg-1.0.10" = _hnZLgPuM;
        "pkg-1.0.11" = _5PQ3KjuE;
        "pkg-1.0.8" = _LifMBBoB;
        "pkg-1.0.12" = _RMh7aUQU;
        "pkg-1.0.13" = _QVn21X4L;
        "pkg-1.0.14" = _l48yl2d0;
        "pkg-1.0.15" = _mWoGfCHg;
        "pkg-1.0.16" = _n0qP50Xx;
        "pkg-1.0.17" = _6LbNgd8q;
        "pkg-0.0.1" = _NORRoPn2;
        "pkg-0.0.2" = _YdH6qt2h;
        "pkg-0.0.3" = _QWJEaKvC;
        "pkg-0.0.4" = _9IuwELqZ;
        "pkg-1.0.18" = _WTaLBBnU;
        "pkg-0.0.5" = _9TuxoJbx;
        "pkg-1.0.19" = _zgM6meON;
        "pkg-0.0.6" = _PVRuFGjZ;
        "pkg-1.0.20" = _CMxRoenD;
        "pkg-0.0.7" = _Ni9A46bx;
        "pkg-1.0.21" = _Ze6BWeAn;
        "pkg-0.0.8" = _miI48LfV;
        "pkg-1.0.22" = _6etkgUuC;
        "pkg-1.0.23" = _eS6cGLNO;
        "pkg-1.0.24" = _J6gXBo0M;
        "pkg-1.0.25" = _cqYLTl05;
        "pkg-1.0.26" = _c7oeBaRP;
        "pkg-1.0.27" = _TaJ7QBcH;
        "pkg-1.0.28" = _h8FYPiXO;
        "pkg-1.0.29" = _jINMh4YO;
        "pkg-1.0.30" = _eF9jnYYj;
        "pkg-1.0.31" = _OJsHSlkn;
        "pkg-1.0.32" = _pQKD9idR;
        "pkg-1.0.33" = _sBsHrLg5;
        "pkg-1.0.34" = _g6PDp0BF;
        "pkg-1.0.35" = _bvQiDLJN;
        "pkg-1.0.36" = _IgD9w5uw;
        "pkg-2.0.0" = _7I18OSAw;
        "pkg-2.0.1" = _wiivWZbl;
        "pkg-2.0.3" = _UjTzIZkK;
        "pkg-2.0.4" = _bsnNPpOp;
        "pkg-1.0.37" = _dMbXY1ff;
        "pkg-2.0.5" = _PtzjRliU;
        "pkg-2.0.6" = _nppDOHMO;
        "pkg-2.0.2" = _zFsiShzM;
        "pkg-2.0.8" = _nFfhNZVb;
        "pkg-2.0.9" = _EyTmuSYv;
        "pkg-2.0.10" = _O3IsdQ42;
        "pkg-2.0.11" = _Gh35yEvn;
        "pkg-2.0.7" = _XVK9BMBE;
        "pkg-2.0.12" = _3fXEsXvX;
        "pkg-2.0.13" = _a7bCp7ed;
        "pkg-2.0.14" = _1b3KoLor;
        "pkg-2.0.15" = _fzHIjuby;
        "pkg-1.0.38" = _aVsWyU5s;
        "pkg-2.0.16" = _LoLYMwnx;
        "pkg-2.1.0" = _nin8FqfG;
        "pkg-1.0.39" = _WzO0U6u9;
        "pkg-2.0.17" = _ITiLDd6G;
        "pkg-2.1.1" = _K5Xk7SIA;
        "pkg-2.0.18" = _qmNj5M34;
        "pkg-2.1.2" = _I2DobuaI;
        "pkg-2.1.3" = _XK5iR8Ci;
        "pkg-1.0.40" = _8O0RZOBm;
        "pkg-2.0.19" = _eXRmZkOQ;
        "pkg-2.1.4" = _XdhJ0NZE;
        "pkg-1.0.41" = _aLnTCGDS;
        "pkg-2.0.20" = _9jOJreJb;
        "pkg-2.1.5" = _z3eG6aJy;
        "pkg-2.1.6" = _9j89Llxl;
        "pkg-2.0.21" = _rbwchgDW;
        "pkg-2.1.7" = _pNTzElux;
        "pkg-2.2.0" = _mbOe87wy;
        "pkg-2.2.1" = _hVdfmcXN;
        "pkg-2.2.2" = _vS1NFZcL;
        "pkg-2.0.22" = _ObfJleQ4;
        "pkg-2.1.8" = _pXVvefZa;
        "pkg-2.2.3" = _9i4hgQOw;
        "pkg-2.0.222" = _MNOKWv6I;
        "pkg-2.1.9" = _4EoMA0Wv;
        "pkg-2.2.4" = _H92mYqWw;
        "pkg-1.0.42" = _29OEpeXR;
        "pkg-2.0.24" = _6trWBBPw;
        "pkg-2.1.10" = _SLTEqAM0;
        "pkg-2.2.5" = _hX1q6khy;
        "pkg-1.0.43" = _d1rOthoH;
        "pkg-2.0.25" = _E3heWq1e;
        "pkg-2.1.11" = _1T7YQHD0;
        "pkg-2.2.6" = _QKfvbfZl;
        "pkg-2.3.0" = _FdgzdBAi;
        "pkg-2.2.7" = _Z89PdtY6;
        "pkg-2.1.12" = _Agmrp2R9;
        "pkg-2.3.1" = _eh4zfjUN;
        "pkg-2.0.26" = _ZrepbGhL;
        "pkg-2.3.2" = _29ttB8pY;
        "pkg-2.2.8" = _6oULTjIb;
        "pkg-2.3.3" = _OzTNOyZC;
        "pkg-1.0.44" = _VRW8w4LS;
        "pkg-2.0.27" = _poC4xT0a;
        "pkg-2.1.13" = _orGG6NWf;
        "pkg-2.2.9" = _RQd45Rw1;
        "pkg-2.3.4" = _9WQq5hKi;
        "pkg-2.3.5" = _L7fmwYGu;
        "pkg-2.3.6" = _1bp7Ns4E;
        "pkg-2.3.7" = _XQzIig1q;
        "pkg-2.3.8" = _kXroq08d;
        "pkg-2.0.28" = _r1KS8ed2;
        "pkg-2.1.14" = _8ATKbGPE;
        "pkg-2.2.10" = _rwal6YWA;
        "pkg-2.3.9" = _8wWhOH4Y;
        "pkg-1.0.45" = _Avi7yEYs;
        "pkg-2.0.29" = _g3JDqHIP;
        "pkg-2.1.15" = _iLkJT1J8;
        "pkg-2.2.11" = _pwMfXk9I;
        "pkg-2.3.10" = _6bhnuF6Q;
        "pkg-2.3.11" = _FxVPY2BE;
        "pkg-2.2.12" = _UdHBVElA;
        "pkg-2.3.12" = _J2RQ79Cd;
        "pkg-1.0.46" = _FMj9TENy;
        "pkg-2.0.30" = _Nj3DO9WH;
        "pkg-2.1.16" = _qSTY6bQK;
        "pkg-2.2.13" = _ziDGU832;
        "pkg-2.3.13" = _cICoXSK4;
        "pkg-1.0.47" = _lfxi39fD;
        "pkg-2.1.17" = _F2r6TWtg;
        "pkg-2.2.14" = _FHEsiMmT;
        "pkg-2.3.14" = _A7oOjXqU;
        "pkg-2.3.15" = _hV6T0AOo;
        "pkg-2.3.16" = _ZJVPGPQp;
        "pkg-1.0.48" = _nBN7xxzT;
        "pkg-2.0.33" = _w8kTBGl6;
        "pkg-2.1.18" = _YqteSpL5;
        "pkg-2.2.15" = _1d5nUplB;
        "pkg-2.3.17" = _dWeCJ4RD;
        "pkg-1.0.49" = _tipn5nZu;
        "pkg-2.0.34" = _ru410NDX;
        "pkg-2.1.19" = _h81l76WY;
        "pkg-2.2.16" = _JDdZLdBl;
        "pkg-2.3.18" = _fLklFezm;
        "pkg-2.3.19" = _TJ6fLm2z;
        "pkg-1.0.50" = _mG2isWtc;
        "pkg-2.0.35" = _cItKG5TI;
        "pkg-2.1.20" = _7UtEyiSE;
        "pkg-2.2.17" = _xFNP6RPC;
        "pkg-2.3.20" = _q9UIzBbG;
        "pkg-2.3.21" = _GfUUlozi;
        "pkg-2.3.22" = _ehch54B3;
        "pkg-1.0.51" = _gi9llBsA;
        "pkg-2.0.36" = _9k0YE4I8;
        "pkg-2.1.21" = _X23LmtHe;
        "pkg-2.2.19" = _HANHW0Tn;
        "pkg-2.3.23" = _SqHcmMGh;
        "pkg-1.0.52" = _zG2nS4ZA;
        "pkg-2.0.37" = _CRvwcEOj;
        "pkg-2.1.22" = _fmNZRQJ8;
        "pkg-2.2.20" = _PxoEHupa;
        "pkg-2.3.24" = _QKOrlSRW;
        "pkg-2.3.25" = _3eLnWKWr;
        "pkg-1.0.53" = _ksRw0ta5;
        "pkg-2.0.38" = _R75nnkxd;
        "pkg-2.1.23" = _tAWFNGEW;
        "pkg-2.2.21" = _62a8bUBn;
        "pkg-2.3.26" = _UTv11RSN;
        "pkg-1.0.54" = _eYqHGi8W;
        "pkg-2.0.39" = _lpeLzQcX;
        "pkg-2.1.24" = _uDSdSUKO;
        "pkg-2.2.22" = _AwpcBM84;
        "pkg-2.3.27" = _RPHw6gC8;
        "pkg-1.0.55" = _OkNOzUGc;
        "pkg-2.0.40" = _MjN6MdyM;
        "pkg-2.3.28" = _eXbDHtlS;
        "pkg-1.0.56" = _71Zf9mNo;
        "pkg-2.0.41" = _g5kqTxNB;
        "pkg-2.3.29-alpha" = _o35mEkpH;
        "pkg-3.0.0" = _YwAYBj27;
        "pkg-3.0.1" = _ClPvIGDp;
        "pkg-3.0.2" = _pHF8iSXG;
        "pkg-3.0.3" = _DPvW2HG1;
        ...
        "pkg-3.0.8" = _tY3H1unw;
        "pkg-3.0.9" = _XsPLbXYu;
        "pkg-3.0.10" = _ljEmQh6Y;
        "pkg-3.0.11" = _e1OP2EXw;
        "pkg-3.0.13" = _ccvo9HE5;
        "pkg-3.0.14" = _eA4ay1IM;
        "pkg-3.0.15" = _pszxFbyR;
        "pkg-3.0.16" = _x6IsUoNA;
        "pkg-3.0.17" = _Gi8TGiwL;
        "pkg-3.0.18" = _2ytF1ufh;
        "pkg-3.0.19" = _FkorPsAC;
        "pkg-3.0.20" = _u3jXmZM7;
        "pkg-3.0.21" = _EyYORNnc;
        "pkg-3.0.22" = _zuVuWYMH;
        "pkg-3.0.23" = _B7Av7NaW;
        "pkg-3.0.12" = _1NQttFIP;
        "pkg-3.0.24" = _fNV6amnp;
        "pkg-3.0.25" = _pLE2CGQf;
        "pkg-3.0.27" = _eKfvI8Uq;
        "pkg-3.0.28" = _kPexVNDU;
        "pkg-3.1.0" = _44aBMyzr;
        "pkg-3.1.1" = _rkeyncYZ;
        "pkg-3.0.29" = _vyGNN02B;
        "pkg-3.1.2" = _vpQTWyD6;
        "pkg-3.0.30" = _PcFVtyN9;
        "pkg-3.1.3" = _awVCeIRk;
        "pkg-3.0.31" = _mxD0ecV2;
        "pkg-3.1.4" = _Nm8UzlGi;
        "pkg-3.0.32" = _vVRqyJRe;
        "pkg-3.1.5" = _tI38wDUX;
        "pkg-3.0.33" = _Ecnnykez;
        "pkg-3.1.6" = _jZOzUupt;
        "pkg-3.0.34" = _4lTlKaaV;
        "pkg-3.1.7" = _HFz57h8o;
        "pkg-3.1.8" = _nlCnOJMG;
        "pkg-3.0.35" = _Jnshjunw;
        "pkg-3.1.9" = _m2Vclvni;
        "pkg-3.0.36" = _tKDXFqrS;
        "pkg-3.1.10" = _WD3V0jX8;
        "pkg-3.0.37" = _IeKXfm3Q;
