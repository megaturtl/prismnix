...
let
    ...
    in {
        ...
        "minecraft-26.3-snapshot-4" = _ZpRXobqa;
        "minecraft-26.3-snapshot-5" = _ZpRXobqa;
        "minecraft-26.3-snapshot-6" = _ZpRXobqa;
        "minecraft-26.3-snapshot-7" = _ZpRXobqa;
        "minecraft-26.3-snapshot-8" = _ZpRXobqa;
        "pkg-1.0" = _XFk5BbJG;
        "pkg-1.1" = _alIomxXR;
        "pkg-2.0" = _jgfUYzPk;
        "pkg-2.1" = _ZpRXobqa;
