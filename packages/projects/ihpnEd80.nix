...
let
    ...
    in {
        ...
        "pkg-1.2.0+fabric-1.20.1-22" = _CXcJWPtc;
        "pkg-1.3.0+fabric-1.20.1-32" = _YWCOxZ3q;
        "pkg-1.3.0+forge-1.20.1-32" = _XykQfbLb;
        "pkg-1.3.1+fabric-1.20.1-36" = _KlI5O8tb;
        "pkg-1.3.1+forge-1.20.1-36" = _szlzj05H;
        "pkg-1.3.2+fabric-1.20.1-38" = _7kZwvvUD;
        "pkg-1.3.2+forge-1.20.1-38" = _BGKwjiCF;
        "pkg-1.4-beta+fabric-1.20.1-49" = _j2fahJdX;
        "pkg-1.4-beta+forge-1.20.1-49" = _mqO18VhC;
        "pkg-1.4-beta-2+fabric-1.20.1-50" = _i0kDNbFS;
        "pkg-1.4-beta-2+forge-1.20.1-50" = _5qlUvKKZ;
        "pkg-1.4+fabric-1.20.1-51" = _QpgmnaIy;
        "pkg-1.4+forge-1.20.1-51" = _mMAAJCI3;
        "pkg-1.4.1-beta+fabric-1.20.1-56" = _EreH9UX4;
        "pkg-1.4.1-beta+forge-1.20.1-56" = _EgoFxTvU;
        "pkg-1.4.1-beta-2+fabric-1.20.1-59" = _lPh49SVK;
        "pkg-1.4.1-beta-2+forge-1.20.1-59" = _c2GrB7ee;
        "pkg-1.4.1-beta-3+fabric-1.20.1-65" = _Qf1UWcXB;
        "pkg-1.4.1-beta-3+forge-1.20.1-65" = _E6hDlDez;
        "pkg-1.4.1-beta-4+fabric-1.20.1-72" = _ZtSFv7ML;
        "pkg-1.4.1-beta-4+forge-1.20.1-72" = _G6D60flP;
        "pkg-1.4.1+fabric-1.20.1-73" = _FHwRy1XA;
        "pkg-1.4.1+forge-1.20.1-73" = _HsAb44aC;
        "pkg-1.4.2+fabric-1.20.1-74" = _lqkT7RU9;
        "pkg-1.4.2+forge-1.20.1-74" = _PH9a0847;
        "pkg-1.4.3-beta+fabric-1.20.1-85" = _izAUzAiM;
        "pkg-1.4.3-beta+forge-1.20.1-85" = _OgCyaGyx;
        "pkg-1.4.3+fabric-1.20.1-87" = _1cFERuAB;
        "pkg-1.4.3+forge-1.20.1-87" = _gCWFQTei;
        "pkg-1.4.4-beta+fabric-1.20.1-89" = _7r4K0lq8;
        "pkg-1.4.4-beta+forge-1.20.1-89" = _QjhWBSAm;
        "pkg-1.4.4-beta-2+fabric-1.20.1-91" = _TZzdkq8g;
        "pkg-1.4.4-beta-2+forge-1.20.1-91" = _cCNm5Qq4;
        "pkg-1.4.4+fabric-1.20.1-95" = _VEhxPD2J;
        "pkg-1.4.4+forge-1.20.1-95" = _lTPDaqeK;
        "pkg-1.4.5-beta+forge-1.20.1-101" = _DCxsFol4;
        "pkg-1.4.5+forge-1.20.1-106" = _sKxIOl5O;
        "pkg-1.4.5+neoforge-1.21.1-110" = _7NkzJBsw;
        "pkg-1.4.6+neoforge-1.21.1-113" = _FeX13mB1;
        "pkg-1.4.6a+neoforge-1.21.1-114" = _Gnzl4KFQ;
        "pkg-1.4.7+neoforge-1.21.1-120" = _ZQn7810k;
        "pkg-1.4.7+fabric-1.20.1-123" = _CH9LS5Rm;
        "pkg-1.4.8+forge-1.20.1-127" = _xIKGLTek;
        "pkg-1.4.8+fabric-1.20.1-126" = _SJyVhxvo;
        "pkg-1.4.9+forge-1.20.1-132" = _CsaTRgR9;
        "pkg-1.4.9+fabric-1.20.1-131" = _tont39ZS;
        "pkg-1.4.9+neoforge-1.21.1-130" = _LEOroMJx;
        "pkg-1.4.10+forge-1.20.1-138" = _oOCGbUc8;
        "pkg-1.4.10+fabric-1.20.1-137" = _5huGPfHO;
        "pkg-1.4.10+neoforge-1.21.1-139" = _gdhN6Pg2;
        "pkg-1.4.11+forge-1.20.1-142" = _58YbPixw;
