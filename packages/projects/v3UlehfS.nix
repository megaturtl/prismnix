...
let
    ...
    in {
        ...
        "pkg-2.0.1-Forge" = _kKw8ho0Z;
        "pkg-2.0.2-Fabric" = _QcYi061I;
        "pkg-2.0.2-Forge" = _AaRZWbVA;
        "pkg-2.1.0-Fabric" = _sFNjhn3w;
        "pkg-2.1.0-Forge" = _qphVrW2u;
        "pkg-2.1.1-Forge" = _ngvMOx2z;
        "pkg-2.1.2-Fabric" = _pCZBDSf9;
        "pkg-2.1.2-Forge" = _jGsXkZSw;
        "pkg-2.1.3-Fabric" = _WOdopig8;
        "pkg-2.1.3-Forge" = _mq1Qvb18;
        "pkg-2.1.5" = _Itb1TQFC;
        "pkg-2.1.6" = _ip0IeASu;
        "pkg-2.2.0" = _wcJNDsEi;
        "pkg-2.2.1" = _XdJULDkG;
        ...
        "pkg-2.3.4" = _7xq9B8mR;
        "pkg-2.3.5" = _mWogGDsB;
        "pkg-2.4.0-BETA.1" = _jWous0nE;
        "pkg-2.4.0-BETA.3" = _Erki1uJd;
        "pkg-2.4.0-BETA.4" = _28Ut24FN;
