...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.16" = _dtSasq5X;
        "pkg-1.0.0+1.15" = _MDNWP49x;
        "pkg-1.1.0+1.16" = _vwLeGtdo;
        "pkg-1.2.0+1.16" = _Eb6cI52x;
        "pkg-1.3.0+1.15" = _2gpzxQ8f;
        "pkg-1.3.0+1.16" = _OdUXrEnU;
        "pkg-1.4.0+1.14" = _ksWraMy8;
        "pkg-1.4.0+1.15" = _m3DBG6xs;
        "pkg-1.4.0+1.16" = _yc1irEkZ;
        "pkg-1.4.0+1.17" = _S1pYwj85;
        "pkg-1.4.1+1.14" = _AuCE6BHq;
        "pkg-1.4.1+1.15" = _vyIzpDCB;
        "pkg-1.4.1+1.16" = _P9RCa3P0;
        "pkg-1.4.1+1.17" = _mSTuwjIj;
        "pkg-1.4.2+1.14" = _sNFnnQ1O;
        "pkg-1.4.2+1.15" = _TlOgXLPa;
        "pkg-1.4.2+1.16" = _SzlG9m06;
        "pkg-1.4.2+1.17" = _6MW1v5yA;
        "pkg-1.4.2+1.18" = _YEcfKfAo;
        "pkg-1.4.2+1.18.2" = _UM7I6xFv;
        "pkg-1.5.0+1.14" = _U2uzIsLw;
        "pkg-1.5.0+1.15" = _vXFtRvLE;
        "pkg-1.5.0+1.16" = _V0w19I1q;
        "pkg-1.5.0+1.17" = _qGMIAtHR;
        "pkg-1.5.0+1.18" = _4ZULpLX6;
        "pkg-1.5.0+1.18.2" = _EYxkL0Ds;
        "pkg-1.5.0+1.19" = _2hlYd2KS;
        "pkg-1.5.0+1.19.4" = _seVqJqqB;
        "pkg-1.5.0+1.20" = _VFkr4zMC;
        "pkg-3.0.0+1.20.x" = _z112ssqI;
        "pkg-3.0.1+1.20.x" = _3mrQnyTz;
        "pkg-3.1.0+1.8.9" = _G0lqK9Js;
        "pkg-3.1.0+1.14.x" = _bETs5hSg;
        "pkg-3.1.0+1.15.x" = _EzfS71Br;
        "pkg-3.1.0+1.16.x" = _pUCx8Lq0;
        "pkg-3.1.0+1.17.x" = _IZxZR6aW;
        "pkg-3.1.0+1.18.2" = _pxyG0qAH;
        "pkg-3.1.0+1.19.3" = _Kue4szXd;
        "pkg-3.1.0+1.19.4" = _a1y7YDkW;
        "pkg-3.1.0+1.20.1" = _WaO5IB1q;
        "pkg-3.1.0+1.19.2" = _yB6oWHa2;
        "pkg-3.1.0+1.20.2" = _lOhHV7i1;
        "pkg-4.0.0+1.20.4" = _LgdccGhC;
        "pkg-4.0.1+1.20.4" = _6lwzxSI3;
        "pkg-4.1.0+1.20.5" = _MQHgPZHH;
        "pkg-4.1.1+1.20.6" = _fYxJOVki;
        "pkg-4.2.0+1.21" = _KkRFEG7u;
        "pkg-4.2.1+1.21.1" = _nWbgJNPj;
        "pkg-4.2.2+1.21.3" = _DvUqzGDj;
        "pkg-4.2.3+1.21.3" = _pEYJyDDx;
        "pkg-4.2.4+1.21.4" = _hB8M60Ec;
        "pkg-4.3.0+1.21.4" = _ZiNw8Tlt;
        "pkg-4.3.1+1.21.5" = _jdbz5MJ5;
        "pkg-4.4.0+1.21.6" = _bYEQonzP;
        "pkg-4.4.1+1.21.7" = _EfM7iaFH;
        "pkg-4.4.2+1.21.8" = _7eT70niK;
        "pkg-4.4.3+1.21.10" = _lzw9aMTD;
        "pkg-4.4.4+1.21.10" = _1BUoVSUL;
        "pkg-4.5.0+1.21.11" = _TqYNZvYx;
        "pkg-4.5.1+1.21.11" = _Tiz1VFDa;
        "pkg-4.5.1+1.21.10" = _WUq1wTUu;
