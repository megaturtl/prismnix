...
let
    versions = (let
        ...
        _jOPkNagB = {
            "id" = "jOPkNagB";
            "file" = "DPS-3_15.zip";
            "hash" = "sha512-YJLRH3kcUqFEQTD0CmPTqizyRF3A3WwOuhIUxC39AcvAIx3h9DkzvFFODMrqPtz5y59g4HjKG/s3D5EITkzkTg==";
        };
        _9RL2Mjpa = {
            "id" = "9RL2Mjpa";
            "file" = "DPS-3_16.zip";
        ...
        _bnX8DbvX = {
            "id" = "bnX8DbvX";
            "file" = "duplicatable-pottery-sherds-3.16.jar";
            "hash" = "sha512-ztA2Npp1L5SI2dafh/wjIDvc7BNjn3e+GnnrlGlW6xuTqNcQ8M8rTjxIVHm57BeUrEbYyHdtG29C26aNhvhG4g==";
        };
    in {
        "V6QJOFDI" = _V6QJOFDI;
        "GvEaFW24" = _GvEaFW24;
        ...
        "datapack-1.21.9" = _9RL2Mjpa;
        "datapack-1.21.10" = _9RL2Mjpa;
        "datapack-1.21.11" = _9RL2Mjpa;
        "datapack-26.1" = _9RL2Mjpa;
        "datapack-26.1.1" = _9RL2Mjpa;
        "datapack-26.1.2" = _9RL2Mjpa;
        "datapack-26.2" = _9RL2Mjpa;
        "datapack-26.3" = _9RL2Mjpa;
        ...
        "fabric-1.21.9" = _bnX8DbvX;
        "fabric-1.21.10" = _bnX8DbvX;
        "fabric-1.21.11" = _bnX8DbvX;
        "fabric-26.1" = _bnX8DbvX;
        "fabric-26.1.1" = _bnX8DbvX;
        "fabric-26.1.2" = _bnX8DbvX;
        "fabric-26.2" = _bnX8DbvX;
        "fabric-26.3" = _bnX8DbvX;
        ...
        "forge-1.21.9" = _bnX8DbvX;
        "forge-1.21.10" = _bnX8DbvX;
        "forge-1.21.11" = _bnX8DbvX;
        "forge-26.1" = _bnX8DbvX;
        "forge-26.1.1" = _bnX8DbvX;
        "forge-26.1.2" = _bnX8DbvX;
        "forge-26.2" = _bnX8DbvX;
        "forge-26.3" = _bnX8DbvX;
        ...
        "quilt-1.21.9" = _bnX8DbvX;
        "quilt-1.21.10" = _bnX8DbvX;
        "quilt-1.21.11" = _bnX8DbvX;
        "quilt-26.1" = _bnX8DbvX;
        "quilt-26.1.1" = _bnX8DbvX;
        "quilt-26.1.2" = _bnX8DbvX;
        "quilt-26.2" = _bnX8DbvX;
        "quilt-26.3" = _bnX8DbvX;
        ...
        "neoforge-1.21.9" = _bnX8DbvX;
        "neoforge-1.21.10" = _bnX8DbvX;
        "neoforge-1.21.11" = _bnX8DbvX;
        "neoforge-26.1" = _bnX8DbvX;
        "neoforge-26.1.1" = _bnX8DbvX;
        "neoforge-26.1.2" = _bnX8DbvX;
        "neoforge-26.2" = _bnX8DbvX;
        "neoforge-26.3" = _bnX8DbvX;
        "pkg-1.0" = _V6QJOFDI;
        "pkg-1.1-beta" = _GvEaFW24;
        "pkg-1.2" = _XHR6Jgdp;
        "pkg-1.3" = _lhhaMThM;
        "pkg-1.3+fabric-beta" = _cg6fodTW;
        "pkg-2.0" = _OOZRQocb;
        "pkg-2.0+mod-beta" = _9gjZW3jP;
        "pkg-2.1" = _hwkFlc82;
        "pkg-3.1-beta" = _bYBkCdye;
        "pkg-3.2-beta" = _BfKBlsiH;
        "pkg-3.2" = _rHirM33f;
        "pkg-3.2+mod" = _UDw6RAV0;
        "pkg-3.3" = _F5d2dE0n;
        "pkg-3.3+mod" = _HQ7I43ow;
        "pkg-3.4" = _SZlV8JzK;
        "pkg-3.4+mod" = _SjvPXWUQ;
        "pkg-3.5" = _mbjJCqW7;
        "pkg-3.5+mod" = _3bNEztBv;
        "pkg-3.7" = _QiaKmRhT;
        "pkg-3.7+mod" = _InffO1Rk;
        "pkg-3.8" = _NHBVlaVs;
        "pkg-3.8+mod" = _Sg7z9C7D;
        "pkg-3.9" = _4lIOQnCB;
        "pkg-3.10" = _fsVLXGRH;
        "pkg-3.10+mod" = _lsacZvGV;
        "pkg-3.11" = _QSPSdr5D;
        "pkg-3.11+mod" = _4KlD4q8Z;
        "pkg-3.12" = _70hawkr4;
        "pkg-3.12+mod" = _H4Qzgn3c;
        "pkg-3.13" = _YQWusj8w;
        "pkg-3.13+mod" = _JY66N7sy;
        "pkg-3.14" = _gr84c5Y8;
        "pkg-3.14+mod" = _8u87LLwj;
        "pkg-3.15" = _jOPkNagB;
        "pkg-3.15+mod" = _BB5nkQiM;
        "pkg-3.16" = _9RL2Mjpa;
        "pkg-3.16+mod" = _bnX8DbvX;
        "default" = _bnX8DbvX;
    });
