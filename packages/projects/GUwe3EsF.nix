...
let
    ...
    in {
        ...
        "pkg-1.0.2+MC1.18.2-1.19" = _P1rSvrMI;
        "pkg-1.0.3+MC1.18.2-1.19" = _FTpb7xLA;
        "pkg-1.0.4+MC1.18.2-1.19.1" = _ii4NKoNB;
        "pkg-1.0.5+MC1.18.2-1.19.1" = _acX4iyQW;
        "pkg-1.0.6+MC1.18.2-1.19.2" = _x1L2WeKm;
        "pkg-1.1.0+MC1.19.4" = _wQwfpMzi;
        "pkg-1.0.7+MC1.18.2-1.19.2" = _rKgNX7g4;
        "pkg-1.1.1+MC1.19.4" = _J0qWoWoU;
        "pkg-1.0.8+MC1.18.2-1.19.2" = _EXyAcyr4;
        "pkg-1.1.2+MC1.19.4" = _HMqLlFsJ;
        "pkg-1.0.8-1+MC1.18.2-1.19.2" = _jAFkOk6a;
        "pkg-1.0.9+MC1.18.2-1.19.2" = _4BBIxj14;
        "pkg-1.1.3+MC1.19.4" = _ZTE9V5DR;
        "pkg-1.1.4+MC1.20-1.20.1" = _qVyuRBgx;
        "pkg-1.1.5+MC1.20.2" = _gbe5Tuj2;
        "pkg-1.1.6+MC1.20.3-1.20.4" = _vZfSA5uq;
        "pkg-1.1.7+MC1.20.5" = _1Kp6k2Er;
        "pkg-1.1.8+MC1.20.5-1.20.6" = _cjqqgFBv;
        "pkg-1.2.0+MC1.21" = _vsOHaqC7;
        "pkg-1.2.1+MC1.21" = _7EJXmr4F;
        "pkg-1.2.2+MC1.21-1.21.1" = _QM2NEG12;
        "pkg-1.3.0+MC1.20.2" = _qAyhD8f6;
        "pkg-1.4.0+MC1.20.3-1.20.4" = _gSUpyekm;
        "pkg-1.5.0+MC1.20.5-1.20.6" = _40eMrnwx;
        "pkg-1.6.0+MC1.21-1.21.1" = _UtIfFNzI;
        "pkg-1.3.1+MC1.20.2" = _5x4lNS7U;
        "pkg-1.4.1+MC1.20.3-1.20.4" = _FvXlQ6ce;
        "pkg-1.5.1+MC1.20.5-1.20.6" = _nx9vwWbK;
        "pkg-1.6.1+MC1.21-1.21.1" = _wmhOAT86;
        "pkg-1.7.0+MC1.21.2-1.21.3" = _cjuRQj1b;
        "pkg-1.8.0+MC1.21.4" = _NLzgJ0Fd;
        "pkg-1.8.1+MC1.21.4-1.21.5" = _ruZqA2vk;
        "pkg-1.8.2+MC1.21.4-1.21.6" = _qG0rvSu4;
        "pkg-1.8.3+MC1.21.4-1.21.7" = _aQt9JfXM;
        "pkg-1.8.4+MC1.21.4-1.21.8" = _lDzbcWyY;
        "pkg-1.8.5+MC1.21.4-1.21.10" = _LwwoeXgm;
