...
let
    versions = (let
        ...
        _IAHn7eKt = {
            "id" = "IAHn7eKt";
            "file" = "item_descriptions-2.8.3+26.1.2-fabric.jar";
            "hash" = "sha512-c+HMJgMJ9pXrzBp5ASycNHWooEnog8Rc1Icipp+1+eT7ezZM5FZcHlMYNwiS07y2t4KHgV05BJBWYd+yUJUxyw==";
        };
        _cHFr5eVs = {
            "id" = "cHFr5eVs";
            "file" = "item_descriptions-2.8.3+26.2-fabric.jar";
            "hash" = "sha512-E7WQC3YyTULCDx83iQewm/2x0uKqVOHXrcj1WSS991z8MrLTgYbAEMsg8LzgOMyzeYvas1XLj3dfiZADEshtxA==";
        };
        _wdogW7EH = {
            "id" = "wdogW7EH";
            "file" = "item_descriptions-2.8.3+26.2-neoforge.jar";
            "hash" = "sha512-TlpBCCgWZ0rc9NcoPvKxvQQl1Q06H+xJh0sFyWZvIXCNFKWCXZ3xqwYm86miGglu+5LIUng1JRmrHJ9Z5rMwIg==";
        };
        _sB7AisI4 = {
            "id" = "sB7AisI4";
            "file" = "item_descriptions-2.8.3+26.1.2-neoforge.jar";
            "hash" = "sha512-6jqggFNa4vIwtZM3kj3yP2pC1cHtnxZhW0JFibq3Al/YF6s56i2nXTX/eQyqpuZmDqiKXk7vS2FQleowqRRWYA==";
        };
        _qkQgAOTT = {
            "id" = "qkQgAOTT";
            "file" = "item_descriptions-2.8.4+26.1.2-fabric.jar";
            "hash" = "sha512-Id2CgU3kJbwbxe+2VQMqMkUJzXc8Mt+lPQGokosN7VirtaufVcHBqACvxv0MdP84x8Aeu3HRlGr9dNL9m6DV2w==";
        };
        _rd90sKaj = {
            "id" = "rd90sKaj";
            "file" = "item_descriptions-2.8.4+26.1.2-neoforge.jar";
            "hash" = "sha512-ShIy/4X7is4g/b9Kb1UFPPIL82KL2wwMIksG6D2y+3dwJOPX6xE4xa1QRP3DQbWcbuTTuTrMndmiPrTdJTaS9A==";
        };
        _fu09rx8G = {
            "id" = "fu09rx8G";
            "file" = "item_descriptions-2.8.4+26.2-fabric.jar";
            "hash" = "sha512-VyHCvdnDwxBddpY+Zo0eeN/3VpesI4P4KxDdEWijpE1yCbQGYK2FlkoL/TU55gVWL9UcLFSSEhbicOmcvDpwGw==";
        };
        _ek0wHqZb = {
            "id" = "ek0wHqZb";
    ...
    in {
        ...
        "fabric-26.3-snapshot-6" = _Sqif41cl;
        "fabric-26.3-snapshot-7" = _cHFr5eVs;
        "fabric-26.3-snapshot-8" = _fu09rx8G;
        "fabric-26.3-snapshot-9" = _fu09rx8G;
        ...
        "pkg-1.9+1.21" = _qHl8ZU9p;
        "pkg-1.9+1.20" = _RruqNFyd;
        "pkg-1.9+1.20.6" = _Ak3J2oHV;
        "pkg-1.10+1.20" = _ensmnGgW;
        "pkg-1.10+1.20.6" = _KCXdpCu0;
        "pkg-1.10+24w14potato" = _XYYD2APP;
        "pkg-1.10+1.21" = _h0ecjjpi;
        "pkg-1.11+1.20" = _AWqigEhr;
        "pkg-1.11+1.21" = _KEOf5Mq4;
        "pkg-1.11+20w14infinite" = _HJorimgb;
        "pkg-1.12+1.21.4" = _JxVnOdEK;
        "pkg-1.11+1.19" = _GVqUs8bs;
        "pkg-1.13+1.19.2" = _4y67Xkpj;
        "pkg-1.13+1.20.1" = _govl3kaq;
        "pkg-1.13+1.21.1" = _XtrHH6bO;
        "pkg-1.13+1.21.4" = _QcKTj0Ws;
        "pkg-1.14+1.19.2" = _Ie6JZRzt;
        "pkg-1.14+1.20.1" = _ppDAc3CM;
        "pkg-1.14+1.21.1" = _WzrNIlh4;
        "pkg-1.14+1.21.4" = _TsaeetAO;
        "pkg-1.15+1.19.2" = _A7JUf9va;
        "pkg-1.15+1.20.1" = _Trs2iMnN;
        "pkg-1.15+1.21.1" = _rXvAIvmR;
        "pkg-1.15+1.21.4" = _oxz83VW2;
        "pkg-1.15.1+1.21.1" = _eh5co3LO;
        "pkg-1.15.2+1.21.1" = _lex2zT3J;
        "pkg-1.15.2+1.21.4" = _UcMJq3ta;
        "pkg-2.0.0+1.19.2-fabric" = _lTZ7NOwB;
        "pkg-2.0.0+1.20.1" = _MHDH4eNI;
        "pkg-2.0.0+1.21.1" = _NuXHOqnc;
        "pkg-2.0.0+1.21.4" = _WHo6f2rL;
        "pkg-2.0.0+1.21.5" = _EAP3cXVS;
        "pkg-2.0.0+1.19.2-forge" = _uXm8WeFd;
        "pkg-2.0.1+1.19.2-fabric" = _wRgbAznU;
        "pkg-2.0.1+1.20.1" = _3wDCRKM4;
        "pkg-2.0.1+1.21.1" = _aEJPSsDM;
        "pkg-2.0.1+1.21.4" = _Gngk9MM9;
        "pkg-2.0.1+1.21.5" = _CewQgpZT;
        "pkg-2.0.2+1.21.5" = _5oej7B04;
        "pkg-2.1.0+1.19.2-fabric" = _3bnZFeH0;
        "pkg-2.1.0+1.20.1" = _pHYgUdbE;
        "pkg-2.1.0+1.21.1" = _g9GZkqol;
        "pkg-2.1.0+1.21.4" = _pHSHiIf9;
        "pkg-2.1.0+1.21.5" = _XCXfl9VT;
        "pkg-2.1.0+1.19.2-forge" = _W4anJYOj;
        "pkg-2.1.1+1.19.2-fabric" = _xiGzxI3K;
        "pkg-2.1.1+1.20.1" = _wiAX9yUu;
        "pkg-2.1.1+1.21.1" = _P8u9l1cE;
        "pkg-2.1.1+1.21.4" = _q7tZSRzi;
        "pkg-2.1.1+1.21.5" = _hnJdScOa;
        "pkg-2.1.1+1.19.2-forge" = _4zn7BNRF;
        "pkg-2.1.2+1.19.2-fabric" = _jyHP9nYp;
        "pkg-2.1.2+1.20.1" = _Ou4M2caS;
        "pkg-2.1.2+1.21.1" = _LXQfyAAG;
        "pkg-2.1.2+1.21.4" = _CKDFtV7p;
        "pkg-2.1.2+1.21.5" = _aoRYJ2bx;
        "pkg-2.1.2+1.19.2-forge" = _DxQw2yPR;
        "pkg-2.2.0+1.21.1-fabric" = _kyzp9mkg;
        "pkg-2.2.0+1.20.1-fabric" = _2JrJYKeo;
        "pkg-2.2.0+1.21.4-fabric" = _CzM03A4R;
        "pkg-2.2.0+1.19.2-fabric" = _DH8UZw9s;
        "pkg-2.2.0+1.21.5-fabric" = _TqAEggQf;
        "pkg-2.2.0+1.19.2-forge" = _kEuc6tjE;
        "pkg-2.2.0+1.20.1-forge" = _2GvkSKMN;
        "pkg-2.2.0+1.21.1-neoforge" = _hohW1nOl;
        "pkg-2.2.0+1.21.4-neoforge" = _ZQXxhMp1;
        "pkg-2.2.0+1.21.5-neoforge" = _VFx96Gtz;
        "pkg-2.2.1+1.19.2-forge" = _ge82hW52;
        "pkg-2.2.1+1.20.1-forge" = _QIGDmr9M;
        "pkg-2.2.1+1.21.1-neoforge" = _hWcrqF30;
        "pkg-2.2.2+1.19.2-fabric" = _KsComnvT;
        "pkg-2.2.2+1.19.2-forge" = _nNbrhCD7;
        "pkg-2.2.2+1.20.1-fabric" = _aorjV6CH;
        "pkg-2.2.2+1.20.1-forge" = _2yizqXg8;
        "pkg-2.2.2+25w19a-fabric" = _NFd36YmZ;
        "pkg-2.3.0+1.20.1-fabric" = _vVeqoubm;
        "pkg-2.3.0+1.19.2-fabric" = _HHYCOOEL;
        "pkg-2.3.0+1.20.6-fabric" = _u4dEtTEc;
        "pkg-2.3.0+1.21.1-fabric" = _i97jA37M;
        "pkg-2.3.0+1.21.5-fabric" = _UbuXRyP8;
        "pkg-2.3.0+1.21.4-fabric" = _DjwWGk6h;
        "pkg-2.3.0+1.21.6-fabric" = _e0ZDT5F0;
        "pkg-2.3.0+1.19.2-forge" = _wfhxoJZP;
        "pkg-2.3.0+1.20.1-forge" = _xqwKCyRw;
        "pkg-2.3.0+1.21.1-neoforge" = _tNDxsc8U;
        "pkg-2.3.1+1.21.4-neoforge" = _WHS05uTa;
        "pkg-2.3.1+1.21.5-neoforge" = _nzQj5Qn5;
        "pkg-2.4.0+1.21.5-neoforge" = _1M5GHL8h;
        "pkg-2.4.0+1.21.7-neoforge" = _L7gFlEd6;
        "pkg-2.4.0+1.21.7-fabric" = _3WRjbR0Z;
        "pkg-2.4.0+1.21.4-fabric" = _scpB5MSe;
        "pkg-2.4.0+1.20.1-fabric" = _wcOQR31Y;
        "pkg-2.4.0+1.21.5-fabric" = _YoMQLljQ;
        "pkg-2.4.0+1.21.1-fabric" = _LSlohaUr;
        "pkg-2.4.0+1.21.4-neoforge" = _8Nul0Ief;
        "pkg-2.4.0+1.21.1-neoforge" = _hRc9w313;
        "pkg-2.4.0+1.20.1-forge" = _gF1AUz02;
        "pkg-2.5.0+1.20.1" = _E4f8edVq;
        "pkg-2.5.0+1.21.1" = _Kc8XNZnV;
        "pkg-2.5.0+1.21.4" = _4D7vSZfM;
        "pkg-2.5.0+1.21.5" = _w2diKVmN;
        "pkg-2.5.0+1.21.8" = _Hc9Zycjw;
        "pkg-2.5.0+25w32a" = _gYf8yhBs;
        "pkg-2.5.0+1.21.8-neoforge" = _p1O6Nm7K;
        "pkg-2.5.1+1.20.1-fabric" = _5S4yyZoI;
        "pkg-2.5.1+1.21.1-fabric" = _XsV3NGMr;
        "pkg-2.5.1+1.21.4-fabric" = _kir8C93O;
        "pkg-2.5.1+1.21.5-fabric" = _aWfr3Hkm;
        "pkg-2.5.1+1.21.8-fabric" = _vAYMe97d;
        "pkg-2.5.1+25w34b-fabric" = _1k9VHfRW;
        "pkg-2.5.1+1.20.1-forge" = _O2FxO7tI;
        "pkg-2.5.1+1.21.1-neoforge" = _IDuRZlvj;
        "pkg-2.5.1+1.21.4-neoforge" = _42zAiooq;
        "pkg-2.5.1+1.21.5-neoforge" = _QsfabnyH;
        "pkg-2.5.1+1.21.8-neoforge" = _8Uvdax3i;
        "pkg-2.5.1+25w36b-fabric" = _qIxU3sz4;
        "pkg-2.5.2+1.21.1-fabric" = _7Iqf70tw;
        "pkg-2.5.2+1.21.1-neoforge" = _N6k2PsTW;
        "pkg-2.5.2+1.21.8-fabric" = _JLupf6oe;
        "pkg-2.5.2+1.21.9-pre4" = _acTV6JnN;
        "pkg-2.5.2+1.20.1-forge" = _ol0B8noq;
        "pkg-2.5.2+1.21.8-neoforge" = _icYtF1CD;
        "pkg-2.5.2+1.21.9" = _jWeip531;
        "pkg-2.5.3+1.21.1-fabric" = _ciJncU3E;
        "pkg-2.5.3+1.21.1-neoforge" = _DFXdsKa4;
        "pkg-2.5.3+1.21.8-fabric" = _wgS7CjHs;
        "pkg-2.5.3+1.21.8-neoforge" = _lZQWQahF;
        "pkg-2.5.3+1.21.10-fabric" = _FPKjJuE1;
        "pkg-2.5.3+1.21.10-neoforge" = _ekIFg5pS;
        "pkg-2.5.3+25w41a-fabric" = _Dz2wkJ4b;
        "pkg-2.5.4+1.20.1-fabric" = _XK1EPXKA;
        "pkg-2.5.4+1.21.1-fabric" = _vczb2qhs;
        "pkg-2.5.4+1.21.1-neoforge" = _ZM0DhpmM;
        "pkg-2.5.4+1.21.8-fabric" = _tPx9nFQt;
        "pkg-2.5.4+1.21.8-neoforge" = _NwYN5ba9;
        "pkg-2.5.4+1.21.10-fabric" = _lLX8VF1G;
        "pkg-2.5.4+1.21.10-neoforge" = _wLVkNYGU;
        "pkg-2.5.4+25w41a-fabric" = _b2Itu48X;
        "pkg-2.5.4+1.20.1-forge" = _LD1xqfoY;
        "pkg-2.5.4+25w44a-fabric" = _qrmb64TV;
        "pkg-2.5.5+25w45a-fabric" = _65yevt90;
        "pkg-2.5.5+1.21.1-fabric" = _hScD1wem;
        "pkg-2.5.5+1.21.1-neoforge" = _CWANS5Ep;
        "pkg-2.5.5+1.21.8-fabric" = _8kdZiUs2;
        "pkg-2.5.5+1.21.8-neoforge" = _GAdUrLHj;
        "pkg-2.5.5+1.21.10-fabric" = _GyFeT8dI;
        "pkg-2.5.5+1.21.10-neoforge" = _vdCI6Ami;
        "pkg-2.5.6+1.21.11-pre2-fabric" = _MzwFzU7J;
        "pkg-2.5.6+1.20.1-fabric" = _qtlmdbsT;
        "pkg-2.5.6+1.21.1-fabric" = _R6g3j6eX;
        "pkg-2.5.6+1.21.1-neoforge" = _VMZUWDqz;
        "pkg-2.5.6+1.21.8-fabric" = _6KE35oIb;
        "pkg-2.5.6+1.21.8-neoforge" = _kt9Lihh8;
        "pkg-2.5.6+1.21.10-fabric" = _fe8LkjhQ;
        "pkg-2.5.6+1.21.10-neoforge" = _crvJYPMY;
        "pkg-2.5.7+1.21.1-fabric" = _FUDdPtgO;
        "pkg-2.5.7+1.21.1-neoforge" = _Eu34gn85;
        "pkg-2.5.7+1.21.8-fabric" = _FOPfGQvU;
        "pkg-2.5.7+1.21.8-neoforge" = _yZMeVR4m;
        "pkg-2.5.7+1.21.10-fabric" = _erNBr83b;
        "pkg-2.5.7+1.21.10-neoforge" = _elIesq3N;
        "pkg-2.5.7+1.21.11-rc3-fabric" = _i99aeAxy;
        "pkg-2.5.7+1.21.11-fabric" = _B1QZIIVq;
        "pkg-2.5.8+1.21.1-fabric" = _zoWdoDb8;
        "pkg-2.5.8+1.21.1-neoforge" = _CgbcGemo;
        "pkg-2.5.8+1.21.8-fabric" = _SRWLpK31;
        "pkg-2.5.8+1.21.8-neoforge" = _yckWpfk1;
        "pkg-2.5.8+1.21.10-fabric" = _io4O2qb3;
        "pkg-2.5.8+1.21.10-neoforge" = _Gmatpaml;
        "pkg-2.5.8+1.21.11-fabric" = _6soaKIt0;
        "pkg-2.5.9+1.21.1-neoforge" = _Qu32ESCp;
        "pkg-2.5.9+1.21.8-neoforge" = _vD0INjCQ;
        "pkg-2.5.9+1.21.10-neoforge" = _GmPgjBSK;
        "pkg-2.5.9+1.21.11-neoforge" = _mQ1eLHJU;
        "pkg-2.6.0+1.21.11-neoforge" = _hJm9bOS6;
        "pkg-2.6.0+26.1-snapshot-1-fabric" = _bzsXK2jL;
        "pkg-2.6.0+1.21.11-fabric" = _jrhhbwLX;
        "pkg-2.6.0+1.21.10-fabric" = _q3EH0Wzo;
        "pkg-2.6.0+1.21.10-neoforge" = _JXjB2sWD;
        "pkg-2.6.0+1.21.8-fabric" = _YUaU5TBx;
        "pkg-2.6.0+1.21.8-neoforge" = _jFji5T79;
        "pkg-2.6.0+1.21.1-fabric" = _Za6n6Nqu;
        "pkg-2.6.0+1.21.1-neoforge" = _3OqTzxcs;
        "pkg-2.6.1+1.21.1-fabric" = _m7IL0IiD;
        "pkg-2.6.1+1.21.1-neoforge" = _aW0Ld76a;
        "pkg-2.6.1+1.21.8-fabric" = _klaCIXb2;
        "pkg-2.6.1+1.21.8-neoforge" = _YY8i6E9K;
        "pkg-2.6.1+1.21.10-fabric" = _Ylmfsqab;
        "pkg-2.6.1+1.21.10-neoforge" = _zJonOuc1;
        "pkg-2.6.1+1.21.11-fabric" = _96rZxFtV;
        "pkg-2.6.1+1.21.11-neoforge" = _ilVxVsr8;
        "pkg-2.6.1+26.1-snapshot-1-fabric" = _dfGaxHqU;
        "pkg-2.7.0+1.21.1-fabric" = _SYc4LZla;
        "pkg-2.7.0+1.21.1-neoforge" = _xTilENbw;
        "pkg-2.7.0+1.21.8-fabric" = _3Qba7iIX;
        "pkg-2.7.0+1.21.8-neoforge" = _23AengEv;
        "pkg-2.7.0+1.21.10-fabric" = _kCYjEGR5;
        "pkg-2.7.0+1.21.10-neoforge" = _NxKvOWC3;
        "pkg-2.7.0+1.21.11-fabric" = _aL8wszof;
        "pkg-2.7.0+1.21.11-neoforge" = _kVPrRkD2;
        "pkg-2.7.0+26.1-snapshot-5-fabric" = _YT7XhMh0;
        "pkg-2.7.0+26.1-snapshot-4-neoforge" = _4UYNrm8y;
        "pkg-2.7.1+1.21.1-fabric" = _4GKBmhSX;
        "pkg-2.7.1+1.21.1-neoforge" = _n8aGI2Tr;
        "pkg-2.7.1+1.21.8-fabric" = _j7uCa5g1;
        "pkg-2.7.1+1.21.8-neoforge" = _s4NP7kWu;
        "pkg-2.7.1+1.21.10-fabric" = _s18BCUhz;
        "pkg-2.7.1+1.21.10-neoforge" = _V0p0BccO;
        "pkg-2.7.1+1.21.11-fabric" = _2QIvCfBI;
        "pkg-2.7.1+1.21.11-neoforge" = _JR3Xuckm;
        "pkg-2.7.1+26.1-snapshot-7-fabric" = _IFzn4uaS;
        "pkg-2.7.2+1.21.1-fabric" = _nqOTvmB3;
        "pkg-2.7.2+1.21.1-neoforge" = _3MvmAqB5;
        "pkg-2.7.2+1.21.8-fabric" = _DBGcASXh;
        "pkg-2.7.2+1.21.8-neoforge" = _2WeLKzFK;
        "pkg-2.7.2+1.21.10-fabric" = _OjDuGTgY;
        "pkg-2.7.2+1.21.10-neoforge" = _pbknTtEh;
        "pkg-2.7.2+1.21.11-fabric" = _1M100xyJ;
        "pkg-2.7.2+1.21.11-neoforge" = _w1bR2Cqm;
        "pkg-2.7.2+26.1-snapshot-11-fabric" = _uSbqtcjx;
        "pkg-2.7.3+26.1-rc-1-fabric" = _H14dr5BX;
        "pkg-2.7.3+26.1-fabric" = _UmF61Loz;
        "pkg-2.7.3+26.1-neoforge" = _G2ccFyll;
        "pkg-2.7.3+26.1.1-fabric" = _5DgIhTP5;
        "pkg-2.7.3+26.1.1-neoforge" = _b3v8SyUy;
        "pkg-2.7.3+26.2-snapshot-1-fabric" = _QntQDGPN;
        "pkg-2.7.4+26.1.1-fabric" = _y8tibuqO;
        "pkg-2.7.4+26.1.1-neoforge" = _Z9YcZXOe;
        "pkg-2.7.4+26.2-snapshot-5-fabric" = _x51umBZo;
        "pkg-2.7.5+26.1.2-fabric" = _5USQbRgt;
        "pkg-2.7.5+26.1.2-neoforge" = _EgaIwbx1;
        "pkg-2.7.6+26.1.2-fabric" = _PpvwHlOC;
        "pkg-2.7.6+26.1.2-neoforge" = _JP9aLwLZ;
        "pkg-2.7.6+26.2-snapshot-5-fabric" = _mPjYBFgF;
        "pkg-2.7.7+26.2-snapshot-7-fabric" = _RX6mSuJy;
        "pkg-2.8.0+1.21.1-fabric" = _qgkp5Cw5;
        "pkg-2.8.0+1.21.1-neoforge" = _OrkSfQ0u;
        "pkg-2.8.0+26.1.2-fabric" = _a3bAJSn9;
        "pkg-2.8.0+26.1.2-neoforge" = _WucpslPH;
        "pkg-2.8.0+26.2-pre-6-fabric" = _QLzn66fP;
        "pkg-2.8.1+26.1.2-fabric" = _jTUHCSxA;
        "pkg-2.8.1+26.1.2-neoforge" = _8qe4osCK;
        "pkg-2.8.1+26.2-fabric" = _bXlPrXaJ;
        "pkg-2.8.1+26.2-neoforge" = _xV8CfKxg;
        "pkg-2.8.2+26.2-fabric" = _Sqif41cl;
        "pkg-2.8.3+26.1.2-fabric" = _IAHn7eKt;
        "pkg-2.8.3+26.2-fabric" = _cHFr5eVs;
        "pkg-2.8.3+26.2-neoforge" = _wdogW7EH;
        "pkg-2.8.3+26.1.2-neoforge" = _sB7AisI4;
        "pkg-2.8.4+26.1.2-fabric" = _qkQgAOTT;
