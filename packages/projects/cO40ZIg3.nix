...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.2.2" = _oTOsAULP;
        "pkg-1.19.2-1.1.5" = _yAAkXsNv;
        "pkg-1.19-1.1.6" = _rRp54MDX;
        "pkg-1.20.1-1.2.3" = _jsNF7om6;
        "pkg-1.19-1.1.7" = _5HasBO3o;
        "pkg-1.19-1.1.8" = _p1IqJcyM;
        "pkg-1.20.1-1.2.4" = _GBj04OVN;
        "pkg-1.20.1-1.2.5" = _pyOo10Ll;
        "pkg-1.19-1.1.9" = _imVWjArH;
        "pkg-1.20.1-1.2.6" = _JRr6qDbV;
        "pkg-1.20.1-1.2.7" = _ELKYfsIt;
        "pkg-1.19-1.1.10" = _YzEh0i2W;
        "pkg-1.20.1-1.2.8" = _9mbqNxhz;
        "pkg-1.20.1-1.2.9" = _aHrHODK7;
        "pkg-1.20.1-1.2.10" = _8hVtSJvY;
        "pkg-1.20.1-1.2.11" = _QSr6Be0a;
        "pkg-1.21" = _5PZcagL6;
        "pkg-1.19-1.1.11a" = _rC9jFUFi;
        "pkg-1.21-1.3.0" = _FEe0EqV5;
        "pkg-1.21-1.3.1" = _7PJru5UA;
        "pkg-1.20.1-1.2.12" = _HpvTQCZn;
        "pkg-1.21-1.3.2" = _KAT1DWF0;
        "pkg-1.21-1.3.3" = _qyocTQUb;
        "pkg-1.21-1.3.4" = _jH3wVEds;
        "pkg-1.21-1.3.4a" = _TfczEk7m;
        "pkg-1.21-1.3.5" = _SX4ziPL2;
        "pkg-1.21-1.3.6" = _hQ2k1kkV;
        "pkg-1.21-1.3.7" = _WhqrG9Jq;
        "pkg-1.21-1.4.0" = _jjZrA4tl;
        "pkg-1.21-1.4.1" = _NVh4wHxs;
        "pkg-1.21-1.4.2" = _OYRlW3nE;
        "pkg-1.21-1.4.3" = _uAnCRFyL;
        "pkg-1.20.1-1.2.13" = _qppl3Yso;
        "pkg-1.21-1.5.0" = _e6tpg8my;
        "pkg-1.21-1.5.1" = _HAcE8MTS;
        "pkg-1.21-1.5.2" = _6KQg5p62;
        "pkg-1.21-1.5.3" = _sA9frN1t;
        "pkg-1.21-1.5.4" = _fKCremFg;
        "pkg-1.21-1.5.5" = _sOE4zjiT;
        "pkg-1.19-1.1.12" = _mMaCsAzp;
