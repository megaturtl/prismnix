...
let
    ...
    in {
        ...
        "pkg-1.1.5-forge-mc1.16" = _uyHfVW9n;
        "pkg-1.1.5-forge-mc1.17" = _lrgux01p;
        "pkg-1.1.5-forge-mc1.18" = _NEPPIgab;
        "pkg-1.1.6-forge-mc1.12" = _uuJRv1WR;
        "pkg-1.1.6-forge-mc1.14" = _FqY3rNWX;
        "pkg-1.1.6-forge-mc1.15" = _AJDxiyoL;
        "pkg-1.1.6-forge-mc1.16" = _VDF9YIVl;
        "pkg-1.1.6-forge-mc1.17" = _U4EHlb87;
        "pkg-1.1.6-forge-mc1.18" = _UCWUFlck;
        "pkg-1.1.6-forge-mc1.19" = _tTZHDY7L;
        "pkg-1.1.6a-forge-mc1.19" = _kiJlShdA;
        "pkg-1.1.6-forge-mc1.19.3" = _Y2AHM4jV;
        "pkg-1.1.7-forge-mc1.19.3" = _dWqbkCW3;
        "pkg-1.1.7-forge-mc1.19" = _X4EU0KBN;
        "pkg-1.1.7-forge-mc1.18" = _wKPDlA7E;
        "pkg-1.1.7-forge-mc1.17" = _iMHjy6Cp;
        "pkg-1.1.7-forge-mc1.16" = _KDjzpwfj;
        "pkg-1.1.7-forge-mc1.15" = _SZzFmYtD;
        "pkg-1.1.7-forge-mc1.14" = _4VdSMcj3;
        "pkg-1.1.7-forge-mc1.12" = _IlTfYyuD;
        "pkg-1.1.8-forge-mc1.12" = _A1gJQ1Qz;
        "pkg-1.1.8-forge-mc1.14" = _4My2QXIN;
        "pkg-1.1.8-forge-mc1.15" = _nAaqoyq3;
        "pkg-1.1.8-forge-mc1.16" = _EhjaLhY9;
        "pkg-1.1.8-forge-mc1.17" = _tCeDsHEO;
        "pkg-1.1.8-forge-mc1.18" = _OyKPmaPd;
        "pkg-1.1.8-forge-mc1.19" = _C1cNqoHp;
        "pkg-1.1.8-forge-mc1.19.3" = _klNVb01n;
        "pkg-1.1.8-fabric-mc1.18" = _z6me4VCA;
        "pkg-1.1.8-fabric-mc1.19" = _xUJnUg2I;
        "pkg-1.1.9-forge-mc1.12" = _98wMQADE;
        "pkg-1.1.9-forge-mc1.14" = _WeCGPU2I;
        "pkg-1.1.9-forge-mc1.15" = _Ry4RuKkz;
        "pkg-1.1.9-forge-mc1.16" = _FQD0yhqu;
        "pkg-1.1.9-forge-mc1.17" = _tFDK4f9X;
        "pkg-1.1.9-forge-mc1.18" = _X3VTsb4R;
        "pkg-1.1.9-forge-mc1.19" = _jFbWAiHu;
        "pkg-1.1.9-forge-mc1.19.3" = _q7fOZlMb;
        "pkg-1.1.9-fabric-mc1.18" = _UnyhJ4ay;
        "pkg-1.1.9-fabric-mc1.19" = _5X9vjcrL;
        "pkg-1.1.9-forge-mc1.19.4" = _Guskrivt;
        "pkg-1.1.9-forge-mc1.20" = _XBGc6NWp;
        "pkg-1.1.9-fabric-mc1.20" = _eaeHp2lj;
        "pkg-1.1.10-forge-mc1.12" = _Me8i6k3J;
        "pkg-1.1.10-forge-mc1.14" = _RAN3mDsm;
        "pkg-1.1.10-forge-mc1.15" = _AL5vPpja;
        "pkg-1.1.10-forge-mc1.16" = _Jp2JeSke;
        "pkg-1.1.10-forge-mc1.17" = _Gdut4iOg;
        "pkg-1.1.10-forge-mc1.18" = _g70mWtoU;
        "pkg-1.1.10-forge-mc1.19" = _kAOchqRh;
        "pkg-1.1.10-forge-mc1.19.3" = _r5BPiIfZ;
        "pkg-1.1.10-forge-mc1.19.4" = _ruIRRAW2;
        "pkg-1.1.10-forge-mc1.20" = _jQQOPaDp;
        "pkg-1.1.10-fabric-mc1.18" = _wM4rPsIJ;
        "pkg-1.1.10-fabric-mc1.19.2" = _AwkqDxdM;
        "pkg-1.1.10-fabric-mc1.19.4" = _8WBFwU4h;
        "pkg-1.1.10-fabric-mc1.20" = _AMs94AkX;
        "pkg-1.1.11-forge-mc1.12" = _oBJ1Pf1y;
        "pkg-1.1.11-forge-mc1.14" = _c2vVBJOC;
        "pkg-1.1.11-forge-mc1.15" = _gsSQrnCw;
        "pkg-1.1.11-forge-mc1.16" = _JoMi8Dbo;
        "pkg-1.1.11-forge-mc1.17" = _cnaF3ID1;
        "pkg-1.1.11-forge-mc1.18" = _wRDL0xFi;
        "pkg-1.1.11-forge-mc1.19" = _kbOz0Mb5;
        "pkg-1.1.11-forge-mc1.19.3" = _gEJQDIZ3;
        "pkg-1.1.11-forge-mc1.19.4" = _HnC3wePT;
        "pkg-1.1.11-forge-mc1.20" = _YaariLTl;
        "pkg-1.1.11-fabric-mc1.18" = _8fuDyN9Q;
        "pkg-1.1.11-fabric-mc1.19.2" = _Lt9OFZ53;
        "pkg-1.1.11-fabric-mc1.19.4" = _1a0Xvucc;
        "pkg-1.1.11-fabric-mc1.20" = _a5jw50Sq;
        "pkg-1.1.11a-forge-mc1.20" = _3a2igNv8;
        "pkg-1.1.11b-forge-mc1.20" = _IZsMjARK;
        "pkg-1.1.11c-forge-mc1.20" = _VdNyKZK8;
        "pkg-1.1.11d-forge-mc1.20" = _1CDqHmvJ;
        "pkg-1.1.11d-neoforge-mc1.20.4" = _3SBcOrAK;
        "pkg-1.1.11a-forge-mc1.17" = _PZHy9wom;
        "pkg-1.1.11a-forge-mc1.18" = _QBh88sbb;
        "pkg-1.1.11a-forge-mc1.19" = _tXLRs8A7;
        "pkg-1.1.11a-forge-mc1.19.3" = _OqYPTFav;
        "pkg-1.1.11a-forge-mc1.19.4" = _6GrIqSSV;
        "pkg-1.1.11e-forge-mc1.20" = _m34M9yrw;
        "pkg-1.1.11a-fabric-mc1.18" = _TvetsbI9;
        "pkg-1.1.11a-fabric-mc1.19.2" = _sOEsPpZe;
        "pkg-1.1.11a-fabric-mc1.19.4" = _sn2gjhbA;
        "pkg-1.1.11a-fabric-mc1.20" = _AOIPgdyk;
        "pkg-1.1.11a-neoforge-mc1.20.4" = _DGfSvjQJ;
        "pkg-1.1.11-forge-mc1.20.6" = _6jh9XYwH;
        "pkg-1.1.11-forge-mc1.21" = _25eOjjXZ;
        "pkg-1.1.11-fabric-mc1.20.6" = _zq0o0ksL;
        "pkg-1.1.11-fabric-mc1.21" = _UB84qyfC;
        "pkg-1.1.11-neoforge-mc1.20.6" = _de6ROfIX;
        "pkg-1.1.11-neoforge-mc1.21" = _lxaCCvFJ;
        "pkg-1.1.11a-forge-mc1.20.6" = _OPNvii8j;
        "pkg-1.1.11a-forge-mc1.21" = _Vir2Yndl;
        "pkg-1.1.11a-fabric-mc1.20.6" = _A6GnYLaj;
        "pkg-1.1.11a-fabric-mc1.21" = _V9F8MFr7;
        "pkg-1.1.11a-neoforge-mc1.20.6" = _b3lti3Wh;
        "pkg-1.1.11a-neoforge-mc1.21" = _ItAjFaTb;
        "pkg-1.1.11-fabric-mc1.21.2" = _D6XD8IBA;
        "pkg-1.1.11-neoforge-mc1.21.3" = _P8OF1e14;
        "pkg-1.1.11-forge-mc1.21.3" = _HOxj65mP;
        "pkg-1.1.11-forge-mc1.21.4" = _rQWZaJ6r;
        "pkg-1.1.11-fabric-mc1.21.4" = _5NafsPzf;
        "pkg-1.1.11-neoforge-mc1.21.4" = _2bedKQfF;
        "pkg-1.1.11-forge-mc1.21.5" = _hrWGfI7w;
        "pkg-1.1.11-forge-mc1.21.6" = _GMc55LoR;
        "pkg-1.1.11-fabric-mc1.21.5" = _6x8sMNi9;
        "pkg-1.1.11-fabric-mc1.21.6" = _a9IGVmxx;
        "pkg-1.1.11-neoforge-mc1.21.5" = _7jV2BxLK;
        "pkg-1.1.11-neoforge-mc1.21.6" = _Me8s4Wnl;
        "pkg-1.1.11d-forge-mc1.20.4" = _CYdp5NDb;
        "pkg-1.1.11-forge-mc1.21.10" = _Ma93LE7j;
        "pkg-1.1.11-fabric-mc1.21.10" = _1BjsrYxy;
        "pkg-1.1.11-neoforge-mc1.21.10" = _hZU1N3uP;
        "pkg-1.1.11-forge-mc1.21.11" = _kTVxHJpi;
        "pkg-1.1.11-fabric-mc1.21.11" = _byhjJvbs;
        "pkg-1.1.11-neoforge-mc1.21.11" = _GUOJ0cK4;
        "pkg-1.1.11-forge-mc26.1" = _E8jmvn3b;
        "pkg-1.1.11-fabric-mc26.1" = _kMEDUq9z;
        "pkg-1.1.11-neoforge-mc26.1" = _LgTegER7;
