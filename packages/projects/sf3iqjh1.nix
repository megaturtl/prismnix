...
let
    versions = (let
        ...
        _cFVyiy81 = {
            "id" = "cFVyiy81";
            "file" = "local-locator-1.1.0+26.2.jar";
            "hash" = "sha512-OzT/7ak9p7G8ZyVAn5nlB3uX4wUGKZ85r/7bux77pZTQwN3dcBYWWTPZ53W4kZ0qC/b8I3eJZbRCNk5ZdZmzMg==";
        };
    in {
        "uoq005Y7" = _uoq005Y7;
        "4L5dwqx7" = _4L5dwqx7;
