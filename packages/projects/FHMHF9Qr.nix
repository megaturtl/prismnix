...
let
    ...
    in {
        ...
        "pkg-1.20.1-0.4.1" = _UUuf9jn5;
        "pkg-1.20.1-0.5.0" = _epKwqsNA;
        "pkg-1.20.1-0.6.0" = _1Kg4rykL;
        "pkg-1.20.1-0.7.0" = _OxB5NzAW;
        "pkg-1.20.1-0.8.1" = _kv2VRVMA;
        "pkg-1.20.1-0.9.0" = _CtsBNnwC;
        "pkg-1.21.1-0.9.1" = _Pwm80Joe;
        "pkg-1.21.1-0.9.2" = _wnEzfuHA;
        "pkg-1.20.1-0.10.1" = _Gil4Xcrv;
        "pkg-1.21.1-0.10.0" = _7VpTis6M;
        "pkg-1.21.1-0.10.1" = _cHYhNYQg;
        "pkg-1.20.1-0.11.0" = _rvUg72In;
        "pkg-1.21.1-0.10.2" = _3SqtoOyE;
        "pkg-1.20.1-0.11.1" = _vQQianvJ;
        "pkg-1.21.1-0.10.3" = _2h0UT1Vq;
        "pkg-1.20.1-0.11.2" = _HAbn0vPD;
        "pkg-1.21.1-0.10.4" = _MGZ0ttnL;
        "pkg-1.20.1-0.11.3" = _62PubN8L;
        "pkg-1.21.1-0.10.5" = _mErOn4jg;
        "pkg-1.21.1-0.11.0" = _z1C2hal7;
        "pkg-1.21.1-0.11.1" = _FGBPV40z;
        "pkg-1.21.1-0.12.0" = _bulD3KiN;
