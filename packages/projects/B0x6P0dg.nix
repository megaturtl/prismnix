...
let
    versions = (let
        ...
        _9xRErNbQ = {
            "id" = "9xRErNbQ";
            "file" = "embellish-chat-3.8.0+1.21.0.jar";
            "hash" = "sha512-0CXnUjUB9tyORuSQlMu3lpaZmSx8xZvrDpzLwiL5bscQsyEHor6eOgB4T30ZC2no1iCXo1z/0NN2/sei7Ez1vw==";
        };
        _DCjMUBNf = {
            "id" = "DCjMUBNf";
            "file" = "embellish-chat-3.8.0+1.21.11.jar";
            "hash" = "sha512-oUKjUYPcW5STLZhXiW8/ePe080PCNSLLjO/4cUD5532XfKgiuarK9jK5h9k4BHldiuzaKI6o5ETRyRUNk6RJ4A==";
        };
        _ReUJ6Zi7 = {
            "id" = "ReUJ6Zi7";
            "file" = "embellish-chat-3.8.0+26.1.jar";
            "hash" = "sha512-ZP5ylcSlUOCKrx09/L3id2dWg4h0cgRS/2Y7YASt4Sd2yKPf0+iHcRHuBWTUK+fOxhCYOLdGY+dB5ziGe6HqBw==";
        };
        _oiwZb3SW = {
            "id" = "oiwZb3SW";
            "file" = "embellish-chat-3.8.0+26.2.jar";
            "hash" = "sha512-aqybFSSjaFxH/+wF13dcD6ztF2sk+r/127ApeN5BZP0jvXmUcUx6FS9hC+p7zf14LKQTKZZQgTzu2VDq+0JUXA==";
        };
        _mgN0qLcl = {
            "id" = "mgN0qLcl";
            "file" = "embellish-chat-3.8.0+26.3.jar";
            "hash" = "sha512-jLDKz608EIZlI6ymXYZsRdVuadBKtzSl2AaAik+N+1rpZAhHkKuT+xgj0ErRJKrUjByJBgOqcxeqLJE/3au+GQ==";
        };
    in {
        "CilDuD2z" = _CilDuD2z;
        "7GRF96iI" = _7GRF96iI;
        ...
        "fabric-1.21" = _9xRErNbQ;
        "fabric-1.21.1" = _9xRErNbQ;
        "fabric-26.1-pre-3" = _lgwGxxzD;
        "fabric-26.1-rc-1" = _lgwGxxzD;
        "fabric-26.1-rc-2" = _lgwGxxzD;
        "fabric-26.1-rc-3" = _lgwGxxzD;
        "fabric-26.1" = _ReUJ6Zi7;
        "fabric-26.1.1" = _ReUJ6Zi7;
        "fabric-26.1.2" = _ReUJ6Zi7;
        ...
        "pkg-3.3.0" = _BTXxOkJ5;
        "pkg-3.4.0" = _ddGCx2JF;
        "pkg-3.4.1+1.21.11" = _7m6wIiWD;
        "pkg-3.4.1+1.21.9" = _EUusHCyW;
        "pkg-3.4.1+1.21.6" = _yfNHz77Z;
        "pkg-3.4.1+1.21.5" = _serXqBnL;
        "pkg-3.4.1+1.21.2" = _ZLU7MMOx;
        "pkg-3.4.1+1.21" = _m9MG6waE;
        "pkg-3.5.0+26.1" = _wXqrnUYy;
        "pkg-3.5.0+26.1-beta1" = _jjiNlTE7;
        "pkg-3.5.0+26.1-beta2" = _mUECPCuX;
        "pkg-3.5.0+1.21" = _QBsrtTIU;
        "pkg-3.5.0+1.21.6" = _xEE2K0ge;
        "pkg-3.5.0+1.21.9" = _oF9VwZF4;
        "pkg-3.5.0+1.21.11" = _YMdRwosW;
        "pkg-3.5.1+1.21" = _n0wy4zdG;
        "pkg-3.5.1+1.21.6" = _2hs23Mk1;
        "pkg-3.5.1+1.21.9" = _j5Pmgyli;
        "pkg-3.5.1+1.21.11" = _Vb10Si8X;
        "pkg-3.5.1+26.1" = _Sscfc2Y7;
        "pkg-3.5.1+26.2-alpha1" = _pNe3Amgv;
        "pkg-3.5.1+26.2-alpha2" = _yGIvRjVd;
        "pkg-3.6.0+26.1-beta1" = _WfYVpjzO;
        "pkg-3.6.0+26.1-beta2" = _oDhkMrOM;
        "pkg-3.6.0+1.21" = _xPGqWKne;
        "pkg-3.6.0+1.21.11" = _WYaU4Rkh;
        "pkg-3.6.0+26.1" = _AGBBHQOK;
        "pkg-3.6.1+1.21" = _dz0q0oRm;
        "pkg-3.6.1+1.21.11" = _RKyLw5LN;
        "pkg-3.6.1+26.1" = _y75bhhRh;
        "pkg-3.7.0+26.2-alpha1" = _M6NS7PiB;
        "pkg-3.7.0+26.2-alpha2" = _QpanNbWc;
        "pkg-3.7.0+26.2-beta1" = _duZOYxUN;
        "pkg-3.7.0+26.2-beta2" = _qlfj2Rmq;
        "pkg-3.7.0+1.21" = _uhkodBjM;
        "pkg-3.7.0+1.21.6" = _i3V2uYNW;
        "pkg-3.7.0+1.21.9" = _JZG3dahz;
        ...
        "pkg-3.8.0+1.21" = _9xRErNbQ;
        "pkg-3.8.0+1.21.11" = _DCjMUBNf;
        "pkg-3.8.0+26.1" = _ReUJ6Zi7;
        "pkg-3.8.0+26.2" = _oiwZb3SW;
        "pkg-3.8.0+26.3" = _mgN0qLcl;
        "default" = _mgN0qLcl;
    });
