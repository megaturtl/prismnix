...
let
    versions = (let
        ...
        _dF813AUZ = {
            "id" = "dF813AUZ";
            "file" = "CameraTweaks-1.11.2-26.3.jar";
            "hash" = "sha512-YpaFW5LmcSM72hK9kHemSdxGsP4irbiWNVMS4QRhtgfCJbGN84FIZ6UHKn3e14FoTYNMj48AhRk4uo7dM/B7Tw==";
        };
    in {
        "uK1m6kXZ" = _uK1m6kXZ;
        "1YQ9xuGC" = _1YQ9xuGC;
