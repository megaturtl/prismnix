...
let
    versions = (let
        ...
        _gJjYjHuQ = {
            "id" = "gJjYjHuQ";
            "file" = "witcher-class-mod-neoforge-3.0.0+1.21.1.jar";
            "hash" = "sha512-aFMp4T/BeneU98oavWXvz5XBMkZx92m8GLhRHm/TWqgdZLuhps7mDnY3cWzKz1wTfMn4m1gIcGseIo+6YYR2Rw==";
        };
        _FRx2cZqG = {
            "id" = "FRx2cZqG";
            "file" = "witcher-class-mod-fabric-3.0.0+1.21.1.jar";
            "hash" = "sha512-Ys0FpLZkWBXuA7ilZmfviBd0aJ4Dxg+LvaYKtjI/5fi39Jcl9KrcVnplQ134l8kLWFbQLRY4t0zA2IWEpCvk+w==";
        };
        _OPuPacOd = {
            "id" = "OPuPacOd";
            "file" = "witcher-class-mod-1.2.5-1.20.1.jar";
            "hash" = "sha512-PULaDTXBhnQGYoVfQrMGqUUX2vuNrtCuqKpjZMBQOLvb5FO1ile40dAwk6qCyNqxWBlfPrt+xogkNv7/N4Ik3w==";
        };
        _O31KgVJs = {
            "id" = "O31KgVJs";
            "file" = "witcher-class-mod-fabric-3.1.0+1.21.1.jar";
            "hash" = "sha512-NvBAZ/CtJiAkpyZxWhH3Hl1/U07jYzTZiE7g6tTPjcn16hCg2qVSCXt3Iq0IQUS2BAyI9Kwy8vKWx3t1XNemng==";
        };
        _L18vNMnQ = {
            "id" = "L18vNMnQ";
    ...
    in {
        ...
        "pkg-1.1.1" = _5ca44KlV;
        "pkg-1.1.2" = _fOZAUR2q;
        "pkg-2.0.0-1.21" = _gVsgW9yJ;
        "pkg-2.0.1-1.21" = _mK80RdWb;
        "pkg-2.0.2-1.21" = _UIakwaYA;
        "pkg-2.0.3-1.21" = _Hn61t3Gz;
        "pkg-1.1.3-1.20.1" = _uCzOUexQ;
        "pkg-2.0.4-1.21" = _vjYk0xcH;
        "pkg-1.1.4-1.20.1" = _99j8ccT8;
        "pkg-2.0.5-1.21" = _qdjVn45C;
        "pkg-2.1.0-1.21" = _1IuYfzc5;
        "pkg-2.2.0-1.21" = _BJYQmGMg;
        "pkg-1.1.5-1.20.1" = _7Xjpky5K;
        "pkg-2.2.1-1.21" = _X1sJRkol;
        "pkg-2.2.2-1.21" = _Azg4B7CB;
        "pkg-2.2.3-1.21" = _g1wIydbL;
        "pkg-2.2.4-1.21" = _Mw7AY64K;
        "pkg-1.1.6-1.20.1" = _aZ4EoXLN;
        "pkg-2.3.0-1.21" = _DmMezRME;
        "pkg-1.2.0-1.20.1" = _oRRtdN79;
        "pkg-1.2.1-1.20.1" = _I7udmsZe;
        "pkg-2.3.1-1.21" = _DLXEXDw8;
        "pkg-2.4.0-1.21" = _moGSTEsu;
        "pkg-2.4.1-1.21" = _twJAyEab;
        "pkg-2.4.2-1.21" = _mK3SJrBn;
        "pkg-1.2.2-1.20.1" = _vkTRL5zY;
        "pkg-2.4.3-1.21" = _Py7K9fdA;
        "pkg-2.4.4-1.21" = _L6PCAyis;
        "pkg-2.4.5-1.21" = _4D6T0uJ5;
        "pkg-2.4.6-1.21" = _DZmHhu7s;
        "pkg-2.4.7-1.21" = _FXzGgdUF;
        "pkg-2.4.8-1.21" = _Ycb8cClL;
        "pkg-2.4.9-1.21.1" = _U1HkoNCL;
        "pkg-2.4.10-1.21.1" = _3ZpJkjJp;
        "pkg-2.4.11-1.21.1" = _tccNFmvd;
        "pkg-2.5.0-1.21.1" = _fReILuTR;
        "pkg-2.5.1-1.21.1" = _NdAvRYQ2;
        "pkg-2.5.2-1.21.1" = _e0c2EkNY;
        "pkg-2.6.0+1.21.1-fabric" = _mAMARCwA;
        "pkg-2.6.0+1.21.1-neoforge" = _TGLp5jLS;
        "pkg-2.6.1+1.21.1-neoforge" = _xLYuhYjJ;
        "pkg-2.6.1+1.21.1-fabric" = _xPEi3NaW;
        "pkg-1.2.3-1.20.1" = _o80xOw3L;
        "pkg-2.6.2+1.21.1-fabric" = _1ekqs6RW;
        "pkg-2.6.2+1.21.1-neoforge" = _6BmNw46q;
        "pkg-2.6.3+1.21.1-fabric" = _Y15k7SRn;
        "pkg-2.6.3+1.21.1-neoforge" = _F75h4eKx;
        "pkg-2.7.0+1.21.1-fabric" = _xaoy1hDZ;
        "pkg-2.7.0+1.21.1-neoforge" = _1LsMwkOj;
        "pkg-2.7.1+1.21.1-neoforge" = _7ZZsN6Kl;
        "pkg-2.7.1+1.21.1-fabric" = _3VRAjJTk;
        "pkg-2.7.2+1.21.1-neoforge" = _qBfnM8aZ;
        "pkg-2.7.2+1.21.1-fabric" = _9Mw5sQ9i;
        "pkg-2.8.0+1.21.1-fabric" = _FQWB4qPW;
        "pkg-2.8.0+1.21.1-neoforge" = _kNwJCFSQ;
        "pkg-1.2.4-1.20.1" = _GEaPt4zu;
        "pkg-2.8.1+1.21.1-fabric" = _Vbn6fTk7;
        "pkg-2.8.1+1.21.1-neoforge" = _Q0GOX43Z;
        "pkg-3.0.0+1.21.1-neoforge" = _gJjYjHuQ;
        "pkg-3.0.0+1.21.1-fabric" = _FRx2cZqG;
