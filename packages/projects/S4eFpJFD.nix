...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.6-forge" = _M0AtD8Bo;
        "pkg-1.18.2-1.7-forge" = _SlK6Axrg;
        "pkg-1.19.2-1.9-forge" = _G3aY69MB;
        "pkg-1.16.5-2.2-fabric" = _BMUIBRWd;
        "pkg-1.18.2-2.2-fabric" = _JPaudLKu;
        "pkg-1.19.2-2.2-fabric" = _8MzFGKGW;
        "pkg-1.19.3-2.3-fabric" = _uePn7KAz;
        "pkg-1.19.3-1.9-forge" = _JXOb8ZFl;
        "pkg-1.18.2-3.0-forge+fabric" = _iARI4Gwp;
        "pkg-1.19.2-3.0-forge+fabric" = _oHo2mrt9;
        "pkg-1.19.3-3.0-forge+fabric" = _LVE6xKXP;
        "pkg-1.18.2-3.1-forge+fabric" = _bOZtKX4w;
        "pkg-1.19.2-3.1-forge+fabric" = _XSoAqeek;
        "pkg-1.19.3-3.1-forge+fabric" = _vZTmBxIs;
        "pkg-1.19.4-3.1-forge+fabric" = _SGpinv5s;
        "pkg-1.20-3.1-forge+fabric" = _4n8dLhhH;
        "pkg-1.20.1-3.1-forge+fabric" = _szpXHp09;
        "pkg-1.20.2-3.1-forge+fabric" = _elQDkNSv;
        "pkg-1.18.2-3.2-forge+fabric" = _JX3zXMz7;
        "pkg-1.19.2-3.2-forge+fabric" = _XhBi3Yrr;
        "pkg-1.20.1-3.2-forge+fabric" = _do7bKs7q;
        "pkg-1.20.2-3.2-forge+fabric" = _YurgGwZB;
        "pkg-1.20.3-3.2-fabric+forge+neo" = _OkxVS2tv;
        "pkg-1.20.4-3.2-fabric+forge+neo" = _z7utmo1p;
        "pkg-1.19.2-3.3-fabric+forge+neo" = _DGbzoQkR;
        "pkg-1.20.1-3.3-fabric+forge+neo" = _iExKNCaT;
        "pkg-1.20.2-3.3-fabric+forge+neo" = _x7qHhjmg;
        "pkg-1.20.4-3.3-fabric+forge+neo" = _hxgR9nMw;
        "pkg-1.20.5-3.3-fabric+neo" = _eJRp53SE;
        "pkg-1.20.6-3.3-fabric+forge+neo" = _U4ejyALC;
        "pkg-1.21.0-3.3-fabric+forge+neo" = _bykLW7lC;
        "pkg-1.20.1-3.4-fabric+forge+neo" = _OJ5DX2u5;
        "pkg-1.20.6-3.4-fabric+forge+neo" = _YYdpc679;
        "pkg-1.21.0-3.4-fabric+forge+neo" = _mnmvCYKx;
        "pkg-1.21.1-3.4-fabric+forge+neo" = _BSgqaRCQ;
        "pkg-1.21.2-3.4-fabric+neo" = _G8e3HDYO;
        "pkg-1.21.3-3.4-fabric+forge+neo" = _k3n5GpZL;
        "pkg-1.21.4-3.4-fabric+forge+neo" = _nVoF7xZ8;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _d8t8ljrP;
        "pkg-1.21.1-3.5-fabric+forge+neo" = _Z0rZ5Cbh;
        "pkg-1.21.4-3.5-fabric+forge+neo" = _ZoUjib60;
        "pkg-1.21.5-3.5-fabric+forge+neo" = _50tk8oqe;
        "pkg-1.21.6-3.5-fabric+forge+neo" = _B1sMc49w;
        "pkg-1.21.7-3.5-fabric+forge+neo" = _80V9xgBk;
        "pkg-1.21.8-3.5-fabric+forge+neo" = _BwAefCyG;
        "pkg-1.21.9-3.5-fabric+forge+neo" = _9cvugBPE;
        "pkg-1.21.10-3.5-fabric+forge+neo" = _5XCL44iJ;
        "pkg-1.21.11-3.5-fabric+forge+neo" = _M9hSL5d6;
        "pkg-26.1.0-3.5-fabric+forge+neo" = _wEsPmA48;
