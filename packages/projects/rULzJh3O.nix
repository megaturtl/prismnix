...
let
    versions = (let
        ...
        _b9plbkCS = {
            "id" = "b9plbkCS";
            "file" = "additional_rpg_jewelry-fabric-2.3.0+1.21.1.jar";
            "hash" = "sha512-evlsKM9zslzQf5fk9i5s1CN+jnOO+aHOu5EoMQWa3l0LuEG63rWyW2r5tDRDlHgZgPPeVHjKjMXcO353bOnwpw==";
        };
        _1mpzySyN = {
            "id" = "1mpzySyN";
            "file" = "additional_rpg_jewelry-neoforge-2.3.0+1.21.1.jar";
            "hash" = "sha512-SKlPioHrTicAgsA0xpmXjqsydC13ecIIpysy/ghT+/vxn/Rcoq/OwJY8La9gLVzSKwgm7mGo+DvuVXNwxmiIrA==";
        };
        _VZIAIGTx = {
            "id" = "VZIAIGTx";
            "file" = "additional_rpg_jewelry-fabric-2.3.1+1.21.1.jar";
            "hash" = "sha512-ATVK9DyoGsjNa+YHRsDEqUrxFtd4RalqWxTwE1bgTaxe5aWe60PbysGhmIPh7z/WBuxA5aBnvjDi6Bc4vYr2aQ==";
        };
        _FtXm9snY = {
            "id" = "FtXm9snY";
    ...
    in {
        ...
        "pkg-1.0.4" = _oyiT3nxM;
        "pkg-1.0.5" = _O9zK11NQ;
        "pkg-2.0.0-1.21.1" = _RTlzIth1;
        "pkg-1.0.6" = _RqcAN3Fn;
        "pkg-2.0.1-1.21.1" = _1cOUX5R9;
        "pkg-1.0.7-1.20.1" = _85Rn6NyH;
        "pkg-2.0.2-1.21.1" = _U6Gnam8W;
        "pkg-1.0.8-1.20.1" = _9ErxCU17;
        "pkg-1.0.9-1.20.1" = _AhTxXFac;
        "pkg-2.0.3-1.21.1" = _6KfjpQax;
        "pkg-2.0.4-1.21.1" = _mbsVgvVV;
        "pkg-2.0.5-1.21.1" = _50Mbfe8j;
        "pkg-1.1.0-1.20.1" = _poWy8FSE;
        "pkg-2.1.0-1.21.1" = _meO7G4ik;
        "pkg-1.1.1-1.20.1" = _REsxjAir;
        "pkg-2.1.1-1.21.1" = _yDqLF0kI;
        "pkg-2.2.0+1.21.1-fabric" = _PAtNoajK;
        "pkg-2.2.0+1.21.1-neoforge" = _BDaweknF;
        "pkg-2.2.1+1.21.1-fabric" = _sa7fKnsS;
        "pkg-2.2.1+1.21.1-neoforge" = _3k4uv1hn;
        "pkg-2.2.2+1.21.1-fabric" = _NhsVPAO5;
        "pkg-2.2.2+1.21.1-neoforge" = _tbF4VzZ5;
        "pkg-2.3.0+1.21.1-fabric" = _b9plbkCS;
