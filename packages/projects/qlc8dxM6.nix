...
let
    ...
    in {
        ...
        "pkg-0.6.8" = _zd0YXOM3;
        "pkg-0.6.9" = _KUEUYySJ;
        "pkg-0.6.10" = _IM5UcDgV;
        "pkg-0.6.11" = _btmZiIGP;
        "pkg-0.6.12" = _QLEUSzCF;
        "pkg-0.6.13" = _Ohlm6qTM;
        "pkg-0.6.14" = _GehaxVKC;
        "pkg-0.6.15" = _cnavYEDN;
        "pkg-0.6.17" = _OHMfpWkw;
        "pkg-0.6.18" = _EIGoBrW7;
        "pkg-0.6.19" = _ohoYFfek;
        "pkg-0.6.20" = _WffaZrZ4;
        "pkg-0.2.2" = _NJiThdq2;
        "pkg-0.6.21" = _IVYYjdmQ;
        "pkg-0.6.22" = _xd7Xq7NX;
        "pkg-0.6.23" = _LV2pql6b;
        "pkg-0.6.24" = _ydkoKM60;
        "pkg-0.6.25" = _iSgW2DXR;
        "pkg-0.6.26" = _FTxKGSlD;
        "pkg-0.6.27" = _gww3AjCv;
        "pkg-0.6.28" = _w8ci6ZxX;
        "pkg-0.6.29" = _MTFcL0gR;
        "pkg-0.6.30" = _IZle7E0g;
        "pkg-0.6.31" = _wRQw2Zkd;
        "pkg-0.6.32" = _MPkc2UHQ;
        "pkg-0.6.33" = _IpcucL5c;
        "pkg-0.6.34" = _PvruMtNt;
        "pkg-0.6.35" = _sy89BEhW;
        "pkg-0.6.36" = _mur36P0o;
        "pkg-0.6.37" = _muC1kxAQ;
        "pkg-0.6.38" = _gIBv23F5;
        "pkg-0.6.39" = _pZOS9S9c;
        "pkg-0.6.40" = _GvRhCsu9;
        "pkg-0.6.41" = _jknJCGpV;
        "pkg-0.6.42" = _pyaPGJAG;
        "pkg-0.6.43" = _Jjn1AWcR;
        "pkg-0.6.44" = _kwE9oTO8;
