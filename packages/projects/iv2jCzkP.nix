...
let
    versions = (let
        ...
        _m3CikSWh = {
            "id" = "m3CikSWh";
            "file" = "xmxw-2.12.0+1.20.1-forge.jar";
            "hash" = "sha512-UBQos3cvVKRLuBdmk4uCa9t2TudJBqCjAjITj9Cn0lufmiLPzqGIQ01bt18V6sHDY2vFMfJKiXm87+a7gwYkcw==";
        };
        _l3BU4mYz = {
            "id" = "l3BU4mYz";
            "file" = "xmxw-2.12.0+1.20.1-fabric.jar";
            "hash" = "sha512-3TPVQpycDQIYYfU66mYXUf5qt+KLSIs7EWV62/lb0MuwVGZUUECIIKXXL1HtbeYEoIp1S2THpvTOwQI1HXNSAw==";
        };
        _1gMZSWXf = {
            "id" = "1gMZSWXf";
            "file" = "xmxw-2.12.0+1.20.4-neoforge.jar";
            "hash" = "sha512-B5kGUPMJwk65OA02ny1SewY0QOP3Wi5q2bBhquSwAPhCdAqVn77wa4LKIysdatZXrZ+uB9IT79seX+Td55V5Vg==";
        };
        _zWcr6EEj = {
            "id" = "zWcr6EEj";
            "file" = "xmxw-2.12.0+1.21.1-neoforge.jar";
            "hash" = "sha512-TQAU9jTOWz9fpL9J7Rl6MbYpY4M/ONO5E12Jm2ooHPtdyGNnEadokAIuvSIBvgxDg3FPoZtO0UeOGCeTfERQ4Q==";
        };
        _msev7Kdw = {
            "id" = "msev7Kdw";
            "file" = "xmxw-2.12.0+1.21.1-fabric.jar";
            "hash" = "sha512-4CHV4e0dPe8bWz2G6SHOw04tL2B+0IpvdbQvCCg4Wed5RpJlYq2G6B8e9MwKyfkckJMqdotbjIUWQf1w6ym5Fg==";
        };
        _ANYCmmxL = {
            "id" = "ANYCmmxL";
            "file" = "xmxw-2.12.0+1.21.6-neoforge.jar";
            "hash" = "sha512-JOyBHf1arEMVihiyOY4+n+axh1I+iCW+NGUqw44hBhdPD6x7G/9uMwmtCZ4UjbXviea6Sa1es+6Y4BHEmkcmPA==";
        };
        _iHFbZP42 = {
            "id" = "iHFbZP42";
            "file" = "xmxw-2.12.0+1.21.6-fabric.jar";
            "hash" = "sha512-qlhSiRYQ1XkyIMOrkbiRWWx2krWGHt4vuun31cF4i1z7BwpyxWQMbP1sOtGg+hQVFoRlcs+DjQVToBQRc+zxeg==";
        };
        _GFXEBn2P = {
            "id" = "GFXEBn2P";
            "file" = "xmxw-2.12.0+1.21.11-neoforge.jar";
            "hash" = "sha512-UYQwjvdfo8s7L1VZE0iw32NZwrLZLsgcZwaH6PQNiLqU5JVJdLzf8Y/F626UykWVTfYM5o68wZTwS5mVVdAh1Q==";
        };
        _tBbXaq7H = {
            "id" = "tBbXaq7H";
            "file" = "xmxw-2.12.0+1.21.11-fabric.jar";
            "hash" = "sha512-0QbL1fyaUXu0YNLfInUJh7WQ1OS5YAdgysVxBEl7+KZ5mkXXr3IV3e/XN1dd8zXkQ7Q8HpKkU7E6wG5Vj9wxhw==";
        };
        _PfAM8BdG = {
            "id" = "PfAM8BdG";
            "file" = "xmxw-2.12.0+26.1.2-neoforge.jar";
            "hash" = "sha512-72GsEbCexeu7CKVjC8AzGTkPRPLxZBlI/fknBw50WSaWaOgndhJBgIMiHkLneQgtlXmgpGBsxiYZKVsPvNXnbg==";
        };
        _VrezDdrV = {
            "id" = "VrezDdrV";
            "file" = "xmxw-2.12.0+26.1.2-fabric.jar";
            "hash" = "sha512-h2nU8psLBc+DjTLyc8v4hmKUioV8k5I7LvIoFdvJtzMSQ4rE7nlRuOSuhm0LPfCEHO9aznfiWXlrQxE95lVPxQ==";
        };
        _zLlsY7H3 = {
            "id" = "zLlsY7H3";
            "file" = "xmxw-2.12.0+26.2-neoforge.jar";
            "hash" = "sha512-mESmqpiKYRASx1rEvqeaTC7SuKxwnimTW1nPw5tG1XlFkDgp/4yyBjabDahJq/zBptjpZTlQ6TH9jXUmqUzfoQ==";
        };
        _v0ZSCGu1 = {
            "id" = "v0ZSCGu1";
            "file" = "xmxw-2.12.0+26.2-fabric.jar";
            "hash" = "sha512-ZMbctcwAxjH0+EsUy7QfUjMIy6oZzRhnJ6Z/vE2u5wa/EIzqQeKmEP6LsUVj/25X0yCawx6KaLx8LJX1QDjq/w==";
        };
        _RBChq3GY = {
            "id" = "RBChq3GY";
            "file" = "xmxw-2.12.1+1.20.1-forge.jar";
            "hash" = "sha512-7P0Y/aiKwcGhxe9p7Rty9b4fz3vsRuzLz0kaIBmUqsGC/kn5OPUFHtAxZaIsiU+fVI1uT+xBli31OpcjYf6dMw==";
        };
        _klnm356p = {
            "id" = "klnm356p";
            "file" = "xmxw-2.12.1+1.20.1-fabric.jar";
            "hash" = "sha512-fcQ9uVXNdZsC6maqmFsVDMbhXZ4AUYq6dmWJG+EuyedYmMxIWeeZLPAQ5I9o1y2NVJ4bcio3xv/9Aow12I2Nrg==";
        };
        _ZfuW29kB = {
            "id" = "ZfuW29kB";
            "file" = "xmxw-2.12.1+1.20.4-neoforge.jar";
            "hash" = "sha512-EC31FxingiJxbrk6SZYsSEIcOgtaLqkBHtI3h/Guh3oT2U5khfnlh28McCKcLdYONpYOmfsUrCP6NYlf5U2Fug==";
        };
        _9jzCjsb2 = {
            "id" = "9jzCjsb2";
            "file" = "xmxw-2.12.1+1.21.1-neoforge.jar";
            "hash" = "sha512-pvN9v4YyEMBEdYov7UG9/U5W9tjpiWSfMGyWzQT7usex9M2KHAzgrDvLhIgZLXyXJ8uj4S/aVN+vPf+yTTzKBA==";
        };
        _ZjH85u5I = {
            "id" = "ZjH85u5I";
            "file" = "xmxw-2.12.1+1.21.1-fabric.jar";
            "hash" = "sha512-OZOHq7Az2q4M2bvPFw/Lj0irtenjdZoeEMC7XqsS0Cxqlcwb120TNfKAvY5l4HuqxvbfRlg/ucwtHQq3BLNDVg==";
        };
        _7TrdvPGs = {
            "id" = "7TrdvPGs";
            "file" = "xmxw-2.12.1+1.21.6-neoforge.jar";
            "hash" = "sha512-2ZPPCmkOn10ufyK6BKys50xSv6Uv9Z9OcRrgb+RPr0g8cH3/UK43FdcFd6Uo+kupNMBxgGK3pH0ce2JDZ+F7Iw==";
        };
        _xzm8SdRF = {
            "id" = "xzm8SdRF";
            "file" = "xmxw-2.12.1+1.21.6-fabric.jar";
            "hash" = "sha512-wz4lkCSff73xC0RbsTvGSEaWsqsRHawQ291j+0qN4Rs6VCC5qnal5hV8ji+gBswIPP8+fYASidqKC9SlTsy2eQ==";
        };
        _STUKrWhg = {
            "id" = "STUKrWhg";
            "file" = "xmxw-2.12.1+1.21.11-neoforge.jar";
            "hash" = "sha512-0agm8f1LclquaS5dumiI3WD7Z77EuXVV4DrDpB/Xz28o/1gW30Jc3OFyahmjRRVunUGxUBbr3PQo8LyQfqII1A==";
        };
        _81Gpx3wB = {
            "id" = "81Gpx3wB";
            "file" = "xmxw-2.12.1+1.21.11-fabric.jar";
            "hash" = "sha512-+HsYfnU0mHVs5OFfrwAr0BQtdxLHbXOR1nmKtELw2tFPTgr3pdR8Xt/lW+77KwmHZw3UnZUchWFQaHglpz1iTg==";
        };
        _Qh0JriKO = {
            "id" = "Qh0JriKO";
            "file" = "xmxw-2.12.1+26.1.2-neoforge.jar";
            "hash" = "sha512-IHmNNtHbx53Ewkn5Ys52X6I+nKMuVbKXcQT6OK9FzGL9V6qQvYnrWtrkyn0r85vpk156UFhXFHzzsbjXKzHedA==";
        };
        _Kcwq2u10 = {
            "id" = "Kcwq2u10";
            "file" = "xmxw-2.12.1+26.1.2-fabric.jar";
            "hash" = "sha512-TJ+E3ngDS07mlOrKxxHMpLshC5KPdiAaf7mRjRyk2pgtmIOpq7JnbwuUl8e3bS+cn26mQ340MjWQ5tuta1ucIg==";
        };
        _UO9rGieC = {
            "id" = "UO9rGieC";
            "file" = "xmxw-2.12.1+26.2-neoforge.jar";
            "hash" = "sha512-zjUv8QBPHt6lQMTDqH9WLfkkNcGFiDP5QH/hRQ3bS9z1Inna1CuN6pnMkshWerTPURUbhFIOV/DeeQRmA9dkrQ==";
        };
        _LJk28MNR = {
            "id" = "LJk28MNR";
            "file" = "xmxw-2.12.1+26.2-fabric.jar";
            "hash" = "sha512-vHh13nKomefzSM5WmOzY2oLOggy/XGi786Xn++APwUt3wNHn1aFzYpmYalZL98SUqi+gbIfz+aop28APVujxng==";
        };
    in {
        "Df2g2FcA" = _Df2g2FcA;
        "zgC89GZw" = _zgC89GZw;
        ...
        "UO9rGieC" = _UO9rGieC;
        "LJk28MNR" = _LJk28MNR;
        "neoforge-1.21.1" = _9jzCjsb2;
        "neoforge-1.21.3" = _9jzCjsb2;
        "neoforge-1.21.4" = _9jzCjsb2;
        "neoforge-1.21.6" = _7TrdvPGs;
        "neoforge-1.21.5" = _9jzCjsb2;
        "neoforge-1.21.7" = _7TrdvPGs;
        "neoforge-1.21.8" = _7TrdvPGs;
        "neoforge-1.21" = _9jzCjsb2;
        "neoforge-1.21.2" = _9jzCjsb2;
        "neoforge-1.21.9" = _7TrdvPGs;
        "neoforge-1.21.10" = _7TrdvPGs;
        "neoforge-1.21.11" = _STUKrWhg;
        "neoforge-1.20.1" = _ZfuW29kB;
        "neoforge-1.20.2" = _ZfuW29kB;
        "neoforge-1.20.3" = _ZfuW29kB;
        "neoforge-1.20.4" = _ZfuW29kB;
        "neoforge-1.20.5" = _ZfuW29kB;
        "neoforge-1.20.6" = _ZfuW29kB;
        "neoforge-26.1" = _Qh0JriKO;
        "neoforge-26.1.1" = _Qh0JriKO;
        "neoforge-26.1.2" = _Qh0JriKO;
        "neoforge-26.2" = _UO9rGieC;
        "fabric-1.21.1" = _ZjH85u5I;
        "fabric-1.21.3" = _ZjH85u5I;
        "fabric-1.21.4" = _ZjH85u5I;
        "fabric-1.21.6" = _xzm8SdRF;
        "fabric-1.21.5" = _ZjH85u5I;
        "fabric-1.21.7" = _xzm8SdRF;
        "fabric-1.21.8" = _xzm8SdRF;
        "fabric-1.21" = _ZjH85u5I;
        "fabric-1.21.2" = _ZjH85u5I;
        "fabric-1.21.9" = _xzm8SdRF;
        "fabric-1.21.10" = _xzm8SdRF;
        "fabric-1.21.11" = _81Gpx3wB;
        "fabric-1.20" = _klnm356p;
        "fabric-1.20.1" = _klnm356p;
        "fabric-1.20.2" = _klnm356p;
        "fabric-1.20.3" = _klnm356p;
        "fabric-1.20.4" = _klnm356p;
        "fabric-1.20.5" = _klnm356p;
        "fabric-1.20.6" = _klnm356p;
        "fabric-26.1" = _Kcwq2u10;
        "fabric-26.1.1" = _Kcwq2u10;
        "fabric-26.1.2" = _Kcwq2u10;
        "fabric-26.2" = _LJk28MNR;
        "forge-1.20" = _RBChq3GY;
        "forge-1.20.1" = _RBChq3GY;
        "forge-1.20.2" = _RBChq3GY;
        "forge-1.20.3" = _RBChq3GY;
        "forge-1.20.4" = _RBChq3GY;
        "forge-1.20.5" = _RBChq3GY;
        "forge-1.20.6" = _RBChq3GY;
        "pkg-1.0.1" = _zPgm5NBD;
        "pkg-1.0.2" = _XTCZamw5;
        "pkg-1.0.3" = _4SclTWKW;
        "pkg-1.0.4" = _LJk6CCNJ;
        ...
        "pkg-1.0.7" = _XCnYShF9;
        "pkg-1.0.8" = _iKhKsmQh;
        "pkg-2.0.0+1.21.1-neoforge" = _AqiIDf9x;
        "pkg-2.0.0+1.21.1-fabric" = _RRI7NSZv;
        "pkg-2.0.0+1.21.11-neoforge" = _jSzimzaT;
        "pkg-2.0.0+1.21.11-fabric" = _9Ef5JKqw;
        "pkg-2.1.0+1.20.1-forge" = _CvbxaVXP;
        "pkg-2.1.0+1.20.1-fabric" = _YXDQtHw0;
        "pkg-2.1.0+1.20.4-neoforge" = _wqqaZZeh;
        "pkg-2.1.0+1.21.1-neoforge" = _y6U1pzx7;
        "pkg-2.1.0+1.21.1-fabric" = _BrgL50vJ;
        "pkg-2.1.0+1.21.11-neoforge" = _fSg4RdRy;
        "pkg-2.1.0+1.21.11-fabric" = _39cxwUTR;
        "pkg-2.2.0+1.20.1-forge" = _HN5Dt0dr;
        "pkg-2.2.0+1.20.1-fabric" = _ZaGr1xBJ;
        "pkg-2.2.0+1.20.4-neoforge" = _ZuKBTLU5;
        "pkg-2.2.0+1.21.1-neoforge" = _ZNLnKh62;
        "pkg-2.2.0+1.21.1-fabric" = _rN0a7Fmz;
        "pkg-2.2.0+1.21.11-neoforge" = _rY4XnxGL;
        "pkg-2.2.0+1.21.11-fabric" = _t8LJmUiA;
        "pkg-2.2.1+1.20.1-forge" = _o6JTcFwA;
        "pkg-2.2.1+1.20.1-fabric" = _9g9jDMF1;
        "pkg-2.2.1+1.20.4-neoforge" = _VTW8vWML;
        "pkg-2.2.1+1.21.1-neoforge" = _xSZV5wUL;
        "pkg-2.2.1+1.21.1-fabric" = _51KXI7rO;
        "pkg-2.2.1+1.21.6-neoforge" = _W8r3tkWg;
        "pkg-2.2.1+1.21.6-fabric" = _ZOyISGIg;
        "pkg-2.2.1+1.21.11-neoforge" = _8pRPI2DC;
        "pkg-2.2.1+1.21.11-fabric" = _2rANUsUj;
        "pkg-2.3.0+1.20.1-forge" = _Ri0KrgPu;
        "pkg-2.3.0+1.20.1-fabric" = _Irr86YgN;
        "pkg-2.3.0+1.20.4-neoforge" = _TMkleUTa;
        "pkg-2.3.0+1.21.1-neoforge" = _X0JXDxBT;
        "pkg-2.3.0+1.21.1-fabric" = _4EeeYquM;
        "pkg-2.3.0+1.21.6-neoforge" = _oje40a9N;
        "pkg-2.3.0+1.21.6-fabric" = _kaSehOub;
        "pkg-2.3.0+1.21.11-neoforge" = _J250HBTi;
        "pkg-2.3.0+1.21.11-fabric" = _XrxmfAxX;
        "pkg-2.3.1+1.20.1-forge" = _dH9ofg6h;
        "pkg-2.3.1+1.20.1-fabric" = _T9By7Ii1;
        "pkg-2.3.1+1.20.4-neoforge" = _QzLUoSJI;
        "pkg-2.3.1+1.21.1-neoforge" = _hXBRNjIa;
        "pkg-2.3.1+1.21.1-fabric" = _ayTngAxa;
        "pkg-2.3.1+1.21.6-neoforge" = _1mrg9fH3;
        "pkg-2.3.1+1.21.6-fabric" = _8WaI5NA9;
        "pkg-2.3.1+1.21.11-neoforge" = _tswRd4DP;
        "pkg-2.3.1+1.21.11-fabric" = _MXrD9lvr;
        "pkg-2.3.2+1.20.1-forge" = _bfLU1CWG;
        "pkg-2.3.2+1.20.1-fabric" = _pUd8NBqP;
        "pkg-2.3.2+1.20.4-neoforge" = _z7yOwDle;
        "pkg-2.3.2+1.21.1-neoforge" = _ZdIwqxQO;
        "pkg-2.3.2+1.21.1-fabric" = _9tSBG2H6;
        "pkg-2.3.2+1.21.6-neoforge" = _SpIxZgAp;
        "pkg-2.3.2+1.21.6-fabric" = _jgKJIiBe;
        "pkg-2.3.2+1.21.11-neoforge" = _OJkmV3QB;
        "pkg-2.3.2+1.21.11-fabric" = _jr36Nu0a;
        "pkg-2.3.3+1.20.1-forge" = _X2y8Rrru;
        "pkg-2.3.3+1.20.1-fabric" = _qnfD6tWe;
        "pkg-2.3.3+1.20.4-neoforge" = _oqiM8Y6b;
        "pkg-2.3.3+1.21.1-neoforge" = _tUlrAPxy;
        "pkg-2.3.3+1.21.1-fabric" = _w85bxl1Y;
        "pkg-2.3.3+1.21.6-neoforge" = _n3L7LfXF;
        "pkg-2.3.3+1.21.6-fabric" = _PBXSccFW;
        "pkg-2.3.3+1.21.11-neoforge" = _ZTXDDGSy;
        "pkg-2.3.3+1.21.11-fabric" = _9Kr2RUsp;
        "pkg-2.3.4+1.20.1-forge" = _qmlp58o2;
        "pkg-2.3.4+1.20.1-fabric" = _uSRYtGPo;
        "pkg-2.3.4+1.20.4-neoforge" = _JSUk4koQ;
        "pkg-2.3.4+1.21.1-neoforge" = _SXVOaQcN;
        "pkg-2.3.4+1.21.1-fabric" = _alT4v1Je;
        "pkg-2.3.4+1.21.6-neoforge" = _Wq6FpKbP;
        "pkg-2.3.4+1.21.6-fabric" = _FyYy4hvo;
        "pkg-2.3.4+1.21.11-neoforge" = _klDrnYsF;
        "pkg-2.3.4+1.21.11-fabric" = _wWjPoGdS;
        "pkg-2.4.0+1.20.1-forge" = _tYyOyCJv;
        "pkg-2.4.0+1.20.1-fabric" = _TpJUFhZR;
        "pkg-2.4.0+1.20.4-neoforge" = _MIA8ia2u;
        "pkg-2.4.0+1.21.1-neoforge" = _LSJxHJ1h;
        "pkg-2.4.0+1.21.1-fabric" = _eSfSgNEH;
        "pkg-2.4.0+1.21.6-neoforge" = _NVnBni61;
        "pkg-2.4.0+1.21.6-fabric" = _Y5bwIN1z;
        "pkg-2.4.0+1.21.11-neoforge" = _8BzgqMmt;
        "pkg-2.4.0+1.21.11-fabric" = _URVaH8Tx;
        "pkg-2.5.0+1.20.1-forge" = _zwS4QoNK;
        "pkg-2.5.0+1.20.1-fabric" = _rTJ9Ow3U;
        "pkg-2.5.0+1.20.4-neoforge" = _C0nFOpiB;
        "pkg-2.5.0+1.21.1-neoforge" = _fUGDCnQr;
        "pkg-2.5.0+1.21.1-fabric" = _JHV9dRcY;
        "pkg-2.5.0+1.21.6-neoforge" = _uqPCFvxc;
        "pkg-2.5.0+1.21.6-fabric" = _a7zsffDi;
        "pkg-2.5.0+1.21.11-neoforge" = _wYjJCAwt;
        "pkg-2.5.0+1.21.11-fabric" = _Ip1VLp8t;
        "pkg-2.6.0+1.20.1-forge" = _ozTFlLOW;
        "pkg-2.6.0+1.20.1-fabric" = _pTBxXpAV;
        "pkg-2.6.0+1.20.4-neoforge" = _e1kUgBb1;
        "pkg-2.6.0+1.21.1-neoforge" = _BZpxB8Se;
        "pkg-2.6.0+1.21.1-fabric" = _y2P7WziZ;
        "pkg-2.6.0+1.21.6-neoforge" = _tE0RWxCI;
        "pkg-2.6.0+1.21.6-fabric" = _XNbaCvx4;
        "pkg-2.6.0+1.21.11-neoforge" = _26uwTzmn;
        "pkg-2.6.0+1.21.11-fabric" = _lsfpdqfp;
        "pkg-2.6.1+1.20.1-forge" = _469lRM4R;
        "pkg-2.6.1+1.20.1-fabric" = _Pdhx0DET;
        "pkg-2.6.1+1.20.4-neoforge" = _GXLDfFIV;
        "pkg-2.6.1+1.21.1-neoforge" = _MeDWRdB2;
        "pkg-2.6.1+1.21.1-fabric" = _sKx8dAzF;
        "pkg-2.6.1+1.21.6-neoforge" = _vGbaWMKg;
        "pkg-2.6.1+1.21.6-fabric" = _6Go2DwnA;
        "pkg-2.6.1+1.21.11-neoforge" = _rJ6d21O9;
        "pkg-2.6.1+1.21.11-fabric" = _ATzw8uwY;
        "pkg-2.7.0+1.20.1-forge" = _O5cxzuPu;
        "pkg-2.7.0+1.20.1-fabric" = _w0yBfT2h;
        "pkg-2.7.0+1.20.4-neoforge" = _gGjQ9fDp;
        "pkg-2.7.0+1.21.1-neoforge" = _JB2O0KjW;
        "pkg-2.7.0+1.21.1-fabric" = _A6O5km2e;
        "pkg-2.7.0+1.21.6-neoforge" = _EmdCpr49;
        "pkg-2.7.0+1.21.6-fabric" = _5pQxQkyN;
        "pkg-2.7.0+1.21.11-neoforge" = _c9iqEBGs;
        "pkg-2.7.0+1.21.11-fabric" = _YXcmhe3R;
        "pkg-2.7.1+1.20.1-forge" = _lf6CrGkt;
        "pkg-2.7.1+1.20.1-fabric" = _vpifxUeO;
        "pkg-2.7.1+1.20.4-neoforge" = _X9mnYdpC;
        "pkg-2.7.1+1.21.1-neoforge" = _heO7lSWQ;
        "pkg-2.7.1+1.21.1-fabric" = _HFlqgZjm;
        "pkg-2.7.1+1.21.6-neoforge" = _dPg4M8ZT;
        "pkg-2.7.1+1.21.6-fabric" = _ygYuFfKf;
        "pkg-2.7.1+1.21.11-neoforge" = _XdcMUo5e;
        "pkg-2.7.1+1.21.11-fabric" = _q11rCOnn;
        "pkg-2.7.2+1.20.1-forge" = _fCzUQthC;
        "pkg-2.7.2+1.20.1-fabric" = _c5SpflOa;
        "pkg-2.7.2+1.20.4-neoforge" = _flGPPFcO;
        "pkg-2.7.2+1.21.1-neoforge" = _6f32ufZ8;
        "pkg-2.7.2+1.21.1-fabric" = _X1Qbr7Hd;
        "pkg-2.7.2+1.21.6-neoforge" = _KBYUxSpr;
        "pkg-2.7.2+1.21.6-fabric" = _XvUeVE1u;
        "pkg-2.7.2+1.21.11-neoforge" = _Oiuq2NnF;
        "pkg-2.7.2+1.21.11-fabric" = _lcI8RUKY;
        "pkg-2.7.3+1.20.1-forge" = _ob97MJ90;
        "pkg-2.7.3+1.20.1-fabric" = _5o0rKGGY;
        "pkg-2.7.3+1.20.4-neoforge" = _Qd2XwgLu;
        "pkg-2.7.3+1.21.1-neoforge" = _4dmdAB6h;
        "pkg-2.7.3+1.21.1-fabric" = _WhPwFE1G;
        "pkg-2.7.3+1.21.6-neoforge" = _2ZK1cdWY;
        "pkg-2.7.3+1.21.6-fabric" = _9eyS4uXY;
        "pkg-2.7.3+1.21.11-neoforge" = _xLLz1AiT;
        "pkg-2.7.3+1.21.11-fabric" = _qEDJvVBY;
        "pkg-2.7.4+1.20.1-forge" = _QECSfB0N;
        "pkg-2.7.4+1.20.1-fabric" = _2MzvGQiT;
        "pkg-2.7.4+1.20.4-neoforge" = _dphWHHrA;
        "pkg-2.7.4+1.21.1-neoforge" = _kqwkPx3F;
        "pkg-2.7.4+1.21.1-fabric" = _BaQZPYDi;
        "pkg-2.7.4+1.21.6-neoforge" = _AQZ0a5nS;
        "pkg-2.7.4+1.21.6-fabric" = _XQVIKffi;
        "pkg-2.7.4+1.21.11-neoforge" = _OygIyAuX;
        "pkg-2.7.4+1.21.11-fabric" = _4Q3DBJG8;
        "pkg-2.7.5+1.20.1-forge" = _LAEY0ZtX;
        "pkg-2.7.5+1.20.1-fabric" = _tNSNGITA;
        "pkg-2.7.5+1.20.4-neoforge" = _PhmNjniO;
        "pkg-2.7.5+1.21.1-neoforge" = _35ayTy2t;
        "pkg-2.7.5+1.21.1-fabric" = _25maSCCM;
        "pkg-2.7.5+1.21.6-neoforge" = _kODprXQv;
        "pkg-2.7.5+1.21.6-fabric" = _aBh7u2Aj;
        "pkg-2.7.5+1.21.11-neoforge" = _grz6oiSb;
        "pkg-2.7.5+1.21.11-fabric" = _IjqropU0;
        "pkg-2.9.0+1.20.1-forge" = _zQdESlfa;
        "pkg-2.9.0+1.20.1-fabric" = _6K27xpXQ;
        "pkg-2.9.0+1.20.4-neoforge" = _MLqZv9a9;
        "pkg-2.9.0+1.21.1-neoforge" = _vPfzbmEn;
        "pkg-2.9.0+1.21.1-fabric" = _gM8kh5J8;
        "pkg-2.9.0+1.21.6-neoforge" = _VWdI9jHM;
        "pkg-2.9.0+1.21.6-fabric" = _OQP4KUgW;
        "pkg-2.9.0+1.21.11-neoforge" = _Nmwlm00C;
        "pkg-2.9.0+1.21.11-fabric" = _tpqEn3EY;
        "pkg-2.10.0+1.20.1-forge" = _C1zQPAc2;
        "pkg-2.10.0+1.20.1-fabric" = _bo1cKuAL;
        "pkg-2.10.0+1.20.4-neoforge" = _Bsmg7bQg;
        "pkg-2.10.0+1.21.1-neoforge" = _BQqTBKCJ;
        "pkg-2.10.0+1.21.1-fabric" = _PlcIQTIk;
        "pkg-2.10.0+1.21.6-neoforge" = _ls55se0G;
        "pkg-2.10.0+1.21.6-fabric" = _S4y3GEl1;
        "pkg-2.10.0+1.21.11-neoforge" = _2s0PGW6S;
        "pkg-2.10.0+1.21.11-fabric" = _qomoUSO1;
        "pkg-2.10.0+26.1.2-neoforge" = _sttZKZbb;
        "pkg-2.10.0+26.1.2-fabric" = _eWQpW7YY;
        "pkg-2.10.1+1.20.1-forge" = _z8M4o2Dq;
        "pkg-2.10.1+1.20.1-fabric" = _cuBIx23s;
        "pkg-2.10.1+1.20.4-neoforge" = _riCTJlWo;
        "pkg-2.10.1+1.21.1-neoforge" = _1gnn6EVI;
        "pkg-2.10.1+1.21.1-fabric" = _xWu9hyLq;
        "pkg-2.10.1+1.21.6-neoforge" = _biZKcGeq;
        "pkg-2.10.1+1.21.6-fabric" = _Z69tluYA;
        "pkg-2.10.1+1.21.11-neoforge" = _KKoiimwU;
        "pkg-2.10.1+1.21.11-fabric" = _PzsbXsIb;
        "pkg-2.10.1+26.1.2-neoforge" = _JFCeB3cw;
        "pkg-2.10.1+26.1.2-fabric" = _k7wwcQ4t;
        "pkg-2.11.0+1.20.1-forge" = _TTBdg5jT;
        "pkg-2.11.0+1.20.1-fabric" = _AJN6cAAS;
        "pkg-2.11.0+1.20.4-neoforge" = _gcE7lnzD;
        "pkg-2.11.0+1.21.1-neoforge" = _Kfpg8jty;
        "pkg-2.11.0+1.21.1-fabric" = _i46AdKjz;
        "pkg-2.11.0+1.21.6-neoforge" = _miZwq0ne;
        "pkg-2.11.0+1.21.6-fabric" = _ygh2KSaA;
        "pkg-2.11.0+1.21.11-neoforge" = _J6qC4eDH;
        "pkg-2.11.0+1.21.11-fabric" = _nCwwy37B;
        "pkg-2.11.0+26.1.2-neoforge" = _9Bbo3mws;
        "pkg-2.11.0+26.1.2-fabric" = _BJriT5Yy;
        "pkg-2.11.0+26.2-fabric" = _G54vVJyC;
        "pkg-2.11.1+1.20.1-forge" = _XT6ZGoxT;
        "pkg-2.11.1+1.20.1-fabric" = _Cxi0KL4f;
        "pkg-2.11.1+1.20.4-neoforge" = _O9eh6P0R;
        "pkg-2.11.1+1.21.1-neoforge" = _JLQOPpS3;
        "pkg-2.11.1+1.21.1-fabric" = _MJW0uVln;
        "pkg-2.11.1+1.21.6-neoforge" = _1uEqbsp0;
        "pkg-2.11.1+1.21.6-fabric" = _PqIvnZBm;
        "pkg-2.11.1+1.21.11-neoforge" = _nZVAuH6Q;
        "pkg-2.11.1+1.21.11-fabric" = _oWXc2u7R;
        "pkg-2.11.1+26.1.2-neoforge" = _blgYIA7H;
        "pkg-2.11.1+26.1.2-fabric" = _APtyyM76;
        "pkg-2.11.1+26.2-fabric" = _fASfMRm0;
        "pkg-2.12.0+1.20.1-forge" = _m3CikSWh;
        "pkg-2.12.0+1.20.1-fabric" = _l3BU4mYz;
        "pkg-2.12.0+1.20.4-neoforge" = _1gMZSWXf;
        "pkg-2.12.0+1.21.1-neoforge" = _zWcr6EEj;
        "pkg-2.12.0+1.21.1-fabric" = _msev7Kdw;
        "pkg-2.12.0+1.21.6-neoforge" = _ANYCmmxL;
        "pkg-2.12.0+1.21.6-fabric" = _iHFbZP42;
        "pkg-2.12.0+1.21.11-neoforge" = _GFXEBn2P;
        "pkg-2.12.0+1.21.11-fabric" = _tBbXaq7H;
        "pkg-2.12.0+26.1.2-neoforge" = _PfAM8BdG;
        "pkg-2.12.0+26.1.2-fabric" = _VrezDdrV;
        "pkg-2.12.0+26.2-neoforge" = _zLlsY7H3;
        "pkg-2.12.0+26.2-fabric" = _v0ZSCGu1;
        "pkg-2.12.1+1.20.1-forge" = _RBChq3GY;
        "pkg-2.12.1+1.20.1-fabric" = _klnm356p;
        "pkg-2.12.1+1.20.4-neoforge" = _ZfuW29kB;
        "pkg-2.12.1+1.21.1-neoforge" = _9jzCjsb2;
        "pkg-2.12.1+1.21.1-fabric" = _ZjH85u5I;
        "pkg-2.12.1+1.21.6-neoforge" = _7TrdvPGs;
        "pkg-2.12.1+1.21.6-fabric" = _xzm8SdRF;
        "pkg-2.12.1+1.21.11-neoforge" = _STUKrWhg;
        "pkg-2.12.1+1.21.11-fabric" = _81Gpx3wB;
        "pkg-2.12.1+26.1.2-neoforge" = _Qh0JriKO;
        "pkg-2.12.1+26.1.2-fabric" = _Kcwq2u10;
        "pkg-2.12.1+26.2-neoforge" = _UO9rGieC;
        "pkg-2.12.1+26.2-fabric" = _LJk28MNR;
        "default" = _LJk28MNR;
    });
