...
let
    ...
    in {
        ...
        "pkg-0.4-1.20.1" = _2nBeqTc2;
        "pkg-0.5-1.20.1" = _IjDqkTam;
        "pkg-0.6-1.20.1" = _ZyVZZShL;
        "pkg-0.7-1.20.1" = _Ch6Wuw6U;
        "pkg-0.8-1.20.1" = _OZjEXpsj;
        "pkg-0.9-1.20.1" = _mTPV41w7;
        "pkg-0.10-1.20.1" = _sx0vWFU6;
        "pkg-0.11-1.20.1" = _NhlM57hs;
        "pkg-0.12-1.20.1" = _TDlhJg0O;
        "pkg-13" = _HAcbmFl2;
        "pkg-14" = _odMqfEoJ;
        "pkg-15" = _7zx5LhKD;
        "pkg-16" = _vKAWshms;
        ...
        "pkg-47fix" = _c7VmQRbQ;
        "pkg-48" = _vhAxGKxu;
        "pkg-48additions" = _FCl8yhwP;
        "pkg-48.2" = _UVJYfHlD;
        "pkg-49" = _pwmurGX1;
        "pkg-50" = _BCZu8lK4;
        "pkg-50addition" = _oTcWj1Km;
        "pkg-51" = _a4mR8INW;
        "pkg-51fixed" = _6rutjQrF;
        "pkg-52" = _3VcJAKM5;
        "pkg-53" = _bj1YjNCm;
        "pkg-54" = _LAnlfzuD;
        "pkg-55" = _nvmflxIg;
