...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.0.2" = _Hk9lAfFK;
        "pkg-1.20.1-1.0.3" = _IS6Ov3di;
        "pkg-1.20.4-1.0.3" = _k95w6cTA;
        "pkg-1.20.1-1.0.4" = _mIAQ09OV;
        "pkg-1.20.4-1.0.4" = _Juz1OMwz;
        "pkg-1.20.1-1.0.5" = _Dxja8J9B;
        "pkg-1.20.4-1.0.5" = _kFr3AApt;
        "pkg-1.20.1-1.0.6" = _crLxYxJd;
        "pkg-1.20.1-1.1.0" = _vaV3NguE;
        "pkg-1.20.1-1.1.1" = _OZaVieJI;
        "pkg-1.20.1-1.1.2" = _oKIu2SsK;
        "pkg-1.20.1-1.1.3" = _egmDnsYT;
        "pkg-1.20.1-1.1.4" = _gXyjH3X6;
        "pkg-1.20.1-1.1.5" = _en6GipDI;
        "pkg-1.20.1-2.0.0" = _9N3beQ6w;
        "pkg-1.20.1-2.0.1" = _Qa218TMP;
        "pkg-1.20.1-2.0.2" = _NuaTJdXM;
        "pkg-1.20.1-2.1.0" = _fe426eCo;
        "pkg-1.20.1-2.1.1" = _Bg03sVgJ;
        "pkg-1.20.1-2.1.2" = _KvZODVmv;
        "pkg-1.20.1-2.1.3" = _dl4qMdEC;
        "pkg-1.20.1-2.1.4" = _bKxTW2xo;
        "pkg-1.20.1-2.1.5" = _ipYBCS61;
        "pkg-1.20.1-2.1.6" = _7PtiSrOf;
        "pkg-1.20.1-2.2.0" = _Md5Zx3P1;
        "pkg-1.20.1-2.2.1" = _dtE8JxjG;
        "pkg-1.20.1-2.2.2" = _hBOEhWMd;
        "pkg-1.20.1-2.2.3" = _4zjeCYAy;
        "pkg-1.20.1-2.2.4" = _RLVvmDbZ;
        "pkg-1.20.1-2.2.5" = _j3A1TL9v;
        "pkg-1.20.1-2.3.0" = _czGVf1Nw;
        "pkg-1.20.1-2.3.1" = _OiIiGIF0;
        "pkg-1.20.1-2.4.0" = _V40fhWmb;
        "pkg-1.20.1-3.0.0" = _zGXVzsal;
        "pkg-1.20.1-3.0.1" = _fiBPgrxh;
        "pkg-1.20.1-3.0.2" = _FMpfZMIA;
        "pkg-1.20.1-3.0.3" = _QAVTnAoX;
        "pkg-1.20.1-3.0.4" = _CYlZ3YG2;
        "pkg-1.20.1-3.1.0" = _aonmUl9R;
        "pkg-1.20.1-3.1.1" = _1908EaGB;
        "pkg-1.20.1-3.1.2" = _tMMtvZKh;
        "pkg-1.20.1-3.1.3" = _SNfgcerC;
        "pkg-1.20.1-3.1.4" = _mRPWzdlf;
        "pkg-1.21.1-3.4.0" = _5WLL2YLs;
        "pkg-1.21.1-3.4.1" = _gzEsJthP;
        "pkg-1.20.1-3.4.1" = _CGxDIbXK;
        "pkg-1.21.1-3.4.2" = _MQTPj4hf;
        "pkg-1.21.1-3.4.3" = _UMIbhwxR;
        "pkg-1.21.1-3.4.4" = _W2xzsmRy;
        "pkg-1.21.1-3.4.5" = _LtoZkT5G;
        "pkg-1.20.1-3.4.5" = _jA4zOQK3;
        "pkg-1.20.1-3.4.6" = _R1EWBAbU;
        "pkg-1.21.1-3.4.6" = _LbAXtGUj;
        "pkg-1.21.1-3.4.7" = _YuZYCWF7;
