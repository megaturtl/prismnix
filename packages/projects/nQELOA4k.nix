...
let
    ...
    in {
        ...
        "pkg-1.7" = _aI6Zpogv;
        "pkg-1.8" = _aWzptBxV;
        "pkg-1.20.5-1.7-fabric" = _7ZZiVGGw;
        "pkg-1.20.6-1.7-fabric" = _7XeU0lh7;
        "pkg-1.21-1.7-fabric" = _roMbwAZD;
        "pkg-1.16.5-fabric-1.8" = _SDQlH5G9;
        "pkg-1.18.2-fabric-1.8" = _DK50eGLh;
        "pkg-1.20.1-fabric-1.8" = _MM3m8IFg;
        "pkg-1.20.2-fabric-1.8" = _EZHE5Cvx;
        "pkg-1.20.3-fabric-1.8" = _dD7V1OKL;
        "pkg-1.20.4-fabric-1.8" = _PYebUb3N;
        "pkg-1.20.5-fabric-1.8" = _jnM5qJFg;
        "pkg-1.20.6-fabric-1.8" = _KaQMLcCG;
        "pkg-1.21.1-fabric-1.8" = _jpwIpoTP;
        "pkg-1.20-fabric-1.8" = _ogatWBdj;
        "pkg-1.16.5-fabric-1.9" = _crJ69HWr;
        "pkg-1.18.2-fabric-1.9" = _kTpFM3JS;
        "pkg-1.20.1-fabric-1.9" = _YpTp4wa0;
        "pkg-1.20.2-fabric-1.9" = _NKWth1P2;
        "pkg-1.20.3-fabric-1.9" = _uv7NheMt;
        "pkg-1.20.4-fabric-1.9" = _hD94jhrJ;
        "pkg-1.20.5-fabric-1.9" = _AedZijSr;
        "pkg-1.20.6-fabric-1.9" = _cauR3wdB;
        "pkg-1.20-fabric-1.9" = _eLcUG7Vr;
        "pkg-1.21-fabric-1.9" = _cYltDqZJ;
        "pkg-1.21.1-fabric-1.9" = _cRnMiBjK;
        "pkg-1.21.2-fabric-1.9" = _uEdfkIOT;
        "pkg-1.21.3-fabric-1.9" = _PaAVlPwN;
        "pkg-1.16.5-fabric-1.10" = _vhVHTHHT;
        "pkg-1.18.2-fabric-1.10" = _dr36HOGK;
        "pkg-1.20-fabric-1.10" = _u3NXTAE8;
        "pkg-1.20.1-fabric-1.10" = _920G6BZl;
        "pkg-1.20.2-fabric-1.10" = _ZY2vzWkM;
        "pkg-1.20.3-fabric-1.10" = _xRolESor;
        "pkg-1.20.4-fabric-1.10" = _AHdNNX8C;
        "pkg-1.20.5-fabric-1.10" = _LnpAdmb2;
        "pkg-1.20.6-fabric-1.10" = _QzY3ZDqp;
        "pkg-1.21-fabric-1.10" = _Oe5LCutH;
        "pkg-1.21.1-fabric-1.10" = _39qLNmHN;
        "pkg-1.21.2-fabric-1.10" = _jEFU5O4b;
        "pkg-1.21.3-fabric-1.10" = _DCPPoNik;
        "pkg-1.21.4-fabric-1.10" = _iRT9MDhd;
        "pkg-1.21.5-fabric-1.10" = _F4jKWAXN;
        "pkg-1.21.7-fabric-1.10" = _i6eCBMhN;
        "pkg-1.21.6-fabric-1.10" = _uoDVh9CG;
        "pkg-1.16.5-fabric-1.11" = _XhnSWdmA;
        "pkg-1.18.2-fabric-1.11" = _t11iKRZK;
        "pkg-1.20.1-fabric-1.11" = _agvkbeNe;
        "pkg-1.20.2-fabric-1.11" = _6lElpvkT;
        "pkg-1.20.3-fabric-1.11" = _wp27qxGp;
        "pkg-1.20.4-fabric-1.11" = _6jyVNGfL;
        "pkg-1.20.5-fabric-1.11" = _LbssGTLi;
        "pkg-1.20.6-fabric-1.11" = _t2yfdXcf;
        "pkg-1.20-fabric-1.11" = _EbFaLk0O;
        "pkg-1.21-fabric-1.11" = _fUOjiaz9;
        "pkg-1.21.1-fabric-1.11" = _K3dkKq4T;
        "pkg-1.21.2-fabric-1.11" = _vooAcohP;
        "pkg-1.21.3-fabric-1.11" = _JXuEZW1j;
        "pkg-1.21.4-fabric-1.11" = _npT0R0km;
        "pkg-1.21.5-fabric-1.11" = _17boqGSf;
        "pkg-1.21.6-fabric-1.11" = _5cjKXwpM;
        "pkg-1.21.7-fabric-1.11" = _6TuRdJFX;
        "pkg-1.16.5-fabric-1.12" = _OdpC6eRG;
        "pkg-1.18.2-fabric-1.12" = _WahEihI0;
        "pkg-1.20-fabric-1.12" = _iqvX6z2x;
        "pkg-1.20.1-fabric-1.12" = _p3NvZ2rP;
        "pkg-1.20.2-fabric-1.12" = _hv4zttdo;
        "pkg-1.20.3-fabric-1.12" = _9YOB0fTM;
        "pkg-1.20.4-fabric-1.12" = _iqdb4Frl;
        "pkg-1.20.5-fabric-1.12" = _S8ITpcBq;
        "pkg-1.20.6-fabric-1.12" = _c5MOWMA6;
        "pkg-1.21-fabric-1.12" = _nGt0MZWB;
        "pkg-1.21.1-fabric-1.12" = _BpbxJ4rS;
        "pkg-1.21.2-fabric-1.12" = _5mEV2USN;
        "pkg-1.21.3-fabric-1.12" = _EtSgMinU;
        "pkg-1.21.4-fabric-1.12" = _lBKoeXnO;
        "pkg-1.21.5-fabric-1.12" = _ALyeyE8h;
        "pkg-1.21.6-fabric-1.12" = _AsCsnfr6;
        "pkg-1.21.7-fabric-1.12" = _ddndyuSo;
        "pkg-1.21.8-fabric-1.12" = _qghWrE8v;
        "pkg-1.16.5-fabric-1.13" = _FUy8sTAv;
        "pkg-1.18.2-fabric-1.13" = _QoMH9b5t;
        "pkg-1.20-fabric-1.13" = _jYe1GjaO;
        "pkg-1.20.1-fabric-1.13" = _qevYibxR;
        "pkg-1.20.2-fabric-1.13" = _HFFSltRw;
        "pkg-1.20.3-fabric-1.13" = _gTnp3Mo2;
        "pkg-1.20.4-fabric-1.13" = _CYcJpyIh;
        "pkg-1.20.5-fabric-1.13" = _OeWjK0Di;
        "pkg-1.20.6-fabric-1.13" = _I7ReiCvv;
        "pkg-1.21-fabric-1.13" = _yO0Jpg07;
        "pkg-1.21.1-fabric-1.13" = _CX92WImy;
        "pkg-1.21.2-fabric-1.13" = _KjBtIT4U;
        "pkg-1.21.3-fabric-1.13" = _svnloOaz;
        "pkg-1.21.4-fabric-1.13" = _oAWXWzNO;
        "pkg-1.21.5-fabric-1.13" = _fTfRfwnD;
        "pkg-1.21.6-fabric-1.13" = _RaCI10Eu;
        "pkg-1.21.7-fabric-1.13" = _BGC4DuBK;
        "pkg-1.21.8-fabric-1.13" = _xZ097ymO;
        "pkg-1.21.9-fabric-1.13" = _FzlzsaWe;
        "pkg-1.21.10-fabric-1.13" = _7XmitFjv;
        "pkg-1.21.11-fabric-1.13" = _rxK1qrxI;
        "pkg-26.1-fabric-1.13" = _JgLDuGph;
