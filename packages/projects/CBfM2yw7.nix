...
let
    ...
    in {
        ...
        "pkg-0.10.1-beta" = _8XlOMp4h;
        "pkg-0.10.2-beta" = _w0ya0Twe;
        "pkg-0.10.3-beta" = _gv7iedll;
        "pkg-0.10.4-beta" = _OuADNcMd;
        "pkg-0.10.5-beta" = _qLDLboOX;
        "pkg-0.10.6-beta" = _9OEAzYUj;
        "pkg-0.10.7-beta" = _yguIvs4w;
        "pkg-0.10.8-beta" = _ICHWfoCQ;
        "pkg-0.10.9-beta" = _o1naRNqU;
        "pkg-0.10.10-beta" = _Zqx06ph5;
        "pkg-0.10.11-beta" = _uaGcfwr8;
        "pkg-0.10.12-beta" = _vgW4CsE7;
        "pkg-0.10.13-beta" = _y6rnqnYM;
        "pkg-0.10.14-beta" = _MbvIvFV5;
        "pkg-0.10.15-beta" = _hX3cfqqC;
        "pkg-0.11.0-beta" = _HYwypDPa;
        "pkg-0.11.1-beta" = _kFicMPH6;
        "pkg-0.12.0-beta" = _BdOoHayz;
        "pkg-0.12.1-beta" = _FY8Lm8Ie;
        "pkg-0.13.0-beta" = _bi9BIvk1;
        "pkg-0.13.1-beta" = _O49s7zos;
        "pkg-0.13.2-beta" = _GegSX050;
        "pkg-0.13.3-beta" = _SFKAHcC0;
        "pkg-0.13.4-beta" = _LQLUrfh3;
        "pkg-0.13.5-beta" = _JCNFPUUB;
        "pkg-0.13.6-beta" = _ws0S1A3X;
        "pkg-0.13.7-beta" = _sZK1GcWC;
        "pkg-0.13.8-beta" = _jwoF6kzr;
        "pkg-0.13.9-beta" = _dy6O0ZYb;
        "pkg-0.14.0-beta" = _IO3HcMGq;
        "pkg-0.14.1-beta" = _o44fzA4w;
        "pkg-0.14.2-beta" = _CMQzWORd;
        "pkg-0.14.3-beta" = _3EKcU1cf;
        "pkg-0.14.4-beta" = _mpyupO4W;
        "pkg-0.14.5-beta" = _ZIWxMaY6;
        "pkg-0.14.6-beta" = _XRYb3brF;
        "pkg-0.14.7-beta" = _g2pvVH9L;
        "pkg-0.14.8-beta" = _C4VTuik1;
