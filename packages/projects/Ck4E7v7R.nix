...
let
    ...
    in {
        ...
        "pkg-2.5.1" = _TJCbccGV;
        "pkg-2.6.0" = _EYCR81MC;
        "pkg-20.1.0" = _5mqlOvG2;
        "pkg-20.1.1" = _6YvyGAhn;
        "pkg-20.1.2" = _XvKviSFT;
        "pkg-21.1.0" = _MfzKuNeT;
        "pkg-21.1.1" = _PALpfSdf;
        "pkg-20.1.3" = _9sKYi729;
        "pkg-20.4.0" = _UCCmRukH;
        "pkg-21.1.2" = _OxZVGdoc;
        "pkg-21.1.3" = _q4vfSfnf;
        "pkg-21.1.4" = _UZdn4CrG;
        "pkg-21.1.5" = _9bFR1hey;
        "pkg-21.1.6" = _z9pvLwQu;
        "pkg-21.5.1-beta" = _RvL3KRMw;
        "pkg-21.5.2-beta" = _CysMb58a;
        "pkg-21.5.3-beta" = _c2xUpSFa;
        "pkg-21.1.7" = _ZT6SDp8y;
        "pkg-21.5.4-beta" = _ktHc44gU;
        "pkg-21.1.8" = _k7QwRTdT;
        "pkg-20.1.4" = _pkfJxPf5;
        "pkg-20.1.5" = _epJbg5GY;
        "pkg-20.4.1" = _zABB8eQ6;
        "pkg-21.5.5-beta" = _wGYFyyDD;
        "pkg-21.1.9" = _9aIv5HxH;
        "pkg-20.1.6" = _38moZClH;
        "pkg-20.4.2" = _M0tbbSsK;
        "pkg-20.1.7" = _UD2nQxJx;
        "pkg-20.1.8" = _Dhg3onO2;
        "pkg-21.5.6-beta" = _iDrLs24j;
        "pkg-20.4.3" = _Gwp5RAgH;
        "pkg-21.1.10" = _OfYs7zqx;
        "pkg-20.1.9" = _tFSpeWeb;
        "pkg-21.5.7-beta" = _FL1LKeeF;
        "pkg-20.4.4" = _34nxwTed;
        "pkg-20.1.10" = _ukJkxTNZ;
        "pkg-21.1.11" = _i3Dj1DYf;
        "pkg-21.5.8-beta" = _HiiD800A;
        "pkg-21.1.12" = _qRC2AU31;
        "pkg-20.4.5" = _Mbfe7k4x;
        "pkg-20.1.11" = _mfDRKud3;
        "pkg-21.5.9-beta" = _o5fVAod4;
        "pkg-21.1.13" = _tXH7e2zY;
        "pkg-21.8.1" = _ucVfDIJN;
        "pkg-21.1.14" = _fTbylf08;
        "pkg-20.1.12" = _EaVlVvP1;
        "pkg-21.8.2" = _6r6kdXLW;
        "pkg-21.8.3" = _4piwoOoM;
        "pkg-20.1.13" = _SYp7t1xZ;
        "pkg-21.10.1-beta" = _xT72Jt9l;
        "pkg-21.10.2-beta" = _p5SMSFSs;
        "pkg-21.1.15" = _ILW6vM7o;
        "pkg-20.1.14" = _9YGnKYDF;
        "pkg-20.4.6" = _ReOCRQ9T;
        "pkg-26.1.0-alpha" = _jL1I6Zox;
        "pkg-26.1.1-alpha" = _JOVPJkqr;
        "pkg-21.11.1-beta" = _pP3LL7Ak;
        "pkg-26.1.2-alpha" = _DWuxBDxq;
        "pkg-26.1.3-alpha" = _8QVhcWvx;
        "pkg-26.1.4-alpha" = _Zvfc10U9;
        "pkg-26.1.5-alpha" = _LJM2gPTc;
        "pkg-26.1.6-alpha" = _q2t9O2b8;
        "pkg-26.1.7-alpha" = _TMLh9vTF;
        "pkg-26.1.9-alpha" = _wGVS8dO2;
        "pkg-26.1.10-alpha" = _8kfbvsJl;
        "pkg-26.1.11-beta" = _wiNQW8T5;
        "pkg-21.1.16" = _bFr2FBaJ;
