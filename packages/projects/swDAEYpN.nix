...
let
    versions = (let
        ...
        _JtRqnAdC = {
            "id" = "JtRqnAdC";
            "file" = "reliable_replacer-neoforge-1.21.1-1.8.0.jar";
            "hash" = "sha512-u+xtoN6wJI+QluvgxhLWrCPVj9w9ZwUuEo3L+6p+Z+nhDLkGqj4VLSXuA7L3Bd/shO51a0og+fO6tpWYqxYSdg==";
        };
        _BfKCCYTP = {
            "id" = "BfKCCYTP";
    ...
    in {
        ...
        "pkg-1.2.8" = _uJkKUInw;
        "pkg-1.2.9" = _Y9bVVrS5;
        "pkg-1.2.10" = _xrIE7wQr;
        "pkg-1.3.0" = _oezgf0UH;
        "pkg-1.3.0-fabric-1.21.1" = _UOW8Q1HW;
        "pkg-1.3.0-neoforge-1.21.1" = _21b30Gc6;
        "pkg-1.3.0-26.1.2-neoforge" = _tGoABcds;
        "pkg-1.3.0-26.1.2-fabric" = _lg9hCyld;
        "pkg-1.4.0" = _bB2xQMFw;
        "pkg-1.4.0-fabric-1.21.1" = _kskKQWYN;
        "pkg-1.4.0-neoforge-1.21.1" = _wuTCCOMt;
        "pkg-1.4.0-26.1.2-fabric" = _QlIsj3gn;
        "pkg-1.4.0-26.1.2-neoforge" = _92gBv0aL;
        "pkg-1.5.0" = _M8LhjheR;
        "pkg-1.5.0-fabric-1.21.1" = _ZECp3ih7;
        "pkg-1.5.0-neoforge-1.21.1" = _OfpfJWX5;
        "pkg-1.5.0-26.1.2-neoforge" = _onsRCiSC;
        "pkg-1.5.0-26.1.2-fabric" = _HxVxQ9oN;
        "pkg-1.5.1-neoforge-1.21.1" = _hPRv4MvI;
        "pkg-1.5.1-fabric-1.21.1" = _Li62G1fn;
        "pkg-1.5.1" = _MB6SdAbE;
        "pkg-1.5.2-neoforge-1.21.1" = _HRXt4O0C;
        "pkg-1.5.2-fabric-1.21.1" = _CUZu9TSO;
        "pkg-1.5.2" = _rfJH9PnJ;
        "pkg-1.5.2-26.1.2-fabric" = _EMeKSI8r;
        "pkg-1.5.2-26.1.2-neoforge" = _obVBWMLj;
        "pkg-1.5.3-26.1.2-fabric" = _FPQejRIn;
        "pkg-1.5.3-26.1.2-neoforge" = _KdxDflim;
        "pkg-1.5.3-neoforge-1.21.1" = _g5hGGrER;
        "pkg-1.5.3-fabric-1.21.1" = _5PnCIdCG;
        "pkg-1.5.3" = _XiG3OMmx;
        "pkg-1.5.4-26.1.2-fabric" = _o7RddFb2;
        "pkg-1.5.4-26.1.2-neoforge" = _sTcdkTLy;
        "pkg-1.5.4-neoforge-1.21.1" = _OUMoUk8K;
        "pkg-1.5.4-fabric-1.21.1" = _CaDl2HsK;
        "pkg-1.5.4" = _ajdPKVao;
        "pkg-1.5.5-neoforge-1.21.1" = _XnMm4kI7;
        "pkg-1.5.5-fabric-1.21.1" = _D5iNex1r;
        "pkg-1.5.5" = _3A10XonZ;
        "pkg-1.5.5-26.1.2-neoforge" = _M58HUnBR;
        "pkg-1.5.5-26.1.2-fabric" = _WATOclbJ;
        "pkg-1.5.6" = _zIVfgkgp;
        "pkg-1.5.7" = _oKG38yeu;
        "pkg-1.5.5-26.2-neoforge" = _qr5p5szu;
        "pkg-1.5.5-26.2-fabric" = _JfG28hlo;
        "pkg-1.5.6-neoforge-1.21.1" = _VRpYL8Co;
        "pkg-1.5.6-fabric-1.21.1" = _4SbeqUMQ;
        "pkg-1.6.0-neoforge-1.21.1" = _Dn2XtOlQ;
        "pkg-1.6.0-fabric-1.21.1" = _9VfV5b88;
        "pkg-1.6.1-neoforge-1.21.1" = _M76FevQO;
