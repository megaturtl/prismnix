...
let
    versions = (let
        ...
        _FaxeMd1m = {
            "id" = "FaxeMd1m";
            "file" = "CF32J-2026r17.zip";
            "hash" = "sha512-/ggpePDlcWNkjoXLAYmp1XbtNCiP2kcS0Kxl66dsYLgJ4F+/nwNF8gBaUbcaN1G9Om6cPS/5PmKmQncqZvzPXQ==";
        };
        _kBHdGYJy = {
            "id" = "kBHdGYJy";
            "file" = "CF32J-2026r18.zip";
            "hash" = "sha512-qmkF7FRB1k+uOB9JL5Ueqm7IRmgSacQKZ0HPo9AvNxBHBOAioffCiv6zGOgBklFS4RLklpZtFP+NDh/i6O54vA==";
        };
        _3z79B1Av = {
            "id" = "3z79B1Av";
    ...
    in {
        ...
        "pkg-2025r1" = _EgFr7ifv;
        "pkg-2025r2" = _kaAtptkb;
        "pkg-2025r3" = _IRO1Ark8;
        "pkg-2025r4" = _HbO5Ylnn;
        "pkg-2025r5" = _xr7kyPgE;
        "pkg-2025r6" = _4gKuvMFb;
        "pkg-2025r7" = _yXIOgLfJ;
        "pkg-2025r8" = _rqsXbSOJ;
        "pkg-2025r9" = _bDSUlXzZ;
        "pkg-2025r10" = _SJC5zGY3;
        "pkg-2025r11" = _otqNzDR2;
        "pkg-2025r12" = _XbeS9hbZ;
        "pkg-2025r13" = _hVV7DJYi;
        "pkg-2025r14" = _CKJZXfZW;
        "pkg-2025r15" = _6VDNZSnZ;
        "pkg-2025r16" = _wMmr9O9R;
        "pkg-2025r17" = _L0uLivaZ;
        "pkg-2025r18" = _wbLcTqGm;
        "pkg-2025r19" = _u8ejoWCV;
        "pkg-2025r20" = _POlR9uhv;
        "pkg-2025r21" = _hwwqOsIV;
        "pkg-2025r22" = _R8RbfTkO;
        "pkg-2025r23" = _qOkxDNmN;
        "pkg-2025r24" = _gwzei7It;
        "pkg-2026r1" = _DCB0v065;
        "pkg-2026r2" = _vHy88gfH;
        "pkg-2026r3" = _jXelkdk2;
        "pkg-2026r4" = _hAgYlRFk;
        "pkg-2026r5" = _slpHJWO7;
        "pkg-2026r6" = _9U4MR2fs;
        "pkg-2026r7" = _w8cGcZ3n;
        "pkg-2026r8" = _kdkTDQvK;
        "pkg-2026r9" = _3KZ8z2jt;
        "pkg-2026r10" = _VZNjxAOD;
        "pkg-2026r11" = _NFu6Ba2M;
        "pkg-2026r12" = _aaRLxsTy;
        "pkg-2026r13" = _2VY7V6hz;
        "pkg-2026r14" = _dM9kASVK;
        "pkg-2026r15" = _W5ilQ5Ox;
        "pkg-2026r16" = _nWcKiIq2;
