...
let
    ...
    in {
        ...
        "pkg-1.0+1.21.1" = _RVQtYpVb;
        "pkg-1.0+1.21.3" = _RS9EogUK;
        "pkg-1.0+1.21.4" = _XS8zK2Ja;
        "pkg-1.0+1.21.5" = _sgAlwx9s;
        "pkg-1.0+1.21.6" = _pdTAKgmj;
        "pkg-1.0+1.21.7" = _vvVUrtbR;
        "pkg-1.0+1.21.9" = _STfOTaHE;
        "pkg-1.0+1.21.10" = _mCGNKYSf;
