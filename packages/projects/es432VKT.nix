...
let
    versions = (let
        ...
        _deiSAaiW = {
            "id" = "deiSAaiW";
            "file" = "end-poem-extension-26.3-4.2.1+26.3-rc-2.jar";
            "hash" = "sha512-n04D69QRzc9LMCxKQxl0euQI0MNKMV7tI3CX65RNT9rszxChCTDfK3meNhISPJFt+7YVMd1JMSilO2WJct50Rw==";
        };
        _vo0zwyMu = {
            "id" = "vo0zwyMu";
            "file" = "end-poem-extension-fabric-4.2.1+1.20.1.jar";
            "hash" = "sha512-w6FYbXC+azo1nuQwQiDForYM3tl0wf5r/eUbqvxPqTA8cOarOj9cbdE2Op6vcqd6I8tB7cMwix43yvZfj4F4Kw==";
        };
        _UMHzfWT2 = {
            "id" = "UMHzfWT2";
            "file" = "end-poem-extension-forge-4.2.1+1.20.1.jar";
            "hash" = "sha512-QBXMhe5hJRpKjkHyRl21XjSs94nzzhIA6APT7T/s9eV1qkDgRT5GaimxK81JTw0Nw13WKW0oxeQQXxWLmHNguA==";
        };
        _cSpGj9Yw = {
            "id" = "cSpGj9Yw";
            "file" = "end-poem-extension-fabric-4.2.1+1.21.1.jar";
            "hash" = "sha512-W+Z8dAPmzFGGGm2QAoG6TPXrJGAq9rwzrhLobnRK5NetzsZVAEMV5FSAn4QkFLqmtONoQE8DrOXjceyIbY8eIQ==";
        };
        _jevinnAs = {
            "id" = "jevinnAs";
            "file" = "end-poem-extension-neoforge-4.2.1+1.21.1.jar";
            "hash" = "sha512-ifRbP4KxQuG88nQJ33IjOX/XbK3I6l9OuCBenZeLbmQSd9O5OuRlSbSlazYkr/MUTALFsd+0GCw3MRpGrA4xFQ==";
        };
        _kF8nv9Tn = {
            "id" = "kF8nv9Tn";
            "file" = "end-poem-extension-fabric-4.2.1+1.21.11.jar";
            "hash" = "sha512-CEGFdyLrDkGZjG3rrphfsmPLla3Vt+LsG3R1hno3Vk+8hz09XdFcZsIJdtnecnKx0EjI55zcgWaErP5iKoX2rA==";
        };
        _jAb5okLL = {
            "id" = "jAb5okLL";
            "file" = "end-poem-extension-neoforge-4.2.1+1.21.11.jar";
            "hash" = "sha512-nfzCGh2y926cfUerHihQpYebX9HGkUAxEpJcm3bROobfyIToWTWY4grNuhBQLS4Y9fxVljys2gS58jOZXOpdAA==";
        };
        _eHcm78no = {
            "id" = "eHcm78no";
            "file" = "end-poem-extension-26.2-4.2.2+26.2.jar";
            "hash" = "sha512-+wtprdde5wXlSSOgrlcMx+TCIcoGy1HiwlWGl1ESYJ9GfO+7m0bR6Mb0k7bzjQ3+ntpj2GI3DQiJFD4Z17z0jg==";
        };
        _EjEdY1mm = {
            "id" = "EjEdY1mm";
            "file" = "end-poem-extension-26.3-4.2.2+26.3-rc-2.jar";
            "hash" = "sha512-xGz2c9xLUWtPwRDxyXY6SlCroVQT7BMe74AfZ+SLcizbvabLUPjieUwhhqQApGnnklky1aHDwLwt5tbGDCpupw==";
        };
        _S6hrBwjM = {
            "id" = "S6hrBwjM";
            "file" = "end-poem-extension-fabric-4.2.2+1.20.1.jar";
            "hash" = "sha512-3MOYKxXSe4mqf4Mkq4vwTjAQ/Fal8SrDcqJs1jOa/eRPjz0429VCo8TVp2q9KrdoNncGN0m9QQaGZXJbwew1nQ==";
        };
        _fGF4CvMA = {
            "id" = "fGF4CvMA";
            "file" = "end-poem-extension-forge-4.2.2+1.20.1.jar";
            "hash" = "sha512-E5nXz3cuSJQug1+z4X4E6XsvAW+DRnFsK2zq5FiD95TlZCU9OK6oo3UjmS+4ryG79jPvHCdNKJxySYC3SxvV0Q==";
        };
        _DFzIYtt3 = {
            "id" = "DFzIYtt3";
            "file" = "end-poem-extension-fabric-4.2.2+1.21.1.jar";
            "hash" = "sha512-T6TaZEuRwpG4Zl/Q54aFIyxWXgydzqXs1qArZJG6J8tWKxmPzkG7GPrtmT3D3Pmd2vS0QD148FUSbxX8URL1lg==";
        };
        _YgntDD1f = {
            "id" = "YgntDD1f";
            "file" = "end-poem-extension-neoforge-4.2.2+1.21.1.jar";
            "hash" = "sha512-7zwfAlV/D0puj4DScDNDkyzajcV+FQdr4g4oIKJT8surtkADYQA/LV8zvc9VVa2mbc7VpsOgkLahuX8BRqKO8w==";
        };
        _uHIhB3Qc = {
            "id" = "uHIhB3Qc";
            "file" = "end-poem-extension-fabric-4.2.2+1.21.11.jar";
            "hash" = "sha512-B1oCrsouHnW8NEwovtGcy1Uo8sJIoHH6z5lAbrRLd2m/N1cQUzTKJl/20YaLptder83YIZ+O40Hc9CvU9HWE+Q==";
        };
        _V9mkOcEJ = {
            "id" = "V9mkOcEJ";
            "file" = "end-poem-extension-neoforge-4.2.2+1.21.11.jar";
            "hash" = "sha512-fo4tpQPc84qr80eoxMr1b+W2kTvj8XCGUmSCAdtYugSlQwkxvjdtyJBh0fR6CzLP2R5ywQxKTR9JpXB6y8c5kQ==";
        };
        _lNsODdHJ = {
            "id" = "lNsODdHJ";
            "file" = "end-poem-extension-26.2-4.2.3+26.2.jar";
            "hash" = "sha512-+CsAU7NNb0nFFXm19fvipFM+l5A1Ok2c+i6M/NfdPbMLKXHrSV7HasKb6LNUh0ABuMHSuBss7v9uQYEciB+EFw==";
        };
        _JkdHElNi = {
            "id" = "JkdHElNi";
            "file" = "end-poem-extension-26.3-4.2.3+26.3-rc-2.jar";
            "hash" = "sha512-OzYjRpUlXB7PJZt/6QqtXj0W/BTdXe3P141DB724KrSh9K8DJYd4ZUL0Xjv+foqQzxnshV4RSlP94sqzSY0VZA==";
        };
        _ZU5Vxdby = {
            "id" = "ZU5Vxdby";
            "file" = "end-poem-extension-fabric-4.2.3+1.20.1.jar";
            "hash" = "sha512-BXyi9Hqw7wGnNrkIbIsZyWZLMoBM1vrMTGou6IDfyErsFfLqpiD1S2Qj3qsYbdeFahXfxWG85a4isKmVYai+KQ==";
        };
        _tNgFLNZq = {
            "id" = "tNgFLNZq";
            "file" = "end-poem-extension-forge-4.2.3+1.20.1.jar";
            "hash" = "sha512-cmq7LxUIVrcw5abfKwlRYXd9FSFcVWH25Nv6lnfAhJE805v8WGjCY4GaBwEEcgIzaKM3ECxA+kLYkEU0ds70qg==";
        };
        _n7yMjXmW = {
            "id" = "n7yMjXmW";
            "file" = "end-poem-extension-fabric-4.2.3+1.21.1.jar";
            "hash" = "sha512-OahwmedeIi9UAwsKUtqNacltITTczsQrh2INlHX4OCEdUkhXHzBZ2UUTAZdS72PBeCicv32J/Tw9ZpKOj8k6og==";
        };
        _5bUFgecV = {
            "id" = "5bUFgecV";
            "file" = "end-poem-extension-neoforge-4.2.3+1.21.1.jar";
            "hash" = "sha512-hm0XzsAIeVAI0yq1o4y7FTSfIG3Zct3IxLzyT29LSpD6OnynRi2TQg9FTz5hC9yesnxVa924HhXaGRc3IbciEg==";
        };
        _l8DnnUNJ = {
            "id" = "l8DnnUNJ";
            "file" = "end-poem-extension-fabric-4.2.3+1.21.11.jar";
            "hash" = "sha512-p3ieJUfmr0Ka+2Td1aixn3JIoS5xioH0zMUlDdv8CWfAPmjNDjTshefMsruN5WXnQJPsSaXd7clIsUB7sFYIZQ==";
        };
        _WfqxKVFB = {
            "id" = "WfqxKVFB";
            "file" = "end-poem-extension-neoforge-4.2.3+1.21.11.jar";
            "hash" = "sha512-t1AbN3w6rA4u82vEl7D+j43BHfhS2ZVl73gt3ZYhWNzxOPNd+21LDKqOWAp/xTM0aJzOWSEvqUGeWMgNPs6jmQ==";
        };
    in {
        "Vr4cWw3C" = _Vr4cWw3C;
        "iU7r8L4J" = _iU7r8L4J;
        ...
        "fabric-1.20" = _ZU5Vxdby;
        "fabric-1.20.1" = _ZU5Vxdby;
        "fabric-1.20.2" = _iVjpqx7q;
        "fabric-1.20.3" = _iVjpqx7q;
        "fabric-1.20.4" = _iVjpqx7q;
        "fabric-1.20.5" = _iVjpqx7q;
        "fabric-1.20.6" = _qR8phxZf;
        "fabric-1.21" = _n7yMjXmW;
        "fabric-1.21.1" = _n7yMjXmW;
        "fabric-1.21.2" = _n7yMjXmW;
        "fabric-1.21.3" = _n7yMjXmW;
        "fabric-1.21.4" = _n7yMjXmW;
        "fabric-1.21.5" = _n7yMjXmW;
        "fabric-1.21.6" = _n7yMjXmW;
        "fabric-1.21.7" = _n7yMjXmW;
        "fabric-1.21.8" = _n7yMjXmW;
        "fabric-1.21.9" = _n7yMjXmW;
        "fabric-1.21.10" = _n7yMjXmW;
        "fabric-1.21.11" = _l8DnnUNJ;
        ...
        "fabric-26.1" = _lNsODdHJ;
        "fabric-26.1.1" = _lNsODdHJ;
        "fabric-26.1.2" = _lNsODdHJ;
        "fabric-26.2-pre-3" = _ZOWgTiV8;
        "fabric-26.2" = _lNsODdHJ;
        "fabric-26.3-rc-2" = _JkdHElNi;
        "fabric-26.3-rc-3" = _JkdHElNi;
        "fabric-26.3" = _JkdHElNi;
        ...
        "quilt-1.20" = _ZU5Vxdby;
        "quilt-1.20.1" = _ZU5Vxdby;
        "quilt-1.20.2" = _iVjpqx7q;
        "quilt-1.20.3" = _iVjpqx7q;
        "quilt-1.20.4" = _iVjpqx7q;
        "quilt-1.20.5" = _iVjpqx7q;
        "quilt-1.20.6" = _qR8phxZf;
        "quilt-1.21" = _n7yMjXmW;
        "quilt-1.21.1" = _n7yMjXmW;
        "quilt-1.21.2" = _n7yMjXmW;
        "quilt-1.21.3" = _n7yMjXmW;
        "quilt-1.21.4" = _n7yMjXmW;
        "quilt-1.21.5" = _n7yMjXmW;
        "quilt-1.21.6" = _n7yMjXmW;
        "quilt-1.21.7" = _n7yMjXmW;
        "quilt-1.21.8" = _n7yMjXmW;
        "quilt-1.21.9" = _n7yMjXmW;
        "quilt-1.21.10" = _n7yMjXmW;
        "quilt-1.21.11" = _l8DnnUNJ;
        "quilt-26.1" = _lNsODdHJ;
        "quilt-26.1.1" = _lNsODdHJ;
        "quilt-26.1.2" = _lNsODdHJ;
        "quilt-26.2-pre-3" = _ZOWgTiV8;
        "quilt-26.2" = _lNsODdHJ;
        "quilt-26.3-rc-2" = _JkdHElNi;
        "quilt-26.3-rc-3" = _JkdHElNi;
        "quilt-26.3" = _JkdHElNi;
        "forge-1.19.4" = _OtHucMm6;
        "forge-1.20" = _tNgFLNZq;
        "forge-1.20.1" = _tNgFLNZq;
        ...
        "neoforge-1.21" = _5bUFgecV;
        "neoforge-1.21.1" = _5bUFgecV;
        "neoforge-1.21.2" = _5bUFgecV;
        "neoforge-1.21.3" = _5bUFgecV;
        "neoforge-1.21.4" = _5bUFgecV;
        "neoforge-1.21.5" = _5bUFgecV;
        "neoforge-1.21.6" = _5bUFgecV;
        "neoforge-1.21.7" = _5bUFgecV;
        "neoforge-1.21.8" = _5bUFgecV;
        "neoforge-1.21.9" = _5bUFgecV;
        "neoforge-1.21.10" = _5bUFgecV;
        "neoforge-1.21.11" = _WfqxKVFB;
        ...
        "neoforge-26.1" = _lNsODdHJ;
        "neoforge-26.1.1" = _lNsODdHJ;
        "neoforge-26.1.2" = _lNsODdHJ;
        "neoforge-26.2-pre-3" = _ZOWgTiV8;
        "neoforge-1.20" = _tNgFLNZq;
        "neoforge-1.20.1" = _tNgFLNZq;
        "neoforge-26.2" = _lNsODdHJ;
        "neoforge-26.3-rc-2" = _JkdHElNi;
        "neoforge-26.3-rc-3" = _JkdHElNi;
        "neoforge-26.3" = _JkdHElNi;
        "pkg-v2.0.0+build.3" = _Vr4cWw3C;
        "pkg-v2.0.0+build.4" = _iU7r8L4J;
        "pkg-v2.0.0+build.5" = _TtlNYYkL;
        "pkg-v2.0.0+1.18.build.4" = _Nc3xuDY4;
        "pkg-2.1.0+1.18" = _18HYRjIg;
        "pkg-2.1.0+1.19" = _NSuN2N82;
        "pkg-2.1.0+1.20" = _IA741Dtg;
        "pkg-2.2.2+1.18" = _QquYzRN0;
        "pkg-2.2.2+1.19" = _aDMTlbXu;
        "pkg-2.2.2+1.20" = _pGI7qDE0;
        "pkg-2.2.2+1.20-forge" = _5tqrMEez;
        "pkg-2.2.2+1.19-forge" = _LW53ZDdP;
        "pkg-2.2.2+1.18-forge" = _oW5l8lW9;
        "pkg-3.0.0+1.18-forge" = _mL3XhyJT;
        "pkg-3.0.0+1.18" = _vvtjdM7m;
        "pkg-3.0.1+1.18" = _XcsoGx04;
        "pkg-3.0.1+1.18-forge" = _WSBfFgY7;
        "pkg-3.0.1+1.19-forge" = _MrCONUqA;
        "pkg-3.0.1+1.19" = _XgiR7jid;
        "pkg-3.0.1+1.20-forge" = _ivzdjESq;
        "pkg-3.0.1+1.20" = _EKFYM3hb;
        "pkg-3.0.2+1.20-fabric" = _iVjpqx7q;
        "pkg-3.0.2+1.20-forge" = _OtHucMm6;
        "pkg-3.0.2+1.20-neo" = _WN8oMmxZ;
        "pkg-3.1.0+1.20-forge" = _RIAsnFBM;
        "pkg-3.1.0+1.20-fabric" = _qR8phxZf;
        "pkg-3.1.0+1.20-neo" = _LkXLSfkX;
        "pkg-3.1.0+1.21-forge" = _5G2sP2J4;
        "pkg-3.1.0+1.21-fabric" = _JbYjNWLY;
        "pkg-3.1.0+1.21-neo" = _Me2GBCSY;
        "pkg-3.1.2+1.21-forge" = _eAxIs9gp;
        "pkg-3.1.2+1.21-fabric" = _AqqOxBh2;
        "pkg-3.1.2+1.21-neo" = _8gMSVp8y;
        "pkg-3.1.3+1.21-fabric" = _l6EnD0Kr;
        "pkg-3.1.3+1.21-forge" = _HNU8cdEm;
        "pkg-3.1.3+1.21-neoforge" = _iPmfmlpC;
        "pkg-3.1.4+1.21-fabric" = _plakIMQ0;
        "pkg-3.1.4+1.21-neoforge" = _35My8FP6;
        "pkg-3.1.7+1.21-fabric" = _Pips7Cmw;
        "pkg-3.1.7+1.21-forge" = _oJVGdcQU;
        "pkg-3.1.7+1.21-neoforge" = _B9cPMJXB;
        "pkg-3.1.8+1.21-fabric" = _DrMaCa7h;
        "pkg-3.1.8+1.21-forge" = _HJShByTa;
        "pkg-3.1.8+1.21-neoforge" = _tf9RSO2a;
        "pkg-3.2.1+1.21-fabric" = _6Lr0IDyR;
        "pkg-3.2.1+1.21-forge" = _BvkPuVvK;
        "pkg-3.2.1+1.21-neoforge" = _1sUAOGdL;
        "pkg-3.2.2+1.21-fabric" = _xgk2qUgl;
        "pkg-3.2.2+1.21-forge" = _Weeqrj8W;
        "pkg-3.2.2+1.21-neoforge" = _AW1VaW2L;
        "pkg-3.3.0+1.21-fabric" = _CcMMl09W;
        "pkg-3.3.0+1.21-forge" = _mAVZTlX4;
        "pkg-3.3.0+1.21-neoforge" = _1Z7vkFHi;
        "pkg-3.3.1+1.21-fabric" = _3YqxVkz0;
        "pkg-3.3.1+1.21-forge" = _M4mME1lB;
        "pkg-3.3.1+1.21-neoforge" = _FvlAHZ01;
        "pkg-3.3.2+1.21-fabric" = _ihw9iyc1;
        "pkg-3.3.2+1.21-forge" = _beDMRIk0;
        "pkg-3.3.2+1.21-neoforge" = _diILbF2U;
        "pkg-3.3.3+1.21-fabric" = _Rw8pZRPM;
        "pkg-3.3.3+1.21-neoforge" = _ZaYCRnzv;
        "pkg-3.3.4+25.4-fabric" = _luIU0kny;
        "pkg-3.3.4+25.4-neoforge" = _UZv4c8UE;
        "pkg-3.3.5+25.4-fabric" = _YpA9nBBS;
        "pkg-3.3.5+25.4-neoforge" = _UVbC5O9w;
        "pkg-3.3.5+26.1-universal" = _poXYOYHa;
        "pkg-3.3.6+26.1-universal" = _9eoMzAro;
        "pkg-3.3.7+26.1-universal" = _xmzkEzDi;
        "pkg-3.3.8+26.1-universal" = _3Dyg3y2y;
        "pkg-3.3.9+26.1-universal" = _m0krptjl;
        "pkg-3.3.10+26.1-universal" = _p3f2SBZM;
        "pkg-3.3.10+25.4-fabric" = _Ctm8DOql;
        "pkg-3.3.10+25.4-neoforge" = _dmRPNabX;
        "pkg-4.0.0-universal+26.2" = _ZOWgTiV8;
        "pkg-4.0.0-1.20.1+1.20.1" = _wKjHPdba;
        "pkg-4.0.0-1.21.1+1.21.1" = _Ju82SVhq;
        "pkg-4.0.0-1.21.11+1.21.11" = _yTHfTbo2;
        "pkg-4.0.2-universal+26.2" = _qYfLb8Sp;
        "pkg-4.0.2-1.20.1+1.20.1" = _q3zKicTY;
        "pkg-4.0.2-1.21.1+1.21.1" = _nF4mdi5L;
        "pkg-4.0.2-1.21.11+1.21.11" = _hlOABmoO;
        "pkg-4.1.0-universal+26.2" = _EIdBopgI;
        "pkg-4.1.0-1.20.1+1.20.1" = _kAfAhFvC;
        "pkg-4.1.0-1.21.1+1.21.1" = _dtHcvk6T;
        "pkg-4.1.0-1.21.11+1.21.11" = _YBR5P8zK;
        "pkg-4.2.0-universal+26.2" = _Jb0E1zNd;
        "pkg-4.2.0-1.20.1+1.20.1" = _7ySMLs5y;
        "pkg-4.2.0-1.21.1+1.21.1" = _TNZkzAQ4;
        "pkg-4.2.0-1.21.11+1.21.11" = _Z3ZJccEh;
        "pkg-4.2.1-universal+26.3" = _deiSAaiW;
        "pkg-4.2.1-1.20.1+1.20.1" = _UMHzfWT2;
        "pkg-4.2.1-1.21.1+1.21.1" = _jevinnAs;
        "pkg-4.2.1-1.21.11+1.21.11" = _jAb5okLL;
        "pkg-4.2.2-universal+26.2" = _eHcm78no;
        "pkg-4.2.2-universal+26.3" = _EjEdY1mm;
        "pkg-4.2.2-Fabric+1.20.1" = _S6hrBwjM;
        "pkg-4.2.2-Forge+1.20.1" = _fGF4CvMA;
        "pkg-4.2.2-Fabric+1.21.1" = _DFzIYtt3;
        "pkg-4.2.2-Neo+1.21.1" = _YgntDD1f;
        "pkg-4.2.2-Fabric+1.21.11" = _uHIhB3Qc;
        "pkg-4.2.2-Neo+1.21.11" = _V9mkOcEJ;
        "pkg-4.2.3-universal+26.2" = _lNsODdHJ;
        "pkg-4.2.3-universal+26.3" = _JkdHElNi;
        "pkg-4.2.3-Fabric+1.20.1" = _ZU5Vxdby;
        "pkg-4.2.3-Forge+1.20.1" = _tNgFLNZq;
        "pkg-4.2.3-Fabric+1.21.1" = _n7yMjXmW;
        "pkg-4.2.3-Neo+1.21.1" = _5bUFgecV;
        "pkg-4.2.3-Fabric+1.21.11" = _l8DnnUNJ;
        "pkg-4.2.3-Neo+1.21.11" = _WfqxKVFB;
        "default" = _WfqxKVFB;
    });
