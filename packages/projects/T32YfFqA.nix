...
let
    versions = (let
        ...
        _Omh0y16f = {
            "id" = "Omh0y16f";
            "file" = "TreeMiner-1.4.jar";
            "hash" = "sha512-Cm+V1RAYJTr9ANUB5DWULjBrzi8rWKR85swVaVRto68LdAxvAnVLdEI0BW9tFpHCL9FE+AiHs/qUOKebCtvXVQ==";
        };
    in {
        "T1cZmDxR" = _T1cZmDxR;
        "58sPJTWY" = _58sPJTWY;
        ...
        "bukkit-1.21" = _Omh0y16f;
        "bukkit-1.21.1" = _Omh0y16f;
        "bukkit-1.21.2" = _Omh0y16f;
        "bukkit-1.21.3" = _Omh0y16f;
        "bukkit-1.21.4" = _Omh0y16f;
        "bukkit-1.21.5" = _Omh0y16f;
        "bukkit-1.21.6" = _Omh0y16f;
        "bukkit-1.21.7" = _Omh0y16f;
        "bukkit-1.21.8" = _Omh0y16f;
        "bukkit-1.21.9" = _Omh0y16f;
        "bukkit-1.21.10" = _Omh0y16f;
        "bukkit-1.21.11" = _Omh0y16f;
        "bukkit-26.1" = _Omh0y16f;
        "bukkit-26.1.1" = _Omh0y16f;
        "bukkit-26.1.2" = _Omh0y16f;
        "bukkit-26.2" = _Omh0y16f;
        "bukkit-26.3" = _Omh0y16f;
        ...
        "paper-1.21" = _Omh0y16f;
        "paper-1.21.1" = _Omh0y16f;
        "paper-1.21.2" = _Omh0y16f;
        "paper-1.21.3" = _Omh0y16f;
        "paper-1.21.4" = _Omh0y16f;
        "paper-1.21.5" = _Omh0y16f;
        "paper-1.21.6" = _Omh0y16f;
        "paper-1.21.7" = _Omh0y16f;
        "paper-1.21.8" = _Omh0y16f;
        "paper-1.21.9" = _Omh0y16f;
        "paper-1.21.10" = _Omh0y16f;
        "paper-1.21.11" = _Omh0y16f;
        "paper-26.1" = _Omh0y16f;
        "paper-26.1.1" = _Omh0y16f;
        "paper-26.1.2" = _Omh0y16f;
        "paper-26.2" = _Omh0y16f;
        "paper-26.3" = _Omh0y16f;
        ...
        "spigot-1.21" = _Omh0y16f;
        "spigot-1.21.1" = _Omh0y16f;
        "spigot-1.21.2" = _Omh0y16f;
        "spigot-1.21.3" = _Omh0y16f;
        "spigot-1.21.4" = _Omh0y16f;
        "spigot-1.21.5" = _Omh0y16f;
        "spigot-1.21.6" = _Omh0y16f;
        "spigot-1.21.7" = _Omh0y16f;
        "spigot-1.21.8" = _Omh0y16f;
        "spigot-1.21.9" = _Omh0y16f;
        "spigot-1.21.10" = _Omh0y16f;
        "spigot-1.21.11" = _Omh0y16f;
        "spigot-26.1" = _Omh0y16f;
        "spigot-26.1.1" = _Omh0y16f;
        "spigot-26.1.2" = _Omh0y16f;
        "spigot-26.2" = _Omh0y16f;
        "spigot-26.3" = _Omh0y16f;
        ...
        "pkg-1.0.0" = _58sPJTWY;
        "pkg-1.0.0-UPDATE" = _golCv56R;
        "pkg-1.0.0-1" = _U2szKt0f;
        "pkg-1.0.0-2" = _1axIh6lm;
        "pkg-1.0.0-3" = _d8lChVOD;
        "pkg-1.1" = _o7tfZaDT;
        "pkg-1.2" = _hompfmFi;
        "pkg-1.3" = _bdexxk0H;
        "pkg-1.3-FIX" = _Yb8HPft5;
        "pkg-1.3-2FIX" = _i2Q2f7O1;
        "pkg-1.3-1" = _L1XK8p1I;
        "pkg-1.4" = _NYR0JuXG;
        "pkg-1.4-1" = _nBNXRn3r;
        "pkg-1.4-2" = _Omh0y16f;
