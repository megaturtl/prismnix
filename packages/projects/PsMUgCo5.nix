...
let
    versions = (let
        ...
        _JrmvYntC = {
            "id" = "JrmvYntC";
            "file" = "Hyper_Realistic_Sky_[v3.10].zip";
            "hash" = "sha512-w2v6ntRLAsTBF9RZfYWtEBrv0wocbgT0i8HpGSPdY72vWue8HaBMCA6vroL6EYygylkSWAOQku5/YRJ/rXKB3A==";
        };
    in {
        "XYNIjJ6U" = _XYNIjJ6U;
        "7ZR6oVah" = _7ZR6oVah;
        ...
        "kwKAac4Q" = _kwKAac4Q;
        "JrmvYntC" = _JrmvYntC;
        "minecraft-1.16.5" = _JrmvYntC;
        "minecraft-1.17.1" = _vF8BRNfj;
        "minecraft-1.18.2" = _JrmvYntC;
        "minecraft-1.19.2" = _vF8BRNfj;
        "minecraft-1.19.3" = _vF8BRNfj;
        "minecraft-1.19.4" = _JrmvYntC;
        "minecraft-1.20" = _JrmvYntC;
        "minecraft-1.20.1" = _JrmvYntC;
        "minecraft-1.19" = _vF8BRNfj;
        "minecraft-1.19.1" = _vF8BRNfj;
        "minecraft-1.20.2" = _JrmvYntC;
        "minecraft-1.20.3" = _JrmvYntC;
        "minecraft-1.20.4" = _JrmvYntC;
        "minecraft-1.20.5" = _vF8BRNfj;
        "minecraft-1.20.6" = _vF8BRNfj;
        "minecraft-1.21" = _JrmvYntC;
        "minecraft-1.21.1" = _JrmvYntC;
        "minecraft-1.17" = _lWNsnpAo;
        "minecraft-1.18" = _JrmvYntC;
        "minecraft-1.18.1" = _JrmvYntC;
        "minecraft-1.21.5" = _JrmvYntC;
        "minecraft-1.21.4" = _JrmvYntC;
        "minecraft-1.21.2" = _JrmvYntC;
        "minecraft-1.21.3" = _JrmvYntC;
        "minecraft-1.21.6" = _JrmvYntC;
        "minecraft-1.21.7" = _JrmvYntC;
        "minecraft-1.21.8" = _JrmvYntC;
        "minecraft-1.21.9" = _JrmvYntC;
        "minecraft-1.21.10" = _JrmvYntC;
        "minecraft-1.21.11" = _JrmvYntC;
        "minecraft-26.1" = _JrmvYntC;
        "minecraft-26.1.1" = _JrmvYntC;
        "minecraft-26.1.2" = _JrmvYntC;
        "minecraft-26.2" = _JrmvYntC;
        "minecraft-26.3" = _JrmvYntC;
        "pkg-1.5" = _pJf3TVpA;
        "pkg-1.6" = _aX0QCd1r;
        "pkg-1.7" = _pMSUxsN7;
        "pkg-1.8" = _XwWQ2Smf;
