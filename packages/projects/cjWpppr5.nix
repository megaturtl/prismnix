...
let
    ...
    in {
        ...
        "pkg-0.0.1-Beta1-HOTFIX7" = _GAei94nL;
        "pkg-0.0.1-Beta2" = _LmDoPoQZ;
        "pkg-0.0.1-Beta3" = _gzEkfQQd;
        "pkg-0.0.1-Beta3-HOTFIX1" = _63adHTsd;
        "pkg-0.0.1-Beta3-HOTFIX2" = _noDyV61a;
        "pkg-0.0.1-Beta4" = _ZJF4bp1x;
        "pkg-0.0.1-Beta4-HOTFIX1" = _fgKv5mAd;
        "pkg-0.0.1-Beta5" = _y40Sa0Ou;
        "pkg-0.6.0" = _JBzqG5cC;
        "pkg-0.7.0" = _IeZibpLU;
        "pkg-0.7.1" = _XrR2U48n;
        "pkg-0.7.2" = _Eem0L5mN;
        ...
        "pkg-0.9.2" = _kuao9W1y;
        "pkg-0.9.3" = _yKgZl5aZ;
        "pkg-0.10.0" = _SZgknfyj;
        "pkg-0.11.0" = _RMiPgCoz;
        "pkg-0.11.1" = _sPN2FRqj;
        "pkg-0.11.2" = _ZPp6UyVa;
        "pkg-0.11.3" = _TbTr65xP;
        "pkg-0.12.0" = _MDnXwkd2;
        "pkg-0.12.1" = _NLPvUoPr;
        "pkg-0.12.2" = _1AuMWCIN;
        "pkg-0.13.0" = _AcztixTg;
        "pkg-0.13.1" = _cZzMDQK8;
        "pkg-0.13.2" = _ovrNbMvL;
        "pkg-0.13.3" = _tBlhpD5Z;
        "pkg-0.13.3-1.21.11-pre1" = _inZMF9tB;
        "pkg-0.13.3-1.21.11-pre2" = _MXGXN71c;
        "pkg-0.13.3-1.21.11-pre3" = _8tc3avVw;
        "pkg-0.14.0" = _7rQXVK4W;
        "pkg-0.14.1" = _tkYeTt6Q;
        "pkg-0.14.0-1.21.4" = _IEjucrND;
        "pkg-0.14.2-1.21.4" = _goA1M8x5;
        "pkg-0.14.2" = _Gky5Kfqv;
        "pkg-0.14.3" = _PqZziDuR;
        "pkg-0.14.3-1.21.4" = _cWvzK35G;
        "pkg-0.15.0" = _reMKrdhh;
        "pkg-0.15.1" = _rBoBPe3T;
        "pkg-0.16.0" = _IFEYgUJR;
        "pkg-0.16.1" = _hc14XhS9;
        "pkg-0.16.2" = _mWBjQwfu;
        "pkg-0.16.3" = _4HeSfex9;
        "pkg-0.16.4" = _30RJwtAf;
        "pkg-0.17.0" = _mXgRYsf4;
        "pkg-0.17.1" = _oborFIjW;
        "pkg-0.17.2" = _TnmcuJ4p;
        "pkg-0.18.0" = _WdDu8dFE;
