...
let
    ...
    in {
        ...
        "pkg-1.3.7" = _BiGhcdf4;
        "pkg-1.3.8" = _evjkV0iH;
        "pkg-1.3.8.1" = _hQRan9Om;
        "pkg-1.3.8.2" = _6tpF5QEW;
        "pkg-1.3.9" = _pNegVd6z;
        "pkg-1.3.9.1" = _zmO5q8g5;
        "pkg-1.3.9.2" = _KWpietrd;
        "pkg-1.3.9.3" = _HNsbHi6z;
        "pkg-1.3.9.4" = _J1P0u6nh;
        "pkg-1.3.9.5" = _2bj2fr0g;
        "pkg-1.3.9.6" = _JE3g2oCY;
        "pkg-1.3.10" = _wnkIuW5v;
        "pkg-1.3.11" = _lV8Vdutc;
        "pkg-1.3.11.1" = _hF6IdQKY;
        "pkg-1.3.11.2" = _oImk2QCS;
        "pkg-1.3.12" = _GBqFyb85;
        "pkg-1.3.13" = _98fk3eMb;
        "pkg-1.3.14" = _gYzovtuc;
        "pkg-1.3.15" = _XqQRUK3I;
        "pkg-1.3.15.1" = _nmgh7IxI;
        "pkg-1.3.15.2" = _P4PWJDAT;
        "pkg-1.3.15.3" = _5gqVb0Fj;
        "pkg-1.3.15.4" = _fcJTsdgA;
        "pkg-1.3.15.5" = _mlqaRT0o;
        "pkg-1.3.15.6" = _mPK9UAwy;
        "pkg-1.3.15.7" = _3uigAHG3;
        "pkg-1.4-pre1" = _9a4PXDzx;
        "pkg-1.4-pre2" = _qdjkG1jG;
        "pkg-1.4-pre3" = _EE8bKNUW;
        "pkg-1.4" = _mlksUXTz;
        "pkg-1.4.1" = _HJoqh5CY;
        "pkg-1.4.2" = _iElN9Y9l;
        "pkg-1.4.3" = _n86bmufA;
        ...
        "pkg-1.4.7" = _iA13Qk1W;
        "pkg-1.4.8" = _fV7YKh15;
        "pkg-1.4.8.1" = _KxDQdR2H;
        "pkg-1.4.8.2" = _tKp8mDeu;
        "pkg-1.4.9" = _PaE6yGEu;
        "pkg-1.4.10" = _AuLktPKX;
        "pkg-1.4.10.1" = _yyvie0Yw;
        "pkg-1.4.10.2" = _Px05h3b2;
        "pkg-1.4.11" = _DU4TkovS;
        "pkg-1.4.12" = _tQPSVt5W;
        "pkg-1.4.13" = _4Zi0ZJdN;
        "pkg-1.4.13.1" = _Vcm8AWIh;
        "pkg-1.4.13.2" = _hqCIiYS9;
        "pkg-1.4.13.3" = _HuiklElm;
        "pkg-1.4.13.4" = _vTw0gfku;
        "pkg-1.4.14" = _WvSmTXkN;
        "pkg-1.4.15" = _39Rp234f;
        "pkg-1.4.16" = _lufSQTRY;
        "pkg-1.4.16.1" = _SHSQr7vB;
        "pkg-1.4.16.2" = _MlfX6WVt;
        "pkg-1.4.16.3" = _MWH4KD5A;
        "pkg-1.4.17" = _RvNZj2zD;
        "pkg-1.4.17.1" = _ggY6NseN;
        "pkg-1.4.17.2" = _J2Jw0C7R;
        "pkg-1.4.17.3" = _wGfsSji8;
        "pkg-1.4.17.4" = _SvKOpDLn;
        "pkg-1.4.18" = _spDraGqo;
        "pkg-1.4.181" = _uibcVlU5;
        "pkg-1.4.182" = _GDlAZwma;
        "pkg-1.4.19" = _DuWP1Voh;
        "pkg-1.4.20" = _TC4JnOu9;
        "pkg-1.4.21" = _RmwED2Q1;
        "pkg-1.4.21.1" = _H0cIiNXh;
        "pkg-1.4.21.2" = _nVdJqaAt;
        "pkg-1.4.22" = _EXFrI1hz;
        "pkg-1.4.23" = _Ileb7KHG;
        "pkg-1.4.24" = _BliYzrA4;
        "pkg-1.4.25" = _kXWe5ysO;
        "pkg-1.4.25.1" = _yjESQlyQ;
        "pkg-1.4.26" = _ED2CiIFs;
        "pkg-1.4.27" = _8l1UwQ0A;
        "pkg-1.4.28" = _eLRhCv3N;
        "pkg-1.4.28.1" = _pgFAOh0O;
        "pkg-1.4.28.2" = _7faRzFpe;
        "pkg-1.4.28.3" = _GC1mqgtT;
        "pkg-1.4.28.4" = _DZCMOYO4;
        "pkg-1.4.28.5" = _7cDqPcwO;
        "pkg-1.4.28.6" = _1o47TKtJ;
        "pkg-1.4.28.7" = _90THKdpG;
        "pkg-1.4.29" = _WdRv1ALL;
        "pkg-1.4.29.1" = _so8Ta5Mx;
        "pkg-1.4.30" = _F8m3JO0h;
        "pkg-1.4.30.1" = _wrMy1iFp;
        "pkg-1.4.31" = _E70ikl4l;
        "pkg-1.4.31.1" = _l4OMrLEw;
        "pkg-1.4.31.2" = _sgTZnAKe;
        "pkg-1.4.31.3" = _whLdTdmk;
        "pkg-1.4.32" = _q3DWeynd;
        "pkg-1.4.32.1" = _7R3mgp5y;
        "pkg-1.4.32.2" = _QWD5WwSi;
        "pkg-1.4.32.3" = _pAIClqVQ;
        "pkg-1.4.32.4" = _dEtCvk43;
        "pkg-1.4.32.5" = _p4gyVHns;
        "pkg-1.4.32.6" = _pUnmNKcX;
        "pkg-1.4.32.7" = _58QFlnWf;
        "pkg-1.5-pre1" = _RffTk3QT;
        "pkg-1.5-pre2" = _Wa7Aw9OU;
        "pkg-1.5-pre3" = _Si59MiV0;
        "pkg-1.5" = _Y0osqt7Z;
        "pkg-21.1" = _TpJsHwY2;
        "pkg-21.1.1" = _PO9SXKyT;
        "pkg-21.1.2" = _aZuHPlHk;
        "pkg-21.1.3" = _AjeDxYVT;
        "pkg-21.1.4" = _rNBZIk4d;
        "pkg-21.1.5" = _RQUvZ0iY;
        "pkg-21.1.6" = _rpQ9cZQ7;
        "pkg-21.1.7" = _KPsWRYlW;
        "pkg-21.1.8" = _cYbj27Ip;
        "pkg-21.1.9" = _8jFyz064;
        "pkg-1.5-patch-1" = _Zc1u6Lhn;
        "pkg-1.5-patch-2" = _vqrJknUJ;
        "pkg-21.1.10" = _CBVo2eps;
        "pkg-21.1.11" = _5LsndoU1;
