...
let
    ...
    in {
        ...
        "pkg-1.4.2" = _MJYcmss7;
        "pkg-1.5.9" = _YfkLdJyz;
        "pkg-1.5.10" = _uVXOzvwU;
        "pkg-1.6.0" = _EE1TmNWd;
        "pkg-1.5.11" = _IRMm2eeR;
        "pkg-1.5.12" = _W5J35Xda;
        "pkg-1.6.1" = _oec4zIe5;
        "pkg-1.5.13" = _vyr1xF1J;
        "pkg-1.5.14" = _ZBLVndA8;
        "pkg-1.5.15" = _tMxXxvVt;
        "pkg-1.5.16" = _KCz0xnRl;
        "pkg-1.5.17" = _GuQQKWF3;
        "pkg-1.5.18" = _Z2ltmFRj;
        "pkg-1.5.21" = _4E73BH62;
        "pkg-1.5.23" = _koDPrvtd;
        "pkg-1.6.3" = _Ok8VlodS;
        "pkg-1.6.4" = _GzjWpt0P;
        "pkg-1.5.28" = _NC3HtHhp;
        "pkg-1.5.29" = _47ulFNf4;
        "pkg-1.5.31" = _prutPIHL;
        "pkg-1.8.0" = _G7kwwmtF;
        "pkg-1.5.33" = _11sUEZjL;
        "pkg-1.5.39" = _TIEXCg99;
        "pkg-1.5.42" = _b0DSfgPw;
        "pkg-1.5.43" = _ac4jlWeU;
        "pkg-1.5.44" = _lFNKNvqY;
        "pkg-1.5.47" = _XGoJcsEk;
        "pkg-1.5.48" = _XBNekeRx;
        "pkg-1.5.49" = _QygB4IrD;
        "pkg-1.5.50" = _RL5JDlUp;
        "pkg-1.6.6" = _fUx53G6d;
