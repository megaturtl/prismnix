...
let
    versions = (let
        ...
        _TjnJApDm = {
            "id" = "TjnJApDm";
            "file" = "golden-days-base-16.3-[1.20-to-26.3].zip";
            "hash" = "sha512-QUplLnwhEn35ZsVa3ZNDDF6NpiDb9/wcPkspWHywUAWjRIdOUyBkJ7Unnj1ja3IfJx1rakBnl1y6Gz6QQUr8zQ==";
        };
    in {
        "XICsGvK2" = _XICsGvK2;
        "vQiHGHgT" = _vQiHGHgT;
        ...
        "minecraft-1.20" = _TjnJApDm;
        "minecraft-1.20.1" = _TjnJApDm;
        "minecraft-1.20.2" = _TjnJApDm;
        "minecraft-1.19" = _7rqbt5EU;
        "minecraft-1.19.1" = _7rqbt5EU;
        "minecraft-1.20.3" = _TjnJApDm;
        "minecraft-1.20.4" = _TjnJApDm;
        "minecraft-1.20.5" = _TjnJApDm;
        "minecraft-1.20.6" = _TjnJApDm;
        "minecraft-1.21" = _TjnJApDm;
        "minecraft-1.21.1" = _TjnJApDm;
        "minecraft-1.21.2" = _TjnJApDm;
        "minecraft-1.21.3" = _TjnJApDm;
        "minecraft-1.21.4" = _TjnJApDm;
        "minecraft-1.21.5" = _TjnJApDm;
        "minecraft-1.21.6" = _TjnJApDm;
        "minecraft-1.21.7" = _TjnJApDm;
        "minecraft-1.21.8" = _TjnJApDm;
        "minecraft-1.21.9" = _TjnJApDm;
        "minecraft-1.21.10" = _TjnJApDm;
        "minecraft-1.21.11" = _TjnJApDm;
        "minecraft-26.1" = _TjnJApDm;
        "minecraft-26.1.1" = _TjnJApDm;
        "minecraft-26.1.2" = _TjnJApDm;
        "minecraft-26.2" = _TjnJApDm;
        "minecraft-26.3" = _TjnJApDm;
        "pkg-1.7.1" = _XICsGvK2;
        "pkg-1.8.2" = _vQiHGHgT;
        "pkg-1.9.0" = _jFm5lOhz;
        "pkg-1.9.0-cowhotfix" = _rUXS3BXX;
        "pkg-1.9.1" = _felnve5y;
        "pkg-1.10.0" = _WWCQLi0H;
        "pkg-1.10.1" = _5IJMjzov;
        "pkg-1.11.0" = _7rqbt5EU;
        "pkg-1.12.0" = _mbaHvDxM;
        "pkg-1.12.1" = _SLNSEnz1;
        "pkg-1.12.2" = _NpG0bRG4;
        "pkg-1.12.3" = _FposWE7W;
        "pkg-1.13.0" = _3R7KyH1U;
        "pkg-1.13.1" = _DzDyHE4m;
        "pkg-1.14.0" = _BVnv30U5;
        "pkg-1.15.0" = _HU95ubrJ;
        "pkg-1.15.1" = _VDI6izxg;
        "pkg-1.15.2" = _H1DWjNVe;
        "pkg-1.15.3" = _tXegcMmz;
        "pkg-1.15.4" = _WPxJ8gNJ;
        "pkg-1.15.5" = _YBtUNKzD;
        "pkg-1.15.6" = _G36dsqyU;
        "pkg-16.0" = _lnHOC4Ug;
        "pkg-16.1" = _ldoYKBFc;
        "pkg-16.2" = _uzk4VJgD;
        "pkg-16.3" = _TjnJApDm;
