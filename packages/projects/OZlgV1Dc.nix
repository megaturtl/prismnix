...
let
    ...
    in {
        ...
        "pkg-14.0.0+fabric-1.19.3" = _Q3IK5dd0;
        "pkg-12.0.0+forge-1.18.2" = _SZKiUgWm;
        "pkg-12.0.0+fabric-1.18.2" = _WDOLW3UF;
        "pkg-15.0.1+forge-1.19.4" = _Ft473dGC;
        "pkg-15.0.1+fabric-1.19.4" = _pqG8CsG9;
        "pkg-16.0.0+fabric-1.20" = _vp7C7uMl;
        "pkg-16.0.0+forge-1.20" = _j2z3oZiP;
        "pkg-17.0.0+fabric-1.20.2" = _hMdMS306;
        "pkg-17.0.0+forge-1.20.2" = _M73xhhG7;
        "pkg-17.0.0+neoforge-1.20.2" = _aSddIHdl;
        "pkg-18.0.1+fabric-1.20.4" = _G0rEWhzy;
        "pkg-18.0.1+forge-1.20.4" = _mEtvNX6e;
        "pkg-18.0.1+neoforge-1.20.4" = _5xlSypHN;
        "pkg-19.0.1+fabric-1.20.6" = _ynH7ZUiA;
        "pkg-19.0.1+forge-1.20.6" = _nagrXeqC;
        "pkg-19.0.1+neoforge-1.20.6" = _IP141LDj;
        "pkg-21.0.1+forge-1.21" = _Tvxhk3lL;
        "pkg-21.0.1+fabric-1.21" = _gXLqzkZy;
        "pkg-21.0.1+neoforge-1.21" = _E0t7QMFP;
        "pkg-21.0.2+fabric-1.21" = _D7XOEtv9;
        "pkg-21.0.2+forge-1.21" = _Ur0TGzQH;
        "pkg-21.0.2+neoforge-1.21" = _tozYyP7p;
        "pkg-21.1.1+fabric-1.21.1" = _FOBR6Yg0;
        "pkg-21.1.1+forge-1.21.1" = _BWhsxt1f;
        "pkg-21.1.1+neoforge-1.21.1" = _3FdP1oOy;
        "pkg-21.3.1+fabric-1.21.3" = _xZplgBZQ;
        "pkg-21.3.1+neoforge-1.21.3" = _PGmUlYZ6;
        "pkg-21.3.2+fabric-1.21.3" = _YG3O6sHe;
        "pkg-21.3.2+neoforge-1.21.3" = _5bMJ9WuQ;
        "pkg-21.4.1+fabric-1.21.4" = _cMvvNFVi;
        "pkg-21.4.1+neoforge-1.21.4" = _1F9eYl0q;
        "pkg-21.4.2+forge-1.21.4" = _zjJLhbOB;
        "pkg-21.1.2+fabric-1.21.1" = _UuDh1Duk;
        "pkg-21.1.2+neoforge-1.21.1" = _MjLTCoId;
        "pkg-21.1.2+forge-1.21.1" = _X7YkByIR;
        "pkg-16.0.1+fabric-1.20.1" = _Am6iUR3H;
        "pkg-16.0.1+forge-1.20.1" = _IfWj8fm5;
        "pkg-21.4.3+fabric-1.21.4" = _KfKIuAj6;
        "pkg-21.4.3+forge-1.21.4" = _f0TPpHJc;
        "pkg-21.4.3+neoforge-1.21.4" = _qRW8Hysi;
        "pkg-21.5.1+fabric-1.21.5" = _Bq3NBlNw;
        "pkg-21.5.1+neoforge-1.21.5" = _6ztegI2y;
        "pkg-21.5.2+fabric-1.21.5" = _1yMLvmyc;
        "pkg-21.5.3+forge-1.21.5" = _GsAdDwv3;
        "pkg-21.6.1+fabric-1.21.6" = _XdfOeaOp;
        "pkg-21.6.1+neoforge-1.21.6" = _2pQZF2hn;
        "pkg-21.6.2+forge-1.21.6" = _fxmDBNhN;
        "pkg-21.7.1+neoforge-1.21.7" = _XOORjsxY;
        "pkg-21.7.1+fabric-1.21.7" = _6BzML7WP;
        "pkg-21.7.1+forge-1.21.7" = _y4ZmMkJs;
        "pkg-21.8.1+forge-1.21.8" = _xA1HdG1y;
        "pkg-21.8.1+neoforge-1.21.8" = _tNvGOloy;
        "pkg-21.8.1+fabric-1.21.8" = _dJ8Rjfcj;
        "pkg-21.8.2+fabric-1.21.8" = _6YhkEKuc;
        "pkg-21.5.4+fabric-1.21.5" = _uluUf8FX;
        "pkg-21.8.2+forge-1.21.8" = _6N8cOEOa;
        "pkg-21.8.2+neoforge-1.21.8" = _6SxS1ip7;
        "pkg-21.5.4+forge-1.21.5" = _PIjZRBAa;
        "pkg-21.5.4+neoforge-1.21.5" = _4sPzMtlV;
        "pkg-21.9.1+fabric-1.21.9" = _RpS7R6VM;
        "pkg-21.9.1+neoforge-1.21.9" = _Uw5yqRq9;
        "pkg-21.10.1+fabric-1.21.10" = _dvBJW5q1;
        "pkg-21.10.1+forge-1.21.10" = _2QlCRe4n;
        "pkg-21.10.1+neoforge-1.21.10" = _6v2yom8c;
        "pkg-21.10.2+fabric-1.21.10" = _FDz38aYN;
        "pkg-21.10.2+forge-1.21.10" = _INfYKkNm;
        "pkg-21.10.2+neoforge-1.21.10" = _9izfFu1L;
        "pkg-21.11.1+fabric-1.21.11" = _HYMIcTZ9;
        "pkg-21.11.1+neoforge-1.21.11" = _PpWVabkh;
        "pkg-21.11.3+fabric-1.21.11" = _NeHBz62K;
        "pkg-21.11.3+neoforge-1.21.11" = _cSoHzRJP;
        "pkg-21.11.3+forge-1.21.11" = _wH8vNj8l;
        "pkg-26.1.0.1+neoforge-26.1" = _OG01B0Oh;
        "pkg-26.1.0.1+fabric-26.1" = _1FZKfHNk;
        "pkg-26.1.2.1+fabric-26.1.2" = _NpMGnRVV;
        "pkg-26.1.2.1+neoforge-26.1.2" = _NKtpj75e;
        "pkg-26.1.2.2+fabric-26.1.2" = _1XuiNwYY;
