...
let
    versions = (let
        ...
        _8agtwXSd = {
            "id" = "8agtwXSd";
            "file" = "simple-music-player-1.21.1-1.21.11-fabric-1.21.4-1.1.3.jar";
            "hash" = "sha512-scE1WF10Qc8XTFhcM/wlK46o2xogIwbZG3VhEXlzM+NavDR34XmLkOeYjYRH/6YyaoJTcVWvL5npREs4ChVKRg==";
        };
        _MH2CGUPj = {
            "id" = "MH2CGUPj";
            "file" = "simple-music-player-26.1-26.1.2-1.1.3.jar";
            "hash" = "sha512-q59GtHLo15jpUXnNJADTKtk6ejfcoj016dzhiC6Jruojyrr2mRxXHS9oRI+NijQrdUwcKgOmjoHDXxEDxH6n6w==";
        };
    in {
        "GUmJCOUt" = _GUmJCOUt;
        "A7NB1NYt" = _A7NB1NYt;
        ...
        "8agtwXSd" = _8agtwXSd;
        "MH2CGUPj" = _MH2CGUPj;
        "fabric-1.21" = _8agtwXSd;
        "fabric-1.21.1" = _8agtwXSd;
        "fabric-1.21.2" = _8agtwXSd;
        "fabric-1.21.3" = _8agtwXSd;
        "fabric-1.21.4" = _8agtwXSd;
        "fabric-1.21.5" = _8agtwXSd;
        "fabric-1.21.6" = _8agtwXSd;
        "fabric-1.21.7" = _8agtwXSd;
        "fabric-1.21.8" = _8agtwXSd;
        "fabric-1.21.9" = _8agtwXSd;
        "fabric-1.21.10" = _8agtwXSd;
        "fabric-1.21.11" = _8agtwXSd;
        "fabric-26.1" = _MH2CGUPj;
        "fabric-26.1.1" = _MH2CGUPj;
        "fabric-26.1.2" = _MH2CGUPj;
        "fabric-26.2" = _MH2CGUPj;
        "pkg-1.1.0" = _GUmJCOUt;
        "pkg-1.1.1" = _WTtBZZBQ;
        "pkg-1.1.2" = _MNFsVYm1;
        "pkg-1.1.3" = _MH2CGUPj;
