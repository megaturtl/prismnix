...
let
    ...
    in {
        ...
        "pkg-1.1.4b" = _C1cfo36k;
        "pkg-1.1.15" = _H5Ih1ulP;
        "pkg-1.1.15b" = _EzkIUUc2;
        "pkg-1.1.16" = _z7dZOYl7;
        "pkg-1.2.0" = _pDi4Zv8b;
        "pkg-1.2.1" = _MbfHbDJg;
        "pkg-1.2.1b" = _yVJ0UYKq;
        "pkg-1.2.2" = _qzeGFq5O;
        "pkg-1.2.3" = _UI4beSaW;
        "pkg-1.2.4" = _LOLrCFWh;
        "pkg-1.2.4b" = _MTGaaTk5;
        "pkg-1.2.5" = _sN0OINND;
        "pkg-1.3.0" = _wh21Uj7s;
        "pkg-1.3.1" = _MnDrXM5J;
        "pkg-1.3.2" = _axTzRXjv;
        "pkg-1.3.2b" = _kqunkV7a;
        "pkg-1.4.0" = _3k35phcp;
        "pkg-1.4.0b" = _6ADEOtQY;
        "pkg-1.4.1" = _dgz3KrLD;
        "pkg-1.4.1b" = _WdNPfmRS;
        "pkg-1.5.0" = _z3ezvgi2;
        "pkg-1.5.1" = _BSB94W84;
        "pkg-1.5.2" = _isfRuzdS;
        "pkg-1.5.3" = _KLA0Dbll;
        "pkg-1.5.4" = _3seL63IW;
        "pkg-1.5.4b" = _OZdkBogd;
        "pkg-1.5.5" = _9CDtOsYE;
        "pkg-1.6.0" = _RyEtZcS9;
        "pkg-1.6.0b" = _Zq6ofkSJ;
        "pkg-1.6.1" = _IlwuDXYC;
        "pkg-1.6.2" = _9NKFImgT;
        "pkg-1.7.0" = _YUkWpcDW;
        "pkg-1.7.1b" = _Tejxvsvj;
        "pkg-1.7.1c" = _iYVS7A9F;
        "pkg-1.7.1" = _U7H0rSa2;
        "pkg-1.7.2" = _YhL6IY1d;
        "pkg-1.7.3" = _xTMwEjsa;
        "pkg-1.7.4" = _O1FtlP5Q;
