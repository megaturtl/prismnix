...
let
    versions = (let
        ...
        _PrqGG0eL = {
            "id" = "PrqGG0eL";
            "file" = "Snow Side Texture v4.0.zip";
            "hash" = "sha512-OZQqEEJwWBx92jSX+2Yq6HG/LxpE0yFEboC3ZxpG5R9KUyaRhm/dR6TlYJXV3qdweIRNtttsYp6oashVly8Tdw==";
        };
        _etbZbjTB = {
            "id" = "etbZbjTB";
            "file" = "Snow Side Texture v4.0.1.zip";
            "hash" = "sha512-Ons7Mh3I7YUNcqjDR5Skphwu1BhL0p/SiogfdPpzM+07KwLFnur7Z6y5Qf+B/IGF5yedYm8/jMvjo0ZWFFoGYw==";
        };
    in {
        "5rhGfLxu" = _5rhGfLxu;
        "1MgHVZ1l" = _1MgHVZ1l;
        ...
        "PrqGG0eL" = _PrqGG0eL;
        "etbZbjTB" = _etbZbjTB;
        "minecraft-1.19" = _etbZbjTB;
        "minecraft-1.19.1" = _etbZbjTB;
        "minecraft-1.19.2" = _etbZbjTB;
        "minecraft-1.19.3" = _etbZbjTB;
        "minecraft-1.19.4" = _etbZbjTB;
        "minecraft-1.20" = _etbZbjTB;
        "minecraft-1.20.1" = _etbZbjTB;
        "minecraft-1.20.2" = _etbZbjTB;
        "minecraft-1.20.3" = _etbZbjTB;
        "minecraft-1.20.4" = _etbZbjTB;
        "minecraft-1.20.5" = _etbZbjTB;
        "minecraft-1.20.6" = _etbZbjTB;
        "minecraft-1.21" = _etbZbjTB;
        "minecraft-1.21.1" = _etbZbjTB;
        "minecraft-1.21.2" = _etbZbjTB;
        "minecraft-1.21.3" = _etbZbjTB;
        "minecraft-1.21.4" = _etbZbjTB;
        "minecraft-1.21.5" = _etbZbjTB;
        "minecraft-1.21.6" = _etbZbjTB;
        "minecraft-1.21.7" = _etbZbjTB;
        "minecraft-1.21.8" = _etbZbjTB;
        "minecraft-1.21.9" = _etbZbjTB;
        "minecraft-1.21.10" = _etbZbjTB;
        "minecraft-1.21.11" = _etbZbjTB;
        ...
        "minecraft-1.15" = _etbZbjTB;
        "minecraft-1.15.1" = _etbZbjTB;
        "minecraft-1.15.2" = _etbZbjTB;
        "minecraft-1.16" = _etbZbjTB;
        "minecraft-1.16.1" = _etbZbjTB;
        "minecraft-1.16.2" = _etbZbjTB;
        "minecraft-1.16.3" = _etbZbjTB;
        "minecraft-1.16.4" = _etbZbjTB;
        "minecraft-1.16.5" = _etbZbjTB;
        "minecraft-1.17" = _etbZbjTB;
        "minecraft-1.17.1" = _etbZbjTB;
        "minecraft-1.18" = _etbZbjTB;
        "minecraft-1.18.1" = _etbZbjTB;
        "minecraft-1.18.2" = _etbZbjTB;
        "minecraft-26.1" = _gqkD7hFv;
        "minecraft-26.1.1" = _gqkD7hFv;
        "minecraft-26.1.2" = _gqkD7hFv;
        "minecraft-26.2" = _gqkD7hFv;
        "pkg-1.0-1.19.x" = _5rhGfLxu;
        "pkg-1.0-1.20.x" = _1MgHVZ1l;
        "pkg-1.0-1.21.x" = _oJWCECta;
        "pkg-2.0-1.19.x" = _W07myWML;
        "pkg-2.0-1.20.x" = _nF70QCch;
        "pkg-2.0-1.21" = _KQ5bId5c;
        "pkg-2.0-1.21.4" = _Q8JJYgz6;
        "pkg-3.0" = _gqkD7hFv;
        "pkg-4.0" = _PrqGG0eL;
        "pkg-4.0.1" = _etbZbjTB;
        "default" = _etbZbjTB;
