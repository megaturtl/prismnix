...
let
    ...
    in {
        ...
        "pkg-1.5.0" = _yWjMSGML;
        "pkg-1.5.1" = _D0lyCang;
        "pkg-1.5.11" = _1J8Ej1Pg;
        "pkg-1.5.12" = _jhDqEs3r;
        "pkg-0.0.21" = _mrtKQo6e;
        "pkg-2.0.0" = _Eqb8yjAg;
        "pkg-2.0.01" = _hyiV4iyN;
        "pkg-2.0.2" = _lW427bgX;
        "pkg-2.1.0" = _dTyUnHjI;
        "pkg-2.5.0" = _kZo9YMA0;
        "pkg-2.5.01" = _enVzmmYd;
        "pkg-2.5.10" = _o1rdljUe;
        "pkg-2.6.0" = _1jgQNt70;
        "pkg-2.5.11" = _D41qRpfS;
        "pkg-2.5.15" = _A1mMmr6G;
        "pkg-2.6.01" = _EsTkJpP4;
        "pkg-2.6.02" = _uuEEN7cL;
        "pkg-2.5.17" = _S9jhqG7u;
        "pkg-2.6.07" = _Mx9EwTf5;
