...
let
    versions = (let
        ...
        _BsPRwgBN = {
            "id" = "BsPRwgBN";
            "file" = "PvP Basics 2.3.zip";
            "hash" = "sha512-Bxv0kMvXYsuLwtzwuMIKByKkSFoW5UXLNcPgSaC7eqA4dhVMsraWlZDLsR46dBGHHxjSb4Mls8ewjIPKyqCGrg==";
        };
    in {
        "EJrRwZ5G" = _EJrRwZ5G;
        "2c1QOwBQ" = _2c1QOwBQ;
        ...
        "wRpCHhCq" = _wRpCHhCq;
        "BsPRwgBN" = _BsPRwgBN;
        "minecraft-1.20" = _BsPRwgBN;
        "minecraft-1.20.1" = _BsPRwgBN;
        "minecraft-1.20.2" = _BsPRwgBN;
        "minecraft-1.20.3" = _BsPRwgBN;
        "minecraft-1.20.4" = _BsPRwgBN;
        "minecraft-1.20.5" = _BsPRwgBN;
        "minecraft-1.20.6" = _BsPRwgBN;
        "minecraft-1.21" = _BsPRwgBN;
        "minecraft-1.21.1" = _BsPRwgBN;
        "minecraft-1.21.2" = _BsPRwgBN;
        "minecraft-1.21.3" = _BsPRwgBN;
        "minecraft-1.21.4" = _BsPRwgBN;
        "minecraft-1.21.5" = _BsPRwgBN;
        "minecraft-1.21.6" = _BsPRwgBN;
        "minecraft-1.21.7" = _BsPRwgBN;
        "minecraft-1.21.8" = _BsPRwgBN;
        "minecraft-1.21.9" = _BsPRwgBN;
        "minecraft-1.16" = _BsPRwgBN;
        "minecraft-1.16.1" = _BsPRwgBN;
        "minecraft-1.16.2" = _BsPRwgBN;
        "minecraft-1.16.3" = _BsPRwgBN;
        "minecraft-1.16.4" = _BsPRwgBN;
        "minecraft-1.16.5" = _BsPRwgBN;
        "minecraft-1.17" = _BsPRwgBN;
        "minecraft-1.17.1" = _BsPRwgBN;
        "minecraft-1.18" = _BsPRwgBN;
        "minecraft-1.18.1" = _BsPRwgBN;
        "minecraft-1.18.2" = _BsPRwgBN;
        "minecraft-1.19" = _BsPRwgBN;
        "minecraft-1.19.1" = _BsPRwgBN;
        "minecraft-1.19.2" = _BsPRwgBN;
        "minecraft-1.19.3" = _BsPRwgBN;
        "minecraft-1.19.4" = _BsPRwgBN;
        "minecraft-1.15" = _BsPRwgBN;
        "minecraft-1.15.1" = _BsPRwgBN;
        "minecraft-1.15.2" = _BsPRwgBN;
        "minecraft-1.21.10" = _BsPRwgBN;
        "minecraft-1.21.11" = _BsPRwgBN;
