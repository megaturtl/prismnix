...
let
    versions = (let
        ...
        _3K2VSvoU = {
            "id" = "3K2VSvoU";
            "file" = "Ellen Totem v1.1 26.2.zip";
            "hash" = "sha512-K4SOYfVyds2Qj1JvwnD/x0ePZg1lIcLXD2z71Pkb3qpY/J4/iTkM6ox3tucTvsbXwNEU5XW7Slu8T8397MZ+Dg==";
        };
        _GTBPqYra = {
            "id" = "GTBPqYra";
            "file" = "Ellen Totem v1.1 1.6.1–1.8.9.zip";
            "hash" = "sha512-yI+1n7MPADS3/TqlmfkPMB1jAcaNP8d1P3hHDsgR0HBDU6G1ICWd3UsNl+sLooblUVdRpaj41fK1N6Ooq66lBg==";
        };
    in {
        "GhkU0DHe" = _GhkU0DHe;
        "TDlwT5Rk" = _TDlwT5Rk;
        ...
        "3K2VSvoU" = _3K2VSvoU;
        "GTBPqYra" = _GTBPqYra;
        "minecraft-1.6.1" = _GTBPqYra;
        "minecraft-1.6.2" = _GTBPqYra;
        "minecraft-1.6.4" = _GTBPqYra;
        "minecraft-1.7.2" = _GTBPqYra;
        "minecraft-1.7.3" = _GTBPqYra;
        "minecraft-1.7.4" = _GTBPqYra;
        "minecraft-1.7.5" = _GTBPqYra;
        "minecraft-1.7.6" = _GTBPqYra;
        "minecraft-1.7.7" = _GTBPqYra;
        "minecraft-1.7.8" = _GTBPqYra;
        "minecraft-1.7.9" = _GTBPqYra;
        "minecraft-1.7.10" = _GTBPqYra;
        "minecraft-1.8" = _GTBPqYra;
        "minecraft-1.8.1" = _GTBPqYra;
        "minecraft-1.8.2" = _GTBPqYra;
        "minecraft-1.8.3" = _GTBPqYra;
        "minecraft-1.8.4" = _GTBPqYra;
        "minecraft-1.8.5" = _GTBPqYra;
        "minecraft-1.8.6" = _GTBPqYra;
        "minecraft-1.8.7" = _GTBPqYra;
        "minecraft-1.8.8" = _GTBPqYra;
        "minecraft-1.8.9" = _GTBPqYra;
