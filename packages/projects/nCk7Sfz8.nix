...
let
    ...
    in {
        ...
        "pkg-1.0.6-forge-mc1.16" = _KZ1sLw9D;
        "pkg-1.0.6-forge-mc1.17" = _qujOjPmA;
        "pkg-1.0.6-forge-mc1.18" = _TKscqiZD;
        "pkg-1.0.6b-forge-mc1.19" = _ANJyI7Gj;
        "pkg-1.0.7-forge-mc1.12" = _1K0nQG2E;
        "pkg-1.0.7-forge-mc1.14" = _FBXw8PgR;
        "pkg-1.0.7-forge-mc1.15" = _GePpgBfH;
        "pkg-1.0.7-forge-mc1.16" = _slhdeBNF;
        "pkg-1.0.7-forge-mc1.17" = _gkOAPJwI;
        "pkg-1.0.7-forge-mc1.18" = _oDGt56Ej;
        "pkg-1.0.7-forge-mc1.19" = _XwLNbk5J;
        "pkg-1.0.7-forge-mc1.19.3" = _sU8w6owF;
        "pkg-1.0.8-forge-mc1.19.3" = _8Kk8Oyhz;
        "pkg-1.0.8-forge-mc1.19" = _MpW6Kx0J;
        "pkg-1.0.8-forge-mc1.18" = _PS4CVRVo;
        "pkg-1.0.8-forge-mc1.17" = _Nc9HcrjR;
        "pkg-1.0.8-forge-mc1.16" = _h3cC7f3q;
        "pkg-1.0.8-forge-mc1.15" = _GRhSlvEn;
        "pkg-1.0.8-forge-mc1.14" = _eDSHwS14;
        "pkg-1.0.8-forge-mc1.12" = _3Od9fr80;
        "pkg-1.0.8-fabric-mc1.18" = _AyGysBQf;
        "pkg-1.0.8-fabric-mc1.19" = _L4ZriE5k;
        "pkg-1.0.8-fabric-mc1.19.2" = _uCprO9FK;
        "pkg-1.0.8a-fabric-mc1.18" = _NTqJBgk4;
        "pkg-1.0.8a-fabric-mc1.19.2" = _oGC74Rml;
        "pkg-1.0.8a-fabric-mc1.19.4" = _ph5DL1lt;
        "pkg-1.0.8-forge-mc1.20" = _pSmRbYXQ;
        "pkg-1.0.8-fabric-mc1.20" = _Zh2jiG5a;
        "pkg-1.0.9-forge-mc1.12" = _cI9sSwDa;
        "pkg-1.0.9-forge-mc1.14" = _ZKTSpXCw;
        "pkg-1.0.9-forge-mc1.15" = _YDPY0Zsl;
        "pkg-1.0.9-forge-mc1.16" = _5EOq15rb;
        "pkg-1.0.9-forge-mc1.17" = _TZVLTa4Z;
        "pkg-1.0.9-forge-mc1.18" = _dOmavKyo;
        "pkg-1.0.9-forge-mc1.19.2" = _afvg8H4w;
        "pkg-1.0.9-forge-mc1.19.4" = _pxjDlO27;
        "pkg-1.0.9-forge-mc1.20" = _vDdC537s;
        "pkg-1.0.9-fabric-mc1.18" = _GTwHSKMl;
        "pkg-1.0.9-fabric-mc1.19.2" = _JK8JM1Ea;
        "pkg-1.0.9-fabric-mc1.19.4" = _qYz90E3c;
        "pkg-1.0.9-fabric-mc1.20" = _nPOLrE6R;
        "pkg-1.0.9-neoforge-mc1.20.4" = _pfISb9hI;
        "pkg-1.0.9a-forge-mc1.12" = _lGQnPI93;
        "pkg-1.0.9a-forge-mc1.14" = _NmfGpCxs;
        "pkg-1.0.9a-forge-mc1.15" = _DZGpdEoN;
        "pkg-1.0.9a-forge-mc1.16" = _iBYqMpND;
        "pkg-1.0.9a-forge-mc1.17" = _2LWPpd2X;
        "pkg-1.0.9a-forge-mc1.18" = _d5wUYxZf;
        "pkg-1.0.9a-forge-mc1.19.2" = _awtFQz4U;
        "pkg-1.0.9a-forge-mc1.19.4" = _5glbLMWZ;
        "pkg-1.0.9a-forge-mc1.20" = _ilLITZvh;
        "pkg-1.0.9a-fabric-mc1.18" = _w8oImiRR;
        "pkg-1.0.9a-fabric-mc1.19.2" = _HMl20Asf;
        "pkg-1.0.9a-fabric-mc1.19.4" = _ZbXquaoD;
        "pkg-1.0.9a-fabric-mc1.20" = _IYYCJZyP;
        "pkg-1.0.9a-neoforge-mc1.20.4" = _4in25PVw;
        "pkg-1.0.9-forge-mc1.20.6" = _12wBc5kV;
        "pkg-1.0.9-forge-mc1.21" = _CYhWahTE;
        "pkg-1.0.9-fabric-mc1.20.6" = _DaYDqglF;
        "pkg-1.0.9-fabric-mc1.21" = _EruiidpC;
        "pkg-1.0.9-neoforge-mc1.20.6" = _u9Yc98uI;
        "pkg-1.0.9-neoforge-mc1.21" = _82HxoR5X;
        "pkg-1.0.9a-neoforge-mc1.21" = _WXZ06Rhq;
        "pkg-1.0.9-fabric-mc1.21.2" = _CFbsgncx;
        "pkg-1.0.9-neoforge-mc1.21.3" = _geYYgjGj;
        "pkg-1.0.9a-fabric-mc1.21" = _h2udQFX8;
        "pkg-1.0.9-forge-mc1.21.3" = _nf0Tbukf;
        "pkg-1.0.9-forge-mc1.21.4" = _8fbYZw5d;
        "pkg-1.0.9-fabric-mc1.21.4" = _rUlEl6N9;
        "pkg-1.0.9-neoforge-mc1.21.4" = _UNEd0sr6;
        "pkg-1.0.9a-forge-mc1.21.4" = _yCtUNDBW;
        "pkg-1.0.9a-fabric-mc1.21.4" = _QdPWGMNV;
        "pkg-1.0.9a-neoforge-mc1.21.4" = _86MFAmob;
        "pkg-1.0.9-forge-mc1.21.5" = _u8M5K4lC;
        "pkg-1.0.9-forge-mc1.21.6" = _ZZVqsEC1;
        "pkg-1.0.9-fabric-mc1.21.5" = _2UB1kFUU;
        "pkg-1.0.9-fabric-mc1.21.6" = _9r4x9o6F;
        "pkg-1.0.9-neoforge-mc1.21.5" = _xcXIktbB;
        "pkg-1.0.9-neoforge-mc1.21.6" = _Vru7Nmjb;
        "pkg-1.0.10-forge-mc1.12" = _FkslvaqC;
        "pkg-1.0.10-forge-mc1.14" = _FUSVEMs1;
        "pkg-1.0.10-forge-mc1.15" = _9gVgnpZc;
        "pkg-1.0.10-forge-mc1.16" = _rsXdOysu;
        "pkg-1.0.10-forge-mc1.17" = _PCE5NYD7;
        "pkg-1.0.10-forge-mc1.18" = _jKRjEJ9p;
        "pkg-1.0.10-forge-mc1.19.2" = _CFNcc6Pk;
        "pkg-1.0.10-forge-mc1.19.4" = _vR9cOLuI;
        "pkg-1.0.10-forge-mc1.20.4" = _PzJlEZtp;
        "pkg-1.0.10-forge-mc1.20.6" = _x0zZh8t4;
        "pkg-1.0.10-forge-mc1.21" = _OGQC3shY;
        "pkg-1.0.10-forge-mc1.21.3" = _qwrMlfDa;
        "pkg-1.0.10-forge-mc1.21.4" = _MZBQ2loe;
        "pkg-1.0.10-forge-mc1.21.5" = _q1XYPnIv;
        "pkg-1.0.10-forge-mc1.21.6" = _BurtDatH;
        "pkg-1.0.10-fabric-mc1.18" = _NEVIphjj;
        "pkg-1.0.10-fabric-mc1.19.2" = _1hJPm2KH;
        "pkg-1.0.10-fabric-mc1.19.4" = _co5zp6AR;
        "pkg-1.0.10-fabric-mc1.20.4" = _jw1ZcGZq;
        "pkg-1.0.10-fabric-mc1.20.6" = _edtimuAs;
        "pkg-1.0.10-fabric-mc1.21" = _IMUCxuow;
        "pkg-1.0.10-fabric-mc1.21.2" = _JjbFT1c7;
        "pkg-1.0.10-fabric-mc1.21.4" = _KvhIoXkc;
        "pkg-1.0.10-fabric-mc1.21.5" = _N2BPbL1X;
        "pkg-1.0.10-fabric-mc1.21.6" = _hVGkGI5h;
        "pkg-1.0.10-neoforge-mc1.20.4" = _w03Irzml;
        "pkg-1.0.10-neoforge-mc1.20.6" = _bAsXA00e;
        "pkg-1.0.10-neoforge-mc1.21" = _yprEhrI7;
        "pkg-1.0.10-neoforge-mc1.21.3" = _RRYilXOY;
        "pkg-1.0.10-neoforge-mc1.21.4" = _QaYY2QS0;
        "pkg-1.0.10-neoforge-mc1.21.5" = _OUTbU6qk;
        "pkg-1.0.10-neoforge-mc1.21.6" = _dhk4AlK6;
        "pkg-1.0.10-forge-mc1.21.10" = _CACaWT5u;
        "pkg-1.0.10-fabric-mc1.21.10" = _mbB4ZqKa;
        "pkg-1.0.10-neoforge-mc1.21.10" = _bMpQPYOc;
        "pkg-1.0.10-forge-mc1.21.11" = _5J2MCvhZ;
        "pkg-1.0.10-fabric-mc1.21.11" = _zL8rribQ;
        "pkg-1.0.10-neoforge-mc1.21.11" = _M0jxdPr1;
        "pkg-1.0.10-forge-mc26.1" = _fwmgTm2K;
        "pkg-1.0.10-fabric-mc26.1" = _sk4Hu6b1;
        "pkg-1.0.10-neoforge-mc26.1" = _Y1v5S2Ya;
