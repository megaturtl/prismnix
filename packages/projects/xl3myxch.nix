...
let
    ...
    in {
        ...
        "pkg-7.1.5" = _kqpSNuhY;
        "pkg-7.1.6" = _kmKtJqmf;
        "pkg-4.11.0" = _I43p3MdU;
        "pkg-4.11.1" = _3KlqtbX6;
        "pkg-7.1.7" = _AEMZ8rEc;
        "pkg-7.1.8" = _1Gq39XeI;
        "pkg-4.11.2" = _NlwVVVLq;
        "pkg-7.1.9" = _diADbR57;
        "pkg-7.2.0" = _vrTCi4dI;
        "pkg-4.12.0" = _LUvSwyok;
        "pkg-7.2.1" = _sKUAhePE;
        "pkg-4.12.1" = _dioqJzvv;
        "pkg-7.2.2" = _j5sIQZOm;
        "pkg-7.3.0" = _6QZI7vLA;
        "pkg-4.13.0" = _1Y9sPCk7;
        "pkg-7.3.1" = _inCs0UEj;
        "pkg-8.0.0" = _QWi8WInV;
        "pkg-8.0.7" = _wksd7sRM;
        "pkg-9.0.3" = _Jeweyb6G;
        "pkg-9.0.5" = _fbBBPfy2;
        "pkg-9.0.6" = _AsHgUnoD;
        "pkg-1.10.0" = _yN7aMb5u;
        "pkg-9.0.8" = _CbMYXyBh;
        "pkg-10.0.0" = _6CN8hTSr;
        "pkg-21.4.1" = _5aTHlvyL;
        "pkg-21.4.21" = _iNhekE4u;
        "pkg-21.4.20" = _Xmu3rhbX;
        "pkg-21.4.23" = _wOMJvvXS;
        "pkg-21.4.24" = _PcAGkG9f;
        "pkg-21.4.25" = _YSLAuv4l;
        "pkg-21.5.1" = _H9Mx7emr;
        "pkg-21.5.2" = _fqtRAA8u;
        "pkg-21.5.3" = _wCSsIDpn;
        "pkg-21.5.4" = _SeQhG8tG;
        "pkg-21.4.26" = _raBmssnr;
        "pkg-21.5.10" = _uDNaNqiL;
        "pkg-21.5.13" = _tgPoCxe6;
        "pkg-21.5.15" = _Kyb0o2zu;
        "pkg-21.5.16" = _52kwFMyh;
        "pkg-21.6.0" = _3cKBA0cU;
        "pkg-21.5.18" = _Ua2tSky5;
        "pkg-21.6.2" = _w2Jxqy1t;
        "pkg-21.6.3" = _BIreydnC;
        "pkg-21.7.0" = _xu0eIg1X;
        "pkg-21.7.2" = _CG6cWHSm;
        "pkg-21.10.0" = _ReLTFKm4;
        "pkg-21.10.2" = _zMNYE3KZ;
        "pkg-21.10.3" = _1boHnIXp;
        "pkg-21.10.4" = _xf8bW2hq;
        "pkg-21.10.5" = _oPNpcKP7;
        "pkg-21.11.0" = _lV5pmqPg;
        "pkg-21.11.1" = _S6Usrg1J;
        "pkg-21.10.6" = _um7T5YUg;
        "pkg-21.11.2" = _RO668GrL;
        "pkg-21.11.3" = _I6cba2v4;
        "pkg-26.1.0" = _SBBW3sUc;
        "pkg-26.1.1" = _aonOzGbW;
