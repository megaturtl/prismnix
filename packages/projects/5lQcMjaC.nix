...
let
    ...
    in {
        ...
        "pkg-1.0.1+1.21.4" = _Cg3jpvzP;
        "pkg-1.0.2+1.21.1" = _8O6AXyUK;
        "pkg-1.0.2+1.21.4" = _8xisHdf4;
        "pkg-1.0.3+1.21.1" = _rQdGWEX9;
        "pkg-1.0.3+1.21.4" = _DCV3xFkN;
        "pkg-1.0.3+1.21.5" = _7N9D50XL;
        "pkg-1.0.4+1.21.1" = _rDjo5MAK;
        "pkg-1.0.4+1.21.4" = _vVg1Mqb4;
        "pkg-1.0.4+1.21.5" = _p6yjpjq7;
        "pkg-1.0.5+1.21.1" = _MblVES4A;
        "pkg-1.0.5+1.21.4" = _ftB6fYIt;
        "pkg-1.0.5+1.21.5" = _gFicY0ht;
        "pkg-1.0.6+1.21.1" = _2YxcyGC9;
        "pkg-1.0.7+1.21.1" = _gddlK5xR;
        "pkg-1.0.7+1.21.4" = _GQgLIlHR;
        "pkg-1.0.8+1.21.1" = _jZoSz90z;
        "pkg-1.0.8+1.21.4" = _HY1924aT;
        "pkg-1.0.8+1.21.5" = _jQcfNT1C;
        "pkg-1.0.9+1.21.5" = _X7DzzKec;
        "pkg-1.0.10+1.21.1" = _5xRFv9Bl;
        "pkg-1.0.10+1.21.4" = _5LF9Wwjr;
        "pkg-1.0.10+1.21.5" = _aVlKh8kh;
        "pkg-1.0.10+1.21.6" = _og6gzT30;
        "pkg-1.0.11+1.21.6" = _7Qjc2vBH;
        "pkg-1.0.12+1.21.6" = _CBNJAk6F;
        "pkg-2.0.0+1.21.9" = _gh4sUJxY;
        "pkg-2.0.0+1.21.1" = _COSa7XYK;
        "pkg-2.0.1+1.21.9" = _N22IhJKO;
        "pkg-2.0.1+1.21.1" = _LoOjDgYl;
        "pkg-2.1.0+1.21.1" = _3CMF3iXa;
        "pkg-2.1.0+1.21.10" = _1YU9bOGp;
        "pkg-2.1.1+1.21.1-neoforge" = _7CJBqvBH;
        "pkg-2.1.1+1.21.1-fabric" = _pgHVlEde;
        "pkg-2.1.1+1.21.10-neoforge" = _64akpAhp;
        "pkg-2.1.1+1.21.10-fabric" = _crvmGXcq;
        "pkg-2.1.2+1.21.11-fabric" = _xq86dmfR;
        "pkg-2.1.2+1.21.11-neoforge" = _G0oqMUEX;
        "pkg-2.1.3+1.21.11-fabric" = _kakDCMrW;
        "pkg-2.1.3+1.21.11-neoforge" = _sr94BwUv;
        "pkg-2.1.3+1.21.1-neoforge" = _CNaiTvLG;
        "pkg-2.1.3+1.21.10-neoforge" = _UyBzYf7I;
        "pkg-2.1.3+1.21.1-fabric" = _69RH9Ols;
        "pkg-2.1.3+1.21.10-fabric" = _SU01mvyC;
        "pkg-2.1.4+26.1-neoforge" = _1RsgCj4j;
        "pkg-2.1.4+26.1-fabric" = _7wckFigh;
        "pkg-2.1.5+26.1-neoforge" = _BROLcyy3;
        "pkg-2.1.5+26.1-fabric" = _1wLYD0FD;
        "pkg-2.1.6+26.1-neoforge" = _Ev2VYSUa;
        "pkg-2.1.6+26.1-fabric" = _Cxq1uJcS;
        "pkg-2.1.3-hotfix.1+1.21.1-fabric" = _ZhK9hKIi;
        "pkg-2.1.3-hotfix.1+1.21.1-neoforge" = _a1jdlXMP;
        "pkg-2.1.7+26.1-neoforge" = _1vuc1DHW;
        "pkg-2.1.7+26.1-fabric" = _QDCoBzoj;
        "pkg-3.0.0+26.1.2-neoforge" = _wX8iI4SI;
        "pkg-3.0.0+26.1.2-fabric" = _xWPODR92;
        "pkg-3.0.1+26.1.2-neoforge" = _JEBMZnKG;
