...
let
    versions = (let
        ...
        _CX4ETzlH = {
            "id" = "CX4ETzlH";
            "file" = "discordlinker-4.4.0-1.21-neoforge.jar";
            "hash" = "sha512-P6QWq1hel9Br4k0K0mNbR+rNEn8KDgbgsrpSAJwMpO6nERTufaSyX3CAsaWJ7jQkYYQh6cHM0/wqAbme7235bw==";
        };
        _GTHQyCgp = {
            "id" = "GTHQyCgp";
            "file" = "discordlinker-4.4.0-spigot.jar";
            "hash" = "sha512-x+3DXni9M+jxHHbLdwt/RDQSQAXVSXC0v4wftIAZgmhv0O/D1TEIv2FkLHHGQyhA8tGVEeT6cw5ska6Sx44QbQ==";
        };
        _cQxRV4ck = {
            "id" = "cQxRV4ck";
            "file" = "discordlinker-4.4.0-1.16.5-forge.jar";
            "hash" = "sha512-0mvoe7T68CjBh0SolkvcShzW/lALziwR7dvgwO2NY35b3a1u7Ync/pR6vZjDjJYGYcAEpLBNUF6avLVxlrl4Zw==";
        };
        _s7mXnJ9O = {
            "id" = "s7mXnJ9O";
            "file" = "discordlinker-4.4.0-1.21.11-neoforge.jar";
            "hash" = "sha512-3bGNW5zGjcP5uQOeeoTK41J7zuV+eDojT6cWwXVcz1IXUlL0vdfoioutqVe7ok1mCjLwrzXUQ1v9LIy4k2ZnUA==";
        };
        _rUkWwEy8 = {
            "id" = "rUkWwEy8";
            "file" = "discordlinker-4.4.0-26.2-fabric.jar";
            "hash" = "sha512-65bwmUhvNVmqI5LJfoq8fi2EZ+OUtHM7iN4R7uqwS/pv/prhmrdvpxyW84p6JefvIkfp7FEJQ5vd73ck7XmwiQ==";
        };
        _hBhHR2o3 = {
            "id" = "hBhHR2o3";
            "file" = "discordlinker-4.4.0-1.19.2-fabric.jar";
            "hash" = "sha512-zwvCWV1ww3CPJ8ec+tpm0P5f1G4pvyHvzpln7Awt5aU5wUCkWQ3Sb/sSFt36dTGRETkzyeRwiX2hE1CI9Oem1w==";
        };
        _zXDqbw0E = {
            "id" = "zXDqbw0E";
            "file" = "discordlinker-4.4.0-1.20-fabric.jar";
            "hash" = "sha512-7O6yAI8nO7hVXbxyVddsTRfiqEf6emMiqn1MEpGX76BEf6/Bb0wwoKPEFEsb9er21Gu8aIfjBIwO+5E1MfyMMA==";
        };
        _ukwzFNox = {
            "id" = "ukwzFNox";
            "file" = "discordlinker-4.4.0-1.21-fabric.jar";
            "hash" = "sha512-SawqnlNg20QvkQOHmD8rNYYVMXMyHEGJ3TjcFMjrCmDyBIDqaEmmz4Plcb8ilshVqIrkj3jMNcYUHtBYU54L7g==";
        };
        _SmActfgF = {
            "id" = "SmActfgF";
            "file" = "discordlinker-4.4.0-1.20-forge.jar";
            "hash" = "sha512-FuUDoodYdaJmnYTFX8Lcy3mEXq6E2WMnai4EVr68Hh86dYMLEJO2hxvZ+xcpmohc0IVpxTG5p8wucedoz/aU9A==";
        };
        _4p7UlJDb = {
            "id" = "4p7UlJDb";
            "file" = "discordlinker-4.4.0-26.2-neoforge.jar";
            "hash" = "sha512-0ZEEo59klogra/SbkRnyux9fLsJeHcmeLZO8lridyDIhIt8Je2cuo3BMEWeN2PwLfGIaGz1F1XfWG5C3D3diHg==";
        };
        _cz2Dblep = {
            "id" = "cz2Dblep";
            "file" = "discordlinker-4.4.0-1.21.11-fabric.jar";
            "hash" = "sha512-+ncKeJwQ8ULwMHd/tKACwNs2Rp9ePQTw4Lr4+3or2yG9plt2J005pU7dDVfD/irkU0cFv2TYTPrmMp8OsiklTg==";
        };
        _71lJEEfM = {
            "id" = "71lJEEfM";
            "file" = "discordlinker-4.4.0-1.19.2-forge.jar";
            "hash" = "sha512-uCBiM3CL9KDE7uri44aWAVnVzzh0fRgsfvutINA9WynxL6CUnf5mcMGS2Mk64CHx7azcI6z4xaBaNcL9luGLMg==";
        };
        _6TBmH9Gm = {
            "id" = "6TBmH9Gm";
            "file" = "discordlinker-4.4.0-1.18.2-forge.jar";
            "hash" = "sha512-huvo6fjQo8Est/O/3uTyam7uxy7lr2R4pV9k4pknWni1NunT7UYdl3PQR6wIHxDMszKwxZP+6JLb2xkxpu5qfQ==";
        };
        _Po7fo7EG = {
            "id" = "Po7fo7EG";
            "file" = "discordlinker-4.4.0-1.16.5-fabric.jar";
            "hash" = "sha512-GnsQflf4kUE87wvIxC8kNWoClEMq3CnN/0rLIOzzGoRwEgNBRANwRr1MmerUHwZxu8EEpkFxeqbXX0TtVS+mhA==";
        };
        _EhkVgFpo = {
            "id" = "EhkVgFpo";
            "file" = "discordlinker-4.4.0-1.18.2-fabric.jar";
            "hash" = "sha512-ASJm0djBbj+uuQCQ7jbEmSJQt7NJFq0RdXbHW15I5y/oPWxkBfH4g02+rhdaVMyEQEx+SmC1gOAgH3R6OOIwUw==";
        };
    in {
        "rNt4F9GN" = _rNt4F9GN;
        "kzbHoBCs" = _kzbHoBCs;
        ...
        "Po7fo7EG" = _Po7fo7EG;
        "EhkVgFpo" = _EhkVgFpo;
        "bukkit-1.13" = _GTHQyCgp;
        "bukkit-1.13.1" = _GTHQyCgp;
        "bukkit-1.13.2" = _GTHQyCgp;
        "bukkit-1.14" = _GTHQyCgp;
        "bukkit-1.14.1" = _GTHQyCgp;
        "bukkit-1.14.2" = _GTHQyCgp;
        "bukkit-1.14.3" = _GTHQyCgp;
        "bukkit-1.14.4" = _GTHQyCgp;
        "bukkit-1.15" = _GTHQyCgp;
        "bukkit-1.15.1" = _GTHQyCgp;
        "bukkit-1.15.2" = _GTHQyCgp;
        "bukkit-1.16" = _GTHQyCgp;
        "bukkit-1.16.1" = _GTHQyCgp;
        "bukkit-1.16.2" = _GTHQyCgp;
        "bukkit-1.16.3" = _GTHQyCgp;
        "bukkit-1.16.4" = _GTHQyCgp;
        "bukkit-1.16.5" = _GTHQyCgp;
        "bukkit-1.17" = _GTHQyCgp;
        "bukkit-1.17.1" = _GTHQyCgp;
        "bukkit-1.18" = _GTHQyCgp;
        "bukkit-1.18.1" = _GTHQyCgp;
        "bukkit-1.18.2" = _GTHQyCgp;
        "bukkit-1.19" = _GTHQyCgp;
        "bukkit-1.19.1" = _GTHQyCgp;
        "bukkit-1.19.2" = _GTHQyCgp;
        "bukkit-1.19.3" = _GTHQyCgp;
        "bukkit-1.19.4" = _GTHQyCgp;
        "bukkit-1.20" = _GTHQyCgp;
        "bukkit-1.20.1" = _GTHQyCgp;
        "bukkit-1.20.2" = _GTHQyCgp;
        "bukkit-1.20.3" = _GTHQyCgp;
        "bukkit-1.20.4" = _GTHQyCgp;
        "bukkit-1.20.5" = _GTHQyCgp;
        "bukkit-1.20.6" = _GTHQyCgp;
        "bukkit-1.21" = _GTHQyCgp;
        "bukkit-1.21.1" = _GTHQyCgp;
        "bukkit-1.12" = _GTHQyCgp;
        "bukkit-1.12.1" = _GTHQyCgp;
        "bukkit-1.12.2" = _GTHQyCgp;
        "bukkit-1.21.2" = _GTHQyCgp;
        "bukkit-1.21.3" = _GTHQyCgp;
        "bukkit-1.21.4" = _GTHQyCgp;
        "bukkit-1.21.5" = _GTHQyCgp;
        "bukkit-1.21.6" = _GTHQyCgp;
        "bukkit-1.21.7" = _GTHQyCgp;
        "bukkit-1.21.8" = _GTHQyCgp;
        "bukkit-1.21.9" = _GTHQyCgp;
        "bukkit-1.21.10" = _GTHQyCgp;
        "bukkit-1.21.11" = _GTHQyCgp;
        "bukkit-1.8" = _GTHQyCgp;
        "bukkit-1.8.1" = _GTHQyCgp;
        "bukkit-1.8.2" = _GTHQyCgp;
        "bukkit-1.8.3" = _GTHQyCgp;
        "bukkit-1.8.4" = _GTHQyCgp;
        "bukkit-1.8.5" = _GTHQyCgp;
        "bukkit-1.8.6" = _GTHQyCgp;
        "bukkit-1.8.7" = _GTHQyCgp;
        "bukkit-1.8.8" = _GTHQyCgp;
        "bukkit-1.8.9" = _GTHQyCgp;
        "bukkit-1.9" = _GTHQyCgp;
        "bukkit-1.9.1" = _GTHQyCgp;
        "bukkit-1.9.2" = _GTHQyCgp;
        "bukkit-1.9.3" = _GTHQyCgp;
        "bukkit-1.9.4" = _GTHQyCgp;
        "bukkit-1.10" = _GTHQyCgp;
        "bukkit-1.10.1" = _GTHQyCgp;
        "bukkit-1.10.2" = _GTHQyCgp;
        "bukkit-1.11" = _GTHQyCgp;
        "bukkit-1.11.1" = _GTHQyCgp;
        "bukkit-1.11.2" = _GTHQyCgp;
        "bukkit-26.1" = _GTHQyCgp;
        "bukkit-26.1.1" = _GTHQyCgp;
        "bukkit-26.1.2" = _GTHQyCgp;
        "paper-1.13" = _GTHQyCgp;
        "paper-1.13.1" = _GTHQyCgp;
        "paper-1.13.2" = _GTHQyCgp;
        "paper-1.14" = _GTHQyCgp;
        "paper-1.14.1" = _GTHQyCgp;
        "paper-1.14.2" = _GTHQyCgp;
        "paper-1.14.3" = _GTHQyCgp;
        "paper-1.14.4" = _GTHQyCgp;
        "paper-1.15" = _GTHQyCgp;
        "paper-1.15.1" = _GTHQyCgp;
        "paper-1.15.2" = _GTHQyCgp;
        "paper-1.16" = _GTHQyCgp;
        "paper-1.16.1" = _GTHQyCgp;
        "paper-1.16.2" = _GTHQyCgp;
        "paper-1.16.3" = _GTHQyCgp;
        "paper-1.16.4" = _GTHQyCgp;
        "paper-1.16.5" = _GTHQyCgp;
        "paper-1.17" = _GTHQyCgp;
        "paper-1.17.1" = _GTHQyCgp;
        "paper-1.18" = _GTHQyCgp;
        "paper-1.18.1" = _GTHQyCgp;
        "paper-1.18.2" = _GTHQyCgp;
        "paper-1.19" = _GTHQyCgp;
        "paper-1.19.1" = _GTHQyCgp;
        "paper-1.19.2" = _GTHQyCgp;
        "paper-1.19.3" = _GTHQyCgp;
        "paper-1.19.4" = _GTHQyCgp;
        "paper-1.20" = _GTHQyCgp;
        "paper-1.20.1" = _GTHQyCgp;
        "paper-1.20.2" = _GTHQyCgp;
        "paper-1.20.3" = _GTHQyCgp;
        "paper-1.20.4" = _GTHQyCgp;
        "paper-1.20.5" = _GTHQyCgp;
        "paper-1.20.6" = _GTHQyCgp;
        "paper-1.21" = _GTHQyCgp;
        "paper-1.21.1" = _GTHQyCgp;
        "paper-1.12" = _GTHQyCgp;
        "paper-1.12.1" = _GTHQyCgp;
        "paper-1.12.2" = _GTHQyCgp;
        "paper-1.21.2" = _GTHQyCgp;
        "paper-1.21.3" = _GTHQyCgp;
        "paper-1.21.4" = _GTHQyCgp;
        "paper-1.21.5" = _GTHQyCgp;
        "paper-1.21.6" = _GTHQyCgp;
        "paper-1.21.7" = _GTHQyCgp;
        "paper-1.21.8" = _GTHQyCgp;
        "paper-1.21.9" = _GTHQyCgp;
        "paper-1.21.10" = _GTHQyCgp;
        "paper-1.21.11" = _GTHQyCgp;
        "paper-1.8" = _GTHQyCgp;
        "paper-1.8.1" = _GTHQyCgp;
        "paper-1.8.2" = _GTHQyCgp;
        "paper-1.8.3" = _GTHQyCgp;
        "paper-1.8.4" = _GTHQyCgp;
        "paper-1.8.5" = _GTHQyCgp;
        "paper-1.8.6" = _GTHQyCgp;
        "paper-1.8.7" = _GTHQyCgp;
        "paper-1.8.8" = _GTHQyCgp;
        "paper-1.8.9" = _GTHQyCgp;
        "paper-1.9" = _GTHQyCgp;
        "paper-1.9.1" = _GTHQyCgp;
        "paper-1.9.2" = _GTHQyCgp;
        "paper-1.9.3" = _GTHQyCgp;
        "paper-1.9.4" = _GTHQyCgp;
        "paper-1.10" = _GTHQyCgp;
        "paper-1.10.1" = _GTHQyCgp;
        "paper-1.10.2" = _GTHQyCgp;
        "paper-1.11" = _GTHQyCgp;
        "paper-1.11.1" = _GTHQyCgp;
        "paper-1.11.2" = _GTHQyCgp;
        "paper-26.1" = _GTHQyCgp;
        "paper-26.1.1" = _GTHQyCgp;
        "paper-26.1.2" = _GTHQyCgp;
        "spigot-1.13" = _GTHQyCgp;
        "spigot-1.13.1" = _GTHQyCgp;
        "spigot-1.13.2" = _GTHQyCgp;
        "spigot-1.14" = _GTHQyCgp;
        "spigot-1.14.1" = _GTHQyCgp;
        "spigot-1.14.2" = _GTHQyCgp;
        "spigot-1.14.3" = _GTHQyCgp;
        "spigot-1.14.4" = _GTHQyCgp;
        "spigot-1.15" = _GTHQyCgp;
        "spigot-1.15.1" = _GTHQyCgp;
        "spigot-1.15.2" = _GTHQyCgp;
        "spigot-1.16" = _GTHQyCgp;
        "spigot-1.16.1" = _GTHQyCgp;
        "spigot-1.16.2" = _GTHQyCgp;
        "spigot-1.16.3" = _GTHQyCgp;
        "spigot-1.16.4" = _GTHQyCgp;
        "spigot-1.16.5" = _GTHQyCgp;
        "spigot-1.17" = _GTHQyCgp;
        "spigot-1.17.1" = _GTHQyCgp;
        "spigot-1.18" = _GTHQyCgp;
        "spigot-1.18.1" = _GTHQyCgp;
        "spigot-1.18.2" = _GTHQyCgp;
        "spigot-1.19" = _GTHQyCgp;
        "spigot-1.19.1" = _GTHQyCgp;
        "spigot-1.19.2" = _GTHQyCgp;
        "spigot-1.19.3" = _GTHQyCgp;
        "spigot-1.19.4" = _GTHQyCgp;
        "spigot-1.20" = _GTHQyCgp;
        "spigot-1.20.1" = _GTHQyCgp;
        "spigot-1.20.2" = _GTHQyCgp;
        "spigot-1.20.3" = _GTHQyCgp;
        "spigot-1.20.4" = _GTHQyCgp;
        "spigot-1.20.5" = _GTHQyCgp;
        "spigot-1.20.6" = _GTHQyCgp;
        "spigot-1.21" = _GTHQyCgp;
        "spigot-1.21.1" = _GTHQyCgp;
        "spigot-1.12" = _GTHQyCgp;
        "spigot-1.12.1" = _GTHQyCgp;
        "spigot-1.12.2" = _GTHQyCgp;
        "spigot-1.21.2" = _GTHQyCgp;
        "spigot-1.21.3" = _GTHQyCgp;
        "spigot-1.21.4" = _GTHQyCgp;
        "spigot-1.21.5" = _GTHQyCgp;
        "spigot-1.21.6" = _GTHQyCgp;
        "spigot-1.21.7" = _GTHQyCgp;
        "spigot-1.21.8" = _GTHQyCgp;
        "spigot-1.21.9" = _GTHQyCgp;
        "spigot-1.21.10" = _GTHQyCgp;
        "spigot-1.21.11" = _GTHQyCgp;
        "spigot-1.8" = _GTHQyCgp;
        "spigot-1.8.1" = _GTHQyCgp;
        "spigot-1.8.2" = _GTHQyCgp;
        "spigot-1.8.3" = _GTHQyCgp;
        "spigot-1.8.4" = _GTHQyCgp;
        "spigot-1.8.5" = _GTHQyCgp;
        "spigot-1.8.6" = _GTHQyCgp;
        "spigot-1.8.7" = _GTHQyCgp;
        "spigot-1.8.8" = _GTHQyCgp;
        "spigot-1.8.9" = _GTHQyCgp;
        "spigot-1.9" = _GTHQyCgp;
        "spigot-1.9.1" = _GTHQyCgp;
        "spigot-1.9.2" = _GTHQyCgp;
        "spigot-1.9.3" = _GTHQyCgp;
        "spigot-1.9.4" = _GTHQyCgp;
        "spigot-1.10" = _GTHQyCgp;
        "spigot-1.10.1" = _GTHQyCgp;
        "spigot-1.10.2" = _GTHQyCgp;
        "spigot-1.11" = _GTHQyCgp;
        "spigot-1.11.1" = _GTHQyCgp;
        "spigot-1.11.2" = _GTHQyCgp;
        "spigot-26.1" = _GTHQyCgp;
        "spigot-26.1.1" = _GTHQyCgp;
        "spigot-26.1.2" = _GTHQyCgp;
        "purpur-1.13" = _GTHQyCgp;
        "purpur-1.13.1" = _GTHQyCgp;
        "purpur-1.13.2" = _GTHQyCgp;
        "purpur-1.14" = _GTHQyCgp;
        "purpur-1.14.1" = _GTHQyCgp;
        "purpur-1.14.2" = _GTHQyCgp;
        "purpur-1.14.3" = _GTHQyCgp;
        "purpur-1.14.4" = _GTHQyCgp;
        "purpur-1.15" = _GTHQyCgp;
        "purpur-1.15.1" = _GTHQyCgp;
        "purpur-1.15.2" = _GTHQyCgp;
        "purpur-1.16" = _GTHQyCgp;
        "purpur-1.16.1" = _GTHQyCgp;
        "purpur-1.16.2" = _GTHQyCgp;
        "purpur-1.16.3" = _GTHQyCgp;
        "purpur-1.16.4" = _GTHQyCgp;
        "purpur-1.16.5" = _GTHQyCgp;
        "purpur-1.17" = _GTHQyCgp;
        "purpur-1.17.1" = _GTHQyCgp;
        "purpur-1.18" = _GTHQyCgp;
        "purpur-1.18.1" = _GTHQyCgp;
        "purpur-1.18.2" = _GTHQyCgp;
        "purpur-1.19" = _GTHQyCgp;
        "purpur-1.19.1" = _GTHQyCgp;
        "purpur-1.19.2" = _GTHQyCgp;
        "purpur-1.19.3" = _GTHQyCgp;
        "purpur-1.19.4" = _GTHQyCgp;
        "purpur-1.20" = _GTHQyCgp;
        "purpur-1.20.1" = _GTHQyCgp;
        "purpur-1.20.2" = _GTHQyCgp;
        "purpur-1.20.3" = _GTHQyCgp;
        "purpur-1.20.4" = _GTHQyCgp;
        "purpur-1.20.5" = _GTHQyCgp;
        "purpur-1.20.6" = _GTHQyCgp;
        "purpur-1.21" = _GTHQyCgp;
        "purpur-1.21.1" = _GTHQyCgp;
        "purpur-1.12" = _GTHQyCgp;
        "purpur-1.12.1" = _GTHQyCgp;
        "purpur-1.12.2" = _GTHQyCgp;
        "purpur-1.21.2" = _GTHQyCgp;
        "purpur-1.21.3" = _GTHQyCgp;
        "purpur-1.21.4" = _GTHQyCgp;
        "purpur-1.21.5" = _GTHQyCgp;
        "purpur-1.21.6" = _GTHQyCgp;
        "purpur-1.21.7" = _GTHQyCgp;
        "purpur-1.21.8" = _GTHQyCgp;
        "purpur-1.21.9" = _GTHQyCgp;
        "purpur-1.21.10" = _GTHQyCgp;
        "purpur-1.21.11" = _GTHQyCgp;
        "purpur-1.8" = _GTHQyCgp;
        "purpur-1.8.1" = _GTHQyCgp;
        "purpur-1.8.2" = _GTHQyCgp;
        "purpur-1.8.3" = _GTHQyCgp;
        "purpur-1.8.4" = _GTHQyCgp;
        "purpur-1.8.5" = _GTHQyCgp;
        "purpur-1.8.6" = _GTHQyCgp;
        "purpur-1.8.7" = _GTHQyCgp;
        "purpur-1.8.8" = _GTHQyCgp;
        "purpur-1.8.9" = _GTHQyCgp;
        "purpur-1.9" = _GTHQyCgp;
        "purpur-1.9.1" = _GTHQyCgp;
        "purpur-1.9.2" = _GTHQyCgp;
        "purpur-1.9.3" = _GTHQyCgp;
        "purpur-1.9.4" = _GTHQyCgp;
        "purpur-1.10" = _GTHQyCgp;
        "purpur-1.10.1" = _GTHQyCgp;
        "purpur-1.10.2" = _GTHQyCgp;
        "purpur-1.11" = _GTHQyCgp;
        "purpur-1.11.1" = _GTHQyCgp;
        "purpur-1.11.2" = _GTHQyCgp;
        "purpur-26.1" = _GTHQyCgp;
        "purpur-26.1.1" = _GTHQyCgp;
        "purpur-26.1.2" = _GTHQyCgp;
        "fabric-1.21.11" = _cz2Dblep;
        "fabric-1.16.5" = _Po7fo7EG;
        "fabric-1.19.2" = _hBhHR2o3;
        "fabric-1.18.2" = _EhkVgFpo;
        "fabric-1.20" = _zXDqbw0E;
        "fabric-1.20.1" = _zXDqbw0E;
        "fabric-26.2" = _rUkWwEy8;
        "fabric-1.21" = _ukwzFNox;
        "fabric-1.21.1" = _ukwzFNox;
        "forge-1.19.2" = _71lJEEfM;
        "forge-1.16.5" = _cQxRV4ck;
        "forge-1.20" = _SmActfgF;
        "forge-1.20.1" = _SmActfgF;
        "forge-1.18.2" = _6TBmH9Gm;
        "neoforge-1.21.11" = _s7mXnJ9O;
        "neoforge-1.21" = _CX4ETzlH;
        "neoforge-1.21.1" = _CX4ETzlH;
        "neoforge-26.2" = _4p7UlJDb;
        "pkg-3.0.1" = _rNt4F9GN;
        "pkg-3.1" = _kzbHoBCs;
        "pkg-3.1.1" = _yRIWSVDx;
        "pkg-3.1.2" = _fVAQvLwW;
