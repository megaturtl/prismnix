...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.2-6.0.x" = _tGme1sIy;
        "pkg-1.20.1-1.2-0.5.1.j" = _Xu3PLpMN;
        "pkg-1.20.1-1.3-6.0.x" = _T1uTdFnH;
        "pkg-1.20.1-1.3-0.5.1.j" = _HCJ7YNrJ;
        "pkg-1.20.1-2.3-0.5.1.j" = _YeWlKZvv;
        "pkg-1.20.1-2.3.1-6.0.x" = _Fepdyisv;
        "pkg-1.20.1-2.3.2-0.5.1.j" = _Ugul9BSg;
        "pkg-1.20.1-2.3.2-6.0.x" = _oqEu1Ngf;
        "pkg-1.20.1-2.4.3-0.5.1.j" = _l7xSapWy;
        "pkg-1.20.1-2.4.3-6.0.x" = _4KG9FWDH;
        "pkg-1.20.1-2.4.4-0.5.1.j" = _pk71yY8p;
        "pkg-1.20.1-2.4.4-6.0.x" = _39aUI8XC;
        "pkg-1.20.1-2.4.5-0.5.1.j" = _zAks8m7E;
        "pkg-1.20.1-2.4.5-6.0.x" = _R0ibkm5E;
        "pkg-1.20.1-2.4.6-0.5.1.j" = _on0N7qCj;
        "pkg-1.20.1-2.4.6-6.0.x" = _oapXR8no;
        "pkg-1.20.1-2.4.7-6.0.x" = _JO8jtSkw;
        "pkg-1.20.1-2.4.7-0.5.1.j" = _wSlPjH0J;
        "pkg-1.19.2-2.4.7-0.5.1.i" = _sDfATY0k;
        "pkg-1.20.1-2.4.8-0.5.1.j" = _z4MLVpHt;
        "pkg-1.19.2-2.4.8-0.5.1.i" = _qoKLgBKI;
        "pkg-1.20.1-2.4.8-6.0.x" = _9rYOXT6m;
        "pkg-1.21.1-2.4.8-6.0.x" = _pmMMAZId;
        "pkg-1.20.1-2.4.9-6.0.x" = _7xhGEsf2;
        "pkg-1.20.1-2.4.9-0.5.1.j" = _UBZkskbP;
        "pkg-1.19.2-2.4.9-0.5.1.i" = _cngR3cPN;
        "pkg-1.21.1-2.4.9-6.0.x" = _Dx5cIwDo;
        "pkg-1.19.2-2.5.15-0.5.1.i" = _kZuslM1P;
