...
let
    ...
    in {
        ...
        "pkg-21.4.112" = _BMwCttBC;
        "pkg-21.5.0" = _yb6jwFtm;
        "pkg-21.5.1" = _SUXIC5k9;
        "pkg-21.5.9" = _mgCJrval;
        "pkg-21.5.16" = _ALK2ZJaV;
        "pkg-21.5.17" = _Ahf75kHz;
        "pkg-21.5.18" = _hnAus3y7;
        "pkg-21.6.0" = _geamgx9V;
        "pkg-21.7.0" = _WiKRTfmt;
        "pkg-21.7.1" = _Vx2TzOvH;
        "pkg-21.6.3" = _3n4xRHEv;
        "pkg-21.7.6" = _bWdZyNr9;
        "pkg-21.7.8" = _VfWPaZ2n;
        "pkg-21.10.0" = _j3hzOGEe;
        "pkg-21.10.4" = _BnRWnkzS;
        "pkg-21.11.0" = _EkTWYLMr;
        "pkg-21.10.5" = _58xIcoME;
        "pkg-21.11.1" = _rltQgWSS;
        "pkg-26.1.0" = _DsYIHviS;
