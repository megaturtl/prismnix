...
let
    ...
    in {
        ...
        "pkg-V1.2-data" = _lxhCK3qV;
        "pkg-V1.2-mod" = _qw5Ovs69;
        "pkg-V1.2.1-data" = _YweGW2zw;
        "pkg-V1.2.1-mod" = _m7NCvaFR;
        "pkg-V1.2.2-resource" = _3EsZBDz2;
        "pkg-V1.2.2-data" = _RKMZebNM;
        "pkg-V1.2.2-mod" = _6uyzm3i2;
        "pkg-V1.2.3-resource" = _8QCVt5mX;
        "pkg-V1.2.3-data" = _uxkA3mBh;
        "pkg-V1.2.3-mod" = _5TwmvXdo;
        "pkg-V1.2.4-resource" = _cPQyp8LH;
        "pkg-V1.2.4-data" = _YZtHDCT5;
        "pkg-V1.2.4-mod" = _EBD9msWt;
        "pkg-V1.2.5-resource" = _QE7vlDtX;
        "pkg-V1.2.5-data" = _UoOs5lLk;
        "pkg-V1.2.5-mod" = _TSZRnSvp;
        "pkg-V1.2.6-resource" = _yB9gt2oT;
        "pkg-V1.2.6-data" = _SlDpmqLH;
        "pkg-V1.2.6-mod" = _aPRUrzog;
        "pkg-V1.2.7-resource" = _hn1kcN3i;
        "pkg-V1.2.7-data" = _JLSVYYPM;
        "pkg-V1.2.7-mod" = _EpCgP1KL;
