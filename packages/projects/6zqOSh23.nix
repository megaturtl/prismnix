...
let
    versions = (let
        ...
        _BZtcxoIR = {
            "id" = "BZtcxoIR";
            "file" = "nonchat-1.6.4.jar";
            "hash" = "sha512-L57GhDAcnqtNoCnTbcUOk77FEAsfV42Tpz8dOGagOzmZcv6IUsYBFi1eah2a3XD/WOU/whxS55mB7gICrVMR9g==";
        };
    in {
        "v2cHL5AY" = _v2cHL5AY;
        "vuTnIRZP" = _vuTnIRZP;
        ...
        "9Ko6TVDU" = _9Ko6TVDU;
        "BZtcxoIR" = _BZtcxoIR;
        "bukkit-1.20" = _BZtcxoIR;
        "bukkit-1.20.1" = _BZtcxoIR;
        "bukkit-1.20.2" = _BZtcxoIR;
        "bukkit-1.20.3" = _BZtcxoIR;
        "bukkit-1.20.4" = _BZtcxoIR;
        "bukkit-1.20.5" = _BZtcxoIR;
        "bukkit-1.20.6" = _BZtcxoIR;
        "bukkit-1.21" = _BZtcxoIR;
        "bukkit-1.21.1" = _BZtcxoIR;
        "bukkit-1.21.2" = _BZtcxoIR;
        "bukkit-1.21.3" = _BZtcxoIR;
        "bukkit-1.21.4" = _BZtcxoIR;
        "bukkit-1.19" = _BZtcxoIR;
        "bukkit-1.19.1" = _BZtcxoIR;
        "bukkit-1.19.2" = _BZtcxoIR;
        "bukkit-1.19.3" = _BZtcxoIR;
        "bukkit-1.19.4" = _BZtcxoIR;
        "bukkit-1.18" = _BZtcxoIR;
        "bukkit-1.18.1" = _BZtcxoIR;
        "bukkit-1.18.2" = _BZtcxoIR;
        "bukkit-1.17" = _BZtcxoIR;
        "bukkit-1.17.1" = _BZtcxoIR;
        "bukkit-1.16" = _Jf3AHJtI;
        "bukkit-1.16.1" = _Jf3AHJtI;
        "bukkit-1.16.2" = _Jf3AHJtI;
        "bukkit-1.16.3" = _Jf3AHJtI;
        "bukkit-1.16.4" = _Jf3AHJtI;
        "bukkit-1.16.5" = _BZtcxoIR;
        "bukkit-1.21.5" = _BZtcxoIR;
        "bukkit-1.21.6" = _BZtcxoIR;
        "bukkit-1.21.7" = _BZtcxoIR;
        "bukkit-1.21.8" = _BZtcxoIR;
        "bukkit-1.21.9" = _BZtcxoIR;
        "bukkit-1.21.10" = _BZtcxoIR;
        "bukkit-1.21.11" = _BZtcxoIR;
        "bukkit-26.1" = _BZtcxoIR;
        "bukkit-26.1.1" = _BZtcxoIR;
        "bukkit-26.1.2" = _BZtcxoIR;
        "bukkit-26.2" = _BZtcxoIR;
        "paper-1.20" = _BZtcxoIR;
        "paper-1.20.1" = _BZtcxoIR;
        "paper-1.20.2" = _BZtcxoIR;
        "paper-1.20.3" = _BZtcxoIR;
        "paper-1.20.4" = _BZtcxoIR;
        "paper-1.20.5" = _BZtcxoIR;
        "paper-1.20.6" = _BZtcxoIR;
        "paper-1.21" = _BZtcxoIR;
        "paper-1.21.1" = _BZtcxoIR;
        "paper-1.21.2" = _BZtcxoIR;
        "paper-1.21.3" = _BZtcxoIR;
        "paper-1.21.4" = _BZtcxoIR;
        "paper-1.19" = _BZtcxoIR;
        "paper-1.19.1" = _BZtcxoIR;
        "paper-1.19.2" = _BZtcxoIR;
        "paper-1.19.3" = _BZtcxoIR;
        "paper-1.19.4" = _BZtcxoIR;
        "paper-1.18" = _BZtcxoIR;
        "paper-1.18.1" = _BZtcxoIR;
        "paper-1.18.2" = _BZtcxoIR;
        "paper-1.17" = _BZtcxoIR;
        "paper-1.17.1" = _BZtcxoIR;
        "paper-1.16" = _Jf3AHJtI;
        "paper-1.16.1" = _Jf3AHJtI;
        "paper-1.16.2" = _Jf3AHJtI;
        "paper-1.16.3" = _Jf3AHJtI;
        "paper-1.16.4" = _Jf3AHJtI;
        "paper-1.16.5" = _BZtcxoIR;
        "paper-1.21.5" = _BZtcxoIR;
        "paper-1.21.6" = _BZtcxoIR;
        "paper-1.21.7" = _BZtcxoIR;
        "paper-1.21.8" = _BZtcxoIR;
        "paper-1.21.9" = _BZtcxoIR;
        "paper-1.21.10" = _BZtcxoIR;
        "paper-1.21.11" = _BZtcxoIR;
        "paper-26.1" = _BZtcxoIR;
        "paper-26.1.1" = _BZtcxoIR;
        "paper-26.1.2" = _BZtcxoIR;
        "paper-26.2" = _BZtcxoIR;
        ...
        "purpur-1.16.5" = _BZtcxoIR;
        "purpur-1.17" = _BZtcxoIR;
        "purpur-1.17.1" = _BZtcxoIR;
        "purpur-1.18" = _BZtcxoIR;
        "purpur-1.18.1" = _BZtcxoIR;
        "purpur-1.18.2" = _BZtcxoIR;
        "purpur-1.19" = _BZtcxoIR;
        "purpur-1.19.1" = _BZtcxoIR;
        "purpur-1.19.2" = _BZtcxoIR;
        "purpur-1.19.3" = _BZtcxoIR;
        "purpur-1.19.4" = _BZtcxoIR;
        "purpur-1.20" = _BZtcxoIR;
        "purpur-1.20.1" = _BZtcxoIR;
        "purpur-1.20.2" = _BZtcxoIR;
        "purpur-1.20.3" = _BZtcxoIR;
        "purpur-1.20.4" = _BZtcxoIR;
        "purpur-1.20.5" = _BZtcxoIR;
        "purpur-1.20.6" = _BZtcxoIR;
        "purpur-1.21" = _BZtcxoIR;
        "purpur-1.21.1" = _BZtcxoIR;
        "purpur-1.21.2" = _BZtcxoIR;
        "purpur-1.21.3" = _BZtcxoIR;
        "purpur-1.21.4" = _BZtcxoIR;
        "purpur-1.21.5" = _BZtcxoIR;
        "purpur-1.21.6" = _BZtcxoIR;
        "purpur-1.21.7" = _BZtcxoIR;
        "purpur-1.21.8" = _BZtcxoIR;
        "purpur-1.21.9" = _BZtcxoIR;
        "purpur-1.21.10" = _BZtcxoIR;
        "purpur-1.21.11" = _BZtcxoIR;
        "purpur-26.1" = _BZtcxoIR;
        "purpur-26.1.1" = _BZtcxoIR;
        "purpur-26.1.2" = _BZtcxoIR;
        "purpur-26.2" = _BZtcxoIR;
        "pkg-1.0.0" = _v2cHL5AY;
        "pkg-1.0.1" = _vuTnIRZP;
        "pkg-1.1.2" = _9n8OYLDX;
        "pkg-1.2.2" = _l6cG2IAn;
