...
let
    ...
    in {
        ...
        "pkg-0.6.8" = _augNJr7f;
        "pkg-0.6.9" = _MXGYLOSa;
        "pkg-0.6.10" = _xh3VbgQM;
        "pkg-0.6.11" = _Nqj3ygFG;
        "pkg-0.6.12" = _MeEDMUwr;
        "pkg-0.6.13" = _tpxzdl5U;
        "pkg-0.7.0-beta.4" = _MzsPVoZq;
        "pkg-0.7.0-beta.5" = _W4ToiHdP;
        "pkg-0.7.0-beta.6" = _NA87dl9U;
        "pkg-0.6.40.17" = _NDHaka6I;
