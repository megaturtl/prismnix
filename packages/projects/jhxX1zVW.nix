...
let
    versions = (let
        ...
        _mAb8ic6J = {
            "id" = "mAb8ic6J";
            "file" = "AdditionalEnchantedMiner-1.21.11-fabric-21.11.163.jar";
            "hash" = "sha512-5pHam6DpvOjg4vXb3mJlKUPTsp5zzw3aOqCjio4VyxbsgjZ11VmmXvL47gu/kMPXwqwALKlmFeUWTwbWzOUnuA==";
        };
        _r2Y9HFA0 = {
            "id" = "r2Y9HFA0";
            "file" = "AdditionalEnchantedMiner-1.21.11-forge-21.11.163.jar";
            "hash" = "sha512-d2+C8wtlKo/O6FZ7AeBetkFV8CYHP8pUPOzLGHFCKZFjCW8v8Xx6z+TK0iPINZ2T+FWNpl+eKe2JeLdrzGJvuw==";
        };
        _3yEVXmRT = {
            "id" = "3yEVXmRT";
    ...
    in {
        ...
        "neoforge-1.21.11" = _3yEVXmRT;
        "neoforge-26.1.2" = _mK5rX5za;
        "neoforge-26.2" = _J1DY336I;
        "pkg-19.4.0" = _WAlScL50;
        "pkg-1192.1.0" = _l6GZuMkU;
        "pkg-1194.1.0" = _evJRhKCb;
        "pkg-12.5.7" = _kp5ymDWS;
        "pkg-1192.1.1" = _4pK67MtS;
        "pkg-1194.1.1" = _EV6iOcPT;
        "pkg-1200.0.6-SNAPSHOT" = _BNBPNQWg;
        "pkg-1201.0.8-SNAPSHOT" = _IZAqxVld;
        "pkg-20.0.801" = _nymKnlhi;
        "pkg-1192.2.0" = _dBxRDIR3;
        "pkg-1201.0.9-SNAPSHOT" = _gAPthMF9;
        "pkg-1201.0.10-SNAPSHOT" = _4oFTHz1U;
        "pkg-1201.0.11-SNAPSHOT" = _grnEH7Fl;
        "pkg-1192.2.1" = _peh4DXvW;
        "pkg-1194.2.1" = _pfSw9bwz;
        "pkg-1192.2.13" = _xSSo6WYx;
        "pkg-1201.0.14-SNAPSHOT" = _FADciEA4;
        "pkg-1201.0.15" = _CXLfi0O9;
        "pkg-18.20" = _yW6ampjC;
        "pkg-1192.3.16" = _r5UC5RG6;
        "pkg-1201.0.17" = _u3UMC3Xk;
        "pkg-1192.3.18" = _ati1kbf9;
        "pkg-1202.0.19-SNAPSHOT" = _Eauiy85h;
        "pkg-19.2.0" = _YzTK9b2u;
        "pkg-1202.1.20-SNAPSHOT" = _jjjrxCTX;
        "pkg-1201.0.21" = _TsMW9A5Z;
        "pkg-1201.0.23" = _SifpUQ7m;
        "pkg-1192.3.22" = _2lWkWgIV;
        "pkg-1202.1.24-SNAPSHOT" = _vwKqoMyK;
        "pkg-1192.3.25" = _A7RY99tK;
        "pkg-1201.0.26" = _ztcxfGU1;
        "pkg-1202.1.27-SNAPSHOT" = _PsIJC7aB;
        "pkg-1202.1.30-SNAPSHOT" = _PjDol9iR;
        "pkg-1202.2.32-SNAPSHOT" = _OwuRESoq;
        "pkg-1202.2.33-SNAPSHOT" = _iBlwTBbg;
        "pkg-20.2.883" = _6ozOfyTj;
        "pkg-20.4.43" = _pK45eQwD;
        "pkg-20.4.0" = _7oRpOa9X;
        "pkg-20.4.44" = _4J1b5fbq;
        "pkg-18.22" = _AETMabkf;
        "pkg-1192.3.45" = _ytqnyKnn;
        "pkg-1201.0.46" = _srMcqMaG;
        "pkg-20.4.47" = _5DC40sw1;
        "pkg-18.23" = _jynDFNKH;
        "pkg-1192.3.48" = _5968YuWm;
        "pkg-1194.2.2" = _STF0QjEd;
        "pkg-1201.0.49" = _trohoNP5;
        "pkg-20.4.50" = _OjDfPiZX;
        "pkg-1201.0.51" = _zgQSYSS3;
        "pkg-16.1.15" = _cUiHiTBJ;
        "pkg-19.2.1156" = _GYYm6MqB;
        "pkg-19.2.1157" = _gQGtSz8O;
        "pkg-20.1.1159" = _g9S6sz8i;
        "pkg-20.2.1160" = _Sc7k0YVa;
        "pkg-20.4.56" = _wJLZPdCQ;
        "pkg-20.4.57" = _LGDhdHF2;
        "pkg-1201.0.58" = _HJzyYnmb;
        "pkg-1192.3.59" = _gQR8MpJz;
        "pkg-1192.4.62" = _E75i4Mku;
        "pkg-1194.3.63" = _I0LlfiaA;
        "pkg-1201.1.64" = _31jEF2k6;
        "pkg-1192.4.65" = _iuxol1Us;
        "pkg-1201.1.66" = _86Lgz7W8;
        "pkg-20.4.69" = _HbraJchK;
        "pkg-18.24" = _HRLmrbL8;
        "pkg-20.4.76" = _MKF4yhEE;
        "pkg-20.1.1556" = _usnMi65u;
        "pkg-21.0.78" = _VXx0cMOK;
        "pkg-21.0.79" = _6kxFEAko;
        "pkg-1201.1.80" = _fvRdPEVf;
        "pkg-21.0.81" = _JH9eZi2I;
        "pkg-21.0.82" = _8VmCu3uK;
        "pkg-21.0.83" = _YIlFfrRI;
        "pkg-21.0.84" = _1UY8QXKe;
        "pkg-21.0.85" = _TgWVbuAn;
        "pkg-21.0.86" = _NYH5ldLY;
        "pkg-21.0.87" = _6ejTbK0N;
        "pkg-21.0.88" = _mWbUNhmE;
        "pkg-21.1.89" = _bzliBSEl;
        "pkg-1201.1.90" = _6fbVhSPZ;
        "pkg-21.1.91" = _OPRfx5kj;
        "pkg-21.1.92" = _a4Djq74k;
        "pkg-21.1.93" = _31uafyHW;
        "pkg-21.1.94" = _gPOjGiy6;
        "pkg-21.1.95" = _L5OkceTq;
        "pkg-1192.4.96" = _Ovr404PH;
        "pkg-21.1.97" = _mlxHF6Ie;
        "pkg-21.1.98" = _twxic0Ly;
        "pkg-21.1.99" = _etXNeolO;
        "pkg-21.1.100" = _oBadj8uc;
        "pkg-21.1.101" = _Nqo95URp;
        "pkg-21.1.102" = _pzCI4nzF;
        "pkg-21.1.103" = _hbcq1Mwz;
        "pkg-21.1.104" = _qbEZqDpM;
        "pkg-21.1.105" = _vfWQJDiJ;
        "pkg-21.1.106" = _DiSal1dd;
        "pkg-21.1.107" = _2Yq3p0JW;
        "pkg-21.1.108" = _7QyU3uKc;
        "pkg-21.1.109" = _xynALuT2;
        "pkg-21.1.110" = _CbkdlERM;
        "pkg-21.3.111" = _RpJkNQ0v;
        "pkg-21.1.112" = _Zwp9O730;
        "pkg-21.3.113" = _uYvyz9RE;
        "pkg-21.3.114" = _7OAyScVy;
        "pkg-21.1.115" = _e8ouvLc5;
        "pkg-21.1.116" = _tfJXZd9N;
        "pkg-21.3.117" = _BVkvO36z;
        "pkg-21.1.119" = _B7yt1oV5;
        "pkg-21.4.120" = _U15skuaj;
        "pkg-1201.1.121" = _AGslqpdv;
        "pkg-21.5.123" = _6ydHzbSf;
        "pkg-21.1.124" = _1scOornO;
        "pkg-21.1.125" = _X1vnYgb4;
        "pkg-21.1.126" = _7dVJ6QjH;
        "pkg-21.1.127" = _3zbRtNOL;
        "pkg-21.5.128" = _7KSxjSF5;
        "pkg-21.5.129" = _aqinPa6M;
        "pkg-21.1.130" = _my5zZzD7;
        "pkg-21.7.131" = _Vjish5SV;
        "pkg-21.8.132" = _UWj5lbSu;
        "pkg-1201.1.133" = _xKKE3cA1;
        "pkg-1201.1.134" = _YD01sudk;
        "pkg-21.1.135" = _OHAJ8eVw;
        "pkg-1201.1.136" = _cQSJraHw;
        "pkg-21.8.137" = _cylK83Qe;
        "pkg-18.25" = _7vhO13Zw;
        "pkg-21.4.140" = _jLemFNEN;
        "pkg-21.1.141" = _tWs6fWVA;
        "pkg-21.10.142" = _9MrqOPR6;
        "pkg-21.11.143" = _RLRSdUEg;
        "pkg-21.1.144" = _tlPp8b5p;
        "pkg-21.11.145" = _FIT32MBU;
        "pkg-21.1.146" = _4JAc82GS;
        "pkg-21.1.147" = _JCrh6WyC;
        "pkg-21.11.148" = _tzpyf35x;
        "pkg-21.11.150" = _X23wnMJV;
        "pkg-21.1.152" = _TBQ6F81r;
        "pkg-21.1.153" = _oNV1JTUq;
        "pkg-26.12.154" = _ZrsOCCOg;
        "pkg-26.12.156" = _YQab5RPW;
        "pkg-21.1.157" = _lMPEwYzj;
        "pkg-26.12.158" = _HPFc2ye0;
        "pkg-26.20.159" = _J1DY336I;
        "pkg-26.12.160" = _5P0gjusE;
