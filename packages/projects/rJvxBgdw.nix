...
let
    ...
    in {
        ...
        "pkg-1.3.8" = _OMgaxIvR;
        "pkg-1.3.9" = _DUUe3gWg;
        "pkg-1.21.1-v1.4.0" = _K9qRtjMt;
        "pkg-1.21.1-v1.4.1" = _QeL1MaHI;
        "pkg-1.21.1-v1.4.2" = _ZQ2uBnqg;
        "pkg-1.21.4-v1.4.2" = _OjiJQYtw;
        "pkg-1.21.4-v1.4.3" = _t0P7ucvV;
        "pkg-1.21.4-v1.4.4" = _DlWyJ7sK;
        "pkg-1.21.4-v1.4.5" = _hk0n9u6W;
        "pkg-1.21.1-v1.4.3" = _lnvlyjKP;
        "pkg-1.20-v1.3.10" = _tvN6EHyi;
        "pkg-1.21.1-v1.4.4" = _Jud6ozAC;
        "pkg-1.21.1-v1.4.5" = _XraSJNdf;
        "pkg-1.21.4-v1.5.0" = _cTX2q870;
        "pkg-1.21.4-v1.5.1" = _E2DCbg37;
        "pkg-1.21.4-v1.5.2" = _DqJgHiRD;
        "pkg-1.21.1-v1.4.6" = _K5x2Qbft;
        "pkg-1.21.4-v1.5.3" = _o3MGSd1A;
        "pkg-1.21.4-v1.5.4" = _EERJnsZ0;
        "pkg-1.21.1-v1.4.7" = _Po20VB1C;
        "pkg-1.21.4-v1.6.0" = _hzfj2ZRs;
        "pkg-1.21.4-v1.6.1" = _XtugUn92;
        "pkg-1.21.4-v1.6.2" = _ms33kWdg;
        "pkg-1.21.4-v1.6.3" = _d5SAFivh;
        "pkg-1.21.4-v1.6.4" = _T7w2yNp0;
        "pkg-1.21.4-v1.6.5" = _eV8bXV1j;
        "pkg-1.21.4-v1.6.6" = _9J2wLxK3;
        "pkg-1.21.4-v1.6.7" = _5azZzFP2;
        "pkg-1.21.4-v1.6.8" = _Ir3oTG5u;
        "pkg-1.21.5-v1.6.9" = _wTyeeN1n;
        "pkg-1.21.4-v1.6.9" = _c77cz1sp;
        "pkg-1.21.5-v1.6.10" = _aIGczQYg;
        "pkg-1.21.4-v1.6.10" = _1IDAgw6A;
        "pkg-1.21.5-v1.6.11" = _H52n3jGv;
        "pkg-1.21.4-v1.6.11" = _ssksFxdz;
        "pkg-1.21.5-v1.6.12" = _NWyCUkEG;
        "pkg-1.21.4-v1.6.12" = _r5jJDsMS;
        "pkg-1.21.4-v1.6.13" = _cgM7CHSd;
        "pkg-1.21.5-v1.6.13" = _DCbvLlah;
        "pkg-1.21.4-v1.6.14" = _zkerQMrY;
        "pkg-1.21.1-v1.4.8" = _7lBG5ytv;
        "pkg-1.21.4-v1.6.15" = _x2esCtRa;
        "pkg-1.21.1-v1.4.9" = _3Ho0rztK;
        "pkg-1.21.4-v1.6.16" = _wupq7nNv;
        "pkg-1.21.4-v1.6.17" = _ykmfzqo4;
        "pkg-1.21.5-v2.0.0" = _XU542W1o;
        "pkg-1.21.5-v2.0.1" = _LJCKOfLz;
        "pkg-1.21.5-v2.0.2" = _XwDlzUSa;
        "pkg-1.21.5-v2.0.3" = _UVSnIWpd;
        "pkg-1.21.5-v2.0.4" = _1tTUljCH;
        "pkg-1.21.5-v2.0.5" = _vqLftkVd;
        "pkg-1.21.5-v2.0.6" = _O2AH2hPw;
        "pkg-1.21.5-v2.1.0" = _Z2JSTbCr;
        "pkg-1.21.5-v2.1.1" = _gm1crCTE;
        "pkg-1.21.5-v2.1.2" = _n66A5yYx;
        "pkg-1.21.5-v2.1.3" = _q4Dm43dB;
        "pkg-1.21.5-v2.1.4" = _K11sbwe3;
        "pkg-1.21.5-v2.1.5" = _j0Bf0C9Y;
        "pkg-1.21.4-v1.6.18" = _7eoWuuog;
        "pkg-1.21.5-v2.1.6" = _oNO3WjSs;
        "pkg-1.21.11-v2.2.0" = _3Mipun5P;
        "pkg-1.21.5-v2.1.7" = _8nVPGweM;
        "pkg-1.21.11-v2.2.1" = _V9B1L6p6;
        "pkg-1.21.4-v1.6.19" = _eocp04oo;
        "pkg-1.21.5-v2.1.8" = _JhpIRapT;
        "pkg-1.21.11-v2.2.2" = _QYmjM7ba;
        "pkg-1.21.11-v2.2.3" = _hz3NhgtU;
        "pkg-1.21.11-v2.2.4" = _5OT3NtQJ;
        "pkg-1.21.11-v2.2.5" = _qv0kD17L;
        "pkg-1.21.11-v2.2.6" = _2xlOWYnm;
        "pkg-1.21.11-v2.2.7" = _Ep9DZx8N;
        "pkg-1.21.11-v2.2.8" = _8iRHAqhL;
        "pkg-1.21.11-v2.2.9" = _NuqxcY0x;
        "pkg-1.21.11-v2.2.10" = _GkXWWStz;
        "pkg-1.21.11-v2.2.11" = _DOgFCvh8;
        "pkg-1.21.11-v2.2.12" = _1adALLqm;
        "pkg-1.21.11-v2.2.13" = _KghrxMTq;
        "pkg-1.21.11-v2.2.14" = _3vDhHZXL;
        "pkg-1.21.11-v2.2.15" = _6RqJwQxn;
        "pkg-1.21.11-v2.2.16" = _wcrhZOt1;
        "pkg-1.21.11-v2.2.17" = _z4n8IBKY;
        "pkg-1.21.11-v2.2.18" = _yce5v6aZ;
        "pkg-1.21.11-v2.2.19" = _S2Eu1sM1;
        "pkg-1.21.11-v2.2.20" = _YrKdTlrt;
        "pkg-1.21.11-v2.2.21" = _y8IzLyuu;
        "pkg-1.21.11-v2.2.22" = _GNNTDAtX;
        "pkg-1.21.11-v2.2.23" = _dSNCaLRG;
        "pkg-1.21.11-v2.2.24" = _5qMidzXs;
        "pkg-1.21.11-v2.2.25" = _spPsXubz;
        "pkg-1.21.11-v2.2.26" = _NbPizEjQ;
        "pkg-1.21.11-v2.2.27" = _b0rdpADk;
        "pkg-26.1-r1.0-neoforge" = _DhKBnpmo;
        "pkg-26.1-r1.0-fabric" = _vCG9e2ur;
        "pkg-26.1-r1.1-neoforge" = _Dx2Wa2LK;
        "pkg-26.1-r1.1-fabric" = _tXz4PRJ9;
        "pkg-1.21.11-v2.2.28" = _AdFLY5Mh;
        "pkg-26.1-r1.2-neoforge" = _5TNz29OC;
        "pkg-26.1-r1.2-fabric" = _ZVhJjtW9;
        "pkg-26.1-r1.3-neoforge" = _fX1HiBqW;
        "pkg-26.1-r1.3-fabric" = _h0z6DRXf;
        "pkg-26.1-r1.3.1-neoforge" = _8mFgl0xu;
        "pkg-26.1-r1.3.1-fabric" = _9WERx9ik;
        "pkg-26.1-r1.3.2-neoforge" = _ZEHqYrMm;
        "pkg-26.1-r1.4-neoforge" = _wR06OTHB;
        "pkg-26.1-r1.4-fabric" = _Y6Hjx4Xk;
        "pkg-26.1-r1.6-neoforge" = _rDSS95jL;
        "pkg-26.1-r1.6-fabric" = _O9zkKnyy;
        "pkg-26.1-r1.7-neoforge" = _aRoEHPFh;
        "pkg-26.1-r1.7-fabric" = _4SDcUkGu;
        "pkg-26.1-r1.8-neoforge" = _bDhtKBPf;
        "pkg-26.1-r1.8-fabric" = _zmT5tVzM;
        "pkg-26.1-r1.9-neoforge" = _MPn8uTr8;
        "pkg-26.1-r1.9-fabric" = _asfIzm8v;
        "pkg-26.1-r1.9.1-neoforge" = _DNg6Oz4Q;
