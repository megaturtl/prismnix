...
let
    ...
    in {
        ...
        "pkg-1.18.1-4.0.0" = _MbPPQnks;
        "pkg-1.18.1-4.0.1" = _ogUICJGq;
        "pkg-1.18.2-4.1.0" = _4rF8KUPl;
        "pkg-1.18.2-4.1.1" = _u9xmEMfn;
        "pkg-1.14.4-1.3.3" = _yj0wRWJK;
        "pkg-1.15.2-2.1" = _xamD1Kdk;
        "pkg-1.16.4-2.2.0" = _ZHPDZ6xQ;
        "pkg-1.19-5.0.0" = _7oTqfQLU;
        "pkg-1.19-5.0.1" = _beA2boyk;
        "pkg-1.19-5.0.2" = _YtkorltZ;
        "pkg-1.19-5.0.3" = _hQnueTPO;
        "pkg-1.19.1-5.1.0" = _WYi9XxjY;
        "pkg-1.19.1-5.1.1" = _IeWvrgX5;
        "pkg-1.19.1-5.1.2" = _BtFmoGKo;
        "pkg-1.19.4-5.2.0" = _W1YWgnNo;
        "pkg-1.18.2-4.1.2" = _1NcMKOtU;
        "pkg-1.20.1-6.0.0" = _V2QdQXl0;
