...
let
    ...
    in {
        ...
        "pkg-v0.3" = _JBrsy5py;
        "pkg-overlay2" = _yygo5Kpu;
        "pkg-v0.3.1" = _Jz86QCWg;
        "pkg-v0.3.2" = _geFaHZiL;
        "pkg-v0.3.3" = _sioTXZTb;
        "pkg-v0.3.4" = _3i2G6X0H;
        "pkg-v0.3.5" = _KcHEXJ92;
        "pkg-v0.3.5.legacy" = _P7gLjULO;
        "pkg-v0.3.6" = _Eb1JB9Dp;
        "pkg-v0.3.7" = _X9wA6pOo;
        "pkg-v0.3.7.legacy" = _LkDQJLiH;
        "pkg-v0.3.8.legacy" = _hpVVuryF;
        "pkg-v0.4" = _IHbxzcXY;
        "pkg-v0.5" = _CpuV8hCB;
        "pkg-v0.5.backport" = _AsAdfseq;
        "pkg-v0.5.legacy" = _aZ7ge28S;
        "pkg-v0.6" = _7HwlbHEa;
        "pkg-v0.6.backport" = _KUyO1j4R;
        "pkg-v0.6.legacy" = _qFBiTj1w;
        "pkg-v0.6.1" = _ePaTwe1x;
        "pkg-v0.6.1.backport" = _DmAO03kx;
        "pkg-v0.6.1.legacy" = _YcIvw5sR;
        "pkg-v0.7" = _nXPmkHRb;
        "pkg-v0.7.legacy" = _NKSipZSx;
        "pkg-v0.8" = _vpop0NqY;
        "pkg-v0.8.5" = _n1tRAuJS;
        "pkg-v0.8.5.legacy" = _Y2W9ktUC;
        "pkg-v0.8.6" = _Nri9Lr8U;
        "pkg-v0.9" = _Re73jIgP;
        "pkg-v0.9.1" = _8IOueHT3;
        "pkg-v0.9.5" = _jRWPYMnK;
        "pkg-v0.9.5.legacy" = _j9OKzsEj;
        "pkg-v0.9.6" = _8DTLGGlm;
        "pkg-v0.9.7" = _mreCyKU6;
        "pkg-v0.9.8" = _MVrouA6t;
        "pkg-v0.9.9" = _4oUt0FPk;
        "pkg-v0.10" = _d2U88etG;
        "pkg-v0.11" = _foL63b93;
        "pkg-v0.12" = _krI58ahy;
