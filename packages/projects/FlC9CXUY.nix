...
let
    ...
    in {
        ...
        "pkg-1.0.0-beta.4+1.19" = _dsHcHPzJ;
        "pkg-1.0.0-beta.5+1.19" = _N8GMSMs1;
        "pkg-1.0.0-beta.6+1.19" = _88C4a37R;
        "pkg-1.0.0-beta.7+1.19" = _3KEqcCcf;
        "pkg-1.0.0+1.19" = _yQ3Wz7rC;
        "pkg-1.0.0+1.19.3" = _ren4gTE0;
        "pkg-1.0.0+1.19.4" = _zBKani6P;
        "pkg-1.0.1+1.19" = _JmiLr4xV;
        "pkg-1.0.1+1.19.3" = _dFLUuNqj;
        "pkg-1.0.1+1.19.4" = _Kwduvb0c;
        "pkg-1.0.2+1.19" = _Ep3Jsoy3;
        "pkg-1.0.2+1.19.3" = _qtAPS8ku;
        "pkg-1.0.2+1.19.4" = _95BiwzBG;
        "pkg-1.1.0+1.19.4" = _DRb1NEBD;
        "pkg-1.1.1+1.19.4" = _pXvB1Mk2;
        "pkg-1.1.2+1.19.4" = _XtlomfC9;
        "pkg-1.2.0+1.20" = _4z14pAd3;
        "pkg-1.2.1+1.20" = _4rejVINk;
        "pkg-1.3.0+1.20.2" = _NvS2dByb;
        "pkg-1.3.1+1.20.2" = _PndEnyFT;
        "pkg-1.4.0" = _yxFggQ2y;
        "pkg-2.0.0+1.20.5" = _etul60MP;
        "pkg-2.0.0+1.21" = _34J7BNTQ;
        "pkg-2.0.0+1.21.2" = _L4Iqpl0U;
        "pkg-2.0.1+1.20.5" = _MFOq6Sci;
        "pkg-2.0.1+1.21" = _hQxnJV9J;
        "pkg-2.0.1+1.21.2" = _ywyjeMrW;
        "pkg-2.1.0+1.21.5" = _EuQYQDQN;
        "pkg-2.1.1+1.21.5" = _TYPpgFsB;
        "pkg-2.2.0+1.20.5" = _4EbS0llF;
        "pkg-2.2.0+1.21" = _riPEE0er;
        "pkg-2.2.0+1.21.2" = _9md5VMAC;
        "pkg-2.2.0+1.21.5" = _wFPN3WGL;
        "pkg-2.2.0+1.21.6" = _MYUunFXI;
        "pkg-2.2.0+1.21.9" = _1URJ6DyU;
        "pkg-2.2.1+1.21.9" = _shs3D2VQ;
        "pkg-2.2.2+1.21.9" = _s665htb8;
        "pkg-2.2.3+1.21.9" = _pTpZ1Otj;
        "pkg-2.2.3+1.21.11" = _aUYzOWkd;
        "pkg-2.2.4+1.21.11" = _U9r3Y3TK;
        "pkg-2.4.0+26.1" = _yPXSngyq;
        "pkg-2.4.1+26.1" = _W3Tvolvh;
        "pkg-2.4.2+26.1" = _15UOKOFF;
        "pkg-3.0.0+26.1-forge" = _msIJAVuE;
        "pkg-3.0.0+26.1-neoforge" = _lb6spXZS;
        "pkg-3.0.0+26.1-fabric" = _6qehegcw;
        "pkg-3.0.1+26.1-forge" = _Br1hWNin;
        "pkg-3.0.1+26.1-neoforge" = _RU3twGWp;
        "pkg-3.0.1+26.1-fabric" = _k2RZ3Ujc;
        "pkg-3.0.2+26.1-forge" = _T7HKpSiq;
        "pkg-3.0.2+26.1-neoforge" = _7lQ4Lkgs;
        "pkg-3.0.2+26.1-fabric" = _A3MTg45y;
        "pkg-3.0.3+26.1-forge" = _h0WVIYqq;
        "pkg-3.0.3+26.1-neoforge" = _P4AL5k0m;
        "pkg-3.0.3+26.1-fabric" = _3UeBYj6O;
        "pkg-3.0.4+26.1-forge" = _gXBgebGo;
        "pkg-3.0.4+26.1-neoforge" = _XeVG2GLJ;
        "pkg-3.0.4+26.1-fabric" = _ctFnRns4;
