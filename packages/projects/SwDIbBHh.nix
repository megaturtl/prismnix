...
let
    ...
    in {
        ...
        "pkg-1.18.2-11.3.1" = _LQQJAPgf;
        "pkg-1.19.2-11.3.1" = _w89e5pSc;
        "pkg-1.20.1-11.3.0" = _zu0DBIHW;
        "pkg-1.20.2-12.0.0" = _z6tlL45D;
        "pkg-1.20.2-12.0.1" = _T281fJ3H;
        "pkg-1.20.2-12.0.2" = _2D5LChuv;
        "pkg-1.20.2-12.1.0" = _l6n8FlrU;
        "pkg-1.20.2-12.1.1" = _MmImiX0A;
        "pkg-1.20.1-11.3.1" = _2QsPlfc6;
        "pkg-1.19.2-11.3.2" = _HwvzwaWG;
        "pkg-1.19.2-11.4.0" = _VraOFhG9;
        "pkg-1.20.1-11.4.0" = _kH8uCZt6;
        "pkg-1.20.2-12.2.0" = _YyrkWQeq;
        "pkg-1.20.2-12.2.1" = _wQroKYve;
        "pkg-1.20.1-11.4.1" = _iE48bNdH;
        "pkg-1.20.2-13.0.0" = _LZoKtBpA;
        "pkg-1.20.2-13.1.0" = _4NA7H5eD;
        "pkg-1.20.2-13.2.0" = _nYzzsJUI;
        "pkg-1.20.2-13.2.1" = _rbWc2MUG;
        "pkg-1.20.4-14.0.0" = _8oxhgo3k;
        "pkg-1.20.4-14.0.1" = _KL8lc4OZ;
        "pkg-1.20.4-14.0.2" = _H8KNLSq6;
        "pkg-1.20.4-14.1.0" = _oGyObp2U;
        "pkg-1.20.1-11.5.0" = _BgwWFHKt;
        "pkg-1.19.2-11.5.0" = _xl83ragh;
        "pkg-1.19.2-11.5.1" = _q3jyC8nV;
        "pkg-1.20.4-15.0.0" = _QDZmsLiX;
        "pkg-1.20.4-15.0.1" = _I8uRK4Zt;
        "pkg-1.20.4-15.1.0" = _LHnLkhrS;
        "pkg-1.20.4-15.2.0" = _98UgMZwp;
        "pkg-1.20.1-11.6.0" = _g4WQspwz;
        "pkg-1.20.4-15.3.0" = _oBhaIMrf;
        "pkg-1.20.1-11.6.1" = _cs0DeA47;
        "pkg-1.20.4-15.4.0" = _R7zcZ7d1;
        "pkg-1.20.4-15.5.0" = _4GE0wtCO;
        "pkg-1.20.1-11.7.0" = _4m6ZVedG;
        "pkg-1.20.4-15.6.0" = _2kRJ4vlS;
        "pkg-1.20.4-15.6.1" = _9jdm6n2Y;
        "pkg-1.20.1-11.7.1" = _aa3aMSqt;
        "pkg-1.20.4-15.6.2" = _o8ohb3iw;
        "pkg-1.20.1-11.7.2" = _8nN0F39u;
        "pkg-1.20.4-15.6.3" = _cs2WolBJ;
        "pkg-1.20.4-15.7.0" = _6LhO81i9;
        "pkg-1.20.1-11.7.3" = _ightApf8;
        "pkg-1.20.4-15.7.1" = _Sme5eAwL;
        "pkg-1.20.4-15.7.2" = _kOErbevh;
        "pkg-1.20.5-16.0.0" = _1Z3BGkpv;
        "pkg-1.20.6-17.0.0" = _vsDAYOSi;
        "pkg-1.20.6-17.1.0" = _HsyJK7dA;
        "pkg-1.20.1-11.8.0" = _nqqQVO6m;
        "pkg-1.20.6-17.2.0" = _Ixs6gUGe;
        "pkg-1.20.1-11.9.0" = _3yTj5Yl7;
        "pkg-1.20.6-17.3.0" = _fYikzYlw;
        "pkg-1.20.1-11.9.1" = _PEha35u7;
        "pkg-1.20.6-17.4.0" = _yzZ52jsC;
        "pkg-1.20.1-11.9.2" = _odLZ8zwC;
        "pkg-1.20.6-17.4.1" = _vIr5cZxI;
        "pkg-1.20.1-11.9.3" = _1hwV1DlO;
        "pkg-1.20.6-17.4.2" = _1K0JFtvC;
        "pkg-1.20.1-11.10.0" = _CZaQRZpJ;
        "pkg-1.20.6-17.5.0" = _yM3eccQe;
        "pkg-1.20.1-11.11.0" = _ljmY2G0S;
        "pkg-1.20.6-17.6.0" = _6GxyskhE;
        "pkg-1.20.1-11.12.0" = _PRejidrP;
        "pkg-1.20.6-17.7.0" = _XuDAGC1l;
        "pkg-1.21-18.0.0" = _vt3uzakk;
        "pkg-1.21-18.0.1" = _adVyyPou;
        "pkg-1.21-18.1.0" = _wuuvh4ic;
        "pkg-1.21-18.2.0" = _jqR61Cvy;
        "pkg-1.21-18.3.0" = _qQHIGDXQ;
        "pkg-1.21-18.4.0" = _zyBT8Jnv;
        "pkg-1.21-18.5.0" = _NyauYFk0;
        "pkg-1.21-19.0.0" = _ZCOR5wds;
        "pkg-1.21-19.1.0" = _P0ThI2yU;
        "pkg-1.21-19.2.0" = _dkqU7CEw;
        "pkg-1.20.1-11.12.1" = _dhJeZn2Q;
        "pkg-1.21-19.2.1" = _jSFdKJtu;
        "pkg-1.21-19.3.0" = _aTGQ1nMd;
        "pkg-1.20.1-11.12.2" = _aJ5XEdD4;
        "pkg-1.21.1-20.0.0" = _htIHwiuf;
        "pkg-1.21.1-20.0.1" = _WwGIAt8q;
        "pkg-1.20.1-11.13.0" = _QB67A0ck;
        "pkg-1.21.1-20.1.0" = _c2cIC2cp;
        "pkg-1.20.1-11.13.1" = _1iZP5ANY;
        "pkg-1.21.1-20.1.1" = _kQ6GSEt4;
        "pkg-1.21.1-20.2.0" = _q7kQaQGN;
        "pkg-1.21.1-20.3.0" = _j0heB25C;
        "pkg-1.21.2-21.0.0" = _XSUzDNAj;
        "pkg-1.21.3-21.0.0" = _tvuOTV2h;
        "pkg-1.21.3-21.1.0" = _rzcmRtlP;
        "pkg-1.21.3-21.2.0" = _KoHLU54r;
        "pkg-1.21.3-21.3.0" = _4tm8KiqI;
        "pkg-1.21.1-20.2.1" = _kHKQ7vft;
        "pkg-1.21.3-21.3.1" = _sIY6B7xF;
        "pkg-1.21.4-22.0.0" = _qyshMNHz;
        "pkg-1.21.4-22.1.0" = _1JpbXIjj;
        "pkg-1.21.4-22.2.0" = _Z3f2hsmR;
        "pkg-1.21.1-20.3.1" = _u34AupIl;
        "pkg-1.21.4-22.4.0" = _RVvNn25e;
        "pkg-1.21.4-22.5.0" = _Fsn8KHzt;
        "pkg-1.21.4-22.6.0" = _zUM2Lw0V;
        "pkg-1.19.2-11.6.0" = _tzcrsKzv;
        "pkg-1.20.1-11.14.0" = _sZJ5MRSE;
        "pkg-1.21.1-20.4.0" = _l96IdvRs;
        "pkg-1.21.4-22.7.0" = _Fc5rh91x;
        "pkg-1.21.4-22.8.0" = _zTbbPyXH;
        "pkg-1.20.1-11.14.1" = _FO6rVPRR;
        "pkg-1.21.1-20.4.1" = _LwtKuqz9;
        "pkg-1.21.4-22.8.1" = _2jJnbJCh;
        "pkg-1.21.5-23.0.0" = _YpHuFlJF;
        "pkg-1.21.1-20.4.2" = _M6Np2CSy;
        "pkg-1.21.5-23.0.1" = _gw86dLVP;
        "pkg-1.21.1-20.5.0" = _ar49XKjF;
        "pkg-1.21.5-23.1.0" = _MYNyNnKX;
        "pkg-1.20.1-11.14.2" = _Uo8jSybq;
        "pkg-1.21.1-20.6.0" = _UsYQW4FE;
        "pkg-1.21.5-23.2.0" = _eyjaeGPI;
        "pkg-1.20.1-11.15.0" = _3bAZgZUh;
        "pkg-1.20.1-11.16.0" = _zurs3Myk;
        "pkg-1.21.5-23.3.0" = _ngiC15HR;
        "pkg-1.20.1-11.17.0" = _DhBkJtuo;
        "pkg-1.21.5-23.4.0" = _bfYMMyMq;
        "pkg-1.21.6-23.0.0" = _s7ngy64z;
        "pkg-1.21.6-24.0.1" = _s62bFmas;
        "pkg-1.21.7-25.0.0" = _ThRFUTLU;
        "pkg-1.21.1-20.7.0" = _PaDt3Rke;
        "pkg-1.21.7-25.0.1" = _PELsN3Of;
        "pkg-1.21.7-25.0.2" = _d0Nvh4MP;
        "pkg-1.21.8-26.0.0" = _XXWrJtLm;
        "pkg-1.21.1-20.7.1" = _3OwqDNxC;
        "pkg-1.21.8-26.0.1" = _yvbDTYGg;
        "pkg-1.21.1-20.8.0" = _gwrIxTkZ;
        "pkg-1.21.8-26.1.0" = _w90V5Jp1;
        "pkg-1.21.8-26.2.0" = _AV6zXvzf;
        "pkg-1.21.8-26.3.0" = _96wo2TSJ;
        "pkg-1.21.1-20.9.0" = _NkMU9FOJ;
        "pkg-1.21.9-27.0.0" = _sNDb1yhX;
        "pkg-1.20.1-11.17.1" = _1UcKN8Qz;
        "pkg-1.21.11-29.0.0" = _4bCj4Cn3;
        "pkg-1.21.11-29.1.0" = _g6BJirxL;
        "pkg-1.21.11-29.2.0" = _YUEEwjcg;
        "pkg-1.21.11-29.3.0" = _iHtytXLa;
        "pkg-1.21.11-29.4.0" = _qLBBqh5R;
        "pkg-26.1-snapshot-1-30.0.0" = _s83U6kHm;
        "pkg-1.21.1-20.10.0" = _V1TBVqvO;
        "pkg-1.21.11-29.5.0" = _nexB8ywc;
        "pkg-26.1-snapshot-1-30.1.0" = _v2durQlQ;
        "pkg-26.1-snapshot-1-30.2.0" = _tyfHUAQd;
        "pkg-1.21.1-20.11.0" = _6nsfsmou;
        "pkg-1.21.11-29.6.0" = _wgNeLCyh;
        "pkg-1.21.11-29.7.0" = _hJ3wpDJ5;
        "pkg-26.1-snapshot-30.3.0" = _i7tmnYiR;
        "pkg-1.21.11-29.8.0" = _UWPEUbFY;
        "pkg-1.21.1-20.12.0" = _cO0S9xLN;
        "pkg-1.21.11-29.8.1" = _9pMMcm4V;
        "pkg-26.1-snapshot-30.4.0" = _ujL9LC8h;
        "pkg-1.21.1-20.13.0" = _S9MMD3QX;
        "pkg-1.21.11-29.9.0" = _2OtOw000;
        "pkg-26.1-31.0.0" = _MZYzDbao;
        "pkg-26.1.2-32.0.0" = _2gVfslKH;
        "pkg-26.1.2-32.1.0" = _SFH2vNUi;
        "pkg-26.1.2-32.2.0" = _XhJwLfNN;
        "pkg-26.1.2-32.3.0" = _dHuhZVUL;
        "pkg-1.21.1-20.14.0" = _ynFyltq0;
        "pkg-26.1.2-32.4.0" = _7hasVyvS;
        "pkg-26.1.2-32.5.0" = _p8Vmg2wj;
        "pkg-1.21.1-20.15.0" = _VvoyQIgL;
        "pkg-26.1.2-32.6.0" = _nZj3t9jh;
        "pkg-1.21.1-20.16.0" = _lOvKldtN;
        "pkg-26.1.2-32.7.0" = _qUND1cnX;
        "pkg-1.21.1-20.17.0" = _25Q2pHBc;
        "pkg-26.1.2-32.8.0" = _jsJbhDE7;
        "pkg-1.21.1-20.18.0" = _inILoOaQ;
        "pkg-26.1.2-32.9.0" = _AoFsLGEQ;
        "pkg-26.1.2-33.0.0" = _IHTXrMJe;
        "pkg-1.21.1-20.19.0" = _XFOczWyO;
        "pkg-26.1.2-33.1.0" = _emCu3hIY;
        "pkg-26.2-34.0.0" = _8Km3gIDJ;
        "pkg-26.2-34.1.0" = _ojWYCCn8;
        "pkg-26.1.2-33.2.0" = _J99aSt3n;
        "pkg-26.2-34.2.0" = _iNstAOBL;
        "pkg-26.1.2-33.3.0" = _ZcK4MGJA;
        "pkg-26.2-34.3.0" = _hvnNgiI7;
        "pkg-1.21.1-20.20.0" = _is6DLEoH;
        "pkg-26.1.2-33.4.0" = _WsxoOWTa;
        "pkg-26.2-34.4.0" = _A9PJM3y5;
        "pkg-1.21.1-20.21.0" = _c2kgUnGI;
        "pkg-26.1.2-33.5.0" = _8AvNxQ37;
        "pkg-26.2-34.5.0" = _o1f7F0Mz;
        "pkg-1.21.1-20.22.0" = _R9JZfTWs;
        "pkg-26.1.2-33.6.0" = _7EYg36R6;
        "pkg-26.2-34.6.0" = _e0UVj1CV;
        "pkg-26.2-34.7.0" = _OZZC1tZD;
        "pkg-26.1.2-33.7.0" = _C7Lq7Tk0;
        "pkg-26.2-34.9.0" = _yvLZBRbC;
        "pkg-1.21.1-20.23.0" = _SsYyCOGa;
