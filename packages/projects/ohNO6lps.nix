...
let
    ...
    in {
        ...
        "pkg-4.2.7" = _fI5AsaV4;
        "pkg-4.2.9" = _CkM0mGHX;
        "pkg-v5.0.0-1.19.3-Fabric" = _H1LkHOeQ;
        "pkg-v5.0.1-1.19.3-Fabric" = _hRGdglV6;
        "pkg-v5.0.2-1.19.3-Fabric" = _FtpEL8G9;
        "pkg-v5.0.3-1.19.3-Fabric" = _tlNCwMwZ;
        "pkg-v5.0.4-1.19.3-Fabric" = _sJryrwj9;
        "pkg-4.2.10" = _tqRbIeBK;
        "pkg-v5.0.5-1.19.3-Fabric" = _bh0uyJuX;
        "pkg-v5.0.6-1.19.3-Fabric" = _alqrny5V;
        "pkg-v5.0.7-1.19.3-Fabric" = _cjmImt9R;
        "pkg-v5.0.9-1.19.3-Fabric" = _6J0K7FyD;
        "pkg-4.2.11" = _3VCgXZ79;
        "pkg-v5.0.10-1.19.3-Fabric" = _TFLCxTVc;
        "pkg-v6.0.0-1.19.4-Fabric" = _mFoJ8qnh;
        "pkg-v6.0.1-1.19.4-Fabric" = _ou26o2qg;
        "pkg-v5.0.11-1.19.3-Fabric" = _MkqOn4Yc;
        "pkg-v6.0.2-1.19.4-Fabric" = _2TybfFU8;
        "pkg-v7.0.0-1.20-Fabric" = _ewYccCIi;
        "pkg-v8.0.0-1.20.1-Fabric" = _CtENDTlF;
        "pkg-v9.0.0-1.20.2-Fabric" = _f5d9VI72;
        "pkg-v9.1.0-1.20.2-Fabric" = _52l6IXEd;
        "pkg-v9.1.1-1.20.2-Fabric" = _14GbpcF7;
        "pkg-v9.1.2-1.20.2-Fabric" = _lQ2BNzNV;
        "pkg-v20.4.0-1.20.4-Fabric" = _jygSIEk6;
        "pkg-v20.4.1-1.20.4-Fabric" = _y5ADtIQp;
        "pkg-v20.4.1-1.20.4-Forge" = _hSymtRZz;
        "pkg-v20.4.1-1.20.4-NeoForge" = _8ZEqzvgl;
        "pkg-v20.2.4-1.20.2-Fabric" = _aQOysw5j;
        "pkg-v20.2.4-1.20.2-Forge" = _d4o2DIW4;
        "pkg-v20.2.4-1.20.2-NeoForge" = _RRZz6X5Y;
        "pkg-v20.2.5-1.20.2-Fabric" = _uVasUkyz;
        "pkg-v20.2.5-1.20.2-Forge" = _WjsrL3PB;
        "pkg-v20.2.5-1.20.2-NeoForge" = _REA2Y3hn;
        "pkg-v20.4.2-1.20.4-Fabric" = _IS7wNJuv;
        "pkg-v20.4.2-1.20.4-Forge" = _P3GfPe5a;
        "pkg-v20.4.2-1.20.4-NeoForge" = _Uc2L9JYx;
        "pkg-v20.2.6-1.20.2-Fabric" = _sK1XwxTt;
        "pkg-v20.2.6-1.20.2-NeoForge" = _1bZs84f5;
        "pkg-v20.2.6-1.20.2-Forge" = _r8gESJiS;
        "pkg-v20.4.3-1.20.4-Fabric" = _xbVGsTLe;
        "pkg-v20.4.3-1.20.4-Forge" = _cPR7Hb0e;
        "pkg-v20.4.3-1.20.4-NeoForge" = _izawYWhx;
        "pkg-v20.6.0-1.20.6-Fabric" = _MuoYnIrW;
        "pkg-v20.6.0-1.20.6-NeoForge" = _s4eBrY4J;
        "pkg-v20.6.0-1.20.6-Forge" = _6b78kro0;
        "pkg-v20.6.1-1.20.6-Fabric" = _LDpciQaD;
        "pkg-v20.6.1-1.20.6-Forge" = _Xm6O1nBK;
        "pkg-v20.6.1-1.20.6-NeoForge" = _3CoAOP6V;
        "pkg-v21.0.0-1.21-Fabric" = _lB4p4JnZ;
        "pkg-v21.0.0-1.21-NeoForge" = _d4Qud7sf;
        "pkg-v21.0.1-1.21-Fabric" = _6ftTLYo0;
        "pkg-v21.0.1-1.21-Forge" = _wMoOojVd;
        "pkg-v21.0.1-1.21-NeoForge" = _2z1n7Pal;
        "pkg-v21.0.2-1.21-Fabric" = _YsY7k4Pu;
        "pkg-v21.0.2-1.21-Forge" = _7HZj0EzA;
        "pkg-v21.0.2-1.21-NeoForge" = _sg4l7fSX;
        "pkg-v21.0.3-1.21-Fabric" = _JGO1znQN;
        "pkg-v21.0.3-1.21-Forge" = _BUhcggUR;
        "pkg-v21.0.3-1.21-NeoForge" = _h919yvVV;
        "pkg-v21.0.4-1.21-Fabric" = _ArqXhVnP;
        "pkg-v21.0.4-1.21-Forge" = _SaPUeEYL;
        "pkg-v21.0.4-1.21-NeoForge" = _wYilHKuK;
        "pkg-v21.0.5-1.21-Fabric" = _e8y2gnx1;
        "pkg-v21.0.5-1.21-Forge" = _mCucKtTS;
        "pkg-v21.0.5-1.21-NeoForge" = _wx8Ha8eB;
        "pkg-v21.0.6-1.21-Fabric" = _BNTJgetj;
        "pkg-v21.0.6-1.21-Forge" = _ydIrnr9Q;
        "pkg-v21.0.6-1.21-NeoForge" = _Y2gd8YHL;
        "pkg-v21.0.7-1.21-Fabric" = _UGsNw3aI;
        "pkg-v21.0.7-1.21-Forge" = _QTVwgKKS;
        "pkg-v21.0.7-1.21-NeoForge" = _FRzdKdgh;
        "pkg-v21.0.8-1.21-Fabric" = _GOreNSW6;
        "pkg-v21.0.8-1.21-Forge" = _6k3FSGda;
        "pkg-v21.0.8-1.21-NeoForge" = _bnhVDSAh;
        "pkg-v21.1.0-1.21.1-Fabric" = _gtorYSGm;
        "pkg-v21.1.0-1.21.1-Forge" = _6x66hBcK;
        "pkg-v21.1.0-1.21.1-NeoForge" = _POOzpdre;
        "pkg-v21.1.1-1.21.1-Fabric" = _ZlbHFjxE;
        "pkg-v21.1.1-1.21.1-Forge" = _gBWcBo4D;
        "pkg-v21.1.1-1.21.1-NeoForge" = _IQXTIhtY;
        "pkg-v21.3.0-1.21.3-Fabric" = _4cCcvv3n;
        "pkg-v21.3.0-1.21.3-NeoForge" = _jaexLZJz;
        "pkg-v21.3.1-1.21.3-Fabric" = _DsrEE2v9;
        "pkg-v21.3.1-1.21.3-Forge" = _FBQxdgNw;
        "pkg-v21.3.1-1.21.3-NeoForge" = _Bceb719b;
        "pkg-v8.0.1-1.20.1-Fabric" = _Qs8LaZLo;
        "pkg-v21.1.2-1.21.1-Fabric" = _h0NwCvfv;
        "pkg-v21.1.2-1.21.1-Forge" = _Y8MID0SX;
        "pkg-v21.1.2-1.21.1-NeoForge" = _XAJonlKw;
        "pkg-v21.3.2-1.21.3-Fabric" = _rfzwvtf5;
        "pkg-v21.3.2-1.21.3-Forge" = _zKyu1B19;
        "pkg-v21.3.2-1.21.3-NeoForge" = _5nR6ZFLo;
        "pkg-v21.4.0-1.21.4-Fabric" = _U3jo8Ruz;
        "pkg-v21.4.0-1.21.4-NeoForge" = _U5epFr4M;
        "pkg-v21.1.3-1.21.1-Fabric" = _NqVx7ywO;
        "pkg-v21.1.3-1.21.1-Forge" = _D4gwaaOI;
        "pkg-v21.1.3-1.21.1-NeoForge" = _iigguueA;
        "pkg-v21.3.3-1.21.3-Fabric" = _DmvpqvAw;
        "pkg-v21.3.3-1.21.3-Forge" = _yDl5szfw;
        "pkg-v21.3.3-1.21.3-NeoForge" = _WxNuOsdE;
        "pkg-v21.4.1-1.21.4-Fabric" = _lTrPTmMK;
        "pkg-v21.4.1-1.21.4-Forge" = _F95iyzlf;
        "pkg-v21.4.1-1.21.4-NeoForge" = _cLjwgrWm;
        "pkg-v8.0.2-1.20.1-Fabric" = _1aKtMQZE;
        "pkg-v21.5.0-1.21.5-Fabric" = _30kzHRCp;
        "pkg-v21.5.0-1.21.5-NeoForge" = _DTvWt6rh;
        "pkg-v21.5.1-1.21.5-Fabric" = _mlQdrgSO;
        "pkg-v21.5.1-1.21.5-Forge" = _8YH0O6BJ;
        "pkg-v21.5.1-1.21.5-NeoForge" = _AqDXmnNa;
        "pkg-v21.6.1-1.21.6-Fabric" = _gE44ObxJ;
        "pkg-v21.6.1-1.21.6-NeoForge" = _VRGX0o6a;
        "pkg-v21.6.2-1.21.6-Fabric" = _j5wHs7oN;
        "pkg-v21.6.2-1.21.6-Forge" = _BSlIu4E8;
        "pkg-v21.6.2-1.21.6-NeoForge" = _HSXjKtq5;
        "pkg-v21.6.3-1.21.6-Fabric" = _QI0ND783;
        "pkg-v21.6.3-1.21.6-Forge" = _cAsXnHFu;
        "pkg-v21.6.3-1.21.6-NeoForge" = _TxZ7R5yI;
        "pkg-v21.6.4-1.21.6-Fabric" = _9IqKMm2N;
        "pkg-v21.6.4-1.21.6-Forge" = _PXhPk6km;
        "pkg-v21.6.4-1.21.6-NeoForge" = _h2CL8Htn;
        "pkg-v21.7.0-1.21.7-Fabric" = _mw50luix;
        "pkg-v21.7.0-1.21.7-Forge" = _HuvzoLrt;
        "pkg-v21.7.0-1.21.7-NeoForge" = _s4PrhEe2;
        "pkg-v21.8.0-1.21.8-Fabric" = _Bogviccn;
        "pkg-v21.8.0-1.21.8-Forge" = _ZtH2wuWK;
        "pkg-v21.8.0-1.21.8-NeoForge" = _46MsaoOY;
        "pkg-v21.1.4-1.21.1-Fabric" = _NZACeAT3;
        "pkg-v21.1.4-1.21.1-Forge" = _2PaXv1wf;
        "pkg-v21.1.4-1.21.1-NeoForge" = _e5mORIZw;
        "pkg-v21.3.4-1.21.3-Fabric" = _oOGtBSNs;
        "pkg-v21.3.4-1.21.3-Forge" = _vgbmECKt;
        "pkg-v21.3.4-1.21.3-NeoForge" = _v9l4kLnl;
        "pkg-v21.4.2-1.21.4-Fabric" = _rqzLy7TJ;
        "pkg-v21.4.2-1.21.4-Forge" = _nRwjEzXR;
        "pkg-v21.4.2-1.21.4-NeoForge" = _8fO3mzdN;
        "pkg-v21.8.1-1.21.8-Fabric" = _daREdLQt;
        "pkg-v21.8.1-1.21.8-Forge" = _Q3tzFBIy;
        "pkg-v21.8.1-1.21.8-NeoForge" = _PyaPneYT;
        "pkg-21.9.6" = _CyJvZ4QW;
        "pkg-21.9.7" = _xSFUjnSg;
        "pkg-21.9.8" = _ai3HpFzP;
        "pkg-21.10.0" = _6T4w46C9;
        "pkg-v21.1.5-1.21.1-Fabric" = _2cs5LG0X;
        "pkg-v21.1.5-1.21.1-Forge" = _eqEdcFql;
        "pkg-v21.1.5-1.21.1-NeoForge" = _BKk5o9MZ;
        "pkg-v21.1.6-1.21.1-Fabric" = _N5qzq0XV;
        "pkg-v21.1.6-1.21.1-Forge" = _uz2Elwpw;
        "pkg-v21.1.6-1.21.1-NeoForge" = _tWlsPKJI;
        "pkg-v21.3.5-1.21.3-Fabric" = _NYPJWyPs;
        "pkg-v21.3.5-1.21.3-Forge" = _c1DmZUaK;
        "pkg-v21.3.5-1.21.3-NeoForge" = _7sEgtpvv;
        "pkg-v21.4.3-1.21.4-Fabric" = _SSKF75hc;
        "pkg-v21.4.3-1.21.4-Forge" = _ww1LCRM3;
        "pkg-v21.4.3-1.21.4-NeoForge" = _DjGnsAnc;
        "pkg-v21.5.3-1.21.5-Fabric" = _fWnEuNPu;
        "pkg-v21.5.3-1.21.5-Forge" = _UQTsO2qw;
        "pkg-v21.8.2-1.21.8-Fabric" = _YbUUjWdw;
        "pkg-v21.5.3-1.21.5-NeoForge" = _b16GHACu;
        "pkg-v21.8.2-1.21.8-Forge" = _AaLdFnEV;
        "pkg-v21.8.2-1.21.8-NeoForge" = _8fRnfUMz;
        "pkg-21.10.1" = _IKHTwwTv;
        "pkg-v8.0.3-1.20.1-Fabric" = _HvR3IdRE;
        "pkg-21.11.0" = _Idk1R3dD;
        "pkg-21.11.1" = _uXrWPsCu;
        "pkg-26.1.0.0" = _G9ZxeMEb;
        "pkg-26.1.0.1" = _vWPACd6w;
        "pkg-26.1.0.2" = _J2q1Fj7S;
        "pkg-26.1.3" = _RXbL43Lt;
        "pkg-26.1.4" = _Lnim7AHv;
