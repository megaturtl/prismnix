...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.4.6-forge" = _R4gRfXad;
        "pkg-1.16.5-2.4.7-forge" = _bBk7yKLj;
        "pkg-1.16.5-2.4.8-forge" = _3K6dEpnD;
        "pkg-1.16.5-2.4.9-forge" = _NzuI43l9;
        "pkg-1.16.5-2.4.10-forge" = _c5vFDTxk;
        "pkg-1.16.5-2.4.11-forge" = _hHJ6kKvz;
        "pkg-2.5.0+1.16.5" = _QYaxIHyp;
        "pkg-2.5.1+1.16.5" = _Ffg1iBdb;
        "pkg-2.5.2+1.16.5" = _Mhz1m1a1;
        "pkg-2.6.0+1.16.5" = _SobLtAdR;
        "pkg-2.6.1+1.16.5" = _FvWGqXI4;
        "pkg-2.6.2+1.16.5" = _gYGeIzk5;
        "pkg-2.6.3+1.16.5" = _81aeTBEH;
        "pkg-2.6.4+1.16.5" = _3YpEz33e;
        "pkg-2.6.5+1.16.5" = _3qTRcaB7;
        "pkg-3.0.0+1.16.5" = _ce424foJ;
        "pkg-3.1.0+1.16.5" = _5b3fMfRx;
        "pkg-3.1.1+1.16.5" = _mEwsrKJE;
        "pkg-3.1.2+1.16.5" = _9f0g8pSB;
        "pkg-3.1.3+1.16.5" = _B2XuTHKq;
        "pkg-3.2.0+1.16.5" = _ce82waxQ;
        "pkg-3.2.1+1.16.5" = _zWgjhwUG;
        "pkg-4.0.0+1.18.1" = _f5VTrpT1;
        "pkg-4.0.1+1.18.1" = _CjfxtJcA;
        "pkg-4.1.0+1.18.1" = _oGhlgnM9;
        "pkg-4.1.1+1.18.1" = _QW6flru9;
        "pkg-4.2.0+1.18.1" = _ViCfkP2Z;
        "pkg-4.2.1+1.18.1" = _7KsOdk3k;
        "pkg-4.3.0+1.18.1" = _thb1ZKAh;
        "pkg-4.3.1+1.18.1" = _8QtNQLyT;
        "pkg-4.3.2+1.18.1" = _1b4wEVOS;
        "pkg-4.3.3+1.18.1" = _3UXIivib;
        "pkg-4.3.4+1.18.1" = _cN052mRZ;
        "pkg-4.3.5+1.18.1" = _EyQJV0dJ;
        "pkg-4.3.6+1.18.1" = _vZdUFi2H;
        "pkg-5.0.0+1.18.2" = _GQvxpZwS;
        "pkg-5.0.1+1.18.2" = _WUWrErcx;
        "pkg-5.0.2+1.18.2" = _VDx8i1Hf;
        "pkg-5.0.3+1.18.2" = _707U6biJ;
        "pkg-5.0.4+1.18.2" = _WVYJ38aH;
        "pkg-5.0.5+1.18.2" = _ZojMyBUf;
        "pkg-5.0.6+1.18.2" = _9UsH82bo;
        "pkg-5.0.7+1.18.2" = _k8LIxKO1;
        "pkg-5.0.8+1.18.2" = _yZ5l4o8x;
        "pkg-5.0.9+1.18.2" = _EoEaYi8D;
        "pkg-5.0.10+1.18.2" = _AiLX7Pff;
        "pkg-5.0.11+1.18.2" = _GdBibkDK;
        "pkg-5.1.0+1.18.2" = _SUv6UGR9;
        "pkg-5.1.1+1.18.2" = _3aeT1QkA;
        "pkg-5.1.2+1.18.2" = _1s5rBT6B;
        "pkg-6.0.0+1.19" = _9A87RY1m;
        "pkg-6.0.1+1.19" = _sBl7Ai5r;
        "pkg-6.1.0+1.19" = _OfYiRlD4;
        "pkg-6.1.1+1.19" = _XII8Hr9E;
        "pkg-6.1.2+1.19" = _cfLLqYDq;
        "pkg-6.1.3+1.19" = _VGcChA0G;
        "pkg-6.1.4+1.19" = _npxvggLT;
        "pkg-6.1.5+1.19" = _Wvy36dOt;
        "pkg-6.1.6+1.19" = _2Hp3b5ua;
        "pkg-6.1.7+1.19" = _geuZ72VD;
        "pkg-6.1.8+1.19.2" = _hne8WBDp;
        "pkg-6.2.0+1.19.2" = _STck7rB5;
        "pkg-6.2.1+1.19.2" = _jQziK29g;
        "pkg-6.2.2+1.19.2" = _zeTS0zri;
        "pkg-6.2.3+1.19.2" = _OZnTeqS8;
        "pkg-6.2.4+1.19.2" = _2uFGSrWx;
        "pkg-6.2.5+1.19.2" = _kQUqF18h;
        "pkg-6.2.6+1.19.2" = _g5oCm1Ou;
        "pkg-6.2.7+1.19.2" = _dRKm4RR1;
        "pkg-6.2.8+1.19.2" = _kCBbPskm;
        "pkg-6.2.9+1.19.2" = _2LoJEPju;
        "pkg-6.2.10+1.19.2" = _X9vZpjYA;
        "pkg-6.3.0+1.19.2" = _jauXPrYC;
        "pkg-6.3.1+1.19.2" = _JYzdm6jv;
        "pkg-6.3.2+1.19.2" = _FctWtgNo;
        "pkg-6.3.3+1.19.2" = _FaDsMQNa;
        "pkg-6.3.4+1.19.2" = _3kS6mSVu;
        "pkg-6.3.5+1.19.2" = _zKSgBxG3;
        "pkg-6.3.6+1.19.2" = _2PeP9iRC;
        "pkg-6.3.7+1.19.2" = _cylGtl7g;
        "pkg-6.3.8+1.19.2" = _CjGzGw1I;
        "pkg-6.4.0+1.19.2" = _jmijXk29;
        "pkg-6.4.1+1.19.2" = _z1qzLUDQ;
        "pkg-6.4.2+1.19.2" = _2qsotfwO;
        "pkg-6.4.3+1.19.2" = _tGsqPg7s;
        "pkg-6.4.4+1.19.2" = _s7XvA60z;
        "pkg-6.4.5+1.19.2" = _AEu6fzDB;
        "pkg-6.4.6+1.19.2" = _WL9xHxWQ;
        "pkg-6.4.7+1.19.2" = _ofFKTX9n;
        "pkg-6.4.8+1.19.2" = _AWehgg3y;
        "pkg-6.4.9+1.19.2" = _zOgw6oo3;
        "pkg-6.4.10+1.19.3" = _DC2neIB5;
        "pkg-6.6.0+1.19.2" = _RIWRB6to;
        "pkg-6.6.0+1.19.3" = _Wbp6gpwG;
        "pkg-6.6.1+1.19.2" = _MyJpvVlG;
        "pkg-6.6.1+1.19.3" = _9aeUMAcg;
        "pkg-6.6.2+1.19.2" = _aRfgvbIL;
        "pkg-6.6.2+1.19.3" = _qp6nMJMY;
        "pkg-6.6.3+1.19.2" = _sVMNok8V;
        "pkg-6.6.4+1.19.2" = _6TBSKtfO;
        "pkg-6.6.3+1.19.3-forge" = _KJAeQDB1;
        "pkg-6.6.5+1.19.2" = _iE48pMVI;
        "pkg-6.6.6+1.19.2" = _ycsSY7t5;
        "pkg-6.6.4+1.19.3-forge" = _JsWJ3an6;
        "pkg-6.6.7+1.19.2" = _Q4VHAcW5;
        "pkg-6.6.5+1.19.3-forge" = _8fwN0Al3;
        "pkg-6.6.8+1.19.2" = _kyCfzXO8;
        "pkg-6.6.6+1.19.3-forge" = _KtBO9TSq;
        "pkg-6.6.9+1.19.2" = _tAtN9mY4;
        "pkg-6.6.7+1.19.3-forge" = _T52FKb7V;
        "pkg-6.6.10+1.19.2" = _XRMYTUtt;
        "pkg-6.6.8+1.19.3-forge" = _IEO8DAX3;
        "pkg-6.6.11+1.19.2" = _vwceS7zb;
        "pkg-6.6.12+1.19.2" = _Tw5a7afS;
        "pkg-6.6.10+1.19.3-forge" = _nwZVAwhB;
        "pkg-6.6.13+1.19.2" = _DRuqf615;
        "pkg-6.6.11+1.19.3-forge" = _hZ6Mq2FA;
        "pkg-6.6.14+1.19.2" = _ODIe07pw;
        "pkg-6.6.12+1.19.3-forge" = _n4y8gLSe;
        "pkg-6.6.15+1.19.2" = _2P1rewtG;
        "pkg-6.6.13+1.19.3-forge" = _7sUHICiq;
        "pkg-6.6.16+1.19.2" = _PiLHUlo4;
        "pkg-6.6.14+1.19.3-forge" = _uTIeS31K;
        "pkg-6.6.17+1.19.2" = _zYvdv2zH;
        "pkg-6.6.15+1.19.3-forge" = _vEMKjpxt;
        "pkg-6.6.18+1.19.2" = _4Q7rw1Se;
        "pkg-6.6.18+1.19.4-forge" = _8Y95SWi4;
        "pkg-6.7.0+1.19.2" = _3nABr7NX;
        "pkg-6.7.0+1.19.4-forge" = _EhMeMosK;
        "pkg-6.7.1+1.19.2" = _8JHciTGp;
        "pkg-6.7.1+1.19.4-forge" = _Zqympy7W;
        "pkg-6.7.2+1.19.2" = _Ju5tIpHl;
        "pkg-6.7.3+1.19.2" = _FaHLWPjR;
        "pkg-6.7.3+1.19.4-forge" = _dnjCTtSN;
        "pkg-6.7.4+1.19.2" = _zItsdOLv;
        "pkg-6.7.4+1.19.4-forge" = _UxqRuQue;
        "pkg-6.7.5+1.19.2" = _PlNkRfv1;
        "pkg-6.7.5+1.19.4-forge" = _ANbMnwjj;
        "pkg-6.7.6+1.19.2" = _asUGKc0k;
        "pkg-6.7.6+1.19.4-forge" = _pfbBp7OW;
        "pkg-6.7.7+1.19.2" = _yExhyd6O;
        "pkg-6.7.7+1.19.4-forge" = _OUjklUkO;
        "pkg-6.7.8+1.19.2" = _4gpWSERJ;
        "pkg-6.7.8+1.19.4-forge" = _KLF8lIwH;
        "pkg-6.7.9+1.19.2" = _xaRaWceh;
        "pkg-6.7.9+1.19.4-forge" = _ASNiHvSU;
        "pkg-6.7.10-beta4+1.19.2" = _eHA3M4SI;
        "pkg-6.7.10+1.19.4-forge" = _FDTnxC8P;
        "pkg-6.7.11+1.19.2" = _JqmbRgvj;
        "pkg-6.7.11+1.19.4-forge" = _9aYqfASN;
        "pkg-6.7.13+1.19.2" = _vzwbmXod;
        "pkg-6.7.13+1.19.4-forge" = _4siolWjU;
        "pkg-6.7.14+1.19.2" = _SsokCXUw;
        "pkg-6.7.14+1.19.4-forge" = _J2BFk7u7;
        "pkg-6.7.16+1.19.2" = _eUJahz6p;
        "pkg-6.7.16+1.19.4-forge" = _JQXg8vEr;
        "pkg-6.7.17+1.19.2" = _kR3I5Edh;
        "pkg-6.7.17+1.19.4-forge" = _eoNMDNAV;
        "pkg-6.7.18+1.19.2" = _su9RmI6X;
        "pkg-6.7.18+1.19.4-forge" = _tp8da7yp;
        "pkg-6.7.19+1.19.2" = _PPRJUVkn;
        "pkg-6.7.19+1.19.4-forge" = _d39ChrZ2;
        "pkg-6.7.20+1.19.2" = _kkPM3lcD;
        "pkg-6.7.20+1.19.4-forge" = _JV7JmEdu;
        "pkg-6.7.21+1.19.2" = _CaeAbZn0;
        "pkg-6.7.22+1.19.2" = _O48fGHrk;
        "pkg-6.7.23+1.19.2" = _zk8AEsr1;
        "pkg-6.7.24+1.19.2" = _8JlS7qrK;
        "pkg-6.7.25+1.19.2" = _Gok3sf5n;
        "pkg-6.7.26+1.19.2" = _a92GR1mR;
        "pkg-6.7.27+1.19.2" = _J4mOQ6bo;
        "pkg-6.7.28+1.19.2" = _nkmS4L6a;
        "pkg-6.7.21+1.19.4-forge" = _EfpqsYiV;
        "pkg-6.7.29+1.19.2" = _8CWZfwmG;
        "pkg-6.7.30+1.19.2" = _8tDP20mA;
        "pkg-6.7.31+1.19.2" = _3pmarPhd;
        "pkg-6.7.32+1.19.2" = _aKLIY9lI;
        "pkg-6.7.33+1.19.2" = _9nHFSOKd;
        "pkg-6.7.34+1.19.2" = _4qvR1HmM;
        "pkg-7.0.0+1.20.1-forge" = _q8Xdt3H5;
        "pkg-7.0.1+1.20.1-forge" = _uFRbA6OZ;
        "pkg-7.0.3+1.20.1-forge" = _XkxxpDg1;
        "pkg-7.0.4+1.20.1-forge" = _o4K7WBzS;
        "pkg-7.0.5+1.20.1-forge" = _kKWECqO6;
        "pkg-7.0.6+1.20.1-forge" = _GREWpeDb;
        "pkg-7.0.7+1.20.1-forge" = _6xAzRFdV;
        "pkg-7.0.8+1.20.1-forge" = _os5dg1ii;
        "pkg-6.7.35+1.19.2" = _LT7a4qsr;
        "pkg-7.0.9+1.20.1-forge" = _M2rI28Wp;
        "pkg-7.0.10+1.20.1-forge" = _oxfrPUAI;
        "pkg-7.0.11+1.20.1-forge" = _Dcsq0fYH;
        "pkg-7.0.12+1.20.1-forge" = _HJSAyUr5;
        "pkg-7.0.13+1.20.1-forge" = _4SD2Sc1h;
        "pkg-6.7.36+1.19.2" = _IrGYLCEE;
        "pkg-7.0.14+1.20.1-forge" = _fjM0rVAz;
        "pkg-7.0.15+1.20.1-forge" = _932g48nR;
        "pkg-7.0.16+1.20.1-forge" = _jpydabPG;
        "pkg-7.0.17+1.20.1-forge" = _U84CbT7U;
        "pkg-6.7.38+1.19.2" = _GFTZL5G2;
        "pkg-7.0.18+1.20.1-forge" = _qJpFvtfJ;
        "pkg-7.0.19+1.20.1-forge" = _gLwKIPGu;
        "pkg-6.7.39+1.19.2" = _D3Hv8Wwx;
        "pkg-7.0.20+1.20.1-forge" = _BzB9HOKD;
        "pkg-7.0.21+1.20.1-forge" = _UouOkGks;
        "pkg-6.7.40+1.19.2" = _rNQZ7uUn;
        "pkg-7.0.22+1.20.1-forge" = _BXbDwP2D;
        "pkg-7.0.23+1.20.1-forge" = _WDyRG8a8;
        "pkg-7.0.24+1.20.1-forge" = _wb38IJzY;
        "pkg-6.7.41+1.19.2" = _B0DuWk0V;
        "pkg-7.0.25+1.20.1-forge" = _xaMYVqKN;
        "pkg-7.0.26+1.20.1-forge" = _K8vVO6kf;
        "pkg-6.7.42+1.19.2" = _hnBRFWgG;
        "pkg-7.0.27+1.20.1-forge" = _Drq4yX1E;
        "pkg-6.7.43+1.19.2" = _rZxW0AMF;
        "pkg-7.0.28+1.20.1-forge" = _nuS59zks;
        "pkg-7.0.29+1.20.1-forge" = _fbUfoLVd;
        "pkg-6.8.0+1.19.2" = _tMDYI7Dz;
        "pkg-7.1.0+1.20.1-forge" = _TNSOBn47;
        "pkg-7.1.1+1.20.1-forge" = _F7M5o6zu;
        "pkg-7.1.2+1.20.1-forge" = _Dio3U5xx;
        "pkg-7.2.0+1.20.2-neoforge" = _LqPWCR5Y;
        "pkg-7.1.4+1.20.1-forge" = _IRmeregD;
        "pkg-7.2.2+1.20.2-neoforge" = _R44rvngT;
        "pkg-6.8.1+1.19.2" = _JAVlqjqE;
        "pkg-7.1.5+1.20.1-forge" = _Js8ZFQsn;
        "pkg-7.2.3+1.20.2-neoforge" = _YyuCwoPP;
        "pkg-7.1.6+1.20.1-forge" = _M7OFGajW;
        "pkg-7.2.4+1.20.2-neoforge" = _rABhq1D8;
        "pkg-6.8.2+1.19.2" = _r2zsr9OH;
        "pkg-7.1.7+1.20.1-forge" = _4o1Ht4qo;
        "pkg-7.2.5+1.20.2-neoforge" = _weftyGwq;
        "pkg-7.1.8+1.20.1-forge" = _LMgHrQcZ;
        "pkg-7.2.6+1.20.2-neoforge" = _ndDeS1n1;
        "pkg-7.1.9+1.20.1-forge" = _v2tYViLm;
        "pkg-7.2.7+1.20.2-neoforge" = _ON2G3QWD;
        "pkg-7.2.8+1.20.4-neoforge" = _Ls7fFyjl;
        "pkg-6.8.3+1.19.2" = _8NWFxMEP;
        "pkg-7.1.11+1.20.1-forge" = _XI6IjyXI;
        "pkg-7.2.9+1.20.4-neoforge" = _JxPuFcOB;
        "pkg-6.8.4+1.19.2" = _IVeh4zeL;
        "pkg-7.1.12+1.20.1-forge" = _oJb17srq;
        "pkg-7.2.10+1.20.4-neoforge" = _gN6FjUnI;
        "pkg-6.8.5+1.19.2" = _YO34Gesj;
        "pkg-7.1.13+1.20.1-forge" = _wN6EXzT0;
        "pkg-7.2.11+1.20.4-neoforge" = _7ZkvSMhe;
        "pkg-6.8.6+1.19.2" = _DyIqh78D;
        "pkg-7.1.14+1.20.1-forge" = _qJEPUuol;
        "pkg-7.2.12+1.20.4-neoforge" = _HDUXxpDf;
        "pkg-6.9.0+1.19.2" = _Pb27do0h;
        "pkg-7.2.0+1.20.1-forge" = _wErsBhgc;
        "pkg-7.3.0+1.20.4-neoforge" = _f6rGhdqO;
        "pkg-7.2.1+1.20.1-forge" = _KshKxmMA;
        "pkg-7.3.1+1.20.4-neoforge" = _NVtqrd2B;
        "pkg-6.9.1+1.19.2" = _4I9QzQe5;
        "pkg-7.2.2+1.20.1-forge" = _O2GUFLlP;
        "pkg-7.3.2+1.20.4-neoforge" = _4iGo7g2N;
        "pkg-6.9.2+1.19.2" = _Qo6p79rQ;
        "pkg-7.3.3+1.20.4-neoforge" = _A0n369Dy;
        "pkg-6.9.3+1.19.2" = _Ydc3N1VK;
        "pkg-7.2.3+1.20.1-forge" = _RiA0aNX3;
        "pkg-7.3.4+1.20.4-neoforge" = _O4l7CDFO;
        "pkg-6.9.4+1.19.2" = _43PnX2ur;
        "pkg-7.2.4+1.20.1-forge" = _RGm5h73f;
        "pkg-7.3.5+1.20.4-neoforge" = _9p4ZUZih;
        "pkg-6.9.5+1.19.2" = _qlq8s4jX;
        "pkg-7.2.5+1.20.1-forge" = _G7MhGmCQ;
        "pkg-7.3.6+1.20.4-neoforge" = _W1yzBIFm;
        "pkg-6.9.6+1.19.2" = _uiEz4xQZ;
        "pkg-7.2.6+1.20.1-forge" = _Yq3BZnWz;
        "pkg-7.3.7+1.20.4-neoforge" = _eTIlsGqr;
        "pkg-7.2.7+1.20.1-forge" = _M2D4QS1U;
        "pkg-7.3.8+1.20.4-neoforge" = _S5LzJveq;
        "pkg-7.3.9+1.20.4-neoforge" = _unMaUVFc;
        "pkg-7.2.8+1.20.1-forge" = _ygGU8F9d;
        "pkg-6.9.7+1.19.2" = _op9v0Gkq;
        "pkg-7.2.9+1.20.1-forge" = _rdpcvJcO;
        "pkg-7.3.10+1.20.4-neoforge" = _LfSa0Hsn;
        "pkg-7.2.10+1.20.1-forge" = _1VCdn08h;
        "pkg-7.3.11+1.20.4-neoforge" = _WPHFa0xt;
        "pkg-7.2.11+1.20.1-forge" = _e1YoH4Q7;
        "pkg-7.3.12+1.20.4-neoforge" = _VQQlfpnB;
        "pkg-6.9.8+1.19.2" = _bXVD5bfu;
        "pkg-7.2.12+1.20.1-forge" = _79Xyr1x5;
        "pkg-7.3.13+1.20.4-neoforge" = _V6d6IHyM;
        "pkg-7.2.13+1.20.1-forge" = _o9P2B8G5;
        "pkg-7.2.14+1.20.1-forge" = _fywHvGeG;
        "pkg-7.2.15+1.20.1-forge" = _W0VzRwUY;
        "pkg-7.3.14+1.20.4-neoforge" = _z1lhFbQz;
        "pkg-7.2.16+1.20.1-forge" = _Bc4rI7GR;
        "pkg-7.3.15+1.20.4-neoforge" = _3Dau5Dr8;
        "pkg-7.2.18+1.20.1-forge" = _kz93EYv4;
        "pkg-7.3.17+1.20.4-neoforge" = _oYAV1EJd;
        "pkg-7.2.19+1.20.1-forge" = _V0ugEp6h;
        "pkg-7.3.18+1.20.4-neoforge" = _MPE6AC92;
        "pkg-7.2.20+1.20.1-forge" = _JiT1ZORA;
        "pkg-7.3.19+1.20.4-neoforge" = _Y7aJUzeK;
        "pkg-6.9.9+1.19.2" = _KexfyzzE;
        "pkg-7.3.20+1.20.4-neoforge" = _BjzmknBb;
        "pkg-7.2.21+1.20.1-forge" = _1Am2WDcb;
        "pkg-7.3.0+1.20.1-forge" = _W9VZU621;
        "pkg-7.4.0+1.20.4-neoforge" = _rreD0sPX;
        "pkg-7.3.1+1.20.1-forge" = _Vvz98328;
        "pkg-7.4.1+1.20.4-neoforge" = _3heNJtNo;
        "pkg-6.9.10+1.19.2" = _EHYhVqRC;
        "pkg-7.3.2+1.20.1-forge" = _34AQdnne;
        "pkg-7.4.2+1.20.4-neoforge" = _mLrhREiB;
        "pkg-7.3.3+1.20.1-forge" = _IHPa8MHV;
        "pkg-7.4.3+1.20.4-neoforge" = _pDYYwgcI;
        "pkg-7.3.4+1.20.1-forge" = _ilIEuIfs;
        "pkg-7.4.4+1.20.4-neoforge" = _8IA9Mklj;
        "pkg-6.9.11+1.19.2" = _F9VsOtIN;
        "pkg-6.9.12+1.19.2" = _Y7HnEann;
        "pkg-7.3.5+1.20.1-forge" = _i18p7WS7;
        "pkg-7.4.5+1.20.4-neoforge" = _tSxzR577;
        "pkg-7.3.6+1.20.1-forge" = _OcFby2PS;
        "pkg-7.4.6+1.20.4-neoforge" = _leCbUa12;
        "pkg-6.9.13+1.19.2" = _7fvijmZH;
        "pkg-7.3.7+1.20.1-forge" = _1UFklWJQ;
        "pkg-7.4.7+1.20.4-neoforge" = _Lcu3caLv;
        "pkg-7.3.8+1.20.1-forge" = _h0Uo0lcg;
        "pkg-7.4.8+1.20.4-neoforge" = _60k3T0DG;
        "pkg-7.4.0+1.20.1-forge" = _GEMuQMtz;
        "pkg-7.5.0+1.20.4-neoforge" = _iCRWbdFc;
        "pkg-7.4.1+1.20.1-forge" = _JhknV5wc;
        "pkg-7.5.1+1.20.4-neoforge" = _SAhznMcy;
        "pkg-7.5.0+1.20.6-neoforge" = _UCSu8awr;
        "pkg-7.5.2+1.20.4-neoforge" = _37u2WPzO;
        "pkg-7.4.2+1.20.1-forge" = _fxmvro4E;
        "pkg-7.5.1+1.20.6-neoforge" = _x5EwG9HO;
        "pkg-7.4.3+1.20.1-forge" = _xtGmmhjw;
        "pkg-7.5.3+1.20.4-neoforge" = _XKpg5gnc;
        "pkg-7.5.2+1.20.6-neoforge" = _TVQaUJK4;
        "pkg-7.4.4+1.20.1-forge" = _gsQSgBRD;
        "pkg-7.4.5+1.20.1-forge" = _i4ynORxc;
        "pkg-7.6.0+1.21-neoforge" = _cpxK8aGA;
        "pkg-7.6.1+1.21-neoforge" = _MnHACa25;
        "pkg-7.6.2+1.21-neoforge" = _TRwHIdTc;
        "pkg-7.4.6+1.20.1-forge" = _x1mSOnCk;
        "pkg-7.6.3+1.21-neoforge" = _GgHVY04p;
        "pkg-7.4.7+1.20.1-forge" = _nIJPDv6S;
        "pkg-7.6.4+1.21-neoforge" = _Ra70PBpV;
        "pkg-7.6.5+1.21-neoforge" = _RDNixcMp;
        "pkg-7.6.6+1.21-neoforge" = _Dt198Ew2;
        "pkg-7.4.9+1.20.1-forge" = _x7VW7Bne;
        "pkg-7.6.7+1.21-neoforge" = _UGKyFHSA;
        "pkg-7.6.8+1.21-neoforge" = _ZROxqoAD;
        "pkg-7.6.9+1.21-neoforge" = _en6Ytdma;
        "pkg-7.4.10+1.20.1-forge" = _fSNRn6Ze;
        "pkg-7.6.10+1.21-neoforge" = _Om0dQc0J;
        "pkg-7.5.3+1.20.6-neoforge" = _OaKkhIfs;
        "pkg-7.6.11+1.21-neoforge" = _ORRYYx5s;
        "pkg-7.6.12+1.21-neoforge" = _5JkmsFH4;
        "pkg-7.6.13+1.21-neoforge" = _Z5OZ21jH;
        "pkg-7.6.14+1.21-neoforge" = _RG9NBQHp;
        "pkg-7.6.15+1.21-neoforge" = _4olSEQiP;
        "pkg-7.4.11+1.20.1-forge" = _q1qxRSgw;
        "pkg-7.4.12+1.20.1-forge" = _L9X0xuTD;
        "pkg-7.6.16+1.21-neoforge" = _M7BhJE7s;
        "pkg-7.6.17+1.21-neoforge" = _NtgXkEAl;
        "pkg-7.4.13+1.20.1-forge" = _OGfvg1Sn;
        "pkg-7.6.18+1.21-neoforge" = _fj748B2b;
        "pkg-7.6.19+1.21-neoforge" = _snbcgT13;
        "pkg-7.4.14+1.20.1-forge" = _9Y214pww;
        "pkg-7.6.21+1.21-neoforge" = _Vvaxzdbp;
        "pkg-7.4.15+1.20.1-forge" = _jAJJ4WSq;
        "pkg-7.6.22+1.21-neoforge" = _y19jNgxQ;
        "pkg-7.6.23+1.21.1-neoforge" = _TG3EgxGy;
        "pkg-7.4.16+1.20.1-forge" = _X3CGsiqS;
        "pkg-7.6.24+1.21.1-neoforge" = _zxXaiN2z;
        "pkg-7.4.17+1.20.1-forge" = _6glFZY3d;
        "pkg-7.6.25+1.21.1-neoforge" = _LUUs3rCz;
        "pkg-7.6.26+1.21.1-neoforge" = _ZEA8x3To;
        "pkg-7.4.18+1.20.1-forge" = _h3RchO7W;
        "pkg-7.5.0+1.20.1-forge" = _c0YDHIUO;
        "pkg-7.7.0+1.21.1-neoforge" = _7imfej7c;
        "pkg-7.5.1+1.20.1-forge" = _qsRXhwEC;
        "pkg-7.7.1+1.21.1-neoforge" = _EFVb1s7F;
        "pkg-7.7.2+1.21.1-neoforge" = _6OqZTg9U;
        "pkg-7.5.2+1.20.1-forge" = _k4NBcV7N;
        "pkg-7.7.3+1.21.1-neoforge" = _9PwkQRrq;
        "pkg-7.7.4+1.21.1-neoforge" = _7D6Qpsey;
        "pkg-7.5.3+1.20.1-forge" = _CSEocQXI;
        "pkg-7.5.4+1.20.1-forge" = _aAljBKb0;
        "pkg-7.7.5+1.21.1-neoforge" = _wvKL2RFI;
        "pkg-7.5.5+1.20.1-forge" = _Nqmg8BJH;
        "pkg-7.7.6+1.21.1-neoforge" = _szgoDN4s;
        "pkg-7.7.7+1.21.1-neoforge" = _Iy7eh0n5;
        "pkg-7.7.8+1.21.1-neoforge" = _ntP8EW64;
        "pkg-7.7.9+1.21.1-neoforge" = _cZsfr3H8;
        "pkg-7.5.6+1.20.1-forge" = _qAubF6Vq;
        "pkg-7.7.10+1.21.1-neoforge" = _uDoPscJ4;
        "pkg-7.5.7+1.20.1-forge" = _89VO3gsl;
        "pkg-7.7.11+1.21.1-neoforge" = _Agre9ecg;
        "pkg-7.5.8+1.20.1-forge" = _jDkL0yY0;
        "pkg-7.7.12+1.21.1-neoforge" = _4iyqjoxn;
        "pkg-7.7.13+1.21.1-neoforge" = _dgZ47df5;
        "pkg-7.5.9+1.20.1-forge" = _kap4JfTE;
        "pkg-7.7.14+1.21.1-neoforge" = _9KwNIHiy;
        "pkg-7.5.10+1.20.1-forge" = _lvqaUbVa;
        "pkg-7.7.15+1.21.1-neoforge" = _ZXWnsoQA;
        "pkg-7.5.11+1.20.1-forge" = _l29WULq1;
        "pkg-7.5.12+1.20.1-forge" = _xzFDyuhY;
        "pkg-7.7.16+1.21.1-neoforge" = _Wcha6YKZ;
        "pkg-7.5.13+1.20.1-forge" = _W1WuxbZP;
        "pkg-7.7.17+1.21.1-neoforge" = _nziax1nP;
        "pkg-7.5.14+1.20.1-forge" = _gcD71nn0;
        "pkg-7.7.18+1.21.1-neoforge" = _gLIM95OT;
        "pkg-7.5.15+1.20.1-forge" = _fp7WX4vn;
        "pkg-7.7.19+1.21.1-neoforge" = _OBmxxYtl;
        "pkg-7.5.16+1.20.1-forge" = _gYBeAGSC;
        "pkg-7.7.20+1.21.1-neoforge" = _1dA1wUKg;
        "pkg-7.6.0+1.20.1-forge" = _XB0aVyeU;
        "pkg-7.8.0+1.21.1-neoforge" = _vGxqgekU;
        "pkg-7.6.1+1.20.1-forge" = _3gqYFywo;
        "pkg-7.8.1+1.21.1-neoforge" = _PLf1KTKS;
        "pkg-7.6.2+1.20.1-forge" = _Z9PLLQAS;
        "pkg-7.8.2+1.21.1-neoforge" = _8yAIHmI4;
        "pkg-7.6.3+1.20.1-forge" = _PRE0nrRf;
        "pkg-7.8.3+1.21.1-neoforge" = _ai5aYfy3;
        "pkg-7.6.4+1.20.1-forge" = _IlMNMqYE;
        "pkg-7.8.4+1.21.1-neoforge" = _3YxyjJHA;
        "pkg-7.6.5+1.20.1-forge" = _wy9hWyjU;
        "pkg-7.8.5+1.21.1-neoforge" = _FckKn8pf;
        "pkg-7.6.6+1.20.1-forge" = _VRXWzjCG;
        "pkg-7.8.6+1.21.1-neoforge" = _q33IC2l4;
        "pkg-7.6.7+1.20.1-forge" = _HWfAU5QX;
        "pkg-7.8.7+1.21.1-neoforge" = _KMEP0HPO;
        "pkg-7.6.8+1.20.1-forge" = _YS8Yns7N;
        "pkg-7.8.8+1.21.1-neoforge" = _Hl6UatIT;
        "pkg-7.8.9+1.21.1-neoforge" = _GgRq1uhl;
        "pkg-7.6.11+1.20.1-forge" = _AglHlQxy;
        "pkg-7.8.11+1.21.1-neoforge" = _eEy39SZZ;
        "pkg-7.6.12+1.20.1-forge" = _cpX0uIYB;
        "pkg-7.8.12+1.21.1-neoforge" = _Cb2E5mZg;
        "pkg-7.7.0+1.20.1-forge" = _PEuPgXhn;
        "pkg-7.9.0+1.21.1-neoforge" = _WE384Ktu;
        "pkg-7.7.1+1.20.1-forge" = _DbNd9l3l;
        "pkg-7.9.1+1.21.1-neoforge" = _sY0WlGiS;
        "pkg-7.7.2+1.20.1-forge" = _nkWDxckU;
        "pkg-7.9.2+1.21.1-neoforge" = _eh7tuTcl;
        "pkg-7.7.3+1.20.1-forge" = _ewiHoIpI;
        "pkg-7.9.3+1.21.1-neoforge" = _P3FTVkaT;
        "pkg-7.9.4+1.21.1-neoforge" = _hm5yNCOD;
        "pkg-7.8.0+1.20.1-forge" = _tMviU9nd;
        "pkg-7.10.0+1.21.1-neoforge" = _qOmrvWVJ;
        "pkg-7.8.1+1.20.1-forge" = _Ds8Z7KmI;
        "pkg-7.10.1+1.21.1-neoforge" = _TaNl64rO;
        "pkg-7.8.2+1.20.1-forge" = _qCZPeE3p;
        "pkg-7.10.2+1.21.1-neoforge" = _GepjDJua;
        "pkg-7.8.3+1.20.1-forge" = _aGlAIlzO;
        "pkg-7.10.3+1.21.1-neoforge" = _Q9Zsei17;
        "pkg-7.9.0+1.20.1-forge" = _lqRzI2z9;
        "pkg-7.11.0+1.21.1-neoforge" = _v5pcQdZh;
        "pkg-7.9.2+1.20.1-forge" = _1ZrQn0VI;
        "pkg-7.11.1+1.21.1-neoforge" = _Jh8OWWX3;
        "pkg-7.9.3+1.20.1-forge" = _YsA4wXPv;
        "pkg-7.11.3+1.21.1-neoforge" = _DRSiiNkm;
        "pkg-7.9.4+1.20.1-forge" = _WveH551t;
        "pkg-7.11.4+1.21.1-neoforge" = _6lox9Gn1;
        "pkg-7.9.5+1.20.1-forge" = _Y7qVEfFh;
        "pkg-7.11.5+1.21.1-neoforge" = _QxntUSgI;
        "pkg-7.11.6+1.21.1-neoforge" = _ciFUWp9O;
        "pkg-7.9.6+1.20.1-forge" = _YKxtr6gX;
        "pkg-7.9.7+1.20.1-forge" = _UJOzKzg1;
        "pkg-7.9.8+1.20.1-forge" = _52fJ8k2s;
        "pkg-7.11.8+1.21.1-neoforge" = _pTgYjNli;
        "pkg-7.9.9+1.20.1-forge" = _hg77KU9A;
        "pkg-7.11.9+1.21.1-neoforge" = _f71iS4kt;
        "pkg-7.9.10+1.20.1-forge" = _Peczfd8I;
        "pkg-7.11.10+1.21.1-neoforge" = _t93pDroc;
        "pkg-7.10.0+1.20.1-forge" = _Kdvsrwt7;
        "pkg-7.12.0+1.21.1-neoforge" = _HtnulckZ;
        "pkg-7.10.1+1.20.1-forge" = _ZPLCtDgB;
        "pkg-7.12.1+1.21.1-neoforge" = _hl2ZAEEE;
        "pkg-7.11.0+1.20.1-forge" = _aYPMb4bW;
        "pkg-7.13.0+1.21.1-neoforge" = _QX88anky;
        "pkg-7.11.1+1.20.1-forge" = _8TNMiCpk;
        "pkg-7.13.1+1.21.1-neoforge" = _TrLV99FS;
        "pkg-7.11.2+1.20.1-forge" = _sXcOi1PT;
        "pkg-7.13.2+1.21.1-neoforge" = _1olRExLX;
        "pkg-7.11.3+1.20.1-forge" = _uc4Tc8dG;
        "pkg-7.13.3+1.21.1-neoforge" = _86f0dNSk;
        "pkg-7.11.4+1.20.1-forge" = _tugGH8lY;
        "pkg-7.13.5+1.21.1-neoforge" = _ooFeMrip;
        "pkg-7.11.5+1.20.1-forge" = _4trqSr78;
        "pkg-7.13.6+1.21.1-neoforge" = _EsOZmo3A;
        "pkg-7.12.0+1.20.1-forge" = _CX6WB7XT;
        "pkg-7.14.0+1.21.1-neoforge" = _WETiNRdI;
        "pkg-7.12.1+1.20.1-forge" = _jVWOOlcz;
        "pkg-7.14.1+1.21.1-neoforge" = _e4xnLRx9;
        "pkg-7.13.0+1.20.1-forge" = _xZQEPRHk;
        "pkg-7.15.0+1.21.1-neoforge" = _SRc2vwWX;
        "pkg-7.15.1+1.21.1-neoforge" = _M3kCGvIb;
        "pkg-7.15.2+1.21.1-neoforge" = _wp7AegJy;
