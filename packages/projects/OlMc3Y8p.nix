...
let
    ...
    in {
        ...
        "pkg-1.2.7" = _XXjDfqV1;
        "pkg-1.2.8" = _e6hXyLER;
        "pkg-1.2.10+1.20.2" = _OWlCMuox;
        "pkg-1.2.11+1.20.2" = _m9PWIGZe;
        "pkg-1.2.12+1.20.2" = _QvXRT451;
        "pkg-1.2.13+1.20.2" = _6YCv8fDI;
        "pkg-1.2.14+1.20.2" = _mBVeHyyr;
        "pkg-1.2.15+1.20.2" = _mYNFaqld;
        "pkg-1.2.16+1.20.2" = _wcsFuFWF;
        "pkg-1.2.17+1.20.2" = _AGi87mor;
        "pkg-1.3.0+1.21" = _Srpgcyj6;
        "pkg-1.3.1+1.21" = _LFoQvrpE;
        "pkg-1.3.1+1.21.1" = _lC9fvqYT;
        "pkg-1.3.2+1.21.4" = _R6A68TMR;
        "pkg-1.3.3+1.21.4" = _Zy62w9a5;
        "pkg-1.4.0+1.21.4" = _HsdvWqPI;
        "pkg-1.4.1+1.21.4" = _i99ZZjfZ;
        "pkg-1.4.2+1.21.4" = _yuKvJMix;
        "pkg-1.4.3+1.21.4" = _izzFPzQ3;
        "pkg-1.4.4+1.21.4" = _CGvro2fF;
        "pkg-1.4.5+1.21.4" = _p0mb9x39;
        "pkg-1.4.6+1.21.4" = _K0XJPCW4;
        "pkg-1.4.7+1.21.4" = _S9QlifBS;
        "pkg-1.4.8+1.21.4" = _mesyT2IR;
        "pkg-1.4.9+1.21.4" = _pxKPUfLN;
        "pkg-1.4.10+1.21.4" = _yB9oNefr;
        "pkg-1.4.11+1.21.4" = _M8hwOZZp;
        "pkg-1.4.12+1.21.4" = _mWktTQ7G;
        "pkg-1.4.13+1.21.4" = _jv7lbCSv;
        "pkg-1.4.14+1.21.4" = _s3BzXTUv;
        "pkg-1.4.15+1.21.4" = _YcjXs3Ez;
        "pkg-1.4.16+1.21.4" = _nHzzJPEb;
        "pkg-1.4.17+1.21.4" = _5RLvkaCQ;
        "pkg-1.4.18+1.21.4" = _L3xhlWpi;
        "pkg-1.4.19+1.21.4" = _HZeupEZo;
        "pkg-1.4.20+1.21.4" = _mDvOT4qb;
        "pkg-1.4.21+1.21.4" = _2ET0Hx8f;
        "pkg-1.5.0+1.21.11" = _BuiUSqZJ;
        "pkg-1.5.1+1.21.11" = _m3kwAePA;
        "pkg-1.5.2+1.21.11" = _eAsflBry;
        "pkg-1.5.3+1.21.11" = _nZKD1NsX;
