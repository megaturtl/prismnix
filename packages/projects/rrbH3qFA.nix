...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.20.5" = _7GK1XW2W;
        "pkg-1.0.1-alpha-1.20.5" = _hkZt1kQE;
        "pkg-1.0.2-alpha-1.21.0" = _7gJivDU5;
        "pkg-1.0.3-alpha-1.21.2" = _i4jIscDe;
        "pkg-1.0.4-alpha-1.21.4" = _DJuN45zG;
        "pkg-1.0.5-alpha-1.21.5" = _ZdYSFnTw;
