...
let
    versions = (let
        ...
        _nmCedt2R = {
            "id" = "nmCedt2R";
            "file" = "wide-mining-2.3.0-datapack.zip";
            "hash" = "sha512-6Gy/eK/trGbr2rw69qsshDEZ/o2M9LRGpyRSKSxyjD1DHDN1ccssU1LjIXqwXdBZ1kPYQq55TXkcTR4wamveWg==";
        };
        _dNkdoDFX = {
            "id" = "dNkdoDFX";
            "file" = "wide-mining-2.3.0.jar";
            "hash" = "sha512-eC6A0zyRbDVsDuHV2UuFODY3OrVijkv2wp7VSKIG50zRmQBagaXJqpo7fIatFnaEXZWT9+ThHR5sZsdZfsZ0EQ==";
        };
        _VJmNWY9Z = {
            "id" = "VJmNWY9Z";
            "file" = "wide-mining-2.3.1-datapack.zip";
            "hash" = "sha512-rDeNoQ6QaUCQdVyDhiP0dFlonqOLuzoIMEayNOgqFVu+P6snnIgHycMUB1L0jSoLfG5id5s6aEK45qhMxa7pFg==";
        };
        _VZN40E9K = {
            "id" = "VZN40E9K";
            "file" = "wide-mining-2.3.1.jar";
            "hash" = "sha512-o3ntnyFGfMFzPvMzmtpFAANDMVrWR7zVuMzv/KA1OMQbc/LkNpZcJjVuAIWPpEJNKCcA26j9S50xgBu5QXlPiw==";
        };
    in {
        "DvSs1q8y" = _DvSs1q8y;
        "ylE2QF1S" = _ylE2QF1S;
        ...
        "VJmNWY9Z" = _VJmNWY9Z;
        "VZN40E9K" = _VZN40E9K;
        "datapack-1.21.4" = _VJmNWY9Z;
        "datapack-1.21.5" = _VJmNWY9Z;
        "datapack-1.21.6" = _VJmNWY9Z;
        "datapack-1.21.7" = _VJmNWY9Z;
        "datapack-1.21.8" = _VJmNWY9Z;
        "datapack-1.21" = _RiBbIa8B;
        "datapack-1.21.1" = _VJmNWY9Z;
        "datapack-1.21.2" = _VJmNWY9Z;
        "datapack-1.21.3" = _VJmNWY9Z;
        "datapack-1.21.9" = _VJmNWY9Z;
        "datapack-1.21.10" = _VJmNWY9Z;
        "datapack-1.21.11" = _VJmNWY9Z;
        "datapack-26.1" = _VJmNWY9Z;
        "datapack-26.1.1" = _VJmNWY9Z;
        "datapack-26.1.2" = _VJmNWY9Z;
        "datapack-26.2" = _VJmNWY9Z;
        "fabric-1.21.4" = _VZN40E9K;
        "fabric-1.21.5" = _VZN40E9K;
        "fabric-1.21.6" = _VZN40E9K;
        "fabric-1.21.7" = _VZN40E9K;
        "fabric-1.21.8" = _VZN40E9K;
        "fabric-1.21" = _YJdarSSG;
        "fabric-1.21.1" = _VZN40E9K;
        "fabric-1.21.2" = _VZN40E9K;
        "fabric-1.21.3" = _VZN40E9K;
        "fabric-1.21.9" = _VZN40E9K;
        "fabric-1.21.10" = _VZN40E9K;
        "fabric-1.21.11" = _VZN40E9K;
        "fabric-26.1" = _VZN40E9K;
        "fabric-26.1.1" = _VZN40E9K;
        "fabric-26.1.2" = _VZN40E9K;
        "fabric-26.2" = _VZN40E9K;
        "forge-1.21.4" = _VZN40E9K;
        "forge-1.21.5" = _VZN40E9K;
        "forge-1.21.6" = _VZN40E9K;
        "forge-1.21.7" = _VZN40E9K;
        "forge-1.21.8" = _VZN40E9K;
        "forge-1.21" = _YJdarSSG;
        "forge-1.21.1" = _VZN40E9K;
        "forge-1.21.2" = _VZN40E9K;
        "forge-1.21.3" = _VZN40E9K;
        "forge-1.21.9" = _VZN40E9K;
        "forge-1.21.10" = _VZN40E9K;
        "forge-1.21.11" = _VZN40E9K;
        "forge-26.1" = _VZN40E9K;
        "forge-26.1.1" = _VZN40E9K;
        "forge-26.1.2" = _VZN40E9K;
        "forge-26.2" = _VZN40E9K;
        "neoforge-1.21.4" = _VZN40E9K;
        "neoforge-1.21.5" = _VZN40E9K;
        "neoforge-1.21.6" = _VZN40E9K;
        "neoforge-1.21.7" = _VZN40E9K;
        "neoforge-1.21.8" = _VZN40E9K;
        "neoforge-1.21" = _YJdarSSG;
        "neoforge-1.21.1" = _VZN40E9K;
        "neoforge-1.21.2" = _VZN40E9K;
        "neoforge-1.21.3" = _VZN40E9K;
        "neoforge-1.21.9" = _VZN40E9K;
        "neoforge-1.21.10" = _VZN40E9K;
        "neoforge-1.21.11" = _VZN40E9K;
        "neoforge-26.1" = _VZN40E9K;
        "neoforge-26.1.1" = _VZN40E9K;
        "neoforge-26.1.2" = _VZN40E9K;
        "neoforge-26.2" = _VZN40E9K;
        "quilt-1.21.4" = _VZN40E9K;
        "quilt-1.21.5" = _VZN40E9K;
        "quilt-1.21.6" = _VZN40E9K;
        "quilt-1.21.7" = _VZN40E9K;
        "quilt-1.21.8" = _VZN40E9K;
        "quilt-1.21" = _YJdarSSG;
        "quilt-1.21.1" = _VZN40E9K;
        "quilt-1.21.2" = _VZN40E9K;
        "quilt-1.21.3" = _VZN40E9K;
        "quilt-1.21.9" = _VZN40E9K;
        "quilt-1.21.10" = _VZN40E9K;
        "quilt-1.21.11" = _VZN40E9K;
        "quilt-26.1" = _VZN40E9K;
        "quilt-26.1.1" = _VZN40E9K;
        "quilt-26.1.2" = _VZN40E9K;
        "quilt-26.2" = _VZN40E9K;
        "pkg-1" = _DvSs1q8y;
        "pkg-1+mod" = _ylE2QF1S;
        "pkg-1.1" = _2VLI2LUc;
        "pkg-1.1+mod" = _ie8mkDK0;
        "pkg-1.2" = _PGBLKDbb;
        "pkg-1.2+mod" = _E8wpLr8s;
        "pkg-1.2.1" = _1Tp36i6i;
        "pkg-1.2.1+mod" = _Gr5Y0ttH;
        "pkg-1.2.2" = _Svh0ZjXW;
        "pkg-1.2.2+mod" = _5V79OLo7;
        "pkg-2.0" = _RiBbIa8B;
        "pkg-2.0+mod" = _YJdarSSG;
        "pkg-2.1" = _rekbU1sR;
        "pkg-2.1+mod" = _QhwkSKe9;
        "pkg-2.1.1" = _cyNgW8nS;
        "pkg-2.1.1+mod" = _aW2M2fky;
        "pkg-2.1.2" = _755rvfZJ;
        "pkg-2.1.2+mod" = _AYFt51lF;
        "pkg-2.1.4" = _48XBUS2d;
        "pkg-2.1.4+mod" = _K6LRtyMY;
        "pkg-2.1.5" = _IBAsVDA3;
        "pkg-2.1.5+mod" = _jaztqm9I;
        "pkg-2.2.0" = _W4EHksRQ;
        "pkg-2.2.0+mod" = _gVi5CGVW;
        "pkg-2.3.0" = _nmCedt2R;
        "pkg-2.3.0+mod" = _dNkdoDFX;
        "pkg-2.3.1" = _VJmNWY9Z;
        "pkg-2.3.1+mod" = _VZN40E9K;
        "default" = _VZN40E9K;
    });
