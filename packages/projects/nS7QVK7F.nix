...
let
    versions = (let
        ...
        _Kzzbk6w5 = {
            "id" = "Kzzbk6w5";
            "file" = "Stronger Skill Tree Unlock All 1.21.1- v1.4.2.jar";
            "hash" = "sha512-wrwrHlKW33iBjufWJszBDafrOqn97VhHTwFni1m4qUvaCeLpprg3LGLmhfZ0g0jhDJBwklRv1207FkLEw1IVsw==";
        };
        _4FhvhtSb = {
            "id" = "4FhvhtSb";
            "file" = "Stronger Skill Tree Unlock All 1.21.3+ v1.4.2.jar";
            "hash" = "sha512-fCGHSndMg/pec0Sfgpt6Bivu8TLKt8S51JLAQWBcUPoe7oun0pJWLIESxivy2GOerg/wArhxe0HuQSrlCEPfWw==";
        };
    in {
        "5Ql9POag" = _5Ql9POag;
        "DRJeCC8x" = _DRJeCC8x;
        ...
        "fabric-1.18.2" = _Kzzbk6w5;
        "fabric-1.19" = _Kzzbk6w5;
        "fabric-1.19.1" = _Kzzbk6w5;
        "fabric-1.19.2" = _Kzzbk6w5;
        "fabric-1.19.3" = _NeuROqfd;
        "fabric-1.19.4" = _Kzzbk6w5;
        "fabric-1.20" = _Kzzbk6w5;
        "fabric-1.20.1" = _Kzzbk6w5;
        "fabric-1.20.2" = _Kzzbk6w5;
        "fabric-1.20.3" = _DRJeCC8x;
        "fabric-1.20.4" = _Kzzbk6w5;
        "fabric-1.20.5" = _DRJeCC8x;
        "fabric-1.20.6" = _DRJeCC8x;
        "fabric-1.21" = _Kzzbk6w5;
        "fabric-1.21.1" = _Kzzbk6w5;
        "fabric-1.21.3" = _4FhvhtSb;
        "fabric-1.21.4" = _4FhvhtSb;
        "fabric-1.21.5" = _4FhvhtSb;
        "fabric-1.21.6" = _4FhvhtSb;
        "fabric-1.21.2" = _slsTI73F;
        "fabric-1.21.7" = _DyGaFkqW;
        "fabric-1.21.8" = _4FhvhtSb;
        "fabric-1.21.9" = _4FhvhtSb;
        "fabric-1.21.10" = _4FhvhtSb;
        "fabric-1.21.11" = _4FhvhtSb;
        "fabric-26.1" = _4FhvhtSb;
        "fabric-26.2" = _4FhvhtSb;
        "forge-1.18.2" = _Kzzbk6w5;
        "forge-1.19" = _Kzzbk6w5;
        "forge-1.19.1" = _Kzzbk6w5;
        "forge-1.19.2" = _Kzzbk6w5;
        "forge-1.19.3" = _NeuROqfd;
        "forge-1.19.4" = _Kzzbk6w5;
        "forge-1.20" = _Kzzbk6w5;
        "forge-1.20.1" = _Kzzbk6w5;
        "forge-1.20.2" = _Kzzbk6w5;
        "forge-1.20.3" = _DRJeCC8x;
        "forge-1.20.4" = _Kzzbk6w5;
        "forge-1.20.5" = _DRJeCC8x;
        "forge-1.20.6" = _DRJeCC8x;
        "forge-1.21" = _Kzzbk6w5;
        "forge-1.21.1" = _Kzzbk6w5;
        "forge-1.21.3" = _4FhvhtSb;
        "forge-1.21.4" = _4FhvhtSb;
        "forge-1.21.5" = _4FhvhtSb;
        "forge-1.21.6" = _4FhvhtSb;
        "forge-1.21.2" = _slsTI73F;
        "forge-1.21.7" = _DyGaFkqW;
        "forge-1.21.8" = _4FhvhtSb;
        "forge-1.21.9" = _4FhvhtSb;
        "forge-1.21.10" = _4FhvhtSb;
        "forge-1.21.11" = _4FhvhtSb;
        "forge-26.1" = _4FhvhtSb;
        "forge-26.2" = _4FhvhtSb;
        "neoforge-1.18.2" = _Kzzbk6w5;
        "neoforge-1.19" = _Kzzbk6w5;
        "neoforge-1.19.1" = _Kzzbk6w5;
        "neoforge-1.19.2" = _Kzzbk6w5;
        "neoforge-1.19.3" = _NeuROqfd;
        "neoforge-1.19.4" = _Kzzbk6w5;
        "neoforge-1.20" = _Kzzbk6w5;
        "neoforge-1.20.1" = _Kzzbk6w5;
        "neoforge-1.20.2" = _Kzzbk6w5;
        "neoforge-1.20.3" = _DRJeCC8x;
        "neoforge-1.20.4" = _Kzzbk6w5;
        "neoforge-1.20.5" = _DRJeCC8x;
        "neoforge-1.20.6" = _DRJeCC8x;
        "neoforge-1.21" = _Kzzbk6w5;
        "neoforge-1.21.1" = _Kzzbk6w5;
        "neoforge-1.21.3" = _4FhvhtSb;
        "neoforge-1.21.4" = _4FhvhtSb;
        "neoforge-1.21.5" = _4FhvhtSb;
        "neoforge-1.21.6" = _4FhvhtSb;
        "neoforge-1.21.2" = _slsTI73F;
        "neoforge-1.21.7" = _DyGaFkqW;
        "neoforge-1.21.8" = _4FhvhtSb;
        "neoforge-1.21.9" = _4FhvhtSb;
        "neoforge-1.21.10" = _4FhvhtSb;
        "neoforge-1.21.11" = _4FhvhtSb;
        "neoforge-26.1" = _4FhvhtSb;
        "neoforge-26.2" = _4FhvhtSb;
        "pkg-1.0.0" = _lRu3dBvH;
        "pkg-1.1.0" = _VIHuaeVi;
        "pkg-1.2.0" = _slsTI73F;
        "pkg-1.2.1" = _DyGaFkqW;
