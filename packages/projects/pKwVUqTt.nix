...
let
    ...
    in {
        ...
        "pkg-1.0.0-fabric-1.21.4-0.119.2" = _Zpvf7K6n;
        "pkg-1.0.0-forge-1.21.1-52.1.1" = _UClg2SE7;
        "pkg-1.0.0-fabric-1.21.1-0.116.0" = _BSAXGYLZ;
        "pkg-1.0.0-fabric-1.20.1-0.92.5" = _pzWo7LBL;
        "pkg-1.0.0-forge-1.20.1-47.4.0" = _jDR10ukq;
        "pkg-1.0.0-fabric-1.21.6-0.127.0" = _N2wMtVZS;
        "pkg-1.0.0-forge-1.21.6-56.0.5" = _jQuZHe40;
        "pkg-1.0.0-neoforge-1.21.8-21.8.39" = _dbY5FRZA;
        "pkg-1.0.0-neoforge-1.21.9-21.9.2-b" = _eLkAR43M;
        "pkg-1.0.0-fabric-1.21.9-0.134.0" = _vZsxs0hc;
        "pkg-1.0.0-forge-1.21.9-59.0.1" = _GmuSPs3j;
        "pkg-1.0.1-forge-1.21.9-59.0.5" = _vLTdZqSE;
        "pkg-1.0.0-neoforge-1.21.4-21.4.155" = _AUUxe9LH;
        "pkg-1.0.0-neoforge-1.21.1-21.1.213" = _PFLgYANY;
        "pkg-1.0.2-forge-1.21.8-58.1.7" = _LnlcS6T4;
        "pkg-1.0.2-neoforge-1.21.11-21.11.10b" = _rZ8J67fM;
        "pkg-1.0.2-forge-1.21.11-61.0.2" = _dkkMOU6s;
        "pkg-1.0.2-fabric-1.21.11-0.140.0" = _YxUscDdK;
        "pkg-1.0.3-fabric-26.1.2-0.145.4" = _PYzsm2TE;
        "pkg-1.0.3-forge-26.1.2-64.0.0" = _TUmolv6E;
        "pkg-1.0.3-neoforge-26.1.2.7" = _j61FT1hD;
        "pkg-1.0.1-forge-1.20.1-47.4.0" = _I8FzOn7b;
        "default" = _I8FzOn7b;
    });
