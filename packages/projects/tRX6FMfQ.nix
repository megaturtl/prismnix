...
let
    versions = (let
        ...
        _Zc4Lf2sc = {
            "id" = "Zc4Lf2sc";
            "file" = "craft-engine-paper-plugin-26.8.jar";
            "hash" = "sha512-78qY1js8IamjXC39qgVyuOTVurl3fHshALDsMeoP/e5KGW2RavmZejGaO7EArGUgBO3vGIwcsRetLwPrnQ/gNg==";
        };
        _wuWdEsrI = {
            "id" = "wuWdEsrI";
            "file" = "craft-engine-bukkit-plugin-26.8.jar";
            "hash" = "sha512-TYxH/A7/B8nfQoB2v1tIuXHgCfVUCd6cuifKB5N8Zbq/cC/WWTsMieuwOZWtkYgTksJrzUPRXEWVfJtgec4BFg==";
        };
        _H7DL3ftK = {
            "id" = "H7DL3ftK";
            "file" = "craft-engine-paper-plugin-26.8.1.jar";
            "hash" = "sha512-gDV70yBcEFCmmqBIATy+0qt2ri3o7C2hOPxTbG2OkTzLymTmioz7+hC+SWGpzAgkqE4zuGgM8tjIjrbIT7oYSg==";
        };
        _ua1kDFi7 = {
            "id" = "ua1kDFi7";
            "file" = "craft-engine-bukkit-plugin-26.8.1.jar";
            "hash" = "sha512-7ZvYAu+h1w2YHdG+V7sgqP5SreQyGbhWstGgke2ZoYao5xdoSSdcuBXmbhhgpeqJuGPXMWzXaLkfBouTaXISLg==";
        };
        _jPAplNym = {
            "id" = "jPAplNym";
            "file" = "craft-engine-paper-plugin-26.8.2.jar";
            "hash" = "sha512-NlTEwZE9b5P4l5ye1BBPHvofMCY/AGKUcXAuCGy7I6gnRE7LD0MxQhKtsoPxlvLJlxa2rc5NmLOFjH8X+X8NQQ==";
        };
        _JIbVlzgy = {
            "id" = "JIbVlzgy";
            "file" = "craft-engine-bukkit-plugin-26.8.2.jar";
            "hash" = "sha512-Wv5pq9kM9NjVQY1+pZU/wRQJ+82ze7czc6SSjPhLdiz33wppxAum6O6ce9w8ccGOSelsXEfsTnQDl+XadZJ++g==";
        };
        _h4fc30oM = {
            "id" = "h4fc30oM";
            "file" = "craft-engine-paper-plugin-26.9.jar";
            "hash" = "sha512-pjm73+dQVPg0uxce0kaRBLkC2N4HS48hOVPrEae+NGtgzqFSKcLh+a9qKo5MLI6UJ3zktlD6qIDzwzQk+Lnuxw==";
        };
        _UoMOLYlE = {
            "id" = "UoMOLYlE";
            "file" = "craft-engine-bukkit-plugin-26.9.jar";
            "hash" = "sha512-cMKPlspNyrJ6TXGUVdVfH7GV+9XR8u3rQ44YNqZIoJNN7kAdUlLj6kPMnRiXaJwctEhdz0pQ8SiyrUQrwZIYqw==";
        };
    in {
        "XOmPceqX" = _XOmPceqX;
        "OktNyJzh" = _OktNyJzh;
        ...
        "h4fc30oM" = _h4fc30oM;
        "UoMOLYlE" = _UoMOLYlE;
        "folia-1.20" = _h4fc30oM;
        "folia-1.20.1" = _h4fc30oM;
        "folia-1.20.2" = _h4fc30oM;
        "folia-1.20.3" = _h4fc30oM;
        "folia-1.20.4" = _h4fc30oM;
        "folia-1.20.5" = _h4fc30oM;
        "folia-1.20.6" = _h4fc30oM;
        "folia-1.21" = _h4fc30oM;
        "folia-1.21.1" = _h4fc30oM;
        "folia-1.21.2" = _h4fc30oM;
        "folia-1.21.3" = _h4fc30oM;
        "folia-1.21.4" = _h4fc30oM;
        "folia-1.21.5" = _h4fc30oM;
        "folia-1.21.6" = _h4fc30oM;
        "folia-1.21.7" = _h4fc30oM;
        "folia-1.21.8" = _h4fc30oM;
        "folia-1.21.9" = _h4fc30oM;
        "folia-1.21.10" = _h4fc30oM;
        "folia-1.21.11" = _h4fc30oM;
        "folia-26.1" = _h4fc30oM;
        "folia-26.1.1" = _h4fc30oM;
        "folia-26.1.2" = _h4fc30oM;
        "folia-26.2" = _h4fc30oM;
        "paper-1.20" = _h4fc30oM;
        "paper-1.20.1" = _h4fc30oM;
        "paper-1.20.2" = _h4fc30oM;
        "paper-1.20.3" = _h4fc30oM;
        "paper-1.20.4" = _h4fc30oM;
        "paper-1.20.5" = _h4fc30oM;
        "paper-1.20.6" = _h4fc30oM;
        "paper-1.21" = _h4fc30oM;
        "paper-1.21.1" = _h4fc30oM;
        "paper-1.21.2" = _h4fc30oM;
        "paper-1.21.3" = _h4fc30oM;
        "paper-1.21.4" = _h4fc30oM;
        "paper-1.21.5" = _h4fc30oM;
        "paper-1.21.6" = _h4fc30oM;
        "paper-1.21.7" = _h4fc30oM;
        "paper-1.21.8" = _h4fc30oM;
        "paper-1.21.9" = _h4fc30oM;
        "paper-1.21.10" = _h4fc30oM;
        "paper-1.21.11" = _h4fc30oM;
        "paper-26.1" = _h4fc30oM;
        "paper-26.1.1" = _h4fc30oM;
        "paper-26.1.2" = _h4fc30oM;
        "paper-26.2" = _h4fc30oM;
        "purpur-1.20" = _h4fc30oM;
        "purpur-1.20.1" = _h4fc30oM;
        "purpur-1.20.2" = _h4fc30oM;
        "purpur-1.20.3" = _h4fc30oM;
        "purpur-1.20.4" = _h4fc30oM;
        "purpur-1.20.5" = _h4fc30oM;
        "purpur-1.20.6" = _h4fc30oM;
        "purpur-1.21" = _h4fc30oM;
        "purpur-1.21.1" = _h4fc30oM;
        "purpur-1.21.2" = _h4fc30oM;
        "purpur-1.21.3" = _h4fc30oM;
        "purpur-1.21.4" = _h4fc30oM;
        "purpur-1.21.5" = _h4fc30oM;
        "purpur-1.21.6" = _h4fc30oM;
        "purpur-1.21.7" = _h4fc30oM;
        "purpur-1.21.8" = _h4fc30oM;
        "purpur-1.21.9" = _h4fc30oM;
        "purpur-1.21.10" = _h4fc30oM;
        "purpur-1.21.11" = _h4fc30oM;
        "purpur-26.1" = _h4fc30oM;
        "purpur-26.1.1" = _h4fc30oM;
        "purpur-26.1.2" = _h4fc30oM;
        "purpur-26.2" = _h4fc30oM;
        "spigot-26.1" = _UoMOLYlE;
        "spigot-26.1.1" = _UoMOLYlE;
        "spigot-26.1.2" = _UoMOLYlE;
        "spigot-26.2" = _UoMOLYlE;
        "bukkit-26.1" = _UoMOLYlE;
        "bukkit-26.1.1" = _UoMOLYlE;
        "bukkit-26.1.2" = _UoMOLYlE;
        "bukkit-26.2" = _UoMOLYlE;
        "pkg-0.0.48" = _XOmPceqX;
        "pkg-0.0.49" = _OktNyJzh;
        "pkg-0.0.50" = _i72l4oUX;
        "pkg-0.0.51" = _52HYrNxJ;
        "pkg-0.0.52" = _YiNtivBQ;
        "pkg-0.0.53" = _MpqF3wQf;
        "pkg-0.0.54" = _ZfAIDUFZ;
        "pkg-0.0.55" = _4IBTLWAA;
        "pkg-0.0.55.1" = _XLrnXpA6;
        "pkg-0.0.56" = _jYvYmFkq;
        "pkg-0.0.57" = _zUxw6Tek;
        "pkg-0.0.58" = _uZpi6zim;
        "pkg-0.0.59" = _JO0pJ1Ok;
        "pkg-0.0.60" = _R9mbdAcD;
        "pkg-0.0.61" = _CohNG1nj;
        "pkg-0.0.62" = _EjlJJxrx;
        "pkg-0.0.63" = _bLsPfpkG;
        "pkg-0.0.64" = _YtK4KWrM;
        "pkg-0.0.65" = _NZcDPfLm;
        "pkg-0.0.66" = _qsrfdXHS;
        "pkg-0.0.66.2" = _FEwF5pHS;
        "pkg-0.0.67" = _XTdODf70;
        "pkg-26.5" = _dQ1EfSko;
        "pkg-26.5.1" = _qgYSbXTc;
        "pkg-26.5.2" = _mC6E0kB3;
        "pkg-26.5.3" = _F6RlwGAg;
        "pkg-26.6" = _qlLCN0hz;
        "pkg-26.6.1" = _2JnyXLo1;
        "pkg-26.6.2" = _p0NZTjHY;
        "pkg-26.6.3" = _U97QRjn3;
        "pkg-26.7" = _Dwh1Aetd;
        "pkg-26.7.1" = _kmxRUbsZ;
        "pkg-26.7.2" = _rj7Gdwe0;
        "pkg-26.7.3" = _FJlK0fUI;
        "pkg-26.7.4" = _CTFqQsSF;
        "pkg-26.8" = _wuWdEsrI;
        "pkg-26.8.1" = _ua1kDFi7;
        "pkg-26.8.2" = _JIbVlzgy;
        "pkg-26.9" = _UoMOLYlE;
        "default" = _UoMOLYlE;
    });
