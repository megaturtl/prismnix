...
let
    ...
    in {
        ...
        "fabric-26.3-snapshot-1" = _VmsCQqlE;
        "fabric-26.3-snapshot-2" = _VmsCQqlE;
        "fabric-26.3-snapshot-3" = _VmsCQqlE;
        "fabric-26.3-snapshot-4" = _VmsCQqlE;
        "fabric-26.3-snapshot-5" = _VmsCQqlE;
        "fabric-26.3-snapshot-6" = _VmsCQqlE;
        "fabric-26.3-snapshot-7" = _VmsCQqlE;
        "fabric-26.3-snapshot-8" = _VmsCQqlE;
        "fabric-26.3-snapshot-9" = _VmsCQqlE;
        "fabric-26.3-snapshot-10" = _VmsCQqlE;
        "fabric-26.3-pre-1" = _VmsCQqlE;
        "fabric-26.3-pre-2" = _VmsCQqlE;
        "pkg-1.0.0" = _qMBcVkRM;
        "pkg-1.1.0" = _NgNqN4Tk;
        "pkg-1.2.0" = _PDBsnLNa;
        "pkg-1.2.1" = _VmsCQqlE;
