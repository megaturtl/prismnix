...
let
    versions = (let
        ...
        _R8cJMYgv = {
            "id" = "R8cJMYgv";
            "file" = "expanded-mace-enchanting-1.0.12.jar";
            "hash" = "sha512-iJNR76t6HESmKnpuKfYmKH0KGDYiSZ8Ly9S3ik+5JxKMFnd409yHjzDRmaz99+8Bxu4gF0nWBbhDCR1ZgbhKPA==";
        };
    in {
        "FaWc5yFV" = _FaWc5yFV;
        "tngPEFS5" = _tngPEFS5;
        ...
        "pkg-1.0.8" = _bRtGWvSG;
        "pkg-1.0.9" = _9ayEfrQD;
        "pkg-1.0.10" = _Ru7DkyqU;
        "pkg-1.0.11" = _zyFa9w0V;
        "pkg-1.0.12" = _R8cJMYgv;
        "default" = _R8cJMYgv;
    });
