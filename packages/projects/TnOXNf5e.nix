...
let
    versions = (let
        ...
        _7nzkbVPa = {
            "id" = "7nzkbVPa";
            "file" = "peek-fabric-1.6.0+26.3.jar";
            "hash" = "sha512-6jsiKF60tCjWMOopNlZDjOiIyT5aNPnwYOrAFLjj6selLpV/5u0k5FUGgBcZ2bgaBY6DrVFNAvbg+HUoSTT1xA==";
        };
    in {
        "2dtpMfUt" = _2dtpMfUt;
        "uWwGD8LV" = _uWwGD8LV;
        ...
        "pkg-fabric-1.6.0+26.3" = _7nzkbVPa;
        "default" = _7nzkbVPa;
    });
