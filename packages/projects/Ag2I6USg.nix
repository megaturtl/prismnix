...
let
    versions = (let
        ...
        _FuViXb9A = {
            "id" = "FuViXb9A";
            "file" = "TownsAndNations-1.0.4-1.20-LTS.jar";
            "hash" = "sha512-UJL4LQXOwqBiJILyA6MscoWKZet25Cq9ZGs1Jhc+KmvDHCivhNBIF+GLtKXg2JurwUOFIrWQhg3Dmer8tb/VuA==";
        };
        _fLpUzGLF = {
            "id" = "fLpUzGLF";
            "file" = "TownsAndNations-1.0.4.jar";
            "hash" = "sha512-bP7oKmHfx1TW5CDY03fqKlxjZtobxCFnskyTj6uFvtzZbLWh4CMwnWlkmhOlu0/XjrZSYlYPJmOj8PzYqRaWxQ==";
        };
    in {
        "s55g7vZO" = _s55g7vZO;
        "KAwapCLr" = _KAwapCLr;
        ...
        "paper-1.20" = _FuViXb9A;
        "paper-1.20.1" = _FuViXb9A;
        "paper-1.20.2" = _FuViXb9A;
        "paper-1.20.3" = _FuViXb9A;
        "paper-1.20.4" = _FuViXb9A;
        "paper-1.20.5" = _FuViXb9A;
        "paper-1.20.6" = _FuViXb9A;
        "paper-1.21" = _FuViXb9A;
        "paper-1.21.1" = _FuViXb9A;
        "paper-1.21.2" = _FuViXb9A;
        "paper-1.21.3" = _FuViXb9A;
        "paper-1.21.4" = _FuViXb9A;
        "paper-1.21.5" = _FuViXb9A;
        "paper-1.21.6" = _FuViXb9A;
        "paper-1.21.7" = _FuViXb9A;
        "paper-1.21.8" = _FuViXb9A;
        "paper-1.21.9" = _FuViXb9A;
        "paper-1.21.10" = _FuViXb9A;
        "paper-1.21.11" = _fLpUzGLF;
        "paper-26.1" = _fLpUzGLF;
        "paper-26.1.1" = _fLpUzGLF;
        "paper-26.1.2" = _fLpUzGLF;
        "paper-26.2" = _fLpUzGLF;
        ...
        "purpur-1.21.11" = _fLpUzGLF;
        "purpur-26.1" = _fLpUzGLF;
        "purpur-26.1.1" = _fLpUzGLF;
        "purpur-26.1.2" = _fLpUzGLF;
        "purpur-26.2" = _fLpUzGLF;
        "purpur-1.20" = _FuViXb9A;
        "purpur-1.20.1" = _FuViXb9A;
        "purpur-1.20.2" = _FuViXb9A;
        "purpur-1.20.3" = _FuViXb9A;
        "purpur-1.20.4" = _FuViXb9A;
        "purpur-1.20.5" = _FuViXb9A;
        "purpur-1.20.6" = _FuViXb9A;
        "purpur-1.21" = _FuViXb9A;
        "purpur-1.21.1" = _FuViXb9A;
        "purpur-1.21.2" = _FuViXb9A;
        "purpur-1.21.3" = _FuViXb9A;
        "purpur-1.21.4" = _FuViXb9A;
        "purpur-1.21.5" = _FuViXb9A;
        "purpur-1.21.6" = _FuViXb9A;
        "purpur-1.21.7" = _FuViXb9A;
        "purpur-1.21.8" = _FuViXb9A;
        "purpur-1.21.9" = _FuViXb9A;
        "purpur-1.21.10" = _FuViXb9A;
        "pkg-0.1.10" = _s55g7vZO;
        "pkg-0.13.2" = _KAwapCLr;
        "pkg-0.13.3" = _RmoE8Xu6;
        "pkg-0.13.4" = _GQRbcmP5;
        "pkg-0.14.0" = _VZEnlIUb;
        "pkg-0.14.0-hotfix" = _h1NY3bjj;
        "pkg-0.14.2" = _bSNMJjl1;
        "pkg-0.14.3" = _rKIR6eKs;
        "pkg-0.14.4" = _caV7wrrW;
        "pkg-0.14.5" = _RO4j2KWm;
        "pkg-0.14.6" = _mu0sH1pT;
        "pkg-0.14.7" = _Mwy8EBY4;
        "pkg-0.14.8" = _1LMsBDBn;
        "pkg-0.15.0" = _NkHAEf66;
        "pkg-0.15.1" = _gj5wUNf4;
        "pkg-0.15.2" = _fbVW9RYd;
        "pkg-0.15.2-hotfix" = _CP8HUSYZ;
        "pkg-0.15.3" = _xVn4ITEz;
        "pkg-0.15.4" = _6zeQ3FR1;
        "pkg-0.15.5" = _XqTRYZ7z;
        "pkg-0.15.6" = _SCcRNbKw;
        "pkg-0.16.0" = _gZgWMaru;
        "pkg-0.16.1" = _3YtRtAeU;
        "pkg-0.16.2" = _qS9PXZEQ;
        "pkg-0.16.3" = _D5O6ifSU;
        "pkg-0.16.4" = _lYOdkpv5;
        "pkg-0.16.5" = _Lgd3oAmS;
        "pkg-0.16.6" = _2g1fdueO;
        "pkg-0.16.7" = _LdSMu8Lk;
        "pkg-0.16.8" = _NDgMaPHK;
        "pkg-0.17.0" = _yAtny4B1;
        "pkg-0.17.0-hotfix" = _XVv1oQNX;
        "pkg-0.17.1" = _WSg33ids;
        "pkg-0.17.2" = _HzA6jCVm;
        "pkg-0.17.3" = _AsT4kjFV;
        "pkg-0.17.3-hotfix" = _UDmuH1tj;
        "pkg-0.18.0" = _RL4vZ7Gk;
        "pkg-1.0.0" = _YA4EcuAv;
        "pkg-1.0.0.1" = _DksnCnZH;
        "pkg-1.0.1" = _npx4b1VL;
        "pkg-1.0.2" = _VPkHjik5;
        "pkg-1.0.3" = _WTfiFq9R;
