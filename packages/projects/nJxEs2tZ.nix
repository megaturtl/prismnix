...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.1.0" = _YHojoL9x;
        "pkg-1.19.4-1.1.1" = _T6tN7nIn;
        "pkg-1.20.1-1.1.1" = _2kVFS2z1;
        "pkg-1.19.4-1.2.0" = _CoY5dEJ0;
        "pkg-1.20.1-1.2.0" = _GCNHTNFV;
        "pkg-1.20.2-1.2.0" = _uO5uXUGQ;
        "pkg-1.19.4-1.3.0" = _p3Ro2GNU;
        "pkg-1.20.1-1.3.0" = _sULuUFFt;
        "pkg-1.20.4-1.3.0" = _7pgW0UgS;
        "pkg-1.19.4-1.3.1" = _WexecgFd;
        "pkg-1.20.1-1.3.1" = _uwdup7Cl;
        "pkg-1.20.4-1.3.1" = _LfvclYgB;
        "pkg-1.20.6-1.3.1" = _Y6fJVItB;
        "pkg-1.21-1.3.1" = _qavOgY9M;
        "pkg-1.21.1-1.3.1" = _9K9IdUnv;
        "pkg-1.21.4-1.3.1" = _MjA7a4gj;
        "pkg-1.21.5-1.3.1" = _uEpNPSiy;
        "pkg-1.19.4-1.3.2" = _iy76aF1d;
        "pkg-1.20.1-1.3.2" = _Lc9XHUPl;
        "pkg-1.20.4-1.3.2" = _F6A47wIM;
        "pkg-1.20.6-1.3.2" = _bSB8Owou;
        "pkg-1.21-1.3.2" = _oICV2NiO;
        "pkg-1.21.1-1.3.2" = _59HqiGiJ;
        "pkg-1.21.4-1.3.2" = _WFterzwZ;
        "pkg-1.21.5-1.3.2" = _CmV5G22h;
        "pkg-1.21.6-1.3.2" = _m3w9Hzdq;
        "pkg-1.21.7-1.3.2" = _7vDIaSPt;
        "pkg-1.21.6-1.3.3" = _jWb3w8DA;
        "pkg-1.21.7-1.3.3" = _aNbENqKN;
        "pkg-1.21.6-1.3.4" = _lKA2wGK6;
        "pkg-1.21.7-1.3.4" = _3WukqVgx;
        "pkg-1.21.10-1.3.5" = _7ra5pSNe;
        "pkg-1.19.4-1.3.6" = _WSBsDuTj;
        "pkg-1.20.1-1.3.6" = _V6MwcZpE;
        "pkg-1.20.4-1.3.6" = _VsHY2j1k;
        "pkg-1.20.6-1.3.6" = _26qCeKT6;
        "pkg-1.21-1.3.6" = _9sJwhxkZ;
        "pkg-1.21.1-1.3.6" = _bShUV911;
        "pkg-1.21.4-1.3.6" = _r9684yjh;
        "pkg-1.21.5-1.3.6" = _XjDJzVy3;
        "pkg-1.21.6-1.3.6" = _qxUoR1NJ;
        "pkg-1.21.8-1.3.6" = _twGJelhB;
        "pkg-1.21.10-1.3.6" = _RjdVWnGT;
        "pkg-1.21.11-1.3.6" = _WjawJNFN;
        "pkg-1.21.6-1.3.7" = _bxt1bCz4;
        "pkg-1.21.8-1.3.7" = _1aEFXFs1;
        "pkg-1.21.10-1.3.7" = _ggldsUKj;
        "pkg-1.21.11-1.3.7" = _Mup7FXoZ;
