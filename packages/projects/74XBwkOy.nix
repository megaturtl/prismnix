...
let
    versions = (let
        ...
        _DjQJPxqR = {
            "id" = "DjQJPxqR";
            "file" = "multicount-neoforge-1.2.4-26.3.jar";
            "hash" = "sha512-kdTIWuup3fBDfRImtilZFXRqaye5fSgpT97XR7jQuJZNQFmZpx0H+C2lUk7iCCpeASRdQxDVrBljGhJZ9d+JEg==";
        };
        _U8YxJpIC = {
            "id" = "U8YxJpIC";
            "file" = "multicount-fabric-1.2.4-26.3.jar";
            "hash" = "sha512-fx46/FazC9D1vnBpWMXPAWu7kD7K4IIY8wKwrf97GbuWv7IAsziVhYuzlB5ZIk4uQZhigBJFW4Gdq/kzqYSxDA==";
        };
    in {
        "NWos5BAX" = _NWos5BAX;
        "TMgIXfEa" = _TMgIXfEa;
        ...
        "neoforge-26.3" = _DjQJPxqR;
        "pkg-1.0.1" = _NWos5BAX;
        "pkg-1.1.0-1.19.3" = _TMgIXfEa;
        "pkg-1.1.0-1.19.4" = _bI0yBIRm;
        "pkg-1.1.0-1.20.1" = _KZxAyAvZ;
        "pkg-1.1.0-1.20.2" = _ZmF91U34;
        "pkg-1.1.0-1.20.3" = _2myYuwdS;
        "pkg-1.1.0-1.20.4" = _kzTCaWXA;
        "pkg-1.2.0-1.17" = _ZP0TXCiI;
        "pkg-1.2.0-1.18.1" = _ErNJHqk0;
        "pkg-1.2.0-1.18.2" = _U1XjZTLB;
        "pkg-1.2.0-1.19.2" = _NQc3Pjkh;
        "pkg-1.2.0-1.19.3" = _wn8IPVTh;
        "pkg-1.2.0-1.19.4" = _hnpwPFZ8;
        "pkg-1.2.0-1.20.1" = _59DbXSpq;
        "pkg-1.2.0-1.20.2" = _6IHoXKfu;
        "pkg-1.2.0-1.20.3" = _taNd2DJi;
        "pkg-1.2.0-1.20.4" = _doJ1KKcT;
        "pkg-1.2.0-1.20.6" = _zD2QvuzL;
        "pkg-1.2.0-1.21" = _x9Vs8zlv;
        "pkg-1.2.1-1.17" = _RUHuFIFt;
        "pkg-1.2.1-1.18.1" = _2h0FAhDl;
        "pkg-1.2.1-1.18.2" = _7cBKoJC6;
        "pkg-1.2.1-1.19.2" = _JKnDlNWg;
        "pkg-1.2.1-1.19.3" = _teaHJ9Ar;
        "pkg-1.2.1-1.19.4" = _9smGqGQi;
        "pkg-1.2.1-1.20.1" = _5Eg87hvc;
        "pkg-1.2.1-1.20.2" = _w2n2hwJU;
        "pkg-1.2.1-1.20.3" = _VkHY3k15;
        "pkg-1.2.1-1.20.4" = _lIspH8mR;
        "pkg-1.2.1-1.20.6" = _n1AH1Spd;
        "pkg-1.2.1-1.21" = _Vud2gINV;
        "pkg-1.2.1-1.21.5" = _9YcjvXl7;
        "pkg-1.2.2-1.18.1" = _1cdC6wJD;
        "pkg-1.2.2-1.18.2" = _VqNhKeLH;
        "pkg-1.2.2-1.19.2" = _6Jvms6kt;
        "pkg-1.2.2-1.19.3" = _ebeDKCMh;
        "pkg-1.2.2-1.19.4" = _UT0litVx;
        "pkg-1.2.2-1.20.1" = _oe6OJrYm;
        "pkg-1.2.2-1.20.2" = _kRcqQtqw;
        "pkg-1.2.2-1.20.3" = _bh2F7Vi8;
        "pkg-1.2.2-1.20.4" = _sA64B3Uh;
        "pkg-1.2.2-1.20.6" = _Kq6agnRs;
        "pkg-1.2.2-1.21" = _7TPzYHh6;
        "pkg-1.2.2-1.21.5" = _rKufKkCt;
        "pkg-1.2.3-1.18.1" = _IwQU0blk;
        "pkg-1.2.3-1.18.2" = _xuV2uxGN;
        "pkg-1.2.3-1.19.2" = _KOlyKGcJ;
        "pkg-1.2.3-1.19.3" = _GE2gcIuS;
        "pkg-1.2.3-1.19.4" = _eLO3cMsB;
        "pkg-1.2.3-1.20.1" = _QXgjtL7x;
        "pkg-1.2.3-1.17" = _426EkdqD;
        "pkg-1.2.3-1.17.1" = _yk15DN2p;
        "pkg-1.2.3-1.21.6" = _XP3viljZ;
        "pkg-1.2.3-1.21.9" = _W50sALkX;
        "pkg-1.2.3-1.21.11" = _EtUZRdwx;
        "pkg-1.2.3-26.1" = _LA2YB3uy;
        "pkg-1.2.4-26.2" = _bKYKTLL6;
        "pkg-1.2.4-26.3" = _U8YxJpIC;
        "default" = _U8YxJpIC;
    });
