...
let
    ...
    in {
        ...
        "pkg-1.19.2-1.0.1+fabric" = _8ZlwBDja;
        "pkg-1.18.2-1.0.1+fabric" = _hPBX6OFM;
        "pkg-1.18.2-1.0.1+forge" = _LjC6fzjt;
        "pkg-1.19.2-1.0.2+forge" = _gdVNYc3w;
        "pkg-1.19.2-1.0.2+fabric" = _1tUtT2kT;
        "pkg-1.18.2-1.0.2+fabric" = _MaYvvIfF;
        "pkg-1.18.2-1.0.2+forge" = _S1pvGtSC;
        "pkg-1.18.2-1.0.3+fabric" = _xhYm4qsF;
        "pkg-1.19.2-1.0.3+fabric" = _gkZRWAzf;
        "pkg-1.19.2-1.0.3+forge" = _T9IIKg4d;
        "pkg-1.18.2-1.0.3+forge" = _yXwR4OMH;
        "pkg-1.19.2-1.1.0+forge" = _uUlsGO6e;
        "pkg-1.19.2-1.1.0+fabric" = _g2VNuFdH;
        "pkg-1.19.2-1.1.1+forge" = _h4N5WziD;
        "pkg-1.19.2-1.1.1+fabric" = _cJJwuk7j;
        "pkg-1.18.2-1.1.2+fabric" = _lZ70idk9;
        "pkg-1.18.2-1.1.2+forge" = _q7qVs8KA;
        "pkg-1.19.2-1.1.2+forge" = _cw9oZEFo;
        "pkg-1.19.2-1.1.2+fabric" = _k2JdDVWj;
        "pkg-1.20.1-1.1.3+fabric" = _Gg3mZoOc;
        "pkg-1.20.1-1.1.3+forge" = _foRgIoXY;
        "pkg-1.19.2-1.1.3+forge" = _LteQ5iG9;
        "pkg-1.19.2-1.1.3+fabric" = _EQUaRI0m;
        "pkg-1.19.2-1.1.4+forge" = _N0ZIW5Y9;
        "pkg-1.19.2-1.1.4+fabric" = _GogaQgNr;
        "pkg-1.20.1-1.1.4+fabric" = _NmhR6jIY;
        "pkg-1.20.1-1.1.4+forge" = _ehPc0G14;
        "pkg-1.20.4-1.1.4+neoforge" = _WEmUmcec;
        "pkg-1.20.4-1.1.5+neoforge" = _7dSIgzyf;
        "pkg-1.20.4-1.1.6+neoforge" = _cj9FGAyI;
        "pkg-1.21.1-1.1.7+neoforge" = _zhskqkTl;
        "pkg-1.20.1-1.1.5+forge" = _Gm7oyczu;
        "pkg-1.21.1-1.1.8+neoforge" = _a7QNsSHf;
        "pkg-1.21.1-1.2.0+neoforge" = _E46AplqZ;
        "pkg-1.21.1-1.3.0+neoforge" = _yxK9eH0D;
        "pkg-1.21.1-1.4.0+neoforge" = _w2EExo5P;
        "pkg-1.21.1-1.4.1+neoforge" = _kkJqmO8M;
        "pkg-1.21.1-1.4.2+neoforge" = _5DF41VC3;
