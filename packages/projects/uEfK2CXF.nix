...
let
    ...
    in {
        ...
        "pkg-1.3.2.210" = _UPJ66js9;
        "pkg-1.3.3.218" = _P1UMboiy;
        "pkg-1.3.3.219" = _i4t5tKre;
        "pkg-1.3.3.221" = _9asukDKd;
        "pkg-1.4.0.222" = _acEnHucn;
        "pkg-1.4.0.234" = _kXPl1K7n;
        "pkg-1.3.3.235" = _FrNSFWs1;
        "pkg-1.4.0.237" = _YeJizbIC;
        "pkg-1.4.0.238" = _ecxqA4B1;
        "pkg-1.4.1.245" = _CE7US0VJ;
        "pkg-1.4.1.246" = _5HCwEHcA;
        "pkg-1.4.0.247" = _9HWvOVzO;
        "pkg-1.2.3.243" = _aaOvWcSb;
        "pkg-1.5.0.3" = _KkFzQwYU;
        "pkg-1.5.0.4" = _sJc9YCci;
        "pkg-1.5.0.6" = _wDMSWTQh;
        "pkg-1.5.0.7" = _jcGYP1Lg;
        "pkg-1.5.0.5" = _pqD74Idp;
        "pkg-1.5.0.8" = _4GiQ5hA4;
        "pkg-1.5.1.9" = _obTYX94A;
        "pkg-1.5.1.10" = _Q6NTJRvk;
        "pkg-1.6.0.11" = _ZS5fdj6i;
        "pkg-1.6.0.12" = _p6b7O5Cp;
        "pkg-1.6.0.13" = _yhPJo7Qa;
        "pkg-1.6.0.14" = _PJo4kPKe;
        "pkg-1.6.0.15" = _ebBjhcd3;
        "pkg-1.6.0.16" = _APHqJNeA;
        "pkg-1.6.0.17" = _TgNFki8j;
        "pkg-1.8.0.19" = _C9RC1QPd;
        "pkg-1.8.1.20" = _U4ITLvrh;
        "pkg-1.8.1.21" = _7isqdbV6;
        "pkg-1.8.1.22" = _fH4GgWlj;
        "pkg-1.8.1.23" = _Cyk0piZa;
        "pkg-1.8.1.24" = _C3QfjVQh;
        "pkg-1.8.1.25" = _iNk5Mti6;
        "pkg-1.8.1.26" = _tdnTF7T3;
        "pkg-1.8.1.27" = _A2NhF2ea;
        "pkg-1.8.1.28" = _DGs7QBVM;
        "pkg-1.8.1.29" = _QskiLRR4;
        "pkg-1.9.0.30" = _3xCpGoZN;
        "pkg-1.9.0.31" = _wtZJoBTD;
        "pkg-1.8.2.33" = _Fh338zyF;
        "pkg-1.10.0.35" = _WxVV3vkT;
        "pkg-1.10.0.37" = _TV40PS1V;
        "pkg-1.11.0.38" = _gxoNb1Oc;
