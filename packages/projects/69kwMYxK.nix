...
let
    versions = (let
        ...
        _WvpqFur6 = {
            "id" = "WvpqFur6";
            "file" = "Stone Brick Overlay.zip";
            "hash" = "sha512-Ttbmf9b4eL3gWt54VXPEO+epOI48eiG4vX/2Y8rq9hCAhQbJ2LYGssAAURhNcUnf/QgFv5dx8+BH23hLzwEsYA==";
        };
    in {
        "1fhZ51nM" = _1fhZ51nM;
        "jsHrkqxx" = _jsHrkqxx;
        ...
        "minecraft-1.21" = _WvpqFur6;
        "minecraft-1.21.1" = _WvpqFur6;
        "minecraft-1.21.2" = _WvpqFur6;
        "minecraft-1.21.3" = _WvpqFur6;
        "minecraft-1.21.4" = _WvpqFur6;
        "minecraft-1.21.5" = _WvpqFur6;
        "minecraft-1.21.6" = _WvpqFur6;
        "minecraft-1.21.7" = _WvpqFur6;
        "minecraft-1.21.8" = _WvpqFur6;
        "minecraft-1.21.9" = _WvpqFur6;
        "minecraft-1.21.10" = _WvpqFur6;
        "minecraft-1.21.11" = _WvpqFur6;
        "minecraft-26.1" = _WvpqFur6;
        "minecraft-26.1.1" = _WvpqFur6;
        "minecraft-26.1.2" = _WvpqFur6;
        "minecraft-26.2" = _WvpqFur6;
        "minecraft-26.3" = _WvpqFur6;
        "pkg-1.1" = _1fhZ51nM;
        "pkg-1.2" = _jsHrkqxx;
        "pkg-1.3" = _RCZODOJw;
        "pkg-1.4" = _xFHK5Gdl;
