...
let
    ...
    in {
        ...
        "pkg-0.6.3" = _R8AAL5QA;
        "pkg-0.8.2" = _JrRfsetD;
        "pkg-0.10.1" = _4Fiiibjz;
        "pkg-0.10.2" = _s0QXcjDR;
        "pkg-0.10.3" = _Ypu2rJge;
        "pkg-0.10.4" = _fl2rPKG4;
        "pkg-0.3.2" = _qntpbqJ1;
        "pkg-0.4.4" = _pzAY92sL;
        "pkg-0.5.2" = _sB8qRRpO;
        "pkg-0.7.6" = _BT0v6yHV;
        "pkg-0.9.3" = _Ozu5WJ8B;
        "pkg-0.4.1" = _98nI1UwC;
        "pkg-0.10.5" = _NriqaPXZ;
        "pkg-0.11.1" = _W93y2eXh;
        "pkg-0.4.6" = _hoKDc3Nk;
        "pkg-0.11.2" = _yRUv0Qt5;
        "pkg-0.4.7" = _fn7ZVmRS;
        "pkg-0.10.6" = _yaG0LYaH;
        "pkg-0.4.8" = _T8ekM3pE;
        "pkg-1219.1.1" = _klpeDhll;
        "pkg-12110.1.1" = _VPAUGv8b;
        "pkg-0.10.7" = _6VHLDLSY;
