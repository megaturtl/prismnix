...
let
    versions = (let
        ...
        _GTvgLvTw = {
            "id" = "GTvgLvTw";
            "file" = "tradetweaks-1.20.1-2.2.0.jar";
            "hash" = "sha512-yJhfS+A6njCsWIch28bPdQzcZObec8NWPt1tWfD1HgI+KmVBb9e534IVu0ETPtrdtpCJvNVFlcGd4aE65KznQQ==";
        };
        _1wk4HggX = {
            "id" = "1wk4HggX";
    ...
    in {
        ...
        "pkg-0.2.4" = _OkLjJfDw;
        "pkg-1.0.0" = _CIAtR6LA;
        "pkg-1.21.1-1.0.0" = _V6AxuZ8a;
        "pkg-1.21.1-1.1.0" = _VFQcVfZm;
        "pkg-1.20.1-1.1.0" = _fJ1tbkwi;
        "pkg-1.20.1-2.0.0" = _TVR6pKIv;
