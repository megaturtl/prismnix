...
let
    versions = (let
        ...
        _c2Lpjjb2 = {
            "id" = "c2Lpjjb2";
            "file" = "hearts_cyan-1.1.0-mc26.3.zip";
            "hash" = "sha512-mN+ZxZZFDGNtxQosjHh5lkLO5Omxb38jlPGXvm2ml6rjDAsPnQhvnIXM8clvNMonbwx4K9+otxvzW328UV61fg==";
        };
    in {
        "bjKePwBL" = _bjKePwBL;
        "4HeOiKWF" = _4HeOiKWF;
