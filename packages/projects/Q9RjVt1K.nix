...
let
    ...
    in {
        ...
        "pkg-1.0.0--1.20.1" = _o6RWmVmo;
        "pkg-1.1.1--1.18.2" = _JIWLQ0zT;
        "pkg-1.1.1--1.20.1" = _WxLBrP14;
        "pkg-1.2.3--1.18.2" = _jUpumlsK;
        "pkg-1.2.3--1.20.1" = _eTOKkzgn;
        "pkg-1.3.0--1.18.2" = _IGhEKxbW;
        "pkg-1.3.0--1.20.1" = _7mIjP4P5;
        "pkg-1.3.5--1.18.2" = _AfSyQ7Dp;
        "pkg-1.3.5--1.20.1" = _Gww16rfr;
        "pkg-1.4.0--1.20.1" = _DdNRfliV;
        "pkg-1.4.0--1.18.2" = _P4aQukzF;
        "pkg-1.5.0--1.18.2" = _VeIr8YEV;
        "pkg-1.5.0--1.20.1" = _rhpPhfBM;
        "pkg-1.5.3--1.20.1" = _dhlJ78PZ;
        "pkg-1.5.3--1.18.2" = _uqHTht2M;
        "pkg-1.8.3--1.18.2" = _efH3vjuC;
        "pkg-1.8.3--1.20.1" = _LIenIzEN;
        "pkg-1.9.0--1.18.2" = _6D1FXpSZ;
        "pkg-1.9.0--1.20.1" = _vMzZgT4C;
        "pkg-1.10.3--1.18.2" = _HdMOhTDa;
        "pkg-1.10.3--1.20.1" = _AiLVkLSH;
        "pkg-2.0.3--1.18.2" = _tUUzyU9X;
        "pkg-2.0.5--1.20.1" = _fb8o406L;
        "pkg-2.0.5--1.18.2" = _da8DBfwe;
        "pkg-3.3.3--1.16.5" = _KEz0xeJV;
        "pkg-3.3.3--1.18.2" = _hWFy8dES;
        "pkg-3.3.3--1.20.1" = _fXVbLdtG;
        "pkg-4.3.3--1.20.1" = _MsqMsTH7;
        "pkg-4.5.0--1.16.5" = _41NxTAHO;
        "pkg-4.5.0--1.18.2" = _FuXxyUdJ;
        "pkg-4.5.0--1.20.1" = _QrYDnUEH;
        "pkg-4.5.0--1.20.1-beta-5" = _9pO5xklu;
        "pkg-4.5.0--1.20.1-beta-7" = _asYHj2c9;
        "pkg-4.5.2--1.18.2" = _L6qh4Vj6;
        "pkg-4.5.3--1.18.2" = _BTbvy4Ll;
        "pkg-4.6.3--1.20.1--Normal-Build" = _98myiifJ;
