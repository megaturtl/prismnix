...
let
    versions = (let
        ...
        _biEvxQIS = {
            "id" = "biEvxQIS";
            "file" = "wakes-0.7.1+26.2.jar";
            "hash" = "sha512-3seb4OUA0cWEZXMo1IUFBBw/7m4HWvyjDrwZeR4Vl2b37F78EyyLqtTpWl427JoCdG+S8hrAAA28OwUE1WCASQ==";
        };
    in {
        "bHBG6hgx" = _bHBG6hgx;
        "1DsPbYy8" = _1DsPbYy8;
