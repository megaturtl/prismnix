...
let
    versions = (let
        ...
        _awPQNJpc = {
            "id" = "awPQNJpc";
            "file" = "useless-reptile-0.14.2-26.1.2.jar";
            "hash" = "sha512-XBb+0X0tlz1kRn1sqfS+mBhoUvR12IUFhgW716b2RL+GP1KQthE2L9NQCI9ZgB1op13ZkH4uO0iy1SxQoj+qAA==";
        };
        _VFNShszQ = {
            "id" = "VFNShszQ";
            "file" = "useless-reptile-0.14.2-26.2.jar";
            "hash" = "sha512-Bg/Ca2bqXSe+oSyFJp/TzN39BOzQIIU2yBCNKHMwfn2rfOFFilzwsVS5hdtNEV8z7n+sWj62BELkcd2DkouJ9Q==";
        };
        _YAWa3s1c = {
            "id" = "YAWa3s1c";
            "file" = "useless-reptile-0.14.2-26.3.jar";
            "hash" = "sha512-8O1Tm6u9sgGKqM7YOqHmnInepckEurN7k2pQSHjY3WiJ1HK+LICQE5wKvhlVQ5k9R2pyb0zswa0BEhFsjGQ0OA==";
        };
    in {
        "4eaOxuh0" = _4eaOxuh0;
        "t60ZvxNk" = _t60ZvxNk;
        ...
        "fabric-26.1" = _awPQNJpc;
        "fabric-26.1.1" = _awPQNJpc;
        "fabric-26.1.2" = _awPQNJpc;
        "fabric-26.2" = _VFNShszQ;
        "fabric-26.3" = _YAWa3s1c;
        "pkg-0.1.0" = _4eaOxuh0;
        "pkg-0.1.1" = _t60ZvxNk;
        "pkg-0.1.2" = _6nxmqEiR;
        "pkg-0.1.3" = _hPDmxl7i;
        "pkg-0.1.4" = _eIPJiQLN;
        "pkg-0.1.5" = _2977Frqq;
        "pkg-0.1.5.1-22w43a" = _OzNTeRf6;
        "pkg-0.1.5.2-22w45a" = _h8NFeMCI;
        "pkg-0.1.5.3-1.19.3" = _Kf4WUcLc;
        "pkg-0.1.6-1.19.2" = _Ye2Mczil;
        "pkg-0.1.6.1-1.19.2" = _BFtNf5H8;
        "pkg-0.1.7-1.19.2" = _acfybGoX;
        "pkg-0.1.7-1.19.3" = _l85wAPvw;
        "pkg-0.1.8-1.19.3" = _sLbIN84a;
        "pkg-0.1.8-1.19.2" = _mMtWpKg6;
        "pkg-0.1.9-1.19.2" = _tKkWNyAm;
        "pkg-0.1.9-1.19.3" = _8Eb34LLH;
        "pkg-0.1.10-1.19.3" = _erei8wCS;
        "pkg-0.1.10-1.19.2" = _emTaa7Su;
        "pkg-0.1.11-1.19.3" = _jmUBMz97;
        "pkg-0.1.11-1.19.4" = _Xy2hVdf3;
        "pkg-0.1.11-1.19.2" = _jKMdnxe7;
        "pkg-0.2.0-1.19.2" = _mXu3JeNM;
        "pkg-0.2.1-1.19.4" = _TriR0ylE;
        "pkg-0.2.1-1.19.2" = _katxoXgP;
        "pkg-0.2.2-1.19.2" = _LmHwh0n5;
        "pkg-0.2.2-1.19.4" = _xLVwVo2t;
        "pkg-0.2.2-1.20.1" = _5SRSHPP2;
        "pkg-0.3.0-1.20.1" = _Ufplhoav;
        "pkg-0.4.0-1.20.1" = _QlB61Pnf;
        "pkg-0.4.1-1.20.1" = _qq53WnXp;
        "pkg-0.4.2-1.20.1" = _lMhjlS65;
        "pkg-0.4.3-1.20.1" = _OUJcuJy1;
        "pkg-0.5.0-1.20.1" = _renOQLwR;
        "pkg-0.5.0-1.20.2" = _bEkibyn9;
        "pkg-0.6.0-1.20.2" = _PHQ8BREE;
        "pkg-0.6.0-1.20.1" = _dKCfBwYY;
        "pkg-0.6.0-1.19.2" = _x1L6yYw4;
        "pkg-0.6.1-1.19.2" = _I5DkCYUd;
        "pkg-0.6.1-1.20.1" = _ASzFaVJd;
        "pkg-0.6.1-1.20.2" = _S8VnQbrD;
        "pkg-0.6.2-1.19.2" = _UqU3J7JE;
        "pkg-0.6.2-1.20.1" = _Km6nUhaN;
        "pkg-0.6.2-1.20.2" = _U27YtlTw;
        "pkg-0.6.2-1.20.3" = _XzjnSNhO;
        "pkg-0.6.3-1.19.2" = _5IU2UaPV;
        "pkg-0.6.3-1.20.1" = _jvHhc5t8;
        "pkg-0.6.3-1.20.2" = _JAYgCcpz;
        "pkg-0.6.3-1.20.4" = _hlad7j3d;
        "pkg-0.6.4-1.20.4" = _sRpAuvDh;
        "pkg-0.6.5-1.20.1" = _NeHB3Kvp;
        "pkg-0.6.5-1.20.2" = _W4fUQWn2;
        "pkg-0.6.5-1.20.4" = _pF8yNv6p;
        "pkg-0.7.0-1.19.2" = _T56th5RO;
        "pkg-0.7.0-1.20.1" = _OCA2VFkr;
        "pkg-0.7.0-1.20.4" = _WV5PdT2Y;
        "pkg-0.7.1-1.19.2" = _dPuUcsAj;
        "pkg-0.7.1-1.20.1" = _bniirLJF;
        "pkg-0.7.1-1.20.4" = _1bri4Ggd;
        "pkg-0.7.2-1.20.6" = _vRjT7Waz;
        "pkg-0.7.2-1.20.4" = _Da52OFb4;
        "pkg-0.7.2-1.20.1" = _uBP0YgKu;
        "pkg-0.7.2-1.19.2" = _1uRVNuAd;
        "pkg-0.7.3-1.19.2" = _nLbY9Okk;
        "pkg-0.7.3-1.20.1" = _1w1dYCpY;
        "pkg-0.7.3-1.20.4" = _2tnrodpF;
        "pkg-0.7.3-1.20.6" = _kGNhwD8g;
        "pkg-0.7.4-1.21" = _ryoXFnrO;
        "pkg-0.7.4-1.20.6" = _vdGCBKkx;
        "pkg-0.7.4-1.20.4" = _aYOAmYWZ;
        "pkg-0.7.4-1.20.1" = _KXJERg1T;
        "pkg-0.7.4-1.19.2" = _RXjiSNPs;
        "pkg-0.7.4.1-1.21" = _GIsvnxd1;
        "pkg-0.7.4.2-1.21" = _D1Mqn72A;
        "pkg-0.8.1-1.21.1" = _64ygxPde;
        "pkg-0.8.2-1.21.1" = _sKuEYswb;
        "pkg-0.8.3-1.21.1" = _38lcL201;
        "pkg-0.9.0-1.21.1" = _zTeCK9Al;
        "pkg-0.9.1-1.21.4" = _COiZsS58;
        "pkg-0.9.2-1.21.4" = _Rc3ttBkz;
        "pkg-0.9.3-1.21.1" = _lDqHClME;
        "pkg-0.9.3-1.21.4" = _5lSKQ1Xi;
        "pkg-0.9.3.1-1.21.4" = _xr8UQpFM;
        "pkg-0.9.4-1.21.4" = _Nni4wgM4;
        "pkg-0.9.5-1.21.1" = _Gkjed4R9;
        "pkg-0.9.6-1.21.4" = _Oxc1cT9W;
        "pkg-0.9.6-1.21.1" = _5nbaUdOr;
        "pkg-0.9.7-1.21.1" = _OIeeA02i;
        "pkg-0.9.7-1.21.4" = _tYf41LMO;
        "pkg-0.9.8-1.21.4" = _hsoshEFf;
        "pkg-0.9.8-1.21.1" = _vN7cmG4E;
        "pkg-0.10.0-1.21.5" = _WqeAFazD;
        "pkg-0.10.1-1.21.5" = _j363DbZS;
        "pkg-0.10.1-1.21.6" = _S85RIo6a;
        "pkg-0.9.9-1.21.1" = _H9wrkzEf;
        "pkg-0.9.9-1.21.4" = _CPa2kI7S;
        "pkg-0.10.2-1.21.5" = _VEPZExNK;
        "pkg-0.10.2-1.21.6" = _nCYT7nfs;
        "pkg-0.9.10-1.21.1" = _zCQujoTc;
        "pkg-0.9.10-1.21.4" = _ap7IZfhD;
        "pkg-0.10.3-1.21.5" = _SebyW0Sw;
        "pkg-0.10.3-1.21.6" = _HVaItEJl;
        "pkg-0.10.4-1.21.7" = _QyOaiHbo;
        "pkg-0.10.4-1.21.5" = _17JvSNiM;
        "pkg-0.9.11-1.21.1" = _blwTO88r;
        "pkg-0.9.11-1.21.4" = _BIGuua5J;
        "pkg-0.10.5-1.21.5" = _6ebm1mtd;
        "pkg-0.10.5-1.21.7" = _GhYphnaJ;
        "pkg-0.11.0-1.21.8" = _O3nEYIdX;
        "pkg-0.9.12-1.21.1" = _QV9AIs0q;
        "pkg-0.9.13-1.21.1" = _fLxTE60B;
        "pkg-0.11.1-1.21.8" = _rE8lD5RK;
        "pkg-0.12.0-1.21.11" = _lglFgr6d;
        "pkg-0.12.1-1.21.11" = _zlLD8ycc;
        "pkg-0.12.2-1.21.11" = _hGd7xUDf;
        "pkg-0.12.3-1.21.11" = _jGGPMBUS;
        "pkg-0.13.0-26.1" = _OpXduTjb;
        "pkg-0.13.1-26.1" = _LLr6FmZ7;
        "pkg-0.13.2-26.1" = _dj9I5VHB;
        "pkg-0.13.3-26.1.2" = _9ADSlKHI;
        "pkg-0.13.3-26.2" = _M5Au3Tdi;
        "pkg-0.13.4-26.1.2" = _ZK3RYyAt;
        ...
        "pkg-0.14.2-26.1.2" = _awPQNJpc;
        "pkg-0.14.2-26.2" = _VFNShszQ;
        "pkg-0.14.2-26.3" = _YAWa3s1c;
        "default" = _YAWa3s1c;
    });
