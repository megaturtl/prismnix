...
let
    ...
    in {
        ...
        "pkg-1.0.1-fabric-mc1.20" = _fKPun8XZ;
        "pkg-1.0.1-forge-mc1.20" = _IbKWDpII;
        "pkg-1.0.1-forge-mc1.19.2" = _QloMjpnm;
        "pkg-1.0.1-forge-mc1.19.4" = _7RnRX9FM;
        "pkg-1.0.1-fabric-mc1.19.2" = _DHqaQgii;
        "pkg-1.0.1-fabric-mc1.19.4" = _NHls3Y3u;
        "pkg-1.0.2-forge-mc1.19.2" = _UDa9EZ7c;
        "pkg-1.0.2-forge-mc1.19.4" = _eGE4hLjz;
        "pkg-1.0.2-forge-mc1.20" = _coW5xpTI;
        "pkg-1.0.2-fabric-mc1.19.2" = _hJsMSHxp;
        "pkg-1.0.2-fabric-mc1.19.4" = _vztA1LrJ;
        "pkg-1.0.2-fabric-mc1.20" = _ZWJHChp3;
        "pkg-1.0.2-forge-mc1.20.4" = _yRRn9td3;
        "pkg-1.0.2-fabric-mc1.20.4" = _cFQMTsQ0;
        "pkg-1.0.2-neoforge-mc1.20.4" = _cQW6vymc;
        "pkg-1.0.2-forge-mc1.20.6" = _FIoxInI6;
        "pkg-1.0.2-forge-mc1.21" = _xk9zbpzu;
        "pkg-1.0.2-fabric-mc1.20.6" = _a4aHS3Kq;
        "pkg-1.0.2-fabric-mc1.21" = _MWH0DcT7;
        "pkg-1.0.2-neoforge-mc1.20.6" = _bR8SR8zU;
        "pkg-1.0.2-neoforge-mc1.21" = _7KzsjTQH;
        "pkg-1.0.2a-forge-mc1.20.6" = _YR0Vrszr;
        "pkg-1.0.2a-forge-mc1.21" = _wr5btaN8;
        "pkg-1.0.2a-neoforge-mc1.20.4" = _aRO0dzom;
        "pkg-1.0.2a-neoforge-mc1.20.6" = _o6wzwM02;
        "pkg-1.0.2a-neoforge-mc1.21" = _m85uEYqg;
        "pkg-1.0.2a-forge-mc1.19.2" = _rvPX81u3;
        "pkg-1.0.2a-forge-mc1.19.4" = _Cc6LIGmH;
        "pkg-1.0.2a-forge-mc1.20.2" = _b1oQODQL;
        "pkg-1.0.2a-forge-mc1.20.4" = _iaqfINrn;
        "pkg-1.0.2-fabric-mc1.21.2" = _vQlYFmo0;
        "pkg-1.0.2-neoforge-mc1.21.3" = _NMjQvzhD;
        "pkg-1.0.3-forge-mc1.19.2" = _fdxBKosn;
        "pkg-1.0.3-forge-mc1.19.4" = _6EsfQVGU;
        "pkg-1.0.3-forge-mc1.20.2" = _CYhqOhL6;
        "pkg-1.0.3-forge-mc1.20.4" = _Wvy91xH3;
        "pkg-1.0.3-forge-mc1.20.6" = _xynMfdQE;
        "pkg-1.0.3-forge-mc1.21" = _Q9z5hei0;
        "pkg-1.0.3-fabric-mc1.19.2" = _BTy6LeWz;
        "pkg-1.0.3-fabric-mc1.19.4" = _hP0v7LxQ;
        "pkg-1.0.3-fabric-mc1.20.2" = _F4xBttNI;
        "pkg-1.0.3-fabric-mc1.20.4" = _O1y3OF9r;
        "pkg-1.0.3-fabric-mc1.20.6" = _HXHlvPKz;
        "pkg-1.0.3-fabric-mc1.21" = _r0qroMg5;
        "pkg-1.0.3-fabric-mc1.21.2" = _1kcjaPDC;
        "pkg-1.0.3-neoforge-mc1.20.4" = _jTBKzEJw;
        "pkg-1.0.3-neoforge-mc1.20.6" = _au4xmhB4;
        "pkg-1.0.3-neoforge-mc1.21" = _sfje5A2Q;
        "pkg-1.0.3-neoforge-mc1.21.3" = _HXbc16sh;
        "pkg-1.0.3-forge-mc1.21.4" = _kzmdswFS;
        "pkg-1.0.3-forge-mc1.21.6" = _TwUwj6GE;
        "pkg-1.0.3-fabric-mc1.21.6" = _X0dqjVSV;
        "pkg-1.0.3-neoforge-mc1.21.6" = _JMlTUIRI;
        "pkg-1.0.4-forge-mc1.19.2" = _Ug1BdYAC;
        "pkg-1.0.4-forge-mc1.19.4" = _zENdqCp9;
        "pkg-1.0.4-forge-mc1.20.2" = _5zgQmLP4;
        "pkg-1.0.4-forge-mc1.20.4" = _VA8KpwQe;
        "pkg-1.0.4-forge-mc1.20.6" = _Hd9kql7b;
        "pkg-1.0.4-forge-mc1.21" = _dkDLfdQY;
        "pkg-1.0.4-forge-mc1.21.5" = _Uh0WzQFK;
        "pkg-1.0.4-forge-mc1.21.6" = _9La5IsLW;
        "pkg-1.0.4-fabric-mc1.19.2" = _reoXssiy;
        "pkg-1.0.4-fabric-mc1.19.4" = _4cH6Ql1i;
        "pkg-1.0.4-fabric-mc1.20.2" = _FbtyN8OC;
        "pkg-1.0.4-fabric-mc1.20.4" = _1Y4FKVR5;
        "pkg-1.0.4-fabric-mc1.20.6" = _WTdB6FJw;
        "pkg-1.0.4-fabric-mc1.21" = _pLhfeCZ4;
        "pkg-1.0.4-fabric-mc1.21.5" = _p4VpBLpd;
        "pkg-1.0.4-fabric-mc1.21.6" = _rUuSzfru;
        "pkg-1.0.4-neoforge-mc1.20.4" = _CdNQhCWO;
        "pkg-1.0.4-neoforge-mc1.20.6" = _QAKaKsxW;
        "pkg-1.0.4-neoforge-mc1.21" = _ybUmDE8h;
        "pkg-1.0.4-neoforge-mc1.21.5" = _GMJesn5H;
        "pkg-1.0.4-neoforge-mc1.21.6" = _y94iT6ar;
        "pkg-1.0.4a-forge-mc1.21.4" = _tOC2VlQt;
        "pkg-1.0.4a-fabric-mc1.21.4" = _ejm9nEw5;
        "pkg-1.0.4a-neoforge-mc1.21.4" = _rxSsi59l;
        "pkg-1.0.4-neoforge-mc1.21.9" = _zr0IwIUJ;
        "pkg-1.0.4-forge-mc1.21.11" = _cEMkk70f;
        "pkg-1.0.4-fabric-mc1.21.11" = _LtVqLEE5;
        "pkg-1.0.4-neoforge-mc1.21.11" = _j3V7Jnsb;
        "pkg-1.0.4-forge-mc26.1" = _J7bpazG9;
        "pkg-1.0.4-fabric-mc26.1" = _Pix8JGot;
        "pkg-1.0.4-neoforge-mc26.1" = _YPZjwtsk;
