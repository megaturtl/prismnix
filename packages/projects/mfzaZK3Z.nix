...
let
    versions = (let
        ...
        _6oiYkLHk = {
            "id" = "6oiYkLHk";
            "file" = "ears-thermite-2.0.0.jar";
            "hash" = "sha512-VPPl+upwcNUhYkK5096ViuZ8s+6WgUyDEnAJJvhRunVQ4d0qw9vnFJrqNZE80wNjTa75YnM38eIqijPpM7yM+A==";
        };
        _Oy3spSmn = {
            "id" = "Oy3spSmn";
            "file" = "ears-thermite-2.0.1.jar";
            "hash" = "sha512-I6RDNhdDXX6NKOgOJG/YKyyLLQbDHpWvI88I2ULxqICPxVIzE4loW6URPPM/xkqPnXNwz0Ta5NoyTIUilxCSlg==";
        };
        _DEhRbQxJ = {
            "id" = "DEhRbQxJ";
            "file" = "five-buzz-fabric-2.0.1.jar";
            "hash" = "sha512-nmYZtUWtiuAR2Ir8LDqbgT7WBeOUuOaK8ymNXJpX8bi2Xgf0yYVeL1qBVD/7mtlJl4Mkbbtm2jJC64UEfJFf6Q==";
        };
        _9czFtw2N = {
            "id" = "9czFtw2N";
            "file" = "five-buzz-forge-2.0.1.jar";
            "hash" = "sha512-7PUCDWCX8G3iDGEM9PMvWZhbCePuxXtBhleT+uIpsNU/raZC3FOG3+Rx69B8XQgVY7GlwnDTCwmo7B04RE1lcg==";
        };
        _m1FhUfX9 = {
            "id" = "m1FhUfX9";
            "file" = "ears-plateau-2.0.1.jar";
            "hash" = "sha512-j3wlfzkkA0jF+FXj2un3VtrgN6aalXmm+Vxwe4RcJNjNXB3dgDSr+dWB0ynXUxb8iZ26eJNEsBzTCWteNdblOQ==";
        };
        _L3yCjYrE = {
            "id" = "L3yCjYrE";
            "file" = "five-buzz-neoforge-2.0.1.jar";
            "hash" = "sha512-f/VtIHezBe9NmMjV3aypLaAmKgOj+pFVtndP3OwM1+OnvNub5Xl2i6W0AIAJb3+bWbnDdbW23lwrgA9wwZmqFQ==";
        };
        _HV64XDEr = {
            "id" = "HV64XDEr";
            "file" = "ears-fabric-1.21.11-2.0.1.jar";
            "hash" = "sha512-UENM7t+12FZL3NJ4Y5IWianJqXmEZyp7YkNTr3sIWubWU1difqWeFZM6DYF/FkXy+1Dysua577NHOnqBGMwghw==";
        };
        _RwZcSlH4 = {
            "id" = "RwZcSlH4";
            "file" = "ears-neoforge-1.21.11-2.0.1.jar";
            "hash" = "sha512-fegV4K8C+Jti3d3ksL5QmxOCq9JALUqnhWASVSsX7r1E8N7qGYXWtnE4SnjMJ9k/gIAKUeh+o1dw08/aHZowCQ==";
        };
        _2hMij4Su = {
            "id" = "2hMij4Su";
            "file" = "ears-neoforge-1.21.11-2.0.2.jar";
            "hash" = "sha512-VVpnMgJ9AV8tWgxTEsXqMz0T3Urdzc84ZTbKbsyyw9r0NtdnmvxyseOcBruLCUKCEf+qZ+IXNRdZdEFWpPaEBQ==";
        };
        _vvCnKfTO = {
            "id" = "vvCnKfTO";
            "file" = "ears-fabric-1.21.11-2.0.2.jar";
            "hash" = "sha512-dCr3DhGQ9tsjCPfjNQufInYx/aIeMXugk8X2AaTGgOWwp4XnBOgtaUMjxuySx4S225xTeFD3HKFdTOPjXufQBQ==";
        };
        _hoCqH7iv = {
            "id" = "hoCqH7iv";
            "file" = "ears-buzz-fabric-2.1.0.jar";
            "hash" = "sha512-fKWfEvFri3e/d90gI7/jStSqeq9IOVVQUkwKv09UFgPwzAO6nBrKXm6TXvvefpvMv4PqFnsOp/PlJzX3/HjfRg==";
        };
        _wXhv6vSZ = {
            "id" = "wXhv6vSZ";
            "file" = "ears-buzz-forge-2.1.0.jar";
            "hash" = "sha512-hbITuhcRWRuTJJsUJMmIjsjvr3VqGtehEFbAKnlHfCPn2fU+TkWyRo8cQPeqFSlJI77zkZTq1MeifDl5DzRQ3w==";
        };
        _Ez9t5qGR = {
            "id" = "Ez9t5qGR";
            "file" = "ears-buzz-neoforge-2.1.0.jar";
            "hash" = "sha512-ztkD5AtJlRqhyL8h/Fa+Tx2c209ykoarKiQsDnie5ScDki7ygVdKUFb/qFE0sxH+pp6HgXLZ/RDGdYpHLH+Rag==";
        };
        _GYayFDqi = {
            "id" = "GYayFDqi";
            "file" = "ears-fabric-1.21.11-2.1.0.jar";
            "hash" = "sha512-JW4kfZEGPZTzItKSHpdlSmNOggHxS95s3Y0MUb0ipeZu+CnDNl/gdUKJgObaLUC54EZH89nxR+46688w5IwQwg==";
        };
        _GkWMvBS4 = {
            "id" = "GkWMvBS4";
            "file" = "ears-neoforge-1.21.11-2.1.0.jar";
            "hash" = "sha512-rIC+pyx/1XaKDXkuF7aO3MXc78YIS5ejyWbPOwhjuuc277wYPiZNCd8AkEbxFpkHTvnlxHDQBGnhlD1dPKtHew==";
        };
        _wmHPsTgb = {
            "id" = "wmHPsTgb";
            "file" = "ears-plateau-2.1.0.jar";
            "hash" = "sha512-GdKkQsFlhaXXlomFxEjBxTpS7FEDSkW05cFphsZJvsGnoOlr1EHky+HQUaQ+kBxH+BouMe0XkR20dzVBgXBgYg==";
        };
        _XsRJWcmT = {
            "id" = "XsRJWcmT";
            "file" = "ears-thermite-2.1.0.jar";
            "hash" = "sha512-sOH0TYB2MibRYMiWiNzWaLFlxzkYeK3q6tF9mZDDxmSvxIlbuGFZDoWTBfT+4DWb1cqXwBsaNT5f7FgmIjoVyw==";
        };
        _HeXrqoJl = {
            "id" = "HeXrqoJl";
            "file" = "ears-fabric-1.21.11-2.1.1.jar";
            "hash" = "sha512-rH05PoUB9+q1p5xQGEhaGo8mfIGfIAsLuvEDrZSUp3dwIVdbe7pYMbbzQLOlD7L76wE7VcZPa5+iUXmt1nxTDA==";
        };
        _g1m6F8Pl = {
            "id" = "g1m6F8Pl";
            "file" = "ears-neoforge-1.21.11-2.1.1.jar";
            "hash" = "sha512-kOUYJzugs7mFC1swJNu/BmC3U3SxOd0GS6greY5+Da5ZgK3Mgv3jazvzaiDI2r3wq4bw6FidnB4brgmNOq/Ulw==";
        };
        _nSNyLZDa = {
            "id" = "nSNyLZDa";
            "file" = "ears-strife-2.1.1.jar";
            "hash" = "sha512-qnyU7DYdVnmbNo+iBxlc6E2ODWaObeluXQM52DM/U2dWSW81Mf5YYQVXHoKfhmRn4+CDQu39ilBVMeMKr8HFpg==";
        };
        _348gxlkv = {
            "id" = "348gxlkv";
            "file" = "ears-buzz-fabric-2.1.2.jar";
            "hash" = "sha512-+RubVZlaVI1cOokW4VKrpH1LtRsUak9FOwEup0/yaODkSSJr0MzrV012HklRAqKCfWjsxGTsgJLhh7hALsMu3g==";
        };
        _PohbGg5d = {
            "id" = "PohbGg5d";
            "file" = "ears-buzz-forge-2.1.2.jar";
            "hash" = "sha512-6W5m2AVRamDYj1gIjIvKPcUaXnoXvaKnaLub+HPrmCDylKZLOupTFb+Pfi+DF+5x8DdTic2ikX8VL5H1/GE3MA==";
        };
        _Laga35OM = {
            "id" = "Laga35OM";
            "file" = "ears-buzz-neoforge-2.1.2.jar";
            "hash" = "sha512-dBj36PxVPcrguC7rlMQzBVJgAZKD2jctllr1VDtIx+PRlRBzg3holMNN6+Lhh8mZNnG79C4PCnjMs9W6lx1G1w==";
        };
        _OanGDrJM = {
            "id" = "OanGDrJM";
            "file" = "ears-strife-2.1.2.jar";
            "hash" = "sha512-y9EWJLAn5yvveWqpNeFv4WawaT7BxCALFGuSWbOm4jBvnTFzM/z21UF0JTYvRLlpLF++jY6VMAXp16nxU7mc6A==";
        };
        _YO63YJbH = {
            "id" = "YO63YJbH";
            "file" = "ears-buzz-fabric-2.2.0-a.jar";
            "hash" = "sha512-Q7XUgoaRU8IPeyUZz9nR1Wa29nNC9kk9QPl03eBtUN1ihyxP9PbiA1w8XVHBURDsMEHFnzAnFMsHJowrf6eJug==";
        };
        _wCjAO2DE = {
            "id" = "wCjAO2DE";
            "file" = "ears-buzz-forge-2.2.0-a.jar";
            "hash" = "sha512-Dl5uHRFM7pfhIdMgSjjQTW5GLZEWF7hiB4Uxst2btWiBwVypodiGk+4+ZU8KNHxtCHhyGZUZaVGz3V1mwZ4TWg==";
        };
        _6pVsV4VS = {
            "id" = "6pVsV4VS";
            "file" = "ears-buzz-neoforge-2.2.0-a.jar";
            "hash" = "sha512-1HhUlD3/w/an7EPLC8JVHCaF6BltRzHHW3mniuvuDSWKDhZ6l/HtFLoV7vnWDimaxCCzBUxDRudXpp3YteWc4w==";
        };
        _ZvkrlOpa = {
            "id" = "ZvkrlOpa";
            "file" = "ears-fabric-1.21.11-2.2.0-a.jar";
            "hash" = "sha512-yYlW4BHLpsvpO+2Srq26CUhdmqNkMje7rL5k2UyWRT981c/dPSsabT/HDJ446iGTcfU83dMgZuZvW+FAGDpljg==";
        };
        _pS3DwLkY = {
            "id" = "pS3DwLkY";
            "file" = "ears-neoforge-1.21.11-2.2.0-a.jar";
            "hash" = "sha512-u9+nizz81Lbl3+3zLm616h/9EylQmuXJfgf68hjRzN1b1npFzyJPA20IOycsDVLNWq+N5rbvH1DxM1omRnJWTA==";
        };
        _RpYKbhGy = {
            "id" = "RpYKbhGy";
            "file" = "ears-plateau-2.2.0-a.jar";
            "hash" = "sha512-0frvwLRBm3/xE46Lb70bmIlkFQ7O/zk0AsJ3FfnMvx/OoXHrMNiTeqFYo/S+SvV/c7XZVb8IIb/NpshCd2QbfQ==";
        };
        _n0RpwkI2 = {
            "id" = "n0RpwkI2";
            "file" = "ears-strife-2.2.0-a.jar";
            "hash" = "sha512-3lLnvbOOJDfPYrYYWHDzvTUUPCGG9Bm6ajBjy7xf4MlL4oWG/r9fVQglzC0YRd4LNYIGBZ602u230jX2jyzLJw==";
        };
        _V171BG0A = {
            "id" = "V171BG0A";
            "file" = "ears-thermite-2.2.0-a.jar";
            "hash" = "sha512-o93E9rCD5kQa2JMdOZSn3Pc6PKpUF0/8Wik3mpAsPAcrju0dGW05BrNZbCZcBasYRunia3UKbVU1yeNKbyKcgA==";
        };
        _rNlfQOYe = {
            "id" = "rNlfQOYe";
            "file" = "ears-thermite-2.2.0-b.jar";
            "hash" = "sha512-1CraMUke6mBFHwMDOW09ZS7v+eytGVq8lVjigSizo/4SKgcw2YNZwk6GxoJeGEObxIGtqAX9JTjQ0DOE6FaGjQ==";
        };
        _Iynp3j7Z = {
            "id" = "Iynp3j7Z";
            "file" = "ears-buzz-fabric-2.2.0-b.jar";
            "hash" = "sha512-JHB/cXjD50k63LetnOPvUaWyyLZMMZQBOMOtb5emQHOCVASLoFVALkbaDjKbnFgOXlUBi86XK+l2DSJ43KpXBw==";
        };
        _wcYB8DRM = {
            "id" = "wcYB8DRM";
            "file" = "ears-buzz-forge-2.2.0-b.jar";
            "hash" = "sha512-Y1HjtL0/fyjHGc+twiK0aHSNQVgiq6Yl5+wzvFKuRnKpxyIglqhjiTjvZTLtegfdwqhC+1iket09gBn0bj4N6A==";
        };
        _79JnaPZk = {
            "id" = "79JnaPZk";
            "file" = "ears-buzz-neoforge-2.2.0-b.jar";
            "hash" = "sha512-GZ8qXlSvXAE4iCyS5dmKBn+8L8Unxn+ts3aEi6s0vNqSgNvsigQ2h5yApz60RFthFpagyRL2rbzMhTuYuP/eNw==";
        };
        _pHQioWNq = {
            "id" = "pHQioWNq";
            "file" = "ears-buzz-fabric-2.2.1-a.jar";
            "hash" = "sha512-QOeqMA8GJPmKu/kB3XVvBaRM49zu67jPWYJqaz86tzDHPG5bQQdFZ5o3r0HfaUlgNRPQ08ITfvRwDbJZmdOPNw==";
        };
        _kiXPwDw6 = {
            "id" = "kiXPwDw6";
            "file" = "ears-buzz-forge-2.2.1-a.jar";
            "hash" = "sha512-s4NlLm+BE4wTiLgBi+bZKaJb64X8wHIn8PrkN2X0Lay7C2NgTI+PVe80q5jP83ZnduimPyioaYhwFxSSfGOUkg==";
        };
        _Q1ZcNy9h = {
            "id" = "Q1ZcNy9h";
            "file" = "ears-buzz-neoforge-2.2.1-a.jar";
            "hash" = "sha512-6jk8o08K2jrK6r/28YXuQBzGSFIkMONEViDrvxis0Z4byOsAns+dzKLzhnZQCikW5HqsQvsMSbe306g35QVBsA==";
        };
        _OEInBxEN = {
            "id" = "OEInBxEN";
            "file" = "ears-fabric-1.21.11-2.2.1-a.jar";
            "hash" = "sha512-XoXaj4vmxHUW3BZ4s7Rn7ULQZt5TKDqw1W5/gIezRiEVxY5NBRQidGYFghZna/JfuEi+Szi3himcsI+dz5j2TQ==";
        };
        _h1mx6SYP = {
            "id" = "h1mx6SYP";
            "file" = "ears-neoforge-1.21.11-2.2.1-a.jar";
            "hash" = "sha512-PO31QDvnrovUncy2Gt0hNUrPEznvSUkzpQpX2vm+Z3Zl0en5UN4g/JWovqA+4ohb/wHrWIZeT6LEkUSUB4hLWQ==";
        };
        _7bPIBvH9 = {
            "id" = "7bPIBvH9";
            "file" = "ears-plateau-2.2.1-a.jar";
            "hash" = "sha512-Rs/9v+a0rCVgGQ+GZAcgVx86DnwairdoVKp8qmAP+NSozQkAXIW3SaN7o1vSrIPYLdDlHw/8oyXICYjldBcMZg==";
        };
        _4mVO7YC1 = {
            "id" = "4mVO7YC1";
            "file" = "ears-strife-2.2.1-a.jar";
            "hash" = "sha512-bnsPTjGVB6M5PahOA9p7iee1vpc5fD34i7D/QMPGwXspeDKt4SU6KrnslhOVdBrjYR5XcCXcELiPrWFAq0AtSQ==";
        };
        _Ow65YIZu = {
            "id" = "Ow65YIZu";
            "file" = "ears-thermite-2.2.1-a.jar";
            "hash" = "sha512-t2qkHQRkYsNrNh0OHrtxRMeFDe0x6GXO5xjET4NhgYIBrTDXWlOG3VGR7aevaa1HLdRfXbPBDW0q8ChTT9a5Qw==";
        };
        _aeVAp1bc = {
            "id" = "aeVAp1bc";
            "file" = "ears-buzz-fabric-2.2.1-b.jar";
            "hash" = "sha512-SsVnkvLFd+bvBjN+mBKyC/2F3nSKwc9Yua/5KLA3NFy40VDxDAYl6/sQL39XmqXNrbHhL5NDldgiBJ4INxe2dg==";
        };
        _iJLKjZGh = {
            "id" = "iJLKjZGh";
            "file" = "ears-buzz-forge-2.2.1-b.jar";
            "hash" = "sha512-3B8PD/bLLUezv8RYiVNngINpukVqbgoXV5+DiqZQ/hrZhdkA7cKE/1NTh7aZcl1AQiVjkeV0z6HJ2TR7hkBj0w==";
        };
        _e0uHgkKI = {
            "id" = "e0uHgkKI";
            "file" = "ears-buzz-neoforge-2.2.1-b.jar";
            "hash" = "sha512-9nV+95KiS4WL0JY/A94fohle9QHQ1bYC/YPV0aobTzHjCC3Ep6mFkz5DAFLTl/ua1YK2MVWBxjGSXUqd4CZpOQ==";
        };
        _BFUydEVG = {
            "id" = "BFUydEVG";
            "file" = "ears-fabric-1.21.11-2.2.1-b.jar";
            "hash" = "sha512-mIqDFHSpwZwP4zIyIkUI4qW/VDKj0/j47aAQB2JYo7iJiWRq/PF0oHdyucjZLLlANGMqygQOF2ufM518gNOYkA==";
        };
        _eckRo4TZ = {
            "id" = "eckRo4TZ";
            "file" = "ears-neoforge-1.21.11-2.2.1-b.jar";
            "hash" = "sha512-KWeOyFkKmdFrjOCcGIDTPVIcZNS+jQutM/nNMk0Li4fGWmEGjEE/BNbQD+W58zPA2wZCGoC8jQGZXatyf4TKzQ==";
        };
        _u2ZQbwQD = {
            "id" = "u2ZQbwQD";
            "file" = "ears-plateau-2.2.1-b.jar";
            "hash" = "sha512-4VrKIlz6gH2fVH5op+R4hffEf2b70xc/RIWsC9TJnud3wu+AmzH6dQWcVpxhJVkqJE5+YFYsGqX2Xa/YRIzLqQ==";
        };
        _5ujyn8f6 = {
            "id" = "5ujyn8f6";
            "file" = "ears-strife-2.2.1-b.jar";
            "hash" = "sha512-ORJV1HOksxiz7JvmRsT/H3rI3ewe+uP4jlmbJRFFeQ2z1Q+DY1kkfJrnVTe7ElP7uqqUuwOXpWJg9TMZ2SRjQA==";
        };
        _o7RIJrgm = {
            "id" = "o7RIJrgm";
            "file" = "ears-thermite-2.2.1-b.jar";
            "hash" = "sha512-T/r0jIiojXV5XyhAYAyEdkEQLjsR05vTXOirj7VVcpv+jO35ZSczYoyUhPxnd7VW2qW3L85guueOuqhJ0GhNeA==";
        };
        _gDca6bvp = {
            "id" = "gDca6bvp";
            "file" = "ears-buzz-fabric-2.2.1-c.jar";
            "hash" = "sha512-dNOjm66jlkoILAP1O3GD4/ckBtuJvgY836bagBQTE9Xe0KKTkCdg6ijN7DcMUF5Y183z7kaFp1TCdg8bAeoizQ==";
        };
        _eNvnNxLB = {
            "id" = "eNvnNxLB";
            "file" = "ears-buzz-forge-2.2.1-c.jar";
            "hash" = "sha512-Jeu9f+kkh9SnliHdokKjw5yMq6qPaFmnOGv5r+mJrw429u/Qrf8mxpf6Eb3N30b23Zsosce8eepqYX2nitIXhQ==";
        };
        _h496H0Wu = {
            "id" = "h496H0Wu";
            "file" = "ears-buzz-neoforge-2.2.1-c.jar";
            "hash" = "sha512-o46icUTSVLKroU2/0N3ugyVgPn9xQiKxAQPLbF2nx8fc+D/PSkFSQ4Ft/wyxiun2v7UMErlSyK/3fz7NcFFwFg==";
        };
        _ISYvFnpI = {
            "id" = "ISYvFnpI";
            "file" = "ears-fabric-1.21.11-2.2.1-c.jar";
            "hash" = "sha512-N8GPEc2wes3rRQaq0Ts3qkdgAqbOIwT7VtCaADm5ntXUAgzOPoEKofF/VMSvGyYfVhMNcGB11OmMSUTU9pTAog==";
        };
        _G4vPnvWh = {
            "id" = "G4vPnvWh";
            "file" = "ears-neoforge-1.21.11-2.2.1-c.jar";
            "hash" = "sha512-/lIp/pyRC+czNSsnBYPDMJb6hmnvzxBQNniMgQJo2EsnIL6366RTH/gstgiXAYYdvcqTzowfav+LlfSPC/lpKw==";
        };
        _ItUS3Avu = {
            "id" = "ItUS3Avu";
            "file" = "ears-plateau-2.2.1-c.jar";
            "hash" = "sha512-HUqx5hMyvfx4dCotHl0pPamAAt9mJZFPgstCyAfnvGheD6EN1O8nqFTIQxWbIr0SFBwnz6i9siuC2nYVZd8WrQ==";
        };
        _GEdE12fk = {
            "id" = "GEdE12fk";
            "file" = "ears-strife-2.2.1-c.jar";
            "hash" = "sha512-VelB2+JBOlUwEJKAye290+L6ieXca8oN8l1Sv/+zLOZjhIxwCHRzgRm41C6WUDVPHo3eFp2SLcRMLr1OwLReTw==";
        };
        _MWdkKcnk = {
            "id" = "MWdkKcnk";
            "file" = "ears-thermite-2.2.1-c.jar";
            "hash" = "sha512-K25t6LpSbLpGjXdn/LHA0IqA77cjLvH5PUdJznD7I+qfl5n6nwPichITz2yiunYtrGW2feT/65jYqIAXjHtM0g==";
        };
        _Tdfeeflh = {
            "id" = "Tdfeeflh";
            "file" = "ears-thermite-2.2.1-d.jar";
            "hash" = "sha512-17ujX49JMMFzFaW0pZqRxsgDdzjdqIZSiCrYIb6I8Rm6F5CGYc1IxvVHrzUhl3E+L/Io3QkgOQXCwMN2TqHTHg==";
        };
    in {
        "lpXZo5cT" = _lpXZo5cT;
        "DNxeOyU0" = _DNxeOyU0;
        ...
        "fabric-1.15" = _gDca6bvp;
        "fabric-1.15.1" = _gDca6bvp;
        "fabric-1.15.2" = _gDca6bvp;
        "fabric-1.16" = _gDca6bvp;
        "fabric-1.16.1" = _gDca6bvp;
        "fabric-1.16.2" = _gDca6bvp;
        "fabric-1.16.3" = _gDca6bvp;
        "fabric-1.16.4" = _gDca6bvp;
        "fabric-1.16.5" = _gDca6bvp;
        "fabric-1.17" = _gDca6bvp;
        "fabric-1.17.1" = _gDca6bvp;
        ...
        "fabric-1.18" = _gDca6bvp;
        "fabric-1.18.1" = _gDca6bvp;
        "fabric-1.18.2" = _gDca6bvp;
        "fabric-1.19" = _gDca6bvp;
        "fabric-1.19.1" = _gDca6bvp;
        "fabric-1.19.2" = _gDca6bvp;
        "fabric-1.19.3" = _gDca6bvp;
        "fabric-1.19.4" = _gDca6bvp;
        "fabric-1.20-pre1" = _aLWfOeWZ;
        "fabric-1.20" = _gDca6bvp;
        "fabric-1.20.1" = _gDca6bvp;
        "fabric-1.20.2" = _gDca6bvp;
        "fabric-1.20.3" = _gDca6bvp;
        "fabric-1.20.4" = _gDca6bvp;
        "fabric-1.20.6" = _gDca6bvp;
        "fabric-1.21" = _gDca6bvp;
        "fabric-1.21.1" = _gDca6bvp;
        "fabric-1.21.4" = _TPdnkxJj;
        "fabric-1.21.5" = _gDca6bvp;
        "fabric-1.21.6" = _gDca6bvp;
        "fabric-1.21.7" = _gDca6bvp;
        "fabric-1.21.8" = _gDca6bvp;
        "fabric-1.21.10" = _a9IE3zQy;
        "fabric-1.21.11" = _ISYvFnpI;
        "fabric-26.1" = _Tdfeeflh;
        "fabric-26.1.1" = _Oy3spSmn;
        "fabric-26.1.2" = _Tdfeeflh;
        "fabric-26.2" = _Tdfeeflh;
        "fabric-26.3-snapshot-4" = _rNlfQOYe;
        "fabric-26.3-snapshot-5" = _rNlfQOYe;
        "fabric-26.3-snapshot-6" = _rNlfQOYe;
        "fabric-26.3-snapshot-1" = _rNlfQOYe;
        "fabric-26.3-snapshot-2" = _rNlfQOYe;
        "fabric-26.3-snapshot-3" = _rNlfQOYe;
        "fabric-26.3-snapshot-7" = _rNlfQOYe;
        "fabric-26.3-snapshot-8" = _rNlfQOYe;
        "fabric-1.20.5" = _gDca6bvp;
        "fabric-26.3-snapshot-9" = _rNlfQOYe;
        "fabric-26.3-snapshot-10" = _rNlfQOYe;
        "fabric-26.3-pre-1" = _rNlfQOYe;
        "fabric-26.3-pre-2" = _MWdkKcnk;
        "fabric-26.3" = _Tdfeeflh;
        "java-agent-1.2.5" = _ItUS3Avu;
        "java-agent-b1.7.3" = _OuaRfhcF;
        "java-agent-1.3.2" = _ItUS3Avu;
        "java-agent-1.4.2" = _ItUS3Avu;
        "java-agent-1.4.7" = _ItUS3Avu;
        "java-agent-1.5.2" = _ItUS3Avu;
        "java-agent-1.6.4" = _ItUS3Avu;
        "java-agent-1.7.10" = _m1FhUfX9;
        "forge-1.4.7" = _ItUS3Avu;
        "forge-1.5.2" = _ItUS3Avu;
        "forge-1.7.10" = _m1FhUfX9;
        "forge-1.8.9" = _GEdE12fk;
        "forge-1.12.2" = _GEdE12fk;
        ...
        "forge-1.17" = _eNvnNxLB;
        "forge-1.17.1" = _eNvnNxLB;
        "forge-1.6.4" = _ItUS3Avu;
        "forge-1.9.4" = _GEdE12fk;
        "forge-1.10.2" = _GEdE12fk;
        "forge-1.11.2" = _GEdE12fk;
        "forge-1.18" = _eNvnNxLB;
        "forge-1.18.1" = _eNvnNxLB;
        "forge-1.18.2" = _eNvnNxLB;
        "forge-1.19" = _eNvnNxLB;
        "forge-1.19.1" = _eNvnNxLB;
        "forge-1.19.2" = _eNvnNxLB;
        "forge-1.19.3" = _eNvnNxLB;
        "forge-1.19.4" = _eNvnNxLB;
        "forge-1.20" = _eNvnNxLB;
        "forge-1.20.1" = _eNvnNxLB;
        "forge-1.2.5" = _ItUS3Avu;
        "forge-1.3.2" = _ItUS3Avu;
        "forge-1.4.2" = _ItUS3Avu;
        "quilt-1.17" = _gDca6bvp;
        "quilt-1.17.1" = _gDca6bvp;
        "quilt-1.18" = _gDca6bvp;
        "quilt-1.18.1" = _gDca6bvp;
        "quilt-1.18.2" = _gDca6bvp;
        "quilt-1.19" = _gDca6bvp;
        "quilt-1.19.1" = _gDca6bvp;
        "quilt-1.19.2" = _gDca6bvp;
        "quilt-1.19.3" = _gDca6bvp;
        "quilt-1.19.4" = _gDca6bvp;
        "quilt-1.20-pre1" = _aLWfOeWZ;
        "quilt-1.20" = _gDca6bvp;
        "quilt-1.20.1" = _gDca6bvp;
        "quilt-1.20.2" = _gDca6bvp;
        "quilt-1.20.3" = _gDca6bvp;
        "quilt-1.20.4" = _gDca6bvp;
        "quilt-1.21" = _gDca6bvp;
        "quilt-1.21.1" = _gDca6bvp;
        "quilt-1.20.6" = _gDca6bvp;
        "quilt-1.21.4" = _TPdnkxJj;
        "quilt-1.21.5" = _gDca6bvp;
        "quilt-1.21.6" = _gDca6bvp;
        "quilt-1.21.7" = _gDca6bvp;
        "quilt-1.21.8" = _gDca6bvp;
        ...
        "quilt-1.15" = _gDca6bvp;
        "quilt-1.15.1" = _gDca6bvp;
        "quilt-1.15.2" = _gDca6bvp;
        "quilt-1.16" = _gDca6bvp;
        "quilt-1.16.1" = _gDca6bvp;
        "quilt-1.16.2" = _gDca6bvp;
        "quilt-1.16.3" = _gDca6bvp;
        "quilt-1.16.4" = _gDca6bvp;
        "quilt-1.16.5" = _gDca6bvp;
        "quilt-1.20.5" = _gDca6bvp;
        "rift-1.13.2" = _nJkbZquZ;
        "neoforge-1.21" = _qbgli4xy;
        "neoforge-1.21.1" = _h496H0Wu;
        ...
        "neoforge-1.21.11" = _G4vPnvWh;
        "neoforge-26.1" = _Tdfeeflh;
        "neoforge-26.1.1" = _Oy3spSmn;
        "neoforge-26.1.2" = _Tdfeeflh;
        "neoforge-26.2" = _Tdfeeflh;
        "neoforge-26.3-snapshot-1" = _rNlfQOYe;
        "neoforge-26.3-snapshot-2" = _rNlfQOYe;
        "neoforge-26.3-snapshot-3" = _rNlfQOYe;
        "neoforge-26.3-snapshot-4" = _rNlfQOYe;
        "neoforge-26.3-snapshot-5" = _rNlfQOYe;
        "neoforge-26.3-snapshot-6" = _rNlfQOYe;
        "neoforge-26.3-snapshot-7" = _rNlfQOYe;
        "neoforge-26.3-snapshot-8" = _rNlfQOYe;
        "neoforge-26.3-snapshot-9" = _rNlfQOYe;
        "neoforge-26.3-snapshot-10" = _rNlfQOYe;
        "neoforge-26.3-pre-1" = _rNlfQOYe;
        "neoforge-26.3-pre-2" = _MWdkKcnk;
        "neoforge-26.3" = _Tdfeeflh;
        "babric-b1.7.3" = _e84truih;
        "modloader-1.2.5" = _ItUS3Avu;
        "modloader-1.3.2" = _ItUS3Avu;
        "modloader-1.4.2" = _ItUS3Avu;
        "modloader-1.4.7" = _ItUS3Avu;
        "modloader-1.5.2" = _ItUS3Avu;
        "modloader-1.6.4" = _ItUS3Avu;
        "modloader-1.7.10" = _m1FhUfX9;
        "nilloader-1.2.5" = _ItUS3Avu;
        "nilloader-1.3.2" = _ItUS3Avu;
        "nilloader-1.4.2" = _ItUS3Avu;
        "nilloader-1.4.7" = _ItUS3Avu;
        "nilloader-1.5.2" = _ItUS3Avu;
        "nilloader-1.6.4" = _ItUS3Avu;
        "nilloader-1.7.10" = _m1FhUfX9;
        "pkg-1.2.4+fabric-1.8" = _lpXZo5cT;
        "pkg-1.2.4+fabric-1.14" = _DNxeOyU0;
        "pkg-1.2.4+fabric-1.16" = _8UFk7wTw;
        "pkg-1.2.4+fabric-1.17" = _vqd5u0Ny;
        "pkg-1.2.4+forge-1.2" = _3sK5GNEL;
        "pkg-1.2.4+forge-1.4" = _L8WZew4h;
        "pkg-1.2.4+forge-1.5" = _UdpdOqsM;
        "pkg-1.2.4+forge-1.7" = _JkTHmv33;
        "pkg-1.2.4+forge-1.8" = _67mIJApL;
        "pkg-1.2.4+forge-1.12" = _YO0CxtvV;
        "pkg-1.2.4+forge-1.14" = _mnpF9fFT;
        "pkg-1.2.4+forge-1.15" = _JSrdBn2w;
        "pkg-1.2.4+forge-1.16" = _UTTnypyR;
        "pkg-1.2.4+forge-1.17" = _FnSgzXd0;
        "pkg-1.2.4+fabric-b1.7.3" = _ocBfsNxD;
        "pkg-1.2.4_01+fabric-b1.7.3.01" = _ImyGz7RA;
        "pkg-1.2.4+forge-1.6" = _SsojVERH;
        "pkg-1.2.4+forge-1.9" = _VEilm628;
        "pkg-1.3.0+fabric-1.8" = _9YbGHfEj;
        "pkg-1.3.0+fabric-1.14" = _5FJrNH3J;
        "pkg-1.3.0+fabric-1.16" = _bLhYnp0N;
        "pkg-1.3.0+fabric-1.17" = _KxVLjWg3;
        "pkg-1.3.0+forge-1.2" = _TaVgYwhU;
        "pkg-1.3.0+forge-1.4" = _k9MaA62j;
        "pkg-1.3.0+forge-1.5" = _5YK7HNNZ;
        "pkg-1.3.0+forge-1.6" = _FAJmOYgL;
        "pkg-1.3.0+forge-1.7" = _40LUvzls;
        "pkg-1.3.0+forge-1.8" = _YWUlc8NG;
        "pkg-1.3.0+forge-1.9" = _7pqhssyw;
        "pkg-1.3.0+forge-1.12" = _wkCD7q1B;
        "pkg-1.3.0+forge-1.14" = _bue40S7b;
        "pkg-1.3.0+forge-1.15" = _R9yScWb3;
        "pkg-1.3.0+forge-1.16" = _FVlXZqvd;
        "pkg-1.3.0+forge-1.17" = _p7ssOcRF;
        "pkg-1.3.0+fabric-b1.7.3" = _PUDRPcn5;
        "pkg-1.3.0+forge-1.17.01" = _Uob64eXA;
        "pkg-1.4.0+fabric-1.8" = _iDpfYE15;
        "pkg-1.4.0+fabric-1.14" = _wzUMomJt;
        "pkg-1.4.0+fabric-1.16" = _vQ0ecy0S;
        "pkg-1.4.0+fabric-1.17" = _U7n55kLU;
        "pkg-1.4.0+forge-1.2" = _6UpFQn6f;
        "pkg-1.4.0+forge-1.4" = _GW4TymkT;
        "pkg-1.4.0+forge-1.5" = _6kkaU73J;
        "pkg-1.4.0+forge-1.6" = _hpkHDJ02;
        "pkg-1.4.0+forge-1.7" = _IBZWz4tm;
        "pkg-1.4.0+forge-1.8" = _6eVHdmLT;
        "pkg-1.4.0+forge-1.9" = _X69Z7WNg;
        "pkg-1.4.0+forge-1.12" = _JEiBymvR;
        "pkg-1.4.0+forge-1.14" = _2UEJ2bZV;
        "pkg-1.4.0+forge-1.15" = _nDeloErl;
        "pkg-1.4.0+forge-1.16" = _tjC4UTlC;
        "pkg-1.4.0+forge-1.17" = _eT1jUCHE;
        "pkg-1.4.0+fabric-b1.7.3" = _OLNkOMhP;
        "pkg-1.4.1+fabric-1.8" = _iSEGoIIV;
        "pkg-1.4.1+fabric-1.14" = _8r6Scle5;
        "pkg-1.4.1+fabric-1.16" = _JT6DGx1u;
        "pkg-1.4.1+fabric-1.17" = _zvb9LH2m;
        "pkg-1.4.1+forge-1.2" = _m1RayfTh;
        "pkg-1.4.1+forge-1.4" = _N6axaImF;
        "pkg-1.4.1+forge-1.5" = _wyW8GHOl;
        "pkg-1.4.1+forge-1.6" = _6EaLm7o9;
        "pkg-1.4.1+forge-1.7" = _5JODEHyl;
        "pkg-1.4.1+forge-1.8" = _1OtCDZMR;
        "pkg-1.4.1+forge-1.9" = _rkEdZLz0;
        "pkg-1.4.1+forge-1.12" = _o8r0KF7H;
        "pkg-1.4.1+forge-1.14" = _e1KynUiG;
        "pkg-1.4.1+forge-1.15" = _ZYtJLvdi;
        "pkg-1.4.1+forge-1.16" = _2rjB1zfY;
        "pkg-1.4.1+forge-1.17" = _PkAlb37G;
        "pkg-1.4.1+fabric-b1.7.3" = _9sLhFUFw;
        "pkg-1.4.2+fabric-1.8" = _XNWCCsZu;
        "pkg-1.4.2+fabric-1.14" = _k52XL3dC;
        "pkg-1.4.2+fabric-1.16" = _eGHaFJqz;
        "pkg-1.4.2+fabric-1.17" = _xzyp9aQy;
        "pkg-1.4.2+forge-1.2" = _UGTo7ipt;
        "pkg-1.4.2+forge-1.4" = _tsLMkuq3;
        "pkg-1.4.2+forge-1.5" = _Tk6sKlgA;
        "pkg-1.4.2+forge-1.6" = _a9O6stzK;
        "pkg-1.4.2+forge-1.7" = _LtmojOrF;
        "pkg-1.4.2+forge-1.8" = _9j2uwa24;
        "pkg-1.4.2+forge-1.9" = _hj0ESCzj;
        "pkg-1.4.2+forge-1.12" = _tfhIqwrj;
        "pkg-1.4.2+forge-1.14" = _Kauqpx4E;
        "pkg-1.4.2+forge-1.15" = _7UsoRWEh;
        "pkg-1.4.2+forge-1.16" = _5yJoZxCt;
        "pkg-1.4.2+forge-1.17" = _NlQSU6h7;
        "pkg-1.4.2+fabric-b1.7.3" = _1bA50TFh;
        "pkg-1.4.2+forge-1.18" = _o64adsiA;
        "pkg-1.4.3+fabric-1.8" = _hijroEbI;
        "pkg-1.4.3+fabric-1.14" = _5iTp85Ww;
        "pkg-1.4.3+fabric-1.16" = _N7U7djUO;
        "pkg-1.4.3+fabric-1.17" = _vhKl0qVi;
        "pkg-1.4.3+forge-1.2" = _G4jwIfpw;
        "pkg-1.4.3+forge-1.4" = _HqAk3Ezs;
        "pkg-1.4.3+forge-1.5" = _cVfbaZ0z;
        "pkg-1.4.3+forge-1.6" = _coykKJQr;
        "pkg-1.4.3+forge-1.7" = _i4DPrUhV;
        "pkg-1.4.3+forge-1.8" = _REXxdi7m;
        "pkg-1.4.3+forge-1.9" = _Tn8DXAv1;
        "pkg-1.4.3+forge-1.12" = _JpXZeVrV;
        "pkg-1.4.3+forge-1.14" = _98TUHkys;
        "pkg-1.4.3+forge-1.15" = _iaefWKzr;
        "pkg-1.4.3+forge-1.16" = _f4JVWVHF;
        "pkg-1.4.3+forge-1.17" = _uEI4Rqnv;
        "pkg-1.4.3+forge-1.18" = _UQt29Bpz;
        "pkg-1.4.3+fabric-b1.7.3" = _f18UUct6;
        "pkg-1.4.4+forge-1.2" = _uSc7MTk2;
        "pkg-1.4.4+forge-1.4" = _1b2lQV5U;
        "pkg-1.4.4+forge-1.5" = _liCqUZY8;
        "pkg-1.4.4+forge-1.6" = _eUse71cB;
        "pkg-1.4.4+forge-1.7" = _zUciLb1g;
        "pkg-1.4.4+fabric-1.8" = _o084ETVN;
        "pkg-1.4.4+forge-1.8" = _SeYRq7Pv;
        "pkg-1.4.4+forge-1.9" = _org8dcGX;
        "pkg-1.4.4+forge-1.12" = _Mb474e9o;
        "pkg-1.4.4+fabric-1.14" = _CHd51bHd;
        "pkg-1.4.4+forge-1.14" = _rNhT9tHO;
        "pkg-1.4.4+forge-1.15" = _1xS8sgCi;
        "pkg-1.4.4+fabric-1.16" = _soRZeRz5;
        "pkg-1.4.4+forge-1.16" = _Fy3hlVPV;
        "pkg-1.4.4+fabric-1.17" = _JhJXSbJp;
        "pkg-1.4.4+forge-1.17" = _jkdSoyfQ;
        "pkg-1.4.4+forge-1.18" = _X748GRvR;
        "pkg-1.4.4+fabric-b1.7.3" = _ASSn1Ecv;
        "pkg-1.4.5+forge-1.2" = _zlMYwKBi;
        "pkg-1.4.5+forge-1.4" = _ZVqS2Euc;
        "pkg-1.4.5+forge-1.5" = _57lmbokW;
        "pkg-1.4.5+forge-1.6" = _gEudUghk;
        "pkg-1.4.5+forge-1.7" = _mbTY6PiH;
        "pkg-1.4.5+fabric-1.8" = _MOD19itX;
        "pkg-1.4.5+forge-1.8" = _xkFTPUgR;
        "pkg-1.4.5+forge-1.9" = _CICXtsge;
        "pkg-1.4.5+forge-1.12" = _oUgoAXVV;
        "pkg-1.4.5+fabric-1.14" = _w4JXZOck;
        "pkg-1.4.5+forge-1.14" = _eRcKSSZv;
        "pkg-1.4.5+forge-1.15" = _Dzcq39v9;
        "pkg-1.4.5+fabric-1.16" = _Z3YvbAXk;
        "pkg-1.4.5+forge-1.16" = _s1OUR4VC;
        "pkg-1.4.5+fabric-1.17" = _FZTR3XgE;
        "pkg-1.4.5+forge-1.17" = _MNnU0GCn;
        "pkg-1.4.5+forge-1.18" = _QekGXXrJ;
        "pkg-1.4.5+fabric-b1.7.3" = _HgrHJs7v;
        "pkg-1.4.5_01+forge-1.4" = _kngtmhTB;
        "pkg-1.4.5_01+fabric-1.16" = _GD9ihSQX;
        "pkg-1.4.5_01+fabric-1.17" = _7AcIEmmQ;
        "pkg-1.4.5_01+forge-1.7" = _wRX3RY6s;
        "pkg-1.4.6+fabric-1.19" = _qZkbcILO;
        "pkg-1.4.5+rift-1.13" = _B0NFcUYx;
        "pkg-1.4.6+forge-1.19" = _TsVsSboo;
        "pkg-1.4.6+fabric-1.19.3" = _A3Fr5dh4;
        "pkg-1.4.6+forge-1.19.3" = _IopeluGu;
        "pkg-1.4.6+fabric-1.19.4" = _aLWfOeWZ;
        "pkg-1.4.6+forge-1.19.4" = _J2bf7xnn;
        "pkg-1.4.6+fabric-1.20" = _Lr5BTYBp;
        "pkg-1.4.6+fabric-1.20.2" = _90nzKLG6;
        "pkg-1.4.6+forge-1.12" = _XX0VYSjD;
        "pkg-1.4.6+fabric-1.20.6" = _c97bUcFv;
        "pkg-1.4.6+fabric-1.21" = _sTb8pEOY;
        "pkg-1.4.6+neoforge-1.21" = _qbgli4xy;
        "pkg-1.4.6+stapi-b1.7.3" = _Wd1qQW2X;
        "pkg-1.4.6+neoforge-1.20.2" = _8Ory26EN;
        "pkg-1.4.7+rift-1.13" = _nJkbZquZ;
        "pkg-1.4.7+stapi-b1.7.3" = _e84truih;
        "pkg-1.4.7+fabric-1.14" = _DxJ3658N;
        "pkg-1.4.7+fabric-1.16" = _GSg4P6D1;
        "pkg-1.4.7+fabric-1.17" = _G6OzzetD;
        "pkg-1.4.7+fabric-1.19" = _NUe2jWfv;
        "pkg-1.4.7+fabric-1.19.3" = _vQsPKOjj;
        "pkg-1.4.7+fabric-1.19.4" = _Py9cjAtG;
        "pkg-1.4.7+fabric-1.20" = _49nmGOvy;
        "pkg-1.4.7+fabric-1.20.2" = _9eRXKloQ;
        "pkg-1.4.7+fabric-1.20.6" = _jOqlwWQf;
        "pkg-1.4.7+fabric-1.21" = _rEnDH8t5;
        "pkg-1.4.7+forge-1.2" = _GqzBafDQ;
        "pkg-1.4.7+forge-1.4" = _e4U1YzpO;
        "pkg-1.4.7+forge-1.5" = _BMwZDedi;
        "pkg-1.4.7+forge-1.6" = _kUhSBIEs;
        "pkg-1.4.7+forge-1.7" = _cOJECJY4;
        "pkg-1.4.7+forge-1.8" = _DfkgR8zj;
        "pkg-1.4.7+forge-1.9" = _MsdfpL62;
        "pkg-1.4.7+forge-1.12" = _1iDVXBtp;
        "pkg-1.4.7+forge-1.14" = _g9dekRWZ;
        "pkg-1.4.7+forge-1.15" = _cCDBNuxR;
        "pkg-1.4.7+forge-1.16" = _ZeiuwBBg;
        "pkg-1.4.7+forge-1.17" = _sERfKOtb;
        "pkg-1.4.7+forge-1.18" = _VbHrnbEy;
        "pkg-1.4.7+forge-1.19" = _cJTyPTCH;
        "pkg-1.4.7+forge-1.19.3" = _7NN2qehh;
        "pkg-1.4.7+forge-1.19.4" = _x0gO3b5F;
        "pkg-1.4.7+neoforge-1.20.2" = _DEi3cuFV;
        "pkg-1.4.7+neoforge-1.21" = _Dxc2NR3x;
        "pkg-1.4.7+fabric-1.21.4" = _9zJFyYjZ;
        "pkg-1.4.7+fabric-1.21.5" = _a4WQVEND;
        "pkg-1.4.7+neoforge-1.21.4" = _WbK42EP2;
        "pkg-1.4.7+neoforge-1.21.5" = _vUkO3jJ1;
        "pkg-1.4.7_01+fabric-1.21.4" = _nNgZKzPR;
        "pkg-1.4.7+vanilla-b1.7.3" = _OuaRfhcF;
        "pkg-1.4.7_01+fabric-1.21.5" = _ssiog3u8;
        "pkg-1.4.7_01+neoforge-1.21.5" = _hHwl9j4r;
        "pkg-1.4.7+neoforge-1.21.10" = _etLlXfJE;
        "pkg-1.4.7+fabric-1.21.10" = _cwk4AXRA;
        "pkg-1.4.7_01+fabric-1.21.10" = _lZdsQUDs;
        "pkg-1.4.7_01+neoforge-1.21.10" = _caf1WSYc;
        "pkg-1.4.7+fabric-1.21.11" = _PNdjhzGg;
        "pkg-1.4.7+neoforge-1.21.11" = _Ifc3YHYb;
        "pkg-1.4.7_02+neoforge-1.21.10" = _LqALGpCc;
        "pkg-1.4.7_01+neoforge-1.21.11" = _owy883KC;
        "pkg-1.4.7_02+fabric-1.21.4" = _DZFAtOnh;
        "pkg-1.4.7_01+neoforge-1.21.4" = _uwZ9YPJK;
        "pkg-1.4.7_02+fabric-1.21.5" = _xOFUwyED;
        "pkg-1.4.7_02+neoforge-1.21.5" = _5PRlA3bN;
        "pkg-1.4.7_02+fabric-1.21.10" = _UtemjD1P;
        "pkg-1.4.7_03+neoforge-1.21.10" = _WL8PNjeo;
        "pkg-1.4.7_01+fabric-1.21.11" = _veQXWh43;
        "pkg-1.4.7_02+neoforge-1.21.11" = _lvpfYtDa;
        "pkg-1.4.7+fabric-26.1" = _s5BZ8Xv7;
        "pkg-1.4.7+neoforge-26.1" = _CpVKECPg;
        "pkg-1.4.7_01+stapi-b1.7.3" = _ICfkvFVG;
        "pkg-1.4.7_03+fabric-1.21.10" = _a9IE3zQy;
        "pkg-1.4.7_04+neoforge-1.21.10" = _mgYdVHWn;
        "pkg-1.4.7_02+fabric-1.21.11" = _WiPt3Pqh;
        "pkg-1.4.7_03+neoforge-1.21.11" = _O4uyNQD2;
        "pkg-1.4.7_03+fabric-1.21.4" = _TPdnkxJj;
        "pkg-1.4.7_02+neoforge-1.21.4" = _5JGTCity;
        "pkg-1.4.7_03+fabric-1.21.5" = _oS1LdJxh;
        "pkg-1.4.7_03+neoforge-1.21.5" = _CjjJ4Y5V;
        "pkg-1.4.7_01+fabric-26.1" = _l1AXTUdE;
        "pkg-1.4.7_01+neoforge-26.1" = _F77amHhu;
        "pkg-1.4.7+fabric-26.3" = _f3EUl5Ep;
        "pkg-2.0.0+thermite" = _6oiYkLHk;
        "pkg-2.0.1+thermite" = _Oy3spSmn;
        "pkg-2.0.1+buzz-fabric" = _DEhRbQxJ;
        "pkg-2.0.1+buzz-forge" = _9czFtw2N;
        "pkg-2.0.1+plateau" = _m1FhUfX9;
        "pkg-2.0.1+buzz-neo" = _L3yCjYrE;
        "pkg-2.0.1+fabric-1.21.11" = _HV64XDEr;
        "pkg-2.0.1+neoforge-1.21.11" = _RwZcSlH4;
        "pkg-2.0.2+neoforge-1.21.11" = _2hMij4Su;
        "pkg-2.0.2+fabric-1.21.11" = _vvCnKfTO;
        "pkg-2.1.0+buzz-fabric" = _hoCqH7iv;
        "pkg-2.1.0+buzz-forge" = _wXhv6vSZ;
        "pkg-2.1.0+buzz-neo" = _Ez9t5qGR;
        "pkg-2.1.0+fabric-1.21.11" = _GYayFDqi;
        "pkg-2.1.0+neo-1.21.11" = _GkWMvBS4;
        "pkg-2.1.0+plateau" = _wmHPsTgb;
        "pkg-2.1.0+thermite" = _XsRJWcmT;
        "pkg-2.1.1+fabric-1.21.11" = _HeXrqoJl;
        "pkg-2.1.1+neo-1.21.11" = _g1m6F8Pl;
        "pkg-2.1.1+strife" = _nSNyLZDa;
        "pkg-2.1.2+buzz-fabric" = _348gxlkv;
        "pkg-2.1.2+buzz-forge" = _PohbGg5d;
        "pkg-2.1.2+buzz-neo" = _Laga35OM;
        "pkg-2.1.2+strife" = _OanGDrJM;
        "pkg-2.2.0-a+buzz-fabric" = _YO63YJbH;
        "pkg-2.2.0-a+buzz-forge" = _wCjAO2DE;
        "pkg-2.2.0-a+buzz-neo" = _6pVsV4VS;
        "pkg-2.2.0-a+fabric-1.21.11" = _ZvkrlOpa;
        "pkg-2.2.0-a+neo-1.21.11" = _pS3DwLkY;
        "pkg-2.2.0-a+plateau" = _RpYKbhGy;
        "pkg-2.2.0-a+strife" = _n0RpwkI2;
        "pkg-2.2.0-a+thermite" = _V171BG0A;
        "pkg-2.2.0-b+thermite" = _rNlfQOYe;
        "pkg-2.2.0-b+buzz-fabric" = _Iynp3j7Z;
        "pkg-2.2.0-b+buzz-forge" = _wcYB8DRM;
        "pkg-2.2.0-b+buzz-neo" = _79JnaPZk;
        "pkg-2.2.1-a+buzz-fabric" = _pHQioWNq;
        "pkg-2.2.1-a+buzz-forge" = _kiXPwDw6;
        "pkg-2.2.1-a+buzz-neo" = _Q1ZcNy9h;
        "pkg-2.2.1-a+fabric-1.21.11" = _OEInBxEN;
        "pkg-2.2.1-a+neo-1.21.11" = _h1mx6SYP;
        "pkg-2.2.1-a+plateau" = _7bPIBvH9;
        "pkg-2.2.1-a+strife" = _4mVO7YC1;
        "pkg-2.2.1-a+thermite" = _Ow65YIZu;
        "pkg-2.2.1-b+buzz-fabric" = _aeVAp1bc;
        "pkg-2.2.1-b+buzz-forge" = _iJLKjZGh;
        "pkg-2.2.1-b+buzz-neo" = _e0uHgkKI;
        "pkg-2.2.1-b+fabric-1.21.11" = _BFUydEVG;
        "pkg-2.2.1-b+neo-1.21.11" = _eckRo4TZ;
        "pkg-2.2.1-b+plateau" = _u2ZQbwQD;
        "pkg-2.2.1-b+strife" = _5ujyn8f6;
        "pkg-2.2.1-b+thermite" = _o7RIJrgm;
        "pkg-2.2.1-c+buzz-fabric" = _gDca6bvp;
        "pkg-2.2.1-c+buzz-forge" = _eNvnNxLB;
        "pkg-2.2.1-c+buzz-neo" = _h496H0Wu;
        "pkg-2.2.1-c+fabric-1.21.11" = _ISYvFnpI;
        "pkg-2.2.1-c+neo-1.21.11" = _G4vPnvWh;
        "pkg-2.2.1-c+plateau" = _ItUS3Avu;
        "pkg-2.2.1-c+strife" = _GEdE12fk;
        "pkg-2.2.1-c+thermite" = _MWdkKcnk;
        "pkg-2.2.1-d+thermite" = _Tdfeeflh;
        "default" = _Tdfeeflh;
    });
