...
let
    versions = (let
        ...
        _ju9to9jC = {
            "id" = "ju9to9jC";
            "file" = "resourcelibrary-forge-26.2-4.0.0.jar";
            "hash" = "sha512-Wwo4SgtcBiOKOCOpdqrd9cdCUSvJ/XyVIcO1JyhfnjPE1edcegoXwvGEJkHPJqy/OQ7ooDiuZJFwiQmfC+P4BQ==";
        };
        _KpyKgwST = {
            "id" = "KpyKgwST";
            "file" = "resourcelibrary-fabric-26.2-4.0.0.jar";
            "hash" = "sha512-i7PB/ZjDum2un212hMKP7N9R8H6QtVQwd+zhVLCcrEAHWdQP5oDTiEbJM1Kc9PHihMYnPMhSkl4YRZsn5XCabA==";
        };
        _uLzDuqt8 = {
            "id" = "uLzDuqt8";
            "file" = "resourcelibrary-neoforge-26.2-4.0.0.jar";
            "hash" = "sha512-t8vW7eW/7RRjxjFyJ7XGdAvE1sqQiBqF+R2bODuCigCsQTWdgx05yzqHg/+uIPUsN1UE9jhF0Rrd+FQefI0l5Q==";
        };
        _R5QpG6HW = {
            "id" = "R5QpG6HW";
            "file" = "resourcelibrary-forge-26.2-4.0.1.jar";
            "hash" = "sha512-8W13kkogN8xqk/sgcxAZepsSdb6LJ6jImxVRbGH4YIJGYBmYA78bUZ+T0gg/wa97uGQfObOvtYtW0WzgL7Fb1g==";
        };
        _H9JaSWJj = {
            "id" = "H9JaSWJj";
            "file" = "resourcelibrary-fabric-26.2-4.0.1.jar";
            "hash" = "sha512-7hC3X5/NVs8toeQ7fwFpWJGzOPmL/b3A85BNHGoZ2kSSU+o6T6zw1DncQcf4+88aviYm7n+2ul6B2u9OGD8BRw==";
        };
        _psaYz5F6 = {
            "id" = "psaYz5F6";
            "file" = "resourcelibrary-neoforge-26.2-4.0.1.jar";
            "hash" = "sha512-10emF4sXrTfydFPXo5Hcf97xGZiVcWzpvvuq2QRKwVT2LZSj9FrA0dZdcRooYA4s4kwdEr+tfkL9JQfSDHuk+w==";
        };
        _qkQEEHVG = {
            "id" = "qkQEEHVG";
            "file" = "resourcelibrary-forge-26.2-4.0.3.jar";
            "hash" = "sha512-NpHs4WTApQc9ViwKU+BAO1Cl9yaPhgNmo3HbtOQ4zzbOVUkJ1X7tgtcHd5bgm9mOfzKj8dcU6HnbyP5J+DRSmw==";
        };
        _FVtgycoF = {
            "id" = "FVtgycoF";
            "file" = "resourcelibrary-neoforge-26.2-4.0.3.jar";
            "hash" = "sha512-Zb0CNnNVvrXMY3UP0s6BstykJ/aFI0Lp2DjBr+ZSE22xN5+Y7dW12N5TE+g2heW0CKeMoiiE1QrY3+S9r3ZnSQ==";
        };
        _6qFsFbAY = {
            "id" = "6qFsFbAY";
            "file" = "resourcelibrary-fabric-26.2-4.0.3.jar";
            "hash" = "sha512-DcmuIL+ocFqRKyarQcLCo5MSmmb+9Y+vkGhahnlVGie0cPa/lvqhwUe9zRqrSesNdJ9nhTV1+SX1TwE5+tR4JQ==";
        };
        _CKwVtk5G = {
            "id" = "CKwVtk5G";
            "file" = "resourcelibrary-forge-26.1.2-4.0.3.jar";
            "hash" = "sha512-D9wvcA8p9GAcN4IXznJ3xVJeKZC6n4UmBbINrSb6JQzD1A389/1lrmDI2L/WHkou18QOokc5z1pGNLxNOvWdxg==";
        };
        _tP6X2Zs1 = {
            "id" = "tP6X2Zs1";
            "file" = "resourcelibrary-fabric-26.1.2-4.0.3.jar";
            "hash" = "sha512-KaRRBl/9iaUOZsvrfHaAh3h/8nXkjWfDSF2Av5BnhZ3svfxqkvLXFTnEfMUwxv6B1xW5DZ8FB0anIn1EzqGekQ==";
        };
        _DES9jU2E = {
            "id" = "DES9jU2E";
            "file" = "resourcelibrary-neoforge-26.1.2-4.0.3.jar";
            "hash" = "sha512-YSm9Q38HOajRctPIE25xJH/nRKbjv5yOrayjGZ1vO8wCxl6C1n34aQV1O4K8hZFluxlzaf8QjwqtS3rncBlBVg==";
        };
    in {
        "u68dRKYd" = _u68dRKYd;
        "x5cTKl7l" = _x5cTKl7l;
        ...
        "neoforge-26.1.2" = _DES9jU2E;
        "neoforge-26.2" = _FVtgycoF;
        ...
        "fabric-26.1.2" = _tP6X2Zs1;
        "fabric-26.2" = _6qFsFbAY;
        ...
        "forge-26.2" = _qkQEEHVG;
        "forge-26.1.2" = _CKwVtk5G;
        "pkg-1.20.5-1.0.0" = _x5cTKl7l;
        "pkg-1.20.5-1.1.0" = _uIUjIfXc;
        "pkg-1.20.5-1.2.1" = _646CShKn;
        "pkg-1.20-1.3.0" = _uIYGUKZK;
        "pkg-1.20.1-1.3.0" = _J5xEz9RK;
        "pkg-1.20.2-1.3.0" = _NoGbskml;
        "pkg-1.20.3-1.3.0" = _Aqm37yXm;
        "pkg-1.20.4-1.3.0" = _oDrHV1O4;
        "pkg-1.20.5-1.3.0" = _xJyaa3sG;
        "pkg-1.20.6-1.3.0" = _A8p7G2f7;
        "pkg-1.20-1.3.1" = _ZF3AHPfo;
        "pkg-1.20.1-1.3.1" = _oHjGxzpd;
        "pkg-1.20.2-1.3.1" = _cFLp0MIK;
        "pkg-1.20.3-1.3.1" = _s6b26szI;
        "pkg-1.20.4-1.3.1" = _kTiEVI0B;
        "pkg-1.20.5-1.3.1" = _A7iXujbq;
        "pkg-1.20.6-1.3.1" = _LmCJS1iu;
        "pkg-1.21-2.0.0" = _tfh6WZYY;
        "pkg-1.21-2.0.1" = _4ApYyUfk;
        "pkg-1.21-2.0.2" = _9VGd4AVi;
        "pkg-1.21.1-2.0.2" = _480COhv3;
        "pkg-1.21.1-2.0.3" = _mnTbjLa3;
        "pkg-1.21-2.0.3" = _F3PB77J3;
        "pkg-1.21.3-2.3.0" = _MamCw6mj;
        "pkg-1.21.3-2.3.2" = _w7V8E5vH;
        "pkg-1.21.4-2.3.3" = _yHRwgHVG;
        "pkg-1.21.1-2.1.5" = _V8Yt85sI;
        "pkg-1.21.3-2.3.5" = _EVN6TU5m;
        "pkg-1.21.4-2.4.5" = _aR2VFJZ6;
        "pkg-1.21.1-2.1.6" = _NITrLrhC;
        "pkg-1.21.3-2.3.6" = _nldT3e52;
        "pkg-1.21.4-2.4.6" = _8mUXlp2K;
        "pkg-1.21.1-2.1.7" = _SgynYhNc;
        "pkg-1.21.3-2.3.7" = _mDMwO5AZ;
        "pkg-1.21.4-2.4.7" = _7PP6i96K;
        "pkg-1.21.1-2.5.0" = _NriFn00J;
        "pkg-1.21.3-2.5.0" = _nqHwqEG3;
        "pkg-1.21.4-2.5.0" = _a3J6JViJ;
        "pkg-1.21.5-2.5.0" = _g9DWglCH;
        "pkg-1.21.1-2.5.1" = _iutBKQCZ;
        "pkg-1.21.3-2.5.1" = _jBerwWyO;
        "pkg-1.21.4-2.5.1" = _4ga95ZO0;
        "pkg-1.21.5-2.5.1" = _wt4FmoOY;
        "pkg-1.21.1-2.5.2" = _jPNau0Jc;
        "pkg-1.21.3-2.5.2" = _jUGCKvw0;
        "pkg-1.21.4-2.5.2" = _VSj3Zuzu;
        "pkg-1.21.5-2.5.2" = _p7wxxsN9;
        "pkg-1.21.1-2.6.0" = _ekjC5cKH;
        "pkg-1.21.3-2.6.0" = _o9et3kVi;
        "pkg-1.21.4-2.6.0" = _DPvI5mfd;
        "pkg-1.21.5-2.6.0" = _zh0wULlY;
        "pkg-1.21.6-2.6.0" = _CYKEtILq;
        "pkg-1.21.1-2.6.1" = _6qS3Iw6n;
        "pkg-1.21.3-2.6.1" = _NwJeGezh;
        "pkg-1.21.4-2.6.1" = _RfHTJwrK;
        "pkg-1.21.5-2.6.1" = _KrlCjz0f;
        "pkg-1.21.6-2.6.1" = _1zgyJTqS;
        "pkg-1.21.1-2.7.0" = _cP8soqau;
        "pkg-1.21.3-2.7.0" = _fFSO3Al1;
        "pkg-1.21.4-2.7.0" = _TNSEEYpm;
        "pkg-1.21.5-2.7.0" = _eaA3bRM1;
        "pkg-1.21.7-2.7.0" = _CLU1Z8vv;
        "pkg-1.21.8-2.7.0" = _ZrNFYyub;
        "pkg-1.21.1-2.8.0" = _pfVyG8hK;
        "pkg-1.21.8-2.8.0" = _WRwfxkZl;
        "pkg-1.21.1-2.8.1" = _FASXSvSo;
        "pkg-1.21.8-2.8.1" = _6bXrRxx6;
        "pkg-1.21.1-2.8.2" = _Zcv2whvH;
        "pkg-1.21.8-2.8.2" = _wVaH1OZR;
        "pkg-1.21.9-2.9.1" = _DpsKLK0J;
        "pkg-1.21.1-2.9.1" = _BNCrn8Qz;
        "pkg-1.21.10-2.9.1" = _nR9foDjj;
        "pkg-1.21.1-2.9.2" = _kIopDMVm;
        "pkg-1.21.10-2.9.2" = _73aiehck;
        "pkg-1.21.11-2.10.0" = _NqGWDeZc;
        "pkg-1.21.1-2.10.0" = _xiYocHIu;
        "pkg-26.1.2-3.0.0" = _BSw5sw4E;
        "pkg-26.1.2-3.0.1" = _SJg15g1s;
        "pkg-26.1.2-3.0.2" = _n5U6rSQE;
        "pkg-4.0.0" = _uLzDuqt8;
        "pkg-4.0.1" = _psaYz5F6;
        "pkg-4.0.3" = _6qFsFbAY;
        "pkg-26.1.2-4.0.3" = _DES9jU2E;
        "default" = _DES9jU2E;
    });
