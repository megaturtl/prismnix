...
let
    ...
    in {
        ...
        "pkg-1.9.5" = _rg1Ag0Xa;
        "pkg-1.9.6" = _e6pqP1kk;
        "pkg-1.9.7-power" = _lc9RHqJS;
        "pkg-1.9.8.1" = _wpiAkxfX;
        "pkg-1.9.9-1" = _7cVoMCwV;
        "pkg-1.9.9-2" = _VHsDTC8a;
        "pkg-0.0.9" = _jr9q8h8X;
        "pkg-2.0.1" = _Pla5mVQE;
        "pkg-2.0.2" = _DV28gmlS;
        "pkg-2.0.3" = _RtpOTeuc;
