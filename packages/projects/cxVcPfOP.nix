...
let
    versions = (let
        ...
        _C6XsAWva = {
            "id" = "C6XsAWva";
            "file" = "elytra_yellow-1.0.1-mc26.3.zip";
            "hash" = "sha512-s/VanIjwB4mCDREvZp/j0LE49XPhytJwjd/t6uhdx2s2TjF2ENlzz42c08drzc8+6rMptNgT/OLgJhlrYiBzdQ==";
        };
    in {
        "R9Yc8SAl" = _R9Yc8SAl;
        "yRA5EJFo" = _yRA5EJFo;
