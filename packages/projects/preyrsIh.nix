...
let
    versions = (let
        ...
        _lHMP0Kuy = {
            "id" = "lHMP0Kuy";
            "file" = "ptp+26.2-1.0.35.jar";
            "hash" = "sha512-25kkQimCoRM8dAQhUNZmOShgifwU8wuRP4EM99SfDJ3cq6cBBuIvxx39hMn5VCQqvlvASTJkXaOLKA4CqNl2Zg==";
        };
        _60A0KoTU = {
            "id" = "60A0KoTU";
            "file" = "ptp+26.1.2-1.0.35.jar";
            "hash" = "sha512-j9GMIKHLN/fAlCeP9RF6HSBZaLRRcXHysJPsnzvn1XHLNyPafuCJuwBlKycbHdWMTRoKNWF0FNth+3KXPH3c8w==";
        };
        _JssUtDBU = {
            "id" = "JssUtDBU";
            "file" = "ptp+1.21.11-1.0.35.jar";
            "hash" = "sha512-Yk1Hc3ZxZApKjWIlXiwfzs9dWStlH1L8d4W4faGmY0nNenBAvead674sIF7nXE86qMHcbEYQrB6vJzZc4lD35A==";
        };
        _TE90Ta9c = {
            "id" = "TE90Ta9c";
            "file" = "ptp+1.21.10-1.0.35.jar";
            "hash" = "sha512-0nrIFycbPfLKWEhweSXCfxdG8aGPljYgW6vVHQfjlwDlTfeBtpN3812+rhBQL2YHp363SsER07PeOMwCW4M1cw==";
        };
        _iKYMIWFM = {
            "id" = "iKYMIWFM";
            "file" = "ptp+1.21.8-1.0.35.jar";
            "hash" = "sha512-vViTpwvm0vVgBv60mqhkeoEp8eDdgOe4A1k6uO+U5T9k+PyuHRThMdGnSWO2OsnHKciNnNzlbPJ83TGiLrKdQQ==";
        };
        _BVv8JOZw = {
            "id" = "BVv8JOZw";
            "file" = "ptp+1.21.5-1.0.35.jar";
            "hash" = "sha512-a9jn3mwNe06zKiyAlhuLkPlj2mKOZs32WI6fIaTLY/BtS7fXmRuexhJrC2gw45X6ZN06fojh8Hv0sIIgbCwQZQ==";
        };
        _KuC5w0Ia = {
            "id" = "KuC5w0Ia";
            "file" = "ptp+1.21.4-1.0.35.jar";
            "hash" = "sha512-8BTXhP5xNJpTm5lEot1s+H/HktxsGNHluUS1U9ULxusU30AhDbD28zPP12yqtR+U0P2rejioSr6OhoFcMtX8sA==";
        };
        _VzINMnP5 = {
            "id" = "VzINMnP5";
            "file" = "ptp+1.21.1-1.0.35.jar";
            "hash" = "sha512-DieQX+mX/w9HOk16IpdFOo5Da8aefgsDf6O0E/I1m/JkVzMto2L0tSbqTknbIUBv81RqcE/3sYiEJVWckhbEIA==";
        };
        _hjBuCRBt = {
            "id" = "hjBuCRBt";
            "file" = "ptp+1.21.3-1.0.35.jar";
            "hash" = "sha512-UEqRtDkbveHz4Ir8Zky4LuNfpMs2s1r13+ZYfLyT4c3TYPsHFRNZDktpMuI2J7VmDuIZWwFfQhUZNpFymAGBWQ==";
        };
        _Nm5EDbGP = {
            "id" = "Nm5EDbGP";
            "file" = "ptp+26.3-rc-3-1.0.35.jar";
            "hash" = "sha512-Z0zmyfpno4woIyalD1F6gknUqIsiQ1Zx3dSJcoHP0x4yFskyR6KiPQESx9rvN9pR5cbcaMyTAD2RDqzEb7bw/A==";
        };
        _id24PSZA = {
            "id" = "id24PSZA";
            "file" = "ptp+26.3-rc-3-1.0.35.jar";
    ...
    in {
        ...
        "Nm5EDbGP" = _Nm5EDbGP;
        "id24PSZA" = _id24PSZA;
        "fabric-1.21.4" = _KuC5w0Ia;
        "fabric-1.21.5" = _BVv8JOZw;
        "fabric-1.21.6" = _iKYMIWFM;
        "fabric-1.21.7" = _iKYMIWFM;
        "fabric-1.21.8" = _iKYMIWFM;
        "fabric-1.21.9" = _TE90Ta9c;
        "fabric-1.21.10" = _TE90Ta9c;
        "fabric-1.21" = _VzINMnP5;
        "fabric-1.21.1" = _VzINMnP5;
        ...
        "fabric-1.21.11" = _JssUtDBU;
        "fabric-1.21.2" = _hjBuCRBt;
        "fabric-1.21.3" = _hjBuCRBt;
        ...
        "fabric-26.1" = _60A0KoTU;
        "fabric-26.1.1-rc-1" = _KZsTxgnt;
        "fabric-26.1.1" = _60A0KoTU;
        "fabric-26.1.2" = _60A0KoTU;
        "fabric-26.2" = _lHMP0Kuy;
        "fabric-26.3" = _id24PSZA;
        "quilt-1.21.4" = _KuC5w0Ia;
        "quilt-1.21.5" = _BVv8JOZw;
        "quilt-1.21.6" = _iKYMIWFM;
        "quilt-1.21.7" = _iKYMIWFM;
        "quilt-1.21.8" = _iKYMIWFM;
        "quilt-1.21.9" = _TE90Ta9c;
        "quilt-1.21.10" = _TE90Ta9c;
        "quilt-1.21" = _VzINMnP5;
        "quilt-1.21.1" = _VzINMnP5;
        ...
        "quilt-1.21.11" = _JssUtDBU;
        "quilt-1.21.2" = _hjBuCRBt;
        "quilt-1.21.3" = _hjBuCRBt;
        ...
        "quilt-26.1" = _60A0KoTU;
        "quilt-26.1.1-rc-1" = _KZsTxgnt;
        "quilt-26.1.1" = _60A0KoTU;
        "quilt-26.1.2" = _60A0KoTU;
        "quilt-26.2" = _lHMP0Kuy;
        "quilt-26.3" = _id24PSZA;
        ...
        "pkg-1.0.8" = _mw9LngFO;
        "pkg-1.0.9" = _eK0btbfz;
        "pkg-1.0.10" = _CK3afvwX;
        "pkg-1.0.11" = _YljDrfuZ;
        "pkg-1.0.12" = _D5mOkgkp;
        "pkg-1.0.13" = _B1DeYumL;
        "pkg-1.0.14" = _2xGJkN6Q;
        "pkg-1.0.15" = _wcEF6LPq;
        "pkg-1.0.16-beta" = _BwV3bvCp;
        "pkg-1.0.17-beta" = _1Aa6Qbrp;
        "pkg-1.0.18" = _Gv0PwA4O;
        "pkg-1.0.19" = _He8t6yxa;
        "pkg-1.0.20" = _X0QwXKkc;
        "pkg-1.0.21" = _luwhWl8H;
        "pkg-1.0.22" = _4TlpTlGM;
        "pkg-1.0.23" = _ZzXQzbLA;
        "pkg-1.0.24" = _9TVChoE8;
        "pkg-1.0.24-neoforge" = _xmgIDoAe;
        "pkg-1.0.25" = _A6l0Ikuf;
        "pkg-1.0.25-neoforge" = _R60s3bQ3;
        "pkg-1.0.26" = _8g9BQMJA;
        "pkg-1.0.26-neoforge" = _ot43d32B;
        "pkg-1.0.27" = _nTYSAImz;
        "pkg-1.0.28" = _4kklrvMy;
        "pkg-1.0.29" = _9XlelEd4;
        "pkg-1.0.30" = _imVuZVQq;
        "pkg-1.0.31" = _5ZnG75U7;
        "pkg-1.0.32" = _Yo1AhaeD;
        "pkg-1.0.33" = _DCyIDJ7Z;
        "pkg-1.0.33-hotfix.1" = _xHKvHiFA;
        "pkg-1.0.34" = _pcf2SOQ3;
        "pkg-1.0.35" = _id24PSZA;
        "default" = _id24PSZA;
    });
