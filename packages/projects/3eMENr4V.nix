...
let
    versions = (let
        ...
        _CHhIdHEn = {
            "id" = "CHhIdHEn";
            "file" = "TechReborn-6.2.0.jar";
            "hash" = "sha512-k6ea7EeZLKF9qygp3pv3KsQnRvIevkVUIZwLI7636jWsbRdlDx9Z5V1zaDz7rboSLXJ/GTBLNW+P8HfSotGyxQ==";
        };
    in {
        "ZV5o1TW7" = _ZV5o1TW7;
        "NVt2POPY" = _NVt2POPY;
        ...
        "fabric-26.3" = _CHhIdHEn;
        "pkg-0.3.0.729+universal" = _ZV5o1TW7;
        "pkg-0.3.1.740+universal" = _NVt2POPY;
        "pkg-0.3.2.765+universal" = _BIWNLLGn;
        "pkg-0.4.0.799+universal" = _CpGbY3gi;
        "pkg-0.4.2.816+universal" = _T75fyQ3l;
        "pkg-0.4.3.851+universal" = _NGwpXNfe;
        "pkg-0.5.0.873+universal" = _8E2Uz0nR;
        "pkg-0.5.1.879+universal" = _DkecZhGB;
        "pkg-0.5.3.908+universal" = _Aqnskw4z;
        "pkg-0.5.4.932+universal" = _nvTNq1VP;
        "pkg-0.5.5.941+universal" = _2MDGtmaT;
        "pkg-0.5.6.963+universal" = _ZVkZb0m4;
        "pkg-0.6.0.1015+universal" = _xkf3n7UY;
        "pkg-0.6.1.1021+universal" = _l4UtuDQU;
        "pkg-0.7.0.1032+universal" = _Xk9eTrd0;
        "pkg-0.7.1.1056+universal" = _qadbXK71;
        "pkg-0.7.1.23+universal" = _PhlCxcH8;
        "pkg-0.7.2.40+universal" = _5LeDzmiU;
        "pkg-0.7.2.1066+universal" = _KjYHvRJx;
        "pkg-0.7.3.48+universal" = _zQt0dv94;
        "pkg-0.7.4.1074+universal" = _WOBtQCKC;
        "pkg-0.7.4.55+universal" = _vPTnqCt5;
        "pkg-0.7.5.10+universal" = _sWuB7j6W;
        "pkg-0.7.6.26+universal" = _KHERVPOe;
        "pkg-0.7.7.30+universal" = _lqQ877R8;
        "pkg-0.7.8.1081+universal" = _N05HLT11;
        "pkg-0.7.8.36+universal" = _iVst3eyB;
        "pkg-0.7.9.45+universal" = _fEmJbuUb;
        "pkg-0.7.10.51+universal" = _qaoO7uZM;
        "pkg-0.7.11.59+universal" = _tkt8etCM;
        "pkg-0.7.12.1089+universal" = _GjbhuMv9;
        "pkg-0.7.11.61+universal" = _EvC9GMiA;
        "pkg-0.7.13.1090+universal" = _1neK1oYP;
        "pkg-0.7.13.1091+universal" = _r2V4mKFY;
        "pkg-0.7.14.0002+universal" = _nDCuPPc6;
        "pkg-0.7.15.1096+universal" = _d3ZrhVYg;
        "pkg-1.0.0.74+universal" = _Sgn4y3lg;
        "pkg-1.0.1.75+universal" = _xhOhJNjZ;
        "pkg-1.0.2.92+universal" = _yVO6XyUp;
        "pkg-1.0.3.123+universal" = _EGoxhjWy;
        "pkg-1.0.4.143+universal" = _TpdxUiSW;
        "pkg-0.8.0.316+universal" = _Uhe9lo7q;
        "pkg-0.8.1.317+universal" = _hJSEJh27;
        "pkg-1.0.5.173+universal" = _CR2XXleu;
        "pkg-1.0.6.197+universal" = _YpnFfKiF;
        "pkg-0.7.16.1104+universal" = _87YhL0D3;
        "pkg-0.7.16.1106+universal" = _sW7rhjHR;
        "pkg-1.1.0.258+universal" = _Ivz3hsN7;
        "pkg-1.1.1.267+universal" = _cznxAOND;
        "pkg-1.2.0.3+universal" = _M0hjvzgA;
        "pkg-1.1.2.278+universal" = _qF5ugfes;
        "pkg-0.7.16.1108+universal" = _SdCCnIfa;
        "pkg-1.2.1.51+universal" = _pQYT3848;
        "pkg-1.2.2.52+universal" = _AIaAEz0Y;
        "pkg-0.8.2.318+universal" = _TxuCb0Vt;
        "pkg-1.2.3.76+universal" = _r0TiEK89;
        "pkg-1.3.0.81+universal" = _btnFuAHk;
        "pkg-0.7.17.1109+universal" = _OG6cfayO;
        "pkg-1.3.1.100+universal" = _a3vZYReI;
        "pkg-1.3.2.120+universal" = _Q7HlJoWw;
        "pkg-1.3.2.177+universal" = _JeoBeYSA;
        "pkg-1.3.2.6+universal" = _JU6bkQAV;
        "pkg-1.3.2.1+universal" = _KHETded4;
        "pkg-0.7.18.1110+universal" = _s8qAoNG2;
        "pkg-1.3.3.186+universal" = _v1jqKpJe;
        "pkg-1.3.3.15+universal" = _HwGKvZrK;
        "pkg-1.3.3.10+universal" = _bytPwtju;
        "pkg-1.3.4.187+universal" = _WlO7TlkK;
        "pkg-1.3.4.16+universal" = _rKuTTa9r;
        "pkg-1.3.4.11+universal" = _moRHZNH8;
        "pkg-1.4.0.38+universal" = _eUTgSSx4;
        "pkg-1.4.0.45+universal" = _1APl6Hmc;
        "pkg-1.4.1.49+universal" = _Q3VmDHcz;
        "pkg-1.4.2.50+universal" = _Fj4eHxL0;
        "pkg-1.4.3.52+universal" = _ZhqdTrlF;
        "pkg-1.4.4.54+universal" = _fVrTnZBY;
        "pkg-1.4.5.65+universal" = _WeqhoNNl;
        "pkg-1.4.6.67+universal" = _z7kN2uzi;
        "pkg-1.4.7.70+universal" = _tfE3Ct9s;
        "pkg-1.4.8.81+universal" = _252hF18i;
        "pkg-1.4.9.84+universal" = _hDQGD0FU;
        "pkg-1.4.10.95+universal" = _ug081N6U;
        "pkg-1.4.11.96+universal" = _KxZuS19y;
        "pkg-1.4.12.106+universal" = _PVYHvrsa;
        "pkg-1.4.12.107+universal" = _lKlPAZ01;
        "pkg-1.4.13.109+universal" = _KarzoFxu;
        "pkg-2.0.0.29+universal" = _cC3B5X0L;
        "pkg-2.0.1.32+universal" = _hCDQCi51;
        "pkg-2.0.1.34+universal" = _EhBpqdcE;
        "pkg-1.4.14.118+universal" = _NeR1aoke;
        "pkg-2.0.2.41+universal" = _S83CAk5w;
        "pkg-2.0.3.43+universal" = _6nA8lUZm;
        "pkg-2.0.4.47+universal" = _q3GsAJKw;
        "pkg-2.0.4.50+universal" = _Brz33KiO;
        "pkg-1.4.15.125+universal" = _DvTWNrRN;
        "pkg-2.0.5.63+universal" = _UBh5AF5m;
        "pkg-1.4.15.127+universal" = _4o48JP04;
        "pkg-2.0.6.71+universal" = _AYIpZEhd;
        "pkg-2.0.7.77+universal" = _qK9wrnHt;
        "pkg-2.0.8.84+universal" = _rdcINsFk;
        "pkg-1.4.16.133+universal" = _1sRSSf7t;
        "pkg-2.0.8.85+universal" = _DVdeEnzf;
        "pkg-2.0.8.91+universal" = _mZCUzUie;
        "pkg-2.0.9.2+universal" = _SkidjamW;
        "pkg-2.0.9.8+universal" = _A8vGYDaY;
        "pkg-2.0.9.16+universal" = _fegPusEz;
        "pkg-1.4.17.141+universal" = _tqG2EKOh;
        "pkg-2.0.9.25+universal" = _RiBIu9b2;
        "pkg-1.5.0.146+universal" = _2BiTLeJd;
        "pkg-2.1.0.32+universal" = _R8iyjEQP;
        "pkg-2.1.1.156+universal" = _52t2FQOi;
        "pkg-2.1.1.42+universal" = _M6g06mAB;
        "pkg-2.1.2.160+universal" = _9xJBxUzC;
        "pkg-2.1.3.164+universal" = _zKw2jvvm;
        "pkg-2.1.3.54+universal" = _9DVHEY1A;
        "pkg-0.7.19.1115+universal" = _avUt9XfK;
        "pkg-2.1.4.172+universal" = _v2mXDBDD;
        "pkg-2.1.5.178+universal" = _n3764KRI;
        "pkg-2.1.4.73+universal" = _FOQAJuin;
        "pkg-2.1.6.180+universal" = _QEjrnt4Z;
        "pkg-2.1.6.76+universal" = _Y8I66fG8;
        "pkg-2.1.7.190+universal" = _f6uwBTki;
        "pkg-2.1.8.193+universal" = _EptfmdN3;
        "pkg-2.1.9.198+universal" = _OVsbRVRc;
        "pkg-2.1.9.82+universal" = _ybstISkJ;
        "pkg-2.1.10.88+universal" = _MNgYgZHx;
        "pkg-2.1.10.201+universal" = _ejT8BCSJ;
        "pkg-2.1.10.207+universal" = _VcbVZ1T6;
        "pkg-2.1.11.103+universal" = _ZAoGyg8d;
        "pkg-2.1.11.209+universal" = _OqWG41rl;
        "pkg-2.2.0.136+universal" = _W5jXFNBP;
        "pkg-2.2.0.137+universal" = _uvThTuLo;
        "pkg-2.2.1.142+universal" = _u2swcTC9;
        "pkg-2.1.12.215+universal" = _afg0UDJc;
        "pkg-2.3.0.152+universal" = _iz01ftpw;
        "pkg-2.1.13.219+universal" = _i0TM4y7R;
        "pkg-2.3.1.157+universal" = _keqejh2y;
        "pkg-2.3.1.158+universal" = _urX4wgz6;
        "pkg-2.3.2.167+universal" = _GdZxONe6;
        "pkg-2.3.3.174+universal" = _yAEb63sB;
        "pkg-0.7.20.1118+universal" = _nfAXx23k;
        "pkg-2.4.0.55+universal" = _uLZ7z2Lq;
        "pkg-2.4.1.56+universal" = _icA61nmy;
        "pkg-2.4.2.65+universal" = _lSCjSOwZ;
        "pkg-2.4.3.86+universal" = _Ao1QAfSP;
        "pkg-2.4.4.90+universal" = _Cz9iUNO5;
        "pkg-2.4.5.92+universal" = _gFv6W31f;
        "pkg-2.5.0.95+universal" = _tdCYP9bP;
        "pkg-2.5.0.96+universal" = _y7dXSuVm;
        "pkg-2.5.0.99+universal" = _SoN8Y6Nf;
        "pkg-2.6.0.119+universal" = _zg0XzJi1;
        "pkg-2.6.1.124+universal" = _ipZ8iU4O;
        "pkg-2.1.14.223+universal" = _oG2jDvFF;
        "pkg-2.6.2.139+universal" = _XvkxOvwp;
        "pkg-2.6.3.141+universal" = _Q85y3Orh;
        "pkg-2.6.4.144+universal" = _BCamHh4z;
        "pkg-2.6.5.150+universal" = _Zz5B3S1F;
        "pkg-2.6.6.151+universal" = _jXKzo8g0;
        "pkg-2.6.7.154+universal" = _FExvWutQ;
        "pkg-2.6.8.157+universal" = _6kEvCxh9;
        "pkg-2.3.3.181+universal" = _jKLTuWVz;
        "pkg-2.1.15.226+universal" = _wTSfSqjo;
        "pkg-2.1.16.231+universal" = _YsIe8kJP;
        "pkg-2.6.9.163+universal" = _kNbxIN0o;
        "pkg-2.6.9.165+universal" = _rVWYt01w;
        "pkg-2.1.17.233+universal" = _k285dhKH;
        "pkg-2.6.10.170+universal" = _12kSBdop;
        "pkg-2.6.11.177+universal" = _kjknAG75;
        "pkg-2.6.12.181+universal" = _Jg1ArQVT;
        "pkg-2.6.13.189+universal" = _uALtg23v;
        "pkg-2.7.0.205+universal" = _zBGrAlcQ;
        "pkg-2.7.1.224+universal" = _CVkgAtTZ;
        "pkg-2.7.2.233+universal" = _Cnnh7mA2;
        "pkg-2.7.3.241+universal" = _Fi9iUyr5;
        "pkg-2.7.4.243+universal" = _ekGBkJmU;
        "pkg-2.7.5.254+universal" = _idhN8tuB;
        "pkg-2.7.6.265+universal" = _zCOV0U15;
        "pkg-2.1.18.235+universal" = _FU6IA7bS;
        "pkg-2.7.7.283+universal" = _s3DOt7wz;
        "pkg-2.7.8.297+universal" = _7LmDV3LA;
        "pkg-2.7.9.301+universal" = _EZdq59EH;
        "pkg-2.7.10.327+universal" = _BtfxosbN;
        "pkg-2.8.0.333+universal" = _mpJnPOGP;
        "pkg-2.8.1.342+universal" = _EhYVVzWV;
        "pkg-2.9.0.349+universal" = _yXHTyQiB;
        "pkg-2.9.1.354+universal" = _e4UaCcnT;
        "pkg-2.10.0.364+universal" = _EIKfJQ42;
        "pkg-2.10.1.375+universal" = _6HRGw52F;
        "pkg-2.10.2.385+universal" = _8qMeqDlH;
        "pkg-2.10.3.386+universal" = _vy4JqE51;
        "pkg-2.10.4.394+universal" = _5RvXrkfG;
        "pkg-2.11.0.410+universal" = _bwsVRgPe;
        "pkg-2.11.1.420+universal" = _Pwu9ohhr;
        "pkg-2.12.0.445+universal" = _eGlQjj9x;
        "pkg-2.12.1.446+universal" = _TQK5VKEF;
        "pkg-2.12.2.452+universal" = _UCyN7vJD;
        "pkg-2.1.19.240+universal" = _USKYF0Tp;
        "pkg-2.12.3.477+universal" = _Mcpc2miB;
        "pkg-2.12.4.496+universal" = _VAYpdNhB;
        "pkg-2.12.5.501+universal" = _xxyjm3lJ;
        "pkg-2.12.6.510+universal" = _d8WAx9e0;
        "pkg-2.12.7.518+universal" = _RjX06QM1;
        "pkg-2.12.8.521+universal" = _3nhojUne;
        "pkg-2.12.9.528+universal" = _D6gz9mb9;
        "pkg-2.12.10.533+universal" = _aFPYchrR;
        "pkg-2.13.0.553+universal" = _K3VvGZvZ;
        "pkg-2.13.1.556+universal" = _Btr6GmCE;
        "pkg-2.13.2.561+universal" = _wWxRgfAf;
        "pkg-2.13.3.569+universal" = _9v7pwSHP;
        "pkg-2.13.4.573+universal" = _3wAg0XWS;
        "pkg-2.14.0.584+universal" = _nSZM1aGp;
        "pkg-2.15.0.602+universal" = _o5w9PbSH;
        "pkg-2.15.1.605+universal" = _Zo39EZUS;
        "pkg-2.15.2.608+universal" = _szewlEo5;
        "pkg-2.15.3.622+universal" = _bOP5MmbX;
        "pkg-2.15.4.624+universal" = _5jeXU7v5;
        "pkg-2.15.5.638+universal" = _8ggCLjsM;
        "pkg-2.15.6.642+universal" = _NGvynlrH;
        "pkg-2.15.7.649+universal" = _TbFVzB8a;
        "pkg-2.15.8.661+universal" = _1A7ffZMk;
        "pkg-2.15.9.663+universal" = _GPlrhA7G;
        "pkg-2.15.10.677+universal" = _xq7tF8qt;
        "pkg-2.15.11.688+universal" = _OkMpL1v8;
        "pkg-2.15.12.690+universal" = _NSIOTv9m;
        "pkg-2.15.13.703+universal" = _MJgzO3ed;
        "pkg-2.15.14.705+universal" = _8RK9XhHX;
        "pkg-2.15.15.712+universal" = _wQ9gnW11;
        "pkg-2.16.0.746+universal" = _7yS6LR8e;
        "pkg-2.16.1.765+universal" = _9RbezP0U;
        "pkg-2.16.2.769+universal" = _rMmaoVTr;
        "pkg-2.17.0.782+universal" = _9EY2RORh;
        "pkg-2.17.1.786+universal" = _bazFFo0R;
        "pkg-0.7.21.1131+universal" = _9yDBTln0;
        "pkg-2.17.2.811+universal" = _zJaSoNVB;
        "pkg-2.17.3.815+universal" = _aLDKvm03;
        "pkg-2.17.4.824+universal" = _DkiOBAz0;
        "pkg-2.17.6.828+universal" = _bivThTy9;
        "pkg-2.17.7.840+universal" = _VghKrzUy;
        "pkg-2.17.8.850+universal" = _VHKn5FxR;
        "pkg-2.18.0.856+universal" = _U2wAQ4UA;
        "pkg-2.18.1.863+universal" = _D7tuJFUb;
        "pkg-2.19.0.870+universal" = _9K1H6KLZ;
        "pkg-2.19.1.877+universal" = _MAOsR0Ib;
        "pkg-2.20.0.888+universal" = _nicBvgNH;
        "pkg-2.20.1.889+universal" = _Y4iIzrAe;
        "pkg-2.20.2.897+universal" = _Bn6C1XKW;
        "pkg-2.20.3.899+universal" = _Lj1MbViX;
        "pkg-2.20.4.906+universal" = _PqnrhPlq;
        "pkg-2.20.5.909+universal" = _8XluGYAM;
        "pkg-2.20.6.914+universal" = _qW5LWK8M;
        "pkg-2.20.7.915+universal" = _u969JXF3;
        "pkg-2.20.8.923+universal" = _EX38UoEV;
        "pkg-2.20.9.924+universal" = _O7EnEMi4;
        "pkg-2.20.10.926+universal" = _C7riTNcI;
        "pkg-2.20.11.929+universal" = _e95okMNd;
        "pkg-2.20.12.937+universal" = _rBExFToo;
        "pkg-2.20.13.940+universal" = _oKQuHD3q;
        "pkg-2.21.0.951+universal" = _DARITMms;
        "pkg-2.21.1.954+universal" = _v2bhNw5j;
        "pkg-2.21.2.960+universal" = _kmyNL4nl;
        "pkg-2.22.0.968+universal" = _5QMy1p9U;
        "pkg-2.1.19.241+universal" = _KOqdtBIO;
        "pkg-2.22.1.979+universal" = _TSkUk7wB;
        "pkg-2.23.0.1001+universal" = _tGAukgwM;
        "pkg-2.23.1.1003+universal" = _d0SADIdP;
        "pkg-2.23.2.1007+universal" = _YzjIjT9o;
        "pkg-2.24.1.1017+universal" = _kiPbBF0B;
        "pkg-3.0.0.78" = _DHuvuKuP;
        "pkg-3.0.1.84" = _aLPy8qrQ;
        "pkg-3.0.2.88" = _q4dS9SB7;
        "pkg-3.0.3.99" = _uE48tu7Q;
        "pkg-3.0.3.100" = _Rlx2mzbS;
        "pkg-3.0.3.101" = _pB7iZRPA;
        "pkg-3.0.4.108" = _fbBMw0IJ;
        "pkg-3.0.5.123" = _xkEC9ojH;
        "pkg-3.0.6.133" = _JwqO2kjQ;
        "pkg-3.0.7.138" = _rKZiQEKp;
        "pkg-3.0.8.151" = _hIZLLysi;
        "pkg-3.0.9.165" = _Kwz4xj27;
        "pkg-3.0.10.184" = _xDnCoPF0;
        "pkg-3.0.11.197" = _pd51pBgO;
        "pkg-2.24.1.1032+universal" = _Ei4eYjsr;
        "pkg-3.0.12.218" = _rtz6bh32;
        "pkg-1.14.4+3" = _yshaMGI3;
        "pkg-2.24.2.1041+universal" = _t5io15Ra;
        "pkg-2.24.3.1043+universal" = _MkTwr1Fq;
        "pkg-3.0.26" = _ioOxTVqA;
        "pkg-3.0.27" = _Wp2cEvBf;
        "pkg-3.0.28" = _QeHI0Qr1;
        "pkg-3.1.0" = _lSoXEfG7;
        "pkg-3.2.0" = _zQDDDj8W;
        "pkg-3.2.1" = _r9LiGU63;
        "pkg-3.2.2" = _qyiF9RnG;
        "pkg-2.26.2.1063+universal" = _JscEsmhD;
        "pkg-3.3.0" = _xFkxfCts;
        "pkg-3.3.1" = _yb3lMfJD;
        "pkg-2.26.3.1066+universal" = _M98MW8sg;
        "pkg-3.3.2" = _e5q8VKdu;
        "pkg-3.3.3" = _sO52hOCj;
        "pkg-3.3.4" = _kdaQWbsH;
        "pkg-2.27.1.1076+universal" = _qPZTIg1O;
        "pkg-3.3.5" = _vfEVuZBw;
        "pkg-3.3.6" = _a9QYV1kR;
        "pkg-3.3.7" = _fDXUy6B5;
        "pkg-2.27.2.1079+universal" = _tV1j9PDw;
        "pkg-3.3.8" = _hc18ot3s;
        "pkg-3.3.10" = _fLr2eWoT;
        "pkg-3.3.11" = _55kNkio0;
        "pkg-2.27.3.1084+universal" = _igWQfnP7;
        "pkg-3.4.0" = _eXqrI4WA;
        "pkg-3.4.2" = _85b8AJth;
        "pkg-3.4.3" = _4MRnWr82;
        "pkg-3.4.4" = _HwoiBqE1;
        ...
        "pkg-3.8.3" = _BJZ8QGYO;
        "pkg-3.8.4" = _1Xjt72d4;
        "pkg-5.0.1+beta" = _MKpx1481;
        "pkg-5.0.2+beta" = _On7hmrSm;
        "pkg-5.0.3+beta" = _rYK7mY8b;
        "pkg-5.0.4+beta" = _8IvBKpDT;
        "pkg-5.0.5+beta" = _ps0LQ7iK;
        "pkg-5.0.6+beta" = _AOeTjFmU;
        "pkg-5.0.7+beta" = _NEaUbIYc;
        "pkg-5.0.8+beta" = _Dpq27W8R;
        "pkg-5.0.9+beta" = _SSvjIxIL;
        "pkg-5.0.10+beta" = _Zq5y8LfY;
        "pkg-5.0.11" = _bcclkAzy;
        "pkg-5.1.0+beta" = _A6HTiOYB;
        "pkg-5.1.0" = _iGHcJpJ1;
        "pkg-5.2.0+beta" = _DKV3ojFL;
        "pkg-5.2.0" = _P4K4zKtK;
        "pkg-5.3.0" = _stDaN4Pz;
        "pkg-5.3.1" = _mAxAGbk6;
        "pkg-5.3.2" = _U4eEDesL;
        ...
        "pkg-5.9.0" = _77e0m01F;
        "pkg-5.9.1" = _zM6jEM0G;
        "pkg-5.10.0" = _E5dxG119;
        "pkg-5.10.1" = _GWa52AfD;
        "pkg-5.10.2" = _2x6DlkNk;
        "pkg-5.10.3" = _Nu2dwBY2;
        "pkg-5.10.4" = _Ig90NK0o;
        "pkg-5.11.0" = _cSpegwqY;
        "pkg-5.11.1" = _veBNZx6I;
        "pkg-5.11.2" = _exk31vWl;
        "pkg-5.11.3" = _4DrWW4K3;
        "pkg-5.11.4" = _J41hBL8R;
        "pkg-5.11.5" = _xMQuW1Fm;
        "pkg-5.11.6" = _xWR45gIV;
        "pkg-5.11.7" = _UOygJLpC;
        "pkg-5.11.8" = _vkiGgU00;
        "pkg-5.11.9" = _WUJV3hfT;
        "pkg-5.11.10" = _tYneg20h;
        "pkg-5.11.11" = _vEST3RPW;
        "pkg-5.11.12" = _L2wEkFVW;
        "pkg-5.11.13" = _IGLYRRuW;
        "pkg-5.12.0" = _jVONkE4V;
        "pkg-5.12.1" = _QGotKsPB;
        "pkg-5.12.2" = _NuDg7NNi;
        "pkg-5.12.3" = _jIkPg5wf;
        "pkg-5.12.4" = _qNagqxOZ;
        "pkg-5.12.5" = _aSlKNP8g;
        "pkg-5.8.8" = _aEugmDty;
        "pkg-5.11.15" = _CUZrEbux;
        "pkg-5.13.0" = _8XYfM8wk;
        "pkg-5.8.9" = _ayf7ywBu;
        "pkg-5.11.16" = _kufwBBTz;
        "pkg-5.12.6" = _BqJAvOKp;
        "pkg-5.13.1" = _ZVdNboKj;
        "pkg-5.11.17" = _9aCr2Fdp;
        "pkg-5.8.10" = _qjNPa1P1;
        "pkg-5.13.2" = _hzCKIGHJ;
        "pkg-5.12.7" = _Ero9OsfN;
        "pkg-5.8.11" = _cj9bV0zf;
        "pkg-5.8.12" = _ittOMgA9;
        "pkg-5.13.3" = _EjdiIDc7;
        "pkg-5.12.8" = _hOo4IlcJ;
        "pkg-5.11.18" = _qpctXwwN;
        "pkg-5.8.13" = _2OyY180Y;
        "pkg-5.11.19" = _CNwZZ4FD;
        "pkg-5.12.9" = _s9S93fPv;
        "pkg-5.13.4" = _ATBFXy8R;
        "pkg-5.14.0" = _vjGPjGs6;
        "pkg-5.14.1" = _NgWyRva7;
        "pkg-5.14.2" = _4IvWje25;
        "pkg-5.8.15" = _5ordAPa5;
        "pkg-6.0.0" = _MMeexbFg;
        "pkg-6.0.1" = _9URf438n;
        "pkg-6.0.2" = _JP5UqaPc;
        "pkg-6.0.3" = _LNx1oqv3;
