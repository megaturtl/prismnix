...
let
    versions = (let
        ...
        _IyVyrKj8 = {
            "id" = "IyVyrKj8";
            "file" = "spell_power-fabric-1.6.0+1.21.1.jar";
            "hash" = "sha512-7IV4zZZb2QJ9gbFpRJNjB8R1HmIHR+FyTx6XRYghlqlkHhgdko3ZrpBLiTJjF1gecobSgq0GFK40WfLH53KFDA==";
        };
        _RFCD8Aio = {
            "id" = "RFCD8Aio";
            "file" = "spell_power-neoforge-1.6.0+1.21.1.jar";
            "hash" = "sha512-tPmuJSR4Oi8dTxbac1Q/EHPhfny2ajYjXEtU50SV07c4kqNCR4zHYOxMK88EZXjzB3rzEBO0iwSpvef6zUjigQ==";
        };
        _N6PKJp4A = {
            "id" = "N6PKJp4A";
            "file" = "spell_power-fabric-1.6.1+26.1.2.jar";
            "hash" = "sha512-wErjcNfz01fOrJ8VtmtJ9Z4dCpV1r1BMd8oTDEWUD4iHTZDEIAY9L0F9A1UtKlZl+DQ24ZORVp5uYhz87CJT8w==";
        };
        _sBPO9FXr = {
            "id" = "sBPO9FXr";
            "file" = "spell_power-neoforge-1.6.1+26.1.2.jar";
            "hash" = "sha512-0C+XHcBQ1Y0U8a/+6qiZf1OeHb+prISzvJtkkIe0Sg1D6Ulj4MCBVIWeNnzxo1Cz1EJnMHvH2Shjlo+ijnoobw==";
        };
        _IkhOaLTR = {
            "id" = "IkhOaLTR";
            "file" = "spell_power-fabric-1.6.1+26.2.jar";
            "hash" = "sha512-NV81vsB2JtMWCIWC0bLtgqtfCCf9EoUsGhqW0FahpuzRZnLqgXcyfUobp5/Kb5HeV7Mq/b9C/AGFJuOOJJrSqg==";
        };
        _zkEHQgZY = {
            "id" = "zkEHQgZY";
            "file" = "spell_power-neoforge-1.6.1+26.2.jar";
            "hash" = "sha512-9wDBH8yToKS+k/1n+Mkiq+yUB8LvYkD5/5rHEKQHU3xwQwBA9T+CvEUot9S8XmrKHy8xU4WnVRtHZZkAnEik8g==";
        };
        _JlBYCif9 = {
            "id" = "JlBYCif9";
            "file" = "spell_power-neoforge-1.6.2+26.2.jar";
            "hash" = "sha512-IE4QI03sv2ykPcFPwBbKzyTKMt1/OLalogY8+AEktaLyBxJu9lHvgVxgkkqWa7PnJBUyiftOtkRW/xJMFP4GJw==";
        };
        _1QnsfrhD = {
            "id" = "1QnsfrhD";
            "file" = "spell_power-fabric-1.6.2+26.1.2.jar";
            "hash" = "sha512-2OTQm0CcBsiAxbHAd0m3jj2/wqUupNt7eF05rux4CQrIemG8wPQTpMkS04YvCjB8IVqeTxcybBorgXpMuzmelQ==";
        };
        _hZSvBdgk = {
            "id" = "hZSvBdgk";
            "file" = "spell_power-fabric-1.6.2+26.2.jar";
            "hash" = "sha512-LKZSB3iUDvqUimbiYwxWTfpn2uZmVGzzLJ7FvFiJCB2rILuj1FOEa3//EWBrPPmw7x46QBS1EEm7gEnvJ/dcCw==";
        };
        _O9s0d40b = {
            "id" = "O9s0d40b";
            "file" = "spell_power-neoforge-1.6.2+26.1.2.jar";
            "hash" = "sha512-QBY/nvqof6rapWTDR9kCc7xEV67I/n5V293A1DaJ/tkFsedc0qlSCmcFlb8me1f5VEvMdQO1Jod+vFOAAnIAIw==";
        };
        _USJAOCPM = {
            "id" = "USJAOCPM";
            "file" = "spell_power-forge-1.6.0+1.20.1.jar";
            "hash" = "sha512-WyjzCyykAm5Aj8SAmtKa79nhPFqJZx3L3nxCjNpjyhep+gaJz674KY6z9T6jIPKD1bXiSy27PWZl4+HbIfBPag==";
        };
        _ILAOxp49 = {
            "id" = "ILAOxp49";
    ...
    in {
        ...
        "pkg-1.6.0+1.21.1-fabric" = _IyVyrKj8;
        "pkg-1.6.0+1.21.1-neoforge" = _RFCD8Aio;
        "pkg-1.6.1+26.1.2-fabric" = _N6PKJp4A;
        "pkg-1.6.1+26.1.2-neoforge" = _sBPO9FXr;
        "pkg-1.6.1+26.2-fabric" = _IkhOaLTR;
        "pkg-1.6.1+26.2-neoforge" = _zkEHQgZY;
        "pkg-1.6.2+26.2-neoforge" = _JlBYCif9;
        "pkg-1.6.2+26.1.2-fabric" = _1QnsfrhD;
        "pkg-1.6.2+26.2-fabric" = _hZSvBdgk;
