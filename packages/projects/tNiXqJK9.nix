...
let
    versions = (let
        ...
        _elXripYr = {
            "id" = "elXripYr";
            "file" = "accuratehitboxes-fabric_quilt-2.4.1-1.20.1.jar";
            "hash" = "sha512-geuEMQNkrBTm+ugYK3oO6uZKbrtIwwMi0DdKZ+GaeA34vkqlqn02DqwrQHtU/6ZNtOECoOCXPg/6Qdoh0F+6Tg==";
        };
        _XFemBtSj = {
            "id" = "XFemBtSj";
            "file" = "accuratehitboxes-neoforge-2.4.1-1.20.1.jar";
            "hash" = "sha512-uLmUC1tIcLw8SQPHyHvpfNBYS77JqiOLnIP5ePe49Trau08GcGTDsWbeXxeiOk43ryYub5UHCgOENysowBAuzA==";
        };
        _Hecqalhx = {
            "id" = "Hecqalhx";
            "file" = "accuratehitboxes-fabric_quilt-2.4.2-1.20.1.jar";
            "hash" = "sha512-FGjx8ki2enOH7CDTL7L9v+ApAt3PboAGlY7BdvG00lkXyDrUz30mAYKaAXu4/oFmiviHUr0o2CJhrq4nMLp85g==";
        };
        _ULvLNDcs = {
            "id" = "ULvLNDcs";
            "file" = "accuratehitboxes-neoforge-2.4.2-1.20.1.jar";
            "hash" = "sha512-NLkwrotMCphNcXqgszMgvFhJm+u240i9+MXJSd/Ofe2LfO8ZVOHb5w9aNc9jI0hy8HBeYLbuMEqE5BTqBxK+WA==";
        };
    in {
        "OEf8XLai" = _OEf8XLai;
        "91iJ0Hnr" = _91iJ0Hnr;
        ...
        "Hecqalhx" = _Hecqalhx;
        "ULvLNDcs" = _ULvLNDcs;
        "fabric-1.20.1" = _Hecqalhx;
        "fabric-1.20.2" = _sLsuN60b;
        "fabric-1.20.3" = _sLsuN60b;
        "quilt-1.20.1" = _Hecqalhx;
        "quilt-1.20.2" = _sLsuN60b;
        "quilt-1.20.3" = _sLsuN60b;
        "forge-1.20.1" = _ULvLNDcs;
        "neoforge-1.20.1" = _ULvLNDcs;
        "neoforge-1.20.2" = _oL4v9mpc;
        "neoforge-1.20.3" = _oL4v9mpc;
        "pkg-Fabric_Quilt-1.0.0-1.20.1" = _OEf8XLai;
        "pkg-Fabric_Quilt-1.0.1-1.20.1" = _91iJ0Hnr;
        "pkg-NeoForge_Forge-1.0.1-1.20.1" = _SECkyXoh;
        "pkg-Fabric_Quilt-1.0.2-1.20.2" = _vv9zaWhj;
        "pkg-NeoForge-1.0.2-1.20.2" = _qcG8DBYE;
        "pkg-Fabric_Quilt-1.1.0-1.20.1" = _XnReqO8g;
        "pkg-NeoForge_Forge-1.1.0-1.20.1" = _ZSfVbncP;
        "pkg-Fabric_Quilt-1.1.0-1.20.2" = _5YaYFCkx;
        "pkg-NeoForge-1.1.0-1.20.2" = _n210cx7D;
        "pkg-Fabric_Quilt-1.1.1-1.20.2-1.20.3" = _1Y9RksOp;
        "pkg-NeoForge-1.1.1-1.20.2-1.20.3" = _FDRZWkkw;
        "pkg-Fabric_Quilt-1.2.0-1.20.1" = _6laTih47;
        "pkg-NeoForge_Forge-1.2.0-1.20.1" = _GVlT6KZg;
        "pkg-Fabric_Quilt-1.2.0-1.20.2-1.20.3" = _8zApUWrl;
        "pkg-NeoForge-1.2.0-1.20.2-1.20.3" = _6LjeDYTq;
        "pkg-Fabric_Quilt-2.0.0-1.20.1" = _WercXg4T;
        "pkg-NeoForge_Forge-2.0.0-1.20.1" = _aiytLsK4;
        "pkg-Fabric_Quilt-2.1.0-1.20.2-1.20.3" = _GuDzMItz;
        "pkg-NeoForge-2.1.0-1.20.2-1.20.3" = _r9isgSfv;
        "pkg-Fabric_Quilt-2.2.0-1.20.1" = _1HpuooQ0;
        "pkg-NeoForge_Forge-2.2.0-1.20.1" = _dSmgYvyK;
        "pkg-Fabric_Quilt-2.2.1-1.20.2-1.20.3" = _sLsuN60b;
        "pkg-NeoForge-2.2.1-1.20.2-1.20.3" = _oL4v9mpc;
        "pkg-Fabric_Quilt-2.3.0-1.20.1" = _RUT9QEZI;
        "pkg-NeoForge_Forge-2.3.0-1.20.1" = _OCwMlEzF;
        "pkg-Fabric_Quilt-2.3.1-1.20.1" = _hOybVd6i;
        "pkg-NeoForge_Forge-2.3.1-1.20.1" = _VSL3TJmL;
        "pkg-Fabric_Quilt-2.4.0-1.20.1" = _8mEtiz3s;
        "pkg-NeoForge_Forge-2.4.0-1.20.1" = _4I48Qcqe;
        "pkg-Fabric_Quilt-2.4.1-1.20.1" = _elXripYr;
        "pkg-NeoForge_Forge-2.4.1-1.20.1" = _XFemBtSj;
        "pkg-Fabric_Quilt-2.4.2-1.20.1" = _Hecqalhx;
        "pkg-NeoForge_Forge-2.4.2-1.20.1" = _ULvLNDcs;
        "default" = _ULvLNDcs;
    });
