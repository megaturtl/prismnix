...
let
    versions = (let
        ...
        _N4kpETBm = {
            "id" = "N4kpETBm";
            "file" = "TalkBalloons-fabric-1.6.0+1.20.1.jar";
            "hash" = "sha512-buHrDlLl8lGgOv/qQ4pqW8DEweyJ4oxcQGmfeSPPJDgTzBchcze8MHAa6Z9LR4eLUQ3E477qXa3J7RnmHpzK7g==";
        };
        _HNG3IIDc = {
            "id" = "HNG3IIDc";
            "file" = "TalkBalloons-fabric-1.6.0+1.20.4.jar";
            "hash" = "sha512-XKpb8qxdl3ReN8lDpEOKaDusUJEuxW0Ght39RGdsIOdVGxtk9a2gvMjlT6w3qBL2iifM6AgrCmJ6qQ08GUoMxg==";
        };
        _CbpA8VsF = {
            "id" = "CbpA8VsF";
            "file" = "TalkBalloons-fabric-1.6.0+1.21.1.jar";
            "hash" = "sha512-KbmR7I/J9IC4p0YPSkRkQXdZXku4vmkhLjHO/ojN5cRodgoZs2cw3h69AP+nj6VRu3DQtjQveGs5i7+82IYVWw==";
        };
        _KirWAqCC = {
            "id" = "KirWAqCC";
            "file" = "TalkBalloons-fabric-1.6.0+1.21.10.jar";
            "hash" = "sha512-gpZ/U9e+RtGad9qXx/mjyI8qsB0lTNMlrmrWYTQpN+HedwFsDn2ZEvc2+/WFmr84F5aXo9r6dx/2z0oa2fqRoA==";
        };
        _qDHBpOkW = {
            "id" = "qDHBpOkW";
            "file" = "TalkBalloons-fabric-1.6.0+1.20.4.jar";
        ...
        _pMebgi2V = {
            "id" = "pMebgi2V";
            "file" = "TalkBalloons-fabric-1.6.0+1.21.11.jar";
            "hash" = "sha512-aqiVTRkj9UaViv5O86CYN2S6YUwspAzTEzZOg23AMGR+OYatWP1AXyjuPUuAHzh48JAeMUeOgOC6rXBhLiFT1g==";
        };
        _X1QpZuUs = {
            "id" = "X1QpZuUs";
            "file" = "TalkBalloons-fabric-1.6.0+1.21.4.jar";
            "hash" = "sha512-SWczxioCWDbQVi/7j/jyGG2U5pEjd2XfYAuGJ68TGcb4xRT8+AWGcFVXmrHOpq7qsHlPxuLN9pdaOQaOfrvv0Q==";
        };
        _Dlh3U94l = {
            "id" = "Dlh3U94l";
            "file" = "TalkBalloons-fabric-1.6.0+1.21.5.jar";
            "hash" = "sha512-3EYSfrm2lc43OZHmvYD5z5GHK7AOWnXkN+HG+FCPKLwEz3mcFE8B9P+jvAhbkAh71piR6QSdViuOpP6TZLWapw==";
        };
        _iQA5a6rR = {
            "id" = "iQA5a6rR";
            "file" = "TalkBalloons-fabric-1.6.0+1.21.8.jar";
            "hash" = "sha512-vL4XZVhmnraElAonA4GxV9WxTYsLAwJlljNm3i6QFHCaWNOywyOaZOoG922zqyUghwenrmEwCZ6SIHTe4o0+5Q==";
        };
        _y3QSHjbC = {
            "id" = "y3QSHjbC";
            "file" = "TalkBalloons-fabric-1.6.0+26.1.2.jar";
            "hash" = "sha512-1ZeuR9nJqZXXxHg6csMhoosrfkIxBtB8+tEK47WpUyKGJfYM+g3W1cZh3Q10g4XqB1m+zuLWRCX6HXbdnTtxcA==";
        };
        _BkvY1U8A = {
            "id" = "BkvY1U8A";
            "file" = "TalkBalloons-fabric-1.6.0+26.2.jar";
            "hash" = "sha512-f2GKmTntL4sxerJGsQnWs66ue2FusdmYZS5nFw4yQIrSB7+lFPygkZwhbbEWe/rcsma0M1gtns1I4qtGpBo+3Q==";
        };
        _5uXQP8Yu = {
            "id" = "5uXQP8Yu";
            "file" = "TalkBalloons-forge-1.6.0+1.20.1.jar";
            "hash" = "sha512-LUXzuZsE8VQdBdI1TkL4O5vb5sy/UV9jvd1ftW0QiNmaRcJuVW3bPyHisxkd1uVnumlxAA6Rc+prpCFbw4oqrg==";
        };
        _efTN1TJm = {
            "id" = "efTN1TJm";
            "file" = "TalkBalloons-neoforge-1.6.0+1.20.4.jar";
            "hash" = "sha512-rvAJapuOk/TnalLNg+wKieLUYDJMcLPmDaA9cuS/oElxXXEG9meM3lh+TVWi7nh+PqdtR4Z/1onaHLh6Pus4UA==";
        };
        _QWNw7QIy = {
            "id" = "QWNw7QIy";
            "file" = "TalkBalloons-neoforge-1.6.0+1.21.1.jar";
            "hash" = "sha512-EW3HYjRaLXIW7Aefeh283rXSmzYkAJSZPx36uBQzh9g2CM2aj5E16Ge1kIxclVV74SaqTZAdPgGop/BOvVoxnQ==";
        };
        _Qmqeoqmi = {
            "id" = "Qmqeoqmi";
            "file" = "TalkBalloons-neoforge-1.6.0+1.21.10.jar";
            "hash" = "sha512-J1CBh3Dv/Iw32PHoVWe2uVQ4+FUcdBrcXfgabjgIdRPPGLA3kz5fO24HCYxriXJPyoROGIkNWwZMEoJDu8Wkjw==";
        };
        _AkxFcEUi = {
            "id" = "AkxFcEUi";
            "file" = "TalkBalloons-neoforge-1.6.0+1.21.11.jar";
            "hash" = "sha512-GdgD5ADMa/dhebjobRnkWF7lExuF3dTR6sBzyu0M5GwDdSFvPrpuShID1PazINrQ34nlftgZyOTfE40RiOWNtA==";
        };
        _pzXM4LxK = {
            "id" = "pzXM4LxK";
            "file" = "TalkBalloons-neoforge-1.6.0+1.21.4.jar";
            "hash" = "sha512-3dQ0Ng+FPLM+IdE/l4S1qP14OolQ5fCvGRdoWWqKN/TaCJNSn8IqUDT/r9tmjzdwTspbYSfweO1wyj7u7qCyOA==";
        };
        _6RdKlcw2 = {
            "id" = "6RdKlcw2";
            "file" = "TalkBalloons-neoforge-1.6.0+1.21.5.jar";
            "hash" = "sha512-NPvv0IxviOYRgDXE1qg4G/rfmat1K5zoVsNxkI02l6gw+EsVUGrEbXSnSqYtxFNz3A0sY69FmDQjy0TjoDU4sw==";
        };
        _hYgUmwC5 = {
            "id" = "hYgUmwC5";
            "file" = "TalkBalloons-neoforge-1.6.0+1.21.8.jar";
            "hash" = "sha512-15hXDzvXzyuD/bTGz/PEwAqOyQzhmVYAIbsmH70F8dLFSvD5bq+r6d9+CBF8dnfr6tp22kYAX5BdaoTIPo0CQg==";
        };
        _nVaureYQ = {
            "id" = "nVaureYQ";
            "file" = "TalkBalloons-neoforge-1.6.0+26.1.2.jar";
            "hash" = "sha512-zHaqU84ZTKuSI8Hd5sbxgNK1QH2XqJan2OK8XCvizCAftqtkuW6E+OSs4VIItySZfmk0gwiFw6Bcl3tut2AZEg==";
        };
        _DiFLefO2 = {
            "id" = "DiFLefO2";
            "file" = "TalkBalloons-neoforge-1.6.0+26.2.jar";
            "hash" = "sha512-AAdB9fqgLeBNES0xo8oGJ2Ma7Sukh/PUVOLMsigYSzV2SwD67jus8w5SX3w2DyXyxjC5TzILm5QWOxYDrMr7uA==";
        };
        _aJYSEBED = {
            "id" = "aJYSEBED";
            "file" = "TalkBalloons-fabric-1.6.1+1.20.1.jar";
            "hash" = "sha512-ymOasbmB6g9oW1MmGzP7jiV5qV31qwPujsXb3tGWBXRm/mjLGg2nUveKMkl9FQ5frptjoTmTt5jOKUvrZhKA7A==";
        };
        _1ZlGhESH = {
            "id" = "1ZlGhESH";
            "file" = "TalkBalloons-fabric-1.6.1+1.20.4.jar";
            "hash" = "sha512-OPdsGa+1HAi/+uPjjfkmnlw/9RUgUkYQYBEadWok/4i5uMvgIhGodb1iG0S4nfa+52iLFyWef64GFeSqxf4vUw==";
        };
        _28WfSsjd = {
            "id" = "28WfSsjd";
            "file" = "TalkBalloons-fabric-1.6.1+1.21.1.jar";
            "hash" = "sha512-oVnpwG5mez9Mwrsn+2wLoMWqiHpHOsiP7CRX0+z8BU3veVaEm+qb9YlJhENm1mHJxhN+5/Zec6eSlQaVpSSh4w==";
        };
        _rlRz8MTU = {
            "id" = "rlRz8MTU";
            "file" = "TalkBalloons-fabric-1.6.1+1.21.10.jar";
            "hash" = "sha512-gFRhRSFG1EdrVervqAD0hmX3m7NO7k0vcXgLQjsdzgzo0krMrHWfJJ7g77kiVbCicDxfkhagI+NiRv//rjP/OQ==";
        };
        _OTkhoU8H = {
            "id" = "OTkhoU8H";
            "file" = "TalkBalloons-fabric-1.6.1+1.21.11.jar";
            "hash" = "sha512-WCm77UinOdcRUig8cfWJge4GwQtC4m1CIqk5Fr/YZSCT/hOZo+xIY/5eyRkDxaQT6V+P0A/bDNyShoxVKQbl8w==";
        };
        _eGK6vc1Q = {
            "id" = "eGK6vc1Q";
            "file" = "TalkBalloons-fabric-1.6.1+1.21.4.jar";
            "hash" = "sha512-w67oKkwJAqXJHV738l6y02Qr0UiPFgYSDSNjppZNnpFuuzEV6OwZp5i4JcbfCwPsib3m235fnzIyIKbiXK5Zog==";
        };
        _9sCSHLzD = {
            "id" = "9sCSHLzD";
            "file" = "TalkBalloons-fabric-1.6.1+1.21.5.jar";
            "hash" = "sha512-kmRCoJn9o+egXcmKnlW1Mnxn5DcCGq6ZXvsG5e4B2UiZNLwLCNwTwEkIAlPC66FJEnQY3KqerBnlcgSZlr+Y6A==";
        };
        _GdClu0VR = {
            "id" = "GdClu0VR";
            "file" = "TalkBalloons-fabric-1.6.1+1.21.8.jar";
            "hash" = "sha512-ET8HTAMRs0OZlqnltwrr7DEc9NSwtPrQTCAlkzoYUxBTJv9sdf9VRpKAjNv8kezrIsMOihrM/VkfiminidexbA==";
        };
        _Fh6l8AMu = {
            "id" = "Fh6l8AMu";
            "file" = "TalkBalloons-fabric-1.6.1+26.1.2.jar";
            "hash" = "sha512-gzwdUy3e2MipsaAsCgKPzu9YdaxOzSQNgPOn2ZF/TkCX9V+8lGz0tzgzP7LyPAYZWcbqaum00fvDTV+8JiI/Nw==";
        };
        _gyjyNSIX = {
            "id" = "gyjyNSIX";
            "file" = "TalkBalloons-fabric-1.6.1+26.2.jar";
            "hash" = "sha512-3D6ouoAg6lLXu0WkQFPAtb1Ax1PDjNxUdmmmrG5bY2kyh35FjegBtJ+bte54PIZ2ORRXzsWZZ0BqxMsb2ek8Qw==";
        };
        _peqqZwFX = {
            "id" = "peqqZwFX";
            "file" = "TalkBalloons-forge-1.6.1+1.20.1.jar";
            "hash" = "sha512-cngYSv6lQsbS6oIcDKPMnaN86iTnv0yTe29yRatxnIqg415YobL2RO65xnlxyJpXHT/pHfu333vZksWZkuJ8fA==";
        };
        _Hyj65ST8 = {
            "id" = "Hyj65ST8";
            "file" = "TalkBalloons-neoforge-1.6.1+1.20.4.jar";
            "hash" = "sha512-mnusuLIrbvE5uPEm4DxvFqNw51JMP+AGdI6fRMOEEYL8+AdKLznKM/C+RVzif3TT9I08fm5hLS/qMWkizGwtcw==";
        };
        _gRaEjGOh = {
            "id" = "gRaEjGOh";
            "file" = "TalkBalloons-neoforge-1.6.1+1.21.1.jar";
            "hash" = "sha512-HbItslGvc3I4CyGKhs/1cRaWFCvu3drie50HwdB/buMl6CPM0EXZX7T0yQW09/Ob6XfFwtVVCvbNEIt1Hb3J1w==";
        };
        _PxOuL6Xl = {
            "id" = "PxOuL6Xl";
            "file" = "TalkBalloons-neoforge-1.6.1+1.21.10.jar";
            "hash" = "sha512-C1inkXpGpSbUi/BuPi6+s3CrZXvFrDq664Gfy5IGO2kM6L5eQSbsEtMAzANV/FKO+FIVzfO8qhNBW2IqXkOOkA==";
        };
        _lxcnv4xf = {
            "id" = "lxcnv4xf";
            "file" = "TalkBalloons-neoforge-1.6.1+1.21.11.jar";
            "hash" = "sha512-T7YQNz4qOiVbzqTLZC5tV1Rhq8fHSOHpcPrt1keh1pBvP++l+8pfF8UnJxRHg2awExiKXDQq+tOFktgds7H+Zg==";
        };
        _3oVNhLzM = {
            "id" = "3oVNhLzM";
            "file" = "TalkBalloons-neoforge-1.6.1+1.21.4.jar";
            "hash" = "sha512-yWgShCCnDBfRGWBL3ZwbntbJUhutzV6apxjG8k1I6ZcRxyjXoWHdrX5saUmXG6kawVEaE5J+BK9EQo7KGrx2Cg==";
        };
        _Yrez40F6 = {
            "id" = "Yrez40F6";
            "file" = "TalkBalloons-neoforge-1.6.1+1.21.5.jar";
            "hash" = "sha512-+EPqIE+yjv/H7O1AwYY43a1Z8bfKyl2mAirTSG+c30owk3Y192LzOUZPSbWnUevbYYmJw3tnukHZ1UsELsi0FA==";
        };
        _5kmcd4Hg = {
            "id" = "5kmcd4Hg";
            "file" = "TalkBalloons-neoforge-1.6.1+1.21.8.jar";
            "hash" = "sha512-6unPQp9yne+qiOP7HGCzQJ4eP3c7lJGN2KpWuAUrFfyOZ/m3p9VC3OXLqAn6bcoE0Rjgoj8jDbmcEpmAGNTbAQ==";
        };
        _6BN5cXaP = {
            "id" = "6BN5cXaP";
            "file" = "TalkBalloons-neoforge-1.6.1+26.1.2.jar";
            "hash" = "sha512-Dx98VjBa/EajwZDuC2m3B7h/3rrcUdjt9glRkVJrW9sCDQye/wmDVTapif0ZUENcNcbIRiLqnUrkrtP0gW+kDA==";
        };
        _8X8T4cAV = {
            "id" = "8X8T4cAV";
            "file" = "TalkBalloons-neoforge-1.6.1+26.2.jar";
            "hash" = "sha512-3idqGNcwTpGT/DE7Au1Ixec2fQ0KRQpgt4Ifdx/sV7zALii3yb0J+Lr06RtEi1DTkz0ycJNN3McBhb5KqAYx2A==";
        };
        _eXF0C9IM = {
            "id" = "eXF0C9IM";
            "file" = "TalkBalloons-fabric-1.6.3+1.20.1.jar";
            "hash" = "sha512-sHzWsZqeNbCtgItjVAo6C3WRsEN3b8Hk5Kk7wS0NO5iyMC8IeSA0jYE//UWwEvBvngBIytY0LAcOjUmNhEHuSg==";
        };
        _rhkIeXzc = {
            "id" = "rhkIeXzc";
            "file" = "TalkBalloons-fabric-1.6.3+1.20.4.jar";
            "hash" = "sha512-qQL9t6gLsFBVEKhFMQyB7uy7X5jgDYCNjjwP/sfens6V26huHvF0IzeijbpuaI1cNKmqhmdr0mYlPaxbWNQuUA==";
        };
        _Noz4fJpY = {
            "id" = "Noz4fJpY";
            "file" = "TalkBalloons-fabric-1.6.3+1.21.1.jar";
            "hash" = "sha512-t9RW8CkrOtRjBiVwsYYFFxhNY35spMXI76vR5tgWt8WrV7Wyxd8BuPUDTK60qNXaRDyAi2N/fNWTuh3Vva9XZw==";
        };
        _TPv9i7sB = {
            "id" = "TPv9i7sB";
            "file" = "TalkBalloons-fabric-1.6.3+1.21.10.jar";
            "hash" = "sha512-HWivX8tJlzPqqXxfacwnihET8XJx0O7WwwEjtxjFaMcimbkfe3Ko6fL+CXDr8QuAkLnahV8YnoV+8QCKEozc+g==";
        };
        _KPxtnJHj = {
            "id" = "KPxtnJHj";
            "file" = "TalkBalloons-fabric-1.6.3+1.21.11.jar";
            "hash" = "sha512-ddBERbnsuUBbC4lppWptH/FMunOMT0KKb5y2dvXLs/4rStqsO8rPjfXyRYp0qYnBiU6Ij/e/BGG/0tEPqIKBlg==";
        };
        _SjWnmDCq = {
            "id" = "SjWnmDCq";
            "file" = "TalkBalloons-fabric-1.6.3+1.21.4.jar";
            "hash" = "sha512-QR8H/Cr371bYR6UxC5AMd2L0FivrKXYSI8hZoLwY5myMjtWdDHr049qI8vCxbgN+B3OvrNsw9Cas/oOXWIJFOA==";
        };
        _GTVu6Ig4 = {
            "id" = "GTVu6Ig4";
            "file" = "TalkBalloons-fabric-1.6.3+1.21.5.jar";
            "hash" = "sha512-XUXq3232srSJqbg9jVRVgD0/oWVhMhJEw2MfP9H9oEZgVMf30RoAEljqKZGI8Cazo4vtAzKQpSNM+XPjw3Gd2w==";
        };
        _bK7PaylG = {
            "id" = "bK7PaylG";
            "file" = "TalkBalloons-fabric-1.6.3+1.21.8.jar";
            "hash" = "sha512-9D4wSSQdE4YLGBSUIJ+OKvoqH7F3dK6sT3zrv/JhwLDBdrJ3zFAp70WOPHWRO28JP48LYBPGYTE5+QebU905SQ==";
        };
        _2uAIg5U7 = {
            "id" = "2uAIg5U7";
            "file" = "TalkBalloons-fabric-1.6.3+26.1.2.jar";
            "hash" = "sha512-15lUWKhT79HtGeq3jkXUrD/9Cea42oii7yV37l3dUSRJS0TV8eN7tuE4rSE6anOhgVsVbNjlOJEe3eFco8Hu4g==";
        };
        _i5DDcxVg = {
            "id" = "i5DDcxVg";
            "file" = "TalkBalloons-fabric-1.6.3+26.2.jar";
            "hash" = "sha512-PUUKSb9kiIyYfqOA8rpCK/P7phX70gMZHit0LKOLnhAbOS/ORJQnnM/nF+u+A5tY5HAvLPS+qcD7IYtbLUkj9g==";
        };
        _6bx8ps0f = {
            "id" = "6bx8ps0f";
            "file" = "TalkBalloons-forge-1.6.3+1.20.1.jar";
            "hash" = "sha512-6xyR9qOMprQNzu8mT2mSi1eoH2mDNs5ODKwN8/Ut5gJQIfgWC+p8/R3LN6Jj+wqwIysd19HGBgJKO05UxBGiQA==";
        };
        _WQLm30BW = {
            "id" = "WQLm30BW";
            "file" = "TalkBalloons-neoforge-1.6.3+1.20.4.jar";
            "hash" = "sha512-eQVJ1vyBd0RzRapEN0Vrob6GwOj52dgfivvNBDHMV2hTDt10rZwRby7EsRRbWZgqy3F4pNyuhM3+eGGZtNa/uQ==";
        };
        _BNELFxes = {
            "id" = "BNELFxes";
            "file" = "TalkBalloons-neoforge-1.6.3+1.21.1.jar";
            "hash" = "sha512-7FHDta+5YmI4sOCFuAarkz2ENLPCM4H6LdvJHQXKLriNdXbvlqMCbSCbGhD2JgDcx837Aiked91VaGEx6J9zqA==";
        };
        _HKaDNWSw = {
            "id" = "HKaDNWSw";
            "file" = "TalkBalloons-neoforge-1.6.3+1.21.10.jar";
            "hash" = "sha512-RQwqFSzAoivysrtN9WOouVw86UEBwRxKm3sBEF2/Ew6UaEzjTWtuYK7TMH5P5kNtV//JRuQl8432ElxC5FgBLA==";
        };
        _FPPwHeyD = {
            "id" = "FPPwHeyD";
            "file" = "TalkBalloons-neoforge-1.6.3+1.21.4.jar";
            "hash" = "sha512-bXktWR5hYcIPw3WJzCn/EGEx/R5WWSvNwtpeBbLhL7TJB02NL5GNJU2hkTDmVxoSfVbTi1XK4W+XUhj9dc4bCg==";
        };
        _pV1GwdLR = {
            "id" = "pV1GwdLR";
            "file" = "TalkBalloons-neoforge-1.6.3+1.21.11.jar";
            "hash" = "sha512-YMTrSfOHPW8klMZKAvXMA1TJmKY2IE9pXhLLIrTf5CFvn7k6tZkpwRPOALt0/+dVFY4up9ucp6f2xTLR+OAoAQ==";
        };
        _FvWprY5e = {
            "id" = "FvWprY5e";
            "file" = "TalkBalloons-neoforge-1.6.3+1.21.5.jar";
            "hash" = "sha512-23MLZVjJepUMmiWhgZ8EGP87Yz26mgPrFdnu+r6XlH+VFxJPLa4QBaH3OFmfmIMIIyLYcGRCS1XZvwymskFHxQ==";
        };
        _2qru8qVU = {
            "id" = "2qru8qVU";
            "file" = "TalkBalloons-neoforge-1.6.3+1.21.8.jar";
            "hash" = "sha512-gWQ+mFVCHfapLRVRkhQu2yn0ftqWNusShEOm0qVRXdHVvH1BiK1J1Apdh9RqPrSuBE0U3m4K++z7cDgzZarQOQ==";
        };
        _pYzfYuLF = {
            "id" = "pYzfYuLF";
            "file" = "TalkBalloons-neoforge-1.6.3+26.1.2.jar";
            "hash" = "sha512-NEExXJRa+5FEdnoGbCKtPxwvc0KS+B+DnlMw5oErEEODRqowbzjrBQrRRXQUmozODcWntLwFKvP2/1CjM1xtmw==";
        };
        _QJAsj06y = {
            "id" = "QJAsj06y";
    ...
    in {
        ...
        "pkg-1.1.2" = _drdq3l7P;
        "pkg-1.1.3" = _1CL06WVv;
        "pkg-1.1.4-1.19.2-fabric" = _pJHdqyGR;
        "pkg-1.1.4-1.18.2-fabric" = _KQaEz2bu;
        "pkg-1.1.4-1.20.4-fabric" = _4hVP8d9g;
        "pkg-1.1.4-1.20.1-fabric" = _RfYgTJlR;
        "pkg-1.1.4-1.20.6-fabric" = _volizE3b;
        "pkg-1.1.4-1.21.1-fabric" = _hI6L6wxh;
        "pkg-1.1.4-1.21.3-fabric" = _BUuEvtqr;
        "pkg-1.1.4-1.18.2-forge" = _GFIHbZAX;
        "pkg-1.1.4-1.19.2-forge" = _Hu9jYMG6;
        "pkg-1.1.4-1.20.4-forge" = _jqo5nNmi;
        "pkg-1.1.4-1.20.6-forge" = _j61VHvZH;
        "pkg-1.1.4-1.21.1-forge" = _ghVMe34f;
        "pkg-1.1.4-1.21.3-forge" = _mtmRf7Q6;
        "pkg-1.1.4-1.20.1-forge" = _S9pHhajI;
        "pkg-1.1.4-1.20.4-neoforge" = _1ERxQNMi;
        "pkg-1.1.4-1.21.3-neoforge" = _AAbL11zu;
        "pkg-1.1.4-1.20.6-neoforge" = _Njk2jydf;
        "pkg-1.1.4-1.21.1-neoforge" = _jOQF17xS;
        "pkg-1.1.5-1.20.4-fabric" = _TLHbJ852;
        "pkg-1.1.5-1.21.1-fabric" = _uWRdva0L;
        "pkg-1.1.5-1.20.6-fabric" = _KCuaq9xN;
        "pkg-1.1.5-1.18.2-fabric" = _M4zkaUJ8;
        "pkg-1.1.5-1.20.1-fabric" = _rTYutCRa;
        "pkg-1.1.5-1.19.2-fabric" = _fOhXv6Bk;
        "pkg-1.1.5-1.21.3-fabric" = _Ez5NGTUT;
        "pkg-1.1.5-1.21.1-forge" = _4yOjRmPG;
        "pkg-1.1.5-1.20.4-forge" = _DBhy3uLQ;
        "pkg-1.1.5-1.20.6-forge" = _kXq2M0TZ;
        "pkg-1.1.5-1.18.2-forge" = _Z1GNy7Xi;
        "pkg-1.1.5-1.21.3-forge" = _gUQxWw6f;
        "pkg-1.1.5-1.20.1-forge" = _sa5yYn9Y;
        "pkg-1.1.5-1.21.1-neoforge" = _ejOWbGEW;
        "pkg-1.1.5-1.19.2-forge" = _ux3aA5Wl;
        "pkg-1.1.5-1.20.4-neoforge" = _zYgZ7hiJ;
        "pkg-1.1.5-1.20.6-neoforge" = _EpzjfqUT;
        "pkg-1.1.5-1.21.3-neoforge" = _r8pMSPGi;
        "pkg-1.1.6-1.21.3-fabric" = _etMDghYh;
        "pkg-1.1.6-1.20.4-fabric" = _wCnkJPCN;
        "pkg-1.1.6-1.21.3-forge" = _b9H1Juk0;
        "pkg-1.1.6-1.18.2-fabric" = _GEG2au0a;
        "pkg-1.1.6-1.20.6-forge" = _BrBAoFtL;
        "pkg-1.1.6-1.19.2-fabric" = _jVWR6k7U;
        "pkg-1.1.6-1.20.1-fabric" = _zZtBgFBK;
        "pkg-1.1.6-1.21.1-forge" = _BChIqnFy;
        "pkg-1.1.6-1.20.4-forge" = _YaRJGzjy;
        "pkg-1.1.6-1.18.2-forge" = _JzHs2oBV;
        "pkg-1.1.6-1.21.3-neoforge" = _yxAAdrpj;
        "pkg-1.1.6-1.20.6-fabric" = _Ewm4gTOG;
        "pkg-1.1.6-1.20.1-forge" = _ThduOiXW;
        "pkg-1.1.6-1.19.2-forge" = _gyK3eEwg;
        "pkg-1.1.6-1.21.1-fabric" = _CL7j3jHc;
        "pkg-1.1.6-1.20.4-neoforge" = _CZZi2QBC;
        "pkg-1.1.6-1.20.6-neoforge" = _q1OgEIjz;
        "pkg-1.1.6-1.21.1-neoforge" = _cFmWPLkw;
        "pkg-1.2.0+1.21.5-neoforge" = _AFWrI3cR;
        "pkg-1.2.0+1.21.5-forge" = _AeMVNIOo;
        "pkg-1.2.0+1.21.3-neoforge" = _6DXE3ic5;
        "pkg-1.2.0+1.21.1-neoforge" = _vMhaDsPO;
        "pkg-1.2.0+1.21.4-forge" = _jLXtDbgd;
        "pkg-1.2.0+1.20.6-forge" = _ZgZVrbgj;
        "pkg-1.2.0+1.21.3-forge" = _2Jax3NIY;
        "pkg-1.2.0+1.20.6-neoforge" = _U62ACGdh;
        "pkg-1.2.0+1.21.1-forge" = _bQ1s2KVz;
        "pkg-1.2.0+1.20.4-neoforge" = _6wl1D00N;
        "pkg-1.2.0+1.20.4-forge" = _mRxb2FFz;
        "pkg-1.2.0+1.21.4-neoforge" = _NHnXaERY;
        "pkg-1.2.0+1.20.1-forge" = _l3XMa4Kj;
        "pkg-1.2.0+1.18.2-forge" = _H34eUeNV;
        "pkg-1.2.0+1.19.2-forge" = _WZYANPwu;
        "pkg-1.2.0+1.21.5-fabric" = _LJR9zUNm;
        "pkg-1.2.0+1.21.4-fabric" = _VE329KXc;
        "pkg-1.2.0+1.20.6-fabric" = _A8ETpGAb;
        "pkg-1.2.0+1.21.3-fabric" = _MLJ51Md8;
        "pkg-1.2.0+1.20.1-fabric" = _8AQ2DACx;
        "pkg-1.2.0+1.20.4-fabric" = _WVuz6qxS;
        "pkg-1.2.0+1.21.1-fabric" = _u7Pif2dv;
        "pkg-1.2.0+1.19.2-fabric" = _Qp0sfvjZ;
        "pkg-1.2.0+1.18.2-fabric" = _4aQ3ytvF;
        "pkg-1.2.1+1.21.3-neoforge" = _Dn7tqXDO;
        "pkg-1.2.1+1.21.5-forge" = _qzbDN2dE;
        "pkg-1.2.1+1.21.5-neoforge" = _8RlvDSCA;
        "pkg-1.2.1+1.21.1-neoforge" = _QrDtteBN;
        "pkg-1.2.1+1.20.6-neoforge" = _zkLYt7of;
        "pkg-1.2.1+1.20.4-neoforge" = _tI1xT8NP;
        "pkg-1.2.1+1.21.4-forge" = _4FF1w9Qq;
        "pkg-1.2.1+1.21.4-neoforge" = _oOFr6Zbo;
        "pkg-1.2.1+1.21.3-forge" = _cP5bFaqi;
        "pkg-1.2.1+1.18.2-forge" = _FjcqOIHj;
        "pkg-1.2.1+1.21.5-fabric" = _L7ws0A0H;
        "pkg-1.2.1+1.20.4-forge" = _L0e56ufr;
        "pkg-1.2.1+1.20.1-forge" = _Z8j964qw;
        "pkg-1.2.1+1.21.1-forge" = _swHlLh0O;
        "pkg-1.2.1+1.19.2-forge" = _YIVULHBn;
        "pkg-1.2.1+1.20.6-forge" = _eE67mYeQ;
        "pkg-1.2.1+1.21.4-fabric" = _ucbDuWnk;
        "pkg-1.2.1+1.21.3-fabric" = _CVl10vA2;
        "pkg-1.2.1+1.19.2-fabric" = _scMdIXhJ;
        "pkg-1.2.1+1.20.4-fabric" = _l4g9DuuS;
        "pkg-1.2.1+1.20.6-fabric" = _w0fIyr7o;
        "pkg-1.2.1+1.21.1-fabric" = _zU7tZfxN;
        "pkg-1.2.1+1.20.1-fabric" = _8rnGhyAZ;
        "pkg-1.2.1+1.18.2-fabric" = _vT7lRaUo;
        "pkg-1.3.0+1.18.2-fabric" = _72vpDcws;
        "pkg-1.3.0+1.20.1-fabric" = _cOAMgUE3;
        "pkg-1.3.0+1.20.6-fabric" = _xOQ2lon2;
        "pkg-1.3.0+1.19.2-fabric" = _FHmkgzCs;
        "pkg-1.3.0+1.20.4-fabric" = _LIBCQjuL;
        "pkg-1.3.0+1.21.3-fabric" = _Etn5fHcZ;
        "pkg-1.3.0+1.21.1-fabric" = _5SyJAQMY;
        "pkg-1.3.0+1.21.4-fabric" = _h0eDSlhk;
        "pkg-1.3.0+1.21.5-fabric" = _SKEU2n6O;
        "pkg-1.3.0+1.21.6-fabric" = _csdnnzrb;
        "pkg-1.3.0+1.18.2-forge" = _IrSkCUOR;
        "pkg-1.3.0+1.19.2-forge" = _XtgpCPm6;
        "pkg-1.3.0+1.20.6-forge" = _rgeRdWgd;
        "pkg-1.3.0+1.20.1-forge" = _DMrtO7zL;
        "pkg-1.3.0+1.21.1-forge" = _GunzqyPG;
        "pkg-1.3.0+1.21.4-forge" = _KXlSJkOM;
        "pkg-1.3.0+1.21.3-forge" = _mdyYkbiW;
        "pkg-1.3.0+1.20.6-neoforge" = _Kdy8slPb;
        "pkg-1.3.0+1.21.5-forge" = _2of667sS;
        "pkg-1.3.0+1.20.4-neoforge" = _lMVH3Z96;
        "pkg-1.3.0+1.21.1-neoforge" = _AsQm27JB;
        "pkg-1.3.0+1.21.3-neoforge" = _wTscM9Tg;
        "pkg-1.3.0+1.21.5-neoforge" = _lgn0RjhI;
        "pkg-1.3.0+1.21.4-neoforge" = _wBxoGRkk;
        "pkg-1.3.0+1.21.6-forge" = _2oGNtQ7A;
        "pkg-1.3.0+1.21.6-neoforge" = _9ojYpYaR;
        "pkg-1.3.0+1.20.4-forge" = _o9v7K26x;
        "pkg-1.3.1+1.18.2-fabric" = _nvg10T76;
        "pkg-1.3.1+1.19.2-fabric" = _kZ6vBMM9;
        "pkg-1.3.1+1.20.4-fabric" = _qAgyJJEn;
        "pkg-1.3.1+1.21.4-fabric" = _dAjOu4oD;
        "pkg-1.3.1+1.20.1-fabric" = _2TC8kctg;
        "pkg-1.3.1+1.21.6-fabric" = _Kc6CyCna;
        "pkg-1.3.1+1.21.1-fabric" = _XbYwqnPt;
        "pkg-1.3.1+1.21.3-fabric" = _B8S3gLwi;
        "pkg-1.3.1+1.20.6-fabric" = _yVqliaqu;
        "pkg-1.3.1+1.21.5-fabric" = _EiJKWDpd;
        "pkg-1.3.1+1.18.2-forge" = _Z3ViQqWk;
        "pkg-1.3.1+1.19.2-forge" = _ddlkT1J7;
        "pkg-1.3.1+1.20.4-forge" = _sMy7k2KB;
        "pkg-1.3.1+1.20.1-forge" = _iUj7UbOg;
        "pkg-1.3.1+1.21.4-forge" = _AvIaZchk;
        "pkg-1.3.1+1.20.6-forge" = _ovbtXgGC;
        "pkg-1.3.1+1.21.1-forge" = _qCfVv4MJ;
        "pkg-1.3.1+1.21.5-forge" = _k1jQ2rr0;
        "pkg-1.3.1+1.21.3-forge" = _AHkOcpCS;
        "pkg-1.3.1+1.20.4-neoforge" = _ITw1tHXq;
        "pkg-1.3.1+1.21.6-forge" = _yBelWKsv;
        "pkg-1.3.1+1.21.1-neoforge" = _HtYmLlS2;
        "pkg-1.3.1+1.20.6-neoforge" = _wLGCDivS;
        "pkg-1.3.1+1.21.5-neoforge" = _ZytmB2fH;
        "pkg-1.3.1+1.21.6-neoforge" = _fk7REHsH;
        "pkg-1.3.1+1.21.3-neoforge" = _3xsbPNe6;
        "pkg-1.3.1+1.21.4-neoforge" = _rJ7XbfYi;
        "pkg-1.4.0+1.18.2-fabric" = _HtQfm9zG;
        "pkg-1.4.0+1.20.1-fabric" = _PhTu5upJ;
        "pkg-1.4.0+1.20.4-fabric" = _goCO1q3y;
        "pkg-1.4.0+1.21.10-fabric" = _PxgqkIL0;
        "pkg-1.4.0+1.19.2-fabric" = _M2mbffaN;
        "pkg-1.4.0+1.21.4-fabric" = _tDEWF7AK;
        "pkg-1.4.0+1.21.3-fabric" = _RJ5WmvM2;
        "pkg-1.4.0+1.21.5-fabric" = _tICjTeu8;
        "pkg-1.4.0+1.21.6-fabric" = _BPZEYIVD;
        "pkg-1.4.0+1.20.4-neoforge" = _jU2r0Iyn;
        "pkg-1.4.0+1.19.2-forge" = _wHYxN3ZR;
        "pkg-1.4.0+1.20.4-forge" = _2b2gqUAF;
        "pkg-1.4.0+1.20.1-forge" = _uT1AOQSK;
        "pkg-1.4.0+1.21.4-neoforge" = _7vzzfoqq;
        "pkg-1.4.0+1.21.1-neoforge" = _gFKm0Vh4;
        "pkg-1.4.0+1.21.1-fabric" = _1QFE9fvI;
        "pkg-1.4.0+1.21.3-neoforge" = _NxSj2wQw;
        "pkg-1.4.0+1.18.2-forge" = _5L2AgC6z;
        "pkg-1.4.0+1.21.5-neoforge" = _neM0ou3v;
        "pkg-1.4.0+1.21.6-neoforge" = _hL7H36WT;
        "pkg-1.4.0+1.21.10-neoforge" = _eSAfXAG8;
        "pkg-1.4.1+1.19.2-fabric" = _GlDyqq9S;
        "pkg-1.4.1+1.20.1-fabric" = _OP2jbn4h;
        "pkg-1.4.1+1.20.4-fabric" = _hZR7iIPx;
        "pkg-1.4.1+1.18.2-fabric" = _cyn0NKSg;
        "pkg-1.4.1+1.21.1-fabric" = _TEKKQkyY;
        "pkg-1.4.1+1.21.10-fabric" = _jgp1MEXj;
        "pkg-1.4.1+1.21.11-fabric" = _NKlAmwM1;
        "pkg-1.4.1+1.21.3-fabric" = _Z5YjL48N;
        "pkg-1.4.1+1.21.4-fabric" = _jkN75rzs;
        "pkg-1.4.1+1.21.5-fabric" = _I9cM71EB;
        "pkg-1.4.1+1.21.6-fabric" = _bmRiw8T2;
        "pkg-1.4.1+1.18.2-forge" = _8c4Ghc5y;
        "pkg-1.4.1+1.19.2-forge" = _AnkFhByL;
        "pkg-1.4.1+1.20.1-forge" = _xKm2suhD;
        "pkg-1.4.1+1.20.4-forge" = _GKiviJRI;
        "pkg-1.4.1+1.20.4-neoforge" = _83TYrWNr;
        "pkg-1.4.1+1.21.1-neoforge" = _WsqNPEpi;
        "pkg-1.4.1+1.21.10-neoforge" = _EiB3IzKT;
        "pkg-1.4.1+1.21.11-neoforge" = _S95B9coP;
        "pkg-1.4.1+1.21.3-neoforge" = _npk7uwJb;
        "pkg-1.4.1+1.21.4-neoforge" = _tSwxz1mE;
        "pkg-1.4.1+1.21.5-neoforge" = _Lwd6v14d;
        "pkg-1.4.1+1.21.6-neoforge" = _DjEBKqtk;
        "pkg-1.5.0+1.21.1-fabric" = _l0S6xlQb;
        "pkg-1.5.0+1.21.10-fabric" = _u6R7tqxD;
        "pkg-1.5.0+1.21.11-fabric" = _Do9ZBssK;
        "pkg-1.5.0+1.21.1-neoforge" = _J0FkU5nK;
        "pkg-1.5.0+1.21.8-fabric" = _Lnhc1oGJ;
        "pkg-1.5.0+1.21.5-fabric" = _GTyE4qHx;
        "pkg-1.5.0+26.1.2-fabric" = _Fi6RM2KS;
        "pkg-1.5.0+1.21.4-fabric" = _4oQhC7Ye;
        "pkg-1.5.0+1.21.11-neoforge" = _QLm9Dcu1;
        "pkg-1.5.0+1.21.10-neoforge" = _3CSYfo8X;
        "pkg-1.5.0+1.21.4-neoforge" = _KPybuQSg;
        "pkg-1.5.0+1.21.5-neoforge" = _5EYESD1D;
        "pkg-1.5.0+1.21.8-neoforge" = _UmGPTWSk;
        "pkg-1.5.0+26.1.2-neoforge" = _qleGrrqo;
        "pkg-1.5.1+1.21.1-fabric" = _wmD1Gt33;
        "pkg-1.5.1+1.21.1-neoforge" = _Y4oFD1Zo;
        "pkg-1.5.1+1.21.10-fabric" = _RxnV0zgS;
        "pkg-1.5.1+1.21.11-fabric" = _LRfQXOO6;
        "pkg-1.5.1+1.21.4-fabric" = _ymUN7MvM;
        "pkg-1.5.1+1.21.5-fabric" = _gCYpDDlv;
        "pkg-1.5.1+1.21.8-fabric" = _RLAgXP54;
        "pkg-1.5.1+1.21.10-neoforge" = _vrO56xtD;
        "pkg-1.5.1+1.21.11-neoforge" = _zpL1EAw7;
        "pkg-1.5.1+1.21.4-neoforge" = _B6tj9iSr;
        "pkg-1.5.1+1.21.5-neoforge" = _PwPosr1X;
        "pkg-1.5.1+1.21.8-neoforge" = _AqlUXQeu;
        "pkg-1.5.1+26.1.2-fabric" = _zBFFi3zF;
        "pkg-1.5.1+26.1.2-neoforge" = _zm0TdtMm;
        "pkg-1.5.2+1.21.11-fabric" = _20Af3h1S;
        "pkg-1.5.2+1.21.4-fabric" = _fJN6mhHe;
        "pkg-1.5.2+1.21.10-fabric" = _IyaOqw2Y;
        "pkg-1.5.2+26.1.2-fabric" = _rWUnvjvI;
        "pkg-1.5.2+1.21.1-fabric" = _sIlvpOdQ;
        "pkg-1.5.2+1.21.5-fabric" = _k1GYlBjP;
        "pkg-1.5.2+26.2-fabric" = _n08XoHOl;
        "pkg-1.5.2+1.21.8-fabric" = _k54KQjOA;
        "pkg-1.5.2+1.21.1-neoforge" = _keSLmIv0;
        "pkg-1.5.2+1.21.11-neoforge" = _TxRhZmv0;
        "pkg-1.5.2+1.21.10-neoforge" = _kB7jAXSf;
        "pkg-1.5.2+1.21.4-neoforge" = _WJ91qu3K;
        "pkg-1.5.2+1.21.5-neoforge" = _ShO3ThPG;
        "pkg-1.5.2+1.21.8-neoforge" = _kewjhKuP;
        "pkg-1.5.2+26.1.2-neoforge" = _ohF16fe1;
        "pkg-1.5.2+26.2-neoforge" = _zFV3XFGO;
        "pkg-1.5.3+1.21.1-fabric" = _7tVn0K5m;
        "pkg-1.5.3+1.21.10-fabric" = _Pd2XtF55;
        "pkg-1.5.3+1.21.4-fabric" = _oT2hlsEb;
        "pkg-1.5.3+1.21.8-fabric" = _8VzmkvwG;
        "pkg-1.5.3+1.21.11-fabric" = _Y7y3LYUb;
        "pkg-1.5.3+1.21.1-neoforge" = _LhlVKo9i;
        "pkg-1.5.3+26.1.2-fabric" = _QHMPJRNY;
        "pkg-1.5.3+1.21.5-fabric" = _mPKy082J;
        "pkg-1.5.3+1.21.11-neoforge" = _UxuPd26G;
        "pkg-1.5.3+1.21.10-neoforge" = _QJRVD1bO;
        "pkg-1.5.3+26.2-fabric" = _u0By8p6V;
        "pkg-1.5.3+26.1.2-neoforge" = _yZQmdzjN;
        "pkg-1.5.3+1.21.4-neoforge" = _shCQ2AzE;
        "pkg-1.5.3+1.21.5-neoforge" = _7bbXESjE;
        "pkg-1.5.3+26.2-neoforge" = _SLuo6Tuu;
        "pkg-1.5.3+1.21.8-neoforge" = _oEXhccCm;
        "pkg-1.5.4+1.21.1-fabric" = _tdqFGEIY;
        "pkg-1.5.4+1.21.10-fabric" = _YCslFX46;
        "pkg-1.5.4+1.21.11-fabric" = _cu3Efdpr;
        "pkg-1.5.4+1.21.4-fabric" = _Deg5GXoh;
        "pkg-1.5.4+1.21.5-fabric" = _VwQLAL18;
        "pkg-1.5.4+1.21.8-fabric" = _D927GORH;
        "pkg-1.5.4+1.21.1-neoforge" = _SIZaJpOq;
        "pkg-1.5.4+1.21.10-neoforge" = _3L9wmvn3;
        "pkg-1.5.4+1.21.11-neoforge" = _cX8JTSvg;
        "pkg-1.5.4+1.21.4-neoforge" = _QOBMaiCT;
        "pkg-1.5.4+26.2-fabric" = _WJYY9mVK;
        "pkg-1.5.4+1.21.5-neoforge" = _CzI9uLIJ;
        "pkg-1.5.4+1.21.8-neoforge" = _o8Ophf1m;
        "pkg-1.5.4+26.1.2-neoforge" = _84ar66b3;
        "pkg-1.5.4+26.2-neoforge" = _EKqzIJGF;
        "pkg-1.5.4+26.1.2-fabric" = _fGn98Okm;
        "pkg-1.6.0+1.20.1-fabric" = _2DwbJnuR;
        "pkg-1.6.0+1.20.4-fabric" = _qDHBpOkW;
        "pkg-1.6.0+1.21.1-fabric" = _s2RtnSF7;
        "pkg-1.6.0+1.21.10-fabric" = _rSid4Cia;
        "pkg-1.6.0+1.21.11-fabric" = _pMebgi2V;
        "pkg-1.6.0+1.21.4-fabric" = _X1QpZuUs;
        "pkg-1.6.0+1.21.5-fabric" = _Dlh3U94l;
        "pkg-1.6.0+1.21.8-fabric" = _iQA5a6rR;
        "pkg-1.6.0+26.1.2-fabric" = _y3QSHjbC;
        "pkg-1.6.0+26.2-fabric" = _BkvY1U8A;
        "pkg-1.6.0+1.20.1-forge" = _5uXQP8Yu;
        "pkg-1.6.0+1.20.4-neoforge" = _efTN1TJm;
        "pkg-1.6.0+1.21.1-neoforge" = _QWNw7QIy;
        "pkg-1.6.0+1.21.10-neoforge" = _Qmqeoqmi;
        "pkg-1.6.0+1.21.11-neoforge" = _AkxFcEUi;
        "pkg-1.6.0+1.21.4-neoforge" = _pzXM4LxK;
        "pkg-1.6.0+1.21.5-neoforge" = _6RdKlcw2;
        "pkg-1.6.0+1.21.8-neoforge" = _hYgUmwC5;
        "pkg-1.6.0+26.1.2-neoforge" = _nVaureYQ;
        "pkg-1.6.0+26.2-neoforge" = _DiFLefO2;
        "pkg-1.6.1+1.20.1-fabric" = _aJYSEBED;
        "pkg-1.6.1+1.20.4-fabric" = _1ZlGhESH;
        "pkg-1.6.1+1.21.1-fabric" = _28WfSsjd;
        "pkg-1.6.1+1.21.10-fabric" = _rlRz8MTU;
        "pkg-1.6.1+1.21.11-fabric" = _OTkhoU8H;
        "pkg-1.6.1+1.21.4-fabric" = _eGK6vc1Q;
        "pkg-1.6.1+1.21.5-fabric" = _9sCSHLzD;
        "pkg-1.6.1+1.21.8-fabric" = _GdClu0VR;
        "pkg-1.6.1+26.1.2-fabric" = _Fh6l8AMu;
        "pkg-1.6.1+26.2-fabric" = _gyjyNSIX;
        "pkg-1.6.1+1.20.1-forge" = _peqqZwFX;
        "pkg-1.6.1+1.20.4-neoforge" = _Hyj65ST8;
        "pkg-1.6.1+1.21.1-neoforge" = _gRaEjGOh;
        "pkg-1.6.1+1.21.10-neoforge" = _PxOuL6Xl;
        "pkg-1.6.1+1.21.11-neoforge" = _lxcnv4xf;
        "pkg-1.6.1+1.21.4-neoforge" = _3oVNhLzM;
        "pkg-1.6.1+1.21.5-neoforge" = _Yrez40F6;
