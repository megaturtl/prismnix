...
let
    versions = (let
        ...
        _eVb15P28 = {
            "id" = "eVb15P28";
            "file" = "arc-19.1.2-dev.jar";
            "hash" = "sha512-KfV/CE16OJt7WDDSbkSnmxSdH+5u8C5Y5kFljs5Aj5aT5BYJnQkoADF+fe6SH+rQfppASsvlB1M0eK9RB+UN2Q==";
        };
        _dwmesVK7 = {
            "id" = "dwmesVK7";
            "file" = "arc-19.1.2-dev.jar";
            "hash" = "sha512-81Su0f0BW7entKTUVisGnds/WJGB1aBGCfZ/RdtTnDawJTHiSfT80SaKhmbP7BSM3b6dClc9bv4NofG/yrHihQ==";
        };
        _LicbuOid = {
            "id" = "LicbuOid";
            "file" = "arc-19.1.3-neoforge.jar";
            "hash" = "sha512-4cSZoWypwO06C9Qp28AXq3T8X4TRFYwj9FrslY5oj73sd3aWs7o5AIPk2h+hI69/8CIBLOQ/QW1Jya5q8HOM6Q==";
        };
        _WOj4A7Ly = {
            "id" = "WOj4A7Ly";
            "file" = "arc-19.1.3-fabric.jar";
            "hash" = "sha512-Fx0wMpPuwyMccENwjewe12EaLlMwkqIs18yyR5PP9TgHW5vx2c5cyBE9ATFuTL7/w1R5S61pMkyGADuVELzeAA==";
        };
    in {
        "1CcWeACN" = _1CcWeACN;
        "D19wmC2N" = _D19wmC2N;
        ...
        "pkg-1.5.3" = _TjI03GUV;
        "pkg-1.5.4" = _4OyBCv0j;
        "pkg-1.6-alpha" = _jvFLF15x;
        "pkg-1.6-alpha.1" = _ECRSiTY7;
        "pkg-1.6-alpha.2" = _qps0eVc9;
        "pkg-1.6" = _kyOiGL5v;
        "pkg-1.6.1" = _i4JXZ2b6;
        "pkg-1.6.2" = _g1AN9tWJ;
        "pkg-1.6.3-1.21" = _sfZ9KIrE;
        "pkg-1.6.4-1.21" = _d56M4H1g;
        "pkg-1.6.5-1.21" = _uUuIwFEE;
        "pkg-1.6.6-1.21" = _L0sai6bq;
        "pkg-1.6.6.1-1.21" = _cfiHbWxx;
        "pkg-1.7-1.21" = _TEqIQTEL;
        "pkg-1.7-1.20.1" = _4BqPl1Ho;
        "pkg-1.7.1-1.21" = _MBvIxnNR;
        "pkg-1.7.2-1.21" = _3MetzHVJ;
        "pkg-1.8-1.21.1" = _wPwr6L1C;
        "pkg-1.7.1-1.20.1" = _fKulU3Ps;
        "pkg-1.8.1-1.21.1" = _zymFQspr;
        "pkg-1.8.2-1.21.1" = _XzAFKmsd;
        "pkg-1.8.3-1.21.1" = _exdui8m6;
        "pkg-1.9-1.21.1" = _Ubz5XW6x;
        "pkg-1.9.1-1.21.1" = _Q6dlaO2x;
        "pkg-1.9.1-1.21.5" = _aVAGrVQg;
        "pkg-1.9.2-1.21.5" = _jzqpHjdk;
        "pkg-1.9.3-1.21.5" = _udvgw0sQ;
        "pkg-1.9.3-1.21.1" = _NvbnBoaU;
        "pkg-1.7.2-1.20.1" = _oLANnkRd;
        "pkg-1.9.4-1.21.1" = _CedjDAsq;
        "pkg-1.9.4-1.21.5" = _axSSVj4u;
        "pkg-1.9.4-1.21.6" = _BUKoG7q0;
        "pkg-1.9.5-1.21.5" = _ZdRYPOI9;
        "pkg-1.9.5-1.21.6" = _ZsIJF8gG;
        "pkg-1.9.6-1.21.5" = _tymLok7X;
        "pkg-1.9.6-1.21.6" = _NRpLZcPP;
        "pkg-1.9.6-1.21.9" = _Y1ErvLXe;
        "pkg-1.9.7-1.21.9" = _K3v4eZS6;
        "pkg-1.9.7-1.21.6" = _kMCPKBny;
        "pkg-1.9.5-1.21.1" = _GkoQyiOE;
        "pkg-19.0.0" = _gqw9FNbN;
        "pkg-19.0.1" = _d0qz5qYu;
        "pkg-19.0.2" = _8Z5aktJX;
        "pkg-19.0.3" = _DqBIVzXc;
        "pkg-19.0.4" = _nR4iHG1O;
        "pkg-19.1.0" = _aKxW9S3O;
        "pkg-19.1.1" = _e9S4onNT;
        "pkg-20.1.0" = _M2dHmu3Y;
        "pkg-20.1.1" = _A0zBldvA;
        "pkg-20.2.0" = _9XynZXHp;
        "pkg-20.2.1" = _3LSCrc0x;
        "pkg-20.2.2" = _XnMtwqEU;
        "pkg-9.0.0" = _gTreBhs6;
        "pkg-20.2.3" = _7Xn8riGs;
        "pkg-21.2.0" = _U7tVPAUO;
        "pkg-20.2.4" = _iQVIXHkG;
        "pkg-21.2.1" = _C0r41gjC;
        "pkg-20.2.5" = _D3J5MqCX;
        "pkg-21.2.2" = _MNVPmyft;
        "pkg-21.2.3" = _fT1L8UGk;
        "pkg-20.2.6" = _zEAnx87r;
        "pkg-20.2.7" = _HednfHZX;
        "pkg-21.2.4" = _KDIUF8Hf;
        "pkg-21.2.5" = _pRAcxAC5;
        "pkg-20.2.8" = _Fm96CQrP;
        "pkg-20.2.9" = _XLy4AgXW;
        "pkg-21.2.6" = _jMdsSR7U;
        "pkg-20.2.10" = _Zg1uHcQt;
        "pkg-21.2.7" = _B8yqYJvD;
        "pkg-19.1.2" = _dwmesVK7;
        "pkg-19.1.3" = _WOj4A7Ly;
        "default" = _WOj4A7Ly;
    });
