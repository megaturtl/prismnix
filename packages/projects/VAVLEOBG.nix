...
let
    ...
    in {
        ...
        "pkg-1.10" = _OBDoCWQe;
        "pkg-1.10+mod" = _32sZpQ1W;
        "pkg-2.0" = _aED5BEB8;
        "pkg-2.0+mod" = _vtzhrBOp;
        "pkg-2.0.1" = _fI5CvJZq;
        "pkg-2.0.1+mod" = _ppuwO5QS;
        "pkg-2.1" = _znqXlHf1;
        "pkg-2.1+mod" = _HZEor0Ie;
        "pkg-2.1b" = _IjBqId5Z;
        "pkg-2.1b+mod" = _3xFoRYuj;
        "pkg-2.1c" = _LrZIkHbn;
        "pkg-2.1c+mod" = _smMbDJlb;
        "pkg-2.2" = _JZgJ3ZSw;
        "pkg-2.2+mod" = _YE3xewbF;
        "pkg-2.2.2" = _IMMoEREe;
        "pkg-2.2.2+mod" = _5WxEMsSZ;
        "pkg-2.2.2a" = _UqSSseh2;
        "pkg-2.2.2a+mod" = _WT2CmDV8;
        "pkg-2.2.3" = _NKcbSRdI;
        "pkg-2.2.3+mod" = _Ra8oFqOj;
        "pkg-2.3" = _ihCa5pjc;
        "pkg-2.3+mod" = _1v4TPGTC;
        "pkg-2.3a" = _NsbJWpvj;
        "pkg-2.3a+mod" = _RQPH23iY;
        "pkg-2.3.1" = _EWEdKj7I;
        "pkg-2.3.1+mod" = _9YQfA3Ml;
        "pkg-2.4" = _57KsGYXA;
