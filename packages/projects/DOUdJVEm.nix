...
let
    versions = (let
        ...
        _EJRLNb9y = {
            "id" = "EJRLNb9y";
            "file" = "controlify-3.3.2+mc26.2-universal.jar";
            "hash" = "sha512-06f2J2fUuGmCYqqkICQWbq306DEhtAFUWX4eXov2X6EHjD/7HB8ts/KfYVZ5s968H8tAXgnWoOIkf2SObtq0Ow==";
        };
        _GkBFPJHt = {
            "id" = "GkBFPJHt";
            "file" = "controlify-3.3.2+mc26.1-universal.jar";
            "hash" = "sha512-i3ZZ+XMCsOAvTBTtVzQjhH64zemVPVKeO2sHDdoYAa3Ho3WyDvJon+EJTa43oIm6GxXqo6udDDcr+vbLS6ptfw==";
        };
        _47V2TVlb = {
            "id" = "47V2TVlb";
            "file" = "controlify-3.3.3+mc26.2-universal.jar";
            "hash" = "sha512-qftb7wGbjX2LS78++65GVqSeImck+RAIgFfpA16B8cCr8ZsJ0EJIpE9Mz6cy1ej6jeSjxIkz3fdcMGW8b2tVFg==";
        };
        _eFJbepU0 = {
            "id" = "eFJbepU0";
            "file" = "controlify-3.3.3+mc26.1-universal.jar";
            "hash" = "sha512-wyDHlQIgclxOYf9pAak5IS3+U1GI4+cfw0ppCoVSRCvXjCxZXx65mS/rcMXl5xR60WD28Ar3OAIa+evJNjqBWQ==";
        };
        _cifFe8OL = {
            "id" = "cifFe8OL";
            "file" = "controlify-3.4.0+mc26.1-universal.jar";
            "hash" = "sha512-Aa7xfM548FHUW0udbHs6/PN5rqR56Y1Zo0lu6FlWFODpOiVc6bjfsF+Ebci8GW3bnq2cQI3i+sIIj9rymL6ARw==";
        };
        _3g0PvHTp = {
            "id" = "3g0PvHTp";
            "file" = "controlify-3.4.0+mc26.2-universal.jar";
            "hash" = "sha512-W0jZUSUEN4eKZH+zwT3h8YaG2SMMZ7ZvlvYGFlOtAORsrAuQM4it8aRngTrPFEhkDFUFBk6cJO7WqiXOQkEJIA==";
        };
        _17LMiF9q = {
            "id" = "17LMiF9q";
            "file" = "controlify-3.4.1+mc26.1-universal.jar";
            "hash" = "sha512-/4nJCIxVEfhtLSJ44RacN+WPvjmnc17hg7xppEkj84+JpVjIndgG9JC5QYk38xIEFilSWYlU2zVnWXjHzcHNLQ==";
        };
        _E2Rvo2Q0 = {
            "id" = "E2Rvo2Q0";
            "file" = "controlify-3.4.1+mc26.2-universal.jar";
            "hash" = "sha512-YYKtN00y98DCndt3b2PCNxrgPxmRZCszEyHmaOdaq+Na6ZT5tKz6K4EklC6t1Iq688J4fIhsXYl5P78ll9j5kw==";
        };
        _9ePC9FQ4 = {
            "id" = "9ePC9FQ4";
            "file" = "controlify-3.5.0+mc26.2-universal.jar";
    ...
    in {
        ...
        "pkg-1.0.0+1.19.4" = _ViaGpYcG;
        "pkg-1.1.0-beta.1+1.19.4" = _mvoRZ4lr;
        "pkg-1.1.0-beta.2+1.19.4" = _TSgUsWWO;
        "pkg-1.1.0-beta.3+1.19.4" = _ZshsEOjG;
        "pkg-1.1.0-beta.4+1.19.4" = _OVsSpUi5;
        "pkg-1.1.0+1.19.4" = _4eYmOLUb;
        "pkg-1.1.1+1.19.4" = _jvUMhWpD;
        "pkg-1.2.0+1.19.4" = _3L7GCFAd;
        "pkg-1.3.0-beta.1+1.20" = _v9yBe6Ye;
        "pkg-1.2.1+1.19.4" = _hA4E3OIW;
        "pkg-1.3.0-beta.2+1.20" = _pKaQjz0y;
        "pkg-1.3.0+1.20" = _60bCNc7N;
        "pkg-1.3.1+1.20" = _FLIWpoEL;
        "pkg-1.3.2+1.20" = _qHzBhRrd;
        "pkg-1.4.0+1.20" = _h5ZThJ8W;
        "pkg-1.4.1+1.20" = _FXJNOVCT;
        "pkg-1.4.2+1.20" = _GJuiYIvz;
        "pkg-1.4.3+1.20" = _uPbwSdJT;
        "pkg-1.4.4+1.20" = _aT4dMJAD;
        "pkg-1.4.5+1.20" = _xncNJgTg;
        "pkg-1.4.6+1.20" = _y7xMOOMU;
        "pkg-1.5.0+1.20" = _Oquy1mdB;
        "pkg-1.5.1+1.20" = _L2JeMo5i;
        "pkg-1.6.0+1.20" = _MSWp1Dsg;
        "pkg-1.7.0-beta.1+1.20" = _CzlyUU6C;
        "pkg-1.7.0-beta.2+1.20" = _QPb34aQS;
        "pkg-1.7.0-beta.3+1.20.2" = _5MMK5oJQ;
        "pkg-1.7.0+1.20.2" = _E0IjfW25;
        "pkg-1.7.0+1.20.3" = _1sbnpZZs;
        "pkg-1.7.0+1.20.4" = _ATnQknqh;
        "pkg-1.8.0+1.20.4" = _2oEDJIbx;
        "pkg-1.8.1+1.20.4" = _6GKVGWLK;
        "pkg-2.0.0-beta.1+1.20.4" = _10SuJx9U;
        "pkg-2.0.0-beta.2+1.20.4" = _MZzohk5u;
        "pkg-2.0.0-beta.2+1.20.1" = _JbIeEVC9;
        "pkg-2.0.0-beta.2+24w14potato" = _Cs3ZJcvV;
        "pkg-2.0.0-beta.3+1.20.5-pre1" = _klbkkBCv;
        "pkg-2.0.0-beta.3+1.20.4" = _im0SBR8Y;
        "pkg-2.0.0-beta.3+1.20.1" = _Buc2lLKA;
        "pkg-2.0.0-beta.4+1.20.5-rc2" = _zYDV0AOF;
        "pkg-2.0.0-beta.4+1.20.4" = _C8BV2Qy4;
        "pkg-2.0.0-beta.4+1.20.1" = _Zd1jZT0f;
        "pkg-2.0.0-beta.5+1.20.5-rc2" = _MGnpqXdx;
        "pkg-2.0.0-beta.5+1.20.4" = _FeADDFg7;
        "pkg-2.0.0-beta.5+1.20.1" = _QpBHNrxY;
        "pkg-2.0.0-beta.6+1.20.5" = _fyZT7z6k;
        "pkg-2.0.0-beta.7+1.20.6" = _RJ59Pb7W;
        "pkg-2.0.0-beta.7+1.20.4" = _Zkei91rh;
        "pkg-2.0.0-beta.7+1.20.1" = _UrYvrQox;
        "pkg-2.0.0-beta.8+1.20.6" = _ba3azLbW;
        "pkg-2.0.0-beta.8+1.20.4" = _Q5nQC6JX;
        "pkg-2.0.0-beta.8+1.20.1" = _naETXOxy;
        "pkg-2.0.0-beta.9+1.20.6" = _cif1Amua;
        "pkg-2.0.0-beta.9+1.20.4" = _mpnMZdQU;
        "pkg-2.0.0-beta.9+1.20.1" = _FvddUeFM;
        "pkg-2.0.0-beta.10+1.20.6" = _cgUUVpN5;
        "pkg-2.0.0-beta.10+1.20.4" = _zPpBE48u;
        "pkg-2.0.0-beta.10+1.20.1" = _BtV20YRT;
        "pkg-2.0.0-beta.11+1.21-fabric" = _wd5HGBHn;
        "pkg-2.0.0-beta.11+1.20.6-neoforge" = _33FaWQ20;
        "pkg-2.0.0-beta.11+1.20.6-fabric" = _UMr5nxvw;
        "pkg-2.0.0-beta.11+1.20.4-neoforge" = _evZtJsLa;
        "pkg-2.0.0-beta.11+1.20.4-fabric" = _M4PuEYrI;
        "pkg-2.0.0-beta.11+1.20.1-fabric" = _DyraDYD7;
        "pkg-2.0.0-beta.12+1.21-neoforge" = _kyNyEwKO;
        "pkg-2.0.0-beta.12+1.21-fabric" = _WtY06yYw;
        "pkg-2.0.0-beta.12+1.20.6-neoforge" = _L888cMPM;
        "pkg-2.0.0-beta.12+1.20.6-fabric" = _3PavpR7i;
        "pkg-2.0.0-beta.12+1.20.4-neoforge" = _xD4hE8Hq;
        "pkg-2.0.0-beta.12+1.20.4-fabric" = _xDTfzNlO;
        "pkg-2.0.0-beta.12+1.20.1-fabric" = _MTftatnR;
        "pkg-2.0.0-beta.13+1.21-neoforge" = _ug0reHNd;
        "pkg-2.0.0-beta.13+1.21-fabric" = _zCjLVzXH;
        "pkg-2.0.0-beta.13+1.20.6-neoforge" = _FeV5JYaC;
        "pkg-2.0.0-beta.13+1.20.6-fabric" = _65Aob1cE;
        "pkg-2.0.0-beta.13+1.20.4-neoforge" = _GViwqlmh;
        "pkg-2.0.0-beta.13+1.20.4-fabric" = _KZm7UQoN;
        "pkg-2.0.0-beta.13+1.20.1-fabric" = _Wqjm6V7W;
        "pkg-2.0.0-beta.14+1.21-neoforge" = _aRfesuRq;
        "pkg-2.0.0-beta.14+1.21-fabric" = _QiCZiPOr;
        "pkg-2.0.0-beta.14+1.20.6-neoforge" = _LmzHtEVI;
        "pkg-2.0.0-beta.14+1.20.6-fabric" = _DMuQp5iM;
        "pkg-2.0.0-beta.14+1.20.4-neoforge" = _271cgj2r;
        "pkg-2.0.0-beta.14+1.20.4-fabric" = _bJ7TVbR3;
        "pkg-2.0.0-beta.14+1.20.1-fabric" = _HM1y7RZl;
        "pkg-2.0.0-beta.15" = _A6POlDj0;
        "pkg-2.0.0-beta.16" = _A4HplXhO;
        "pkg-2.0.0-beta.17" = _NeFyhVE4;
        "pkg-2.0.0-beta.18" = _azqKnugz;
        "pkg-2.0.0-beta.19" = _41iKszA0;
        "pkg-2.0.0-beta.20" = _M6Nfllur;
        "pkg-2.0.0-beta.21" = _Co3GkxJc;
        "pkg-2.0.0+1.21.4-fabric" = _oi6gSb9M;
        "pkg-2.0.0+1.20.1-fabric" = _kDvXEb9t;
        "pkg-2.0.0+1.20.4-fabric" = _5Dz4JJsW;
        "pkg-2.0.0+1.20.6-fabric" = _rgP4jJj0;
        "pkg-2.0.0+1.21-fabric" = _rU8d5kXf;
        "pkg-2.0.0+1.21.3-fabric" = _F88oMi03;
        "pkg-2.0.1+1.20.1-fabric" = _ffapfL1r;
        "pkg-2.0.1+1.20.4-fabric" = _121aTBiY;
        "pkg-2.0.1+1.20.4-neoforge" = _GF9p4iLK;
        "pkg-2.0.1+1.20.6-fabric" = _dPQxMwOg;
        "pkg-2.0.1+1.20.6-neoforge" = _NKBFuJ1x;
        "pkg-2.0.1+1.21-fabric" = _KAbBgF9i;
        "pkg-2.0.1+1.21-neoforge" = _EDbEKFiE;
        "pkg-2.0.1+1.21.3-fabric" = _ctXP8Qui;
        "pkg-2.0.1+1.21.3-neoforge" = _RgrJsY1m;
        "pkg-2.0.1+1.21.4-fabric" = _ppgqL33I;
        "pkg-2.0.1+1.21.4-neoforge" = _QjmeJuhS;
        "pkg-2.0.2+1.20.1-fabric" = _xGiVq9Sz;
        "pkg-2.0.2+1.20.4-fabric" = _XhGJ5H43;
        "pkg-2.0.2+1.20.6-fabric" = _GVLDbUGm;
        "pkg-2.0.2+1.21-fabric" = _q36RRQc8;
        "pkg-2.0.2+1.21.3-fabric" = _awLlzxOy;
        "pkg-2.0.2+1.21.4-fabric" = _Naxc8isg;
        "pkg-2.0.3" = _RzoGQZXe;
        "pkg-2.0.4" = _sDAshEPv;
        "pkg-2.1.0" = _GbaFqtyC;
        "pkg-2.1.1" = _AGiKClO7;
        ...
        "pkg-2.5.1" = _UTogoJcz;
        "pkg-2.5.2" = _cjmiXPNV;
        "pkg-3.0.0-beta.1" = _xOVWNlF4;
        "pkg-3.0.0-beta.2" = _1kOhG3tE;
        "pkg-3.0.0-beta.3" = _RWtB0dqp;
        "pkg-3.0.0" = _J2qX8478;
        "pkg-3.0.1" = _g2vgDVPC;
        "pkg-3.0.0+lts" = _URyhn6Zf;
        "pkg-3.0.2" = _l9CCuzb8;
        "pkg-3.1.0" = _BRiFrwAv;
        "pkg-3.0.1+lts" = _W6tNOO4I;
        "pkg-3.1.0+mc26.2" = _u8ZrA3qC;
        "pkg-3.1.0+mc26.1" = _ek2zPLP3;
        "pkg-3.1.1+mc26.1" = _tgZ98XWq;
        "pkg-3.1.1+mc26.2" = _3Z0RNraJ;
        "pkg-3.1.2+mc26.1" = _tmgBJEwx;
        "pkg-3.1.2+mc26.2" = _ww7bBOmX;
        "pkg-3.2.0+mc26.1" = _DDoh80eL;
        "pkg-3.2.0+mc26.2" = _OF7sqGiR;
        "pkg-3.2.1+mc26.1" = _DopleDGn;
        "pkg-3.2.1+mc26.2" = _CehmpRM7;
        "pkg-3.3.0+mc26.2" = _MJ0IIPqj;
        "pkg-3.3.0+mc26.1" = _izntjrVg;
        "pkg-3.3.1+mc26.2" = _23KsUIll;
        "pkg-3.3.1+mc26.1" = _F5rEcp6O;
        "pkg-3.3.2+mc26.2" = _EJRLNb9y;
        "pkg-3.3.2+mc26.1" = _GkBFPJHt;
        "pkg-3.3.3+mc26.2" = _47V2TVlb;
        "pkg-3.3.3+mc26.1" = _eFJbepU0;
        "pkg-3.4.0+mc26.1" = _cifFe8OL;
        "pkg-3.4.0+mc26.2" = _3g0PvHTp;
        "pkg-3.4.1+mc26.1" = _17LMiF9q;
