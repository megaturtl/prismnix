...
let
    versions = (let
        ...
        _gitzCxyH = {
            "id" = "gitzCxyH";
            "file" = "geckolib-fabric-26.2-5.5.4.jar";
            "hash" = "sha512-v6HDpGLYdTc2vVLTHd911hIYItZl3YfZnadLnjDLO/MUeMxWZjRYDuoJNbgUKTvx2QEQ/HCQdCGTQFz/leZfow==";
        };
        _H570FdIH = {
            "id" = "H570FdIH";
            "file" = "geckolib-forge-26.2-5.5.4.jar";
            "hash" = "sha512-hgLTsjAhiOHmy7J/2T/a0wD3rZvZEsaCY6aNJ4thRQFdipfaYHR3OUH6kHmJBCmqtKBwV3e2M05/eg1CI8wwpg==";
        };
        _JJwT4ZBq = {
            "id" = "JJwT4ZBq";
            "file" = "geckolib-neoforge-26.2-5.5.4.jar";
            "hash" = "sha512-SrlSN+Oo9KQgQrjp96bXIhOla0aZIhyLaa8U5D36sFzJzjHTwgCgY8dGBdOhyARid3zUQSmBMkaYINK2Qtfo3g==";
        };
        _7gaQHok7 = {
            "id" = "7gaQHok7";
            "file" = "geckolib-fabric-26.2-5.5.5.jar";
            "hash" = "sha512-CY8ou+VRVR+Z6FWEs2w35GbfxGCEc37TZE/IWI2uZ2ZT9cWxY5PMz/LLkMXzd5Jg4K7FoOjFgT3zRWFmwLzp7A==";
        };
        _qF3gZcbz = {
            "id" = "qF3gZcbz";
            "file" = "geckolib-forge-26.2-5.5.5.jar";
            "hash" = "sha512-mkVql2jICF0tBcbOpPKHCNg7vVSz6Wgwza+fu0YdjaQDdfYGIUz1bj7ods96nAT6nwPH5BLoP+iBn7zzDpPkVg==";
        };
        _fTK5ltWI = {
            "id" = "fTK5ltWI";
            "file" = "geckolib-neoforge-26.2-5.5.5.jar";
            "hash" = "sha512-gzOSpOiiXRfoU+NOgOWyQcgjOyf7LHZITTXlrAUhaFLPUqpLWLJaWOWviwv5dvR58qirtCO58M/g4zF0ShXmyQ==";
        };
        _Xwim7a3L = {
            "id" = "Xwim7a3L";
            "file" = "geckolib-forge-26.2-5.5.6.jar";
            "hash" = "sha512-BTjlVA3N2EvXXcpxH3NvMIRh01yymWdtDEgRH8xv3sVqxv2VACvFDountJPzhX5759Yq4IXTmqOHxbA/+JlJgg==";
        };
        _IEGPh4CJ = {
            "id" = "IEGPh4CJ";
            "file" = "geckolib-neoforge-26.2-5.5.6.jar";
            "hash" = "sha512-BxfTYOC7om3t1360JFCjJ+rm85MWksNT6+OsYiyFVrRC8+ziLl6vaZrJcCpu3W4C0c+6ltPxpSq6mMzgvQuuVQ==";
        };
        _1VWnZPbQ = {
            "id" = "1VWnZPbQ";
            "file" = "geckolib-fabric-26.3-5.5.6.jar";
            "hash" = "sha512-2NglqtjbOjealPd6rCxNAl/Pzxb3IepubIG8KCuUH/LqQkF2wNCyNwd5emA5/RXCpHhP049EsREKwZMxK5joXg==";
        };
        _uGEFXLKA = {
            "id" = "uGEFXLKA";
            "file" = "geckolib-neoforge-26.3-5.5.6.jar";
            "hash" = "sha512-PNwsXMKWNEwRlnfcXnE2S6R4aE5CXnBHQt2xcaHEMNlmwj/EfIHtj0LtQ02XmuIqE0DLNKvOTMQvDMfuZgWm8Q==";
        };
        _tmxM7U4W = {
            "id" = "tmxM7U4W";
            "file" = "geckolib-fabric-1.21.1-4.9.3.jar";
            "hash" = "sha512-4mocFdEM9cEjQwnbuC+yPUeDsllLJFSxapyWT6uemRK+ZpBLA+sB67lNraKY2Y3hjWb14/QXP3cVebVuE/faFg==";
        };
        _nOfQUA8r = {
            "id" = "nOfQUA8r";
            "file" = "geckolib-forge-1.21.1-4.9.3.jar";
            "hash" = "sha512-pNBDA7T0ZZ6Ok4Oi2u1Lo72uPQfGg9KJrAIc0FMv7AgpgskJk0tEIyIUbVW9QjpVu9QFx7YLeFy6z7n7PwbjfA==";
        };
        _Grwn5rUB = {
            "id" = "Grwn5rUB";
    ...
    in {
        ...
        "pkg-3.0.32" = _r2mQozkq;
        "pkg-3.0.87" = _FULWdgD2;
        "pkg-3.0.56" = _LhezFear;
        "pkg-3.0.34" = _E4nh57qb;
        "pkg-3.0.20" = _bpKnMhEa;
        "pkg-3.0.16" = _UKhnnujs;
        "pkg-3.1.14" = _3wOAeMp4;
        "pkg-3.1.15" = _LjY1py3L;
        "pkg-3.0.21" = _EMhe8KDf;
        "pkg-3.0.88" = _FBez9mw0;
        "pkg-3.0.58" = _bfDs5CGO;
        "pkg-3.0.35" = _5GVTBPUE;
        "pkg-3.0.22" = _Lufe4XGu;
        "pkg-3.1.16" = _rnpkwA6U;
        "pkg-3.1.17" = _QahGC1tv;
        "pkg-3.0.89" = _aybWUDvp;
        "pkg-3.0.59" = _MdTCpBJs;
        "pkg-3.0.36" = _AnwcpwtS;
        "pkg-3.0.23" = _UyGeKl49;
        "pkg-3.1.18" = _ssDvxZOr;
        "pkg-3.0.90" = _z7ttczzS;
        "pkg-3.0.60" = _Xy0nEDNy;
        "pkg-3.0.37" = _f3XhBRHz;
        "pkg-3.0.24" = _iRoNiwjq;
        "pkg-3.1.19" = _bQR9FtHO;
        "pkg-3.0.91" = _aavqJAu0;
        "pkg-3.0.61" = _oTCPZRK2;
        "pkg-3.0.25" = _TuPk6QZp;
        "pkg-3.0.38" = _Zl8TorMb;
        "pkg-3.1.20" = _KeljFi5f;
        "pkg-3.0.92" = _s3lOSctd;
        "pkg-3.0.62" = _pOOaURnj;
        "pkg-3.0.39" = _M3YdkbNy;
        "pkg-3.0.26" = _txnNTpPP;
        "pkg-3.1.21" = _VwYAuIe2;
        "pkg-3.0.93" = _R5tKL3H0;
        "pkg-3.0.63" = _lFeJ1Y6Z;
        "pkg-3.0.40" = _5XPm4pRO;
        "pkg-3.0.27" = _Mb3tsipy;
        "pkg-3.1.22" = _toUneKTa;
        "pkg-3.0.94" = _fU0VPYUQ;
        "pkg-3.0.64" = _ZARTsAr0;
        "pkg-3.0.28" = _nWu6K0d8;
        "pkg-3.0.41" = _s3u1zFH2;
        "pkg-3.1.23" = _YcJlytqm;
        "pkg-3.0.31" = _TBflAYyp;
        "pkg-3.0.96" = _GTDBRhSM;
        "pkg-3.0.97" = _4EE9OtNu;
        "pkg-3.0.67" = _GvdbRgRZ;
        "pkg-3.1.25" = _ktczq9M5;
        "pkg-3.1.27" = _9NhnjTrH;
        "pkg-3.0.45" = _NVpH4rdV;
        "pkg-3.0.98" = _af2O77o6;
        "pkg-3.0.68" = _8YJ2SCwm;
        "pkg-3.1.26" = _K7FKS2QU;
        "pkg-3.1.28" = _aJWSPyUh;
        "pkg-3.0.99" = _KozOahEp;
        "pkg-3.0.69" = _znZYx5xF;
        "pkg-3.0.33" = _6CPHVMxL;
        "pkg-3.1.29" = _C4VIuMdv;
        "pkg-3.0.47" = _D7zKpl75;
        "pkg-3.0.100" = _eProCvAi;
        "pkg-3.0.70" = _JUfF6Jer;
        "pkg-3.0.48" = _T8CaK9d5;
        "pkg-3.1.30" = _BKXKWNHN;
        "pkg-3.0.101" = _lt84hTBS;
        "pkg-3.0.71" = _8lHNv1BR;
        "pkg-3.0.49" = _qUDA5Ozd;
        "pkg-3.1.31" = _pnqQuYJn;
        "pkg-3.0.72" = _BHwMnQiT;
        "pkg-3.0.50" = _ULE87UoX;
        "pkg-3.1.32" = _oeKXWdtC;
        "pkg-3.0.102" = _p29L54mf;
        "pkg-3.0.103" = _1ZrdoKlp;
        "pkg-3.0.73" = _xXGDe6P5;
        "pkg-3.0.51" = _lDhul8lN;
        "pkg-3.1.33" = _cddgJkS9;
        "pkg-3.0.74" = _1aPT3e1t;
        "pkg-3.0.52" = _JTvFZCgx;
        "pkg-3.1.34" = _gvGNfUeU;
        "pkg-3.0.104" = _mXxld3t8;
        "pkg-3.0.53" = _OaVRMrL9;
        "pkg-3.0.75" = _V1WV1xOD;
        "pkg-3.1.35" = _AGtXkmMt;
        "pkg-3.0.76" = _PGdyqE3B;
        "pkg-3.0.77" = _NqzcbCO3;
        "pkg-3.0.54" = _LEndENkm;
        "pkg-3.1.36" = _zOvnacPM;
        "pkg-3.0.105" = _jIvd4A4a;
        "pkg-3.0.78" = _G46UXN4P;
        "pkg-3.0.55" = _p2dalTPH;
        "pkg-3.0.42" = _8vkpQIf8;
        "pkg-3.1.37" = _wBBaWvGV;
        "pkg-3.0.79" = _rWeVCWgR;
        "pkg-3.0.43" = _KfwWK3E2;
        "pkg-3.1.38" = _Wc0K0JdF;
        "pkg-4.0.0" = _OoBHBsUu;
        "pkg-3.0.44" = _vFTTggHa;
        "pkg-4.0.1" = _lTKMOGfM;
        "pkg-3.0.57" = _wwh0ZFLu;
        "pkg-3.0.80" = _Z7uH6V77;
        "pkg-3.1.39" = _GF04iZJU;
        "pkg-4.0.2" = _6hvy9UPH;
        "pkg-3.0.106" = _UQGoJDhn;
        "pkg-3.0.107" = _Z8ZwOmeO;
        "pkg-3.1.40" = _lxzmD9V4;
        "pkg-4.0.3" = _FEkGX3MJ;
        "pkg-4.0.4" = _1myM5wR4;
        "pkg-3.1.41" = _YaWDUJEE;
        "pkg-4.1.0" = _CHEy45yh;
        "pkg-4.0.5" = _oTLyaKlW;
        "pkg-4.1.1" = _eynJ8oNP;
        "pkg-4.0.6" = _QTZrKfzq;
        ...
        "pkg-4.6.5" = _hfGBFl1O;
        "pkg-4.6.6" = _qj2pTqCr;
        "pkg-4.7-beta-1" = _CkyFkiq6;
        "pkg-4.7-beta-2" = _IwKBDdGw;
        "pkg-4.7" = _LwI6czff;
        "pkg-4.7.1" = _cIt2XQZl;
        "pkg-4.8" = _aTS2d7QI;
        "pkg-4.7.2" = _AiVKLYep;
        ...
        "pkg-4.8.4" = _aC5KMoNg;
        "pkg-4.7.4" = _DGATwRuj;
        "pkg-4.7.4.1" = _dY3XtlLl;
        "pkg-4.7.5" = _TSeTaM0B;
        "pkg-4.7.5.1" = _QEqpUJ1G;
        "pkg-4.7.1.1" = _oYVCNULY;
        "pkg-4.7.1.2" = _e72SjmmI;
        "pkg-5.0-alpha1" = _z4VahJSu;
        "pkg-5.0-alpha2" = _3SXxFJwk;
        "pkg-5.0" = _eGuuc0wI;
        "pkg-5.0.1" = _yMOk5UQ9;
        "pkg-4.7.1.3" = _g4k8xf2k;
        "pkg-5.0.2" = _3GwkHtM0;
        "pkg-4.8.5" = _eQtABRub;
        "pkg-5.1.0" = _eRwH5qML;
        "pkg-4.7.6" = _DTo3uxPN;
        ...
        "pkg-4.7.7" = _18qeSgOb;
        "pkg-4.8.1" = _bVtfWE8S;
        "pkg-5.3-alpha-1" = _Q3kCMEaG;
        "pkg-5.3-alpha-2" = _tl9nlIEs;
        "pkg-5.3-alpha-3" = _xji1VqGU;
        "pkg-5.4-alpha-1" = _wmusUcv8;
        "pkg-5.4" = _RzfCWlJE;
        "pkg-5.4.1" = _ZDzCLY3R;
        "pkg-5.4.2" = _AMvqWzXw;
        "pkg-5.4.3" = _QiDuEGKS;
