...
let
    versions = (let
        ...
        _KfkxvFca = {
            "id" = "KfkxvFca";
            "file" = "grass_lower-1.0.1-mc26.3.zip";
            "hash" = "sha512-V/EvzjWXALZlcf3eJfmxCR5S//1qv92xFnfZxY6KsdmWQ1LaO3yXtBKJG+Fn7/J/7EGHOaGzUv+y9p/LJi6feQ==";
        };
    in {
        "YTJCVcsJ" = _YTJCVcsJ;
        "LLE8wYvw" = _LLE8wYvw;
