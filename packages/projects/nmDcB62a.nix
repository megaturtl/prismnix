...
let
    versions = (let
        ...
        _X5IBt7e3 = {
            "id" = "X5IBt7e3";
            "file" = "modernfix-forge-5.27.72+mc1.20.1.jar";
            "hash" = "sha512-4O6HnTpaefVFlMoLvyiCyRpkMrdoeUpBNLGO7IFNrR4IdpVWjMaR5e+3ZHTR5yQZbdxvU9ILLl3HunMR2NUhcg==";
        };
        _6by2SBrT = {
            "id" = "6by2SBrT";
            "file" = "modernfix-forge-5.27.76+mc1.20.1.jar";
            "hash" = "sha512-mY/NWIOV2dl1YO0S+gGaJ6Cxpodys5e60FH6JC3fyM2N5mNQltDSfXVjxXHyY8fBRB39eSVTF+1OhUAtOiolzQ==";
        };
        _Za21t5GN = {
            "id" = "Za21t5GN";
            "file" = "modernfix-forge-5.27.77+mc1.20.1.jar";
            "hash" = "sha512-qPHTgxNSSs8BDJdlUPJepLAj+y/Go46DTvghwLPf0RAIvKdKnJwRTXlSob8PHKGGYoxfMh85bplPZ7HBlRXRIA==";
        };
        _3URmWpVW = {
            "id" = "3URmWpVW";
            "file" = "modernfix-neoforge-5.27.21+mc26.1.2.jar";
            "hash" = "sha512-hGCwG+2OZbvWQtKoEPmyeUsMP1nbgV1bKbbnh6pmszhQybbtL7BZTYA203AIoDMzVJ1CqembuuJTjbRWb2keJg==";
        };
        _vMwgV2m5 = {
            "id" = "vMwgV2m5";
            "file" = "modernfix-forge-5.27.78+mc1.20.1.jar";
            "hash" = "sha512-x3lNliE4cAWaxraMXY3SyK/0BBFxJ6VRQT6u+eOIg/TMN+4BpI7mYaZFOy/FOOt5z1FU868nlmpPhKkcHMUwxg==";
        };
        _7O5TWeHv = {
            "id" = "7O5TWeHv";
            "file" = "modernfix-forge-5.27.78+mc1.20.1.jar";
        ...
        _N9cVTjFl = {
            "id" = "N9cVTjFl";
            "file" = "modernfix-neoforge-5.27.23+mc1.21.1.jar";
            "hash" = "sha512-4xgnFJPLdh02OGAxOdQkiRB21MoUkvaGVuvVA5NtWLCEPAfjoFoL5INUq8PwBeQNurdpCt8LqjF+/cutrbYP5Q==";
        };
        _uuWZXSci = {
            "id" = "uuWZXSci";
            "file" = "modernfix-forge-5.27.79+mc1.20.1.jar";
            "hash" = "sha512-UFSE7mjnyUhRJqtT9PSsfJNlttiJ2Cd/phjfPB2zOxpLqI/FxpXZD+Z8gJxJKTlTRO4Cat+ItUZcaMqRCnqMHg==";
        };
        _jAZ7Ge3d = {
            "id" = "jAZ7Ge3d";
            "file" = "modernfix-forge-5.27.83+mc1.20.1.jar";
            "hash" = "sha512-KYfUOrmRwxyU5T0W/gaU3SmkBfx832vmn1v1s9agal0bgrqPXY7LTfReWSxknjm8aXh8qmKzQXtVSDknk75uVQ==";
        };
        _5HLHxQ2F = {
            "id" = "5HLHxQ2F";
            "file" = "modernfix-neoforge-5.27.24+mc1.21.1.jar";
            "hash" = "sha512-2hP6FbLJanSn1fjqlOpATJYje5fVLJp35+NKyRjSjEB2CmjPOJdpGzF9URmrm4UDUULDYkEIsT3aNRbDQLlhMQ==";
        };
        _j7EoxpYe = {
            "id" = "j7EoxpYe";
    ...
    in {
        ...
        "pkg-2.3.2" = _bakWifEu;
        "pkg-3.3.1" = _lesun1xH;
        "pkg-1.13.0" = _TLWpxXmE;
        "pkg-2.4.0" = _tiJtC3Oq;
        "pkg-3.4.0" = _RhqFUhKl;
        "pkg-1.13.1" = _cRc8mTYR;
        "pkg-2.4.1" = _tF5MXC99;
        "pkg-3.4.1" = _YxjVHp6F;
        "pkg-1.14.0" = _4D2n0P0v;
        "pkg-2.5.0" = _JC0k0BLU;
        "pkg-3.5.0" = _wdlIqJM9;
        "pkg-4.0.0" = _DkR6UGcX;
        "pkg-1.14.1" = _j79FcbOV;
        "pkg-2.5.1" = _WNYg8TPD;
        "pkg-3.5.1" = _AR3lYRXy;
        "pkg-1.14.2" = _vHjPr4v0;
        "pkg-2.5.2" = _JofM3ehE;
        "pkg-3.5.2" = _ZD8n3OeB;
        "pkg-1.15.0" = _AvZe17Tl;
        "pkg-2.6.0" = _kGN22Ber;
        "pkg-3.6.0" = _JXUd23wE;
        "pkg-4.1.0" = _McrIpooS;
        "pkg-1.16.0" = _Qkwj2yjS;
        "pkg-2.7.0" = _Fn6lcgy4;
        "pkg-3.7.0" = _GhEe98X3;
        "pkg-4.2.0" = _I24pbFOk;
        "pkg-1.16.1" = _90vs2FzN;
        "pkg-2.7.1" = _HgJiOAQn;
        "pkg-3.7.1" = _FfgHSOEU;
        "pkg-4.2.1" = _lF2pqrO8;
        "pkg-5.0.0+mc1.16.5" = _KuHaMmH1;
        "pkg-5.0.0+mc1.19.2" = _f7G7ygPr;
        "pkg-5.0.0+mc1.18.2" = _1Mffj87M;
        "pkg-5.0.0+mc1.20" = _fqLJ9uB4;
        "pkg-5.0.0+mc1.19.4" = _tr7cCUCK;
        "pkg-5.0.1+mc1.18.2" = _P6rbJql2;
        "pkg-5.0.1+mc1.20" = _p9S1UnOj;
        "pkg-5.0.1+mc1.16.5" = _qbRB2wZ2;
        "pkg-5.0.1+mc1.19.4" = _VbB4VqCo;
        "pkg-5.0.1+mc1.19.2" = _ZopebhEU;
        "pkg-5.0.2+mc1.16.5" = _BTaK8vvw;
        "pkg-5.0.2+mc1.20" = _WENf7fmL;
        "pkg-5.0.2+mc1.19.4" = _KvbeSuS1;
        "pkg-5.0.2+mc1.19.2" = _1gWqXFaX;
        "pkg-5.0.2+mc1.18.2" = _D2athySH;
        "pkg-5.0.3+mc1.16.5" = _iO9FlOIm;
        "pkg-5.0.3+mc1.20.1" = _DHw0yfjn;
        "pkg-5.0.4+mc1.20.1" = _9MmJorda;
        "pkg-5.0.4+mc1.18.2" = _PKKqdqS8;
        "pkg-5.0.4+mc1.19.4" = _CS1MpLrX;
        "pkg-5.0.4+mc1.19.2" = _lJnMKe8e;
        "pkg-5.0.4+mc1.16.5" = _uzk1oBWH;
        "pkg-5.1.0+mc1.16.5" = _JqdfKm8N;
        "pkg-5.1.0+mc1.19.2" = _gRSAAIUU;
        "pkg-5.1.0+mc1.18.2" = _NQFTTsi6;
        "pkg-5.1.0+mc1.19.4" = _jqteDlfX;
        "pkg-5.1.0+mc1.20.1" = _G5B0BoGA;
        "pkg-5.1.1+mc1.20.1" = _QVSzLhRT;
        "pkg-5.1.1+mc1.19.4" = _btaNfyRK;
        "pkg-5.2.0+mc1.16.5" = _H7mnYOML;
        "pkg-5.2.0+mc1.18.2" = _e4ytl9KT;
        "pkg-5.2.0+mc1.19.4" = _RMzc2zgT;
        "pkg-5.2.0+mc1.19.2" = _linysjCw;
        "pkg-5.2.0+mc1.20.1" = _jiSgqiXH;
        "pkg-5.2.1+mc1.16.5" = _41RDuPe2;
        "pkg-5.2.1+mc1.19.4" = _cwTG6hyQ;
        "pkg-5.2.1+mc1.19.2" = _wYFiI0CR;
        "pkg-5.2.1+mc1.18.2" = _1QLOTz4V;
        "pkg-5.2.1+mc1.20.1" = _OFdWh7vx;
        "pkg-5.2.2+mc1.16.5" = _zaaC7slX;
        "pkg-5.2.2+mc1.19.4" = _qlVWBKgU;
        "pkg-5.2.2+mc1.19.2" = _v9uT5wj5;
        "pkg-5.2.2+mc1.20.1" = _4ZIvpHca;
        "pkg-5.2.2+mc1.18.2" = _gBP4wtrN;
        "pkg-5.2.3+mc1.20.1" = _c0IRQDNy;
        "pkg-5.2.3+mc1.19.4" = _ZAuuntw4;
        "pkg-5.2.3+mc1.19.2" = _eUxKumbO;
        "pkg-5.2.3+mc1.16.5" = _uOTQ9aSd;
        "pkg-5.2.3+mc1.18.2" = _97pLchRn;
        "pkg-5.2.4+mc1.16.5" = _ZqhmgF0E;
        "pkg-5.2.4+mc1.20.1" = _WJnAag75;
        "pkg-5.2.4+mc1.19.4" = _YMq1FhHc;
        "pkg-5.2.4+mc1.19.2" = _51N1kQ5P;
        "pkg-5.2.4+mc1.18.2" = _Lbh7ndyf;
        "pkg-5.2.5+mc1.16.5" = _A7VJZ2sj;
        "pkg-5.2.5+mc1.19.2" = _GOlEdlgS;
        "pkg-5.2.5+mc1.19.4" = _XjunZE7n;
        "pkg-5.2.5+mc1.20.1" = _BmneBBYa;
        "pkg-5.2.5+mc1.18.2" = _okrRsbRZ;
        "pkg-5.3.0+mc1.20.1" = _PV5hrdhD;
        "pkg-5.3.0+mc1.16.5" = _sk9kFgqw;
        "pkg-5.3.0+mc1.19.4" = _Ixz7TNCN;
        "pkg-5.3.0+mc1.19.2" = _jdCqC43M;
        "pkg-5.3.0+mc1.18.2" = _3otSD6Ai;
        "pkg-5.3.1+mc1.20.1" = _yRHXqAyS;
        "pkg-5.3.1+mc1.16.5" = _sZJM5bCM;
        "pkg-5.3.1+mc1.19.4" = _9uRdxCNg;
        "pkg-5.3.1+mc1.19.2" = _sBZ9FlQW;
        "pkg-5.3.1+mc1.18.2" = _S2KHHn3O;
        "pkg-5.3.2+mc1.20.1" = _9HGXIyEe;
        "pkg-5.3.2+mc1.19.2" = _sWajyf3d;
        "pkg-5.3.2+mc1.18.2" = _zDXxoYbt;
        "pkg-5.3.2+mc1.16.5" = _x3K80mPd;
        "pkg-5.3.2+mc1.19.4" = _DDGA4vbS;
        "pkg-5.4.0+mc1.20.1" = _synysXtc;
        "pkg-5.4.0+mc1.19.2" = _xYsH89XA;
        "pkg-5.4.0+mc1.18.2" = _GPUrRuDK;
        "pkg-5.4.0+mc1.16.5" = _Jw8xBmGc;
        "pkg-5.4.0+mc1.19.4" = _YufYRxqH;
        "pkg-5.4.1+mc1.16.5" = _orPjIEAx;
        "pkg-5.4.1+mc1.18.2" = _FGNCOJKF;
        "pkg-5.4.1+mc1.19.2" = _YDyqtNIH;
        "pkg-5.4.1+mc1.19.4" = _gpXn0fGj;
        "pkg-5.4.1+mc1.20.1" = _RPmoiZHT;
        "pkg-5.4.2+mc1.16.5" = _jHaVrcbU;
        "pkg-5.4.2+mc1.20.1" = _WYn556RC;
        "pkg-5.4.2+mc1.19.4" = _Ggtcd6Lc;
        "pkg-5.5.0+mc1.20.1" = _RIRMMnjp;
        "pkg-5.5.0+mc1.19.4" = _Ve0iT3SL;
        "pkg-5.5.0+mc1.18.2" = _4GPZ0uWs;
        "pkg-5.5.0+mc1.16.5" = _GLv15259;
        "pkg-5.4.3-beta.19+mc23w31a.3716" = _wYHO5U66;
        "pkg-5.5.1+mc1.19.2" = _nemKhyeF;
        "pkg-5.6.0+mc1.16.5" = _Z9Nf1tw4;
        "pkg-5.6.0+mc1.19.2" = _YWxJmxJY;
        "pkg-5.6.0+mc1.20.1" = _IDCtf2Pk;
        "pkg-5.6.0+mc1.18.2" = _YzYQ1W8W;
        "pkg-5.6.0+mc1.19.4" = _tI8jU427;
        "pkg-5.4.3-beta.22+mc23w32a.8614" = _WmXK2piP;
        "pkg-5.6.1+mc1.16.5" = _edDrlUuk;
        "pkg-5.6.1+mc1.18.2" = _B26rDrrz;
        "pkg-5.6.1+mc1.19.4" = _QlqkSEup;
        "pkg-5.6.1+mc1.19.2" = _YRcPOXZH;
        "pkg-5.6.1+mc1.20.1" = _PJlRMp4v;
        "pkg-5.4.3-beta.24+mc23w33a.8d10" = _LJrDWFEH;
        "pkg-5.7.0+mc1.16.5" = _rigrXobp;
        "pkg-5.7.0+mc1.20.1" = _xJbpSSiw;
        "pkg-5.7.0+mc1.18.2" = _ohh21bah;
        "pkg-5.7.0+mc1.19.4" = _f1dYaEYt;
        "pkg-5.7.0+mc1.19.2" = _wz12hVLM;
        "pkg-5.7.1+mc1.19.2" = _2Gz3u7pY;
        "pkg-5.7.1+mc1.18.2" = _wS8BEj1H;
        "pkg-5.7.1+mc1.16.5" = _9ca4pizA;
        "pkg-5.7.1+mc1.19.4" = _oqeQjBRP;
        "pkg-5.7.1+mc1.20.1" = _XDyibw2U;
        "pkg-5.7.2+mc1.19.2" = _88ksqzbj;
        "pkg-5.7.2+mc1.16.5" = _TtNOTwgu;
        "pkg-5.7.2+mc1.19.4" = _LXlsO4Vo;
        "pkg-5.7.2+mc1.20.1" = _zny6etkd;
        "pkg-5.7.2+mc1.18.2" = _GaKeTHbJ;
        "pkg-5.7.3-beta.1+mc1.20.2-pre3" = _oYMb8L0w;
        "pkg-5.7.3+mc1.20.2" = _9R9LPE4L;
        "pkg-5.7.4+mc1.16.5" = _SbLn3VXX;
        "pkg-5.7.4+mc1.18.2" = _QpVWtj3q;
        "pkg-5.7.4+mc1.20.1" = _tlTrDouz;
        "pkg-5.7.4+mc1.19.2" = _v2HWaHmC;
        "pkg-5.7.5+mc1.20.1" = _OxmgvWdr;
        "pkg-5.7.5+mc1.20.2" = _ADyFF3WV;
        "pkg-5.8.0+mc1.20.2" = _NZfBUD1x;
        "pkg-5.8.0+mc1.16.5" = _iFQICDdq;
        "pkg-5.8.0+mc1.18.2" = _6cUAWrqk;
        "pkg-5.8.0+mc1.20.1" = _hhpzMwx0;
        "pkg-5.8.0+mc1.19.2" = _bCqKORCZ;
        "pkg-5.8.1+mc1.20.2" = _5YONh7M3;
        "pkg-5.8.1+mc1.18.2" = _qqf2pVIf;
        "pkg-5.8.1+mc1.16.5" = _StT6fUPe;
        "pkg-5.8.1+mc1.20.1" = _mnS5cWZA;
        "pkg-5.8.1+mc1.19.2" = _lmCEiM2x;
        "pkg-5.8.2-beta.2+mc23w42a.231c" = _I019kuJ8;
        "pkg-5.8.2-beta.5+mc23w43a.472e" = _vQ1eqwUT;
        "pkg-5.9.0+mc1.20.2" = _6jU8mhig;
        "pkg-5.9.0+mc1.19.2" = _p3IGhtdO;
        "pkg-5.9.0+mc1.18.2" = _6caqQhyN;
        "pkg-5.9.0+mc1.20.1" = _jUXzFIgk;
        "pkg-5.9.0+mc1.16.5" = _FgynMuhC;
        "pkg-5.9.1+mc1.20.2" = _9e1ulwtU;
        "pkg-5.9.1+mc1.16.5" = _LZJryrWA;
        "pkg-5.9.1+mc1.18.2" = _v7RwGjGf;
        "pkg-5.9.1+mc1.19.2" = _LADYq9h9;
        "pkg-5.9.1+mc1.20.1" = _OMUhFXfR;
        "pkg-5.9.2+mc1.20.2" = _r62BNWkZ;
        "pkg-5.9.2+mc1.16.5" = _pTldUfVl;
        "pkg-5.9.2+mc1.19.2" = _jJVhEy8G;
        "pkg-5.9.2+mc1.20.1" = _hymPZqLe;
        "pkg-5.9.2+mc1.18.2" = _1niVYLe4;
        "pkg-5.8.2-beta.23+mc23w45a.464c" = _WrH5h6hR;
        "pkg-5.9.3+mc1.20.1" = _SEKTVPwa;
        "pkg-5.9.3+mc1.20.2" = _nYh2qee4;
        "pkg-5.9.3+mc1.16.5" = _m0WsH8Pp;
        "pkg-5.9.3+mc1.19.2" = _QTtrC1Mj;
        "pkg-5.9.3+mc1.18.2" = _G55gynqz;
        "pkg-5.10.0+mc1.16.5" = _anWzGpyT;
        "pkg-5.10.0+mc1.20.1" = _AIejFbqQ;
        "pkg-5.10.0+mc1.20.2" = _6wupFeDa;
        "pkg-5.10.0+mc1.19.2" = _wdSwq9ke;
        "pkg-5.10.0+mc1.18.2" = _IScTO5kT;
        "pkg-5.10.0+mc1.20.3" = _qgFq0dU0;
        "pkg-5.10.1+mc1.16.5" = _CDiUztEN;
        "pkg-5.10.1+mc1.20.4" = _7c9U7JHU;
        "pkg-5.10.1+mc1.20.2" = _6IhNexn2;
        "pkg-5.10.1+mc1.20.1" = _XmsWashv;
        "pkg-5.10.1+mc1.19.2" = _6YtCmcgN;
        "pkg-5.10.2+mc1.20.4" = _gkUP299q;
        "pkg-5.11.0+mc1.16.5" = _usNAzp2p;
        "pkg-5.11.0+mc1.20.4" = _RXaOdpBL;
        "pkg-5.11.0+mc1.18.2" = _b5yVw0pL;
        "pkg-5.11.0+mc1.20.1" = _nksMSrEt;
        "pkg-5.11.0+mc1.19.2" = _UKHyXfho;
        "pkg-5.11.1+mc1.20.4" = _IJWNOJEe;
        "pkg-5.11.1+mc1.16.5" = _Ohe8OvYJ;
        "pkg-5.11.1+mc1.20.1" = _gepXNUac;
        "pkg-5.11.1+mc1.19.2" = _bBOj6OEk;
        "pkg-5.11.1+mc1.18.2" = _oOnGhdHG;
        "pkg-5.12.0+mc1.20.1" = _A7mqqvc5;
        "pkg-5.12.0+mc1.19.2" = _LQU2U5mx;
        "pkg-5.12.0+mc1.20.4" = _rf0fSXa5;
        "pkg-5.12.0+mc1.16.5" = _24VdLGlD;
        "pkg-5.12.0+mc1.18.2" = _r9eMwecP;
        "pkg-5.12.1+mc1.20.4" = _bsTG5IKj;
        "pkg-5.12.1+mc1.20.1" = _uUQmiRzm;
        "pkg-5.10.3-beta.16+mc24w04a.f244" = _OOAMFEGB;
        "pkg-5.13.0+mc1.16.5" = _IWsQb2tD;
        "pkg-5.13.0+mc1.20.4" = _T8GvLNSz;
        "pkg-5.13.0+mc1.20.1" = _u5R7SNlj;
        "pkg-5.13.0+mc1.19.2" = _YPwzjK2W;
        "pkg-5.13.0+mc1.18.2" = _P0Gj6bhf;
        "pkg-5.10.3-beta.28+mc24w09a.eaca" = _xgdNEjjn;
        "pkg-5.14.0+mc1.20.4" = _f6WrRlmX;
        "pkg-5.14.0+mc1.16.5" = _uazja51B;
        "pkg-5.14.0+mc1.20.1" = _XWMKGS0l;
        "pkg-5.14.0+mc1.18.2" = _yx7Ty06C;
        "pkg-5.14.0+mc1.19.2" = _9eACxgCp;
        "pkg-5.15.0+mc1.20.1" = _u1FOqNCn;
        "pkg-5.15.0+mc1.19.2" = _wMmG6Z2w;
        "pkg-5.15.0+mc1.16.5" = _PmGpKiME;
        "pkg-5.15.0+mc1.20.4" = _IMUijlCk;
        "pkg-5.15.0+mc1.18.2" = _8IOJKzmV;
        "pkg-5.16.0-beta.1+mc24w14a" = _OS3nKgb9;
        "pkg-5.16.0+mc1.20.1" = _nQTU8UXe;
        "pkg-5.16.0+mc1.20.4" = _69cUr8FY;
        "pkg-5.16.0+mc1.18.2" = _YtxEBvsf;
        "pkg-5.16.0+mc1.16.5" = _TI6DbX58;
        "pkg-5.16.0+mc1.19.2" = _xsOOBMvd;
        "pkg-5.16.1+mc1.19.2" = _TwtE3QUV;
        "pkg-5.16.1+mc1.20.1" = _2Rr52SPW;
        "pkg-5.16.1+mc1.18.2" = _ruxa7tmt;
        "pkg-5.16.1+mc1.20.4" = _WnvIT2k4;
        "pkg-5.17.0+mc1.16.5" = _dWBNYmKr;
        "pkg-5.17.0+mc1.20.4" = _Kf6nINYI;
        "pkg-5.17.0+mc1.20.1" = _BpXImv5B;
        "pkg-5.17.0+mc1.20.5" = _QXdjmNRb;
        "pkg-5.17.0+mc1.18.2" = _OLsQcRB4;
        "pkg-5.17.0+mc1.19.2" = _Enb5QBS3;
        "pkg-5.17.2+mc1.20.6" = _AV7XOtET;
        "pkg-5.17.3+mc1.20.6" = _xrfAu1uz;
        "pkg-5.18.0+mc1.16.5" = _Cc0b1kXl;
        "pkg-5.18.0+mc1.20.1" = _o1xUnPS2;
        "pkg-5.18.0+mc1.20.6" = _g8YTb1tk;
        "pkg-5.18.0+mc1.18.2" = _Vlkqd178;
        "pkg-5.18.0+mc1.19.2" = _i0vWRI7P;
        "pkg-5.18.1+mc1.21" = _FMcuOGSQ;
        "pkg-5.18.1+mc1.20.1" = _JCb26GJk;
        "pkg-5.18.2+mc1.21" = _9pYr3f79;
        "pkg-5.18.3+mc1.21" = _Z6zUeVzl;
        "pkg-5.18.4+mc1.21" = _Ot0Gu4EP;
        "pkg-5.18.5+mc1.21" = _kVsoDxr7;
        "pkg-5.18.6+mc1.20.1" = _QroNBg6X;
        "pkg-5.18.6+mc1.21" = _QTSxkl1e;
        "pkg-5.18.7+mc1.21" = _A6zzCptF;
        "pkg-5.18.8+mc1.21" = _TXrV8DtO;
        "pkg-5.18.9+mc1.20.1" = _2U36f0dT;
        "pkg-5.18.10+mc1.20.1" = _j5VhGcov;
        "pkg-5.19.0+mc1.20.1" = _MKrkLMqg;
        "pkg-5.19.0+mc1.21" = _vNbpPeOM;
        "pkg-5.19.1+mc1.21" = _HFaBErrM;
        "pkg-5.19.1+mc1.20.1" = _HdKHe8QA;
        "pkg-5.19.2+mc1.21.1" = _s7ay7jMY;
        "pkg-5.19.3+mc1.20.1" = _w905atQ5;
        "pkg-5.19.3+mc1.21.1" = _18tAoFs1;
        "pkg-5.19.4+mc1.20.1" = _m83ZRQdk;
        "pkg-5.18.1+mc1.19.2" = _FqoRZlrr;
        "pkg-5.19.5+mc1.21.1" = _QVe1LGQD;
        "pkg-5.19.5+mc1.20.1" = _QkyFrVSl;
        "pkg-5.19.6+mc1.21.1" = _tjiGBYIY;
        "pkg-5.19.6+mc1.20.1" = _XlmOKkqg;
        "pkg-5.19.7+mc1.20.1" = _vX1O3CGg;
        "pkg-5.20.0+mc1.21.4" = _TYLvaA6H;
        "pkg-5.20.0+mc1.20.1" = _tLSzIfcj;
        "pkg-5.20.0+mc1.21.1" = _rOLLd6NG;
        "pkg-5.20.1+mc1.21.4" = _vOIDbZlt;
        "pkg-5.20.2+mc1.20.1" = _LmgaF8pW;
        "pkg-5.20.2+mc1.21.4" = _CAmPOdHE;
        "pkg-5.20.2+mc1.21.1" = _ZKnJCu6a;
        "pkg-5.20.3+mc1.21.4" = _xbg7UvQT;
        "pkg-5.21.0+mc1.21.1" = _4AeXSL8S;
        "pkg-5.21.0+mc1.20.1" = _5m06ltZw;
        "pkg-5.22.0+mc1.21.1" = _RU9sGOmD;
        "pkg-5.22.0+mc1.20.1" = _bGN4sTBS;
        "pkg-5.23.0+mc1.21.1" = _JNjN5X7g;
        "pkg-5.23.0+mc1.20.1" = _OLk2pIh9;
        "pkg-5.23.1+mc1.20.1" = _coV9vitC;
        "pkg-5.23.1+mc1.21.1" = _gADERDwI;
        "pkg-5.24.0+mc1.21.1" = _GYwy7uIj;
        "pkg-5.24.0+mc1.20.1" = _h03ZvjY8;
        "pkg-5.24.1+mc1.20.1" = _DdUByV9S;
        "pkg-5.24.1+mc1.21.1" = _nXuORlyQ;
        "pkg-5.24.2+mc1.21.1" = _i0BcjLmQ;
        "pkg-5.24.2+mc1.20.1" = _1duKwUE0;
        "pkg-5.24.3+mc1.21.1" = _4SPHwiDB;
        "pkg-5.24.3+mc1.20.1" = _EAQLVtM2;
        "pkg-5.24.4+mc1.20.1" = _CixO1IdG;
        "pkg-5.25.0+mc1.21.1" = _N9LUsEeT;
        "pkg-5.25.0+mc1.20.1" = _B1kPym71;
        "pkg-5.25.1+mc1.21.1" = _8Be8uJW6;
        "pkg-5.25.1+mc1.20.1" = _PbIMs8a8;
        "pkg-5.25.2+mc1.20.1" = _scXW7F8Q;
        "pkg-5.26.1+mc1.21.1" = _c759JLsq;
        "pkg-5.26.1+mc1.20.1" = _zSQuM6f3;
        "pkg-5.26.2+mc1.20.1" = _Uvlhuprw;
        "pkg-5.27.0+mc1.20.1" = _49XAoWnX;
        "pkg-5.27.0+mc1.21.1" = _7bPu6FEi;
        "pkg-5.27.0+mc26.1" = _kVUTFg9G;
        "pkg-5.27.1+mc26.1.2" = _heiruKEq;
        "pkg-5.27.2+mc26.1.2" = _Z85t4Kdb;
        "pkg-5.27.1+mc1.20.1" = _b21hnh8M;
        "pkg-5.27.1+mc1.21.1" = _ZW2GXRLo;
        "pkg-5.27.3+mc26.1.2" = _5OrqAMiE;
        "pkg-5.27.3+mc1.20.1" = _VFLdAav9;
        "pkg-5.27.4+mc1.20.1" = _3I2aimZB;
        "pkg-5.27.4+mc26.1.2" = _y3pkFPfO;
        "pkg-5.27.6+mc1.20.1" = _ejvnCmyX;
        "pkg-5.27.2+mc1.21.1" = _iYwIkyV5;
        "pkg-5.27.5+mc26.1.2" = _1MM4Ok3r;
        "pkg-5.27.7+mc1.20.1" = _q1Be1JOI;
        "pkg-5.27.8+mc1.20.1" = _OvpPdk44;
        "pkg-5.27.6+mc26.1.2" = _uIned7g2;
        "pkg-5.27.10+mc1.20.1" = _VA9W2wcb;
        "pkg-5.27.7+mc26.1.2" = _SXe8JyAD;
        "pkg-5.27.3+mc1.21.1" = _QbebWhuK;
        "pkg-5.27.11+mc1.20.1" = _E4BGknH1;
        "pkg-5.27.12+mc1.20.1" = _eYMgSQpS;
        "pkg-5.27.14+mc1.20.1" = _b4RNigzC;
        "pkg-5.27.4+mc1.21.1" = _6U8JVjdw;
        "pkg-5.27.15+mc1.20.1" = _ZtCxqDmV;
        "pkg-5.27.19+mc1.20.1" = _wyNpkwMS;
        "pkg-5.27.5+mc1.21.1" = _NtFWZLui;
        "pkg-5.27.9+mc26.1.2" = _8Ofc3Eoi;
        "pkg-5.27.21+mc1.20.1" = _j0wtcGTI;
        "pkg-5.27.6+mc1.21.1" = _lVkfC362;
        "pkg-5.27.10+mc26.1.2" = _zur3Wwgk;
        "pkg-5.27.22+mc1.20.1" = _rswcMw5Z;
        "pkg-5.27.11+mc26.1.2" = _iA2z44m0;
        "pkg-5.27.7+mc1.21.1" = _Ml6xWbje;
        "pkg-5.27.24+mc1.20.1" = _y7VfIMUX;
        "pkg-5.27.25+mc1.20.1" = _nnkRBkUx;
        "pkg-5.27.8+mc1.21.1" = _VGmSpV69;
        "pkg-5.27.12+mc26.1.2" = _51lrbpoY;
        "pkg-5.27.33+mc1.20.1" = _6cyk10oZ;
        "pkg-5.27.9+mc1.21.1" = _Icd2DkF6;
        "pkg-5.27.39+mc1.20.1" = _3xsuDIom;
        "pkg-5.27.10+mc1.21.1" = _slJIhbWX;
        "pkg-5.27.40+mc1.20.1" = _27NYZ7LL;
        "pkg-5.27.11+mc1.21.1" = _nWk1yGgV;
        "pkg-5.27.44+mc1.20.1" = _VidbIJB9;
        "pkg-5.27.49+mc1.20.1" = _cEaTJM25;
        "pkg-5.27.12+mc1.21.1" = _iFmzYK6q;
        "pkg-5.27.16+mc26.1.2" = _CW5mQ9Wh;
        "pkg-5.27.50+mc1.20.1" = _8BoXX9rl;
        "pkg-5.27.51+mc1.20.1" = _5Uz1QIVU;
        "pkg-5.27.17+mc26.1.2" = _EqimZmNn;
        "pkg-5.27.14+mc1.21.1" = _KcU1Mn0I;
        "pkg-5.27.57+mc1.20.1" = _kWfdKtWR;
        "pkg-5.27.58+mc1.20.1" = _JUhfu5Dq;
        "pkg-5.27.15+mc1.21.1" = _ZkPOaQLQ;
        "pkg-5.27.18+mc26.1.2" = _MiignKwh;
        "pkg-5.27.63+mc1.20.1" = _dFQ9fgvb;
        "pkg-5.27.66+mc1.20.1" = _ZxDvSMHV;
        "pkg-5.27.20+mc1.21.1" = _VsJnrw8k;
        "pkg-5.27.20+mc26.1.2" = _oG75RchZ;
        "pkg-5.27.72+mc1.20.1" = _X5IBt7e3;
        "pkg-5.27.76+mc1.20.1" = _6by2SBrT;
        "pkg-5.27.77+mc1.20.1" = _Za21t5GN;
        "pkg-5.27.21+mc26.1.2" = _3URmWpVW;
        "pkg-5.27.78+mc1.20.1" = _7O5TWeHv;
        "pkg-5.27.23+mc1.21.1" = _N9cVTjFl;
        "pkg-5.27.79+mc1.20.1" = _uuWZXSci;
