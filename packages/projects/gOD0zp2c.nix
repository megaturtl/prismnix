...
let
    versions = (let
        ...
        _n4f5tRF0 = {
            "id" = "n4f5tRF0";
            "file" = "visible-entities-0.2.1+mc26.3.jar";
            "hash" = "sha512-gtqctZ1tr+L2Ur4i4QrY9iC8DA/y4MLOfpasFSeWn3a4LYq5eSJTHlLO+M0CJ91VRXNmrIHI0/H2Z3ZMKw1YFQ==";
        };
    in {
        "7Qkd2N68" = _7Qkd2N68;
        "UCkFYzDv" = _UCkFYzDv;
