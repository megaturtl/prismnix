...
let
    versions = (let
        ...
        _sXDX4YX8 = {
            "id" = "sXDX4YX8";
            "file" = "Craftorithm-1.13.0.0.jar";
            "hash" = "sha512-0JotPFkZq1KvZlz825OmNKnkW3maBSXhDCy+v6MpoNLShNyETks8/eRVT70rsklT8g+XD+7Tek6bRSjOEQUiWA==";
        };
        _t3159hXY = {
            "id" = "t3159hXY";
            "file" = "Craftorithm-1.13.1.0.jar";
            "hash" = "sha512-4QJNRckBpNbrgQcWPA7fb/SAJg/9lyXWtMzsZ+OKEXfyr/URiguMhaBg+4U8iQPXtd9nURlT5+yqm/G+2508NQ==";
        };
        _mK7VfHfu = {
            "id" = "mK7VfHfu";
            "file" = "Craftorithm-1.13.2.0.jar";
            "hash" = "sha512-QmZhg0xXK3TZga998WSC97oGI0CJeYzZe5qiqdQvmpeLH2s+8muUcX2SWI+L8zNts80RnxP+Y6ZHe4JsOg2RTQ==";
        };
        _IJPZzHuk = {
            "id" = "IJPZzHuk";
            "file" = "Craftorithm-1.13.3.0.jar";
            "hash" = "sha512-TX6xqLqgdf4h9+rSpNBOb9cryy2SJ57x29ly6+XhfeJNl6BHV6TQfdaSvtb+pBwPMfWyxuAud3FViZ/Bmwgf9A==";
        };
        _fpyySdnG = {
            "id" = "fpyySdnG";
            "file" = "Craftorithm-1.13.5.0.jar";
            "hash" = "sha512-OSBXwmvIGyONysQbOd/zE42vl7husn5rMtLcCuuftwXexT9Chhe2fS/pxsxV2uhVsATGvlEGK3rhbYG2gR+cEA==";
        };
        _3xmuXO6x = {
            "id" = "3xmuXO6x";
            "file" = "Craftorithm-1.13.5.1.jar";
            "hash" = "sha512-dW21QnVbQjrN7kJdCpuR+HVlLwVo00c/od4b+wnHFI5GrCjEFrvTZiZufRC6Nnlshv4Cyay/tDPuz7mohHf8Og==";
        };
        _54W6VZwl = {
            "id" = "54W6VZwl";
            "file" = "Craftorithm-1.13.5.2.jar";
            "hash" = "sha512-VcckrLQFg70dduOa6NN4fkny7GwxRpISoeRxu8735XasyJnHgscI/oIvkBaw+nId4unuhP7v+8OsBNX5/w15Tg==";
        };
        _pWnDZJQ4 = {
            "id" = "pWnDZJQ4";
            "file" = "Craftorithm-1.13.6.0.jar";
            "hash" = "sha512-/hTSmZAJzyc4utGH5fk6GHq5ejBP6fRSGDzI/igu9ZjQn8xp0Mw80mKx69xTyORgPfVVxEoPn9tce6IROY/lpQ==";
        };
        _m0ksA2Yn = {
            "id" = "m0ksA2Yn";
            "file" = "Craftorithm-1.13.7.0.jar";
            "hash" = "sha512-Cx4n+YNvJRP0xgu+1u64452fXiIRuzUPClNnAP6tg1l6SmVr7KVE9wvMv85qFVkkkOXM65GC3Do9TNqSjjheww==";
        };
        _dnvOCxSg = {
            "id" = "dnvOCxSg";
            "file" = "Craftorithm-1.13.7.1.jar";
            "hash" = "sha512-G4Meox3FIwn73iRLEXXhCMd2jH4mZs2sZ/1JjLGi6VWiDphHeYQQS/BClMNQFDiubiCSyFV7+RPyWvax2homSw==";
        };
        _EQLmazWn = {
            "id" = "EQLmazWn";
            "file" = "Craftorithm-1.13.7.2.jar";
            "hash" = "sha512-RYyWnlgCPVZGFCV0Wu2PY09xXPqlt5ZycpmjKFcILwjjBcPcMr47A+v/3SB8UOxDjRWmZ1hozrenkF5StNkz8w==";
        };
        _uv6gQtvl = {
            "id" = "uv6gQtvl";
            "file" = "Craftorithm-1.13.7.3.jar";
            "hash" = "sha512-KXu4+wiZsBg5Ev9j/vXk0BoPDrGmsoFLBu+Jy0aCr2QehQnVqotOQ0RRlMfNGv8bWwOAVSDN9kk1xfa43gWsVg==";
        };
        _GSAybPUj = {
            "id" = "GSAybPUj";
            "file" = "Craftorithm-1.14.0.0.jar";
            "hash" = "sha512-DMaETNiSiiFWxQj5KwuUF8x3Cw/3uW3vC2t08c/9rKttHsNS1fwqnPZLak7vpDJOIRBoEB9NyRzbST/nZ0LeZQ==";
        };
    in {
        "dj0eRoVj" = _dj0eRoVj;
        "7IpblrOo" = _7IpblrOo;
        ...
        "folia-1.20" = _GSAybPUj;
        "folia-1.20.1" = _GSAybPUj;
        "folia-1.20.2" = _GSAybPUj;
        "folia-1.20.3" = _GSAybPUj;
        "folia-1.20.4" = _GSAybPUj;
        "folia-1.20.6" = _GSAybPUj;
        "folia-1.21" = _GSAybPUj;
        "folia-1.20.5" = _GSAybPUj;
        "folia-1.21.1" = _GSAybPUj;
        "folia-1.21.2" = _GSAybPUj;
        "folia-1.21.3" = _GSAybPUj;
        "folia-1.21.4" = _GSAybPUj;
        "folia-1.21.5" = _GSAybPUj;
        "folia-1.21.6" = _GSAybPUj;
        "folia-1.21.7" = _GSAybPUj;
        "folia-1.21.8" = _GSAybPUj;
        "folia-1.21.9" = _GSAybPUj;
        "folia-1.21.10" = _GSAybPUj;
        "folia-1.21.11" = _GSAybPUj;
        "folia-26.1" = _GSAybPUj;
        "folia-26.1.1" = _GSAybPUj;
        "folia-26.1.2" = _GSAybPUj;
        "folia-26.2" = _GSAybPUj;
        ...
        "paper-1.20" = _GSAybPUj;
        "paper-1.20.1" = _GSAybPUj;
        "paper-1.20.2" = _GSAybPUj;
        "paper-1.20.3" = _GSAybPUj;
        "paper-1.20.4" = _GSAybPUj;
        "paper-1.20.6" = _GSAybPUj;
        "paper-1.21" = _GSAybPUj;
        "paper-1.20.5" = _GSAybPUj;
        "paper-1.21.1" = _GSAybPUj;
        "paper-1.21.2" = _GSAybPUj;
        "paper-1.21.3" = _GSAybPUj;
        "paper-1.21.4" = _GSAybPUj;
        "paper-1.21.5" = _GSAybPUj;
        "paper-1.21.6" = _GSAybPUj;
        "paper-1.21.7" = _GSAybPUj;
        "paper-1.21.8" = _GSAybPUj;
        "paper-1.21.9" = _GSAybPUj;
        "paper-1.21.10" = _GSAybPUj;
        "paper-1.21.11" = _GSAybPUj;
        "paper-26.1" = _GSAybPUj;
        "paper-26.1.1" = _GSAybPUj;
        "paper-26.1.2" = _GSAybPUj;
        "paper-26.2" = _GSAybPUj;
        ...
        "purpur-1.20" = _GSAybPUj;
        "purpur-1.20.1" = _GSAybPUj;
        "purpur-1.20.2" = _GSAybPUj;
        "purpur-1.20.3" = _GSAybPUj;
        "purpur-1.20.4" = _GSAybPUj;
        "purpur-1.20.6" = _GSAybPUj;
        "purpur-1.21" = _GSAybPUj;
        "purpur-1.20.5" = _GSAybPUj;
        "purpur-1.21.1" = _GSAybPUj;
        "purpur-1.21.2" = _GSAybPUj;
        "purpur-1.21.3" = _GSAybPUj;
        "purpur-1.21.4" = _GSAybPUj;
        "purpur-1.21.5" = _GSAybPUj;
        "purpur-1.21.6" = _GSAybPUj;
        "purpur-1.21.7" = _GSAybPUj;
        "purpur-1.21.8" = _GSAybPUj;
        "purpur-1.21.9" = _GSAybPUj;
        "purpur-1.21.10" = _GSAybPUj;
        "purpur-1.21.11" = _GSAybPUj;
        "purpur-26.1" = _GSAybPUj;
        "purpur-26.1.1" = _GSAybPUj;
        "purpur-26.1.2" = _GSAybPUj;
        "purpur-26.2" = _GSAybPUj;
        ...
        "spigot-1.20" = _GSAybPUj;
        "spigot-1.20.1" = _GSAybPUj;
        "spigot-1.20.2" = _GSAybPUj;
        "spigot-1.20.3" = _GSAybPUj;
        "spigot-1.20.4" = _GSAybPUj;
        "spigot-1.20.6" = _GSAybPUj;
        "spigot-1.21" = _GSAybPUj;
        "spigot-1.20.5" = _GSAybPUj;
        "spigot-1.21.1" = _GSAybPUj;
        "spigot-1.21.2" = _GSAybPUj;
        "spigot-1.21.3" = _GSAybPUj;
        "spigot-1.21.4" = _GSAybPUj;
        "spigot-1.21.5" = _GSAybPUj;
        "spigot-1.21.6" = _GSAybPUj;
        "spigot-1.21.7" = _GSAybPUj;
        "spigot-1.21.8" = _GSAybPUj;
        "spigot-1.21.9" = _GSAybPUj;
        "spigot-1.21.10" = _GSAybPUj;
        "spigot-1.21.11" = _GSAybPUj;
        "spigot-26.1" = _GSAybPUj;
        "spigot-26.1.1" = _GSAybPUj;
        "spigot-26.1.2" = _GSAybPUj;
        "spigot-26.2" = _GSAybPUj;
        "pkg-1.4.5" = _dj0eRoVj;
        "pkg-1.4.6" = _7IpblrOo;
        "pkg-1.5.0" = _6ItA8SB4;
        "pkg-1.5.1" = _POmFC5SY;
        ...
        "pkg-1.8.8" = _TufOvzn8;
        "pkg-1.8.9" = _zloxh1hn;
        "pkg-1.8.10" = _8AimJ3GQ;
        "pkg-1.8.11" = _CIxOa8lM;
        "pkg-1.8.12" = _IjqeBsWK;
        "pkg-1.8.13" = _lz3mVfNL;
        "pkg-1.9.0" = _DWxA3BAr;
        "pkg-1.9.1-20240216" = _FSixdSl2;
        "pkg-1.9.2" = _a459owy3;
        "pkg-1.9.3" = _pFEDYafb;
        "pkg-1.9.4" = _KWzQk87S;
        "pkg-1.10.0" = _iBwWDkvB;
        "pkg-1.10.1" = _DYjgZHNJ;
        "pkg-1.10.2" = _SlThS6H0;
        "pkg-1.10.3" = _EYblNwEo;
        "pkg-1.10.4" = _ke5CJDKB;
        "pkg-1.10.5" = _IgIaZxue;
        "pkg-1.10.6" = _via5NiS2;
        "pkg-1.10.7" = _xpkfNiWu;
        "pkg-1.10.8" = _fRD6pNuW;
        "pkg-1.10.9" = _EBQ1P1tq;
        "pkg-1.10.10" = _o8UjQrmE;
        "pkg-1.10.11" = _DWo2BIHG;
        "pkg-1.10.12" = _Q44S9CjY;
        "pkg-1.10.13" = _6PpTpBjN;
        "pkg-1.10.14" = _2My0NmJj;
        "pkg-1.10.15" = _8VglO4Hx;
        "pkg-1.10.16" = _wRvbAC5K;
        "pkg-1.10.17" = _sWkMXIft;
        "pkg-1.10.18" = _ZLAiNZvB;
        "pkg-1.10.19" = _PfJczw2z;
        "pkg-1.10.20" = _5CVf1Ac4;
        "pkg-1.10.22" = _GKUHHvQ0;
        "pkg-1.10.25" = _t2NIkxeZ;
        "pkg-1.10.26" = _QOdNK6jn;
        "pkg-1.11.1.0" = _ByUFkJYj;
        "pkg-1.11.1.1" = _7DLJAvYj;
        "pkg-1.11.2.0" = _BjrFqFdF;
        "pkg-1.11.3.0" = _8LG5SDg0;
        "pkg-1.11.4.0" = _Oi3iUH4q;
        "pkg-1.11.4.1" = _AYF8lLHV;
        "pkg-1.12.0.0" = _DihGIaPE;
        "pkg-1.12.0.1" = _vcx07V8z;
        "pkg-1.12.0.2" = _LfMmYiCK;
        "pkg-1.12.0.3" = _DxLs2Oq0;
        "pkg-1.12.1.0" = _Sq1dbSLp;
        "pkg-1.12.2.0" = _KFUbmsBq;
        "pkg-1.13.0.0" = _sXDX4YX8;
        "pkg-1.13.1.0" = _t3159hXY;
        "pkg-1.13.2.0" = _mK7VfHfu;
        "pkg-1.13.3.0" = _IJPZzHuk;
        "pkg-1.13.5.0" = _fpyySdnG;
        "pkg-1.13.5.1" = _3xmuXO6x;
        "pkg-1.13.5.2" = _54W6VZwl;
        "pkg-1.13.6.0" = _pWnDZJQ4;
        "pkg-1.13.7.0" = _m0ksA2Yn;
        "pkg-1.13.7.1" = _dnvOCxSg;
        "pkg-1.13.7.2" = _EQLmazWn;
        "pkg-1.13.7.3" = _uv6gQtvl;
        "pkg-1.14.0.0" = _GSAybPUj;
        "default" = _GSAybPUj;
    });
