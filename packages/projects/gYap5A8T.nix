...
let
    versions = (let
        ...
        _Byleeqtj = {
            "id" = "Byleeqtj";
            "file" = "monkeylib538-paper-26.2-5.2.0+paper+26.2-all.jar";
            "hash" = "sha512-8cyrGchUizF/SO2Fgsf5H4MVr5WmqcJITgkUQvSxwVt6hFnEy9+eB/pWscJp+gxdBJalMYEWApwQdO6+4+yw1g==";
        };
        _opRVaw8c = {
            "id" = "opRVaw8c";
            "file" = "monkeylib538-paper-26.1-5.2.0+paper+26.1-all.jar";
            "hash" = "sha512-Q+c2J0XL7JALSlpYyQY1wMUQTbzqJISAw/g70upk4g+UGWRB1prljM4w+H43DSn+uYl1iPJp/J6Rqep8wmEGCg==";
        };
        _L7zF7QAz = {
            "id" = "L7zF7QAz";
            "file" = "monkeylib538-fabric-26.1-5.2.0+fabric+26.1.jar";
            "hash" = "sha512-eTWbc/kuyn0MZFCV0tk/CDOqwiMzLKhcrMMjdRAxsW5lnrUDQz5oodHMqta6p7BD/5JLop2d27qZxa2x681jCw==";
        };
        _hwY1fSWe = {
            "id" = "hwY1fSWe";
            "file" = "monkeylib538-neoforge-26.2-5.2.0+neoforge+26.2.jar";
            "hash" = "sha512-PzDKgN1bCjfmH0FZvrcpw9RvcIshES1WA5KceQVr9AQx0kWuPBaNWBF8Al3QB9vf/ooyuVf/+vkdEv7gkopxdA==";
        };
        _E3cim4xn = {
            "id" = "E3cim4xn";
            "file" = "monkeylib538-fabric-26.2-5.2.0+fabric+26.2.jar";
            "hash" = "sha512-6l9jsiJxE3MGbGLFCaLY1Y4L1+cgHvii6JWKOb7wEgxVwVJBh0O/ow9iScYc858KJnTlxLSpPgvyvU9KRsE9UQ==";
        };
        _k2f3L5V2 = {
            "id" = "k2f3L5V2";
            "file" = "monkeylib538-neoforge-26.1-5.2.0+neoforge+26.1.jar";
            "hash" = "sha512-+0+ZzS0Cr23HEmqB/b/JH1P7t47SDjlNwwq78B20UWU6S65clu0fes0TaPqEme7nXzSZg5HTVErclDHy8oKUcg==";
        };
        _W7eM5uq6 = {
            "id" = "W7eM5uq6";
            "file" = "monkeylib538-paper-26.1-5.2.1+paper+26.1-all.jar";
            "hash" = "sha512-r41+TMdIaLNnVnJ9UNrJuEJ1D6d6Wgt7casesiD6zOOxGktWca9Fxa5VqHpuaPHh3tLNeTLsaKEJ96hH4R3uKg==";
        };
        _73QrCM1R = {
            "id" = "73QrCM1R";
            "file" = "monkeylib538-paper-26.2-5.2.1+paper+26.2-all.jar";
            "hash" = "sha512-0XZlEmtZaduFN2MFYHYiEbtafJy0ynd0aKApMR/rFpE3dQBF+xYoL6tp8KcynbgDxqYrD5RcKy5xlyHjrkuLmg==";
        };
        _LZJXRsDl = {
            "id" = "LZJXRsDl";
            "file" = "monkeylib538-neoforge-26.1-5.2.1+neoforge+26.1.jar";
            "hash" = "sha512-QNyEQ2atgEjBaj1YiWwgGzMUQ9QNHE3aldX5glXs9H25zuMV2PNitx7lCWDZAGSOZAcknmaBR1Y/u62uh6CxSg==";
        };
        _yQHXxHBt = {
            "id" = "yQHXxHBt";
            "file" = "monkeylib538-neoforge-26.2-5.2.1+neoforge+26.2.jar";
            "hash" = "sha512-1kWYzMlnw5IQPz6FzxOah87DthvaurYaLzEDZUh36w0BNK/xTI1RkXhaP8UCS41yDzbC1M+rg9wyJ8vyCktd7w==";
        };
        _eMDC3wgp = {
            "id" = "eMDC3wgp";
            "file" = "monkeylib538-fabric-26.1-5.2.1+fabric+26.1.jar";
            "hash" = "sha512-KOT5Cm2a89YvZobYVyW4JRun6qq4rHUgRCyZJ9ttmMPDnLnEYx3D95S+vhE2I3nX4AXf6Cf4f6GxAqMMkfErsA==";
        };
        _HuJPFJuo = {
            "id" = "HuJPFJuo";
            "file" = "monkeylib538-fabric-26.2-5.2.1+fabric+26.2.jar";
            "hash" = "sha512-o+jf0YYMD6oX4qhMT3k8J0nopfSmhdl6u6ZpzWUuLwOrSabuVBu8/LxmIS4pCcfXu2NNi4mv26rk7gxS2TlrbQ==";
        };
        _puCR89cy = {
            "id" = "puCR89cy";
            "file" = "monkeylib538-paper-26.1-5.3.0+paper+26.1-all.jar";
            "hash" = "sha512-VZDEm4hG68fq+jm8wjQNV8d0O7A7rDbRA11vdSOV8jGAGN1r8S4T6QVum78BorrjLq7bG9ygCtLFREa8371H/Q==";
        };
        _4yhkuXLA = {
            "id" = "4yhkuXLA";
            "file" = "monkeylib538-neoforge-26.2-5.3.0+neoforge+26.2.jar";
            "hash" = "sha512-ZHkQE76sIy3ktKcKFSw+FxTfhAeEecEkAc5OXFmNMz7WTfF6xRGgP48piSFvdnz5Zw9tywRUbesVFJQ2wjxcWQ==";
        };
        _BBUVC0hC = {
            "id" = "BBUVC0hC";
            "file" = "monkeylib538-paper-26.2-5.3.0+paper+26.2-all.jar";
            "hash" = "sha512-gT5yZurj7nEMODVBDm9JzdqUvqSw1yKA+Kd+NFxCfVSZUFu00om/MkPzErwQNNSSdi1OoLeC4ATxw/R5GwYhCw==";
        };
        _bWqeCV0T = {
            "id" = "bWqeCV0T";
            "file" = "monkeylib538-fabric-26.2-5.3.0+fabric+26.2.jar";
            "hash" = "sha512-qPp36YtW7P4RbsrCcWNoNuaESz35UfvlkvYYnJVyf3Lax5TCtMV3wSF22gyeRF4zHCDhfLuL3VXU6RF4UVuGvQ==";
        };
        _qfFjToNk = {
            "id" = "qfFjToNk";
            "file" = "monkeylib538-fabric-26.1-5.3.0+fabric+26.1.jar";
            "hash" = "sha512-CJXddJ4w4UOBFDCcb/klwRuRROaeA71lae7ff0ku1SRxMMB1669fE87aZeHpPwNT7caRNL1YN/EgnDeoLfxN1A==";
        };
        _Ga1z5tLP = {
            "id" = "Ga1z5tLP";
    ...
    in {
        ...
        "pkg-1.0.2" = _aBB35sMC;
        "pkg-1.1.0+1.20.2" = _qAJamqje;
        "pkg-1.1.0+1.20.4" = _naDzEWYe;
        "pkg-1.0.2+1.20.4" = _K0rq8N7T;
        "pkg-1.3.0+1.20.4" = _nHFREkpC;
        "pkg-1.3.0+1.20.6" = _861C1VEc;
        "pkg-1.3.0+1.20.2" = _GUgFGTwN;
        "pkg-1.3.1+1.20.2" = _PwSVRfUx;
        "pkg-1.3.1+1.20.4" = _8hpohEf9;
        "pkg-1.3.1+1.20.6" = _KPYb4zN7;
        "pkg-2.0.0+1.20.6" = _7ElAdoSR;
        "pkg-2.0.0+1.20.1" = _Uwoh8L9g;
        "pkg-2.0.0+1.20.4" = _ettX0KXV;
        "pkg-2.0.0+1.20.2" = _i7aZhp20;
        "pkg-2.0.0+1.21" = _jo9i7saq;
        "pkg-2.0.1+1.20.6" = _I71DIPwV;
        "pkg-2.0.1+1.20.1" = _K1zgprPY;
        "pkg-2.0.1+1.20.4" = _Uir58T7M;
        "pkg-2.0.1+1.20.2" = _RAjY1tFs;
        "pkg-2.0.1+1.21" = _Oxqn9Y3t;
        "pkg-2.0.2+1.20.4" = _NuHvI9A9;
        "pkg-2.0.2+1.20.1" = _8u9M4JD9;
        "pkg-2.0.2+1.20.6" = _7FhcU0Hz;
        "pkg-2.0.2+1.20.2" = _gJauKzvM;
        "pkg-2.0.2+1.21" = _GVPrw18r;
        "pkg-3.0.0-alpha.2+1.21.9" = _9c0XcocO;
        "pkg-3.0.0-alpha.2+1.21.5" = _xDsro90x;
        "pkg-3.0.0-alpha.2+1.20.5" = _V3FY2Hbw;
        "pkg-3.0.0-alpha.3+1.21.9" = _P1gAjaVm;
        "pkg-3.0.0-alpha.3+1.21.5" = _NUhXQm90;
        "pkg-3.0.0-alpha.3+1.20.5" = _oySF6UIR;
        "pkg-3.0.0-beta.1+fabric+1.21.9" = _i9iX1FSf;
        "pkg-3.0.0-beta.1+fabric+1.20.1" = _44GYMCmR;
        "pkg-3.0.0-beta.1+fabric+1.21.11" = _drSft3Ci;
        "pkg-3.0.0-beta.1+neoforge+1.21" = _zNzuqI1l;
        "pkg-3.0.0-beta.1+neoforge+1.21.11" = _hQPZbLfB;
        "pkg-3.0.0-beta.1+neoforge+1.21.9" = _qZKmLinT;
        "pkg-3.0.0-beta.2+fabric+1.21" = _aHUiNs8C;
        "pkg-3.0.0-beta.2+fabric+1.20.1" = _iFZVeJu4;
        "pkg-3.0.0-beta.2+fabric+1.21.11" = _cr2pcFYq;
        "pkg-3.0.0-beta.2+fabric+1.21.9" = _nC0DmziZ;
        "pkg-3.0.0-beta.2+neoforge+1.21" = _cWHxaJvF;
        "pkg-3.0.2+fabric+1.21.1" = _KLKjpIXT;
        "pkg-3.0.2+fabric+1.21.9" = _6l5EyQMB;
        "pkg-3.0.2+neoforge+1.21.1" = _XJOFIZGt;
        "pkg-3.0.2+fabric+1.21.11" = _twsdjFm8;
        "pkg-3.0.2+neoforge+1.21.11" = _YUhGQNZu;
        "pkg-3.0.2+neoforge+1.21.9" = _QM46DHhj;
        "pkg-3.0.2+paper+1.21.1" = _8vYwd0x4;
        "pkg-3.0.3+neoforge+1.21.1" = _AZxGGTat;
        "pkg-3.0.3+fabric+1.21.1" = _MtfEQZoM;
        "pkg-3.0.3+fabric+1.21.11" = _8JcxR5F4;
        "pkg-3.0.3+fabric+1.21.9" = _pyH7TU4b;
        "pkg-3.0.3+neoforge+1.21.11" = _KIbQpOgv;
        "pkg-3.0.3+neoforge+1.21.9" = _aDCjsZRm;
        "pkg-3.0.3+paper+1.21.1" = _IF6gPZUQ;
        "pkg-3.1.0+neoforge+1.21.2" = _f6O9UeJQ;
        "pkg-3.1.0+neoforge+1.21.9" = _I2b5BZXj;
        "pkg-3.1.0+paper+1.21.1" = _UcC7vfCU;
        "pkg-3.1.0+neoforge+1.21.1" = _j2Ejh70F;
        "pkg-3.1.0+neoforge+1.21.11" = _gU0DNCsi;
        "pkg-3.1.0+fabric+1.21.1" = _TmI9aeOF;
        "pkg-3.1.0+fabric+1.21.2" = _YNJImi4f;
        "pkg-3.1.0+fabric+1.21.9" = _EG6Hkmo8;
        "pkg-3.1.0+fabric+1.21.11" = _lQp7vwX4;
        "pkg-4.0.0+neoforge+26.1" = _t7j0wRac;
        "pkg-4.0.0+fabric+26.1" = _XNN0NZCA;
        "pkg-4.0.1+paper+26.1" = _bKY0FFri;
        "pkg-4.0.1+neoforge+26.1" = _VO6cYTu8;
        "pkg-4.0.1+fabric+26.1" = _nRrNqvwM;
        "pkg-3.0.0-beta.2+java17+1.20.1" = _D16Aqe6Q;
        "pkg-5.0.0+paper+26.2" = _ae2PUPHo;
        "pkg-5.0.0+neoforge+26.2" = _KmD2qeDQ;
        "pkg-5.0.0+paper+26.1" = _Mp7HTPEf;
        "pkg-5.0.0+fabric+26.1" = _M1J0EyJg;
        "pkg-5.0.0+neoforge+26.1" = _LD40MSyr;
        "pkg-5.0.0+fabric+26.2" = _LDdUWGZa;
        "pkg-5.1.0+neoforge+26.2" = _frZLH2ct;
        "pkg-5.1.0+paper+26.2" = _6515N7Cm;
        "pkg-5.1.0+paper+26.1" = _PutxYx2v;
        "pkg-5.1.0+neoforge+26.1" = _XA8DSv8N;
        "pkg-5.1.0+fabric+26.2" = _xh0VfMWS;
        "pkg-5.1.0+fabric+26.1" = _9v7Th3VR;
        "pkg-5.1.1+paper+26.2" = _pSBCZaAp;
        "pkg-5.1.1+neoforge+26.1" = _vZtvJ8UD;
        "pkg-5.1.1+fabric+26.2" = _eOiV4TZF;
        "pkg-5.1.1+paper+26.1" = _ilfYZ6Uf;
        "pkg-5.1.1+neoforge+26.2" = _IJ8hh20s;
        "pkg-5.1.1+fabric+26.1" = _qOpbN0kE;
        "pkg-5.1.2+paper+26.2" = _1aYI7hOo;
        "pkg-5.1.2+paper+26.1" = _XUg4R3Km;
        "pkg-5.1.2+neoforge+26.2" = _g29Xq5Jm;
        "pkg-5.1.2+neoforge+26.1" = _uwyWvozz;
        "pkg-5.1.2+fabric+26.1" = _3WiQqGKK;
        "pkg-5.1.2+fabric+26.2" = _hBDl5NKg;
        "pkg-5.2.0+paper+26.2" = _Byleeqtj;
        "pkg-5.2.0+paper+26.1" = _opRVaw8c;
        "pkg-5.2.0+fabric+26.1" = _L7zF7QAz;
        "pkg-5.2.0+neoforge+26.2" = _hwY1fSWe;
        "pkg-5.2.0+fabric+26.2" = _E3cim4xn;
        "pkg-5.2.0+neoforge+26.1" = _k2f3L5V2;
        "pkg-5.2.1+paper+26.1" = _W7eM5uq6;
        "pkg-5.2.1+paper+26.2" = _73QrCM1R;
        "pkg-5.2.1+neoforge+26.1" = _LZJXRsDl;
        "pkg-5.2.1+neoforge+26.2" = _yQHXxHBt;
        "pkg-5.2.1+fabric+26.1" = _eMDC3wgp;
        "pkg-5.2.1+fabric+26.2" = _HuJPFJuo;
        "pkg-5.3.0+paper+26.1" = _puCR89cy;
        "pkg-5.3.0+neoforge+26.2" = _4yhkuXLA;
        "pkg-5.3.0+paper+26.2" = _BBUVC0hC;
