...
let
    ...
    in {
        ...
        "pkg-2.03" = _c6Z8TEXH;
        "pkg-2.04" = _2X19O8E5;
        "pkg-2.04.1" = _KPans7PN;
        "pkg-2.04+1.21.1" = _M8bmhHfW;
        "pkg-2.05+1.21.1" = _LeQsZ9Fj;
        "pkg-2.06+1.21.1" = _GS8qwfaZ;
        "pkg-2.06" = _v5cayPrX;
        "pkg-2.07+1.21.1" = _zzmWdgnT;
        "pkg-2.07" = _bdJDC6ub;
        "pkg-2.08+1.21.1" = _jG0MUcZv;
        "pkg-2.08" = _3zTWYZaf;
        "pkg-2.09+1.21.1" = _sfMgkEyX;
        "pkg-2.09" = _x4KMBURw;
        "pkg-2.10+1.21.1" = _vw859aFn;
        "pkg-2.10" = _iN2WBKPR;
        "pkg-2.11" = _WR6iu5PW;
