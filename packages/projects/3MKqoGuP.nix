...
let
    versions = (let
        ...
        _YBXb6O4t = {
            "id" = "YBXb6O4t";
            "file" = "rogues-fabric-3.1.1+1.20.1.jar";
            "hash" = "sha512-gBdxNnpjbZMRdGUi59fM+lpZ6ooVPXACwwerJpfUg837gVTuE1v2ELgh8IwdbVuVztQYqSfyzVFeXTL6qnerrg==";
        };
        _MUUnGayh = {
            "id" = "MUUnGayh";
    ...
    in {
        ...
        "pkg-1.0.5+1.20.1" = _jXP1teJy;
        "pkg-1.0.6+1.20.1" = _r3W2ltdb;
        "pkg-1.0.7+1.20.1" = _7Nf408na;
        "pkg-1.0.8+1.20.1" = _nR5fpBFj;
        "pkg-1.0.9+1.20.1" = _NwGoBPZx;
        "pkg-1.1.0+1.20.1" = _Zv9heBzC;
        "pkg-2.0.0+1.21.1" = _plWEVjo6;
        "pkg-2.0.1+1.21.1" = _OYSwkHb3;
        "pkg-2.1.0+1.21.1" = _uUukxUSN;
        "pkg-2.2.0+1.21.1" = _FZfhysO9;
        "pkg-2.2.1+1.21.1" = _PDKKbj77;
        "pkg-2.2.2+1.21.1" = _XNajW1op;
        "pkg-2.2.3+1.21.1" = _fjtMwyVO;
        "pkg-2.2.4+1.21.1" = _zfwYwcei;
        "pkg-1.2.0+1.20.1" = _ONjutVUi;
        "pkg-2.3.0+1.21.1" = _FXEW5pvx;
        "pkg-2.4.0+1.21.1" = _UzDTsJuy;
        "pkg-2.4.1+1.21.1" = _TkbKNXx1;
        "pkg-2.4.2+1.21.1" = _IZtXICpZ;
        "pkg-2.4.3+1.21.1" = _TgMR6BrH;
        "pkg-2.4.4+1.21.1" = _KsMDvz1W;
        "pkg-2.4.5+1.21.1" = _dWVRG7nU;
        "pkg-2.4.6+1.21.1" = _i9svydZV;
        "pkg-2.4.7+1.21.1" = _x9C8zUmF;
        "pkg-2.4.8+1.21.1" = _ORMy0l29;
        "pkg-2.4.9+1.21.1" = _JAV0CPpO;
        "pkg-2.4.10+1.21.1" = _nuCWrC80;
        "pkg-2.5.0+1.21.1" = _MxyWiejg;
        "pkg-2.5.1+1.21.1" = _4acS6GTZ;
        "pkg-2.5.2+1.21.1" = _6g1Bb7GJ;
        "pkg-2.5.3+1.21.1" = _zgr4ixT1;
        "pkg-2.6.0+1.21.1-fabric" = _MZJZPzkR;
        "pkg-2.6.0+1.21.1-neoforge" = _y9AuKRHQ;
        "pkg-2.6.1+1.21.1-fabric" = _eKuNe9mi;
        "pkg-2.6.1+1.21.1-neoforge" = _bFDKnG7t;
        "pkg-2.6.2+1.21.1-fabric" = _zFbJBztv;
        "pkg-2.6.2+1.21.1-neoforge" = _w1j44o52;
        "pkg-2.6.3+1.21.1-neoforge" = _5RucVMCQ;
        "pkg-2.6.3+1.21.1-fabric" = _DchIWMXX;
        "pkg-2.6.4+1.21.1-neoforge" = _oc0Z98i9;
        "pkg-2.6.4+1.21.1-fabric" = _DWWYl1qC;
        "pkg-2.7.0+1.21.1-fabric" = _WdhGYkfY;
        "pkg-2.7.0+1.21.1-neoforge" = _jJOQJfFo;
        "pkg-3.0.0+1.21.1-fabric" = _dOvIeuqf;
        "pkg-3.0.0+1.21.1-neoforge" = _xbW0st7R;
        "pkg-3.0.1+1.21.1-fabric" = _Xq6sQsmo;
        "pkg-3.0.1+1.21.1-neoforge" = _mytNOwPe;
        "pkg-3.0.2+1.21.1-fabric" = _1H2tzYiZ;
        "pkg-3.0.2+1.21.1-neoforge" = _4tgpSpG3;
        "pkg-3.0.3+1.21.1-fabric" = _951UCe4q;
