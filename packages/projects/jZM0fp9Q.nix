...
let
    versions = (let
        ...
        _eL9owlE1 = {
            "id" = "eL9owlE1";
            "file" = "MB-3D Items Pack 2.4.0.zip";
            "hash" = "sha512-JbIEH+UyeX2JmfwUlRsEnw3Kx9FuFgO24yjLWTVn+LuLlj2qeiA3Y136L1pskI//PB4wWywsBoExR7Vya52hFQ==";
        };
    in {
        "ZjRhtbm0" = _ZjRhtbm0;
        "ex9ZZr9c" = _ex9ZZr9c;
        ...
        "minecraft-1.20.2" = _eL9owlE1;
        "minecraft-1.20.3" = _eL9owlE1;
        "minecraft-1.20.4" = _eL9owlE1;
        "minecraft-1.20.5" = _eL9owlE1;
        "minecraft-1.20.6" = _eL9owlE1;
        "minecraft-1.21" = _eL9owlE1;
        "minecraft-1.21.1" = _eL9owlE1;
        "minecraft-1.21.2" = _eL9owlE1;
        "minecraft-1.21.3" = _eL9owlE1;
        "minecraft-1.21.4" = _eL9owlE1;
        "minecraft-1.21.5" = _eL9owlE1;
        "minecraft-1.21.6" = _eL9owlE1;
        "minecraft-1.21.7" = _eL9owlE1;
        "minecraft-1.21.8" = _eL9owlE1;
        "minecraft-1.21.9" = _eL9owlE1;
        "minecraft-1.21.10" = _eL9owlE1;
        "minecraft-1.21.11" = _eL9owlE1;
        "minecraft-26.1" = _eL9owlE1;
        "minecraft-26.1.1" = _eL9owlE1;
        "minecraft-26.1.2" = _eL9owlE1;
        "minecraft-26.2" = _eL9owlE1;
        "minecraft-23w31a" = _eL9owlE1;
        "minecraft-23w32a" = _eL9owlE1;
        "minecraft-23w33a" = _eL9owlE1;
        "minecraft-23w35a" = _eL9owlE1;
        "minecraft-1.20.2-pre1" = _eL9owlE1;
        "minecraft-23w42a" = _eL9owlE1;
        "minecraft-23w43a" = _eL9owlE1;
        "minecraft-23w43b" = _eL9owlE1;
        "minecraft-23w44a" = _eL9owlE1;
        "minecraft-23w45a" = _eL9owlE1;
        "minecraft-23w46a" = _eL9owlE1;
        "minecraft-24w03a" = _eL9owlE1;
        "minecraft-24w03b" = _eL9owlE1;
        "minecraft-24w04a" = _eL9owlE1;
        "minecraft-24w05a" = _eL9owlE1;
        "minecraft-24w05b" = _eL9owlE1;
        "minecraft-24w06a" = _eL9owlE1;
        "minecraft-24w07a" = _eL9owlE1;
        "minecraft-24w09a" = _eL9owlE1;
        "minecraft-24w10a" = _eL9owlE1;
        "minecraft-24w11a" = _eL9owlE1;
        "minecraft-24w12a" = _eL9owlE1;
        "minecraft-24w13a" = _eL9owlE1;
        "minecraft-24w14potato" = _eL9owlE1;
        "minecraft-24w14a" = _eL9owlE1;
        "minecraft-1.20.5-pre1" = _eL9owlE1;
        "minecraft-1.20.5-pre2" = _eL9owlE1;
        "minecraft-1.20.5-pre3" = _eL9owlE1;
        "minecraft-24w18a" = _eL9owlE1;
        "minecraft-24w19a" = _eL9owlE1;
        "minecraft-24w19b" = _eL9owlE1;
        "minecraft-24w20a" = _eL9owlE1;
        "minecraft-24w33a" = _eL9owlE1;
        "minecraft-24w34a" = _eL9owlE1;
        "minecraft-24w35a" = _eL9owlE1;
        "minecraft-24w36a" = _eL9owlE1;
        "minecraft-24w37a" = _eL9owlE1;
        "minecraft-24w38a" = _eL9owlE1;
        "minecraft-24w39a" = _eL9owlE1;
        "minecraft-24w40a" = _eL9owlE1;
        "minecraft-1.21.2-pre1" = _eL9owlE1;
        "minecraft-1.21.2-pre2" = _eL9owlE1;
        "minecraft-24w44a" = _eL9owlE1;
        "minecraft-24w45a" = _eL9owlE1;
        "minecraft-24w46a" = _eL9owlE1;
        "minecraft-26.3" = _eL9owlE1;
        "pkg-1.0.0" = _ZjRhtbm0;
        "pkg-1.1.0" = _ex9ZZr9c;
        "pkg-1.2.0" = _rkAFAWTn;
        "pkg-1.3.2" = _Wzpth1vM;
