...
let
    versions = (let
        ...
        _GjoZXnU9 = {
            "id" = "GjoZXnU9";
            "file" = "NuclearCraft-1.21.1-1.3.0-rc3.jar";
            "hash" = "sha512-qt1zVpyLh4vdn4TBO56tfKGZHFe/Ao7DANtED/PmRVMjFoD9+Qm876sWIhgchTaBquho7Ht7rJxemdppM0iLMg==";
        };
        _kefJECnt = {
            "id" = "kefJECnt";
    ...
    in {
        ...
        "pkg-1.1.9" = _VaEfkgJa;
        "pkg-1.2.0" = _Jzrz9Kho;
        "pkg-1.2.1-rc" = _M0aMeBWs;
        "pkg-1.2.2-rc" = _mOZxDAlz;
        "pkg-1.2.3-rc" = _ivxu3nvk;
        "pkg-1.2.4-rc" = _LWa3Dz4O;
        "pkg-1.2.4-rc2" = _E7jHR2uO;
        "pkg-1.2.4-rc3" = _HntIahTa;
        "pkg-1.2.5-beta.1" = _NUYxhd0H;
        "pkg-1.0.0.beta.3" = _ekhFvgjM;
        "pkg-1.2.5-beta.2" = _vhgHcZdY;
        "pkg-1.2.5-rc1" = _qgvPPUNe;
        "pkg-1.2.6-beta.3" = _jDAl3Qx2;
        "pkg-1.2.6-beta.10" = _V0n8seK1;
        "pkg-1.2.6-rc.4" = _KkROYjC7;
        "pkg-1.2.6-rc.7" = _VxiLnPCp;
        "pkg-1.2.6-rc.10" = _8ERh93np;
        "pkg-1.2.6" = _hGlnm15l;
        "pkg-1.2.8" = _CZ6WjV33;
        "pkg-1.2.9" = _6SLggR2k;
        "pkg-1.2.11" = _uEoKEpsk;
        "pkg-1.2.15" = _Ob93EhCA;
        "pkg-1.2.16" = _5fz6KqRo;
        "pkg-1.2.17" = _PBjcfvwy;
        "pkg-1.2.18" = _nUYKqXAL;
        "pkg-1.2.19" = _hkNQWbdO;
        "pkg-1.2.20" = _Nk0iAyvT;
        "pkg-1.2.21" = _ShC9om10;
        "pkg-1.2.22" = _3kucS8BH;
        "pkg-1.2.23" = _AujGcTDp;
        "pkg-1.2.24" = _fj6SG0hU;
        "pkg-1.2.25" = _wcS0tht6;
        "pkg-1.2.26" = _DsdS7YhJ;
        "pkg-1.2.28-beta1" = _MrY7T6IH;
        "pkg-1.2.28-beta3" = _6pvRuCvB;
        "pkg-1.2.28-beta4" = _LeOAGFno;
        "pkg-1.2.28-beta5" = _CXyHtDw4;
        "pkg-1.2.28-beta6" = _FIUAgWPM;
        "pkg-1.2.29" = _hCG6J8K8;
        "pkg-1.3.0-alpha3" = _As6L6rqH;
        "pkg-1.3.0-alpha4" = _SGk1ASky;
