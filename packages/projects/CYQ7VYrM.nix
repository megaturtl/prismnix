...
let
    ...
    in {
        ...
        "pkg-1.0.3" = _8zaBXRSq;
        "pkg-1.0.4" = _vY1J52zt;
        "pkg-1.0.5-1.19" = _WP1jM37I;
        "pkg-1.0.5-1.20" = _NvibFzvt;
        "pkg-1.0.6-1.19" = _1y0Es6FC;
        "pkg-1.0.7-1.19" = _qlRoza1D;
        "pkg-1.0.6.9-1.20" = _46ewnQQR;
        "pkg-1.1.0-1.19" = _t5emrqsG;
        "pkg-1.1.0-1.19-fabric" = _hqiDs6qH;
        "pkg-1.1.0-1.19-fabric-cv" = _HjoGii6q;
        "pkg-1.1.0-1.20-1.20.4-CV" = _rJheG2M2;
        "pkg-1.1.0-1.20.5-1.20.6-fabric" = _ZvK3Zy9d;
        "pkg-1.1.0-1.20.6" = _GCsIvEx7;
        "pkg-1.1.1-1.20-1.20.4-fabric" = _RvpSh1U3;
        "pkg-1.1.2-1.20-1.20.4-fabric" = _2ICELYpp;
        "pkg-1.1.3-1.20-1.20.4-fabric" = _vQHd7Fyv;
        "pkg-1.1.4-1.20-1.20.4" = _lXbI8mQP;
        "pkg-1.1.4-1.20-1.20.4-fabric" = _z7ktJZJS;
        "pkg-1.1.4-1.20-1.20.4-neo" = _KkPHHUaj;
        "pkg-1.1.4-1.20.1-neo" = _vJcrrKz0;
        "pkg-1.1.5-1.20-1.20.4" = _aySWRfHs;
        "pkg-1.1.5-1.20-1.20.4-fabric" = _errurZaf;
        "pkg-1.1.6-1.21x" = _xhpnRgM3;
        "pkg-1.1.5-1.21x-neo" = _c9zyR2XK;
        "pkg-1.1.7-1.20-1.20.4-fabric" = _IcnCjn9k;
        "pkg-1.2.0-1.20-1.20.1" = _gzkrqO46;
        "pkg-1.2.1-1.20-1.20.1" = _4cu2A0Wi;
        "pkg-1.2.1.2-1.20.2" = _MrCShMsc;
        "pkg-1.2.1.2-1.20-1.20.1" = _7Tvf1GHt;
        "pkg-1.2.2-1.20-1.20.1" = _dMYxJUuR;
        "pkg-1.2.3-1.20-1.20.1-fabric" = _1i9JiY3W;
        "pkg-1.2.3-1.20.2-fabric" = _g99Doc4p;
        "pkg-1.2.3.1-1.20-1.20.1" = _Iub0HzrG;
        "pkg-1.2.3.1-1.20-1.20.1-fabric" = _A3h2DMEA;
        "pkg-1.2.4-1.20-1.20.1" = _cxmhdgak;
        "pkg-1.2.4-1.20-1.20.1-fabric" = _6SZgZIoc;
        "pkg-1.2.4-1.21-1.21.1-fabric" = _IqJ0kvYv;
        "pkg-1.2.5-1.21-1.21.2-fabric" = _jBVWlX7U;
        "pkg-1.2.5-1.21.2-1.21.4-fabric" = _OdLaiqqu;
        "pkg-1.2.6-1.21-1.21.1-fabric" = _uZHSYtu4;
        "pkg-1.2.7-1.21-1.21.1-fabric" = _HMc8AkfT;
        "pkg-1.3.0-1.20-1.20.1-forge" = _yGMP6HI9;
        "pkg-1.3.1-1.20-1.20.1-forge" = _UQPoMglb;
        "pkg-1.3.1-1.20.3-1.20.4-forge" = _OxSGCN2k;
        "pkg-1.3.1-1.21-1.21.1-fabric" = _7s4JtEHc;
        "pkg-1.3.1-1.21.2-1.21.4-fabric" = _oxHtEVGO;
        "pkg-1.3.1.1-1.21-1.21.1-fabric" = _j1CEljoA;
        "pkg-1.3.2-1.21-1.21.1-neo" = _Ljldqqcx;
        "pkg-1.3.1.1-1.21.5-fabric" = _Q1nCwlHB;
        "pkg-1.3.2-1.21.2-1.21.4-neo" = _qQcmQcSD;
        "pkg-1.3.3-1.20-1.20.1-forge" = _d7LJjg6J;
        "pkg-1.3.4-1.20-1.20.1-forge" = _kiUOSy6E;
        "pkg-1.3.4.1-1.20-1.20.1-forge" = _hzpEEZ7H;
        "pkg-1.3.5-1.20-1.20.1-forge" = _C8Nh7OYF;
        "pkg-1.3.6-1.21.6-1.21.8-fabric" = _8w370z7x;
        "pkg-1.3.7-1.21-1.21.1-fabric" = _JBQik5gJ;
        "pkg-1.3.7.1-1.20-1.20.1-fabric" = _xAoUP27h;
        "pkg-1.4-1.21-1.21.1-fabric" = _UgU8fBMM;
        "pkg-1.4.1-1.21-1.21.1-fabric" = _3FRPgZXp;
        "pkg-1.4.2-1.21-1.21.1" = _lHRRMuPs;
        "pkg-1.4.3-1.21-1.21.1-fabric" = _HL3r2VlG;
        "pkg-1.4.4-1.21.11-fabric" = _Oqc7ToJf;
        "pkg-1.3.5S-1.20.1-forge" = _TNuBmU2P;
