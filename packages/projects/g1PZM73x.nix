...
let
    ...
    in {
        ...
        "pkg-1.21.4-v1.0.3" = _6AT0c6MG;
        "pkg-1.21.4-v1.0.4" = _ppNSj3gI;
        "pkg-1.21.4-v1.0.5" = _WMoEwQ0K;
        "pkg-1.21.4-v1.1.0" = _epmGiao3;
        "pkg-1.21.4-v1.1.1" = _VIUr35Pv;
        "pkg-1.21.4-v1.1.2" = _4qltxdcA;
        "pkg-1.21.4-v1.1.3" = _IpYOKNly;
        "pkg-1.21.4-v1.2.0" = _tfC1xLrS;
        "pkg-1.21.5-v1.2.1" = _DotDoizC;
        "pkg-1.21.5-v1.2.2" = _pYcUZLs8;
        "pkg-1.21.5-v1.3.0" = _tSTVndab;
        "pkg-1.21.5-v1.3.1" = _5fDxZ2uU;
        "pkg-1.21.5-v1.4.0" = _obFj9GMn;
        "pkg-1.21.5-v1.4.1" = _EWPrpiUj;
        "pkg-1.21.5-v1.4.2" = _fDOKiw6X;
        "pkg-1.21.5-v2.0.0" = _V2WGOTVd;
        "pkg-1.21.5-v2.0.1" = _Asaj2mgB;
        "pkg-1.21.5-v2.0.2" = _TgVkziDz;
        "pkg-1.21.5-v2.0.3" = _buB1g5t6;
        "pkg-1.21.5-v2.0.4" = _uVytNIBF;
        "pkg-1.21.5-v2.0.5" = _HG6WTqVI;
        "pkg-1.21.5-v2.0.6" = _lw1WNilW;
        "pkg-1.21.5-v2.0.7" = _Ln7lB7SJ;
        "pkg-1.21.5-v2.0.8" = _Lzp24eqz;
        "pkg-1.21.5-v2.0.9" = _AxB2gcuX;
        "pkg-1.21.5-v2.0.10" = _7jKeEfci;
        "pkg-1.21.5-v2.0.11" = _1LGwioRq;
        "pkg-1.21.5-v2.1.0" = _2ZQq7guZ;
        "pkg-1.21.5-v2.1.1" = _xHUXrOQy;
        "pkg-1.21.5-v2.1.2" = _CXwWRACw;
        "pkg-1.21.11-v2.2.0" = _mrvySyCJ;
        "pkg-1.21.11-v2.2.1" = _mHIRmgXc;
        "pkg-1.21.11-v2.2.2" = _zbXRZ5Hj;
        "pkg-1.21.5-v2.1.3" = _BxeLZ28v;
        "pkg-1.21.11-v2.3.0" = _2OUc2X92;
        "pkg-1.21.11-v2.3.1" = _V8rqba6h;
        "pkg-1.21.1-v2.3.1" = _PiaBuZ7M;
        "pkg-1.21.1-v2.3.2" = _QuErDX0J;
        "pkg-1.21.11-v2.3.2" = _8HBXS3RU;
        "pkg-1.21.11-v2.3.3" = _kv3qQizm;
        "pkg-1.21.11-v2.3.4" = _ZLJjTZPT;
        "pkg-1.21.11-v2.3.5" = _szJ3sNxY;
        "pkg-1.21.1-v2.3.3" = _w4YEWrNE;
        "pkg-1.21.1-v2.3.4" = _UOWTU6vg;
        "pkg-1.21.11-v2.3.6" = _FCbwlSdD;
        "pkg-1.21.11-v2.3.7" = _NZGpIDfr;
        "pkg-1.21.11-v2.3.8" = _6DJAKq0E;
        "pkg-1.21.11-v2.3.9" = _wnwILEWy;
        "pkg-1.21.11-v2.3.10" = _QbS89OAC;
        "pkg-1.21.11-v2.4.0" = _XkufILJ6;
        "pkg-1.21.11-v2.4.1" = _d8e4kMNH;
        "pkg-1.21.11-v2.4.3" = _v9ONyeB7;
        "pkg-1.21.1-v2.3.5" = _5IE0Uchb;
        "pkg-1.21.4-v1.2.1" = _SBTagDmo;
        "pkg-1.21.5-v2.1.4" = _QCdwrUSA;
        "pkg-1.21.11-v2.4.4" = _b47t17tC;
        "pkg-1.21.11-v2.4.5" = _sIKcYPTX;
        "pkg-1.21.11-v2.4.6" = _HgrukXs3;
        "pkg-1.21.1-v2.3.6" = _F0PKULhv;
        "pkg-1.21.11-v2.4.7" = _qrEnAGhB;
        "pkg-1.21.11-v2.4.8" = _9RiDcrdI;
        "pkg-1.21.1-v2.3.7" = _2z3flpjG;
        "pkg-1.21.5-v2.1.5" = _bMBIrhaX;
        "pkg-1.21.11-v2.4.9" = _VI3Kz9vn;
        "pkg-26.1-r1.0-neoforge" = _IQrm868R;
        "pkg-26.1-r1.0-fabric" = _l6me17Zn;
        "pkg-26.1-r1.1-neoforge" = _K4YkjigU;
        "pkg-26.1-r1.1-fabric" = _fDoMUsjH;
        "pkg-26.1-r1.2-neoforge" = _eLEBuH4R;
        "pkg-26.1-r1.2-fabric" = _QKMjCre5;
        "pkg-26.1-r1.2.1-neoforge" = _wrqb7bJi;
        "pkg-26.1-r1.2.1-fabric" = _iNiLhVtJ;
        "pkg-26.1-r1.3-neoforge" = _OVpBWqz0;
        "pkg-26.1-r1.3-fabric" = _CJICmD97;
        "pkg-26.1-r1.4-neoforge" = _mImNjEJS;
        "pkg-26.1-r1.4-fabric" = _WZHGZvpS;
        "pkg-26.1-r1.4.1-neoforge" = _8fQ3Cshx;
