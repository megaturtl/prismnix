...
let
    versions = (let
        ...
        _zEvKKuz2 = {
            "id" = "zEvKKuz2";
            "file" = "SPBR-21_1.zip";
            "hash" = "sha512-3Yo01b9Cg4R73p7ph8LakBT+MECcIM3cZ2s+O2G5O21R+jtgFXd8zrmaII2BlqGJG8KMfPCsFtwW7pNPE17TlA==";
        };
        _sIjZ5a66 = {
            "id" = "sIjZ5a66";
            "file" = "SPBR-18_8[Legacy].zip";
            "hash" = "sha512-+yS/7x90hJP3I8r/QxGLckr/ohDAPdA3Wb5ir0z3hdUsabCZTUST6DWkAGlHmrDxZFhAdv4iqb5nMFXAnXA2zw==";
        };
        _3s2tJ0xX = {
            "id" = "3s2tJ0xX";
            "file" = "SPBR-21_2.zip";
            "hash" = "sha512-Ym6o15XzMaBwUMRdy+pqQZTSwm2jV2+3I46a85ZnhAqlvyu+X/5vOubh8nYhYUOSGmXhdWNGy4TWFHYrKD23+Q==";
        };
        _cJwWApnt = {
            "id" = "cJwWApnt";
            "file" = "SPBR-22.zip";
    ...
    in {
        ...
        "minecraft-1.21.4" = _sIjZ5a66;
        "minecraft-1.21.5" = _sIjZ5a66;
        ...
        "pkg-17.4" = _PYKUu85P;
        "pkg-17.5" = _hPxVDZtd;
        "pkg-18-Legacy" = _tsy2oDl9;
        "pkg-18" = _GZb8Ew95;
        "pkg-18.1" = _j00cYf0k;
        "pkg-18.1-Legacy" = _9y5e1jlU;
        "pkg-18.2" = _tYuHk333;
        "pkg-18.2-Legacy" = _PACk5yQ4;
        "pkg-18.3" = _PR3DIxd6;
        "pkg-18.3-Legacy" = _H6Fua1hl;
        "pkg-18.4" = _fUHSnfcn;
        "pkg-18.4-Legacy" = _WF6wF3tJ;
        "pkg-18.5-1.21.9" = _fdBMlFsf;
        "pkg-18.5-Legacy" = _ShkgmzUK;
        "pkg-18.6-Legacy" = _r8R4vD12;
        "pkg-18.6" = _v4UQZd3s;
        "pkg-18.7-Legacy" = _sFhsXxz4;
        "pkg-18.7" = _UKz9Kto1;
        "pkg-18.8" = _xlnSBthu;
        "pkg-19" = _JhKKzGNP;
        "pkg-19.1" = _HNfULmBG;
