...
let
    ...
    in {
        ...
        "pkg-0.3" = _BKStrOoB;
        "pkg-0.4" = _uFnAhX4o;
        "pkg-1.0+1.21" = _z0D0HOQ5;
        "pkg-1.0-rc.1+1.21.2" = _Fl9OG1GX;
        "pkg-1.0+1.21.2" = _P60C7eq0;
        "pkg-1.0-rc.1+1.21.4" = _DwxpUMxi;
        "pkg-1.0+1.21.4" = _PkrxJ6nt;
        "pkg-1.1-rc.1+1.21.6" = _G5ls3EiK;
        "pkg-1.1-rc.2+1.21.6" = _jSS9POvp;
        "pkg-1.1+1.21.6" = _m2tWHqQR;
        "pkg-2.0+1.21.6" = _r4NpqhLm;
        "pkg-2.0+1.21.4" = _P3RSXw4a;
        "pkg-2.0+1.21.2" = _KFMUhwED;
        "pkg-2.0+1.21" = _JHbYB4pJ;
        "pkg-2.0+1.20.1" = _ho9AXXFt;
        "pkg-2.0.1+1.20.1" = _aP5ZSaoA;
        "pkg-3.0+1.21.4" = _WGW939VX;
        "pkg-3.0+1.21.2" = _R9Rt2kGB;
        "pkg-3.0+1.21" = _emxkbvxS;
