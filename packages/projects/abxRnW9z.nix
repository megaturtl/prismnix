...
let
    ...
    in {
        ...
        "pkg-forge-1.19.2-1.0.0" = _guBeajhD;
        "pkg-forge-1.19.3-1.0.0" = _WZ9N2Nml;
        "pkg-forge-1.19.3-1.0.1" = _YbzCSuff;
        "pkg-forge-1.19.3-1.0.2" = _Mq3pl9On;
        "pkg-forge-1.19.4-1.0.2" = _G22cDyq5;
        "pkg-forge-1.19.4-1.0.3" = _vBkVnNWM;
        "pkg-forge-1.20-1.0.3" = _ePDvR6kl;
        "pkg-forge-1.20.1-1.0.3" = _r9MT5eVm;
        "pkg-forge-1.20.2-1.0.4" = _cKKKTiG9;
        "pkg-neoforge-1.20.2-1.0.4" = _pNiaIj59;
        "pkg-neoforge-1.20.2-1.0.5" = _IWuiQiGc;
        "pkg-neoforge-1.20.3-1.0.5" = _jultoa6F;
        "pkg-neoforge-1.20.4-1.0.5" = _R3B65VnP;
        "pkg-forge-1.19.2-1.0.6" = _nk4iYE8s;
        "pkg-forge-1.20.1-1.0.6" = _r0yTj3Cw;
        "pkg-neoforge-1.20.4-1.0.6" = _UJcM8jFe;
        "pkg-forge-1.19.2-1.0.7" = _4YNTqHBs;
        "pkg-forge-1.20.1-1.0.7" = _5QnxJZml;
        "pkg-neoforge-1.20.4-1.0.7" = _IrB44N2C;
        "pkg-neoforge-1.20.4-1.0.8" = _a2ftfkVT;
        "pkg-forge-1.19.2-1.0.8" = _fMgz2fxA;
        "pkg-forge-1.20.1-1.0.8" = _xJE08WC5;
        "pkg-neoforge-1.20.5-1.0.8" = _dDEKKLQZ;
        "pkg-neoforge-1.20.6-1.0.8" = _nCFbf6oe;
        "pkg-neoforge-1.21-1.0.8" = _oUdXAo8F;
        "pkg-neoforge-1.21.1-1.0.8" = _2XDBotzI;
        "pkg-forge-1.19.2-1.0.9" = _LFNWaysw;
        "pkg-forge-1.20.1-1.0.9" = _ym9lPcTV;
        "pkg-neoforge-1.21.1-1.0.9" = _IyVz8P1V;
        "pkg-neoforge-1.21.2-1.0.9" = _KjZSr1fp;
        "pkg-neoforge-1.21.3-1.0.9" = _SV7ABbuA;
        "pkg-neoforge-1.21.4-1.0.9" = _hbdXyOz1;
        "pkg-neoforge-1.21.5-1.0.9" = _l2zwzTLv;
        "pkg-neoforge-1.21.6-1.0.9" = _BpP7nVjr;
        "pkg-neoforge-1.21.7-1.0.9" = _n7ASDyVF;
        "pkg-neoforge-1.21.7-1.0.10" = _k4u7HwAO;
        "pkg-neoforge-1.21.8-1.0.10" = _gCN1QDjL;
        "pkg-neoforge-1.21.9-1.0.10" = _JdOYTwqL;
        "pkg-neoforge-1.21.10-1.0.10" = _6oGDNgEw;
        "pkg-neoforge-1.21.11-1.0.10" = _VvSZBnkh;
        "pkg-neoforge-1.0.10+26.1" = _Av4Igpil;
