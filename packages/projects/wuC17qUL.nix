...
let
    ...
    in {
        ...
        "pkg-3.0.0-beta.15" = _C9rglanp;
        "pkg-3.0.0-beta.16" = _zopeOgzt;
        "pkg-3.0.0-beta.17" = _h7t8Nu8F;
        "pkg-3.0.0-beta.18" = _qvOp3BFJ;
        "pkg-3.0.0-beta.19" = _4MBtnhcR;
        "pkg-3.0.0-beta.20" = _L0VkauV2;
        "pkg-3.0.0-beta.21" = _cV8kp2r5;
        "pkg-3.0.0-beta.22" = _dTUWOlml;
        "pkg-3.0.0-beta.23" = _HUos8PXU;
        "pkg-3.0.0-beta.24" = _HDVCM9MY;
        "pkg-3.0.0-beta.25" = _I7IVBc7b;
        "pkg-3.0.0-beta.26" = _lJXE2WZf;
        "pkg-3.0.0-beta.27" = _JUjRg4bq;
        "pkg-3.0.0-beta.28" = _O0asZdlN;
        "pkg-3.0.0-beta.29" = _xLhlBzDS;
        "pkg-3.0.0-beta.30" = _UNQtjYVM;
        "pkg-3.0.0-beta.31" = _LG9ZL8u1;
        "pkg-2.2.2-1.8.9" = _k3wzkrIi;
