...
let
    versions = (let
        ...
        _n4diwc1t = {
            "id" = "n4diwc1t";
            "file" = "simple-datapacks-2.8-fabric+1.20.jar";
            "hash" = "sha512-udlomc0cYXIsxYCcu2X/y1Qg9r+HwW90IaQin1IBsJhpvxqxe7iRUqcyanckPIPXi1cbJ4oCW2+7nt6eD0tAzw==";
        };
        _yS6jh5YL = {
            "id" = "yS6jh5YL";
            "file" = "simple-datapacks-2.8-forge+1.20-srg.jar";
            "hash" = "sha512-DgwV0yD8lDcvCcPSk04jTSudBz5Jg1/5p1/QJxb4P7Cck+qGhAL+jaz5TzQshfx8T5i3A0Ot7sdogAAyrMDrrA==";
        };
        _r4pytsAA = {
            "id" = "r4pytsAA";
            "file" = "simple-datapacks-2.8-fabric+1.20.2.jar";
            "hash" = "sha512-wL29ipRebecF1Qaf9KZ9MXvIdu8gXg85DpO1E9uFWI8eLxLcIWmRwGUB+e33FF3M+1Ki1ixDp98/6l5IFrV8gA==";
        };
        _4m4AJZJe = {
            "id" = "4m4AJZJe";
            "file" = "simple-datapacks-2.8-forge+1.20.2-srg.jar";
            "hash" = "sha512-9BQnZ6wdvXuroWvmLmnASnrdqgPG2H9eBB5BnoFHupVc2wJIjsgJKzM1Wv03gYDSW83n4Ds7c0Fbc2WJDmNNpA==";
        };
        _ZodVZ2KA = {
            "id" = "ZodVZ2KA";
            "file" = "simple-datapacks-2.8-forge+1.20.6.jar";
            "hash" = "sha512-mboC3MkoX8XJlgMW87iHKy5n1nhl1clQM1c8ryravQsZV5W0r1HDM/3TYRPzMCM8yR/EyoMNcQ+/I5h42+TW2g==";
        };
        _M4A5j1dn = {
            "id" = "M4A5j1dn";
            "file" = "simple-datapacks-2.8-neoforge+1.21.jar";
            "hash" = "sha512-ckHCpHxzVnJoEJaKKYiRgp0Nmq6qsJNlOZeYhsAwLYqpudYivlzMeNd1KUghU+CMg8o+T7lm1MdUtgSAyWiXEQ==";
        };
        _LqAiROBF = {
            "id" = "LqAiROBF";
            "file" = "simple-datapacks-2.8-fabric+1.21.2.jar";
            "hash" = "sha512-eXt+y9aznrJh0NDdMObtUMcFzMEvILsx5s+b3ZwyXlfc9hyqRHwTXGyD/j80D3hTxL/7Siw5D8BzhMAs+NVCoQ==";
        };
        _BKbBO5Mq = {
            "id" = "BKbBO5Mq";
            "file" = "simple-datapacks-2.8-forge+1.21.2.jar";
            "hash" = "sha512-x7z3qOlUJ9IvsPX0ZeBoen6jtikOkLX7f1wItmdyvatOqauDzJFRFAjh6kOq9BO5Pbf5GeIyQa3hsqopm6UkYA==";
        };
        _59Mp6ujQ = {
            "id" = "59Mp6ujQ";
            "file" = "simple-datapacks-2.8-neoforge+1.21.2.jar";
            "hash" = "sha512-VY568yiRqjsijdD/m0HNksHKTUaFl0btJoXcF1tNay/dE7owvn/RqqSXoW8xwoFjo96M7oB5BvL3523unR9Zzg==";
        };
        _DYSdSixF = {
            "id" = "DYSdSixF";
            "file" = "simple-datapacks-2.8-forge+26.1.jar";
            "hash" = "sha512-RWzXcNhbdu3I01Kw39fLyD8y9RIIOA6a3HnJFAfiFNjzyMfKITcEwKONcgt6cvytjOP3k+xwv8sDZ3//WviAKw==";
        };
        _bPt1vPqF = {
            "id" = "bPt1vPqF";
            "file" = "simple-datapacks-2.8-fabric+26.1.jar";
            "hash" = "sha512-pjQBRoehGTKGrLgT6FhfDx0q6n7/G5cBRvTGhAvmPjBlV4gZEzta8Dn97lvjI9CVWQLT/wn6FlemPq7fMkRpNQ==";
        };
        _5NpMam1F = {
            "id" = "5NpMam1F";
            "file" = "simple-datapacks-2.8-neoforge+26.1.jar";
            "hash" = "sha512-63UoApBwvhoUdEXSfZ89EAjgY5/dljXEn2OulYTYQP2t0ToS7ysg1HlvdoU6j0Dy2KVWUh/teE/Fw3e6ms6neA==";
        };
        _VCBe7dy2 = {
            "id" = "VCBe7dy2";
            "file" = "simple-datapacks-2.8.1-fabric+1.20.jar";
            "hash" = "sha512-1wh/mWCFe37TY661htkKfmwkL1RHlo1Fc0z0hSa69TpK32Kip1sspJ5w1/kWXXLy5Ynm4OTm9s+3x1YuHlVMuA==";
        };
        _A32J0zEL = {
            "id" = "A32J0zEL";
            "file" = "simple-datapacks-2.8.1-forge+1.20-srg.jar";
            "hash" = "sha512-xTJ3QMDjG0SGnVdeslTjR0/MLXQaQmW+V5pxe6xvchCZn0nkL9xCw7bTzh/T4HdobH9jEDozVLzE9gGV4GeNmQ==";
        };
        _tFkQ4Ne6 = {
            "id" = "tFkQ4Ne6";
            "file" = "simple-datapacks-2.8.1-fabric+1.20.2.jar";
            "hash" = "sha512-JzDRbJF2OcuvXAktT9/shQkZN+WeI56Mcgp5d2M4wZVpeU34KIf+LRpEaiGjHfsa/EWpp+KfNzRdnZCVHanoMA==";
        };
        _o4erUNhX = {
            "id" = "o4erUNhX";
            "file" = "simple-datapacks-2.8.1-forge+1.20.2-srg.jar";
            "hash" = "sha512-d51eftLnppQt3GvVWsXDGJbvRVAUCSgXNKTNNIEJdYUWQcJevGB/JY81C9RbqA8T2ta8/oVaHy99db6pQbCoUA==";
        };
        _rjax5HyA = {
            "id" = "rjax5HyA";
            "file" = "simple-datapacks-2.8.1-forge+1.20.6.jar";
            "hash" = "sha512-wSHJi/fHBBVGrpbBYPya2PGlmIhLQpB/a18KGVkm/vwAlU/3qNBN3auCnYPLyyUURZZkFSZsWrzLlny1RnA6hg==";
        };
        _SfUT34Z8 = {
            "id" = "SfUT34Z8";
            "file" = "simple-datapacks-2.8.1-neoforge+1.21.jar";
            "hash" = "sha512-mo1ZMOaLoGf6oDyDsz4BRZCt4U/BAhauacZwVmg+RDkCS67TFLdPmrnU8XvgYXukFvc70hcEcwX5HMGL4diGLQ==";
        };
        _UGmybQoC = {
            "id" = "UGmybQoC";
            "file" = "simple-datapacks-2.8.1-fabric+1.21.2.jar";
            "hash" = "sha512-7DJEGNg92NxgGxlPTJgIKEiAYXam5LorUAKFSV+jJVvMC2tgnHe/HMVrzGqoaia3NQfaMZASAh/Kt0A+vsAPAQ==";
        };
        _UttH7Yuw = {
            "id" = "UttH7Yuw";
            "file" = "simple-datapacks-2.8.1-forge+1.21.2.jar";
            "hash" = "sha512-wV/WSeAgdCdq9OFWpk41ne3dKCgFlF4UwHNCxfs7yr3o6DSKBHDkmG0N5hpAO5UlE4z3Lt8jPP7vOO3kIJLqBg==";
        };
        _b2TO74Ai = {
            "id" = "b2TO74Ai";
            "file" = "simple-datapacks-2.8.1-neoforge+1.21.2.jar";
            "hash" = "sha512-/wMQ2CiAuJYwKo0gWVJKlLJIPdyGiIli/yO1BKCBbZ5+ek0ZtCd1T4AzhB2RhP8ZkSIELNCPfySInnq6UY2gNQ==";
        };
        _RG4tQVcb = {
            "id" = "RG4tQVcb";
            "file" = "simple-datapacks-2.8.1-forge+26.1.jar";
            "hash" = "sha512-udEeTJYqKwONu18+SsE5JkEUYHhFnkQVsa63KMf3UTPkKBsxdzDD++7WuGCgvqPXhHZ0s0P1H77LL5oQMyjp4A==";
        };
        _RzY5xfRi = {
            "id" = "RzY5xfRi";
            "file" = "simple-datapacks-2.8.1-fabric+26.1.jar";
            "hash" = "sha512-qUgqLaKhYioIgXlbj9A9+tas759SmxNeyadWu9sXRpRVj43qt57OB0pi6wtySaQE6NGMVvyiUTa+q97X9b9MBg==";
        };
        _Xkz0VhC3 = {
            "id" = "Xkz0VhC3";
            "file" = "simple-datapacks-2.8.1-neoforge+26.1.jar";
            "hash" = "sha512-r1N/IKQJu+32rx+IdhRw7sOu5IVcR67GAFjSFhpwV1p0+1Cj/B/JrCHWwxIeCeOL98eLp+R+wVkPp6y9LKrWhQ==";
        };
    in {
        "NKJSOtHL" = _NKJSOtHL;
        "QzuWiQDx" = _QzuWiQDx;
        ...
        "fabric-1.20" = _VCBe7dy2;
        "fabric-1.20.1-rc1" = _VCBe7dy2;
        "fabric-1.20.1" = _VCBe7dy2;
        "fabric-1.20.2" = _tFkQ4Ne6;
        "fabric-23w40a" = _tFkQ4Ne6;
        "fabric-23w41a" = _tFkQ4Ne6;
        "fabric-23w42a" = _tFkQ4Ne6;
        "fabric-23w43a" = _tFkQ4Ne6;
        "fabric-23w43b" = _tFkQ4Ne6;
        "fabric-23w44a" = _tFkQ4Ne6;
        "fabric-23w45a" = _tFkQ4Ne6;
        "fabric-23w46a" = _tFkQ4Ne6;
        "fabric-1.20.3-pre1" = _tFkQ4Ne6;
        "fabric-1.20.3-pre2" = _tFkQ4Ne6;
        "fabric-1.20.3-pre3" = _tFkQ4Ne6;
        "fabric-1.20.3-pre4" = _tFkQ4Ne6;
        "fabric-1.20.3-rc1" = _tFkQ4Ne6;
        "fabric-1.20.3" = _tFkQ4Ne6;
        "fabric-1.20.4-rc1" = _tFkQ4Ne6;
        "fabric-1.20.4" = _tFkQ4Ne6;
        "fabric-1.20.5" = _tFkQ4Ne6;
        "fabric-1.20.6-rc1" = _tFkQ4Ne6;
        "fabric-1.20.6" = _tFkQ4Ne6;
        "fabric-24w18a" = _tFkQ4Ne6;
        "fabric-24w19a" = _tFkQ4Ne6;
        "fabric-24w19b" = _tFkQ4Ne6;
        "fabric-24w20a" = _tFkQ4Ne6;
        "fabric-24w21a" = _tFkQ4Ne6;
        "fabric-24w21b" = _tFkQ4Ne6;
        "fabric-1.21-pre1" = _tFkQ4Ne6;
        "fabric-1.21-pre2" = _tFkQ4Ne6;
        "fabric-1.21-pre3" = _tFkQ4Ne6;
        "fabric-1.21-pre4" = _tFkQ4Ne6;
        "fabric-1.21-rc1" = _tFkQ4Ne6;
        "fabric-1.21" = _tFkQ4Ne6;
        "fabric-1.21.1-rc1" = _tFkQ4Ne6;
        "fabric-1.21.1" = _tFkQ4Ne6;
        ...
        "fabric-1.21.2" = _UGmybQoC;
        "fabric-1.21.3" = _UGmybQoC;
        "fabric-24w44a" = _UGmybQoC;
        "fabric-24w45a" = _UGmybQoC;
        "fabric-24w46a" = _UGmybQoC;
        "fabric-1.21.4-pre1" = _UGmybQoC;
        "fabric-1.21.4-pre2" = _UGmybQoC;
        "fabric-1.21.4-pre3" = _UGmybQoC;
        "fabric-1.21.4-rc1" = _UGmybQoC;
        "fabric-1.21.4-rc2" = _UGmybQoC;
        "fabric-1.21.4-rc3" = _UGmybQoC;
        "fabric-1.21.4" = _UGmybQoC;
        "fabric-25w02a" = _UGmybQoC;
        "fabric-25w03a" = _UGmybQoC;
        "fabric-25w04a" = _UGmybQoC;
        "fabric-25w05a" = _UGmybQoC;
        "fabric-25w06a" = _UGmybQoC;
        "fabric-25w07a" = _UGmybQoC;
        "fabric-25w08a" = _UGmybQoC;
        "fabric-25w09a" = _UGmybQoC;
        "fabric-25w09b" = _UGmybQoC;
        "fabric-25w10a" = _UGmybQoC;
        "fabric-1.21.5-pre1" = _UGmybQoC;
        "fabric-1.21.5-pre2" = _UGmybQoC;
        "fabric-1.21.5-pre3" = _UGmybQoC;
        "fabric-1.21.5-rc1" = _UGmybQoC;
        "fabric-1.21.5-rc2" = _UGmybQoC;
        "fabric-1.21.5" = _UGmybQoC;
        "fabric-25w14craftmine" = _UGmybQoC;
        "fabric-25w15a" = _UGmybQoC;
        "fabric-25w16a" = _UGmybQoC;
        "fabric-25w17a" = _UGmybQoC;
        "fabric-25w18a" = _UGmybQoC;
        "fabric-25w19a" = _UGmybQoC;
        "fabric-25w20a" = _UGmybQoC;
        "fabric-25w21a" = _UGmybQoC;
        "fabric-1.21.6-pre1" = _UGmybQoC;
        "fabric-1.21.6-pre2" = _UGmybQoC;
        "fabric-1.21.6-pre3" = _UGmybQoC;
        "fabric-1.21.6-pre4" = _UGmybQoC;
        "fabric-1.21.6-rc1" = _UGmybQoC;
        "fabric-1.21.6" = _UGmybQoC;
        "fabric-1.21.7-rc1" = _UGmybQoC;
        "fabric-1.21.7-rc2" = _UGmybQoC;
        "fabric-1.21.7" = _UGmybQoC;
        "fabric-1.21.8-rc1" = _UGmybQoC;
        "fabric-1.21.8" = _UGmybQoC;
        "fabric-1.21.9" = _UGmybQoC;
        "fabric-1.21.10" = _UGmybQoC;
        "fabric-1.21.10-rc1" = _UGmybQoC;
        "fabric-1.21.11" = _UGmybQoC;
        "fabric-25w41a" = _UGmybQoC;
        "fabric-25w42a" = _UGmybQoC;
        "fabric-25w43a" = _UGmybQoC;
        "fabric-25w44a" = _UGmybQoC;
        "fabric-25w45a" = _UGmybQoC;
        "fabric-25w46a" = _UGmybQoC;
        "fabric-1.21.11-pre1" = _UGmybQoC;
        "fabric-1.21.11-pre2" = _UGmybQoC;
        "fabric-1.21.11-pre3" = _UGmybQoC;
        "fabric-1.21.11-pre4" = _UGmybQoC;
        "fabric-1.21.11-pre5" = _UGmybQoC;
        "fabric-1.21.11-rc1" = _UGmybQoC;
        "fabric-1.21.11-rc2" = _UGmybQoC;
        "fabric-1.21.11-rc3" = _UGmybQoC;
        ...
        "fabric-26.1" = _RzY5xfRi;
        "fabric-26.1.1-rc-1" = _RzY5xfRi;
        "fabric-26.1.1" = _RzY5xfRi;
        "fabric-26w14a" = _RzY5xfRi;
        "fabric-26.1.2-rc-1" = _RzY5xfRi;
        "fabric-26.1.2" = _RzY5xfRi;
        "fabric-26.2" = _RzY5xfRi;
        "fabric-1.21.9-pre1" = _UGmybQoC;
        "fabric-1.21.9-pre2" = _UGmybQoC;
        "fabric-1.21.9-pre3" = _UGmybQoC;
        "fabric-1.21.9-pre4" = _UGmybQoC;
        "fabric-1.21.9-rc1" = _UGmybQoC;
        "fabric-1.20.5-pre1" = _tFkQ4Ne6;
        "fabric-1.20.5-pre2" = _tFkQ4Ne6;
        "fabric-1.20.5-pre3" = _tFkQ4Ne6;
        "fabric-1.20.5-pre4" = _tFkQ4Ne6;
        "fabric-1.20.5-rc1" = _tFkQ4Ne6;
        "fabric-1.20.5-rc2" = _tFkQ4Ne6;
        "fabric-1.20.5-rc3" = _tFkQ4Ne6;
        "fabric-25w31a" = _UGmybQoC;
        "fabric-25w32a" = _UGmybQoC;
        "fabric-25w33a" = _UGmybQoC;
        "fabric-25w34a" = _UGmybQoC;
        "fabric-25w34b" = _UGmybQoC;
        "fabric-25w35a" = _UGmybQoC;
        "fabric-25w36a" = _UGmybQoC;
        "fabric-25w36b" = _UGmybQoC;
        "fabric-25w37a" = _UGmybQoC;
        "fabric-23w51a" = _tFkQ4Ne6;
        "fabric-23w51b" = _tFkQ4Ne6;
        "fabric-24w03a" = _tFkQ4Ne6;
        "fabric-24w03b" = _tFkQ4Ne6;
        "fabric-24w04a" = _tFkQ4Ne6;
        "fabric-24w05a" = _tFkQ4Ne6;
        "fabric-24w05b" = _tFkQ4Ne6;
        "fabric-24w06a" = _tFkQ4Ne6;
        "fabric-24w07a" = _tFkQ4Ne6;
        "fabric-24w09a" = _tFkQ4Ne6;
        "fabric-24w10a" = _tFkQ4Ne6;
        "fabric-24w11a" = _tFkQ4Ne6;
        "fabric-24w12a" = _tFkQ4Ne6;
        "fabric-24w13a" = _tFkQ4Ne6;
        "fabric-24w14potato" = _tFkQ4Ne6;
        "fabric-24w14a" = _tFkQ4Ne6;
        ...
        "fabric-26.2-snapshot-1" = _RzY5xfRi;
        "fabric-26.2-snapshot-2" = _RzY5xfRi;
        "fabric-26.2-snapshot-3" = _RzY5xfRi;
        "fabric-26.2-snapshot-4" = _RzY5xfRi;
        "fabric-26.2-snapshot-5" = _RzY5xfRi;
        "fabric-26.2-snapshot-6" = _RzY5xfRi;
        "fabric-26.2-snapshot-7" = _RzY5xfRi;
        "fabric-26.2-snapshot-8" = _RzY5xfRi;
        "fabric-26.2-pre-1" = _RzY5xfRi;
        "fabric-26.2-pre-2" = _RzY5xfRi;
        "fabric-26.2-pre-3" = _RzY5xfRi;
        "fabric-26.2-pre-4" = _RzY5xfRi;
        "fabric-26.2-pre-5" = _RzY5xfRi;
        "fabric-26.2-pre-6" = _RzY5xfRi;
        "fabric-26.2-rc-1" = _RzY5xfRi;
        "fabric-26.2-rc-2" = _RzY5xfRi;
        ...
        "quilt-1.20" = _VCBe7dy2;
        "quilt-1.20.1-rc1" = _VCBe7dy2;
        "quilt-1.20.1" = _VCBe7dy2;
        "quilt-1.20.2" = _tFkQ4Ne6;
        "quilt-23w40a" = _tFkQ4Ne6;
        "quilt-23w41a" = _tFkQ4Ne6;
        "quilt-23w42a" = _tFkQ4Ne6;
        "quilt-23w43a" = _tFkQ4Ne6;
        "quilt-23w43b" = _tFkQ4Ne6;
        "quilt-23w44a" = _tFkQ4Ne6;
        "quilt-23w45a" = _tFkQ4Ne6;
        "quilt-23w46a" = _tFkQ4Ne6;
        "quilt-1.20.3-pre1" = _tFkQ4Ne6;
        "quilt-1.20.3-pre2" = _tFkQ4Ne6;
        "quilt-1.20.3-pre3" = _tFkQ4Ne6;
        "quilt-1.20.3-pre4" = _tFkQ4Ne6;
        "quilt-1.20.3-rc1" = _tFkQ4Ne6;
        "quilt-1.20.3" = _tFkQ4Ne6;
        "quilt-1.20.4-rc1" = _tFkQ4Ne6;
        "quilt-1.20.4" = _tFkQ4Ne6;
        "quilt-1.20.5" = _tFkQ4Ne6;
        "quilt-1.20.6-rc1" = _tFkQ4Ne6;
        "quilt-1.20.6" = _tFkQ4Ne6;
        "quilt-24w18a" = _tFkQ4Ne6;
        "quilt-24w19a" = _tFkQ4Ne6;
        "quilt-24w19b" = _tFkQ4Ne6;
        "quilt-24w20a" = _tFkQ4Ne6;
        "quilt-24w21a" = _tFkQ4Ne6;
        "quilt-24w21b" = _tFkQ4Ne6;
        "quilt-1.21-pre1" = _tFkQ4Ne6;
        "quilt-1.21-pre2" = _tFkQ4Ne6;
        "quilt-1.21-pre3" = _tFkQ4Ne6;
        "quilt-1.21-pre4" = _tFkQ4Ne6;
        "quilt-1.21-rc1" = _tFkQ4Ne6;
        "quilt-1.21" = _tFkQ4Ne6;
        "quilt-1.21.1-rc1" = _tFkQ4Ne6;
        "quilt-1.21.1" = _tFkQ4Ne6;
        ...
        "quilt-1.21.2" = _UGmybQoC;
        "quilt-1.21.3" = _UGmybQoC;
        "quilt-24w44a" = _UGmybQoC;
        "quilt-24w45a" = _UGmybQoC;
        "quilt-24w46a" = _UGmybQoC;
        "quilt-1.21.4-pre1" = _UGmybQoC;
        "quilt-1.21.4-pre2" = _UGmybQoC;
        "quilt-1.21.4-pre3" = _UGmybQoC;
        "quilt-1.21.4-rc1" = _UGmybQoC;
        "quilt-1.21.4-rc2" = _UGmybQoC;
        "quilt-1.21.4-rc3" = _UGmybQoC;
        "quilt-1.21.4" = _UGmybQoC;
        "quilt-25w02a" = _UGmybQoC;
        "quilt-25w03a" = _UGmybQoC;
        "quilt-25w04a" = _UGmybQoC;
        "quilt-25w05a" = _UGmybQoC;
        "quilt-25w06a" = _UGmybQoC;
        "quilt-25w07a" = _UGmybQoC;
        "quilt-25w08a" = _UGmybQoC;
        "quilt-25w09a" = _UGmybQoC;
        "quilt-25w09b" = _UGmybQoC;
        "quilt-25w10a" = _UGmybQoC;
        "quilt-1.21.5-pre1" = _UGmybQoC;
        "quilt-1.21.5-pre2" = _UGmybQoC;
        "quilt-1.21.5-pre3" = _UGmybQoC;
        "quilt-1.21.5-rc1" = _UGmybQoC;
        "quilt-1.21.5-rc2" = _UGmybQoC;
        "quilt-1.21.5" = _UGmybQoC;
        "quilt-25w14craftmine" = _UGmybQoC;
        "quilt-25w15a" = _UGmybQoC;
        "quilt-25w16a" = _UGmybQoC;
        "quilt-25w17a" = _UGmybQoC;
        "quilt-25w18a" = _UGmybQoC;
        "quilt-25w19a" = _UGmybQoC;
        "quilt-25w20a" = _UGmybQoC;
        "quilt-25w21a" = _UGmybQoC;
        "quilt-1.21.6-pre1" = _UGmybQoC;
        "quilt-1.21.6-pre2" = _UGmybQoC;
        "quilt-1.21.6-pre3" = _UGmybQoC;
        "quilt-1.21.6-pre4" = _UGmybQoC;
        "quilt-1.21.6-rc1" = _UGmybQoC;
        "quilt-1.21.6" = _UGmybQoC;
        "quilt-1.21.7-rc1" = _UGmybQoC;
        "quilt-1.21.7-rc2" = _UGmybQoC;
        "quilt-1.21.7" = _UGmybQoC;
        "quilt-1.21.8-rc1" = _UGmybQoC;
        "quilt-1.21.8" = _UGmybQoC;
        "quilt-1.21.9" = _UGmybQoC;
        "quilt-1.21.10" = _UGmybQoC;
        "quilt-1.21.10-rc1" = _UGmybQoC;
        "quilt-1.21.11" = _UGmybQoC;
        "quilt-25w41a" = _UGmybQoC;
        "quilt-25w42a" = _UGmybQoC;
        "quilt-25w43a" = _UGmybQoC;
        "quilt-25w44a" = _UGmybQoC;
        "quilt-25w45a" = _UGmybQoC;
        "quilt-25w46a" = _UGmybQoC;
        "quilt-1.21.11-pre1" = _UGmybQoC;
        "quilt-1.21.11-pre2" = _UGmybQoC;
        "quilt-1.21.11-pre3" = _UGmybQoC;
        "quilt-1.21.11-pre4" = _UGmybQoC;
        "quilt-1.21.11-pre5" = _UGmybQoC;
        "quilt-1.21.11-rc1" = _UGmybQoC;
        "quilt-1.21.11-rc2" = _UGmybQoC;
        "quilt-1.21.11-rc3" = _UGmybQoC;
        ...
        "quilt-26.1" = _RzY5xfRi;
        "quilt-26.1.1-rc-1" = _RzY5xfRi;
        "quilt-26.1.1" = _RzY5xfRi;
        "quilt-26w14a" = _RzY5xfRi;
        "quilt-26.1.2-rc-1" = _RzY5xfRi;
        "quilt-26.1.2" = _RzY5xfRi;
        "quilt-26.2" = _RzY5xfRi;
        "quilt-1.21.9-pre1" = _UGmybQoC;
        "quilt-1.21.9-pre2" = _UGmybQoC;
        "quilt-1.21.9-pre3" = _UGmybQoC;
        "quilt-1.21.9-pre4" = _UGmybQoC;
        "quilt-1.21.9-rc1" = _UGmybQoC;
        "quilt-1.20.5-pre1" = _tFkQ4Ne6;
        "quilt-1.20.5-pre2" = _tFkQ4Ne6;
        "quilt-1.20.5-pre3" = _tFkQ4Ne6;
        "quilt-1.20.5-pre4" = _tFkQ4Ne6;
        "quilt-1.20.5-rc1" = _tFkQ4Ne6;
        "quilt-1.20.5-rc2" = _tFkQ4Ne6;
        "quilt-1.20.5-rc3" = _tFkQ4Ne6;
        "quilt-25w31a" = _UGmybQoC;
        "quilt-25w32a" = _UGmybQoC;
        "quilt-25w33a" = _UGmybQoC;
        "quilt-25w34a" = _UGmybQoC;
        "quilt-25w34b" = _UGmybQoC;
        "quilt-25w35a" = _UGmybQoC;
        "quilt-25w36a" = _UGmybQoC;
        "quilt-25w36b" = _UGmybQoC;
        "quilt-25w37a" = _UGmybQoC;
        "quilt-23w51a" = _tFkQ4Ne6;
        "quilt-23w51b" = _tFkQ4Ne6;
        "quilt-24w03a" = _tFkQ4Ne6;
        "quilt-24w03b" = _tFkQ4Ne6;
        "quilt-24w04a" = _tFkQ4Ne6;
        "quilt-24w05a" = _tFkQ4Ne6;
        "quilt-24w05b" = _tFkQ4Ne6;
        "quilt-24w06a" = _tFkQ4Ne6;
        "quilt-24w07a" = _tFkQ4Ne6;
        "quilt-24w09a" = _tFkQ4Ne6;
        "quilt-24w10a" = _tFkQ4Ne6;
        "quilt-24w11a" = _tFkQ4Ne6;
        "quilt-24w12a" = _tFkQ4Ne6;
        "quilt-24w13a" = _tFkQ4Ne6;
        "quilt-24w14potato" = _tFkQ4Ne6;
        "quilt-24w14a" = _tFkQ4Ne6;
        ...
        "quilt-26.2-snapshot-1" = _RzY5xfRi;
        "quilt-26.2-snapshot-2" = _RzY5xfRi;
        "quilt-26.2-snapshot-3" = _RzY5xfRi;
        "quilt-26.2-snapshot-4" = _RzY5xfRi;
        "quilt-26.2-snapshot-5" = _RzY5xfRi;
        "quilt-26.2-snapshot-6" = _RzY5xfRi;
        "quilt-26.2-snapshot-7" = _RzY5xfRi;
        "quilt-26.2-snapshot-8" = _RzY5xfRi;
        "quilt-26.2-pre-1" = _RzY5xfRi;
        "quilt-26.2-pre-2" = _RzY5xfRi;
        "quilt-26.2-pre-3" = _RzY5xfRi;
        "quilt-26.2-pre-4" = _RzY5xfRi;
        "quilt-26.2-pre-5" = _RzY5xfRi;
        "quilt-26.2-pre-6" = _RzY5xfRi;
        "quilt-26.2-rc-1" = _RzY5xfRi;
        "quilt-26.2-rc-2" = _RzY5xfRi;
        ...
        "forge-1.20" = _A32J0zEL;
        "forge-1.20.1-rc1" = _A32J0zEL;
        "forge-1.20.1" = _A32J0zEL;
        "forge-1.20.2" = _o4erUNhX;
        "forge-23w40a" = _o4erUNhX;
        "forge-23w41a" = _o4erUNhX;
        "forge-23w42a" = _o4erUNhX;
        "forge-23w43a" = _o4erUNhX;
        "forge-23w43b" = _o4erUNhX;
        "forge-23w44a" = _o4erUNhX;
        "forge-23w45a" = _o4erUNhX;
        "forge-23w46a" = _o4erUNhX;
        "forge-1.20.3-pre1" = _o4erUNhX;
        "forge-1.20.3-pre2" = _o4erUNhX;
        "forge-1.20.3-pre3" = _o4erUNhX;
        "forge-1.20.3-pre4" = _o4erUNhX;
        "forge-1.20.3-rc1" = _o4erUNhX;
        "forge-1.20.3" = _o4erUNhX;
        "forge-1.20.4-rc1" = _o4erUNhX;
        "forge-1.20.4" = _o4erUNhX;
        "forge-1.20.6" = _rjax5HyA;
        "forge-24w18a" = _rjax5HyA;
        "forge-24w19a" = _rjax5HyA;
        "forge-24w19b" = _rjax5HyA;
        "forge-24w20a" = _rjax5HyA;
        "forge-24w21a" = _rjax5HyA;
        "forge-24w21b" = _rjax5HyA;
        "forge-1.21-pre1" = _rjax5HyA;
        "forge-1.21-pre2" = _rjax5HyA;
        "forge-1.21-pre3" = _rjax5HyA;
        "forge-1.21-pre4" = _rjax5HyA;
        "forge-1.21-rc1" = _rjax5HyA;
        "forge-1.21" = _rjax5HyA;
        "forge-1.21.1-rc1" = _rjax5HyA;
        "forge-1.21.1" = _rjax5HyA;
        ...
        "forge-1.21.2" = _UttH7Yuw;
        "forge-1.21.3" = _UttH7Yuw;
        "forge-24w44a" = _UttH7Yuw;
        "forge-24w45a" = _UttH7Yuw;
        "forge-24w46a" = _UttH7Yuw;
        "forge-1.21.4-pre1" = _UttH7Yuw;
        "forge-1.21.4-pre2" = _UttH7Yuw;
        "forge-1.21.4-pre3" = _UttH7Yuw;
        "forge-1.21.4-rc1" = _UttH7Yuw;
        "forge-1.21.4-rc2" = _UttH7Yuw;
        "forge-1.21.4-rc3" = _UttH7Yuw;
        "forge-1.21.4" = _UttH7Yuw;
        "forge-25w02a" = _UttH7Yuw;
        "forge-25w03a" = _UttH7Yuw;
        "forge-25w04a" = _UttH7Yuw;
        "forge-25w05a" = _UttH7Yuw;
        "forge-25w06a" = _UttH7Yuw;
        "forge-25w07a" = _UttH7Yuw;
        "forge-25w08a" = _UttH7Yuw;
        "forge-25w09a" = _UttH7Yuw;
        "forge-25w09b" = _UttH7Yuw;
        "forge-25w10a" = _UttH7Yuw;
        "forge-1.21.5-pre1" = _UttH7Yuw;
        "forge-1.21.5-pre2" = _UttH7Yuw;
        "forge-1.21.5-pre3" = _UttH7Yuw;
        "forge-1.21.5-rc1" = _UttH7Yuw;
        "forge-1.21.5-rc2" = _UttH7Yuw;
        "forge-1.21.5" = _UttH7Yuw;
        "forge-25w14craftmine" = _UttH7Yuw;
        "forge-25w15a" = _UttH7Yuw;
        "forge-25w16a" = _UttH7Yuw;
        "forge-25w17a" = _UttH7Yuw;
        "forge-25w18a" = _UttH7Yuw;
        "forge-25w19a" = _UttH7Yuw;
        "forge-25w20a" = _UttH7Yuw;
        "forge-25w21a" = _UttH7Yuw;
        "forge-1.21.6-pre1" = _UttH7Yuw;
        "forge-1.21.6-pre2" = _UttH7Yuw;
        "forge-1.21.6-pre3" = _UttH7Yuw;
        "forge-1.21.6-pre4" = _UttH7Yuw;
        "forge-1.21.6-rc1" = _UttH7Yuw;
        "forge-1.21.6" = _UttH7Yuw;
        "forge-1.21.7-rc1" = _UttH7Yuw;
        "forge-1.21.7-rc2" = _UttH7Yuw;
        "forge-1.21.7" = _UttH7Yuw;
        "forge-1.21.8-rc1" = _UttH7Yuw;
        "forge-1.21.8" = _UttH7Yuw;
        "forge-1.21.9" = _UttH7Yuw;
        "forge-1.21.10" = _UttH7Yuw;
        "forge-1.21.10-rc1" = _UttH7Yuw;
        "forge-25w41a" = _UttH7Yuw;
        "forge-25w42a" = _UttH7Yuw;
        "forge-25w43a" = _UttH7Yuw;
        "forge-25w44a" = _UttH7Yuw;
        "forge-25w45a" = _UttH7Yuw;
        "forge-25w46a" = _UttH7Yuw;
        "forge-1.21.11-pre1" = _UttH7Yuw;
        "forge-1.21.11-pre2" = _UttH7Yuw;
        "forge-1.21.11-pre3" = _UttH7Yuw;
        "forge-1.21.11-pre4" = _UttH7Yuw;
        "forge-1.21.11-pre5" = _UttH7Yuw;
        "forge-1.21.11-rc1" = _UttH7Yuw;
        "forge-1.21.11-rc2" = _UttH7Yuw;
        "forge-1.21.11-rc3" = _UttH7Yuw;
        "forge-1.21.11" = _UttH7Yuw;
        ...
        "forge-26.1" = _RG4tQVcb;
        "forge-26.1.1-rc-1" = _RG4tQVcb;
        "forge-26.1.1" = _RG4tQVcb;
        "forge-26w14a" = _RG4tQVcb;
        "forge-26.1.2-rc-1" = _RG4tQVcb;
        "forge-26.1.2" = _RG4tQVcb;
        "forge-26.2" = _RG4tQVcb;
        "forge-1.21.9-pre1" = _UttH7Yuw;
        "forge-1.21.9-pre2" = _UttH7Yuw;
        "forge-1.21.9-pre3" = _UttH7Yuw;
        "forge-1.21.9-pre4" = _UttH7Yuw;
        "forge-1.21.9-rc1" = _UttH7Yuw;
        "forge-25w31a" = _UttH7Yuw;
        "forge-25w32a" = _UttH7Yuw;
        "forge-25w33a" = _UttH7Yuw;
        "forge-25w34a" = _UttH7Yuw;
        "forge-25w34b" = _UttH7Yuw;
        "forge-25w35a" = _UttH7Yuw;
        "forge-25w36a" = _UttH7Yuw;
        "forge-25w36b" = _UttH7Yuw;
        "forge-25w37a" = _UttH7Yuw;
        ...
        "forge-26.2-snapshot-1" = _RG4tQVcb;
        "forge-26.2-snapshot-2" = _RG4tQVcb;
        "forge-26.2-snapshot-3" = _RG4tQVcb;
        "forge-26.2-snapshot-4" = _RG4tQVcb;
        "forge-26.2-snapshot-5" = _RG4tQVcb;
        "forge-26.2-snapshot-6" = _RG4tQVcb;
        "forge-26.2-snapshot-7" = _RG4tQVcb;
        "forge-26.2-snapshot-8" = _RG4tQVcb;
        "forge-26.2-pre-1" = _RG4tQVcb;
        "forge-26.2-pre-2" = _RG4tQVcb;
        "forge-26.2-pre-3" = _RG4tQVcb;
        "forge-26.2-pre-4" = _RG4tQVcb;
        "forge-26.2-pre-5" = _RG4tQVcb;
        "forge-26.2-pre-6" = _RG4tQVcb;
        "forge-26.2-rc-1" = _RG4tQVcb;
        "forge-26.2-rc-2" = _RG4tQVcb;
        ...
        "neoforge-1.21" = _SfUT34Z8;
        "neoforge-1.21.1-rc1" = _SfUT34Z8;
        "neoforge-1.21.1" = _SfUT34Z8;
        ...
        "neoforge-1.21.2" = _b2TO74Ai;
        "neoforge-1.21.3" = _b2TO74Ai;
        "neoforge-24w44a" = _b2TO74Ai;
        "neoforge-24w45a" = _b2TO74Ai;
        "neoforge-24w46a" = _b2TO74Ai;
        "neoforge-1.21.4-pre1" = _b2TO74Ai;
        "neoforge-1.21.4-pre2" = _b2TO74Ai;
        "neoforge-1.21.4-pre3" = _b2TO74Ai;
        "neoforge-1.21.4-rc1" = _b2TO74Ai;
        "neoforge-1.21.4-rc2" = _b2TO74Ai;
        "neoforge-1.21.4-rc3" = _b2TO74Ai;
        "neoforge-1.21.4" = _b2TO74Ai;
        "neoforge-25w02a" = _b2TO74Ai;
        "neoforge-25w03a" = _b2TO74Ai;
        "neoforge-25w04a" = _b2TO74Ai;
        "neoforge-25w05a" = _b2TO74Ai;
        "neoforge-25w06a" = _b2TO74Ai;
        "neoforge-25w07a" = _b2TO74Ai;
        "neoforge-25w08a" = _b2TO74Ai;
        "neoforge-25w09a" = _b2TO74Ai;
        "neoforge-25w09b" = _b2TO74Ai;
        "neoforge-25w10a" = _b2TO74Ai;
        "neoforge-1.21.5-pre1" = _b2TO74Ai;
        "neoforge-1.21.5-pre2" = _b2TO74Ai;
        "neoforge-1.21.5-pre3" = _b2TO74Ai;
        "neoforge-1.21.5-rc1" = _b2TO74Ai;
        "neoforge-1.21.5-rc2" = _b2TO74Ai;
        "neoforge-1.21.5" = _b2TO74Ai;
        "neoforge-25w14craftmine" = _b2TO74Ai;
        "neoforge-25w15a" = _b2TO74Ai;
        "neoforge-25w16a" = _b2TO74Ai;
        "neoforge-25w17a" = _b2TO74Ai;
        "neoforge-25w18a" = _b2TO74Ai;
        "neoforge-25w19a" = _b2TO74Ai;
        "neoforge-25w20a" = _b2TO74Ai;
        "neoforge-25w21a" = _b2TO74Ai;
        "neoforge-1.21.6-pre1" = _b2TO74Ai;
        "neoforge-1.21.6-pre2" = _b2TO74Ai;
        "neoforge-1.21.6-pre3" = _b2TO74Ai;
        "neoforge-1.21.6-pre4" = _b2TO74Ai;
        "neoforge-1.21.6-rc1" = _b2TO74Ai;
        "neoforge-1.21.6" = _b2TO74Ai;
        "neoforge-1.21.7-rc1" = _b2TO74Ai;
        "neoforge-1.21.7-rc2" = _b2TO74Ai;
        "neoforge-1.21.7" = _b2TO74Ai;
        "neoforge-1.21.8-rc1" = _b2TO74Ai;
        "neoforge-1.21.8" = _b2TO74Ai;
        "neoforge-1.21.9" = _b2TO74Ai;
        "neoforge-1.21.10" = _b2TO74Ai;
        "neoforge-1.21.10-rc1" = _b2TO74Ai;
        "neoforge-25w41a" = _b2TO74Ai;
        "neoforge-25w42a" = _b2TO74Ai;
        "neoforge-25w43a" = _b2TO74Ai;
        "neoforge-25w44a" = _b2TO74Ai;
        "neoforge-25w45a" = _b2TO74Ai;
        "neoforge-25w46a" = _b2TO74Ai;
        "neoforge-1.21.11-pre1" = _b2TO74Ai;
        "neoforge-1.21.11-pre2" = _b2TO74Ai;
        "neoforge-1.21.11-pre3" = _b2TO74Ai;
        "neoforge-1.21.11-pre4" = _b2TO74Ai;
        "neoforge-1.21.11-pre5" = _b2TO74Ai;
        "neoforge-1.21.11-rc1" = _b2TO74Ai;
        "neoforge-1.21.11-rc2" = _b2TO74Ai;
        "neoforge-1.21.11-rc3" = _b2TO74Ai;
        "neoforge-1.21.11" = _b2TO74Ai;
        ...
        "neoforge-26.1" = _Xkz0VhC3;
        "neoforge-26.1.1-rc-1" = _Xkz0VhC3;
        "neoforge-26.1.1" = _Xkz0VhC3;
        "neoforge-26w14a" = _Xkz0VhC3;
        "neoforge-26.1.2-rc-1" = _Xkz0VhC3;
        "neoforge-26.1.2" = _Xkz0VhC3;
        "neoforge-26.2" = _Xkz0VhC3;
        "neoforge-1.21.9-pre1" = _b2TO74Ai;
        "neoforge-1.21.9-pre2" = _b2TO74Ai;
        "neoforge-1.21.9-pre3" = _b2TO74Ai;
        "neoforge-1.21.9-pre4" = _b2TO74Ai;
        "neoforge-1.21.9-rc1" = _b2TO74Ai;
        "neoforge-25w31a" = _b2TO74Ai;
        "neoforge-25w32a" = _b2TO74Ai;
        "neoforge-25w33a" = _b2TO74Ai;
        "neoforge-25w34a" = _b2TO74Ai;
        "neoforge-25w34b" = _b2TO74Ai;
        "neoforge-25w35a" = _b2TO74Ai;
        "neoforge-25w36a" = _b2TO74Ai;
        "neoforge-25w36b" = _b2TO74Ai;
        "neoforge-25w37a" = _b2TO74Ai;
        "neoforge-26.2-snapshot-1" = _Xkz0VhC3;
        "neoforge-26.2-snapshot-2" = _Xkz0VhC3;
        "neoforge-26.2-snapshot-3" = _Xkz0VhC3;
        "neoforge-26.2-snapshot-4" = _Xkz0VhC3;
        "neoforge-26.2-snapshot-5" = _Xkz0VhC3;
        "neoforge-26.2-snapshot-6" = _Xkz0VhC3;
        "neoforge-26.2-snapshot-7" = _Xkz0VhC3;
        "neoforge-26.2-snapshot-8" = _Xkz0VhC3;
        "neoforge-26.2-pre-1" = _Xkz0VhC3;
        "neoforge-26.2-pre-2" = _Xkz0VhC3;
        "neoforge-26.2-pre-3" = _Xkz0VhC3;
        "neoforge-26.2-pre-4" = _Xkz0VhC3;
        "neoforge-26.2-pre-5" = _Xkz0VhC3;
        "neoforge-26.2-pre-6" = _Xkz0VhC3;
        "neoforge-26.2-rc-1" = _Xkz0VhC3;
        "neoforge-26.2-rc-2" = _Xkz0VhC3;
        "pkg-1.0" = _TuaecooK;
        "pkg-2.0" = _3UR9BfUI;
        "pkg-2.0.1" = _VzwttIxc;
        "pkg-2.1" = _FvLem9Jh;
        ...
        "pkg-2.8-fabric+1.20" = _n4diwc1t;
        "pkg-2.8-forge+1.20" = _yS6jh5YL;
        "pkg-2.8-fabric+1.20.2" = _r4pytsAA;
        "pkg-2.8-forge+1.20.2" = _4m4AJZJe;
        "pkg-2.8-forge+1.20.6" = _ZodVZ2KA;
        "pkg-2.8-neoforge+1.21" = _M4A5j1dn;
        "pkg-2.8-fabric+1.21.2" = _LqAiROBF;
        "pkg-2.8-forge+1.21.2" = _BKbBO5Mq;
        "pkg-2.8-neoforge+1.21.2" = _59Mp6ujQ;
        "pkg-2.8-forge+26.1" = _DYSdSixF;
        "pkg-2.8-fabric+26.1" = _bPt1vPqF;
        "pkg-2.8-neoforge+26.1" = _5NpMam1F;
        "pkg-2.8.1-fabric+1.20" = _VCBe7dy2;
        "pkg-2.8.1-forge+1.20" = _A32J0zEL;
        "pkg-2.8.1-fabric+1.20.2" = _tFkQ4Ne6;
        "pkg-2.8.1-forge+1.20.2" = _o4erUNhX;
        "pkg-2.8.1-forge+1.20.6" = _rjax5HyA;
        "pkg-2.8.1-neoforge+1.21" = _SfUT34Z8;
        "pkg-2.8.1-fabric+1.21.2" = _UGmybQoC;
        "pkg-2.8.1-forge+1.21.2" = _UttH7Yuw;
        "pkg-2.8.1-neoforge+1.21.2" = _b2TO74Ai;
        "pkg-2.8.1-forge+26.1" = _RG4tQVcb;
        "pkg-2.8.1-fabric+26.1" = _RzY5xfRi;
        "pkg-2.8.1-neoforge+26.1" = _Xkz0VhC3;
        "default" = _Xkz0VhC3;
    });
