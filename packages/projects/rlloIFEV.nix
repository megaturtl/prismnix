...
let
    ...
    in {
        ...
        "pkg-1.16.5-5.4.32" = _vkKtQkPB;
        "pkg-1.17.1-6.0.33" = _aLSNvOrR;
        "pkg-1.18.2-7.1.27" = _6Znf3Ilg;
        "pkg-1.19.2-8.2.18" = _nnDkqHOG;
        "pkg-1.19.3-8.3.6" = _FmmDuqsd;
        "pkg-1.16.5-5.4.33" = _hDf9oPDn;
        "pkg-1.17.1-6.0.34" = _jv0fI3JP;
        "pkg-1.18.2-7.1.28" = _vd9KuK8a;
        "pkg-1.19.2-8.2.19" = _C5cDj800;
        "pkg-1.19.3-8.3.7" = _quSAbPm2;
        "pkg-1.16.5-5.4.24" = _qulwxsVL;
        "pkg-1.17.1-6.0.24" = _wXNt6cdj;
        "pkg-1.18.2-7.1.22" = _TXEa9Unm;
        "pkg-1.19.2-8.2.17" = _IDUIdeSm;
        "pkg-1.19.4-8.4.0" = _Al5EVx34;
        "pkg-1.16.5-5.4.34" = _1RViEGFL;
        "pkg-1.16.5-5.4.25" = _CHZtS2Gl;
        "pkg-1.17.1-6.0.35" = _vKu9DehK;
        "pkg-1.17.1-6.0.25" = _SOcUM5fd;
        "pkg-1.18.2-7.1.29" = _jMotu0Zk;
        "pkg-1.18.2-7.1.23" = _7CCX31w3;
        "pkg-1.19.2-8.2.20" = _ad3oVSG5;
        "pkg-1.19.3-8.3.8" = _eoOnU9CV;
        "pkg-1.19.4-8.4.1" = _6D88fI3r;
        "pkg-1.16.5-5.4.35" = _og5HX3wY;
        "pkg-1.17.1-6.0.36" = _3yZHsL4X;
        "pkg-1.18.2-7.1.30" = _auYymUrs;
        "pkg-1.19.2-8.2.21" = _br3acjjl;
        "pkg-1.19.3-8.3.9" = _apja6Dhu;
        "pkg-1.19.4-8.4.2" = _o4Uyxsjm;
        "pkg-1.16.5-5.4.26" = _T1C7xCiO;
        "pkg-1.17.1-6.0.26" = _ajgmFxBT;
        "pkg-1.18.2-7.1.24" = _Qc3Qv35x;
        "pkg-1.16.5-5.4.36" = _YTcpZXlQ;
        "pkg-1.17.1-6.0.37" = _H4BqxoaC;
        "pkg-1.18.2-7.1.31" = _i0qHsErK;
        "pkg-1.19.2-8.2.22" = _cbWsCrZH;
        "pkg-1.19.4-8.4.3" = _URn54PU1;
        "pkg-1.16.5-5.4.27" = _d8LHnOA5;
        "pkg-1.17.1-6.0.27" = _rkfMzYjw;
        "pkg-1.18.2-7.1.25" = _rNi6UWMq;
        "pkg-1.16.5-5.4.37" = _CQsyrtt2;
        "pkg-1.17.1-6.0.38" = _YiOHhILw;
        "pkg-1.18.2-7.1.32" = _YewZJkKf;
        "pkg-1.19.2-8.2.23" = _zPIVq8HQ;
        "pkg-1.19.4-8.4.4" = _42zDOlIu;
        "pkg-1.16.5-5.4.28" = _6QG85Cpr;
        "pkg-1.17.1-6.0.28" = _V8N3A0OP;
        "pkg-1.18.2-7.1.26" = _STPPMo4x;
        "pkg-1.19.2-8.2.24" = _gua8xldT;
        "pkg-1.16.5-5.4.38" = _SeUbJGkP;
        "pkg-1.17.1-6.0.39" = _b5tQw0mz;
        "pkg-1.18.2-7.1.33" = _oklNQ0dA;
        "pkg-1.19.2-8.2.25" = _ZioXKY7K;
        "pkg-1.19.4-8.4.5" = _krUFFadm;
        "pkg-1.20-rc1-9.0.0" = _Npl8FdSX;
        "pkg-1.19.4-8.4.6" = _EGYtV3xo;
        "pkg-1.19.4-8.4.7" = _hPIM40SJ;
        "pkg-1.20-9.0.0" = _tosqfGgQ;
        "pkg-1.20-9.0.1" = _slubd3TX;
        "pkg-1.20-9.0.2" = _RyT2OXFZ;
        "pkg-1.16.5-5.4.39" = _DCn9Zsh7;
        "pkg-1.17.1-6.0.40" = _k2aIDdg3;
        "pkg-1.18.2-7.1.34" = _KOmKCJ0k;
        "pkg-1.19.2-8.2.26" = _T0af8iyz;
        "pkg-1.19.4-8.4.8" = _b7krNQfy;
        "pkg-1.20.1-9.1.0" = _alNMLcxl;
        "pkg-1.16.5-5.4.40" = _AicNyHmg;
        "pkg-1.17.1-6.0.41" = _JLiXpbUs;
        "pkg-1.18.2-7.1.35" = _VnDE4DEC;
        "pkg-1.19.2-8.2.27" = _JNHVoyb9;
        "pkg-1.19.4-8.4.9" = _DyYGFiPM;
        "pkg-1.20.1-9.1.1" = _KeTPhdV4;
        "pkg-1.16.5-5.4.41" = _5s71yXMV;
        "pkg-1.17.1-6.0.42" = _jPRIBMyA;
        "pkg-1.18.2-7.1.36" = _7u8NqNuP;
        "pkg-1.19.2-8.2.28" = _Y0TS2Cd0;
        "pkg-1.19.4-8.4.10" = _71Ld6Zvc;
        "pkg-1.20.1-9.1.2" = _sRElubLP;
        "pkg-1.16.5-5.4.29" = _Ii8CoFxg;
        "pkg-1.17.1-6.0.29" = _uLFgSrSc;
        "pkg-1.16.5-5.4.42" = _Mci898r9;
        "pkg-1.17.1-6.0.43" = _qZziKJ2J;
        "pkg-1.18.2-7.1.37" = _EZpTx2l6;
        "pkg-1.19.2-8.2.29" = _k2i1CIRO;
        "pkg-1.19.4-8.4.11" = _4yYn519B;
        "pkg-1.20.1-9.1.3" = _XFdxMe7g;
        "pkg-1.16.5-5.4.30" = _SrkNNuAI;
        "pkg-1.17.1-6.0.30" = _yTJnhFCO;
        "pkg-1.16.5-5.4.43" = _ZB5ObWDD;
        "pkg-1.17.1-6.0.44" = _RWlqVg62;
        "pkg-1.18.2-7.1.38" = _f4MfVrVz;
        "pkg-1.19.2-8.2.30" = _QlbG8Rg1;
        "pkg-1.19.4-8.4.12" = _GfxbHbKj;
        "pkg-1.20.1-9.1.4" = _tdmN5UVP;
        "pkg-1.16.5-5.4.31" = _qzSqyvBI;
        "pkg-1.17.1-6.0.31" = _SNKBzkpQ;
        "pkg-1.17.1-6.0.32" = _h5Fad8QY;
        "pkg-1.16.5-5.4.46" = _fXCOkisf;
        "pkg-1.17.1-6.0.47" = _HgQHtRcj;
        "pkg-1.18.2-7.1.41" = _pq4eco6g;
        "pkg-1.19.2-8.2.33" = _qwaY03Wi;
        "pkg-1.19.4-8.4.15" = _BazlFems;
        "pkg-1.20.1-9.1.7" = _KqsSv33W;
        "pkg-1.16.5-5.4.47" = _euN4sCEH;
        "pkg-1.17.1-6.0.48" = _J0IWCcFW;
        "pkg-1.18.2-7.1.42" = _J9O32xos;
        "pkg-1.19.2-8.2.34" = _gnjoUu2f;
        "pkg-1.19.4-8.4.16" = _eYtq2399;
        "pkg-1.20.1-9.1.8" = _iYUhPo8x;
        "pkg-1.20.2-9.2.0" = _MKBy5F0I;
        "pkg-1.20.1-9.1.5" = _hcxdzC1w;
        "pkg-1.20.1-9.1.6" = _UuBCH83b;
        "pkg-1.20.2-9.2.1" = _yQDbrrx2;
        "pkg-1.16.5-5.4.48" = _9Bf1wTVe;
        "pkg-1.17.1-6.0.49" = _smCjdPtc;
        "pkg-1.18.2-7.1.43" = _eWGV5ntd;
        "pkg-1.19.2-8.2.35" = _Hhm2z1aj;
        "pkg-1.19.4-8.4.17" = _jzeyZuA3;
        "pkg-1.20.1-9.1.9" = _C78BanYS;
        "pkg-1.16.5-5.4.49" = _y176qjkH;
        "pkg-1.17.1-6.0.50" = _JzeN7Is5;
        "pkg-1.18.2-7.1.44" = _QbRLEuyy;
        "pkg-1.19.2-8.2.36" = _MKIiEH1b;
        "pkg-1.19.4-8.4.18" = _ng1f77OX;
        "pkg-1.20.1-9.1.10" = _QHBTpTg1;
        "pkg-1.20.2-9.2.2" = _4SH8ESf0;
        "pkg-1.19.2-8.2.31" = _y6GgNc3T;
        "pkg-1.19.4-8.4.13" = _Dnu56zoR;
        "pkg-1.19.2-8.2.32" = _wsSxnrfL;
        "pkg-1.19.4-8.4.14" = _kmwfHFql;
        "pkg-1.20.2-9.2.3" = _RbeMxrhe;
        "pkg-1.16.5-5.4.50" = _XL0r7Pv9;
        "pkg-1.17.1-6.0.51" = _wwQhVddp;
        "pkg-1.18.2-7.1.45" = _6kxcENjy;
        "pkg-1.19.2-8.2.37" = _fZXSUvLJ;
        "pkg-1.19.4-8.4.19" = _cYJcqK4T;
        "pkg-1.20.1-9.1.11" = _OZYAzeTR;
        "pkg-1.16.5-5.4.51" = _6NAEVL5U;
        "pkg-1.17.1-6.0.52" = _ZX1zUypH;
        "pkg-1.18.2-7.1.46" = _bZkPIwKN;
        "pkg-1.19.2-8.2.38" = _SZ8pohLr;
        "pkg-1.19.4-8.4.20" = _c6ESk0Q0;
        "pkg-1.20.1-9.1.12" = _kf3NfFx1;
        "pkg-1.20.2-9.2.4" = _8I0ytvnY;
        "pkg-1.20.4-9.4.0" = _G6nFU7RY;
        "pkg-1.18.2-7.1.47" = _bjtX4cAx;
        "pkg-1.19.2-8.2.39" = _70ydZU6U;
        "pkg-1.20.1-9.1.13" = _xa2rNDt3;
        "pkg-1.20.4-9.4.1" = _rmOIDUiI;
        "pkg-1.20.4-9.4.2" = _iF6UHeUn;
        "pkg-1.18.2-7.1.39" = _gxfhGx3I;
        "pkg-1.20.4-9.4.3" = _5qngrLbH;
        "pkg-1.18.2-7.1.48" = _O0gFosas;
        "pkg-1.19.2-8.2.40" = _3nZgdUsQ;
        "pkg-1.20.1-9.1.14" = _peCGwBXB;
        "pkg-1.18.2-7.1.40" = _xojqr589;
        "pkg-1.20.4-9.4.4" = _BNberKGE;
        "pkg-1.20.6-9.6.0" = _KZG9ydbw;
        "pkg-1.20.4-9.4.5" = _W0S6YZOY;
        "pkg-1.21-10.0.0" = _eu0U8r3V;
        "pkg-1.20.6-9.6.2" = _OM68XX8U;
        "pkg-1.21-10.0.2" = _RspsLAbI;
        "pkg-1.20.4-9.4.6" = _Mn84WPSB;
        "pkg-1.20.6-9.6.3" = _7F2hRnJ3;
        "pkg-1.21-10.0.3" = _A8m18qX7;
        "pkg-1.20.1-9.1.15" = _FDqFhZfz;
        "pkg-1.20.6-9.6.1" = _CHwiS74Y;
        "pkg-1.20.6-9.6.4" = _AzNT1Qxf;
        "pkg-1.21-10.0.4" = _AruxVEie;
        "pkg-1.21-10.0.1" = _Vmnmnrfa;
        "pkg-1.18.2-7.1.49" = _voGeNbOd;
        "pkg-1.19.2-8.2.41" = _SDFfEpIi;
        "pkg-1.21-10.0.5" = _66kLxgg9;
        "pkg-1.20.1-9.1.16" = _FeYZiTcJ;
        "pkg-1.21-10.0.6" = _1OThGyda;
        "pkg-1.21-10.0.7" = _zMlG1STY;
        "pkg-1.21.1-10.1.0" = _yEj14eK7;
        "pkg-1.21.1-10.1.1" = _otWLLZk6;
        "pkg-1.21.1-10.1.2" = _GxSICLmq;
        "pkg-1.20.1-9.1.17" = _PxOuhEQn;
        "pkg-1.20.1-9.1.18" = _KdrSqCIH;
        "pkg-1.21.1-10.1.3" = _h097RYXl;
        "pkg-1.21.1-10.1.4" = _sYnfAv6Y;
        "pkg-1.21.1-10.1.5" = _f7tWSXVt;
        "pkg-1.21.1-10.1.6" = _GadYgFpW;
        "pkg-1.21.1-10.1.7" = _dXfJ1gIw;
        "pkg-1.20.1-9.1.19" = _zVFfyOP4;
        "pkg-1.21.1-10.1.8" = _Q83otQJw;
        "pkg-1.21.4-10.4.0" = _twZWYN4M;
        "pkg-1.21.1-10.1.9" = _GVSxBCco;
        "pkg-1.20.1-9.1.20" = _wkq3ofK7;
        "pkg-1.21.4-10.4.1" = _5Hduuhsy;
        "pkg-1.21.1-10.1.10" = _JyC0g7Lu;
        "pkg-1.20.1-9.1.21" = _tuWH159o;
        "pkg-1.21.1-10.1.11" = _kLgyf2r3;
        "pkg-1.21.4-10.4.2" = _xrRC2NLS;
        "pkg-1.20.1-9.1.24" = _79HfFd81;
        "pkg-1.20.1-9.1.25" = _amb4Ggvj;
        "pkg-1.21.1-10.1.12" = _OKICkrUM;
        "pkg-1.21.4-10.4.3" = _5J4MyAIa;
        "pkg-1.20.1-9.1.22" = _hF5ZPe3P;
        "pkg-1.20.1-9.1.23" = _KzkRE3bS;
        "pkg-1.21.4-10.4.4" = _C0xM4L1o;
        "pkg-1.20.1-9.1.26" = _JglksaBM;
        "pkg-1.21.1-10.1.13" = _5qBNu8my;
        "pkg-1.20.1-9.1.27" = _XpToi29t;
        "pkg-1.20.1-9.1.28" = _QYB8PWtU;
        "pkg-1.21.1-10.1.15" = _SlNcSHjP;
        "pkg-1.20.1-9.1.29" = _5eLDOgGZ;
        "pkg-1.20.1-9.1.30" = _kbhvmaCR;
        "pkg-1.21.1-10.1.14" = _cXvLRPWV;
        "pkg-1.21.4-10.4.6" = _iJLJG6lm;
        "pkg-1.21.4-10.4.7" = _8VfgSYgO;
        "pkg-1.21.1-10.1.16" = _oT9lHtHI;
        "pkg-1.21.4-10.4.8" = _xT2Ffn5J;
        "pkg-1.20.1-9.1.32" = _eabCK3Xb;
        "pkg-1.20.1-9.1.33" = _ciOPRrkf;
        "pkg-1.21.1-10.1.17" = _vXgcqcJk;
        "pkg-1.21.4-10.4.9" = _efTVGpTa;
        "pkg-1.20.1-9.1.34" = _93cQ4328;
        "pkg-1.20.1-9.1.31" = _XjQxivlU;
        "pkg-1.20.1-9.1.35" = _fjRqNdJ1;
        "pkg-1.21.1-10.1.18" = _kCXEkj8r;
        "pkg-1.21.5-10.5.0" = _2LRiPyz5;
        "pkg-1.21.4-10.4.10" = _dMG93x2l;
        "pkg-1.20.1-9.1.36" = _CqpxI8w5;
        "pkg-1.21.1-10.1.19" = _Mse7s79Y;
        "pkg-1.21.4-10.4.11" = _nLe8wldk;
        "pkg-1.21.5-10.5.1" = _bBglPNeT;
        "pkg-1.20.1-9.1.37" = _PO5Zx5TX;
        "pkg-1.21.1-10.1.20" = _LYAza4GH;
        "pkg-1.21.1-10.1.21" = _9nwiWyA3;
        "pkg-1.21.1-10.1.22" = _X4veh15G;
        "pkg-1.20.1-9.1.38" = _lnzLVA1W;
        "pkg-1.21.4-10.4.12" = _9nE5U58W;
        "pkg-1.21.4-10.4.13" = _Awlfopi1;
        "pkg-1.21.5-10.5.2" = _9RhcBbVi;
        "pkg-1.20.1-9.1.39" = _QrW0SDkH;
        "pkg-1.21.1-10.1.23" = _41RS1Evh;
        "pkg-1.21.5-10.5.3" = _DgP3e1Zw;
        "pkg-1.21.6-10.6.0" = _6VYdBXHD;
        "pkg-1.21.7-10.7.0" = _aMfFOWIF;
        "pkg-1.21.1-10.1.24" = _j6YY4odb;
        "pkg-1.20.1-9.1.40" = _Og3OMEWJ;
        "pkg-1.21.8-10.8.0" = _txfrgw3b;
        "pkg-1.21.8-10.8.1" = _sc74PJvY;
        "pkg-1.20.1-9.1.41" = _PaHAEoCa;
        "pkg-1.21.1-10.1.25" = _QVybGfBP;
        "pkg-1.21.8-10.8.2" = _KmORpu03;
        "pkg-1.20.1-9.1.42" = _vZN3DxP2;
        "pkg-1.21.1-10.1.26" = _a3VUPlc1;
        "pkg-1.21.8-10.8.3" = _IVbYZshY;
        "pkg-1.20.1-9.1.43" = _hvbhRvQa;
        "pkg-1.20.1-9.1.44" = _KSBlBPV5;
        "pkg-1.21.1-10.1.27" = _JUrjDFhi;
        "pkg-1.21.8-10.8.4" = _P3LjVY8i;
        "pkg-1.21.10-10.10.0" = _tD1jMLBN;
        "pkg-1.20.1-9.1.45" = _v206GWp6;
        "pkg-1.20.1-9.1.46" = _mblO4kaU;
        "pkg-1.21.1-10.1.28" = _VbCPI4K2;
        "pkg-1.21.1-10.1.29" = _Mf1VMgxK;
        "pkg-1.21.10-10.10.1" = _z1BiZKDy;
        "pkg-1.21.10-10.10.2" = _pUmFFFme;
        "pkg-1.21.11-10.11.0" = _zg4XzhT5;
        "pkg-1.21.10-10.10.3" = _px2Alm2i;
        "pkg-1.21.1-10.1.30" = _ISO4T17W;
        "pkg-1.21.11-10.11.1" = _6wxjzJ9S;
        "pkg-1.20.1-9.1.47" = _GlT4FnTs;
        "pkg-1.21.1-10.1.31" = _9kIZO4k5;
        "pkg-1.21.10-10.10.4" = _xBMUHCSG;
        "pkg-1.20.1-9.1.48" = _ndjO71r5;
        "pkg-1.21.11-10.11.2" = _VqBR0J6T;
        "pkg-1.20.1-9.1.49" = _8JL58SeM;
        "pkg-1.20.1-9.1.50" = _hIiloTnQ;
        "pkg-1.21.10-10.10.5" = _xaHpF00O;
        "pkg-1.21.1-10.1.32" = _2yIrUpk7;
        "pkg-1.21.11-10.11.3" = _IYve2nQ1;
        "pkg-1.20.1-9.1.51" = _E4UZZZAV;
        "pkg-1.21.1-10.1.33" = _jOUBFX2f;
        "pkg-1.21.11-10.11.4" = _lNx2626W;
        "pkg-1.21.11-10.11.5" = _cKvhxqWf;
        "pkg-1.21.10-10.10.6" = _uQ0xHxTz;
        ...
        "pkg-26.1.2-11.2.0" = _gvH9BSzg;
        "pkg-26.1.2-11.2.1" = _Lm5MAyHK;
        "pkg-26.1.2-11.2.2" = _oAKmG5eI;
        "pkg-1.21.1-10.1.35" = _RfI8MfzH;
        "pkg-1.20.1-9.1.54" = _5H4yAyuO;
        "pkg-26.1.2-11.2.3" = _55s6nvCW;
        "pkg-26.1.2-11.2.4" = _cFO3tKEx;
