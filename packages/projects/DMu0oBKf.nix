...
let
    ...
    in {
        ...
        "pkg-15.0.2+fabric-1.19" = _2lJnYaeR;
        "pkg-15.0.2+forge-1.19" = _M9rqyi5U;
        "pkg-15.1.0+fabric-1.19" = _dIfJgrtZ;
        "pkg-15.1.0+forge-1.19" = _8YFo5WQL;
        "pkg-16.0.1+fabric-1.19.3" = _TR0tkJWb;
        "pkg-16.0.1+forge-1.19.3" = _c0feVAUH;
        "pkg-14.0.3+forge-1.18.2" = _VUzil4JJ;
        "pkg-14.0.3+fabric-1.18.2" = _BgwwMD48;
        "pkg-16.0.2+forge-1.19.3" = _HPAJLo7C;
        "pkg-16.0.2+fabric-1.19.3" = _e8OrScgh;
        "pkg-15.1.6+forge-1.19" = _MMRBlTzv;
        "pkg-15.1.6+fabric-1.19" = _c3oJXxtm;
        "pkg-14.0.4+fabric-1.18.2" = _jm3MDxsl;
        "pkg-14.0.4+forge-1.18.2" = _lLXZEvzk;
        "pkg-17.0.1+fabric-1.19.4" = _IYaR7bGK;
        "pkg-17.0.1+forge-1.19.4" = _yqM9N5Xg;
        "pkg-17.0.2+fabric-1.19.4" = _8c8gPXdd;
        "pkg-17.0.2+forge-1.19.4" = _bGwiOXKq;
        "pkg-15.1.7+forge-1.19.2" = _2uAisxKA;
        "pkg-15.1.7+fabric-1.19.2" = _IKXfKSzT;
        "pkg-14.0.7+forge-1.18.2" = _f0C0FKhV;
        "pkg-14.0.7+fabric-1.18.2" = _h47liBvn;
        "pkg-18.0.1+fabric-1.20" = _sLmX6cpz;
        "pkg-18.0.1+forge-1.20" = _dv6E7bUz;
        "pkg-18.0.2+fabric-1.20" = _YPx9Kurp;
        "pkg-18.0.2+forge-1.20" = _291sIr19;
        "pkg-15.1.8+forge-1.19.2" = _PXPJ7RMy;
        "pkg-15.1.8+fabric-1.19.2" = _R9P3qVZS;
        "pkg-18.1.0+forge-1.20" = _6eE3Eg93;
        "pkg-18.1.0+fabric-1.20" = _VEjAkUh6;
        "pkg-18.1.1+forge-1.20" = _kcruX51n;
        "pkg-18.1.1+fabric-1.20" = _MgKDQk6r;
        "pkg-18.2.0+forge-1.20" = _zVu4IRwj;
        "pkg-18.2.0+fabric-1.20" = _CU6QPyel;
        "pkg-18.2.1+fabric-1.20" = _OjUnElKd;
        "pkg-18.2.1+forge-1.20" = _7DBZfmKJ;
        "pkg-19.0.1+fabric-1.20.2" = _GdcCBfsr;
        "pkg-19.0.1+forge-1.20.2" = _VAYXtmNg;
        "pkg-15.1.9+fabric-1.19.2" = _tKBYt2oi;
        "pkg-15.1.9+forge-1.19.2" = _c6e4xjFu;
        "pkg-14.0.9+forge-1.18.2" = _8LLhpnL6;
        "pkg-14.0.9+fabric-1.18.2" = _ePJNtNrh;
        "pkg-18.2.2+fabric-1.20" = _sWQln4wI;
        "pkg-18.2.2+forge-1.20" = _oTvBYBjb;
        "pkg-19.0.2+fabric-1.20.2" = _2UBAN5Dq;
        "pkg-19.0.2+forge-1.20.2" = _cKJKQtmT;
        "pkg-19.0.2+neoforge-1.20.2" = _I5Pw4wrg;
        "pkg-20.0.1+fabric-1.20.4" = _GYKugkDc;
        "pkg-20.0.1+forge-1.20.4" = _quXMOotD;
        "pkg-20.0.1+neoforge-1.20.4" = _whAeoScu;
        "pkg-20.0.2+forge-1.20.4" = _OEH7XQ9t;
        "pkg-20.0.2+fabric-1.20.4" = _wSo3eIGY;
        "pkg-20.0.2+neoforge-1.20.4" = _Qcc1Mc6d;
        "pkg-20.0.3+fabric-1.20.4" = _xOe3HQ5m;
        "pkg-18.2.3+fabric-1.20.1" = _OSsprjir;
        "pkg-20.0.3+forge-1.20.4" = _Sn1o1aF0;
        "pkg-18.2.3+forge-1.20.1" = _DiNsg4xV;
        "pkg-20.0.3+neoforge-1.20.4" = _mEj8WdY3;
        "pkg-21.0.1+fabric-1.20.6" = _af5ZU524;
        "pkg-21.0.1+forge-1.20.6" = _FpegjpTv;
        "pkg-21.0.1+neoforge-1.20.6" = _hvTcosIx;
        "pkg-18.2.4+fabric-1.20.1" = _qiY6hA56;
        "pkg-18.2.4+forge-1.20.1" = _nb8FNUFo;
        "pkg-8.1.9+forge-1.12.2" = _wTjRHejU;
        "pkg-21.0.2+fabric-1.21" = _tAqudKLK;
        "pkg-21.0.2+forge-1.21" = _uzgTIqHA;
        "pkg-21.0.2+neoforge-1.21" = _O0XzOWDX;
        "pkg-21.0.3+fabric-1.21" = _G3yMTkTr;
        "pkg-21.0.3+forge-1.21" = _pIg7lGIk;
        "pkg-21.0.3+neoforge-1.21" = _50emybsL;
        "pkg-21.1.1+fabric-1.21.1" = _XVxoXU3d;
        "pkg-21.1.1+forge-1.21.1" = _7PxQ35zP;
        "pkg-21.1.1+neoforge-1.21.1" = _SqpZ6h4S;
        "pkg-18.2.5+fabric-1.20.1" = _bss6C81q;
        "pkg-18.2.5+forge-1.20.1" = _toAiSZzl;
        "pkg-21.1.2+fabric-1.21.1" = _9juc6CQ3;
        "pkg-21.1.2+forge-1.21.1" = _MFV1WX8C;
        "pkg-21.1.2+neoforge-1.21.1" = _A1ed7hgc;
        "pkg-21.3.1+fabric-1.21.3" = _x99ZqCGa;
        "pkg-21.3.1+neoforge-1.21.3" = _ZSU4oZas;
        "pkg-21.3.2+fabric-1.21.3" = _m0uSEkaq;
        "pkg-21.3.2+neoforge-1.21.3" = _2GHXdCDQ;
        "pkg-21.1.3+fabric-1.21.1" = _EauT7WNY;
        "pkg-21.1.3+neoforge-1.21.1" = _x75PnAkU;
        "pkg-21.1.3+forge-1.21.1" = _kIpeDi8R;
        "pkg-21.3.3+fabric-1.21.3" = _fBy338Q2;
        "pkg-21.3.3+neoforge-1.21.3" = _JxycJDDK;
        "pkg-21.4.1+fabric-1.21.4" = _fHj0yJmW;
        "pkg-21.4.1+neoforge-1.21.4" = _gDsJuIU6;
        "pkg-21.1.5+fabric-1.21.1" = _GauFSLw1;
        "pkg-21.1.5+forge-1.21.1" = _7UPNoGd5;
        "pkg-21.1.5+neoforge-1.21.1" = _uFQrAvJM;
        "pkg-21.4.2+fabric-1.21.4" = _xJxVL9NN;
        "pkg-21.4.2+neoforge-1.21.4" = _5f2vV3c8;
        "pkg-21.4.3+forge-1.21.4" = _IRbl0jTY;
        "pkg-21.5.1+neoforge-1.21.5" = _Y7lithNW;
        "pkg-21.5.1+fabric-1.21.5" = _fJArpptg;
        "pkg-21.4.4+fabric-1.21.4" = _yDJ2rwns;
        "pkg-21.4.4+neoforge-1.21.4" = _CSyhtZFm;
        "pkg-21.4.4+forge-1.21.4" = _3vrypRRR;
        "pkg-21.5.2+forge-1.21.5" = _rgqfKwhj;
        "pkg-21.6.1+neoforge-1.21.6" = _7TtXmHb6;
        "pkg-21.6.1+fabric-1.21.6" = _17EVifUb;
        "pkg-21.6.2+forge-1.21.6" = _CL319mo0;
        "pkg-21.7.1+forge-1.21.7" = _MNBm8l1H;
        "pkg-21.7.1+fabric-1.21.7" = _CtomlUoN;
        "pkg-21.7.1+neoforge-1.21.7" = _RtJaN5RX;
        "pkg-21.8.1+neoforge-1.21.8" = _GDZLDNPf;
        "pkg-21.8.1+fabric-1.21.8" = _HmEMmLts;
        "pkg-21.8.1+forge-1.21.8" = _LnkjsvVV;
        "pkg-21.1.6+fabric-1.21.1" = _hOCFoQac;
        "pkg-21.1.6+forge-1.21.1" = _aT8bAGS2;
        "pkg-21.1.6+neoforge-1.21.1" = _StwKB1IQ;
        "pkg-21.8.2+fabric-1.21.8" = _6lHrJlho;
        "pkg-21.8.2+neoforge-1.21.8" = _6JGBrtXn;
        "pkg-21.8.2+forge-1.21.8" = _mXi9kGLw;
        "pkg-18.2.6+fabric-1.20.1" = _9y4MPSVS;
        "pkg-21.4.5+fabric-1.21.4" = _cJPeC6Lj;
        "pkg-21.5.3+fabric-1.21.5" = _4ll0HH77;
        "pkg-18.2.6+forge-1.20.1" = _umzsWJQd;
        "pkg-21.5.3+forge-1.21.5" = _QyRs2ivi;
        "pkg-21.4.5+forge-1.21.4" = _oebukPTx;
        "pkg-21.4.5+neoforge-1.21.4" = _LTnjTbp3;
        "pkg-21.5.3+neoforge-1.21.5" = _koAbGVkr;
        "pkg-21.9.1+fabric-1.21.9" = _dDSJbgBi;
        "pkg-21.9.1+neoforge-1.21.9" = _kAbJfinx;
        "pkg-21.9.2+fabric-1.21.9" = _IKM8gZa8;
        "pkg-21.9.2+neoforge-1.21.9" = _4Pm6kMIt;
        "pkg-21.10.1+fabric-1.21.10" = _gog2sFGz;
        "pkg-21.10.1+forge-1.21.10" = _9BEem1dl;
        "pkg-21.10.1+neoforge-1.21.10" = _z2v3q7v4;
        "pkg-21.11.1+fabric-1.21.11" = _1RPskEDP;
        "pkg-21.11.1+neoforge-1.21.11" = _ienqQTHq;
        "pkg-21.11.3+fabric-1.21.11" = _FRbpgdVD;
        "pkg-21.11.3+forge-1.21.11" = _NLdr1e57;
        "pkg-21.11.3+neoforge-1.21.11" = _UG4VEpsU;
        "pkg-18.2.8+fabric-1.20.1" = _OwtzQrKt;
        "pkg-18.2.8+forge-1.20.1" = _pHj8hyWv;
        "pkg-21.1.7+fabric-1.21.1" = _O7KkfR3Y;
        "pkg-21.1.7+neoforge-1.21.1" = _UBFLqHl0;
        "pkg-21.11.4+fabric-1.21.11" = _Z8BzLi5v;
        "pkg-21.1.7+forge-1.21.1" = _UmTEYq7m;
        "pkg-21.11.4+forge-1.21.11" = _kzPIbPuT;
        "pkg-21.11.4+neoforge-1.21.11" = _os21dCkZ;
        "pkg-21.11.5+fabric-1.21.11" = _1s1JHamL;
        "pkg-21.11.5+forge-1.21.11" = _dk17fzEm;
        "pkg-21.11.5+neoforge-1.21.11" = _hJZTzu8p;
        "pkg-26.1.0.1+fabric-26.1" = _ZlYheOfe;
        "pkg-26.1.0.1+neoforge-26.1" = _Lnhol0EM;
        "pkg-21.1.8+fabric-1.21.1" = _KPb0DKye;
        "pkg-21.1.8+forge-1.21.1" = _zw62gZIL;
        "pkg-21.1.8+neoforge-1.21.1" = _hrJBuMwg;
        "pkg-21.1.9+fabric-1.21.1" = _22zq0V2r;
        "pkg-21.1.9+neoforge-1.21.1" = _Oqp2NgN0;
        "pkg-21.1.9+forge-1.21.1" = _julzUg17;
        "pkg-26.1.2.1+fabric-26.1.2" = _AdwpjRfn;
        "pkg-26.1.2.1+neoforge-26.1.2" = _oJ7fFbz3;
        "pkg-18.2.9+fabric-1.20.1" = _GFnEjWqp;
        "pkg-21.1.10+fabric-1.21.1" = _1gVlq6sW;
        "pkg-18.2.9+forge-1.20.1" = _KOqT9kSZ;
        "pkg-21.1.10+neoforge-1.21.1" = _9CqWhYyd;
        "pkg-21.1.10+forge-1.21.1" = _6SiFYb20;
        "pkg-26.2.0.1+fabric-26.2" = _yYMxso3d;
        "pkg-26.2.0.1+neoforge-26.2" = _aRtv4z8I;
        "pkg-26.1.2.2+fabric-26.1.2" = _uFP71r7b;
