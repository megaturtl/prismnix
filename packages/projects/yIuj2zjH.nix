...
let
    ...
    in {
        ...
        "pkg-4.1.0" = _Vx1CkvJN;
        "pkg-4.0.3" = _TPiHtnkK;
        "pkg-4.1.1-Fabric-1.21.1" = _kCMK0fgb;
        "pkg-4.1.2-Fabric-1.21.1" = _JI3FMjqO;
        "pkg-4.1.3" = _tL85dMeg;
        "pkg-4.2.0" = _nEtDvynX;
        "pkg-4.2.1-NeoForge-1.21.1" = _PXkerhiw;
        "pkg-4.2.1-NeoForge-1.21.4" = _zNboVytP;
        "pkg-4.2.1-NeoForge-1.21.5-NeoForge-" = _vGrMq78U;
        "pkg-4.2.1-NeoForge-1.21.8" = _rh7hVAYZ;
        "pkg-4.2.1-NeoForge-1.21.9" = _vtM0cpoZ;
        "pkg-4.2.1-NeoForge-1.21.10" = _TnQRIHeF;
        "pkg-4.3.0-NeoForge-1.21.1" = _QNRbojUP;
        "pkg-4.3.0-NeoForge-1.21.4" = _o6GXltWH;
        "pkg-4.3.0-NeoForge-1.21.5" = _8Ug4A2ha;
        "pkg-4.3.0-NeoForge-1.21.8" = _seyYTsgk;
        "pkg-4.3.0-NeoForge-1.21.10" = _OEAXP1PT;
        "pkg-4.3.0-NeoForge-1.21.11" = _lakazNjF;
        "pkg-4.3.0-NeoForge-26.1" = _kaHq09Ya;
        "pkg-4.3.1-NeoForge-1.21.1" = _b737IBcc;
        "pkg-4.3.2-NeoForge-1.21.1" = _31R056hC;
        "pkg-4.3.1-NeoForge-26.1" = _ferVG0ku;
        "pkg-4.3.3-NeoForge-26.1" = _XQTS16LQ;
        "pkg-4.4.0" = _3wHSt3qy;
        "pkg-4.4.0-26.1.x" = _akGa8r12;
        "pkg-4.4.1-Fabric-26.1.x" = _2fyRcks3;
        "pkg-4.4.1-NeoForge-26.1.x" = _BmKMB6MI;
        "pkg-4.4.2-Fabric-26.1.x" = _w79hLlmq;
        "pkg-4.4.2-NeoForge-26.1.x" = _DUGbm0za;
        "pkg-4.4.3-Fabric-26.1.2" = _JVPljfVl;
        "pkg-4.4.3-NeoForge-26.1.2" = _3ONLaCss;
        "pkg-4.4.4-NeoForge-26.1.2" = _GoJD6A4V;
