...
let
    versions = (let
        ...
        _ejxt3pqx = {
            "id" = "ejxt3pqx";
            "file" = "AxTrade-1.26.2.jar";
            "hash" = "sha512-wfpG2zhRghL8m3m6fbMpELtXHCetTFcFLOTBxaX1NYtng8l1bW+bsUNRa5w2TK9D6VlxvNUvFQ/xu24kbXW2Xw==";
        };
        _KjvLLJVW = {
            "id" = "KjvLLJVW";
            "file" = "AxTrade-1.27.0.jar";
            "hash" = "sha512-58la7HtYSMbGIIGEc/ePHHV2CLQh91J4y4b4ueHiYcVsrxEFmYYIUqnCgIWnQ87fxqgt3DL/7WmQHubq7QymPw==";
        };
        _mo1kwu5E = {
            "id" = "mo1kwu5E";
            "file" = "AxTrade-1.27.1.jar";
            "hash" = "sha512-uAcBNKGOxSUQZxZZRsCne/WfLqwnTPJLPxdklZllekvoyT78pqrJvhtfDA+hth9RyxLJJ4mQyvdkCASNxsdmAg==";
        };
        _MJkhSula = {
            "id" = "MJkhSula";
            "file" = "AxTrade-1.27.2.jar";
            "hash" = "sha512-9lcEHs7MBJ7CPNmw/Y7Mr5PD+fefDCxJdIUVmFJnzg5bf4FypBoFXsb6M1xggwlUohd4NHuQOlsMIXi9k4KJrA==";
        };
    in {
        "skoPWRpg" = _skoPWRpg;
        "aUP5Plml" = _aUP5Plml;
        ...
        "bukkit-1.20.2" = _MJkhSula;
        "bukkit-1.20.3" = _MJkhSula;
        "bukkit-1.20.4" = _MJkhSula;
        "bukkit-1.20.5" = _MJkhSula;
        "bukkit-1.20.6" = _MJkhSula;
        "bukkit-1.21" = _MJkhSula;
        "bukkit-1.21.1" = _MJkhSula;
        "bukkit-1.21.2" = _MJkhSula;
        "bukkit-1.21.3" = _MJkhSula;
        "bukkit-1.21.4" = _MJkhSula;
        "bukkit-1.21.5" = _MJkhSula;
        "bukkit-1.21.6" = _MJkhSula;
        "bukkit-1.21.7" = _MJkhSula;
        "bukkit-1.21.8" = _MJkhSula;
        "bukkit-1.21.9" = _MJkhSula;
        "bukkit-1.21.10" = _MJkhSula;
        "bukkit-1.21.11" = _MJkhSula;
        "bukkit-26.1" = _MJkhSula;
        "bukkit-26.1.1" = _MJkhSula;
        "bukkit-26.1.2" = _MJkhSula;
        "bukkit-26.2" = _MJkhSula;
        ...
        "folia-1.20.2" = _MJkhSula;
        "folia-1.20.3" = _MJkhSula;
        "folia-1.20.4" = _MJkhSula;
        "folia-1.20.5" = _MJkhSula;
        "folia-1.20.6" = _MJkhSula;
        "folia-1.21" = _MJkhSula;
        "folia-1.21.1" = _MJkhSula;
        "folia-1.21.2" = _MJkhSula;
        "folia-1.21.3" = _MJkhSula;
        "folia-1.21.4" = _MJkhSula;
        "folia-1.21.5" = _MJkhSula;
        "folia-1.21.6" = _MJkhSula;
        "folia-1.21.7" = _MJkhSula;
        "folia-1.21.8" = _MJkhSula;
        "folia-1.21.9" = _MJkhSula;
        "folia-1.21.10" = _MJkhSula;
        "folia-1.21.11" = _MJkhSula;
        "folia-26.1" = _MJkhSula;
        "folia-26.1.1" = _MJkhSula;
        "folia-26.1.2" = _MJkhSula;
        "folia-26.2" = _MJkhSula;
        ...
        "paper-1.20.2" = _MJkhSula;
        "paper-1.20.3" = _MJkhSula;
        "paper-1.20.4" = _MJkhSula;
        "paper-1.20.5" = _MJkhSula;
        "paper-1.20.6" = _MJkhSula;
        "paper-1.21" = _MJkhSula;
        "paper-1.21.1" = _MJkhSula;
        "paper-1.21.2" = _MJkhSula;
        "paper-1.21.3" = _MJkhSula;
        "paper-1.21.4" = _MJkhSula;
        "paper-1.21.5" = _MJkhSula;
        "paper-1.21.6" = _MJkhSula;
        "paper-1.21.7" = _MJkhSula;
        "paper-1.21.8" = _MJkhSula;
        "paper-1.21.9" = _MJkhSula;
        "paper-1.21.10" = _MJkhSula;
        "paper-1.21.11" = _MJkhSula;
        "paper-26.1" = _MJkhSula;
        "paper-26.1.1" = _MJkhSula;
        "paper-26.1.2" = _MJkhSula;
        "paper-26.2" = _MJkhSula;
        ...
        "purpur-1.20.2" = _MJkhSula;
        "purpur-1.20.3" = _MJkhSula;
        "purpur-1.20.4" = _MJkhSula;
        "purpur-1.20.5" = _MJkhSula;
        "purpur-1.20.6" = _MJkhSula;
        "purpur-1.21" = _MJkhSula;
        "purpur-1.21.1" = _MJkhSula;
        "purpur-1.21.2" = _MJkhSula;
        "purpur-1.21.3" = _MJkhSula;
        "purpur-1.21.4" = _MJkhSula;
        "purpur-1.21.5" = _MJkhSula;
        "purpur-1.21.6" = _MJkhSula;
        "purpur-1.21.7" = _MJkhSula;
        "purpur-1.21.8" = _MJkhSula;
        "purpur-1.21.9" = _MJkhSula;
        "purpur-1.21.10" = _MJkhSula;
        "purpur-1.21.11" = _MJkhSula;
        "purpur-26.1" = _MJkhSula;
        "purpur-26.1.1" = _MJkhSula;
        "purpur-26.1.2" = _MJkhSula;
        "purpur-26.2" = _MJkhSula;
        ...
        "spigot-1.20.2" = _MJkhSula;
        "spigot-1.20.3" = _MJkhSula;
        "spigot-1.20.4" = _MJkhSula;
        "spigot-1.20.5" = _MJkhSula;
        "spigot-1.20.6" = _MJkhSula;
        "spigot-1.21" = _MJkhSula;
        "spigot-1.21.1" = _MJkhSula;
        "spigot-1.21.2" = _MJkhSula;
        "spigot-1.21.3" = _MJkhSula;
        "spigot-1.21.4" = _MJkhSula;
        "spigot-1.21.5" = _MJkhSula;
        "spigot-1.21.6" = _MJkhSula;
        "spigot-1.21.7" = _MJkhSula;
        "spigot-1.21.8" = _MJkhSula;
        "spigot-1.21.9" = _MJkhSula;
        "spigot-1.21.10" = _MJkhSula;
        "spigot-1.21.11" = _MJkhSula;
        "spigot-26.1" = _MJkhSula;
        "spigot-26.1.1" = _MJkhSula;
        "spigot-26.1.2" = _MJkhSula;
        "spigot-26.2" = _MJkhSula;
        "pkg-1.0.0" = _skoPWRpg;
        "pkg-1.1.0" = _aUP5Plml;
        "pkg-1.1.1" = _o1ukqSRJ;
        "pkg-1.2.0" = _WDH5F0aT;
        ...
        "pkg-1.8.1" = _hA9P4h8F;
        "pkg-1.9.0" = _u7G4lkhg;
        "pkg-1.10.0" = _h7sEPO56;
        "pkg-1.10.1" = _vlO1gT7J;
        "pkg-1.11.0" = _TEfgUwq3;
        "pkg-1.12.0" = _ksNaoQbx;
        "pkg-1.12.1" = _DxrYanEn;
        "pkg-1.12.2" = _1r6azvwV;
        "pkg-1.12.3" = _53HpqqbT;
        "pkg-1.13.0" = _RUwQVIqX;
        "pkg-1.14.0" = _1DroEAGt;
        "pkg-1.14.1" = _7pJsTVsu;
        "pkg-1.15.0" = _CZ5SeL9y;
        "pkg-1.15.1" = _Cf0tCWBt;
        "pkg-1.16.0" = _reYGKndo;
        "pkg-1.16.1" = _3tlB3qZs;
        "pkg-1.16.2" = _A1LGFF6n;
        "pkg-1.16.3" = _zD3CRnPl;
        "pkg-1.17.0" = _r0HkolBu;
        "pkg-1.18.0" = _zaQLT2h5;
        "pkg-1.18.1" = _yjBkbakZ;
        "pkg-1.18.2" = _iqNgbG8n;
        "pkg-1.19.0" = _jShn2vCG;
        "pkg-1.19.1" = _M5nWMKb3;
        "pkg-1.19.2" = _Q9RabKT7;
        "pkg-1.20.0" = _QSOdZgPV;
        "pkg-1.20.1" = _qcBynJEY;
        "pkg-1.20.2" = _BIN5JQNl;
        "pkg-1.20.3" = _qdKrMwQI;
        "pkg-1.20.4" = _m1oQ2PF3;
        "pkg-1.21.0" = _WGt3pzX6;
        "pkg-1.21.1" = _LTYkKv2N;
        "pkg-1.21.2" = _e00WEZb9;
        "pkg-1.22.0" = _ZdKOQ4XL;
        "pkg-1.23.0" = _XwZfy5iN;
        "pkg-1.23.1" = _nj0FFwAs;
        "pkg-1.24.0" = _YOF03hfT;
        "pkg-1.24.1" = _8m3fnHbw;
        "pkg-1.24.2" = _nu7dc4FF;
        "pkg-1.24.3" = _HINFyL3w;
        "pkg-1.24.4" = _gDKrHAk1;
        "pkg-1.24.5" = _26yAfEUa;
        "pkg-1.25.0" = _Cy5TRFBR;
        "pkg-1.25.1" = _siekR9xg;
        "pkg-1.25.2" = _HzlK98S5;
        "pkg-1.25.3" = _CnA5lO3i;
        "pkg-1.25.4" = _E3vspPvr;
        "pkg-1.26.0" = _3TwEncvf;
        "pkg-1.26.1" = _P3z5akfQ;
        "pkg-1.26.2" = _ejxt3pqx;
        "pkg-1.27.0" = _KjvLLJVW;
        "pkg-1.27.1" = _mo1kwu5E;
        "pkg-1.27.2" = _MJkhSula;
        "default" = _MJkhSula;
    });
