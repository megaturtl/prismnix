...
let
    ...
    in {
        ...
        "pkg-1.19.3-Fabric-2.2.0" = _dF8s3tl3;
        "pkg-1.19.4-Fabric-2.3.0" = _EVkItnSb;
        "pkg-1.19.4-Forge-2.3.0" = _zbAesA1b;
        "pkg-1.20-Forge-3.0.1" = _8j6is9ay;
        "pkg-1.20-Fabric-3.0.1" = _ymnwqLI1;
        "pkg-1.20-Forge-3.0.2" = _EuHx0coi;
        "pkg-1.20-Fabric-3.0.2" = _ipDHJmCV;
        "pkg-1.20-Forge-3.0.3" = _mwlYB7rq;
        "pkg-1.20-Fabric-3.0.3" = _lYpHN3iF;
        "pkg-1.20.4-Forge-3.4.0" = _mO2Ou7pv;
        "pkg-1.20.4-Fabric-3.4.0" = _3CEVoaSN;
        "pkg-1.20.4-Forge-3.4.1" = _SudRQQSY;
        "pkg-1.20.4-Fabric-3.4.1" = _hXyLPxPz;
        "pkg-1.20.4-Forge-3.4.2" = _2kmhqa1o;
        "pkg-1.20.4-NeoForge-3.4.2" = _hf9Pw91V;
        "pkg-1.20.4-Fabric-3.4.2" = _BIMTws7n;
        "pkg-1.20.4-Forge-3.4.3" = _c5PmoGZz;
        "pkg-1.20.4-NeoForge-3.4.3" = _ApxfQWlS;
        "pkg-1.20.4-Fabric-3.4.3" = _ZtIhxDv1;
        "pkg-1.21.1-Fabric-4.1.0" = _l4WmNjfe;
        "pkg-1.21.1-Forge-4.1.0" = _vnpz3n1Z;
        "pkg-1.21.1-NeoForge-4.1.0" = _X63nGLQb;
        "pkg-1.21.1-Forge-4.1.1" = _QNpL2Sw4;
        "pkg-1.21.1-NeoForge-4.1.1" = _AvedwcIe;
        "pkg-1.21.1-Fabric-4.1.1" = _bdpPtvTn;
        "pkg-1.21.4-NeoForge-4.4.0" = _O4kCyQUo;
