...
let
    ...
    in {
        ...
        "pkg-v2.4" = _VVMkzPpd;
        "pkg-v2.5" = _ZFfTvddb;
        "pkg-v2.5.1" = _PEZDQr0J;
        "pkg-v2.5.2" = _dBmf5bHc;
        "pkg-v2.6" = _ByQJNMCA;
        "pkg-v2.6.1" = _XPMI5Ox8;
        "pkg-2.6.2" = _7MNvIrwI;
        "pkg-v2.7" = _vGXByoxl;
        "pkg-v2.8" = _xipMWwUn;
        "pkg-v2.8.1" = _7qxcnSdK;
        "pkg-v2.9.0" = _pKuYl9Cw;
        "pkg-v2.9.0LM" = _DTZOA1rK;
        "pkg-v3.0.0LM" = _z6UrDn2D;
        "pkg-v3.0.0" = _BdirNL4L;
        "pkg-v3.0.1LM" = _szM1dvUb;
        "pkg-v3.0.1" = _Rqg2WObv;
        "pkg-v3.1.0LM" = _UvRZsoyx;
        "pkg-v3.1.0" = _g4MJ1SSa;
        "pkg-v3.1.1LM" = _8OLJK7Di;
        "pkg-v3.1.1" = _kdtjENFG;
        "pkg-v3.1.2LM" = _b5rTM230;
        "pkg-v3.1.2" = _MKzydVVj;
        "pkg-v3.2.0LM" = _JXTITgnJ;
        "pkg-v3.2.0" = _htanJoAs;
        "pkg-v3.2.1" = _N10nVTzj;
        "pkg-v3.3.0" = _JkoWi39g;
        "pkg-v3.4.0" = _J85cWjWi;
        "pkg-v3.5.0" = _D7z5VLh4;
