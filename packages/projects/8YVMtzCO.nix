...
let
    ...
    in {
        ...
        "pkg-0.2.0+forge-1.20.1" = _rEsPTTPw;
        "pkg-0.2.1+forge-1.20.1" = _hMFxa2DR;
        "pkg-0.2.1+fabric-1.20.1" = _X7eUwvGi;
        "pkg-0.2.2+forge-1.20.1" = _hDd14Jgi;
        "pkg-0.2.2+fabric-1.20.1" = _Ofz0BKEY;
        "pkg-0.2.3+fabric-1.20.1" = _NCQKknD3;
        "pkg-0.2.3+forge-1.20.1" = _qlnvwuaM;
        "pkg-0.2.4+forge-1.20.1" = _7dCwQS9H;
        "pkg-0.2.4+fabric-1.20.1" = _mD8HMkRb;
        "pkg-0.2.5+fabric-1.20.1" = _dr7roArQ;
        "pkg-0.2.5+forge-1.20.1" = _KdlhpX4s;
        "pkg-0.3.0+forge-1.20.1" = _DvmGfVCz;
        "pkg-0.3.0+fabric-1.20.1" = _1nBSUPJN;
        "pkg-0.4.0+fabric-1.20.1" = _AOKTZPSJ;
        "pkg-0.4.0+forge-1.20.1" = _ZubwVL8N;
        "pkg-0.4.1+forge-1.20.1" = _Zhjg4fVY;
        "pkg-0.4.1+fabric-1.20.1" = _iD3rfAUV;
        "pkg-0.4.2+fabric-1.20.1" = _3UNLZd9P;
        "pkg-0.4.2+forge-1.20.1" = _hdad4QFH;
        "pkg-0.4.3+forge-1.20.1" = _XGIupmFE;
        "pkg-0.4.3+fabric-1.20.1" = _IJSJgC7n;
        "pkg-0.4.5+fabric-1.20.1" = _bxEGgweC;
        "pkg-0.4.5+forge-1.20.1" = _rIAivc0b;
        "pkg-0.4.6+forge-1.20.1" = _uTnlwKjf;
        "pkg-0.4.6+fabric-1.20.1" = _cQz5iHNo;
        "pkg-0.5" = _lPFqM7PT;
        "pkg-0.6.0" = _rTSuhuYa;
        "pkg-0.6.1" = _kPgUbHc2;
        "pkg-0.6.2" = _MX6yMZq9;
