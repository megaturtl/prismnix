...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.21.1-neoforge" = _PMiDVyJR;
        "pkg-1.0.0+1.21.10-fabric" = _RA8xoByf;
        "pkg-1.0.0+1.21.10-forge" = _bovrrDhf;
        "pkg-1.0.0+1.21.10-neoforge" = _m9mYdaCL;
        "pkg-1.0.0+1.21.11-neoforge" = _N5m25Sr8;
        "pkg-1.0.0+1.21.11-forge" = _PtwEB7tl;
        "pkg-1.0.0+1.21.11-fabric" = _tNh0AROT;
        "pkg-1.1.1+1.21.1-neoforge" = _DndEsICZ;
        "pkg-1.1.1+1.20.1-forge" = _fpoMi78z;
        "pkg-1.1.1+1.20.1-fabric" = _7v7sNaww;
        "pkg-1.1.1+1.21.1-fabric" = _xUzd4ywJ;
        "pkg-1.1.1+1.21.10-fabric" = _rngoyuD3;
        "pkg-1.1.1+1.21.11-fabric" = _VeMaeTyU;
        "pkg-1.2.0+1.21.11-neoforge" = _PYJAw498;
        "pkg-1.2.0+1.21.10-neoforge" = _J6ePccki;
        "pkg-1.2.0+1.21.1-neoforge" = _bE2qbHBp;
        "pkg-1.2.0+1.21.11-fabric" = _ItupOe8K;
        "pkg-1.2.0+1.21.10-fabric" = _IiuZZxCs;
        "pkg-1.2.0+1.21.1-fabric" = _5b5zeqHN;
        "pkg-1.2.0+1.21.11-forge" = _DtSySym7;
        "pkg-1.2.0+1.21.10-forge" = _k7YbgzeX;
        "pkg-1.2.1+1.21.1-neoforge" = _Lo2JmCVA;
        "pkg-1.2.1+1.21.10-neoforge" = _CpVKVFdA;
        "pkg-1.2.2+1.21.10-neoforge" = _fLRamN39;
        "pkg-1.2.2+1.21.1-neoforge" = _bvrDEd6u;
        "pkg-1.2.0+26.1-snapshot-7-fabric" = _fjpsDCgi;
        "pkg-1.2.0+26.1-snapshot-7-neoforge" = _QZfzUkP2;
        "pkg-1.2.1+1.21.11-neoforge" = _re2ovAtP;
        "pkg-1.2.3+1.21.10-neoforge" = _TBPLlV13;
        "pkg-1.2.3+1.21.1-neoforge" = _xgFqRg4Z;
        "pkg-1.2.1+1.21.11-forge" = _mSpAPWGU;
        "pkg-1.2.1+1.21.10-forge" = _181W4L5T;
        "pkg-1.2.1+1.21.11-fabric" = _Trk0nQFm;
        "pkg-1.2.1+1.21.10-fabric" = _v2WTFh25;
        "pkg-1.2.1+1.21.1-fabric" = _vDkysYSs;
        "pkg-1.2.1+26.1-fabric" = _exM115HD;
        "pkg-1.2.1+26.1-neoforge" = _D6xH4jyo;
        "pkg-26.1.2.0" = _K4Uoe0Bn;
        "pkg-1.2.4+1.21.1-neoforge" = _yJODCqaW;
