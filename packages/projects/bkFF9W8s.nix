...
let
    versions = (let
        ...
        _Q4jxn2Xc = {
            "id" = "Q4jxn2Xc";
            "file" = "CF32PA-2026r17.zip";
            "hash" = "sha512-McKgzJ7pZ9XFL/zVPDENUcgaaprcVSRpiFPn3HHSkhGM+V56igBv0X4GpqxKpQ69wX+9VrBMT/v60sesinekaA==";
        };
        _dpFvjZP4 = {
            "id" = "dpFvjZP4";
            "file" = "CF32PA-2026r18.zip";
            "hash" = "sha512-cW8CCBzS+3JgP99U+2f2K6/1nZBgpQaVDnu5LBZUds2kKDK5w1iQ4O0ojDTv6rpjuI2dufD8OJVDH6FNL4vy1A==";
        };
        _bVvy1Fj0 = {
            "id" = "bVvy1Fj0";
            "file" = "CF32PA-2026r19.zip";
            "hash" = "sha512-xCLzYUCXp9/5hi08YLbzSTNCrZWff5k0GxmOvL0whdNTocABXFxu9yZir1SbWe1N5uvx4IG3xH8TdG1ceQdA5A==";
        };
        _RXhC3xZk = {
            "id" = "RXhC3xZk";
            "file" = "CF32PA-2026r20.zip";
            "hash" = "sha512-PKHLD+XZ1+OWIweigIzIUgwlv5ELkSBAwTIyxdqbxLBo6E0Z7XBuHyQTMkPgt7xPxO1aElT0XgnaEDnnSXiCiw==";
        };
        _S5AOXuR7 = {
            "id" = "S5AOXuR7";
            "file" = "CF32PA-2026r21.zip";
            "hash" = "sha512-MWTPMvg0Ilc7Ht7wFWk3OTb61MKtLQLjyiG1xg4A4Jf/xnbodU7TUuJGNuzwCmjSgMRSU/mY1ezt+t7uMM13sg==";
        };
    in {
        "m3OXlK7v" = _m3OXlK7v;
        "eOHTGwRB" = _eOHTGwRB;
        ...
        "minecraft-26.2" = _S5AOXuR7;
        "minecraft-26.3-snapshot-1" = _RXhC3xZk;
        "minecraft-26.3-snapshot-2" = _RXhC3xZk;
        "minecraft-26.3-snapshot-3" = _RXhC3xZk;
        "minecraft-26.3-snapshot-4" = _RXhC3xZk;
        "minecraft-26.3-snapshot-5" = _RXhC3xZk;
        "minecraft-26.3-snapshot-6" = _RXhC3xZk;
        "minecraft-26.3-snapshot-7" = _RXhC3xZk;
        "minecraft-26.3-snapshot-8" = _RXhC3xZk;
        "minecraft-26.3-snapshot-9" = _RXhC3xZk;
        "minecraft-26.3-snapshot-10" = _RXhC3xZk;
        "minecraft-26.3-pre-1" = _RXhC3xZk;
        "minecraft-26.3-pre-2" = _RXhC3xZk;
        "minecraft-26.3-pre-3" = _RXhC3xZk;
        "minecraft-26.3" = _S5AOXuR7;
        "pkg-1.20.2" = _m3OXlK7v;
        "pkg-Pre1.21" = _eOHTGwRB;
        "pkg-2025r1" = _A3myTBg5;
        "pkg-2025r2" = _PmmEgr6h;
        "pkg-2025r3" = _FSxCqtQd;
        "pkg-2025r4" = _GjeLhXIW;
        "pkg-2025r5" = _YC44iEAI;
        "pkg-2025r6" = _pSFCCLdk;
        "pkg-2025r7" = _ZcMzWR35;
        "pkg-2025r8" = _JRqNKQDB;
        "pkg-2025r9" = _OEkW8Y3q;
        "pkg-2025r10" = _Zn7VxXNv;
        "pkg-2025r11" = _tGOJ5JCL;
        "pkg-2025r12" = _B3KZ3Sz2;
        "pkg-2025r13" = _vnEgzyyK;
        "pkg-2025r14" = _YMMJfQkf;
        "pkg-2025r15" = _7ZD7nQAT;
        "pkg-2025r16" = _HW49xV51;
        "pkg-2025r17" = _QsR7LlGL;
        "pkg-2025r18" = _3e5RrZgT;
        "pkg-2025r19" = _34dKhaeK;
        "pkg-2025r20" = _RuuWKkWG;
        "pkg-2025r21" = _tu7aORp0;
        "pkg-2025r22" = _XInofMK6;
        "pkg-2025r23" = _esS1pS3j;
        "pkg-2025r24" = _UuYuth5q;
        "pkg-2026r1" = _BRUEbnD0;
        "pkg-2026r2" = _oZniaYwc;
        "pkg-2026r3" = _hL5y5GHk;
        "pkg-2026r4" = _PmNNC8Fp;
        "pkg-2026r5" = _fOtpL4Fa;
        "pkg-2026r6" = _VXszafns;
        "pkg-2026r7" = _nSfnN8SP;
        "pkg-2026r8" = _FOFshcFG;
        "pkg-2026r9" = _PkL4LmuO;
        "pkg-2026r10" = _K7Hn5UWz;
        "pkg-2026r11" = _60BT9SFw;
        "pkg-2026r12" = _mJH0aJ3b;
        "pkg-2026r13" = _fKfNH0TR;
        "pkg-2026r14" = _3xUCixqP;
        "pkg-2026r15" = _kZGe8i8v;
        "pkg-2026r16" = _eTaRnAV0;
        "pkg-2026r17" = _Q4jxn2Xc;
        "pkg-2026r18" = _dpFvjZP4;
        "pkg-2026r19" = _bVvy1Fj0;
        "pkg-2026r20" = _RXhC3xZk;
        "pkg-2026r21" = _S5AOXuR7;
        "default" = _S5AOXuR7;
    });
