...
let
    versions = (let
        ...
        _zQBIevPY = {
            "id" = "zQBIevPY";
            "file" = "reobf-kimetsunoyaibamultiplayer-1.6.551.jar";
            "hash" = "sha512-Jhc2RnKWC/cVqhN2Sw1HdZL+7B1eSSRQ68/DP5ir19cHnrsHlh2RmyFGujx1XZ3IeHQL5VVpVxo372NkVxAzVw==";
        };
        _mz2AhPSL = {
            "id" = "mz2AhPSL";
            "file" = "reobf-kimetsunoyaibamultiplayer-1.6.552.jar";
            "hash" = "sha512-vbQ6Lh7dnFi/xf4rfIAUYz8Cx5tWo+ulag799l+GToxWrZUZYREnIcj85LINqYgF80fNhi2/iYzHB+SSWDZ4/g==";
        };
        _HN3YnmRW = {
            "id" = "HN3YnmRW";
            "file" = "reobf-kimetsunoyaibamultiplayer-1.6.553.jar";
            "hash" = "sha512-x9vWRU9aoi7biYia56WVwKYZUDW7KwhSv3ZZr6veE8ZMY7yH3dhf3dg5wGsDaDw1FsruZt0WsRNKilHwxkY6Ng==";
        };
        _vGvqywXm = {
            "id" = "vGvqywXm";
            "file" = "reobf-kimetsunoyaibamultiplayer-1.6.554.jar";
            "hash" = "sha512-xbynGz1a5rQLjM7wNdsZA/u6bCqYTvCHHSiWL1R9T2EK/VpUbJzisl/IuU3ruWm1rogWnjWQg8G+N8/7Q3q/LQ==";
        };
        _Ug3zI4OM = {
            "id" = "Ug3zI4OM";
            "file" = "reobf-kimetsunoyaibamultiplayer-1.6.555.jar";
            "hash" = "sha512-37rq8xDGtmQCRDmZdSCY31db0Og7yUb66/AYeQ1FS3PmZHHxmgvFynDcVTbrWeCubsaEMk6/kUVdPtB3nVdk0w==";
        };
        _3pfHZiiD = {
            "id" = "3pfHZiiD";
            "file" = "reobf-kimetsunoyaibamultiplayer-1.6.556.jar";
            "hash" = "sha512-ImGrW0wWXJB30u5dwH8GTR+5PIbbymKfbVkmr7bRD8pEJImiW3pPtPkXoh+2g4UMPOfrkDaNhDEdE2wMeAFRXw==";
        };
        _j194U8bL = {
            "id" = "j194U8bL";
            "file" = "reobf-kimetsunoyaibamultiplayer-1.6.557.jar";
            "hash" = "sha512-RxCSpyEjTHubb+alxCSvJNc07J2AMkOb3cJvlPGDBpbM7ybsQm4e7C/lp/RZczQgzDF+xycwDSN7byJCIoI+lQ==";
        };
        _ZFovjMKA = {
            "id" = "ZFovjMKA";
            "file" = "reobf-kimetsunoyaibamultiplayer-1.6.558.jar";
            "hash" = "sha512-djX8ngEDOfGwk7osGrSG6pa/+TBPuhKMTgkEEQq1WfXbORHBUlBSOaaGnx4rnbO7rf6AbcuAoXI18cpVVvL+Sg==";
        };
        _71YOvFup = {
            "id" = "71YOvFup";
            "file" = "reobf-kimetsunoyaibamultiplayer-1.6.559.jar";
            "hash" = "sha512-TgSUJvCqS15067sei0KJVv2Yh3KuKje4+qF1G6cf7x2/wcyd3+BOtQeYDG6uiLYdwuhfQzR6EcKP03EeDBPzTg==";
        };
        _zb0EDkng = {
            "id" = "zb0EDkng";
            "file" = "reobf-kimetsunoyaibamultiplayer-1.6.56.jar";
            "hash" = "sha512-4AMcxi3oK/O7fWz5fezq3nAoGYl2P7JEBDLWEnGge4HuU+yTCDni8ahHtIO4EW2RdEb7J4YCbu9FPJWRT+BBYg==";
        };
        _Y7mj8lI4 = {
            "id" = "Y7mj8lI4";
            "file" = "reobf-kimetsunoyaibamultiplayer-1.6.561.jar";
            "hash" = "sha512-qosvumeWfHYedIjzv4YNf7guxw7JOFq4CXDzpyIAfGzFiEbZwl7oAIhPBIwhEzM7gJJJ3L0d6sQTatx+L05dlg==";
        };
        _m3L4rLCw = {
            "id" = "m3L4rLCw";
            "file" = "reobf-kimetsunoyaibamultiplayer-1.6.562.jar";
            "hash" = "sha512-+rR+a789KHTjOj2LwYgRxesLoL7XYmenuR1Q7BPrdwNU5shQjSnPf2pYDnv69FEm8a3sY6fzlRugipgs91ZV2w==";
        };
        _oc2xaTC0 = {
            "id" = "oc2xaTC0";
            "file" = "reobf-kimetsunoyaibamultiplayer-1.6.563.jar";
            "hash" = "sha512-IjQfG2FB2LIGE1GJSgYuT218ztxMP08O7R2vI/VmfRPYYH4UcG3K+0LFSPdNEO058HQAdPbJ3PgmOcZv1/GY0g==";
        };
        _3Ku2BK8O = {
            "id" = "3Ku2BK8O";
    ...
    in {
        ...
        "pkg-1.2.3" = _9yMzfCe7;
        "pkg-1.3.0" = _6dPORuQx;
        "pkg-1.3.89" = _UIGw2cZO;
        "pkg-1.4.04" = _9AisAx48;
        "pkg-1.5.18" = _4yhEOY8S;
        "pkg-1.5.21" = _nkjlqh8e;
        "pkg-1.5.24" = _OhzjJwS8;
        "pkg-1.5.29" = _dCkTxwfe;
        "pkg-1.5.3" = _l9YryD5X;
        "pkg-1.5.41" = _WtJnT2yJ;
        "pkg-1.5.66" = _mrdu7nD8;
        "pkg-1.5.68" = _beuHsxKs;
        "pkg-1.5.70" = _Wgy0eTok;
        "pkg-1.5.71" = _byuYlVnR;
        "pkg-1.5.72" = _qHumDFb6;
        "pkg-1.5.73" = _AMTks1wJ;
        "pkg-1.5.75" = _b5xjz9LU;
        "pkg-1.5.77" = _a2q9LV6q;
        "pkg-1.5.79" = _stMwY9CH;
        "pkg-1.5.81" = _lQq89D4V;
        "pkg-1.5.82" = _rGbn18WK;
        "pkg-1.5.83" = _KvGYPFk2;
        "pkg-1.5.84" = _MFnJ5dkA;
        "pkg-1.5.95" = _DIXsb88T;
        "pkg-1.5.97" = _EtHUfosO;
        "pkg-1.6.11" = _oo54HMl1;
        "pkg-1.6.17" = _ST722rrR;
        "pkg-1.6.20" = _SGyhxTo7;
        "pkg-1.6.21" = _FUfyOp5y;
        "pkg-1.6.2999" = _eJSxfW1A;
        "pkg-1.6.3" = _SrWyTnwQ;
        "pkg-1.6.32" = _EZaiBMOs;
        "pkg-1.6.353" = _novCHCjC;
        "pkg-1.6.36" = _lAzZEZPB;
        "pkg-1.6.361" = _71YTGsGI;
        "pkg-1.6.364" = _VkjsiNiH;
        "pkg-1.6.37" = _EgIgdCP4;
        "pkg-1.6.38" = _5k6qqyCp;
        "pkg-1.6.381" = _zXnUAgPV;
        "pkg-1.6.382" = _NNO6fEQH;
        "pkg-1.6.383" = _OauG4Ez9;
        "pkg-1.6.384" = _AzgLbbfu;
        "pkg-1.6.386" = _hG6DUskB;
        "pkg-1.6.387" = _HAjyPBlZ;
        "pkg-1.6.389" = _FQXebf3u;
        "pkg-1.6.39" = _Lod5q3Za;
        "pkg-1.6.391" = _3RfqULxL;
        "pkg-1.6.392" = _SmYbeDyX;
        "pkg-1.6.393" = _qiymT3ra;
        "pkg-1.6.394" = _lOcY4IVs;
        "pkg-1.6.395" = _kYp3FZNQ;
        "pkg-1.6.397" = _ubyJTXU3;
        "pkg-1.6.398" = _s1EaVBD0;
        "pkg-1.6.399" = _tVsqfCXH;
        "pkg-1.6.3991" = _ua1DFp7j;
        "pkg-1.6.3992" = _wFuPDBRF;
        "pkg-1.6.3993" = _srFoWd0R;
        "pkg-1.6.3995" = _BvXVIWgY;
        "pkg-1.6.40" = _YWbcCIML;
        "pkg-1.6.41" = _vnm9XoqM;
        "pkg-1.6.421" = _phVBQCS0;
        "pkg-1.6.422" = _Ht49Lo7P;
        "pkg-1.6.423" = _X98csWbi;
        "pkg-1.6.44" = _VQNRwieB;
        "pkg-1.6.441" = _9Ef2Ne8a;
        "pkg-1.6.442" = _vWnnuf4E;
        "pkg-1.6.443" = _7t2E8IvP;
        "pkg-1.6.444" = _wWwx0uRl;
        "pkg-1.6.445" = _27jNEk31;
        "pkg-1.6.447" = _8fLovfFs;
        "pkg-1.6.448" = _2snHSERR;
        "pkg-1.6.449" = _5mqZquBh;
        "pkg-1.6.45" = _7oIphpOv;
        "pkg-1.6.451" = _F7z4orNG;
        "pkg-1.6.452" = _2Osdi3Fs;
        "pkg-1.6.453" = _hQYwwG6S;
        "pkg-1.6.455" = _sDgZyS4a;
        "pkg-1.6.456" = _37K2pTPw;
        "pkg-1.6.457" = _7jYLsnXB;
        "pkg-1.6.458" = _vNVXvAAw;
        "pkg-1.6.459" = _2mTMHYso;
        "pkg-1.6.46" = _tIe5fx72;
        "pkg-1.6.461" = _5XICDxmL;
        "pkg-1.6.47" = _y4t3alCl;
        "pkg-1.6.471" = _q8cwRcIj;
        "pkg-1.6.472" = _6OtHXaDd;
        "pkg-1.6.474" = _KBsaBSVB;
        "pkg-1.6.475" = _5KDYNK94;
        "pkg-1.6.476" = _1PxPhmIA;
        "pkg-1.6.478" = _UCcUmzfO;
        "pkg-1.6.479" = _WJIjWy1Q;
        "pkg-1.6.482" = _3OgrgYPk;
        "pkg-1.6.483" = _s8mGWjPu;
        "pkg-1.6.484" = _x004LM2G;
        "pkg-1.6.485" = _g3SXHGGi;
        "pkg-1.6.486" = _CG3ZnmeJ;
        "pkg-1.6.487" = _R6LNU2cQ;
        "pkg-1.6.488" = _fiA7zYT7;
        "pkg-1.6.489" = _jwu9FVQx;
        "pkg-1.6.49" = _Us1Z2mBg;
        "pkg-1.6.492" = _GhcJYiBJ;
        "pkg-1.6.493" = _lLJ3D6Uv;
        "pkg-1.6.494" = _nqL3cciX;
        "pkg-1.6.495" = _yZRqc0kN;
        "pkg-1.6.496" = _ZuTRNMvw;
        "pkg-1.6.497" = _mlTlxTIH;
        "pkg-1.6.499" = _RfCbdxpJ;
        "pkg-1.6.5" = _fHkx89Yq;
        "pkg-1.6.51" = _c2TgnnM4;
        "pkg-1.6.52" = _FE2wvzvQ;
        "pkg-1.6.53" = _MX2W8bY7;
        "pkg-1.6.531" = _17BQn2cZ;
        "pkg-1.6.534" = _kZj6amki;
        "pkg-1.6.535" = _lsYPhYRu;
        "pkg-1.6.536" = _8yS8DEhA;
        "pkg-1.6.537" = _c1numEBi;
        "pkg-1.6.538" = _AdGqlIF3;
        "pkg-1.6.539" = _mJ1k9pCy;
        "pkg-1.6.54" = _dmRsaadB;
        "pkg-1.6.541" = _CLlClfOn;
        "pkg-1.6.542" = _iHBnANSM;
        "pkg-1.6.543" = _LMzrqBpy;
        "pkg-1.6.545" = _C5Gk9xtu;
        "pkg-1.6.546" = _jUmusI9p;
        "pkg-1.6.547" = _oCWe9cvd;
        "pkg-1.6.548" = _sAAxeLLC;
        "pkg-1.6.549" = _ccqFBbS7;
        "pkg-1.6.551" = _zQBIevPY;
        "pkg-1.6.552" = _mz2AhPSL;
        "pkg-1.6.553" = _HN3YnmRW;
        "pkg-1.6.554" = _vGvqywXm;
        "pkg-1.6.555" = _Ug3zI4OM;
        "pkg-1.6.556" = _3pfHZiiD;
        "pkg-1.6.557" = _j194U8bL;
        "pkg-1.6.558" = _ZFovjMKA;
        "pkg-1.6.559" = _71YOvFup;
        "pkg-1.6.56" = _zb0EDkng;
        "pkg-1.6.561" = _Y7mj8lI4;
