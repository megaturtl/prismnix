...
let
    versions = (let
        ...
        _iztlhhMH = {
            "id" = "iztlhhMH";
            "file" = "Abibliophobia.zip";
            "hash" = "sha512-XnlhztrP8+No7MezjfeJNmYPqZ3fEEPT8YKBRF1F1vS13bhXUnVaFitAw6cGqdlt3Ls897bdcmUGSVjJ/nZWXA==";
        };
        _EvZZZ1Fx = {
            "id" = "EvZZZ1Fx";
            "file" = "Abibliophobia.zip";
            "hash" = "sha512-zwYcyOkoHGv/zpNB7qaOYi+iJ0TWOlTFEMM/LqhUl4cQdjfHQBaWdNyJKY44JTUBfsKV19VEPtmJihZUUCCNhA==";
        };
        _HY5KfLR5 = {
            "id" = "HY5KfLR5";
            "file" = "Abibliophobia.zip";
            "hash" = "sha512-dbu66YWP/TPWenQzkdARqxDfM4HazXJgxK93Q31DngucOYNn6DEkbRRUEopNnY5zWGVV/BBh/z4wB9V5MRBPdA==";
        };
    in {
        "SSiWRxgD" = _SSiWRxgD;
        "9ayDE13Y" = _9ayDE13Y;
        ...
        "EvZZZ1Fx" = _EvZZZ1Fx;
        "HY5KfLR5" = _HY5KfLR5;
        "minecraft-1.18" = _HY5KfLR5;
        "minecraft-1.18.1" = _HY5KfLR5;
        "minecraft-1.18.2" = _HY5KfLR5;
        "minecraft-1.19" = _HY5KfLR5;
        "minecraft-1.19.1" = _HY5KfLR5;
        "minecraft-1.19.2" = _HY5KfLR5;
        "minecraft-1.19.3" = _HY5KfLR5;
        "minecraft-1.19.4" = _HY5KfLR5;
        "minecraft-1.20" = _HY5KfLR5;
        "minecraft-1.20.1" = _HY5KfLR5;
        "minecraft-1.20.2" = _HY5KfLR5;
        "minecraft-1.20.3" = _HY5KfLR5;
        "minecraft-1.20.4" = _HY5KfLR5;
        "minecraft-1.20.5" = _HY5KfLR5;
        "minecraft-1.20.6" = _HY5KfLR5;
        "minecraft-1.21" = _HY5KfLR5;
        "minecraft-1.21.1" = _HY5KfLR5;
        "minecraft-1.21.2" = _HY5KfLR5;
        "minecraft-1.21.3" = _HY5KfLR5;
        "minecraft-1.21.4" = _HY5KfLR5;
        "minecraft-1.21.5" = _HY5KfLR5;
        "minecraft-1.21.6" = _HY5KfLR5;
        "minecraft-1.21.7" = _HY5KfLR5;
        "minecraft-1.21.8" = _HY5KfLR5;
        "minecraft-1.21.9" = _HY5KfLR5;
        "minecraft-1.21.10" = _HY5KfLR5;
        "minecraft-1.21.11" = _HY5KfLR5;
        ...
        "minecraft-1.17" = _HY5KfLR5;
        "minecraft-1.17.1" = _HY5KfLR5;
        "minecraft-26.1" = _HY5KfLR5;
        "minecraft-26.1.1" = _HY5KfLR5;
        "minecraft-26.1.2" = _HY5KfLR5;
        "minecraft-26.2" = _HY5KfLR5;
        "minecraft-26.3" = _HY5KfLR5;
        "pkg-1.0.1" = _SSiWRxgD;
        "pkg-1.1.1" = _9ayDE13Y;
        "pkg-1.2.0" = _qzXH79oP;
        "pkg-1.3.1" = _KgrVzD9U;
