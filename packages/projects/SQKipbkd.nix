...
let
    versions = (let
        ...
        _39MxXWdh = {
            "id" = "39MxXWdh";
            "file" = "fix-mc-stats-neoforge-1.21-2.4.2.jar";
            "hash" = "sha512-gKHBVBIN0UO5bjgyB7EqpUpJexflfYxWdEyhgnDLf6RxL3BCk64iVctmtCVLxjWv/WBA/A2YWyvVfe/zQRg5vg==";
        };
        _6yELpHgV = {
            "id" = "6yELpHgV";
            "file" = "fix-mc-stats-fabric-1.21-2.4.2.jar";
            "hash" = "sha512-L8zphJym2exk2TQRz+MxaVlnHOGWXB0fc1FFZA2EuE+yX8EOWaNF/Ww60smrnqclz2kUwsw/GJIX6SL/UV0teg==";
        };
        _3nSfwZfU = {
            "id" = "3nSfwZfU";
            "file" = "fix-mc-stats-neoforge-1.21.11-2.4.2.jar";
            "hash" = "sha512-UVdcv6Sg2dFLl0nuAwXSM+NI/TGWv+gXLzSgPfUgFpixaGDZ+yomN0cnGRnFOUe9sxL1qpKq6PEX9ltEzpi4zg==";
        };
        _yFrzHN4Z = {
            "id" = "yFrzHN4Z";
            "file" = "fix-mc-stats-fabric-1.21.11-2.4.2.jar";
            "hash" = "sha512-ui/R42h7y3uqSPi8oQup1eQGDJu1Bd2Idia6r5MESFOs6XJQSsbM6m3Kz5f14iNIRW5DQm1hyNSkU12NBy6vNQ==";
        };
        _HipRgzhW = {
            "id" = "HipRgzhW";
            "file" = "fix-mc-stats-neoforge-26.1-2.4.2.jar";
            "hash" = "sha512-zxq4+5h461rxD3m42mjDBibe15qdZIHHGpJrlV70J5KoNE9FFnfIcSVAlf5sNkSgRy26UQGiHMH+W7UaKH7fCQ==";
        };
        _5f3T1FYM = {
            "id" = "5f3T1FYM";
            "file" = "fix-mc-stats-fabric-26.1-2.4.2.jar";
            "hash" = "sha512-KTs1/huqiaFgnjANm7cAvCKuia0Le0gJ5pUVGiB9NOjBwAY+B6D/XEahSoQ8Mh2rk0gpyNLuIVsvVNKYgb7IYw==";
        };
        _DrPkek1i = {
            "id" = "DrPkek1i";
            "file" = "fix-mc-stats-neoforge-26.2-2.4.2.jar";
            "hash" = "sha512-F23Qitqpf0JyIq8SjV+Lfjk+bQuepiGIFzeLKYhJYy0CKBHip6rTwcX3UzWCru/rhVjKZ9khf95DIvAkHe39/A==";
        };
        _TQlr7aHc = {
            "id" = "TQlr7aHc";
            "file" = "fix-mc-stats-fabric-26.2-2.4.2.jar";
            "hash" = "sha512-SERMptdu+RANeVQBbG6jtkHHNUSlpgav+UgQQIm91JDVPf7TgXCvZXSFFCTry1GdyKGRYzSfMPmq509ftFQazA==";
        };
        _DNl5t9YH = {
            "id" = "DNl5t9YH";
            "file" = "fix-mc-stats-neoforge-26.2-2.4.3.jar";
            "hash" = "sha512-xok6UV03ZPlxIqUDk9xks3CiQWEGYRjKG6lfE026vjBz/EinyIlxOO435I5gNGZq2eqN9NeXY4p6uiF91EAi+w==";
        };
        _KYYQqEh0 = {
            "id" = "KYYQqEh0";
            "file" = "fix-mc-stats-fabric-26.2-2.4.3.jar";
            "hash" = "sha512-kIuml5VEM6Lwuuh/DDcGwLYRXnm+x50IRQtJX1SS1XfYxEU6p7G7+83UCZ68RG12ZOJjJb2WbuD2X/lpcnyAvQ==";
        };
        _TbG7sUyV = {
            "id" = "TbG7sUyV";
            "file" = "fix-mc-stats-neoforge-1.21.11-2.4.3.jar";
            "hash" = "sha512-SFOqMxPxTkavrtQU1gcu+xJeZ0iuJS3XN9HpsgFem/NDHT1nYJmXBfke9H9PM3rDt98Q7ElbfTbftLfs148lsg==";
        };
        _ipIfV3jK = {
            "id" = "ipIfV3jK";
            "file" = "fix-mc-stats-fabric-1.21.11-2.4.3.jar";
            "hash" = "sha512-E7dGmDgHouw9+63HPHEWCvBXW9Rdm1YYxngOLMQ+KleS28CaEl1mFz2GCyv898ZkWxqpzpdPNEJOrNzNF1T0nw==";
        };
        _HaniL23I = {
            "id" = "HaniL23I";
            "file" = "fix-mc-stats-neoforge-26.1-2.4.3.jar";
            "hash" = "sha512-aGLO6f8KObOKA9dgOTmCWQ1qK+pB+5Q10u8g+1alPPheP8vZjTSsNcJ2VHYJIUkxFnQcR7yjaPRXzKXLb9JS5g==";
        };
        _851focDx = {
            "id" = "851focDx";
            "file" = "fix-mc-stats-fabric-26.1-2.4.3.jar";
            "hash" = "sha512-nsAnWnzgxQFqM3dKP6XTP1PgB2ejybUQwCubdEJNOtl3/gAiNj+zRSsvITYZ+014HYUaQ6kwyzE4QZRB5Pn/Ew==";
        };
        _AgSzpALs = {
            "id" = "AgSzpALs";
            "file" = "fix-mc-stats-neoforge-26.3-2.5.0-SNAPSHOT.jar";
            "hash" = "sha512-nmQ555QIo05KwTbElFxoODSBxOtitNZx9FHhILIRxA0qaNfo4OJFBUeqry+JqXqtaUhjChoBhvaWLp+rrRU+vA==";
        };
        _KiACqU67 = {
            "id" = "KiACqU67";
            "file" = "fix-mc-stats-fabric-26.3-2.5.0.jar";
            "hash" = "sha512-M2kCWxUyTQsUYl5fimD99e1TAOrSAAFJfW8Le6ZFY+osLMIEf17X4wIrCgjREHLMbVaKbHPhTvrzR6UuAHtYqA==";
        };
    in {
        "pdNcFMrl" = _pdNcFMrl;
        "oEIhJOYC" = _oEIhJOYC;
        ...
        "fabric-1.21" = _6yELpHgV;
        "fabric-1.21.1" = _6yELpHgV;
        ...
        "fabric-1.21.11" = _ipIfV3jK;
        "fabric-26.1" = _851focDx;
        "fabric-26.1.1-rc-1" = _HjYPJTTL;
        "fabric-26.1.1" = _851focDx;
        "fabric-26.1.2-rc-1" = _HjYPJTTL;
        "fabric-26.1.2" = _851focDx;
        "fabric-26.2" = _KYYQqEh0;
        "fabric-26.3" = _KiACqU67;
        "quilt-1.20.4" = _cbxj3mC1;
        "quilt-1.20.5" = _GJ4P0QDq;
        "quilt-1.20.6" = _GJ4P0QDq;
        "quilt-1.21" = _6yELpHgV;
        "quilt-1.21.1" = _6yELpHgV;
        ...
        "quilt-1.21.11" = _ipIfV3jK;
        "quilt-26.1" = _851focDx;
        "quilt-26.1.1-rc-1" = _HjYPJTTL;
        "quilt-26.1.1" = _851focDx;
        "quilt-26.1.2-rc-1" = _HjYPJTTL;
        "quilt-26.1.2" = _851focDx;
        "quilt-26.2" = _KYYQqEh0;
        "quilt-26.3" = _KiACqU67;
        "neoforge-1.21.11" = _TbG7sUyV;
        "neoforge-1.21" = _39MxXWdh;
        "neoforge-1.21.1" = _39MxXWdh;
        "neoforge-26.1" = _HaniL23I;
        "neoforge-26.1.1-rc-1" = _zVVQGLxD;
        "neoforge-26.1.1" = _HaniL23I;
        "neoforge-26.1.2" = _HaniL23I;
        "neoforge-26.2" = _DNl5t9YH;
        "neoforge-26.3" = _AgSzpALs;
        "pkg-1.0.0-SNAPSHOT" = _VzAydmfq;
        "pkg-1.0.0" = _cbxj3mC1;
        "pkg-1.0.1" = _BH6v5Q5G;
        "pkg-1.0.2" = _GJ4P0QDq;
        "pkg-1.1.0" = _RMkkb2Qy;
        ...
        "pkg-1.3.4" = _pBf1BunJ;
        "pkg-1.3.5" = _plDlAe6V;
        "pkg-2.0.0-SNAPSHOT-1" = _U6Hz7wOE;
        "pkg-2.0.0-SNAPSHOT-2" = _9PFRkQ4Z;
        "pkg-2.0.0-SNAPSHOT-3" = _kVr7Z7Zr;
        "pkg-2.0.0" = _XziUtBSr;
        "pkg-2.0.0+1.21.5" = _CcNZhYMi;
        "pkg-2.0.1" = _nzp5EPh8;
        "pkg-2.1.0" = _Rv1RljLH;
        "pkg-neoforge-2.2.0-SNAPSHOT" = _kGVBsTgV;
        "pkg-fabric-2.2.0-SNAPSHOT-1" = _orWh4vNg;
        "pkg-neoforge-2.2.0-SNAPSHOT-1" = _AXJRe1rh;
        "pkg-neoforge-2.2.0+1.21.1" = _2NxngUgH;
        "pkg-fabric-2.2.0+1.21.1" = _2mT3RFeh;
        "pkg-neoforge-2.2.0" = _tJa6QccM;
        "pkg-fabric-2.2.0" = _rjCOcBoe;
        "pkg-fabric-2.2.1+1.21.1" = _an2FUiy9;
        "pkg-fabric-2.2.1" = _J7G1MONc;
        "pkg-neoforge-2.3.0-SNAPSHOT-1" = _h6BeQ1j4;
        "pkg-fabric-2.3.0-SNAPSHOT-1" = _8KdJvm6I;
        "pkg-neoforge-2.2.2" = _Eq6dvLVV;
        "pkg-fabric-2.2.2" = _qTzELVpi;
        "pkg-neoForge-2.3.0" = _zVVQGLxD;
        "pkg-fabric-2.3.0" = _HjYPJTTL;
        "pkg-neoforge-2.2.3+1.21.1" = _sBvxKK7e;
        "pkg-fabric-2.2.3+1.21.1" = _sVxV8lhV;
        "pkg-neoforge-2.2.3+1.21.11" = _rvBZBomF;
        "pkg-fabric-2.2.3+1.21.11" = _UfhYLEaB;
        "pkg-neoforge-2.3.1" = _kPLE46pU;
        "pkg-fabric-2.3.1" = _MqlaZghO;
        "pkg-neoforge-2.4.0" = _BurbuTji;
        "pkg-fabric-2.4.0" = _OcwWSRG1;
        "pkg-neoforge-2.4.1" = _bqLTWOzm;
        "pkg-neoforge-2.4.2+1.21.1" = _39MxXWdh;
        "pkg-fabric-2.4.2+1.21.1" = _6yELpHgV;
        "pkg-neoforge-2.4.2+1.21.11" = _3nSfwZfU;
        "pkg-fabric-2.4.2+1.21.11" = _yFrzHN4Z;
        "pkg-neoforge-2.4.2+26.1.2" = _HipRgzhW;
        "pkg-fabric-2.4.2+26.1.2" = _5f3T1FYM;
        "pkg-neoforge-2.4.2" = _DrPkek1i;
        "pkg-fabric-2.4.2" = _TQlr7aHc;
        "pkg-neoforge-2.4.3" = _DNl5t9YH;
        "pkg-fabric-2.4.3" = _KYYQqEh0;
        "pkg-neoforge-2.4.3+1.21.11" = _TbG7sUyV;
        "pkg-fabric-2.4.3+1.21.11" = _ipIfV3jK;
        "pkg-neoforge-2.4.3+26.1.2" = _HaniL23I;
        "pkg-fabric-2.4.3+26.1.2" = _851focDx;
        "pkg-neoforge-2.5.0-SNAPSHOT-1" = _AgSzpALs;
        "pkg-fabric-2.5.0" = _KiACqU67;
        "default" = _KiACqU67;
    });
