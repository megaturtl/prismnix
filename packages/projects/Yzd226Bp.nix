...
let
    ...
    in {
        ...
        "pkg-0.0.1+build.6" = _eBdYDHSe;
        "pkg-0.0.1+build.7" = _SOV9xwOR;
        "pkg-0.0.1+build.8" = _omlnJDms;
        "pkg-0.0.1+build.9" = _Nx7LXsPC;
        "pkg-0.0.1+build.10" = _Laa92WTX;
        "pkg-0.0.1+build.11" = _rQQ2RFms;
        "pkg-0.0.1+build.12" = _WBjSUJfk;
        "pkg-0.0.1+build.13" = _LUCeowZF;
        "pkg-0.0.1+build.14" = _K3Ro5M1n;
        "pkg-0.0.1+build.15" = _ApIeodRz;
        "pkg-0.0.1+build.16" = _a3jGan6x;
        "pkg-0.0.1+build.17" = _eA98eWwM;
        "pkg-0.0.1+build.18" = _CwlY3CGb;
        "pkg-0.0.1+build.19" = _BhIRmsNB;
        "pkg-0.0.1+build.20" = _SSOiaA38;
        "pkg-0.0.1+build.21" = _eSbEwCFf;
        "pkg-0.0.1+build.22" = _5XLl86WK;
        "pkg-0.0.1+build.23" = _zc9YGqpw;
        "pkg-0.0.1+build.24" = _XMmy4vlz;
        "pkg-0.0.1+build.25" = _KO0RXUBd;
        "pkg-0.0.1+build.26" = _WTD7xzNG;
        "pkg-0.0.1+build.27" = _VTN4SJVi;
        "pkg-0.0.1+build.29" = _kb12Sg3b;
        "pkg-0.0.1+build.30" = _WHMIogyy;
        "pkg-0.0.1+build.31" = _yntdLdB4;
        "pkg-0.0.1+build.32" = _IHMoBj7O;
        "pkg-0.0.1+build.33" = _yKwnTtud;
        "pkg-0.0.1+build.34" = _UQ8GF2PA;
