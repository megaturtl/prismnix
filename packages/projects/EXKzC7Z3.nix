...
let
    ...
    in {
        ...
        "pkg-0.1-beta" = _GwGjuc4d;
        "pkg-0.2-beta" = _KrBOLrej;
        "pkg-0.3" = _yW5TEpWG;
        "pkg-1.0" = _5qqwhmLc;
        "pkg-1.0+mod" = _T3sW5Ezt;
        "pkg-1.1" = _GsB37a68;
        "pkg-1.1+mod" = _F5jkeBV6;
        "pkg-1.3" = _hmEpwSQ7;
        "pkg-1.3+mod" = _pjBaU9Sf;
        "pkg-1.4" = _IOsT8O6B;
        "pkg-1.4+mod" = _tz1EcFcq;
        "pkg-1.5" = _nllQ2kaE;
        "pkg-1.5+mod" = _8pJOt6UJ;
        "pkg-1.6" = _FNTMWJ29;
        "pkg-1.6+mod" = _PhMypHux;
        "pkg-1.7" = _RqAZ30ks;
        "pkg-1.7+mod" = _7vw2C7jr;
        "pkg-1.8" = _mCdtMaDu;
        "pkg-1.8+mod" = _C4Xeve7C;
        "pkg-1.9" = _1UmfXhub;
