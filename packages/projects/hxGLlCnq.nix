...
let
    ...
    in {
        ...
        "pkg-1.3.6" = _fLcC1ZOl;
        "pkg-1.3.7" = _p2E1Uio3;
        "pkg-1.3.7-1.21" = _1GuBrI6U;
        "pkg-1.4-1.21.1" = _G1lPSkCj;
        "pkg-1.4.1-1.21.1" = _h3I1Qrb7;
        "pkg-1.4.2-1.21.1" = _HfmOlX7L;
        "pkg-1.4.3-1.21.1" = _2lJ9es8z;
        "pkg-1.5-1.21.1" = _49ZUCkhL;
        "pkg-1.5.1-1.21.1" = _Gc2Gt05e;
        "pkg-1.5.2-1.21.1" = _wihqibXE;
        "pkg-1.5.3-1.21.1" = _FDn7BOCa;
        "pkg-1.5.4-1.21.1" = _tLkoE9fL;
        "pkg-1.5.4-1.21.5" = _JeLgBk7k;
        "pkg-1.3.8" = _QeCmdOfQ;
        "pkg-1.5.5-1.21.5" = _LaTHNlHt;
        "pkg-1.5.5-1.21.1" = _tON83aGT;
        "pkg-1.3.9" = _ya6IgqDo;
        "pkg-1.6.0-1.21.6" = _qy9XcLBX;
        "pkg-1.5.6-1.21.1" = _kCs7IPV5;
        "pkg-1.6.1-1.21.6" = _li3AG3nk;
        "pkg-1.5.6-1.21.5" = _WlWDFrco;
        "pkg-1.6.2-1.21.6" = _49KwCIFL;
        "pkg-1.5.7-1.21.1" = _4TjsWx9N;
        "pkg-1.6.2-1.21.9" = _S9TKUqvl;
        "pkg-1.6.3-1.21.9" = _KGyT6MBZ;
        "pkg-1.6.3-1.21.6" = _c8XQVque;
        "pkg-1.6.4-1.21.6" = _xJeVwGuV;
        "pkg-1.6.4-1.21.9" = _hpvMqu1Z;
        "pkg-1.5.8-1.21.1" = _1LUJW0Oj;
        "pkg-1.5.9-1.21.1" = _UnI8TFhU;
        "pkg-1.6.5-1.21.6" = _ASvrpdQ2;
        "pkg-1.3.10" = _UIxSglQx;
        "pkg-19.0.0" = _gDWrS7Mf;
        "pkg-19.0.1" = _jG2kbvS8;
        "pkg-19.0.2" = _1IyLu5PL;
        "pkg-19.0.3" = _NUX8An4I;
        "pkg-19.0.4" = _S2sajBWb;
        "pkg-19.0.5" = _qPbnfVgB;
        "pkg-19.0.6" = _vxy24t46;
        "pkg-19.0.7" = _9Px7wGBk;
        "pkg-19.0.8" = _QSUCibvs;
        "pkg-19.0.9" = _vG3Cm5DE;
        "pkg-19.1.0" = _uQWAvtgQ;
        "pkg-20.1.0" = _NmYyEzpB;
        "pkg-20.2.0" = _VsObL3Jz;
        "pkg-20.2.1" = _24Ausa2F;
        "pkg-9.0.0" = _6PuTdm1X;
        "pkg-20.2.2" = _NtrCqjeH;
        "pkg-1.6.6-1.21.6" = _ARiLNFGI;
        "pkg-20.2.3" = _823Qsykj;
        "pkg-21.2.0" = _EtAc0T42;
        "pkg-20.2.4" = _YZ3fBBcq;
        "pkg-21.2.1" = _yfWPq2Ue;
        "pkg-20.2.5" = _ImjQ7lHm;
