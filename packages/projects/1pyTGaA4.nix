...
let
    versions = (let
        ...
        _d86KBsHi = {
            "id" = "d86KBsHi";
            "file" = "UniTweaks-0.31.0.jar";
            "hash" = "sha512-UcxqEyiwFK7OSkvDSoY4HLYD14pJk0jaGhFrst6t1akXdpF3SPDIvEeT/c813kyACu05oqhSPFihKlzOmJmwfw==";
        };
    in {
        "8tnJXeIY" = _8tnJXeIY;
        "A3yapAgo" = _A3yapAgo;
        ...
        "w5z3Y5kf" = _w5z3Y5kf;
        "d86KBsHi" = _d86KBsHi;
        "fabric-b1.7.3" = _d86KBsHi;
        "babric-b1.7.3" = _d86KBsHi;
        "pkg-0.1.0" = _8tnJXeIY;
        "pkg-0.2.0" = _A3yapAgo;
        "pkg-0.3.0" = _kLfvAI4N;
        "pkg-0.4.0" = _tuA2zZWD;
