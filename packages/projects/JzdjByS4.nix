...
let
    ...
    in {
        ...
        "pkg-1.0.0+1.18" = _pnK8qhpf;
        "pkg-1.0.0+1.19" = _lfQf3EhU;
        "pkg-1.1.0+mc1.18.2" = _j9s71ron;
        "pkg-1.1.0+mc1.19" = _pqW8Op0n;
        "pkg-1.2.0+mc1.18.2" = _lhcjuXFr;
        "pkg-1.2.0+mc1.19.2" = _jO54NGBf;
        "pkg-1.2.0+mc1.19.3" = _iulrP3L9;
        "pkg-1.3.0+mc1.18.2" = _Mg7mHdkq;
        "pkg-1.3.0+mc1.19.2" = _2Ivk5kOl;
        "pkg-1.3.0+mc1.19.3" = _sQMMp3nS;
        "pkg-1.3.0+mc1.19.4" = _M6nEd3AS;
        "pkg-1.3.0+mc1.20" = _HcmfhU81;
        "pkg-1.3.1+mc1.20.2" = _RoqNES5T;
        "pkg-1.4.0+mc1.20.3" = _fsQk57lT;
        "pkg-1.5.0+mc1.20.6" = _pbMnmcpZ;
        "pkg-1.6.0+mc1.21" = _qKmjjNtn;
        "pkg-1.7.0+mc1.21.2" = _91WgUkzH;
        "pkg-1.8.0+mc1.21.5" = _qrf1ZajH;
        "pkg-1.9.0+mc1.21.6" = _HsyIGswq;
        "pkg-1.10.0+mc1.21.11" = _CGQnALrf;
        "pkg-1.11.0+mc26.1-fabric" = _hQBrPzQ6;
