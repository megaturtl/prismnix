...
let
    ...
    in {
        ...
        "pkg-1.3.0b" = _58zZT6js;
        "pkg-1.3.0b-1.19.3" = _kkNINNVM;
        "pkg-1.4.0" = _yN4kr8ZG;
        "pkg-1.4.0-1.19.3" = _rfLYUXMa;
        "pkg-1.4.0-1.18.2" = _h4Nxb0iS;
        "pkg-1.4.1" = _Ux48BN0R;
        "pkg-1.4.1-1.18.2" = _VbGVmWNy;
        "pkg-1.4.1-1.19.3" = _OojVKGU5;
        "pkg-1.4.2" = _H0Cnjmzr;
        "pkg-1.4.2-1.19.3" = _M62YL3tV;
        "pkg-1.5.0" = _hQFa32vu;
        "pkg-1.5.0-1.19.3" = _4cgJ0uLw;
        "pkg-1.5.0-1.18.2" = _dHbBWNsc;
        "pkg-1.5.1" = _c6wCSlhV;
        "pkg-1.5.1-1.19.3" = _UY5nsTet;
        "pkg-1.5.1-1.18.2" = _juQHD6cx;
        "pkg-1.7.0" = _Jxniypip;
        "pkg-1.7.0-1.18.2" = _zpoRzMoO;
        "pkg-1.7.0-1.19.3" = _e1EAlb1d;
        "pkg-1.7.0-1.19.4" = _gb3rBqwK;
        "pkg-1.7.1-1.19.2" = _gBEnRV65;
        "pkg-1.7.1-1.18.2" = _g53RNZJj;
        "pkg-1.7.1-1.19.3" = _voJBehFx;
        "pkg-1.7.1-1.19.4" = _SsKdXXBo;
        "pkg-1.7.2-1.19.2" = _76JWc7Qc;
        "pkg-1.7.2-1.18.2" = _158Obj76;
        "pkg-1.7.2-1.19.3" = _Fn6rj0dl;
        "pkg-1.7.2-1.19.4" = _LiUwwJDw;
        "pkg-1.7.3-1.20" = _cPjMaoyD;
        "pkg-1.7.3-1.16.5" = _X2OMImM4;
        "pkg-1.16.5-1.7.4" = _iaYHOBHU;
        "pkg-1.7.4.1-mc1.16.5" = _TbNJhpIS;
        "pkg-1.7.4-mc1.18.2" = _GvWRimZP;
        "pkg-1.7.4-mc1.19.2" = _4293M0I0;
        "pkg-1.7.4-mc1.19.4" = _6WF4K0lC;
        "pkg-1.7.4-mc1.20" = _fNd2Nrbg;
        "pkg-1.7.5-mc1.16.5" = _LyOfKmNm;
        "pkg-1.7.5-mc1.18.2" = _T8T2j3Oa;
        "pkg-1.7.5-mc1.19.2" = _RMHyRTMO;
        "pkg-1.7.5-mc1.20" = _k6aMOXSK;
        "pkg-1.7.5-mc1.19.4" = _5a6r18wg;
        "pkg-1.7.5-mc1.19.3" = _TWqmB08o;
        "pkg-1.7.6-mc1.18.2" = _bc6UMTl5;
        "pkg-1.7.6-mc1.19.2" = _hiVtV8jI;
        "pkg-1.7.6-mc1.19.3" = _E49qmDOc;
        "pkg-1.7.6-mc1.19.4" = _Cci4dqWk;
        "pkg-1.7.6-mc1.20" = _KiFYezDU;
        "pkg-1.7.6-mc1.16.5" = _2HWi4aR3;
        "pkg-2.0.0" = _wa07LIm7;
        "pkg-2.0.0-mc1.21.11" = _x5nbzLI3;
        "pkg-2.0.1-mc1.21.11" = _ltLX5z90;
        "pkg-2.0.2a-mc1.21.11" = _zSrJTnhc;
        "pkg-1.8.0-mc1.20.1" = _r3HAQxDK;
        "pkg-1.8.1-mc1.16.5" = _BJin3Asb;
        "pkg-1.8.1-mc1.18.2" = _nNNeZBkU;
        "pkg-1.8.1-mc1.19.2" = _aP3eQ51R;
        "pkg-1.8.1-mc1.20.1" = _8WhXjcOa;
        "pkg-1.8.1-mc1.21.1" = _QpTFn8Av;
        "pkg-2.1.0-mc1.21.11" = _XLlnETIZ;
        "pkg-1.8.1.1-mc1.21.1" = _ajfnvGWC;
        "pkg-1.8.1.1-mc1.20.1" = _90jqJFWP;
        "pkg-1.8.1.1-mc1.19.2" = _7r1hCedS;
        "pkg-1.8.1.1-mc1.18.2" = _r1HS58pf;
        "pkg-1.8.1.1-mc1.16.5" = _xYYFtXDs;
        "pkg-2.1.0.1-mc1.21.11" = _f1rBrbAP;
        "pkg-2.1.0-mc26.1-pre" = _lfzB4I7l;
        "pkg-1.9.0+1.19.2-fabric" = _1fjZJasD;
        "pkg-1.9.0+1.21.1-neoforge" = _pPGLR1gG;
        "pkg-1.9.0+1.16.5-forge" = _FpjpM0Nb;
        "pkg-1.9.0+1.20.1-fabric" = _PdWbKhk7;
        "pkg-1.9.0+1.18.2-forge" = _fLkJ5xfH;
        "pkg-1.9.0+1.16.5-fabric" = _aXwvpVbk;
        "pkg-1.9.0+1.21.1-fabric" = _dZUMKIAj;
        "pkg-1.9.0+1.20.1-forge" = _SYn7CJkG;
        "pkg-1.9.0+1.19.2-forge" = _l2oQAyem;
        "pkg-1.9.0+1.18.2-fabric" = _WWaIzexN;
        "pkg-2.2.0+1.21.11-fabric" = _Nqkt4Yct;
        "pkg-2.2.0+1.21.11-neoforge" = _75UCnPae;
        "pkg-1.9.1+1.19.2-fabric" = _HMrMJ8pE;
        "pkg-1.9.1+1.18.2-forge" = _5IjkPGJ9;
        "pkg-1.9.1+1.19.2-forge" = _KMIZ3vFB;
        "pkg-1.9.1+1.20.1-fabric" = _q58jYePT;
        "pkg-1.9.1+1.18.2-fabric" = _UDCpqb8t;
        "pkg-1.9.1+1.21.1-fabric" = _BRXwYxyu;
        "pkg-1.9.1+1.16.5-fabric" = _VD0moFZN;
        "pkg-1.9.1+1.16.5-forge" = _jbLZyI1G;
        "pkg-1.9.1+1.20.1-forge" = _REk8CLyJ;
        "pkg-1.9.1+1.21.1-neoforge" = _HTmKQr1U;
        "pkg-2.9.1+26.1-fabric" = _QLx9g2In;
        "pkg-2.9.1+26.1-neoforge" = _JJ9wj5VE;
        "pkg-2.9.2+1.21.11-neoforge" = _7ACqyztp;
        "pkg-2.9.2+26.1-fabric" = _lMoKliVW;
        "pkg-1.9.2+1.20.1-fabric" = _gEbS3uxm;
        "pkg-1.9.2+1.19.2-forge" = _W9IK9pYz;
        "pkg-2.9.2+1.21.11-fabric" = _3cay0uwe;
        "pkg-2.9.2+26.1-neoforge" = _CiFyeNEx;
        "pkg-1.9.2+1.21.1-fabric" = _G7bfhE5p;
        "pkg-1.9.2+1.18.2-forge" = _cgpRfNiq;
        "pkg-1.9.2+1.20.1-forge" = _riKAIOIQ;
        "pkg-1.9.2+1.16.5-fabric" = _wzk4JTuv;
        "pkg-1.9.2+1.19.2-fabric" = _AqAiV1mU;
        "pkg-1.9.2+1.21.1-neoforge" = _2vxj9CP1;
        "pkg-1.9.2+1.18.2-fabric" = _ie1u3JyK;
        "pkg-1.9.2+1.16.5-forge" = _N5kkGY6q;
        "pkg-1.9.3+1.20.1-fabric" = _J5G8K85P;
        "pkg-1.9.3+1.16.5-forge" = _WIEHZhUt;
        "pkg-1.9.3+1.21.1-neoforge" = _OhAk9OCf;
        "pkg-1.9.3+1.18.2-forge" = _suIj6bRE;
        "pkg-1.9.3+1.18.2-fabric" = _XjN0Ws1g;
        "pkg-1.9.3+1.20.1-forge" = _CA6Iz5UK;
        "pkg-2.9.3+1.21.11-neoforge" = _D1lIK24h;
        "pkg-1.9.3+1.19.2-fabric" = _m34vNSdr;
        "pkg-2.9.3+26.1-fabric" = _qJ1nClWx;
        "pkg-2.9.3+1.21.11-fabric" = _XyObXmyE;
        "pkg-1.9.3+1.21.1-fabric" = _JrNZ2sD5;
        "pkg-1.9.3+1.19.2-forge" = _b5PaYF2l;
        "pkg-1.9.3+1.16.5-fabric" = _1QLOjvwJ;
        "pkg-2.9.3+26.1-neoforge" = _EWLNO35s;
        "pkg-2.9.3-mc26.2-pre" = _FKnclhfN;
        "pkg-2.9.3.1+26.2-fabric" = _DsPun3UN;
        "pkg-2.9.3.1+26.2-neoforge" = _GZwDxIsN;
        "pkg-2.9.4+26.1-fabric" = _m1wGeEEm;
        "pkg-2.9.4+1.21.11-neoforge" = _hW3QgGLm;
        "pkg-2.9.4+1.21.11-fabric" = _uI33pKmd;
        "pkg-2.9.4+26.2-fabric" = _ipsVSzW8;
        "pkg-2.9.4+26.1-neoforge" = _JlLWQ4sP;
        "pkg-2.9.4+26.2-neoforge" = _gdXSsjwU;
        "pkg-1.9.4+1.18.2-fabric" = _7ugXrsJH;
        "pkg-1.9.4+1.20.1-fabric" = _IT6OooXA;
        "pkg-1.9.4+1.18.2-forge" = _P1Vp8xxp;
        "pkg-1.9.4+1.16.5-fabric" = _I7hwp6gk;
        "pkg-1.9.4+1.21.1-fabric" = _EUj1g7gq;
        "pkg-1.9.4+1.21.1-neoforge" = _UfWxtEeD;
        "pkg-1.9.4+1.20.1-forge" = _7VvbZRnW;
        "pkg-1.9.4+1.19.2-forge" = _VcgkUJJu;
        "pkg-1.9.4+1.19.2-fabric" = _2coH01Jz;
        "pkg-1.9.4+1.16.5-forge" = _4B6auUAL;
        "pkg-1.9.4.1+1.21.1-fabric" = _I2O2pka9;
        "pkg-1.9.4.1+1.16.5-forge" = _Jn0cikIO;
        "pkg-1.9.4.1+1.18.2-forge" = _TRdsnCv7;
        "pkg-1.9.4.1+1.19.2-fabric" = _tZDMKQ3H;
        "pkg-1.9.4.1+1.19.2-forge" = _KSctr4Fd;
        "pkg-1.9.4.1+1.16.5-fabric" = _KhkIQ4wQ;
        "pkg-1.9.4.1+1.20.1-fabric" = _dklvMiiJ;
        "pkg-1.9.4.1+1.18.2-fabric" = _rI3iTiBc;
        "pkg-1.9.4.1+1.21.1-neoforge" = _tyityTZV;
        "pkg-1.9.4.1+1.20.1-forge" = _9z2EXfxh;
        "pkg-2.9.4.1+26.1-neoforge" = _ehBsutFc;
        "pkg-2.9.4.1+1.21.11-neoforge" = _G3aWZ9JJ;
        "pkg-2.9.4.1+26.1-fabric" = _ffaKuWbC;
