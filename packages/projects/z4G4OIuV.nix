...
let
    versions = (let
        ...
        _xuxlRph3 = {
            "id" = "xuxlRph3";
            "file" = "quantified api-omni-2.2.0.jar";
            "hash" = "sha512-TzwcjFzR9XSPHGJGYhfOBn4H1hsCLpv1jqSCKYQryhgooHepMrlK7twX+umTMeW63tQv8sTZiykN9la7hmSCiw==";
        };
    in {
        "ZkvOZROw" = _ZkvOZROw;
        "Im6GsUGH" = _Im6GsUGH;
        ...
        "b1gG8jMJ" = _b1gG8jMJ;
        "xuxlRph3" = _xuxlRph3;
        "forge-1.20.1" = _xuxlRph3;
        "forge-1.20.2" = _xuxlRph3;
        "forge-1.20.3" = _xuxlRph3;
        "forge-1.20.4" = _xuxlRph3;
        "forge-1.20.5" = _xuxlRph3;
        "forge-1.20.6" = _xuxlRph3;
        "forge-1.19.2" = _mLnjuOi2;
        "forge-1.19.3" = _mLnjuOi2;
        "forge-1.19.4" = _mLnjuOi2;
        "forge-1.18.2" = _xTbM3XDx;
        "forge-1.21.1" = _xuxlRph3;
        "forge-1.21.2" = _xuxlRph3;
        "forge-1.21.3" = _xuxlRph3;
        "forge-1.21.4" = _xuxlRph3;
        "forge-1.21.5" = _xuxlRph3;
        "forge-1.21.6" = _xuxlRph3;
        "forge-1.21.7" = _xuxlRph3;
        "forge-1.21.8" = _xuxlRph3;
        "forge-1.21.9" = _xuxlRph3;
        "forge-1.21.10" = _xuxlRph3;
        "forge-1.21.11" = _xuxlRph3;
        "forge-26.1" = _xuxlRph3;
        "forge-26.1.1" = _xuxlRph3;
        "forge-26.1.2" = _xuxlRph3;
        "forge-26.2" = _xuxlRph3;
        "forge-1.21" = _xuxlRph3;
        "fabric-1.20.1" = _xuxlRph3;
        "fabric-1.21.1" = _xuxlRph3;
        "fabric-1.21.2" = _xuxlRph3;
        "fabric-1.21.3" = _xuxlRph3;
        "fabric-1.21.4" = _xuxlRph3;
        "fabric-1.21.5" = _xuxlRph3;
        "fabric-1.21.6" = _xuxlRph3;
        "fabric-1.21.7" = _xuxlRph3;
        "fabric-1.21.8" = _xuxlRph3;
        "fabric-1.21.9" = _xuxlRph3;
        "fabric-1.21.10" = _xuxlRph3;
        "fabric-1.21.11" = _xuxlRph3;
        "fabric-26.1" = _xuxlRph3;
        "fabric-26.1.1" = _xuxlRph3;
        "fabric-26.1.2" = _xuxlRph3;
        "fabric-26.2" = _xuxlRph3;
        "fabric-1.20.2" = _xuxlRph3;
        "fabric-1.20.3" = _xuxlRph3;
        "fabric-1.20.4" = _xuxlRph3;
        "fabric-1.20.5" = _xuxlRph3;
        "fabric-1.20.6" = _xuxlRph3;
        "fabric-1.21" = _xuxlRph3;
        "neoforge-1.20.1" = _xuxlRph3;
        "neoforge-1.21.1" = _xuxlRph3;
        "neoforge-1.21.2" = _xuxlRph3;
        "neoforge-1.21.3" = _xuxlRph3;
        "neoforge-1.21.4" = _xuxlRph3;
        "neoforge-1.21.5" = _xuxlRph3;
        "neoforge-1.21.6" = _xuxlRph3;
        "neoforge-1.21.7" = _xuxlRph3;
        "neoforge-1.21.8" = _xuxlRph3;
        "neoforge-1.21.9" = _xuxlRph3;
        "neoforge-1.21.10" = _xuxlRph3;
        "neoforge-1.21.11" = _xuxlRph3;
        "neoforge-26.1" = _xuxlRph3;
        "neoforge-26.1.1" = _xuxlRph3;
        "neoforge-26.1.2" = _xuxlRph3;
        "neoforge-26.2" = _xuxlRph3;
        "neoforge-1.20.2" = _xuxlRph3;
        "neoforge-1.20.3" = _xuxlRph3;
        "neoforge-1.20.4" = _xuxlRph3;
        "neoforge-1.20.5" = _xuxlRph3;
        "neoforge-1.20.6" = _xuxlRph3;
        "neoforge-1.21" = _xuxlRph3;
        "pkg-1.1.1" = _Y5zl1lCv;
        "pkg-1.2.0" = _IZ1hjeSh;
        "pkg-1.2.1" = _oNgr7snM;
        "pkg-1.2.2" = _6ZdR62fu;
