...
let
    ...
    in {
        ...
        "pkg-4.1.1" = _y9e50sqH;
        "pkg-5.0.0" = _bsImW3nW;
        "pkg-6.0.0+1.21.2-pre1" = _7E9STy7q;
        "pkg-6.0.0+1.21.2" = _MhgExZU0;
        "pkg-1.2.2+1.20" = _1sXOFvIM;
        "pkg-2.2.2+1.20.2" = _A0Cazvk2;
        "pkg-3.2.2+1.20.3" = _Rk06JwpO;
        "pkg-4.1.2+1.20.5" = _qg5s4PzB;
        "pkg-5.0.1+1.21" = _Eq5O7v7b;
        "pkg-6.0.1+1.21.2" = _p0Ql63G6;
        "pkg-6.0.2+1.21.2" = _mlhaKNhu;
        "pkg-7.0.0+1.21.9" = _Wwn1Nfk1;
        "pkg-9.0.0+26.1" = _cQVQptup;
        "pkg-10.0.0-beta+26.2-rc.2" = _UebH3GlS;
