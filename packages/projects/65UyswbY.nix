...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _SS2rHGU8;
        "pkg-1.1.1" = _IK8wOtzR;
        "pkg-1.2.0-pre.1" = _b9nLlPIt;
        "pkg-1.2.0-pre.2" = _wcTOh0DQ;
        "pkg-1.2.0-pre.3" = _lkgAabL5;
        "pkg-1.2.0" = _r6L9XUy2;
        "pkg-2.0.0" = _xhdlBL2G;
        "pkg-2.1.0-beta.1" = _ZFITbYRu;
        "pkg-2.1.0-beta.2" = _OZdw0TIe;
        "pkg-2.1.0" = _oxOyuQ8u;
        "pkg-2.2.0-beta.01" = _ibvcGX3Y;
        "pkg-2.2.0-beta.02" = _pUOks9Kz;
        "pkg-2.2.0" = _1nrEQden;
        "pkg-2.2.1+1.20.1" = _nTce9TPL;
        "pkg-2.2.1+1.21" = _CvJAkZU4;
        "pkg-2.3.0+1.20.1" = _tOW161NG;
        "pkg-2.3.0+1.21" = _vRNecWx8;
        "pkg-2.3.1+1.20.1" = _iPLoGyOc;
        "pkg-2.3.1+1.21" = _Wf9x6YeG;
        "pkg-2.3.2+1.20.1" = _J5lsN185;
        "pkg-2.3.2+1.21" = _tuMnRX3d;
        "pkg-2.3.3+1.20.1" = _6HNwOwBa;
        "pkg-2.3.3+1.21" = _CSxIOnoF;
        "pkg-2.3.4+1.20.1" = _QX1TZxYu;
        "pkg-2.3.4+1.21" = _onfoldAy;
        "pkg-2.3.4+1.21.4" = _vfDmELto;
        "pkg-2.3.5+1.20.1" = _vu2NUtvF;
        "pkg-2.3.5+1.21" = _2uNPBeDm;
        "pkg-2.3.5+1.21.4" = _Q8Zb0WCM;
        "pkg-2.3.7+1.20.1" = _I3TB3Suu;
        "pkg-2.3.7+1.21" = _XyF1o2Ca;
        "pkg-2.3.7+1.21.4" = _yVBtlRI6;
        "pkg-2.3.8+1.20.1" = _6Z1Z9KEm;
        "pkg-2.3.8+1.21" = _Zd74VKf0;
        "pkg-2.3.8+1.21.4" = _PSWa4aPp;
        "pkg-2.3.9+1.20.1" = _o4YeWb3f;
        "pkg-2.3.9+1.21" = _ex97xkxp;
        "pkg-2.3.9+1.21.4" = _gOhywFr1;
        "pkg-2.3.9+1.21.6" = _uYjoME8b;
        "pkg-2.3.10+1.20.1" = _J986MmWA;
        "pkg-2.3.10+1.21" = _mMFutxE4;
        "pkg-2.3.10+1.21.4" = _IpzdxhAy;
        "pkg-2.3.10+1.21.6" = _p5UYBxEr;
        "pkg-2.3.11+1.20.1" = _GDtrzbqL;
        "pkg-2.3.11+1.21.1" = _PWiUgUsv;
        "pkg-2.3.11+1.21.4" = _AMSb1QpK;
        "pkg-2.3.11+1.21.7" = _rMSZnekk;
        "pkg-2.3.12+1.21.7" = _Yju9d3Mt;
        "pkg-2.3.13+1.20.1" = _mwCH4IJc;
        "pkg-2.3.13+1.21.1" = _nxpgf9H7;
        "pkg-2.3.13+1.21.4" = _kzpneq3Y;
        "pkg-2.3.13+1.21.8" = _uOmIfPik;
        "pkg-2.3.14+1.20.1" = _hWdBDIS0;
        "pkg-2.3.14+1.21.1" = _RUyG3m7n;
        "pkg-2.3.14+1.21.4" = _qDk3Xi0K;
        "pkg-2.3.14+1.21.8" = _cigQeML3;
        "pkg-2.3.14+1.21.9" = _dTw6p6et;
        "pkg-2.3.15+1.20.1" = _DXqSaBVZ;
        "pkg-2.3.15+1.21.1" = _yK42jJTC;
        "pkg-2.3.15+1.21.4" = _uYMZZesy;
        "pkg-2.3.15+1.21.8" = _qNR8rKOA;
        "pkg-2.3.15+1.21.10" = _Vt4lCyOX;
        "pkg-2.3.16+1.20.1" = _lzKZ8PJP;
        "pkg-2.3.16+1.21.1" = _7C7Uqqsc;
        "pkg-2.3.16+1.21.4" = _wMRjYtDO;
        "pkg-2.3.16+1.21.8" = _89uEkc1y;
        "pkg-2.3.16+1.21.10" = _LLvh6Z89;
        "pkg-2.3.16+1.21.11" = _Up8Na4xG;
        "pkg-2.3.17+1.20.1" = _u6cu7qzb;
        "pkg-2.3.17+1.21.1" = _gnfeicbY;
        "pkg-2.3.17+1.21.4" = _Aw8RIEuQ;
        "pkg-2.3.17+1.21.8" = _AoXplMyO;
        "pkg-2.3.17+1.21.10" = _Lc9mCfG6;
        "pkg-2.3.17+1.21.11" = _2JTIaLtx;
        "pkg-2.4.0-beta.1+1.21.1" = _CGg0F1mc;
        "pkg-2.4.0+1.20.1" = _Stbv4d97;
        "pkg-2.4.0+1.21.1" = _kj5qBrZ6;
        "pkg-2.4.0+1.21.4" = _WlVOI7bl;
        "pkg-2.4.0+1.21.8" = _dZNYBtUe;
        "pkg-2.4.0+1.21.10" = _kdty9IxX;
        "pkg-2.4.0+1.21.11" = _8eiBV9Yy;
        "pkg-3.0.0-beta.1+26.1-rc-2" = _b59mPLdq;
        "pkg-3.0.0+26.1" = _9nvEFnVd;
        "pkg-3.2.1+26.1.2" = _jol22wCl;
        "pkg-3.2.2+26.1.2" = _jXBlLNlM;
        "pkg-3.3.0-beta.1+26.2-pre-2" = _DKeAmMOa;
        "pkg-3.102.3+26.1.2" = _FBS63ig0;
