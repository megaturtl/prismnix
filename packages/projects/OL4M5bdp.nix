...
let
    ...
    in {
        ...
        "pkg-2.0.3-SNAPSHOT" = _5gFCTjX1;
        "pkg-2.0.4-SNAPSHOT" = _qi68fYuJ;
        "pkg-2.0.5.1-SNAPSHOT" = _ciJjowPP;
        "pkg-2.0.6-SNAPSHOT" = _9JATn5wb;
        "pkg-2.0.7-SNAPSHOT" = _w4aKG4Qp;
        "pkg-2.0.7.1-SNAPSHOT" = _fhrBcnQg;
        "pkg-2.0.8-SNAPSHOT" = _LYqrmDew;
        "pkg-2.0.9-SNAPSHOT" = _xLFkjkJD;
        "pkg-2.0.11-SNAPSHOT" = _jJOMkhdf;
        "pkg-2.2.1.4-SNAPSHOT" = _Q3ApeDun;
        "pkg-2.2.1.5-SNAPSHOT" = _nDLwqFtn;
        "pkg-2.2.1.6-SNAPSHOT" = _3MSSzJQU;
        "pkg-2.2.1.7-SNAPSHOT" = _ARg2dGUQ;
        "pkg-2.2.1.8-SNAPSHOT" = _Ke7XUoS2;
        "pkg-2.2.1.9-SNAPSHOT" = _jyfikEEh;
        "pkg-2.2.1.10-SNAPSHOT" = _Qen7FOO4;
        "pkg-2.2.1.11-SNAPSHOT" = _xHWe4yW8;
        "pkg-2.2.1.11.1-SNAPSHOT" = _XNZg5492;
        "pkg-2.2.1.12-SNAPSHOT" = _Y2dBdBHg;
        "pkg-2.2.1.13-SNAPSHOT" = _VrgL5oeG;
        "pkg-2.2.1.14-SNAPSHOT" = _6EQOMcsL;
        "pkg-2.2.2.0-SNAPSHOT" = _XwOFwCqO;
        "pkg-2.2.2.1-SNAPSHOT" = _O4Z7SEbB;
        "pkg-2.2.3.0-SNAPSHOT" = _RvoeEt1q;
        "pkg-2.2.3.1-SNAPSHOT" = _e84o0d6I;
        "pkg-2.2.4.0-1.20.1-SNAPSHOT" = _aKJHoXqf;
        "pkg-2.2.4.1-1.20.1-SNAPSHOT" = _1bNO54yu;
        "pkg-2.2.4.2.1-1.20.1-SNAPSHOT" = _YCTFhVlA;
        "pkg-2.2.4.3.1-1.20.1-SNAPSHOT" = _DEvXKCpC;
        "pkg-2.2.4.4-1.20.1-SNAPSHOT" = _5u8d2tSV;
        "pkg-2.2.4.5-1.20.1-SNAPSHOT" = _dQYtJgyI;
        "pkg-2.2.4.6-1.20.1-SNAPSHOT" = _8HNB60K3;
        "pkg-2.2.4.7-1.20.1-SNAPSHOT" = _pJYHN3ZZ;
        "pkg-2.2.4.8-1.20.1-SNAPSHOT" = _KYvQY3ic;
        "pkg-2.2.5.0-1.20.1-SNAPSHOT" = _9tJtilg5;
        "pkg-2.2.5.1-1.20.1-SNAPSHOT" = _mZqPPMhG;
        "pkg-2.2.5.2-1.20.1-SNAPSHOT" = _nsz6cAjN;
        "pkg-2.2.5.2.fix-1.20.1-SNAPSHOT" = _FlRGEGr7;
        "pkg-2.2.6.0-1.20.1-SNAPSHOT" = _mu7vPmiM;
        "pkg-2.2.6.1-1.20.1-SNAPSHOT" = _HNCTAHho;
        "pkg-2.2.6.2-1.20.1-SNAPSHOT" = _TpXVsryx;
        "pkg-2.2.6.3-1.20.1-SNAPSHOT" = _ps9X96MO;
        "pkg-2.2.6.4-1.20.1-SNAPSHOT" = _NL1Vu0CP;
