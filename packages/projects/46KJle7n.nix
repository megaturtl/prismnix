...
let
    ...
    in {
        ...
        "pkg-1.90" = _4YwOMKAp;
        "pkg-1.99" = _iw63gTDC;
        "pkg-1.99.2" = _fUDkl8Bn;
        "pkg-1.99.3" = _7W6yvSeu;
        "pkg-1.99.4" = _6r8HrftG;
        "pkg-1.99.5" = _lIY3K5bS;
        "pkg-2.04" = _yMjvty2Q;
        "pkg-2.05" = _pMKNdzz3;
        "pkg-2.06" = _YDL9NgTn;
        "pkg-2.07" = _NXH9HB9P;
        ...
        "pkg-2.38" = _xDfxAoAX;
        "pkg-2.39" = _6myjSBlq;
        "pkg-2.52-1.21.1" = _yNBJjI0B;
        "pkg-2.52" = _xsQAn5AE;
        "pkg-2.53" = _pEuA0roN;
        "pkg-2.53-1.21.1" = _7sRBSchc;
        "pkg-2.54-1.21.1" = _1w4giRKU;
        "pkg-2.54" = _SLorxvNp;
        "pkg-2.55-1.21.1" = _hyqxMkFa;
        "pkg-2.56" = _440DKADS;
        "pkg-2.56-1.21.1" = _d485hVC9;
        "pkg-2.57-1.21.1" = _IN8Rst7i;
        "pkg-2.57" = _ZVlu33D7;
        "pkg-2.58-1.21.1" = _o84MERiP;
        "pkg-2.58" = _3xjv4tRm;
        "pkg-2.59" = _nXeUpgOT;
        "pkg-2.59-1.21.1" = _LljnD0U0;
        "pkg-2.60" = _fjqHd3VJ;
        "pkg-2.60-1.21.1" = _fpJqEGqD;
        "pkg-2.61" = _tCqQge3Y;
        "pkg-2.62" = _DJxEq6We;
        "pkg-2.63-1.21.1" = _uWtRXlbj;
        "pkg-2.63" = _THhs91w5;
        "pkg-2.64" = _kjMK29YM;
        "pkg-2.64-1.21.1" = _Rjm5si1z;
        "pkg-2.65-1.21.1" = _F7PnB5dO;
        "pkg-2.66-1.21.1" = _5Jdv2V6q;
        "pkg-2.65" = _a4mPtmjF;
        "pkg-3.00" = _WsJV55ID;
        "pkg-3.01" = _OjBI9Ox1;
        "pkg-3.02" = _ub347xvo;
