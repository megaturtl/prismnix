...
let
    versions = (let
        ...
        _T65JqeNL = {
            "id" = "T65JqeNL";
            "file" = "LegendControl-Defender-3.5.1-1.21.1-NeoForge.jar";
            "hash" = "sha512-bzFxcLt59Tv5cYIZHIJJ+lg+IeJz2sy8i0ST4LVT3KWBK4i4FUF5BzdSkqq8Iq3zZWSEsH6Z+sn82cjfWRf1Og==";
        };
    in {
        "N6hPycf2" = _N6hPycf2;
        "ItHCoNuZ" = _ItHCoNuZ;
