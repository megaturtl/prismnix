...
let
    versions = (let
        ...
        _I8kBLVJB = {
            "id" = "I8kBLVJB";
            "file" = "Emissive-Ores-with-Frames-0.1.17+mc1.20-26.3.zip";
            "hash" = "sha512-PkxtHsqj5nJgIo0J8I5JxTgsA+LOhTpA3v3eOf70IcPFVGBy3M1Vb8/bLtU6VSQ+0/idYZfxzmrhIEXzLsGEAA==";
        };
    in {
        "wRV3okRz" = _wRV3okRz;
        "Ed5tbvFK" = _Ed5tbvFK;
        ...
        "minecraft-1.20" = _I8kBLVJB;
        "minecraft-1.20.1" = _I8kBLVJB;
        "minecraft-1.20.2" = _I8kBLVJB;
        "minecraft-1.20.3" = _I8kBLVJB;
        "minecraft-1.20.4" = _I8kBLVJB;
        "minecraft-1.20.5" = _I8kBLVJB;
        "minecraft-1.20.6" = _I8kBLVJB;
        "minecraft-1.21" = _I8kBLVJB;
        "minecraft-1.21.1" = _I8kBLVJB;
        "minecraft-1.21.2" = _I8kBLVJB;
        "minecraft-1.21.3" = _I8kBLVJB;
        "minecraft-1.21.4" = _I8kBLVJB;
        "minecraft-1.21.5" = _I8kBLVJB;
        "minecraft-1.21.6" = _I8kBLVJB;
        "minecraft-1.21.7" = _I8kBLVJB;
        "minecraft-1.21.8" = _I8kBLVJB;
        "minecraft-1.21.9" = _I8kBLVJB;
        "minecraft-1.21.10" = _I8kBLVJB;
        "minecraft-1.21.11" = _I8kBLVJB;
        "minecraft-23w31a" = _I8kBLVJB;
        "minecraft-23w32a" = _I8kBLVJB;
        "minecraft-23w33a" = _I8kBLVJB;
        "minecraft-23w35a" = _I8kBLVJB;
        "minecraft-1.20.2-pre1" = _I8kBLVJB;
        "minecraft-23w42a" = _I8kBLVJB;
        "minecraft-23w43a" = _I8kBLVJB;
        "minecraft-23w43b" = _I8kBLVJB;
        "minecraft-23w44a" = _I8kBLVJB;
        "minecraft-23w45a" = _I8kBLVJB;
        "minecraft-23w46a" = _I8kBLVJB;
        "minecraft-24w03a" = _I8kBLVJB;
        "minecraft-24w03b" = _I8kBLVJB;
        "minecraft-24w04a" = _I8kBLVJB;
        "minecraft-24w05a" = _I8kBLVJB;
        "minecraft-24w05b" = _I8kBLVJB;
        "minecraft-24w06a" = _I8kBLVJB;
        "minecraft-24w07a" = _I8kBLVJB;
        "minecraft-24w09a" = _I8kBLVJB;
        "minecraft-24w10a" = _I8kBLVJB;
        "minecraft-24w11a" = _I8kBLVJB;
        "minecraft-24w12a" = _I8kBLVJB;
        "minecraft-24w13a" = _I8kBLVJB;
        "minecraft-24w14potato" = _I8kBLVJB;
        "minecraft-24w14a" = _I8kBLVJB;
        "minecraft-1.20.5-pre1" = _I8kBLVJB;
        "minecraft-1.20.5-pre2" = _I8kBLVJB;
        "minecraft-1.20.5-pre3" = _I8kBLVJB;
        "minecraft-24w18a" = _I8kBLVJB;
        "minecraft-24w19a" = _I8kBLVJB;
        "minecraft-24w19b" = _I8kBLVJB;
        "minecraft-24w20a" = _I8kBLVJB;
        "minecraft-24w33a" = _I8kBLVJB;
        "minecraft-24w34a" = _I8kBLVJB;
        "minecraft-24w35a" = _I8kBLVJB;
        "minecraft-24w36a" = _I8kBLVJB;
        "minecraft-24w37a" = _I8kBLVJB;
        "minecraft-24w38a" = _I8kBLVJB;
        "minecraft-24w39a" = _I8kBLVJB;
        "minecraft-24w40a" = _I8kBLVJB;
        "minecraft-1.21.2-pre1" = _I8kBLVJB;
        "minecraft-1.21.2-pre2" = _I8kBLVJB;
        "minecraft-24w44a" = _I8kBLVJB;
        "minecraft-24w45a" = _I8kBLVJB;
        "minecraft-24w46a" = _I8kBLVJB;
        "minecraft-26.1" = _I8kBLVJB;
        "minecraft-26.1.1" = _I8kBLVJB;
        "minecraft-26.1.2" = _I8kBLVJB;
        "minecraft-26.2" = _I8kBLVJB;
        "minecraft-26.3" = _I8kBLVJB;
        "pkg-0.1.0" = _wRV3okRz;
        "pkg-0.1.1" = _Ed5tbvFK;
        "pkg-0.1.2" = _Qg96akaw;
        "pkg-0.1.3" = _Ql0vBoB7;
        ...
        "pkg-0.1.8" = _G0hDRrh2;
        "pkg-0.1.9" = _4KCtiayH;
        "pkg-0.1.10" = _245m3czI;
        "pkg-0.1.11" = _bPTPkjLK;
        "pkg-0.1.12" = _LHs4UP9l;
        "pkg-0.1.13" = _VUDTSxZS;
        "pkg-0.1.14" = _Ej2ZNXAV;
        "pkg-0.1.15" = _9WQi11JI;
        "pkg-0.1.16" = _MV8eWFnK;
        "pkg-0.1.17" = _I8kBLVJB;
        "default" = _I8kBLVJB;
    });
