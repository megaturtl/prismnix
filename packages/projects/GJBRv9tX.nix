...
let
    ...
    in {
        ...
        "pkg-INQ_1.1.1" = _32G2yUZr;
        "pkg-INQ_1.1.2" = _Fi4O34pz;
        "pkg-INQ_1.1.3" = _yDfajQV2;
        "pkg-INQ_1.2" = _WmhYbwGh;
        "pkg-INQ_1.3" = _BBBS8bVt;
        "pkg-INQ_1.4" = _TmLw8i35;
        "pkg-INQ_1.5" = _U6DMoyvN;
        "pkg-INQ_V1.5" = _mk6MfwhY;
        "pkg-INQ_V1.6" = _yyC63ZE7;
        "pkg-INQ_1.6" = _LhJnK3aK;
        "pkg-INQ_1.7" = _sRiKr9ai;
        "pkg-INQ_V1.7.1" = _16ofjbjW;
        "pkg-1.7.1" = _YHcbdogo;
        "pkg-INQ_1.7.5" = _OoW9C5r3;
        "pkg-INQ_V1.7.5" = _t9CT31iZ;
        "pkg-SI_1.8" = _Kt3Fv71J;
        "pkg-1.8.0" = _pLQUgEfV;
        "pkg-INQ_1.8.1" = _3Q5E4qsB;
        "pkg-INQ_1.9" = _juhgJeyi;
        "pkg-SI_2.0" = _E6NJdQzw;
        "pkg-INQ_2.0.0" = _YEG6ug8Y;
        "pkg-Spore_inquisition_2.1" = _lMcXjZXC;
        "pkg-spore_inquisition_2.1" = _KHs2ij1w;
        "pkg-INQ_2.1" = _GFNc0VOo;
        "pkg-INQ_2.2.0" = _CPqJJL6v;
        "pkg-INQ_2.2.1" = _KEdTLeeJ;
        "pkg-INQ_2.3.2" = _7o61YP9g;
        "pkg-2.3.2" = _L0AGdJwc;
        "pkg-INQ_2.4.0" = _z6qZNv6M;
        "pkg-INQ_2.5.0" = _cd1rj2kp;
        "pkg-INQ_2.5.1" = _lYYBjOKo;
        "pkg-INQ_2.5.1_NEO" = _1wCEkomq;
        "pkg-INQ_2.5.1_NEO(patch)" = _4LpPVLLw;
        "pkg-INQ_2.6.0" = _fEUAjZf3;
        "pkg-INQ_2.6.0_NEO" = _fYcWIDMf;
        "pkg-INQ_2.6.1_NEO" = _7EjFiTWR;
        "pkg-INQ_2.6.1" = _T60A5xth;
        "pkg-INQ_2.7.0_NEO" = _XKE3EFab;
        "pkg-INQ_2.7.0" = _wqof8Iln;
        "pkg-INQ_2.7.1_NEO" = _rf4ExBQ6;
        "pkg-INQ_NEO_2.7.2" = _h6gCafx6;
        "pkg-INQ_2.7.2" = _UiITgeHi;
        "pkg-INQ_NEO_2.7.3" = _RV52jOGt;
        "pkg-INQ_2.7.3" = _CgiVZANE;
        "pkg-INQ_NEO_2.8.0" = _xb9beAy3;
        "pkg-INQ_2.8.0" = _JnifjWC1;
        "pkg-INQ_2.8.1" = _egdU1ZHt;
        "pkg-INQ_NEO_2.9.0" = _zRs1yTF7;
        "pkg-INQ_2.9" = _dNoXUXB6;
        "pkg-INQ_2.9.0" = _8PihNixw;
        "pkg-INQ_NEO_2.9.1" = _WVc76yC7;
        "pkg-INQ_2.9.1" = _BLde8JfF;
        "pkg-INQ_NEO_2.9.2" = _gyNR8fM2;
        "pkg-INQ_2.9.2" = _ourHCsO8;
        "pkg-INQ_NEO_2.9.3" = _1Pw6nJGT;
        "pkg-INQ_2.9.3" = _Qb1SWoxV;
        "pkg-INQ_NEO_2.9.4" = _ISEKXfue;
        "pkg-INQ_2.9.4" = _Vpummprg;
        "pkg-INQ_2.9.5" = _kyIB9zHa;
        "pkg-INQ_2.9.5_NEO" = _zaPNcRUM;
        "pkg-INQ_2.9.6" = _400Oih00;
        "pkg-INQ_2.9.7" = _L0ToNkxX;
        "pkg-INQ_2.9.8" = _ZuR9ToDg;
        "pkg-INQ_3.0" = _WVRLDfR7;
        "pkg-INQ_3.1.0" = _jTBlVupd;
        "pkg-INQ_3.1" = _CCnEw85W;
