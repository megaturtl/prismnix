...
let
    ...
    in {
        ...
        "pkg-1.18.2-0.0.2-alpha.1" = _D9fKW1xF;
        "pkg-1.18.2-0.0.2-alpha.2" = _epwV2qfr;
        "pkg-1.18.2-0.0.2-alpha.3" = _ADOw9nNC;
        "pkg-1.18.2-0.0.2-alpha.4" = _U5Bj0Yqa;
        "pkg-1.18.2-0.0.2-alpha.5" = _k3wWtxMs;
        "pkg-1.18.2-0.0.2-alpha.6" = _oP47jjn6;
        "pkg-1.18.2-0.0.2-alpha.7" = _bnc3r30f;
        "pkg-1.18.2-0.0.2-alpha.8" = _sfQH6sQJ;
        "pkg-1.18.2-0.0.2-alpha.9" = _VtZODsEa;
        "pkg-1.18.2-0.0.2-alpha.10" = _RYEImqa9;
        "pkg-1.18.2-0.0.2-alpha.11" = _byISRu0P;
        "pkg-1.18.2-0.0.2-alpha.12" = _eFxVzko8;
        "pkg-1.18.2-0.0.2-alpha.12.1" = _ydQP1t9C;
        "pkg-1.18.2-0.0.2-alpha.13" = _eg87bL3y;
        "pkg-1.18.2-0.0.3-alpha.1" = _wSqU6zq0;
        "pkg-1.18.2-0.0.3-alpha.2" = _H2aPJdAz;
        "pkg-1.18.2-0.0.3-alpha.3" = _Xji0ZFiE;
        "pkg-1.18.2-0.0.3-alpha.4" = _3C7hz3QO;
        "pkg-1.18.2-0.0.3-alpha.5" = _BIwxnY5W;
        "pkg-1.18.2-0.0.3-alpha.6" = _HIw6o5oD;
        "pkg-1.18.2-0.0.3-alpha.7" = _dxdl4IKB;
        "pkg-1.18.2-0.0.3-alpha.8" = _1WOpjCYR;
        "pkg-1.18.2-0.0.4-alpha.1" = _khreVQXQ;
        "pkg-1.18.2-0.0.4-alpha.2" = _7AbFOoAx;
        "pkg-1.18.2-0.0.4-beta.1" = _TKqFQobd;
        "pkg-1.18.2-0.0.4-beta.2" = _TkqVnMAn;
        "pkg-1.19.2-0.0.4-alpha.6" = _WjJko21U;
        "pkg-1.19.2-0.0.5-alpha.1" = _Dc92WOXb;
        "pkg-1.18.2-0.0.5-alpha.1" = _4CioLyCj;
        "pkg-1.19.2-0.0.5-alpha.2" = _WLV6zBu3;
        "pkg-1.19.2-0.0.5-alpha.3" = _73gKTdye;
        "pkg-1.18.2-0.0.5-alpha.3" = _UsDNKyf6;
        "pkg-1.18.2-0.0.5-alpha.3-patch.1" = _TJJp64Sx;
        "pkg-1.18.2-0.0.5-alpha.4" = _vzvgEN1t;
        "pkg-1.19.2-0.0.5-alpha.4" = _3rEmv7PS;
        "pkg-1.18.2-0.0.5-alpha.5" = _LBVoE0tS;
        "pkg-1.19.2-0.0.5-alpha.5" = _J14XxOsF;
        "pkg-1.19.2-0.0.5-alpha.6" = _xLOsUGYS;
        "pkg-1.19.2-0.0.6-alpha.1" = _Ct8C76fV;
        "pkg-1.18.2-0.0.6-alpha.1" = _E67RqsYL;
        "pkg-1.18.2-0.0.6-alpha.2" = _37nOK1TV;
        "pkg-1.19.2-0.0.6-alpha.2" = _VoiSkcGE;
        "pkg-1.18.2-0.0.6-alpha.3" = _nY1uA5wV;
        "pkg-1.19.2-0.0.6-alpha.3" = _Q30YuXrr;
        "pkg-1.18.2-0.0.6-alpha.4" = _Stn9EAGM;
        "pkg-1.19.2-0.0.6-alpha.4" = _n6MLnLDS;
        "pkg-1.18.2-0.0.6-alpha.5" = _JL5Dhad4;
        "pkg-1.19.2-0.0.6-alpha.5" = _MD0x4kXK;
        "pkg-1.18.2-0.0.6-alpha.6" = _MJqul9xA;
        "pkg-1.19.2-0.0.6-alpha.6" = _yw5dgWiE;
        "pkg-1.18.2-0.0.6-alpha.7" = _wo6F7Wvm;
        "pkg-1.19.2-0.0.6-alpha.7" = _Oz96XMc1;
        "pkg-1.18.2-0.0.6-alpha.8" = _I88YAyiD;
        "pkg-1.18.2-0.0.6-alpha.9" = _effS3Cft;
        "pkg-1.19.2-0.0.6-alpha.9" = _jKSmsjC0;
        "pkg-1.18.2-0.0.6-alpha.10" = _eduNRJma;
        "pkg-1.18.2-0.0.7-alpha.1" = _GKwZTaex;
        "pkg-1.18.2-0.0.7-alpha.2" = _Z4AiXrWE;
        "pkg-1.18.2-0.0.7-alpha.3" = _F5hxqqYL;
        "pkg-1.18.2-0.0.7-alpha.6" = _fXp0NORM;
        "pkg-1.19.2-0.0.7-alpha.6" = _7yRLLG9m;
        "pkg-1.19.2-0.0.8-alpha.1" = _yVgQO4HE;
        "pkg-1.18.2-0.0.8-alpha.1" = _ZLr1QcEh;
        "pkg-1.18.2-0.0.9-alpha.1" = _NblOOQbD;
        "pkg-1.19.2-0.0.9-alpha.1" = _rUnZ7NQg;
        "pkg-1.19.2-0.0.9-alpha.2" = _ah9BGcIG;
        "pkg-1.19.2-0.0.9-alpha.2-a" = _z8w2RmF7;
        "pkg-1.19.2-0.0.9-alpha.2-b" = _QYXPOrtV;
        "pkg-1.19.2-0.0.9-alpha.2-c" = _Qff2nt6B;
        "pkg-1.19.2-0.0.9-alpha.2-d" = _1rHqNC1d;
