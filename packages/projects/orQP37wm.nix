...
let
    versions = (let
        ...
        _Xmgox0J4 = {
            "id" = "Xmgox0J4";
            "file" = "bbs-cml-2.1-1.20.1.jar";
            "hash" = "sha512-8uHhXH1pB5h5E2qBxYx+FULkdGNp9obljdlLUm3GngQC6lOZ3CzyxCTynUjUMJTBJZqB1BRrezqVqvNy7bfOmA==";
        };
        _sb3hAQph = {
            "id" = "sb3hAQph";
            "file" = "bbs-cml-2.1-1.20.4.jar";
            "hash" = "sha512-fR+8CEo0/l+M8JcHAwfysOIdbIrBInn1ebLZbH5YkMUWfbKmfm2XLNR/bSL364HJgCnBkncaKsFhP2YYYHZLEQ==";
        };
        _jXgbzPGl = {
            "id" = "jXgbzPGl";
            "file" = "bbs-cml-2.1-1.21.1.jar";
            "hash" = "sha512-DXo/i0naue1TXjk26sixLM7JywWjunK2sd66eXbzGhKds/oJQpSuexaS7avzoJU5fm86mtExMJs+FMWm99jU/A==";
        };
        _GPhWNLrk = {
            "id" = "GPhWNLrk";
            "file" = "bbs-cml-2.1-1.21.4.jar";
            "hash" = "sha512-1Ea5BAKA5jkz8kpZZxNOvjjdTo9H1F4iev4EdIOVQaaip2MjG5AO375sOGEg88KtCrK/v5UtgNuQhS4v5wYdSw==";
        };
        _yPJ4M5dZ = {
            "id" = "yPJ4M5dZ";
            "file" = "bbs-cml-2.1.0.1-1.20.1.jar";
            "hash" = "sha512-AhIcNGxXTqkhebDXhE7A/IPtaR7wOKwe/iJpUxmQ2B2Pd0QMktOeos10GZqD/q+qX3WpzNx3UBsYwOz+VcrnjQ==";
        };
        _AEXsdnjV = {
            "id" = "AEXsdnjV";
            "file" = "bbs-cml-2.1.0.1-1.20.4.jar";
            "hash" = "sha512-KBJSdh1V2n51GjDcDCKNsInuHuW4UO4iF5KslkcZJUImZsJnDZgMDPXZbaIjw0A2x8FoAim5xTyyQSjJSIkLJg==";
        };
        _IZFIzLit = {
            "id" = "IZFIzLit";
            "file" = "bbs-cml-2.1.1-1.20.1.jar";
            "hash" = "sha512-/yU1RJr1y8sdUdNamLh/ZExvxhoqWJmRw6QrJEQrSDjMs8i1vMP3rNUVT9IhEBtqoWUkLxwlg2FWBhugtQ3VsQ==";
        };
        _oZ3vQUCs = {
            "id" = "oZ3vQUCs";
            "file" = "bbs-cml-2.1.1-1.20.4.jar";
            "hash" = "sha512-9mVxymTuc7niNJvb6r/7lQWkAFxlhLj+ClRzQ7674lwMPBX76Z8y8/GHuRw2n5Y7UC9hRXcGGdSZLdAmdEXLEg==";
        };
        _6COSX9LA = {
            "id" = "6COSX9LA";
            "file" = "bbs-cml-2.1.1-1.21.1.jar";
            "hash" = "sha512-q5kj398A9PXCS+DoQzsrE6fZ3aKa3pJ9azM3DW2OgVatRm4jH6BhVDFI2rRzSMzBHEURiKwRIGnWJewAR2AERA==";
        };
        _VVXluRXp = {
            "id" = "VVXluRXp";
            "file" = "bbs-cml-2.1.1-1.21.4.jar";
            "hash" = "sha512-BUdgL061E9ec8e5M7BWRQwPmTz0yzt7W5UHs+4wtDyz5tx816ySZngaR/SeJEfjqVLlTa6woD4PoebQgihU/hg==";
        };
        _voCgxYxB = {
            "id" = "voCgxYxB";
            "file" = "bbs-cml-2.1.1-1.21.11.jar";
            "hash" = "sha512-BuYwP+J+1rI+lqodMe4wJWEIlds+54gCJdvDMjzahv0N+MPdk3YB9C1O7cCCqIAz8Oi76HZEx5tndPCrdPgPUg==";
        };
        _ArL26kcX = {
            "id" = "ArL26kcX";
    ...
    in {
        ...
        "pkg-1.6.21-beta-2-1.21.1" = _hNOMIpSS;
        "pkg-1.7-1.20.1" = _PfDvYzdx;
        "pkg-1.7-1.20.4" = _yyw01lDS;
        "pkg-1.7-beta-1-1.21.1" = _pqvs3zKz;
        "pkg-1.7.01-1.20.1" = _v843y60P;
        "pkg-1.7.01-1.20.4" = _80iBayQ5;
        "pkg-1.7.01-beta-1-1.21.1" = _2L9ZZAL3;
        "pkg-1.7.01-beta-2-1.21.1" = _35voGMVy;
        "pkg-1.7.01-beta-3-1.21.1" = _TwtkpqsM;
        "pkg-1.7.1-1.20.1" = _VULHoOvd;
        "pkg-1.7.1-1.20.4" = _U2zLY7VM;
        "pkg-1.7.1-beta-1-1.21.1" = _egAEADth;
        "pkg-1.7.1-beta-2-1.21.1" = _ED7Rib9d;
        "pkg-1.7.1-1.21.1" = _PcQ5b5w4;
        "pkg-1.7.11-1.20.1" = _pWMjm9Q4;
        "pkg-1.7.11-1.20.4" = _8LH6yEtp;
        "pkg-1.7.11-1.21.1" = _FuDb3xlu;
        "pkg-1.7.2-1.20.1" = _Ckk9LgA0;
        "pkg-1.7.2-1.20.4" = _P5UZumed;
        "pkg-1.7.2-1.21.1" = _UmzOM1Xc;
        "pkg-1.7.4-1.20.1" = _KYzlSNPp;
        "pkg-1.7.4-1.20.4" = _KNykYIyg;
        "pkg-1.7.4-1.21.1" = _QcPfPMjO;
        "pkg-1.7.5-1.20.1" = _RsEr6S90;
        "pkg-1.7.5-1.20.4" = _IvB9q8fa;
        "pkg-1.7.5-1.21.1" = _kAz68Fqq;
        "pkg-1.7.6-1.20.1" = _eA2Xv0LD;
        "pkg-1.7.6-1.20.4" = _pS7JV3PN;
        "pkg-1.7.6-1.21.1" = _CeoFW7y2;
        "pkg-1.7.6.1-1.20.1" = _PW83W1AO;
        "pkg-1.7.6.1-1.20.4" = _HRrsMmoq;
        "pkg-1.7.6.1-1.21.1" = _7sWxBuGF;
        "pkg-1.7.7-1.20.1" = _gGZ4ejEe;
        "pkg-1.7.7-1.20.4" = _AhcGhSTp;
        "pkg-1.7.7-1.21.1" = _YJfbPcGe;
        "pkg-1.8-1.20.1" = _FRDwAt0h;
        "pkg-1.8-1.20.4" = _Ml8ducTA;
        "pkg-1.8-1.21.1" = _cRRjn931;
        "pkg-1.8.1-1.20.1" = _3EUSiPra;
        "pkg-1.8.1-1.20.4" = _xRaAOxJ0;
        "pkg-1.8.1-1.21.1" = _OViJG8Uy;
        "pkg-1.9-1.20.1" = _1L5lcvsq;
        "pkg-1.9-1.20.4" = _EAUMaYJH;
        "pkg-1.9-1.21.1" = _aHCurZKU;
        "pkg-1.9-1.21.4" = _9vDMTh9L;
        "pkg-1.9.1-1.20.1" = _zEAE4tZA;
        "pkg-1.9.1-1.20.4" = _b3V08lpE;
        "pkg-1.9.1-1.21.1" = _7xhmq4Lp;
        "pkg-1.9.1-1.21.4" = _77FGbTO7;
        "pkg-1.9.2-1.20.1" = _dmioVCGX;
        "pkg-1.9.2-1.20.4" = _OjL8lyjL;
        "pkg-1.9.2-1.21.1" = _j7NYAVw1;
        "pkg-1.9.2-1.21.4" = _B6TcmGIJ;
        "pkg-1.9.3-1.20.1" = _1s1eEPqT;
        "pkg-1.9.3-1.20.4" = _IYkoesC8;
        "pkg-1.9.3-1.21.1" = _5uamzzW1;
        "pkg-1.9.3-1.21.4" = _qzqa7Vfo;
        "pkg-1.9.4-1.20.1" = _sl5dJewu;
        "pkg-1.9.4-1.20.4" = _dJhPOO8l;
        "pkg-1.9.4-1.21.1" = _cs57loI4;
        "pkg-1.9.4-1.21.4" = _xYdOaMqr;
        "pkg-1.10-1.20.1" = _HnxXLPWu;
        "pkg-1.10-1.20.4" = _zvfjY3kz;
        "pkg-1.10-1.21.1" = _4JmhbeVm;
        "pkg-1.10-1.21.4" = _kAdvHyyx;
        "pkg-1.10.1-1.20.1" = _4fpNZQhW;
        "pkg-1.10.1-1.20.4" = _fOOu5Fxs;
        "pkg-1.10.1-1.21.1" = _ZXGXGllp;
        "pkg-1.10.1-1.21.4" = _LXpmSz1i;
        "pkg-1.10.2-1.20.1" = _wxnIusOx;
        "pkg-1.10.2-1.20.4" = _6VkwYpp0;
        "pkg-1.10.2-1.21.1" = _R7JBnQVf;
        "pkg-1.10.2-1.21.4" = _R7E5PYYU;
        "pkg-1.10.3-1.20.1" = _O8v7l6WH;
        "pkg-1.10.3-1.20.4" = _7dSBPBEf;
        "pkg-1.10.3-1.21.1" = _TjyRrBVx;
        "pkg-1.10.3-1.21.4" = _zM3sLoDe;
        "pkg-2.0-beta-1-1.20.1" = _oaYMq7j1;
        "pkg-2.0-beta-1-1.20.4" = _SiyFQDtn;
        "pkg-2.0-beta-1-1.21.1" = _bEjsC5Ok;
        "pkg-2.0-beta-1-1.21.4" = _6B7ILS7p;
        "pkg-2.1-1.20.1" = _Xmgox0J4;
        "pkg-2.1-1.20.4" = _sb3hAQph;
        "pkg-2.1-1.21.1" = _jXgbzPGl;
        "pkg-2.1-1.21.4" = _GPhWNLrk;
        "pkg-2.1.0.1-1.20.1" = _yPJ4M5dZ;
        "pkg-2.1.0.1-1.20.4" = _AEXsdnjV;
        "pkg-2.1.1-1.20.1" = _IZFIzLit;
        "pkg-2.1.1-1.20.4" = _oZ3vQUCs;
        "pkg-2.1.1-1.21.1" = _6COSX9LA;
