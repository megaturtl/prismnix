...
let
    versions = (let
        ...
        _mvdZn9g0 = {
            "id" = "mvdZn9g0";
            "file" = "factory_blocks-fabric-1.4.2+mc26.2.jar";
            "hash" = "sha512-Eyi9kzRr/b1YDE5Yr/X78XqPWQsj/5SasjhvkpQ7rMdVkX1qPoGIisRuZr7uGjL+cZ4mpzifIgpsBG9mDTBjhw==";
        };
        _vSJ9lYDc = {
            "id" = "vSJ9lYDc";
    ...
    in {
        ...
        "pkg-1.31" = _ktp9EXGM;
        "pkg-1.3.2" = _VOfSHHfy;
        "pkg-fabric-1.21.1-1.3.2" = _vT2dpC0o;
        "pkg-neoforge-1.21.1-1.3.2" = _cMc2iiPt;
        "pkg-fabric-1.21.3-1.3.2" = _xC9SWpMU;
        "pkg-neoforge-1.21.3-1.3.2" = _J9BAPCwu;
        "pkg-fabric-1.20.4-1.3.1" = _tq3Plymn;
        "pkg-neoforge-1.20.4-1.3.1" = _90knW6QJ;
        "pkg-fabric-1.21.1-1.3.3" = _3Aa2DKNe;
        "pkg-neoforge-1.21.1-1.3.3" = _iHjj8Efi;
        "pkg-fabric-1.21.3-1.3.3" = _4NE3EQuZ;
        "pkg-neoforge-1.21.3-1.3.3" = _ZKbAWpF4;
        "pkg-fabric-1.21.1-1.3.4" = _wdTXMvbI;
        "pkg-neoforge-1.21.1-1.3.4" = _BcLgPqXB;
        "pkg-fabric-1.21.3-1.3.4" = _FTeNEMCJ;
        "pkg-neoforge-1.21.3-1.3.4" = _EzJ0cS7R;
        "pkg-fabric-1.21.4-1.3.4" = _K9eI8QnM;
        "pkg-neoforge-1.21.4-1.3.4" = _5udeGiP3;
        "pkg-fabric-1.21.4-1.4.0" = _oVcAb96n;
        "pkg-neoforge-1.21.4-1.4.0" = _ijQn2OJB;
        "pkg-fabric-1.21.1-1.4.0" = _qdbtjlzQ;
        "pkg-neoforge-1.21.1-1.4.0" = _7ugThhI5;
        "pkg-fabric-1.20.6-1.4.0" = _94I52IGs;
        "pkg-neoforge-1.20.6-1.4.0" = _J9jqWlXC;
        "pkg-fabric-1.20.4-1.4.0" = _loWTESKH;
        "pkg-neoforge-1.20.4-1.4.0" = _NE4WTdTp;
        "pkg-forge-1.20.4-1.4.0" = _qRdtgakP;
        "pkg-fabric-1.20.1-1.4.0" = _8uMRxAbr;
        "pkg-forge-1.20.1-1.4.0" = _R3EQLbo9;
        "pkg-fabric-1.21.5-1.4.0" = _2QUY8IUC;
        "pkg-neoforge-1.21.5-1.4.0" = _ZpJ1egAa;
        "pkg-fabric-1.21.7-1.4.0" = _dXLalFgL;
        "pkg-neoforge-1.21.7-1.4.0" = _rerAzydf;
        "pkg-fabric-1.21.8-1.4.1" = _ecJewAKv;
        "pkg-neoforge-1.21.8-1.4.1" = _qAbsYj1R;
        "pkg-fabric-1.21.9-1.4.2" = _zoFO6IU0;
        "pkg-neoforge-1.21.9-1.4.2" = _2AqARxaY;
        "pkg-fabric-1.21.10-1.4.2" = _bJuzhaNC;
        "pkg-neoforge-1.21.10-1.4.2" = _22MJsJeb;
        "pkg-fabric-1.21.11-1.4.2" = _x2yw2lCw;
