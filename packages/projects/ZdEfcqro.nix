...
let
    ...
    in {
        ...
        "pkg-1.0.3" = _WSVnreuU;
        "pkg-1.0.4" = _1XpXKb4W;
        "pkg-1.1.0-modfest" = _DyXTHGB1;
        "pkg-1.1.1-modfest" = _y7TheoSs;
        "pkg-2.0.0-alpha.1" = _wZ8dV0Me;
        "pkg-2.0.0-alpha.2" = _f9J11Rnv;
        "pkg-2.0.0-alpha.3" = _GzODxfno;
        "pkg-2.0.0-alpha.4" = _WtQE0eRV;
        "pkg-2.0.0-alpha.5" = _IpdOuyM9;
        "pkg-2.0.0-alpha.6" = _D387Cusk;
        "pkg-2.0.0-alpha.7" = _KIajkgMC;
        "pkg-2.0.0-alpha.8" = _hfb7tpIM;
        "pkg-2.0.0-alpha.9" = _qcM4rcR2;
        "pkg-2.0.0-alpha.10" = _wjvu4w0P;
        "pkg-2.0.0-alpha.11" = _8oPJIEQQ;
        "pkg-2.0.0-alpha.12" = _nvaeMsDf;
        "pkg-2.0.0-alpha.13" = _gep7jcMp;
        "pkg-2.0.0-alpha.14" = _xJsLmI51;
        "pkg-2.0.0-alpha.16" = _OSKW4kHk;
        "pkg-2.0.0-alpha.17" = _qZIcejPB;
        "pkg-2.0.0-alpha.18" = _8UteE7Kf;
        "pkg-2.0.0-alpha.19" = _gapygL3k;
        "pkg-2.0.0-alpha.20" = _qUVg32m1;
        "pkg-2.0.0-alpha.21" = _2ZGlkdGu;
        "pkg-2.0.0-alpha.22" = _b2h8CEZC;
        "pkg-2.0.0-alpha.23" = _43estSK6;
        "pkg-2.0.0-alpha.24" = _J1cWh6Lb;
        "pkg-2.0.0-alpha.26" = _ufqHDg5U;
        "pkg-2.0.0-alpha.27" = _x4iv98PC;
        "pkg-2.0.0-alpha.28" = _Pzawbdck;
        "pkg-2.0.0-alpha.29" = _R985CcMf;
        "pkg-2.0.0-alpha.30" = _qxZBYaJO;
        "pkg-2.0.0-alpha.31" = _qkjjNIpB;
        "pkg-2.0.0-alpha.32" = _yugFBmVV;
        "pkg-2.0.0-alpha.33" = _NhbrIwYe;
        "pkg-2.0.0-alpha.34" = _XjIUeLGs;
        "pkg-2.0.0-alpha.35" = _OoUyZulP;
        "pkg-2.0.0-alpha.36" = _nrant6qu;
        "pkg-2.0.0-alpha.37" = _Sm7MZ5lp;
        "pkg-2.0.0-alpha.38" = _62VuGmFR;
        "pkg-2.0.0-alpha.39" = _OOSUuWda;
        "pkg-2.0.0-beta.1" = _6iIhseiu;
        "pkg-2.0.0-beta.1b" = _U7lOpWlL;
        "pkg-2.0.0-beta.2" = _cfMhjZeU;
        "pkg-2.0.0-beta.2b" = _Msf70Di6;
        "pkg-2.0.0-beta.2c" = _xE1LnbVO;
        "pkg-2.0.0-beta.2d" = _CE7oKthR;
        "pkg-2.0.0-beta.3" = _DnW3woEP;
        "pkg-2.0.0-beta.4" = _VZIv3IMX;
        "pkg-2.0.0-beta.5" = _6gAhvmA4;
        "pkg-2.0.0-beta.5b" = _FXgt43Je;
        "pkg-2.0.0-beta.6" = _DbGtwqeX;
        "pkg-2.0.0-beta.7" = _AYH6HAQa;
        "pkg-2.0.0-beta.8" = _cF9NS4W0;
        "pkg-2.0.0-beta.9" = _QkeVztVw;
        "pkg-2.0.0-beta.10" = _bXCIzIvp;
        "pkg-2.0.0-beta.11" = _FuaH39cn;
        "pkg-2.0.0-beta.12" = _R04xDfwX;
        "pkg-2.0.0-beta.13" = _e6eQutbG;
        "pkg-2.0.0-beta.14" = _LkQETHJy;
        "pkg-2.0.0-beta.15" = _xWH2cEaB;
        "pkg-2.0.0-beta.16" = _flLiRuGw;
        "pkg-2.0.0-beta.17" = _ROGsldLS;
        "pkg-2.0.0-beta.18" = _bvCoE3bR;
        "pkg-2.0.0-beta.19" = _FGHEf7Ra;
        "pkg-2.0.0-beta.20" = _6c30fUNt;
        "pkg-2.0.0-beta.21" = _VXOtyph8;
        "pkg-2.0.0-beta.22" = _9cnadrMi;
        "pkg-2.0.0-beta.23" = _PZA9QuIB;
        "pkg-2.0.0-beta.24" = _R85KeYSF;
        "pkg-2.0.0-beta.25" = _2L2Qn6dL;
        "pkg-2.0.0-beta.26" = _KHp8wocx;
        "pkg-2.0.0-beta.27" = _Ik3ohvsJ;
        "pkg-2.0.0-beta.28" = _6DvdbkPV;
        "pkg-2.0.0-beta.29" = _zF36iIfg;
        "pkg-2.0.0-beta.30" = _xGaOxEs7;
        "pkg-2.0.0-beta.31" = _zPpYmiBg;
        "pkg-2.0.0-beta.32" = _tQicXWUw;
        "pkg-2.0.0-beta.33" = _A4zEQpaT;
        "pkg-2.0.0-beta.34" = _E4nzFsms;
        "pkg-2.0.0-beta.35" = _rLfJa4cg;
        "pkg-2.0.0-beta.36" = _qDn1FdmR;
        "pkg-2.0.0-beta.37" = _ORjJDm9A;
        "pkg-2.0.0-beta.38" = _YQuMbGju;
        "pkg-2.0.0-beta.39" = _MG7UviMs;
        "pkg-2.0.0-beta.40" = _CunG01Wo;
        "pkg-2.0.0-beta.41" = _veXgTHEv;
        "pkg-2.0.0-beta.42" = _i4xEDI7F;
        "pkg-2.0.0-beta.43" = _ahjWk1si;
        "pkg-2.0.0-beta.44" = _IoMPukGx;
        "pkg-2.0.0-beta.45" = _bBOWqoVz;
