...
let
    ...
    in {
        ...
        "pkg-2.1.8" = _W6iY82x9;
        "pkg-2.1.9" = _6K5oNnrM;
        "pkg-2.1.10" = _xFdcGJjE;
        "pkg-2.1.11" = _ZyPvRa1R;
        "pkg-2.1.12" = _sdntxJAh;
        "pkg-2.1.15" = _mqKdf6KB;
        "pkg-2.1.18" = _29CZbNK5;
        "pkg-2.1.19" = _SVLGprGQ;
        "pkg-2.1.20" = _peUQiXcS;
        "pkg-2.2.0" = _8vEEZlyC;
        "pkg-2.2.1" = _nFQFzAf4;
        "pkg-2.2.2" = _SQyIlbCk;
        "pkg-2.2.3" = _GyUfHDcp;
        ...
        "pkg-2.2.8" = _m6E3JIfC;
        "pkg-2.2.9" = _J2G7mqtJ;
        "pkg-2.2.10" = _LQsDGReC;
        "pkg-2.2.11" = _P3S0VCeW;
        "pkg-2.2.12" = _ZGAEfIga;
        "pkg-2.2.13" = _ZC4gSLEC;
        "pkg-2.2.14" = _3wYNaW0o;
        "pkg-2.2.15" = _Ec73DEjw;
        "pkg-2.2.16" = _CON0wms6;
        "pkg-2.2.17" = _nK0LBKg6;
        "pkg-2.2.18" = _Qm6KgGhB;
        "pkg-2.2.19" = _jafxSvLq;
        "pkg-2.2.20" = _NAttOmnc;
        "pkg-2.2.21" = _v5sBDaBy;
        "pkg-2.2.22" = _ic1SmBdB;
        "pkg-2.2.23" = _l3TMq49U;
        "pkg-2.2.24" = _SX6eESuL;
        "pkg-2.2.25" = _CCtGwfwN;
        "pkg-2.2.26" = _xOCUFvmA;
        "pkg-2.2.27" = _yODLURSc;
        "pkg-2.3.0" = _4ymhNxqv;
        "pkg-2.3.1" = _EfuiBrZS;
        "pkg-2.3.2" = _GJf03XJi;
        "pkg-2.3.3" = _AViTOG93;
        ...
        "pkg-2.3.8" = _t3MKKKyx;
        "pkg-2.3.9" = _J9ChJonu;
        "pkg-2.3.11" = _JbnE62oc;
        "pkg-2.3.12" = _qgf5Nbbm;
        "pkg-2.3.14" = _iRI5rICy;
        "pkg-2.3.15" = _4C23jqYB;
        "pkg-2.3.16" = _ygX97LeA;
        "pkg-2.3.18" = _VKPjdpcK;
        "pkg-2.3.19" = _NMx53lfW;
        "pkg-2.3.20" = _IRCeGJWm;
        "pkg-2.3.21" = _6ljrXWAX;
        "pkg-2.3.23" = _E7m40xCq;
        "pkg-2.3.24" = _RnYpTQWq;
        "pkg-2.3.25" = _8TGsDrnL;
        "pkg-2.3.26" = _cr1g1fDT;
        "pkg-2.3.27" = _s1DufhJ1;
        "pkg-2.3.28" = _UWTOc0i4;
        "pkg-2.3.29" = _OolwdROP;
        "pkg-2.3.31" = _fGOSz6ZS;
        "pkg-2.4.0" = _e75oM5KL;
        "pkg-2.4.1" = _hq6e9GKf;
        "pkg-2.4.2" = _HJbXTJR7;
        "pkg-2.4.3" = _Zflt7g3R;
        ...
        "pkg-2.7.8" = _7wEWcter;
        "pkg-2.7.9" = _jr1D0QYc;
        "pkg-2.7.10" = _cJcCuly6;
        "pkg-2.7.11" = _USej4KUn;
        "pkg-2.7.12" = _SwDS22TW;
        "pkg-2.7.13" = _wagVZdwz;
        "pkg-2.8.0" = _ItxIsw8f;
        "pkg-2.8.1" = _4kX3K9TR;
        "pkg-2.8.3" = _fnmEhNIr;
        "pkg-2.8.4" = _PTmUJWcg;
        ...
        "pkg-2.8.8" = _9ylM8ZW2;
        "pkg-2.8.9" = _wS0niO0z;
        "pkg-2.8.10" = _qQvE2ADZ;
        "pkg-2.8.12" = _Km22OF0B;
        "pkg-2.8.13" = _fNEK7bPD;
        "pkg-2.8.14" = _Lh2Opz0X;
        "pkg-2.8.15" = _hNuaiN34;
        "pkg-2.8.16" = _mHy60aGO;
        "pkg-2.8.17" = _F3lgCxah;
        "pkg-2.8.18" = _NgES9CaP;
        "pkg-2.8.19" = _iZ8ZQvmh;
        "pkg-2.8.20" = _fZsPfXPS;
        "pkg-2.8.21" = _p8L60kVj;
        "pkg-2.8.22" = _6CHyMJ42;
        "pkg-2.8.23" = _m2HIJ73M;
        "pkg-2.8.24" = _4lLoD4js;
        "pkg-2.8.25" = _hc9weLHy;
        "pkg-2.8.26" = _ShCnBaA1;
        "pkg-2.8.27" = _VCExVTQM;
        "pkg-2.8.28" = _epyWABTp;
        "pkg-2.8.29" = _s7YSDXv9;
        "pkg-2.8.30" = _d3CFmSQ1;
        "pkg-2.8.31" = _zzlKa2bM;
        "pkg-2.8.32" = _F3KzvkJl;
        "pkg-2.8.33" = _KIbXNQ8b;
        "pkg-2.9.0" = _q6xMnKjZ;
        "pkg-2.9.1" = _AjTC2rti;
        "pkg-2.9.2" = _MrEWJbbB;
        "pkg-2.9.3" = _RGDgzQjo;
        ...
        "pkg-2.9.8" = _Wp7uuuJj;
        "pkg-2.9.9" = _bElOxeLi;
        "pkg-2.9.10" = _TIxjaiTN;
        "pkg-2.9.11" = _4R8Sd9Is;
        "pkg-2.9.12" = _i1GYgy1l;
        "pkg-2.10.0" = _JVjVs3nF;
        "pkg-2.10.1" = _HaSTWPdy;
        "pkg-2.10.2" = _d4bZ7iWy;
        "pkg-2.10.3" = _GjRIBUhc;
        "pkg-2.10.4" = _rsKACxNv;
        "pkg-2.10.5" = _sTtak3Tm;
        "pkg-2.10.7" = _qqzEJKQe;
