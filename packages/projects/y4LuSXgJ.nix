...
let
    ...
    in {
        ...
        "pkg-1.1" = _Tfijw4FB;
        "pkg-1.2" = _sNIayF8h;
        "pkg-1.2+mod" = _9P1RNYD6;
        "pkg-1.2.1" = _ubShsAOl;
        "pkg-1.2.1+mod" = _nY5FsxST;
        "pkg-1.3" = _I3bmROxW;
        "pkg-1.3+mod" = _zbmHqwCS;
        "pkg-1.4" = _tUfkVL1x;
        "pkg-1.4+mod" = _3ZmfGBDR;
        "pkg-1.4.1" = _Y2vtG4wf;
        "pkg-1.4.1+mod" = _kF5rolcX;
        "pkg-1.5" = _hYwbxOpy;
        "pkg-1.6" = _6O67Ka3c;
        "pkg-1.6+mod" = _cGVqkzQD;
        "pkg-1.6.1" = _Ww2E0dvh;
        "pkg-1.6.1+mod" = _r00HjfLP;
        "pkg-1.6.2" = _l7gcabEi;
        "pkg-1.6.2+mod" = _unJ5fXdi;
        "pkg-1.6.3" = _xz4cKCR6;
        "pkg-1.6.3+mod" = _vrI1izMh;
        "pkg-1.7" = _szoqKC6u;
