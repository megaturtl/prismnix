...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _uLYWipnu;
        "pkg-1.1.1" = _npCwJpG7;
        "pkg-1.2.0+1.20" = _3grsecjC;
        "pkg-1.2.1+1.20.2" = _e0oFJNR4;
        "pkg-1.2.1+1.20.1" = _vRMylhKb;
        "pkg-1.2.2+1.20.2" = _oHwnVauW;
        "pkg-1.2.2+1.20.1" = _3br19ARs;
        "pkg-1.3.0+1.20.1" = _qUPoZome;
        "pkg-1.3.0+1.20.4" = _Wv0YXsLl;
        "pkg-1.3.0+1.20.2" = _iXkffJnL;
        "pkg-1.3.1+1.20.4" = _AGuu8V0O;
        "pkg-1.3.1+1.20.2" = _4hwz5gJ5;
        "pkg-1.3.1+1.20.1" = _BFDkkt53;
        "pkg-1.3.1+1.20.1-quilt" = _tRmWABic;
        "pkg-1.3.2+1.20.4" = _4r7Eb0KH;
        "pkg-1.3.2+1.20.2" = _XguaNYMT;
        "pkg-1.3.2+1.20.1" = _563BLQFl;
        "pkg-1.3.3+1.20.1" = _eetmNRG6;
        "pkg-1.3.3+1.20.2" = _1CSHYZpN;
        "pkg-1.3.3+1.20.4" = _47GKXlR4;
        "pkg-1.3.4+1.20.4" = _968wmL2s;
        "pkg-1.3.4+1.20.2" = _6xTkTT9X;
        "pkg-1.3.4+1.20.1" = _l9r8jlfC;
        "pkg-1.3.5+1.20.4" = _RSVE3uJR;
        "pkg-1.3.5+1.20.2" = _rgLmBU6m;
        "pkg-1.3.5+1.20.1" = _jQZMe0Tv;
        "pkg-1.3.6+1.20.2" = _jMlicYba;
        "pkg-1.3.6+1.20.4" = _q6wcKRo3;
        "pkg-1.3.6+1.20.1" = _RhlsDK3W;
        "pkg-1.3.7+1.20.4" = _F5zFCfmS;
        "pkg-1.3.7+1.20.2" = _XJDLUGuC;
        "pkg-1.3.7+1.20.1" = _7WZmof4O;
        "pkg-1.3.8+1.20.4" = _JwdGDHdd;
        "pkg-1.3.8+1.20.2" = _rnSY66fA;
        "pkg-1.3.8+1.20.1" = _khIWIN26;
        "pkg-1.3.9+1.20.4" = _Ck1KSuuk;
        "pkg-1.3.9+1.20.2" = _I5NdC3lx;
        "pkg-1.3.9+1.20.1" = _SCYn1kjC;
        "pkg-1.3.10+1.21" = _pJUT1LUJ;
        "pkg-1.3.10+1.20.1" = _I6CzCExt;
        "pkg-1.3.10+1.20.4" = _XKiE1JwH;
        "pkg-1.3.10+1.20.2" = _fqwD5szZ;
        "pkg-1.3.11+1.21" = _mNs7N00W;
        "pkg-1.3.12+1.21" = _Fjq1WgSF;
        "pkg-1.3.11+1.20.1" = _3cQ06w06;
        "pkg-1.3.11+1.20.2" = _HhmmQdSY;
        "pkg-1.3.11+1.20.4" = _K9C1asMQ;
        "pkg-1.3.13+1.21" = _5y2VuJy8;
        "pkg-1.3.14+1.21" = _mnsHa6Iz;
        "pkg-1.3.15+1.21" = _ODoS7bKw;
        "pkg-1.3.16+1.21" = _3SJXFvmT;
