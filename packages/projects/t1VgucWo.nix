...
let
    ...
    in {
        ...
        "pkg-1.2.0a-forge-mc1.16" = _E199JZSj;
        "pkg-1.2.0a-forge-mc1.17" = _UWEsBQJT;
        "pkg-1.2.0a-forge-mc1.18" = _mSVESha4;
        "pkg-1.2.0-forge-mc1.19" = _i17wjNI7;
        "pkg-1.2.0b-forge-mc1.18" = _l0bcjh5d;
        "pkg-1.2.0c-forge-mc1.18" = _yVdKYuxx;
        "pkg-1.2.1-forge-mc1.12" = _vuh4kYD4;
        "pkg-1.2.1-forge-mc1.14" = _HZ31FVsE;
        "pkg-1.2.1-forge-mc1.15" = _eIwRSnQS;
        "pkg-1.2.1-forge-mc1.16" = _NWpVyuF2;
        "pkg-1.2.1-forge-mc1.17" = _YTfOw7GP;
        "pkg-1.2.1-forge-mc1.18" = _kx29gG6K;
        "pkg-1.2.1-forge-mc1.19" = _McvA3ctc;
        "pkg-1.2.1a-forge-mc1.12" = _sVJrZo57;
        "pkg-1.2.2-forge-mc1.12" = _993MFr6g;
        "pkg-1.2.2-forge-mc1.14" = _G0kF1i0I;
        "pkg-1.2.2-forge-mc1.15" = _qrGvW17L;
        "pkg-1.2.2-forge-mc1.16" = _bsvfAlj4;
        "pkg-1.2.2-forge-mc1.17" = _HD9bjW2i;
        "pkg-1.2.2-forge-mc1.18" = _9q1E7PBj;
        "pkg-1.2.2-forge-mc1.19" = _YFCrILYM;
        "pkg-1.2.3-forge-mc1.12" = _SGHOLQLc;
        "pkg-1.2.3-forge-mc1.14" = _GfQ3cCXI;
        "pkg-1.2.3-forge-mc1.15" = _9aOEZi4K;
        "pkg-1.2.3-forge-mc1.16" = _VzN1H3c6;
        "pkg-1.2.3-forge-mc1.17" = _aGjZzOiy;
        "pkg-1.2.3-forge-mc1.18" = _8PzYfFJm;
        "pkg-1.2.3-forge-mc1.19" = _uKbb8SyA;
        "pkg-1.2.3-forge-mc1.19.3" = _xH7Q7mUz;
        "pkg-1.2.3-fabric-mc1.18" = _xicdW1RC;
        "pkg-1.2.3-fabric-mc1.19" = _hNkmLoio;
        "pkg-1.2.3a-fabric-mc1.19" = _FItKqQcm;
        "pkg-1.2.3a-fabric-mc1.18" = _ISGAyDiW;
        "pkg-1.2.3b-fabric-mc1.19" = _ghLonkq8;
        "pkg-1.2.3a-fabric-mc1.19.2" = _nsY9eCFI;
        "pkg-1.2.3-forge-mc1.20" = _DGwOl4dJ;
        "pkg-1.2.3-fabric-mc1.20" = _5VD2MQ6h;
        "pkg-1.2.4-forge-mc1.12" = _ptVqFrcV;
        "pkg-1.2.4-forge-mc1.14" = _855Ri8us;
        "pkg-1.2.4-forge-mc1.15" = _j3AM2X6n;
        "pkg-1.2.4-forge-mc1.16" = _jokIgSPy;
        "pkg-1.2.4-forge-mc1.17" = _j6yzIty0;
        "pkg-1.2.4-forge-mc1.18" = _j9qbW9nY;
        "pkg-1.2.4-forge-mc1.19" = _s5DpU408;
        "pkg-1.2.4-forge-mc1.19.3" = _wmeQ9i4G;
        "pkg-1.2.4-forge-mc1.20" = _IIJptZdV;
        "pkg-1.2.4-fabric-mc1.18" = _Mee0Zmcq;
        "pkg-1.2.4-fabric-mc1.19.2" = _l9fGlE36;
        "pkg-1.2.4-fabric-mc1.19.4" = _CGxscaUm;
        "pkg-1.2.4-fabric-mc1.20" = _dNZBYcoe;
        "pkg-1.2.5-forge-mc1.12" = _7dyHD5kT;
        "pkg-1.2.5-forge-mc1.14" = _7L7h5R0w;
        "pkg-1.2.5-forge-mc1.15" = _dAQrtx56;
        "pkg-1.2.5-forge-mc1.16" = _7aZxAyKB;
        "pkg-1.2.5-forge-mc1.17" = _YTdH7dfB;
        "pkg-1.2.5-forge-mc1.18" = _lZFKf7cy;
        "pkg-1.2.5-forge-mc1.19" = _Ih5fuqj9;
        "pkg-1.2.5-forge-mc1.19.3" = _rQL4CV1q;
        "pkg-1.2.5-forge-mc1.20" = _B4VDIIaS;
        "pkg-1.2.5-fabric-mc1.18" = _FMESdx6O;
        "pkg-1.2.5-fabric-mc1.19.2" = _w1znH6Fu;
        "pkg-1.2.5-fabric-mc1.19.4" = _4zJuI5wR;
        "pkg-1.2.5-fabric-mc1.20" = _CLXY4UTJ;
        "pkg-1.2.6-forge-mc1.12" = _IxArPOBE;
        "pkg-1.2.6-forge-mc1.14" = _TUWrfPDb;
        "pkg-1.2.6-forge-mc1.15" = _ttJLOJ0E;
        "pkg-1.2.6-forge-mc1.16" = _TN6Ko1Sv;
        "pkg-1.2.6-forge-mc1.17" = _Z6mttIR2;
        "pkg-1.2.6-forge-mc1.18" = _10vtjlNo;
        "pkg-1.2.6-forge-mc1.19" = _Dw0bJfZ8;
        "pkg-1.2.6-forge-mc1.19.3" = _rVT7k6hB;
        "pkg-1.2.6-forge-mc1.20" = _c6YzcMUb;
        "pkg-1.2.6-fabric-mc1.18" = _ziU3mBh8;
        "pkg-1.2.6-fabric-mc1.19.2" = _GT3mrXK3;
        "pkg-1.2.6-fabric-mc1.19.4" = _6bwIervH;
        "pkg-1.2.6-fabric-mc1.20" = _n4xh5U1E;
        "pkg-1.2.7-forge-mc1.12" = _z9r9eJ1x;
        "pkg-1.2.7-forge-mc1.14" = _cmnQESu0;
        "pkg-1.2.7-forge-mc1.15" = _DFFFcfsc;
        "pkg-1.2.7-forge-mc1.16" = _KKFDbucy;
        "pkg-1.2.7-forge-mc1.17" = _wN8rCnoN;
        "pkg-1.2.7-forge-mc1.18" = _CJqEBEDD;
        "pkg-1.2.7-forge-mc1.19" = _aRtouEHl;
        "pkg-1.2.7-forge-mc1.19.3" = _QAWe21ih;
        "pkg-1.2.7-forge-mc1.20" = _UzRykJUh;
        "pkg-1.2.7-fabric-mc1.18" = _FYmvC9wC;
        "pkg-1.2.7-fabric-mc1.19.2" = _25xxXe9G;
        "pkg-1.2.7-fabric-mc1.19.4" = _StY45dJx;
        "pkg-1.2.7-fabric-mc1.20" = _chLuNprv;
        "pkg-1.2.7a-fabric-mc1.19.4" = _oRV9iZVS;
        "pkg-1.2.7a-fabric-mc1.20" = _MAhhQIJQ;
        "pkg-1.2.7-forge-mc1.20.2" = _G9vY0194;
        "pkg-1.2.7-fabric-mc1.20.2" = _PHToKfLy;
        "pkg-1.2.8-forge-mc1.12" = _HTN6HT0T;
        "pkg-1.2.8-forge-mc1.14" = _asXFiioB;
        "pkg-1.2.8-forge-mc1.15" = _62EtLbso;
        "pkg-1.2.8-forge-mc1.16" = _tcPp3PBs;
        "pkg-1.2.8-forge-mc1.17" = _hYD5P16x;
        "pkg-1.2.8-forge-mc1.18" = _7SvqpjDN;
        "pkg-1.2.8-forge-mc1.19" = _clRc0WZF;
        "pkg-1.2.8-forge-mc1.19.3" = _EjYWcEzP;
        "pkg-1.2.8-forge-mc1.20.1" = _cw2O8qBa;
        "pkg-1.2.8-forge-mc1.20.2" = _k3o6MmHf;
        "pkg-1.2.8-fabric-mc1.18" = _Ja25XP8g;
        "pkg-1.2.8-fabric-mc1.19.2" = _7ImQBjzV;
        "pkg-1.2.8-fabric-mc1.19.4" = _SlqN1ggx;
        "pkg-1.2.8-fabric-mc1.20.1" = _CDdzV3es;
        "pkg-1.2.8-fabric-mc1.20.2" = _HsEF5Naf;
        "pkg-1.2.8a-fabric-mc1.18" = _OgWAEFCM;
        "pkg-1.2.8a-fabric-mc1.19.2" = _Npx0lXO9;
        "pkg-1.2.8a-fabric-mc1.19.4" = _O6JiIGSy;
        "pkg-1.2.8a-fabric-mc1.20.1" = _rLIi25kQ;
        "pkg-1.2.8a-fabric-mc1.20.2" = _7xP4xdKu;
        "pkg-1.2.8a-forge-mc1.12" = _tfYf5GO3;
        "pkg-1.2.8a-forge-mc1.14" = _Czerz3RO;
        "pkg-1.2.8a-forge-mc1.15" = _xQ1dzFVt;
        "pkg-1.2.8a-forge-mc1.16" = _D9ED6hSW;
        "pkg-1.2.8a-forge-mc1.17" = _NWVKLE6k;
        "pkg-1.2.8a-forge-mc1.18" = _ULA5VvxR;
        "pkg-1.2.8a-forge-mc1.19" = _CCyTzaOu;
        "pkg-1.2.8a-forge-mc1.19.3" = _VLFYcWzb;
        "pkg-1.2.8a-forge-mc1.20.1" = _5RSR78ic;
        "pkg-1.2.8a-forge-mc1.20.2" = _JFhqPzPp;
        "pkg-1.2.8a-fabric-mc1.20.4" = _Efqeu7hh;
        "pkg-1.2.8a-forge-mc1.20.4" = _eTG0SiFM;
        "pkg-1.2.8-neoforge-mc1.20.4" = _Dqxwau0G;
        "pkg-1.2.8-forge-mc1.20.6" = _LAuUc8hQ;
        "pkg-1.2.8-forge-mc1.21" = _dIX4rSPs;
        "pkg-1.2.8-fabric-mc1.20.6" = _xmu85750;
        "pkg-1.2.8-fabric-mc1.21" = _Tjs2pHHR;
        "pkg-1.2.8-neoforge-mc1.20.6" = _VbZdUcjd;
        "pkg-1.2.8-neoforge-mc1.21" = _xC7Vc2qa;
        "pkg-1.2.8b-forge-mc1.12" = _MYsVsPVw;
        "pkg-1.2.8b-fabric-mc1.20.4" = _ZvBwIK13;
        "pkg-1.2.8b-fabric-mc1.20.6" = _W54WRntE;
        "pkg-1.2.8b-fabric-mc1.21" = _IhWfYqZC;
        "pkg-1.2.8-fabric-mc1.21.2" = _JxVoQPNL;
        "pkg-1.2.8-neoforge-mc1.21.3" = _DcLR0c3B;
        "pkg-1.2.8a-fabric-mc1.21.2" = _TwdwvJwY;
        "pkg-1.2.8a-neoforge-mc1.21.3" = _TYlmSj84;
        "pkg-1.2.8-forge-mc1.21.3" = _4PFmpbch;
        "pkg-1.2.8-forge-mc1.21.4" = _9hWDv9G0;
        "pkg-1.2.8-fabric-mc1.21.4" = _YAT1856z;
        "pkg-1.2.8-neoforge-mc1.21.4" = _cfIpS686;
        "pkg-1.2.8-forge-mc1.21.5" = _oiholC0Z;
        "pkg-1.2.8-forge-mc1.21.6" = _Gf766BBr;
        "pkg-1.2.8-fabric-mc1.21.5" = _czXIrUZ4;
        "pkg-1.2.8-fabric-mc1.21.6" = _sbzDlnx3;
        "pkg-1.2.8-neoforge-mc1.21.5" = _50CQ0LQW;
        "pkg-1.2.8-neoforge-mc1.21.6" = _JYZ2Eyfv;
        "pkg-1.2.9-forge-mc1.14" = _eaioHImq;
        "pkg-1.2.9-forge-mc1.15" = _jpYwb0VL;
        "pkg-1.2.9-forge-mc1.16" = _veolC3ZX;
        "pkg-1.2.9-forge-mc1.17" = _a4qqL9rG;
        "pkg-1.2.9-forge-mc1.18" = _wv37hF8Q;
        "pkg-1.2.9-forge-mc1.19.2" = _viu9OEbV;
        "pkg-1.2.9-forge-mc1.19.4" = _C1eZH1X3;
        "pkg-1.2.9-forge-mc1.20.1" = _hfQ3VSpz;
        "pkg-1.2.9-forge-mc1.20.2" = _NjxcM0Xc;
        "pkg-1.2.9-forge-mc1.20.4" = _LoITzQrQ;
        "pkg-1.2.9-forge-mc1.20.6" = _hKet41BF;
        "pkg-1.2.9-forge-mc1.21" = _vULQJkUf;
        "pkg-1.2.9-forge-mc1.21.3" = _rR3yI0Nv;
        "pkg-1.2.9-forge-mc1.21.4" = _BeLQAmKO;
        "pkg-1.2.9-forge-mc1.21.5" = _BCjsfIzV;
        "pkg-1.2.9-forge-mc1.21.6" = _lmcXd2ke;
        "pkg-1.2.9-fabric-mc1.18" = _4bZ6eeSU;
        "pkg-1.2.9-fabric-mc1.19.2" = _8QNpuH2N;
        "pkg-1.2.9-fabric-mc1.19.4" = _UjdmRlRb;
        "pkg-1.2.9-fabric-mc1.20.1" = _muWpIAch;
        "pkg-1.2.9-fabric-mc1.20.2" = _uNuQLlBB;
        "pkg-1.2.9-fabric-mc1.20.4" = _msYXKhYx;
        "pkg-1.2.9-fabric-mc1.20.6" = _ULorm3lJ;
        "pkg-1.2.9-fabric-mc1.21.1" = _gC8IvJwh;
        "pkg-1.2.9-fabric-mc1.21.3" = _48E6YWy9;
        "pkg-1.2.9-fabric-mc1.21.4" = _nMy6BFj7;
        "pkg-1.2.9-fabric-mc1.21.5" = _4y4STU5D;
        "pkg-1.2.9-fabric-mc1.21.6" = _Tu5ARCZQ;
        "pkg-1.2.9-neoforge-mc1.20.4" = _pZxFkrEL;
        "pkg-1.2.9-neoforge-mc1.20.6" = _XnWHLx76;
        "pkg-1.2.9-neoforge-mc1.21" = _lVVhQRyh;
        "pkg-1.2.9-neoforge-mc1.21.3" = _H7KrLyB5;
        "pkg-1.2.9-neoforge-mc1.21.4" = _nzAGWiM7;
        "pkg-1.2.9-neoforge-mc1.21.5" = _DbVfFQRq;
        "pkg-1.2.9-neoforge-mc1.21.6" = _fT0cnr3D;
        "pkg-1.2.9-forge-mc1.12" = _s8TUpsaG;
        "pkg-1.2.9-forge-mc1.21.10" = _27FSD7Vj;
        "pkg-1.2.9-fabric-mc1.21.10" = _42mMnrlT;
        "pkg-1.2.9-neoforge-mc1.21.10" = _LaFNjLeQ;
        "pkg-1.2.9-forge-mc1.21.11" = _jBoDY02b;
        "pkg-1.2.9-fabric-mc1.21.11" = _5VbbD2VB;
        "pkg-1.2.9-neoforge-mc1.21.11" = _4h7Plucn;
        "pkg-1.2.9a-forge-mc1.12" = _6RtABTVf;
        "pkg-1.2.9-forge-mc26.1" = _DuuEzayB;
        "pkg-1.2.9-fabric-mc26.1" = _78s3Ulp1;
        "pkg-1.2.9-neoforge-mc26.1" = _Iy64Jptk;
