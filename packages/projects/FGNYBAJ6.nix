...
let
    ...
    in {
        ...
        "pkg-1.1.3-1.20.1" = _fa5BKC9j;
        "pkg-1.2.0" = _C8rLpXhf;
        "pkg-1.3.0-1.20.1" = _LS4Bg3iE;
        "pkg-1.3.0-1.20.4" = _UjXhlzMA;
        "pkg-1.3.1-1.20.1" = _WhsAzNev;
        "pkg-1.3.1-1.20.4" = _gNOFzRcX;
        "pkg-1.3.1-1.21" = _5Qr2Hgfm;
        "pkg-1.3.2-1.21" = _UszGGdUL;
        "pkg-1.4.0-1.20.1" = _4FwkV0dM;
        "pkg-1.4.0-1.20.4" = _QCW5oYPk;
        "pkg-1.4.0-1.21" = _42Wryi21;
        "pkg-1.4.1-1.20.1" = _AQDvTm1D;
        "pkg-1.4.1-1.20.4" = _SUcwsuAL;
        "pkg-1.4.1-1.21" = _9Ewg7LhM;
        "pkg-1.4.2-1.20.1" = _6ymmZlur;
        "pkg-1.4.2-1.20.4" = _OUnBi3UI;
        "pkg-1.4.2-1.21" = _Wh3fIkWf;
        "pkg-1.4.3-1.21" = _6yETl5eW;
        "pkg-1.4.3-1.21.3" = _UhXcU6y1;
        "pkg-1.4.3-1.21.4" = _ZElOxBWg;
        "pkg-1.4.3-1.21.5" = _mcgcwqAr;
        "pkg-1.4.4-1.21.3" = _mWbt3TeZ;
        "pkg-1.4.4-1.21.4" = _mIP91dWr;
        "pkg-1.4.4-1.21.5" = _NrLGzPZo;
        "pkg-1.4.5-1.21.4" = _ZSFjS3V4;
        "pkg-1.4.5-1.21.5" = _u9aXOCE5;
        "pkg-1.5.0-1.20.1" = _ZKoWMpGz;
        "pkg-1.5.0-1.21" = _m3X6me7Y;
        "pkg-1.5.0-1.21.5" = _faBAb1Vs;
        "pkg-1.5.1-1.21.1" = _b0zbZhqN;
        "pkg-1.5.1-1.21" = _jwBqz6wk;
        "pkg-1.5.1-1.21.5" = _tvdWmRbA;
        "pkg-1.5.2-1.21" = _5PTwuDHb;
        "pkg-1.5.2-1.21.5" = _euKVpoZJ;
        "pkg-1.5.2-1.21.1" = _ynxmux07;
        "pkg-1.5.3-1.21.1" = _OzLL4h40;
        "pkg-1.5.3-1.21.5" = _s49cXaLP;
        "pkg-1.5.3-1.21.11" = _voKP3soK;
