...
let
    ...
    in {
        ...
        "pkg-1.20.1-0.0.21" = _5NNHQ7NR;
        "pkg-1.21.1-24.10.0903" = _VbWMiYJY;
        "pkg-1.21.1-24.10.1000-neo" = _gJTeGn8i;
        "pkg-1.21.1-24.10.1600" = _QTOyZkXJ;
        "pkg-1.21.1-24.10.1801-neo" = _gYEzrRh5;
        "pkg-1.21.1-24.11.2101-neo" = _5EVyXljk;
        "pkg-1.21.4-24.12.2600-Neo" = _AyvBhJ3a;
        "pkg-1.21.1-25.01.0300-Neo" = _B8gEnq1G;
        "pkg-1.21.1-25.02.0600-Neo" = _y4aoC9tZ;
        "pkg-1.21.1-25.02.1400-Neo" = _ujdmZ8Sj;
        "pkg-1.21.1-25.04.2101-Beta-Neo" = _mhcgAYRD;
        "pkg-1.21.1-25.04.2901-Beta-Neo" = _jeyV8WAP;
        "pkg-1.21.1-25.05.1700" = _FzLsFeLA;
        "pkg-1.21.5-25.05.2400-Neo" = _vClmnNIx;
        "pkg-1.21.5-25.05.2600-Neo" = _JPIv7skE;
        "pkg-1.21.1-25.06.2000-Neo" = _Qowma2ca;
        "pkg-1.20.1-25.07.0800" = _AdIiHjWd;
        "pkg-1.21.7-25.07.1100-Neo" = _aLUGR35g;
        "pkg-1.21.8-2.0.0-25071900-Neo" = _Cn63GFmI;
        "pkg-1.21.8-2.0.0-25072000" = _8v0UjjkR;
        "pkg-1.21.9-2.0.0-25100800-Neo" = _bJ5R35FH;
        "pkg-1.21.10-2.0.0-25101400-Neo" = _sQYL3CSe;
        "pkg-1.21.10-2.0.0-25101600-Neo" = _rola7dvZ;
        "pkg-1.21.1-2.0.1-25103100-Neo" = _7XsTahzZ;
        "pkg-1.21.10-2.0.0-25103100" = _7QlRFXl7;
        "pkg-1.21.10-2.0.0-25110100" = _yDuMUAuw;
        "pkg-1.21.1-2.0.2-25110200-Neo" = _uE35QeQH;
        "pkg-1.21.1-2.0.4-25110500-Neo" = _2oFdjyMV;
        "pkg-1.21.11-2.0.1-25122100-Neo" = _V8M215Tr;
        "pkg-1.21.11-2.0.1-25122500" = _RSO0wWq4;
        "pkg-1.21.11-2.0.2-26020300-Neo" = _VREBnA4A;
        "pkg-26.1.1-2.0.2-26020300-Neo" = _aXpQAGOE;
        "pkg-26.1.1-2.0.2-26041100-Neo" = _YXqo4Tfo;
        "pkg-26.1.2-2.0.2-26041100-Neo" = _ZhbKGyjK;
        "pkg-26.1.1-2.0.1-26041300" = _OD9Cj3xr;
        "pkg-26.1.1-2.0.2-26041500-Neo" = _fTeAYtqH;
        "pkg-26.1.1-2.0.2-26041600-Neo" = _iBV4avZ7;
        "pkg-26.1.1-2.1.0-26061200-Neo" = _mtVhxi1j;
