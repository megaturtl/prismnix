...
let
    versions = (let
        ...
        _Hwqp4xhc = {
            "id" = "Hwqp4xhc";
            "file" = "emotecraft-fabric-for-MC1.21.11-3.2.0-b.build.163.jar";
            "hash" = "sha512-zKHtfn8NtNg/g87rXRRtTGfT/vZJku73rMTtMRLqA+u8IbBfJn0oOnTMCWCl2Fkjle9F9dxHPt6c/YXfVhBNiw==";
        };
        _Nxw2htPO = {
            "id" = "Nxw2htPO";
            "file" = "emotecraft-neoforge-for-MC1.21.11-3.2.0-b.build.163.jar";
            "hash" = "sha512-OkDvTF0DpV6X3H3BgoqrsV6Am2xSWMOqnAW7UyUv3SO7iqbmHqKd8ncHv5qooDyZAq1LOjZJBB/J+UKsKKZKIQ==";
        };
        _Gh7hgcmW = {
            "id" = "Gh7hgcmW";
            "file" = "emotecraft-paper-for-MC1.21.11-3.2.0-b.build.163.jar";
            "hash" = "sha512-J4hL+4u2qjb3PeuqElxzSRMXB/iXjw+jyRSmYy0e9hH+TMSaFko6coRaZCfFJ6onGbSjuyN8360N15hJn3uLaw==";
        };
        _SZ4GecpA = {
            "id" = "SZ4GecpA";
            "file" = "emotecraft-geyser-for-MC1.21.11-3.2.0-b.build.163.jar";
            "hash" = "sha512-LLO26uCaTYgJAZJnbonptFfTiVfathjgD5j+ym/5Wj75WCo4f9ofhU9xtzI2JUzoIUNoKImq8Z0vzr5kgCTu2Q==";
        };
        _N3M6FTa2 = {
            "id" = "N3M6FTa2";
            "file" = "emotecraft-for-MC26.1.2-3.3.0-b.build.164.jar";
            "hash" = "sha512-JGVP1OciF9RWEuSeT47T4qdufwEKspQbk3N6TPqXIoaa6DVHJwz8cIE4W3T8AZ6iqQBBuQN3hv/rPQ2izP28KQ==";
        };
        _HeWPsF8V = {
            "id" = "HeWPsF8V";
            "file" = "emotecraft-paper-for-MC26.1.2-3.3.0-b.build.164.jar";
            "hash" = "sha512-XHUAYlmUEFClZL9SlPhSQDlwOBOj8/sQD86bKEXyOkPMz75GZWko/UMFs9+sBx4jd6cY0jtMSsqWicDkYEiQIA==";
        };
        _aZNbAEkv = {
            "id" = "aZNbAEkv";
            "file" = "emotecraft-geyser-for-MC26.1.2-3.3.0-b.build.164.jar";
            "hash" = "sha512-fChFq90V9/XgG0KrpkrWNGa5HK7PGE5gpWUXIDWB1reckQtzXJvGjhx7N5frqDWzij16vfozjWs2ywKR9CO1uw==";
        };
        _dWmUMoEr = {
            "id" = "dWmUMoEr";
            "file" = "emotecraft-for-MC26.2-3.4.0-b.build.165.jar";
            "hash" = "sha512-1GHsRJzgIEdIZrGQaT/C+NyVaHrzrReOoaclXEHZKlNz1sjFKewSb+DrM50NwyV0rUkqOv4xBQwKQo2OQxEkXw==";
        };
        _m45dAoAQ = {
            "id" = "m45dAoAQ";
            "file" = "emotecraft-paper-for-MC26.2-3.4.0-b.build.165.jar";
            "hash" = "sha512-AKhdwSFYpIs297ECiHkIfbrXIMmSmZB3lA1OkhvYo2WmM+AP9GGCGjD+ez7xwSP4s3T84qy2zsgNt23q6dTdjw==";
        };
        _IzrUr1gI = {
            "id" = "IzrUr1gI";
            "file" = "emotecraft-geyser-for-MC26.2-3.4.0-b.build.165.jar";
            "hash" = "sha512-rz3abg+Otwmo9T0a5xj0axD5cGQA3ntML0GdL8swxMFVjNHRio0URbuPQlwuIJd9ffSkTZoE01j8OCaurxhcIA==";
        };
        _SGqvzAHz = {
            "id" = "SGqvzAHz";
            "file" = "emotecraft-paper-for-MC26.2-3.4.0-b.build.166.jar";
            "hash" = "sha512-Pscc3WP3fY9l5oHOW4dXYA99bLU5AjYFYEjGEVdX/P+P3vlDJ8Ru2zMeNmX1c5Dmx3TwRoOt/ePO84BRanL/xw==";
        };
        _wbOdORs5 = {
            "id" = "wbOdORs5";
            "file" = "emotecraft-for-MC26.2-3.4.0-b.build.166.jar";
            "hash" = "sha512-tzFe0AJuE5AdAvVo+bYnB8S/UEta3hjrdZyiB1DAgZhfghlT4hpouNSbATLUnoXUEK+w0IZEyt6jG3gX48JBBw==";
        };
        _sQAIchSm = {
            "id" = "sQAIchSm";
            "file" = "emotecraft-geyser-for-MC26.2-3.4.0-b.build.166.jar";
            "hash" = "sha512-M4qPpAqiBPAol+SrwWGXMRSFBCZ8Vq3OlZSWrkeNFoBbAw39iV6zH64LHZlPP9FoxvQMhVgpVK0ClMHqYA4/QA==";
        };
        _7swXh3Fo = {
            "id" = "7swXh3Fo";
            "file" = "emotecraft-geyser-for-MC26.3-3.5.0-a.build.167.jar";
            "hash" = "sha512-mqzNVmHmFdwQtPrin5bF408jQ03yXq8OWq08cs1Wl8qfxK3kFtKyCYwgDjjnBkdhhKT+EXi+HR2o25cKgnZIFw==";
        };
        _HbF9UFdP = {
            "id" = "HbF9UFdP";
            "file" = "emotecraft-paper-for-MC26.3-3.5.0-a.build.167.jar";
            "hash" = "sha512-GwoSoug2OQYqGFe9oeQOdmRmwzBYxvbEQz4HBfOSLjoKlRwTUf1x1LsyIbaeHuG0XtsYxF1zgWtKjOG8jnnkAw==";
        };
        _tkC33xHd = {
            "id" = "tkC33xHd";
    ...
    in {
        ...
        "pkg-1.3.1" = _WzOyhCoN;
        "pkg-1.4.0" = _LTUWpL7U;
        "pkg-2.0SNAPSHOT0" = _RLjGDEEY;
        "pkg-2.0-b1" = _Ycs17SJ8;
        "pkg-2.0-b2" = _eXh7hhIL;
        "pkg-2.0.0" = _5pK0OJeT;
        "pkg-2.0.1" = _zTCmESwz;
        "pkg-2.0.2" = _8qiOPtrU;
        "pkg-2.0.3" = _GA5qYcsp;
        "pkg-2.0.4" = _CNC0NFnn;
        "pkg-2.0.4-1.17-rc2" = _CVEEUiU0;
        "pkg-2.0.5-1.17-rc2" = _sFwcIuk2;
        "pkg-2.0.6" = _LsGEt0G6;
        "pkg-2.0.7" = _hw4MzaBO;
        "pkg-2.0.8" = _XaW414Nz;
        "pkg-2.0.9" = _oaebUouH;
        "pkg-2.1-SNAPSHOT-1" = _tAhUtBqm;
        "pkg-2.1-SNAPSHOT-2" = _hOlTR0Zs;
        "pkg-2.1-SNAPSHOT-3" = _sOX0oFpg;
        "pkg-2.1-SNAPSHOT-b692f79" = _F6YNHsxC;
        "pkg-2.1-SNAPSHOT-6385565" = _Qpm1hQWR;
        "pkg-2.1-SNAPSHOT-build.4" = _sA5qoZfS;
        "pkg-2.1-SNAPSHOT-build.5" = _VzLn8LdF;
        "pkg-2.1-SNAPSHOT-build.6" = _BrhvBBIL;
        "pkg-2.1-SNAPSHOT-build.7" = _kkaBff5Z;
        "pkg-2.1-SNAPSHOT-build.8" = _9mCzFR23;
        "pkg-2.1-SNAPSHOT-build.9" = _MalHlsZ2;
        "pkg-2.1-SNAPSHOT-build.10" = _zCMGFBBB;
        "pkg-2.1-SNAPSHOT-build.10-fabric" = _q93V638A;
        "pkg-2.1-SNAPSHOT-build.10-forge" = _6rQv0DEk;
        "pkg-2.1-SNAPSHOT-build.11-MC1.18.1-forge" = _gj9igUnL;
        "pkg-2.1-SNAPSHOT-build.11-MC1.18.1-fabric" = _ldxABswS;
        "pkg-2.1-SNAPSHOT-build.11-MC1.17.1-forge" = _tVVVVcJv;
        "pkg-2.1-SNAPSHOT-build.11-MC1.17.1-fabric" = _UxqU0Svt;
        "pkg-2.1-SNAPSHOT-build.11-MC1.16.5-forge" = _Vfd2GzRZ;
        "pkg-2.1-SNAPSHOT-build.11-MC1.16.5-fabric" = _KxXEzccV;
        "pkg-2.1-MC1.18.1-forge" = _ykXjQEhH;
        "pkg-2.1-MC1.18.1-fabric" = _dp29EE5f;
        "pkg-2.1-MC1.17.1-forge" = _iHW53tWc;
        "pkg-2.1-MC1.17.1-fabric" = _n2T306oH;
        "pkg-2.1-MC1.16.5-forge" = _HHIpMsxR;
        "pkg-2.1-MC1.16.5-fabric" = _yE6gcl0N;
        "pkg-2.1.1-MC1.18.2-forge" = _1pnYM4Ma;
        "pkg-2.1.1-MC1.18.2-fabric" = _iIGnVXO2;
        "pkg-2.1.1-MC1.17.1-forge" = _QFqp2ELl;
        "pkg-2.1.1-MC1.17.1-fabric" = _ZEhk9kOJ;
        "pkg-2.1.1-MC1.16.5-forge" = _d93WcXUq;
        "pkg-2.1.1-MC1.16.5-fabric" = _Xo3slvMK;
        "pkg-2.1.2-MC1.18.2-forge" = _ZyU860w6;
        "pkg-2.1.2-MC1.18.2-fabric" = _nvkXugs1;
        "pkg-2.1.2-MC1.17.1-forge" = _qYybj2tT;
        "pkg-2.1.2-MC1.17.1-fabric" = _53sikmLI;
        "pkg-2.1.2-MC1.16.5-forge" = _Dpvz7EXQ;
        "pkg-2.1.2-MC1.16.5-fabric" = _n3DhNcqw;
        "pkg-2.1.3-SNAPSHOT-build.17-MC1.18.2-forge" = _1fCBrUrN;
        "pkg-2.1.3-SNAPSHOT-build.17-MC1.18.2-fabric" = _e3KUYiA1;
        "pkg-2.1.3-SNAPSHOT-build.17-MC1.17.1-forge" = _PpG22Irj;
        "pkg-2.1.3-SNAPSHOT-build.17-MC1.17.1-fabric" = _Cgl9EZxu;
        "pkg-2.1.3-SNAPSHOT-build.17-MC1.16.5-forge" = _Gb1s9z7u;
        "pkg-2.1.3-SNAPSHOT-build.17-MC1.16.5-fabric" = _HWIT7KSG;
        "pkg-2.1.3-SNAPSHOT-build.19-MC1.18.2-forge" = _6xFmhFLR;
        "pkg-2.1.3-SNAPSHOT-build.19-MC1.18.2-fabric" = _ysyecsY8;
        "pkg-2.1.3-SNAPSHOT-build.19-MC1.17.1-forge" = _rFjK2pAM;
        "pkg-2.1.3-SNAPSHOT-build.19-MC1.17.1-fabric" = _HEqK5qUp;
        "pkg-2.1.3-SNAPSHOT-build.19-MC1.16.5-forge" = _6wIdHM3p;
        "pkg-2.1.3-SNAPSHOT-build.19-MC1.16.5-fabric" = _3LSQZcwo;
        "pkg-2.1.3-SNAPSHOT-build.21-MC1.18.2-forge" = _Boek4E3Z;
        "pkg-2.1.3-SNAPSHOT-build.21-MC1.18.2-fabric" = _7htvtDSe;
        "pkg-2.1.3-SNAPSHOT-build.21-MC1.17.1-forge" = _1e6LkG8i;
        "pkg-2.1.3-SNAPSHOT-build.21-MC1.17.1-fabric" = _HeuYHR0n;
        "pkg-2.1.3-SNAPSHOT-build.21-MC1.16.5-forge" = _6vZ6ZjwI;
        "pkg-2.1.3-SNAPSHOT-build.21-MC1.16.5-fabric" = _VpbWT05z;
        "pkg-2.1.3-SNAPSHOT-build.22-MC1.18.2-forge" = _CQ5hp1ay;
        "pkg-2.1.3-SNAPSHOT-build.22-MC1.18.2-fabric" = _AVSUNefN;
        "pkg-2.1.3-SNAPSHOT-build.22-MC1.17.1-forge" = _HPMyZMlQ;
        "pkg-2.1.3-SNAPSHOT-build.22-MC1.17.1-fabric" = _XR6A3Lc8;
        "pkg-2.1.3-SNAPSHOT-build.22-MC1.16.5-forge" = _wSysxyOd;
        "pkg-2.1.3-SNAPSHOT-build.22-MC1.16.5-fabric" = _qBjzziub;
        "pkg-2.1.3-SNAPSHOT-build.23-MC1.18.2-forge" = _63jsdWDn;
        "pkg-2.1.3-SNAPSHOT-build.23-MC1.18.2-fabric" = _h9FCqo3p;
        "pkg-2.1.3-SNAPSHOT-build.23-MC1.17.1-forge" = _IrX6FD9Q;
        "pkg-2.1.3-SNAPSHOT-build.23-MC1.17.1-fabric" = _GPZuIEY3;
        "pkg-2.1.3-SNAPSHOT-build.23-MC1.16.5-forge" = _XUTKWwmZ;
        "pkg-2.1.3-SNAPSHOT-build.23-MC1.16.5-fabric" = _lYVrunDl;
        "pkg-2.1.3-SNAPSHOT-build.24-MC1.18.2-forge" = _D890KqZO;
        "pkg-2.1.3-SNAPSHOT-build.24-MC1.18.2-fabric" = _mXhxsFiR;
        "pkg-2.1.3-SNAPSHOT-build.24-MC1.17.1-forge" = _EnhZvF4P;
        "pkg-2.1.3-SNAPSHOT-build.24-MC1.17.1-fabric" = _pdxJFsW5;
        "pkg-2.1.3-SNAPSHOT-build.24-MC1.16.5-forge" = _4QjEhSFO;
        "pkg-2.1.3-SNAPSHOT-build.24-MC1.16.5-fabric" = _63hY0N4d;
        "pkg-2.1.3-SNAPSHOT-build.25-MC1.18.2-forge" = _QcPAiLkX;
        "pkg-2.1.3-SNAPSHOT-build.25-MC1.18.2-fabric" = _XkjY0Qq1;
        "pkg-2.1.3-SNAPSHOT-build.25-MC1.17.1-forge" = _9Y0sflw3;
        "pkg-2.1.3-SNAPSHOT-build.25-MC1.17.1-fabric" = _XdF3QalJ;
        "pkg-2.1.3-SNAPSHOT-build.25-MC1.16.5-forge" = _4StF08Zw;
        "pkg-2.1.3-SNAPSHOT-build.25-MC1.16.5-fabric" = _k7LyhhgU;
        "pkg-2.1.3-SNAPSHOT-build.27-MC1.18.2-forge" = _ECDoqXad;
        "pkg-2.1.3-SNAPSHOT-build.27-MC1.18.2-fabric" = _F2ZrhoZH;
        "pkg-2.1.3-SNAPSHOT-build.27-MC1.17.1-forge" = _ok9VYSgP;
        "pkg-2.1.3-SNAPSHOT-build.27-MC1.17.1-fabric" = _HcwZZijq;
        "pkg-2.1.3-SNAPSHOT-build.27-MC1.16.5-forge" = _MEN6ReQc;
        "pkg-2.1.3-SNAPSHOT-build.27-MC1.16.5-fabric" = _VSpEewer;
        "pkg-2.1.3-SNAPSHOT-build.28-MC1.18.2-forge" = _rdw3jZnp;
        "pkg-2.1.3-SNAPSHOT-build.28-MC1.18.2-fabric" = _tbhsbjar;
        "pkg-2.1.3-SNAPSHOT-build.28-MC1.17.1-forge" = _EcyGB5zh;
        "pkg-2.1.3-SNAPSHOT-build.28-MC1.17.1-fabric" = _uo6QM4ts;
        "pkg-2.1.3-SNAPSHOT-build.28-MC1.16.5-forge" = _dl3tpVoa;
        "pkg-2.1.3-SNAPSHOT-build.28-MC1.16.5-fabric" = _iOc7tkMH;
        "pkg-2.1.3-SNAPSHOT-build.29-MC1.19-fabric" = _q65wM87f;
        "pkg-2.1.3-SNAPSHOT-build.29-MC1.18.2-forge" = _PE1Rz7RT;
        "pkg-2.1.3-SNAPSHOT-build.29-MC1.18.2-fabric" = _Xz10Lz6d;
        "pkg-2.1.3-SNAPSHOT-build.29-MC1.16.5-forge" = _N6Aq60BA;
        "pkg-2.1.3-SNAPSHOT-build.29-MC1.16.5-fabric" = _QMUxlXz5;
        "pkg-2.1.3-SNAPSHOT-build.30-MC1.19-forge" = _GKPW2Z59;
        "pkg-2.1.3-SNAPSHOT-build.30-MC1.19-fabric" = _V9i2SXYQ;
        "pkg-2.1.3-SNAPSHOT-build.30-MC1.18.2-forge" = _dSdO8HJt;
        "pkg-2.1.3-SNAPSHOT-build.30-MC1.18.2-fabric" = _fYmJUQ3F;
        "pkg-2.1.3-SNAPSHOT-build.30-MC1.16.5-forge" = _dQGSSteJ;
        "pkg-2.1.3-SNAPSHOT-build.30-MC1.16.5-fabric" = _TKLrfGhJ;
        "pkg-2.1.3-SNAPSHOT-build.31-MC1.19-forge" = _e8RdyaUB;
        "pkg-2.1.3-SNAPSHOT-build.31-MC1.19-fabric" = _WDGp8utA;
        "pkg-2.1.3-SNAPSHOT-build.31-MC1.18.2-forge" = _sWkcVQuB;
        "pkg-2.1.3-SNAPSHOT-build.31-MC1.18.2-fabric" = _8dvpQa8S;
        "pkg-2.1.3-SNAPSHOT-build.31-MC1.16.5-forge" = _CM50Kag0;
        "pkg-2.1.3-SNAPSHOT-build.31-MC1.16.5-fabric" = _idz0j3DC;
        "pkg-2.1.3-SNAPSHOT-build.32-MC1.19-forge" = _laFrihZO;
        "pkg-2.1.3-SNAPSHOT-build.32-MC1.19-fabric" = _o2eRhx3s;
        "pkg-2.1.3-SNAPSHOT-build.32-MC1.18.2-forge" = _UeYIGozf;
        "pkg-2.1.3-SNAPSHOT-build.32-MC1.18.2-fabric" = _MsvdQ0Jc;
        "pkg-2.1.3-SNAPSHOT-build.32-MC1.16.5-forge" = _ckOJ6i6n;
        "pkg-2.1.3-SNAPSHOT-build.32-MC1.16.5-fabric" = _md56YNpC;
        "pkg-2.2.0-SNAPSHOT-build.35-MC1.19.2-forge" = _QjWvdE3u;
        "pkg-2.2.0-SNAPSHOT-build.35-MC1.19.2-fabric" = _pSk3hsBc;
        "pkg-2.2.0-SNAPSHOT-build.35-MC1.18.2-forge" = _vdWhVaNP;
        "pkg-2.2.0-SNAPSHOT-build.35-MC1.18.2-fabric" = _rSaIet5S;
        "pkg-2.2.0-SNAPSHOT-build.35-MC1.16.5-forge" = _dOQ0q9EZ;
        "pkg-2.2.0-SNAPSHOT-build.35-MC1.16.5-fabric" = _2MzZLPn5;
        "pkg-2.2.0-SNAPSHOT-build.36-MC1.19.2-forge" = _DRbMmVyd;
        "pkg-2.2.0-SNAPSHOT-build.36-MC1.19.2-fabric" = _D9gMEVFD;
        "pkg-2.2.0-SNAPSHOT-build.36-MC1.18.2-forge" = _3vfnMBbn;
        "pkg-2.2.0-SNAPSHOT-build.36-MC1.18.2-fabric" = _e2cai3jB;
        "pkg-2.2.0-SNAPSHOT-build.36-MC1.16.5-forge" = _Say4LIuw;
        "pkg-2.2.0-SNAPSHOT-build.36-MC1.16.5-fabric" = _MiFGYSe4;
        "pkg-2.2.0-SNAPSHOT-build.37-MC1.19.2-forge" = _S4QhgQFK;
        "pkg-2.2.0-SNAPSHOT-build.37-MC1.19.2-fabric" = _TTajT9qz;
        "pkg-2.2.0-SNAPSHOT-build.37-MC1.18.2-forge" = _ampBk5i8;
        "pkg-2.2.0-SNAPSHOT-build.37-MC1.18.2-fabric" = _RUD35GCT;
        "pkg-2.2.0-SNAPSHOT-build.37-MC1.16.5-forge" = _s8EPPsNB;
        "pkg-2.2.0-SNAPSHOT-build.37-MC1.16.5-fabric" = _byQ8xkjs;
        "pkg-2.2.0-MC1.19.2-forge" = _yuPRWJ8k;
        "pkg-2.2.0-MC1.19.2-fabric" = _dBB7GxAG;
        "pkg-2.2.0-MC1.18.2-forge" = _CQfJLriX;
        "pkg-2.2.0-MC1.18.2-fabric" = _V1ajrIwr;
        "pkg-2.2.0-MC1.16.5-forge" = _LI9tomy2;
        "pkg-2.2.0-MC1.16.5-fabric" = _PeuaF8sw;
        "pkg-2.2.2-MC1.19.2-forge" = _rnaJd7xS;
        "pkg-2.2.2-MC1.19.2-fabric" = _73BLn97K;
        "pkg-2.2.2-MC1.18.2-forge" = _3GTLlENE;
        "pkg-2.2.2-MC1.18.2-fabric" = _i1VjnD7E;
        "pkg-2.2.2-MC1.16.5-forge" = _4cMYA3Er;
        "pkg-2.2.2-MC1.16.5-fabric" = _ey35nhnS;
        "pkg-2.2.3-SNAPSHOT-build.40-MC1.19.2-forge" = _iAQLm00B;
        "pkg-2.2.3-SNAPSHOT-build.40-MC1.19.2-fabric" = _XuPoXuFh;
        "pkg-2.2.3-SNAPSHOT-build.40-MC1.18.2-forge" = _iGplryeA;
        "pkg-2.2.3-SNAPSHOT-build.40-MC1.18.2-fabric" = _dz98CeFn;
        "pkg-2.2.3-SNAPSHOT-build.40-MC1.16.5-forge" = _OGoWjgjJ;
        "pkg-2.2.3-SNAPSHOT-build.40-MC1.16.5-fabric" = _UPMiHTyP;
        "pkg-2.2.3-MC1.19.2-forge" = _bQAvDaI6;
        "pkg-2.2.3-MC1.19.2-fabric" = _RtYLalTi;
        "pkg-2.2.3-MC1.18.2-forge" = _s0N7Zgzo;
        "pkg-2.2.3-MC1.18.2-fabric" = _oey67ELr;
        "pkg-2.2.3-MC1.16.5-forge" = _9H1hhNIo;
        "pkg-2.2.3-MC1.16.5-fabric" = _k9MgcQmQ;
        "pkg-2.2.4-MC1.19.2-forge" = _WBYQJtu9;
        "pkg-2.2.4-MC1.19.2-fabric" = _bROpJFWZ;
        "pkg-2.2.4-MC1.18.2-forge" = _Wfp9cg5i;
        "pkg-2.2.4-MC1.18.2-fabric" = _y6ujlYAE;
        "pkg-2.2.4-MC1.16.5-forge" = _GIH9Hxb4;
        "pkg-2.2.4-MC1.16.5-fabric" = _czLNW21m;
        "pkg-2.2.5-MC1.19.2-forge" = _PnqzDspo;
        "pkg-2.2.5-MC1.19.2-fabric" = _hpOzeA3F;
        "pkg-2.2.5-MC1.18.2-forge" = _RE1BKxI8;
        "pkg-2.2.5-MC1.18.2-fabric" = _25JiNHog;
        "pkg-2.2.5-MC1.16.5-forge" = _tKNw7fvw;
        "pkg-2.2.5-MC1.16.5-fabric" = _HyxtDh1N;
        "pkg-2.2.6-SNAPSHOT-build.44-MC1.19.2-forge" = _auBfRvjy;
        "pkg-2.2.6-SNAPSHOT-build.44-MC1.19.2-fabric" = _rKq67C77;
        "pkg-2.2.6-SNAPSHOT-build.44-MC1.18.2-forge" = _jZKonKJ0;
        "pkg-2.2.6-SNAPSHOT-build.44-MC1.18.2-fabric" = _MjLxuS9U;
        "pkg-2.2.6-SNAPSHOT-build.44-MC1.16.5-forge" = _GmT3Gdmr;
        "pkg-2.2.6-SNAPSHOT-build.44-MC1.16.5-fabric" = _1oDR36MB;
        "pkg-2.2.7-b.46+1.19.3-fabric" = _kV90c7FZ;
        "pkg-2.2.7-b.build.47+1.19.3-forge" = _DiQvVDRW;
        "pkg-2.2.7-b.build.47+1.19.3-fabric" = _LVl8YFvF;
        "pkg-2.2.7-b.build.47+1.19.2-forge" = _PmBVbKKt;
        "pkg-2.2.7-b.build.47+1.19.2-fabric" = _d9mAMnw0;
        "pkg-2.2.7-b.build.47+1.18.2-forge" = _QzlpZh4r;
        "pkg-2.2.7-b.build.47+1.18.2-fabric" = _ToCobxiP;
        "pkg-2.2.7-b.build.47+1.16.5-forge" = _OU1kdZya;
        "pkg-2.2.7-b.build.47+1.16.5-fabric" = _CwHBNRDB;
        "pkg-2.2.7-b.build.48+1.19.4-forge" = _5K7Vy0CM;
        "pkg-2.2.7-b.build.48+1.19.4-fabric" = _8usSPO0G;
        "pkg-2.2.7-b.build.48+1.19.3-forge" = _uC0FgiCP;
        "pkg-2.2.7-b.build.48+1.19.3-fabric" = _repCGNbQ;
        "pkg-2.2.7-b.build.48+1.19.2-forge" = _B99cZBQ0;
        "pkg-2.2.7-b.build.48+1.19.2-fabric" = _ywlwyKDv;
        "pkg-2.2.7-b.build.48+1.18.2-forge" = _XnDCvVtU;
        "pkg-2.2.7-b.build.48+1.18.2-fabric" = _z18j1WDv;
        "pkg-2.2.7-a.build.49+1.20.1-forge" = _jBlri9Pa;
        "pkg-2.2.7-a.build.49+1.20.1-fabric" = _IqKGk9AT;
        "pkg-2.2.7-a.build.49+1.19.4-forge" = _cAAOVjLS;
        "pkg-2.2.7-a.build.49+1.19.4-fabric" = _Zv3TojDv;
        "pkg-2.2.7-a.build.49+1.19.2-forge" = _pjDS5LRD;
        "pkg-2.2.7-a.build.49+1.19.2-fabric" = _AKCyi6dw;
        "pkg-2.2.7-a.build.49+1.18.2-forge" = _QILSBfTw;
        "pkg-2.2.7-a.build.49+1.18.2-fabric" = _yFTvRWgr;
        "pkg-2.2.7-b.build.50+1.20.1-forge" = _2f5mEUPY;
        "pkg-2.2.7-b.build.50+1.20.1-fabric" = _NFPdxMt9;
        "pkg-2.2.7-b.build.50+1.19.4-forge" = _CXK26aNh;
        "pkg-2.2.7-b.build.50+1.19.4-fabric" = _bNYFbb9P;
        "pkg-2.2.7-b.build.50+1.19.2-forge" = _kZGkovfR;
        "pkg-2.2.7-b.build.50+1.19.2-fabric" = _pFGcytFI;
        "pkg-2.2.7-b.build.50+1.18.2-forge" = _MsVWqONy;
        "pkg-2.2.7-b.build.50+1.18.2-fabric" = _TOLa2tJO;
        "pkg-2.4.0-a.f140890e" = _CUDCdgav;
        "pkg-2.4.2-b.build.55+1.21.1-forge" = _pgdIxACw;
        "pkg-2.4.2-b.build.55+1.21.1-fabric" = _vTPbJEL2;
        "pkg-2.4.2-b.build.56+1.21.1-forge" = _nxl5YcGJ;
        "pkg-2.4.2-b.build.56+1.21.1-fabric" = _SDsqkZxk;
        "pkg-2.4.2-b.build.56+1.21.1-bukkit" = _wtVzLVm0;
        "pkg-2.4.3-b.build.57+1.21.1-fabric" = _PEh15PrL;
        "pkg-2.4.3-b.build.57+1.21.1-forge" = _UaDGUZh4;
        "pkg-2.4.3-b.build.58+1.21.1-forge" = _waCCZ2jj;
        "pkg-2.4.3-b.build.58+1.21.1-fabric" = _l4qakilC;
        "pkg-2.4.3-b.build.58+1.21.1-bukkit" = _vfb7dBqF;
        "pkg-2.4.3-b.build.57+1.21.1-bukkit" = _V0bmaGaj;
        "pkg-2.4.4-b.build.59+1.21.1-forge" = _dGXU4mch;
        "pkg-2.4.4-b.build.59+1.21.1-fabric" = _Ymdf3T81;
        "pkg-2.4.4-b.build.59+1.21.1-bukkit" = _7UgKiMQh;
        "pkg-2.4.4-b.build.60+1.21.1-fabric" = _i2OzCpjB;
        "pkg-2.4.4-b.build.60+1.21.1-forge" = _9i3vjFfA;
        "pkg-2.4.4-b.build.60+1.21.1-bukkit" = _xg7NV68q;
        "pkg-2.4.4+1.21.1-fabric" = _ltLJGtLk;
        "pkg-2.4.4+1.21.1-forge" = _rEkZphNE;
        "pkg-2.4.4+1.21.1-bukkit" = _lqt1Pq5Z;
        "pkg-2.4.5+1.21.1-forge" = _2JhLQHGH;
        "pkg-2.4.5+1.21.1-fabric" = _7knzRdv8;
        "pkg-2.4.5+1.21.1-bukkit" = _hnelAlQ8;
        "pkg-2.4.6+1.21.1-forge" = _ph764ff5;
        "pkg-2.4.6+1.21.1-fabric" = _TxPTEp93;
        "pkg-2.4.6+1.21.1-bukkit" = _ynLAsJlG;
        "pkg-2.4.7+1.21.1-fabric" = _CZ2AQFxR;
        "pkg-2.4.7+1.21.1-forge" = _Yf3XvzTr;
        "pkg-2.4.7+1.21.1-bukkit" = _tcMZEAih;
        "pkg-2.4.8+1.21.1-fabric" = _yiqDGkGD;
        "pkg-2.4.8+1.21.1-forge" = _Td59PDnZ;
        "pkg-2.4.8+1.21.1-bukkit" = _lguUpF9K;
        "pkg-2.5.0-a.build.69+1.21.4-forge" = _ZvBDd9Xq;
        "pkg-2.5.0-a.build.69+1.21.4-fabric" = _hg02ubpz;
        "pkg-2.5.0-a.build.69+1.21.4-bukkit" = _Txn7jfii;
        "pkg-2.5.0-a.build.70+1.21.4-fabric" = _2ALJr2lP;
        "pkg-2.5.0-a.build.70+1.21.4-forge" = _h2x5n2dp;
        "pkg-2.5.0-a.build.70+1.21.4-bukkit" = _KIupyj5v;
        "pkg-2.5.0-b.build.71+1.21.4-forge" = _pJ1BqQwn;
        "pkg-2.5.0-b.build.71+1.21.4-fabric" = _ySsv91UT;
        "pkg-2.5.0-b.build.71+1.21.4-paper" = _aror3eMb;
        "pkg-2.5.1-b.build.72+1.21.4-forge" = _ResXP3Uk;
        "pkg-2.5.1-b.build.72+1.21.4-fabric" = _afaYyo92;
        "pkg-2.5.1-b.build.72+1.21.4-paper" = _QaJSSuMq;
        "pkg-2.5.2-b.build.74+1.21.4-forge" = _3ykC30N4;
        "pkg-2.5.2-b.build.74+1.21.4-fabric" = _szEVUvGD;
        "pkg-2.5.2-b.build.74+1.21.4-paper" = _If9XGcVk;
        "pkg-2.5.2-b.build.75+1.21.4-fabric" = _xjZXBJkn;
        "pkg-2.5.2-b.build.75+1.21.4-forge" = _UjKXvGt0;
        "pkg-2.5.2-b.build.75+1.21.4-paper" = _Taw12Wq2;
        "pkg-2.5.2-b.build.76+1.21.4-fabric" = _upATV51k;
        "pkg-2.5.2-b.build.76+1.21.4-forge" = _hQyexX2d;
        "pkg-2.5.2-b.build.76+1.21.4-paper" = _9iMI9Zmp;
        "pkg-2.5.3-b.build.77+1.21.4-forge" = _GTmtEZKb;
        "pkg-2.5.3-b.build.77+1.21.4-fabric" = _Yufn9Oms;
        "pkg-2.5.3-b.build.77+1.21.4-paper" = _lD0MvWUq;
        "pkg-2.5.4-b.build.78+1.21.4-paper" = _Vfguew8x;
        "pkg-2.5.4-b.build.78+1.21.4-forge" = _2wAnd9OV;
        "pkg-2.5.4-b.build.78+1.21.4-fabric" = _E4IeO4NI;
        "pkg-2.5.4-b.build.79+1.21.4-paper" = _Ptc73GUr;
        "pkg-2.5.4-b.build.79+1.21.4-forge" = _8ZThhKUr;
        "pkg-2.5.4-b.build.79+1.21.4-fabric" = _LAHiWfo9;
        "pkg-2.4.9+1.21.1-forge" = _Uvskpn8j;
        "pkg-2.4.9+1.21.1-fabric" = _oIYbvh6T;
        "pkg-2.4.9+1.21.1-bukkit" = _qwhR3CjV;
        "pkg-2.5.5-b.build.82+1.21.4-paper" = _lv6Kuy2q;
        "pkg-2.5.5-b.build.82+1.21.4-fabric" = _xfHJXudC;
        "pkg-2.5.5-b.build.82+1.21.4-forge" = _wm9S50H7;
        "pkg-2.6.0-a.build.85+1.21.5-fabric" = _BH4LFdiu;
        "pkg-2.5.5+1.21.4-paper" = _EQdE5GXw;
        "pkg-2.5.5+1.21.4-forge" = _X7iC5rSc;
        "pkg-2.5.5+1.21.4-fabric" = _5XsQ3Xbt;
        "pkg-2.6.0-a.build.87+1.21.5-forge" = _44CHHqq4;
        "pkg-2.6.0-a.build.87+1.21.5-fabric" = _fqyj29ZM;
        "pkg-2.5.6+1.21.4-paper" = _9yybCntZ;
        "pkg-2.5.6+1.21.4-forge" = _ybeqNlO4;
        "pkg-2.5.6+1.21.4-fabric" = _18oWJvmu;
        "pkg-2.6.0-a.build.92+1.21.5-paper" = _wgck6WYo;
        "pkg-2.6.0-a.build.92+1.21.5-forge" = _VYL7YCTh;
        "pkg-2.6.0-a.build.92+1.21.5-fabric" = _Vj9jIhQZ;
        "pkg-2.6.0-b.build.93+1.21.5-paper" = _2t4I9Zt5;
        "pkg-2.6.0-b.build.93+1.21.5-forge" = _KdUU24De;
        "pkg-2.6.0-b.build.93+1.21.5-fabric" = _mEHoMDCP;
        "pkg-2.4.10+1.21.1-forge" = _bL1hNBpd;
        "pkg-2.4.10+1.21.1-fabric" = _JFlw2BZk;
        "pkg-2.4.10+1.21.1-bukkit" = _GKhkDKK2;
        "pkg-2.6.0-b.build.95+1.21.5-paper" = _3XwLnUxc;
        "pkg-2.6.0-b.build.95+1.21.5-forge" = _Eswi3lSs;
        "pkg-2.6.0-b.build.95+1.21.5-fabric" = _2CjwmOzZ;
        "pkg-2.6.0-b.build.96+1.21.5-paper" = _huHTe8Uc;
        "pkg-2.6.0-b.build.96+1.21.5-forge" = _TIfSbQZs;
        "pkg-2.6.0-b.build.96+1.21.5-fabric" = _5R6mqk1R;
        "pkg-2.5.7+1.21.4-paper" = _cjiPF0F7;
        "pkg-2.5.7+1.21.4-forge" = _nSe8HpPD;
        "pkg-2.5.7+1.21.4-fabric" = _QOoYnATY;
        "pkg-2.6.0-b.build.98+1.21.5-paper" = _Aj1Ftw6O;
        "pkg-2.6.0-b.build.98+1.21.5-forge" = _Jd7xp4r2;
        "pkg-2.6.0-b.build.98+1.21.5-fabric" = _Tu5UO27e;
        "pkg-2.6.1+1.21.5-paper" = _z8FA4kiH;
        "pkg-2.6.1+1.21.5-forge" = _9BtW6i8e;
        "pkg-2.6.1+1.21.5-fabric" = _4QvPDQWM;
        "pkg-3.0.0-a.build.106+1.21.7-paper" = _5C8NKcw9;
        "pkg-3.0.0-a.build.106+1.21.7-forge" = _jbZLWXOs;
        "pkg-3.0.0-a.build.106+1.21.7-fabric" = _swWqK9eX;
        "pkg-3.0.0-a.build.108+1.21.7-paper" = _Ymw2OHtI;
        "pkg-3.0.0-a.build.108+1.21.7-forge" = _KB9r2jbt;
        "pkg-3.0.0-a.build.108+1.21.7-fabric" = _GlXCtZrV;
        "pkg-3.0.0-a.build.109+1.21.7-paper" = _rho05NJV;
        "pkg-3.0.0-a.build.109+1.21.7-forge" = _1pzQPSs1;
        "pkg-3.0.0-a.build.109+1.21.7-fabric" = _NhPm7U0R;
        "pkg-3.0.0-a.build.110+1.21.7-paper" = _HxcAO3mh;
        "pkg-3.0.0-a.build.110+1.21.7-forge" = _Eqms6xAD;
        "pkg-3.0.0-a.build.110+1.21.7-fabric" = _DOfYnckV;
        "pkg-3.0.0-a.build.112+1.21.7-paper" = _FspwrIUe;
        "pkg-3.0.0-a.build.112+1.21.7-fabric" = _HfBXQKmI;
        "pkg-3.0.0-a.build.112+1.21.7-forge" = _ZnLS51c3;
        "pkg-2.4.11+1.21.1-fabric" = _hYdZTvne;
        "pkg-2.4.11+1.21.1-forge" = _NfeUCEf8;
        "pkg-2.4.11+1.21.1-bukkit" = _CFzmhJOb;
        "pkg-2.4.12+1.21.1-fabric" = _daqt5qcK;
        "pkg-2.4.12+1.21.1-forge" = _fu6N0NgM;
        "pkg-2.4.12+1.21.1-bukkit" = _DVp3FUqR;
        "pkg-2.6.2+1.21.5-paper" = _ny9tWdHq;
        "pkg-2.6.2+1.21.5-forge" = _G7m1YMYp;
        "pkg-2.6.2+1.21.5-fabric" = _JegUMwLH;
        "pkg-2.5.8+1.21.4-paper" = _nyMO0fCO;
        "pkg-2.5.8+1.21.4-forge" = _YueSSKD9;
        "pkg-2.5.8+1.21.4-fabric" = _njhJbosE;
        "pkg-3.0.0-b.build.119+1.21.7-paper" = _aRtXwr72;
        "pkg-3.0.0-b.build.119+1.21.7-fabric" = _X1WOxJjB;
        "pkg-3.0.0-b.build.119+1.21.7-forge" = _gV0ikRtb;
        "pkg-3.0.0-b.build.120+1.21.7-paper" = _6H3xqC8O;
        "pkg-3.0.0-b.build.120+1.21.7-fabric" = _D0ZoorKt;
        "pkg-3.0.0-b.build.120+1.21.7-forge" = _3ZHNvcE1;
        "pkg-3.0.0-b.build.121+1.21.7-paper" = _P8hBs7Mg;
        "pkg-3.0.0-b.build.121+1.21.7-forge" = _I49SdeAJ;
        "pkg-3.0.0-b.build.121+1.21.7-fabric" = _SOOzV0aO;
        "pkg-3.0.0-b.build.122+1.21.7-paper" = _NuEX9cYB;
        "pkg-3.0.0-b.build.122+1.21.7-forge" = _H1LQB9ge;
        "pkg-3.0.0-b.build.122+1.21.7-fabric" = _fGfGJHj6;
        "pkg-3.0.0-b.build.123+1.21.7-paper" = _dpXIfbOx;
        "pkg-3.0.0-b.build.123+1.21.7-forge" = _IOD9Z0v7;
        "pkg-3.0.0-b.build.123+1.21.7-fabric" = _ClsGHED4;
        "pkg-3.1.0-b.build.124+1.21.9-paper" = _FT8LDL2O;
        "pkg-3.1.0-b.build.124+1.21.9-forge" = _7Buz49lF;
        "pkg-3.1.0-b.build.124+1.21.9-fabric" = _ykpWcmVC;
        "pkg-3.1.0-b.build.125+1.21.9-paper" = _o7rjjBvO;
        "pkg-3.1.0-b.build.125+1.21.9-forge" = _81OaLmME;
        "pkg-3.1.0-b.build.125+1.21.9-fabric" = _CRM1cO7l;
        "pkg-3.0.0-b.build.127+1.21.7-paper" = _hVG179WX;
        "pkg-3.0.0-b.build.127+1.21.7-forge" = _YHO0HsBg;
        "pkg-3.0.0-b.build.127+1.21.7-fabric" = _VeMVR6lp;
        "pkg-3.1.0-b.build.128+1.21.9-paper" = _bIHxlrJl;
        "pkg-3.1.0-b.build.128+1.21.9-forge" = _6yQyY5pL;
        "pkg-3.1.0-b.build.128+1.21.9-fabric" = _ykv2yoiq;
        "pkg-3.1.0-b.build.129+1.21.9-paper" = _LIpzyVhC;
        "pkg-3.1.0-b.build.129+1.21.9-fabric" = _LDwlofFj;
        "pkg-3.1.0-b.build.129+1.21.9-forge" = _Od1xKWGb;
        "pkg-3.1.0-b.build.130+1.21.9-paper" = _6yOhx6SS;
        "pkg-3.1.0-b.build.130+1.21.9-fabric" = _yvX3cyhl;
        "pkg-3.1.0-b.build.130+1.21.9-forge" = _JJJLMiXE;
        "pkg-3.1.0-b.build.131+1.21.9-paper" = _fRC6XnWP;
        "pkg-3.1.0-b.build.131+1.21.9-fabric" = _3TUdChhE;
        "pkg-3.1.0-b.build.131+1.21.9-forge" = _NPQrGKBH;
        "pkg-3.2.0-a.build.133+1.21.11-paper" = _cxQodKhO;
        "pkg-3.2.0-a.build.133+1.21.11-fabric" = _4gc6chGS;
        "pkg-3.2.0-a.build.133+1.21.11-forge" = _tpngZqL1;
        "pkg-3.2.0-b.build.134+1.21.11-paper" = _WWy2regL;
        "pkg-3.2.0-b.build.134+1.21.11-fabric" = _vPZ6hxTy;
        "pkg-3.2.0-b.build.134+1.21.11-forge" = _AEMjHkCJ;
        "pkg-3.2.0-b.build.137+1.21.11-geyser" = _lkDtgtqK;
        "pkg-3.2.0-b.build.137+1.21.11-paper" = _okyDjyI6;
        "pkg-3.2.0-b.build.137+1.21.11-fabric" = _rbW61sAJ;
        "pkg-3.2.0-b.build.137+1.21.11-forge" = _A9l8UJMO;
        "pkg-3.2.0-b.build.138+1.21.11-paper" = _32Mvl3PN;
        "pkg-3.2.0-b.build.138+1.21.11-fabric" = _TvafXStq;
        "pkg-3.2.0-b.build.138+1.21.11-geyser" = _wN21MTvS;
        "pkg-3.2.0-b.build.138+1.21.11-forge" = _ZhCYZlGh;
        "pkg-3.0.0-b.build.139+1.21.7-paper" = _XUadKUAv;
        "pkg-3.0.0-b.build.139+1.21.7-forge" = _9jtOdjDz;
        "pkg-3.0.0-b.build.139+1.21.7-fabric" = _6ftsR5Uf;
        "pkg-3.2.0-b.build.140+1.21.11-geyser" = _QjCAGjtM;
        "pkg-3.2.0-b.build.140+1.21.11-paper" = _ew5xYral;
        "pkg-3.2.0-b.build.140+1.21.11-fabric" = _WaNdsAdw;
        "pkg-3.2.0-b.build.140+1.21.11-forge" = _7SUhiwPY;
        "pkg-3.2.0-b.build.141+1.21.11-paper" = _xo7RJGbe;
        "pkg-3.2.0-b.build.141+1.21.11-geyser" = _X2kLQaK1;
        "pkg-3.2.0-b.build.141+1.21.11-fabric" = _BX64qaCS;
        "pkg-3.2.0-b.build.141+1.21.11-forge" = _GKSvpIdN;
        "pkg-3.2.0-b.build.142+1.21.11-paper" = _xoaNso3t;
        "pkg-3.2.0-b.build.142+1.21.11-fabric" = _YRjJCgXF;
        "pkg-3.2.0-b.build.142+1.21.11-forge" = _V7W2tfSe;
        "pkg-3.2.0-b.build.142+1.21.11-geyser" = _SDwEGbCG;
        "pkg-3.2.0-b.build.143+1.21.11-paper" = _DzuqBp62;
        "pkg-3.2.0-b.build.143+1.21.11-geyser" = _MbK28kX6;
        "pkg-3.2.0-b.build.143+1.21.11-fabric" = _4Bxtsjsf;
        "pkg-3.2.0-b.build.143+1.21.11-forge" = _K3bzkWgL;
        "pkg-3.2.0-b.build.144+1.21.11-geyser" = _yj9JenfQ;
        "pkg-3.2.0-b.build.144+1.21.11-fabric" = _og0AxVXR;
        "pkg-3.2.0-b.build.144+1.21.11-forge" = _LxThkoDr;
        "pkg-3.2.0-b.build.144+1.21.11-paper" = _2JEtSUVX;
        "pkg-3.3.0-a.build.146+26.1-geyser" = _ncVs1G5x;
        "pkg-3.3.0-a.build.146+26.1-fabricneo" = _gMqv0ZKU;
        "pkg-3.2.0-b.build.147+1.21.11-paper" = _SOa678z2;
        "pkg-3.2.0-b.build.147+1.21.11-fabric" = _nOfqkQlL;
        "pkg-3.2.0-b.build.147+1.21.11-forge" = _68oytAXL;
        "pkg-3.2.0-b.build.147+1.21.11-geyser" = _bzT1IRbY;
        "pkg-3.3.0-a.build.148+26.1-fabricneo" = _sZtfVmXx;
        "pkg-3.3.0-a.build.148+26.1-geyser" = _Mwp3uDLZ;
        "pkg-3.2.0-b.build.149+1.21.11-fabric" = _Lwm0wDGH;
        "pkg-3.2.0-b.build.149+1.21.11-forge" = _rK4WlYXl;
        "pkg-3.2.0-b.build.149+1.21.11-paper" = _UQFjrKP6;
        "pkg-3.2.0-b.build.149+1.21.11-geyser" = _MrVFwEcD;
        "pkg-3.3.0-a.build.150" = _ZkP5YEad;
        "pkg-3.3.0-a.build.150-paper" = _nINS20IR;
        "pkg-3.3.0-a.build.150-geyser" = _fBVd10Ig;
        "pkg-3.2.0-b.build.151+1.21.11-fabric" = _KNZUJBot;
        "pkg-3.2.0-b.build.151+1.21.11-forge" = _fn4jGoKX;
        "pkg-3.2.0-b.build.151+1.21.11-paper" = _bVXhMtrE;
        "pkg-3.2.0-b.build.151+1.21.11-geyser" = _dV9SfdGf;
        "pkg-3.3.0-b.build.152" = _agefprnn;
        "pkg-3.3.0-b.build.152-paper" = _KVamhOFr;
        "pkg-3.3.0-b.build.152-geyser" = _foZ0ioba;
        "pkg-3.4.0-b.build.153-geyser" = _YxA042HI;
        "pkg-3.4.0-b.build.153-paper" = _EgTwZHCC;
        "pkg-3.4.0-b.build.153" = _hWkVx9pM;
        "pkg-3.4.0-a.build.154-geyser" = _IoCXdp7o;
        "pkg-3.4.0-a.build.154-paper" = _U724x2RV;
        "pkg-3.4.0-a.build.154" = _TXpFGmsc;
        "pkg-3.3.0-b.build.157-geyser" = _KaiNjvO9;
        "pkg-3.3.0-b.build.157-paper" = _BioWS4ZA;
        "pkg-3.3.0-b.build.157" = _pIpSAOLE;
        "pkg-3.2.0-b.build.155+1.21.11-fabric" = _WhnchgCH;
        "pkg-3.2.0-b.build.155+1.21.11-forge" = _vuxdtFjt;
        "pkg-3.2.0-b.build.155+1.21.11-paper" = _QVV640sk;
        "pkg-3.2.0-b.build.155+1.21.11-geyser" = _fRzuQkxt;
        "pkg-3.2.0-b.build.159+1.21.11-fabric" = _11btIGaG;
        "pkg-3.2.0-b.build.159+1.21.11-forge" = _Avzgb7iL;
        "pkg-3.2.0-b.build.159+1.21.11-paper" = _VIbRzuRD;
        "pkg-3.2.0-b.build.159+1.21.11-geyser" = _d2Bn1CEn;
        "pkg-3.3.0-b.build.160-geyser" = _IpMxXlnY;
        "pkg-3.3.0-b.build.160-paper" = _KwVVvQ4C;
        "pkg-3.3.0-b.build.160" = _vKzxDlHd;
        "pkg-3.4.0-b.build.161-paper" = _bvBFm9Ov;
        "pkg-3.4.0-b.build.161-geyser" = _dmWoRkJK;
        "pkg-3.4.0-b.build.161" = _N7BHnI8T;
        "pkg-3.4.0-b.build.162" = _r6QJBg3z;
        "pkg-3.4.0-b.build.162-paper" = _BxLu7cQr;
        "pkg-3.4.0-b.build.162-geyser" = _rf2reX3T;
        "pkg-3.2.0-b.build.163+1.21.11-fabric" = _Hwqp4xhc;
        "pkg-3.2.0-b.build.163+1.21.11-forge" = _Nxw2htPO;
        "pkg-3.2.0-b.build.163+1.21.11-paper" = _Gh7hgcmW;
        "pkg-3.2.0-b.build.163+1.21.11-geyser" = _SZ4GecpA;
        "pkg-3.3.0-b.build.164" = _N3M6FTa2;
        "pkg-3.3.0-b.build.164-paper" = _HeWPsF8V;
        "pkg-3.3.0-b.build.164-geyser" = _aZNbAEkv;
        "pkg-3.4.0-b.build.165" = _dWmUMoEr;
        "pkg-3.4.0-b.build.165-paper" = _m45dAoAQ;
        "pkg-3.4.0-b.build.165-geyser" = _IzrUr1gI;
        "pkg-3.4.0-b.build.166-paper" = _SGqvzAHz;
        "pkg-3.4.0-b.build.166" = _wbOdORs5;
        "pkg-3.4.0-b.build.166-geyser" = _sQAIchSm;
