...
let
    ...
    in {
        ...
        "pkg-2.2.4" = _KHo5BObK;
        "pkg-2.2.5" = _QMqMPkZA;
        "pkg-2.2.6b" = _g9nizQ2N;
        "pkg-2.2.7b" = _U7euGJZO;
        "pkg-2.3" = _rdxnEecc;
        "pkg-2.4" = _RotM3V49;
        "pkg-2.4.1" = _NZ1ATwY6;
        "pkg-3.0.beta" = _KwheRP3r;
        "pkg-3.0.1.beta" = _FrHVKA4V;
        "pkg-3.0.2.beta" = _qDnGMv0l;
        "pkg-3.0.3.beta" = _SOcS2gI9;
        "pkg-3.0.4.beta" = _Sz5HsSMB;
