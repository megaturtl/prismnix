...
let
    ...
    in {
        ...
        "pkg-1.1.1+1.6.0" = _PCKBBJyx;
        "pkg-1.1.2+1.5.2" = _AogUHAL9;
        "pkg-1.1.2+1.6.1" = _Nyxio7Ds;
        "pkg-1.1.3+1.5.2" = _C06Xtc9x;
        "pkg-1.1.3+1.6.1" = _qQQR59hw;
        "pkg-1.1.4+1.5.2" = _Rdcz3fcK;
        "pkg-1.1.4+1.6.1" = _9BIk5vvs;
        "pkg-1.1.4+1.6.1-hotfix.1" = _rrn9iNen;
        "pkg-1.1.5+1.5.2" = _SoHOipLO;
        "pkg-1.1.5+1.6.1" = _3FvUk9A6;
        "pkg-1.1.5+1.6.1+hotfix.1" = _wincdwyq;
        "pkg-1.1.5+1.6.1+hotfix.2" = _ZnAgIWZX;
        "pkg-1.1.6+1.5.2" = _Ja67MYcr;
        "pkg-1.1.6+1.6.1" = _c1WW69Rz;
        "pkg-1.1.6+1.6.1+hotfix.1" = _6TOdiSpO;
        "pkg-1.1.6+1.7.0" = _mgtNOqEY;
        "pkg-1.1.7+1.5.2" = _szJDJtfQ;
        "pkg-1.1.7+1.7.0" = _QDktxmwm;
        "pkg-1.1.7+1.7.1" = _6qVH2ATx;
        "pkg-1.1.8+1.5.2" = _cG5yFBP9;
        "pkg-1.1.8+1.7.1" = _HK1UnAmB;
        "pkg-1.1.8+1.7.2" = _q28CH2mj;
