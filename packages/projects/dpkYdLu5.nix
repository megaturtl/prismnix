...
let
    ...
    in {
        ...
        "pkg-1.4" = _jXdp6tUw;
        "pkg-1.5" = _RgqTpod6;
        "pkg-1.5+mc1.20.1" = _5vgLKMuG;
        "pkg-1.6+mc1.19.4" = _ek0qeLA8;
        "pkg-1.6+mc1.18.2" = _eL2D0PAG;
        "pkg-1.7+mc1.20.1" = _oSJLJ3ws;
        "pkg-1.7.1+mc1.20.2" = _9uGNZdek;
        "pkg-1.6+mc1.19.2" = _tObGKdg8;
        "pkg-1.8.0+mc1.20.3" = _SggsvDSf;
        "pkg-1.6.1+mc1.18.2" = _5Ozmtday;
        "pkg-1.6.1+mc1.19.2" = _I5HoYOzU;
        "pkg-1.6.1+mc1.19.4" = _4d2c0YT6;
        "pkg-1.7.2+mc1.20.1" = _53ETvwW5;
        "pkg-1.7.2+mc1.20.2" = _zGNgPvFI;
        "pkg-1.8.1+mc1.20.4" = _DVCTZCQE;
        "pkg-1.9.0+mc1.20.6" = _FtJPWYVd;
        "pkg-1.6.2+mc1.18.2" = _SrHOGARP;
        "pkg-1.6.2+mc1.19.2" = _iZUUg1bf;
        "pkg-1.6.2+mc1.19.4" = _yMUGJhz5;
        "pkg-1.7.3+mc1.20.1" = _DUe7wSlK;
        "pkg-1.7.3+mc1.20.2" = _nRYTmS1z;
        "pkg-1.8.2+mc1.20.4" = _am8E5abQ;
        "pkg-1.10.0+mc1.20.6" = _5XKEmbz8;
        "pkg-1.11.0+mc1.21" = _AzCyvR3o;
        "pkg-1.6.3+mc1.18.2" = _z63S0d4d;
        "pkg-1.6.3+mc1.19.2" = _Yh1XYvb1;
        "pkg-1.6.3+mc1.19.4" = _ZFXj1txG;
        "pkg-1.7.4+mc1.20.1" = _4LcWZiB0;
        "pkg-1.7.4+mc1.20.2" = _hTxG67gG;
        "pkg-1.8.3+mc1.20.4" = _BgvXf0g3;
        "pkg-1.10.1+mc1.20.6" = _XUuvZoGa;
        "pkg-1.11.1+mc1.21" = _4ArHh3Gl;
        "pkg-1.6.4+mc1.18.2" = _oK4vG3Ua;
        "pkg-1.6.4+mc1.19.2" = _WhrT4GCN;
        "pkg-1.6.4+mc1.19.4" = _GNS6wcqw;
        "pkg-1.7.5+mc1.20.1" = _aXWUkSif;
        "pkg-1.7.5+mc1.20.2" = _eQlOzdKM;
        "pkg-1.8.4+mc1.20.4" = _NPTNdRHj;
        "pkg-1.10.2+mc1.20.6" = _6xlDlDKe;
        "pkg-1.11.2+mc1.21" = _zLpWH3WX;
        "pkg-1.6.5+mc1.18.2" = _25w5rcMy;
        "pkg-1.6.5+mc1.19.2" = _XKhZEB5u;
        "pkg-1.6.5+mc1.19.4" = _i8CDbW8R;
        "pkg-1.7.6+mc1.20.1" = _dtom2i5O;
        "pkg-1.7.6+mc1.20.2" = _QMpt8gmq;
        "pkg-1.8.5+mc1.20.4" = _XbVOmEvv;
        "pkg-1.10.3+mc1.20.6" = _GUmUO4Jn;
        "pkg-1.11.3+mc1.21" = _ndpaCnCX;
        "pkg-1.11.4+mc1.21" = _pLvx6cf1;
        "pkg-1.12.0+mc1.21.2" = _hu3SvKNn;
        "pkg-1.13.0+mc1.21.4" = _XRWeX7VS;
        "pkg-1.7.7+mc1.20.1" = _bVr17Kbo;
        "pkg-1.7.7+mc1.20.2" = _tiP0Zt3Q;
        "pkg-1.8.6+mc1.20.4" = _1PP3W2Sr;
        "pkg-1.10.4+mc1.20.6" = _d1weORhl;
        "pkg-1.11.5+mc1.21" = _PK7EGBEg;
        "pkg-1.12.1+mc1.21.2" = _DRzj6AAF;
        "pkg-1.13.1+mc1.21.4" = _DltxvLRb;
        "pkg-1.7.8+mc1.20.1" = _QRJDeJNh;
        "pkg-1.7.8+mc1.20.2" = _dYg1Sib4;
        "pkg-1.8.7+mc1.20.4" = _vjLdYxnR;
        "pkg-1.10.5+mc1.20.6" = _y7WlCItV;
        "pkg-1.11.6+mc1.21" = _OJhL4bIB;
        "pkg-1.12.2+mc1.21.2" = _6yOeNIwW;
        "pkg-1.13.2+mc1.21.4" = _XrWmHZ1l;
        "pkg-1.98.0+mc1.21" = _aQw8xTce;
        "pkg-1.99.0+mc1.21.2" = _9MMdLsOt;
        "pkg-2.0.0+mc1.21.4" = _wb4JFs4S;
        "pkg-2.1.0+mc1.21.5" = _ZXvzLGCm;
        "pkg-1.98.1+mc1.21" = _40O97jz0;
        "pkg-1.99.1+mc1.21.2" = _ln7NMe5n;
        "pkg-2.0.1+mc1.21.4" = _4vPJ8FzT;
        "pkg-2.1.1+mc1.21.5" = _e9wdwoZB;
        "pkg-2.2.0+mc1.21.6" = _NDEym51J;
        "pkg-1.98.2+mc1.21" = _Y8KD65tr;
        "pkg-1.99.2+mc1.21.2" = _RPL9It3F;
        "pkg-2.0.2+mc1.21.4" = _9jHtdCuz;
        "pkg-2.1.2+mc1.21.5" = _OGcQjfrI;
        "pkg-2.2.1+mc1.21.6" = _nfrCPy2I;
        "pkg-2.3.0+mc1.21.9" = _pGcopPKx;
        "pkg-1.98.3+mc1.21" = _61evZD04;
        "pkg-1.99.3+mc1.21.2" = _9bwdwK1B;
        "pkg-2.0.3+mc1.21.4" = _GpEpUP7w;
        "pkg-2.1.3+mc1.21.5" = _wU7CZmDn;
        "pkg-2.2.2+mc1.21.6" = _fnmBbCmI;
        "pkg-2.3.1+mc1.21.9" = _1tBOZIf2;
        "pkg-2.4.0+mc1.21.11" = _bLNx9oKh;
        "pkg-1.98.4+mc1.21" = _omwygYq4;
        "pkg-1.99.4+mc1.21.2" = _oJxv4ml0;
        "pkg-2.0.4+mc1.21.4" = _H6cI62YQ;
        "pkg-2.1.4+mc1.21.5" = _nlNDtuIr;
        "pkg-2.2.3+mc1.21.6" = _UXSik8W5;
        "pkg-2.3.2+mc1.21.9" = _iTqTBoVp;
        "pkg-2.4.1+mc1.21.11" = _kPlqlO3m;
        "pkg-2.5.0+mc26.1-neoforge" = _jaamXqc6;
        "pkg-2.5.0+mc26.1-fabric" = _Fn5utBWo;
        "pkg-2.5.1+mc26.1-neoforge" = _cP9hvWLG;
