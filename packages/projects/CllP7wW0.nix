...
let
    ...
    in {
        ...
        "pkg-2.1.2" = _kVlPalL8;
        "pkg-2.1.3" = _xEJKQkZp;
        "pkg-2.1.3.1" = _Fv16193b;
        "pkg-2.2.0" = _RFzbg7kj;
        "pkg-2.2.1" = _iTQgYmrX;
        "pkg-2.2.1.1" = _IcYlXcKW;
        "pkg-2.2.2" = _llzYUjPw;
        "pkg-2.2.2.1" = _jvPPLz26;
        "pkg-2.2.2.2" = _7CQJZAEo;
        "pkg-2.2.3" = _ZQ1b9Noe;
        "pkg-2.2.3.1" = _GNmJlNRE;
        "pkg-2.2.4" = _jo6r15rd;
        "pkg-2.1.2.1" = _GZ35gpLS;
        "pkg-2.3.0" = _i18YF1Et;
        "pkg-2.2.3.2" = _Dv66b3me;
        "pkg-2.3.0.1" = _P8ncWVX0;
        "pkg-2.3.0.2" = _nL1yYSEz;
        "pkg-2.3.1" = _5F3Q9nyU;
        "pkg-2.4.0" = _xO8Ob5oR;
        "pkg-2.4.1" = _qRCAP10T;
        "pkg-2.5.0" = _rnWX6cpR;
