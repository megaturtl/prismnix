...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _KB6dqNpp;
        "pkg-1.0.9" = _k6Aoev2M;
        "pkg-1.0.10" = _Gnn6vkk1;
        "pkg-1.0.11" = _T9m8di8F;
        "pkg-1.0.12" = _GcFhT2Lu;
        "pkg-1.0.13" = _CspFIrs5;
        "pkg-1.0.14" = _s2L150DV;
        "pkg-1.0.15" = _PyEKXrkE;
        "pkg-1.0.16" = _VF5WPRJC;
        "pkg-1.0.17" = _YoTs1Gvg;
        "pkg-1.0.17.1" = _jKZ3iTA5;
        "pkg-1.0.17.3" = _rvIOAWOw;
        "pkg-1.0.17.4" = _ICEo5Cre;
        "pkg-1.0.17.5" = _HppzGq8S;
        "pkg-1.0.17.6" = _xZHIWKgR;
        "pkg-1.0.17.7" = _IfO7zMlV;
        "pkg-1.0.17.7.1" = _QXaJ8FYj;
        "pkg-1.0.17.7.2" = _HqvSVVw7;
        "pkg-1.0.17.8" = _EhzVfJJs;
        "pkg-1.0.18" = _eoZpy67I;
        "pkg-1.0.18.1" = _9TnV02zY;
        "pkg-1.0.18.2" = _tdPB8UJw;
        "pkg-1.0.18.3" = _pNtnP11n;
        "pkg-1.0.19" = _5p3BCHjU;
        "pkg-1.0.20" = _5oIE0NdM;
        "pkg-1.0.21" = _fuppbOZ9;
        "pkg-1.0.22" = _q7r9hT63;
        "pkg-1.0.22-hotfix" = _XNUI0oZK;
        "pkg-1.0.23" = _ivGNwQQ1;
