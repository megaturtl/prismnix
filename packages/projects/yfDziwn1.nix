...
let
    versions = (let
        ...
        _Hhc7wgKA = {
            "id" = "Hhc7wgKA";
            "file" = "SodiumTranslations.zip";
            "hash" = "sha512-m8IxRgZewO3swGEZ/IAQFHhOpmm7jyDmgz1BN3MkN0VGehOwwiaZ2hOpaY56DZjZD5elclOxPs07R1aQbws9yQ==";
        };
        _PWltlBcZ = {
            "id" = "PWltlBcZ";
            "file" = "SodiumTranslations.zip";
    ...
    in {
        ...
        "pkg-v2.1.0" = _quY6bogm;
        "pkg-v2.2.0" = _omschtBI;
        "pkg-v2.3.0" = _PvPTlgow;
        "pkg-v2.4.0" = _5CEpFqwI;
        "pkg-v2.5.0" = _LJ4V72DJ;
        "pkg-v2.6.0" = _pbearc8g;
        "pkg-v2.7.0" = _Naw32Asd;
        "pkg-v2.8.0" = _maQVLxXi;
        "pkg-v2.9.0" = _9DGCdov1;
        "pkg-v2.10.0" = _gJW8tRdQ;
        "pkg-v2.11.0" = _E5bQs4lZ;
        "pkg-v2.12.0" = _hG527GKm;
        "pkg-v2.13.0" = _umg6sh43;
        "pkg-v2.14.0" = _zPaf4AJw;
        "pkg-v2.15.0" = _SBSzeDhE;
        "pkg-v2.16.0" = _t0smQMux;
        "pkg-v2.17.0" = _hJtGlWlj;
        "pkg-v2.18.0" = _buNkqWOG;
        "pkg-v2.19.0" = _5B3IlQLZ;
        "pkg-v2.20.0" = _DLZqoWj6;
        "pkg-v2.21.0" = _CeCmsjs8;
        "pkg-v2.22.0" = _KLZuAPPk;
        "pkg-v2.23.0" = _FKuKNwiH;
        "pkg-v2.24.0" = _cK7pmVOl;
        "pkg-v2.25.0" = _90djltEk;
        "pkg-v2.26.0" = _QIUzFOtg;
        "pkg-v2.27.0" = _s2FqIXh9;
        "pkg-v2.28.0" = _ZOE9JArR;
        "pkg-v2.29.0" = _FYqmjitN;
        "pkg-v2.30.0" = _QFLQVTh2;
        "pkg-v3.0.0" = _xCCMgh7L;
        "pkg-v3.1.0" = _9shpx7NM;
        "pkg-v3.2.0" = _ThdOVcfs;
        "pkg-v3.3.0" = _2g8eQdpU;
        "pkg-v3.4.0" = _3dVpBxxu;
        "pkg-v3.5.0" = _CkbLHtym;
        "pkg-v3.6.0" = _o3jcoTn4;
        "pkg-v3.7.0" = _StuHF5aC;
        "pkg-v3.8.0" = _Pi0LOPWP;
        "pkg-v3.9.0" = _d5haRKSg;
        "pkg-v3.10.0" = _H3CwWhek;
        "pkg-v3.11.0" = _jxHmg0uz;
        "pkg-v3.12.0" = _PZ1zOJyv;
        "pkg-v3.13.0" = _gxrD73pY;
        "pkg-v3.14.0" = _LXyVD82i;
        "pkg-v3.15.0" = _PhdQqp9M;
        "pkg-v3.16.0" = _N76l7gNw;
        "pkg-v3.17.0" = _rr7vSO7n;
        "pkg-v3.18.0" = _AcOC4PXT;
        "pkg-v3.19.0" = _MQyiZDxo;
        "pkg-v3.20.0" = _5HmWi3Tp;
        "pkg-v3.21.0" = _LaeGTuuo;
        "pkg-v3.22.0" = _WTOnCddm;
        "pkg-v3.23.0" = _Ff3iLzwK;
        "pkg-v3.24.0" = _UW7rbLDl;
        "pkg-v3.25.0" = _7VuVdb3P;
        "pkg-v3.26.0" = _DjcKMCbf;
        "pkg-v3.27.0" = _9Ze6jNPA;
        "pkg-v3.28.0" = _5WJ7o2H0;
        "pkg-v4.0.0" = _hAF9j86m;
        "pkg-v4.1.0" = _9zG2sTUa;
        "pkg-v4.2.0" = _aoB2LQun;
        "pkg-v4.3.0" = _MlhjI9qi;
        "pkg-v4.4.0" = _rseM3xWQ;
        "pkg-v4.5.0" = _BtRqvj3X;
        "pkg-v4.6.0" = _P4lUdez2;
        "pkg-v4.7.0" = _TZ7Pon7A;
        "pkg-v4.8.0" = _jSZSOlid;
        "pkg-v4.9.0" = _hFpd78A8;
        "pkg-v4.10.0" = _X3UwMBeG;
        "pkg-v4.11.0" = _bmWYzqI4;
        "pkg-v4.12.0" = _uBJetVKi;
        "pkg-v4.13.0" = _eVyUmd3p;
        "pkg-v4.14.0" = _GLPr0Qn9;
        "pkg-v4.15.0" = _P9ToDibH;
        "pkg-v4.16.0" = _E5S7DPSP;
        "pkg-v4.17.0" = _Ucd0w79e;
        "pkg-v4.18.0" = _IhmUucgL;
        "pkg-v4.19.0" = _KcFncwDe;
        "pkg-v4.20.0" = _C2E1HpP4;
        "pkg-v4.21.0" = _LXc39xFy;
        "pkg-v4.22.0" = _WByLysCv;
        "pkg-v4.23.0" = _VjM9LI0H;
        "pkg-v4.25.0" = _6hd3qeel;
        "pkg-v4.26.0" = _FLyeG6PN;
        "pkg-v4.27.0" = _GWDBXXcf;
        "pkg-v4.28.0" = _RcCeb7rc;
        "pkg-v4.29.0" = _omwNL9lS;
        "pkg-v4.30.0" = _RT7TpDwz;
        "pkg-v4.31.0" = _LJphZoJr;
        "pkg-v4.32.0" = _VM0QQhUt;
        "pkg-v4.34.0" = _YdkhC4Og;
        "pkg-v4.35.0" = _pDdesyCp;
        "pkg-v4.36.0" = _Mv5eNkQa;
        "pkg-v4.37.0" = _THrankNf;
        "pkg-v4.38.0" = _fIQ1Rbut;
        "pkg-v4.39.0" = _5JjR53Aw;
        "pkg-v4.40.0" = _YX2q1FUD;
        "pkg-v4.41.0" = _v0g54wsS;
        "pkg-v4.42.0" = _WZQGmjDS;
        "pkg-v4.43.0" = _2SpO6F0j;
        "pkg-v4.44.0" = _3sDdaIcF;
        "pkg-v4.45.0" = _gg2j3lh7;
        "pkg-v4.46.0" = _kMhmZLcr;
        "pkg-v4.47.0" = _9fQQ7TYI;
        "pkg-v4.48.0" = _x7n18otA;
        "pkg-v4.49.0" = _IG6CxWl0;
        "pkg-v4.50.0" = _fkEfyeA8;
        "pkg-v4.51.0" = _d5RndRwn;
        "pkg-v4.52.0" = _ty2pVO7d;
        "pkg-v4.53.0" = _aijQg1Bh;
        "pkg-v4.54.0" = _dNgwg6h6;
        "pkg-v4.55.0" = _YkHWmHq8;
        "pkg-v5.0.0" = _V6p6VzRp;
        "pkg-v5.1.0" = _KtsgplHc;
        "pkg-v5.2.0" = _2WME7YQN;
        "pkg-v5.3.0" = _5bJdkZhA;
        "pkg-v5.4.0" = _WF8Yfuv4;
        "pkg-v5.5.0" = _K14D7inW;
        "pkg-v5.6.0" = _1Jvg6uGm;
        "pkg-v5.7.0" = _wDPJqkKs;
        "pkg-v5.8.0" = _751FoAnj;
        "pkg-v5.9.0" = _jhZ8HWWd;
        "pkg-v5.10.0" = _WGhwIJk2;
        "pkg-v6.1.0" = _MsPBu1d9;
        "pkg-v6.2.0" = _gDwLP8mS;
        "pkg-v6.3.0" = _osqMGpQL;
        "pkg-v6.4.0" = _w8K4dlyA;
        "pkg-v6.5.0" = _Rn1KQGur;
        "pkg-v6.6.0" = _hKDIPztm;
        "pkg-v6.7.0" = _YCYskNsv;
        "pkg-v6.8.0" = _t7Rc3DDV;
        "pkg-v6.9.0" = _J4u4xv6D;
        "pkg-v6.10.0" = _FknJTNfY;
        "pkg-v6.11.0" = _je9Y2eez;
        "pkg-v6.12.0" = _yX6kBQlM;
        "pkg-v6.13.0" = _5XfjBR17;
        "pkg-v6.14.0" = _RytAdtax;
        "pkg-v6.15.0" = _9hGCf44T;
        "pkg-v6.16.0" = _JVplQLgz;
        "pkg-v7.0.0" = _ya2Zkn6H;
        "pkg-v7.1.0" = _hffJNAo4;
        "pkg-v7.2.0" = _OhU2JjU8;
        "pkg-v7.3.0" = _NzgyaJKQ;
        "pkg-v7.4.0" = _1AHSPjqk;
        "pkg-v7.5.0" = _r7ofu8VV;
        "pkg-v7.6.0" = _Bis8djLk;
        "pkg-v7.7.0" = _Q4pV0Zs5;
        "pkg-v7.8.0" = _ableb7r5;
        "pkg-v7.9.0" = _oH4e56Ma;
        "pkg-v7.10.0" = _FssqfKaV;
        "pkg-v7.11.0" = _iA9H7gau;
        "pkg-v7.12.0" = _3nrLzWin;
        "pkg-v7.13.0" = _CfiSZo4D;
        "pkg-v8.0.0" = _UnzMKYTy;
        "pkg-v8.1.0" = _krBxUB2j;
        "pkg-v8.2.0" = _qcpWzIqW;
        "pkg-v8.3.0" = _6JDrHfVF;
        "pkg-v8.4.0" = _i4hf27wn;
        "pkg-v8.5.0" = _aJMQSFrp;
