...
let
    ...
    in {
        ...
        "pkg-0.3.7" = _WCHWUqb2;
        "pkg-0.3.8" = _edLJnD7h;
        "pkg-1.20.1-0.4.0" = _eGY0RWgr;
        "pkg-1.20.1-0.4.1a" = _7v7WgkON;
        "pkg-1.20.1-0.4.2" = _8uL9Noql;
        "pkg-1.20.1-0.4.3" = _VAp2Dem9;
        "pkg-1.20.1-0.4.4" = _QCNxuFdp;
        "pkg-1.20.1-0.5.0" = _eF9cZLeT;
        "pkg-1.20.1-0.5.1" = _6rGs8Bj5;
        "pkg-1.20.1-0.5.2" = _Uy8IC98m;
        "pkg-1.20.1-0.5.3" = _DkoEKpLm;
        "pkg-1.21" = _9M7Ntx7N;
        "pkg-1.21-0.6.1" = _ecSGEmGW;
        "pkg-1.21-0.6.2" = _YJDjvF0A;
