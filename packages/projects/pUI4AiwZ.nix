...
let
    ...
    in {
        ...
        "pkg-1.4.6-4277775" = _eJD8f2bU;
        "pkg-1.4.6-1a8a9a4" = _IpBO6VcV;
        "pkg-1.5.0-2c0f725" = _GSAbn99J;
        "pkg-1.5.0-066e50e" = _BcMSaHry;
        "pkg-1.5.0-ff7445c" = _xHEs4MTi;
        "pkg-1.5.0-b81f690" = _PWNDBzUt;
        "pkg-1.5.0-c1d26ae" = _QiMMt0zp;
        "pkg-1.5.0-49eaddd" = _8CWNMdNA;
        "pkg-1.5.0-450db09" = _tBTFifE5;
        "pkg-1.5.1-287cb61" = _KEWGuvhP;
        "pkg-1.5.1-f8b296b" = _9JQusgci;
        "pkg-1.5.1-090728e" = _cJB1nNTJ;
        "pkg-1.5.1-751a03f" = _Vy8Bd9Ed;
        "pkg-1.5.1-0415194" = _fwJZD0Ma;
        "pkg-1.5.1-58802cf" = _4LdEi8YE;
        "pkg-1.5.1-f4bfbc0" = _oRq0NO5c;
        "pkg-1.5.1-043483f" = _Ap6M2nsB;
        "pkg-1.5.1-0c3aff4" = _ebkKMW2J;
        "pkg-1.5.1-633bc92" = _TFyOwKkv;
        "pkg-1.5.1-aa5873b" = _O5fD3Lvf;
        "pkg-1.5.1-b72c51b" = _dTFd8Zhr;
        "pkg-1.5.1-723d0ea" = _kYZ9w8LS;
        "pkg-1.5.1-408baec" = _JNz6HTJl;
        "pkg-1.5.1-e7d0e18" = _NBGxmThT;
        "pkg-1.5.1-7a3665d" = _ZBYKtKKT;
        "pkg-1.5.1-1857de7" = _o59s8zYw;
        "pkg-1.5.1-f149a6d" = _BXPozBzo;
        "pkg-1.5.2-81fbb4d" = _uJLdhaIk;
        "pkg-1.5.2-4be55e2" = _yFYvKGPX;
        "pkg-1.5.3-27c1d88" = _bxemfKOh;
        "pkg-1.5.3-90038dd" = _TeBoig4z;
        "pkg-1.5.3-2b48253" = _6BxX1nC0;
        "pkg-1.5.3-b45ac37" = _pNTwwidM;
        "pkg-1.5.3-05453b0" = _w4OTbhuN;
        "pkg-1.5.3-0d1077f" = _RYLOGCLE;
        "pkg-1.5.4-7c4206a" = _ZbPPm7Ut;
        "pkg-1.5.5-35b286e" = _w1vzsvUA;
        "pkg-1.5.5-2173c60" = _IPGGNvtw;
        "pkg-1.5.5-a9fbe0e" = _OFpibfXv;
        "pkg-1.5.5-09e2e4a" = _MQBDbQ5c;
        "pkg-1.5.5-8eee693" = _aPWUISlR;
        "pkg-1.5.5-5874fc3" = _l9H2DuYn;
        "pkg-1.5.5-56b97bc" = _Fv1Y95lT;
        "pkg-1.5.5-deb70ef" = _xDGZPEc4;
        "pkg-1.5.6-d203eeb" = _GIjxHAhW;
        "pkg-1.5.6-d0acb49" = _9fCBbJIH;
        "pkg-1.5.6-91f76a1" = _sjOkAbVc;
        "pkg-1.5.6-ba9f787" = _dxnl980h;
        "pkg-1.5.6-8569f90" = _Pw5FmWkw;
        "pkg-1.5.6-85844ef" = _3tRHxKBr;
        "pkg-1.5.6-afeeaeb" = _kp8915xS;
        "pkg-1.5.6-3d31010" = _e1sAUZtF;
        "pkg-1.5.6-8e7d4b0" = _SFmu8pPf;
        "pkg-1.5.7-82da3b8" = _WblE1ffU;
        "pkg-1.5.7-bfb2ce9" = _BdHpivef;
        "pkg-1.5.7-c42b574" = _d2OVdu7m;
        "pkg-1.5.7-7a2d631" = _hbyKSI6C;
        "pkg-1.5.7-bfb1b7d" = _6z393hsw;
        "pkg-1.5.7-4d5ec30" = _L53mO4dT;
