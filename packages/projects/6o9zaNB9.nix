...
let
    ...
    in {
        ...
        "pkg-0.2.1" = _J2GOqYF5;
        "pkg-0.2.1+26.1" = _IcTM9PFX;
        "pkg-0.3.0" = _vWtq1M3K;
        "pkg-0.3.1" = _fNcnlJN6;
        "pkg-0.3.2" = _tDMzj7b4;
        "pkg-0.3.5" = _5KQnqivO;
        "pkg-0.3.5+26.1" = _ygWQyS6Y;
        "pkg-0.3.6" = _WiPdS2KR;
        "pkg-0.3.6+26.1" = _7lIW5j3H;
        "pkg-0.3.7" = _SBw81VYB;
        "pkg-0.3.7+26.1" = _Zo3igWrw;
        "pkg-0.3.9" = _yNeyddJr;
        "pkg-0.3.9+26.1" = _3c672Hfk;
        "pkg-0.4.0" = _XWBMKGvL;
        "pkg-0.4.0+26.1" = _NzRV3Dx0;
        "pkg-0.5.0" = _vgejTPHr;
        "pkg-0.5.0+26.1" = _McOBPwMD;
        "pkg-0.6.0" = _hNOCsJG5;
