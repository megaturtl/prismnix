...
let
    versions = (let
        ...
        _heHnARk2 = {
            "id" = "heHnARk2";
            "file" = "JustTimm's Lightsaber Workshop 3.2.2.zip";
            "hash" = "sha512-rD1kuH3XEC/0u8POmYi9W2VQUivlXh+TqEPkQSR2u71Kv91XsuYpouNrQ9VxK1jqMcRrDVkilNtKSrs24kzoKA==";
        };
    in {
        "v1kb1NA3" = _v1kb1NA3;
        "aK57HHj0" = _aK57HHj0;
        ...
        "minecraft-1.20.2" = _heHnARk2;
        "minecraft-1.20.3" = _xcXw1250;
        "minecraft-1.20.4" = _heHnARk2;
        "minecraft-1.20.5" = _xcXw1250;
        "minecraft-1.20.6" = _heHnARk2;
        "minecraft-1.21" = _heHnARk2;
        "minecraft-1.21.1" = _heHnARk2;
        "minecraft-1.21.3" = _heHnARk2;
        "minecraft-1.21.4" = _heHnARk2;
        ...
        "minecraft-1.21.5" = _heHnARk2;
        "minecraft-1.21.6" = _heHnARk2;
        "minecraft-1.21.7" = _heHnARk2;
