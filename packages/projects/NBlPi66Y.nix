...
let
    ...
    in {
        ...
        "pkg-1.3.8" = _9yFXmsfH;
        "pkg-1.3.9" = _Xv3DSfJS;
        "pkg-1.3.10" = _tVBzgvPq;
        "pkg-1.3.11" = _AKh6t6L8;
        "pkg-1.3.12" = _BcmSQMjX;
        "pkg-1.3.13" = _zJVIlpiv;
        "pkg-1.3.14" = _IzMbBMfz;
        "pkg-1.3.16" = _qDh0Qd0V;
        "pkg-2.0.0.beta.1" = _QltOQDmC;
        "pkg-2.0.0.beta.2" = _z3kKqZpH;
        "pkg-2.0.0.rc.1" = _W93gPoMZ;
        "pkg-2.0.0" = _Q5H5DLea;
        "pkg-2.0.1" = _RI3CSDu0;
        "pkg-2.0.2" = _alfXVn1P;
        "pkg-2.0.3" = _daCwofCU;
