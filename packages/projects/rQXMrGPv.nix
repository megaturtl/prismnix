...
let
    versions = (let
        ...
        _5Z0jcB9J = {
            "id" = "5Z0jcB9J";
            "file" = "kabo-village-marker-1.4.0+mc1.3-1.5.jar";
            "hash" = "sha512-b/qbHjddGik1NCWzeWY/rFhliyWc4p/yIVTV92VEa9N/+uT84zjiTyaVRm2cPaFEudUzj2ribxd5mh2E4iNe3w==";
        };
        _MulwvmIq = {
            "id" = "MulwvmIq";
            "file" = "kabo-village-marker-1.4.0+mc1.6.jar";
            "hash" = "sha512-jjOtMV1EU9E/f/4lyhpDEWeDT6joJkuMAJNrhGWLoKz3wBSUSXCjEnm3gbQ5VfKP8BMGK4UvHlLYO1wyiuQmKg==";
        };
        _ZkJfB5DF = {
            "id" = "ZkJfB5DF";
            "file" = "kabo-village-marker-1.4.0+mc1.7.jar";
            "hash" = "sha512-w5AY3EFwyFp1YTNAFOWflOdWgkgmMlXqw/m/bS/Kv3JuW0TLU72awhgqgMvn4RdBYF4lrmTAZgU+IRPCMRbOxg==";
        };
        _xGVG9Etx = {
            "id" = "xGVG9Etx";
            "file" = "kabo-village-marker-1.4.0+mc1.8-1.8.1.jar";
            "hash" = "sha512-81l5DlteVnw+rHoOnJ14ta2hTxxPC+94pS3Q4+XTZwFU5WGgcHqrBYiOU8GhfvAa3+2rHrZqLqANLcziXeJOYg==";
        };
        _JdpzFuM4 = {
            "id" = "JdpzFuM4";
            "file" = "kabo-village-marker-1.4.0+mc1.8.2-1.8.9.jar";
            "hash" = "sha512-zsAIZdjFFxbdCzNjy7xNN8/CVnjzXJil+3t9NxvhOXvPzcXvYgbvUYVsfgEFFW+rfx3klWpwU3HE7zBLj7cTYg==";
        };
        _8gmCTVHk = {
            "id" = "8gmCTVHk";
            "file" = "kabo-village-marker-1.4.0+mc1.9-1.12.jar";
            "hash" = "sha512-2tICuwb2iL1koX/GehrhuZOGSZ+/Naig71m08t60NuxeYwZ/gvbge+JqL99zbl9UiHntbQSSq1nGMpBk6/5c4w==";
        };
        _NxmQo21I = {
            "id" = "NxmQo21I";
            "file" = "kabo-village-marker-1.4.0+mc1.13.jar";
            "hash" = "sha512-Qd7K6WOYb8db5E7na/gJ8HKv3rYb3HBr7Mv5rnfWfl2nCWmQCSdTYJVFBy6G3UuVbOizEFFx0tk2Gyinp1D2WQ==";
        };
    in {
        "kZjXvAYe" = _kZjXvAYe;
        "2VFjRLfU" = _2VFjRLfU;
        ...
        "8gmCTVHk" = _8gmCTVHk;
        "NxmQo21I" = _NxmQo21I;
        "ornithe-1.3.1" = _5Z0jcB9J;
        "ornithe-1.3.2" = _5Z0jcB9J;
        "ornithe-1.4.2" = _5Z0jcB9J;
        "ornithe-1.4.4" = _5Z0jcB9J;
        "ornithe-1.4.5" = _5Z0jcB9J;
        "ornithe-1.4.6" = _5Z0jcB9J;
        "ornithe-1.4.7" = _5Z0jcB9J;
        "ornithe-1.5.1" = _5Z0jcB9J;
        "ornithe-1.5.2" = _5Z0jcB9J;
        "ornithe-1.6.1" = _MulwvmIq;
        "ornithe-1.6.2" = _MulwvmIq;
        "ornithe-1.6.4" = _MulwvmIq;
        "ornithe-1.7.2" = _ZkJfB5DF;
        "ornithe-1.7.3" = _ZkJfB5DF;
        "ornithe-1.7.4" = _ZkJfB5DF;
        "ornithe-1.7.5" = _ZkJfB5DF;
        "ornithe-1.7.6" = _ZkJfB5DF;
        "ornithe-1.7.7" = _ZkJfB5DF;
        "ornithe-1.7.8" = _ZkJfB5DF;
        "ornithe-1.7.9" = _ZkJfB5DF;
        "ornithe-1.7.10" = _ZkJfB5DF;
        "ornithe-1.8" = _xGVG9Etx;
        "ornithe-1.8.1" = _xGVG9Etx;
        "ornithe-1.8.2" = _JdpzFuM4;
        "ornithe-1.8.3" = _JdpzFuM4;
        "ornithe-1.8.4" = _JdpzFuM4;
        "ornithe-1.8.5" = _JdpzFuM4;
        "ornithe-1.8.6" = _JdpzFuM4;
        "ornithe-1.8.7" = _JdpzFuM4;
        "ornithe-1.8.8" = _JdpzFuM4;
        "ornithe-1.8.9" = _JdpzFuM4;
        "ornithe-1.9" = _8gmCTVHk;
        "ornithe-1.9.1" = _8gmCTVHk;
        "ornithe-1.9.2" = _8gmCTVHk;
        "ornithe-1.9.3" = _8gmCTVHk;
        "ornithe-1.9.4" = _8gmCTVHk;
        "ornithe-1.10" = _8gmCTVHk;
        "ornithe-1.10.1" = _8gmCTVHk;
        "ornithe-1.10.2" = _8gmCTVHk;
        "ornithe-1.11" = _8gmCTVHk;
        "ornithe-1.11.1" = _8gmCTVHk;
        "ornithe-1.11.2" = _8gmCTVHk;
        "ornithe-1.12" = _8gmCTVHk;
        "ornithe-1.12.1" = _8gmCTVHk;
        "ornithe-1.12.2" = _8gmCTVHk;
        "ornithe-1.13" = _NxmQo21I;
        "ornithe-1.13.1" = _NxmQo21I;
        "ornithe-1.13.2" = _NxmQo21I;
        "pkg-1.0.0+mc1.3-1.5" = _kZjXvAYe;
        "pkg-1.0.0+mc1.6" = _2VFjRLfU;
        "pkg-1.0.0+mc1.7" = _5JmmosTb;
        "pkg-1.0.0+mc1.8" = _3JRJgJjR;
        "pkg-1.0.0+mc1.9-1.12" = _kwQZmJWi;
        "pkg-1.0.0+mc1.13" = _CcvveflM;
        "pkg-1.1.0+mc1.3-1.5" = _MFnhRBi3;
        "pkg-1.1.0+mc1.6" = _A9UYXxpO;
        "pkg-1.1.0+mc1.7" = _DDmpFrtG;
        "pkg-1.1.0+mc1.8" = _sQ5mhLi6;
        "pkg-1.1.0+mc1.9-1.12" = _CKj7MIp9;
        "pkg-1.1.0+mc1.13" = _wj5zkFmp;
        "pkg-1.2.0+mc1.3-1.5" = _avHnNiul;
        "pkg-1.2.0+mc1.6" = _FpkJuUFL;
        "pkg-1.2.0+mc1.7" = _mwtbl00u;
        "pkg-1.2.0+mc1.8" = _2Xe6aCiy;
        "pkg-1.2.0+mc1.9-1.12" = _FXu9Xffj;
        "pkg-1.2.0+mc1.13" = _MU3Ps4D3;
        "pkg-1.2.1+mc1.8-1.8.1" = _3sQ7Ipp7;
        "pkg-1.2.1+mc1.8.2-1.8.9" = _nhFbE30a;
        "pkg-1.3.0+mc1.3-1.5" = _iFNpOXxw;
        "pkg-1.3.0+mc1.6" = _e0vst8A3;
        "pkg-1.3.0+mc1.7" = _JAdUcZce;
        "pkg-1.3.0+mc1.8-1.8.1" = _kFyRXi9a;
        "pkg-1.3.0+mc1.8.2-1.8.9" = _wsVKa3iS;
        "pkg-1.3.0+mc1.9-1.12" = _DCTPdfK1;
        "pkg-1.3.0+mc1.13" = _FVOK0CnV;
        "pkg-1.4.0+mc1.3-1.5" = _5Z0jcB9J;
        "pkg-1.4.0+mc1.6" = _MulwvmIq;
        "pkg-1.4.0+mc1.7" = _ZkJfB5DF;
        "pkg-1.4.0+mc1.8-1.8.1" = _xGVG9Etx;
        "pkg-1.4.0+mc1.8.2-1.8.9" = _JdpzFuM4;
        "pkg-1.4.0+mc1.9-1.12" = _8gmCTVHk;
        "pkg-1.4.0+mc1.13" = _NxmQo21I;
        "default" = _NxmQo21I;
    });
