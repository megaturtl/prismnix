...
let
    ...
    in {
        ...
        "pkg-2.0.1" = _rQC1VXW7;
        "pkg-2.0.2" = _T5PriSXi;
        "pkg-3.0.0a-preview1" = _4CcKck4F;
        "pkg-3.0.0a-preview2" = _vJyVeY5j;
        "pkg-3.0.0a-preview3" = _nem8EP3F;
        "pkg-3.0.0a-preview4" = _ExnP6JoU;
        "pkg-3.0.0a-preview5" = _6acmTbrs;
        "pkg-3.0.0" = _5tsjlT7d;
        "pkg-3.0.1" = _vx4INoRC;
        "pkg-3.1.0" = _bmMVPaNV;
        "pkg-3.2.0" = _qgYSdjHf;
        ...
        "pkg-3.4.2" = _QmX5oXIe;
        "pkg-3.4.3" = _H3bB4Fn3;
        "pkg-4.0.0-alpha.1" = _hTUtX4as;
        "pkg-4.0.0-alpha.2" = _vjTjc4rN;
        "pkg-4.0.0-alpha.3" = _VgKNQ0NE;
        "pkg-4.0.0-alpha.4" = _tlZemHj2;
        "pkg-4.0.0-beta.1" = _AsYSNAGD;
        "pkg-4.0.0" = _CbdrJuK5;
        "pkg-4.0.1" = _Oe8tSDVA;
        "pkg-4.1.0" = _bhiIQuiT;
        "pkg-4.2.0-beta.1" = _CaCTgLQF;
