...
let
    ...
    in {
        ...
        "pkg-1.0.1-1.20.3+" = _12QZ0OKz;
        "pkg-1.0.2-1.20+" = _DjncmEPC;
        "pkg-1.0.2-1.20.3+" = _Yg5OQiEb;
        "pkg-1.0.2-1.20.5+" = _JTJfaz1H;
        "pkg-1.0.3-1.20+" = _oUiMZjnc;
        "pkg-1.0.3-1.20.3+" = _76JUcXB7;
        "pkg-1.0.3-1.20.5+" = _lbai59OW;
        "pkg-1.1.0-1.21.0" = _oS692yMe;
        "pkg-1.1.1-1.20" = _bRxzUleH;
        "pkg-1.1.1-1.20.3" = _Pjj0O6p9;
        "pkg-1.1.1-1.20.5" = _tH5c2gyx;
        "pkg-1.1.1-1.21.0" = _Rq8VWfAD;
        "pkg-1.2.0-1.21.0" = _1ewCOxln;
        "pkg-1.3.0-1.21.0" = _dbP29nBx;
        "pkg-1.3.1-1.21.0" = _Dkk8QsEK;
        "pkg-1.3.2-1.21.0" = _Nac9xLex;
        "pkg-1.4.0-1.21.2" = _afneRfMG;
        "pkg-1.4.1-1.21.4" = _tQzJiHAL;
        "pkg-1.3.3-1.21.0" = _PAOQ99U7;
        "pkg-1.4.1-1.21.2" = _RuEdF0bq;
        "pkg-1.4.2-1.21.5" = _f6hAxWRu;
        "pkg-1.4.3-1.21.6" = _yZwf8SEU;
        "pkg-1.4.2-1.21.4" = _mzqoOs0j;
        "pkg-1.4.3-1.21.5" = _9NtOMOA7;
        "pkg-1.4.4-1.21.6" = _bTw6BLof;
        "pkg-1.4.5-1.21.9" = _VccNydTi;
        "pkg-1.4.6-1.21.9" = _8X6MkBjK;
