...
let
    ...
    in {
        ...
        "pkg-1.0.1-1.21.1" = _yXdkZcBK;
        "pkg-1.0.2-1.21.1" = _dm1HUlVa;
        "pkg-1.0.3-1.21.1" = _XrPLtk63;
        "pkg-1.0.4-1.21.1" = _U9zsV9WN;
        "pkg-1.0.5-1.21.1" = _DeQahJm9;
        "pkg-1.0.6-1.21.1" = _vxmfRYru;
        "pkg-1.0.7-1.21.1" = _96iPWWN8;
        "pkg-1.0.8-1.21.1" = _kOIWJ5rs;
        "pkg-1.0.9-1.21.1" = _V7KhadIz;
        "pkg-1.0.10-1.21.1" = _24s1ymmd;
        "pkg-1.0.11-1.21.1" = _uqblKN5O;
        "pkg-1.0.12-1.21.1" = _6NjDfCCk;
        "pkg-1.0.13-1.21.1" = _pAQkcomY;
        "pkg-1.1.0-1.21.1" = _oirsZ71Z;
        "pkg-1.1.1-1.21.1" = _BsXYZsFm;
        "pkg-1.1.2-1.21.1" = _XVQDXJkY;
        "pkg-1.1.3-1.21.1" = _sRcaxgO9;
        "pkg-1.1.4-1.21.1" = _DI6KODZy;
        "pkg-1.1.5-1.21.1" = _anNcbVXV;
        "pkg-1.1.6-1.21.1" = _VXBYjUwC;
        "pkg-0.9.0-1.20.1-beta" = _WnXxX6mb;
        "pkg-1.1.7-1.21.1" = _6QyIlaXn;
        "pkg-0.9.1-1.20.1-beta" = _hxP0UaHt;
        "pkg-0.9.2-1.20.1-beta" = _NKXPfK76;
        "pkg-0.9.3-1.20.1-beta" = _NpDCfldx;
        "pkg-1.0.0-1.20.1" = _kAUK3C1N;
        "pkg-1.0.1-1.20.1" = _9QlyjcJv;
        "pkg-1.1.8-1.21.1" = _jEv8njai;
        "pkg-1.0.2-1.20.1" = _VLRbiSTJ;
        "pkg-1.0.3-1.20.1" = _NH2EM90u;
        "pkg-1.0.4-1.20.1" = _8JzhdddB;
        "pkg-1.0.5-1.20.1" = _LO4NLUDm;
        "pkg-1.1.9-1.21.1" = _exrY05o6;
        "pkg-1.0.6-1.20.1" = _ej35JVEu;
        "pkg-1.1.10-1.21.1" = _MmUnwoSb;
        "pkg-1.0.7-1.20.1" = _834w03Bs;
        "pkg-1.1.11-1.21.1" = _LBbe2WHo;
        "pkg-1.0.8-1.20.1" = _hjj5d2ZZ;
        "pkg-1.1.12-1.21.1" = _hiYL5mhc;
        "pkg-1.1.13-1.21.1" = _dYtd6x4g;
        "pkg-1.0.9-1.20.1" = _evs9LehW;
        "pkg-1.1.14-1.21.1" = _fLwnJQO4;
        "pkg-1.0.10-1.20.1" = _oiLNlM01;
        "pkg-1.1.15-1.21.1" = _EhqmCxZC;
        "pkg-1.1.16-1.21.1" = _1JgZFyLH;
        "pkg-1.0.11-1.20.1" = _VzBWQasE;
        "pkg-1.0.12-1.20.1" = _yEQVNdkv;
        "pkg-1.0.13-1.20.1" = _WPbyxh6c;
        "pkg-1.1.17-1.21.1" = _Gpwsword;
        "pkg-1.0.14-1.20.1" = _zZYiwbv1;
        "pkg-1.1.18-1.21.1" = _ezakbQqZ;
        "pkg-1.2.0-1.21.1" = _f48bVTCH;
        "pkg-1.2.1-1.21.1" = _PieXT66H;
        "pkg-1.1.0-1.20.1" = _ZcWOIA3x;
        "pkg-1.1.1-1.20.1" = _LEYZt6WO;
        "pkg-1.2.2-1.21.1" = _bWLb9RJ5;
        "pkg-1.2.3-1.21.1" = _fLgjIyHO;
        "pkg-1.1.2-1.20.1" = _EcqpQguM;
        "pkg-1.2.4-1.21.1" = _hnv06bn1;
        "pkg-1.2.5-1.21.1" = _f5galYPR;
        "pkg-1.1.3-1.20.1" = _W1lsN21E;
        "pkg-1.1.4-1.20.1" = _p6vLdRmB;
        "pkg-1.3.0-1.21.1" = _Qi5k4qWd;
        "pkg-1.4.0-1.21.1" = _Ffc5FAuR;
        "pkg-1.2.0-1.20.1" = _ihSWYubU;
        "pkg-1.2.1-1.20.1" = _7MY4DfSr;
        "pkg-1.2.2-1.20.1" = _Bk2srEEX;
        "pkg-1.4.1-1.21.1" = _fSupvoR7;
        "pkg-1.4.2-1.21.1" = _ZnHyaurT;
        "pkg-1.2.3-1.20.1" = _9K0MHThV;
        "pkg-1.4.3-1.21.1" = _jBJRjy3p;
        "pkg-1.2.4-1.20.1" = _D6NMbGxg;
        "pkg-1.2.5-1.20.1" = _MV2BDFKm;
        "pkg-1.4.4-1.21.1" = _uhJWnfQj;
        "pkg-1.2.6-1.20.1" = _e8x5PEQ4;
        "pkg-1.4.5-1.21.1" = _lmLo5Zla;
        "pkg-1.2.7-1.20.1" = _orFPvySe;
        "pkg-1.4.6-1.21.1" = _rMWbdQC2;
        "pkg-1.5.0-1.21.1" = _Q2Mnjlqk;
        "pkg-1.5.1-1.21.1" = _CIoekA6D;
        "pkg-1.5.2-1.21.1" = _DZnuqMJf;
        "pkg-1.5.3-1.21.1" = _qKd3YpfS;
        "pkg-1.2.8-1.20.1" = _YlZomP9h;
        "pkg-1.2.9-1.20.1" = _qNa3fXBB;
        "pkg-1.6.0-1.21.1" = _Uw4N3dTu;
        "pkg-1.6.1-1.21.1" = _VT36z30L;
        "pkg-1.6.2-1.21.1" = _WIKkDJ1t;
        "pkg-1.6.3-1.21.1" = _qXGSTRtb;
        "pkg-1.3.0-1.20.1" = _qU2nXufR;
        "pkg-1.3.1-1.20.1" = _PA9ZJZj5;
        "pkg-1.3.2-1.20.1" = _uqZn9w5C;
        "pkg-1.6.4-1.21.1" = _Enr2tSOH;
        "pkg-1.6.6-1.21.1" = _F9Ubz2tC;
        "pkg-1.6.7-1.21.1" = _SmaK2tYA;
        "pkg-1.6.8-1.21.1" = _Q96kd7Uy;
        "pkg-1.6.9-1.21.1" = _dAIGNknN;
        "pkg-1.6.10-1.21.1" = _hsQjcNSg;
        "pkg-1.3.3-1.20.1" = _f2OYu3vU;
        "pkg-1.3.4-1.20.1" = _aZXW4DmN;
        "pkg-1.6.11-1.21.1" = _lHSZ2gYI;
        "pkg-1.3.5-1.20.1" = _QwEY7zEa;
        "pkg-26.1.0-alpha" = _ptFKOilO;
        "pkg-26.1.1-alpha" = _AwNNq7Ok;
        "pkg-26.1.2-alpha" = _Bu7MARza;
        "pkg-26.1.3-alpha" = _vhAjRCqa;
