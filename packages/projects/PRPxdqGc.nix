...
let
    versions = (let
        ...
        _JcNrazPD = {
            "id" = "JcNrazPD";
            "file" = "ESU-bukkit-1.1.0-dev-41.jar";
            "hash" = "sha512-b16JUpZksMMKl9Xpp9OXpQLeQyWnqEY46tbECc+18DvMISp9gCYR0JMJPytnl8mZ/Yrrdw3Fh/pCCvEWK8CkNw==";
        };
        _fngYdiTf = {
            "id" = "fngYdiTf";
            "file" = "ESU-velocity-1.1.0-dev-41.jar";
            "hash" = "sha512-p/iSe5UGyW6gHZO6k9DF6FbnGflvZqiR41O45bykRBdUi05pto4qG75+mTB7DYuZD5izxIUg/i9mAK4XdB3v2Q==";
        };
        _6403PBaq = {
            "id" = "6403PBaq";
            "file" = "ESU-velocity-1.1.0-dev-42.jar";
            "hash" = "sha512-lhfiwoS84Hts2V6/IfXThL8JCBQ/UjzxmNDf8xuyYdihk4EsUkfbI9rowoT7fU30qL6qbZLfgcolPoCoE/QKKg==";
        };
        _U2dm2hQn = {
            "id" = "U2dm2hQn";
            "file" = "ESU-bukkit-1.1.0-dev-42.jar";
            "hash" = "sha512-qLpUXoIgOG/hwlAzlGpmvx4ToMNvnSxl3Zx2EPQZlTKR2DvujvRSLu4pQ24bA5xSMR9sPTEbVIUZfX/THTNbzw==";
        };
        _g7BYC5F0 = {
            "id" = "g7BYC5F0";
            "file" = "ESU-velocity-1.1.0-dev-43.jar";
            "hash" = "sha512-Cy5J2pIn8rEE06G9vOqy2VfM1yCLjiQZMd2S/0XMXD8X64j7YofF5xC/QG68gOj9iwEe+NBpiqB8f3eTbdlqtg==";
        };
        _3YM2hI1N = {
            "id" = "3YM2hI1N";
            "file" = "ESU-bukkit-1.1.0-dev-43.jar";
            "hash" = "sha512-jyEPtZGpZqnEmKc1fQnH35AwrpV+5TSNpsVTZpJiE7DQzKtZz7wcXtyvhT3zr8xcN5DKcBCnut++WtEz5I19KQ==";
        };
        _XJOo4h9W = {
            "id" = "XJOo4h9W";
            "file" = "ESU-velocity-1.1.0-dev-44.jar";
            "hash" = "sha512-DDVDfTiDUr0wRt1WQPtg2k6YLwcdOE5WcEUi3GxcIEz3jy5is1Y6L4Cm+9Smr3Km1T44X+NPHpBjJJTXslh0Dg==";
        };
        _FCXDjr8x = {
            "id" = "FCXDjr8x";
            "file" = "ESU-bukkit-1.1.0-dev-44.jar";
            "hash" = "sha512-UjRgL0rplBd5TvhOvAn1EKI40kkNkyBSYH5xMfk/WHzVxErZdIy20Q51Qckkr9+v53F43GA5GcqnArLsKU6BFw==";
        };
        _XkqtNkSg = {
            "id" = "XkqtNkSg";
            "file" = "ESU-velocity-1.1.0-dev-45.jar";
            "hash" = "sha512-NfVIy0a6Lqlh7vGYzmc7nv4DlF0wR5M7RBERkWZh1yFP8NSi4JZGuGtSG/md6SqPVP8cNoekC/m5XWg030+New==";
        };
        _Yi7VlkNL = {
            "id" = "Yi7VlkNL";
            "file" = "ESU-bukkit-1.1.0-dev-45.jar";
            "hash" = "sha512-b9mdP/dAr/trWt5PCeg70cKsaiYO5QGZUKM52bO/gwCfN0sqjv1yv4zbNSZfNqeEMRV/yBYMG7TlMJjLhSbTWQ==";
        };
        _h5caVrLt = {
            "id" = "h5caVrLt";
            "file" = "ESU-velocity-1.1.0-dev-46.jar";
            "hash" = "sha512-MHQk5CbG6Wjb7Ie9cskFxquGSQSr7a8YTqcJta7svOWKv2nTScmuT7MOFgoIr6qfI+9P9z5KU1b/HET77oPHuA==";
        };
        _TkYvdYDN = {
            "id" = "TkYvdYDN";
            "file" = "ESU-bukkit-1.1.0-dev-46.jar";
            "hash" = "sha512-4ENE4yz7WiXL5M6FSqn11cvrC0s3tsoSDV2ca63dfemWrKDOwVzTOhdISGJs+QDVIqI/UxCPZiCG3sR/oTCuEA==";
        };
        _C4Zh1jXx = {
            "id" = "C4Zh1jXx";
            "file" = "ESU-velocity-1.1.0-dev-49.jar";
            "hash" = "sha512-w+geir3FpyHazN13IO/eT2EhFCJaPSrd6kn3/WZNimja+KHGkS3adx4su6WFqX4VCsQOaMcidxVZHaVSiHq+8w==";
        };
        _d89C9EF8 = {
            "id" = "d89C9EF8";
            "file" = "ESU-bukkit-1.1.0-dev-49.jar";
            "hash" = "sha512-QmK8sV67Xr3wumLeEcVRtMix2i5trYeFKJj5dzljZVroEDjR48ATV3V1rIQXGEp3cN0EJ5qlFsoC5QucnMo/uQ==";
        };
        _HwT42MUY = {
            "id" = "HwT42MUY";
            "file" = "ESU-velocity-1.1.0.jar";
            "hash" = "sha512-YKpQjd4TIdQYefYLM6ZALqiDAdWEjn1gbQ4L6iwZ5oTBR5BCjUkWCvWLIreBpXdUhAb6GvBU4HAaegKS6xRy+Q==";
        };
        _B413Gy6Q = {
            "id" = "B413Gy6Q";
            "file" = "ESU-bukkit-1.1.0.jar";
            "hash" = "sha512-mbj3zkMrNrAgofGlkifa+f5gs9ZeOD8pioeeaKbvmlg4J2oQgYp6qTKjIOujijl8y87eJpv+q/GF3k3WrL5CJw==";
        };
        _uogcfhrY = {
            "id" = "uogcfhrY";
            "file" = "ESU-velocity-1.1.1-dev-3.jar";
            "hash" = "sha512-+DiDSQGck1JI1xZV6duQ+SWYbgYLLR/69MtQmqQsMofmcXcFLfABZwvslAx8Jsp55hKOWs3iZYg0csRb4vaVfA==";
        };
        _T3YeEhA9 = {
            "id" = "T3YeEhA9";
            "file" = "ESU-bukkit-1.1.1-dev-3.jar";
            "hash" = "sha512-UuXHZQHcf/oMNY3eBgIl6i30LckLKkVky5+UJZzWuV6yTpdQ8LF8j59/OijMKNh1pZ6lXOcSM1Xw6dUR8c6eBw==";
        };
        _56HCdzZo = {
            "id" = "56HCdzZo";
            "file" = "ESU-velocity-1.1.1-dev-4.jar";
            "hash" = "sha512-jp8SXRec3wDEc3jPnsDGKfsNSGX3otLIJRVw7u5QuvhbKXemfgAti+30scwELZnsxHUJ1s/9ORj1i8XEU0k4eQ==";
        };
        _dmp3Iqdp = {
            "id" = "dmp3Iqdp";
            "file" = "ESU-bukkit-1.1.1-dev-4.jar";
            "hash" = "sha512-XXNfwuTR0j52qivJM2bMEpzD2ThVj3AyAleQbP93u1CCgQjKxwKx4cW1lcmHRI2/3vwfvXx6gLq/PRGO6FNkWQ==";
        };
        _S0sTEXsG = {
            "id" = "S0sTEXsG";
            "file" = "ESU-velocity-1.1.1-dev-10.jar";
            "hash" = "sha512-7s48jYmKmK9oBuFjCZEkjWUQbe9W/Rd3rpyQNicwG5rD5rfdW4GWd5xnWuF4xDXBVqZnDQ/iVTVGnG+JC4JxrQ==";
        };
        _JqkUnuSj = {
            "id" = "JqkUnuSj";
            "file" = "ESU-bukkit-1.1.1-dev-10.jar";
            "hash" = "sha512-6VaEu8GAy/E8gmYQoeFbgVyFrPXXHZZduuE6J0wajjhW3xIJH5Ix9XoeTpcQmuaMc+qJIuMBnrPsn4XiGKoknQ==";
        };
        _PtlapNS6 = {
            "id" = "PtlapNS6";
            "file" = "ESU-bukkit-1.1.1-dev-11.jar";
            "hash" = "sha512-4neXeWSB/Y0cSySeoukSgNPrgsvZKx/Dn0LusX1Bq/lpzUvjz2Eli/FHCV3AgfFFdV8O/Rq2Mi3MqyE4BEI/BQ==";
        };
        _tbHlXWpj = {
            "id" = "tbHlXWpj";
            "file" = "ESU-velocity-1.1.1-dev-11.jar";
            "hash" = "sha512-I8l8eGXefPXeFYtjCE0ZX0YnBJ0MXYdoqQgRGpiGOB+TIbxgvDOdrVLIg/xkcOeGp5i7hwcimk71WVrJke/QVw==";
        };
        _1c0ktP3g = {
            "id" = "1c0ktP3g";
            "file" = "ESU-velocity-1.1.1-dev-13.jar";
            "hash" = "sha512-R+AjdvYJhIrzxi1qu4lrEKgyUE/4Ej/TGLUmTuIcVmXSwy235Q3kgebOBgUn+AfJ7t2R6RtW1JUw91wNXtAatg==";
        };
        _AZzE5stP = {
            "id" = "AZzE5stP";
            "file" = "ESU-bukkit-1.1.1-dev-13.jar";
            "hash" = "sha512-Lw28D/0TXXymxg5IxWwPktAblgdHPCkYZSJ2+4pxsuNZFf/hpCcw+a0X7PwRhemnvs7gC80WvA9yVGiOCHmj6A==";
        };
    in {
        "o3F2BOpW" = _o3F2BOpW;
        "vEBc4eGQ" = _vEBc4eGQ;
        ...
        "1c0ktP3g" = _1c0ktP3g;
        "AZzE5stP" = _AZzE5stP;
        "folia-1.20" = _AZzE5stP;
        "folia-1.20.1" = _AZzE5stP;
        "folia-1.20.2" = _AZzE5stP;
        "folia-1.20.3" = _AZzE5stP;
        "folia-1.20.4" = _AZzE5stP;
        "folia-1.20.5" = _AZzE5stP;
        "folia-1.20.6" = _AZzE5stP;
        "folia-1.21" = _AZzE5stP;
        "folia-1.21.1" = _AZzE5stP;
        "folia-1.21.2" = _AZzE5stP;
        "folia-1.21.3" = _AZzE5stP;
        "folia-1.21.4" = _AZzE5stP;
        "folia-1.21.5" = _AZzE5stP;
        "folia-1.21.6" = _AZzE5stP;
        "folia-1.21.7" = _AZzE5stP;
        "folia-1.21.8" = _AZzE5stP;
        "folia-1.16.5" = _JcWxcla8;
        "folia-1.17.1" = _AZzE5stP;
        "folia-1.18.2" = _AZzE5stP;
        "folia-1.19.4" = _AZzE5stP;
        "folia-1.21.9" = _AZzE5stP;
        "folia-1.21.10" = _AZzE5stP;
        "folia-1.21.11" = _AZzE5stP;
        "folia-26.1" = _AZzE5stP;
        "folia-26.1.1" = _AZzE5stP;
        "folia-26.1.2" = _AZzE5stP;
        "folia-26.2" = _AZzE5stP;
        "paper-1.20" = _AZzE5stP;
        "paper-1.20.1" = _AZzE5stP;
        "paper-1.20.2" = _AZzE5stP;
        "paper-1.20.3" = _AZzE5stP;
        "paper-1.20.4" = _AZzE5stP;
        "paper-1.20.5" = _AZzE5stP;
        "paper-1.20.6" = _AZzE5stP;
        "paper-1.21" = _AZzE5stP;
        "paper-1.21.1" = _AZzE5stP;
        "paper-1.21.2" = _AZzE5stP;
        "paper-1.21.3" = _AZzE5stP;
        "paper-1.21.4" = _AZzE5stP;
        "paper-1.21.5" = _AZzE5stP;
        "paper-1.21.6" = _AZzE5stP;
        "paper-1.21.7" = _AZzE5stP;
        "paper-1.21.8" = _AZzE5stP;
        "paper-1.16.5" = _JcWxcla8;
        "paper-1.17.1" = _AZzE5stP;
        "paper-1.18.2" = _AZzE5stP;
        "paper-1.19.4" = _AZzE5stP;
        "paper-1.21.9" = _AZzE5stP;
        "paper-1.21.10" = _AZzE5stP;
        "paper-1.21.11" = _AZzE5stP;
        "paper-26.1" = _AZzE5stP;
        "paper-26.1.1" = _AZzE5stP;
        "paper-26.1.2" = _AZzE5stP;
        "paper-26.2" = _AZzE5stP;
        "purpur-1.20" = _AZzE5stP;
        "purpur-1.20.1" = _AZzE5stP;
        "purpur-1.20.2" = _AZzE5stP;
        "purpur-1.20.3" = _AZzE5stP;
        "purpur-1.20.4" = _AZzE5stP;
        "purpur-1.20.5" = _AZzE5stP;
        "purpur-1.20.6" = _AZzE5stP;
        "purpur-1.21" = _AZzE5stP;
        "purpur-1.21.1" = _AZzE5stP;
        "purpur-1.21.2" = _AZzE5stP;
        "purpur-1.21.3" = _AZzE5stP;
        "purpur-1.21.4" = _AZzE5stP;
        "purpur-1.21.5" = _AZzE5stP;
        "purpur-1.21.6" = _AZzE5stP;
        "purpur-1.21.7" = _AZzE5stP;
        "purpur-1.21.8" = _AZzE5stP;
        "purpur-1.16.5" = _JcWxcla8;
        "purpur-1.17.1" = _AZzE5stP;
        "purpur-1.18.2" = _AZzE5stP;
        "purpur-1.19.4" = _AZzE5stP;
        "purpur-1.21.9" = _AZzE5stP;
        "purpur-1.21.10" = _AZzE5stP;
        "purpur-1.21.11" = _AZzE5stP;
        "purpur-26.1" = _AZzE5stP;
        "purpur-26.1.1" = _AZzE5stP;
        "purpur-26.1.2" = _AZzE5stP;
        "purpur-26.2" = _AZzE5stP;
        "velocity-1.21.5" = _1c0ktP3g;
        "velocity-1.21.7" = _1c0ktP3g;
        "velocity-1.21.8" = _1c0ktP3g;
        "velocity-1.16.5" = _sPsIbjeV;
        "velocity-1.17.1" = _1c0ktP3g;
        "velocity-1.18.2" = _1c0ktP3g;
        "velocity-1.19.4" = _1c0ktP3g;
        "velocity-1.20" = _1c0ktP3g;
        "velocity-1.20.1" = _1c0ktP3g;
        "velocity-1.20.2" = _1c0ktP3g;
        "velocity-1.20.3" = _1c0ktP3g;
        "velocity-1.20.4" = _1c0ktP3g;
        "velocity-1.20.5" = _1c0ktP3g;
        "velocity-1.20.6" = _1c0ktP3g;
        "velocity-1.21" = _1c0ktP3g;
        "velocity-1.21.1" = _1c0ktP3g;
        "velocity-1.21.2" = _1c0ktP3g;
        "velocity-1.21.3" = _1c0ktP3g;
        "velocity-1.21.4" = _1c0ktP3g;
        "velocity-1.21.6" = _1c0ktP3g;
        "velocity-1.21.9" = _1c0ktP3g;
        "velocity-1.21.10" = _1c0ktP3g;
        "velocity-1.21.11" = _1c0ktP3g;
        "velocity-26.1" = _1c0ktP3g;
        "velocity-26.1.1" = _1c0ktP3g;
        "velocity-26.1.2" = _1c0ktP3g;
        "velocity-26.2" = _1c0ktP3g;
        "bukkit-1.16.5" = _JcWxcla8;
        "bukkit-1.17.1" = _AZzE5stP;
        "bukkit-1.18.2" = _AZzE5stP;
        "bukkit-1.19.4" = _AZzE5stP;
        "bukkit-1.20" = _AZzE5stP;
        "bukkit-1.20.1" = _AZzE5stP;
        "bukkit-1.20.2" = _AZzE5stP;
        "bukkit-1.20.3" = _AZzE5stP;
        "bukkit-1.20.4" = _AZzE5stP;
        "bukkit-1.20.5" = _AZzE5stP;
        "bukkit-1.20.6" = _AZzE5stP;
        "bukkit-1.21" = _AZzE5stP;
        "bukkit-1.21.1" = _AZzE5stP;
        "bukkit-1.21.2" = _AZzE5stP;
        "bukkit-1.21.3" = _AZzE5stP;
        "bukkit-1.21.4" = _AZzE5stP;
        "bukkit-1.21.5" = _AZzE5stP;
        "bukkit-1.21.6" = _AZzE5stP;
        "bukkit-1.21.7" = _AZzE5stP;
        "bukkit-1.21.8" = _AZzE5stP;
        "bukkit-1.21.9" = _AZzE5stP;
        "bukkit-1.21.10" = _AZzE5stP;
        "bukkit-1.21.11" = _AZzE5stP;
        "bukkit-26.1" = _AZzE5stP;
        "bukkit-26.1.1" = _AZzE5stP;
        "bukkit-26.1.2" = _AZzE5stP;
        "bukkit-26.2" = _AZzE5stP;
        "spigot-1.16.5" = _JcWxcla8;
        "spigot-1.17.1" = _AZzE5stP;
        "spigot-1.18.2" = _AZzE5stP;
        "spigot-1.19.4" = _AZzE5stP;
        "spigot-1.20" = _AZzE5stP;
        "spigot-1.20.1" = _AZzE5stP;
        "spigot-1.20.2" = _AZzE5stP;
        "spigot-1.20.3" = _AZzE5stP;
        "spigot-1.20.4" = _AZzE5stP;
        "spigot-1.20.5" = _AZzE5stP;
        "spigot-1.20.6" = _AZzE5stP;
        "spigot-1.21" = _AZzE5stP;
        "spigot-1.21.1" = _AZzE5stP;
        "spigot-1.21.2" = _AZzE5stP;
        "spigot-1.21.3" = _AZzE5stP;
        "spigot-1.21.4" = _AZzE5stP;
        "spigot-1.21.5" = _AZzE5stP;
        "spigot-1.21.6" = _AZzE5stP;
        "spigot-1.21.7" = _AZzE5stP;
        "spigot-1.21.8" = _AZzE5stP;
        "spigot-1.21.9" = _AZzE5stP;
        "spigot-1.21.10" = _AZzE5stP;
        "spigot-1.21.11" = _AZzE5stP;
        "spigot-26.1" = _AZzE5stP;
        "spigot-26.1.1" = _AZzE5stP;
        "spigot-26.1.2" = _AZzE5stP;
        "spigot-26.2" = _AZzE5stP;
        "pkg-0.4.0" = _vEBc4eGQ;
        "pkg-0.5.0" = _3vGRCOq4;
        "pkg-0.5.1" = _MIy9XTX8;
        "pkg-0.6.0" = _ZnkPuxMC;
        ...
        "pkg-0.9.1" = _7uZdjEtB;
        "pkg-0.9.2" = _Ah2rPcyQ;
        "pkg-0.9.3-SNAPSHOT-b11" = _fblKZp8b;
        "pkg-0.9.3-SNAPSHOT-b27" = _jUbDqVmn;
        "pkg-0.9.3-SNAPSHOT-30" = _yeFQ0sD8;
        "pkg-0.9.3-SNAPSHOT-34" = _gqvfLtH6;
        "pkg-0.9.3-SNAPSHOT-35" = _f52u611I;
        "pkg-0.9.3-SNAPSHOT-36" = _qrWA0XiL;
        "pkg-0.9.3-SNAPSHOT-37" = _50nCl5bB;
        "pkg-0.9.3-SNAPSHOT-38" = _6fQSidML;
        "pkg-0.9.3-SNAPSHOT-39" = _t5RYOWuK;
        "pkg-0.9.3-SNAPSHOT-42" = _Wq2qFgtq;
        "pkg-0.9.3-SNAPSHOT-43" = _EOoEXu9d;
        "pkg-0.9.3-SNAPSHOT-44" = _WNadvv2s;
        "pkg-0.9.3-SNAPSHOT-46" = _GFHsi6wS;
        "pkg-0.9.3-SNAPSHOT-47" = _w10t40jC;
        "pkg-0.9.3-SNAPSHOT-50" = _zQJpw1ID;
        "pkg-0.9.3-SNAPSHOT-51" = _dDiXi1hH;
        "pkg-0.9.3-SNAPSHOT-52" = _4ao6lZOv;
        "pkg-0.9.3-SNAPSHOT-53" = _trcq2LOA;
        "pkg-0.9.3-SNAPSHOT-54" = _A0UhrkEj;
        "pkg-0.9.3-SNAPSHOT-57" = _ZYGD9CDh;
        "pkg-0.9.3-SNAPSHOT-59" = _bmjE5pea;
        "pkg-0.9.3-SNAPSHOT-60" = _ky5gorsn;
        "pkg-0.9.3-SNAPSHOT-62" = _xPpyx0IT;
        "pkg-0.9.3-SNAPSHOT-63" = _ajpnSoRT;
        "pkg-0.9.3-SNAPSHOT-65" = _eqDS2FNU;
        "pkg-0.9.3-SNAPSHOT-68" = _HhsF0lOR;
        "pkg-0.9.3-SNAPSHOT-69" = _qQCYShVJ;
        "pkg-0.9.3-SNAPSHOT-70" = _pRIZnJ7q;
        "pkg-0.9.3-SNAPSHOT-71" = _tdaHUvmk;
        "pkg-0.9.3-SNAPSHOT-73" = _hPBfqnIz;
        "pkg-0.9.3-SNAPSHOT-74" = _6lehNCHL;
        "pkg-0.10.0" = _rJxZydQ4;
        "pkg-0.10.1-dev-8" = _laQfF2AD;
        "pkg-0.10.1-dev-9" = _xAl1tL9o;
        "pkg-0.10.1-dev-10" = _xnmLiDaR;
        "pkg-0.10.1-dev-11" = _SZFuOUdL;
        "pkg-0.10.1-dev-14" = _gCaWfmJh;
        "pkg-0.10.1-dev-15" = _2BvGj1I5;
        "pkg-0.10.1-dev-16" = _rSlOm9L9;
        "pkg-0.10.1-dev-17" = _kMvLAq8A;
        "pkg-0.10.1-dev-19" = _mjbJA0AR;
        "pkg-0.10.1-dev-20" = _rzzfrif0;
        "pkg-0.10.1-dev-21" = _nZPZcR2Q;
        "pkg-0.10.1-dev-32" = _1YVXisxT;
        "pkg-0.10.1-dev-33" = _mJIUaoWr;
        "pkg-0.10.1-dev-34" = _dyaY5Gbv;
        "pkg-0.10.1-dev-35" = _elshmKyn;
        "pkg-0.10.1-dev-36" = _Cft3PlC5;
        "pkg-0.10.1-dev-37" = _CKMAQReC;
        "pkg-0.10.1-dev-38" = _8ALNOFk8;
        "pkg-0.10.1-dev-39" = _rxmaa1ng;
        "pkg-0.10.1-dev-40" = _Zl0s7mn5;
        "pkg-0.10.1-dev-41" = _Q9NtyJSU;
        "pkg-0.10.1-dev-42" = _hmbRILoA;
        "pkg-0.10.1-dev-43" = _gXwGpdOb;
        "pkg-0.10.1-dev-44" = _ZpohUMmB;
        "pkg-0.10.1-dev-46" = _ipw3rYB3;
        "pkg-0.10.1-dev-47" = _7XumMASc;
        "pkg-0.10.1-dev-48" = _R0RHsJa2;
        "pkg-0.10.1" = _nyMHbSoj;
        "pkg-0.10.2-dev-4" = _OxNgLXGB;
        "pkg-0.10.2-dev-5" = _tJxArhTP;
        "pkg-0.10.2-dev-7" = _fymivWO5;
        "pkg-0.10.2-dev-8" = _sgoZW5GO;
        "pkg-0.10.2-dev-9" = _gY2a29lM;
        "pkg-0.10.2-dev-13" = _ZhlVb5nm;
        "pkg-0.10.2-dev-14" = _RY7rUWFT;
        "pkg-0.10.2-dev-15" = _VRQMopna;
        "pkg-0.10.2" = _ktpPjBVy;
        "pkg-0.10.3-dev-2" = _CJFomyCl;
        "pkg-0.10.3-dev-4" = _E5HFbcNK;
        "pkg-0.10.3-dev-5" = _KgzplfQp;
        "pkg-0.10.3-dev-8" = _f2zkxvbq;
        "pkg-0.10.3-dev-10" = _mPqfaw9A;
        "pkg-0.10.3-dev-13" = _xp8DD1lz;
        "pkg-0.10.3-dev-14" = _geu5wIqb;
        "pkg-0.10.3-dev-15" = _VVSgswg7;
        "pkg-0.10.3-dev-17" = _2HhlWpuy;
        "pkg-0.10.3-dev-18" = _NmIIhutx;
        "pkg-0.10.3-dev-19" = _wAkCRunW;
        "pkg-0.10.3-dev-20" = _a5awJjMw;
        "pkg-0.10.3-dev-21" = _WyU1O3BI;
        "pkg-0.10.3-dev-22" = _xUEj2eAD;
        "pkg-0.10.3-dev-24" = _8tXA0h3b;
        "pkg-0.10.3-dev-25" = _nxOylMQ6;
        "pkg-0.10.3-dev-26" = _vbxE26Fc;
        "pkg-0.10.3-dev-28" = _MrzNkQ0D;
        "pkg-0.10.3-dev-34" = _uHonabX4;
        "pkg-0.10.3-dev-35" = _NJuMza1g;
        "pkg-0.10.3-dev-36" = _UpCPP2qv;
        "pkg-0.10.3-dev-37" = _aK1xPeSt;
        "pkg-0.10.3-dev-38" = _MJI8v48B;
        "pkg-0.10.3-dev-39" = _BBi752ti;
        "pkg-0.10.3-dev-40" = _zNDLBmtg;
        "pkg-0.10.3-dev-41" = _wGMFQLUc;
        "pkg-0.10.3-dev-42" = _7XCkB6zl;
        "pkg-0.10.3-dev-43" = _gRHDdRjQ;
        "pkg-0.10.3-dev-44" = _dtfSgvtx;
        "pkg-0.10.3-dev-45" = _9Trl8S1Y;
        "pkg-0.10.3-dev-47" = _HuhznJgr;
        "pkg-0.10.3-dev-48" = _BOlU07Vj;
        "pkg-0.11.0" = _G8B4LElv;
        "pkg-0.11.1-dev-2" = _VyjNT9vE;
        "pkg-0.11.1-dev-3" = _3rJshoBU;
        "pkg-0.11.1-dev-4" = _c4wolaDf;
        "pkg-0.11.1-dev-6" = _3EyANKJj;
        "pkg-0.11.1-dev-7" = _iRgmQaNh;
        "pkg-0.11.1-dev-9" = _oIyt8gKO;
        "pkg-0.11.1-dev-10" = _Kre5GuVH;
        "pkg-0.11.1-dev-11" = _rPdujVae;
        "pkg-0.11.1" = _gn8jQtQE;
        "pkg-0.11.2-dev-2" = _SwhgmATk;
        "pkg-0.11.2-dev-3" = _RgkR0hqk;
        "pkg-0.11.2-dev-5" = _Ixw8mGbm;
        "pkg-0.11.2-dev-8" = _d5JaAFR3;
        "pkg-0.11.2-dev-10" = _urlGwoq5;
        "pkg-0.11.2-dev-11" = _uyQGuDkh;
        "pkg-0.11.2" = _OqlJrznf;
        "pkg-0.11.3-dev-3" = _DiLNCfix;
        "pkg-0.11.3-dev-4" = _FlOXdSNN;
        "pkg-0.11.3-dev-5" = _vdNigFci;
        "pkg-0.11.3-dev-6" = _rmBuyp6F;
        "pkg-0.11.3-dev-8" = _PTKKkiWw;
        "pkg-0.11.3-dev-9" = _m1E8cO6n;
        "pkg-0.11.3-dev-11" = _cyyxU51G;
        "pkg-0.11.3-dev-13" = _9h5CxEN5;
        "pkg-0.11.3-dev-14" = _6aqNEcGd;
        "pkg-0.11.3-dev-19" = _TP6NMAtJ;
        "pkg-0.11.3-dev-22" = _KpNhNcOj;
        "pkg-0.11.3-dev-23" = _il2qYhqb;
        "pkg-0.11.3-dev-24" = _8H3GzYo7;
        "pkg-0.11.3-dev-25" = _30MR2MTb;
        "pkg-0.11.3-dev-30" = _apUtvshO;
        "pkg-0.11.3-dev-34" = _xaueJTQ8;
        "pkg-0.11.3-dev-35" = _Jp7S4nro;
        "pkg-0.11.3-dev-36" = _5msKrjC6;
        "pkg-0.11.3-dev-38" = _bTZDLo9K;
        "pkg-0.11.3-dev-39" = _YgaCosd8;
        "pkg-0.11.3-dev-41" = _IJBdwuiJ;
        "pkg-0.11.3-dev-42" = _7wGWIWH0;
        "pkg-0.11.3-dev-43" = _wBQwehCe;
        "pkg-0.11.3-dev-44" = _GtlaFjBJ;
        "pkg-0.11.3-dev-45" = _7gA2KtS7;
        "pkg-0.11.3-dev-47" = _CDx9j9df;
        "pkg-0.11.3-dev-48" = _4A5T8lap;
        "pkg-0.11.3-dev-49" = _yvcFw1ZG;
        "pkg-0.11.3-dev-50" = _3Mgo9pwS;
        "pkg-0.11.3-dev-51" = _WUPsUzlr;
        "pkg-0.11.3-dev-53" = _OD2zSimc;
        "pkg-0.11.3-dev-54" = _x3Fc59wv;
        "pkg-0.11.3-dev-57" = _TnE9uqde;
        "pkg-0.11.3-dev-58" = _1ffll6ga;
        "pkg-0.11.3-dev-59" = _lbh09jz2;
        "pkg-0.11.3-dev-60" = _nWc1tp1J;
        "pkg-0.11.3-dev-61" = _uRqNrm4S;
        "pkg-0.11.3-dev-62" = _lOcqf3XD;
        "pkg-0.11.3-dev-65" = _awurPO12;
        "pkg-0.11.3-dev-66" = _s0bBXzNp;
        "pkg-0.11.3-dev-68" = _uVmosOze;
        "pkg-0.11.3-dev-69" = _d2lBPovi;
        "pkg-0.11.3-dev-71" = _3GwUNvax;
        "pkg-0.11.3-dev-72" = _oNfcFJ6M;
        "pkg-0.11.3-dev-73" = _g2dWgLCu;
        "pkg-0.11.3-dev-74" = _ROdp9jQ0;
        "pkg-0.12.0" = _z3sjHe77;
        "pkg-0.12.1-dev-2" = _1fxO8TLG;
        "pkg-0.12.1-dev-4" = _GW4wUlpE;
        "pkg-0.12.1-dev-7" = _x0pX05uv;
        "pkg-0.12.1-dev-10" = _zjuWEPxO;
        "pkg-0.12.1-dev-11" = _ttl3ShIO;
        "pkg-0.12.1-dev-12" = _p8ONnAlN;
        "pkg-0.12.1-dev-13" = _KFrpU7Ij;
        "pkg-0.12.1-dev-14" = _SQzKje2y;
        "pkg-0.12.1-dev-15" = _KWamoV4Y;
        "pkg-0.12.1-dev-16" = _pt1CvcRn;
        "pkg-0.12.1-dev-17" = _sZycb2nD;
        "pkg-0.12.1-dev-18" = _SC5i38K6;
        "pkg-0.12.1-dev-19" = _oR69SoOi;
        "pkg-0.12.1-dev-20" = _jC2VjGKo;
        "pkg-0.12.1-dev-21" = _rygGJKG8;
        "pkg-0.12.1-dev-22" = _IYtQR6lD;
        "pkg-0.12.1-dev-23" = _j5P6LSrO;
        "pkg-0.12.1-dev-26" = _2XZaUcTS;
        "pkg-0.12.1-dev-27" = _lFrG0J8f;
        "pkg-0.12.1-dev-28" = _dhDVvufa;
        "pkg-0.12.1-dev-29" = _QQmRnzQJ;
        "pkg-0.12.1-dev-31" = _v1BvBzZK;
        "pkg-0.12.1-dev-32" = _enrebKPT;
        "pkg-0.12.1-dev-33" = _l2civ50h;
        "pkg-0.12.1-dev-34" = _DAT3cRpv;
        "pkg-0.12.1-dev-35" = _jVg0KjS2;
        "pkg-0.12.1-dev-36" = _BthsT7c7;
        "pkg-0.12.1-dev-37" = _7NMogG1n;
        "pkg-0.12.1-dev-38" = _UUdBVt7E;
        "pkg-0.12.1-dev-41" = _HuWMdu7X;
        "pkg-0.12.1-dev-42" = _IbjxgAo0;
        "pkg-0.12.1-dev-43" = _yJgiq0XZ;
        "pkg-0.12.1-dev-44" = _112ptmJU;
        "pkg-0.12.1-dev-46" = _zF7nzUUT;
        "pkg-0.12.1-dev-51" = _DINNJ9uY;
        "pkg-0.12.1-dev-52" = _iKNw35sn;
        "pkg-0.12.1-dev-53" = _GfmdPqEn;
        "pkg-0.12.1-dev-54" = _cY9FZUEF;
        "pkg-0.12.1-dev-55" = _glygeM0v;
        "pkg-0.12.1-dev-56" = _Wgf1oBFG;
        "pkg-0.12.1-dev-60" = _iwaNZWnd;
        "pkg-0.12.1-dev-61" = _b9XjiUXk;
        "pkg-0.12.1-dev-62" = _Emj7uvYj;
        "pkg-0.12.1-dev-63" = _IUpEF66m;
        "pkg-0.12.1-dev-65" = _rv3VOg26;
        "pkg-0.12.1-dev-66" = _L1iCrvRU;
        "pkg-0.12.1-dev-67" = _d8PvRjtx;
        "pkg-0.12.1-dev-68" = _RP3jBY9Z;
        "pkg-0.12.1-dev-69" = _UBzDXjJf;
        "pkg-0.12.1-dev-70" = _JMudAEiv;
        "pkg-0.12.1-dev-71" = _WBwtKYFj;
        "pkg-0.12.1-dev-72" = _Yx5GqRA9;
        "pkg-0.12.1-dev-73" = _ClXL9qLM;
        "pkg-0.12.1-dev-74" = _XJI4LlCS;
        "pkg-0.12.1-dev-76" = _6rcicslt;
        "pkg-0.12.1-dev-77" = _VeXaDna9;
        "pkg-0.12.1-dev-78" = _TdgVhSrU;
        "pkg-0.12.1" = _MLbPPYiw;
        "pkg-0.12.2-dev-3" = _lkKxHk8x;
        "pkg-0.12.2-dev-4" = _bR3HwLrn;
        "pkg-0.12.2-dev-6" = _coMr9iMS;
        "pkg-0.12.2" = _qqusX8KN;
        "pkg-0.12.3-dev-2" = _omduiv6v;
        "pkg-0.12.3-dev-3" = _llKQBLLn;
        "pkg-0.12.3-dev-4" = _hvbJWh2D;
        "pkg-0.12.3-dev-5" = _yTetQbxS;
        "pkg-0.12.3-dev-6" = _vyTePcqT;
        "pkg-0.12.3-dev-7" = _a5hrY2Id;
        "pkg-0.12.3-dev-8" = _mg1Zmtje;
        "pkg-0.12.3-dev-10" = _H2lvij4G;
        "pkg-0.12.3-dev-15" = _V6isjP4s;
        "pkg-0.12.3-dev-16" = _ydF1IkA9;
        "pkg-0.12.3-dev-17" = _OK5NL6DC;
        "pkg-0.12.3-dev-18" = _yfYOoxh1;
        "pkg-0.12.3-dev-19" = _szkSIj2Q;
        "pkg-0.12.3-dev-20" = _morsUQ5y;
        "pkg-0.12.3-dev-21" = _9ZncHr9J;
        "pkg-0.12.3-dev-22" = _iVqTHfhm;
        "pkg-0.12.3-dev-23" = _yVTeKDNU;
        "pkg-0.12.3-dev-24" = _9BrMmZYg;
        "pkg-0.12.3-dev-26" = _6149bO0k;
        "pkg-0.12.3-dev-27" = _hKEZmmlz;
        "pkg-0.12.3-dev-29" = _4b8mEHC5;
        "pkg-0.12.3-dev-30" = _FyxQ2guk;
        "pkg-0.12.3-dev-31" = _h3GemXDv;
        "pkg-0.12.3-dev-32" = _yrxF0FS1;
        "pkg-0.12.3-dev-33" = _qOJmjI2Q;
        "pkg-0.12.3-dev-34" = _jCfP14ey;
        "pkg-0.12.3-dev-36" = _rExK38km;
        "pkg-0.12.3-dev-38" = _3wu9ci1w;
        "pkg-0.12.3-dev-41" = _1hkZVXWL;
        "pkg-0.12.3-dev-42" = _ukCPvbRW;
        "pkg-0.12.3-dev-43" = _uO27ZGKo;
        "pkg-0.12.3-dev-46" = _GGHhXuqt;
        "pkg-0.12.3-dev-47" = _IlggSFlJ;
        "pkg-0.12.3-dev-49" = _dwqqKz7x;
        "pkg-0.12.3-dev-56" = _5CCab2ph;
        "pkg-0.12.3-dev-58" = _nFgi290R;
        "pkg-0.12.3-dev-59" = _2P1XDWao;
        "pkg-0.12.3-dev-60" = _IQgfhpvo;
        "pkg-0.12.3-dev-62" = _rgafozrG;
        "pkg-0.12.3-dev-66" = _Qt0GwB48;
        "pkg-0.12.3-dev-67" = _HmBNw9Y6;
        "pkg-0.12.3-dev-70" = _3nvW7VFy;
        "pkg-0.12.3-dev-71" = _3fjVKYrj;
        "pkg-0.12.3-dev-72" = _GWD6LKLY;
        "pkg-0.12.3-dev-73" = _m3iXMrKi;
        "pkg-0.12.3" = _5aA85VLb;
        "pkg-0.12.4-dev-3" = _XT4DNrMQ;
        "pkg-0.12.4-dev-4" = _I7QuBQwF;
        "pkg-0.12.4-dev-6" = _UjSucSEZ;
        "pkg-0.12.4-dev-7" = _xfG8aGs7;
        "pkg-0.12.4-dev-8" = _P1cvqOHz;
        "pkg-0.12.4-dev-9" = _kehP5GTF;
        "pkg-0.12.4-dev-10" = _Nhjjok2V;
        "pkg-0.12.4-dev-11" = _blKVVX4i;
        "pkg-0.12.4-dev-12" = _V9w6w2i2;
        "pkg-0.12.4-dev-13" = _S03NXT6C;
        "pkg-0.12.4-dev-14" = _9zSHFe5v;
        "pkg-0.12.4-dev-15" = _IB4LRSYa;
        "pkg-0.12.4-dev-16" = _ZFjUAalf;
        "pkg-0.12.4-dev-17" = _t4uLmfi9;
        "pkg-0.12.4-dev-18" = _viG2jBSO;
        "pkg-0.12.4-dev-19" = _krqY7MnY;
        "pkg-0.12.4-dev-20" = _SXoF0YFD;
        "pkg-0.12.4-dev-21" = _8jReuDc5;
        "pkg-0.12.4-dev-22" = _TaNGLMV6;
        "pkg-0.12.4-dev-23" = _16QQwTSQ;
        "pkg-0.12.4-dev-24" = _u3b09lZv;
        "pkg-0.12.4-dev-25" = _RTqcQN1g;
        "pkg-0.12.4-dev-26" = _hPr3hrsM;
        "pkg-0.12.4-dev-27" = _fDqoW5b5;
        "pkg-0.12.4-dev-28" = _71MkfE7Y;
        "pkg-0.12.4-dev-29" = _Ca0AcRxr;
        "pkg-0.12.4-dev-30" = _7SRGerxd;
        "pkg-0.12.4-dev-31" = _YwTG7Ute;
        "pkg-0.12.4-dev-32" = _Nb9Rt0qm;
        "pkg-0.12.4-dev-33" = _mJU5WoxT;
        "pkg-0.12.4-dev-34" = _xtNd34TB;
        "pkg-0.12.4-dev-35" = _cfGCAqQi;
        "pkg-0.12.4-dev-36" = _XZq7rYTw;
        "pkg-0.12.4-dev-37" = _IWay7noE;
        "pkg-0.12.4-dev-38" = _BkT913y4;
        "pkg-0.12.4-dev-39" = _FqyU4qAL;
        "pkg-0.12.4-dev-40" = _khS1s2Ij;
        "pkg-0.12.4-dev-41" = _gV3nN155;
        "pkg-0.12.4-dev-42" = _PBrAoxIB;
        "pkg-0.12.4-dev-43" = _iMRS5rpn;
        "pkg-0.12.4-dev-44" = _sfN5Yhbb;
        "pkg-0.12.4-dev-45" = _K8uF7EaV;
        "pkg-0.12.4-dev-46" = _VXedmdHM;
        "pkg-0.12.4-dev-47" = _99rlT7kX;
        "pkg-0.12.4-dev-48" = _MQC6HBj0;
        "pkg-0.12.4-dev-49" = _QjgHgye4;
        "pkg-0.12.4-dev-50" = _pZpck8QZ;
        "pkg-0.12.4-dev-51" = _VgYe19bo;
        "pkg-0.12.4-dev-52" = _jW2JDNzD;
        "pkg-0.12.4-dev-54" = _QjUsTjrh;
        "pkg-0.12.4-dev-56" = _n3kLw0pI;
        "pkg-0.12.4-dev-57" = _Rcaq7V60;
        "pkg-0.12.4-dev-58" = _BVLtQCwQ;
        "pkg-0.12.4-dev-59" = _voojV6d0;
        "pkg-0.12.4-dev-60" = _Ps2WZsRr;
        "pkg-0.12.4-dev-61" = _EGHFZBfN;
        "pkg-0.12.4-dev-63" = _2y4BSwSu;
        "pkg-0.12.4-dev-65" = _3CZ6fk6b;
        "pkg-0.12.4-dev-66" = _I6X5YTpq;
        "pkg-0.12.4-dev-67" = _SmOzFkAk;
        "pkg-0.12.4-dev-69" = _rJfnzFc1;
        "pkg-0.12.4-dev-70" = _jZCH4HG9;
        "pkg-0.12.4-dev-71" = _4bfdq2dA;
        "pkg-0.12.4-dev-72" = _XZUGNHAK;
        "pkg-0.12.4-dev-74" = _INQ60xnI;
        "pkg-0.12.4-dev-75" = _62I9YwuO;
        "pkg-0.12.4" = _s5CqVJWG;
        "pkg-0.12.5-dev-3" = _EiYurZAR;
        "pkg-0.12.5-dev-4" = _tNwHYENn;
        "pkg-0.12.5-dev-10" = _LgmYkYne;
        "pkg-0.12.5-dev-11" = _EPUf076I;
        "pkg-0.12.5-dev-12" = _xDFFde1C;
        "pkg-0.12.5-dev-13" = _Tg8hpm0H;
        "pkg-0.12.5-dev-14" = _3LS8H5rp;
        "pkg-0.12.5-dev-15" = _vzWIludY;
        "pkg-0.12.5-dev-16" = _I2P3rJWk;
        "pkg-0.12.5-dev-17" = _IWu0aoiq;
        "pkg-0.12.5-dev-18" = _FORx5hlU;
        "pkg-0.12.5-dev-19" = _hPtwKbli;
        "pkg-0.12.5-dev-20" = _KcIQSCep;
        "pkg-0.12.5-dev-21" = _u4uqU7h3;
        "pkg-0.12.5-dev-22" = _UQQuJsxR;
        "pkg-0.12.5-dev-24" = _FVO5sGVO;
        "pkg-0.12.5" = _QJhl5gQd;
        "pkg-0.12.6-dev-3" = _tQL0YwgV;
        "pkg-0.12.6-dev-4" = _NmDEsbTw;
        "pkg-0.12.6-dev-5" = _UcfOULGS;
        "pkg-0.12.6-dev-6" = _hFTgXehy;
        "pkg-0.12.6-dev-11" = _VYISkPUq;
        "pkg-0.12.6-dev-13" = _s9MMHPVx;
        "pkg-0.12.6-dev-14" = _MkoCHpoS;
        "pkg-0.12.6-dev-15" = _9eA2nvBH;
        "pkg-0.12.6-dev-16" = _7iCQ1PT9;
        "pkg-0.12.6-dev-17" = _L3MLCibK;
        "pkg-0.12.6-dev-18" = _tuRuHUxM;
        "pkg-0.12.6-dev-19" = _bQxiPCgt;
        "pkg-0.12.6-dev-21" = _ICT2EFZ7;
        "pkg-0.12.6-dev-22" = _H1yFzkh3;
        "pkg-0.12.6-dev-23" = _o5BzvQHY;
        "pkg-0.12.6-dev-27" = _fTOe0d5r;
        "pkg-0.12.6-dev-29" = _V2JZEFoo;
        "pkg-0.12.6-dev-31" = _bpHxM3Ln;
        "pkg-0.12.6-dev-32" = _eZAroiY3;
        "pkg-0.12.6-dev-33" = _nDeZppZo;
        "pkg-0.12.6-dev-34" = _QwL6iMzg;
        "pkg-0.12.6-dev-35" = _42dPUvOM;
        "pkg-0.12.6-dev-36" = _7bEPE0et;
        "pkg-0.12.6-dev-38" = _eAdb7vGN;
        "pkg-0.13.0" = _AevJYM8s;
        "pkg-0.13.1-dev-2" = _spyh15Ea;
        "pkg-0.13.1-dev-3" = _KnoNboYG;
        "pkg-0.13.1-dev-4" = _QY5II0Zu;
        "pkg-0.13.1-dev-5" = _xDDLIJwR;
        "pkg-0.13.1-dev-6" = _7w6YKzlj;
        "pkg-0.13.1-dev-7" = _DubPFEu6;
        "pkg-0.13.1-dev-8" = _hwoLWWa0;
        "pkg-0.13.1-dev-9" = _mvbTgiqk;
        "pkg-0.13.1-dev-10" = _NDEDtJao;
        "pkg-0.13.1-dev-11" = _du6na3Gx;
        "pkg-0.13.1-dev-12" = _iM4elXGe;
        "pkg-0.13.1-dev-17" = _h32rSmgD;
        "pkg-0.13.1-dev-18" = _4hNYz4P7;
        "pkg-0.13.1-dev-19" = _siVA863i;
        "pkg-0.13.1-dev-20" = _UmjFLZKJ;
        "pkg-0.13.1-dev-21" = _WyxhNpiq;
        "pkg-0.13.1-dev-22" = _fIAmkoY6;
        "pkg-0.13.1-dev-23" = _yI2UDHpO;
        "pkg-0.13.1-dev-24" = _c7hGnNPP;
        "pkg-0.13.1-dev-25" = _JSZkheDu;
        "pkg-0.13.1-dev-26" = _rWCPyis0;
        "pkg-0.13.1-dev-27" = _mCbUC3Xd;
        "pkg-0.13.1-dev-29" = _YRkGnqom;
        "pkg-0.13.1-dev-30" = _vE24sjjt;
        "pkg-0.13.1-dev-31" = _lAqxbmrN;
        "pkg-0.13.1-dev-32" = _A4IXKA2l;
        "pkg-0.13.1-dev-33" = _P1YY8NbT;
        "pkg-0.13.1-dev-34" = _Qvu89pUg;
        "pkg-0.13.1-dev-35" = _pHsjZ1Q1;
        "pkg-0.13.1-dev-36" = _UsydEZ1d;
        "pkg-0.13.1-dev-37" = _hsCSNhr7;
        "pkg-0.13.1-dev-38" = _woDphAkn;
        "pkg-0.13.1-dev-39" = _EUqDDOIR;
        "pkg-0.13.1-dev-40" = _7OqfCRPv;
        "pkg-0.13.1-dev-41" = _geZQ6pIj;
        "pkg-0.13.1-dev-42" = _OYvnWJV9;
        "pkg-0.13.1-dev-43" = _1d06HUcX;
        "pkg-0.13.1-dev-44" = _HCGIcGh7;
        "pkg-0.13.1-dev-45" = _h5ClNhWK;
        "pkg-0.13.1-dev-46" = _MwtVoEnB;
        "pkg-0.13.1-dev-47" = _JKpDKLGC;
        "pkg-0.13.1-dev-48" = _rQPntx7B;
        "pkg-0.13.1-dev-49" = _KzEhYnEi;
        "pkg-0.13.1-dev-50" = _DHQ7zXqr;
        "pkg-0.13.1-dev-51" = _1FYq4Ktw;
        "pkg-0.13.1-dev-52" = _BxuH2tCe;
        "pkg-0.13.1-dev-53" = _CH3MAhpc;
        "pkg-0.13.1-dev-54" = _m3hOfL18;
        "pkg-0.13.1-dev-55" = _wIdc5mcp;
        "pkg-0.13.1-dev-56" = _ogQA23S0;
        "pkg-0.13.1-dev-57" = _eEyI7iVa;
        "pkg-0.13.1-dev-58" = _eJIbx0mN;
        "pkg-0.13.1-dev-59" = _hawZO0tD;
        "pkg-0.13.1-dev-62" = _nqMIrpOZ;
        "pkg-0.13.1-dev-63" = _QCqBNJOr;
        "pkg-0.13.1-dev-64" = _rgjwH0Eq;
        "pkg-0.13.1-dev-65" = _bVlz9vVo;
        "pkg-0.13.1-dev-66" = _P8D1XhII;
        "pkg-0.13.1-dev-67" = _ehXPc5Zr;
        "pkg-0.13.1-dev-68" = _CzRCogVz;
        "pkg-0.13.1-dev-69" = _GCUGcCG9;
        "pkg-0.13.1-dev-70" = _pbuUMVup;
        "pkg-0.13.1-dev-71" = _ttQoVdJ5;
        "pkg-0.13.1-dev-72" = _aP9H9TFQ;
        "pkg-0.13.1-dev-73" = _6KBW2njz;
        "pkg-0.14.0" = _v5ZJG0PR;
        "pkg-0.14.1-dev-2" = _qUuFMABv;
        "pkg-0.14.1-dev-3" = _feQI1Zx5;
        "pkg-0.14.1-dev-4" = _Z8ZpYPNr;
        "pkg-0.14.1-dev-6" = _iY9c0Bvf;
        "pkg-0.14.1-dev-7" = _tGnkKkA0;
        "pkg-0.14.1-dev-8" = _2zZQRUgF;
        "pkg-0.14.1-dev-10" = _MRoEKAvE;
        "pkg-0.14.1-dev-11" = _pBpJaHsx;
        "pkg-0.14.1-dev-12" = _JXn5LqJM;
        "pkg-0.14.1-dev-13" = _X25o30bP;
        "pkg-0.14.1-dev-14" = _85nMC5v1;
        "pkg-0.14.1-dev-15" = _QbkOhICi;
        "pkg-0.14.1-dev-16" = _RjL3Noq2;
        "pkg-0.14.1-dev-17" = _wuyPVFa2;
        "pkg-0.14.1-dev-18" = _4fKcxP2q;
        "pkg-0.14.1-dev-19" = _2LGyJXjY;
        "pkg-0.14.1-dev-20" = _D6n3Kzg9;
        "pkg-0.14.1-dev-21" = _6QvOPNke;
        "pkg-0.14.1-dev-22" = _9LcYv8I5;
        "pkg-0.14.1-dev-23" = _aJKM5BnB;
        "pkg-0.14.1-dev-24" = _XImb6ar1;
        "pkg-0.14.1-dev-25" = _jwPwYdQo;
        "pkg-0.14.1-dev-26" = _PGME3si5;
        "pkg-0.14.1-dev-27" = _y70MdVPm;
        "pkg-0.14.1-dev-30" = _jKU1DJ3U;
        "pkg-0.14.1-dev-32" = _xhtR6gHd;
        "pkg-0.14.1-dev-33" = _54xRggcB;
        "pkg-0.14.1-dev-34" = _ed6huSpK;
        "pkg-0.14.1-dev-35" = _kIi9mGSM;
        "pkg-0.14.1-dev-36" = _RAvsbby8;
        "pkg-0.14.1-dev-37" = _rNNtKtbT;
        "pkg-0.14.1-dev-38" = _1ed7qtKY;
        "pkg-0.14.1-dev-39" = _f8MNbEqx;
        "pkg-0.14.1-dev-40" = _kOgWM984;
        "pkg-0.14.1" = _4OJIAagw;
        "pkg-0.14.2-dev-2" = _JOK2DyVh;
        "pkg-0.14.2-dev-3" = _ZBvtyx3Q;
        "pkg-0.14.2-dev-4" = _Mna6Damo;
        "pkg-0.14.2-dev-6" = _5UdOLrn0;
        "pkg-0.14.2-dev-7" = _sUHT94D1;
        "pkg-0.14.2-dev-8" = _UDVNsjiO;
        "pkg-0.14.2-dev-9" = _JyJmmHa2;
        "pkg-0.14.2-dev-10" = _MVO1Q2KB;
        "pkg-0.14.2-dev-11" = _i3JeQ02O;
        "pkg-0.14.2-dev-12" = _yGmyXyEq;
        "pkg-0.14.2-dev-13" = _5tmBDjiH;
        "pkg-0.14.2-dev-14" = _CnEAMpOY;
        "pkg-0.14.2-dev-15" = _uSyVxRBW;
        "pkg-0.14.2-dev-16" = _TsE0yNtm;
        "pkg-0.14.2-dev-17" = _o2jNBTOJ;
        "pkg-0.14.2-dev-19" = _Whqcjkcc;
        "pkg-0.14.2-dev-20" = _HT0aUsUq;
        "pkg-0.14.2-dev-21" = _Ltuqlj7e;
        "pkg-0.14.2-dev-22" = _y6q1BGHD;
        "pkg-0.14.2-dev-23" = _lv5foGgS;
        "pkg-0.14.2-dev-24" = _8sHyRg0O;
        "pkg-0.14.2-dev-25" = _Dz7HfR6y;
        "pkg-0.14.2-dev-26" = _WGVS4mr0;
        "pkg-0.14.2-dev-27" = _RuUIYEZM;
        "pkg-0.14.2-dev-28" = _ogeVsnbo;
        "pkg-0.14.2-dev-29" = _OLngGg8a;
        "pkg-0.14.2-dev-30" = _sE5Mjthr;
        "pkg-0.14.2-dev-31" = _fF7WGwIN;
        "pkg-0.14.2-dev-32" = _aawjkUPX;
        "pkg-0.14.2-dev-33" = _uxrsK0R0;
        "pkg-0.14.2-dev-34" = _GVr5tZaV;
        "pkg-0.14.2-dev-35" = _N9EDf1E1;
        "pkg-0.14.2-dev-36" = _IoyZVmdQ;
        "pkg-0.14.2-dev-37" = _Hkn78TpN;
        "pkg-0.14.2-dev-38" = _5fUEEQzt;
        "pkg-0.14.2-dev-39" = _HDitQkYg;
        "pkg-0.14.2-dev-40" = _la6qYHAA;
        "pkg-0.14.2-dev-41" = _jc1tLIME;
        "pkg-0.14.2-dev-43" = _gYYVKGLH;
        "pkg-0.14.2-dev-44" = _ln7HulKz;
        "pkg-0.14.2-dev-45" = _KOrT3SFm;
        "pkg-0.14.2-dev-46" = _J6RRRpmd;
        "pkg-0.14.2-dev-47" = _7M6OdZ4u;
        "pkg-0.14.2-dev-49" = _7vvbGfvO;
        "pkg-0.14.2-dev-50" = _Pi38N9Kw;
        "pkg-0.14.2-dev-51" = _1kjQOMM2;
        "pkg-0.14.2-dev-52" = _KqEelyqq;
        "pkg-0.14.2-dev-54" = _XMdZZ4Gz;
        "pkg-0.14.2-dev-55" = _WhuVv7l7;
        "pkg-0.14.2-dev-56" = _SieVJOMb;
        "pkg-0.14.2-dev-57" = _ByzF304z;
        "pkg-0.14.2-dev-58" = _ep3sYRhh;
        "pkg-0.14.2-dev-59" = _GPPh3Ai6;
        "pkg-0.14.2-dev-60" = _Db2z4WIT;
        "pkg-0.14.2-dev-61" = _l2wmfZvA;
        "pkg-0.14.2-dev-62" = _c6aBX0nu;
        "pkg-0.14.2-dev-63" = _4fsDg3Be;
        "pkg-0.14.2-dev-64" = _3q6ZN0FM;
        "pkg-0.14.2-dev-65" = _rUVA2a0N;
        "pkg-0.14.2" = _MkMtCdzD;
        "pkg-0.14.3-dev-2" = _2OOlG5Nh;
        "pkg-0.14.3-dev-3" = _IkJDnXrk;
        "pkg-0.14.3-dev-4" = _OJFmP7HL;
        "pkg-0.14.3-dev-5" = _EYvPnXZg;
        "pkg-0.14.3-dev-6" = _leoX1Pdk;
        "pkg-0.14.3-dev-7" = _yjEfZHXZ;
        "pkg-0.14.3-dev-8" = _ebRqrR8j;
        "pkg-0.14.3-dev-10" = _EAikQfl4;
        "pkg-0.14.3-dev-11" = _bCxGYdfL;
        "pkg-0.14.3-dev-12" = _CvlIgTQ4;
        "pkg-0.14.3-dev-13" = _neCP1qCg;
        "pkg-0.14.3-dev-15" = _VPoRFBNc;
        "pkg-0.14.3-dev-16" = _1B4SncdV;
        "pkg-0.14.3-dev-17" = _2muqShkS;
        "pkg-0.14.3-dev-18" = _pkDWOfLc;
        "pkg-0.14.3-dev-19" = _EVPilA8Y;
        "pkg-0.14.3-dev-20" = _sFMaUME8;
        "pkg-0.14.3-dev-21" = _fH4T6deN;
        "pkg-0.14.3-dev-22" = _vjvmkyho;
        "pkg-0.14.3-dev-23" = _ap6CxlbU;
        "pkg-0.14.3-dev-24" = _xywHyaTf;
        "pkg-0.14.3-dev-25" = _QKgcnWkD;
        "pkg-0.14.3-dev-26" = _UZleSoV8;
        "pkg-0.14.3-dev-27" = _XuOPPkNa;
        "pkg-0.14.3-dev-28" = _Z6HbzgEX;
        "pkg-0.14.3-dev-29" = _izZ2p8ai;
        "pkg-0.14.3-dev-30" = _HOqhVHZ7;
        "pkg-0.14.3-dev-31" = _7hSsCIB1;
        "pkg-0.14.3-dev-32" = _67RSlSnB;
        "pkg-0.14.3-dev-33" = _wCI62euY;
        "pkg-0.14.3-dev-34" = _hSgHLeG8;
        "pkg-0.14.3-dev-35" = _34kE8Jns;
        "pkg-0.14.3-dev-36" = _wgMBrpAX;
        "pkg-0.14.3-dev-37" = _hS5Ij8QR;
        "pkg-0.14.3-dev-38" = _rWCm1IFg;
        "pkg-0.14.3-dev-41" = _dQGO3Mo5;
        "pkg-0.14.3-dev-42" = _XQhw6Be5;
        "pkg-0.14.3-dev-43" = _g8OuNjhE;
        "pkg-0.14.3-dev-44" = _SgJfAoTs;
        "pkg-0.14.3-dev-45" = _Jlt2AoMD;
        "pkg-0.14.3-dev-46" = _Vmr9o0FF;
        "pkg-0.14.3-dev-47" = _HcLnRga8;
        "pkg-0.14.3-dev-48" = _MnzROHLU;
        "pkg-0.14.3-dev-49" = _P2nz2ZW2;
        "pkg-0.14.3-dev-50" = _kluy4QBt;
        "pkg-0.14.3-dev-51" = _nnnKE9TK;
        "pkg-0.14.3-dev-52" = _g04qFMBT;
        "pkg-0.14.3-dev-53" = _A7lG3NJG;
        "pkg-0.14.3-dev-54" = _mDRzFZwr;
        "pkg-0.14.3-dev-55" = _okxyUccK;
        "pkg-0.14.3-dev-56" = _JJsfnrqQ;
        "pkg-0.14.3-dev-57" = _lPa5alUv;
        "pkg-0.14.3-dev-58" = _nLf34ei3;
        "pkg-0.14.3-dev-59" = _bDDLOIYc;
        "pkg-0.14.3-dev-60" = _bKZOK76t;
        "pkg-0.14.3-dev-61" = _j8evBS7N;
        "pkg-0.14.3-dev-62" = _r81Lhfu9;
        "pkg-0.14.3-dev-64" = _Io4utlkb;
        "pkg-0.14.3-dev-68" = _wShbDvqm;
        "pkg-0.14.3-dev-69" = _DQ2pBP9G;
        "pkg-0.14.3-dev-70" = _tv8W29xK;
        "pkg-0.14.3-dev-73" = _bXout90N;
        "pkg-0.14.3-dev-74" = _al1SY9KB;
        "pkg-0.14.3-dev-77" = _7JU87oOW;
        "pkg-0.14.3-dev-78" = _RlfcOYdo;
        "pkg-0.14.3-dev-79" = _hQeVJFQX;
        "pkg-0.15.0" = _AWLGbqdS;
        "pkg-0.15.1-dev-2" = _cEiQdTrY;
        "pkg-0.15.1-dev-4" = _CIe5UhbR;
        "pkg-0.15.1-dev-7" = _DxGSkHv1;
        "pkg-0.15.1-dev-9" = _DiiKnjhL;
        "pkg-0.15.1-dev-10" = _DKd8BJrO;
        "pkg-0.15.1-dev-11" = _VXyCxeYa;
        "pkg-0.15.1-dev-12" = _OjHc3rlm;
        "pkg-0.15.1-dev-13" = _iKpXzgmw;
        "pkg-0.15.1-dev-18" = _NYzTE2ks;
        "pkg-0.15.1-dev-19" = _XdkkcHNg;
        "pkg-0.15.1-dev-20" = _Klc36jRx;
        "pkg-0.15.1-dev-22" = _xWJfrlkt;
        "pkg-0.15.1-dev-24" = _vFbwWL8F;
        "pkg-0.15.1-dev-25" = _nX6eEFoM;
        "pkg-0.15.1-dev-26" = _AJBcnl6g;
        "pkg-0.15.1-dev-27" = _LSRuwDkp;
        "pkg-0.15.1-dev-28" = _minAKvJV;
        "pkg-0.15.1-dev-29" = _wksytBad;
        "pkg-0.15.1-dev-30" = _qyBcOELj;
        "pkg-0.15.1-dev-31" = _uIJM63l5;
        "pkg-0.15.1-dev-32" = _Pv7LkdM0;
        "pkg-0.15.1-dev-33" = _JtiXBx2z;
        "pkg-0.15.1-dev-34" = _Kx1DqP95;
        "pkg-0.15.1-dev-35" = _TB1OjI8Z;
        "pkg-0.15.1-dev-37" = _l7apw9vr;
        "pkg-0.15.1-dev-38" = _giVuc3SJ;
        "pkg-0.15.1-dev-39" = _lhyXsHKi;
        "pkg-0.15.1-dev-42" = _qaia80j6;
        "pkg-0.15.1-dev-43" = _BIOcQeT8;
        "pkg-0.15.1-dev-44" = _76kNW6Nd;
        "pkg-0.15.1-dev-45" = _J5uaFgU5;
        "pkg-0.15.1-dev-46" = _WJ0t4wF2;
        "pkg-0.15.1-dev-47" = _rvmXs14u;
        "pkg-0.15.1-dev-48" = _8y4f2mcr;
        "pkg-0.15.1-dev-49" = _Ljym6J3W;
        "pkg-0.15.1-dev-50" = _VlmJ6GMU;
        "pkg-0.15.1-dev-51" = _fLemJ7M3;
        "pkg-0.15.1-dev-53" = _2hVN6f2t;
        "pkg-0.15.1-dev-54" = _rsIuCUba;
        "pkg-0.15.1-dev-55" = _nyUb0R3R;
        "pkg-0.15.1-dev-56" = _3BCECyhR;
        "pkg-0.15.1-dev-57" = _zhCXXMdE;
        "pkg-0.15.1-dev-58" = _e1mfO2XP;
        "pkg-0.15.1-dev-59" = _1KRTQnaD;
        "pkg-0.15.1-dev-60" = _P7eSfjAZ;
        "pkg-0.15.1-dev-61" = _pUhYFZQs;
        "pkg-0.15.1-dev-62" = _mLgVRodv;
        "pkg-0.15.1-dev-63" = _3aSp9x0b;
        "pkg-0.15.1-dev-64" = _aKxbq20R;
        "pkg-0.15.1-dev-65" = _lEJ9OTp4;
        "pkg-0.15.1-dev-66" = _dSh0VOom;
        "pkg-0.15.1-dev-67" = _OPWQfGlI;
        "pkg-0.15.1-dev-68" = _T8daXUno;
        "pkg-0.15.1-dev-70" = _hdJSJq5v;
        "pkg-0.15.1-dev-71" = _ADhqTRgV;
        "pkg-0.15.1-dev-72" = _a69FWTSx;
        "pkg-0.15.1-dev-73" = _tDRMkrFc;
        "pkg-0.15.1-dev-74" = _FcwCKOxM;
        "pkg-0.15.1-dev-75" = _jd6gxAqu;
        "pkg-0.15.1-dev-76" = _og4FQnwI;
        "pkg-0.15.1-dev-80" = _h1MQlZu6;
        "pkg-0.15.1-dev-81" = _aReKs4qZ;
        "pkg-0.15.1-dev-82" = _qfZB8l8z;
        "pkg-0.15.1-dev-83" = _DJAXmrNl;
        "pkg-0.15.1-dev-84" = _7XZkGnXZ;
        "pkg-0.15.1-dev-85" = _Lj5p8jGS;
        "pkg-0.15.1-dev-87" = _lmvb61Jb;
        "pkg-0.15.1-dev-88" = _ckOUQybB;
        "pkg-0.15.1-dev-89" = _CS9IJYFs;
        "pkg-0.15.1-dev-90" = _v01UcGLX;
        "pkg-0.15.1-dev-91" = _Vu0Ep0sJ;
        "pkg-0.15.1-dev-92" = _bP6TTmU4;
        "pkg-0.15.1-dev-93" = _bYgksEW0;
        "pkg-0.15.1-dev-94" = _VRizNR5v;
        "pkg-0.15.1-dev-95" = _KOXS4oO4;
        "pkg-0.15.1-dev-96" = _9jTrFvMB;
        "pkg-0.15.1-dev-97" = _jBtTyqor;
        "pkg-0.15.1-dev-98" = _miMcubok;
        "pkg-0.15.1-dev-100" = _LAneoZAB;
        "pkg-0.15.1-dev-101" = _YLlYiibA;
        "pkg-0.15.1-dev-102" = _EjRILVIL;
        "pkg-0.15.1-dev-104" = _xDMsBMjZ;
        "pkg-0.15.1-dev-107" = _kX2t6nmu;
        "pkg-0.15.1-dev-108" = _n6ZloB5c;
        "pkg-0.15.1-dev-109" = _dP1q2Ri3;
        "pkg-0.15.1-dev-110" = _A7n7ipXx;
        "pkg-0.15.1-dev-112" = _qTvDcgn3;
        "pkg-0.15.1-dev-113" = _cHntb8dD;
        "pkg-0.15.1-dev-114" = _5jh0JHDG;
        "pkg-0.15.1-dev-115" = _iVKyyUez;
        "pkg-0.15.1-dev-116" = _6W5zezWK;
        "pkg-0.15.1-dev-120" = _hpq1f77t;
        "pkg-0.15.1-dev-121" = _KMKi3nDN;
        "pkg-0.15.1-dev-122" = _zNv1ETXU;
        "pkg-0.15.1-dev-123" = _rBjn8BLm;
        "pkg-0.15.1-dev-124" = _x9uKRG1g;
        "pkg-0.15.1-dev-125" = _w7UIYsVe;
        "pkg-0.15.1-dev-127" = _QUTWKjY6;
        "pkg-0.15.1-dev-130" = _MTQYerkJ;
        "pkg-0.15.1-dev-133" = _jciv9hLJ;
        "pkg-0.15.1-dev-134" = _HHyXorwm;
        "pkg-0.15.1-dev-135" = _83SGnDrR;
        "pkg-0.15.1-dev-137" = _tJLznGk1;
        "pkg-0.15.1-dev-138" = _WJpvSe0C;
        "pkg-0.15.1-dev-139" = _xGjLIywU;
        "pkg-1.0.0" = _qRkZul52;
        "pkg-1.0.1-dev-2" = _zmgVa4sK;
        "pkg-1.0.1-dev-3" = _Tpx8o95E;
        "pkg-1.0.1-dev-4" = _73RSkhBO;
        "pkg-1.0.1-dev-5" = _VjcZtCPu;
        "pkg-1.0.1-dev-6" = _ayESojdP;
        "pkg-1.0.1-dev-8" = _fBsN0myO;
        "pkg-1.0.1-dev-9" = _bVeB79jq;
        "pkg-1.0.1-dev-10" = _ouR4jQyA;
        "pkg-1.0.1-dev-11" = _jL7cIyT3;
        "pkg-1.0.1" = _fcoxgDXK;
        "pkg-1.1.0-dev-2" = _YaTDDGJj;
        "pkg-1.1.0-dev-3" = _cc9Xuovc;
        "pkg-1.1.0-dev-23" = _JcWxcla8;
        "pkg-1.1.0-dev-24" = _UPH9hMSR;
        "pkg-1.1.0-dev-25" = _j696Hdyc;
        "pkg-1.1.0-dev-26" = _6iE3ZMud;
        "pkg-1.1.0-dev-28" = _HOQtaF1i;
        "pkg-1.1.0-dev-30" = _TE33Avwq;
        "pkg-1.1.0-dev-31" = _k6PFDYLL;
        "pkg-1.1.0-dev-32" = _LVQ4av2X;
        "pkg-1.1.0-dev-34" = _ssJbMGhv;
        "pkg-1.1.0-dev-35" = _jCJBZy5l;
        "pkg-1.1.0-dev-37" = _dfEClGy0;
        "pkg-1.1.0-dev-38" = _WO9oeKYS;
        "pkg-1.1.0-dev-39" = _jzFxioMU;
        "pkg-1.1.0-dev-40" = _3SIiABY7;
        "pkg-1.1.0-dev-41" = _fngYdiTf;
        "pkg-1.1.0-dev-42" = _U2dm2hQn;
        "pkg-1.1.0-dev-43" = _3YM2hI1N;
        "pkg-1.1.0-dev-44" = _FCXDjr8x;
        "pkg-1.1.0-dev-45" = _Yi7VlkNL;
        "pkg-1.1.0-dev-46" = _TkYvdYDN;
        "pkg-1.1.0-dev-49" = _d89C9EF8;
        "pkg-1.1.0" = _B413Gy6Q;
        "pkg-1.1.1-dev-3" = _T3YeEhA9;
        "pkg-1.1.1-dev-4" = _dmp3Iqdp;
        "pkg-1.1.1-dev-10" = _JqkUnuSj;
        "pkg-1.1.1-dev-11" = _tbHlXWpj;
        "pkg-1.1.1-dev-13" = _AZzE5stP;
        "default" = _AZzE5stP;
    });
