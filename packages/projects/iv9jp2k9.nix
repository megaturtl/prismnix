...
let
    versions = (let
        ...
        _kHZRg7IU = {
            "id" = "kHZRg7IU";
            "file" = "lithosphere 1.8.2 28.08.2026.zip";
            "hash" = "sha512-xmVXPjCjYhAY56dj7KwKsmkQZ/QjhZDomf15O5SFAUviPOZGyrkVRVfYAAVFndapld7/idlDXq41VVPuDVXuTQ==";
        };
        _aatZx6pq = {
            "id" = "aatZx6pq";
            "file" = "lithosphere-1.8.2.jar";
            "hash" = "sha512-qSH0TCOtMrPSle+l6RQlsGlAz+xRz7AmOiiN6ImhwJQ59jHb7QHD0v/rbVbxxS68HV2EGOKAMww2v0N3NTXxQw==";
        };
    in {
        "tEfrvtAv" = _tEfrvtAv;
        "VtCowAjU" = _VtCowAjU;
        ...
        "datapack-1.20" = _kHZRg7IU;
        "datapack-1.20.2" = _kHZRg7IU;
        "datapack-1.20.4" = _kHZRg7IU;
        "datapack-1.19.3" = _3zqj1ZAe;
        "datapack-1.20.1" = _kHZRg7IU;
        "datapack-1.20.3" = _kHZRg7IU;
        "datapack-1.20.5" = _kHZRg7IU;
        "datapack-1.20.6" = _kHZRg7IU;
        "datapack-1.21" = _kHZRg7IU;
        "datapack-1.21.1" = _kHZRg7IU;
        "datapack-1.21.2" = _kHZRg7IU;
        "datapack-1.21.3" = _kHZRg7IU;
        "datapack-1.21.4" = _kHZRg7IU;
        "datapack-1.21.5" = _kHZRg7IU;
        "datapack-1.21.6" = _kHZRg7IU;
        "datapack-1.21.7" = _kHZRg7IU;
        "datapack-1.21.8" = _kHZRg7IU;
        "datapack-1.21.9" = _kHZRg7IU;
        "datapack-1.21.10" = _kHZRg7IU;
        "datapack-1.21.11" = _kHZRg7IU;
        "datapack-26.1" = _kHZRg7IU;
        "datapack-26.1.1" = _kHZRg7IU;
        "datapack-26.1.2" = _kHZRg7IU;
        "datapack-26.2" = _kHZRg7IU;
        "fabric-1.19" = _7mWcbA0m;
        "fabric-1.19.1" = _7mWcbA0m;
        "fabric-1.19.2" = _7mWcbA0m;
        "fabric-1.19.3" = _7mWcbA0m;
        "fabric-1.19.4" = _7mWcbA0m;
        "fabric-1.20" = _aatZx6pq;
        "fabric-1.20.1" = _aatZx6pq;
        "fabric-1.20.2" = _aatZx6pq;
        "fabric-1.20.3" = _aatZx6pq;
        "fabric-1.20.4" = _aatZx6pq;
        "fabric-1.20.5" = _aatZx6pq;
        "fabric-1.20.6" = _aatZx6pq;
        "fabric-1.21" = _aatZx6pq;
        "fabric-1.21.1" = _aatZx6pq;
        "fabric-1.21.2" = _aatZx6pq;
        "fabric-1.21.3" = _aatZx6pq;
        "fabric-1.21.4" = _aatZx6pq;
        "fabric-1.21.5" = _aatZx6pq;
        "fabric-1.21.6" = _aatZx6pq;
        "fabric-1.21.7" = _aatZx6pq;
        "fabric-1.21.8" = _aatZx6pq;
        "fabric-1.21.9" = _aatZx6pq;
        "fabric-1.21.10" = _aatZx6pq;
        "fabric-1.21.11" = _aatZx6pq;
        "fabric-26.1" = _aatZx6pq;
        "fabric-26.1.1" = _aatZx6pq;
        "fabric-26.1.2" = _aatZx6pq;
        "fabric-26.2" = _aatZx6pq;
        "forge-1.19" = _7mWcbA0m;
        "forge-1.19.1" = _7mWcbA0m;
        "forge-1.19.2" = _7mWcbA0m;
        "forge-1.19.3" = _7mWcbA0m;
        "forge-1.19.4" = _7mWcbA0m;
        "forge-1.20" = _aatZx6pq;
        "forge-1.20.1" = _aatZx6pq;
        "forge-1.20.2" = _aatZx6pq;
        "forge-1.20.3" = _aatZx6pq;
        "forge-1.20.4" = _aatZx6pq;
        "forge-1.20.5" = _aatZx6pq;
        "forge-1.20.6" = _aatZx6pq;
        "forge-1.21" = _aatZx6pq;
        "forge-1.21.1" = _aatZx6pq;
        "forge-1.21.2" = _aatZx6pq;
        "forge-1.21.3" = _aatZx6pq;
        "forge-1.21.4" = _aatZx6pq;
        "forge-1.21.5" = _aatZx6pq;
        "forge-1.21.6" = _aatZx6pq;
        "forge-1.21.7" = _aatZx6pq;
        "forge-1.21.8" = _aatZx6pq;
        "forge-1.21.9" = _aatZx6pq;
        "forge-1.21.10" = _aatZx6pq;
        "forge-1.21.11" = _aatZx6pq;
        "forge-26.1" = _aatZx6pq;
        "forge-26.1.1" = _aatZx6pq;
        "forge-26.1.2" = _aatZx6pq;
        "forge-26.2" = _aatZx6pq;
        "quilt-1.19" = _7mWcbA0m;
        "quilt-1.19.1" = _7mWcbA0m;
        "quilt-1.19.2" = _7mWcbA0m;
        "quilt-1.19.3" = _7mWcbA0m;
        "quilt-1.19.4" = _7mWcbA0m;
        "quilt-1.20" = _aatZx6pq;
        "quilt-1.20.1" = _aatZx6pq;
        "quilt-1.20.2" = _aatZx6pq;
        "quilt-1.20.3" = _aatZx6pq;
        "quilt-1.20.4" = _aatZx6pq;
        "quilt-1.20.5" = _aatZx6pq;
        "quilt-1.20.6" = _aatZx6pq;
        "quilt-1.21" = _aatZx6pq;
        "quilt-1.21.1" = _aatZx6pq;
        "quilt-1.21.2" = _aatZx6pq;
        "quilt-1.21.3" = _aatZx6pq;
        "quilt-1.21.4" = _aatZx6pq;
        "quilt-1.21.5" = _aatZx6pq;
        "quilt-1.21.6" = _aatZx6pq;
        "quilt-1.21.7" = _aatZx6pq;
        "quilt-1.21.8" = _aatZx6pq;
        "quilt-1.21.9" = _aatZx6pq;
        "quilt-1.21.10" = _aatZx6pq;
        "quilt-1.21.11" = _aatZx6pq;
        "quilt-26.1" = _aatZx6pq;
        "quilt-26.1.1" = _aatZx6pq;
        "quilt-26.1.2" = _aatZx6pq;
        "quilt-26.2" = _aatZx6pq;
        "neoforge-1.20.4" = _aatZx6pq;
        "neoforge-1.20.5" = _aatZx6pq;
        "neoforge-1.20.6" = _aatZx6pq;
        "neoforge-1.21" = _aatZx6pq;
        "neoforge-1.21.1" = _aatZx6pq;
        "neoforge-1.21.2" = _aatZx6pq;
        "neoforge-1.21.3" = _aatZx6pq;
        "neoforge-1.21.4" = _aatZx6pq;
        "neoforge-1.20" = _aatZx6pq;
        "neoforge-1.20.1" = _aatZx6pq;
        "neoforge-1.20.2" = _aatZx6pq;
        "neoforge-1.20.3" = _aatZx6pq;
        "neoforge-1.21.5" = _aatZx6pq;
        "neoforge-1.21.6" = _aatZx6pq;
        "neoforge-1.21.7" = _aatZx6pq;
        "neoforge-1.21.8" = _aatZx6pq;
        "neoforge-1.21.9" = _aatZx6pq;
        "neoforge-1.21.10" = _aatZx6pq;
        "neoforge-1.21.11" = _aatZx6pq;
        "neoforge-26.1" = _aatZx6pq;
        "neoforge-26.1.1" = _aatZx6pq;
        "neoforge-26.1.2" = _aatZx6pq;
        "neoforge-26.2" = _aatZx6pq;
        "pkg-1.0" = _tEfrvtAv;
        "pkg-1.0+mod" = _VtCowAjU;
        "pkg-1.1" = _O604hnT0;
        "pkg-1.1+mod" = _3EpKmHDe;
        "pkg-1.1.1" = _mWqPAsFB;
        "pkg-1.1.1+mod" = _Pwv9Ntya;
        "pkg-1.2" = _3zqj1ZAe;
        "pkg-1.2+mod" = _7mWcbA0m;
        "pkg-1.3" = _feSyaErW;
        "pkg-1.3+mod" = _yrTaxqqx;
        "pkg-1.4" = _Txfk2RDu;
        "pkg-1.4+mod" = _GMSG3JA8;
        "pkg-1.5" = _Ee6INUAz;
        "pkg-1.5+mod" = _Tg0INXd5;
        "pkg-1.6" = _oVfs5LJ9;
        "pkg-1.6+mod" = _Wc1TqBTY;
        "pkg-1.7" = _jBiNUKhM;
        "pkg-1.7+mod" = _RHWYyWOp;
        "pkg-1.8" = _Uli8oOke;
        "pkg-1.8+mod" = _kFy5vWzT;
        "pkg-1.8.1" = _r6QyOeqt;
        "pkg-1.8.1+mod" = _Cu9qQGut;
        "pkg-1.8.2" = _kHZRg7IU;
        "pkg-1.8.2+mod" = _aatZx6pq;
        "default" = _aatZx6pq;
    });
