...
let
    ...
    in {
        ...
        "pkg-1.0.0-beta.2" = _BEHhwwIc;
        "pkg-1.0.0-beta.3-paper" = _5u8dniNR;
        "pkg-1.0.0-beta.3" = _h35vrl2s;
        "pkg-1.0.0-beta.4-paper" = _UMgnqul7;
        "pkg-1.0.0-beta.4" = _dmarcT63;
        "pkg-1.0.0-beta.5-paper" = _MLhGEMp7;
        "pkg-1.0.0-beta.5" = _EmBAPROP;
        "pkg-1.0.0-beta.8" = _7dkFmG7Z;
        "pkg-1.0.0-beta.9-paper" = _oDwGFMj6;
        "pkg-1.0.0-beta.9" = _b55Gb8Cz;
        "pkg-1.0.0-beta.10-paper" = _MynMxHKm;
        "pkg-1.0.0-beta.10" = _LJVKG1gg;
        "pkg-1.0.0-beta.11" = _bxBtuV2M;
        "pkg-1.0.0-beta.11-paper" = _zlbrGsfS;
        "pkg-1.0.0-beta.15" = _n3SjFpDA;
        "pkg-1.0.0-beta.15-paper" = _bbBcy5zX;
        "pkg-1.0.0-beta.16" = _VrTbeceL;
        "pkg-1.0.0-beta.16-paper" = _eYELSAuT;
        "pkg-1.0.0-beta.19" = _vlSQQehV;
