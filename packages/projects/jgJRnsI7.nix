...
let
    versions = (let
        ...
        _fDKWED9Y = {
            "id" = "fDKWED9Y";
            "file" = "totem-no-shading-0.1.2+mc26.1.2.jar";
            "hash" = "sha512-cIXgSxbJ0hl6DkpFV5493Nlx+muTu9o39lGTogxx9n+tg51Awjvo0+neViYDlkbai6b7hf6lbAqorL84oZnAEg==";
        };
        _oQ3rOBId = {
            "id" = "oQ3rOBId";
            "file" = "totem-no-shading-0.1.3+mc26.1.2.jar";
            "hash" = "sha512-TzXK6Nvidv05zDNaYdcbBR3XfIrdqJRo4F8eBidvJ6nBrz2UFAONCoSs8TT89qfRnkh70hfwVGasTQyz0Z7nWA==";
        };
    in {
        "GaycbM0h" = _GaycbM0h;
        "pEipaw0L" = _pEipaw0L;
        ...
        "fabric-26.1.2" = _oQ3rOBId;
        "pkg-0.1.0+1.21" = _GaycbM0h;
        "pkg-0.1.0+1.21.1" = _pEipaw0L;
        "pkg-0.1.0+1.20.6" = _Vxx0xV6d;
        "pkg-0.1.0+1.20.1" = _e2v3Ttif;
        "pkg-0.1.0+24w33a" = _TIcURyRX;
        "pkg-0.1.0+24w34a" = _kMB025V5;
        "pkg-0.1.0+24w35a" = _a2E4wQxE;
        "pkg-0.1.0+24w36a" = _SQLbEHLd;
        "pkg-0.1.0+24w37a" = _Okhd0wBy;
        "pkg-0.1.0+24w38a" = _YQLXqEXf;
        "pkg-0.1.0+24w39a" = _JU5zJ2wR;
        "pkg-0.1.0+24w40a" = _hDsuWvOJ;
        "pkg-0.1.1+mc1.21.1" = _xTGSFdvH;
        "pkg-0.1.1+mc1.21" = _JejudKY3;
        "pkg-0.1.1+mc1.20.1" = _mwbk9eqn;
        "pkg-0.1.1+mc1.21.2-pre1" = _13dCPNSR;
        "pkg-0.1.1+mc1.20.6" = _ogSXFIFf;
        "pkg-0.1.1+mc1.21.2-pre2" = _7rKHwRa0;
        "pkg-0.1.1+mc1.21.2-pre3" = _VqYubxne;
        "pkg-0.1.1+mc1.21.2-pre4" = _3sBCvETn;
        "pkg-0.1.1+mc1.21.2-pre5" = _7hJH0hQA;
        "pkg-0.1.1+mc1.21.2-rc1" = _oziCo9NL;
        "pkg-0.1.1+mc1.21.2-rc2" = _X4ZEcV9x;
        "pkg-0.1.1+mc1.21.2" = _BWgTQnSP;
        "pkg-0.1.1+mc1.21.3" = _iuahFerB;
        "pkg-0.1.1+mc24w44a" = _dvRH5LBi;
        "pkg-0.1.1+mc24w45a" = _J2fONV5L;
        "pkg-0.1.1+mc24w46a" = _tx0ziwHS;
        "pkg-0.1.1+mc1.21.4-pre1" = _Zcfo953l;
        "pkg-0.1.1+mc1.21.4-pre2" = _QwNle9Rd;
        "pkg-0.1.1+mc1.21.4-pre3" = _zq9XLubn;
        "pkg-0.1.1+mc1.21.4-rc1" = _7O2rnhuo;
        "pkg-0.1.1+mc1.21.4-rc2" = _LMCdAtlC;
        "pkg-0.1.1+mc1.21.4-rc3" = _xadVqVKK;
        "pkg-0.1.1+mc1.21.4" = _Nvi1UDNJ;
        "pkg-0.1.1+mc25w02a" = _WXvdJYwR;
        "pkg-0.1.1+mc25w03a" = _pAeJo1S7;
        "pkg-0.1.1+mc25w04a" = _ZGLxPW3U;
        "pkg-0.1.1+mc25w05a" = _AxwCHGMX;
        "pkg-0.1.1+mc25w06a" = _mEQsQIMW;
        "pkg-0.1.1+mc25w07a" = _QHgwoyzc;
        "pkg-0.1.1+mc25w08a" = _HDs6lhhn;
        "pkg-0.1.1+mc1.21.5-pre1" = _UXhX0esH;
        "pkg-0.1.1+mc1.21.5-pre2" = _ti6C4au0;
        "pkg-0.1.1+mc1.21.5-pre3" = _doW12O7K;
        "pkg-0.1.1+mc1.21.5-rc1" = _m8tJE0tY;
        "pkg-0.1.1+mc1.21.5-rc2" = _X39dY0JW;
        "pkg-0.1.1+mc1.21.5" = _WoVbn0La;
        "pkg-0.1.1+mc25w14craftmine" = _27Pk9Pip;
        "pkg-0.1.1+mc25w15a" = _x5NiEHYB;
        "pkg-0.1.1+mc25w16a" = _OTEy7opo;
        "pkg-0.1.1+mc25w17a" = _YwmEIcYz;
        "pkg-0.1.1+mc25w18a" = _vZ5MIEr5;
        "pkg-0.1.1+mc25w19a" = _pn5JZf8h;
        "pkg-0.1.1+mc25w20a" = _SQUh08OH;
        "pkg-0.1.1+mc25w21a" = _NVpHPM8P;
        "pkg-0.1.1+mc1.21.6-pre2" = _B6HvIcNT;
        "pkg-0.1.1+mc1.21.6-pre1" = _BEU2bgZJ;
        "pkg-0.1.1+mc1.21.6-pre3" = _Jo7mr5q1;
        "pkg-0.1.1+mc1.21.6-pre4" = _U9tnqV0O;
        "pkg-0.1.1+mc1.21.6-rc1" = _z9I31FSZ;
        "pkg-0.1.1+mc1.21.6" = _tpv8PwhO;
        "pkg-0.1.1+mc1.21.7-rc1" = _D4xjElWd;
        "pkg-0.1.1+mc1.21.7-rc2" = _dQ5Jwhzl;
        "pkg-0.1.1+mc1.21.7" = _xhZFfeNv;
        "pkg-0.1.1+mc1.21.8-rc1" = _iHPae8BL;
        "pkg-0.1.1+mc1.21.8" = _9C3IceXQ;
        "pkg-0.1.1+mc25w31a" = _OpRovyh8;
        "pkg-0.1.1+mc25w32a" = _bssirKxO;
        "pkg-0.1.1+mc25w33a" = _lE6R7hnM;
        "pkg-0.1.1+mc25w34a" = _sm52asvF;
        "pkg-0.1.1+mc25w34b" = _vOJrME4h;
        "pkg-0.1.1+mc25w35a" = _gBnliQk5;
        "pkg-0.1.1+mc25w36a" = _R8mX1TLR;
        "pkg-0.1.1+mc25w36b" = _VjArlEiq;
        "pkg-0.1.1+mc25w37a" = _wEnsLcQr;
        "pkg-0.1.1+mc1.21.9" = _KPhapTi9;
        "pkg-0.1.1+mc1.21.10" = _JuXfArr9;
        "pkg-0.1.1+mc1.21.11" = _UBKw2hHQ;
        "pkg-0.1.1+mc26.1-snapshot-1" = _gtYukNKX;
        "pkg-0.1.2+mc26.1-snapshot-2" = _CuDJhE2M;
        "pkg-0.1.2+mc26.1-snapshot-3" = _YFhmxIIv;
        "pkg-0.1.2+mc26.1-snapshot-4" = _4fhHhVnS;
        "pkg-0.1.2+mc26.1-snapshot-5" = _Tg74zfFA;
        "pkg-0.1.2+mc26.1-snapshot-6" = _okCBoqF4;
        "pkg-0.1.2+mc26.1-snapshot-7" = _YMZseNKL;
        "pkg-0.1.2+mc26.1-snapshot-8" = _OsHN1tqF;
        "pkg-0.1.2+mc26.1-snapshot-9" = _Yoox8D3W;
        "pkg-0.1.2+mc26.1.2" = _fDKWED9Y;
        "pkg-0.1.3+mc26.1.2" = _oQ3rOBId;
        "default" = _oQ3rOBId;
    });
