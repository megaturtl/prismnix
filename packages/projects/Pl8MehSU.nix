...
let
    versions = (let
        ...
        _J81L0MdY = {
            "id" = "J81L0MdY";
            "file" = "view-model-1.0.5-1.21.11-fabric.jar";
            "hash" = "sha512-N22j/DUBP8omGyYxIt+Piqs6uCfry3w8lt6t8ofc06lP13hivLz/MR1TKd+P2W1p6Ug1SR2mzoJH/u/G2RCaFw==";
        };
        _A8pXU4l9 = {
            "id" = "A8pXU4l9";
            "file" = "view-model-1.0.5-26.1-fabric.jar";
            "hash" = "sha512-iui52vlk8cYy0+hdxMU35+K2lMS52C6vDJIGvP349sYKmYbqwuub4qC7fPmi9jHKyj8PCUejkEyJMZIKRd9few==";
        };
        _VKsFrxCx = {
            "id" = "VKsFrxCx";
            "file" = "view-model-1.0.5-26.2-fabric.jar";
            "hash" = "sha512-F6tqN+P1+BJjrK4Z+mVHFPzxyJaZfFQ5+lW9pfhzBFMatlUVxsz4AOMIDjoD8UeTYkM3rCPaR1YlUVjUJdXrhg==";
        };
        _QjmRfjqG = {
            "id" = "QjmRfjqG";
            "file" = "view-model-1.0.6-1.21.11-fabric.jar";
            "hash" = "sha512-ZBEPEXZysJSSsWa9qriX8bHk/yZiykqOTcR9IHedDp+rDPl5FsSs4eX+TTKaDI0yMafRZU1dGtmRwu5QxIpXHA==";
        };
        _hO4sKKZ4 = {
            "id" = "hO4sKKZ4";
            "file" = "view-model-1.0.6-26.1-fabric.jar";
            "hash" = "sha512-jyumNgDBinQCwH5rS0orUfBnN3GugCHMRillF0VXrl/QqQI+LVm5pifIQstS3/CDe/wKB1KGS8bKRYtd5KBbIw==";
        };
        _QaPKwoul = {
            "id" = "QaPKwoul";
            "file" = "view-model-1.0.6-26.2-fabric.jar";
            "hash" = "sha512-8vGRIBd3qCcjwqgfHlI9r5lljALVAAXa/Yu7nuV8AbB4V7ma/G1tgHShgDKEe5/OORJ1GGD0dz6EFL1GxobKug==";
        };
    in {
        "zKKsa478" = _zKKsa478;
        "UMi6LB7V" = _UMi6LB7V;
        ...
        "fabric-1.21.11" = _QjmRfjqG;
        "fabric-26.1" = _hO4sKKZ4;
        "fabric-26.1.1" = _hO4sKKZ4;
        "fabric-26.1.2" = _hO4sKKZ4;
        "fabric-26.2" = _QaPKwoul;
        "pkg-1.20.4-1.0-fabric" = _zKKsa478;
        "pkg-1.20.6-2.0-fabric" = _UMi6LB7V;
        "pkg-3.0-1.20.6-fabric" = _6Nf0oy3B;
        "pkg-4.0-1.20-fabric" = _69sjZGD1;
        "pkg-4.0-1.20.2-fabric" = _zlAWVTPC;
        "pkg-4.0-1.20.6-fabric" = _3qyaBtJN;
        "pkg-5.0-1.20-fabric" = _yko68E5I;
        "pkg-5.0-1.20.2-fabric" = _NlOQYPYz;
        "pkg-5.0-1.20.6-fabric" = _IgVpknA5;
        "pkg-6.0-1.20-fabric" = _qoJQ0Pou;
        "pkg-6.0-1.20.2-fabric" = _DdIt997S;
        "pkg-6.0-1.20.6-fabric" = _OuR5LRFc;
        "pkg-6.0-1.21-fabric" = _6UUnc7j5;
        "pkg-7.0-1.20-fabric" = _gYdCubo8;
        "pkg-7.0-1.20.2-fabric" = _z01UoGRS;
        "pkg-7.0-1.20.6-fabric" = _qH9umWF8;
        "pkg-7.0-1.21-fabric" = _Pi4Xre6T;
        "pkg-8.0-1.20-fabric" = _HSf27YmN;
        "pkg-8.0-1.20.2-fabric" = _JRAOcgaI;
        "pkg-8.0-1.21-fabric" = _DbuhkBCV;
        "pkg-8.0-1.20.6-fabric" = _qoy9AXKj;
        "pkg-9.0-1.20-fabric" = _6O8gXyUH;
        "pkg-9.0-1.20.2-fabric" = _ixtjyKuX;
        "pkg-9.0-1.20.6-fabric" = _eXXkrwJ5;
        "pkg-9.0-1.21-fabric" = _bVHuUwwJ;
        "pkg-1.0.0-1.20-fabric" = _G8gE3zwm;
        "pkg-1.0.0-1.20.2-fabric" = _jad3oZoc;
        "pkg-1.0.0-1.20.6-fabric" = _45TyJ2bL;
        "pkg-1.0.0-1.21-fabric" = _1YXIFC5I;
        "pkg-1.0.0-1.21.4-fabric" = _v19uB1HM;
        "pkg-1.0.1-1.20-fabric" = _NNgsX9gc;
        "pkg-1.0.1-1.20.2-fabric" = _bvsE5QP5;
        "pkg-1.0.1-1.20.6-fabric" = _kjOgC6nR;
        "pkg-1.0.1-1.21-fabric" = _8TBfktyn;
        "pkg-1.0.1-1.21.4-fabric" = _Qe2Vox9D;
        "pkg-1.0.1-1.21.5-fabric" = _P8OWzDcD;
        "pkg-1.0.1-1.21.6-fabric" = _QFW9Fl4O;
        "pkg-1.0.1-1.21.10-fabric" = _yG1j4ewX;
        "pkg-1.0.2-1.21.11-fabric" = _twxuO3AR;
        "pkg-1.0.2-26.1-fabric" = _THcdEfBZ;
        "pkg-1.0.3-1.21.11-fabric" = _gdoURDJd;
        "pkg-1.0.3-26.1-fabric" = _NsOyDFL6;
        "pkg-1.0.3-26.2-fabric" = _UexulNb8;
        "pkg-1.0.4-1.21.11-fabric" = _7R52NadH;
        "pkg-1.0.4-26.1-fabric" = _MlfKcJiC;
        "pkg-1.0.4-26.2-fabric" = _u12e6zNR;
        "pkg-1.0.5-1.21.11-fabric" = _J81L0MdY;
        "pkg-1.0.5-26.1-fabric" = _A8pXU4l9;
        "pkg-1.0.5-26.2-fabric" = _VKsFrxCx;
        "pkg-1.0.6-1.21.11-fabric" = _QjmRfjqG;
        "pkg-1.0.6-26.1-fabric" = _hO4sKKZ4;
        "pkg-1.0.6-26.2-fabric" = _QaPKwoul;
        "default" = _QaPKwoul;
    });
