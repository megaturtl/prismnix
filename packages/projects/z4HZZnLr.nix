...
let
    versions = (let
        ...
        _5TOYHuQr = {
            "id" = "5TOYHuQr";
            "file" = "FastAsyncWorldEdit-Paper-2.15.4.jar";
            "hash" = "sha512-9iOlcprtOGxa7AzFpR8BpjYtRSsCCFG9jhe7nfZrmrqiF7B6T78+4ITd6iAoJIQzkOAkhvbupWQGJOara8yBuA==";
        };
        _Li78VnLD = {
            "id" = "Li78VnLD";
            "file" = "FastAsyncWorldEdit-Bukkit-2.15.4.jar";
            "hash" = "sha512-Xd0thrbQwvRVX0e5bhHICzs7ssaocVgJq3G3qKQa+ANlZbJ9LMwhUoOV+/1i6CXxdeIJa7gBu7WO5aPfRxtVsQ==";
        };
    in {
        "EalAAGQd" = _EalAAGQd;
        "TJu9z7Fu" = _TJu9z7Fu;
        ...
        "paper-1.21.1" = _5TOYHuQr;
        "paper-1.21.2" = _N86xPK8R;
        "paper-1.21.3" = _cf5QSDJ7;
        "paper-1.21.4" = _5TOYHuQr;
        "paper-1.21.7" = _5TOYHuQr;
        "paper-1.21.8" = _5TOYHuQr;
        "paper-1.21.5" = _5TOYHuQr;
        "paper-1.21.6" = _5TOYHuQr;
        "paper-1.21.9" = _5TOYHuQr;
        "paper-1.21.10" = _5TOYHuQr;
        "paper-1.21.11" = _5TOYHuQr;
        "paper-26.1" = _5TOYHuQr;
        "paper-26.1.1" = _5TOYHuQr;
        "paper-26.1.2" = _5TOYHuQr;
        "paper-26.2" = _5TOYHuQr;
        ...
        "spigot-1.21.1" = _Li78VnLD;
        "spigot-1.21.2" = _N86xPK8R;
        "spigot-1.21.3" = _GjiMsU0f;
        "spigot-1.21.4" = _Li78VnLD;
        "spigot-1.21.7" = _Li78VnLD;
        "spigot-1.21.8" = _Li78VnLD;
        "spigot-1.21.5" = _Li78VnLD;
        "spigot-1.21.6" = _Li78VnLD;
        "spigot-1.21.9" = _Li78VnLD;
        "spigot-1.21.10" = _Li78VnLD;
        "spigot-1.21.11" = _Li78VnLD;
        "spigot-26.1" = _Li78VnLD;
        "spigot-26.1.1" = _Li78VnLD;
        "spigot-26.1.2" = _Li78VnLD;
        "spigot-26.2" = _Li78VnLD;
        ...
        "pkg-2.9.1" = _3qSFAzTe;
        "pkg-2.9.2" = _YSQCH9EW;
        "pkg-2.10.0" = _IPOiEpsL;
        "pkg-2.11.0" = _CyUQUWfI;
        "pkg-2.11.1" = _E1M6iDPV;
        "pkg-2.11.2" = _DRBksutn;
        "pkg-2.12.0" = _ib4vTRkD;
        "pkg-2.12.2" = _N86xPK8R;
        "pkg-2.12.3" = _GjiMsU0f;
        "pkg-2.13.1" = _o8Ytdhc5;
        "pkg-2.14.1" = _MIFlUrov;
        "pkg-2.14.2" = _wQDmOyLb;
        "pkg-2.14.3" = _qE0gYHJh;
        "pkg-2.15.0" = _MOe9fY3h;
        "pkg-2.15.1" = _Dx0x0kQW;
        "pkg-2.15.2" = _gHUCKiVD;
        "pkg-2.15.3" = _wDzcK7Sn;
        "pkg-2.15.4" = _Li78VnLD;
        "default" = _Li78VnLD;
    });
