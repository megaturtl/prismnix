...
let
    versions = (let
        ...
        _UAqcjhgj = {
            "id" = "UAqcjhgj";
            "file" = "portfolio-1.21.1-1.6.0-neoforge.jar";
            "hash" = "sha512-6KCbJOglG6UFAjsiKLmwM6Rdb2u9GO8DvGOHX3HC/+pYv1eXmdIxRQ22rMfHCHpogNc8M5171BJwefLASRCXeQ==";
        };
        _9pCkhOCQ = {
            "id" = "9pCkhOCQ";
            "file" = "portfolio-1.21.1-1.6.0-fabric.jar";
            "hash" = "sha512-e11vhh9WTw2oiEyt42brdZegiCuW2H21oYyUwdtQbwO+Sjb65aYHDWDnkBeKDVltYsmMZwTQxO3Gztd5+NUIJQ==";
        };
        _vNTNJ1nA = {
            "id" = "vNTNJ1nA";
            "file" = "portfolio-1.21.1-1.6.0-datapack.zip";
            "hash" = "sha512-nDNIzUmn+DczDnb0KVYSuXW04YTc033XhZwKqyRZynYWECZqbpAtkKvyeFyzGW1BRaLv+Bb3bISCsjNoGOHGxQ==";
        };
        _pJ0uCysJ = {
            "id" = "pJ0uCysJ";
            "file" = "portfolio-1.21.x-1.6.0-neoforge.jar";
            "hash" = "sha512-y6YHK+S4bDDwilmTDnk+z6JwHyZETLpkzUKLawJPZv3xXBCzeRZrujpYcju5u390pDLk9ULq0ApafTHd/lU4QQ==";
        };
        _cCdSLCcM = {
            "id" = "cCdSLCcM";
            "file" = "portfolio-1.21.x-1.6.0-fabric.jar";
            "hash" = "sha512-k6zCdWmxwg59wuQ0zcVmZ2wJakuwkQznPygKRXMUOVsjx1OdW018ItQZ2vxY35nmwdd+6mrAluy/a7S093ow2g==";
        };
        _1aqRUJRS = {
            "id" = "1aqRUJRS";
            "file" = "portfolio-1.21.x-1.6.0-datapack.zip";
            "hash" = "sha512-jAlfMIJK4sYnVgsKoOR1FhJdqOvCN7C2oyS/d2GBPVAU/6iqjEnRDTm+yFwsDZi36tdBCBDldHYMHBHw7YuWUw==";
        };
        _TkWpI85P = {
            "id" = "TkWpI85P";
            "file" = "portfolio-1.21.9+1.6.0-neoforge.jar";
            "hash" = "sha512-OWpUVLuYeBF8w8rIYk4NFXQymgMzHQ51kg6m8R0sQdNbsOaM+2lZReokzkv+mEiK0c7un61mwqgQYT/W9zxXhg==";
        };
        _g2XRkHHT = {
            "id" = "g2XRkHHT";
            "file" = "portfolio-1.21.9+1.6.0-datapack.zip";
            "hash" = "sha512-pJUqzABlj6JxEF3+28hI1tMrq0bvHPsjU4lIMl7jnvUuhRq0gJ/yuEXeqPVfcAA1AIwf+KOxXjI0RSxY2o6I/w==";
        };
        _4opPu49o = {
            "id" = "4opPu49o";
            "file" = "portfolio-26.x-1.6.0-neoforge.jar";
            "hash" = "sha512-5QpX7of58Wki0Re2bIz6AMZG74iTKV/EIaRERfDatvK4okK6TJpq1aeZ5VATAVClFlawYQToX8W9DTeFL5VpYA==";
        };
        _DdIuoIBl = {
            "id" = "DdIuoIBl";
            "file" = "portfolio-26.x-1.6.0-fabric.jar";
            "hash" = "sha512-vJyzgs55PYn4UV9CL7u+6G69lAp0l4DDPCMDWbXg/25k/7tQuKh6gtiss+lsRh1MAlo6SNagQyivTYEAVbcrkw==";
        };
        _bwU9Och0 = {
            "id" = "bwU9Och0";
            "file" = "portfolio-26.x-1.6.0-datapack.zip";
            "hash" = "sha512-XWGMjg3TGDN0WBUnrMWko6pu2Ou85MLA1EtUMA/rfeTbKOPjqiJ4DFMVcUCoLVz6Y3mpxh1e1rznIpE0rizTKw==";
        };
    in {
        "N7WjpGec" = _N7WjpGec;
        "yhjhE1q9" = _yhjhE1q9;
        ...
        "fabric-1.21.1" = _9pCkhOCQ;
        "fabric-1.21.2" = _cCdSLCcM;
        "fabric-1.21.3" = _cCdSLCcM;
        "fabric-1.21.4" = _cCdSLCcM;
        "fabric-1.21.5" = _cCdSLCcM;
        "fabric-1.21.6" = _cCdSLCcM;
        "fabric-1.21.7" = _cCdSLCcM;
        "fabric-1.21.8" = _cCdSLCcM;
        "fabric-1.21.9" = _cCdSLCcM;
        "fabric-1.21.10" = _cCdSLCcM;
        "fabric-1.21.11" = _cCdSLCcM;
        "fabric-26.1" = _DdIuoIBl;
        "fabric-26.1.1" = _DdIuoIBl;
        "fabric-26.1.2" = _DdIuoIBl;
        "fabric-26.2" = _DdIuoIBl;
        "neoforge-1.21" = _ok2l9sHm;
        "neoforge-1.21.1" = _UAqcjhgj;
        "neoforge-1.21.2" = _pJ0uCysJ;
        "neoforge-1.21.3" = _pJ0uCysJ;
        "neoforge-1.21.4" = _pJ0uCysJ;
        "neoforge-1.21.5" = _pJ0uCysJ;
        "neoforge-1.21.6" = _pJ0uCysJ;
        "neoforge-1.21.7" = _pJ0uCysJ;
        "neoforge-1.21.8" = _pJ0uCysJ;
        "neoforge-1.21.9" = _TkWpI85P;
        "neoforge-1.21.10" = _TkWpI85P;
        "neoforge-1.21.11" = _TkWpI85P;
        "neoforge-26.1" = _4opPu49o;
        "neoforge-26.1.1" = _4opPu49o;
        "neoforge-26.1.2" = _4opPu49o;
        "neoforge-26.2" = _4opPu49o;
        "datapack-1.21" = _i1rzzyKF;
        "datapack-1.21.1" = _vNTNJ1nA;
        "datapack-1.21.2" = _1aqRUJRS;
        "datapack-1.21.3" = _1aqRUJRS;
        "datapack-1.21.4" = _1aqRUJRS;
        "datapack-1.21.5" = _1aqRUJRS;
        "datapack-1.21.6" = _1aqRUJRS;
        "datapack-1.21.7" = _1aqRUJRS;
        "datapack-1.21.8" = _1aqRUJRS;
        "datapack-25w31a" = _b5AOAYX7;
        "datapack-25w32a" = _b5AOAYX7;
        "datapack-1.21.9" = _g2XRkHHT;
        "datapack-1.21.10" = _g2XRkHHT;
        "datapack-1.21.11" = _g2XRkHHT;
        "datapack-26.1" = _bwU9Och0;
        "datapack-26.1.1" = _bwU9Och0;
        "datapack-26.1.2" = _bwU9Och0;
        "datapack-26.2" = _bwU9Och0;
        "pkg-1.0.0-forge" = _N7WjpGec;
        "pkg-1.0.0-fabric" = _yhjhE1q9;
        "pkg-1.1.0-forge" = _kqpvNlUz;
        "pkg-1.1.0-fabric" = _uc40qMRg;
        "pkg-1.2.0-forge" = _ghUuZufq;
        "pkg-1.2.0-fabric" = _5pN5QTRA;
        "pkg-1.3.0-forge" = _KNUTUrw9;
        "pkg-1.3.0-fabric" = _qekYmrvs;
        "pkg-1.3.5-forge" = _xQBC5gem;
        "pkg-1.3.5-fabric" = _qwIF75mP;
        "pkg-1.4.0-forge" = _Z8r2ccYf;
        "pkg-1.4.0-fabric" = _Gyhi4wAa;
        "pkg-1.4.0-neoforge" = _kmRfVVxh;
        "pkg-1.4.0-datapack" = _sdPp5Q9i;
        "pkg-1.4.1-forge" = _oAGUNCa3;
        "pkg-1.4.1-fabric" = _KqcjgQIJ;
        "pkg-1.4.1-neoforge" = _xydbcWf7;
        "pkg-1.4.1-datapack" = _9RpBy7Kr;
        "pkg-1.4.1-datapack-SNAPSHOT" = _b5AOAYX7;
        "pkg-1.5.0-neoforge" = _HPVaR7uX;
        "pkg-1.5.0-fabric" = _6PBCkzvU;
        "pkg-1.5.0-datapack" = _zf82lk5M;
        "pkg-1.5.0-forge" = _9jAmDkFc;
        "pkg-1.5.1-neoforge" = _aMdUHmIH;
        "pkg-1.5.1-fabric" = _Sxy7ocpD;
        "pkg-1.5.1-datapack" = _y9xaVg6t;
        "pkg-1.5.5-neoforge" = _6R1LcfBU;
        "pkg-1.5.5-fabric" = _mn29SRQc;
        "pkg-1.5.5-datapack" = _Bjarlk1o;
        "pkg-1.6.0-neoforge" = _4opPu49o;
        "pkg-1.6.0-fabric" = _DdIuoIBl;
        "pkg-1.6.0-datapack" = _bwU9Och0;
        "default" = _bwU9Och0;
    });
