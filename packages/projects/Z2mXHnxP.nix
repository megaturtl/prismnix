...
let
    ...
    in {
        ...
        "pkg-1.19.2-Forge-1.0.3" = _8Gq5f3b9;
        "pkg-1.19.2-Fabric-1.0.4" = _NySrIdMV;
        "pkg-1.19.2-Forge-1.0.4" = _KAarwq7Z;
        "pkg-1.19.3-Forge-1.1.0" = _kWtjzB64;
        "pkg-1.19.3-Fabric-1.1.0" = _uol0Ji2G;
        "pkg-1.19.2-Forge-1.0.5" = _CogRXOHi;
        "pkg-1.19.2-Fabric-1.0.5" = _16pSLk6u;
        "pkg-1.19.3-Forge-1.1.1" = _CthwWOrc;
        "pkg-1.19.3-Fabric-1.1.1" = _N2yKMcSO;
        "pkg-1.18.2-Fabric-1.0.0" = _gTTPcjUR;
        "pkg-1.18.2-Forge-1.0.0" = _XzRYWtHN;
        "pkg-1.19.4-Fabric-1.2.0" = _tS9cnHTd;
        "pkg-1.19.4-Forge-1.2.0" = _f3PibvQR;
        "pkg-1.19.2-Fabric-1.0.6" = _W4uRBVaV;
        "pkg-1.19.2-Forge-1.0.6" = _9iPMgrMe;
        "pkg-1.20-Forge-2.0.2" = _449b2DDy;
        "pkg-1.20-Fabric-2.0.2" = _YouhzPUf;
        "pkg-1.20-Forge-2.0.3" = _iYszV4T0;
        "pkg-1.20-Fabric-2.0.3" = _RmyDSPdb;
        "pkg-1.20-Forge-2.0.4" = _fQyD1cxI;
        "pkg-1.20-Fabric-2.0.4" = _kuHlZxVW;
        "pkg-1.20-Forge-2.0.5" = _vKRSJIfJ;
        "pkg-1.20-Fabric-2.0.5" = _lrZS6PH1;
        "pkg-1.20.4-Forge-2.4.0" = _qqIjSslt;
        "pkg-1.20.4-Fabric-2.4.0" = _QplnGAIz;
        "pkg-1.20.4-Forge-2.4.1" = _wtF2F6Ax;
        "pkg-1.20.4-Fabric-2.4.1" = _lQXMx7kq;
        "pkg-1.20-Forge-2.0.6" = _2nUEz0zq;
        "pkg-1.20-Fabric-2.0.6" = _FL88RLRu;
        "pkg-1.20.4-Forge-2.4.2" = _jJn0Zg8g;
        "pkg-1.20.4-Fabric-2.4.2" = _W7R83Bhr;
        "pkg-1.20.4-Forge-2.4.3" = _oVphbTam;
        "pkg-1.20.4-NeoForge-2.4.3" = _IHNXXJ1L;
        "pkg-1.20.4-Fabric-2.4.3" = _BxEPEvgo;
        "pkg-1.20.4-Forge-2.4.4" = _kDpdIch6;
        "pkg-1.20.4-NeoForge-2.4.4" = _98DJ9gap;
        "pkg-1.20.4-Fabric-2.4.4" = _VYtNUWOc;
        "pkg-1.21.1-Fabric-3.1.0" = _RYl9C9bM;
        "pkg-1.21.1-Forge-3.1.0" = _dCHYDKNw;
        "pkg-1.21.1-NeoForge-3.1.0" = _gMFXgV0T;
        "pkg-1.21.1-Forge-3.1.1" = _eOYVviCY;
        "pkg-1.21.1-NeoForge-3.1.1" = _elJTVMGu;
        "pkg-1.21.1-Fabric-3.1.1" = _TV759vks;
        "pkg-1.21.1-Forge-3.1.2" = _GEm0rUp4;
        "pkg-1.21.1-NeoForge-3.1.2" = _dPuHAoU3;
        "pkg-1.21.1-Fabric-3.1.2" = _A9LuScTc;
        "pkg-1.21.1-Forge-3.1.3" = _7XAYKa8o;
        "pkg-1.21.1-NeoForge-3.1.3" = _JXvA28QW;
        "pkg-1.21.1-Fabric-3.1.3" = _wWdEPfV3;
        "pkg-1.21.1-Forge-3.1.4" = _9OD6lj1D;
        "pkg-1.21.1-NeoForge-3.1.4" = _oNRbcwIE;
        "pkg-1.21.1-Fabric-3.1.4" = _BpP9FnUL;
        "pkg-1.21.4-NeoForge-3.4.0" = _2h5lbJvW;
        "pkg-1.21.4-Fabric-3.4.0" = _GNbnvBBJ;
        "pkg-1.21.4-NeoForge-3.4.1" = _VGGj4FAD;
        "pkg-1.21.4-Fabric-3.4.1" = _eUEnv9r3;
        "pkg-1.21.1-Forge-3.1.5" = _cL1bcVib;
        "pkg-1.21.1-NeoForge-3.1.5" = _iopJiJQp;
