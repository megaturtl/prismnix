...
let
    versions = (let
        ...
        _2vTSJypi = {
            "id" = "2vTSJypi";
            "file" = "MoogsNetherStructures-universal-1.21-3.1.0.jar";
            "hash" = "sha512-Of+LSfr7aZ+hOjf6IJyes9/u5GAkN9lCnUN3srXT84Mt5T0whT9h7FI/4a65ZRuHtQ+c8gNyexbxuYSptkTsLg==";
        };
        _bcwhyj8t = {
            "id" = "bcwhyj8t";
            "file" = "MoogsNetherStructures-universal-1.20-3.1.0.jar";
            "hash" = "sha512-43JTPH2vLwah2Uo7aSwl7BG8RU2TcRsgS9fkAqHiCJGoQD9XqBIJcjzv0TLTdeZ5zkFBC8wPMtma8Mc38jo03Q==";
        };
        _OLTqXnsN = {
            "id" = "OLTqXnsN";
            "file" = "MoogsNetherStructures-universal-1.21-3.1.1.jar";
            "hash" = "sha512-lfj4/P84Ub8bkuKrhGXlUVBv6BnVJp734lHURlY1RqMY7n/Le4pnEgmJXk/V3whBAfID2kO2XRr0gz6de65sAA==";
        };
    in {
        "TEUYnBzF" = _TEUYnBzF;
        "FCKzWzK8" = _FCKzWzK8;
        ...
        "bcwhyj8t" = _bcwhyj8t;
        "OLTqXnsN" = _OLTqXnsN;
        "forge-1.20" = _bcwhyj8t;
        "forge-1.20.1" = _bcwhyj8t;
        "forge-1.20.2" = _bcwhyj8t;
        "forge-1.19.3" = _zuewaTTB;
        "forge-1.19.4" = _zuewaTTB;
        "forge-1.19" = _svpLC7Fk;
        "forge-1.19.1" = _svpLC7Fk;
        "forge-1.19.2" = _svpLC7Fk;
        "forge-1.20.3" = _bcwhyj8t;
        "forge-1.20.4" = _bcwhyj8t;
        "forge-1.20.5" = _bcwhyj8t;
        "forge-1.20.6" = _bcwhyj8t;
        "forge-1.21" = _OLTqXnsN;
        "forge-1.21.1" = _OLTqXnsN;
        "forge-1.21.2" = _OLTqXnsN;
        "forge-1.21.3" = _OLTqXnsN;
        "forge-1.21.4" = _OLTqXnsN;
        "forge-1.21.5" = _OLTqXnsN;
        "forge-1.21.6" = _OLTqXnsN;
        "forge-1.21.7" = _OLTqXnsN;
        "forge-1.21.8" = _OLTqXnsN;
        "forge-1.21.9" = _OLTqXnsN;
        "forge-1.21.10" = _OLTqXnsN;
        "forge-1.21.11" = _OLTqXnsN;
        "forge-26.1" = _OLTqXnsN;
        "forge-26.1.1" = _OLTqXnsN;
        "forge-26.1.2" = _OLTqXnsN;
        "forge-26.2" = _OLTqXnsN;
        "forge-26.3" = _OLTqXnsN;
        "fabric-1.20" = _bcwhyj8t;
        "fabric-1.20.1" = _bcwhyj8t;
        "fabric-1.20.2" = _bcwhyj8t;
        "fabric-1.19.3" = _bRlg33JA;
        "fabric-1.19.4" = _bRlg33JA;
        "fabric-1.19" = _b5P9yjKY;
        "fabric-1.19.1" = _b5P9yjKY;
        "fabric-1.19.2" = _b5P9yjKY;
        "fabric-1.20.3" = _bcwhyj8t;
        "fabric-1.20.4" = _bcwhyj8t;
        "fabric-1.20.5" = _bcwhyj8t;
        "fabric-1.20.6" = _bcwhyj8t;
        "fabric-1.21" = _OLTqXnsN;
        "fabric-1.21.1" = _OLTqXnsN;
        "fabric-1.21.4" = _OLTqXnsN;
        "fabric-1.21.5" = _OLTqXnsN;
        "fabric-1.21.6" = _OLTqXnsN;
        "fabric-1.21.7" = _OLTqXnsN;
        "fabric-1.21.8" = _OLTqXnsN;
        "fabric-1.21.9" = _OLTqXnsN;
        "fabric-1.21.10" = _OLTqXnsN;
        "fabric-1.21.2" = _OLTqXnsN;
        "fabric-1.21.3" = _OLTqXnsN;
        "fabric-1.21.11" = _OLTqXnsN;
        "fabric-26.1" = _OLTqXnsN;
        "fabric-26.1.1" = _OLTqXnsN;
        "fabric-26.1.2" = _OLTqXnsN;
        "fabric-26.2" = _OLTqXnsN;
        "fabric-26.3" = _OLTqXnsN;
        ...
        "neoforge-1.20" = _bcwhyj8t;
        "neoforge-1.20.1" = _bcwhyj8t;
        "neoforge-1.20.2" = _bcwhyj8t;
        "neoforge-1.20.3" = _bcwhyj8t;
        "neoforge-1.20.4" = _bcwhyj8t;
        "neoforge-1.20.5" = _bcwhyj8t;
        "neoforge-1.20.6" = _bcwhyj8t;
        "neoforge-1.21" = _OLTqXnsN;
        "neoforge-1.21.1" = _OLTqXnsN;
        "neoforge-1.21.4" = _OLTqXnsN;
        "neoforge-1.21.5" = _OLTqXnsN;
        "neoforge-1.21.6" = _OLTqXnsN;
        "neoforge-1.21.7" = _OLTqXnsN;
        "neoforge-1.21.8" = _OLTqXnsN;
        "neoforge-1.21.9" = _OLTqXnsN;
        "neoforge-1.21.10" = _OLTqXnsN;
        "neoforge-1.21.2" = _OLTqXnsN;
        "neoforge-1.21.3" = _OLTqXnsN;
        "neoforge-1.21.11" = _OLTqXnsN;
        "neoforge-26.1" = _OLTqXnsN;
        "neoforge-26.1.1" = _OLTqXnsN;
        "neoforge-26.1.2" = _OLTqXnsN;
        "neoforge-26.2" = _OLTqXnsN;
        "neoforge-26.3" = _OLTqXnsN;
