...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _ACtPIxB0;
        "pkg-1.1.1" = _oopKNnWy;
        "pkg-1.1.1h" = _Rj0Uvpza;
        "pkg-1.1.3" = _9ACFJ9Ux;
        "pkg-2.0.0-fabric-1.20.1" = _AQWrIz5t;
        "pkg-2.0.0-forge-1.20.1" = _yqLSmPge;
        "pkg-2.0.0-fabric-1.21.1" = _uVIuJKSb;
        "pkg-2.0.0-neoforge-1.21.1" = _owCT5jxt;
        "pkg-2.0.1-fabric-1.20.1" = _W0YkH1w1;
        "pkg-2.0.1-forge-1.20.1" = _8kFY4ann;
        "pkg-2.0.1-fabric-1.21.1" = _CdeYOrL9;
        "pkg-2.0.1-neoforge-1.21.1" = _D3JiL2aw;
        "pkg-2.0.2-neoforge-1.21.1" = _Xk64RZCT;
        "pkg-2.0.2-fabric-1.21.1" = _X0RMa8XG;
        "pkg-2.0.2-fabric-1.20.1" = _LySDtMBQ;
        "pkg-2.0.2-forge-1.20.1" = _bhBAlwWp;
        "pkg-2.0.3-fabric-1.20.1" = _rtOtxr5P;
        "pkg-2.0.3-forge-1.20.1" = _eQOEXofz;
        "pkg-2.0.3-fabric-1.21.1" = _IwF3x6hd;
        "pkg-2.0.3-neoforge-1.21.1" = _1Qwp4Y3l;
        "pkg-2.0.4-neoforge-1.21.1" = _DN9ahK5L;
        "pkg-2.0.4-fabric-1.21.1" = _1RLRB9H8;
        "pkg-2.0.4-fabric-1.20.1" = _uC9wA6wc;
        "pkg-2.0.4-forge-1.20.1" = _Mv82Q2Wz;
        "pkg-2.0.5-1.21.1-neoforge" = _geWDjT70;
        "pkg-2.0.6-1.21.1-neoforge" = _Sc2VH15X;
        "pkg-2.0.6-1.21.1-fabric" = _4d1ylTxw;
        "pkg-2.0.6-1.20.1-fabric" = _j7O4WdKD;
        "pkg-2.0.6-1.20.1-forge" = _YgQL7JGS;
        "pkg-2.1.0-1.20.1-fabric" = _GoxfZd46;
        "pkg-2.1.0-1.20.1-forge" = _O4W7cYAp;
        "pkg-2.1.0-1.21.1-neoforge" = _yisqwP8p;
        "pkg-2.1.0-1.21.1-fabric" = _TktVh5UW;
        "pkg-2.2.0-1.20.1-fabric" = _110QAKBX;
        "pkg-2.2.0-1.20.1-forge" = _dOLwgFWf;
        "pkg-2.2.0-1.21.1-neoforge" = _WxI3Pnwu;
        "pkg-2.2.0-1.21.1-fabric" = _INn094q3;
        "pkg-2.2.1-1.21.1-neoforge" = _vaz2iO3l;
        "pkg-2.2.1-1.21.1-fabric" = _koaiH1pw;
        "pkg-2.2.1-1.20.1-fabric" = _pldSHZTN;
        "pkg-2.2.1-1.20.1-forge" = _MYZYVKNW;
        "pkg-2.3.0-1.20.1-fabric" = _X6ulZLrd;
        "pkg-2.3.0-1.20.1-forge" = _I4ey2ahc;
        "pkg-2.3.0-1.21.1-fabric" = _FPDAVd6i;
        "pkg-2.3.0-1.21.1-neoforge" = _ITyVhm4m;
        "pkg-2.3.1-1.20.1-fabric" = _NcR0Twym;
        "pkg-2.3.1-1.20.1-forge" = _AwZkevQm;
        "pkg-2.3.1-1.21.1-neoforge" = _A3HdX2AB;
        "pkg-2.3.1-1.21.1-fabric" = _CGWfElDA;
        "pkg-3.0.0-1.21.1-neoforge" = _Z9xqRijB;
        "pkg-3.0.0-1.21.1-fabric" = _ai4iQvtW;
        "pkg-3.0.0-1.20.1-fabric" = _Ce0ExIBd;
        "pkg-3.0.0-1.20.1-forge" = _NAUc6KIW;
        "pkg-3.1.0-1.20.1-fabric" = _cOhXMH30;
        "pkg-3.1.0-1.20.1-forge" = _Qhd2rZKA;
        "pkg-3.1.0-1.21.1-neoforge" = _2UN0BVoP;
        "pkg-3.1.0-1.21.1-fabric" = _y8S7eaQM;
        "pkg-3.2.0-1.20.1-fabric" = _gSHvDRLF;
        "pkg-3.2.0-1.20.1-forge" = _yTlnoaz8;
        "pkg-3.2.0-1.21.1-neoforge" = _9kfwI1Oc;
        "pkg-3.2.0-1.21.1-fabric" = _Vtxr2Xyu;
        "pkg-3.3.0-1.21.1-fabric" = _OBr1w2DB;
        "pkg-3.3.0-1.21.1-neoforge" = _BELRNzIg;
        "pkg-3.3.0-1.20.1-fabric" = _731J6skg;
        "pkg-3.3.0-1.20.1-forge" = _Qe30ksLJ;
        "pkg-3.3.1-1.20.1-forge" = _KTiyGfI2;
        "pkg-3.3.1-1.20.1-fabric" = _RVXAUrqh;
        "pkg-3.3.2-1.20.1-forge" = _5jrBVS34;
