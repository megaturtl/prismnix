...
let
    versions = (let
        ...
        _pnv86kjJ = {
            "id" = "pnv86kjJ";
            "file" = "lambdynamiclights-4.11.1+26.1.2.jar";
            "hash" = "sha512-dX+/xTufWDU/AWDAC2klYgiK5hHDxkF1mXad7KKDh0lrh3iobW1faCXLQmq1oSTHVuSmxmFNcRqykUH6CpD95w==";
        };
        _LCAMVAqE = {
            "id" = "LCAMVAqE";
            "file" = "lambdynamiclights-4.12.3+26.2.jar";
            "hash" = "sha512-c+3l8vm/6GlBYVVANX5PQHc870p2+FDRWM94lfm2e5PHMnVm4fvB47A94KQcGMuZcL05XkiDwRPK6QNQJR+3Qg==";
        };
        _ksaGCvSu = {
            "id" = "ksaGCvSu";
            "file" = "lambdynamiclights-4.8.11+1.21.1.jar";
            "hash" = "sha512-AoYHbospIt++kM1FRKDRbm0H1ySccyo3R56kKB6c+WyG3S4c5SYUib1VU866MwRLxVCgS561gmReuX8VycamTA==";
        };
        _USlEyPPR = {
            "id" = "USlEyPPR";
            "file" = "lambdynamiclights-4.11.2+26.1.2.jar";
            "hash" = "sha512-vZ8SpgsE+TQg0jr5s+F/uMkccFJzwCV967BE+WcvHovCNntZQb3CLcSNbMTzTlLkg/0HIVFgd7wFakfcPaVz1A==";
        };
        _XVsaQXSm = {
            "id" = "XVsaQXSm";
    ...
    in {
        ...
        "fabric-1.21" = _ksaGCvSu;
        "fabric-1.21.1" = _ksaGCvSu;
        ...
        "fabric-26.1" = _USlEyPPR;
        "fabric-26.1.1-rc-1" = _Nttq3ROe;
        "fabric-26.1.1" = _USlEyPPR;
        ...
        "quilt-1.21" = _ksaGCvSu;
        "quilt-1.21.1" = _ksaGCvSu;
        ...
        "quilt-26.1" = _USlEyPPR;
        "quilt-26.1.1-rc-1" = _Nttq3ROe;
        "quilt-26.1.1" = _USlEyPPR;
        ...
        "neoforge-26.1" = _USlEyPPR;
        "neoforge-26.1.1-rc-1" = _Nttq3ROe;
        "neoforge-26.1.1" = _USlEyPPR;
        ...
        "pkg-2.0.0+1.17" = _8zO3sewB;
        "pkg-2.0.1+1.17" = _s0scL0LW;
        "pkg-2.0.2+1.17" = _GiwO5rBh;
        "pkg-2.1.0+1.17" = _zhBXhMhZ;
        "pkg-2.1.2+1.19" = _Fp4gUsxF;
        "pkg-2.2.0+1.19.2" = _YQkZSlfq;
        "pkg-2.2.0+1.19.3" = _9E1ECN95;
        "pkg-2.3.0+1.19.4" = _7Cx8p05b;
        "pkg-2.3.1+1.19.4" = _85Jaf9ic;
        "pkg-2.3.1+1.20.1" = _Vsx4I8Np;
        "pkg-2.3.2+1.20.1" = _mYl4RvKg;
        "pkg-2.3.3+1.20.2" = _i6nks8QI;
        "pkg-2.3.4+1.20.4" = _mrQ8ZiyU;
        "pkg-3.0.0+1.21.1" = _TrEFTjdL;
        "pkg-3.0.1+1.21.1" = _jMgX3AR4;
        "pkg-3.1.0+1.21.1" = _JzkXlBqj;
        "pkg-3.2.0+1.21.2" = _ZOQT3Gug;
        "pkg-3.1.1+1.21.1" = _49xc9xjf;
        "pkg-3.2.1+1.21.3" = _Isx1ctPV;
        "pkg-3.1.2+1.21.1" = _f0UyHyXq;
        "pkg-3.2.2+1.21.3" = _EUvC0Bde;
        "pkg-3.1.3+1.21.1" = _iIqUfRsC;
        "pkg-3.2.3+1.21.3" = _4bBgnLVo;
        "pkg-3.1.4+1.21.1" = _MuAYXyhm;
        "pkg-3.2.4+1.21.3" = _7kUVMXJG;
        "pkg-4.0.0+1.21.4" = _WMLKo8fG;
        "pkg-4.0.1+1.21.4" = _YgZzYuBw;
        "pkg-4.0.2+1.20.1" = _aVrPgg7g;
        "pkg-4.0.2+1.21.1" = _ydDtxHg4;
        "pkg-4.0.2+1.21.3" = _q90MUWEF;
        "pkg-4.0.2+1.21.4" = _S2vkLTTc;
        "pkg-4.1.0+1.20.1" = _B4DKgMlC;
        "pkg-4.1.0+1.21.1" = _LafnJW4O;
        "pkg-4.1.0+1.21.3" = _93jUghXD;
        "pkg-4.1.0+1.21.4" = _Q9UNnRXZ;
        "pkg-4.2.1+1.21.5" = _Uz3e6n2Z;
        "pkg-4.2.2+1.21.5" = _Z18cdbej;
        "pkg-4.2.3+1.21.5" = _cLBceQhi;
        "pkg-4.1.1+1.20.1" = _X9iAcPW1;
        "pkg-4.1.1+1.21.1" = _lWd14y0a;
        "pkg-4.1.1+1.21.4" = _zqAHmLWD;
        "pkg-4.2.5+1.21.5" = _Vyr6lY2p;
        "pkg-4.1.2+1.20.1" = _XaLo388x;
        "pkg-4.1.2+1.21.1" = _kuX6nw8R;
        "pkg-4.1.2+1.21.4" = _Rb8r8pQh;
        "pkg-4.2.6+1.21.5" = _UPiFwTHO;
        "pkg-4.1.3+1.20.1" = _Zxi6kGDV;
        "pkg-4.1.3+1.21.1" = _DnQux4Yj;
        "pkg-4.1.3+1.21.4" = _zghzVa4c;
        "pkg-4.2.7+1.21.5" = _STvJaSpP;
        "pkg-4.3.0-rc.1+1.21.6" = _dVcIIt06;
        "pkg-4.3.0+1.21.6" = _eNZaVVBz;
        "pkg-4.1.4+1.20.1" = _evN5ygtI;
        "pkg-4.1.5+1.21.1" = _f44TfMoS;
        "pkg-4.2.9+1.21.5" = _sETXsa5R;
        "pkg-4.3.2+1.21.8" = _mOsadEfH;
        "pkg-4.1.6+1.21.1" = _kHMDe6RH;
        "pkg-4.2.10+1.21.5" = _Lb43VFLB;
        "pkg-4.3.3+1.21.8" = _Pruo0oqp;
        "pkg-4.4.0+1.20.1" = _AQfTnYyJ;
        "pkg-4.4.0+1.21.1" = _xIIck91M;
        "pkg-4.4.0+1.21.5" = _E9MjFbCQ;
        "pkg-4.4.0+1.21.8" = _UJKv2xon;
        "pkg-4.4.1+1.21.1" = _hbaMWHUD;
        "pkg-4.4.1+1.21.5" = _tpjbCH3V;
        "pkg-4.4.1+1.21.8" = _PcxqJePE;
        "pkg-4.5.0+1.21.1" = _pg0Mcyhz;
        "pkg-4.5.0+1.21.5" = _JNhqGmhp;
        "pkg-4.5.0+1.21.8" = _cqMbYiA0;
        "pkg-4.5.1+1.21.1" = _tMMmq78U;
        "pkg-4.5.1+1.21.5" = _x1tyjNIj;
        "pkg-4.5.1+1.21.8" = _HUOsmfdx;
        "pkg-4.6.0+1.21.1" = _ek5rzUjz;
        "pkg-4.6.0+1.21.5" = _j3cuxtH7;
        "pkg-4.6.0+1.21.8" = _JWfjD8sk;
        "pkg-4.7.0+1.21.9" = _PrqOK0ad;
        "pkg-4.7.1+1.21.5" = _CtHOLS71;
        "pkg-4.7.1+1.21.8" = _WeJU00Fo;
        "pkg-4.7.1+1.21.9" = _Jn02a4tl;
        "pkg-4.7.2+1.21.1" = _79RTTQyI;
        "pkg-4.7.2+1.21.5" = _niOzyNOc;
        "pkg-4.7.2+1.21.8" = _v58Ee3fD;
        "pkg-4.7.2+1.21.9" = _41vCkc8N;
        "pkg-4.8.1+1.21.1" = _jl1kfnzm;
        "pkg-4.8.1+1.21.5" = _d3DzM1Qp;
        "pkg-4.8.1+1.21.8" = _kN0ghiED;
        "pkg-4.8.1+1.21.10" = _LeQppDds;
        "pkg-4.8.2+1.21.1" = _1hFmOd02;
        "pkg-4.8.2+1.21.5" = _YxG4Ocnj;
        "pkg-4.8.2+1.21.8" = _b9sK3Xil;
        "pkg-4.8.2+1.21.10" = _KwjvfUzt;
        "pkg-4.9.0-alpha.1+25w41a" = _c52sf24i;
        "pkg-4.8.3+1.21.1" = _diUhlhpb;
        "pkg-4.8.3+1.21.5" = _xQyw7K8g;
        "pkg-4.8.3+1.21.8" = _Mw0gKP7c;
        "pkg-4.8.3+1.21.10" = _vAEdE1bk;
        "pkg-4.8.4+1.21.1" = _UKOTbtYN;
        "pkg-4.8.4+1.21.5" = _Rdf8MbFs;
        "pkg-4.8.4+1.21.8" = _BQdvq3g2;
        "pkg-4.8.4+1.21.10" = _dSf75Gs7;
        "pkg-4.9.0-alpha.2+25w42a" = _nn0V3chF;
        "pkg-4.8.5+1.21.1" = _b1OtBmOJ;
        "pkg-4.8.5+1.21.5" = _bB3RVUx0;
        "pkg-4.8.5+1.21.8" = _FToB9HT1;
        "pkg-4.8.5+1.21.10" = _bORAMbLk;
        "pkg-4.8.6+1.21.1" = _jo8kVG44;
        "pkg-4.8.6+1.21.8" = _foMsxsVt;
        "pkg-4.8.6+1.21.10" = _BRdrLWGs;
        "pkg-4.9.0-alpha.3+25w45a" = _UeHhwW4C;
        "pkg-4.8.7+1.21.1" = _CQuTG9xY;
        "pkg-4.8.7+1.21.5" = _1DmwErAj;
        "pkg-4.8.7+1.21.8" = _6Bz5yiB2;
        "pkg-4.8.7+1.21.10" = _QEjgcnZG;
        "pkg-4.9.0-rc.1+1.21.11" = _wYDuQ0Qi;
        "pkg-4.9.0+1.21.11" = _z5t9q8Gz;
        "pkg-4.9.1+1.21.11" = _5Tp7kdU0;
        "pkg-4.10.0-alpha.1+26.1-snapshot-6" = _KFDLOexl;
        "pkg-4.10.0-rc.1+26.1" = _DOvPjwGz;
        "pkg-4.10.0+26.1" = _Nttq3ROe;
        "pkg-4.10.1+26.1.1" = _XrvvtEB5;
        "pkg-4.8.8+1.21.1" = _IQcvNDtF;
        "pkg-4.10.2+26.1.2" = _UnhzVQJV;
        "pkg-4.8.9+1.21.1" = _nztg2oS2;
        "pkg-4.10.3+26.1.2" = _w3QfTqbn;
        "pkg-4.11.0+26.1.2" = _NYmekdmx;
        "pkg-4.12.0+26.2" = _ZSDGIboY;
        "pkg-4.12.1+26.2" = _ExB2q9K7;
        "pkg-4.8.10+1.21.1" = _DZDOX6ps;
        "pkg-4.12.2+26.2" = _jBLH7Qy8;
        "pkg-4.11.1+26.1.2" = _pnv86kjJ;
        "pkg-4.12.3+26.2" = _LCAMVAqE;
