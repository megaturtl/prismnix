...
let
    versions = (let
        ...
        _GoVUGAil = {
            "id" = "GoVUGAil";
            "file" = "GD-BetterLoot_v1.4.0-1.21+_DP.zip";
            "hash" = "sha512-Nb1hMQLxC5351YmrA/cnCnY4ATtqXtGEUC1I+EtaXJDXWJkdyDrxJZ0ClOsw0Lxi3pQxh2rY2Nj+5zYhkw1Wgw==";
        };
        _v7KHV0XB = {
            "id" = "v7KHV0XB";
            "file" = "GD-BetterLoot_v1.4.0-1.21+_Mod.jar";
            "hash" = "sha512-pkz2bkuApaYPwkwnxJxal+ch1wR8Oj3z6f4K/leLanyzjYKDxUUhwPuDQRDslP9zMb6xsGDsDdnN845jcvYY5Q==";
        };
    in {
        "mLQdKV49" = _mLQdKV49;
        "nf7fNi7G" = _nf7fNi7G;
        ...
        "datapack-1.21.9" = _GoVUGAil;
        "datapack-1.21.10" = _GoVUGAil;
        "datapack-1.21.11" = _GoVUGAil;
        "datapack-26.1" = _GoVUGAil;
        "datapack-26.1.1" = _GoVUGAil;
        "datapack-26.1.2" = _GoVUGAil;
        "datapack-26.2" = _GoVUGAil;
        ...
        "fabric-1.21.9" = _v7KHV0XB;
        "fabric-1.21.10" = _v7KHV0XB;
        "fabric-1.21.11" = _v7KHV0XB;
        "fabric-26.1" = _v7KHV0XB;
        "fabric-26.1.1" = _v7KHV0XB;
        "fabric-26.1.2" = _v7KHV0XB;
        "fabric-26.2" = _v7KHV0XB;
        ...
        "forge-1.21.9" = _v7KHV0XB;
        "forge-1.21.10" = _v7KHV0XB;
        "forge-1.21.11" = _v7KHV0XB;
        "forge-26.1" = _v7KHV0XB;
        "forge-26.1.1" = _v7KHV0XB;
        "forge-26.1.2" = _v7KHV0XB;
        "forge-26.2" = _v7KHV0XB;
        ...
        "neoforge-1.21.9" = _v7KHV0XB;
        "neoforge-1.21.10" = _v7KHV0XB;
        "neoforge-1.21.11" = _v7KHV0XB;
        "neoforge-26.1" = _v7KHV0XB;
        "neoforge-26.1.1" = _v7KHV0XB;
        "neoforge-26.1.2" = _v7KHV0XB;
        "neoforge-26.2" = _v7KHV0XB;
        ...
        "quilt-1.21.9" = _v7KHV0XB;
        "quilt-1.21.10" = _v7KHV0XB;
        "quilt-1.21.11" = _v7KHV0XB;
        "quilt-26.1" = _v7KHV0XB;
        "quilt-26.1.1" = _v7KHV0XB;
        "quilt-26.1.2" = _v7KHV0XB;
        "quilt-26.2" = _v7KHV0XB;
        "pkg-1.0b1" = _nf7fNi7G;
        "pkg-1.0b2" = _PlhdPrT0;
        "pkg-1.0b3" = _VTTpcgQJ;
        "pkg-1.0b4" = _KlKIZvoP;
