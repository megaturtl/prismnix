...
let
    versions = (let
        ...
        _MkDAK8k3 = {
            "id" = "MkDAK8k3";
            "file" = "TradeSpire-1.5.jar";
            "hash" = "sha512-sn+LM5SfX64sppanFeOuM40HaOhbe2fvBe9TC+OqY6YuR7MuY5Hnlt3PXQGzll1KGdl/6atZq+KZvB6cb7LZ5g==";
        };
    in {
        "1Qddcm90" = _1Qddcm90;
        "eKziC8gh" = _eKziC8gh;
        ...
        "bukkit-1.21" = _MkDAK8k3;
        "bukkit-1.21.1" = _MkDAK8k3;
        "bukkit-1.21.2" = _MkDAK8k3;
        "bukkit-1.21.3" = _MkDAK8k3;
        "bukkit-1.21.4" = _MkDAK8k3;
        "bukkit-1.21.5" = _MkDAK8k3;
        "bukkit-1.21.6" = _MkDAK8k3;
        "bukkit-1.21.7" = _MkDAK8k3;
        "bukkit-1.21.8" = _MkDAK8k3;
        "bukkit-1.21.9" = _MkDAK8k3;
        "bukkit-1.21.10" = _MkDAK8k3;
        "bukkit-1.21.11" = _MkDAK8k3;
        "bukkit-26.1" = _MkDAK8k3;
        "bukkit-26.1.1" = _MkDAK8k3;
        "bukkit-26.1.2" = _MkDAK8k3;
        "bukkit-26.2" = _MkDAK8k3;
        "bukkit-26.3" = _MkDAK8k3;
        ...
        "paper-1.21" = _MkDAK8k3;
        "paper-1.21.1" = _MkDAK8k3;
        "paper-1.21.2" = _MkDAK8k3;
        "paper-1.21.3" = _MkDAK8k3;
        "paper-1.21.4" = _MkDAK8k3;
        "paper-1.21.5" = _MkDAK8k3;
        "paper-1.21.6" = _MkDAK8k3;
        "paper-1.21.7" = _MkDAK8k3;
        "paper-1.21.8" = _MkDAK8k3;
        "paper-1.21.9" = _MkDAK8k3;
        "paper-1.21.10" = _MkDAK8k3;
        "paper-1.21.11" = _MkDAK8k3;
        "paper-26.1" = _MkDAK8k3;
        "paper-26.1.1" = _MkDAK8k3;
        "paper-26.1.2" = _MkDAK8k3;
        "paper-26.2" = _MkDAK8k3;
        "paper-26.3" = _MkDAK8k3;
        ...
        "spigot-1.21" = _MkDAK8k3;
        "spigot-1.21.1" = _MkDAK8k3;
        "spigot-1.21.2" = _MkDAK8k3;
        "spigot-1.21.3" = _MkDAK8k3;
        "spigot-1.21.4" = _MkDAK8k3;
        "spigot-1.21.5" = _MkDAK8k3;
        "spigot-1.21.6" = _MkDAK8k3;
        "spigot-1.21.7" = _MkDAK8k3;
        "spigot-1.21.8" = _MkDAK8k3;
        "spigot-1.21.9" = _MkDAK8k3;
        "spigot-1.21.10" = _MkDAK8k3;
        "spigot-1.21.11" = _MkDAK8k3;
        "spigot-26.1" = _MkDAK8k3;
        "spigot-26.1.1" = _MkDAK8k3;
        "spigot-26.1.2" = _MkDAK8k3;
        "spigot-26.2" = _MkDAK8k3;
        "spigot-26.3" = _MkDAK8k3;
