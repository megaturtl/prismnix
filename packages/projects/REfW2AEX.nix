...
let
    versions = (let
        ...
        _AtftB9Jj = {
            "id" = "AtftB9Jj";
            "file" = "InvMove-0.9.6+26.1.2-Fabric.jar";
            "hash" = "sha512-6T8MgIec8lMI8jU6se+EE6S4M5prxRkFImqSq5pczBx8wPdV0EJ2A+QIcbO67WjXT1e2FoP3hNZ0gQ+0PzEexA==";
        };
        _VFFU6Lfs = {
            "id" = "VFFU6Lfs";
            "file" = "InvMove-0.9.6+26.2-Fabric.jar";
            "hash" = "sha512-u+CeSSx8H3G+mDRzBtJHKWjMCd6tcw587CBCbup/lVHqfv7sGVMBx31qb5ox5IAApuT12iuZ9EcISOr35FByqg==";
        };
        _wjZzQM0p = {
            "id" = "wjZzQM0p";
            "file" = "InvMove-0.9.6+26.3-Fabric.jar";
            "hash" = "sha512-mSQomYx+BeKHsMNqCUvRQEyYSYnGywjcIQG+ElM4rU1RPPw53mwlTdmmys2Tfp7JhvsQ2B+ajYFXqwiPR2uHdA==";
        };
        _PFXabMOy = {
            "id" = "PFXabMOy";
            "file" = "InvMove-0.9.6+26.1.2-NeoForge.jar";
            "hash" = "sha512-vVY4jXOtHdXztmGapzH8UeE5ADvuX9/t8IKKPk25MZG8BJqXTVp+idHFPmv2MHXJaVmBWARUNyPlDEf7CJhGvg==";
        };
        _yap3t6X4 = {
            "id" = "yap3t6X4";
            "file" = "InvMove-0.9.6+26.2-NeoForge.jar";
            "hash" = "sha512-3JxoMNSSLla2aBq2eSsRrKFe3uITySszCvTc/+d/Dz42iuiFZL19gnjpgGQzfoYoK1lwJg/9kDx9U3Nx8LdtUQ==";
        };
        _n5kkRukL = {
            "id" = "n5kkRukL";
            "file" = "InvMove-0.9.6+26.3-NeoForge.jar";
            "hash" = "sha512-kdI1HvcFkdER7YQhGO6pw/Gg4O5nWnPC7SVX4X7wK3CmtDMsZ0Cb0Iv37AqR4/YFlNgmtE75U8wEKBZ7On6eTg==";
        };
    in {
        "g6dHjPlj" = _g6dHjPlj;
        "Nw08AijY" = _Nw08AijY;
        ...
        "fabric-26.1" = _AtftB9Jj;
        "fabric-26.1.1" = _AtftB9Jj;
        "fabric-26.1.2" = _AtftB9Jj;
        "fabric-26.2" = _VFFU6Lfs;
        "fabric-26.3" = _wjZzQM0p;
        ...
        "neoforge-26.1" = _PFXabMOy;
        "neoforge-26.1.1" = _PFXabMOy;
        "neoforge-26.1.2" = _PFXabMOy;
        "neoforge-26.2" = _yap3t6X4;
        "neoforge-26.3" = _n5kkRukL;
        "pkg-1.18-0.5.0-fabric" = _g6dHjPlj;
        "pkg-1.18-0.5.0-forge" = _Nw08AijY;
        "pkg-1.18-0.6.0-forge" = _zSjRFisS;
        "pkg-1.18-0.6.0-fabric" = _KlCCrdyH;
        "pkg-1.18-0.6.1-fabric" = _z1wUcYrz;
        "pkg-1.18-0.6.1-forge" = _Rowb4urF;
        "pkg-1.18-0.6.2-fabric" = _FxtmKzFE;
        "pkg-1.18-0.6.2-forge" = _nyLttvyA;
        "pkg-1.18-0.7.0-fabric" = _2PM0Ne3I;
        "pkg-1.18-0.7.0-forge" = _mXm80CHn;
        "pkg-1.16-0.8.0-fabric" = _nc2YXBFR;
        "pkg-1.16-0.8.0-forge" = _ZUUyXFpC;
        "pkg-1.18-0.8.0-quilt" = _KZODMPL5;
        "pkg-1.18-0.8.0-fabric" = _YglVnx4G;
        "pkg-1.18-0.8.0-forge" = _AvfVeby1;
        "pkg-1.19-0.8.0-quilt" = _aarEmm3o;
        "pkg-1.19-0.8.0-fabric" = _VgnPhVTW;
        "pkg-1.19-0.8.0-forge" = _Clo0PUhb;
        "pkg-1.16-0.8.1-fabric" = _FlJXgCDA;
        "pkg-1.16-0.8.1-forge" = _ODrlrF3Z;
        "pkg-1.18-0.8.1-fabric" = _whx4cyXm;
        "pkg-1.18-0.8.1-quilt" = _DjMssqvc;
        "pkg-1.18-0.8.1-forge" = _FJ91FXja;
        "pkg-1.19-0.8.1-fabric" = _O575lNuT;
        "pkg-1.19-0.8.1-quilt" = _dGo1L388;
        "pkg-1.19-0.8.1-forge" = _2tK5XdF0;
        "pkg-1.16-0.8.2-fabric" = _um5St4s3;
        "pkg-1.16-0.8.2-forge" = _u2qv60JQ;
        "pkg-1.18-0.8.2-fabric" = _sVkuPH9Y;
        "pkg-1.18-0.8.2-quilt" = _qTu058ya;
        "pkg-1.18-0.8.2-forge" = _gn5FSncy;
        "pkg-1.19-0.8.2-fabric" = _sWRkeaiE;
        "pkg-1.19-0.8.2-quilt" = _LG7n0kA8;
        "pkg-1.19-0.8.2-forge" = _RKDVymOM;
        "pkg-1.16-0.8.3-fabric" = _UTuW1mu8;
        "pkg-1.16-0.8.3-forge" = _RsLNtqpA;
        "pkg-1.18-0.8.3-fabric" = _H2moqgPv;
        "pkg-1.18-0.8.3-quilt" = _kzI0tILB;
        "pkg-1.18-0.8.3-forge" = _2sYsuomN;
        "pkg-1.19-0.8.3-fabric" = _1uJ8OF0p;
        "pkg-1.19-0.8.3-quilt" = _Q59zS7Fb;
        "pkg-1.19-0.8.3-forge" = _NudOSeIR;
        "pkg-1.19-0.8.3a-forge" = _L9gZxJNb;
        "pkg-1.18-0.8.3a-forge" = _VE4bOg3y;
        "pkg-1.16-0.8.3a-forge" = _WzbaGwer;
        "pkg-1.16-0.8.4-fabric" = _pfLgaUxC;
        "pkg-1.16-0.8.4-forge" = _hrMnbArx;
        "pkg-1.18-0.8.4-fabric" = _920571eR;
        "pkg-1.18-0.8.4-quilt" = _h6ELnOF4;
        "pkg-1.18-0.8.4-forge" = _JxGn75dh;
        "pkg-1.19-0.8.4-fabric" = _vk2Y8XQV;
        "pkg-1.19-0.8.4-quilt" = _WIXovitR;
        "pkg-1.19-0.8.4-forge" = _AE0sDDm3;
        "pkg-1.20-0.8.4-fabric" = _W5h8ZaUy;
        "pkg-1.20-0.8.4-quilt" = _kqq0UN1u;
        "pkg-1.20-0.8.4-forge" = _6CNOChud;
        "pkg-1.20-0.8.5-fabric" = _1BZ0wHLG;
        "pkg-1.20-0.8.5-quilt" = _LGhnGid6;
        "pkg-1.20-0.8.5-forge" = _VSooa0oK;
        "pkg-1.20-0.8.6-fabric" = _qlq09IgJ;
        "pkg-1.20-0.8.6-quilt" = _iiUJSWK2;
        "pkg-1.21-0.8.7-fabric" = _rppVtrEO;
        "pkg-1.21-0.8.7-neoforge" = _ZGPw3w38;
        "pkg-1.21-0.8.8-fabric" = _FcdIvKru;
        "pkg-1.21-0.8.8-neoforge" = _ciO3M5kB;
        "pkg-1.20-0.8.6-forge" = _Z2eGw8Et;
        "pkg-0.9.0+1.21.1-neoforge" = _aKvh9sK2;
        "pkg-0.9.0+1.21.4-neoforge" = _gjlYoSmi;
        "pkg-0.9.0+1.21.3-neoforge" = _ZWdz09wT;
        "pkg-0.9.0+1.20.6-neoforge" = _hiT9efk5;
        "pkg-0.9.0+1.20.4-neoforge" = _nB82rLVj;
        "pkg-0.9.0+1.20.1-forge" = _8f2ZTI5U;
        "pkg-0.9.0+1.19.4-forge" = _i1v7Jpy1;
        "pkg-0.9.0+1.18.2-forge" = _iGuphgM3;
        "pkg-0.9.0+1.17.1-forge" = _1DdhTrwV;
        "pkg-0.9.0+1.16.5-forge" = _Ixpr8N4p;
        "pkg-0.9.0+1.21.4-fabric" = _Km5p4Rik;
        "pkg-0.9.0+1.21.3-fabric" = _sgX2qVn6;
        "pkg-0.9.0+1.21.1-fabric" = _4q5KJDfw;
        "pkg-0.9.0+1.20.6-fabric" = _wxREmKNx;
        "pkg-0.9.0+1.20.4-fabric" = _Rtwpu2tL;
        "pkg-0.9.0+1.20.1-fabric" = _d0UU2F0u;
        "pkg-0.9.0+1.19.4-fabric" = _aEu014PS;
        "pkg-0.9.0+1.18.2-fabric" = _mTFJdtmY;
        "pkg-0.9.0+1.16.5-fabric" = _I72TGtJd;
        "pkg-0.9.0+1.17.1-fabric" = _qpInV1Ym;
        "pkg-0.9.1+1.21.8-neoforge" = _HxGeaP9a;
        "pkg-0.9.1+1.21.3-neoforge" = _eSrRdQux;
        "pkg-0.9.1+1.21.10-neoforge" = _DGmC9Iw6;
        "pkg-0.9.1+1.21.1-neoforge" = _uLbFCiwE;
        "pkg-0.9.1+1.20.4-neoforge" = _MafmOVH8;
        "pkg-0.9.1+1.20.6-neoforge" = _nbE3vHin;
        "pkg-0.9.1+1.20.1-forge" = _4ezsLW9u;
        "pkg-0.9.1+1.19.4-forge" = _6lM1fEsP;
        "pkg-0.9.1+1.18.2-forge" = _xiFq6u5T;
        "pkg-0.9.1+1.17.1-forge" = _v1IVp500;
        "pkg-0.9.1+1.16.5-forge" = _n6IXFNAI;
        "pkg-0.9.1+1.21.8-fabric" = _8ovblj8v;
        "pkg-0.9.1+1.21.3-fabric" = _hIuQBV1E;
        "pkg-0.9.1+1.21.10-fabric" = _9Ipd7bhg;
        "pkg-0.9.1+1.21.1-fabric" = _6UFvmf9a;
        "pkg-0.9.1+1.20.6-fabric" = _I0poxLeY;
        "pkg-0.9.1+1.20.4-fabric" = _TuSY4UWx;
        "pkg-0.9.1+1.20.1-fabric" = _GRWRJ4Kc;
        "pkg-0.9.1+1.19.4-fabric" = _EPxjt7pK;
        "pkg-0.9.1+1.18.2-fabric" = _qOrlP7Iv;
        "pkg-0.9.1+1.17.1-fabric" = _J2lm4Cr8;
        "pkg-0.9.1+1.16.5-fabric" = _cPd3OzBo;
        "pkg-0.9.2+1.21.8-neoforge" = _cMCZq8uX;
        "pkg-0.9.2+1.21.3-neoforge" = _iSvvPzdB;
        "pkg-0.9.2+1.21.10-neoforge" = _n9lou8Oh;
        "pkg-0.9.2+1.21.1-neoforge" = _umgyEQXr;
        "pkg-0.9.2+1.20.6-neoforge" = _Aa4UZauy;
        "pkg-0.9.2+1.20.4-neoforge" = _RfXeMwsR;
        "pkg-0.9.2+1.20.1-forge" = _G1ab6lrz;
        "pkg-0.9.2+1.19.4-forge" = _VmIASKVb;
        "pkg-0.9.2+1.18.2-forge" = _OUMqWa8u;
        "pkg-0.9.2+1.17.1-forge" = _NqyRZPQb;
        "pkg-0.9.2+1.16.5-forge" = _fZgPiXMc;
        "pkg-0.9.2+1.21.8-fabric" = _U33UfFnW;
        "pkg-0.9.2+1.21.3-fabric" = _FnJuviy3;
        "pkg-0.9.2+1.21.10-fabric" = _Jpp8qWYf;
        "pkg-0.9.2+1.21.1-fabric" = _yQ1pAM9D;
        "pkg-0.9.2+1.20.6-fabric" = _XugFIQy9;
        "pkg-0.9.2+1.20.4-fabric" = _ZkvjHoy5;
        "pkg-0.9.2+1.20.1-fabric" = _FF4dNbtV;
        "pkg-0.9.2+1.19.4-fabric" = _sUKVwPSt;
        "pkg-0.9.2+1.18.2-fabric" = _HuzfYMuo;
        "pkg-0.9.2+1.17.1-fabric" = _ZSQRyFsq;
        "pkg-0.9.2+1.16.5-fabric" = _7OnYGKUs;
        "pkg-0.9.3+1.21.8-neoforge" = _LA88Ilun;
        "pkg-0.9.3+1.21.3-neoforge" = _le70JEAu;
        "pkg-0.9.3+1.21.11-neoforge" = _jR4Xgj72;
        "pkg-0.9.3+1.21.10-neoforge" = _QVW2AmdT;
        "pkg-0.9.3+1.21.1-neoforge" = _C7ePwvWW;
        "pkg-0.9.3+1.20.6-neoforge" = _IAXYKOTB;
        "pkg-0.9.3+1.20.4-neoforge" = _hzGBKQ4G;
        "pkg-0.9.3+1.20.1-forge" = _RLzFQg0l;
        "pkg-0.9.3+1.19.4-forge" = _DHeKqNRO;
        "pkg-0.9.3+1.18.2-forge" = _gg1Z5QRH;
        "pkg-0.9.3+1.17.1-forge" = _UuV7j6N9;
        "pkg-0.9.3+1.16.5-forge" = _vkVtgcE8;
        "pkg-0.9.3+1.21.8-fabric" = _C5mCFkLM;
        "pkg-0.9.3+1.21.3-fabric" = _ZQ0i5O6G;
        "pkg-0.9.3+1.21.11-fabric" = _gU3PoQLk;
        "pkg-0.9.3+1.21.10-fabric" = _V6kvp3lP;
        "pkg-0.9.3+1.21.1-fabric" = _nOwgsiRT;
        "pkg-0.9.3+1.20.6-fabric" = _6Vmyw0kS;
        "pkg-0.9.3+1.20.4-fabric" = _TbNOoUOK;
        "pkg-0.9.3+1.20.1-fabric" = _66wsDJTD;
        "pkg-0.9.3+1.19.4-fabric" = _sZVFOfci;
        "pkg-0.9.3+1.18.2-fabric" = _ZI8YSXEx;
        "pkg-0.9.3+1.17.1-fabric" = _WbKt8JCf;
        "pkg-0.9.3+1.16.5-fabric" = _owptTpwV;
        "pkg-0.9.4+26.1-fabric" = _2g1FxCzc;
        "pkg-0.9.4+26.1-neoforge" = _hlswdHNe;
        "pkg-0.9.5+26.1.2-fabric" = _O4AcyiAr;
        "pkg-0.9.5+26.2-fabric" = _yGtwx8GD;
        "pkg-0.9.5+26.1.2-neoforge" = _dl7078oQ;
        "pkg-0.9.5+26.2-neoforge" = _jitGFF6K;
        "pkg-0.9.6+26.1.2-fabric" = _AtftB9Jj;
        "pkg-0.9.6+26.2-fabric" = _VFFU6Lfs;
        "pkg-0.9.6+26.3-fabric" = _wjZzQM0p;
        "pkg-0.9.6+26.1.2-neoforge" = _PFXabMOy;
        "pkg-0.9.6+26.2-neoforge" = _yap3t6X4;
        "pkg-0.9.6+26.3-neoforge" = _n5kkRukL;
        "default" = _n5kkRukL;
    });
