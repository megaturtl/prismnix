...
let
    ...
    in {
        ...
        "pkg-1.19.4-0.1.3" = _46BxKyVe;
        "pkg-1.19.4-0.1.4" = _nC8t0Vm4;
        "pkg-1.19.4-0.1.4.1" = _sWb8frbJ;
        "pkg-1.19.2-0.1.4.1" = _TByHUUVh;
        "pkg-1.19.2-0.1.4.1_01" = _pdbY8ked;
        "pkg-1.19.4-0.1.5" = _5Ev2nvYs;
        "pkg-1.19.2-0.1.5" = _N4txlsEL;
        "pkg-1.19.4-1.0.0" = _lBTEf4cF;
        "pkg-1.19.2-1.0.0" = _xQ7KXi2a;
        "pkg-1.19.2-1.0.1" = _AMX7zetp;
        "pkg-1.18.2-1.0.1" = _5CwUg3DW;
        "pkg-1.19.2-1.1.0" = _ntrdkWm3;
        "pkg-1.19.4-1.1.0" = _fhrVWOVB;
        "pkg-1.19.2-1.1.1" = _GuAQef1C;
        "pkg-1.19.4-1.1.1" = _maf5uttd;
        "pkg-1.19.2-1.1.2" = _RePHSl5T;
        "pkg-1.19.4-1.1.2" = _kbJhvk5L;
        "pkg-1.19.2-1.2.0" = _Qh3a3Cak;
        "pkg-1.19.4-1.2.0" = _BqoSVKGW;
        "pkg-1.20.1-1.2.1" = _uoM1p0rN;
        "pkg-1.19.2-1.2.2" = _LOssqTh0;
        "pkg-1.19.4-1.2.2" = _M21KnNaA;
        "pkg-1.20.1-1.2.2" = _eYVUJ2Uf;
        "pkg-1.2.2-1.19.2" = _nn181664;
        "pkg-1.19.2-1.3.0" = _6o9bd9A0;
        "pkg-1.20.1-1.3.0" = _6cw6Wk78;
        "pkg-1.3.0-1.19.2" = _RIwVK73J;
        "pkg-1.3.0.1-1.19.2" = _6ba0yV3F;
        "pkg-1.19.2-1.3.0.1" = _4TtSilIT;
        "pkg-1.20.1-1.3.0.1" = _E62OSUxx;
        "pkg-1.3.0.2-1.19.2" = _TuzzbchA;
        "pkg-1.20.1-1.4" = _qA44LSBh;
        "pkg-1.18.2-1.4" = _9AYxLRHL;
        "pkg-1.20.1-1.4.1" = _1sxrekvt;
        "pkg-1.4.2-1.18.2" = _w6HTLiv7;
        "pkg-1.4.2-1.19.2" = _soVP5fyv;
        "pkg-1.4.2-1.20.1" = _RhpjzrSI;
        "pkg-1.18.2-1.4.2" = _umdGFGbc;
        "pkg-1.20.1-1.4.2" = _qvGf947K;
        "pkg-1.4.3-1.20.2" = _PFd1KDh0;
        "pkg-1.20.2-1.4.3" = _58CaeDCd;
        "pkg-1.20.1-1.4.4" = _lADJjVte;
        "pkg-1.20.1-1.5" = _buYAlXwz;
        "pkg-1.18.2-1.5.0" = _mtJHSk76;
        "pkg-1.20.1-1.5.0" = _rvXeG9Ba;
        "pkg-1.20.1-1.5.1" = _JTHHm5LS;
        "pkg-1.20.1-2.0.0" = _WIJBCQMq;
        "pkg-1.20.1-2.0.1" = _1Z2SeeSN;
        "pkg-1.20.1-2.0.2" = _MyNZz2kS;
        "pkg-1.20.1-2.0.3" = _5GCWbUCK;
        "pkg-1.19.2-2.0.3" = _vTS1H8HL;
        "pkg-1.20.1-2.0.4" = _GfoMtIHC;
        "pkg-1.19.2-2.0.3.1" = _BJepfy5n;
        "pkg-1.20.1-2.1.0" = _XrcpXMjb;
        "pkg-1.20.1-2.1.1" = _sC1CbDOQ;
        "pkg-1.20.1-2.1.2" = _KHM54Ggo;
        "pkg-1.20.1-2.1.3" = _4AKn2Kyz;
        "pkg-1.20.1-2.1.4" = _bMOLeMXi;
        "pkg-1.20.1-2.2.0" = _KnoJHy7y;
        "pkg-1.20.1-3.0.0" = _F0j0X8VQ;
        "pkg-1.20.1-3.0.1" = _sYPHecx6;
        "pkg-3.1.0" = _oEwlZhRP;
        "pkg-3.2.0" = _S2E287C2;
        "pkg-3.2.1" = _YWoyC7E0;
        "pkg-3.2.2" = _judqn8WC;
        ...
        "pkg-3.2.9" = _zluSRLMV;
        "pkg-3.3.7" = _1BGnCszC;
        "pkg-3.2.11" = _2yU9uRBE;
        "pkg-3.3.9" = _jT1497OD;
        "pkg-3.3.10" = _rLXfiyI1;
        "pkg-3.2.12" = _sE4gKdBz;
        "pkg-3.2.13" = _8ny9DifY;
        "pkg-4.0.0" = _i8CXqgFa;
        "pkg-4.0.1" = _Z6nG4rGU;
        "pkg-4.0.2" = _GeGkzRRV;
        "pkg-4.0.3" = _s7A9sipv;
