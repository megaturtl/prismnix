...
let
    versions = (let
        ...
        _KiUBqtMu = {
            "id" = "KiUBqtMu";
            "file" = "Animated-Minerals-0.5.12+mc1.20-26.3.zip";
            "hash" = "sha512-iYE6tQ5SE3tEYLIxwfFtdg2xwmJqMHmONAFjiwPv/dFqy+/01jzFLUtXxD5IzIpOjiALXC4dF59I1rUx/sR/kg==";
        };
    in {
        "dxY52qbw" = _dxY52qbw;
        "9sgiS9vw" = _9sgiS9vw;
        ...
        "minecraft-1.20" = _KiUBqtMu;
        "minecraft-1.20.1" = _KiUBqtMu;
        "minecraft-1.20.2" = _KiUBqtMu;
        "minecraft-1.20.3" = _KiUBqtMu;
        "minecraft-1.20.4" = _KiUBqtMu;
        "minecraft-1.20.5" = _KiUBqtMu;
        "minecraft-1.20.6" = _KiUBqtMu;
        "minecraft-1.21" = _KiUBqtMu;
        "minecraft-1.21.1" = _KiUBqtMu;
        "minecraft-1.21.2" = _KiUBqtMu;
        "minecraft-1.21.3" = _KiUBqtMu;
        "minecraft-1.21.4" = _KiUBqtMu;
        "minecraft-1.21.5" = _KiUBqtMu;
        "minecraft-1.21.6" = _KiUBqtMu;
        "minecraft-1.21.7" = _KiUBqtMu;
        "minecraft-1.21.8" = _KiUBqtMu;
        "minecraft-1.21.9" = _KiUBqtMu;
        "minecraft-1.21.10" = _KiUBqtMu;
        "minecraft-1.21.11" = _KiUBqtMu;
        "minecraft-23w31a" = _KiUBqtMu;
        "minecraft-23w32a" = _KiUBqtMu;
        "minecraft-23w33a" = _KiUBqtMu;
        "minecraft-23w35a" = _KiUBqtMu;
        "minecraft-1.20.2-pre1" = _KiUBqtMu;
        "minecraft-23w42a" = _KiUBqtMu;
        "minecraft-23w43a" = _KiUBqtMu;
        "minecraft-23w43b" = _KiUBqtMu;
        "minecraft-23w44a" = _KiUBqtMu;
        "minecraft-23w45a" = _KiUBqtMu;
        "minecraft-23w46a" = _KiUBqtMu;
        "minecraft-24w03a" = _KiUBqtMu;
        "minecraft-24w03b" = _KiUBqtMu;
        "minecraft-24w04a" = _KiUBqtMu;
        "minecraft-24w05a" = _KiUBqtMu;
        "minecraft-24w05b" = _KiUBqtMu;
        "minecraft-24w06a" = _KiUBqtMu;
        "minecraft-24w07a" = _KiUBqtMu;
        "minecraft-24w09a" = _KiUBqtMu;
        "minecraft-24w10a" = _KiUBqtMu;
        "minecraft-24w11a" = _KiUBqtMu;
        "minecraft-24w12a" = _KiUBqtMu;
        "minecraft-24w13a" = _KiUBqtMu;
        "minecraft-24w14potato" = _KiUBqtMu;
        "minecraft-24w14a" = _KiUBqtMu;
        "minecraft-1.20.5-pre1" = _KiUBqtMu;
        "minecraft-1.20.5-pre2" = _KiUBqtMu;
        "minecraft-1.20.5-pre3" = _KiUBqtMu;
        "minecraft-24w18a" = _KiUBqtMu;
        "minecraft-24w19a" = _KiUBqtMu;
        "minecraft-24w19b" = _KiUBqtMu;
        "minecraft-24w20a" = _KiUBqtMu;
        "minecraft-24w33a" = _KiUBqtMu;
        "minecraft-24w34a" = _KiUBqtMu;
        "minecraft-24w35a" = _KiUBqtMu;
        "minecraft-24w36a" = _KiUBqtMu;
        "minecraft-24w37a" = _KiUBqtMu;
        "minecraft-24w38a" = _KiUBqtMu;
        "minecraft-24w39a" = _KiUBqtMu;
        "minecraft-24w40a" = _KiUBqtMu;
        "minecraft-1.21.2-pre1" = _KiUBqtMu;
        "minecraft-1.21.2-pre2" = _KiUBqtMu;
        "minecraft-24w44a" = _KiUBqtMu;
        "minecraft-24w45a" = _KiUBqtMu;
        "minecraft-24w46a" = _KiUBqtMu;
        "minecraft-26.1" = _KiUBqtMu;
        "minecraft-26.1.1" = _KiUBqtMu;
        "minecraft-26.1.2" = _KiUBqtMu;
        "minecraft-26.2" = _KiUBqtMu;
        "minecraft-26.3" = _KiUBqtMu;
        "pkg-0.1.0" = _dxY52qbw;
        "pkg-0.2.0" = _9sgiS9vw;
        "pkg-0.2.1" = _OltCszko;
        "pkg-0.2.2" = _Zayr6qMq;
        ...
        "pkg-0.5.8" = _tgatrhXC;
        "pkg-0.5.9" = _4btkfnf6;
        "pkg-0.5.10" = _Qid9Nhqr;
        "pkg-0.5.11" = _2MwE3NQ7;
        "pkg-0.5.12" = _KiUBqtMu;
        "default" = _KiUBqtMu;
    });
