...
let
    ...
    in {
        ...
        "pkg-9.2.2" = _D5XMHx9I;
        "pkg-9.3.0" = _IckN6dEs;
        "pkg-10.0.0" = _gHIdHCuD;
        "pkg-10.1.0" = _elYMASQf;
        "pkg-10.2.0" = _W3F9n96N;
        "pkg-9.3.1" = _ZqA1adIm;
        "pkg-10.2.1" = _NYnjzJm1;
        "pkg-10.2.2" = _OgyL7Xcc;
        "pkg-10.2.3" = _2T654GKp;
        "pkg-10.2.4" = _DGSMz2CQ;
        "pkg-9.3.2" = _jwYCUZPW;
        "pkg-10.2.5" = _ssLqal8p;
        "pkg-9.4.0" = _AitxQ6K2;
        "pkg-10.3.0" = _BgYVvrdB;
        "pkg-10.3.1" = _jvivVdEd;
        "pkg-9.4.1" = _7rbS8LWl;
        "pkg-10.3.2" = _oYIhUq5n;
        "pkg-9.4.2" = _7rttes4D;
        "pkg-10.4.0" = _S2QdAOpp;
        "pkg-10.5.0" = _7DyVvonj;
        "pkg-10.5.1" = _q6hnNGtC;
        "pkg-9.4.3" = _lSiHA1qU;
        "pkg-10.5.2" = _cgx01typ;
        "pkg-10.5.3" = _D3CDlA7Z;
        "pkg-11.0.0" = _pg1vcaRM;
        "pkg-11.1.0" = _eFKuGqSD;
        "pkg-11.1.1" = _sBqISJgr;
        "pkg-11.1.2" = _CNDyv3iO;
        "pkg-11.2.0" = _8xw0Z6Pc;
        "pkg-10.6.0" = _1lKlr9Uf;
        "pkg-11.3.0" = _7iRMdMmk;
        "pkg-11.3.1" = _HmTVwPA9;
