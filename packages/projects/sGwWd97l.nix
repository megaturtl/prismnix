...
let
    ...
    in {
        ...
        "pkg-0.3.6b-1.20.1-fabric-hotfix1" = _jVzi7TXe;
        "pkg-0.3.6b-1.20.1-forge-hotfix2" = _5worXWXw;
        "pkg-0.3.6b-1.20.1-fabric-hotfix2" = _kz8AHd8v;
        "pkg-0.3.7b-1.20.1-forge" = _7wNWFqrV;
        "pkg-0.3.7b-1.20.1-fabric" = _19SKLvoH;
        "pkg-0.3.7b-1.20.1-forge-hotfix1" = _qYBaNki0;
        "pkg-0.3.7b-1.20.1-fabric-hotfix1" = _Zaal1K5i;
        "pkg-0.3.8r-1.20.1-forge" = _zE3EdKLR;
        "pkg-0.3.8r-1.20.1-fabric" = _8vyaAWPK;
        "pkg-0.3.8r-1.20.1-fabric-fix1" = _3xtQdzBi;
        "pkg-0.3.8r-1.20.1-forge-fix1" = _Nz6UbQoS;
        "pkg-0.3.8r-1.20.1-fabric-fix2" = _62O8urbU;
        "pkg-0.3.8r-1.20.1-forge-fix2" = _sg9JPfc7;
        "pkg-0.3.8r-1.20.1-fabric-fix3" = _zqIZfPMX;
        "pkg-0.3.8r-1.20.1-forge-fix3" = _5P6nwB56;
        "pkg-0.3.8r-1.20.1-fabric-fix4" = _rjdTHDi1;
        "pkg-0.3.8r-1.20.1-forge-fix4" = _KL5QPTFN;
        "pkg-0.3.8r-1.20.1-fabric-fix5" = _WYH4PLPD;
        "pkg-0.3.8r-1.20.1-forge-fix5" = _53CJYKhw;
        "pkg-0.3.9r-1.20.1-fabric" = _HOCL3vEC;
        "pkg-0.3.9r-1.20.1-forge" = _1vhS6fWS;
        "pkg-0.3.9r-1.20.1-fabric-fix1" = _7JMZIQbC;
        "pkg-0.3.9r-1.20.1-forge-fix1" = _R9v3Zg1G;
        "pkg-0.3.9r-1.20.1-fabric-fix2" = _h79Ia9Fp;
        "pkg-0.3.9r-1.20.1-forge-fix2" = _ZS3nobwL;
        "pkg-0.3.9r-1.20.1-fabric-fix3" = _8CfCeYg8;
        "pkg-0.3.9r-1.20.1-forge-fix3" = _UJUZqjzT;
        "pkg-0.3.10r-1.20.1-fabric" = _gexoxeNM;
        "pkg-0.3.10r-1.20.1-forge" = _TZ29OgXh;
        "pkg-0.4.0r-1.20.1-fabric" = _YsqtYuEg;
        "pkg-0.4.0r-1.20.1-forge" = _LVcfgjW2;
        "pkg-0.4.6r-1.20.1-fabric" = _Q4ChI9jY;
        "pkg-0.4.6r-1.20.1-forge" = _F48CBZoO;
        "pkg-0.4.6r-1.20.1-fabric-hotfix1" = _yxeSlrt3;
        "pkg-0.4.6r-1.20.1-forge-hotfix1" = _UjUjOh4I;
        "pkg-0.4.6r-1.20.1-fabric-hotfix2" = _wQwRnGr8;
        "pkg-0.4.6r-1.20.1-forge-hotfix2" = _mpHeFHUF;
        "pkg-0.4.6r-1.20.1-fabric-hotfix3" = _JB53eO19;
        "pkg-0.4.6r-1.20.1-forge-hotfix3" = _M7X5ZrwB;
        "pkg-0.5.4r-1.20.1-fabric" = _bQ3yO8pH;
        "pkg-0.5.4r-1.20.1-forge" = _kVCNM47v;
        "pkg-0.5.4r-fix1-1.20.1-fabric" = _gbj2ZhQF;
        "pkg-0.5.4r-fix1-1.20.1-forge" = _gPUtt9qR;
        "pkg-0.5.4r-fix2-1.20.1-fabric" = _BZLAcZQb;
        "pkg-0.5.4r-fix2-1.20.1-forge" = _Uj2CXD19;
        "pkg-0.5.4r-fix3-1.20.1-fabric" = _PDhbYXpC;
        "pkg-0.5.4r-fix3-1.20.1-forge" = _WVE0f80L;
        "pkg-0.6.0r-1.20.1-fabric" = _r8zVGWCj;
        "pkg-0.6.0r-1.20.1-forge" = _o7ymUVLm;
        "pkg-0.6.0r-fix1-1.20.1-fabric" = _G9XaIuUN;
        "pkg-0.6.0r-fix1-1.20.1-forge" = _5JMvVFIB;
        "pkg-0.6.0r-fix2-1.20.1-fabric" = _srrIunGg;
        "pkg-0.6.0r-fix2-1.20.1-forge" = _aDFWjN4N;
        "pkg-0.6.0r-fix3-1.20.1-fabric" = _S0z1CRm1;
        "pkg-0.6.0r-fix3-1.20.1-forge" = _HllUyGH9;
        "pkg-0.6.0r-fix4-1.20.1-fabric" = _w8QxzS70;
        "pkg-0.6.0r-fix4-1.20.1-forge" = _c97jn3YP;
        "pkg-0.6.0r-fix5-1.20.1-fabric" = _d3jcZ63q;
        "pkg-0.6.0r-fix5-1.20.1-forge" = _6MClyMgX;
        "pkg-0.6.0r-fix5-1.21.1-fabric" = _i8Ct8Y5s;
        "pkg-0.6.0r-fix5-1.21.1-neoforge" = _XsNHB5Lb;
        "pkg-0.6.0r-fix6-1.20.1-fabric" = _6vt5sca8;
        "pkg-0.6.0r-fix6-1.20.1-forge" = _ueX4cn8n;
        "pkg-0.6.0r-fix6-1.21.1-fabric" = _pRZ6AVeX;
        "pkg-0.6.0r-fix6-1.21.1-neoforge" = _Nh7IvP2d;
        "pkg-0.6.0r-fix7-1.20.1-fabric" = _yG8Z1xyO;
        "pkg-0.6.0r-fix7-1.20.1-forge" = _S8JN5kMO;
        "pkg-0.6.0r-fix7-1.21.1-fabric" = _bexfK8tC;
        "pkg-0.6.0r-fix7-1.21.1-neoforge" = _xEPwcoSd;
        "pkg-0.6.1r-1.20.1-fabric" = _uNlbRk6A;
        "pkg-0.6.1r-1.20.1-forge" = _MXzHIydI;
        "pkg-0.6.1r-1.21.1-fabric" = _5byo11Jx;
        "pkg-0.6.1r-1.21.1-neoforge" = _EB3lrcYC;
        "pkg-0.6.1r-fix1" = _Yu2xJ7pH;
        "pkg-0.6.1r-fix2-1.20.1-fabric" = _ZAdTyjpq;
        "pkg-0.6.1r-fix2-1.20.1-forge" = _Tcoy8Lsl;
        "pkg-0.6.1r-fix2-1.21.1-fabric" = _euWuiJyL;
        "pkg-0.6.1r-fix2-1.21.1-neoforge" = _GpL0i5NT;
        "pkg-0.6.1r-fix3-1.20.1-fabric" = _EQCK2jcL;
        "pkg-0.6.1r-fix3-1.20.1-forge" = _qzxwv5QX;
        "pkg-0.6.1r-fix3-1.21.1-fabric" = _3wv0Pzsx;
        "pkg-0.6.1r-fix3-1.21.1-neoforge" = _gZxABeyP;
        "pkg-0.6.1r-fix4-1.20.1-fabric" = _q0MOmHsZ;
        "pkg-0.6.1r-fix4-1.20.1-forge" = _zFXKeBRR;
        "pkg-0.6.1r-fix4-1.21.1-fabric" = _DCaN54M6;
        "pkg-0.6.1r-fix4-1.21.1-neoforge" = _A6zfUJ6k;
        "pkg-0.6.1r-fix5-1.20.1-fabric" = _PrtHeqCr;
        "pkg-0.6.1r-fix5-1.20.1-forge" = _4lKpgATx;
        "pkg-0.6.1r-fix5-1.21.1-fabric" = _eBiERsqR;
        "pkg-0.6.1r-fix5-1.21.1-neoforge" = _f0UtYLtz;
        "pkg-0.6.2r-1.20.1-fabric" = _8w1h1mwY;
        "pkg-0.6.2r-1.20.1-forge" = _Q5fry8J8;
        "pkg-0.6.2r-1.21.1-fabric" = _9JM0Esbb;
        "pkg-0.6.2r-1.21.1-neoforge" = _eXnbg1Bx;
        "pkg-0.6.2r-fix1-1.20.1-fabric" = _u4SR4a8k;
        "pkg-0.6.2r-fix1-1.20.1-forge" = _MqJJTSz8;
        "pkg-0.6.2r-fix1-1.21.1-fabric" = _hndktX9G;
        "pkg-0.6.2r-fix1-1.21.1-neoforge" = _UlWHVIl7;
        "pkg-0.6.2r-fix2-1.20.1-fabric" = _T66xUx47;
        "pkg-0.6.2r-fix2-1.20.1-forge" = _LjvmueGf;
        "pkg-0.6.2r-fix2-1.21.1-fabric" = _nyVgD7WM;
        "pkg-0.6.2r-fix2-1.21.1-neoforge" = _D0f6CamB;
        "pkg-0.6.3r-1.20.1-fabric" = _mxCtYUJW;
        "pkg-0.6.3r-1.20.1-forge" = _8GWhKtVv;
        "pkg-0.6.3r-1.21.1-fabric" = _gmcyctgo;
        "pkg-0.6.3r-1.21.1-neoforge" = _uvhjCLYF;
        "pkg-0.6.4r-1.20.1-fabric" = _JsFhfJd6;
        "pkg-0.6.4r-1.20.1-forge" = _mggPIGl4;
        "pkg-0.6.4r-1.21.1-fabric" = _mi7gVHL3;
        "pkg-0.6.4r-1.21.1-neoforge" = _2yCBm36p;
        "pkg-0.7.0r-fix1-1.20.1-fabric" = _CDBsIX5V;
        "pkg-0.7.0r-fix1-1.20.1-forge" = _TlP6R7Mi;
        "pkg-0.7.0r-fix1-1.21.1-fabric" = _8uuc3m8u;
        "pkg-0.7.0r-fix1-1.21.1-neoforge" = _maylp4oJ;
        "pkg-0.7.0r-fix2-1.20.1-fabric" = _C4CoV2Kw;
        "pkg-0.7.0r-fix2-1.20.1-forge" = _5JUg2e4N;
        "pkg-0.7.0r-fix2-1.21.1-fabric" = _YprfOhVy;
        "pkg-0.7.0r-fix2-1.21.1-neoforge" = _sZuaVo3T;
        "pkg-0.7.0r-fix3-1.20.1-fabric" = _81zYJhvq;
        "pkg-0.7.0r-fix3-1.20.1-forge" = _6yOKnAeB;
        "pkg-0.7.0r-fix3-1.21.1-fabric" = _Njuf64Fy;
        "pkg-0.7.0r-fix3-1.21.1-neoforge" = _E6xVP82W;
        "pkg-0.7.0r-fix4-1.20.1-fabric" = _Ld7lveJV;
        "pkg-0.7.0r-fix4-1.20.1-forge" = _gE0K5btq;
        "pkg-0.7.0r-fix4-1.21.1-fabric" = _TCk8o2oL;
        "pkg-0.7.0r-fix4-1.21.1-neoforge" = _HfrjmErg;
        "pkg-0.7.0r-fix5-1.20.1-fabric" = _QT97VwfU;
