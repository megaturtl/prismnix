...
let
    ...
    in {
        ...
        "pkg-1.19.3-Fabric-3.3.0" = _kA7MDzPW;
        "pkg-1.19.4-Fabric-3.4.0" = _TzrcWYpl;
        "pkg-1.19.4-Forge-3.4.0" = _BcX4CMtc;
        "pkg-1.20-Forge-4.0.1" = _JmB3Jh9x;
        "pkg-1.20-Fabric-4.0.1" = _McprBxTA;
        "pkg-1.20-Forge-4.0.2" = _N75UXpfR;
        "pkg-1.20-Fabric-4.0.2" = _kbBSCFhO;
        "pkg-1.20-Forge-4.0.3" = _UoFb8XqU;
        "pkg-1.20-Fabric-4.0.3" = _LAORtIY1;
        "pkg-1.20-Forge-4.0.4" = _kVO57zxB;
        "pkg-1.20-Fabric-4.0.4" = _qLnQnqXS;
        "pkg-1.19.2-Fabric-3.2.1" = _vlpZvDsy;
        "pkg-1.19.2-Forge-3.2.1" = _K4G8SGWy;
        "pkg-1.20.4-Forge-4.4.0" = _tSco9t4E;
        "pkg-1.20.4-Fabric-4.4.0" = _2Z4xpeH5;
        "pkg-1.20.4-Forge-4.4.1" = _a4fD45oH;
        "pkg-1.20.4-Fabric-4.4.1" = _St6cNi1U;
        "pkg-1.20.4-Forge-4.4.2" = _JYbhvvYE;
        "pkg-1.20.4-NeoForge-4.4.2" = _buSrqoIV;
        "pkg-1.20.4-Fabric-4.4.2" = _6bYbds1y;
        "pkg-1.21.1-Fabric-5.1.0" = _dCl5L71u;
        "pkg-1.21.1-Forge-5.1.0" = _IeHb1BWe;
        "pkg-1.21.1-NeoForge-5.1.0" = _SY5SwuYO;
        "pkg-1.21.1-Forge-5.1.1" = _UsMpo7t0;
        "pkg-1.21.1-NeoForge-5.1.1" = _Go3nbneL;
        "pkg-1.21.1-Fabric-5.1.1" = _4ybDuGhA;
        "pkg-1.21.4-Fabric-5.4.0" = _ezSBs4dx;
