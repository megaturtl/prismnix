...
let
    versions = (let
        ...
        _MIlOIpGV = {
            "id" = "MIlOIpGV";
            "file" = "resourcepackchecker-fabric-1.2.2+26.3.jar";
            "hash" = "sha512-W1yL7Tqz7bzNUvEBjed31PfkQK3eCvsEK+QUh0hwWizxFSYwMCLQO5oj9jsPa+D3ciEK2qIksIdiVtvxWlgB4Q==";
        };
    in {
        "j82fQkJK" = _j82fQkJK;
        "hPpb3pBO" = _hPpb3pBO;
        ...
        "pkg-fabric-1.2.2+26.3" = _MIlOIpGV;
        "default" = _MIlOIpGV;
    });
