...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _iEFv1gPU;
        "pkg-1.0.9" = _t6E8OJeP;
        "pkg-1.0.10" = _D5sdIE3k;
        "pkg-1.0.11" = _qHrfZGNq;
        "pkg-1.0.12" = _65oEwa9H;
        "pkg-1.0.13" = _IOgSrXTj;
        "pkg-1.0.14" = _KangnZcR;
        "pkg-1.0.15" = _z1i5zXjS;
        "pkg-1.0.16" = _PObROwyx;
        "pkg-1.0.17" = _c9fOTrVN;
        "pkg-1.0.18" = _3pl9kDve;
