...
let
    ...
    in {
        ...
        "pkg-1.3.0" = _DhdOOQNv;
        "pkg-1.3.1" = _kXneTdi6;
        "pkg-1.3.1+1.20.1" = _2S0wY1Mw;
        "pkg-1.3.2+1.20.1" = _6rKESBPw;
        "pkg-1.3.2+1.21.1" = _71uyXCn7;
        "pkg-1.3.2.1+1.20.1" = _EwOZ35ta;
        "pkg-1.3.2.1+1.21.1" = _WD9RGPDw;
        "pkg-1.3.2.2+1.21.1" = _woSS2azy;
        "pkg-1.3.2.2+1.20.1" = _2kCrTNOE;
        "pkg-1.3.3+1.21.1" = _iebcSmbr;
        "pkg-1.3.3+1.20.1" = _5duOwp5q;
        "pkg-1.3.4+1.21.1" = _UyLJKFaC;
        "pkg-1.3.4+1.20.1" = _ryT5El3x;
        "pkg-1.3.5+1.21.1" = _yqBJYLpJ;
        "pkg-1.3.5+1.20.1" = _GUrAjZQT;
        "pkg-1.3.6+1.21.1" = _1gGHXUIx;
        "pkg-1.3.6+1.20.1" = _M4EHcZqY;
        "pkg-1.3.7+1.21.1" = _axrGV9Vw;
        "pkg-1.3.7+1.20.1" = _OsBzeNkA;
        "pkg-1.3.8+1.21.1" = _3z2OXvLq;
