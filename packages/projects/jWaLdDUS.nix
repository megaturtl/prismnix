...
let
    ...
    in {
        ...
        "NM6oCIh9" = _NM6oCIh9;
        "90KseMKq" = _90KseMKq;
        "minecraft-1.18.2" = _90KseMKq;
        "minecraft-1.19.2" = _90KseMKq;
        "minecraft-1.19.4" = _90KseMKq;
        "minecraft-1.20.1" = _90KseMKq;
        "minecraft-1.20.4" = _90KseMKq;
        "minecraft-1.17.1" = _90KseMKq;
        "minecraft-1.20" = _90KseMKq;
        "pkg-1.0" = _QCWDrkFj;
        "pkg-1.1" = _ZqIOsINC;
        "pkg-1.2" = _GDK4hDTO;
        "pkg-1.3" = _jwxg5lhz;
