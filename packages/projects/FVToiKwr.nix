...
let
    ...
    in {
        ...
        "pkg-2.0.0" = _GbVJHRMh;
        "pkg-2.0.1" = _fQwgTzq5;
        "pkg-2.1.0+1.20.1-fabric" = _lGpmAJcf;
        "pkg-2.1.0+1.20.1-forge" = _qnTWSLYu;
        "pkg-2.1.0+1.21.1-fabric" = _qNQk3wov;
        "pkg-2.1.0+1.21.1-neoforge" = _PRiLsMC5;
        "pkg-2.1.1+1.20.1-fabric" = _Yjc84K5I;
        "pkg-2.1.1+1.21.1-fabric" = _QDhmpHpO;
        "pkg-2.1.1+1.20.1-forge" = _qyu1ptRv;
        "pkg-2.1.1+1.21.1-neoforge" = _CH55MKtI;
        "pkg-2.1.2+1.20.1-fabric" = _THo8fpZH;
        "pkg-2.1.2+1.20.1-forge" = _oZqAExUm;
        "pkg-2.1.2+1.21.1-fabric" = _LmgZFi2n;
        "pkg-2.1.2+1.21.1-neoforge" = _oogwFuaw;
        "pkg-2.1.3+1.20.1-fabric" = _bMxG6oEi;
        "pkg-2.1.3+1.21.1-fabric" = _rbiw6rDN;
        "pkg-2.1.3+1.20.1-forge" = _BcWEF5ST;
        "pkg-2.1.3+1.21.1-neoforge" = _6npewqAi;
        "pkg-2.2.0+1.20.1-fabric" = _PvAoR0u5;
        "pkg-2.2.0+1.20.1-forge" = _825HffA4;
        "pkg-2.2.0+1.21.1-fabric" = _1dRSrLKP;
        "pkg-2.2.0+1.21.1-neoforge" = _hCYkPitt;
        "pkg-2.2.1+1.20.1-fabric" = _5LLYGocx;
        "pkg-2.2.1+1.20.1-forge" = _t1PeFVM5;
        "pkg-2.2.1+1.21.1-fabric" = _nK2TM0fo;
        "pkg-2.2.1+1.21.1-neoforge" = _HT6ZBxcV;
        "pkg-2.2.2+1.20.1-fabric" = _OdNixdND;
