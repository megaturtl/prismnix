...
let
    ...
    in {
        ...
        "pkg-2.4.2" = _1zdCyuaO;
        "pkg-2.4.3" = _EmVvGh7N;
        "pkg-2.4.4-beta" = _8IJOwbg0;
        "pkg-2.4.5-beta1" = _KldfXkwo;
        "pkg-2.4.5-beta2" = _oyPMVCBn;
        "pkg-2.4.5-beta3" = _jdpszBjQ;
        "pkg-2.4.5-beta4" = _qoB6L3kb;
        "pkg-2.4.5-beta5" = _2t3frzok;
        "pkg-2.4.5-beta6" = _KC0hnRsn;
        "pkg-2.4.5-beta7" = _p85CfEu9;
