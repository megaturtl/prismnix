...
let
    versions = (let
        ...
        _13ofAx80 = {
            "id" = "13ofAx80";
            "file" = "skinshuffle-2.13.0+26.2-fabric.jar";
            "hash" = "sha512-JCcNeG/eNmcUobuXRwP8O7fxgSUBAcK3sPXA+E5Yb0/LEoSoL1o+ht+GRkSPoocxLewjbqVPKE2OwLW9MpiPsQ==";
        };
        _R2FqiNx5 = {
            "id" = "R2FqiNx5";
            "file" = "skinshuffle-2.14.0+26.3-fabric.jar";
            "hash" = "sha512-HFx6LKgSTS9LEhsEwrDo/j92mUyAuEDCZFeg4jz4Orcj5ypMQA8bSaCzkfJWdVyqyo0+Q21irlTUWsve+Jn+2Q==";
        };
    in {
        "2fwzuEa6" = _2fwzuEa6;
        "CH14kUk4" = _CH14kUk4;
        ...
        "fabric-26.2" = _13ofAx80;
        "fabric-26.3" = _R2FqiNx5;
        "pkg-0.1.0+1.20" = _2fwzuEa6;
        "pkg-0.1.1+1.20" = _CH14kUk4;
        "pkg-0.2.0+1.20" = _Fuva9NMZ;
        "pkg-0.2.1+1.20" = _FutGZOKm;
        "pkg-0.3.0+1.20" = _tG36PrRX;
        "pkg-1.0.0+1.20" = _On22nuh4;
        "pkg-1.0.1+1.20" = _J9H0jHW3;
        "pkg-1.0.2+1.20.2" = _nrJItAzY;
        "pkg-1.1.0+1.20.2" = _W7ZGawz5;
        "pkg-1.1.0+1.20.4" = _hbf3WeoJ;
        "pkg-2.0.0+1.20.1" = _7JygZqWF;
        "pkg-2.0.0+1.20.4" = _pJOJSCHZ;
        "pkg-2.0.0+1.21" = _yFoyGO0w;
        "pkg-2.0.0+1.20.6" = _QgsCMRCc;
        "pkg-2.0.1+1.20.4" = _bhCKbCuR;
        "pkg-2.0.1+1.20.6" = _nmkYBhxf;
        "pkg-2.0.1+1.21" = _kcV92Uau;
        "pkg-2.0.1+1.20.1" = _JvtRibV4;
        "pkg-2.0.2+1.20.4" = _qIXX53qt;
        "pkg-2.0.2+1.20.6" = _Tf4NZCDi;
        "pkg-2.0.2+1.21" = _IKBsfEhV;
        "pkg-2.0.2+1.20.1" = _N9hewPvB;
        "pkg-2.0.3+1.20.1" = _8G6HpP6M;
        "pkg-2.0.3+1.20.4" = _RcNDeSv7;
        "pkg-2.0.3+1.21" = _a7iBX9Uu;
        "pkg-2.0.3+1.20.6" = _jrZd7Dc1;
        "pkg-2.0.4+1.20.4" = _ZPD8Eztd;
        "pkg-2.0.4+1.21" = _bZnz0Vd8;
        "pkg-2.0.4+1.20.1" = _Yz528ScN;
        "pkg-2.0.4+1.20.6" = _fWaSI0GP;
        "pkg-2.1.0+1.20.4" = _sT9luoQt;
        "pkg-2.1.0+1.20.1" = _YuKTMhBF;
        "pkg-2.1.0+1.21" = _lQmrTkeL;
        "pkg-2.1.0+1.20.6" = _G5Lv6Har;
        "pkg-2.2.0+1.21" = _zmoaZ5kh;
        "pkg-2.2.0+1.20.4" = _OnG7OKgh;
        "pkg-2.2.0+1.20.1" = _OIBJmsL0;
        "pkg-2.2.0+1.20.6" = _1kRNZoD6;
        "pkg-2.2.1+1.20.4" = _g5MNmWJr;
        "pkg-2.2.1+1.20.6" = _VUAmoDpe;
        "pkg-2.2.1+1.21" = _su2kozaO;
        "pkg-2.2.1+1.20.1" = _O23v2Mcy;
        "pkg-2.2.2+1.20.1" = _H9nRCID2;
        "pkg-2.2.2+1.20.4" = _nXPk8JW2;
        "pkg-2.2.2+1.21" = _4K1wLliR;
        "pkg-2.2.2+1.20.6" = _WdqK6sGa;
        "pkg-2.3.0+1.21" = _iNClm9Aw;
        "pkg-2.3.0+1.20.1" = _CQR5OaDe;
        "pkg-2.4.0+1.21" = _2ZWtbJeR;
        "pkg-2.4.0+1.20.1" = _rSw7iKFj;
        "pkg-2.4.0+1.21.3" = _ANRSZ19N;
        "pkg-2.5.0+1.21" = _NXKIVIGz;
        "pkg-2.5.0+1.21.3" = _B1PA98A5;
        "pkg-2.5.0+1.21.4" = _fNZZvzQg;
        "pkg-2.6.0+1.21.3" = _PEPrIzWc;
        "pkg-2.6.0+1.21" = _JC1RI0ft;
        "pkg-2.6.0+1.21.4" = _Gpt92Dlk;
        "pkg-2.7.0+1.21.3" = _dmJpARxm;
        "pkg-2.7.0+1.21" = _p0LrZeNe;
        "pkg-2.7.0+1.21.4" = _QrivRDWz;
        "pkg-2.8.0+1.21.4" = _YtRiUbE3;
        "pkg-2.8.0+1.21.3" = _nvlXOfWl;
        "pkg-2.8.0+1.21.5" = _egQC716n;
        "pkg-2.8.0+1.21" = _HbeGfKBy;
        "pkg-2.8.0+april_fools_edition+1.21" = _67tvOxba;
        "pkg-2.8.0+april_fools_edition+1.21.3" = _2JyLKu4j;
        "pkg-2.8.0+april_fools_edition+1.21.5" = _Atc9BWRi;
        "pkg-2.8.0+april_fools_edition+1.21.4" = _KfpiZkjU;
        "pkg-2.8.1+1.21.3" = _vAUS5C3s;
        "pkg-2.8.1+1.21.5" = _Kkd1UTJh;
        "pkg-2.8.1+1.21.4" = _CApA7zIQ;
        "pkg-2.8.1+1.21" = _mV5vveA4;
        "pkg-2.8.2+1.21.3" = _4ZTybGu9;
        "pkg-2.8.2+1.21.5" = _Bq6CLihd;
        "pkg-2.8.2+1.21" = _IZTUOkNa;
        "pkg-2.8.2+1.21.4" = _F8vqljbS;
        "pkg-2.9.0+1.21.3" = _Fo7yMpnh;
        "pkg-2.9.0+1.21.4" = _qrmJt551;
        "pkg-2.9.0+1.21.5" = _8GuS06Z3;
        "pkg-2.9.0+1.21" = _et7obE0x;
        "pkg-2.9.1+1.21.4" = _eMna4QtA;
        "pkg-2.9.1+1.21.3" = _3DM14TYS;
        "pkg-2.9.1+1.21" = _lvj5D7rA;
        "pkg-2.9.1+1.21.5" = _kw62mSmL;
        "pkg-2.9.2+1.21.6" = _AxdX9Kd6;
        "pkg-2.9.3+1.21.6" = _eKLFiOnw;
        "pkg-2.9.4+1.21.6" = _wmvprW8H;
        "pkg-2.9.5+1.21.6" = _D9FapwvK;
        "pkg-2.10.0+1.21.10" = _eV4pyYSS;
        "pkg-2.10.1+1.21.11-fabric" = _BaVZ1Rmt;
        "pkg-2.10.2+1.21.11-fabric" = _wG0z8FCI;
        "pkg-2.11.0+26.1-fabric" = _PxOMlzF3;
        "pkg-2.11.1+26.1-fabric" = _d79ADO6W;
        "pkg-2.12.0+26.2-fabric" = _FVkJSq7D;
        "pkg-2.13.0+26.2-fabric" = _13ofAx80;
        "pkg-2.14.0+26.3-fabric" = _R2FqiNx5;
        "default" = _R2FqiNx5;
    });
