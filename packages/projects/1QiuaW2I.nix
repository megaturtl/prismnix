...
let
    ...
    in {
        ...
        "pkg-Fabric-1.6.5" = _EwUEEJGR;
        "pkg-Forge-1.6.5" = _Sql3ER3a;
        "pkg-NeoForge-1.6.5" = _nwDN99cH;
        "pkg-Fabric-1.6.6" = _sRelkLeR;
        "pkg-Forge-1.6.6" = _FSMSRv8L;
        "pkg-NeoForge-1.6.6" = _YBzLaSMu;
        "pkg-Fabric-1.6.7" = _4o3ObrMK;
        "pkg-NeoForge-1.6.7" = _Cd1JbRty;
        "pkg-Forge-1.6.7" = _9OqR0WZf;
        "pkg-Fabric-1.6.8" = _K42aIef5;
        "pkg-NeoForge-1.6.8" = _uoeypQHg;
        "pkg-Forge-1.6.8" = _MoiSh7Zg;
        "pkg-Fabric-1.6.9" = _LN1nEx25;
        "pkg-NeoForge-1.6.9" = _rxbOGuPn;
        "pkg-Forge-1.6.9" = _TQx7iIHo;
        "pkg-NeoForge-1.6.10" = _Keq2tEeM;
        "pkg-NeoForge-1.6.11" = _9yByHKWI;
        "pkg-NeoForge-1.6.12" = _ZBYdmIE4;
        "pkg-Forge-1.6.12" = _oUeVDQq2;
        "pkg-Fabric-1.6.12" = _JkZeWAKb;
        "pkg-Fabric-1.7.0" = _7BMynDoI;
        "pkg-Forge-1.7.0" = _OajR0cVv;
        "pkg-NeoForge-1.7.0" = _6QFIS2qx;
        "pkg-Fabric-1.7.1" = _aq9INoMb;
        "pkg-Forge-1.7.1" = _RldmUVj5;
        "pkg-NeoForge-1.7.1" = _jMeifiYN;
