...
let
    ...
    in {
        ...
        "pkg-4.0.0+1.14.4" = _vOWtI3gy;
        "pkg-4.0.1+1.16.2" = _L7TmfftT;
        "pkg-5.0.0-beta.1+21w03a" = _kvcXLIhw;
        "pkg-5.0.0-beta.2+1.17" = _XQ6sAlpr;
        "pkg-5.0.0-beta.3+1.17.1" = _esyBJPbU;
        "pkg-5.0.0-beta.4+1.18.2" = _FNsXFknk;
        "pkg-5.0.0-beta.5+1.18.2" = _P6ld16qa;
        "pkg-5.0.0-beta.6+1.18.2" = _CwMl84DF;
        "pkg-5.0.0-beta.7+1.18.2" = _nu6gjAtJ;
        "pkg-5.0.0-beta.8+1.19" = _E4nO7jjo;
        "pkg-5.0.0-beta.9+1.19" = _vNZwWPKn;
        "pkg-5.0.0-beta.10+1.19.3" = _oOWfXNvO;
        "pkg-5.0.0-beta.11+1.19.4" = _iptyzc9N;
        "pkg-5.0.0-beta.12+1.20" = _fGpO4l2z;
        "pkg-5.0.0-beta.13+1.20.1" = _XM9JShU4;
        "pkg-5.0.0+1.20.1" = _Hmpagx7s;
        "pkg-5.0.1+1.20.1" = _buDX2XKX;
        "pkg-5.0.2+Quilt" = _wTjuReJe;
        "pkg-6.0.0+Quilt" = _3WRTt0FK;
        "pkg-7.0.0+Quilt" = _PPg8l36Y;
        "pkg-5.1.0+1.20.1+Quilt" = _Io5ormBU;
        "pkg-7.1.0+Quilt" = _flkRovrR;
        "pkg-5.2.0-beta.1+Quilt" = _GiK47vku;
        "pkg-5.2.0+Quilt" = _iCQI9P3P;
        "pkg-7.2.0+Quilt" = _IwYTho21;
        "pkg-8.0.1+Fabric" = _Mknl4czx;
        "pkg-9.0.0+Fabric" = _ri1cYvhK;
        "pkg-9.0.1+Fabric" = _iult97Ac;
        "pkg-9.0.2+Fabric" = _jQ9ADWX2;
        "pkg-9.1.0+Fabric" = _Twzw1hNG;
        "pkg-9.2.0+Fabric" = _3gDiLm1B;
        "pkg-5.3.0+Quilt" = _sAXEojQu;
        "pkg-9.3.0+Fabric" = _fTlz6oCq;
        "pkg-10.0.0-beta.1+Fabric" = _1JcTw7UE;
        "pkg-10.0.0-beta.2+Fabric" = _1qAo2cOK;
        "pkg-10.0.0-beta.3+Fabric" = _cybITlOF;
        "pkg-10.0.0-beta.4+Fabric" = _MlbhHWAA;
        "pkg-11.0.0-beta.1+Fabric" = _C9JUefdi;
        "pkg-11.0.0-beta.2+fabric" = _KCqJPYpX;
        "pkg-11.0.0-beta.2+neo" = _d7dOYjlB;
        "pkg-11.0.0-beta.3+fabric" = _jgpdXmNk;
        "pkg-11.0.0-beta.3+neo" = _dBXauQTG;
        "pkg-10.0.0-beta.5+fabric" = _WtminchT;
        "pkg-10.0.0-beta.5+neo" = _80TNXW2q;
        "pkg-10.0.0-beta.6+fabric" = _NRyamMJW;
        "pkg-10.0.0-beta.6+neo" = _La8DRCu7;
        "pkg-11.0.0-beta.4+fabric" = _j5LPgV8h;
        "pkg-11.0.0-beta.4+neo" = _cSu8rT0x;
        "pkg-12.0.0-beta.1+fabric" = _d1cnCrl2;
        "pkg-12.0.0-beta.1+neo" = _CnfUjqsb;
        "pkg-12.0.0-beta.2+fabric" = _CViw4JTG;
        "pkg-12.0.0-beta.2+neo" = _4FC1eZp5;
        "pkg-12.0.0-beta.3+fabric" = _TSz9epnO;
        "pkg-12.0.0-beta.3+neo" = _eaoEtT6y;
        "pkg-10.0.0-beta.7+fabric" = _zwBaMyhN;
        "pkg-10.0.0-beta.7+neo" = _zYF1KqHz;
        "pkg-10.0.0-beta.8+fabric" = _v14uvE5b;
        "pkg-10.0.0-beta.8+neo" = _3V5VvPQc;
        "pkg-5.4.0-beta.1+fabric" = _oTxkM89S;
        "pkg-5.4.0-beta.1+forge" = _WMwyY4rk;
        "pkg-5.4.0-beta.2+fabric" = _5alq7FGJ;
        "pkg-5.4.0-beta.2+forge" = _Q9UGB7Cv;
        "pkg-5.4.0-beta.3+fabric" = _cq77oFr7;
        "pkg-5.4.0-beta.3+forge" = _oUiRGWmm;
        "pkg-5.4.0-beta.4+fabric" = _mnDlbGMj;
        "pkg-5.4.0-beta.4+forge" = _yJFcxhSq;
        "pkg-12.0.0-beta.4+fabric" = _2qUIwZui;
        "pkg-12.0.0-beta.4+neo" = _1LsMGaj7;
        "pkg-12.0.0-beta.5+fabric" = _HJTyng0I;
        "pkg-12.0.0-beta.5+neo" = _y090DYKo;
        "pkg-13.0.0-alpha.1+fabric" = _sK3RP1Cg;
        "pkg-13.0.0-alpha.2+fabric" = _jyK8GdIp;
        "pkg-13.0.0-beta.1+fabric" = _9pk1gJMU;
        "pkg-13.0.0-beta.1+neo" = _EJMfgpJu;
        "pkg-10.0.0-beta.9+fabric" = _pOXkvNdk;
        "pkg-10.0.0-beta.9+neo" = _7RRUNCfJ;
        "pkg-5.4.0-beta.5+fabric" = _UMWcC6Zu;
        "pkg-5.4.0-beta.5+forge" = _TgTMsciR;
        "pkg-5.4.0-beta.6+fabric" = _AavI6Q9r;
        "pkg-5.4.0-beta.6+forge" = _2yMZZngw;
        "pkg-5.4.0-beta.7+fabric" = _6r8lzcbT;
        "pkg-5.4.0-beta.7+forge" = _ac2U1kut;
        "pkg-5.4.0-beta.8+fabric" = _d7vfHrR4;
        "pkg-5.4.0-beta.8+forge" = _s4W0Kgaa;
        "pkg-10.0.0-beta.10+fabric" = _DuEvCBMw;
        "pkg-10.0.0-beta.10+neo" = _9r90qGm7;
        "pkg-13.0.0-beta.2+fabric" = _lYZpt8WQ;
        "pkg-13.0.0-beta.2+neo" = _BCcxpqct;
        "pkg-14.0.0-alpha.1+fabric" = _oLaYQIuE;
        "pkg-14.0.0-alpha.2+fabric" = _VLxnV7lK;
        "pkg-14.0.0-alpha.3+fabric" = _AvydR0Oq;
        "pkg-14.0.0-beta.1+fabric" = _qwhYUbuW;
        "pkg-14.0.0-beta.1+neo" = _9cOAO1GK;
        "pkg-14.0.0-beta.2+fabric" = _9PeQMxEu;
        "pkg-14.0.0-beta.2+neo" = _IiwR6K12;
        "pkg-14.0.0-beta.3+fabric" = _Zc1RUWpc;
        "pkg-14.0.0-beta.3+neo" = _ytb8G9Y4;
        "pkg-13.0.0-beta.3+fabric" = _MUPtJEmX;
        "pkg-13.0.0-beta.3+neo" = _CYV0xaUg;
        "pkg-15.0.0-beta.1+fabric" = _hlvp8xE9;
        "pkg-15.0.0-beta.1+neo" = _io5TYvk3;
        "pkg-15.0.0-beta.2+fabric" = _eUKZhoqM;
        "pkg-15.0.0-beta.2+neo" = _zIGtMb2W;
        "pkg-15.0.0-beta.3+fabric" = _u4t2pubc;
        "pkg-15.0.0-beta.3+neo" = _dS2CphEx;
        "pkg-15.0.0-beta.4+fabric" = _dOCS7VBn;
        "pkg-15.0.0-beta.4+neo" = _6WCgR2DA;
        "pkg-15.0.0-beta.5+fabric" = _97vlRtL9;
        "pkg-15.0.0-beta.5+neo" = _Zp5dTkTT;
        "pkg-16.0.0-beta.1+fabric" = _jxxCD8S5;
        "pkg-16.0.0-beta.1+neo" = _y2BxvGEz;
        "pkg-16.0.0-beta.2+fabric" = _MiOAcTGw;
        "pkg-16.0.0-beta.2+neo" = _FRHpJBJG;
        "pkg-10.0.0-beta.11+fabric" = _5E7kXRy8;
        "pkg-10.0.0-beta.11+neo" = _z4FMGvbw;
        "pkg-10.0.0-beta.12+fabric" = _NAC0lscY;
        "pkg-10.0.0-beta.12+neo" = _z040nwfW;
        "pkg-10.0.0-beta.13+fabric" = _UX8lfoRm;
        "pkg-10.0.0-beta.13+neo" = _AkPuuAgJ;
        "pkg-5.4.0-beta.9+fabric" = _W4c9MT4L;
        "pkg-5.4.0-beta.9+forge" = _8M3vtEOe;
        "pkg-17.0.0-beta.1" = _Qct44PL0;
        "pkg-17.0.0-beta.2" = _gK1CDvlE;
        "pkg-17.0.0-beta.3" = _yXRfcOfY;
