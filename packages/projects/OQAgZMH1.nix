...
let
    ...
    in {
        ...
        "forge-1.21" = _F4KldqbX;
        "forge-1.21.1" = _F4KldqbX;
        "forge-1.21.2" = _F4KldqbX;
        "forge-1.21.3" = _F4KldqbX;
        "forge-1.21.4" = _F4KldqbX;
        "forge-1.21.5" = _F4KldqbX;
        "forge-1.21.6" = _F4KldqbX;
        "forge-1.21.7" = _F4KldqbX;
        "forge-1.21.8" = _F4KldqbX;
        "forge-1.21.9" = _F4KldqbX;
        "forge-1.21.10" = _F4KldqbX;
        "forge-1.21.11" = _F4KldqbX;
        "forge-26.1" = _F4KldqbX;
        "forge-26.1.1" = _F4KldqbX;
        "forge-26.1.2" = _F4KldqbX;
        "forge-26.2" = _F4KldqbX;
        ...
        "fabric-1.21" = _F4KldqbX;
        "fabric-1.21.1" = _F4KldqbX;
        "fabric-1.21.4" = _F4KldqbX;
        "fabric-1.21.5" = _F4KldqbX;
        "fabric-1.21.6" = _F4KldqbX;
        "fabric-1.21.7" = _F4KldqbX;
        "fabric-1.21.8" = _F4KldqbX;
        "fabric-1.21.9" = _F4KldqbX;
        "fabric-1.21.10" = _F4KldqbX;
        "fabric-1.21.2" = _F4KldqbX;
        "fabric-1.21.3" = _F4KldqbX;
        "fabric-1.21.11" = _F4KldqbX;
        "fabric-26.1" = _F4KldqbX;
        "fabric-26.1.1" = _F4KldqbX;
        "fabric-26.1.2" = _F4KldqbX;
        "fabric-26.2" = _F4KldqbX;
        ...
        "neoforge-1.21" = _F4KldqbX;
        "neoforge-1.21.1" = _F4KldqbX;
        "neoforge-1.21.4" = _F4KldqbX;
        "neoforge-1.21.5" = _F4KldqbX;
        "neoforge-1.21.6" = _F4KldqbX;
        "neoforge-1.21.7" = _F4KldqbX;
        "neoforge-1.21.8" = _F4KldqbX;
        "neoforge-1.21.9" = _F4KldqbX;
        "neoforge-1.21.10" = _F4KldqbX;
        "neoforge-1.21.2" = _F4KldqbX;
        "neoforge-1.21.3" = _F4KldqbX;
        "neoforge-1.21.11" = _F4KldqbX;
        "neoforge-26.1" = _F4KldqbX;
        "neoforge-26.1.1" = _F4KldqbX;
        "neoforge-26.1.2" = _F4KldqbX;
        "neoforge-26.2" = _F4KldqbX;
        "pkg-3.1.4" = _7as7ADXL;
        "pkg-3.0.6" = _owkrXX1s;
        "pkg-2.5.9" = _OTnK2lWL;
        "pkg-2.2.5" = _GaIHziqo;
