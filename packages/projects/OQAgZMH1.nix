...
let
    versions = (let
        ...
        _BX5s7vMY = {
            "id" = "BX5s7vMY";
            "file" = "MoogsVoyagerStructures-universal-1.20-5.1.0.jar";
            "hash" = "sha512-wi/tpm40CR0kAIdBikKZ/UMMq+SSZpjZwe94XDetgYfUYSTjKmLhsnKJTLmRWJ94dDH/2AoJNi5BIZxq5+StuQ==";
        };
        _FQq1mkSi = {
            "id" = "FQq1mkSi";
            "file" = "MoogsVoyagerStructures-universal-1.21-5.1.0.jar";
            "hash" = "sha512-q+WUIZnRBy52GkaoLZ+n+aucBenwYcafaaUxZ2dHxMvTXLuawuL/Gw7ftkf/3DQ+fPIKIQttkbzATPr5497sdA==";
        };
        _F4KldqbX = {
            "id" = "F4KldqbX";
            "file" = "MoogsVoyagerStructures-universal-1.21-5.1.1.jar";
            "hash" = "sha512-wFq/eiJto6WefrSIn6eK7345HMwHVVGjVF1LJO6QiVjcoTyHQIyV36jmWdDcX7q/md0dA0rSWOtJN7uYSudnyA==";
        };
        _HZpL7DX5 = {
            "id" = "HZpL7DX5";
            "file" = "MoogsVoyagerStructures-universal-1.20-5.1.1.jar";
            "hash" = "sha512-h83CsHxil/qxWAX3j4z5sd6Z//0Lr1tvDtYF9WtxuyliWG0g90B3VVCGgO0GDW5v4mqPcU6tOmDXU40/ROE+bg==";
        };
        _1ac5ccix = {
            "id" = "1ac5ccix";
            "file" = "MoogsVoyagerStructures-universal-1.21-5.1.2.jar";
            "hash" = "sha512-RsWF5qDJ2BRi7kbCWWdt+4AQTz/aJcjVRNsEvfvizF/R92LmmrtUPTNIvc5hA4HAELAKj37Z+ONOTuEm69cnqw==";
        };
    in {
        "7as7ADXL" = _7as7ADXL;
        "owkrXX1s" = _owkrXX1s;
        ...
        "forge-1.20" = _HZpL7DX5;
        "forge-1.20.1" = _HZpL7DX5;
        "forge-1.20.2" = _HZpL7DX5;
        "forge-1.20.3" = _HZpL7DX5;
        "forge-1.20.4" = _HZpL7DX5;
        "forge-1.20.5" = _HZpL7DX5;
        "forge-1.20.6" = _HZpL7DX5;
        "forge-1.21" = _1ac5ccix;
        "forge-1.21.1" = _1ac5ccix;
        "forge-1.21.2" = _1ac5ccix;
        "forge-1.21.3" = _1ac5ccix;
        "forge-1.21.4" = _1ac5ccix;
        "forge-1.21.5" = _1ac5ccix;
        "forge-1.21.6" = _1ac5ccix;
        "forge-1.21.7" = _1ac5ccix;
        "forge-1.21.8" = _1ac5ccix;
        "forge-1.21.9" = _1ac5ccix;
        "forge-1.21.10" = _1ac5ccix;
        "forge-1.21.11" = _1ac5ccix;
        "forge-26.1" = _1ac5ccix;
        "forge-26.1.1" = _1ac5ccix;
        "forge-26.1.2" = _1ac5ccix;
        "forge-26.2" = _1ac5ccix;
        "forge-26.3" = _1ac5ccix;
        ...
        "fabric-1.20" = _HZpL7DX5;
        "fabric-1.20.1" = _HZpL7DX5;
        "fabric-1.20.2" = _HZpL7DX5;
        "fabric-1.19.4" = _TadqDY3v;
        "fabric-1.20.3" = _HZpL7DX5;
        "fabric-1.20.4" = _HZpL7DX5;
        "fabric-1.20.5" = _HZpL7DX5;
        "fabric-1.20.6" = _HZpL7DX5;
        "fabric-1.21" = _1ac5ccix;
        "fabric-1.21.1" = _1ac5ccix;
        "fabric-1.21.4" = _1ac5ccix;
        "fabric-1.21.5" = _1ac5ccix;
        "fabric-1.21.6" = _1ac5ccix;
        "fabric-1.21.7" = _1ac5ccix;
        "fabric-1.21.8" = _1ac5ccix;
        "fabric-1.21.9" = _1ac5ccix;
        "fabric-1.21.10" = _1ac5ccix;
        "fabric-1.21.2" = _1ac5ccix;
        "fabric-1.21.3" = _1ac5ccix;
        "fabric-1.21.11" = _1ac5ccix;
        "fabric-26.1" = _1ac5ccix;
        "fabric-26.1.1" = _1ac5ccix;
        "fabric-26.1.2" = _1ac5ccix;
        "fabric-26.2" = _1ac5ccix;
        "fabric-26.3" = _1ac5ccix;
        ...
        "neoforge-1.20" = _HZpL7DX5;
        "neoforge-1.20.1" = _HZpL7DX5;
        "neoforge-1.20.2" = _HZpL7DX5;
        "neoforge-1.20.3" = _HZpL7DX5;
        "neoforge-1.20.4" = _HZpL7DX5;
        "neoforge-1.20.5" = _HZpL7DX5;
        "neoforge-1.20.6" = _HZpL7DX5;
        "neoforge-1.21" = _1ac5ccix;
        "neoforge-1.21.1" = _1ac5ccix;
        "neoforge-1.21.4" = _1ac5ccix;
        "neoforge-1.21.5" = _1ac5ccix;
        "neoforge-1.21.6" = _1ac5ccix;
        "neoforge-1.21.7" = _1ac5ccix;
        "neoforge-1.21.8" = _1ac5ccix;
        "neoforge-1.21.9" = _1ac5ccix;
        "neoforge-1.21.10" = _1ac5ccix;
        "neoforge-1.21.2" = _1ac5ccix;
        "neoforge-1.21.3" = _1ac5ccix;
        "neoforge-1.21.11" = _1ac5ccix;
        "neoforge-26.1" = _1ac5ccix;
        "neoforge-26.1.1" = _1ac5ccix;
        "neoforge-26.1.2" = _1ac5ccix;
        "neoforge-26.2" = _1ac5ccix;
        "neoforge-26.3" = _1ac5ccix;
        "pkg-3.1.4" = _7as7ADXL;
        "pkg-3.0.6" = _owkrXX1s;
        "pkg-2.5.9" = _OTnK2lWL;
        "pkg-2.2.5" = _GaIHziqo;
        "pkg-2.6.1" = _GtIKSDtY;
        "pkg-2.2.6-1.18.2" = _CjHdqdL3;
        "pkg-2.5.10-1.19.2" = _zvIKEhHo;
        "pkg-3.1.6-1.19.2" = _zqpp90gz;
        "pkg-3.1.7-1.19.3" = _RMpyEmrO;
        "pkg-2.5.11-1.19.3" = _Z3BUY6Rx;
        "pkg-2.5.12-1.19.3" = _LWmr4U8n;
        "pkg-3.2-1.19.2" = _x8NB2VrV;
        "pkg-3.2-1.19.4" = _he56TvwS;
        "pkg-4.0-1.20-fabric" = _sQESuL9s;
        "pkg-4.0-1.20-forge" = _ela0HjIs;
        "pkg-4.1-1.20-fabric" = _B1VGsBFk;
        "pkg-4.1-1.20-forge" = _MswqKniG;
        "pkg-4.1-1.19.2-fabric" = _6kTxDtOT;
        "pkg-4.1-1.19.2-forge" = _ZTaX3qnO;
        "pkg-4.1-1.19.4-fabric" = _nqLa8u7U;
        "pkg-4.1-1.19.4-forge" = _yFJ2X7AL;
        "pkg-4.1.1-1.19.2-forge" = _xRs9V70H;
        "pkg-4.1.1-1.19.4-fabric" = _RRVUkj0x;
        "pkg-4.1.1-1.19.4-forge" = _aTWItCTi;
        "pkg-4.1.1-1.20-fabric" = _MDlM9pIY;
        "pkg-4.1.1-1.20-forge" = _hKZzRjeN;
        "pkg-4.1.2-1.19.2-fabric" = _MHfeEqkS;
        "pkg-4.1.2-1.19.2-forge" = _aWohfTl8;
        "pkg-4.1.2-1.19.4-fabric" = _TadqDY3v;
        "pkg-4.1.2-1.19.4-forge" = _Qaj8NwIZ;
        "pkg-4.1.2-1.20-fabric" = _tbOvFJdA;
        "pkg-4.1.2-1.20-forge" = _iYOyd0Bu;
        "pkg-4.1.3-1.20.6-fabric" = _VpOxJpz5;
        "pkg-4.1.3" = _mMiZm0yg;
        "pkg-4.1.3-1.21-fabric" = _e6PhniyV;
        "pkg-4.1.2-1.20.4" = _mIRzn48P;
        "pkg-4.1.5-1.21-fabric" = _dhbVTbgM;
        "pkg-4.1.5-1.21-neoforge" = _wkTSRk0H;
        "pkg-4.2.5-1.21-fabric" = _7MNqnh2E;
        "pkg-4.2.5-1.21-neoforge" = _dE2uOScx;
        "pkg-4.2.6" = _ABq0F3uY;
        "pkg-4.2.6-1.21-fabric" = _iZ13qkr6;
        "pkg-4.3.0-1.21.4-fabric" = _PBoGZeSn;
        "pkg-4.3.0-1.21.4-neoforge" = _QdbA5Lbq;
        "pkg-4.3.1-1.21.4" = _RT5cfT9Z;
        "pkg-4.3.1-1.21.4-fabric" = _TW8m16gS;
        "pkg-4.2.7-1.21-neoforge" = _ILXwGq7m;
        "pkg-4.2.7-1.21-fabric" = _JRbl0gSO;
        "pkg-4.3.2-1.21.4-fabric" = _IPGIn59i;
        "pkg-4.3.2-1.21.4-neoforge" = _VHhC9NC9;
        "pkg-4.2.8-1.21-fabric" = _VYyt5avd;
        "pkg-4.2.8-1.21-neoforge" = _hPJGtGfd;
        "pkg-4.3.4-1.21.4" = _nVMl6LZC;
        "pkg-4.2.9-1.21" = _9BxIfLvU;
        "pkg-4.3.0-1.21" = _oIngqxxH;
        "pkg-4.4.5-1.21.5" = _9cn85zoQ;
        "pkg-4.1.5-1.20-forge" = _LimCQeNx;
        "pkg-4.1.5-1.20-fabric" = _OQH5doaL;
        "pkg-4.4.6-1.21.5-6" = _YXFL6hqj;
        "pkg-4.4.6-1.21.7" = _b4FftnkR;
        "pkg-4.4.6-1.21.8" = _LIfNH7BC;
        "pkg-4.4.7-1.21.5-6" = _irPQY2T3;
        "pkg-4.4.7-1.21.7" = _og6yuGU1;
        "pkg-4.4.7-1.21.8" = _REuAMYq3;
        "pkg-4.4.7-1.21.4" = _qjoBonma;
        "pkg-4.4.8-1.21.9" = _u4vRuMRO;
        "pkg-4.4.9-1.21.9-1.21.10" = _zjHFPrAq;
        "pkg-5.0.0" = _tY1h6UFY;
        "pkg-5.0.1" = _hFybik9s;
        "pkg-5.0.2" = _JwFlmoOp;
        "pkg-5.0.21" = _3jEMNi1E;
        "pkg-5.0.3" = _ZqmJ0yAc;
        "pkg-5.0.4" = _GRPrSi9S;
        "pkg-5.0.5" = _xT93OMBe;
        "pkg-5.0.6" = _TIfNi62J;
        ...
        "pkg-5.0.8" = _2kWFzrLt;
        "pkg-5.0.9" = _w8dck0sA;
        "pkg-5.0.10" = _yWllMkRb;
        "pkg-5.0.11" = _cvepxaBC;
        "pkg-5.0.14" = _uEZeTQ4b;
        "pkg-5.1.0" = _FQq1mkSi;
        "pkg-5.1.1" = _HZpL7DX5;
        "pkg-5.1.2" = _1ac5ccix;
        "default" = _1ac5ccix;
