...
let
    ...
    in {
        ...
        "pkg-1.1.1" = _HSsb9vQv;
        "pkg-1.1.2" = _6cmTyCft;
        "pkg-1.1.3+fabric-1.20.1" = _vxkn4FZt;
        "pkg-1.1.3+fabric-1.21.1" = _vOAEFk51;
        "pkg-1.1.3+fabric-26.1.2" = _hW6hOAHV;
        "pkg-1.1.3+fabric-26.2" = _FEBp27aA;
        "pkg-1.1.3+forge-1.20.1" = _Qrh01YiB;
