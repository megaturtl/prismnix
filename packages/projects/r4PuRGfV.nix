...
let
    versions = (let
        ...
        _xaGHkaus = {
            ...
            "hash" = "sha512-eW8wzx42iYF5GwWT6HrBrnIaGiSUeY8ersGqL5ODHBG0XmV/UBSCYi6eZte0pcOtXmFOH7Boge9teys2+ZBt1Q==";
        };
        _ROvChtQg = {
            "id" = "ROvChtQg";
            "file" = "MoogsEndStructures-universal-1.20-2.1.0.jar";
            "hash" = "sha512-JjjrVpcnj2PcBglXAvDPwSWM9ZUmviOsGdWGbzPD8ExQeSGO6mVt0+y9ncL9vFSSA3Ylz5x6Lp3qouzolD448Q==";
        };
        _S7bUhX4n = {
            "id" = "S7bUhX4n";
            "file" = "MoogsEndStructures-universal-1.21-2.1.1.jar";
            "hash" = "sha512-VzLJi/PR5qo8ds8j23cwEGXdlvBg+5v4XorwB2m8apPiE6rX/3mjEWs8/VAV/phDe9rfn9wN2Cnq4XWePB/ulg==";
        };
    in {
        "q0UL3Od1" = _q0UL3Od1;
        "YhUHKAJk" = _YhUHKAJk;
        ...
        "ROvChtQg" = _ROvChtQg;
        "S7bUhX4n" = _S7bUhX4n;
        "fabric-1.20" = _ROvChtQg;
        "fabric-1.20.1" = _ROvChtQg;
        "fabric-1.19.3" = _ZrsZZOv5;
        "fabric-1.19.4" = _ZrsZZOv5;
        "fabric-1.19" = _914UDoWa;
        "fabric-1.19.1" = _914UDoWa;
        "fabric-1.19.2" = _914UDoWa;
        "fabric-1.20.2" = _ROvChtQg;
        "fabric-1.20.3" = _ROvChtQg;
        "fabric-1.20.4" = _ROvChtQg;
        "fabric-1.20.5" = _ROvChtQg;
        "fabric-1.20.6" = _ROvChtQg;
        "fabric-1.21" = _S7bUhX4n;
        "fabric-1.21.1" = _S7bUhX4n;
        "fabric-1.21.4" = _S7bUhX4n;
        "fabric-1.21.5" = _S7bUhX4n;
        "fabric-1.21.6" = _S7bUhX4n;
        "fabric-1.21.7" = _S7bUhX4n;
        "fabric-1.21.8" = _S7bUhX4n;
        "fabric-1.21.9" = _S7bUhX4n;
        "fabric-1.21.10" = _S7bUhX4n;
        "fabric-1.21.2" = _S7bUhX4n;
        "fabric-1.21.3" = _S7bUhX4n;
        "fabric-1.21.11" = _S7bUhX4n;
        "fabric-26.1" = _S7bUhX4n;
        "fabric-26.1.1" = _S7bUhX4n;
        "fabric-26.1.2" = _S7bUhX4n;
        "fabric-26.2" = _S7bUhX4n;
        "fabric-26.3" = _S7bUhX4n;
        "forge-1.20" = _ROvChtQg;
        "forge-1.20.1" = _ROvChtQg;
        "forge-1.19.3" = _xiLADsJt;
        "forge-1.19.4" = _xiLADsJt;
        "forge-1.19" = _UVCxM93W;
        "forge-1.19.1" = _UVCxM93W;
        "forge-1.19.2" = _UVCxM93W;
        "forge-1.20.2" = _ROvChtQg;
        "forge-1.20.3" = _ROvChtQg;
        "forge-1.20.4" = _ROvChtQg;
        "forge-1.21" = _S7bUhX4n;
        "forge-1.21.1" = _S7bUhX4n;
        "forge-1.21.2" = _S7bUhX4n;
        "forge-1.21.3" = _S7bUhX4n;
        "forge-1.21.4" = _S7bUhX4n;
        "forge-1.21.5" = _S7bUhX4n;
        "forge-1.21.6" = _S7bUhX4n;
        "forge-1.21.7" = _S7bUhX4n;
        "forge-1.21.8" = _S7bUhX4n;
        "forge-1.21.9" = _S7bUhX4n;
        "forge-1.21.10" = _S7bUhX4n;
        "forge-1.21.11" = _S7bUhX4n;
        "forge-26.1" = _S7bUhX4n;
        "forge-26.1.1" = _S7bUhX4n;
        "forge-26.1.2" = _S7bUhX4n;
        "forge-1.20.5" = _ROvChtQg;
        "forge-1.20.6" = _ROvChtQg;
        "forge-26.2" = _S7bUhX4n;
        "forge-26.3" = _S7bUhX4n;
        ...
        "neoforge-1.20" = _ROvChtQg;
        "neoforge-1.20.1" = _ROvChtQg;
        "neoforge-1.20.2" = _ROvChtQg;
        "neoforge-1.20.3" = _ROvChtQg;
        "neoforge-1.20.4" = _ROvChtQg;
        "neoforge-1.20.5" = _ROvChtQg;
        "neoforge-1.20.6" = _ROvChtQg;
        "neoforge-1.21" = _S7bUhX4n;
        "neoforge-1.21.1" = _S7bUhX4n;
        "neoforge-1.21.4" = _S7bUhX4n;
        "neoforge-1.21.5" = _S7bUhX4n;
        "neoforge-1.21.6" = _S7bUhX4n;
        "neoforge-1.21.7" = _S7bUhX4n;
        "neoforge-1.21.8" = _S7bUhX4n;
        "neoforge-1.21.9" = _S7bUhX4n;
        "neoforge-1.21.10" = _S7bUhX4n;
        "neoforge-1.21.2" = _S7bUhX4n;
        "neoforge-1.21.3" = _S7bUhX4n;
        "neoforge-1.21.11" = _S7bUhX4n;
        "neoforge-26.1" = _S7bUhX4n;
        "neoforge-26.1.1" = _S7bUhX4n;
        "neoforge-26.1.2" = _S7bUhX4n;
        "neoforge-26.2" = _S7bUhX4n;
        "neoforge-26.3" = _S7bUhX4n;
        "pkg-1.1-1.20-fabric" = _q0UL3Od1;
        "pkg-1.1-1.20-forge" = _YhUHKAJk;
        "pkg-1.1-1.19.4-fabric" = _r5aEH7RL;
        "pkg-1.1-1.19.4-forge" = _SwWz3q6d;
        "pkg-1.1-1.19.2-fabric" = _CcPFq9Ev;
        "pkg-1.1-1.19.2-forge" = _OZXLK9wA;
        "pkg-1.2-1.20-fabric" = _1597Tazl;
        "pkg-1.2-1.20-forge" = _phipiA1L;
        "pkg-1.2-1.19.4-fabric" = _4DeQE7BQ;
        "pkg-1.2-1.19.4-forge" = _meObFVEJ;
        "pkg-1.2-1.19.2-fabric" = _Y34F1WUQ;
        "pkg-1.2-1.19.2-forge" = _2bZgJLST;
        "pkg-1.3-1.20-forge" = _m0dE9QBD;
        "pkg-1.3-1.20-fabric" = _GLblTUat;
        "pkg-1.3-1.19.4-forge" = _HS7qeiKF;
        "pkg-1.3-1.19.4-fabric" = _xmGoinJC;
        "pkg-1.3-1.19.2-forge" = _3VRMXtM5;
        "pkg-1.3-1.19.2-fabric" = _9sLOoGrD;
        "pkg-1.3.1-1.19.2-fabric" = _914UDoWa;
        "pkg-1.3.1-1.19.2-forge" = _UVCxM93W;
        "pkg-1.3.1-1.19.4-fabric" = _ZrsZZOv5;
        "pkg-1.3.1-1.19.4-forge" = _xiLADsJt;
        "pkg-1.3.1-1.20-fabric" = _s3M8KkSa;
        "pkg-1.3.1-1.20-forge" = _JCVb9fak;
        "pkg-1.3.2-1.20.6-fabric" = _o2LGbXuz;
        "pkg-1.3.2" = _dAnQWtz1;
        "pkg-1.3.2-1.21-fabric" = _Tuh65Tqq;
        "pkg-1.3.3-1.21-fabric" = _NTIE4tE4;
        "pkg-1.3.3-1.21-neoforge" = _s0Quk5Z8;
        "pkg-1.3.5" = _JibtQYn5;
        "pkg-1.3.5-1.21-fabric" = _KaiO0WDo;
        "pkg-1.3.4-1.20-forge" = _jevdEW7V;
        "pkg-1.3.4" = _yUhrlPZn;
        "pkg-1.3.4-1.20-fabric" = _H58OIzws;
        "pkg-1.3.4-1.20.6-fabric" = _RIt5tW4e;
        "pkg-1.4.0-1.21.4-fabric" = _PDyPPR4l;
        "pkg-1.4.0-1.21.4-neoforge" = _fk8IyLPO;
        "pkg-1.4.1-1.21.4-fabric" = _7nFVQ07D;
        "pkg-1.4.1-1.21.4-neoforge" = _kdt3Sem4;
        "pkg-1.4.2-1.21.4" = _8E0yBZ0A;
        "pkg-1.4.3-1.21.5" = _H4GZTMrE;
        "pkg-1.4.4-1.21.5-6" = _cCnIVz2X;
        "pkg-1.4.4-1.21.7" = _ULYB1Th0;
        "pkg-1.4.4-1.21.8" = _qibPIlBU;
        "pkg-1.4.5-1.21.8" = _uZAW0uQ4;
        "pkg-1.4.6-1.21.8" = _D1lQr0B1;
        "pkg-1.4.5-1.20" = _XBCTLHUm;
        "pkg-1.4.6-1.20" = _K1Z0ytq5;
        "pkg-1.4.6-1.20.6" = _CdYDFX5c;
        "pkg-1.4.6-1.21" = _cO2Hw6EY;
        "pkg-1.4.6-1.21.5-6" = _PZcvB5XQ;
        "pkg-1.4.6-1.21.7" = _FZY5H73L;
        "pkg-1.4.6-1.21.9" = _7XqNBEM4;
        "pkg-1.4.7-1.21.9-1.21.10" = _Am6lGk8F;
        "pkg-2.0.0" = _YejMGPG6;
        "pkg-2.0.1" = _wCxljxf5;
        "pkg-2.0.2" = _oN0WTi2D;
        "pkg-2.0.3" = _JW80uvhz;
