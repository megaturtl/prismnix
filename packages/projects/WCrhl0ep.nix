...
let
    ...
    in {
        ...
        "pkg-1.4.2-1.21.4" = _IK9QTQy0;
        "pkg-1.3.1-1.21.1" = _J3sbdPT7;
        "pkg-1.4.3-1.21.4" = _HH0NixdW;
        "pkg-1.3.2-1.21.1" = _jsF1lXgS;
        "pkg-1.4.4-1.21.4" = _EwQoqFVV;
        "pkg-1.3.3-1.21.1" = _F6jDPeIr;
        "pkg-1.5.0-1.21.5" = _fiu505GS;
        "pkg-1.3.4-1.21.1" = _mMBMPxBD;
        "pkg-1.5.1-1.21.5" = _qDqgYVDe;
        "pkg-1.3.5-1.21.1" = _gQyydkIf;
        "pkg-1.6.0-1.21.6(8)" = _GtMG0R9P;
        "pkg-1.6.1-1.21.6(8)" = _AaCdGdMZ;
        "pkg-1.6.2-1.21.5(8)" = _K17WszWA;
        "pkg-1.3.6-1.21.1" = _q0wN9zB5;
        "pkg-1.7.0-1.21.9" = _yn3ISJrV;
        "pkg-1.7.0-1.21.10" = _UM0LhlB4;
        "pkg-1.3.7-1.21.1" = _SAdxq5pE;
        "pkg-1.7.1-1.21.10" = _IllIjiGF;
        "pkg-1.6.3-1.21.5(8)" = _1XE4tOke;
        "pkg-1.8.0-1.21.11" = _LjpZ4mmC;
