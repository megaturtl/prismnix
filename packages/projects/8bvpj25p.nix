...
let
    ...
    in {
        ...
        "pkg-1.2-b1+MC1.17-1.17.1" = _wkRr01qn;
        "pkg-1.2.1-b1+MC1.18" = _YaIGhhV0;
        "pkg-1.2.1+MC1.18-1.18.1" = _3BbW86J8;
        "pkg-1.2.2+MC1.18-1.18.2" = _pAkKWU2S;
        "pkg-1.2.3+MC1.19" = _sjMYYn9W;
        "pkg-1.2.4+MC1.19" = _DMEmrfhm;
        "pkg-1.2.5+MC1.19" = _2jOA7t4c;
        "pkg-1.2.6+MC1.19" = _ExHCqDUl;
        "pkg-1.2.7+MC1.19.1" = _hmPf7v02;
        "pkg-1.2.8+MC1.19.1-1.19.2" = _n4WQHd7z;
        "pkg-1.2.9+MC1.19.3-1.19.4" = _xxGgdBkY;
        "pkg-1.2.10+MC1.20-1.20.1" = _mTem18WH;
        "pkg-1.2.11+MC1.20.2" = _feP9RPfc;
        "pkg-1.2.12+MC1.20.2-1.20.4" = _iMUjT9Ez;
        "pkg-1.2.13+MC1.20.2-1.20.4" = _ELJhX1Fy;
        "pkg-1.2.13+MC1.20-1.20.1" = _1bZxV3rG;
        "pkg-1.2.14+MC1.20.5" = _JcTbaZgo;
        "pkg-1.2.15+MC1.20.5-1.20.6" = _sUkB86tH;
        "pkg-1.3.0+MC1.21" = _uy0ezukZ;
        "pkg-1.3.1+MC1.21" = _SRa45y7a;
        "pkg-1.3.2+MC1.21-1.21.1" = _47Q5Isqi;
        "pkg-1.4.0+MC1.21.2-1.21.3" = _eER2muoZ;
        "pkg-1.5.0+MC1.21.4" = _GHELgMtD;
        "pkg-1.6.0+MC1.21.5" = _tuepfeLm;
        "pkg-1.3.3+MC1.21-1.21.1" = _izXXmfJ8;
        "pkg-1.4.1+MC1.21.2-1.21.3" = _EURqiTBC;
        "pkg-1.5.1+MC1.21.4" = _wrsnKjbQ;
        "pkg-1.6.1+MC1.21.5" = _ySR2gNOB;
        "pkg-1.7.0+MC1.21.6" = _fEIPgMOM;
        "pkg-1.7.1+MC1.21.6-1.21.7" = _SmOWR41z;
        "pkg-1.7.2+MC1.21.6-1.21.8" = _lSl6bdz5;
        "pkg-1.2.16+MC1.20-1.20.1" = _IN1JfzF7;
        "pkg-1.7.3+MC1.21.6-1.21.8" = _nHQD8gCm;
        "pkg-1.3.4+MC1.21-1.21.1" = _Ey7hsHmE;
        "pkg-1.4.2+MC1.21.2-1.21.3" = _bPU4ygxE;
        "pkg-1.5.2+MC1.21.4" = _Y1p35BAF;
        "pkg-1.6.2+MC1.21.5" = _vlPZOctz;
        "pkg-1.8.0+MC1.21.9-1.21.10" = _W95BYi1x;
        "pkg-1.3.5+MC1.21-1.21.1" = _5nqws1q7;
        "pkg-1.4.3+MC1.21.2-1.21.3" = _fzRPZdyh;
        "pkg-1.5.3+MC1.21.4" = _yetDvyg4;
        "pkg-1.6.3+MC1.21.5" = _V7CslwqV;
        "pkg-1.7.4+MC1.21.6-1.21.8" = _rJgc46LR;
        "pkg-1.8.1+MC1.21.9-1.21.10" = _NQqxXmbr;
