...
let
    versions = (let
        ...
        _XMZ4DLdc = {
            "id" = "XMZ4DLdc";
            "file" = "Maces AS+ v1.6.2.zip";
            "hash" = "sha512-CaPCjq5OdqPAWuZzMFRXL2pRBUC2TDzZrMkW8pZw8UQkRAzgK7byMToakl+jbKskGigywK8NYgXfuI+O3xKbNg==";
        };
    in {
        "AMV4CWHt" = _AMV4CWHt;
        "cqJrQox4" = _cqJrQox4;
        ...
        "BKhAndeZ" = _BKhAndeZ;
        "XMZ4DLdc" = _XMZ4DLdc;
        "minecraft-1.20" = _XMZ4DLdc;
        "minecraft-1.20.1" = _XMZ4DLdc;
        "minecraft-23w31a" = _XMZ4DLdc;
        "minecraft-23w32a" = _XMZ4DLdc;
        "minecraft-23w33a" = _XMZ4DLdc;
        "minecraft-23w35a" = _XMZ4DLdc;
        "minecraft-1.20.2-pre1" = _XMZ4DLdc;
        "minecraft-1.20.2" = _XMZ4DLdc;
        "minecraft-23w42a" = _XMZ4DLdc;
        "minecraft-23w43a" = _XMZ4DLdc;
        "minecraft-23w43b" = _XMZ4DLdc;
        "minecraft-23w44a" = _XMZ4DLdc;
        "minecraft-23w45a" = _XMZ4DLdc;
        "minecraft-23w46a" = _XMZ4DLdc;
        "minecraft-1.20.3" = _XMZ4DLdc;
        "minecraft-1.20.4" = _XMZ4DLdc;
        "minecraft-24w03a" = _XMZ4DLdc;
        "minecraft-24w03b" = _XMZ4DLdc;
        "minecraft-24w04a" = _XMZ4DLdc;
        "minecraft-24w05a" = _XMZ4DLdc;
        "minecraft-24w05b" = _XMZ4DLdc;
        "minecraft-24w06a" = _XMZ4DLdc;
        "minecraft-24w07a" = _XMZ4DLdc;
        "minecraft-24w09a" = _XMZ4DLdc;
        "minecraft-24w10a" = _XMZ4DLdc;
        "minecraft-24w11a" = _XMZ4DLdc;
        "minecraft-24w12a" = _XMZ4DLdc;
        "minecraft-24w13a" = _XMZ4DLdc;
        "minecraft-24w14potato" = _XMZ4DLdc;
        "minecraft-24w14a" = _XMZ4DLdc;
        "minecraft-1.20.5-pre1" = _XMZ4DLdc;
        "minecraft-1.20.5-pre2" = _XMZ4DLdc;
        "minecraft-1.20.5-pre3" = _XMZ4DLdc;
        "minecraft-1.20.5" = _XMZ4DLdc;
        "minecraft-1.20.6" = _XMZ4DLdc;
        "minecraft-24w18a" = _XMZ4DLdc;
        "minecraft-24w19a" = _XMZ4DLdc;
        "minecraft-24w19b" = _XMZ4DLdc;
        "minecraft-24w20a" = _XMZ4DLdc;
        "minecraft-1.21" = _XMZ4DLdc;
        "minecraft-1.21.1" = _XMZ4DLdc;
        "minecraft-24w33a" = _XMZ4DLdc;
        "minecraft-24w34a" = _XMZ4DLdc;
        "minecraft-24w35a" = _XMZ4DLdc;
        "minecraft-24w36a" = _XMZ4DLdc;
        "minecraft-24w37a" = _XMZ4DLdc;
        "minecraft-24w38a" = _XMZ4DLdc;
        "minecraft-24w39a" = _XMZ4DLdc;
        "minecraft-24w40a" = _XMZ4DLdc;
        "minecraft-1.21.2-pre1" = _XMZ4DLdc;
        "minecraft-1.21.2-pre2" = _XMZ4DLdc;
        "minecraft-1.21.2" = _XMZ4DLdc;
        "minecraft-1.21.3" = _XMZ4DLdc;
        "minecraft-24w44a" = _XMZ4DLdc;
        "minecraft-24w45a" = _XMZ4DLdc;
        "minecraft-24w46a" = _XMZ4DLdc;
        "minecraft-1.21.4" = _XMZ4DLdc;
        "minecraft-1.21.5" = _XMZ4DLdc;
        "minecraft-1.21.6" = _XMZ4DLdc;
        "minecraft-1.21.7" = _XMZ4DLdc;
        "minecraft-1.21.8" = _XMZ4DLdc;
        "minecraft-1.21.9" = _XMZ4DLdc;
        "minecraft-1.21.10" = _XMZ4DLdc;
        "minecraft-1.21.11" = _XMZ4DLdc;
        "pkg-1.2.2" = _AMV4CWHt;
        "pkg-1.3.0" = _cqJrQox4;
        "pkg-1.3.1" = _CPXr6MRd;
        "pkg-1.3.2" = _tFsZpyCq;
