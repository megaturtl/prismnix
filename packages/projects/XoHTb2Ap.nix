...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _tNIJLQ0s;
        "pkg-1.2.0" = _A9kFOzYp;
        "pkg-1.19.2-1.2.0" = _hr8mBtxW;
        "pkg-fabric-1.20.x-1.3.0" = _Ma4inj0t;
        "pkg-fabric-1.19.4-1.3.0" = _JWhtNGF1;
        "pkg-fabric-1.19.2-1.3.0" = _GnWu5MBX;
        "pkg-fabric-1.18.2-1.3.0" = _vxTxeqxq;
        "pkg-fabric-1.17.1-1.3.0" = _1tcTu2gg;
        "pkg-fabric-1.16.5-1.3.0" = _hHA8JsTG;
        "pkg-fabric-1.15.2-1.3.0" = _dToCk1c2;
        "pkg-fabric-1.14.4-1.3.0" = _nD8rQuRY;
        "pkg-1.3.0" = _QGuLhUxu;
        "pkg-fabric-1.20.2-1.3.1" = _BDwPfWKe;
        "pkg-1.3.2-beta+fabric.1.20.6" = _cYbHF2E2;
        "pkg-1.3.2+fabric.1.21.1-1.21.2" = _LE8aEZ5E;
        "pkg-1.3.3+fabric.1.21.3-1.21.4" = _1vi9VuRV;
        "pkg-1.4.1+fabric.1.21.5" = _esrSDBeH;
        "pkg-1.4.2+fabric.1.21.5" = _zdK9vaUj;
        "pkg-1.4.2" = _BISBCHTk;
        "pkg-1.4.2+fabric.1.21.6-1.21.8" = _CfcwomMK;
        "pkg-1.4.3+fabric.1.21.9+" = _tIJEZz19;
        "pkg-1.4.3" = _kFCmDE3w;
        "pkg-1.5.0+fabric.1.21.9+" = _HTfq0Z8U;
        "pkg-1.5.0+paper.1.21.9+" = _iwi4VPvU;
        "pkg-1.5.0+fabric.26.1" = _quBcj0Fx;
        "pkg-1.5.1+fabric.26.1" = _Su5eRdRq;
        "pkg-1.5.1+forge.26.1" = _v4gOaMJ5;
        "pkg-1.5.1+neoforge.26.1" = _AKirLGK4;
        "pkg-1.5.1+paper.26.1" = _oOXqn6vP;
        "pkg-1.5.2+fabric.26.2" = _qyk9ZGgC;
