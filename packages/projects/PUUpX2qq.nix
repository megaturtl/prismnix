...
let
    versions = (let
        ...
        _gmcptwnY = {
            "id" = "gmcptwnY";
            "file" = "Alacrity.zip";
            "hash" = "sha512-Rnsxl8zkgLNxeHRdDKzsMoZRYI5xVNUCo0hOV3x7OoenSg2giaftsn/UsXu/baK5P0rx7xJeGyBAmqgOoYqNXA==";
        };
        _Kc2ktOzs = {
            "id" = "Kc2ktOzs";
            "file" = "Alacrity.zip";
            "hash" = "sha512-Cw+qRVUxUwALTLsYdnL0nQbhm0IS88SQlkzJHm6XdnugCrQqMMS3erUplIg/mioSUfmP04PVnPoHzleT0UUoIg==";
        };
    in {
        "XeAsoSx5" = _XeAsoSx5;
        "G1nr1GBn" = _G1nr1GBn;
        ...
        "minecraft-1.20" = _Kc2ktOzs;
        "minecraft-1.20.1" = _Kc2ktOzs;
        "minecraft-1.20.2" = _Kc2ktOzs;
        "minecraft-1.20.3" = _Kc2ktOzs;
        "minecraft-1.20.4" = _Kc2ktOzs;
        "minecraft-1.20.5" = _Kc2ktOzs;
        "minecraft-1.20.6" = _Kc2ktOzs;
        "minecraft-1.21" = _Kc2ktOzs;
        "minecraft-1.21.1" = _Kc2ktOzs;
        "minecraft-1.21.2" = _Kc2ktOzs;
        "minecraft-1.21.3" = _Kc2ktOzs;
        "minecraft-1.21.4" = _Kc2ktOzs;
        "minecraft-1.21.5" = _Kc2ktOzs;
        "minecraft-1.21.6" = _Kc2ktOzs;
        "minecraft-1.21.7" = _Kc2ktOzs;
        "minecraft-1.21.8" = _Kc2ktOzs;
        "minecraft-1.21.9" = _Kc2ktOzs;
        "minecraft-1.21.10" = _Kc2ktOzs;
        "minecraft-1.21.11" = _Kc2ktOzs;
        "minecraft-23w14a" = _Kc2ktOzs;
        "minecraft-23w16a" = _Kc2ktOzs;
        "minecraft-23w31a" = _Kc2ktOzs;
        "minecraft-23w32a" = _Kc2ktOzs;
        "minecraft-23w33a" = _Kc2ktOzs;
        "minecraft-23w35a" = _Kc2ktOzs;
        "minecraft-1.20.2-pre1" = _Kc2ktOzs;
        "minecraft-23w42a" = _Kc2ktOzs;
        "minecraft-23w43a" = _Kc2ktOzs;
        "minecraft-23w43b" = _Kc2ktOzs;
        "minecraft-23w44a" = _Kc2ktOzs;
        "minecraft-23w45a" = _Kc2ktOzs;
        "minecraft-23w46a" = _Kc2ktOzs;
        "minecraft-24w03a" = _Kc2ktOzs;
        "minecraft-24w03b" = _Kc2ktOzs;
        "minecraft-24w04a" = _Kc2ktOzs;
        "minecraft-24w05a" = _Kc2ktOzs;
        "minecraft-24w05b" = _Kc2ktOzs;
        "minecraft-24w06a" = _Kc2ktOzs;
        "minecraft-24w07a" = _Kc2ktOzs;
        "minecraft-24w09a" = _Kc2ktOzs;
        "minecraft-24w10a" = _Kc2ktOzs;
        "minecraft-24w11a" = _Kc2ktOzs;
        "minecraft-24w12a" = _Kc2ktOzs;
        "minecraft-24w13a" = _Kc2ktOzs;
        "minecraft-24w14potato" = _Kc2ktOzs;
        "minecraft-24w14a" = _Kc2ktOzs;
        "minecraft-1.20.5-pre1" = _Kc2ktOzs;
        "minecraft-1.20.5-pre2" = _Kc2ktOzs;
        "minecraft-1.20.5-pre3" = _Kc2ktOzs;
        "minecraft-24w18a" = _Kc2ktOzs;
        "minecraft-24w19a" = _Kc2ktOzs;
        "minecraft-24w19b" = _Kc2ktOzs;
        "minecraft-24w20a" = _Kc2ktOzs;
        "minecraft-24w33a" = _Kc2ktOzs;
        "minecraft-24w34a" = _Kc2ktOzs;
        "minecraft-24w35a" = _Kc2ktOzs;
        "minecraft-24w36a" = _Kc2ktOzs;
        "minecraft-24w37a" = _Kc2ktOzs;
        "minecraft-24w38a" = _Kc2ktOzs;
        "minecraft-24w39a" = _Kc2ktOzs;
        "minecraft-24w40a" = _Kc2ktOzs;
        "minecraft-1.21.2-pre1" = _Kc2ktOzs;
        "minecraft-1.21.2-pre2" = _Kc2ktOzs;
        "minecraft-24w44a" = _Kc2ktOzs;
        "minecraft-24w45a" = _Kc2ktOzs;
        "minecraft-24w46a" = _Kc2ktOzs;
        "minecraft-26.1" = _Kc2ktOzs;
        "minecraft-26.1.1" = _Kc2ktOzs;
        "minecraft-26.1.2" = _Kc2ktOzs;
        "minecraft-26.2" = _Kc2ktOzs;
        "minecraft-26.3" = _Kc2ktOzs;
        "pkg-16.1" = _XeAsoSx5;
        "pkg-17" = _G1nr1GBn;
        "pkg-18" = _dfyK9p69;
        "pkg-19" = _rojjMgOC;
