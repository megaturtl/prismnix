...
let
    ...
    in {
        ...
        "minecraft-1.20" = _gmcptwnY;
        "minecraft-1.20.1" = _gmcptwnY;
        "minecraft-1.20.2" = _gmcptwnY;
        "minecraft-1.20.3" = _gmcptwnY;
        "minecraft-1.20.4" = _gmcptwnY;
        "minecraft-1.20.5" = _gmcptwnY;
        "minecraft-1.20.6" = _gmcptwnY;
        "minecraft-1.21" = _gmcptwnY;
        "minecraft-1.21.1" = _gmcptwnY;
        "minecraft-1.21.2" = _gmcptwnY;
        "minecraft-1.21.3" = _gmcptwnY;
        "minecraft-1.21.4" = _gmcptwnY;
        "minecraft-1.21.5" = _gmcptwnY;
        "minecraft-1.21.6" = _gmcptwnY;
        "minecraft-1.21.7" = _gmcptwnY;
        "minecraft-1.21.8" = _gmcptwnY;
        "minecraft-1.21.9" = _gmcptwnY;
        "minecraft-1.21.10" = _gmcptwnY;
        "minecraft-1.21.11" = _gmcptwnY;
        "minecraft-23w14a" = _gmcptwnY;
        "minecraft-23w16a" = _gmcptwnY;
        "minecraft-23w31a" = _gmcptwnY;
        "minecraft-23w32a" = _gmcptwnY;
        "minecraft-23w33a" = _gmcptwnY;
        "minecraft-23w35a" = _gmcptwnY;
        "minecraft-1.20.2-pre1" = _gmcptwnY;
        "minecraft-23w42a" = _gmcptwnY;
        "minecraft-23w43a" = _gmcptwnY;
        "minecraft-23w43b" = _gmcptwnY;
        "minecraft-23w44a" = _gmcptwnY;
        "minecraft-23w45a" = _gmcptwnY;
        "minecraft-23w46a" = _gmcptwnY;
        "minecraft-24w03a" = _gmcptwnY;
        "minecraft-24w03b" = _gmcptwnY;
        "minecraft-24w04a" = _gmcptwnY;
        "minecraft-24w05a" = _gmcptwnY;
        "minecraft-24w05b" = _gmcptwnY;
        "minecraft-24w06a" = _gmcptwnY;
        "minecraft-24w07a" = _gmcptwnY;
        "minecraft-24w09a" = _gmcptwnY;
        "minecraft-24w10a" = _gmcptwnY;
        "minecraft-24w11a" = _gmcptwnY;
        "minecraft-24w12a" = _gmcptwnY;
        "minecraft-24w13a" = _gmcptwnY;
        "minecraft-24w14potato" = _gmcptwnY;
        "minecraft-24w14a" = _gmcptwnY;
        "minecraft-1.20.5-pre1" = _gmcptwnY;
        "minecraft-1.20.5-pre2" = _gmcptwnY;
        "minecraft-1.20.5-pre3" = _gmcptwnY;
        "minecraft-24w18a" = _gmcptwnY;
        "minecraft-24w19a" = _gmcptwnY;
        "minecraft-24w19b" = _gmcptwnY;
        "minecraft-24w20a" = _gmcptwnY;
        "minecraft-24w33a" = _gmcptwnY;
        "minecraft-24w34a" = _gmcptwnY;
        "minecraft-24w35a" = _gmcptwnY;
        "minecraft-24w36a" = _gmcptwnY;
        "minecraft-24w37a" = _gmcptwnY;
        "minecraft-24w38a" = _gmcptwnY;
        "minecraft-24w39a" = _gmcptwnY;
        "minecraft-24w40a" = _gmcptwnY;
        "minecraft-1.21.2-pre1" = _gmcptwnY;
        "minecraft-1.21.2-pre2" = _gmcptwnY;
        "minecraft-24w44a" = _gmcptwnY;
        "minecraft-24w45a" = _gmcptwnY;
        "minecraft-24w46a" = _gmcptwnY;
        "minecraft-26.1" = _gmcptwnY;
        "minecraft-26.1.1" = _gmcptwnY;
        "minecraft-26.1.2" = _gmcptwnY;
        "minecraft-26.2" = _gmcptwnY;
        "pkg-16.1" = _XeAsoSx5;
        "pkg-17" = _G1nr1GBn;
        "pkg-18" = _dfyK9p69;
        "pkg-19" = _rojjMgOC;
