...
let
    versions = (let
        ...
        _BbRYOGo5 = {
            "id" = "BbRYOGo5";
            "file" = "Flashback-0.42.2-for-MC26.2.jar";
            "hash" = "sha512-HqnD8vQP/eyVGpNXaFo9/Hd2jQPq7q0JVRGKr//h/VBl16YiHf7LKuS7OLsBr02cEk9Yk7l0+rkzxZrLvuO7rg==";
        };
        _rXE1571x = {
            "id" = "rXE1571x";
            "file" = "Flashback-0.43.1-for-MC26.1.jar";
            "hash" = "sha512-HjbByJPnJdQ6SRbalqQ1B1EDq2iOIgL3TDzLluzlRNnsSRUhKKC8acaPnYhoKJA7qqQl915kRh966eUqoDDAPQ==";
        };
        _8bITQOSG = {
            "id" = "8bITQOSG";
            "file" = "Flashback-0.43.2-for-MC26.2.jar";
            "hash" = "sha512-0/v3nocWiLUN46ZXnJgkqtRH3sJjBCoG0QLuv9lQZvFZ1N/E6+0IJK1XdeNJ3u8t1IlkX5qzk83YLw/OJkMaRg==";
        };
        _d1dppNas = {
            "id" = "d1dppNas";
            "file" = "Flashback-0.39.8-for-MC1.21.jar";
            "hash" = "sha512-Ja4r/YqQfj6npdDj7eUXXoztgma8CtphT1at1LwHp6lmoZ8I1QmLuOdf+ZXozEtn8m0e7NpBvZqEISeMEICu2A==";
        };
        _ZPjE5qyt = {
            "id" = "ZPjE5qyt";
            "file" = "Flashback-0.39.8-for-MC1.21.4.jar";
            "hash" = "sha512-jgQpniyQLDQVWtZaXU/x94cm9ztLNNKBb+0XygHTKWrcehwaPrPlbHEt4K9MnQKT3Bo5oDcstqgi0o4XXuFSpw==";
        };
        _1peG4ZMP = {
            "id" = "1peG4ZMP";
            "file" = "Flashback-0.39.8-for-MC1.21.5.jar";
            "hash" = "sha512-DGngyRuTbpET9uIzJMCYmrWa9kbvV65Ml7t15+Up2yRK4omhX/HiHSFE4/RrIeTGAbL6CgeSOP4fqY5YWgd3Yg==";
        };
        _cECNAW4x = {
            "id" = "cECNAW4x";
            "file" = "Flashback-0.39.8-for-MC1.21.8.jar";
            "hash" = "sha512-bFj7ezkYmLBoJ6AEDCeqGyf4FjZBx1wd4KxUvPCvKd42+Td62UlKw1d9qHimBGkAQBLJoPYSk9r66JQgEeVjMw==";
        };
        _RxaKqsBm = {
            "id" = "RxaKqsBm";
            "file" = "Flashback-0.39.8-for-MC1.21.10.jar";
            "hash" = "sha512-PymBW1JPVkIfjnpcemtxWRtq5Jxm9/eDKx0kmahlguTrbyYZHAqQ3PNUoLkZErMRIupgIhFltwD9vPSIowZAxg==";
        };
        _Km7BHQo4 = {
            "id" = "Km7BHQo4";
            "file" = "Flashback-0.39.8-for-MC1.21.11.jar";
            "hash" = "sha512-oHHV70n4GarReNNIPzPtuQv/H1RTonE2hLffE/fhBj9OEfMM6+gt+FING9v1PIUUoHU9q5yxLysGH/8CZkmuDw==";
        };
        _2obIELyD = {
            "id" = "2obIELyD";
            "file" = "Flashback-0.43.3-for-MC26.1.jar";
            "hash" = "sha512-xy0FJE811dYq2RKYujue/fV9dt6Ulsxt6dOyGBLhbJO4nn+T1lXm16GwKnVAOIfQTrKPnF1c0N0UYfklQad6zg==";
        };
        _fZW00XaD = {
            "id" = "fZW00XaD";
            "file" = "Flashback-0.43.3-for-MC26.2.jar";
            "hash" = "sha512-boWbSyTTp7FNSiSKAAEzOwxJp+whauhYAmCU0XK4qJpXSTJ4ZYKuBGkaSm6kGNYxRueVK3sS8B50CdOQjVeoUA==";
        };
        _wZHvoJL4 = {
            "id" = "wZHvoJL4";
            "file" = "Flashback-0.39.9-for-MC1.21.1.jar";
            "hash" = "sha512-FMBQKvKL2CmoinPJvc1Y9g1S5YEKj9U+4T1LAbpali4+B+GmLG6aGH4jaVpkn3/OzfQUOPC+HrK9386jcDjiWQ==";
        };
        _fEAYoULc = {
            "id" = "fEAYoULc";
            "file" = "Flashback-0.39.9-for-MC1.21.4.jar";
            "hash" = "sha512-8OttBBUCA38Ny+yiVSCNJzRpVPleVqrmKeqQ2HMQlpaMJSXr43EnUJb1kcyevzsF3WYe9M+uuVAXHzBEvdJ0lQ==";
        };
        _jDtuXjaB = {
            "id" = "jDtuXjaB";
            "file" = "Flashback-0.39.9-for-MC1.21.5.jar";
            "hash" = "sha512-2e264kls5n2PLKyvnCcKkaZuDZVu2xNt4kT1XIfv+pwBcO1Rhi/1qFFOnZoPYjYsCreiE72c1yhwDfteZWqbMg==";
        };
        _nHsysn84 = {
            "id" = "nHsysn84";
            "file" = "Flashback-0.39.9-for-MC1.21.8.jar";
            "hash" = "sha512-Y9Ca5i+Cm9vKxeVrjyGG7qp83b45uvwwwEPdQ92fxtqnuH9huwsZop1/403cB8ZeC0C6reKSZ25QgvrYTqiTuw==";
        };
        _Ocxu16Iw = {
            "id" = "Ocxu16Iw";
            "file" = "Flashback-0.39.9-for-MC1.21.10.jar";
            "hash" = "sha512-QfB9ICAa5oqQFOga+nWBGLi4mdYby3wvRCUF0F02gbSol76wSmsPQp6CKFQafQmsFI3nEBl5piQAiawPEBceow==";
        };
        _jX4lPCLC = {
            "id" = "jX4lPCLC";
            "file" = "Flashback-0.39.9-for-MC1.21.11.jar";
            "hash" = "sha512-GuhxyM2BaiBnDBCeORkCohpYocNjukHwRvncCtzPuDR3GPj5D04xbICHJtpVtk16w+YFkaQXoP8X3wS8daFDaw==";
        };
        _jE9h9P8L = {
            "id" = "jE9h9P8L";
            "file" = "Flashback-0.43.4-for-MC26.1.jar";
            "hash" = "sha512-ynWHeGuN9YSyQMU5I/LzaR6W7b7fIG3ZEwHrZfVG+VIKSceg6PQ2dt15u0PJI3+VE4jka1lFjqmNqvIyahedNw==";
        };
        _h6FH7iAC = {
            "id" = "h6FH7iAC";
    ...
    in {
        ...
        "pkg-0.8.0" = _ZJ3kxCVd;
        "pkg-0.9.0" = _QP5RLOnl;
        "pkg-0.10.0" = _DTQdmnfW;
        "pkg-0.11.0" = _FyEUYd8n;
        "pkg-0.13.0" = _mFplZNy6;
        "pkg-0.14.0" = _G863R7rB;
        "pkg-0.15.0" = _phWB81q5;
        "pkg-0.16.0" = _qZXZW2KF;
        "pkg-0.17.0" = _a9VLruXK;
        "pkg-0.17.2" = _BYjovGqL;
        "pkg-0.18.0" = _zTOsZaxR;
        "pkg-0.20.0" = _S0Fc3jYH;
        "pkg-0.20.1" = _OJJaw9FV;
        "pkg-0.30.0" = _spFS6uTQ;
        "pkg-0.31.0" = _1s6tMPy9;
        "pkg-0.31.1" = _7amKKVQL;
        "pkg-0.32.0" = _69c5G5pv;
        "pkg-0.32.1" = _p95k77zu;
        "pkg-0.33.0" = _BoZkOz9E;
        "pkg-0.34.0" = _rNCr1Rbs;
        "pkg-0.35.2" = _nTEOqUP3;
        "pkg-0.36.0" = _hQkBepoB;
        "pkg-0.37.0" = _z0SX4zNw;
        "pkg-0.38.0" = _wNUb5o27;
        "pkg-0.38.1" = _h1Uz2DX0;
        "pkg-0.38.2" = _pOGQFvgK;
        "pkg-0.39.1" = _vQyhWboq;
        "pkg-0.39.2" = _TBJhV6PS;
        "pkg-0.39.3" = _VaqZB1DF;
        "pkg-0.39.4" = _xs2Obe8Z;
        "pkg-0.39.5" = _AGkqd25Y;
        "pkg-0.40.0" = _XRtfepgi;
        "pkg-0.41.1" = _cGezdWTX;
        "pkg-0.39.6" = _YdrGfqsJ;
        "pkg-0.42.0" = _nvfyhAhI;
        "pkg-0.39.7" = _3GzWAKj5;
        "pkg-0.42.1" = _HkyawEi6;
        "pkg-0.42.2" = _BbRYOGo5;
        "pkg-0.43.1" = _rXE1571x;
        "pkg-0.43.2" = _8bITQOSG;
