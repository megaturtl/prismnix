...
let
    ...
    in {
        ...
        "pkg-1.0b8" = _RsNV9FK4;
        "pkg-1.0b9" = _QyleobzW;
        "pkg-1.0b10" = _FRGiQjHe;
        "pkg-1.0b11" = _fWMKdmNz;
        "pkg-1.0b12" = _LrHdgQT1;
        "pkg-1.0b13" = _xMcdn5cV;
        "pkg-1.0b14" = _jX3E5xDt;
        "pkg-1.0b15" = _iv2HoI57;
        "pkg-v1.0b16" = _d8Zlrt0n;
        "pkg-1.0b17" = _L53qifEu;
        "pkg-1.0b18" = _jpD7Ft3G;
        "pkg-1.0b19" = _faZWV671;
        "pkg-1.0R1" = _LHW1L89Q;
        "pkg-1.1b1" = _L3Ahl0ai;
        "pkg-1.1b2" = _UPHHi6Wn;
        "pkg-1.1b3" = _GznTqSEP;
