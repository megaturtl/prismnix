...
let
    versions = (let
        ...
        _xzXzQR1F = {
            "id" = "xzXzQR1F";
            "file" = "notify-bungeecord.jar";
            "hash" = "sha512-+jW9QXYNjfKp0tNun+DevHTGF9ASTgySCtzNC+rLwaAuJ1zacrbuLC8xO3l+psypkPcRQaARFgy1AQTaJkP+4A==";
        };
        _sbuz1L6r = {
            "id" = "sbuz1L6r";
            "file" = "notify-velocity.jar";
            "hash" = "sha512-j0MeLFq3bUeanwbPCkdI+Fp7RS5JZh9irJQOQf9cHhVfG8YP1oZ4vpBMTaOJKBEBGJjZFg4G7oc+LC6LR+RCQw==";
        };
    in {
        "xCKRqQup" = _xCKRqQup;
        "hfFdSPEZ" = _hfFdSPEZ;
        ...
        "xzXzQR1F" = _xzXzQR1F;
        "sbuz1L6r" = _sbuz1L6r;
        "bungeecord-1.20" = _xzXzQR1F;
        "bungeecord-1.20.1" = _xzXzQR1F;
        "bungeecord-1.20.2" = _xzXzQR1F;
        "bungeecord-1.20.3" = _xzXzQR1F;
        "bungeecord-1.20.4" = _xzXzQR1F;
        "bungeecord-1.20.5" = _xzXzQR1F;
        "bungeecord-1.20.6" = _xzXzQR1F;
        "bungeecord-1.21" = _xzXzQR1F;
        "bungeecord-1.21.1" = _xzXzQR1F;
        "bungeecord-1.21.2" = _xzXzQR1F;
        "bungeecord-1.21.3" = _xzXzQR1F;
        "bungeecord-1.21.4" = _xzXzQR1F;
        "bungeecord-1.21.5" = _xzXzQR1F;
        "bungeecord-1.21.6" = _xzXzQR1F;
        "bungeecord-1.21.7" = _xzXzQR1F;
        "bungeecord-1.21.8" = _xzXzQR1F;
        "bungeecord-1.21.9" = _xzXzQR1F;
        "bungeecord-1.21.10" = _xzXzQR1F;
        "bungeecord-1.21.11" = _xzXzQR1F;
        "bungeecord-26.1" = _xzXzQR1F;
        "bungeecord-26.1.1" = _xzXzQR1F;
        "bungeecord-26.1.2" = _xzXzQR1F;
        "bungeecord-26.2" = _xzXzQR1F;
        "bungeecord-26.3" = _xzXzQR1F;
        "velocity-1.20" = _sbuz1L6r;
        "velocity-1.20.1" = _sbuz1L6r;
        "velocity-1.20.2" = _sbuz1L6r;
        "velocity-1.20.3" = _sbuz1L6r;
        "velocity-1.20.4" = _sbuz1L6r;
        "velocity-1.20.5" = _sbuz1L6r;
        "velocity-1.20.6" = _sbuz1L6r;
        "velocity-1.21" = _sbuz1L6r;
        "velocity-1.21.1" = _sbuz1L6r;
        "velocity-1.21.2" = _sbuz1L6r;
        "velocity-1.21.3" = _sbuz1L6r;
        "velocity-1.21.4" = _sbuz1L6r;
        "velocity-1.21.5" = _sbuz1L6r;
        "velocity-1.21.6" = _sbuz1L6r;
        "velocity-1.21.7" = _sbuz1L6r;
        "velocity-1.21.8" = _sbuz1L6r;
        "velocity-1.21.9" = _sbuz1L6r;
        "velocity-1.21.10" = _sbuz1L6r;
        "velocity-1.21.11" = _sbuz1L6r;
        "velocity-26.1" = _sbuz1L6r;
        "velocity-26.1.1" = _sbuz1L6r;
        "velocity-26.1.2" = _sbuz1L6r;
        "velocity-26.2" = _sbuz1L6r;
        "velocity-26.3" = _sbuz1L6r;
        "waterfall-1.20" = _xzXzQR1F;
        "waterfall-1.20.1" = _xzXzQR1F;
        "waterfall-1.20.2" = _xzXzQR1F;
        "waterfall-1.20.3" = _xzXzQR1F;
        "waterfall-1.20.4" = _xzXzQR1F;
        "waterfall-1.20.5" = _xzXzQR1F;
        "waterfall-1.20.6" = _xzXzQR1F;
        "waterfall-1.21" = _xzXzQR1F;
        "waterfall-1.21.1" = _xzXzQR1F;
        "waterfall-1.21.2" = _xzXzQR1F;
        "waterfall-1.21.3" = _xzXzQR1F;
        "waterfall-1.21.4" = _xzXzQR1F;
        "waterfall-1.21.5" = _xzXzQR1F;
        "waterfall-1.21.6" = _xzXzQR1F;
        "waterfall-1.21.7" = _xzXzQR1F;
        "waterfall-1.21.8" = _xzXzQR1F;
        "waterfall-1.21.9" = _xzXzQR1F;
        "waterfall-1.21.10" = _xzXzQR1F;
        "waterfall-1.21.11" = _xzXzQR1F;
        "waterfall-26.1" = _xzXzQR1F;
        "waterfall-26.1.1" = _xzXzQR1F;
        "waterfall-26.1.2" = _xzXzQR1F;
        "waterfall-26.2" = _xzXzQR1F;
        "waterfall-26.3" = _xzXzQR1F;
        "pkg-0.0.1-dev.1cba142" = _hfFdSPEZ;
        "pkg-0.0.1-dev.34ea0b5" = _qwFN7IcI;
        "pkg-0.0.1-dev.2c1a545" = _vQqjPoyH;
        "pkg-0.0.1-dev.46bf28c" = _pa2sFftl;
        "pkg-0.0.1-dev.33adf16" = _44H8lYR1;
        "pkg-0.0.1-dev.a023265" = _WVqs0eT0;
        "pkg-0.0.2-dev.6634e42" = _xByfEOYL;
        "pkg-0.0.2-dev.d65eb80" = _1pMEiw6y;
        "pkg-0.0.2-dev.287427c" = _WgnP8ctD;
        "pkg-0.0.2-dev.7cf06fb" = _ybI1IEJ2;
        "pkg-0.0.2-dev.0cab448" = _xfm9t6TX;
        "pkg-0.0.2-dev.66cf3a6" = _tMgnCAcP;
        "pkg-0.0.3-dev.ceb819e" = _VnkyM2ka;
        "pkg-0.0.4-dev.4e82a82" = _fRPZfjDN;
        "pkg-0.0.5-dev.c641afa" = _9FvlJthy;
        "pkg-0.0.6-dev.d629aea" = _PGtiqHgR;
        "pkg-0.0.7-dev.d56663f" = _u12s7ZUK;
        "pkg-0.0.8-dev.abc7437" = _sbuz1L6r;
        "default" = _sbuz1L6r;
    });
