...
let
    ...
    in {
        ...
        "pkg-2.1.1" = _G1GaN6tZ;
        "pkg-2.2.0" = _rV7JyaFM;
        "pkg-2.2.0-1.12" = _1hVjcbe3;
        "pkg-2.3.0" = _SMIAiJda;
        "pkg-2.3.1" = _jF71muPZ;
        "pkg-2.3.11.17" = _wDW4caeK;
        "pkg-2.3.21.17" = _BBczZajG;
        "pkg-2.3.2-1.16" = _XX05jFgD;
        "pkg-2.3.4-1.16" = _vze6tO9T;
        "pkg-2.3.4-1.17" = _Z8tmAOLp;
        "pkg-2.3.4-1.16." = _4niqKAeO;
        "pkg-2.3.5-fabric-1.17" = _ClH2Bdmz;
        "pkg-2.3.5-1.17" = _nlvY8DWO;
        "pkg-2.3.5-1.16" = _TF9ZiOwG;
        "pkg-2.3.5" = _6kMFevuI;
        "pkg-2.3.5-1.16." = _wdyxdYrZ;
        "pkg-2.3.5." = _7KPIGfsb;
        "pkg-2.3.5-1.16.5" = _D1hlMIJ3;
        "pkg-2.3.5-1.16.5." = _HLhVpK41;
        "pkg-2.3.5-fabric-1.18" = _otxswM2L;
        "pkg-2.3.5-1.18" = _j3aH9pi4;
        "pkg-2.4.0-1.18.2" = _oQ5wihTZ;
        "pkg-2.4.1-1.18.2" = _MJxuD0vb;
        "pkg-2.4.1-fabric-1.18.2" = _u8hpTF5M;
        "pkg-2.4.1-1.16.5" = _pMkbo7CU;
        "pkg-2.4.2-1.18.2" = _lqH7ML87;
        "pkg-2.4.2-fabric-1.18.2" = _BhDei3gF;
        "pkg-2.4.2-1.16.5" = _81cXxovv;
        "pkg-2.4.3-1.18.2" = _1RzVQ2d5;
        "pkg-2.4.4-1.19" = _U0LqSWo7;
        "pkg-2.4.4-1.18.2" = _AAPbAReu;
        "pkg-2.4.4-1.16.5" = _y8bMMvI7;
        "pkg-2.4.4.1-1.16.5" = _WPv7K6l0;
        "pkg-2.4.4.1-1.18.2" = _aUyHOPa2;
        "pkg-2.4.4.1-1.19" = _RAlcmazy;
        "pkg-2.4.5-1.18.2" = _dzMUVo0a;
        "pkg-2.4.5-1.16.5" = _hxXiJAZl;
        "pkg-2.4.5-1.19" = _Oo2lM1WC;
        "pkg-2.4.5" = _yijmWo8h;
        "pkg-2.4.6-1.19.1" = _6oX5EEVX;
        "pkg-2.4.7-1.19.1" = _H9OABUKJ;
        "pkg-2.4.7-1.18.2" = _fJfcgBlo;
        "pkg-2.4.7-1.16.5" = _NNCdgxu7;
        "pkg-2.4.71.12.2" = _DM4qSykZ;
        "pkg-2.4.7-1.19.2" = _Du9Gu868;
        "pkg-2.4.7.11.12.2" = _xLuSqQki;
        "pkg-2.5.0-1.18.2" = _7I80E1QP;
        "pkg-2.5.0spigot1.19.2" = _6IYYE6z9;
        "pkg-2.5.0-1.19.2" = _H47c33TR;
        "pkg-2.6.0spigot1.19.3" = _2fgeJmyX;
        "pkg-2.6.0-1.19.3" = _XWaJDBSe;
        "pkg-2.6.2-1.18.2" = _soh4Cq45;
        "pkg-2.6.2-1.19.3" = _qZYc6MED;
        "pkg-2.6.2spigot1.19.3" = _ZrZ1nJXz;
        "pkg-2.6.2-1.19.2" = _dPVICF67;
        "pkg-2.6.4-1.19.3" = _sFNLLQC4;
        "pkg-2.6.4-1.19.4" = _qp1MSsid;
        "pkg-2.6.4-1.19.2" = _SWDTtIps;
        "pkg-2.6.4-1.18.2" = _I6UkX6Ob;
        "pkg-3.0.0-1.20.1" = _8WHjxZMQ;
        "pkg-3.0.1-1.19.2" = _5qpoRT03;
        "pkg-3.0.1-1.19.4" = _hlS3ZfKg;
        "pkg-3.0.1-1.20.1" = _xUhZhT8a;
        "pkg-3.0.1-1.18.2" = _OCKNDfJD;
        "pkg-3.0.1spigot1.20.1" = _871SH65k;
        "pkg-3.0.2-1.20.1" = _c1uw17Dt;
        "pkg-3.0.2-1.19.4" = _ePiNT5VV;
        "pkg-3.0.2-1.19.2" = _7fw9e8yR;
        "pkg-3.0.2-1.18.2" = _TnQM84SR;
        "pkg-3.0.2spigot1.20.1" = _ppLFpjAY;
        "pkg-3.0.3-1.20.1" = _RZpa9Y3q;
        "pkg-3.0.3-1.20.2" = _ZlLJC9ox;
        "pkg-3.0.3-1.19.4" = _qLepK1x9;
        "pkg-3.0.3-1.19.2" = _v3OJZ9sg;
        "pkg-3.0.3-1.18.2" = _VRZyJM4a;
        "pkg-3.0.3spigot1.20.1" = _8aXeAavL;
        "pkg-3.0.3-1.16.5" = _AwBaZp1d;
        "pkg-3.0.4-1.19.4" = _bdvFrykd;
        "pkg-3.0.4-1.19.2" = _FF9yC5SC;
        "pkg-3.0.4-1.20.1" = _76oAGkqR;
        "pkg-3.0.4-1.18.2" = _u9uFYEhQ;
        "pkg-3.0.4.1-1.19.4" = _GjW1eSd7;
        "pkg-3.0.4.1-1.19.2" = _NQOuh3zO;
        "pkg-3.0.4.1-1.20.1" = _K8oOzrH0;
        "pkg-3.0.4" = _g3DokvIK;
        "pkg-3.0.5-1.19.4" = _D3jinyNw;
        "pkg-3.0.5-1.19.2" = _G1kMnNdl;
        "pkg-3.0.5-1.18.2" = _sCNinVrE;
        "pkg-3.0.5-1.20.1" = _QwJ1mIOo;
        "pkg-3.0.5-1.16.5" = _ZNd0vTyv;
        "pkg-3.0.5spigot1.20.1" = _QqrBPuOz;
        "pkg-3.0.5-1.20.2" = _3BnVbbJS;
        "pkg-3.0.5.1spigot1.20.1" = _lP27fggH;
        "pkg-3.0.5-1.20.4" = _t7t8BbD7;
        "pkg-3.0.6-1.20.4" = _QoapHSQM;
        "pkg-3.0.6-1.20.2" = _L0IIA8Da;
        "pkg-3.0.6-1.19.4" = _ovGx1ENg;
        "pkg-3.0.6-1.18.2" = _NrDYnnlf;
        "pkg-3.0.6-1.20.1" = _5j2yF4ub;
        "pkg-3.0.7-1.20.4" = _WwSQdU5H;
        "pkg-3.0.7-1.20.2" = _QOzfHPjB;
        "pkg-3.0.7-1.20.1" = _HvnD1N3N;
        "pkg-3.0.7-1.19.4" = _hlAiaE87;
        "pkg-3.0.7-1.18.2" = _viNyyNfK;
        "pkg-3.0.7spigot1.20.4" = _wwq2XFWM;
        "pkg-3.0.7.1spigot1.20.4" = _YjBjd4DI;
        "pkg-3.0.7-1.20.6" = _kVffcBQn;
        "pkg-3.0.7.1-1.20.1" = _ILJrSvYW;
        "pkg-3.0.7-1.21" = _Tvnxofx4;
        "pkg-3.0.7.1-1.21" = _M7DhZ9ge;
        "pkg-3.0.7.2-1.21" = _I3kp6jxL;
        "pkg-3.1.0-1.21.3" = _m5FJRbtl;
        "pkg-3.1.0.1-1.21.3" = _C2o574ps;
        "pkg-3.1.0-1.21.5" = _FAapTjCe;
        "pkg-3.1.0.1-1.21.5" = _KKof0KSR;
        "pkg-3.1.0.1-1.21.6" = _JOLMTAVo;
        "pkg-3.1.0.1-1.21.8" = _hnvQhJVC;
        "pkg-3.1.0.1-1.21.9" = _Uzz4Lppk;
        "pkg-3.1.0.1-1.21.10" = _595l6i6O;
        "pkg-3.1.0.2-1.21.11" = _VXL6R2hS;
