...
let
    versions = (let
        ...
        _lEtBnsUK = {
            "id" = "lEtBnsUK";
            "file" = "ShopkeepersAddon-2.27.0-260804.jar";
            "hash" = "sha512-lCPnRodos6ETGtrEXEQmOv6t6XOS8w9UqmtKQJWmIsK3jtIp2hxp9P2ykLevaxt5tuOrGPM1YseI4KvBoxRm1A==";
        };
        _kE1h0l5B = {
            "id" = "kE1h0l5B";
            "file" = "ShopkeepersAddon-2.27.0-260811.jar";
            "hash" = "sha512-K+1rbk2Epwxo2kRPRtSUm83DjNE+bIMD5bFx419atFPRRszbFdRKlfPU4bdmDTcitRFjBzVYs/EDNFMXCGZ5RQ==";
        };
    in {
        "6a4gh9sX" = _6a4gh9sX;
        "6KLI4v12" = _6KLI4v12;
        ...
        "spigot-1.20.6" = _kE1h0l5B;
        "spigot-1.21" = _kE1h0l5B;
        "spigot-1.21.1" = _kE1h0l5B;
        "spigot-1.21.2" = _kE1h0l5B;
        "spigot-1.21.3" = _kE1h0l5B;
        "spigot-1.21.4" = _kE1h0l5B;
        "spigot-1.16" = _6KLI4v12;
        "spigot-1.16.1" = _6KLI4v12;
        "spigot-1.16.2" = _6KLI4v12;
        "spigot-1.16.3" = _6KLI4v12;
        "spigot-1.16.4" = _6KLI4v12;
        "spigot-1.21.5" = _kE1h0l5B;
        "spigot-1.21.6" = _kE1h0l5B;
        "spigot-1.21.7" = _kE1h0l5B;
        "spigot-1.21.8" = _kE1h0l5B;
        "spigot-1.21.9" = _kE1h0l5B;
        "spigot-1.21.10" = _kE1h0l5B;
        "spigot-1.21.11" = _kE1h0l5B;
        "spigot-26.1" = _kE1h0l5B;
        "spigot-26.1.1" = _kE1h0l5B;
        "spigot-26.1.2" = _kE1h0l5B;
        "spigot-26.2" = _kE1h0l5B;
        "paper-1.21" = _kE1h0l5B;
        "paper-1.21.1" = _kE1h0l5B;
        "paper-1.21.2" = _kE1h0l5B;
        "paper-1.21.3" = _kE1h0l5B;
        "paper-1.21.4" = _kE1h0l5B;
        "paper-1.21.5" = _kE1h0l5B;
        "paper-1.21.6" = _kE1h0l5B;
        "paper-1.21.7" = _kE1h0l5B;
        "paper-1.21.8" = _kE1h0l5B;
        "paper-1.20.6" = _kE1h0l5B;
        "paper-1.21.9" = _kE1h0l5B;
        "paper-1.21.10" = _kE1h0l5B;
        "paper-1.21.11" = _kE1h0l5B;
        "paper-26.1" = _kE1h0l5B;
        "paper-26.1.1" = _kE1h0l5B;
        "paper-26.1.2" = _kE1h0l5B;
        "paper-26.2" = _kE1h0l5B;
        "purpur-1.21" = _kE1h0l5B;
        "purpur-1.21.1" = _kE1h0l5B;
        "purpur-1.21.2" = _kE1h0l5B;
        "purpur-1.21.3" = _kE1h0l5B;
        "purpur-1.21.4" = _kE1h0l5B;
        "purpur-1.21.5" = _kE1h0l5B;
        "purpur-1.21.6" = _kE1h0l5B;
        "purpur-1.21.7" = _kE1h0l5B;
        "purpur-1.21.8" = _kE1h0l5B;
        "purpur-1.20.6" = _kE1h0l5B;
        "purpur-1.21.9" = _kE1h0l5B;
        "purpur-1.21.10" = _kE1h0l5B;
        "purpur-1.21.11" = _kE1h0l5B;
        "purpur-26.1" = _kE1h0l5B;
        "purpur-26.1.1" = _kE1h0l5B;
        "purpur-26.1.2" = _kE1h0l5B;
        "purpur-26.2" = _kE1h0l5B;
        "bukkit-1.20.6" = _kE1h0l5B;
        "bukkit-1.21" = _kE1h0l5B;
        "bukkit-1.21.1" = _kE1h0l5B;
        "bukkit-1.21.2" = _kE1h0l5B;
        "bukkit-1.21.3" = _kE1h0l5B;
        "bukkit-1.21.4" = _kE1h0l5B;
        "bukkit-1.21.5" = _kE1h0l5B;
        "bukkit-1.21.6" = _kE1h0l5B;
        "bukkit-1.21.7" = _kE1h0l5B;
        "bukkit-1.21.8" = _kE1h0l5B;
        "bukkit-1.21.9" = _kE1h0l5B;
        "bukkit-1.21.10" = _kE1h0l5B;
        "bukkit-1.21.11" = _kE1h0l5B;
        "bukkit-26.1" = _kE1h0l5B;
        "bukkit-26.1.1" = _kE1h0l5B;
        "bukkit-26.1.2" = _kE1h0l5B;
        "bukkit-26.2" = _kE1h0l5B;
        "pkg-2.23.3.1" = _6a4gh9sX;
        "pkg-2.23.3.2" = _6KLI4v12;
        "pkg-2.23.8" = _CESzlKoj;
        "pkg-2.23.8-250706" = _onSVfavl;
        "pkg-2.23.8-250712" = _xxHjFjah;
        "pkg-2.23.9.1" = _EGJjogK4;
        "pkg-2.23.9.2" = _hJ0VsZcN;
        "pkg-2.23.9.3" = _xyPDmIl4;
        "pkg-2.23.9.4" = _4aPuD6wR;
        "pkg-2.23.9.5" = _WuFvkpOO;
        "pkg-2.23.10.1" = _aAv2EzK2;
        "pkg-2.23.10.2" = _qcgYr3VA;
        "pkg-2.23.10.2-250927" = _YPYhquwN;
        "pkg-2.25.0-260211" = _AZ7rQp5x;
        "pkg-2.25.0-260212" = _N6cNi8Io;
        "pkg-2.26.0-260330" = _HwCXMouS;
        "pkg-2.26.0-260719" = _F1zc68NI;
        "pkg-2.27.0-260804" = _lEtBnsUK;
        "pkg-2.27.0-260811" = _kE1h0l5B;
        "default" = _kE1h0l5B;
    });
