...
let
    versions = (let
        ...
        _pMQ8sAF8 = {
            "id" = "pMQ8sAF8";
            "file" = "catchrate-display-fabric-2.8.24.jar";
            "hash" = "sha512-gozpaEhKx7xXy6X5ITowxdAgmGrWc15c6WFzugLdG3Orwg1RbLqU41dj5CUEM8lFgkJsuJ4ZKiCs7CWprf4uRw==";
        };
        _ik3a6wtr = {
            "id" = "ik3a6wtr";
            "file" = "catchrate-display-neoforge-2.8.24.jar";
            "hash" = "sha512-3n9MICLBRnLwnrn/d0ndO50wxFZBaaT8JnXwpDkgmnNErpDv1N3mNq7gFAWNNXra4ksFpx2by+vsvPlHWsOuYw==";
        };
        _zwkM6IPp = {
            "id" = "zwkM6IPp";
            "file" = "catchrate-display-fabric-2.9.0.jar";
            "hash" = "sha512-Y/QEEl3W/DS0MfFRDiJyX4WQkqUtU3RR5UCAAoKhQvWjHoRubd5taYPdOleGHVyjDiGBGlhvkptpBIBwfDvang==";
        };
        _GbyGRiFH = {
            "id" = "GbyGRiFH";
            "file" = "catchrate-display-neoforge-2.9.0.jar";
            "hash" = "sha512-y6+DNQ1ydQImCL84xj6RV7No3/z/xEyzTuaxLVSYDdfzM4dKpbOWAQtA/2/6/uVSGlDniZ3Dihz1/MfAg0dRog==";
        };
        _ak1Gj0VQ = {
            "id" = "ak1Gj0VQ";
            "file" = "catchrate-display-fabric-2.9.1.jar";
            "hash" = "sha512-LBNrLMrME51QtQt3ULO2pygQwjXPDOTjVqXHmgQOitcZwXUXm65vKwGoekjSBU+UvkTc91ulCV0w8KS8ko7pyA==";
        };
        _ytWBaOIt = {
            "id" = "ytWBaOIt";
            "file" = "catchrate-display-neoforge-2.9.1.jar";
            "hash" = "sha512-ED6ZbpiD7omeeoYDrlfUthfcly3Ycm2io6wF0XWcl2gVCwRsGC2PwzJSmsKUpCUcQZ8MyBvqSIzHA/0GR6qGqw==";
        };
        _UU6xTHX0 = {
            "id" = "UU6xTHX0";
            "file" = "catchrate-display-fabric-2.9.2.jar";
            "hash" = "sha512-2+Xu6iZOTylfjr0BKJy2zoKmL+d628gydL2nkyWOM+5V6UtO93wCVwr7Hhzwiu1LcPVHYdeD5WiU8M8xOj7PEg==";
        };
        _rUpz45jp = {
            "id" = "rUpz45jp";
    ...
    in {
        ...
        "pkg-1.2.30" = _w4y9d5uj;
        "pkg-1.2.31" = _bwH5WSUI;
        "pkg-1.2.32" = _8s1Fdj2V;
        "pkg-1.2.33" = _AXTwkzQh;
        "pkg-1.3.0+fabric" = _4pZ6q0YY;
        "pkg-1.3.0+neoforge" = _KGFiZxVR;
        "pkg-1.3.1+fabric" = _aGWKws1w;
        "pkg-1.3.1+neoforge" = _lhIzdiUu;
        "pkg-1.3.4+fabric" = _OWV2LERf;
        "pkg-1.3.4+neoforge" = _8cxkdLiO;
        "pkg-1.4.1+fabric" = _f0Nm0Hzi;
        "pkg-1.4.1+neoforge" = _F1n01L5u;
        "pkg-2.0.0+fabric" = _LvUCXql6;
        "pkg-2.0.0+neoforge" = _6se34mwR;
        "pkg-2.1.0+fabric" = _y8luwSvm;
        "pkg-2.1.0+neoforge" = _a7HEKDIV;
        "pkg-2.1.1+fabric" = _fkypk4OR;
        "pkg-2.1.1+neoforge" = _xniyoBX4;
        "pkg-2.1.2+fabric" = _FvfiRL87;
        "pkg-2.1.2+neoforge" = _gaJTAGGv;
        "pkg-2.2.0+fabric" = _binzAf3p;
        "pkg-2.2.0+neoforge" = _eVQ3HXUu;
        "pkg-2.3.0+fabric" = _Bc7YEDNZ;
        "pkg-2.3.0+neoforge" = _kWiH9Wid;
        "pkg-2.3.1+fabric" = _dWrH2E95;
        "pkg-2.3.1+neoforge" = _PBpL2JKM;
        "pkg-2.3.2+fabric" = _V9ILyzLc;
        "pkg-2.3.2+neoforge" = _Dj8H9pOn;
        "pkg-2.4.0+fabric" = _zedzL7al;
        "pkg-2.4.0+neoforge" = _lmDo1yIG;
        "pkg-2.4.1+fabric" = _clYxMxZE;
        "pkg-2.4.1+neoforge" = _w80uEdaQ;
        "pkg-2.4.2+fabric" = _kccgSLxa;
        "pkg-2.4.2+neoforge" = _TkvG0ZXI;
        "pkg-2.4.3+fabric" = _O8ODfAUK;
        "pkg-2.4.3+neoforge" = _lEXtMkJe;
        "pkg-2.5.0+fabric" = _iEBBr8fH;
        "pkg-2.5.0+neoforge" = _zRNbC73I;
        "pkg-2.5.1+fabric" = _25yJthOm;
        "pkg-2.5.1+neoforge" = _UD8OhJ3x;
        "pkg-2.5.2+fabric" = _gQF7WNhd;
        "pkg-2.5.2+neoforge" = _zjIZiXT3;
        "pkg-2.5.3+fabric" = _AzeCy1sC;
        "pkg-2.5.3+neoforge" = _UQYfba92;
        "pkg-2.5.4+fabric" = _9buxKchI;
        "pkg-2.5.4+neoforge" = _vU4dS7Ti;
        "pkg-2.5.5+fabric" = _DXCEV4or;
        "pkg-2.5.5+neoforge" = _TJ1XuVO3;
        "pkg-2.5.6+fabric" = _GY6jFyf6;
        "pkg-2.5.6+neoforge" = _Q9rLNvTQ;
        "pkg-2.5.7+fabric" = _PHDZstBw;
        "pkg-2.5.7+neoforge" = _MsGCLnP7;
        "pkg-2.5.8+fabric" = _VLM0fNfE;
        "pkg-2.5.8+neoforge" = _8H2HaOQ5;
        "pkg-2.5.9+fabric" = _jxPrqDr0;
        "pkg-2.5.9+neoforge" = _NhW0tOd4;
        "pkg-2.6.0+fabric" = _LnHBMmZJ;
        "pkg-2.6.0+neoforge" = _3xGnydLR;
        "pkg-2.6.1+fabric" = _XNOlApKG;
        "pkg-2.6.1+neoforge" = _jtpd1KmO;
        "pkg-2.6.2+fabric" = _4rqtyqck;
        "pkg-2.6.2+neoforge" = _jTmcE324;
        "pkg-2.6.3+fabric" = _VIY3Blmr;
        "pkg-2.6.3+neoforge" = _57oeIEvR;
        "pkg-2.7.0+fabric" = _Awm52m0e;
        "pkg-2.7.0+neoforge" = _8a8yIEAF;
        "pkg-2.7.1+fabric" = _GLB2uDci;
        "pkg-2.7.1+neoforge" = _NRnpWzJI;
        "pkg-2.7.2+fabric" = _atOz21av;
        "pkg-2.7.2+neoforge" = _pheayV7P;
        "pkg-2.7.3+fabric" = _CErnV0OL;
        "pkg-2.7.3+neoforge" = _RoJYbLTo;
        "pkg-2.7.4+fabric" = _qfVaTA4o;
        "pkg-2.7.4+neoforge" = _GVTtwYmx;
        "pkg-2.7.5+fabric" = _w5YAJSMy;
        "pkg-2.7.5+neoforge" = _uISLZjmG;
        "pkg-2.7.6+fabric" = _9SSF62fd;
        "pkg-2.7.6+neoforge" = _UCvovpps;
        "pkg-2.7.7+fabric" = _g6ec2Poe;
        "pkg-2.7.7+neoforge" = _HJQdM4Hb;
        "pkg-2.7.8+fabric" = _5B9lJMLu;
        "pkg-2.7.8+neoforge" = _RcMqPkVK;
        "pkg-2.7.9+fabric" = _RSmsFHjS;
        "pkg-2.7.9+neoforge" = _iNLdRW4L;
        "pkg-2.7.10+fabric" = _JNFGaTi4;
        "pkg-2.7.10+neoforge" = _uQVlLJV2;
        "pkg-2.7.11+fabric" = _kMX6sUU2;
        "pkg-2.7.11+neoforge" = _YWIz5Bwt;
        "pkg-2.7.12+fabric" = _UtKAvHkA;
        "pkg-2.7.12+neoforge" = _WpuRWiv4;
        "pkg-2.7.13+fabric" = _cG7WiUqg;
        "pkg-2.7.13+neoforge" = _MjcfxnpX;
        "pkg-2.8.0+fabric" = _k4IOpTFQ;
        "pkg-2.8.0+neoforge" = _hKLl8RLf;
        "pkg-2.8.1+fabric" = _sWrTC9z0;
        "pkg-2.8.1+neoforge" = _JzwWnaiq;
        "pkg-2.8.2+fabric" = _fFnOO3WG;
        "pkg-2.8.2+neoforge" = _3EZLaHdU;
        "pkg-2.8.3+fabric" = _OV6h1IBy;
        "pkg-2.8.3+neoforge" = _Dy1StYwz;
        "pkg-2.8.4+fabric" = _DaFMk2UO;
        "pkg-2.8.4+neoforge" = _5IESNUpz;
        "pkg-2.8.6+fabric" = _mX2dFjuc;
        "pkg-2.8.6+neoforge" = _ly3LJnjo;
        "pkg-2.8.7+fabric" = _2WzHdDAn;
        "pkg-2.8.7+neoforge" = _5hJemkPK;
        "pkg-2.8.8+fabric" = _qNRh46sK;
        "pkg-2.8.8+neoforge" = _3T9FG0e6;
        "pkg-2.8.9+fabric" = _ctcPryZf;
        "pkg-2.8.9+neoforge" = _dtn51lTc;
        "pkg-2.8.10+fabric" = _Ou7rqwEj;
        "pkg-2.8.10+neoforge" = _FuVc66ma;
        "pkg-2.8.11+fabric" = _oykwrvQc;
        "pkg-2.8.11+neoforge" = _f7djdha9;
        "pkg-2.8.12+fabric" = _eumbTcdw;
        "pkg-2.8.12+neoforge" = _LXxlIfwM;
        "pkg-2.8.13+fabric" = _RZaz5aJZ;
        "pkg-2.8.13+neoforge" = _u4rrWHv5;
        "pkg-2.8.14+fabric" = _GlbWzTQn;
        "pkg-2.8.14+neoforge" = _fWZUGvk3;
        "pkg-2.8.17+fabric" = _u2OTDp2Y;
        "pkg-2.8.17+neoforge" = _sy0YTFVZ;
        "pkg-2.8.18+fabric" = _6EvSmXWI;
        "pkg-2.8.18+neoforge" = _2hFV9qY1;
        "pkg-2.8.19+fabric" = _ADFkt76A;
        "pkg-2.8.19+neoforge" = _BdAnnFwy;
        "pkg-2.8.20+fabric" = _gYjHRg4I;
        "pkg-2.8.20+neoforge" = _DhdPBHns;
        "pkg-2.8.21+fabric" = _tlbl1C2R;
        "pkg-2.8.21+neoforge" = _UoRMvjW7;
        "pkg-2.8.22+fabric" = _4MuGKLQg;
        "pkg-2.8.22+neoforge" = _bmoCjqQG;
        "pkg-2.8.23+fabric" = _x0kgL5h0;
        "pkg-2.8.23+neoforge" = _9IzoaItT;
        "pkg-2.8.24+fabric" = _pMQ8sAF8;
        "pkg-2.8.24+neoforge" = _ik3a6wtr;
        "pkg-2.9.0+fabric" = _zwkM6IPp;
        "pkg-2.9.0+neoforge" = _GbyGRiFH;
        "pkg-2.9.1+fabric" = _ak1Gj0VQ;
