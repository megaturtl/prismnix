...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _KYpnzEQ5;
        "pkg-1.0.9" = _URWzNo9c;
        "pkg-1.0.10" = _XnFKYhPs;
        "pkg-1.0.11" = _aWa2UMkB;
        "pkg-1.0.12" = _dVUuXIVW;
        "pkg-1.0.13" = _7gBRgUTK;
        "pkg-1.0.14" = _KfEeJnMN;
        "pkg-1.0.15" = _UZT0hCAK;
        "pkg-1.0.16" = _loO76v3o;
        "pkg-1.0.17" = _WkiWKiUN;
        "pkg-1.0.18" = _xyHLme5Y;
        "pkg-1.0.19" = _Iw0rstSb;
        "pkg-1.0.20" = _J8ZgTMQk;
        "pkg-1.0.21" = _Pe7K2lyA;
        "pkg-1.0.22" = _CR99yfwH;
        "pkg-1.0.23" = _3zsXJOko;
        "pkg-1.0.24" = _Pvk0zpAx;
        "pkg-1.0.25" = _UMqtAYpP;
        "pkg-1.0.26" = _9JO17wfV;
        "pkg-1.0.27" = _b9ua2K4h;
        "pkg-1.0.28" = _D2l4jjpc;
        "pkg-1.0.29" = _YncNX4Ni;
        "pkg-1.0.30" = _H2Hmj3xQ;
        "pkg-1.0.31" = _VUZHpupH;
        "pkg-1.0.32" = _PtSP9X0b;
        "pkg-1.0.33" = _LT4dndCZ;
        "pkg-1.0.34" = _DHC9bv75;
        "pkg-1.0.35" = _W93iqTMZ;
        "pkg-1.0.36" = _TOTipUu9;
        "pkg-1.0.37" = _boaL3Uh9;
        "pkg-1.0.38" = _Q7b12h2D;
        "pkg-1.0.39" = _TYFrVQWN;
        "pkg-1.0.40" = _7hr7m5pO;
        "pkg-1.0.41" = _Qty1QWbs;
        "pkg-1.0.42" = _Wiptcqgy;
        "pkg-1.0.43" = _G8GaI5bJ;
        "pkg-1.0.44" = _bIVa6eha;
        "pkg-1.0.45" = _FnOiKQVR;
        "pkg-1.0.46" = _QOiCWPtQ;
        "pkg-1.0.47" = _MehUnf9R;
        "pkg-1.0.48" = _pTR6xXRh;
        "pkg-2.0.0" = _JweIihDC;
        "pkg-2.0.1" = _B3C6DsaW;
        "pkg-2.1.0" = _fIUFQNLb;
        "pkg-2.2.0" = _WuoKwer9;
