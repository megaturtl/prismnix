...
let
    versions = (let
        ...
        _VwoVYDeI = {
            "id" = "VwoVYDeI";
            "file" = "Unique Potions By Blond 26.3 - 1.14 - 1.2.6.zip";
            "hash" = "sha512-cM6dAnnMRzyHQTXYvZQ/mMpAlx1FvfxJ6S6OJ6G1OFJyfHobwk1EJ4PeLO9u930hOlaHxGx22nmS41o6KIJBzg==";
        };
    in {
        "knPLBAo0" = _knPLBAo0;
        "ePqv8Wmp" = _ePqv8Wmp;
        ...
        "cbRIbYtn" = _cbRIbYtn;
        "VwoVYDeI" = _VwoVYDeI;
        "minecraft-1.20" = _VwoVYDeI;
        "minecraft-1.20.1" = _VwoVYDeI;
        "minecraft-1.20.2" = _VwoVYDeI;
        "minecraft-1.20.3" = _VwoVYDeI;
        "minecraft-1.20.4" = _VwoVYDeI;
        "minecraft-1.20.5" = _VwoVYDeI;
        "minecraft-1.20.6" = _VwoVYDeI;
        "minecraft-1.21" = _VwoVYDeI;
        "minecraft-1.21.1" = _VwoVYDeI;
        "minecraft-1.21.5" = _VwoVYDeI;
        "minecraft-1.21.6" = _VwoVYDeI;
        "minecraft-1.21.7" = _VwoVYDeI;
        "minecraft-1.21.8" = _VwoVYDeI;
        "minecraft-1.14" = _VwoVYDeI;
        "minecraft-1.14.1" = _VwoVYDeI;
        "minecraft-1.14.2" = _VwoVYDeI;
        "minecraft-1.14.3" = _VwoVYDeI;
        "minecraft-1.14.4" = _VwoVYDeI;
        "minecraft-1.15" = _VwoVYDeI;
        "minecraft-1.15.1" = _VwoVYDeI;
        "minecraft-1.15.2" = _VwoVYDeI;
        "minecraft-1.16" = _VwoVYDeI;
        "minecraft-1.16.1" = _VwoVYDeI;
        "minecraft-1.16.2" = _VwoVYDeI;
        "minecraft-1.16.3" = _VwoVYDeI;
        "minecraft-1.16.4" = _VwoVYDeI;
        "minecraft-1.16.5" = _VwoVYDeI;
        "minecraft-1.17" = _VwoVYDeI;
        "minecraft-1.17.1" = _VwoVYDeI;
        "minecraft-1.18" = _VwoVYDeI;
        "minecraft-1.18.1" = _VwoVYDeI;
        "minecraft-1.18.2" = _VwoVYDeI;
        "minecraft-1.19" = _VwoVYDeI;
        "minecraft-1.19.1" = _VwoVYDeI;
        "minecraft-1.19.2" = _VwoVYDeI;
        "minecraft-1.19.3" = _VwoVYDeI;
        "minecraft-1.19.4" = _VwoVYDeI;
        "minecraft-1.21.2" = _VwoVYDeI;
        "minecraft-1.21.3" = _VwoVYDeI;
        "minecraft-1.21.4" = _VwoVYDeI;
        "minecraft-1.21.9" = _VwoVYDeI;
        "minecraft-1.21.10" = _VwoVYDeI;
        "minecraft-1.21.11" = _VwoVYDeI;
        "minecraft-26.1" = _VwoVYDeI;
        "minecraft-26.1.1" = _VwoVYDeI;
        "minecraft-26.1.2" = _VwoVYDeI;
        "minecraft-26.2" = _VwoVYDeI;
        "minecraft-26.3-pre-1" = _VwoVYDeI;
        "pkg-1.0.0" = _knPLBAo0;
        "pkg-1.1.0" = _ePqv8Wmp;
        "pkg-1.1.1" = _oeTDVe84;
        "pkg-1.1.2" = _sqPSHHcs;
