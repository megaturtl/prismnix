...
let
    ...
    in {
        ...
        "pkg-1.0.9" = _pwxfdOes;
        "pkg-1.1.0" = _yRzHH5NO;
        "pkg-5f09d11" = _DAEGJ7gG;
        "pkg-543f085" = _2FCd5eOj;
        "pkg-16304a9" = _3MkmF9ib;
        "pkg-ef65bee" = _VlbvG60R;
        "pkg-74cf2a2" = _rtAeE5aR;
        "pkg-075d47b" = _wUXkRI1C;
        "pkg-dc17c95" = _PJXmlNRw;
        "pkg-1.1.2" = _HhPvBW7x;
        "pkg-5b4b581" = _34kfSaJ5;
        "pkg-1.1.3" = _O0IRF6kt;
        "pkg-2755216" = _fp3C8nRd;
        "pkg-1.1.4" = _JnjAABhA;
        "pkg-09d726f" = _kW4ubG01;
        "pkg-2d7ebd8" = _3frqSNYg;
        "pkg-1.1.5" = _1ZbTnBf6;
        "pkg-12bec03" = _P4qSAMCb;
        "pkg-1.1.6" = _Hoen0xyO;
        "pkg-1.1.7" = _nvv8KnHE;
        "pkg-ad8da68" = _WMTpGGY4;
        "pkg-1.1.8" = _gWqmAsKK;
        "pkg-ca6eb71" = _jyKQvLCP;
        "pkg-1.1.9" = _f7ykeHex;
        "pkg-5f17d3d" = _6t9Tq9z2;
        "pkg-d40a30d" = _hJi1SjJX;
        "pkg-1.1.10" = _GpO6mvZA;
        "pkg-f585755" = _XXasQCBz;
        "pkg-1.1.11" = _u3kAcJNV;
        "pkg-fe98ff3" = _Flud5PTX;
        "pkg-1.1.12" = _QUridXxP;
        "pkg-91bedd5" = _SNGsyTMJ;
        "pkg-e9f6f27" = _gW1JNBa8;
        "pkg-1.1.13" = _jaGR1OGQ;
        "pkg-894784e" = _nYLuGn9U;
        "pkg-0d31466" = _m5cHjTgJ;
        "pkg-85b0af2" = _1H5fpj7S;
        "pkg-86487a8" = _tBAYUC7B;
        "pkg-fe53873" = _X0xYKZKa;
        "pkg-c1c9916" = _QHkjxzHX;
        "pkg-1.1.17" = _rXNz8o9W;
        "pkg-6423bbc" = _ghENqM8r;
        "pkg-1.1.18" = _TmGV60r3;
        "pkg-2046ac6" = _OvGAAkca;
        "pkg-585a6fd" = _xQa9bmD5;
        "pkg-78231bd" = _wKnO4kRJ;
        "pkg-655662f" = _iTYXgOte;
        "pkg-1.1.19" = _vzUI2Ja1;
        "pkg-5f5b20b" = _nrPWV4Jr;
        "pkg-1.1.20" = _9sXSDaE2;
        "pkg-8de9695" = _u74nNZIS;
        "pkg-759581c" = _6Wa18o1n;
        "pkg-1.1.21" = _SBtO2QhL;
        "pkg-79e9a39" = _RLcbv1jw;
        "pkg-1.1.22" = _JSrW3Q2t;
        "pkg-dd04cee" = _aBV4bbY2;
        "pkg-5220a1a" = _cAGHYvGU;
        "pkg-89c69e3" = _KbpiWpTv;
        "pkg-1.1.23" = _H80ftdNf;
        "pkg-588b755" = _4hHtwGZE;
        "pkg-637cb5b" = _ojafwZwG;
        "pkg-3952869" = _sCNEoIxI;
        "pkg-3b9915d" = _8fHm6bmq;
        "pkg-8d44b93" = _3Cwm1jvR;
        "pkg-5879eb5" = _ZpCSsbqn;
        "pkg-1b18b3d" = _Q7Pc6gUr;
        "pkg-35e9edd" = _QAlRYguw;
        "pkg-e82b74e" = _Q6lHLVAW;
        "pkg-97d6da9" = _gA50JkHk;
        "pkg-20a51e1" = _qOdiLB2s;
        "pkg-f88746b" = _Q39hgPxE;
        "pkg-352b7eb" = _r0pWRRcI;
        "pkg-1.1.24" = _X69i67rx;
        "pkg-ca691d8" = _pbThhwQ8;
        "pkg-5e2f384" = _I4cgIRhS;
        "pkg-1489153" = _gwqO6J6b;
        "pkg-fab2948" = _CfHo6Xk3;
        "pkg-c0b748a" = _rYvuUrTn;
        "pkg-1.1.25" = _jRN5Jztt;
        "pkg-0afdb5d" = _dmXE5vk8;
        "pkg-cace305" = _oA2W9iR7;
        "pkg-e4526cc" = _upSfocwy;
        "pkg-1.1.26" = _1lgfZ5BI;
        "pkg-6b3fb97" = _zclliCa1;
        "pkg-e7f0730" = _Zamm2GWn;
        "pkg-9756f34" = _bh68igeU;
        "pkg-c91f7be" = _srxLr8G2;
        "pkg-e632cff" = _xLu3qnsP;
        "pkg-5690892" = _dbj8oOSx;
        "pkg-c9fcc43" = _NReGleyy;
        "pkg-a6da729" = _jLVGDGjt;
        "pkg-be15850" = _m4Dv50iw;
        "pkg-f172fd9" = _YxRcQbqq;
        "pkg-c6e03b6" = _wHxNOeom;
        "pkg-2bb3634" = _foS7mKan;
        "pkg-f779f2d" = _jXyjdtG9;
        "pkg-8cd5ffe" = _eEs0udAD;
        "pkg-5bedab0" = _HB95WSXk;
        "pkg-c463aeb" = _eG9bNxhS;
        "pkg-e671c99" = _b0dhsiDQ;
        "pkg-f221685" = _hHDXE0NU;
        "pkg-e638f4d" = _r04s3qzv;
        "pkg-2a79564" = _9FYSLb8w;
        "pkg-850ba5e" = _IkpvAHo0;
        "pkg-6540728" = _HqllV4MO;
        "pkg-1de2601" = _d2tbmo9O;
        "pkg-74424b4" = _6xWOJym7;
        "pkg-5001208" = _97P2R2RV;
        "pkg-4f1d58d" = _rH0Pqk3d;
        "pkg-b1a8e47" = _ChvdpgTn;
        "pkg-b845d00" = _vp4tdhVO;
        "pkg-f278636" = _ZMOAXoMh;
        "pkg-3781544" = _LDvTbWi9;
        "pkg-a83e1b0" = _h4cl8mhd;
        "pkg-b94a567" = _6zTi6xpN;
        "pkg-c55f85e" = _iUVnQVwZ;
