...
let
    ...
    in {
        ...
        "pkg-3.4.4" = _h745c4a4;
        "pkg-3.4.9" = _OtlmvgLM;
        "pkg-3.4.11" = _r5YEBVrM;
        "pkg-3.4.12" = _tmtMaopO;
        "pkg-3.4.13" = _cOxKsjqm;
        "pkg-3.4.14" = _boKhyBcv;
        "pkg-3.4.15" = _gZS7lCXV;
        "pkg-3.4.16" = _fq7dByIX;
        "pkg-3.4.17" = _7txpWZMr;
        "pkg-3.5.0" = _7I25UX9o;
        "pkg-3.5.1" = _5JjhawZl;
        "pkg-3.5.3" = _j1psIGLl;
        "pkg-3.5.4" = _lxeV8emh;
