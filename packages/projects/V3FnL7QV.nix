...
let
    ...
    in {
        ...
        "pkg-2.1.0-1.21.5-fabric" = _XyIXn8qN;
        "pkg-2.1.1-1.21.5-fabric" = _i0Ijy6ha;
        "pkg-2.1.2-1.21.5-fabric" = _FEEDOHgW;
        "pkg-2.2.0-1.21.5-fabric" = _e8ney7MY;
        "pkg-2.2.1-1.21.5-fabric" = _a1lolxBk;
        "pkg-1.1.0-1.8.9" = _GMrccsGT;
        "pkg-1.1.1-1.8.9" = _VU0kbboy;
        "pkg-2.2.2-1.21.5-fabric" = _NV3umDx0;
        "pkg-2.3.0-1.21.5-fabric" = _tRfzBqAh;
        "pkg-2.4.0-1.21.5-fabric" = _D8GCAnm6;
        "pkg-2.4.1-1.21.5-fabric" = _BQywVsnE;
        "pkg-2.4.2-1.21.5-fabric" = _uRbS05U8;
        "pkg-2.4.3-1.21.5-fabric" = _zp2r0qI6;
        "pkg-2.4.4-1.21.5-fabric" = _ZEN9NFkS;
        "pkg-3.0.0-1.21.5" = _nycMFLlu;
        "pkg-3.0.0-1.21.8" = _S2LIvmVR;
        "pkg-3.0.1+1.21.5" = _Hn9sQ1Fl;
        "pkg-3.0.1+1.21.8" = _TqbUVhI9;
        "pkg-3.0.2+1.21.5" = _gFephgwi;
        "pkg-3.0.2+1.21.8" = _MDFpz2ha;
        "pkg-3.0.3" = _Fz6G2wYb;
        "pkg-3.1.0+1.21.5" = _luSUyIgT;
        "pkg-3.1.0+1.21.8" = _P07E0VbS;
        "pkg-3.1.1" = _xxjMTGEh;
        "pkg-3.2.0" = _P2UVibg2;
        "pkg-3.2.1" = _qys23aoz;
        "pkg-3.2.2" = _aucDTBwm;
        ...
        "pkg-4.2.8" = _RD6k4LuA;
        "pkg-4.2.9" = _skpgC1XK;
        "pkg-4.2.10" = _xzQT3PD3;
        "pkg-v5.0.0-mc26.1.2" = _yHhhoinv;
        "pkg-v5.0.1-mc26.1.2" = _ZWnMi9wV;
        "pkg-v5.0.2-mc26.1.2" = _SZ9Cspm6;
        "pkg-v5.0.3-mc26.1.2" = _DhhJUfpH;
        "pkg-v5.0.4-mc26.1.2" = _Y6kNgsuU;
        "pkg-v5.0.5-mc26.1.2" = _Kf4SKOFp;
        "pkg-v5.0.6-mc26.1.2" = _yqFZchvP;
        "pkg-v5.0.7-mc26.1.2" = _9uJIz3lD;
        "pkg-v5.0.8-mc26.1.2" = _sNnrl7WX;
        "pkg-v5.0.9-mc26.1.2" = _s8Hc2fx9;
        "pkg-v5.0.10-mc26.1.2" = _Pw2ZY7SH;
        "pkg-v5.0.11-mc26.1.2" = _sxHnKhIw;
