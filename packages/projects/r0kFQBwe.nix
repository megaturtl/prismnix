...
let
    versions = (let
        ...
        _1t8gBSnj = {
            "id" = "1t8gBSnj";
            "file" = "SpearsOverhaul[1.4][26.3].zip";
            "hash" = "sha512-CHa3tL0Mf0Jn8+gQ3ybiU0kSM7oTC/8BnY5p+LKGaWoUm4xh2PY3lN4ZuP4YAXTtgTEqBztaUJNW8LCazscjNA==";
        };
    in {
        "o0ZVXDj1" = _o0ZVXDj1;
        "66wlLjng" = _66wlLjng;
