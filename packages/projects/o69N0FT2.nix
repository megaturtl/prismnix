...
let
    ...
    in {
        ...
        "pkg-1.2.2+1.21.4" = _jT9co9b6;
        "pkg-1.2.3+1.21.4" = _pZGb53SS;
        "pkg-1.3.0+1.21.4" = _E0SDl3fV;
        "pkg-1.4.0+1.21.4" = _c3eNaHSt;
        "pkg-1.4.0+1.21.5-rc1" = _MqgULwMK;
        "pkg-1.4.1+1.21.5" = _LWRpzZAy;
        "pkg-1.4.2+1.21.5" = _8DgdPTsi;
        "pkg-1.4.3+1.21.5" = _AaTFnhPq;
        "pkg-1.4.4+1.21.5" = _bv1yTKbz;
        "pkg-1.4.4+1.21.4" = _Qa0GrYJZ;
        "pkg-1.4.4+1.21.1" = _S8YuygJB;
        "pkg-1.4.4+1.21.6-rc1" = _O2wGAKrO;
        "pkg-1.4.4+1.21.9" = _WjLv56P7;
        "pkg-1.4.5+1.21.1" = _J0omiI8b;
        "pkg-1.4.5+1.21.10" = _BR5RzBnq;
        "pkg-1.4.5+1.21.4" = _SpKEHuEK;
        "pkg-1.4.5+1.21.5" = _aBk5jg5u;
        "pkg-1.4.5+1.21.8" = _bJddRell;
        "pkg-1.4.6+1.21.1" = _piyC1i5l;
        "pkg-1.4.6+1.21.10" = _PcZb4G1V;
        "pkg-1.4.6+1.21.4" = _uhijQyxH;
        "pkg-1.4.6+1.21.5" = _xA0YhEsr;
        "pkg-1.4.6+1.21.8" = _dvuXNpMz;
        "pkg-1.4.6+1.21.11-rc2" = _IEzMus42;
        "pkg-1.4.7+1.21.1" = _MQrnWCBg;
        "pkg-1.4.7+1.21.10" = _G5A8djSj;
        "pkg-1.4.7+1.21.11" = _UW5cEmGV;
        "pkg-1.4.7+1.21.4" = _44wcLsLH;
        "pkg-1.4.7+1.21.5" = _fRgHThI0;
        "pkg-1.4.7+1.21.8" = _7TRjkBxP;
        "pkg-1.4.7+26.1" = _xZjw2Blb;
        "pkg-1.4.8+26.1.1" = _fNDdSYxb;
        "pkg-1.4.8+1.21.1" = _e7hsBR3R;
        "pkg-1.4.8+1.21.10" = _qUNiNjkQ;
        "pkg-1.4.8+1.21.11" = _brK6IQ7R;
        "pkg-1.4.8+1.21.4" = _HZKUC5KY;
        "pkg-1.4.8+1.21.5" = _JbMnvulV;
        "pkg-1.4.8+1.21.8" = _vC5J1CTw;
        "pkg-1.4.9+26.1.1" = _iOR1l66V;
        "pkg-1.4.9+1.21.1" = _FGkPwjrC;
        "pkg-1.4.9+1.21.10" = _rwTWeirj;
        "pkg-1.4.9+1.21.11" = _wFX5UueD;
        "pkg-1.4.9+1.21.4" = _Dk1akzMF;
        "pkg-1.4.9+1.21.5" = _UJ5gPRqL;
        "pkg-1.4.9+1.21.8" = _pufhyNmP;
        "pkg-1.4.10+26.1.1" = _1M5uGtXp;
        "pkg-1.4.10+1.21.1" = _KVW2AIIf;
        "pkg-1.4.10+1.21.10" = _vRRNICFf;
        "pkg-1.4.10+1.21.11" = _kVtUvNhZ;
        "pkg-1.4.10+1.21.4" = _U2nCHZTs;
        "pkg-1.4.10+1.21.5" = _OcQUE2D6;
        "pkg-1.4.10+1.21.8" = _BqkWirfw;
