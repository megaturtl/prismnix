...
let
    versions = (let
        ...
        _v2PSNZ3v = {
            "id" = "v2PSNZ3v";
            "file" = "ae2importexportcard-26.1.2-2.1.0.jar";
            "hash" = "sha512-Ge5HuVL1xMPJ0/aOvcgTKudCbciThegrN8C0jOIDt60b4Yibg8RfiSJH09/SOi72a0wDGuaVWQPIU3WbbrY5+g==";
        };
        _UNYpf7A1 = {
            "id" = "UNYpf7A1";
            "file" = "ae2importexportcard-1.21.1-1.6.0.jar";
            "hash" = "sha512-T+S14f68Nqe9CdZZtyFSP3hTitwCHqs3jsTsfzEbgxHRNtwj5JMy9SKdTDCgbDeJSrsSqrANeFolYu9NXT9big==";
        };
        _C6sdMFGi = {
            "id" = "C6sdMFGi";
            "file" = "ae2importexportcard-1.21.1-1.7.0.jar";
            "hash" = "sha512-kFB7YvjCTKyduN5M3nUR5JUJLwgjFmXwOxBxcI5UNSIJbu6lyAmiK5Q3qa/gcv1zg+8Hj2clRzyn8unNp2PF8g==";
        };
        _DUObGlCJ = {
            "id" = "DUObGlCJ";
            "file" = "ae2importexportcard-1.21.1-1.7.1.jar";
            "hash" = "sha512-iD7BFLburSwO/0CJAakAVuLH4ZW5th6fku3Ydm5J8JQfgSQ5jppyOaVi1URJLXVKJJ+aKrjdRLm9cm4qLXJt7w==";
        };
        _ZIvnnecQ = {
            "id" = "ZIvnnecQ";
            "file" = "ae2importexportcard-26.1.2-2.2.0.jar";
            "hash" = "sha512-BqI4nC6utAG8vuV3QDy/S1Uq4cB/AiN2C7xNQECxQNy/sHiw41mcGa3CTXhO6elQaQEEM3s5zwBoASAWo/u7gA==";
        };
        _wwM4NzLS = {
            "id" = "wwM4NzLS";
            "file" = "ae2importexportcard-26.1.2-2.2.0.jar";
            "hash" = "sha512-OVMiuDoxK9XNwWoX/FcxGd0ds2Q8pyxvd6BvyTM3neMgAlJXVLjxGWJxhzrQvB9H7bOeJ1ptdyrmvM97+UoIvA==";
        };
        _eUJvKXkJ = {
            "id" = "eUJvKXkJ";
            "file" = "ae2importexportcard-26.1.2-2.2.1.jar";
            "hash" = "sha512-zD/aIWbKiwf5oCYqf2EAb1BqI2SuB3wEiDAh2BnBnsitJ5leqVmOJF/NUozL3WNxE7xGgOxHnX1AkJVbrPw6NA==";
        };
        _xJ3k4Pvg = {
            "id" = "xJ3k4Pvg";
    ...
    in {
        ...
        "pkg-1.20.1-1.0.3" = _JtLd0kWi;
        "pkg-1.20.1-1.0.4" = _etgrO9xX;
        "pkg-1.20.1-1.1.0" = _jyzj4dyg;
        "pkg-1.20.1-1.1.1" = _VGUW4MyE;
        "pkg-1.20.1-1.1.2" = _jhq8h5O9;
        "pkg-1.20.1-1.2.0" = _x7nUXDkj;
        "pkg-1.20.1-1.2.1" = _WtkGnuvJ;
        "pkg-1.20.1-1.2.2" = _EnkYbQ8X;
        "pkg-1.21-1.0.0" = _mkzKxyHE;
        "pkg-1.21-1.0.1" = _z0WuNLUy;
        "pkg-1.21-1.1.0" = _TQlP2UED;
        "pkg-1.21-1.1.1" = _qGhvYTKw;
        "pkg-1.21-1.2.0" = _afPUNKPX;
        "pkg-1.21-1.3.0" = _v0Pphk3W;
        "pkg-1.21-1.3.1" = _3qVoeU6z;
        "pkg-1.20.1-1.3.0" = _v8c3El4q;
        "pkg-1.21-1.4.0" = _UcKctWsx;
        "pkg-1.21.1-1.4.1" = _IR5huwKg;
        "pkg-1.19.2-1.0.0" = _h9A1XZdm;
        "pkg-1.21.1-1.4.2" = _amUTlQHY;
        "pkg-1.21.1-1.4.3" = _ecKTdHTd;
        "pkg-1.18.2-1.0.0" = _5TBilHBj;
        "pkg-1.21.1-1.5.0" = _UtJepGDL;
        "pkg-26.1.2-2.0.0" = _nSe4CsaS;
        "pkg-26.1.2-2.0.1" = _IuliJoet;
        "pkg-26.1.2-2.0.2" = _gDAmhTZZ;
        "pkg-26.1.2-2.1.0" = _v2PSNZ3v;
        "pkg-1.21.1-1.6.0" = _UNYpf7A1;
        "pkg-1.21.1-1.7.0" = _C6sdMFGi;
        "pkg-1.21.1-1.7.1" = _DUObGlCJ;
