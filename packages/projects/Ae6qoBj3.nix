...
let
    ...
    in {
        ...
        "pkg-0.2.6" = _LtLbLaxv;
        "pkg-0.2.7" = _AgpbJDIn;
        "pkg-0.3-alpha.5" = _GOszGTYX;
        "pkg-0.3-alpha.6" = _YnWO0g9T;
        "pkg-0.3" = _rOUQqBQU;
        "pkg-0.4" = _7h8CUVuX;
        "pkg-0.4.1" = _wXzoSpSn;
        "pkg-0.4.2" = _UW07S5nf;
        ...
        "pkg-1.2" = _Fb3tnvym;
        "pkg-1.2.1" = _8mJaj9gS;
        "pkg-2.0.0-alpha.1" = _XTQ9mcFY;
        "pkg-1.0.10" = _u5VCdLzN;
        "pkg-1.1.1" = _lyV6BAUF;
        "pkg-1.2.2" = _jRBAvW8X;
        "pkg-2.0.0-alpha.2" = _AKmwZZVR;
        "pkg-2.0.0-beta.1" = _TGA0hLpb;
        "pkg-2.0.0-beta.2" = _Gp6EzP25;
        "pkg-1.0.11" = _G35Yb3qU;
        "pkg-1.3" = _ssynlv8K;
        "pkg-1.3.1" = _I96pPtG8;
        "pkg-1.3.2" = _cT6MjJ4R;
        "pkg-1.3.3" = _4Fr1WkWJ;
        ...
        "pkg-2.0" = _Bf4eUQd2;
        "pkg-2.1" = _OIPXiZHi;
        "pkg-2.2-beta.1" = _l4yqqXg1;
        "pkg-2.2-beta.2+1.21.3" = _XkCFNoaS;
        "pkg-2.2+1.21.1" = _FWIikjMQ;
        "pkg-2.2+1.21.3" = _Zp5Yejo8;
        "pkg-2.2+1.21.4" = _smmcizNf;
        "pkg-2.2.1+1.21.1" = _gPdPRcoB;
        "pkg-2.2.1+1.21.4" = _UPqBB1I8;
        "pkg-2.2.2+1.21.5" = _zDXNmjzS;
        "pkg-2.2.3+1.21.5" = _Q6lsqAPN;
        "pkg-2.2.4+1.21.8" = _DwKFlQzd;
        "pkg-2.2.2+1.21.1" = _p9zkfILS;
        "pkg-2.2.3+1.21.1" = _JifzrLcZ;
        "pkg-2.2.5+1.21.8" = _uMTD5fGy;
        "pkg-2.2.4+1.21.1" = _CrpwcECY;
        "pkg-2.2.6+1.21.8" = _3zfEJ0Kp;
        "pkg-2.2.7+1.21.8" = _NSNrFOiR;
        "pkg-2.2.8+1.21.8" = _I4UbpRqO;
        "pkg-2.2.9+1.21.9" = _2lclJ8KS;
        "pkg-2.2.9+1.21.10" = _7WUcM2IV;
        "pkg-2.2.5+1.21.1" = _9xSoaSyv;
        "pkg-2.2.10+1.21.10" = _waGFbhEt;
        "pkg-2.2.11+1.21.10" = _GxAuRdgv;
        "pkg-2.2.6+1.21.1" = _OEXcnjEW;
        "pkg-2.2.12+1.21.10" = _Fk114Gxr;
        "pkg-2.2.13+1.21.10" = _x3jbmzaa;
        "pkg-2.2.13+1.21.11" = _YFssukdD;
        "pkg-2.2.7+1.21.1" = _p7qLMAzy;
        "pkg-2.2.14+1.21.11" = _4lc1OWHH;
        "pkg-2.3.0+1.21.11" = _Rb8kDYhe;
        "pkg-2.3.0+1.21.1" = _qhoGjEpO;
        "pkg-2.3.1+1.21.11" = _jGdsXqEC;
        "pkg-2.3.2+1.21.11" = _7VIaZFk6;
        "pkg-2.3.3+1.21.11" = _3jriFmfO;
        "pkg-2.3.1+1.21.1" = _hNTurvHs;
        "pkg-2.3.0+1.21.1-neoforge" = _aNO9c4Sp;
        "pkg-2.4.0+1.21.11" = _NNfGXP1O;
        "pkg-3.0.0+26.1-alpha.1" = _vAFGOTMU;
        "pkg-3.0.0+26.1-alpha.2" = _fMvmc01j;
        "pkg-3.0.0+26.1-beta.1" = _Y9BSMTLO;
        "pkg-3.0.0+26.1-beta.2" = _H3zOKOl0;
        "pkg-3.0.0+26.1-beta.3" = _NqYqJVxN;
        "pkg-2.3.1+1.21.1-neoforge" = _be3BwlFO;
        "pkg-2.3.2+1.21.1-neoforge" = _UzRc3iVt;
        "pkg-3.0.0+26.1-beta.4" = _o4H0R21O;
        "pkg-2.3.2+1.21.1" = _C3SQgts5;
