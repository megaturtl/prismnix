...
let
    ...
    in {
        ...
        "pkg-20.2.0" = _gHGJEsgn;
        "pkg-20.3.0" = _qSgmOWau;
        "pkg-20.3.1" = _4B5CSkB8;
        "pkg-20.3.2" = _Vbh6rFqr;
        "pkg-20.4.1" = _IF70nnlO;
        "pkg-20.4.2" = _hMWlxNyC;
        "pkg-20.4.3" = _oqRuYvoR;
        "pkg-20.5.0" = _G6zGy29z;
        "pkg-20.5.1" = _dJYBgNc4;
        "pkg-20.6.0" = _o2dob3rY;
        "pkg-20.7.0" = _ZRgIYHfQ;
        "pkg-20.7.1" = _mkomJXsp;
        "pkg-20.7.2" = _lwaAbCc8;
        "pkg-20.7.3" = _JZP8w4vj;
        "pkg-20.8.1" = _1uMjxTaB;
        "pkg-20.7.4" = _9pneQp42;
        "pkg-20.8.2" = _7QeGUpTi;
        "pkg-20.7.5" = _g5W1Cdiq;
        "pkg-20.8.3" = _F6Xqtrbq;
        "pkg-20.9.0" = _uIRyjQTs;
        "pkg-20.9.3" = _EPWczJbw;
        "pkg-20.10.0" = _hvfJXu39;
        "pkg-20.10.1" = _pbhqoijm;
        "pkg-20.11.1" = _ze4sFbco;
        "pkg-20.12.0" = _P1jsHCTW;
        "pkg-20.12.1" = _msm4jzuE;
        "pkg-20.12.2" = _w09nieEe;
        "pkg-20.13.0" = _UXsjO0Gz;
        "pkg-20.14.1" = _IwE4xEQf;
        "pkg-21.0.1-SNAPSHOT" = _UAKKS3Kq;
        "pkg-21.0.3-SNAPSHOT" = _421q8hL8;
        "pkg-21.1.0" = _2NERzB6w;
        "pkg-21.1.3" = _60guweDV;
        "pkg-21.1.4" = _bbur853T;
        "pkg-21.1.5" = _vPvRppRx;
        "pkg-21.1.6" = _OXnf8ISH;
        "pkg-21.3.0" = _1XiFvI2i;
        "pkg-21.3.1" = _yQkTP1YU;
        "pkg-21.4.0" = _uNFOBkct;
        "pkg-21.1.7" = _dmk6XdZO;
        "pkg-21.4.1" = _B4HyKQiT;
        "pkg-21.3.2" = _oBItC37Z;
        "pkg-21.4.2" = _hqo1R7zL;
        "pkg-21.4.3" = _l2w7jueM;
        "pkg-21.5.0" = _yq7LzQb6;
        "pkg-21.5.1" = _ZUrZVs2w;
        "pkg-21.6.2" = _ovI4sYH2;
        "pkg-21.7.3" = _P3JwMqkM;
        "pkg-21.8.4" = _zt0j1TQK;
        "pkg-21.8.5" = _RWrnTlcj;
        "pkg-12.5.3" = _TQh827yN;
        "pkg-21.10.0" = _yhJNuPyl;
        "pkg-21.10.3" = _pYqVk7QN;
        "pkg-21.11.0" = _BT6C9GJO;
        "pkg-20.7.6" = _uBvRag8i;
        "pkg-20.7.7" = _RXUKseli;
        "pkg-21.10.4" = _bFHq5v8g;
        "pkg-21.11.1" = _eUD1KPm0;
        "pkg-21.10.5" = _jIUHlgOk;
