...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _1KX3qow7;
        "pkg-1.0.1+mod" = _CDxdUhhq;
        "pkg-1.0.2" = _GcVKNmt1;
        "pkg-1.0.2+mod" = _uMfely5M;
        "pkg-1.0.3" = _vNgFPNAa;
        "pkg-1.0.3+mod" = _8XTV0U43;
        "pkg-1.0.4" = _ydKEqKp4;
        "pkg-1.0.4+mod" = _TmM7PeNC;
        "pkg-1.0.5" = _flViwhX9;
        "pkg-1.0.5+mod" = _KNGDiZ6q;
        "pkg-1.1.0" = _AOXa1pB4;
        "pkg-1.1.0+mod" = _pB6Fcxry;
        "pkg-2.0.0" = _XnYx5U6J;
        "pkg-2.0.0+mod" = _WHElTkyl;
        "pkg-2.0.1" = _YRprIVBK;
        "pkg-2.0.1+mod" = _pJurCgvi;
        "pkg-2.0.2" = _wMCf3G99;
        "pkg-2.0.2+mod" = _juNPQ9e3;
        "pkg-2.0.3" = _rTuuRgFN;
        "pkg-2.0.3+mod" = _2mvts1pN;
        "pkg-2.0.4" = _5AU8sIax;
        "pkg-2.0.4+mod" = _ny5Zv5aN;
        "pkg-2.1.0" = _J8rNqNlE;
        "pkg-2.1.0+mod" = _6HpJ4BrH;
        "pkg-2.1.1" = _67unTDLm;
        "pkg-2.1.1+mod" = _uyWy5d17;
        "pkg-2.1.2" = _Ic8hcbzp;
        "pkg-2.1.2+mod" = _kY4jxDY7;
        "pkg-2.1.3" = _5WeNiOhb;
        "pkg-2.1.3+mod" = _rUZmexF4;
        "pkg-2.1.4" = _SMeLL30b;
        "pkg-2.1.4+mod" = _OVpzhkEt;
        "pkg-2.1.5" = _QL8e4HAo;
