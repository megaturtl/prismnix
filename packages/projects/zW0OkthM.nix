...
let
    versions = (let
        ...
        _753ipbQm = {
            "id" = "753ipbQm";
            "file" = "§6Immersive_Interfaces_Modded§8_1.20.x.zip";
            "hash" = "sha512-NZV5qtTcKEFDzRZurD7RLV3Wk6+srtjKJaUbGnKj2bWCiTvXUrMnzqU4a8MuwRQicrgGydkqklIiFy6dGjygiQ==";
        };
        _loRL2lJV = {
            "id" = "loRL2lJV";
            "file" = "§6Immersive_Interfaces_Modded§8_1.21.x.zip";
            "hash" = "sha512-x+6574FRkhBDCBg3Non2ZZfE6seGtwIxCVJd8OJJwmzFIa+i5HZTFNHiZQZr6wIBTLZoJgZAItbnZtS/CPN4Mg==";
        };
        _LWV3Fpjs = {
            "id" = "LWV3Fpjs";
            "file" = "§6Immersive_Interfaces_Modded§8_26.x.zip";
            "hash" = "sha512-1M+/JNc5a0yHn1KIVPvSU9OSj2UPJjNGNswlGSd5jJneTqFGfcnBwCbrqtXF29JzRtRyCqsSpTwQmFIdO86G4g==";
        };
        _WO5sFiG0 = {
            "id" = "WO5sFiG0";
            "file" = "§6Immersive_Interfaces_Modded§8_1.20.x.zip";
            "hash" = "sha512-Y6L87+Z+4dZNodGDxN3g1YCp+RSV7gOeDzSsBD/q5SINLkMdJrygIRnRsgdlXeAXGEKJTW0MUmGqJ0sVulVy8w==";
        };
        _EEa2hNpo = {
            "id" = "EEa2hNpo";
            "file" = "§6Immersive_Interfaces_Modded§8_1.21.x.zip";
            "hash" = "sha512-oje8kEcrE+zxcUSD0ZmWNrp1ZyV/ObcT98hTByuHTuSzHHtI5OAdkrikSCnMPVqTV+oPz97Aw4/+i9gCimtzdg==";
        };
        _4toDr0z6 = {
            "id" = "4toDr0z6";
            "file" = "§6Immersive_Interfaces_Modded§8_26.x.zip";
            "hash" = "sha512-SEnYitG9T4ftlE+AVFa95mEqFNlkTSRRdL4QYhZlhodBw71ytAWC+pn11EkG+v4+AlTZ+BNDlxqi/Fp62dqt9Q==";
        };
        _eixfoIBm = {
            "id" = "eixfoIBm";
            "file" = "§6Immersive_Interfaces_Modded.zip";
            "hash" = "sha512-wKfh+n2iuaf6MY6gtTgID9/+sxrL3yEc1yR2KTUUjgADXpAT8KCea9jPRArT/gLHy1a36EVaQVxUvqQ9r5Zv9g==";
        };
    in {
        "PKbyq13S" = _PKbyq13S;
        "PDRDZ8rg" = _PDRDZ8rg;
        ...
        "4toDr0z6" = _4toDr0z6;
        "eixfoIBm" = _eixfoIBm;
        "minecraft-1.20" = _eixfoIBm;
        "minecraft-1.20.1" = _eixfoIBm;
        "minecraft-1.20.2" = _eixfoIBm;
        "minecraft-1.20.3" = _eixfoIBm;
        "minecraft-1.20.4" = _eixfoIBm;
        "minecraft-1.20.5" = _eixfoIBm;
        "minecraft-1.20.6" = _eixfoIBm;
        "minecraft-1.21" = _eixfoIBm;
        "minecraft-1.21.1" = _eixfoIBm;
        "minecraft-1.21.2" = _eixfoIBm;
        "minecraft-1.21.3" = _eixfoIBm;
        "minecraft-1.21.4" = _eixfoIBm;
        "minecraft-1.21.5" = _eixfoIBm;
        "minecraft-1.21.6" = _eixfoIBm;
        "minecraft-1.21.7" = _eixfoIBm;
        ...
        "minecraft-1.21.8" = _eixfoIBm;
        "minecraft-1.21.9" = _eixfoIBm;
        "minecraft-1.21.10" = _eixfoIBm;
        "minecraft-1.21.11" = _eixfoIBm;
        "minecraft-26.1" = _eixfoIBm;
        "minecraft-26.1.1" = _eixfoIBm;
        "minecraft-26.1.2" = _eixfoIBm;
        "minecraft-26.2" = _eixfoIBm;
        "minecraft-23w31a" = _eixfoIBm;
        "minecraft-23w32a" = _eixfoIBm;
        "minecraft-23w33a" = _eixfoIBm;
        "minecraft-23w35a" = _eixfoIBm;
        "minecraft-1.20.2-pre1" = _eixfoIBm;
        "minecraft-23w42a" = _eixfoIBm;
        "minecraft-23w43a" = _eixfoIBm;
        "minecraft-23w43b" = _eixfoIBm;
        "minecraft-23w44a" = _eixfoIBm;
        "minecraft-23w45a" = _eixfoIBm;
        "minecraft-23w46a" = _eixfoIBm;
        "minecraft-24w03a" = _eixfoIBm;
        "minecraft-24w03b" = _eixfoIBm;
        "minecraft-24w04a" = _eixfoIBm;
        "minecraft-24w05a" = _eixfoIBm;
        "minecraft-24w05b" = _eixfoIBm;
        "minecraft-24w06a" = _eixfoIBm;
        "minecraft-24w07a" = _eixfoIBm;
        "minecraft-24w09a" = _eixfoIBm;
        "minecraft-24w10a" = _eixfoIBm;
        "minecraft-24w11a" = _eixfoIBm;
        "minecraft-24w12a" = _eixfoIBm;
        "minecraft-24w13a" = _eixfoIBm;
        "minecraft-24w14potato" = _eixfoIBm;
        "minecraft-24w14a" = _eixfoIBm;
        "minecraft-1.20.5-pre1" = _eixfoIBm;
        "minecraft-1.20.5-pre2" = _eixfoIBm;
        "minecraft-1.20.5-pre3" = _eixfoIBm;
        "minecraft-24w33a" = _eixfoIBm;
        "minecraft-24w34a" = _eixfoIBm;
        "minecraft-24w35a" = _eixfoIBm;
        "minecraft-24w36a" = _eixfoIBm;
        "minecraft-24w37a" = _eixfoIBm;
        "minecraft-24w38a" = _eixfoIBm;
        "minecraft-24w39a" = _eixfoIBm;
        "minecraft-24w40a" = _eixfoIBm;
        "minecraft-1.21.2-pre1" = _eixfoIBm;
        "minecraft-1.21.2-pre2" = _eixfoIBm;
        "minecraft-24w44a" = _eixfoIBm;
        "minecraft-24w45a" = _eixfoIBm;
        "minecraft-24w46a" = _eixfoIBm;
        "minecraft-24w18a" = _eixfoIBm;
        "minecraft-24w19a" = _eixfoIBm;
        "minecraft-24w19b" = _eixfoIBm;
        "minecraft-24w20a" = _eixfoIBm;
        "pkg-1.0" = _PKbyq13S;
        "pkg-1.1" = _PDRDZ8rg;
        "pkg-1.2" = _3arRtxR5;
        "pkg-1.3" = _dvJixzBR;
        ...
        "pkg-1.9" = _ivHFVD0t;
        "pkg-1.9.1" = _6QMG8r6x;
        "pkg-2.0-1.20.x" = _753ipbQm;
        "pkg-2.0-1.21.x" = _loRL2lJV;
        "pkg-2.0-26.x" = _LWV3Fpjs;
        "pkg-2.0.1-1.20.x" = _WO5sFiG0;
        "pkg-2.0.1-1.21.x" = _EEa2hNpo;
        "pkg-2.0.1-26.x" = _4toDr0z6;
        "pkg-2.0.2" = _eixfoIBm;
        "default" = _eixfoIBm;
    });
