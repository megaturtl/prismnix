...
let
    ...
    in {
        ...
        "pkg-1.2.2+1.17" = _rB3rN7Yy;
        "pkg-1.2.2+1.18" = _buL9OoOQ;
        "pkg-1.3.0+1.18.2" = _LoKWP6Mn;
        "pkg-1.3.1+1.18.2" = _IiXFyaYT;
        "pkg-1.4+1.19" = _1mi900xq;
        "pkg-1.4.1+1.19" = _y4xOF0Cg;
        "pkg-1.4.2+1.19" = _xJJirY2O;
        "pkg-1.4.3+1.19" = _NtH0L0kf;
        "pkg-1.4.4+1.19" = _ypD6A0Dz;
        "pkg-1.4.5+1.19" = _ic9rDGCw;
        "pkg-1.5+1.19.3" = _Rf1xZfyj;
        "pkg-1.5.1+1.19.3" = _dSAeA4LW;
        "pkg-1.5.2+1.19.3" = _3SjxtlFd;
        "pkg-1.5.2+1.19.2" = _WgQhPB7O;
        "pkg-1.5.2+1.20" = _84s3PTI1;
        "pkg-1.5.3+1.19.4" = _DuTJ5yKH;
        "pkg-1.5.3+1.20.2" = _MQtEHzYO;
        "pkg-1.5.4+1.20.5" = _Kxmmmhs5;
        "pkg-1.5.4+1.21" = _6SzVPVR4;
        "pkg-1.5.4+1.21.2" = _mkf1dFwO;
        "pkg-1.5.4+1.21.4" = _4X4bIaS0;
        "pkg-1.5.5+1.21.4" = _W8c8LF0s;
        "pkg-1.5.5+1.21.5" = _htKsCP2s;
        "pkg-1.5.6+1.21.7" = _Dew5OFOW;
        "pkg-1.5.7+1.21.7" = _o1Y79t6V;
        "pkg-1.5.8+1.21.8" = _tHo3epyo;
        "pkg-1.5.9+1.21.8" = _GRuX8d2G;
        "pkg-1.5.9+1.21.9" = _HG7qn2PL;
        "pkg-1.5.10+1.21.11" = _GAQAG80Q;
        "pkg-1.5.10+1.21.9" = _qagjZeWX;
