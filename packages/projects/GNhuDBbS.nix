...
let
    ...
    in {
        ...
        "pkg-1.2.1+mc1.18.2" = _pPDppNT7;
        "pkg-1.2.1+mc1.19.2" = _Gl2i8kjs;
        "pkg-1.2.2+mc1.20.2" = _sZ0SCW6g;
        "pkg-1.3.0+mc1.21.2" = _f4IWzKbb;
        "pkg-1.3.1+mc1.21.2" = _7z4hsmUv;
        "pkg-1.3.2+mc1.21.2" = _lVoXjVuG;
