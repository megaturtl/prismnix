...
let
    versions = (let
        ...
        _rABX8JFW = {
            "id" = "rABX8JFW";
            "file" = "jasione-1.0.7+1.18.2-forge.jar";
            "hash" = "sha512-lMzqu7lgcUPhRBJ/PeUYA+hJYsSvcOTu1ig+PNuETDJ+DiZgD4x59jYI/ER9WNnYZwx3203u+ue2BqufRU27FA==";
        };
        _mTEqqMii = {
            "id" = "mTEqqMii";
            "file" = "jasione-1.0.7+1.20.1-fabric.jar";
            "hash" = "sha512-t5T/h6PCgW2HLoq5z5i79cOhdNYx/AW+xS1ANQzdYZuprTz9C+LEh8t44ezmyocHodL4ynyyfBvp/uRpnAdacw==";
        };
        _eg8MCrug = {
            "id" = "eg8MCrug";
            "file" = "jasione-1.0.7+1.20.1-forge.jar";
            "hash" = "sha512-FrXHmVHJdQrIvsn82qR0aM9KutjlW6q5w7OFfSBLsFXn/oykkTY+Osescz7YlR5f0ShprXJ2WF0LpJl0KMTdkw==";
        };
        _WTMXwPOp = {
            "id" = "WTMXwPOp";
            "file" = "jasione-1.0.7+1.21.1-neoforge.jar";
            "hash" = "sha512-hOdEB6AWzocMkSz6pM5jCqUv09UcBDjipKbdRBn/lI0dMJ7QAiozAItNXIGS8BIlYajeQ5RdEva0A22JJSV7mQ==";
        };
        _92lQMDrp = {
            "id" = "92lQMDrp";
            "file" = "jasione-1.0.7+1.21.11-fabric.jar";
            "hash" = "sha512-pKKjFsXV6fAZGc28c9pcSvvx8+6coJcHVtbl/rk8QbfC8R+9nWJdoK7lWL0UNNe8Dxmjwe544e7lZ/sEAl/gJQ==";
        };
        _GxfKbxWl = {
            "id" = "GxfKbxWl";
            "file" = "jasione-1.0.7+1.21.11-neoforge.jar";
            "hash" = "sha512-rhKj92OTeGUKGk5xI8EHrAuN05uhOsE43Pg3sL6xtHwO5Hkod8cygWU2UsOC3Vxo2hf+IleKWig00I5QMFk+Tw==";
        };
        _SjKNvv6Z = {
            "id" = "SjKNvv6Z";
            "file" = "jasione-1.0.7+26.1.2-fabric.jar";
            "hash" = "sha512-tZMjIdHymJJHI3ISU/wijxLnBK9BSgqlyOWLtVKAHi0+rpjdR2asgHCCa84xFrHXuvz5u+PFSefQMl2KAgobpQ==";
        };
        _2x3tzVBS = {
            "id" = "2x3tzVBS";
            "file" = "jasione-1.0.7+26.1.2-neoforge.jar";
            "hash" = "sha512-6vOXfEfKvR2kb8YtzHm1XpoLbdkV7OQyWUwiw82APQQOIzOAb1eISwipcMIc9LxxTthTyhXfRZA88dRofSyOEw==";
        };
        _Cb9xcUvI = {
            "id" = "Cb9xcUvI";
            "file" = "jasione-1.0.8+1.18.2-forge.jar";
            "hash" = "sha512-SC1sBhhJkDCKbdodunhOmpXWQGT+4/cpHM7id488EoQGtN5I3BgYYdGSze6mojvwXDKUeHMH6eBdCXMgvayyFw==";
        };
        _cme2nsCA = {
            "id" = "cme2nsCA";
            "file" = "jasione-1.0.8+1.20.1-fabric.jar";
            "hash" = "sha512-BF2RSCd7GQyBMJHoYFgZ4XuMyaYfE+Hl9j1A5WofH8uYehj1GefMU+9Pr8cG/2RM0g6k6JmTqnyglcRWBxSjYA==";
        };
        _wzVPKUzw = {
            "id" = "wzVPKUzw";
            "file" = "jasione-1.0.8+1.20.1-forge.jar";
            "hash" = "sha512-0OgoObp3JuLSfCG5thfV6lbQ0gdilBIBLlmc4UdCkM2U43FiIkiACkU8nxsRHyh8WuN28BJVZLFvEf3vnkLgBg==";
        };
        _vbe7Ency = {
            "id" = "vbe7Ency";
            "file" = "jasione-1.0.8+1.21.1-neoforge.jar";
            "hash" = "sha512-7Ia0Fbmt4D6YvuIU1N/B+zGiRnLdl4cImU3xHZCzZ359I7Fqaaj3Duxwc2B8lOZOm4TPotGeInS1qTBDpcwkVg==";
        };
        _jZLpETqw = {
            "id" = "jZLpETqw";
            "file" = "jasione-1.0.8+1.21.11-fabric.jar";
            "hash" = "sha512-vGdTXd4GRAcCrd1WCL+u6/kxHrnN1jeVEum9CNOm2NMoX4qTj1y/D2NQQ8ecJLFZOArQh/jQEeuBA4xwcHYGug==";
        };
        _BJqA9ffK = {
            "id" = "BJqA9ffK";
            "file" = "jasione-1.0.8+1.21.11-neoforge.jar";
            "hash" = "sha512-2nREQ3mW0i7jV9tiLMLyHAVitMmuJSHpbfL5z+NnPVazTXEsEILJXc2UHslXRWwXTzUCxhk7QtNIEAWNTd+WmA==";
        };
        _TPKzcQgZ = {
            "id" = "TPKzcQgZ";
            "file" = "jasione-1.0.8+26.1.2-fabric.jar";
            "hash" = "sha512-X0hthOrWks5AuvHElmsXwM0sl9rqBrxnkpf/7jyTb6EAPvNeuMLpJNo4qEUfVbkkfewq23W4DMA1FY6uuU1U+g==";
        };
        _EtzywdZj = {
            "id" = "EtzywdZj";
            "file" = "jasione-1.0.8+26.1.2-neoforge.jar";
            "hash" = "sha512-k6g+XPZah4ETG/U9cQOv5+NHHFsyuf/UJZQE6BdhJj8YHzlLflyvZpp2AwkWPNMj+sB0+UcY/ZMC8Amiv/J+eA==";
        };
    in {
        "ypGLSLDV" = _ypGLSLDV;
        "pONUBKGA" = _pONUBKGA;
        ...
        "TPKzcQgZ" = _TPKzcQgZ;
        "EtzywdZj" = _EtzywdZj;
        "forge-1.20.1" = _wzVPKUzw;
        "forge-1.19" = _wzVPKUzw;
        "forge-1.19.1" = _wzVPKUzw;
        "forge-1.19.2" = _wzVPKUzw;
        "forge-1.19.3" = _wzVPKUzw;
        "forge-1.19.4" = _wzVPKUzw;
        "forge-1.20" = _wzVPKUzw;
        "forge-1.20.2" = _wzVPKUzw;
        "forge-1.20.3" = _wzVPKUzw;
        "forge-1.20.4" = _wzVPKUzw;
        "forge-1.20.5" = _wzVPKUzw;
        "forge-1.20.6" = _wzVPKUzw;
        "forge-1.18.2" = _Cb9xcUvI;
        "neoforge-1.21" = _vbe7Ency;
        "neoforge-1.21.1" = _vbe7Ency;
        "neoforge-1.21.2" = _vbe7Ency;
        "neoforge-1.21.3" = _vbe7Ency;
        "neoforge-1.21.4" = _vbe7Ency;
        "neoforge-1.21.5" = _vbe7Ency;
        "neoforge-1.21.6" = _vbe7Ency;
        "neoforge-1.21.7" = _vbe7Ency;
        "neoforge-1.21.8" = _vbe7Ency;
        "neoforge-1.21.10" = _BJqA9ffK;
        "neoforge-1.21.11" = _BJqA9ffK;
        "neoforge-26.1" = _EtzywdZj;
        "neoforge-26.1.1" = _EtzywdZj;
        "neoforge-26.1.2" = _EtzywdZj;
        "neoforge-26.2" = _EtzywdZj;
        "fabric-1.20.1" = _cme2nsCA;
        "fabric-1.20.2" = _cme2nsCA;
        "fabric-1.20.3" = _cme2nsCA;
        "fabric-1.20.4" = _cme2nsCA;
        "fabric-1.20.5" = _jZLpETqw;
        "fabric-1.20.6" = _jZLpETqw;
        "fabric-1.21" = _jZLpETqw;
        "fabric-1.21.1" = _jZLpETqw;
        "fabric-1.21.2" = _jZLpETqw;
        "fabric-1.21.3" = _jZLpETqw;
        "fabric-1.21.4" = _jZLpETqw;
        "fabric-1.21.5" = _jZLpETqw;
        "fabric-1.21.6" = _jZLpETqw;
        "fabric-1.21.7" = _jZLpETqw;
        "fabric-1.21.8" = _jZLpETqw;
        "fabric-1.21.9" = _jZLpETqw;
        "fabric-1.21.10" = _jZLpETqw;
        "fabric-1.21.11" = _jZLpETqw;
        "fabric-26.1" = _TPKzcQgZ;
        "fabric-26.1.1" = _TPKzcQgZ;
        "fabric-26.1.2" = _TPKzcQgZ;
        "fabric-26.2" = _TPKzcQgZ;
        "fabric-1.18.2" = _cme2nsCA;
        "fabric-1.19" = _cme2nsCA;
        "fabric-1.19.1" = _cme2nsCA;
        "fabric-1.19.2" = _cme2nsCA;
        "fabric-1.19.3" = _cme2nsCA;
        "fabric-1.19.4" = _cme2nsCA;
        "fabric-1.20" = _cme2nsCA;
        "quilt-1.20.1" = _cme2nsCA;
        "quilt-1.20.2" = _cme2nsCA;
        "quilt-1.20.3" = _cme2nsCA;
        "quilt-1.20.4" = _cme2nsCA;
        "quilt-1.20.5" = _jZLpETqw;
        "quilt-1.20.6" = _jZLpETqw;
        "quilt-1.21" = _jZLpETqw;
        "quilt-1.21.1" = _jZLpETqw;
        "quilt-1.21.2" = _jZLpETqw;
        "quilt-1.21.3" = _jZLpETqw;
        "quilt-1.21.4" = _jZLpETqw;
        "quilt-1.21.5" = _jZLpETqw;
        "quilt-1.21.6" = _jZLpETqw;
        "quilt-1.21.7" = _jZLpETqw;
        "quilt-1.21.8" = _jZLpETqw;
        "quilt-1.21.9" = _jZLpETqw;
        "quilt-1.21.10" = _jZLpETqw;
        "quilt-1.21.11" = _jZLpETqw;
        "quilt-26.1" = _TPKzcQgZ;
        "quilt-26.1.1" = _TPKzcQgZ;
        "quilt-26.1.2" = _TPKzcQgZ;
        "quilt-26.2" = _TPKzcQgZ;
        "quilt-1.18.2" = _cme2nsCA;
        "quilt-1.19" = _cme2nsCA;
        "quilt-1.19.1" = _cme2nsCA;
        "quilt-1.19.2" = _cme2nsCA;
        "quilt-1.19.3" = _cme2nsCA;
        "quilt-1.19.4" = _cme2nsCA;
        "quilt-1.20" = _cme2nsCA;
        "pkg-1.0.0+1.20.1-forge" = _ypGLSLDV;
        "pkg-1.0.0+1.21.1-neoforge" = _pONUBKGA;
        "pkg-1.0.0+1.21.11-fabric" = _bAIVwkYB;
        "pkg-1.0.0+1.21.11-neoforge" = _K68zglMR;
        "pkg-1.0.0+26.1.2-fabric" = _I9JLLvE9;
        "pkg-1.0.0+26.1.2-neoforge" = _QS5ZlA1k;
        "pkg-1.0.1+1.20.1-forge" = _klsDu4Gs;
        "pkg-1.0.1+1.21.1-neoforge" = _ZVvL7beL;
        "pkg-1.0.1+1.21.11-fabric" = _YPT5u0at;
        "pkg-1.0.1+1.21.11-neoforge" = _PCuw8yEy;
        "pkg-1.0.1+26.1.2-fabric" = _lxidGaaD;
        "pkg-1.0.1+26.1.2-neoforge" = _vSXZZbiZ;
        "pkg-1.0.2+1.20.1-forge" = _XS6keksX;
        "pkg-1.0.2+1.21.1-neoforge" = _FnsmzxzN;
        "pkg-1.0.2+1.21.11-fabric" = _SyrdWvIx;
        "pkg-1.0.2+1.21.11-neoforge" = _e1g1QUgz;
        "pkg-1.0.2+26.1.2-fabric" = _IW2iEUGp;
        "pkg-1.0.2+26.1.2-neoforge" = _hHOxg2H8;
        "pkg-1.0.3+1.20.1-forge" = _PY3A1z34;
        "pkg-1.0.3+1.21.1-neoforge" = _Eg9ptt41;
        "pkg-1.0.3+1.21.11-fabric" = _xZ5qbACz;
        "pkg-1.0.3+1.21.11-neoforge" = _AfYkYqWa;
        "pkg-1.0.3+26.1.2-fabric" = _jSeZ1MXc;
        "pkg-1.0.3+26.1.2-neoforge" = _oyVfmdvm;
        "pkg-1.0.4+1.20.1-forge" = _TlECJLmb;
        "pkg-1.0.4+1.21.1-neoforge" = _25GzJDPb;
        "pkg-1.0.4+1.21.11-fabric" = _1E4ILeZA;
        "pkg-1.0.4+1.18.2-forge" = _V1RbM1ZL;
        "pkg-1.0.4+1.21.11-neoforge" = _LjJRjYx3;
        "pkg-1.0.4+26.1.2-fabric" = _8ddPyABR;
        "pkg-1.0.4+26.1.2-neoforge" = _UMyEgcal;
        "pkg-1.0.5+1.18.2-forge" = _LlpLSQux;
        "pkg-1.0.5+1.20.1-fabric" = _6pbNxUuC;
        "pkg-1.0.5+1.20.1-forge" = _6eXvjGXr;
        "pkg-1.0.5+1.21.1-neoforge" = _kIInthND;
        "pkg-1.0.5+1.21.11-fabric" = _htepnSHh;
        "pkg-1.0.5+1.21.11-neoforge" = _cKKKqVyr;
        "pkg-1.0.5+26.1.2-fabric" = _ScKOVdhT;
        "pkg-1.0.5+26.1.2-neoforge" = _2NmbMRIf;
        "pkg-1.0.6+1.18.2-forge" = _fIk6WMJ2;
        "pkg-1.0.6+1.20.1-fabric" = _yuWRZeHN;
        "pkg-1.0.6+1.20.1-forge" = _kwzAnPwS;
        "pkg-1.0.6+1.21.1-neoforge" = _j1Rfpsws;
        "pkg-1.0.6+1.21.11-fabric" = _KTwQTB9q;
        "pkg-1.0.6+1.21.11-neoforge" = _Dfu83Qpr;
        "pkg-1.0.6+26.1.2-fabric" = _b3MVCsFP;
        "pkg-1.0.6+26.1.2-neoforge" = _7MCoffB5;
        "pkg-1.0.7+1.18.2-forge" = _rABX8JFW;
        "pkg-1.0.7+1.20.1-fabric" = _mTEqqMii;
        "pkg-1.0.7+1.20.1-forge" = _eg8MCrug;
        "pkg-1.0.7+1.21.1-neoforge" = _WTMXwPOp;
        "pkg-1.0.7+1.21.11-fabric" = _92lQMDrp;
        "pkg-1.0.7+1.21.11-neoforge" = _GxfKbxWl;
        "pkg-1.0.7+26.1.2-fabric" = _SjKNvv6Z;
        "pkg-1.0.7+26.1.2-neoforge" = _2x3tzVBS;
        "pkg-1.0.8+1.18.2-forge" = _Cb9xcUvI;
        "pkg-1.0.8+1.20.1-fabric" = _cme2nsCA;
        "pkg-1.0.8+1.20.1-forge" = _wzVPKUzw;
        "pkg-1.0.8+1.21.1-neoforge" = _vbe7Ency;
        "pkg-1.0.8+1.21.11-fabric" = _jZLpETqw;
        "pkg-1.0.8+1.21.11-neoforge" = _BJqA9ffK;
        "pkg-1.0.8+26.1.2-fabric" = _TPKzcQgZ;
        "pkg-1.0.8+26.1.2-neoforge" = _EtzywdZj;
        "default" = _EtzywdZj;
    });
