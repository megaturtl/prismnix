...
let
    ...
    in {
        ...
        "pkg-1.20.1-0.0.4.7-alpha" = _CKNeGVly;
        "pkg-1.20.1-0.1.0.8" = _IrMCXF7I;
        "pkg-1.20.1-0.1.1.9-alpha" = _Qohep13x;
        "pkg-1.20.1-0.1.1.10" = _ZLr8LIpw;
        "pkg-1.20.1-0.1.2.12-alpha" = _KCQLs5Uv;
        "pkg-1.20.1-0.1.2.13" = _ue3yQUBe;
        "pkg-1.20.1-0.2.0.14-alpha" = _JrBZgJVp;
        "pkg-1.20.1-0.2.0.15" = _zUxqrjdK;
        "pkg-1.20.1-0.2.1.16-alpha" = _SD1JdZCs;
        "pkg-1.20.1-0.2.1.17-alpha" = _eabJ0rIe;
        "pkg-1.20.1-0.2.2.18-alpha" = _VXHU2BwA;
        "pkg-1.20.1-0.2.3.19-alpha" = _AV9C8kgF;
        "pkg-1.20.1-0.2.3.20" = _z3yB40sT;
        "pkg-1.21.1-0.3.3.22-alpha" = _TdhIiGHS;
        "pkg-1.21.1-0.3.3.23-alpha" = _fxJPxcKC;
        "pkg-1.21.1-0.3.4.24-alpha" = _NzqSlgw0;
        "pkg-1.21.1-0.3.5.25-alpha" = _lRMuRYUl;
        "pkg-1.21.1-0.3.5.26" = _UbgBZqMf;
        "pkg-1.20.1-0.2.4.27-alpha" = _lD8640p6;
        "pkg-1.20.1-0.2.4.28" = _FWCxQJGx;
        "pkg-1.21-0.4.0.29-alpha" = _nsWCnSWI;
        "pkg-1.21-0.4.0.30" = _VHRVIH7k;
        "pkg-1.21.3-0.5.0.31" = _bRGMwWmj;
        "pkg-1.21-0.4.1.32-alpha" = _SQOW5ynI;
        "pkg-1.21-0.4.1.33" = _AaI8kDsr;
        "pkg-1.21.3-0.5.1.34-alpha" = _WWDSZ8t5;
        "pkg-1.21.3-0.5.1.35" = _GrpdNFyD;
        "pkg-1.21.4-0.6.1.36-alpha" = _6dDULgO7;
        "pkg-1.21.4-0.6.0.37" = _HQLwuTDm;
        "pkg-1.21.4-0.7.0.38" = _xsq8wY3e;
        "pkg-1.21.4-0.7.1.39-alpha" = _r6dv0rGr;
        "pkg-1.21.4-0.7.1.40" = _cC2uWgOu;
        "pkg-1.21.3-0.5.2.41" = _PMstGvVp;
        "pkg-1.21.5-0.8.0.43-alpha" = _TDdyJFUJ;
        "pkg-1.21.5-0.8.0.44-alpha" = _Q1NGLmaA;
        "pkg-1.21.5-0.8.0.45" = _g6gGbUcz;
        "pkg-1.21.5-0.9.0.46-alpha" = _E9B9vx8V;
        "pkg-1.21.5-0.9.0.47" = _2IKjTW1p;
        "pkg-1.21.5-0.10.0.48-alpha" = _Hf1aV7sw;
        "pkg-1.21.5-0.10.0.49" = _kniLSa9l;
        "pkg-1.21.5-0.10.0.50-alpha" = _GWIbfTVs;
        "pkg-1.21.5-0.10.1.51-alpha" = _niO2m4AR;
        "pkg-1.21.5-0.10.1.52" = _UdNMNKB3;
        "pkg-1.21.6-0.11.0.53-alpha" = _Vcsu36YH;
        "pkg-1.21.6-0.11.0.54" = _hkzddNzg;
        "pkg-1.21.7-0.11.0.55-alpha" = _AoSJ3jvb;
        "pkg-1.21.7-0.11.0.56" = _vCOKmCcE;
        "pkg-1.21.8-0.11.0.57-alpha" = _1T0BCaBZ;
        "pkg-1.21.8-0.11.0.58" = _EnSuoK0p;
        "pkg-1.21.9-0.12.0.59-alpha" = _I8MjlNSD;
        "pkg-1.21.9-0.12.0.60" = _SzNsT1GV;
        "pkg-1.21.9-0.12.1.61-alpha" = _FWwrAUcA;
        "pkg-1.21.9-0.12.1.62" = _4yEeWlbP;
        "pkg-1.21.9-0.13.0.63-alpha" = _smsWp41j;
        "pkg-1.21.9-0.13.0.64" = _Y0zBx9R1;
        "pkg-1.21.10-0.14.0.65-alpha" = _jETQe6nt;
        "pkg-1.21.10-0.14.0.66" = _I4HB1Uh4;
        "pkg-1.21.11-0.15.0.67-alpha" = _I3wkmok9;
        "pkg-1.21.11-0.15.0.68" = _mDAOPXnE;
        "pkg-26.1.1-0.16.0.69-alpha" = _pF5I5JKp;
        "pkg-26.1.2-0.16.0.70-alpha" = _YSdpSjOf;
        "pkg-26.1.1-0.16.0.71" = _xHtfzQ9x;
