...
let
    ...
    in {
        ...
        "pkg-1.5.8" = _pTMVISsT;
        "pkg-1.5.9" = _YKLjR0uc;
        "pkg-1.5.10" = _DufSmWSj;
        "pkg-1.5.11" = _sRiniFCh;
        "pkg-1.5.12" = _L9Efp4XE;
        "pkg-1.5.13" = _mc2pvcPy;
        "pkg-1.5.14" = _wUkRz1Xk;
        "pkg-1.5.15" = _UEbDYKcj;
        "pkg-1.5.16" = _j8Ea2fF1;
        "pkg-1.5.17" = _1NCpcOsD;
        "pkg-1.5.18" = _lJ1iniML;
        "pkg-1.5.19" = _7e2BIgSy;
