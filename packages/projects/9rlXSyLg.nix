...
let
    ...
    in {
        ...
        "pkg-1.4.0" = _dGjSemMh;
        "pkg-1.0.3" = _bnec5p4Z;
        "pkg-1.0.0-1.19.2" = _v7Gos0OM;
        "pkg-1.0.1-1.19.2" = _H4zUytf5;
        "pkg-1.4.1" = _gSL6QqWc;
        "pkg-1.0.4" = _r4tGcJbC;
        "pkg-1.0.2-1.19.2" = _9VTFdNnw;
        "pkg-1.0.5" = _3YtVafK3;
        "pkg-1.4.2" = _8u4Zpiu3;
        "pkg-1.0.3-1.19.2" = _nRa5uub0;
        "pkg-1.0.6" = _gjM8TaTb;
        "pkg-1.0.4-1.19.2" = _6qzv9RyG;
        "pkg-1.4.3-1.20.1-fabric" = _LkXuaUsM;
        "pkg-1.0.7-1.20.1-forge" = _YNpmzfhG;
        "pkg-1.0.5-1.19.2-fabric" = _Zi2WuE2Y;
        "pkg-1.0.5-1.19.2-forge" = _bw9sMxgI;
        "pkg-1.4.4-1.20.1-fabric" = _uWH2Ftym;
        "pkg-1.0.8-1.20.1-forge" = _FibOTjOd;
        "pkg-1.0.6-1.19.2-fabric" = _nNr0TOSy;
        "pkg-1.0.6-1.19.2-forge" = _I04yJQhu;
        "pkg-1.4.5-1.20.1-fabric" = _XjYQHLEG;
        "pkg-1.0.7-1.19.2-fabric" = _MBgJ88iT;
        "pkg-1.0.7-1.19.2-forge" = _2Lam4GrG;
        "pkg-2024.05.05-1.20-fabric" = _whKMCImw;
        "pkg-2024.05.05-1.20.1-forge" = _QPVpShEe;
        "pkg-2024.05.05-1.19-fabric" = _qdGK58pt;
        "pkg-2024.05.05-1.19-forge" = _zbCluj4v;
        "pkg-2024.06.21-1.20-fabric" = _i45cIUOG;
        "pkg-2024.06.21-1.20.1-forge" = _LKLoKJm6;
        "pkg-2024.06.21-1.19-fabric" = _O7lOl4VK;
        "pkg-2024.07.10-1.21-forge" = _9jQmq4Cz;
        "pkg-2024.07.10-1.21-fabric" = _mq9tybX9;
        "pkg-2024.07.12-1.19-forge" = _64M3oUWR;
        "pkg-2024.07.12-1.20.1-forge" = _AkIYQu82;
        "pkg-2024.07.12-1.21-forge" = _f1S4snsN;
        "pkg-2024.07.12-1.19-fabric" = _abckTE2N;
        "pkg-2024.07.12-1.20-fabric" = _KU1YGLBG;
        "pkg-2024.07.12-1.21-fabric" = _5LbPL7sh;
        "pkg-24.7.27-1.21-neoforge" = _XTtFkQpo;
        "pkg-24.08.09-1.20-fabric" = _OFvsGnTZ;
        "pkg-24.08.09-1.21-fabric" = _utCc4HDK;
        "pkg-24.09.03-1.20-fabric" = _QV8Xp2VI;
        "pkg-24.09.03-1.20-forge" = _SQ6r60Q8;
        "pkg-24.09.03-1.21-fabric" = _JzGrgke8;
        "pkg-24.09.03-1.21-forge" = _GAc1tHRv;
        "pkg-24.09.03-1.21-neoforge" = _oE7rBQO5;
        "pkg-24.09.07-1.19-fabric" = _lRjGRJy3;
        "pkg-24.09.07-1.19-forge" = _7HfU11jZ;
        "pkg-24.11.04-1.19-fabric" = _7McNrVpL;
        "pkg-24.11.04-1.19-forge" = _wtykwLgz;
        "pkg-24.11.04-1.20-fabric" = _BYM8EUZo;
        "pkg-24.11.04-1.20-forge" = _owAb4qsR;
        "pkg-24.11.04-1.21-fabric" = _FrhCIuEF;
        "pkg-24.11.04-1.21-forge" = _VLSk2mtJ;
        "pkg-24.11.04-1.21-neoforge" = _i8CLJZSj;
        "pkg-24.11.06-1.21-fabric" = _t0vSAbdn;
        "pkg-24.11.06-1.20-forge" = _DOkqGFnK;
        "pkg-24.11.06-1.20-fabric" = _JdvLQhsy;
        "pkg-24.11.07-1.19-forge" = _yrvg4gTw;
        "pkg-24.11.07-1.19-fabric" = _1YVVAs8M;
        "pkg-24.11.22-1.21.3-forge" = _pe3PbQSe;
        "pkg-24.11.22-1.21.3-fabric" = _vsNPT2Ji;
        "pkg-24.11.22-1.21.3-neoforge" = _Pki7pUXI;
        "pkg-24.11.22-1.21-forge" = _xzVxjwMN;
        "pkg-24.11.22-1.21-fabric" = _MPQibbJX;
        "pkg-24.11.22-1.21-neoforge" = _YIk0PhEs;
        "pkg-24.11.22-1.20-forge" = _bPAxN4Pu;
        "pkg-24.11.22-1.20-fabric" = _nU9cqGRT;
        "pkg-24.11.22-1.19-forge" = _5qO9Yy3w;
        "pkg-24.11.22-1.19-fabric" = _VclHJ95J;
        "pkg-24.11.29-1.20-forge" = _RAaOvXO9;
        "pkg-24.11.29-1.20.4-forge" = _cbZlWVKs;
        "pkg-24.11.29-1.20.6-forge" = _wryz7uYW;
        "pkg-24.11.29-1.20.6-fabric" = _NLBFe5S2;
        "pkg-24.12.09-1.21.4-fabric" = _TIPpTftY;
        "pkg-24.12.09-1.21.4-forge" = _J3DtKH8k;
        "pkg-24.12.09-1.21.4-neoforge" = _fjFNV7UL;
        "pkg-24.12.27-1.19-forge" = _TsLnr8J7;
        "pkg-25.07.03-1.21.5-fabric" = _gz7baLlY;
        "pkg-25.07.03-1.21.5-forge" = _5LFB8IJG;
        "pkg-25.07.03-1.21.5-neoforge" = _uvBdq5KS;
        "pkg-25.07.03-1.21.6-fabric" = _BXPBILM0;
        "pkg-25.07.03-1.21.6-forge" = _4AwGeaOH;
        "pkg-25.07.03-1.21.6-neoforge" = _ZCt786BO;
        "pkg-25.07.03-1.21.7-fabric" = _PLcrHHPL;
        "pkg-25.07.03-1.21.7-forge" = _P3ooRN5p;
        "pkg-25.07.03-1.21.7-neoforge" = _bUgdFrlL;
        "pkg-25.07.26-1.21.7-forge" = _Y9dX5EjZ;
        "pkg-25.07.26-1.21.7-neoforge" = _v9ABHa1d;
        "pkg-25.07.26-1.21.7-fabric" = _XKJb3Nd7;
        "pkg-25.08.08-1.19-fabric" = _D1yqHS9V;
        "pkg-25.08.08-1.20-fabric" = _OA46Gkxs;
        "pkg-25.08.08-1.20.6-fabric" = _xnnDLQ2f;
        "pkg-25.08.08-1.21-fabric" = _BBsXNLrZ;
        "pkg-25.08.08-1.21.3-fabric" = _1Yc7cRW2;
        "pkg-25.08.08-1.21.4-fabric" = _yJFL76Sg;
        "pkg-25.08.08-1.21.5-fabric" = _dwbMLzra;
        "pkg-25.08.08-1.21.6-fabric" = _Iyqnfu73;
        "pkg-25.08.08-1.21.7-fabric" = _GD6q4bZs;
        "pkg-25.08.08-1.19-forge" = _vLbkg6eQ;
        "pkg-25.08.08-1.20-forge" = _TpQjbJ75;
        "pkg-25.08.08-1.20.6-forge" = _zkM58zA3;
        "pkg-25.08.08-1.21-forge" = _gHPMiaEY;
        "pkg-25.08.08-1.21.3-forge" = _dI4BtjaQ;
        "pkg-25.08.08-1.21.4-forge" = _y0GPRUKV;
        "pkg-25.08.08-1.21.5-forge" = _ek7okTgy;
        "pkg-25.08.08-1.21.6-forge" = _moouhpe3;
        "pkg-25.08.08-1.21.7-forge" = _FDuw6Uv3;
        "pkg-25.08.08-1.21-neoforge" = _jFuhwbQM;
        "pkg-25.08.08-1.21.3-neoforge" = _44DD4sZe;
        "pkg-25.08.08-1.21.4-neoforge" = _1x1fS95f;
        "pkg-25.08.08-1.21.5-neoforge" = _9PSVUCXU;
        "pkg-25.08.08-1.21.6-neoforge" = _wm7lm7UG;
        "pkg-25.08.08-1.21.7-neoforge" = _LwAR3WwH;
        "pkg-25.08.08-1.20.4-forge" = _S32Vqhgo;
        "pkg-25.09.22-1.19-fabric" = _RWSPrOsB;
        "pkg-25.09.22-1.20-fabric" = _CjRQrJL8;
        "pkg-25.09.22-1.20.6-fabric" = _5wXn2ova;
        "pkg-25.09.22-1.21-fabric" = _elNrtwZk;
        "pkg-25.09.22-1.21.3-fabric" = _XNzMRt2r;
        "pkg-25.09.22-1.21.4-fabric" = _XFnciuoR;
        "pkg-25.09.22-1.21.5-fabric" = _tQZ4XRYf;
        "pkg-25.09.22-1.21.6-fabric" = _agdhaENV;
        "pkg-25.09.22-1.21.7-fabric" = _IR6GwDZc;
        "pkg-25.09.22-1.19-forge" = _N6tdpu0s;
        "pkg-25.09.22-1.20-forge" = _2AJQvQZZ;
        "pkg-25.09.22-1.20.4-forge" = _qNnFdSU6;
        "pkg-25.09.22-1.20.6-forge" = _IimWdelE;
        "pkg-25.09.22-1.21-forge" = _5Nr6VJAz;
        "pkg-25.09.22-1.21.3-forge" = _LrGRiDS3;
        "pkg-25.09.22-1.21.4-forge" = _RIM3a3FA;
        "pkg-25.09.22-1.21.5-forge" = _KP4hJuzG;
        "pkg-25.08.05-1.21.6-forge" = _XHkewTH7;
        "pkg-25.09.22-1.21.7-forge" = _481rEAiG;
        "pkg-25.09.22-1.21-neoforge" = _YYynf5qc;
        "pkg-25.09.22-1.21.3-neoforge" = _cOdstDRR;
        "pkg-25.09.22-1.21.4-neoforge" = _eno2Jz8x;
        "pkg-25.09.22-1.21.5-neoforge" = _9Im4M98o;
        "pkg-25.09.22-1.21.6-neoforge" = _MzVWLNVu;
        "pkg-25.09.22-1.21.7-neoforge" = _MAGZDkrp;
        "pkg-25.10.11-1.21.7-neoforge" = _cpKv3Nrr;
        "pkg-25.12.11-1.21.11-neoforge" = _i542BFkn;
        "pkg-25.12.11-1.21.11-forge" = _2UX6hgSg;
        "pkg-26.03.26+26.1-fabric" = _iigTFBc4;
        "pkg-26.03.26+26.1-forge" = _fJjeSvP1;
        "pkg-26.03.26+26.1-neoforge" = _yxe4pjPV;
        "pkg-26.03.26a+26.1-neoforge" = _zBTluYNm;
        "pkg-26.06.19-26.2-neoforge" = _MPRc4wKn;
        "pkg-26.06.19-26.2-forge" = _Qx69FSFp;
        "pkg-26.06.19-26.2-fabric" = _AVGsrYxw;
        "pkg-26.07.01-1.19-fabric" = _JANVkr5M;
        "pkg-26.07.01-1.20-fabric" = _Zv5WA4jT;
        "pkg-26.07.01-1.20.6-fabric" = _sKz94HmU;
        "pkg-26.07.01-1.21-fabric" = _d5n2RuLg;
        "pkg-26.07.01-1.21.3-fabric" = _OTCNZJiq;
        "pkg-26.07.01-1.21.4-fabric" = _tziOOA18;
        "pkg-26.07.01-1.21.5-fabric" = _MnHux5Z2;
        "pkg-26.07.01-1.21.6-fabric" = _1GIk5nMb;
        "pkg-26.07.01-1.21.7-fabric" = _buePM0cO;
        "pkg-26.07.01-1.19-forge" = _BJuYCRR6;
        "pkg-26.07.01-1.20-forge" = _jCMNhRLo;
        "pkg-26.07.01-1.20.4-forge" = _brHIwstS;
        "pkg-26.07.01-1.20.6-forge" = _gaIMv0Wr;
        "pkg-26.07.01-1.21-forge" = _bGQY2czQ;
        "pkg-26.07.01-1.21.3-forge" = _nTqo0snM;
        "pkg-26.07.01-1.21.4-forge" = _aSDGYixG;
        "pkg-26.07.01-1.21.5-forge" = _y62m2iwx;
        "pkg-26.07.01-1.21.6-forge" = _oDfQWyr0;
        "pkg-26.07.01-1.21.7-forge" = _Tq4VxoAy;
        "pkg-26.07.01-1.21.11-forge" = _6kuONoq1;
        "pkg-26.07.01-1.21-neoforge" = _8x7j76JV;
        "pkg-26.07.01-1.21.3-neoforge" = _OYQgAnTc;
        "pkg-26.07.01-1.21.4-neoforge" = _C634uVUe;
        "pkg-26.07.01-1.21.5-neoforge" = _Qjm0HWZN;
        "pkg-26.07.01-1.21.6-neoforge" = _NbeQImup;
        "pkg-26.07.01-1.21.7-neoforge" = _BTCBdjRk;
        "pkg-26.07.01-1.21.11-neoforge" = _NEvLhzIw;
        "pkg-26.07.01-26.1-fabric" = _BN65jCGU;
        "pkg-26.07.01-26.1-forge" = _ZFgocCSK;
        "pkg-26.07.01-26.1-neoforge" = _mxSBHvwP;
        "pkg-26.07.01-26.2-fabric" = _bh14ODmF;
