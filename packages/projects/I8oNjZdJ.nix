...
let
    ...
    in {
        ...
        "pkg-1.18.1-1.3.0-fabric" = _UEDfWUbs;
        "pkg-1.19-1.3.1-Fabric" = _6I6Ie48j;
        "pkg-1.19-1.3.1-Forge" = _GlOQiPRx;
        "pkg-1.19-1.3.2-Fabric" = _N2xCT7cg;
        "pkg-1.18.2-1.3.2-Fabric" = _cRSS61aK;
        "pkg-1.18.2-1.3.1-Forge" = _LyYH2qwY;
        "pkg-1.18.2-1.3.3-Forge" = _d8sMiXew;
        "pkg-1.18.2-1.3.3-Fabric" = _80gNPRSA;
        "pkg-1.19-1.3.3-Forge" = _Q8AUiMmU;
        "pkg-1.19-1.3.3-Fabric" = _TS78ObBX;
        "pkg-1.19-1.3.4-Forge" = _uEY6l7v4;
        "pkg-1.19-1.4.0-Forge" = _KqIQpI0d;
        "pkg-1.19-1.4.0-Fabric" = _fGNLz9iP;
        "pkg-1.19.2-1.4.1-Forge" = _MsKp8nbD;
        "pkg-1.19.2-1.4.1-Fabric" = _ZizyjBRe;
        "pkg-1.19.3-1.4.3-Fabric" = _LCgzEJwH;
        "pkg-1.19.3-1.4.3-Forge" = _xO6XWsx1;
        "pkg-1.18.2-1.4.4-Fabric" = _fcX6t0j4;
        "pkg-1.18.2-1.4.4-Forge" = _v1DhkJeL;
        "pkg-1.16.5-1.4.4-Forge" = _HVGXc7b6;
        "pkg-1.19.3-1.4.4-Forge" = _pNeLCoJg;
        "pkg-1.19.4-1.4.4-Fabric" = _BzFmIUGu;
        "pkg-1.19.4-1.4.4-Forge" = _xdvKNEse;
        "pkg-1.18.2-1.4.5-Fabric" = _qkcKeENG;
        "pkg-1.18.2-1.4.5-Forge" = _jMirq356;
        "pkg-1.19.4-1.4.5-Fabric" = _xasiOd35;
        "pkg-1.19.4-1.4.5-Forge" = _PkPIbbfd;
        "pkg-1.20.1-2.0.0-Fabric" = _9B0nhkVi;
        "pkg-1.20.1-2.0.0-Forge" = _dXbqhg13;
        "pkg-1.18.2-1.5.0-Fabric" = _nZOIvsZQ;
