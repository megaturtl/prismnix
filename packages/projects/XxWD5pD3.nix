...
let
    ...
    in {
        ...
        "pkg-forge-10.0.0-beta.1" = _Bf4qfsQf;
        "pkg-fabric-10.0.0-beta.1" = _6AN4WLgf;
        "pkg-fabric-10.0.0-beta.2" = _n6ctl28A;
        "pkg-forge-10.0.0-beta.2" = _ePPHPjw7;
        "pkg-fabric-10.0.0-beta.3" = _EkIUZgzp;
        "pkg-forge-10.0.0-beta.3" = _uWZo3axN;
        "pkg-fabric-10.0.0-beta.4" = _kOb7LSAK;
        "pkg-forge-10.0.0-beta.4" = _pRtKJO4l;
        "pkg-fabric-10.0.0-beta.5" = _2TIYWbvo;
        "pkg-forge-10.0.0" = _aUAC5DXB;
        "pkg-fabric-10.0.0" = _mlkfFOT9;
        "pkg-forge-10.0.1" = _Q6LSGEqw;
        "pkg-fabric-10.1.0-beta.1" = _f0cVzJbq;
        "pkg-forge-10.1.0-beta.1" = _xKkeaqkM;
        "pkg-fabric-10.1.0-beta.2" = _2OY506tW;
        "pkg-forge-10.1.0-beta.2" = _LmtoNQhm;
        "pkg-fabric-11.0.0-alpha.1" = _Ieppgyii;
        "pkg-forge-11.0.0-alpha.1" = _XSv7aCzj;
        "pkg-forge-11.0.0-alpha.2" = _7rSpITeE;
        "pkg-fabric-11.0.0-alpha.2" = _Z32dIodF;
        "pkg-forge-11.0.0-alpha.3" = _fMM2pwnM;
        "pkg-fabric-11.0.0-alpha.3" = _Woty8glY;
        "pkg-forge-11.0.0-alpha.4" = _NFcpTG3k;
        "pkg-fabric-11.0.0-alpha.5" = _W5IItIBw;
        "pkg-forge-11.0.0-alpha.5" = _xDGpy4Qn;
        "pkg-forge-11.0.0-alpha.6" = _ByV6cOMZ;
        "pkg-fabric-11.0.0" = _nZG3f7mn;
        "pkg-forge-11.0.0" = _697yLiPU;
        "pkg-fabric-11.1.0" = _fjroW9SS;
        "pkg-forge-11.1.0" = _BF8g0TZ3;
        "pkg-forge-11.1.1" = _sWmGENVC;
        "pkg-fabric-11.1.2" = _qosXJAjq;
        "pkg-forge-11.1.2" = _OiY2lfg0;
        "pkg-fabric-11.1.3" = _3FuIT2JI;
        "pkg-forge-11.1.3" = _5KhL4WhW;
        "pkg-fabric-11.1.4" = _RWto5Lhw;
        "pkg-fabric-12.0.0-alpha" = _wHN8x90L;
        "pkg-forge-11.1.4" = _sm5CvPw0;
        "pkg-fabric-12.0.1-alpha" = _oMLKu1Ze;
        "pkg-fabric-12.0.2-alpha" = _nuYdiTZB;
        "pkg-forge-12.0.0-alpha" = _oLeqpmhw;
        "pkg-fabric-12.1.0-alpha" = _mV6fTxoi;
        "pkg-forge-12.0.1-alpha" = _kOcIph1U;
        "pkg-fabric-11.1.5" = _HJrR1zgA;
        "pkg-forge-11.1.5" = _JSwFZQ02;
        "pkg-forge-12.0.2-alpha" = _aR5tGCcS;
        "pkg-forge-12.1.0-alpha" = _s3g4KtWI;
        "pkg-forge-12.1.1-alpha" = _enxs5scj;
        "pkg-fabric-11.1.6" = _9WXP1AHX;
        "pkg-forge-11.1.6" = _mv6YbdV3;
        "pkg-fabric-12.1.2-beta" = _7Gq3qbtw;
        "pkg-forge-12.1.2-beta" = _bD9ZXRfC;
        "pkg-fabric-11.1.7" = _7UmbOb4g;
        "pkg-forge-11.1.7" = _WVYkyvRH;
        "pkg-fabric-12.2.0-beta" = _bpkm2yMw;
        "pkg-forge-12.2.0-beta" = _C5nwXELu;
        "pkg-fabric-12.3.0-beta" = _ZaNpnMCh;
        "pkg-forge-12.3.0-beta" = _OFBWYrp4;
        "pkg-fabric-12.4.0-beta" = _PvPdRUHX;
        "pkg-forge-12.4.0-beta" = _PDkmB4UV;
        "pkg-forge-12.5.0-beta" = _zkC0WSUn;
        "pkg-fabric-12.5.0-beta" = _Z6jnGDF9;
        "pkg-fabric-12.5.1-beta" = _5xa1OSzf;
        "pkg-forge-12.5.1-beta" = _5EyIPVWA;
        "pkg-forge-12.5.2-beta" = _XVFb5sJ7;
        "pkg-fabric-11.2.0" = _WzDBx3u7;
        "pkg-forge-11.2.0" = _YNFx3Hjn;
        "pkg-forge-11.3.0" = _nrq8eC4Q;
        "pkg-fabric-11.3.0" = _6VmOchNB;
        "pkg-fabric-12.6.0" = _9XtLETKp;
        "pkg-forge-12.6.0" = _hCIvVRgg;
        "pkg-fabric-11.4.0" = _RFmdcgz3;
        "pkg-forge-11.4.0" = _vrdekdmw;
        "pkg-fabric-12.7.0" = _Z8OKgUoh;
        "pkg-forge-12.7.0" = _P4SHVMac;
        "pkg-fabric-11.5.0" = _25KjhlGv;
        "pkg-forge-11.5.0" = _S3K8G49B;
        "pkg-forge-12.8.1-beta" = _6qQEQmM8;
        "pkg-fabric-11.6.0-beta" = _36EMfB3q;
        "pkg-forge-11.6.0-beta" = _DZd4yQe4;
        "pkg-fabric-12.8.2-beta" = _c3zEVaQ8;
        "pkg-forge-12.8.2-beta" = _wYymrhE4;
        "pkg-fabric-11.6.1-beta" = _8HeKobcP;
        "pkg-forge-11.6.1-beta" = _yz68xU3j;
        "pkg-fabric-12.8.3-beta" = _pcHc3tZs;
        "pkg-forge-12.8.3-beta" = _MrXpPIvo;
        "pkg-fabric-11.6.2" = _aszqg0Wn;
        "pkg-forge-11.6.2" = _WAh5HPC8;
        "pkg-fabric-12.8.4" = _RgkwNSjT;
        "pkg-forge-12.8.4" = _62yssi1E;
        "pkg-forge-11.6.3" = _A5FUIGjh;
        "pkg-forge-11.6.4" = _q5TQ3zgd;
        "pkg-fabric-12.8.5" = _9P35YnKN;
        "pkg-forge-12.8.5" = _ix3GcoBP;
        "pkg-fabric-11.6.5" = _RJnK9Ovj;
        "pkg-forge-11.6.5" = _MoGLgJK1;
        "pkg-forge-12.8.6" = _t3aUE6HS;
        "pkg-fabric-11.6.6" = _7NWAte1m;
        "pkg-forge-11.6.6" = _PWdOzVug;
        "pkg-fabric-11.6.7" = _HQd68kb6;
        "pkg-forge-11.6.7" = _lp2vAcHP;
        "pkg-fabric-12.9.0" = _c0KKkf1Z;
        "pkg-fabric-12.9.1" = _zhr2jXaL;
        "pkg-forge-12.9.1" = _9evKVcVd;
        "pkg-fabric-11.7.0" = _MPdVG6oo;
        "pkg-forge-11.7.0" = _COSdQAoF;
        "pkg-fabric-13.0.0-alpha" = _TBVf9h2p;
        "pkg-forge-13.0.0" = _CKA0xF7f;
        "pkg-forge-13.0.1-alpha" = _GL3uhBGD;
        "pkg-fabric-13.0.2-alpha" = _brl6VeNy;
        "pkg-fabric-13.0.3-alpha" = _TMEAMYIx;
        "pkg-forge-13.0.3-alpha" = _g7uJnOOS;
        "pkg-forge-13.0.4-alpha" = _sALiGsl3;
        "pkg-fabric-12.9.2" = _yIupDKor;
        "pkg-forge-12.9.2" = _oAGWsu3M;
        "pkg-forge-13.0.5-beta" = _JRLfd73N;
        "pkg-fabric-13.0.6-beta" = _UAuf0uiD;
        "pkg-forge-13.0.7-beta" = _3Mvq6QHo;
        "pkg-forge-13.0.8-beta" = _L6VGYHd3;
        "pkg-forge-13.0.9-beta" = _y5W8KGqT;
        "pkg-fabric-11.7.1" = _xGjt6qMm;
        "pkg-forge-13.0.10-beta" = _sOqmy2ww;
        "pkg-12.9.3" = _8C4WbuoI;
        "pkg-11.7.2" = _DsTIvcA1;
        "pkg-forge-12.9.4" = _Tw8kyhfI;
        "pkg-forge-11.7.3" = _NHcKcc8c;
        "pkg-fabric-12.9.5" = _Xc1WEGPd;
        "pkg-forge-12.9.5" = _1HKx8M9v;
        "pkg-forge-11.7.4" = _qf2Yz73T;
        "pkg-fabric-11.7.4" = _8HEK7sk8;
        "pkg-fabric-15.0.0-alpha" = _ijZQY1Rd;
        "pkg-forge-15.0.0-alpha" = _xzP4cydc;
        "pkg-fabric-15.0.1-alpha" = _a5pC6xdL;
        "pkg-forge-15.0.1-alpha" = _QalOLGBM;
        "pkg-fabric-15.0.2-alpha" = _RpMpf7zi;
        "pkg-forge-15.0.2-alpha" = _Zrp3c9yN;
        "pkg-forge-15.0.3-alpha" = _7vB6vk2v;
        "pkg-fabric-15.0.3-alpha" = _7ACUdipn;
        "pkg-fabric-15.0.4-beta" = _Sz6f1zJd;
        "pkg-forge-15.0.4-beta" = _qfpQmwll;
        "pkg-fabric-12.9.6" = _lePuKDdy;
        "pkg-fabric-15.0.5-beta" = _TKhjxSIB;
        "pkg-forge-15.0.5-beta" = _oS3Ga2mY;
        "pkg-15.0.6-beta" = _IcREcVDb;
        "pkg-15.0.7-beta" = _AxEi5RIz;
        "pkg-15.0.8-beta" = _b13bPfeM;
        "pkg-15.0.9-beta" = _rLjoLUTF;
        "pkg-fabric-11.7.5" = _wGIGpPsQ;
        "pkg-forge-11.7.5" = _tifFqBKk;
        "pkg-fabric-12.9.7" = _W4efZESl;
        "pkg-forge-12.9.7" = _lThI0ayT;
        "pkg-forge-11.7.6" = _qBbqV301;
        "pkg-fabric-11.7.6" = _l3tOwBzj;
        "pkg-forge-12.9.8" = _LxjXwNSj;
        "pkg-fabric-12.9.8" = _Bj8oQseU;
        "pkg-15.0.10" = _CkK2zzkf;
        "pkg-15.0.11" = _5cb16tgY;
        "pkg-15.0.12" = _1kT0YXJf;
        "pkg-15.0.13" = _lT1sdBmI;
        "pkg-15.0.14" = _8edEAu2V;
        "pkg-15.0.15" = _U3MExcIx;
        "pkg-16.0.1-alpha" = _OIOSSXhK;
        "pkg-16.0.2" = _Cf5vGMwV;
        "pkg-17.0.0-alpha" = _XfVOZDN8;
        "pkg-15.0.16" = _jgICE67P;
        "pkg-17.0.1-alpha" = _nhQTb3m4;
        "pkg-15.0.17" = _ZVjAvWE5;
        "pkg-17.0.2-beta" = _MNGBfmiy;
        "pkg-15.0.18" = _fFh1IdTY;
        "pkg-17.0.3-beta" = _fugqOJWC;
        "pkg-17.0.4-beta" = _LznTi8p2;
        "pkg-15.0.19" = _ibJ4Ydxw;
        "pkg-fabric-12.9.9" = _VI3B0aKr;
        "pkg-17.0.5-beta" = _ZBr63LNs;
        "pkg-forge-12.9.9" = _qGKR0YVC;
        "pkg-17.0.6-beta" = _d1AtkO1b;
        "pkg-15.0.20" = _YO5wVxT7;
        "pkg-17.0.7-beta" = _XCXfEG6G;
        "pkg-17.1.0-beta" = _hNV0u2Ke;
        "pkg-17.1.1-beta" = _GkAgfE4B;
        "pkg-17.2.0-beta" = _u5dC9pjL;
        "pkg-15.0.21" = _NmC7F1OZ;
        "pkg-17.3.0-beta" = _i1h1wOhr;
        "pkg-17.4.0-beta" = _3fQeIJU2;
        "pkg-17.5.0-beta" = _Hnumk0Bl;
        "pkg-17.5.1-beta" = _RQKXi0Jk;
        "pkg-15.0.22" = _ZyC52h3W;
        "pkg-17.6.0-beta" = _SK6yn8MM;
        "pkg-17.6.1-beta" = _w2R8hIML;
        "pkg-17.6.2-beta" = _WJVipmUL;
        "pkg-17.6.3-beta" = _pThfoWlc;
        "pkg-17.6.4-beta" = _D7bfN7hf;
        "pkg-17.6.5-beta" = _QV62CH9w;
        "pkg-17.6.6-beta" = _BZL7JFgj;
        "pkg-17.7.0-alpha" = _uAI0bShS;
        "pkg-17.7.1-beta" = _kP2VZhqZ;
        "pkg-15.0.23" = _pHuguX3Y;
        "pkg-17.8.0-beta" = _hYG5tbva;
        "pkg-17.8.1-beta" = _FNy8w4ic;
        "pkg-17.9.0-beta" = _UmQtYI0G;
        "pkg-17.10.0-beta" = _792UNplB;
        "pkg-17.10.1-beta" = _Euz9WnGy;
        "pkg-17.10.2-beta" = _JWh6WyXU;
        "pkg-17.10.3-beta" = _FzURHfti;
        "pkg-17.10.4-beta" = _RpmE1nzj;
        "pkg-17.11.0-beta" = _UvErlgaY;
        "pkg-17.11.1-beta" = _xn5sieSc;
        "pkg-17.12.0-beta" = _Lo9sz0BU;
        "pkg-15.0.24" = _pUCfuoqf;
        "pkg-17.12.1-beta" = _EtNeQMla;
        "pkg-17.13.0-beta" = _OK01nNQM;
        "pkg-15.1.0" = _kywcQ25B;
        "pkg-15.1.1" = _isHbiIeZ;
        "pkg-18.0.0-alpha" = _pGnl32B8;
        "pkg-18.0.1-alpha" = _tjB3sQ3W;
        "pkg-18.1.0-alpha" = _NoFBkXQe;
        "pkg-18.1.1-alpha" = _9Vscdpuz;
        "pkg-15.2.0" = _qpG9cRjY;
        "pkg-15.2.1" = _fZYI0nmw;
        "pkg-18.1.2-alpha" = _mfB8KDaB;
        "pkg-18.1.3-alpha" = _L3u3Zbmr;
        "pkg-15.2.2" = _Fx9uV7AL;
        "pkg-15.2.3" = _eQcAHHqJ;
        "pkg-19.0.0-alpha" = _4AsGT2cN;
        "pkg-19.0.1-alpha" = _WTviSGxg;
        "pkg-19.0.2-alpha" = _Q6wAB4Fm;
        "pkg-19.0.3-alpha" = _RyqiiHUt;
        "pkg-19.0.4-alpha" = _NsFt2Dws;
        "pkg-15.2.4" = _G13uBrme;
        "pkg-19.0.5-alpha" = _v48VlCNF;
        "pkg-19.0.6-alpha" = _45j4Lh8t;
        "pkg-19.0.7-alpha" = _7VNKQE9m;
        "pkg-15.2.5" = _o7nZu2n5;
        "pkg-15.2.6" = _3w98zsYp;
        "pkg-15.2.7" = _9RulCOOy;
        "pkg-19.0.8-alpha" = _hZu6jr2B;
        "pkg-15.2.8" = _fg8ibB1d;
        "pkg-19.0.9-alpha" = _bSahmw5k;
        "pkg-15.2.9" = _fatWoH9r;
        "pkg-19.0.10-alpha" = _P2bQilsh;
        "pkg-19.0.11-alpha" = _g0jCjl5y;
        "pkg-19.0.12-alpha" = _csjkbDtF;
        "pkg-19.0.13-alpha" = _XWNJEhkV;
        "pkg-19.0.14-alpha" = _TWq5gMts;
        "pkg-19.0.15-alpha" = _L3Ndblbb;
        "pkg-19.0.16-beta" = _1beZUHbG;
        "pkg-15.2.10" = _at9aycRr;
        "pkg-15.2.11" = _egygeC2Z;
        "pkg-19.0.17-beta" = _CSxQyPX8;
        "pkg-19.0.18-beta" = _4j1CehdP;
        "pkg-15.2.12" = _xmoW71GF;
        "pkg-19.0.19-beta" = _8hwSVt90;
        "pkg-19.0.20-beta" = _BXufDcIQ;
        "pkg-15.2.13" = _VGMDHpdE;
        "pkg-19.0.21-beta" = _RBx6QI1k;
        "pkg-19.0.22-beta" = _bW57A2dn;
        "pkg-19.0.23-beta" = _5QRSvy1M;
        "pkg-15.2.14" = _jawS8d1S;
        "pkg-15.2.15" = _5T1NXCuQ;
        "pkg-19.0.24" = _fd0eWnni;
        "pkg-19.0.25" = _EqqVJiaM;
        "pkg-19.0.26" = _ATqt4KNJ;
        "pkg-19.0.27" = _MtfkxF8X;
        "pkg-15.2.16" = _zywmowQO;
        "pkg-19.1.0-beta" = _Sx1PeddP;
        "pkg-15.3.0-beta" = _5qYZGCZY;
        "pkg-19.1.1-beta" = _LuX5CLrK;
        "pkg-15.3.1-beta" = _bMdluLyv;
        "pkg-19.1.2-beta" = _eLN5Fcvz;
        "pkg-15.3.2-beta" = _RRBDfS9L;
        "pkg-19.1.3-beta" = _eLhFW15k;
        "pkg-15.3.3" = _JSY0V9J5;
        "pkg-19.2.0-beta" = _XirZ0Ibs;
        "pkg-19.2.1-beta" = _k9EF1Igr;
        "pkg-19.2.2-beta" = _FsBnZLCO;
        "pkg-19.2.3-beta" = _yFGEjQGA;
        "pkg-forge-12.9.10" = _A3fwETx2;
        "pkg-forge-12.9.11" = _kRbtLCAl;
        "pkg-forge-12.9.12" = _U8JDlAX0;
        "pkg-19.2.4" = _T1yX86cQ;
        "pkg-19.2.5-beta" = _GWkCs8BE;
        "pkg-19.2.6-beta" = _TBO9tagI;
        "pkg-19.2.7" = _2tpOzdrK;
        "pkg-15.3.4" = _Ap6Grcvz;
        "pkg-19.2.8" = _oq9bmQCW;
        "pkg-19.2.9" = _DUSBnYm0;
        "pkg-19.2.10" = _juQOuKVW;
        "pkg-15.3.5" = _SrvX4PXK;
        "pkg-15.4.0" = _M2fCB0ua;
        "pkg-15.3.6" = _jshq8JsX;
        "pkg-15.4.1" = _LbIVLEYC;
        "pkg-15.4.2" = _eqFFaFdj;
        "pkg-15.4.3" = _N4qMBylz;
        "pkg-19.2.11" = _FcobeuQZ;
        "pkg-15.4.4" = _ACZsejkY;
        "pkg-19.2.12" = _Skhspwxl;
        "pkg-15.4.5" = _JK3sC1Xz;
        "pkg-19.2.13" = _SSa4JmFc;
        "pkg-15.4.6" = _ZJYegSUG;
        "pkg-15.4.7" = _GjbmnmSR;
        "pkg-19.2.14" = _mbQJm4mU;
        "pkg-15.4.8" = _Zfyso1sP;
        "pkg-19.2.15" = _gl74ldr3;
        "pkg-19.2.16" = _V7DsUIUp;
        "pkg-19.2.17" = _kfyIqgJ6;
        "pkg-15.4.9" = _bPqA2EAH;
        "pkg-15.4.10" = _kA3rm9EP;
        "pkg-26.1.2-alpha" = _aBMPSwQv;
        "pkg-26.1.3-alpha" = _rcOWQfo7;
        "pkg-26.1.4-alpha" = _WHMeX0Br;
        "pkg-26.1.5-alpha" = _85JEIVdn;
        "pkg-26.1.6-alpha" = _vhJS4TgO;
        "pkg-26.1.7-alpha" = _MNCJXW7X;
