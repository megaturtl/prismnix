...
let
    versions = (let
        ...
        _yD4yIWff = {
            "id" = "yD4yIWff";
            "file" = "BetterHud-velocity-2.1.0-SNAPSHOT-448.jar";
            "hash" = "sha512-9IJhYENS1wNre1z305HF18b0HYZEd08CdbzAKmNT7lN5qOFols1NL+q48pT7RB27BJ72mAphacFt1B+NpLg5NQ==";
        };
        _JGWfqQJc = {
            "id" = "JGWfqQJc";
            "file" = "BetterHud-fabric+26.2-2.1.0-SNAPSHOT-448.jar";
            "hash" = "sha512-8dpBoHE+Iehlj6Pw4b2zCNZ12UuOTCxD8mARRBRGUC0XYHvtGgMmcH/xYOJouA42G7CxKxP8FWoYGKwDaSv5jw==";
        };
        _awh0s5EZ = {
            "id" = "awh0s5EZ";
            "file" = "BetterHud-bukkit-2.1.0-SNAPSHOT-448.jar";
            "hash" = "sha512-OBPWQJph9/ku8/e6AHtDxWedR9B09QfadjS3t49Do/F/0e6BGFMURvm8Pwzb6n8CSh2WlTtCqZcp8v8oZtQ1PA==";
        };
    in {
        "9fITYhpr" = _9fITYhpr;
        "fJnd5sgr" = _fJnd5sgr;
        ...
        "bukkit-1.21" = _awh0s5EZ;
        "bukkit-1.21.1" = _awh0s5EZ;
        "bukkit-1.21.2" = _awh0s5EZ;
        "bukkit-1.21.3" = _awh0s5EZ;
        "bukkit-1.21.4" = _awh0s5EZ;
        "bukkit-1.21.5" = _awh0s5EZ;
        "bukkit-1.21.6" = _awh0s5EZ;
        "bukkit-1.21.7" = _awh0s5EZ;
        "bukkit-1.21.8" = _awh0s5EZ;
        "bukkit-1.21.9" = _awh0s5EZ;
        "bukkit-1.21.10" = _awh0s5EZ;
        "bukkit-1.21.11" = _awh0s5EZ;
        "bukkit-26.1" = _awh0s5EZ;
        "bukkit-26.1.1" = _awh0s5EZ;
        "bukkit-26.1.2" = _awh0s5EZ;
        "bukkit-26.2" = _awh0s5EZ;
        ...
        "folia-1.21" = _awh0s5EZ;
        "folia-1.21.1" = _awh0s5EZ;
        "folia-1.21.2" = _awh0s5EZ;
        "folia-1.21.3" = _awh0s5EZ;
        "folia-1.21.4" = _awh0s5EZ;
        "folia-1.21.5" = _awh0s5EZ;
        "folia-1.21.6" = _awh0s5EZ;
        "folia-1.21.7" = _awh0s5EZ;
        "folia-1.21.8" = _awh0s5EZ;
        "folia-1.21.9" = _awh0s5EZ;
        "folia-1.21.10" = _awh0s5EZ;
        "folia-1.21.11" = _awh0s5EZ;
        "folia-26.1" = _awh0s5EZ;
        "folia-26.1.1" = _awh0s5EZ;
        "folia-26.1.2" = _awh0s5EZ;
        "folia-26.2" = _awh0s5EZ;
        ...
        "paper-1.21" = _awh0s5EZ;
        "paper-1.21.1" = _awh0s5EZ;
        "paper-1.21.2" = _awh0s5EZ;
        "paper-1.21.3" = _awh0s5EZ;
        "paper-1.21.4" = _awh0s5EZ;
        "paper-1.21.5" = _awh0s5EZ;
        "paper-1.21.6" = _awh0s5EZ;
        "paper-1.21.7" = _awh0s5EZ;
        "paper-1.21.8" = _awh0s5EZ;
        "paper-1.21.9" = _awh0s5EZ;
        "paper-1.21.10" = _awh0s5EZ;
        "paper-1.21.11" = _awh0s5EZ;
        "paper-26.1" = _awh0s5EZ;
        "paper-26.1.1" = _awh0s5EZ;
        "paper-26.1.2" = _awh0s5EZ;
        "paper-26.2" = _awh0s5EZ;
        ...
        "purpur-1.21" = _awh0s5EZ;
        "purpur-1.21.1" = _awh0s5EZ;
        "purpur-1.21.2" = _awh0s5EZ;
        "purpur-1.21.3" = _awh0s5EZ;
        "purpur-1.21.4" = _awh0s5EZ;
        "purpur-1.21.5" = _awh0s5EZ;
        "purpur-1.21.6" = _awh0s5EZ;
        "purpur-1.21.7" = _awh0s5EZ;
        "purpur-1.21.8" = _awh0s5EZ;
        "purpur-1.21.9" = _awh0s5EZ;
        "purpur-1.21.10" = _awh0s5EZ;
        "purpur-1.21.11" = _awh0s5EZ;
        "purpur-26.1" = _awh0s5EZ;
        "purpur-26.1.1" = _awh0s5EZ;
        "purpur-26.1.2" = _awh0s5EZ;
        "purpur-26.2" = _awh0s5EZ;
        ...
        "spigot-1.21" = _awh0s5EZ;
        "spigot-1.21.1" = _awh0s5EZ;
        "spigot-1.21.2" = _awh0s5EZ;
        "spigot-1.21.3" = _awh0s5EZ;
        "spigot-1.21.4" = _awh0s5EZ;
        "spigot-1.21.5" = _awh0s5EZ;
        "spigot-1.21.6" = _awh0s5EZ;
        "spigot-1.21.7" = _awh0s5EZ;
        "spigot-1.21.8" = _awh0s5EZ;
        "spigot-1.21.9" = _awh0s5EZ;
        "spigot-1.21.10" = _awh0s5EZ;
        "spigot-1.21.11" = _awh0s5EZ;
        "spigot-26.1" = _awh0s5EZ;
        "spigot-26.1.1" = _awh0s5EZ;
        "spigot-26.1.2" = _awh0s5EZ;
        "spigot-26.2" = _awh0s5EZ;
        ...
        "velocity-1.21" = _yD4yIWff;
        "velocity-1.21.1" = _yD4yIWff;
        "velocity-1.21.2" = _yD4yIWff;
        "velocity-1.21.3" = _yD4yIWff;
        "velocity-1.21.4" = _yD4yIWff;
        "velocity-1.21.5" = _yD4yIWff;
        "velocity-1.21.6" = _yD4yIWff;
        "velocity-1.21.7" = _yD4yIWff;
        "velocity-1.21.8" = _yD4yIWff;
        "velocity-1.21.9" = _yD4yIWff;
        "velocity-1.21.10" = _yD4yIWff;
        "velocity-1.21.11" = _yD4yIWff;
        "velocity-26.1" = _yD4yIWff;
        "velocity-26.1.1" = _yD4yIWff;
        "velocity-26.1.2" = _yD4yIWff;
        "velocity-26.2" = _yD4yIWff;
        ...
        "quilt-26.2" = _JGWfqQJc;
        "pkg-1.0" = _9fITYhpr;
        "pkg-1.1" = _fJnd5sgr;
        "pkg-1.2" = _qRgtZSdg;
        "pkg-1.3" = _lkjFXCn1;
        "pkg-1.3-HOTFIX" = _wd2s2tDI;
        "pkg-1.4" = _LMDIIAAJ;
        "pkg-1.4-HOTFIX" = _GVIjW1eE;
        "pkg-1.5.216" = _9TlYtSYH;
        "pkg-1.5.217" = _OP6z2vOc;
        "pkg-1.5.218" = _SNvzoWar;
        "pkg-1.5.219" = _EfJZytYu;
        "pkg-1.5.222" = _85icY3zk;
        "pkg-1.5.223" = _GVR8apGb;
        "pkg-1.5" = _GHBxh9Tn;
        "pkg-1.6.224" = _nDleoJNq;
        "pkg-1.6.225" = _qIB8C7m5;
        "pkg-1.6.227" = _yebGVyvL;
        "pkg-1.6.228" = _udu2xhal;
        "pkg-1.6.232" = _yjhZKLdH;
        "pkg-1.6.233" = _EB7SCoNQ;
        "pkg-1.6.237" = _YvONEXXp;
        "pkg-1.6.238" = _m8HNVQvI;
        "pkg-1.6.242" = _fXZbDrY9;
        "pkg-1.6.243" = _NkX4RFGT;
        "pkg-1.6.245" = _z5o57kAm;
        "pkg-1.6.246" = _CaOBv1fm;
        "pkg-1.6.247" = _tbVEhhZ3;
        "pkg-1.6.248" = _sEyiF6R6;
        "pkg-1.6.249" = _P9GaPN4z;
        "pkg-1.6.250" = _G6pOrSUz;
        "pkg-1.6.251" = _UZLaLQ5n;
        "pkg-1.6.252" = _BIJtUCRr;
        "pkg-1.6.253" = _76lw70fU;
        "pkg-1.6.254" = _8Fb79Ilf;
        "pkg-1.6.255" = _JjARwqJv;
        "pkg-1.6.256" = _ouYHn4DG;
        "pkg-1.7" = _pRgxApuf;
        "pkg-1.7.DEV-259" = _EPYjgio6;
        "pkg-1.7.DEV-264" = _jqqo6Uis;
        "pkg-1.7.DEV-265" = _JuJ2Yv9r;
        "pkg-1.7.DEV-266" = _CZcYCXBy;
        "pkg-1.7.DEV-267" = _eYJmvkar;
        "pkg-1.7.DEV-280" = _MJf57Kfe;
        "pkg-1.8" = _9zUk5Jje;
        "pkg-1.8.DEV-282" = _QSQae93o;
        "pkg-1.8.DEV-283" = _lZVBW4TB;
        "pkg-1.8.DEV-284" = _jIATPIer;
        "pkg-1.8.DEV-285" = _eQXENHo3;
        "pkg-1.8.DEV-286" = _XicEpo8W;
        "pkg-1.8.DEV-288" = _U8wPJPAl;
        "pkg-1.8.DEV-289" = _gEFiSPj5;
        "pkg-1.9" = _vBgHmSYL;
        "pkg-1.9.DEV-291" = _RjgNOwlx;
        "pkg-1.9.DEV-292" = _WnoyWDDR;
        "pkg-1.9.DEV-293" = _DVjHek55;
        "pkg-1.9.DEV-294" = _FTj4NA1R;
        "pkg-1.9.DEV-295" = _Mc0O5tuD;
        "pkg-1.9.1" = _W7aU2cmG;
        "pkg-1.9.1.DEV-297" = _jg0TYCfg;
        "pkg-1.9.1.DEV-299" = _ORjAbVIO;
        "pkg-1.9.1.DEV-300" = _apI9HxED;
        "pkg-1.9.2" = _KN9KdLsq;
        "pkg-1.9.2.DEV-302" = _4RvpZEEh;
        "pkg-1.9.2.DEV-303" = _ZfYZzGZJ;
        "pkg-1.9.2.DEV-304" = _dsutqwgT;
        "pkg-1.9.2.DEV-305" = _xpPNV0Td;
        "pkg-1.9.2.DEV-306" = _jtO5xg4J;
        "pkg-1.9.2.DEV-307" = _EYNCH7yA;
        "pkg-1.9.2.DEV-308" = _F5zo2lwq;
        "pkg-1.9.2.DEV-309" = _HNFsjrZT;
        "pkg-1.9.2.DEV-311" = _N3I51j9u;
        "pkg-1.9.2.DEV-312" = _JtmvwVI0;
        "pkg-1.9.2.DEV-313" = _Cl8tq2Au;
        "pkg-1.9.2.DEV-314" = _7C5O7neW;
        "pkg-1.9.2.DEV-315" = _tkgITb21;
        "pkg-1.9.2.DEV-316" = _wku8sFW4;
        "pkg-1.9.2.DEV-317" = _JUe3s4VS;
        "pkg-1.10" = _fS53MnHl;
        "pkg-1.10.1.DEV-319" = _DrmW1PRU;
        "pkg-1.10.1.DEV-320" = _diGanZcS;
        "pkg-1.10.1" = _aMO1cT0T;
        "pkg-1.10.2.DEV-322" = _7QqFOH2m;
        "pkg-1.10.2" = _5j46R3ex;
        "pkg-1.10.3.DEV-324" = _B8JGVF9G;
        "pkg-1.10.3.DEV-325" = _LHqbmw6j;
        "pkg-1.10.3" = _SRGtQMhp;
        "pkg-1.11.DEV-328" = _IXugUGJz;
        "pkg-1.11.DEV-331" = _iBvyQXwG;
        "pkg-1.11.DEV-332" = _OSErKEHT;
        "pkg-1.11.333" = _7MAGj8yZ;
        "pkg-1.11.334" = _ypYpj99i;
        "pkg-1.11.335" = _qDqThXMn;
        "pkg-1.11.336" = _o0rAwEBJ;
        "pkg-1.11.337" = _vXPDNJdu;
        "pkg-1.11.339" = _OiBN8iPp;
        "pkg-1.11.340" = _6Q6zktKH;
        "pkg-1.11.341" = _i1X5dGyY;
        "pkg-1.11.1" = _IQsccXRI;
        "pkg-1.11.2.345" = _cp4aZmSx;
        "pkg-1.11.2.346" = _Xy7P3jB9;
        "pkg-1.11.2.347" = _xj6aiDdx;
        "pkg-1.11.2.348" = _yQ29nsSQ;
        "pkg-1.11.2.350" = _sQ4yp8R6;
        "pkg-1.11.2.352" = _TfAyHvz6;
        "pkg-1.11.2.353" = _aPQtCtaH;
        "pkg-1.11.2.354" = _fZe0vwut;
        "pkg-1.11.2" = _oxsjQAjt;
        "pkg-1.11.3.356" = _PAtZzyFp;
        "pkg-1.11.3.357" = _os9JgtY6;
        "pkg-1.11.3.359" = _TTXbj2Bv;
        "pkg-1.11.3.360" = _zPYaVf15;
        "pkg-1.11.3.361" = _UPAFxHys;
        "pkg-1.11.3.362" = _r0fwrubP;
        "pkg-1.11.3.367" = _45gP53S6;
        "pkg-1.11.3" = _EoaYTeBZ;
        "pkg-1.11.4.369" = _SoXLfbAv;
        "pkg-1.11.4.370" = _yyToI2ph;
        "pkg-1.11.4.371" = _a1QgmTr1;
        "pkg-1.11.4.372" = _VJuTlJem;
        "pkg-1.11.4.373" = _9RkPXPKI;
        "pkg-1.11.4.374" = _6eyrou7M;
        "pkg-1.11.4" = _PGYLJC92;
        "pkg-1.12.375" = _MbFMpkcs;
        "pkg-1.12.376" = _ARu3lA1l;
        "pkg-1.12.377" = _YNZ69cMi;
        "pkg-1.12.378" = _s25hFKO0;
        "pkg-1.12.379" = _Xdpzo02M;
        "pkg-1.12.380" = _Vp6EWr0P;
        "pkg-1.12.381" = _Lcw74viD;
        "pkg-1.12.382" = _O21dpiFg;
        "pkg-1.12.383" = _DzfsENmj;
        "pkg-1.12.384" = _QWivvGMQ;
        "pkg-1.12.385" = _jPZe9p4J;
        "pkg-1.12" = _Tfud3b0v;
        "pkg-1.12.1.386" = _s0Km9dqs;
        "pkg-1.12.1.387" = _IF7P7LIb;
        "pkg-1.12.1.388" = _u8Vs9b6d;
        "pkg-1.12.1.389" = _uo3avt7z;
        "pkg-1.12.1.390" = _RKNnbG4v;
        "pkg-1.12.1.391" = _e3HuQVYl;
        "pkg-1.12.1.392" = _DsBIq8N9;
        "pkg-1.12.1.393" = _oICZ7H71;
        "pkg-1.12.1.394" = _Zf7dugvj;
        "pkg-1.12.1.395" = _QXHhDVVD;
        "pkg-1.12.1.396" = _veVsCxY8;
        "pkg-1.12.1.399" = _KiBQVe2T;
        "pkg-1.12.1.400" = _Nkj09zR4;
        "pkg-1.12.1-SNAPSHOT-401" = _KvHRQQqK;
        "pkg-1.12.1" = _UrM83I7W;
        "pkg-1.12.2-SNAPSHOT-402" = _zi7LcxB1;
        "pkg-1.12.2-SNAPSHOT-403" = _s1FKRmt1;
        "pkg-1.12.2-SNAPSHOT-405" = _S5pZtmW1;
        "pkg-1.12.2-SNAPSHOT-406" = _V02PbdXQ;
        "pkg-1.12.2-SNAPSHOT-407" = _VbK3uLt1;
        "pkg-1.12.2-SNAPSHOT-408" = _JCDiGtXS;
        "pkg-1.12.2-SNAPSHOT-409" = _WrU2ShiK;
        "pkg-1.12.2-SNAPSHOT-410" = _3Y0aCEXN;
        "pkg-1.12.2-SNAPSHOT-411" = _r6A9MSdB;
        "pkg-1.12.2-SNAPSHOT-412" = _EvBDL6HB;
        "pkg-1.12.2-SNAPSHOT-413" = _SiNadOVZ;
        "pkg-1.12.2-SNAPSHOT-414" = _eK1HRzvd;
        "pkg-1.12.2-SNAPSHOT-415" = _xURAbRi0;
        "pkg-1.12.2-SNAPSHOT-416" = _D2Pmw5KY;
        "pkg-1.12.2" = _XQ4aopBc;
        "pkg-1.12.3-SNAPSHOT-417" = _bI6c66Uu;
        "pkg-1.12.3-SNAPSHOT-418" = _tNvs8NTL;
        "pkg-1.12.3-SNAPSHOT-419" = _b2IjAmaA;
        "pkg-1.12.3-SNAPSHOT-420" = _R5ayQ27T;
        "pkg-1.12.3-SNAPSHOT-421" = _NQnQy9GE;
        "pkg-1.12.3-SNAPSHOT-422" = _QzgdyRxX;
        "pkg-1.13.0-SNAPSHOT-423" = _nJpRK6gw;
        "pkg-1.13.0-SNAPSHOT-424" = _wtqbB8ix;
        "pkg-1.13.0-SNAPSHOT-425" = _dQOQljbz;
        "pkg-1.13.0" = _bJHMp01v;
        "pkg-1.13.1-SNAPSHOT-426" = _nJRocHBg;
        "pkg-1.13.1-SNAPSHOT-427" = _RmeZ9KwO;
        "pkg-1.13.1-SNAPSHOT-428" = _ALz7WOpg;
        "pkg-1.13.1" = _bapUeEBG;
        "pkg-1.13.2-SNAPSHOT-429" = _Fh2j3qMH;
        "pkg-1.13.2-SNAPSHOT-430" = _WaMPuxAu;
        "pkg-1.13.2" = _rEmtiEyW;
        "pkg-1.13.3-SNAPSHOT-431" = _U1eerxlh;
        "pkg-1.13.3-SNAPSHOT-432" = _w7rNhwda;
        "pkg-1.13.3-SNAPSHOT-433" = _SLn7DaEj;
        "pkg-1.13.3-SNAPSHOT-434" = _W0A7ZOin;
        "pkg-1.13.3-SNAPSHOT-435" = _uYGh7rLb;
        "pkg-1.13.3-SNAPSHOT-436" = _pmmtlerx;
        "pkg-1.14.0-SNAPSHOT-437" = _VOy2LJ71;
        "pkg-1.14.0-SNAPSHOT-438" = _wl9fJdzE;
        "pkg-1.14.0" = _LB6vwPTc;
        "pkg-1.14.1-SNAPSHOT-439" = _geKpZN0r;
        "pkg-1.14.1-SNAPSHOT-440" = _7n3E0ESG;
        "pkg-1.14.1" = _x2Tr1kby;
        "pkg-1.14.2-SNAPSHOT-441" = _sP4hkTRN;
        "pkg-2.0.0-SNAPSHOT-442" = _ushvjrk3;
        "pkg-2.0.0-SNAPSHOT-443" = _4PXdCzHM;
        "pkg-2.0.0-SNAPSHOT-444" = _5QCA61fA;
        "pkg-2.0.0" = _nSayADJA;
        "pkg-2.1.0-SNAPSHOT-445" = _NK95tcZU;
        "pkg-2.1.0-SNAPSHOT-446" = _2nAT2xoc;
        "pkg-2.1.0-SNAPSHOT-447" = _U03l6BIv;
        "pkg-2.1.0-SNAPSHOT-448" = _awh0s5EZ;
        "default" = _awh0s5EZ;
    });
