...
let
    ...
    in {
        ...
        "pkg-4.1.8" = _ghbPi9Ip;
        "pkg-4.1.9" = _49z5oNhq;
        "pkg-4.1.10" = _V0YI7Kqp;
        "pkg-4.1.11" = _OKaU8aWT;
        "pkg-4.1.12" = _E0dxPJOm;
        "pkg-5.0.0" = _7cXzIQ3O;
        "pkg-5.0.1" = _zflGmHMh;
        "pkg-5.0.2" = _hbzvqmTZ;
        "pkg-5.0.3" = _6swuflYo;
        ...
        "pkg-7.0.8" = _r5yMXPab;
        "pkg-7.0.9" = _Bb3QGp82;
        "pkg-7.0.10" = _bhyH9Pts;
        "pkg-7.0.11" = _9snOuvgf;
        "pkg-8.0.0" = _ws2bB946;
        "pkg-8.0.1" = _RYW3u1De;
        "pkg-8.0.2" = _EHLFYriS;
        "pkg-8.0.3" = _8UyVd0ni;
        "pkg-8.0.4" = _dGKW4dKR;
        "pkg-8.0.5" = _2Yz7cW01;
        "pkg-7.0.12" = _NZvngeGG;
        "pkg-6.0.11" = _dvkVwxka;
        "pkg-8.0.6" = _7MkyirJk;
        "pkg-7.0.13" = _TLlsXNj6;
        "pkg-8.0.7" = _oOxw6ErR;
        "pkg-8.0.8" = _ekzTcjQ2;
        "pkg-8.0.9" = _K0fiBvn9;
        "pkg-8.0.10" = _FcoesdMe;
        "pkg-8.0.11" = _34fKUWBB;
        "pkg-8.0.12" = _zdO3mNYM;
        "pkg-7.0.14" = _HlbDwsPk;
        "pkg-8.0.13" = _vaLLlM8E;
        "pkg-8.0.14" = _SXNR7ZW0;
        "pkg-7.0.15" = _tHDveaxK;
        "pkg-7.0.16" = _xnLznSfT;
        "pkg-8.0.15" = _RmimPYNS;
        "pkg-8.0.16" = _8421rqFF;
        "pkg-9.0.0" = _1GosqZDI;
        "pkg-9.0.1" = _ENJRRMyR;
        "pkg-9.0.2" = _3lO7DvnB;
        "pkg-9.0.3" = _mWekC3SL;
