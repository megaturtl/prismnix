...
let
    versions = (let
        ...
        _KJD8nTAZ = {
            "id" = "KJD8nTAZ";
            "file" = "PlasmoVoice-Paper-2.1.14.jar";
            "hash" = "sha512-ELNhFE0j+JQRw1FZSxHDSUjpUwsiQNfh9Q3LXbs3k8O1k0bGtS2+i7xkiq+bu49deZJpFeIuXI9AacwztBeydg==";
        };
        _28EcEYsd = {
            "id" = "28EcEYsd";
            "file" = "PlasmoVoice-BungeeCord-2.1.14.jar";
            "hash" = "sha512-VTYq++NUJkA15SOcXIRyGIAs+s/7b9Bgombyrr3RqaqIIHpjQ3JHsU7XpzHcGZ/HV5rdDSXDc4nAXFycnEDU8w==";
        };
        _XPIZBgyz = {
            "id" = "XPIZBgyz";
            "file" = "PlasmoVoice-Velocity-2.1.14.jar";
            "hash" = "sha512-HBoIrt3UswqXSa6TYlg5/OgTd8ZgePJ2HXnzSe3SsSALoQnbVfPoGHvIEc9f4Dqof+GwRqroIYtQb+kG0OGSuQ==";
        };
        _wRiW4NnR = {
            "id" = "wRiW4NnR";
            "file" = "plasmovoice-fabric-1.16.5-2.1.14.jar";
            "hash" = "sha512-cnsszXT858CYKc6xYzOLqQ3w1c+hkMeSJj+tx+Gp6OVhfd8rpiHziOU3QZ/fQXYTTd/BOc8mE82r1y+xzlww9Q==";
        };
        _tzzU8EzB = {
            "id" = "tzzU8EzB";
            "file" = "plasmovoice-forge-1.16.5-2.1.14.jar";
            "hash" = "sha512-MQAM0mq0PRQQQdBQWObl7DhuLCDNvpYuzadstQ/Cq7TswpnVguvHFKjkw/e8ndu+nTGW+/MZ1vxhRSj2EtJINQ==";
        };
        _AE2cxAc3 = {
            "id" = "AE2cxAc3";
            "file" = "plasmovoice-fabric-1.17.1-2.1.14.jar";
            "hash" = "sha512-U3De7jtZZ96BpXDOTR89Kh7YnrO5qKrNDlnz/mvTxFZLsGTmcI7xIgqakHOKVt7K8jE92NIv5QIUrmd5ImbtLg==";
        };
        _sFJgTrLB = {
            "id" = "sFJgTrLB";
            "file" = "plasmovoice-forge-1.17.1-2.1.14.jar";
            "hash" = "sha512-SxU2G0GzN8HRnV5/YqFfh4KKTP1EuDAJ6hALNQxbXYu4uwreFE9EK3f8nLo0IlgtvHfbZuz6iYGXc4DBG8SnbA==";
        };
        _kqGDlNSu = {
            "id" = "kqGDlNSu";
            "file" = "plasmovoice-fabric-1.18.2-2.1.14.jar";
            "hash" = "sha512-egyaGjNb+fov0WV66DAx56J7NhqyHVIEYsjzReLkNMI2wSA8J+8ZzrJp/N6MsckBoSFzou07CrH1lH8QoWh5bA==";
        };
        _v7nwsoPQ = {
            "id" = "v7nwsoPQ";
            "file" = "plasmovoice-forge-1.18.2-2.1.14.jar";
            "hash" = "sha512-XMHTxpsE+ZG/gVuPwgAObW0AzTCHBqn5h8pkBXELrSfq+tGLpl/qiztKyM7DJjJxLhVeDR8O7WPqz/YjW+48QA==";
        };
        _mR1hnwer = {
            "id" = "mR1hnwer";
            "file" = "plasmovoice-fabric-1.19.2-2.1.14.jar";
            "hash" = "sha512-LMpLvy6ko4HiDrUBReDWabgLl7KxlDKLMy3YExF4E5tbOqLTWBJq80FYMcYdEDfP2FoaLO6f+FRK9H4PnTr1uw==";
        };
        _29lvrSHv = {
            "id" = "29lvrSHv";
            "file" = "plasmovoice-forge-1.19.2-2.1.14.jar";
            "hash" = "sha512-jN718wZiKcgB04NHuYVBJ+b5D0U0McUhsYGdcDChJUzRLdTEMHWYf6R72EDdIr1RThoQCULR660r87smeIPxqQ==";
        };
        _3nLSUb13 = {
            "id" = "3nLSUb13";
            "file" = "plasmovoice-fabric-1.19.3-2.1.14.jar";
            "hash" = "sha512-37nF4pDUA9YNZj9Mj2f9DyoVS4/u9oYzILkOh9BoSOENdVV1MtX/KdzbIZPVRYS/63E88uAUZ0Qdz+yhtq5qiA==";
        };
        _25ftWLAV = {
            "id" = "25ftWLAV";
            "file" = "plasmovoice-forge-1.19.3-2.1.14.jar";
            "hash" = "sha512-bTboFnWJmUh67fOxWdqD/rMo8UPpTWwnvgte3tSgvpe6D2tnjb+DC497j5WlhhNr2KVcWMxQGkKMyV0GAeC/dg==";
        };
        _P53oUMXe = {
            "id" = "P53oUMXe";
            "file" = "plasmovoice-fabric-1.19.4-2.1.14.jar";
            "hash" = "sha512-5+k3VYOSn3TUefqA4V8Fo+4CKdKhZUfJ4Yx1COCQy4x+DEtz7XWJ2nQ60z6731wK4lTocIbhiot7MLJKkJvKFQ==";
        };
        _WHTX06Lj = {
            "id" = "WHTX06Lj";
            "file" = "plasmovoice-forge-1.19.4-2.1.14.jar";
            "hash" = "sha512-U4xpkY+9d1DSzls7yRW8hVZQ50pD4bn6FA+R8y2zPAORX5m6YRQXUOkVKisPchulw/bxL8hMGJ8OVrUGGSjizw==";
        };
        _iAE1giJO = {
            "id" = "iAE1giJO";
            "file" = "plasmovoice-fabric-1.20.1-2.1.14.jar";
            "hash" = "sha512-AsF8WpE+JFS5ElYglHDDQx1gYEubDyzGBEP0ZYCb332L5BC3RWDBY8KYEah75guIj/ITRkAu3Joi0bFANG9lCQ==";
        };
        _42KRvgDT = {
            "id" = "42KRvgDT";
            "file" = "plasmovoice-forge-1.20.1-2.1.14.jar";
            "hash" = "sha512-HbbFOefSignZFfRGvdw/aiU5KrHFfk7dL1yPaBfYzzQ58+fRfEjZOb+b7nn0ADWlofZ9r8kCTKY/E1+KOm8Ldw==";
        };
        _wSSG58we = {
            "id" = "wSSG58we";
            "file" = "plasmovoice-fabric-1.20.4-2.1.14.jar";
            "hash" = "sha512-w4JfMUYIs53fQ1uxb30AZMwP9Ow+9RaY2T/WzlOllW5Npn5G1XJeRtxnd7p5DoEsp6glusyxhutzRQvtkoRjsw==";
        };
        _rNKWUXSS = {
            "id" = "rNKWUXSS";
            "file" = "plasmovoice-forge-1.20.4-2.1.14.jar";
            "hash" = "sha512-5NIwge+7HZC+I0T0kSb8/HRGJGehm4UE1CSEnMrFz4eS1sDi8CCfn4RUk85sOKjQNlhQvt0BNqFoji0yMDbMww==";
        };
        _xClPuKir = {
            "id" = "xClPuKir";
            "file" = "plasmovoice-fabric-1.21.1-2.1.14.jar";
            "hash" = "sha512-zAVMF4gFtrO+RYEZ7upEvSo5ApH9YuTgt6DbjU2tv9jjDT9+3WDhZojXmHzO5inL6qfngBxYqzxq6aiS0LRu6Q==";
        };
        _LzBZEz79 = {
            "id" = "LzBZEz79";
            "file" = "plasmovoice-forge-1.21.1-2.1.14.jar";
            "hash" = "sha512-cP/EosfHw6TKtMNfnGk4yNZYqD6XzxHOz9O95pC+YnHY0J8YFOxZvrYf0OU3IdJu7VU8EucqWI6WM9u/EcdaSA==";
        };
        _iqRDCQnJ = {
            "id" = "iqRDCQnJ";
            "file" = "plasmovoice-neoforge-1.21.1-2.1.14.jar";
            "hash" = "sha512-9hYEMdOEt4u/pnXLFd/OpSddIN0dYpqWKXOqNf2Y2rj74nr6iwr/+fJ27IfXFWAZ833QNr015JmkidQfSds2ow==";
        };
        _RdWIzDp3 = {
            "id" = "RdWIzDp3";
            "file" = "plasmovoice-fabric-1.21.4-2.1.14.jar";
            "hash" = "sha512-nhnsTVgbEM43DeP3wii1s3xJpuFAE365dCuh/82dBZDdLjMqY8H8Fhk9vOwHVqitthG0pehxFb/7/kAVb+Z2dg==";
        };
        _dH3F1c8o = {
            "id" = "dH3F1c8o";
            "file" = "plasmovoice-neoforge-1.21.4-2.1.14.jar";
            "hash" = "sha512-ma0YNiN24yeAwKnlHxT9Q3R67Ni2KXcpWdamdoKk5xfRrg++o6oMGn0tPWk+WjncnRyz2z0/bi+f8W0Y4tIzZQ==";
        };
        _1c2kfg5y = {
            "id" = "1c2kfg5y";
            "file" = "plasmovoice-fabric-1.21.6-2.1.14.jar";
            "hash" = "sha512-dIjW9IyVWDqJz4xY5WwJJWpZpUjYiEs4y0bs3qhRUZqvg3vCMmlmS9lVAHmYxpyoLmmapJfk4muo+M3hxfjpfg==";
        };
        _u2OSUbY5 = {
            "id" = "u2OSUbY5";
            "file" = "plasmovoice-neoforge-1.21.6-2.1.14.jar";
            "hash" = "sha512-1FWOo3VexWTr/A2hzIxle0xcPZ61OhVNQCbO4wyg5NbdGBIf+f6RzemCX8c/0gcOVb3Tzv+ZsecjHk3W8Pc+ug==";
        };
        _G5FRe7on = {
            "id" = "G5FRe7on";
            "file" = "plasmovoice-neoforge-1.21.7-2.1.14.jar";
            "hash" = "sha512-ZtbLzdtr9GdQCrOzaf0qChmTB2tWROk2KcumRozgdRvcWVKwYQzXwU1pRKM911aCKAYGEyN8BdnyWgj8P6VwMg==";
        };
        _hk5FJncK = {
            "id" = "hk5FJncK";
            "file" = "plasmovoice-fabric-1.21.11-2.1.14.jar";
            "hash" = "sha512-jxOD5viXGXHMBHuEXCRn2SMgnimIc62e9Km0Kt15XEDFVWtH6Qp1EFc4MTxePE6w+wCmxxIYJVNVtXN9GKwi/w==";
        };
        _KofFjmN9 = {
            "id" = "KofFjmN9";
            "file" = "plasmovoice-neoforge-1.21.11-2.1.14.jar";
            "hash" = "sha512-QI2QaL1XABkOWvrlfoAKjcDyJkWND3Qoy93Hp3Eyt6ppdoZb/hDvd0Kv8xSAUmu90mFdmlcLojHGWed2gr15SQ==";
        };
        _91nSPr0m = {
            "id" = "91nSPr0m";
            "file" = "plasmovoice-fabric-26.1-2.1.14.jar";
            "hash" = "sha512-+v4UQpwE6QilupDdTya1SczsE2LnVftdl1LpkT8+nlC+Tki/dTH9c0lPKHazHbpi1GO18QVwTiXvjaXg+uGgjw==";
        };
        _SBrE7yag = {
            "id" = "SBrE7yag";
            "file" = "plasmovoice-neoforge-26.1-2.1.14.jar";
            "hash" = "sha512-P0+ctomDO/3PwvOLjNbH3wmpxih1cJPZffzs0r/q9V3pVA64LDwd1y1g07RcfSuFcYyVHlbMzP3pWHrGkshMAQ==";
        };
        _Yl9Ihcy7 = {
            "id" = "Yl9Ihcy7";
            "file" = "plasmovoice-fabric-26.2-2.1.14.jar";
            "hash" = "sha512-2KBwByK8e3PBIrbLbH9KaNjRKuLT/o/n3OVNoR8QupY9HZO7suoPkykpqQ2JePnVdQQ19wGCR1n+s+S2ZANOlQ==";
        };
        _MysrqwIr = {
            "id" = "MysrqwIr";
            "file" = "plasmovoice-neoforge-26.2-2.1.14.jar";
            "hash" = "sha512-Ji5sgCJUqeZK5PoUQJaOelRLvHthwthDCwpEW8INDQDUpGrHg1gbEGuOvEJdUqX6zFZb15Nm/6rzrDu64mJm1g==";
        };
        _bj9hL35f = {
            "id" = "bj9hL35f";
            "file" = "PlasmoVoice-Paper-2.1.15.jar";
            "hash" = "sha512-cmzqoa8ZxUAeKF39+4fx7nDa4JVxPjCMczxB73MaCjU6RG/U9pmUaZZD4wUip2U0j+m/llCneGdTU8qoHXN8HQ==";
        };
        _ZuM68NFv = {
            "id" = "ZuM68NFv";
            "file" = "PlasmoVoice-BungeeCord-2.1.15.jar";
            "hash" = "sha512-XEfd82JbrAOSZ06tT+KtKYF21eMMOvkO+QPJLA8RitZwqpiLYcqZRBE9V0k6qhYEHhZWzrvter0VdrOo/VCGXw==";
        };
        _ITaGfo8d = {
            "id" = "ITaGfo8d";
            "file" = "PlasmoVoice-Velocity-2.1.15.jar";
            "hash" = "sha512-WvW8+4b3LYFp/ZWIQizmQOGMtzNrVfkBdDl/kYxIFgd1D/IttQ6X1mPDX6BoFxtfV9Q7nRpraQh9DAtpWk8Zjg==";
        };
        _bWySdM3F = {
            "id" = "bWySdM3F";
            "file" = "plasmovoice-fabric-1.16.5-2.1.15.jar";
            "hash" = "sha512-JGo+JySVi0F5gSDqJjPKe6v4w8Qktx3jnUlotxPD3+JZ7BePiFVHaM4bCHYcNBNQNTYygLckUtSSDkJpwjIC9A==";
        };
        _erXORs0C = {
            "id" = "erXORs0C";
            "file" = "plasmovoice-forge-1.16.5-2.1.15.jar";
            "hash" = "sha512-AB4jr74GY7mOuT+vUNKZADRgrT3JKOZR7ByTF9GmADqbJ6Eg3mYUogWV1iItfVBJRiThwlg6m/u8QTI7LwHLSA==";
        };
        _aRFfBL12 = {
            "id" = "aRFfBL12";
            "file" = "plasmovoice-fabric-1.17.1-2.1.15.jar";
            "hash" = "sha512-JjTZgiLhj1p121Xp7S5tbNnskh2s31nJZNZnkVUwnc7/M9KCuRYabzfUO509MhOognrI8r7YdUsDLNa50dZ1Kg==";
        };
        _edOKResC = {
            "id" = "edOKResC";
            "file" = "plasmovoice-forge-1.17.1-2.1.15.jar";
            "hash" = "sha512-wJQOGkrrxxoY/LFBiEtqfyLlpl9u8avbh0JSjXALcxOt023UQbzJnFkLTlYXil1A6L68iZRonRb5yB7fzfC+5w==";
        };
        _4VveJs6B = {
            "id" = "4VveJs6B";
            "file" = "plasmovoice-fabric-1.18.2-2.1.15.jar";
            "hash" = "sha512-LxI6kB5DEY1NmbqGQlZZQQ8P1FQK38mhVdY56eAOSsj9xpN44vIcpQevyA5cn322W9NwQkiYsFwh9V30AdeyFg==";
        };
        _GPqTAiUq = {
            "id" = "GPqTAiUq";
            "file" = "plasmovoice-forge-1.18.2-2.1.15.jar";
            "hash" = "sha512-D7G+ibRRfRpzbNEoZNY82wqSbLdIM7O/RH0pkhslSFRKjezx+CAQx4g4U5EmO55CmZpPq/2JmUkHyLYzd0zuSw==";
        };
        _BMOOX8vT = {
            "id" = "BMOOX8vT";
            "file" = "plasmovoice-fabric-1.19.2-2.1.15.jar";
            "hash" = "sha512-XmtVWhUd7lYpYZZxK5laWpPMHewFngO+1/W8xcUwmJxeGKekExOFX2zOYJ/Uw/BN+pRPWSPk9x6/IO1TafIcAg==";
        };
        _NNfNFU3s = {
            "id" = "NNfNFU3s";
            "file" = "plasmovoice-forge-1.19.2-2.1.15.jar";
            "hash" = "sha512-S7kJK0vom2yoPhAkuQIzLDbBkQ9tKNhZUr/YL3zckDbOB5oZ93hAg3rtOCfeVBmATkTWy+xjM4mRgGFqappbRQ==";
        };
        _XUiPg8Qs = {
            "id" = "XUiPg8Qs";
            "file" = "plasmovoice-fabric-1.19.3-2.1.15.jar";
            "hash" = "sha512-tESK8Fb0ddsbLZmxP5TyQj7j9PqnCcBuXs5gp0jSpqWOeOgjTBSS8j1J0KYvN7XfhmCCxBK024aDIBrQKLam9Q==";
        };
        _jQLD26Mw = {
            "id" = "jQLD26Mw";
            "file" = "plasmovoice-forge-1.19.3-2.1.15.jar";
            "hash" = "sha512-IJWfj4fWbk/ZT97BQfc9ZslssXC3Ji/x8MlfgeU5UJjEU3p6vq+B25TtZuSf+UAbAjscQWNPmXXltrDCFm6byA==";
        };
        _DHO48gFs = {
            "id" = "DHO48gFs";
            "file" = "plasmovoice-fabric-1.19.4-2.1.15.jar";
            "hash" = "sha512-4WH3O3PJwwMZgfnmeoD1w5czY+OJ+yhLegKXWyZJyheTiS0oiFjNiZapHoVRxJYtsQIWHEKsjtz1VLC6PXqpow==";
        };
        _6GYjV2O8 = {
            "id" = "6GYjV2O8";
            "file" = "plasmovoice-forge-1.19.4-2.1.15.jar";
            "hash" = "sha512-z1QBhU8iIVfKTMHLNekHMo+H5iOfoStpG+iLt2Zmqgogzt23Qr6MRDFAX2U2hN6ts/nE5SpcPQfKP59xZDcFig==";
        };
        _9IP2ZuLR = {
            "id" = "9IP2ZuLR";
            "file" = "plasmovoice-fabric-1.20.1-2.1.15.jar";
            "hash" = "sha512-TI47oMkMsMI6a8pTp18P/wzXgabZa6FwsHWMPXbCRbWByFyGgKtBCKiVApllqnE+oAzllUul3lT+riXjU4RtzA==";
        };
        _PilOaFGj = {
            "id" = "PilOaFGj";
            "file" = "plasmovoice-forge-1.20.1-2.1.15.jar";
            "hash" = "sha512-u8/seqLmGoSx8ie7w8RQccXvDskNHrPP6/aK+3mNDg5tvh4ApldJECJ09MoaU27p8bk3Uz4+FQI4yHOyyjtavQ==";
        };
        _A4Vxj7G6 = {
            "id" = "A4Vxj7G6";
            "file" = "plasmovoice-fabric-1.20.4-2.1.15.jar";
            "hash" = "sha512-BrKEjvQg1FEzVyuwgBEq6elhLS4EB9DJ9HaVtXuP+OrELyvZNAI/JdPIuArOUXGj3FBe/3jggg0i7TBqObXmSw==";
        };
        _ynOVDR1M = {
            "id" = "ynOVDR1M";
            "file" = "plasmovoice-forge-1.20.4-2.1.15.jar";
            "hash" = "sha512-d82xCs1MfzoPpBvFlErwPrUJEjly2gcHOy2ELBV3TH+8GPisT40cNngqfMSKBLyETLsIg8LGsmIk4XEbi5jT5A==";
        };
        _mUYm8WtG = {
            "id" = "mUYm8WtG";
            "file" = "plasmovoice-fabric-1.21.1-2.1.15.jar";
            "hash" = "sha512-S9lX66tUtHZa1e16dgma0BILhyaJEt0po28vlOYn4a1b3oT7fQYPixpUMFjfiXY01mhWVKmlVxA29jrRv5hwYw==";
        };
        _Jtf457xT = {
            "id" = "Jtf457xT";
            "file" = "plasmovoice-forge-1.21.1-2.1.15.jar";
            "hash" = "sha512-IW8GGdYyX//Meg04frBMhvEzm3eyT7md9wxtJPob1n2TRM2Pa7WywDgoC4/DjAEw73wwkArZS9Ub9SmHSz5GNQ==";
        };
        _c5AsOWDn = {
            "id" = "c5AsOWDn";
            "file" = "plasmovoice-neoforge-1.21.1-2.1.15.jar";
            "hash" = "sha512-AG72pEGUcf4lecsGuAu06xVG5oONEZ6TObu+XRZPQXSOtu6m+qTUfCVlRGnEWd4+20xE9JUST4E/r/nsQa64Pg==";
        };
        _pAEVbuUE = {
            "id" = "pAEVbuUE";
            "file" = "plasmovoice-fabric-1.21.4-2.1.15.jar";
            "hash" = "sha512-qbStBh67pa+q0/5k2bznNy8iuJggesoi8nKDJVvCPW1JvLkwIbW900+KLMMMBLe8cvbh1GcYDrZRFVGEtNRIdQ==";
        };
        _xOrQKg3v = {
            "id" = "xOrQKg3v";
            "file" = "plasmovoice-neoforge-1.21.4-2.1.15.jar";
            "hash" = "sha512-fIO4/0nXMygDzPhknoysy+Z1c0Pb+tAwPzqQXot/9+1OZPv19d3ib168bR9nlh0cyGFoCKtc1jGJJ7qVpyywgg==";
        };
        _ThTacY6v = {
            "id" = "ThTacY6v";
            "file" = "plasmovoice-fabric-1.21.6-2.1.15.jar";
            "hash" = "sha512-JCIdVhZOdEfwhA8qiXjk75a6QqBqc77j0/a40GKRfgunk5ukuoPkO5vnqZK24haTCW2zya4Mogkbzkr8jF+iwA==";
        };
        _EUIYFwX1 = {
            "id" = "EUIYFwX1";
            "file" = "plasmovoice-neoforge-1.21.6-2.1.15.jar";
            "hash" = "sha512-aFPj+7m46Y4yjoOP5s+pQXdP5/szApU5zKqv2eTcNfaV1vlQeDQdJKgVNwCta6M2aVuSEWa59tN6NyApvdjwGw==";
        };
        _YbxhowCB = {
            "id" = "YbxhowCB";
            "file" = "plasmovoice-neoforge-1.21.7-2.1.15.jar";
            "hash" = "sha512-gPPny4gpr4V7+VySu7d74Yc1z0n1Wd2gGoBcqwds1amGwYNGmnO7+4QXxrzVcUlkhkrPVeAqPwz/tHQQmh7WQQ==";
        };
        _wdPwqY6d = {
            "id" = "wdPwqY6d";
            "file" = "plasmovoice-fabric-1.21.11-2.1.15.jar";
            "hash" = "sha512-OYcXLINF1qEeB8rKwcAAS5aiHiND4GHQjv/4VVXOIQAy6h/hIrRPqXRH6YUpy7AL+xwJkPFCPoky4y7mVF1cBg==";
        };
        _8Qlk9FFo = {
            "id" = "8Qlk9FFo";
            "file" = "plasmovoice-neoforge-1.21.11-2.1.15.jar";
            "hash" = "sha512-up851bb3FKXDDckcNQ399hnxBqal9JVevEA/0m0yyfVRWgNAXrSyK4g8F3rh3fgkE2sZ0KNvvK7cWU1TqPJ+NA==";
        };
        _SUneHxyL = {
            "id" = "SUneHxyL";
            "file" = "plasmovoice-fabric-26.1-2.1.15.jar";
            "hash" = "sha512-SmTdDNzADo3gQ9Tq99nG4g9JduoXBoygGHvDBOm0Lk+wasUe1+v2+si2I/efABICeAzBgO6YNCK06HM5OcVV/w==";
        };
        _7ISGzuHZ = {
            "id" = "7ISGzuHZ";
            "file" = "plasmovoice-neoforge-26.1-2.1.15.jar";
            "hash" = "sha512-yQCoEHmfBmTFt6Juus0ppxNcqdVtcg9Gw5qf6xq1Hj0RvDVLeRqEXQDl2WJQdxD2hdKinvQdOe8wF2LR+3Fxsw==";
        };
        _fyTfip1f = {
            "id" = "fyTfip1f";
            "file" = "plasmovoice-fabric-26.2-2.1.15.jar";
            "hash" = "sha512-Rcg0JGgOEwDIMlXU8h6rD40Gjx2agUaUBCn2Dczq42IB8f0qbPHWM1aH8uSz7yS2a2fZo20+n8nR4GLgzjo5YQ==";
        };
        _mAAkrTAY = {
            "id" = "mAAkrTAY";
            "file" = "plasmovoice-neoforge-26.2-2.1.15.jar";
            "hash" = "sha512-2jv1B0tW8MmN00Zn8pN/+yS8ZTj2LnzIDumrKx7Am38aIJ5c10G+PerV6xH04PjA0IGXJbNKMWJJ1BTzE4Yflg==";
        };
        _YnC4RoiW = {
            "id" = "YnC4RoiW";
            "file" = "PlasmoVoice-Paper-2.1.16.jar";
            "hash" = "sha512-VzbFzEwfhwZAU3MRJhFjUpr1iiq3/Klxg2vqdyEt8S3Kim+are6/Ns5BCruiUGM3hY0xw8sOdqHJ4k2hbG48yA==";
        };
        _bV5M16rm = {
            "id" = "bV5M16rm";
            "file" = "PlasmoVoice-BungeeCord-2.1.16.jar";
            "hash" = "sha512-RKDneu2DpFHke4dP1BKDrXDYQCblBkayPdVvAzFl2bh2qWGgzyGnjBgURbYPMKHJ3S1UUtCErnXqgwLB/xhgBQ==";
        };
        _yhqObhdn = {
            "id" = "yhqObhdn";
            "file" = "PlasmoVoice-Velocity-2.1.16.jar";
            "hash" = "sha512-kV7maFFvF6uWEayWqQxd3u0/0UGcnoFVY5te/Ytu/2Fu+BW+CLpbJedsCi3+bwUSnNros3Ch9fnbGdl/Xa2u2A==";
        };
        _d5Vq7GSV = {
            "id" = "d5Vq7GSV";
            "file" = "plasmovoice-fabric-1.16.5-2.1.16.jar";
            "hash" = "sha512-XZqv3FqLpIWiMZAvdW3q9chJeBJldT4BQ7EREOFkKB9ahUTOCO2lRxH2RZWcSZe1N83YWb3vKA+Hsm806g6Mhw==";
        };
        _YiBCQScq = {
            "id" = "YiBCQScq";
            "file" = "plasmovoice-forge-1.16.5-2.1.16.jar";
            "hash" = "sha512-5RSxXvEXj/DucJ0tVEl24kVX3CYgP1pkUjj97KRKMO59ezbokd56++EQzajgpk7p8QlhAhhxCGwS1NZNQfxeeg==";
        };
        _BwNfJoyR = {
            "id" = "BwNfJoyR";
            "file" = "plasmovoice-fabric-1.17.1-2.1.16.jar";
            "hash" = "sha512-cD34gSz2e6fw/0CZog3gSxgXsHZY+dN+3WDXV1+9IDl1BG0twCDdZAe/P7DYP1gXYyE7/rVVrGKQBVmmHZ7iRw==";
        };
        _cVpdCT2c = {
            "id" = "cVpdCT2c";
            "file" = "plasmovoice-forge-1.17.1-2.1.16.jar";
            "hash" = "sha512-Cz+MxKz8JF0gymW2UtpdBVDfjtRfLkh4y+e0ZHFi7xO+nF+r6MYm3etjihjDlB7xreq6l3oU6pHm7oqTXStokg==";
        };
        _4UeRfXob = {
            "id" = "4UeRfXob";
            "file" = "plasmovoice-fabric-1.18.2-2.1.16.jar";
            "hash" = "sha512-IozdbXhdsWcFr3ixLjttQYO6u4MK0xwVB/pMquMhx7n6cjw30R0JiFfnmG3kf8nU3tJRfgWSExzw03JS/3ucYw==";
        };
        _j5R8B4pJ = {
            "id" = "j5R8B4pJ";
            "file" = "plasmovoice-forge-1.18.2-2.1.16.jar";
            "hash" = "sha512-bxbeiQObRdU0e9dngzZ6qZ6gpNwRoCTTKlIllQiQLhHyPjfNCJ2A2BbZUcB90jAEXgXhbx7rH26PTZmStyguaA==";
        };
        _3YFYlhdI = {
            "id" = "3YFYlhdI";
            "file" = "plasmovoice-fabric-1.19.2-2.1.16.jar";
            "hash" = "sha512-goM2/U3uAIYzGdPL1ak6u1+82dqW1eO95kEffj8qJaH/3AHqIxXld/9F8dZ02HSLwGuQuXIku7yb8riFYuwvaA==";
        };
        _LszICBuk = {
            "id" = "LszICBuk";
            "file" = "plasmovoice-forge-1.19.2-2.1.16.jar";
            "hash" = "sha512-MLa94R4AqWDC590QwWJVt667NWo+QxJp/BNmTJ7SQmaV7YLW4lls1Oh3z/0XOBsNqSibrX1tez5SzVovPdCSXw==";
        };
        _yWKD7lxE = {
            "id" = "yWKD7lxE";
            "file" = "plasmovoice-fabric-1.19.3-2.1.16.jar";
            "hash" = "sha512-KBWkgMIGCrMfDlXCasL3/eyQi+Yfhy8aATXVIVlRmh42WRm90CqwjVQlroruBzbP0JXQEs5mW+GqBehC3o3OCg==";
        };
        _SSWUGmzC = {
            "id" = "SSWUGmzC";
            "file" = "plasmovoice-forge-1.19.3-2.1.16.jar";
            "hash" = "sha512-ZiK46WWezkSSYH7S4ZjzauNgp7Soxm6bDHEYTiO/UZ/gHIHr59Gq/MiRX4z3tFeWGMbROyJrWmWiLOPmTLPC9w==";
        };
        _fBptF4bl = {
            "id" = "fBptF4bl";
            "file" = "plasmovoice-fabric-1.19.4-2.1.16.jar";
            "hash" = "sha512-MxmyAIG8BCdlaoUkkIlvAOc8g+JKBZuEom6slcDuEfrSWPW4H+j0d47DHUwDELUIm20bYh2S0waCXYaNMNMZ4g==";
        };
        _dCB1vtKG = {
            "id" = "dCB1vtKG";
            "file" = "plasmovoice-forge-1.19.4-2.1.16.jar";
            "hash" = "sha512-7/YG+5jk238m8NkaUhcrxzxVEXFQqpBk7qpFFTLXcsBORAv4uPXvT5ICvXR7vBSO/awbrSDWh9MWyf/FJoQgDw==";
        };
        _LaqosLyL = {
            "id" = "LaqosLyL";
            "file" = "plasmovoice-fabric-1.20.1-2.1.16.jar";
            "hash" = "sha512-oPMFWoWO8w8DoiUzpq6A0rwjspSg0N6JOcwM5tRDCw6LV4fcXOgC8QnOCjZQRmu4ZtWrbsksE82gu5c5YzTQ5Q==";
        };
        _xEF4ahI1 = {
            "id" = "xEF4ahI1";
            "file" = "plasmovoice-forge-1.20.1-2.1.16.jar";
            "hash" = "sha512-Pg/EnhtdwLHzGUdGJnShBL3oiIAGQ7R/B6j4YMUlfbfqAhM46kkuikucurhDnfZILTCGcUXDxSoubCphPvuHTA==";
        };
        _7rR9vGWu = {
            "id" = "7rR9vGWu";
            "file" = "plasmovoice-fabric-1.20.4-2.1.16.jar";
            "hash" = "sha512-Vi/Ca2TperqtfYwqAVjiwb7TClF8S59d4tpRXPci9291/7TZwGIAtPLrlB4I/wgArWPk7XuSbE/DcfJMEDiBuA==";
        };
        _OVpcr8sH = {
            "id" = "OVpcr8sH";
            "file" = "plasmovoice-forge-1.20.4-2.1.16.jar";
            "hash" = "sha512-hDkELj9LNgCG1jIrZ8y31F6omTP85eYtcN69Gj1KGP2AX7WWtN0lv8d23BlFN9jTEKtNARhaspuA7I+/YMZxEw==";
        };
        _ooF8VCUr = {
            "id" = "ooF8VCUr";
            "file" = "plasmovoice-fabric-1.21.1-2.1.16.jar";
            "hash" = "sha512-xkTw8cNtW3UbZ4U83c8KMI3WESM3Hv1/udwRtK5Yg4slLrxxJkBvdWgPzOSV0tlGqzjbyYsKozOwT08YiSzjIg==";
        };
        _4RTbfv5W = {
            "id" = "4RTbfv5W";
            "file" = "plasmovoice-forge-1.21.1-2.1.16.jar";
            "hash" = "sha512-FyzipsJVcCzFVla9JQ8Blcr8nCFIVX2vXIKKesJyAf28Kqqvvny2ZvqzCwfbsW+rp4lk6xcNGN84o6CuYWZOeQ==";
        };
        _zMpeWebP = {
            "id" = "zMpeWebP";
            "file" = "plasmovoice-neoforge-1.21.1-2.1.16.jar";
            "hash" = "sha512-D3QYZaXMXhJZEq9+xukZwjgo2norHVon4r1QCxpm0tNU72wu4tS+UB3pWj5nEsJMo4H1xVRmrVGb9zdnqWJnSQ==";
        };
        _HZce3iub = {
            "id" = "HZce3iub";
            "file" = "plasmovoice-fabric-1.21.4-2.1.16.jar";
            "hash" = "sha512-U+ErTJ8oYhDTBFG3gwKAKkPpo4t+w4Y53ylkZ9OzQFgOIL3f+mfwApd/A8wPFo1P/4EZ/p+u3o0ExOTwfSL7Aw==";
        };
        _X94OfJee = {
            "id" = "X94OfJee";
            "file" = "plasmovoice-neoforge-1.21.4-2.1.16.jar";
            "hash" = "sha512-gpp7SHu15lHO84rwXm5eBsxhG7Q/gZ1eBr/U3uM7ecIHjAuy86yAJ6aRFRCmhzubPAcz6tR3cVCuYY9TIO0UKg==";
        };
        _BNGudqPQ = {
            "id" = "BNGudqPQ";
            "file" = "plasmovoice-fabric-1.21.6-2.1.16.jar";
            "hash" = "sha512-yILCMiCqcMvaRCw+uS4DJsEdGT/6Pn9zDqtKnDNQPKf5Ju8T0LYltvy7bmED7uYdjmehvMLl8QFHa2Ml8RO8xw==";
        };
        _3hJBCtvh = {
            "id" = "3hJBCtvh";
            "file" = "plasmovoice-neoforge-1.21.6-2.1.16.jar";
            "hash" = "sha512-Vb5Evj/kfshr4UJLTBEQ8+E+Lap/a06CCBmO5/72yzk4CMSM1gkyDFOsygUaeck8o6aX61l3c42vcHUg8L3VGQ==";
        };
        _Jm8d2JVF = {
            "id" = "Jm8d2JVF";
            "file" = "plasmovoice-neoforge-1.21.7-2.1.16.jar";
            "hash" = "sha512-jX79GvOze1T6gshG8xcl92Hvkw90Nr60JiC37NSKgPfWgcCp94CUBnFlj5kF3a7cBCBn2Rdfnxa1KNXoR4UE/g==";
        };
        _RgGsgKhS = {
            "id" = "RgGsgKhS";
            "file" = "plasmovoice-fabric-1.21.11-2.1.16.jar";
            "hash" = "sha512-jNEuyExrx7VkGulwKhAKkMGy7UNF0/Q3VTVI5Wur7WFQ62Ir/pNmSPZYmRaxd1TLV9WJPGfZ9oEED7XTkjbvsA==";
        };
        _FWwLJCVL = {
            "id" = "FWwLJCVL";
            "file" = "plasmovoice-neoforge-1.21.11-2.1.16.jar";
            "hash" = "sha512-wYma8IdYa4ODUBIdH1sPL4hBQp/a2HMQbyebORqVWW2ndrGWZPca5w+A1ZGPGfW8leTTISg8A6PPSqIdqiSPgQ==";
        };
        _VShrR3w9 = {
            "id" = "VShrR3w9";
            "file" = "plasmovoice-fabric-26.1-2.1.16.jar";
            "hash" = "sha512-G33DqEBoRgryp06L8VxFu2aLmnjseac9MOBVyJZYLtmxaPbpAi0yyL0hEpj+I2iEfR9gb9ctCYQCBBQH8Qx08w==";
        };
        _rZSt1qmN = {
            "id" = "rZSt1qmN";
            "file" = "plasmovoice-neoforge-26.1-2.1.16.jar";
            "hash" = "sha512-NEsj18uOfDQ/LedR2xKdtSclg6YEMHCk2YhZRIS7x1DS918M9qEA/8is0dgnBC7bO5qCk+FlUHiM1PUfb3B4Dw==";
        };
        _I0T9OQcy = {
            "id" = "I0T9OQcy";
            "file" = "plasmovoice-fabric-26.2-2.1.16.jar";
            "hash" = "sha512-QHYAttbRb4ghbdoHE48z7R0V+bDPGOeR6FyaTbiaPQ9VPDuC3Ulj0yq63v42iQbw/R2qbF1CrcmpCzont7zdWQ==";
        };
        _Y3SygC4h = {
            "id" = "Y3SygC4h";
            "file" = "plasmovoice-neoforge-26.2-2.1.16.jar";
            "hash" = "sha512-botX7LByjFK2ZH2a/10ZaqpQuakUgMaVqkF7c7GuoopLYZy2cZT3t27rPV9+M2E6D8uoy4OBdd+8Lqb7GNS7Zg==";
        };
        _DySKquus = {
            "id" = "DySKquus";
            "file" = "PlasmoVoice-Paper-2.1.17.jar";
            "hash" = "sha512-2eIehuUkVIM/bCLn8gJoxYX13d4+jXjtZIBmiu1HjgIdTpcmuvHVbnVcQliFQD4BHx20NLOuEEn52u18DaNAFA==";
        };
        _44fnPRkZ = {
            "id" = "44fnPRkZ";
            "file" = "PlasmoVoice-BungeeCord-2.1.17.jar";
            "hash" = "sha512-PKK95TNok0hyDL0axVDciJ4ty92aY5VUnVUWI8pv3Bmg6P5XzKrBTMTYJrmqCEvtUgZvGlOy3rNCmZ4H6vGbrw==";
        };
        _Zh4xxdjc = {
            "id" = "Zh4xxdjc";
            "file" = "PlasmoVoice-Velocity-2.1.17.jar";
            "hash" = "sha512-XayOaUBIMEAJtdHje9em2HjSlLv6TlZb/4WsoR+YWXYLSj+bwL1DET5HEQb9k9D5JfxztzNy07/nDhPjv/V+FA==";
        };
        _gEu4XS1L = {
            "id" = "gEu4XS1L";
            "file" = "plasmovoice-fabric-1.16.5-2.1.17.jar";
            "hash" = "sha512-WpW6cYwswwRgOcSGRqD3rgxD/AVFQFF796mX7suk4Zh2/6KLwiCQ6KKjOugbgktFcgwUCACKjVpq3fQyQQxvvQ==";
        };
        _sVbz4VTK = {
            "id" = "sVbz4VTK";
            "file" = "plasmovoice-forge-1.16.5-2.1.17.jar";
            "hash" = "sha512-jkrVZZU+NTbZgxNXf3/d8jOFzTHTugZ5WAgFUDeSG18nuI6UeJyF6lj0hC9tTbZBa8wifUsnjpfAI4VnO6xN4g==";
        };
        _fHEQPw5a = {
            "id" = "fHEQPw5a";
            "file" = "plasmovoice-fabric-1.17.1-2.1.17.jar";
            "hash" = "sha512-ZbvRJ18WzY9L52nWpNZx1z5FyYTS1vdo04hUY/p4eYkWyfuYgrvGXCqqWloAGIOobJtKVLJOpgkPWTjqvIM3og==";
        };
        _bHsbPNxp = {
            "id" = "bHsbPNxp";
            "file" = "plasmovoice-forge-1.17.1-2.1.17.jar";
            "hash" = "sha512-z2TWBeAAJAdBGGiIW9pgXJYfhTfIWI+UtJ6PkZJr0hxI8t094YxYdFAyHNjmJ/VZe/lkgzRfO8xK2XmPQAlZAg==";
        };
        _wwrYyVoj = {
            "id" = "wwrYyVoj";
            "file" = "plasmovoice-fabric-1.18.2-2.1.17.jar";
            "hash" = "sha512-vVWdAjzpCWyj9g8Oik0f04uC0TsFMYEXLm0km6xAOm2u8PkMF+I2lczNMqG4hXRxw2dJvgUudj8e3pcKVArE4g==";
        };
        _agUvymvl = {
            "id" = "agUvymvl";
            "file" = "plasmovoice-forge-1.18.2-2.1.17.jar";
            "hash" = "sha512-P5+X8vNcy2/EBmVrnXulil/jr0MnMnvRU8Gbf/AWzEkBxvCr2Jygk4KHIvq1TGzyZjRlPvgCQ6Huq0vbP8aicg==";
        };
        _MRO4EUl3 = {
            "id" = "MRO4EUl3";
            "file" = "plasmovoice-fabric-1.19.2-2.1.17.jar";
            "hash" = "sha512-Ju21KIt3/Z3y6kD6T8xkBtuhtTgE3eaydhu/kOGrPnDz/r6sVP93oVopRM2QU7JFGiRstyl475O6vXvEVRwwlA==";
        };
        _F1VKyzib = {
            "id" = "F1VKyzib";
            "file" = "plasmovoice-forge-1.19.2-2.1.17.jar";
            "hash" = "sha512-nzj31C9nJPsursotZYPCY7gDGg6g5Uyo9RzgnjWZ6mqVSI/V5AivaruHP/rfSnJhHlVJkikaSgkfG9ev6jtbPw==";
        };
        _tLodvyUL = {
            "id" = "tLodvyUL";
            "file" = "plasmovoice-fabric-1.19.3-2.1.17.jar";
            "hash" = "sha512-IDFHNsfXTiW+tbVhJA5m988dz3ijdMi7Y/xC7E9DdRqGi/dsGzTjwKoNtDask9MKs9ZGOdLmTF1UWu3sqKx3LQ==";
        };
        _8v1jTdZF = {
            "id" = "8v1jTdZF";
            "file" = "plasmovoice-forge-1.19.3-2.1.17.jar";
            "hash" = "sha512-cHCQ9UdKoUBhDxpfxU7+YFDkzPFb089wni0jOTK8KKC0GXy/NNDR/QxX9xDVcghaSUVyMh/AW7yV5HAaF9MhhQ==";
        };
        _UcXNz7M6 = {
            "id" = "UcXNz7M6";
            "file" = "plasmovoice-fabric-1.19.4-2.1.17.jar";
            "hash" = "sha512-MMx2NEKyYh4Za75HW3BZ2Xnin6fJcchZNZFVnkAwPtqADcNZ69FpyWqYiKnwEMnAHen33kzwVnxyJ859mN5ixQ==";
        };
        _7qYx9ePB = {
            "id" = "7qYx9ePB";
            "file" = "plasmovoice-forge-1.19.4-2.1.17.jar";
            "hash" = "sha512-WGiGdaWsOZpaceM85QGHLYKKqbfCaIzMqUDHWbbps8sGxVnbSJXatmEArUz049ZJayYLLWuSe16BBvPaeEZ2Yg==";
        };
        _rFDDAPes = {
            "id" = "rFDDAPes";
            "file" = "plasmovoice-fabric-1.20.1-2.1.17.jar";
            "hash" = "sha512-M+h2jBmXKRU55swQtKt9e0FpaAVZlW6dn5qjDhjAkVCsLi8+GanBcOMwLh/XAmUMHuComTgVXBaFOnjpCtea0g==";
        };
        _KoHwlbDf = {
            "id" = "KoHwlbDf";
            "file" = "plasmovoice-forge-1.20.1-2.1.17.jar";
            "hash" = "sha512-eN/8cBYxp656StWYKyfpk5HeJUh5u8yAWR9OD6h3sHshJum8lbrZa05umQzYCo3038/NxCRxwJXEk/ZO3VmdVw==";
        };
        _VsQ7zzMT = {
            "id" = "VsQ7zzMT";
            "file" = "plasmovoice-fabric-1.20.4-2.1.17.jar";
            "hash" = "sha512-uW29SJX7msFniVeU4g7k2B4hrBuv0uLl2wBwENYBNGuLQtRg5MYPnwomxftn4271O0hq6CFk8BPgTzQyKvpNWQ==";
        };
        _emtfYObu = {
            "id" = "emtfYObu";
            "file" = "plasmovoice-forge-1.20.4-2.1.17.jar";
            "hash" = "sha512-NgjiIcKDgB2IegeNVk84ZRcZYivB30vBt4OjuxogrCqyr1KV70h0rqrhHssrynZmoarDmbNK8LE3yAT8K65PUg==";
        };
        _6Q2QmcUp = {
            "id" = "6Q2QmcUp";
            "file" = "plasmovoice-fabric-1.21.1-2.1.17.jar";
            "hash" = "sha512-ZOYJUyMAhlvAOIOS8of8DmKwMLLz5jfQWLiO5Sln1RW2sBiZAUnWXXdo88qOlPAH/LNYi33UnFtZSfXM77prug==";
        };
        _lkNAkqrJ = {
            "id" = "lkNAkqrJ";
            "file" = "plasmovoice-forge-1.21.1-2.1.17.jar";
            "hash" = "sha512-HEdoLDLm5+KnOLtAdwtlTrWDh3MPwawfpquKsDJQak3R7hHxKWYcftIDoTaRg5swda0JnBJAJKVqE4VvjjK0Jw==";
        };
        _97HOKGM0 = {
            "id" = "97HOKGM0";
            "file" = "plasmovoice-neoforge-1.21.1-2.1.17.jar";
            "hash" = "sha512-aEej1Lirb8sU1Xd3v1TMqHmMI9dGtPTPgP4x+uSoaZXn4cWmrX5+zCqUr+OnkJTTr//MDffPBh56lsPv9qwtMg==";
        };
        _zueqcgC8 = {
            "id" = "zueqcgC8";
            "file" = "plasmovoice-fabric-1.21.4-2.1.17.jar";
            "hash" = "sha512-bcWwI/2yZ0KfvX/Y6IMiVrXsenejOHZo71ZyFXK9at//RQ6Kt7wu+NoLq+hff5Yk3GjvGZQSfhBZpdCJwOXJwg==";
        };
        _8rd5gky9 = {
            "id" = "8rd5gky9";
            "file" = "plasmovoice-neoforge-1.21.4-2.1.17.jar";
            "hash" = "sha512-94qmcthsUWpHtxCTLWaVwhlv51evxTUTBpQ2NUp92fmmKqXMbf/edVRvWyKIXo53Xc6fiABNd1LAf4Xmt23EzQ==";
        };
        _FoUzQj6E = {
            "id" = "FoUzQj6E";
            "file" = "plasmovoice-fabric-1.21.6-2.1.17.jar";
            "hash" = "sha512-+tzdqo/6kgYCcwjDB1QItjD//G47nyv8fKBSQELetfYgfdWiiADdmvI7xbf78Rmy5T3q4LciRVvHxtaVNFiDNA==";
        };
        _2te5OiFQ = {
            "id" = "2te5OiFQ";
            "file" = "plasmovoice-neoforge-1.21.6-2.1.17.jar";
            "hash" = "sha512-EzwgQPF0FL8/7Kxx0mOoOrM1lL2DL/z9M5D6IP6KmL7O38+/1s7+QgSbPlgX9n+s8X+Vd6RE1ChqJPa+5VPxnw==";
        };
        _6tIx8oXd = {
            "id" = "6tIx8oXd";
            "file" = "plasmovoice-neoforge-1.21.7-2.1.17.jar";
            "hash" = "sha512-Fqa9F+pW/zFNOXq3qGGOmRz3gQgCmcpBqR2VuSr4ohfP/hYnaV1UbWSXzHlz0fjGaBBikQH3e1WujS57nNkqyQ==";
        };
        _eK4Sv4pO = {
            "id" = "eK4Sv4pO";
            "file" = "plasmovoice-fabric-1.21.11-2.1.17.jar";
            "hash" = "sha512-qdTQ9qUdabQgZWRjIlzKNOuseZgtUUrKkOvvYEzoUIZVedR5YgQ9HbeJmMB21A1wz5ZcVMOS6TxxqTZL96qZ8w==";
        };
        _u1ZZ3y0Y = {
            "id" = "u1ZZ3y0Y";
            "file" = "plasmovoice-neoforge-1.21.11-2.1.17.jar";
            "hash" = "sha512-WZsac3L/PEO0HANqGe9yXR17TuHKdigmNxqat6eG9h/9irpPNLbqJOpb233Bb0LMc1soEqBeM2Gd8jwIKLZ0TQ==";
        };
        _AWrwR3ci = {
            "id" = "AWrwR3ci";
            "file" = "plasmovoice-fabric-26.1-2.1.17.jar";
            "hash" = "sha512-LBXsbi/88HzglpEVLezdJDYFHWzS62KeiAGjQVcsL+EE0rz96+QK8dmYux5hOxipduJ1UpuBME0+0PdmU3XPEw==";
        };
        _xRZUtLOh = {
            "id" = "xRZUtLOh";
            "file" = "plasmovoice-neoforge-26.1-2.1.17.jar";
            "hash" = "sha512-BV/EU9lXvzNtHyGDQPg7LlASWMHJUNfiz5y3yiixxtAaMe86Ap6/9wF6suD0x1qDtPBmr12keul/El/mwM9deg==";
        };
        _lmQvyHuY = {
            "id" = "lmQvyHuY";
            "file" = "plasmovoice-fabric-26.2-2.1.17.jar";
            "hash" = "sha512-ZT+0NGIjQ8o3WPRq1vrG3nMSCutehCvCWBcLLGbEShRkAb1IfJITkmpO7MNFBqCXgkX4uN3TjTBM70nyMVmciA==";
        };
        _QqZ4grre = {
            "id" = "QqZ4grre";
            "file" = "plasmovoice-neoforge-26.2-2.1.17.jar";
            "hash" = "sha512-bbABtYS62YGYVnPpWWw94lMmFH11HS2bQBx1Xk6gJK8D21YqSVulyLahwgCHtJG25+vZpDUAF135f4Ixfq+dXQ==";
        };
        _vKP6gBRn = {
            "id" = "vKP6gBRn";
            "file" = "plasmovoice-fabric-26.3-2.1.17.jar";
            "hash" = "sha512-AAkO20k/xrYypoJcdl/3l/hGliXywwpEuNB9kgtvpxWeZnHVhdEi0nLS56bmoR8sHLX4HLryc4NUrYCr2f6Pgw==";
        };
        _l4DODz7G = {
            "id" = "l4DODz7G";
            "file" = "plasmovoice-neoforge-26.3-2.1.17.jar";
            "hash" = "sha512-DU026E/Ss3dglvsMMykWjKU4fiRkKBmMZBdyeIh0d7hUyZ8SMnUPO16w2bOUJo4aWmxHTfs5M+vuUhtRRtpMnA==";
        };
    in {
        "zlQbC0Oq" = _zlQbC0Oq;
        "UIMRLcYI" = _UIMRLcYI;
        ...
        "fabric-1.17.1" = _fHEQPw5a;
        "fabric-1.16.4" = _9Zgx9Y3d;
        "fabric-1.16.5" = _gEu4XS1L;
        "fabric-1.18" = _GDqzd1zx;
        "fabric-1.18.1" = _acFZc9lT;
        "fabric-1.18.2" = _wwrYyVoj;
        "fabric-1.19" = _MRO4EUl3;
        "fabric-1.19.1" = _MRO4EUl3;
        "fabric-1.19.2" = _MRO4EUl3;
        "fabric-1.19.3" = _tLodvyUL;
        "fabric-1.19.4" = _UcXNz7M6;
        "fabric-1.20" = _rFDDAPes;
        "fabric-1.20.1" = _rFDDAPes;
        "fabric-1.20.2" = _VsQ7zzMT;
        "fabric-1.20.3" = _VsQ7zzMT;
        "fabric-1.20.4" = _VsQ7zzMT;
        "fabric-1.20.5" = _PkoAnEu8;
        "fabric-1.20.6" = _CwMlzZgx;
        "fabric-1.21" = _6Q2QmcUp;
        "fabric-1.21.1" = _6Q2QmcUp;
        "fabric-1.21.2" = _ZgaGmbtf;
        "fabric-1.21.3" = _ZgaGmbtf;
        "fabric-1.21.4" = _zueqcgC8;
        "fabric-1.21.5" = _fzenktTg;
        "fabric-1.21.6" = _FoUzQj6E;
        "fabric-1.21.7" = _FoUzQj6E;
        "fabric-1.21.8" = _FoUzQj6E;
        "fabric-1.21.9" = _W5v3VgoJ;
        "fabric-1.21.10" = _W5v3VgoJ;
        "fabric-1.21.11" = _eK4Sv4pO;
        "fabric-26.1" = _AWrwR3ci;
        "fabric-26.1.1" = _AWrwR3ci;
        "fabric-26.1.2" = _AWrwR3ci;
        "fabric-26.2" = _lmQvyHuY;
        "fabric-26.3" = _vKP6gBRn;
        "forge-1.17" = _UWzwfmfX;
        "forge-1.17.1" = _bHsbPNxp;
        "forge-1.16.4" = _KwUIvqax;
        "forge-1.16.5" = _sVbz4VTK;
        "forge-1.18" = _yVLotUOR;
        "forge-1.18.1" = _iwzUwLGb;
        "forge-1.18.2" = _agUvymvl;
        "forge-1.19" = _F1VKyzib;
        "forge-1.19.1" = _F1VKyzib;
        "forge-1.19.2" = _F1VKyzib;
        "forge-1.19.3" = _8v1jTdZF;
        "forge-1.19.4" = _7qYx9ePB;
        "forge-1.20" = _KoHwlbDf;
        "forge-1.20.1" = _KoHwlbDf;
        "forge-1.20.4" = _emtfYObu;
        "forge-1.21" = _lkNAkqrJ;
        "forge-1.21.1" = _lkNAkqrJ;
        "forge-1.20.2" = _emtfYObu;
        "forge-1.20.3" = _emtfYObu;
        "paper-1.16.4" = _NtkK86vk;
        "paper-1.16.5" = _DySKquus;
        "paper-1.17" = _NtkK86vk;
        "paper-1.17.1" = _DySKquus;
        "paper-1.18" = _NtkK86vk;
        "paper-1.18.1" = _NtkK86vk;
        "paper-1.18.2" = _DySKquus;
        "paper-1.19" = _NtkK86vk;
        "paper-1.19.1" = _NtkK86vk;
        "paper-1.19.2" = _DySKquus;
        "paper-1.19.3" = _aLnbX09d;
        "paper-1.19.4" = _DySKquus;
        "paper-1.20" = _oD2bUPCy;
        "paper-1.20.1" = _DySKquus;
        "paper-1.20.2" = _oD2bUPCy;
        "paper-1.20.3" = _oD2bUPCy;
        "paper-1.20.4" = _DySKquus;
        "paper-1.20.5" = _oD2bUPCy;
        "paper-1.20.6" = _oD2bUPCy;
        "paper-1.21" = _DySKquus;
        "paper-1.21.1" = _DySKquus;
        "paper-1.21.2" = _DySKquus;
        "paper-1.21.3" = _DySKquus;
        "paper-1.21.4" = _DySKquus;
        "paper-1.21.5" = _DySKquus;
        "paper-1.21.6" = _DySKquus;
        "paper-1.21.7" = _DySKquus;
        "paper-1.21.8" = _DySKquus;
        "paper-1.21.9" = _DySKquus;
        "paper-1.21.10" = _DySKquus;
        "paper-1.21.11" = _DySKquus;
        "paper-26.1" = _DySKquus;
        "paper-26.1.1" = _DySKquus;
        "paper-26.1.2" = _DySKquus;
        "paper-26.2" = _DySKquus;
        "paper-26.3" = _DySKquus;
        ...
        "spigot-1.16.5" = _DySKquus;
        "spigot-1.17" = _NtkK86vk;
        "spigot-1.17.1" = _DySKquus;
        "spigot-1.18" = _NtkK86vk;
        "spigot-1.18.1" = _NtkK86vk;
        "spigot-1.18.2" = _DySKquus;
        "spigot-1.19" = _NtkK86vk;
        "spigot-1.19.1" = _NtkK86vk;
        "spigot-1.19.2" = _DySKquus;
        "spigot-1.19.3" = _aLnbX09d;
        "spigot-1.19.4" = _DySKquus;
        "spigot-1.20" = _oD2bUPCy;
        "spigot-1.20.1" = _DySKquus;
        "spigot-1.20.2" = _oD2bUPCy;
        "spigot-1.20.3" = _oD2bUPCy;
        "spigot-1.20.4" = _DySKquus;
        "spigot-1.20.5" = _oD2bUPCy;
        "spigot-1.20.6" = _oD2bUPCy;
        "spigot-1.21" = _DySKquus;
        "spigot-1.21.1" = _DySKquus;
        "spigot-1.21.2" = _DySKquus;
        "spigot-1.21.3" = _DySKquus;
        "spigot-1.21.4" = _DySKquus;
        "spigot-1.21.5" = _DySKquus;
        "spigot-1.21.6" = _DySKquus;
        "spigot-1.21.7" = _DySKquus;
        "spigot-1.21.8" = _DySKquus;
        "spigot-1.21.9" = _DySKquus;
        "spigot-1.21.10" = _DySKquus;
        "spigot-1.21.11" = _DySKquus;
        "spigot-26.1" = _DySKquus;
        "spigot-26.1.1" = _DySKquus;
        "spigot-26.1.2" = _DySKquus;
        "spigot-26.2" = _DySKquus;
        "spigot-26.3" = _DySKquus;
        "bungeecord-1.19.2" = _44fnPRkZ;
        "bungeecord-1.19.3" = _ITnADYQK;
        "bungeecord-1.19.4" = _44fnPRkZ;
        "bungeecord-1.20" = _ITnADYQK;
        "bungeecord-1.20.1" = _44fnPRkZ;
        "bungeecord-1.20.2" = _ITnADYQK;
        "bungeecord-1.20.3" = _ITnADYQK;
        "bungeecord-1.20.4" = _44fnPRkZ;
        "bungeecord-1.20.5" = _ITnADYQK;
        "bungeecord-1.20.6" = _ITnADYQK;
        "bungeecord-1.21" = _44fnPRkZ;
        "bungeecord-1.16.5" = _44fnPRkZ;
        "bungeecord-1.17.1" = _44fnPRkZ;
        "bungeecord-1.18.2" = _44fnPRkZ;
        "bungeecord-1.21.1" = _44fnPRkZ;
        "bungeecord-1.21.2" = _44fnPRkZ;
        "bungeecord-1.21.3" = _44fnPRkZ;
        "bungeecord-1.21.4" = _44fnPRkZ;
        "bungeecord-1.21.5" = _44fnPRkZ;
        "bungeecord-1.21.6" = _44fnPRkZ;
        "bungeecord-1.21.7" = _44fnPRkZ;
        "bungeecord-1.21.8" = _44fnPRkZ;
        "bungeecord-1.21.9" = _44fnPRkZ;
        "bungeecord-1.21.10" = _44fnPRkZ;
        "bungeecord-1.21.11" = _44fnPRkZ;
        "bungeecord-26.1" = _44fnPRkZ;
        "bungeecord-26.1.1" = _44fnPRkZ;
        "bungeecord-26.1.2" = _44fnPRkZ;
        "bungeecord-26.2" = _44fnPRkZ;
        "bungeecord-26.3" = _44fnPRkZ;
        "velocity-1.19.2" = _Zh4xxdjc;
        "velocity-1.19.3" = _u04Ge8Ca;
        "velocity-1.19.4" = _Zh4xxdjc;
        "velocity-1.20" = _u04Ge8Ca;
        "velocity-1.20.1" = _Zh4xxdjc;
        "velocity-1.20.2" = _u04Ge8Ca;
        "velocity-1.20.3" = _u04Ge8Ca;
        "velocity-1.20.4" = _Zh4xxdjc;
        "velocity-1.20.5" = _u04Ge8Ca;
        "velocity-1.20.6" = _u04Ge8Ca;
        "velocity-1.21" = _Zh4xxdjc;
        "velocity-1.16.5" = _Zh4xxdjc;
        "velocity-1.17.1" = _Zh4xxdjc;
        "velocity-1.18.2" = _Zh4xxdjc;
        "velocity-1.21.1" = _Zh4xxdjc;
        "velocity-1.21.2" = _Zh4xxdjc;
        "velocity-1.21.3" = _Zh4xxdjc;
        "velocity-1.21.4" = _Zh4xxdjc;
        "velocity-1.21.5" = _Zh4xxdjc;
        "velocity-1.21.6" = _Zh4xxdjc;
        "velocity-1.21.7" = _Zh4xxdjc;
        "velocity-1.21.8" = _Zh4xxdjc;
        "velocity-1.21.9" = _Zh4xxdjc;
        "velocity-1.21.10" = _Zh4xxdjc;
        "velocity-1.21.11" = _Zh4xxdjc;
        "velocity-26.1" = _Zh4xxdjc;
        "velocity-26.1.1" = _Zh4xxdjc;
        "velocity-26.1.2" = _Zh4xxdjc;
        "velocity-26.2" = _Zh4xxdjc;
        "velocity-26.3" = _Zh4xxdjc;
        "folia-1.19.2" = _DySKquus;
        "folia-1.19.3" = _aLnbX09d;
        "folia-1.19.4" = _DySKquus;
        "folia-1.20" = _oD2bUPCy;
        "folia-1.20.1" = _DySKquus;
        "folia-1.20.2" = _oD2bUPCy;
        "folia-1.20.3" = _oD2bUPCy;
        "folia-1.20.4" = _DySKquus;
        "folia-1.20.5" = _oD2bUPCy;
        "folia-1.20.6" = _oD2bUPCy;
        "folia-1.21" = _DySKquus;
        "folia-1.16.5" = _DySKquus;
        "folia-1.17.1" = _DySKquus;
        "folia-1.18.2" = _DySKquus;
        "folia-1.21.1" = _DySKquus;
        "folia-1.21.2" = _DySKquus;
        "folia-1.21.3" = _DySKquus;
        "folia-1.21.4" = _DySKquus;
        "folia-1.21.5" = _DySKquus;
        "folia-1.21.6" = _DySKquus;
        "folia-1.21.7" = _DySKquus;
        "folia-1.21.8" = _DySKquus;
        "folia-1.21.9" = _DySKquus;
        "folia-1.21.10" = _DySKquus;
        "folia-1.21.11" = _DySKquus;
        "folia-26.1" = _DySKquus;
        "folia-26.1.1" = _DySKquus;
        "folia-26.1.2" = _DySKquus;
        "folia-26.2" = _DySKquus;
        "folia-26.3" = _DySKquus;
        "neoforge-1.21" = _97HOKGM0;
        "neoforge-1.21.1" = _97HOKGM0;
        "neoforge-1.21.2" = _vSSc2pqg;
        "neoforge-1.21.3" = _vSSc2pqg;
        "neoforge-1.21.4" = _8rd5gky9;
        "neoforge-1.21.5" = _oOOKff9Q;
        "neoforge-1.21.6" = _2te5OiFQ;
        "neoforge-1.21.7" = _6tIx8oXd;
        "neoforge-1.21.8" = _6tIx8oXd;
        "neoforge-1.21.9" = _F4kIceic;
        "neoforge-1.21.10" = _F4kIceic;
        "neoforge-1.21.11" = _u1ZZ3y0Y;
        "neoforge-26.1" = _xRZUtLOh;
        "neoforge-26.1.1" = _xRZUtLOh;
        "neoforge-26.1.2" = _xRZUtLOh;
        "neoforge-26.2" = _QqZ4grre;
        "neoforge-26.3" = _l4DODz7G;
        "pkg-fabric-1.17.1-1.2.7" = _zlQbC0Oq;
        "pkg-forge-1.17.1-1.2.7" = _UIMRLcYI;
        "pkg-fabric-1.16.5-1.2.7" = _4tIZC6Dv;
        "pkg-forge-1.16-1.2.7" = _WbpqRNS1;
        "pkg-fabric-1.18-1.2.7" = _UfJiSde5;
        "pkg-forge-1.18-1.2.7" = _1WCgFj9b;
        "pkg-fabric-1.16-1.2.8" = _LOfc9IpQ;
        "pkg-forge-1.16-1.2.8" = _miu4baTk;
        "pkg-fabric-1.17-1.2.8" = _XLkEqhSk;
        "pkg-forge-1.17-1.2.8" = _JQzLULIG;
        "pkg-fabric-1.18-1.2.8" = _nJFN8sJe;
        "pkg-forge-1.18-1.2.8" = _TVfYKhG6;
        "pkg-fabric-1.16-1.2.9" = _5PxfQIvr;
        "pkg-forge-1.16-1.2.9" = _xVcDK6gO;
        "pkg-fabric-1.17-1.2.9" = _CXkLNwxe;
        "pkg-forge-1.17-1.2.9" = _YG86f5Vc;
        "pkg-fabric-1.18-1.2.9" = _apgep7HE;
        "pkg-forge-1.18-1.2.9" = _C1LMscVv;
        "pkg-fabric-1.18-1.2.10-alpha" = _XQrCilqk;
        "pkg-forge-1.18-1.2.10-alpha" = _NOCHzkjx;
        "pkg-fabric-1.16-1.2.10" = _KYVQvfLT;
        "pkg-forge-1.16-1.2.10" = _IR9VZSv0;
        "pkg-fabric-1.17-1.2.10" = _fC3c833E;
        "pkg-forge-1.17-1.2.10" = _sRFa96Wq;
        "pkg-fabric-1.18-1.2.10" = _GDqzd1zx;
        "pkg-forge-1.18-1.2.10" = _yVLotUOR;
        "pkg-fabric-1.18.2-1.2.10" = _qsAOnnXQ;
        "pkg-forge-1.18.2-1.2.10" = _U5wNrys5;
        "pkg-fabric-1.16-1.2.11" = _sQYffleb;
        "pkg-forge-1.16-1.2.11" = _LyWf2UYP;
        "pkg-fabric-1.17-1.2.11" = _dxRYB81W;
        "pkg-forge-1.17-1.2.11" = _9Z3FBmQY;
        "pkg-fabric-1.18.2-1.2.11" = _Lwy2apRP;
        "pkg-forge-1.18.2-1.2.11" = _rnC626IH;
        "pkg-fabric-1.16-1.2.12" = _48o5DJIb;
        "pkg-forge-1.16-1.2.12" = _EqvMlTYI;
        "pkg-fabric-1.17-1.2.12" = _ihM7ZZOa;
        "pkg-forge-1.17-1.2.12" = _S754oEWo;
        "pkg-fabric-1.18-1.2.12" = _DgR7LRrJ;
        "pkg-forge-1.18-1.2.12" = _rKmQ8Hcs;
        "pkg-fabric-1.16-1.2.13" = _lxHiwS61;
        "pkg-forge-1.16-1.2.13" = _GlRQiakj;
        "pkg-fabric-1.17-1.2.13" = _zUoQOIIl;
        "pkg-forge-1.17-1.2.13" = _ic24MIrF;
        "pkg-fabric-1.18-1.2.13" = _CGqrbEX7;
        "pkg-forge-1.18-1.2.13" = _lhUkbzhf;
        "pkg-fabric-1.19-1.2.14" = _JwMdbMUY;
        "pkg-forge-1.19-1.2.14" = _OIPDkDlj;
        "pkg-fabric-1.19-1.2.15" = _gJ0bEIFc;
        "pkg-forge-1.19-1.2.15" = _mUsmTp05;
        "pkg-fabric-1.16-1.2.16" = _LbIAyQnG;
        "pkg-forge-1.16-1.2.16" = _8YPGyFSD;
        "pkg-fabric-1.17-1.2.16" = _jKUVl9N2;
        "pkg-forge-1.17-1.2.16" = _qg7hVRsr;
        "pkg-fabric-1.18-1.2.16" = _afDQrRY6;
        "pkg-forge-1.18-1.2.16" = _jnG31g8d;
        "pkg-fabric-1.19-1.2.16" = _2pV4QkPE;
        "pkg-forge-1.19-1.2.16" = _kqc5fAvC;
        "pkg-fabric-1.16-1.2.17" = _AKievjlB;
        "pkg-forge-1.16-1.2.17" = _tN5Z7hqv;
        "pkg-fabric-1.17-1.2.17" = _2O2dhmvJ;
        "pkg-forge-1.17-1.2.17" = _T7Y9z3Od;
        "pkg-fabric-1.18-1.2.17" = _E5JQPfe5;
        "pkg-forge-1.18-1.2.17" = _BBRW8P3o;
        "pkg-fabric-1.19-1.2.17" = _VLckCF3E;
        "pkg-forge-1.19-1.2.17" = _GXxncLC2;
        "pkg-forge-1.19-1.2.17a" = _rLwicjb5;
        "pkg-fabric-1.19.1-1.2.18" = _CxDDfO13;
        "pkg-fabric-1.16-1.2.19" = _9Zgx9Y3d;
        "pkg-forge-1.16-1.2.19" = _KwUIvqax;
        "pkg-fabric-1.17-1.2.19" = _N9vOymRx;
        "pkg-forge-1.17-1.2.19" = _UWzwfmfX;
        "pkg-fabric-1.18-1.2.19" = _acFZc9lT;
        "pkg-forge-1.18-1.2.19" = _iwzUwLGb;
        "pkg-fabric-1.19-1.2.19" = _5v4sPf1L;
        "pkg-forge-1.19-1.2.19" = _g9oGGIve;
        "pkg-fabric-1.19.x-1.2.19" = _3UIMooYI;
        "pkg-forge-1.19.x-1.2.19" = _F6xpwlsn;
        "pkg-spigot-1.16.x-1.19.x-1.0.11" = _NtkK86vk;
        "pkg-fabric-1.19.3-1.2.19" = _XHxk0rwE;
        "pkg-forge-1.19.3-1.2.19" = _WAVVrCIa;
        "pkg-fabric-1.19.2-2.0.0+887a74a" = _UowSxv5s;
        "pkg-forge-1.19.2-2.0.0+887a74a" = _7FnhlTAO;
        "pkg-fabric-1.19.3-2.0.0+887a74a" = _zKEjPxER;
        "pkg-forge-1.19.3-2.0.0+887a74a" = _EABn2Cs8;
        "pkg-fabric-1.19.2-2.0.0+7a19d00" = _iYBOdlZP;
        "pkg-forge-1.19.2-2.0.0+7a19d00" = _xPCqTxGx;
        "pkg-fabric-1.19.3-2.0.0+7a19d00" = _o8Edia28;
        "pkg-forge-1.19.3-2.0.0+7a19d00" = _cluFA3fM;
        "pkg-fabric-1.19.2-2.0.0+ad5419c" = _voK1A26s;
        "pkg-forge-1.19.2-2.0.0+ad5419c" = _KCtIdI1b;
        "pkg-fabric-1.19.3-2.0.0+ad5419c" = _CrGzdMEW;
        "pkg-forge-1.19.3-2.0.0+ad5419c" = _BsnJG4nU;
        "pkg-fabric-1.19.2-2.0.0+37c605f" = _zoUbuRnY;
        "pkg-forge-1.19.2-2.0.0+37c605f" = _b7CRdwjo;
        "pkg-fabric-1.19.3-2.0.0+37c605f" = _wtBzNFL9;
        "pkg-forge-1.19.3-2.0.0+37c605f" = _ZLjSopM6;
        "pkg-fabric-1.19.2-2.0.0+4f622ba" = _ADNFX85H;
        "pkg-forge-1.19.2-2.0.0+4f622ba" = _7zWuIOIJ;
        "pkg-fabric-1.19.3-2.0.0+4f622ba" = _cRObw4Yc;
        "pkg-forge-1.19.3-2.0.0+4f622ba" = _kSTN0q00;
        "pkg-fabric-1.19.2-2.0.0+57c7e55" = _G7EqHoYT;
        "pkg-forge-1.19.2-2.0.0+57c7e55" = _YVbfh5YZ;
        "pkg-fabric-1.19.3-2.0.0+57c7e55" = _4C02MTtZ;
        "pkg-forge-1.19.3-2.0.0+57c7e55" = _7goBiFBQ;
        "pkg-fabric-1.19.2-2.0.0+2711053" = _jKzdo7sy;
        "pkg-forge-1.19.2-2.0.0+2711053" = _T8wdk7IB;
        "pkg-fabric-1.19.3-2.0.0+2711053" = _ZEhH6anT;
        "pkg-forge-1.19.3-2.0.0+2711053" = _Rzp2EPIu;
        "pkg-fabric-1.19.2-2.0.0+16cdd8e" = _DN4U6pMS;
        "pkg-forge-1.19.2-2.0.0+16cdd8e" = _vNlpreop;
        "pkg-fabric-1.19.3-2.0.0+16cdd8e" = _JiD4O4QR;
        "pkg-forge-1.19.3-2.0.0+16cdd8e" = _FaEQeXRK;
        "pkg-fabric-1.19.2-2.0.0+0799b77" = _5ew4G9uj;
        "pkg-forge-1.19.2-2.0.0+0799b77" = _tfiUEdey;
        "pkg-fabric-1.19.3-2.0.0+0799b77" = _tzqX0wPg;
        "pkg-forge-1.19.3-2.0.0+0799b77" = _4R6pzXnP;
        "pkg-fabric-1.19.2-2.0.0+2d5a31a" = _exieWx3h;
        "pkg-forge-1.19.2-2.0.0+2d5a31a" = _T1yQztXl;
        "pkg-fabric-1.19.3-2.0.0+2d5a31a" = _sC6xqv5Q;
        "pkg-forge-1.19.3-2.0.0+2d5a31a" = _n4X6gEqH;
        "pkg-fabric-1.19.2-2.0.0+40cb88f" = _hgguZH1W;
        "pkg-forge-1.19.2-2.0.0+40cb88f" = _E7ZIWAL1;
        "pkg-fabric-1.19.3-2.0.0+40cb88f" = _RhQKMWRs;
        "pkg-forge-1.19.3-2.0.0+40cb88f" = _uvsKPlMM;
        "pkg-fabric-1.19.2-2.0.0+fd6d2d2" = _aadAW8FE;
        "pkg-forge-1.19.2-2.0.0+fd6d2d2" = _ZP4CLSi7;
        "pkg-fabric-1.19.3-2.0.0+fd6d2d2" = _WCom8k02;
        "pkg-forge-1.19.3-2.0.0+fd6d2d2" = _EK7hxObk;
        "pkg-fabric-1.19.2-2.0.0+477d324" = _jnyRJM9j;
        "pkg-forge-1.19.2-2.0.0+477d324" = _ES5hJGLD;
        "pkg-fabric-1.19.3-2.0.0+477d324" = _H2HkzoPC;
        "pkg-forge-1.19.3-2.0.0+477d324" = _mDZJ3k2k;
        "pkg-fabric-1.19.2-2.0.0+b02783a" = _61OM5ceX;
        "pkg-forge-1.19.2-2.0.0+b02783a" = _nVbE2zO2;
        "pkg-fabric-1.19.3-2.0.0+b02783a" = _h3xfllvW;
        "pkg-fabric-1.19.4-2.0.0+b02783a" = _fZPz7zmZ;
        "pkg-forge-1.19.4-2.0.0+b02783a" = _RQbcFC9e;
        "pkg-fabric-1.19.2-2.0.0+579db77" = _QNjCA3lP;
        "pkg-forge-1.19.2-2.0.0+579db77" = _uIMd7fxl;
        "pkg-fabric-1.19.3-2.0.0+579db77" = _C6jG994b;
        "pkg-forge-1.19.3-2.0.0+579db77" = _oT8KDEVH;
        "pkg-fabric-1.19.4-2.0.0+579db77" = _fMyUvrMv;
        "pkg-forge-1.19.4-2.0.0+579db77" = _aBwGz9PQ;
        "pkg-fabric-1.19.2-2.0.0+a3e5dfc" = _b4Gc3SDW;
        "pkg-forge-1.19.2-2.0.0+a3e5dfc" = _iesdX1k1;
        "pkg-fabric-1.19.3-2.0.0+a3e5dfc" = _wnWfka0R;
        "pkg-forge-1.19.3-2.0.0+a3e5dfc" = _LQwhXgyT;
        "pkg-fabric-1.19.4-2.0.0+a3e5dfc" = _L83btuRQ;
        "pkg-forge-1.19.4-2.0.0+a3e5dfc" = _N5mmC3x7;
        "pkg-fabric-1.19.2-2.0.0+a6a9ad0" = _gg1431Zl;
        "pkg-forge-1.19.2-2.0.0+a6a9ad0" = _1KByovqo;
        "pkg-fabric-1.19.3-2.0.0+a6a9ad0" = _Ac9dvTdO;
        "pkg-forge-1.19.3-2.0.0+a6a9ad0" = _Ia9ajZSF;
        "pkg-fabric-1.19.4-2.0.0+a6a9ad0" = _Nx1dHeM8;
        "pkg-forge-1.19.4-2.0.0+a6a9ad0" = _u5ronidJ;
        "pkg-fabric-1.19.2-2.0.0+acb0cc8" = _XPJZRUp6;
        "pkg-forge-1.19.2-2.0.0+acb0cc8" = _t7YXHysy;
        "pkg-fabric-1.19.3-2.0.0+acb0cc8" = _Vg4EG5b3;
        "pkg-forge-1.19.3-2.0.0+acb0cc8" = _xecGprWj;
        "pkg-fabric-1.19.4-2.0.0+acb0cc8" = _aI5PZJQz;
        "pkg-forge-1.19.4-2.0.0+acb0cc8" = _YuZNX4dB;
        "pkg-fabric-1.19.2-2.0.0+f503c99" = _OQ1pdv15;
        "pkg-forge-1.19.2-2.0.0+f503c99" = _sj51lDxj;
        "pkg-fabric-1.19.3-2.0.0+f503c99" = _qv2aD1jV;
        "pkg-forge-1.19.3-2.0.0+f503c99" = _Gq8Va8tC;
        "pkg-fabric-1.19.4-2.0.0+f503c99" = _UUnQeZYY;
        "pkg-forge-1.19.4-2.0.0+f503c99" = _Q3IP728l;
        "pkg-fabric-1.19.2-2.0.0+3577e26" = _NNqLdeeo;
        "pkg-forge-1.19.2-2.0.0+3577e26" = _ap25XqEj;
        "pkg-fabric-1.19.3-2.0.0+3577e26" = _vtvaLasi;
        "pkg-forge-1.19.3-2.0.0+3577e26" = _eKrsIVHV;
        "pkg-fabric-1.19.4-2.0.0+3577e26" = _eEs6lnk9;
        "pkg-forge-1.19.4-2.0.0+3577e26" = _dRBNmBdB;
        "pkg-fabric-1.19.2-2.0.0+2a71733" = _iqjb3oDI;
        "pkg-forge-1.19.2-2.0.0+2a71733" = _ggFRsVED;
        "pkg-fabric-1.19.3-2.0.0+2a71733" = _pRxQiejC;
        "pkg-forge-1.19.3-2.0.0+2a71733" = _w3dDevOR;
        "pkg-fabric-1.19.4-2.0.0+2a71733" = _x4H8cECr;
        "pkg-forge-1.19.4-2.0.0+2a71733" = _7ZUbKRre;
        "pkg-bungeecord-2.0.0+2a71733" = _zUbZiCN8;
        "pkg-spigot-2.0.0+2a71733" = _ajcLfNb6;
        "pkg-velocity-2.0.0+ALPHA" = _pnfoFxif;
        "pkg-fabric-1.19.2-2.0.0+122abb5" = _pytE8Aio;
        "pkg-forge-1.19.2-2.0.0+122abb5" = _7L47Cvww;
        "pkg-fabric-1.19.3-2.0.0+122abb5" = _5ySKXU2v;
        "pkg-forge-1.19.3-2.0.0+122abb5" = _RFnYgwXJ;
        "pkg-fabric-1.19.4-2.0.0+122abb5" = _b92nHOf6;
        "pkg-forge-1.19.4-2.0.0+122abb5" = _5nZKFRS8;
        "pkg-BungeeCord-2.0.0+122abb5" = _eEfWNmHM;
        "pkg-spigot-2.0.0+122abb5" = _uCqZ19sJ;
        "pkg-BungeeCord-2.0.0" = _ZwBEMppA;
        "pkg-spigot-2.0.0" = _YocEt1O2;
        "pkg-velocity-2.0.0" = _mnGLEwRO;
        "pkg-fabric-1.19.2-2.0.0" = _btYEf3o7;
        "pkg-forge-1.19.2-2.0.0" = _YUpDOu3W;
        "pkg-fabric-1.19.3-2.0.0" = _IhqdfuoK;
        "pkg-forge-1.19.3-2.0.0" = _eIP06tos;
        "pkg-fabric-1.19.4-2.0.0" = _V1qAlwAD;
        "pkg-forge-1.19.4-2.0.0" = _n0OqEXOp;
        "pkg-spigot-2.0.1" = _Bgs7gwLr;
        "pkg-BungeeCord-2.0.1" = _FSfkvyPV;
        "pkg-velocity-2.0.1" = _RBw86kdP;
        "pkg-fabric-1.19.2-2.0.1" = _yzuhlOB7;
        "pkg-forge-1.19.2-2.0.1" = _tURRUzTp;
        "pkg-fabric-1.19.3-2.0.1" = _RHFWI9Mi;
        "pkg-forge-1.19.3-2.0.1" = _QIYD4K1B;
        "pkg-fabric-1.19.4-2.0.1" = _Btd1FbLI;
        "pkg-forge-1.19.4-2.0.1" = _dZXFRU9E;
        "pkg-spigot-2.0.2" = _J600GaTC;
        "pkg-BungeeCord-2.0.2" = _y0hoPOoy;
        "pkg-velocity-2.0.2" = _bNFu73ga;
        "pkg-fabric-1.19.2-2.0.2" = _QWnDpfVO;
        "pkg-forge-1.19.2-2.0.2" = _xhUOqLCL;
        "pkg-fabric-1.19.3-2.0.2" = _iroKjvSf;
        "pkg-forge-1.19.3-2.0.2" = _5VBNn8xc;
        "pkg-fabric-1.19.4-2.0.2" = _lQl1TP8O;
        "pkg-forge-1.19.4-2.0.2" = _8cu4imEE;
        "pkg-spigot-2.0.3" = _U7rI0E7V;
        "pkg-BungeeCord-2.0.3" = _DsEvWt8e;
        "pkg-velocity-2.0.3" = _OKTR2mds;
        "pkg-fabric-1.19.2-2.0.3" = _CPTO5fua;
        "pkg-forge-1.19.2-2.0.3" = _s5BmRcSS;
        "pkg-fabric-1.19.3-2.0.3" = _zbzUvbxJ;
        "pkg-forge-1.19.3-2.0.3" = _s6AiXv2j;
        "pkg-fabric-1.19.4-2.0.3" = _StFz4k1Y;
        "pkg-forge-1.19.4-2.0.3" = _Z1SihGK8;
        "pkg-spigot-2.0.4" = _JPt7aPf1;
        "pkg-BungeeCord-2.0.4" = _oXuJWeV0;
        "pkg-velocity-2.0.4" = _L92N71Co;
        "pkg-fabric-1.19.2-2.0.4" = _mSb8zHAJ;
        "pkg-forge-1.19.2-2.0.4" = _wOu6lFJ5;
        "pkg-fabric-1.19.3-2.0.4" = _TWjDZLBC;
        "pkg-forge-1.19.3-2.0.4" = _8vM4y30D;
        "pkg-fabric-1.19.4-2.0.4" = _tTfHrlzr;
        "pkg-forge-1.19.4-2.0.4" = _H91Cbo2H;
        "pkg-fabric-1.20-2.0.4" = _pgOlScl2;
        "pkg-spigot-2.0.5" = _DFmOr3rj;
        "pkg-BungeeCord-2.0.5" = _NXGo3r6S;
        "pkg-velocity-2.0.5" = _TNLC4G6d;
        "pkg-fabric-1.19.2-2.0.5" = _npxLATPQ;
        "pkg-forge-1.19.2-2.0.5" = _YCzRrpOA;
        "pkg-fabric-1.19.3-2.0.5" = _h3zzYZ8Y;
        "pkg-forge-1.19.3-2.0.5" = _LTO2MKXq;
        "pkg-fabric-1.19.4-2.0.5" = _UU2eu9xz;
        "pkg-forge-1.19.4-2.0.5" = _27kNZMKk;
        "pkg-fabric-1.20-2.0.5" = _Q01PZmL1;
        "pkg-spigot-2.0.6" = _MM2JOE1S;
        "pkg-BungeeCord-2.0.6" = _MPq3le7E;
        "pkg-velocity-2.0.6" = _kBFwXavN;
        "pkg-fabric-1.19.2-2.0.6" = _s9MWFHzd;
        "pkg-forge-1.19.2-2.0.6" = _fp91zonM;
        "pkg-fabric-1.19.3-2.0.6" = _rIJSoEt5;
        "pkg-forge-1.19.3-2.0.6" = _HjQFFkf4;
        "pkg-fabric-1.19.4-2.0.6" = _4Gm91Mqz;
        "pkg-forge-1.19.4-2.0.6" = _lr6tUsp1;
        "pkg-fabric-1.20.1-2.0.6" = _X7F0pv3U;
        "pkg-forge-1.20.1-2.0.6" = _E5JkrGQw;
        "pkg-spigot-2.0.7" = _OIjkhEsd;
        "pkg-bungeecord-2.0.7" = _FuP6yq3Z;
        "pkg-velocity-2.0.7" = _dYg15W5q;
        "pkg-fabric-1.19.2-2.0.7" = _DFKRupnj;
        "pkg-forge-1.19.2-2.0.7" = _qPnkFRlX;
        "pkg-fabric-1.19.3-2.0.7" = _2xAflivt;
        "pkg-forge-1.19.3-2.0.7" = _sqAx8w9O;
        "pkg-fabric-1.19.4-2.0.7" = _IIP2xikm;
        "pkg-forge-1.19.4-2.0.7" = _xQwnwTPn;
        "pkg-fabric-1.20.1-2.0.7" = _vyznIjzL;
        "pkg-forge-1.20.1-2.0.7" = _zjRqGTs3;
        "pkg-fabric-1.20.2-2.0.7" = _eK9d4aOZ;
        "pkg-spigot-2.0.8" = _TEM54tQl;
        "pkg-bungeecord-2.0.8" = _unLtTPmm;
        "pkg-velocity-2.0.8" = _wzcnnBv0;
        "pkg-fabric-1.19.2-2.0.8" = _CSntyyPo;
        "pkg-forge-1.19.2-2.0.8" = _YY6ygrf1;
        "pkg-fabric-1.19.3-2.0.8" = _Bhm2gpys;
        "pkg-forge-1.19.3-2.0.8" = _AxjXoyM6;
        "pkg-fabric-1.19.4-2.0.8" = _GPImnYBh;
        "pkg-forge-1.19.4-2.0.8" = _gXSObe0Z;
        "pkg-fabric-1.20.1-2.0.8" = _WcH8MqNA;
        "pkg-forge-1.20.1-2.0.8" = _piuPs5b0;
        "pkg-fabric-1.20.2-2.0.8" = _yg260sGa;
        "pkg-fabric-1.20.3-2.0.8" = _fykZJcya;
        "pkg-spigot-2.0.9" = _zOwrIJTG;
        "pkg-bungeecord-2.0.9" = _poVRAB6y;
        "pkg-velocity-2.0.9" = _d795WErI;
        "pkg-fabric-1.19.2-2.0.9" = _YMKy6E3U;
        "pkg-forge-1.19.2-2.0.9" = _OuK12fAj;
        "pkg-fabric-1.19.3-2.0.9" = _iSR9UU2x;
        "pkg-forge-1.19.3-2.0.9" = _d7lNaBE5;
        "pkg-fabric-1.19.4-2.0.9" = _lMSUxPzN;
        "pkg-forge-1.19.4-2.0.9" = _t0Q4ro0c;
        "pkg-fabric-1.20.1-2.0.9" = _ML0FWqQx;
        "pkg-forge-1.20.1-2.0.9" = _Hol9lcOf;
        "pkg-fabric-1.20.2-2.0.9" = _8VvBm2gx;
        "pkg-fabric-1.20.4-2.0.9" = _V23O2NYF;
        "pkg-fabric-1.20.6-2.0.9" = _PkoAnEu8;
        "pkg-spigot-2.0.10" = _oD2bUPCy;
        "pkg-bungeecord-2.0.10" = _ITnADYQK;
        "pkg-velocity-2.0.10" = _u04Ge8Ca;
        "pkg-fabric-1.19.2-2.0.10" = _5aq5D1Xf;
        "pkg-forge-1.19.2-2.0.10" = _ryqH45ap;
        "pkg-fabric-1.19.3-2.0.10" = _KuXaEu45;
        "pkg-forge-1.19.3-2.0.10" = _cnCr1kxQ;
        "pkg-fabric-1.19.4-2.0.10" = _31IhsqCF;
        "pkg-forge-1.19.4-2.0.10" = _l6BF3d6P;
        "pkg-fabric-1.20.1-2.0.10" = _TAFChWlk;
        "pkg-forge-1.20.1-2.0.10" = _hUfO1M02;
        "pkg-fabric-1.20.2-2.0.10" = _fYhFLtIB;
        "pkg-fabric-1.20.4-2.0.10" = _fxRRia1R;
        "pkg-fabric-1.20.6-2.0.10" = _CwMlzZgx;
        "pkg-fabric-1.21-2.0.10" = _e3mAxhWS;
        "pkg-spigot-2.1.0" = _kvMzSpC9;
        "pkg-bungeecord-2.1.0" = _wQ9BWAYe;
        "pkg-velocity-2.1.0" = _lnsDoumn;
        "pkg-fabric-1.16.5-2.1.0" = _xpqwgj0F;
        "pkg-forge-1.16.5-2.1.0" = _UvXXj4NT;
        "pkg-fabric-1.17.1-2.1.0" = _IjJrEZi5;
        "pkg-forge-1.17.1-2.1.0" = _oLMb9HWC;
        "pkg-fabric-1.18.2-2.1.0" = _v5yJAtPO;
        "pkg-forge-1.18.2-2.1.0" = _H4ogq7MG;
        "pkg-fabric-1.19.2-2.1.0" = _hSGmqXch;
        "pkg-forge-1.19.2-2.1.0" = _bT0JaJbw;
        "pkg-fabric-1.19.4-2.1.0" = _aaHXNC7i;
        "pkg-forge-1.19.4-2.1.0" = _TahpOXfY;
        "pkg-fabric-1.20.1-2.1.0" = _3SHhc4cO;
        "pkg-forge-1.20.1-2.1.0" = _7aIODW5e;
        "pkg-fabric-1.20.4-2.1.0" = _xxmexzx3;
        "pkg-forge-1.20.4-2.1.0" = _grCKjFQw;
        "pkg-fabric-1.21-2.1.0" = _Yp4iJ3Mv;
        "pkg-forge-1.21-2.1.0" = _vFnxjFjB;
        "pkg-neoforge-2.1.0" = _kECjTa4H;
        "pkg-spigot-2.1.1" = _Q8fE6C5q;
        "pkg-bungeecord-2.1.1" = _7cDPVZ4p;
        "pkg-velocity-2.1.1" = _2TXQQ4oL;
        "pkg-fabric-1.16.5-2.1.1" = _5vy2kacI;
        "pkg-forge-1.16.5-2.1.1" = _voWzRs4l;
        "pkg-fabric-1.17.1-2.1.1" = _WZHf5SgO;
        "pkg-forge-1.17.1-2.1.1" = _oDAeXkUP;
        "pkg-fabric-1.18.2-2.1.1" = _S9BuXOvK;
        "pkg-forge-1.18.2-2.1.1" = _LYYmlBaG;
        "pkg-fabric-1.19.2-2.1.1" = _IUGxGiD5;
        "pkg-forge-1.19.2-2.1.1" = _fxUzHVTV;
        "pkg-fabric-1.19.3-2.1.1" = _Sidq33IA;
        "pkg-forge-1.19.3-2.1.1" = _6M7rH3WH;
        "pkg-fabric-1.19.4-2.1.1" = _eY2Z6BhC;
        "pkg-forge-1.19.4-2.1.1" = _Xp5vkJGp;
        "pkg-fabric-1.20.1-2.1.1" = _9ha1XP2j;
        "pkg-forge-1.20.1-2.1.1" = _bTkiiu3o;
        "pkg-fabric-1.20.4-2.1.1" = _zOXFLhAY;
        "pkg-forge-1.20.4-2.1.1" = _5jEbcpMv;
        "pkg-fabric-1.21-2.1.1" = _jTIovJJS;
        "pkg-forge-1.21-2.1.1" = _5gLr7fwa;
        "pkg-neoforge-1.21-2.1.1" = _FQMJOyc9;
        "pkg-fabric-1.21.2-2.1.1" = _IRONrOb2;
        "pkg-neoforge-1.21.2-2.1.1" = _RygcVyzy;
        "pkg-spigot-2.1.2" = _qWsrYIHL;
        "pkg-bungeecord-2.1.2" = _ii7LUX4i;
        "pkg-velocity-2.1.2" = _1vVo1I6q;
        "pkg-fabric-1.16.5-2.1.2" = _U6BLWxl6;
        "pkg-forge-1.16.5-2.1.2" = _tWry2VB5;
        "pkg-fabric-1.17.1-2.1.2" = _of3ofXIW;
        "pkg-forge-1.17.1-2.1.2" = _YnFrGpKo;
        "pkg-fabric-1.18.2-2.1.2" = _QYdrN4lA;
        "pkg-forge-1.18.2-2.1.2" = _Ukv6jQdP;
        "pkg-fabric-1.19.2-2.1.2" = _gOYwYPds;
        "pkg-forge-1.19.2-2.1.2" = _4u79FbrB;
        "pkg-fabric-1.19.3-2.1.2" = _gOR6UnGX;
        "pkg-forge-1.19.3-2.1.2" = _pXtb2bM8;
        "pkg-fabric-1.19.4-2.1.2" = _JX9cNJPE;
        "pkg-forge-1.19.4-2.1.2" = _KPx1S2Xz;
        "pkg-fabric-1.20.1-2.1.2" = _xHiN7uay;
        "pkg-forge-1.20.1-2.1.2" = _2myH3vs2;
        "pkg-fabric-1.20.4-2.1.2" = _jNFP3CWF;
        "pkg-forge-1.20.4-2.1.2" = _x7eY7WT7;
        "pkg-fabric-1.21-2.1.2" = _wRTfGnAv;
        "pkg-forge-1.21-2.1.2" = _AqerGaZ5;
        "pkg-neoforge-1.21-2.1.2" = _3sAKacW6;
        "pkg-fabric-1.21.3-2.1.2" = _TvNrdfDV;
        "pkg-neoforge-1.21.3-2.1.2" = _o7sxQbah;
        "pkg-fabric-1.21.4-2.1.2" = _c1KEbu22;
        "pkg-neoforge-1.21.4-2.1.2" = _PRrPlioy;
        "pkg-spigot-2.1.3" = _3ta29XY1;
        "pkg-bungeecord-2.1.3" = _ztNhPyLI;
        "pkg-velocity-2.1.3" = _TANb6uoH;
        "pkg-fabric-1.16.5-2.1.3" = _WLx22DgT;
        "pkg-forge-1.16.5-2.1.3" = _BIeOEZsg;
        "pkg-fabric-1.17.1-2.1.3" = _xXpbEfzq;
        "pkg-forge-1.17.1-2.1.3" = _lVRK04ae;
        "pkg-fabric-1.18.2-2.1.3" = _wRXfZnzZ;
        "pkg-forge-1.18.2-2.1.3" = _yAyANrKP;
        "pkg-fabric-1.19.2-2.1.3" = _QjeO33Sm;
        "pkg-forge-1.19.2-2.1.3" = _mxKpruLH;
        "pkg-fabric-1.19.3-2.1.3" = _X8ZO0mOY;
        "pkg-forge-1.19.3-2.1.3" = _nrJGZGaN;
        "pkg-fabric-1.19.4-2.1.3" = _nkrxXoya;
        "pkg-forge-1.19.4-2.1.3" = _v6bMSdfT;
        "pkg-fabric-1.20.1-2.1.3" = _DtmPdKzd;
        "pkg-forge-1.20.1-2.1.3" = _5Gk8vbxB;
        "pkg-fabric-1.20.4-2.1.3" = _69odbKUJ;
        "pkg-forge-1.20.4-2.1.3" = _2EOW2JKi;
        "pkg-fabric-1.21-2.1.3" = _UCDHANKj;
        "pkg-forge-1.21-2.1.3" = _8MQ7SfwO;
        "pkg-neoforge-1.21-2.1.3" = _eq9DvUyj;
        "pkg-fabric-1.21.3-2.1.3" = _1nde4iJM;
        "pkg-neoforge-1.21.3-2.1.3" = _o9dJuAbA;
        "pkg-fabric-1.21.4-2.1.3" = _uSaOY1f6;
        "pkg-neoforge-1.21.4-2.1.3" = _Hv0n42Pd;
        "pkg-fabric-1.21.5-2.1.4+cb9658f" = _pf1ZGzbI;
        "pkg-neoforge-1.21.5-2.1.4+cb9658f" = _HExw5qn8;
        "pkg-fabric-1.21.5-2.1.4+bd8a51e" = _MF5T1aPM;
        "pkg-neoforge-1.21.5-2.1.4+bd8a51e" = _BOYGEqzL;
        "pkg-spigot-2.1.4" = _Lgvds0jj;
        "pkg-bungeecord-2.1.4" = _wvfcJLch;
        "pkg-velocity-2.1.4" = _3vREyskS;
        "pkg-fabric-1.16.5-2.1.4" = _gqamLj3V;
        "pkg-forge-1.16.5-2.1.4" = _OXN0dlwq;
        "pkg-fabric-1.17.1-2.1.4" = _FI8fFBCp;
        "pkg-forge-1.17.1-2.1.4" = _ccZFYvrY;
        "pkg-fabric-1.18.2-2.1.4" = _IxIoOK0F;
        "pkg-forge-1.18.2-2.1.4" = _HEEo4dvA;
        "pkg-fabric-1.19.2-2.1.4" = _LcTlgYap;
        "pkg-forge-1.19.2-2.1.4" = _x2oqwkFk;
        "pkg-fabric-1.19.3-2.1.4" = _n7nN8emm;
        "pkg-forge-1.19.3-2.1.4" = _70pqZUXU;
        "pkg-fabric-1.19.4-2.1.4" = _pltvrmAg;
        "pkg-forge-1.19.4-2.1.4" = _rHiX0VAg;
        "pkg-fabric-1.20.1-2.1.4" = _5AjRZxpd;
        "pkg-forge-1.20.1-2.1.4" = _7kiRvmLN;
        "pkg-fabric-1.20.4-2.1.4" = _MHBOCP92;
        "pkg-forge-1.20.4-2.1.4" = _qPMsEMHi;
        "pkg-fabric-1.21-2.1.4" = _HYC9iRhU;
        "pkg-forge-1.21-2.1.4" = _4dHjfpgI;
        "pkg-neoforge-1.21-2.1.4" = _RSClZf4O;
        "pkg-fabric-1.21.3-2.1.4" = _LNeR4Di8;
        "pkg-neoforge-1.21.3-2.1.4" = _M7sWhpk5;
        "pkg-fabric-1.21.4-2.1.4" = _Ju6WYjI8;
        "pkg-neoforge-1.21.4-2.1.4" = _MdqQy1c6;
        "pkg-fabric-1.21.5-2.1.4" = _y8UG1VMM;
        "pkg-neoforge-1.21.5-2.1.4" = _ywoIEXqI;
        "pkg-fabric-1.21.6-2.1.5+07c7c45" = _pTM3mk2l;
        "pkg-neoforge-1.21.6-2.1.5+07c7c45" = _rMnqhEAH;
        "pkg-spigot-2.1.5" = _9h9c3iOH;
        "pkg-bungeecord-2.1.5" = _muQArHDU;
        "pkg-velocity-2.1.5" = _cdahTD1Q;
        "pkg-fabric-1.16.5-2.1.5" = _PcOiIVwx;
        "pkg-forge-1.16.5-2.1.5" = _St2tjIPX;
        "pkg-fabric-1.17.1-2.1.5" = _IJQY23Bl;
        "pkg-forge-1.17.1-2.1.5" = _jLqgbNye;
        "pkg-fabric-1.18.2-2.1.5" = _A5U3nUv9;
        "pkg-forge-1.18.2-2.1.5" = _rGTld6Mt;
        "pkg-fabric-1.19.2-2.1.5" = _Dzcay8WQ;
        "pkg-forge-1.19.2-2.1.5" = _84c52IvT;
        "pkg-fabric-1.19.3-2.1.5" = _vLwR6s7l;
        "pkg-forge-1.19.3-2.1.5" = _wgynuqzM;
        "pkg-fabric-1.19.4-2.1.5" = _eJ54BFcj;
        "pkg-forge-1.19.4-2.1.5" = _l6gqRGO8;
        "pkg-fabric-1.20.1-2.1.5" = _RTD06Dql;
        "pkg-forge-1.20.1-2.1.5" = _au0uQrKa;
        "pkg-fabric-1.20.4-2.1.5" = _TEqxWzAd;
        "pkg-forge-1.20.4-2.1.5" = _cbUStiSl;
        "pkg-fabric-1.21-2.1.5" = _zoJnpTvx;
        "pkg-forge-1.21-2.1.5" = _lhAJghwa;
        "pkg-neoforge-1.21-2.1.5" = _v4oNSmk8;
        "pkg-fabric-1.21.3-2.1.5" = _qlH1ZxA8;
        "pkg-neoforge-1.21.3-2.1.5" = _TbF6NKYh;
        "pkg-fabric-1.21.4-2.1.5" = _vBm1h2pZ;
        "pkg-neoforge-1.21.4-2.1.5" = _oFkU2z0L;
        "pkg-fabric-1.21.5-2.1.5" = _5dZQM3H7;
        "pkg-neoforge-1.21.5-2.1.5" = _sJtDcrAf;
        "pkg-fabric-1.21.6-2.1.5" = _7sVwhlGV;
        "pkg-neoforge-1.21.6-2.1.5" = _FLK33Rgo;
        "pkg-neoforge-1.21.7-2.1.5" = _3dtSpi91;
        "pkg-spigot-2.1.6+60bf85a" = _aLnbX09d;
        "pkg-spigot-2.1.6" = _j9WvAurZ;
        "pkg-bungeecord-2.1.6" = _cmXdWdhX;
        "pkg-velocity-2.1.6" = _RlDhEthM;
        "pkg-fabric-1.16.5-2.1.6" = _hdkDiKGb;
        "pkg-forge-1.16.5-2.1.6" = _ly7O8idh;
        "pkg-fabric-1.17.1-2.1.6" = _HDXsfNwp;
        "pkg-forge-1.17.1-2.1.6" = _if00Mg3R;
        "pkg-fabric-1.18.2-2.1.6" = _ki7dScdc;
        "pkg-forge-1.18.2-2.1.6" = _zQMxMpmb;
        "pkg-fabric-1.19.2-2.1.6" = _qeqq4JFi;
        "pkg-forge-1.19.2-2.1.6" = _ohXy8i08;
        "pkg-fabric-1.19.3-2.1.6" = _E3kyCLUS;
        "pkg-forge-1.19.3-2.1.6" = _5ic5YRmo;
        "pkg-fabric-1.19.4-2.1.6" = _mKSFv4P1;
        "pkg-forge-1.19.4-2.1.6" = _HFNgk7F2;
        "pkg-fabric-1.20.1-2.1.6" = _gNQHF6ba;
        "pkg-forge-1.20.1-2.1.6" = _jUfq4vP0;
        "pkg-fabric-1.20.4-2.1.6" = _F6G6ocF8;
        "pkg-forge-1.20.4-2.1.6" = _8LpcuGNZ;
        "pkg-fabric-1.21-2.1.6" = _9pJwC22u;
        "pkg-forge-1.21-2.1.6" = _hkav2nhR;
        "pkg-neoforge-1.21-2.1.6" = _59VqRVbB;
        "pkg-fabric-1.21.3-2.1.6" = _z6SlDWhY;
        "pkg-neoforge-1.21.3-2.1.6" = _8WUzVSRD;
        "pkg-fabric-1.21.4-2.1.6" = _1NCfCd93;
        "pkg-neoforge-1.21.4-2.1.6" = _tNnNE16U;
        "pkg-fabric-1.21.5-2.1.6" = _b2fS2R5Q;
        "pkg-neoforge-1.21.5-2.1.6" = _bAaqNvI5;
        "pkg-fabric-1.21.6-2.1.6" = _MIuFIHON;
        "pkg-neoforge-1.21.6-2.1.6" = _nmZMQs1A;
        "pkg-neoforge-1.21.7-2.1.6" = _7XtdBofW;
        "pkg-fabric-1.21.9-2.1.6" = _BOsxfAZF;
        "pkg-neoforge-1.21.9-2.1.6" = _PqWXvnFj;
        "pkg-neoforge-1.21.9-2.1.7+e36dc60" = _7tmmc2qC;
        "pkg-fabric-1.21.9-2.1.7+c9fe3b7" = _TIyJGIJE;
        "pkg-neoforge-1.21.9-2.1.7+c9fe3b7" = _Ifsk3Sri;
        "pkg-spigot-2.1.7" = _KQRGwiy5;
        "pkg-bungeecord-2.1.7" = _Jvb9inJx;
        "pkg-velocity-2.1.7" = _OikdB2Xc;
        "pkg-fabric-1.16.5-2.1.7" = _xtenUuO9;
        "pkg-forge-1.16.5-2.1.7" = _WgsYZLja;
        "pkg-fabric-1.17.1-2.1.7" = _QiE7NzVV;
        "pkg-forge-1.17.1-2.1.7" = _Ur2EAXF1;
        "pkg-fabric-1.18.2-2.1.7" = _52lH13dG;
        "pkg-forge-1.18.2-2.1.7" = _ZyD7MQYV;
        "pkg-fabric-1.19.2-2.1.7" = _zihDtgWz;
        "pkg-forge-1.19.2-2.1.7" = _GDOiHjmV;
        "pkg-fabric-1.19.3-2.1.7" = _fflRednp;
        "pkg-forge-1.19.3-2.1.7" = _Aqf73lfg;
        "pkg-fabric-1.19.4-2.1.7" = _UrDN4uLT;
        "pkg-forge-1.19.4-2.1.7" = _DCNpLeLd;
        "pkg-fabric-1.20.1-2.1.7" = _7zRVldLZ;
        "pkg-forge-1.20.1-2.1.7" = _HP6oCYxw;
        "pkg-fabric-1.20.4-2.1.7" = _rYdiWoJd;
        "pkg-forge-1.20.4-2.1.7" = _IpVjMCHm;
        "pkg-fabric-1.21-2.1.7" = _kc92MYof;
        "pkg-forge-1.21-2.1.7" = _F7NsmLl3;
        "pkg-neoforge-1.21-2.1.7" = _3OsysJDF;
        "pkg-fabric-1.21.3-2.1.7" = _8Dbxwhu6;
        "pkg-neoforge-1.21.3-2.1.7" = _LQvKVIb2;
        "pkg-fabric-1.21.4-2.1.7" = _3zeJDQjH;
        "pkg-neoforge-1.21.4-2.1.7" = _MQmnsCAe;
        "pkg-fabric-1.21.5-2.1.7" = _1i5dE49d;
        "pkg-neoforge-1.21.5-2.1.7" = _oQ7mxyEM;
        "pkg-fabric-1.21.6-2.1.7" = _51jwGWOo;
        "pkg-neoforge-1.21.6-2.1.7" = _vF9wv1fA;
        "pkg-neoforge-1.21.7-2.1.7" = _n8fQAAsO;
        "pkg-fabric-1.21.9-2.1.7" = _F9Q91QmG;
        "pkg-neoforge-1.21.9-2.1.7" = _rc8I1XlQ;
        "pkg-fabric-1.21.11-2.1.7" = _ISlqMUTC;
        "pkg-neoforge-1.21.11-2.1.7" = _3dg77MTG;
        "pkg-spigot-2.1.8" = _SKgeYMeH;
        "pkg-bungeecord-2.1.8" = _F9ppdUNB;
        "pkg-velocity-2.1.8" = _xNuolO2M;
        "pkg-fabric-1.16.5-2.1.8" = _VuTt1NJL;
        "pkg-forge-1.16.5-2.1.8" = _WzpQv66D;
        "pkg-fabric-1.17.1-2.1.8" = _WKF1GIfQ;
        "pkg-forge-1.17.1-2.1.8" = _k5aDKrav;
        "pkg-fabric-1.18.2-2.1.8" = _3C9Nmi07;
        "pkg-forge-1.18.2-2.1.8" = _sjezMVT8;
        "pkg-fabric-1.19.2-2.1.8" = _BAQ3Znyi;
        "pkg-forge-1.19.2-2.1.8" = _SYdhTbJ7;
        "pkg-fabric-1.19.3-2.1.8" = _w8lQIoOu;
        "pkg-forge-1.19.3-2.1.8" = _Qz2meYtM;
        "pkg-fabric-1.19.4-2.1.8" = _8ZYrgSuL;
        "pkg-forge-1.19.4-2.1.8" = _5HyUbLv6;
        "pkg-fabric-1.20.1-2.1.8" = _UuAhG6Wf;
        "pkg-forge-1.20.1-2.1.8" = _t7HenBce;
        "pkg-fabric-1.20.4-2.1.8" = _yud7oif5;
        "pkg-forge-1.20.4-2.1.8" = _XeVu4G7G;
        "pkg-fabric-1.21-2.1.8" = _ZbxxzdUj;
        "pkg-forge-1.21-2.1.8" = _gBtlsNhw;
        "pkg-neoforge-1.21-2.1.8" = _k1eAJFsl;
        "pkg-fabric-1.21.3-2.1.8" = _ZgaGmbtf;
        "pkg-neoforge-1.21.3-2.1.8" = _vSSc2pqg;
        "pkg-fabric-1.21.4-2.1.8" = _hPWe9u5F;
        "pkg-neoforge-1.21.4-2.1.8" = _81uxZFRd;
        "pkg-fabric-1.21.5-2.1.8" = _fzenktTg;
        "pkg-neoforge-1.21.5-2.1.8" = _oOOKff9Q;
        "pkg-fabric-1.21.6-2.1.8" = _v5irHzkg;
        "pkg-neoforge-1.21.6-2.1.8" = _A6Lcjsjq;
        "pkg-neoforge-1.21.7-2.1.8" = _DDfqn563;
        "pkg-fabric-1.21.9-2.1.8" = _W5v3VgoJ;
        "pkg-neoforge-1.21.9-2.1.8" = _F4kIceic;
        "pkg-fabric-1.21.11-2.1.8" = _4gN2P9j6;
        "pkg-neoforge-1.21.11-2.1.8" = _AKDH2FDz;
        "pkg-fabric-26.1-2.1.9+9b97125" = _dzv0C6km;
        "pkg-neoforge-26.1-2.1.9+9b97125" = _cgPaSXba;
        "pkg-spigot-2.1.9" = _9nJosuoO;
        "pkg-bungeecord-2.1.9" = _NUqL7OUg;
        "pkg-velocity-2.1.9" = _lfHpwrXI;
        "pkg-fabric-1.16.5-2.1.9" = _iyoPkY4k;
        "pkg-forge-1.16.5-2.1.9" = _IUTD70ad;
        "pkg-fabric-26.1-2.1.9" = _1MYZbMc5;
        "pkg-neoforge-26.1-2.1.9" = _cjwr6JyI;
        "pkg-fabric-1.17.1-2.1.9" = _pPWEMg2c;
        "pkg-forge-1.17.1-2.1.9" = _8QIBZ9kz;
        "pkg-fabric-1.18.2-2.1.9" = _f1XQNIs1;
        "pkg-forge-1.18.2-2.1.9" = _yFUPOikR;
        "pkg-fabric-1.19.2-2.1.9" = _33rzbSWa;
        "pkg-forge-1.19.2-2.1.9" = _FbTKi9K7;
        "pkg-fabric-1.19.3-2.1.9" = _jYJwirUo;
        "pkg-forge-1.19.3-2.1.9" = _e5sAZj2F;
        "pkg-fabric-1.19.4-2.1.9" = _8JwcRZkj;
        "pkg-forge-1.19.4-2.1.9" = _V0LVAxFz;
        "pkg-fabric-1.20.1-2.1.9" = _1onBLPuL;
        "pkg-forge-1.20.1-2.1.9" = _WpIuiKO6;
        "pkg-fabric-1.20.4-2.1.9" = _LIljONJh;
        "pkg-forge-1.20.4-2.1.9" = _1AuJLp7A;
        "pkg-fabric-1.21.1-2.1.9" = _yDeFZILQ;
        "pkg-forge-1.21.1-2.1.9" = _JpX5NJJe;
        "pkg-neoforge-1.21.1-2.1.9" = _LktH7OhI;
        "pkg-fabric-1.21.4-2.1.9" = _hIqVVndg;
        "pkg-neoforge-1.21.4-2.1.9" = _F31mlXoO;
        "pkg-fabric-1.21.6-2.1.9" = _B2yGOZ6R;
        "pkg-neoforge-1.21.6-2.1.9" = _TpGhTv7W;
        "pkg-neoforge-1.21.7-2.1.9" = _rl4CaJ3l;
        "pkg-fabric-1.21.11-2.1.9" = _h3lX3MGi;
        "pkg-neoforge-1.21.11-2.1.9" = _OwoMvw9L;
        "pkg-spigot-2.1.10" = _TTanWC5X;
        "pkg-bungeecord-2.1.10" = _KsQ16il6;
        "pkg-velocity-2.1.10" = _d79Foy1l;
        "pkg-fabric-1.16.5-2.1.10" = _jY4JjOGf;
        "pkg-forge-1.16.5-2.1.10" = _8Lw1e1PU;
        "pkg-fabric-1.17.1-2.1.10" = _BZLMMmoK;
        "pkg-forge-1.17.1-2.1.10" = _T13ylekA;
        "pkg-fabric-1.18.2-2.1.10" = _z37oCvto;
        "pkg-forge-1.18.2-2.1.10" = _if5WnRni;
        "pkg-fabric-1.19.2-2.1.10" = _6lsLYjab;
        "pkg-forge-1.19.2-2.1.10" = _eJTr0G2k;
        "pkg-fabric-1.19.3-2.1.10" = _3NhMUIyh;
        "pkg-forge-1.19.3-2.1.10" = _HHG1Tf0n;
        "pkg-fabric-1.19.4-2.1.10" = _sP9UkUVY;
        "pkg-forge-1.19.4-2.1.10" = _gZfOXxwx;
        "pkg-fabric-1.20.1-2.1.10" = _GoZNZCrA;
        "pkg-forge-1.20.1-2.1.10" = _3fdVR3eA;
        "pkg-fabric-1.20.4-2.1.10" = _x3Ou3vPP;
        "pkg-forge-1.20.4-2.1.10" = _MD3McGI6;
        "pkg-fabric-1.21.1-2.1.10" = _b78ntfSB;
        "pkg-forge-1.21.1-2.1.10" = _EBDOKPY6;
        "pkg-neoforge-1.21.1-2.1.10" = _VCkY6lDY;
        "pkg-fabric-1.21.4-2.1.10" = _zGItpWNH;
        "pkg-neoforge-1.21.4-2.1.10" = _YU5Kyxi7;
        "pkg-fabric-1.21.6-2.1.10" = _ibhGyOSc;
        "pkg-neoforge-1.21.6-2.1.10" = _1PRSts7M;
        "pkg-neoforge-1.21.7-2.1.10" = _5ZNPTJO4;
        "pkg-fabric-1.21.11-2.1.10" = _CKEApCo4;
        "pkg-neoforge-1.21.11-2.1.10" = _ibbYNj2F;
        "pkg-fabric-26.1-2.1.10" = _ajXKELcG;
        "pkg-neoforge-26.1-2.1.10" = _RWEC3CWG;
        "pkg-fabric-26.2-2.1.10" = _LJQibu4m;
        "pkg-neoforge-26.2-2.1.10" = _eSjVih1K;
        "pkg-spigot-2.1.11" = _3988VOak;
        "pkg-bungeecord-2.1.11" = _MJB78Uc1;
        "pkg-velocity-2.1.11" = _2eHqlULj;
        "pkg-fabric-1.16.5-2.1.11" = _jsnAWm8z;
        "pkg-forge-1.16.5-2.1.11" = _BGyn9gGV;
        "pkg-fabric-1.17.1-2.1.11" = _5Mkktfwz;
        "pkg-forge-1.17.1-2.1.11" = _OKIFC98Q;
        "pkg-fabric-1.18.2-2.1.11" = _4XNJbidI;
        "pkg-forge-1.18.2-2.1.11" = _j2irnIq4;
        "pkg-fabric-1.19.2-2.1.11" = _1T5OgMBY;
        "pkg-forge-1.19.2-2.1.11" = _pPM2b6vA;
        "pkg-fabric-1.19.3-2.1.11" = _YXTL0drP;
        "pkg-forge-1.19.3-2.1.11" = _vEhjDUQX;
        "pkg-fabric-1.19.4-2.1.11" = _7s4MnTfg;
        "pkg-forge-1.19.4-2.1.11" = _R7Vna1RF;
        "pkg-fabric-1.20.1-2.1.11" = _lbKN6JlV;
        "pkg-forge-1.20.1-2.1.11" = _qMPwi9Np;
        "pkg-fabric-1.20.4-2.1.11" = _cu1LsFKI;
        "pkg-forge-1.20.4-2.1.11" = _HbvT7066;
        "pkg-fabric-1.21.1-2.1.11" = _DpmltJB6;
        "pkg-forge-1.21.1-2.1.11" = _X4fkgWHx;
        "pkg-neoforge-1.21.1-2.1.11" = _31SC8cYL;
        "pkg-fabric-1.21.4-2.1.11" = _Yp0ELBUG;
        "pkg-neoforge-1.21.4-2.1.11" = _Gf9Fy6vl;
        "pkg-fabric-1.21.6-2.1.11" = _dthrDxcm;
        "pkg-neoforge-1.21.6-2.1.11" = _G1q9Faep;
        "pkg-neoforge-1.21.7-2.1.11" = _FWtwYUQV;
        "pkg-fabric-1.21.11-2.1.11" = _AWRk5h1c;
        "pkg-neoforge-1.21.11-2.1.11" = _8uGcKJj9;
        "pkg-fabric-26.1-2.1.11" = _didkkzgN;
        "pkg-neoforge-26.1-2.1.11" = _Y4anHjZM;
        "pkg-fabric-26.2-2.1.11" = _pO7Ln7bw;
        "pkg-neoforge-26.2-2.1.11" = _tKkWHIRB;
        "pkg-spigot-2.1.12" = _l4EpFiPh;
        "pkg-bungeecord-2.1.12" = _jnOy7pGG;
        "pkg-velocity-2.1.12" = _xm04YSU9;
        "pkg-fabric-1.16.5-2.1.12" = _H43SXVLl;
        "pkg-forge-1.16.5-2.1.12" = _sbfzHgop;
        "pkg-fabric-1.17.1-2.1.12" = _kcBEvii8;
        "pkg-forge-1.17.1-2.1.12" = _M53fQm64;
        "pkg-fabric-1.18.2-2.1.12" = _pkM8VRll;
        "pkg-forge-1.18.2-2.1.12" = _JDXpv5vH;
        "pkg-fabric-1.19.2-2.1.12" = _Ua9yPBqn;
        "pkg-forge-1.19.2-2.1.12" = _weLmvavG;
        "pkg-fabric-1.19.3-2.1.12" = _NOL0ydBv;
        "pkg-forge-1.19.3-2.1.12" = _iqmfLvLy;
        "pkg-fabric-1.19.4-2.1.12" = _1MeCTyBK;
        "pkg-forge-1.19.4-2.1.12" = _3yNRytII;
        "pkg-fabric-1.20.1-2.1.12" = _2NSfNCGy;
        "pkg-forge-1.20.1-2.1.12" = _iM0wgI7P;
        "pkg-fabric-1.20.4-2.1.12" = _Aoa3y5qP;
        "pkg-forge-1.20.4-2.1.12" = _5nwAeXfK;
        "pkg-fabric-1.21.1-2.1.12" = _IelCKJiG;
        "pkg-forge-1.21.1-2.1.12" = _xSaMIq1s;
        "pkg-neoforge-1.21.1-2.1.12" = _zsUh2SkP;
        "pkg-fabric-1.21.4-2.1.12" = _wFZVXbNZ;
        "pkg-neoforge-1.21.4-2.1.12" = _Af1zgcAh;
        "pkg-fabric-1.21.6-2.1.12" = _WznClie5;
        "pkg-neoforge-1.21.6-2.1.12" = _8XMRLdFs;
        "pkg-neoforge-1.21.7-2.1.12" = _FnZIxjgt;
        "pkg-fabric-1.21.11-2.1.12" = _YsGOnsoV;
        "pkg-neoforge-1.21.11-2.1.12" = _nk0Ee25E;
        "pkg-fabric-26.1-2.1.12" = _fSyuGGCB;
        "pkg-neoforge-26.1-2.1.12" = _gJjjEAe3;
        "pkg-fabric-26.2-2.1.12" = _le0wbIWY;
        "pkg-neoforge-26.2-2.1.12" = _8PPlSIiV;
        "pkg-spigot-2.1.13" = _arX8C9vY;
        "pkg-bungeecord-2.1.13" = _jSDUUFCr;
        "pkg-velocity-2.1.13" = _t3nN17Ev;
        "pkg-fabric-1.16.5-2.1.13" = _Ij2elt8R;
        "pkg-forge-1.16.5-2.1.13" = _tPJg09C2;
        "pkg-fabric-1.17.1-2.1.13" = _IPv9YCVc;
        "pkg-forge-1.17.1-2.1.13" = _7QR2J5Bt;
        "pkg-fabric-1.18.2-2.1.13" = _MbibXOPy;
        "pkg-forge-1.18.2-2.1.13" = _k7CXavOl;
        "pkg-fabric-1.19.2-2.1.13" = _yBfkXUg0;
        "pkg-forge-1.19.2-2.1.13" = _zPEvEz2Z;
        "pkg-fabric-1.19.3-2.1.13" = _KCLwNGjY;
        "pkg-forge-1.19.3-2.1.13" = _INVim1qx;
        "pkg-fabric-1.19.4-2.1.13" = _ZXfdIGXS;
        "pkg-forge-1.19.4-2.1.13" = _NFxjp9we;
        "pkg-fabric-1.20.1-2.1.13" = _o72IGP6K;
        "pkg-forge-1.20.1-2.1.13" = _sQEBy4Ef;
        "pkg-fabric-1.20.4-2.1.13" = _H3PWQ63j;
        "pkg-forge-1.20.4-2.1.13" = _27JVC9yW;
        "pkg-fabric-1.21.1-2.1.13" = _OVMaXvhD;
        "pkg-forge-1.21.1-2.1.13" = _wws6wiG0;
        "pkg-neoforge-1.21.1-2.1.13" = _SCojmeXV;
        "pkg-fabric-1.21.4-2.1.13" = _3iStsEQC;
        "pkg-neoforge-1.21.4-2.1.13" = _x652wC4N;
        "pkg-fabric-1.21.6-2.1.13" = _T4febEI0;
        "pkg-neoforge-1.21.6-2.1.13" = _UI2zXAdl;
        "pkg-neoforge-1.21.7-2.1.13" = _2X6jioz2;
        "pkg-fabric-1.21.11-2.1.13" = _6tbEbkDm;
        "pkg-neoforge-1.21.11-2.1.13" = _KpagoHsC;
        "pkg-fabric-26.1-2.1.13" = _ggHxxQLq;
        "pkg-neoforge-26.1-2.1.13" = _hQUn5Pk3;
        "pkg-fabric-26.2-2.1.13" = _22NbJoJF;
        "pkg-neoforge-26.2-2.1.13" = _Wq2hKmnW;
        "pkg-spigot-2.1.14" = _KJD8nTAZ;
        "pkg-bungeecord-2.1.14" = _28EcEYsd;
        "pkg-velocity-2.1.14" = _XPIZBgyz;
        "pkg-fabric-1.16.5-2.1.14" = _wRiW4NnR;
        "pkg-forge-1.16.5-2.1.14" = _tzzU8EzB;
        "pkg-fabric-1.17.1-2.1.14" = _AE2cxAc3;
        "pkg-forge-1.17.1-2.1.14" = _sFJgTrLB;
        "pkg-fabric-1.18.2-2.1.14" = _kqGDlNSu;
        "pkg-forge-1.18.2-2.1.14" = _v7nwsoPQ;
        "pkg-fabric-1.19.2-2.1.14" = _mR1hnwer;
        "pkg-forge-1.19.2-2.1.14" = _29lvrSHv;
        "pkg-fabric-1.19.3-2.1.14" = _3nLSUb13;
        "pkg-forge-1.19.3-2.1.14" = _25ftWLAV;
        "pkg-fabric-1.19.4-2.1.14" = _P53oUMXe;
        "pkg-forge-1.19.4-2.1.14" = _WHTX06Lj;
        "pkg-fabric-1.20.1-2.1.14" = _iAE1giJO;
        "pkg-forge-1.20.1-2.1.14" = _42KRvgDT;
        "pkg-fabric-1.20.4-2.1.14" = _wSSG58we;
        "pkg-forge-1.20.4-2.1.14" = _rNKWUXSS;
        "pkg-fabric-1.21.1-2.1.14" = _xClPuKir;
        "pkg-forge-1.21.1-2.1.14" = _LzBZEz79;
        "pkg-neoforge-1.21.1-2.1.14" = _iqRDCQnJ;
        "pkg-fabric-1.21.4-2.1.14" = _RdWIzDp3;
        "pkg-neoforge-1.21.4-2.1.14" = _dH3F1c8o;
        "pkg-fabric-1.21.6-2.1.14" = _1c2kfg5y;
        "pkg-neoforge-1.21.6-2.1.14" = _u2OSUbY5;
        "pkg-neoforge-1.21.7-2.1.14" = _G5FRe7on;
        "pkg-fabric-1.21.11-2.1.14" = _hk5FJncK;
        "pkg-neoforge-1.21.11-2.1.14" = _KofFjmN9;
        "pkg-fabric-26.1-2.1.14" = _91nSPr0m;
        "pkg-neoforge-26.1-2.1.14" = _SBrE7yag;
        "pkg-fabric-26.2-2.1.14" = _Yl9Ihcy7;
        "pkg-neoforge-26.2-2.1.14" = _MysrqwIr;
        "pkg-spigot-2.1.15" = _bj9hL35f;
        "pkg-bungeecord-2.1.15" = _ZuM68NFv;
        "pkg-velocity-2.1.15" = _ITaGfo8d;
        "pkg-fabric-1.16.5-2.1.15" = _bWySdM3F;
        "pkg-forge-1.16.5-2.1.15" = _erXORs0C;
        "pkg-fabric-1.17.1-2.1.15" = _aRFfBL12;
        "pkg-forge-1.17.1-2.1.15" = _edOKResC;
        "pkg-fabric-1.18.2-2.1.15" = _4VveJs6B;
        "pkg-forge-1.18.2-2.1.15" = _GPqTAiUq;
        "pkg-fabric-1.19.2-2.1.15" = _BMOOX8vT;
        "pkg-forge-1.19.2-2.1.15" = _NNfNFU3s;
        "pkg-fabric-1.19.3-2.1.15" = _XUiPg8Qs;
        "pkg-forge-1.19.3-2.1.15" = _jQLD26Mw;
        "pkg-fabric-1.19.4-2.1.15" = _DHO48gFs;
        "pkg-forge-1.19.4-2.1.15" = _6GYjV2O8;
        "pkg-fabric-1.20.1-2.1.15" = _9IP2ZuLR;
        "pkg-forge-1.20.1-2.1.15" = _PilOaFGj;
        "pkg-fabric-1.20.4-2.1.15" = _A4Vxj7G6;
        "pkg-forge-1.20.4-2.1.15" = _ynOVDR1M;
        "pkg-fabric-1.21.1-2.1.15" = _mUYm8WtG;
        "pkg-forge-1.21.1-2.1.15" = _Jtf457xT;
        "pkg-neoforge-1.21.1-2.1.15" = _c5AsOWDn;
        "pkg-fabric-1.21.4-2.1.15" = _pAEVbuUE;
        "pkg-neoforge-1.21.4-2.1.15" = _xOrQKg3v;
        "pkg-fabric-1.21.6-2.1.15" = _ThTacY6v;
        "pkg-neoforge-1.21.6-2.1.15" = _EUIYFwX1;
        "pkg-neoforge-1.21.7-2.1.15" = _YbxhowCB;
        "pkg-fabric-1.21.11-2.1.15" = _wdPwqY6d;
        "pkg-neoforge-1.21.11-2.1.15" = _8Qlk9FFo;
        "pkg-fabric-26.1-2.1.15" = _SUneHxyL;
        "pkg-neoforge-26.1-2.1.15" = _7ISGzuHZ;
        "pkg-fabric-26.2-2.1.15" = _fyTfip1f;
        "pkg-neoforge-26.2-2.1.15" = _mAAkrTAY;
        "pkg-spigot-2.1.16" = _YnC4RoiW;
        "pkg-bungeecord-2.1.16" = _bV5M16rm;
        "pkg-velocity-2.1.16" = _yhqObhdn;
        "pkg-fabric-1.16.5-2.1.16" = _d5Vq7GSV;
        "pkg-forge-1.16.5-2.1.16" = _YiBCQScq;
        "pkg-fabric-1.17.1-2.1.16" = _BwNfJoyR;
        "pkg-forge-1.17.1-2.1.16" = _cVpdCT2c;
        "pkg-fabric-1.18.2-2.1.16" = _4UeRfXob;
        "pkg-forge-1.18.2-2.1.16" = _j5R8B4pJ;
        "pkg-fabric-1.19.2-2.1.16" = _3YFYlhdI;
        "pkg-forge-1.19.2-2.1.16" = _LszICBuk;
        "pkg-fabric-1.19.3-2.1.16" = _yWKD7lxE;
        "pkg-forge-1.19.3-2.1.16" = _SSWUGmzC;
        "pkg-fabric-1.19.4-2.1.16" = _fBptF4bl;
        "pkg-forge-1.19.4-2.1.16" = _dCB1vtKG;
        "pkg-fabric-1.20.1-2.1.16" = _LaqosLyL;
        "pkg-forge-1.20.1-2.1.16" = _xEF4ahI1;
        "pkg-fabric-1.20.4-2.1.16" = _7rR9vGWu;
        "pkg-forge-1.20.4-2.1.16" = _OVpcr8sH;
        "pkg-fabric-1.21.1-2.1.16" = _ooF8VCUr;
        "pkg-forge-1.21.1-2.1.16" = _4RTbfv5W;
        "pkg-neoforge-1.21.1-2.1.16" = _zMpeWebP;
        "pkg-fabric-1.21.4-2.1.16" = _HZce3iub;
        "pkg-neoforge-1.21.4-2.1.16" = _X94OfJee;
        "pkg-fabric-1.21.6-2.1.16" = _BNGudqPQ;
        "pkg-neoforge-1.21.6-2.1.16" = _3hJBCtvh;
        "pkg-neoforge-1.21.7-2.1.16" = _Jm8d2JVF;
        "pkg-fabric-1.21.11-2.1.16" = _RgGsgKhS;
        "pkg-neoforge-1.21.11-2.1.16" = _FWwLJCVL;
        "pkg-fabric-26.1-2.1.16" = _VShrR3w9;
        "pkg-neoforge-26.1-2.1.16" = _rZSt1qmN;
        "pkg-fabric-26.2-2.1.16" = _I0T9OQcy;
        "pkg-neoforge-26.2-2.1.16" = _Y3SygC4h;
        "pkg-spigot-2.1.17" = _DySKquus;
        "pkg-bungeecord-2.1.17" = _44fnPRkZ;
        "pkg-velocity-2.1.17" = _Zh4xxdjc;
        "pkg-fabric-1.16.5-2.1.17" = _gEu4XS1L;
        "pkg-forge-1.16.5-2.1.17" = _sVbz4VTK;
        "pkg-fabric-1.17.1-2.1.17" = _fHEQPw5a;
        "pkg-forge-1.17.1-2.1.17" = _bHsbPNxp;
        "pkg-fabric-1.18.2-2.1.17" = _wwrYyVoj;
        "pkg-forge-1.18.2-2.1.17" = _agUvymvl;
        "pkg-fabric-1.19.2-2.1.17" = _MRO4EUl3;
        "pkg-forge-1.19.2-2.1.17" = _F1VKyzib;
        "pkg-fabric-1.19.3-2.1.17" = _tLodvyUL;
        "pkg-forge-1.19.3-2.1.17" = _8v1jTdZF;
        "pkg-fabric-1.19.4-2.1.17" = _UcXNz7M6;
        "pkg-forge-1.19.4-2.1.17" = _7qYx9ePB;
        "pkg-fabric-1.20.1-2.1.17" = _rFDDAPes;
        "pkg-forge-1.20.1-2.1.17" = _KoHwlbDf;
        "pkg-fabric-1.20.4-2.1.17" = _VsQ7zzMT;
        "pkg-forge-1.20.4-2.1.17" = _emtfYObu;
        "pkg-fabric-1.21.1-2.1.17" = _6Q2QmcUp;
        "pkg-forge-1.21.1-2.1.17" = _lkNAkqrJ;
        "pkg-neoforge-1.21.1-2.1.17" = _97HOKGM0;
        "pkg-fabric-1.21.4-2.1.17" = _zueqcgC8;
        "pkg-neoforge-1.21.4-2.1.17" = _8rd5gky9;
        "pkg-fabric-1.21.6-2.1.17" = _FoUzQj6E;
        "pkg-neoforge-1.21.6-2.1.17" = _2te5OiFQ;
        "pkg-neoforge-1.21.7-2.1.17" = _6tIx8oXd;
        "pkg-fabric-1.21.11-2.1.17" = _eK4Sv4pO;
        "pkg-neoforge-1.21.11-2.1.17" = _u1ZZ3y0Y;
        "pkg-fabric-26.1-2.1.17" = _AWrwR3ci;
        "pkg-neoforge-26.1-2.1.17" = _xRZUtLOh;
        "pkg-fabric-26.2-2.1.17" = _lmQvyHuY;
        "pkg-neoforge-26.2-2.1.17" = _QqZ4grre;
        "pkg-fabric-26.3-2.1.17" = _vKP6gBRn;
        "pkg-neoforge-26.3-2.1.17" = _l4DODz7G;
        "default" = _l4DODz7G;
    });
