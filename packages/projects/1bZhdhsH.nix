...
let
    ...
    in {
        ...
        "fabric-1.17.1" = _BwNfJoyR;
        "fabric-1.16.4" = _9Zgx9Y3d;
        "fabric-1.16.5" = _d5Vq7GSV;
        "fabric-1.18" = _GDqzd1zx;
        "fabric-1.18.1" = _acFZc9lT;
        "fabric-1.18.2" = _4UeRfXob;
        "fabric-1.19" = _3YFYlhdI;
        "fabric-1.19.1" = _3YFYlhdI;
        "fabric-1.19.2" = _3YFYlhdI;
        "fabric-1.19.3" = _yWKD7lxE;
        "fabric-1.19.4" = _fBptF4bl;
        "fabric-1.20" = _LaqosLyL;
        "fabric-1.20.1" = _LaqosLyL;
        "fabric-1.20.2" = _7rR9vGWu;
        "fabric-1.20.3" = _7rR9vGWu;
        "fabric-1.20.4" = _7rR9vGWu;
        "fabric-1.20.5" = _PkoAnEu8;
        "fabric-1.20.6" = _CwMlzZgx;
        "fabric-1.21" = _ooF8VCUr;
        "fabric-1.21.1" = _ooF8VCUr;
        "fabric-1.21.2" = _ZgaGmbtf;
        "fabric-1.21.3" = _ZgaGmbtf;
        "fabric-1.21.4" = _HZce3iub;
        "fabric-1.21.5" = _fzenktTg;
        "fabric-1.21.6" = _BNGudqPQ;
        "fabric-1.21.7" = _BNGudqPQ;
        "fabric-1.21.8" = _BNGudqPQ;
        "fabric-1.21.9" = _W5v3VgoJ;
        "fabric-1.21.10" = _W5v3VgoJ;
        "fabric-1.21.11" = _RgGsgKhS;
        "fabric-26.1" = _VShrR3w9;
        "fabric-26.1.1" = _VShrR3w9;
        "fabric-26.1.2" = _VShrR3w9;
        "fabric-26.2" = _I0T9OQcy;
        "forge-1.17" = _UWzwfmfX;
        "forge-1.17.1" = _cVpdCT2c;
        "forge-1.16.4" = _KwUIvqax;
        "forge-1.16.5" = _YiBCQScq;
        "forge-1.18" = _yVLotUOR;
        "forge-1.18.1" = _iwzUwLGb;
        "forge-1.18.2" = _j5R8B4pJ;
        "forge-1.19" = _LszICBuk;
        "forge-1.19.1" = _LszICBuk;
        "forge-1.19.2" = _LszICBuk;
        "forge-1.19.3" = _SSWUGmzC;
        "forge-1.19.4" = _dCB1vtKG;
        "forge-1.20" = _xEF4ahI1;
        "forge-1.20.1" = _xEF4ahI1;
        "forge-1.20.4" = _OVpcr8sH;
        "forge-1.21" = _4RTbfv5W;
        "forge-1.21.1" = _4RTbfv5W;
        "forge-1.20.2" = _OVpcr8sH;
        "forge-1.20.3" = _OVpcr8sH;
        "paper-1.16.4" = _NtkK86vk;
        "paper-1.16.5" = _YnC4RoiW;
        "paper-1.17" = _NtkK86vk;
        "paper-1.17.1" = _YnC4RoiW;
        "paper-1.18" = _NtkK86vk;
        "paper-1.18.1" = _NtkK86vk;
        "paper-1.18.2" = _YnC4RoiW;
        "paper-1.19" = _NtkK86vk;
        "paper-1.19.1" = _NtkK86vk;
        "paper-1.19.2" = _YnC4RoiW;
        "paper-1.19.3" = _aLnbX09d;
        "paper-1.19.4" = _YnC4RoiW;
        "paper-1.20" = _oD2bUPCy;
        "paper-1.20.1" = _YnC4RoiW;
        "paper-1.20.2" = _oD2bUPCy;
        "paper-1.20.3" = _oD2bUPCy;
        "paper-1.20.4" = _YnC4RoiW;
        "paper-1.20.5" = _oD2bUPCy;
        "paper-1.20.6" = _oD2bUPCy;
        "paper-1.21" = _YnC4RoiW;
        "paper-1.21.1" = _YnC4RoiW;
        "paper-1.21.2" = _YnC4RoiW;
        "paper-1.21.3" = _YnC4RoiW;
        "paper-1.21.4" = _YnC4RoiW;
        "paper-1.21.5" = _YnC4RoiW;
        "paper-1.21.6" = _YnC4RoiW;
        "paper-1.21.7" = _YnC4RoiW;
        "paper-1.21.8" = _YnC4RoiW;
        "paper-1.21.9" = _YnC4RoiW;
        "paper-1.21.10" = _YnC4RoiW;
        "paper-1.21.11" = _YnC4RoiW;
        "paper-26.1" = _YnC4RoiW;
        "paper-26.1.1" = _YnC4RoiW;
        "paper-26.1.2" = _YnC4RoiW;
        "paper-26.2" = _YnC4RoiW;
        ...
        "spigot-1.16.5" = _YnC4RoiW;
        "spigot-1.17" = _NtkK86vk;
        "spigot-1.17.1" = _YnC4RoiW;
        "spigot-1.18" = _NtkK86vk;
        "spigot-1.18.1" = _NtkK86vk;
        "spigot-1.18.2" = _YnC4RoiW;
        "spigot-1.19" = _NtkK86vk;
        "spigot-1.19.1" = _NtkK86vk;
        "spigot-1.19.2" = _YnC4RoiW;
        "spigot-1.19.3" = _aLnbX09d;
        "spigot-1.19.4" = _YnC4RoiW;
        "spigot-1.20" = _oD2bUPCy;
        "spigot-1.20.1" = _YnC4RoiW;
        "spigot-1.20.2" = _oD2bUPCy;
        "spigot-1.20.3" = _oD2bUPCy;
        "spigot-1.20.4" = _YnC4RoiW;
        "spigot-1.20.5" = _oD2bUPCy;
        "spigot-1.20.6" = _oD2bUPCy;
        "spigot-1.21" = _YnC4RoiW;
        "spigot-1.21.1" = _YnC4RoiW;
        "spigot-1.21.2" = _YnC4RoiW;
        "spigot-1.21.3" = _YnC4RoiW;
        "spigot-1.21.4" = _YnC4RoiW;
        "spigot-1.21.5" = _YnC4RoiW;
        "spigot-1.21.6" = _YnC4RoiW;
        "spigot-1.21.7" = _YnC4RoiW;
        "spigot-1.21.8" = _YnC4RoiW;
        "spigot-1.21.9" = _YnC4RoiW;
        "spigot-1.21.10" = _YnC4RoiW;
        "spigot-1.21.11" = _YnC4RoiW;
        "spigot-26.1" = _YnC4RoiW;
        "spigot-26.1.1" = _YnC4RoiW;
        "spigot-26.1.2" = _YnC4RoiW;
        "spigot-26.2" = _YnC4RoiW;
        "bungeecord-1.19.2" = _bV5M16rm;
        "bungeecord-1.19.3" = _ITnADYQK;
        "bungeecord-1.19.4" = _bV5M16rm;
        "bungeecord-1.20" = _ITnADYQK;
        "bungeecord-1.20.1" = _bV5M16rm;
        "bungeecord-1.20.2" = _ITnADYQK;
        "bungeecord-1.20.3" = _ITnADYQK;
        "bungeecord-1.20.4" = _bV5M16rm;
        "bungeecord-1.20.5" = _ITnADYQK;
        "bungeecord-1.20.6" = _ITnADYQK;
        "bungeecord-1.21" = _bV5M16rm;
        "bungeecord-1.16.5" = _bV5M16rm;
        "bungeecord-1.17.1" = _bV5M16rm;
        "bungeecord-1.18.2" = _bV5M16rm;
        "bungeecord-1.21.1" = _bV5M16rm;
        "bungeecord-1.21.2" = _bV5M16rm;
        "bungeecord-1.21.3" = _bV5M16rm;
        "bungeecord-1.21.4" = _bV5M16rm;
        "bungeecord-1.21.5" = _bV5M16rm;
        "bungeecord-1.21.6" = _bV5M16rm;
        "bungeecord-1.21.7" = _bV5M16rm;
        "bungeecord-1.21.8" = _bV5M16rm;
        "bungeecord-1.21.9" = _bV5M16rm;
        "bungeecord-1.21.10" = _bV5M16rm;
        "bungeecord-1.21.11" = _bV5M16rm;
        "bungeecord-26.1" = _bV5M16rm;
        "bungeecord-26.1.1" = _bV5M16rm;
        "bungeecord-26.1.2" = _bV5M16rm;
        "bungeecord-26.2" = _bV5M16rm;
        "velocity-1.19.2" = _yhqObhdn;
        "velocity-1.19.3" = _u04Ge8Ca;
        "velocity-1.19.4" = _yhqObhdn;
        "velocity-1.20" = _u04Ge8Ca;
        "velocity-1.20.1" = _yhqObhdn;
        "velocity-1.20.2" = _u04Ge8Ca;
        "velocity-1.20.3" = _u04Ge8Ca;
        "velocity-1.20.4" = _yhqObhdn;
        "velocity-1.20.5" = _u04Ge8Ca;
        "velocity-1.20.6" = _u04Ge8Ca;
        "velocity-1.21" = _yhqObhdn;
        "velocity-1.16.5" = _yhqObhdn;
        "velocity-1.17.1" = _yhqObhdn;
        "velocity-1.18.2" = _yhqObhdn;
        "velocity-1.21.1" = _yhqObhdn;
        "velocity-1.21.2" = _yhqObhdn;
        "velocity-1.21.3" = _yhqObhdn;
        "velocity-1.21.4" = _yhqObhdn;
        "velocity-1.21.5" = _yhqObhdn;
        "velocity-1.21.6" = _yhqObhdn;
        "velocity-1.21.7" = _yhqObhdn;
        "velocity-1.21.8" = _yhqObhdn;
        "velocity-1.21.9" = _yhqObhdn;
        "velocity-1.21.10" = _yhqObhdn;
        "velocity-1.21.11" = _yhqObhdn;
        "velocity-26.1" = _yhqObhdn;
        "velocity-26.1.1" = _yhqObhdn;
        "velocity-26.1.2" = _yhqObhdn;
        "velocity-26.2" = _yhqObhdn;
        "folia-1.19.2" = _YnC4RoiW;
        "folia-1.19.3" = _aLnbX09d;
        "folia-1.19.4" = _YnC4RoiW;
        "folia-1.20" = _oD2bUPCy;
        "folia-1.20.1" = _YnC4RoiW;
        "folia-1.20.2" = _oD2bUPCy;
        "folia-1.20.3" = _oD2bUPCy;
        "folia-1.20.4" = _YnC4RoiW;
        "folia-1.20.5" = _oD2bUPCy;
        "folia-1.20.6" = _oD2bUPCy;
        "folia-1.21" = _YnC4RoiW;
        "folia-1.16.5" = _YnC4RoiW;
        "folia-1.17.1" = _YnC4RoiW;
        "folia-1.18.2" = _YnC4RoiW;
        "folia-1.21.1" = _YnC4RoiW;
        "folia-1.21.2" = _YnC4RoiW;
        "folia-1.21.3" = _YnC4RoiW;
        "folia-1.21.4" = _YnC4RoiW;
        "folia-1.21.5" = _YnC4RoiW;
        "folia-1.21.6" = _YnC4RoiW;
        "folia-1.21.7" = _YnC4RoiW;
        "folia-1.21.8" = _YnC4RoiW;
        "folia-1.21.9" = _YnC4RoiW;
        "folia-1.21.10" = _YnC4RoiW;
        "folia-1.21.11" = _YnC4RoiW;
        "folia-26.1" = _YnC4RoiW;
        "folia-26.1.1" = _YnC4RoiW;
        "folia-26.1.2" = _YnC4RoiW;
        "folia-26.2" = _YnC4RoiW;
        "neoforge-1.21" = _zMpeWebP;
        "neoforge-1.21.1" = _zMpeWebP;
        "neoforge-1.21.2" = _vSSc2pqg;
        "neoforge-1.21.3" = _vSSc2pqg;
        "neoforge-1.21.4" = _X94OfJee;
        "neoforge-1.21.5" = _oOOKff9Q;
        "neoforge-1.21.6" = _3hJBCtvh;
        "neoforge-1.21.7" = _Jm8d2JVF;
        "neoforge-1.21.8" = _Jm8d2JVF;
        "neoforge-1.21.9" = _F4kIceic;
        "neoforge-1.21.10" = _F4kIceic;
        "neoforge-1.21.11" = _FWwLJCVL;
        "neoforge-26.1" = _rZSt1qmN;
        "neoforge-26.1.1" = _rZSt1qmN;
        "neoforge-26.1.2" = _rZSt1qmN;
        "neoforge-26.2" = _Y3SygC4h;
