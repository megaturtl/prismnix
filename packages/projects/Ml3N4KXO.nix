...
let
    ...
    in {
        ...
        "pkg-1.0.0-1.20.1-full" = _ZfM5FIrj;
        "pkg-1.0.1-1.20.1-part" = _fxOgwVr9;
        "pkg-1.0.1-1.20.1-full" = _Xhuk0PHO;
        "pkg-1.1.0-1.20.1" = _GnmJkpay;
        "pkg-1.2.0-1.20.1" = _wCIpeqeB;
        "pkg-1.2.1-1.20.1" = _FUjYcl1M;
        "pkg-1.2.2-1.20.1" = _pV3NGkVU;
        "pkg-1.2.2-1.20.1-hotfix" = _judSAuhx;
        "pkg-1.3.0-1.20.1" = _MOzKdvmd;
        "pkg-1.3.1-1.20.1" = _CBHkkyRN;
        "pkg-1.3.2-1.20.1" = _mVmKX3lP;
        "pkg-1.3.2-1.20.1-hotfix" = _mS40tlmN;
        "pkg-1.3.3-1.20.1" = _PXLNnOnT;
        "pkg-1.3.4-1.20.1" = _gH9luTJ5;
        "pkg-1.4.0-1.20.1" = _fV9lFJvi;
        "pkg-1.4.0-1.21.1-fabric" = _neuhcKyM;
        "pkg-1.4.1-1.20.1" = _2ItUbh85;
        "pkg-1.4.2-1.20.1-forge" = _9eesQ2Y3;
        "pkg-1.4.3-1.20.1" = _hffQiKxO;
        "pkg-1.4.4-1.20.1" = _exr5LLuk;
