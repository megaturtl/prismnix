...
let
    ...
    in {
        ...
        "neoforge-1.20.1" = _OaChvzBl;
        "neoforge-1.21.11" = _n2umVN63;
        "neoforge-26.1.1" = _h1Pc6iWF;
        "neoforge-26.1.2" = _2uZ9N7xq;
