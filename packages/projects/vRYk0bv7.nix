...
let
    ...
    in {
        ...
        "pkg-13.0.0+fabric-1.19.3" = _xjnznXBp;
        "pkg-13.0.0+forge-1.19.3" = _BCENRVYA;
        "pkg-11.0.2+forge-1.18.2" = _slnWgEu7;
        "pkg-11.0.2+fabric-1.18.2" = _ORTbHY9O;
        "pkg-12.0.2+forge-1.19" = _zEIzlTdB;
        "pkg-12.0.2+fabric-1.19" = _izchHwwT;
        "pkg-13.0.1+forge-1.19.3" = _byPaF9lW;
        "pkg-13.0.1+fabric-1.19.3" = _VkR0JKtY;
        "pkg-11.0.3+fabric-1.18.2" = _PK7aqiw3;
        "pkg-11.0.3+forge-1.18.2" = _CAu19PWV;
        "pkg-14.0.1+forge-1.19.4" = _goGnZzFi;
        "pkg-14.0.1+fabric-1.19.4" = _3M4noG0h;
        "pkg-15.0.0+fabric-1.20" = _jmfsPOT6;
        "pkg-15.0.0+forge-1.20" = _9RGmX3GL;
        "pkg-15.1.0+fabric-1.20" = _KUxVaZQX;
        "pkg-15.1.0+forge-1.20" = _hNSp78Kp;
        "pkg-12.1.0+forge-1.19.2" = _VLnMeNCk;
        "pkg-12.1.0+fabric-1.19.2" = _ILfR8sIf;
        "pkg-16.0.0+fabric-1.20.2" = _JmakExD9;
        "pkg-16.0.0+forge-1.20.2" = _9QvSgxRz;
        "pkg-16.0.0+neoforge-1.20.2" = _Ajo8CsNH;
        "pkg-16.0.1+fabric-1.20.4" = _KtMApssr;
        "pkg-16.0.1+forge-1.20.4" = _Hf4LKPAM;
        "pkg-16.0.1+neoforge-1.20.4" = _kjaPJi8a;
        "pkg-17.0.1+fabric-1.20.6" = _Ab9vJ5cS;
        "pkg-17.0.1+forge-1.20.6" = _5zVZAd3z;
        "pkg-17.0.1+neoforge-1.20.6" = _Y0e2veEZ;
        "pkg-21.0.1+fabric-1.21" = _2SXvFwm5;
        "pkg-21.0.1+forge-1.21" = _uMB8lAUT;
        "pkg-21.0.1+neoforge-1.21" = _IVfLp2Pl;
        "pkg-21.0.2+fabric-1.21" = _jtMAQdPY;
        "pkg-21.0.2+forge-1.21" = _GsgB9l1P;
        "pkg-21.0.2+neoforge-1.21" = _yWhA8e0g;
        "pkg-21.1.1+fabric-1.21.1" = _iiIt4atq;
        "pkg-21.1.1+forge-1.21.1" = _zanJw9fM;
        "pkg-21.1.1+neoforge-1.21.1" = _zm1jBGGN;
        "pkg-21.3.1+fabric-1.21.3" = _zHsENHo4;
        "pkg-21.3.1+neoforge-1.21.3" = _jNsXrkIe;
        "pkg-21.3.2+fabric-1.21.3" = _zlpf4jrW;
        "pkg-21.3.2+neoforge-1.21.3" = _DUsiNbdc;
        "pkg-21.3.3+fabric-1.21.3" = _9XKkMQGQ;
        "pkg-21.4.1+fabric-1.21.4" = _TV8k7N50;
        "pkg-21.4.1+neoforge-1.21.4" = _TjRGkCSW;
        "pkg-21.4.2+fabric-1.21.4" = _hBmpFFnD;
        "pkg-21.4.2+neoforge-1.21.4" = _ISZVzy6V;
        "pkg-21.1.2+fabric-1.21.1" = _RS3tFaMO;
        "pkg-21.1.2+forge-1.21.1" = _rKgZDms2;
        "pkg-21.1.2+neoforge-1.21.1" = _4MguzUn2;
        "pkg-21.4.3+fabric-1.21.4" = _O5Qds8mW;
        "pkg-21.4.3+neoforge-1.21.4" = _SwdawEpb;
        "pkg-15.1.1+fabric-1.20" = _Ve2pngwH;
        "pkg-15.1.1+forge-1.20" = _fugZlKHM;
        "pkg-21.4.4+forge-1.21.4" = _nUN0Jh2I;
        "pkg-21.4.5+fabric-1.21.4" = _nkTuc7EW;
        "pkg-21.4.5+forge-1.21.4" = _30RYyY7B;
        "pkg-21.4.5+neoforge-1.21.4" = _Ez8x02AH;
        "pkg-21.1.4+fabric-1.21.1" = _pc61Sh6M;
        "pkg-21.1.4+neoforge-1.21.1" = _xyqrX19y;
        "pkg-21.1.4+forge-1.21.1" = _nuu526Z0;
        "pkg-21.1.5+forge-1.21.1" = _BgnQ4yUi;
        "pkg-21.4.6+forge-1.21.4" = _Abuf0qOW;
        "pkg-21.5.1+fabric-1.21.5" = _DGHuEq8F;
        "pkg-21.5.1+neoforge-1.21.5" = _zHlmuWPY;
        "pkg-21.5.2+forge-1.21.5" = _VTeWFDIB;
        "pkg-21.6.1+fabric-1.21.6" = _r5oVMZ5A;
        "pkg-21.6.1+neoforge-1.21.6" = _aV04IMK3;
        "pkg-21.6.2+forge-1.21.6" = _BiB5w7Wc;
        "pkg-21.7.1+forge-1.21.7" = _uNWD3fZF;
        "pkg-21.7.1+fabric-1.21.7" = _SU9gNbTv;
        "pkg-21.7.1+neoforge-1.21.7" = _YuEdryZ5;
        "pkg-21.8.1+fabric-1.21.8" = _ezdnm4th;
        "pkg-21.8.1+forge-1.21.8" = _3ZehQsiC;
        "pkg-21.8.1+neoforge-1.21.8" = _A8adklUp;
        "pkg-21.9.1+fabric-1.21.9" = _J8GBh0m1;
        "pkg-21.9.1+neoforge-1.21.9" = _AQiQlE7j;
        "pkg-21.10.1+forge-1.21.10" = _oYE2z9O2;
        "pkg-21.10.1+neoforge-1.21.10" = _e8Zsiqgp;
        "pkg-21.10.1+fabric-1.21.10" = _Xv5yJIws;
        "pkg-21.10.2+fabric-1.21.10" = _8pBON0BS;
        "pkg-21.10.2+forge-1.21.10" = _g0r3zSIb;
        "pkg-21.10.2+neoforge-1.21.10" = _t5hSMYp6;
        "pkg-21.11.2+fabric-1.21.11" = _M5Ckcz4S;
        "pkg-21.11.2+neoforge-1.21.11" = _lZIXeDBu;
        "pkg-21.11.4+fabric-1.21.11" = _h27RWnjv;
        "pkg-21.11.4+forge-1.21.11" = _egxnuVO3;
        "pkg-21.11.4+neoforge-1.21.11" = _Kq3z6gII;
        "pkg-15.1.3+forge-1.20.1" = _rFFVyXKs;
        "pkg-15.1.3+fabric-1.20.1" = _m866Ufz6;
        "pkg-26.1.0.2" = _8qYqcrpb;
        "pkg-26.1.2.1" = _trA79xXQ;
        "pkg-26.1.2.2+fabric-26.1.2" = _XjDxrgVh;
        "pkg-26.1.2.2+neoforge-26.1.2" = _l7OrPoQM;
        "pkg-15.1.5+fabric-1.20.1" = _rvZNAUdl;
        "pkg-21.1.10+fabric-1.21.1" = _HlkqEQN4;
        "pkg-21.1.10+forge-1.21.1" = _4njOdEyT;
        "pkg-15.1.5+forge-1.20.1" = _r0K8IYd7;
        "pkg-21.1.10+neoforge-1.21.1" = _JRxmKPV9;
        "pkg-26.1.2.3+fabric-26.1.2" = _ukYAKMuL;
        "pkg-26.1.2.3+neoforge-26.1.2" = _rx9Y6Y5L;
        "pkg-21.1.11+fabric-1.21.1" = _apJG54CW;
        "pkg-21.1.11+neoforge-1.21.1" = _HY8Ybozd;
        "pkg-21.1.11+forge-1.21.1" = _iTbrgmL4;
        "pkg-26.2.0.1+neoforge-26.2" = _R8L8hx2o;
        "pkg-26.2.0.1+fabric-26.2" = _qIsYpFhq;
        "pkg-26.1.2.4+fabric-26.1.2" = _YfIzpe6s;
