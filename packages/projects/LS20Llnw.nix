...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _zaZLRRgf;
        "pkg-2.0.0" = _QRtliWla;
        "pkg-2.1.0-neoforge+26.1" = _XhApV6g2;
        "pkg-2.1.0-fabric+26.1" = _FzXkYcIR;
        "pkg-2.1.1-neoforge+26.1" = _inA3Esnd;
        "pkg-2.1.1-fabric+26.1" = _wIOlT0Ug;
        "pkg-2.1.1+26.1-neoforge" = _xMNUgdq2;
        "pkg-2.1.1+1.21.11-neoforge" = _ss9gxRgl;
        "pkg-2.1.1+26.1-fabric" = _IfTiS7eC;
        "pkg-2.1.1+1.21.11-fabric" = _2anc7PYS;
        "pkg-2.1.1+1.21.1-neoforge" = _KjTH8xQx;
        "pkg-2.1.1+1.21.1-fabric" = _v7RnT4Ac;
        "pkg-2.1.1+1.20.1-fabric" = _mPtuE1jt;
        "pkg-2.1.2+1.20.1-forge" = _uWahK3dz;
        "pkg-2.1.3+1.21.1-neoforge" = _C0HQDrn7;
        "pkg-2.1.3+26.1-neoforge" = _niPIcWeM;
        "pkg-2.1.3+1.21.11-neoforge" = _B6XhBTKb;
        "pkg-2.1.3+26.1-fabric" = _kNZ4h0cP;
        "pkg-2.1.3+1.20.1-forge" = _GbrYSZ5g;
        "pkg-2.1.3+1.20.1-fabric" = _XxPRStX3;
        "pkg-2.1.3+1.21.1-fabric" = _t15r4S4N;
        "pkg-2.1.3+1.21.11-fabric" = _juK9dB2e;
        "pkg-2.1.4+1.21.11-neoforge" = _spJNJq5Q;
        "pkg-2.1.4+1.21.1-neoforge" = _sxQvj7Iw;
        "pkg-2.1.4+26.1-neoforge" = _JEcRDU8m;
        "pkg-2.1.4+26.1-fabric" = _XTvEnlim;
        "pkg-2.1.4+1.20.1-forge" = _wIj2C5QK;
        "pkg-2.1.4+1.20.1-fabric" = _NcXnzK3A;
        "pkg-2.1.4+1.21.11-fabric" = _UQ0pkoMj;
        "pkg-2.1.4+1.21.1-fabric" = _u8SKASnw;
        "pkg-2.1.4+26.2-fabric" = _D2hKDqzp;
        ...
        "pkg-2.2.1+1.20.1-forge" = _BDQjNw8O;
        "pkg-2.2.1+26.1-fabric" = _jPlBpNz9;
