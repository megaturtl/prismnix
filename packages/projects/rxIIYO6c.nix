...
let
    ...
    in {
        ...
        "pkg-1.8.8" = _qTJGiuCo;
        "pkg-1.5.5.7" = _ADIRkxKS;
        "pkg-3.6.1.85" = _jUnitpGk;
        "pkg-3.6.1.88" = _3XnE2iWA;
        "pkg-3.6.2.92" = _5x4nQV0E;
        "pkg-3.6.3.111" = _TkJ6nDUK;
        "pkg-3.6.4.113" = _rtqDbRrV;
        "pkg-3.7.0.152" = _5s1u9uN2;
        "pkg-3.7.1.155" = _4U8Td4Sc;
        "pkg-3.8.0.14" = _XVeaDVaM;
        "pkg-3.8.1.16" = _hlLiDRiB;
        "pkg-3.8.2.32" = _iAPEYj3B;
        "pkg-3.8.3.39" = _KpNAIJ7D;
        "pkg-3.8.4.50" = _93Np1BkB;
        "pkg-3.7.2.167" = _v6T8o8Ht;
        "pkg-3.9.0.6" = _vseNIKmt;
        "pkg-3.8.5.58" = _JZb7mMLX;
        "pkg-3.9.1.17" = _7XxgiusL;
        "pkg-3.9.1.19" = _IFTo0ry1;
        "pkg-3.9.2.34" = _6StFiz6V;
        "pkg-3.9.2.37" = _z61vnfy7;
        "pkg-3.10.0.67" = _vUFOf3iH;
        "pkg-3.10.1.76" = _GhTRZIQu;
        "pkg-3.10.2.92" = _FGU09YgL;
        "pkg-3.11.0.148" = _AX42Y90m;
