...
let
    versions = (let
        ...
        _w0M6mkoi = {
            "id" = "w0M6mkoi";
            "file" = "pv-addon-discs-1.2.0.jar";
            "hash" = "sha512-DR+n07ljIPoFDiC0mEh1INnRvenKpvnoAdrfW+2l5ruhXVAmKRasv2fc+mU+gbuLjPZAnn4cs0ZVi2TcOSG/mA==";
        };
    in {
        "h6VIWxPj" = _h6VIWxPj;
        "sAcog2qW" = _sAcog2qW;
        ...
        "V22EXIno" = _V22EXIno;
        "w0M6mkoi" = _w0M6mkoi;
        "paper-1.19.2" = _w0M6mkoi;
        "paper-1.19.3" = _w0M6mkoi;
        "paper-1.19.4" = _w0M6mkoi;
        "paper-1.20" = _w0M6mkoi;
        "paper-1.20.1" = _w0M6mkoi;
        "paper-1.20.2" = _w0M6mkoi;
        "paper-1.20.3" = _w0M6mkoi;
        "paper-1.20.4" = _w0M6mkoi;
        "paper-1.20.5" = _w0M6mkoi;
        "paper-1.20.6" = _w0M6mkoi;
        "paper-1.21" = _w0M6mkoi;
        "paper-1.21.1" = _w0M6mkoi;
        "paper-1.16.5" = _w0M6mkoi;
        "paper-1.17.1" = _w0M6mkoi;
        "paper-1.18.2" = _w0M6mkoi;
        "paper-1.21.2" = _w0M6mkoi;
        "paper-1.21.3" = _w0M6mkoi;
        "paper-1.21.4" = _w0M6mkoi;
        "paper-1.21.5" = _w0M6mkoi;
        "paper-1.21.6" = _w0M6mkoi;
        "paper-1.21.7" = _w0M6mkoi;
        "paper-1.21.8" = _w0M6mkoi;
        "paper-1.21.9" = _w0M6mkoi;
        "paper-1.21.10" = _w0M6mkoi;
        "paper-1.21.11" = _w0M6mkoi;
        "paper-26.1" = _w0M6mkoi;
        "paper-26.1.1" = _w0M6mkoi;
        "paper-26.1.2" = _w0M6mkoi;
        "paper-26.2" = _w0M6mkoi;
        "folia-1.16.5" = _w0M6mkoi;
        "folia-1.17.1" = _w0M6mkoi;
        "folia-1.18.2" = _w0M6mkoi;
        "folia-1.19.2" = _w0M6mkoi;
        "folia-1.19.3" = _w0M6mkoi;
        "folia-1.19.4" = _w0M6mkoi;
        "folia-1.20" = _w0M6mkoi;
        "folia-1.20.1" = _w0M6mkoi;
        "folia-1.20.2" = _w0M6mkoi;
        "folia-1.20.3" = _w0M6mkoi;
        "folia-1.20.4" = _w0M6mkoi;
        "folia-1.20.5" = _w0M6mkoi;
        "folia-1.20.6" = _w0M6mkoi;
        "folia-1.21" = _w0M6mkoi;
        "folia-1.21.1" = _w0M6mkoi;
        "folia-1.21.2" = _w0M6mkoi;
        "folia-1.21.3" = _w0M6mkoi;
        "folia-1.21.4" = _w0M6mkoi;
        "folia-1.21.5" = _w0M6mkoi;
        "folia-1.21.6" = _w0M6mkoi;
        "folia-1.21.7" = _w0M6mkoi;
        "folia-1.21.8" = _w0M6mkoi;
        "folia-1.21.9" = _w0M6mkoi;
        "folia-1.21.10" = _w0M6mkoi;
        "folia-1.21.11" = _w0M6mkoi;
        "folia-26.1" = _w0M6mkoi;
        "folia-26.1.1" = _w0M6mkoi;
        "folia-26.1.2" = _w0M6mkoi;
        "folia-26.2" = _w0M6mkoi;
        "purpur-1.16.5" = _w0M6mkoi;
        "purpur-1.17.1" = _w0M6mkoi;
        "purpur-1.18.2" = _w0M6mkoi;
        "purpur-1.19.2" = _w0M6mkoi;
        "purpur-1.19.3" = _w0M6mkoi;
        "purpur-1.19.4" = _w0M6mkoi;
        "purpur-1.20" = _w0M6mkoi;
        "purpur-1.20.1" = _w0M6mkoi;
        "purpur-1.20.2" = _w0M6mkoi;
        "purpur-1.20.3" = _w0M6mkoi;
        "purpur-1.20.4" = _w0M6mkoi;
        "purpur-1.20.5" = _w0M6mkoi;
        "purpur-1.20.6" = _w0M6mkoi;
        "purpur-1.21" = _w0M6mkoi;
        "purpur-1.21.1" = _w0M6mkoi;
        "purpur-1.21.2" = _w0M6mkoi;
        "purpur-1.21.3" = _w0M6mkoi;
        "purpur-1.21.4" = _w0M6mkoi;
        "purpur-1.21.5" = _w0M6mkoi;
        "purpur-1.21.6" = _w0M6mkoi;
        "purpur-1.21.7" = _w0M6mkoi;
        "purpur-1.21.8" = _w0M6mkoi;
        "purpur-1.21.9" = _w0M6mkoi;
        "purpur-1.21.10" = _w0M6mkoi;
        "purpur-1.21.11" = _w0M6mkoi;
        "purpur-26.1" = _w0M6mkoi;
        "purpur-26.1.1" = _w0M6mkoi;
        "purpur-26.1.2" = _w0M6mkoi;
        "purpur-26.2" = _w0M6mkoi;
        "pkg-1.0.0" = _h6VIWxPj;
        "pkg-1.0.1" = _sAcog2qW;
        "pkg-1.0.3" = _ZsKxdT54;
        "pkg-1.0.4" = _YEdyFEXS;
        ...
        "pkg-1.1.8" = _C0AL9yNu;
        "pkg-1.1.9" = _oengcTYg;
        "pkg-1.1.10" = _ILCLlpav;
        "pkg-1.1.11" = _V22EXIno;
        "pkg-1.2.0" = _w0M6mkoi;
        "default" = _w0M6mkoi;
    });
