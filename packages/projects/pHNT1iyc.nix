...
let
    ...
    in {
        ...
        "pkg-1.0.4+1.20.4" = _Npc25MXy;
        "pkg-1.1.0+1.20.4" = _5u3gQmDF;
        "pkg-1.2.0+1.21" = _xZFMIcjU;
        "pkg-1.2.1+1.21" = _EUuja2Zw;
        "pkg-1.2.2+1.21" = _sRatOwI9;
        "pkg-1.1.1+1.20.4" = _EAkN36Zh;
        "pkg-1.2.3+1.21" = _mJBA1LzJ;
        "pkg-1.2.4+1.21" = _e4ZaG7Op;
        "pkg-1.2.5+1.21" = _hlHv5JGk;
        "pkg-1.2.6+1.21" = _Dnt1tpEl;
        "pkg-1.2.7+1.21" = _EZ0iKkEL;
        "pkg-1.2.8+1.21" = _ZXEFTNsh;
        "pkg-1.3.0+1.21" = _fXRfIj4m;
        "pkg-1.3.1+1.21" = _inUbOXRZ;
        "pkg-1.3.2+1.21" = _HwQoRdRk;
        "pkg-1.4.0-beta-1.21" = _XrSPqBjK;
        "pkg-1.5.0-beta-1.21.1" = _RHoWmiCu;
        "pkg-1.5.1-beta-1.21.1" = _Xnd03pSd;
        "pkg-1.5.2-beta-1.21.1" = _Mwu8sgSd;
        "pkg-1.5.3-beta-1.21.1" = _Ak0GsSZZ;
        "pkg-1.5.4-beta-1.21.1" = _3ANIk7wR;
        "pkg-1.6.0-beta-1.21.1" = _hrg5GhSv;
        "pkg-1.6.1-beta-1.21.1" = _xmPXhLHi;
        "pkg-1.6.2-beta-1.21.1" = _hsc8cN3A;
        "pkg-1.6.3-beta-1.21.1" = _QkNUYTo5;
        "pkg-1.6.4-beta-1.21.1" = _oGuDirD1;
        "pkg-1.6.5-beta-1.21.1" = _trLf0Pfc;
        "pkg-1.6.6-beta-1.21.1" = _JFgqZdrv;
        "pkg-1.6.7-beta-1.21.1" = _jWpgCcym;
        "pkg-1.7.0-1.21.1" = _iCaMGI7J;
        "pkg-1.8.0-1.21.1" = _PwXTxM1z;
        "pkg-1.8.1-1.21.1" = _mX1cGUob;
        "pkg-1.8.2-1.21.1" = _QOIBJRMc;
        "pkg-1.8.3-1.21.1" = _gDbOqtbG;
        "pkg-1.8.4-1.21.1" = _9LzkBoCq;
        "pkg-1.8.5-1.21.1" = _hajIgaSd;
        "pkg-1.8.6-1.21.1" = _n1os0Qgn;
        "pkg-1.8.7-1.21.1" = _VbHaLx2Y;
        "pkg-1.8.8-1.21.1" = _qQle0vyd;
        "pkg-1.8.9-1.21.1" = _gticooeH;
        "pkg-1.8.10-1.21.1" = _s5KV10IV;
        "pkg-1.8.11-1.21.1" = _bNvkuQ9w;
        "pkg-1.8.12-1.21.1" = _Jm9RllyW;
        "pkg-1.8.13-1.21.1" = _zPOEE5Dn;
        "pkg-1.8.14-1.21.1" = _oAj3LKzY;
        "pkg-1.8.15-1.21.1" = _hitxdp8u;
        "pkg-1.8.16-1.21.1" = _6nox8UPW;
        "pkg-1.8.17-1.21.1" = _eki5WuYo;
        "pkg-1.8.18-1.21.1" = _f3Qkd8JR;
        "pkg-1.8.19-1.21.1" = _TERRBwjB;
        "pkg-1.8.20-1.21.1" = _JU82Ph9m;
        "pkg-1.8.21-1.21.1" = _QD12vFdM;
        "pkg-1.8.22-1.21.1" = _Bp4Runrc;
        "pkg-1.8.23-1.21.1" = _OpYISHNV;
        "pkg-1.8.24-1.21.1" = _nA7rccV0;
        "pkg-1.8.25-1.21.1" = _Fro0V2H3;
        "pkg-1.8.26-1.21.1" = _1jj3cxQ8;
        "pkg-1.8.27-1.21.1" = _h1sN5HIR;
        "pkg-1.8.28-1.21.1" = _NvbRuhVS;
        "pkg-1.8.29-1.21.1" = _o9CTYi3i;
        "pkg-1.8.30-1.21.1" = _mUBh5ifp;
        "pkg-1.9.0-1.21.1" = _pzGn1FJW;
        "pkg-1.9.1-1.21.1" = _tELCc6Yk;
        "pkg-1.9.2-1.21.1" = _EUJtJiyy;
        "pkg-1.9.3-1.21.1" = _SlFili25;
        "pkg-1.9.4-1.21.1" = _jn0xedR2;
        "pkg-1.9.5-1.21.1" = _kMcwhsC3;
        "pkg-1.9.6-1.21.1" = _b7CTM8FH;
        "pkg-1.9.7-1.21.1" = _PEeIrsfX;
        "pkg-1.9.8-1.21.1" = _kY1vlulk;
        "pkg-1.9.9-1.21.1" = _vNWA5QZg;
        "pkg-1.10.0-1.21.1" = _F7E4TzeO;
        "pkg-1.10.1-1.21.1" = _16qwURQi;
        "pkg-1.10.2-1.21.1" = _ErmYCA7d;
        "pkg-1.10.3-1.21.1" = _QFQuFWnM;
        "pkg-1.10.4-1.21.1" = _NnhrAo8J;
        "pkg-1.11.0-1.21.1" = _GiwC9SXw;
        "pkg-1.11.1-1.21.1" = _Q12V9YK5;
        "pkg-1.11.2-1.21.1" = _KGDfLMLl;
        "pkg-1.11.3-1.21.1" = _gn49fLUs;
        "pkg-1.11.4-1.21.1" = _42Ba8aYJ;
        "pkg-1.11.5-1.21.1" = _zuZeNpyW;
        "pkg-1.11.6-1.21.1" = _inX7NbEO;
        "pkg-1.11.7-1.21.1" = _5TovRwMt;
        "pkg-1.11.8-1.21.1" = _54xoMRty;
        "pkg-1.11.9-1.21.1" = _ENvUVXez;
        "pkg-1.11.10-1.21.1" = _ciyDFgWt;
        "pkg-1.11.11-1.21.1" = _o1g3v0XL;
        "pkg-1.11.12-1.21.1" = _yOrn6SZA;
        "pkg-1.11.13-1.21.1" = _HheVWTys;
        "pkg-1.11.14-1.21.1" = _9ke5nsmN;
        "pkg-1.12.0-1.21.1" = _ZcJN1WYi;
        "pkg-1.12.1-1.21.1" = _ViaUtU5D;
        "pkg-1.13.0-alpha-26.1.2" = _5atFD99d;
        "pkg-1.13.1-alpha-26.1.2" = _eQv9a6Cv;
        "pkg-1.12.2-1.21.1" = _ku7SevUa;
        "pkg-1.12.3-1.21.1" = _6tR1WuRM;
        "pkg-1.12.4-1.21.1" = _oZQr2V9a;
        "pkg-1.12.5-1.21.1" = _e1d1uCXC;
        "pkg-1.13.2-alpha-26.1.2" = _5bSmeLrO;
        "pkg-1.13.3-alpha-26.1.2" = _cuThczHW;
        "pkg-1.12.6-1.21.1" = _7oZKhPUk;
        "pkg-1.12.7-1.21.1" = _zCmDf5rv;
        "pkg-1.12.8-1.21.1" = _gcu2Wine;
        "pkg-1.12.9-1.21.1" = _WDt0TL2A;
        "pkg-1.12.10-1.21.1" = _TPDn1WPA;
        "pkg-1.12.11-1.21.1" = _y0D2hF5R;
