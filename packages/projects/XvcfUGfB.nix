...
let
    ...
    in {
        ...
        "pkg-0.1.2" = _kJ5600cC;
        "pkg-0.1.3" = _SuVDMaGJ;
        "pkg-0.1.4+1.21.1+fabric" = _ZPNYKJm0;
        "pkg-0.1.4+1.21.1+neoforge" = _7nmj0DbM;
        "pkg-0.1.5+1.21.1+fabric" = _ypGiygmU;
        "pkg-0.1.5+1.21.1+neoforge" = _3qedDFc2;
        "pkg-0.1.6+1.21.1+fabric" = _uG7S5M0l;
        "pkg-0.1.6+1.21.1+neoforge" = _gjiux76v;
        "pkg-0.1.7+1.21.1+fabric" = _DikpcqjA;
        "pkg-0.1.7+1.21.1+neoforge" = _qDoHEG2E;
        "pkg-0.1.8+1.21.1+fabric" = _WQmRcw6l;
        "pkg-0.1.8+1.21.1+neoforge" = _ZruuNk9A;
        "pkg-0.1.9+1.21.1+fabric" = _8Uyoz8s9;
        "pkg-0.1.9+1.21.1+neoforge" = _KRFYt7rI;
        "pkg-0.1.10+1.21.1+fabric" = _59zBDFg0;
        "pkg-0.1.10+1.21.1+neoforge" = _zc1myJoW;
        "pkg-0.1.11+1.21.1+fabric" = _fUIhTTIF;
        "pkg-0.1.11+1.21.1+neoforge" = _waeE3X5L;
        "pkg-0.1.12+1.21.1+fabric" = _g9I8SQKb;
        "pkg-0.1.12+1.21.1+neoforge" = _XdLIiAIn;
        "pkg-0.1.13+1.21.1+fabric" = _RdKQdWOn;
        "pkg-0.1.13+1.21.1+neoforge" = _nZBUVm2d;
        "pkg-0.1.14+1.21.1+fabric" = _vBDcJ7nr;
        "pkg-0.1.14+1.21.1+neoforge" = _ZAJgHo95;
        "pkg-0.1.15+1.21.1+fabric" = _9LnY3OvY;
        "pkg-0.1.15+1.21.1+neoforge" = _2aLbng89;
        "pkg-0.1.16+1.21.1+fabric" = _lMpMn7Z9;
        "pkg-0.1.16+1.21.1+neoforge" = _umDQuNQM;
        "pkg-0.1.17+1.21.1+fabric" = _UbudRkrw;
        "pkg-0.1.17+1.21.1+neoforge" = _qK2bFMNl;
        "pkg-0.1.18+1.21.1+fabric" = _l5m8NE7d;
        "pkg-0.1.18+1.21.1+neoforge" = _FZHRqtab;
        "pkg-0.2.0+1.21.1+fabric" = _LUZJc8gV;
        "pkg-0.2.0+1.21.1+neoforge" = _PAJgRC3p;
        "pkg-0.2.1+1.21.1+fabric" = _2lb82odx;
        "pkg-0.2.1+1.21.1+neoforge" = _eeylN0vm;
        "pkg-0.2.2+1.21.1+fabric" = _5ZdNwkDa;
        "pkg-0.2.2+1.21.1+neoforge" = _gDkjhw4g;
        "pkg-0.2.3+1.21.1+fabric" = _DLLx8pmN;
        "pkg-0.2.3+1.21.1+neoforge" = _D8ZhAysT;
        "pkg-0.3.0+1.21.1+fabric" = _lpXbh5Uh;
        "pkg-0.3.0+1.21.1+neoforge" = _dQj6HMps;
        "pkg-0.4.0+1.21.1+fabric" = _vniA7VxV;
        "pkg-0.4.0+1.21.1+neoforge" = _1qW50pKg;
        "pkg-0.4.1+1.21.1+fabric" = _1xIGL2Tx;
        "pkg-0.4.1+1.21.1+neoforge" = _JhvYzX9i;
        "pkg-0.4.2+1.21.1+fabric" = _MuOX9Kwc;
        "pkg-0.4.2+1.21.1+neoforge" = _9cSyfBfl;
        "pkg-0.4.2-hotfix+1.21.1+fabric" = _OvQUyK7H;
        "pkg-0.4.2-hotfix+1.21.1+neoforge" = _RBWRe49z;
        "pkg-0.4.3+1.21.1+fabric" = _8DkHO6Z6;
        "pkg-0.4.3+1.21.1+neoforge" = _Cl2JTbHX;
        "pkg-0.5.0+1.21.1+fabric" = _477BdhWq;
        "pkg-0.5.0+1.21.1+neoforge" = _t58mhAAG;
        "pkg-0.5.1+1.21.1+fabric" = _cLAxyimY;
        "pkg-0.5.1+1.21.1+neoforge" = _aE42o85c;
        "pkg-0.6.0+1.21.1+fabric" = _ePsRt5DH;
        "pkg-0.6.0+1.21.1+neoforge" = _Etmd9RPt;
        "pkg-0.6.0-hotfix+1.21.1+fabric" = _KdKiGwUn;
        "pkg-0.6.0-hotfix+1.21.1+neoforge" = _JR4Hohbp;
        "pkg-0.6.1+1.21.1+fabric" = _uIGMR6Gg;
        "pkg-0.6.1+1.21.1+neoforge" = _xAaLIQZh;
        "pkg-0.6.1-hotfix+1.21.1+fabric" = _w0FeJdWR;
        "pkg-0.6.1-hotfix+1.21.1+neoforge" = _lkZH2YBb;
        "pkg-0.6.2+1.21.1+fabric" = _woDFORkx;
        "pkg-0.6.2+1.21.1+neoforge" = _WKFpJEmS;
        "pkg-0.6.3+1.21.1+fabric" = _kXFcGJUF;
        "pkg-0.6.3+1.21.1+neoforge" = _HyYTDex0;
        "pkg-0.6.4+1.21.1+fabric" = _CmhZsGpC;
        "pkg-0.6.4+1.21.1+neoforge" = _AuGaEkm3;
        "pkg-0.7.0+1.21.1+fabric" = _BxZwr0HD;
        "pkg-0.7.0+1.21.1+neoforge" = _eyJT4l6J;
        "pkg-0.7.0-hotfix+1.21.1+fabric" = _qohxfmj9;
        "pkg-0.7.0-hotfix+1.21.1+neoforge" = _CD4xFiR9;
        "pkg-0.8.0+1.21.1+fabric" = _zAwtT2GS;
