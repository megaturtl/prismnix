...
let
    versions = (let
        ...
        _UfpCj2YC = {
            "id" = "UfpCj2YC";
            "file" = "MinGen v7.0.zip";
            "hash" = "sha512-PUELk4uBJRcAsC66wz94rBsfzPIPTB3MNN+L/JkhOKWIXyWvq97RBHB5t9p1ZHp/E5QkftY8foVL0uCDuPXS8g==";
        };
        _os63RpQa = {
            "id" = "os63RpQa";
            "file" = "mingen-v7.0.jar";
            "hash" = "sha512-CaJpWuWPZKQXMpYjYC0xKHq6tfGr5i+87d8I0JKxN8MBSSCjtRJYaAkhcSkD5Zmu6no9dvYJKuBN1FS3xojqzw==";
        };
        _MZw3e4Ne = {
            "id" = "MZw3e4Ne";
            "file" = "MinGen v7.0.1.zip";
            "hash" = "sha512-KqaQ36DbfltdQPnwaXeM/PJbHq1KSkBforZp1PH0s+rVQy6L0GvNUJn2+pb1rDFqBY9m15M566+YAfb0pEMlbQ==";
        };
        _ZC3ujQaK = {
            "id" = "ZC3ujQaK";
            "file" = "mingen-7.0.1.jar";
            "hash" = "sha512-iVpF00JNqveNHTAOEpybNTJMLsCcMxg7AnDTxhFhxeEXceUne/7k2OPUjXaNLpaTqeGWlsHh1grddPVOm6rfGA==";
        };
        _pPl5m5Op = {
            "id" = "pPl5m5Op";
            "file" = "MinGen v7.1.zip";
            "hash" = "sha512-iSJ7RZ1iTiVTiF+KIhfRnxX/yZqRikIoEH5vYloJTypj9ZPpd+rhsuN4JBkmLNVRmo2eFt4g8q9G2+z4dalfyw==";
        };
        _Mql2OzB6 = {
            "id" = "Mql2OzB6";
            "file" = "mingen-v7.1.jar";
            "hash" = "sha512-MpEfo7pgdvIN8SUOeo8IiOWXiC/cOOQmqZ+6uAPOROaA/cTQK/Kd1Mo0ARTr3efgqVxS0CVbmxWDNaBncnF9rw==";
        };
        _mP6cOxL1 = {
            "id" = "mP6cOxL1";
            "file" = "Mingen v7.1.1.zip";
            "hash" = "sha512-B6O3tPfc15OuYELwFiwhRWhNxwhsFafDsyG659tT4MND/8Ngxi+9N04WGgy9ldNeBmW2uftQA4bZ6b0NSBd3UQ==";
        };
        _tmj5nYiP = {
            "id" = "tmj5nYiP";
            "file" = "mingen-v7.1.1.jar";
            "hash" = "sha512-0mE8PTPkFz5P/RsXsouxAOmDlpE76OgfqIyOEAKMmqSS2AnTi3UmVe7zWo0r69mYx1qXn03G9zOEHvJAZI00IA==";
        };
        _RREY76H4 = {
            "id" = "RREY76H4";
            "file" = "Mingen v7.2.zip";
            "hash" = "sha512-TVbpwmVwWt6XG7FMJdtOt/+xSGtJtLtthmmr/CLuzhYpsHD/MiYQAC1gyBTNbTjRTR/E+Y8e9QSpSGxYflv23g==";
        };
        _NsLMypZK = {
            "id" = "NsLMypZK";
            "file" = "mingen-v7.2.jar";
            "hash" = "sha512-J2diyFwp9Tzit2JWv2ovP9AehTNR3epdR5qbFpqbxYFfAfUinWYOQmUtV2vtYAoq8pKsDx8dVf2PzoYX/x5hbA==";
        };
        _OHfBAcSn = {
            "id" = "OHfBAcSn";
            "file" = "Mingen v7.2.1.zip";
            "hash" = "sha512-1N4yITXIS5QJEsBQwsC1krKFff1hrdtxvpX+nTPjacGh6t72ebG5o8dHAXCHIS7JdKDuFqCDdf/oFDtHa1/Xtw==";
        };
        _davtldc3 = {
            "id" = "davtldc3";
            "file" = "mingen-v7.2.1.jar";
            "hash" = "sha512-lMxe9ESNgH+5pDfX0dHd2AN0qmABsw06/vWxq/GUoPY/s9ZPb6i1la6BgShnIsEomt63nC/Jnm9yT07NHeI1Fg==";
        };
        _3HpelNu3 = {
            "id" = "3HpelNu3";
            "file" = "Mingen v7.2.2.zip";
            "hash" = "sha512-G7BaTaIChOIxvehAT6jYA0sBQ1aUW81pt7aLr7YoFPJQPNavdy8/RulycS3J+fLbB3bDgIQDVYHk3Grkcy/hPg==";
        };
        _Ze9ByKBY = {
            "id" = "Ze9ByKBY";
            "file" = "mingen-v7.2.2.jar";
            "hash" = "sha512-t4gmTSTbazFpeibgdDGSCyn96nKUyCaPejIe30bSqz2hZclJQZ6zOwmyD36/ZtdX8e+MdFT6WGjZWgjm2yfrKQ==";
        };
        _bdIEhBEo = {
            "id" = "bdIEhBEo";
            "file" = "Mingen v7.2.3.zip";
            "hash" = "sha512-+4LDk498lZhOQsWUjzrs+ouj+y97Vahin4MNOAed/X5ic28ygmTNNeL3xZQJBRkYVTERxiklRnpONRXaMh3mkw==";
        };
        _N4KCFqwj = {
            "id" = "N4KCFqwj";
            "file" = "mingen-v7.2.3.jar";
            "hash" = "sha512-ldUGO4IeiSDbIQrSIasXRD/lCJtrkWfkUjnsPv/GBpu2nuumngFOfoOUzI03LYolKdG2v2A9TDSttDsk440fRg==";
        };
        _Iqncocdj = {
            "id" = "Iqncocdj";
            "file" = "mingen v7.2.4.zip";
            "hash" = "sha512-9egSBzsMb3ZUQkalD03rpq/xG8dfKamrAvc9ekG/FYn8IBZ8XoMTLIgp+8TBm+gCVgiJ7fEV4lgTYaBICSsTkw==";
        };
        _JcXFZu7K = {
            "id" = "JcXFZu7K";
            "file" = "mingen-v7.2.4.jar";
            "hash" = "sha512-UxKyuSqyQO9dV77PdIBg8iudTVxQb7eShVqzOVrdurmSkSemFkaOEn5CmYj7jvtN/su3+KGVma6znU8puWAoJw==";
        };
        _pBZ0FBoW = {
            "id" = "pBZ0FBoW";
            "file" = "Mingen v7.3.zip";
            "hash" = "sha512-II8gYHZcbXPrvLF4KQDe5alle2zTmY+oxBuvZVURlUn0hMsNpKJ0y3EQAdfkJmlGNizDLemdavwQLtHkUWDBlw==";
        };
        _YmgcHoy3 = {
            "id" = "YmgcHoy3";
            "file" = "mingen-7.3.jar";
            "hash" = "sha512-BqFDqOQAqG1iyBkueAfC4NgqayGCamnGmetem/9Szrnem73Ye0Dv95ojrV7g6zdCbra+Lm7snN1iMsny3xWywQ==";
        };
    in {
        "wLm3kI98" = _wLm3kI98;
        "OxzIGiCm" = _OxzIGiCm;
        ...
        "pBZ0FBoW" = _pBZ0FBoW;
        "YmgcHoy3" = _YmgcHoy3;
        "datapack-1.20.6" = _pBZ0FBoW;
        "datapack-1.20.5" = _pBZ0FBoW;
        "datapack-1.21" = _pBZ0FBoW;
        "datapack-1.21.1" = _pBZ0FBoW;
        "datapack-1.21.2" = _pBZ0FBoW;
        "datapack-1.21.3" = _pBZ0FBoW;
        "datapack-1.21.4" = _pBZ0FBoW;
        "datapack-1.20" = _pBZ0FBoW;
        "datapack-1.20.1" = _pBZ0FBoW;
        "datapack-1.20.2" = _pBZ0FBoW;
        "datapack-1.20.3" = _pBZ0FBoW;
        "datapack-1.20.4" = _pBZ0FBoW;
        "datapack-1.21.5" = _pBZ0FBoW;
        "datapack-1.21.9" = _pBZ0FBoW;
        "datapack-1.21.10" = _pBZ0FBoW;
        "datapack-1.21.6" = _pBZ0FBoW;
        "datapack-1.21.7" = _pBZ0FBoW;
        "datapack-1.21.8" = _pBZ0FBoW;
        "datapack-1.21.11" = _pBZ0FBoW;
        "datapack-24w33a" = _pBZ0FBoW;
        "datapack-24w34a" = _pBZ0FBoW;
        "datapack-24w35a" = _pBZ0FBoW;
        "datapack-24w36a" = _pBZ0FBoW;
        "datapack-24w37a" = _pBZ0FBoW;
        "datapack-24w38a" = _pBZ0FBoW;
        "datapack-24w39a" = _pBZ0FBoW;
        "datapack-24w40a" = _pBZ0FBoW;
        "datapack-1.21.2-pre1" = _pBZ0FBoW;
        "datapack-1.21.2-pre2" = _pBZ0FBoW;
        "datapack-24w44a" = _pBZ0FBoW;
        "datapack-24w45a" = _pBZ0FBoW;
        "datapack-24w46a" = _pBZ0FBoW;
        "datapack-26.1" = _pBZ0FBoW;
        "datapack-23w31a" = _pBZ0FBoW;
        "datapack-23w32a" = _pBZ0FBoW;
        "datapack-23w33a" = _pBZ0FBoW;
        "datapack-23w35a" = _pBZ0FBoW;
        "datapack-1.20.2-pre1" = _pBZ0FBoW;
        "datapack-23w40a" = _pBZ0FBoW;
        "datapack-23w41a" = _pBZ0FBoW;
        "datapack-23w42a" = _pBZ0FBoW;
        "datapack-23w43a" = _pBZ0FBoW;
        "datapack-23w43b" = _pBZ0FBoW;
        "datapack-23w44a" = _pBZ0FBoW;
        "datapack-23w45a" = _pBZ0FBoW;
        "datapack-23w46a" = _pBZ0FBoW;
        "datapack-1.20.3-pre1" = _pBZ0FBoW;
        "datapack-1.20.3-pre2" = _pBZ0FBoW;
        "datapack-1.20.3-pre3" = _pBZ0FBoW;
        "datapack-1.20.3-pre4" = _pBZ0FBoW;
        "datapack-23w51a" = _pBZ0FBoW;
        "datapack-23w51b" = _pBZ0FBoW;
        "datapack-24w03a" = _pBZ0FBoW;
        "datapack-24w03b" = _pBZ0FBoW;
        "datapack-24w04a" = _pBZ0FBoW;
        "datapack-24w05a" = _pBZ0FBoW;
        "datapack-24w05b" = _pBZ0FBoW;
        "datapack-24w06a" = _pBZ0FBoW;
        "datapack-24w07a" = _pBZ0FBoW;
        "datapack-24w09a" = _pBZ0FBoW;
        "datapack-24w10a" = _pBZ0FBoW;
        "datapack-24w11a" = _pBZ0FBoW;
        "datapack-24w12a" = _pBZ0FBoW;
        "datapack-24w13a" = _pBZ0FBoW;
        "datapack-24w14a" = _pBZ0FBoW;
        "datapack-1.20.5-pre1" = _pBZ0FBoW;
        "datapack-1.20.5-pre2" = _pBZ0FBoW;
        "datapack-1.20.5-pre3" = _pBZ0FBoW;
        "datapack-1.20.5-pre4" = _pBZ0FBoW;
        "datapack-1.20.5-rc1" = _pBZ0FBoW;
        "datapack-1.20.5-rc2" = _pBZ0FBoW;
        "datapack-1.20.5-rc3" = _pBZ0FBoW;
        "datapack-24w18a" = _pBZ0FBoW;
        "datapack-24w19a" = _pBZ0FBoW;
        "datapack-24w19b" = _pBZ0FBoW;
        "datapack-24w20a" = _pBZ0FBoW;
        "datapack-24w21a" = _pBZ0FBoW;
        "datapack-24w21b" = _pBZ0FBoW;
        "datapack-1.21-pre1" = _pBZ0FBoW;
        "datapack-1.21-pre2" = _pBZ0FBoW;
        "datapack-1.21-pre3" = _pBZ0FBoW;
        "datapack-1.21-pre4" = _pBZ0FBoW;
        "datapack-1.21-rc1" = _pBZ0FBoW;
        "datapack-26.1.1" = _pBZ0FBoW;
        "datapack-26.1.2" = _pBZ0FBoW;
        "datapack-26.2" = _pBZ0FBoW;
        "datapack-26.3-snapshot-1" = _pBZ0FBoW;
        "datapack-26.3-snapshot-2" = _pBZ0FBoW;
        "datapack-26.3-snapshot-3" = _pBZ0FBoW;
        "datapack-26.3-snapshot-4" = _pBZ0FBoW;
        "datapack-26.3-snapshot-5" = _pBZ0FBoW;
        "datapack-26.3-snapshot-6" = _pBZ0FBoW;
        "datapack-26.3-snapshot-7" = _pBZ0FBoW;
        "datapack-26.3-snapshot-8" = _pBZ0FBoW;
        "datapack-26.3-snapshot-9" = _pBZ0FBoW;
        "datapack-26.3-snapshot-10" = _pBZ0FBoW;
        "datapack-26.3-pre-1" = _pBZ0FBoW;
        "datapack-26.3-pre-2" = _pBZ0FBoW;
        "datapack-26.3-pre-3" = _pBZ0FBoW;
        "datapack-26.3-rc-1" = _pBZ0FBoW;
        "datapack-26.3-rc-2" = _pBZ0FBoW;
        "datapack-26.3-rc-3" = _pBZ0FBoW;
        "datapack-26.3" = _pBZ0FBoW;
        "fabric-1.20.5" = _YmgcHoy3;
        "fabric-1.20.6" = _YmgcHoy3;
        "fabric-1.21" = _YmgcHoy3;
        "fabric-1.21.1" = _YmgcHoy3;
        "fabric-1.21.2" = _YmgcHoy3;
        "fabric-1.21.3" = _YmgcHoy3;
        "fabric-1.21.4" = _YmgcHoy3;
        "fabric-1.20" = _YmgcHoy3;
        "fabric-1.20.1" = _YmgcHoy3;
        "fabric-1.20.2" = _YmgcHoy3;
        "fabric-1.20.3" = _YmgcHoy3;
        "fabric-1.20.4" = _YmgcHoy3;
        "fabric-1.21.5" = _YmgcHoy3;
        "fabric-1.21.9" = _YmgcHoy3;
        "fabric-1.21.10" = _YmgcHoy3;
        "fabric-1.21.6" = _YmgcHoy3;
        "fabric-1.21.7" = _YmgcHoy3;
        "fabric-1.21.8" = _YmgcHoy3;
        "fabric-1.21.11" = _YmgcHoy3;
        "fabric-24w33a" = _YmgcHoy3;
        "fabric-24w34a" = _YmgcHoy3;
        "fabric-24w35a" = _YmgcHoy3;
        "fabric-24w36a" = _YmgcHoy3;
        "fabric-24w37a" = _YmgcHoy3;
        "fabric-24w38a" = _YmgcHoy3;
        "fabric-24w39a" = _YmgcHoy3;
        "fabric-24w40a" = _YmgcHoy3;
        "fabric-1.21.2-pre1" = _YmgcHoy3;
        "fabric-1.21.2-pre2" = _YmgcHoy3;
        "fabric-24w44a" = _YmgcHoy3;
        "fabric-24w45a" = _YmgcHoy3;
        "fabric-24w46a" = _YmgcHoy3;
        "fabric-26.1" = _YmgcHoy3;
        "fabric-23w31a" = _YmgcHoy3;
        "fabric-23w32a" = _YmgcHoy3;
        "fabric-23w33a" = _YmgcHoy3;
        "fabric-23w35a" = _YmgcHoy3;
        "fabric-1.20.2-pre1" = _YmgcHoy3;
        "fabric-23w40a" = _YmgcHoy3;
        "fabric-23w41a" = _YmgcHoy3;
        "fabric-23w42a" = _YmgcHoy3;
        "fabric-23w43a" = _YmgcHoy3;
        "fabric-23w43b" = _YmgcHoy3;
        "fabric-23w44a" = _YmgcHoy3;
        "fabric-23w45a" = _YmgcHoy3;
        "fabric-23w46a" = _YmgcHoy3;
        "fabric-1.20.3-pre1" = _YmgcHoy3;
        "fabric-1.20.3-pre2" = _YmgcHoy3;
        "fabric-1.20.3-pre3" = _YmgcHoy3;
        "fabric-1.20.3-pre4" = _YmgcHoy3;
        "fabric-23w51a" = _YmgcHoy3;
        "fabric-23w51b" = _YmgcHoy3;
        "fabric-24w03a" = _YmgcHoy3;
        "fabric-24w03b" = _YmgcHoy3;
        "fabric-24w04a" = _YmgcHoy3;
        "fabric-24w05a" = _YmgcHoy3;
        "fabric-24w05b" = _YmgcHoy3;
        "fabric-24w06a" = _YmgcHoy3;
        "fabric-24w07a" = _YmgcHoy3;
        "fabric-24w09a" = _YmgcHoy3;
        "fabric-24w10a" = _YmgcHoy3;
        "fabric-24w11a" = _YmgcHoy3;
        "fabric-24w12a" = _YmgcHoy3;
        "fabric-24w13a" = _YmgcHoy3;
        "fabric-24w14a" = _YmgcHoy3;
        "fabric-1.20.5-pre1" = _YmgcHoy3;
        "fabric-1.20.5-pre2" = _YmgcHoy3;
        "fabric-1.20.5-pre3" = _YmgcHoy3;
        "fabric-1.20.5-pre4" = _YmgcHoy3;
        "fabric-1.20.5-rc1" = _YmgcHoy3;
        "fabric-1.20.5-rc2" = _YmgcHoy3;
        "fabric-1.20.5-rc3" = _YmgcHoy3;
        "fabric-24w18a" = _YmgcHoy3;
        "fabric-24w19a" = _YmgcHoy3;
        "fabric-24w19b" = _YmgcHoy3;
        "fabric-24w20a" = _YmgcHoy3;
        "fabric-24w21a" = _YmgcHoy3;
        "fabric-24w21b" = _YmgcHoy3;
        "fabric-1.21-pre1" = _YmgcHoy3;
        "fabric-1.21-pre2" = _YmgcHoy3;
        "fabric-1.21-pre3" = _YmgcHoy3;
        "fabric-1.21-pre4" = _YmgcHoy3;
        "fabric-1.21-rc1" = _YmgcHoy3;
        "fabric-26.1.1" = _YmgcHoy3;
        "fabric-26.1.2" = _YmgcHoy3;
        "fabric-26.2" = _YmgcHoy3;
        "fabric-26.3-snapshot-1" = _YmgcHoy3;
        "fabric-26.3-snapshot-2" = _YmgcHoy3;
        "fabric-26.3-snapshot-3" = _YmgcHoy3;
        "fabric-26.3-snapshot-4" = _YmgcHoy3;
        "fabric-26.3-snapshot-5" = _YmgcHoy3;
        "fabric-26.3-snapshot-6" = _YmgcHoy3;
        "fabric-26.3-snapshot-7" = _YmgcHoy3;
        "fabric-26.3-snapshot-8" = _YmgcHoy3;
        "fabric-26.3-snapshot-9" = _YmgcHoy3;
        "fabric-26.3-snapshot-10" = _YmgcHoy3;
        "fabric-26.3-pre-1" = _YmgcHoy3;
        "fabric-26.3-pre-2" = _YmgcHoy3;
        "fabric-26.3-pre-3" = _YmgcHoy3;
        "fabric-26.3-rc-1" = _YmgcHoy3;
        "fabric-26.3-rc-2" = _YmgcHoy3;
        "fabric-26.3-rc-3" = _YmgcHoy3;
        "fabric-26.3" = _YmgcHoy3;
        "forge-1.20.5" = _YmgcHoy3;
        "forge-1.20.6" = _YmgcHoy3;
        "forge-1.21" = _YmgcHoy3;
        "forge-1.21.1" = _YmgcHoy3;
        "forge-1.21.2" = _YmgcHoy3;
        "forge-1.21.3" = _YmgcHoy3;
        "forge-1.21.4" = _YmgcHoy3;
        "forge-1.20" = _YmgcHoy3;
        "forge-1.20.1" = _YmgcHoy3;
        "forge-1.20.2" = _YmgcHoy3;
        "forge-1.20.3" = _YmgcHoy3;
        "forge-1.20.4" = _YmgcHoy3;
        "forge-1.21.5" = _YmgcHoy3;
        "forge-1.21.9" = _YmgcHoy3;
        "forge-1.21.10" = _YmgcHoy3;
        "forge-1.21.6" = _YmgcHoy3;
        "forge-1.21.7" = _YmgcHoy3;
        "forge-1.21.8" = _YmgcHoy3;
        "forge-1.21.11" = _YmgcHoy3;
        "forge-24w33a" = _YmgcHoy3;
        "forge-24w34a" = _YmgcHoy3;
        "forge-24w35a" = _YmgcHoy3;
        "forge-24w36a" = _YmgcHoy3;
        "forge-24w37a" = _YmgcHoy3;
        "forge-24w38a" = _YmgcHoy3;
        "forge-24w39a" = _YmgcHoy3;
        "forge-24w40a" = _YmgcHoy3;
        "forge-1.21.2-pre1" = _YmgcHoy3;
        "forge-1.21.2-pre2" = _YmgcHoy3;
        "forge-24w44a" = _YmgcHoy3;
        "forge-24w45a" = _YmgcHoy3;
        "forge-24w46a" = _YmgcHoy3;
        "forge-26.1" = _YmgcHoy3;
        "forge-23w31a" = _YmgcHoy3;
        "forge-23w32a" = _YmgcHoy3;
        "forge-23w33a" = _YmgcHoy3;
        "forge-23w35a" = _YmgcHoy3;
        "forge-1.20.2-pre1" = _YmgcHoy3;
        "forge-23w40a" = _YmgcHoy3;
        "forge-23w41a" = _YmgcHoy3;
        "forge-23w42a" = _YmgcHoy3;
        "forge-23w43a" = _YmgcHoy3;
        "forge-23w43b" = _YmgcHoy3;
        "forge-23w44a" = _YmgcHoy3;
        "forge-23w45a" = _YmgcHoy3;
        "forge-23w46a" = _YmgcHoy3;
        "forge-1.20.3-pre1" = _YmgcHoy3;
        "forge-1.20.3-pre2" = _YmgcHoy3;
        "forge-1.20.3-pre3" = _YmgcHoy3;
        "forge-1.20.3-pre4" = _YmgcHoy3;
        "forge-23w51a" = _YmgcHoy3;
        "forge-23w51b" = _YmgcHoy3;
        "forge-24w03a" = _YmgcHoy3;
        "forge-24w03b" = _YmgcHoy3;
        "forge-24w04a" = _YmgcHoy3;
        "forge-24w05a" = _YmgcHoy3;
        "forge-24w05b" = _YmgcHoy3;
        "forge-24w06a" = _YmgcHoy3;
        "forge-24w07a" = _YmgcHoy3;
        "forge-24w09a" = _YmgcHoy3;
        "forge-24w10a" = _YmgcHoy3;
        "forge-24w11a" = _YmgcHoy3;
        "forge-24w12a" = _YmgcHoy3;
        "forge-24w13a" = _YmgcHoy3;
        "forge-24w14a" = _YmgcHoy3;
        "forge-1.20.5-pre1" = _YmgcHoy3;
        "forge-1.20.5-pre2" = _YmgcHoy3;
        "forge-1.20.5-pre3" = _YmgcHoy3;
        "forge-1.20.5-pre4" = _YmgcHoy3;
        "forge-1.20.5-rc1" = _YmgcHoy3;
        "forge-1.20.5-rc2" = _YmgcHoy3;
        "forge-1.20.5-rc3" = _YmgcHoy3;
        "forge-24w18a" = _YmgcHoy3;
        "forge-24w19a" = _YmgcHoy3;
        "forge-24w19b" = _YmgcHoy3;
        "forge-24w20a" = _YmgcHoy3;
        "forge-24w21a" = _YmgcHoy3;
        "forge-24w21b" = _YmgcHoy3;
        "forge-1.21-pre1" = _YmgcHoy3;
        "forge-1.21-pre2" = _YmgcHoy3;
        "forge-1.21-pre3" = _YmgcHoy3;
        "forge-1.21-pre4" = _YmgcHoy3;
        "forge-1.21-rc1" = _YmgcHoy3;
        "forge-26.1.1" = _YmgcHoy3;
        "forge-26.1.2" = _YmgcHoy3;
        "forge-26.2" = _YmgcHoy3;
        "forge-26.3-snapshot-1" = _YmgcHoy3;
        "forge-26.3-snapshot-2" = _YmgcHoy3;
        "forge-26.3-snapshot-3" = _YmgcHoy3;
        "forge-26.3-snapshot-4" = _YmgcHoy3;
        "forge-26.3-snapshot-5" = _YmgcHoy3;
        "forge-26.3-snapshot-6" = _YmgcHoy3;
        "forge-26.3-snapshot-7" = _YmgcHoy3;
        "forge-26.3-snapshot-8" = _YmgcHoy3;
        "forge-26.3-snapshot-9" = _YmgcHoy3;
        "forge-26.3-snapshot-10" = _YmgcHoy3;
        "forge-26.3-pre-1" = _YmgcHoy3;
        "forge-26.3-pre-2" = _YmgcHoy3;
        "forge-26.3-pre-3" = _YmgcHoy3;
        "forge-26.3-rc-1" = _YmgcHoy3;
        "forge-26.3-rc-2" = _YmgcHoy3;
        "forge-26.3-rc-3" = _YmgcHoy3;
        "forge-26.3" = _YmgcHoy3;
        "quilt-1.20.5" = _YmgcHoy3;
        "quilt-1.20.6" = _YmgcHoy3;
        "quilt-1.21" = _YmgcHoy3;
        "quilt-1.21.1" = _YmgcHoy3;
        "quilt-1.21.2" = _YmgcHoy3;
        "quilt-1.21.3" = _YmgcHoy3;
        "quilt-1.21.4" = _YmgcHoy3;
        "quilt-1.20" = _YmgcHoy3;
        "quilt-1.20.1" = _YmgcHoy3;
        "quilt-1.20.2" = _YmgcHoy3;
        "quilt-1.20.3" = _YmgcHoy3;
        "quilt-1.20.4" = _YmgcHoy3;
        "quilt-1.21.5" = _YmgcHoy3;
        "quilt-1.21.9" = _YmgcHoy3;
        "quilt-1.21.10" = _YmgcHoy3;
        "quilt-1.21.6" = _YmgcHoy3;
        "quilt-1.21.7" = _YmgcHoy3;
        "quilt-1.21.8" = _YmgcHoy3;
        "quilt-1.21.11" = _YmgcHoy3;
        "quilt-24w33a" = _YmgcHoy3;
        "quilt-24w34a" = _YmgcHoy3;
        "quilt-24w35a" = _YmgcHoy3;
        "quilt-24w36a" = _YmgcHoy3;
        "quilt-24w37a" = _YmgcHoy3;
        "quilt-24w38a" = _YmgcHoy3;
        "quilt-24w39a" = _YmgcHoy3;
        "quilt-24w40a" = _YmgcHoy3;
        "quilt-1.21.2-pre1" = _YmgcHoy3;
        "quilt-1.21.2-pre2" = _YmgcHoy3;
        "quilt-24w44a" = _YmgcHoy3;
        "quilt-24w45a" = _YmgcHoy3;
        "quilt-24w46a" = _YmgcHoy3;
        "quilt-26.1" = _YmgcHoy3;
        "quilt-23w31a" = _YmgcHoy3;
        "quilt-23w32a" = _YmgcHoy3;
        "quilt-23w33a" = _YmgcHoy3;
        "quilt-23w35a" = _YmgcHoy3;
        "quilt-1.20.2-pre1" = _YmgcHoy3;
        "quilt-23w40a" = _YmgcHoy3;
        "quilt-23w41a" = _YmgcHoy3;
        "quilt-23w42a" = _YmgcHoy3;
        "quilt-23w43a" = _YmgcHoy3;
        "quilt-23w43b" = _YmgcHoy3;
        "quilt-23w44a" = _YmgcHoy3;
        "quilt-23w45a" = _YmgcHoy3;
        "quilt-23w46a" = _YmgcHoy3;
        "quilt-1.20.3-pre1" = _YmgcHoy3;
        "quilt-1.20.3-pre2" = _YmgcHoy3;
        "quilt-1.20.3-pre3" = _YmgcHoy3;
        "quilt-1.20.3-pre4" = _YmgcHoy3;
        "quilt-23w51a" = _YmgcHoy3;
        "quilt-23w51b" = _YmgcHoy3;
        "quilt-24w03a" = _YmgcHoy3;
        "quilt-24w03b" = _YmgcHoy3;
        "quilt-24w04a" = _YmgcHoy3;
        "quilt-24w05a" = _YmgcHoy3;
        "quilt-24w05b" = _YmgcHoy3;
        "quilt-24w06a" = _YmgcHoy3;
        "quilt-24w07a" = _YmgcHoy3;
        "quilt-24w09a" = _YmgcHoy3;
        "quilt-24w10a" = _YmgcHoy3;
        "quilt-24w11a" = _YmgcHoy3;
        "quilt-24w12a" = _YmgcHoy3;
        "quilt-24w13a" = _YmgcHoy3;
        "quilt-24w14a" = _YmgcHoy3;
        "quilt-1.20.5-pre1" = _YmgcHoy3;
        "quilt-1.20.5-pre2" = _YmgcHoy3;
        "quilt-1.20.5-pre3" = _YmgcHoy3;
        "quilt-1.20.5-pre4" = _YmgcHoy3;
        "quilt-1.20.5-rc1" = _YmgcHoy3;
        "quilt-1.20.5-rc2" = _YmgcHoy3;
        "quilt-1.20.5-rc3" = _YmgcHoy3;
        "quilt-24w18a" = _YmgcHoy3;
        "quilt-24w19a" = _YmgcHoy3;
        "quilt-24w19b" = _YmgcHoy3;
        "quilt-24w20a" = _YmgcHoy3;
        "quilt-24w21a" = _YmgcHoy3;
        "quilt-24w21b" = _YmgcHoy3;
        "quilt-1.21-pre1" = _YmgcHoy3;
        "quilt-1.21-pre2" = _YmgcHoy3;
        "quilt-1.21-pre3" = _YmgcHoy3;
        "quilt-1.21-pre4" = _YmgcHoy3;
        "quilt-1.21-rc1" = _YmgcHoy3;
        "quilt-26.1.1" = _YmgcHoy3;
        "quilt-26.1.2" = _YmgcHoy3;
        "quilt-26.2" = _YmgcHoy3;
        "quilt-26.3-snapshot-1" = _YmgcHoy3;
        "quilt-26.3-snapshot-2" = _YmgcHoy3;
        "quilt-26.3-snapshot-3" = _YmgcHoy3;
        "quilt-26.3-snapshot-4" = _YmgcHoy3;
        "quilt-26.3-snapshot-5" = _YmgcHoy3;
        "quilt-26.3-snapshot-6" = _YmgcHoy3;
        "quilt-26.3-snapshot-7" = _YmgcHoy3;
        "quilt-26.3-snapshot-8" = _YmgcHoy3;
        "quilt-26.3-snapshot-9" = _YmgcHoy3;
        "quilt-26.3-snapshot-10" = _YmgcHoy3;
        "quilt-26.3-pre-1" = _YmgcHoy3;
        "quilt-26.3-pre-2" = _YmgcHoy3;
        "quilt-26.3-pre-3" = _YmgcHoy3;
        "quilt-26.3-rc-1" = _YmgcHoy3;
        "quilt-26.3-rc-2" = _YmgcHoy3;
        "quilt-26.3-rc-3" = _YmgcHoy3;
        "quilt-26.3" = _YmgcHoy3;
        "neoforge-1.20.5" = _YmgcHoy3;
        "neoforge-1.20.6" = _YmgcHoy3;
        "neoforge-1.21" = _YmgcHoy3;
        "neoforge-1.21.1" = _YmgcHoy3;
        "neoforge-1.21.2" = _YmgcHoy3;
        "neoforge-1.21.3" = _YmgcHoy3;
        "neoforge-1.21.4" = _YmgcHoy3;
        "neoforge-1.20" = _YmgcHoy3;
        "neoforge-1.20.1" = _YmgcHoy3;
        "neoforge-1.20.2" = _YmgcHoy3;
        "neoforge-1.20.3" = _YmgcHoy3;
        "neoforge-1.20.4" = _YmgcHoy3;
        "neoforge-1.21.5" = _YmgcHoy3;
        "neoforge-1.21.9" = _YmgcHoy3;
        "neoforge-1.21.10" = _YmgcHoy3;
        "neoforge-1.21.6" = _YmgcHoy3;
        "neoforge-1.21.7" = _YmgcHoy3;
        "neoforge-1.21.8" = _YmgcHoy3;
        "neoforge-1.21.11" = _YmgcHoy3;
        "neoforge-24w33a" = _YmgcHoy3;
        "neoforge-24w34a" = _YmgcHoy3;
        "neoforge-24w35a" = _YmgcHoy3;
        "neoforge-24w36a" = _YmgcHoy3;
        "neoforge-24w37a" = _YmgcHoy3;
        "neoforge-24w38a" = _YmgcHoy3;
        "neoforge-24w39a" = _YmgcHoy3;
        "neoforge-24w40a" = _YmgcHoy3;
        "neoforge-1.21.2-pre1" = _YmgcHoy3;
        "neoforge-1.21.2-pre2" = _YmgcHoy3;
        "neoforge-24w44a" = _YmgcHoy3;
        "neoforge-24w45a" = _YmgcHoy3;
        "neoforge-24w46a" = _YmgcHoy3;
        "neoforge-26.1" = _YmgcHoy3;
        "neoforge-23w31a" = _YmgcHoy3;
        "neoforge-23w32a" = _YmgcHoy3;
        "neoforge-23w33a" = _YmgcHoy3;
        "neoforge-23w35a" = _YmgcHoy3;
        "neoforge-1.20.2-pre1" = _YmgcHoy3;
        "neoforge-23w40a" = _YmgcHoy3;
        "neoforge-23w41a" = _YmgcHoy3;
        "neoforge-23w42a" = _YmgcHoy3;
        "neoforge-23w43a" = _YmgcHoy3;
        "neoforge-23w43b" = _YmgcHoy3;
        "neoforge-23w44a" = _YmgcHoy3;
        "neoforge-23w45a" = _YmgcHoy3;
        "neoforge-23w46a" = _YmgcHoy3;
        "neoforge-1.20.3-pre1" = _YmgcHoy3;
        "neoforge-1.20.3-pre2" = _YmgcHoy3;
        "neoforge-1.20.3-pre3" = _YmgcHoy3;
        "neoforge-1.20.3-pre4" = _YmgcHoy3;
        "neoforge-23w51a" = _YmgcHoy3;
        "neoforge-23w51b" = _YmgcHoy3;
        "neoforge-24w03a" = _YmgcHoy3;
        "neoforge-24w03b" = _YmgcHoy3;
        "neoforge-24w04a" = _YmgcHoy3;
        "neoforge-24w05a" = _YmgcHoy3;
        "neoforge-24w05b" = _YmgcHoy3;
        "neoforge-24w06a" = _YmgcHoy3;
        "neoforge-24w07a" = _YmgcHoy3;
        "neoforge-24w09a" = _YmgcHoy3;
        "neoforge-24w10a" = _YmgcHoy3;
        "neoforge-24w11a" = _YmgcHoy3;
        "neoforge-24w12a" = _YmgcHoy3;
        "neoforge-24w13a" = _YmgcHoy3;
        "neoforge-24w14a" = _YmgcHoy3;
        "neoforge-1.20.5-pre1" = _YmgcHoy3;
        "neoforge-1.20.5-pre2" = _YmgcHoy3;
        "neoforge-1.20.5-pre3" = _YmgcHoy3;
        "neoforge-1.20.5-pre4" = _YmgcHoy3;
        "neoforge-1.20.5-rc1" = _YmgcHoy3;
        "neoforge-1.20.5-rc2" = _YmgcHoy3;
        "neoforge-1.20.5-rc3" = _YmgcHoy3;
        "neoforge-24w18a" = _YmgcHoy3;
        "neoforge-24w19a" = _YmgcHoy3;
        "neoforge-24w19b" = _YmgcHoy3;
        "neoforge-24w20a" = _YmgcHoy3;
        "neoforge-24w21a" = _YmgcHoy3;
        "neoforge-24w21b" = _YmgcHoy3;
        "neoforge-1.21-pre1" = _YmgcHoy3;
        "neoforge-1.21-pre2" = _YmgcHoy3;
        "neoforge-1.21-pre3" = _YmgcHoy3;
        "neoforge-1.21-pre4" = _YmgcHoy3;
        "neoforge-1.21-rc1" = _YmgcHoy3;
        "neoforge-26.1.1" = _YmgcHoy3;
        "neoforge-26.1.2" = _YmgcHoy3;
        "neoforge-26.2" = _YmgcHoy3;
        "neoforge-26.3-snapshot-1" = _YmgcHoy3;
        "neoforge-26.3-snapshot-2" = _YmgcHoy3;
        "neoforge-26.3-snapshot-3" = _YmgcHoy3;
        "neoforge-26.3-snapshot-4" = _YmgcHoy3;
        "neoforge-26.3-snapshot-5" = _YmgcHoy3;
        "neoforge-26.3-snapshot-6" = _YmgcHoy3;
        "neoforge-26.3-snapshot-7" = _YmgcHoy3;
        "neoforge-26.3-snapshot-8" = _YmgcHoy3;
        "neoforge-26.3-snapshot-9" = _YmgcHoy3;
        "neoforge-26.3-snapshot-10" = _YmgcHoy3;
        "neoforge-26.3-pre-1" = _YmgcHoy3;
        "neoforge-26.3-pre-2" = _YmgcHoy3;
        "neoforge-26.3-pre-3" = _YmgcHoy3;
        "neoforge-26.3-rc-1" = _YmgcHoy3;
        "neoforge-26.3-rc-2" = _YmgcHoy3;
        "neoforge-26.3-rc-3" = _YmgcHoy3;
        "neoforge-26.3" = _YmgcHoy3;
        "pkg-b1.0" = _wLm3kI98;
        "pkg-b1.1" = _OxzIGiCm;
        "pkg-b1.2" = _zaEFWLld;
        "pkg-b1.3" = _enAwwSja;
        "pkg-r1.0" = _QBbnEeLs;
        "pkg-r1.0+mod" = _bDrv9XxV;
        "pkg-r1.1" = _qNkCrL8r;
        "pkg-r1.1+mod" = _IGuhAdXa;
        "pkg-r1.2" = _DLNKpC9Z;
        "pkg-r1.2+mod" = _RUij49IG;
        "pkg-1.3" = _f3VAYZrj;
        "pkg-1.3+mod" = _pBmbNp8T;
        "pkg-1.4" = _B3H3vL1o;
        "pkg-1.4+mod" = _kn3y0Jch;
        "pkg-1.5" = _yQeiZrFl;
        "pkg-1.5+mod" = _wgA4bkmr;
        "pkg-1.6" = _zTrYdpi9;
        "pkg-1.6+mod" = _qwQRYCtR;
        "pkg-1.7" = _IxIZbyEN;
        "pkg-1.7+mod" = _M7mNPH7c;
        "pkg-1.8" = _BacqK80P;
        "pkg-1.8+mod" = _H4rzI6m4;
        "pkg-1.9" = _KC6vGY8D;
        "pkg-1.9+mod" = _AuWbmMvt;
        "pkg-2.0" = _sxOR2PLc;
        "pkg-2.0+mod" = _x4D5qI9a;
        "pkg-2.1" = _iW6TztkJ;
        "pkg-2.1+mod" = _tM39M1Sf;
        "pkg-2.3" = _LB9tD6DP;
        "pkg-2.3+mod" = _9FknZMlO;
        "pkg-2.4" = _3QgR9fq6;
        "pkg-2.4+mod" = _of8C8ABZ;
        "pkg-2.5" = _EIwSRuk1;
        "pkg-2.5+mod" = _gq9smGKM;
        "pkg-2.6" = _D4luDq1Y;
        "pkg-2.6+mod" = _2rSR1rVe;
        "pkg-2.7" = _9suFAjY3;
        "pkg-2.7+mod" = _lxLxLUtf;
        "pkg-2.8" = _YT11P2LR;
        "pkg-2.8+mod" = _WfPIpG2j;
        "pkg-2.9" = _1Cv4ptNN;
        "pkg-2.9+mod" = _dV9HFpvD;
        "pkg-3.0" = _AFhPDJEO;
        "pkg-3.0+mod" = _N0uShDyl;
        "pkg-3.1" = _BeMRbUJT;
        "pkg-3.1+mod" = _AnaKQqwW;
        "pkg-3.2" = _63CTquEN;
        "pkg-3.2+mod" = _rplQUB9i;
        "pkg-3.3" = _jEaAQR6E;
        "pkg-3.3+mod" = _sjIdsFJE;
        "pkg-3.4" = _1qiRxwbl;
        "pkg-3.4+mod" = _Zw7Ri01f;
        "pkg-3.5" = _W2WIkbq4;
        "pkg-3.5+mod" = _uhqXPQsI;
        "pkg-3.6" = _R35LYehr;
        "pkg-3.6+mod" = _BxOZXCew;
        "pkg-3.7" = _vCnWMQGu;
        "pkg-3.7+mod" = _bjWvbygs;
        "pkg-3.8" = _yWcVdbZg;
        "pkg-3.8+mod" = _TQBK31LK;
        "pkg-3.9" = _G8yosrOR;
        "pkg-3.9+mod" = _l7Y5ED3u;
        "pkg-4.0" = _uJd7bboY;
        "pkg-4.0+mod" = _e1ZbbZ2K;
        "pkg-4.1" = _nDEyIw76;
        "pkg-4.1+mod" = _PMlRR5b4;
        "pkg-4.2" = _8KZsxgWh;
        "pkg-4.3" = _CHM4zgBb;
        "pkg-4.4" = _HpMg44J5;
        "pkg-4.5" = _JuDelS0K;
        ...
        "pkg-v6.2" = _67F3p1DZ;
        "pkg-v6.3" = _dG8xpkxv;
        "pkg-v6.3.5" = _V8qBOZGw;
        "pkg-v6.4" = _7pg11yhr;
        "pkg-v6.4.5" = _IUax25ea;
        "pkg-v6.5" = _OUT3G0uF;
        "pkg-v6.6" = _j0BWtjrE;
        "pkg-v6.7" = _vzM7afGj;
        "pkg-v6.8" = _nGJvZnmP;
        "pkg-v6.9" = _wgQjVcNy;
        "pkg-v6.9.5" = _vpK2GTSb;
        "pkg-v6.9.6" = _eZoRyZ7g;
        "pkg-v7.0" = _os63RpQa;
        "pkg-v7.0.1" = _ZC3ujQaK;
        "pkg-v7.1" = _Mql2OzB6;
        "pkg-v7.1.1" = _tmj5nYiP;
        "pkg-v7.2" = _NsLMypZK;
        "pkg-v7.2.1" = _davtldc3;
        "pkg-v7.2.2" = _Ze9ByKBY;
        "pkg-v7.2.3" = _N4KCFqwj;
        "pkg-v7.2.4" = _JcXFZu7K;
        "pkg-v7.3" = _YmgcHoy3;
        "default" = _YmgcHoy3;
    });
