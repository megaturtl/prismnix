...
let
    ...
    in {
        ...
        "pkg-0.3.2b" = _QIPKIINd;
        "pkg-1.9.43" = _eCSbC9qK;
        "pkg-1.9.45" = _jFlLXDyR;
        "pkg-1.9.50" = _VQOMbHEV;
        "pkg-1.10.23" = _cDOlS1Ky;
        "pkg-1.10.24" = _aaSxlRBR;
        "pkg-1.10.36" = _AliG8wlL;
        "pkg-1.9.54" = _qNlX7voE;
        "pkg-1.11.28" = _s8FGlBhs;
        "pkg-1.10.48" = _FKBjYrjk;
        "pkg-1.11.36" = _rwGfUxbm;
        "pkg-1.11.44" = _WsOlVxTh;
        "pkg-1.11.55" = _tYI6Cs95;
        "pkg-1.11.61" = _VcP695kZ;
        "pkg-1.11.63" = _rGbPgYgU;
        "pkg-1.11.71" = _M8XCCqYJ;
        "pkg-1.11.79" = _ATZFAPLK;
