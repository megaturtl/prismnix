...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.2.6b" = _nVen9e72;
        "pkg-2.2.7" = _noyQZgHm;
        "pkg-2.2.7a" = _rSHl0dKp;
        "pkg-2.2.7b" = _E37Ig4fv;
        "pkg-2.2.7c" = _Q2Krzhep;
        "pkg-2.2.7d" = _6PonClat;
        "pkg-2.2.8" = _mrXKB4KZ;
        "pkg-2.3.0" = _Ns5Yte6l;
        "pkg-2.3.0a" = _xDjtXpra;
        "pkg-2.3.0b" = _TAfNrUGl;
        "pkg-2.3.1" = _jbY9e1VH;
        "pkg-2.3.1b" = _MHNO5cPX;
        "pkg-2.3.1c" = _8prfVhws;
        "pkg-2.4.0a" = _SlgtESeF;
        "pkg-2.4.0b" = _qOKsE3aN;
        "pkg-2.4.0c" = _a5rLl0TQ;
        "pkg-2.4.0d" = _k8ckEiZ1;
        "pkg-2.4.1" = _EL0bE4D4;
        "pkg-2.5.0beta1" = _vOYasc1y;
        "pkg-2.5.0beta2" = _It3GS3Es;
        "pkg-2.5.0beta3" = _6GZVWAW3;
        "pkg-2.5.1" = _dHpEM1GP;
        "pkg-2.5.2hotfix" = _MW3PZD6P;
        "pkg-2.5.2a" = _7Ih3nivh;
