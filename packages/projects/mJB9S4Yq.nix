...
let
    ...
    in {
        ...
        "fabric-26.3-snapshot-6" = _2ecdqTQT;
        "fabric-26.3-snapshot-7" = _2ecdqTQT;
        "fabric-26.3-snapshot-8" = _2ecdqTQT;
        "fabric-26.3-snapshot-9" = _2ecdqTQT;
        "fabric-26.3-snapshot-10" = _2ecdqTQT;
        "fabric-26.3-pre-1" = _2ecdqTQT;
        "fabric-26.3-pre-2" = _2ecdqTQT;
        ...
        "neoforge-26.3-snapshot-6" = _dvJaONNq;
        "neoforge-26.3-snapshot-7" = _dvJaONNq;
        "neoforge-26.3-snapshot-8" = _dvJaONNq;
        "neoforge-26.3-snapshot-9" = _dvJaONNq;
        "neoforge-26.3-snapshot-10" = _dvJaONNq;
        "neoforge-26.3-pre-1" = _dvJaONNq;
        "neoforge-26.3-pre-2" = _dvJaONNq;
        "pkg-1.1.0" = _pjFhy9fg;
        "pkg-2.0" = _2lme2cbi;
        "pkg-2.1" = _3RiQsxhY;
        "pkg-2.2" = _y6zZCNzx;
        "pkg-2.3+1.21.3" = _y8VJkqPz;
        "pkg-2.3+1.20.6" = _D3UF5Sx8;
        "pkg-2.3+1.21.8" = _icRjQic2;
        "pkg-2.3+1.20.4" = _39vA8q36;
        "pkg-2.3+1.21.1" = _bcjoXE57;
        "pkg-2.3+1.20.1" = _X5bOhlQW;
        "pkg-2.3+1.21.4" = _tXbpIveN;
        "pkg-2.3+1.21.5" = _uWd8GIJu;
        "pkg-2.3.1+1.20.1" = _mhBMIrmw;
        "pkg-2.3.1+1.20.4" = _wShO1mMQ;
        "pkg-2.3.1+1.20.6" = _ZbZwid9f;
        "pkg-2.3.1+1.21.1" = _nKIlBIfB;
        "pkg-2.3.1+1.21.3" = _SX4EkNNs;
        "pkg-2.3.1+1.21.4" = _Nh3tgNXq;
        "pkg-2.3.1+1.21.5" = _QBPhjh7b;
        "pkg-2.3.1+1.21.8" = _8oCU4kUc;
        "pkg-2.3.1+1.21.9" = _jYjNf50B;
        "pkg-2.4.0+1.20-fabric" = _RuQyp6ZV;
        "pkg-2.4.0+1.20.3-fabric" = _gEZoTXrB;
        "pkg-2.4.0+1.21-fabric" = _4SghkZ3d;
        "pkg-2.4.0+1.21-neoforge" = _YD2QAfPB;
        "pkg-2.4.0+1.21.2-fabric" = _uc7Toore;
        "pkg-2.4.0+1.21.2-neoforge" = _feawed2w;
        "pkg-2.4.0+1.21.9-fabric" = _XtggLchF;
        "pkg-2.4.0+1.21.9-neoforge" = _qOzA7phu;
        "pkg-2.4.0+1.21.11-neoforge" = _h7DLF04r;
        "pkg-2.4.0+26.1-fabric" = _3BW35Z0u;
        "pkg-2.4.0+26.1-neoforge" = _lqIhoN5y;
        "pkg-2.5.0+1.21.2-fabric" = _9flV4qIx;
        "pkg-2.5.0+1.20-fabric" = _93QNEa0I;
        "pkg-2.5.0+1.20.3-fabric" = _rB2fjEPw;
        "pkg-2.5.0+1.21-fabric" = _6K0zNuPF;
        "pkg-2.5.0+1.21-neoforge" = _CTrQzY78;
        "pkg-2.5.0+1.21.2-neoforge" = _TymTU4AK;
        "pkg-2.5.0+1.21.9-fabric" = _cbOVNrcz;
        "pkg-2.5.0+1.21.9-neoforge" = _4R8P8RpK;
        "pkg-2.5.0+1.21.11-neoforge" = _lxrVs2vd;
        "pkg-2.5.0+26.1-fabric" = _1g6YR293;
        "pkg-2.5.0+26.1-neoforge" = _sqUWJevP;
        "pkg-2.5.1+1.20-fabric" = _jjxmSUQN;
        "pkg-2.5.1+1.20.3-fabric" = _BmjcfCw2;
        "pkg-2.5.1+1.21-fabric" = _1qwtFKYD;
        "pkg-2.5.1+1.21-neoforge" = _3CtHhvyn;
        "pkg-2.5.1+1.21.2-fabric" = _dR4saO0R;
        "pkg-2.5.1+1.21.2-neoforge" = _N9sPbdMt;
        "pkg-2.5.1+1.21.9-fabric" = _YWM8jTOK;
        "pkg-2.5.1+1.21.9-neoforge" = _UJn9Owf0;
        "pkg-2.5.1+1.21.11-neoforge" = _eC3umUho;
        "pkg-2.5.1+26.1-fabric" = _9dZKX8OW;
        "pkg-2.5.1+26.1-neoforge" = _ExBdMPxU;
        "pkg-2.5.1+26.2-fabric" = _2ecdqTQT;
        "pkg-2.5.1+26.2-neoforge" = _dvJaONNq;
        "default" = _dvJaONNq;
    });
