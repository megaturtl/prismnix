...
let
    ...
    in {
        ...
        "pkg-0.3.4" = _UN11yIkC;
        "pkg-0.4.2" = _FOx5Sp5O;
        "pkg-0.5.0-DEV" = _zrAwDSYe;
        "pkg-0.5.1" = _v3JnRcbG;
        "pkg-0.5.2" = _bHfTmppT;
        "pkg-PREPRE-0.6.0" = _x4j1waOt;
        "pkg-PRE-0.6.0-1.7.2" = _JqV0pw8m;
        "pkg-PRE-0.6.0-1.7.10" = _MZQI487J;
        "pkg-PRE2-0.6.0-1.7.2" = _Njn5uxSw;
        "pkg-PRE2-0.6.0-1.7.10" = _uioq8ibD;
        "pkg-0.6.1" = _775pHgwz;
        "pkg-0.6.2" = _MXbmxTUw;
        "pkg-0.7.0" = _D56dObfs;
        "pkg-0.7.5-PRE" = _iA1btRi1;
        "pkg-0.7.5-PRE2" = _K2kcAwcu;
        "pkg-0.7.5" = _qctNnPJ0;
        "pkg-0.7.5.1" = _pzdsHK8y;
        "pkg-0.7.5.2" = _3nfZNSDE;
        "pkg-0.7.5.3" = _gEcCWo2y;
        "pkg-0.7.6" = _sUgteBCB;
        "pkg-0.8.0" = _panpmpuU;
        "pkg-0.8.1" = _PbbLOgll;
        "pkg-0.8.2" = _rJqym09e;
        "pkg-0.8.2.1" = _KfeLG9dy;
        "pkg-0.9.0-beta" = _4M1ahf5m;
        "pkg-0.9.0" = _lTZVUPYv;
        "pkg-0.9.1" = _7CZ3qRCb;
        "pkg-0.9.0.1" = _3u3v87W3;
        "pkg-0.9.2" = _LkD9Jv0p;
        "pkg-0.9.2.1" = _POQxAD1K;
        "pkg-0.9.2.2" = _HtOozQjd;
        "pkg-1.0.0" = _mFijlfLI;
        "pkg-1.1.0.0" = _YftEKNjQ;
        "pkg-1.1.0.1" = _puMmJYis;
        "pkg-1.1.0.2" = _NVlIlBEp;
        "pkg-2.0.0.0" = _VpYKSZ7W;
        "pkg-2.0.0.1" = _5f2iptXm;
        "pkg-2.0.1.0" = _RlL3Z1BR;
        "pkg-2.0.1.1" = _jb9cvwYC;
        "pkg-2.0.1.2-1.15.2" = _V2kEGxuV;
        "pkg-2.0.1.2-1.16.4" = _zKRDaa5m;
        "pkg-2.0.1.3-1.15.2" = _JIBkwP6U;
        "pkg-2.0.1.3-1.16.4" = _Lvidqcas;
        "pkg-2.0.1.4-1.15.2" = _mUOZRZWD;
        "pkg-2.0.1.4-1.16.4" = _C4arxASZ;
        "pkg-2.0.1.5-1.15.2" = _Fok0J9mQ;
        "pkg-2.0.1.5-1.16.4" = _KbgHFYfz;
        "pkg-2.0.1.6-1.15.2" = _nC07XB50;
        "pkg-2.0.1.6-1.16.4" = _Olm2LoCm;
        "pkg-2.0.1.7" = _qz75OsSm;
        "pkg-2.0.1.8" = _NoQyuUXB;
        "pkg-2.0.2.0" = _uG7Lx8m0;
        "pkg-2.0.2.1" = _MA0JJ2iT;
        "pkg-2.0.2.2" = _q9TU6HvQ;
        "pkg-2.0.2.3" = _GobzDxX7;
        "pkg-2.0.3.0" = _Dh7gnwzG;
        "pkg-2.0.3.1" = _9Z5mRHwQ;
        "pkg-2.0.4.0" = _i2AATTox;
        "pkg-2.0.4.1" = _44Lpthey;
        "pkg-2.0.4.2" = _SnKC3EuD;
        "pkg-2.0.4.3" = _DlhD4kUK;
        "pkg-2.0.4.4" = _O6csmqWP;
        "pkg-2.0.4.5" = _EhNXWyLg;
        "pkg-2.0.4.6" = _iusuDYnx;
        "pkg-2.0.5.0" = _Hg2EgfWB;
        "pkg-2.0.6.0" = _7tYoAnPd;
        "pkg-2.0.6.1" = _XeE3FOuz;
        "pkg-2.0.6.2" = _f50fChGk;
        "pkg-2.0.7.0" = _uG6tnZXV;
        "pkg-2.0.7.1" = _8zvpfSfb;
        "pkg-2.1.0.0" = _ATFo1TJk;
        "pkg-2.1.0.1" = _yU0udBT2;
        "pkg-2.1.0.2" = _sXcYuVxi;
        "pkg-2.1.1.0" = _Dt9Hm3OV;
        "pkg-2.1.2.0" = _ZmOHgpLf;
        "pkg-2.1.2.1" = _nahsVmWq;
        "pkg-2.1.2.2" = _Mv2Gjj1Q;
        "pkg-2.1.3.0" = _prmClZo6;
        "pkg-2.1.3.1" = _uD6b4y6x;
        "pkg-2.1.4.0" = _3iTM8zZV;
        "pkg-2.1.4.1" = _WfD1zjuK;
        "pkg-2.1.4.2" = _9pSESN4a;
        "pkg-2.1.5.0" = _f92Gp6fA;
        "pkg-2.1.6.0" = _243QJNrQ;
        "pkg-2.1.6.1" = _9pjWZ2a1;
        "pkg-2.1.6.2" = _zcM520iT;
        "pkg-2.1.6.3" = _h1adqLml;
        "pkg-2.1.6.4" = _wTQIV7I1;
        "pkg-2.1.6.5" = _kuG9GuTv;
        "pkg-2.1.6.6" = _tvX8MRMU;
        "pkg-2.1.6.7" = _Z5SUD21v;
        "pkg-2.1.6.8" = _T5UQMVw4;
        "pkg-1.18.2-2.1.6.9" = _eyceYDsr;
        "pkg-2.2.0.0" = _AkFmJkjq;
        "pkg-2.2.0.0-1.19.3" = _RXpqMB1f;
        "pkg-2.2.0.0-1.19.4" = _97a6uFAS;
        "pkg-2.2.0.1" = _IHkuDG2M;
        "pkg-2.2.1.0" = _yKlTVT6K;
        "pkg-2.2.1.0-1.19.4" = _JlSZA3HI;
        "pkg-1.19.4-2.2.1.1" = _BHG8LOx0;
        "pkg-1.19.2-2.2.1.1" = _gbBCRhei;
        "pkg-1.19.2-2.2.1.2" = _myrq3YYd;
        "pkg-1.19.4-2.2.1.2" = _pNn3X5Tx;
        "pkg-1.19.2-2.3.0.0" = _7VIemo78;
        "pkg-1.19.4-2.3.0.0" = _T9dpOCDU;
        "pkg-1.19.2-2.3.0.1" = _6xJggR4S;
        "pkg-1.19.4-2.3.0.1" = _5Y89nW1i;
        "pkg-1.19.4-2.3.1.0" = _9XYhMUXl;
        "pkg-1.19.2-2.3.1.0" = _9b7chtO1;
        "pkg-2.3.2.0" = _3ov276Wo;
        "pkg-1.19.4-2.3.2.1" = _jVr6GHdW;
        "pkg-1.19.2-2.3.2.1" = _cMnpaeAF;
        "pkg-1.19.4-2.3.3.0" = _N9toRyfI;
        "pkg-1.19.2-2.3.3.0" = _QR6bOcFj;
        "pkg-1.19.2-2.3.3.1" = _1N0Vyu4d;
        "pkg-1.19.4-2.3.3.1" = _iWxOK8T2;
        "pkg-1.19.2-2.3.4.0" = _AJUVX6uy;
        "pkg-1.19.4-2.3.4.0" = _cVzv5Wcg;
        "pkg-1.20.1-2.3.4.0" = _F9Yhv6GW;
        "pkg-1.20.1-2.3.4.1" = _2TBQrPqT;
        "pkg-1.20.1-2.3.4.2" = _kjzijAu6;
        "pkg-1.20.1-2.3.5.0" = _7rpVhEsS;
        "pkg-1.20.1-2.3.5.1" = _M543a2gQ;
        "pkg-1.20.1-2.3.5.2" = _J4nlo7Na;
        "pkg-1.20.1-2.3.6.0" = _4UkwZqWM;
        "pkg-1.20.1-2.3.7.0" = _4FWfIjxB;
        "pkg-1.20.1-2.3.7.1" = _L6pkqTUS;
        "pkg-1.20.1-2.3.8.0" = _sIDLmWTA;
        "pkg-1.20.1-2.3.8.0.358-2" = _yjId59jM;
        "pkg-1.20.1-2.3.8.1" = _uRlKjDs6;
        "pkg-1.20.1-2.3.8.2" = _jsfceZ6Z;
        "pkg-1.20.1-2.3.9.0" = _gOtiyMOa;
        "pkg-1.20.1-2.3.9.1" = _ZtZTQvvc;
        "pkg-1.20.1-2.3.9.2" = _sNJ3ZTKC;
        "pkg-1.20.1-2.3.9.3" = _xRyLVR24;
        "pkg-1.20.1-2.3.9.4" = _GOD5IH37;
        "pkg-1.20.1-2.3.9.5" = _KvcBuDGl;
        "pkg-1.20.1-2.3.9.6" = _wr0etKa8;
        "pkg-1.20.1-2.3.9.7" = _o44y1DQc;
        "pkg-1.20.1-2.3.9.8" = _8L1K3IQ5;
        "pkg-1.20.1-2.3.10.1" = _6kdk0fAd;
        "pkg-1.20.1-2.3.10.2" = _8HOwxORP;
        "pkg-1.20.1-2.3.10.3" = _JbkDnKqA;
        "pkg-1.20.1-2.4.0" = _esRjTjXu;
        "pkg-1.20.1-2.4.1" = _QdCWAtP4;
        "pkg-1.20.1-2.4.2" = _AdAPEbKz;
        "pkg-1.20.1-2.5.0" = _JEHhdbHl;
        "pkg-1.20.1-2.5.1" = _iuTzBkpV;
        "pkg-1.20.1-2.5.2" = _5g3cJIVR;
        "pkg-1.20.1-2.5.3" = _DTfI06cm;
        "pkg-1.20.1-2.5.4" = _Z2vMafi1;
        "pkg-1.20.1-2.5.5a" = _nQTQfjyi;
        "pkg-1.20.1-2.6.0a" = _8t0PtBrR;
        "pkg-2.6.0a-1.21.1" = _lE0VcUPh;
        "pkg-2.6.0b-1.21.1" = _Ms37tl6j;
        "pkg-2.6.0c-1.21.1" = _vXuFTnS8;
        "pkg-2.6.0d-1.21.1" = _Knq77wuv;
        "pkg-2.6.0b-1.20.1" = _gx5mozeG;
        "pkg-2.6.1a-1.21.1" = _oPUC7hjF;
        "pkg-2.6.1a-1.20.1" = _UH4cHaIo;
        "pkg-2.6.1b-1.21.1" = _f04O9kwc;
        "pkg-2.6.1b-1.20.1" = _dfrJVkgf;
        "pkg-2.6.2a-1.21.1" = _NBAEBU3Q;
        "pkg-2.6.2a-1.20.1" = _HCp4KAi5;
        "pkg-2.6.2b-1.21.1" = _JE9cuVRx;
        "pkg-2.6.2b-1.20.1" = _K2qSVNwH;
        "pkg-2.6.2c-1.21.1" = _YtyX5CF1;
        "pkg-2.6.2c-1.20.1" = _3fIzBhlL;
        "pkg-2.6.2d-1.21.1" = _BVQHMl8X;
        "pkg-2.6.2d-1.20.1" = _mnHGgQKo;
        "pkg-2.6.2e-1.21.1" = _azPFVmPJ;
        "pkg-2.6.2e-1.20.1" = _WdPbssh8;
        "pkg-2.6.2f-1.21.1" = _5D6scpsk;
        "pkg-2.6.2f-1.20.1" = _ETCvqgnh;
        "pkg-2.6.3-1.21.1" = _9kQj3IZY;
        "pkg-2.6.3-1.20.1" = _DXgIMoYy;
        "pkg-2.6.3b-1.21.1" = _OJ1EJEzc;
        "pkg-2.6.3b-1.20.1" = _SEgJHZ4K;
        "pkg-2.6.4a-1.21.1" = _g5ElTz36;
        "pkg-2.6.4a-1.20.1" = _NwO01e5T;
        "pkg-2.6.4b-1.21.1" = _8JnFwm8x;
        "pkg-2.6.4b-1.20.1" = _DzgrTRKz;
        "pkg-2.6.4c-1.21.1" = _KPDfUT9l;
        "pkg-2.6.5a-1.21.1" = _iw6qMAf6;
        "pkg-2.6.5a-1.20.1" = _fQ4xHEfo;
        "pkg-2.6.5b-1.21.1" = _AEGQ4JBJ;
        "pkg-2.6.5b-1.20.1" = _D2Y5nnPF;
        "pkg-2.6.5c-1.21.1" = _tWC1kG9W;
        "pkg-2.6.5c-1.20.1" = _bStcQ0WG;
        "pkg-2.6.5d-1.21.1" = _XoNV3Zk9;
        "pkg-2.6.5d-1.20.1" = _dA4tOE0L;
        "pkg-2.6.5e-1.21.1" = _k6WjHmBL;
        "pkg-2.6.5f-1.21.1" = _ZQjo0t0s;
        "pkg-2.6.5f-1.20.1" = _LB9ONAEI;
        "pkg-2.6.6-1.20.1" = _QOXj1sTN;
        "pkg-2.7.0-1.21.1" = _LBwAE4Gc;
        "pkg-2.6.6a-1.20.1" = _Q1zUzgKO;
        "pkg-2.7.0a-1.21.1" = _vzEmZtPP;
        "pkg-2.6.6b-1.20.1" = _12liM5hY;
        "pkg-2.6.6c-1.20.1" = _BCAy9Iw9;
        "pkg-2.7.1a-1.21.1" = _QuuOFz7I;
        "pkg-2.7.1b-1.21.1" = _86IETnDt;
        "pkg-2.7.1c-1.21.1" = _yAjrXzWE;
        "pkg-2.7.1d-1.21.1" = _63ygeulO;
        "pkg-2.7.2a-1.21.1" = _4ybe5UWr;
        "pkg-2.7.3a-1.21.1" = _7scyexBb;
        "pkg-2.7.4a-1.21.1" = _ZtKgrj4j;
        "pkg-2.7.5a-1.21.1" = _kvtNNhg9;
        "pkg-2.7.5b-1.21.1" = _6BobJgiJ;
        "pkg-2.7.5c-1.21.1" = _sD7Io5sH;
        "pkg-2.7.5d-1.21.1" = _KzJz7Rr5;
        "pkg-2.7.6a-1.21.1" = _Yzvsgt6L;
        "pkg-2.7.7a-1.21.1" = _50Lc0qAb;
        "pkg-2.7.7b-1.21.1" = _pEybP7i1;
        "pkg-2.7.8a-1.21.1" = _5JIrL5IR;
        "pkg-2.7.9a-1.21.1" = _a5wMScZY;
        "pkg-2.7.9b-1.21.1" = _uBoBXoyZ;
        "pkg-2.7.9c-1.21.1" = _f2enRgzk;
        "pkg-2.7.10a-1.21.1" = _tDzUDStr;
        "pkg-2.7.10b-1.21.1" = _56m2bJ6O;
        "pkg-2.7.10c-1.21.1" = _QxFnCOGa;
        "pkg-2.7.10d-1.21.1" = _I009aYcH;
        "pkg-2.7.10e-1.21.1" = _Qyc8oj6l;
        "pkg-2.7.10f-1.21.1" = _DUkZdRTP;
        "pkg-2.7.11a-1.21.1" = _HwgJ1f4P;
        "pkg-2.7.11b-1.21.1" = _uW6ppo1s;
        "pkg-2.7.11c-1.21.1" = _7ZM04eKg;
        "pkg-2.7.11d-1.21.1" = _URjrnsOK;
        "pkg-2.7.12a-1.21.1" = _B0wTNkvf;
        "pkg-2.7.13a-1.21.1" = _nf2FcQAY;
        "pkg-2.7.13b-1.21.1" = _aDaCyiuO;
        "pkg-2.8.0a-1.21.1" = _DjCtnA8g;
        "pkg-2.8.0b-1.21.1" = _MRj1xtGM;
        "pkg-2.8.1a-1.21.1" = _2idxy272;
        "pkg-2.8.1b-1.21.1" = _g2G5TVxu;
        "pkg-2.8.1c-1.21.1" = _YkhnkQAt;
        "pkg-2.8.1d-1.21.1" = _dgWL15nK;
