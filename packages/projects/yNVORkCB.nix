...
let
    versions = (let
        ...
        _4p1rcZFh = {
            "id" = "4p1rcZFh";
            "file" = "SimplePets.jar";
            "hash" = "sha512-JFnM7EJnhh717f8f95RcB831DTBpZMzwKco+FOU62NImd+o+6wN8iUc79U2CXP0/an929e/+Fj8j2/M8H4rqSg==";
        };
    in {
        "5yOc6jqa" = _5yOc6jqa;
        "6YaQuqPq" = _6YaQuqPq;
        ...
        "bukkit-1.21.8" = _4p1rcZFh;
        "bukkit-1.21.10" = _4p1rcZFh;
        "bukkit-1.21.9" = _4p1rcZFh;
        "bukkit-1.21.11" = _4p1rcZFh;
        "bukkit-26.1" = _4p1rcZFh;
        "bukkit-26.1.1" = _4p1rcZFh;
        "bukkit-26.1.2" = _4p1rcZFh;
        "bukkit-26.2" = _4p1rcZFh;
        ...
        "paper-1.21.8" = _4p1rcZFh;
        "paper-1.21.10" = _4p1rcZFh;
        "paper-1.21.9" = _4p1rcZFh;
        "paper-1.21.11" = _4p1rcZFh;
        "paper-26.1" = _4p1rcZFh;
        "paper-26.1.1" = _4p1rcZFh;
        "paper-26.1.2" = _4p1rcZFh;
        "paper-26.2" = _4p1rcZFh;
        ...
        "purpur-1.21.8" = _4p1rcZFh;
        "purpur-1.21.10" = _4p1rcZFh;
        "purpur-1.21.9" = _4p1rcZFh;
        "purpur-1.21.11" = _4p1rcZFh;
        "purpur-26.1" = _4p1rcZFh;
        "purpur-26.1.1" = _4p1rcZFh;
        "purpur-26.1.2" = _4p1rcZFh;
        "purpur-26.2" = _4p1rcZFh;
        ...
        "spigot-1.21.8" = _4p1rcZFh;
        "spigot-1.21.10" = _4p1rcZFh;
        "spigot-1.21.9" = _4p1rcZFh;
        "spigot-1.21.11" = _4p1rcZFh;
        "spigot-26.1" = _4p1rcZFh;
        "spigot-26.1.1" = _4p1rcZFh;
        "spigot-26.1.2" = _4p1rcZFh;
        "spigot-26.2" = _4p1rcZFh;
        "pkg-5.0-build-185" = _5yOc6jqa;
        "pkg-5.0-build-190" = _6YaQuqPq;
        "pkg-5.0-build-192" = _VOcaL6ez;
        "pkg-5.0-build-195" = _kfoyL0LZ;
        "pkg-5.0-BUILD-200" = _qnUAtnGa;
        "pkg-5.0-build-207" = _LigzaBnW;
        "pkg-5.0-BUILD-211" = _7JNI5YNc;
        "pkg-5.0-BUILD-216" = _tBkXPemZ;
        "pkg-5.0-BUILD-222" = _hLsqPzKt;
        "pkg-5.0-BUILD-231" = _NMQ6v8j5;
        "pkg-5.0-BUILD-236" = _cGSYSeNS;
        "pkg-5.0-BUILD-238" = _rcLuDyBM;
        "pkg-5.0-BUILD-240" = _AYKCNVZK;
        "pkg-5.0-BUILD-241" = _lngCkdhd;
        "pkg-5.0-BUILD-257" = _ZpkYkP30;
        "pkg-5.0-BUILD-263" = _f2iqTai8;
        "pkg-5.0-BUILD-265" = _aSm9DGb2;
        "pkg-5.0-BUILD-270" = _FA52QHPK;
        "pkg-5.0-BUILD-272" = _PSPGmwiL;
        "pkg-5.0-BUILD-275" = _i4JMbmjm;
        "pkg-5.0-BUILD-278" = _YqKtQsvc;
        "pkg-5.0-BUILD-282" = _cPfBk4TQ;
        "pkg-5.0-BUILD-286" = _KOFwHq8Z;
        "pkg-5.0-BUILD-287" = _P343g1C8;
        "pkg-R5-B292" = _S4Nv54nI;
        "pkg-R5-B294" = _ecp869ni;
        "pkg-R5-B297" = _MO1zZeyf;
        "pkg-R5-B306" = _jSagwxkB;
        "pkg-R5-B315" = _4p1rcZFh;
        "default" = _4p1rcZFh;
    });
