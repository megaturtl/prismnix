...
let
    ...
    in {
        ...
        "pkg-1.2.487-BETA" = _JkPi3jmK;
        "pkg-1.2.490-BETA" = _fijH5Sj0;
        "pkg-1.2.491-BETA" = _zMGI2WVz;
        "pkg-1.2.492-BETA" = _chtidquJ;
        "pkg-1.2.493-BETA" = _9vkmWKa4;
        "pkg-1.2.5-BETA" = _udamAOyF;
        "pkg-1.2.51-BETA" = _INWRtJlF;
        "pkg-1.2.53-BETA" = _squPIcvE;
        "pkg-1.2.54-BETA" = _hv0E0Pmv;
        "pkg-1.2.55-BETA" = _y3YMahqu;
        "pkg-1.2.56-BETA" = _pPoQFUEm;
        "pkg-1.2.57-BETA" = _Xa0Btr27;
        "pkg-1.2.58-BETA" = _h0Br1Gl0;
        "pkg-1.2.59-BETA" = _sDEp7WyR;
        "pkg-1.2.60-BETA" = _zcFf9nR9;
        "pkg-1.2.61-BETA" = _g1uB3fhI;
        "pkg-1.2.62-BETA" = _jaBweOaz;
        "pkg-1.2.63-BETA" = _SiEMwvOW;
        "pkg-1.2.64-BETA" = _BXtCpqkj;
        "pkg-1.2.65-BETA" = _X3Fp6eB8;
        "pkg-1.2.651-BETA" = _x3T76Lqi;
        "pkg-1.2.652-BETA" = _iY9kt6E0;
        "pkg-1.2.7-BETA" = _z6XiRjTk;
        "pkg-1.2.71-BETA" = _ZPop9VXj;
        "pkg-1.2.72-BETA" = _UXbeEeh9;
        "pkg-1.2.73-BETA" = _cD10XKvE;
        "pkg-1.2.75-BETA" = _7XSy0rS3;
        "pkg-1.2.76-BETA" = _kHyaDvvd;
        "pkg-1.2.77-BETA" = _LS92KKX4;
        "pkg-1.2.78-BETA" = _XHuvAwy9;
        "pkg-1.2.79-BETA" = _BdSeae4H;
        "pkg-1.3.0" = _BWawHvPY;
        "pkg-1.3.01" = _5mltrjuQ;
        "pkg-1.3.03" = _KOAt19GQ;
        "pkg-1.3.04" = _R7W1R4vB;
        "pkg-1.3.05" = _W6fgvhYG;
        "pkg-1.3.06" = _8XAZCGp8;
        "pkg-1.3.07" = _oBMzgbdh;
        "pkg-1.3.11" = _MEVplLRB;
        "pkg-1.3.12" = _bahy7wHy;
        "pkg-1.3.13" = _rQOVSDrq;
        "pkg-1.3.15" = _5tSyEDk1;
        "pkg-1.3.16" = _x5dJiHeb;
        "pkg-1.3.17" = _p0cO1Kyn;
        "pkg-1.3.18" = _HTuGMLeZ;
        "pkg-1.3.19" = _CobP0nsd;
        "pkg-1.3.2" = _ESlB9ODa;
        "pkg-1.3.21" = _h90ANqxg;
        "pkg-1.3.22" = _gvGyIGBk;
        "pkg-1.3.23" = _UuCGGvlT;
        "pkg-1.3.24" = _3wIIRNbh;
        "pkg-1.3.25" = _TtCDtkMz;
        "pkg-1.3.251" = _XasOJRvf;
        "pkg-1.3.26" = _JLd0w1Of;
        "pkg-1.3.27" = _KHLR33TV;
        "pkg-1.3.28" = _AjK4F3TL;
        "pkg-1.3.281" = _orKUvcZS;
        "pkg-1.3.3" = _UpnnTUii;
        "pkg-1.3.301" = _DUtcPeyp;
        "pkg-1.3.302" = _YsQz5Hu8;
        "pkg-1.3.31" = _JvH7vCtE;
        "pkg-1.3.31-hf" = _MS58lVFd;
        "pkg-1.4.1" = _6tpx6EZo;
        "pkg-1.4.2" = _kDtcNwCP;
        "pkg-1.4.3" = _adbl1LIL;
        "pkg-1.5.0" = _MkOYvabs;
