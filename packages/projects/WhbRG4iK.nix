...
let
    ...
    in {
        ...
        "pkg-1.8.1" = _oHAko2xm;
        "pkg-1.9.0" = _RdpuJfjg;
        "pkg-1.10.0" = _a7SgCh8W;
        "pkg-1.11.0" = _KlJ03K3I;
        "pkg-1.11.1" = _FaCaUOFs;
        "pkg-1.12.0" = _jPEjJST0;
        "pkg-1.12.1" = _dWryIdUY;
        "pkg-1.12.2" = _uFJKVYDV;
        "pkg-1.12.3" = _XiehU3ne;
        "pkg-1.12.4" = _7bo5KA2S;
        "pkg-1.13.0" = _aufE28Na;
        "pkg-1.14.0" = _nlfT2jHV;
        "pkg-1.14.1" = _SjhvzbUC;
        "pkg-1.14.2" = _n7dcLucW;
        "pkg-1.14.3" = _bSrG4Fxf;
        "pkg-1.14.4+1.19.3" = _ZMbS4EYg;
        "pkg-1.14.5+1.19.3" = _XYq90g2b;
        "pkg-1.15.0+1.19.4" = _OSEfdzSy;
        "pkg-1.15.1+1.20.1" = _HMfGMPn2;
        "pkg-1.15.2+1.20.1" = _8qK6ANpJ;
        "pkg-1.15.3" = _mva7rKdl;
        "pkg-1.15.4" = _KpvXCE2X;
        "pkg-1.15.5+1.20.1" = _PNG0Dp43;
        "pkg-1.15.6+1.20.1" = _flPXaySR;
        "pkg-1.15.7+1.20.5" = _P5urckC8;
        "pkg-1.15.8+1.20.5" = _tdF6zGZX;
        "pkg-1.15.9+1.20.5" = _5wXruaFu;
        "pkg-1.16.0+1.21" = _U3JJC6zk;
        "pkg-1.16.1+1.21" = _HtuOat2a;
        "pkg-1.16.2+1.21" = _ue2maFEp;
        "pkg-1.16.3+1.21.2" = _xVSb7T6Z;
        "pkg-1.16.4+1.21.2" = _TCCuyvLw;
        "pkg-1.16.4+1.21" = _NpyrzO8Q;
        "pkg-1.16.5+1.21.4" = _HwMxEh47;
        "pkg-1.16.6+1.21.4" = _AAk9cT9g;
        "pkg-1.16.7+1.21.4" = _iQryyIGD;
        "pkg-1.17.0+1.21.4" = _TfbakxnW;
        "pkg-2.0.0+1.21.5" = _vYAKnvr4;
        "pkg-1.17.1+1.21.1" = _Y0zS16Bk;
        "pkg-2.0.1+1.21.5" = _Fee5709g;
        "pkg-2.0.2+1.21.9" = _otYjflTL;
        "pkg-2.0.3+1.21.11" = _U7hPBr6x;
        "pkg-2.0.4+26.1" = _RzqGQ6Yy;
