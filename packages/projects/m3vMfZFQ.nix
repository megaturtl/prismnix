...
let
    versions = (let
        ...
        _WsFfMrKG = {
            "id" = "WsFfMrKG";
            "file" = "Default-Dark-Mode-Expansion-1.19.0+-2026.9.1.zip";
            "hash" = "sha512-804rOllKtCWcr9ZzYwKPo/jD2FB13+iBoAkI7EZGeSl05hvzUezXE227O4o8cllVZlY2YlmRmdN6op73VPA1ZQ==";
        };
    in {
        "yXDkpPb1" = _yXDkpPb1;
        "l46hjgpd" = _l46hjgpd;
        ...
        "1VdGpeX7" = _1VdGpeX7;
        "WsFfMrKG" = _WsFfMrKG;
        "minecraft-1.19" = _WsFfMrKG;
        "minecraft-1.19.1" = _WsFfMrKG;
        "minecraft-1.19.2" = _WsFfMrKG;
        "minecraft-1.19.3" = _WsFfMrKG;
        "minecraft-1.19.4" = _WsFfMrKG;
        "minecraft-1.20" = _WsFfMrKG;
        "minecraft-1.20.1" = _WsFfMrKG;
        "minecraft-1.20.2" = _WsFfMrKG;
        "minecraft-1.20.3" = _WsFfMrKG;
        "minecraft-1.20.4" = _WsFfMrKG;
        "minecraft-1.20.5" = _WsFfMrKG;
        "minecraft-1.20.6" = _WsFfMrKG;
        "minecraft-1.21" = _WsFfMrKG;
        "minecraft-1.21.1" = _WsFfMrKG;
        "minecraft-1.18" = _weguyi0G;
        "minecraft-1.18.1" = _weguyi0G;
        "minecraft-1.18.2" = _weguyi0G;
        "minecraft-1.21.2" = _WsFfMrKG;
        "minecraft-1.21.3" = _WsFfMrKG;
        "minecraft-1.21.4" = _WsFfMrKG;
        ...
        "minecraft-1.21.5" = _WsFfMrKG;
        "minecraft-25w14craftmine" = _WsFfMrKG;
        ...
        "minecraft-1.21.6" = _WsFfMrKG;
        "minecraft-1.21.7-rc1" = _LSZ6cR25;
        "minecraft-1.21.7" = _WsFfMrKG;
        "minecraft-1.21.8" = _WsFfMrKG;
        "minecraft-1.21.9" = _WsFfMrKG;
        "minecraft-1.21.10" = _WsFfMrKG;
        "minecraft-25w41a" = _kCDj412J;
        "minecraft-25w42a" = _kCDj412J;
        "minecraft-25w43a" = _kCDj412J;
        "minecraft-25w44a" = _kCDj412J;
        "minecraft-1.21.11" = _WsFfMrKG;
        ...
        "minecraft-26.1" = _WsFfMrKG;
        "minecraft-26.1.1" = _WsFfMrKG;
        "minecraft-26.1.2" = _WsFfMrKG;
        "minecraft-26.2" = _WsFfMrKG;
        "minecraft-22w13oneblockatatime" = _1VdGpeX7;
        "minecraft-23w13a_or_b" = _1VdGpeX7;
        "minecraft-24w14potato" = _1VdGpeX7;
        "minecraft-26.3-snapshot-1" = _WsFfMrKG;
        "minecraft-26.3-snapshot-2" = _WsFfMrKG;
        "minecraft-26.3-snapshot-3" = _WsFfMrKG;
        "minecraft-26.3-snapshot-4" = _WsFfMrKG;
        "minecraft-26.3-snapshot-5" = _WsFfMrKG;
        "minecraft-26.3-snapshot-6" = _WsFfMrKG;
        "minecraft-26.3-snapshot-7" = _WsFfMrKG;
        "minecraft-26.3-snapshot-8" = _WsFfMrKG;
        "minecraft-26.3-snapshot-9" = _WsFfMrKG;
        "minecraft-26.3-snapshot-10" = _WsFfMrKG;
        "minecraft-26.3-pre-1" = _WsFfMrKG;
        "minecraft-26.3-pre-2" = _WsFfMrKG;
    ...
    fn = lib.prismnix.pkgs.mkVersionedModrinthPkgFn {
        ...
        versions = versions;
        meta = {
            license = lib.getLicenseFromSpdxIdOr "LicenseRef-LicenseRef-AllRightsReserved-Aric3435" {
                free = false;
                deprecated = false;
                redistributable = false;
                fullName = "LicenseRef-LicenseRef-AllRightsReserved-Aric3435";
                shortName = "LicenseRef-LicenseRef-AllRightsReserved-Aric3435";
                url = "https://raw.githubusercontent.com/aricloverEXTRA/Default-Dark-Mode-Expansion/refs/heads/1.21/LICENSE_ASSETS.txt";
            };
        };
    };
in callPackage fn {}