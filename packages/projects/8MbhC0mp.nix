...
let
    ...
    in {
        ...
        "pkg-2+mod" = _WEkxVbXX;
        "pkg-2.1" = _VrfkcOn2;
        "pkg-2.1+mod" = _bRazYGU6;
        "pkg-2.2" = _A3ZqS8UB;
        "pkg-2.2+mod" = _ljqOiprA;
        "pkg-2.3" = _cYcpMVZD;
        "pkg-2.3+mod" = _oLl9VJPd;
        "pkg-3" = _rVmxnrfU;
        "pkg-3+mod" = _sFsTEYRr;
        "pkg-3.1" = _5osDO8bl;
        "pkg-3.1+mod" = _O6vjdLsa;
        "pkg-3.2" = _c4rZqaKV;
        "pkg-3.2+mod" = _Y61xYOUl;
        "pkg-3.3" = _ZxxUqT9q;
        "pkg-3.3+mod" = _KjmaPhCl;
        "pkg-4.0" = _89NQzj6Y;
        "pkg-4.0+mod" = _CdnTy2OB;
        "pkg-4.1" = _OGHGYeHE;
        "pkg-4.1+mod" = _scvgZEpy;
        "pkg-4.2" = _BNTOlLoi;
        "pkg-4.2+mod" = _Uc0t93S1;
        "pkg-26.1" = _m17S8QWT;
        "pkg-26.1+mod" = _rqN0HFzN;
        "pkg-4.4" = _91f7139O;
