...
let
    ...
    in {
        ...
        "pkg-v1.26.0" = _lSOnTW6E;
        "pkg-v1.26.1" = _Z0fxwQkY;
        "pkg-v1.26.2" = _psp68c5a;
        "pkg-v1.27.0" = _ApOgxetb;
        "pkg-v1.27.1" = _jTZK5Ywn;
        "pkg-v1.27.2" = _UJnuQrmh;
        "pkg-v1.28.0" = _BeVuu2V4;
        "pkg-v1.27.3" = _IhC6haya;
        "pkg-v1.27.4" = _KEjzIagq;
        "pkg-v1.27.5" = _WbDpM8Ph;
        "pkg-v1.27.6" = _5KAU3Npj;
        "pkg-v1.29.0" = _eqUTNtfx;
        "pkg-v1.29.1" = _jq6ikEJ2;
        "pkg-v1.27.7" = _PtvgvomK;
        "pkg-v1.29.2" = _9QPe3kYQ;
        "pkg-v1.30.0" = _B3gM49Ih;
        "pkg-v1.30.1" = _O1G3Xdm4;
        "pkg-v1.30.2" = _VNEQCjN6;
        "pkg-v1.30.3" = _5mTmh9vT;
        "pkg-v1.30.4" = _T8HlBBY6;
        "pkg-v1.30.5" = _QrF3qEpi;
        "pkg-v1.31.0" = _sc6o4ZAN;
        "pkg-v1.31.1" = _wP0wERsP;
        "pkg-v1.31.2" = _IWBkXMCM;
        "pkg-v1.32.0" = _vQGXVBKV;
        "pkg-v1.32.1" = _HJbaBJQS;
        "pkg-v1.33.0" = _CChTQmow;
        "pkg-v1.34.0" = _kp6HxaJX;
        "pkg-v1.35.0" = _Kwkf5irP;
