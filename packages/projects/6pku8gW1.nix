...
let
    versions = (let
        ...
        _XFXD3lak = {
            "id" = "XFXD3lak";
            "file" = "energizedpower-3.0.0-rc.1+1.21.1-fabric.jar";
            "hash" = "sha512-hYtAxfACoTG4AAVSAsZy1NjD0cK1aYdLVLNH1a2SPdru1C6YgxgBPw0F+Jb2vBV+lLBlRe1zCqlhsRDpPb0BaA==";
        };
        _fwS5csNP = {
            "id" = "fwS5csNP";
            "file" = "energizedpower-3.0.0-rc.1+26.1.x-fabric.jar";
            "hash" = "sha512-5BCGlSJLpu2P0N40egHIpIbI+5Hdk2xkWd4XYKVqxEWdi60rtAFJeLbvwYzMetxw4gJsTJ3XSOafFT9HN1rbMg==";
        };
        _LAA1ohq3 = {
            "id" = "LAA1ohq3";
            "file" = "energizedpower-3.0.0-rc.1+26.2.x-fabric.jar";
            "hash" = "sha512-nwR1E3wROmd4lX4bigWpGDSmYZzUyeb/aZWD6GOuE156iC9svXPL7bPHeOqN4xrK8/RmPf3fwkgcFufMsJ+t0A==";
        };
        _mGrv3vOC = {
            "id" = "mGrv3vOC";
            "file" = "energizedpower-3.0.0-rc.1+1.21.1-neoforge.jar";
            "hash" = "sha512-0Jdmn/8Siyb/0gQrfak1nl1fRmc9ItpCqpGbhzZ+nnur0lkEYOVs/oOf8kAzokphGt/Q4m53Q1eIEaEovxgoMA==";
        };
        _Cvw8T2jw = {
            "id" = "Cvw8T2jw";
            "file" = "energizedpower-3.0.0-rc.1+26.1.x-neoforge.jar";
            "hash" = "sha512-q3SRfvGXye9ASEYCnR0v37PaDcBJw74OvDk91mRyWqGvaUNPCEGipWf9s8UsV3/vVAWyv2rCjZ9eOCBcaOpWCA==";
        };
        _n5yscjot = {
            "id" = "n5yscjot";
            "file" = "energizedpower-3.0.0-rc.1+26.2.x-neoforge.jar";
            "hash" = "sha512-9AJ130W8As0E8xemIxFtNKvEnkLOlt7lcmPJbHsCf4hp46m2jX3uC7o3Q2MrmNlu2vhlmm6EeOtww/iWRlNOOg==";
        };
        _3dW66NPZ = {
            "id" = "3dW66NPZ";
            "file" = "energizedpower-3.0.0+1.21.1-fabric.jar";
            "hash" = "sha512-a0zE2Uw4B67eo1NanO/lVPhvOtCgmlenHFkEhd+Jw9FnD9ilksGLKdgkoTOsGv6zjfJo5FNC1+i/i7DWLrVDkA==";
        };
        _GPLG3Lpx = {
            "id" = "GPLG3Lpx";
            "file" = "energizedpower-3.0.0+26.1.x-fabric.jar";
            "hash" = "sha512-KTJ+E6WMjeydhSJCgjtn+gxSiZRwNBlARhjwPClZHMqZ15CoSCghEXH+XhooP4Bn6DYi2QWktaIrRAs0kD3WmA==";
        };
        _wwQ1xdyL = {
            "id" = "wwQ1xdyL";
            "file" = "energizedpower-3.0.0+26.2.x-fabric.jar";
            "hash" = "sha512-Yad7z4+BD7bcwK0GGU8O15M/xdsORf2jZtpq1B6gSaUV9tHYnwhPVF855s50QlvmTvAOg6xJaFkmjMF0uBLbuQ==";
        };
        _yQjy8TSv = {
            "id" = "yQjy8TSv";
            "file" = "energizedpower-3.0.0+1.21.1-neoforge.jar";
            "hash" = "sha512-jsyLXobpJ9SjicSH0rNzSXvFReHjG5KLaGV9ZxPVyOW0ul2SRwmLMIPehNQp3u1maw8nrnyK6nbzXFITgzv9sA==";
        };
        _dYpiA7T7 = {
            "id" = "dYpiA7T7";
            "file" = "energizedpower-3.0.0+26.1.x-neoforge.jar";
            "hash" = "sha512-LeWn0bZnN2r3G2qJTmQGpfU5E0/ps4yjRqJItE1aqONtTfVjp+j+aYzmnd8FTmwjwCGgyzsr3JXtzQ+XHsStlw==";
        };
        _gU8ikHHX = {
            "id" = "gU8ikHHX";
    ...
    in {
        ...
        "pkg-1.19.3-1.0.3-beta" = _8L38wn2r;
        "pkg-1.19.3-1.0.4" = _Op7unsgF;
        "pkg-1.19.3-1.1.0" = _KS4FrFXK;
        "pkg-1.19.3-1.2.0" = _mgXJDY6d;
        "pkg-1.19.3-1.2.1" = _ItDY62fN;
        "pkg-1.19.3-1.3.0" = _dGz7kAu2;
        "pkg-1.19.3-1.3.1" = _pXMiQqFh;
        "pkg-1.19.2-1.3.1" = _GgYdfig5;
        "pkg-1.19.3-1.3.2" = _arvwBEwP;
        "pkg-1.18.2-1.3.2" = _yDGJ5VfU;
        "pkg-1.17.1-1.3.2" = _BsPpFHwH;
        "pkg-1.17.1-1.3.3" = _LEKjTiQ4;
        "pkg-1.18.2-1.3.3" = _TMKEd2o1;
        "pkg-1.19.2-1.3.3" = _BWNsXaGa;
        "pkg-1.19.3-1.3.3" = _YxiBFIXk;
        "pkg-1.17.1-1.3.4" = _OI310VAh;
        "pkg-1.18.2-1.3.4" = _TduOKK0d;
        "pkg-1.19.2-1.3.4" = _wUAI6ATX;
        "pkg-1.19.3-1.3.4" = _nWeAbpWV;
        "pkg-1.19.3-1.3.4-fabric" = _KZaG09Mz;
        "pkg-1.19.3-1.3.5-fabric" = _hwdLN2qX;
        "pkg-1.17.1-1.3.5" = _vaKzNsdm;
        "pkg-1.18.2-1.3.5" = _VtFrDSUw;
        "pkg-1.19.2-1.3.5" = _ume1DEId;
        "pkg-1.19.3-1.3.5" = _nMxkWQxE;
        "pkg-1.19.3-1.3.6-fabric" = _igbC7NQS;
        "pkg-1.17.1-1.3.6" = _PM0bYpPY;
        "pkg-1.18.2-1.3.6" = _cBLyulxb;
        "pkg-1.19.2-1.3.6" = _EuGb8ENj;
        "pkg-1.19.3-1.3.6" = _s554Q0l1;
        "pkg-1.19.2-1.3.6-fabric" = _16okjdC6;
        "pkg-1.18.2-1.3.6-fabric" = _1T8JcCzl;
        "pkg-1.17.1-1.3.6-fabric" = _GKs8eHbb;
        "pkg-1.17.1-1.3.7-fabric" = _6CKRBBRR;
        "pkg-1.18.2-1.3.7-fabric" = _sPkk8xTn;
        "pkg-1.19.2-1.3.7-fabric" = _iCccL6cy;
        "pkg-1.19.3-1.3.7-fabric" = _ix5CtAge;
        "pkg-1.17.1-1.3.7" = _Yq5hLvG4;
        "pkg-1.18.2-1.3.7" = _myPweCL4;
        "pkg-1.19.2-1.3.7" = _klctt3OE;
        "pkg-1.19.3-1.3.7" = _5MxyGhAk;
        "pkg-1.18.2-1.3.8" = _SyyAG53k;
        "pkg-1.17.1-1.4.0-fabric" = _RpLP7FB6;
        "pkg-1.18.2-1.4.0-fabric" = _eNO99uS0;
        "pkg-1.19.2-1.4.0-fabric" = _NNxbvz9N;
        "pkg-1.19.3-1.4.0-fabric" = _h7F9aJ5e;
        "pkg-1.17.1-1.4.0" = _u7Eq6KQd;
        "pkg-1.18.2-1.4.0" = _Ns2THAVT;
        "pkg-1.19.2-1.4.0" = _EccELvpx;
        "pkg-1.19.3-1.4.0" = _13HEKoFh;
        "pkg-1.17.1-1.4.1-fabric" = _gVE13we4;
        "pkg-1.18.2-1.4.1-fabric" = _saBTQEv0;
        "pkg-1.19.2-1.4.1-fabric" = _rwUv8EuI;
        "pkg-1.19.3-1.4.1-fabric" = _hnY88CGr;
        "pkg-1.17.1-1.4.1" = _bVVTEu01;
        "pkg-1.18.2-1.4.1" = _3skdwnss;
        "pkg-1.19.2-1.4.1" = _hUQj6z2f;
        "pkg-1.19.3-1.4.1" = _kMVnrrUh;
        "pkg-1.17.1-1.4.2-fabric" = _SeZ5IO4z;
        "pkg-1.18.2-1.4.2-fabric" = _EwPXdt98;
        "pkg-1.19.2-1.4.2-fabric" = _SSToxpqi;
        "pkg-1.19.3-1.4.2-fabric" = _H9M4Bj9l;
        "pkg-1.17.1-1.4.2" = _E6p1RACH;
        "pkg-1.18.2-1.4.2" = _xV9PAUYO;
        "pkg-1.19.2-1.4.2" = _IW2vWCKa;
        "pkg-1.19.3-1.4.2" = _awvEYoiv;
        "pkg-1.19.4-1.4.2-fabric" = _TGZ9y6Zs;
        "pkg-1.19.4-1.4.2" = _ROFX0Ecd;
        "pkg-1.18.2-1.4.3-fabric" = _C1StBhRN;
        "pkg-1.19.2-1.4.3-fabric" = _KQ4KTCbv;
        "pkg-1.19.3-1.4.3-fabric" = _1KWJm8JV;
        "pkg-1.19.4-1.4.3-fabric" = _NgwmJ61N;
        "pkg-1.18.2-1.4.3" = _pqfa3TgE;
        "pkg-1.19.2-1.4.3" = _xbLSJLYm;
        "pkg-1.19.3-1.4.3" = _WIVIvl6F;
        "pkg-1.19.4-1.4.3" = _5aj8Kk7i;
        "pkg-1.18.2-1.4.4-fabric" = _kmLSJPp1;
        "pkg-1.19.2-1.4.4-fabric" = _hnc3mg9C;
        "pkg-1.19.3-1.4.4-fabric" = _u677OOUA;
        "pkg-1.19.4-1.4.4-fabric" = _RR6GSj6m;
        "pkg-1.18.2-1.4.4" = _xJWIuWxb;
        "pkg-1.19.2-1.4.4" = _FafFh1Hg;
        "pkg-1.19.3-1.4.4" = _20OSKuhF;
        "pkg-1.19.4-1.4.4" = _jKa3doPf;
        "pkg-1.18.2-1.4.5-fabric" = _Xsvp9HuF;
        "pkg-1.19.2-1.4.5-fabric" = _kvX9nroi;
        "pkg-1.19.3-1.4.5-fabric" = _odpIiVcp;
        "pkg-1.19.4-1.4.5-fabric" = _GxO3JedU;
        "pkg-1.18.2-1.4.5" = _Cv1wLyri;
        "pkg-1.19.2-1.4.5" = _hZIfXyLm;
        "pkg-1.19.3-1.4.5" = _a1WsUHcj;
        "pkg-1.19.4-1.4.5" = _kx5Hq2YL;
        "pkg-1.18.2-1.4.6-fabric" = _7ueCFJGg;
        "pkg-1.19.2-1.4.6-fabric" = _umEKe07l;
        "pkg-1.19.3-1.4.6-fabric" = _y7fnHAJi;
        "pkg-1.19.4-1.4.6-fabric" = _r0wwjVLY;
        "pkg-1.18.2-1.4.6" = _U87VfycX;
        "pkg-1.19.2-1.4.6" = _MLt83U3X;
        "pkg-1.19.3-1.4.6" = _S4WyqQiw;
        "pkg-1.19.4-1.4.6" = _28z9n0ad;
        "pkg-1.18.2-1.5.0-fabric" = _8o0DCZEE;
        "pkg-1.19.2-1.5.0-fabric" = _QjmE8nyY;
        "pkg-1.19.3-1.5.0-fabric" = _qfsFEL97;
        "pkg-1.19.4-1.5.0-fabric" = _uvpT4Rdb;
        "pkg-1.18.2-1.5.0" = _gyfwII5X;
        "pkg-1.19.2-1.5.0" = _xEA4cbKM;
        "pkg-1.19.3-1.5.0" = _HZ7pljRc;
        "pkg-1.19.4-1.5.0" = _21bKshtH;
        "pkg-1.18.2-1.5.1-fabric" = _kP8mG2Ut;
        "pkg-1.19.2-1.5.1-fabric" = _aW11yGTR;
        "pkg-1.19.3-1.5.1-fabric" = _q5WxGLXq;
        "pkg-1.19.4-1.5.1-fabric" = _F55u0WeL;
        "pkg-1.18.2-1.5.1" = _h5qCSBA5;
        "pkg-1.19.2-1.5.1" = _HzhyC3Fu;
        "pkg-1.19.3-1.5.1" = _APxaH9OP;
        "pkg-1.19.4-1.5.1" = _DUQ2Nm9c;
        "pkg-1.18.2-1.6.0-fabric" = _nP8lo9Yd;
        "pkg-1.19.2-1.6.0-fabric" = _2OqocppN;
        "pkg-1.19.3-1.6.0-fabric" = _3MNklald;
        "pkg-1.19.4-1.6.0-fabric" = _M2Zb6qRE;
        "pkg-1.18.2-1.6.0" = _gJBXdsoF;
        "pkg-1.19.2-1.6.0" = _Q5MlOg9P;
        "pkg-1.19.3-1.6.0" = _Xzwv5GEg;
        "pkg-1.19.4-1.6.0" = _Qk6V9B8K;
        "pkg-1.18.2-1.6.1-fabric" = _OWUm7ISK;
        "pkg-1.19.2-1.6.1-fabric" = _ZsusYB7D;
        "pkg-1.19.3-1.6.1-fabric" = _GPjNa92Z;
        "pkg-1.19.4-1.6.1-fabric" = _tSblBR1b;
        "pkg-1.18.2-1.6.1" = _nW4c7jxN;
        "pkg-1.19.2-1.6.1" = _Q6VtgYDK;
        "pkg-1.19.3-1.6.1" = _VKR2gkdx;
        "pkg-1.19.4-1.6.1" = _TLJQrYaW;
        "pkg-1.18.2-1.6.2-fabric" = _1oMkvxp4;
        "pkg-1.19.2-1.6.2-fabric" = _3TubMk1R;
        "pkg-1.19.3-1.6.2-fabric" = _dUN2oXRx;
        "pkg-1.19.4-1.6.2-fabric" = _RQ34AbKC;
        "pkg-1.18.2-1.6.2" = _LxaPcJeI;
        "pkg-1.19.2-1.6.2" = _MI1FYhc2;
        "pkg-1.19.3-1.6.2" = _XbvEejjz;
        "pkg-1.19.4-1.6.2" = _9cAJhpuV;
        "pkg-1.18.2-1.7.0-fabric" = _8vkyPkYL;
        "pkg-1.19.2-1.7.0-fabric" = _erOStE1c;
        "pkg-1.19.3-1.7.0-fabric" = _1W3I18s6;
        "pkg-1.19.4-1.7.0-fabric" = _t6lDE6W7;
        "pkg-1.18.2-1.7.0" = _9rsdT9Pe;
        "pkg-1.19.2-1.7.0" = _HiqaUCZh;
        "pkg-1.19.3-1.7.0" = _s3DldwL8;
        "pkg-1.19.4-1.7.0" = _Eq7DfPAV;
        "pkg-1.18.2-1.7.1-fabric" = _QNJB6Kjz;
        "pkg-1.19.2-1.7.1-fabric" = _7spTC2Ee;
        "pkg-1.19.3-1.7.1-fabric" = _XbIBJk4n;
        "pkg-1.19.4-1.7.1-fabric" = _bADEOKzo;
        "pkg-1.18.2-1.7.1" = _MatQTq2E;
        "pkg-1.19.2-1.7.1" = _YhdUWhBY;
        "pkg-1.19.3-1.7.1" = _6vZS0yec;
        "pkg-1.19.4-1.7.1" = _WvytEe38;
        "pkg-1.20-1.7.1-fabric" = _hX1YHATB;
        "pkg-1.20-1.7.1" = _Z0A2fUPF;
        "pkg-1.20.1-1.7.1-fabric" = _pH1bxDuZ;
        "pkg-1.20.1-1.7.2" = _f8wKb0VU;
        "pkg-1.20-1.7.3" = _Fpkt1zzV;
        "pkg-1.20.1-1.7.3" = _UbHYbWbl;
        "pkg-1.19.2-1.7.4-fabric" = _edmZDAAz;
        "pkg-1.19.3-1.7.4-fabric" = _VXzSS3Uq;
        "pkg-1.19.4-1.7.4-fabric" = _Seki39Eu;
        "pkg-1.20.1-1.7.4-fabric" = _L752CkHo;
        "pkg-1.19.2-1.7.4" = _XAtZGBSL;
        "pkg-1.19.3-1.7.4" = _RjYYzxZJ;
        "pkg-1.19.4-1.7.4" = _vVieEuWe;
        "pkg-1.20.1-1.7.4" = _sIhtIkNz;
        "pkg-1.19.2-1.7.5-fabric" = _8RVlAabi;
        "pkg-1.19.3-1.7.5-fabric" = _JqamjBUe;
        "pkg-1.19.4-1.7.5-fabric" = _kLdRvifr;
        "pkg-1.20.1-1.7.5-fabric" = _Gywfczv8;
        "pkg-1.19.2-1.7.5" = _4Di8Zbtm;
        "pkg-1.19.3-1.7.5" = _s6p8UsjH;
        "pkg-1.19.4-1.7.5" = _WdoUG5mJ;
        "pkg-1.20.1-1.7.5" = _otE6qYDl;
        "pkg-1.19.2-1.7.6-fabric" = _o5xely12;
        "pkg-1.19.3-1.7.6-fabric" = _1zqHx3BT;
        "pkg-1.19.4-1.7.6-fabric" = _jp5DoPjh;
        "pkg-1.20.1-1.7.6-fabric" = _FvDv3ZAm;
        "pkg-1.19.2-1.7.6" = _uGFAyWK6;
        "pkg-1.19.3-1.7.6" = _wZ38MCzZ;
        "pkg-1.19.4-1.7.6" = _5jM26NQw;
        "pkg-1.20.1-1.7.6" = _agzE0Atu;
        "pkg-1.19.2-1.8.0-beta-1-fabric" = _9y4i8BgI;
        "pkg-1.19.3-1.8.0-beta-1-fabric" = _E3VznRoa;
        "pkg-1.19.4-1.8.0-beta-1-fabric" = _U0I0aLne;
        "pkg-1.20.1-1.8.0-beta-1-fabric" = _eNy9zbJV;
        "pkg-1.19.2-1.8.0-beta-1" = _mLhkefzy;
        "pkg-1.19.3-1.8.0-beta-1" = _V3ymoCBU;
        "pkg-1.19.4-1.8.0-beta-1" = _AmI5X7g1;
        "pkg-1.20.1-1.8.0-beta-1" = _7kgb3FsH;
        "pkg-1.19.2-2.0.0-beta-2-fabric" = _uBShqcg5;
        "pkg-1.19.3-2.0.0-beta-2-fabric" = _QzwnliP6;
        "pkg-1.19.4-2.0.0-beta-2-fabric" = _XTM1O5hu;
        "pkg-1.20.1-2.0.0-beta-2-fabric" = _JDYvCD9C;
        "pkg-1.19.2-2.0.0-beta-2" = _9pAKOHtd;
        "pkg-1.19.3-2.0.0-beta-2" = _lZizPtIe;
        "pkg-1.19.4-2.0.0-beta-2" = _XMU4TolI;
        "pkg-1.20.1-2.0.0-beta-2" = _sQeahIqp;
        "pkg-1.19.2-2.0.0-fabric" = _6u5NsNxB;
        "pkg-1.19.3-2.0.0-fabric" = _zfnOfurV;
        "pkg-1.19.4-2.0.0-fabric" = _YcPMHCqu;
        "pkg-1.20.1-2.0.0-fabric" = _SxLe99Ha;
        "pkg-1.19.2-2.0.0" = _CTXm1lBw;
        "pkg-1.19.3-2.0.0" = _rKDzpQrG;
        "pkg-1.19.4-2.0.0" = _WcOCvsXC;
        "pkg-1.20.1-2.0.0" = _aFZG490R;
        "pkg-1.19.2-2.0.1-fabric" = _8yjd0sho;
        "pkg-1.19.3-2.0.1-fabric" = _9fvWmMbW;
        "pkg-1.19.4-2.0.1-fabric" = _AKQv3W4r;
        "pkg-1.20.1-2.0.1-fabric" = _Rmc2LVln;
        "pkg-1.19.2-2.0.1" = _SX3OyzGy;
        "pkg-1.19.3-2.0.1" = _AWCvUw4V;
        "pkg-1.19.4-2.0.1" = _47dOkyM8;
        "pkg-1.20.1-2.0.1" = _JAJ8pfxu;
        "pkg-1.19.2-2.1.0-fabric" = _lWpBvERo;
        "pkg-1.19.3-2.1.0-fabric" = _K8GAHx3z;
        "pkg-1.19.4-2.1.0-fabric" = _uehHnVOm;
        "pkg-1.20.1-2.1.0-fabric" = _xX0e7KS1;
        "pkg-1.19.2-2.1.0" = _G6Vofs4F;
        "pkg-1.19.3-2.1.0" = _LogDtort;
        "pkg-1.19.4-2.1.0" = _5nrmL0qI;
        "pkg-1.20.1-2.1.0" = _895SvTBf;
        "pkg-1.19.2-2.1.1-fabric" = _mDDM9qJE;
        "pkg-1.19.3-2.1.1-fabric" = _Oz3gdXiS;
        "pkg-1.19.4-2.1.1-fabric" = _rBXaMAui;
        "pkg-1.20.1-2.1.1-fabric" = _b2ZYr7fQ;
        "pkg-1.19.2-2.1.1" = _6nNFGRGw;
        "pkg-1.19.3-2.1.1" = _9iBhOPtm;
        "pkg-1.19.4-2.1.1" = _af1s5ire;
        "pkg-1.20.1-2.1.1" = _1iKMCBRX;
        "pkg-1.19.2-2.1.2" = _a4oystdk;
        "pkg-1.19.3-2.1.2" = _a3l5RfGC;
        "pkg-1.19.4-2.1.2" = _vnAATv4c;
        "pkg-1.20.1-2.1.2" = _75yhXQ6h;
        "pkg-1.20.2-2.1.2-fabric" = _ibGsnV7c;
        "pkg-1.20.2-2.1.2" = _HWJmDPFD;
        "pkg-1.20.2-2.1.3" = _8hW2oxAX;
        "pkg-1.20.2-2.1.4-fabric" = _uPzkIL2U;
        "pkg-1.19.2-2.2.0-fabric" = _Uf7SGz4B;
        "pkg-1.19.4-2.2.0-fabric" = _KAOmt0Ba;
        "pkg-1.20.1-2.2.0-fabric" = _14Fnqykg;
        "pkg-1.20.2-2.2.0-fabric" = _eaoGch7H;
        "pkg-1.19.2-2.2.0" = _L3okDElE;
        "pkg-1.19.4-2.2.0" = _hUjPca4p;
        "pkg-1.20.1-2.2.0" = _yM6YC0bY;
        "pkg-1.20.2-2.2.0" = _waSI0lqa;
        "pkg-1.19.2-2.2.1-fabric" = _qoNYtDRt;
        "pkg-1.19.4-2.2.1-fabric" = _YYw1Pepd;
        "pkg-1.20.1-2.2.1-fabric" = _DrMBvdhd;
        "pkg-1.20.2-2.2.1-fabric" = _TLVGRwcw;
        "pkg-1.19.2-2.2.1" = _dDYT1duj;
        "pkg-1.19.4-2.2.1" = _8BeM4hmi;
        "pkg-1.20.1-2.2.1" = _PxKREfjz;
        "pkg-1.20.2-2.2.1" = _GF1JLaSj;
        "pkg-1.19.2-2.2.2-fabric" = _yJr4NO2e;
        "pkg-1.19.4-2.2.2-fabric" = _UUfwyiBJ;
        "pkg-1.20.1-2.2.2-fabric" = _4A0z8y5u;
        "pkg-1.20.2-2.2.2-fabric" = _W4ntezEP;
        "pkg-1.19.2-2.2.2" = _LZdyAYpo;
        "pkg-1.19.4-2.2.2" = _vqhvD9EQ;
        "pkg-1.20.1-2.2.2" = _Ug6s1hF4;
        "pkg-1.20.2-2.2.2" = _RIAS9QAZ;
        "pkg-1.19.2-2.3.0-fabric" = _D1iOKOAe;
        "pkg-1.19.4-2.3.0-fabric" = _gDBjx4OO;
        "pkg-1.20.1-2.3.0-fabric" = _BZM4UP1z;
        "pkg-1.20.2-2.3.0-fabric" = _uOKbGBgQ;
        "pkg-1.19.2-2.3.0-forge" = _ZOJszqeY;
        "pkg-1.19.4-2.3.0-forge" = _eWsSdhCj;
        "pkg-1.20.1-2.3.0-forge" = _m1JtdmVG;
        "pkg-1.20.2-2.3.0-forge" = _ullZEs6Z;
        "pkg-1.19.2-2.4.0-fabric" = _Mwmwv9f8;
        "pkg-1.19.4-2.4.0-fabric" = _WR66zi15;
        "pkg-1.20.1-2.4.0-fabric" = _J1Ma5bU2;
        "pkg-1.20.2-2.4.0-fabric" = _tsS3fR2x;
        "pkg-1.19.2-2.4.0-forge" = _vAkc4kmC;
        "pkg-1.19.4-2.4.0-forge" = _HoTWwmu5;
        "pkg-1.20.1-2.4.0-forge" = _MrjuyOxu;
        "pkg-1.20.2-2.4.0-forge" = _zYk9EGtB;
        "pkg-1.20.2-2.4.0-neoforge" = _GLoZyjdh;
        "pkg-1.19.2-2.5.0-fabric" = _lMRG9IeV;
        "pkg-1.19.4-2.5.0-fabric" = _IbpRulba;
        "pkg-1.20.1-2.5.0-fabric" = _SdxuTNE2;
        "pkg-1.20.2-2.5.0-fabric" = _bCsW5Tvt;
        "pkg-1.19.2-2.5.0-forge" = _LLV8W6Uk;
        "pkg-1.19.4-2.5.0-forge" = _muQnv4CT;
        "pkg-1.20.1-2.5.0-forge" = _WnzCiMbX;
        "pkg-1.20.2-2.5.0-forge" = _BViIHsVN;
        "pkg-1.20.2-2.5.0-neoforge" = _qsi02306;
        "pkg-1.19.2-2.5.1-fabric" = _udiCoMAe;
        "pkg-1.19.4-2.5.1-fabric" = _eS309Uo3;
        "pkg-1.20.1-2.5.1-fabric" = _lNbf6nz2;
        "pkg-1.20.2-2.5.1-fabric" = _ObIdoimS;
        "pkg-1.19.2-2.5.1-forge" = _ZyKIzyuU;
        "pkg-1.19.4-2.5.1-forge" = _sthwtLNb;
        "pkg-1.20.1-2.5.1-forge" = _ySOLintG;
        "pkg-1.20.2-2.5.1-forge" = _dQiRSEW9;
        "pkg-1.20.2-2.5.1-neoforge" = _YYaCTkQQ;
        "pkg-1.19.2-2.6.0-fabric" = _hXuE34Uv;
        "pkg-1.19.4-2.6.0-fabric" = _mFlimO86;
        "pkg-1.20.1-2.6.0-fabric" = _ViCNmOFw;
        "pkg-1.20.2-2.6.0-fabric" = _EeBUf0LP;
        "pkg-1.19.2-2.6.0-forge" = _5wlOyLkz;
        "pkg-1.19.4-2.6.0-forge" = _FElRGFjo;
        "pkg-1.20.1-2.6.0-forge" = _7br85p0G;
        "pkg-1.20.2-2.6.0-forge" = _CgJo4YFW;
        "pkg-1.20.2-2.6.0-neoforge" = _Vb1s2ljx;
        "pkg-1.19.2-2.6.1-fabric" = _47v02ouL;
        "pkg-1.19.4-2.6.1-fabric" = _ITgSrDCS;
        "pkg-1.20.1-2.6.1-fabric" = _o03KBMyC;
        "pkg-1.20.2-2.6.1-fabric" = _vr4urY7v;
        "pkg-1.19.2-2.6.1-forge" = _ZBYkjhd5;
        "pkg-1.19.4-2.6.1-forge" = _T9h7vIzD;
        "pkg-1.20.1-2.6.1-forge" = _S9bblRu9;
        "pkg-1.20.2-2.6.1-forge" = _4AHRKhUY;
        "pkg-1.20.2-2.6.1-neoforge" = _A1WWHiKf;
        "pkg-1.19.3-2.1.5-fabric" = _HP0u7bSC;
        "pkg-1.19.3-2.1.5-forge" = _T7MPIuso;
        "pkg-1.20.3-2.6.1-fabric" = _ll9sJQ8i;
        "pkg-1.19.2-2.6.2-forge" = _gzgEhhFl;
        "pkg-1.19.4-2.6.2-forge" = _PWdErv6H;
        "pkg-1.20.1-2.6.2-forge" = _YvQW8PBb;
        "pkg-1.20.2-2.6.2-forge" = _BCqPYDwA;
        "pkg-1.20.2-2.6.2-neoforge" = _Eh8b7iKV;
        "pkg-1.20.3-2.6.2-neoforge" = _hocpLYzT;
        "pkg-1.20.3-2.6.2-forge" = _p1tlYuHH;
        "pkg-1.20.4-2.6.2-fabric" = _gDKMKHBG;
        "pkg-1.20.4-2.6.2-forge" = _IFlo3Iy7;
        "pkg-1.20.4-2.6.2-neoforge" = _BOSwHTCf;
        "pkg-1.20.3-2.6.3-fabric" = _4aCx9EtL;
        "pkg-1.20.4-2.6.3-fabric" = _z1UYEOxo;
        "pkg-1.20.3-2.6.3-forge" = _1zx4hN4I;
        "pkg-1.20.4-2.6.3-forge" = _jwzbPGfe;
        "pkg-1.20.3-2.6.3-neoforge" = _R0DZlrPf;
        "pkg-1.20.4-2.6.3-neoforge" = _48KNCVQy;
        "pkg-1.20.4-2.6.4-fabric" = _8PVQ3NoK;
        "pkg-1.20.4-2.6.4-forge" = _r3kvyA9U;
        "pkg-1.20.4-2.6.4-neoforge" = _Tg8mQNU1;
        "pkg-1.20.4-2.6.5-neoforge" = _I7TN20XW;
        "pkg-1.19.2-2.7.0-fabric" = _hlgxpiGk;
        "pkg-1.20.1-2.7.0-fabric" = _RTWcp1Nk;
        "pkg-1.20.2-2.7.0-fabric" = _4hcloU4s;
        "pkg-1.20.4-2.7.0-fabric" = _7fCRJLZu;
        "pkg-1.19.2-2.7.0-forge" = _amD4mW0l;
        "pkg-1.20.1-2.7.0-forge" = _BXNLh7ED;
        "pkg-1.20.2-2.7.0-forge" = _8b1ETtqX;
        "pkg-1.20.4-2.7.0-forge" = _HlS6nlvy;
        "pkg-1.20.2-2.7.0-neoforge" = _sdhNr6D2;
        "pkg-1.20.4-2.7.0-neoforge" = _6tSv4jpE;
        "pkg-1.19.2-2.8.0-fabric" = _6LKBtTTa;
        "pkg-1.20.1-2.8.0-fabric" = _qtWXBfEm;
        "pkg-1.20.2-2.8.0-fabric" = _c9Odzhxj;
        "pkg-1.20.4-2.8.0-fabric" = _YCEBRCpS;
        "pkg-1.19.2-2.8.0-forge" = _HyMmGqWX;
        "pkg-1.20.1-2.8.0-forge" = _tXio3dt2;
        "pkg-1.20.2-2.8.0-forge" = _To3h9FVO;
        "pkg-1.20.4-2.8.0-forge" = _gCXBBxj7;
        "pkg-1.20.2-2.8.0-neoforge" = _aaLvkfM9;
        "pkg-1.20.4-2.8.0-neoforge" = _TSkZcuZi;
        "pkg-1.19.4-2.6.6-fabric" = _IcTp5Fzy;
        "pkg-1.20.3-2.6.6-fabric" = _CzjWao3v;
        "pkg-1.19.2-2.9.0-fabric" = _M9e4ESOZ;
        "pkg-1.20.1-2.9.0-fabric" = _6PBNHCW0;
        "pkg-1.20.2-2.9.0-fabric" = _g5yOg4pp;
        "pkg-1.20.4-2.9.0-fabric" = _mKuHvqdl;
        "pkg-1.19.2-2.9.0-forge" = _LZV0gd09;
        "pkg-1.20.1-2.9.0-forge" = _8We66vjx;
        "pkg-1.20.2-2.9.0-forge" = _pDmfmyZF;
        "pkg-1.20.4-2.9.0-forge" = _TS7TdHDL;
        "pkg-1.20.2-2.9.0-neoforge" = _69O3S5ve;
        "pkg-1.20.4-2.9.0-neoforge" = _NARutF3F;
        "pkg-1.19.2-2.9.1-fabric" = _qIkng1Cm;
        "pkg-1.20.1-2.9.1-fabric" = _IKKOQ9Fc;
        "pkg-1.20.2-2.9.1-fabric" = _GOLNifkB;
        "pkg-1.20.4-2.9.1-fabric" = _xQQXINez;
        "pkg-1.19.2-2.9.1-forge" = _HfTgNVs4;
        "pkg-1.20.1-2.9.1-forge" = _ZmtR9m3W;
        "pkg-1.20.2-2.9.1-forge" = _GBMbhBnj;
        "pkg-1.20.4-2.9.1-forge" = _Eoq9sYLE;
        "pkg-1.20.2-2.9.1-neoforge" = _FgcqpsmB;
        "pkg-1.20.4-2.9.1-neoforge" = _6iDSp7AB;
        "pkg-1.19.2-2.9.2-fabric" = _cHzuELBc;
        "pkg-1.20.1-2.9.2-fabric" = _VObgjIS2;
        "pkg-1.20.2-2.9.2-fabric" = _CJCrtOxd;
        "pkg-1.20.4-2.9.2-fabric" = _FQ6rSWpD;
        "pkg-1.19.4-2.6.7-fabric" = _Vw32CuBg;
        "pkg-1.20.3-2.6.7-fabric" = _o8nXd7x8;
        "pkg-1.19.2-2.9.3-fabric" = _JM3pqrEb;
        "pkg-1.20.1-2.9.3-fabric" = _hLV0yoa9;
        "pkg-1.20.2-2.9.3-fabric" = _q0lEbK5Y;
        "pkg-1.20.4-2.9.3-fabric" = _psQE5qeZ;
        "pkg-1.19.2-2.9.3-forge" = _WVD8psxQ;
        "pkg-1.20.1-2.9.3-forge" = _YAVYgkG7;
        "pkg-1.20.2-2.9.3-forge" = _6umKqIwI;
        "pkg-1.20.4-2.9.3-forge" = _VHD2PFhY;
        "pkg-1.20.2-2.9.3-neoforge" = _69Tov8Sw;
        "pkg-1.20.4-2.9.3-neoforge" = _L9xLV7U0;
        "pkg-1.20.5-2.9.3-fabric" = _QSwlFW7i;
        "pkg-1.20.5-2.9.4-fabric" = _72r8xOOC;
        "pkg-1.20.5-2.9.4-neoforge" = _8XqRGsV4;
        "pkg-1.20.5-2.9.5-fabric" = _PlKSL3UO;
        "pkg-1.20.5-2.9.5-neoforge" = _joAUtylL;
        "pkg-1.20.5-2.9.6-fabric" = _1YXTKiCl;
        "pkg-1.20.5-2.9.7-fabric" = _cad5r33l;
        "pkg-1.20.5-2.9.7-neoforge" = _hKDQ5jDv;
        "pkg-1.20.5-2.9.8-neoforge" = _4hvAErge;
        "pkg-1.20.5-2.9.9-fabric" = _6Mv5YD4O;
        "pkg-1.20.5-2.9.9-neoforge" = _sHGDSSm5;
        "pkg-1.20.6-2.9.9-fabric" = _5odQz2bo;
        "pkg-1.20.5-2.9.10-neoforge" = _3Zi3vAXV;
        "pkg-1.20.6-2.9.10-neoforge" = _ElvQjWkF;
        "pkg-1.20.6-2.9.11-neoforge" = _DBjfUgtR;
        "pkg-1.19.2-2.10.0-fabric" = _VeplStlz;
        "pkg-1.20.1-2.10.0-fabric" = _AzYwyhfL;
        "pkg-1.20.2-2.10.0-fabric" = _9phA8uIQ;
        "pkg-1.20.6-2.10.0-fabric" = _ex9OT7t3;
        "pkg-1.19.2-2.10.0-forge" = _3QfUwH7s;
        "pkg-1.20.1-2.10.0-forge" = _N3Kbcl20;
        "pkg-1.20.2-2.10.0-forge" = _yo3dMPII;
        "pkg-1.20.2-2.10.0-neoforge" = _Y1xrD5tl;
        "pkg-1.20.6-2.10.0-neoforge" = _UTLUJ7s0;
        "pkg-1.19.2-2.10.1-fabric" = _CZETm8jx;
        "pkg-1.20.1-2.10.1-fabric" = _6dwlaMMl;
        "pkg-1.20.2-2.10.1-fabric" = _LaFdSuYN;
        "pkg-1.20.6-2.10.1-fabric" = _OVRsMTZF;
        "pkg-1.19.2-2.10.1-forge" = _LGqV82Qs;
        "pkg-1.20.1-2.10.1-forge" = _VkchQRIU;
        "pkg-1.20.2-2.10.1-forge" = _fCqsh6qX;
        "pkg-1.20.2-2.10.1-neoforge" = _gPn6OYUP;
        "pkg-1.20.6-2.10.1-neoforge" = _TJvl7RvK;
        "pkg-1.20.4-2.9.12-fabric" = _R1vhjYFX;
        "pkg-1.20.5-2.9.12-fabric" = _ayd9OP2v;
        "pkg-1.20.4-2.9.12-forge" = _cqjZLtbj;
        "pkg-1.20.4-2.9.12-neoforge" = _ioIXUyER;
        "pkg-1.20.5-2.9.12-neoforge" = _ztoVZcvq;
        "pkg-1.19.4-2.6.8-fabric" = _uu4yv39r;
        "pkg-1.20.3-2.6.8-fabric" = _bkbiGyo1;
        "pkg-1.19.4-2.6.8-forge" = _EQvpqOsF;
        "pkg-1.20.3-2.6.8-forge" = _sjMCjDvb;
        "pkg-1.20.3-2.6.8-neoforge" = _cw8jYfGU;
        "pkg-1.19.2-2.11.0-fabric" = _xyVOUFMh;
        "pkg-1.20.1-2.11.0-fabric" = _oLixuVzx;
        "pkg-1.20.2-2.11.0-fabric" = _fTwKhcQv;
        "pkg-1.20.6-2.11.0-fabric" = _FlZiHwHI;
        "pkg-1.19.2-2.11.0-forge" = _vdOq5OOw;
        "pkg-1.20.1-2.11.0-forge" = _c7k6juFS;
        "pkg-1.20.2-2.11.0-forge" = _NsiwzDlw;
        "pkg-1.20.2-2.11.0-neoforge" = _9vHsqvUp;
        "pkg-1.20.6-2.11.0-neoforge" = _NKAku8u5;
        "pkg-1.20.4-2.9.13-fabric" = _gut0R94K;
        "pkg-1.20.5-2.9.13-fabric" = _gad1qqun;
        "pkg-1.20.4-2.9.13-forge" = _mP9gf2tM;
        "pkg-1.20.4-2.9.13-neoforge" = _dcnkpyAa;
        "pkg-1.20.5-2.9.13-neoforge" = _haUk36Ih;
        "pkg-1.19.4-2.6.9-fabric" = _R2ZjnnDD;
        "pkg-1.20.3-2.6.9-fabric" = _P5TP012P;
        "pkg-1.19.4-2.6.9-forge" = _ZRkv45A0;
        "pkg-1.20.3-2.6.9-neoforge" = _YLeIHIfA;
        "pkg-1.19.3-2.1.6-fabric" = _gVzXmabG;
        "pkg-1.18.2-1.7.7-fabric" = _zbBHXeFQ;
        "pkg-1.20-1.7.7-fabric" = _ghD6UF41;
        "pkg-1.17.1-1.4.7-fabric" = _5gMqfbQe;
        "pkg-1.20.1-2.11.1-fabric" = _A372ERgC;
        "pkg-1.20.6-2.11.1-fabric" = _afmPvmRO;
        "pkg-1.19.2-2.11.1-forge" = _8msv8hys;
        "pkg-1.20.1-2.11.1-forge" = _Dp2tPjof;
        "pkg-1.20.6-2.11.1" = _ixzq4oGU;
        "pkg-1.19.2-2.11.2-fabric" = _17jIzmbI;
        "pkg-1.20.1-2.11.2-fabric" = _8rClGTdH;
        "pkg-1.20.2-2.11.2-fabric" = _3LKItDS2;
        "pkg-1.20.6-2.11.2-fabric" = _KbeUkMUm;
        "pkg-1.19.2-2.11.2-forge" = _8rkE4Fux;
        "pkg-1.20.1-2.11.2-forge" = _w2zyKgy8;
        "pkg-1.20.2-2.11.2-forge" = _Ok1XDNn7;
        "pkg-1.20.2-2.11.2-neoforge" = _IcXgg17Y;
        "pkg-1.20.6-2.11.2-neoforge" = _qw6r6fuq;
        "pkg-1.21-2.11.2-fabric" = _PHMguegl;
        "pkg-1.21-2.11.2-neoforge" = _REhMsAnu;
        "pkg-1.21-2.11.3-neoforge" = _HhsbsKEc;
        "pkg-1.19.2-2.12.0-fabric" = _cW5kOtgH;
        "pkg-1.20.1-2.12.0-fabric" = _I1h2Il9q;
        "pkg-1.20.2-2.12.0-fabric" = _L9aZ7hk0;
        "pkg-1.21-2.12.0-fabric" = _1pWGPr7h;
        "pkg-1.19.2-2.12.0-forge" = _HLzSLnd4;
        "pkg-1.20.1-2.12.0-forge" = _MGAdUowH;
        "pkg-1.20.2-2.12.0-forge" = _DWTqujPb;
        "pkg-1.20.2-2.12.0-neoforge" = _X8K9jMZM;
        "pkg-1.21-2.12.0-neoforge" = _SJsjmb9b;
        "pkg-1.19.2-2.12.1-fabric" = _dcI5SAup;
        "pkg-1.20.1-2.12.1-fabric" = _tlstSWz9;
        "pkg-1.20.2-2.12.1-fabric" = _vynOXLOg;
        "pkg-1.21-2.12.1-fabric" = _mxiuO90t;
        "pkg-1.19.2-2.12.1-forge" = _Wh0FkOAc;
        "pkg-1.20.1-2.12.1-forge" = _sSM03dgT;
        "pkg-1.20.2-2.12.1-forge" = _ZtCnW20R;
        "pkg-1.20.2-2.12.1-neoforge" = _eoCDC4Gl;
        "pkg-1.21-2.12.1-neoforge" = _YSMCLwLO;
        "pkg-1.21.1-2.12.1-fabric" = _J2AQ7wRm;
        "pkg-1.21.1-2.12.1-neoforge" = _mNzle5zN;
        "pkg-1.21.1-2.12.2-fabric" = _pcg4nSnQ;
        "pkg-1.21.1-2.12.2-neoforge" = _1OxmEJAK;
        "pkg-1.19.2-2.12.3-fabric" = _6evnZziw;
        "pkg-1.20.1-2.12.3-fabric" = _2T9ODlcp;
        "pkg-1.20.2-2.12.3-fabric" = _xvgzuGBB;
        "pkg-1.21.1-2.12.3-fabric" = _Zwa79fmz;
        "pkg-1.19.2-2.12.3-forge" = _U3Nc2uXi;
        "pkg-1.20.1-2.12.3-forge" = _gQ0KFkYN;
        "pkg-1.20.2-2.12.3-forge" = _KQ2hVZG5;
        "pkg-1.20.2-2.12.3-neoforge" = _VuFsPHJb;
        "pkg-1.21.1-2.12.3-neoforge" = _IpjZC4HI;
        "pkg-1.19.2-2.12.4-fabric" = _o54UxKL1;
        "pkg-1.20.1-2.12.4-fabric" = _jsPyfdlX;
        "pkg-1.20.2-2.12.4-fabric" = _DYku10BI;
        "pkg-1.21.1-2.12.4-fabric" = _27xQGxDh;
        "pkg-1.19.2-2.12.4-forge" = _cTh0wOtn;
        "pkg-1.20.1-2.12.4-forge" = _edxAbHjc;
        "pkg-1.20.2-2.12.4-forge" = _KYIgZkjl;
        "pkg-1.20.2-2.12.4-neoforge" = _gqsCf7IB;
        "pkg-1.21.1-2.12.4-neoforge" = _EB3mX4tP;
        "pkg-1.21.2-2.12.4-fabric" = _2RYLhqDm;
        "pkg-1.21.3-2.12.4-fabric" = _unyZ8r4B;
        "pkg-1.21.2-2.12.4-neoforge" = _RRDTZlL2;
        "pkg-1.21.3-2.12.4-neoforge" = _JxbRVpan;
        "pkg-1.21.4-2.12.4-fabric" = _adEl8zyX;
        "pkg-1.21.4-2.12.4-neoforge" = _TCPCQ1Sx;
        "pkg-1.21.4-2.12.5-neoforge" = _TAiblRVI;
        "pkg-1.20.1-2.13.0-fabric" = _4c4SZ966;
        "pkg-1.21.1-2.13.0-fabric" = _xPVHanEZ;
        "pkg-1.21.4-2.13.0-fabric" = _NsFvVzq2;
        "pkg-1.20.1-2.13.0-forge" = _zV6JwrlR;
        "pkg-1.21.1-2.13.0-neoforge" = _JCuEv19p;
        "pkg-1.21.4-2.13.0-neoforge" = _dRo8gz5D;
        "pkg-1.19.2-2.12.6-fabric" = _KKOgaYq5;
        "pkg-1.20.2-2.12.6-fabric" = _mp1icr4F;
        "pkg-1.21.5-2.13.0-fabric" = _VEAl1JSH;
        "pkg-1.21.5-2.13.0-neoforge" = _Y4TW5fp0;
        "pkg-1.20.1-2.14.0-fabric" = _wvDCkTSJ;
        "pkg-1.21.1-2.14.0-fabric" = _HqdrYuoY;
        "pkg-1.21.5-2.14.0-fabric" = _kAxkwDh1;
        "pkg-1.20.1-2.14.0-forge" = _nJQ31mbQ;
        "pkg-1.21.1-2.14.0-neoforge" = _WqdY9gef;
        "pkg-1.21.5-2.14.0-neoforge" = _o7K35WIZ;
        "pkg-1.21.6-2.14.0-fabric" = _GudC0WWe;
        "pkg-1.21.6-2.14.1-fabric" = _gQYTZFa1;
        "pkg-1.21.6-2.14.0-neoforge" = _Qnjt78PO;
        "pkg-1.21.7-2.14.1-fabric" = _FJxpHfGF;
        "pkg-1.21.7-2.14.1-neoforge" = _gV2iUwww;
        "pkg-1.21.7-2.14.2-neoforge" = _fvXifTNU;
        "pkg-1.21.8-2.14.1-fabric" = _dlRldBos;
        "pkg-1.21.8-2.14.2-neoforge" = _5qqffzYh;
        "pkg-1.20.1-2.15.0-fabric" = _xbGqdcOs;
        "pkg-1.21.1-2.15.0-fabric" = _S3WegzqR;
        "pkg-1.21.8-2.15.0-fabric" = _m0Tm0ygn;
        "pkg-1.20.1-2.15.0-forge" = _p0jI7WMa;
        "pkg-1.21.1-2.15.0-neoforge" = _mVokrRki;
        "pkg-1.21.8-2.15.0-neoforge" = _n9xkrmp7;
        "pkg-1.20.1-2.15.1-fabric" = _7dVg07NQ;
        "pkg-1.21.1-2.15.1-fabric" = _rQVwiElZ;
        "pkg-1.21.8-2.15.1-fabric" = _c4PqsgYl;
        "pkg-1.20.1-2.15.1-forge" = _1nSABp0g;
        "pkg-1.21.1-2.15.1-neoforge" = _agW15igb;
        "pkg-1.21.8-2.15.1-neoforge" = _dUMoYUEr;
        "pkg-1.20.1-2.15.2-fabric" = _93ucq7GO;
        "pkg-1.21.1-2.15.2-fabric" = _yha9sJK8;
        "pkg-1.21.8-2.15.2-fabric" = _X0YpMGbQ;
        "pkg-1.20.1-2.15.3-fabric" = _RcmGaGB4;
        "pkg-1.21.1-2.15.3-fabric" = _prOtFrnk;
        "pkg-1.21.8-2.15.3-fabric" = _IueG1V66;
        "pkg-1.20.1-2.15.3-forge" = _yqUDVcxw;
        "pkg-1.21.1-2.15.3-neoforge" = _H7x4itPu;
        "pkg-1.21.8-2.15.3-neoforge" = _pE4iRbUx;
        "pkg-1.20.1-2.15.4-fabric" = _j0ruDDSv;
        "pkg-1.21.1-2.15.4-fabric" = _fargYzVi;
        "pkg-1.21.8-2.15.4-fabric" = _4JquDBXH;
        "pkg-1.20.1-2.15.4-forge" = _t72mo95v;
        "pkg-1.21.1-2.15.4-neoforge" = _5JhvAWvt;
        "pkg-1.21.8-2.15.4-neoforge" = _WWOzsXQj;
        "pkg-1.21.9-2.15.4-fabric" = _mnBlD2vQ;
        "pkg-1.21.9-2.15.4-neoforge" = _sVtN8DJi;
        "pkg-1.21.10-2.15.4-fabric" = _SjDToLcl;
        "pkg-1.21.10-2.15.4-neoforge" = _ljKOU2pQ;
        "pkg-1.21.10-2.15.5-neoforge" = _XJxL5yzC;
        "pkg-1.20.1-2.15.6-fabric" = _Nfmtmu3l;
        "pkg-1.21.1-2.15.6-fabric" = _cVClfHic;
        "pkg-1.21.10-2.15.7-fabric" = _xV7B38Yg;
        "pkg-1.21.1-2.15.7-fabric" = _4CqN4PRx;
        "pkg-1.20.1-2.15.7-fabric" = _jUgmNgV4;
        "pkg-1.21.1-2.15.7-neoforge" = _dUtoLBns;
        "pkg-1.21.10-2.15.8-neoforge" = _bEFAL8Av;
        "pkg-1.21.10-2.15.9-fabric" = _EGs11xOV;
        "pkg-1.21.11-2.15.9-fabric" = _nziWjw8s;
        "pkg-1.21.11-2.15.9-neoforge" = _Qsuthcub;
        "pkg-1.21.11-2.15.10-fabric" = _3fm9iP9B;
        "pkg-1.20.1-2.15.11-fabric" = _CticYZMl;
        "pkg-1.21.1-2.15.11-fabric" = _6fpWaPZD;
        "pkg-1.21.11-2.15.11-fabric" = _kgM9lNFs;
        "pkg-1.20.1-2.15.11-forge" = _KPrQYkRZ;
        "pkg-1.21.1-2.15.11-neoforge" = _Pgq2Xdm4;
        "pkg-1.21.11-2.15.11-neoforge" = _SiVRLz3L;
        "pkg-1.20.1-2.15.12-fabric" = _Cp7YoRUr;
        "pkg-1.21.1-2.15.12-fabric" = _lQ3T62Ud;
        "pkg-1.21.11-2.15.12-fabric" = _3YoFwVm2;
        "pkg-1.20.1-2.15.12-forge" = _Q1Ah0oLY;
        "pkg-1.21.1-2.15.12-neoforge" = _UAGd3Xtr;
        "pkg-1.21.11-2.15.12-neoforge" = _jayVqrAF;
        "pkg-1.21.11-2.15.13-neoforge" = _1jnnQEJf;
        "pkg-1.18.2-1.7.8" = _ZD5n22WT;
        "pkg-1.21.11-2.15.14-neoforge" = _ojv4KPWQ;
        "pkg-1.21.10-2.15.14-neoforge" = _e1eEnVGs;
        "pkg-1.21.9-2.15.14-neoforge" = _YumErrt3;
        "pkg-26.1-2.15.14-fabric" = _9FJVbq7b;
        "pkg-26.1-2.15.14-neoforge" = _b0SE3eTz;
        "pkg-26.1-2.15.15-fabric" = _aiiRLfvp;
        "pkg-1.20.1-2.15.16-fabric" = _ClRrSgf0;
        "pkg-1.21.1-2.15.16-fabric" = _UfDSi5B1;
        "pkg-26.1.x-2.15.16-fabric" = _JcaWVTbA;
        "pkg-1.20.1-2.15.16-forge" = _2I0eur6t;
        "pkg-1.21.1-2.15.16-neoforge" = _YR615goP;
        "pkg-26.1.x-2.15.16-neoforge" = _XcAxiR59;
        "pkg-1.20.1-2.15.17-fabric" = _pe8GaG5M;
        "pkg-1.21.1-2.15.17-fabric" = _sO1y7df2;
        "pkg-26.1.x-2.15.17-fabric" = _lqJLubhP;
        "pkg-1.20.1-2.15.17-forge" = _2DUpiCgy;
        "pkg-1.21.1-2.15.17-neoforge" = _MufIkb00;
        "pkg-26.1.x-2.15.17-neoforge" = _UYru1v1g;
        "pkg-1.20.1-2.15.18-fabric" = _dHOyrSwS;
        "pkg-1.21.1-2.15.18-fabric" = _1KHMqrxK;
        "pkg-26.1.x-2.15.18-fabric" = _XOhujKer;
        "pkg-1.20.1-2.15.18-forge" = _9QJW6fA7;
        "pkg-1.21.1-2.15.18-neoforge" = _qZDlZ1vE;
        "pkg-26.1.x-2.15.18-neoforge" = _uB68a2YZ;
        "pkg-26.1.x-2.15.19-fabric" = _36ucqo2s;
        "pkg-26.1.x-2.15.19-neoforge" = _KMRyvyxY;
        "pkg-1.20.1-2.15.20-fabric" = _BXRYMAKE;
        "pkg-1.21.1-2.15.20-fabric" = _BnoWDnaf;
        "pkg-26.1.x-2.15.20-fabric" = _PHE4QN8a;
        "pkg-1.20.1-2.15.20-forge" = _Db8nyMgr;
        "pkg-1.21.1-2.15.20-neoforge" = _adUIMyEP;
        "pkg-26.1.x-2.15.20-neoforge" = _lcoidTRL;
        "pkg-1.20.1-2.15.21-fabric" = _FHtY2DfS;
        "pkg-1.21.1-2.15.21-fabric" = _ytn5r3rc;
        "pkg-26.1.x-2.15.21-fabric" = _OInLZHal;
        "pkg-1.20.1-2.15.21-forge" = _bbVWwJwp;
        "pkg-1.21.1-2.15.21-neoforge" = _DXjkw66L;
        "pkg-26.1.x-2.15.21-neoforge" = _EpHQxxY1;
        "pkg-1.21.1-2.16.0-fabric" = _iT8zzmQ6;
        "pkg-26.1.x-2.16.0-fabric" = _j5pEguQk;
        "pkg-1.21.1-2.16.0-neoforge" = _N2ZDCaiN;
        "pkg-26.1.x-2.16.0-neoforge" = _FD6GArS5;
        "pkg-1.20.1-2.15.22-fabric" = _KODH6DmQ;
        "pkg-1.20.1-2.15.22-forge" = _S09bQ0v6;
        "pkg-1.21.1-2.16.1-fabric" = _ZH2JUnKa;
        "pkg-26.1.x-2.16.1-fabric" = _u26JOQXC;
        "pkg-1.21.1-2.16.1-neoforge" = _WPLp20Au;
        "pkg-26.1.x-2.16.1-neoforge" = _zUdDgIEX;
        "pkg-26.1.x-2.16.2-neoforge" = _y6ae4lnX;
        "pkg-1.21.1-2.16.3-fabric" = _DZgjJjCk;
        "pkg-26.1.x-2.16.3-fabric" = _ylsITDxu;
        "pkg-1.21.1-2.16.3-neoforge" = _bCimj3pk;
        "pkg-26.1.x-2.16.3-neoforge" = _CQ7PeCOe;
        "pkg-1.21.1-2.17.0-fabric" = _MqK6PR45;
        "pkg-26.1.x-2.17.0-fabric" = _BILf9s7h;
        "pkg-1.21.1-2.17.0-neoforge" = _v6mHfKeM;
        "pkg-26.1.x-2.17.0-neoforge" = _rAq7iWhZ;
        "pkg-1.21.1-2.17.1-fabric" = _zaaV0YKD;
        "pkg-26.1.x-2.17.1-fabric" = _3zyu76h9;
        "pkg-1.21.1-2.17.1-neoforge" = _idnHF2WF;
        "pkg-26.1.x-2.17.1-neoforge" = _b9N5RkMM;
        "pkg-1.21.1-2.17.2-fabric" = _Cr2kzYkj;
        "pkg-26.1.x-2.17.2-fabric" = _eUDymnqV;
        "pkg-1.21.1-2.17.2-neoforge" = _VeX5m4Ct;
        "pkg-26.1.x-2.17.2-neoforge" = _hepNTQa4;
        "pkg-2.17.3+1.21.1-fabric" = _pTLmKhPk;
        "pkg-2.17.3+26.1.x-fabric" = _sn5VmroL;
        "pkg-2.17.3+1.21.1-neoforge" = _VbJfc3vw;
        "pkg-2.17.3+26.1.x-neoforge" = _i9JXkmVT;
        "pkg-2.17.4+1.21.1-fabric" = _5Xlo0ASb;
        "pkg-2.17.4+26.1.x-fabric" = _CPo4xpzV;
        "pkg-2.17.4+1.21.1-neoforge" = _WCGX0gHm;
        "pkg-2.17.4+26.1.x-neoforge" = _hcurISSh;
        "pkg-2.18.0+1.21.1-fabric" = _3WeosN6M;
        "pkg-2.18.0+26.1.x-fabric" = _Cx9NjlCw;
        "pkg-2.18.0+1.21.1-neoforge" = _Ayv6M855;
        "pkg-2.18.0+26.1.x-neoforge" = _FP3zzjyA;
        "pkg-2.18.1+1.21.1-fabric" = _qqasr0oo;
        "pkg-2.18.1+26.1.x-fabric" = _kIqBCLIa;
        "pkg-2.18.1+1.21.1-neoforge" = _xqXOF05B;
        "pkg-2.18.1+26.1.x-neoforge" = _TgWFRjJj;
        "pkg-2.18.2+1.21.1-fabric" = _QXrDxz3m;
        "pkg-2.18.2+26.1.x-fabric" = _zgO7yPOn;
        "pkg-2.18.2+1.21.1-neoforge" = _NXt7abyA;
        "pkg-2.18.2+26.1.x-neoforge" = _6tcqWFUN;
        "pkg-2.18.3+1.21.1-fabric" = _poPvosM6;
        "pkg-2.18.3+26.1.x-fabric" = _lH9d2bbr;
        "pkg-2.18.3+1.21.1-neoforge" = _2QW2ZGDq;
        "pkg-2.18.3+26.1.x-neoforge" = _nd0V2kdR;
        "pkg-3.0.0-beta.1+1.21.1-fabric" = _KWqjcKsE;
        "pkg-3.0.0-beta.1+26.1.x-fabric" = _3YakRExq;
        "pkg-3.0.0-beta.1+1.21.1-neoforge" = _46Gb3dWQ;
        "pkg-3.0.0-beta.1+26.1.x-neoforge" = _Miz572mb;
        "pkg-3.0.0-beta.2+1.21.1-fabric" = _EBQZFGIf;
        "pkg-3.0.0-beta.2+26.1.x-fabric" = _BkMA1l0b;
        "pkg-3.0.0-beta.2+1.21.1-neoforge" = _RPYOMM9p;
        "pkg-3.0.0-beta.2+26.1.x-neoforge" = _4kaiVLD9;
        "pkg-3.0.0-beta.3+1.21.1-fabric" = _5UqMjPk2;
        "pkg-3.0.0-beta.3+26.1.x-fabric" = _SjyXkSuU;
        "pkg-3.0.0-beta.3+1.21.1-neoforge" = _d9MmPZQE;
        "pkg-3.0.0-beta.3+26.1.x-neoforge" = _vLnJxku9;
        "pkg-3.0.0-beta.4+26.1.x-fabric" = _FvhQgyBW;
        "pkg-3.0.0-beta.4+26.1.x-neoforge" = _oADIxNCg;
        "pkg-3.0.0-beta.4+26.2.x-fabric" = _fINZEkqx;
        "pkg-3.0.0-beta.4+26.2.x-neoforge" = _esUhwDt2;
        "pkg-3.0.0-beta.5+1.21.1-fabric" = _NLOQnQZi;
        "pkg-3.0.0-beta.5+26.1.x-fabric" = _vdDEb64N;
        "pkg-3.0.0-beta.5+26.2.x-fabric" = _mdefv58y;
        "pkg-3.0.0-beta.5+1.21.1-neoforge" = _6PF52xI9;
        "pkg-3.0.0-beta.5+26.1.x-neoforge" = _PANzJnu5;
        "pkg-3.0.0-beta.5+26.2.x-neoforge" = _cA5K2EjG;
        "pkg-3.0.0-beta.6+1.21.1-fabric" = _CxU9qIpe;
        "pkg-3.0.0-beta.6+26.1.x-fabric" = _DMfLAehR;
        "pkg-3.0.0-beta.6+26.2.x-fabric" = _SZKdg2B8;
        "pkg-3.0.0-beta.6+1.21.1-neoforge" = _dFYmUhDo;
        "pkg-3.0.0-beta.6+26.1.x-neoforge" = _kvUHgeO8;
        "pkg-3.0.0-beta.6+26.2.x-neoforge" = _zV0eN6KP;
        "pkg-3.0.0-beta.7+1.21.1-fabric" = _d9Tkmspv;
        "pkg-3.0.0-beta.7+26.1.x-fabric" = _6FsHXl3S;
        "pkg-3.0.0-beta.7+26.2.x-fabric" = _YqICbrlz;
        "pkg-3.0.0-beta.7+1.21.1-neoforge" = _DX1C3yJg;
        "pkg-3.0.0-beta.7+26.1.x-neoforge" = _dYEmZEik;
        "pkg-3.0.0-beta.7+26.2.x-neoforge" = _ZV4TaVO2;
        "pkg-3.0.0-beta.8+1.21.1-fabric" = _gGKZjRM9;
        "pkg-3.0.0-beta.8+26.1.x-fabric" = _NVqCIg5Z;
        "pkg-3.0.0-beta.8+26.2.x-fabric" = _uZPZUYms;
        "pkg-3.0.0-beta.8+1.21.1-neoforge" = _jlJw1LRb;
        "pkg-3.0.0-beta.8+26.1.x-neoforge" = _Wg2HcksN;
        "pkg-3.0.0-beta.8+26.2.x-neoforge" = _mvIcHydt;
        "pkg-3.0.0-beta.9+1.21.1-fabric" = _LGKOyxqe;
        "pkg-3.0.0-beta.9+26.1.x-fabric" = _DQJPJKfp;
        "pkg-3.0.0-beta.9+26.2.x-fabric" = _6pTOtAx4;
        "pkg-3.0.0-beta.9+1.21.1-neoforge" = _AjSrsm05;
        "pkg-3.0.0-beta.9+26.1.x-neoforge" = _hmFo7AZL;
        "pkg-3.0.0-beta.9+26.2.x-neoforge" = _fGWOUOuw;
        "pkg-3.0.0-rc.1+1.21.1-fabric" = _XFXD3lak;
        "pkg-3.0.0-rc.1+26.1.x-fabric" = _fwS5csNP;
        "pkg-3.0.0-rc.1+26.2.x-fabric" = _LAA1ohq3;
        "pkg-3.0.0-rc.1+1.21.1-neoforge" = _mGrv3vOC;
        "pkg-3.0.0-rc.1+26.1.x-neoforge" = _Cvw8T2jw;
        "pkg-3.0.0-rc.1+26.2.x-neoforge" = _n5yscjot;
        "pkg-3.0.0+1.21.1-fabric" = _3dW66NPZ;
        "pkg-3.0.0+26.1.x-fabric" = _GPLG3Lpx;
        "pkg-3.0.0+26.2.x-fabric" = _wwQ1xdyL;
