...
let
    ...
    in {
        ...
        "pkg-1.16.5-2.1-forge" = _PnxMbhJo;
        "pkg-1.18.2-2.2-forge" = _zEAPJ8ZU;
        "pkg-1.19.2-2.4-forge" = _FvicBsmA;
        "pkg-1.16.5-2.7-fabric" = _h7Welk37;
        "pkg-1.18.2-2.7-fabric" = _VYHFAx9v;
        "pkg-1.19.2-2.7-fabric" = _5WBCFLC7;
        "pkg-1.16.5-2.7-forge" = _qhHNj0cB;
        "pkg-1.18.2-2.7-forge" = _aHruMIDe;
        "pkg-1.19.2-2.7-forge" = _6xSEHqqh;
        "pkg-1.16.5-2.8-fabric" = _heWAj8JG;
        "pkg-1.18.2-2.8-fabric" = _2k4BXXON;
        "pkg-1.19.2-2.8-fabric" = _hJ5iB89D;
        "pkg-1.19.3-2.9-fabric" = _SBi5sZ33;
        "pkg-1.19.3-2.7-forge" = _Z9fhohG4;
        "pkg-1.18.2-3.0-forge+fabric" = _MND7jNzU;
        "pkg-1.19.2-3.0-forge+fabric" = _DnEsZOqG;
        "pkg-1.19.3-3.0-forge+fabric" = _D45w2pux;
        "pkg-1.18.2-3.1-forge+fabric" = _Md6BSvcR;
        "pkg-1.19.2-3.1-forge+fabric" = _6AIbEqSM;
        "pkg-1.19.3-3.1-forge+fabric" = _KUufoQQ1;
        "pkg-1.18.2-3.2-forge+fabric" = _WlfKmRUM;
        "pkg-1.19.2-3.2-forge+fabric" = _qaoo98MY;
        "pkg-1.19.3-3.2-forge+fabric" = _ZwenlV2r;
        "pkg-1.19.4-3.2-forge+fabric" = _IrJHyQ0O;
        "pkg-1.20-3.2-forge+fabric" = _gOiDPyEL;
        "pkg-1.20.1-3.2-forge+fabric" = _L8yNkb0L;
        "pkg-1.20.2-3.2-forge+fabric" = _XyaEXbKa;
        "pkg-1.18.2-3.3-forge+fabric" = _Lzbn96L0;
        "pkg-1.19.2-3.3-forge+fabric" = _G68Uq4kN;
        "pkg-1.20.1-3.3-forge+fabric" = _15Y5hsw8;
        "pkg-1.20.2-3.3-forge+fabric" = _rDYixqua;
        "pkg-1.20.2-3.4-fabric+forge+neo" = _xUu2hUCa;
        "pkg-1.20.3-3.4-fabric+forge+neo" = _YEZVIEGK;
        "pkg-1.20.4-3.4-fabric+forge+neo" = _46MikR2e;
        "pkg-1.19.2-3.5-fabric+forge+neo" = _fFPVRVpy;
        "pkg-1.20.1-3.5-fabric+forge+neo" = _wyh93P6I;
        "pkg-1.20.2-3.5-fabric+forge+neo" = _W9EUideT;
        "pkg-1.20.4-3.5-fabric+forge+neo" = _303DlW7U;
        "pkg-1.20.5-3.5-fabric+neo" = _9Wu98Lnt;
        "pkg-1.20.6-3.5-fabric+forge+neo" = _WQNkmnBj;
        "pkg-1.21.0-3.5-fabric+forge+neo" = _mtCeboBu;
        "pkg-1.20.1-3.6-fabric+forge+neo" = _qtgGJN2o;
        "pkg-1.20.6-3.6-fabric+forge+neo" = _L4e3H823;
        "pkg-1.21.0-3.6-fabric+forge+neo" = _vTIEBz6a;
        "pkg-1.21.1-3.6-fabric+forge+neo" = _fsm5aKli;
        "pkg-1.21.2-3.6-fabric+neo" = _OZPPRjbx;
        "pkg-1.21.3-3.6-fabric+forge+neo" = _1KlerM6d;
        "pkg-1.21.4-3.6-fabric+forge+neo" = _paiwDQOV;
        "pkg-1.20.1-3.7-fabric+forge+neo" = _l2qsxL9o;
        "pkg-1.21.1-3.7-fabric+forge+neo" = _jfkEQwIF;
        "pkg-1.21.4-3.7-fabric+forge+neo" = _xte8FvKW;
        "pkg-1.20.1-4.0-fabric+forge+neo" = _gqSMiMvS;
        "pkg-1.21.1-4.0-fabric+forge+neo" = _66x4ulpK;
        "pkg-1.21.4-4.0-fabric+forge+neo" = _51sXfO7h;
        "pkg-1.20.1-4.1-fabric+forge+neo" = _lFIhypmk;
        "pkg-1.21.1-4.1-fabric+forge+neo" = _7Lw3IXim;
        "pkg-1.21.4-4.1-fabric+forge+neo" = _xFDEzDIf;
        "pkg-1.21.5-4.1-fabric+forge+neo" = _o5iVU0wZ;
        "pkg-1.21.6-4.1-fabric+forge+neo" = _JVU4Gblz;
        "pkg-1.21.7-4.1-fabric+forge+neo" = _XNKtyNEZ;
        "pkg-1.21.8-4.1-fabric+forge+neo" = _grCE2GKf;
        "pkg-1.21.9-4.1-fabric+forge+neo" = _O2tLTBep;
        "pkg-1.21.10-4.1-fabric+forge+neo" = _BS3zliJi;
        "pkg-1.21.11-4.1-fabric+forge+neo" = _8xOdwea4;
        "pkg-26.1.0-4.1-fabric+forge+neo" = _baOPWqDc;
        "pkg-26.1.1-4.1-fabric+forge+neo" = _8uvPeArM;
        "pkg-26.1.2-4.1-fabric+forge+neo" = _yRbqF2RF;
        "pkg-1.20.1-4.2-fabric+forge+neo" = _tmI15AGR;
        "pkg-1.21.1-4.2-fabric+forge+neo" = _wXLzF7Cp;
