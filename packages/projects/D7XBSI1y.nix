...
let
    versions = (let
        ...
        _AnYq3r1h = {
            "id" = "AnYq3r1h";
            "file" = "fastasyncvoxelsniper-3.2.5.jar";
            "hash" = "sha512-uIOYtgtJE1E1/f9TqI6U2atNp/vIz2tL6FmN9I0DtxpnHZI+k02/OD6N/zpCHEdH+k8UJa6ziNvWZZUz/ze0Uw==";
        };
    in {
        "HnTY2kmL" = _HnTY2kmL;
        "WA8UOvCj" = _WA8UOvCj;
        ...
        "paper-1.21.4" = _AnYq3r1h;
        "paper-1.21.6" = _AnYq3r1h;
        "paper-1.21.7" = _AnYq3r1h;
        "paper-1.21.8" = _AnYq3r1h;
        "paper-1.21.1" = _AnYq3r1h;
        "paper-1.21.5" = _AnYq3r1h;
        "paper-1.21.9" = _AnYq3r1h;
        "paper-1.21.10" = _AnYq3r1h;
        "paper-1.21.11" = _AnYq3r1h;
        "paper-26.1" = _AnYq3r1h;
        "paper-26.1.1" = _AnYq3r1h;
        "paper-26.1.2" = _AnYq3r1h;
        "paper-26.2" = _AnYq3r1h;
        ...
        "spigot-1.21.4" = _AnYq3r1h;
        "spigot-1.21.6" = _AnYq3r1h;
        "spigot-1.21.7" = _AnYq3r1h;
        "spigot-1.21.8" = _AnYq3r1h;
        "spigot-1.21.1" = _AnYq3r1h;
        "spigot-1.21.5" = _AnYq3r1h;
        "spigot-1.21.9" = _AnYq3r1h;
        "spigot-1.21.10" = _AnYq3r1h;
        "spigot-1.21.11" = _AnYq3r1h;
        "spigot-26.1" = _AnYq3r1h;
        "spigot-26.1.1" = _AnYq3r1h;
        "spigot-26.1.2" = _AnYq3r1h;
        "spigot-26.2" = _AnYq3r1h;
        ...
        "purpur-1.21.4" = _AnYq3r1h;
        "purpur-1.21.6" = _AnYq3r1h;
        "purpur-1.21.7" = _AnYq3r1h;
        "purpur-1.21.8" = _AnYq3r1h;
        "purpur-1.21.1" = _AnYq3r1h;
        "purpur-1.21.5" = _AnYq3r1h;
        "purpur-1.21.9" = _AnYq3r1h;
        "purpur-1.21.10" = _AnYq3r1h;
        "purpur-1.21.11" = _AnYq3r1h;
        "purpur-26.1" = _AnYq3r1h;
        "purpur-26.1.1" = _AnYq3r1h;
        "purpur-26.1.2" = _AnYq3r1h;
        "purpur-26.2" = _AnYq3r1h;
        "pkg-2.7.0" = _HnTY2kmL;
        "pkg-2.8.0" = _WA8UOvCj;
        "pkg-2.9.0" = _3TevL0tJ;
        "pkg-2.9.1" = _CokU2HXW;
        ...
        "pkg-2.9.3" = _Ubs3bVVy;
        "pkg-2.9.4" = _wFvk9g03;
        "pkg-3.0.0-SNAPSHOT" = _a6xWXrLN;
        "pkg-3.0.0-SNAPSHOT-2" = _bGidcXNZ;
        "pkg-3.0.0-SNAPSHOT-3" = _OUvOJOmD;
        "pkg-3.0.0" = _zE57Vdvj;
        "pkg-3.1.1-SNAPSHOT" = _tkHVEYZf;
        "pkg-3.1.1" = _7xXHGmjF;
        "pkg-3.2.0" = _24fX0YW7;
        "pkg-3.2.1" = _4o0aAyX2;
        "pkg-3.2.2" = _gCbbBJSM;
