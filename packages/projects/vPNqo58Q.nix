...
let
    ...
    in {
        ...
        "pkg-8.1.0+forge-1.19" = _IjPL1T1N;
        "pkg-9.0.0+fabric-1.19.3" = _Mz7eeTEe;
        "pkg-9.0.0+forge-1.19.3" = _gN1XVFx6;
        "pkg-7.1.0+forge-1.18.2" = _rlQ7mQes;
        "pkg-7.1.0+fabric-1.18.2" = _Fhy3pE8g;
        "pkg-10.0.1+forge-1.19.4" = _fxUm9n5z;
        "pkg-8.1.1+forge-1.19.2" = _C46Y48g4;
        "pkg-10.0.1+fabric-1.19.4" = _EmDsfaiv;
        "pkg-8.1.1+fabric-1.19.2" = _almeE46g;
        "pkg-10.0.2+fabric-1.19.4" = _FKfK6YfH;
        "pkg-8.1.2+forge-1.19.2" = _onfW0a04;
        "pkg-10.0.2+forge-1.19.4" = _ofJ9s6y0;
        "pkg-8.1.2+fabric-1.19.2" = _iM86WEvk;
        "pkg-11.0.0+fabric-1.20" = _L3su862e;
        "pkg-11.0.0+forge-1.20" = _kiZkKw4d;
        "pkg-11.1.0+fabric-1.20" = _3zMCvvSv;
        "pkg-11.1.0+forge-1.20" = _7Zzx91AW;
        "pkg-8.3.0+forge-1.19.2" = _gUwtFfmz;
        "pkg-8.3.0+fabric-1.19.2" = _x2nEWOgf;
        "pkg-12.0.0+fabric-1.20.2" = _OranQBcj;
        "pkg-12.0.0+forge-1.20.2" = _uSdTs5qr;
        "pkg-12.1.0+fabric-1.20.2" = _eSkate4P;
        "pkg-12.1.0+forge-1.20.2" = _Usk9UOE5;
        "pkg-12.1.0+neoforge-1.20.2" = _C8zlAwG9;
        "pkg-13.0.1+fabric-1.20.4" = _L8ES7as6;
        "pkg-13.0.1+forge-1.20.4" = _rfluucsd;
        "pkg-13.0.1+neoforge-1.20.4" = _IMQ65mCI;
        "pkg-13.0.2+fabric-1.20.4" = _ecFWvFOq;
        "pkg-13.0.2+forge-1.20.4" = _ilefH4JG;
        "pkg-13.0.2+neoforge-1.20.4" = _HgyiFYdI;
        "pkg-14.0.1+fabric-1.20.6" = _VQ8xWPow;
        "pkg-14.0.1+forge-1.20.6" = _K6WdMtjD;
        "pkg-14.0.1+neoforge-1.20.6" = _WoXRnOV4;
        "pkg-21.0.1+fabric-1.21" = _SgwQ7nne;
        "pkg-21.0.1+forge-1.21" = _5moXy0E4;
        "pkg-21.0.1+neoforge-1.21" = _DzgtJwj4;
        "pkg-21.0.2+fabric-1.21" = _PhCCotf7;
        "pkg-21.0.2+forge-1.21" = _UxV0SLQE;
        "pkg-21.0.2+neoforge-1.21" = _EjrgdKdi;
        "pkg-21.1.1+fabric-1.21.1" = _8r99AEqJ;
        "pkg-21.1.1+forge-1.21.1" = _svjeiaC7;
        "pkg-21.1.1+neoforge-1.21.1" = _knx56t47;
        "pkg-21.3.1+neoforge-1.21.3" = _d5iQL3W6;
        "pkg-21.3.1+fabric-1.21.3" = _vw741TQi;
        "pkg-21.4.1+fabric-1.21.4" = _Oyl18rhf;
        "pkg-21.4.1+neoforge-1.21.4" = _D8MvaQ65;
        "pkg-21.4.2+forge-1.21.4" = _TdKzbEf1;
        "pkg-11.1.1+fabric-1.20.1" = _boRneGlV;
        "pkg-21.4.3+fabric-1.21.4" = _jFIC4snu;
        "pkg-11.1.1+forge-1.20.1" = _jE5Qfyt4;
        "pkg-21.4.3+neoforge-1.21.4" = _tvKKWJTX;
        "pkg-21.4.3+forge-1.21.4" = _1XLbVDyf;
        "pkg-21.1.2+fabric-1.21.1" = _AdcnT2oZ;
        "pkg-21.1.2+neoforge-1.21.1" = _pNVLmLD4;
        "pkg-21.1.2+forge-1.21.1" = _VCujsHIz;
        "pkg-11.1.2+fabric-1.20.1" = _MVGckVSp;
        "pkg-21.1.3+fabric-1.21.1" = _mv3SAvJD;
        "pkg-11.1.2+forge-1.20.1" = _NbP9bSEH;
        "pkg-21.1.3+forge-1.21.1" = _x3TvonYW;
        "pkg-21.1.3+neoforge-1.21.1" = _h5aSmcaC;
        "pkg-21.4.4+fabric-1.21.4" = _rvqGEJUA;
        "pkg-21.4.4+neoforge-1.21.4" = _ygqARZtL;
        "pkg-21.4.4+forge-1.21.4" = _PLs5pQfx;
        "pkg-21.4.5+fabric-1.21.4" = _4FYmuxT9;
        "pkg-21.1.4+fabric-1.21.1" = _q3hVU6QE;
        "pkg-11.1.3+fabric-1.20.1" = _qOrKqP96;
        "pkg-21.4.5+neoforge-1.21.4" = _EdNtCZNL;
        "pkg-21.4.5+forge-1.21.4" = _QojI6dxf;
        "pkg-11.1.3+forge-1.20.1" = _pUepqrFU;
        "pkg-21.1.4+forge-1.21.1" = _H7WIbDCm;
        "pkg-21.1.4+neoforge-1.21.1" = _zrdJxCEJ;
        "pkg-21.5.1+fabric-1.21.5" = _Za3rjzhp;
        "pkg-21.5.1+neoforge-1.21.5" = _5lRfPoFB;
        "pkg-21.5.2+forge-1.21.5" = _1FrRk6YS;
        "pkg-21.1.5+forge-1.21.1" = _XPBK23pm;
        "pkg-21.1.5+neoforge-1.21.1" = _uvCLtDK9;
        "pkg-21.4.6+forge-1.21.4" = _19iP6nFr;
        "pkg-21.4.6+neoforge-1.21.4" = _CWfCsWY2;
        "pkg-21.5.3+forge-1.21.5" = _wZK9qkaQ;
        "pkg-21.5.3+neoforge-1.21.5" = _9vOMV9ha;
        "pkg-21.5.4+fabric-1.21.5" = _bhncMZoh;
        "pkg-21.1.6+fabric-1.21.1" = _MCC5GPPY;
        "pkg-21.1.6+forge-1.21.1" = _NmfskkaK;
        "pkg-21.5.4+forge-1.21.5" = _u1igqqCl;
        "pkg-21.1.6+neoforge-1.21.1" = _o6VvH5H9;
        "pkg-21.4.7+fabric-1.21.4" = _Hi7h0Cnc;
        "pkg-21.5.4+neoforge-1.21.5" = _ppvQN9vp;
        "pkg-21.4.7+forge-1.21.4" = _PE4jnXlm;
        "pkg-21.4.7+neoforge-1.21.4" = _eg4pZjFr;
        "pkg-21.5.5+fabric-1.21.5" = _yig73CWJ;
        "pkg-21.5.5+forge-1.21.5" = _ce9PrCUE;
        "pkg-21.5.5+neoforge-1.21.5" = _HhGiCCfa;
        "pkg-21.5.6+fabric-1.21.5" = _6EKLv0Ha;
        "pkg-21.1.7+fabric-1.21.1" = _faHxRMBc;
        "pkg-21.5.6+forge-1.21.5" = _htsuwv3v;
        "pkg-21.1.7+forge-1.21.1" = _z3Rcei0O;
        "pkg-21.1.7+neoforge-1.21.1" = _Uy9n1p6N;
        "pkg-21.5.6+neoforge-1.21.5" = _qVONZeVC;
        "pkg-21.4.8+fabric-1.21.4" = _1o9Dll0L;
        "pkg-21.4.8+neoforge-1.21.4" = _Bryi5ctO;
        "pkg-21.4.8+forge-1.21.4" = _69UNVqkJ;
        "pkg-21.6.1+fabric-1.21.6" = _fUAep8ho;
        "pkg-21.6.1+neoforge-1.21.6" = _UOqU0vI8;
        "pkg-21.6.2+forge-1.21.6" = _UAbK87Dq;
        "pkg-21.7.1+fabric-1.21.7" = _Tsi8OADh;
        "pkg-21.7.1+neoforge-1.21.7" = _P7y4gaLm;
        "pkg-21.7.1+forge-1.21.7" = _pwszT6mI;
        "pkg-11.1.4+fabric-1.20.1" = _Se7o4Hv8;
        "pkg-11.1.4+forge-1.20.1" = _CgYDErri;
        "pkg-21.1.8+neoforge-1.21.1" = _OITwdEsS;
        "pkg-21.1.8+forge-1.21.1" = _9igGktzF;
        "pkg-21.7.2+forge-1.21.7" = _malnCJUQ;
        "pkg-21.1.8+fabric-1.21.1" = _MuESE2cd;
        "pkg-21.7.2+fabric-1.21.7" = _kagzbQak;
        "pkg-21.7.2+neoforge-1.21.7" = _2gqE38Bd;
        "pkg-21.8.1+fabric-1.21.8" = _y9slgYRl;
        "pkg-21.8.1+forge-1.21.8" = _HUcSCHDr;
        "pkg-21.8.1+neoforge-1.21.8" = _FxnhRfFA;
        "pkg-21.8.2+fabric-1.21.8" = _fTCW1uvU;
        "pkg-21.8.2+forge-1.21.8" = _3SxBL9he;
        "pkg-21.8.2+neoforge-1.21.8" = _zEidyyxL;
        "pkg-3.1.11+forge-1.21.2" = _DZ52fdjc;
        "pkg-11.1.5+fabric-1.20.1" = _XydHmhny;
        "pkg-11.1.5+forge-1.20.1" = _H8SeAE8l;
        "pkg-21.8.3+fabric-1.21.8" = _dnaamFUh;
        "pkg-21.1.9+fabric-1.21.1" = _eWSlVWm2;
        "pkg-21.8.3+neoforge-1.21.8" = _8V9InIhR;
        "pkg-21.8.3+forge-1.21.8" = _eroA7gyo;
        "pkg-21.1.9+neoforge-1.21.1" = _htfCkPAc;
        "pkg-21.1.9+forge-1.21.1" = _5SdjTQMz;
        "pkg-21.9.1+neoforge-1.21.9" = _y6gOj559;
        "pkg-21.9.1+fabric-1.21.9" = _iueYXf8A;
        "pkg-21.10.1+fabric-1.21.10" = _E4BWrSCx;
        "pkg-21.10.1+neoforge-1.21.10" = _HvOpF3uZ;
        "pkg-21.10.1+forge-1.21.10" = _jY1jg2zm;
        "pkg-21.10.2+fabric-1.21.10" = _Bo1IWgQA;
        "pkg-21.10.2+neoforge-1.21.10" = _qDbGF5aF;
        "pkg-21.10.2+forge-1.21.10" = _S1pWKroZ;
        "pkg-21.11.1+fabric-1.21.11" = _FpOzGJaZ;
        "pkg-21.11.1+neoforge-1.21.11" = _3dbKOE4b;
        "pkg-11.1.6+fabric-1.20.1" = _tY4EglHo;
        "pkg-11.1.6+forge-1.20.1" = _Febi39qw;
        "pkg-21.1.10+fabric-1.21.1" = _wfdpwYlS;
        "pkg-21.1.10+forge-1.21.1" = _cK0k1OHq;
        "pkg-21.1.10+neoforge-1.21.1" = _jSYA1mqy;
        "pkg-21.11.3+fabric-1.21.11" = _Rklv587P;
        "pkg-21.11.3+forge-1.21.11" = _NlGSk4tE;
        "pkg-21.11.3+neoforge-1.21.11" = _ga9EFBtN;
        "pkg-21.11.4+fabric-1.21.11" = _sX0eqY9M;
        "pkg-21.11.4+forge-1.21.11" = _9Pa4ojuS;
        "pkg-21.11.4+neoforge-1.21.11" = _a5ZDePhN;
        "pkg-21.11.5+fabric-1.21.11" = _K63NnMwc;
        "pkg-21.11.5+forge-1.21.11" = _B6r69lm7;
        "pkg-21.11.5+neoforge-1.21.11" = _Cf3yYbS5;
        "pkg-21.11.6+fabric-1.21.11" = _sOJMpaLr;
        "pkg-21.11.6+neoforge-1.21.11" = _F1iBoao8;
        "pkg-21.11.6+forge-1.21.11" = _aGCAyAgg;
        "pkg-26.1.0.1+fabric-26.1" = _hpzT3J4h;
        "pkg-26.1.0.1+neoforge-26.1" = _joAaRE54;
        "pkg-26.1.2.1+fabric-26.1.2" = _FuBW2WH8;
        "pkg-26.1.2.1+neoforge-26.1.2" = _S00oi0sV;
        "pkg-21.1.11+fabric-1.21.1" = _kHmBEYA0;
        "pkg-21.1.11+neoforge-1.21.1" = _zMZWFyiK;
        "pkg-21.1.11+forge-1.21.1" = _9oVExKjN;
        "pkg-26.1.2.2+fabric-26.1.2" = _ALQokjRW;
        "pkg-26.1.2.2+neoforge-26.1.2" = _pa258BEX;
        "pkg-26.1.2.3+fabric-26.1.2" = _O6UQYThc;
        "pkg-26.1.2.3+neoforge-26.1.2" = _4kF1sx1R;
        "pkg-26.2.0.1+fabric-26.2" = _lkn0YTWS;
        "pkg-26.2.0.1+neoforge-26.2" = _4He4fK4n;
        "pkg-26.2.0.2+neoforge-26.2" = _gqehT6VM;
        "pkg-26.2.0.2+fabric-26.2" = _JYgv0vLL;
        "pkg-26.1.2.4+fabric-26.1.2" = _AxHTO2Wq;
        "pkg-26.1.2.4+neoforge-26.1.2" = _QpOJxylZ;
        "pkg-11.1.7+fabric-1.20.1" = _9EKLNI1n;
        "pkg-11.1.7+forge-1.20.1" = _oqcmMMJu;
        "pkg-21.1.12+fabric-1.21.1" = _kCCLFkvj;
        "pkg-21.1.12+neoforge-1.21.1" = _OEb1XE4e;
        "pkg-21.1.12+forge-1.21.1" = _5bRpMrh9;
        "pkg-11.1.8+fabric-1.20.1" = _JKIx0cPl;
        "pkg-11.1.8+forge-1.20.1" = _Nsl6irvM;
        "pkg-21.1.13+fabric-1.21.1" = _uWUcaujO;
        "pkg-21.1.13+neoforge-1.21.1" = _F4OqcWhP;
        "pkg-21.1.13+forge-1.21.1" = _fHgrkDHT;
        "pkg-26.2.0.3+fabric-26.2" = _5iD7OXLD;
        "pkg-26.1.2.5+fabric-26.1.2" = _o3FLuOo9;
        "pkg-26.2.0.3+neoforge-26.2" = _PkZ5jEJH;
        "pkg-26.1.2.5+neoforge-26.1.2" = _bsHEckAE;
        "pkg-26.2.0.4+fabric-26.2" = _HGqK5vuh;
        "pkg-26.2.0.4+neoforge-26.2" = _DRwl95No;
        "pkg-26.1.2.6+fabric-26.1.2" = _Z3LoAFke;
        "pkg-26.1.2.6+neoforge-26.1.2" = _jFpkTLn6;
        "pkg-11.1.9+fabric-1.20.1" = _HJmGMsOm;
        "pkg-26.1.2.7+fabric-26.1.2" = _JiqVUYMu;
        "pkg-26.2.0.5+fabric-26.2" = _4Z22UbgA;
        "pkg-26.2.0.5+neoforge-26.2" = _1yzIJNyw;
        "pkg-26.1.2.7+neoforge-26.1.2" = _1Dxipl6y;
        "pkg-21.1.14+neoforge-1.21.1" = _CD0C4ftK;
