...
let
    ...
    in {
        ...
        "pkg-R1.21.3_V01.01.04" = _9SxVW8uF;
        "pkg-R1.21.4_V01.01.03" = _1sUjPAJq;
        "pkg-R1.21.5_V01.01.02" = _6a5wygcy;
        "pkg-R1.21.6_V01.01.01" = _fMxjmP99;
        "pkg-R1.21.7_V01.01.01" = _VXsrzWmX;
        "pkg-R1.21.8_V01.01.01" = _vJ6leCWl;
        "pkg-R1.21.9_V01.01.01" = _59jut2TJ;
        "pkg-R1.21.10_V01.01.01" = _mEP6yD5n;
        "pkg-R1.21.11_V01.01.01" = _ZO3x4hrU;
        "pkg-R26.1_V01.00" = _keFs11X6;
        "pkg-R1.21_V01.02" = _SX0liWwj;
        "pkg-R1.21.1_V01.04" = _PoClDZ7Y;
        "pkg-R1.21.2_V01.02" = _4F1ARwo7;
        "pkg-R1.21.3_V01.02" = _3VF9jn4W;
        "pkg-R1.21.4_V01.02" = _5LgB77qd;
        "pkg-R1.21.5_V01.02" = _zYPQTi8i;
        "pkg-R1.21.6_V01.02" = _Lvv8bVdD;
        "pkg-R1.21.7_V01.02" = _l0aEC3lP;
        "pkg-R1.21.8_V01.02" = _gmvJ5Dm4;
        "pkg-R1.21.9_V01.02" = _pg9kMoHk;
