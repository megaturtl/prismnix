...
let
    versions = (let
        ...
        _e9YeIqNN = {
            "id" = "e9YeIqNN";
            "file" = "client_maps-1.3.4.jar";
            "hash" = "sha512-hkSPe1SSGUMqIa5tUrcWQkv29GZlYnN1aCQ9oR2GTkcAeiE4fQviHldVCpkp4v2x0UtMGepQxJRfJ5X1M1rWEg==";
        };
    in {
        "v10uUl0d" = _v10uUl0d;
        "ynr3Ce0x" = _ynr3Ce0x;
        ...
        "fabric-26.3" = _e9YeIqNN;
        "pkg-1.0.0" = _v10uUl0d;
        "pkg-1.0.0+1.20.6" = _ynr3Ce0x;
        "pkg-1.0.2+1.20.6" = _jMQjlGpi;
        "pkg-1.0.1" = _L50bzfUG;
        "pkg-1.0.3+1.20.4" = _fFrL0Mkb;
        "pkg-1.0.3+1.20.6" = _sl57yPdK;
        "pkg-1.0.3+1.20.1" = _8HOvJwsl;
        "pkg-1.0.3+1.21" = _XJxJZhid;
        "pkg-1.0.4+1.21" = _2kYtBkIp;
        "pkg-1.0.5" = _oLGPUIhL;
        "pkg-1.0.5+1.20.1" = _DoXvzqRE;
        "pkg-1.1.0" = _ksyqwMoj;
        "pkg-1.1.0+1.21.3" = _YcKZrqTD;
        "pkg-1.1.0+1.21.4" = _z3AhkCOS;
        "pkg-1.1.0+1.21.5" = _N2SGJRPC;
        "pkg-1.2.1" = _cS5ic42g;
        "pkg-1.2.1+1.21.7" = _REpRrCyh;
        "pkg-1.2.1+1.21.9" = _ADFpsftW;
        "pkg-1.3.0" = _vpwnJXCu;
        "pkg-1.3.0+1.21.4" = _Cu4FHl74;
        "pkg-1.3.1+1.21.11" = _LEQmJ9A6;
        "pkg-1.3.2" = _nGKn667s;
        "pkg-1.3.2+1.21.4" = _dC3fpPjo;
        "pkg-1.3.2+26.1" = _ljI88vwq;
        "pkg-1.3.3" = _DN62FwPX;
        "pkg-1.3.4" = _e9YeIqNN;
        "default" = _e9YeIqNN;
    });
