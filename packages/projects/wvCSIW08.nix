...
let
    versions = (let
        ...
        _3Bj7Dk5Q = {
            "id" = "3Bj7Dk5Q";
            "file" = "vmtranslationupdate-fabric-5.2.3+mc1.16.5.jar";
            "hash" = "sha512-x1wqHZ9GqMzF/so7XdAPYrJN5doXiB6uW99wIec65HN66vLvgYlxUR/bhgZ6mMMzJgkctSZ/biWdbNZmL6K2MA==";
        };
        _wVEEhpDz = {
            "id" = "wVEEhpDz";
            "file" = "vmtranslationupdate-fabric-5.2.3+mc1.18.2.jar";
            "hash" = "sha512-cEB1d3/7dQtXf7rZAf4J9fBQVRD+RfrVsFO8IndA776ydVvjMeWmlIfHEuZJoEuj6qRk9EQCYQBlN5cvvFwRgg==";
        };
        _OwyiVCMo = {
            "id" = "OwyiVCMo";
            "file" = "vmtranslationupdate-fabric-5.2.3+mc1.19.2.jar";
            "hash" = "sha512-b50Se1OMb1Y/WOvf9LQS/YVDfiti3ZWWsUumYiJEtRmFlrxAQF89u4U/4VB8qc9GUCr7Pyfb3H7Pw1eNmmKPMg==";
        };
        _lvLtqoOI = {
            "id" = "lvLtqoOI";
            "file" = "vmtranslationupdate-fabric-5.2.3+mc1.20.1.jar";
            "hash" = "sha512-zbEzJu3OqU+2GJaDCuNoKZ8eVxsLy8Mw7zY/4MBdabFeEhICyw9OwHT3yDunj5YAa8mEuk5OWWT6OZowWYT21w==";
        };
        _7S618KlY = {
            "id" = "7S618KlY";
            "file" = "vmtranslationupdate-fabric-5.2.3+mc1.20.4.jar";
            "hash" = "sha512-I1ZlWsAZC0UFDLz/HWIyWP9nfRF1ylaP0elMfZu/AGXy3nZqegGzzKRRVgeFqxPXyhJLAYTN5AVn8oO6OraV9w==";
        };
        _cCPYyUOG = {
            "id" = "cCPYyUOG";
            "file" = "vmtranslationupdate-fabric-5.2.3+mc1.20.6.jar";
            "hash" = "sha512-7dr2EE9qyIT4amG0AD5bslwGqGh4o8tMSl9JFpLgvU8a+e5T7lY0Vyyx+v2sS3+ca2umyTchdl3+ouQOGKWiBA==";
        };
        _LOwCHdcz = {
            "id" = "LOwCHdcz";
            "file" = "vmtranslationupdate-fabric-5.2.3+mc1.21.1.jar";
            "hash" = "sha512-/U4Eahz66kxZnIn+M5pinNZ8HKOTIiQ13NYdY5q8dFU0VtJOrPvyBzA7OApAm+XgSxMQKIl+ECGr+0PFOYRQUQ==";
        };
        _V61EXPl3 = {
            "id" = "V61EXPl3";
            "file" = "vmtranslationupdate-fabric-5.2.3+mc1.21.10.jar";
            "hash" = "sha512-4avy0KgZVAYvjad5AAXQ3xebA28HP010n4nruTQ3szHaevA9ajlxvP9AcXz1OPfcMSb9qfnrI3BsUWSP3Lg7hQ==";
        };
        _VXkDs7eM = {
            "id" = "VXkDs7eM";
            "file" = "vmtranslationupdate-fabric-5.2.3+mc1.21.11.jar";
            "hash" = "sha512-Zz+f9TugBGL1D0X3IFGGaqSxInvblwafhcKTMKmRlRvcTdn2eDmkt6NWHhetIzjnwIWT7/m8OQ1U2lzu9bDw0A==";
        };
        _Yevg974n = {
            "id" = "Yevg974n";
            "file" = "vmtranslationupdate-fabric-5.2.3+mc1.21.4.jar";
            "hash" = "sha512-RwRjZ3bsTKmRQnh1Y9rDb4wU6lk5iUwuLi39jnil+7UB9LqOpp2MF49+NGzggu9ENc2sejKSuu0eZyeT3TZREw==";
        };
        _Fc6uU51A = {
            "id" = "Fc6uU51A";
            "file" = "vmtranslationupdate-fabric-5.2.3+mc1.21.5.jar";
            "hash" = "sha512-WMVGgbUTZi7Rsa1BBGM4ebm53AurumwVS/z3+s6GNF0rb0+sDRcGigd2ns1w1pvbvFZ1KWV14f9ksVkArxVmnw==";
        };
        _eNvQlqEn = {
            "id" = "eNvQlqEn";
            "file" = "vmtranslationupdate-fabric-5.2.3+mc1.21.8.jar";
            "hash" = "sha512-Nz0o6B5F35nIBLHqOw7V6jqerSEKSfJ+iCvJgwvs/pIGhxcgpmb1Yjbz5qJKceM2T/ajvFX1gHQdexBGy1jSsA==";
        };
        _YuWSzQeQ = {
            "id" = "YuWSzQeQ";
            "file" = "vmtranslationupdate-fabric-5.2.3+mc26.1.2.jar";
            "hash" = "sha512-NT8PvC71w4q1fxrRPZrUh6k/zQhlhqtiAYr9czIUciS8fzHKWLXKNrU6VFRd04z4q2ajiNr0GeTY8Qq4j4PSaw==";
        };
        _jzzxTe3s = {
            "id" = "jzzxTe3s";
            "file" = "vmtranslationupdate-fabric-5.2.3+mc26.2.jar";
            "hash" = "sha512-bnWPUGstPr1GmZLZBf9rOI5GQB00kYVOOATbij9E0uplVbrWyxdUTZIOmXrx/PKcxlR1f7RCU0mrHXPxC192QQ==";
        };
        _4BUKvIC1 = {
            "id" = "4BUKvIC1";
            "file" = "vmtranslationupdate-forge-5.2.3+mc1.16.5.jar";
            "hash" = "sha512-IX8tb61+T9FX+QzKeGaQ99TP5nUUlqZ1LqPH6MyvWyLU2wD5q9oGJRxIXZ7fVL4icKTvPKgh+nPdYextOz5E1A==";
        };
        _SZfgGuQ5 = {
            "id" = "SZfgGuQ5";
            "file" = "vmtranslationupdate-forge-5.2.3+mc1.18.2.jar";
            "hash" = "sha512-6cI79RycDzzoYQYTVomaQjMlhkcAWkEFza0SYb/9hDCfO1HccT1pyQ0jyIrsDK6/dWJTMjs11kp8o2FAOIHclg==";
        };
        _l7Fjzi3f = {
            "id" = "l7Fjzi3f";
            "file" = "vmtranslationupdate-forge-5.2.3+mc1.19.2.jar";
            "hash" = "sha512-I/kfx5MOrzghs8JBSmXLLwfRA1bstT3XwyvbHI7WFIm7oAL6fLSAngGmENUH+7cnVMOYksdy3wPQGTplhKj7Zg==";
        };
        _AuaQCUDu = {
            "id" = "AuaQCUDu";
            "file" = "vmtranslationupdate-forge-5.2.3+mc1.20.1.jar";
            "hash" = "sha512-Nh4U/ZUeHF0FP0W4+AIV9Z5kSg8cvoqSqGpP6IMHH3kD1/nFm582NoU1CPcRLB6q77I5UiSW+Esi73gzL6loZA==";
        };
        _eRBsVETl = {
            "id" = "eRBsVETl";
            "file" = "vmtranslationupdate-neoforge-5.2.3+mc1.20.4.jar";
            "hash" = "sha512-/YhGQQulsdlbd9YGAyj9ZC5EU4YiGiBhqmhfeIbwylHLE6mGJ0NH8ubXUN3Fg8TxlTxZq0oGe3HKnYK88Laijw==";
        };
        _ZfaSfjGf = {
            "id" = "ZfaSfjGf";
            "file" = "vmtranslationupdate-neoforge-5.2.3+mc1.20.6.jar";
            "hash" = "sha512-4PQ0R7CsXbbMgGeYRexRuww/4KMAhVb3z8WK4y1jx3tzLdxdVREkc6zsKRb0NQsaT05UC6DDXFxWukOCH09KKQ==";
        };
        _4apfMSGs = {
            "id" = "4apfMSGs";
            "file" = "vmtranslationupdate-neoforge-5.2.3+mc1.21.1.jar";
            "hash" = "sha512-G4PsJ33dDQx3ZQpWF8BSj6QHRY1Ewjd5jYhhEiZc+42J94TDcrIbkSp4RtHGkD30ivYU22qu4KOH5slgXHne8g==";
        };
        _4oUSQSF1 = {
            "id" = "4oUSQSF1";
            "file" = "vmtranslationupdate-neoforge-5.2.3+mc1.21.10.jar";
            "hash" = "sha512-Bn9zdVxPVi+mrgawWsfpYpxKgiHBptCIwQO/EqTs68IlmzVw8ukvAyFsvkJn9KtVCE6UhHngV7MxYWgBAg5Myw==";
        };
        _qRxsPyDz = {
            "id" = "qRxsPyDz";
            "file" = "vmtranslationupdate-neoforge-5.2.3+mc1.21.11.jar";
            "hash" = "sha512-G3fRgZ3tyPzxAfyWflvAUDRl1qKZ2qst+jSuj5KyQ1S5xMeid//VWaUdakYUifeOd5nIRHBQ8qPadWYeXf5pwA==";
        };
        _JQGkReix = {
            "id" = "JQGkReix";
            "file" = "vmtranslationupdate-neoforge-5.2.3+mc1.21.4.jar";
            "hash" = "sha512-sVJlXJaKVDOM2Zc7IgKZV291t3cmyhFlbOyJiuD5tpMAa1HxaAzXidgutRx8KMrI5G0q8z2lwRTwD56XZzjBig==";
        };
        _OkcFSz68 = {
            "id" = "OkcFSz68";
            "file" = "vmtranslationupdate-neoforge-5.2.3+mc1.21.5.jar";
            "hash" = "sha512-UjM9pnZ/IP80t2T2KMZyImmAkbffdn0mc3gD6cNqLSaMaMnpwkvJ27xUkT6n2pp/sVPrAxvUhpRnYZUGJixhUA==";
        };
        _K628XhUx = {
            "id" = "K628XhUx";
            "file" = "vmtranslationupdate-neoforge-5.2.3+mc1.21.8.jar";
            "hash" = "sha512-aOnRWE6kFYLpTjNbuDcUSbrrSw7GH+72I6nbCXcm7guc0rkC06c5utgHJ7NK5zvPIOLdCHnAjPFN47Fggop1QA==";
        };
        _Cn3KOebd = {
            "id" = "Cn3KOebd";
            "file" = "vmtranslationupdate-neoforge-5.2.3+mc26.1.2.jar";
            "hash" = "sha512-KLnWsdHmXt7D3dcBDx8x3gJLBbdyP7WNqo6vCiFA6300oHEbon4WUHEYw+GO1RjDWJ50/Fm/9g9/K1S3xpyAlg==";
        };
        _kkzSoIlQ = {
            "id" = "kkzSoIlQ";
    ...
    in {
        ...
        "pkg-2.3" = _Zn6qo7Et;
        "pkg-2.3.1" = _ABXu37L4;
        "pkg-2.3.2+mc1.20.4" = _3AXvVgja;
        "pkg-2.3.2+mc1.20.1" = _oKQRYuQr;
        "pkg-2.3.2+mc1.12.2" = _uVVV706x;
        "pkg-2.3.2+mc1.16.5" = _9KA9NVay;
        "pkg-2.3.2+mc1.18.2" = _Cp1jFqxq;
        "pkg-2.3.2+mc1.19.2" = _h7bFGkru;
        "pkg-2.3.2+mc1.19.4" = _Y412Iqg0;
        "pkg-2.3.2+mc1.20.2" = _q2NwgIce;
        "pkg-2.4.0+mc1.12.2" = _maSutzI9;
        "pkg-2.4.0+mc1.20.4" = _tlwRQzTD;
        "pkg-2.4.0+mc1.19.2" = _WFWBcv40;
        "pkg-2.4.0+mc1.18.2" = _aAZwYOC6;
        "pkg-2.4.0+mc1.16.5" = _quj3b9vj;
        "pkg-2.4.0+mc1.20.6" = _yGcfyzAj;
        "pkg-3.0.0+mc1.20.4" = _IXK6E4p3;
        "pkg-3.0.0+mc1.18.2" = _W0PJPzTr;
        "pkg-3.0.0+mc1.19.2" = _PcEUeXeg;
        "pkg-3.0.0+mc1.20.1" = _EESFZhhu;
        "pkg-3.0.0+mc1.20.6" = _etSzvNCI;
        "pkg-3.0.0+mc1.21.1" = _4O3uJt4o;
        "pkg-3.0.0+mc1.21.4" = _TmHbLNes;
        "pkg-3.0.0+mc1.21.5" = _TieJ4msU;
        "pkg-3.1.0+mc1.18.2" = _ATyhRG1h;
        "pkg-3.1.0+mc1.19.2" = _W8WHpPTQ;
        "pkg-3.1.0+mc1.20.1" = _PjIBMwcC;
        "pkg-3.1.0+mc1.20.4" = _DBMYG3ju;
        "pkg-3.1.0+mc1.20.6" = _TkuD90tR;
        "pkg-3.1.0+mc1.21.1" = _faaLnucc;
        "pkg-3.1.0+mc1.21.4" = _iuOEoZfo;
        "pkg-3.1.0+mc1.21.5" = _ZdykVRV9;
        "pkg-3.2.0+mc1.12.2" = _CyaNft7B;
        "pkg-3.2.0+mc1.16.5" = _Okv13ijM;
        "pkg-3.2.0+mc1.18.2" = _4vGocfSA;
        "pkg-3.2.0+mc1.19.2" = _LM71dJBH;
        "pkg-3.2.0+mc1.20.1" = _3FlB16CJ;
        "pkg-3.2.0+mc1.20.4" = _6vPbqwWd;
        "pkg-3.2.0+mc1.20.6" = _S2Js4BIq;
        "pkg-3.2.0+mc1.21.1" = _teKZIgJG;
        "pkg-3.2.0+mc1.21.4" = _Uou5gf53;
        "pkg-3.2.0+mc1.21.5" = _iwAigGNv;
        "pkg-3.2.1+mc1.21.5" = _HFPC1d3i;
        "pkg-3.2.1+mc1.21.7" = _8AJi90nu;
        "pkg-3.3.0+mc1.21.4" = _3WtSMSa8;
        "pkg-3.3.0+mc1.21.5" = _3kZXxfNB;
        "pkg-3.3.0+mc1.21.8" = _Fb5dM0Yp;
        "pkg-3.3.0+mc1.21.1" = _znrZSDAz;
        "pkg-4.0.0+mc1.16.5" = _vL77hcpJ;
        "pkg-4.0.0+mc1.18.2" = _63jpI7QT;
        "pkg-4.0.0+mc1.12.2" = _D1CyWOfS;
        "pkg-4.0.0+mc1.21.8" = _im1YUnWy;
        "pkg-4.0.0+mc1.21.5" = _tL01xanu;
        "pkg-4.0.0+mc1.21.4" = _abbzbL91;
        "pkg-4.0.0+mc1.21.1" = _OrY2TKdE;
        "pkg-4.0.0+mc1.20.6" = _cKGAHF5e;
        "pkg-4.0.0+mc1.20.4" = _udR1XRGS;
        "pkg-4.0.0+mc1.20.1" = _KP1ChO8d;
        "pkg-4.0.0+mc1.19.2" = _4U167tI3;
        "pkg-fabric-5.0.0+mc1.16.5" = _15jeI3xU;
        "pkg-fabric-5.0.0+mc1.18.2" = _AOYKUeqV;
        "pkg-fabric-5.0.0+mc1.19.2" = _7GlELhIs;
        "pkg-fabric-5.0.0+mc1.20.1" = _5CNJ8agX;
        "pkg-fabric-5.0.0+mc1.20.4" = _cXMyshdH;
        "pkg-fabric-5.0.0+mc1.20.6" = _Pe5PEyhu;
        "pkg-fabric-5.0.0+mc1.21.1" = _3NwinqVr;
        "pkg-fabric-5.0.0+mc1.21.10" = _VSNIaSOU;
        "pkg-fabric-5.0.0+mc1.21.11" = _FD24uKEc;
        "pkg-fabric-5.0.0+mc1.21.4" = _sBL0zq3X;
        "pkg-fabric-5.0.0+mc1.21.5" = _LVX1N3KZ;
        "pkg-fabric-5.0.0+mc1.21.8" = _vliZtHpX;
        "pkg-forge-5.0.0+mc1.16.5" = _6UIFajTC;
        "pkg-forge-5.0.0+mc1.18.2" = _pTlo5k4S;
        "pkg-forge-5.0.0+mc1.19.2" = _1bC6Fa2m;
        "pkg-forge-5.0.0+mc1.20.1" = _wzldX05w;
        "pkg-neoforge-5.0.0+mc1.20.4" = _mfurnshm;
        "pkg-neoforge-5.0.0+mc1.20.6" = _yQzfoJDr;
        "pkg-neoforge-5.0.0+mc1.21.1" = _560KznS3;
        "pkg-neoforge-5.0.0+mc1.21.10" = _amTu7P8t;
        "pkg-neoforge-5.0.0+mc1.21.11" = _XtsXLQTv;
        "pkg-neoforge-5.0.0+mc1.21.4" = _h49gJmJj;
        "pkg-neoforge-5.0.0+mc1.21.5" = _u2HCAD5q;
        "pkg-neoforge-5.0.0+mc1.21.8" = _qsWcpodL;
        "pkg-forge-5.0.1+mc1.12.2" = _8gOllxIa;
        "pkg-fabric-5.0.1+mc1.16.5" = _tjMKUs0e;
        "pkg-fabric-5.0.1+mc1.18.2" = _GyKUZj1A;
        "pkg-fabric-5.0.1+mc1.19.2" = _7lLlNV0d;
        "pkg-fabric-5.0.1+mc1.20.1" = _HtitI89g;
        "pkg-fabric-5.0.1+mc1.20.4" = _zQqZRq59;
        "pkg-fabric-5.0.1+mc1.20.6" = _cXCK9TkX;
        "pkg-fabric-5.0.1+mc1.21.1" = _dSEN8i50;
        "pkg-fabric-5.0.1+mc1.21.10" = _e7pLcvX7;
        "pkg-fabric-5.0.1+mc1.21.11" = _ABqPeXJM;
        "pkg-fabric-5.0.1+mc1.21.4" = _BlTXwwtZ;
        "pkg-fabric-5.0.1+mc1.21.5" = _QM1gnOD6;
        "pkg-fabric-5.0.1+mc1.21.8" = _yfUWoddI;
        "pkg-forge-5.0.1+mc1.16.5" = _qr3VhyfB;
        "pkg-forge-5.0.1+mc1.18.2" = _b30vppNY;
        "pkg-forge-5.0.1+mc1.19.2" = _mTIXZKOE;
        "pkg-forge-5.0.1+mc1.20.1" = _ZvXOwNEw;
        "pkg-neoforge-5.0.1+mc1.20.4" = _O1FA2v7u;
        "pkg-neoforge-5.0.1+mc1.20.6" = _X8ZEsmJp;
        "pkg-neoforge-5.0.1+mc1.21.1" = _IFobgJJK;
        "pkg-neoforge-5.0.1+mc1.21.10" = _ZSDb2RXc;
        "pkg-neoforge-5.0.1+mc1.21.11" = _k0FwDDXi;
        "pkg-neoforge-5.0.1+mc1.21.4" = _rBhepIgX;
        "pkg-neoforge-5.0.1+mc1.21.5" = _3EIlvqSW;
        "pkg-neoforge-5.0.1+mc1.21.8" = _7Z1PQNxt;
        "pkg-fabric-5.0.2+mc1.16.5" = _2OKuZR9y;
        "pkg-fabric-5.0.2+mc1.18.2" = _TsL1ItHb;
        "pkg-fabric-5.0.2+mc1.19.2" = _OoxikvNr;
        "pkg-fabric-5.0.2+mc1.20.1" = _zQdtzMKV;
        "pkg-fabric-5.0.2+mc1.20.4" = _9GZ0IemD;
        "pkg-fabric-5.0.2+mc1.20.6" = _ZdzUk32L;
        "pkg-fabric-5.0.2+mc1.21.1" = _sDpHrzkr;
        "pkg-fabric-5.0.2+mc1.21.10" = _gmDIKAbc;
        "pkg-fabric-5.0.2+mc1.21.11" = _CnRwYcA2;
        "pkg-fabric-5.0.2+mc1.21.4" = _7l1nMGSZ;
        "pkg-fabric-5.0.2+mc1.21.5" = _7UBLtU2B;
        "pkg-fabric-5.0.2+mc1.21.8" = _JG798rIz;
        "pkg-forge-5.0.2+mc1.16.5" = _koSt8lgx;
        "pkg-forge-5.0.2+mc1.18.2" = _LypUayLd;
        "pkg-forge-5.0.2+mc1.19.2" = _bDCuhd0j;
        "pkg-forge-5.0.2+mc1.20.1" = _9uafzGq7;
        "pkg-neoforge-5.0.2+mc1.20.4" = _zRSi7K6y;
        "pkg-neoforge-5.0.2+mc1.20.6" = _gHbDL6yy;
        "pkg-neoforge-5.0.2+mc1.21.1" = _9IAeI8tt;
        "pkg-neoforge-5.0.2+mc1.21.10" = _d2CwlRJ2;
        "pkg-neoforge-5.0.2+mc1.21.11" = _XGOnc8ok;
        "pkg-neoforge-5.0.2+mc1.21.4" = _hQmDrfvB;
        "pkg-neoforge-5.0.2+mc1.21.5" = _71Jn11fC;
        "pkg-neoforge-5.0.2+mc1.21.8" = _nsiIcHiU;
        "pkg-forge-5.0.2+mc1.12.2" = _iHNg9QQP;
        "pkg-fabric-5.0.3+mc1.16.5" = _lrhHyOon;
        "pkg-fabric-5.0.3+mc1.18.2" = _JYlLzprk;
        "pkg-fabric-5.0.3+mc1.19.2" = _SbcX6I8u;
        "pkg-fabric-5.0.3+mc1.20.1" = _PN57CRwK;
        "pkg-fabric-5.0.3+mc1.20.4" = _mr5u69eJ;
        "pkg-fabric-5.0.3+mc1.20.6" = _zz5PFc9X;
        "pkg-fabric-5.0.3+mc1.21.1" = _n1oXvved;
        "pkg-fabric-5.0.3+mc1.21.10" = _plKN7bxL;
        "pkg-fabric-5.0.3+mc1.21.11" = _sPVhMjWv;
        "pkg-fabric-5.0.3+mc1.21.4" = _MfhFLiUU;
        "pkg-fabric-5.0.3+mc1.21.5" = _HLLX7Kw3;
        "pkg-fabric-5.0.3+mc1.21.8" = _5sk43oIu;
        "pkg-forge-5.0.3+mc1.16.5" = _RiVeRgDc;
        "pkg-forge-5.0.3+mc1.18.2" = _gHuLE2RB;
        "pkg-forge-5.0.3+mc1.19.2" = _oCGsa3xU;
        "pkg-forge-5.0.3+mc1.20.1" = _yQMniUma;
        "pkg-neoforge-5.0.3+mc1.20.4" = _XxwGxOdZ;
        "pkg-neoforge-5.0.3+mc1.20.6" = _OwDXM7GB;
        "pkg-neoforge-5.0.3+mc1.21.1" = _UcaVHSLe;
        "pkg-neoforge-5.0.3+mc1.21.10" = _DRa64BJp;
        "pkg-neoforge-5.0.3+mc1.21.11" = _2I9IYljj;
        "pkg-neoforge-5.0.3+mc1.21.4" = _g9RSyL5O;
        "pkg-neoforge-5.0.3+mc1.21.5" = _nkhygqYf;
        "pkg-neoforge-5.0.3+mc1.21.8" = _o81mQYDv;
        "pkg-fabric-5.0.4+mc1.16.5" = _WSFabrKr;
        "pkg-fabric-5.0.4+mc1.18.2" = _fcBjYYq1;
        "pkg-fabric-5.0.4+mc1.19.2" = _kPZwswEV;
        "pkg-fabric-5.0.4+mc1.20.1" = _ikAsHE9b;
        "pkg-fabric-5.0.4+mc1.20.4" = _3JNYs18a;
        "pkg-fabric-5.0.4+mc1.20.6" = _PEo695oO;
        "pkg-fabric-5.0.4+mc1.21.1" = _2OjJoP9h;
        "pkg-fabric-5.0.4+mc1.21.10" = _GItFRvPR;
        "pkg-fabric-5.0.4+mc1.21.11" = _K8KCAXw1;
        "pkg-fabric-5.0.4+mc1.21.4" = _8LGZJDkQ;
        "pkg-fabric-5.0.4+mc1.21.5" = _9ThIptGR;
        "pkg-fabric-5.0.4+mc1.21.8" = _JNa2SQK6;
        "pkg-forge-5.0.4+mc1.16.5" = _vRfwDRMC;
        "pkg-forge-5.0.4+mc1.18.2" = _h8U4mFqb;
        "pkg-forge-5.0.4+mc1.19.2" = _4rVO2oON;
        "pkg-forge-5.0.4+mc1.20.1" = _VlYDafxk;
        "pkg-neoforge-5.0.4+mc1.20.4" = _7MTosAAS;
        "pkg-neoforge-5.0.4+mc1.20.6" = _NMEIRxUU;
        "pkg-neoforge-5.0.4+mc1.21.1" = _g1NYI1lt;
        "pkg-neoforge-5.0.4+mc1.21.10" = _Crm6k6MT;
        "pkg-neoforge-5.0.4+mc1.21.11" = _LcUdLaje;
        "pkg-neoforge-5.0.4+mc1.21.4" = _PNrIzsrs;
        "pkg-neoforge-5.0.4+mc1.21.5" = _iNNtN1FK;
        "pkg-neoforge-5.0.4+mc1.21.8" = _rA6Xsv0Q;
        "pkg-fabric-5.1.0+mc1.16.5" = _a6eVSCJS;
        "pkg-fabric-5.1.0+mc1.18.2" = _n1bVrYAx;
        "pkg-fabric-5.1.0+mc1.19.2" = _oCheC9a4;
        "pkg-fabric-5.1.0+mc1.20.1" = _lnL0zQJF;
        "pkg-fabric-5.1.0+mc1.20.4" = _VGZfbzA7;
        "pkg-fabric-5.1.0+mc1.20.6" = _74Pz5jTt;
        "pkg-fabric-5.1.0+mc1.21.1" = _uRFB0frK;
        "pkg-fabric-5.1.0+mc1.21.10" = _QQBshhhp;
        "pkg-fabric-5.1.0+mc1.21.11" = _IRHwBOCl;
        "pkg-fabric-5.1.0+mc1.21.4" = _YUKxHP4l;
        "pkg-fabric-5.1.0+mc1.21.5" = _pBFRg4X1;
        "pkg-fabric-5.1.0+mc1.21.8" = _dZuDtzSd;
        "pkg-fabric-5.1.0+mc26.1.2" = _r4oKxPVD;
        "pkg-forge-5.1.0+mc1.16.5" = _iMqUv9oC;
        "pkg-forge-5.1.0+mc1.18.2" = _vIQrGA3R;
        "pkg-forge-5.1.0+mc1.19.2" = _RJEFK7Pt;
        "pkg-forge-5.1.0+mc1.20.1" = _HDEwg2TF;
        "pkg-neoforge-5.1.0+mc1.20.4" = _qgDdD39q;
        "pkg-neoforge-5.1.0+mc1.20.6" = _mupNX4PJ;
        "pkg-neoforge-5.1.0+mc1.21.1" = _Jl1eKC3f;
        "pkg-neoforge-5.1.0+mc1.21.10" = _XjMPEZ4v;
        "pkg-neoforge-5.1.0+mc1.21.11" = _POl9GhhU;
        "pkg-neoforge-5.1.0+mc1.21.4" = _boVrM0ue;
        "pkg-neoforge-5.1.0+mc1.21.5" = _BiwmjOmE;
        "pkg-neoforge-5.1.0+mc1.21.8" = _x8wH6gVT;
        "pkg-neoforge-5.1.0+mc26.1.2" = _zW3qcE16;
        "pkg-5.1.0" = _MVCpQumQ;
        "pkg-fabric-5.2.0+mc1.16.5" = _Wm91ZrwC;
        "pkg-fabric-5.2.0+mc1.18.2" = _GFBSuCR9;
        "pkg-fabric-5.2.0+mc1.19.2" = _lY4ovkrP;
        "pkg-fabric-5.2.0+mc1.20.1" = _yKPSeUIz;
        "pkg-fabric-5.2.0+mc1.20.4" = _TutY1AwN;
        "pkg-fabric-5.2.0+mc1.20.6" = _y590ln6e;
        "pkg-fabric-5.2.0+mc1.21.1" = _OOjfhC9m;
        "pkg-fabric-5.2.0+mc1.21.10" = _cXHJZRQQ;
        "pkg-fabric-5.2.0+mc1.21.11" = _NY06bL1L;
        "pkg-fabric-5.2.0+mc1.21.4" = _c5mnReKA;
        "pkg-fabric-5.2.0+mc1.21.5" = _ijix7rRg;
        "pkg-fabric-5.2.0+mc1.21.8" = _VudaMCWn;
        "pkg-fabric-5.2.0+mc26.1.2" = _rdtXKfIF;
        "pkg-fabric-5.2.0+mc26.2" = _2dpqFpjU;
        "pkg-forge-5.2.0+mc1.16.5" = _rsAdzlTa;
        "pkg-forge-5.2.0+mc1.18.2" = _KHLmMI8g;
        "pkg-forge-5.2.0+mc1.19.2" = _eRroSTrs;
        "pkg-forge-5.2.0+mc1.20.1" = _Iqbg3LZs;
        "pkg-neoforge-5.2.0+mc1.20.4" = _6TTu4ptS;
        "pkg-neoforge-5.2.0+mc1.20.6" = _CbJeYgLP;
        "pkg-neoforge-5.2.0+mc1.21.1" = _lucFFpiC;
        "pkg-neoforge-5.2.0+mc1.21.10" = _zIlwyz2o;
        "pkg-neoforge-5.2.0+mc1.21.11" = _QJshrtxa;
        "pkg-neoforge-5.2.0+mc1.21.4" = _CXROdQYN;
        "pkg-neoforge-5.2.0+mc1.21.5" = _hZKyqCY6;
        "pkg-neoforge-5.2.0+mc1.21.8" = _gN1Y1T3v;
        "pkg-neoforge-5.2.0+mc26.1.2" = _Lu6zpRtH;
        "pkg-neoforge-5.2.0+mc26.2" = _vnS6wSGQ;
        "pkg-forge-5.2.0+mc1.12.2" = _JM8zKnUM;
        "pkg-fabric-5.2.1+mc1.16.5" = _5nu1Hfaj;
        "pkg-fabric-5.2.1+mc1.18.2" = _IUivczpD;
        "pkg-fabric-5.2.1+mc1.19.2" = _C8kNZUEE;
        "pkg-fabric-5.2.1+mc1.20.1" = _UBqUEYpq;
        "pkg-fabric-5.2.1+mc1.20.4" = _RjZtCLLd;
        "pkg-fabric-5.2.1+mc1.20.6" = _UPKiczDy;
        "pkg-fabric-5.2.1+mc1.21.1" = _rmcbzpSt;
        "pkg-fabric-5.2.1+mc1.21.10" = _GwZmTwfX;
        "pkg-fabric-5.2.1+mc1.21.11" = _qp8mlSTn;
        "pkg-fabric-5.2.1+mc1.21.4" = _U7q2067W;
        "pkg-fabric-5.2.1+mc1.21.5" = _I61SuWVR;
        "pkg-fabric-5.2.1+mc1.21.8" = _UEK18uMf;
        "pkg-fabric-5.2.1+mc26.1.2" = _yxlIhnPb;
        "pkg-fabric-5.2.1+mc26.2" = _hUAYRNKF;
        "pkg-forge-5.2.1+mc1.16.5" = _BSzt0WAy;
        "pkg-forge-5.2.1+mc1.18.2" = _WtjPKlxs;
        "pkg-forge-5.2.1+mc1.19.2" = _iH7JF7AS;
        "pkg-forge-5.2.1+mc1.20.1" = _wQBvb4TZ;
        "pkg-neoforge-5.2.1+mc1.20.4" = _ie9NSbJc;
        "pkg-neoforge-5.2.1+mc1.20.6" = _D5Oc5AcA;
        "pkg-neoforge-5.2.1+mc1.21.1" = _5OsnSnvd;
        "pkg-neoforge-5.2.1+mc1.21.10" = _CxXIZPq5;
        "pkg-neoforge-5.2.1+mc1.21.11" = _WPPXQvYL;
        "pkg-neoforge-5.2.1+mc1.21.4" = _a93WpxhC;
        "pkg-neoforge-5.2.1+mc1.21.5" = _aLulBxem;
        "pkg-neoforge-5.2.1+mc1.21.8" = _SRbmVWe4;
        "pkg-neoforge-5.2.1+mc26.1.2" = _xJl5ahLz;
        "pkg-neoforge-5.2.1+mc26.2" = _Lf50tkXO;
        "pkg-fabric-5.2.2+mc1.16.5" = _f85Ypcgr;
        "pkg-fabric-5.2.2+mc1.18.2" = _s2ZuAD41;
        "pkg-fabric-5.2.2+mc1.19.2" = _Z0rK4kgh;
        "pkg-fabric-5.2.2+mc1.20.1" = _FxXUb1vH;
        "pkg-fabric-5.2.2+mc1.20.4" = _4iAZAHeS;
        "pkg-fabric-5.2.2+mc1.20.6" = _8Xldb8ee;
        "pkg-fabric-5.2.2+mc1.21.1" = _Je9LtqFh;
        "pkg-fabric-5.2.2+mc1.21.10" = _L5txowBO;
        "pkg-fabric-5.2.2+mc1.21.11" = _SebJ3mPf;
        "pkg-fabric-5.2.2+mc1.21.4" = _Xuf28qnL;
        "pkg-fabric-5.2.2+mc1.21.5" = _NeiX7ZKs;
        "pkg-fabric-5.2.2+mc1.21.8" = _cdAIq0S5;
        "pkg-fabric-5.2.2+mc26.1.2" = _72NQ6Y1c;
        "pkg-fabric-5.2.2+mc26.2" = _iJrciV5R;
        "pkg-forge-5.2.2+mc1.16.5" = _44CxWtOc;
        "pkg-forge-5.2.2+mc1.18.2" = _qPXy2IeZ;
        "pkg-forge-5.2.2+mc1.19.2" = _Ja6kRqcH;
        "pkg-forge-5.2.2+mc1.20.1" = _tenN187d;
        "pkg-neoforge-5.2.2+mc1.20.4" = _6Wx99sGq;
        "pkg-neoforge-5.2.2+mc1.20.6" = _bFohJ1RZ;
        "pkg-neoforge-5.2.2+mc1.21.1" = _qXDbKU3G;
        "pkg-neoforge-5.2.2+mc1.21.10" = _lKpzvolz;
        "pkg-neoforge-5.2.2+mc1.21.11" = _fthOth9J;
        "pkg-neoforge-5.2.2+mc1.21.4" = _bnGlIBGI;
        "pkg-neoforge-5.2.2+mc1.21.5" = _YdMsRmUN;
        "pkg-neoforge-5.2.2+mc1.21.8" = _Tj7HSiMR;
        "pkg-neoforge-5.2.2+mc26.1.2" = _THba9iqQ;
        "pkg-neoforge-5.2.2+mc26.2" = _v5kWKC4Y;
        "pkg-fabric-5.2.3+mc1.16.5" = _3Bj7Dk5Q;
        "pkg-fabric-5.2.3+mc1.18.2" = _wVEEhpDz;
        "pkg-fabric-5.2.3+mc1.19.2" = _OwyiVCMo;
        "pkg-fabric-5.2.3+mc1.20.1" = _lvLtqoOI;
        "pkg-fabric-5.2.3+mc1.20.4" = _7S618KlY;
        "pkg-fabric-5.2.3+mc1.20.6" = _cCPYyUOG;
        "pkg-fabric-5.2.3+mc1.21.1" = _LOwCHdcz;
        "pkg-fabric-5.2.3+mc1.21.10" = _V61EXPl3;
        "pkg-fabric-5.2.3+mc1.21.11" = _VXkDs7eM;
        "pkg-fabric-5.2.3+mc1.21.4" = _Yevg974n;
        "pkg-fabric-5.2.3+mc1.21.5" = _Fc6uU51A;
        "pkg-fabric-5.2.3+mc1.21.8" = _eNvQlqEn;
        "pkg-fabric-5.2.3+mc26.1.2" = _YuWSzQeQ;
        "pkg-fabric-5.2.3+mc26.2" = _jzzxTe3s;
        "pkg-forge-5.2.3+mc1.16.5" = _4BUKvIC1;
        "pkg-forge-5.2.3+mc1.18.2" = _SZfgGuQ5;
        "pkg-forge-5.2.3+mc1.19.2" = _l7Fjzi3f;
        "pkg-forge-5.2.3+mc1.20.1" = _AuaQCUDu;
        "pkg-neoforge-5.2.3+mc1.20.4" = _eRBsVETl;
        "pkg-neoforge-5.2.3+mc1.20.6" = _ZfaSfjGf;
        "pkg-neoforge-5.2.3+mc1.21.1" = _4apfMSGs;
        "pkg-neoforge-5.2.3+mc1.21.10" = _4oUSQSF1;
        "pkg-neoforge-5.2.3+mc1.21.11" = _qRxsPyDz;
        "pkg-neoforge-5.2.3+mc1.21.4" = _JQGkReix;
        "pkg-neoforge-5.2.3+mc1.21.5" = _OkcFSz68;
