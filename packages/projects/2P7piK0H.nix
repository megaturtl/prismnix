...
let
    versions = (let
        ...
        _MBep1T7g = {
            "id" = "MBep1T7g";
            "file" = "DeathSpectator-Forge-1.20.1-1.3.8.jar";
            "hash" = "sha512-wYPwdn2rLNGr71Y8Ps0teQ3KMeReRnULeOhMQxHqDiSLAK7vx1K1KM8/wIztBwGX5CLKDCRoLG5Cmp2HVu2MCQ==";
        };
        _TmQszHYo = {
            "id" = "TmQszHYo";
            "file" = "DeathSpectator-Fabric-1.20.1-1.3.8.jar";
            "hash" = "sha512-UL1JjZB2vCoLzbO5nVjaoIE8aNEkEl5q5poqiXU3r+j/XWAr2LvFApxIdqWTtxhK6cwfxuU3gV5c1tO3K2h52g==";
        };
        _QKGAFyfV = {
            "id" = "QKGAFyfV";
            "file" = "DeathSpectator-Neoforge-1.21.1-1.3.8.jar";
            "hash" = "sha512-BTc2G7NdAM9Jj+gKFyv4Oe8NSEl/8aUiqGN4RNA/QvDIdWqaPXx6rHki95MYc+Ecv+qKf8GGPjWzzqRRWQ9CsA==";
        };
        _UmiRH7H0 = {
            "id" = "UmiRH7H0";
            "file" = "DeathSpectator-Fabric-1.21.1-1.3.8.jar";
            "hash" = "sha512-ZhyWBXW+q0+SDcqpGbxf6XIMx0BN1PfX3fHePNwYSD62HOIm4k/+dfL98ahkjdCpT16HKSrz1RtgHbWKLL6hHQ==";
        };
    in {
        "h3GAEF4Z" = _h3GAEF4Z;
        "wsKSFi7M" = _wsKSFi7M;
        ...
        "QKGAFyfV" = _QKGAFyfV;
        "UmiRH7H0" = _UmiRH7H0;
        "forge-1.20.1" = _MBep1T7g;
        "forge-1.21" = _ol84ViEY;
        "forge-1.19.2" = _wT12rQSF;
        "forge-1.19.3" = _wT12rQSF;
        "forge-1.19.4" = _wT12rQSF;
        "forge-1.20.2" = _MBep1T7g;
        "forge-1.20.3" = _MBep1T7g;
        "forge-1.20.4" = _MBep1T7g;
        "forge-1.20.5" = _MBep1T7g;
        "forge-1.20.6" = _MBep1T7g;
        ...
        "fabric-1.20.1" = _TmQszHYo;
        "fabric-1.21" = _ea0WhEm0;
        "fabric-1.20.2" = _TmQszHYo;
        "fabric-1.20.3" = _TmQszHYo;
        "fabric-1.20.4" = _TmQszHYo;
        "fabric-1.20.5" = _TmQszHYo;
        "fabric-1.20.6" = _TmQszHYo;
        "fabric-1.19.2" = _di0ZEJtO;
        "fabric-1.19.3" = _di0ZEJtO;
        "fabric-1.19.4" = _di0ZEJtO;
        "fabric-1.21.1" = _UmiRH7H0;
        "fabric-1.21.2" = _UmiRH7H0;
        "fabric-1.21.3" = _UmiRH7H0;
        "fabric-1.21.4" = _UmiRH7H0;
        "fabric-1.21.5" = _UmiRH7H0;
        "fabric-1.21.6" = _UmiRH7H0;
        "fabric-1.21.7" = _UmiRH7H0;
        "fabric-1.21.8" = _UmiRH7H0;
        "fabric-1.21.9" = _UmiRH7H0;
        "fabric-1.21.10" = _UmiRH7H0;
        "fabric-1.21.11" = _UmiRH7H0;
        "neoforge-1.21" = _QtBnTlkt;
        "neoforge-1.21.1" = _QKGAFyfV;
        "neoforge-1.21.2" = _QKGAFyfV;
        "neoforge-1.21.3" = _QKGAFyfV;
        "neoforge-1.21.4" = _QKGAFyfV;
        "neoforge-1.21.5" = _QKGAFyfV;
        "neoforge-1.21.6" = _QKGAFyfV;
        "neoforge-1.21.7" = _QKGAFyfV;
        "neoforge-1.21.8" = _QKGAFyfV;
        "neoforge-1.21.9" = _QKGAFyfV;
        "neoforge-1.21.10" = _QKGAFyfV;
        "neoforge-1.21.11" = _QKGAFyfV;
        "pkg-1.0" = _T74uhfLg;
        "pkg-1.1" = _iEGtUMUb;
        "pkg-1.2" = _Eje7Y4pt;
        "pkg-1.3" = _KKQRig35;
