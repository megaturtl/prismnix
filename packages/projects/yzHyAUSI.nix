...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.7.1.0" = _GqVkXtXE;
        "pkg-1.19.2-1.8.3.0" = _jy3iJF1i;
        "pkg-1.19.3-1.9.0.0" = _S7676T8g;
        "pkg-1.19.3-1.9.1.0" = _N1dU3G8G;
        "pkg-1.18.2-1.7.2.0" = _la3KHYNz;
        "pkg-1.19.3-1.9.2.0" = _zbofHt8B;
        "pkg-1.19.3-1.9.2.1" = _pWgmy1P2;
        "pkg-1.19.2-1.8.3.1" = _7xH9bLYC;
        "pkg-1.19.2-1.8.3.2" = _mw1D8Vha;
        "pkg-1.19.3-1.9.3.0" = _8mp4GlZu;
        "pkg-1.19.4-1.10.0.0" = _hFjThbpW;
        "pkg-1.19.4-1.10.1.0" = _FR5dbjAk;
        "pkg-1.20.1-2.0.0.0" = _oioDy66h;
        "pkg-1.20.1-2.1.0.0" = _v1LtlrsG;
        "pkg-1.20.1-2.1.1.0" = _bs389u0b;
        "pkg-1.19.4-1.10.2.0" = _IIfDwnOJ;
        "pkg-1.19.2-1.8.4.0" = _ZLfjRSXo;
        "pkg-1.20.2-2.2.0.0" = _Y3UJMjEa;
        "pkg-1.20.1-2.1.1.1" = _7e0XyHh2;
        "pkg-1.20.2-2.2.0.1" = _25ZZfYOE;
        "pkg-1.20.1-2.1.1.2" = _sve8L3xE;
        "pkg-1.20.2-2.2.0.2" = _xIEh5woN;
        "pkg-1.20.2-2.2.0.3" = _NJcxyBSK;
        "pkg-1.20.1-2.1.1.3" = _WCi2mj7z;
        "pkg-1.20.4-3.0.0.0" = _tTiAaeqo;
        "pkg-1.20.4-3.1.0.0" = _fMtFRk1p;
        "pkg-1.20.4-3.1.0.1" = _STtonE6I;
        "pkg-1.20.4-3.1.1.0" = _FTVy7bNv;
        "pkg-1.20.4-3.1.2.0" = _husUYIuE;
        "pkg-1.20.6-3.2.0.0" = _N63AdeLW;
        "pkg-1.20.4-3.1.2.1" = _sw7L0HSh;
        "pkg-1.21-4.0.0.0" = _AV6FhsnU;
        "pkg-1.21-4.1.0.0" = _NtHOLaA8;
        "pkg-1.21-4.1.0.1" = _ksNmietu;
        "pkg-1.21-4.1.1.0" = _gwLYV7kX;
        "pkg-1.21.1-4.2.0.0" = _rBWW0jdO;
        "pkg-1.20.1-2.1.2.0" = _4d6Cgkny;
        "pkg-1.21.3-4.3.0.0" = _bmi5khjU;
        "pkg-1.21.4-4.4.0.0" = _tQusauvF;
        "pkg-1.21.5-4.5.0.0" = _rxczcDZB;
        "pkg-1.21.6-4.6.0.0" = _TOKglBLP;
        "pkg-1.21.6-4.6.1.0" = _d9DXzqYP;
        "pkg-1.21.7-4.7.0.0" = _IGdaaQRq;
        "pkg-1.21.4-4.4.1.0" = _Ml8XN7ut;
        "pkg-1.21.5-4.5.1.0" = _vtivKAGr;
        "pkg-1.21.9-4.8.0.0" = _CKgpWlBa;
        "pkg-1.21.10-4.9.0.0" = _rKei9MWX;
        "pkg-1.21.1-4.2.1.0" = _QQeBRsPL;
        "pkg-1.21.3-4.3.1.0" = _jNQ6hyq2;
        "pkg-1.21.4-4.4.2.0" = _uyWcFMTI;
        "pkg-1.21.5-4.5.2.0" = _79JrMtoR;
        "pkg-1.21.7-4.7.1.0" = _sU1UgUwT;
        "pkg-1.21.10-4.9.1.0" = _KFn9nmh2;
        "pkg-1.21.10-4.9.2.0" = _pp6GfsG5;
        "pkg-1.21.11-4.10.0.0" = _TEokUyDO;
        "pkg-26.1.1-5.0.0.0" = _mDs1svVc;
        "pkg-26.1.1-5.0.0.1" = _xRJE5FsY;
        "pkg-26.1.1-5.0.0.2" = _2DiMS6Jx;
