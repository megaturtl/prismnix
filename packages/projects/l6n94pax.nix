...
let
    ...
    in {
        ...
        "pkg-forge-1.19-1.0.3" = _aazBoPfX;
        "pkg-forge-1.19.1-1.0.0" = _ftymE4tl;
        "pkg-forge-1.19.2-1.0.0" = _lbLs35pJ;
        "pkg-forge-1.19.3-1.0.0" = _5ELUI14V;
        "pkg-forge-1.19.3-1.0.1" = _8ThPs097;
        "pkg-forge-1.19.4-1.0.1" = _ZUpebxft;
        "pkg-forge-1.20-1.0.1" = _QOH8q9fg;
        "pkg-forge-1.20.1-1.0.1" = _O7zXIIWN;
        "pkg-forge-1.20.2-1.0.1" = _pSD9myPW;
        "pkg-neoforge-1.20.2-1.0.1" = _c27bYnDs;
        "pkg-neoforge-1.20.2-1.0.2" = _5MisSZAy;
        "pkg-neoforge-1.20.3-1.0.2" = _1s2sZvhw;
        "pkg-neoforge-1.20.4-1.0.2" = _dxbfZKuF;
        "pkg-forge-1.19.2-1.0.3" = _LPu8txJj;
        "pkg-forge-1.20.1-1.0.3" = _QxqL3cXW;
        "pkg-neoforge-1.20.4-1.0.3" = _yAaChpGB;
        "pkg-neoforge-1.20.4-1.0.4" = _kW6R7bcM;
        "pkg-forge-1.19.2-1.0.5" = _PWAoEKks;
        "pkg-forge-1.20.1-1.0.5" = _GGw0SvX6;
        "pkg-neoforge-1.20.4-1.0.5" = _I1tT3mn8;
        "pkg-neoforge-1.20.5-1.0.5" = _uvesXPsY;
        "pkg-neoforge-1.20.6-1.0.5" = _NoK3w8TJ;
        "pkg-neoforge-1.20.6-1.0.6" = _IFcx8nHi;
        "pkg-neoforge-1.20.6-1.0.7" = _fK9pXR06;
        "pkg-neoforge-1.21-1.0.7" = _BZ5y37BX;
        "pkg-neoforge-1.21-1.0.8" = _wNyRCKr3;
        "pkg-forge-1.19.2-1.0.9" = _zqyQKWas;
        "pkg-forge-1.20.1-1.0.9" = _Cy0lLT00;
        "pkg-neoforge-1.21-1.0.9" = _oQUAqPpq;
        "pkg-neoforge-1.21.1-1.0.9" = _a1uixjWQ;
        "pkg-forge-1.19.2-1.0.10" = _IAJs7LOm;
        "pkg-forge-1.20.1-1.0.10" = _ynSdlyG3;
        "pkg-neoforge-1.21.1-1.0.10" = _ALp0uvxD;
        "pkg-forge-1.19.2-1.0.11" = _Hkfm2BkH;
        "pkg-forge-1.20.1-1.0.11" = _gpz5nlqC;
        "pkg-neoforge-1.21.1-1.0.11" = _WLEk38tV;
        "pkg-neoforge-1.21.1-1.0.12" = _q1Hj1XAQ;
        "pkg-forge-1.19.2-1.0.13" = _erNoK6yU;
        "pkg-forge-1.20.1-1.0.13" = _21pm2SWu;
        "pkg-neoforge-1.21.1-1.0.13" = _9ACAMVvL;
        "pkg-neoforge-1.21.2-1.0.13" = _59WdR1re;
        "pkg-neoforge-1.21.3-1.0.13" = _cNXr39M3;
        "pkg-neoforge-1.21.4-1.0.13" = _bCrIMyt0;
        "pkg-neoforge-1.21.1-1.0.14" = _ud6gz0mh;
        "pkg-neoforge-1.21.4-1.0.14" = _U1beLtbq;
        "pkg-forge-1.20.1-1.1.0" = _uMQU4g6f;
        "pkg-neoforge-1.21.1-1.1.0" = _C0ZG4QHo;
        "pkg-neoforge-1.21.4-1.1.0" = _KUBYXljG;
        "pkg-neoforge-1.21.5-1.1.0" = _5Mv5Mhdj;
        "pkg-neoforge-1.21.4-1.1.1" = _XDdfObQF;
        "pkg-neoforge-1.21.5-1.1.1" = _IxJmEH59;
        "pkg-neoforge-1.21.6-1.1.1" = _nC5ZVEKK;
        "pkg-neoforge-1.21.6-1.1.2" = _tuIRgCFn;
        "pkg-neoforge-1.21.6-1.1.3" = _ynG87fsy;
        "pkg-neoforge-1.21.7-1.1.3" = _cfpYk3Cl;
        "pkg-neoforge-1.21.7-1.1.4" = _Kpw49C7i;
        "pkg-neoforge-1.21.8-1.1.4" = _AEYQY9aD;
        "pkg-neoforge-1.21.9-1.1.4" = _h31sFalA;
        "pkg-neoforge-1.21.9-1.1.5" = _AVEPG6HF;
        "pkg-neoforge-1.21.10-1.1.5" = _HWl7zHOx;
        "pkg-neoforge-1.21.10-1.1.6" = _6VjVb2EQ;
        "pkg-neoforge-1.21.10-1.1.7" = _aaDa19Es;
        "pkg-neoforge-1.21.11-1.1.7" = _3oXQxP6b;
        "pkg-neoforge-1.1.7+26.1" = _bdjHlmWD;
