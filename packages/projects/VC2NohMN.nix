...
let
    versions = (let
        ...
        _NLV8VOf4 = {
            "id" = "NLV8VOf4";
            "file" = "chesttracker-2.8.4+26.2.jar";
            "hash" = "sha512-ha84amJdoudEgJfLOPlGn0Q3W5GLVn58osDUAj8l8kTty06eI1wYcSxn5gD5pWETPKDe3qThOpx45UFlGDM8fQ==";
        };
        _9dKA1FrM = {
            "id" = "9dKA1FrM";
            "file" = "chesttracker-2.8.4+26.1.2.jar";
            "hash" = "sha512-borW0g1FrdUuPvW9iw+3H8UI+19kKO55Eg1mDwoHvYdo/RkXRKaPf6b68FTlvRvFwf9WKNFK9q7mme5ca3CN2Q==";
        };
        _efuwPABu = {
            "id" = "efuwPABu";
            "file" = "chesttracker-2.8.4+26.1.1.jar";
            "hash" = "sha512-Wj4D/JoR+spRxow0WkJSgPrd4f/Y9FNdzaKDluteedffewH2ha6dIZKLQqOt1kXaU/nbhZEIqO0FLB/ClHxPFw==";
        };
        _bjF3QdMU = {
            "id" = "bjF3QdMU";
            "file" = "chesttracker-2.8.4+26.1.jar";
            "hash" = "sha512-bf5af0lXh6SKCP0cOb45iJ1ekevr+2Tk2BWtuvmsqcr90VnfmRHkk+jDVx249Q8Kp/HcEUPDqY7Mz6jp0ft6LA==";
        };
        _T13R6ERF = {
            "id" = "T13R6ERF";
            "file" = "chesttracker-2.8.4+1.21.11.jar";
            "hash" = "sha512-dqaBfWGYqIh/Bs6XCZj/oVDcUan1qjVygyGr2V2pvms5SSK08zA7SFYHcKIZXfsjp61NpzVCNQ/c+rwu1sbX3g==";
        };
        _RV0Bdfdk = {
            "id" = "RV0Bdfdk";
            "file" = "chesttracker-2.8.4+1.21.10.jar";
            "hash" = "sha512-ytsMzKlbPhk1OMgT3Yj8EK8e2g7tK0QAGP0R8URViDFmljZ8qu9qdGGm4LBkP062xbhj/EUVUU/Ch8OW/Aegwg==";
        };
        _F7uRxSZe = {
            "id" = "F7uRxSZe";
            "file" = "chesttracker-2.8.4+1.21.9.jar";
            "hash" = "sha512-+rjGuXgEAudDtCaD0T211zoL81yK6S7M8jkH4qp4ZEqyhaVf4pPkg0P6WAdo4emW1cqstHpGCa1BltJburU8ww==";
        };
        _AsyZPOZ3 = {
            "id" = "AsyZPOZ3";
            "file" = "chesttracker-2.8.4+1.21.8.jar";
            "hash" = "sha512-cFel3daC7r1arn7aC6wZ2OvjXi+R7Wk/JilNUrxPMymhak8zvTNlNz6/JTWE4/d+d+1izFkUIs62tJrsb1MBFg==";
        };
        _TLyLPcAV = {
            "id" = "TLyLPcAV";
            "file" = "chesttracker-2.8.4+1.21.7.jar";
            "hash" = "sha512-fDSFL/iZ+DUcRrph2wlPpLOmvu4csaZ+9B0Vdv4X751CNPokJDuUjKJof7oclXrJqb4EEy6t1j/HRJjKif93xA==";
        };
        _ogzAlTI9 = {
            "id" = "ogzAlTI9";
            "file" = "chesttracker-2.8.4+1.21.6.jar";
            "hash" = "sha512-NLvjc42nEzU7RsDM2OAjBg9eLTbZKjLLfjb8D/FJvxQ8xAbB8yCBUuTjoIGDiDHJ2+IWSCpsMl0TVxRSnlDjcQ==";
        };
        _GHirfxCu = {
            "id" = "GHirfxCu";
            "file" = "chesttracker-2.8.4+1.21.5.jar";
            "hash" = "sha512-SdSG3nDkD6QupixDsHwUo6Z831qtAgK9slPNeod6x0r99T0b9QqXB8w8O3QMmqvx1KE4mT4/OUZrBU245ZbiPw==";
        };
        _ssXjUimP = {
            "id" = "ssXjUimP";
            "file" = "chesttracker-2.8.4.1+1.21.9.jar";
            "hash" = "sha512-4jhDjebY533CDhe0Syw+Uhg5MBaJ1Jm1PfQD9k8Dpv0XfYL/hhoM/wGTcQ6kv0fgedomNmsKenQVo7CkVTuyew==";
        };
        _1BYj4oLk = {
            "id" = "1BYj4oLk";
    ...
    in {
        ...
        "fabric-1.21.7" = _TLyLPcAV;
        "fabric-1.21.8" = _AsyZPOZ3;
        "fabric-1.21.11" = _T13R6ERF;
        "fabric-26.1" = _bjF3QdMU;
        "fabric-26.1.1" = _efuwPABu;
        ...
        "quilt-1.21.7" = _TLyLPcAV;
        "quilt-1.21.8" = _AsyZPOZ3;
        "quilt-1.21.11" = _T13R6ERF;
        "quilt-26.1" = _bjF3QdMU;
        "quilt-26.1.1" = _efuwPABu;
        ...
        "pkg-2.7.0+1.21.9" = _IOUZpTXO;
        "pkg-2.7.0+1.21.10" = _W3hojNrg;
        "pkg-2.7.1+1.21.9" = _3zXDy1Rr;
        "pkg-2.7.1+1.21.10" = _tYmC1s8O;
        "pkg-2.7.2+1.21.9" = _zUFKnn8I;
        "pkg-2.7.2+1.21.10" = _tos02Zih;
        "pkg-2.7.2+1.21.6" = _1NSwWmG9;
        "pkg-2.7.2+1.21.7" = _q785oe0r;
        "pkg-2.7.2+1.21.8" = _cQ0c4iQo;
        "pkg-2.7.3+1.21.9" = _oWJPEL4A;
        "pkg-2.7.3+1.21.10" = _E8JbPaM8;
        "pkg-2.7.3+1.21.8" = _mSjj1q6U;
        "pkg-2.7.3+1.21.7" = _yhh1fMeq;
        "pkg-2.7.3+1.21.6" = _vPgmSyhB;
        "pkg-2.7.3+1.21.11" = _GaCz3H5X;
        "pkg-2.7.4+1.21.11" = _LXQ8AoXX;
        "pkg-2.7.4+1.21.10" = _pB9pKetI;
        "pkg-2.7.4+1.21.8" = _1nK5HMmn;
        "pkg-2.7.4+1.21.7" = _BkmsKcCn;
        "pkg-2.7.4+1.21.9" = _QcL17l7v;
        "pkg-2.7.4+1.21.6" = _tRP6dWT4;
        "pkg-2.7.5+1.21.6" = _PahJdbRf;
        "pkg-2.7.5+1.21.8" = _uggJ76VG;
        "pkg-2.7.5+1.21.7" = _qhWVsCrB;
        "pkg-2.7.5+1.21.10" = _bHQYtETR;
        "pkg-2.7.5+1.21.9" = _DWDnuIQQ;
        "pkg-2.7.5+1.21.11" = _ZHFpqXC9;
        "pkg-2.7.6+1.21.11" = _1mm1MBWf;
        "pkg-2.7.6+1.21.7" = _raRahVkj;
        "pkg-2.7.6+1.21.8" = _hRoQU4aL;
        "pkg-2.7.6+1.21.10" = _HF1bcxvX;
        "pkg-2.7.6+1.21.9" = _drNp9SHS;
        "pkg-2.7.6+1.21.6" = _QVwqarws;
        "pkg-2.7.7+1.21.11" = _uC064NFC;
        "pkg-2.7.7.1+1.21.11" = _kUbVhoHp;
        "pkg-2.7.7+1.21.6" = _61weoEAS;
        "pkg-2.7.7+1.21.10" = _HZw311Dy;
        "pkg-2.7.7+1.21.7" = _9ySzO5zA;
        "pkg-2.7.7+1.21.8" = _by0zhSRB;
        "pkg-2.7.8+1.21.7" = _fwMtfQm8;
        "pkg-2.7.8+1.21.6" = _F88Kkn3k;
        "pkg-2.7.8+1.21.8" = _yMDYh3IX;
        "pkg-2.7.8+1.21.9" = _qD5fI0YB;
        "pkg-2.7.8+1.21.10" = _UxqGb4ZJ;
        "pkg-2.7.8+1.21.11" = _X0YPLMfh;
        "pkg-2.7.9+1.21.7" = _mqxh2ZqC;
        "pkg-2.7.9+1.21.8" = _XwxBCTCj;
        "pkg-2.7.9+1.21.6" = _pQ92ZGG0;
        "pkg-2.7.9+1.21.10" = _zZf9yCex;
        "pkg-2.7.9+1.21.9" = _hXzlamjP;
        "pkg-2.7.9+1.21.11" = _jFCqRmEC;
        "pkg-2.7.9.1+1.21.7" = _lwuarhRg;
        "pkg-2.7.9.1+1.21.6" = _Ptq7uXw9;
        "pkg-2.7.9.1+1.21.9" = _KRva8phc;
        "pkg-2.7.9.1+1.21.10" = _RzwiN13Y;
        "pkg-2.7.9.1+1.21.8" = _9IDHlOj7;
        "pkg-2.7.9.1+1.21.11" = _R3RkqLyi;
        "pkg-2.8.0+1.21.6" = _bEnr0F20;
        "pkg-2.8.0+1.21.7" = _7drukXdb;
        "pkg-2.8.0+1.21.8" = _IlIvsPz6;
        "pkg-2.8.0+1.21.10" = _wrA8t226;
        "pkg-2.8.0+1.21.9" = _psxitHaC;
        "pkg-2.8.0+1.21.11" = _GbEHA9kb;
        "pkg-2.8.1+1.21.6" = _A4P9Tgmv;
        "pkg-2.8.1+1.21.7" = _4kL9PmiP;
        "pkg-2.8.1+1.21.8" = _icVrS0YY;
        "pkg-2.8.1+1.21.9" = _UkCvmvxK;
        "pkg-2.8.1+1.21.10" = _tNLq0hBx;
        "pkg-2.8.1+1.21.11" = _xsPqTMMp;
        "pkg-2.8.1-beta.1+26.1" = _t2CsUx6V;
        "pkg-2.8.1-beta.2+26.1" = _cT0fkRn7;
        "pkg-2.8.1-beta.3+26.1" = _ZW3QizO8;
        "pkg-2.8.1-beta.4+26.1" = _gW0MOMjL;
        "pkg-2.8.1-beta.5+26.1" = _5oOrQf0M;
        "pkg-2.8.1-beta.6+26.1" = _mi6U0Iy8;
        "pkg-2.8.1+26.1" = _v8E3D3sh;
        "pkg-2.8.1+26.1.1" = _H6BIi4UC;
        "pkg-2.8.1+26.1.2" = _YeYh4O8V;
        "pkg-2.8.2+1.21.7" = _Fj475FAX;
        "pkg-2.8.2+1.21.6" = _CQXG972L;
        "pkg-2.8.2+1.21.8" = _KirIWr7k;
        "pkg-2.8.2+1.21.10" = _aL8p7PbC;
        "pkg-2.8.2+26.1.1" = _ZJwci7By;
        "pkg-2.8.2+26.1.2" = _lvWERJSp;
        "pkg-2.8.2+26.1" = _KvE8RE46;
        "pkg-2.8.2+1.21.9" = _JSntfPyd;
        "pkg-2.8.2+1.21.11" = _hEXSeGRB;
        "pkg-2.8.2+1.21.5" = _e7RPROTR;
        "pkg-2.8.2.1+1.21.5" = _CruVvZAV;
        "pkg-2.8.2+26.2" = _KZGmUqXx;
        "pkg-2.8.3+26.2" = _cwtdCpdg;
        "pkg-2.8.3+26.1.2" = _R3ks7YVg;
        "pkg-2.8.3+26.1" = _XlHBT3Ma;
        "pkg-2.8.3+26.1.1" = _lXIPel48;
        "pkg-2.8.3+1.21.11" = _2DCI28rp;
        "pkg-2.8.3+1.21.10" = _u0I8Wx7a;
        "pkg-2.8.3+1.21.9" = _lRRM0c5R;
        "pkg-2.8.3+1.21.8" = _TrJAht5u;
        "pkg-2.8.3+1.21.6" = _cxGWwgQ6;
        "pkg-2.8.3+1.21.7" = _aJOSw6xa;
        "pkg-2.8.3+1.21.5" = _KZd3JbtC;
        "pkg-2.8.4+26.2" = _NLV8VOf4;
        "pkg-2.8.4+26.1.2" = _9dKA1FrM;
        "pkg-2.8.4+26.1.1" = _efuwPABu;
        "pkg-2.8.4+26.1" = _bjF3QdMU;
        "pkg-2.8.4+1.21.11" = _T13R6ERF;
        "pkg-2.8.4+1.21.10" = _RV0Bdfdk;
        "pkg-2.8.4+1.21.9" = _F7uRxSZe;
        "pkg-2.8.4+1.21.8" = _AsyZPOZ3;
        "pkg-2.8.4+1.21.7" = _TLyLPcAV;
        "pkg-2.8.4+1.21.6" = _ogzAlTI9;
