...
let
    ...
    in {
        ...
        "pkg-1.6.1" = _Gf8UFQqQ;
        "pkg-1.6.2" = _D7xAHMeQ;
        "pkg-1.6.3-1.21.5" = _8bPmD4BQ;
        "pkg-1.6.3-1.21.8" = _VA9wT4Rg;
        "pkg-1.6.4-1.21.5" = _7B7vWC31;
        "pkg-1.6.4-1.21.8" = _F4Pc2Hdd;
        "pkg-1.6.5-1.21.5" = _mZ243zlR;
        "pkg-1.6.5-1.21.8" = _pRewMLwh;
        "pkg-1.7.0-1.21.5" = _rFcoIc6v;
        "pkg-1.7.0-1.21.8" = _S9XE4323;
        "pkg-1.7.0-1.21.10" = _IhDtuF1G;
        "pkg-1.8.0-1.21.5" = _InydHRfi;
        "pkg-1.8.0-1.21.8" = _zeFoLMPH;
        "pkg-1.8.0-1.21.10" = _t000mtX3;
        "pkg-1.8.0-1.21.11" = _YWMAzRhq;
        "pkg-1.8.1-1.21.5" = _rNVb9qsz;
        "pkg-1.8.1-1.21.8" = _o5bgstXz;
        "pkg-1.8.1-1.21.10" = _NlailQnE;
