...
let
    ...
    in {
        ...
        "pkg-12.1.0+forge-1.19" = _CkOmU2px;
        "pkg-13.0.0+forge-1.19.3" = _PbVnbuZd;
        "pkg-13.0.0+fabric-1.19.3" = _eQivMJ4i;
        "pkg-11.1.1+forge-1.18.2" = _BuRhOSU8;
        "pkg-11.1.1+fabric-1.18.2" = _62j7kBOm;
        "pkg-13.1.0+forge-1.19.3" = _2LDlr3Z5;
        "pkg-13.1.0+fabric-1.19.3" = _tj4RAnZh;
        "pkg-12.2.0+forge-1.19.2" = _P4tKBfWR;
        "pkg-14.0.1+forge-1.19.4" = _EiJet1Qc;
        "pkg-14.0.1+fabric-1.19.4" = _d18OwGMc;
        "pkg-12.2.0+fabric-1.19.2" = _kSr51rv5;
        "pkg-14.1.0+forge-1.19.4" = _6yAZ3bYn;
        "pkg-12.3.0+forge-1.19.2" = _OabgLyDQ;
        "pkg-14.1.0+fabric-1.19.4" = _apMMRpdH;
        "pkg-12.3.0+fabric-1.19.2" = _McrMZkIV;
        "pkg-15.0.0+fabric-1.20" = _IDj7kzhS;
        "pkg-15.0.0+forge-1.20" = _aG4T8pjo;
        "pkg-16.0.0+fabric-1.20.2" = _XEBQ0HGG;
        "pkg-16.0.0+forge-1.20.2" = _JjB5MNWT;
        "pkg-16.0.0+neoforge-1.20.2" = _IguQzFBx;
        "pkg-16.0.1+fabric-1.20.4" = _kBG7QKqK;
        "pkg-16.0.1+forge-1.20.4" = _ykFDMSjv;
        "pkg-16.0.1+neoforge-1.20.4" = _x1PacTKm;
        "pkg-17.0.1+fabric-1.20.6" = _juNXPnmD;
        "pkg-17.0.1+forge-1.20.6" = _JkMPkNLC;
        "pkg-17.0.1+neoforge-1.20.6" = _biTZRuOm;
        "pkg-21.0.1+fabric-1.21" = _K6GybE8F;
        "pkg-21.0.1+forge-1.21" = _MAAvzENj;
        "pkg-21.0.1+neoforge-1.21" = _bTi5CY4k;
        "pkg-21.0.2+fabric-1.21" = _6tkyI4EE;
        "pkg-21.0.2+forge-1.21" = _K5M9YcP1;
        "pkg-21.0.2+neoforge-1.21" = _S62fstbE;
        "pkg-21.1.1+fabric-1.21.1" = _WYBC52ih;
        "pkg-21.1.1+forge-1.21.1" = _f1fwONZW;
        "pkg-21.1.1+neoforge-1.21.1" = _dUwXic1a;
        "pkg-21.3.1+fabric-1.21.3" = _AxJWbY3b;
        "pkg-21.3.1+neoforge-1.21.3" = _WI73THLQ;
        "pkg-21.4.1+fabric-1.21.4" = _jrxh1gyu;
        "pkg-21.4.1+neoforge-1.21.4" = _x9fJOK71;
        "pkg-21.4.2+fabric-1.21.4" = _1L26egEl;
        "pkg-21.4.2+neoforge-1.21.4" = _T0d8iYsB;
        "pkg-21.1.2+fabric-1.21.1" = _SFvgBc8h;
        "pkg-21.1.2+neoforge-1.21.1" = _8qULbyfZ;
        "pkg-21.1.2+forge-1.21.1" = _HMaDdI3r;
        "pkg-15.0.1+fabric-1.20" = _psPC55XX;
        "pkg-21.4.3+fabric-1.21.4" = _cmFWfGaR;
        "pkg-15.0.1+forge-1.20" = _u5h49oN1;
        "pkg-21.4.3+neoforge-1.21.4" = _p2wUnnws;
        "pkg-21.4.4+forge-1.21.4" = _JTI5f5cq;
        "pkg-15.0.2+fabric-1.20" = _AY1QAuBz;
        "pkg-15.0.2+forge-1.20" = _jkN1BGEf;
        "pkg-15.0.3+fabric-1.20" = _8pN64CgN;
        "pkg-15.0.3+forge-1.20" = _Hg91m3li;
        "pkg-15.0.4+fabric-1.20" = _uvZ7fLIP;
        "pkg-15.0.4+forge-1.20" = _4tL7nJgr;
        "pkg-21.1.3+fabric-1.21.1" = _aDdRBVZt;
        "pkg-21.1.3+forge-1.21.1" = _A2i2Ke9G;
        "pkg-21.1.3+neoforge-1.21.1" = _EGYINnqo;
        "pkg-15.0.5+fabric-1.20" = _OCvteqQl;
        "pkg-21.1.4+fabric-1.21.1" = _8r7UMcCz;
        "pkg-21.4.5+fabric-1.21.4" = _kmg19jRW;
        "pkg-21.4.5+forge-1.21.4" = _CCBLkvhe;
        "pkg-21.4.5+neoforge-1.21.4" = _JHHOiPFZ;
        "pkg-15.0.6+fabric-1.20.1" = _Tp7hsj6X;
        "pkg-15.0.6+forge-1.20.1" = _rJQ8kReC;
        "pkg-21.5.1+fabric-1.21.5" = _GTkzTHuw;
        "pkg-21.5.1+neoforge-1.21.5" = _yYeEMXxy;
        "pkg-21.5.2+forge-1.21.5" = _4mdATOeU;
        "pkg-21.6.1+fabric-1.21.6" = _ro0mXZeP;
        "pkg-21.6.1+neoforge-1.21.6" = _Sn0eR0Dm;
        "pkg-21.6.2+forge-1.21.6" = _f3Pbzmdm;
        "pkg-21.7.1+forge-1.21.7" = _xChkreFH;
        "pkg-21.7.1+neoforge-1.21.7" = _SJQPW7EN;
        "pkg-21.7.1+fabric-1.21.7" = _2UNKtrHZ;
        "pkg-15.0.7+fabric-1.20.1" = _VkZV1H1V;
        "pkg-21.1.5+fabric-1.21.1" = _BUwgroHL;
        "pkg-15.0.7+forge-1.20.1" = _kcpvBoLg;
        "pkg-21.7.2+fabric-1.21.7" = _zacm91dR;
        "pkg-21.1.5+forge-1.21.1" = _DfUKu20R;
        "pkg-21.1.5+neoforge-1.21.1" = _870XSm10;
        "pkg-21.7.2+forge-1.21.7" = _Na7Yc4nh;
        "pkg-21.7.2+neoforge-1.21.7" = _m7XSpJKK;
        "pkg-21.1.6+fabric-1.21.1" = _bcyjQVo8;
        "pkg-15.0.8+fabric-1.20.1" = _Ji0X9sqn;
        "pkg-21.1.6+neoforge-1.21.1" = _l8YDW33r;
        "pkg-21.1.6+forge-1.21.1" = _DKW99Ma8;
        "pkg-15.0.8+forge-1.20.1" = _u0OuPBOa;
        "pkg-21.8.1+forge-1.21.8" = _8yaxsuO9;
        "pkg-21.8.1+fabric-1.21.8" = _VzuAv5q8;
        "pkg-21.8.1+neoforge-1.21.8" = _sXYLXlFu;
        "pkg-15.0.9+forge-1.20.1" = _wIceOdyy;
        "pkg-21.1.7+fabric-1.21.1" = _Juc7czPw;
        "pkg-21.1.7+neoforge-1.21.1" = _lttOPq3Q;
        "pkg-21.1.7+forge-1.21.1" = _aw4x4Ts9;
        "pkg-21.8.2+fabric-1.21.8" = _c8utu73H;
        "pkg-21.8.2+neoforge-1.21.8" = _MZaUovAa;
        "pkg-21.8.2+forge-1.21.8" = _A7Hr8Rxs;
        "pkg-15.0.9+fabric-1.20.1" = _Jf6iHGAG;
        "pkg-21.9.1+fabric-1.21.9" = _gUn51xGk;
        "pkg-21.9.1+neoforge-1.21.9" = _MmAQ6gwm;
        "pkg-21.10.1+fabric-1.21.10" = _lhBAd9VY;
        "pkg-21.10.1+neoforge-1.21.10" = _pUxnJsqA;
        "pkg-21.10.1+forge-1.21.10" = _jgxsfVBd;
        "pkg-21.10.2+fabric-1.21.10" = _zEJaI9ga;
        "pkg-21.10.2+forge-1.21.10" = _4E0wo79m;
        "pkg-21.10.2+neoforge-1.21.10" = _EAZUSAdz;
        "pkg-21.11.1+neoforge-1.21.11" = _GZUuhLzK;
        "pkg-21.11.1+fabric-1.21.11" = _8TCgBqfa;
        "pkg-21.11.3+fabric-1.21.11" = _LArQWMkb;
        "pkg-21.11.3+forge-1.21.11" = _QQsf31mn;
        "pkg-21.11.3+neoforge-1.21.11" = _PI5CnL0i;
        "pkg-21.1.8+neoforge-1.21.1" = _K0ieWPNK;
        "pkg-21.1.8+fabric-1.21.1" = _340fkzoZ;
        "pkg-21.1.8+forge-1.21.1" = _FUg80pbv;
        "pkg-15.0.10+forge-1.20.1" = _NymiKOlG;
        "pkg-15.0.10+fabric-1.20.1" = _aoYbRu2H;
        "pkg-15.0.11+fabric-1.20.1" = _1YXIqq8Y;
        "pkg-15.0.11+forge-1.20.1" = _4lMjEx47;
        "pkg-21.1.9+fabric-1.21.1" = _apu5lcwE;
        "pkg-21.1.9+neoforge-1.21.1" = _OJhWT28x;
        "pkg-21.1.9+forge-1.21.1" = _4oNHaB4V;
        "pkg-26.1.0.1+fabric-26.1" = _E0bAQxK1;
        "pkg-26.1.0.1+neoforge-26.1" = _qy3qkejn;
        "pkg-21.1.10+fabric-1.21.1" = _bfFOubFC;
        "pkg-21.1.10+neoforge-1.21.1" = _GNASFQTj;
        "pkg-21.1.10+forge-1.21.1" = _NGZX0VAK;
        "pkg-15.0.12+fabric-1.20.1" = _usDZdV9f;
        "pkg-15.0.12+forge-1.20.1" = _oEVhOfUM;
        "pkg-21.1.11+fabric-1.21.1" = _iZpfTrGy;
        "pkg-21.1.11+neoforge-1.21.1" = _p2xTwdDd;
