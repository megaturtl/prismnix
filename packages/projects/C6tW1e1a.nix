...
let
    versions = (let
        ...
        _L9TYn2qC = {
            "id" = "L9TYn2qC";
            "file" = "Sky's Title Screen.zip";
            "hash" = "sha512-bxXsXVnXFtWztwsoaC8AKp3Ry0i4o0f9S8QM9Ww5BsJys5Wz7nS2vS/VoOmARC6tvVnwj1U2xDtijd3x0A5LfA==";
        };
        _dJrQRoiX = {
            "id" = "dJrQRoiX";
            "file" = "Sky's Title Screen - NoKeyArt.zip";
            "hash" = "sha512-4v3eK7q05bIehvc9OxpadjVUpBLRL7iEO+BMuTKwi/9o6t1TDaDgAN/xDW5t3tB4PUchyUm8Lj1aujfpGaOcnw==";
        };
        _Rxug8hnW = {
            "id" = "Rxug8hnW";
            "file" = "Archive.zip";
            "hash" = "sha512-eK5blyj8538hNgYBW8ouvkKN7JnRdeDUc23AJob5ZoQIzx21XUEjKhAW9J/JLlxtY8+olC6tN8zbNipcN/94XQ==";
        };
        _R22alFb9 = {
            "id" = "R22alFb9";
            "file" = "Archive.zip";
            "hash" = "sha512-fIit3IZPTj9+bI/h10d6UOA7xISeQ17BQYp0JBPNzbMgsmkTPH2zJ9p3NSCXOu6ON5BSaQLjYyO3to3uKFnZxg==";
        };
    in {
        "ihLDDupx" = _ihLDDupx;
        "65OINlKg" = _65OINlKg;
        ...
        "Rxug8hnW" = _Rxug8hnW;
        "R22alFb9" = _R22alFb9;
        "minecraft-1.20" = _R22alFb9;
        "minecraft-1.20.1" = _R22alFb9;
        "minecraft-1.20.2" = _R22alFb9;
        "minecraft-1.20.3" = _R22alFb9;
        "minecraft-1.20.4" = _R22alFb9;
        "minecraft-1.20.5" = _R22alFb9;
        "minecraft-1.20.6" = _R22alFb9;
        "minecraft-1.21" = _R22alFb9;
        "minecraft-1.21.1" = _R22alFb9;
        "minecraft-1.21.2" = _R22alFb9;
        "minecraft-1.21.3" = _R22alFb9;
        "minecraft-1.21.4" = _R22alFb9;
        "minecraft-1.21.5" = _R22alFb9;
        "minecraft-1.21.6" = _R22alFb9;
        "minecraft-1.21.7" = _R22alFb9;
        "minecraft-1.21.8" = _R22alFb9;
        "minecraft-1.21.9" = _R22alFb9;
        "minecraft-1.21.10" = _R22alFb9;
        "minecraft-1.21.11" = _R22alFb9;
        "minecraft-26.1" = _R22alFb9;
        "minecraft-26.1.1" = _R22alFb9;
        "minecraft-26.1.2" = _R22alFb9;
        "minecraft-26.2" = _R22alFb9;
        "minecraft-26.3" = _R22alFb9;
        "pkg-2.0" = _ihLDDupx;
        "pkg-3.0" = _65OINlKg;
        "pkg-4.0" = _3ZhssJC6;
        "pkg-4.01" = _nB7hWE0P;
