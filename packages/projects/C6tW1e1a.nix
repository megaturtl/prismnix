...
let
    ...
    in {
        ...
        "L9TYn2qC" = _L9TYn2qC;
        "dJrQRoiX" = _dJrQRoiX;
        "minecraft-1.20" = _dJrQRoiX;
        "minecraft-1.20.1" = _dJrQRoiX;
        "minecraft-1.20.2" = _dJrQRoiX;
        "minecraft-1.20.3" = _dJrQRoiX;
        "minecraft-1.20.4" = _dJrQRoiX;
        "minecraft-1.20.5" = _dJrQRoiX;
        "minecraft-1.20.6" = _dJrQRoiX;
        "minecraft-1.21" = _dJrQRoiX;
        "minecraft-1.21.1" = _dJrQRoiX;
        "minecraft-1.21.2" = _dJrQRoiX;
        "minecraft-1.21.3" = _dJrQRoiX;
        "minecraft-1.21.4" = _dJrQRoiX;
        "minecraft-1.21.5" = _dJrQRoiX;
        "minecraft-1.21.6" = _dJrQRoiX;
        "minecraft-1.21.7" = _dJrQRoiX;
        "minecraft-1.21.8" = _dJrQRoiX;
        "minecraft-1.21.9" = _dJrQRoiX;
        "minecraft-1.21.10" = _dJrQRoiX;
        "minecraft-1.21.11" = _dJrQRoiX;
        "minecraft-26.1" = _dJrQRoiX;
        "minecraft-26.1.1" = _dJrQRoiX;
        "minecraft-26.1.2" = _dJrQRoiX;
        "minecraft-26.2" = _dJrQRoiX;
        "pkg-2.0" = _ihLDDupx;
        "pkg-3.0" = _65OINlKg;
        "pkg-4.0" = _3ZhssJC6;
        "pkg-4.01" = _nB7hWE0P;
