...
let
    ...
    in {
        ...
        "pkg-1.20.2-10.1.0" = _fisohsCx;
        "pkg-1.20.1-10.1.0" = _21ttPJiN;
        "pkg-1.20.2-11.0.0" = _rAjGaG5l;
        "pkg-1.20.1-10.1.1" = _eFEvZmn0;
        "pkg-1.20.2-12.0.0" = _VLaLcyHS;
        "pkg-1.20.2-12.1.0" = _5VfsBLK0;
        "pkg-1.20.2-12.2.0" = _KHNvtCV7;
        "pkg-1.20.2-12.2.1" = _kislRt37;
        "pkg-1.20.4-14.0.0" = _HdHfwad8;
        "pkg-1.20.4-14.1.0" = _mPqv12J5;
        "pkg-1.20.1-10.2.0" = _JpixTBq4;
        "pkg-1.19.2-9.2.0" = _ggzA7RdR;
        "pkg-1.20.4-15.0.0" = _rvLlJXe5;
        "pkg-1.20.4-16.0.0" = _gN2ycQam;
        "pkg-1.20.4-16.2.0" = _b9PQnbmo;
        "pkg-1.20.4-16.3.0" = _l6bGIGl7;
        "pkg-1.20.1-10.3.0" = _WFmaxlDb;
        "pkg-1.20.1-10.3.1" = _TkrmvwUg;
        "pkg-1.20.1-10.3.2" = _yiqBfkNl;
        "pkg-1.20.4-16.3.1" = _Aoq2Rwcn;
        "pkg-1.20.6-17.0.0" = _GtP8Bw9M;
        "pkg-1.20.6-17.0.1" = _JvvcM5Lk;
        "pkg-1.20.6-17.1.0" = _feeSEFuM;
        "pkg-1.20.1-10.4.0" = _5bEMmML9;
        "pkg-1.20.6-17.2.0" = _SNaDxvfG;
        "pkg-1.21-18.0.0" = _kEJXAnkd;
        "pkg-1.21-18.0.1" = _s2oZ8KcR;
        "pkg-1.21-18.1.0" = _rBIDRtlk;
        "pkg-1.21-18.2.0" = _BPy9FlEf;
        "pkg-1.21-18.3.0" = _HEU7shNP;
        "pkg-1.20.1-10.5.0" = _l8g8eoEi;
        "pkg-1.21-18.4.0" = _17iFRkIC;
        "pkg-1.21-18.5.0" = _3CeToRHi;
        "pkg-1.21-18.6.0" = _VOG1mALV;
        "pkg-1.21-18.6.1" = _RVz8IpiH;
        "pkg-1.21-18.6.2" = _156xfBi2;
        "pkg-1.21.1-19.0.0" = _Wyl8Z9P1;
        "pkg-1.21.1-19.0.1" = _eP5WwVmy;
        "pkg-1.21.1-19.0.2" = _ErwbuPG6;
        "pkg-1.21.4-20.0.0" = _2WS5Qpmx;
        "pkg-1.21.4-20.0.1" = _F2mCiyMN;
        "pkg-1.21.4-20.1.0" = _wvbDVS33;
        "pkg-1.21.4-20.1.1" = _5Esm4ndX;
        "pkg-1.21.4-20.1.2" = _837ddDZP;
        "pkg-1.21.1-19.0.3" = _6oDcISjA;
        "pkg-1.21.4-20.2.0" = _etAFsliB;
        "pkg-1.21.5-21.0.0" = _hAisX3PW;
        "pkg-1.21.5-21.0.1" = _jnze5KK5;
        "pkg-1.21.5-21.0.2" = _KCEI7iLA;
        "pkg-1.21.5-21.0.3" = _P9ducfzY;
        "pkg-1.21.5-21.0.4" = _5p4gN7gc;
        "pkg-1.21.5-21.1.0" = _7T5mt1Xz;
        "pkg-1.21.5-21.2.0" = _H5Fk9STP;
        "pkg-1.21.5-21.3.0" = _g49tblBq;
        "pkg-1.21.5-21.3.1" = _dbeOKsOj;
        "pkg-1.21.5-21.3.2" = _i0wVtkYK;
        "pkg-1.21.1-19.0.4" = _GiyUhAwi;
        "pkg-1.21.5-21.5.0" = _l9ZURgB6;
        "pkg-1.21.5-21.6.0" = _e5O7Ov5t;
        "pkg-1.21.5-21.7.0" = _mjrMZv51;
        "pkg-1.21.8-22.0.0" = _EUloB9D7;
        "pkg-1.21.8-22.0.1" = _8kEorQTb;
        "pkg-1.21.8-22.0.2" = _ABFU5ENC;
        "pkg-1.21.8-22.1.0" = _wdpgA0zF;
        "pkg-1.21.8-22.1.1" = _wDjVBcud;
        "pkg-1.21.8-22.1.2" = _WVCX95Y5;
        "pkg-1.21.8-22.2.0" = _43FlwZU5;
        "pkg-1.21.8-22.4.0" = _ZeYKo5Kk;
        "pkg-1.21.8-22.6.0" = _n8X4ibZZ;
        "pkg-1.21.8-22.6.1" = _6roucE0n;
        "pkg-1.21.8-22.6.2" = _jRlfpbdf;
        "pkg-1.21.9-23.0.0" = _w5rd3QhS;
        "pkg-1.21.9-23.0.1" = _cczfxYIu;
        "pkg-1.21.9-23.0.2" = _GQ5cAjPn;
        "pkg-1.21.9-23.0.3" = _YN39RTC2;
        "pkg-1.21.10-24.0.0" = _2W0IP75s;
        "pkg-1.21.10-24.1.0" = _vPFraA6S;
        "pkg-1.21.1-19.1.0" = _RM57Ks9X;
        "pkg-1.21.11-25.0.0" = _11hOVfMt;
        "pkg-1.21.1-19.2.0" = _uv4x2px6;
        "pkg-1.21.11-25.1.0" = _VvDwWJrX;
        "pkg-1.21.11-25.2.0" = _AOcTJATG;
        "pkg-1.21.11-25.3.0" = _uZM70HlM;
        "pkg-1.21.11-25.3.1" = _3KbRdGz3;
        "pkg-26.1-snapshot-1-26.0.0" = _kFn13PM9;
        "pkg-26.1-snapshot-2-27.0.0" = _dnbLC9y8;
        "pkg-26.1-snapshot-2-27.1.0" = _sM0GU7Mt;
        "pkg-1.21.1-19.3.0" = _QXrDOYiN;
        "pkg-1.21.11-25.4.0" = _ozjhbgjV;
        "pkg-26.1-snapshot-2-27.2.0" = _jbtPPkwg;
        "pkg-1.21.11-25.5.0" = _K16sdvGr;
        "pkg-26.1-snapshot-27.3.0" = _uaZKXNWm;
        "pkg-26.1-snapshot-27.4.0" = _hwZdgq0V;
        "pkg-26.1-28.0.0" = _lBrzlBa4;
        "pkg-26.1.2-29.0.0" = _34QOBDxB;
