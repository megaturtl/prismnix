...
let
    ...
    in {
        ...
        "pkg-0.0.13t" = _JKSv2fDM;
        "pkg-0.0.14t" = _hsr64kuu;
        "pkg-0.0.15t" = _qJ8yF7iM;
        "pkg-0.0.16t" = _V8rJYd1v;
        "pkg-0.0.17t" = _tVrtaFbE;
        "pkg-0.0.18t" = _D8jNZsyv;
        "pkg-0.0.19t" = _spyrs4Aj;
        "pkg-0.0.20t" = _ubVFOU0Y;
        "pkg-0.0.201t" = _oDVt98IU;
        "pkg-0.0.21t" = _GNASBJhg;
        "pkg-0.0.22t" = _50DlB54j;
        "pkg-0.0.23t" = _QqUuMMRf;
        "pkg-0.0.24" = _wzwuWceu;
        "pkg-0.0.25" = _2qqkr3uF;
        "pkg-0.0.26" = _cr7dJeLM;
        "pkg-0.0.27" = _kK97cYoN;
        "pkg-0.0.28" = _tM4HNyBF;
        "pkg-0.0.29" = _uAMuao9s;
        "pkg-0.0.30" = _a8AtLrxI;
        "pkg-0.0.31" = _iulDOZ9g;
        "pkg-0.0.311" = _AtTFyjad;
        "pkg-0.0.312" = _HXhVh1t5;
        "pkg-0.0.313" = _eRW78gP5;
        "pkg-0.0.314" = _L837KrFk;
        "pkg-0.0.32" = _gv6OS2GZ;
        "pkg-0.0.32-forge" = _XprxdIp8;
        "pkg-0.0.321" = _BSnuS3bq;
        "pkg-0.0.321-forge" = _vRLjwb1H;
        "pkg-0.0.33-forge" = _DfZYichS;
        "pkg-0.0.33" = _oyTBM2Zb;
        "pkg-0.0.33-0.15.3" = _hVQlVQYD;
        "pkg-0.0.34-forge" = _oriO90aZ;
