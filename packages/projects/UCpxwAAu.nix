...
let
    ...
    in {
        ...
        "pkg-1.1+1.20" = _kxNcxUFg;
        "pkg-1.1+1.21" = _WzxtLQ0I;
        "pkg-1.1+1.21.2" = _zDIOFywH;
        "pkg-1.1.1+1.20" = _H4WQHOul;
        "pkg-1.2+1.20.1" = _6sr9CIbD;
        "pkg-1.2+1.21.1" = _pxP5b5O3;
        "pkg-1.2+1.21.2" = _2exYgmBb;
        "pkg-1.3.0+1.20.1-forge" = _HkL17ibc;
        "pkg-1.3.0+1.20.1-fabric" = _zyP0L6Cg;
        "pkg-1.3.0+1.21.1-neoforge" = _b9bPkmg9;
        "pkg-1.3.0+1.21.1-fabric" = _XLEBHSIr;
        "pkg-1.3.0+1.21.3-neoforge" = _xI6QEgIR;
        "pkg-1.3.0+1.21.3-fabric" = _bOGwNrB1;
        "pkg-1.4.0+1.20.1-forge" = _Dot8eOwj;
        "pkg-1.4.0+1.20.1-fabric" = _G6z4EREt;
        "pkg-1.4.0+1.21.1-neoforge" = _AwlbpERg;
        "pkg-1.4.0+1.21.1-fabric" = _EMncb3HN;
        "pkg-1.4.0+1.21.3-neoforge" = _ja2JH23c;
        "pkg-1.4.0+1.21.3-fabric" = _5gJ1o1xp;
        "pkg-1.4.0+1.21.6-fabric" = _N87RsfcV;
        "pkg-1.4.0+1.21.6-neoforge" = _cZQauXuP;
        "pkg-1.4.1+1.20.1-fabric" = _sdr47TUh;
        "pkg-1.4.1+1.21.1-neoforge" = _ly6y8N96;
        "pkg-1.4.1+1.21.1-fabric" = _6pQLBjnc;
        "pkg-1.4.1+1.21.3-neoforge" = _rq5tP5uo;
        "pkg-1.4.1+1.21.3-fabric" = _NIza19up;
        "pkg-1.4.1+1.21.6-neoforge" = _1dIb1ALm;
        "pkg-1.4.1+1.21.6-fabric" = _HPIvSx7V;
        "pkg-1.4.1+1.20.1-forge" = _pBNAxWgf;
        "pkg-1.4.1+1.21.9-fabric" = _FM9MPqc5;
        "pkg-1.4.1+1.21.9-neoforge" = _9KBNssR9;
        "pkg-1.4.1+1.21.11-fabric" = _T9Hf2S4C;
        "pkg-1.5.0+1.20.1-forge" = _wqlaxhze;
        "pkg-1.5.0+1.20.1-fabric" = _N7BiVkDy;
        "pkg-1.5.0+1.21.1-neoforge" = _eH7MV60T;
        "pkg-1.5.0+1.21.1-fabric" = _Nb7UCLQV;
        "pkg-1.5.0+1.21.3-neoforge" = _zZiOcmyh;
        "pkg-1.5.0+1.21.3-fabric" = _IqhFeo5T;
        "pkg-1.5.0+1.21.6-neoforge" = _Qpzkwd8j;
        "pkg-1.5.0+1.21.6-fabric" = _KbknERSR;
        "pkg-1.5.0+1.21.9-neoforge" = _paex6Fmy;
        "pkg-1.5.0+1.21.9-fabric" = _UttToSDq;
        "pkg-1.5.0+1.21.11-neoforge" = _oVDue6qY;
        "pkg-1.5.0+1.21.11-fabric" = _Sy4UZsfj;
        "pkg-1.6.1+1.21.1-neoforge" = _vWbOX3kW;
        "pkg-1.6.1+1.21.1-fabric" = _orDX30PT;
        "pkg-1.6.1+1.21.3-neoforge" = _T7nGnwKL;
        "pkg-1.6.1+1.21.3-fabric" = _C9Hc5LMt;
        "pkg-1.6.1+1.21.4-neoforge" = _LWapNjjU;
        "pkg-1.6.1+1.21.4-fabric" = _eDfzfSyO;
        "pkg-1.6.1+1.21.6-neoforge" = _j8Mp8PFW;
        "pkg-1.6.1+1.21.6-fabric" = _mOZc1RWS;
        "pkg-1.6.1+1.21.9-neoforge" = _JYUL67tN;
        "pkg-1.6.1+1.21.9-fabric" = _661Yeoen;
        "pkg-1.6.1+1.21.11-neoforge" = _tlhvqvYQ;
        "pkg-1.6.1+1.21.11-fabric" = _xPuGIQBU;
        "pkg-1.6.2+1.21.4-neoforge" = _i9aI9Nou;
        "pkg-1.6.2+1.21.4-fabric" = _fCdYOjS4;
        "pkg-1.6.2+1.21.6-neoforge" = _L59oI1aS;
        "pkg-1.6.2+1.21.6-fabric" = _HrPsKTZ8;
        "pkg-1.6.2+1.21.9-neoforge" = _Rb8map72;
        "pkg-1.6.2+1.21.9-fabric" = _tPmVJq96;
        "pkg-1.6.2+1.21.11-neoforge" = _nMjLMtkb;
        "pkg-1.6.2+1.21.11-fabric" = _yB14vlDR;
        "pkg-1.6.3+1.21.4-neoforge" = _jrg43b9y;
        "pkg-1.6.3+1.21.4-fabric" = _aCpg7Kbu;
        "pkg-1.6.3+1.21.6-neoforge" = _CgFmjRJy;
        "pkg-1.6.3+1.21.6-fabric" = _yTMC8UmK;
        "pkg-1.6.3+1.21.9-neoforge" = _Bl3bqQ4e;
        "pkg-1.6.3+1.21.9-fabric" = _wjWdsh9z;
        "pkg-1.6.3+1.21.11-neoforge" = _MiG8tO5N;
        "pkg-1.6.3+1.21.11-fabric" = _aJWeziMg;
        "pkg-1.6.4+1.21.1-neoforge" = _PFXoiLwr;
        "pkg-1.6.4+1.21.1-fabric" = _zcmxsFlD;
        "pkg-1.6.4+1.21.3-neoforge" = _sgtcfxto;
        "pkg-1.6.4+1.21.3-fabric" = _TuAG6Sg8;
        "pkg-1.6.4+1.21.4-neoforge" = _f2I3FnzQ;
        "pkg-1.6.4+1.21.4-fabric" = _93OzNAtv;
        "pkg-1.6.4+1.21.6-neoforge" = _oWhQEAGw;
        "pkg-1.6.4+1.21.6-fabric" = _LQQpMPAL;
        "pkg-1.6.4+1.21.9-neoforge" = _avTiNlT3;
        "pkg-1.6.4+1.21.9-fabric" = _w9m3PNWT;
        "pkg-1.6.4+1.21.11-neoforge" = _2MULZcYa;
        "pkg-1.6.4+1.21.11-fabric" = _zaEiTEUF;
        "pkg-1.6.4+26.1-fabric" = _dftH4oB3;
        "pkg-1.6.4+26.1-neoforge" = _FlmZNcwr;
        "pkg-1.6.5+1.21.1-neoforge" = _vjQhsqkm;
        "pkg-1.6.5+1.21.1-fabric" = _wGJo7WM2;
        "pkg-1.6.5+1.21.3-neoforge" = _t60jOWSu;
        "pkg-1.6.5+1.21.3-fabric" = _HV7bxVSC;
        "pkg-1.6.5+1.21.4-neoforge" = _PxwYzjTR;
        "pkg-1.6.5+1.21.4-fabric" = _aeiRxsbC;
        "pkg-1.6.5+1.21.6-neoforge" = _42WEtiTE;
        "pkg-1.6.5+1.21.6-fabric" = _Zv2AM6gs;
        "pkg-1.6.5+1.21.9-neoforge" = _NVjSTJds;
        "pkg-1.6.5+1.21.9-fabric" = _DxKpjcpT;
        "pkg-1.6.5+1.21.11-neoforge" = _g2Vby2u3;
        "pkg-1.6.5+1.21.11-fabric" = _QmtAAVx6;
        "pkg-1.6.5+26.1-neoforge" = _xE1fQGCN;
        "pkg-1.6.5+26.1-fabric" = _ZtcjbkUl;
        "pkg-2.0.0+1.21.1-neoforge" = _L4vBTG31;
        "pkg-2.0.0+1.21.1-fabric" = _9mWlP3x3;
        "pkg-2.0.0+1.21.3-neoforge" = _JGO8lWXh;
        "pkg-2.0.0+1.21.3-fabric" = _NiA1xyhu;
        "pkg-2.0.0+1.21.4-neoforge" = _eJI8rXTo;
        "pkg-2.0.0+1.21.4-fabric" = _dGx6Umjv;
        "pkg-2.0.0+1.21.6-neoforge" = _3s9rafT0;
        "pkg-2.0.0+1.21.6-fabric" = _7QWoCDDv;
        "pkg-2.0.0+1.21.10-neoforge" = _gCwc8Sog;
        "pkg-2.0.0+1.21.10-fabric" = _ir3PvPNP;
        "pkg-2.0.0+1.21.11-neoforge" = _gmD258Yn;
        "pkg-2.0.0+1.21.11-fabric" = _12dDGAhG;
        "pkg-2.0.0+26.1-neoforge" = _1dCW8iGE;
        "pkg-2.0.0+26.1-fabric" = _I4Z7SaHh;
        "pkg-2.0.1+1.21.1-neoforge" = _S4z7PThV;
        "pkg-2.0.1+1.21.1-fabric" = _GK9eCNFX;
        "pkg-2.0.1+1.21.3-neoforge" = _FNMNZ4vQ;
        "pkg-2.0.1+1.21.3-fabric" = _afzAzjhF;
        "pkg-2.0.1+1.21.4-neoforge" = _8TJKwUKR;
        "pkg-2.0.1+1.21.4-fabric" = _8AuVMApI;
        "pkg-2.0.1+1.21.6-neoforge" = _2NpZg11s;
        "pkg-2.0.1+1.21.6-fabric" = _RvnrdriT;
        "pkg-2.0.1+1.21.10-neoforge" = _rQBTkhU5;
        "pkg-2.0.1+1.21.10-fabric" = _JkIttkGq;
        "pkg-2.0.1+1.21.11-neoforge" = _UVRQrH2S;
        "pkg-2.0.1+1.21.11-fabric" = _zjgtably;
        "pkg-2.0.1+26.1-neoforge" = _UOhJ0tx0;
        "pkg-2.0.1+26.1-fabric" = _hHDf2zQR;
        "pkg-2.1.0+1.21.1-neoforge" = _l6uqKoKd;
        "pkg-2.1.0+1.21.1-fabric" = _7SDeQoE0;
        "pkg-2.1.0+1.21.3-neoforge" = _WjdJWYNa;
        "pkg-2.1.0+1.21.3-fabric" = _FaJnNE6C;
        "pkg-2.1.0+1.21.4-neoforge" = _Q3b4eSAw;
        "pkg-2.1.0+1.21.4-fabric" = _bKOOEOLb;
        "pkg-2.1.0+1.21.6-neoforge" = _k8tUHbIL;
        "pkg-2.1.0+1.21.6-fabric" = _rVi2zrtC;
        "pkg-2.1.0+1.21.10-neoforge" = _Iyti3N0a;
        "pkg-2.1.0+1.21.10-fabric" = _GpIrNOPr;
        "pkg-2.1.0+1.21.11-neoforge" = _iJuB0JmF;
        "pkg-2.1.0+1.21.11-fabric" = _yhky1kqC;
        "pkg-2.1.0+26.1-neoforge" = _bauzFvz2;
        "pkg-2.1.0+26.1-fabric" = _SoeKgR3z;
        "pkg-2.2.0+1.21.1-neoforge" = _tDRzCOIC;
        "pkg-2.2.0+1.21.1-fabric" = _ULx9iKUd;
        "pkg-2.2.0+1.21.3-neoforge" = _ZSUO3MYP;
        "pkg-2.2.0+1.21.3-fabric" = _GMbJQdms;
        "pkg-2.2.0+1.21.4-neoforge" = _wqkgOlfm;
        "pkg-2.2.0+1.21.4-fabric" = _eUgOJM2z;
        "pkg-2.2.0+1.21.6-neoforge" = _Mu85XpG8;
        "pkg-2.2.0+1.21.6-fabric" = _C5QHTSGT;
        "pkg-2.2.0+1.21.10-neoforge" = _ndJNtEos;
        "pkg-2.2.0+1.21.10-fabric" = _f5JrFB39;
        "pkg-2.2.0+1.21.11-neoforge" = _MAdMU6Iy;
