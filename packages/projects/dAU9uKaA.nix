...
let
    ...
    in {
        ...
        "pkg-1.4.3" = _Jk3Aujun;
        "pkg-1.4.4" = _eChIZ7hZ;
        "pkg-1.21-v1.4.5" = _wWe5NcZV;
        "pkg-1.21.5-v1.5.0" = _SSMdP8OZ;
        "pkg-1.21.5-v1.5.1" = _zR32HM8S;
        "pkg-1.21.5-v1.5.2" = _14UuDkeP;
        "pkg-1.21.5-v2.0.0" = _ED5zuQJ4;
        "pkg-1.21.9-v2.0.0" = _uOKgRT7l;
        "pkg-1.21.5-v2.0.1" = _IWmlO2Su;
        "pkg-1.21.10-v2.0.1" = _ReTfC65x;
        "pkg-1.21.5-v2.0.2" = _rjZLaRVl;
        "pkg-1.21.10-v2.0.2" = _oOkhkBkJ;
        "pkg-1.21.11-v2.0.2" = _1MOFKD7f;
        "pkg-1.21.11-v2.0.3" = _kLhCsiOn;
        "pkg-1.21.5-v2.0.3" = _LVhVGsE1;
        "pkg-1.21.11-v2.0.4" = _AGN60jLD;
        "pkg-1.21.5-v2.1.0" = _iaXt99TU;
        "pkg-1.21.11-v2.1.0" = _CcAgrQZG;
        "pkg-26.1-r1.0" = _Y2OyV9vC;
        "pkg-26.1-r1.1" = _PmxFQvoK;
        "pkg-26.1-r1.2" = _dNjIoi9S;
        "pkg-1.21-r3.0" = _4nKEadi9;
        "pkg-26.1-r2.0" = _vKIJYCVA;
        "default" = _vKIJYCVA;
    });
