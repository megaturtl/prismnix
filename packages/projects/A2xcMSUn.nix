...
let
    versions = (let
        ...
        _Mi8CjNTD = {
            "id" = "Mi8CjNTD";
            "file" = "TinySkeletons-v26.1.1-mc26.1.x-NeoForge.jar";
            "hash" = "sha512-mpG8EFmzPk7rRMm1O4gJI0INsB8EeX3wsGN3JPi4X3qwed47g3oxASxjaBwhNVpap/j3OBbkN8xXRRgl/gAO8A==";
        };
        _ObGoQZxV = {
            "id" = "ObGoQZxV";
            "file" = "TinySkeletons-v26.1.1-mc26.1.x-Fabric.jar";
            "hash" = "sha512-FLDtUfSAD1SZalYJ1EDorCWXeRKOhWuqitx2OpALbei15VsP6BY3hDWh13Tu9eoNeKYcAG1N7Ag5P9aEiOdxIw==";
        };
        _TuG5Es0a = {
            "id" = "TuG5Es0a";
            "file" = "TinySkeletons-v26.2.1-mc26.2.x-Fabric.jar";
            "hash" = "sha512-h+w+qcrDzReGDgloEVWDY6Agnq49lACSdzNKNLPrYFd8AgeNH/BW02gJ/WLqHA4XrEzJkpYyH8f/up2PYQWJ3Q==";
        };
        _cqclTcWM = {
            "id" = "cqclTcWM";
    ...
    in {
        ...
        "pkg-v4.1.0-1.19.1-Fabric" = _gr7oWWdA;
        "pkg-v4.2.0-1.19.2-Forge" = _ZoBxxROx;
        "pkg-v4.2.0-1.19.2-Fabric" = _j8tuWMAa;
        "pkg-v4.2.1-1.19.2-Fabric" = _8g6slmgu;
        "pkg-v4.2.1-1.19.2-Forge" = _zhUQYD2W;
        "pkg-v4.2.2-1.19.2-Fabric" = _4ewo2AQq;
        "pkg-v4.2.2-1.19.2-Forge" = _sY0Rj3F7;
        "pkg-v5.0.0-1.19.3-Forge" = _TrCHmze0;
        "pkg-v5.0.0-1.19.3-Fabric" = _FgHvt70I;
        "pkg-v6.0.0-1.19.4-Fabric" = _i5e52rd7;
        "pkg-v6.0.0-1.19.4-Forge" = _2PiaMyxs;
        "pkg-v6.0.0-1.20-Forge" = _YOBdcjNo;
        "pkg-v6.0.0-1.20-Fabric" = _ekrN994T;
        "pkg-v8.0.0-1.20.1-Forge" = _tAl8rImt;
        "pkg-v8.0.0-1.20.1-Fabric" = _978Gh1jG;
        "pkg-v3.3.0-1.18.2-Forge" = _yCgK4nAd;
        "pkg-v3.3.0-1.18.2-Fabric" = _jmaqR4Ag;
        "pkg-v8.0.1-1.20.1-Forge" = _bvxrcKcl;
        "pkg-v8.0.1-1.20.1-Fabric" = _pPzF5vy3;
        "pkg-v3.3.1-1.18.2-Forge" = _P0enNJfd;
        "pkg-v3.3.1-1.18.2-Fabric" = _zKTiapE9;
        "pkg-v20.4.0-1.20.4-Fabric" = _P7hGKFF6;
        "pkg-v20.4.0-1.20.4-Forge" = _mOzBEpgc;
        "pkg-v20.4.0-1.20.4-NeoForge" = _H7dcE5Ab;
        "pkg-v20.4.1-1.20.4-Fabric" = _LqfdkRJY;
        "pkg-v20.4.1-1.20.4-Forge" = _pLlCY65P;
        "pkg-v20.4.1-1.20.4-NeoForge" = _RjTqsILl;
        "pkg-v21.0.0-1.21-Fabric" = _4VbQOmI2;
        "pkg-v21.0.0-1.21-NeoForge" = _FcKL6Jbr;
        "pkg-v21.1.0-1.21.1-Fabric" = _HzXTnJHD;
        "pkg-v21.1.0-1.21.1-NeoForge" = _QO99Qp79;
        "pkg-v21.3.0-1.21.3-Fabric" = _6myIT8jy;
        "pkg-v21.3.0-1.21.3-NeoForge" = _RYQ7Wmzy;
        "pkg-v21.4.0-1.21.4-Fabric" = _YicFtwek;
        "pkg-v21.4.0-1.21.4-NeoForge" = _Rwb4ALu2;
        "pkg-v21.4.1-1.21.4-Fabric" = _qbhbdvJj;
        "pkg-v21.4.1-1.21.4-NeoForge" = _17dOM8Uk;
        "pkg-v21.5.0-1.21.5-Fabric" = _8HDrJVCD;
        "pkg-v21.5.0-1.21.5-NeoForge" = _IiYPcRCB;
        "pkg-v21.5.1-1.21.5-Fabric" = _Nll7PP5Z;
        "pkg-v21.5.1-1.21.5-NeoForge" = _SaPglasm;
        "pkg-v21.7.0-1.21.7-Fabric" = _rjD0G2KL;
        "pkg-v21.7.0-1.21.7-NeoForge" = _zEh1cyvk;
        "pkg-v21.8.0-1.21.8-Fabric" = _6d4DgwyF;
        "pkg-v21.8.0-1.21.8-NeoForge" = _uTfEyPsN;
        "pkg-v21.8.1-1.21.8-Fabric" = _8GnweXZn;
        "pkg-v21.8.1-1.21.8-NeoForge" = _bbobQ2rE;
        "pkg-v21.8.2-1.21.8-Fabric" = _hNieqSyk;
        "pkg-v21.8.2-1.21.8-NeoForge" = _YOQTCXLA;
        "pkg-21.9.0" = _zNeEBaTH;
        "pkg-21.10.0" = _F6SX5shY;
        "pkg-21.11.0" = _zWJicrmp;
        "pkg-21.11.1" = _kCLzCOdl;
        "pkg-26.1.0" = _Nwx79PXf;
        "pkg-v21.8.3-1.21.8-Fabric" = _GwIBLXH3;
        "pkg-v21.8.3-1.21.8-NeoForge" = _CB7g9REC;
        "pkg-21.10.1" = _aqYC9IRT;
        "pkg-21.11.2" = _myVL0Sgh;
