...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _u64SEZCe;
        "pkg-1.0.9" = _hRt0mCDY;
        "pkg-1.0.10" = _zAriLELe;
        "pkg-1.0.11" = _rW1Deh5W;
        "pkg-1.0.12" = _bp7GGU5U;
        "pkg-1.0.13" = _MeZe4JRM;
        "pkg-1.0.14" = _Ay3TAvxi;
        "pkg-1.0.15" = _cbasnFS1;
        "pkg-1.0.16" = _6cU4Uni0;
        "pkg-1.0.17" = _qwPAHYes;
        "pkg-1.0.18" = _lRbTvnZ0;
        "pkg-1.0.19" = _Nxhxph8j;
        "pkg-1.0.20" = _fyEnaPPg;
        "pkg-1.0.21" = _XU25IINE;
        "pkg-1.0.22" = _Z0GGEmA1;
        "pkg-1.0.23" = _wiIYpEns;
        "pkg-1.0.24" = _ugbaRtSc;
        "pkg-1.0.25" = _AFTN0kng;
        "pkg-1.0.26" = _PNTM9ihf;
        "pkg-1.0.27" = _oAtjeg1x;
        "pkg-1.0.28" = _1hwDy3WV;
        "pkg-1.0.29" = _cc5ZX5vM;
        "pkg-1.0.30" = _PtUAJkB7;
        "pkg-1.0.31" = _9frB3smr;
        "pkg-1.0.32" = _VDCIhDPS;
        "pkg-1.0.33" = _Wwq0AcfK;
        "pkg-1.0.34" = _z6vEKD0O;
        "pkg-1.0.35" = _CtcDEZru;
        "pkg-1.0.36" = _JDy8wDuv;
        "pkg-1.0.37" = _ZezZGTQq;
        "pkg-1.0.38" = _uIbXwBWB;
        "pkg-1.0.39" = _DZcvP7hX;
        "pkg-1.0.40" = _PWJzGM32;
        "pkg-1.0.41" = _XPnyqRQ9;
        "pkg-1.0.41.1" = _ZOoWSJnW;
        "pkg-1.0.41.2" = _gr2SLLcP;
        "pkg-1.0.41.3" = _AFCTAk3r;
        "pkg-1.0.42" = _f55WRIpz;
        "pkg-1.0.42.1" = _UBXZcqEu;
        "pkg-1.0.42.2" = _tC2jn3wz;
        "pkg-1.0.43" = _H1lyPQuA;
        "pkg-1.0.44" = _MnCBdcbG;
        "pkg-1.0.42.3" = _DHv9JqDn;
        "pkg-1.0.42.4" = _Q46kIm5u;
        "pkg-1.0.44.1" = _RE8nM3bz;
        "pkg-1.0.42.5" = _9c4a5QYy;
        "pkg-1.0.45" = _jyQGhnKy;
        "pkg-1.0.45.1" = _3k3c9aBk;
        "pkg-1.0.46" = _ICCJVwwn;
        "pkg-1.0.46.1" = _6kRye2WY;
        "pkg-1.0.46.2" = _P0NWwHDp;
        "pkg-1.46.3" = _T06waNqS;
        "pkg-1.46.4" = _FtADMt1A;
        "pkg-1.47.0" = _iJa8dDT7;
        "pkg-1.47.1" = _cS3EHwQD;
        "pkg-1.47.2" = _u6RTNlmY;
        "pkg-1.48.0" = _LWyPVdfz;
        "pkg-1.48.1" = _MZWxi7On;
        "pkg-1.48.2" = _QLlvn46Z;
        "pkg-1.48.3" = _thFiYvYF;
        "pkg-1.48.4" = _n9QNaqtq;
        "pkg-1.48.5" = _3KtNDssS;
        "pkg-1.48.6" = _OC2KLhmH;
        "pkg-1.48.7" = _g4krAL1M;
        "pkg-1.48.8" = _TaicwhhJ;
        "pkg-1.48.9" = _RPwjKvjk;
        "pkg-1.48.10" = _YFTw3iI4;
        "pkg-1.48.11" = _hYOCe89w;
