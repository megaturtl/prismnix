...
let
    ...
    in {
        ...
        "pkg-0.1.4-mc1.19.2" = _iuRWRZzZ;
        "pkg-0.1.4fix-mc1.18.2" = _rjdlostC;
        "pkg-0.1.5-mc1.19.4" = _u7HM3W3B;
        "pkg-0.1.6-mc1.19.4" = _nTcv490z;
        "pkg-0.1.5-mc1.16.4" = _368BWXDO;
        "pkg-0.1.5-mc1.17.1" = _qh6FWMoe;
        "pkg-0.1.5-mc1.18.2" = _m0fmUdZK;
        "pkg-0.1.5-mc1.19.2" = _BT2rHUaj;
        "pkg-0.1.7-mc1.19.4" = _xlZXNCtW;
        "pkg-0.1.6-mc1.16.5" = _iEXuPn4l;
        "pkg-0.1.6-mc1.17.1" = _RDHKzcnu;
        "pkg-0.1.6-mc1.18.2" = _5By4rmQj;
        "pkg-0.1.6-mc1.19.2" = _1j1rLuSS;
        "pkg-0.1.8-mc1.19.4" = _7GlsGlC3;
        "pkg-0.1.0-mc1.20.1" = _wmFNNg3z;
        "pkg-0.1.1-mc1.20.1" = _UEY037AP;
        "pkg-0.1.2-mc1.20.1" = _3Bj76Kmu;
        "pkg-0.1.3-mc1.20.1" = _YSuoUM5A;
        "pkg-0.1.9-mc1.19.4" = _TpvT01NL;
        "pkg-0.1.7-mc1.16.5" = _ujlMi4b1;
        "pkg-0.1.7-mc1.19.2" = _p4DsaHYA;
        "pkg-0.1.7-mc1.18.2" = _OlZM9y9Z;
        "pkg-0.1.5-mc1.20.1" = _fJvWsu82;
        "pkg-0.1.8-mc1.19.2" = _v4qJSJiz;
        "pkg-0.1.8-mc1.16.5" = _UpI7ahIH;
        "pkg-0.1.8-mc1.18.2" = _sACrFe9N;
        "pkg-0.1.10-mc1.19.4" = _c2D1DiIR;
        "pkg-0.1.6-mc1.20.1" = _vJAdsR2K;
        "pkg-0.1.11-mc1.19.4" = _PpRugc6z;
        "pkg-0.1.9-mc1.19.2" = _l1Y3Xaib;
        "pkg-0.1.9-mc1.18.2" = _ufbXQlWk;
        "pkg-0.1.9-mc1.16.5" = _2fucg9VL;
        "pkg-0.1.7-mc1.20.1" = _jJDaw5um;
        "pkg-0.1.8-mc1.20.1" = _pi119Otk;
        "pkg-0.1.1-mc1.20.4" = _BzLvv6At;
        "pkg-0.1.2-mc1.20.4" = _XVaJ0YOj;
        "pkg-0.1.4-mc1.20.4" = _PMutoRSd;
        "pkg-0.1.10-mc1.16.5" = _TOfoZ0mC;
        "pkg-0.1.10-mc1.18.2" = _i7WrRQry;
        "pkg-0.1.10-mc1.19.2" = _9hqcKUUT;
        "pkg-0.1.5-mc1.20.4" = _TvlOZNx7;
        "pkg-0.1.9-mc1.20.1" = _bYSrjsQk;
        "pkg-0.1.6-mc1.20.4" = _IaVocOqs;
        "pkg-0.1.6-mc1.20.6" = _BcZc9pAn;
        "pkg-0.1.10-mc1.20.1" = _CJtfrUps;
        "pkg-0.1.11-mc1.19.2" = _uiqgfdbU;
        "pkg-0.1.11-mc1.18.2" = _EudtGHYN;
        "pkg-0.1.11-mc1.16.5" = _KbpDqjGd;
        "pkg-0.1.7-mc1.20.4" = _14dk3suo;
        "pkg-0.1.7-mc1.20.6" = _hB9yDciB;
        "pkg-0.1.11-mc1.20.1" = _iDHm3khs;
        "pkg-0.1.12-mc1.18.2" = _tJmkWGP2;
        "pkg-0.1.12-mc1.19.2" = _F6w5pQi7;
        "pkg-0.1.12-mc1.16.5" = _Gp8nM473;
        "pkg-0.1.8-mc1.20.4" = _iJSjPnPb;
        "pkg-0.1.8-mc1.20.6" = _AIFlXqOg;
        "pkg-0.1.9-mc1.20.6" = _3DPHi2jZ;
        "pkg-0.1.9-mc1.21" = _LvU7KWhS;
        "pkg-0.1.10-mc1.21" = _1cCJS5PL;
        "pkg-0.1.13-mc1.16.5" = _WYQde9Ws;
        "pkg-0.1.11-mc1.21" = _8mZd4noc;
        "pkg-0.1.10-mc1.20.6" = _NPY6C43s;
        "pkg-0.1.12-mc1.21" = _wR1n5tHb;
        "pkg-0.1.13-mc1.21" = _7XdqoSs1;
        "pkg-0.1.11-mc1.20.6" = _Mg5ew1Vg;
        "pkg-0.1.14-mc1.21" = _i5ep8wRg;
        "pkg-0.1.12-mc1.20.6" = _EdFg8H1t;
        "pkg-0.1.15-mc1.21" = _x9g57fhp;
        "pkg-0.1.13-mc1.20.6" = _Hprw2oIx;
        "pkg-0.1.9-mc1.20.4" = _zfjfhUVM;
        "pkg-0.1.16-mc1.21" = _IftXP1s6;
        "pkg-0.1.17-mc1.21" = _bL1rzWSC;
        "pkg-0.1.18-mc1.21" = _hmkgJXZz;
        "pkg-0.1.19-mc1.21" = _gmjlc9Lf;
        "pkg-0.1.14-mc1.20.6" = _hcoFqDP3;
        "pkg-0.1.10-mc1.20.4" = _dg5LFnwo;
        "pkg-0.1.12-mc1.20.1" = _I8gFHtf3;
        "pkg-0.1.13-mc1.19.2" = _slOVdbMX;
        "pkg-0.1.13-mc1.18.2" = _l0IsqH8z;
        "pkg-0.1.14-mc1.16.5" = _D2KZfc3J;
        "pkg-0.1.15-mc1.16.5" = _iY4yzveu;
        "pkg-0.1.14-mc1.19.2" = _p0vTd2va;
        "pkg-0.1.13-mc1.20.1" = _6lS8JYz3;
        "pkg-0.1.11-mc1.20.4" = _pfVNQIr0;
        "pkg-0.1.14-mc1.18.2" = _mT0K5Qtx;
        "pkg-0.1.15-mc1.20.6" = _amMdvTGn;
        "pkg-0.1.20-mc1.21" = _8fnW8iNP;
        "pkg-0.1.21-mc1.21" = _UkzTvoQj;
        "pkg-0.1.22-mc1.21.1" = _UX09Ug7A;
        "pkg-0.1.23-mc1.21.1" = _m71GxVEu;
        "pkg-0.1.24-mc1.21.3" = _3hBTOTzR;
        "pkg-0.1.25-mc1.21.3" = _j5IO50qu;
        "pkg-0.1.24-mc1.21.1" = _Es7kdS3U;
        "pkg-0.1.25-mc1.21.1" = _LwYXz43R;
        "pkg-0.1.26-mc1.21.3" = _fTtMcOP3;
        "pkg-0.1.26-mc1.21.1" = _AV7BKWUa;
        "pkg-0.1.27-mc1.21.3" = _LEVJ81ZJ;
        "pkg-0.1.28-mc1.21.4" = _X2uxSTK8;
        "pkg-0.2.1-mc1.21.1" = _T5htOpOW;
        "pkg-0.2.1-mc1.21.3" = _M9l3AdDM;
        "pkg-0.2.1-mc1.21.4" = _6MDUTqob;
        "pkg-0.2.2-mc1.21.4" = _BZuU241S;
        "pkg-0.2.2-mc1.21.3" = _vsSQjI4w;
        "pkg-0.2.2-mc1.21.1" = _hV4oaCno;
        "pkg-0.2.4-mc1.21.1" = _qMfmvaVY;
        "pkg-0.2.4-mc1.21.4" = _2pjxYiS6;
        "pkg-0.2.4-mc1.21.3" = _iUUeaOog;
        "pkg-0.2.5-mc1.21.1" = _iz2SEf0U;
        "pkg-0.2.5-mc1.21.3" = _9xUA2RhQ;
        "pkg-0.2.5-mc1.21.4" = _wL1ucL6Y;
        "pkg-0.2.6-mc1.21.1" = _4NT3ivof;
        "pkg-0.2.6-mc1.21.3" = _8RQOVuQr;
        "pkg-0.2.6-mc1.21.4" = _y4QPjB94;
        "pkg-0.2.7-mc1.21.1" = _vVWFPxgR;
        "pkg-0.2.8-mc1.21.1" = _ShceJDbG;
        "pkg-0.2.8-mc1.21.3" = _E8QcWgFb;
        "pkg-0.2.8-mc1.21.4" = _4oUHeJ3r;
        "pkg-0.2.9-mc1.21.3" = _NJx6icNI;
        "pkg-0.2.9-mc1.21.1" = _KvzFo2yb;
        "pkg-0.2.10-mc1.21.1" = _A25kdDT1;
        "pkg-0.2.10-mc1.21.3" = _vRTA6ONX;
        "pkg-0.2.10-mc1.21.4" = _ZQRNh20V;
        "pkg-0.2.11-mc1.21.3" = _vgnLCQ1x;
        "pkg-0.2.11-mc1.21.1" = _rbHqUgoj;
        "pkg-0.2.12-mc1.21.3" = _j8VQ1pKc;
        "pkg-0.2.11-mc1.21.4" = _uZpJoOR8;
        "pkg-0.3.0-alpha1-mc1.21.5" = _56Yxn4Mm;
        "pkg-0.3.1-mc1.21.1" = _19oDFgYG;
        "pkg-0.3.1-mc1.21.3" = _pO30Ko6x;
        "pkg-0.3.1-mc1.21.4" = _6Rghjezq;
        "pkg-0.3.1-mc1.21.5" = _5QY51SfN;
        "pkg-0.3.2-mc1.21.5" = _IsmjpMA7;
        "pkg-0.3.3-mc1.21.5" = _buDLgekd;
        "pkg-0.3.2-mc1.21.4" = _ql9z4f8Y;
        "pkg-0.3.2-mc1.21.1" = _Atnupu99;
        "pkg-0.3.2-mc1.21.3" = _2yXSZYMg;
        "pkg-0.3.4-mc1.21.5" = _ZZ7JHOsk;
        "pkg-0.3.5-mc1.21.5" = _vOYLBTTD;
        "pkg-0.3.3-mc1.21.1" = _i6atsMOU;
        "pkg-0.3.3-mc1.21.4" = _osdryC1S;
        "pkg-0.3.3-mc1.21.3" = _vaNkpeyo;
        "pkg-0.3.6-mc1.21.5" = _gLCLiX89;
        "pkg-0.3.5-mc1.21.4" = _44OfBwIt;
        "pkg-0.3.7-mc1.21.5" = _vjYm4L7k;
        "pkg-0.3.4-mc1.21.1" = _GMBFJ2Oh;
        "pkg-0.3.4-mc1.21.3" = _rN1vDhwE;
        "pkg-0.3.5-mc1.21.1" = _xIa0U5qs;
        "pkg-0.3.8-mc1.21.7" = _GGLwS4g2;
        "pkg-0.3.8-mc1.21.5" = _Or9N8mJD;
        "pkg-0.3.6-mc1.21.4" = _eUX0d6Mq;
        "pkg-0.3.5-mc1.21.3" = _fVJQwwvv;
        "pkg-0.3.6-mc1.21.1" = _kkzEnIXv;
        "pkg-0.1.14-mc1.20.1" = _adXONMb5;
        "pkg-0.3.9-mc1.21.7" = _NH5a1cDH;
        "pkg-0.4.0+mc1.21.8" = _jqqmjQHs;
        "pkg-0.4.1+mc1.21.8" = _OfRPtNzp;
        "pkg-0.4.1+mc1.21.5" = _Zd18tthY;
        "pkg-0.4.1+mc1.21.4" = _1r2sKhOk;
        "pkg-0.4.1+mc1.21.3" = _WRPP5cNG;
        "pkg-0.4.1+mc1.21.1" = _znxhC06k;
        "pkg-0.4.2+mc1.21.8" = _woiTnwqu;
        "pkg-0.4.3+mc1.21.8" = _Nm31E37k;
        "pkg-0.4.0+mc1.21.10" = _5QmBoQ5S;
        "pkg-0.4.1+mc1.21.10" = _zVF7YOQK;
        "pkg-0.4.2+mc1.21.10" = _yAFkztiS;
        "pkg-0.4.3+mc1.21.10" = _gJi9t7LR;
        "pkg-0.4.4+mc1.21.10" = _kyuPrXCF;
        "pkg-0.4.5+mc1.21.10" = _GqEkTPo7;
        "pkg-0.4.7+mc1.21.10" = _v2RCOetn;
        "pkg-0.4.8+mc1.21.10" = _XBIW3xpE;
        "pkg-0.4.9+mc1.21.10" = _u0wFZSpO;
        "pkg-0.4.2+mc1.21.5" = _1sMntbe0;
        "pkg-0.4.2+mc1.21.4" = _fOgQfS2j;
        "pkg-0.4.2+mc1.21.3" = _43YofX8O;
        "pkg-0.4.2+mc1.21.1" = _YcfOKxBv;
        "pkg-0.4.0+mc1.21.11" = _uJhHU4fU;
        "pkg-0.4.1+mc1.21.11" = _dnABuTsI;
        "pkg-0.4.11+mc1.21.10" = _PVqnsLDh;
        "pkg-0.4.2+mc1.21.11" = _6bgftvWS;
        "pkg-0.4.5+mc1.21.8" = _4E6KWMAH;
        "pkg-0.4.3+mc1.21.5" = _gx78SBFF;
        "pkg-0.4.3+mc1.21.4" = _CvHt5Uhi;
        "pkg-0.4.3+mc1.21.3" = _f6aASVZt;
        "pkg-0.4.3+mc1.21.1" = _CgDQ0u0Q;
        "pkg-0.4.3-alpha.1+mc1.21.11" = _S4cQ06cr;
        "pkg-0.4.3-alpha.2+mc1.21.11" = _9J78q5WT;
        "pkg-0.4.3+mc1.21.11" = _EopSKiRN;
        "pkg-0.4.4+mc1.21.3" = _qD9DEqzC;
        "pkg-0.5.0+mc26.1.1" = _bThmGExj;
        "pkg-0.4.4+mc1.21.11" = _fKaY22pe;
        "pkg-0.5.1+mc26.1.2" = _nn8xdrme;
        "pkg-0.5.2+mc26.1.2" = _FEflxe6s;
        "pkg-0.5.0+mc26.2" = _N3d1oEun;
        "pkg-0.5.4+mc26.1.2" = _8IvsfLow;
        "pkg-0.5.1+mc26.2" = _PU3DPP5w;
        "pkg-0.4.5+mc1.21.11" = _SvPK1yWT;
