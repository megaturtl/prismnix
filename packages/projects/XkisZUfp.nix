...
let
    ...
    in {
        ...
        "pkg-2.6_beta_fabric_1.17.1" = _r3B3AGdk;
        "pkg-2.6_beta_forge_1.17.1" = _99NMm0Ah;
        "pkg-2.6_beta_forge_1.18.1" = _eGB0YCtI;
        "pkg-2.6_beta_fabric_1.18.1" = _UlPk8twl;
        "pkg-2.6_beta_forge_1.18.2" = _jqMACapX;
        "pkg-2.6_beta_fabric_1.18.2" = _SRHnmXpk;
        "pkg-2.6_beta_forge_1.19" = _QrnYbFus;
        "pkg-2.6_beta_fabric_1.19" = _XwjH9QbU;
        "pkg-2.6_beta_quilt_1.19" = _xgnvxktA;
        "pkg-2.6.1_beta_fabric_1.17.1" = _bnF4b7lN;
        "pkg-2.6.1_beta_forge_1.17.1" = _71B2iSFR;
        "pkg-2.6.1_beta_fabric_1.18.1" = _jTvvB8tK;
        "pkg-2.6.1_beta_forge_1.18.1" = _quOUSz3j;
        "pkg-2.6.1_beta_forge_1.18.2" = _s0UuSqVu;
        "pkg-2.6.1_beta_fabric_1.18.2" = _ZlPyu2f7;
        "pkg-2.6.1_beta_fabric_1.19" = _wLtudmgh;
        "pkg-2.6.1_beta_forge_1.19" = _1lePoqXm;
        "pkg-2.6.1_beta_fabric_1.19.1" = _4d9Ic4jy;
        "pkg-2.6.1_beta_forge_1.19.1" = _AAobEWZb;
        "pkg-2.6.1_beta_fabric_1.16.5" = _hzRVV72l;
        "pkg-2.6.1_beta_forge_1.16.5" = _9Ra3nVaP;
        "pkg-2.6.2_release_fabric_1.16.5" = _5jjPaxPi;
        "pkg-2.6.2_release_forge_1.16.5" = _KKhDtBRa;
        "pkg-2.6.2_release_fabric_1.17.1" = _Zzt3fZYu;
        "pkg-2.6.2_release_forge_1.17.1" = _eoSU0nw0;
        "pkg-2.6.2_release_fabric_1.18.1" = _Eoj3Tkag;
        "pkg-2.6.2_release_forge_1.18.1" = _uQSLq3Vi;
        "pkg-2.6.2_release_fabric_1.18.2" = _K33YL4mQ;
        "pkg-2.6.2_release_forge_1.18.2" = _pMjpDmfd;
        "pkg-2.6.2_release_fabric_1.19" = _4EW0Vt6g;
        "pkg-2.6.2_release_forge_1.19" = _LgmHu9RF;
        "pkg-2.6.2_release_fabric_1.19.1" = _LdaNhePI;
        "pkg-2.6.2_release_forge_1.19.1" = _RY0ZrR1D;
        "pkg-2.6.2_release_fabric_1.19.2" = _Cca23UB7;
        "pkg-2.6.2_release_forge_1.19.2" = _FwJ9hqb2;
        "pkg-2.6.3_release_fabric_1.16.5" = _Rfl1otab;
        "pkg-2.6.3_release_forge_1.16.5" = _ITSbEBfq;
        "pkg-2.6.3_release_fabric_1.17.1" = _NoOmzGp7;
        "pkg-2.6.3_release_forge_1.17.1" = _ZRbykUi1;
        "pkg-2.6.3_release_fabric_1.18.1" = _xogLymtn;
        "pkg-2.6.3_release_forge_1.18.1" = _4kyonbqT;
        "pkg-2.6.3_release_fabric_1.18.2" = _qqq4tuAp;
        "pkg-2.6.3_release_forge_1.18.2" = _AnNLvF6F;
        "pkg-2.6.3_release_fabric_1.19" = _DLLKMpAS;
        "pkg-2.6.3_release_forge_1.19" = _XWScmgDj;
        "pkg-2.6.3_release_fabric_1.19.1" = _mbhC1fMw;
        "pkg-2.6.3_release_forge_1.19.1" = _uUzDu4Gx;
        "pkg-2.6.3_release_fabric_1.19.2" = _yPYmq8Wf;
        "pkg-2.6.3_release_forge_1.19.2" = _1LbA2ATU;
        "pkg-2.6.4_release_fabric_1.16.5" = _m3offNRf;
        "pkg-2.6.4_release_forge_1.16.5" = _Mi12PSHn;
        "pkg-2.6.4_release_fabric_1.17.1" = _FlwROaoz;
        "pkg-2.6.4_release_forge_1.17.1" = _XVRL53nN;
        "pkg-2.6.4_release_fabric_1.18.1" = _uqNtoYuy;
        "pkg-2.6.4_release_forge_1.18.1" = _CcydqJGL;
        "pkg-2.6.4_release_fabric_1.18.2" = _9Lz22NNG;
        "pkg-2.6.4_release_forge_1.18.2" = _y4VV8KQl;
        "pkg-2.6.4_release_fabric_1.19" = _CXlRyPlk;
        "pkg-2.6.4_release_forge_1.19" = _xYA8DMu6;
        "pkg-2.6.4_release_fabric_1.19.1" = _s4ulDL22;
        "pkg-2.6.4_release_forge_1.19.1" = _UvyUJv2U;
        "pkg-2.6.4_release_fabric_1.19.2" = _AZWGYtEK;
        "pkg-2.6.4_release_forge_1.19.2" = _dy8SslQV;
        "pkg-2.6.4_release_fabric_1.19.3" = _Q5DRGDpr;
        "pkg-2.6.4_release_forge_1.19.3" = _cT1apIk7;
        "pkg-2.6.5_beta_fabric_1.19.3" = _dasAIBL0;
        "pkg-2.6.5_beta_forge_1.19.3" = _PmDfrJ3k;
        "pkg-2.6.5_beta_fabric_1.19.2" = _5Zt9oxwi;
        "pkg-2.6.5_beta_forge_1.19.2" = _aQaepaGc;
        "pkg-2.6.6_release_fabric_1.16.5" = _dXaMNDO0;
        "pkg-2.6.6_release_forge_1.16.5" = _MlEG8l78;
        "pkg-2.6.6_release_fabric_1.17.1" = _Vpuk4JzA;
        "pkg-2.6.6_release_forge_1.17.1" = _ptBK95PH;
        "pkg-2.6.6_release_fabric_1.18.1" = _uO8OwNQS;
        "pkg-2.6.6_release_forge_1.18.1" = _jzl2RdNQ;
        "pkg-2.6.6_release_fabric_1.18.2" = _sILDCQnR;
        "pkg-2.6.6_release_forge_1.18.2" = _WNaTZYbf;
        "pkg-2.6.6_release_fabric_1.19" = _ChwF9sCE;
        "pkg-2.6.6_release_forge_1.19" = _4eJsKulD;
        "pkg-2.6.6_release_fabric_1.19.1" = _x5l3cOj8;
        "pkg-2.6.6_release_forge_1.19.1" = _OAYb5SKR;
        "pkg-2.6.6_release_fabric_1.19.2" = _YOFCEFSD;
        "pkg-2.6.6_release_forge_1.19.2" = _emsjhVAQ;
        "pkg-2.6.6_release_fabric_1.19.3" = _EBSq8Yz9;
        "pkg-2.6.6_release_forge_1.19.3" = _SrP8fcGN;
        "pkg-2.6.6_beta_fabric_1.19.4" = _WGA7rrJG;
        "pkg-2.6.6_beta_forge_1.19.4" = _BKZmuSoE;
        "pkg-2.6.7_release_fabric_1.16.5" = _OrZt8u6p;
        "pkg-2.6.7_release_forge_1.16.5" = _s8iXAT4w;
        "pkg-2.6.7_release_fabric_1.17.1" = _Hw9wBK14;
        "pkg-2.6.7_release_forge_1.17.1" = _w8w6cGX6;
        "pkg-2.6.7_release_fabric_1.18.1" = _OL6XoJlk;
        "pkg-2.6.7_release_forge_1.18.1" = _10Jc0opx;
        "pkg-2.6.7_release_fabric_1.18.2" = _shOqPYYU;
        "pkg-2.6.7_release_forge_1.18.2" = _nkHv46X8;
        "pkg-2.6.7_release_fabric_1.19" = _CxKlnODE;
        "pkg-2.6.7_release_forge_1.19" = _5FcSBWkf;
        "pkg-2.6.7_release_fabric_1.19.1" = _qqLD02Qo;
        "pkg-2.6.7_release_forge_1.19.1" = _F39e9Xa7;
        "pkg-2.6.7_release_fabric_1.19.2" = _PCsFSA99;
        "pkg-2.6.7_release_forge_1.19.2" = _gfDATWLg;
        "pkg-2.6.7_release_fabric_1.19.3" = _dlFYjyXa;
        "pkg-2.6.7_release_forge_1.19.3" = _VP4gX5RJ;
        "pkg-2.6.7_release_fabric_1.19.4" = _m4VAqhMp;
        "pkg-2.6.7_release_forge_1.19.4" = _bYJVI2sZ;
        "pkg-2.6.7_release_fabric_1.20" = _ZJgRuLUP;
        "pkg-2.6.7_release_forge_1.20" = _ehBrczi9;
        "pkg-2.6.8_release_fabric_1.16.5" = _nrrDd8Gu;
        "pkg-2.6.8_release_forge_1.16.5" = _8UoMWsQz;
        "pkg-2.6.8_release_fabric_1.17.1" = _pRv9JyzK;
        "pkg-2.6.8_release_forge_1.17.1" = _zq4XLTEY;
        "pkg-2.6.8_release_fabric_1.18.1" = _DgnZRfLm;
        "pkg-2.6.8_release_forge_1.18.1" = _7XtwFKKl;
        "pkg-2.6.8_release_fabric_1.18.2" = _HoPKFcNr;
        "pkg-2.6.8_release_forge_1.18.2" = _JknS43c6;
        "pkg-2.6.8_release_fabric_1.19" = _AIJWk9IN;
        "pkg-2.6.8_release_forge_1.19" = _K4zakio3;
        "pkg-2.6.8_release_fabric_1.19.1" = _f2rCHpMr;
        "pkg-2.6.8_release_forge_1.19.1" = _u7peNQTg;
        "pkg-2.6.8_release_fabric_1.19.2" = _G2JALB1f;
        "pkg-2.6.8_release_forge_1.19.2" = _tyIpJMNs;
        "pkg-2.6.8_release_fabric_1.19.3" = _GzMN7udO;
        "pkg-2.6.8_release_forge_1.19.3" = _zzBtO5KT;
        "pkg-2.6.8_release_fabric_1.19.4" = _zZoZCxxZ;
        "pkg-2.6.8_release_forge_1.19.4" = _ErApTTmh;
        "pkg-2.6.8_release_fabric_1.20" = _VIQm5DuH;
        "pkg-2.6.8_release_forge_1.20" = _1nJQ8QZ6;
        "pkg-2.6.8_release_fabric_1.20.1" = _pMsUrrHl;
        "pkg-2.6.8_release_forge_1.20.1" = _Id04GF7Z;
        "pkg-2.6.8_release_fabric_1.20.2" = _tD3LLKTD;
        "pkg-2.6.8_release_forge_1.20.2" = _cn6mj9iO;
        "pkg-2.6.9_release_fabric_1.16.5" = _kjOBS7bR;
        "pkg-2.6.9_release_forge_1.16.5" = _ACvW4cQb;
        "pkg-2.6.9_release_fabric_1.17.1" = _C6x7kDCV;
        "pkg-2.6.9_release_forge_1.17.1" = _U3b1ZuDy;
        "pkg-2.6.9_release_fabric_1.18.1" = _mM2MXR9B;
        "pkg-2.6.9_release_forge_1.18.1" = _pfJhaU4I;
        "pkg-2.6.9_release_fabric_1.18.2" = _WnQd4guQ;
        "pkg-2.6.9_release_forge_1.18.2" = _elcpn35W;
        "pkg-2.6.9_release_fabric_1.19" = _A0TGmpgS;
        "pkg-2.6.9_release_forge_1.19" = _PWa2xCJR;
        "pkg-2.6.9_release_fabric_1.19.1" = _4nEu9Eqy;
        "pkg-2.6.9_release_forge_1.19.1" = _vozsD6Oj;
        "pkg-2.6.9_release_fabric_1.19.2" = _lTjj8LM8;
        "pkg-2.6.9_release_forge_1.19.2" = _UIn3pqFj;
        "pkg-2.6.9_release_fabric_1.19.3" = _ivxBAcdm;
        "pkg-2.6.9_release_forge_1.19.3" = _7d6uC8YV;
        "pkg-2.6.9_release_fabric_1.19.4" = _C4HMDWLf;
        "pkg-2.6.9_release_forge_1.19.4" = _PaB09ria;
        "pkg-2.6.9_release_fabric_1.20" = _fVCMYy43;
        "pkg-2.6.9_release_forge_1.20" = _Kyr8lXvU;
        "pkg-2.6.9_release_fabric_1.20.1" = _mLBi7a8x;
        "pkg-2.6.9_release_forge_1.20.1" = _PpaL5EI3;
        "pkg-2.6.9_release_forge_1.20.4" = _LjGyxHGN;
        "pkg-2.6.9_release_fabric_1.20.4" = _phLyujHt;
        "pkg-2.6.9_release_fabric_1.20.2" = _Ru4fH9mc;
        "pkg-2.6.9_release_forge_1.20.2" = _VLxPyTYI;
        "pkg-2.7-beta" = _xUqWx8bo;
        "pkg-2.8_beta_fabric_1.21" = _swOXFeZe;
        "pkg-2.8_beta_neoforge_1.21" = _zHhpwEkR;
        "pkg-2.8_beta_fabric_1.21.4" = _jW67NKB5;
        "pkg-2.8_beta_neoforge_1.21.4" = _33zVmVVl;
        "pkg-2.8.2_beta_fabric_1.21" = _3BSW3vN5;
        "pkg-2.8.2_beta_neoforge_1.21" = _vfdksXAG;
        "pkg-2.8.2_beta_fabric_1.21.4" = _OpVcLqTs;
        "pkg-2.8.2_beta_neoforge_1.21.4" = _gcTBb3FL;
        "pkg-2.8.3_beta_fabric_1.21" = _8myrGjsP;
        "pkg-2.8.3_beta_neoforge_1.21" = _iKfvtXOj;
        "pkg-2.8.3_beta_fabric_1.21.4" = _1kTmFHxQ;
        "pkg-2.8.3_beta_neoforge_1.21.4" = _XiQcc5PX;
        "pkg-2.9_release_fabric_1.21.4" = _9Kc1lVlt;
        "pkg-2.9_release_neoforge_1.21.4" = _OXw0z8lN;
        "pkg-2.9_release_fabric_1.21.5" = _uw1h4eE5;
        "pkg-2.9_release_neoforge_1.21.5" = _UfEQ9Pla;
        "pkg-2.9_release_fabric_1.21" = _cIva2vBd;
        "pkg-2.9_release_neoforge_1.21" = _2t88eqU2;
        "pkg-2.9_release_fabric_1.21.6" = _43U7XPop;
        "pkg-2.9_release_neoforge_1.21.6" = _PIqdy8L3;
        "pkg-2.10_release_fabric_1.21.6" = _cGMCP1Wz;
        "pkg-2.10_release_neoforge_1.21.6" = _msxvIAMg;
        "pkg-2.10_release_fabric_1.21.9" = _S8CyvCWa;
        "pkg-2.10_release_neoforge_1.21.9" = _c56HG2cv;
        "pkg-2.10_release_fabric_1.21.10" = _ckEeMVez;
        "pkg-2.10_release_neoforge_1.21.10" = _lPMUnh4P;
        "pkg-2.11_release_fabric_1.21.11" = _ycAXn4S1;
        "pkg-2.11_release_neoforge_1.21.11" = _Elc6yCvZ;
        "pkg-2.11_release_fabric_1.21" = _ZtSp4zVd;
        "pkg-2.11_release_neoforge_1.21" = _Y1Yv1X2B;
        "pkg-2.12_release_fabric_1.21.11" = _NEt1DX8Y;
        "pkg-2.12_release_neoforge_1.21.11" = _nwfHMRDl;
        "pkg-2.13_release_fabric_1.21" = _ReXCo747;
        "pkg-2.13_release_neoforge_1.21" = _UyX1gpGB;
        "pkg-2.14_release_fabric_1.21.11" = _wpUBclIM;
        "pkg-2.14_release_neoforge_1.21.11" = _dqwLqnhu;
        "pkg-2.15_release_fabric_1.21.11" = _cNjPMhU4;
        "pkg-2.15_release_neoforge_1.21.11" = _DxdA1fCo;
        "pkg-2.14_release_fabric_1.21" = _mNh9iuNi;
        "pkg-2.14_release_neoforge_1.21" = _Imevjyz0;
        "pkg-2.16_beta_fabric_1.21.11" = _9lZFDXQS;
        "pkg-2.16_beta_neoforge_1.21.11" = _g21Cycno;
        "pkg-3.0_beta_fabric_1.21.11" = _wCs5WEH8;
        "pkg-3.0_beta_neoforge_1.21.11" = _BP6llKju;
        "pkg-3.0_beta_forge_1.20.1" = _pkg70XEo;
        "pkg-3.0_beta_neoforge_1.21" = _LhsSDlbe;
        "pkg-3.0_beta_fabric_1.20.1" = _R3EY6Ev7;
        "pkg-3.0_beta_fabric_1.21" = _WUaPStUm;
        "pkg-3.0.1_beta_forge_1.20.1" = _dbrPCNDU;
        "pkg-3.0.2_beta_forge_1.20.1" = _crmuo4JY;
        "pkg-3.0.2_beta_fabric_1.20.1" = _O6VsmOvM;
        "pkg-3.0.2_beta_fabric_1.21.1" = _o8RElFfp;
        "pkg-3.0.2_beta_neoforge_1.21.1" = _6yDVES5H;
        "pkg-3.0.2_beta_fabric_1.21.11" = _lQ0CiYEU;
        "pkg-3.0.2_beta_neoforge_1.21.11" = _UpGJlbUX;
        "pkg-3.0.4_beta_fabric_1.20.1" = _QA4UxUiE;
        "pkg-3.0.4_beta_forge_1.20.1" = _yCIFp9lC;
        "pkg-3.0.4_beta_fabric_1.21.1" = _w7Sp5XgD;
        "pkg-3.0.4_beta_neoforge_1.21.1" = _7RSaftu7;
        "pkg-3.0.4_beta_fabric_1.21.11" = _5LkCYNrE;
        "pkg-3.0.4_beta_neoforge_1.21.11" = _JnLMF5qo;
        "pkg-3.0.5_beta_fabric_1.21.1" = _T514AZg8;
        "pkg-3.0.5_beta_neoforge_1.21.1" = _nvMyIx0w;
        "pkg-3.0.5_beta_fabric_1.20.1" = _JEWzeBDy;
        "pkg-3.0.5_beta_forge_1.20.1" = _LJ5OFzHW;
