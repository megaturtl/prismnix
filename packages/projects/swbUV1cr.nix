...
let
    versions = (let
        ...
        _xvccCRD9 = {
            "id" = "xvccCRD9";
            "file" = "bluemap-5.24-fabric.jar";
            "hash" = "sha512-y4G1OCtYg3uN+5L5fpI06hWxpBJeyLV5E/BvnQuvKfAJHCudvRicl6p1rkgyxazExnD7SvuqZ7Dqi36cD3u+Ew==";
        };
        _Vw9owywv = {
            "id" = "Vw9owywv";
            "file" = "bluemap-5.24-forge.jar";
            "hash" = "sha512-hu3LOEqDy0mMYZPObco7cgERSa1vbzlb/IcjM0i0WAoD+7hjl1qNxZ2ZVN5p9TDXFJQMhTP/wbMmDEmVotBq3g==";
        };
        _5e8f3dxZ = {
            "id" = "5e8f3dxZ";
            "file" = "bluemap-5.24-neoforge.jar";
            "hash" = "sha512-bLsXe57nlaKsp6AjnPm91ziKdgcWQyJw6IKwraDhtl+pGA8am2wnhdz9eIQqcKcS4tM71vKrl6QujYziqXqFsA==";
        };
        _zjZDXCw6 = {
            "id" = "zjZDXCw6";
            "file" = "bluemap-5.24-paper.jar";
            "hash" = "sha512-+Ews6dshC4Rq60NeVsMRKJwMIN2INOypwGR4ojjDDwMT8wFyG/ybMEEaJTXYROduAS6Ct3Ki6EkINcPVzToE6A==";
        };
        _STFjPUmV = {
            "id" = "STFjPUmV";
            "file" = "bluemap-5.24-spigot.jar";
            "hash" = "sha512-oOo1FdVBqgQDIFpwc3O1UDgLeIPLePGvVBzEff9Zs1CWbxucLo4VMd1ydPcfgh/lZMP+x3MZIl2DOv10cuuX7A==";
        };
        _FsUQn95s = {
            "id" = "FsUQn95s";
            "file" = "bluemap-5.24-sponge.jar";
            "hash" = "sha512-jaRmyCC8kjgAO9PWpTNktxKXsbEn30Xr+nPC78Z79Po4jh3DrYZIdZMCIl90fE8Ix0q8Eif2iDURKzQ7eBqu3g==";
        };
        _p8hLlqrQ = {
            "id" = "p8hLlqrQ";
            "file" = "bluemap-5.25-fabric.jar";
            "hash" = "sha512-h9WLD6cpgi97WC5rWFwI7SGwItvKS9zMhZhtBJIt0X3G55+wCBZyfenmR9YAjFhm6aAXOzgss2Rdy4ro3IEhQg==";
        };
        _WPKOs9Bs = {
            "id" = "WPKOs9Bs";
            "file" = "bluemap-5.25-forge.jar";
            "hash" = "sha512-vxBvAMcwOH+4yZ+cbzW7cGmotq0F0lnpg89uljP0yevg9wZJBOYzvD0FhCErIOYdu8Kz42L9UORshEXPCJ9LiA==";
        };
        _BdIYVPN8 = {
            "id" = "BdIYVPN8";
            "file" = "bluemap-5.25-neoforge.jar";
            "hash" = "sha512-6TwUCq7R77DlPs9+C9Xl8Twbr4yd1Imlchydr8oYONkEA3OlhjeKAmXH+4GZdwkxq+3mQRjqmwiu4i1Gy4N51g==";
        };
        _Z3yDfkrZ = {
            "id" = "Z3yDfkrZ";
            "file" = "bluemap-5.25-paper.jar";
            "hash" = "sha512-pcV8pDEKA4bPb1P75xrozXGGuSkKFqhm8N6eQEuxZRoiPgpwtZMaZ1i6aEoCJAiUF+PiPV3TNybIooPzr8Ks/A==";
        };
        _fdLXBo7C = {
            "id" = "fdLXBo7C";
            "file" = "bluemap-5.25-spigot.jar";
            "hash" = "sha512-h2KICj7Tg1QKIi5FkyidjTXeNG8Izh9JLVzs6eiLHg+J0PsPblO6+84lwXmUOKF1TnL4Ap6NkuVKI0k6/krjmw==";
        };
        _7ZY1OmgN = {
            "id" = "7ZY1OmgN";
            "file" = "bluemap-5.25-sponge.jar";
            "hash" = "sha512-utCMMyAljAUresqGZpXZU0p0THwlERSMDt6NTC+knnvjFeiJRJO8Mx2Ozay1e2yT16PB3axIYG4M9by+w5rA1w==";
        };
        _D2AfEu6B = {
            "id" = "D2AfEu6B";
            "file" = "bluemap-5.26-fabric.jar";
            "hash" = "sha512-vMxCY2lPl60hB8duh11EuPl8GjRZUcijTIXmX7+jUG3zIXI4xRPCsTpQMAv4EFsVOqBXvhyaKR3XDOwo46eytA==";
        };
        _XuND8xy1 = {
            "id" = "XuND8xy1";
            "file" = "bluemap-5.26-forge.jar";
            "hash" = "sha512-wnRaKOQA7CX/eOIsOa1XQicjQiZypeCLPbK3QfIwaiChJJilELfnY26XEj+jPxq5ZMfGMecrcyb+29R9Ewwf4w==";
        };
        _mU8c9dp8 = {
            "id" = "mU8c9dp8";
            "file" = "bluemap-5.26-neoforge.jar";
            "hash" = "sha512-YVV/lK7z0uCmru4ra4DNqdN3IcXqzqerQfmFYFOYRB1GW2Th17auZBju6eqJRclSGsb9VNgY0b7gKrS3zmlZ1Q==";
        };
        _1mgatKkb = {
            "id" = "1mgatKkb";
            "file" = "bluemap-5.26-paper.jar";
            "hash" = "sha512-DFfyv1C2SNDGK5fZMBFgu0TQ1wN2rbNyWZjyAADpY4rhniRGx5aTaVMpfpuo3iz11O5X6f034scbvKhsRV062A==";
        };
        _75LCjwwl = {
            "id" = "75LCjwwl";
            "file" = "bluemap-5.26-spigot.jar";
            "hash" = "sha512-ExsWO8S/VA3g5An+uiWK6GFTpFhp8UiijcWtK3SLfpONVAfm4OEi9WF8YJkA+b+TpV6t7oly3keEG+nx5kIaew==";
        };
        _Eiv8PNHP = {
            "id" = "Eiv8PNHP";
            "file" = "bluemap-5.26-sponge.jar";
            "hash" = "sha512-uDI5OKSr4pV6GEUjOmwOyXrZbZIRVXcEw1Sdfp+u33CIK63i0lWT1/W/uwN0ZuJOflXgaZvgXJV5KwWP8Dwa7Q==";
        };
        _MX0sTM4l = {
            "id" = "MX0sTM4l";
            "file" = "bluemap-5.27-fabric.jar";
            "hash" = "sha512-v8B/acZYK4kpZ+iyzRHDesLK0rGTD34yXJrNbdrTiXUvCC+fPXNeLU4lKPp4iMFS4pweKNz2iswK/TaIKLZ9NA==";
        };
        _L4zG8GIE = {
            "id" = "L4zG8GIE";
            "file" = "bluemap-5.27-forge.jar";
            "hash" = "sha512-UsJSAp9LvdLFzWb857WyI+rdjg/OnxfRVvmML3yD+Ea5e+L+rbFo0ri9Iv1CbFywJaFX7mCMKCKsq7QfesaKFQ==";
        };
        _1EXOwqA2 = {
            "id" = "1EXOwqA2";
            "file" = "bluemap-5.27-neoforge.jar";
            "hash" = "sha512-ENRzkkOZa0DSAzCnhYLvQFcVNR+1C1QxlFldqM6o+bv57m16uoWGZT9Cp/YRPJ8OBLW/YeQqxaR8MVLqDEt8gg==";
        };
        _w7JKRF0Q = {
            "id" = "w7JKRF0Q";
            "file" = "bluemap-5.27-paper.jar";
            "hash" = "sha512-7fhlw8BBIyWu7FUZlZ/7sVttnOZutiK73bPe+WhEzDtie3mup6SO0TkUYT4vOVc82zQv8JMohOSU2frV+nN8IQ==";
        };
        _v6LCJjZF = {
            "id" = "v6LCJjZF";
            "file" = "bluemap-5.27-spigot.jar";
            "hash" = "sha512-9W4BnSsjfucLUjGqujewiHWQMn2VuBLMrFMkKPw+7A8GHyKldR/04e4q0fiuWE2uwYmPeY3CNwZACpUiY20mcw==";
        };
        _gk5u2pdM = {
            "id" = "gk5u2pdM";
    ...
    in {
        ...
        "pkg-1.7.3-forge-1.19" = _BWxhsCRc;
        "pkg-1.7.3-spigot" = _uACYEYTE;
        "pkg-1.7.3-sponge-8.0.0" = _y9Ve4KTs;
        "pkg-3.3-spigot" = _SokCYUxt;
        "pkg-3.3-fabric-1.19" = _URGg6hB0;
        "pkg-3.3-sponge-9.0.0" = _AW5lJn1Q;
        "pkg-3.3-forge-1.19.1" = _XXRac7to;
        "pkg-3.4-sponge-9.0.0" = _waMUVIpZ;
        "pkg-3.4-spigot" = _3wj8RTzr;
        "pkg-3.4-forge-1.19.1" = _PS55jl5H;
        "pkg-3.4-fabric-1.19" = _LyJMFM8L;
        "pkg-3.5-sponge-8.0.0" = _UOpMwohH;
        "pkg-3.5-sponge-9.0.0" = _yqKE2sia;
        "pkg-3.5-fabric-1.16.1" = _tNlxj5PG;
        "pkg-3.5-fabric-1.18" = _hBjGysrx;
        "pkg-3.5-fabric-1.17" = _ugLRPhre;
        "pkg-3.5-forge-1.15.2" = _2WFd5cWf;
        "pkg-3.5-forge-1.14.4" = _mtJ75SMA;
        "pkg-3.5-forge-1.18.1" = _RMHD3IJB;
        "pkg-3.5-forge-1.17.1" = _N0dl95Kx;
        "pkg-3.5-forge-1.16.2" = _WrCRUWHl;
        "pkg-3.5-fabric-1.16.2" = _9lcmJDQx;
        "pkg-3.5-forge-1.19.1" = _11U3y5fk;
        "pkg-3.5-fabric-1.15.2" = _e8DiKZUE;
        "pkg-3.5-fabric-1.19" = _v1Swvpou;
        "pkg-3.5-spigot" = _GPUI8zkE;
        "pkg-3.6-forge-1.16.2" = _W97UU7Cc;
        "pkg-3.6-sponge-9.0.0" = _mECeqevr;
        "pkg-3.6-spigot" = _jUuNvxJS;
        "pkg-3.6-forge-1.18.1" = _prPeG4nT;
        "pkg-3.6-forge-1.14.4" = _liYbFFt2;
        "pkg-3.6-sponge-8.0.0" = _83hq70vg;
        "pkg-3.6-forge-1.17.1" = _oaFy9bqI;
        "pkg-3.6-fabric-1.17" = _LMbFDFqe;
        "pkg-3.6-forge-1.15.2" = _BeSMpDJ1;
        "pkg-3.6-forge-1.19.1" = _8mHvzdsF;
        "pkg-3.6-fabric-1.18" = _5Aup9ubX;
        "pkg-3.6-fabric-1.15.2" = _GOqaepjT;
        "pkg-3.6-fabric-1.16.1" = _n6I6p0gk;
        "pkg-3.6-fabric-1.19" = _n0vYjxsR;
        "pkg-3.6-fabric-1.16.2" = _XFSI9S1U;
        "pkg-3.7-sponge-8.0.0" = _LqPTTlyN;
        "pkg-3.7-fabric-1.18" = _hCB1u23R;
        "pkg-3.7-fabric-1.16.2" = _QgJLcniC;
        "pkg-3.7-forge-1.16.2" = _CNxnb3fh;
        "pkg-3.7-forge-1.18.1" = _O6XzRnJT;
        "pkg-3.7-spigot" = _IyasdBWz;
        "pkg-3.7-forge-1.17.1" = _X8k4lV0Z;
        "pkg-3.7-forge-1.14.4" = _NXYtzDJb;
        "pkg-3.7-fabric-1.19" = _DJXy72ge;
        "pkg-3.7-sponge-9.0.0" = _pzeMSC3a;
        "pkg-3.7-fabric-1.19.3" = _Ib6sSf3k;
        "pkg-3.7-fabric-1.17" = _QcB2I5Vb;
        "pkg-3.7-fabric-1.15.2" = _i7p7l3aZ;
        "pkg-3.7-forge-1.19.3" = _cUySyFAx;
        "pkg-3.7-forge-1.19.1" = _6dItxwOO;
        "pkg-3.7-forge-1.15.2" = _ELmnU68J;
        "pkg-3.8-forge-1.17.1" = _KDw8cu96;
        "pkg-3.8-fabric-1.17" = _gK5jfsXW;
        "pkg-3.8-forge-1.14.4" = _cFRFjNQ1;
        "pkg-3.8-sponge-8.0.0" = _WLqqsMhA;
        "pkg-3.8-sponge-9.0.0" = _k80ZQtpZ;
        "pkg-3.8-forge-1.18.1" = _KN8nB8Q7;
        "pkg-3.8-fabric-1.15.2" = _t02uipuA;
        "pkg-3.8-fabric-1.19.3" = _XRhFIB5c;
        "pkg-3.8-spigot" = _Xo8QzgiX;
        "pkg-3.8-fabric-1.16.2" = _H1MiBOsD;
        "pkg-3.8-forge-1.15.2" = _gjyJir0s;
        "pkg-3.8-forge-1.16.2" = _6dwy531u;
        "pkg-3.8-fabric-1.19" = _asQs08Zp;
        "pkg-3.8-fabric-1.18" = _XaR5vEXY;
        "pkg-3.8-forge-1.19.3" = _4I4I1uc6;
        "pkg-3.8-forge-1.19.1" = _IWbEBUWT;
        "pkg-3.9-sponge-8.0.0" = _ypgBW3NT;
        "pkg-3.9-sponge-9.0.0" = _OwC9qYxk;
        "pkg-3.9-spigot" = _LhHsCVs9;
        "pkg-3.9-forge-1.16.2" = _1XSpcEyP;
        "pkg-3.9-forge-1.19.3" = _GaeVO7pj;
        "pkg-3.9-forge-1.14.4" = _CpDus5xH;
        "pkg-3.9-forge-1.17.1" = _T33LYFxN;
        "pkg-3.9-fabric-1.19" = _zQpr1WY8;
        "pkg-3.9-fabric-1.17" = _PEWFY9fo;
        "pkg-3.9-fabric-1.18" = _M5fZ9gYh;
        "pkg-3.9-forge-1.18.1" = _9W0il9Hp;
        "pkg-3.9-fabric-1.16.2" = _sJftGmsc;
        "pkg-3.9-forge-1.19.1" = _4rYPJsAd;
        "pkg-3.9-fabric-1.15.2" = _N73WUFkp;
        "pkg-3.9-forge-1.15.2" = _Wry6MxSQ;
        "pkg-3.9-fabric-1.19.3" = _qDb1pZV1;
        "pkg-3.10-sponge-9.0.0" = _WS4v1RNJ;
        "pkg-3.10-sponge-8.0.0" = _H41sFJn8;
        "pkg-3.10-spigot" = _IaEsf9KA;
        "pkg-3.10-forge-1.18.1" = _cbP8tIaW;
        "pkg-3.10-forge-1.19.1" = _3NdTSqgE;
        "pkg-3.10-forge-1.16.5" = _g0Ft1ljJ;
        "pkg-3.10-forge-1.19.3" = _dlehUanW;
        "pkg-3.10-fabric-1.15.2" = _fwGfhUDd;
        "pkg-3.10-fabric-1.17" = _pzmxSljn;
        "pkg-3.10-fabric-1.16.2" = _5QM7w4RE;
        "pkg-3.10-fabric-1.19" = _oXkBkUui;
        "pkg-3.10-fabric-1.19.3" = _QCeLBm9O;
        "pkg-3.10-fabric-1.18" = _RQEQInSw;
        "pkg-3.10-forge-1.17.1" = _boaGjgCU;
        "pkg-3.12-sponge-8.0.0" = _TR6G5RO0;
        "pkg-3.12-spigot" = _7aIncldX;
        "pkg-3.12-sponge-9.0.0" = _gqqsa7Mf;
        "pkg-3.12-forge-1.18.1" = _wR5j7NpL;
        "pkg-3.12-forge-1.19.3" = _JBP1yxQ1;
        "pkg-3.12-fabric-1.16.2" = _nWSkwmiY;
        "pkg-3.12-forge-1.17.1" = _UdsahtvW;
        "pkg-3.12-forge-1.19.1" = _huQ3odu5;
        "pkg-3.12-fabric-1.15.2" = _5FdNQZy8;
        "pkg-3.12-fabric-1.19.4" = _OHAKzbDr;
        "pkg-3.12-forge-1.16.5" = _Zby74oPz;
        "pkg-3.12-fabric-1.19.3" = _25FbM7jw;
        "pkg-3.12-fabric-1.17" = _DbEcUWLp;
        "pkg-3.12-fabric-1.18" = _m8BeuP4h;
        "pkg-3.12-fabric-1.19" = _P2QsELdN;
        "pkg-3.12-forge-1.19.4" = _2Ru55irp;
        "pkg-3.13-sponge-8.0.0" = _zqnxIgyZ;
        "pkg-3.13-sponge-9.0.0" = _4P159H4G;
        "pkg-3.13-spigot" = _a0chO4ZZ;
        "pkg-3.13-fabric-1.19.4" = _uip7tqyD;
        "pkg-3.13-fabric-1.15.2" = _M58i4kur;
        "pkg-3.13-fabric-1.19" = _51epxpKG;
        "pkg-3.13-forge-1.18.1" = _5e9EELit;
        "pkg-3.13-forge-1.19.1" = _guHqbtbc;
        "pkg-3.13-forge-1.17.1" = _DVvZXGmf;
        "pkg-3.13-fabric-1.18" = _7DZP34KK;
        "pkg-3.13-forge-1.19.3" = _yzCiqn3Y;
        "pkg-3.13-fabric-1.19.3" = _9IzodMcO;
        "pkg-3.13-fabric-1.16.2" = _4xDa02R8;
        "pkg-3.13-forge-1.19.4" = _V6iHoG5o;
        "pkg-3.13-forge-1.16.5" = _1t6hIEuD;
        "pkg-3.13-fabric-1.17" = _OhRN4WmW;
        "pkg-3.13-folia" = _bP5RASfL;
        "pkg-3.14-sponge-8.0.0" = _VKPcVt6e;
        "pkg-3.14-folia" = _HCyji2oz;
        "pkg-3.14-sponge-9.0.0" = _OaueRLzQ;
        "pkg-3.14-spigot" = _nu6Jcaxv;
        "pkg-3.14-forge-1.18.1" = _jMzLUxEB;
        "pkg-3.14-forge-1.17.1" = _3e4a4Z13;
        "pkg-3.14-fabric-1.19.4" = _B0tRxw5v;
        "pkg-3.14-forge-1.19.4" = _sOi1dCKx;
        "pkg-3.14-fabric-1.20" = _K4zShUjj;
        "pkg-3.14-fabric-1.15.2" = _leyj5mgh;
        "pkg-3.14-forge-1.16.5" = _7aj9m5kL;
        "pkg-3.14-fabric-1.16.2" = _4E5s6PWw;
        "pkg-3.14-fabric-1.17" = _HTGvW0jw;
        "pkg-3.14-fabric-1.18" = _ExMNE88e;
        "pkg-3.14-forge-1.20" = _GvNWfXqb;
        "pkg-3.15-folia" = _rb4WgHCA;
        "pkg-3.15-sponge-9.0.0" = _JGzn3tHY;
        "pkg-3.15-spigot" = _UbQewD6h;
        "pkg-3.15-sponge-8.0.0" = _ifp3lwIE;
        "pkg-3.15-forge-1.19.4" = _DWwcAl0s;
        "pkg-3.15-forge-1.17.1" = _RhVIiEnK;
        "pkg-3.15-forge-1.18.1" = _LjICUV47;
        "pkg-3.15-forge-1.16.5" = _PkH9AXys;
        "pkg-3.15-forge-1.20" = _9WmQXFRT;
        "pkg-3.15-fabric-1.20" = _4XdhQbc2;
        "pkg-3.15-fabric-1.19.4" = _ttkpAJjA;
        "pkg-3.15-fabric-1.15.2" = _EB5YC4zp;
        "pkg-3.15-fabric-1.18" = _sx4oKulu;
        "pkg-3.15-fabric-1.17" = _ckSa8IGD;
        "pkg-3.15-fabric-1.16.2" = _nYHjzbcj;
        "pkg-3.16-sponge-8.0.0" = _DJVGQB2g;
        "pkg-3.16-sponge-9.0.0" = _pwaSFndu;
        "pkg-3.16-folia" = _Lu5Dly0s;
        "pkg-3.16-spigot" = _pD5jmQS9;
        "pkg-3.16-fabric-1.17" = _iYpHRn5q;
        "pkg-3.16-fabric-1.15.2" = _by5tQhfn;
        "pkg-3.16-fabric-1.16.2" = _xgbJLAkQ;
        "pkg-3.16-forge-1.17.1" = _zkTOmbBE;
        "pkg-3.16-forge-1.20" = _lqPY5taU;
        "pkg-3.16-forge-1.18.1" = _mrggf3Wk;
        "pkg-3.16-forge-1.19.4" = _mQDPSGIT;
        "pkg-3.16-forge-1.16.5" = _lOebDNHy;
        "pkg-3.16-fabric-1.18" = _YQrZZlza;
        "pkg-3.16-fabric-1.19.4" = _nmfiJaRT;
        "pkg-3.16-fabric-1.20" = _km6iyWPb;
        "pkg-3.17-spigot" = _rYDqyjM4;
        "pkg-3.17-sponge-9.0.0" = _dulYex77;
        "pkg-3.17-paper" = _3L60jdWU;
        "pkg-3.17-sponge-8.0.0" = _f0g7viBV;
        "pkg-3.17-fabric-1.16.2" = _R1e0iCnp;
        "pkg-3.17-fabric-1.15.2" = _g99mX4Sv;
        "pkg-3.17-forge-1.18.1" = _rDw5YNuT;
        "pkg-3.17-fabric-1.20" = _xgcQSkBc;
        "pkg-3.17-forge-1.17.1" = _lpiV8sZZ;
        "pkg-3.17-forge-1.19.4" = _JnFnvd1K;
        "pkg-3.17-fabric-1.19.4" = _DRS9IxHy;
        "pkg-3.17-fabric-1.17" = _3bp3c0Xs;
        "pkg-3.17-fabric-1.18" = _totk7K7Q;
        "pkg-3.17-forge-1.20" = _ppr95oiu;
        "pkg-3.17-fabric-1.20.2" = _CNjvxHcc;
        "pkg-3.18-spigot" = _OlE6ehFa;
        "pkg-3.18-paper" = _8HWr7OIS;
        "pkg-3.18-sponge" = _cS0c2KOx;
        "pkg-3.18-fabric-1.19.4" = _D9lNwbBg;
        "pkg-3.18-fabric-1.20" = _8vveRYh7;
        "pkg-3.18-fabric-1.17" = _HfYIWcQy;
        "pkg-3.18-forge-1.18.1" = _6FdwcZ7f;
        "pkg-3.18-forge-1.17.1" = _1aQOKVFm;
        "pkg-3.18-forge-1.19.4" = _DdmxAIoN;
        "pkg-3.18-fabric-1.15.2" = _ubROEgtD;
        "pkg-3.18-forge-1.20" = _rNCssbVU;
        "pkg-3.18-fabric-1.16.2" = _RjMMXIvp;
        "pkg-3.18-fabric-1.18" = _GqKSqhqM;
        "pkg-3.19-sponge" = _lIdt6Y8K;
        "pkg-3.19-spigot" = _y68MXUp1;
        "pkg-3.19-neoforge-1.20.2" = _QkJuJCL2;
        "pkg-3.19-paper" = _6bgyrw8j;
        "pkg-3.19-forge-1.17.1" = _Jw0QtE8p;
        "pkg-3.19-forge-1.18.1" = _x0XxP2Gi;
        "pkg-3.19-fabric-1.15.2" = _tmTjl6AE;
        "pkg-3.19-fabric-1.17" = _Ei4doPUu;
        "pkg-3.19-fabric-1.16.2" = _IUU9jefW;
        "pkg-3.19-fabric-1.20" = _UKJqFAVM;
        "pkg-3.19-forge-1.19.4" = _jghNyh5w;
        "pkg-3.19-fabric-1.19.4" = _TLDOhVmc;
        "pkg-3.19-forge-1.20" = _PTswaxBf;
        "pkg-3.19-fabric-1.18" = _8JdS7RTe;
        "pkg-3.20-spigot" = _6KkEPL6z;
        "pkg-3.20-paper" = _pooqAXA1;
        "pkg-3.20-sponge" = _Xg4hcYbJ;
        "pkg-3.20-fabric-1.15.2" = _4u3ZWI4h;
        "pkg-3.20-fabric-1.16.2" = _BeV4Dv46;
        "pkg-3.20-fabric-1.20" = _QjdzVjGq;
        "pkg-3.20-forge-1.17.1" = _L0OymEbW;
        "pkg-3.20-fabric-1.17" = _H2lm7Kh4;
        "pkg-3.20-fabric-1.19.4" = _tKvh8cmN;
        "pkg-3.20-forge-1.18.1" = _JgZF9yB9;
        "pkg-3.20-neoforge-1.20.2" = _tUvGIfJb;
        "pkg-3.20-fabric-1.18" = _wdVWHBWu;
        "pkg-3.20-forge-1.20" = _RHQWSd7S;
        "pkg-3.20-forge-1.19.4" = _ZWZQWCba;
        "pkg-3.21-sponge" = _YrBq0gsE;
        "pkg-3.21-paper" = _qKBCgdOI;
        "pkg-3.21-spigot" = _Qgel0oQB;
        "pkg-3.21-neoforge-1.20.6" = _i6yVskxp;
        "pkg-3.21-forge-1.20.6" = _nWBcwxSD;
        "pkg-3.21-fabric-1.18" = _vijZ28yY;
        "pkg-3.21-forge-1.19.4" = _5gX9S5pk;
        "pkg-3.21-forge-1.20" = _voTvBL3r;
        "pkg-3.21-forge-1.18.1" = _fFnYlJMI;
        "pkg-3.21-fabric-1.20.5" = _RyfTNmc1;
        "pkg-3.21-fabric-1.19.4" = _UHITi6qe;
        "pkg-3.21-fabric-1.20" = _KJdesrDu;
        "pkg-3.21-fabric-1.17" = _EtDSCoCZ;
        "pkg-3.21-fabric-1.15.2" = _VFsJTqaI;
        "pkg-3.21-fabric-1.16.2" = _WMdrKqRA;
        "pkg-5.2-spigot" = _jfArmu5q;
        "pkg-5.2-paper" = _1Xeqsp2o;
        "pkg-5.2-sponge" = _6rKCrVbK;
        "pkg-5.2-neoforge" = _8VAG5fgZ;
        "pkg-5.2-forge-1.20.6" = _Q1i0FwN9;
        "pkg-5.2-forge" = _MFC4ql5h;
        "pkg-5.2-fabric-1.19.4" = _5FszOxDI;
        "pkg-5.2-fabric-1.18" = _CrLmiyFp;
        "pkg-5.2-fabric" = _7qitCWhD;
        "pkg-5.2-forge-1.20" = _Fw5Ktxsr;
        "pkg-5.2-fabric-1.20.5" = _fHB7XbaK;
        "pkg-5.2-forge-1.19.4" = _BqCC8xNo;
        "pkg-5.2-forge-1.18.1" = _4JrLd54S;
        "pkg-5.2-fabric-1.20" = _Pdj9VJT2;
        "pkg-5.3-paper" = _oBLWNpoE;
        "pkg-5.3-spigot" = _TL5ElRWX;
        "pkg-5.3-sponge" = _LVvrMHv1;
        "pkg-5.3-neoforge" = _tStL3eQv;
        "pkg-5.3-forge" = _STvf4Fyf;
        "pkg-5.3-forge-1.20.6" = _CTBCsxGK;
        "pkg-5.3-fabric-1.18" = _rXw4kyFY;
        "pkg-5.3-forge-1.18.1" = _BZXAWEx9;
        "pkg-5.3-forge-1.20" = _aHbq9KFB;
        "pkg-5.3-forge-1.19.4" = _6WbGaYr6;
        "pkg-5.3-fabric-1.19.4" = _yT3V7dyZ;
        "pkg-5.3-fabric-1.20.5" = _sr3EYjbw;
        "pkg-5.3-fabric-1.20" = _lHRktt6S;
        "pkg-5.3-fabric" = _Zpzf0Xab;
        "pkg-5.4-forge" = _1zhVy0wv;
        "pkg-5.4-fabric" = _Ysj3eVYx;
        "pkg-5.4-neoforge" = _5qeVt1YT;
        "pkg-5.4-paper" = _IlXENmUW;
        "pkg-5.4-spigot" = _DB0OeC5p;
        "pkg-5.4-sponge" = _BqimviNz;
        "pkg-5.5-fabric" = _Mvle7bPy;
        "pkg-5.5-forge" = _3lEYCiM6;
        "pkg-5.5-neoforge" = _Hp4CqBgz;
        "pkg-5.5-paper" = _KDFOHrSO;
        "pkg-5.5-spigot" = _Ap3wfaNh;
        "pkg-5.5-sponge" = _GVPdmFIw;
        "pkg-5.6-fabric" = _JmdVHurR;
        "pkg-5.6-forge" = _J7szJc3H;
        "pkg-5.6-neoforge" = _cIURAskn;
        "pkg-5.6-paper" = _Y46AN0fr;
        "pkg-5.6-spigot" = _pmYkP5U4;
        "pkg-5.6-sponge" = _55qwtYgk;
        "pkg-5.7-fabric" = _Dr2hvJBc;
        "pkg-5.7-forge" = _gPUpIIVC;
        "pkg-5.7-neoforge" = _8iJcPOHJ;
        "pkg-5.7-paper" = _NeDjOeW8;
        "pkg-5.7-spigot" = _wBnzat7x;
        "pkg-5.7-sponge" = _8wbKuccL;
        "pkg-5.8-forge" = _CfgbMTFv;
        "pkg-5.8-neoforge" = _rEtTFvqw;
        "pkg-5.8-fabric" = _RRDbiatR;
        "pkg-5.8-paper" = _ocV0Cu23;
        "pkg-5.8-spigot" = _DHMiLjzs;
        "pkg-5.8-sponge" = _hsNeT4xp;
        "pkg-5.9-forge" = _ORdb1z7Q;
        "pkg-5.9-neoforge" = _tIkFwok2;
        "pkg-5.9-paper" = _T7is5pfn;
        "pkg-5.9-fabric" = _fB6f4XRA;
        "pkg-5.9-spigot" = _Cof6r1PP;
        "pkg-5.9-sponge" = _voGC8E6Y;
        "pkg-5.10-forge" = _7BhfPTYk;
        "pkg-5.10-neoforge" = _nLY9ZoTm;
        "pkg-5.10-paper" = _WsrwdFLo;
        "pkg-5.10-spigot" = _ucikJabQ;
        "pkg-5.10-sponge" = _1CEYyi8b;
        "pkg-5.10-fabric" = _e6RaDudD;
        "pkg-5.11-forge" = _MhSuzfg4;
        "pkg-5.11-neoforge" = _hkIow3nd;
        "pkg-5.11-paper" = _bhZhBtEw;
        "pkg-5.11-spigot" = _KZERvvjG;
        "pkg-5.11-sponge" = _vUIj2Lx6;
        "pkg-5.11-fabric" = _plVwynim;
        "pkg-5.12-forge" = _RLlvBbVl;
        "pkg-5.12-neoforge" = _tXZ7uKr2;
        "pkg-5.12-paper" = _LIP9FOJo;
        "pkg-5.12-spigot" = _bmAQnVuH;
        "pkg-5.12-sponge" = _bNFCSUSC;
        "pkg-5.12-fabric" = _d38XhzPO;
        "pkg-5.12-mc1.20-6-forge" = _kC7iYqja;
        "pkg-5.13-forge" = _mBYRhuWW;
        "pkg-5.13-neoforge" = _zhuKhuv9;
        "pkg-5.13-paper" = _wpE4tHiK;
        "pkg-5.13-spigot" = _lfk408pd;
        "pkg-5.13-sponge" = _rT6vYzL7;
        "pkg-5.13-fabric" = _ovtipQy0;
        "pkg-5.14-fabric" = _71GhBvzO;
        "pkg-5.14-forge" = _IemOUhhS;
        "pkg-5.14-neoforge" = _qy5TFR9O;
        "pkg-5.14-paper" = _rUyuQba7;
        "pkg-5.14-spigot" = _2EbixxKF;
        "pkg-5.14-sponge" = _KbEONDKc;
        "pkg-5.15-fabric" = _gpuTeXXq;
        "pkg-5.15-forge" = _WLMP7TUE;
        "pkg-5.15-neoforge" = _GUql08KN;
        "pkg-5.15-paper" = _WyxMyd9G;
        "pkg-5.15-spigot" = _wOxy6bmQ;
        "pkg-5.15-sponge" = _c8D3DfBZ;
        "pkg-5.16-fabric" = _TROfpX7m;
        "pkg-5.16-forge" = _cWApJfHT;
        "pkg-5.16-neoforge" = _F7X1mGES;
        "pkg-5.16-paper" = _Vb2ZE8bR;
        "pkg-5.16-spigot" = _nTnTxZjy;
        "pkg-5.16-sponge" = _skbJoYZO;
        "pkg-5.17-fabric" = _triO13tL;
        "pkg-5.17-neoforge" = _XtPxXt5i;
        "pkg-5.17-paper" = _aENbg99H;
        "pkg-5.17-spigot" = _tJhB0zdY;
        "pkg-5.17-sponge" = _bTEgF5hf;
        "pkg-5.18-fabric" = _77GKAPZW;
        "pkg-5.18-forge" = _ZWcN0R3C;
        "pkg-5.18-neoforge" = _EDCXKja3;
        "pkg-5.18-paper" = _m5VHpHTF;
        "pkg-5.18-spigot" = _JSWwQB4z;
        "pkg-5.18-sponge" = _4IVxE9rc;
        "pkg-5.19-fabric" = _6mX5Ts7z;
        "pkg-5.19-forge" = _9P45rA0M;
        "pkg-5.19-neoforge" = _G4Ew7ZQL;
        "pkg-5.19-paper" = _JuKCQu9M;
        "pkg-5.19-spigot" = _ieoEMcG4;
        "pkg-5.19-sponge" = _vxoqjxl5;
        "pkg-5.20-fabric" = _D9j76thC;
        "pkg-5.20-forge" = _wsiZLBKu;
        "pkg-5.20-neoforge" = _utdgfNlv;
        "pkg-5.20-paper" = _jPyegm5Q;
        "pkg-5.20-spigot" = _yzncnT0V;
        "pkg-5.20-sponge" = _AuiAZ74A;
        "pkg-5.21-fabric" = _9m8tLuL5;
        "pkg-5.21-forge" = _4GNY8O6u;
        "pkg-5.21-neoforge" = _8mtm8cUz;
        "pkg-5.21-paper" = _eM2WNEZA;
        "pkg-5.21-spigot" = _WlKtrEnp;
        "pkg-5.21-sponge" = _GqBBM8uq;
        "pkg-5.22-fabric" = _VTvifNPN;
        "pkg-5.22-forge" = _Qa2SOJwW;
        "pkg-5.22-neoforge" = _1iiFH8V4;
        ...
        "pkg-5.24-fabric" = _xvccCRD9;
        "pkg-5.24-forge" = _Vw9owywv;
        "pkg-5.24-neoforge" = _5e8f3dxZ;
        "pkg-5.24-paper" = _zjZDXCw6;
        "pkg-5.24-spigot" = _STFjPUmV;
        "pkg-5.24-sponge" = _FsUQn95s;
        "pkg-5.25-fabric" = _p8hLlqrQ;
        "pkg-5.25-forge" = _WPKOs9Bs;
        "pkg-5.25-neoforge" = _BdIYVPN8;
        "pkg-5.25-paper" = _Z3yDfkrZ;
        "pkg-5.25-spigot" = _fdLXBo7C;
        "pkg-5.25-sponge" = _7ZY1OmgN;
        "pkg-5.26-fabric" = _D2AfEu6B;
        "pkg-5.26-forge" = _XuND8xy1;
        "pkg-5.26-neoforge" = _mU8c9dp8;
        "pkg-5.26-paper" = _1mgatKkb;
        "pkg-5.26-spigot" = _75LCjwwl;
        "pkg-5.26-sponge" = _Eiv8PNHP;
        "pkg-5.27-fabric" = _MX0sTM4l;
        "pkg-5.27-forge" = _L4zG8GIE;
        "pkg-5.27-neoforge" = _1EXOwqA2;
