...
let
    ...
    in {
        ...
        "pkg-1.2.0-build.32" = _4PM4JbT2;
        "pkg-1.2.1-build.34" = _qhUNOBGp;
        "pkg-1.3.0-build.39" = _hFAkKIdP;
        "pkg-1.3.1-build.41" = _hhhi6Pm5;
        "pkg-1.4.0-build.50" = _L3WXVnSC;
        "pkg-1.4.0-build.59" = _xxkG0Kg3;
        "pkg-1.6.0-build.109" = _Gv2g8LVs;
