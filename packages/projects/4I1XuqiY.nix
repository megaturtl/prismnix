...
let
    versions = (let
        ...
        _YjwgLLSp = {
            "id" = "YjwgLLSp";
            "file" = "entity_model_features-3.3-1.20.1-fabric.jar";
            "hash" = "sha512-GgeB0pGGhCZlW1bgbj/wsEODWH5BzHgiYH15U4IrP4vjI1YgF4sTLix/RxpstAbLUwNkQOKnFeHUhvlpzq6Ghg==";
        };
        _zV6cz7Gj = {
            "id" = "zV6cz7Gj";
            "file" = "entity_model_features-3.3-1.21.11-fabric.jar";
            "hash" = "sha512-X3x3/1RMZ0lnFAu9+2XBxSY1rOnhWHoMX9HPl22oPhATsc3VOagFcYhaBugVtjGTcQDZni95vLaXnVIL6pLCmw==";
        };
        _GcvrFfEy = {
            "id" = "GcvrFfEy";
            "file" = "entity_model_features-3.3-1.20.1-forge.jar";
            "hash" = "sha512-DunpGctLvGnSWYWCPPA8ypDM+Y+8A0K/RZ5j9Cj7J3VRHRT0Us6uSMrQPmlPTRkJgSh62wX7fsyUyopmT0CDMQ==";
        };
        _k1QsbVdH = {
            "id" = "k1QsbVdH";
            "file" = "entity_model_features-3.3-1.21-fabric.jar";
            "hash" = "sha512-vcdFkl9EU2aXL2qH1deJLDbolKKrBn3IqayFvtedoJEbvuMXaViwJj+UdmGjrIqyqgI0V3aFxwheBjys0MxOLg==";
        };
        _bWVaLoxi = {
            "id" = "bWVaLoxi";
            "file" = "entity_model_features-3.3-1.21-forge.jar";
            "hash" = "sha512-IQ1O04t9nsWjW+Fs7/EjL30k5hIyJ7g3RvIBf+/qzxzp/kMZn/5IsPgfoBGPf1wEOBUtjCLJbgGBZKKTikBSRw==";
        };
        _TqVBeoGT = {
            "id" = "TqVBeoGT";
            "file" = "entity_model_features-3.3-1.21-neoforge.jar";
            "hash" = "sha512-Xj18tmgRDtuB43m+ar/9UtMizbRaJ885vWioe0w+bdBk1kLzIKdsKK58xiqWTbJc/LglilI2McGDVPygcQ3h/Q==";
        };
        _w2LUWGIS = {
            "id" = "w2LUWGIS";
            "file" = "entity_model_features-3.3-1.21.11-forge.jar";
            "hash" = "sha512-UQRe74eROl56O/S8dg5j5pM0xsSDqrMimDKleQzFfj031KEwORQmAGd4Rc3aBEsFh9u9FUTogelMpcgQ9X5S2Q==";
        };
        _cjR1rTet = {
            "id" = "cjR1rTet";
            "file" = "entity_model_features-3.3-1.21.11-neoforge.jar";
            "hash" = "sha512-zC8ay1xVOeP9d8Omp2/E6oOOYmOscnadXy/Xici41vrDH/TZhXZakpbdYGfbiV8Pp2xzsyYkB4GApd7O5uBHQQ==";
        };
        _WoH4IntR = {
            "id" = "WoH4IntR";
            "file" = "entity_model_features-3.3-1.21.3-fabric.jar";
            "hash" = "sha512-olYt3EkuUk00/P8H7+0HjoqT1owsUkg7kEL1ugc0w7zJcdsTX6frOyLioFkpBngfIGbW+NOpTZl2l/ZV4Y6PPw==";
        };
        _XpyjZqac = {
            "id" = "XpyjZqac";
            "file" = "entity_model_features-3.3-1.21.3-forge.jar";
            "hash" = "sha512-3F1/J7ZZXpk5KAwnviR6UMtAyRgY55S+r9bEZEz4cTrx8HikRtglJDZjN5H315lhC2J+ymrdrn30WulJX7L2Fw==";
        };
        _PWpFJjf1 = {
            "id" = "PWpFJjf1";
            "file" = "entity_model_features-3.3-1.21.3-neoforge.jar";
            "hash" = "sha512-6XS7ctZ4utMyD+arRAFifwRx8wxkmhd3SlpjU8H3LXcBZRTd/tsHQHshzfAAjqLT9tSJxXLc/zpoPiKwzbKZMQ==";
        };
        _aJhPmQZE = {
            "id" = "aJhPmQZE";
            "file" = "entity_model_features-3.3-1.21.4-fabric.jar";
            "hash" = "sha512-GWDtq+BkMdyeHMyqT+AdgROowRisCkursIzEjhWHG+dfTsn5/HHXa+3SNPaPclyzDiuiEMi4xcf+LPOqQLnAjw==";
        };
        _nrwmY2K4 = {
            "id" = "nrwmY2K4";
            "file" = "entity_model_features-3.3-1.21.4-forge.jar";
            "hash" = "sha512-lHduvahT4SdxCeeyxYegzNbeSHnfDY+0SdYFH1SlUVDvxYM4qIhu79NLydD5DDgwpmOmb8hl1AzoSXq01b6mmg==";
        };
        _IXmP6Cm0 = {
            "id" = "IXmP6Cm0";
            "file" = "entity_model_features-3.3-1.21.4-neoforge.jar";
            "hash" = "sha512-kxfnTaeO8gWBPhDHn41cPj8xtlPDTRvn6vRRfzLcMPFikuwZzJC5vcHnj+GJNEiCMecVcViQcFPflasf/nO1UA==";
        };
        _kS0L6gX4 = {
            "id" = "kS0L6gX4";
            "file" = "entity_model_features-3.3-1.21.5-fabric.jar";
            "hash" = "sha512-9bP6Pm+qgn5YJbbgYEBIpkbNmqdfTRItR9KNmhaEvK/Phfd+orwidxya4jstM1Ls5upzJ6PMhD4urV40/B0MJQ==";
        };
        _qBSMeBs9 = {
            "id" = "qBSMeBs9";
            "file" = "entity_model_features-3.3-1.21.5-forge.jar";
            "hash" = "sha512-I17yhZu/eeNW4mpWOfauVblY9gqXdvbft4xqYowcOfiDJbhXtkO3HOrhN9sV+JuKfnL0bmNb2VKTRBd0UO4Ukg==";
        };
        _8rdpclqI = {
            "id" = "8rdpclqI";
            "file" = "entity_model_features-3.3-1.21.5-neoforge.jar";
            "hash" = "sha512-ZlFAstKPPY+UfPmjIZggCyplNy/K8rMBh4m2Dmu+4e7v1Hab0ei09WtGCqjBO/kyiIK2ZF0D3lJrgMO2DTQxjA==";
        };
        _r7htVMlY = {
            "id" = "r7htVMlY";
            "file" = "entity_model_features-3.3-1.21.6-fabric.jar";
            "hash" = "sha512-W3mxoMQa5jBZG2n3b9iaPBYh2EzK7bcLLq6uEWenPc6G3J/htKMWw9XbAj5X9/dQkMpJx4yQiQQaWndv/p++Vw==";
        };
        _gIqCuIXT = {
            "id" = "gIqCuIXT";
            "file" = "entity_model_features-3.3-1.21.6-forge.jar";
            "hash" = "sha512-kVjEd6CNhHVWo4vtlk5u2vi6Gd0poXnS7nMtMgZvlyw9NfiqQPZeH/oCOwozRlmsTaqGAe2Imv/G/yi6SowCDA==";
        };
        _htYJqpYr = {
            "id" = "htYJqpYr";
            "file" = "entity_model_features-3.3-1.21.6-neoforge.jar";
            "hash" = "sha512-Z21LNefRmc5q9PmisNWphgJaIBbioq2lhF1dfJ5kRCx0LT41nCykBZRrSW9yRz9VQ8XBDadQlHLMr2XcPxwT0w==";
        };
        _veZMhr8J = {
            "id" = "veZMhr8J";
            "file" = "entity_model_features-3.3-1.21.9-fabric.jar";
            "hash" = "sha512-Lml551DQUeF/26SBtnHUBfeOVo/7HRgk9wtoEnk8BV3XIoYvn8Nx41vEDe0QsC2ev7iIyflo2q4ihPBAh+Ov+Q==";
        };
        _yi8ZP6CX = {
            "id" = "yi8ZP6CX";
            "file" = "entity_model_features-3.3-1.21.9-forge.jar";
            "hash" = "sha512-wifkXYoryoIYR8Ij1wkEnMW3NMdlV2DL5BBgnQJSmPWMSUrWp5eVXGS0OqDlKjxYRCvaWFPkmdaUzI5Bo/YO2A==";
        };
        _MfV2XyHV = {
            "id" = "MfV2XyHV";
            "file" = "entity_model_features-3.3-1.21.9-neoforge.jar";
            "hash" = "sha512-ZiFE4adyMKw5N+inbJ+Mb8Kxy33H2Veyn9pUe+y7gaznDK1U5Zz/nD3v3WQwQGy140l1uE8tJdTyl5UCVDfrcg==";
        };
        _QSLPrO2f = {
            "id" = "QSLPrO2f";
            "file" = "entity_model_features-3.3-26.1-fabric.jar";
            "hash" = "sha512-GVJK1Sn/6ZDdrtMyzdtGkxn/in9BSp5/jsfIRVQB+gBFUpa0eHQqjdwYhxjoHM6Ce+kIcW/y+brCxxpAMeIDMQ==";
        };
        _GYu73iPJ = {
            "id" = "GYu73iPJ";
            "file" = "entity_model_features-3.3-26.2-fabric.jar";
            "hash" = "sha512-/5bZ8oPpfRUpn7cMkgp2DQHzaGBBYDb/f+enGFhrOimeYW5wHd191aNmbRtDkLwO4378uXjFOLl38TmADphwbA==";
        };
        _Psz2rruD = {
            "id" = "Psz2rruD";
            "file" = "entity_model_features-3.3-26.1-neoforge.jar";
            "hash" = "sha512-tzmeVo/Lf73F0lVOAY8ZOn9h9Cp56lvuStxUnOztVAGRjEwwECeZxb8pc2bjmOvNMdWYPaF5/TFx8YVd3lip/A==";
        };
        _1nuGyOBC = {
            "id" = "1nuGyOBC";
            "file" = "entity_model_features-3.3-26.2-neoforge.jar";
            "hash" = "sha512-1jZTq7pweJxaXDFxX3ttR7yNvvv4Vg3kp8F9IJHxmJhASeOO2U9r0BAgQJmmajvG0IOPICfxYnOAW84AUHlRag==";
        };
        _e3rC4B72 = {
            "id" = "e3rC4B72";
            "file" = "entity_model_features-3.3.1-1.21-fabric.jar";
            "hash" = "sha512-i+QsUlalpIYePjWkc7Mq8i5fI9FXrNjB1tML8hbmg+e2zzBkKVg0KQPEuLQI2zpn+CioxqOnStiUU5IIoOiQPQ==";
        };
        _rHGuG5Tm = {
            "id" = "rHGuG5Tm";
            "file" = "entity_model_features-3.3.1-1.21-forge.jar";
            "hash" = "sha512-b6Spx/v9TNsKAw3/EDnmvbnxvoIEgnx3olvG1SRwSHe8DSJwaZuDp/mUYpxrTFyJ8fg7L5gVOPrjBB8TKdZg5A==";
        };
        _Mjqj6j81 = {
            "id" = "Mjqj6j81";
            "file" = "entity_model_features-3.3.1-1.21-neoforge.jar";
            "hash" = "sha512-UKiOkP/fl+iFu5r1eN9a61dt9fr/oFD+WlcZJHJUc7ZOsWYIE0Eb/pV1Rz+HlaexhlB6apoxJwTFsAwCbW6ByQ==";
        };
        _u6vdO2Sx = {
            "id" = "u6vdO2Sx";
            "file" = "entity_model_features-3.3.2-1.20.1-fabric.jar";
            "hash" = "sha512-+fV2S3lbCPbw0CwgUqpZoqbJjhVrTsT75mapS6R3vx9zkAWvXriPppfbXDDPO33RmuYNRcnredcL7fx2U3deCQ==";
        };
        _i0VAklRD = {
            "id" = "i0VAklRD";
            "file" = "entity_model_features-3.3.2-1.21.11-fabric.jar";
            "hash" = "sha512-4bQxielse9yYghWZcggovZGJRf7Vh0xTexX3sE4vXg40UZhlcY+mwDDCk+1hgCRDrnqhk+A1DgcXoLEeHWDIcQ==";
        };
        _oBVAnJx9 = {
            "id" = "oBVAnJx9";
            "file" = "entity_model_features-3.3.2-1.20.1-forge.jar";
            "hash" = "sha512-ionDIWQQHFTPc/J2HsABFP2L8fyaSrw+cCehDm59F3ycHrwMIYahZtiIYiumY1Ai2mpA/SQN0ATL9RWciO+iyw==";
        };
        _OPoRR9IG = {
            "id" = "OPoRR9IG";
            "file" = "entity_model_features-3.3.2-1.21-fabric.jar";
            "hash" = "sha512-FoNZ4ez1r3uP7/BZ8XBWH9cHSVrhWlzVNJsijkX+4j5XPicHnJ6k78xr2vi+jNKp0SrCDW+gp2Nj6iMkFSl7WA==";
        };
        _pCR2VcW0 = {
            "id" = "pCR2VcW0";
            "file" = "entity_model_features-3.3.2-1.21.11-forge.jar";
            "hash" = "sha512-eBQ71/WPfKJvfWyxQexkxuhz3B2t7Wyy/ezsPG9BctGcSGgfQakoSgoUUiSNeCi13jtYIy7rAI8+qMODqMnPnw==";
        };
        _HXEPGlzC = {
            "id" = "HXEPGlzC";
            "file" = "entity_model_features-3.3.2-1.21-forge.jar";
            "hash" = "sha512-YT9sVLtJaYKINxaanUqzLA8wHEZBWKpaUfyaiNrF/rOKOUq+H+3dEe5X52jSWju+9wHrm+R8lFAi94jtdCgwPg==";
        };
        _Uh4XJhLL = {
            "id" = "Uh4XJhLL";
            "file" = "entity_model_features-3.3.2-1.21-neoforge.jar";
            "hash" = "sha512-enIiNnsg9lVz5mrA2kHt38Ya8qzXcWCMk1UhFmBanCDe1brljzX9FzF9yDH/TLS4yD5GnYcbO9V0fOeoiGif8Q==";
        };
        _MkByfKvN = {
            "id" = "MkByfKvN";
            "file" = "entity_model_features-3.3.2-1.21.3-fabric.jar";
            "hash" = "sha512-gFImbCvbt09udPvSzwB5Igdy5w+vC1rghW0D/dnRkkcfeNEPPTFdExvnszYf+kMsdi7BcMJYLZZ6usPpDNlYbA==";
        };
        _26JvtZX5 = {
            "id" = "26JvtZX5";
            "file" = "entity_model_features-3.3.2-1.21.11-neoforge.jar";
            "hash" = "sha512-Qq878YJYwcgTQ1yXJwV871Pw5ysrcf/Y2CBpmtY5h21GGsJSpUca4W+vMOO1N16MkO0l4mFEW2gpOE1fMI1LCw==";
        };
        _AUXNMptu = {
            "id" = "AUXNMptu";
            "file" = "entity_model_features-3.3.2-1.21.3-forge.jar";
            "hash" = "sha512-Qw464rFP8sg7qfhRDgbLKzdQ3AH//hFBQk/G2W329vNQIqfLo0IIHcDvo2+xJLo3ITFh+m7+qmevAghS4QWaMg==";
        };
        _HhLLpPil = {
            "id" = "HhLLpPil";
            "file" = "entity_model_features-3.3.2-1.21.4-fabric.jar";
            "hash" = "sha512-GPogUiHUYuB1H40ahFteTT2/dCXGrbrh5i4oT4IrZlOvgwXJ9Vf1Lh2vQy2tYpCRBZtjJwJV8qOvzeiBxCjk+A==";
        };
        _wR3yw0fF = {
            "id" = "wR3yw0fF";
            "file" = "entity_model_features-3.3.2-1.21.4-forge.jar";
            "hash" = "sha512-7Y18GWadaxmPU7HqKjCgMszgOTp6fKUM5lN9+cUshoMDWi+/xr26LrXoH6ofKH6vp1k78RYVjszQ7ziuqzr05g==";
        };
        _BtF251e2 = {
            "id" = "BtF251e2";
            "file" = "entity_model_features-3.3.2-1.21.3-neoforge.jar";
            "hash" = "sha512-kblqJKmxn1yVAJlEFiH5sypKslnTHlQP2411ec/OEBIDL9RhOd5HK+QTdziPecJuC7GGK4ekCUjwuSMLUSzgJw==";
        };
        _ojFqGq9T = {
            "id" = "ojFqGq9T";
            "file" = "entity_model_features-3.3.2-1.21.5-fabric.jar";
            "hash" = "sha512-Y5fr7S6M5huAPGM2rhDIbrRP9/32XegclWiF2gjw1riLObpSMvxAlqndCWvmhwO5Y57EyP94RpztCrE9jiE0XQ==";
        };
        _72pNm8sf = {
            "id" = "72pNm8sf";
            "file" = "entity_model_features-3.3.2-1.21.4-neoforge.jar";
            "hash" = "sha512-BMhxta5pIe/2YQ/eQlSgp6bAx1EZhRrIH5adczvcZk5OstOzIsqH8SCB+QB7pSdVLmbWutEYNYNWpyzIZteM+A==";
        };
        _1nXdlnA7 = {
            "id" = "1nXdlnA7";
            "file" = "entity_model_features-3.3.2-1.21.5-forge.jar";
            "hash" = "sha512-5t6GIN/C0v7lCpxKgGpoQV6hcFBTHWbGNDo4geK3r7QzuMWumzkEGZj4eV4Wtt9moHF2+ft7TzJ1L9Xt2kGaVg==";
        };
        _owEDXGSU = {
            "id" = "owEDXGSU";
            "file" = "entity_model_features-3.3.2-1.21.5-neoforge.jar";
            "hash" = "sha512-Nf80YC0z9MUDsOuaqYmBlo8L62FVaNZSqUQLwh8WrmFF+shhPpMi+OjRGYJeIZjQQt1BkISyxrSHGgusCsJN9Q==";
        };
        _qZWmYixs = {
            "id" = "qZWmYixs";
            "file" = "entity_model_features-3.3.2-1.21.6-forge.jar";
            "hash" = "sha512-WjkP2iIXlTfeXiSuTiusygMp4fUlOkBjsObG4N1p3h4klmnHfOV9JiYg6iZhENWOPwP2zl7IbM6he63jmY+4/Q==";
        };
        _cNbHncan = {
            "id" = "cNbHncan";
            "file" = "entity_model_features-3.3.2-1.21.6-neoforge.jar";
            "hash" = "sha512-XXotHAmq5yaE+ZlB3FXM1uor1PefBh3zKxjA/vVy3O3cyvRb/PpeGMf8SGIY7Mmq1sfK/zgi9MGeemx81rkfAQ==";
        };
        _BphQkfJ2 = {
            "id" = "BphQkfJ2";
            "file" = "entity_model_features-3.3.2-1.21.9-fabric.jar";
            "hash" = "sha512-wFaHUMAONgsmrCEbmatOuNqGGs+B/b4MwLgdJUpgXqadost2KN14Z0rs1qtnXn23/7F1yV6zBT3HAHSJsYxqgg==";
        };
        _XOrlxubx = {
            "id" = "XOrlxubx";
            "file" = "entity_model_features-3.3.2-1.21.9-forge.jar";
            "hash" = "sha512-5FbXxjLMXqvAw9pfPFqmG2mfNXqnwJ4fcgdMCvRR72DX5nMkhZUKs5J/ly+8ilvUy8mnULPwFri+vCElGA5VHQ==";
        };
        _oVeljWVY = {
            "id" = "oVeljWVY";
            "file" = "entity_model_features-3.3.2-1.21.9-neoforge.jar";
            "hash" = "sha512-1JP5F9Q4PNe3k+9WAV2RcP7hauOVwvBXp8LSWAK5tjEbLDRj0a/jUjfW0+qDma4qZ3eSAT3FonvDQeyMFKLqaQ==";
        };
        _niiFKZm5 = {
            "id" = "niiFKZm5";
            "file" = "entity_model_features-3.3.2-26.1-fabric.jar";
            "hash" = "sha512-5ZBXamqvE1DN4HABKO4Mw/EUVUaUDif2Lkatq6NaQce5YdPjRMKPlVqrtdB3unz8IYJgBuRn81KUxOWmFYpFuQ==";
        };
        _mbqUK066 = {
            "id" = "mbqUK066";
            "file" = "entity_model_features-3.3.2-26.1-neoforge.jar";
            "hash" = "sha512-PZecJWilp5tHLfJsCFYmzSarRlzd5RAMCuXe7tPYly4b64hvqUUF/huvJMpOD/iW4UuG+M9JV2Fuvo5Uk3g0Ag==";
        };
        _88bD57NA = {
            "id" = "88bD57NA";
            "file" = "entity_model_features-3.3.2-1.21.6-fabric.jar";
            "hash" = "sha512-TrMp/MWmVlv691xJNvD9a7oP4QuJTM1BnWhKzsVIuJFHV/RAE5vKLlkYuK0+InV+rn9gh+pzvQkvuwbF8WpIvg==";
        };
        _cYdpAV48 = {
            "id" = "cYdpAV48";
            "file" = "entity_model_features-3.3.2-26.2-fabric.jar";
            "hash" = "sha512-iwSZlqlTnS825oUAl1JjN+EavwFI/UIEip11hgUOy2Cn/x0MwsGmp2W26LOj0FcAHomPD1wiTfUIxCTeMwqt2Q==";
        };
        _WjUZiSit = {
            "id" = "WjUZiSit";
            "file" = "entity_model_features-3.3.2-26.2-neoforge.jar";
            "hash" = "sha512-7Ntw5IPoil+z4es0y4MEWpLyj2IA7hDYajxyVRQdH4PxpeO7YdFiGRZ77qb+4QUbXvg9lr1MFroslT8oguO09w==";
        };
        _35uT4Vyh = {
            "id" = "35uT4Vyh";
            "file" = "entity_model_features-3.3.3-1.21.11-fabric.jar";
            "hash" = "sha512-/UP7b7lWp8lj7Z8/mv8B1uTMP9Zd0zPSitLc35BZBIdvs30YFPd/dYkTgQw5+jmolCKOOpJDlPbURrGDk+Ss4A==";
        };
        _J1TRbBhb = {
            "id" = "J1TRbBhb";
            "file" = "entity_model_features-3.3.3-1.20.1-fabric.jar";
            "hash" = "sha512-olLGx8wimvZBQhHVaTbZXddov09RpNsjF+vPSLTg1cTrm+7EM8UJkU0N6zkxr5cMpV+deOpuMHFZlyz4Xuq1uA==";
        };
        _BIX7ZlxN = {
            "id" = "BIX7ZlxN";
            "file" = "entity_model_features-3.3.3-1.20.1-forge.jar";
            "hash" = "sha512-wxP8fXQzldE+WKg/+1gMU63LlVFwLIKeo5zb+2mULD916nc76FlojfWGyjHzBRDl4b1MXM9sTb8LvvcthqMOIg==";
        };
        _Slv3pGvf = {
            "id" = "Slv3pGvf";
            "file" = "entity_model_features-3.3.3-1.21-fabric.jar";
            "hash" = "sha512-7q5V+VLjQBQTP5xh40K8GGOtLarPu8V7xvHuVwxEBTU/RAes954FrMvL1w7q/5a+nJ0gkDfoJmM+qp8L3bWgcw==";
        };
        _RxGoCy2c = {
            "id" = "RxGoCy2c";
            "file" = "entity_model_features-3.3.3-1.21-forge.jar";
            "hash" = "sha512-mAnAVVCUfUUHxb59RTFmorkZRwB3eTa9QF9YCQExnIoHKH4Re5BtQaBLbj5/jhrreUduQmA0S+eLLEM16s7D9g==";
        };
        _Maxn59zo = {
            "id" = "Maxn59zo";
            "file" = "entity_model_features-3.3.3-1.21-neoforge.jar";
            "hash" = "sha512-9UXr0AP0QyrUU+Gt9FJ/PT/bkRYDmUiEiuAblR0FpGQO+emLMamftkNQv0nURb3GIf6j+x+UpOeTm+dF2/Q4Kw==";
        };
        _YYi44ujo = {
            "id" = "YYi44ujo";
            "file" = "entity_model_features-3.3.3-1.21.11-forge.jar";
            "hash" = "sha512-EdIwfUF/0ysMHWd8s3WOU5GSYdQIccN5zp36it06dr0egfA0rWQoEpAemy/O08rZsFxfwWYp14aWdx/0mGi7DQ==";
        };
        _E20ucMfl = {
            "id" = "E20ucMfl";
            "file" = "entity_model_features-3.3.3-1.21.11-neoforge.jar";
            "hash" = "sha512-Ld49Q8o96p1SUr1HehoG7PG2RKKoFMILc4/t5xozKokN93/XcfhsjDze46LSW6UmM6m0ZbkueJopwQDZlNxudg==";
        };
        _qdf9VP90 = {
            "id" = "qdf9VP90";
            "file" = "entity_model_features-3.3.3-1.21.3-fabric.jar";
            "hash" = "sha512-f567oUErryHecPLit83nNSHngYjiWf2iq6UrjPLUlyW63Rhj+yoiraLIGIB7neOoSsmEqEgiz4cp1XcyO8PVxg==";
        };
        _l7rk4PJG = {
            "id" = "l7rk4PJG";
            "file" = "entity_model_features-3.3.3-1.21.3-forge.jar";
            "hash" = "sha512-MZwJ+VdjQ2eIdzxzAiWvKA11NdkHn6i6KVxjU3TN0RiSX1W6bviF1Jq785G89k1WE+E5qyT0yDQOA7nX4XfYtw==";
        };
        _kaecdUOb = {
            "id" = "kaecdUOb";
            "file" = "entity_model_features-3.3.3-1.21.3-neoforge.jar";
            "hash" = "sha512-+ixJxBPY6BxFGpmRROF5YLjCR48AVIwsE+bYwfeEeQTdWGnKvRqvXz89RD0hw6Resv6fkfqXcxBgjvA75ZUTKw==";
        };
        _Xka6KYTL = {
            "id" = "Xka6KYTL";
            "file" = "entity_model_features-3.3.3-1.21.4-fabric.jar";
            "hash" = "sha512-dMFeAQQtjWyf9P7iwzQNp7nhlJaksg2+zOhZNmsUxOv9bJ6JB/zdU3rUilwqSaseNZMXCWjT/65yrzt4yXmduQ==";
        };
        _zhOmxY7d = {
            "id" = "zhOmxY7d";
            "file" = "entity_model_features-3.3.3-1.21.4-forge.jar";
            "hash" = "sha512-8j32FPXFKh04CP3xzOliF0st3liz1XujH7Rvib1uW4nv1S+9kLUTamIg9c86G27ziFKTv6Y/E8cfOGnkjUZzAg==";
        };
        _ySjKSyTZ = {
            "id" = "ySjKSyTZ";
            "file" = "entity_model_features-3.3.3-1.21.4-neoforge.jar";
            "hash" = "sha512-I5py2XN6DhlVp3uOQGKOmLK5ay594IU3vVZDpk5zyd8ngNxiFKKztLp51Fkh1wyvK47hLy2iuJp5nBg1DDE8AA==";
        };
        _z50mgBnc = {
            "id" = "z50mgBnc";
            "file" = "entity_model_features-3.3.3-1.21.5-fabric.jar";
            "hash" = "sha512-kalvb9oR5OL2Uud+oeqscrwOOBJHTsiNO4t0fbIZ+vDCT2P6qBA9gLN0ul8OYrmxHCBzmkGCUC02LPY5nUAZaQ==";
        };
        _6u46ukpk = {
            "id" = "6u46ukpk";
            "file" = "entity_model_features-3.3.3-1.21.5-forge.jar";
            "hash" = "sha512-c7+6YG4Fgwh6EInJtAxYdJaz4DwMuc/0Ng7h0Ofz3XBy0dxPLKabO9ya1TQGMXPukZcKjpWMNqNbCvND+AbW8w==";
        };
        _rfoGaNrj = {
            "id" = "rfoGaNrj";
            "file" = "entity_model_features-3.3.3-1.21.5-neoforge.jar";
            "hash" = "sha512-62G4CxQfgpzmT6P49zdk0RmGILZDIkOyxC4rQqXBRMXOcnalIgGDHeIGlLjTrVKWsNv6kaeeTlo1bSqmRmSlYg==";
        };
        _gmxBsvv6 = {
            "id" = "gmxBsvv6";
            "file" = "entity_model_features-3.3.3-1.21.6-fabric.jar";
            "hash" = "sha512-o3l1aCRyRlMlyCkBt0wgimbGQAaAAGKfYhh4K1jCebsLArW5ptcIGzMhHfjeU2NZminMyu0jheix77BwBcwIrg==";
        };
        _fWNjqokZ = {
            "id" = "fWNjqokZ";
            "file" = "entity_model_features-3.3.3-1.21.6-forge.jar";
            "hash" = "sha512-xKwEoYDHnV0Gr03WocSpkWgf2NkubuNhnJ6ARAC7yb6gpLZhrVdtGn+o5ApI7JMlIT5SXcdnNQw82mkZET56jg==";
        };
        _OcAAuoEj = {
            "id" = "OcAAuoEj";
            "file" = "entity_model_features-3.3.3-1.21.6-neoforge.jar";
            "hash" = "sha512-UrrG7RKpHS39/y/jiBeAb+K8WIomuDIcyl7Oa8F38AEmoxoJ1fs5Mpz+ZvTpgfbO3Eu/sZthisxsIDepMPZ0cQ==";
        };
        _2NWYC1XD = {
            "id" = "2NWYC1XD";
            "file" = "entity_model_features-3.3.3-1.21.9-fabric.jar";
            "hash" = "sha512-x/+jOGTGQMOeped36f48oeK7wz1LN0/DpSYsyvqbcQ2X5JcDV1ClxlrA3qIts/bAO/TzYHJiDek3w/zME9TR4A==";
        };
        _TOxEYtXS = {
            "id" = "TOxEYtXS";
            "file" = "entity_model_features-3.3.3-1.21.9-forge.jar";
            "hash" = "sha512-2A3XWlBKk8wBeDzJPD3Tq9Kwq9YUI5lkUPtB4d1m5Mias90r7S6pr/X7oWk6UOMmclriXC/OzO6RI2IT4kAUNQ==";
        };
        _XRkQrQI2 = {
            "id" = "XRkQrQI2";
            "file" = "entity_model_features-3.3.3-1.21.9-neoforge.jar";
            "hash" = "sha512-mxp2q294U51vtOxDKduVCijNC1Nd9MNxqYqqnsuLtkyOus3VOb3kpZ1QoeHbPH5AU5OVL/80f/m7qUgl2aaMGw==";
        };
        _1Sjlmp3n = {
            "id" = "1Sjlmp3n";
            "file" = "entity_model_features-3.3.3-26.1-fabric.jar";
            "hash" = "sha512-iCidluw7mAt04RVFCfjBZSH7rx9395L6ZOEQgCtR7OtntX64EnsRFF/wPyNGBCYZZ7PiHjfzoeO+TgJCNjDmeg==";
        };
        _Nblc53K6 = {
            "id" = "Nblc53K6";
            "file" = "entity_model_features-3.3.3-26.1-neoforge.jar";
            "hash" = "sha512-XyN89ep5ylAC23OXMMKpOgyhuObCnY9fPV1Kw14dEZM6pk3sz2woqLStenkv31yJmk1+BnKs98ZwRFUAlRMTHw==";
        };
        _75LlyGi8 = {
            "id" = "75LlyGi8";
            "file" = "entity_model_features-3.3.3-26.2-fabric.jar";
            "hash" = "sha512-J60fCqnM3w7sisUlAv4Gh8p9tXWfIImfOPbfRHrw41S1xAChhejlroAiO5h5Qkc/Opq2yOBRLL9HLPPHUOnVGw==";
        };
        _bqwRKZmt = {
            "id" = "bqwRKZmt";
            "file" = "entity_model_features-3.3.3-26.2-neoforge.jar";
            "hash" = "sha512-ooR2wPZdyV2wuPIB+QHZxSM8Uyri0c8201KVdvu6k+bNKFROiIJLpK1K/46NGVT566bsS0A0K2Ppu0djZvKVhw==";
        };
        _dI96AXLI = {
            "id" = "dI96AXLI";
            "file" = "entity_model_features-3.3.4-1.21.11-fabric.jar";
            "hash" = "sha512-SfY5x3pXMXpljTAUFr8zmhpUMiTHk8SW8kR/5xPZoHcbTCTi1TxbA511tZhcWtCp95ZAqxyFIbkZCX3nyR4U1Q==";
        };
        _jfQbHcrM = {
            "id" = "jfQbHcrM";
            "file" = "entity_model_features-3.3.4-1.20.1-forge.jar";
            "hash" = "sha512-PLdeyWjCFRDji+hNyyhSklEVeJ+o2o22cr7+6SBwaLRuRg3XFNael9qX3gVu2ioonLck/bw+fGjsk8Vdajpsuw==";
        };
        _TE68K1JY = {
            "id" = "TE68K1JY";
            "file" = "entity_model_features-3.3.4-1.20.1-fabric.jar";
            "hash" = "sha512-c3R9liKCnHPKQVbh514fEK4LbhDj3d2Ui8YiJWZ+4FoOk565CC9dUOz6pgIPm9jcNZYBFmpOBmDfp/BM0Xr2sw==";
        };
        _wussJIdB = {
            "id" = "wussJIdB";
            "file" = "entity_model_features-3.3.4-1.21-fabric.jar";
            "hash" = "sha512-xrImANj6RnbWhI+le42Fi0/NRbdKqhWv01Ed9hERbxm9fb8M4YAhyEBR2pF2zexQTv6D5DUiY7PomEIdz8fA+Q==";
        };
        _PN45pqzw = {
            "id" = "PN45pqzw";
            "file" = "entity_model_features-3.3.4-1.21-forge.jar";
            "hash" = "sha512-4eDjoAoCH9ausobAT1OqideCYR7ht2hNUgWRJyFlJJ5yJUi9BW0dHKtLD+iv1xdgw269HaJCqBiBhm1j97fXtA==";
        };
        _VfDcs0fz = {
            "id" = "VfDcs0fz";
            "file" = "entity_model_features-3.3.4-1.21.11-forge.jar";
            "hash" = "sha512-kE7uuoJJkpQel+R4JIzzFgvSXeRtyHSLvWqHA1emknhc7mTPNKIYbDocMCDeBpNNtgP+xotSXSgyviFApefT9g==";
        };
        _51bupM32 = {
            "id" = "51bupM32";
            "file" = "entity_model_features-3.3.4-1.21-neoforge.jar";
            "hash" = "sha512-pZRXvgeu8Iiuc/5R8X2CQYUDyyDCtWlzoeLntC9l1fjsVqyXQXmjKYpGXd+rZJb9auO8/ESrsik8QTdJXHUVhg==";
        };
        _TUqyvqOI = {
            "id" = "TUqyvqOI";
            "file" = "entity_model_features-3.3.4-1.21.11-neoforge.jar";
            "hash" = "sha512-EjIWRUTRl6KXhYH9mvVAgwBkZYpGj7n6BqVZmrLsGPF/9h72HoG6MoBu7VQvX0ucdtoTBldZmEbX51ncgharUg==";
        };
        _qlqmGqo8 = {
            "id" = "qlqmGqo8";
            "file" = "entity_model_features-3.3.4-1.21.3-fabric.jar";
            "hash" = "sha512-NnZs3nwFx8XlCCyhzKkkPvp/haVJNhZ4wcfdLLbcZ1ZJbNw1p1Inm5osJZrVkvjz1YncogZe9KeEvhbQRJXJjQ==";
        };
        _eNJIeO3q = {
            "id" = "eNJIeO3q";
            "file" = "entity_model_features-3.3.4-1.21.3-forge.jar";
            "hash" = "sha512-qqP3OEdvj8v+p2xwYHoRi2x7X1Rn+yPPRPqk0MqJc4ObPlAtxu/ngDq/VppcGebvMZ+XLfL6C2IeE+gbgDOLtQ==";
        };
        _1zOQF5wK = {
            "id" = "1zOQF5wK";
            "file" = "entity_model_features-3.3.4-1.21.3-neoforge.jar";
            "hash" = "sha512-wHzNbSPrXnSSz/RkqkNl4LRsvVPRt5YgBslEsL7xJku/ZjULicbf8S6uXBdK5UlwTwreo/Ix5VYAsyl72icA0w==";
        };
        _g3CW0Xwv = {
            "id" = "g3CW0Xwv";
            "file" = "entity_model_features-3.3.4-1.21.4-fabric.jar";
            "hash" = "sha512-NIFf0yBJxyiswbYAkWBVEQoC3uUrmLvTrPz+avU0IBLuKGfM7u3cHEk6+RoaIY0PynubeG8d8hFvoEQz88PcQw==";
        };
        _TAKsyMrN = {
            "id" = "TAKsyMrN";
            "file" = "entity_model_features-3.3.4-1.21.4-forge.jar";
            "hash" = "sha512-amAKVR9NCjaWEo09zsdFrjHkXpkR1jDUtAeixmi5l6U3FDez1Q0pDoBZbed8clSYSjaoQKIcHyh0Vm61RhnR7Q==";
        };
        _JHYdSNW7 = {
            "id" = "JHYdSNW7";
            "file" = "entity_model_features-3.3.4-1.21.4-neoforge.jar";
            "hash" = "sha512-IMKo+uQQjN0eYF3HGSareB+6NddBe5OiioX3VQ31Tz2GDhmtJUQ9osgTV6hQ6v3TvchYk3tXlJnOOsbDyUfXyg==";
        };
        _nhIlYb3o = {
            "id" = "nhIlYb3o";
            "file" = "entity_model_features-3.3.4-1.21.5-fabric.jar";
            "hash" = "sha512-f1JXm1LBPgYcnnzoGmFpvEB48EuFz6+hoivJyM/LUCTCrO18X8SVsq45pN8lWNmjFDwr3n5X1xw/FXVadvze6Q==";
        };
        _lI29irmQ = {
            "id" = "lI29irmQ";
            "file" = "entity_model_features-3.3.4-1.21.5-forge.jar";
            "hash" = "sha512-euacF8oxryFVftG2gcSvzzdgNsBY4ywjR25Y7Hs0zU2x7x9grEK9CwypFFZRsm7aTT8fN1Vgt9KQSQlwtjLEqw==";
        };
        _T7cNlNl0 = {
            "id" = "T7cNlNl0";
            "file" = "entity_model_features-3.3.4-1.21.5-neoforge.jar";
            "hash" = "sha512-96gOX5pizcRn8YYU9rpnggJwyFhDVdWndrhQ+Iol87ETl2+IpzSXjj9Sja/kWPDpZ8/4CRHLd20QYAUPsjKZUw==";
        };
        _ecvpWmOj = {
            "id" = "ecvpWmOj";
            "file" = "entity_model_features-3.3.4-1.21.6-fabric.jar";
            "hash" = "sha512-cX3ZIbQjyQF6Et6BmmX16JJcbRLExbKO3QwA1Hwxv6pTfRClUO/UPzt4+e4+mqGAITv527smb9XG6CEPjVlIPg==";
        };
        _VF8Pp6Hh = {
            "id" = "VF8Pp6Hh";
            "file" = "entity_model_features-3.3.4-1.21.6-forge.jar";
            "hash" = "sha512-b/9WnZgDo3stMHfV1pvRGWduRbkxdzeQ6r8J1aH0YBtFrXF1g+qMlKCXxt3ZxD1Vw5exJaIjR/8yfn8gwad8+A==";
        };
        _blCCfC0o = {
            "id" = "blCCfC0o";
            "file" = "entity_model_features-3.3.4-1.21.6-neoforge.jar";
            "hash" = "sha512-wXEgPVn1IXkwtrltNNXUPHQTQrx6YumQD5BNFLGsYNiAU1UXaYgyNMpkYt2n0y+NBRU6I7xfvZ2nR1Z4/R7u4A==";
        };
        _rgdEjIl4 = {
            "id" = "rgdEjIl4";
            "file" = "entity_model_features-3.3.4-1.21.9-fabric.jar";
            "hash" = "sha512-Ra6Br5hVZzJ4EOdMNSfbTa/u0ITDsoUCDKpeUevK4hxAix0R5Ji8GKrhdYqPw/6HEfwNafcdY96pwtJKmPUdHQ==";
        };
        _mMdk3CfI = {
            "id" = "mMdk3CfI";
            "file" = "entity_model_features-3.3.4-1.21.9-forge.jar";
            "hash" = "sha512-9U7vl6ULwgf4W2rdzuZFAUhLLEtn6HVK734ZsQ5WA/ZkIevUqnWDKfCViWJ1dnTM2Tk5uBkP2QHtC6BV1I8mtw==";
        };
        _e3f6zF8j = {
            "id" = "e3f6zF8j";
            "file" = "entity_model_features-3.3.4-26.1-fabric.jar";
            "hash" = "sha512-Jr1WE62+wReWKTqTpDyqJ5wu/qPGcHP5vef8Mor1vKtpz7KSnTvnk31ieipCahQVRkajnqhtmplT2qMATiUKNg==";
        };
        _Q6tI9UMs = {
            "id" = "Q6tI9UMs";
            "file" = "entity_model_features-3.3.4-1.21.9-neoforge.jar";
            "hash" = "sha512-Dy3smMWEbVBn6ZCQPz8VjQqtXlmR846hfVPhr+cEGaCqTeSx3hG9C+Fo/PUPRz14bgylwDkeM87N567l6CDfGg==";
        };
        _EWboPjCr = {
            "id" = "EWboPjCr";
            "file" = "entity_model_features-3.3.4-26.1-neoforge.jar";
            "hash" = "sha512-BxUaIZIIOfy1mpxYiDk1pxWmfho/3C14qFWHGIdkraP70onChqbifx1iELfoBnN28iB9yGViW4OICHPQB2j4CQ==";
        };
        _buPQdDt5 = {
            "id" = "buPQdDt5";
            "file" = "entity_model_features-3.3.4-26.2-fabric.jar";
            "hash" = "sha512-FEcD3NGNuErASnBtw/4khg8WcodaGhqcImvMRpci/9qkiIq4NgUzkh4L3ubGvCNrYYTJeFSrMBcOGbMs4jUg1g==";
        };
        _ixGterOL = {
            "id" = "ixGterOL";
            "file" = "entity_model_features-3.3.4-26.2-neoforge.jar";
            "hash" = "sha512-XozmUvc2i9WnxHVZmI/32DFu2ZdtXU2l9NK+6GA2+AxWWjcMnlU9WpuUszBusiX5NAA4MWEP891tq0xkxGDZ1g==";
        };
        _Ym9Qq1ZU = {
            "id" = "Ym9Qq1ZU";
            "file" = "entity_model_features-3.3.5-1.21.11-fabric.jar";
            "hash" = "sha512-0ue95yUcdghy4p7JN0Pr34xxXEaURES7q0hdebU2k4nPR6j5qZtq+gNu/9hi4rySCldKr6eoJBP9wyQdfdHjVg==";
        };
        _YbR2h9og = {
            "id" = "YbR2h9og";
            "file" = "entity_model_features-3.3.5-1.20.1-fabric.jar";
            "hash" = "sha512-H92pWIKwTnuPG0ZimXwd0BFTJZM/3elogoJet72y1P8/Oef+o1iX0caPSYLI6LAZY8qBMdmb2eX9T1MywpqltA==";
        };
        _CMN1owfw = {
            "id" = "CMN1owfw";
            "file" = "entity_model_features-3.3.5-1.20.1-forge.jar";
            "hash" = "sha512-alAn/rzSCcS8Z0NGUwR56lKwik8hbVyeCY8kr60Pd60vi1azo9ZCKQ35uU7u21wk6VSimdij/YI9QLsygx4Bjw==";
        };
        _wXNAvHgN = {
            "id" = "wXNAvHgN";
            "file" = "entity_model_features-3.3.5-1.21-fabric.jar";
            "hash" = "sha512-FpDUkdjSelSGCFC7k9Jn7g4dngEp1IkCdJj1aC5kFvdcMLxk8C+hs/QqAANnGHGxjY4fbbQeD77r4Ip4+bKvuQ==";
        };
        _GgxEdDYE = {
            "id" = "GgxEdDYE";
            "file" = "entity_model_features-3.3.5-1.21-forge.jar";
            "hash" = "sha512-Lgsa1xrSC2oW05C8Zor78oSdYc25wtPe8EVbP5FO9ZHS2m3Yrh1iSNxhlx7igizcTntkWQNT+dxbLjW85fGGKQ==";
        };
        _fuQI5nyf = {
            "id" = "fuQI5nyf";
            "file" = "entity_model_features-3.3.5-1.21.11-forge.jar";
            "hash" = "sha512-wHIqW/XW8u54YRRknmhAWEBqGNf8P03IS00yqsNmEcvmRXXC8Whi40aFcTzkzuWtsAWBpHWyygw5uXy69wczZw==";
        };
        _szv0UmJn = {
            "id" = "szv0UmJn";
            "file" = "entity_model_features-3.3.5-1.21-neoforge.jar";
            "hash" = "sha512-aHYRg6Lf/uCZgA03aeqj8sjxVrLDAQLyBCK0iRS+kU2akpypWDfPAcLQdmebKR4zgxiTiuT8knknklBhqs4kgA==";
        };
        _Gb7hFNKJ = {
            "id" = "Gb7hFNKJ";
            "file" = "entity_model_features-3.3.5-1.21.11-neoforge.jar";
            "hash" = "sha512-4B+rKpnekugYGaPcje4CxU7inAGNsRQ20RaZ7JGesjDldthxJQouJt2QjnSAPYCiLTnr3TDW02fffyq8ocUP4A==";
        };
        _4VDWv0Jd = {
            "id" = "4VDWv0Jd";
            "file" = "entity_model_features-3.3.5-1.21.3-fabric.jar";
            "hash" = "sha512-ZkEnCQUJLErSvr6nOnVa08t8L3NJWJe8lIVQB9+YbdutebmBVxjAYwl9u2IPoUMykJK2C9QGJNJpWejix2gZHQ==";
        };
        _Kt7hxteV = {
            "id" = "Kt7hxteV";
            "file" = "entity_model_features-3.3.5-1.21.3-forge.jar";
            "hash" = "sha512-A6Z3Qws7+uh90Fe4XtKFtdbm52w6ZfEuMl2f3tmP7dqzJuS8GAFV35BgF1huiW8tQQbabsXcXQHVE37kGA+Upw==";
        };
        _pFMUhhOE = {
            "id" = "pFMUhhOE";
            "file" = "entity_model_features-3.3.5-1.21.3-neoforge.jar";
            "hash" = "sha512-GgNggb/NtmaK8c4Fs0AJagWfc4kD/Cv5UHTBVF9hbb+ZGleRIYo/sWQmI/tynVYorReQq+CQRATiK5LsUWRjWg==";
        };
        _QvGbZnzN = {
            "id" = "QvGbZnzN";
            "file" = "entity_model_features-3.3.5-1.21.4-fabric.jar";
            "hash" = "sha512-cFphRjzSBXoRg4fK/zln46bbosrBxkIfG7Ss0OKt9+Zu1hKvW9NDoxjFkyuaXQv91OI6pANXB6CBV3vLuPchFg==";
        };
        _EjTzPuK8 = {
            "id" = "EjTzPuK8";
            "file" = "entity_model_features-3.3.5-1.21.4-forge.jar";
            "hash" = "sha512-N2BxdRjlykTjunFTAkUdZ3K6CDYvQhIIDdWRivUEv4mwU2EE/4CSzucjvYbAPyAu8NLDc6h/o2EPQivlDbkgSg==";
        };
        _ulnlx0aQ = {
            "id" = "ulnlx0aQ";
            "file" = "entity_model_features-3.3.5-1.21.4-neoforge.jar";
            "hash" = "sha512-QKt7r+HoynhDpLiYFou6au8iC3vnj0jDuEyGbhDD+XraE4HBspsOTFSRsjfN1fM3Hnffr55+nxXYC9F9O0OLEg==";
        };
        _ZVhVNNE2 = {
            "id" = "ZVhVNNE2";
            "file" = "entity_model_features-3.3.5-1.21.5-fabric.jar";
            "hash" = "sha512-n4k+w1V0aU+mQ1OrmnCGt0b50N3jKC3RkqoZSSlh3l6tzS77m9Lw5OduFzotFNDSFc5TZnZdA1EQHOgpyJjOsA==";
        };
        _y5vniHYS = {
            "id" = "y5vniHYS";
            "file" = "entity_model_features-3.3.5-1.21.5-forge.jar";
            "hash" = "sha512-NyLLcrsE6YcZSPCZozbqjkVZ0RaGBuAIlL2LHb96ovxU9IsBtjQFMMWDmvDonEhy8A2avY6tGObbv2/lH0aecg==";
        };
        _PoCQ6Mny = {
            "id" = "PoCQ6Mny";
            "file" = "entity_model_features-3.3.5-1.21.5-neoforge.jar";
            "hash" = "sha512-zOPaUtLMM8MrY4VYbxffTmkas84KUUDzM2IZl6S7h6GTcQgb80wmJ5Pyjxot2ZqbuIW6FPMOPbpp5PDdjZ+buQ==";
        };
        _uPN3IxXg = {
            "id" = "uPN3IxXg";
            "file" = "entity_model_features-3.3.5-1.21.6-fabric.jar";
            "hash" = "sha512-/6/+mG83m2oi83pthV31qdiqsK0uPXUIpCSPIglc1M086pZ5U75NLl04VwEZixifbGbzp78aqQvDq8ki/Yp7ng==";
        };
        _lBl8Ei9P = {
            "id" = "lBl8Ei9P";
            "file" = "entity_model_features-3.3.5-1.21.6-forge.jar";
            "hash" = "sha512-j7/LJUTi2P1+uVIuxBX/IIvKGAd0ZsXvnXKv4dTLjwFQ9n4jfBUV2hoQl+zyRZM69dsf71cTY2FFiYa3BYSCtQ==";
        };
        _FUPVoVkc = {
            "id" = "FUPVoVkc";
            "file" = "entity_model_features-3.3.5-1.21.6-neoforge.jar";
            "hash" = "sha512-BGrrcY3QeQwEa7Qmq4sNp03wa2yPvIhoPEGGLMj/AtcjTeD5fStrCZ70aoaAhotwVvPVFIAXBuVuFi39+3YJnw==";
        };
        _2pJAsUpA = {
            "id" = "2pJAsUpA";
            "file" = "entity_model_features-3.3.5-1.21.9-fabric.jar";
            "hash" = "sha512-IA8CQWyeBXHeM+ay+o7x8TieGnKO3M2VVf2tIkBMWmvB8S2H3hHHswC8g/Ho1QOL0OomDWPg2kY+Zi4RrkI+/Q==";
        };
        _mwJYhC79 = {
            "id" = "mwJYhC79";
            "file" = "entity_model_features-3.3.5-1.21.9-forge.jar";
            "hash" = "sha512-u1AxOD4BkBfqO6QzZgLYCJrfPPHQwH3UujrP1V101XQHNe4nWreELq3Hu32GFvbLyUVrqNZelFK2qgvJoAojFA==";
        };
        _pzEsrdVv = {
            "id" = "pzEsrdVv";
            "file" = "entity_model_features-3.3.5-1.21.9-neoforge.jar";
            "hash" = "sha512-hGlrQLSc2ULq6C0w7RDC/B5R4XMt7ENlt1WkQQWEJoMmzgemQYUFwUMX03sUut3Q76omglavRYfqcVbynYPQrw==";
        };
        _SrQK3uuO = {
            "id" = "SrQK3uuO";
            "file" = "entity_model_features-3.3.5-26.1-fabric.jar";
            "hash" = "sha512-wcc9Wh+O6jh5ztx0Icdscus40OekZKTecGUUURVEB/XtlOJpVaXz86OMEHwr/WkvcQHp3kHAhFPlBSpLZGl77g==";
        };
        _4SuwJy4Y = {
            "id" = "4SuwJy4Y";
            "file" = "entity_model_features-3.3.5-26.1-neoforge.jar";
            "hash" = "sha512-jrEhWc5S6bbBOiW+ehDJX7phB3u871dXAGC3suiOE+J+IMT31klzT4WMZS3T7cdFbtznv0RpI2Ix20kxeR1UdQ==";
        };
        _p8M0c1vN = {
            "id" = "p8M0c1vN";
            "file" = "entity_model_features-3.3.5-26.2-fabric.jar";
            "hash" = "sha512-7lmOBwPLFRZu01+T4tGeadW+4WByHFDM3iABr+zuJEcHRL0u/pEl6QghHlj2ClQHTpFfK3Jstu5w3D6Y9GmMew==";
        };
        _7Wx3KN9W = {
            "id" = "7Wx3KN9W";
            "file" = "entity_model_features-3.3.5-26.2-neoforge.jar";
            "hash" = "sha512-ttT5MZQ7FuREnD4+jITLr2HaqGYPQZOLODE0owv2IOD6jEH7wm4yYNTbA/AStDH4gDxoGR2JquPlmfjC9jm/vg==";
        };
        _CG0GqFOp = {
            "id" = "CG0GqFOp";
            "file" = "entity_model_features-3.3.6-1.20.1-fabric.jar";
            "hash" = "sha512-s4aI+r9NOuAY1QrJJFQzWSodtCtzj87Nw3u2ECorz20wKHC33AhnDs1eHXi8migyNSFrJAiTJ/0wkSKx/URUWA==";
        };
        _TnZnflpQ = {
            "id" = "TnZnflpQ";
            "file" = "entity_model_features-3.3.6-1.21.11-fabric.jar";
            "hash" = "sha512-+FAuE2Ec8bE5iRyr2mTfgPdHbg9MOLKYPPUH9Gb/7+O8s5OmbnjfMBAb5nROuG5YUvbZ9hhZHD2EN7n3KOKV7w==";
        };
        _XjgE1yBe = {
            "id" = "XjgE1yBe";
            "file" = "entity_model_features-3.3.6-1.20.1-forge.jar";
            "hash" = "sha512-H6VIp+OuZ9ZcUMPopmnJmnrVNIX2NrV/MvspxJQebQVggIo3pFPygwMrlyGMBJIh2YBFmMk4RzSv1heQF1vJ2Q==";
        };
        _vmwUIH7O = {
            "id" = "vmwUIH7O";
            "file" = "entity_model_features-3.3.6-1.21-fabric.jar";
            "hash" = "sha512-AjTH+bj7oazCSXg/bOOlnHs9ssuf200h6JQRmjtLspvan5qZRux9xha6J5fZLg4COVnF9uxigsILcX0MzKoQ2w==";
        };
        _OqbqhUeC = {
            "id" = "OqbqhUeC";
            "file" = "entity_model_features-3.3.6-1.21-forge.jar";
            "hash" = "sha512-L3aSKXtc2T3JZGRlDbT58kLCjTQOPRRoluwF9ujXfcJzCkMbWhMtGD7t94ZN+RF/Ok+5BHUSDOSjcaqz8HKYaQ==";
        };
        _8RgqbCVN = {
            "id" = "8RgqbCVN";
            "file" = "entity_model_features-3.3.6-1.21-neoforge.jar";
            "hash" = "sha512-D4Zze9BDXdly/hf8KyYfGyuJHWpUDWyyR8d19IUBOKra+I9f3AkRakYDcaLn5pcBTJ/GqV7XFlaegG4OZzcnsA==";
        };
        _lo0Bpmdv = {
            "id" = "lo0Bpmdv";
            "file" = "entity_model_features-3.3.6-1.21.11-forge.jar";
            "hash" = "sha512-hFFCj36QJ6jbFn5Owh6dXuGvzm+7du+z20B251GAdLLWpnbjZthYoya4iky2jKQLVNxqSrPYtK3iExZtdcxCRQ==";
        };
        _GzVxT3Jx = {
            "id" = "GzVxT3Jx";
            "file" = "entity_model_features-3.3.6-1.21.11-neoforge.jar";
            "hash" = "sha512-bdawnwm7GqImMRC4gzLXxSct8ENtwWt9Em6rjoO3O1GWv5DyJL0lBpKt0nHb5BM3B+n2eMHqARLvUYp1ytF9DQ==";
        };
        _WH3lw1Si = {
            "id" = "WH3lw1Si";
            "file" = "entity_model_features-3.3.6-1.21.3-fabric.jar";
            "hash" = "sha512-tCtwx/ITXZdhV4GUzO7kIbPogKSP3neeqAC/7VuE9fqDOmjnqh28Qyv2emBB80ajD4eTzpmGLOIJTmxJFsZ9mg==";
        };
        _BSwXmchB = {
            "id" = "BSwXmchB";
            "file" = "entity_model_features-3.3.6-1.21.3-forge.jar";
            "hash" = "sha512-23+CA6lGXM1oaYfrN5rB514ew9lMseFS8o7bUt6y5Mul49Uou6kC8oSioxX/fLH8c+w3GLRpeVM5LZVXxozgxA==";
        };
        _VFdxe241 = {
            "id" = "VFdxe241";
            "file" = "entity_model_features-3.3.6-1.21.3-neoforge.jar";
            "hash" = "sha512-obxwre2xw2Fz+JXEv1LP13oNH+T8G63pmKX5hXGRWGFNTYNuTrdu+2FPcBK2S01DPpzUqqRWLUK3gj3M4S2WCw==";
        };
        _8ZE5NorK = {
            "id" = "8ZE5NorK";
            "file" = "entity_model_features-3.3.6-1.21.4-fabric.jar";
            "hash" = "sha512-gc4U7wWA/G/ojI1FlpQqzS9Kx0xP5Ut1ZVWV5vLxoLMP5WQ8re1kofQjqC0/jf5YEQztvIS6T9KkLSvH6ZpN9A==";
        };
        _RKxgkQFh = {
            "id" = "RKxgkQFh";
            "file" = "entity_model_features-3.3.6-1.21.4-neoforge.jar";
            "hash" = "sha512-FS7W4YCh+gUgeCDcSIepdoDKZBohSiqJeaelq90/XI/+RgnENdoayr3a2tHLtM7ayslW8HY3QT7sTaCJe5ngtA==";
        };
        _iL3n4fkJ = {
            "id" = "iL3n4fkJ";
            "file" = "entity_model_features-3.3.6-1.21.4-forge.jar";
            "hash" = "sha512-rNlhhrOsk0bNzOFKkjq0fuyrD8I21DLacKI7nAEZjdaNtNeN4pEHL8a2xvUcVbVEOcxawi+wHkfEV/YYRf/GUA==";
        };
        _GASjJZKr = {
            "id" = "GASjJZKr";
            "file" = "entity_model_features-3.3.6-1.21.5-fabric.jar";
            "hash" = "sha512-JcfcvOBQMkCox6XbK22VLeuWSKDdZADkRZdlG4ppQjgdJ/bjSnZePKhIqT07zsgFLBku8TsajBvwbi3gGhljGA==";
        };
        _HKQMdvJ6 = {
            "id" = "HKQMdvJ6";
            "file" = "entity_model_features-3.3.6-1.21.5-neoforge.jar";
            "hash" = "sha512-e+om+o7wuJMzpmBqcgMcmiT4+WfzAvsbgGkDnmKLufzyEnr3Ikdfw0d4H3r1teZC7cvuVmVxxcjHwB6zRt/2Bw==";
        };
        _ae1OLOzX = {
            "id" = "ae1OLOzX";
            "file" = "entity_model_features-3.3.6-1.21.6-fabric.jar";
            "hash" = "sha512-R/PRlSbC9mMBpVZz97lsXh9NAg3Cu86KeE/2n+DgeOFfZ+ypqfg9qjA5P+O2dDY1r26iGlGmkZKOYrYSnyJy+g==";
        };
        _t1QF4Lag = {
            "id" = "t1QF4Lag";
            "file" = "entity_model_features-3.3.6-1.21.5-forge.jar";
            "hash" = "sha512-CKrffLPjHk5PUziZMZjHwnClregXwIrlKKa9ya0br8xBK49MFkhIn0EQWRIbjdky0LMBaL7uPamUO4vo6P1xug==";
        };
        _j4UOmh6s = {
            "id" = "j4UOmh6s";
            "file" = "entity_model_features-3.3.6-1.21.6-forge.jar";
            "hash" = "sha512-B/bktgF7t64UxveBBXBdN2yA4p7rzlbBLCGg5fu8p/RpE7COz5syqZSOvyPwf27YShrDvHcMwbVHolURDXJCgw==";
        };
        _12AEcTuD = {
            "id" = "12AEcTuD";
            "file" = "entity_model_features-3.3.6-1.21.6-neoforge.jar";
            "hash" = "sha512-730ggB8K0fzt+dyoftFidPTxx3hIM/egKSiJNJKt5vhY/Rg/7u5GoeqifIROXJT07u9vIQ0Ca5yqun/aE4eEAQ==";
        };
        _NHlbKbFQ = {
            "id" = "NHlbKbFQ";
            "file" = "entity_model_features-3.3.6-1.21.9-fabric.jar";
            "hash" = "sha512-uf3hT0bc6AdBw1brH7UaSC7H5LW2ExKynDwXb7q6DxJMWOevpKykYC8rpBpBXloLfIb+4eLQPYU4VuS2YYwvVQ==";
        };
        _hfXzqNj4 = {
            "id" = "hfXzqNj4";
            "file" = "entity_model_features-3.3.6-1.21.9-forge.jar";
            "hash" = "sha512-FCUncgz1koc1SpK01XmjaQLQ/CTCw795AuUVCdW7x2aGGt+8sIqz6FhXA++Bk5UKqFBLLV6cMnOUZoDmZOamcw==";
        };
        _tx81t3kl = {
            "id" = "tx81t3kl";
            "file" = "entity_model_features-3.3.6-1.21.9-neoforge.jar";
            "hash" = "sha512-/rb0wlK9ZfmxuVDnP7rhKVVaV1stJCGRMjaAnjtnfUh1rw1Fms1ZTh8ageGshyBd9UYbUXMZknEhequEFnFafA==";
        };
        _x608KQlq = {
            "id" = "x608KQlq";
            "file" = "entity_model_features-3.3.6-26.1-fabric.jar";
            "hash" = "sha512-vslme+LyJOM1fpZoR4v4SYx0weMe9Xxn1B6NYKCnok52eciU7VnWzkurSmBPthYPynlICo0bgWkUbvkNkl4Tbw==";
        };
        _MGIqQNww = {
            "id" = "MGIqQNww";
            "file" = "entity_model_features-3.3.6-26.1-neoforge.jar";
            "hash" = "sha512-CVz6sE9IKNbNKp3DH3++AYOEo59jpUfnQNF9DFni3BJkn0AT6ULuswIzog99jlrJM6arhQHriB4r4dRdJ+r5oQ==";
        };
        _QjGIDlyH = {
            "id" = "QjGIDlyH";
            "file" = "entity_model_features-3.3.6-26.2-fabric.jar";
            "hash" = "sha512-U5LS5ibJ7hDCQOdOEp5/I3BG4MKEOpDzuR85K3+9G/JW6eL9feWvBUyv+JF5aFRXNYJNcxW6hPJo1KnvqUmIOQ==";
        };
        _gfsJrXHb = {
            "id" = "gfsJrXHb";
            "file" = "entity_model_features-3.3.6-26.3-fabric.jar";
            "hash" = "sha512-VlWK1uDgZrBR01CpFsAVvITS3yrV4WZKmKKWm28+tplB3lUMKTU6ziwgVtTEqRBRiliWLbDQXt9eDtJInU306A==";
        };
        _PFycDEaa = {
            "id" = "PFycDEaa";
            "file" = "entity_model_features-3.3.6-26.2-neoforge.jar";
            "hash" = "sha512-qVs6N7iSLX15PFg0NeqDVoXM0U7SLoDHuWigBBgB8qs2RSyPZ/Ple0qNOZGCpblM+nL1E1txc4gTOGI15DLZ6w==";
        };
        _eO4YXm8k = {
            "id" = "eO4YXm8k";
            "file" = "entity_model_features-3.3.6-26.3-neoforge.jar";
            "hash" = "sha512-q6BR0a5uxxl6qFT27WBPJM3ll8/eKmksFXrL0wd6kz0FkhLjr1B7GMbCok2gePr6ab5vgaJdTfS3ECRGJbzB0Q==";
        };
        _lneAv26x = {
            "id" = "lneAv26x";
            "file" = "entity_model_features-3.3.7-1.21.11-fabric.jar";
            "hash" = "sha512-HUrqrOKcCkurff0calZYVIYlArH93hQCn9tiBG/QAo/1/ZIedTazKqvmx0jxmUkO6Wxfy40Gbze5OgMnzrjdwA==";
        };
        _8dz1ftwT = {
            "id" = "8dz1ftwT";
            "file" = "entity_model_features-3.3.7-1.20.1-fabric.jar";
            "hash" = "sha512-yHTt4jPX+rKzixkkHZonU2UhgXvR3gGXGp5ppDWeiXaI24UFpIQMFbutPEiVRs6Pta7zFQHr5b3ABNEgA2fE5w==";
        };
        _OkTiZTIn = {
            "id" = "OkTiZTIn";
            "file" = "entity_model_features-3.3.7-1.20.1-forge.jar";
            "hash" = "sha512-2SzF8pjvrTbsGJv+PBP/khfge27wwVCrP+sQT5kQvZkyfh7yKp7mJ/Ioogm7Mqd/JuvnTPK2lSw6Bz2ROYgv2A==";
        };
        _26kdY29I = {
            "id" = "26kdY29I";
            "file" = "entity_model_features-3.3.7-1.21-fabric.jar";
            "hash" = "sha512-8Wgz0LMVX7Ul3RsJkeHAS+fBu/brGUdbhlY1/if0H4T3Hp0syyT0DoW4/Ne/eu6GZomyj3LPF0a06QvZ5vzuUQ==";
        };
        _84t6tej9 = {
            "id" = "84t6tej9";
            "file" = "entity_model_features-3.3.7-1.21-forge.jar";
            "hash" = "sha512-5L3ceUFE199RQYtfvkGUrPeKbUSViZkz+e/t4ERrFtWRmPrc6vp3Lfwywmp8//dxq+qosyPApwcrY6xojUvHAg==";
        };
        _5AMSii6O = {
            "id" = "5AMSii6O";
            "file" = "entity_model_features-3.3.7-1.21-neoforge.jar";
            "hash" = "sha512-x6qBODdzCQqphScC43SjbQV+HpmJw9w1d1oSkHMBhRyetv4fH5lhl7HTc6dETH7Wst+5hI/l5PBQFJjMV8jcXg==";
        };
        _95htO7Lk = {
            "id" = "95htO7Lk";
            "file" = "entity_model_features-3.3.7-1.21.11-forge.jar";
            "hash" = "sha512-X1YrwqnV79nfTZ1ruYPgGPyZgnIMTRF3O4xuz/iUbSXBTyJscSL6iylLbn3DawBG7d6r10pXKE9mY8rdoMaIdA==";
        };
        _gcfz6g5Q = {
            "id" = "gcfz6g5Q";
            "file" = "entity_model_features-3.3.7-1.21.11-neoforge.jar";
            "hash" = "sha512-zErxLtzGNVqWF8Li2Apres8olGEKpceylhe/C9glvb8m9OYk1ztXtrLvXcqZvUCHDvILQqVoNco52aCq2xdkmQ==";
        };
        _9SE7zyuj = {
            "id" = "9SE7zyuj";
            "file" = "entity_model_features-3.3.7-1.21.3-fabric.jar";
            "hash" = "sha512-s8zFYrN5Ohw4QDpJZvkX7pQJE1axNVNjl0GXb2o3Qh+kSoxu/Xi3hsQZAQF0I6uwJK+6ncrlsm8jKAHjQOZejQ==";
        };
        _d7hZc9Sz = {
            "id" = "d7hZc9Sz";
            "file" = "entity_model_features-3.3.7-1.21.3-neoforge.jar";
            "hash" = "sha512-ZmpbcJNt7kr0+ca/R1aFSoCP7aVDLvh7pcwwAu8MNgOqDMRbJXIHA0mbd7ZQbFqSkhiuU2a5OHa7U+WNNIsBFA==";
        };
        _ZVjugDVw = {
            "id" = "ZVjugDVw";
            "file" = "entity_model_features-3.3.7-1.21.3-forge.jar";
            "hash" = "sha512-QfnIcZL42PEQqM8PwNu37jkXjekLwOuge/zh5NmvYuDk7ukXldkz+kVzbgbiKsPj0Xh9Sb9PWAwu1n5lXvcC1w==";
        };
        _mCljDXsC = {
            "id" = "mCljDXsC";
            "file" = "entity_model_features-3.3.7-1.21.4-fabric.jar";
            "hash" = "sha512-M7T4XGicu/RW60Qsv+g1cBRojeUrkkeA9QCweqHrD1dPDQnOP2QZzn6RnxK3NCZfmydQVFKI4t/xxmz7Ctp2Og==";
        };
        _8XjTylNf = {
            "id" = "8XjTylNf";
            "file" = "entity_model_features-3.3.7-1.21.4-forge.jar";
            "hash" = "sha512-W5pRsDu7MVUbNy2dklVrsrd7oxiRG9XuoU1NWku05+STWHnPziSkpS/YtYwaTpEa8BUvi6ba6K9Hi8zxJ93cAA==";
        };
        _3ZvTZcko = {
            "id" = "3ZvTZcko";
            "file" = "entity_model_features-3.3.7-1.21.4-neoforge.jar";
            "hash" = "sha512-IGosle96+h8IHIabYbKXiVXfXwnX+90IRGoLvgV5VH9wpJJwoWfe9Sk1uHzmN87kb8yncfFzVTsQMZlLAdAP8g==";
        };
        _4goICpS8 = {
            "id" = "4goICpS8";
            "file" = "entity_model_features-3.3.7-1.21.5-fabric.jar";
            "hash" = "sha512-Zq6K5gsM5msWPqZx5jrbgpxQGu78BXaltjM0+7omVN20P0CV7ybuSE/0uBKYk9VXKXFnn61RHs+9yfrRQk0ZsA==";
        };
        _KaJu4oLq = {
            "id" = "KaJu4oLq";
            "file" = "entity_model_features-3.3.7-1.21.5-forge.jar";
            "hash" = "sha512-v/7ZKm69pEwnYKQGaeYGptWvO+Y8rwThrxRM2CIgu2mynp8APq9Zpd2IIipPGdxc6sEaK5bGxyG8F5fNRp6utA==";
        };
        _SgC2FW7B = {
            "id" = "SgC2FW7B";
            "file" = "entity_model_features-3.3.7-1.21.5-neoforge.jar";
            "hash" = "sha512-VlkHZyVwef9UqOXrcWzE3ACqCIh8YrPvSgbes+XMn7jxls2kZftHPwHAPPkMW9El3IN6kEWEYsYXdkEBZU89LA==";
        };
        _3912PwQp = {
            "id" = "3912PwQp";
            "file" = "entity_model_features-3.3.7-1.21.6-fabric.jar";
            "hash" = "sha512-Vem54Cs3CCcEvvD5+tB86PbU7w18S61mb8l9ydWdm8rUN8ccVY/tExqM2b9hUfKYZn3aNgN1nNK7miQ7zKgzDQ==";
        };
        _oKvpdQUV = {
            "id" = "oKvpdQUV";
            "file" = "entity_model_features-3.3.7-1.21.6-forge.jar";
            "hash" = "sha512-/9VaxdH9SUFn1x+2DcGJlTcTLiqGFsjrX+Atj1NXPdaa+XKFScvFvBGrYn4jjeP8en8HZn2weqOMPbpUGyKaiw==";
        };
        _sbbDxV6U = {
            "id" = "sbbDxV6U";
            "file" = "entity_model_features-3.3.7-1.21.6-neoforge.jar";
            "hash" = "sha512-jQNqjUoWnT/D9qNfoX1plUUx6ZizcjVb8gqZvqL3sm0zAtRsHx/BhTMag/En6YO24/ljCWuVDhOyznwH/veViA==";
        };
        _P5oeZbZJ = {
            "id" = "P5oeZbZJ";
            "file" = "entity_model_features-3.3.7-1.21.9-fabric.jar";
            "hash" = "sha512-9Xfcm5SsEZjoyAewikDYcIYGQee7KrH9FRBQ2M6GxvjwMv8UqfbUkYqxMNVsTookmGW4UQXi57d0VZdnzLDI5A==";
        };
        _X81PDH8p = {
            "id" = "X81PDH8p";
            "file" = "entity_model_features-3.3.7-1.21.9-forge.jar";
            "hash" = "sha512-+tFzf9EIMeKDa9qFZCeuvwERo+dat7gICjX5GBFwiyCOjROIBg8PxHa/HNEPwOhCQ1OPbKFJruiLPauq22po2w==";
        };
        _Vuc1rQXP = {
            "id" = "Vuc1rQXP";
            "file" = "entity_model_features-3.3.7-1.21.9-neoforge.jar";
            "hash" = "sha512-6CfHho2ywdjKI+NGUrImtgeYxGsbzv1t1vwC1/37fM/spzE1gDaXBSRg+uIbQ0LSYHFdYq1rip3p8k5NznHXng==";
        };
        _7GaobLrM = {
            "id" = "7GaobLrM";
            "file" = "entity_model_features-3.3.7-26.1-fabric.jar";
            "hash" = "sha512-IBX+OhYeg5JfiAIjjc1kdarVpcb4wnPbwBhOZtVGVm/nbeyTMrbp9bgmZs3W9HJEoU9q9LQKmKbFV6PbWzF1nw==";
        };
        _QFJ3CMEx = {
            "id" = "QFJ3CMEx";
            "file" = "entity_model_features-3.3.7-26.1-neoforge.jar";
            "hash" = "sha512-xJAaaEAG6llx4Oc5p1nN0Ei1v00JfOw62rDU9o28YZqDoUxGnsd6GNpNtiaW/UtEbQGzVYDPwBqGzOULMigapw==";
        };
        _6kiZ0S2d = {
            "id" = "6kiZ0S2d";
            "file" = "entity_model_features-3.3.7-26.2-fabric.jar";
            "hash" = "sha512-H3VUrnUL4GtVmps8nkYlGucscZOstPeKsvkRv3cWG1Ib/O10UqjEkUdrt4LOqbtdeOfyRt3vWWmRDyNTVo53ZQ==";
        };
        _pAGUBfhR = {
            "id" = "pAGUBfhR";
            "file" = "entity_model_features-3.3.7-26.2-neoforge.jar";
            "hash" = "sha512-49xaQ8motHVArLCZH+GddFD3hZkp9p347dfriT034wy+Wk6pweat4vk3HPC7ptzqhjbn79hUxvrBLxRSpHLkBQ==";
        };
        _cnQeFUOe = {
            "id" = "cnQeFUOe";
            "file" = "entity_model_features-3.3.7-26.3-fabric.jar";
            "hash" = "sha512-XK2jSmftFs859jiAJEXNyJjRjPB80F79+Z4ZNEaWNjZK/sd172dbMyqGjwQM2ehTjAPCULCZG+pI4VpXvy9oTg==";
        };
        _n6xnzjlh = {
            "id" = "n6xnzjlh";
    ...
    in {
        ...
        "pkg-0.2.4.forge.1.19.4" = _rVKOnrA7;
        "pkg-0.2.4.forge.1.19.3" = _T7mzJLz6;
        "pkg-0.2.4.forge.1.19.2" = _Dea94PIY;
        "pkg-0.2.5b" = _DjswzKtj;
        "pkg-0.2.5" = _aDp7snRT;
        "pkg-0.2.5c" = _V2OyfXxm;
        "pkg-0.2.5d" = _Xd7QIIv1;
        "pkg-0.2.5e" = _GlVrMJfd;
        "pkg-0.2.5f" = _TEAO0eWy;
        "pkg-0.2.6a" = _6WfVnhiq;
        "pkg-0.2.6b" = _3ArUcFku;
        "pkg-0.2.6c" = _zTnuaNyR;
        "pkg-0.2.6d" = _I8BdGIyR;
        "pkg-0.2.6e" = _7bzU6chG;
        "pkg-0.2.6f" = _deVKWS49;
        "pkg-0.2.7a" = _MjDE57Jw;
        "pkg-0.2.7b" = _weH0Em4N;
        "pkg-0.2.7c" = _OZhKhqbO;
        "pkg-0.2.7d" = _Y4ERRvDT;
        "pkg-0.2.7e" = _7eRoc49u;
        "pkg-0.2.7f" = _8GH17mIS;
        "pkg-0.2.8" = _PuJLEdhx;
        "pkg-0.2.9" = _yVjuZyf5;
        "pkg-0.2.10" = _NF2Ro84F;
        "pkg-0.2.11" = _nqu0vi2x;
        "pkg-0.2.12" = _ZAuTqMfx;
        "pkg-0.2.13" = _b1pJegrh;
        "pkg-0.RC.1" = _33ddTlVK;
        "pkg-0.RC.2" = _S8VuZDQ4;
        "pkg-0.RC.3" = _PETiI2Yb;
        "pkg-0.RC.4" = _8FU1BYfi;
        "pkg-1.0" = _toEX8PUQ;
        "pkg-1.0.1" = _j6G5CGoD;
        "pkg-1.0.2" = _PRB8TBBT;
        "pkg-1.1.0" = _OsioKrT1;
        "pkg-1.2.beta.2" = _xOy316Zc;
        "pkg-1.2" = _fbZGMUWW;
        "pkg-1.2.1" = _tcrjMnUN;
        "pkg-1.2.3" = _S9HtDtJv;
        "pkg-1.3" = _bwjbN1G7;
        ...
        "pkg-3.0.4" = _j9SsXgqm;
        "pkg-3.0.5" = _pvyci2Ch;
        "pkg-3.0.6-forge-1.20.1" = _PVobhHEK;
        "pkg-3.0.6-fabric-1.20.1" = _EQoRsv3W;
        "pkg-3.0.6-forge-1.20.2" = _RIVXVAyh;
        "pkg-3.0.6-neoforge-1.20.2" = _jYc5wQZY;
        "pkg-3.0.6-fabric-1.20.2" = _bhhFvtEK;
        "pkg-3.0.6-forge-1.20.4" = _IW4DtaJK;
        "pkg-3.0.6-neoforge-1.20.4" = _WGEwZs53;
        "pkg-3.0.6-fabric-1.20.4" = _ZQBmaplm;
        "pkg-3.0.6-forge-1.20.6" = _DvNDczdn;
        "pkg-3.0.6-neoforge-1.20.6" = _KPEfSa40;
        "pkg-3.0.6-fabric-1.20.6" = _zI5db1u0;
        "pkg-3.0.6-forge-1.21" = _ylqd3aNo;
        "pkg-3.0.6-neoforge-1.21" = _AWNPYFdy;
        "pkg-3.0.6-fabric-1.21" = _8MaD2jDa;
        "pkg-3.0.6-forge-1.21.3" = _hZbElcC7;
        "pkg-3.0.6-neoforge-1.21.3" = _vq8BBvSg;
        "pkg-3.0.6-fabric-1.21.3" = _tx5ozK1H;
        "pkg-3.0.6-forge-1.21.4" = _bozQQR46;
        "pkg-3.0.6-neoforge-1.21.4" = _9N1FQBIi;
        "pkg-3.0.6-fabric-1.21.4" = _UhHK2xLQ;
        "pkg-3.0.6-forge-1.21.5" = _s4rMDv7j;
        "pkg-3.0.6-neoforge-1.21.5" = _8mbs7VMQ;
        "pkg-3.0.6-fabric-1.21.5" = _XTD7j9N2;
        "pkg-3.0.6-forge-1.21.6" = _v2i9AeXA;
        "pkg-3.0.6-neoforge-1.21.6" = _Vand2RI3;
        "pkg-3.0.6-fabric-1.21.6" = _LzLApfcL;
        "pkg-3.0.6-forge-1.21.9" = _PW0MGwF7;
        "pkg-3.0.6-neoforge-1.21.9" = _4km9TC4Z;
        "pkg-3.0.6-fabric-1.21.9" = _o9YTgnHM;
        "pkg-3.0.7-forge-1.20.1" = _yvcQe2gF;
        "pkg-3.0.7-fabric-1.20.1" = _98XZmlck;
        "pkg-3.0.7-forge-1.20.2" = _l1yslPqC;
        "pkg-3.0.7-neoforge-1.20.2" = _8J8zqplM;
        "pkg-3.0.7-fabric-1.20.2" = _qtrgDovb;
        "pkg-3.0.7-forge-1.20.4" = _H74Hq3qs;
        "pkg-3.0.7-neoforge-1.20.4" = _5V3zrPsW;
        "pkg-3.0.7-fabric-1.20.4" = _T3Ro8Dcy;
        "pkg-3.0.7-forge-1.20.6" = _eP5LfU06;
        "pkg-3.0.7-neoforge-1.20.6" = _84H7xf2A;
        "pkg-3.0.7-fabric-1.20.6" = _dHG7R6ZV;
        "pkg-3.0.7-forge-1.21" = _vFL8QJIa;
        "pkg-3.0.7-neoforge-1.21" = _sKRcyJZ6;
        "pkg-3.0.7-fabric-1.21" = _wrv1h7Vv;
        "pkg-3.0.7-forge-1.21.3" = _x2CUnk9z;
        "pkg-3.0.7-neoforge-1.21.3" = _PWe3o3VR;
        "pkg-3.0.7-fabric-1.21.3" = _2CICpJqo;
        "pkg-3.0.7-forge-1.21.4" = _hwmQdQzq;
        "pkg-3.0.7-neoforge-1.21.4" = _8fAjT8Un;
        "pkg-3.0.7-fabric-1.21.4" = _WdmbXMff;
        "pkg-3.0.7-forge-1.21.5" = _xDLsRmrO;
        "pkg-3.0.7-neoforge-1.21.5" = _b7ZnlAd5;
        "pkg-3.0.7-fabric-1.21.5" = _hiw764Y1;
        "pkg-3.0.7-forge-1.21.6" = _5o0IsIB0;
        "pkg-3.0.7-neoforge-1.21.6" = _FOc799nh;
        "pkg-3.0.7-fabric-1.21.6" = _2WVMrDc2;
        "pkg-3.0.7-forge-1.21.9" = _QWRT54cu;
        "pkg-3.0.7-neoforge-1.21.9" = _iq80od6D;
        "pkg-3.0.7-fabric-1.21.9" = _QpujSalM;
        "pkg-3.0.8-forge-1.21.11" = _89SnaoEY;
        "pkg-3.0.8-fabric-1.21.11" = _mKzyfrp8;
        "pkg-3.0.9-forge-1.20.1" = _8cDUqzVp;
        "pkg-3.0.9-fabric-1.20.1" = _eCAHQ8VM;
        "pkg-3.0.9-forge-1.20.2" = _zRSGFO5k;
        "pkg-3.0.9-neoforge-1.20.2" = _ElLnki57;
        "pkg-3.0.9-fabric-1.20.2" = _otMM1so2;
        "pkg-3.0.9-forge-1.20.4" = _DutyyxPz;
        "pkg-3.0.9-neoforge-1.20.4" = _iG2FrcmP;
        "pkg-3.0.9-fabric-1.20.4" = _ikWbzXA7;
        "pkg-3.0.9-forge-1.20.6" = _DCWcwyme;
        "pkg-3.0.9-neoforge-1.20.6" = _AuNX94Ov;
        "pkg-3.0.9-fabric-1.20.6" = _aS2EhahM;
        "pkg-3.0.9-forge-1.21" = _6WDZdXQq;
        "pkg-3.0.9-neoforge-1.21" = _5Uyq6ayv;
        "pkg-3.0.9-fabric-1.21" = _tCUoahyn;
        "pkg-3.0.9-forge-1.21.3" = _V5eVcJMQ;
        "pkg-3.0.9-neoforge-1.21.3" = _ix2RMG22;
        "pkg-3.0.9-fabric-1.21.3" = _CcBJjECW;
        "pkg-3.0.9-forge-1.21.4" = _Qi63odm1;
        "pkg-3.0.9-neoforge-1.21.4" = _gy4eDgKO;
        "pkg-3.0.9-fabric-1.21.4" = _rGar9pl5;
        "pkg-3.0.9-forge-1.21.5" = _gDp6BoBN;
        "pkg-3.0.9-neoforge-1.21.5" = _QBNFJVWK;
        "pkg-3.0.9-fabric-1.21.5" = _gTpO96NU;
        "pkg-3.0.9-forge-1.21.6" = _hkSOPzzt;
        "pkg-3.0.9-neoforge-1.21.6" = _mDbWrzBB;
        "pkg-3.0.9-fabric-1.21.6" = _tQ7KnRtu;
        "pkg-3.0.9-forge-1.21.9" = _qFLTXRn5;
        "pkg-3.0.9-neoforge-1.21.9" = _TSmT1Qig;
        "pkg-3.0.9-fabric-1.21.9" = _5L2TgEVy;
        "pkg-3.0.9-forge-1.21.11" = _74XNgvJG;
        "pkg-3.0.9-neoforge-1.21.11" = _AqA9DvIJ;
        "pkg-3.0.9-fabric-1.21.11" = _mO9RYxKF;
        "pkg-3.0.10-forge-1.20.1" = _ZAqLFpFZ;
        "pkg-3.0.10-fabric-1.20.1" = _GMsbVfZZ;
        "pkg-3.0.10-forge-1.20.2" = _33ku4lsB;
        "pkg-3.0.10-neoforge-1.20.2" = _420Rnidx;
        "pkg-3.0.10-fabric-1.20.2" = _ywtRIwJ6;
        "pkg-3.0.10-forge-1.20.4" = _7xezAU2H;
        "pkg-3.0.10-neoforge-1.20.4" = _lVGIdnrI;
        "pkg-3.0.10-fabric-1.20.4" = _iiN28DZT;
        "pkg-3.0.10-forge-1.20.6" = _D6aPro4I;
        "pkg-3.0.10-neoforge-1.20.6" = _YQYPbfLh;
        "pkg-3.0.10-fabric-1.20.6" = _pf0RKUIh;
        "pkg-3.0.10-forge-1.21" = _c9dhrPmE;
        "pkg-3.0.10-neoforge-1.21" = _uysyqlsZ;
        "pkg-3.0.10-fabric-1.21" = _O33Eiuq1;
        "pkg-3.0.10-forge-1.21.3" = _SJRZqTK7;
        "pkg-3.0.10-neoforge-1.21.3" = _tAoy2a7E;
        "pkg-3.0.10-fabric-1.21.3" = _f8b163eE;
        "pkg-3.0.10-forge-1.21.4" = _sdcjBl3I;
        "pkg-3.0.10-neoforge-1.21.4" = _j4ZDxa2q;
        "pkg-3.0.10-fabric-1.21.4" = _lbn0xsLM;
        "pkg-3.0.10-forge-1.21.5" = _YiCrfHXw;
        "pkg-3.0.10-neoforge-1.21.5" = _l9qKSuVV;
        "pkg-3.0.10-fabric-1.21.5" = _vduoV3ti;
        "pkg-3.0.10-forge-1.21.6" = _NTwaGGFm;
        "pkg-3.0.10-neoforge-1.21.6" = _ZVSnp7Fz;
        "pkg-3.0.10-fabric-1.21.6" = _9YmuHru2;
        "pkg-3.0.10-forge-1.21.9" = _P2WVdaDB;
        "pkg-3.0.10-neoforge-1.21.9" = _XQbqxRg2;
        "pkg-3.0.10-fabric-1.21.9" = _P9pxh3US;
        "pkg-3.0.10-forge-1.21.11" = _Kp3hJGm0;
        "pkg-3.0.10-neoforge-1.21.11" = _hvrvMEUy;
        "pkg-3.0.10-fabric-1.21.11" = _fw5ejGT7;
        "pkg-3.0.11-forge-1.20.1" = _pQWf7B6Z;
        "pkg-3.0.11-fabric-1.20.1" = _ryrcH1Vb;
        "pkg-3.0.11-forge-1.20.2" = _wZ5gRYRM;
        "pkg-3.0.11-neoforge-1.20.2" = _IHPXiIO7;
        "pkg-3.0.11-fabric-1.20.2" = _1zeCbRug;
        "pkg-3.0.11-forge-1.20.4" = _EKGAfe5X;
        "pkg-3.0.11-neoforge-1.20.4" = _5ISs9db1;
        "pkg-3.0.11-fabric-1.20.4" = _axNNpaHr;
        "pkg-3.0.11-forge-1.20.6" = _Eq98Ch4l;
        "pkg-3.0.11-neoforge-1.20.6" = _yKxqAQb9;
        "pkg-3.0.11-fabric-1.20.6" = _DznqCTAb;
        "pkg-3.0.11-forge-1.21" = _HhQkrEJR;
        "pkg-3.0.11-neoforge-1.21" = _eWEQjNfI;
        "pkg-3.0.11-fabric-1.21" = _ZiN44dP9;
        "pkg-3.0.11-forge-1.21.3" = _GrT8xDOe;
        "pkg-3.0.11-neoforge-1.21.3" = _5aGboAXJ;
        "pkg-3.0.11-fabric-1.21.3" = _SWnMqRLW;
        "pkg-3.0.11-forge-1.21.4" = _bUPgM2gF;
        "pkg-3.0.11-neoforge-1.21.4" = _8Wn0ispY;
        "pkg-3.0.11-fabric-1.21.4" = _bqKIHl0e;
        "pkg-3.0.11-forge-1.21.5" = _pTYiulyD;
        "pkg-3.0.11-neoforge-1.21.5" = _flnQFEW9;
        "pkg-3.0.11-fabric-1.21.5" = _dwclLPuQ;
        "pkg-3.0.11-forge-1.21.6" = _L3TxwKD1;
        "pkg-3.0.11-neoforge-1.21.6" = _vPYphhvS;
        "pkg-3.0.11-fabric-1.21.6" = _QqDdyZ4m;
        "pkg-3.0.11-forge-1.21.9" = _tqz7cunG;
        "pkg-3.0.11-neoforge-1.21.9" = _vdO1SJbm;
        "pkg-3.0.11-fabric-1.21.9" = _QAiZMgOn;
        "pkg-3.0.11-forge-1.21.11" = _K9KYf9t3;
        "pkg-3.0.11-neoforge-1.21.11" = _qX2Mb3yB;
        "pkg-3.0.11-fabric-1.21.11" = _3xCY6scW;
        "pkg-3.0.12-forge-1.20.1" = _Q2IpTAPW;
        "pkg-3.0.12-fabric-1.20.1" = _NdOVYyQg;
        "pkg-3.0.12-forge-1.20.2" = _yp90yZP3;
        "pkg-3.0.12-neoforge-1.20.2" = _qLq2AWJq;
        "pkg-3.0.12-fabric-1.20.2" = _aWpkUZdx;
        "pkg-3.0.12-forge-1.20.4" = _y5PpMyxW;
        "pkg-3.0.12-neoforge-1.20.4" = _rr8u85UA;
        "pkg-3.0.12-fabric-1.20.4" = _JnphcIRd;
        "pkg-3.0.12-forge-1.20.6" = _gifZC6jl;
        "pkg-3.0.12-neoforge-1.20.6" = _s5MuVUl3;
        "pkg-3.0.12-fabric-1.20.6" = _23c506nA;
        "pkg-3.0.12-forge-1.21" = _nBZuq3xo;
        "pkg-3.0.12-neoforge-1.21" = _JHa6X5M3;
        "pkg-3.0.12-fabric-1.21" = _r7vEKOfY;
        "pkg-3.0.12-forge-1.21.3" = _q62Xb2TX;
        "pkg-3.0.12-neoforge-1.21.3" = _OVQvysZs;
        "pkg-3.0.12-fabric-1.21.3" = _JMb5KUPA;
        "pkg-3.0.12-forge-1.21.4" = _M5zo9RgC;
        "pkg-3.0.12-neoforge-1.21.4" = _FaJHieGl;
        "pkg-3.0.12-fabric-1.21.4" = _R2yZzFdz;
        "pkg-3.0.12-forge-1.21.5" = _SmXqMoRZ;
        "pkg-3.0.12-neoforge-1.21.5" = _slXhzIWZ;
        "pkg-3.0.12-fabric-1.21.5" = _6LKHFSBA;
        "pkg-3.0.12-forge-1.21.6" = _D0OvnN5E;
        "pkg-3.0.12-neoforge-1.21.6" = _qp5IOidy;
        "pkg-3.0.12-fabric-1.21.6" = _zUvzKHRv;
        "pkg-3.0.12-forge-1.21.9" = _fJzEPVFb;
        "pkg-3.0.12-neoforge-1.21.9" = _gQoiY57A;
        "pkg-3.0.12-fabric-1.21.9" = _tu8Q2jPq;
        "pkg-3.0.12-forge-1.21.11" = _gLuJWMlN;
        "pkg-3.0.12-neoforge-1.21.11" = _6Brygtz2;
        "pkg-3.0.12-fabric-1.21.11" = _uvlfzqyo;
        "pkg-3.0.13-fabric-26.1" = _QqlPpUiX;
        "pkg-3.0.13-neoforge-26.1" = _hy5rhYqv;
        "pkg-3.0.14-fabric-26.1" = _nmiro2eR;
        "pkg-3.0.14-neoforge-26.1" = _y7qmN4Mf;
        "pkg-3.0.15-forge-1.20.1" = _IkCzFQPH;
        "pkg-3.0.15-fabric-1.20.1" = _U9TGicKv;
        "pkg-3.0.15-forge-1.20.2" = _d5gUnUSh;
        "pkg-3.0.15-neoforge-1.20.2" = _cxZVtWU6;
        "pkg-3.0.15-fabric-1.20.2" = _CKN78qk9;
        "pkg-3.0.15-forge-1.20.4" = _WegjzLnE;
        "pkg-3.0.15-neoforge-1.20.4" = _2PVborhF;
        "pkg-3.0.15-fabric-1.20.4" = _FXTx8y4g;
        "pkg-3.0.15-forge-1.20.6" = _DlIrSqyP;
        "pkg-3.0.15-neoforge-1.20.6" = _H670fbMx;
        "pkg-3.0.15-fabric-1.20.6" = _3yMuMFnE;
        "pkg-3.0.15-forge-1.21" = _Fh8r8czk;
        "pkg-3.0.15-neoforge-1.21" = _QyWGDHt9;
        "pkg-3.0.15-fabric-1.21" = _OdWiro2h;
        "pkg-3.0.15-forge-1.21.3" = _dz5umUf1;
        "pkg-3.0.15-neoforge-1.21.3" = _VHnXrC0s;
        "pkg-3.0.15-fabric-1.21.3" = _b7aEhWpO;
        "pkg-3.0.15-forge-1.21.4" = _DCWhjuI2;
        "pkg-3.0.15-neoforge-1.21.4" = _goTqSImS;
        "pkg-3.0.15-fabric-1.21.4" = _Dh9LqvDv;
        "pkg-3.0.15-forge-1.21.5" = _ks7YrBgQ;
        "pkg-3.0.15-neoforge-1.21.5" = _jXS2AKZD;
        "pkg-3.0.15-fabric-1.21.5" = _zzbs8Cvb;
        "pkg-3.0.15-forge-1.21.6" = _rqQVFi8e;
        "pkg-3.0.15-neoforge-1.21.6" = _iY0U2CQb;
        "pkg-3.0.15-fabric-1.21.6" = _bAgHRVTm;
        "pkg-3.0.15-forge-1.21.9" = _LKZWYWC7;
        "pkg-3.0.15-neoforge-1.21.9" = _Viu5KdxD;
        "pkg-3.0.15-fabric-1.21.9" = _I0bgQ35e;
        "pkg-3.0.15-forge-1.21.11" = _FRm1kms3;
        "pkg-3.0.15-neoforge-1.21.11" = _sZcKy8lC;
        "pkg-3.0.15-fabric-1.21.11" = _FOBDYx8J;
        "pkg-3.0.15-neoforge-26.1" = _81R1txra;
        "pkg-3.0.15-fabric-26.1" = _QmjzUJ5G;
        "pkg-3.0.16-forge-1.20.1" = _qwLsrVEZ;
        "pkg-3.0.16-fabric-1.20.1" = _Xgm6kTmM;
        "pkg-3.0.16-forge-1.20.2" = _9F333N7v;
        "pkg-3.0.16-neoforge-1.20.2" = _MtOy0Ze4;
        "pkg-3.0.16-fabric-1.20.2" = _fy6XSKxc;
        "pkg-3.0.16-forge-1.20.4" = _zu7KP9Ak;
        "pkg-3.0.16-neoforge-1.20.4" = _1ULEGokI;
        "pkg-3.0.16-fabric-1.20.4" = _cRLf6aFb;
        "pkg-3.0.16-forge-1.20.6" = _znyNPCgG;
        "pkg-3.0.16-neoforge-1.20.6" = _J9MsiwD7;
        "pkg-3.0.16-fabric-1.20.6" = _ddJIaOnw;
        "pkg-3.0.16-forge-1.21" = _66f4te88;
        "pkg-3.0.16-neoforge-1.21" = _wLlQ1dCZ;
        "pkg-3.0.16-fabric-1.21" = _XgwwdJe0;
        "pkg-3.0.16-forge-1.21.3" = _oGvcmies;
        "pkg-3.0.16-neoforge-1.21.3" = _9qBgTyj8;
        "pkg-3.0.16-fabric-1.21.3" = _b4JjHGpF;
        "pkg-3.0.16-forge-1.21.4" = _q0R5Syeb;
        "pkg-3.0.16-neoforge-1.21.4" = _3p0sqCyy;
        "pkg-3.0.16-fabric-1.21.4" = _zYFhqWvN;
        "pkg-3.0.16-forge-1.21.5" = _Yc4SW9yo;
        "pkg-3.0.16-neoforge-1.21.5" = _4sNmrNfI;
        "pkg-3.0.16-fabric-1.21.5" = _mTM3JyYQ;
        "pkg-3.0.16-forge-1.21.6" = _8QuBlYGh;
        "pkg-3.0.16-neoforge-1.21.6" = _fdwWg6zH;
        "pkg-3.0.16-fabric-1.21.6" = _iGwj8BFd;
        "pkg-3.0.16-forge-1.21.9" = _WHE3Zg1q;
        "pkg-3.0.16-neoforge-1.21.9" = _w3P88yhk;
        "pkg-3.0.16-fabric-1.21.9" = _to2mlWqD;
        "pkg-3.0.16-forge-1.21.11" = _WNHxC9yw;
        "pkg-3.0.16-neoforge-1.21.11" = _E9tAVEtn;
        "pkg-3.0.16-fabric-1.21.11" = _ey4fnK4M;
        "pkg-3.0.16-neoforge-26.1" = _qrgrGZ3J;
        "pkg-3.0.16-fabric-26.1" = _iWmJ8xiN;
        "pkg-3.0.17-forge-1.20.1" = _nRb48t2X;
        "pkg-3.0.17-fabric-1.20.1" = _kujplV21;
        "pkg-3.0.17-forge-1.20.2" = _xKtVLMOV;
        "pkg-3.0.17-neoforge-1.20.2" = _Ov8f5XtU;
        "pkg-3.0.17-fabric-1.20.2" = _MIAJ5n74;
        "pkg-3.0.17-forge-1.20.4" = _ToCsDF8r;
        "pkg-3.0.17-neoforge-1.20.4" = _ljDkDZIJ;
        "pkg-3.0.17-fabric-1.20.4" = _EOMHQlfK;
        "pkg-3.0.17-forge-1.20.6" = _vDz6gtJm;
        "pkg-3.0.17-neoforge-1.20.6" = _phG4TMHZ;
        "pkg-3.0.17-fabric-1.20.6" = _iFg6ObpQ;
        "pkg-3.0.17-forge-1.21" = _GZSi8Wrw;
        "pkg-3.0.17-neoforge-1.21" = _ePlhNKXk;
        "pkg-3.0.17-fabric-1.21" = _SppB0oZD;
        "pkg-3.0.17-forge-1.21.3" = _IebhShl8;
        "pkg-3.0.17-neoforge-1.21.3" = _pPhzSOtt;
        "pkg-3.0.17-fabric-1.21.3" = _ju9hWxgS;
        "pkg-3.0.17-forge-1.21.4" = _cRyounpg;
        "pkg-3.0.17-neoforge-1.21.4" = _9BIdZZnq;
        "pkg-3.0.17-fabric-1.21.4" = _hJLq6zZQ;
        "pkg-3.0.17-forge-1.21.5" = _h9d4BSQk;
        "pkg-3.0.17-neoforge-1.21.5" = _DwiQXyrp;
        "pkg-3.0.17-fabric-1.21.5" = _r2GYS9gS;
        "pkg-3.0.17-forge-1.21.6" = _G7iF9Y6R;
        "pkg-3.0.17-neoforge-1.21.6" = _UoscQfFf;
        "pkg-3.0.17-fabric-1.21.6" = _pdqb4uEy;
        "pkg-3.0.17-forge-1.21.9" = _72VxAzBP;
        "pkg-3.0.17-neoforge-1.21.9" = _6veBkaA9;
        "pkg-3.0.17-fabric-1.21.9" = _JQsL4bgz;
        "pkg-3.0.17-forge-1.21.11" = _85k7NLV0;
        "pkg-3.0.17-neoforge-1.21.11" = _NbcLyoCI;
        "pkg-3.0.17-fabric-1.21.11" = _bXWByT4I;
        "pkg-3.0.17-neoforge-26.1" = _YqfUhxYm;
        "pkg-3.0.17-fabric-26.1" = _WCq0oMm6;
        "pkg-3.1-forge-1.20.1" = _nvwWrBHD;
        "pkg-3.1-fabric-1.20.1" = _DH8WtoDk;
        "pkg-3.1-forge-1.21" = _LZjcj2Je;
        "pkg-3.1-neoforge-1.21" = _1boQueHm;
        "pkg-3.1-fabric-1.21" = _gob38d26;
        "pkg-3.1-forge-1.21.3" = _tmRMEK4b;
        "pkg-3.1-neoforge-1.21.3" = _t0kSwmxT;
        "pkg-3.1-fabric-1.21.3" = _jfW4LJdM;
        "pkg-3.1-forge-1.21.4" = _v4hF9INu;
        "pkg-3.1-neoforge-1.21.4" = _KhKQUAjI;
        "pkg-3.1-fabric-1.21.4" = _GFcsbbwq;
        "pkg-3.1-forge-1.21.5" = _c0fepcZI;
        "pkg-3.1-neoforge-1.21.5" = _rHTZYeog;
        "pkg-3.1-fabric-1.21.5" = _PkZVTFkY;
        "pkg-3.1-forge-1.21.6" = _ViiQ9yEf;
        "pkg-3.1-neoforge-1.21.6" = _nAc13KbO;
        "pkg-3.1-fabric-1.21.6" = _cxnIUMRo;
        "pkg-3.1-forge-1.21.9" = _uE3z1IAe;
        "pkg-3.1-neoforge-1.21.9" = _JzAFbHk2;
        "pkg-3.1-fabric-1.21.9" = _ZJ80N1Lq;
        "pkg-3.1-forge-1.21.11" = _mMFA2qvS;
        "pkg-3.1-neoforge-1.21.11" = _53msWnlR;
        "pkg-3.1-fabric-1.21.11" = _m6zrsq2e;
        "pkg-3.1-neoforge-26.1" = _DIDXNJiR;
        "pkg-3.1-fabric-26.1" = _8q9iuKUh;
        "pkg-3.1.1-forge-1.20.1" = _b1RsbY5B;
        "pkg-3.1.1-fabric-1.20.1" = _JOIu1npK;
        "pkg-3.1.1-forge-1.21" = _wJb2rFLb;
        "pkg-3.1.1-neoforge-1.21" = _X2O4Wo1f;
        "pkg-3.1.1-fabric-1.21" = _b3EE4NV0;
        "pkg-3.1.1-forge-1.21.3" = _CBABKI6A;
        "pkg-3.1.1-neoforge-1.21.3" = _t3P1UGrW;
        "pkg-3.1.1-fabric-1.21.3" = _AbN2xMQP;
        "pkg-3.1.1-forge-1.21.4" = _74K2OwqZ;
        "pkg-3.1.1-neoforge-1.21.4" = _E1vJn948;
        "pkg-3.1.1-fabric-1.21.4" = _msxCrXtU;
        "pkg-3.1.1-forge-1.21.5" = _IJL6U4sR;
        "pkg-3.1.1-neoforge-1.21.5" = _zkqIaPee;
        "pkg-3.1.1-fabric-1.21.5" = _nnsN0zke;
        "pkg-3.1.1-forge-1.21.6" = _mRCrkBKk;
        "pkg-3.1.1-neoforge-1.21.6" = _PhiwdGJS;
        "pkg-3.1.1-fabric-1.21.6" = _Hw7lrEc4;
        "pkg-3.1.1-forge-1.21.9" = _2qJvDpOA;
        "pkg-3.1.1-neoforge-1.21.9" = _piCwx7mb;
        "pkg-3.1.1-fabric-1.21.9" = _BZ48C2Rx;
        "pkg-3.1.1-forge-1.21.11" = _wve080xs;
        "pkg-3.1.1-neoforge-1.21.11" = _xEl3vGSM;
        "pkg-3.1.1-fabric-1.21.11" = _VliSdpxl;
        "pkg-3.1.1-neoforge-26.1" = _2U2mZoIt;
        "pkg-3.1.1-fabric-26.1" = _awv0MUoS;
        "pkg-3.2-forge-1.20.1" = _HHNoZL7n;
        "pkg-3.2-fabric-1.20.1" = _QFkxhpPa;
        "pkg-3.2-forge-1.21" = _3e6qGylt;
        "pkg-3.2-neoforge-1.21" = _i1TzfZG6;
        "pkg-3.2-fabric-1.21" = _BWOJ87Eb;
        "pkg-3.2-forge-1.21.3" = _bb1LcWYy;
        "pkg-3.2-neoforge-1.21.3" = _kxRIC46Z;
        "pkg-3.2-fabric-1.21.3" = _9M92YHFs;
        "pkg-3.2-forge-1.21.4" = _2b8kMX3X;
        "pkg-3.2-neoforge-1.21.4" = _hsJ898F2;
        "pkg-3.2-fabric-1.21.4" = _UM1VIj9Y;
        "pkg-3.2-forge-1.21.5" = _YxOKNwKU;
        "pkg-3.2-neoforge-1.21.5" = _yFx4xkSF;
        "pkg-3.2-fabric-1.21.5" = _XtLeD6Gc;
        "pkg-3.2-forge-1.21.6" = _lDR2fk5Q;
        "pkg-3.2-neoforge-1.21.6" = _xGu5TsDV;
        "pkg-3.2-fabric-1.21.6" = _r8nGKJWy;
        "pkg-3.2-forge-1.21.9" = _1kYUi5dD;
        "pkg-3.2-neoforge-1.21.9" = _fAMUwmpb;
        "pkg-3.2-fabric-1.21.9" = _Abxb8A08;
        "pkg-3.2-forge-1.21.11" = _syRhDm9T;
        "pkg-3.2-neoforge-1.21.11" = _eO9FuL1R;
        "pkg-3.2-fabric-1.21.11" = _xvOZYJVS;
        "pkg-3.2-neoforge-26.1" = _x3470yNS;
        "pkg-3.2-fabric-26.1" = _2hCBMgOm;
        "pkg-3.2.1-forge-1.20.1" = _XED1pmuG;
        "pkg-3.2.1-fabric-1.20.1" = _JMIYLXTx;
        "pkg-3.2.2-forge-1.20.1" = _lssOUOiA;
        "pkg-3.2.2-fabric-1.20.1" = _6BwWznJB;
        "pkg-3.2.2-forge-1.21" = _gIxx8SkM;
        "pkg-3.2.2-neoforge-1.21" = _WD6HMbpv;
        "pkg-3.2.2-fabric-1.21" = _TWMX6vf5;
        "pkg-3.2.2-forge-1.21.3" = _w2Y6KfM3;
        "pkg-3.2.2-neoforge-1.21.3" = _eas8n57a;
        "pkg-3.2.2-fabric-1.21.3" = _fRmTyEc8;
        "pkg-3.2.2-forge-1.21.4" = _jK3zWueS;
        "pkg-3.2.2-neoforge-1.21.4" = _8jjsgAhH;
        "pkg-3.2.2-fabric-1.21.4" = _6LcaJB0K;
        "pkg-3.2.2-forge-1.21.5" = _TvmcvzAr;
        "pkg-3.2.2-neoforge-1.21.5" = _xv5r85ug;
        "pkg-3.2.2-fabric-1.21.5" = _2e3IKsvW;
        "pkg-3.2.2-forge-1.21.6" = _PwsqUB14;
        "pkg-3.2.2-neoforge-1.21.6" = _7OEOs9Op;
        "pkg-3.2.2-fabric-1.21.6" = _esWw012V;
        "pkg-3.2.2-forge-1.21.9" = _pm55B6DK;
        "pkg-3.2.2-neoforge-1.21.9" = _MfZYTmR3;
        "pkg-3.2.2-fabric-1.21.9" = _5LgLhWqS;
        "pkg-3.2.2-forge-1.21.11" = _ui4duIag;
        "pkg-3.2.2-neoforge-1.21.11" = _yz5chVEH;
        "pkg-3.2.2-fabric-1.21.11" = _wbSSx6vc;
        "pkg-3.2.2-neoforge-26.1" = _zXykUxad;
        "pkg-3.2.2-fabric-26.1" = _dZCNlZz2;
        "pkg-3.2.3-fabric-1.20.1" = _hmS0KQQF;
        "pkg-3.2.3-fabric-1.21.11" = _eeK3rXUZ;
        "pkg-3.2.3-forge-1.20.1" = _LrYqKvYd;
        "pkg-3.2.3-fabric-1.21" = _MLWJe5HJ;
        "pkg-3.2.3-forge-1.21" = _vBJZsFQL;
        "pkg-3.2.3-neoforge-1.21" = _rQGC5BxR;
        "pkg-3.2.3-forge-1.21.11" = _8vU0bCgK;
        "pkg-3.2.3-neoforge-1.21.11" = _CK1fxnwx;
        "pkg-3.2.3-fabric-1.21.3" = _2oAysGts;
        "pkg-3.2.3-forge-1.21.3" = _BZlPvynr;
        "pkg-3.2.3-neoforge-1.21.3" = _3YyXgzIn;
        "pkg-3.2.3-fabric-1.21.4" = _qrhiaII4;
        "pkg-3.2.3-forge-1.21.4" = _BOZsdWmQ;
        "pkg-3.2.3-neoforge-1.21.4" = _1Nbj2oKH;
        "pkg-3.2.3-fabric-1.21.5" = _lWIwdpeo;
        "pkg-3.2.3-forge-1.21.5" = _MOZktFo9;
        "pkg-3.2.3-neoforge-1.21.5" = _8iVxw78j;
        "pkg-3.2.3-fabric-1.21.6" = _JvYG6Vdg;
        "pkg-3.2.3-forge-1.21.6" = _MDbaHBHn;
        "pkg-3.2.3-neoforge-1.21.6" = _EAg5naSJ;
        "pkg-3.2.3-fabric-1.21.9" = _5THj840D;
        "pkg-3.2.3-forge-1.21.9" = _PEZfx26C;
        "pkg-3.2.3-neoforge-1.21.9" = _6W5mROJU;
        "pkg-3.2.3-fabric-26.1" = _6MoPxSdy;
        "pkg-3.2.3-neoforge-26.1" = _OAIniA70;
        "pkg-3.2.4-fabric-1.21.11" = _CWZPvNbk;
        "pkg-3.2.4-fabric-1.20.1" = _HLnLv1St;
        "pkg-3.2.4-forge-1.20.1" = _VSBDdOOY;
        "pkg-3.2.4-fabric-1.21" = _NLDNY8vg;
        "pkg-3.2.4-forge-1.21" = _gWXh8pEP;
        "pkg-3.2.4-neoforge-1.21" = _PAYgk63v;
        "pkg-3.2.4-forge-1.21.11" = _20Qq754c;
        "pkg-3.2.4-neoforge-1.21.11" = _VMJ8kjqR;
        "pkg-3.2.4-fabric-1.21.3" = _vPosJHjz;
        "pkg-3.2.4-forge-1.21.3" = _enMzd9FY;
        "pkg-3.2.4-neoforge-1.21.3" = _k6Xrv8MD;
        "pkg-3.2.4-fabric-1.21.4" = _egL7U2Fa;
        "pkg-3.2.4-forge-1.21.4" = _jIwj8koM;
        "pkg-3.2.4-neoforge-1.21.4" = _mSdGwbUW;
        "pkg-3.2.4-fabric-1.21.5" = _rQNlzjgl;
        "pkg-3.2.4-forge-1.21.5" = _TfrGdpNt;
        "pkg-3.2.4-neoforge-1.21.5" = _oIIQ9QLG;
        "pkg-3.2.4-fabric-1.21.6" = _rPlvbW7d;
        "pkg-3.2.4-forge-1.21.6" = _F9vy6Gth;
        "pkg-3.2.4-neoforge-1.21.6" = _hcT0GN6Q;
        "pkg-3.2.4-fabric-1.21.9" = _q5SsVEBz;
        "pkg-3.2.4-forge-1.21.9" = _NHPp9ZxA;
        "pkg-3.2.4-neoforge-1.21.9" = _vMgQCRmK;
        "pkg-3.2.4-fabric-26.1" = _3AWXQABp;
        "pkg-3.2.4-neoforge-26.1" = _hABUrVHX;
        "pkg-3.2.5-neoforge-26.2" = _QxbPFvdn;
        "pkg-3.2.5-fabric-26.2" = _DzLYJMqg;
        "pkg-3.2.6-neoforge-26.2" = _jFT7K26t;
        "pkg-3.2.6-fabric-26.2" = _xQeW3qQB;
        "pkg-3.3-fabric-1.20.1" = _YjwgLLSp;
        "pkg-3.3-fabric-1.21.11" = _zV6cz7Gj;
        "pkg-3.3-forge-1.20.1" = _GcvrFfEy;
        "pkg-3.3-fabric-1.21" = _k1QsbVdH;
        "pkg-3.3-forge-1.21" = _bWVaLoxi;
        "pkg-3.3-neoforge-1.21" = _TqVBeoGT;
        "pkg-3.3-forge-1.21.11" = _w2LUWGIS;
        "pkg-3.3-neoforge-1.21.11" = _cjR1rTet;
        "pkg-3.3-fabric-1.21.3" = _WoH4IntR;
        "pkg-3.3-forge-1.21.3" = _XpyjZqac;
        "pkg-3.3-neoforge-1.21.3" = _PWpFJjf1;
        "pkg-3.3-fabric-1.21.4" = _aJhPmQZE;
        "pkg-3.3-forge-1.21.4" = _nrwmY2K4;
        "pkg-3.3-neoforge-1.21.4" = _IXmP6Cm0;
        "pkg-3.3-fabric-1.21.5" = _kS0L6gX4;
        "pkg-3.3-forge-1.21.5" = _qBSMeBs9;
        "pkg-3.3-neoforge-1.21.5" = _8rdpclqI;
        "pkg-3.3-fabric-1.21.6" = _r7htVMlY;
        "pkg-3.3-forge-1.21.6" = _gIqCuIXT;
        "pkg-3.3-neoforge-1.21.6" = _htYJqpYr;
        "pkg-3.3-fabric-1.21.9" = _veZMhr8J;
        "pkg-3.3-forge-1.21.9" = _yi8ZP6CX;
        "pkg-3.3-neoforge-1.21.9" = _MfV2XyHV;
        "pkg-3.3-fabric-26.1" = _QSLPrO2f;
        "pkg-3.3-fabric-26.2" = _GYu73iPJ;
        "pkg-3.3-neoforge-26.1" = _Psz2rruD;
        "pkg-3.3-neoforge-26.2" = _1nuGyOBC;
        "pkg-3.3.1-fabric-1.21" = _e3rC4B72;
        "pkg-3.3.1-forge-1.21" = _rHGuG5Tm;
        "pkg-3.3.1-neoforge-1.21" = _Mjqj6j81;
        "pkg-3.3.2-fabric-1.20.1" = _u6vdO2Sx;
        "pkg-3.3.2-fabric-1.21.11" = _i0VAklRD;
        "pkg-3.3.2-forge-1.20.1" = _oBVAnJx9;
        "pkg-3.3.2-fabric-1.21" = _OPoRR9IG;
        "pkg-3.3.2-forge-1.21.11" = _pCR2VcW0;
        "pkg-3.3.2-forge-1.21" = _HXEPGlzC;
        "pkg-3.3.2-neoforge-1.21" = _Uh4XJhLL;
        "pkg-3.3.2-fabric-1.21.3" = _MkByfKvN;
        "pkg-3.3.2-neoforge-1.21.11" = _26JvtZX5;
        "pkg-3.3.2-forge-1.21.3" = _AUXNMptu;
        "pkg-3.3.2-fabric-1.21.4" = _HhLLpPil;
        "pkg-3.3.2-forge-1.21.4" = _wR3yw0fF;
        "pkg-3.3.2-neoforge-1.21.3" = _BtF251e2;
        "pkg-3.3.2-fabric-1.21.5" = _ojFqGq9T;
        "pkg-3.3.2-neoforge-1.21.4" = _72pNm8sf;
        "pkg-3.3.2-forge-1.21.5" = _1nXdlnA7;
        "pkg-3.3.2-neoforge-1.21.5" = _owEDXGSU;
        "pkg-3.3.2-forge-1.21.6" = _qZWmYixs;
        "pkg-3.3.2-neoforge-1.21.6" = _cNbHncan;
        "pkg-3.3.2-fabric-1.21.9" = _BphQkfJ2;
        "pkg-3.3.2-forge-1.21.9" = _XOrlxubx;
        "pkg-3.3.2-neoforge-1.21.9" = _oVeljWVY;
        "pkg-3.3.2-fabric-26.1" = _niiFKZm5;
        "pkg-3.3.2-neoforge-26.1" = _mbqUK066;
        "pkg-3.3.2-fabric-1.21.6" = _88bD57NA;
        "pkg-3.3.2-fabric-26.2" = _cYdpAV48;
        "pkg-3.3.2-neoforge-26.2" = _WjUZiSit;
        "pkg-3.3.3-fabric-1.21.11" = _35uT4Vyh;
        "pkg-3.3.3-fabric-1.20.1" = _J1TRbBhb;
        "pkg-3.3.3-forge-1.20.1" = _BIX7ZlxN;
        "pkg-3.3.3-fabric-1.21" = _Slv3pGvf;
        "pkg-3.3.3-forge-1.21" = _RxGoCy2c;
        "pkg-3.3.3-neoforge-1.21" = _Maxn59zo;
        "pkg-3.3.3-forge-1.21.11" = _YYi44ujo;
        "pkg-3.3.3-neoforge-1.21.11" = _E20ucMfl;
        "pkg-3.3.3-fabric-1.21.3" = _qdf9VP90;
        "pkg-3.3.3-forge-1.21.3" = _l7rk4PJG;
        "pkg-3.3.3-neoforge-1.21.3" = _kaecdUOb;
        "pkg-3.3.3-fabric-1.21.4" = _Xka6KYTL;
        "pkg-3.3.3-forge-1.21.4" = _zhOmxY7d;
        "pkg-3.3.3-neoforge-1.21.4" = _ySjKSyTZ;
        "pkg-3.3.3-fabric-1.21.5" = _z50mgBnc;
        "pkg-3.3.3-forge-1.21.5" = _6u46ukpk;
        "pkg-3.3.3-neoforge-1.21.5" = _rfoGaNrj;
        "pkg-3.3.3-fabric-1.21.6" = _gmxBsvv6;
        "pkg-3.3.3-forge-1.21.6" = _fWNjqokZ;
        "pkg-3.3.3-neoforge-1.21.6" = _OcAAuoEj;
        "pkg-3.3.3-fabric-1.21.9" = _2NWYC1XD;
        "pkg-3.3.3-forge-1.21.9" = _TOxEYtXS;
        "pkg-3.3.3-neoforge-1.21.9" = _XRkQrQI2;
        "pkg-3.3.3-fabric-26.1" = _1Sjlmp3n;
        "pkg-3.3.3-neoforge-26.1" = _Nblc53K6;
        "pkg-3.3.3-fabric-26.2" = _75LlyGi8;
        "pkg-3.3.3-neoforge-26.2" = _bqwRKZmt;
        "pkg-3.3.4-fabric-1.21.11" = _dI96AXLI;
        "pkg-3.3.4-forge-1.20.1" = _jfQbHcrM;
        "pkg-3.3.4-fabric-1.20.1" = _TE68K1JY;
        "pkg-3.3.4-fabric-1.21" = _wussJIdB;
        "pkg-3.3.4-forge-1.21" = _PN45pqzw;
        "pkg-3.3.4-forge-1.21.11" = _VfDcs0fz;
        "pkg-3.3.4-neoforge-1.21" = _51bupM32;
        "pkg-3.3.4-neoforge-1.21.11" = _TUqyvqOI;
        "pkg-3.3.4-fabric-1.21.3" = _qlqmGqo8;
        "pkg-3.3.4-forge-1.21.3" = _eNJIeO3q;
        "pkg-3.3.4-neoforge-1.21.3" = _1zOQF5wK;
        "pkg-3.3.4-fabric-1.21.4" = _g3CW0Xwv;
        "pkg-3.3.4-forge-1.21.4" = _TAKsyMrN;
        "pkg-3.3.4-neoforge-1.21.4" = _JHYdSNW7;
        "pkg-3.3.4-fabric-1.21.5" = _nhIlYb3o;
        "pkg-3.3.4-forge-1.21.5" = _lI29irmQ;
        "pkg-3.3.4-neoforge-1.21.5" = _T7cNlNl0;
        "pkg-3.3.4-fabric-1.21.6" = _ecvpWmOj;
        "pkg-3.3.4-forge-1.21.6" = _VF8Pp6Hh;
        "pkg-3.3.4-neoforge-1.21.6" = _blCCfC0o;
        "pkg-3.3.4-fabric-1.21.9" = _rgdEjIl4;
        "pkg-3.3.4-forge-1.21.9" = _mMdk3CfI;
        "pkg-3.3.4-fabric-26.1" = _e3f6zF8j;
        "pkg-3.3.4-neoforge-1.21.9" = _Q6tI9UMs;
        "pkg-3.3.4-neoforge-26.1" = _EWboPjCr;
        "pkg-3.3.4-fabric-26.2" = _buPQdDt5;
        "pkg-3.3.4-neoforge-26.2" = _ixGterOL;
        "pkg-3.3.5-fabric-1.21.11" = _Ym9Qq1ZU;
        "pkg-3.3.5-fabric-1.20.1" = _YbR2h9og;
        "pkg-3.3.5-forge-1.20.1" = _CMN1owfw;
        "pkg-3.3.5-fabric-1.21" = _wXNAvHgN;
        "pkg-3.3.5-forge-1.21" = _GgxEdDYE;
        "pkg-3.3.5-forge-1.21.11" = _fuQI5nyf;
        "pkg-3.3.5-neoforge-1.21" = _szv0UmJn;
        "pkg-3.3.5-neoforge-1.21.11" = _Gb7hFNKJ;
        "pkg-3.3.5-fabric-1.21.3" = _4VDWv0Jd;
        "pkg-3.3.5-forge-1.21.3" = _Kt7hxteV;
        "pkg-3.3.5-neoforge-1.21.3" = _pFMUhhOE;
        "pkg-3.3.5-fabric-1.21.4" = _QvGbZnzN;
        "pkg-3.3.5-forge-1.21.4" = _EjTzPuK8;
        "pkg-3.3.5-neoforge-1.21.4" = _ulnlx0aQ;
        "pkg-3.3.5-fabric-1.21.5" = _ZVhVNNE2;
        "pkg-3.3.5-forge-1.21.5" = _y5vniHYS;
        "pkg-3.3.5-neoforge-1.21.5" = _PoCQ6Mny;
        "pkg-3.3.5-fabric-1.21.6" = _uPN3IxXg;
        "pkg-3.3.5-forge-1.21.6" = _lBl8Ei9P;
        "pkg-3.3.5-neoforge-1.21.6" = _FUPVoVkc;
        "pkg-3.3.5-fabric-1.21.9" = _2pJAsUpA;
        "pkg-3.3.5-forge-1.21.9" = _mwJYhC79;
        "pkg-3.3.5-neoforge-1.21.9" = _pzEsrdVv;
        "pkg-3.3.5-fabric-26.1" = _SrQK3uuO;
        "pkg-3.3.5-neoforge-26.1" = _4SuwJy4Y;
        "pkg-3.3.5-fabric-26.2" = _p8M0c1vN;
        "pkg-3.3.5-neoforge-26.2" = _7Wx3KN9W;
        "pkg-3.3.6-fabric-1.20.1" = _CG0GqFOp;
        "pkg-3.3.6-fabric-1.21.11" = _TnZnflpQ;
        "pkg-3.3.6-forge-1.20.1" = _XjgE1yBe;
        "pkg-3.3.6-fabric-1.21" = _vmwUIH7O;
        "pkg-3.3.6-forge-1.21" = _OqbqhUeC;
        "pkg-3.3.6-neoforge-1.21" = _8RgqbCVN;
        "pkg-3.3.6-forge-1.21.11" = _lo0Bpmdv;
        "pkg-3.3.6-neoforge-1.21.11" = _GzVxT3Jx;
        "pkg-3.3.6-fabric-1.21.3" = _WH3lw1Si;
        "pkg-3.3.6-forge-1.21.3" = _BSwXmchB;
        "pkg-3.3.6-neoforge-1.21.3" = _VFdxe241;
        "pkg-3.3.6-fabric-1.21.4" = _8ZE5NorK;
        "pkg-3.3.6-neoforge-1.21.4" = _RKxgkQFh;
        "pkg-3.3.6-forge-1.21.4" = _iL3n4fkJ;
        "pkg-3.3.6-fabric-1.21.5" = _GASjJZKr;
        "pkg-3.3.6-neoforge-1.21.5" = _HKQMdvJ6;
        "pkg-3.3.6-fabric-1.21.6" = _ae1OLOzX;
        "pkg-3.3.6-forge-1.21.5" = _t1QF4Lag;
        "pkg-3.3.6-forge-1.21.6" = _j4UOmh6s;
        "pkg-3.3.6-neoforge-1.21.6" = _12AEcTuD;
        "pkg-3.3.6-fabric-1.21.9" = _NHlbKbFQ;
        "pkg-3.3.6-forge-1.21.9" = _hfXzqNj4;
        "pkg-3.3.6-neoforge-1.21.9" = _tx81t3kl;
        "pkg-3.3.6-fabric-26.1" = _x608KQlq;
        "pkg-3.3.6-neoforge-26.1" = _MGIqQNww;
        "pkg-3.3.6-fabric-26.2" = _QjGIDlyH;
        "pkg-3.3.6-fabric-26.3" = _gfsJrXHb;
        "pkg-3.3.6-neoforge-26.2" = _PFycDEaa;
        "pkg-3.3.6-neoforge-26.3" = _eO4YXm8k;
        "pkg-3.3.7-fabric-1.21.11" = _lneAv26x;
        "pkg-3.3.7-fabric-1.20.1" = _8dz1ftwT;
        "pkg-3.3.7-forge-1.20.1" = _OkTiZTIn;
        "pkg-3.3.7-fabric-1.21" = _26kdY29I;
        "pkg-3.3.7-forge-1.21" = _84t6tej9;
        "pkg-3.3.7-neoforge-1.21" = _5AMSii6O;
        "pkg-3.3.7-forge-1.21.11" = _95htO7Lk;
        "pkg-3.3.7-neoforge-1.21.11" = _gcfz6g5Q;
        "pkg-3.3.7-fabric-1.21.3" = _9SE7zyuj;
        "pkg-3.3.7-neoforge-1.21.3" = _d7hZc9Sz;
        "pkg-3.3.7-forge-1.21.3" = _ZVjugDVw;
        "pkg-3.3.7-fabric-1.21.4" = _mCljDXsC;
        "pkg-3.3.7-forge-1.21.4" = _8XjTylNf;
        "pkg-3.3.7-neoforge-1.21.4" = _3ZvTZcko;
        "pkg-3.3.7-fabric-1.21.5" = _4goICpS8;
        "pkg-3.3.7-forge-1.21.5" = _KaJu4oLq;
        "pkg-3.3.7-neoforge-1.21.5" = _SgC2FW7B;
        "pkg-3.3.7-fabric-1.21.6" = _3912PwQp;
        "pkg-3.3.7-forge-1.21.6" = _oKvpdQUV;
        "pkg-3.3.7-neoforge-1.21.6" = _sbbDxV6U;
        "pkg-3.3.7-fabric-1.21.9" = _P5oeZbZJ;
        "pkg-3.3.7-forge-1.21.9" = _X81PDH8p;
        "pkg-3.3.7-neoforge-1.21.9" = _Vuc1rQXP;
        "pkg-3.3.7-fabric-26.1" = _7GaobLrM;
        "pkg-3.3.7-neoforge-26.1" = _QFJ3CMEx;
        "pkg-3.3.7-fabric-26.2" = _6kiZ0S2d;
