...
let
    ...
    in {
        ...
        "pkg-forge-1.19-1.0.7" = _O7Uv81mQ;
        "pkg-forge-1.19-1.0.8" = _4MWYRimr;
        "pkg-forge-1.19-1.0.9" = _zZppEs6l;
        "pkg-forge-1.19-1.0.10" = _fuOBXgxv;
        "pkg-forge-1.19-1.0.11" = _FsFTULi4;
        "pkg-forge-1.19.1-1.0.0" = _EMP6hR7d;
        "pkg-forge-1.19.2-1.0.0" = _PeyzfiZ7;
        "pkg-forge-1.19.3-1.0.0" = _EaYwPGkH;
        "pkg-forge-1.19.3-1.0.1" = _p3BVCot5;
        "pkg-forge-1.19.3-1.0.2" = _OgLHEAnV;
        "pkg-forge-1.19.3-1.0.3" = _tPZEKTuw;
        "pkg-forge-1.19.4-1.0.3" = _Z1GSvBlM;
        "pkg-forge-1.19.2-1.0.4" = _sWU9UTpc;
        "pkg-forge-1.19.4-1.0.4" = _YtUPxaSf;
        "pkg-forge-1.20-1.0.4" = _6WhidDxj;
        "pkg-forge-1.20.1-1.0.4" = _ijVRuv4R;
        "pkg-forge-1.20.1-1.0.5" = _cm4SmbX0;
        "pkg-forge-1.20.1-1.0.6" = _b3eCl8Sg;
        "pkg-forge-1.20.1-1.0.7" = _rEJvtDAY;
        "pkg-forge-1.20.1-1.0.8" = _MABSV53a;
        "pkg-forge-1.20.2-1.0.8" = _C4colxO8;
        "pkg-forge-1.20.2-1.0.9" = _ipz7QFQK;
        "pkg-neoforge-1.20.2-1.0.9" = _En8y4Qqv;
        "pkg-neoforge-1.20.2-1.0.10" = _zPLMH9Fw;
        "pkg-forge-1.20.2-1.0.11" = _aJm55Rq0;
        "pkg-neoforge-1.20.2-1.0.11" = _GXr9xxJ8;
        "pkg-neoforge-1.20.3-1.0.11" = _S1hB3lug;
        "pkg-neoforge-1.20.4-1.0.11" = _YxLtj3qg;
        "pkg-forge-1.19.2-1.0.12" = _zYk0Qrm8;
        "pkg-forge-1.20.1-1.0.12" = _GVPFbxS5;
        "pkg-neoforge-1.20.4-1.0.12" = _mrHz3IBz;
        "pkg-forge-1.19.2-1.0.13" = _H463E3hc;
        "pkg-forge-1.20.1-1.0.13" = _tBW16eih;
        "pkg-neoforge-1.20.4-1.0.13" = _7tfC3lCk;
        "pkg-neoforge-1.20.4-1.0.14" = _p7vjo5gi;
        "pkg-forge-1.19.2-1.0.15" = _MkMc7pfG;
        "pkg-forge-1.20.1-1.0.15" = _gtehUXb7;
        "pkg-neoforge-1.20.4-1.0.15" = _4OneFNPB;
        "pkg-forge-1.19.2-1.0.16" = _vg3dMxqb;
        "pkg-forge-1.20.1-1.0.16" = _VEMy4zTC;
        "pkg-neoforge-1.20.4-1.0.16" = _pZKmR7et;
        "pkg-neoforge-1.20.5-1.0.16" = _L0XkHrlb;
        "pkg-neoforge-1.20.6-1.0.16" = _2TcMHyo9;
        "pkg-forge-1.19.2-1.0.17" = _VSLoF0kv;
        "pkg-forge-1.20.1-1.0.17" = _jVmwSyo0;
        "pkg-neoforge-1.20.4-1.0.17" = _RBCByfqa;
        "pkg-neoforge-1.20.6-1.0.17" = _JDDmqzfg;
        "pkg-neoforge-1.20.6-1.0.18" = _iAnG4alO;
        "pkg-neoforge-1.20.6-1.0.19" = _8Qn6r1Vq;
        "pkg-neoforge-1.21-1.0.19" = _eCgv7C6T;
        "pkg-neoforge-1.20.6-1.0.20" = _8LD8HzST;
        "pkg-neoforge-1.21-1.0.20" = _fPWEPO9Z;
        "pkg-neoforge-1.21-1.0.21" = _HLi88mP7;
        "pkg-neoforge-1.21-1.0.22" = _CSjRy2qP;
        "pkg-forge-1.19.2-1.0.23" = _ikKW7XEL;
        "pkg-forge-1.20.1-1.0.23" = _ggnWXFMo;
        "pkg-neoforge-1.21-1.0.23" = _eneTGtMc;
        "pkg-neoforge-1.21-1.0.24" = _rCzQxT20;
        "pkg-neoforge-1.21.1-1.0.24" = _1Dk6Ch4i;
        "pkg-forge-1.19.2-1.0.25" = _rNTyhjdf;
        "pkg-forge-1.20.1-1.0.25" = _mCpLG9yZ;
        "pkg-neoforge-1.21.1-1.0.25" = _NTNOVCA4;
        "pkg-forge-1.19.2-1.0.26" = _imPKGxRC;
        "pkg-forge-1.20.1-1.0.26" = _QTLtvcNW;
        "pkg-neoforge-1.21.1-1.0.26" = _qiCMQ1R5;
        "pkg-neoforge-1.21.1-1.0.27" = _TlnksXIn;
        "pkg-neoforge-1.21.1-1.0.28" = _uuEGmjI9;
        "pkg-forge-1.19.2-1.0.29" = _SLlagjUw;
        "pkg-forge-1.20.1-1.0.29" = _xOE3tOLe;
        "pkg-neoforge-1.21.1-1.0.29" = _iwEoaoDq;
        "pkg-forge-1.19.2-1.0.30" = _ry0qjsqs;
        "pkg-forge-1.20.1-1.0.30" = _eenzUktG;
        "pkg-neoforge-1.21.1-1.0.30" = _8KOiikgo;
        "pkg-neoforge-1.21.1-1.0.31" = _WFoWxmv1;
        "pkg-forge-1.19.2-1.0.32" = _6kWHaaua;
        "pkg-forge-1.20.1-1.0.32" = _4MZRQ4mt;
        "pkg-neoforge-1.21.1-1.0.32" = _KcYoy2Iz;
        "pkg-neoforge-1.21.2-1.0.32" = _m5ZyPynK;
        "pkg-neoforge-1.21.3-1.0.32" = _2ZbZUlEq;
        "pkg-forge-1.20.1-1.0.33" = _Tb3lqWn6;
        "pkg-neoforge-1.21.1-1.0.33" = _eliW5LQU;
        "pkg-neoforge-1.21.3-1.0.33" = _fFo5qZF2;
        "pkg-neoforge-1.21.4-1.0.33" = _bIdAXTii;
        "pkg-forge-1.20.1-1.0.34" = _ICtTLMEm;
        "pkg-neoforge-1.21.1-1.0.34" = _zJxY6CHb;
        "pkg-neoforge-1.21.4-1.0.34" = _aqzJgEeH;
        "pkg-neoforge-1.21.4-1.0.35" = _GCU3hGIS;
        "pkg-neoforge-1.21.5-1.0.35" = _23pMxd8E;
        "pkg-neoforge-1.21.5-1.0.36" = _xhrijjss;
        "pkg-neoforge-1.21.5-1.0.37" = _vl9kMvBg;
        "pkg-neoforge-1.21.6-1.0.37" = _1XVkkwYS;
        "pkg-neoforge-1.21.6-1.0.38" = _Cn2uypgq;
        "pkg-neoforge-1.21.6-1.0.39" = _1euZdvxh;
        "pkg-neoforge-1.21.7-1.0.39" = _naNFGJFC;
        "pkg-neoforge-1.21.7-1.0.40" = _UNzbMrV6;
        "pkg-neoforge-1.21.8-1.0.40" = _4nduyjB1;
        "pkg-neoforge-1.21.1-1.0.40" = _roIp3d7C;
        "pkg-neoforge-1.21.4-1.0.40" = _c0KtSdkC;
        "pkg-neoforge-1.21.5-1.0.40" = _MdoHlUpQ;
        "pkg-neoforge-1.21.9-1.0.40" = _6TmiyCcw;
        "pkg-neoforge-1.21.9-1.0.41" = _Pa2MsDBR;
        "pkg-forge-1.20.1-1.0.42" = _ImfnHW7F;
        "pkg-neoforge-1.21.1-1.0.42" = _vCl7AnA5;
        "pkg-neoforge-1.21.9-1.0.42" = _YcOcWoIY;
        "pkg-forge-1.20.1-1.0.43" = _Q8jQlzzb;
        "pkg-neoforge-1.21.1-1.0.43" = _LnsdKR85;
        "pkg-neoforge-1.21.9-1.0.43" = _lapbhcJd;
        "pkg-neoforge-1.21.10-1.0.43" = _EzXccpI1;
        "pkg-neoforge-1.21.10-1.0.44" = _ODdMTuGF;
        "pkg-forge-1.20.1-1.0.45" = _qGNcCoKJ;
        "pkg-neoforge-1.21.1-1.0.45" = _m8a84BfH;
        "pkg-neoforge-1.21.10-1.0.45" = _DJXh66uV;
        "pkg-neoforge-1.21.11-1.0.45" = _vMSSUvqy;
        "pkg-neoforge-1.21.1-1.0.46" = _pdJf8Ces;
        "pkg-neoforge-1.21.10-1.0.46" = _j4gwtvhL;
        "pkg-neoforge-1.21.11-1.0.46" = _9oWrySlM;
        "pkg-neoforge-1.0.46+26.1" = _lQCCBeD1;
        "pkg-neoforge-1.0.47+26.1" = _FtOZ77y9;
        "pkg-neoforge-1.0.47+26.1.1" = _SLHcCgqA;
        "pkg-neoforge-1.0.47+26.1.2" = _RfJFbCpK;
