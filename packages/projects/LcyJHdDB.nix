...
let
    versions = (let
        ...
        _uj2hBSp8 = {
            "id" = "uj2hBSp8";
            "file" = "3.4 FA Illager Mod Compats.zip";
            "hash" = "sha512-jRiWrZaEkiCOEOQ1cMUN+hwNtlvE1dIcbLkTtmb1GllpsgKFQb+ijtD8MEhXQMNXNiHdNQ4B59NlvBEbZ98RrQ==";
        };
        _A7AQZwny = {
            "id" = "A7AQZwny";
            "file" = "3.5 FA Illager Mod Compats.zip";
            "hash" = "sha512-3TsdvffwV20tMixhA/lD7//UHzmRhHYStCfJSS22nts/07H06GacqHuMRJIMFXw0SusJJcqyfOxFBW20pse67Q==";
        };
        _egWYgIxf = {
            "id" = "egWYgIxf";
            "file" = "3.6 FA Illager Mod Compats.zip";
            "hash" = "sha512-1//MfoFxsKqSzcJfFY6ksC8qng3xaB181gaFStUSsXHYiFfMue45EQo08ATkn0xdA7LKu0RSSt0cCj/19j6MCQ==";
        };
        _BWiinIaZ = {
            "id" = "BWiinIaZ";
            "file" = "3.7 FA Illager Mod Compats.zip";
            "hash" = "sha512-amKOPDoUh34fivzt7eL2zfQNuBeQqXevyVOSLz+xFAPd0t+Tv2eaz6P/Z7VhwaMuLoLnEgzA3p5FBluGsiGgkA==";
        };
        _mFFGvuNQ = {
            "id" = "mFFGvuNQ";
            "file" = "3.8 FA Illager Mod Compats.zip";
            "hash" = "sha512-8M8GJ0Bq2/1VyWDmTQLkxslFnAvpa2eRxrl05NlKXEzPZrmNlhRF0DJYqx9R5xEvJ/Olef3wdo04PUwlcyRooQ==";
        };
        _CgJS2Qi0 = {
            "id" = "CgJS2Qi0";
            "file" = "3.9 FA Illager Mod Compats.zip";
            "hash" = "sha512-EPLlNmMA0EBNY7c4g9S7XGuyPGXOb1kERBtTi54huPieO89KvHNcaqQuK/0N+OaTU4umDxpSP6Qk6yfXnCrKaA==";
        };
        _4Nr8H7hJ = {
            "id" = "4Nr8H7hJ";
            "file" = "4.0 FA Illager Mod Compats.zip";
            "hash" = "sha512-ZZwPHdsuYmnv5zoJ7CoiHOXNtXeWVF+6iiq5rPJpF3dhrwbOsUeG+6jiIRaOinMvUQ6eWl+hWIWSTmT4rfVnGw==";
        };
        _5iGmHKmf = {
            "id" = "5iGmHKmf";
            "file" = "4.1 FA Illager Mod Compats.zip";
            "hash" = "sha512-izqhsQaqPQiIX9EgyzVjn9lDd7CtulFCL5vLveDRiRXNV2Iv4WP05VeoWsKjtAiQg4QGm/p4L3sr/0MPNjKB2g==";
        };
        _3bdUQGky = {
            "id" = "3bdUQGky";
            "file" = "4.2 FA Illager Mod Compats.zip";
            "hash" = "sha512-ylEyT/IC0jn0u2j8HobPOIPtk5fYOdhVghGqUhzAfPi0Qd4kamtKerBscQWHAKpRWB7kR5INLd6cGH2k9Gm8EA==";
        };
        _AAVu0P0V = {
            "id" = "AAVu0P0V";
            "file" = "4.3 FA Illager Mod Compats.zip";
            "hash" = "sha512-gCeuCV57V1X2y14V4lvHEJNc4jy0mTBXenmlHy9bfPAZOQorcvLM12sii3nrjU/gU1YK5UbRTzYyjexsGlkhZA==";
        };
        _I4ZS1uNa = {
            "id" = "I4ZS1uNa";
            "file" = "4.5 FA Illager Mod Compats.zip";
            "hash" = "sha512-XumRXkBDIUPxkYVfasgvCWdpb3BdKYNMOQT7mmQZTr8SdkqynI1h80QEGu9qyg8EGcu4YpEQifHC43bpSjGs2w==";
        };
        _I72cqmG4 = {
            "id" = "I72cqmG4";
            "file" = "4.6 FA Illager Mod Compats.zip";
            "hash" = "sha512-UF1x8QnpegrX5MY8wTTovlY/2UrW29+TgXpRaEkCfMrQc5p6YZPmUG+MM6BFMk0vhpAFJ55o0Yw0hkEgBz6cIw==";
        };
    in {
        "VezsIdod" = _VezsIdod;
        "xwxLM7A3" = _xwxLM7A3;
        ...
        "I4ZS1uNa" = _I4ZS1uNa;
        "I72cqmG4" = _I72cqmG4;
        "minecraft-1.14" = _I72cqmG4;
        "minecraft-1.14.1" = _I72cqmG4;
        "minecraft-1.14.2" = _I72cqmG4;
        "minecraft-1.14.3" = _I72cqmG4;
        "minecraft-1.14.4" = _I72cqmG4;
        "minecraft-1.15" = _I72cqmG4;
        "minecraft-1.15.1" = _I72cqmG4;
        "minecraft-1.15.2" = _I72cqmG4;
        "minecraft-1.16" = _I72cqmG4;
        "minecraft-1.16.1" = _I72cqmG4;
        "minecraft-1.16.2" = _I72cqmG4;
        "minecraft-1.16.3" = _I72cqmG4;
        "minecraft-1.16.4" = _I72cqmG4;
        "minecraft-1.16.5" = _I72cqmG4;
        "minecraft-1.17" = _I72cqmG4;
        "minecraft-1.17.1" = _I72cqmG4;
        "minecraft-1.18" = _I72cqmG4;
        "minecraft-1.18.1" = _I72cqmG4;
        "minecraft-1.18.2" = _I72cqmG4;
        "minecraft-1.19" = _I72cqmG4;
        "minecraft-1.19.1" = _I72cqmG4;
        "minecraft-1.19.2" = _I72cqmG4;
        "minecraft-1.19.3" = _I72cqmG4;
        "minecraft-1.19.4" = _I72cqmG4;
        "minecraft-1.20" = _I72cqmG4;
        "minecraft-1.20.1" = _I72cqmG4;
        "minecraft-23w31a" = _I72cqmG4;
        "minecraft-23w32a" = _I72cqmG4;
        "minecraft-23w33a" = _I72cqmG4;
        "minecraft-23w35a" = _I72cqmG4;
        "minecraft-1.20.2-pre1" = _I72cqmG4;
        "minecraft-1.20.2" = _I72cqmG4;
        "minecraft-23w42a" = _I72cqmG4;
        "minecraft-23w43a" = _I72cqmG4;
        "minecraft-23w43b" = _I72cqmG4;
        "minecraft-23w44a" = _I72cqmG4;
        "minecraft-23w45a" = _I72cqmG4;
        "minecraft-23w46a" = _I72cqmG4;
        "minecraft-1.20.3" = _I72cqmG4;
        "minecraft-1.20.4" = _I72cqmG4;
        "minecraft-24w03a" = _I72cqmG4;
        "minecraft-24w03b" = _I72cqmG4;
        "minecraft-24w04a" = _I72cqmG4;
        "minecraft-24w05a" = _I72cqmG4;
        "minecraft-24w05b" = _I72cqmG4;
        "minecraft-24w06a" = _I72cqmG4;
        "minecraft-24w07a" = _I72cqmG4;
        "minecraft-24w09a" = _I72cqmG4;
        "minecraft-24w10a" = _I72cqmG4;
        "minecraft-24w11a" = _I72cqmG4;
        "minecraft-24w12a" = _I72cqmG4;
        "minecraft-24w13a" = _I72cqmG4;
        "minecraft-24w14potato" = _I72cqmG4;
        "minecraft-24w14a" = _I72cqmG4;
        "minecraft-1.20.5-pre1" = _I72cqmG4;
        "minecraft-1.20.5-pre2" = _I72cqmG4;
        "minecraft-1.20.5-pre3" = _I72cqmG4;
        "minecraft-1.20.5" = _I72cqmG4;
        "minecraft-1.20.6" = _I72cqmG4;
        "minecraft-24w18a" = _I72cqmG4;
        "minecraft-24w19a" = _I72cqmG4;
        "minecraft-24w19b" = _I72cqmG4;
        "minecraft-24w20a" = _I72cqmG4;
        "minecraft-1.21" = _I72cqmG4;
        "minecraft-1.21.1" = _I72cqmG4;
        "minecraft-24w33a" = _I72cqmG4;
        "minecraft-24w34a" = _I72cqmG4;
        "minecraft-24w35a" = _I72cqmG4;
        "minecraft-24w36a" = _I72cqmG4;
        "minecraft-24w37a" = _I72cqmG4;
        "minecraft-24w38a" = _I72cqmG4;
        "minecraft-24w39a" = _I72cqmG4;
        "minecraft-24w40a" = _I72cqmG4;
        "minecraft-1.21.2-pre1" = _I72cqmG4;
        "minecraft-1.21.2-pre2" = _I72cqmG4;
        "minecraft-1.21.2" = _I72cqmG4;
        "minecraft-1.21.3" = _I72cqmG4;
        "minecraft-24w44a" = _I72cqmG4;
        "minecraft-24w45a" = _I72cqmG4;
        "minecraft-24w46a" = _I72cqmG4;
        "minecraft-1.21.4" = _I72cqmG4;
        "minecraft-1.21.5" = _I72cqmG4;
        "minecraft-1.21.6" = _I72cqmG4;
        "minecraft-1.21.7" = _I72cqmG4;
        "minecraft-1.21.8" = _I72cqmG4;
        "minecraft-1.21.9" = _I72cqmG4;
        "minecraft-1.21.10" = _I72cqmG4;
        "minecraft-1.21.11" = _I72cqmG4;
        "minecraft-26.1" = _I72cqmG4;
        "minecraft-26.1.1" = _I72cqmG4;
        "minecraft-26.1.2" = _I72cqmG4;
        "minecraft-26.2" = _I72cqmG4;
        "minecraft-26.3" = _I72cqmG4;
        "pkg-1.9.5" = _VezsIdod;
        "pkg-1.9.6" = _xwxLM7A3;
        "pkg-1.9.7" = _pKiZCxvo;
        "pkg-2.0" = _OjxiVVX9;
