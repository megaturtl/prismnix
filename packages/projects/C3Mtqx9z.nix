...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.0.3" = _AfQvgwPU;
        "pkg-1.20.1-1.0.4" = _COgdzWiX;
        "pkg-1.20.1-1.0.5" = _548YrHcB;
        "pkg-1.20.1-1.0.6" = _VeuShJWk;
        "pkg-1.20.1-1.0.7" = _wAhgyj9T;
        "pkg-1.20.1-1.0.8" = _HtEB3Bor;
        "pkg-1.20.1-1.0.9" = _CmME0bZt;
        "pkg-1.20.1-1.0.10" = _NSkfx4BW;
        "pkg-1.20.1-1.0.11" = _haaHKjLh;
        "pkg-1.20.1-1.0.12" = _eq9DCd4C;
        "pkg-1.20.1-1.0.13" = _ePnpwlNV;
        "pkg-1.20.1-1.0.14" = _Pjf90wpR;
        "pkg-1.20.1-1.0.15" = _alsZh43X;
        "pkg-1.20.1-1.0.16" = _IsDZ0N1Z;
        "pkg-1.20.1-1.0.17" = _7QKrlNjA;
        "pkg-1.20.1-1.0.18" = _mhdCjyQt;
        "pkg-1.20.1-1.1.0" = _NAxF5OXv;
        "pkg-1.20.1-1.1.1" = _az0OBpPX;
        "pkg-1.20.1-1.2.0" = _ekZZsjuY;
        "pkg-1.20.1-1.2.1" = _5F0P6hP6;
        "pkg-1.20.1-1.2.2" = _Ovkb4b2d;
        "pkg-1.20.1-1.2.3" = _IiujFr6r;
        "pkg-1.2.4" = _tYhjswMB;
        "pkg-1.2.5" = _67WGNoKf;
        "pkg-1.2.7" = _mZwtw4x2;
        "pkg-1.2.8" = _dlrsKws6;
        "pkg-1.2.9" = _26RBCadU;
        "pkg-1.2.10" = _eODEj5hj;
