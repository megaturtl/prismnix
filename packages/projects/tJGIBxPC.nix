...
let
    ...
    in {
        ...
        "pkg-1.1.0+1.20.4" = _awNnTe9o;
        "pkg-1.2.0+1.21" = _3eA6vh21;
        "pkg-1.2.1+1.21" = _dZALGIsD;
        "pkg-1.1.1+1.20.4" = _X2tqhFnG;
        "pkg-1.3.0+1.21" = _hYcjwjAY;
        "pkg-1.4.0-beta-1.21" = _o36NkFhO;
        "pkg-1.5.0-beta-1.21.1" = _qVcORZTJ;
        "pkg-1.5.1-beta-1.21.1" = _ZBtaxMUa;
        "pkg-1.5.2-beta-1.21.1" = _xYVFGFOg;
        "pkg-1.5.3-beta-1.21.1" = _On56WC0G;
        "pkg-1.6.0-beta-1.21.1" = _KWCqqsZx;
        "pkg-1.6.1-beta-1.21.1" = _TLAW2gIB;
        "pkg-1.6.2-beta-1.21.1" = _rsGFqslV;
        "pkg-1.6.3-beta-1.21.1" = _lFipPvCA;
        "pkg-1.7.0-beta-1.21.1" = _iDtmIaXT;
        "pkg-1.8.0-1.21.1" = _SXSAGGZP;
        "pkg-1.8.1-1.21.1" = _aOTrWMuL;
        "pkg-1.8.2-1.21.1" = _rhAikiw7;
        "pkg-1.8.3-1.21.1" = _iAOhspSX;
        "pkg-1.8.4-1.21.1" = _ECtd0Jn1;
        "pkg-1.8.5-1.21.1" = _pudSac3o;
        "pkg-1.8.6-1.21.1" = _5SDrXgAa;
        "pkg-1.8.7-1.21.1" = _DGFvHtxe;
        "pkg-1.8.8-1.21.1" = _5hTxHSFB;
        "pkg-1.8.9-1.21.1" = _9xtBpiuA;
        "pkg-1.8.10-1.21.1" = _s3w7EB6h;
        "pkg-1.8.11-1.21.1" = _zsBCT1IT;
        "pkg-1.8.12-1.21.1" = _S33hLdqG;
        "pkg-1.8.13-1.21.1" = _cVyOEHCD;
        "pkg-1.8.14-1.21.1" = _gC2cfbJ9;
        "pkg-1.8.15-1.21.1" = _biuYdwWx;
        "pkg-1.8.16-1.21.1" = _Y4usuICT;
        "pkg-1.8.17-1.21.1" = _APO5h8CN;
        "pkg-1.8.18-1.21.1" = _jqpG3aC9;
        "pkg-1.8.19-1.21.1" = _ZWtrsZCZ;
        "pkg-1.8.20-1.21.1" = _uTBRmX0W;
        "pkg-1.8.21-1.21.1" = _Zom70m5V;
        "pkg-1.9.0-1.21.1" = _BCpb4U2u;
