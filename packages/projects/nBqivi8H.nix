...
let
    ...
    in {
        ...
        "pkg-2.3.3.261" = _WnF8uVjR;
        "pkg-2.1.5.262" = _JnacmmNe;
        "pkg-2.1.6.263" = _3GvQuUkr;
        "pkg-2.2.4.264" = _LUPmccna;
        "pkg-2.3.4.265" = _12NS2Bk5;
        "pkg-2.1.7.266" = _pHnk5j0S;
        "pkg-2.3.5.269" = _w7PIvVka;
        "pkg-2.2.5.271" = _Ahd0p6JL;
        "pkg-2.1.8.273" = _idAilIMs;
        "pkg-2.3.7.278" = _SAaBOx2u;
        "pkg-2.3.8.279" = _MjjyUh2u;
        "pkg-2.3.9.283" = _JNu61LNh;
        "pkg-2.3.10.284" = _J0Ff0QbE;
        "pkg-2.3.11.290" = _DhxaYy8T;
        "pkg-2.3.12.297" = _Q1zSnNoU;
        "pkg-2.3.12.304" = _rzR4PFTz;
        "pkg-2.3.13.306" = _asZH7DNs;
        "pkg-2.3.14.308" = _mhg1BW8C;
        "pkg-2.3.15.312" = _GYEIEahs;
        "pkg-2.3.17.321" = _YOvmWRGF;
        "pkg-2.3.18.329" = _uG8iJCY2;
        "pkg-2.3.19.330" = _HuspoWkO;
        "pkg-2.3.20.333" = _uMWrv6OM;
        "pkg-2.3.21.342" = _4PYNw0ZK;
        "pkg-2.3.22.343" = _rwTMs0HE;
        "pkg-2.3.23.345" = _UjIUPWZu;
        "pkg-2.3.24.349" = _cWBBFDlX;
        "pkg-2.3.25.351" = _J0TWFn3G;
        "pkg-2.3.27.353" = _gP9JX1lX;
        "pkg-2.3.28.354" = _jGfLfP4K;
        "pkg-3.0.7.389" = _XfYSzmsm;
        "pkg-3.0.8.390" = _I4X4cBoJ;
        "pkg-3.0.9.392" = _dHaKrgj7;
        "pkg-3.0.11.396" = _GwDzImsZ;
        "pkg-3.0.12.406" = _lVb9iCa5;
        "pkg-3.0.13.408" = _HAiePN0k;
        "pkg-3.0.14.412" = _SkMQuZga;
        "pkg-3.0.15.415" = _wlHBQWYX;
        "pkg-3.0.16.417" = _cQ6zYij4;
        "pkg-3.0.17.420" = _XWmFYi9z;
        "pkg-3.0.18.428" = _atXs68Ml;
        "pkg-3.0.19.432" = _1ELTyjbb;
        "pkg-3.0.20.440" = _5SakwVBP;
        "pkg-3.0.21.443" = _GSaFWnWC;
        "pkg-3.0.22.444" = _VQZBHHAL;
        "pkg-3.0.23.451" = _Ehfd6UD6;
        "pkg-3.0.24.452" = _sUKQrpgw;
        "pkg-3.0.25.456" = _9skmx9MF;
        "pkg-3.0.26.459" = _GO4xkO7f;
        "pkg-3.0.27.462" = _4ZiMm6P9;
        "pkg-3.0.28.500" = _J8xqMQac;
        "pkg-3.0.29.507" = _KgZ5rBTj;
        "pkg-3.0.27.515" = _TfoU5mud;
        "pkg-3.0.28.516" = _PLu3YEQp;
        "pkg-3.0.29.518" = _CcXWgwLo;
        "pkg-3.0.29.524" = _9deZgp5v;
        "pkg-3.0.30.529" = _S15O1OHb;
        "pkg-3.0.31.531" = _ASrbjsih;
        "pkg-3.1.1.565" = _qzP5LS4e;
        "pkg-3.1.2.569" = _4PsRHFSy;
        "pkg-3.1.2.571" = _UQo5Rcvi;
        "pkg-3.1.2.575" = _I2thehKX;
        "pkg-3.1.2.581" = _Mac9Af5n;
        "pkg-3.1.2.583" = _d53l4Hnw;
        "pkg-3.1.2.588" = _l9BgMzOt;
        "pkg-3.1.2.598" = _Gy454rgW;
        "pkg-3.1.2.601" = _6rSD66FH;
        "pkg-3.1.2.602" = _55M378Ea;
        "pkg-3.1.2.604" = _tkerHB19;
        "pkg-3.1.2.605" = _gKtYxPl1;
        "pkg-3.1.2.615" = _wV2dxRpV;
        "pkg-3.1.3.617" = _95gh5ONX;
        "pkg-3.1.3.618" = _69VsJvHd;
        "pkg-3.1.3.620" = _qOa989HU;
        "pkg-3.1.2.621" = _YR33MHbk;
        "pkg-3.1.3.622" = _n5FNRb6H;
        "pkg-3.1.3.623" = _fhxiyAyu;
        "pkg-3.1.3.625" = _Ycsve7Fo;
        "pkg-3.1.3.627" = _Dbp9EmsO;
