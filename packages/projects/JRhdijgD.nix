...
let
    ...
    in {
        ...
        "pkg-1.0.3-h1.2.6" = _i1mrXmMi;
        "pkg-1.0.4-h1.2.6" = _SKwjJiyT;
        "pkg-1.0.5-h1.2.6" = _E295ICMM;
        "pkg-1.0.6-h1.2.6" = _eUDRGg0s;
        "pkg-1.0.7-h1.2.6" = _cxWIpuGh;
        "pkg-1.0.8-h1.2.6" = _z0vYec1u;
        "pkg-1.0.9-h1.2.6" = _g9ZP53wG;
        "pkg-1.0.10-h1.2.6" = _xcEucPI8;
        "pkg-1.0.11-h1.2.6" = _7qE8NBMs;
        "pkg-1.0.12-h1.2.6" = _y6kVuvP9;
        "pkg-1.1-h1.3" = _2iUCEuKk;
        "pkg-1.1.1-h1.3" = _AcO7zA6r;
        "pkg-1.1.2-h1.3" = _7FqaUhwh;
        "pkg-1.1.3-h1.3" = _Z9YkbzSa;
        "pkg-1.2-h1.3" = _PApHmclK;
        "pkg-1.2.1-h1.3" = _2obTO1yh;
