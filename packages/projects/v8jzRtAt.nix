...
let
    ...
    in {
        ...
        "pkg-v1.8.12" = _Cy8sxUkv;
        "pkg-v1.9.3.1" = _f7gI6Z0c;
        "pkg-v1.8.22.2" = _TczkcMhv;
        "pkg-v1.9.1" = _q6YqkfZh;
        "pkg-v1.9.4" = _Ye2GkAll;
        "pkg-v1.9.4-beta1" = _yAcmyKhO;
        "pkg-v1.9.5" = _lg2Ayoyz;
        "pkg-v1.9.6" = _TT7wBWUo;
        "pkg-v1.9.6-beta1" = _dqiNt7l6;
        "pkg-v1.9.6.1" = _DcU219qe;
        "pkg-v1.9.6.2" = _iElgCXTP;
        "pkg-v1.9.7" = _pAOYhSFG;
        "pkg-v1.9.7.1" = _pEejllCr;
        "pkg-v1.9.7-beta2" = _iVNBk11f;
        "pkg-v1.9.8" = _jtRsK8D0;
        "pkg-v1.9.8-beta1" = _bhlGbfeb;
        "pkg-v1.9.8-beta2" = _elpv7slY;
        "pkg-v1.9.8-beta3" = _lVmEhAcT;
        "pkg-v1.9.8-beta4" = _TeaH5Ucb;
        "pkg-v1.9.9" = _uzxU6Qyc;
        "pkg-v1.4.2024" = _ALTatTPh;
        "pkg-v1.9.9-beta1" = _wtGEY20W;
        "pkg-v1.9.9-beta2" = _d4F7WON1;
        "pkg-v1.9.10" = _SiNjZ1n5;
        "pkg-v1.9.10-beta1" = _CAaB4pFf;
        "pkg-v1.9.10.1" = _LIXO44tK;
        "pkg-1.9.10-beta2" = _ZhRY0rEe;
        "pkg-v1.9.10-beta3" = _U02FsvV3;
        "pkg-v1.9.10.2" = _aOI1StpJ;
        "pkg-v1.9.10-beta4" = _wHtloXwm;
        "pkg-v1.9.10-beta5" = _M8KLoYNc;
        "pkg-v1.9.10-beta6" = _9ZLY6v7N;
        "pkg-v1.9.10-beta7" = _9aseGMM0;
        "pkg-v1.9.10-beta8" = _KQ0fs6p6;
        "pkg-v1.9.10-beta9" = _6TDA6q5x;
        "pkg-v1.9.11" = _HAh7fFcj;
        "pkg-v1.9.11-beta1" = _Uc5cTeKk;
        "pkg-v1.9.11-beta2" = _VdVWa37H;
        "pkg-v1.9.12" = _z9dlNALi;
        "pkg-v1.9.12-beta1" = _55MTSizv;
        "pkg-v1.9.12-beta2" = _j3NpxnBo;
        "pkg-v1.9.12-beta3" = _hygRhwIg;
        "pkg-v1.9.12.1" = _sovoaKdB;
        "pkg-v1.9.12-beta4" = _qJ2vvF66;
        "pkg-v1.9.12-beta5" = _lRJXpAJK;
        "pkg-v1.10" = _IZSbmpQW;
        "pkg-v1.10-beta1" = _OSeecLHe;
        "pkg-v1.10.0.1" = _KdmbFCxl;
        "pkg-v1.10-beta2" = _GgfZi0br;
        "pkg-v1.10-beta3" = _7N3EQNq0;
        "pkg-v1.10.1" = _Pzh954a1;
        "pkg-v1.10.1-beta1" = _ech0QT9H;
        "pkg-v1.10.1-beta2" = _jpuLRSTd;
        "pkg-v1.10.2-beta2" = _6Z5tYPfd;
