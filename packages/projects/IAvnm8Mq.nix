...
let
    versions = (let
        ...
        _mngShJl1 = {
            "id" = "mngShJl1";
            "file" = "villagerinabucket-fabric-26.3-1.0.0.jar";
            "hash" = "sha512-8mP4uabLR5O3jpoaQ4kyTJfyXgbWNx1Wi56yO8nt9m/Nw/iSNhoe7xm74vDrt6LkhAItXdWaXgiOh3Hk+Q9wzQ==";
        };
        _pwfOH8dS = {
            "id" = "pwfOH8dS";
