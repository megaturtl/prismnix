...
let
    versions = (let
        ...
        _kKDosytE = {
            "id" = "kKDosytE";
            "file" = "ExecutableEvents-3.26.8.9.jar";
            "hash" = "sha512-N6ycD3/khCpyUpgsdDpJ+GE7htJtLZqtY7M+hCubzLn7XC0riFH00PozaCLJx3EtWd5bD6p+c884cAMSvc4dXg==";
        };
        _BeAxwadg = {
            "id" = "BeAxwadg";
            "file" = "ExecutableEvents-3.26.8.10.jar";
            "hash" = "sha512-EZ58Gcq8O6nDAgD0rehc27xZRlG4oKZqrIiFu71tufjG7QVBzEu4+HJJVDN84m52SXbFOk3CSQCTXDU9KumoLg==";
        };
        _61X0ltnu = {
            "id" = "61X0ltnu";
            "file" = "ExecutableEvents-3.26.8.30.jar";
            "hash" = "sha512-VyCNQl5fiRZUie6qPc5MGUPr7qUTJgR04qEMvve0DTlcSHSK1DyS6ThT/Jr0nMyrJgA/ILtYDxkAn8YC6h6csw==";
        };
        _JyX28Dc2 = {
            "id" = "JyX28Dc2";
            "file" = "ExecutableEvents-3.26.9.1.jar";
            "hash" = "sha512-HKXPhjJhggEh2uateqq5ESL5KOThO7/g7KV7QfTeJqdPuR5rZeHzYEf52smcnF44YsEjwbUuir6SojBIFYXU8A==";
        };
        _IQsnr2cV = {
            "id" = "IQsnr2cV";
            "file" = "ExecutableEvents-3.26.9.6.jar";
            "hash" = "sha512-tialXqcIFRwOcRqNYLgirP3ZJIMtaOuoUTD3aA0OE3B4PYBglWsOEt54eywlM2jbE1SfooUsUaXI8G+DCQo7Kg==";
        };
        _LNBD5R97 = {
            "id" = "LNBD5R97";
            "file" = "ExecutableEvents-3.26.9.9.jar";
            "hash" = "sha512-5R6mDrBa/VwZVaH80neQvxg0cpEn6Gw0B/1ZQBvuxZ94JpF0WWLTkbiETQkMPHXkDkvzAG7CUgstKAaLD1eaIw==";
        };
        _VKeLFCWp = {
            "id" = "VKeLFCWp";
            "file" = "ExecutableEvents-3.26.9.13.jar";
            "hash" = "sha512-f/cDkynZDMaG0d3MmIpjbhM+HCnQbuxcpndQrb1i++8vxW96qWM2lK7/kpBJ+QQWSwpblXRevwvuUG08KGUklg==";
        };
        _qIVPyj5f = {
            "id" = "qIVPyj5f";
            "file" = "ExecutableEvents-3.26.9.14.jar";
            "hash" = "sha512-TZunQ3vVfzdGaxlmXToQC5QAK5+xdkkrE9R+dhaCGi2KuRdTHOeF46nS1FHZmS7QpaASuHxLRY1+Ik9yDY6qCw==";
        };
    in {
        "FPskKr76" = _FPskKr76;
        "jyVVo5AE" = _jyVVo5AE;
        ...
        "VKeLFCWp" = _VKeLFCWp;
        "qIVPyj5f" = _qIVPyj5f;
        "bukkit-1.8" = _qIVPyj5f;
        "bukkit-1.8.1" = _qIVPyj5f;
        "bukkit-1.8.2" = _qIVPyj5f;
        "bukkit-1.8.3" = _qIVPyj5f;
        "bukkit-1.8.4" = _qIVPyj5f;
        "bukkit-1.8.5" = _qIVPyj5f;
        "bukkit-1.8.6" = _qIVPyj5f;
        "bukkit-1.8.7" = _qIVPyj5f;
        "bukkit-1.8.8" = _qIVPyj5f;
        "bukkit-1.8.9" = _qIVPyj5f;
        "bukkit-1.9" = _qIVPyj5f;
        "bukkit-1.9.1" = _qIVPyj5f;
        "bukkit-1.9.2" = _qIVPyj5f;
        "bukkit-1.9.3" = _qIVPyj5f;
        "bukkit-1.9.4" = _qIVPyj5f;
        "bukkit-1.10" = _qIVPyj5f;
        "bukkit-1.10.1" = _qIVPyj5f;
        "bukkit-1.10.2" = _qIVPyj5f;
        "bukkit-1.11" = _qIVPyj5f;
        "bukkit-1.11.1" = _qIVPyj5f;
        "bukkit-1.11.2" = _qIVPyj5f;
        "bukkit-1.12" = _qIVPyj5f;
        "bukkit-1.12.1" = _qIVPyj5f;
        "bukkit-1.12.2" = _qIVPyj5f;
        "bukkit-1.13" = _qIVPyj5f;
        "bukkit-1.13.1" = _qIVPyj5f;
        "bukkit-1.13.2" = _qIVPyj5f;
        "bukkit-1.14" = _qIVPyj5f;
        "bukkit-1.14.1" = _qIVPyj5f;
        "bukkit-1.14.2" = _qIVPyj5f;
        "bukkit-1.14.3" = _qIVPyj5f;
        "bukkit-1.14.4" = _qIVPyj5f;
        "bukkit-1.15" = _qIVPyj5f;
        "bukkit-1.15.1" = _qIVPyj5f;
        "bukkit-1.15.2" = _qIVPyj5f;
        "bukkit-1.16" = _qIVPyj5f;
        "bukkit-1.16.1" = _qIVPyj5f;
        "bukkit-1.16.2" = _qIVPyj5f;
        "bukkit-1.16.3" = _qIVPyj5f;
        "bukkit-1.16.4" = _qIVPyj5f;
        "bukkit-1.16.5" = _qIVPyj5f;
        "bukkit-1.17" = _qIVPyj5f;
        "bukkit-1.17.1" = _qIVPyj5f;
        "bukkit-1.18" = _qIVPyj5f;
        "bukkit-1.18.1" = _qIVPyj5f;
        "bukkit-1.18.2" = _qIVPyj5f;
        "bukkit-1.19" = _qIVPyj5f;
        "bukkit-1.19.1" = _qIVPyj5f;
        "bukkit-1.19.2" = _qIVPyj5f;
        "bukkit-1.19.3" = _qIVPyj5f;
        "bukkit-1.19.4" = _qIVPyj5f;
        "bukkit-1.20" = _qIVPyj5f;
        "bukkit-1.20.1" = _qIVPyj5f;
        "bukkit-1.20.2" = _qIVPyj5f;
        "bukkit-1.20.3" = _qIVPyj5f;
        "bukkit-1.20.4" = _qIVPyj5f;
        "bukkit-1.20.5" = _qIVPyj5f;
        "bukkit-1.20.6" = _qIVPyj5f;
        "bukkit-1.21" = _qIVPyj5f;
        "bukkit-1.21.1" = _qIVPyj5f;
        "bukkit-1.21.2" = _qIVPyj5f;
        "bukkit-1.21.3" = _qIVPyj5f;
        "bukkit-1.21.4" = _qIVPyj5f;
        "bukkit-1.21.5" = _qIVPyj5f;
        "bukkit-1.21.6" = _qIVPyj5f;
        "bukkit-1.21.7" = _qIVPyj5f;
        "bukkit-1.21.8" = _qIVPyj5f;
        "bukkit-1.21.9" = _qIVPyj5f;
        "bukkit-1.21.10" = _qIVPyj5f;
        "bukkit-1.21.11" = _qIVPyj5f;
        "bukkit-26.1" = _qIVPyj5f;
        "bukkit-26.2" = _qIVPyj5f;
        ...
        "folia-1.8" = _qIVPyj5f;
        "folia-1.8.1" = _qIVPyj5f;
        "folia-1.8.2" = _qIVPyj5f;
        "folia-1.8.3" = _qIVPyj5f;
        "folia-1.8.4" = _qIVPyj5f;
        "folia-1.8.5" = _qIVPyj5f;
        "folia-1.8.6" = _qIVPyj5f;
        "folia-1.8.7" = _qIVPyj5f;
        "folia-1.8.8" = _qIVPyj5f;
        "folia-1.8.9" = _qIVPyj5f;
        "folia-1.9" = _qIVPyj5f;
        "folia-1.9.1" = _qIVPyj5f;
        "folia-1.9.2" = _qIVPyj5f;
        "folia-1.9.3" = _qIVPyj5f;
        "folia-1.9.4" = _qIVPyj5f;
        "folia-1.10" = _qIVPyj5f;
        "folia-1.10.1" = _qIVPyj5f;
        "folia-1.10.2" = _qIVPyj5f;
        "folia-1.11" = _qIVPyj5f;
        "folia-1.11.1" = _qIVPyj5f;
        "folia-1.11.2" = _qIVPyj5f;
        "folia-1.12" = _qIVPyj5f;
        "folia-1.12.1" = _qIVPyj5f;
        "folia-1.12.2" = _qIVPyj5f;
        "folia-1.13" = _qIVPyj5f;
        "folia-1.13.1" = _qIVPyj5f;
        "folia-1.13.2" = _qIVPyj5f;
        "folia-1.14" = _qIVPyj5f;
        "folia-1.14.1" = _qIVPyj5f;
        "folia-1.14.2" = _qIVPyj5f;
        "folia-1.14.3" = _qIVPyj5f;
        "folia-1.14.4" = _qIVPyj5f;
        "folia-1.15" = _qIVPyj5f;
        "folia-1.15.1" = _qIVPyj5f;
        "folia-1.15.2" = _qIVPyj5f;
        "folia-1.16" = _qIVPyj5f;
        "folia-1.16.1" = _qIVPyj5f;
        "folia-1.16.2" = _qIVPyj5f;
        "folia-1.16.3" = _qIVPyj5f;
        "folia-1.16.4" = _qIVPyj5f;
        "folia-1.16.5" = _qIVPyj5f;
        "folia-1.17" = _qIVPyj5f;
        "folia-1.17.1" = _qIVPyj5f;
        "folia-1.18" = _qIVPyj5f;
        "folia-1.18.1" = _qIVPyj5f;
        "folia-1.18.2" = _qIVPyj5f;
        "folia-1.19" = _qIVPyj5f;
        "folia-1.19.1" = _qIVPyj5f;
        "folia-1.19.2" = _qIVPyj5f;
        "folia-1.19.3" = _qIVPyj5f;
        "folia-1.19.4" = _qIVPyj5f;
        "folia-1.20" = _qIVPyj5f;
        "folia-1.20.1" = _qIVPyj5f;
        "folia-1.20.2" = _qIVPyj5f;
        "folia-1.20.3" = _qIVPyj5f;
        "folia-1.20.4" = _qIVPyj5f;
        "folia-1.20.5" = _qIVPyj5f;
        "folia-1.20.6" = _qIVPyj5f;
        "folia-1.21" = _qIVPyj5f;
        "folia-1.21.1" = _qIVPyj5f;
        "folia-1.21.2" = _qIVPyj5f;
        "folia-1.21.3" = _qIVPyj5f;
        "folia-1.21.4" = _qIVPyj5f;
        "folia-1.21.5" = _qIVPyj5f;
        "folia-1.21.6" = _qIVPyj5f;
        "folia-1.21.7" = _qIVPyj5f;
        "folia-1.21.8" = _qIVPyj5f;
        "folia-1.21.9" = _qIVPyj5f;
        "folia-1.21.10" = _qIVPyj5f;
        "folia-1.21.11" = _qIVPyj5f;
        "folia-26.1" = _qIVPyj5f;
        "folia-26.2" = _qIVPyj5f;
        "paper-1.8" = _qIVPyj5f;
        "paper-1.8.1" = _qIVPyj5f;
        "paper-1.8.2" = _qIVPyj5f;
        "paper-1.8.3" = _qIVPyj5f;
        "paper-1.8.4" = _qIVPyj5f;
        "paper-1.8.5" = _qIVPyj5f;
        "paper-1.8.6" = _qIVPyj5f;
        "paper-1.8.7" = _qIVPyj5f;
        "paper-1.8.8" = _qIVPyj5f;
        "paper-1.8.9" = _qIVPyj5f;
        "paper-1.9" = _qIVPyj5f;
        "paper-1.9.1" = _qIVPyj5f;
        "paper-1.9.2" = _qIVPyj5f;
        "paper-1.9.3" = _qIVPyj5f;
        "paper-1.9.4" = _qIVPyj5f;
        "paper-1.10" = _qIVPyj5f;
        "paper-1.10.1" = _qIVPyj5f;
        "paper-1.10.2" = _qIVPyj5f;
        "paper-1.11" = _qIVPyj5f;
        "paper-1.11.1" = _qIVPyj5f;
        "paper-1.11.2" = _qIVPyj5f;
        "paper-1.12" = _qIVPyj5f;
        "paper-1.12.1" = _qIVPyj5f;
        "paper-1.12.2" = _qIVPyj5f;
        "paper-1.13" = _qIVPyj5f;
        "paper-1.13.1" = _qIVPyj5f;
        "paper-1.13.2" = _qIVPyj5f;
        "paper-1.14" = _qIVPyj5f;
        "paper-1.14.1" = _qIVPyj5f;
        "paper-1.14.2" = _qIVPyj5f;
        "paper-1.14.3" = _qIVPyj5f;
        "paper-1.14.4" = _qIVPyj5f;
        "paper-1.15" = _qIVPyj5f;
        "paper-1.15.1" = _qIVPyj5f;
        "paper-1.15.2" = _qIVPyj5f;
        "paper-1.16" = _qIVPyj5f;
        "paper-1.16.1" = _qIVPyj5f;
        "paper-1.16.2" = _qIVPyj5f;
        "paper-1.16.3" = _qIVPyj5f;
        "paper-1.16.4" = _qIVPyj5f;
        "paper-1.16.5" = _qIVPyj5f;
        "paper-1.17" = _qIVPyj5f;
        "paper-1.17.1" = _qIVPyj5f;
        "paper-1.18" = _qIVPyj5f;
        "paper-1.18.1" = _qIVPyj5f;
        "paper-1.18.2" = _qIVPyj5f;
        "paper-1.19" = _qIVPyj5f;
        "paper-1.19.1" = _qIVPyj5f;
        "paper-1.19.2" = _qIVPyj5f;
        "paper-1.19.3" = _qIVPyj5f;
        "paper-1.19.4" = _qIVPyj5f;
        "paper-1.20" = _qIVPyj5f;
        "paper-1.20.1" = _qIVPyj5f;
        "paper-1.20.2" = _qIVPyj5f;
        "paper-1.20.3" = _qIVPyj5f;
        "paper-1.20.4" = _qIVPyj5f;
        "paper-1.20.5" = _qIVPyj5f;
        "paper-1.20.6" = _qIVPyj5f;
        "paper-1.21" = _qIVPyj5f;
        "paper-1.21.1" = _qIVPyj5f;
        "paper-1.21.2" = _qIVPyj5f;
        "paper-1.21.3" = _qIVPyj5f;
        "paper-1.21.4" = _qIVPyj5f;
        "paper-1.21.5" = _qIVPyj5f;
        "paper-1.21.6" = _qIVPyj5f;
        "paper-1.21.7" = _qIVPyj5f;
        "paper-1.21.8" = _qIVPyj5f;
        "paper-1.21.9" = _qIVPyj5f;
        "paper-1.21.10" = _qIVPyj5f;
        "paper-1.21.11" = _qIVPyj5f;
        "paper-26.1" = _qIVPyj5f;
        "paper-26.2" = _qIVPyj5f;
        "purpur-1.8" = _qIVPyj5f;
        "purpur-1.8.1" = _qIVPyj5f;
        "purpur-1.8.2" = _qIVPyj5f;
        "purpur-1.8.3" = _qIVPyj5f;
        "purpur-1.8.4" = _qIVPyj5f;
        "purpur-1.8.5" = _qIVPyj5f;
        "purpur-1.8.6" = _qIVPyj5f;
        "purpur-1.8.7" = _qIVPyj5f;
        "purpur-1.8.8" = _qIVPyj5f;
        "purpur-1.8.9" = _qIVPyj5f;
        "purpur-1.9" = _qIVPyj5f;
        "purpur-1.9.1" = _qIVPyj5f;
        "purpur-1.9.2" = _qIVPyj5f;
        "purpur-1.9.3" = _qIVPyj5f;
        "purpur-1.9.4" = _qIVPyj5f;
        "purpur-1.10" = _qIVPyj5f;
        "purpur-1.10.1" = _qIVPyj5f;
        "purpur-1.10.2" = _qIVPyj5f;
        "purpur-1.11" = _qIVPyj5f;
        "purpur-1.11.1" = _qIVPyj5f;
        "purpur-1.11.2" = _qIVPyj5f;
        "purpur-1.12" = _qIVPyj5f;
        "purpur-1.12.1" = _qIVPyj5f;
        "purpur-1.12.2" = _qIVPyj5f;
        "purpur-1.13" = _qIVPyj5f;
        "purpur-1.13.1" = _qIVPyj5f;
        "purpur-1.13.2" = _qIVPyj5f;
        "purpur-1.14" = _qIVPyj5f;
        "purpur-1.14.1" = _qIVPyj5f;
        "purpur-1.14.2" = _qIVPyj5f;
        "purpur-1.14.3" = _qIVPyj5f;
        "purpur-1.14.4" = _qIVPyj5f;
        "purpur-1.15" = _qIVPyj5f;
        "purpur-1.15.1" = _qIVPyj5f;
        "purpur-1.15.2" = _qIVPyj5f;
        "purpur-1.16" = _qIVPyj5f;
        "purpur-1.16.1" = _qIVPyj5f;
        "purpur-1.16.2" = _qIVPyj5f;
        "purpur-1.16.3" = _qIVPyj5f;
        "purpur-1.16.4" = _qIVPyj5f;
        "purpur-1.16.5" = _qIVPyj5f;
        "purpur-1.17" = _qIVPyj5f;
        "purpur-1.17.1" = _qIVPyj5f;
        "purpur-1.18" = _qIVPyj5f;
        "purpur-1.18.1" = _qIVPyj5f;
        "purpur-1.18.2" = _qIVPyj5f;
        "purpur-1.19" = _qIVPyj5f;
        "purpur-1.19.1" = _qIVPyj5f;
        "purpur-1.19.2" = _qIVPyj5f;
        "purpur-1.19.3" = _qIVPyj5f;
        "purpur-1.19.4" = _qIVPyj5f;
        "purpur-1.20" = _qIVPyj5f;
        "purpur-1.20.1" = _qIVPyj5f;
        "purpur-1.20.2" = _qIVPyj5f;
        "purpur-1.20.3" = _qIVPyj5f;
        "purpur-1.20.4" = _qIVPyj5f;
        "purpur-1.20.5" = _qIVPyj5f;
        "purpur-1.20.6" = _qIVPyj5f;
        "purpur-1.21" = _qIVPyj5f;
        "purpur-1.21.1" = _qIVPyj5f;
        "purpur-1.21.2" = _qIVPyj5f;
        "purpur-1.21.3" = _qIVPyj5f;
        "purpur-1.21.4" = _qIVPyj5f;
        "purpur-1.21.5" = _qIVPyj5f;
        "purpur-1.21.6" = _qIVPyj5f;
        "purpur-1.21.7" = _qIVPyj5f;
        "purpur-1.21.8" = _qIVPyj5f;
        "purpur-1.21.9" = _qIVPyj5f;
        "purpur-1.21.10" = _qIVPyj5f;
        "purpur-1.21.11" = _qIVPyj5f;
        "purpur-26.1" = _qIVPyj5f;
        "purpur-26.2" = _qIVPyj5f;
        "spigot-1.8" = _qIVPyj5f;
        "spigot-1.8.1" = _qIVPyj5f;
        "spigot-1.8.2" = _qIVPyj5f;
        "spigot-1.8.3" = _qIVPyj5f;
        "spigot-1.8.4" = _qIVPyj5f;
        "spigot-1.8.5" = _qIVPyj5f;
        "spigot-1.8.6" = _qIVPyj5f;
        "spigot-1.8.7" = _qIVPyj5f;
        "spigot-1.8.8" = _qIVPyj5f;
        "spigot-1.8.9" = _qIVPyj5f;
        "spigot-1.9" = _qIVPyj5f;
        "spigot-1.9.1" = _qIVPyj5f;
        "spigot-1.9.2" = _qIVPyj5f;
        "spigot-1.9.3" = _qIVPyj5f;
        "spigot-1.9.4" = _qIVPyj5f;
        "spigot-1.10" = _qIVPyj5f;
        "spigot-1.10.1" = _qIVPyj5f;
        "spigot-1.10.2" = _qIVPyj5f;
        "spigot-1.11" = _qIVPyj5f;
        "spigot-1.11.1" = _qIVPyj5f;
        "spigot-1.11.2" = _qIVPyj5f;
        "spigot-1.12" = _qIVPyj5f;
        "spigot-1.12.1" = _qIVPyj5f;
        "spigot-1.12.2" = _qIVPyj5f;
        "spigot-1.13" = _qIVPyj5f;
        "spigot-1.13.1" = _qIVPyj5f;
        "spigot-1.13.2" = _qIVPyj5f;
        "spigot-1.14" = _qIVPyj5f;
        "spigot-1.14.1" = _qIVPyj5f;
        "spigot-1.14.2" = _qIVPyj5f;
        "spigot-1.14.3" = _qIVPyj5f;
        "spigot-1.14.4" = _qIVPyj5f;
        "spigot-1.15" = _qIVPyj5f;
        "spigot-1.15.1" = _qIVPyj5f;
        "spigot-1.15.2" = _qIVPyj5f;
        "spigot-1.16" = _qIVPyj5f;
        "spigot-1.16.1" = _qIVPyj5f;
        "spigot-1.16.2" = _qIVPyj5f;
        "spigot-1.16.3" = _qIVPyj5f;
        "spigot-1.16.4" = _qIVPyj5f;
        "spigot-1.16.5" = _qIVPyj5f;
        "spigot-1.17" = _qIVPyj5f;
        "spigot-1.17.1" = _qIVPyj5f;
        "spigot-1.18" = _qIVPyj5f;
        "spigot-1.18.1" = _qIVPyj5f;
        "spigot-1.18.2" = _qIVPyj5f;
        "spigot-1.19" = _qIVPyj5f;
        "spigot-1.19.1" = _qIVPyj5f;
        "spigot-1.19.2" = _qIVPyj5f;
        "spigot-1.19.3" = _qIVPyj5f;
        "spigot-1.19.4" = _qIVPyj5f;
        "spigot-1.20" = _qIVPyj5f;
        "spigot-1.20.1" = _qIVPyj5f;
        "spigot-1.20.2" = _qIVPyj5f;
        "spigot-1.20.3" = _qIVPyj5f;
        "spigot-1.20.4" = _qIVPyj5f;
        "spigot-1.20.5" = _qIVPyj5f;
        "spigot-1.20.6" = _qIVPyj5f;
        "spigot-1.21" = _qIVPyj5f;
        "spigot-1.21.1" = _qIVPyj5f;
        "spigot-1.21.2" = _qIVPyj5f;
        "spigot-1.21.3" = _qIVPyj5f;
        "spigot-1.21.4" = _qIVPyj5f;
        "spigot-1.21.5" = _qIVPyj5f;
        "spigot-1.21.6" = _qIVPyj5f;
        "spigot-1.21.7" = _qIVPyj5f;
        "spigot-1.21.8" = _qIVPyj5f;
        "spigot-1.21.9" = _qIVPyj5f;
        "spigot-1.21.10" = _qIVPyj5f;
        "spigot-1.21.11" = _qIVPyj5f;
        "spigot-26.1" = _qIVPyj5f;
        "spigot-26.2" = _qIVPyj5f;
        ...
        "pkg-3.26.8.9" = _kKDosytE;
        "pkg-3.26.8.10" = _BeAxwadg;
        "pkg-3.26.8.30" = _61X0ltnu;
        "pkg-3.26.9.1" = _JyX28Dc2;
        "pkg-3.26.9.6" = _IQsnr2cV;
        "pkg-3.26.9.9" = _LNBD5R97;
        "pkg-3.26.9.13" = _VKeLFCWp;
        "pkg-3.26.9.14" = _qIVPyj5f;
        "default" = _qIVPyj5f;
    });
