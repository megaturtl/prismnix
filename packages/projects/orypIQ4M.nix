...
let
    versions = (let
        ...
        _zTWriU64 = {
            "id" = "zTWriU64";
            "file" = "SimpleRepair-Sponge-1.2.0.jar";
            "hash" = "sha512-+i3UbkMbFNhpiTPAFJ8obBzCGLt0kZZZKmm/tUIqSgiHDrRfgck++lEBf16UXXjYSGTTEW+4mJqNK46UEmVIpA==";
        };
        _7ncGRrGy = {
            "id" = "7ncGRrGy";
            "file" = "SimpleRepair-Paper-1.2.0.jar";
            "hash" = "sha512-hYcKcBHEtS+4VCFYzcd1I/b25uqVT5bETcMjPEBEKTRkjhZycucoKsRAFOIBvAQ7B0KaRVv+JqsnhuDXmALv4g==";
        };
        _zNHZajb4 = {
            "id" = "zNHZajb4";
            "file" = "SimpleRepair-Fabric-1.2.0.jar";
            "hash" = "sha512-o05q5lyK99Q52iqL9dlBep587ophbG0pwOlas6sLKzFQqn8FrRBDf3xCJqNIAcYSfKCmqy6snT2oW7p9Y4nlbg==";
        };
    in {
        "QrhEG04c" = _QrhEG04c;
        "NvvGauoF" = _NvvGauoF;
        ...
        "7ncGRrGy" = _7ncGRrGy;
        "zNHZajb4" = _zNHZajb4;
        "sponge-1.19" = _zTWriU64;
        "sponge-1.19.1" = _zTWriU64;
        "sponge-1.19.2" = _zTWriU64;
        "sponge-1.19.3" = _zTWriU64;
        "sponge-1.19.4" = _zTWriU64;
        "sponge-1.20" = _zTWriU64;
        "sponge-1.20.1" = _zTWriU64;
        "sponge-1.20.2" = _zTWriU64;
        "sponge-1.20.3" = _zTWriU64;
        "sponge-1.20.4" = _zTWriU64;
        "sponge-1.20.5" = _zTWriU64;
        "sponge-1.20.6" = _zTWriU64;
        "sponge-1.21" = _zTWriU64;
        "sponge-1.21.1" = _zTWriU64;
        "sponge-1.21.2" = _zTWriU64;
        "sponge-1.21.3" = _zTWriU64;
        "sponge-1.21.4" = _zTWriU64;
        "sponge-1.21.5" = _zTWriU64;
        "sponge-1.21.6" = _zTWriU64;
        "sponge-1.21.7" = _zTWriU64;
        "sponge-1.21.8" = _zTWriU64;
        "sponge-1.21.9" = _zTWriU64;
        "sponge-1.21.10" = _zTWriU64;
        "sponge-1.16.5" = _zTWriU64;
        "sponge-1.17" = _zTWriU64;
        "sponge-1.17.1" = _zTWriU64;
        "sponge-1.18" = _zTWriU64;
        "sponge-1.18.1" = _zTWriU64;
        "sponge-1.18.2" = _zTWriU64;
        "sponge-1.21.11" = _zTWriU64;
        "sponge-26.1" = _zTWriU64;
        "sponge-26.1.1" = _zTWriU64;
        "sponge-26.1.2" = _zTWriU64;
        "sponge-26.2" = _zTWriU64;
        ...
        "folia-26.1.1" = _SkQQFISe;
        "folia-26.1.2" = _SkQQFISe;
        "folia-26.2" = _SkQQFISe;
        ...
        "paper-26.1" = _7ncGRrGy;
        "paper-26.1.1" = _7ncGRrGy;
        "paper-26.1.2" = _7ncGRrGy;
        "paper-26.2" = _7ncGRrGy;
        ...
        "purpur-26.1.1" = _SkQQFISe;
        "purpur-26.1.2" = _SkQQFISe;
        "purpur-26.2" = _SkQQFISe;
        ...
        "fabric-26.1" = _zNHZajb4;
        "fabric-26.1.1" = _zNHZajb4;
        "fabric-26.1.2" = _zNHZajb4;
        "fabric-26.2" = _zNHZajb4;
        ...
        "quilt-26.1" = _zNHZajb4;
        "quilt-26.1.1" = _zNHZajb4;
        "quilt-26.1.2" = _zNHZajb4;
        "quilt-26.2" = _zNHZajb4;
        "pkg-1.0.0" = _JnGgP5nT;
        "pkg-1.0.1" = _knbB7ZAZ;
        "pkg-1.1.0" = _Q3DgcPcz;
        "pkg-1.1.1" = _zpbiTgQT;
