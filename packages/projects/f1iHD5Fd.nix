...
let
    ...
    in {
        ...
        "datapack-1.21.5" = _xbgEdSEe;
        "datapack-1.21.6" = _xbgEdSEe;
        "datapack-1.21.7" = _xbgEdSEe;
        "datapack-1.21" = _bV17Pbsc;
        "datapack-1.21.1" = _bV17Pbsc;
        "datapack-1.21.8" = _xbgEdSEe;
        "datapack-25w31a" = _OfoIyrOb;
        "datapack-25w32a" = _OfoIyrOb;
        "datapack-1.21.9" = _xbgEdSEe;
        "datapack-1.21.10" = _xbgEdSEe;
        ...
        "datapack-26.1" = _xbgEdSEe;
        "datapack-26.1.1" = _xbgEdSEe;
        "datapack-26.1.2" = _xbgEdSEe;
        "datapack-26.2" = _xbgEdSEe;
        "fabric-1.21.4" = _XcYUPJX0;
        "fabric-1.21.5" = _7gHGC6iB;
        "fabric-1.21.6" = _7gHGC6iB;
        "fabric-1.21.7" = _7gHGC6iB;
        "fabric-1.21" = _p4IPim8h;
        "fabric-1.21.1" = _nGmdlYPr;
        "fabric-25w31a" = _fTVHRUjH;
        "fabric-1.21.8" = _7gHGC6iB;
        "fabric-25w32a" = _fTVHRUjH;
        "fabric-1.21.9" = _7gHGC6iB;
        "fabric-1.21.10" = _7gHGC6iB;
        ...
        "fabric-26.1" = _7gHGC6iB;
        "fabric-26.1.1" = _7gHGC6iB;
        "fabric-26.1.2" = _7gHGC6iB;
        "fabric-26.2" = _7gHGC6iB;
        "forge-1.21.4" = _XcYUPJX0;
        "forge-1.21.5" = _7gHGC6iB;
        "forge-1.21.6" = _7gHGC6iB;
        "forge-1.21.7" = _7gHGC6iB;
        "forge-1.21" = _p4IPim8h;
        "forge-1.21.1" = _nGmdlYPr;
        "forge-25w31a" = _fTVHRUjH;
        "forge-1.21.8" = _7gHGC6iB;
        "forge-25w32a" = _fTVHRUjH;
        "forge-1.21.9" = _7gHGC6iB;
        "forge-1.21.10" = _7gHGC6iB;
        ...
        "forge-26.1" = _7gHGC6iB;
        "forge-26.1.1" = _7gHGC6iB;
        "forge-26.1.2" = _7gHGC6iB;
        "forge-26.2" = _7gHGC6iB;
        "neoforge-1.21.4" = _XcYUPJX0;
        "neoforge-1.21.5" = _7gHGC6iB;
        "neoforge-1.21.6" = _7gHGC6iB;
        "neoforge-1.21.7" = _7gHGC6iB;
        "neoforge-1.21" = _p4IPim8h;
        "neoforge-1.21.1" = _nGmdlYPr;
        "neoforge-25w31a" = _fTVHRUjH;
        "neoforge-1.21.8" = _7gHGC6iB;
        "neoforge-25w32a" = _fTVHRUjH;
        "neoforge-1.21.9" = _7gHGC6iB;
        "neoforge-1.21.10" = _7gHGC6iB;
        ...
        "neoforge-26.1" = _7gHGC6iB;
        "neoforge-26.1.1" = _7gHGC6iB;
        "neoforge-26.1.2" = _7gHGC6iB;
        "neoforge-26.2" = _7gHGC6iB;
        "quilt-1.21.4" = _XcYUPJX0;
        "quilt-1.21.5" = _7gHGC6iB;
        "quilt-1.21.6" = _7gHGC6iB;
        "quilt-1.21.7" = _7gHGC6iB;
        "quilt-1.21" = _p4IPim8h;
        "quilt-1.21.1" = _nGmdlYPr;
        "quilt-25w31a" = _fTVHRUjH;
        "quilt-1.21.8" = _7gHGC6iB;
        "quilt-25w32a" = _fTVHRUjH;
        "quilt-1.21.9" = _7gHGC6iB;
        "quilt-1.21.10" = _7gHGC6iB;
        ...
        "quilt-26.1" = _7gHGC6iB;
        "quilt-26.1.1" = _7gHGC6iB;
        "quilt-26.1.2" = _7gHGC6iB;
        "quilt-26.2" = _7gHGC6iB;
        "pkg-1.31" = _mu7SfL9X;
        "pkg-V1.33" = _m1AKxTyG;
        "pkg-V1.35" = _zEZ1Bsg4;
        "pkg-V1.36" = _wdXmQQNS;
