...
let
    versions = (let
        ...
        _mbqxFUu4 = {
            "id" = "mbqxFUu4";
            "file" = "ForgeCraft V1.8.0.zip";
            "hash" = "sha512-p7PUyFwowZuILU9gn2KiZV0on8LpxcCzyYdA/IlVWhmqhLY2gI2aCAWwc4kdeyG7Ui5TR+WroFXAD+CeWn5b0w==";
        };
        _MugXt6MK = {
            "id" = "MugXt6MK";
            "file" = "forgecraft-V1.8.0.jar";
            "hash" = "sha512-1AvyJRVeLIvMcNjiV/8RaEYGigS19gCGnQKkd2FjctMUMiVGCemdJz9P8wLrk+pj6oyERXPG84UqVXhjcAVokA==";
        };
        _xbgEdSEe = {
            "id" = "xbgEdSEe";
            "file" = "ForgeCraft V1.8.1.zip";
            "hash" = "sha512-ixVVmjSR//RD+mMB6sbFmYzsMEhpgB9F0QkW8HKkPqmw/IioNTf7jvJLihMngZFINmsf+pcnAmXtfw36Z/5wwQ==";
        };
        _7gHGC6iB = {
            "id" = "7gHGC6iB";
            "file" = "forgecraft-V1.8.1.jar";
            "hash" = "sha512-Q7I1nBuMiv7HxnfALZ701WrKezpfVkf4fBOkgKmmW4y/j2x7eNxpti5Vn80FB4Gl3nB3ESl2pzVfFnYZ/9P9jw==";
        };
        _6ccHpGyf = {
            "id" = "6ccHpGyf";
            "file" = "ForgeCraft V1.8.2.zip";
            "hash" = "sha512-e/1ORBgWE4Sq1zQJgHn4reqhXafkyg8VLtQhaxo3nFpfiGcxGxOMReRy1joTTCOZopjI+xVux3RfDZBOlLZy2g==";
        };
        _V6Jhxka7 = {
            "id" = "V6Jhxka7";
            "file" = "ForgeCraft V1.8.2 - 26.3.zip";
            "hash" = "sha512-IeVD7rSaWUGsjwk/cMGknV+aucqz/KsptGiBauANU6t7zyY7EWGVnqt14BE0k3j5+1E8bBiI342kxAxhX0nZTg==";
        };
        _ve0cCG7r = {
            "id" = "ve0cCG7r";
            "file" = "forgecraft-V1.8.2.jar";
            "hash" = "sha512-KNyW1SzDH6gGU0Zo0bgs5vUSeeagYLHkRDdP5a+ZoxLVTQdnT5ZWOP2gDcVDRPbg5WhDC3eAIjA09KhiuKN7Tg==";
        };
        _wm8Aca4l = {
            "id" = "wm8Aca4l";
            "file" = "forgecraft-V1.8.2.jar";
            "hash" = "sha512-GMtsCcPFsQEjiHUtsKljZ3GkbrkSceGdNwUQpe2edfBlPNY114mDQuI1i8UO5JOD4OjKKIT3BK3dNuEhULJAWA==";
        };
        _qiaaosCP = {
            "id" = "qiaaosCP";
            "file" = "ForgeCraft V1.8.3 - 26.3.zip";
            "hash" = "sha512-EoMxExemapmx0VGb2FJyvEi31AnKkrcAu0xsGlMPIcmNxa53fP+IlTiuA9Yhvw9ZEZ4qztp3zTI5HkaVqFPS6g==";
        };
        _B8O1n2C9 = {
            "id" = "B8O1n2C9";
            "file" = "forgecraft-B1.8.3.jar";
            "hash" = "sha512-IIDSLoLZRO6p7CmcyJUx1InQ7KvrDZSpNOZJfhhnaztNUNw5g8UNy+UlWcTaHXIYa7gQ0fMavTwZwEV/dBQ3pA==";
        };
        _Z3Lq2zI0 = {
            "id" = "Z3Lq2zI0";
            "file" = "ForgeCraft V1.8.3.zip";
            "hash" = "sha512-tWdzuQm8yx4SXd1tlhOkMkQfmekojyKzMpxOSATxizqKJNRXpD/bX6Tzrg+9r7GxSCWBcipzUo76N1X4Wuscmw==";
        };
        _qbx9QJP3 = {
            "id" = "qbx9QJP3";
            "file" = "forgecraft-B1.8.3.jar";
            "hash" = "sha512-6b1HTVJD+XxNjgMaly6JwWxMygmGcYuWy08bZ6GmooPua0m9Uj6q1j855kb1BTxK7gx5xYfqQXOpWL/eXphnjA==";
        };
    in {
        "mu7SfL9X" = _mu7SfL9X;
        "m1AKxTyG" = _m1AKxTyG;
        ...
        "datapack-1.21.5" = _Z3Lq2zI0;
        "datapack-1.21.6" = _Z3Lq2zI0;
        "datapack-1.21.7" = _Z3Lq2zI0;
        "datapack-1.21" = _bV17Pbsc;
        "datapack-1.21.1" = _bV17Pbsc;
        "datapack-1.21.8" = _Z3Lq2zI0;
        "datapack-25w31a" = _OfoIyrOb;
        "datapack-25w32a" = _OfoIyrOb;
        "datapack-1.21.9" = _Z3Lq2zI0;
        "datapack-1.21.10" = _Z3Lq2zI0;
        ...
        "datapack-26.1" = _Z3Lq2zI0;
        "datapack-26.1.1" = _Z3Lq2zI0;
        "datapack-26.1.2" = _Z3Lq2zI0;
        "datapack-26.2" = _Z3Lq2zI0;
        "datapack-26.3" = _qiaaosCP;
        "fabric-1.21.4" = _XcYUPJX0;
        "fabric-1.21.5" = _qbx9QJP3;
        "fabric-1.21.6" = _qbx9QJP3;
        "fabric-1.21.7" = _qbx9QJP3;
        "fabric-1.21" = _p4IPim8h;
        "fabric-1.21.1" = _nGmdlYPr;
        "fabric-25w31a" = _fTVHRUjH;
        "fabric-1.21.8" = _qbx9QJP3;
        "fabric-25w32a" = _fTVHRUjH;
        "fabric-1.21.9" = _qbx9QJP3;
        "fabric-1.21.10" = _qbx9QJP3;
        ...
        "fabric-26.1" = _qbx9QJP3;
        "fabric-26.1.1" = _qbx9QJP3;
        "fabric-26.1.2" = _qbx9QJP3;
        "fabric-26.2" = _qbx9QJP3;
        "fabric-26.3" = _B8O1n2C9;
        "forge-1.21.4" = _XcYUPJX0;
        "forge-1.21.5" = _qbx9QJP3;
        "forge-1.21.6" = _qbx9QJP3;
        "forge-1.21.7" = _qbx9QJP3;
        "forge-1.21" = _p4IPim8h;
        "forge-1.21.1" = _nGmdlYPr;
        "forge-25w31a" = _fTVHRUjH;
        "forge-1.21.8" = _qbx9QJP3;
        "forge-25w32a" = _fTVHRUjH;
        "forge-1.21.9" = _qbx9QJP3;
        "forge-1.21.10" = _qbx9QJP3;
        ...
        "forge-26.1" = _qbx9QJP3;
        "forge-26.1.1" = _qbx9QJP3;
        "forge-26.1.2" = _qbx9QJP3;
        "forge-26.2" = _qbx9QJP3;
        "forge-26.3" = _B8O1n2C9;
        "neoforge-1.21.4" = _XcYUPJX0;
        "neoforge-1.21.5" = _qbx9QJP3;
        "neoforge-1.21.6" = _qbx9QJP3;
        "neoforge-1.21.7" = _qbx9QJP3;
        "neoforge-1.21" = _p4IPim8h;
        "neoforge-1.21.1" = _nGmdlYPr;
        "neoforge-25w31a" = _fTVHRUjH;
        "neoforge-1.21.8" = _qbx9QJP3;
        "neoforge-25w32a" = _fTVHRUjH;
        "neoforge-1.21.9" = _qbx9QJP3;
        "neoforge-1.21.10" = _qbx9QJP3;
        ...
        "neoforge-26.1" = _qbx9QJP3;
        "neoforge-26.1.1" = _qbx9QJP3;
        "neoforge-26.1.2" = _qbx9QJP3;
        "neoforge-26.2" = _qbx9QJP3;
        "neoforge-26.3" = _B8O1n2C9;
        "quilt-1.21.4" = _XcYUPJX0;
        "quilt-1.21.5" = _qbx9QJP3;
        "quilt-1.21.6" = _qbx9QJP3;
        "quilt-1.21.7" = _qbx9QJP3;
        "quilt-1.21" = _p4IPim8h;
        "quilt-1.21.1" = _nGmdlYPr;
        "quilt-25w31a" = _fTVHRUjH;
        "quilt-1.21.8" = _qbx9QJP3;
        "quilt-25w32a" = _fTVHRUjH;
        "quilt-1.21.9" = _qbx9QJP3;
        "quilt-1.21.10" = _qbx9QJP3;
        ...
        "quilt-26.1" = _qbx9QJP3;
        "quilt-26.1.1" = _qbx9QJP3;
        "quilt-26.1.2" = _qbx9QJP3;
        "quilt-26.2" = _qbx9QJP3;
        "quilt-26.3" = _B8O1n2C9;
        "pkg-1.31" = _mu7SfL9X;
        "pkg-V1.33" = _m1AKxTyG;
        "pkg-V1.35" = _zEZ1Bsg4;
        "pkg-V1.36" = _wdXmQQNS;
        "pkg-V1.36+mod" = _PtrEpGlc;
        "pkg-V1.37" = _gRnzLrqf;
        "pkg-V1.37+mod" = _mOLqhJMg;
        "pkg-V1.38" = _SzxDBdKV;
        "pkg-V1.38+mod" = _uSLDRFLI;
        "pkg-V1.4" = _jRD6AbTZ;
        "pkg-V1.4+mod" = _XcYUPJX0;
        "pkg-1.5" = _IxIOj6jT;
        "pkg-1.5+mod" = _BpA9nw8l;
        "pkg-1.51" = _v6x3GAXl;
        "pkg-1.51+mod" = _9RTbVl39;
        "pkg-1.52" = _TcyFBVJR;
        "pkg-1.52+mod" = _d8kwnsER;
        "pkg-V1.53" = _v0aqAjvH;
        "pkg-V1.53+mod" = _EWQpDS9X;
        "pkg-V1.54" = _trPNTjkV;
        "pkg-V1.54+mod" = _RKJ3sHxV;
        "pkg-V1.56" = _MUbwco4X;
        "pkg-V1.56+mod" = _rbcJhAUP;
        "pkg-V1.56.1" = _zM3LuSKW;
        "pkg-V1.56.1+mod" = _HymptKFs;
        "pkg-V1.56.2" = _SuWmkm5s;
        "pkg-V1.56.2+mod" = _GwgIWlIJ;
        "pkg-V1.57" = _ddp7LzqO;
        "pkg-V1.57+mod" = _vy3g5y2V;
        "pkg-V1.57.1" = _81kHRBEJ;
        "pkg-V1.57.1+mod" = _3DxBXYSh;
        "pkg-V1.57.2" = _TpHRq1h8;
        "pkg-V1.57.2+mod" = _2jipZL7k;
        "pkg-V1.58" = _17GKLRdq;
        "pkg-V1.58+mod" = _bXMFNbGh;
        "pkg-V1.58+Resource" = _XwsfeXLN;
        "pkg-V1.58+Resources" = _utg0Aftl;
        "pkg-V1.59" = _bV17Pbsc;
        "pkg-V1.59+mod" = _nGmdlYPr;
        "pkg-V1.59.1" = _5TJwuPiR;
        "pkg-V1.59.1+mod" = _ZtjzxF92;
        "pkg-V1.6" = _hb9Hey1p;
        "pkg-V1.6+mod" = _cFlwxPrt;
        "pkg-V1.6.1" = _fR6Xkjsi;
        "pkg-V1.6.1+mod" = _sEsbnZog;
        "pkg-V1.6.2" = _KdSiwty9;
        "pkg-V1.6.2+mod" = _pMBDi70Q;
        "pkg-V1.6.3" = _D6j0NVG5;
        "pkg-V1.6.3+mod" = _8f7ynoOg;
        "pkg-V1.6.0" = _OfoIyrOb;
        "pkg-V1.6.0+mod" = _fTVHRUjH;
        "pkg-V1.61" = _PxxFArNN;
        "pkg-V1.61+mod" = _nWMqVw4Y;
        "pkg-V1.61.1" = _bCnSV5hc;
        "pkg-V1.61.1+mod" = _51O8j9vS;
        "pkg-V1.61.2" = _8hTbyoGA;
        "pkg-V1.61.2+mod" = _eElummNx;
        "pkg-V1.61.3" = _DJGKIEZi;
        "pkg-V1.61.3+mod" = _i5y8hadK;
        "pkg-V1.62.0" = _28NKiJdx;
        "pkg-V1.62.0+mod" = _D1Z54onJ;
        "pkg-V1.62.1" = _PHOWfXAe;
        "pkg-V1.62.1+mod" = _3X0j0Zmz;
        "pkg-V1.62.2" = _kXo4OiJW;
        "pkg-V1.62.2+mod" = _YfB9HFYL;
        "pkg-V1.63.0" = _1nuHSSBq;
        "pkg-V1.63.0+mod" = _n8Lh9IK1;
        "pkg-V1.64.0" = _AuRobmY7;
        "pkg-V1.64.0+mod" = _mQTgYs68;
        "pkg-V1.64.1" = _Lg1NBwTm;
        "pkg-V1.64.1+mod" = _hcUdiqxI;
        "pkg-V1.65.0" = _TbLJGC91;
        "pkg-V1.65.0+mod" = _oEbpbGB2;
        "pkg-V1.7.0" = _ZH8GX0Wm;
        "pkg-V1.7.0+mod" = _Q8RrFxtO;
        "pkg-V1.7.1" = _2XVP64ZV;
        "pkg-V1.7.1+mod" = _IU7LNq7R;
        "pkg-V1.7.2" = _XAHae9R0;
        "pkg-V1.7.2+mod" = _JwPJNfLa;
        "pkg-V1.7.3" = _5YWStEcL;
        "pkg-V1.7.3+mod" = _witxtKJf;
        "pkg-V1.7.4" = _tib7x4ka;
        "pkg-V1.7.4+mod" = _RRGulnMg;
        "pkg-V1.7.4.1+mod" = _x8hPbR87;
        "pkg-V1.7.4.2" = _igg20YYE;
        "pkg-V1.7.4.2+mod" = _ItkI0oia;
        "pkg-V1.7.4.21" = _dGx5tW8m;
        "pkg-V1.7.4.21+mod" = _IfFXI1UV;
        "pkg-V1.7.5" = _kySQUbb7;
        "pkg-V1.7.5+mod" = _wMbZ0T1W;
        "pkg-V1.7.5.1" = _XA4pmJQL;
        "pkg-V1.7.5.1+mod" = _ufGAN0Nf;
        "pkg-V1.7.6" = _FT7RG94R;
        "pkg-V1.7.6+mod" = _nlOIYPaa;
        "pkg-V1.7.7" = _lrVptrwe;
        "pkg-V1.7.7+mod" = _ssfDl9KO;
        "pkg-V1.7.8" = _G8wTsJZu;
        "pkg-V1.7.8+mod" = _emixOG4W;
        "pkg-V1.7.9" = _bXMxx3pm;
        "pkg-V1.7.9+mod" = _FFUXKLQP;
        "pkg-V1.7.9.1" = _bZsCZMau;
        "pkg-V1.7.9.1+mod" = _6LLQQTdT;
        "pkg-V1.7.9.2" = _2PJBMSGM;
        "pkg-V1.7.9.2+mod" = _cK44MUaZ;
        "pkg-1.8.0" = _sovUBVCt;
        "pkg-1.8.0+mod" = _4BouIdDW;
        "pkg-1.8.1" = _imknmnMw;
        "pkg-1.8.2" = _x4e1RPGO;
        "pkg-1.8.2+mod" = _tTQIXz1w;
        "pkg-1.8.3" = _N8KNy8mh;
        "pkg-1.8.4" = _g1Hjenck;
        "pkg-1.8.4.1" = _RZNsVUAz;
        "pkg-1.8.4.1+mod" = _Hc3jGXms;
        "pkg-V1.8.0" = _mbqxFUu4;
        "pkg-V1.8.0+mod" = _MugXt6MK;
        "pkg-V1.8.1" = _xbgEdSEe;
        "pkg-V1.8.1+mod" = _7gHGC6iB;
        "pkg-V1.8.2" = _V6Jhxka7;
        "pkg-V1.8.2+mod" = _wm8Aca4l;
        "pkg-B1.8.3" = _Z3Lq2zI0;
        "pkg-B1.8.3+mod" = _qbx9QJP3;
        "default" = _qbx9QJP3;
    });
