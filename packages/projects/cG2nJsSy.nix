...
let
    versions = (let
        ...
        _BHNvlapO = {
            "id" = "BHNvlapO";
            "file" = "VillagerInfo-4.3.2.jar";
            "hash" = "sha512-aPUBupdUXzF88PxZRGTjSguBe+OULVRdwJmQNOksJ/UerRfMu1yCNdw1S07ATA84+Dv7dXCaRQcPlbDDtBnI8w==";
        };
    in {
        "iCN9o0w9" = _iCN9o0w9;
        "xHBQaqr4" = _xHBQaqr4;
        ...
        "paper-1.20.5" = _BHNvlapO;
        "paper-1.20.6" = _BHNvlapO;
        "paper-1.21" = _BHNvlapO;
        "paper-1.21.1" = _BHNvlapO;
        "paper-1.21.2" = _BHNvlapO;
        "paper-1.21.3" = _BHNvlapO;
        "paper-1.21.4" = _BHNvlapO;
        "paper-1.21.5" = _BHNvlapO;
        "paper-1.21.6" = _BHNvlapO;
        "paper-1.21.7" = _BHNvlapO;
        "paper-1.21.8" = _BHNvlapO;
        "paper-1.21.9" = _BHNvlapO;
        "paper-1.21.10" = _BHNvlapO;
        "paper-1.21.11" = _BHNvlapO;
        "paper-26.1" = _BHNvlapO;
        "paper-26.1.1" = _BHNvlapO;
        "paper-26.1.2" = _BHNvlapO;
        "paper-26.2" = _BHNvlapO;
        ...
        "purpur-1.20.5" = _BHNvlapO;
        "purpur-1.20.6" = _BHNvlapO;
        "purpur-1.21" = _BHNvlapO;
        "purpur-1.21.1" = _BHNvlapO;
        "purpur-1.21.2" = _BHNvlapO;
        "purpur-1.21.3" = _BHNvlapO;
        "purpur-1.21.4" = _BHNvlapO;
        "purpur-1.21.5" = _BHNvlapO;
        "purpur-1.21.6" = _BHNvlapO;
        "purpur-1.21.7" = _BHNvlapO;
        "purpur-1.21.8" = _BHNvlapO;
        "purpur-1.21.9" = _BHNvlapO;
        "purpur-1.21.10" = _BHNvlapO;
        "purpur-1.21.11" = _BHNvlapO;
        "purpur-26.1" = _BHNvlapO;
        "purpur-26.1.1" = _BHNvlapO;
        "purpur-26.1.2" = _BHNvlapO;
        "purpur-26.2" = _BHNvlapO;
        "pkg-2.0" = _iCN9o0w9;
        "pkg-2.1" = _xHBQaqr4;
        "pkg-2.2" = _U65qCNCh;
        "pkg-2.3" = _P7PVhbXr;
        ...
        "pkg-2.6" = _IlYXqNzm;
        "pkg-2.7" = _uVxboRh3;
        "pkg-3.0.0-beta-1" = _m1R8kBR5;
        "pkg-3.0.0-beta-2" = _Rbwr8rjk;
        "pkg-3.0.0-beta-3" = _X0vYX1Kc;
        "pkg-3.0.0-beta-4" = _loSDl9pO;
        "pkg-3.0.0-beta-5" = _FWPb7T7V;
        "pkg-3.0.0" = _Z8SgiRnL;
        "pkg-3.0.1" = _KyPWNaQp;
        "pkg-3.0.2" = _EpzYrCwz;
        "pkg-3.0.3" = _9rOT8mW4;
