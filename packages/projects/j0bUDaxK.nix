...
let
    versions = (let
        ...
        _kjbu6ENq = {
            "id" = "kjbu6ENq";
            "file" = "Mobs Equipment v2.0.4 [1.21.11-26.2].zip";
            "hash" = "sha512-7FNd9E/DdaThAktESUSVWvuNnPpFNXnVVPFXM+w7LTsDNeHXb7iZXt5G1/zL5p3T2h5sWy0JS66jKgMLy8P0hQ==";
        };
        _xfudQ6Yr = {
            "id" = "xfudQ6Yr";
