...
let
    ...
    in {
        ...
        "pkg-1.3-fabric-1.0.3" = _uOH9Py8u;
        "pkg-1.4-fabric-1.0.1" = _B6UNAmVE;
        "pkg-1.4-forge-1.0.1" = _weAQadlV;
        "pkg-1.3-fabric-1.0.4" = _P6707NnC;
        "pkg-1.4-fabric-1.0.2" = _EHJteu1u;
        "pkg-1.4-forge-1.0.2" = _Zp5rj8S7;
        "pkg-1.3-fabric-1.1.0" = _ZV5CO4zs;
        "pkg-1.5-fabric-1.0.0" = _2lWpTYRq;
        "pkg-1.5-forge-1.0.0" = _4JEB2vKc;
        "pkg-1.5-fabric-1.0.1" = _9nPOeA1v;
        "pkg-1.5-forge-1.0.1" = _gKDB84ol;
        "pkg-1.6-fabric-1.0.0" = _XJKujgmB;
        "pkg-1.6-neoforge-1.0.0" = _kKP3GWa3;
        "pkg-1.6-neoforge-1.0.1" = _vYUq8ykQ;
        "pkg-1.6-fabric-1.1.0" = _gSyyapnZ;
        "pkg-1.6-neoforge-1.1.0" = _aiCL1nwq;
        "pkg-1.6-neoforge-1.1.1" = _Pex4Jw8r;
        "pkg-1.6.1-neoforge-1.2.0" = _mTKnqx0B;
        "pkg-1.6.1-fabric-1.2.0" = _mIDy2E9x;
        "pkg-1.6.1-neoforge-1.2.1" = _Lh0clnjO;
        "pkg-1.7.0-fabric-1.3.0" = _HqC8AcX1;
        "pkg-1.7.0-neoforge-1.3.0" = _4vjj1bz1;
        "pkg-1.7.1-fabric-1.3.0" = _kKYjAPDP;
        "pkg-1.7.1-neoforge-1.3.0" = _MoNv5bhj;
        "pkg-1.7.2-fabric-1.3.0" = _6kqNNkZe;
