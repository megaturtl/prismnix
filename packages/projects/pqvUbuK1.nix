...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _e6y95wGC;
        "pkg-1.0.0+1.20.1-fabric" = _hKYGUp7M;
        "pkg-1.0.0+1.21.1-neoforge" = _gJPkql2x;
        "pkg-1.0.0+1.21.6-fabric" = _pGcNOga0;
        "pkg-1.0.0+1.21.11-fabric" = _guG3b1ff;
        "pkg-1.0.0+1.21.10-fabric" = _gOKgoVKB;
        "pkg-1.0.0+1.21.2-fabric" = _5BPQgVj1;
        "pkg-1.0.0+1.21.1-fabric" = _6tFaZDCi;
        "pkg-1.0.0+1.21.5-fabric" = _SiMXqOG6;
        "pkg-1.0.0+1.21.4-fabric" = _yktUWDmu;
        "pkg-1.0.0+1.21.9-fabric" = _vEFtZF4r;
        "pkg-1.0.0+26.1-fabric" = _eylCFipa;
        "pkg-1.0.0+26.1-neoforge" = _WbolVIhq;
        "pkg-1.0.1+26.1-neoforge" = _kKNk1N0v;
        "pkg-1.0.1+1.21.11-fabric" = _dOTv7jh8;
        "pkg-1.0.1+1.21.11-neoforge" = _tyUlP1Px;
        "pkg-1.0.1+1.20.1-fabric" = _E6oFcpNc;
        "pkg-1.0.1+1.20.1-forge" = _wVHgJWoo;
        "pkg-1.0.2+1.20.1-forge" = _M6ATEtbJ;
        "pkg-1.0.3+1.20.1-forge" = _ae6zJDDi;
        "pkg-1.0.4+1.20.1-fabric" = _1KyvqLWl;
        "pkg-1.0.4+1.20.1-forge" = _tDwLY7Sp;
        "pkg-1.0.5+1.20.1-forge" = _pjaezq63;
        "pkg-1.0.5+1.21.11-neoforge" = _Ai4gaAfg;
        "pkg-1.0.5+1.21.1-neoforge" = _pkCaibxO;
        "pkg-1.0.5+1.21.4-fabric" = _6t8waWw1;
        "pkg-1.0.5+1.20.1-fabric" = _9Jf3nnUj;
        "pkg-1.0.5+1.21.11-fabric" = _J75gbJqM;
        "pkg-1.0.5+1.21.10-fabric" = _vaBvr49m;
        "pkg-1.0.5+1.21.1-fabric" = _C5ev17sU;
        "pkg-1.0.5+1.21.2-fabric" = _mSh3rwUf;
        "pkg-1.0.5+1.21.6-fabric" = _3HcpSJHM;
        "pkg-1.0.5+1.21.5-fabric" = _sVJxfClD;
        "pkg-1.0.5+1.21.9-fabric" = _kCw4572T;
        "pkg-1.0.5+26.1-neoforge" = _ZlpMGaH3;
        "pkg-1.0.5+26.1-fabric" = _aDCRexgK;
        "pkg-1.0.6+1.21.11-fabric" = _R34YKoQM;
        "pkg-1.1.0+1.21.1-neoforge" = _unDOaKsq;
        "pkg-1.1.0+1.20.1-forge" = _7n3Vlk2V;
        "pkg-1.1.0+1.21.11-neoforge" = _i4sP2thc;
        "pkg-1.1.0+1.21.10-fabric" = _oACqI1zE;
        "pkg-1.1.0+1.21.1-fabric" = _34gt0SFh;
        "pkg-1.1.0+1.20.1-fabric" = _vYiCd9tp;
        "pkg-1.1.0+1.21.11-fabric" = _qgyUHV2u;
        "pkg-1.1.0+1.21.2-fabric" = _1GQ3sDhl;
        "pkg-1.1.0+1.21.4-fabric" = _r2CGDtd9;
        "pkg-1.1.0+1.21.5-fabric" = _ZchIxvVC;
        "pkg-1.1.0+1.21.6-fabric" = _GTE18bei;
        "pkg-1.1.0+1.21.9-fabric" = _hDu9z01e;
        "pkg-1.1.0+26.1-fabric" = _bshfMAUJ;
        "pkg-1.1.0+26.1-neoforge" = _YT4tLsSy;
        "pkg-1.1.1+1.21.11-fabric" = _vMn4mBug;
        "pkg-1.1.2+1.20.1-forge" = _MBXtRgOr;
        "pkg-1.1.2+1.21.1-neoforge" = _6zGvp8SV;
        "pkg-1.1.2+1.21.11-neoforge" = _JQOizneU;
        "pkg-1.1.2+1.21.5-fabric" = _x0ZERzny;
        "pkg-1.1.2+1.21.1-fabric" = _MyxibPAh;
        "pkg-1.1.2+1.20.1-fabric" = _KTFft0E3;
        "pkg-1.1.2+1.21.10-fabric" = _65sqMpyP;
        "pkg-1.1.2+1.21.11-fabric" = _9NWr0ZYs;
        "pkg-1.1.2+1.21.2-fabric" = _gFdspHmc;
        "pkg-1.1.2+1.21.4-fabric" = _inP4f9zk;
        "pkg-1.1.2+1.21.6-fabric" = _ZwZEdf3j;
        "pkg-1.1.2+1.21.9-fabric" = _vvrEvSeu;
        "pkg-1.1.2+26.1-neoforge" = _N43kWWdL;
        "pkg-1.1.2+26.1-fabric" = _Aju0M1v6;
        "pkg-1.1.3+1.21.11-neoforge" = _w9IsBHJQ;
        "pkg-1.1.3+1.20.1-forge" = _B4pzeN5q;
        "pkg-1.1.3+1.21.1-neoforge" = _oMwQAfMo;
        "pkg-1.1.3+1.21.10-fabric" = _qb53FewO;
        "pkg-1.1.3+1.21.1-fabric" = _ZkpdYVkS;
        "pkg-1.1.3+1.20.1-fabric" = _oUq527Yh;
        "pkg-1.1.3+1.21.11-fabric" = _2gko2mXP;
        "pkg-1.1.3+1.21.2-fabric" = _Xz1FosXY;
        "pkg-1.1.3+1.21.4-fabric" = _cOdb7Aup;
        "pkg-1.1.3+1.21.5-fabric" = _lcIBQhI7;
        "pkg-1.1.3+1.21.6-fabric" = _ytahX26J;
        "pkg-1.1.3+26.1-neoforge" = _RrQG1FSZ;
        "pkg-1.1.3+26.1-fabric" = _Chmapx8L;
        "pkg-1.1.3+1.21.9-fabric" = _vrLhqcKR;
        "pkg-1.1.4+1.21.11-neoforge" = _SjTMXzVX;
        "pkg-1.1.4+1.21.1-neoforge" = _Wu1JqPPB;
        "pkg-1.1.4+1.20.1-fabric" = _LZu4uexg;
        "pkg-1.1.4+1.21.1-fabric" = _5mV1OlI3;
        "pkg-1.1.4+1.20.1-forge" = _L80EtS6U;
        "pkg-1.1.4+1.21.10-fabric" = _wFmBNaJI;
        "pkg-1.1.4+1.21.2-fabric" = _4ZYHhTTb;
        "pkg-1.1.4+1.21.11-fabric" = _eGKZru9S;
        "pkg-1.1.4+1.21.4-fabric" = _wJcW6n7W;
        "pkg-1.1.4+1.21.5-fabric" = _h28KPTOY;
        "pkg-1.1.4+1.21.6-fabric" = _QMpTYtO3;
        "pkg-1.1.4+1.21.9-fabric" = _bWccKj7x;
        "pkg-1.1.4+26.1-fabric" = _wO9akNon;
        "pkg-1.1.4+26.1-neoforge" = _y6mbah9N;
        "pkg-1.1.5+1.20.1-forge" = _PLHNrzeI;
        "pkg-1.1.6+1.20.1-forge" = _Tmssrjvx;
        "pkg-1.1.6+1.21.1-fabric" = _lzlhs7sf;
        "pkg-1.1.6+1.20.1-fabric" = _u4DhvWKD;
        "pkg-1.1.6+1.21.1-neoforge" = _JVUtC5dW;
        "pkg-1.1.6+1.21.10-fabric" = _espj2H2I;
        "pkg-1.1.6+1.21.11-neoforge" = _5w3mlSWL;
        "pkg-1.1.6+1.21.11-fabric" = _YHPN3KZ0;
        "pkg-1.1.6+1.21.2-fabric" = _NN3AJcoC;
        "pkg-1.1.6+1.21.4-fabric" = _sIRLPvjX;
        "pkg-1.1.6+1.21.9-fabric" = _8VmyMmR6;
        "pkg-1.1.6+1.21.5-fabric" = _sVS2FgsE;
        "pkg-1.1.6+1.21.6-fabric" = _cJ0JgNCk;
        "pkg-1.1.6+26.1-neoforge" = _GSVZZvAg;
        "pkg-1.1.6+26.1-fabric" = _8cYum5Z3;
        "pkg-1.1.7+1.20.1-forge" = _P6iHMQ6f;
        "pkg-1.1.8+1.21.1-neoforge" = _hzDbSMQA;
        "pkg-1.1.8+1.20.1-fabric" = _7g7BEbpc;
        "pkg-1.1.8+1.21.11-neoforge" = _mX4ORhPF;
        "pkg-1.1.8+1.21.11-fabric" = _DVvcDbjz;
        "pkg-1.1.8+1.21.1-fabric" = _aEpN6bq8;
        "pkg-1.1.8+1.20.1-forge" = _rCKyuFFw;
        "pkg-1.1.8+1.21.10-fabric" = _feHMYkNJ;
        "pkg-1.1.8+1.21.4-fabric" = _2S877x5F;
        "pkg-1.1.8+1.21.5-fabric" = _6HzC3yXB;
        "pkg-1.1.8+1.21.6-fabric" = _73cyUlql;
        "pkg-1.1.8+1.21.9-fabric" = _VyKQQR3D;
        "pkg-1.1.8+1.21.2-fabric" = _4TRRggBy;
        "pkg-1.1.8+26.1-neoforge" = _BeT0xko6;
        "pkg-1.1.8+26.1-fabric" = _jQYt72Iq;
        "pkg-1.1.9+1.20.1-fabric" = _U7jDb8kW;
        "pkg-1.1.9+1.21.1-neoforge" = _xycnAiIp;
        "pkg-1.1.9+1.21.11-neoforge" = _EPOf83D8;
        "pkg-1.1.9+1.20.1-forge" = _gV2sGmI1;
        "pkg-1.1.9+1.21.11-fabric" = _4apJSHjG;
        "pkg-1.1.9+1.21.10-fabric" = _XStly0Zm;
        "pkg-1.1.9+1.21.1-fabric" = _hMND09JO;
        "pkg-1.1.9+1.21.2-fabric" = _fd7BPlX5;
        "pkg-1.1.9+1.21.4-fabric" = _DMa1iEPJ;
        "pkg-1.1.9+1.21.6-fabric" = _xrfE1Lpz;
        "pkg-1.1.9+1.21.5-fabric" = _dRrbYzOU;
        "pkg-1.1.9+1.21.9-fabric" = _mKkzNgDV;
        "pkg-1.1.9+26.1-fabric" = _7MV70itf;
        "pkg-1.1.9+26.1-neoforge" = _qh6lUDwJ;
        "pkg-1.1.10+1.20.1-fabric" = _SMQKpZWg;
        "pkg-1.1.10+1.21.11-fabric" = _cLmZv3Xd;
        "pkg-1.1.10+1.21.11-neoforge" = _TquOQtKU;
        "pkg-1.1.10+1.20.1-forge" = _NnzmNNJq;
        "pkg-1.1.10+1.21.1-neoforge" = _3nVsSQvm;
        "pkg-1.1.10+1.21.1-fabric" = _9lbXBvIh;
        "pkg-1.1.10+1.21.6-fabric" = _iFTbQiSW;
        "pkg-1.1.10+1.21.2-fabric" = _xD4iv3J3;
        "pkg-1.1.10+1.21.4-fabric" = _TJ9iboD2;
        "pkg-1.1.10+1.21.10-fabric" = _g8Q65j5W;
        "pkg-1.1.10+26.1-fabric" = _npS22dbZ;
        "pkg-1.1.10+1.21.5-fabric" = _ScLw2mgn;
        "pkg-1.1.10+1.21.9-fabric" = _vLJA7QZr;
        "pkg-1.1.10+26.1-neoforge" = _Sgg2Rkzr;
        "pkg-1.1.11+1.21.1-neoforge" = _IihmBA1e;
        "pkg-1.1.11+1.21.11-neoforge" = _4odWQ0B8;
        "pkg-1.1.11+1.20.1-fabric" = _O28Ch9VD;
        "pkg-1.1.11+1.20.1-forge" = _Tl5tXRA0;
        "pkg-1.1.11+1.21.1-fabric" = _ybcwmWdG;
        "pkg-1.1.11+1.21.2-fabric" = _umhoWZKE;
        "pkg-1.1.11+1.21.10-fabric" = _J3HgTyDT;
        "pkg-1.1.11+1.21.11-fabric" = _wEUOUBdi;
        "pkg-1.1.11+1.21.4-fabric" = _FZ36b5L2;
        "pkg-1.1.11+1.21.5-fabric" = _qMbVRHat;
        "pkg-1.1.11+1.21.9-fabric" = _b2Ac1vAm;
        "pkg-1.1.11+1.21.6-fabric" = _V6MvJNg4;
        "pkg-1.1.11+26.2-fabric" = _bEzw34W8;
        "pkg-1.1.11+26.1-neoforge" = _CxDHQTeo;
        "pkg-1.1.11+26.1-fabric" = _LHG5w0dg;
        "pkg-1.1.12+1.21.11-neoforge" = _ygL1nnbt;
        "pkg-1.1.12+1.20.1-forge" = _8nlZpA2q;
        "pkg-1.1.12+1.21.1-fabric" = _f2sazeZj;
        "pkg-1.1.12+1.20.1-fabric" = _ZzuPnsvb;
        "pkg-1.1.12+1.21.10-fabric" = _1IGFpPhM;
        "pkg-1.1.12+1.21.2-fabric" = _sMsY4KfN;
        "pkg-1.1.12+1.21.4-fabric" = _TfUr6UOA;
        "pkg-1.1.12+1.21.11-fabric" = _OD5PhZeG;
        "pkg-1.1.12+1.21.5-fabric" = _GeilJIzD;
        "pkg-1.1.12+1.21.9-fabric" = _GUcFL14M;
        "pkg-1.1.12+1.21.6-fabric" = _8ePxxZaO;
        "pkg-1.1.12+26.2-fabric" = _fpPeVLBv;
        "pkg-1.1.12+26.1-fabric" = _6xbqAnTs;
