...
let
    versions = (let
        ...
        _oUkjJaLx = {
            "id" = "oUkjJaLx";
            "file" = "[1.21.x] Injured Effects v1.4.17.jar";
            "hash" = "sha512-eJts8+Z9lZK2vzb3o4Emlqdp28NY8e0JYA3JnQ/Yimty52OUozkRmx6Y2kMxchVY7GZU+acBONpYEtBCKUpyGg==";
        };
        _6D7HgAcZ = {
            "id" = "6D7HgAcZ";
            "file" = "[1.21.x] Injured Effects v1.4.17.zip";
            "hash" = "sha512-4tcndeqEiZC5rQeFihm6y4sysH0NovNu5F0/cysdFR6ca8YJqjnjSIXTw41TEc6XiwLLGWPzbw7Y84aMtDh1wA==";
        };
        _x8L4p8Tq = {
            "id" = "x8L4p8Tq";
            "file" = "[26.1-26.2] Injured Effects v1.5.0.zip";
            "hash" = "sha512-aNXh1hjBUanRWJRcldR2EZbxClXDS+G3wol+bK1TpbCmKc+NVT7myuvb4cADD6vqOBy3Eb36I/EzldwQu1/XiA==";
        };
        _ArnGafwq = {
            "id" = "ArnGafwq";
            "file" = "[26.1-26.2] Injured Effects v1.5.0.jar";
            "hash" = "sha512-/V1Wm9J2ijM1DY75EysY/TaJRLxT9n3/h8A0+hCHnOpW+Hq7SWPP3Rw4mUt73X3F+H2niSHP/RUG0xuH2BrvKw==";
        };
    in {
        "QYmEhKrr" = _QYmEhKrr;
        "heg1lLhF" = _heg1lLhF;
        ...
        "datapack-1.21" = _6D7HgAcZ;
        "datapack-1.21.1" = _6D7HgAcZ;
        "datapack-24w33a" = _3ui5FR1O;
        "datapack-24w34a" = _3ui5FR1O;
        "datapack-1.21.2" = _6D7HgAcZ;
        "datapack-1.21.3" = _6D7HgAcZ;
        "datapack-1.21.4" = _6D7HgAcZ;
        "datapack-25w04a" = _fUeLk0Ja;
        "datapack-1.21.5" = _6D7HgAcZ;
        ...
        "datapack-1.21.6" = _6D7HgAcZ;
        "datapack-1.21.7" = _6D7HgAcZ;
        "datapack-1.21.8" = _6D7HgAcZ;
        "datapack-25w31a" = _pWOjRuXi;
        "datapack-25w32a" = _pWOjRuXi;
        "datapack-1.21.9" = _6D7HgAcZ;
        "datapack-1.21.10" = _6D7HgAcZ;
        "datapack-1.21.11" = _6D7HgAcZ;
        "datapack-26.1" = _x8L4p8Tq;
        "datapack-26.1.1" = _x8L4p8Tq;
        "datapack-26.1.2" = _x8L4p8Tq;
        "datapack-26.2" = _x8L4p8Tq;
        ...
        "fabric-1.21" = _oUkjJaLx;
        "fabric-1.21.1" = _oUkjJaLx;
        "fabric-24w33a" = _xS69c40m;
        "fabric-24w34a" = _xS69c40m;
        "fabric-1.21.2" = _oUkjJaLx;
        "fabric-1.21.3" = _oUkjJaLx;
        "fabric-1.21.4" = _oUkjJaLx;
        "fabric-25w04a" = _LXxuZ2xP;
        "fabric-1.21.5-pre2" = _3OR5TDXd;
        "fabric-1.21.5" = _oUkjJaLx;
        ...
        "fabric-1.21.6" = _oUkjJaLx;
        "fabric-1.21.7" = _oUkjJaLx;
        "fabric-1.21.8" = _oUkjJaLx;
        "fabric-25w31a" = _FKFv4RU7;
        "fabric-25w32a" = _FKFv4RU7;
        "fabric-1.21.9" = _oUkjJaLx;
        "fabric-1.21.10" = _oUkjJaLx;
        "fabric-1.21.11" = _oUkjJaLx;
        "fabric-26.1" = _ArnGafwq;
        "fabric-26.1.1" = _ArnGafwq;
        "fabric-26.1.2" = _ArnGafwq;
        "fabric-26.2" = _ArnGafwq;
        ...
        "forge-1.21" = _oUkjJaLx;
        "forge-1.21.1" = _oUkjJaLx;
        "forge-24w33a" = _xS69c40m;
        "forge-24w34a" = _xS69c40m;
        "forge-1.21.2" = _oUkjJaLx;
        "forge-1.21.3" = _oUkjJaLx;
        "forge-1.21.4" = _oUkjJaLx;
        "forge-25w04a" = _LXxuZ2xP;
        "forge-1.21.5-pre2" = _3OR5TDXd;
        "forge-1.21.5" = _oUkjJaLx;
        ...
        "forge-1.21.6" = _oUkjJaLx;
        "forge-1.21.7" = _oUkjJaLx;
        "forge-1.21.8" = _oUkjJaLx;
        "forge-25w31a" = _FKFv4RU7;
        "forge-25w32a" = _FKFv4RU7;
        "forge-1.21.9" = _oUkjJaLx;
        "forge-1.21.10" = _oUkjJaLx;
        "forge-1.21.11" = _oUkjJaLx;
        "forge-26.1" = _ArnGafwq;
        "forge-26.1.1" = _ArnGafwq;
        "forge-26.1.2" = _ArnGafwq;
        "forge-26.2" = _ArnGafwq;
        ...
        "quilt-1.21" = _oUkjJaLx;
        "quilt-1.21.1" = _oUkjJaLx;
        "quilt-24w33a" = _xS69c40m;
        "quilt-24w34a" = _xS69c40m;
        "quilt-1.21.2" = _oUkjJaLx;
        "quilt-1.21.3" = _oUkjJaLx;
        "quilt-1.21.4" = _oUkjJaLx;
        "quilt-25w04a" = _LXxuZ2xP;
        "quilt-1.21.5-pre2" = _3OR5TDXd;
        "quilt-1.21.5" = _oUkjJaLx;
        ...
        "quilt-1.21.6" = _oUkjJaLx;
        "quilt-1.21.7" = _oUkjJaLx;
        "quilt-1.21.8" = _oUkjJaLx;
        "quilt-25w31a" = _FKFv4RU7;
        "quilt-25w32a" = _FKFv4RU7;
        "quilt-1.21.9" = _oUkjJaLx;
        "quilt-1.21.10" = _oUkjJaLx;
        "quilt-1.21.11" = _oUkjJaLx;
        "quilt-26.1" = _ArnGafwq;
        "quilt-26.1.1" = _ArnGafwq;
        "quilt-26.1.2" = _ArnGafwq;
        "quilt-26.2" = _ArnGafwq;
        "neoforge-1.21" = _oUkjJaLx;
        "neoforge-1.21.1" = _oUkjJaLx;
        "neoforge-24w33a" = _xS69c40m;
        "neoforge-24w34a" = _xS69c40m;
        "neoforge-1.21.2" = _oUkjJaLx;
        "neoforge-1.21.3" = _oUkjJaLx;
        "neoforge-1.21.4" = _oUkjJaLx;
        "neoforge-25w04a" = _LXxuZ2xP;
        "neoforge-1.21.5-pre2" = _3OR5TDXd;
        "neoforge-1.21.5" = _oUkjJaLx;
        ...
        "neoforge-1.21.6" = _oUkjJaLx;
        "neoforge-1.21.7" = _oUkjJaLx;
        "neoforge-1.21.8" = _oUkjJaLx;
        "neoforge-25w31a" = _FKFv4RU7;
        "neoforge-25w32a" = _FKFv4RU7;
        "neoforge-1.21.9" = _oUkjJaLx;
        "neoforge-1.21.10" = _oUkjJaLx;
        "neoforge-1.21.11" = _oUkjJaLx;
        "neoforge-26.1" = _ArnGafwq;
        "neoforge-26.1.1" = _ArnGafwq;
        "neoforge-26.1.2" = _ArnGafwq;
        "neoforge-26.2" = _ArnGafwq;
        "pkg-1.1" = _QYmEhKrr;
        "pkg-1.2" = _heg1lLhF;
        "pkg-1.2.1" = _Ij8KtKi1;
        "pkg-1.2.2" = _v4ZaQndF;
        ...
        "pkg-1.4.16" = _HaFKuxNr;
        "pkg-1.4.16+mod" = _2fZD4WGh;
        "pkg-1.4.17+mod" = _oUkjJaLx;
        "pkg-1.4.17" = _6D7HgAcZ;
        "pkg-1.5.0" = _x8L4p8Tq;
        "pkg-1.5.0+mod" = _ArnGafwq;
        "default" = _ArnGafwq;
    });
