...
let
    ...
    in {
        ...
        "pkg-2.0.1+1.20.1" = _pdlkxTN4;
        "pkg-2.1.0+1.20.1" = _llzyrFZI;
        "pkg-2.1.1+1.20.1" = _4ud5JHCs;
        "pkg-3.0.0+1.20.6" = _GfEZ7Tpf;
        "pkg-3.0.1+1.20.6" = _DwUjeRqd;
        "pkg-3.0.2+1.20.6" = _XZnv2Q1T;
        "pkg-3.1.0+1.20.6" = _Kc3wGLq3;
        "pkg-3.2.0+1.21" = _DHSiv8S2;
        "pkg-3.2.2+1.21" = _LqzPaHvq;
        "pkg-4.0.0+1.21" = _6dfvmAdm;
        "pkg-4.0.1+1.21" = _DnFHEYHD;
        "pkg-5.0.0+fabric+1.21.1" = _nZmCEbUa;
        "pkg-5.0.0+paper+1.21.1" = _ZvyEmTTb;
        "pkg-5.0.0+neoforge+1.21.1" = _Qbij4J7Y;
        "pkg-5.1.0+neoforge+1.21.1" = _9QfmFxfA;
        "pkg-5.1.0+paper+1.21.1" = _Zech3i6M;
        "pkg-5.1.0+fabric+1.21.1" = _urgM9eUm;
        "pkg-5.2.0+neoforge+26.1" = _bj7BG7XC;
        "pkg-5.2.0+fabric+26.1" = _9uvpc7jq;
        "pkg-5.2.1+neoforge+26.1" = _Snjsw5PB;
        "pkg-5.2.1+fabric+26.1" = _LmejPXPp;
        "pkg-5.2.1+paper+26.1" = _T9pJUfP8;
        "pkg-5.3.0+neoforge+26.1" = _p9noTAlw;
        "pkg-5.3.0+paper+26.1" = _zRo6UgLc;
        "pkg-5.3.0+fabric+26.1" = _pvJwDlA8;
