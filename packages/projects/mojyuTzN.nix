...
let
    ...
    in {
        ...
        "pkg-1.2.6+MC1.18-1.18.1" = _1kGe7XEy;
        "pkg-1.2.8+MC1.18.2-1.19" = _IUaYdACH;
        "pkg-1.2.9+MC1.18.2-1.19" = _YVTTI8zv;
        "pkg-1.2.10+MC1.18.2-1.19.1" = _wC3AXTXA;
        "pkg-1.2.11+MC1.18.2-1.19.2" = _qxylPf2g;
        "pkg-1.2.12+MC1.19.3-1.19.4" = _rpcX3UQX;
        "pkg-1.2.13+MC1.20-1.20.1" = _Ofum5oeg;
        "pkg-1.2.15+MC1.20-1.20.4" = _1IgDS9Eg;
        "pkg-1.2.16+MC1.20.5-1.20.6" = _VDtAnz1B;
        "pkg-1.3.0+MC1.21" = _Hd2N8912;
        "pkg-1.3.1+MC1.21-1.21.1" = _VElLLpJq;
        "pkg-1.4.0+MC1.20-1.20.4" = _UxsWsPxH;
        "pkg-1.5.0+MC1.20.5-1.20.6" = _QVEIiSkb;
        "pkg-1.6.0+MC1.21-1.21.1" = _DikPoPTn;
        "pkg-1.7.0+MC1.21.2-1.21.4" = _SW3fjrc1;
        "pkg-1.7.1+MC1.21.2-1.21.5" = _8lpDaJwO;
        "pkg-1.7.2+MC1.21.2-1.21.6" = _FJMmLLZF;
        "pkg-1.7.3+MC1.21.2-1.21.7" = _sjnfZ1HW;
        "pkg-1.7.4+MC1.21.2-1.21.8" = _lUIO48Z0;
