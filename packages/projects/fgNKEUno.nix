...
let
    ...
    in {
        ...
        "pkg-1.4.2" = _GuCwFYLz;
        "pkg-1.4.3" = _UkBv3EqD;
        "pkg-1.4.3-fixes" = _xe2RBzHh;
        "pkg-1.4.4" = _lTv9yQE7;
        "pkg-1.4.5" = _tfJhLgg8;
        "pkg-1.4.6" = _fHSQwAMo;
        "pkg-1.4.6-fixes" = _htAK4Dqe;
        "pkg-1.4.7" = _SATEdUVY;
        "pkg-1.4.8" = _QsLfUUIm;
        "pkg-1.4.8+1.20.1" = _DeMxVev4;
        "pkg-1.4.9" = _DjamYAdP;
        "pkg-1.4.10" = _7Eb1MFO1;
        "pkg-1.4.11" = _fkbmri13;
        "pkg-1.4.11+1.20.1" = _KWkShy09;
        "pkg-1.4.11.1+1.20.1" = _ekgm09g8;
        "pkg-1.4.11.2+1.20.1" = _VMB70OWJ;
        "pkg-1.4.12" = _BzhKm2ek;
        "pkg-1.4.12+1.20.1" = _oXKigTGm;
        "pkg-2.0.0" = _R5QOVw6B;
        "pkg-2.0.1" = _4xmahV41;
        "pkg-2.0.2" = _dxxDEFFt;
        "pkg-2.0.3" = _DfPlUpx8;
        "pkg-2.0.4" = _Wzahrejz;
        "pkg-2.0.5" = _HvVC0Ikx;
        "pkg-2.0.5.1" = _LPsm1ALz;
        "pkg-2.0.6" = _mEV1ShV4;
        "pkg-2.0.7" = _rCDjYA6d;
        "pkg-2.0.8" = _SbrJ4eK2;
        "pkg-2.0.9" = _eCTsYnHP;
        "pkg-2.0.9-beta.1" = _B8YdoWG7;
        "pkg-2.0.9-beta.2" = _bh4nelrc;
        "pkg-2.1.0" = _5Ydrpn6p;
        "pkg-2.1.1" = _834C0eCO;
        "pkg-2.1.2" = _KpiWupEb;
        "pkg-2.1.3" = _sT6F2FUv;
        "pkg-2.1.4" = _WhpyajMS;
        "pkg-2.1.4-fix.1" = _4rVEppbX;
        "pkg-2.1.5" = _DCFueIob;
        "pkg-2.1.5-beta.1" = _XZiPzQPe;
        "pkg-2.1.5-beta.2" = _aMC8bmdf;
        "pkg-2.1.6" = _MLEZEAIm;
        "pkg-2.1.5-fix.1" = _rEyetp1a;
        "pkg-2.1.6-fix.1" = _tAgZdvDI;
        "pkg-2.2.0" = _1HIqZz9I;
        "pkg-2.2.1" = _ElTgvC0z;
