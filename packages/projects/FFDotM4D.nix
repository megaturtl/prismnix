...
let
    ...
    in {
        ...
        "pkg-26.1-b3" = _5oiWxO5l;
        "pkg-1.21.11-b3" = _ozVVMAmn;
        "pkg-1.21.10-b3" = _J3llJnky;
        "pkg-1.21.8-b3" = _V0RgjMTf;
        "pkg-1.21.4-b3" = _7WpClwUx;
        "pkg-1.21.5-b3" = _9WscLy6o;
        "pkg-26.1-b4" = _uV7bkcvC;
        "pkg-1.21.11-b4" = _nQ7JvfK2;
        "pkg-26.1-b6" = _TbA9PM29;
        "pkg-26.1-b7" = _cJYuUDIB;
        "pkg-26.1-b8" = _FsGOVHqn;
        "pkg-26.1-b9" = _tbwQf1vU;
        "pkg-1.21.11-b9" = _JnEXemHW;
        "pkg-26.1-b10" = _5JZppswO;
        "pkg-1.21.11-b10" = _gHEcsEV9;
        "pkg-1.21.11-b11" = _wLXXjRoE;
        "pkg-26.1-b12" = _hCFJNBAE;
        "pkg-1.21.11-b12" = _zfIJrhLB;
        "pkg-26.1-b13" = _FcBsvmMK;
        "pkg-1.21.11-b13" = _ZslH2Mml;
        "pkg-26.1-b14" = _kJXn899M;
        "pkg-1.21.11-b14" = _1ThSCJ2k;
        "pkg-26.1-b15" = _L89gdMmI;
        "pkg-1.21.11-b15" = _wDq9aFc8;
        "pkg-26.1-b16" = _OHvrYbMM;
        "pkg-1.21.11-b16" = _Sa724HMV;
        "pkg-26.1-b17" = _YEM3ywa5;
        "pkg-1.21.11-b17" = _IeULWFAu;
        "pkg-26.1-b18" = _iHe3jLKA;
        "pkg-1.21.11-b18" = _Ovc8tfrs;
        "pkg-26.1-b19" = _9yNa6Pxa;
        "pkg-1.21.11-b19" = _SY76uzEn;
        "pkg-26.2-b19" = _2vkmS7iM;
        "pkg-1.21.11-b20" = _EfN92jSe;
        "pkg-26.2-b21" = _5Zq8F2jr;
