...
let
    versions = (let
        ...
        _rAtGLr4u = {
            "id" = "rAtGLr4u";
            "file" = "Kofi's Vanilla Pack  v3.23.zip";
            "hash" = "sha512-MWXn5ZNFcPUu3p4qdGtNNBfG8ftxb8CZ2ZFy1Xq/3hqk6gZw6AEjCmH0n1SyjFQh4OwQTIzq5aiAEV3A3YzkcQ==";
        };
    in {
        "9T619YFR" = _9T619YFR;
        "E1neTXCp" = _E1neTXCp;
        ...
        "sAXphNYI" = _sAXphNYI;
        "rAtGLr4u" = _rAtGLr4u;
        "minecraft-1.20" = _rAtGLr4u;
        "minecraft-1.20.1" = _rAtGLr4u;
        "minecraft-1.20.2" = _rAtGLr4u;
        "minecraft-1.20.3" = _rAtGLr4u;
        "minecraft-1.20.4" = _rAtGLr4u;
        "minecraft-1.20.5" = _rAtGLr4u;
        "minecraft-1.20.6" = _rAtGLr4u;
        "minecraft-1.21" = _rAtGLr4u;
        "minecraft-1.21.1" = _rAtGLr4u;
        "minecraft-1.21.2" = _rAtGLr4u;
        "minecraft-1.21.3" = _rAtGLr4u;
        "minecraft-1.21.4" = _rAtGLr4u;
        "minecraft-1.21.5" = _rAtGLr4u;
        "minecraft-1.21.6" = _rAtGLr4u;
        "minecraft-1.21.7" = _rAtGLr4u;
        "minecraft-1.21.8" = _rAtGLr4u;
        "minecraft-1.21.9" = _rAtGLr4u;
        "minecraft-1.21.10" = _rAtGLr4u;
        "minecraft-1.19" = _rAtGLr4u;
        "minecraft-1.19.1" = _rAtGLr4u;
        "minecraft-1.19.2" = _rAtGLr4u;
        "minecraft-1.19.3" = _rAtGLr4u;
        "minecraft-1.19.4" = _rAtGLr4u;
        "minecraft-1.21.11" = _rAtGLr4u;
        "minecraft-26.1" = _rAtGLr4u;
        "minecraft-1.18" = _sAXphNYI;
        "minecraft-1.18.1" = _sAXphNYI;
        "minecraft-1.18.2" = _sAXphNYI;
        "minecraft-26.1.1" = _rAtGLr4u;
        "minecraft-26.1.2" = _rAtGLr4u;
        "minecraft-26.2" = _rAtGLr4u;
        "pkg-1" = _9T619YFR;
        "pkg-1.5" = _E1neTXCp;
        "pkg-1.6" = _kW5hLb1l;
        "pkg-1.7" = _D4kDOWS5;
