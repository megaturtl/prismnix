...
let
    ...
    in {
        ...
        "pkg-1.2.8" = _oYE8quEW;
        "pkg-1.2.9" = _XkmUTTFv;
        "pkg-1.2.10" = _xZ6tk7RY;
        "pkg-1.2.11" = _cef9ivPt;
        "pkg-1.2.12" = _OksFwGRL;
        "pkg-1.0.5" = _XylYCKT5;
        "pkg-1.2.13" = _jovVcOqb;
        "pkg-1.0.6" = _JYRiiC6e;
        "pkg-1.2.14" = _T8auyPMX;
        "pkg-1.2.15" = _hLjmp0IN;
        "pkg-1.0.7" = _ARZLENAM;
        "pkg-1.0.9" = _cCgMdXNE;
        "pkg-1.0.10" = _vNcAVVK0;
        "pkg-1.0.11" = _cORDFiHF;
        "pkg-1.0.12" = _hOUt9RRg;
        "pkg-1.0.13" = _5K8Gqm1R;
        "pkg-1.0.14" = _kSmoMCEI;
        "pkg-1.0.15" = _YYzGojgd;
        "pkg-1.2.16" = _io2duzJM;
        "pkg-1.0.16" = _MUpT3eaH;
        "pkg-1.0.17" = _mt4dILPo;
        "pkg-1.2.17" = _kxYkdJ07;
        "pkg-1.2.18" = _rfznaZum;
        "pkg-1.0.18" = _ROADZx1W;
        "pkg-1.1.0" = _hENPViwZ;
        "pkg-1.1.1" = _Q5w50Bcp;
