...
let
    ...
    in {
        ...
        "pkg-2.0.8" = _unjQAak5;
        "pkg-2.0.9" = _TFuTJ9gx;
        "pkg-2.0.10" = _HIZS6nrh;
        "pkg-2.0.11" = _HzB20fs3;
        "pkg-2.0.13" = _jDBlcrkW;
        "pkg-2.0.14" = _ZkiQR3Zc;
        "pkg-2.0.15" = _udsbFgqF;
        "pkg-2.0.16" = _kwzhLqkI;
        "pkg-2.0.17" = _vMeP1r6e;
        "pkg-2.0.19" = _VycLNJjR;
        "pkg-2.0.20" = _MW9MLRjN;
        "pkg-2.0.21" = _Yohdbmol;
        "pkg-2.0.22" = _LY3HI1Dp;
