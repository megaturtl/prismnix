...
let
    ...
    in {
        ...
        "pkg-133.6.4" = _AXZoeRWy;
        "pkg-137.10.9" = _jKXRZ0o6;
        "pkg-138.11.10" = _ImEF0yGV;
        "pkg-139.12.11" = _oazvArzl;
        "pkg-141.14.13" = _juVlRZoW;
        "pkg-142.15.14" = _h2qTre0M;
        "pkg-143.16.15" = _LTXaZL00;
        "pkg-144.17.16" = _NDzuYmDP;
        "pkg-145.18.17" = _RYJJPC0m;
        "pkg-146.19.18" = _qkAFM8Al;
        "pkg-147.20.19" = _wCcDAReL;
        "pkg-148.21.22" = _asv4RSDo;
        "pkg-149.22.21" = _YF3hra3A;
        "pkg-150.23.22" = _Q7F7ZImd;
        "pkg-151.24.23" = _wbuwvAR5;
        "pkg-152.25.24" = _5gVm11pp;
        "pkg-153.26.25" = _hdlfTIxW;
        "pkg-155.28.27" = _uYBVkAsR;
        "pkg-156.29.28" = _eQzHynrG;
        "pkg-157.30.29" = _et0A4JiX;
        "pkg-158.31.30" = _7mqewxFN;
        "pkg-159.32.31" = _zm2l3VJA;
        "pkg-160.33.32" = _YpB9PxP5;
        "pkg-162.35.34" = _ghE0V2sI;
        "pkg-167.40.39" = _Ih26I7lQ;
        "pkg-168.41.40" = _GzRXyhTY;
        "pkg-169.42.41" = _Za7rroiq;
        "pkg-170.43.42" = _MVHO47LD;
        "pkg-171.44.43" = _3r8nVXH7;
        "pkg-172.45.44" = _qCRIoTWS;
        "pkg-173.46.45" = _FuFZmh9I;
