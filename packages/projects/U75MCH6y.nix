...
let
    versions = (let
        ...
        _kxb9v541 = {
            "id" = "kxb9v541";
            "file" = "MTR-forge-1.20.1-3.6.2.2.jar";
            "hash" = "sha512-ZNHzNuycegxH+rlpoLXff2Lqa/ArHXR08AJqwHU1/SAmUAhrv28NaoL6aRctDNxGhIpByeCyJujAzdUWx6XVWQ==";
        };
        _S9M2g0jl = {
            "id" = "S9M2g0jl";
    ...
    in {
        ...
        "pkg-1.20.1-3.5.6" = _OZbIhXxw;
        "pkg-1.20.1-3.6.1" = _rP5iY985;
