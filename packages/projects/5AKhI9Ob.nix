...
let
    versions = (let
        ...
        _oFgRwCTs = {
            "id" = "oFgRwCTs";
            "file" = "WildRTP-3.6.1.jar";
            "hash" = "sha512-k2anVS1e+cE6BdYJYqZJSxOh7dDnmsheMSz77Ynb7VycjbhtgOj8dwlXXJsWg0FVIbEhI6Tz7t6N6khrItfZMg==";
        };
        _wVNXJy8F = {
            "id" = "wVNXJy8F";
            "file" = "WildRTP-3.6.2.jar";
            "hash" = "sha512-QBpdPIVUcim5prFqV7ii9b8dS2+deEvE3wjNy2QNJmRBbOk6xsXMetS3BSNoEb8BAoPETWmOZVCAqPD1cJi0bQ==";
        };
        _nkFhNeVk = {
            "id" = "nkFhNeVk";
            "file" = "WildRTP-3.6.3.jar";
            "hash" = "sha512-IHuVeCCQqDKNNoUVDKpNqmUPI8c6/ez6bKtppEzwWbueKd+0OUs+nalgoZxsEIwy76et+C1R96C7srcGrJBHNg==";
        };
        _gUD8WzUZ = {
            "id" = "gUD8WzUZ";
            "file" = "WildRTP-3.6.4.jar";
            "hash" = "sha512-weW+hI5gphXbeyQD8urGIehGe/BsuyE7EAXGFaIxdebiEHzb+a2W9v/dC2NAEOAl6llNcMUtz31ATO9AEBKcvQ==";
        };
        _EhtZaDNI = {
            "id" = "EhtZaDNI";
            "file" = "WildRTP-3.6.5.jar";
            "hash" = "sha512-W9oXO/FxNJoK4hARP7docBqeL60FsHCdotbIUvdZtkQNCXlHOQiYM4z5R68I7Oz7+I20HptpFMnHx6U2nm5O6A==";
        };
        _yVCFYyuJ = {
            "id" = "yVCFYyuJ";
            "file" = "WildRTP-3.7-beta.1.jar";
            "hash" = "sha512-gttGVIVonT7/VGy8T3aiPSrPNrgzjOzu1mA23fteDPjT5/vkuJhJ4nA/1iWvf0C87RHmv4nt/12EiaeUytY40g==";
        };
        _CI47Mazv = {
            "id" = "CI47Mazv";
            "file" = "WildRTP-3.7-beta.2.jar";
            "hash" = "sha512-YmKyW+yRTjIadufYY26FNpluigiUPueBf95NY3auNNF3ubLu7Vs4Gj5gciClDL7NUB7RD+8M+CgLAUYOFjYoNA==";
        };
    in {
        "zfRvBBPV" = _zfRvBBPV;
        "FretOMD5" = _FretOMD5;
        ...
        "yVCFYyuJ" = _yVCFYyuJ;
        "CI47Mazv" = _CI47Mazv;
        "bukkit-1.19" = _yVCFYyuJ;
        "bukkit-1.19.1" = _yVCFYyuJ;
        "bukkit-1.19.2" = _yVCFYyuJ;
        "bukkit-1.19.3" = _yVCFYyuJ;
        ...
        "bukkit-1.18" = _yVCFYyuJ;
        "bukkit-1.18.1" = _yVCFYyuJ;
        "bukkit-1.18.2" = _yVCFYyuJ;
        "bukkit-1.19.4" = _yVCFYyuJ;
        "bukkit-1.20" = _yVCFYyuJ;
        "bukkit-1.20.1" = _yVCFYyuJ;
        "bukkit-1.20.2" = _yVCFYyuJ;
        "bukkit-1.20.3" = _yVCFYyuJ;
        "bukkit-1.20.4" = _yVCFYyuJ;
        "bukkit-1.20.5" = _yVCFYyuJ;
        "bukkit-1.20.6" = _yVCFYyuJ;
        "bukkit-1.21" = _yVCFYyuJ;
        "bukkit-1.21.1" = _yVCFYyuJ;
        "bukkit-1.21.2" = _yVCFYyuJ;
        "bukkit-1.21.3" = _yVCFYyuJ;
        "bukkit-1.21.4" = _yVCFYyuJ;
        "bukkit-1.21.5" = _yVCFYyuJ;
        "bukkit-1.21.6" = _yVCFYyuJ;
        "bukkit-1.21.7" = _yVCFYyuJ;
        "bukkit-1.21.8" = _yVCFYyuJ;
        "bukkit-1.21.9" = _yVCFYyuJ;
        "bukkit-1.21.10" = _yVCFYyuJ;
        "bukkit-1.21.11" = _yVCFYyuJ;
        "bukkit-26.1" = _yVCFYyuJ;
        "bukkit-26.1.1" = _yVCFYyuJ;
        "bukkit-26.1.2" = _yVCFYyuJ;
        "bukkit-26.2" = _yVCFYyuJ;
        "paper-1.19" = _CI47Mazv;
        "paper-1.19.1" = _CI47Mazv;
        "paper-1.19.2" = _CI47Mazv;
        "paper-1.19.3" = _CI47Mazv;
        ...
        "paper-1.18" = _CI47Mazv;
        "paper-1.18.1" = _CI47Mazv;
        "paper-1.18.2" = _CI47Mazv;
        "paper-1.19.4" = _CI47Mazv;
        "paper-1.20" = _CI47Mazv;
        "paper-1.20.1" = _CI47Mazv;
        "paper-1.20.2" = _CI47Mazv;
        "paper-1.20.3" = _CI47Mazv;
        "paper-1.20.4" = _CI47Mazv;
        "paper-1.20.5" = _CI47Mazv;
        "paper-1.20.6" = _CI47Mazv;
        "paper-1.21" = _CI47Mazv;
        "paper-1.21.1" = _CI47Mazv;
        "paper-1.21.2" = _CI47Mazv;
        "paper-1.21.3" = _CI47Mazv;
        "paper-1.21.4" = _CI47Mazv;
        "paper-1.21.5" = _CI47Mazv;
        "paper-1.21.6" = _CI47Mazv;
        "paper-1.21.7" = _CI47Mazv;
        "paper-1.21.8" = _CI47Mazv;
        "paper-1.21.9" = _CI47Mazv;
        "paper-1.21.10" = _CI47Mazv;
        "paper-1.21.11" = _CI47Mazv;
        "paper-26.1" = _CI47Mazv;
        "paper-26.1.1" = _CI47Mazv;
        "paper-26.1.2" = _CI47Mazv;
        "paper-26.2" = _CI47Mazv;
        "purpur-1.19" = _CI47Mazv;
        "purpur-1.19.1" = _CI47Mazv;
        "purpur-1.19.2" = _CI47Mazv;
        "purpur-1.19.3" = _CI47Mazv;
        ...
        "purpur-1.18" = _CI47Mazv;
        "purpur-1.18.1" = _CI47Mazv;
        "purpur-1.18.2" = _CI47Mazv;
        "purpur-1.19.4" = _CI47Mazv;
        "purpur-1.20" = _CI47Mazv;
        "purpur-1.20.1" = _CI47Mazv;
        "purpur-1.20.2" = _CI47Mazv;
        "purpur-1.20.3" = _CI47Mazv;
        "purpur-1.20.4" = _CI47Mazv;
        "purpur-1.20.5" = _CI47Mazv;
        "purpur-1.20.6" = _CI47Mazv;
        "purpur-1.21" = _CI47Mazv;
        "purpur-1.21.1" = _CI47Mazv;
        "purpur-1.21.2" = _CI47Mazv;
        "purpur-1.21.3" = _CI47Mazv;
        "purpur-1.21.4" = _CI47Mazv;
        "purpur-1.21.5" = _CI47Mazv;
        "purpur-1.21.6" = _CI47Mazv;
        "purpur-1.21.7" = _CI47Mazv;
        "purpur-1.21.8" = _CI47Mazv;
        "purpur-1.21.9" = _CI47Mazv;
        "purpur-1.21.10" = _CI47Mazv;
        "purpur-1.21.11" = _CI47Mazv;
        "purpur-26.1" = _CI47Mazv;
        "purpur-26.1.1" = _CI47Mazv;
        "purpur-26.1.2" = _CI47Mazv;
        "purpur-26.2" = _CI47Mazv;
        "spigot-1.19" = _CI47Mazv;
        "spigot-1.19.1" = _CI47Mazv;
        "spigot-1.19.2" = _CI47Mazv;
        "spigot-1.19.3" = _CI47Mazv;
        ...
        "spigot-1.18" = _CI47Mazv;
        "spigot-1.18.1" = _CI47Mazv;
        "spigot-1.18.2" = _CI47Mazv;
        "spigot-1.19.4" = _CI47Mazv;
        "spigot-1.20" = _CI47Mazv;
        "spigot-1.20.1" = _CI47Mazv;
        "spigot-1.20.2" = _CI47Mazv;
        "spigot-1.20.3" = _CI47Mazv;
        "spigot-1.20.4" = _CI47Mazv;
        "spigot-1.20.5" = _CI47Mazv;
        "spigot-1.20.6" = _CI47Mazv;
        "spigot-1.21" = _CI47Mazv;
        "spigot-1.21.1" = _CI47Mazv;
        "spigot-1.21.2" = _CI47Mazv;
        "spigot-1.21.3" = _CI47Mazv;
        "spigot-1.21.4" = _CI47Mazv;
        "spigot-1.21.5" = _CI47Mazv;
        "spigot-1.21.6" = _CI47Mazv;
        "spigot-1.21.7" = _CI47Mazv;
        "spigot-1.21.8" = _CI47Mazv;
        "spigot-1.21.9" = _CI47Mazv;
        "spigot-1.21.10" = _CI47Mazv;
        "spigot-1.21.11" = _CI47Mazv;
        "spigot-26.1" = _CI47Mazv;
        "spigot-26.1.1" = _CI47Mazv;
        "spigot-26.1.2" = _CI47Mazv;
        "spigot-26.2" = _CI47Mazv;
        "folia-1.18" = _CI47Mazv;
        "folia-1.18.1" = _CI47Mazv;
        "folia-1.18.2" = _CI47Mazv;
        "folia-1.19" = _CI47Mazv;
        "folia-1.19.1" = _CI47Mazv;
        "folia-1.19.2" = _CI47Mazv;
        "folia-1.19.3" = _CI47Mazv;
        "folia-1.19.4" = _CI47Mazv;
        "folia-1.20" = _CI47Mazv;
        "folia-1.20.1" = _CI47Mazv;
        "folia-1.20.2" = _CI47Mazv;
        "folia-1.20.3" = _CI47Mazv;
        "folia-1.20.4" = _CI47Mazv;
        "folia-1.20.5" = _CI47Mazv;
        "folia-1.20.6" = _CI47Mazv;
        "folia-1.21" = _CI47Mazv;
        "folia-1.21.1" = _CI47Mazv;
        "folia-1.21.2" = _CI47Mazv;
        "folia-1.21.3" = _CI47Mazv;
        "folia-1.21.4" = _CI47Mazv;
        "folia-1.21.5" = _CI47Mazv;
        "folia-1.21.6" = _CI47Mazv;
        "folia-1.21.7" = _CI47Mazv;
        "folia-1.21.8" = _CI47Mazv;
        "folia-1.21.9" = _CI47Mazv;
        "folia-1.21.10" = _CI47Mazv;
        "folia-1.21.11" = _CI47Mazv;
        "folia-26.1" = _CI47Mazv;
        "folia-26.1.1" = _CI47Mazv;
        "folia-26.1.2" = _CI47Mazv;
        "folia-26.2" = _CI47Mazv;
        "pkg-1.1" = _zfRvBBPV;
        "pkg-1.2" = _FretOMD5;
        "pkg-1.2-legacy" = _2FT4xD7C;
        "pkg-1.3" = _BlDm1aNx;
        "pkg-1.3-legacy" = _beeSqaK6;
        "pkg-1.3.1-legacy" = _4NQqKwtm;
        "pkg-1.3.1" = _9kJ7NeIl;
        "pkg-2.0" = _S5nXZPrU;
        "pkg-2.1" = _fGL0Kcyu;
        "pkg-2.2" = _IX5onrH0;
        ...
        "pkg-2.6" = _XJa6vutO;
        "pkg-2.6.1" = _FivlFOmZ;
        "pkg-3.0-alpha.0" = _ZpFxzlsy;
        "pkg-3.0-alpha.1" = _ymwfD00a;
        "pkg-3.0-alpha.2" = _IOIxlZoE;
        "pkg-3.0-alpha.3" = _ou4GlTF1;
        "pkg-3.0-alpha.4" = _v5k2ucwy;
        "pkg-3.0-alpha.5" = _P47DQNLP;
        "pkg-3.0" = _7iOdaIHI;
        "pkg-3.1" = _S134XzCs;
        "pkg-3.1.1" = _c0KLDHZW;
        "pkg-3.1.2" = _P2yOhGub;
        ...
        "pkg-3.6.4" = _gUD8WzUZ;
        "pkg-3.6.5" = _EhtZaDNI;
        "pkg-3.7-beta.1" = _yVCFYyuJ;
        "pkg-3.7-beta.2" = _CI47Mazv;
        "default" = _CI47Mazv;
    });
