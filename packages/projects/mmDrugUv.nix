...
let
    ...
    in {
        ...
        "pkg-0.0.4-datapack" = _cHwJLStI;
        "pkg-0.0.5-datapack" = _Fmw2HS7r;
        "pkg-0.1.0-datapack" = _lwlUamZV;
        "pkg-0.1.1-datapack" = _7D5w5YRg;
        "pkg-0.1.2-datapack" = _CpfSAmsz;
        "pkg-0.1.3-datapack" = _OOKCJBHf;
        "pkg-0.1.3-mod" = _azXX2zny;
        "pkg-0.1.4-datapack" = _1OIRqYSS;
        "pkg-0.1.4-mod" = _WfkapmLW;
        "pkg-0.1.5-datapack" = _6DoL5Daw;
        "pkg-0.1.5-mod" = _e3MnttiQ;
        "pkg-0.1.6-datapack" = _IRWzZeY1;
        "pkg-0.1.6-mod" = _iyCqgeyu;
        "pkg-0.1.7-datapack" = _hDGciEN3;
        "pkg-0.1.7-mod" = _SB9k6vmS;
        "pkg-0.1.8-datapack" = _aqjQDaMn;
        "pkg-0.1.8-mod" = _eNdtLMy4;
        "pkg-0.2.0-datapack" = _EENe3ke0;
        "pkg-0.2.0-mod" = _NVe4zpLl;
        "pkg-0.2.1-datapack" = _IQiurTSi;
        "pkg-0.2.1-mod" = _FaJoVmIb;
        "pkg-0.2.2-datapack" = _SrmXSYD9;
        "pkg-0.2.2-mod" = _IFAmYk0p;
        "pkg-0.2.3-datapack" = _f3z6ZFqd;
        "pkg-0.2.3-mod" = _kcHtd24b;
        "pkg-0.2.4-datapack" = _qtC3h7gB;
        "pkg-0.2.4-mod" = _QSCDuUUY;
        "pkg-0.3.0-datapack" = _79Xgv5q6;
        "pkg-0.3.0-mod" = _ox1gQ4et;
        "pkg-0.3.1-datapack" = _83TlrUhe;
        "pkg-0.3.1-mod" = _AV4i3qQi;
        "pkg-0.4.0-datapack" = _ZToeUosS;
