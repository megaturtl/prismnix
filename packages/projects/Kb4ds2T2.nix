...
let
    versions = (let
        ...
        _1eIzG94C = {
            "id" = "1eIzG94C";
            "file" = "boar-geyser.jar";
            "hash" = "sha512-XsgEm3PhQf9g8yGnjcfQRT18no1d0oArvXqBMQrB4uE8E3gPapotvQHPHd1JXx1fRiYvxJDF4X+Bq55qQvUW6Q==";
        };
        _ClmMlRPX = {
            "id" = "ClmMlRPX";
            "file" = "boar-geyser.jar";
            "hash" = "sha512-qM+5rf/pnbnS/yNJoDK/jZKwPYhpIC4kD4E/E0oFZDDbdYpDg9UHkFFCAz0cBAul87hqc146T0rNOJH8ga/NPA==";
        };
        _BUo0omeu = {
            "id" = "BUo0omeu";
            "file" = "boar-geyser.jar";
            "hash" = "sha512-LGYWS/0AEwE9GNWsLTOM2qsA/FfcJboBdkdbu2qehl//t3D4eAUrQXZyACSZ2Kti5CnjPKc9CgNH/S8NPG5PrA==";
        };
        _kWenZVrO = {
            "id" = "kWenZVrO";
            "file" = "boar-geyser.jar";
            "hash" = "sha512-5qWqn7oH60V5C0ms/abyEpLB0Xn6+FxJQBycIWBJMZc5onkng/k0Wx8bSXB3Wo3fgESgFvpFtx+cQgHKG9L+aA==";
        };
        _upKb4yAd = {
            "id" = "upKb4yAd";
            "file" = "boar-geyser.jar";
            "hash" = "sha512-iwJU4Xx7uH6yO9bd9wfP5MfTgicweyi9XQ+n14rEbiPmEkg0Pz2MYTBWISLnUykWzk6+rOhpeCD9xtLR7Un18Q==";
        };
        _dDppdnmW = {
            "id" = "dDppdnmW";
            "file" = "boar-geyser.jar";
            "hash" = "sha512-MCsjgTf8wLlIJcpLjK42y0bOI1XscliEF9UOq7fqyXJ7Auf/hTf4q6HCzLzlIO2Hnt0UohkpY6TyogXXvxEVnw==";
        };
    in {
        "pMM4MyRP" = _pMM4MyRP;
        "bgZ7ErN1" = _bgZ7ErN1;
        ...
        "geyser-1.8" = _dDppdnmW;
        "geyser-1.8.1" = _dDppdnmW;
        "geyser-1.8.2" = _dDppdnmW;
        "geyser-1.8.3" = _dDppdnmW;
        "geyser-1.8.4" = _dDppdnmW;
        "geyser-1.8.5" = _dDppdnmW;
        "geyser-1.8.6" = _dDppdnmW;
        "geyser-1.8.7" = _dDppdnmW;
        "geyser-1.8.8" = _dDppdnmW;
        "geyser-1.8.9" = _dDppdnmW;
        "geyser-1.9" = _dDppdnmW;
        "geyser-1.9.1" = _dDppdnmW;
        "geyser-1.9.2" = _dDppdnmW;
        "geyser-1.9.3" = _dDppdnmW;
        "geyser-1.9.4" = _dDppdnmW;
        "geyser-1.10" = _dDppdnmW;
        "geyser-1.10.1" = _dDppdnmW;
        "geyser-1.10.2" = _dDppdnmW;
        "geyser-1.11" = _dDppdnmW;
        "geyser-1.11.1" = _dDppdnmW;
        "geyser-1.11.2" = _dDppdnmW;
        "geyser-1.12" = _dDppdnmW;
        "geyser-1.12.1" = _dDppdnmW;
        "geyser-1.12.2" = _dDppdnmW;
        "geyser-1.13" = _dDppdnmW;
        "geyser-1.13.1" = _dDppdnmW;
        "geyser-1.13.2" = _dDppdnmW;
        "geyser-1.14" = _dDppdnmW;
        "geyser-1.14.1" = _dDppdnmW;
        "geyser-1.14.2" = _dDppdnmW;
        "geyser-1.14.3" = _dDppdnmW;
        "geyser-1.14.4" = _dDppdnmW;
        "geyser-1.15" = _dDppdnmW;
        "geyser-1.15.1" = _dDppdnmW;
        "geyser-1.15.2" = _dDppdnmW;
        "geyser-1.16" = _dDppdnmW;
        "geyser-1.16.1" = _dDppdnmW;
        "geyser-1.16.2" = _dDppdnmW;
        "geyser-1.16.3" = _dDppdnmW;
        "geyser-1.16.4" = _dDppdnmW;
        "geyser-1.16.5" = _dDppdnmW;
        "geyser-1.17" = _dDppdnmW;
        "geyser-1.17.1" = _dDppdnmW;
        "geyser-1.18" = _dDppdnmW;
        "geyser-1.18.1" = _dDppdnmW;
        "geyser-1.18.2" = _dDppdnmW;
        "geyser-1.19" = _dDppdnmW;
        "geyser-1.19.1" = _dDppdnmW;
        "geyser-1.19.2" = _dDppdnmW;
        "geyser-1.19.3" = _dDppdnmW;
        "geyser-1.19.4" = _dDppdnmW;
        "geyser-1.20" = _dDppdnmW;
        "geyser-1.20.1" = _dDppdnmW;
        "geyser-1.20.2" = _dDppdnmW;
        "geyser-1.20.3" = _dDppdnmW;
        "geyser-1.20.4" = _dDppdnmW;
        "geyser-1.20.5" = _dDppdnmW;
        "geyser-1.20.6" = _dDppdnmW;
        "geyser-1.21" = _dDppdnmW;
        "geyser-1.21.1" = _dDppdnmW;
        "geyser-1.21.2" = _dDppdnmW;
        "geyser-1.21.3" = _dDppdnmW;
        "geyser-1.21.4" = _dDppdnmW;
        "geyser-1.21.5" = _dDppdnmW;
        "geyser-1.21.6" = _dDppdnmW;
        "geyser-1.21.7" = _dDppdnmW;
        "geyser-1.21.8" = _dDppdnmW;
        "geyser-1.21.9" = _dDppdnmW;
        "geyser-1.21.10" = _dDppdnmW;
        "geyser-1.21.11" = _dDppdnmW;
        "geyser-26.1" = _dDppdnmW;
        "geyser-26.1.1" = _dDppdnmW;
        "geyser-26.1.2" = _dDppdnmW;
        "geyser-26.2" = _dDppdnmW;
        "pkg-1.0.0" = _pMM4MyRP;
        "pkg-1.0.1" = _bgZ7ErN1;
        "pkg-1.0.2" = _Ymc7pCaM;
        "pkg-1.0.3" = _tFaKp4EF;
        "pkg-1.0.4" = _ceMZV1WI;
        "pkg-1.0.4-HOTFIX" = _rLISCLkX;
        "pkg-1.0.4-HOTFIX2" = _6nKd3Mow;
        "pkg-1.0.4-89a2ffb" = _rliEbNpk;
        "pkg-1.0.4-78e0957" = _pheyDBZh;
        "pkg-1.0.4-9b87f12" = _WIbXfBnN;
        "pkg-1.0.4-6a79f28" = _wZYjIMlO;
        "pkg-1.0.4-018d001" = _qyolC1cV;
        "pkg-1.0.4-db10b08" = _EIakmeag;
        "pkg-1.0.4-7c5b70d" = _ONbqDxNr;
        "pkg-1.0.4-c6ca779" = _J1mAZZNY;
        "pkg-1.0.4-2d5e962" = _337SLRwx;
        "pkg-1.0.4-3598df7" = _fQ02KKB3;
        "pkg-1.0.4-66188cd" = _vrDU1or2;
        "pkg-1.0.4-d4d960e" = _avJZiOU9;
        "pkg-1.0.4-de25439" = _OWdLSmI1;
        "pkg-1.0.4-b7063d0" = _xMifRg6z;
        "pkg-1.0.4-0696b9f" = _gjHf5u2R;
        "pkg-1.0.4-bdc002f" = _lkCjQkyw;
        "pkg-1.0.4-99ecc8b" = _dFhPns3h;
        "pkg-1.0.4-d25c8ba" = _ZszAD7R6;
        "pkg-1.0.4-29efe40" = _QT0sYUkW;
        "pkg-1.0.4-237dea3" = _22ntQRDN;
        "pkg-1.0.4-f63ff8f" = _XIn3Ndwg;
        "pkg-1.0.4-e436534" = _s5Wi3DDj;
        "pkg-1.0.4-3337a11" = _CFT2Vcm6;
        "pkg-1.0.4-aeecf51" = _HH0DmJNt;
        "pkg-1.0.4-b2ea691" = _YCuAinQN;
        "pkg-1.0.4-e422708" = _rOE0pzy7;
        "pkg-1.0.4-3760c86" = _G3XXHpng;
        "pkg-1.0.4-cd4b9f6" = _c9VuwxGP;
        "pkg-1.0.4-d32d85e" = _PWtfm3EZ;
        "pkg-1.0.4-fda1779" = _m266pJHe;
        "pkg-1.0.4-bab3f3a" = _HMvgDaOH;
        "pkg-1.0.4-85437b8" = _68AkOTx0;
        "pkg-1.0.4-a7fce0b" = _vTkqDKIh;
        "pkg-1.0.4-ca94a02" = _spzmSVVF;
        "pkg-1.0.4-a069d34" = _1HTyIWqH;
        "pkg-1.0.4-c803edb" = _CsoWDYoJ;
        "pkg-1.0.4-a7290ca" = _EUnveLeT;
        "pkg-1.0.4-6615530" = _PGf207PJ;
        "pkg-1.0.4-23f53f8" = _3Jtuvrqz;
        "pkg-1.0.4-15ec58a" = _CSAwbYlh;
        "pkg-1.0.4-b857fe6" = _ouNUjPlP;
        "pkg-1.0.4-0126fbc" = _2LtbYuvW;
        "pkg-1.0.4-d87648e" = _tQDsDUJs;
        "pkg-1.0.4-166edf7" = _qb99DGCF;
        "pkg-1.0.4-e4b9413" = _oIRsM0bn;
        "pkg-1.0.4-4e04aff" = _qtvCi4k8;
        "pkg-1.0.4-4588f66" = _ZL7UfUKk;
        "pkg-1.0.4-9d97354" = _aG5pKPbP;
        "pkg-1.0.4-892a6ef" = _SACIPEz7;
        "pkg-1.0.4-4d1ce80" = _Hmi9UQaZ;
        "pkg-1.0.4-99535a2" = _PIgWjjr8;
        "pkg-1.0.4-90d6b86" = _PketSI0y;
        "pkg-1.0.4-071bd80" = _fk6SyJeb;
        "pkg-1.0.4-5d7c92a" = _BTDR1hWQ;
        "pkg-1.0.4-873bf6e" = _IghrqKFZ;
        "pkg-1.0.4-2dc8c53" = _2CmXbwqe;
        "pkg-1.0.4-33c5427" = _J2qEQKPj;
        "pkg-1.0.4-269d863" = _8WPqYIt2;
        "pkg-1.0.4-dc442a7" = _zwTAnKKd;
        "pkg-1.0.4-c7702d7" = _FcUd6q5b;
        "pkg-1.0.4-2ea0198" = _SQsaAQul;
        "pkg-1.0.4-e343bad" = _P7QoTVaZ;
        "pkg-1.0.4-1297bfc" = _tC0IjagL;
        "pkg-1.0.4-3317f55" = _igqDzsLF;
        "pkg-1.0.4-85a0ae7" = _2fBOLtb8;
        "pkg-1.0.4-41d79b2" = _Lp9HazOR;
        "pkg-1.0.4-310093e" = _v4ies118;
        "pkg-1.0.4-aad53ff" = _ciMMhLL6;
        "pkg-1.0.4-d1f85dc" = _ZMVFXA9v;
        "pkg-1.0.4-e752d36" = _jwFKol7q;
        "pkg-1.0.4-c8eb836" = _ZPK4TGoK;
        "pkg-1.0.4-fc06017" = _KskzGC8R;
        "pkg-1.0.4-2f89e2b" = _YergFoID;
        "pkg-1.0.4-f291089" = _uCyOtJCN;
        "pkg-1.0.4-74d8bef" = _9VWxiolr;
        "pkg-1.0.4-361ce78" = _G8SKzumo;
        "pkg-1.0.4-b776efd" = _55O5jLJj;
        "pkg-1.0.4-965debb" = _VUzNTOfH;
        "pkg-1.0.4-65eb2a2" = _YUJK7df8;
        "pkg-1.0.4-dd49e48" = _qTiqYW5q;
        "pkg-1.0.4-9b1fc05" = _xanoQ2Dr;
        "pkg-1.0.4-c46998d" = _cJfwOGU4;
        "pkg-1.0.4-7dc814f" = _TsNBJQeG;
        "pkg-1.0.4-b5131f4" = _zss9JIJc;
        "pkg-1.0.4-20540e3" = _Bt0s0wSZ;
        "pkg-1.0.4-8741c74" = _TbpAffC5;
        "pkg-1.0.4-3f9684f" = _5I7as4Zo;
        "pkg-1.0.4-895cf59" = _uaEqtwU0;
        "pkg-1.0.4-1d3170f" = _1ILNem65;
        "pkg-1.0.4-bf205f7" = _DWJYUC3m;
        "pkg-1.0.4-781caec" = _Nf3oSVz8;
        "pkg-1.0.4-788ad02" = _LUOj0em2;
        "pkg-1.0.4-a8b2dbc" = _WHjPdjl9;
        "pkg-1.0.4-f41fde5" = _HzKcPvX5;
        "pkg-1.0.4-fa38595" = _kLJdjSgH;
        "pkg-1.0.4-cbcfac8" = _lu6N5vAU;
        "pkg-1.0.4-67781f1" = _inyCHCDN;
        "pkg-1.0.4-e18ba83" = _FsTeBIud;
        "pkg-1.0.4-3def85f" = _f1xfc8Oj;
        "pkg-1.0.4-f4117b8" = _fhqyy8qX;
        "pkg-1.0.4-c59f872" = _3qU8r4pD;
        "pkg-1.0.4-0d26697" = _jFo72vt9;
        "pkg-1.0.4-8cfe3ad" = _ErgA4TUZ;
        "pkg-1.0.4-5178581" = _97Xr4QBD;
        "pkg-1.0.4-112971c" = _tyaZF3no;
        "pkg-1.0.4-d44464c" = _E9tJgzTa;
        "pkg-1.0.4-6d0454f" = _90slj3Ry;
        "pkg-1.0.4-55edd50" = _rTY4vQTK;
        "pkg-1.0.4-e93e9c7" = _zLG21jmt;
        "pkg-1.0.4-3880ba1" = _XB1eL5IK;
        "pkg-1.0.4-705895f" = _fLDat4TB;
        "pkg-1.0.4-507334a" = _VLZVZ5CD;
        "pkg-1.0.4-bca5885" = _YkRGXVac;
        "pkg-1.0.4-ba89a9e" = _QaiEgNNS;
        "pkg-1.0.4-72c2e56" = _hjwIFUcr;
        "pkg-1.0.4-15dcad8" = _ltLJrBib;
        "pkg-1.0.4-e932bff" = _DpobubzH;
        "pkg-1.0.4-80fba46" = _aDRXSc9i;
        "pkg-1.0.4-f84b64f" = _v4OqO4Ug;
        "pkg-1.0.4-a51727d" = _9Zn58c6X;
        "pkg-1.0.4-0112d6d" = _V9bSyc9T;
        "pkg-1.0.4-9da2b9b" = _o8Ezls3D;
        "pkg-1.0.4-05d225f" = _6VerWnOA;
        "pkg-1.0.4-f8b0df8" = _63oFKrz3;
        "pkg-1.0.4-8bd00ba" = _oMa77eUA;
        "pkg-2.0.0-17bb221" = _JIR90nKy;
        "pkg-2.0.0-7ad8f0b" = _abMVh9u4;
        "pkg-2.0.0-827c5db" = _KDIQs2H2;
        "pkg-2.0.0-548a4b2" = _UH5diOrf;
        "pkg-2.0.0-ee7dcdc" = _n4dMyQy5;
        "pkg-2.0.0-d9048dd" = _gx3nZCDa;
        "pkg-2.0.0-85e73c4" = _IXkhsIIh;
        "pkg-2.0.0-39fe9f5" = _bK0Igiky;
        "pkg-2.0.0-d5a2ef1" = _WzxlgJ9C;
        "pkg-2.0.0-960f401" = _LKFA8tly;
        "pkg-2.0.0-4099bb9" = _DmFImSLs;
        "pkg-2.0.0-04607d5" = _Go62AUXd;
        "pkg-2.0.0-4d03e8f" = _xax9KaVe;
        "pkg-2.0.0-9803aa9" = _mdi6vdQY;
        "pkg-2.0.0-7732dd7" = _ZsRSZQUH;
        "pkg-2.0.0-b640860" = _q3eZozJK;
        "pkg-2.0.0-d9c13e8" = _tB6aE6lt;
        "pkg-2.0.0-5e52bdd" = _ZGlAF22Q;
        "pkg-2.0.0-b495b30" = _mSyYJhQW;
        "pkg-2.0.0-ce9021a" = _mY4FlNDy;
        "pkg-2.0.0-6792539" = _B0XeHl99;
        "pkg-2.0.0-1fc3f42" = _kenoEgoK;
        "pkg-2.0.0-ab071b0" = _8VzctitM;
        "pkg-2.0.0-6bde93c" = _iwsiIFnE;
        "pkg-2.0.0-cc05fd9" = _cr6qSfFH;
        "pkg-2.0.0-b83e804" = _oMM06sBk;
        "pkg-2.0.0-30c840a" = _pJjt7Sle;
        "pkg-2.0.0-9eef917" = _UEBXlvdK;
        "pkg-2.0.0-ee47f71" = _1eIzG94C;
        "pkg-2.0.0-6ccbf7e" = _ClmMlRPX;
        "pkg-2.0.1-SNAPSHOT-5031450" = _BUo0omeu;
        "pkg-2.0.1-SNAPSHOT-36e7c2f" = _kWenZVrO;
        "pkg-2.0.1-SNAPSHOT-f42a6cc" = _upKb4yAd;
        "pkg-2.0.1-SNAPSHOT-d2fc047" = _dDppdnmW;
        "default" = _dDppdnmW;
    });
