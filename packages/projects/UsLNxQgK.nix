...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.2" = _rZjBNQFl;
        "pkg-1.18.2-0.56" = _jBFKtv9y;
        "pkg-1.20.1-1.2.1" = _v6TfzRck;
        "pkg-1.20.1-1.2.2" = _i99hKWi2;
        "pkg-1.21.1-0.1.0" = _iqHzi252;
        "pkg-1.21.1-0.1.1" = _CCoE3y93;
        "pkg-1.21.1-0.2.0" = _LboBwKQ7;
        "pkg-1.21.1-0.2.1" = _NOnkFeiM;
        "pkg-1.21.1-0.2.2" = _feddxdPy;
        "pkg-1.21.1-0.2.3" = _3YKvD6nb;
        "pkg-1.21.1-0.2.4" = _S0Qie1Ip;
        "pkg-1.21.1-0.2.5" = _Eoyfcv1d;
        "pkg-1.21.1-0.2.6" = _WnwpYaCm;
        "pkg-1.21.1-0.2.7" = _1pT4ynxC;
        "pkg-1.21.1-0.3.0" = _WsbSweIb;
        "pkg-1.21.1-0.3.1" = _HLAJOP0k;
        "pkg-1.21.1-0.4.0" = _6peoOcoz;
        "pkg-1.21.1-0.4.1" = _20KaWcaP;
        "pkg-1.21.1-0.4.2" = _JE8d8fN8;
        "pkg-1.21.1-0.4.3" = _w09oQvnP;
        "pkg-1.21.1-0.4.4" = _eJmU8hzH;
        "pkg-1.21.1-0.5.0" = _n8GW0yS0;
        "pkg-1.21.1-0.5.1" = _5dYScDTZ;
        "pkg-1.21.1-0.5.2" = _CbK3prGU;
        "pkg-1.21.1-0.5.3" = _6Jai3siJ;
        "pkg-1.21.1-0.5.4" = _qJTWvjrM;
        "pkg-1.21.1-0.6.0" = _iwcsWI80;
        "pkg-1.21.1-0.6.1" = _BhHtcmio;
        "pkg-1.21.1-0.6.2" = _bbe8r5L3;
        "pkg-1.21.1-0.6.3" = _5EReui7r;
        "pkg-1.21.1-0.6.4" = _WeNUMOHw;
        "pkg-1.21.1-0.6.5" = _5gcGsxyg;
        "pkg-1.21.1-0.6.6" = _Sisu5iZN;
        "pkg-1.21.1-0.6.7" = _6QhyuvOl;
        "pkg-1.21.1-0.6.8" = _N0IRaz3l;
        "pkg-1.21.1-0.6.9" = _JENyfnRR;
        "pkg-1.21.1-0.6.10" = _DbYde1c3;
        "pkg-1.21.1-0.6.11" = _Dx7z78vU;
