...
let
    ...
    in {
        ...
        "pkg-v4.0.1-1.19.2-Forge" = _x89uMNLD;
        "pkg-v4.0.2-1.19.2-Forge" = _vYmFQqpP;
        "pkg-v4.0.2-1.19.2-Fabric" = _E7tue40c;
        "pkg-v4.0.3-1.19.2-Forge" = _F0cqVmMC;
        "pkg-v4.0.3-1.19.2-Fabric" = _h1CD2Sgj;
        "pkg-v5.0.0-1.19.3-Forge" = _536elOMS;
        "pkg-v5.0.0-1.19.3-Fabric" = _aodnrSN6;
        "pkg-v6.0.0-1.19.4-Fabric" = _xMbgUxJR;
        "pkg-v6.0.0-1.19.4-Forge" = _b9MEtkuw;
        "pkg-v7.0.0-1.20-Fabric" = _wrbCCndF;
        "pkg-v7.0.0-1.20-Forge" = _r8rqzOAu;
        "pkg-v8.0.0-1.20.1-Forge" = _QxfztE9X;
        "pkg-v8.0.0-1.20.1-Fabric" = _2qIke0Vz;
        "pkg-v8.0.1-1.20.1-Forge" = _hxhuRoHV;
        "pkg-v8.0.1-1.20.1-Fabric" = _VsqNptEe;
        "pkg-v20.4.0-1.20.4-Fabric" = _zoUAWUPn;
        "pkg-v20.4.0-1.20.4-Forge" = _Zdxb4YZf;
        "pkg-v20.4.0-1.20.4-NeoForge" = _dCw1LB2q;
        "pkg-v20.4.1-1.20.4-Fabric" = _YD0X91zo;
        "pkg-v20.4.1-1.20.4-Forge" = _uOVpm2za;
        "pkg-v20.4.1-1.20.4-NeoForge" = _LUnwEVaL;
        "pkg-v21.0.0-1.21-Fabric" = _446XXBbA;
        "pkg-v21.0.0-1.21-NeoForge" = _o2nlTZUv;
        "pkg-v21.1.0-1.21.1-Fabric" = _CvPUjtHD;
        "pkg-v21.1.0-1.21.1-NeoForge" = _LGDlN6hn;
        "pkg-v21.1.1-1.21.1-Fabric" = _9BnvDBto;
        "pkg-v21.1.1-1.21.1-NeoForge" = _nn8PJyYj;
        "pkg-v21.3.0-1.21.3-Fabric" = _jOn0Ugfs;
        "pkg-v21.3.0-1.21.3-NeoForge" = _UQiC48LF;
        "pkg-v21.4.0-1.21.4-Fabric" = _YTzGDFDV;
        "pkg-v21.4.0-1.21.4-NeoForge" = _PI0zG6Xe;
        "pkg-v21.5.0-1.21.5-Fabric" = _3T9KmJFo;
        "pkg-v21.5.0-1.21.5-NeoForge" = _ZYRLRo8s;
        "pkg-v21.6.0-1.21.6-Fabric" = _CFBQk9Wl;
        "pkg-v21.6.0-1.21.6-NeoForge" = _kU8kSlT1;
        "pkg-v21.7.0-1.21.7-Fabric" = _twigBT6M;
        "pkg-v21.7.0-1.21.7-NeoForge" = _BL2LqEAw;
        "pkg-v21.8.0-1.21.8-Fabric" = _E5GhQtjE;
        "pkg-v21.8.0-1.21.8-NeoForge" = _P1eRlQ2D;
        "pkg-21.9.0" = _y0LDTmEG;
        "pkg-21.10.0" = _Yq2yFzYA;
