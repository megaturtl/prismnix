...
let
    versions = (let
        ...
        _sc9MMar9 = {
            "id" = "sc9MMar9";
            "file" = "immersiveenchanting-6.0.1-neoforge-26.1.2.jar";
            "hash" = "sha512-vIPQnl3SaCGzwg4lGfWRvBglB3wVBdyTRb6Nkt2+yh7Q2eFISfMVojGK1C/CiXwdXtl3fVubYVFPFYfcv+RwFQ==";
        };
    in {
        "BW8xfQt8" = _BW8xfQt8;
        "1qAfK45Z" = _1qAfK45Z;
