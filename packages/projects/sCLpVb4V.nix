...
let
    versions = (let
        ...
        _k9F2Zehw = {
            "id" = "k9F2Zehw";
            "file" = "stairstoblocks-1.18.2-fabric-0.1.jar";
            "hash" = "sha512-9l91Mfn2+ufJu7+5rDeYU6XDsS2t3bsWEq9TYIrcjoVaCVSfIcQcZv86+g0K9VHv1GZ5vjltk3mfYiGYts1eGg==";
        };
        _3OxYsbku = {
            "id" = "3OxYsbku";
            "file" = "stairstoblocks-1.18.2-forge-0.1.jar";
            "hash" = "sha512-1jxENo7uBc/42384qKCVD7W53v1BLoUPl3Rso2slTaDnZnZ23iI8GVlJQQZXYKmszE6+/s1m1qvF2ybwmH7E2w==";
        };
        _hNCqztdB = {
            "id" = "hNCqztdB";
            "file" = "stairstoblocks-1.19.2-fabric-0.1.jar";
            "hash" = "sha512-MKZyMnpuNk2NAu/hxZali+BVEPlVZrq+Kc+IOqKQE2WMZFqOBJyatZ9DewuAyBL7aZOIEXOYd8D1AaOJDH47Og==";
        };
        _fbkYFiPs = {
            "id" = "fbkYFiPs";
            "file" = "stairstoblocks-1.19.2-forge-0.1.jar";
            "hash" = "sha512-bjDkYifAdXzWsbprYQE0PfFRG1ElcdZ6T5UCF+zzLqsAwGRBhswqrr//t77+KflsyUCK1pBhvLE+00ydyZhiNQ==";
        };
        _U8kQDL6d = {
            "id" = "U8kQDL6d";
            "file" = "stairstoblocks-1.20.1-fabric-0.1.jar";
            "hash" = "sha512-7qYbmrWGgY+96UxPTAVvmQnAaf9PZLOt6lTGpOh1EPnzykmPNPXxXB6wYgF4j+GlX5j73OOUVpsYvlwIWmsmfA==";
        };
        _noVYSEp4 = {
            "id" = "noVYSEp4";
            "file" = "stairstoblocks-1.20.1-forge-0.1.jar";
            "hash" = "sha512-npSHEYxUvnmT1lZV7ACAw8CXW6567Zq16Vb/KX6cBReOUPbqR40iQ34rjH5927GvB9RW1oos4ECd34Rrm2N3Mg==";
        };
        _BVGAgA5U = {
            "id" = "BVGAgA5U";
            "file" = "stairstoblocks-1.21.1-fabric-0.1.jar";
            "hash" = "sha512-pnPikj+NjrNU5Yni8BfKKf0j8PCi2C1fERdaEWQUOcdnC5jpsl8cYkyL9rlU+AMdQ5gKaL/S2UviNp5zZ7G9nQ==";
        };
        _KG0fF6VQ = {
            "id" = "KG0fF6VQ";
            "file" = "stairstoblocks-1.21.1-forge-0.1.jar";
            "hash" = "sha512-5B0kJrmeIF306fz77Vz9duhwZVk4C7f1cwHoi0FShrPxPZLU1biB2q8+RlmlYzI1LqcYmcvtPhBbv8+bWwxnUA==";
        };
        _SuSCRQzZ = {
            "id" = "SuSCRQzZ";
            "file" = "stairstoblocks-1.21.1-neoforge-0.1.jar";
            "hash" = "sha512-bY8FVoRRKffccCfzmmgtJdPhVE6Xs+MFtES1Jnq5pYVkZLDyBM6RK77+DdKvqRW/WgOSsx8VHuuKjM37UNR/Xg==";
        };
        _jOSAb4kz = {
            "id" = "jOSAb4kz";
            "file" = "stairstoblocks-26.1.2-fabric-0.1.jar";
            "hash" = "sha512-60/4JfKlOp17BprFOh5GGH26xORmN9TqnXlR0VXGBvZQ00zU0gjkTrFRdj6Qk0oSyNxZBNVQUsbFK7QKB7l2jA==";
        };
        _JmZJl3dI = {
            "id" = "JmZJl3dI";
            "file" = "stairstoblocks-26.1.2-forge-0.1.jar";
            "hash" = "sha512-uUow532z5DXgKh5jkUCU0FhW2hx24JLYxqCT99CNFJxyPfEBYf+3GyimTU+5P5L1LgruBCSEmoPSrMw7g+/UAg==";
        };
        _kANQznzu = {
            "id" = "kANQznzu";
            "file" = "stairstoblocks-26.1.2-neoforge-0.1.jar";
            "hash" = "sha512-hXpcYIXKvXeA88nZCbO4JfU9ag7eYQFZ/j3IKQ73VyHPFyEVqPOklHKm0FhCl9AsO2aRcaTWVTwgRZp1R2yZ5Q==";
        };
        _wzr88oeX = {
            "id" = "wzr88oeX";
            "file" = "stairstoblocks-26.2-fabric-0.1.jar";
            "hash" = "sha512-dC6eu8RuRhwi2L+ILxk0RqhbITxDn9AjlW/BSgGXJI0PK8bEaSIxKz2SB+AM9C+l6dfrCmosh8ZrBQpHsUqN+w==";
        };
        _qsC2iDfr = {
            "id" = "qsC2iDfr";
            "file" = "stairstoblocks-26.2-forge-0.1.jar";
            "hash" = "sha512-6YD1DB6LeCtjEkzJfO2WVohhp+HS/rbWf+OxvxApmLnpAJXuVcb5AgCD+j7R8MPyg/F7mK6LPAj9doXrYMYeIw==";
        };
        _5oZ80E6q = {
            "id" = "5oZ80E6q";
            "file" = "stairstoblocks-26.2-neoforge-0.1.jar";
            "hash" = "sha512-oLfjQT4Ge+apIec1UI/OoEmFOSMe7x/FITu8oWH6a5Z5jOfv6zGvk/Qb8veN6Rx2MdoGhAxPgPmCldkSH+Thog==";
        };
    in {
        "DFQYk6me" = _DFQYk6me;
        "caPc0j3K" = _caPc0j3K;
        ...
        "qsC2iDfr" = _qsC2iDfr;
        "5oZ80E6q" = _5oZ80E6q;
        "fabric-1.18" = _k9F2Zehw;
        "fabric-1.18.1" = _k9F2Zehw;
        "fabric-1.18.2" = _k9F2Zehw;
        "fabric-1.19.2" = _hNCqztdB;
        "fabric-1.19.4" = _u8FISkuu;
        "fabric-1.20" = _U8kQDL6d;
        "fabric-1.20.1" = _U8kQDL6d;
        "fabric-1.20.2" = _V7Quhicw;
        "fabric-1.20.3" = _BI1gWm3o;
        "fabric-1.20.4" = _BI1gWm3o;
        "fabric-1.20.5" = _yQvwWoZF;
        "fabric-1.20.6" = _yQvwWoZF;
        "fabric-1.21" = _BVGAgA5U;
        "fabric-1.21.1" = _BVGAgA5U;
        ...
        "fabric-26.1" = _jOSAb4kz;
        "fabric-26.1.1" = _jOSAb4kz;
        "fabric-26.1.2" = _jOSAb4kz;
        "fabric-1.19" = _hNCqztdB;
        "fabric-1.19.1" = _hNCqztdB;
        "fabric-26.2" = _wzr88oeX;
        "quilt-1.18" = _k9F2Zehw;
        "quilt-1.18.1" = _k9F2Zehw;
        "quilt-1.18.2" = _k9F2Zehw;
        "quilt-1.19.2" = _hNCqztdB;
        "quilt-1.19.4" = _u8FISkuu;
        "quilt-1.20" = _U8kQDL6d;
        "quilt-1.20.1" = _U8kQDL6d;
        "quilt-1.20.2" = _V7Quhicw;
        "quilt-1.20.3" = _BI1gWm3o;
        "quilt-1.20.4" = _BI1gWm3o;
        "quilt-1.20.5" = _yQvwWoZF;
        "quilt-1.20.6" = _yQvwWoZF;
        "quilt-1.21" = _BVGAgA5U;
        "quilt-1.21.1" = _BVGAgA5U;
        ...
        "quilt-26.1" = _jOSAb4kz;
        "quilt-26.1.1" = _jOSAb4kz;
        "quilt-26.1.2" = _jOSAb4kz;
        "quilt-1.19" = _hNCqztdB;
        "quilt-1.19.1" = _hNCqztdB;
        "quilt-26.2" = _wzr88oeX;
        "forge-1.18" = _3OxYsbku;
        "forge-1.18.1" = _3OxYsbku;
        "forge-1.18.2" = _3OxYsbku;
        "forge-1.19" = _fbkYFiPs;
        "forge-1.19.1" = _fbkYFiPs;
        "forge-1.19.2" = _fbkYFiPs;
        "forge-1.19.4" = _nthnPHLT;
        "forge-1.20" = _noVYSEp4;
        "forge-1.20.1" = _noVYSEp4;
        "forge-1.20.2" = _14o5TobP;
        "forge-1.20.3" = _h61e5b4d;
        "forge-1.20.4" = _h61e5b4d;
        "forge-1.20.5" = _u9KTzJia;
        "forge-1.20.6" = _u9KTzJia;
        "forge-1.21" = _KG0fF6VQ;
        "forge-1.21.1" = _KG0fF6VQ;
        ...
        "forge-26.1" = _JmZJl3dI;
        "forge-26.1.1" = _JmZJl3dI;
        "forge-26.1.2" = _JmZJl3dI;
        "forge-26.2" = _qsC2iDfr;
        "neoforge-1.20" = _noVYSEp4;
        "neoforge-1.20.1" = _noVYSEp4;
        "neoforge-1.20.5" = _k45Z2ZQf;
        "neoforge-1.20.6" = _k45Z2ZQf;
        "neoforge-1.21" = _SuSCRQzZ;
        "neoforge-1.21.1" = _SuSCRQzZ;
        ...
        "neoforge-26.1" = _kANQznzu;
        "neoforge-26.1.1" = _kANQznzu;
        "neoforge-26.1.2" = _kANQznzu;
        "neoforge-26.2" = _5oZ80E6q;
        "pkg-1.18.2-fabric-0" = _DFQYk6me;
        "pkg-1.18.2-forge-0" = _caPc0j3K;
        "pkg-1.19.2-fabric-0" = _rToYTn9Y;
        "pkg-1.19.2-forge-0" = _PDswBbzE;
        "pkg-1.19.4-fabric-0" = _u8FISkuu;
        "pkg-1.19.4-forge-0" = _nthnPHLT;
        "pkg-1.20.1-fabric-0" = _7aOdbvT1;
        "pkg-1.20.1-forge-0" = _7eegdFHz;
        "pkg-1.20.2-fabric-0" = _V7Quhicw;
        "pkg-1.20.2-forge-0" = _14o5TobP;
        "pkg-1.20.4-fabric-0" = _BI1gWm3o;
        "pkg-1.20.4-forge-0" = _h61e5b4d;
        "pkg-1.20.6-fabric-0" = _yQvwWoZF;
        "pkg-1.20.6-forge-0" = _u9KTzJia;
        "pkg-1.20.6-neoforge-0" = _k45Z2ZQf;
        "pkg-1.21.1-fabric-0" = _eVaioZf0;
        "pkg-1.21.1-forge-0" = _8TeFJtsQ;
        "pkg-1.21.1-neoforge-0" = _tE0y3vZN;
        "pkg-1.21.3-fabric-0" = _72J1h8Lr;
        "pkg-1.21.3-forge-0" = _XEsHXnia;
        "pkg-1.21.3-neoforge-0" = _zz3kbvoL;
        "pkg-1.21.4-fabric-0" = _RwL5fBCX;
        "pkg-1.21.4-forge-0" = _C03byuSW;
        "pkg-1.21.4-neoforge-0" = _AGcVLEJg;
        "pkg-1.21.5-fabric-0" = _3erqHMQC;
        "pkg-1.21.5-forge-0" = _QJj6rs8W;
        "pkg-1.21.5-neoforge-0" = _Y5KAIulJ;
        "pkg-1.21.7-fabric-0" = _bDUbUCaD;
        "pkg-1.21.7-forge-0" = _E2U4Gw8Z;
        "pkg-1.21.7-neoforge-0" = _2paa8sTD;
        "pkg-1.21.8-fabric-0" = _lgl33iO1;
        "pkg-1.21.8-forge-0" = _USEqtfyq;
        "pkg-1.21.8-neoforge-0" = _ln3z0OOy;
        "pkg-1.21.9-fabric-0" = _VOh6n4mr;
        "pkg-1.21.9-forge-0" = _ZnddI82L;
        "pkg-1.21.9-neoforge-0" = _7sY1rXXZ;
        "pkg-1.21.10-fabric-0" = _l3P6CWO4;
        "pkg-1.21.10-forge-0" = _JJM9Z78z;
        "pkg-1.21.10-neoforge-0" = _XtmNTH23;
        "pkg-1.21.11-fabric-0" = _LdEIN6mI;
        "pkg-1.21.11-forge-0" = _trRz9a9i;
        "pkg-1.21.11-neoforge-0" = _PnhCWK7t;
        "pkg-26.1.1-fabric-0" = _sXaiGqyM;
        "pkg-26.1.1-forge-0" = _MwSWMXZ9;
        "pkg-26.1.1-neoforge-0" = _jBHbMTF1;
        "pkg-26.1.2-fabric-0" = _YanAGlLJ;
        "pkg-26.1.2-forge-0" = _iypfYE0j;
        "pkg-26.1.2-neoforge-0" = _xAVIBzZ8;
        "pkg-1.18.2-fabric-0.1" = _k9F2Zehw;
        "pkg-1.18.2-forge-0.1" = _3OxYsbku;
        "pkg-1.19.2-fabric-0.1" = _hNCqztdB;
        "pkg-1.19.2-forge-0.1" = _fbkYFiPs;
        "pkg-1.20.1-fabric-0.1" = _U8kQDL6d;
        "pkg-1.20.1-forge-0.1" = _noVYSEp4;
        "pkg-1.21.1-fabric-0.1" = _BVGAgA5U;
        "pkg-1.21.1-forge-0.1" = _KG0fF6VQ;
        "pkg-1.21.1-neoforge-0.1" = _SuSCRQzZ;
        "pkg-26.1.2-fabric-0.1" = _jOSAb4kz;
        "pkg-26.1.2-forge-0.1" = _JmZJl3dI;
        "pkg-26.1.2-neoforge-0.1" = _kANQznzu;
        "pkg-26.2-fabric-0.1" = _wzr88oeX;
        "pkg-26.2-forge-0.1" = _qsC2iDfr;
        "pkg-26.2-neoforge-0.1" = _5oZ80E6q;
        "default" = _5oZ80E6q;
    });
