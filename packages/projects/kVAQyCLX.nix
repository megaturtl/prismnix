...
let
    ...
    in {
        ...
        "pkg-1.9.0" = _xECdvSQt;
        "pkg-1.9.1" = _ExrhFAJb;
        "pkg-1.10.0" = _U8TrJn9K;
        "pkg-1.10.1" = _H4c9m6Df;
        "pkg-1.10.2" = _RMUYUbRe;
        "pkg-1.11.0" = _7XiJOr6R;
        "pkg-1.11.1" = _v4LSkn6M;
        "pkg-1.11.2" = _rVZmEExQ;
        "pkg-1.11.3" = _qLnjniwB;
        "pkg-1.12.0" = _3ip4E9ol;
        "pkg-1.13.0" = _2iveOP38;
        "pkg-1.13.1" = _2Jo2YUCS;
        "pkg-1.13.2" = _RxHlIQLp;
        "pkg-1.13.3" = _sqBvKQjt;
        "pkg-1.13.4" = _lQIE6dmb;
        "pkg-1.13.5" = _mEZxcGmj;
        "pkg-1.13.6" = _q0HlyqoE;
        "pkg-1.13.7" = _SYxvA2Pc;
        "pkg-1.13.8" = _rpmWEOoI;
        "pkg-1.13.9" = _6mnYTAMQ;
