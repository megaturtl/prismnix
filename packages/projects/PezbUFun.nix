...
let
    ...
    in {
        ...
        "pkg-20.1.3" = _s3iFPQ1R;
        "pkg-21.1.3" = _g0cagwlZ;
        "pkg-20.1.4" = _EBmnGhcD;
        "pkg-20.1.5" = _7j6r0ked;
        "pkg-21.1.5" = _Lxbnp8DP;
        "pkg-20.2.1" = _jqPMEoCa;
        "pkg-21.2.1" = _fC7FaqaY;
        "pkg-21.2.2-1.21.1" = _6vGV4EY9;
        "pkg-20.2.2-1.20.1" = _ZeL9tyAx;
        "pkg-21.2.3-1.21.1" = _uz02ra1l;
        "pkg-20.2.3-1.20.1" = _lm0cPKf8;
        "pkg-21.2.4-1.21.1" = _2qxuUxvS;
        "pkg-20.2.4-1.20.1" = _KOIdjYwV;
        "pkg-21.2.5-1.21.1" = _BuMzoYX7;
        "pkg-20.2.5-1.20.1" = _g3AGNdVS;
        "pkg-21.2.6-1.21.1" = _BhY75CJB;
        "pkg-21.3.1-1.21.1" = _ohPR33fY;
        "pkg-20.2.6-1.20.1" = _fK3ENZZB;
        "pkg-21.3.2-1.21.1" = _kW4bdi3K;
