...
let
    ...
    in {
        ...
        "pkg-1.21.1-1.0.1" = _bMwxBAZy;
        "pkg-1.20.1-1.0.2" = _FPYSRrdq;
        "pkg-1.21.1-1.0.2" = _sRMMFgei;
        "pkg-1.20.1-1.1.0" = _VwY0d2aP;
        "pkg-1.21.1-1.1.0" = _2K9JED9J;
        "pkg-26.1.2-2.0.0" = _W72V7EWO;
