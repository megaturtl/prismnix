...
let
    versions = (let
        ...
        _kfEoAbya = {
            "id" = "kfEoAbya";
            "file" = "misctweaks-neoforge-1.4.2+26.2.jar";
            "hash" = "sha512-FOXIZ2TJ7lpsZ8BlCngkTAFBLLbCMC47zWx1b4sbyHxYIrMVu+moK2pcMnbFf/wx34YKNM/8YNEfXMeX3My7aQ==";
        };
        _xUVQIRB4 = {
            "id" = "xUVQIRB4";
            "file" = "misctweaks-neoforge-1.4.2+1.21.1.jar";
            "hash" = "sha512-n23hiAAjWIrCmi8f94YTDfQCGzUIBU2T7ayxoaMJUaHzGdHrZETLnhpQ0CmxnoXypVoi8urdfafi73KYR8OpOQ==";
        };
        _P92dFsEN = {
            "id" = "P92dFsEN";
            "file" = "misctweaks-neoforge-1.4.2+26.1.2.jar";
            "hash" = "sha512-zk18oJaywZcTCuOG/mQ+seetLeq7PAxdEsIvbwksw5SWg7f33B5w2mFiF5tMvplg0tPQQl9GMPPXrbi32MR6Kw==";
        };
        _33nKJJQH = {
            "id" = "33nKJJQH";
            "file" = "misctweaks-fabric-1.4.2+26.2.jar";
            "hash" = "sha512-LVLL62V96li/iXHCVy2ueoPHZtHYoqlR+x1j/Uw+OyJwPunOxoEtPApxxdb2j5pJgKB/bAiE7JMczz4fOuqB3w==";
        };
        _LiQlbuj3 = {
            "id" = "LiQlbuj3";
            "file" = "misctweaks-fabric-1.4.2+1.21.1.jar";
            "hash" = "sha512-NThzLX+m76rsv1j7OEGTefkF87MXNujSKPOfGCXXO/+Ep2sVd3RHXuFOXXO6Ybwm+j1lom+Z+ouesFKW2PkKhw==";
        };
        _HxHgV8h2 = {
            "id" = "HxHgV8h2";
            "file" = "misctweaks-fabric-1.4.2+26.1.2.jar";
            "hash" = "sha512-Hwpyxfc37wfZNOEgLXuM+zAS8+7ryF8F3ep9DLXeXsIdy8EEm0eRINQnWkO/v6bEGFP9svISr6e0SS6i8rAajg==";
        };
        _3cL2qGhr = {
            "id" = "3cL2qGhr";
            "file" = "misctweaks-fabric-1.4.3+1.21.1.jar";
            "hash" = "sha512-SYOv5SG1RakSPvEmpu8cbfkx5ZshRctCeuBkDI6XYszs7/xWwIz7FD4AcyskuFLTpVT+P6PnMGF0cfDtAGh+Ww==";
        };
        _juaT3mXf = {
            "id" = "juaT3mXf";
    ...
    in {
        ...
        "pkg-1.1.0+1.21.1" = _bs2TvqE5;
        "pkg-1.1.0+1.21.4" = _x2mqAZnb;
        "pkg-1.1.1+1.21.1" = _TnDm5NEQ;
        "pkg-1.1.1+1.21.4" = _Cy1BhMhx;
        "pkg-1.1.2+1.21.1" = _eqBHkigs;
        "pkg-1.1.2+1.21.4" = _wjkwXIMg;
        "pkg-1.1.2+1.20.1" = _CoqZaK3p;
        "pkg-1.1.2+1.21.5" = _K1m2Ov4h;
        "pkg-1.2.0+1.20.1" = _9ldsdTu4;
        "pkg-1.2.0+1.21.1" = _SZaOjvBQ;
        "pkg-1.2.0+1.21.4" = _Y9a654WS;
        "pkg-1.2.0+1.21.5" = _hsr9QMhn;
        "pkg-1.2.1+1.20.1" = _THckbFbG;
        "pkg-1.2.1+1.21.7" = _FNlBZPyI;
        "pkg-1.2.1+1.21.1" = _znTAtZha;
        "pkg-1.2.1+1.21.4" = _IcT6eaA9;
        "pkg-1.2.1+1.21.5" = _Zl6DuWqJ;
        "pkg-1.2.2+1.21.8" = _7fXredYF;
        "pkg-1.2.2+1.20.1" = _YRmuOF9h;
        "pkg-1.2.2+1.21.4" = _3Wfk9lFC;
        "pkg-1.2.2+1.21.1" = _Lh9ZD1Ih;
        "pkg-1.2.3+1.20.1" = _5fZOCEaH;
        "pkg-1.2.3+1.21.1" = _3OyzwMzN;
        "pkg-1.2.3+1.21.8" = _FKfOs0sq;
        "pkg-1.2.3+1.21.4" = _f7GwQAQh;
        "pkg-1.1.3+1.20.1" = _S3QJO6jS;
        "pkg-1.2.4+1.21.1" = _Jdo2aVsh;
        "pkg-1.2.4+1.21.4" = _dM148Ixj;
        "pkg-1.2.4+1.21.8" = _Az66TreD;
        "pkg-1.2.4+1.20.1" = _lqbj1Ps8;
        "pkg-1.1.4+1.20.1" = _5wBnIliX;
        "pkg-1.2.4+1.21.10" = _fRyXwz6T;
        "pkg-1.2.5+1.20.1-fabric" = _2o0czxIi;
        "pkg-1.2.5+1.21.1-neoforge" = _WJmEFwQ9;
        "pkg-1.2.5+1.21.1-fabric" = _hFdG8AXT;
        "pkg-1.2.5+1.21.10-fabric" = _FGljw2fS;
        "pkg-1.2.5+1.21.10-neoforge" = _g6gMZzJy;
        "pkg-1.2.6+1.20.1-fabric" = _DUVU7U68;
        "pkg-1.2.7+1.20.1-fabric" = _ftE2YkFR;
        "pkg-1.2.7+1.21.1-fabric" = _yDNR7ayE;
        "pkg-1.2.7+1.21.1-neoforge" = _jGE2o08Q;
        "pkg-1.2.7+1.21.10-neoforge" = _j70zgbFJ;
        "pkg-1.2.7+1.21.10-fabric" = _qIpfIPFM;
        "pkg-1.2.8+1.21.11-neoforge" = _J73jyqsl;
        "pkg-1.2.8+1.21.11-fabric" = _1qZJ4hB2;
        "pkg-1.2.8+1.20.1-fabric" = _kaph6zIt;
        "pkg-1.2.9+1.20.1-fabric" = _tBPZHkqR;
        "pkg-1.3.0+1.21.1-neoforge" = _Wc7PcPvx;
        "pkg-1.3.0+1.21.11-neoforge" = _tifNJqU0;
        "pkg-1.3.0+1.21.1-fabric" = _gX9OKdA1;
        "pkg-1.3.0+1.21.11-fabric" = _myDtKEm4;
        "pkg-1.3.1+26.1-fabric" = _YKvQMWna;
        "pkg-1.3.1+26.1-neoforge" = _ByGVr3D9;
        "pkg-1.3.2+26.1-neoforge" = _cVDp4jsv;
        "pkg-1.3.2+26.1-fabric" = _J7krLt8T;
        "pkg-1.4.0+26.1.2-neoforge" = _ONYX4WeH;
        "pkg-1.4.0+26.1.2-fabric" = _d11eqjLe;
        "pkg-1.4.1+26.1.2-neoforge" = _N9aYOmOC;
        "pkg-1.4.1+26.1.2-fabric" = _tZ5tY9Nr;
        "pkg-1.4.1+26.2-fabric" = _c74KDDZR;
        "pkg-1.4.2+26.2" = _33nKJJQH;
