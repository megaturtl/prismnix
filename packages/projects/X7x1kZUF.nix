...
let
    versions = (let
        ...
        _6hPTLPVm = {
            "id" = "6hPTLPVm";
            "file" = "view-distance-tweaks-2.11.3-RELEASE.jar";
            "hash" = "sha512-yALHVTFcOgKsFEoUz0FZNWrDwD3CY2N3Vf297YXgqfaPSI9PBci0GuGAFoL2P+4LWJrc0FFBfMDcNc0LGqm7/A==";
        };
        _CEouxLzu = {
            "id" = "CEouxLzu";
            "file" = "view-distance-tweaks-2.11.4-RELEASE.jar";
            "hash" = "sha512-AWFBjq9ohIJIsNyUW+Ick7GcRV/svi1Va6IOn44v+B4UrjzUGPgBAnnfR324qvT4nhPHU/4hUn+rtkWLE1ypyA==";
        };
        _clro50F3 = {
            "id" = "clro50F3";
            "file" = "view-distance-tweaks-2.11.5-RELEASE.jar";
            "hash" = "sha512-d0VQTwYjzEticbenjXjm3ZHK+85y+959Ydph/VKGwAO+O9fD6w8p/hxhQbg70RkuGa7hA/Wn5ENursqTmdMRRA==";
        };
        _ZGzV3QW4 = {
            "id" = "ZGzV3QW4";
            "file" = "view-distance-tweaks-2.11.6-RELEASE.jar";
            "hash" = "sha512-5fvsW/0lZ1MzVe0iXE5rihGzCZkK9TWrvpKsG+nRK5QbRFIzjXRvFCoBvhO8Rlt98Mc7870iRVgPL5GQwc9gZw==";
        };
    in {
        "HGHxCDAY" = _HGHxCDAY;
        "EZETV57Q" = _EZETV57Q;
        ...
        "clro50F3" = _clro50F3;
        "ZGzV3QW4" = _ZGzV3QW4;
        "bukkit-1.21" = _ZGzV3QW4;
        "bukkit-1.21.1" = _ZGzV3QW4;
        "bukkit-1.21.2" = _ZGzV3QW4;
        "bukkit-1.21.3" = _ZGzV3QW4;
        "bukkit-1.21.4" = _ZGzV3QW4;
        "bukkit-1.21.5" = _ZGzV3QW4;
        "bukkit-1.21.6" = _ZGzV3QW4;
        "bukkit-1.21.7" = _ZGzV3QW4;
        "bukkit-1.21.8" = _ZGzV3QW4;
        "bukkit-1.21.9" = _ZGzV3QW4;
        "bukkit-1.21.10" = _ZGzV3QW4;
        "bukkit-1.21.11" = _ZGzV3QW4;
        "bukkit-26.1" = _ZGzV3QW4;
        "bukkit-26.1.1" = _ZGzV3QW4;
        "bukkit-26.1.2" = _ZGzV3QW4;
        "bukkit-26.2" = _ZGzV3QW4;
        "bukkit-26.3" = _ZGzV3QW4;
        "paper-1.21" = _ZGzV3QW4;
        "paper-1.21.1" = _ZGzV3QW4;
        "paper-1.21.2" = _ZGzV3QW4;
        "paper-1.21.3" = _ZGzV3QW4;
        "paper-1.21.4" = _ZGzV3QW4;
        "paper-1.21.5" = _ZGzV3QW4;
        "paper-1.21.6" = _ZGzV3QW4;
        "paper-1.21.7" = _ZGzV3QW4;
        "paper-1.21.8" = _ZGzV3QW4;
        "paper-1.21.9" = _ZGzV3QW4;
        "paper-1.21.10" = _ZGzV3QW4;
        "paper-1.21.11" = _ZGzV3QW4;
        "paper-26.1" = _ZGzV3QW4;
        "paper-26.1.1" = _ZGzV3QW4;
        "paper-26.1.2" = _ZGzV3QW4;
        "paper-26.2" = _ZGzV3QW4;
        "paper-26.3" = _ZGzV3QW4;
        "spigot-1.21" = _ZGzV3QW4;
        "spigot-1.21.1" = _ZGzV3QW4;
        "spigot-1.21.2" = _ZGzV3QW4;
        "spigot-1.21.3" = _ZGzV3QW4;
        "spigot-1.21.4" = _ZGzV3QW4;
        "spigot-1.21.5" = _ZGzV3QW4;
        "spigot-1.21.6" = _ZGzV3QW4;
        "spigot-1.21.7" = _ZGzV3QW4;
        "spigot-1.21.8" = _ZGzV3QW4;
        "spigot-1.21.9" = _ZGzV3QW4;
        "spigot-1.21.10" = _ZGzV3QW4;
        "spigot-1.21.11" = _ZGzV3QW4;
        "spigot-26.1" = _ZGzV3QW4;
        "spigot-26.1.1" = _ZGzV3QW4;
        "spigot-26.1.2" = _ZGzV3QW4;
        "spigot-26.2" = _ZGzV3QW4;
        "spigot-26.3" = _ZGzV3QW4;
        "purpur-1.21" = _ZGzV3QW4;
        "purpur-1.21.1" = _ZGzV3QW4;
        "purpur-1.21.2" = _ZGzV3QW4;
        "purpur-1.21.3" = _ZGzV3QW4;
        "purpur-1.21.4" = _ZGzV3QW4;
        "purpur-1.21.5" = _ZGzV3QW4;
        "purpur-1.21.6" = _ZGzV3QW4;
        "purpur-1.21.7" = _ZGzV3QW4;
        "purpur-1.21.8" = _ZGzV3QW4;
        "purpur-1.21.9" = _ZGzV3QW4;
        "purpur-1.21.10" = _ZGzV3QW4;
        "purpur-1.21.11" = _ZGzV3QW4;
        "purpur-26.1" = _ZGzV3QW4;
        "purpur-26.1.1" = _ZGzV3QW4;
        "purpur-26.1.2" = _ZGzV3QW4;
        "purpur-26.2" = _ZGzV3QW4;
        "purpur-26.3" = _ZGzV3QW4;
        "folia-1.21" = _ZGzV3QW4;
        "folia-1.21.1" = _ZGzV3QW4;
        "folia-1.21.2" = _ZGzV3QW4;
        "folia-1.21.3" = _ZGzV3QW4;
        "folia-1.21.4" = _ZGzV3QW4;
        "folia-1.21.5" = _ZGzV3QW4;
        "folia-1.21.6" = _ZGzV3QW4;
        "folia-1.21.7" = _ZGzV3QW4;
        "folia-1.21.8" = _ZGzV3QW4;
        "folia-1.21.9" = _ZGzV3QW4;
        "folia-1.21.10" = _ZGzV3QW4;
        "folia-1.21.11" = _ZGzV3QW4;
        "folia-26.1" = _ZGzV3QW4;
        "folia-26.1.1" = _ZGzV3QW4;
        "folia-26.1.2" = _ZGzV3QW4;
        "folia-26.2" = _ZGzV3QW4;
        "folia-26.3" = _ZGzV3QW4;
        ...
        "pkg-2.11.3-RELEASE" = _6hPTLPVm;
        "pkg-2.11.4-RELEASE" = _CEouxLzu;
        "pkg-2.11.5-RELEASE" = _clro50F3;
        "pkg-2.11.6-RELEASE" = _ZGzV3QW4;
        "default" = _ZGzV3QW4;
    });
