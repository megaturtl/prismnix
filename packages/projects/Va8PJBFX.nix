...
let
    ...
    in {
        ...
        "pkg-1.3.5" = _Y7rNAruy;
        "pkg-1.3.6" = _RpoRgNnx;
        "pkg-1.3.7+26.1-fabric" = _EPT9LzJa;
        "pkg-1.3.7+1.20.1-fabric" = _TiHjVb1c;
        "pkg-1.3.8-fabric+1.20.1" = _u7FyypwR;
        "pkg-1.3.8-forge+1.20.1" = _PJWr63qK;
        "pkg-1.3.9-fabric+26.2" = _5aJoWCcp;
        "pkg-1.4.0-alpha.1-neoforge+1.21.11" = _SZf3CIeC;
        "pkg-1.4.0-alpha.1-fabric+1.21.11" = _bgpLxfvV;
        "pkg-1.4.0-alpha.1-neoforge+26.1" = _eyEOHLxF;
        "pkg-1.4.0-alpha.1-fabric+26.1" = _b1QVLq7V;
        "pkg-1.4.0-alpha.1-fabric+26.2" = _wHTp69Ll;
        "pkg-1.4.0-alpha.2-neoforge+26.1" = _gSOJ0AG4;
        "pkg-1.4.0-alpha.2-neoforge+1.21.11" = _rHP0M2UW;
        "pkg-1.4.0-alpha.3-fabric+1.21.11" = _jAG9jQmS;
        "pkg-1.4.0-alpha.3-fabric+26.1" = _Hdfh1n9Z;
        "pkg-1.4.0-alpha.3-neoforge+26.2" = _EsbzdWcy;
        "pkg-1.4.0-alpha.3-fabric+26.2" = _j6rbYLiT;
        "pkg-1.4.0-alpha.4-fabric+26.1" = _VOWPqRuK;
        "pkg-1.4.0-alpha.4-fabric+1.21.11" = _e5ZPKfY7;
        "pkg-1.4.0-alpha.4-neoforge+1.21.11" = _AUEKmIJ9;
