...
let
    versions = (let
        ...
        _i5pqQE7w = {
            "id" = "i5pqQE7w";
            "file" = "AntiRedstoneLag-26.2.jar";
            "hash" = "sha512-MPE+sIzIoqNy8kwUGCHWe13GkS10Ml1r5qNJiQhR0M3qtWwTEaNoyof9um59loPnuJweRIIgDL9VM59LljBqlA==";
        };
    in {
        "tdA7fL3I" = _tdA7fL3I;
        "QYkzaZVA" = _QYkzaZVA;
        ...
        "paper-1.21.6" = _i5pqQE7w;
        "paper-1.21.7" = _i5pqQE7w;
        "paper-1.21.8" = _i5pqQE7w;
        "paper-1.21.9" = _i5pqQE7w;
        "paper-1.21.10" = _i5pqQE7w;
        "paper-1.21.11" = _i5pqQE7w;
        "paper-26.1" = _i5pqQE7w;
        "paper-26.1.1" = _i5pqQE7w;
        "paper-26.1.2" = _i5pqQE7w;
        "paper-26.2" = _i5pqQE7w;
        ...
        "purpur-1.21.6" = _i5pqQE7w;
        "purpur-1.21.7" = _i5pqQE7w;
        "purpur-1.21.8" = _i5pqQE7w;
        "purpur-1.21.9" = _i5pqQE7w;
        "purpur-1.21.10" = _i5pqQE7w;
        "purpur-1.21.11" = _i5pqQE7w;
        "purpur-26.1" = _i5pqQE7w;
        "purpur-26.1.1" = _i5pqQE7w;
        "purpur-26.1.2" = _i5pqQE7w;
        "purpur-26.2" = _i5pqQE7w;
        "folia-1.21.6" = _i5pqQE7w;
        "folia-1.21.7" = _i5pqQE7w;
        "folia-1.21.8" = _i5pqQE7w;
        "folia-1.21.9" = _i5pqQE7w;
        "folia-1.21.10" = _i5pqQE7w;
        "folia-1.21.11" = _i5pqQE7w;
        "folia-26.1" = _i5pqQE7w;
        "folia-26.1.1" = _i5pqQE7w;
        "folia-26.1.2" = _i5pqQE7w;
        "folia-26.2" = _i5pqQE7w;
        "pkg-1.0" = _tdA7fL3I;
        "pkg-1.1" = _QYkzaZVA;
        "pkg-1.2" = _jk6sQFx8;
        "pkg-2.0.0" = _EfdPa6Hz;
