...
let
    ...
    in {
        ...
        "pkg-2.0+1.15" = _gLITeNmj;
        "pkg-2.0+1.16" = _unp9o1BX;
        "pkg-2.1+1.12" = _IUVruTcF;
        "pkg-2.1+1.14" = _sZ2c3Fie;
        "pkg-2.1+1.15" = _6gmpfXZ0;
        "pkg-2.1+1.16" = _fkoze2Aq;
        "pkg-2.1+1.17" = _EkT0Z5Js;
        "pkg-2.2+1.12" = _dBFyv32v;
        "pkg-2.2+1.13" = _ujIktLXZ;
        "pkg-2.2+1.14" = _SERyvO7U;
        "pkg-2.2+1.15" = _jKdLoGEc;
        "pkg-2.2+1.16" = _IwINuGro;
        "pkg-2.2+1.17" = _hGDFBEoZ;
        "pkg-2.2+1.18" = _anSpGZkl;
        "pkg-2.2+1.19" = _VP1Lj1kv;
        "pkg-2.3+1.14" = _LyZIn7G7;
        "pkg-2.3+1.15" = _LTHdz2LJ;
        "pkg-2.3+1.16" = _S4GVain5;
        "pkg-2.3+1.17" = _2wzfBJLG;
        "pkg-2.3+1.18" = _Fg16ADwG;
        "pkg-2.3+1.19" = _jSRWGgq7;
        "pkg-2.3+1.20" = _Sfxt80sM;
        "pkg-2.3+1.12" = _iwVwm8Id;
        "pkg-2.3+1.13" = _7yoBTkDj;
        "pkg-2.4+1.12" = _CgZPhP0j;
        "pkg-2.4+1.13" = _W3Mh2y22;
        "pkg-2.4+1.14" = _CZqmXfPX;
        "pkg-2.4+1.15" = _DR6VB4eL;
        "pkg-2.4+1.16" = _TBrCiF4F;
        "pkg-2.4+1.17" = _LBRBr90b;
        "pkg-2.4+1.18" = _IEZta4RR;
        "pkg-2.4+1.19" = _RizUFk0p;
        "pkg-2.4+1.20" = _zsATCGJk;
        "pkg-3.0+1.20.2" = _je4Q15eZ;
        "pkg-3.1+1.20.4" = _en6zyLhW;
        "pkg-3.2+1.20.6" = _ukTmsve7;
        "pkg-3.3+1.21" = _bG4mFsbu;
        "pkg-3.4+1.21.1" = _SRuAL84d;
        "pkg-3.5+1.21.3" = _A2pRqiBr;
        "pkg-3.6+1.21.4" = _IKTwBJyl;
        "pkg-3.7+1.21.5" = _8Ek2bEAh;
        "pkg-3.8+1.21.6" = _k5oXTPxl;
        "pkg-3.9+1.21.7" = _kdypnrWg;
        "pkg-3.10+1.21.8" = _7qLPZXpn;
        "pkg-3.11+1.21.10" = _XwTIPk5M;
        "pkg-3.12+1.21.11" = _mrNiiO1w;
