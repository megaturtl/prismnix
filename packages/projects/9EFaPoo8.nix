...
let
    ...
    in {
        ...
        "pkg-v1.3" = _hgIYXjWS;
        "pkg-v2.0" = _SxjGI0ms;
        "pkg-v2.0+mod" = _uKTzChuw;
        "pkg-v2.1" = _R2m8F1sK;
        "pkg-v2.1+mod" = _bnwmqbhB;
        "pkg-v2.2" = _ZOsBAEEB;
        "pkg-v2.2+mod" = _Z3HZ4amq;
        "pkg-v2.3" = _lQ2b8JmB;
        "pkg-v2.3+mod" = _BwJjRxTb;
        "pkg-v2.4" = _qgorCvyu;
        "pkg-v2.4+mod" = _Eo1e5xWF;
        "pkg-v2.5" = _axZPrVIU;
        "pkg-v2.5+mod" = _vyorEg8q;
        "pkg-v2.6" = _sVitp5LS;
        "pkg-v2.6+mod" = _yCEF2LrB;
        "pkg-v2.6.1" = _5fPjfwSK;
        "pkg-v2.6.1+mod" = _WDeDWi31;
        "pkg-v2.7" = _tKUA0e2W;
        "pkg-v2.7+mod" = _nrSeNsQw;
        "pkg-v3.0" = _xgd0mTvq;
        "pkg-v3.0+mod" = _37ZAyLF5;
        "pkg-v3.1" = _gF4AwdWh;
        "pkg-v3.1+mod" = _lBGO1awB;
        "pkg-v3.2" = _jYZeR5Ba;
        "pkg-v3.2+mod" = _oyi1gYsR;
        "pkg-v3.3" = _SlhRsOzO;
        "pkg-v3.3+mod" = _dIAuUGnc;
        "pkg-v3.4" = _9cGWGylO;
        "pkg-v3.4+mod" = _faBIiIHv;
        "pkg-v3.4.1" = _5wgwa1P7;
        "pkg-v3.4.1+mod" = _33KeqZeU;
        "pkg-v3.4.2" = _eZH9llQi;
        "pkg-v3.4.2+mod" = _3aFhCrEj;
        "pkg-v3.4.3" = _B8ejzsg9;
        "pkg-v3.4.3+mod" = _YaWqtjEO;
        "pkg-v3.4.4" = _OHM7JCUD;
        "pkg-v3.4.4+mod" = _gP3SC1hJ;
        "pkg-v3.5" = _kRonn00D;
        "pkg-v3.5+mod" = _ImPvIfVj;
        "pkg-v3.5.1" = _F8oiQcln;
        "pkg-v3.5.1+mod" = _VDz19k7u;
        "pkg-v3.5.2" = _FdLcvcHP;
        "pkg-v3.5.2+mod" = _7rxOfwNZ;
        "pkg-v4.0" = _JtpCiGtO;
        "pkg-v4.0+mod" = _p052RXLK;
        "pkg-v4.1" = _Ara31oAZ;
        "pkg-v4.1+mod" = _xDrnlNQa;
        "pkg-v4.1.1" = _whBy6lPa;
        "pkg-v4.1.1+mod" = _luHWKPRD;
        "pkg-v4.1.2" = _HhJyHX5k;
        "pkg-v4.1.2+mod" = _t6AWUqP9;
        "pkg-v3.6" = _awuLrxzo;
        "pkg-v3.6+mod" = _IhhlJE4d;
        "pkg-v4.2" = _Sn4mWIVj;
        "pkg-v4.2+mod" = _dIa4RK2J;
        "pkg-v3.7" = _hFFCjTJ6;
        "pkg-v3.7+mod" = _89DRvyVw;
        "pkg-v4.3" = _H42tOBBE;
        "pkg-v4.3+mod" = _lAXEDCIf;
        "pkg-v4.3.1" = _HTbPjLXp;
