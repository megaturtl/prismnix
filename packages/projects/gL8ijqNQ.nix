...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _Row37kKz;
        "pkg-1.1.1" = _wkiTxzam;
        "pkg-1.21.0-1.1.2" = _eyF4e5ll;
        "pkg-1.21.0-1.2.0" = _ZFfH2nuH;
        "pkg-1.21.0-1.2.2" = _5pfahT76;
        "pkg-1.21.0-1.3.0" = _hdGqIlQu;
        "pkg-1.21.1-1.3.1" = _2VfHpRTm;
        "pkg-1.4.0" = _2aHchKvc;
        "pkg-1.4.2" = _uoGXN329;
        "pkg-1.4.3" = _FqiaVrMr;
        "pkg-1.4.4" = _4BIjSved;
        ...
        "pkg-1.6.8" = _2WVO2Rtt;
        "pkg-1.6.9" = _WeKvA4C5;
        "pkg-1.6.10" = _gmF6FARG;
        "pkg-1.6.11" = _iDiJmV79;
        "pkg-1.6.12" = _SmKFhZMS;
