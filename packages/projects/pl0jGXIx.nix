...
let
    ...
    in {
        ...
        "pkg-8.0.5" = _3MQbvyk7;
        "pkg-8.0.6" = _OaGWEBHR;
        "pkg-7.0.10" = _7jm2tULG;
        "pkg-8.0.7" = _UjJ6dx2r;
        "pkg-8.0.8" = _kDiy9FkF;
        "pkg-8.0.9" = _hj6AEiom;
        "pkg-7.0.11" = _2HH3MNTl;
        "pkg-7.0.12" = _48qKWNA7;
        "pkg-8.0.10" = _gUQm7bKy;
        "pkg-8.0.11" = _J6dMJTRV;
        "pkg-8.0.12" = _tRjNEHKB;
        "pkg-8.0.13" = _Wt5BMV8B;
        "pkg-9.0.0" = _7JvMDVgq;
        "pkg-9.0.1" = _7ZEN5M4n;
