...
let
    versions = (let
        ...
        _QaTR74Du = {
            "id" = "QaTR74Du";
            "file" = "freecam-fabric-1.4.1-rc.1+mc1.17.1.jar";
            "hash" = "sha512-T0TUpLGaNsIkzc6vg8eZ3hqjKFQ5SGNYLKsSqaS9I4/WQkshg2A2KgEeR8BYfqLTFVsgm6YQVtSgrbCZZTV8vg==";
        };
        _rWNT0chb = {
            "id" = "rWNT0chb";
            "file" = "freecam-forge-1.4.1-rc.1+mc1.17.1.jar";
            "hash" = "sha512-F1Iy7mhSR1ftwgg00QiqdpZKknT+gLPKULa8tY+7Vi31bN0TS8lXZBgdx19YsXJxPSLNllchqjeMXSSz1Eqy7g==";
        };
        _9fuk2PNo = {
            "id" = "9fuk2PNo";
            "file" = "freecam-fabric-1.4.1-rc.1+mc1.18.2.jar";
            "hash" = "sha512-S9lXwfZnBNnEqALOjBcLK58IHImyB0ELMI3KnQiYtyUo09Jowqy071hhmgpfNKtqGgwjfKIn4diTe24xp7Arpg==";
        };
        _EZaXwVW8 = {
            "id" = "EZaXwVW8";
            "file" = "freecam-forge-1.4.1-rc.1+mc1.18.2.jar";
            "hash" = "sha512-55PRoJDFSC+5K+rPDlan7dyhdlVx+t5IDQW53yD/e1q6+97NE+kO6r0/Qc5sUkeO+Je/hXNTE89ptRdBSDNlRg==";
        };
        _KOWqMRcm = {
            "id" = "KOWqMRcm";
            "file" = "freecam-fabric-1.4.1-rc.1+mc1.19.4.jar";
            "hash" = "sha512-r+7X0bw2xs6grkgqkPjCRFzuq7uYXheyVkR/V/1A2n+/1ft7UcBhPaeTic51pVykPlsACwSpbTbzV+jtTANsOA==";
        };
        _5Qhvd6ob = {
            "id" = "5Qhvd6ob";
            "file" = "freecam-forge-1.4.1-rc.1+mc1.19.4.jar";
            "hash" = "sha512-3CgDqpQ8KkHTh6RZn/5TteAnfjzbp29SuWcaF3EYcYFhQQrV4LCwceo8lzxoLKXS+vCgwBkhXPx82nBWW29JfA==";
        };
        _agnNOkzN = {
            "id" = "agnNOkzN";
            "file" = "freecam-fabric-1.4.1-rc.1+mc1.20.6.jar";
            "hash" = "sha512-5RXtcmXSks693JMLiKDzH5I5dk4/wwFpVkwC38+ltfqs0z95Z03AajVnflbsrHvCgNodJ2PpPyoYJggd58U3NQ==";
        };
        _KvLsNskJ = {
            "id" = "KvLsNskJ";
            "file" = "freecam-neoforge-1.4.1-rc.1+mc1.20.6.jar";
            "hash" = "sha512-iKWbKA1tzb3tBOQvcsALSCrrhVJSwGT02FPusQbDtw/c2olsF67mLbijbOXZtDFyrW+/8ItpIg00bxB0sxu7vw==";
        };
        _iCFUntbJ = {
            "id" = "iCFUntbJ";
            "file" = "freecam-fabric-1.4.1-rc.1+mc1.21.11.jar";
            "hash" = "sha512-UijpSbNDfo460gtoMc30tGwat0tkHEFmSEJI04Gj8woXQWNmXFVD+PS0ZssxtfEtpjmvRsIZTuF+h/hT1pzOfw==";
        };
        _D15EEBsW = {
            "id" = "D15EEBsW";
            "file" = "freecam-neoforge-1.4.1-rc.1+mc1.21.11.jar";
            "hash" = "sha512-Dm8cCzkpYrNzkuXLyZSzJASIOrMnH58IAHf0nnv3f8U/Ncqryp46gNG7+DV9AVZmCrpqABeejf8DuEzx6cZzYg==";
        };
        _73gs9spC = {
            "id" = "73gs9spC";
            "file" = "freecam-fabric-1.4.1-rc.1+mc26.1.2.jar";
            "hash" = "sha512-cJrk2upqIZFNOg7MsgaPyjSgxHwEdrvV0Qd+Hj2Z/OKMZ0U+FF91OJVadV8puovM/lhDBW76FEz07GA9Sp/zmA==";
        };
        _4RN4rsMr = {
            "id" = "4RN4rsMr";
            "file" = "freecam-neoforge-1.4.1-rc.1+mc26.1.2.jar";
            "hash" = "sha512-+TgyhMhZyj5FM6m3nIq0bzlja8l+L64Z89EsG4wIaJ4NXKePUY7tgy6uznR0GqiGdY1dnf1671DuGQJJpJtxAQ==";
        };
        _OqDcTeQ8 = {
            "id" = "OqDcTeQ8";
            "file" = "freecam-fabric-1.4.1-rc.1+mc26.2.jar";
            "hash" = "sha512-Y1jHqZTqxZdPze2MM5wrdFMKoEoZi3RFeBL1qY8u3dZDuspbnmfxRQfwteXRuQnsC/mTY0fB6XXCXQ2FMuMgLw==";
        };
        _2hsFARvZ = {
            "id" = "2hsFARvZ";
            "file" = "freecam-neoforge-1.4.1-rc.1+mc26.2.jar";
            "hash" = "sha512-VSzvvirOPsaEEAlN4giWCsvQtKD8OlJVsiyaRlVo+2OEPYe/QNhCiHoJzdNIrkULtso2lEM2YLu0VX3zVnDqfg==";
        };
        _V0vlgo4T = {
            "id" = "V0vlgo4T";
            "file" = "freecam-fabric-1.4.1+mc1.17.1.jar";
            "hash" = "sha512-+RUflIWvM/jqVWzpjy5n/YmYRGO0G1Ju6uvjDpBu+xTOHD5QYf2O83UmH3jzKwM8TuHqiGww5tWcEK7MHMP6qQ==";
        };
        _BR75XQDs = {
            "id" = "BR75XQDs";
            "file" = "freecam-forge-1.4.1+mc1.17.1.jar";
            "hash" = "sha512-aupUFfTSg+m9Twqhf7yAux+RFymJ1141No0m+t+Ur4VY1HNo7H8RLw3QJ5mYk5gXSaJKgi8LS+GTQDAQsvldQA==";
        };
        _DfG1c6ni = {
            "id" = "DfG1c6ni";
            "file" = "freecam-fabric-1.4.1+mc1.18.2.jar";
            "hash" = "sha512-GdEYV7CSegsVjbvTzRmyFTVhHIZgYvCshugCoPf5zh/H2Fmma7HSq7jBeGO6eG7m4pFONhuVUjqfSgePffGbZA==";
        };
        _Q4M754Lb = {
            "id" = "Q4M754Lb";
            "file" = "freecam-forge-1.4.1+mc1.18.2.jar";
            "hash" = "sha512-8GfvsP5S4azv9bsNY5dMKGRIzSRjmrASqfDjaIEApnjJ/5Ehs1lgiPOGiug0jcvnfN7LX1go1XZVCSxo04D/jA==";
        };
        _cyuTAvNV = {
            "id" = "cyuTAvNV";
            "file" = "freecam-fabric-1.4.1+mc1.19.4.jar";
            "hash" = "sha512-71T3SS67sF6MsBz3A4XtFHsR6lm0ZnG0CFu/nCcKK8XRi+T2p29a0N1YzUuIJ9kSqXjsYY9IFwOog/6j4i+xCA==";
        };
        _7C96cbH4 = {
            "id" = "7C96cbH4";
            "file" = "freecam-forge-1.4.1+mc1.19.4.jar";
            "hash" = "sha512-nne66u3bBvlNfK2Gp3mv9kVgAmXADab4ZXu0pE+MUV4WxFKmMLe5z0ckPdJDchEdyp+lmYtal4+N7TaWtOn7Cw==";
        };
        _bc65gAmE = {
            "id" = "bc65gAmE";
            "file" = "freecam-fabric-1.4.1+mc1.20.6.jar";
            "hash" = "sha512-YZItAe4GojTf7hNyyxV5JIeEDEklffKoYoP46zT3TCvF8EF1jnulSrvr0OsPLB2IGVbdr4JXKdcJZWBo9G7Bkg==";
        };
        _c407NQ93 = {
            "id" = "c407NQ93";
            "file" = "freecam-neoforge-1.4.1+mc1.20.6.jar";
            "hash" = "sha512-G9xmi109Q2lP0VLFKzCTgBVJ73xNeUe4/NU0eTJMYO0l2LYwiXPXkXUphL4h3V6hibhunjj4Dw0RSdDqUQ+OUA==";
        };
        _55z2tEpa = {
            "id" = "55z2tEpa";
            "file" = "freecam-fabric-1.4.1+mc1.21.11.jar";
            "hash" = "sha512-h/LMMsHYaknf0VRVIe6A2bcnSN/aW3tOJ4D1lFvax9DL9bTzJXCLuyqbvqRmVFkQw6NS0PbXe2Rleul2/SS3HA==";
        };
        _r677Afnt = {
            "id" = "r677Afnt";
            "file" = "freecam-neoforge-1.4.1+mc1.21.11.jar";
            "hash" = "sha512-mEwc+IYDzL8EFYwVf6ZojiB+6KM/NPk8FpX0MkZfbw8tmLdk6nkPtgCyg8lB/pYSDWI9GrgYoqKGF/qDgRHJNQ==";
        };
        _RystERKE = {
            "id" = "RystERKE";
            "file" = "freecam-fabric-1.4.1+mc26.1.2.jar";
            "hash" = "sha512-8n8XpIR/o7qPHbOxh7WtbTtJxZRbViZoWXM+Anw8zrqp2DHykE112wYgR76sRvb8YGgcgjRgr/Tnesy29Wq+SA==";
        };
        _JwpOFcO1 = {
            "id" = "JwpOFcO1";
            "file" = "freecam-neoforge-1.4.1+mc26.1.2.jar";
            "hash" = "sha512-vmxQCvryCZSAMVfiUgCQM8kp47zQZbf/wb8N+jPZK3ZSaPJjIZ+STb7XzUsjczqs7sUU/UUXAOpioNoTdkU/Yg==";
        };
        _r125dZ2j = {
            "id" = "r125dZ2j";
            "file" = "freecam-fabric-1.4.1+mc26.2.jar";
            "hash" = "sha512-L27GgZs9rjn6wNq9wtcXmAYwqPEjmB0wi76wP94DPULhyGlDy8ybfQhdSq1QFDvNhEPmv0z0kypOtYOQbApANQ==";
        };
        _QlS8sqds = {
            "id" = "QlS8sqds";
            "file" = "freecam-neoforge-1.4.1+mc26.2.jar";
            "hash" = "sha512-TJkGKEkqKa/1I1HCFj/ayvl2CilTz3L+eh78Pfdz5GNRHcbDMqaklkO5+vX0TlRs4R77nC5ewlYo0osYDn7n2Q==";
        };
        _Tu3Mp6aa = {
            "id" = "Tu3Mp6aa";
            "file" = "freecam-fabric-1.5.0-alpha.0+mc1.17.1.jar";
            "hash" = "sha512-QvTOhzxepr94P0SGDivcm1PqUxWdsHlX/lyKAwBMt1jT/2S3SgLNb8ER5o6ukiOoff6pSVHu4s1A2db5zUXxsQ==";
        };
        _CFiQVOwD = {
            "id" = "CFiQVOwD";
            "file" = "freecam-forge-1.5.0-alpha.0+mc1.17.1.jar";
            "hash" = "sha512-ISuNMgGWfRLTydiZOPiJw9SvLa85fA5529jUQPD7DqzQS97Mv8dpOI8C+kc7vVNa6W3bWEhgTNaGMIrOU1iL0g==";
        };
        _wER2RkH9 = {
            "id" = "wER2RkH9";
            "file" = "freecam-fabric-1.5.0-alpha.0+mc1.18.2.jar";
            "hash" = "sha512-FF+4fEOMZvROm9dIZ11VDbutURn8rmdiIZU3HxfpNRMr8S7KdcLnxVvtK+hmUutxtvdKCbi1rzNea5/3V/cvGA==";
        };
        _7uz3vGCt = {
            "id" = "7uz3vGCt";
            "file" = "freecam-forge-1.5.0-alpha.0+mc1.18.2.jar";
            "hash" = "sha512-25R9BfBSW8AHQJ62nDOQP3gzSM0L/+mPWFmEjK75l01gzMz/lsQF1u5TiGvJasWHGKp2Ch7I7ZpkjFauS9Dy5w==";
        };
        _D1H11xUT = {
            "id" = "D1H11xUT";
            "file" = "freecam-fabric-1.5.0-alpha.0+mc1.19.4.jar";
            "hash" = "sha512-Dy5ElwiHHm7cYgGwiN55bYnM3YUobf7HG3Pr8QCCnCcRkT/mSPAxdynTgroOuxJcD3fTKyDRk0QLV3fi7Dw+Xg==";
        };
        _e9Qkefcg = {
            "id" = "e9Qkefcg";
            "file" = "freecam-forge-1.5.0-alpha.0+mc1.19.4.jar";
            "hash" = "sha512-wmnRG70OJzugbEFDKzBj9vdXcj06CO8mNph+0DJAdJ4phntb7gZvDT8W2PB+6ug5mkaxdEtDTV3oZk4U8rCczA==";
        };
        _fmECJkUP = {
            "id" = "fmECJkUP";
            "file" = "freecam-fabric-1.5.0-alpha.0+mc1.20.6.jar";
            "hash" = "sha512-fNAbT91PPuC7CBNDbRTNq8/2Oj2zpbFYpZkALLM8/+ppQ5yeFoqN6u3PrKEH/kPJMIjyFqDVk4DFvz+gu7M8jQ==";
        };
        _aJBGKCUD = {
            "id" = "aJBGKCUD";
            "file" = "freecam-neoforge-1.5.0-alpha.0+mc1.20.6.jar";
            "hash" = "sha512-2MfgaKtuPIgct0RX+vOaqo4Em5yUWyjShRtSYjTZJrlbSysQp2R7veXniEwU8ZALiF4yODpy5gDzQTkAdIamjw==";
        };
        _laWtr0FF = {
            "id" = "laWtr0FF";
            "file" = "freecam-fabric-1.5.0-alpha.0+mc1.21.11.jar";
            "hash" = "sha512-3PW3Z5GRgw5cM1AOT0U1+uwOvygoeqlgPDm4XTgfJOx6eb9CZCc30Mi83wDK+H280TegnEYj/KwUcVTfas3TrA==";
        };
        _enrbgZWz = {
            "id" = "enrbgZWz";
            "file" = "freecam-neoforge-1.5.0-alpha.0+mc1.21.11.jar";
            "hash" = "sha512-unXtzQ7RD3ZQvYcufTkUtmd3vlArJ/UwWw3k3rqRIRZl136hFijRgK/XddIC4h2GKaSZvcKeg7gg2QsMVG9Aqg==";
        };
        _uRY6WbpH = {
            "id" = "uRY6WbpH";
            "file" = "freecam-fabric-1.5.0-alpha.0+mc26.1.2.jar";
            "hash" = "sha512-8LcDF15hFMFRwNgFifQFcEayUTRhVqK1aq7oKOYxto4zXfbyVJeUZjbrN9J/9PD7Ckf9xFmI7uq8L9U564LEuA==";
        };
        _Y2ifB4Tu = {
            "id" = "Y2ifB4Tu";
            "file" = "freecam-neoforge-1.5.0-alpha.0+mc26.1.2.jar";
            "hash" = "sha512-46hSHld27EXaU77cxKwgIZJz6WYwO3i3yqhrfT88ZSvsT7XohdW+3OTTp6N8a/HxHahRC9sBVqk3E+hfaViP/w==";
        };
        _krdWOeTQ = {
            "id" = "krdWOeTQ";
            "file" = "freecam-fabric-1.5.0-alpha.0+mc26.2.jar";
            "hash" = "sha512-vnXxNRfSK4jIbrWVb8h9Nq3gadwYkmqWTIiVUC+9Zfw5rDqUQxaXBuUs9IV+IrSa8upjkH8wymgbo4UndPYdjw==";
        };
        _EkowUmxx = {
            "id" = "EkowUmxx";
            "file" = "freecam-neoforge-1.5.0-alpha.0+mc26.2.jar";
            "hash" = "sha512-OyP/teUNEpdH0B22d5iJKKjomyrHGi1aeAu08SFbt4/V5L9EajVhhhfovFHL2XC/B6rWhD6kJY+lMNVz60PAbg==";
        };
        _fmIWvQyc = {
            "id" = "fmIWvQyc";
            "file" = "freecam-fabric-1.5.0-alpha.0+mc26.3.jar";
            "hash" = "sha512-xp+Bkr5UnkifCxhFMRo2Ib14KhJDtDdrPLJXO3S6BgiznhD7FM3vDH8tY3/1vxJaunrwtaiHU/iJ7fDSIodaDQ==";
        };
        _XLt86VYl = {
            "id" = "XLt86VYl";
            "file" = "freecam-neoforge-1.5.0-alpha.0+mc26.3.jar";
            "hash" = "sha512-HuUPDgee3U6CSNJEocm/3vkjT/SKCzSUb7K6XpQsOuPMdSuDyrOlZZ8pB5G4pYSf6lOLrOT9xn6b3vWCWkF/ZA==";
        };
        _T1UxEXk8 = {
            "id" = "T1UxEXk8";
            "file" = "freecam-fabric-1.5.0-alpha.1+mc1.17.1.jar";
            "hash" = "sha512-ZOsckU58Z5zb0Qg930O595o8ljjaBYIbwyG/yJQ2SxusDvFOE6K/Z78QIHAUHHI+ruW5cQwAvzc3HbcKd1Tz7A==";
        };
        _fJPntzs6 = {
            "id" = "fJPntzs6";
            "file" = "freecam-forge-1.5.0-alpha.1+mc1.17.1.jar";
            "hash" = "sha512-yYCIGyOzrH0xWMAX3f/ZxCsN56z/aig7d4wOr/8JQQ88B3Y/NeaJycuzNApPQRkE2XAYUWimi5Z1jwxubi1ntA==";
        };
        _hu6MbG8s = {
            "id" = "hu6MbG8s";
            "file" = "freecam-fabric-1.5.0-alpha.1+mc1.18.2.jar";
            "hash" = "sha512-lsHEh5MHy/k9fhKESg02OEB+MHcostlUTArrOGtR/6AYyb03N2ftVaEwt1hsJBr1vX+omV57A6X5ATzVz1kZPg==";
        };
        _WsE8anR9 = {
            "id" = "WsE8anR9";
            "file" = "freecam-forge-1.5.0-alpha.1+mc1.18.2.jar";
            "hash" = "sha512-n0lOLCVPfei+zXTI20gxfH7yFu81VjhW5FGmi8ymbm3wgEybSdmy+pMYiHOoxoTjAFU0t/JvfWACx76nCCFang==";
        };
        _z9YJEnbw = {
            "id" = "z9YJEnbw";
            "file" = "freecam-fabric-1.5.0-alpha.1+mc1.19.4.jar";
            "hash" = "sha512-KrpaCetq+XJcgPY0FOJtZy8Kuyq+imTtk4z2ja0Huipbt81W/jnPuMeQX6IKRo+56a2I3la7IFkxvTpwXYYgqw==";
        };
        _ABSs6sKE = {
            "id" = "ABSs6sKE";
            "file" = "freecam-forge-1.5.0-alpha.1+mc1.19.4.jar";
            "hash" = "sha512-kHPc+B1Xeok1G8fLx04e4T4ev76ZXP3LKKlg2mg46RnwTYsBToOt9vGGFJXHTGNo5pWH5P78S5dhkwr83I0jeA==";
        };
        _RwcVTxIT = {
            "id" = "RwcVTxIT";
            "file" = "freecam-fabric-1.5.0-alpha.1+mc1.20.6.jar";
            "hash" = "sha512-nEj/TXEzx6t9ZcNz1rUbUHTHOvNyZ88X24otTq77CH+rZyTDKjwVGjM/wKKEz/o8G99MZczoLjTchBHKL4kYHQ==";
        };
        _1u2PeV1v = {
            "id" = "1u2PeV1v";
            "file" = "freecam-neoforge-1.5.0-alpha.1+mc1.20.6.jar";
            "hash" = "sha512-FUlTeFSG0iRDC5z/vuqDb7rLxsTuOvO9ytB2exSobNOtwyrMDEkE4gYQfJFte1rAX8Kqy9mnjJnLOe2BicYFoA==";
        };
        _v8KVU6de = {
            "id" = "v8KVU6de";
            "file" = "freecam-fabric-1.5.0-alpha.1+mc1.21.11.jar";
            "hash" = "sha512-d7keuw5ZufGDd8N0T9Jw61AZ/hNoWji9bdCJ4zsK0ljhwpl6zYLpFnMq2a4rOQWv37yXD/GB+qRArdxeBupecA==";
        };
        _gh0CqTYT = {
            "id" = "gh0CqTYT";
            "file" = "freecam-neoforge-1.5.0-alpha.1+mc1.21.11.jar";
            "hash" = "sha512-ZOHeXhqobnhQ3aqnyttDxeOc+OEJhjzVwc6f+8FjviY35ZiwNEGtn2f95bAiFxBJ0NL/f+dfUNm/5L7kB+FgsQ==";
        };
        _JCJvprx4 = {
            "id" = "JCJvprx4";
            "file" = "freecam-fabric-1.5.0-alpha.1+mc26.1.2.jar";
            "hash" = "sha512-g1BNxWX8U5yPRcgsyFWhNwYe/k4kg5fme1P5WAP/WmUn1dit1Q3+je9xHtqsPGyi9JoaTThMUzJRjfHoOpvG/g==";
        };
        _3b9CC22i = {
            "id" = "3b9CC22i";
            "file" = "freecam-neoforge-1.5.0-alpha.1+mc26.1.2.jar";
            "hash" = "sha512-0UC54HKDhbrB+UR7ESmM0dYiHYyuXAsfq0IUZFJIV+OunFIO0CEbyj3QqBXEapRe1FOaTeliNTno6+gB4nueSA==";
        };
        _RRhBzvpn = {
            "id" = "RRhBzvpn";
            "file" = "freecam-fabric-1.5.0-alpha.1+mc26.2.jar";
            "hash" = "sha512-jrT3SElPZ3CTi6PZt4oqlG7OdQ7o4PO7gwGdKtsyfze8Vv2CVDhKhudAtMBZFN3IFZRNYHWKZCbsG37Sqjm3iA==";
        };
        _Zyw2pZUA = {
            "id" = "Zyw2pZUA";
            "file" = "freecam-neoforge-1.5.0-alpha.1+mc26.2.jar";
            "hash" = "sha512-NCEbTsY2OLKdatPh3+p8C9athLaiZxZzvFsGbRhoTnNcJ16j/C4F9/faGoWAqyvF87JchgiUVA5TioIRb3Ebzg==";
        };
        _QzwNJy7n = {
            "id" = "QzwNJy7n";
            "file" = "freecam-fabric-1.5.0-alpha.1+mc26.3.jar";
            "hash" = "sha512-MdnaeFOMkX9E022o0DevF9k2rEOVeqC/iMj65qbPjVY6C7x4MePMMinGkFnluRx6rkZra48Hx6MvqWYEKqZOlg==";
        };
        _qu9pTO6c = {
            "id" = "qu9pTO6c";
