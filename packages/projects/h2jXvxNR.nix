...
let
    versions = (let
        ...
        _Jkw9GA1X = {
            "id" = "Jkw9GA1X";
            "file" = "starcatcher-3.1.0-NEOFORGE-1.21.1.jar";
            "hash" = "sha512-XHvOVLZbMsMF5aHNK6IFy/3P+29FhsE+q2mkWVJTU+sn6QCAy9lDcXJ2im1hbDpphQG9VNKgnag2ylvPqre95A==";
        };
        _W4HMtfMM = {
            "id" = "W4HMtfMM";
            "file" = "starcatcher-3.1.1-NEOFORGE-1.21.1.jar";
            "hash" = "sha512-0XxEQ0YU3yusyXr7p4XfJQSOA4Q8dIBptk0gRZtfQJ0XwFj9miRAZ2xlLGIsl98gue/q1YP1fRDxCasKSY7y3w==";
        };
        _tB5KR6Du = {
            "id" = "tB5KR6Du";
            "file" = "starcatcher-3.1.2-NEOFORGE-1.21.1.jar";
            "hash" = "sha512-Ldhte/6fwLeYMbdB0RPva0qRwgac10fVPQLcUYQsTF9ZPHHK9sFqwazivTVZQsLw6NTawX2KAF7I+98OPiVI9A==";
        };
        _8ExmAi8H = {
            "id" = "8ExmAi8H";
            "file" = "starcatcher-3.1.3-NEOFORGE-1.21.1.jar";
            "hash" = "sha512-fGui7h3xpG24f7WecdfmMhXdpadlkwCNQvtPKT3fqagU+n1tvsaKBFm+z2hJ3wKFY6TnHZ4tDSlxKc3kK1bcfw==";
        };
        _8Mw66pt7 = {
            "id" = "8Mw66pt7";
            "file" = "starcatcher-3.1.2-PREVIEW-NEOFORGE-26.1.2.jar";
            "hash" = "sha512-X/aLB2oPKI0+A9j4e7ndkVlsGtjRMr81O2GkqTk3umfcPYdBuiqbfbs64kzFSr3OWByRQoljxM5hClC/RhH3uw==";
        };
        _QtFUMkUo = {
            "id" = "QtFUMkUo";
            "file" = "starcatcher-3.1.3-PREVIEW-NEOFORGE-26.2.jar";
            "hash" = "sha512-4T7aefdWyDAkBa3jIh0O/d0Z3U9BazEfi02YxOKUjvajjLLmvhTxtbQiCEQCu+7xoeU1zOX+PvM59ON7Vua66g==";
        };
        _VrUusGGJ = {
            "id" = "VrUusGGJ";
            "file" = "starcatcher-3.1.3-PREVIEW-FORGE-1.20.1.jar";
            "hash" = "sha512-UnQQ4nvdN8Voulgedb+IrW5edC7knn6GW/NfVPCGtKzOF1IFV5OzQvzg72KkM/WrP4Onx+mF+jt81cKZiU4+xw==";
        };
        _j8ogdqql = {
            "id" = "j8ogdqql";
            "file" = "starcatcher-3.1.4-FORGE-1.20.1.jar";
            "hash" = "sha512-WO7r976rYJQrqp34Jj0h8PetqH+rXRa05ySPSamRiM8gu118Bz/y3p/Ya6e2BE7Xm0OHH71oiz6eOKpNiWUFIg==";
        };
        _DDcW7Eto = {
            "id" = "DDcW7Eto";
            "file" = "starcatcher-3.1.4.1-FORGE-1.20.1.jar";
            "hash" = "sha512-1IzgozKRsQSXk2h5/zCsx6JlV/gZzdDT34Axm7+GvpLm6s3IioBjs2s4K8GqVe45CwWio81SjvpnYHTB/O0yuw==";
        };
        _oaBearOA = {
            "id" = "oaBearOA";
            "file" = "starcatcher-3.1.4-NEOFORGE-1.21.1.jar";
            "hash" = "sha512-9pDLo44WYJp7u3L5m6+U+ESdvNF1v/rzCSYbiDQDp6IVKQ9TNrWH/mT+DI2YlDfBtp3tDcETrsRQbz/LypLiWw==";
        };
        _gVEvP496 = {
            "id" = "gVEvP496";
            "file" = "starcatcher-3.1.4-NEOFORGE-26.1.2.jar";
            "hash" = "sha512-k2ggPTNpt98uToV80lcW1TZ9oNR/noQdbQwTMIj8alIlcyHJPkfmzGczFfUPgjCIXGZjRSgefIKcs+9QHKDtsQ==";
        };
        _JUgq0oJq = {
            "id" = "JUgq0oJq";
            "file" = "starcatcher-3.1.4.1-NEOFORGE-26.1.2.jar";
            "hash" = "sha512-J8QmiNntZKE2WDw7rHH548VFe0D+sOBMzBmOlcrHcM7O6bhjObxBNb/6o1VfLX2bSrBpVojKAlClHpxlq859cQ==";
        };
        _6cnwGavZ = {
            "id" = "6cnwGavZ";
            "file" = "starcatcher-3.1.4.1-NEOFORGE-1.21.1.jar";
            "hash" = "sha512-SFtGAgEMT2Wr088v6xkFE/qS97gkkpmG8PzzQlrF7rVS2jazGnbAR1cFklk8S1o+pE8ijqHpg3jd/0PuyehsFQ==";
        };
        _jf0qfeEV = {
            "id" = "jf0qfeEV";
            "file" = "starcatcher-3.1.4.2-FORGE-1.20.1.jar";
            "hash" = "sha512-eNvD1aeYB0RTvkY6JQAm/rluDGvPUqA3DfxeesoUBvPfpJYwncHkK48NyaxsDNHaziWk99D69Kq+jMGBO2nabQ==";
        };
        _9531K74r = {
            "id" = "9531K74r";
            "file" = "starcatcher-3.1.4.3-FORGE-1.20.1.jar";
            "hash" = "sha512-FlyFtG77S8LW9HdBHqbhIO57wF2CiD04qtoUjrLW94hoS6p7huhJ6qdFzh3hxEFMeiD/plUTZH4JMp7oemweDQ==";
        };
        _LLEg27kz = {
            "id" = "LLEg27kz";
            "file" = "starcatcher-3.1.4.4-FORGE-1.20.1.jar";
            "hash" = "sha512-Bl4GTrQUhgkraXJiv/VFBIb9NvjXHYumfw8vKWRSQ9PxXJgZr4qHY0ZPusfPaa73EXBpjb3qlcoJcXgbtlda7g==";
        };
        _PJPWp3Zs = {
            "id" = "PJPWp3Zs";
    ...
    in {
        ...
        "pkg-1.2" = _HhVntS72;
        "pkg-1.2.1" = _6sZmVW4K;
        "pkg-1.3-NEOFORGE-1.21.1" = _nKPihH4q;
        "pkg-1.2.2-FORGE-1.20.1" = _vnGikexk;
        "pkg-1.2.3-FORGE-1.20.1" = _tZBpjySr;
        "pkg-1.3.1-NEOFORGE-1.21.1" = _jHwJKcUS;
        "pkg-1.3.1-FORGE-1.20.1" = _wQ3pp1qw;
        "pkg-1.3.2-NEOFORGE-1.21.1" = _i3PTmsOD;
        "pkg-1.3.3-NEOFORGE-1.21.1" = _oLCODGj9;
        "pkg-1.3.3-FORGE-1.20.1" = _sJWYyq6Q;
        "pkg-1.3.4-NEOFORGE-1.21.1" = _fYD7p5Ki;
        "pkg-1.3.4-FORGE-1.20.1" = _vDl8EHRD;
        "pkg-1.3.5-FORGE-1.20.1" = _3zeSEw89;
        "pkg-2.0-NEOFORGE-1.21.1" = _y1KxaFWg;
        "pkg-2.0.1-NEOFORGE-1.21.1" = _RHXcCxQR;
        "pkg-2.1-NEOFORGE-1.21.1" = _SXEOxs7V;
        "pkg-2.1-FORGE-1.20.1" = _W3OIAsLP;
        "pkg-2.1.1-FORGE-1.20.1" = _RAy3SeJo;
        "pkg-2.1.1-NEOFORGE-1.21.1" = _2RNK5dAD;
        "pkg-2.1.2-FORGE-1.20.1" = _uFslPAEP;
        "pkg-2.1.3-FORGE-1.20.1" = _Qu5IbToy;
        "pkg-2.1.2-NEOFORGE-1.21.1" = _MnIquYds;
        "pkg-2.2-NEOFORGE-1.21.1" = _k5EhSUF4;
        "pkg-2.2.1-NEOFORGE-1.21.1" = _R4Tcd3JL;
        "pkg-2.2-FORGE-1.20.1" = _3XoVodNa;
        "pkg-2.2.2-NEOFORGE-1.21.1" = _3NwecLBx;
        "pkg-2.2.1-FORGE-1.20.1" = _VlwkRKZk;
        "pkg-2.2.3-NEOFORGE-1.21.1" = _C2GAD1i5;
        "pkg-2.3-NEOFORGE-1.21.1" = _dlzuL3U2;
        "pkg-2.3.1-NEOFORGE-1.21.1" = _eAXxvDxQ;
        "pkg-2.3.2-NEOFORGE-1.21.1" = _nvN5q1Hj;
        "pkg-2.3.3-NEOFORGE-1.21.1" = _afaS1mLw;
        "pkg-2.3-ALPHA-NEOFORGE-26.1.2" = _EkYrP6cG;
        "pkg-2.3.1-ALPHA-NEOFORGE-26.1.2" = _8uMHc7NN;
        "pkg-2.3.4-NEOFORGE-1.21.1" = _Z563rMV6;
        "pkg-2.3.5-NEOFORGE-1.21.1" = _kqmR95GU;
        "pkg-2.3.5-ALPHA-FORGE-1.20.1" = _nZlDxx3P;
        "pkg-2.3.5-ALPHA-2-FORGE-1.20.1" = _9ZTvoQcP;
        "pkg-2.3.6-NEOFORGE-1.21.1" = _oXIV631k;
        "pkg-2.3.7-NEOFORGE-1.21.1" = _abgr8zuw;
        "pkg-2.3.7-FORGE-1.20.1" = _dwHhOldn;
        "pkg-2.3.7.1-FORGE-1.20.1" = _Cp0bAnLr;
        "pkg-2.3.8-NEOFORGE-1.21.1" = _Y1VEhDhw;
        "pkg-2.3.8-FORGE-1.20.1" = _8GwmG5Pc;
        "pkg-2.3.9-NEOFORGE-1.21.1" = _qM7p6wJ3;
        "pkg-2.3.9-NEOFORGE-26.1.2" = _HA5jThzH;
        "pkg-2.3.9-FORGE-1.20.1" = _O6lBs5dI;
        "pkg-2.3.10-FORGE-1.20.1" = _42Q1N44w;
        "pkg-2.3.11-FORGE-1.20.1" = _UgyYo4zC;
        "pkg-2.3.12-FORGE-1.20.1" = _J1RfpDRv;
        "pkg-2.3.13-NEOFORGE-1.21.1" = _Q9DCb1Z0;
        "pkg-2.3.14-NEOFORGE-1.21.1" = _612RYjYi;
        "pkg-2.3.14-NEOFORGE-26.1.2" = _g8p9PuQX;
        "pkg-2.3.13.1-FORGE-1.20.1" = _mE3PIlWZ;
        "pkg-2.3.15-NEOFORGE-1.21.1" = _kdYIATSl;
        "pkg-2.3.16-FORGE-1.20.1" = _UC5hEOUf;
        "pkg-2.3.16-NEOFORGE-1.21.1" = _US8H70He;
        "pkg-2.3.16.1-NEOFORGE-1.21.1" = _VVhtOX6q;
        "pkg-2.3.16.1-FORGE-1.20.1" = _UclEXjDo;
        "pkg-2.3.17-NEOFORGE-1.21.1" = _5Pceeqpa;
        "pkg-2.3.17-FORGE-1.20.1" = _MzpHhIMl;
        "pkg-2.3.17.1-NEOFORGE-1.21.1" = _5JBObiWj;
        "pkg-2.3.17.1-FORGE-1.20.1" = _rXYZXCyr;
        "pkg-2.3.18-NEOFORGE-1.21.1" = _lEk3NS3m;
        "pkg-2.3.18-FORGE-1.20.1" = _DmPkkJ49;
        "pkg-3.0-NEOFORGE-1.21.1" = _EBDYtmLn;
        "pkg-3.0.1-NEOFORGE-1.21.1" = _saJhZ5J2;
        "pkg-3.0.2-NEOFORGE-1.21.1" = _4ffzcumR;
        "pkg-3.0.3-NEOFORGE-1.21.1" = _KtYOkMSA;
        "pkg-3.0.4-NEOFORGE-1.21.1" = _bGtpbLaz;
        "pkg-3.0.5-NEOFORGE-1.21.1" = _8oVo8DJU;
        "pkg-3.0.6-NEOFORGE-1.21.1" = _gDYg666K;
        "pkg-2.3.19-FORGE-1.20.1" = _99MYui4e;
        "pkg-3.1.0-NEOFORGE-1.21.1" = _Jkw9GA1X;
        "pkg-3.1.1-NEOFORGE-1.21.1" = _W4HMtfMM;
        "pkg-3.1.2-NEOFORGE-1.21.1" = _tB5KR6Du;
        "pkg-3.1.3-NEOFORGE-1.21.1" = _8ExmAi8H;
        "pkg-3.1.2-PREVIEW-NEOFORGE-26.1.2" = _8Mw66pt7;
        "pkg-3.1.3-PREVIEW-NEOFORGE-26.2" = _QtFUMkUo;
        "pkg-3.1.3-PREVIEW-FORGE-1.20.1" = _VrUusGGJ;
        "pkg-3.1.4-FORGE-1.20.1" = _j8ogdqql;
        "pkg-3.1.4.1-FORGE-1.20.1" = _DDcW7Eto;
        "pkg-3.1.4-NEOFORGE-1.21.1" = _oaBearOA;
        "pkg-3.1.4-NEOFORGE-26.1.2" = _gVEvP496;
        "pkg-3.1.4.1-NEOFORGE-26.1.2" = _JUgq0oJq;
        "pkg-3.1.4.1-NEOFORGE-1.21.1" = _6cnwGavZ;
        "pkg-3.1.4.2-FORGE-1.20.1" = _jf0qfeEV;
