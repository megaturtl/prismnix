...
let
    versions = (let
        ...
        _nPaC0AOI = {
            "id" = "nPaC0AOI";
            "file" = "PhoenixCratesLite-6.2.0.jar";
            "hash" = "sha512-9NNweAkHSOHpQ36TCLDXLU800VVuaG06ubqfxi0/S62OzVswuB2fPDQs3C2YyaBhdlYgkL0oufdmfXDydNgzcw==";
        };
        _ks24Yz4t = {
            "id" = "ks24Yz4t";
            "file" = "PhoenixCratesLite-6.2.1.jar";
            "hash" = "sha512-4PlHmDx4m4S97rtHAP4L+4etboTi7/CrbJJPbVxipmz1CiemC9vnE/g8n2GZvpptCFi7LM79aSwcCOgikD+aYg==";
        };
    in {
        "sHQI9WeN" = _sHQI9WeN;
        "2bbrOb7t" = _2bbrOb7t;
        ...
        "spigot-1.20.6" = _ks24Yz4t;
        "spigot-1.21" = _ks24Yz4t;
        "spigot-1.21.1" = _ks24Yz4t;
        "spigot-1.20.4" = _ks24Yz4t;
        "spigot-1.21.3" = _ks24Yz4t;
        "spigot-1.8.8" = _Tt4KWqH3;
        "spigot-1.21.4" = _ks24Yz4t;
        "spigot-1.21.2" = _ks24Yz4t;
        "spigot-1.13" = _JLZx4y8x;
        "spigot-1.13.1" = _JLZx4y8x;
        "spigot-1.19.3" = _kXN7VLIV;
        "spigot-1.20" = _ks24Yz4t;
        "spigot-1.20.1" = _ks24Yz4t;
        "spigot-1.20.2" = _ks24Yz4t;
        "spigot-1.20.3" = _ks24Yz4t;
        "spigot-1.20.5" = _ks24Yz4t;
        "spigot-1.21.5" = _ks24Yz4t;
        "spigot-1.21.6" = _ks24Yz4t;
        "spigot-1.21.7" = _ks24Yz4t;
        "spigot-1.10.1" = _KjJg9FRt;
        "spigot-1.21.8" = _ks24Yz4t;
        "spigot-1.14.3" = _Tt4KWqH3;
        "spigot-1.16.4" = _Tt4KWqH3;
        "spigot-1.21.9" = _ks24Yz4t;
        "spigot-1.21.10" = _ks24Yz4t;
        "spigot-1.21.11" = _ks24Yz4t;
        "spigot-26.1" = _ks24Yz4t;
        "spigot-26.1.1" = _ks24Yz4t;
        "spigot-26.1.2" = _ks24Yz4t;
        "spigot-26.2" = _ks24Yz4t;
        "paper-1.21" = _ks24Yz4t;
        "paper-1.21.1" = _ks24Yz4t;
        ...
        "paper-1.20.4" = _ks24Yz4t;
        "paper-1.20.6" = _ks24Yz4t;
        "paper-1.21.3" = _ks24Yz4t;
        "paper-1.8.8" = _Tt4KWqH3;
        "paper-1.21.4" = _ks24Yz4t;
        "paper-1.21.2" = _ks24Yz4t;
        "paper-1.13" = _JLZx4y8x;
        "paper-1.13.1" = _JLZx4y8x;
        "paper-1.19.3" = _kXN7VLIV;
        "paper-1.20" = _ks24Yz4t;
        "paper-1.20.1" = _ks24Yz4t;
        "paper-1.20.2" = _ks24Yz4t;
        "paper-1.20.3" = _ks24Yz4t;
        "paper-1.20.5" = _ks24Yz4t;
        "paper-1.21.5" = _ks24Yz4t;
        "paper-1.21.6" = _ks24Yz4t;
        "paper-1.21.7" = _ks24Yz4t;
        "paper-1.10.1" = _KjJg9FRt;
        "paper-1.21.8" = _ks24Yz4t;
        "paper-1.14.3" = _Tt4KWqH3;
        "paper-1.16.4" = _Tt4KWqH3;
        "paper-1.21.9" = _ks24Yz4t;
        "paper-1.21.10" = _ks24Yz4t;
        "paper-1.21.11" = _ks24Yz4t;
        "paper-26.1" = _ks24Yz4t;
        "paper-26.1.1" = _ks24Yz4t;
        "paper-26.1.2" = _ks24Yz4t;
        "paper-26.2" = _ks24Yz4t;
        ...
        "folia-1.20.1" = _ks24Yz4t;
        "folia-1.20.2" = _ks24Yz4t;
        "folia-1.20.3" = _ks24Yz4t;
        "folia-1.20.4" = _ks24Yz4t;
        "folia-1.20.5" = _ks24Yz4t;
        "folia-1.20.6" = _ks24Yz4t;
        "folia-1.21.1" = _ks24Yz4t;
        "folia-1.21.2" = _ks24Yz4t;
        "folia-1.21.3" = _ks24Yz4t;
        "folia-1.21.4" = _ks24Yz4t;
        "folia-1.21.5" = _ks24Yz4t;
        "folia-1.21.6" = _ks24Yz4t;
        "folia-1.21.7" = _ks24Yz4t;
        "folia-1.10.1" = _KjJg9FRt;
        "folia-1.21" = _ks24Yz4t;
        "folia-1.21.8" = _ks24Yz4t;
        "folia-1.8.8" = _Tt4KWqH3;
        "folia-1.14.3" = _Tt4KWqH3;
        "folia-1.16.4" = _Tt4KWqH3;
        "folia-1.20" = _ks24Yz4t;
        "folia-1.21.9" = _ks24Yz4t;
        "folia-1.21.10" = _ks24Yz4t;
        "folia-1.21.11" = _ks24Yz4t;
        "folia-26.1" = _ks24Yz4t;
        "folia-26.1.1" = _ks24Yz4t;
        "folia-26.1.2" = _ks24Yz4t;
        "folia-1.19.3" = _kXN7VLIV;
        "folia-26.2" = _ks24Yz4t;
        "pkg-3.6" = _sHQI9WeN;
        "pkg-3.7.1" = _2bbrOb7t;
        "pkg-3.7.5" = _tggZLkdX;
        "pkg-3.7.6" = _LFd4TFFB;
