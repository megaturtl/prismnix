...
let
    ...
    in {
        ...
        "pkg-1.16.5-1.8.0-alpha+20210613-1739" = _aOYe2Ba0;
        "pkg-1.16.5-1.8.0-beta.1" = _VISlYsyg;
        "pkg-1.16.5-1.8.0-beta.2" = _clLDukj0;
        "pkg-1.16.5-1.8.0-beta.3" = _9LDsyg5O;
        "pkg-1.16.5-1.8.0-beta.4" = _5lMBPuAV;
        "pkg-1.16.5-1.8.0-beta.5" = _VTLeMb41;
        "pkg-1.16.5-1.8.0" = _uIGZnbaw;
        "pkg-1.16.5-1.8.1" = _lby3E7HT;
        "pkg-1.16.5-1.8.2" = _Ljz4s9yF;
        "pkg-1.17.1-1.8.3-alpha+20211003-1844" = _pRbpVZ2p;
        "pkg-1.17.1-1.8.3-alpha+20211009-1747" = _QX3q7pyG;
        "pkg-1.17.1-1.8.3-alpha+20211016-1640" = _YeZPbFyO;
        "pkg-1.17.1-1.8.3-alpha+20211024-2159" = _GgnsS9hG;
        "pkg-1.16.5-1.8.3" = _aokcdjSP;
        "pkg-1.16.5-1.8.4" = _lSqn6MoU;
        "pkg-1.17.1-1.8.4-beta.1" = _J1MWAqfm;
        "pkg-1.16.5-1.8.5" = _VsAkfdBs;
        "pkg-1.16.5-1.8.6" = _swSmhW3T;
        "pkg-1.18.1-1.8.0-alpha+20211220-2153" = _IjdKQWNi;
        "pkg-1.18.1-1.8.0-alpha+20211221-2217" = _BpgfJUMF;
        "pkg-1.18.1-1.8.0-alpha+20210102-1316" = _GIg5zCCg;
        "pkg-1.18.1-1.8.0-alpha+20220106-2313" = _n8O4c2BZ;
        "pkg-1.18.1-1.8.0-alpha+20220113-1402" = _AOk17JSe;
        "pkg-1.18.1-1.8.0-alpha+20220115-1439" = _WWZHRZ9M;
        "pkg-1.18.1-1.8.0-beta.1" = _YL0RJ7Zc;
        "pkg-1.18.1-1.8.0-beta.2" = _liYqM91s;
        "pkg-1.18.1-1.8.0-beta.3" = _T6L8WY2k;
        "pkg-1.18.1-1.8.0" = _7K0h1ryj;
        "pkg-1.18.1-1.8.1" = _rPS2HpvL;
        "pkg-1.18.2-1.8.2-alpha+20220402-1551" = _de3gLiep;
        "pkg-1.18.2-1.8.2-alpha+20220413-2209" = _gzEAkfdt;
        "pkg-1.18.2-1.8.2-beta.1" = _mxiiV7co;
        "pkg-1.16.5-1.8.7" = _NuGtPZyM;
        "pkg-1.18.2-1.8.2" = _CEyqI007;
        "pkg-1.18.2-1.8.3" = _5g8Cc9NR;
        "pkg-1.16.5-1.8.9" = _un8i8d5b;
        "pkg-1.18.2-1.8.4" = _ke4V0xHI;
        "pkg-1.16.5-1.8.10" = _GaxGSK7u;
        "pkg-1.16.5-1.9.0-alpha+20220724-1604" = _Ab4s28en;
        "pkg-1.16.5-1.9.0-alpha+20220726-2338" = _NXofQMVp;
        "pkg-1.19.1-1.8.0-alpha+20220729-2305" = _2qtZhek3;
        "pkg-1.16.5-1.9.0-alpha+20220807-1755" = _Lj8NYdTu;
        "pkg-1.18.2-1.8.5" = _HXGpIjN7;
        "pkg-1.19.2-1.8.0-beta.1" = _Z2Ykh7ve;
        "pkg-1.16.5-1.9.0-alpha+20220826-2128" = _FyQba8yB;
        "pkg-1.16.5-1.9.0-alpha+20220911-1727" = _F8V2ZsAx;
        "pkg-1.19.2-1.8.0" = _XIneOdgZ;
        "pkg-1.18.2-1.8.6" = _oTxIhmRU;
        "pkg-1.16.5-1.8.11" = _qURVEB1S;
        "pkg-1.16.5-1.9.0-beta.1" = _OF1hXXIm;
        "pkg-1.19.2-1.8.1" = _GVMFTeOX;
        "pkg-1.18.2-1.8.7" = _xTLMUAqQ;
        "pkg-1.19.2-1.9.0-alpha+20221003-1811" = _w9LxRJqO;
        "pkg-1.19.2-1.9.0-alpha+20221022-1224" = _bXrXyS4W;
        "pkg-1.16.5-1.9.0-beta.2" = _UAEWW7IH;
        "pkg-1.19.2-1.9.0-alpha+20221030-1855" = _5oh08bs0;
        "pkg-1.16.5-1.9.0" = _ijoA6fZz;
        "pkg-1.19.2-1.9.0-beta.1" = _ZfwhjkSR;
        "pkg-1.15.2-1.7.2" = _zr5vyX2b;
        "pkg-1.14.4-1.7.1" = _oRZyB8j9;
        "pkg-1.12.2-1.6.2" = _JBd0KUB4;
        "pkg-1.19.2-1.9.0-beta.2" = _2CwevN0Q;
        "pkg-1.18.2-1.8.8" = _v6Dkbqrv;
        "pkg-1.19.2-1.9.0-beta.3" = _TqcwMlL4;
        "pkg-1.19.2-1.9.0" = _2lg8WJRY;
        "pkg-1.16.5-1.9.1" = _pl6JqxEx;
        "pkg-1.19.3-1.9.0-alpha+20230102-2249" = _buNDa3qO;
        "pkg-1.19.2-1.9.1" = _9cau0FG4;
        "pkg-1.19.3-1.9.0-alpha+20230122-1324" = _sRMZ1bdT;
        "pkg-1.19.3-1.9.0-beta.1" = _BfwYdQPX;
        "pkg-1.19.2-1.9.2" = _XV0hVyOM;
        "pkg-1.16.5-1.9.2" = _2SZt9JCP;
        "pkg-1.16.5-1.9.3" = _SSrGR07X;
        "pkg-1.19.2-1.9.3" = _tFLkPSbu;
        "pkg-1.19.3-1.9.0" = _eehF8sk5;
        "pkg-1.19.4-1.9.0-alpha+20230324-1759" = _uaSiTzhn;
        "pkg-1.19.2-1.9.4" = _7WE5gd8P;
        "pkg-1.19.4-1.9.0-alpha+20230402-1700" = _G0oZLny8;
        "pkg-1.19.3-1.9.1" = _d5cZapqN;
        "pkg-1.16.5-1.9.4" = _BqyEC0uC;
        "pkg-1.16.5-1.9.6" = _WtEZYy3f;
        "pkg-1.19.4-1.9.0-beta.1" = _qk253B3k;
        "pkg-1.16.5-1.9.7" = _7SVvIav3;
        "pkg-1.19.4-1.9.0" = _2G4ctyJh;
        "pkg-1.16.5-1.9.8" = _QtWtYXAh;
        "pkg-1.20.1-1.9.1-alpha+20230621-1954" = _iT3HE88a;
        "pkg-1.16.5-1.9.9" = _MgijeHVt;
        "pkg-1.19.4-1.9.1" = _IvfZkMLG;
        "pkg-1.20.1-1.9.1-beta.1" = _NFnVltts;
        "pkg-1.20.1-1.9.1-beta.2" = _yYcBZAmw;
        "pkg-1.19.2-1.9.5" = _7BF7QCkO;
        "pkg-1.19.4-1.9.2" = _OYqN9sL5;
        "pkg-1.20.1-1.9.1" = _2GayMFrR;
        "pkg-1.20.1-1.9.2" = _YNk0zH78;
        "pkg-1.16.5-1.9.10" = _jnletJgi;
        "pkg-1.20.1-1.9.3" = _UgxMzQpX;
        "pkg-1.19.4-1.9.3" = _GR3MBTdE;
        "pkg-1.10.0-alpha+20231113-1916" = _ED1NnfRN;
        "pkg-1.10.0-alpha+20231122-1750" = _G8jBcAAO;
        "pkg-1.20.1-1.10.0-beta.1" = _5gWcqZT5;
        "pkg-1.20.1-1.10.0-beta.2" = _aDhclPv5;
        "pkg-1.20.1-1.10.0-beta.3" = _nbcXTJK7;
        "pkg-1.20.1-1.10.0-beta.4" = _PgLyZcEZ;
        "pkg-1.20.1-1.10.0" = _mW5DEeJ7;
        "pkg-1.20.1-1.10.1" = _yw5dSY16;
        "pkg-1.20.1-1.10.2" = _xHmuOTNO;
        "pkg-1.20.1-1.10.3" = _xn3Sjvwq;
        "pkg-1.20.1-1.10.4" = _LlvKCRWe;
        "pkg-1.20.1-1.10.5" = _tpJdHCMz;
        "pkg-1.20.4-1.10.0-alpha+240118-1939" = _U1qZPWK5;
        "pkg-1.10.6" = _OIEoTUjz;
        "pkg-1.20.4-1.10.0-alpha+240209-1903" = _bgbD3miC;
        "pkg-1.20.4-1.10.0-beta.1" = _xjT93cic;
        "pkg-1.20.4-1.10.0-beta.2" = _zZwG3fod;
        "pkg-1.10.7" = _WjQnLRdy;
        "pkg-1.20.4-1.10.0" = _S1X7sHux;
        "pkg-1.20.4-1.10.1" = _jGaaLqjO;
        "pkg-1.20.4-1.10.2" = _vYg5imNb;
        "pkg-1.20.4-1.10.3" = _Qg3uKDk2;
        "pkg-1.20.6-1.10.0-alpha+240515-1533" = _oCbnClWy;
        "pkg-1.20.1-1.10.8" = _lC12TTQW;
        "pkg-1.20.6-1.10.0-beta.1" = _jIT7UXSR;
        "pkg-1.21-1.10.0-alpha+240623-1409" = _nHsuPXZR;
        "pkg-1.20.6-1.10.0" = _YOw1O7SA;
        "pkg-1.21-1.10.0-alpha+240708-2028" = _c3fZol2n;
        "pkg-1.20.1-1.10.9" = _Y7J6O0s9;
        "pkg-1.21-1.10.0-alpha+240712-1751" = _rXEYiT6d;
        "pkg-1.21-1.10.0-alpha+240719-2326" = _1YVpUUqc;
        "pkg-1.21-1.10.0-beta.1" = _ohTWGW0o;
        "pkg-1.21-1.10.0-beta.2" = _c8u8EAc5;
        "pkg-1.20.1-1.10.10" = _cgQgFoj8;
        "pkg-1.21-1.10.0" = _cmkmKhKB;
        "pkg-1.10.11" = _NgzhGmo0;
        "pkg-1.21-1.10.1" = _Q9HcWELJ;
        "pkg-1.21-1.10.2" = _m72ye2Lr;
        "pkg-1.10.12" = _FP5CsB4Z;
        "pkg-1.10.3" = _k5e26Qh4;
        "pkg-1.10.13" = _dBEdKX9l;
        "pkg-1.21-1.10.4" = _3bGE3oss;
        "pkg-1.21-1.10.5" = _vKI0bJ6m;
        "pkg-1.21-1.10.6" = _Dve3PSoR;
        "pkg-1.21-1.10.7" = _4kzyBa4H;
        "pkg-1.21-1.10.8" = _kIXSjBpi;
        "pkg-1.21-1.10.9" = _BMpl0c3k;
        "pkg-1.21-1.10.10" = _ugUZ9VU0;
        "pkg-1.20.1-1.10.14" = _q58oLVOH;
        "pkg-1.20.1-1.10.15" = _cXTYa0Ok;
