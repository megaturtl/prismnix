...
let
    ...
    in {
        ...
        "pkg-1.3-fabric-1.1.1" = _WZjW6dGw;
        "pkg-1.4-fabric-1.0.0" = _NEfijgjp;
        "pkg-1.4-forge-1.0.0" = _fsnqXuKJ;
        "pkg-1.3-fabric-1.2.0" = _szQKtNUm;
        "pkg-1.4-fabric-1.1.0" = _pQQDGOyg;
        "pkg-1.4-forge-1.1.0" = _YWcCrirl;
        "pkg-1.4-fabric-1.1.1" = _dmr4UTBr;
        "pkg-1.3-fabric-1.2.1" = _8pJzadCF;
        "pkg-1.4-fabric-1.2.0" = _5XqITbEm;
        "pkg-1.4-forge-1.2.0" = _4frdo2YN;
        "pkg-1.4-fabric-1.3.0" = _wE2YeGju;
        "pkg-1.3-fabric-1.3.0" = _ysruduMP;
        "pkg-1.4-forge-1.3.0" = _LQmbp5Xa;
        "pkg-1.4-forge-1.3.1" = _xEpjIdQs;
        "pkg-1.3-fabric-1.3.1" = _yF5ZXeQO;
        "pkg-1.4-fabric-1.3.1" = _FfO2dAyF;
        "pkg-1.4-fabric-1.4.0" = _WchzHe3y;
        "pkg-1.3-fabric-1.4.0" = _7KRpB3VO;
        "pkg-1.4-forge-1.4.0" = _Es6qUyZF;
        "pkg-1.3-fabric-1.5.0" = _6vYBjaLN;
        "pkg-1.4-fabric-1.5.0" = _14mTwE8W;
        "pkg-1.4-forge-1.5.0" = _zgURXgD4;
        "pkg-1.5-fabric-1.0.0" = _vijceoCW;
        "pkg-1.5-forge-1.0.0" = _4AKC1y6J;
        "pkg-1.5-forge-1.0.1" = _gKoA4h6S;
        "pkg-1.5-fabric-1.1.0" = _1ldEHL5c;
        "pkg-1.5-fabric-1.1.1" = _LtjYb8iG;
        "pkg-1.5-fabric-1.1.2" = _djz6JWcS;
        "pkg-1.5-forge-1.1.0" = _L7mvSyUY;
        "pkg-1.5-forge-1.1.1" = _vBp4shju;
        "pkg-1.5-fabric-1.1.3" = _RdxDFkBI;
        "pkg-1.5-fabric-1.1.4" = _bWXWEg39;
        "pkg-1.5-forge-1.1.2" = _jNjXmLbJ;
        "pkg-1.5-fabric-1.1.5" = _6iv1YQ8q;
        "pkg-1.5-forge-1.1.3" = _dOZdhSxy;
        "pkg-1.5-forge-1.2.0" = _nJpIwObx;
        "pkg-1.5-fabric-1.2.0" = _AT46iKEy;
        "pkg-1.6-fabric-1.0.1" = _A0zXSGGv;
        "pkg-1.6-fabric-1.1.0" = _oZVoGKQE;
        "pkg-1.6-fabric-1.2.0" = _SrC2K8Os;
        "pkg-1.6-fabric-1.3.0" = _1e6JvCKz;
        "pkg-1.6-fabric-1.3.1" = _6kSMeH0Q;
        "pkg-1.6-neoforge-1.3.1" = _uhFneTXw;
        "pkg-1.6-neoforge-1.3.2" = _ZwwbgGC3;
        "pkg-1.6-neoforge-1.3.3" = _DQfND2mD;
        "pkg-1.6-neoforge-1.3.4" = _73bhYZIA;
        "pkg-1.6-fabric-1.3.5" = _9mLAR8N1;
        "pkg-1.6-neoforge-1.3.5" = _9DQKzQbi;
        "pkg-1.6-fabric-1.3.6" = _sAG8RWIE;
        "pkg-1.6-neoforge-1.3.6" = _eIhc0SIH;
        "pkg-1.6-fabric-1.4.0" = _WqzwlcxU;
        "pkg-1.6-neoforge-1.4.0" = _25D7uj3T;
        "pkg-1.6-fabric-1.5.0" = _loRaF5XK;
        "pkg-1.6-neoforge-1.5.0" = _oNYoInkO;
        "pkg-1.6-neoforge-1.5.1" = _4NXvB2jm;
        "pkg-1.6.1-fabric-1.5.2" = _JKYNl5Jl;
        "pkg-1.6.1-neoforge-1.5.2" = _ZM0NqeAZ;
        "pkg-1.6.1-fabric-1.6.0" = _gWV5p6xj;
        "pkg-1.6.1-neoforge-1.6.0" = _gxuWVaSt;
        "pkg-1.6.1-fabric-1.6.1" = _ReIkCnf8;
        "pkg-1.6.1-neoforge-1.6.1" = _1QP71O1A;
        "pkg-1.6.1-fabric-1.6.2" = _EE7Wk4vc;
        "pkg-1.6.1-neoforge-1.6.2" = _41JBXSzM;
        "pkg-1.6.1-fabric-1.6.3" = _ebDiFn3m;
        "pkg-1.6.1-neoforge-1.6.3" = _von45M10;
        "pkg-1.7.0-fabric-1.7.0" = _VVZduk22;
        "pkg-1.7.0-neoforge-1.7.0" = _sqKoGUIg;
        "pkg-1.7.1-fabric-1.8.0" = _HjGRbKy3;
        "pkg-1.7.1-neoforge-1.8.0" = _v9SMD1hx;
        "pkg-1.7.1-fabric-1.8.1" = _2Nil2M9k;
        "pkg-1.7.1-neoforge-1.8.1" = _kp8hVifR;
        "pkg-1.7.1-fabric-1.9.0" = _psqnqmHh;
        "pkg-1.7.1-neoforge-1.9.0" = _v5gca3gH;
        "pkg-1.7.2-fabric-1.9.0" = _CgWLHMcu;
