...
let
    versions = (let
        ...
        _OtMhcUej = {
            "id" = "OtMhcUej";
            "file" = "FCL-12.116.jar";
            "hash" = "sha512-RRWSz7Kq9TAQFR7XaOJFqWS3BiiW10aOyjJugT2J32JLpbMUPPvlKyPtW9AF9p1f4zXXpdUgYv8rkSEoGSrbIg==";
        };
        _xRA4Htj7 = {
            "id" = "xRA4Htj7";
            "file" = "fcl-20.43.jar";
            "hash" = "sha512-vVacr57hiPETAzvvbBtwEjF85y82gHReMpLQdmq1srhKm2kxkkqPuvCYxxJkKm4G0zyz6huORXkgBTjy0dcXLQ==";
        };
        _9NDlrhmh = {
            "id" = "9NDlrhmh";
            "file" = "fcl-26.8.jar";
            "hash" = "sha512-aAzPCCXb8s55/SbNpg3v9JaR3gLWT5I2H8VSl9VESy+T8a5iJdo8TrNNs8vcZGCkZfFlLDonAuS5C9JhvZl4uw==";
        };
        _z8SJNIET = {
            "id" = "z8SJNIET";
            "file" = "FCL-12.116b.jar";
            "hash" = "sha512-SW1LtkmXrv6ZLEkIlhSEwfjKjM8FML2vLkj12wH3YWpPwLBQHEQiG4y/pntcVGSFgJySWXKA4vYbbxJOisnHVg==";
        };
        _6Yj50XtG = {
            "id" = "6Yj50XtG";
            "file" = "FCL-12.117.jar";
            "hash" = "sha512-gtPKyOk+ZxYnAZvL0E/xlGkHn4GdWKVAxZ24szE36FMhkzbRExHIp/PFhntosJKdXkdHMPyvUfIPiTOfwCDsjg==";
        };
        _OvLixfH6 = {
            "id" = "OvLixfH6";
            "file" = "fcl-20.44.jar";
            "hash" = "sha512-edG/NOl40mtloQKBIEajoJjuGr1dkpNcYwmTt9f3Njh5p7rSoHjva+7NeTjVI5IyL4G6iGUnKsEt6GVP00IkMw==";
        };
        _H44Hv2Lr = {
            "id" = "H44Hv2Lr";
            "file" = "fcl-26.9.jar";
            "hash" = "sha512-INg3KcJcLLfvAUfs5JVLjOy18/6XWPAT5ArjiAO6XKJhUhXA4YJJbiTxtDIkjMYIlCILG2AlMzy7nvGLRCPgBg==";
        };
        _MES1A3EO = {
            "id" = "MES1A3EO";
            "file" = "FCL-12.118.jar";
            "hash" = "sha512-lve4McocdF73UwCR/78l1avbtylXdCdh8sHVUy743fRzucOcJimfJiI3x+N9EsUm5WUQmkBBAUxlmN5/cqY+IQ==";
        };
        _682BJJT4 = {
            "id" = "682BJJT4";
            "file" = "fcl-20.45.jar";
            "hash" = "sha512-yeP1Pqtf2BdSicUMAClNzsK/AYfCzV0JisW97vMejulr77j58lOmGloN5Wi1kD7c2fAln2Mae2PGt5agzDhFNg==";
        };
        _g10ZuU6Y = {
            "id" = "g10ZuU6Y";
            "file" = "fcl-26.10.jar";
    ...
    in {
        ...
        "pkg-1.12.81" = _4qbCUxnw;
        "pkg-1.12.82c" = _A5ACsf1B;
        "pkg-20.1" = _FcJl4xRC;
        "pkg-20.2" = _6YOumhVH;
        "pkg-20.3" = _CezKZ1Tb;
        "pkg-20.4" = _mabez25q;
        ...
        "pkg-20.9" = _7zPeQu2F;
        "pkg-20.10" = _hJoZQWce;
        "pkg-20.10b" = _SAGV6aV3;
        "pkg-12.83" = _p0QtT9PH;
        "pkg-12.83b" = _DNOD0TLq;
        "pkg-20.10c" = _3j0bQJtB;
        "pkg-20.11" = _RQFcU1DD;
        "pkg-20.11b" = _5oHsjTo0;
        "pkg-12.84" = _vRVlVec4;
        "pkg-20.11c" = _Rpp1eyy3;
        "pkg-12.84b" = _dWsl87Tf;
        "pkg-12.85" = _WaGmAc54;
        "pkg-20.12" = _lNhVkAco;
        "pkg-12.85b" = _1WgduLLa;
        "pkg-20.12b" = _8B2mzSbf;
        "pkg-12.86" = _dC5tEjJz;
        "pkg-20.13" = _IZTeLWT1;
        "pkg-20.14" = _epsQVDzn;
        "pkg-20.15" = _qg1E3Am7;
        ...
        "pkg-12.88" = _fQG1oDLP;
        "pkg-20.16" = _8Z27y2zi;
        "pkg-20.16b" = _VTj4Gy4J;
        "pkg-21.1" = _bRehm98w;
        "pkg-20.17" = _C4WFCyyh;
        "pkg-12.89" = _E8eaQ5gN;
        "pkg-20.17b" = _N0ZbRrrG;
        "pkg-21.2" = _hkJtYmxa;
        "pkg-12.90" = _oRQYbKrz;
        "pkg-20.18" = _rTmL71xB;
        "pkg-20.19" = _e3lOREVu;
        "pkg-21.3" = _MOecMkjo;
        "pkg-12.91" = _yVuVBBVY;
        "pkg-20.19b" = _VFpqUL3T;
        "pkg-12.91b" = _I0GgcLsh;
        "pkg-20.20" = _XW40l92k;
        "pkg-12.91c" = _coV7DW9V;
        "pkg-12.91d" = _kmPkSGOH;
        "pkg-12.92" = _2grJ3WHV;
        "pkg-20.21" = _se6qdP8N;
        "pkg-21.4" = _dcNXozlI;
        "pkg-21.5" = _CyAPc8yD;
        "pkg-21.5b" = _RizBNxfW;
        "pkg-12.92b" = _vfCbhAiN;
        "pkg-12.93" = _VPgpzImY;
        "pkg-20.22" = _NZf09hPl;
        "pkg-21.6" = _HLamHOq6;
        "pkg-21.7" = _tqb4ElXh;
        "pkg-12.94" = _tyZa8mTE;
        "pkg-20.23" = _YMcJzso8;
        "pkg-20.23b" = _kBUEbnZf;
        "pkg-21.7b" = _meE9zLUM;
        "pkg-12.94c" = _FKfSOyVL;
        "pkg-20.23c" = _rT00IqGx;
        "pkg-21.7c" = _qQIwcwsq;
        "pkg-21.7d" = _shus3j9w;
        "pkg-21.8" = _Ih9XeEsO;
        "pkg-21.8b" = _etlrfRX8;
        ...
        "pkg-20.28" = _gSRo0yXZ;
        "pkg-21.13" = _DxuUdLjo;
        "pkg-12.100" = _oeYUTgHj;
        "pkg-20.29" = _1udjegTr;
        "pkg-21.14" = _N9F5NbHm;
        "pkg-12.101" = _QE8jJoCm;
        "pkg-20.30" = _Q0cGE6k5;
        "pkg-21.15" = _drMwwzCS;
        "pkg-21.15b" = _Oh1KjXVo;
        "pkg-12.102" = _DhOTcoOd;
        "pkg-20.31" = _2dr2mHwq;
        "pkg-21.16" = _TLWQKosf;
        "pkg-21.17" = _KnepDwp7;
        "pkg-21.17b" = _DdSF9BDC;
        "pkg-21.18" = _cAEGawPT;
        "pkg-12.103" = _oQEWYcxO;
        "pkg-20.32" = _Apv096bg;
        "pkg-21.19" = _sUIdKrFT;
        "pkg-21.19b" = _xSfupWSE;
        "pkg-12.104" = _PJkE9XRm;
        "pkg-20.33" = _e8lXUr41;
        "pkg-21.20" = _dwlWJXev;
        "pkg-12.105" = _9BL1aOch;
        "pkg-20.34" = _7V2pxUUo;
        "pkg-21.21" = _dW6RlDPt;
        "pkg-12.106" = _Xr5ruQFx;
        "pkg-20.35" = _weMXI2or;
        "pkg-21.22" = _uCwwGhmZ;
        "pkg-12.107" = _4lhjmskT;
        "pkg-12.107b" = _ROV8arun;
        "pkg-20.35b" = _7sJXXgLJ;
        "pkg-21.22b" = _nRfcb2VX;
        "pkg-12.108" = _iUChRFFl;
        "pkg-20.36" = _zrgzvIQK;
        "pkg-21.23" = _4ZjPvJyl;
        "pkg-12.109" = _dr1YsaMa;
        "pkg-20.37" = _McTaZZFk;
        "pkg-21.24" = _WSMRdBEk;
        "pkg-12.110" = _uacBYSAx;
        "pkg-20.38" = _JvXbORla;
        "pkg-21.25" = _vx0hnrPh;
        "pkg-21.26" = _V4cqsBzK;
        "pkg-20.38b" = _EBriHMVr;
        "pkg-12.110b" = _uagFxlNv;
        "pkg-26.1" = _mFupWUgR;
        "pkg-26.1b" = _Y7F0bGcm;
        "pkg-26.2" = _ROiKCn9L;
        "pkg-12.111" = _A6Dw6u2l;
        "pkg-20.39" = _KMeBGV6h;
        "pkg-26.3" = _BTjOB0kS;
        "pkg-26.4" = _eYaYocfO;
        "pkg-12.112" = _9kTmvT9Z;
        "pkg-12.113" = _bPwURB4P;
        "pkg-20.40" = _LwUDsDXw;
        "pkg-26.5" = _Vx1OdEpf;
        "pkg-12.114" = _yzTyxOFq;
        "pkg-20.41" = _nVngjwZ5;
        "pkg-26.6" = _8PKwbTNB;
        "pkg-12.115" = _Dwu3LZGX;
        "pkg-20.42" = _ut44XQU4;
        "pkg-26.7" = _jv7svt5H;
        "pkg-12.116" = _OtMhcUej;
        "pkg-20.43" = _xRA4Htj7;
        "pkg-26.8" = _9NDlrhmh;
        "pkg-12.116b" = _z8SJNIET;
        "pkg-12.117" = _6Yj50XtG;
        "pkg-20.44" = _OvLixfH6;
        "pkg-26.9" = _H44Hv2Lr;
