...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _FsoLIMq8;
        "pkg-1.0.9" = _k5arCs0s;
        "pkg-1.0.10" = _Ku72J71f;
        "pkg-1.0.11" = _J9RYFgwM;
        "pkg-1.0.12" = _afCiCBpZ;
        "pkg-1.0.13" = _xD0zPR9m;
        "pkg-1.0.14" = _zuZFpVNx;
        "pkg-1.0.15" = _9L5H1akn;
        "pkg-1.0.16" = _Jhjm2o2M;
        "pkg-1.0.17" = _iL5cxTgK;
        "pkg-1.0.18" = _JdlxHVnZ;
