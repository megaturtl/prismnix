...
let
    ...
    in {
        ...
        "pkg-1.0.8" = _oGrsSxe6;
        "pkg-1.0.9" = _3FoWfWuo;
        "pkg-1.0.10" = _Q0WyaZYJ;
        "pkg-1.0.11" = _IUx4XyAu;
        "pkg-1.0.12" = _NTxmM1RN;
        "pkg-1.0.13" = _FJ9LJFxN;
        "pkg-1.0.14" = _TRDXi6Wt;
        "pkg-1.0.15" = _vEBjyiFO;
        "pkg-1.0.16" = _YVsF8HU1;
        "pkg-1.0.17" = _UMKZGzXL;
        "pkg-1.0.18" = _i8ivWCnw;
