...
let
    ...
    in {
        ...
        "pkg-0.3.8" = _YCpraFCt;
        "pkg-0.3.9" = _F75W7HML;
        "pkg-1.20.1-0.3.9" = _rlNTRr2e;
        "pkg-1.20.1-0.3.10" = _chakoRye;
        "pkg-1.18.2-0.3.10" = _A0FWRrWP;
        "pkg-1.18.2-0.3.11" = _4GaJKJoH;
        "pkg-1.20.1-0.3.11" = _JxB3gBzc;
        "pkg-1.20.2-0.3.11" = _MQ7NrqXP;
        "pkg-1.20.4-0.3.11" = _R5GPVXYM;
        "pkg-1.20.6-0.3.12-sakura.10" = _ihpACjLo;
        "pkg-1.21.1-0.3.12-sakura.6" = _z0xh6sMT;
        "pkg-1.21.3-0.3.12-sakura.11" = _z2qcVCET;
        "pkg-1.21.1-0.3.13-sakura.3" = _BFaPijMg;
        "pkg-1.21.3-0.3.13-sakura.3" = _ekSKfRb9;
        "pkg-1.21.4-0.3.13-sakura.3" = _VcTr3AYo;
        "pkg-1.21.3-0.3.14" = _Qh0plSq3;
        "pkg-1.21.4-0.3.14" = _PpQoWWxV;
        "pkg-1.21.5-0.3.14" = _7Ma32dRR;
        "pkg-1.21.1-0.3.14" = _5tVZej2i;
        "pkg-0.3.15" = _fZivQYGD;
        "pkg-0.3.16" = _buY4n8tz;
