...
let
    versions = (let
        ...
        _czhbjEG2 = {
            "id" = "czhbjEG2";
            "file" = "jamboree-0.0.20+1.21.jar";
            "hash" = "sha512-vgP/NChDQiFYRAuonBG16LAo9tKh9arveWpQqDrn3SazRYEvvrvsejoFi108y/4CqkqE4LIZSzNGVps0gkZ2wQ==";
        };
        _hIDX9P4J = {
            "id" = "hIDX9P4J";
            "file" = "jamboree-0.0.20+1.21.9.jar";
            "hash" = "sha512-ovu+QKjLuKOzVioCB2JWzFCf8vyJ9BsnMOo3Ui/42Jgvk+gzJimsb0JtgjH/ImJOolBYInUnsmNYzS1EF/sCGA==";
        };
        _km5k3sb0 = {
            "id" = "km5k3sb0";
            "file" = "jamboree-0.0.20+1.21.11.jar";
            "hash" = "sha512-ef0wxxttsAlAgwPaxbKZM7MGuRt/ccePHMRf1kcz3OPz9qMliiqF32owPJMstP2jQk6eKOrHq9GFyHiHV2rLdQ==";
        };
        _90Q6AFBE = {
            "id" = "90Q6AFBE";
            "file" = "jamboree-0.0.20+26.1.jar";
            "hash" = "sha512-4NQ3VQ1vhGQRMwIyyFjocEvl7ej/roC1RCwyATlrNetqgT2l/mSRA3YkW233s4MxngPdjtHd+iwVeL6/PR1k3Q==";
        };
        _kHgToqYr = {
            "id" = "kHgToqYr";
            "file" = "jamboree-0.0.20+26.2.jar";
            "hash" = "sha512-6igOsyZTMI5wTYg+CY4S0vm2XDtAIXb91FMjfuC58nYKYP40ub8GJFstfM4vfeADquGNdvUSIJVwSEb4abMVZg==";
        };
        _i0lNLoZm = {
            "id" = "i0lNLoZm";
            "file" = "jamboree-0.0.20+26.3.jar";
            "hash" = "sha512-XIo5vDUTPVC4Jt9EhQ3cLnSee7f9mSzaNUll0jmmrWizPk0QEXwzmDMPJ6VcnJh8tyUKcH3Ul++XrAExyS+yXw==";
        };
    in {
        "hyRGVNXl" = _hyRGVNXl;
        "azqAiHoz" = _azqAiHoz;
        ...
        "kHgToqYr" = _kHgToqYr;
        "i0lNLoZm" = _i0lNLoZm;
        "fabric-1.21.1" = _czhbjEG2;
        "fabric-1.21.2" = _czhbjEG2;
        "fabric-1.21.3" = _czhbjEG2;
        "fabric-1.21.4" = _czhbjEG2;
        "fabric-1.21.5" = _czhbjEG2;
        "fabric-1.21.6" = _czhbjEG2;
        "fabric-1.21.7" = _czhbjEG2;
        "fabric-1.21.8" = _czhbjEG2;
        "fabric-1.21.9" = _hIDX9P4J;
        "fabric-1.21.10" = _hIDX9P4J;
        "fabric-1.21.11" = _km5k3sb0;
        "fabric-1.21" = _czhbjEG2;
        "fabric-26.1" = _90Q6AFBE;
        "fabric-26.1.1" = _90Q6AFBE;
        "fabric-26.1.2" = _90Q6AFBE;
        "fabric-26.2" = _kHgToqYr;
        "fabric-26.3" = _i0lNLoZm;
        "pkg-0.0.1" = _hyRGVNXl;
        "pkg-0.0.2+1.21.1" = _azqAiHoz;
        "pkg-0.0.2+1.21.4" = _ZRI0oquS;
        "pkg-0.0.3+1.21.1" = _VEssJLNn;
        "pkg-0.0.3+1.21.4" = _YMQmtWaw;
        "pkg-0.0.4+1.21.1" = _pXS3GDfb;
        "pkg-0.0.4+1.21.4" = _9og1F8nT;
        "pkg-0.0.5+1.21.1" = _xIzcYOYO;
        "pkg-0.0.5+1.21.4" = _VRJW1ouj;
        "pkg-0.0.6+1.21.1" = _wgJkBy2T;
        "pkg-0.0.6+1.21.4" = _GoXtvOnY;
        "pkg-0.0.7+1.21.1" = _QRcXDyZw;
        "pkg-0.0.7+1.21.4" = _DmiKT5EY;
        "pkg-0.0.8+1.21.1" = _Cirxw7wd;
        "pkg-0.0.8+1.21.4" = _mSnuu6bg;
        "pkg-0.0.9+1.21.1" = _8NwJoPll;
        "pkg-0.0.9+1.21.4" = _1CbF73ig;
        "pkg-0.0.10+1.21.1" = _d3YfTzlu;
        "pkg-0.0.10+1.21.4" = _HIJ7qMe8;
        "pkg-0.0.11+1.21.1" = _TyypuccL;
        "pkg-0.0.11+1.21.4" = _zpfFGxCe;
        "pkg-0.0.12+1.21.1" = _hMHvzRAH;
        "pkg-0.0.12+1.21.4" = _IkOGs6gX;
        "pkg-0.0.13+1.21.1" = _dYgzT5Y5;
        "pkg-0.0.13+1.21.4" = _GyTj56w8;
        "pkg-0.0.13+1.21.9" = _Tq9urHkt;
        "pkg-0.0.13+1.21.10" = _VcS5PFYc;
        "pkg-0.0.14+1.21.1" = _6StyKRP0;
        "pkg-0.0.14+1.21.4" = _XXKsKaJ2;
        "pkg-0.0.14+1.21.9" = _ERApDH3m;
        "pkg-0.0.14+1.21.10" = _BCWRGbYb;
        "pkg-0.0.15+1.21.1" = _7h9rFMby;
        "pkg-0.0.15+1.21.4" = _ZE4zj4bY;
        "pkg-0.0.15+1.21.9" = _STmoYgvy;
        "pkg-0.0.15+1.21.10" = _NOzR571r;
        "pkg-0.0.16+1.21" = _Zk0YxSP2;
        "pkg-0.0.16+1.21.4" = _EpxGzWWL;
        "pkg-0.0.16+1.21.9" = _vEjO0lSy;
        "pkg-0.0.16+1.21.11" = _k9nrZ35j;
        "pkg-0.0.17+1.21" = _8JFjpvSI;
        "pkg-0.0.17+1.21.4" = _XGnCe4tl;
        "pkg-0.0.17+1.21.9" = _u4wHkGD1;
        "pkg-0.0.17+1.21.11" = _OwEAsOjZ;
        "pkg-0.0.18+1.21" = _Y4HT45fS;
        "pkg-0.0.18+1.21.4" = _TszzJHqJ;
        "pkg-0.0.18+1.21.9" = _oUxnLKjg;
        "pkg-0.0.18+1.21.11" = _EdsTZb3l;
        "pkg-0.0.18+26.1" = _PtbdvQwe;
        "pkg-0.0.19+1.21" = _RwgKNDxS;
        "pkg-0.0.19+1.21.9" = _JOzoUw3R;
        "pkg-0.0.19+1.21.11" = _nY1Y4uUz;
        "pkg-0.0.19+26.1" = _P1XtKZIq;
        "pkg-0.0.19+26.2" = _USEsyql8;
        "pkg-0.0.20+1.21" = _czhbjEG2;
        "pkg-0.0.20+1.21.9" = _hIDX9P4J;
        "pkg-0.0.20+1.21.11" = _km5k3sb0;
        "pkg-0.0.20+26.1" = _90Q6AFBE;
        "pkg-0.0.20+26.2" = _kHgToqYr;
        "pkg-0.0.20+26.3" = _i0lNLoZm;
        "default" = _i0lNLoZm;
    });
