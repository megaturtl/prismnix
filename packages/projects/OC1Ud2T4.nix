...
let
    ...
    in {
        ...
        "pkg-0.0.6+1.21" = _9OqeGPR2;
        "pkg-0.0.6+1.21.3" = _Gegh5YO0;
        "pkg-0.0.6+1.21.4" = _gCv3ZCUr;
        "pkg-0.0.7+1.21.3" = _qFYO1sqv;
        "pkg-0.0.7+1.21.4" = _3W2qLJA4;
        "pkg-0.0.8+1.21" = _AckuiHr2;
        "pkg-0.0.8+1.21.3" = _jvB7p4fR;
        "pkg-0.0.8+1.21.4" = _dd8rqeGh;
        "pkg-0.0.9+1.21" = _j9GJ9vro;
        "pkg-0.0.9+1.21.3" = _w5pxBeo8;
        "pkg-0.0.9+1.21.4" = _huX6HyjT;
        "pkg-0.0.10+1.21" = _UFICBcFW;
        "pkg-0.0.10+1.21.3" = _38jXsB31;
        "pkg-0.0.10+1.21.4" = _gKfjaR31;
        "pkg-0.0.11+1.21" = _uEqYqdeH;
        "pkg-0.0.11+1.21.3" = _PzLCIK94;
        "pkg-0.0.11+1.21.4" = _g64tRoEW;
        "pkg-0.0.12+1.21" = _h6OgDj1C;
        "pkg-0.0.12+1.21.3" = _yh5VoEMt;
        "pkg-0.0.12+1.21.4" = _wHsMNYMG;
        "pkg-0.0.13+1.21" = _SqUU1eWk;
        "pkg-0.0.13+1.21.3" = _fCJYLd6q;
        "pkg-0.0.13+1.21.4" = _G3CUOy9v;
        "pkg-0.0.14-1.21" = _xHBTK6gT;
        "pkg-0.0.14+1.21.3" = _wrgRC89H;
        "pkg-0.0.14+1.21.4" = _xp1cnDGN;
        "pkg-0.0.14+1.21.8" = _80fWjV6v;
        "pkg-0.0.14+1.21.10" = _u4o2jrCW;
        "pkg-0.0.15+1.21.8" = _4JrfVzTQ;
