...
let
    ...
    in {
        ...
        "pkg-2.4.33" = _D0yhjMKk;
        "pkg-3.0.0+3" = _j9LAEIOe;
        "pkg-3.0.0+4" = _lGm9LoNY;
        "pkg-3.0.0+5" = _sK0TQLJG;
        "pkg-3.0.1+2" = _bUDdTMKy;
        "pkg-2.4.34" = _wcra71m2;
        "pkg-3.0.1+4" = _1bXqtCYW;
        "pkg-3.0.1+5" = _8mZAQusv;
        "pkg-2.4.35" = _PSHS2Kyf;
        "pkg-2.4.36" = _BTTYxVt1;
        "pkg-3.0.2" = _D2uavk4t;
        "pkg-3.0.3" = _P3nqACbd;
        "pkg-2.4.37" = _Zs3YiAOq;
        "pkg-3.0.4" = _Xcu3Vyyv;
        "pkg-2.5.0" = _7900dqeb;
        "pkg-3.0.5" = _bziiiPdS;
        "pkg-3.0.6" = _rMKOCXqw;
        ...
        "pkg-3.0.8" = _DmV7kIA4;
        "pkg-3.0.9" = _OCL681ep;
        "pkg-3.0.11" = _wVhKAzfX;
        "pkg-3.0.12" = _5jvhm0dF;
        "pkg-2.5.1" = _LsT3l3jp;
        "pkg-3.0.13" = _nwHN7X2p;
        "pkg-2.5.2" = _ITbn27cm;
        "pkg-3.0.14" = _P9doF484;
        "pkg-2.5.3" = _rJafW3tD;
        "pkg-2.5.4" = _T1AxyyUw;
        "pkg-3.0.15" = _2A5n6JhY;
        "pkg-3.0.16" = _8wBvyNMf;
        "pkg-2.6.0" = _g6QN5MFV;
        "pkg-3.1.0" = _8sIlqETt;
        "pkg-3.1.1" = _5eYv9BUW;
        "pkg-2.6.1" = _rh7XMvJI;
