...
let
    versions = (let
        ...
        _c8quWcaD = {
            "id" = "c8quWcaD";
            "file" = "casting-26.1.2-3.9.14.jar";
            "hash" = "sha512-39GeA/oi1zeTJ8jmX48CWgGAbSDmNzD/gUvonW/5xklsY0vDvpV4W9l+htwn6DL3+jZBFI7zlDF4Kq1A1FhFlA==";
        };
        _Z7HcSAzg = {
            "id" = "Z7HcSAzg";
            "file" = "casting-26.1.2-3.9.15.jar";
            "hash" = "sha512-G56KuojfiZ3xkOqlAsvdJaGf/yf9+d6NYK4EYKogZLtw/KuJbsNeBbu36I6W4RNz/kfw//LdjFMqjEKnKQ32Eg==";
        };
        _kSKXy7ZX = {
            "id" = "kSKXy7ZX";
            "file" = "casting-26.1.2-3.10.0.jar";
            "hash" = "sha512-IkZAdRjIhI5LSkiN+rtuLtdJZ766bTEzzIGpaWJuQcrZPtpRPvN08KgzI3b5SjMgMq9jpE5RWvnx4Uy25mtB5g==";
        };
        _dMsw6vEl = {
            "id" = "dMsw6vEl";
            "file" = "casting-26.1.2-3.10.1.jar";
            "hash" = "sha512-we2MtVrQ9LZ/75kgc281ZCWrSaFPhsOkJOKb1XlvyCG9Hiq89hM3y6QoZt2lV1VNR+Tj9BGoZR19Sv4k4wSjeA==";
        };
        _2zJs7dCb = {
            "id" = "2zJs7dCb";
            "file" = "casting-26.1.2-3.10.1.jar";
            "hash" = "sha512-y10ZqVr7SZYheIg0w/DogbuVqhCi9lexSQIcgdgVLFWYFaIC8gzpL4qcoVnbA4Dc83OfrJLSL7dY+ckbmgoT/A==";
        };
        _G95Sfsxj = {
            "id" = "G95Sfsxj";
            "file" = "casting-26.1.2-3.10.1.jar";
        ...
        _Cmq799ue = {
            "id" = "Cmq799ue";
            "file" = "casting-26.1.2-3.10.2.jar";
            "hash" = "sha512-5siDBOSLY5KTZbya0iT4L+rwFLak/3y8VZZa1iFv73z15HeyS8hhL7B99YyYWCswab+gkGBOY1Y76yP+94f/aw==";
        };
        _NXkQogVi = {
            "id" = "NXkQogVi";
            "file" = "casting-26.1.2-3.10.3.jar";
            "hash" = "sha512-77MRSvDTBjhh81ux6gOIqKcORHCaN4aTCD4RgVWlBoymrxV04wNLE/MWgDXUDB0qI0N70JxzutcAj2eJAmJkZQ==";
        };
        _VJ4Cm1Mq = {
            "id" = "VJ4Cm1Mq";
            "file" = "casting-26.1.2-3.10.4.jar";
            "hash" = "sha512-4JZFVPECUrVEZOJbOcHoaBzkrx7NfhtdY80AuHRNkiAtuGrnogk4p69yhun+LKMP1u9pXPZHQelxWVVVgRMONA==";
        };
        _IWSH9bsv = {
            "id" = "IWSH9bsv";
            "file" = "casting-26.1.2-3.10.4.jar";
            "hash" = "sha512-r06hLtNjZfSCdCcQ105pd0DsocCFoQ+75IomaV87c+rQmLH3d+ICkPh07biqBV4pFkl95YAPB31DxhLtQdRUtw==";
        };
        _XsIjaV4V = {
            "id" = "XsIjaV4V";
            "file" = "casting-26.1.2-3.10.6.jar";
            "hash" = "sha512-lHs8+Y72eHYdZNx+jbYPLnkn5yP4/uvnp/nOuNoiSfIVbb57+Ls8TLt3LxAKuOMTpgTfcpg9jzU0plmds8XOjw==";
        };
        _sIRvnyLy = {
            "id" = "sIRvnyLy";
            "file" = "casting-26.1.2-3.10.7.jar";
            "hash" = "sha512-6ru0z8KORKd9oZrG4vNXFMhAASqVRIoV1K8h5zy5g5NYFetfHW/N3JKNKEyF6zzhd6op8PcXTm02sOb+Lh8ylw==";
        };
        _ClNWL0OP = {
            "id" = "ClNWL0OP";
            "file" = "casting-26.1.2-3.10.8.jar";
            "hash" = "sha512-P8o1swq5H1TGSf6BnAlrNyA28V04qY6Ne+6viLK+sshlujsLXztM7mNnWp8xqeJUV28ytlgzSohQdVUfu2SzJA==";
        };
        _URbsK4al = {
            "id" = "URbsK4al";
            "file" = "casting-26.1.2-3.10.9.jar";
            "hash" = "sha512-7/lmQf8TGETY01oErHLmD4IUmD5kDlJMqLnhEG3Y45oo/5qgYpNrSHFWrHzWDV+CQ86dAPwBaVhEm/qETfOAxA==";
        };
        _CZFKpgcN = {
            "id" = "CZFKpgcN";
            "file" = "casting-26.1.2-3.10.10.jar";
            "hash" = "sha512-9gixQMPv6UwRNKnT73WVfCbWCaXzi0+I1bDurdyXcMd6+zkTxvHGIFp5aGpOtCYY50rVVD7d/J8AiAtV8fZFtQ==";
        };
        _cWXpGKPo = {
            "id" = "cWXpGKPo";
            "file" = "casting-26.1.2-3.10.11.jar";
            "hash" = "sha512-lkv2Yae0RAgEEsiUdxpDQ2c9s8mXEtmLUofIGBlFwEVJngjg9kHbdrhE2pjm6VSTMFQ3EtKMz0vJagIBajVeLQ==";
        };
        _TTJBObZD = {
            "id" = "TTJBObZD";
    ...
    in {
        ...
        "pkg-1.21-1.10.0" = _Ce4NCV26;
        "pkg-1.21-1.10.1" = _yTrRvcIb;
        "pkg-1.21-1.10.2" = _NsqJY3BY;
        "pkg-1.21-1.10.3" = _DiOJvXi2;
        "pkg-1.21-1.10.4" = _pRXcKtSG;
        "pkg-1.21-1.11.0" = _OzVZNz86;
        "pkg-1.21-1.11.1" = _zGithyr2;
        "pkg-1.21-1.11.3" = _Wq9SznnJ;
        "pkg-1.21-1.11.4" = _FBl987Ze;
        "pkg-1.21-1.12.0" = _28dERtbX;
        "pkg-1.21-1.12.1" = _KLZMtbJU;
        "pkg-1.21-1.13.0" = _V9D0kpGb;
        "pkg-1.21-1.13.3" = _s9nre26d;
        "pkg-1.21-1.13.4" = _WaRrKXOG;
        "pkg-1.21-1.13.5" = _CLxHFoS0;
        "pkg-1.21-1.13.6" = _vKo6sOd6;
        "pkg-1.21-1.14.0" = _1RfT2yQV;
        "pkg-1.21-1.14.1" = _znU5pf9H;
        "pkg-1.21-1.15.0" = _VdBFJB9w;
        "pkg-1.21-1.15.1" = _jMgicGul;
        "pkg-1.21-1.15.2" = _L8uEPn5f;
        "pkg-1.21-1.15.3" = _MnYXydC8;
        "pkg-1.21-1.15.4" = _aE9hqtIl;
        "pkg-1.21-1.15.5" = _rkDZ0c4w;
        "pkg-1.21-1.15.6" = _hneGufbQ;
        "pkg-1.21-1.15.7" = _EFcVZisD;
        "pkg-1.21-1.15.8" = _2jSRJXVV;
        "pkg-1.21-1.15.9" = _HtLpwRex;
        "pkg-1.21-1.15.10" = _96R0xPGJ;
        "pkg-1.21-1.16.0" = _O21dUwU3;
        "pkg-1.21-1.16.3" = _IN8Fp0T4;
        "pkg-1.21-1.16.5" = _AA4AtKVj;
        "pkg-1.21-1.16.6" = _4GkfTVBN;
        "pkg-1.21.1-1.17.0" = _iOAEV213;
        "pkg-1.21.1-1.17.1" = _MpkLincU;
        "pkg-1.21.1-1.17.2" = _JjYZnwVJ;
        "pkg-1.21.1-1.17.4" = _F2GZTceY;
        "pkg-1.21.1-1.17.5" = _Ldue6ClI;
        "pkg-1.21.1-1.17.6" = _QITfWQTm;
        "pkg-1.21.1-1.17.7" = _91UqQEpD;
        "pkg-1.21.1-1.17.9" = _au58dl5H;
        "pkg-1.21.1-1.17.10" = _IwX3DHho;
        "pkg-1.21.1-1.17.11" = _7Asj5FC7;
        "pkg-1.21.1-1.17.12" = _a973Awzu;
        "pkg-1.21.1-1.17.13" = _kIR4Ipw9;
        "pkg-1.21.1-1.17.14" = _YPPA2gEs;
        "pkg-1.21.1-1.17.15" = _MfhCxhOp;
        "pkg-1.21.1-1.17.16" = _pdpirP5V;
        "pkg-1.21.1-1.17.17" = _Cjn0S12T;
        "pkg-1.21.1-1.17.18" = _fdbCYkf8;
        "pkg-1.21.1-2.0.3" = _lShkCZz5;
        "pkg-1.21.1-2.0.4" = _paemUWmz;
        "pkg-1.21.1-2.0.5" = _ZJSI2Wpg;
        "pkg-1.21.1-2.0.6" = _BxSNhwqK;
        "pkg-1.21.1-2.0.7" = _u92DywK2;
        "pkg-1.21.1-2.0.8" = _GceG1IE8;
        "pkg-1.21.1-2.0.9" = _Y2YYTK9K;
        "pkg-1.21.1-2.0.10" = _4rVLXVyu;
        "pkg-1.21.1-2.0.11" = _i8dBbgSX;
        "pkg-1.21.1-2.0.12" = _GfzcZ4nb;
        "pkg-1.21.1-2.0.14" = _14COilv0;
        "pkg-1.21.1-2.0.16" = _i3x8SM83;
        "pkg-1.21.1-2.0.17" = _h6I8SXTc;
        "pkg-1.21.1-2.0.18" = _i2dyHozV;
        "pkg-1.21.1-2.0.19" = _A7DVU4YS;
        "pkg-1.21.1-2.0.20" = _rdpX4Tak;
        "pkg-1.21.1-2.0.21" = _WdFGXofE;
        "pkg-1.21.1-2.0.22" = _QJnOLLri;
        "pkg-1.21.1-2.0.24" = _F96aDBtq;
        "pkg-1.21.1-2.0.25" = _Gbr6oOqr;
        "pkg-1.21.1-2.0.26" = _4ctzy7G3;
        "pkg-1.21.1-2.0.28" = _bocFL5vC;
        "pkg-1.21.1-2.0.29" = _urQclpta;
        "pkg-1.21.1-2.0.30" = _DJ4dQgFA;
        "pkg-1.21.1-2.0.31" = _zqe9VCqX;
        "pkg-1.21.1-2.1.0" = _Ut20sFKA;
        "pkg-1.21.1-2.1.1" = _Fi7nht6w;
        "pkg-1.21.1-2.1.2" = _z1PhUsVZ;
        "pkg-1.21.1-2.1.3" = _clWzbsrr;
        "pkg-1.21.1-2.1.4" = _BmSRw8Ua;
        "pkg-1.21.1-2.2.1" = _Vd9kANzv;
        "pkg-1.21.1-2.2.2" = _4GcRfnN1;
        "pkg-1.21.1-2.2.3" = _Krbz2pco;
        "pkg-1.21.1-2.2.4" = _eqHDiEcu;
        "pkg-1.21.1-2.2.5" = _lV580dHO;
        "pkg-1.21.1-2.2.6" = _jwbwSTbx;
        "pkg-1.21.1-2.2.7" = _yk7otfli;
        "pkg-1.21.1-2.2.9" = _ghOf4Y5V;
        "pkg-1.21.1-2.2.10" = _kaVFjcuQ;
        "pkg-1.21.1-2.2.11" = _2vvE54f5;
        "pkg-1.21.1-2.2.12" = _uz3TzPpb;
        "pkg-1.21.1-2.2.13" = _C8lbSrJC;
        "pkg-1.21.1-2.2.14" = _sGcmhLXL;
        "pkg-1.21.1-2.2.15" = _z74lDYCj;
        "pkg-1.21.1-2.2.16" = _TSeO668t;
        "pkg-1.21.1-2.2.17" = _7y4vN4lE;
        "pkg-1.21.1-2.2.18" = _jY0DhXhJ;
        "pkg-1.21.1-2.2.19" = _ml2fpV8w;
        "pkg-1.21.1-2.2.20" = _BeYYgyyu;
        "pkg-1.21.1-2.2.21" = _pmWInWCf;
        "pkg-1.21.1-2.2.22" = _TjUafIHv;
        "pkg-1.21.1-2.2.24" = _Si26rd6o;
        "pkg-1.21.1-2.3.0" = _RPTor8xz;
        "pkg-1.21.1-2.3.1" = _VJoB9H8W;
        "pkg-1.21.1-2.3.3" = _lVxRuIM9;
        "pkg-1.21.1-2.3.5" = _Ev93nfdy;
        "pkg-1.21.1-2.3.6" = _UDRgnTRv;
        "pkg-1.21.1-2.3.7" = _LVK3J3bj;
        "pkg-1.21.1-2.3.8" = _u5ADGdLJ;
        "pkg-1.21.1-2.3.9" = _DQ0eiH2E;
        "pkg-26.1-pre-3-3.0.0" = _XQC9wzRE;
        "pkg-26.1-3.1.0" = _HBrPlMAM;
        "pkg-26.1-3.2.0" = _QWrHFH1e;
        "pkg-26.1-3.2.1" = _OObqerZy;
        "pkg-26.1-3.2.5" = _TSiCS20N;
        "pkg-26.1-3.2.6" = _fl1ndDy0;
        "pkg-26.1-3.3.0" = _Fk8oXBlT;
        "pkg-26.1.1-3.4.0" = _EY547Gpr;
        "pkg-26.1.2-3.5.0" = _CG5CGMGw;
        "pkg-26.1.2-3.5.1" = _qz5Av79Q;
        "pkg-26.1.2-3.5.2" = _9iJ6yOrF;
        "pkg-26.1.2-3.6.0" = _cIu22G2X;
        "pkg-26.1.2-3.6.1" = _2HXjMG0M;
        "pkg-1.21.1-2.3.10" = _DROyDGIY;
        "pkg-26.1.2-3.7.0" = _MBBxYAEl;
        "pkg-26.1.2-3.7.1" = _Y6zxgz9J;
        "pkg-26.1.2-3.7.2" = _xQ7gT4BS;
        "pkg-26.1.2-3.7.3" = _2uvXZmXk;
        "pkg-1.21.1-2.3.11" = _lSdFKEPS;
        "pkg-26.1.2-3.7.4" = _wc99nORB;
        "pkg-26.1.2-3.7.5" = _XburkQVu;
        "pkg-26.1.2-3.7.6" = _U43FCDCU;
        "pkg-1.21.1-2.3.12" = _91gWJmzs;
        "pkg-1.21.1-2.3.13" = _mHE6wnd2;
        "pkg-26.1.2-3.8.0" = _4WiXnhj8;
        "pkg-26.1.2-3.8.1" = _1U6aKDsF;
        "pkg-26.1.2-3.8.2" = _PcTnEtAm;
        "pkg-26.1.2-3.8.3" = _KUvwewqp;
        "pkg-26.1.2-3.9.0" = _xsLjE3VT;
        "pkg-26.1.2-3.9.1" = _2SFvi2Rh;
        "pkg-26.1.2-3.9.3" = _i6jjuxcQ;
        "pkg-26.1.2-3.9.4" = _Xzhz6JPU;
        "pkg-26.1.2-3.9.5" = _1ilIA6SL;
        "pkg-26.1.2-3.9.6" = _HW5J9L5f;
        "pkg-26.1.2-3.9.7" = _oFfn9diV;
        "pkg-26.1.2-3.9.8" = _LmDGzdgO;
        "pkg-26.1.2-3.9.9" = _ZgJRUUsQ;
        "pkg-26.1.2-3.9.10" = _dofYh63b;
        "pkg-26.1.2-3.9.11" = _OSb228WX;
        "pkg-26.1.2-3.9.12" = _Jq7GKzGz;
        "pkg-26.1.2-3.9.13" = _7u4tbZZv;
        "pkg-26.1.2-3.9.14" = _c8quWcaD;
        "pkg-26.1.2-3.9.15" = _Z7HcSAzg;
        "pkg-26.1.2-3.10.0" = _kSKXy7ZX;
        "pkg-26.1.2-3.10.1" = _G95Sfsxj;
        "pkg-26.1.2-3.10.2" = _Cmq799ue;
        "pkg-26.1.2-3.10.3" = _NXkQogVi;
        "pkg-26.1.2-3.10.4" = _IWSH9bsv;
        "pkg-26.1.2-3.10.6" = _XsIjaV4V;
        "pkg-26.1.2-3.10.7" = _sIRvnyLy;
        "pkg-26.1.2-3.10.8" = _ClNWL0OP;
        "pkg-26.1.2-3.10.9" = _URbsK4al;
