...
let
    ...
    in {
        ...
        "pkg-1.21.1-1.0.8" = _sgRcJ546;
        "pkg-1.21.1-1.0.9" = _8i0mCosh;
        "pkg-1.21.1-1.0.11" = _4Ox0eGuR;
        "pkg-1.21.1-1.0.12" = _KFiYVAgr;
        "pkg-1.21.1-1.0.15" = _8dGnCmZF;
        "pkg-1.21.1-1.0.16" = _iPIx61V2;
        "pkg-1.21.1-1.0.17" = _hzsqhtP7;
        "pkg-1.21.1-1.0.19" = _iCNfIq2B;
        "pkg-1.21.1-1.0.20" = _or1jY7mq;
        "pkg-1.21.1-1.0.21" = _eAA4bHGq;
        "pkg-1.21.1-1.0.22" = _Dxn9bJ2k;
        "pkg-1.21.1-1.0.23" = _7dr6swch;
        "pkg-1.21.1-1.1.1" = _PoWj6RPl;
        "pkg-1.21.1-1.1.2" = _ppjUA3r6;
        "pkg-1.21.1-1.1.4" = _N6I89Uh0;
        "pkg-1.21.1-1.1.6" = _dJpI5us6;
        "pkg-1.21.11-1.2.1" = _b9AN2lSF;
        "pkg-1.21.11-1.3.0" = _viFzm5Zf;
        "pkg-26.1-pre-3-2.1.0" = _5cu41xLu;
        "pkg-26.1.1-2.2.0" = _Kp4fI9wT;
        ...
        "pkg-26.1.2-2.5.2" = _A5dAZJr2;
        "pkg-1.21.1-5.2.3" = _tUp9lRxJ;
        "pkg-26.1.2-2.5.3" = _6R7ItiTy;
        "pkg-26.1.2-2.6.0" = _qxB3g9nr;
        "pkg-26.1.2-2.7.0" = _cRdf8cN4;
        "pkg-26.1.2-2.7.1" = _fSj0Fhe3;
