...
let
    ...
    in {
        ...
        "pkg-1.0.0" = _OxEw8XSK;
        "pkg-1.0.1-1.20" = _NHEWtQ7n;
        "pkg-1.0.2-1.20" = _8FuZxaWQ;
        "pkg-1.0.3-1.20" = _rmQDoK64;
        "pkg-1.0.4-1.20" = _mVPkiMLl;
        "pkg-1.0.5-1.20" = _z7L4i7n4;
        "pkg-1.0.6-1.20" = _buGW5Hqe;
        "pkg-1.0.7-1.20" = _4jUYytQb;
        "pkg-1.0.8-1.20" = _QKjVs9ZF;
        "pkg-1.0.9-1.20" = _xofxiz49;
        "pkg-1.1.0-1.20" = _hANX9b8U;
        "pkg-1.1.1-1.20" = _QFUtAEVA;
        "pkg-1.1.2-1.20" = _XfSrdOHq;
        "pkg-1.1.3-1.20" = _hXrejG17;
        "pkg-1.1.3-1.20-forge" = _ZSKgUDQj;
        "pkg-1.1.3.1-1.20-forge" = _jBs1PyS1;
        "pkg-1.1.4-1.20-forge" = _kRKfAR7l;
        "pkg-1.1.4-1.20" = _K39cgYkp;
        "pkg-1.1.5-1.20-forge" = _J8zbeBMq;
        "pkg-1.1.5-1.20" = _TeDuYJEc;
        "pkg-1.1.7-1.20-forge" = _lhHsDkba;
        "pkg-1.1.7-1.20" = _v2S954Ir;
        "pkg-1.1.8-1.20-forge" = _GG5nq5EP;
        "pkg-1.1.8-1.20" = _EKLapK1F;
        "pkg-1.1.9-1.20-forge" = _U4PJ9TuJ;
        "pkg-1.1.9-1.20" = _Y4E2ff6K;
        "pkg-1.2.0-hf1-1.20" = _5K15jgp2;
        "pkg-1.2.0-hf1-1.20-forge" = _XQifto01;
        "pkg-1.2.1-1.20-forge" = _AT0gIooX;
        "pkg-1.2.1-1.20" = _iOYJOqBs;
        "pkg-1.2.2-1.20-forge" = _nrTDBkBt;
        "pkg-1.2.2-1.20" = _2QJLwCsq;
        "pkg-1.2.3-1.20-forge" = _S5maROeE;
        "pkg-1.2.3-1.20" = _6hM6PP1z;
        "pkg-1.2.3.1-1.20-forge" = _HGwY538B;
        "pkg-1.2.3.1-1.20" = _XNsjXm0s;
        "pkg-1.2.4-1.20-forge" = _nLGtZSpe;
        "pkg-1.2.4-1.20" = _KGLZ77Oq;
        "pkg-1.2.5-1.20-forge" = _um7U3cc6;
        "pkg-1.2.5-1.20" = _nxfeMxUc;
        "pkg-1.2.6-1.20-forge" = _ZVoyrRYF;
        "pkg-1.2.6-1.20" = _LiyA2XGR;
        "pkg-1.2.6-1.20.4" = _Cne930Zi;
        "pkg-1.2.6.1-1.20-forge" = _32b5Zk8a;
        "pkg-1.2.7-1.20-forge" = _8bJNrb4B;
        "pkg-1.2.7-1.20.4" = _NsLaPsaQ;
        "pkg-1.2.7-1.20.1" = _VxZArIYT;
        "pkg-1.2.7-1.20.6" = _eoe1dRLf;
        "pkg-1.2.7-1.21" = _4B6U7IlA;
        "pkg-1.2.7.1-1.21" = _YalJB4pA;
        "pkg-1.2.7.2-1.21" = _2ulWkHQW;
        "pkg-1.2.7.3-1.21" = _RjGyBpRJ;
        "pkg-1.3.0-1.20-forge" = _F0txUGpU;
        "pkg-1.3.0-1.21" = _q57TgYWY;
        "pkg-1.3.0.1-1.21" = _LwYFjVZS;
        "pkg-1.3.1-1.20-forge" = _uIcurZ5Y;
        "pkg-1.3.2-1.20-forge" = _5pyqW6lr;
        "pkg-1.3.2-1.21.1" = _kDOgvQPQ;
        "pkg-1.3.3-1.20-forge" = _xoiyDGqF;
        "pkg-1.3.3-1.21.1" = _iJF1sImR;
        "pkg-1.3.4-1.20-forge" = _eFbLQzkG;
        "pkg-1.3.4-1.21.1" = _gFD1JQkQ;
        "pkg-1.3.5-1.20-forge" = _NDguc82d;
        "pkg-1.3.5-1.21.1" = _sZFYrDkD;
        "pkg-1.3.6-1.20-forge" = _Tlp6qCHY;
        "pkg-1.3.6-1.21.1" = _xwThUrDe;
        "pkg-1.3.6.1-1.20-forge" = _bUUu829c;
        "pkg-1.3.7-1.20-forge" = _tV40N5Xz;
        "pkg-1.3.7-1.21.1" = _2G7y5wsC;
        "pkg-1.3.8-1.21.1" = _ycQOU8Ay;
        "pkg-1.3.8-1.21.3" = _FY9Wwlx6;
        "pkg-1.3.8-1.21.4" = _1GfJDrl1;
        "pkg-1.3.9-1.21.4" = _sbncsjW4;
        "pkg-1.4.0-1.21.4" = _ByC49AUX;
        "pkg-1.4.0.1-1.21.1-neoforge" = _zX4quCmi;
        "pkg-1.3.8-1.20-forge" = _cbV3Ncp9;
        "pkg-1.4.1-1.21.1-neoforge" = _M6pjJ12o;
        "pkg-1.4.1-1.21.4" = _K5mFzezF;
        "pkg-1.3.9-1.20-forge" = _s58mpZtN;
        "pkg-1.4.2-1.21.1-neoforge" = _WLRHxFbU;
        "pkg-1.4.2.1-1.21.4" = _zVD0MdNB;
        "pkg-1.4.3-1.21.1-neoforge" = _MvXtI8Ck;
        "pkg-1.4.3-1.21.4" = _auCPEVwk;
        "pkg-1.4.4-1.21.1-neoforge" = _O6eEQHCS;
        "pkg-1.4.4-1.21.4" = _RghAIU38;
        "pkg-1.4.5-1.21.1-neoforge" = _MtXg1pvA;
        "pkg-1.4.5-1.21.4" = _wBu9PPqb;
        "pkg-1.4.5-1.21.5" = _vyHuGmDg;
        "pkg-1.4.5.1-1.21.5" = _KzeeLis0;
        "pkg-1.3.9.2-1.20-forge" = _c8HEKjYh;
        "pkg-1.4.6-1.21.1-neoforge" = _33AYOBdv;
        "pkg-1.4.6-1.21.5" = _EdYyBf3n;
        "pkg-1.4.7-1.21.1-neoforge" = _Tpb2c9Ay;
        "pkg-1.4.7-1.21.5" = _yzL6oFR6;
        "pkg-1.4.7.1-1.21.5" = _In6iFANs;
        "pkg-1.4.0.1-1.20-forge" = _UqlrBoM2;
        "pkg-1.4.8-1.21.1-neoforge" = _HhaDODJn;
        "pkg-1.4.8-1.21.5" = _wffTHcfL;
        "pkg-1.4.9-1.21.1-neoforge" = _YF8kBDUc;
        "pkg-1.4.9-1.21.5" = _gPaTgKj4;
        "pkg-1.5.0-1.21.6" = _7erSnS1s;
        "pkg-1.5.1-1.21.6" = _sl02mrBo;
        "pkg-1.5.1-1.21.7" = _Wu7ly3eR;
        "pkg-1.5.1.1-1.21.1-neoforge" = _aGwr0Te6;
        "pkg-1.5.1-1.21.8" = _n8OpL81P;
        "pkg-1.5.2-1.21.1-neoforge" = _lsntTYPe;
        "pkg-1.5.2-1.21.8" = _Er3Kgx5k;
        "pkg-1.4.0.2-1.20-forge" = _qlwu5IQ3;
        "pkg-1.4.1-1.20-forge" = _ECa58e4B;
        "pkg-1.5.3-1.21.8" = _AfR56HGE;
        "pkg-1.5.4-1.21.8" = _euHnhyY5;
        "pkg-1.5.4-1.21.9" = _mi5MfpP8;
        "pkg-1.5.4-1.21.10" = _VFOtYs66;
