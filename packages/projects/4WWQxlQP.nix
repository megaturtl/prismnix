...
let
    versions = (let
        ...
        _bfczZvad = {
            "id" = "bfczZvad";
            "file" = "servercore-neoforge-1.5.20+26.3.jar";
            "hash" = "sha512-FY1FkUnDiWlmbOOVcpL3dH06NoYFYA3K2ISQ/rK1T5gFFB6Vc4StRrfSQGwQBc20Kml6YM0tHXG64Obxg0eBZw==";
        };
        _LCG1Bm84 = {
            "id" = "LCG1Bm84";
            "file" = "servercore-fabric-1.5.20+26.3.jar";
            "hash" = "sha512-q+H4BupYeXH6996CbhiwcxSkqeaQ9kpMOlTn9hw+b0eSYzsTqRclK9jeFUzsOdpmGRENg3mc9TNFDFtMrHqESA==";
        };
    in {
        "jdWMQF3q" = _jdWMQF3q;
        "iIO82sHi" = _iIO82sHi;
        ...
        "neoforge-26.3" = _bfczZvad;
        "pkg-1.2.3-1.17.1" = _jdWMQF3q;
        "pkg-1.2.4-1.18-pre4" = _iIO82sHi;
        "pkg-1.2.4-1.17.1" = _zrc8Lb7r;
        "pkg-1.2.5-1.17.1" = _XcHqpCID;
        "pkg-1.2.5-1.18" = _OKdqaWsX;
        "pkg-1.2.6-1.18.1" = _LdRH09D2;
        "pkg-1.2.7-1.18.1" = _HbKbVB8Y;
        "pkg-1.2.8-1.18.2" = _4PbPJU10;
        "pkg-1.2.8-1.18.1" = _IOuEmJ7r;
        "pkg-1.2.9" = _1Axad5Jl;
        "pkg-1.3.0" = _nYXTzmMC;
        "pkg-1.3.1-1.19" = _LfJCIqp7;
        "pkg-1.3.1-1.19.1" = _NDlsg2Sf;
        "pkg-1.3.2-1.19.2" = _A6ySBG0U;
        "pkg-1.3.3-1.19.2" = _kzD8EGTS;
        "pkg-1.3.4-1.19.3" = _k0LvWP3Q;
        "pkg-1.3.5+1.19.4" = _oQtOLaDw;
        "pkg-1.3.6+1.20" = _JBWhQzQ9;
        "pkg-1.3.7+1.20.1" = _exA4UxFq;
        "pkg-1.3.8+1.20.2" = _LrB49Mln;
        "pkg-1.3.9+1.20.1" = _RjHT254T;
        "pkg-1.3.9+1.20.2" = _sicenHyA;
        "pkg-1.4.0+1.20.3" = _H1fXXdNC;
        "pkg-1.5.0+1.20.4" = _YsPv0uo1;
        "pkg-1.5.0+1.20.2" = _5vkTj9Xk;
        "pkg-1.5.0+1.20.1" = _4ryIi7Dl;
        "pkg-1.5.1+1.20.1" = _7ZoHTOVf;
        "pkg-1.5.1+1.20.5" = _wk6hpBNs;
        "pkg-1.5.2+1.20.6" = _QG3j2VPK;
        "pkg-1.5.3+1.20.6" = _XJN7yK0o;
        "pkg-1.5.3+1.21" = _Jm7dxuoE;
        "pkg-1.5.4+1.21" = _B3eN97DO;
        "pkg-1.3.6+1.19.2" = _O7JYOuJ7;
        "pkg-1.5.5+1.21.1" = _nlNqnwcA;
        "pkg-1.5.6+1.21.2" = _IGMvJtwP;
        "pkg-1.5.7+1.21.3" = _Rc81BIN6;
        "pkg-1.5.2+1.20.1" = _rx1c7m6q;
        "pkg-1.5.8+1.21.3" = _PgKTFLEL;
        "pkg-1.5.8+1.21.4" = _vCnDCHyg;
        "pkg-1.5.9+1.21.5" = _eHI7CpB9;
        "pkg-1.5.10+1.21.1" = _77MAnmOn;
        "pkg-1.5.10+1.21.5" = _UkQJyQpq;
        "pkg-1.5.11+1.21.5" = _ujuSffvw;
        "pkg-1.5.12+1.21.5" = _biB9A928;
        "pkg-1.5.13+1.21.6" = _Lxdwau1m;
        "pkg-1.5.14+1.21.8" = _LovZDz4w;
        "pkg-1.5.14+1.21.9" = _7fysEjun;
        "pkg-1.5.15+1.21.11" = _7Fkwao8d;
        "pkg-1.5.16+26.1" = _2QeJcNhM;
        "pkg-1.5.17+26.1.2" = _tcwIcZH7;
        "pkg-1.5.17+1.21.1" = _zEViyXZ9;
        "pkg-1.5.18+26.1.2" = _CIxKzMjd;
        "pkg-1.5.18+26.2" = _utYQFqQI;
        "pkg-1.5.19+26.2" = _88gv0DMz;
        "pkg-1.5.19+26.1.2" = _TzrJj0Fc;
        "pkg-1.5.19+1.21.1" = _6N9hXiRa;
        "pkg-1.5.20+26.3" = _LCG1Bm84;
        "default" = _LCG1Bm84;
    });
