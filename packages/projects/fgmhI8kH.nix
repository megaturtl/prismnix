...
let
    ...
    in {
        ...
        "pkg-3.1.4" = _LcnT1dY5;
        "pkg-3.1.5" = _cSwNn8fR;
        "pkg-3.1.5a" = _KihNxY42;
        "pkg-3.1.6" = _HuaUXmX8;
        "pkg-3.1.7" = _9g99Yime;
        "pkg-2.9.3" = _j703cf0E;
        "pkg-3.1.8" = _3eXWBWdB;
        "pkg-3.2.0" = _qC5GfpM0;
        "pkg-3.2.0b" = _Pg8s7GZE;
        "pkg-2.9.4" = _mL9oaPkZ;
        "pkg-3.2.1" = _JiU3eJDL;
        "pkg-3.2.2" = _Fmf9SrAU;
        "pkg-3.2.3" = _ygoCStaG;
        ...
        "pkg-3.4.9" = _JHpY779l;
        "pkg-3.5.3" = _ECwXu32h;
        "pkg-3.4.9a" = _CGCwEJfv;
        "pkg-3.5.3a" = _yX64Brxl;
        "pkg-3.4.9b" = _y0h7VzLL;
        "pkg-3.4.10" = _tpKHcPzx;
        "pkg-3.5.4" = _bUY7KcOc;
        "pkg-3.4.11" = _Cn64CxUR;
        "pkg-3.5.5" = _1DhwBv7J;
        "pkg-3.4.12" = _LQm5JkIu;
        "pkg-3.5.6" = _4K1jqWeG;
        "pkg-3.4.13" = _GRjcKRHS;
        "pkg-3.5.7a" = _ZKXEGQ03;
        "pkg-3.4.14" = _xaqkr8Ey;
        "pkg-3.5.8" = _IS8JSyqE;
        "pkg-3.5.9" = _HWhGk038;
        "pkg-3.5.9a" = _2uaRdli9;
        "pkg-3.5.10" = _YrPboaSw;
        "pkg-3.5.10a" = _ZElsnCT3;
        "pkg-3.6.0" = _HsnajUmb;
        "pkg-3.6.0a" = _cHxLhqXe;
        "pkg-3.6.0b" = _fyIUePne;
        "pkg-3.6.1" = _GkrjwPMq;
        "pkg-3.6.1a" = _xCF2QD9M;
        "pkg-3.6.2-beta.1" = _idaHfyIG;
        "pkg-3.6.2a" = _bItEO2nE;
