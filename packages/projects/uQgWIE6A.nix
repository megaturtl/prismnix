...
let
    ...
    in {
        ...
        "pkg-1.0.0+26.1.1" = _xhaNskHj;
        "pkg-1.0.1+26.1.x" = _aHjhsJ60;
        "pkg-1.0.2+26.1.x" = _S6abZVn4;
        "pkg-2.0.0+1.21.11" = _tWLMxmyO;
        "pkg-2.0.0+1.21.1-neoforge" = _whwqwfXb;
        "pkg-2.0.0+26.1.x" = _qyRsxqKr;
