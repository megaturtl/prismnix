...
let
    versions = (let
        ...
        _sW6895o6 = {
            "id" = "sW6895o6";
            "file" = "chicken_nerf-1.7.0+MC26.2.x.jar";
            "hash" = "sha512-5CuYsnDPFa+tGFCp5DYgalF2q2bJpYFvi2lkv+SoU2mGuzCGTEVZEojB+RzmMQ8aGOvVZWSuuvFrqoAjBMkASw==";
        };
    in {
        "iBB0eGLH" = _iBB0eGLH;
        "8Ci6FeVv" = _8Ci6FeVv;
        ...
        "quilt-26.2" = _sW6895o6;
        "pkg-1.0.6+MC1.17" = _iBB0eGLH;
        "pkg-1.0.7+MC1.17-1.17.1" = _8Ci6FeVv;
        "pkg-1.0.8+MC1.18" = _2qhY8Lxr;
        "pkg-1.0.9+MC1.18-1.18.1" = _VhkvcAy0;
        "pkg-1.0.10+MC1.18-1.18.1" = _EQwpZhDw;
        "pkg-1.0.11+MC1.18-1.18.1" = _y00ol3lb;
        "pkg-1.0.12+MC1.18-1.18.1" = _tQDoWodS;
        "pkg-1.0.13+MC1.18-1.18.2" = _41HHChyf;
        "pkg-1.0.14+MC1.19" = _BhgJ8CeX;
        "pkg-1.0.15+MC1.19-1.19.1" = _UDNJNCiR;
        "pkg-1.0.16+MC1.19-1.19.2" = _KS7pvCwt;
        "pkg-1.0.17+MC1.19.3-1.19.4" = _e6hqVqAR;
        "pkg-1.0.18+MC1.20-1.20.1" = _EUCo79f3;
        "pkg-1.0.19+MC1.20.2" = _prg2lmVC;
        "pkg-1.0.20+MC1.20.2-1.20.4" = _n8RaXuV6;
        "pkg-1.0.21+MC1.20.2-1.20.5" = _MIpDoa3l;
        "pkg-1.0.22+MC1.20.2-1.20.6" = _ZBCNLA3U;
        "pkg-1.1.0+MC1.21" = _TNVReY7d;
        "pkg-1.1.1+MC1.21-1.21.1" = _XoPMyHpV;
        "pkg-1.2.0+MC1.21.2-1.21.3" = _LrHHmGS5;
        "pkg-1.2.1+MC1.21.2-1.21.4" = _sHcwRfyF;
        "pkg-1.3.0+MC1.21.5" = _Tve2ZzYG;
        "pkg-1.3.1+MC1.21.5-1.21.6" = _Q4B7uy8n;
        "pkg-1.3.2+MC1.21.5-1.21.7" = _fR0Ri7vp;
        "pkg-1.3.3+MC1.21.5-1.21.8" = _Pg1Mfah1;
        "pkg-1.4.0+MC1.21.9-1.21.10" = _yCVsxvwo;
        "pkg-1.5.0+MC1.21.11" = _d4dxOt9t;
        "pkg-1.3.4+MC1.21.5-1.21.8" = _kp4C1zKW;
        "pkg-1.4.1+MC1.21.9-1.21.10" = _d3jCDJt7;
        "pkg-1.5.1+MC1.21.11" = _dmVv08TH;
        "pkg-1.6.0+MC26.1-26.1.x" = _rPk1257Q;
        "pkg-1.7.0+MC26.2.x" = _sW6895o6;
        "default" = _sW6895o6;
    });
