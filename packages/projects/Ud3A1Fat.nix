...
let
    ...
    in {
        ...
        "pkg-0.2.1+mc1.21.0" = _eK0FuBva;
        "pkg-0.2.1+mc1.20.1" = _DQGkzqEw;
        "pkg-0.2.1+mc1.21.2" = _eEndJE8O;
        "pkg-0.2.2+mc1.21.2" = _9qI9uc0q;
        "pkg-0.2.2+mc1.21.0" = _X3hByxU6;
        "pkg-0.2.2+mc1.21.5" = _XoU4nIFW;
