...
let
    versions = (let
        ...
        _mU8oxl4c = {
            "id" = "mU8oxl4c";
            "file" = "QuickShop-Hikari-6.3.0.0.jar";
            "hash" = "sha512-FHLB2h4upBdwj+I2/HVsmpncS/uGMZD6kf+N+PKZj3pC6D/gkoC6TA0fWxmkPntiPgRs9Iu2gImKHZfLOS0SbA==";
        };
        _KMG0aexU = {
            "id" = "KMG0aexU";
            "file" = "QuickShop-Hikari-6.3.0.1.jar";
            "hash" = "sha512-w+tp4JcRUG6hx+iLsnGtSBmfh7pf2RIfoMn5++lyAMelyKsqk8LYyjwwgKY4TZKZrbr3IZGrzMlIafcfZXVPIQ==";
        };
        _ZsqkDX6F = {
            "id" = "ZsqkDX6F";
            "file" = "QuickShop-Hikari-6.3.0.2.jar";
            "hash" = "sha512-a3Jp/DV/0l9d8JhMf243660Ed8HgqXiko6n+e6yi7/Ek5D0EDlNdpZSP6mO/jEQBlQAZ9JQUaYnSkc12qps48A==";
        };
    in {
        "nHCH6pGk" = _nHCH6pGk;
        "Rdy63zH0" = _Rdy63zH0;
        ...
        "paper-1.20" = _ZsqkDX6F;
        "paper-1.20.1" = _ZsqkDX6F;
        "paper-1.20.2" = _ZsqkDX6F;
        "paper-1.20.3" = _ZsqkDX6F;
        "paper-1.20.4" = _ZsqkDX6F;
        "paper-1.20.5" = _ZsqkDX6F;
        "paper-1.20.6" = _ZsqkDX6F;
        "paper-1.21" = _ZsqkDX6F;
        "paper-1.21.1" = _ZsqkDX6F;
        "paper-1.21.2" = _ZsqkDX6F;
        "paper-1.21.3" = _ZsqkDX6F;
        "paper-1.21.4" = _ZsqkDX6F;
        "paper-1.21.5" = _ZsqkDX6F;
        "paper-1.21.6" = _ZsqkDX6F;
        "paper-1.21.7" = _ZsqkDX6F;
        "paper-1.21.8" = _ZsqkDX6F;
        "paper-1.21.9" = _ZsqkDX6F;
        "paper-1.21.10" = _ZsqkDX6F;
        "paper-1.21.11" = _ZsqkDX6F;
        "paper-26.1" = _ZsqkDX6F;
        "paper-26.1.1" = _ZsqkDX6F;
        "paper-26.1.2" = _ZsqkDX6F;
        "paper-26.2" = _ZsqkDX6F;
        ...
        "purpur-1.20" = _ZsqkDX6F;
        "purpur-1.20.1" = _ZsqkDX6F;
        "purpur-1.20.2" = _ZsqkDX6F;
        "purpur-1.20.3" = _ZsqkDX6F;
        "purpur-1.20.4" = _ZsqkDX6F;
        "purpur-1.20.5" = _ZsqkDX6F;
        "purpur-1.20.6" = _ZsqkDX6F;
        "purpur-1.21" = _ZsqkDX6F;
        "purpur-1.21.1" = _ZsqkDX6F;
        "purpur-1.21.2" = _ZsqkDX6F;
        "purpur-1.21.3" = _ZsqkDX6F;
        "purpur-1.21.4" = _ZsqkDX6F;
        "purpur-1.21.5" = _ZsqkDX6F;
        "purpur-1.21.6" = _ZsqkDX6F;
        "purpur-1.21.7" = _ZsqkDX6F;
        "purpur-1.21.8" = _ZsqkDX6F;
        "purpur-1.21.9" = _ZsqkDX6F;
        "purpur-1.21.10" = _ZsqkDX6F;
        "purpur-1.21.11" = _ZsqkDX6F;
        "purpur-26.1" = _ZsqkDX6F;
        "purpur-26.1.1" = _ZsqkDX6F;
        "purpur-26.1.2" = _ZsqkDX6F;
        "purpur-26.2" = _ZsqkDX6F;
        ...
        "folia-1.20" = _ZsqkDX6F;
        "folia-1.20.1" = _ZsqkDX6F;
        "folia-1.20.2" = _ZsqkDX6F;
        "folia-1.20.3" = _ZsqkDX6F;
        "folia-1.20.4" = _ZsqkDX6F;
        "folia-1.20.5" = _ZsqkDX6F;
        "folia-1.20.6" = _ZsqkDX6F;
        "folia-1.21" = _ZsqkDX6F;
        "folia-1.21.1" = _ZsqkDX6F;
        "folia-1.21.2" = _ZsqkDX6F;
        "folia-1.21.3" = _ZsqkDX6F;
        "folia-1.21.4" = _ZsqkDX6F;
        "folia-1.21.5" = _ZsqkDX6F;
        "folia-1.21.6" = _ZsqkDX6F;
        "folia-1.21.7" = _ZsqkDX6F;
        "folia-1.21.8" = _ZsqkDX6F;
        "folia-1.21.9" = _ZsqkDX6F;
        "folia-1.21.10" = _ZsqkDX6F;
        "folia-1.21.11" = _ZsqkDX6F;
        "folia-26.1" = _ZsqkDX6F;
        "folia-26.1.1" = _ZsqkDX6F;
        "folia-26.1.2" = _ZsqkDX6F;
        "folia-26.2" = _ZsqkDX6F;
        ...
        "pkg-6.3.0.0" = _mU8oxl4c;
        "pkg-6.3.0.1" = _KMG0aexU;
        "pkg-6.3.0.2" = _ZsqkDX6F;
        "default" = _ZsqkDX6F;
    });
