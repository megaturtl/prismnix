...
let
    versions = (let
        ...
        _2CfqU3eK = {
            "id" = "2CfqU3eK";
            "file" = "Attollo-1.5.7.jar";
            "hash" = "sha512-dcOWxzeNe0cKmVmMM+AyRkEdyQida/W053bbK6qeY4bBeyUp+jWDj33ejPDOfOHsHpZ/djQ/lLIkXq+Bln1dgw==";
        };
        _7OVmU0GD = {
            "id" = "7OVmU0GD";
            "file" = "Attollo-1.5.8.jar";
            "hash" = "sha512-AGsdxqh7/guRQyjAmLdfogBhMn79RMlfN5xYYX75eTxGiHuZqm6HlzEj91KAl0K+NnSjtStP+5hDRLFbC0Vvlw==";
        };
    in {
        "LmVKfHen" = _LmVKfHen;
        "wGbkmfRV" = _wGbkmfRV;
        ...
        "bukkit-1.20.6" = _7OVmU0GD;
        "bukkit-1.21" = _7OVmU0GD;
        "bukkit-1.21.1" = _7OVmU0GD;
        "bukkit-1.21.2" = _7OVmU0GD;
        "bukkit-1.21.3" = _7OVmU0GD;
        "bukkit-1.21.4" = _7OVmU0GD;
        "bukkit-1.21.5" = _7OVmU0GD;
        "bukkit-1.21.6" = _7OVmU0GD;
        "bukkit-1.21.7" = _7OVmU0GD;
        "bukkit-1.21.8" = _7OVmU0GD;
        "bukkit-1.21.9" = _7OVmU0GD;
        "bukkit-1.21.10" = _7OVmU0GD;
        ...
        "paper-1.20.6" = _7OVmU0GD;
        "paper-1.21" = _7OVmU0GD;
        "paper-1.21.1" = _7OVmU0GD;
        "paper-1.21.2" = _7OVmU0GD;
        "paper-1.21.3" = _7OVmU0GD;
        "paper-1.21.4" = _7OVmU0GD;
        "paper-1.21.5" = _7OVmU0GD;
        "paper-1.21.6" = _7OVmU0GD;
        "paper-1.21.7" = _7OVmU0GD;
        "paper-1.21.8" = _7OVmU0GD;
        "paper-1.21.9" = _7OVmU0GD;
        "paper-1.21.10" = _7OVmU0GD;
        ...
        "folia-1.20.6" = _7OVmU0GD;
        "folia-1.21" = _7OVmU0GD;
        "folia-1.21.1" = _7OVmU0GD;
        "folia-1.21.2" = _7OVmU0GD;
        "folia-1.21.3" = _7OVmU0GD;
        "folia-1.21.4" = _7OVmU0GD;
        "folia-1.21.5" = _7OVmU0GD;
        "folia-1.21.6" = _7OVmU0GD;
        "folia-1.21.7" = _7OVmU0GD;
        "folia-1.21.8" = _7OVmU0GD;
        "folia-1.21.9" = _7OVmU0GD;
        "folia-1.21.10" = _7OVmU0GD;
        "pkg-1.0.0-RELEASE" = _LmVKfHen;
        "pkg-1.0.1-RELEASE" = _wGbkmfRV;
        "pkg-1.0.2-SNAPSHOT+fd50c51" = _wul1FvN2;
        "pkg-1.0.2-SNAPSHOT+45a7f7e" = _UO5RIf1u;
        "pkg-1.0.2-SNAPSHOT+90c7aca" = _ko8U3AIQ;
        "pkg-1.0.2-SNAPSHOT+3345eed" = _EFK36uHc;
        "pkg-1.0.2-SNAPSHOT+297da9c" = _PQPIN6Xj;
        "pkg-1.0.2-SNAPSHOT+08db3e8" = _BHwKM0zi;
        "pkg-1.1.0+a63605b" = _tSwJeS7U;
        "pkg-1.1.1-SNAPSHOT+bde6185" = _pitvU4vP;
        "pkg-1.1.1-SNAPSHOT+2fca3a9" = _OYkiS4UC;
        "pkg-1.2.0-SNAPSHOT+5ca791b" = _haP6QsLN;
        "pkg-1.2.0-SNAPSHOT+70372df" = _v8eci5wD;
        "pkg-1.2.0-SNAPSHOT+31989b8" = _1SOcCXbo;
        "pkg-1.2.0-SNAPSHOT+dd607c9" = _PSG0QiAF;
        "pkg-1.2.0-SNAPSHOT+2740d52" = _SiHz0SoH;
        "pkg-1.2.0-SNAPSHOT+6d47d8e" = _sLKAJKU4;
        "pkg-1.2.0-SNAPSHOT+e6247eb" = _BdK2g4rw;
        "pkg-1.2.0-SNAPSHOT+b3160e7" = _wCa6slN2;
        "pkg-1.2.0-SNAPSHOT+2d28815" = _1QP0Dpsv;
        "pkg-1.2.0-SNAPSHOT+e996114" = _XrOyBeq5;
        "pkg-1.2.0-SNAPSHOT+7ef8340" = _mC3Z6Kq1;
        "pkg-1.2.0-SNAPSHOT+2142413" = _CSHiXVND;
        "pkg-1.2.0-SNAPSHOT+a610920" = _r0kQNYza;
        "pkg-1.2.0-SNAPSHOT+e368396" = _FTNSfTa8;
        "pkg-1.2.0-SNAPSHOT+e51acf9" = _isAc5KA1;
        "pkg-1.2.0-SNAPSHOT+28511c0" = _nsmgHhI1;
        "pkg-1.2.0-SNAPSHOT+e74e6ae" = _wFgOzqvB;
        "pkg-1.2.0-SNAPSHOT+32921f3" = _eAQ3km23;
        "pkg-1.2.0-SNAPSHOT+2d5ee21" = _jfenyaJj;
        "pkg-1.3.0-DEV+6" = _AFTp45pB;
        "pkg-1.3.0-SNAPSHOT+7" = _LbBtfQ4r;
        "pkg-1.3.0-SNAPSHOT+8" = _QljYp2rf;
        "pkg-1.3.0-SNAPSHOT+9" = _2e9qSzpK;
        "pkg-1.3.0-SNAPSHOT+10" = _3LGNHb1K;
        "pkg-1.3.0-SNAPSHOT+11" = _GNvF8KtD;
        "pkg-1.3.0-SNAPSHOT+12" = _bU086pyG;
        "pkg-1.3.0-SNAPSHOT+13" = _KbMJLJmC;
        "pkg-1.3.0" = _P1GaKII8;
        "pkg-1.3.1" = _o00xn80d;
        "pkg-1.3.2" = _Zw8MTQuX;
        "pkg-1.3.3" = _RMtEQWX5;
        "pkg-1.3.3-SNAPSHOT+19" = _QHeUnF1t;
        "pkg-1.4.0-SNAPSHOT+20" = _A1iWzRz3;
        "pkg-1.4.0-SNAPSHOT+21" = _xeErnJ06;
        "pkg-1.4.0-SNAPSHOT+22" = _Rho1MNvS;
        "pkg-1.4.0-SNAPSHOT+23" = _8BkXTzb7;
        "pkg-1.4.0-SNAPSHOT+24" = _nT85VdgR;
        "pkg-1.4.0-SNAPSHOT+25" = _lyRiDO2f;
        "pkg-1.4.0-SNAPSHOT+30" = _3Qjx5BYO;
        "pkg-1.4.0-SNAPSHOT+31" = _Eceuh0pN;
        "pkg-1.4.0-SNAPSHOT+35" = _qFG7sb5o;
        "pkg-1.4.0-SNAPSHOT+38" = _Qy3dmXuW;
        "pkg-1.4.0-SNAPSHOT+39" = _8P4u92CX;
        "pkg-1.4.0-SNAPSHOT+40" = _fFH6UWsv;
        "pkg-1.4.0-SNAPSHOT+41" = _QlchBBTk;
        "pkg-1.5.0" = _5PE0Btbx;
        "pkg-1.5.1" = _ToqIyknV;
        "pkg-1.5.2" = _IbkcNHek;
        "pkg-1.5.4" = _H1Nlna7H;
