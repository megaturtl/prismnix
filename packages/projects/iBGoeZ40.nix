...
let
    versions = (let
        ...
        _g8FJY2Rt = {
            "id" = "g8FJY2Rt";
            "file" = "morefrogs-fabric-26.2-1.26.9.1.jar";
            "hash" = "sha512-KYqB6T/cgIsXIyj4c+IwBGb2dKKPdrwZ1iTLMQEcaZD3JPJmxZaQJjvvO+k4sMAwDjbyAkYRjIVQtQ8qE0Trpg==";
        };
        _ojP16Dh1 = {
            "id" = "ojP16Dh1";
            "file" = "morefrogs-neoforge-26.2-1.26.9.1.jar";
            "hash" = "sha512-4/4jP2JvQF570qD/Kzv/7oDq1HDyXQegu8QQbRDLnztdpINRLwAs1McWxEoogo4QuRG4gDHc1j58r1hCgzahFw==";
        };
        _R1R4wAJz = {
            "id" = "R1R4wAJz";
            "file" = "morefrogs-fabric-26.2-1.26.9.2.jar";
            "hash" = "sha512-G0HXqya8m/oM7zejBU8oOO28iX4mnsrUuF+djsxfJSSc/PbTtSx90juBCDfcVtgOA/0quEK8mWLFlPLE/9QNdA==";
        };
        _u7LFtbgY = {
            "id" = "u7LFtbgY";
            "file" = "morefrogs-neoforge-26.2-1.26.9.2.jar";
            "hash" = "sha512-vA64CPVHTbQw885bek4vuUaO7NcX10EMcHoOiwlAgKE4v+vSy1MeOBVtOXKpBgCh1S86V8ScuG8vy2b2BvIWfg==";
        };
    in {
        "74sgjqBG" = _74sgjqBG;
        "CmT97aef" = _CmT97aef;
        ...
        "fabric-26.2" = _R1R4wAJz;
        "fabric-26.3-snapshot-1" = _R1R4wAJz;
        "fabric-26.3-snapshot-2" = _R1R4wAJz;
        "fabric-26.3-snapshot-3" = _R1R4wAJz;
        "fabric-26.3-snapshot-4" = _R1R4wAJz;
        "fabric-26.3-snapshot-5" = _R1R4wAJz;
        "fabric-26.3-snapshot-6" = _R1R4wAJz;
        "fabric-26.3-snapshot-7" = _R1R4wAJz;
        "fabric-26.3-snapshot-8" = _R1R4wAJz;
        "fabric-26.3-snapshot-9" = _R1R4wAJz;
        "fabric-26.3-snapshot-10" = _R1R4wAJz;
        "fabric-26.3-pre-1" = _R1R4wAJz;
        ...
        "quilt-26.2" = _R1R4wAJz;
        "quilt-26.3-snapshot-1" = _R1R4wAJz;
        "quilt-26.3-snapshot-2" = _R1R4wAJz;
        "quilt-26.3-snapshot-3" = _R1R4wAJz;
        "quilt-26.3-snapshot-4" = _R1R4wAJz;
        "quilt-26.3-snapshot-5" = _R1R4wAJz;
        "quilt-26.3-snapshot-6" = _R1R4wAJz;
        "quilt-26.3-snapshot-7" = _R1R4wAJz;
        "quilt-26.3-snapshot-8" = _R1R4wAJz;
        "quilt-26.3-snapshot-9" = _R1R4wAJz;
        "quilt-26.3-snapshot-10" = _R1R4wAJz;
        "quilt-26.3-pre-1" = _R1R4wAJz;
        ...
        "neoforge-26.2" = _u7LFtbgY;
        "neoforge-26.3-snapshot-1" = _u7LFtbgY;
        "neoforge-26.3-snapshot-2" = _u7LFtbgY;
        "neoforge-26.3-snapshot-3" = _u7LFtbgY;
        "neoforge-26.3-snapshot-4" = _u7LFtbgY;
        "neoforge-26.3-snapshot-5" = _u7LFtbgY;
        "neoforge-26.3-snapshot-6" = _u7LFtbgY;
        "neoforge-26.3-snapshot-7" = _u7LFtbgY;
        "neoforge-26.3-snapshot-8" = _u7LFtbgY;
        "neoforge-26.3-snapshot-9" = _u7LFtbgY;
        "neoforge-26.3-snapshot-10" = _u7LFtbgY;
        "neoforge-26.3-pre-1" = _u7LFtbgY;
        "pkg-1.19-1.0.0" = _74sgjqBG;
        "pkg-1.19-1.0.0-forge" = _CmT97aef;
        "pkg-1.19-1.1.0-fabric" = _e0JHhDVB;
        "pkg-1.19.x-fabric" = _hDqKqiUL;
        "pkg-1.19.x-1.2.1-fabric" = _YyrNRrZ1;
        "pkg-1.19.x-1.2.2-fabric" = _mGqvnIrn;
        "pkg-1.19-1.0.1-forge" = _TnZVRwcY;
        "pkg-1.19.x-1.2.3-fabric" = _z6G31eZU;
        "pkg-1.19.x-1.1.1-forge" = _bTVucXuk;
        "pkg-1.19.x-1.2.3a-fabric-quilt" = _MndiAlzI;
        "pkg-1.19.x-1.1.1a-forge" = _OoDjNctZ;
        "pkg-1.19.x-1.2.3b-fabric-quilt" = _pZj4dj9Q;
        "pkg-1.19.3-1.2.4a-fabric" = _7kFDbxh6;
        "pkg-1.19.3-1.2.5-fabric" = _FaQKpQaZ;
        "pkg-1.2.5" = _jSQrMOym;
        "pkg-2.0.0" = _JSGczvrQ;
        "pkg-2.0.1" = _97KuBp5I;
        "pkg-2.0.3" = _FnXEQDqi;
        "pkg-1.26.7.4" = _sXKweLS3;
        "pkg-1.26.9.1" = _ojP16Dh1;
        "pkg-1.26.9.2" = _u7LFtbgY;
        "default" = _u7LFtbgY;
    });
