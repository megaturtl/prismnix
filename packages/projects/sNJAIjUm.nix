...
let
    versions = (let
        ...
        _UYMxzqUh = {
            "id" = "UYMxzqUh";
            "file" = "jewelry-neoforge-2.4.0+1.21.1.jar";
            "hash" = "sha512-ptgoS1yqcx47cptzLd+xf2VJIP7JgELO/tXSmeE6EUx7ham52B9wXBd9xmeeQFep2GGcJo8pNIDb+sOKW7d3fQ==";
        };
        _XXizhMNZ = {
            "id" = "XXizhMNZ";
            "file" = "jewelry-fabric-2.4.0+1.21.1.jar";
            "hash" = "sha512-rcEGFi63J5nfx6W0gcDxAsW0DLOtyaXHAsIk1P6B5hIRYMgHKsx7Oj9EhchCrhdYNRA0tVPOT/rJ7yu1JO4clA==";
        };
        _z2o0daz2 = {
            "id" = "z2o0daz2";
            "file" = "jewelry-fabric-2.4.1+26.1.2.jar";
            "hash" = "sha512-aTa7Tva5PNLnIOxtj/o3cxNsKQJt2SBVP12qrX7felH9reAgM+pI3iE8HFlV4q6zf1vb7LQXoJvtLsyEkS4mfQ==";
        };
        _4OiU0vce = {
            "id" = "4OiU0vce";
            "file" = "jewelry-neoforge-2.4.1+26.1.2.jar";
            "hash" = "sha512-hJj7sT72nYU/I1Do7xutx4E+ITenYTy+p6W7oxRmLNr3iVryq/qTdZ14ZXtz40pDnpW859XnEnExhCmkG7V9dw==";
        };
        _Un6Q2icJ = {
            "id" = "Un6Q2icJ";
            "file" = "jewelry-neoforge-2.4.1+26.2.jar";
            "hash" = "sha512-RbDIFK/WpfPFrA6IvHjhPnk0+R+nxO3rma7Jwt1KamKmN9Nfpewto4ej7xPyHg94KZwgQa8H+WhMbD+JloOVBg==";
        };
        _5XsD3uH6 = {
            "id" = "5XsD3uH6";
    ...
    in {
        ...
        "pkg-1.0.1+1.20.1" = _65Fd41kT;
        "pkg-1.1.0+1.19.2" = _CwEN5pPv;
        "pkg-1.1.0+1.20.1" = _4M8lcPaH;
        "pkg-1.1.1+1.20.1" = _X9PIBtmi;
        "pkg-1.1.2+1.20.1" = _ifadZx4z;
        "pkg-1.1.3+1.20.1" = _LFfWOWJ2;
        "pkg-1.2.0+1.20.1" = _mWQ4KSek;
        "pkg-1.2.1+1.20.1" = _S6UgyPaP;
        "pkg-1.2.2+1.20.1" = _S5kYH7fo;
        "pkg-1.2.3+1.20.1" = _zwOZSKqu;
        "pkg-1.2.4+1.20.1" = _3PO8CFiY;
        "pkg-1.3.0+1.20.1" = _O2Qn5G9Z;
        "pkg-1.3.1+1.20.1" = _O2WEGMsP;
        "pkg-1.3.2+1.20.1" = _QGbrNeFd;
        "pkg-1.3.3+1.20.1" = _DIvLFllq;
        "pkg-1.3.4+1.20.1" = _Dhp5wgKk;
        "pkg-1.3.5+1.20.1" = _nOwzxEZn;
        "pkg-1.3.6+1.20.1" = _cAMpQ1jG;
        "pkg-1.3.7+1.20.1" = _O9B6r9VO;
        "pkg-2.0.0+1.21.1" = _oewY3qxQ;
        "pkg-2.0.1+1.21.1" = _5FzmHdd6;
        "pkg-2.0.2+1.21.1" = _IFiwtSBh;
        "pkg-2.0.3+1.21.1" = _JDQ3soyZ;
        "pkg-2.0.4+1.21.1" = _Lf1sGoms;
        "pkg-2.0.5+1.21.1" = _dffVQ6jN;
        "pkg-2.0.7+1.21.1" = _Q4OyURi8;
        "pkg-2.0.8+1.21.1" = _RqdBIR39;
        "pkg-2.0.9+1.21.1" = _rTByhD2b;
        "pkg-2.0.10+1.21.1" = _fXR8JPPC;
        "pkg-2.1.0+1.21.1-neoforge" = _JV7I3ioa;
        "pkg-2.1.1+1.21.1-fabric" = _QOo4t7ki;
        "pkg-2.1.1+1.21.1-neoforge" = _MxercfyV;
        "pkg-2.1.2+1.21.1-neoforge" = _hayXSGQC;
        "pkg-2.1.2+1.21.1-fabric" = _EkWGknD0;
        "pkg-2.2.0+1.21.1-fabric" = _Gt7NdeGh;
        "pkg-2.2.0+1.21.1-neoforge" = _5rc0cmok;
        "pkg-2.3.0+1.21.1-neoforge" = _kYyQQTmC;
        "pkg-2.3.0+1.21.1-fabric" = _RV65nf3J;
        "pkg-2.3.1+1.21.1-fabric" = _x2aaEGEB;
        "pkg-2.3.1+1.21.1-neoforge" = _6yaGdFgV;
        "pkg-2.3.2+1.21.1-neoforge" = _7N47QYpl;
        "pkg-2.3.2+1.21.1-fabric" = _93Bti7MQ;
        "pkg-2.3.3+1.21.1-fabric" = _U02aRsgR;
        "pkg-2.3.3+1.21.1-neoforge" = _DGZ9I5i8;
        "pkg-2.4.0+1.21.1-neoforge" = _UYMxzqUh;
        "pkg-2.4.0+1.21.1-fabric" = _XXizhMNZ;
        "pkg-2.4.1+26.1.2-fabric" = _z2o0daz2;
