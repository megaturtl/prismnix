...
let
    ...
    in {
        ...
        "pkg-1.0.1" = _AA1oeTG2;
        "pkg-1.1.0" = _GNhRnTXT;
        "pkg-1.1.1-1.21.1" = _eYgYM4aT;
        "pkg-1.1.1-1.20.1" = _PouFgTUJ;
        "pkg-1.1.2-1.20.1" = _5JdTygki;
        "pkg-1.1.2-1.21.1" = _zKXMi5cZ;
        "pkg-1.1.3-1.21.1" = _WRtdhCGj;
        "pkg-1.1.3-1.20.1" = _5AGHD33Q;
        "pkg-1.1.3-1.21" = _GNAt9NBw;
        "pkg-2.0.0-1.21.4" = _LFjt7nrv;
        "pkg-2.0.1-1.21.4" = _S99oCKHm;
        "pkg-2.1.0-1.21.4" = _Jxju4rsB;
        "pkg-2.1.1-1.21.4" = _EKEcOw18;
        "pkg-2.1.1-1.21.1" = _tMJzaINT;
        "pkg-2.1.2-1.21.1" = _nwilWGIu;
        "pkg-2.1.3-1.21.1" = _gfAjwHyK;
        "pkg-2.1.4-1.21.1" = _LbNsY902;
        "pkg-2.2.0-1.21.1" = _aotvpcuY;
        "pkg-2.2.0-1.21.4" = _YNk2p8QF;
        "pkg-2.2.1-1.21.4" = _tPyd8LZW;
        "pkg-2.2.2-1.21.4" = _ymaGZpQR;
        "pkg-2.2.3-1.21.4" = _jqR5jmUf;
        "pkg-2.2.4-1.21.4" = _3pv1Y6xV;
        "pkg-2.3.0-1.21.4" = _aU40AEYC;
        "pkg-2.3.1-1.21.4" = _lEuHDiwV;
        "pkg-2.3.2-1.21.4" = _fanQPJ5U;
        "pkg-2.4.1-1.21.4" = _GvWAFDYK;
        "pkg-2.4.2-1.21.4" = _Roi0iF7B;
        "pkg-2.4.4-1.21.4" = _x6QmJWJ6;
        "pkg-2.4.5-1.21.4" = _y58104a0;
        "pkg-prominence-1.0.0" = _vi1J5PxU;
        "pkg-3.0.0-1.21.5-beta" = _sfIo2pS1;
        "pkg-3.0.0-1.21.5-beta3" = _QN3ZsLpx;
        "pkg-3.0.0-1.21.5-beta3.5" = _oZscYDy5;
        "pkg-3.0.0-1.21.5-pre1" = _Ak6ik4vK;
        "pkg-3.0.0-1.21.6" = _PO0wQd5U;
        "pkg-prominence-1.1.0" = _hoHdZ9M1;
        "pkg-3.0.2-1.21.7" = _oyHpWmCV;
        "pkg-3.0.3-1.21.7" = _SDskxQor;
        "pkg-2.2.1-1.21.1" = _p4AzAOrN;
        "pkg-3.0.4-1.21.7" = _dkIBgcPn;
        "pkg-3.0.5-1.21.7" = _KGyErtiZ;
        "pkg-3.0.6-1.21.7" = _cMG9mNia;
        "pkg-3.0.7-1.21.7" = _JdNi3v59;
        "pkg-3.0.8-1.21.7" = _yrKE601b;
        "pkg-3.0.9-1.21.8" = _2zo8QGoS;
        "pkg-3.0.10-1.21.8" = _6DboX29E;
        "pkg-3.0.10-1.21.9" = _hZW3WhF6;
        "pkg-3.0.11-1.21.10" = _TQ40uEiv;
        "pkg-3.0.12-1.21.10" = _CPSjBNiv;
        "pkg-3.0.13.5-1.21.10" = _QyuJC7A9;
        "pkg-3.0.15-1.21.10" = _20ffVr8J;
        "pkg-3.0.16-1.21.10" = _EO1QhOiN;
        "pkg-3.0.17-1.21.10" = _T3LzPpOf;
        "pkg-3.1.0-1.21.10" = _4xIBjxbw;
        "pkg-3.1.1-1.21.10" = _rJwgNyrX;
        "pkg-3.1.2-1.21.10" = _94HDaua1;
        "pkg-3.1.3-1.21.10" = _11sQALTr;
        "pkg-3.1.3-1.21.11" = _gItapK9O;
        "pkg-3.1.4-1.21.11" = _xMPWhvsq;
        "pkg-3.1.5-1.21.11" = _VBYQ7uv5;
        "pkg-3.1.6-1.21.11" = _XQuDEguW;
        "pkg-3.1.7-1.21.11" = _6o3FVQZE;
        "pkg-3.1.7-26.1.1" = _pw7jHmuQ;
        "pkg-3.1.8-26.1.1" = _o33BbNjY;
        "pkg-3.1.9-26.2" = _hDPZdayw;
