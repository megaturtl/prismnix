...
let
    ...
    in {
        ...
        "pkg-16.0.0+fabric-1.19.3" = _jJxa5Gmc;
        "pkg-14.1.1+forge-1.18.2" = _HSWQDe7S;
        "pkg-14.1.1+fabric-1.18.2" = _LlFwkgUx;
        "pkg-16.0.1+forge-1.19.3" = _9tmOVtry;
        "pkg-16.0.1+fabric-1.19.3" = _Pb0E8WZN;
        "pkg-15.0.1+forge-1.19" = _Et9oI0rT;
        "pkg-15.0.1+fabric-1.19" = _QSc3hlWR;
        "pkg-14.1.2+forge-1.18.2" = _aiy49T0Q;
        "pkg-14.1.2+fabric-1.18.2" = _o32sAXGh;
        "pkg-17.0.1+fabric-1.19.4" = _NdWk53Qq;
        "pkg-17.0.1+forge-1.19.4" = _h2fGLwAL;
        "pkg-18.0.0+fabric-1.20" = _gUEpxWEe;
        "pkg-18.0.0+forge-1.20" = _iuGiPVsP;
        "pkg-18.0.1+fabric-1.20" = _QIKpMBgZ;
        "pkg-18.0.1+forge-1.20" = _CKNINccT;
        "pkg-16.0.2+forge-1.19.3" = _n1N8gK1t;
        "pkg-16.0.2+fabric-1.19.3" = _srYLHGmM;
        "pkg-15.0.2+forge-1.19" = _wRqU3JuA;
        "pkg-15.0.2+fabric-1.19" = _64N7yejA;
        "pkg-17.0.2+fabric-1.19.4" = _7P1WUDrG;
        "pkg-17.0.2+forge-1.19.4" = _ayHJIZRi;
        "pkg-19.0.0+fabric-1.20.2" = _w9xvfauD;
        "pkg-19.0.0+forge-1.20.2" = _HYa1CJIc;
        "pkg-19.0.0+neoforge-1.20.2" = _E01imSXQ;
        "pkg-20.0.1+fabric-1.20.4" = _NqeV4Paq;
        "pkg-20.0.1+forge-1.20.4" = _dKbEPttX;
        "pkg-20.0.1+neoforge-1.20.4" = _1ND1cFJv;
        "pkg-20.0.2+fabric-1.20.4" = _WQuAHNve;
        "pkg-20.0.2+forge-1.20.4" = _fDOyeuYl;
        "pkg-20.0.2+neoforge-1.20.4" = _NWRiaqeG;
        "pkg-21.0.1+fabric-1.20.6" = _R4Z3bOY5;
        "pkg-21.0.1+forge-1.20.6" = _5yhpUFE5;
        "pkg-21.0.1+neoforge-1.20.6" = _tcduI2FF;
        "pkg-21.0.2+fabric-1.20.6" = _YfMiHW38;
        "pkg-21.0.2+forge-1.20.6" = _QT19TeGt;
        "pkg-21.0.2+neoforge-1.20.6" = _HMv3cEyp;
        "pkg-21.0.3+fabric-1.21" = _kd9i6umo;
        "pkg-21.0.3+forge-1.21" = _S7wQIhjQ;
        "pkg-21.0.3+neoforge-1.21" = _nSe8oUzh;
        "pkg-21.0.4+fabric-1.21" = _V6HApGrN;
        "pkg-21.0.4+forge-1.21" = _AgvPxmYh;
        "pkg-21.0.4+neoforge-1.21" = _50eZyhJE;
        "pkg-21.0.5+fabric-1.21" = _zyBAn9sF;
        "pkg-21.0.5+forge-1.21" = _I9dAQbVD;
        "pkg-21.0.5+neoforge-1.21" = _pnMgBZuC;
        "pkg-20.6.4+forge-1.20.6" = _PS0CDIsy;
        "pkg-20.6.4+fabric-1.20.6" = _6Co6VRHI;
        "pkg-20.6.4+neoforge-1.20.6" = _uOdOANmX;
        "pkg-21.1.1+fabric-1.21.1" = _GWn9yrIl;
        "pkg-21.1.1+forge-1.21.1" = _ykQUKekE;
        "pkg-21.1.1+neoforge-1.21.1" = _eczePZAa;
        "pkg-21.3.1+fabric-1.21.3" = _s4ADgT2J;
        "pkg-21.3.1+neoforge-1.21.3" = _uPvP8MQV;
        "pkg-21.4.1+fabric-1.21.4" = _DvkKvLnO;
        "pkg-21.4.1+neoforge-1.21.4" = _3vQgoPcl;
        "pkg-21.1.2+fabric-1.21.1" = _hI8pZoVS;
        "pkg-21.1.2+forge-1.21.1" = _sppbOOlH;
        "pkg-21.1.2+neoforge-1.21.1" = _zCo3ri3t;
        "pkg-21.3.2+fabric-1.21.3" = _3fd2tq79;
        "pkg-21.4.2+fabric-1.21.4" = _ZLoAo5ZN;
        "pkg-21.3.2+neoforge-1.21.3" = _sTd7pJPj;
        "pkg-21.4.2+neoforge-1.21.4" = _jEO1c8T6;
        "pkg-21.4.3+forge-1.21.4" = _wWDxSwWY;
        "pkg-21.5.1+fabric-1.21.5" = _jHYasDzM;
        "pkg-21.5.1+neoforge-1.21.5" = _BcKTCcpW;
        "pkg-21.5.2+forge-1.21.5" = _ZdWqs4Hr;
        "pkg-21.6.1+fabric-1.21.6" = _gtTsxotk;
        "pkg-21.6.1+neoforge-1.21.6" = _2zjzruU6;
        "pkg-21.6.2+forge-1.21.6" = _Ezg2oxzP;
        "pkg-21.7.1+forge-1.21.7" = _RR1cqbSe;
        "pkg-21.7.1+neoforge-1.21.7" = _gweYHjqZ;
        "pkg-21.7.1+fabric-1.21.7" = _diRbJIIP;
        "pkg-21.8.1+fabric-1.21.8" = _JsYsSvoy;
        "pkg-21.8.1+neoforge-1.21.8" = _NkQrZkDb;
        "pkg-21.8.1+forge-1.21.8" = _zg3P8ngi;
        "pkg-18.0.2+fabric-1.20.1" = _zgawi2vw;
        "pkg-18.0.2+forge-1.20.1" = _qCfqBSp6;
        "pkg-21.8.2+fabric-1.21.8" = _asXdkWEY;
        "pkg-21.1.3+fabric-1.21.1" = _rReL4zP9;
        "pkg-21.1.3+forge-1.21.1" = _Ts61W7aq;
        "pkg-21.1.3+neoforge-1.21.1" = _TgvWvpaq;
        "pkg-21.8.2+neoforge-1.21.8" = _k2ePJ00J;
        "pkg-21.8.2+forge-1.21.8" = _VeVO4A43;
        "pkg-21.5.3+fabric-1.21.5" = _1WcfjGqW;
        "pkg-21.4.4+fabric-1.21.4" = _OGdQkWTP;
        "pkg-21.4.4+neoforge-1.21.4" = _Y0g5lwVM;
        "pkg-21.4.4+forge-1.21.4" = _uVtEPF5h;
        "pkg-21.5.3+forge-1.21.5" = _MHxorZlv;
        "pkg-21.5.3+neoforge-1.21.5" = _MbMzl7N4;
        "pkg-21.8.3+fabric-1.21.8" = _HEMrwiBR;
        "pkg-21.1.4+fabric-1.21.1" = _WarM6iFt;
        "pkg-21.1.4+forge-1.21.1" = _LHZcof0j;
        "pkg-21.8.3+forge-1.21.8" = _kAjyArj2;
        "pkg-21.1.4+neoforge-1.21.1" = _zFWJFG9t;
        "pkg-21.8.3+neoforge-1.21.8" = _WpS45PIo;
        "pkg-18.0.3+forge-1.20.1" = _vNF6Yrv4;
        "pkg-18.0.3+fabric-1.20.1" = _Mv3kSrRO;
        "pkg-21.4.5+fabric-1.21.4" = _oIHjFeUL;
        "pkg-21.5.4+fabric-1.21.5" = _v06zNwdK;
        "pkg-21.5.4+forge-1.21.5" = _EkLZj13w;
        "pkg-21.5.4+neoforge-1.21.5" = _UDaZ0VMv;
        "pkg-21.4.5+neoforge-1.21.4" = _d55UrYu8;
        "pkg-21.4.5+forge-1.21.4" = _xgvqLfVt;
        "pkg-18.0.4+fabric-1.20.1" = _cxuTtrVx;
        "pkg-21.1.5+fabric-1.21.1" = _LxHdpgVy;
        "pkg-18.0.4+forge-1.20.1" = _t5i53ltA;
        "pkg-21.1.5+forge-1.21.1" = _sW6utwEI;
        "pkg-21.1.5+neoforge-1.21.1" = _akQv5d1t;
        "pkg-21.8.4+fabric-1.21.8" = _XkZKKVyj;
        "pkg-21.5.5+fabric-1.21.5" = _IuNtuxgR;
        "pkg-21.8.4+neoforge-1.21.8" = _e0J5IrUi;
        "pkg-21.8.4+forge-1.21.8" = _Eko7eink;
        "pkg-21.5.5+forge-1.21.5" = _MY0NYd3j;
        "pkg-21.4.6+fabric-1.21.4" = _8HyKmWpB;
        "pkg-21.4.6+neoforge-1.21.4" = _PTnvHaO1;
        "pkg-21.5.5+neoforge-1.21.5" = _fxp3ip8k;
        "pkg-21.4.6+forge-1.21.4" = _PinpOdOI;
        "pkg-21.9.1+fabric-1.21.9" = _a8RD35pt;
        "pkg-21.9.1+neoforge-1.21.9" = _xjDm4Ttb;
        "pkg-21.8.5+fabric-1.21.8" = _wxRZWZ0x;
        "pkg-21.8.5+forge-1.21.8" = _HwSwzTQI;
        "pkg-21.8.5+neoforge-1.21.8" = _ZpF4ctjV;
        "pkg-21.10.1+fabric-1.21.10" = _gRtw5ugo;
        "pkg-21.10.1+neoforge-1.21.10" = _sf8wxnfb;
        "pkg-21.10.1+forge-1.21.10" = _D7cpjFsC;
        "pkg-21.10.2+forge-1.21.10" = _Fkh7fRzL;
        "pkg-21.11.1+neoforge-1.21.11" = _px9l8O97;
        "pkg-21.11.1+fabric-1.21.11" = _Y5oU2dqZ;
        "pkg-21.11.3+forge-1.21.11" = _hmnCx4we;
        "pkg-26.1.0.1+fabric-26.1" = _DIfxcONY;
        "pkg-26.1.0.1+neoforge-26.1" = _ylZwh8yE;
        "pkg-21.1.6+fabric-1.21.1" = _ts4ygA2C;
        "pkg-21.1.6+neoforge-1.21.1" = _RHtZ1B17;
        "pkg-21.1.6+forge-1.21.1" = _8Y3EFb1p;
        "pkg-26.2.0.1+fabric-26.2" = _USWFHeGZ;
        "pkg-26.2.0.1+neoforge-26.2" = _8wBGKStJ;
        "pkg-26.2.0.2+fabric-26.2" = _FDkyniQi;
        "pkg-26.2.0.2+neoforge-26.2" = _gaAKZLu1;
        "pkg-26.1.2.1+fabric-26.1.2" = _MT52suO9;
        "pkg-26.1.2.1+neoforge-26.1.2" = _NN3JBSDv;
        "pkg-18.0.5+fabric-1.20.1" = _3fViiF51;
        "pkg-18.0.5+forge-1.20.1" = _AVz3mvZZ;
        "pkg-21.1.7+fabric-1.21.1" = _xaqHFEAN;
        "pkg-21.1.7+neoforge-1.21.1" = _zzMoq9Cs;
        "pkg-21.1.7+forge-1.21.1" = _AylKDl22;
        "pkg-18.0.6+fabric-1.20.1" = _1nZGLni7;
        "pkg-26.2.0.3+fabric-26.2" = _hS9ZtUOA;
        "pkg-26.2.0.3+neoforge-26.2" = _21bFjBeP;
        "pkg-26.1.2.2+fabric-26.1.2" = _nXJ1NvhQ;
        "pkg-26.1.2.2+neoforge-26.1.2" = _hakaEFny;
