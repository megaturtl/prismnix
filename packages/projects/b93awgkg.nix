...
let
    versions = (let
        ...
        _WL6fnRhA = {
            "id" = "WL6fnRhA";
            "file" = "status-fabric-1.1.0+26.3.jar";
            "hash" = "sha512-bfd8qoThf0szlXqOhxn0TAAc/s8DG5H/9ZvBWP9Uw7SbgcWT0Je9obAVQ0lmx59mUCfCDur2f1DD9WfILP921Q==";
        };
    in {
        "PlroDSu5" = _PlroDSu5;
        "KFyaZuSw" = _KFyaZuSw;
        ...
        "pkg-fabric-1.1.0+26.3" = _WL6fnRhA;
        "default" = _WL6fnRhA;
    });
