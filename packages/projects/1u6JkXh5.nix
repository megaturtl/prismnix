...
let
    versions = (let
        ...
        _6YnCYPwc = {
            "id" = "6YnCYPwc";
            "file" = "worldedit-mod-7.4.5.jar";
            "hash" = "sha512-YR/3zADXjGOihO8mtvvIBq8pXEaTdeXnHk1+mTqm6j+pCUXkZRHJm2FXoB7Vw4aKKmQZtHo4EUzB5nsywg98ow==";
        };
        _F5ea2ov3 = {
            "id" = "F5ea2ov3";
            "file" = "worldedit-bukkit-7.4.5.jar";
            "hash" = "sha512-o4NJL6xr+01Dolffp7X8B2quUDpxFRtGPeT+gObz1fwRIJ6vQJe6oRXz/r8K3EDKCh7Noie4Q5tCnQpLo6Y6Tw==";
        };
    in {
        "Dg6Ca50i" = _Dg6Ca50i;
        "AIgHtI8t" = _AIgHtI8t;
        ...
        "bukkit-1.21.4" = _F5ea2ov3;
        "bukkit-1.21.5" = _F5ea2ov3;
        "bukkit-1.21.6" = _F5ea2ov3;
        "bukkit-1.21.7" = _F5ea2ov3;
        "bukkit-1.21.8" = _F5ea2ov3;
        "bukkit-1.21.9" = _F5ea2ov3;
        "bukkit-1.21.10" = _F5ea2ov3;
        "bukkit-1.21.11" = _F5ea2ov3;
        "bukkit-26.1" = _F5ea2ov3;
        "bukkit-26.1.1" = _F5ea2ov3;
        "bukkit-26.1.2" = _F5ea2ov3;
        "bukkit-26.2" = _F5ea2ov3;
        ...
        "spigot-1.21.4" = _F5ea2ov3;
        "spigot-1.21.5" = _F5ea2ov3;
        "spigot-1.21.6" = _F5ea2ov3;
        "spigot-1.21.7" = _F5ea2ov3;
        "spigot-1.21.8" = _F5ea2ov3;
        "spigot-1.21.9" = _F5ea2ov3;
        "spigot-1.21.10" = _F5ea2ov3;
        "spigot-1.21.11" = _F5ea2ov3;
        "spigot-26.1" = _F5ea2ov3;
        "spigot-26.1.1" = _F5ea2ov3;
        "spigot-26.1.2" = _F5ea2ov3;
        "spigot-26.2" = _F5ea2ov3;
        ...
        "paper-1.21.4" = _F5ea2ov3;
        "paper-1.21.5" = _F5ea2ov3;
        "paper-1.21.6" = _F5ea2ov3;
        "paper-1.21.7" = _F5ea2ov3;
        "paper-1.21.8" = _F5ea2ov3;
        "paper-1.21.9" = _F5ea2ov3;
        "paper-1.21.10" = _F5ea2ov3;
        "paper-1.21.11" = _F5ea2ov3;
        "paper-26.1" = _F5ea2ov3;
        "paper-26.1.1" = _F5ea2ov3;
        "paper-26.1.2" = _F5ea2ov3;
        "paper-26.2" = _F5ea2ov3;
        ...
        "neoforge-26.2" = _6YnCYPwc;
        "folia-1.21.4" = _F5ea2ov3;
        "folia-1.21.5" = _F5ea2ov3;
        "folia-1.21.6" = _F5ea2ov3;
        "folia-1.21.7" = _F5ea2ov3;
        "folia-1.21.8" = _F5ea2ov3;
        "folia-1.21.9" = _F5ea2ov3;
        "folia-1.21.10" = _F5ea2ov3;
        "folia-1.21.11" = _F5ea2ov3;
        "folia-26.1" = _F5ea2ov3;
        "folia-26.1.1" = _F5ea2ov3;
        "folia-26.1.2" = _F5ea2ov3;
        "folia-26.2" = _F5ea2ov3;
        "pkg-5.3" = _Dg6Ca50i;
        "pkg-5.4" = _AIgHtI8t;
        "pkg-5.4.1" = _AFHCVxTg;
        "pkg-5.4.2" = _hMId5U9N;
        ...
        "pkg-5.6.2" = _otWEqKO8;
        "pkg-5.6.3" = _C7AM2Nf7;
        "pkg-6.0-beta-01" = _1TfwProW;
        "pkg-6.0" = _K9Kr1Adh;
        "pkg-6.1" = _XCmvEOto;
        "pkg-6.0-alpha-01" = _9SnkhqdV;
        "pkg-6.1.1" = _CW7JWsgU;
        "pkg-6.1.2" = _7MeVDPGO;
        "pkg-6.1.3" = _7Aay0MZN;
        "pkg-6.1.4" = _cFsJ57F7;
        "pkg-6.1.5" = _z3kpR8EM;
        "pkg-6.1.6" = _N6JysKOE;
        "pkg-6.1.7.2" = _YaTbijLh;
        "pkg-6.1.7.3" = _tIX9g91q;
        "pkg-6.1.8" = _cyiJNYhk;
        "pkg-6.1.9" = _JezAXbj7;
        "pkg-6.1.10" = _GaGvu76z;
        "pkg-7.0.0" = _etwT4uGE;
        "pkg-7.0.1" = _2uJu3ngh;
        "pkg-7.1.0" = _p4TkysW2;
        "pkg-7.2.0-beta-03" = _zaQ8qMzP;
        "pkg-7.2.0" = _l9stATkW;
        "pkg-7.2.1" = _vZZ3kA17;
        "pkg-7.2.2" = _ObVDD08E;
        "pkg-7.2.3" = _uP57Puxr;
        ...
        "pkg-7.2.8" = _CjJgblfK;
        "pkg-7.2.9" = _Ruu3UNJL;
        "pkg-7.2.10" = _1e0moJAJ;
        "pkg-7.2.11-beta-01" = _TP7zga9i;
        "pkg-7.2.11-beta-02" = _CIVe1lu1;
        "pkg-7.2.11" = _LMELD5yT;
        "pkg-7.2.12" = _nUSfYzrB;
        "pkg-7.2.13" = _zssGEU1n;
        "pkg-7.2.14" = _MaJdQbX5;
        "pkg-7.2.15" = _XL2dgNKo;
        "pkg-7.2.16" = _cehBcfHA;
        "pkg-7.3.0-beta-01" = _vMYSETPc;
        "pkg-7.2.17" = _KGSgRLZU;
        "pkg-7.3.0-beta-02" = _ans4Koju;
        "pkg-7.2.18" = _aNn2Fqf4;
        "pkg-7.3.0-beta-03" = _jiqenRwc;
        "pkg-7.2.19" = _TdNeSMad;
        "pkg-7.3.0-beta-04" = _gaP8AHk5;
        "pkg-7.2.20" = _DfjpjdP5;
        "pkg-7.3.0" = _JzCMkGax;
        "pkg-7.3.1" = _j8KJp1Ch;
        "pkg-7.3.2" = _VaMk0SQH;
        "pkg-7.3.3" = _kZ0IykHx;
        "pkg-7.3.4-beta-01" = _DBLNBwrB;
        "pkg-7.3.4" = _vMrPkmgF;
        "pkg-7.3.5" = _Jo76t1oi;
        "pkg-7.3.6" = _yAujLUIK;
        "pkg-7.3.7" = _H12HdUau;
        "pkg-7.3.8" = _ecqqLKUO;
        "pkg-7.3.9-beta-01" = _lynJ1VTU;
        "pkg-7.3.9" = _Bu1zaaoc;
        "pkg-7.3.10-beta-01" = _HIoAq6RI;
        "pkg-7.3.10" = _4jRlujfz;
        "pkg-7.3.11" = _DlD8WKr9;
        "pkg-7.3.12-beta-01" = _NhJaettg;
        "pkg-7.3.12-beta-02" = _aqvVpeHP;
        "pkg-7.3.12" = _9Z1aKSP5;
        "pkg-7.3.13" = _U0uDF7yg;
        "pkg-7.3.14" = _txgouwkE;
        "pkg-7.3.15-beta-01" = _DYf6XJqU;
        "pkg-7.3.15-beta-02" = _UIGHLWyH;
        "pkg-7.3.15" = _DpmreoFj;
        "pkg-7.3.16" = _Jk1z2u7n;
        "pkg-7.3.17-beta-01" = _xuV6tYbh;
        "pkg-7.3.17" = _3ISh7ADm;
        "pkg-7.4.0-beta-01" = _5T0Vw5PH;
        "pkg-7.3.18-beta-01" = _qYMNQYjH;
        "pkg-7.3.18" = _XlUIRmF8;
        "pkg-7.4.0-beta-02" = _sO1YYZp4;
        "pkg-7.4.0-beta-03" = _K7geSdjb;
        "pkg-7.4.0-beta-03.1" = _7cjC8upt;
        "pkg-7.4.0-rc-01" = _1MJ3rIHu;
        "pkg-7.3.19" = _2YDdVDmG;
        "pkg-7.4.0" = _CkT32vix;
        "pkg-7.4.1" = _JUWRHdru;
        "pkg-7.4.2" = _p8T2aZ8U;
        "pkg-7.4.3-beta-01" = _k9KdTr1M;
        "pkg-7.4.3" = _yDUBafTJ;
        "pkg-7.4.4-beta-01" = _ESAHQFYo;
        "pkg-7.4.4" = _qNuPcliz;
        "pkg-7.4.5" = _F5ea2ov3;
        "default" = _F5ea2ov3;
    });
