...
let
    ...
    in {
        ...
        "pkg-1.19-1.3.0-alpha+20220611-1631" = _OMz3I51w;
        "pkg-1.19-1.3.0-beta.1" = _LGxPH3kT;
        "pkg-1.19.1-1.3.0" = _YYzqLaCF;
        "pkg-1.19.1-1.3.1" = _T0Vuacdc;
        "pkg-1.19.1-2.0.0-alpha+20221129-2000" = _LtSDNmU4;
        "pkg-1.19.1-2.0.0-alpha+20221130-1944" = _vvmKGwgK;
        "pkg-1.19.3-2.0.0-alpha+20221210-1600" = _oyILpkgl;
        "pkg-1.19.3-2.0.0" = _7DSFuLx6;
        "pkg-1.19.4-2.1.0-beta.1" = _TzedjL2r;
        "pkg-1.19.4-2.1.0" = _lWVMkenc;
        "pkg-1.20-2.1.0-beta.1" = _eTqAeXTY;
        "pkg-2.1.0" = _qCMwYRMZ;
        "pkg-1.20.2-2.2.0-beta.1" = _sf6rQV1I;
        "pkg-1.20.2-2.2.2" = _mT2MWO6E;
        "pkg-1.20.4-2.3.0" = _jTJdbzqz;
        "pkg-1.20.4-2.4.0" = _ycktuOAM;
        "pkg-1.20.4-2.4.0-beta.2" = _EAuhPNWJ;
        "pkg-1.20.4-2.4.0-beta.3" = _3jf82FH4;
        "pkg-1.20.5-2.4.0-alpha+20240426-1014" = _bkznYPhC;
        "pkg-1.20.6-2.4.0-beta.1" = _KqANRruk;
        "pkg-1.20.6-2.4.0-alpha+20240524-1135" = _BgMirDSb;
        "pkg-1.20.6-2.4.0" = _vevYWRUB;
        "pkg-1.21-2.4.0-beta.1" = _XuIn8XaI;
        "pkg-1.21-2.4.0" = _BCoUwPez;
        "pkg-1.21.1-2.5.0" = _NojyWO79;
        "pkg-1.21.3-2.5.0" = _qqlfBEcb;
        "pkg-1.21.4-2.5.0" = _zF8Lqc52;
        "pkg-1.21.4-2.5.1" = _K8FRo0fL;
        "pkg-1.21.1-2.5.1" = _PVzaPLSv;
        "pkg-1.21-2.4.1" = _Gm5HIFYa;
