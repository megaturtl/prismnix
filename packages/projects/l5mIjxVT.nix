...
let
    ...
    in {
        ...
        "pkg-0.3.4" = _p537NWwy;
        "pkg-1.0.0" = _Lffkf1ZQ;
        "pkg-1.0.0+mod" = _GA1Gk0yE;
        "pkg-1.1.0" = _CwsTLCz3;
        "pkg-1.1.0+mod" = _hg4WBsKq;
        "pkg-1.1.0.1" = _2caVSdZb;
        "pkg-1.1.0.1+mod" = _1Ut4Z0Ao;
        "pkg-1.1.0.1-HF" = _qSRDwwSJ;
        "pkg-1.1.0.1-HF+mod" = _CrTDttjp;
        "pkg-1.2.0" = _BvhTbKgP;
        "pkg-1.2.0+mod" = _doNRRdxc;
        "pkg-1.3.0" = _eDbDEauR;
        "pkg-1.3.0+mod" = _PomXm24y;
        "pkg-1.4.0" = _lVLnOQTH;
