...
let
    versions = (let
        ...
        _JitAkkR2 = {
            "id" = "JitAkkR2";
            "file" = "skinrestorer-2.11.0+1.19.1-fabric.jar";
            "hash" = "sha512-VWOiBEfP9Bh8FPj8Lsb1k/1FgYB9SXDJQc0IqAA0855krZ9WIl9lkZx0lUnM69/Qd7bp7P3RV4vNxBNAZmGeZg==";
        };
        _Pjwououg = {
            "id" = "Pjwououg";
            "file" = "skinrestorer-2.11.0+1.19.1-forge.jar";
            "hash" = "sha512-8if/JR8UnQne38+MdkZFCUQUQU44Hs7iWqFznvzq1XEz3uk/IxWzUc3YV/5Jtzp2VwzOcbWa83BjbYZW8qU68w==";
        };
        _MY53lLws = {
            "id" = "MY53lLws";
            "file" = "skinrestorer-2.11.0+1.19.3-forge.jar";
            "hash" = "sha512-qo4QMJyL6o0hNam4tlhvjMVcFIR6CbImD9l39aAhhPNXAzPvw7CtG1P+z9OlEq1a6gxw9uPxfgCbjqPIkKf/PA==";
        };
        _PajNReVl = {
            "id" = "PajNReVl";
            "file" = "skinrestorer-2.11.0+1.19.3-fabric.jar";
            "hash" = "sha512-XNeC5eve9FtVmrB8iE16WSy360KyvAcQxTbjffvKYQb89w0lBTiljGMBBaRI1s6j5fqwYvRoSC9AA5ExhCsYaA==";
        };
        _jtDM8We4 = {
            "id" = "jtDM8We4";
            "file" = "skinrestorer-2.11.0+1.19.4-fabric.jar";
            "hash" = "sha512-UOxIVXmqU7QSxUMtWqcavtB+ymIBtFRQkuvsivAEd6psCRBGSVKnU8Akv295scNh9wT7peUkwUE2b2brA4KTWQ==";
        };
        _71e6rNg8 = {
            "id" = "71e6rNg8";
            "file" = "skinrestorer-2.11.0+1.19.4-forge.jar";
            "hash" = "sha512-wkQOpem3CDC4ZR2npbi9ikriUjUcD3w/i31rPU98q3SLvhBrL1RtIH2TRjLUG4EfnqAB4qFIK7pxZwBt4WvBTQ==";
        };
        _WwS30jjd = {
            "id" = "WwS30jjd";
            "file" = "skinrestorer-2.11.0+1.20-forge.jar";
            "hash" = "sha512-MkDWHcUGpi0wbGZvum+Uq1AgzywFDtphVCeK5ZXgt3A1i4UFJx3iINDSgAIN7zZOPXsWbRt9bjnGI8zea9alXA==";
        };
        _uCDr3lnP = {
            "id" = "uCDr3lnP";
            "file" = "skinrestorer-2.11.0+1.20-fabric.jar";
            "hash" = "sha512-JHd+sLn1q0ksGvlHzbsggvzjV5o2+Atc4kANm60SDfsv90yVQ1wPRNIGJVY4RQac0zMkDu897s8JqWA7DKVLew==";
        };
        _hVMzMRoD = {
            "id" = "hVMzMRoD";
            "file" = "skinrestorer-2.11.0+1.20.2-forge.jar";
            "hash" = "sha512-76vkH9VQoyDmifvxhUnBufxtGWtGv2grNpa3kT5vlhDUkaJ+oS0Ggx2XLCpDDIYOf9a8e574gytrjdPA4d/T6Q==";
        };
        _KAkbimaV = {
            "id" = "KAkbimaV";
            "file" = "skinrestorer-2.11.0+1.20.2-fabric.jar";
            "hash" = "sha512-s5FZbL+YD60pyscZqJbiPwWW3gATvZbt6r5NYrhqOQnxOM9Q5dRhOjbk2kaT/ZVJy5VnIAgN6C719su1ZMKEbg==";
        };
        _pRGFaBhH = {
            "id" = "pRGFaBhH";
            "file" = "skinrestorer-2.11.0+1.20.3-forge.jar";
            "hash" = "sha512-xhi0qHePDoxdhlkYRFzySxyVD1nR5Z4KgstWn7lAeehQ0deZlrF89ceaZtNI3CRrTwf9WZfC/08p/0aDkHm5bA==";
        };
        _rTvrYf51 = {
            "id" = "rTvrYf51";
            "file" = "skinrestorer-2.11.0+1.20.3-fabric.jar";
            "hash" = "sha512-q6vHNGqQi/qkLPox5qY22n/xK4wTXskW5yi5wIU1od+AcM56YYKooujlOiGP7qzOaso050iycE9xerTgZ/qKCw==";
        };
        _2ANinEFu = {
            "id" = "2ANinEFu";
            "file" = "skinrestorer-2.11.0+1.20.5-forge.jar";
            "hash" = "sha512-pUR+3cVrw02iC4KzzgPhXiTrcWXleoM/7FNLt2TLHsNIoUrDqOaB9Q7y2ogkcmdR+b5tqsa8nDkp1Kv5UbBlYQ==";
        };
        _M3QbnmLq = {
            "id" = "M3QbnmLq";
            "file" = "skinrestorer-2.11.0+1.20.5-fabric.jar";
            "hash" = "sha512-4clmWYI5GXjuZI+E9OWiB6BCsc3KMF4Cer5dNKRrDAK2WM11k59oGXiIcr0/qlxQPQ/0Xy/aA/7oX/eoWlH+mQ==";
        };
        _QFkb2iq2 = {
            "id" = "QFkb2iq2";
            "file" = "skinrestorer-2.11.0+1.21-neoforge.jar";
            "hash" = "sha512-Tz3oYZo+z04po983nUIV+gujFDV3gjUFsWngxhZnGDVVaY77qKCTk2Is5we/qOEHn0no8pT3TxXLwRF3LXOjNA==";
        };
        _fCzJclBX = {
            "id" = "fCzJclBX";
            "file" = "skinrestorer-2.11.0+1.21-forge.jar";
            "hash" = "sha512-8UYqIm5XWcwjmqgy5rnsbnYh7W+K894rGacRXhOgC4aEFw6X3gh5q6XkBWf3w+eST2V6t15sGREwtHnQ/gaRwA==";
        };
        _xE07fxaw = {
            "id" = "xE07fxaw";
            "file" = "skinrestorer-2.11.0+1.21-fabric.jar";
            "hash" = "sha512-h42bO6idvaj4X7CSLGbBhDz5fwO2VMy2xdtLrABZMg8Aox7XqgrVs5+io1bDBUSq8DVI7fjPxlOluPfa3A8XAA==";
        };
        _mYqTWKPW = {
            "id" = "mYqTWKPW";
            "file" = "skinrestorer-2.11.0+1.21.5-neoforge.jar";
            "hash" = "sha512-/l2tIdevdmBp9YeykiTL4HCBpWetWzMU0Onv7JZekta0eN+Kemle1eesYnoUKaQBUeRNxjEdECbsbyB2PwDY/Q==";
        };
        _Rn3clyny = {
            "id" = "Rn3clyny";
            "file" = "skinrestorer-2.11.0+1.21.5-forge.jar";
            "hash" = "sha512-VmGYzorGTgg4kUyFJgE6ty5ak36wc/Y8h9UT/O1Jx/ccqqGEVQG4yFov8R4gzQZ192pdeshjqJK/Mmgmwl1FhA==";
        };
        _ibGok4K5 = {
            "id" = "ibGok4K5";
            "file" = "skinrestorer-2.11.0+1.21.5-fabric.jar";
            "hash" = "sha512-xW2JKwMB45hWkUXCCnMF5eXx+hNR2IbmBMoRYg04aNHUhcqFij+t1RKu8JdVrj+sfS+BOuNHUuOb7U0zf8Irww==";
        };
        _KPFrefhL = {
            "id" = "KPFrefhL";
            "file" = "skinrestorer-2.11.0+1.21.6-neoforge.jar";
            "hash" = "sha512-Q/6njbOcL92YUD+UDl1lXa6pNmxb/UI9klRST10F2jyJkRYsSoar0Vx+w1gTpeUV/eFzxEr8/Nd4iGuUFATinw==";
        };
        _SszKthr1 = {
            "id" = "SszKthr1";
            "file" = "skinrestorer-2.11.0+1.21.6-forge.jar";
            "hash" = "sha512-8JeaAEPkAozyunp6edhFdnK9WHGeOhaGPUuOz0yoKkgvhuO2fRi4TSuC2O53rbZUd/X+yPfTKFcuPDfU4DtlsA==";
        };
        _l9u5GS1J = {
            "id" = "l9u5GS1J";
            "file" = "skinrestorer-2.11.0+1.21.6-fabric.jar";
            "hash" = "sha512-38IWpd6g6bep+kc27zeoQ0G3DeJ5SCPl9XUN47NuIjBwYXlNwLuQWyWaw+nAg2XiU8Wypk13EkJpakkFGNNMUg==";
        };
        _7pPErBDd = {
            "id" = "7pPErBDd";
            "file" = "skinrestorer-2.11.0+1.21.9-forge.jar";
            "hash" = "sha512-EHWaBB6l7I2NYPEGvgS5P2sjFE+h4ihkOig9X2IOlq2JH621NufBgiiA5KveBao9P9GtVdFJWZ8dKajvoFhkxw==";
        };
        _GDggW1Ld = {
            "id" = "GDggW1Ld";
            "file" = "skinrestorer-2.11.0+1.21.9-neoforge.jar";
            "hash" = "sha512-zqGVzZMqltqit/2qk9kS2M/mHaqouJryhOTyyoBuQPmumOiosxTc98e+wqljfkEfXK8aU3R+PCsMyLWdAiwcMQ==";
        };
        _pKCYuj1E = {
            "id" = "pKCYuj1E";
            "file" = "skinrestorer-2.11.0+1.21.9-fabric.jar";
            "hash" = "sha512-JGDVWYHWX2WRb0pKY5pT7i14sE05LBeYPMZuFx/q9EkOGfARyDB2GFP26i358KO/mBSdoy3zhI9TD5ByIggPbg==";
        };
        _5fUfLIhQ = {
            "id" = "5fUfLIhQ";
            "file" = "skinrestorer-2.11.0+1.21.11-forge.jar";
            "hash" = "sha512-74KXlnULdnjwB8DvFIkMbuLUS/b4TQaWTzh124XcAadHZh5hBis3Iy8EHFXDl4vi7D88g4ViMPBJo+apTsRdYw==";
        };
        _tCyWeLuk = {
            "id" = "tCyWeLuk";
            "file" = "skinrestorer-2.11.0+1.21.11-neoforge.jar";
            "hash" = "sha512-PaYo5tEtp0SUw4oo0AVqrJKwML5PzW6wHMa2bmHTv5OhyiNhXI849kZzO9jkDcXaN2anqH4KAZGxczCKfb5AiQ==";
        };
        _S6TdblIH = {
            "id" = "S6TdblIH";
            "file" = "skinrestorer-2.11.0+1.21.11-fabric.jar";
            "hash" = "sha512-P3zDNAXdvBw7U2Sm499D+ZBDpI6F4vPXGf8vyvcvnYfn9pGwokEsbvtlOjpV6RcBKe/J1F+NxmSM0MTOD4rC3Q==";
        };
        _SIPoN63Q = {
            "id" = "SIPoN63Q";
            "file" = "skinrestorer-2.11.0+26.1-neoforge.jar";
            "hash" = "sha512-+V5JVe77G6NV966tfn/rwEaxUpZ5typKVKIARn1x/VmuakJDYfHLATRmNuxB5QH/ilTk3GqyLV0CdhHMAs51og==";
        };
        _rPmMM0mv = {
            "id" = "rPmMM0mv";
            "file" = "skinrestorer-2.11.0+26.1-fabric.jar";
            "hash" = "sha512-mXZVUBEvicyszn6ZmcTGMVeDp3nzqUu7InqVZxRYVSmEqsyi+06lfvSakCslTTBQLzp4l9bp0P1IhJbRoNIY0Q==";
        };
        _ZSx0mxGT = {
            "id" = "ZSx0mxGT";
    ...
    in {
        ...
        "fabric-1.20.2" = _KAkbimaV;
        "fabric-1.20.3" = _rTvrYf51;
        "fabric-1.20.4" = _rTvrYf51;
        "fabric-1.20.5" = _M3QbnmLq;
        "fabric-1.20.6" = _M3QbnmLq;
        "fabric-1.21" = _xE07fxaw;
        "fabric-1.21.1" = _xE07fxaw;
        "fabric-1.21.2" = _xE07fxaw;
        "fabric-1.21.3" = _xE07fxaw;
        "fabric-1.21.4" = _xE07fxaw;
        "fabric-1.21.5" = _ibGok4K5;
        "fabric-1.19" = _58Vt5JSk;
        "fabric-1.19.1" = _JitAkkR2;
        "fabric-1.19.2" = _JitAkkR2;
        "fabric-1.19.3" = _PajNReVl;
        "fabric-1.21.6" = _l9u5GS1J;
        "fabric-1.21.7" = _l9u5GS1J;
        "fabric-1.21.8" = _l9u5GS1J;
        "fabric-1.21.9" = _pKCYuj1E;
        "fabric-1.21.10" = _pKCYuj1E;
        "fabric-1.21.11" = _S6TdblIH;
        "fabric-26.1" = _rPmMM0mv;
        ...
        "neoforge-1.21" = _QFkb2iq2;
        "neoforge-1.20.2" = _Qg4cmjw8;
        "neoforge-1.21.1" = _QFkb2iq2;
        "neoforge-1.21.2" = _QFkb2iq2;
        "neoforge-1.21.3" = _QFkb2iq2;
        "neoforge-1.21.4" = _QFkb2iq2;
        "neoforge-1.21.5" = _mYqTWKPW;
        "neoforge-1.21.6" = _KPFrefhL;
        "neoforge-1.21.7" = _KPFrefhL;
        "neoforge-1.21.8" = _KPFrefhL;
        "neoforge-1.21.9" = _GDggW1Ld;
        "neoforge-1.21.10" = _GDggW1Ld;
        "neoforge-1.21.11" = _tCyWeLuk;
        "neoforge-26.1" = _SIPoN63Q;
        ...
        "quilt-1.20.6" = _M3QbnmLq;
        "quilt-1.21" = _xE07fxaw;
        "quilt-1.20" = _uCDr3lnP;
        "quilt-1.20.1" = _uCDr3lnP;
        "quilt-1.20.2" = _KAkbimaV;
        "quilt-1.21.1" = _xE07fxaw;
        "quilt-1.21.2" = _xE07fxaw;
        "quilt-1.21.3" = _xE07fxaw;
        "quilt-1.21.4" = _xE07fxaw;
        "quilt-1.21.5" = _ibGok4K5;
        "quilt-1.19" = _58Vt5JSk;
        "quilt-1.19.1" = _JitAkkR2;
        "quilt-1.19.2" = _JitAkkR2;
        "quilt-1.19.3" = _PajNReVl;
        "quilt-1.19.4" = _jtDM8We4;
        "quilt-1.21.6" = _l9u5GS1J;
        "quilt-1.21.7" = _l9u5GS1J;
        "quilt-1.21.8" = _l9u5GS1J;
        "quilt-1.21.9" = _pKCYuj1E;
        "quilt-1.21.10" = _pKCYuj1E;
        "quilt-1.21.11" = _S6TdblIH;
        "quilt-26.1" = _rPmMM0mv;
        ...
        "forge-1.20.3" = _pRGFaBhH;
        "forge-1.20.4" = _pRGFaBhH;
        "forge-1.20.5" = _2ANinEFu;
        "forge-1.20.6" = _2ANinEFu;
        "forge-1.21" = _fCzJclBX;
        "forge-1.21.1" = _fCzJclBX;
        "forge-1.21.2" = _fCzJclBX;
        "forge-1.21.3" = _fCzJclBX;
        "forge-1.21.4" = _fCzJclBX;
        "forge-1.21.5" = _Rn3clyny;
        "forge-1.19.1" = _Pjwououg;
        "forge-1.19.2" = _Pjwououg;
        "forge-1.19.3" = _MY53lLws;
        "forge-1.19.4" = _71e6rNg8;
        "forge-1.21.6" = _SszKthr1;
        "forge-1.21.7" = _SszKthr1;
        "forge-1.21.8" = _SszKthr1;
        "forge-1.21.9" = _7pPErBDd;
        "forge-1.21.10" = _7pPErBDd;
        "forge-1.21.11" = _5fUfLIhQ;
        "forge-26.1" = _ZSx0mxGT;
        ...
        "pkg-1.2.4+1.20" = _V0i3N5sb;
        "pkg-1.2.6+1.20.2" = _sqPldbDi;
        "pkg-1.2.6+1.20.3" = _NV6kcTJJ;
        "pkg-1.2.6+1.20.5" = _IVxEN47E;
        "pkg-1.2.6+1.21" = _VNuMcKJq;
        "pkg-2.0.0+1.20.3" = _sWjBpMx4;
        "pkg-2.0.0+1.20.5" = _TuwnWljq;
        "pkg-2.0.0+1.21" = _NYORKdYj;
        "pkg-2.0.1+1.21" = _GmsEygyN;
        "pkg-2.0.1+1.20.5" = _X1h6nujm;
        "pkg-2.0.1+1.20.3" = _3ZY9VORC;
        "pkg-2.0.2+1.20" = _QarsYLRI;
        "pkg-2.0.2+1.20.2" = _j0whAxD4;
        "pkg-2.0.2+1.20.3" = _gpJZROum;
        "pkg-2.0.2+1.20.5" = _QFhE7qZt;
        "pkg-2.0.2+1.21" = _P5uzl7ih;
        "pkg-2.0.3+1.20" = _q9qjzHuO;
        "pkg-2.0.3+1.20.2" = _lKYj9Wi5;
        "pkg-2.0.3+1.20.3" = _AwKntxHm;
        "pkg-2.0.3+1.20.5" = _wpvNwzap;
        "pkg-2.0.3+1.21" = _K2zGSeOY;
        "pkg-2.1.0+1.20-forge" = _82A2pYgA;
        "pkg-2.1.0+1.20-fabric" = _aZRoi2QY;
        "pkg-2.1.0+1.20.2-fabric" = _czkNS6fV;
        "pkg-2.1.0+1.20.2-forge" = _ygrjUfME;
        "pkg-2.1.0+1.20.2-neoforge" = _Qg4cmjw8;
        "pkg-2.1.0+1.20.3-forge" = _JoaTSni9;
        "pkg-2.1.0+1.20.3-fabric" = _LDQuzPXJ;
        "pkg-2.1.0+1.20.3-neoforge" = _mmSsPrmg;
        "pkg-2.1.0+1.20.5-fabric" = _lJkJ9Y2w;
        "pkg-2.1.0+1.20.5-forge" = _sfNklR4F;
        "pkg-2.1.0+1.20.5-neoforge" = _7wplJFFy;
        "pkg-2.1.0+1.21-fabric" = _GSZWlZM2;
        "pkg-2.1.0+1.21-forge" = _VGB72XFd;
        "pkg-2.1.0+1.21-neoforge" = _pJm2AY8h;
        "pkg-2.2.0+1.20-forge" = _BQbgjMjP;
        "pkg-2.2.0+1.20-fabric" = _LcaFMkrT;
        "pkg-2.2.0+1.20.2-fabric" = _LcvRK3iu;
        "pkg-2.2.0+1.20.2-forge" = _aM0pDXiN;
        "pkg-2.2.0+1.20.3-forge" = _W3vgrsin;
        "pkg-2.2.0+1.20.3-fabric" = _ZvijkFp9;
        "pkg-2.2.0+1.20.5-forge" = _dKYL3ZLF;
        "pkg-2.2.0+1.20.5-fabric" = _jPXxC0Ny;
        "pkg-2.2.0+1.20.5-neoforge" = _fZMEMB7x;
        "pkg-2.2.0+1.21-forge" = _AazKfYo8;
        "pkg-2.2.0+1.21-fabric" = _rQOHIEsh;
        "pkg-2.2.0+1.21-neoforge" = _hCPkEIpn;
        "pkg-2.2.1+1.20-fabric" = _NYAVBAQy;
        "pkg-2.2.1+1.20-forge" = _BIhFNSc0;
        "pkg-2.2.1+1.20.2-forge" = _wkxKwaIh;
        "pkg-2.2.1+1.20.2-fabric" = _ypp88Nt8;
        "pkg-2.2.1+1.20.3-fabric" = _KjjKG5vC;
        "pkg-2.2.1+1.20.3-forge" = _2lukiDdA;
        "pkg-2.2.1+1.20.5-forge" = _EHIFIHcY;
        "pkg-2.2.1+1.20.5-fabric" = _eR83q279;
        "pkg-2.2.1+1.20.5-neoforge" = _U5lrKNr4;
        "pkg-2.2.1+1.21-forge" = _HEbuF2uh;
        "pkg-2.2.1+1.21-fabric" = _1ozhCpij;
        "pkg-2.2.1+1.21-neoforge" = _SzksegYP;
        "pkg-2.3.0+1.20-forge" = _pR9N8xrr;
        "pkg-2.3.0+1.20-fabric" = _56xjisiQ;
        "pkg-2.3.0+1.20.2-forge" = _MAEh6QWe;
        "pkg-2.3.0+1.20.2-fabric" = _R5k4dCva;
        "pkg-2.3.0+1.20.3-forge" = _dDOVj19w;
        "pkg-2.3.0+1.20.3-fabric" = _ydrUeal0;
        "pkg-2.3.0+1.20.5-fabric" = _co2QgV79;
        "pkg-2.3.0+1.20.5-forge" = _GKpkSeVL;
        "pkg-2.3.0+1.21-forge" = _1jrxBhXW;
        "pkg-2.3.0+1.21-fabric" = _lLFShhsz;
        "pkg-2.3.0+1.21-neoforge" = _cTWpti4s;
        "pkg-2.3.0+1.21.5-fabric" = _KXaMmwFV;
        "pkg-2.3.0+1.21.5-forge" = _wIAkNbr6;
        "pkg-2.3.0+1.21.5-neoforge" = _zglWcXb0;
        "pkg-2.3.1+1.19-fabric" = _YlUMNf3d;
        "pkg-2.3.1+1.19.1-fabric" = _6t0CEBfe;
        "pkg-2.3.1+1.19.3-fabric" = _zUaeV8HT;
        "pkg-2.3.1+1.19.4-fabric" = _14phcUtr;
        "pkg-2.3.1+1.20-fabric" = _aofsx2KS;
        "pkg-2.3.1+1.20.2-fabric" = _JNnOdS0d;
        "pkg-2.3.1+1.20.3-fabric" = _AdVStl0C;
        "pkg-2.3.1+1.20.5-fabric" = _mOCygsEv;
        "pkg-2.3.1+1.21-forge" = _usST9347;
        "pkg-2.3.1+1.21-neoforge" = _ESyzIXyM;
        "pkg-2.3.1+1.21-fabric" = _Hwt522nY;
        "pkg-2.3.1+1.21.5-neoforge" = _WVkK8cVB;
        "pkg-2.3.1+1.21.5-fabric" = _MwSVYzQz;
        "pkg-2.3.1+1.21.5-forge" = _oAFyhWPs;
        "pkg-2.3.2+1.19-fabric" = _58Vt5JSk;
        "pkg-2.3.2+1.19.1-fabric" = _9f87seOx;
        "pkg-2.3.2+1.19.3-fabric" = _dSy15KnX;
        "pkg-2.3.2+1.19.4-fabric" = _vHl9wsgp;
        "pkg-2.3.2+1.20-fabric" = _kxZPn2ze;
        "pkg-2.3.2+1.20.2-fabric" = _nNQn1I9o;
        "pkg-2.3.2+1.20.3-fabric" = _ufB3WB9u;
        "pkg-2.3.2+1.20.5-fabric" = _KOsfaahW;
        "pkg-2.3.2+1.21-forge" = _3yhst4fF;
        "pkg-2.3.2+1.21-neoforge" = _oP4RHZW2;
        "pkg-2.3.2+1.21-fabric" = _ljkXsuxs;
        "pkg-2.3.2+1.21.5-neoforge" = _8TK1DyUD;
        "pkg-2.3.2+1.21.5-forge" = _6l9GB4fS;
        "pkg-2.3.2+1.21.5-fabric" = _pNnZy9W8;
        "pkg-2.3.3+1.19.1-fabric" = _RmSi69WO;
        "pkg-2.3.3+1.19.1-forge" = _rbz0QfAb;
        "pkg-2.3.3+1.19.3-fabric" = _NDYXdvDE;
        "pkg-2.3.3+1.19.3-forge" = _EdDmHhmU;
        "pkg-2.3.3+1.19.4-fabric" = _Ul9sRJ8C;
        "pkg-2.3.3+1.19.4-forge" = _Bu5ZdJjO;
        "pkg-2.3.3+1.20-forge" = _WkVU7lK5;
        "pkg-2.3.3+1.20-fabric" = _DaC2LuPZ;
        "pkg-2.3.3+1.20.2-forge" = _qIIwJIhh;
        "pkg-2.3.3+1.20.2-fabric" = _AX3RSIIb;
        "pkg-2.3.3+1.20.3-fabric" = _uUMfYmRo;
        "pkg-2.3.3+1.20.3-forge" = _QY9sxPmc;
        "pkg-2.3.3+1.20.5-forge" = _4T1zqdwu;
        "pkg-2.3.3+1.20.5-fabric" = _Itknf9O2;
        "pkg-2.3.3+1.21-forge" = _l5t4iCnm;
        "pkg-2.3.3+1.21-fabric" = _lIqNZ1re;
        "pkg-2.3.3+1.21-neoforge" = _jza0h12a;
        "pkg-2.3.3+1.21.5-forge" = _ESmE4TFm;
        "pkg-2.3.3+1.21.5-neoforge" = _OIZaQmiB;
        "pkg-2.3.3+1.21.5-fabric" = _EYeFQ8l2;
        "pkg-2.3.4+1.19.1-forge" = _HhfW79ch;
        "pkg-2.3.4+1.19.1-fabric" = _cwcBxfFG;
        "pkg-2.3.4+1.19.3-forge" = _qIRO1wYo;
        "pkg-2.3.4+1.19.3-fabric" = _dvhC4Jyv;
        "pkg-2.3.4+1.19.4-forge" = _XpZEBodY;
        "pkg-2.3.4+1.19.4-fabric" = _KIY0Oxv4;
        "pkg-2.3.4+1.20-forge" = _wTYo6S6h;
        "pkg-2.3.4+1.20-fabric" = _PSpG1xGx;
        "pkg-2.3.4+1.20.2-forge" = _zjvroQR8;
        "pkg-2.3.4+1.20.2-fabric" = _afsXq9Ij;
        "pkg-2.3.4+1.20.3-fabric" = _S0fMnWbw;
        "pkg-2.3.4+1.20.3-forge" = _7hdEyCyH;
        "pkg-2.3.4+1.20.5-forge" = _TKBbrUHm;
        "pkg-2.3.4+1.20.5-fabric" = _mQWDIBBP;
        "pkg-2.3.4+1.21-forge" = _H1w8yL5i;
        "pkg-2.3.4+1.21-neoforge" = _UmCbwg6m;
        "pkg-2.3.4+1.21-fabric" = _1mCt5tor;
        "pkg-2.3.4+1.21.5-neoforge" = _yA8iwZ5S;
        "pkg-2.3.4+1.21.5-forge" = _Ht2pgIDv;
        "pkg-2.3.4+1.21.5-fabric" = _JKT8k6vn;
        "pkg-2.3.4+1.21.6-forge" = _7Dh9UqlY;
        "pkg-2.3.4+1.21.6-neoforge" = _iBJLjdkB;
        "pkg-2.3.4+1.21.6-fabric" = _VbBPgHha;
        "pkg-2.3.5+1.19.1-fabric" = _CdK3Ei6x;
        "pkg-2.3.5+1.19.1-forge" = _uo7R2jOv;
        "pkg-2.3.5+1.19.3-fabric" = _DQgfqmlO;
        "pkg-2.3.5+1.19.3-forge" = _C6M4YBAL;
        "pkg-2.3.5+1.19.4-fabric" = _hNumbPPm;
        "pkg-2.3.5+1.19.4-forge" = _QC1UuvzS;
        "pkg-2.3.5+1.20-fabric" = _VunOV4F2;
        "pkg-2.3.5+1.20-forge" = _A6Sv35EO;
        "pkg-2.3.5+1.20.2-forge" = _eAjlmY8v;
        "pkg-2.3.5+1.20.2-fabric" = _9TmIR5UY;
        "pkg-2.3.5+1.20.3-forge" = _qHPfJ1u8;
        "pkg-2.3.5+1.20.3-fabric" = _ETrfyBNV;
        "pkg-2.3.5+1.20.5-fabric" = _OjpZSeej;
        "pkg-2.3.5+1.20.5-forge" = _EBkdch5F;
        "pkg-2.3.5+1.21-forge" = _9P0ZLnjV;
        "pkg-2.3.5+1.21-neoforge" = _zN5Kd10c;
        "pkg-2.3.5+1.21-fabric" = _1pIn15hX;
        "pkg-2.3.5+1.21.5-forge" = _crdWD7I9;
        "pkg-2.3.5+1.21.5-neoforge" = _wjaFpX3Q;
        "pkg-2.3.5+1.21.5-fabric" = _ClTEWZ6l;
        "pkg-2.3.5+1.21.6-forge" = _CJ02a8s3;
        "pkg-2.3.5+1.21.6-neoforge" = _cUXPEg2h;
        "pkg-2.3.5+1.21.6-fabric" = _fs7VElhv;
        "pkg-2.4.0+1.19.1-forge" = _ItlgVAzw;
        "pkg-2.4.0+1.19.1-fabric" = _jkHcoH7e;
        "pkg-2.4.0+1.19.3-forge" = _37f6kpGF;
        "pkg-2.4.0+1.19.3-fabric" = _UhiHCRtp;
        "pkg-2.4.0+1.19.4-forge" = _eqByIECO;
        "pkg-2.4.0+1.19.4-fabric" = _DP1R2hJm;
        "pkg-2.4.0+1.20-forge" = _zQY8yV2v;
        "pkg-2.4.0+1.20-fabric" = _oUnTL3Pc;
        "pkg-2.4.0+1.20.2-fabric" = _SrHabSlR;
        "pkg-2.4.0+1.20.2-forge" = _Tu8KOvkS;
        "pkg-2.4.0+1.20.3-forge" = _kgyfIjK3;
        "pkg-2.4.0+1.20.3-fabric" = _W0uJbxEJ;
        "pkg-2.4.0+1.20.5-fabric" = _3T2dIVtv;
        "pkg-2.4.0+1.20.5-forge" = _jvwH4R0a;
        "pkg-2.4.0+1.21-neoforge" = _Wxmir3m2;
        "pkg-2.4.0+1.21-forge" = _oYz0GhNA;
        "pkg-2.4.0+1.21-fabric" = _oDpP1xOE;
        "pkg-2.4.0+1.21.5-forge" = _k0HBKYuY;
        "pkg-2.4.0+1.21.5-neoforge" = _pHs1AA3t;
        "pkg-2.4.0+1.21.5-fabric" = _Iki6yoUk;
        "pkg-2.4.0+1.21.6-forge" = _Q9xKNYsa;
        "pkg-2.4.0+1.21.6-neoforge" = _m0LfFf2d;
        "pkg-2.4.0+1.21.6-fabric" = _rjEihV6R;
        "pkg-2.4.1+1.19.1-fabric" = _PIXChwBz;
        "pkg-2.4.1+1.19.1-forge" = _gQCKNhTA;
        "pkg-2.4.1+1.19.3-fabric" = _5NhOqOs9;
        "pkg-2.4.1+1.19.3-forge" = _UjURte0n;
        "pkg-2.4.1+1.19.4-fabric" = _VjfiDE2i;
        "pkg-2.4.1+1.19.4-forge" = _r72Ws9kk;
        "pkg-2.4.1+1.20-forge" = _zBTTp6Rf;
        "pkg-2.4.1+1.20-fabric" = _4VfNwLMw;
        "pkg-2.4.1+1.20.2-forge" = _n1bS9unS;
        "pkg-2.4.1+1.20.2-fabric" = _YruBeffH;
        "pkg-2.4.1+1.20.3-forge" = _rDt6l9MM;
        "pkg-2.4.1+1.20.3-fabric" = _Z4aqIVKG;
        "pkg-2.4.1+1.20.5-forge" = _gtbMH1gh;
        "pkg-2.4.1+1.20.5-fabric" = _mygzY9ME;
        "pkg-2.4.1+1.21-forge" = _exbBrt96;
        "pkg-2.4.1+1.21-neoforge" = _IakpBdOl;
        "pkg-2.4.1+1.21-fabric" = _rHvdvuA2;
        "pkg-2.4.1+1.21.5-neoforge" = _llA53pG9;
        "pkg-2.4.1+1.21.5-forge" = _1E9AKRWR;
        "pkg-2.4.1+1.21.5-fabric" = _cNgBdaIo;
        "pkg-2.4.1+1.21.6-neoforge" = _ywbW0v7b;
        "pkg-2.4.1+1.21.6-forge" = _5A5TZPQJ;
        "pkg-2.4.1+1.21.6-fabric" = _72bhcpkr;
        "pkg-2.4.2+1.19.1-fabric" = _eTvlfR1i;
        "pkg-2.4.2+1.19.1-forge" = _IYokzlsV;
        "pkg-2.4.2+1.19.3-forge" = _T8CMQANV;
        "pkg-2.4.2+1.19.3-fabric" = _qyi5uNZk;
        "pkg-2.4.2+1.19.4-forge" = _rkHIx75N;
        "pkg-2.4.2+1.19.4-fabric" = _N1RMh4j0;
        "pkg-2.4.2+1.20-fabric" = _q06yyYO8;
        "pkg-2.4.2+1.20-forge" = _fhVMrhdM;
        "pkg-2.4.2+1.20.2-forge" = _mpD2VABD;
        "pkg-2.4.2+1.20.2-fabric" = _U3hOsAlp;
        "pkg-2.4.2+1.20.3-fabric" = _RrBDMzdl;
        "pkg-2.4.2+1.20.3-forge" = _e7xrGl7v;
        "pkg-2.4.2+1.20.5-forge" = _awo01CBK;
        "pkg-2.4.2+1.20.5-fabric" = _CCCbrBR6;
        "pkg-2.4.2+1.21-forge" = _v8tWfJIR;
        "pkg-2.4.2+1.21-neoforge" = _Of4Vmq48;
        "pkg-2.4.2+1.21-fabric" = _DSo0pGBT;
        "pkg-2.4.2+1.21.5-forge" = _cXeHIWsm;
        "pkg-2.4.2+1.21.5-neoforge" = _GL4mh7m3;
        "pkg-2.4.2+1.21.5-fabric" = _rYSecA4B;
        "pkg-2.4.2+1.21.6-forge" = _3D9DQqVU;
        "pkg-2.4.2+1.21.6-fabric" = _FVSYkUOa;
        "pkg-2.4.2+1.21.6-neoforge" = _FkED4XiQ;
        "pkg-2.4.3+1.19.1-fabric" = _aVMcFN0A;
        "pkg-2.4.3+1.19.1-forge" = _NRP8cF7M;
        "pkg-2.4.3+1.19.3-forge" = _22wtqCkV;
        "pkg-2.4.3+1.19.3-fabric" = _zvp32fqn;
        "pkg-2.4.3+1.19.4-fabric" = _G2FOYg98;
        "pkg-2.4.3+1.19.4-forge" = _b8MJR2MI;
        "pkg-2.4.3+1.20-forge" = _g7Dm2Sg8;
        "pkg-2.4.3+1.20-fabric" = _vOQRWGz7;
        "pkg-2.4.3+1.20.2-forge" = _udwAyLlj;
        "pkg-2.4.3+1.20.2-fabric" = _l4u34wCZ;
        "pkg-2.4.3+1.20.3-fabric" = _zkOxRxWe;
        "pkg-2.4.3+1.20.3-forge" = _Bq8Zh2eZ;
        "pkg-2.4.3+1.20.5-forge" = _aZPFjkz2;
        "pkg-2.4.3+1.20.5-fabric" = _IMm335HV;
        "pkg-2.4.3+1.21-forge" = _MzdaK4r4;
        "pkg-2.4.3+1.21-fabric" = _tAfs8lH0;
        "pkg-2.4.3+1.21-neoforge" = _NNAoiEfu;
        "pkg-2.4.3+1.21.5-fabric" = _ZCNrmLY2;
        "pkg-2.4.3+1.21.5-neoforge" = _wCqqw4bA;
        "pkg-2.4.3+1.21.5-forge" = _kaP7G5R9;
        "pkg-2.4.3+1.21.6-forge" = _iIZ1NZGU;
        "pkg-2.4.3+1.21.6-fabric" = _T88D7KI1;
        "pkg-2.4.3+1.21.6-neoforge" = _PkOW8R9Q;
        "pkg-2.4.3+1.21.9-neoforge" = _3kx8db4W;
        "pkg-2.4.3+1.21.9-forge" = _Z0uGvv1j;
        "pkg-2.4.3+1.21.9-fabric" = _MKWfnXfO;
        "pkg-2.4.3+1.21.11-forge" = _44939MCA;
        "pkg-2.4.3+1.21.11-neoforge" = _SKaedbSG;
        "pkg-2.4.3+1.21.11-fabric" = _8K5Fuf9S;
        "pkg-2.5.0+1.19.1-forge" = _Pzea8rBl;
        "pkg-2.5.0+1.19.1-fabric" = _aLGNl12u;
        "pkg-2.5.0+1.19.3-forge" = _ho6SgL8a;
        "pkg-2.5.0+1.19.3-fabric" = _ut1dDtfS;
        "pkg-2.5.0+1.19.4-fabric" = _NXSW3SSq;
        "pkg-2.5.0+1.19.4-forge" = _hVu9dEkY;
        "pkg-2.5.0+1.20-forge" = _qnvH83GJ;
        "pkg-2.5.0+1.20-fabric" = _b8GoBEZd;
        "pkg-2.5.0+1.20.2-forge" = _jCcVUNve;
        "pkg-2.5.0+1.20.2-fabric" = _YvcA3G8g;
        "pkg-2.5.0+1.20.3-forge" = _LVRFyYny;
        "pkg-2.5.0+1.20.3-fabric" = _WsYQ5KJF;
        "pkg-2.5.0+1.20.5-fabric" = _v11dlFgf;
        "pkg-2.5.0+1.20.5-forge" = _BNmjygEA;
        "pkg-2.5.0+1.21-forge" = _kEbQxcN4;
        "pkg-2.5.0+1.21-neoforge" = _JQKP3oMb;
        "pkg-2.5.0+1.21-fabric" = _d9veLdqw;
        "pkg-2.5.0+1.21.5-neoforge" = _L29BNKHO;
        "pkg-2.5.0+1.21.5-forge" = _MC1RKWpR;
        "pkg-2.5.0+1.21.5-fabric" = _bZEUfxho;
        "pkg-2.5.0+1.21.6-neoforge" = _8iWBniL3;
        "pkg-2.5.0+1.21.6-fabric" = _7Jlm6n2U;
        "pkg-2.5.0+1.21.6-forge" = _ebmnVQSt;
        "pkg-2.5.0+1.21.9-neoforge" = _xSZy5j1s;
        "pkg-2.5.0+1.21.9-forge" = _THHdFrkO;
        "pkg-2.5.0+1.21.9-fabric" = _20oFkohZ;
        "pkg-2.5.0+1.21.11-neoforge" = _Y4FHnK78;
        "pkg-2.5.0+1.21.11-fabric" = _ZIKgsH8x;
        "pkg-2.5.0+1.21.11-forge" = _KL67xYdk;
        "pkg-2.6.0+1.19.1-fabric" = _PXzpIFTT;
        "pkg-2.6.0+1.19.1-forge" = _11FK2xoT;
        "pkg-2.6.0+1.19.3-forge" = _KCLaQgLp;
        "pkg-2.6.0+1.19.3-fabric" = _dYrYiUvj;
        "pkg-2.6.0+1.19.4-fabric" = _ZPU0CFpO;
        "pkg-2.6.0+1.19.4-forge" = _eqNocN6T;
        "pkg-2.6.0+1.20-forge" = _yFa8KBQN;
        "pkg-2.6.0+1.20-fabric" = _FsXZTDtg;
        "pkg-2.6.0+1.20.2-forge" = _XT6l8Jpj;
        "pkg-2.6.0+1.20.2-fabric" = _TqxVZcuS;
        "pkg-2.6.0+1.20.3-forge" = _GIrvlMYt;
        "pkg-2.6.0+1.20.3-fabric" = _nkneTqH3;
        "pkg-2.6.0+1.20.5-forge" = _GjYq1lo8;
        "pkg-2.6.0+1.20.5-fabric" = _gFSJjhHj;
        "pkg-2.6.0+1.21-neoforge" = _Mprv2col;
        "pkg-2.6.0+1.21-forge" = _KA2qS0ne;
        "pkg-2.6.0+1.21-fabric" = _SFT0zLRw;
        "pkg-2.6.0+1.21.5-neoforge" = _lIQRoUfo;
        "pkg-2.6.0+1.21.5-forge" = _jmzPjWWN;
        "pkg-2.6.0+1.21.5-fabric" = _Po1nnXb8;
        "pkg-2.6.0+1.21.6-forge" = _hmnHofCT;
        "pkg-2.6.0+1.21.6-neoforge" = _zn1e8qR9;
        "pkg-2.6.0+1.21.6-fabric" = _MJCuvvt5;
        "pkg-2.6.0+1.21.9-forge" = _4wB2I2ic;
        "pkg-2.6.0+1.21.9-neoforge" = _Ttx6vkgO;
        "pkg-2.6.0+1.21.9-fabric" = _VJnPpog8;
        "pkg-2.6.0+1.21.11-forge" = _rFmz4tda;
        "pkg-2.6.0+1.21.11-neoforge" = _vwRym3oV;
        "pkg-2.6.0+1.21.11-fabric" = _leBCMyEe;
        "pkg-2.7.0+1.19.1-fabric" = _KaKoaLcp;
        "pkg-2.7.0+1.19.1-forge" = _PzDIXZW7;
        "pkg-2.7.0+1.19.3-fabric" = _rXR4jUJP;
        "pkg-2.7.0+1.19.3-forge" = _Uo2SHgrc;
        "pkg-2.7.0+1.19.4-forge" = _Vc5V7tU5;
        "pkg-2.7.0+1.19.4-fabric" = _2Udeah4m;
        "pkg-2.7.0+1.20-forge" = _ODiLeApe;
        "pkg-2.7.0+1.20-fabric" = _TwEwBt5C;
        "pkg-2.7.0+1.20.2-forge" = _ieuc8FJc;
        "pkg-2.7.0+1.20.2-fabric" = _5veTdcaA;
        "pkg-2.7.0+1.20.3-fabric" = _bBZF8p3a;
        "pkg-2.7.0+1.20.3-forge" = _ie6WcgHB;
        "pkg-2.7.0+1.20.5-forge" = _bLWGdyCP;
        "pkg-2.7.0+1.20.5-fabric" = _Pqbbgjyf;
        "pkg-2.7.0+1.21-neoforge" = _dHM5BlZ5;
        "pkg-2.7.0+1.21-forge" = _LUoynBmf;
        "pkg-2.7.0+1.21-fabric" = _rGFYCxRC;
        "pkg-2.7.0+1.21.5-neoforge" = _Y5hhHJZP;
        "pkg-2.7.0+1.21.5-forge" = _pMIga9Pt;
        "pkg-2.7.0+1.21.5-fabric" = _9yqcZsXT;
        "pkg-2.7.0+1.21.6-forge" = _rFCNaj8V;
        "pkg-2.7.0+1.21.6-neoforge" = _43vxRiMB;
        "pkg-2.7.0+1.21.6-fabric" = _umWoU1Eu;
        "pkg-2.7.0+1.21.9-forge" = _OFTXNZ8n;
        "pkg-2.7.0+1.21.9-fabric" = _z4F9CZ8F;
        "pkg-2.7.0+1.21.9-neoforge" = _Bmm8u4tS;
        "pkg-2.7.0+1.21.11-neoforge" = _Ac8vreVJ;
        "pkg-2.7.0+1.21.11-forge" = _LZOWZ8FJ;
        "pkg-2.7.0+1.21.11-fabric" = _64YNvBfd;
        "pkg-2.7.1+26.1-forge" = _ojkP6t86;
        "pkg-2.7.1+26.1-neoforge" = _bgK915DS;
        "pkg-2.7.1+26.1-fabric" = _vxDnBONX;
        "pkg-2.8.0+26.1-neoforge" = _9pYWSbCV;
        "pkg-2.8.0+26.1-forge" = _MYXoT24z;
        "pkg-2.8.0+26.1-fabric" = _9MoU6vsD;
        "pkg-2.8.1+1.19.1-forge" = _aDHFgfVq;
        "pkg-2.8.1+1.19.1-fabric" = _iaTMMsTb;
        "pkg-2.8.1+1.19.3-forge" = _VRnasNlE;
        "pkg-2.8.1+1.19.3-fabric" = _6hlPBfwm;
        "pkg-2.8.1+1.19.4-fabric" = _sFsEACA6;
        "pkg-2.8.1+1.19.4-forge" = _LgsPAinR;
        "pkg-2.8.1+1.20-forge" = _ESZ5lE4k;
        "pkg-2.8.1+1.20-fabric" = _xcHSO44j;
        "pkg-2.8.1+1.20.2-forge" = _HSy7ONGa;
        "pkg-2.8.1+1.20.2-fabric" = _oYrzxy4G;
        "pkg-2.8.1+1.20.3-forge" = _97G6gcB8;
        "pkg-2.8.1+1.20.3-fabric" = _1si7HDRu;
        "pkg-2.8.1+1.20.5-forge" = _vWJAWI2d;
        "pkg-2.8.1+1.20.5-fabric" = _mvUARQ2A;
        "pkg-2.8.1+1.21-forge" = _UuEVCPNa;
        "pkg-2.8.1+1.21-neoforge" = _YoyPqLPS;
        "pkg-2.8.1+1.21-fabric" = _JbBMxXN6;
        "pkg-2.8.1+1.21.5-neoforge" = _ry6dUqmv;
        "pkg-2.8.1+1.21.5-forge" = _fwGJxAkP;
        "pkg-2.8.1+1.21.5-fabric" = _5AAThbWQ;
        "pkg-2.8.1+1.21.6-forge" = _oeUoydqA;
        "pkg-2.8.1+1.21.6-neoforge" = _Af6Rt5Xz;
        "pkg-2.8.1+1.21.6-fabric" = _c9q827U7;
        "pkg-2.8.1+1.21.9-forge" = _xJuAjkPD;
        "pkg-2.8.1+1.21.9-neoforge" = _5Jq1mr6b;
        "pkg-2.8.1+1.21.9-fabric" = _bYJj7USh;
        "pkg-2.8.1+1.21.11-forge" = _CNXMB0Uo;
        "pkg-2.8.1+1.21.11-neoforge" = _ktklwk25;
        "pkg-2.8.1+1.21.11-fabric" = _TxM3UGz6;
        "pkg-2.8.1+26.1-neoforge" = _zWQpbzcy;
        "pkg-2.8.1+26.1-forge" = _Tz3r3OhV;
        "pkg-2.8.1+26.1-fabric" = _rgcYRGDt;
        "pkg-2.9.0+1.19.1-fabric" = _Ln8GJigV;
        "pkg-2.9.0+1.19.1-forge" = _vOFfENEu;
        "pkg-2.9.0+1.19.3-fabric" = _XvpetyLw;
        "pkg-2.9.0+1.19.3-forge" = _G5gycMyR;
        "pkg-2.9.0+1.19.4-fabric" = _LR36RX01;
        "pkg-2.9.0+1.19.4-forge" = _6ofcZH0X;
        "pkg-2.9.0+1.20-forge" = _hetcrcyD;
        "pkg-2.9.0+1.20-fabric" = _7A4aUEiK;
        "pkg-2.9.0+1.20.2-forge" = _7hjtM9dc;
        "pkg-2.9.0+1.20.2-fabric" = _RXPtM1gV;
        "pkg-2.9.0+1.20.3-forge" = _6i8tJig2;
        "pkg-2.9.0+1.20.3-fabric" = _L060oMnp;
        "pkg-2.9.0+1.20.5-forge" = _Eg2c7TsT;
        "pkg-2.9.0+1.20.5-fabric" = _tvevFhnX;
        "pkg-2.9.0+1.21-neoforge" = _RyUYnIVM;
        "pkg-2.9.0+1.21-forge" = _KEbVJUCj;
        "pkg-2.9.0+1.21-fabric" = _C4bJQJh4;
        "pkg-2.9.0+1.21.5-forge" = _BzQh0W1o;
        "pkg-2.9.0+1.21.5-neoforge" = _DOw59wKm;
        "pkg-2.9.0+1.21.5-fabric" = _EOPctgDP;
        "pkg-2.9.0+1.21.6-neoforge" = _hwMgTOcu;
        "pkg-2.9.0+1.21.6-forge" = _jBjXvRnt;
        "pkg-2.9.0+1.21.6-fabric" = _M9xsFuxL;
        "pkg-2.9.0+1.21.9-neoforge" = _lHNZNc5S;
        "pkg-2.9.0+1.21.9-forge" = _E7pZIros;
        "pkg-2.9.0+1.21.9-fabric" = _fIiRvNwB;
        "pkg-2.9.0+1.21.11-forge" = _hRRhvl34;
        "pkg-2.9.0+1.21.11-neoforge" = _lyqnYCYp;
        "pkg-2.9.0+1.21.11-fabric" = _FyV19hQI;
        "pkg-2.9.0+26.1-neoforge" = _JZbudgXH;
        "pkg-2.9.0+26.1-forge" = _mqX8uXko;
        "pkg-2.9.0+26.1-fabric" = _lICMyGKE;
        "pkg-2.10.0+1.19.1-forge" = _d77KPVMD;
        "pkg-2.10.0+1.19.1-fabric" = _iZzlw0kY;
        "pkg-2.10.0+1.19.3-forge" = _Upb6VaTw;
        "pkg-2.10.0+1.19.3-fabric" = _hWtp8gJT;
        "pkg-2.10.0+1.19.4-forge" = _ZWACwaX7;
        "pkg-2.10.0+1.19.4-fabric" = _zBTpcIz1;
        "pkg-2.10.0+1.20-fabric" = _NJGwLsY2;
        "pkg-2.10.0+1.20-forge" = _YWasQFNI;
        "pkg-2.10.0+1.20.2-forge" = _7UJv7bP2;
        "pkg-2.10.0+1.20.2-fabric" = _nkOP768w;
        "pkg-2.10.0+1.20.3-forge" = _mlVUuSmS;
        "pkg-2.10.0+1.20.3-fabric" = _DtNciLLx;
        "pkg-2.10.0+1.20.5-forge" = _B4b4JYU2;
        "pkg-2.10.0+1.20.5-fabric" = _zZKsjQaD;
        "pkg-2.10.0+1.21-forge" = _LjDTNqfc;
        "pkg-2.10.0+1.21-neoforge" = _P7Vre2lP;
        "pkg-2.10.0+1.21-fabric" = _BmUANmui;
        "pkg-2.10.0+1.21.5-neoforge" = _Akh4GdO0;
        "pkg-2.10.0+1.21.5-fabric" = _YxtI3COr;
        "pkg-2.10.0+1.21.5-forge" = _XYzM6IwZ;
        "pkg-2.10.0+1.21.6-forge" = _R4XI50KD;
        "pkg-2.10.0+1.21.6-neoforge" = _fFw6ezwz;
        "pkg-2.10.0+1.21.6-fabric" = _uQjeH2Nf;
        "pkg-2.10.0+1.21.9-neoforge" = _OTe0gU7q;
        "pkg-2.10.0+1.21.9-forge" = _pXGLD1rL;
        "pkg-2.10.0+1.21.9-fabric" = _kjr0FRdG;
        "pkg-2.10.0+1.21.11-forge" = _qf24HTXu;
        "pkg-2.10.0+1.21.11-neoforge" = _dgdq5hXA;
        "pkg-2.10.0+1.21.11-fabric" = _kLxwqV0H;
        "pkg-2.10.0+26.1-forge" = _8AclrzcC;
        "pkg-2.10.0+26.1-fabric" = _aXzPUPsr;
        "pkg-2.10.0+26.1-neoforge" = _VG6Rbbwy;
        "pkg-2.11.0+1.19.1-fabric" = _JitAkkR2;
        "pkg-2.11.0+1.19.1-forge" = _Pjwououg;
        "pkg-2.11.0+1.19.3-forge" = _MY53lLws;
        "pkg-2.11.0+1.19.3-fabric" = _PajNReVl;
        "pkg-2.11.0+1.19.4-fabric" = _jtDM8We4;
        "pkg-2.11.0+1.19.4-forge" = _71e6rNg8;
        "pkg-2.11.0+1.20-forge" = _WwS30jjd;
        "pkg-2.11.0+1.20-fabric" = _uCDr3lnP;
        "pkg-2.11.0+1.20.2-forge" = _hVMzMRoD;
        "pkg-2.11.0+1.20.2-fabric" = _KAkbimaV;
        "pkg-2.11.0+1.20.3-forge" = _pRGFaBhH;
        "pkg-2.11.0+1.20.3-fabric" = _rTvrYf51;
        "pkg-2.11.0+1.20.5-forge" = _2ANinEFu;
        "pkg-2.11.0+1.20.5-fabric" = _M3QbnmLq;
        "pkg-2.11.0+1.21-neoforge" = _QFkb2iq2;
        "pkg-2.11.0+1.21-forge" = _fCzJclBX;
        "pkg-2.11.0+1.21-fabric" = _xE07fxaw;
        "pkg-2.11.0+1.21.5-neoforge" = _mYqTWKPW;
        "pkg-2.11.0+1.21.5-forge" = _Rn3clyny;
        "pkg-2.11.0+1.21.5-fabric" = _ibGok4K5;
        "pkg-2.11.0+1.21.6-neoforge" = _KPFrefhL;
        "pkg-2.11.0+1.21.6-forge" = _SszKthr1;
        "pkg-2.11.0+1.21.6-fabric" = _l9u5GS1J;
        "pkg-2.11.0+1.21.9-forge" = _7pPErBDd;
        "pkg-2.11.0+1.21.9-neoforge" = _GDggW1Ld;
        "pkg-2.11.0+1.21.9-fabric" = _pKCYuj1E;
        "pkg-2.11.0+1.21.11-forge" = _5fUfLIhQ;
        "pkg-2.11.0+1.21.11-neoforge" = _tCyWeLuk;
        "pkg-2.11.0+1.21.11-fabric" = _S6TdblIH;
