...
let
    versions = (let
        ...
        _36lg8YOX = {
            "id" = "36lg8YOX";
            "file" = "berserker_rpg-neoforge-3.0.0+1.21.1.jar";
            "hash" = "sha512-uXIL642DJ/4YsXuWCetj8X7xN5+yyfFCNVeUK8QBfMt/WJQDgdG7mVlbpb761P+3xUQOY/ZkgVzSojyRpVbS+A==";
        };
        _tCMcqqbG = {
            "id" = "tCMcqqbG";
            "file" = "berserker_rpg-fabric-3.0.0+1.21.1.jar";
            "hash" = "sha512-tHqDO1GmCj+mC8YFPLTkWYBBIw7vqbxwnJtQsEZfDnjF/TImjUGVjpJTLNw1+bpeddV/rLuT8r4HmCpmhGge0g==";
        };
        _zxNEll6s = {
            "id" = "zxNEll6s";
            "file" = "berserker-class-mod-1.2.6-1.20.1.jar";
            "hash" = "sha512-dKzdrgYf54L5xF1AXX29RCokuoOmOMojJ9OQePPltol91QVXpKYc0fYVnnrTu4fpyHW3PcGud22ViUTWdYbr0w==";
        };
        _nlxB0a7h = {
            "id" = "nlxB0a7h";
            "file" = "berserker_rpg-neoforge-3.1.0+1.21.1.jar";
            "hash" = "sha512-UgzC2oSNIgIG3V4TPIlhtM8qxRCT4g9f3fq2T98Z9AgsyNgX6u5DOmhYgzIZYB10oRamrLLwNmYoPjDcDMMw5Q==";
        };
        _pjAHmQF7 = {
            "id" = "pjAHmQF7";
    ...
    in {
        ...
        "pkg-1.0.8" = _70nG9P6b;
        "pkg-1.1.0" = _oUCqGa4g;
        "pkg-2.0.0-1.21" = _eSg53kdd;
        "pkg-2.0.1-1.21" = _4tH633uY;
        "pkg-2.0.2-1.21" = _4YhG4hZ0;
        "pkg-2.0.3-1.21" = _qpS1pNBK;
        "pkg-2.1.0-1.21" = _Jy2KE0dw;
        "pkg-2.2.0-1.21" = _W5YjAkcP;
        "pkg-2.2.1-1.21" = _lSCmoi6D;
        "pkg-2.2.2-1.21" = _Bpo8QVLi;
        "pkg-2.3.0-1.21" = _AXvxdPQ1;
        "pkg-1.2.0" = _siks43bY;
        "pkg-1.2.1-1.20.1" = _Cs1wLvNo;
        "pkg-1.2.2-1.20.1" = _KlZwN3C4;
        "pkg-2.4.0-1.21" = _xW1iG0na;
        "pkg-2.4.1-1.21" = _DajXDscJ;
        "pkg-1.2.3-1.20.1" = _Bqegppli;
        "pkg-2.4.2-1.21" = _EU40AUma;
        "pkg-2.4.3-1.21" = _ibClwptf;
        "pkg-2.4.4-1.21" = _HDaNysXk;
        "pkg-2.4.5-1.21" = _naBFMrII;
        "pkg-2.4.6-1.21" = _drdoA8DR;
        "pkg-2.4.7-1.21" = _ZWtoVdHG;
        "pkg-1.2.4-1.20.1" = _3f1DbyXS;
        "pkg-2.4.8-1.21" = _mTIiB2aI;
        "pkg-2.4.9-1.21" = _20Hp6RK4;
        "pkg-1.2.5-1.20.1" = _eEF3gPGB;
        "pkg-2.5.0+1.21.1-fabric" = _n1e9yyDv;
        "pkg-2.5.0+1.21.1-neoforge" = _HZJwMhxB;
        "pkg-2.5.1+1.21.1-fabric" = _xhUxED0N;
        "pkg-2.5.1+1.21.1-neoforge" = _WbVjrorv;
        "pkg-2.5.2+1.21.1-neoforge" = _QKkAduMo;
        "pkg-2.5.2+1.21.1-fabric" = _OD4oktgI;
        "pkg-2.5.3+1.21.1-neoforge" = _baIS65TP;
        "pkg-2.5.3+1.21.1-fabric" = _KUh5rcud;
        "pkg-2.5.4+1.21.1-fabric" = _Z2Btar6B;
        "pkg-2.5.4+1.21.1-neoforge" = _uXYQQsU8;
        "pkg-2.5.5+1.21.1-neoforge" = _iNMOHYop;
        "pkg-2.5.5+1.21.1-fabric" = _nRLrnafn;
        "pkg-2.6.0+1.21.1-fabric" = _9kArgSXQ;
        "pkg-2.6.0+1.21.1-neoforge" = _vjKwYR4P;
        "pkg-3.0.0+1.21.1-neoforge" = _36lg8YOX;
        "pkg-3.0.0+1.21.1-fabric" = _tCMcqqbG;
