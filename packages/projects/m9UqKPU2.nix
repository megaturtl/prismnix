...
let
    ...
    in {
        ...
        "pkg-1.4.0" = _Bh6j1rjd;
        "pkg-1.4.1" = _cvRqFUlf;
        "pkg-1.4.1_hotfix_1" = _z4UJYfzg;
        "pkg-1.5.0" = _NFLqMqFs;
        "pkg-1.5.1" = _HLFzGv0R;
        "pkg-1.5.1_hotfix_1" = _8lSUImtk;
        "pkg-1.5.2" = _1WV7jwbh;
        "pkg-1.5.3" = _JulC2yq3;
        "pkg-1.5.3+mod" = _QguPuNoR;
        "pkg-1.5.3_port_25U3_beta_1" = _4FAAPUHU;
        "pkg-1.5.4_beta_2" = _x331Nwn0;
        "pkg-1.5.4_beta_3" = _Vxx3uxEm;
        "pkg-1.5.4" = _y9jCDphC;
        "pkg-1.5.4_port_25U3_beta_1" = _dabn00SN;
        "pkg-1.5.4+mod" = _609gH36o;
        "pkg-1.5.4_hotfix_1" = _rODOK1y5;
        "pkg-1.5.4_port_25U3_beta_2" = _D5cl9Oop;
        "pkg-1.5.4_port_25U3_beta_3" = _3wnVBl9w;
        "pkg-1.6.0_beta_1" = _gNSc6Wjo;
        "pkg-1.6.0_beta_2" = _sgiDsclX;
        "pkg-1.5.4_port_25U3_beta_4" = _6s2vlu25;
        "pkg-1.5.4_port_25U3_beta_5" = _iKg6k3bu;
        "pkg-1.5.5" = _TF0cwibI;
        "pkg-1.6.0_beta_3" = _1Hm0h3Mk;
        "pkg-1.5.5+mod" = _BQRRCCu7;
        "pkg-1.6.0_beta_4" = _8FJxGr7B;
        "pkg-1.6.0" = _cS6WhhPW;
        "pkg-1.6.0+mod" = _FDjYgn4j;
        "pkg-1.6.1" = _ZCoSBbCH;
        "pkg-1.6.2" = _5daJ1tFn;
