...
let
    versions = (let
        ...
        _DYbZnDEd = {
            "id" = "DYbZnDEd";
            "file" = "[1.7.2-1.8.9]CotCot.zip";
            "hash" = "sha512-PSyimomDffkfR1j7xvAfAlvg1SC/4THtxXTTOA0DxWbZUdJJAwgwa+OuLdQWbVb17DWoFF+3nfT3pgYV7OjhHw==";
        };
        _NALCYlFW = {
            "id" = "NALCYlFW";
            "file" = "[26.3]CotCot.zip";
            "hash" = "sha512-gIi6eSyqApxxOSH0yeiqRzMgwpTF0VIO9ApBS4CIZpCRiQAbmH0Pe6aUiIT4eEN7mdk2JJy0wvild+DJSMybJw==";
        };
    in {
        "EFt6R8Vt" = _EFt6R8Vt;
        "e9mPtSJZ" = _e9mPtSJZ;
        ...
        "DYbZnDEd" = _DYbZnDEd;
        "NALCYlFW" = _NALCYlFW;
        "minecraft-1.7.2" = _DYbZnDEd;
        "minecraft-1.7.3" = _DYbZnDEd;
        "minecraft-1.7.4" = _DYbZnDEd;
        "minecraft-1.7.5" = _DYbZnDEd;
        "minecraft-1.7.6" = _DYbZnDEd;
        "minecraft-1.7.7" = _DYbZnDEd;
        "minecraft-1.7.8" = _DYbZnDEd;
        "minecraft-1.7.9" = _DYbZnDEd;
        "minecraft-1.7.10" = _DYbZnDEd;
        "minecraft-1.8" = _DYbZnDEd;
        "minecraft-1.8.1" = _DYbZnDEd;
        "minecraft-1.8.2" = _DYbZnDEd;
        "minecraft-1.8.3" = _DYbZnDEd;
        "minecraft-1.8.4" = _DYbZnDEd;
        "minecraft-1.8.5" = _DYbZnDEd;
        "minecraft-1.8.6" = _DYbZnDEd;
        "minecraft-1.8.7" = _DYbZnDEd;
        "minecraft-1.8.8" = _DYbZnDEd;
        "minecraft-1.8.9" = _DYbZnDEd;
        ...
        "minecraft-26.1" = _NALCYlFW;
        "minecraft-26.1.1" = _NALCYlFW;
        "minecraft-26.1.2" = _NALCYlFW;
        "minecraft-26.2" = _NALCYlFW;
        "minecraft-26.3" = _NALCYlFW;
        "pkg-2023.4.2" = _o8deQpfx;
        "pkg-2023.8.1" = _z02QvTbV;
        "pkg-2023.9.1" = _HkftZZwB;
        "pkg-2024.1.1" = _nZ369t2e;
        "pkg-2024.7.1" = _B9ss4jfw;
        "pkg-2024.11.1" = _lINl2mWW;
        "pkg-2025.2.1" = _UIgpA82T;
        "pkg-2025.4.1" = _DcQKOfL7;
        "pkg-2025.7.1" = _W133d7hi;
        "pkg-2025.10.1" = _iSdQg3xR;
        "pkg-2026.1.1" = _Ya3edDBm;
        "pkg-2026.4.1" = _mCw3LjJd;
        "pkg-2026.6.1" = _5myRlU4g;
        "pkg-2026.9.1" = _NALCYlFW;
        "default" = _NALCYlFW;
    });
