...
let
    versions = (let
        ...
        _YddFPVsh = {
            "id" = "YddFPVsh";
            "file" = "Volcanic Dark 26.3 - 1.19.3 - 1.1.4.zip";
            "hash" = "sha512-fJQBW6wNnhZ+HymPimgLupwAb2a045U3OZ8MJn2iHyvBvy0GD24MC6nAuNpEILRFWXLzcHW+PLsf58puhadWBQ==";
        };
    in {
        "zP3I6M6g" = _zP3I6M6g;
        "7Hr1S9Vs" = _7Hr1S9Vs;
        ...
        "fPC8ll8y" = _fPC8ll8y;
        "YddFPVsh" = _YddFPVsh;
        "minecraft-1.19.3" = _YddFPVsh;
        "minecraft-1.19.4" = _YddFPVsh;
        "minecraft-1.20" = _YddFPVsh;
        "minecraft-1.20.1" = _YddFPVsh;
        "minecraft-1.20.2" = _YddFPVsh;
        "minecraft-1.20.3" = _YddFPVsh;
        "minecraft-1.20.4" = _YddFPVsh;
        "minecraft-1.20.5" = _YddFPVsh;
        "minecraft-1.20.6" = _YddFPVsh;
        "minecraft-1.21" = _YddFPVsh;
        "minecraft-1.21.1" = _YddFPVsh;
        "minecraft-1.21.2" = _YddFPVsh;
        "minecraft-1.21.3" = _YddFPVsh;
        "minecraft-1.21.4" = _YddFPVsh;
        "minecraft-1.21.5" = _YddFPVsh;
        "minecraft-1.21.6" = _YddFPVsh;
        "minecraft-1.21.7" = _YddFPVsh;
        "minecraft-1.21.8" = _YddFPVsh;
        "minecraft-1.21.9" = _YddFPVsh;
        "minecraft-1.21.10" = _YddFPVsh;
        "minecraft-1.21.11" = _YddFPVsh;
        "minecraft-26.1" = _YddFPVsh;
        "minecraft-26.1.1" = _YddFPVsh;
        "minecraft-26.1.2" = _YddFPVsh;
        "minecraft-26.2" = _YddFPVsh;
        "minecraft-26.3" = _YddFPVsh;
        "pkg-1.0.0" = _zP3I6M6g;
        "pkg-1.0.1" = _7Hr1S9Vs;
        "pkg-1.1.0" = _ibcDePIm;
        "pkg-1.1.1" = _ZiAXoThC;
