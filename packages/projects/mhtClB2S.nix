...
let
    ...
    in {
        ...
        "pkg-1.18.2-0.5.1" = _t8ua2Lfz;
        "pkg-1.18.2-0.5.2" = _akzh6NfC;
        "pkg-1.18.2-0.5.3" = _QvwCNJwH;
        "pkg-1.18.2-0.5.4" = _k0oucefD;
        "pkg-1.18.2-0.5.5" = _D3wOSKNu;
        "pkg-1.18.2-0.6.0" = _R0CZq64Z;
        "pkg-1.18.2-0.6.1" = _RFazsRcL;
        "pkg-1.18.2-0.6.2" = _9SN1yRyw;
        "pkg-1.20.1-1.0.1" = _t274hT5r;
        "pkg-1.20.1-1.0.2" = _8lqAQO0z;
        "pkg-1.20.1-1.0.3" = _caFMAdRt;
        "pkg-1.20.1-1.1.0" = _DpMZjoPI;
        "pkg-1.20.1-1.1.1" = _wSU98pL4;
        "pkg-1.20.1-1.1.2" = _ZeRVrfJF;
        "pkg-1.20.1-1.1.3" = _MjZPkQtU;
        "pkg-1.2.0" = _doATei6Q;
        "pkg-1.2.1" = _NujH3UgQ;
        "pkg-1.2.2" = _XORCNC5W;
        "pkg-1.2.3" = _xa4rX739;
