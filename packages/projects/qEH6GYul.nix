...
let
    versions = (let
        ...
        _fFfT0vXZ = {
            "id" = "fFfT0vXZ";
            "file" = "LibX-26.1.2-7.0.0.jar";
            "hash" = "sha512-BmMjPVXUafJLlmVMXSNPllMnw5JoFqru8JxM+cTteu3gkOULqVyT2ONEyi6E8FF1/f7MBQj0ZdEKqB/lBuNTHA==";
        };
        _hqDl08eX = {
            "id" = "hqDl08eX";
            "file" = "LibX-1.21.1-6.0.14.jar";
            "hash" = "sha512-ij4I6zRVWDrZyQHDIj/8SYgbgSy0ajegt5ILD/DpSd+fiboAqjMcVPSDWbl4aJzaNyONLjX+OFamdQazP784Aw==";
        };
        _2A3vhTeV = {
            "id" = "2A3vhTeV";
            "file" = "LibX-26.1.2-7.0.1.jar";
            "hash" = "sha512-kkrSq4nhwYcl078b1Z3m9eBz/u7Ki6Bv75IiKdHSDZJrUcs5F+xu2Mxb9tZspjARjaXUQSgNH5orAEoYJjOJ+Q==";
        };
        _8lfXNnGN = {
            "id" = "8lfXNnGN";
            "file" = "LibX-26.1.2-7.0.2.jar";
            "hash" = "sha512-3yZ2YSnJ5qNyMzA+Ji5j0viZJgPvzTgYUcRZbMtW1W8ncqT9AMRLGRt0SAwwOYzydPyZ6n3iDAIhVNcr9OO4ag==";
        };
        _ka6JCz7M = {
            "id" = "ka6JCz7M";
            "file" = "LibX-26.1.2-7.0.3.jar";
            "hash" = "sha512-WFiWghgnlzfDysKh5BKU7BcPOEfbptf0NEMSFdpfY6L4C4fbjrF7M9oYnTw2zMVO5JH+CI8GJMHkndIFfC885Q==";
        };
        _ADxNEmse = {
            "id" = "ADxNEmse";
            "file" = "LibX-1.21.1-6.0.15.jar";
            "hash" = "sha512-lE3Xg0z7iLFd6VJ8MC3HIG1+ix5EnZfMYF+25yJWGcaNBepbqTTx0dob9f8qfnm7mQhw6IYpPcM23u6lN+Bzgg==";
        };
        _f5GBMQmv = {
            "id" = "f5GBMQmv";
            "file" = "LibX-26.1.2-7.0.4.jar";
            "hash" = "sha512-JP0amgxfbYvEeEY/TrcT7h7Da+akkuGpUxNhsfDBjQPw/Vm3nXBMsO7/gqSSAOIAt0pijvZECrkKJbbspk0kUQ==";
        };
    in {
        "WQD4lKso" = _WQD4lKso;
        "brUo93wx" = _brUo93wx;
        ...
        "neoforge-1.21.1" = _ADxNEmse;
        "neoforge-26.1.2" = _f5GBMQmv;
        "pkg-1.17.1-2.0.7" = _WQD4lKso;
        "pkg-1.17.1-2.0.8" = _brUo93wx;
        "pkg-1.17.1-2.0.9" = _lfWbLwvn;
        "pkg-1.17.1-2.0.10" = _yJOUextj;
        "pkg-1.17.1-2.0.11" = _aCo8jFyr;
        "pkg-1.17.1-2.0.12" = _uVszKsig;
        "pkg-1.17.1-2.0.13" = _KT2YX5Th;
        "pkg-1.17.1-2.0.14" = _CAl4slWy;
        "pkg-1.17.1-2.0.15" = _17v30O9T;
        "pkg-1.17.1-2.0.16" = _nHw4R05S;
        "pkg-1.17.1-2.0.17" = _6UbVFenV;
        "pkg-1.17.1-2.0.18" = _3L3lSQgy;
        "pkg-1.17.1-2.0.19" = _9gpPXyZ4;
        "pkg-1.17.1-2.0.20" = _ifhwC81f;
        "pkg-1.17.1-2.0.21" = _WnzOv56s;
        "pkg-1.17.1-2.0.22" = _zdE3YCdl;
        "pkg-1.17.1-2.1.0" = _S1nLKlsa;
        "pkg-1.17.1-2.1.1" = _qNttk4vG;
        "pkg-1.17.1-2.1.2" = _BE9icZyw;
        "pkg-1.17.1-2.1.3" = _v5NuJupU;
        "pkg-1.17.1-2.1.4" = _HJd0BzcI;
        "pkg-1.17.1-2.1.5" = _YZ5Q5Y1N;
        "pkg-1.17.1-2.1.6" = _JgxBhYY1;
        "pkg-1.17.1-2.1.7" = _dVbFbQYP;
        "pkg-1.17.1-2.1.8" = _3AJKHQ1S;
        "pkg-1.17.1-2.1.9" = _LSMDEiWU;
        "pkg-1.17.1-2.1.10" = _X0HtAw4F;
        "pkg-1.17.1-2.1.11" = _tifMg3Ep;
        "pkg-1.17.1-2.1.12" = _DQCDg33j;
        "pkg-1.17.1-2.1.13" = _za3sm7nD;
        "pkg-1.17.1-2.1.14" = _KlBVM2eh;
        "pkg-1.17.1-2.1.15" = _KSbCIiNh;
        "pkg-1.17.1-2.1.16" = _5rBvGloO;
        "pkg-1.17.1-2.1.17" = _6maOmTNY;
        "pkg-1.17.1-2.1.18" = _yLGoIwcO;
        "pkg-1.17.1-2.1.19" = _AOxtsFzF;
        "pkg-1.17.1-2.1.20" = _81a0CZVB;
        "pkg-1.17.1-2.1.21" = _wYFyaHfZ;
        "pkg-1.17.1-2.1.22" = _ZlCgOlxt;
        "pkg-1.18-3.0.0" = _TgOJazoO;
        "pkg-1.18-3.0.1" = _f5PzGwxM;
        "pkg-1.18.1-3.1.0" = _K9xpIVfy;
        "pkg-1.18.1-3.1.1" = _LaeQxIyt;
        "pkg-1.18.1-3.1.2" = _1v64IMMe;
        "pkg-1.17.1-2.1.24" = _YAajEk65;
        "pkg-1.18.1-3.1.3" = _uGsGeJOo;
        "pkg-1.18.1-3.1.4" = _x0ajgX6U;
        "pkg-1.18.1-3.1.5" = _Q04V63Dy;
        "pkg-1.17.1-2.1.25" = _GLQWT0n3;
        "pkg-1.18.1-3.1.6" = _Fsnd0NSU;
        "pkg-1.18.1-3.1.7" = _ecK9FBQ4;
        "pkg-1.18.1-3.1.8" = _wMTC03AR;
        "pkg-1.18.1-3.1.9" = _VEkPBmSb;
        "pkg-1.18.1-3.1.10" = _jqOFyp22;
        "pkg-1.18.1-3.1.11" = _5EFAjj92;
        "pkg-1.18.1-3.1.12" = _ixNZ3Z9H;
        "pkg-1.18.1-3.1.13" = _c2m5fSV0;
        "pkg-1.18.1-3.1.15" = _JHEkzmOL;
        "pkg-1.18.1-3.1.16" = _zKr0x0Dk;
        "pkg-1.18.1-3.1.17" = _zsuQYE0n;
        "pkg-1.18.1-3.1.18" = _b97p9Y96;
        "pkg-1.18.2-3.2.0" = _QBkTreZM;
        "pkg-1.18.2-3.2.1" = _JBLWzt7l;
        "pkg-1.18.2-3.2.2" = _H8OuNoaI;
        "pkg-1.18.2-3.2.3" = _3TQHPWgF;
        "pkg-1.18.2-3.2.4" = _y7nBbrZX;
        "pkg-1.18.2-3.2.5" = _Wcxn1rfk;
        "pkg-1.18.2-3.2.6" = _5SvwRNJY;
        "pkg-1.18.2-3.2.7" = _GsLbF8qi;
        "pkg-1.18.2-3.2.8" = _XOi5MOsS;
        "pkg-1.18.2-3.2.9" = _EBKkZPvr;
        "pkg-1.18.2-3.2.10" = _WKrOSJpq;
        "pkg-1.18.2-3.2.11" = _FIVGeuym;
        "pkg-1.18.2-3.2.12" = _x872xoLo;
        "pkg-1.18.2-3.2.13" = _IvoO8SxE;
        "pkg-1.18.2-3.2.14" = _nKHougqZ;
        "pkg-1.18.2-3.2.15" = _GsPhvRq6;
        "pkg-1.18.2-3.2.16" = _5N9kQqTE;
        "pkg-1.18.2-3.2.17" = _BPSkYaAw;
        "pkg-1.16.3-1.0.76" = _PLU6tx9n;
        "pkg-1.18.2-3.2.18" = _74agt1cB;
        "pkg-1.19-4.0.0" = _1zDW5nzR;
        "pkg-1.19-4.0.1" = _GYGqbWtT;
        "pkg-1.19-4.0.2" = _VO7eERk5;
        "pkg-1.19-4.0.3" = _g9XNb67f;
        "pkg-1.19-4.0.4" = _pCF9EXUG;
        "pkg-1.19-4.0.5" = _mOgG6kpK;
        "pkg-1.19-4.0.6" = _1Vwg7P1k;
        "pkg-1.19-4.0.7" = _Ytdna6my;
        "pkg-1.19.1-4.1.0" = _sC6mZgFZ;
        "pkg-1.19.1-4.1.1" = _sJypg6K1;
        "pkg-1.19.1-4.1.2" = _bFAF4kt7;
        "pkg-1.19.1-4.1.3" = _T1cxuhxF;
        "pkg-1.18.2-3.2.19" = _Rw7rEJk3;
        "pkg-1.19.2-4.2.0" = _aTRqD5Sj;
        "pkg-1.19.2-4.2.1" = _cpZIoMzw;
        "pkg-1.19.2-4.2.2" = _ZQRvGECM;
        "pkg-1.19.2-4.2.3" = _AZVWqUZG;
        "pkg-1.19.2-4.2.4" = _GB6n74FU;
        "pkg-1.19.2-4.2.5" = _z63k4Ux0;
        "pkg-1.19.2-4.2.6" = _fo0fwikJ;
        "pkg-1.19.2-4.2.7" = _GK3CURAj;
        "pkg-1.19.2-4.2.8" = _MI1qef6z;
        "pkg-1.19.3-4.3.0" = _Qwehw7xz;
        "pkg-1.19.3-4.3.1" = _QiUgi7oH;
        "pkg-1.19.3-4.3.2" = _DVZsG6H2;
        "pkg-1.19.4-4.4.0" = _YC0tRmP9;
        "pkg-1.19.4-4.4.1" = _TsWPD1Gs;
        "pkg-1.19.4-4.4.2" = _snMMVyML;
        "pkg-1.19.4-4.4.3" = _lvdQl0nj;
        "pkg-1.19.4-4.4.4" = _VOTZYrpD;
        "pkg-1.19.4-4.4.5" = _KhpzM95H;
        "pkg-1.19.4-4.4.6" = _RWuaz3f7;
        "pkg-1.19.4-4.4.7" = _Qr5Zd06t;
        "pkg-1.19.4-4.4.8" = _qL9QK6TE;
        "pkg-1.19.4-4.4.9" = _Yagz90LP;
        "pkg-1.19.4-4.4.10" = _ULA2W0v2;
        "pkg-1.19.4-4.4.11" = _Pm4syPSy;
        "pkg-1.20.1-5.0.0" = _Y7pX0tdn;
        "pkg-1.20.1-5.0.1" = _De8VfjOn;
        "pkg-1.20.1-5.0.2" = _iis82ChP;
        "pkg-1.20.1-5.0.3" = _d8xUMvrV;
        "pkg-1.20.1-5.0.4" = _xYIR86YP;
        "pkg-1.20.1-5.0.5" = _tBgMZ4AK;
        "pkg-1.20.1-5.0.6" = _gkDDZ0LM;
        "pkg-1.20.1-5.0.7" = _kMmNALv4;
        "pkg-1.20.1-5.0.8" = _cLGot3M6;
        "pkg-1.20.1-5.0.9" = _IPlLiLmA;
        "pkg-1.20.1-5.0.10" = _lIq6j9xL;
        "pkg-1.20.1-5.0.11" = _InlRPIQ9;
        "pkg-1.20.1-5.0.12" = _Lc0q4GAj;
        "pkg-1.20.1-5.0.13" = _xu0zhQB8;
        "pkg-1.20.1-5.0.14" = _YHTMDq85;
        "pkg-1.21.1-6.0.0" = _2QGV5zSs;
        "pkg-1.21.1-6.0.1" = _1Hli2Su8;
        "pkg-1.21.1-6.0.2" = _SNmrRWm5;
        "pkg-1.21.1-6.0.3" = _hkGdpHdO;
        "pkg-1.21.1-6.0.4" = _8oYTDPz3;
        "pkg-1.21.1-6.0.5" = _DbX18kSV;
        "pkg-1.21.1-6.0.6" = _eRZEnAsO;
        "pkg-1.21.1-6.0.7" = _uusKqQHt;
        "pkg-1.21.1-6.0.8" = _cfELyvLC;
        "pkg-1.21.1-6.0.9" = _CLe8cTHs;
        "pkg-1.21.1-6.0.10" = _1jQ1oYaF;
        "pkg-1.21.1-6.0.11" = _yohGnYGV;
        "pkg-1.21.1-6.0.12" = _7epd0iYY;
        "pkg-1.21.1-6.0.13" = _YnbUigkd;
        "pkg-26.1.2-7.0.0" = _fFfT0vXZ;
        "pkg-1.21.1-6.0.14" = _hqDl08eX;
        "pkg-26.1.2-7.0.1" = _2A3vhTeV;
        "pkg-26.1.2-7.0.2" = _8lfXNnGN;
        "pkg-26.1.2-7.0.3" = _ka6JCz7M;
        "pkg-1.21.1-6.0.15" = _ADxNEmse;
        "pkg-26.1.2-7.0.4" = _f5GBMQmv;
        "default" = _f5GBMQmv;
    });
