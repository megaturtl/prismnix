...
let
    versions = (let
        ...
        _xhU3ezDV = {
            "id" = "xhU3ezDV";
            "file" = "simplemacro-neoforge-1.2.1+26.2.jar";
            "hash" = "sha512-7AsP/IFUnYfG3rdJlx3G5OBIKWlNjIN/IrGCnnUI6XknYiTtnHoF84+nziidCUDYQZE/pwA0VSa/qaIc8aZnMw==";
        };
        _8amMOuQX = {
            "id" = "8amMOuQX";
            "file" = "simplemacro-forge-1.2.1+26.2.jar";
            "hash" = "sha512-Ow5hCyQaXSIOM4gdpM8997qKWZJmbf0M32IM/aF2oSasCsTCW+zKQNqVgOkh6piwl2jikwB0e7QmtCek3wuxqg==";
        };
        _EdBKgr70 = {
            "id" = "EdBKgr70";
    ...
    in {
        ...
        "pkg-neoforge-1.21.3-1.0.0" = _susT0yps;
        "pkg-fabric-1.21.4-1.0.0" = _2VvYpprz;
        "pkg-1.21.4-1.0.0" = _b6ZI3GTA;
        "pkg-fabric-1.21.5-1.0.0" = _FDLRiyKP;
        "pkg-neoforge-1.21.5-1.0.0" = _Xm0OtaEk;
        "pkg-fabric-1.21.6-1.0.0" = _hBlMY7eC;
        "pkg-neoforge-1.21.6-1.0.0" = _MAr4xavT;
        "pkg-fabric-1.21.7-1.0.0" = _c1S8Z3N3;
        "pkg-neoforge-1.21.7-1.0.0" = _5ZU09oEV;
        "pkg-fabric-1.21.8-1.0.0" = _RMBEdlZI;
        "pkg-neoforge-1.21.8-1.0.0" = _oNiB0Dpd;
        "pkg-fabric-1.21.10-1.0.0" = _Y9pJdlHQ;
        "pkg-neoforge-1.21.10-1.0.0" = _Ek0KgIEt;
        "pkg-fabric-1.21.1-1.1.0" = _x7fQXrp2;
        "pkg-neoforge-1.21.1-1.1.0" = _kwsPVSL4;
        "pkg-fabric-1.21.3-1.1.0" = _SGbslCwY;
        "pkg-neoforge-1.21.3-1.1.0" = _hMa5VGAX;
        "pkg-fabric-1.21.4-1.1.0" = _6aMsW1hh;
        "pkg-neoforge-1.21.4-1.1.0" = _LMVxOSFS;
        "pkg-fabric-1.21.11-1.1.0" = _FbsxEAuf;
        "pkg-neoforge-1.21.11-1.1.0" = _LHiMpUHh;
        "pkg-fabric-1.21.5-1.1.0" = _QrdoJRDX;
        "pkg-neoforge-1.21.5-1.1.0" = _Lt1c979x;
        "pkg-fabric-1.21.6-1.1.0" = _Csse8iQP;
        "pkg-neoforge-1.21.6-1.1.0" = _osWdDJqC;
        "pkg-fabric-1.21.7-1.1.0" = _qMNq6vOy;
        "pkg-neoforge-1.21.7-1.1.0" = _uVJtqCJQ;
        "pkg-fabric-1.21.8-1.1.0" = _kiYWFtO7;
        "pkg-neoforge-1.21.8-1.1.0" = _1BPCA7sk;
        "pkg-fabric-1.21.10-1.1.0" = _3dQaWmqL;
        "pkg-neoforge-1.21.10-1.1.0" = _MsgRJk8l;
        "pkg-fabric-1.21.1-1.1.1" = _n7ONDinZ;
        "pkg-forge-1.21.1-1.1.1" = _tDHSzZnB;
        "pkg-neoforge-1.21.1-1.1.1" = _mQA03z7Z;
        "pkg-fabric-1.21.10-1.1.1" = _QHOrn5u1;
        "pkg-forge-1.21.10-1.1.1" = _EkZAu1ct;
        "pkg-neoforge-1.21.10-1.1.1" = _jptU6mx9;
        "pkg-fabric-1.21.11-1.1.1" = _3jysSQUN;
        "pkg-forge-1.21.11-1.1.1" = _Exmzxqtb;
        "pkg-neoforge-1.21.11-1.1.1" = _6jALhAdp;
        "pkg-fabric-1.2.0+26.1" = _ra56aVib;
        "pkg-forge-1.2.0+26.1" = _oeUH23V8;
        "pkg-neoforge-1.2.0+26.1" = _F0Ca2Av3;
        "pkg-neoforge-1.2.0+26.2" = _Wc12jdRi;
        "pkg-forge-1.2.0+26.2" = _l67D7Abx;
        "pkg-fabric-1.2.0+26.2" = _2iB5QioB;
