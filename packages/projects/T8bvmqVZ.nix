...
let
    ...
    in {
        ...
        "pkg-0.0.8" = _zAejhGzd;
        "pkg-0.0.9" = _QLjmud4k;
        "pkg-0.0.10" = _28W4ro3A;
        "pkg-0.0.11" = _MXrUDzQ2;
        "pkg-0.0.12" = _UOJ1wzAU;
        "pkg-0.0.13" = _xBRae6Z1;
        "pkg-0.0.14" = _QK2zqFIL;
        "pkg-0.0.15" = _qEdzH6pH;
        "pkg-0.0.16" = _QloSgRYO;
        "pkg-0.0.17" = _uM5y7a36;
        "pkg-0.0.18" = _mHK155bN;
        "pkg-0.0.19" = _Iznx3ADe;
        "pkg-0.0.20" = _Tj8KVt5U;
        "pkg-0.0.21" = _iiTMK7TN;
        "pkg-0.0.22" = _opkbEfCC;
        "pkg-0.0.23" = _a76lmqVJ;
        "pkg-0.0.24" = _UCWqQ0cT;
        "pkg-0.0.25" = _Je6kTiRV;
        "pkg-0.0.26" = _enpGdAvv;
        "pkg-0.0.27" = _KGBva2yg;
        "pkg-0.0.28" = _i3ShqztJ;
        "pkg-0.0.29" = _qTdocWG0;
        "pkg-0.0.29b" = _RzBZhbmX;
        "pkg-0.0.30" = _nhfoDTtX;
        "pkg-0.0.31" = _JT5b8DQu;
        "pkg-0.0.32" = _OVDs1nH2;
        "pkg-0.0.30b" = _7Q1rlZJ1;
        "pkg-0.0.33jolly" = _VVD3gYnc;
        "pkg-0.0.34" = _oOtLESkj;
        "pkg-0.0.35" = _ZMUItfa8;
        "pkg-0.0.36" = _MufMHtpx;
        "pkg-0.0.37" = _KekEBJB2;
        "pkg-0.0.38" = _kTgaoLud;
        "pkg-0.0.39" = _ENXqchX8;
        "pkg-0.0.40" = _aBivyLgh;
        "pkg-0.0.41" = _KhetYQ7p;
        "pkg-0.0.42" = _T3WMbxwg;
        "pkg-0.0.43" = _AHpm6JFZ;
        "pkg-0.0.44" = _XKDQlGJW;
        "pkg-2.1.6-beta" = _4dVQyRvX;
        "pkg-2.1.7-beta" = _3o61VNuV;
        "pkg-2.1.8-beta" = _s3KEbbqa;
        "pkg-2.1.9-beta" = _cSCeD78i;
        "pkg-2.1.10-beta" = _KB2G0oTE;
        "pkg-2.1.11-beta" = _zNDKNuBZ;
        "pkg-2.1.12-beta" = _28WdBSyU;
