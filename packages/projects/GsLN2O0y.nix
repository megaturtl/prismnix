...
let
    ...
    in {
        ...
        "b2kdtwKH" = _b2kdtwKH;
        "gWOWHFtt" = _gWOWHFtt;
        "minecraft-1.16" = _i9hvvcSJ;
        "minecraft-1.16.1" = _i9hvvcSJ;
        "minecraft-1.16.2" = _i9hvvcSJ;
        "minecraft-1.16.3" = _i9hvvcSJ;
        "minecraft-1.16.4" = _i9hvvcSJ;
        "minecraft-1.16.5" = _i9hvvcSJ;
        "minecraft-1.17" = _i9hvvcSJ;
        "minecraft-1.17.1" = _i9hvvcSJ;
        "minecraft-1.18" = _i9hvvcSJ;
        "minecraft-1.18.1" = _i9hvvcSJ;
        "minecraft-1.18.2" = _i9hvvcSJ;
        "minecraft-1.19" = _i9hvvcSJ;
        "minecraft-1.19.1" = _i9hvvcSJ;
        "minecraft-1.19.2" = _i9hvvcSJ;
        "minecraft-1.19.3" = _i9hvvcSJ;
        "minecraft-1.19.4" = _i9hvvcSJ;
        ...
        "minecraft-26.3-snapshot-6" = _gWOWHFtt;
        "minecraft-26.3-snapshot-7" = _gWOWHFtt;
        "minecraft-26.3-snapshot-8" = _gWOWHFtt;
        "minecraft-26.3-snapshot-9" = _gWOWHFtt;
        "minecraft-26.3-snapshot-10" = _gWOWHFtt;
        "minecraft-26.3-pre-1" = _gWOWHFtt;
        "minecraft-26.3-pre-2" = _gWOWHFtt;
        "pkg-1.0" = _gWOWHFtt;
        "default" = _gWOWHFtt;
    });
