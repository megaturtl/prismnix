...
let
    ...
    in {
        ...
        "pkg-0.5" = _7I3XcCf3;
        "pkg-0.6" = _Bus3bvON;
        "pkg-0.6+mod" = _PNDmSvcR;
        "pkg-1" = _djJFgMAk;
        "pkg-1+mod" = _AqJ85Udp;
        "pkg-1.1" = _fStp5XeY;
        "pkg-1.1+mod" = _Lzh8jFhz;
        "pkg-1.2" = _Rj9hO6WO;
        "pkg-1.2+mod" = _q53wKowu;
        "pkg-1.3" = _Y1Br3HxH;
        "pkg-1.3+mod" = _SFDCozj9;
        "pkg-1.4" = _txDKhFdK;
        "pkg-1.4+mod" = _fLr3GjZi;
        "pkg-2.0" = _gaeMnvXJ;
        "pkg-2.0+mod" = _Vi9o7qLr;
        "pkg-2.1" = _Ok0sie4C;
        "pkg-2.1+mod" = _hsHPP0ZY;
        "pkg-26.1" = _P2cbPJnR;
        "pkg-26.1+mod" = _OfLc2zME;
        "pkg-2.3" = _65rWWBY6;
