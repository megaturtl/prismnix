...
let
    ...
    in {
        ...
        "pkg-v21.4.0-1.21.4-Fabric" = _kWuBA4vx;
        "pkg-v21.5.0-1.21.5-Fabric" = _XInxWEUL;
        "pkg-v21.5.0-1.21.5-NeoForge" = _MRdS7Xda;
        "pkg-v21.8.0-1.21.8-Fabric" = _XIeP6Gds;
        "pkg-v21.8.0-1.21.8-NeoForge" = _bkQbRTf0;
        "pkg-v21.4.0-1.21.4-NeoForge" = _x2pZ49JM;
        "pkg-21.10.1" = _KOsWKqnl;
        "pkg-v21.3.1-1.21.3-Fabric" = _A5qCHrNR;
        "pkg-v21.3.1-1.21.3-NeoForge" = _HVqGtaVG;
        "pkg-v21.4.1-1.21.4-Fabric" = _ULW3A4Oi;
        "pkg-v21.4.1-1.21.4-NeoForge" = _FH3euP0l;
        "pkg-21.11.0" = _IteW0iej;
        "pkg-v21.3.2-1.21.3-Fabric" = _xajpQDWm;
        "pkg-v21.3.2-1.21.3-NeoForge" = _ZEgavBcC;
        "pkg-v21.4.2-1.21.4-Fabric" = _ewfu8lJy;
        "pkg-v21.4.2-1.21.4-NeoForge" = _51hWbxTg;
        "pkg-21.11.1" = _pO7pyFtx;
        "pkg-21.10.2" = _SOA8ojHt;
        "pkg-v21.5.1-1.21.5-Fabric" = _EEGdJqQ3;
        "pkg-v21.8.1-1.21.8-Fabric" = _k1iCJ7ad;
        "pkg-v21.5.1-1.21.5-NeoForge" = _CXNvwMxo;
        "pkg-v21.8.1-1.21.8-NeoForge" = _Uda8TTaU;
        "pkg-26.1.0" = _NhqjphKc;
