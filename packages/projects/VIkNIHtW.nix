...
let
    versions = (let
        ...
        _H8AxSHIO = {
            "id" = "H8AxSHIO";
            "file" = "PTS-Deco-14.0-NeoForge26.2.jar";
            "hash" = "sha512-TqdFNHY1GEd+Zl5MrG/fzGoZcuCFZl10+hAq3XjYn/0Ct7qyHXmOpqdzn7j3u1zpXe3PGHnhEY+IlqYTZCDcxw==";
        };
        _tcZ2rzPh = {
            "id" = "tcZ2rzPh";
            "file" = "PTS-Deco-14.0-Fabric26.2.jar";
            "hash" = "sha512-1TZDBaPXymwjX5hnNRH0MSfKKlSFnWrfkEA4SbKae563Z5WMyOv8XXKuyg7vmXpPeV+e/ImwptpdZzNWrspEsQ==";
        };
        _gvDB6VmH = {
            "id" = "gvDB6VmH";
            "file" = "PTS-Deco-15.0-NeoForge26.3.jar";
            "hash" = "sha512-6BLbde105X+pWQKqhyH1crPj1a1C8k6/AVNkQj4MSrF1bQoWaQxh2KFx8dgEFg2l5KzjaaIjUV6/c8okwcCqyA==";
        };
        _HbuJJbUV = {
            "id" = "HbuJJbUV";
            "file" = "PTS-Deco-15.0-Fabric26.3.jar";
            "hash" = "sha512-AaQ61ZrUvUZUVPlhihwKmnDUui6y/0tSiJbazE7jORb9uv+83kwoQEY3cCbNb3+DjvSNSfw9x71jzQ679nvGCw==";
        };
    in {
        "gXwvTDUc" = _gXwvTDUc;
        "AFD7ZtJ7" = _AFD7ZtJ7;
        ...
        "fabric-26.2" = _tcZ2rzPh;
        "fabric-26.3" = _HbuJJbUV;
        ...
        "neoforge-26.2" = _H8AxSHIO;
        "neoforge-26.3" = _gvDB6VmH;
        "pkg-forge3.0.9-1.19.2" = _gXwvTDUc;
        "pkg-fabric3.0.9-1.19.2" = _AFD7ZtJ7;
        "pkg-forge3.0.9-1.19.4" = _PU2Rfs72;
        "pkg-fabric3.0.9-1.19.4" = _h7oPVDh9;
        "pkg-fabric3.0.8-1.20.1" = _lCSZBrTb;
        "pkg-3.1.0-1.20.1" = _MjpozKav;
        "pkg-3.0.5-forge1.20.4" = _m2SHWYDF;
        "pkg-3.0.5-fabric1.20.4" = _73NXC1nK;
        "pkg-3.0.5-neoforge1.20.4" = _ruYzRUR2;
        "pkg-3.0.8.5-forge1.21.1" = _quUJzn4n;
        "pkg-3.0.8.5-fabric1.21.1" = _f19pMX7e;
        "pkg-3.0.8.5-neoforge1.21.1" = _4A38s7p9;
        "pkg-3.0.8.5-fabric1.21.8" = _4TZirpzu;
        "pkg-3.0.8.5-neoforge1.21.8" = _RaUxAsH6;
        "pkg-3.1.1-1.20.1" = _srf2Hqj2;
        "pkg-3.1.1.5-1.20.1" = _R3D9eoZ9;
        "pkg-forge1.20.1-3.2.0" = _Q3Ybcn4g;
        "pkg-fabric1.20.1-3.2.0" = _A3y2yXo7;
        "pkg-fabric-1.21.8-3.0.8.6" = _4qlrUEI9;
        "pkg-neoforge-1.21.8-3.0.8.6" = _uIi0ChEX;
        "pkg-3.2.1-forge1.20.1" = _QEnyyf7H;
        "pkg-3.2.1-fabric1.20.1" = _5CSsY82o;
        "pkg-3.2.1-neoforge1.21.1" = _YQBJu8AZ;
        "pkg-3.2.1-fabric1.21.1" = _QmyKWkM5;
        "pkg-neoforge3.2.2" = _JEtFzyx5;
        "pkg-fabric3.2.2" = _rMX7VFME;
        "pkg-neoforge-alpha4.0.0" = _NorkBfKM;
        "pkg-fabric-alpha4.0.0" = _72XPaOUb;
        "pkg-fabric-alpha-4.0.1" = _mCmGEHn4;
        "pkg-neoforge-alpha-4.0.1" = _sf9VHhoK;
        "pkg-forge-alpha4.0.2-1.21.8" = _VDWofDiG;
        "pkg-fabric-alpha4.0.2-1.21.8" = _YdOq8iaE;
        "pkg-neoforge-alpha4.0.2-1.21.8" = _WhLECWqJ;
        "pkg-forge-beta-4.0.2.1-1.21.8" = _jDTDoZW6;
        "pkg-forge1.21.8-beta-4.0.3" = _SUqNxl9H;
        "pkg-fabric1.21.8-beta-4.0.3" = _AwLKxuTM;
        "pkg-neoforge1.21.8-beta-4.0.3" = _NT9pbnZD;
        "pkg-fabric1.21.9-beta-4.0.4" = _qzyIgRoO;
        "pkg-neoforge1.21.9-beta-4.0.4" = _zhEScaBL;
        "pkg-beta-4.0.5-neoforge1.21.9" = _WFURXqIl;
        "pkg-beta-4.0.5-fabric1.21.9" = _3jsm5wX7;
        "pkg-beta-4.0.5-neoforge1.21.10" = _5Dk6UCZj;
        "pkg-beta-4.0.5-fabric1.21.10" = _2asT0WIn;
        "pkg-4.0.6-beta-fabric1.21.10" = _3pAGVyzu;
        "pkg-bet-4.0.6-neoforge1.21.10" = _Mdqtaj9s;
        "pkg-beta-4.0.6.5-fabric" = _BA4JKWpG;
        "pkg-beta-4.0.6.5-neoforge" = _mRyq5H5S;
        "pkg-beta-4.0.7-fabric1.21.10" = _WdYFYUap;
        "pkg-beta-4.0.7-neoforge1.21.10" = _RVHB2hDr;
        "pkg-beta-4.0.7.5-fabric1.21.10" = _97jJnzwg;
        "pkg-beta-4.0.7.5-neoforge1.21.10" = _aoHjUSBZ;
        "pkg-beta-4.0.8-fabric1.21.10" = _BHMVGR3u;
        "pkg-beta-4.0.8-neoforge1.21.10" = _2oyc92t4;
        "pkg-4.0.0-fabric1.21.10" = _FIv9FEgM;
        "pkg-4.0.0-neoforge1.21.10" = _9LZqS7Wh;
        "pkg-4.0.0-fabric1.21.9" = _hEEUjHfD;
        "pkg-4.0.0-neoforge1.21.9" = _HtgcziEu;
        "pkg-4.0.0-fabric1.21.8" = _EkawPZOj;
        "pkg-4.0.0-neoforge1.21.8" = _J2AreRfs;
        "pkg-4.0.0-fabric1.21.7" = _xJwfNVWA;
        "pkg-4.0.0-neoforge1.21.7" = _pJXyIEio;
        "pkg-4.0.0-fabric1.21.6" = _MzspqfMp;
        "pkg-4.0.0-neoforge1.21.6" = _HTIQgpRk;
        "pkg-4.0.0-fabric1.21.5" = _aLHY9Wv7;
        "pkg-4.0.0-neoforge1.21.5" = _GUf3UMsg;
        "pkg-4.0.0-fabric4.0.0" = _QrMxGWLA;
        "pkg-4.0.0-neoforge1.21.4" = _w1tPC1cT;
        "pkg-4.0.0-fabric1.21.3" = _TsX6JD65;
        "pkg-4.0.0-neoforge1.21.3" = _jJi4mL3G;
        "pkg-4.0.0-fabric1.21.2" = _WcQSvEYS;
        "pkg-4.0.0-neoforge1.21.2" = _fShyDbb0;
        "pkg-4.0.0-fabric1.21.1" = _ipKB9XRD;
        "pkg-4.0.0-neoforge1.21.1" = _WMKQavnm;
        "pkg-4.0.0-forge1.21.1" = _COA3ZqXp;
        "pkg-4.0.0-fabric1.21" = _MnvYG9x4;
        "pkg-4.0.0-neoforge1.21" = _8XV8ty02;
        "pkg-4.0.0-forge1.21" = _lsoMeTbv;
        "pkg-4.0.0.5-fabric1.21.10" = _Xj4igQ4f;
        "pkg-4.0.0.5-fabric1.21.9" = _Gv4QqBy3;
        "pkg-4.0.0.5-fabric1.21.8" = _Kwi1oalE;
        "pkg-4.0.0.5-fabric1.21.7" = _4gB63BmV;
        "pkg-4.0.0.5-fabric1.21.6" = _MWGT1Fgj;
        "pkg-4.0.0.5-fabric1.21.5" = _4RfnejNl;
        "pkg-4.0.0.5-fabric1.21.4" = _OdYZRpuA;
        "pkg-4.0.0.5-fabric1.21.3" = _pCbKe1fm;
        "pkg-4.0.0.5-fabric1.21.2" = _ltba3YxC;
        "pkg-4.0.0.5-fabric1.21.1" = _o35zORIu;
        "pkg-4.0.0.5-fabric1.21" = _UyP6jthm;
        "pkg-4.0.0-fabric1.20.6" = _1My0bvEC;
        "pkg-4.0.0-neoforge1.20.6" = _M6OoFe6Q;
        "pkg-4.0.0-forge1.20.6" = _PZSmz9ma;
        "pkg-4.0.0-fabric.20.5" = _UXC4wdDQ;
        "pkg-4.0.0-neoforge1.20.5" = _5pRX8FCf;
        "pkg-4.0.0-fabric1.20.4" = _etl5lvBR;
        "pkg-4.0.0-neoforge1.20.4" = _NoxCyjkF;
        "pkg-4.0.0-forge1.20.4" = _tybpP5T3;
        "pkg-4.0.0-fabric1.20.3" = _IF8jpR9M;
        "pkg-4.0.0-neoforge1.20.3" = _puj0iHwg;
        "pkg-4.0.0-forge1.20.3" = _jpUJV0Ao;
        "pkg-4.0.0-fabric1.20.2" = _VdGZQcXX;
        "pkg-4.0.0-neoforge1.20.2" = _jR4VV27p;
        "pkg-4.0.0-forge1.20.2" = _M9Uh5QUq;
        "pkg-4.0.0-fabric1.20.1" = _6IOQp0yb;
        "pkg-4.0.0-forge1.20.1" = _tjpiGghR;
        "pkg-4.0.0.6-fabric1.21.10" = _f0jRXA6F;
        "pkg-4.0.0.6-neoforge1.21.10" = _QZNWxZRK;
        "pkg-4.0.0-fabric1.20" = _l66EFCej;
        "pkg-4.0.0-forge1.20" = _SBcOF3lN;
        "pkg-4.0.0.1-fabric1.20" = _H69hJuQt;
        "pkg-4.0.0-fabric1.19.4" = _33eFNvcE;
        "pkg-4.0.0-forge1.19.4" = _OzYSzRhy;
        "pkg-4.0.0-fabric1.19.3" = _RXF89tcU;
        "pkg-4.0.0-forge1.19.3" = _IGzpZGZ2;
        "pkg-4.0.0-fabric1.19.2" = _fnCoSvsU;
        "pkg-4.0.0-forge1.19.2" = _RKmFZqQy;
        "pkg-4.0.0-fabric1.19.1" = _UvVkTh3e;
        "pkg-4.0.0-forge1.19.1" = _u0YTW367;
        "pkg-4.0.0-fabric1.19" = _gmsMru3z;
        "pkg-4.0.0-forge1.19" = _wstxsAKA;
        "pkg-4.0.0-fabric1.18.2" = _tPVWtByP;
        "pkg-4.0.0-forge1.18.2" = _AYMTeWcu;
        "pkg-4.0.0-fabric.1.18.1" = _5XN87rx8;
        "pkg-4.0.0-forge1.18.1" = _86tHLbsF;
        "pkg-4.0.0-fabric1.18" = _rDvZ3NZQ;
        "pkg-4.0.0-forge1.18" = _RVIQikHk;
        "pkg-4.0.0-fabric1.17.1" = _wc5cd31N;
        "pkg-4.0.0-forge1.17.1" = _ch4eqwp8;
        "pkg-4.0.0-fabric1.17" = _udHK8My3;
        "pkg-4.0.0-fabric1.21.4" = _soubiM6f;
        "pkg-4.0.1-neoforge1.21.11" = _anyWLZ1b;
        "pkg-4.0.1-fabric1.21.11" = _CAZV8P8K;
        "pkg-beta-4.0.1.1-fabric1.21.11" = _FgACg5V6;
        "pkg-4.0.2-forge1.21.11" = _vhhR2JHk;
        "pkg-4.0.2-fabric1.21.11" = _rRIpu1wy;
        "pkg-4.0.2-neoforge1.21.11" = _LnofUwgV;
        "pkg-4.0.3-forge1.21.11" = _HO4rMPYT;
        "pkg-4.0.3-fabric1.21.11" = _DZO0x8rU;
        "pkg-4.0.3-neoforge1.21.11" = _P7N192WJ;
        "pkg-4.0.4-forge1.21.11" = _J3zGklwF;
        "pkg-4.0.4-fabric1.21.11" = _39rpVl2I;
        "pkg-4.0.4-neoforge1.21.11" = _1wOTRKaw;
        "pkg-4.0.4-forge1.21.1" = _3q70Q036;
        "pkg-4.0.4-fabric1.21.1" = _h4VFc2bE;
        "pkg-4.0.4-neoforge1.21.1" = _OfpwiG9f;
        "pkg-4.0.4-fabric1.20.1" = _eWdXHiqB;
        "pkg-4.0.4-forge1.20.1" = _ZrIGP6Fq;
        "pkg-4.0.4.5-forge1.20.1" = _bge9Vve3;
        "pkg-4.0.4.5-fabric1.20.1" = _cuY92pUt;
        "pkg-4.0.5-forge1.16.5" = _QO61XhiI;
        "pkg-4.0.5-forge1.16.4" = _XbDOAyWW;
        "pkg-4.0.5-forge1.16.3" = _r3mZHbk0;
        "pkg-4.0.5-forge1.16.2" = _ZBTJFtKG;
        "pkg-4.0.5-forge1.16.1" = _ZaEessLA;
        "pkg-4.0.5-forge1.15.2" = _VsHH3wPs;
        "pkg-4.0.5-forge1.15.1" = _M4ELigMl;
        "pkg-4.0.5-forge1.14.4" = _p9aa4AiO;
        "pkg-4.0.5-forge1.20.1" = _xvoX8LxV;
        "pkg-4.0.5-fabric1.20.1" = _132JbKOG;
        "pkg-4.0.5-neoforge1.21.11" = _sHfr929E;
        "pkg-4.0.5-fabric1.21.11" = _dbRQtjQc;
        "pkg-4.0.5.1-forge1.20.1" = _A442ExRC;
        "pkg-4.0.5.1-fabric1.20.1" = _BGNTa0tj;
        "pkg-4.1-neoforge26.1" = _pvjwPoWK;
        "pkg-4.1-fabric26.1" = _CIAXXpOS;
        "pkg-1.0-neoforge26.1" = _Br1QHLAa;
        "pkg-1.0-fabric26.1" = _ZkKHvIZC;
        "pkg-2.0-neoforge26.1.1" = _iExJZ9yc;
        "pkg-2.0-fabric26.1.1" = _PBVhWf0H;
        "pkg-3.0-neoforge26.1.1" = _KvGu5t7v;
        "pkg-3.0-fabric26.1.1" = _I9DuKMxZ;
        "pkg-4.0-fabric26.1.2" = _tLpPtZFa;
        "pkg-4.0-neoforge26.1.2" = _xdlZrsQJ;
        "pkg-5.0-neoforge26.1.2" = _aE5wZ5bk;
        "pkg-5.0-fabric26.1.2" = _GLx2vpQJ;
        "pkg-6.0-neoforge26.1.2" = _we60CZP7;
        "pkg-6.0-fabric26.1.2" = _utX9XftP;
        "pkg-7.0-neoforge26.1.2" = _wBebikRC;
        "pkg-7.0-fabric26.1.2" = _nIzQDRtb;
        "pkg-7.1-neoforge26.1.2" = _DBDimlAS;
        "pkg-7.1-fabric26.1.2" = _VRBiAOhF;
        "pkg-8.0-neoforge26.1.2" = _pkexgfvA;
        "pkg-8.0-fabric26.1.2" = _9ESxK9ru;
        "pkg-9.0-neoforge26.2" = _VsGB19UL;
        "pkg-9.0-fabric26.2" = _rcRrjjvM;
        "pkg-10.0-neoforge26.2" = _v8HSS83m;
        "pkg-10.0-fabric26.2" = _weBTxQGL;
        "pkg-11.0-neoforge26.2" = _t6eVr9WU;
        "pkg-11.0-fabric26.2" = _IBa4IeS3;
        "pkg-11.0-neoforge26.1.2" = _12kBzErC;
        "pkg-11.0-fabric26.1.2" = _gVmVZfyD;
        "pkg-11.0-neoforge26.1.1" = _ytKjrPIo;
        "pkg-11.0-fabric26.1.1" = _e44jTLLt;
        "pkg-11.0-neoforge26.1" = _gM7Sl2K2;
        "pkg-11.0-fabric26.1" = _AQZbIm68;
        "pkg-11.0-neoforge1.21.11" = _lIVuFMaJ;
        "pkg-11.0-fabric1.21.11" = _OKgKFyxZ;
        "pkg-11.0-neoforge1.21.10" = _Ms7PvKXw;
        "pkg-11.0-fabric1.21.10" = _pDfF4f89;
        "pkg-11.0-neoforge1.21.8" = _EsRsbvrB;
        "pkg-11.0-fabric1.21.8" = _5slBM8UB;
        "pkg-11.0-neoforge1.21.5" = _Ydp5opNb;
        "pkg-11.0-fabric1.21.5" = _hRPj1PAF;
        "pkg-11.0-neoforge1.21.4" = _qGiqzJnP;
        ...
        "pkg-14.0-neoforge26.2" = _H8AxSHIO;
        "pkg-14.0-fabric26.2" = _tcZ2rzPh;
        "pkg-15.0-neoforge26.3" = _gvDB6VmH;
        "pkg-15.0-fabric26.3" = _HbuJJbUV;
        "default" = _HbuJJbUV;
    });
