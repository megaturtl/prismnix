...
let
    versions = (let
        ...
        _seYfdjdQ = {
            "id" = "seYfdjdQ";
            "file" = "adastra-1.21.1-1.16.19-neoforge.jar";
            "hash" = "sha512-ZYdifTT1NoYhhFKuXRDA7xEP6wdIvNx1P1doGlYHqIHulkahFuZTiMFxIqrr8p6N7yUX6qtjfaZq3hNcUTh25g==";
        };
        _TPlHrt17 = {
            "id" = "TPlHrt17";
            "file" = "adastra-1.21.1-1.16.19-fabric.jar";
            "hash" = "sha512-FZ05ZhHmIcdd5vZu+p2FmL9berqkQ1BDf3KgSIlHkC2BXLVbHU55MfPXctSEyhaAMRl/03QKm+2jXdgiMHCJUw==";
        };
        _Zafmz5xs = {
            "id" = "Zafmz5xs";
            "file" = "adastra-1.21.1-1.16.20-neoforge.jar";
            "hash" = "sha512-l5VLN1ii1RfSIm+xn4NPYvoPTyjfSgZ0EGguYLpuCFNptikc8bjqTp2fP3X8W//p1fWFG38ujnBPcC32XGEApg==";
        };
        _kV5ErsaG = {
            "id" = "kV5ErsaG";
            "file" = "adastra-1.21.1-1.16.20-fabric.jar";
            "hash" = "sha512-PqCSBGGrMMSMKcE2BDRzJBCW3t1dI+032eGKbgwJ9HdBloqwnci8kFR9ycV1nNDSp0THJ4eO+bfzzNBZ5GWYOw==";
        };
        _ohhwrpc5 = {
            "id" = "ohhwrpc5";
            "file" = "adastra-1.21.1-1.16.21-neoforge.jar";
            "hash" = "sha512-FSu+P84s25o4nitRMCQMRFiVOXPssDleZUDuPrLIO70OB8G5rcpUu/HbVUDxVVlHcTbvwtDyV5/XIw12eMgVqA==";
        };
        _buKLE9ip = {
            "id" = "buKLE9ip";
            "file" = "adastra-1.21.1-1.16.21-fabric.jar";
            "hash" = "sha512-rhC+7miFyul4CAmQK7t+b2JwbMqUkw1V5S3RmUd3gQPiONbeMI7dJ1/TCcmPQGsnx7Qx0D/YuqfQZlmzHPD/HA==";
        };
        _1PcJ5HiN = {
            "id" = "1PcJ5HiN";
            "file" = "adastra-1.21.1-1.16.22-neoforge.jar";
            "hash" = "sha512-CKaM3+lGuCTXdyNELSEVctEUgWEk/ScfMrs4rXEeHhsigtalVfqfJiERXi7QKuZnFuBonu5BonTHDxHeplbDYg==";
        };
        _ubMP4jhJ = {
            "id" = "ubMP4jhJ";
            "file" = "adastra-1.21.1-1.16.22-fabric.jar";
            "hash" = "sha512-PV3OO2ypxImRand1/u8o2oXSE/2G+WAmGJqVeQeozmRz8WFvQE0/HfIoaG6t01if5jp3hFuy1XQPFE1hCl/CJA==";
        };
        _d9pTNAOd = {
            "id" = "d9pTNAOd";
            "file" = "adastra-1.21.1-1.16.23-neoforge.jar";
            "hash" = "sha512-pa7WaVXnUybeeBSJELFq7IhxhsGJ1LpJxqvjNQT5fQDCloWUNzxEPQXdui7Z8uJfmU5Hv0NvKLX9RJhzZal2kA==";
        };
        _3rcvMXIT = {
            "id" = "3rcvMXIT";
            "file" = "adastra-1.21.1-1.16.23-fabric.jar";
            "hash" = "sha512-p7dS0udKbRwVb3fTeV4nw+eoIFbjeq6B0FEaIHBsFTe5TQh9Alk94iiTvE2ZOGlhopZBsVfF45yXAnm7+5rp9g==";
        };
        _P6UKrUtG = {
            "id" = "P6UKrUtG";
            "file" = "adastra-1.21.1-1.16.24-neoforge.jar";
            "hash" = "sha512-jGItLZdFp0GFI2MW4FiVF42SrvrfHoOMRSqq93KC5T01sZef9xV04F1Zj/oXFcywMY2PhGsf+5JUDaedlOBkXg==";
        };
        _oYFQwlvA = {
            "id" = "oYFQwlvA";
            "file" = "adastra-1.21.1-1.16.24-fabric.jar";
            "hash" = "sha512-xDs1QqzW70cMGl58gpJB1fFk57bvabTuiPlLSCWVXTYOISoHNFkp/I5eVM5MFBqp6upF/gA1EZ6qxpWTuGBmsA==";
        };
        _SrxrK0Sv = {
            "id" = "SrxrK0Sv";
            "file" = "adastra-1.21.1-1.16.25-neoforge.jar";
            "hash" = "sha512-zoug3PmPHMPziVE3OjUxC9soaOXboh5oeo5HgQ2kH5P2JzIlzqKpJZ0V2VxtYKVOq74D2zsIvFLJxvrIGZADJA==";
        };
        _vq7NPdo7 = {
            "id" = "vq7NPdo7";
            "file" = "adastra-1.21.1-1.16.25-fabric.jar";
            "hash" = "sha512-6I6qK+8RhaOlLwLDhfbovlViZzSAUDzQ+CxzKm1rQciAOXah0xaWWFNGMjneCTpy+r2lmZEf6W1t2TJxD75wNg==";
        };
        _18wLDrwY = {
            "id" = "18wLDrwY";
            "file" = "ad_astra-fabric-1.20.1-1.15.21.jar";
            "hash" = "sha512-zTUXB+BaYvezEJJWQpegGzP9VwHFGJ2qO9tvKmOlBxazlLB7hXMJ55YND2rcfV1CxQrDevA5sgbinbywBkg4gA==";
        };
        _8EwzHQkx = {
            "id" = "8EwzHQkx";
            "file" = "ad_astra-forge-1.20.1-1.15.21.jar";
            "hash" = "sha512-ITYYYCq4bz4DBb5tmi5H01Fv0So/RnZ3GdtIQqar4jAoS59ALQJq1ns5M29u6A91AuurUSjGBdZluMFlyHfJjw==";
        };
        _xkI2fZPp = {
            "id" = "xkI2fZPp";
            "file" = " ad_astra-fabric-1.18.2-1.0.10.jar";
            "hash" = "sha512-wqeBe+tqqh2DDX6sauFYSvSlm6wew6obaZ7tLLMXHUdkyaTK3SPmGfZrsyTIU/nccsfb+8ABcokoYfARZT459A==";
        };
        _9pnKHdCG = {
            "id" = "9pnKHdCG";
            "file" = "adastra-1.21.1-1.16.26-neoforge.jar";
            "hash" = "sha512-vjRqT6PcniZSi27vWXz/kNUuhsn6RqsgacQZZ+Klczjm1feA/46AqII+MZkEnx5OjKE936UpK2XfdeTuFvcd3w==";
        };
        _R1Zh2VaO = {
            "id" = "R1Zh2VaO";
            "file" = "adastra-1.21.1-1.16.26-fabric.jar";
            "hash" = "sha512-aFf+elB8Z4XXdjOMCtqFr24+J/HrnO6SXYq5CFK10UFFhlMl0cR+939UsputXTiQe6AUxIL+CBq5S0/vloI/4g==";
        };
    in {
        "tSm8mJ5H" = _tSm8mJ5H;
        "1jF2Fajp" = _1jF2Fajp;
        ...
        "9pnKHdCG" = _9pnKHdCG;
        "R1Zh2VaO" = _R1Zh2VaO;
        "fabric-1.18.2" = _xkI2fZPp;
        "fabric-1.19.2" = _zXU0zDes;
        "fabric-1.19.3" = _GVf0Dxrn;
        "fabric-1.19.4" = _AEOl4qWM;
        "fabric-1.20" = _ZKEZUh2e;
        "fabric-1.20.1" = _18wLDrwY;
        "fabric-1.20.4" = _8jKAHcdv;
        "fabric-1.21.1" = _R1Zh2VaO;
        "forge-1.19.2" = _jswyrySh;
        "forge-1.19.3" = _gM81Pe3g;
        "forge-1.19.4" = _apaMnBDD;
        "forge-1.20" = _RohrE1G4;
        "forge-1.20.1" = _8EwzHQkx;
        "neoforge-1.20.4" = _Pl56bqmV;
        "neoforge-1.21.1" = _9pnKHdCG;
        "pkg-1.0.0" = _tSm8mJ5H;
        "pkg-1.0.1" = _1jF2Fajp;
        "pkg-1.0.2-1.18.2" = _gSh656wW;
        "pkg-1.0.2-1.19.2" = _fG52dOcS;
        "pkg-1.0.3" = _OoVaj9um;
        "pkg-1.0.5-1.18.2" = _gAbBtEnb;
        "pkg-1.10-FABRIC" = _J3U3uIby;
        "pkg-1.10-FORGE" = _xiV8O2n8;
        "pkg-1.11-FABRIC" = _jqvmkZYG;
        "pkg-1.11-FORGE" = _m4m4CDqy;
        "pkg-1.11.1-FORGE" = _7hefnmc3;
        "pkg-1.11.2-FABRIC" = _oWfcn1z0;
        "pkg-1.11.2-FORGE" = _tOjHdzUN;
        "pkg-1.11.3-FABRIC" = _IDME4AA4;
        "pkg-1.11.3-FORGE" = _zlbE6Kdi;
        "pkg-1.11.4" = _gcofsxt9;
        "pkg-1.11.5" = _I3cBSQZH;
        "pkg-1.11.6" = _H35PWK5Y;
        "pkg-1.11.7" = _euBX2spq;
        "pkg-1.11.8" = _mqonv1gZ;
        "pkg-1.11.9" = _CT6oT5N6;
        "pkg-1.12.0" = _bWrhyxBs;
        "pkg-1.12.1" = _sH2Z1w7t;
        "pkg-1.13.0" = _MqDuY0zd;
        "pkg-1.12.2" = _xjAHTBxF;
        "pkg-1.13.1" = _mVO5JjEP;
        "pkg-1.13.2" = _4z5fHbiT;
        "pkg-1.13.3" = _TmYWWueC;
        "pkg-1.0.6" = _S4zZGF0X;
        "pkg-1.12.3" = _nNKKrHvH;
        "pkg-1.13.4" = _y9kMFcxZ;
        "pkg-1.12.4" = _E9DBRAIT;
        "pkg-1.12.5" = _QwkZZe7b;
        "pkg-1.13.5" = _nn3WaZMm;
        "pkg-1.14.0" = _6bUDeqhI;
        "pkg-1.0.7" = _QfGTTKEm;
        "pkg-1.14.1" = _apaMnBDD;
        "pkg-1.12.6" = _lsWkbtEH;
        "pkg-1.13.6" = _gM81Pe3g;
        "pkg-1.0.8" = _4LDV3zx8;
        "pkg-1.0.9" = _TQ4C1n5D;
        "pkg-1.15" = _JM91Sn4b;
        "pkg-1.15.1" = _RohrE1G4;
        "pkg-1.12.7" = _jswyrySh;
        "pkg-1.15.2" = _TA1s5rP6;
        "pkg-1.15.3" = _9rCTue8e;
        "pkg-1.15.4" = _AUgYW5MG;
        "pkg-1.15.5" = _QzjRLT8e;
        "pkg-1.15.7" = _HdDxTL4A;
        "pkg-1.15.8" = _UKU6f8pz;
        "pkg-1.15.9" = _sTVtTOWk;
        "pkg-1.15.10" = _80ZASnFF;
        "pkg-1.15.11" = _F0U2KOaJ;
        "pkg-1.15.12" = _VxrayLlt;
        "pkg-1.15.13" = _GtYvEYcD;
        "pkg-1.15.14" = _mgzejQOj;
        "pkg-1.16.0" = _glkWYMcN;
        "pkg-1.15.15" = _fQu5UOld;
        "pkg-1.16.1" = _kbi2bVzx;
        "pkg-1.15.16" = _6yGNZ8l5;
        "pkg-1.16.2" = _3NC88P03;
        "pkg-1.16.3" = _pQV7Fl7z;
        "pkg-1.15.17" = _7Bm3XJNX;
        "pkg-1.16.4" = _vWVBPn99;
        "pkg-1.15.18" = _MxqFxL9C;
        "pkg-1.16.5" = _8jKAHcdv;
        "pkg-1.15.19" = _Xtm1uo8F;
        "pkg-1.15.20" = _gZClwdxY;
        "pkg-1.16.19" = _TPlHrt17;
        "pkg-1.16.20" = _kV5ErsaG;
        "pkg-1.16.21" = _buKLE9ip;
        "pkg-1.16.22" = _ubMP4jhJ;
        "pkg-1.16.23" = _3rcvMXIT;
        "pkg-1.16.24" = _oYFQwlvA;
        "pkg-1.16.25" = _vq7NPdo7;
        "pkg-1.15.21" = _8EwzHQkx;
        "pkg-1.0.10" = _xkI2fZPp;
        "pkg-1.16.26" = _R1Zh2VaO;
        "default" = _R1Zh2VaO;
    });
