...
let
    ...
    in {
        ...
        "pkg-1.0.2+1.21.9" = _HAeoFuyZ;
        "pkg-1.0.2+1.21.10" = _nqqvkSmi;
        "pkg-1.0.3+1.21.10" = _h9PepKWI;
        "pkg-1.0.3+1.21.9" = _FkcHJBDH;
        "pkg-1.0.3+1.21.8" = _GkSucJ95;
        "pkg-1.0.3+1.21.5" = _vlIT7rOY;
        "pkg-1.0.4+1.21.10" = _ywO9vb9w;
        "pkg-1.0.4+1.21.9" = _hit4aDJ0;
        "pkg-1.0.4+1.21.8" = _JJ2VLtuW;
        "pkg-1.0.4+1.21.5" = _9gAFntzw;
        "pkg-1.0.5+1.21.10" = _QJEysqCY;
        "pkg-1.0.5+1.21.9" = _yxO3koYw;
        "pkg-1.0.5+1.21.8" = _Kxa0E7Jc;
        "pkg-1.0.5+1.21.7" = _s9nPKiYy;
        "pkg-1.0.5+1.21.6" = _xfDsKlXu;
        "pkg-1.0.5+1.21.5" = _eOIof8OX;
        "pkg-1.0.6+1.21.10" = _32UY0Ks4;
        "pkg-1.0.6+1.21.9" = _QCSvTuhK;
        "pkg-1.0.6+1.21.8" = _OUki6VsL;
        "pkg-1.0.6+1.21.7" = _cUAiPFoU;
        "pkg-1.0.6+1.21.6" = _9ozE2C5D;
        "pkg-1.0.6+1.21.5" = _Q8DEiXgH;
        "pkg-1.0.7+1.21.10" = _cSpIfcZh;
        "pkg-1.0.7+1.21.9" = _lVqcYvHN;
        "pkg-1.0.7+1.21.8" = _dtzbZeFa;
        "pkg-1.0.7+1.21.7" = _moYGKyO0;
        "pkg-1.0.7+1.21.6" = _5nlE3IVU;
        "pkg-1.0.7+1.21.5" = _sT17Lz7g;
        "pkg-1.0.8+1.21.10" = _DOg9mYa5;
        "pkg-1.0.8+1.21.9" = _bn6HdW8x;
        "pkg-1.0.8+1.21.8" = _I3lydxDL;
        "pkg-1.0.8+1.21.7" = _9YvMH6kp;
        "pkg-1.0.8+1.21.6" = _IroywrHA;
        "pkg-1.0.8+1.21.5" = _ZbkD8Gur;
        "pkg-1.0.8+25w45a" = _9uNioipp;
        "pkg-1.0.8+1.21.4" = _UulQEj29;
        "pkg-1.0.8+1.21.3" = _pPj7Q6kw;
        "pkg-1.0.8+1.21.2" = _6DSCeOBi;
        "pkg-1.0.8+1.21.1" = _ZVFuOixu;
        "pkg-1.0.8+1.21" = _X1b7JW1O;
        "pkg-1.0.9+25w46a" = _L8opyKoJ;
        "pkg-1.0.9+1.21.10" = _5u0un49L;
        "pkg-1.0.9+1.21.9" = _TTlrJoTM;
        "pkg-1.0.9+1.21.8" = _A5YRwMXz;
        "pkg-1.0.9+1.21.7" = _DxOqstWH;
        "pkg-1.0.9+1.21.6" = _ArJYQZQ0;
        "pkg-1.0.9+1.21.5" = _TzPBxEjE;
        "pkg-1.0.10+1.21.5" = _bVgl0sam;
        "pkg-1.0.10+1.21.8" = _qi6qfiaO;
        "pkg-1.0.10+1.21.10" = _2DOPgB4Q;
        "pkg-1.0.10+1.21.11" = _P0l61qjy;
        "pkg-1.0.10+1.21.9" = _Il7wHyOl;
        "pkg-1.0.11+1.21.10" = _kX8UgPBU;
        "pkg-1.1.0+1.21.11" = _B7AZO6D7;
        "pkg-1.1.0+1.21.10" = _v5bQAhJs;
        "pkg-1.1.0+1.21.8" = _2rNprwCK;
        "pkg-1.1.0+1.21" = _le00GV1m;
        "pkg-1.1.1+1.21.8" = _rGrqGbxq;
        "pkg-1.1.1+1.21.10" = _ZJzosl3u;
        "pkg-1.1.1+1.21.11" = _YqnaDSHv;
        "pkg-1.2.0+1.21.10" = _XCFqEWlP;
        "pkg-1.2.0+1.21.11" = _tTACDuxV;
        "pkg-1.2.1+1.21.10" = _QvniO35Y;
        "pkg-1.2.1+1.21.11" = _oMM9uLQV;
        "pkg-1.2.2+1.21.10" = _93MIRzkl;
        "pkg-1.2.2+1.21.11" = _b4WB7Gdu;
        "pkg-1.2.3+1.21.10" = _j1zUEyHm;
        "pkg-1.2.3+1.21.11" = _CStFUEs5;
        "pkg-1.2.4+1.21.10" = _JMlsc1kZ;
        "pkg-1.2.4+1.21.11" = _ziIg7Mrd;
        "pkg-1.3.0+1.21.10" = _iagFBPZM;
        "pkg-1.3.0+1.21.11" = _BS0MrIuW;
        "pkg-1.3.0+26.1" = _hFHd6CxA;
        "pkg-1.3.1+1.21.10" = _62mklIWN;
        "pkg-1.3.1+1.21.11" = _DYtt21DN;
        "pkg-1.3.1+26.1" = _ZKdUs3ZP;
        "pkg-1.3.1+26.1.1" = _5p94wJ7Y;
        "pkg-1.3.2+1.21.10" = _1NMsW0OT;
        "pkg-1.3.2+1.21.11" = _8lx3Sg05;
        "pkg-1.3.2+26.1" = _IFHbPKQa;
        "pkg-1.3.2+26.1.1" = _cLTZvFr4;
        "pkg-1.3.2+26.1.2" = _GEPUdb02;
        "pkg-1.3.3+26.1" = _KadD1wJw;
        "pkg-1.3.4+1.21.10" = _EOq3y7AF;
        "pkg-1.3.4+1.21.11" = _AHoOwTuz;
        "pkg-1.3.4+26.1" = _dr59RSOi;
        "pkg-1.3.4+26.2" = _irMwHDZm;
        "pkg-1.4.0+26.1" = _7Ci3OLPj;
        "pkg-1.4.0+26.2" = _LypBUY8t;
        "pkg-1.4.1+26.1" = _CHIvQdG6;
        "pkg-1.4.1+26.2" = _FdzlhDdb;
        "pkg-1.4.1+26.3" = _aDyzFUtB;
        "pkg-1.4.1+1.21.1" = _imrHm090;
