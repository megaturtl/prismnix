...
let
    versions = (let
        ...
        _qxi1qGon = {
            "id" = "qxi1qGon";
            "file" = "Call-Your-Horse-v2.1.3.zip";
            "hash" = "sha512-v4E4PWr9+UUzYCf7UR6vHvS8TpU6L3ZXDdf5EuUirgAwEGUiHkC9Tjgq4ZGLnaYIQ+DGO5xILY2SmpjfrFhgaA==";
        };
        _nP1o6kVd = {
            "id" = "nP1o6kVd";
    ...
    in {
        ...
        "datapack-1.21.6" = _qxi1qGon;
        "datapack-1.21.7" = _qxi1qGon;
        "datapack-1.21.8" = _qxi1qGon;
        "datapack-1.21.9" = _qxi1qGon;
        "datapack-1.21.10" = _qxi1qGon;
        "datapack-1.21.11" = _qxi1qGon;
        "datapack-26.1" = _qxi1qGon;
        ...
        "fabric-1.21.6" = _nP1o6kVd;
        "fabric-1.21.7" = _nP1o6kVd;
        "fabric-1.21.8" = _nP1o6kVd;
        "fabric-1.21.9" = _nP1o6kVd;
        "fabric-1.21.10" = _nP1o6kVd;
        "fabric-1.21.11" = _nP1o6kVd;
        "fabric-26.1" = _nP1o6kVd;
        ...
        "forge-1.21.6" = _nP1o6kVd;
        "forge-1.21.7" = _nP1o6kVd;
        "forge-1.21.8" = _nP1o6kVd;
        "forge-1.21.9" = _nP1o6kVd;
        "forge-1.21.10" = _nP1o6kVd;
        "forge-1.21.11" = _nP1o6kVd;
        "forge-26.1" = _nP1o6kVd;
        ...
        "neoforge-1.21.6" = _nP1o6kVd;
        "neoforge-1.21.7" = _nP1o6kVd;
        "neoforge-1.21.8" = _nP1o6kVd;
        "neoforge-1.21.9" = _nP1o6kVd;
        "neoforge-1.21.10" = _nP1o6kVd;
        "neoforge-1.21.11" = _nP1o6kVd;
        "neoforge-26.1" = _nP1o6kVd;
        ...
        "quilt-1.21.6" = _nP1o6kVd;
        "quilt-1.21.7" = _nP1o6kVd;
        "quilt-1.21.8" = _nP1o6kVd;
        "quilt-1.21.9" = _nP1o6kVd;
        "quilt-1.21.10" = _nP1o6kVd;
        "quilt-1.21.11" = _nP1o6kVd;
        "quilt-26.1" = _nP1o6kVd;
        ...
        "pkg-v.1.1.1+mod" = _uezhHWfm;
        "pkg-v.1.1.2" = _Qs2mlo67;
        "pkg-v.1.1.2+mod" = _lLbkjjd9;
        "pkg-v.1.1.3" = _k6FWesWf;
        "pkg-v.1.1.3+mod" = _KMA7HjcR;
        "pkg-v.1.2.3" = _UiPVV9JQ;
        "pkg-v.1.2.3+mod" = _7yHpnCIe;
        "pkg-1.2.4" = _OuVWWLC5;
        "pkg-1.2.4+mod" = _uKs4yoPz;
        "pkg-v.1.2.5" = _qjLNVpdo;
        "pkg-v.1.2.5+mod" = _k5YGFHil;
        "pkg-v.1.2.6" = _LagkEyzr;
        "pkg-v.1.2.6+mod" = _9GWSIIkn;
        "pkg-v.1.2.7" = _C1emR2zC;
        "pkg-v.1.2.7+mod" = _U6EBYHBV;
        "pkg-1.2.8" = _t6iiUe6u;
        "pkg-1.2.8+mod" = _jw2zeVaH;
        "pkg-v.1.2.8" = _GM4VD3aA;
        "pkg-v.1.2.8+mod" = _Yzr9QfsV;
        "pkg-v.1.2.9" = _irem02h7;
        "pkg-v.1.2.9+mod" = _aSdCxi2m;
        "pkg-v.1.2.10" = _QVRjm0Ey;
        "pkg-v.1.2.10+mod" = _BGoe1TdF;
        "pkg-v.1.2.11" = _aDGqTwFr;
        "pkg-v.1.2.11+mod" = _EorwdSFb;
        "pkg-v.1.3.11" = _lBVbuhdg;
        "pkg-v.1.3.11+mod" = _zGibNM7f;
        "pkg-v.1.3.10" = _khmETIC9;
        "pkg-v.1.3.10+mod" = _2CscQkFN;
        "pkg-v1.3.12" = _S65fGN1r;
        "pkg-v1.3.12+mod" = _4yWmRAmm;
        "pkg-v1.3.11" = _7WkvBNJq;
        "pkg-v1.3.11+mod" = _8McTlamo;
        "pkg-v.1.3.13" = _zimxr9x4;
        "pkg-v.1.3.13+mod" = _Jb3nlL1r;
        "pkg-v1.3.13" = _SpH4S7uF;
        "pkg-v1.3.13+mod" = _TUatidlF;
        "pkg-v1.3.14" = _OdUWEgzb;
        "pkg-v1.3.14+mod" = _QtI3wamv;
        "pkg-v1.3.15" = _N8Y4Etjr;
        "pkg-v1.3.15+mod" = _12nBf4L4;
        "pkg-v1.4.15" = _LbMX0Zv2;
        "pkg-v1.4.15+mod" = _wxf3TlLV;
        "pkg-v1.4.16" = _j8NEwyOy;
        "pkg-v1.4.16+mod" = _oehvlUW1;
        "pkg-v1.4.17" = _iiz4N7FF;
        "pkg-v1.4.17+mod" = _CrzX1Yx6;
        "pkg-v1.5.0" = _UuJtTCsn;
        "pkg-v1.5.0+mod" = _nR4GXxib;
        "pkg-v1.5.1" = _T8P52vYv;
        "pkg-v1.5.1+mod" = _CEQLSOvR;
        "pkg-v1.5.2" = _Ev1m1pCq;
        "pkg-v1.5.2+mod" = _zenrk7LM;
        "pkg-v1.6.2" = _WC39YbO3;
        "pkg-v1.6.2+mod" = _CNnSy68y;
        "pkg-v1.6.3" = _PTA0Qtnx;
        "pkg-v1.6.3+mod" = _qnggFYW3;
        "pkg-v1.6.4" = _wIHdT1ql;
        "pkg-v1.6.4+mod" = _tfAUOt0i;
        "pkg-2.0.0" = _Y0GS1gQc;
        "pkg-2.0.0+mod" = _j1Gg45VI;
        "pkg-v2.0.1" = _dFJCsdx5;
        "pkg-v2.0.1+mod" = _LATM4tKD;
        "pkg-v2.0.2" = _ixmFlxNk;
        "pkg-v2.0.2+mod" = _vt4HyxJt;
        "pkg-v2.0.3" = _xk0KaEcM;
        "pkg-v2.0.3+mod" = _LzVC95xL;
        "pkg-v2.1.0" = _ynXyo2JO;
        "pkg-v2.1.0+mod" = _PGn9wRWU;
        "pkg-v2.1.1" = _GgIlNSqf;
        "pkg-v2.1.1+mod" = _JSEC1u3b;
        "pkg-v2.1.2" = _JP2AZEX0;
