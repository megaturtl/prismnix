...
let
    versions = (let
        ...
        _rxFmYTxd = {
            "id" = "rxFmYTxd";
            "file" = "lootr-neoforge-1.21.1-1.11.38.123.jar";
            "hash" = "sha512-w0lQ+VpzeZyCscIU9vAZ5TJ5D0ViKBHB3s62bW5iL22667WnfDrJQvX8y+Sk5jNY+X0xirBEHvZgBkS8N7uIeg==";
        };
        _VYbLUFAk = {
            "id" = "VYbLUFAk";
            "file" = "lootr-fabric-1.21.1-1.11.38.123.jar";
            "hash" = "sha512-z2MV9oRzYdLWycAMu4JnPMfOkWz7uJcAy2S8zvtyaImhNcDnKClMCbcEX2ERqT18dj1fu145/wXke4LUTa3OPw==";
        };
        _Trh49IZt = {
            "id" = "Trh49IZt";
            "file" = "lootr-neoforge-1.21.1-1.11.38.124.jar";
            "hash" = "sha512-tCUiX0FuGBAUbq4s3a8XgEJ1biGiQB8zcE3N6ECbFtshuH+BEhquli1iub2U0ieos5PaNSsE/by8XvV13OE8hg==";
        };
        _rNCVo4w9 = {
            "id" = "rNCVo4w9";
            "file" = "lootr-fabric-1.21.1-1.11.38.124.jar";
            "hash" = "sha512-E7MtzJElO0Jg92fJ2kTbUHX//rHhP9E4LtkAxzdWC96aKgn5DVVXvavJhfl3MRfi1CW68b2Ib6V/0bodLuS2iA==";
        };
        _ST5FHZnD = {
            "id" = "ST5FHZnD";
            "file" = "lootr-neoforge-1.21.1-1.11.38.125.jar";
    ...
    in {
        ...
        "pkg-1.16.4-0.0.4.12" = _HZhV0uLB;
        "pkg-1.16.4-0.0.4.13" = _Dq0BT3nP;
        "pkg-1.16.4-0.0.4.14" = _Kj8uTgJ8;
        "pkg-1.16.4-0.0.4.15" = _ggD5F5BX;
        "pkg-1.16.4-0.0.4.16" = _vkhWyUdu;
        "pkg-1.16.4-0.0.5.17" = _wibDICI4;
        "pkg-0.0.6.18" = _24tgcR2s;
        "pkg-0.0.8.23" = _Ttm5aIOf;
        "pkg-0.0.9.25" = _SujxHsoz;
        "pkg-0.0.8.25" = _iqcgixZK;
        "pkg-0.0.9.26" = _LDzX00Qx;
        "pkg-0.0.9.27" = _eBX1BZNw;
        "pkg-0.0.10.29" = _pxsO95ij;
        "pkg-0.0.11.30" = _TAjWjuTe;
        "pkg-0.0.9.30" = _jsX7sWTq;
        "pkg-0.0.10.30" = _RqaDqmzo;
        "pkg-0.0.11.34" = _OkpjCHFn;
        "pkg-0.0.9.31" = _GGPFTO8b;
        "pkg-0.0.10.31" = _zemwxYHC;
        "pkg-0.0.12.35" = _Cs7CwkS2;
        "pkg-0.0.12.36" = _AQ8Ij2oh;
        "pkg-0.1.11.35-experimental" = _COgS7YcJ;
        "pkg-0.0.12.38" = _AXCIRMD3;
        "pkg-0.1.13.41" = _sH3WPKdA;
        "pkg-0.1.14.42" = _nAPBEYtG;
        "pkg-0.1.14.43" = _cnGuYyNw;
        "pkg-0.1.14.45" = _OzsHdl8y;
        "pkg-0.1.14.48" = _MQpW3ZD3;
        "pkg-0.1.11.37" = _A5bpU5uF;
        "pkg-0.1.15.49" = _Usnckthu;
        "pkg-0.2.16.50" = _O0FpP277;
        "pkg-0.1.15.50" = _kv2XN0ol;
        "pkg-0.1.12.40" = _7pATUOgJ;
        "pkg-0.1.12.41" = _JCCAiqfI;
        "pkg-0.1.12.42" = _gFBbmSNA;
        "pkg-0.3.17.53" = _YOKz1G1u;
        "pkg-0.3.18.54" = _dE8IkeO0;
        "pkg-0.2.16.52" = _D2SKFRUo;
        "pkg-0.1.15.51" = _1sYZgHdo;
        "pkg-0.3.19.55" = _o5AQrjso;
        "pkg-0.3.19.56" = _RpVcS6gv;
        "pkg-0.1.12.43" = _pv9IYtTX;
        "pkg-0.2.16.53" = _bsB2Bhke;
        "pkg-0.1.15.52" = _9aFmIpdl;
        "pkg-0.3.20.57" = _l2Z3kDcn;
        "pkg-0.2.17.54" = _PkuuCgbI;
        "pkg-0.1.16.53" = _aPMtmY4k;
        "pkg-0.3.18.55" = _gA1UZbVU;
        "pkg-0.3.20.58" = _RXVA6nvn;
        "pkg-0.1.1" = _zQLmjua5;
        "pkg-0.1.2" = _F3BGqBeG;
        "pkg-0.1.3" = _RcJRtlBN;
        "pkg-0.2.0" = _m5Lfrk8g;
        ...
        "pkg-0.3.1" = _Kn5H1bPr;
        "pkg-0.3.2" = _udwITG0N;
        "pkg-0.3.20.59" = _eK0l8zNI;
        "pkg-0.2.18.55" = _Bn7gYC9y;
        "pkg-0.1.17.54" = _6TJlrDOW;
        "pkg-0.3.21.58" = _8IfojkDx;
        "pkg-0.4.0" = _wqwIRe9A;
        "pkg-0.4.2" = _Q1a0yiV3;
        "pkg-0.1.19.56" = _w498KlYa;
        "pkg-0.2.19.56" = _gZbWrwLq;
        "pkg-0.3.22.59" = _9gFC1Jeg;
        "pkg-0.4.21.60" = _R4r4VPEO;
        "pkg-0.1.13.44" = _RaPrebEc;
        "pkg-0.4.3" = _wIVtg70v;
        "pkg-0.3.23.60" = _tbdNw4Eb;
        "pkg-0.4.22.61" = _6LzmXoyN;
        "pkg-0.4.4" = _A4LNZnuZ;
        "pkg-0.2.20.57" = _8wNSMI6H;
        "pkg-0.1.20.57" = _QGiSpaeW;
        "pkg-0.2.21.58" = _8C4kR9aX;
        "pkg-0.5.0" = _vgR61BI9;
        "pkg-0.5.1" = _NIdatVTU;
        "pkg-0.4.24.63" = _Wzhg7dWk;
        "pkg-0.4.25.64" = _YNEiWK4Q;
        "pkg-0.3.24.61" = _4ZRRqE4b;
        "pkg-0.4.25.65" = _YJpiKNBl;
        "pkg-0.4.23.60" = _shUI972d;
        "pkg-0.4.24.61" = _VoHwhPHg;
        "pkg-0.2.23.60" = _5k9iUxGP;
        "pkg-0.1.15.46" = _3chnbfTW;
        "pkg-0.6.26.63" = _VrIELWcF;
        "pkg-0.6.0" = _3KG4z4rQ;
        "pkg-0.5.26.66" = _ygyDYKuW;
        "pkg-0.4.26.66" = _Vy6RXZdZ;
        "pkg-0.6.1" = _5XTTx0zK;
        "pkg-0.4.26.65" = _SWVUZnep;
        "pkg-0.5.27.67" = _v69my7kG;
        "pkg-0.6.27.67" = _su49HTrf;
        "pkg-0.3.25.62" = _MlXVvpW5;
        "pkg-0.5.25.62" = _9GYZmH6J;
        "pkg-0.7.28.65" = _HrKp5GtJ;
        "pkg-0.7.28.66" = _FQDSmiBX;
        "pkg-0.7.28.67" = _7Nv5b9z9;
        "pkg-0.3.26.63" = _A8u3YoWj;
        "pkg-0.3.27.64" = _fjXUH5Yd;
        "pkg-0.4.27.66" = _DBh3YVaT;
        "pkg-0.5.29.69" = _BFQ9WKSI;
        "pkg-0.6.28.68" = _T0SqCwwe;
        "pkg-0.7.29.69" = _3d5qsxQO;
        "pkg-0.7.29.70" = _Ju6CJ424;
        "pkg-0.3.28.65" = _w2hEo5la;
        "pkg-0.4.27.67" = _94g9xhhk;
        "pkg-0.5.29.70" = _pFr53NCP;
        "pkg-0.6.28.69" = _vswD4Si0;
        "pkg-0.7.29.71" = _wWcrgZwH;
        "pkg-0.7.29.68" = _DtZL7OFm;
        "pkg-0.7.29.72" = _UC6eKCSW;
        "pkg-0.7.29.73" = _tT9BtJDq;
        "pkg-0.7.29.74" = _kYj03jR6;
        "pkg-0.7.29.75" = _uBdAr7AK;
        "pkg-0.6.2" = _fTrJqmfv;
        "pkg-0.3.25.64" = _qtr43F7N;
        "pkg-0.8.31.74" = _oENq02ZK;
        "pkg-0.7.31.76" = _GWUFGkel;
        "pkg-0.3.26.66" = _fMLzuvh6;
        "pkg-0.4.25.67" = _WgGe8bIQ;
        "pkg-0.7.31.77" = _O0tDMmkr;
        "pkg-0.4.28.68" = _C4OieRQF;
        "pkg-0.7.30.77" = _RJksbmWs;
        "pkg-0.8.31.78" = _xuoeOnYI;
        "pkg-0.7.33.81" = _fqmzdpE2;
        "pkg-0.7.33.82" = _FJZ5eToG;
        "pkg-0.2.19.51" = _msdGS3NS;
        "pkg-0.4.28.69" = _hxumeI6f;
        "pkg-0.4.26.69" = _xtOKEujd;
        "pkg-0.3.28.70" = _W1iHprsE;
        "pkg-0.7.34.85" = _ZqSHctHT;
        "pkg-1.10.33.77" = _L9f6lWhR;
        "pkg-1.10.33.78" = _4bMmbZZC;
        "pkg-1.10.33.79" = _o70Rz34Z;
        "pkg-1.10.33.80" = _GJigWpSl;
        "pkg-1.10.33.81" = _sUGbf4Ti;
        "pkg-1.10.33.82" = _NvZmsH3h;
        "pkg-1.10.33.84" = _qghgMj7F;
        "pkg-1.10.33.85" = _xTBk9prn;
        "pkg-1.10.34.86" = _jXjew0q3;
        "pkg-1.11.35.87" = _BOekLUYi;
        "pkg-0.7.35.90" = _uZTpIy1Z;
        "pkg-0.7.35.85" = _udi9KR9R;
        "pkg-0.4.28.75" = _6ULhni05;
        "pkg-0.4.29.71" = _hYidm9fp;
        "pkg-0.3.30.73" = _T2ZpJMhE;
        "pkg-0.4.29.72" = _7WyuvACZ;
        "pkg-1.12.36.88" = _UlwRNO00;
        "pkg-1.10.34.87" = _H5EPsZu0;
        "pkg-1.10.34.88" = _B7dOgXae;
        "pkg-1.12.36.89" = _acdAWo4M;
        "pkg-1.10.35.89" = _krx35dPx;
        "pkg-1.10.35.90" = _HJSOQTLl;
        "pkg-1.10.35.91" = _QMRmPuOh;
        "pkg-1.13.36.89" = _Z0vjfoTl;
        "pkg-neoforge-1.21.5-1.14.37.90" = _wIAB4KJ7;
        "pkg-fabric-1.21.5-1.14.37.90" = _m3pwr6uC;
        "pkg-neoforge-1.21.5-1.14.37.91" = _P0Sp6W0c;
        "pkg-fabric-1.21.5-1.14.37.91" = _Fm2A0Un3;
        "pkg-neoforge-1.21.5-1.14.37.92" = _vtWeCzfY;
        "pkg-fabric-1.21.5-1.14.37.92" = _cajLESkB;
        "pkg-neoforge-1.21.7-1.15.38.94" = _JqozAadU;
        "pkg-fabric-1.21.7-1.15.38.94" = _YWFcEVur;
        "pkg-0.7.35.91" = _HmhkyU8X;
        "pkg-neoforge-1.21.8-1.16.39.95" = _DoS3C2Zj;
        "pkg-fabric-1.21.8-1.16.39.95" = _5T0cn166;
        "pkg-neoforge-1.21.6-1.16.39.96" = _Qm7WVT01;
        "pkg-fabric-1.21.6-1.16.39.96" = _4pScWAE7;
        "pkg-0.7.35.92" = _pvIQeqjt;
        "pkg-neoforge-1.21.9-1.17.30.96" = _n3x5DyBz;
        "pkg-fabric-1.21.9-1.17.30.96" = _T2K9YC05;
        "pkg-neoforge-1.21.10-1.18.31.97" = _ODNNZYLl;
        "pkg-fabric-1.21.10-1.18.31.97" = _oRCHw17p;
        "pkg-neoforge-1.21.9-1.17.30.97" = _vDiGKIJh;
        "pkg-fabric-1.21.9-1.17.30.97" = _G4OrKaj2;
        "pkg-neoforge-1.21.10-1.18.31.98" = _992izwqn;
        "pkg-fabric-1.21.10-1.18.31.98" = _x4VxA6Eb;
        "pkg-1.10.35.92" = _lkMXFjGb;
        "pkg-0.7.35.94" = _mWTXC1ZX;
        "pkg-0.7.35.86" = _nj1zDLc6;
        "pkg-0.3.30.74" = _LQP5jrCT;
        "pkg-1.10.35.94" = _o6vsUEzV;
        "pkg-1.10.35.95" = _98v7aziC;
        "pkg-1.10.35.96" = _OzMefC2m;
        "pkg-1.10.35.99" = _cOrO8AXN;
        "pkg-1.21.1-1.11.36.100" = _KhdeMfbQ;
        "pkg-1.21.5-1.14.38.93" = _C5cP6if7;
        "pkg-1.21.6-1.16.40.97" = _tNxLeJ6M;
        "pkg-1.21.8-1.16.40.96" = _KCO39N1z;
        "pkg-1.21.9-1.17.31.98" = _67HkQPZn;
        "pkg-1.21.10-1.18.32.99" = _tBqlJU85;
        "pkg-1.21.1-1.11.36.101" = _YcFSlTQX;
        "pkg-1.21.1-1.11.36.103" = _ZsCHWaSx;
        "pkg-1.21.1-1.11.36.104" = _CKbDfGM7;
        "pkg-1.21.11-1.19.33.100" = _NKsNpTwe;
        "pkg-1.21.1-1.11.36.105" = _Tqumqmiq;
        "pkg-1.21.1-1.11.36.106" = _FVVsp5BE;
        "pkg-1.21.1-1.11.36.107" = _JZI10S7H;
        "pkg-1.21.1-1.11.36.108" = _mhb70wbl;
        "pkg-1.21.1-1.11.36.109" = _NB9O4UOT;
        "pkg-1.21.1-1.11.36.110" = _Bgmr50HI;
        "pkg-1.21.1-1.11.36.111" = _C9cw5EPa;
        "pkg-1.21.1-1.11.36.113" = _l8X2hPPr;
        "pkg-1.21.1-1.11.36.114" = _SEy2jzxJ;
        "pkg-1.21.11-1.20.34.101" = _YGHOIQfA;
        "pkg-1.21.1-1.11.36.115" = _rE51S2Uo;
        "pkg-1.21.1-1.11.36.116" = _QiYtX8gp;
        "pkg-1.21.1-1.11.36.117" = _MGjhLduX;
        "pkg-1.21.1-1.11.37.118" = _Rxyok2IC;
        "pkg-1.21.35.102" = _NbE5Oots;
        "pkg-1.21.35.103" = _s0EnSZFB;
        "pkg-1.21.35.104" = _lbM1KKV4;
        "pkg-1.21.35.105" = _6oOC8H3O;
        "pkg-1.21.35.106" = _vXoVbinO;
        "pkg-1.22.36.108" = _tqyRpJg6;
        "pkg-1.21.11-1.20.34.102" = _70TrpJbc;
        "pkg-1.21.11-1.20.34.103" = _YAzjYgCP;
        "pkg-1.22.36.109" = _ig04GPJH;
        "pkg-1.21.1-1.11.37.119" = _aZYQOAfj;
        "pkg-1.21.11-1.20.34.104" = _efKMR8nl;
        "pkg-1.21.1-1.11.37.120" = _SojdASBz;
        "pkg-1.22.36.110" = _9y9XDwls;
        "pkg-1.22.37.111" = _w6Bv4rMG;
        "pkg-1.23.38.112" = _aZZ8icRb;
        "pkg-1.22.37.112" = _axsdiCit;
        "pkg-1.23.38.113" = _OpOpu4vW;
        "pkg-1.22.37.113" = _aNlujRKH;
        "pkg-1.23.38.114" = _CADyHY41;
        "pkg-1.21.1-1.11.37.121" = _eYyx60ld;
        "pkg-1.24.39.115" = _2mzu9QvQ;
        "pkg-1.24.39.116" = _UKlJEgXS;
        "pkg-1.23.38.115" = _ZTAAUmYQ;
        "pkg-1.23.38.116" = _AUAmJ0U9;
        "pkg-1.24.39.117" = _rLHJ7MDb;
        "pkg-1.23.38.117" = _kDUmREOC;
        "pkg-1.24.39.118" = _6aAxKwLC;
        "pkg-1.24.39.119" = _qsXGwHpo;
        "pkg-1.23.38.118" = _v3bIij0K;
        "pkg-1.21.1-1.11.37.122" = _uapIrG9e;
        "pkg-1.23.38.119" = _CED2liyl;
        "pkg-1.24.39.120" = _bxJH3M69;
        "pkg-1.23.38.120" = _m1PLActz;
        "pkg-1.24.39.121" = _k00AgeE7;
