...
let
    ...
    in {
        ...
        "pkg-1.17.1-2.0.18" = _2MZhAEkk;
        "pkg-1.17.1-2.0.19" = _6bd1LZfJ;
        "pkg-1.17.1-2.0.20" = _zoCOuiv2;
        "pkg-1.17.1-2.0.21" = _xAdKjPAd;
        "pkg-1.17.1-2.0.22" = _njY60bix;
        "pkg-1.17.1-2.0.23" = _vi90qDjT;
        "pkg-1.17.1-2.0.24" = _vRRHqgFT;
        "pkg-1.17.1-2.0.25" = _5gxolyTf;
        "pkg-1.17.1-2.0.26" = _Jp9Fd00M;
        "pkg-1.17.1-2.0.27" = _adgGl94L;
        "pkg-1.17.1-2.0.28" = _qJzNRHpw;
        "pkg-1.17.1-2.0.29" = _KElTvsMc;
        "pkg-1.17.1-2.0.30" = _49VAsoxd;
        "pkg-1.17.1-2.0.31" = _A1kjyIY5;
        "pkg-1.17.1-2.0.32" = _IFA82Fvg;
        "pkg-1.18.1-3.0.2" = _e2OXVRPm;
        "pkg-1.18.1-3.0.3" = _NUpyLUd1;
        "pkg-1.18.1-3.1.0" = _LCTf9uBz;
        "pkg-1.18.1-3.1.1" = _Zg5FLLJ6;
        "pkg-1.18.1-3.1.2" = _S7I0lJZ6;
        "pkg-1.18.1-3.1.3" = _RfHwZYpb;
        "pkg-1.18.1-3.2.0" = _gocN8fnc;
        "pkg-1.18.1-3.2.1" = _27EPA3iR;
        "pkg-1.18.1-3.2.2" = _vircYbhq;
        "pkg-1.18.1-3.2.4" = _RTZgASoh;
        "pkg-1.17.1-2.0.33" = _VyPRYeI1;
        "pkg-1.18.1-3.2.5" = _FRqHYSWk;
        "pkg-1.18.1-3.2.6" = _tN9OLaxb;
        "pkg-1.18.1-3.2.7" = _Pv35FwzH;
        "pkg-1.18.1-3.2.8" = _Ms196qrj;
        "pkg-1.18.1-3.2.9" = _vSVNkl33;
        "pkg-1.18.2-3.3.1" = _LdzqdL8F;
        "pkg-1.18.2-3.3.2" = _mpNMMHMd;
        "pkg-1.18.2-3.3.3" = _mXiSkXPT;
        "pkg-1.18.2-3.3.4" = _plAgyUte;
        "pkg-1.16.4-1.6.14" = _Cn8GWioA;
        "pkg-1.18.2-3.3.5" = _2T3GJgS7;
        "pkg-1.18.2-3.3.6" = _3SJJpYqU;
        "pkg-1.18.2-3.3.7" = _8baKQLs3;
        "pkg-1.18.2-3.3.8" = _O530QA7w;
        "pkg-1.18.2-3.3.9" = _nuPDZijG;
        "pkg-1.18.2-3.3.10" = _heSY3L7P;
        "pkg-1.18.2-3.3.11" = _td6WNciF;
        "pkg-1.18.2-3.3.12" = _6wWHoP67;
        "pkg-1.19-4.0.0" = _jKYiw508;
        "pkg-1.17.1-2.0.34" = _7Uc1DFMl;
        "pkg-1.19-4.0.1" = _7ducH73z;
        "pkg-1.18.2-3.3.13" = _TcC9nSFA;
        "pkg-1.19-4.0.2" = _FstQrwa7;
        "pkg-1.19-4.0.3" = _VLKioh07;
        "pkg-1.18.2-3.3.14" = _vC4y9QvJ;
        "pkg-1.19-4.0.4" = _mm3FLpqK;
        "pkg-1.18.2-3.3.15" = _qNwTD176;
        "pkg-1.18.2-3.3.16" = _e9Gb3B2N;
        "pkg-1.19-4.0.5" = _OyraCwWU;
        "pkg-1.19-4.0.6" = _wj0Awaio;
        "pkg-1.18.2-3.3.17" = _3hv5SdMg;
        "pkg-1.19-4.0.7" = _eB7k15PX;
        "pkg-1.18.2-3.3.18" = _fF6dl2cW;
        "pkg-1.19-4.0.8" = _tTqvmmDr;
        "pkg-1.19-4.0.9" = _1aP9VTuH;
        "pkg-1.19-4.0.10" = _HGsluzl1;
        "pkg-1.18.2-3.3.19" = _Df2QuGbE;
        "pkg-1.18.2-3.3.20" = _VTwvmcO7;
        "pkg-1.19-4.0.11" = _OkZcKyP2;
        "pkg-1.19-4.0.12" = _LSr1ZLX0;
        "pkg-1.19-4.0.13" = _5mBWAQ4D;
        "pkg-1.18.2-3.3.21" = _tMdbtv55;
        "pkg-1.19-4.0.14" = _RSuZADF0;
        "pkg-1.18.2-3.3.22" = _OcwEFXzv;
        "pkg-1.19-4.0.15" = _sI5emn6F;
        "pkg-1.18.2-3.3.23" = _renywnzQ;
        "pkg-1.19-4.0.16" = _gjRgvDVh;
        "pkg-1.18.2-3.3.24" = _R7Wtyka7;
        "pkg-1.19-4.0.17" = _CSGDGuYG;
        "pkg-1.19-4.0.18" = _m4tEa9qd;
        "pkg-1.19-4.0.19" = _FEtXlR21;
        "pkg-1.19.1-4.1.0" = _mEXt47CC;
        "pkg-1.18.2-3.3.25" = _Vvhv9KtS;
        "pkg-1.19.1-4.1.1" = _dbo0c7Zr;
        "pkg-1.19.1-4.1.2" = _My4weWJH;
        "pkg-1.19.2-4.2.0" = _e4eYjBlP;
        "pkg-1.19.2-4.2.1" = _eu5pK7RY;
        "pkg-1.19.2-4.2.2" = _MoaUMhpO;
        "pkg-1.19.2-4.2.3" = _pKkrhD25;
        "pkg-1.18.2-3.3.26" = _B7hMbTVG;
        "pkg-1.19.2-4.2.4" = _bWxImEiu;
        "pkg-1.19.2-4.2.5" = _h0f8Lvew;
        "pkg-1.18.2-3.3.27" = _r8H8h43Y;
        "pkg-1.18.2-3.3.28" = _vuLoWjab;
        "pkg-1.19.2-4.2.6" = _wdVidLTo;
        "pkg-1.18.2-3.3.29" = _LiuACOY1;
        "pkg-1.18.2-3.3.30" = _2FKorFHT;
        "pkg-1.19.2-4.2.7" = _DXTBDOLR;
        "pkg-1.19.2-4.2.8" = _j5iAPp8h;
        "pkg-1.18.2-3.3.31" = _vU7XfMml;
        "pkg-1.19.2-4.2.9" = _D4RHLJtH;
        "pkg-1.19.2-4.2.10" = _C5V7dWU6;
        "pkg-1.19.2-4.2.11" = _7qRD0YMF;
        "pkg-1.19.2-4.2.12" = _zwHXWrCo;
        "pkg-1.19.2-4.2.13" = _96mJ5e2r;
        "pkg-1.19.2-4.2.14" = _v3iU7TcF;
        "pkg-1.20.1-5.0.0" = _ZT3cvRpQ;
        "pkg-1.20.1-5.0.1" = _UAQUAMT3;
        "pkg-1.20.1-5.0.2" = _WF7YeNm6;
        "pkg-1.20.1-5.0.3" = _iZkY3d7p;
        "pkg-1.19.2-4.2.15" = _QJZNU51q;
        "pkg-1.20.1-5.0.4" = _247jfWog;
        "pkg-1.20.1-5.0.5" = _lw8bccoN;
        "pkg-1.20.1-5.0.6" = _c4c2t6no;
        "pkg-1.20.1-5.0.7" = _pFMFpynY;
        "pkg-1.20.1-5.0.8" = _bIUuGBE5;
        "pkg-1.18.2-3.3.32" = _kvOR2SGq;
        "pkg-1.19.2-4.2.16" = _oxO3xIG5;
        "pkg-1.20.1-5.0.9" = _XvRaUGfZ;
        "pkg-1.18.2-3.3.33" = _PFU4TaEy;
        "pkg-1.19.2-4.2.17" = _XJK9d97L;
        "pkg-1.20.1-5.0.10" = _sr4ei535;
        "pkg-1.20.1-5.0.11" = _ExAvbgJ4;
        "pkg-1.20.1-5.0.12" = _UjhHufEf;
        "pkg-1.19.2-4.2.18" = _3UMUwSbF;
        "pkg-1.19.2-4.2.19" = _KHX4D9hP;
        "pkg-1.20.1-5.0.13" = _cWa6uf7C;
        "pkg-1.19.2-4.2.20" = _kObHX29V;
        "pkg-1.20.1-5.0.14" = _Cxz4wPWt;
        "pkg-1.19.2-4.2.21" = _zoJXJCLj;
        "pkg-1.20.1-5.0.15" = _gJEnQFms;
        "pkg-1.20.1-5.0.16" = _fUFGYCVG;
        "pkg-1.20.1-5.0.17" = _jdAWTseY;
        "pkg-1.20.1-5.0.18" = _z7F7GUzJ;
        "pkg-1.20.1-5.0.19" = _qDDF2Mjb;
        "pkg-1.20.1-5.0.20" = _uDm0KQ5r;
        "pkg-1.20.1-5.0.21" = _UGyLQ46R;
        "pkg-1.20.1-5.1.0" = _HGO1m4t5;
        "pkg-1.20.1-5.1.1" = _Z1FOlXTb;
        "pkg-1.20.1-5.1.2" = _LydeZ5SA;
        "pkg-1.20.1-5.1.3" = _bOmkWrM3;
        "pkg-1.20.1-5.1.4" = _IqEp8abP;
        "pkg-1.19.2-4.2.22" = _NzOutOwd;
        "pkg-1.20.1-5.1.5" = _Kn99Aup1;
        "pkg-1.20.1-5.1.6" = _Ga5DwoCj;
        "pkg-1.20.1-5.1.7" = _zsqP6cr9;
        "pkg-1.20.1-5.1.8" = _dM5jHkcK;
        "pkg-1.20.1-5.1.9" = _fsumNeNL;
        "pkg-1.20.1-5.1.10" = _T7IYXkl6;
        "pkg-1.20.1-5.1.11" = _NT7NLXin;
        "pkg-1.20.1-5.1.12" = _MFFhGSEk;
        "pkg-1.20.1-5.1.13" = _hJv0gAuv;
        "pkg-1.20.1-5.1.14" = _VWihS11c;
        "pkg-1.20.1-5.1.15" = _bi9tuxXv;
        "pkg-1.20.1-5.1.16" = _afVts0ej;
        "pkg-1.20.1-5.1.17" = _fED5jQkF;
        "pkg-1.20.1-5.1.18" = _BlkBFEpe;
        "pkg-1.20.1-5.1.19" = _qHEITJhT;
        "pkg-1.20.1-5.1.20" = _v2L6SFLu;
        "pkg-1.19.2-4.2.23" = _YtjyUTaV;
        "pkg-1.20.1-5.1.21" = _wRdY3NbN;
        "pkg-1.20.1-5.1.22" = _N6koHpgd;
        "pkg-1.20.1-5.1.23" = _ty9rFUZr;
        "pkg-1.20.1-5.1.24" = _JSBOxI07;
        "pkg-1.19.2-4.2.24" = _4OSeAw8H;
        "pkg-21.1.0" = _7DAkfdli;
        "pkg-21.1.1" = _FCwgNZrg;
        "pkg-21.1.2" = _Bq2SDaap;
        "pkg-21.1.3" = _1cFEpvm5;
        "pkg-21.1.4" = _N48x90y0;
        "pkg-1.20.1-5.1.25" = _56dTNWoi;
        "pkg-21.1.5" = _GlsWEMLE;
        "pkg-21.1.6" = _MUFswQ5M;
        "pkg-21.1.7" = _3c62uK9f;
        "pkg-21.1.8" = _LnI9fjRV;
        "pkg-21.1.9" = _DEuGjm6V;
        "pkg-21.1.10" = _E7jTyIS3;
        "pkg-21.1.11" = _xRqIPexo;
        "pkg-21.1.12" = _lazIsLM3;
        "pkg-21.1.13" = _8lWpNPxa;
        "pkg-21.1.14" = _fxCb8IQ3;
        "pkg-1.20.1-5.1.26" = _Ct53G4OK;
        "pkg-21.1.15" = _obsLXoSI;
        "pkg-21.1.16" = _7fw7fCe9;
        "pkg-1.20.1-5.1.27" = _wFI0utsu;
        "pkg-21.1.17" = _oh0L19w0;
        "pkg-21.1.18" = _pJZ0Djn4;
        "pkg-21.1.19" = _rnxPbbSO;
        "pkg-1.20.1-5.1.28" = _DHc1A6v8;
        "pkg-21.1.20" = _Qw18mGaH;
        "pkg-21.1.21" = _8R37lIaN;
        "pkg-21.1.22" = _OU2fqSZJ;
        "pkg-21.1.23" = _yPRUsfYr;
        "pkg-21.1.24" = _muiUmDdI;
        "pkg-21.1.25" = _1uQL6loa;
        "pkg-1.20.1-5.1.29" = _ATQjZGHM;
        "pkg-21.1.26" = _tdNSQIoh;
        "pkg-1.20.1-5.1.30" = _KQOyejrO;
        "pkg-1.20.1-5.1.31" = _v0k8AAUG;
        "pkg-21.1.27" = _hO82acGp;
        "pkg-1.20.1-5.1.32" = _J1e3y0Jc;
        "pkg-21.1.28" = _B8ePE2MC;
        "pkg-21.1.29" = _QoiCWJ7A;
        "pkg-21.1.30" = _ZcOTnJog;
