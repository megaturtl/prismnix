...
let
    versions = (let
        ...
        _OhLDr7Mj = {
            "id" = "OhLDr7Mj";
            "file" = "apollo-bukkit-1.2.9.jar";
            "hash" = "sha512-jZrilI3R/Jg46hJDlJCCXR8Y6BymWVTw8wurG5X01Jf17nLgc7fkhdU9hchwt8yXLPzoAih5T2bEx3r6jTpPFg==";
        };
        _1qR7cOcJ = {
            "id" = "1qR7cOcJ";
            "file" = "apollo-bungee-1.2.9.jar";
            "hash" = "sha512-ihxvqHlnlZE6djwbhbIGFEjnZWlhWZvFHymUfdV6sZQAYDWThYpJuces9lI3zx2c+bHw9nzvYRnUNO0G+WLIFQ==";
        };
        _zJT8pRj5 = {
            "id" = "zJT8pRj5";
            "file" = "apollo-velocity-1.2.9.jar";
            "hash" = "sha512-uv6OkwHmfeWRij/0wXfzhnVMWcMFFkoUhOro0W5oR7Mrq4D2cvQNkZeElHnYLZXdlgLKL1DGgdB7QtAKHxPZtg==";
        };
        _wqt90QGI = {
            "id" = "wqt90QGI";
            "file" = "apollo-folia-1.2.9.jar";
            "hash" = "sha512-61/tyiS0MqWC7gJulqdkS+N5KkVHvAhtHIRxxqdjtBBzIccsILUqNpSW0fwjXQjvlL0LqAKxdTyNM6wkGOC9Fg==";
        };
    in {
        "6jTpiHVy" = _6jTpiHVy;
        "luvTVnhF" = _luvTVnhF;
        ...
        "zJT8pRj5" = _zJT8pRj5;
        "wqt90QGI" = _wqt90QGI;
        "bungeecord-1.7.10" = _1qR7cOcJ;
        "bungeecord-1.8.9" = _1qR7cOcJ;
        "bungeecord-1.12.2" = _1qR7cOcJ;
        "bungeecord-1.16.5" = _1qR7cOcJ;
        "bungeecord-1.17.1" = _F2dNY0GN;
        "bungeecord-1.18.1" = _6JC2ldN1;
        "bungeecord-1.18.2" = _6JC2ldN1;
        "bungeecord-1.19" = _1qR7cOcJ;
        "bungeecord-1.19.2" = _mbIGrZXW;
        "bungeecord-1.19.3" = _mbIGrZXW;
        "bungeecord-1.19.4" = _mbIGrZXW;
        "bungeecord-1.20" = _1qR7cOcJ;
        "bungeecord-1.20.1" = _1qR7cOcJ;
        "bungeecord-1.20.2" = _1qR7cOcJ;
        "bungeecord-1.20.3" = _1qR7cOcJ;
        "bungeecord-1.20.4" = _1qR7cOcJ;
        "bungeecord-1.20.5" = _1qR7cOcJ;
        "bungeecord-1.20.6" = _1qR7cOcJ;
        "bungeecord-1.21" = _1qR7cOcJ;
        "bungeecord-1.21.1" = _1qR7cOcJ;
        "bungeecord-1.21.2" = _1qR7cOcJ;
        "bungeecord-1.21.3" = _1qR7cOcJ;
        "bungeecord-1.21.4" = _1qR7cOcJ;
        "bungeecord-1.21.5" = _1qR7cOcJ;
        "bungeecord-1.18" = _6JC2ldN1;
        "bungeecord-1.21.6" = _1qR7cOcJ;
        "bungeecord-1.21.7" = _1qR7cOcJ;
        "bungeecord-1.21.8" = _1qR7cOcJ;
        "bungeecord-1.17" = _O7E5Mg9J;
        "bungeecord-1.21.9" = _1qR7cOcJ;
        "bungeecord-1.21.10" = _1qR7cOcJ;
        "bungeecord-1.21.11" = _1qR7cOcJ;
        "bungeecord-26.1" = _1qR7cOcJ;
        "bungeecord-26.1.1" = _1qR7cOcJ;
        "bungeecord-26.1.2" = _1qR7cOcJ;
        "bungeecord-26.2" = _1qR7cOcJ;
        "velocity-1.7.10" = _zJT8pRj5;
        "velocity-1.8.9" = _zJT8pRj5;
        "velocity-1.12.2" = _zJT8pRj5;
        "velocity-1.16.5" = _zJT8pRj5;
        "velocity-1.17.1" = _Dr9c3f1Z;
        "velocity-1.18.1" = _Dr9c3f1Z;
        "velocity-1.18.2" = _Dr9c3f1Z;
        "velocity-1.19" = _zJT8pRj5;
        "velocity-1.19.2" = _iweBeWz3;
        "velocity-1.19.3" = _iweBeWz3;
        "velocity-1.19.4" = _iweBeWz3;
        "velocity-1.20" = _zJT8pRj5;
        "velocity-1.20.1" = _zJT8pRj5;
        "velocity-1.20.2" = _zJT8pRj5;
        "velocity-1.20.3" = _zJT8pRj5;
        "velocity-1.20.4" = _zJT8pRj5;
        "velocity-1.20.5" = _zJT8pRj5;
        "velocity-1.20.6" = _zJT8pRj5;
        "velocity-1.21" = _zJT8pRj5;
        "velocity-1.21.1" = _zJT8pRj5;
        "velocity-1.21.2" = _zJT8pRj5;
        "velocity-1.21.3" = _zJT8pRj5;
        "velocity-1.18" = _Dr9c3f1Z;
        "velocity-1.21.4" = _zJT8pRj5;
        "velocity-1.21.5" = _zJT8pRj5;
        "velocity-1.21.6" = _zJT8pRj5;
        "velocity-1.21.7" = _zJT8pRj5;
        "velocity-1.21.8" = _zJT8pRj5;
        "velocity-1.21.9" = _zJT8pRj5;
        "velocity-1.21.10" = _zJT8pRj5;
        "velocity-1.21.11" = _zJT8pRj5;
        "velocity-26.1" = _zJT8pRj5;
        "velocity-26.1.1" = _zJT8pRj5;
        "velocity-26.1.2" = _zJT8pRj5;
        "velocity-26.2" = _zJT8pRj5;
        "bukkit-1.7.10" = _OhLDr7Mj;
        "bukkit-1.8.9" = _OhLDr7Mj;
        "bukkit-1.12.2" = _OhLDr7Mj;
        "bukkit-1.16.5" = _OhLDr7Mj;
        "bukkit-1.17.1" = _EWVYOBfn;
        "bukkit-1.18.1" = _HlC8z8uC;
        "bukkit-1.18.2" = _HlC8z8uC;
        "bukkit-1.19" = _OhLDr7Mj;
        "bukkit-1.19.2" = _U7U45wNw;
        "bukkit-1.19.3" = _U7U45wNw;
        "bukkit-1.19.4" = _U7U45wNw;
        "bukkit-1.20" = _OhLDr7Mj;
        "bukkit-1.20.1" = _OhLDr7Mj;
        "bukkit-1.20.2" = _OhLDr7Mj;
        "bukkit-1.20.3" = _OhLDr7Mj;
        "bukkit-1.20.4" = _OhLDr7Mj;
        "bukkit-1.20.5" = _OhLDr7Mj;
        "bukkit-1.20.6" = _OhLDr7Mj;
        "bukkit-1.21" = _OhLDr7Mj;
        "bukkit-1.21.1" = _OhLDr7Mj;
        "bukkit-1.18" = _HlC8z8uC;
        "bukkit-1.21.2" = _OhLDr7Mj;
        "bukkit-1.21.3" = _OhLDr7Mj;
        "bukkit-1.21.4" = _OhLDr7Mj;
        "bukkit-1.21.5" = _OhLDr7Mj;
        "bukkit-1.21.6" = _OhLDr7Mj;
        "bukkit-1.21.7" = _OhLDr7Mj;
        "bukkit-1.21.8" = _OhLDr7Mj;
        "bukkit-1.21.9" = _OhLDr7Mj;
        "bukkit-1.21.10" = _OhLDr7Mj;
        "bukkit-1.21.11" = _OhLDr7Mj;
        "bukkit-1.17" = _EWVYOBfn;
        "bukkit-26.1" = _OhLDr7Mj;
        "bukkit-26.1.1" = _OhLDr7Mj;
        "bukkit-26.1.2" = _OhLDr7Mj;
        "bukkit-26.2" = _OhLDr7Mj;
        "folia-1.7.10" = _wqt90QGI;
        "folia-1.8.9" = _wqt90QGI;
        "folia-1.12.2" = _wqt90QGI;
        "folia-1.16.5" = _wqt90QGI;
        "folia-1.17.1" = _X1x5IYOm;
        "folia-1.18" = _K35mFZSo;
        "folia-1.18.1" = _K35mFZSo;
        "folia-1.18.2" = _K35mFZSo;
        "folia-1.19" = _wqt90QGI;
        "folia-1.20" = _wqt90QGI;
        "folia-1.20.1" = _wqt90QGI;
        "folia-1.20.2" = _wqt90QGI;
        "folia-1.20.3" = _wqt90QGI;
        "folia-1.20.4" = _wqt90QGI;
        "folia-1.20.5" = _wqt90QGI;
        "folia-1.20.6" = _wqt90QGI;
        "folia-1.21" = _wqt90QGI;
        "folia-1.21.1" = _wqt90QGI;
        "folia-1.21.2" = _wqt90QGI;
        "folia-1.21.3" = _wqt90QGI;
        "folia-1.21.4" = _wqt90QGI;
        "folia-1.21.5" = _wqt90QGI;
        "folia-1.21.6" = _wqt90QGI;
        "folia-1.21.7" = _wqt90QGI;
        "folia-1.21.8" = _wqt90QGI;
        "folia-1.21.9" = _wqt90QGI;
        "folia-1.21.10" = _wqt90QGI;
        "folia-1.21.11" = _wqt90QGI;
        "folia-26.1" = _wqt90QGI;
        "folia-26.1.1" = _wqt90QGI;
        "folia-26.1.2" = _wqt90QGI;
        "folia-26.2" = _wqt90QGI;
        "paper-1.7.10" = _OhLDr7Mj;
        "paper-1.8.9" = _OhLDr7Mj;
        "paper-1.12.2" = _OhLDr7Mj;
        "paper-1.16.5" = _OhLDr7Mj;
        "paper-1.17" = _EWVYOBfn;
        "paper-1.17.1" = _EWVYOBfn;
        "paper-1.18" = _HlC8z8uC;
        "paper-1.18.1" = _HlC8z8uC;
        "paper-1.18.2" = _HlC8z8uC;
        "paper-1.19" = _OhLDr7Mj;
        "paper-1.20" = _OhLDr7Mj;
        "paper-1.20.1" = _OhLDr7Mj;
        "paper-1.20.2" = _OhLDr7Mj;
        "paper-1.20.3" = _OhLDr7Mj;
        "paper-1.20.4" = _OhLDr7Mj;
        "paper-1.20.5" = _OhLDr7Mj;
        "paper-1.20.6" = _OhLDr7Mj;
        "paper-1.21" = _OhLDr7Mj;
        "paper-1.21.1" = _OhLDr7Mj;
        "paper-1.21.2" = _OhLDr7Mj;
        "paper-1.21.3" = _OhLDr7Mj;
        "paper-1.21.4" = _OhLDr7Mj;
        "paper-1.21.5" = _OhLDr7Mj;
        "paper-1.21.6" = _OhLDr7Mj;
        "paper-1.21.7" = _OhLDr7Mj;
        "paper-1.21.8" = _OhLDr7Mj;
        "paper-1.21.9" = _OhLDr7Mj;
        "paper-1.21.10" = _OhLDr7Mj;
        "paper-1.21.11" = _OhLDr7Mj;
        "paper-26.1" = _OhLDr7Mj;
        "paper-26.1.1" = _OhLDr7Mj;
        "paper-26.1.2" = _OhLDr7Mj;
        "paper-26.2" = _OhLDr7Mj;
        "spigot-1.7.10" = _OhLDr7Mj;
        "spigot-1.8.9" = _OhLDr7Mj;
        "spigot-1.12.2" = _OhLDr7Mj;
        "spigot-1.16.5" = _OhLDr7Mj;
        "spigot-1.17" = _EWVYOBfn;
        "spigot-1.17.1" = _EWVYOBfn;
        "spigot-1.18" = _HlC8z8uC;
        "spigot-1.18.1" = _HlC8z8uC;
        "spigot-1.18.2" = _HlC8z8uC;
        "spigot-1.19" = _OhLDr7Mj;
        "spigot-1.20" = _OhLDr7Mj;
        "spigot-1.20.1" = _OhLDr7Mj;
        "spigot-1.20.2" = _OhLDr7Mj;
        "spigot-1.20.3" = _OhLDr7Mj;
        "spigot-1.20.4" = _OhLDr7Mj;
        "spigot-1.20.5" = _OhLDr7Mj;
        "spigot-1.20.6" = _OhLDr7Mj;
        "spigot-1.21" = _OhLDr7Mj;
        "spigot-1.21.1" = _OhLDr7Mj;
        "spigot-1.21.2" = _OhLDr7Mj;
        "spigot-1.21.3" = _OhLDr7Mj;
        "spigot-1.21.4" = _OhLDr7Mj;
        "spigot-1.21.5" = _OhLDr7Mj;
        "spigot-1.21.6" = _OhLDr7Mj;
        "spigot-1.21.7" = _OhLDr7Mj;
        "spigot-1.21.8" = _OhLDr7Mj;
        "spigot-1.21.9" = _OhLDr7Mj;
        "spigot-1.21.10" = _OhLDr7Mj;
        "spigot-1.21.11" = _OhLDr7Mj;
        "spigot-26.1" = _OhLDr7Mj;
        "spigot-26.1.1" = _OhLDr7Mj;
        "spigot-26.1.2" = _OhLDr7Mj;
        "spigot-26.2" = _OhLDr7Mj;
        "pkg-1.1.2" = _cuVA1UUi;
        "pkg-1.1.3" = _3vtVfYcK;
        "pkg-1.1.4" = _w9zIXCd0;
        "pkg-1.1.5" = _iweBeWz3;
