...
let
    ...
    in {
        ...
        "pkg-1.1.0" = _cAFZdDy6;
        "pkg-1.1.1" = _yLdriDGb;
        "pkg-8d406a7" = _7oLi4HvK;
        "pkg-1.1.2" = _gq7t65AY;
        "pkg-1.1.3" = _GlY3rlQ0;
        "pkg-2e551c4" = _E2GLLsik;
        "pkg-1.1.4" = _f4kt0aVW;
        "pkg-87e4369" = _12XIejXh;
        "pkg-1.1.5" = _k8ibl3yC;
        "pkg-1.1.6" = _Q1RcQaYi;
        "pkg-a66743b" = _Z3dhRWmD;
        "pkg-1.1.7" = _rm3QyyET;
        "pkg-1.1.8" = _AKNV1F0x;
        "pkg-d6df6cc" = _vqbRibva;
        "pkg-1.1.9" = _fFO2LJJO;
        "pkg-ac434c3" = _D8E3BxfW;
        "pkg-1.1.10" = _uW0uRv9K;
        "pkg-9296612" = _nf88Ywip;
        "pkg-945cae7" = _RCQapbQS;
        "pkg-1.1.12" = _opIJL2b8;
        "pkg-349ef51" = _hhi2Dyxu;
        "pkg-cc96c51" = _3UNmqV0l;
        "pkg-1.1.13" = _UGUjANax;
        "pkg-41f52c2" = _oKAG1c2e;
        "pkg-1.1.14" = _gwDAWwwd;
        "pkg-b2396be" = _ySsyUvex;
        "pkg-1c93575" = _7YJAi00P;
        "pkg-f9db228" = _1OZHi9cx;
        "pkg-1.1.15" = _HL11rW5R;
        "pkg-5c71756" = _w7mGXufQ;
        "pkg-1.1.16" = _p0U6Q7r6;
        "pkg-089f86e" = _Nm6cb1lC;
        "pkg-f56718f" = _XfgcRqdr;
        "pkg-1.1.17" = _pt4BjUeN;
        "pkg-98af11b" = _Y9vEZQXX;
        "pkg-74296c5" = _wOkg1yQQ;
        "pkg-6d4ec93" = _nVXecsg0;
        "pkg-60936d2" = _tQzVr6vb;
        "pkg-1.1.18" = _TUBSLGql;
        "pkg-0753e63" = _Rigab9Gu;
        "pkg-16a29f2" = _6TKAu4m4;
        "pkg-038adfe" = _zTJKGjoM;
        "pkg-2f1abc8" = _1juIQHyr;
        "pkg-21250c4" = _ArbsEwIT;
        "pkg-d338ec2" = _NTCgNmnq;
        "pkg-a6d499e" = _hMQt9ZZZ;
        "pkg-5d10a82" = _B3FFvh1I;
        "pkg-470d97e" = _l7IDgHuH;
