...
let
    versions = (let
        ...
        _gr5vJF1a = {
            "id" = "gr5vJF1a";
            "file" = "raritycore-1211.14.0.jar";
            "hash" = "sha512-898U5VwzPx/lNzaCN3Ood94gnYP8HII4xMPc8jfMf5PO5BkCw3RpsRJ1IpToyKPMlQZCaLz8y3Tbr9J4E8+PlQ==";
        };
        _LaDnOmBf = {
            "id" = "LaDnOmBf";
            "file" = "raritycore-1211.14.1.jar";
            "hash" = "sha512-NOeD2CEAoQl6CkQ1D85HclT0xhoIfZKENOmWnbSFbfcCEfu+jvTZxdUyyAEPq4g/E/9Go5F4/ijWWlnGABxUzg==";
        };
        _H3FCL7hp = {
            "id" = "H3FCL7hp";
            "file" = "raritycore-1211.14.2.jar";
            "hash" = "sha512-FT1Fozp8eR48tpXNOOLjNI1IhFDFTm0whajZ62iEpiCqTFJLGao4PE0Yme+9RJFy1t2eapYjGKTpdxOiRt4B5g==";
        };
        _hKD3Wrt1 = {
            "id" = "hKD3Wrt1";
            "file" = "raritycore-1211.14.4.jar";
            "hash" = "sha512-vU7+aQ3RnIu3XdZWTaABhN2G6lUQCvX7ZX926A7xB0IXeKHeYiyVMI4hkCDrm5KLSPAzw17FW9eRwdXxiQAh7g==";
        };
        _zRw7im2D = {
            "id" = "zRw7im2D";
            "file" = "raritycore-1201.14.1.jar";
            "hash" = "sha512-dC0+P6rsdcTxr1oXKev/RUHhHk1A8E8IM3bNmDbgmxHBveNqqkvS90eN3ZyRZ3h7O6DwaM7kedcaXu8JAXVyAQ==";
        };
        _Td6lTS1E = {
            "id" = "Td6lTS1E";
            "file" = "raritycore-1211.14.5.jar";
            "hash" = "sha512-S9FfFKjHa3UJe3DU/vpVGjjxbRaEIMRGzEo69MIq4lL7wWcF0LBnULyf/gk0++y67xqq+gZBPh2wQgTSvtvpkA==";
        };
        _LWDVntFc = {
            "id" = "LWDVntFc";
            "file" = "raritycore-2601.14.0.jar";
            "hash" = "sha512-H4r8FGo6y082AcZPG1fv9XEyzjfrSnZOEQUR21TPNyxsvm2mdPYo/oVZWrKzfTnVDYNUcPs9uxK1VE2hXedcJA==";
        };
        _JhJQYZ4q = {
            "id" = "JhJQYZ4q";
            "file" = "raritycore-2602.14.0.jar";
            "hash" = "sha512-Fmev6RXaM5OmdrUuvzjp1lo6ta/mQibaXmCk85FKHn3mMYjEBtNVcZfk4dLZ7M1yXtp75Qtik4fVgXMlZW+FKQ==";
        };
        _VZur0f0x = {
            "id" = "VZur0f0x";
            "file" = "raritycore-1211.14.6.jar";
            "hash" = "sha512-Jhg6Bb1qrj08Ec4w744xJfRR4B9ILfU2VG8mgdHzyqd5gW08Yr3HPHDPus3BLELwN3NAM1pKPlWK0MDi3Zh1Uw==";
        };
        _VWBHD3fb = {
            "id" = "VWBHD3fb";
            "file" = "raritycore-1201.14.2.jar";
            "hash" = "sha512-EjKNzEIZeaJQzp4P4+s+3fMSaXqFLJPb6B7nKcpOc9Q8BrS5IOSZuQGFnOFhz1/Hx8JsJIzI+KZHEp9MiRZkow==";
        };
        _GDhOXYp4 = {
            "id" = "GDhOXYp4";
            "file" = "raritycore-1211.14.7.jar";
            "hash" = "sha512-ilpfNo2xjh9IvLNXKUtvll6PMDg1ZF6dSr8Keft8c+icH9lWcmsPzXO8POFntppEGpnyioG882LUBklnhGqsYw==";
        };
        _thuJ3b6c = {
            "id" = "thuJ3b6c";
            "file" = "raritycore-2601.14.1.jar";
            "hash" = "sha512-DGTe6rbLi7H8EODPbbLhP+sA8rL+itP6hVK6fk3FBe0NDOy2kGZOf60Q+4sc5N+GNCjyBvR3dA51PUdNfWwQIg==";
        };
        _5GSaAtVS = {
            "id" = "5GSaAtVS";
            "file" = "raritycore-2602.14.1.jar";
            "hash" = "sha512-IFv937FRZdLpQ24plUdbF8GEcDhTmDCRMnn7ewMkpbadoldbbN7t4oOPh/llqQOrxQJ79arXpzG63RdCdV91Bw==";
        };
        _CE6u4CQb = {
            "id" = "CE6u4CQb";
    ...
    in {
        ...
        "pkg-1.2.0" = _DQHWz4yt;
        "pkg-1.3.1" = _iRQgpEdi;
        "pkg-1201.4.1" = _bdup9kre;
        "pkg-1201.5.1" = _UzD5qDRf;
        "pkg-1201.5.1-fix" = _vl0Xo08d;
        "pkg-1201.5.1-fix2" = _sj4eZSa3;
        "pkg-1201.5.2" = _HlqB8imw;
        "pkg-1201.6.2" = _7X0tOXND;
        "pkg-1201.7.2" = _LQuxANBK;
        "pkg-1201.8.2" = _CWaZkh8k;
        "pkg-1201.8.2-fix" = _eZsBYhK8;
        "pkg-1201.9.2" = _D1vPCu2q;
        "pkg-1201.9.2-fix" = _VzC17Mdj;
        "pkg-1201.9.2-fix2" = _7At60UvI;
        "pkg-1201.10.3" = _hkqnp3cQ;
        "pkg-1201.11.0" = _18JfC6RO;
        "pkg-1201.12.0" = _R6UEC4dt;
        "pkg-1201.12.1" = _XihuYZwp;
        "pkg-1201.12.2" = _sn86aE0S;
        "pkg-1201.12.3" = _tXcQTACd;
        "pkg-1211.12.3" = _aLq6KszW;
        "pkg-12111.12.3" = _xdMupbte;
        "pkg-2601.12.3" = _1Z1bPtZl;
        "pkg-1201.12.4" = _BekcMmiw;
        "pkg-1201.12.5" = _QWlNQtWC;
        "pkg-1201.12.6" = _PpJZwKkP;
        "pkg-1211.12.4" = _7tvN2fCZ;
        "pkg-1201.12.7" = _ZkIVXry3;
        "pkg-1211.12.5" = _YaluKP6u;
        "pkg-1201.12.8" = _BNFIfJ79;
        "pkg-1211.12.6" = _CCEnlV5t;
        "pkg-1201.12.9" = _edi0PDvF;
        "pkg-1211.12.7" = _vPPhn6AR;
        "pkg-1201.12.10" = _480jnmfP;
        "pkg-1201.12.11" = _15BkKadl;
        "pkg-1211.12.8" = _AmC2zUuz;
        "pkg-1211.12.9" = _VtoHhkds;
        "pkg-1211.12.10" = _AVU8lZIH;
        "pkg-1201.12.12" = _HW4N4FqG;
        "pkg-1201.12.13" = _mEjcBojc;
        "pkg-1211.12.11" = _6yl8mYG4;
        "pkg-1201.13.0-beta" = _L2DMZenS;
        "pkg-1201.13.0" = _lQsP4VPz;
        "pkg-1211.13.0" = _mHYT3CaB;
        "pkg-1211.13.1" = _qu4Evbuc;
        "pkg-1201.13.1" = _E1YzTPBa;
        "pkg-1201.13.2" = _AjSHW5Ae;
        "pkg-1211.13.2" = _3Ngx0NNF;
        "pkg-2601.13.0" = _5apAw030;
        "pkg-1211.13.3" = _APH20cQg;
        "pkg-2601.13.1" = _1omRIFpm;
        "pkg-1201.13.3" = _OJqtyYMv;
        "pkg-1211.13.4" = _5MhLUjH9;
        "pkg-2601.13.2" = _WYwcH4RG;
        "pkg-1211.13.5" = _qjsRhqcl;
        "pkg-1201.13.4" = _OUemOmyd;
        "pkg-1211.13.6" = _hxZeNyii;
        "pkg-2601.13.3" = _PC4im12o;
        "pkg-1201.13.5" = _MvObJlSF;
        "pkg-1211.13.7" = _IhRDhcEi;
        "pkg-2601.13.4" = _1YAamjTo;
        "pkg-1201.13.6" = _baIy5GGr;
        "pkg-1211.13.8" = _IoT9uTlq;
        "pkg-2601.13.5" = _izOw2Wdn;
        "pkg-2601.13.6" = _x9g7ZqtX;
        "pkg-1211.13.9" = _gTHfmeXh;
        "pkg-1201.13.7" = _J9Y3TuS9;
        "pkg-1211.13.10" = _XTkG0vxW;
        "pkg-1211.13.11" = _uIz5bzaR;
        "pkg-1201.14.0" = _EYF7L0sR;
        "pkg-1211.13.12" = _8gEr1Fdp;
        "pkg-1211.14.0" = _gr5vJF1a;
        "pkg-1211.14.1" = _LaDnOmBf;
        "pkg-1211.14.2" = _H3FCL7hp;
        "pkg-1211.14.4" = _hKD3Wrt1;
        "pkg-1201.14.1" = _zRw7im2D;
        "pkg-1211.14.5" = _Td6lTS1E;
        "pkg-2601.14.0" = _LWDVntFc;
        "pkg-2602.14.0" = _JhJQYZ4q;
        "pkg-1211.14.6" = _VZur0f0x;
        "pkg-1201.14.2" = _VWBHD3fb;
        "pkg-1211.14.7" = _GDhOXYp4;
