...
let
    ...
    in {
        ...
        "pkg-0.1.1" = _umNWD7Iq;
        "pkg-0.1.2" = _AAzKtpHL;
        "pkg-v0.2.0" = _SBE4oCLf;
        "pkg-v0.3.0" = _aJSyDPkn;
        "pkg-v0.3.1" = _GR6D4aDz;
        "pkg-v0.3.2" = _1bZaCCPG;
        "pkg-v0.3.3-1.18.2" = _55bW4ydX;
        "pkg-v0.3.3-1.19" = _L6RVEUeL;
        "pkg-v0.3.4-1.19" = _DBL5UbLJ;
        "pkg-v0.3.4-1.18.2" = _DtwVbgrW;
        "pkg-v0.3.5-1.19.1" = _OyEl8tic;
        "pkg-v0.4.0-1.19.2" = _4EtIY6Zi;
        "pkg-v0.4.1-1.19.2" = _HA3ueujD;
        "pkg-1.0.0+1.21.4" = _eYXJLa6s;
        "pkg-1.0.0+1.21.5" = _6sSGNFUR;
        "pkg-1.0.1+1.21.4" = _FNiexRv8;
        "pkg-1.0.1+1.21.5" = _Klthhxu4;
        "pkg-1.0.1+1.21.1" = _H34TxtUc;
        "pkg-1.0.2+1.21.1" = _2eUWXIKG;
        "pkg-1.0.3+1.21.1" = _kUHdDIpa;
        "pkg-1.0.3+1.21.4" = _NQeB17h6;
        "pkg-1.0.3+1.21.5" = _mtAtO354;
        "pkg-1.0.4+1.21.4" = _tabalCqS;
        "pkg-1.0.4+1.21.1" = _kILQJ698;
        "pkg-1.0.4+1.21.5" = _RxCshno6;
        "pkg-1.0.5" = _pdR95ObP;
        "pkg-1.0.6" = _8AKTFep8;
        "pkg-1.0.7" = _oOINodqy;
        "pkg-1.0.8" = _GyZTtYRy;
