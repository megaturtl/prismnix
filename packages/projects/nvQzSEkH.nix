...
let
    versions = (let
        ...
        _A416FkrB = {
            "id" = "A416FkrB";
            "file" = "Jade-1.21.1-Fabric-15.10.6.jar";
            "hash" = "sha512-+64ceWNooJxXndeAodUQ+lq3Pw7KNw3b/gqebKFi4bgGJhV3MGoll3PzCdxJOKg5sgZcXu+YsoEIVcJBrd8X9Q==";
        };
        _adpNvTZS = {
            "id" = "adpNvTZS";
            "file" = "Jade-1.21.1-Fabric-15.10.6.jar";
        ...
        _fnbQ0Mb3 = {
            "id" = "fnbQ0Mb3";
            "file" = "Jade-mc26.1-NeoForge-26.1.9.jar";
            "hash" = "sha512-n+8CveGA84lxd3IZkCZ8ST7Ch5ssRP+XyMOlkOLZYKrQCXzXyWf0A0Y1W1DrbTHc4aZP0kK9AiwXQLKoGKByBA==";
        };
        _ue8CO97w = {
            "id" = "ue8CO97w";
        ...
        _uGgaQ65p = {
            "id" = "uGgaQ65p";
            "file" = "Jade-mc26.2-NeoForge-26.2.9.jar";
            "hash" = "sha512-NKYHxjVRC6yXWyW/5q0T8AdyentmNnDe9d5RPW/4+ieYrSAYDIocMUuXjIAi/O//dzWOokEE/7Xj6db53SEOdA==";
        };
        _aMkOTJX7 = {
            "id" = "aMkOTJX7";
            "file" = "Jade-mc26.1-NeoForge-26.1.10.jar";
            "hash" = "sha512-qw6Yv2ASnULrKqGxwJ8JWW5J6V5bnsSagZ8JGzxQOeZctpUvK3vUiHA8nXAdV8rgAHOLPgUoL4EdZQC6Hw/hHA==";
        };
        _fW2xykin = {
            "id" = "fW2xykin";
            "file" = "Jade-mc26.1-Fabric-26.1.9.jar";
            "hash" = "sha512-azitIrOIgFfGGa64nqp4reaMA9u6jTdYxlsyrTRHE3jPIi3BuRCMMQfZc57us4VHbnYMFMzWiv3nVGYPY87czg==";
        };
        _GBES6etT = {
            "id" = "GBES6etT";
            "file" = "Jade-mc26.2-NeoForge-26.2.10.jar";
            "hash" = "sha512-I8TODgrsDXCzi6XIo0blIzqqOSOpT1TcG0EuSO+Y05TToaw86qn+Z03BZTu+9ImiKL4WfwEdFj23rm5KlHBRuQ==";
        };
        _vdhnGNqO = {
            "id" = "vdhnGNqO";
            "file" = "Jade-mc26.3-Fabric-26.3.0.jar";
            "hash" = "sha512-FN5EPCXuwo842FfXZ6NJ/Tkur5AElg8HmVTA0DqF1MIX02iimRr4aw4dcV8zKHF1FOuEdx13B4czWqhFPvzvdw==";
        };
        _Yo9xOce3 = {
            "id" = "Yo9xOce3";
            "file" = "Jade-mc26.1-Fabric-26.1.11.jar";
            "hash" = "sha512-odnjR3mJ0EkXgk6QRkj27156PnMCZu645aO8qWuFHg+KRUa8Imtqc9ysKaTTC5wMFHR6L342DJTTfp6P0XpPyA==";
        };
        _5jKeKXwB = {
            "id" = "5jKeKXwB";
            "file" = "Jade-mc26.1-NeoForge-26.1.11.jar";
            "hash" = "sha512-me3Dx6XHQXkLC2IQdsTiE/TV0NtRzwzeSweIMefPau6xIbXkur1AOc7sOPsuD6ap5k8F3cS3ZEeU8SdjITacVg==";
        };
        _lt43vWtF = {
            "id" = "lt43vWtF";
    ...
    in {
        ...
        "fabric-26.1" = _Yo9xOce3;
        "fabric-26.1.1-rc-1" = _yA7ziX81;
        "fabric-26.1.1" = _Yo9xOce3;
        "fabric-26w14a" = _rbyAHXPM;
        "fabric-26.1.2" = _Yo9xOce3;
        ...
        "fabric-26.2" = _ue8CO97w;
        "fabric-26.3-pre-3" = _vdhnGNqO;
        ...
        "quilt-26.1" = _Yo9xOce3;
        "quilt-26.1.1-rc-1" = _yA7ziX81;
        "quilt-26.1.1" = _Yo9xOce3;
        ...
        "pkg-8.8.1" = _JSi5dyS2;
        "pkg-9.4.1" = _HIL9jJQF;
        "pkg-10.0.0" = _AncyVLy5;
        "pkg-10.1.0" = _xk54zw9v;
        "pkg-10.1.1" = _EgZGElBL;
        "pkg-10.2.0" = _bhyR7YNm;
        "pkg-11.0.0" = _BWdNl4EE;
        "pkg-10.3.0" = _aYg0KAo5;
        "pkg-11.0.1" = _KuAs1UBn;
        "pkg-10.3.1" = _qIHOeHzS;
        "pkg-11.0.2" = _XVLI5QsX;
        "pkg-11.0.3" = _Vh3wXVs6;
        "pkg-5.100.0" = _MSJGBHIo;
        "pkg-11.1.0" = _5HiwJ7Se;
        "pkg-11.1.1" = _aS8nBmNK;
        "pkg-11.1.2" = _IIpnN0Qf;
        "pkg-11.1.3" = _lcQiLHVM;
        "pkg-11.1.4" = _ujkXpLkl;
        "pkg-11.2.0" = _F5BnRKSt;
        "pkg-11.2.1" = _xQcxjdfW;
        "pkg-11.2.2" = _C9KywtGd;
        "pkg-10.4.0" = _4bCqgRsR;
        "pkg-3.100.0" = _H3ou3KBw;
        "pkg-11.3.0" = _rVfNqnx6;
        "pkg-11.4.1" = _YaELNGeC;
        "pkg-11.4.2" = _u3ts4cHu;
        "pkg-11.4.3" = _rTAmf6cM;
        "pkg-12.0.0" = _YtsKFrlw;
        "pkg-11.5.0" = _oeEzN4Af;
        "pkg-11.5.1" = _2iRQrBk4;
        "pkg-12.1.1" = _Vw8iMb7Y;
        "pkg-8.9.0" = _rBcIqjdI;
        "pkg-11.6.0" = _SlsObyHn;
        "pkg-12.1.2" = _7ykNJqNq;
        "pkg-12.1.3" = _o2sXK6XR;
        "pkg-11.6.1" = _jyvjSF1Y;
        "pkg-11.6.2" = _ckXpheui;
        "pkg-8.9.1" = _SpOQVu02;
        "pkg-5.3.1" = _UEoiUewC;
        "pkg-11.6.3" = _5gvujWrb;
        "pkg-12.1.5" = _Uwt21lf2;
        "pkg-12.1.6" = _XbNEZjWV;
        "pkg-12.1.7" = _A3Qmrqh1;
        "pkg-12.1.8" = _kX0whWaT;
        "pkg-12.2.0" = _njXu5ySg;
        "pkg-12.2.1" = _pyljMVxx;
        "pkg-8.9.2" = _kp0HjPre;
        "pkg-13.0.0" = _gUfoXs8r;
        "pkg-12.3.0" = _K048p8ZE;
        "pkg-13.1.0" = _ChB6svaA;
        "pkg-13.2.0" = _XoEjMfV6;
        "pkg-11.6.4" = _huOVr6wC;
        "pkg-11.7.0" = _uLIwu0Qg;
        "pkg-13.2.1" = _dxGKPrkW;
        "pkg-12.4.0" = _soTdTMDe;
        "pkg-13.2.2" = _zNQTQths;
        "pkg-11.7.1" = _cqz4BTbh;
        "pkg-11.8.0" = _CciLEAMK;
        "pkg-5.3.2" = _L2um3gq1;
        "pkg-13.3.1" = _9rrZAORZ;
        "pkg-14.0.0-potato+fabric" = _dF9pXzzi;
        "pkg-14.0.0+fabric" = _NKpz2O5U;
        "pkg-14.0.1+fabric" = _zBRTR48S;
        "pkg-14.0.2+neoforge" = _VX7bhedt;
        "pkg-14.0.2+fabric" = _RZQxZtl6;
        "pkg-14.1.0+fabric" = _lwgbRGaY;
        "pkg-11.9.0+fabric" = _yksHdZ4j;
        "pkg-14.2.0+fabric" = _BnscDKcL;
        "pkg-11.9.1+fabric" = _kIHvC4Li;
        "pkg-11.9.1+forge" = _AXsURWBl;
        "pkg-11.9.2+fabric" = _re9m40O9;
        "pkg-11.9.2+forge" = _X6kFPDSp;
        "pkg-14.2.1+fabric" = _Ou5F0zCg;
        "pkg-14.2.2+neoforge" = _5JH8igBc;
        "pkg-14.2.3+neoforge" = _43DuyPgG;
        "pkg-14.2.3+fabric" = _Yx2HKOrO;
        "pkg-14.2.4+fabric" = _H9wg0p1c;
        "pkg-11.9.3+forge" = _NruPjXIH;
        "pkg-15.0.1+fabric" = _kEtH9pf8;
        "pkg-15.0.2+fabric" = _wqbAqgyJ;
        "pkg-15.0.3+fabric" = _pc7Loi6P;
        "pkg-15.0.4+neoforge" = _gF1TRsRm;
        "pkg-15.0.4+fabric" = _ZMaraV5t;
        "pkg-15.0.5+neoforge" = _K1QP6zk7;
        "pkg-15.1.0+fabric" = _19gb5iEa;
        "pkg-15.1.1+neoforge" = _fYjkxRNy;
        "pkg-15.1.2+fabric" = _xzFnPn44;
        "pkg-15.1.2+neoforge" = _y0Qgfue5;
        "pkg-15.1.3+neoforge" = _YWwchlKJ;
        "pkg-15.1.3+fabric" = _4O1mPdg9;
        "pkg-11.9.4+forge" = _MLYKnVCk;
        "pkg-15.1.4+fabric" = _Um5AmLft;
        "pkg-15.1.4+neoforge" = _NVvPo5yc;
        "pkg-11.10.0+fabric" = _vlM1OUBd;
        "pkg-15.1.5+fabric" = _VQc9njMw;
        "pkg-15.1.5+neoforge" = _1866MBfo;
        "pkg-15.1.6+neoforge" = _eNY0Rg8n;
        "pkg-15.1.7+neoforge" = _1OxWWUkf;
        "pkg-15.1.8+neoforge" = _3LmyqeEt;
        "pkg-15.1.8+fabric" = _2PamFbp4;
        "pkg-11.10.1+forge" = _dldgfOqB;
        "pkg-15.2.0+fabric" = _m4JY8Ioc;
        "pkg-15.2.1+fabric" = _3ZwcSlCl;
        "pkg-15.2.1+neoforge" = _2OBOPDer;
        "pkg-11.10.2+fabric" = _XTAUVfnD;
        "pkg-11.11.0+fabric" = _bwDoSE9Z;
        "pkg-11.11.1+forge" = _UmuG0hq8;
        "pkg-15.3.0+fabric" = _uXsQaAN6;
        "pkg-4.5.0" = _wYVlZH8l;
        "pkg-15.3.1+fabric" = _wQ58TpT7;
        "pkg-15.3.2+fabric" = _h0ynLaNt;
        "pkg-15.3.3+fabric" = _cBvDQh5i;
        "pkg-15.3.4+neoforge" = _S4xSKa4a;
        "pkg-15.3.4+fabric" = _vHRyi3EF;
        "pkg-15.4.0+neoforge" = _63Z2YN3T;
        "pkg-15.4.1+fabric" = _UqFCwiPm;
        "pkg-15.4.1+neoforge" = _Z90ICXCg;
        "pkg-11.12.0+fabric" = _Lvyx1o7I;
        "pkg-11.12.1+forge" = _oWwzG652;
        "pkg-15.5.0+fabric" = _yBkqd6an;
        "pkg-15.5.1+fabric" = _ycbZawVK;
        "pkg-16.0.0-alpha.0+fabric" = _njUnUmcQ;
        "pkg-16.0.0-alpha.1+fabric" = _26IWQOrI;
        "pkg-16.0.0-alpha.2+fabric" = _16zVQWlN;
        "pkg-15.5.2+neoforge" = _NRvHmI0Y;
        "pkg-15.6.0+neoforge" = _S2SDGdBv;
        "pkg-16.0.0-alpha.3+fabric" = _Oy6o0HsB;
        "pkg-15.7.0+fabric" = _f5Sf7pxS;
        "pkg-15.7.1+neoforge" = _zoXpBSpm;
        "pkg-15.8.0+fabric" = _kpUj7epW;
        "pkg-16.0.0-alpha.4+fabric" = _YaDHHAWi;
        "pkg-16.0.0-beta.0+fabric" = _dfqqZcIG;
        "pkg-16.0.1+neoforge" = _Wo8OVKxw;
        "pkg-16.0.0+fabric" = _eyGIHex9;
        "pkg-15.8.1+neoforge" = _rAMQlzqw;
        "pkg-16.0.2+neoforge" = _5W6rnZp4;
        "pkg-16.0.3+fabric" = _lH7ZVZCk;
        "pkg-16.0.3+neoforge" = _1VZxf9TH;
        "pkg-15.8.2+fabric" = _NX5NMF25;
        "pkg-16.0.4+fabric" = _pGE7hUKk;
        "pkg-16.0.4+neoforge" = _QjOJBooo;
        "pkg-15.8.2+neoforge" = _u8W1Jbpo;
        "pkg-11.12.2+forge" = _bzWVE2db;
        "pkg-15.8.3+neoforge" = _ALpv8KVb;
        "pkg-15.8.3+fabric" = _1Ucj3FzM;
        "pkg-17.0.0+fabric" = _9bgHxSiP;
        "pkg-17.0.1+fabric" = _5Txno2MN;
        "pkg-17.0.1+neoforge" = _Y2x4pssg;
        "pkg-15.9.0+neoforge" = _6drvdhDm;
        "pkg-15.9.0+fabric" = _LFgwBTe9;
        "pkg-17.0.2+fabric" = _oV0JDnkv;
        "pkg-17.0.2+neoforge" = _Urd0O0Uy;
        "pkg-15.9.1+neoforge" = _BYimLFOQ;
        "pkg-15.9.1+fabric" = _hM4x4Hcn;
        "pkg-17.0.3+fabric" = _pAlCWjua;
        "pkg-17.0.3+neoforge" = _oVjZpden;
        "pkg-17.1.0+fabric" = _uWLqeB9w;
        "pkg-17.1.1+fabric" = _3UdBbXoi;
        "pkg-15.9.2+neoforge" = _JkFFfEao;
        "pkg-15.9.2+fabric" = _pA0xvozk;
        "pkg-17.1.2+fabric" = _EJub6tVz;
        "pkg-17.1.2+neoforge" = _YPhZomnA;
        "pkg-17.2.0+fabric" = _S1GWTEhB;
        "pkg-11.12.3+fabric" = _oJx1UoWN;
        "pkg-11.12.3+forge" = _SOuuRR07;
        "pkg-17.2.1+fabric" = _cfWk8zie;
        "pkg-15.9.3+fabric" = _sbzn5jqB;
        "pkg-17.2.2+fabric" = _sSHUBFoq;
        "pkg-15.9.3+neoforge" = _3x01MocY;
        "pkg-17.2.2+neoforge" = _6FZao59X;
        "pkg-17.3.0+neoforge" = _Rpe14jmy;
        "pkg-15.9.4+neoforge" = _ErF9rUGQ;
        "pkg-11.13.0+forge" = _eyV1NG7g;
        "pkg-11.13.1+forge" = _9gf6jOO0;
        "pkg-11.13.1+fabric" = _drol2x1P;
        "pkg-15.10.0+neoforge" = _jBPaSUDN;
        "pkg-15.10.0+fabric" = _NSxMqEgR;
        "pkg-18.0.0+fabric" = _FuJqSnog;
        "pkg-18.0.0+neoforge" = _1urtMVpZ;
        "pkg-18.0.1+fabric" = _OD4lLSAh;
        "pkg-18.0.1+neoforge" = _qrwVU4Ad;
        "pkg-18.0.2+fabric" = _I8ETn32R;
        "pkg-18.0.3+fabric" = _cJIrDrbJ;
        "pkg-18.1.0+neoforge" = _2B1K9HAo;
        "pkg-18.1.0+fabric" = _EE9Gk8ly;
        "pkg-18.1.1+fabric" = _uHuQED6W;
        "pkg-15.10.1+fabric" = _aYVY3zTC;
        "pkg-18.2.0+fabric" = _VNSIKHbV;
        "pkg-18.2.0+neoforge" = _t2nMgLQM;
        "pkg-19.0.1+fabric" = _3uasHttk;
        "pkg-19.0.1+neoforge" = _pPibgfXY;
        "pkg-15.10.1+neoforge" = _2P7THd8J;
        "pkg-19.0.2+fabric" = _eqf37Xnc;
        "pkg-19.0.2+neoforge" = _x4EoNRXq;
        "pkg-19.0.3+neoforge" = _OkO5G6Dd;
        "pkg-19.0.3+fabric" = _AMBKaYce;
        "pkg-19.0.4+neoforge" = _ktFRpwiF;
        "pkg-19.0.4+fabric" = _NNvRcygS;
        "pkg-15.10.2+neoforge" = _iku9fmp8;
        "pkg-15.10.2+fabric" = _PtcHhnOY;
        "pkg-19.1.0+neoforge" = _W933t5zu;
        "pkg-19.1.0+fabric" = _nSFrx1iK;
        "pkg-19.1.1+neoforge" = _pOR0yXnX;
        "pkg-19.1.1+fabric" = _CPGdNAPA;
        "pkg-15.10.3+neoforge" = _43sRR8f6;
        "pkg-11.13.2+forge" = _LecuGude;
        "pkg-19.2.0+fabric" = _iOCawybv;
        "pkg-19.3.0+fabric" = _eM01zcHw;
        "pkg-20.0.0+fabric" = _h0pgeFjj;
        "pkg-19.3.1+neoforge" = _V5Hbf49Y;
        "pkg-19.3.2+fabric" = _o3aatc5Q;
        "pkg-20.0.1+fabric" = _k0i2MKgQ;
        "pkg-20.0.2+fabric" = _zRj1t0CY;
        "pkg-20.0.3+fabric" = _8q7iwbxb;
        "pkg-20.0.4+fabric" = _eTnLLMdS;
        "pkg-20.0.5+neoforge" = _q7P6JKIH;
        "pkg-20.0.5+fabric" = _qC0qUqL5;
        "pkg-20.1.0+fabric" = _nCbsPtPw;
        "pkg-21.0.1+fabric" = _7cBo3s22;
        "pkg-21.0.1+neoforge" = _rR9kXYnS;
        "pkg-26.0.0+fabric" = _fkVbgJ4r;
        "pkg-21.1.0+fabric" = _KMZboJlD;
        "pkg-21.1.1+fabric" = _HKUAgY3D;
        "pkg-15.10.4+neoforge" = _VGRMP69T;
        "pkg-15.10.4+fabric" = _anDPp1Qs;
        "pkg-26.0.1+fabric" = _LILh0uCA;
        "pkg-26.0.2+fabric" = _waSFFnur;
        "pkg-15.10.5+neoforge" = _yd8FKCmx;
        "pkg-15.10.5+fabric" = _5Sbkzz4O;
        "pkg-21.1.2+fabric" = _552ldiCx;
        "pkg-21.1.3+fabric" = _KoFDJ3lD;
        "pkg-21.1.3+neoforge" = _q9JDI6JU;
        "pkg-21.1.4+fabric" = _sGI08gfW;
        "pkg-26.0.3+fabric" = _dU7myLRG;
        "pkg-26.0.4+fabric" = _vdJBOoMU;
        "pkg-26.0.5+neoforge" = _5MbmCXZC;
        "pkg-26.0.5+fabric" = _rbyAHXPM;
        "pkg-26.0.6+neoforge" = _lE1BCRgi;
        "pkg-26.0.7+fabric" = _T2MaJ7vE;
        "pkg-26.0.8+neoforge" = _iUwIda7S;
        "pkg-26.0.8+fabric" = _yxt4DUPB;
        "pkg-21.1.5+fabric" = _qIfLWWYm;
        "pkg-21.1.5+neoforge" = _usEgI3B0;
        "pkg-21.1.6+neoforge" = _1rxITWgp;
        "pkg-21.1.6+fabric" = _swJhAyak;
        "pkg-26.0.9+neoforge" = _xp9l9JJG;
        "pkg-26.0.10+neoforge" = _44hEJcn9;
        "pkg-21.1.7+neoforge" = _LDFqgwEA;
        "pkg-26.1.0+fabric" = _QglgrEFX;
        "pkg-26.1.1+neoforge" = _mRb9OwnE;
        "pkg-26.2.0+fabric" = _4UKaVQez;
        "pkg-26.1.2+fabric" = _23eHNK54;
        "pkg-26.1.3+fabric" = _qjdVqY6H;
        "pkg-26.1.3+neoforge" = _8W6pQPQp;
        "pkg-26.1.4+fabric" = _11ajlkkb;
        "pkg-26.2.1+fabric" = _qxwj9BOs;
        "pkg-26.2.2+neoforge" = _HLYMycSr;
        "pkg-26.1.5+fabric" = _mGN16yZ2;
        "pkg-26.2.3+fabric" = _YAOAeGCx;
        "pkg-26.2.3+neoforge" = _fQ5Kzx2d;
        "pkg-26.1.5+neoforge" = _8NrKHyFs;
        "pkg-26.1.6+fabric" = _zu6GcgEW;
        "pkg-26.2.4+fabric" = _LIvmDxnR;
        "pkg-26.2.5+fabric" = _Jk32EiBj;
        "pkg-26.1.7+fabric" = _254DcJMj;
        "pkg-26.1.7+neoforge" = _8CJXIzgp;
        "pkg-26.2.4+neoforge" = _mutMXwsg;
        "pkg-26.2.6+fabric" = _KGWJmVcb;
        "pkg-26.2.7+fabric" = _eSu8CVEs;
        "pkg-26.2.8+fabric" = _YVZmJZjb;
        "pkg-26.2.8+neoforge" = _bYTBXC57;
        "pkg-26.1.8+fabric" = _Bw2a8uFN;
        "pkg-26.1.8+neoforge" = _gWlwZzoj;
        "pkg-26.2.9+fabric" = _dnZQ9Fgp;
        "pkg-11.13.2+fabric" = _MkFPIkgR;
        "pkg-11.13.3+fabric" = _ahavHbAT;
        "pkg-11.13.3+forge" = _xJQHCmWJ;
        "pkg-26.2.10+fabric" = _JB4B8a9g;
        "pkg-15.10.6+neoforge" = _eYz2YBGT;
        "pkg-15.10.6+fabric" = _adpNvTZS;
        "pkg-26.1.9+neoforge" = _fnbQ0Mb3;
        "pkg-26.2.11+fabric" = _ue8CO97w;
        "pkg-26.2.9+neoforge" = _uGgaQ65p;
        "pkg-26.1.10+neoforge" = _aMkOTJX7;
        "pkg-26.1.9+fabric" = _fW2xykin;
        "pkg-26.2.10+neoforge" = _GBES6etT;
        "pkg-26.3.0+fabric" = _vdhnGNqO;
        "pkg-26.1.11+fabric" = _Yo9xOce3;
