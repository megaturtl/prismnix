...
let
    ...
    in {
        ...
        "pkg-1.0.3-beta-1.21.1" = _lEoxuG0O;
        "pkg-1.1.0-beta-1.21.1" = _MDTnSDfG;
        "pkg-1.1.1-beta-1.21.1" = _BawaEuRw;
        "pkg-1.1.2-beta-1.21.1" = _aGg4cdlN;
        "pkg-1.2.0-beta-1.21.1" = _lzBGYuUb;
        "pkg-1.2.1-beta-1.21.1" = _4iA5lMzS;
        "pkg-1.2.2-beta-1.21.1" = _AxajQLbH;
        "pkg-1.3.0-beta-1.21.1" = _qHGjntBC;
        "pkg-1.3.1-beta-1.21.1" = _2Uw9fI0s;
        "pkg-1.3.2-beta-1.21.1" = _ibp8GLe6;
        "pkg-1.4.0-beta-1.21.1" = _2PDiocAK;
        "pkg-1.4.1-beta-1.21.1" = _zvmFE0c2;
        "pkg-1.4.2-beta-1.21.1" = _kscTSSdj;
        "pkg-1.4.3-beta-1.21.1" = _DqCdOJE7;
        "pkg-1.4.4-1.21.1" = _9q53wnt3;
        "pkg-1.4.5-beta-1.21.1" = _zudpqMeq;
        "pkg-1.4.6-beta-1.21.1" = _wKWKAKWx;
        "pkg-1.4.7-beta-1.21.1" = _ynAfjkLV;
        "pkg-1.4.8-beta-1.21.1" = _xWuLkV6Z;
        "pkg-1.4.9-beta-1.21.1" = _abaMydyd;
        "pkg-1.4.10-beta-1.21.1" = _aTY8DWhe;
        "pkg-1.4.11-beta-1.21.1" = _bASNxWQG;
        "pkg-1.4.12-beta-1.21.1" = _W8ZVQLJr;
        "pkg-1.4.13-beta-1.21.1" = _890QTUz4;
        "pkg-1.4.14-beta-1.21.1" = _bqsk3T71;
        "pkg-1.4.15-beta-1.21.1" = _LVYC4yom;
        "pkg-1.4.16-beta-1.21.1" = _sW2qqoqk;
        "pkg-1.5.0-beta-1.21.1" = _p6A5q3Hl;
        "pkg-1.5.1-beta-1.21.1" = _7HK3vlDH;
        "pkg-1.5.2-beta-1.21.1" = _BkfnMvnD;
        "pkg-1.5.3-beta-1.21.1" = _bi2I9VZV;
        "pkg-1.5.4-beta-1.21.1" = _IwUIGT90;
        "pkg-1.6.0-beta-1.21.1" = _wnV4EBU3;
        "pkg-1.6.1-beta-1.21.1" = _4BBas7iD;
        "pkg-1.6.2-beta-1.21.1" = _ACWpKDL0;
        "pkg-1.6.3-beta-1.21.1" = _dsBB3YeP;
        "pkg-1.6.4-beta-1.21.1" = _diyQDu1F;
        "pkg-1.7.0-beta-1.21.1" = _3f3tHyi2;
        "pkg-1.7.1-beta-1.21.1" = _Y7WrMChq;
        "pkg-1.7.2-beta-1.21.1" = _OTyQ0yua;
        "pkg-1.8.0-beta-1.21.1" = _FKL5xaKW;
        "pkg-1.8.1-beta-1.21.1" = _s9FE6TGH;
        "pkg-1.8.2-beta-1.21.1" = _vLfiMrjk;
        "pkg-1.9.0-1.21.1" = _7ryjHMRj;
        "pkg-1.9.0-alpha-26.1.2" = _16GrV1U0;
        "pkg-1.9.1-alpha-26.1.2" = _IhdgyO02;
        "pkg-1.9.1-1.21.1" = _frcvp5wx;
        "pkg-1.9.2-1.21.1" = _8r1qpMwP;
        "pkg-1.9.2-alpha-26.1.2" = _M7TImTW6;
        "pkg-1.9.3-1.21.1" = _k7gCJ4wv;
        "pkg-1.9.3-alpha-26.1.2" = _BKtwe26t;
        "pkg-1.9.4-1.21.1" = _OXC3NGVo;
        "pkg-1.9.4-alpha-26.1.2" = _bZlZfRL8;
        "pkg-1.9.5-1.21.1" = _Tr2bEcB9;
        "pkg-1.9.5-alpha-26.1.2" = _VUlZKwYp;
        "pkg-1.9.6-1.21.1" = _2lDTk8j4;
        "pkg-1.9.6-alpha-26.1.2" = _DMElS7K9;
        "pkg-1.9.7-1.21.1" = _dt1Gsywc;
