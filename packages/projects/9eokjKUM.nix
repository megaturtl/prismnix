...
let
    versions = (let
        ...
        _UUN4iPGW = {
            ...
            "hash" = "sha512-Iurt6rMesyCO24YwW0Rwcx8vww33h7cTb+EmpDbp8hy2fnmo9DQ59DnDDUmfLi1LHaqvMiGIjev4wsDdwGQBtg==";
        };
        _kA4OTxAx = {
            "id" = "kA4OTxAx";
    ...
    in {
        ...
        "datapack-1.21.9" = _UUN4iPGW;
        "datapack-1.21.10" = _UUN4iPGW;
        "datapack-1.21.11" = _UUN4iPGW;
        "datapack-26.1" = _UUN4iPGW;
        ...
        "fabric-1.21.9" = _kA4OTxAx;
        "fabric-1.21.10" = _kA4OTxAx;
        "fabric-1.21.11" = _kA4OTxAx;
        "fabric-26.1" = _kA4OTxAx;
        ...
        "forge-1.21.9" = _kA4OTxAx;
        "forge-1.21.10" = _kA4OTxAx;
        "forge-1.21.11" = _kA4OTxAx;
        "forge-26.1" = _kA4OTxAx;
        ...
        "neoforge-1.21.9" = _kA4OTxAx;
        "neoforge-1.21.10" = _kA4OTxAx;
        "neoforge-1.21.11" = _kA4OTxAx;
        "neoforge-26.1" = _kA4OTxAx;
        ...
        "quilt-1.21.9" = _kA4OTxAx;
        "quilt-1.21.10" = _kA4OTxAx;
        "quilt-1.21.11" = _kA4OTxAx;
        "quilt-26.1" = _kA4OTxAx;
        ...
        "pkg-7.0" = _17vjeddX;
        "pkg-8.0" = _mZA7zrYL;
        "pkg-8.0.mod" = _jkKTcHqC;
        "pkg-9.0" = _bmh98lkX;
        "pkg-9.0.mod" = _L3dyjboC;
        "pkg-10.0" = _MyFpjpAX;
        "pkg-10.0.mod" = _CTIsqJw2;
        "pkg-11.0" = _VkmnCqe0;
        "pkg-11.0.mod" = _yDAySorx;
        "pkg-12.0" = _Dcmheidf;
        "pkg-12.0.mod" = _DmVLyupr;
        "pkg-13.0" = _PnDx6HkL;
        "pkg-13.0.mod" = _zZIu3wpK;
        "pkg-14.0" = _oVpVMaga;
        "pkg-14.0.mod" = _eOL8t8bX;
        "pkg-15.0" = _LwzkAEO0;
        "pkg-15.0.mod" = _dmnbvT79;
        "pkg-16.0" = _mL5aJked;
        "pkg-16.0.mod" = _LRzlU5Zb;
        "pkg-17.0" = _3FOnlolB;
        "pkg-17.0.mod" = _Tmaqz4Ry;
        "pkg-18.0" = _klAKcoX6;
        "pkg-18.0.mod" = _Civh11wH;
        "pkg-19.0" = _PeWFaCsz;
        "pkg-19.0.mod" = _m276Gg1H;
        "pkg-20.0" = _tqlWl8P0;
        "pkg-20.0.mod" = _7T2efbsk;
        "pkg-21.0" = _jcp3Fy9M;
        "pkg-21.0.mod" = _rzIIoO01;
        "pkg-22.0" = _oJNejq1X;
        "pkg-22.0.mod" = _t7IqXZaJ;
        "pkg-23.0" = _CxCpbzUj;
        "pkg-23.0.mod" = _AtE7KzTd;
        "pkg-24.0" = _pNdfc44t;
        "pkg-24.0.mod" = _8m2ZUSs9;
        "pkg-24.1" = _Ypge4PJj;
