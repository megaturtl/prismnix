...
let
    versions = (let
        ...
        _Mgqoh4Go = {
            "id" = "Mgqoh4Go";
            "file" = "!   FreshDiscs - lowqualitygames 1.13-1.15.2.zip";
            "hash" = "sha512-uG8D8AVp/hKIN5LEm+L6QuuNdN/WiHAgYDXg+PCR6nhq/s+nuixsEFrvbc4Vkpk2AwSXK7McmyjbyskkDX3bUQ==";
        };
        _j57B6Ed1 = {
            "id" = "j57B6Ed1";
            "file" = "!   FreshDiscs - lowqualitygames 1.16-1.20.1.zip";
            "hash" = "sha512-PvzKLIo0FafQaqYd0YMFePvH1uwwpEwnL/XwEf0IkkHfSGYKtsP426yD75eEa1TRNxboin1Ip5oLz90r1nuwgw==";
        };
        _A6Qs2Tdx = {
            "id" = "A6Qs2Tdx";
            "file" = "!   FreshDiscs - lowqualitygames 1.20.2-26.3.zip";
            "hash" = "sha512-IotwZat4AcmxXU03x2QogDdn4toxyikeI/CtBBk3SgLqrRJtSx9I0De3qpgIJADqnWTyghmt9EEDAmHzH4UcDw==";
        };
        _StMB7fZx = {
            "id" = "StMB7fZx";
            "file" = "!   FreshDiscs - lowqualitygames 1.7.2-1.10.2.zip";
            "hash" = "sha512-mmczuXRINITZFsI/xmmMrGU9nLn2Lw54l6XwPX1EVOG7Pgzbgj2HBZVZYZ+E/WRW3X8QOBAw+oGKxjXtXLaMPQ==";
        };
        _7N9Ys6TK = {
            "id" = "7N9Ys6TK";
            "file" = "!   FreshDiscs - lowqualitygames 1.13-1.15.2.zip";
            "hash" = "sha512-73cjwSfv8XtEQQoW8I4C9tRG2m+yqE+q9W7tDiTRuxUOLMCFJv9X9BuYWkBFrt7wYFliQZdhFwJHcyA+pzD/vA==";
        };
        _Uhbqbqes = {
            "id" = "Uhbqbqes";
            "file" = "!   FreshDiscs - lowqualitygames 1.16-1.20.1.zip";
            "hash" = "sha512-obJJhAL9+IjBQ+aIDGSwZR0paoYolOXh/66VKkkzL4VVwnMAvBpwvP82aAqxGyxxDacQspBGG9mO0xvSLoAXOA==";
        };
        _7LqU6Gap = {
            "id" = "7LqU6Gap";
            "file" = "!   FreshDiscs - lowqualitygames 1.20.2-26.3.zip";
            "hash" = "sha512-9pfCyzO+PZZFakLfxF3tToHBiNc8dhybWGCzug+lDZwz6Nd/vSdaj6MOP5Iqelr9e5Hf5fUPHTv/k4PL4/Xuaw==";
        };
        _pCy437oW = {
            "id" = "pCy437oW";
            "file" = "!   FreshDiscs - lowqualitygames 1.13-1.15.2.zip";
            "hash" = "sha512-JeHxz0m0/HYAxcq/po3uzk4iQ7vrFZeS+tEBF7iYhJrM4JUhQDLaOEz1Di88/3H7p2Kvd95qR5ObcgbPvJKyxg==";
        };
        _7wiR72Dp = {
            "id" = "7wiR72Dp";
            "file" = "!   FreshDiscs - lowqualitygames 1.16-1.20.1.zip";
            "hash" = "sha512-zPrIhF3O4Nudp/YLO7hPTY3Z5518D1aGMQ07L4yiWSGbx37VOAhlZhG4XFqTL7Ch8miypVuvTSvShlxSsJCNKw==";
        };
        _b3eAGAeo = {
            "id" = "b3eAGAeo";
            "file" = "!   FreshDiscs - lowqualitygames 1.20.2-26.3.zip";
            "hash" = "sha512-l3Uh/vuv9aq6zqNOADYWWp1Mx6qFl6xJpi4aEC9nLaeg8GhtjYIOx5J/9dwtUSHVF8gWUOsUaokqttz1wzN/0Q==";
        };
        _42irjaGt = {
            "id" = "42irjaGt";
            "file" = "!   FreshDiscs - lowqualitygames 1.7.2-1.10.2.zip";
            "hash" = "sha512-4D32pTCG9ZAOuOt3UQucGk6kDowOwMjykVTnksEOJhbWRse6+ep1N3NuijwUflMoK/enEt198eUG9YOaOnTvKw==";
        };
        _xCyoHkzv = {
            "id" = "xCyoHkzv";
            "file" = "!   FreshDiscs - lowqualitygames 1.11-1.12.2.zip";
            "hash" = "sha512-8A+hNAOhNLH2E9LTu7vBipZ+XJ0ThVS5nUwtoEmBpNHSAtfXvKRDofft/XEC0WCoJhPMrvBYOdSdotnyygjYPg==";
        };
    in {
        "TyBZ2mfq" = _TyBZ2mfq;
        "a28QzMH5" = _a28QzMH5;
        ...
        "42irjaGt" = _42irjaGt;
        "xCyoHkzv" = _xCyoHkzv;
        "minecraft-1.20.2" = _b3eAGAeo;
        "minecraft-1.20.3" = _b3eAGAeo;
        "minecraft-1.20.4" = _b3eAGAeo;
        "minecraft-1.20.5" = _b3eAGAeo;
        "minecraft-1.20.6" = _b3eAGAeo;
        "minecraft-1.21" = _b3eAGAeo;
        "minecraft-1.21.1" = _b3eAGAeo;
        "minecraft-1.21.2" = _b3eAGAeo;
        "minecraft-1.21.3" = _b3eAGAeo;
        "minecraft-1.21.4" = _b3eAGAeo;
        "minecraft-1.21.5" = _b3eAGAeo;
        "minecraft-1.13" = _pCy437oW;
        "minecraft-1.13.1" = _pCy437oW;
        "minecraft-1.13.2" = _pCy437oW;
        "minecraft-1.14" = _pCy437oW;
        "minecraft-1.14.1" = _pCy437oW;
        "minecraft-1.14.2" = _pCy437oW;
        "minecraft-1.14.3" = _pCy437oW;
        "minecraft-1.14.4" = _pCy437oW;
        "minecraft-1.15" = _pCy437oW;
        "minecraft-1.15.1" = _pCy437oW;
        "minecraft-1.15.2" = _pCy437oW;
        "minecraft-1.16" = _7wiR72Dp;
        "minecraft-1.16.1" = _7wiR72Dp;
        "minecraft-1.16.2" = _7wiR72Dp;
        "minecraft-1.16.3" = _7wiR72Dp;
        "minecraft-1.16.4" = _7wiR72Dp;
        "minecraft-1.16.5" = _7wiR72Dp;
        "minecraft-1.17" = _7wiR72Dp;
        "minecraft-1.17.1" = _7wiR72Dp;
        "minecraft-1.18" = _7wiR72Dp;
        "minecraft-1.18.1" = _7wiR72Dp;
        "minecraft-1.18.2" = _7wiR72Dp;
        "minecraft-1.19" = _7wiR72Dp;
        "minecraft-1.19.1" = _7wiR72Dp;
        "minecraft-1.19.2" = _7wiR72Dp;
        "minecraft-1.19.3" = _7wiR72Dp;
        "minecraft-1.19.4" = _7wiR72Dp;
        "minecraft-1.20" = _7wiR72Dp;
        "minecraft-1.20.1" = _7wiR72Dp;
        "minecraft-1.21.6" = _b3eAGAeo;
        "minecraft-1.21.7" = _b3eAGAeo;
        "minecraft-1.21.8" = _b3eAGAeo;
        "minecraft-1.21.9" = _b3eAGAeo;
        "minecraft-1.21.10" = _b3eAGAeo;
        "minecraft-1.21.11" = _b3eAGAeo;
        "minecraft-1.11" = _xCyoHkzv;
        "minecraft-1.11.1" = _xCyoHkzv;
        "minecraft-1.11.2" = _xCyoHkzv;
        "minecraft-1.12" = _xCyoHkzv;
        "minecraft-1.12.1" = _xCyoHkzv;
        "minecraft-1.12.2" = _xCyoHkzv;
        "minecraft-26.1-pre-1" = _tZxSjGII;
        "minecraft-26.1-pre-2" = _tZxSjGII;
        "minecraft-26.1" = _b3eAGAeo;
        "minecraft-26.1.1" = _b3eAGAeo;
        "minecraft-26.1.2" = _b3eAGAeo;
        "minecraft-26.2" = _b3eAGAeo;
        "minecraft-26.3-snapshot-1" = _7LqU6Gap;
        "minecraft-26.3-snapshot-2" = _7LqU6Gap;
        "minecraft-26.3-snapshot-3" = _7LqU6Gap;
        "minecraft-26.3-snapshot-4" = _7LqU6Gap;
        "minecraft-26.3-snapshot-5" = _7LqU6Gap;
        "minecraft-26.3-snapshot-6" = _7LqU6Gap;
        "minecraft-26.3-snapshot-7" = _7LqU6Gap;
        "minecraft-26.3-snapshot-8" = _7LqU6Gap;
        "minecraft-26.3-snapshot-9" = _7LqU6Gap;
        "minecraft-1.7.2" = _42irjaGt;
        "minecraft-1.7.3" = _42irjaGt;
        "minecraft-1.7.4" = _42irjaGt;
        "minecraft-1.7.5" = _42irjaGt;
        "minecraft-1.7.6" = _42irjaGt;
        "minecraft-1.7.7" = _42irjaGt;
        "minecraft-1.7.8" = _42irjaGt;
        "minecraft-1.7.9" = _42irjaGt;
        "minecraft-1.7.10" = _42irjaGt;
        "minecraft-1.8" = _42irjaGt;
        "minecraft-1.8.1" = _42irjaGt;
        "minecraft-1.8.2" = _42irjaGt;
        "minecraft-1.8.3" = _42irjaGt;
        "minecraft-1.8.4" = _42irjaGt;
        "minecraft-1.8.5" = _42irjaGt;
        "minecraft-1.8.6" = _42irjaGt;
        "minecraft-1.8.7" = _42irjaGt;
        "minecraft-1.8.8" = _42irjaGt;
        "minecraft-1.8.9" = _42irjaGt;
        "minecraft-1.9" = _42irjaGt;
        "minecraft-1.9.1" = _42irjaGt;
        "minecraft-1.9.2" = _42irjaGt;
        "minecraft-1.9.3" = _42irjaGt;
        "minecraft-1.9.4" = _42irjaGt;
        "minecraft-1.10" = _42irjaGt;
        "minecraft-1.10.1" = _42irjaGt;
        "minecraft-1.10.2" = _42irjaGt;
        "minecraft-26.3-snapshot-10" = _7LqU6Gap;
        "minecraft-26.3-pre-1" = _b3eAGAeo;
        "minecraft-26.3-pre-2" = _b3eAGAeo;
        "minecraft-26.3-pre-3" = _b3eAGAeo;
        "minecraft-26.3-rc-1" = _b3eAGAeo;
        "minecraft-26.3-rc-2" = _b3eAGAeo;
        "pkg-0.1" = _a28QzMH5;
        "pkg-0.2" = _hLr98WC7;
        "pkg-0.3" = _Do9noJtc;
        "pkg-0.4" = _em4thhHB;
        ...
        "pkg-1.4" = _z0AGZQop;
        "pkg-1.5" = _A6Qs2Tdx;
        "pkg-1.2-late-release" = _StMB7fZx;
        "pkg-1.6" = _7LqU6Gap;
        "pkg-1.6-optimized" = _b3eAGAeo;
        "pkg-1.2-optimized" = _xCyoHkzv;
        "default" = _xCyoHkzv;
    });
