...
let
    versions = (let
        ...
        _8MkDZkJA = {
            "id" = "8MkDZkJA";
            "file" = "YungsBetterDesertTemples-26.1.2-Fabric-5.1.1.jar";
            "hash" = "sha512-iYvyD0ZRkqAOGkpL9k7qDfvMx1p9CWRklSdk+Ag+ZQCmdsUIF+qMJyc/4A0+MUXrVuV7wHVyDzp7oN51RGXnMQ==";
        };
        _c5C5dZJ8 = {
            "id" = "c5C5dZJ8";
            "file" = "YungsBetterDesertTemples-26.1.2-NeoForge-5.1.1.jar";
            "hash" = "sha512-blCWyvax3jJqL2bbxlHd8FfEkNTA75IaXq1RGx/bEh6OSxAe4Ah0GYHbLebC0i/KtmpeGn6COZax+QrFlWPXLQ==";
        };
    in {
        "QqT68vQL" = _QqT68vQL;
        "L4h3G4u8" = _L4h3G4u8;
        ...
        "fabric-26.1.1" = _8MkDZkJA;
        "fabric-26.1.2" = _8MkDZkJA;
        "neoforge-1.20.4" = _cX43WPt5;
        "neoforge-1.21.1" = _GQ9iNWkI;
        "neoforge-1.21" = _GQ9iNWkI;
        "neoforge-1.21.4" = _eUMO4Bdh;
        "neoforge-26.1.1" = _c5C5dZJ8;
        "neoforge-26.1.2" = _c5C5dZJ8;
        "pkg-1.19.2-Forge-2.2.1" = _QqT68vQL;
        "pkg-1.19.2-Fabric-2.2.1" = _L4h3G4u8;
        "pkg-1.19.2-Forge-2.2.2" = _4szLNMTj;
        "pkg-1.19.2-Fabric-2.2.2" = _fPGcJ7Ts;
        "pkg-1.19.3-Forge-2.3.0" = _MtlwvaOG;
        "pkg-1.19.3-Fabric-2.3.0" = _p8cwpZLc;
        "pkg-1.19.4-Fabric-2.4.0" = _XPZvt9X7;
        "pkg-1.19.4-Forge-2.4.0" = _Sa1Psnly;
        "pkg-1.20-Forge-3.0.1" = _ChDXLIZS;
        "pkg-1.20-Fabric-3.0.1" = _xrrG1pue;
        "pkg-1.20-Forge-3.0.2" = _4a8fruuc;
        "pkg-1.20-Fabric-3.0.2" = _v4pDHgFV;
        "pkg-1.20-Forge-3.0.3" = _lRK2ZA9U;
        "pkg-1.20-Fabric-3.0.3" = _1Z9HNWpj;
        "pkg-1.20.4-Forge-3.4.0" = _sscYfIzO;
        "pkg-1.20.4-Fabric-3.4.0" = _Rnvv7pHS;
        "pkg-1.20.4-Forge-3.4.1" = _dCWZlWYv;
        "pkg-1.20.4-Fabric-3.4.1" = _ubWx2R23;
        "pkg-1.20.4-Forge-3.4.2" = _i3nkVPfA;
        "pkg-1.20.4-NeoForge-3.4.2" = _9Hoqyuad;
        "pkg-1.20.4-Fabric-3.4.2" = _PPFN6otn;
        "pkg-1.20.4-Forge-3.4.3" = _Rfwd8KoN;
        "pkg-1.20.4-NeoForge-3.4.3" = _Hcmz4q2I;
        "pkg-1.20.4-Fabric-3.4.3" = _WSCc2UQ6;
        "pkg-1.20.4-Forge-3.4.4" = _UR5dmUeN;
        "pkg-1.20.4-NeoForge-3.4.4" = _cX43WPt5;
        "pkg-1.20.4-Fabric-3.4.4" = _wCG6Lqw9;
        "pkg-1.21.1-Fabric-4.1.0" = _ZCy75nMX;
        "pkg-1.21.1-Forge-4.1.0" = _vAvMUkkj;
        "pkg-1.21.1-NeoForge-4.1.0" = _5SMNguuV;
        "pkg-1.21.1-Forge-4.1.1" = _fKudapvW;
        "pkg-1.21.1-NeoForge-4.1.1" = _TCDeMfz9;
        "pkg-1.21.1-Fabric-4.1.1" = _7OwwSyUp;
        "pkg-1.21.1-Forge-4.1.2" = _xmMMCBj8;
        "pkg-1.21.1-NeoForge-4.1.2" = _TPmwhutI;
        "pkg-1.21.1-Fabric-4.1.2" = _wyk3RO8o;
        "pkg-1.21.1-Fabric-4.1.3" = _24pS4i8d;
        "pkg-1.21.1-NeoForge-4.1.3" = _3J7rwhqh;
        "pkg-1.21.1-Forge-4.1.3" = _BizicyDR;
        "pkg-1.21.1-Forge-4.1.4" = _YfDtyvIb;
        "pkg-1.21.1-NeoForge-4.1.4" = _n3dqXFGK;
        "pkg-1.21.1-Fabric-4.1.4" = _TWRjrgyx;
        "pkg-1.21.1-Forge-4.1.5" = _hHnNYiZy;
        "pkg-1.21.1-NeoForge-4.1.5" = _GQ9iNWkI;
        "pkg-1.21.1-Fabric-4.1.5" = _M6eeDRkC;
        "pkg-1.21.4-NeoForge-4.4.0" = _eUMO4Bdh;
        "pkg-1.21.4-Fabric-4.4.0" = _W68glo4a;
        "pkg-26.1.2-Fabric-5.1.0" = _Fv7ssFpr;
        "pkg-26.1.2-NeoForge-5.1.0" = _PdYp5G62;
        "pkg-26.1.2-Fabric-5.1.1" = _8MkDZkJA;
        "pkg-26.1.2-NeoForge-5.1.1" = _c5C5dZJ8;
        "default" = _c5C5dZJ8;
    });
