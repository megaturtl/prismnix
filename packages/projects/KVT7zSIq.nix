...
let
    versions = (let
        ...
        _yUt31hea = {
            "id" = "yUt31hea";
            "file" = "§6MrOres 3D§a-Glowing V2.zip";
            "hash" = "sha512-IkCCAULoBE0uhWzvFD9YXqCkhEljFRDs7k14WdAWY22hHk0IgqmKA35naWgTdcoxRlJq+0EuQPmq9WxxtmnBqg==";
        };
    in {
        "O3dp24QQ" = _O3dp24QQ;
        "eqbsvLhT" = _eqbsvLhT;
        ...
        "minecraft-1.20" = _yUt31hea;
        "minecraft-1.20.1" = _yUt31hea;
        "minecraft-1.20.2" = _yUt31hea;
        "minecraft-1.20.3" = _yUt31hea;
        "minecraft-1.20.4" = _yUt31hea;
        "minecraft-1.20.5" = _yUt31hea;
        "minecraft-1.20.6" = _yUt31hea;
        "minecraft-1.21" = _yUt31hea;
        "minecraft-1.21.1" = _yUt31hea;
        "minecraft-1.21.2" = _yUt31hea;
        "minecraft-1.21.3" = _yUt31hea;
        "minecraft-1.21.4" = _yUt31hea;
        "minecraft-1.21.5" = _yUt31hea;
        "minecraft-1.21.6" = _yUt31hea;
        "minecraft-1.21.7" = _yUt31hea;
        "minecraft-1.21.8" = _yUt31hea;
        ...
        "minecraft-1.21.9" = _yUt31hea;
        "minecraft-1.21.10-rc1" = _rug4kH95;
        "minecraft-1.21.10" = _yUt31hea;
        ...
        "minecraft-1.20.2-pre1" = _yUt31hea;
        ...
        "minecraft-1.20.5-pre1" = _yUt31hea;
        "minecraft-1.20.5-pre2" = _yUt31hea;
        "minecraft-1.20.5-pre3" = _yUt31hea;
        ...
        "minecraft-1.21.2-pre1" = _yUt31hea;
        "minecraft-1.21.2-pre2" = _yUt31hea;
        ...
        "minecraft-23w31a" = _yUt31hea;
        "minecraft-23w32a" = _yUt31hea;
        "minecraft-23w33a" = _yUt31hea;
        "minecraft-23w35a" = _yUt31hea;
        "minecraft-23w42a" = _yUt31hea;
        "minecraft-23w43a" = _yUt31hea;
        "minecraft-23w43b" = _yUt31hea;
        "minecraft-23w44a" = _yUt31hea;
        "minecraft-23w45a" = _yUt31hea;
        "minecraft-23w46a" = _yUt31hea;
        "minecraft-24w03a" = _yUt31hea;
        "minecraft-24w03b" = _yUt31hea;
        "minecraft-24w04a" = _yUt31hea;
        "minecraft-24w05a" = _yUt31hea;
        "minecraft-24w05b" = _yUt31hea;
        "minecraft-24w06a" = _yUt31hea;
        "minecraft-24w07a" = _yUt31hea;
        "minecraft-24w09a" = _yUt31hea;
        "minecraft-24w10a" = _yUt31hea;
        "minecraft-24w11a" = _yUt31hea;
        "minecraft-24w12a" = _yUt31hea;
        "minecraft-24w13a" = _yUt31hea;
        "minecraft-24w14potato" = _yUt31hea;
        "minecraft-24w14a" = _yUt31hea;
        "minecraft-24w18a" = _yUt31hea;
        "minecraft-24w19a" = _yUt31hea;
        "minecraft-24w19b" = _yUt31hea;
        "minecraft-24w20a" = _yUt31hea;
        "minecraft-24w33a" = _yUt31hea;
        "minecraft-24w34a" = _yUt31hea;
        "minecraft-24w35a" = _yUt31hea;
        "minecraft-24w36a" = _yUt31hea;
        "minecraft-24w37a" = _yUt31hea;
        "minecraft-24w38a" = _yUt31hea;
        "minecraft-24w39a" = _yUt31hea;
        "minecraft-24w40a" = _yUt31hea;
        "minecraft-24w44a" = _yUt31hea;
        "minecraft-24w45a" = _yUt31hea;
        "minecraft-24w46a" = _yUt31hea;
        "minecraft-1.21.11" = _yUt31hea;
        "minecraft-26.1" = _yUt31hea;
        "minecraft-26.1.1" = _yUt31hea;
        "minecraft-26.1.2" = _yUt31hea;
        "minecraft-26.2" = _yUt31hea;
        "minecraft-26.1-pre-1" = _yUt31hea;
        "minecraft-26.1-pre-2" = _yUt31hea;
        "minecraft-26.1-pre-3" = _yUt31hea;
        "minecraft-26.1-rc-1" = _yUt31hea;
        "minecraft-26.1-rc-2" = _yUt31hea;
        "minecraft-26.1-rc-3" = _yUt31hea;
        "minecraft-26.1.1-rc-1" = _yUt31hea;
        "minecraft-26.1.2-rc-1" = _yUt31hea;
        "minecraft-26.2-pre-1" = _yUt31hea;
        "minecraft-26.2-pre-2" = _yUt31hea;
        "minecraft-26.2-pre-3" = _yUt31hea;
        "minecraft-26.2-pre-4" = _yUt31hea;
        "minecraft-26.2-pre-5" = _yUt31hea;
        "minecraft-26.2-pre-6" = _yUt31hea;
        "minecraft-26.2-rc-1" = _yUt31hea;
        "minecraft-26.2-rc-2" = _yUt31hea;
        "minecraft-26.3-pre-1" = _yUt31hea;
        "minecraft-26.3-pre-2" = _yUt31hea;
        "minecraft-26.3-pre-3" = _yUt31hea;
        "minecraft-26.3-rc-1" = _yUt31hea;
        "minecraft-26.3-rc-2" = _yUt31hea;
        "minecraft-26.3-rc-3" = _yUt31hea;
        "minecraft-26.3" = _yUt31hea;
        "pkg-1.0" = _LRJ3ucUY;
        "pkg-1.0.1" = _p0ghCiv3;
        "pkg-1.0.2" = _LGyKLdBL;
        "pkg-1.0.3" = _rug4kH95;
        "pkg-1.18.2-1.19.4" = _CAHFV69q;
        "pkg-1.20-1.21.5" = _YLcvYP0I;
        "pkg-1.21.6-1.21.8" = _B8yXXyJx;
        "pkg-1.21.9-1.21.11" = _j5xSaQDj;
        "pkg-26.0-26.1.2" = _4C4dsa7v;
        "pkg-26.2" = _nTrxjJ3p;
        "pkg-V2" = _yUt31hea;
        "default" = _yUt31hea;
    });
