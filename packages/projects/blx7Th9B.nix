...
let
    ...
    in {
        ...
        "pkg-1.9.1" = _eU3GS6Sz;
        "pkg-1.9.2" = _F7sRGiQA;
        "pkg-1.9.2.1" = _VGXOvHV8;
        "pkg-1.9.3-1.18.2" = _Iy8etHSJ;
        "pkg-1.9.3-1.19" = _8YZMcGwr;
        "pkg-1.9.3-1.19.1" = _hNuQNdrP;
        "pkg-1.9.3-1.19.2" = _adv5kCcO;
        "pkg-1.9.3.1-1.18.2" = _83PsS8Rt;
        "pkg-1.9.3.1-1.19.2" = _EedvH6Lv;
        "pkg-1.9.4-1.18.2" = _HWv9srXg;
        "pkg-1.9.4-1.19.3" = _pCKZVyZB;
        "pkg-1.9.5-1.18.2" = _GhqHVbvl;
        "pkg-1.9.5-1.19.4" = _So5PBokW;
        "pkg-1.9.6-1.18.2" = _PyZcbGnL;
        "pkg-1.9.6-1.19.4" = _mjoe6Z2Z;
        "pkg-1.9.6-1.20" = _bUIyVmkT;
        "pkg-1.9.6.1-1.19.4" = _Ku0V4Qkz;
        "pkg-1.9.6.1-1.20.1" = _imAs4F6x;
        "pkg-1.9.6.2-1.20.2" = _Bp6sqSBL;
        "pkg-1.9.6.3-1.20.3" = _MDIusHkO;
        "pkg-1.9.6.4-1.20.4" = _eBnCWHki;
        "pkg-1.9.7+mc1.20.4" = _F7LrMwdd;
        "pkg-1.9.7.1+mc1.20.x" = _3SMaWnUN;
        "pkg-1.9.7.2+mc1.20.x" = _MFRj7fRd;
        "pkg-1.9.7.3+mc1.20.x" = _yu8Z1PF9;
        "pkg-1.9.7.4+mc1.20.x" = _OvdrP5eg;
        "pkg-1.9.7.5+mc1.20.x" = _XZnATe3C;
        "pkg-1.9.7.6+mc1.20.x" = _6Lntk6yg;
        "pkg-1.9.7.7+mc1.20.x" = _avI7vTJJ;
        "pkg-1.9.8+mc1.21.x" = _8r2s5xSo;
        "pkg-1.9.8.1+1.21.x" = _1CpxJRKr;
        "pkg-1.9.8.2+mc1.21.x" = _QjO1ZRn5;
        "pkg-1.9.8.3+mc1.21.x" = _OFXXIo5t;
        "pkg-1.9.8.4+mc1.21.3x" = _JaKfWmvz;
        "pkg-1.9.8.5+mc1.21.4x" = _Qr0vL8JV;
        "pkg-1.10" = _wNiP9eB6;
        "pkg-1.10.1" = _HdD9OEvc;
        "pkg-1.11" = _NyV0Z5XE;
        "pkg-1.11.1" = _K7FahubI;
        "pkg-1.11.2" = _QO7oVPeL;
        "pkg-1.11.3" = _TQIrXmR4;
        "pkg-1.11.4" = _FLhF7de8;
        "pkg-1.11.5" = _RkEPN2i2;
        "pkg-1.11.6" = _cdcyC9Ck;
        "pkg-1.11.7" = _f7NmxrW8;
        "pkg-1.11.8" = _wMJdOxrt;
        "pkg-1.11.9" = _Gi2DQlrA;
        "pkg-1.11.10" = _hob6g0cK;
        "pkg-1.12" = _j7lnPldo;
        "pkg-1.12.1" = _ahzv2E0L;
        "pkg-1.12.2" = _32yn0j3A;
        "pkg-1.12.3" = _2CN4Ifn1;
        "pkg-1.12.4" = _oOl6ECxu;
