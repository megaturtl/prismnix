...
let
    versions = (let
        ...
        _wcNcFHT3 = {
            "id" = "wcNcFHT3";
            "file" = "homestead.jar";
            "hash" = "sha512-J4c0j8KXNJSd/shYuTDAx/nQG9vR+nvP3FDHwzWz3v78o2QM4gQV4jK+JyNnrLkM5Mf2hku/zHzFlPcrNqb00w==";
        };
        _fYHGlMd7 = {
            "id" = "fYHGlMd7";
    ...
    in {
        ...
        "pkg-2.3.3" = _MIKlSdCD;
        "pkg-2.4.0" = _9ZTQW1y0;
        "pkg-2.5.0-prerelease-1" = _plrYBCS3;
        "pkg-2.5.0-prerelease-2" = _6ohZmklR;
        "pkg-2.5.0" = _cJcnrfTP;
        "pkg-2.5.1" = _4DJXX86x;
        "pkg-2.5.2" = _sq0eHVAk;
        "pkg-2.6.0" = _KPaSGOlZ;
        ...
        "pkg-3.5.3" = _1Wc2tnC1;
        "pkg-3.5.4" = _PgbyDetN;
        "pkg-3.6.0-snapshot-1745780194025" = _8cN6yUGp;
        "pkg-3.6.0-snapshot-1746046328941" = _Rc16lxpf;
        "pkg-3.6.0-snapshot-1746104004229" = _MUT4dMq2;
        "pkg-3.6.0-snapshot-1746206782524" = _YllPJrOs;
        "pkg-3.6.0" = _HURaC6vp;
        "pkg-3.6.1" = _28b6czyS;
        "pkg-4.0.0-25w24a" = _9nQZaq5m;
        "pkg-4.0.0-25w25a" = _V70qzyGV;
        "pkg-4.0.0-25w25b" = _wiVFVF9f;
        "pkg-4.0.0" = _VHL0AEGK;
        "pkg-4.0.1" = _Jb1YplpY;
        "pkg-4.0.2" = _zrmigJb1;
        "pkg-4.0.3" = _aVZuyBTe;
        ...
        "pkg-4.1.2" = _2KXjHXrA;
        "pkg-4.1.3" = _qb2l60RC;
        "pkg-4.2.0-25w50a" = _Omhy644b;
        "pkg-4.2.0" = _kCeU1Eyo;
        "pkg-4.3.0-25w52a" = _ycT1rTa6;
        "pkg-4.3.0" = _PBOBqLuk;
        "pkg-4.3.1" = _3kgCY4jF;
        "pkg-5.0.0.0-26w04a" = _dmVEH9xq;
        "pkg-5.0.0.0-26w04b" = _VJ8Osfp1;
        "pkg-5.0.0.0-26w05a" = _N4jdy3Rx;
        "pkg-5.0.0.0" = _C4j37ls7;
        "pkg-5.0.0.1" = _Wj5MRD7q;
        "pkg-5.0.0.2" = _EUWFin6p;
        "pkg-5.0.1.0-26w08a" = _Nbwwvi2c;
        "pkg-5.0.1.0-26w08b" = _ZheQXZqm;
        "pkg-5.0.1.0" = _3AM7b0AR;
        "pkg-5.0.1.1" = _765KiHcC;
        "pkg-5.0.1.2" = _2EJqpNwx;
        "pkg-5.0.1.3" = _EebvB1Xo;
        "pkg-5.0.1.4" = _l6wqQ1yK;
        "pkg-5.0.2.0" = _oSx9Y2Zv;
        "pkg-5.0.2.1" = _SipRwsen;
        "pkg-5.0.2.2" = _O6fyuq8C;
        "pkg-5.1.0.0-26w14a" = _QmJ28tBl;
        "pkg-5.1.0.0-26w15a" = _joemj91G;
        "pkg-5.1.0.0-26w15b" = _u70ie0jw;
        "pkg-5.1.0.0-26w15c" = _nLPw8c4b;
        "pkg-5.1.0.0-26w16a" = _lwNNypmP;
        "pkg-5.1.0.0-rc-1" = _PQxyF6fY;
        "pkg-5.1.0.0" = _80AvupoZ;
        "pkg-5.1.0.1" = _YoYDvG0y;
        "pkg-5.2.0.0-26w18a" = _zCIX0A96;
        "pkg-5.2.0.0-26w18b" = _dVP6jhC2;
        "pkg-5.2.0.0" = _dTwc7rf8;
        "pkg-5.2.0.1" = _7px3nvox;
        "pkg-5.2.1.0-26w22a" = _VU8zyEPn;
        "pkg-5.2.1.0" = _VYPH5DwJ;
        "pkg-5.2.2.0" = _LQ6veKTJ;
        "pkg-5.2.2.1" = _6kaoDO6j;
