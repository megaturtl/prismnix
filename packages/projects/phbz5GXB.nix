...
let
    ...
    in {
        ...
        "pkg-18" = _Zx1P3kKC;
        "pkg-32" = _4sWDW6Bo;
        "pkg-34-Panes" = _nSpeuWfM;
        "pkg-34-Blocks" = _Wm1z39gO;
        "pkg-34-All" = _vdZAQlDp;
        "pkg-46-Panes" = _fM7fux57;
        "pkg-46-Blocks" = _dkXsN8p3;
        "pkg-46-All" = _qv4RghZQ;
        "pkg-55-Blocks" = _6hkzh4YO;
        "pkg-55-All" = _iaK07bjQ;
        "pkg-55-Panes" = _Ry5LVjCp;
        "pkg-64-Blocks" = _944WZamQ;
        "pkg-64-All" = _1OwoglXy;
        "pkg-64-Panes" = _jSTrpRTg;
        "pkg-69-Blocks" = _G52l2alq;
        "pkg-69-All" = _Nx0T5got;
        "pkg-69-Panes" = _HxlW8JmN;
        "pkg-75-Blocks" = _eQ6NZlS4;
        "pkg-75-All" = _YUF1GSj3;
        "pkg-75-Panes" = _pB8ZeMI2;
        "pkg-75" = _3XZY8qvO;
        "pkg-84" = _r2UYzaK9;
        "pkg-84.1" = _AeDB0RnO;
        "pkg-84.2" = _T4Wf21KK;
