...
let
    versions = (let
        ...
        _NKlMHJ7C = {
            "id" = "NKlMHJ7C";
            "file" = "[DP] Recycling 4.7.1.zip";
            "hash" = "sha512-eSk90FiCfF/OoSyWxW5RytR9nI7ExzYTSslirDoVplM0TlclzzwGf+nq/ln1tlL0OmG68+hyNImBJRmFcMH15g==";
        };
        _SOmBTCZd = {
            "id" = "SOmBTCZd";
            "file" = "recyclings-4.7.1.jar";
            "hash" = "sha512-7YT697eqoK7VMGogGJGapEWLgiKsdZmobsj5Pdjkxs76JW77PEZots+fk82ugeeGqgZCr7NDmJUgegOo5l41xQ==";
        };
        _GtYDCDuM = {
            "id" = "GtYDCDuM";
            "file" = "[DP] Recycling 5.0.0.zip";
            "hash" = "sha512-tvBhJgi50OiXfJ5HsH3LnCaXScR4UBhNUL6rebFAPadXkcJ6Lk6azOpbeP8YfMR3j1P1HrN/cuITeEWrj5Y8UQ==";
        };
        _WhoGQKPZ = {
            "id" = "WhoGQKPZ";
            "file" = "recyclings-5.0.0.jar";
            "hash" = "sha512-N3LjDh9YSG5Lv0KdPs8yFOc206bK2FQElbkCamM0ozjSOfYZNmW5wDexnwYvRst/DifhnSZpTEjycQEeZm9oAQ==";
        };
        _PwFkZFur = {
            "id" = "PwFkZFur";
            "file" = "[DP] Recycling 5.0.1.zip";
            "hash" = "sha512-YM4elYP4qSIC9hlFFZKE4BtMgh92XAMWyjmeaANYu8thi88wTQZFm9eXiiIdZf3IT817BHvIUwUDiI8QJ9VVDA==";
        };
        _yumfeNxd = {
            "id" = "yumfeNxd";
            "file" = "recyclings-5.0.1.jar";
            "hash" = "sha512-/275iS+KwT0C3XLhx2K4xITBM5IK11wRh8gyNkADpKZuKp8P9v6Ke7tmaka/+7iO64+7ynbAvL5LEDVzb9NMrw==";
        };
        _dHtHmyyP = {
            "id" = "dHtHmyyP";
            "file" = "[DP] Recycling 5.0.2.zip";
            "hash" = "sha512-2nzri3Q4cbZhpRbljd91OFbxUuntSK+enStakqPOkt9StpZK/kss25V3Q5WAywa8DmOMAbZJdl1d7jX37I39UQ==";
        };
        _GZUL539V = {
            "id" = "GZUL539V";
            "file" = "recyclings-5.0.2.jar";
            "hash" = "sha512-AklJ6k7CyPieVlICT/XGA7ctSzztXSHQ0V+tBhxwNfRFCt/btwC4MaJpGlhrq80W28yoeuO4dTCjt6c9pEZ4zQ==";
        };
        _yj2Uxyra = {
            "id" = "yj2Uxyra";
            "file" = "[DP] Recycling 5.1.0.zip";
            "hash" = "sha512-P6xErwxbq3YN7yk73VK+BachdFCqpiw5VmnmsIU1w0nLJpB1FrmRvK1org2H2l0sZAidErYkkL3bq5bkWOOaOw==";
        };
        _9znX0QOU = {
            "id" = "9znX0QOU";
            "file" = "recyclings-5.1.0.jar";
            "hash" = "sha512-9brarSR4V2ZJaC4S3nyO8qhxRc5fIg6gi95dSgK7bBYXImczlU3QinlYtrnfW5k1F2XeWT26vRHXkgAgW7Nmpg==";
        };
        _OXRIsmRP = {
            "id" = "OXRIsmRP";
            "file" = "[DP] Recycling 5.1.1.zip";
            "hash" = "sha512-E0hGYMozqqSeBMdnhl7SYxKRrperiBwZNjgcq8FsqsWaMrud89nZ4EMmfMddRstg6t9rUsF+ERzTUUZua01GTQ==";
        };
        _P7frl5PU = {
            "id" = "P7frl5PU";
            "file" = "recyclings-5.1.1.jar";
            "hash" = "sha512-STf5Z65fvDCEBVeTDPXYnuQU72sWZ5M9iu4HvXu9hV+o0C6MIKYc+IscKo51xi3oDV/iI3FPXTkbWhvZxDPe6Q==";
        };
        _UPSGxaDn = {
            "id" = "UPSGxaDn";
            "file" = "[DP] Recycling 5.1.2.zip";
            "hash" = "sha512-ZB1KZK/FbhDAYkfS8qhhz1/um9BA2ILm8dSzca+75lWU0j6uYieu15BcFgj2mpmTTYUxdogvptsdmaZR6etfWg==";
        };
        _8UqZ6gjv = {
            "id" = "8UqZ6gjv";
            "file" = "recyclings-5.1.2.jar";
            "hash" = "sha512-6HGysPoCpx1wanBQ5ShrmrSb5C+dI6I39ACp1hKzHOqR4Pfe113zLhfGZNwG8M0jyJgRGTbruu5pmaChqQNI9Q==";
        };
        _q5BWyDAn = {
            "id" = "q5BWyDAn";
            "file" = "[DP] Recycling 5.1.3.zip";
            "hash" = "sha512-a4mGQ/L77xtQCHhEH0+iAIIKZtUH6li83q0kVD44GjTATbDnGU3K8u5Jyh4WXaJMO7CBKasAam8zXWVEClD21A==";
        };
        _uSicVDJR = {
            "id" = "uSicVDJR";
            "file" = "recyclings-5.1.3.jar";
            "hash" = "sha512-LZtgMJhMK+qNvBxvHesVwjNRfbVRCK9Cw9Yk9LkC59rKVG/d14Bln05IMJRtxC+VTutDd76teXctVMqwtzEvzA==";
        };
        _e9zonAK1 = {
            "id" = "e9zonAK1";
            "file" = "[DP] Recycling 5.2.0.zip";
            "hash" = "sha512-8byYIpSCGGisKK3tE9OJQWLlKWd3p5j0D5GrYtNk5k+yD+Lsf6QIaW08nGy98LtWnXunoOChu0BkXuM1M2/iYA==";
        };
        _IxlRf7r2 = {
            "id" = "IxlRf7r2";
            "file" = "recyclings-5.2.0.jar";
            "hash" = "sha512-bR7sNdq8yBhG745jU6PQq4qA5GGG+ov96RaanCUT1fx2KpKAmrbU4W43kPRofUGaM1h5STVZuY50tHXuJZmRjw==";
        };
    in {
        "ayhmMkXQ" = _ayhmMkXQ;
        "OEPGOb21" = _OEPGOb21;
        ...
        "e9zonAK1" = _e9zonAK1;
        "IxlRf7r2" = _IxlRf7r2;
        "datapack-1.21.4" = _e9zonAK1;
        "datapack-1.21.5" = _e9zonAK1;
        ...
        "datapack-1.21.6" = _e9zonAK1;
        "datapack-1.21.7" = _e9zonAK1;
        "datapack-1.21.8" = _e9zonAK1;
        "datapack-25w31a" = _73fxIuYk;
        "datapack-25w32a" = _73fxIuYk;
        "datapack-25w33a" = _73fxIuYk;
        "datapack-1.21.9" = _e9zonAK1;
        "datapack-1.21.10" = _e9zonAK1;
        "datapack-25w41a" = _tQ2NtPR4;
        "datapack-25w42a" = _tQ2NtPR4;
        "datapack-25w43a" = _tQ2NtPR4;
        "datapack-1.21.2" = _e9zonAK1;
        "datapack-1.21.3" = _e9zonAK1;
        "datapack-25w44a" = _tQ2NtPR4;
        "datapack-25w45a" = _tQ2NtPR4;
        "datapack-25w46a" = _tQ2NtPR4;
        "datapack-1.21.11-pre1" = _tQ2NtPR4;
        "datapack-1.21.11" = _e9zonAK1;
        "datapack-26.1" = _e9zonAK1;
        "datapack-26.1.1" = _e9zonAK1;
        "datapack-26.1.2" = _e9zonAK1;
        "datapack-26.2-snapshot-2" = _Tbj8Is5Q;
        "datapack-1.16" = _e9zonAK1;
        "datapack-1.16.1" = _e9zonAK1;
        "datapack-1.16.2" = _e9zonAK1;
        "datapack-1.16.3" = _e9zonAK1;
        "datapack-1.16.4" = _e9zonAK1;
        "datapack-1.16.5" = _e9zonAK1;
        "datapack-1.17" = _e9zonAK1;
        "datapack-1.17.1" = _e9zonAK1;
        "datapack-1.18" = _e9zonAK1;
        "datapack-1.18.1" = _e9zonAK1;
        "datapack-1.18.2" = _e9zonAK1;
        "datapack-1.19" = _e9zonAK1;
        "datapack-1.19.1" = _e9zonAK1;
        "datapack-1.19.2" = _e9zonAK1;
        "datapack-1.19.3" = _e9zonAK1;
        "datapack-1.19.4" = _e9zonAK1;
        "datapack-1.20" = _e9zonAK1;
        "datapack-1.20.1" = _e9zonAK1;
        "datapack-1.20.2" = _e9zonAK1;
        "datapack-1.20.3" = _e9zonAK1;
        "datapack-1.20.4" = _e9zonAK1;
        "datapack-1.20.5" = _e9zonAK1;
        "datapack-1.20.6" = _e9zonAK1;
        "datapack-1.21" = _e9zonAK1;
        "datapack-1.21.1" = _e9zonAK1;
        ...
        "datapack-26.2" = _e9zonAK1;
        "datapack-26.3-snapshot-1" = _q5BWyDAn;
        "datapack-26.3-snapshot-2" = _q5BWyDAn;
        "datapack-26.3-snapshot-3" = _q5BWyDAn;
        "datapack-26.3-snapshot-4" = _q5BWyDAn;
        "datapack-26.3-snapshot-5" = _q5BWyDAn;
        "datapack-26.3-snapshot-6" = _q5BWyDAn;
        "datapack-26.3-snapshot-7" = _q5BWyDAn;
        "datapack-26.3-snapshot-8" = _q5BWyDAn;
        "datapack-26.3-snapshot-9" = _q5BWyDAn;
        "datapack-26.3-snapshot-10" = _q5BWyDAn;
        "datapack-26.3-pre-1" = _q5BWyDAn;
        "datapack-26.3-pre-2" = _q5BWyDAn;
        "datapack-26.3-pre-3" = _q5BWyDAn;
        "datapack-26.3" = _e9zonAK1;
        "fabric-1.21.4" = _IxlRf7r2;
        "fabric-1.21.5" = _IxlRf7r2;
        ...
        "fabric-1.21.6" = _IxlRf7r2;
        "fabric-1.21.7" = _IxlRf7r2;
        "fabric-1.21.8" = _IxlRf7r2;
        "fabric-25w31a" = _MVrPt2B9;
        "fabric-25w32a" = _MVrPt2B9;
        "fabric-25w33a" = _MVrPt2B9;
        "fabric-1.21.9" = _IxlRf7r2;
        "fabric-1.21.10" = _IxlRf7r2;
        "fabric-25w41a" = _yol51ePF;
        "fabric-25w42a" = _yol51ePF;
        "fabric-25w43a" = _yol51ePF;
        "fabric-1.21.2" = _IxlRf7r2;
        "fabric-1.21.3" = _IxlRf7r2;
        "fabric-25w44a" = _yol51ePF;
        "fabric-25w45a" = _yol51ePF;
        "fabric-25w46a" = _yol51ePF;
        "fabric-1.21.11-pre1" = _yol51ePF;
        "fabric-1.21.11" = _IxlRf7r2;
        "fabric-26.1" = _IxlRf7r2;
        "fabric-26.1.1" = _IxlRf7r2;
        "fabric-26.1.2" = _IxlRf7r2;
        "fabric-26.2-snapshot-2" = _2YidGhzY;
        "fabric-1.16" = _IxlRf7r2;
        "fabric-1.16.1" = _IxlRf7r2;
        "fabric-1.16.2" = _IxlRf7r2;
        "fabric-1.16.3" = _IxlRf7r2;
        "fabric-1.16.4" = _IxlRf7r2;
        "fabric-1.16.5" = _IxlRf7r2;
        "fabric-1.17" = _IxlRf7r2;
        "fabric-1.17.1" = _IxlRf7r2;
        "fabric-1.18" = _IxlRf7r2;
        "fabric-1.18.1" = _IxlRf7r2;
        "fabric-1.18.2" = _IxlRf7r2;
        "fabric-1.19" = _IxlRf7r2;
        "fabric-1.19.1" = _IxlRf7r2;
        "fabric-1.19.2" = _IxlRf7r2;
        "fabric-1.19.3" = _IxlRf7r2;
        "fabric-1.19.4" = _IxlRf7r2;
        "fabric-1.20" = _IxlRf7r2;
        "fabric-1.20.1" = _IxlRf7r2;
        "fabric-1.20.2" = _IxlRf7r2;
        "fabric-1.20.3" = _IxlRf7r2;
        "fabric-1.20.4" = _IxlRf7r2;
        "fabric-1.20.5" = _IxlRf7r2;
        "fabric-1.20.6" = _IxlRf7r2;
        "fabric-1.21" = _IxlRf7r2;
        "fabric-1.21.1" = _IxlRf7r2;
        ...
        "fabric-26.2" = _IxlRf7r2;
        "fabric-26.3-snapshot-1" = _uSicVDJR;
        "fabric-26.3-snapshot-2" = _uSicVDJR;
        "fabric-26.3-snapshot-3" = _uSicVDJR;
        "fabric-26.3-snapshot-4" = _uSicVDJR;
        "fabric-26.3-snapshot-5" = _uSicVDJR;
        "fabric-26.3-snapshot-6" = _uSicVDJR;
        "fabric-26.3-snapshot-7" = _uSicVDJR;
        "fabric-26.3-snapshot-8" = _uSicVDJR;
        "fabric-26.3-snapshot-9" = _uSicVDJR;
        "fabric-26.3-snapshot-10" = _uSicVDJR;
        "fabric-26.3-pre-1" = _uSicVDJR;
        "fabric-26.3-pre-2" = _uSicVDJR;
        "fabric-26.3-pre-3" = _uSicVDJR;
        "fabric-26.3" = _IxlRf7r2;
        "forge-1.21.4" = _IxlRf7r2;
        "forge-1.21.5" = _IxlRf7r2;
        ...
        "forge-1.21.6" = _IxlRf7r2;
        "forge-1.21.7" = _IxlRf7r2;
        "forge-1.21.8" = _IxlRf7r2;
        "forge-25w31a" = _MVrPt2B9;
        "forge-25w32a" = _MVrPt2B9;
        "forge-25w33a" = _MVrPt2B9;
        "forge-1.21.9" = _IxlRf7r2;
        "forge-1.21.10" = _IxlRf7r2;
        "forge-25w41a" = _yol51ePF;
        "forge-25w42a" = _yol51ePF;
        "forge-25w43a" = _yol51ePF;
        "forge-1.21.2" = _IxlRf7r2;
        "forge-1.21.3" = _IxlRf7r2;
        "forge-25w44a" = _yol51ePF;
        "forge-25w45a" = _yol51ePF;
        "forge-25w46a" = _yol51ePF;
        "forge-1.21.11-pre1" = _yol51ePF;
        "forge-1.21.11" = _IxlRf7r2;
        "forge-26.1" = _IxlRf7r2;
        "forge-26.1.1" = _IxlRf7r2;
        "forge-26.1.2" = _IxlRf7r2;
        "forge-26.2-snapshot-2" = _2YidGhzY;
        "forge-1.16" = _IxlRf7r2;
        "forge-1.16.1" = _IxlRf7r2;
        "forge-1.16.2" = _IxlRf7r2;
        "forge-1.16.3" = _IxlRf7r2;
        "forge-1.16.4" = _IxlRf7r2;
        "forge-1.16.5" = _IxlRf7r2;
        "forge-1.17" = _IxlRf7r2;
        "forge-1.17.1" = _IxlRf7r2;
        "forge-1.18" = _IxlRf7r2;
        "forge-1.18.1" = _IxlRf7r2;
        "forge-1.18.2" = _IxlRf7r2;
        "forge-1.19" = _IxlRf7r2;
        "forge-1.19.1" = _IxlRf7r2;
        "forge-1.19.2" = _IxlRf7r2;
        "forge-1.19.3" = _IxlRf7r2;
        "forge-1.19.4" = _IxlRf7r2;
        "forge-1.20" = _IxlRf7r2;
        "forge-1.20.1" = _IxlRf7r2;
        "forge-1.20.2" = _IxlRf7r2;
        "forge-1.20.3" = _IxlRf7r2;
        "forge-1.20.4" = _IxlRf7r2;
        "forge-1.20.5" = _IxlRf7r2;
        "forge-1.20.6" = _IxlRf7r2;
        "forge-1.21" = _IxlRf7r2;
        "forge-1.21.1" = _IxlRf7r2;
        ...
        "forge-26.2" = _IxlRf7r2;
        "forge-26.3-snapshot-1" = _uSicVDJR;
        "forge-26.3-snapshot-2" = _uSicVDJR;
        "forge-26.3-snapshot-3" = _uSicVDJR;
        "forge-26.3-snapshot-4" = _uSicVDJR;
        "forge-26.3-snapshot-5" = _uSicVDJR;
        "forge-26.3-snapshot-6" = _uSicVDJR;
        "forge-26.3-snapshot-7" = _uSicVDJR;
        "forge-26.3-snapshot-8" = _uSicVDJR;
        "forge-26.3-snapshot-9" = _uSicVDJR;
        "forge-26.3-snapshot-10" = _uSicVDJR;
        "forge-26.3-pre-1" = _uSicVDJR;
        "forge-26.3-pre-2" = _uSicVDJR;
        "forge-26.3-pre-3" = _uSicVDJR;
        "forge-26.3" = _IxlRf7r2;
        "neoforge-1.21.4" = _IxlRf7r2;
        "neoforge-1.21.5" = _IxlRf7r2;
        ...
        "neoforge-1.21.6" = _IxlRf7r2;
        "neoforge-1.21.7" = _IxlRf7r2;
        "neoforge-1.21.8" = _IxlRf7r2;
        "neoforge-25w31a" = _MVrPt2B9;
        "neoforge-25w32a" = _MVrPt2B9;
        "neoforge-25w33a" = _MVrPt2B9;
        "neoforge-1.21.9" = _IxlRf7r2;
        "neoforge-1.21.10" = _IxlRf7r2;
        "neoforge-25w41a" = _yol51ePF;
        "neoforge-25w42a" = _yol51ePF;
        "neoforge-25w43a" = _yol51ePF;
        "neoforge-1.21.2" = _IxlRf7r2;
        "neoforge-1.21.3" = _IxlRf7r2;
        "neoforge-25w44a" = _yol51ePF;
        "neoforge-25w45a" = _yol51ePF;
        "neoforge-25w46a" = _yol51ePF;
        "neoforge-1.21.11-pre1" = _yol51ePF;
        "neoforge-1.21.11" = _IxlRf7r2;
        "neoforge-26.1" = _IxlRf7r2;
        "neoforge-26.1.1" = _IxlRf7r2;
        "neoforge-26.1.2" = _IxlRf7r2;
        "neoforge-26.2-snapshot-2" = _2YidGhzY;
        "neoforge-1.16" = _IxlRf7r2;
        "neoforge-1.16.1" = _IxlRf7r2;
        "neoforge-1.16.2" = _IxlRf7r2;
        "neoforge-1.16.3" = _IxlRf7r2;
        "neoforge-1.16.4" = _IxlRf7r2;
        "neoforge-1.16.5" = _IxlRf7r2;
        "neoforge-1.17" = _IxlRf7r2;
        "neoforge-1.17.1" = _IxlRf7r2;
        "neoforge-1.18" = _IxlRf7r2;
        "neoforge-1.18.1" = _IxlRf7r2;
        "neoforge-1.18.2" = _IxlRf7r2;
        "neoforge-1.19" = _IxlRf7r2;
        "neoforge-1.19.1" = _IxlRf7r2;
        "neoforge-1.19.2" = _IxlRf7r2;
        "neoforge-1.19.3" = _IxlRf7r2;
        "neoforge-1.19.4" = _IxlRf7r2;
        "neoforge-1.20" = _IxlRf7r2;
        "neoforge-1.20.1" = _IxlRf7r2;
        "neoforge-1.20.2" = _IxlRf7r2;
        "neoforge-1.20.3" = _IxlRf7r2;
        "neoforge-1.20.4" = _IxlRf7r2;
        "neoforge-1.20.5" = _IxlRf7r2;
        "neoforge-1.20.6" = _IxlRf7r2;
        "neoforge-1.21" = _IxlRf7r2;
        "neoforge-1.21.1" = _IxlRf7r2;
        ...
        "neoforge-26.2" = _IxlRf7r2;
        "neoforge-26.3-snapshot-1" = _uSicVDJR;
        "neoforge-26.3-snapshot-2" = _uSicVDJR;
        "neoforge-26.3-snapshot-3" = _uSicVDJR;
        "neoforge-26.3-snapshot-4" = _uSicVDJR;
        "neoforge-26.3-snapshot-5" = _uSicVDJR;
        "neoforge-26.3-snapshot-6" = _uSicVDJR;
        "neoforge-26.3-snapshot-7" = _uSicVDJR;
        "neoforge-26.3-snapshot-8" = _uSicVDJR;
        "neoforge-26.3-snapshot-9" = _uSicVDJR;
        "neoforge-26.3-snapshot-10" = _uSicVDJR;
        "neoforge-26.3-pre-1" = _uSicVDJR;
        "neoforge-26.3-pre-2" = _uSicVDJR;
        "neoforge-26.3-pre-3" = _uSicVDJR;
        "neoforge-26.3" = _IxlRf7r2;
        "quilt-1.21.4" = _IxlRf7r2;
        "quilt-1.21.5" = _IxlRf7r2;
        ...
        "quilt-1.21.6" = _IxlRf7r2;
        "quilt-1.21.7" = _IxlRf7r2;
        "quilt-1.21.8" = _IxlRf7r2;
        "quilt-25w31a" = _MVrPt2B9;
        "quilt-25w32a" = _MVrPt2B9;
        "quilt-25w33a" = _MVrPt2B9;
        "quilt-1.21.9" = _IxlRf7r2;
        "quilt-1.21.10" = _IxlRf7r2;
        "quilt-25w41a" = _yol51ePF;
        "quilt-25w42a" = _yol51ePF;
        "quilt-25w43a" = _yol51ePF;
        "quilt-1.21.2" = _IxlRf7r2;
        "quilt-1.21.3" = _IxlRf7r2;
        "quilt-25w44a" = _yol51ePF;
        "quilt-25w45a" = _yol51ePF;
        "quilt-25w46a" = _yol51ePF;
        "quilt-1.21.11-pre1" = _yol51ePF;
        "quilt-1.21.11" = _IxlRf7r2;
        "quilt-26.1" = _IxlRf7r2;
        "quilt-26.1.1" = _IxlRf7r2;
        "quilt-26.1.2" = _IxlRf7r2;
        "quilt-26.2-snapshot-2" = _2YidGhzY;
        "quilt-1.16" = _IxlRf7r2;
        "quilt-1.16.1" = _IxlRf7r2;
        "quilt-1.16.2" = _IxlRf7r2;
        "quilt-1.16.3" = _IxlRf7r2;
        "quilt-1.16.4" = _IxlRf7r2;
        "quilt-1.16.5" = _IxlRf7r2;
        "quilt-1.17" = _IxlRf7r2;
        "quilt-1.17.1" = _IxlRf7r2;
        "quilt-1.18" = _IxlRf7r2;
        "quilt-1.18.1" = _IxlRf7r2;
        "quilt-1.18.2" = _IxlRf7r2;
        "quilt-1.19" = _IxlRf7r2;
        "quilt-1.19.1" = _IxlRf7r2;
        "quilt-1.19.2" = _IxlRf7r2;
        "quilt-1.19.3" = _IxlRf7r2;
        "quilt-1.19.4" = _IxlRf7r2;
        "quilt-1.20" = _IxlRf7r2;
        "quilt-1.20.1" = _IxlRf7r2;
        "quilt-1.20.2" = _IxlRf7r2;
        "quilt-1.20.3" = _IxlRf7r2;
        "quilt-1.20.4" = _IxlRf7r2;
        "quilt-1.20.5" = _IxlRf7r2;
        "quilt-1.20.6" = _IxlRf7r2;
        "quilt-1.21" = _IxlRf7r2;
        "quilt-1.21.1" = _IxlRf7r2;
        ...
        "quilt-26.2" = _IxlRf7r2;
        "quilt-26.3-snapshot-1" = _uSicVDJR;
        "quilt-26.3-snapshot-2" = _uSicVDJR;
        "quilt-26.3-snapshot-3" = _uSicVDJR;
        "quilt-26.3-snapshot-4" = _uSicVDJR;
        "quilt-26.3-snapshot-5" = _uSicVDJR;
        "quilt-26.3-snapshot-6" = _uSicVDJR;
        "quilt-26.3-snapshot-7" = _uSicVDJR;
        "quilt-26.3-snapshot-8" = _uSicVDJR;
        "quilt-26.3-snapshot-9" = _uSicVDJR;
        "quilt-26.3-snapshot-10" = _uSicVDJR;
        "quilt-26.3-pre-1" = _uSicVDJR;
        "quilt-26.3-pre-2" = _uSicVDJR;
        "quilt-26.3-pre-3" = _uSicVDJR;
        "quilt-26.3" = _IxlRf7r2;
        "pkg-0.1.0" = _ayhmMkXQ;
        "pkg-0.1.0+mod" = _OEPGOb21;
        "pkg-1.0.0" = _5nSx0Ybb;
        "pkg-1.0.0+mod" = _FXVbA3gh;
        "pkg-1.0.1" = _JSlIMFJF;
        "pkg-1.0.1+mod" = _eJQMfKs1;
        "pkg-1.0.2" = _julULrwp;
        "pkg-1.0.2+mod" = _xavf9Xht;
        "pkg-1.0.3" = _avhWCFio;
        "pkg-1.0.3+mod" = _a4i9uoRp;
        "pkg-1.0.4" = _3sUWukyI;
        "pkg-1.0.4+mod" = _BDemKr6d;
        "pkg-1.0.5" = _nlPcoAMy;
        "pkg-1.0.5+mod" = _pCO1d0UG;
        "pkg-1.1.0" = _OWnbUisG;
        "pkg-1.1.0+mod" = _8x7iKgxa;
        "pkg-1.2.0" = _Q8Uh7tDr;
        "pkg-1.2.0+mod" = _g42pzCVK;
        "pkg-1.2.1" = _pZ9EVJjW;
        "pkg-1.2.1+mod" = _68gOLEv4;
        "pkg-1.3.0" = _73fxIuYk;
        "pkg-1.3.0+mod" = _MVrPt2B9;
        "pkg-1.4.0" = _lY6emgbv;
        "pkg-1.4.0+mod" = _tKrMKY6u;
        "pkg-1.5.0" = _jqTCarfm;
        "pkg-1.5.0+mod" = _6rRRJUf2;
        "pkg-1.5.1" = _wwNgambP;
        "pkg-1.5.1+mod" = _9GxkI9Na;
        "pkg-1.6.0" = _BumQFBH0;
        "pkg-1.6.0+mod" = _8aFGV7t6;
        "pkg-1.7.0" = _i14hdalj;
        "pkg-1.7.0+mod" = _LITfAta7;
        "pkg-1.8.0" = _JGzMoO9A;
        "pkg-1.8.0+mod" = _s1oPstmm;
        "pkg-2.0.0" = _G5qjhlHZ;
        "pkg-2.0.0+mod" = _KcmK7bYb;
        "pkg-3.0.0" = _14HU4G5q;
        "pkg-3.0.0+mod" = _KfZWaQSi;
        "pkg-3.0.1" = _r6xmugcT;
        "pkg-3.0.1+mod" = _rs3Ga8m6;
        "pkg-3.0.2" = _1f7gnz6P;
        "pkg-3.0.2+mod" = _EsPqsXTh;
        "pkg-3.0.3" = _tQ2NtPR4;
        "pkg-3.0.3+mod" = _yol51ePF;
        "pkg-3.1.0" = _U2gPS28H;
        "pkg-3.1.0+mod" = _FRZOG6I3;
        "pkg-3.2.0" = _URWJfxdl;
        "pkg-3.2.0+mod" = _Cw23zbKz;
        "pkg-3.3.0" = _7sL1ViF7;
        "pkg-3.3.0+mod" = _R85K9rHN;
        "pkg-3.4.0" = _UDsdfJvI;
        "pkg-3.4.0+mod" = _pUHJsi3y;
        "pkg-3.4.1" = _Tbj8Is5Q;
        "pkg-3.4.1+mod" = _2YidGhzY;
        "pkg-4.0.0" = _x2ygXmcn;
        "pkg-4.0.0+mod" = _gREPf7qe;
        "pkg-4.1.0" = _6LBzr6tk;
        "pkg-4.1.0+mod" = _xrPwHPZB;
        "pkg-4.1.1" = _2G1jTLUu;
        "pkg-4.1.1+mod" = _GLXchueX;
        "pkg-4.2.0" = _tI52pLny;
        "pkg-4.2.0+mod" = _6Oj4oPa6;
        "pkg-4.3.0" = _qd39fF6J;
        "pkg-4.3.0+mod" = _P6nLrEZK;
        "pkg-4.3.1" = _oLm68o7i;
        "pkg-4.3.1+mod" = _AlDmTHvm;
        "pkg-4.3.2" = _MJeeM1aF;
        "pkg-4.3.2+mod" = _wvhLfMEk;
        "pkg-4.4.0" = _7ZdlgjqR;
        "pkg-4.4.0+mod" = _vtYAZY95;
        "pkg-4.4.1" = _LWc82Nim;
        "pkg-4.4.1+mod" = _ZsNay6vW;
        "pkg-4.4.2" = _eqf3qPqY;
        "pkg-4.4.2+mod" = _8d2trPDH;
        "pkg-4.4.3" = _r3vDANur;
        "pkg-4.4.3+mod" = _ixac5xQe;
        "pkg-4.5.0" = _ZUcv3f2t;
        "pkg-4.5.0+mod" = _JoYVolu9;
        "pkg-4.6.0" = _EiFZgX1q;
        "pkg-4.6.0+mod" = _3pCS2BpU;
        "pkg-4.7.0" = _7kRZl4lT;
        "pkg-4.7.0+mod" = _kHdCgzSJ;
        "pkg-4.7.1" = _NKlMHJ7C;
        "pkg-4.7.1+mod" = _SOmBTCZd;
        "pkg-5.0.0" = _GtYDCDuM;
        "pkg-5.0.0+mod" = _WhoGQKPZ;
        "pkg-5.0.1" = _PwFkZFur;
        "pkg-5.0.1+mod" = _yumfeNxd;
        "pkg-5.0.2" = _dHtHmyyP;
        "pkg-5.0.2+mod" = _GZUL539V;
        "pkg-5.1.0" = _yj2Uxyra;
        "pkg-5.1.0+mod" = _9znX0QOU;
        "pkg-5.1.1" = _OXRIsmRP;
        "pkg-5.1.1+mod" = _P7frl5PU;
        "pkg-5.1.2" = _UPSGxaDn;
        "pkg-5.1.2+mod" = _8UqZ6gjv;
        "pkg-5.1.3" = _q5BWyDAn;
        "pkg-5.1.3+mod" = _uSicVDJR;
        "pkg-5.2.0" = _e9zonAK1;
        "pkg-5.2.0+mod" = _IxlRf7r2;
        "default" = _IxlRf7r2;
    });
