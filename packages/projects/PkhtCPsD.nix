...
let
    versions = (let
        ...
        _EcdFG4JX = {
            "id" = "EcdFG4JX";
            "file" = "HexOverpowered-fabric-1.21.1-0.11.7-pre47.jar";
            "hash" = "sha512-ykV58GvfJeUIdZLAHd8c5ITxXQ5+esxJ71v7silxIvM+JSUxx9cpnnzaiw8ttNKN2zfGhH0Dvvt4FL3wWtefGQ==";
        };
        _tzJT35pz = {
            "id" = "tzJT35pz";
            "file" = "HexOverpowered-neoforge-1.21.1-0.11.7-pre47.jar";
            "hash" = "sha512-i3Y509R+o3izLQF1J5jOJamkCelf3f2zWd/H7IilNY/Fiwpi5c9tVSqFWDvZVAhRmp+KDZdQQMhvI+P8uCda0A==";
        };
        _Zha8j5qD = {
            "id" = "Zha8j5qD";
            "file" = "HexOverpowered-fabric-1.19.2-0.12.0.jar";
            "hash" = "sha512-ZTjzIjxAeQ2dtRKml5n7XcLttwB/ePoXL1svTPwuaB3+HOV4DbKXq1xBSi/G1/XXrLUSkdXS99SeXzcVQvbQ0A==";
        };
        _XzlP0vWP = {
            "id" = "XzlP0vWP";
            "file" = "HexOverpowered-fabric-1.20.1-0.12.0.jar";
            "hash" = "sha512-BnitDhPu6qj6Dny/cyGCZ4U7u/HegWRnuxmd5WtI0hi1n2eK5SfTqHECifEaAkfFGhEOqaCqxK93nkc7wVSxGA==";
        };
        _WOC5T6Jq = {
            "id" = "WOC5T6Jq";
            "file" = "HexOverpowered-fabric-1.21.1-0.12.0-pre48.jar";
            "hash" = "sha512-CZzm50KT4LpfkCowsAN7yeRXLnwZZlUevLvwNEnu7mk6sTE3uUB5kn4TmH8i/FFgv8hfLz+muXuuqan/nhDGWA==";
        };
        _D4XYb4w9 = {
            "id" = "D4XYb4w9";
            "file" = "HexOverpowered-forge-1.19.2-0.12.0.jar";
            "hash" = "sha512-fIlz6hcSbA79CVIw95U9fvDZnBtFj81nCXbjCKyY8XlrbKbd++mjQMJmQ9Ttna4feeNYSd2CE4u7aopm5OV/OQ==";
        };
        _YNH8xSte = {
            "id" = "YNH8xSte";
            "file" = "HexOverpowered-forge-1.20.1-0.12.0.jar";
            "hash" = "sha512-CLH5gQWypfC9/WAViiGmvE9/0R3z9IzvwdjgBO5BZRQdG6jE1Wuj2riLPpI/ZDamtkxPjSv55TNC15nwmfaD+w==";
        };
        _prTOz7D7 = {
            "id" = "prTOz7D7";
            "file" = "HexOverpowered-neoforge-1.21.1-0.12.0-pre48.jar";
            "hash" = "sha512-22gre40fO9jayKqR/R3IR2Rlk63xg2p4V5IwcRnh3f6KZbAN8oJ7kSunfFg1MC0qLE/c0kLPL+w2+lCdHf3abQ==";
        };
        _83XL3ZmV = {
            "id" = "83XL3ZmV";
            "file" = "HexOverpowered-fabric-1.20.1-0.12.1.jar";
            "hash" = "sha512-lqNTSdc7mq+WD0AdJnx5lio4nFWcstDdPpjY3HNzeS0Haj+3RaE2pxCBBz00SKPBTaDzy1r5D+rh3jzZfv5ZzQ==";
        };
        _qShARh6M = {
            "id" = "qShARh6M";
            "file" = "HexOverpowered-forge-1.20.1-0.12.1.jar";
            "hash" = "sha512-z+K6DJaQ81zmxq0BZpbN/gEnL3SqRKRgZceZGoWzYOugHXJsQfCYBlcVH1nHse7J3VA9n21OR2adVjgpPiKDUg==";
        };
        _PEKN5SUd = {
            "id" = "PEKN5SUd";
            "file" = "HexOverpowered-fabric-1.21.1-0.12.1.pre48.jar";
            "hash" = "sha512-JBCvpXYUx2Th/vIRUDUKWz4rLD2xTo+0Z505MujmFD+s35FoYoaHRpHVxc1T0VeF6TbEBFDh8hu+XDLU5fuqtQ==";
        };
        _7EClSfFX = {
            "id" = "7EClSfFX";
            "file" = "HexOverpowered-neoforge-1.21.1-0.12.1.pre48.jar";
            "hash" = "sha512-arJibpsBG21Mq0fUrqSnvIN9aFbOM+JmfviMggTxQH2Gi44fJONxgIzzwrdHFDuiywNuc4kyH2Vnqi4MNRwYeA==";
        };
        _gcDZCRBG = {
            "id" = "gcDZCRBG";
            "file" = "HexOverpowered-fabric-1.21.1-0.12.1.pre53.jar";
            "hash" = "sha512-yzoOcQr0OJwPM5g1JjbbAiPBq0givC1Qi65w6e3ivKHZNdteKqxTr4MOfdeI9x2/p/oYIGMV9l9nCYA9S/SM6A==";
        };
        _w2uvQnn6 = {
            "id" = "w2uvQnn6";
            "file" = "HexOverpowered-neoforge-1.21.1-0.12.1.pre53.jar";
            "hash" = "sha512-h4TdUAEXYYijcPUDWawYIG/Ud3pdBdY39/Hmo5ASTrdO3F1+IH5k1alzmGOA/xJ7pFF3KcLFiVplqS62N04/Ew==";
        };
        _s5eN1ZBb = {
            "id" = "s5eN1ZBb";
            "file" = "HexOverpowered-fabric-1.21.1-0.12.2.pre53.jar";
            "hash" = "sha512-jB4o4hNf/Ag0Lotlq9pFx2bLsSv6vaqsgXdkjyzYBsSAT5Ng5t23hDwCunARY7XynWUhLAYf67NLq9fyMsl+Gw==";
        };
        _CjCe3Tgx = {
            "id" = "CjCe3Tgx";
            "file" = "HexOverpowered-neoforge-1.21.1-0.12.2.pre53.jar";
            "hash" = "sha512-JBxW3uNgdxOrrKsmrhEquY2tEAYK/p7bGDm9ZnuUlKJ1KjsiVu+l09gAkBiyFo0Qt1Q/haBF80aFRshQr7Dofg==";
        };
        _rmyTjEDh = {
            "id" = "rmyTjEDh";
            "file" = "HexOverpowered-fabric-1.20.1-0.12.2.jar";
            "hash" = "sha512-ifuipNrjkXb9fUFQANb9DCseO3al9hqCKpeF21ggA/1opgLKlxC4TF8ck2NgudbTzIxWZx1xDnsg55SXKyi4qA==";
        };
        _AN4qQYMh = {
            "id" = "AN4qQYMh";
            "file" = "HexOverpowered-forge-1.20.1-0.12.2.jar";
            "hash" = "sha512-MeAevmo8D7GrAGdGwO0jnyjKlLG6a87n90dgKYyvYccYuCRlsLxES4EtZW8nNpNNDulQUMnS7QKXLR37UhIDPw==";
        };
        _t8YcoCen = {
            "id" = "t8YcoCen";
            "file" = "HexOverpowered-fabric-1.19.2-0.12.2.jar";
            "hash" = "sha512-HKvLd+pG9aIGrP4ZcAWvMcFIrwCu8fpy1vAJ5EI3d0qfEHuqWde8FNn0hEaskqHJ+OAl57cl+mqWhBJ13QpcRQ==";
        };
        _aSPLeWLo = {
            "id" = "aSPLeWLo";
    ...
    in {
        ...
        "pkg-1.19.2-0.5.3" = _9j1F9Wwq;
        "pkg-1.20.1-0.5.3" = _YJfL50ig;
        "pkg-1.19.2-0.5.3.1" = _MizrvSyP;
        "pkg-1.20.1-0.5.3.1" = _rSctr8XO;
        "pkg-1.19.2-0.6.0" = _2Iy65L0b;
        "pkg-1.20.1-0.6.0" = _GVCcvGGt;
        "pkg-1.19.2-0.6.1" = _uZVNaFIa;
        "pkg-1.20.1-0.6.1" = _tFVeb7zS;
        "pkg-1.19.2-0.7.0" = _tzE7OuYe;
        "pkg-1.20.1-0.7.0" = _frFQq5Et;
        "pkg-1.19.2-0.7.1" = _UYc4mtoQ;
        "pkg-1.20.1-0.7.1" = _jsKL8aYa;
        "pkg-1.19.2-0.7.2" = _Ea9LLouV;
        "pkg-1.20.1-0.7.2" = _nmgdp8vg;
        "pkg-1.19.2-0.7.2.1" = _DukMat0x;
        "pkg-1.19.2-0.7.3" = _R9XPzZtO;
        "pkg-1.20.1-0.7.3" = _gKli0SIU;
        "pkg-1.19.2-0.8.0" = _t6B380OT;
        "pkg-1.20.1-0.8.0" = _hKADNraQ;
        "pkg-1.19.2-0.8.0.1" = _UYDWNFIz;
        "pkg-1.20.1-0.8.0.1" = _lXIYDRZz;
        "pkg-1.19.2-0.8.0.2" = _PqX0iFQp;
        "pkg-1.20.1-0.8.0.2" = _fVMUGEZ7;
        "pkg-1.19.2-0.8.1" = _Vqfb1plG;
        "pkg-1.20.1-0.8.1" = _NjVLZkgs;
        "pkg-1.19.2-0.8.2" = _pyp8erjw;
        "pkg-1.20.1-0.8.2" = _KpCbjc0R;
        "pkg-1.19.2-0.8.2.1" = _SMxOwGkq;
        "pkg-1.19.2-0.9.0" = _UTdLd5IX;
        "pkg-1.20.1-0.9.0" = _Upc6kr2H;
        "pkg-1.20.1-0.9.1" = _ZZ2duzq2;
        "pkg-1.20.1-0.10.0" = _DBcJqirr;
        "pkg-1.20.1-0.10.1" = _mqkzPN50;
        "pkg-1.20.1-0.10.2" = _1bsUW3a6;
        "pkg-1.19.2-0.10.3" = _SqUKVUyQ;
        "pkg-1.20.1-0.10.3" = _piRco0Nq;
        "pkg-1.19.2-0.10.4" = _dDR2Yb4Y;
        "pkg-1.20.1-0.10.4" = _yJwpqdO6;
        "pkg-1.19.2-0.10.5" = _R0j8YTeV;
        "pkg-1.20.1-0.10.5" = _AFBtoeJ9;
        "pkg-1.19.2-0.11.0" = _5jaxvXPi;
        "pkg-1.20.1-0.11.0" = _hSEN5RQS;
        "pkg-1.19.2-0.11.1" = _KO4EYBwC;
        "pkg-1.20.1-0.11.1" = _yHsVvG2x;
        "pkg-1.19.2-0.11.2" = _Age1ZCco;
        "pkg-1.20.1-0.11.2" = _k2tzdVMQ;
        "pkg-1.19.2-0.11.2.1" = _aFe66NSC;
        "pkg-1.20.1-0.11.2.1" = _NXELxa9T;
        "pkg-1.19.2-0.11.2.2" = _ysSnay7L;
        "pkg-1.20.1-0.11.2.2" = _gKh9VqYa;
        "pkg-1.19.2-0.11.3" = _BNYNcFGR;
        "pkg-1.20.1-0.11.3" = _iOtu4fUn;
        "pkg-1.19.2-0.11.3.1" = _ONFLuFcx;
        "pkg-1.20.1-0.11.3.1" = _edmCClco;
        "pkg-1.20.1-0.11.3.2" = _Dcp7hPZo;
        "pkg-1.19.2-0.11.4" = _9eeRQuXT;
        "pkg-1.20.1-0.11.4" = _MUAtltKW;
        "pkg-1.20.1-0.11.4.1" = _pZRsPurj;
        "pkg-1.19.2-0.11.5" = _tuD2Xpzv;
        "pkg-1.20.1-0.11.5" = _oyYJqc7x;
        "pkg-1.19.2-0.11.5.1" = _d6EspdTQ;
        "pkg-1.20.1-0.11.5.1" = _q8B6l0Mn;
        "pkg-1.21.1-0.11.5.1" = _nBnfFcfc;
        "pkg-1.19.2-0.11.6" = _Sg6b6VM6;
        "pkg-1.20.1-0.11.6" = _xjo0ygeU;
        "pkg-1.21.1-0.11.6" = _LzoX0EIk;
        "pkg-1.21.1-0.11.7" = _tzJT35pz;
        "pkg-1.19.2-0.11.7" = _gFXGUWce;
        "pkg-1.20.1-0.11.7" = _IoRlbimk;
        "pkg-1.19.2-0.12.0" = _D4XYb4w9;
        "pkg-1.20.1-0.12.0" = _YNH8xSte;
        "pkg-1.21.1-0.12.0" = _prTOz7D7;
        "pkg-1.20.1-0.12.1" = _qShARh6M;
        "pkg-1.21.1-0.12.1.pre48" = _7EClSfFX;
        "pkg-1.21.1-0.12.1.pre53" = _w2uvQnn6;
