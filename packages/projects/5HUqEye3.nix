...
let
    ...
    in {
        ...
        "pkg-b1.0.0" = _eGDd2x2V;
        "pkg-b1.1.0" = _ybGcVE4J;
        "pkg-b1.1.1" = _xHuJNPiz;
        "pkg-b1.1.2" = _hGkaxdIs;
        "pkg-1.1.3-beta" = _UxQZ9Eba;
        "pkg-1.1.4-beta" = _9FgvFwIV;
        "pkg-1.1.5-beta" = _3SME7WcI;
        "pkg-1.0.0-forge-beta" = _5s1CAxiS;
        "pkg-1.1.6-beta" = _ZPFiRPdr;
        "pkg-1.1.7-beta" = _ilC82fTz;
        "pkg-1.1.8-beta" = _kW2F1rRJ;
        "pkg-1.0.0" = _kLvovpKN;
        "pkg-1.0.1" = _RZFe3l1v;
        "pkg-1.1.9-beta" = _ZVZjeZyw;
        "pkg-1.1.10-beta" = _zYbJEEW2;
        "pkg-1.2.0-beta" = _n6vYDLiW;
        "pkg-1.2.1-beta" = _GdnzHZTm;
        "pkg-1.0.2" = _wFDeFVod;
        "pkg-1.0.3" = _wmVWOTli;
        "pkg-1.2.2-beta" = _gy9BfRm5;
        "pkg-1.2.3-beta" = _JhvZD0MM;
        "pkg-1.0.4" = _q7xdXDRi;
        "pkg-1.0.5" = _2AlB9ocn;
