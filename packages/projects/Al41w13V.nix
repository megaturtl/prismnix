...
let
    versions = (let
        ...
        _ZHLDSN8Y = {
            "id" = "ZHLDSN8Y";
            "file" = "§e§lAllure§r§0.zip";
            "hash" = "sha512-dQn8mo/XCWVbGfe1xAFkurh+Mn0fjrHiQj9Rht24FGbVDGcpFW34JrwuDDjx7foZMhJ3FrxLnCCVdT2DEegcKw==";
        };
    in {
        "4ZBDIV4F" = _4ZBDIV4F;
        "K5tJ7xjQ" = _K5tJ7xjQ;
        ...
        "mQOpR51D" = _mQOpR51D;
        "ZHLDSN8Y" = _ZHLDSN8Y;
        "minecraft-1.20.2" = _ZHLDSN8Y;
        "minecraft-1.21" = _ZHLDSN8Y;
        "minecraft-1.20.3" = _ZHLDSN8Y;
        "minecraft-1.20.4" = _ZHLDSN8Y;
        "minecraft-1.20.5" = _ZHLDSN8Y;
        "minecraft-1.20.6" = _ZHLDSN8Y;
        "minecraft-1.21.1" = _ZHLDSN8Y;
        "minecraft-1.21.2" = _ZHLDSN8Y;
        "minecraft-1.21.3" = _ZHLDSN8Y;
        "minecraft-1.21.4" = _ZHLDSN8Y;
        "minecraft-1.21.6" = _ZHLDSN8Y;
        "minecraft-1.21.7" = _ZHLDSN8Y;
        "minecraft-1.21.8" = _ZHLDSN8Y;
        "minecraft-1.21.9" = _ZHLDSN8Y;
        "minecraft-1.21.10" = _ZHLDSN8Y;
        "minecraft-1.21.11" = _ZHLDSN8Y;
        "minecraft-26.1" = _ZHLDSN8Y;
        "minecraft-26.1.1" = _ZHLDSN8Y;
        "minecraft-26.1.2" = _ZHLDSN8Y;
        "minecraft-1.21.5" = _ZHLDSN8Y;
        "minecraft-26.2" = _ZHLDSN8Y;
