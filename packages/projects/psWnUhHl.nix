...
let
    versions = (let
        ...
        _oSGjnNOf = {
            "id" = "oSGjnNOf";
            "file" = "SModeration-Paper-2.0.0.jar";
    ...
    in {
        ...
        "paper-1.21.6" = _oSGjnNOf;
        "paper-1.21.7" = _oSGjnNOf;
        "paper-1.21.8" = _oSGjnNOf;
        "paper-1.21.9" = _oSGjnNOf;
        "paper-1.21.10" = _oSGjnNOf;
        "paper-1.21.11" = _oSGjnNOf;
        "paper-26.1" = _oSGjnNOf;
        "paper-26.1.1" = _oSGjnNOf;
        "paper-26.1.2" = _oSGjnNOf;
        "paper-26.2" = _oSGjnNOf;
        ...
        "purpur-1.21.6" = _oSGjnNOf;
        "purpur-1.21.7" = _oSGjnNOf;
        "purpur-1.21.8" = _oSGjnNOf;
        "purpur-1.21.9" = _oSGjnNOf;
        "purpur-1.21.10" = _oSGjnNOf;
        "purpur-1.21.11" = _oSGjnNOf;
        "purpur-26.1" = _oSGjnNOf;
        "purpur-26.1.1" = _oSGjnNOf;
        "purpur-26.1.2" = _oSGjnNOf;
        "purpur-26.2" = _oSGjnNOf;
        "folia-1.21.3" = _d6Hxmhyy;
        "folia-1.21.4" = _soOGLBgY;
        "folia-1.21.5" = _soOGLBgY;
        "folia-1.21.6" = _oSGjnNOf;
        "folia-1.21.7" = _oSGjnNOf;
        "folia-1.21.8" = _oSGjnNOf;
        "folia-1.21.9" = _oSGjnNOf;
        "folia-1.21.10" = _oSGjnNOf;
        "folia-1.21.11" = _oSGjnNOf;
        "folia-26.1" = _oSGjnNOf;
        "folia-26.1.1" = _oSGjnNOf;
        "folia-26.1.2" = _oSGjnNOf;
        "folia-26.2" = _oSGjnNOf;
        "pkg-1.1.1" = _om0l0JtW;
        "pkg-1.2.0" = _n44JVfrt;
        "pkg-1.2.1" = _ow0l2iq5;
        "pkg-1.3.0" = _ssDJmF3s;
