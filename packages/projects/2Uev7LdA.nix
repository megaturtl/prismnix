...
let
    versions = (let
        ...
        _1UwXLgNX = {
            "id" = "1UwXLgNX";
            "file" = "lambdabettergrass-2.9.0+26.3.jar";
            "hash" = "sha512-Z9wzjzOPXSeV+YGqAaiJ4t6sJuT/EU/IawoPuoZ9hYXK9j+jJEHhTlEirImQU0RjsDMlUP9vfFS4EwAJs5AzLQ==";
        };
    in {
        "z44JNNt7" = _z44JNNt7;
        "5rHxiW08" = _5rHxiW08;
        ...
        "quilt-26.3" = _1UwXLgNX;
        "pkg-1.0.1" = _z44JNNt7;
        "pkg-1.0.2+1.16" = _5rHxiW08;
        "pkg-1.0.2+20w51a" = _gvU72Coy;
        "pkg-1.0.3+1.16" = _b7b45yqL;
        "pkg-1.0.3+21w03a" = _Pc3Ijsky;
        "pkg-1.1.0+21w05b" = _JiU63vNt;
        "pkg-1.1.1+21w14a" = _6upWR9Fn;
        "pkg-1.1.2+21w20a" = _iV1biDDy;
        "pkg-1.2.0+1.17" = _ZzfyOoxk;
        "pkg-1.2.1+1.17" = _6KQ1zcVH;
        "pkg-1.2.2+1.17" = _A7w87AWG;
        "pkg-1.2.3+1.18" = _CXzPYiJu;
        "pkg-1.2.4+1.18" = _LpLEGUBZ;
        "pkg-1.3.0+1.19" = _UWFTYBmq;
        "pkg-1.4.0+1.19.3" = _lshdVWEE;
        "pkg-1.5.0+1.19.4" = _s8ush6EH;
        "pkg-1.5.1+1.19.4" = _8PwxwkZk;
        "pkg-1.5.1+1.20" = _RYNcamJi;
        "pkg-1.5.2+1.20.1" = _Fhyj2P7Q;
        "pkg-2.0.0+1.20.1" = _XiWMT7TR;
        "pkg-2.0.0+1.21.1" = _kciVMLmf;
        "pkg-2.0.1+1.20.1" = _ZvIZV1hM;
        "pkg-2.0.1+1.21.1" = _BNJgZaQs;
        "pkg-2.0.2+1.20.1" = _sVdEKYrj;
        "pkg-2.0.2+1.21.1" = _2UomQWSb;
        "pkg-2.1.0+1.21.3" = _VG4sr7zQ;
        "pkg-2.1.0+1.21.4" = _L2I1dhnd;
        "pkg-2.2.0+1.21.5" = _UNDaqJJm;
        "pkg-2.3.0+1.21.8" = _jy42iTMY;
        "pkg-2.0.3+1.20.1" = _eTxu3nyw;
        "pkg-2.0.3+1.21.1" = _FEQKA9Fw;
        "pkg-2.1.1+1.21.3" = _RxvbNytT;
        "pkg-2.1.1+1.21.4" = _46MS8PqU;
        "pkg-2.2.1+1.21.5" = _6AuDCXyB;
        "pkg-2.3.1+1.21.8" = _toseAeOt;
        "pkg-2.0.4+1.21.1" = _WdPLwaZg;
        "pkg-2.1.2+1.21.3" = _zds1n1KV;
        "pkg-2.1.2+1.21.4" = _C6bOGeO0;
        "pkg-2.2.2+1.21.5" = _xJ2fIy2B;
        "pkg-2.3.2+1.21.8" = _N5zETMFN;
        "pkg-2.4.0+1.21.9" = _S3Imk5hD;
        "pkg-2.5.0+1.21.9" = _FY86dPVr;
        "pkg-2.6.0-alpha.1+25w45a" = _yldGz6jb;
        "pkg-2.6.0+1.21.11" = _BqLhPJRI;
        "pkg-2.7.0+26.1" = _txtX8EyX;
        "pkg-2.7.1+26.1" = _GAW3AMQg;
        "pkg-2.7.2+26.1.1" = _oGxP5WHV;
        "pkg-2.8.0+26.2" = _Yvs1pVOQ;
        "pkg-2.8.1+26.2" = _4z8ZHuGj;
        "pkg-2.9.0+26.3" = _1UwXLgNX;
        "default" = _1UwXLgNX;
    });
