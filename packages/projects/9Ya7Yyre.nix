...
let
    versions = (let
        ...
        _diPR3J7B = {
            "id" = "diPR3J7B";
            "file" = "strawberrylib-fabric-26.2-r3.jar";
            "hash" = "sha512-w7GNirdikZjtPkHBvF3+l8jSPI36CDv9+aZtNsX3AGFkKgK/mn8nM83u2cfhJoWauk0jlqe9gZnEmGhHztFXFg==";
        };
        _4Sk34qMJ = {
            "id" = "4Sk34qMJ";
            "file" = "strawberrylib-fabric-26.2-r4.jar";
            "hash" = "sha512-ItbMguiF0fb9nh0wxs+67+ABbpDggUBmDwED/TvnvWQZkRioVdOgIg/eONhR3xY64/cOcPGvfg3lbfnMkdwFmg==";
        };
        _VDB7q0mn = {
            "id" = "VDB7q0mn";
            "file" = "strawberrylib-fabric-26.1-r10.jar";
            "hash" = "sha512-dqUlmqujIbSlnE02QiNwr5MRU1/Rbs7UQZyHN5j7l39Dhn1k82Ko2WefvwMISU7tepovqFoXV5ufVVt7cP0TAQ==";
        };
        _WQ04e6J3 = {
            "id" = "WQ04e6J3";
    ...
    in {
        ...
        "pkg-1.21.5-r4" = _RRk4o4sf;
        "pkg-1.21.5-r5" = _bxhsoJlz;
        "pkg-1.21.6-r1" = _JK612l1x;
        "pkg-1.21.7-r1" = _1bkMjEqk;
        "pkg-1.21.7-r2" = _AAs7Wmc6;
        "pkg-1.21.7-r3" = _Pi8K3jLj;
        "pkg-1.21.7-r4" = _lPPoiQh9;
        "pkg-1.21.7-r5" = _40bBpnDV;
        "pkg-1.21.7-r6" = _K7NqAvD5;
        "pkg-1.21.7-r7" = _SVSrbvtq;
        "pkg-1.21.7-r8" = _MkOXWDYg;
        "pkg-1.21.7-r9" = _KL2Fd7qF;
        "pkg-1.21.8-r1" = _f9K26x4p;
        "pkg-1.21.8-r2" = _51VJUiQN;
        "pkg-1.21.9-r1" = _qeBcn1Lh;
        "pkg-1.21.10-r1" = _jqqADqIf;
        "pkg-1.21.10-r2" = _5zgiSCbr;
        "pkg-1.21.10-r3" = _ri99zKBq;
        "pkg-1.21.10-r4" = _wEdjEASk;
        "pkg-1.21.10-r5" = _1dfnUdc3;
        "pkg-1.21.10-r6" = _tDWEeCwO;
        "pkg-1.21.10-r7" = _fer3zSkB;
        "pkg-1.21.11-r1" = _TFaNF6Oh;
        "pkg-1.21.11-r2" = _hxZluBvr;
        "pkg-1.21.11-r3" = _8IsFiH8b;
        "pkg-1.21.11-r4" = _5XnDlrHT;
        "pkg-26.1-r1" = _a1eQm2N3;
        "pkg-26.1-r2" = _URHKovWK;
        "pkg-26.1-r3" = _SkvmjmHc;
        "pkg-26.1-r4" = _2J6aNTl6;
        "pkg-26.1-r5" = _UdBiTY4A;
        "pkg-26.1-r6" = _leTINaNu;
        "pkg-26.1-r7" = _TyTUQRgG;
        "pkg-26.1-r8" = _Y97mHCxs;
        "pkg-26.2-r1" = _l1fA3CPa;
        "pkg-26.1-r9" = _ZTcuEejF;
        "pkg-26.2-r2" = _oMHDHxdk;
