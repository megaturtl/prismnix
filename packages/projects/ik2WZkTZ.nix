...
let
    ...
    in {
        ...
        "pkg-1.20.1-1.0.4" = _ecSjtDnx;
        "pkg-1.20.1-1.0.5" = _Wwvr0aha;
        "pkg-1.20.1-1.0.6" = _fBVOTUaX;
        "pkg-1.20.1-1.1.0" = _pGem6cEJ;
        "pkg-1.20.1-1.2.0" = _q4elRNen;
        "pkg-1.20.1-1.2.1" = _jvXGx2H3;
        "pkg-1.20.1-1.2.2" = _zQzBElQA;
        "pkg-1.20.1-1.3.0" = _34ZF1llP;
        "pkg-1.20.1-1.3.1" = _djsApdsv;
        "pkg-1.20.1-1.3.2" = _LoJZz25D;
        "pkg-1.20.1-1.3.3" = _BMwPSh51;
        "pkg-1.20.1-1.3.4" = _kRFHEGRg;
        "pkg-1.20.1-1.4.0" = _FMhcLRkL;
        "pkg-1.20.1-1.4.1" = _71Mw5ZWY;
        "pkg-1.20.1-1.4.2" = _SpTlS9c3;
        "pkg-1.21.1-1.4.3" = _I5Tung1P;
        "pkg-1.20.1-1.4.3" = _CMJUhoZu;
        "pkg-1.20.1-1.4.4" = _7FNMmjsv;
        "pkg-1.21.1-1.4.4" = _kURINP3o;
        "pkg-1.21.1-1.4.5" = _HRZOGFzZ;
        "pkg-1.21.1-1.4.6" = _zNRDxybT;
        "pkg-1.20.1-1.4.6" = _TcupfesV;
        "pkg-1.21.1-1.4.7" = _2ydLoUFo;
        "pkg-1.21.1-1.4.8" = _XBvL3Xas;
        "pkg-1.21.1-1.4.9" = _yfZdKYdR;
        "pkg-1.20.1-1.4.9" = _NOmZ92Rf;
        "pkg-1.21.1-1.4.10" = _xRg5da3H;
        "pkg-1.21.1-1.4.11" = _92kpdAqC;
        "pkg-1.20.1-1.4.11" = _nFyQy5IK;
        "pkg-1.21.1-1.4.13" = _GPDHHIQB;
        "pkg-1.21.1-1.4.14" = _IG5rJjLf;
        "pkg-1.21.1-1.4.15" = _T2IerUWK;
        "pkg-1.21.1-1.4.16" = _9CGA0Y1S;
        "pkg-1.21.1-1.4.17" = _cdOHqSaV;
        "pkg-1.21.1-1.4.18" = _bMjlNFdC;
        "pkg-1.20.1-1.4.18" = _KFHG5gGs;
        "pkg-1.21.1-1.4.19" = _6JPvrlR2;
        "pkg-1.20.1-1.4.20" = _EvDNFwc0;
        "pkg-1.21.1-1.4.20" = _zTQrKLGp;
        "pkg-1.20.1-1.4.21" = _v3QTOtAV;
        "pkg-1.21.1-1.4.22" = _X3n4Gfqk;
        "pkg-1.20.1-1.4.22" = _3PwUJgZl;
        "pkg-1.21.1-1.4.23" = _A3GgmAJe;
        "pkg-1.20.1-1.4.23" = _8asIbMXN;
        "pkg-1.21.1-1.4.24" = _TlWbWev2;
        "pkg-1.21.1-1.4.25" = _oAqMSjdK;
        "pkg-1.20.1-1.4.25" = _JdZSMDst;
        "pkg-1.21.1-1.4.26" = _nMtwxuv6;
        "pkg-1.20.1-1.4.27" = _IIDzUTjo;
        "pkg-1.21.1-1.4.27" = _8sqOrAND;
        "pkg-1.21.1-1.4.28" = _XTwbuRtj;
        "pkg-1.21.1-1.4.29" = _BmPFxGKe;
        "pkg-1.21.1-1.4.30" = _WKgnwTzf;
        "pkg-1.21.1-1.4.31" = _2ECpFJOr;
        "pkg-1.21.1-1.4.32" = _5LJl0ioZ;
        "pkg-1.21.1-1.4.33" = _SPwzCvod;
        "pkg-1.21.1-1.4.34" = _iWiTWliw;
        "pkg-1.21.1-1.4.35" = _SZ95SIk8;
