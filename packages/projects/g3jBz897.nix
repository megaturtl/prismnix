...
let
    ...
    in {
        ...
        "pkg-1.2.0+1.20.1" = _sb46j4pM;
        "pkg-2.0+1.20.2" = _e1RdQDbk;
        "pkg-3.0+1.20.3-4" = _P2EqVVYm;
        "pkg-3.1+1.20.3-4" = _17DYNupI;
        "pkg-3.2+1.20.3-4" = _dsjsBNNN;
        "pkg-3.3+1.20.3" = _ebE7Fmf6;
        "pkg-4.0+1.21" = _dwmJRySX;
        "pkg-4.0.1+1.21" = _vKH9YHSS;
        "pkg-4.0.2+1.21.2" = _JycjOZ4G;
        "pkg-4.0.3+1.21.2" = _KVLiz13n;
        "pkg-4.0.4+1.21.4" = _3Nd8V3TT;
        "pkg-4.0.5+1.21.5" = _RDEZap7Y;
        "pkg-4.0.6+1.21.6" = _k18Jcy20;
        "pkg-4.0.7+1.21.9" = _aWy3KKvm;
        "pkg-4.1+1.20.1" = _AdoPOA94;
        "pkg-4.2+1.21.6" = _YdJbTsqA;
