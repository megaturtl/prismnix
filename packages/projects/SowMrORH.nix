...
let
    versions = (let
        ...
        _qInfpEsj = {
            "id" = "qInfpEsj";
            "file" = "Quieter_Elytra_26.3.zip";
            "hash" = "sha512-PkIQ2+NL2OuVwtnOhoZ2qQWstxT4naNtxim/BzogPUR19CrXhFAPM+FBOcXtTfakfZot8F3UmcWagvvthNm8YA==";
        };
    in {
        "gOWythMf" = _gOWythMf;
        "Q1qgx0Qj" = _Q1qgx0Qj;
        ...
        "minecraft-1.21.1" = _qInfpEsj;
        "minecraft-1.21.2" = _qInfpEsj;
        "minecraft-1.21.3" = _qInfpEsj;
        "minecraft-1.21.4" = _qInfpEsj;
        "minecraft-1.21.5" = _qInfpEsj;
        "minecraft-1.21.6" = _qInfpEsj;
        "minecraft-1.21.7" = _qInfpEsj;
        "minecraft-1.21.8" = _qInfpEsj;
        "minecraft-1.21.9" = _qInfpEsj;
        "minecraft-1.21.11" = _qInfpEsj;
        "minecraft-1.21.10" = _qInfpEsj;
        "minecraft-26.1" = _qInfpEsj;
        "minecraft-26.1.1" = _qInfpEsj;
        "minecraft-26.1.2" = _qInfpEsj;
        "minecraft-26.2" = _qInfpEsj;
        "minecraft-26.3" = _qInfpEsj;
        "pkg-1.0" = _gOWythMf;
        "pkg-1.1" = _Q1qgx0Qj;
        "pkg-1.2" = _A0JY9HlQ;
        "pkg-1.21.11" = _GUlHkeg6;
        "pkg-26.1" = _bAKbaysz;
        "pkg-26.2" = _6F7N0B6s;
        "pkg-26.3" = _qInfpEsj;
        "default" = _qInfpEsj;
