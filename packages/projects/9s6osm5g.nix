...
let
    ...
    in {
        ...
        "pkg-2.14.2+fabric" = _FtlBFpp0;
        "pkg-4.0.2+forge" = _tR748cRj;
        "pkg-4.14.54+forge" = _D7tEkaAc;
        "pkg-4.6.0+fabric" = _mJwBHBVB;
        "pkg-4.14.54+fabric" = _wqFP5baC;
        "pkg-5.3.58+forge" = _HvviXJZV;
        "pkg-5.3.58+fabric" = _vb3noRwi;
        "pkg-6.2.57+forge" = _6vFGWMar;
        "pkg-6.2.57+fabric" = _63NArvT8;
        "pkg-7.0.69" = _re60xAev;
        "pkg-7.0.69+forge" = _hcuWsP3M;
        "pkg-6.2.62+forge" = _DmOAoTTg;
        "pkg-6.2.62" = _d1D40LRO;
        "pkg-5.3.63" = _gb0cZ2Qp;
        "pkg-5.3.63+forge" = _GH6kNTCk;
        "pkg-4.14.64+forge" = _31tLmbMI;
        "pkg-4.14.64" = _KiKLKNrl;
        "pkg-7.0.72+fabric" = _wOP2dCdL;
        "pkg-7.0.72+forge" = _CsdOwOro;
        "pkg-7.0.73+fabric" = _ehzvjLXC;
        "pkg-7.0.73+forge" = _XInqR7zc;
        "pkg-7.0.74+fabric" = _FPWqEBEx;
        "pkg-7.0.74+forge" = _c4kFw2we;
        "pkg-8.0.75+fabric" = _hg9bSXT3;
        "pkg-8.0.75+forge" = _VazGdWq6;
        "pkg-8.1.77+fabric" = _JaKvOQIz;
        "pkg-8.1.77+forge" = _Q0bdszKc;
        "pkg-6.3.81" = _gPqHXnrg;
        "pkg-4.15.82" = _szXeTOs6;
        "pkg-8.2.88+fabric" = _EXrxCjl6;
        "pkg-8.2.88+forge" = _Fw7B2c97;
        "pkg-9.0.92+fabric" = _72Wj1Wri;
        "pkg-9.0.93+fabric" = _IVxgEGfU;
        "pkg-9.0.94+fabric" = _M3yxljrZ;
        "pkg-9.0.94+forge" = _VYURtAAK;
        "pkg-10.0.95+fabric" = _QXKLvmdz;
        "pkg-10.0.96+fabric" = _6XGTNEII;
        "pkg-10.0.96+forge" = _X8YuGurB;
        "pkg-11.0.97+fabric" = _XqZIxbLN;
        "pkg-11.0.98+fabric" = _dVpHBgHi;
        "pkg-11.0.99+fabric" = _y0kQixP8;
        "pkg-11.0.99+forge" = _aAaLEVNM;
        "pkg-4.16.91" = _CXaMuU8e;
        "pkg-4.17.101" = _i0ExoqTD;
        "pkg-6.5.102" = _ZbWG3eJW;
        "pkg-9.1.104+fabric" = _w2VZSLTf;
        "pkg-8.3.103+fabric" = _o9dFD9SO;
        "pkg-9.1.104+forge" = _8AMPotFw;
        "pkg-8.3.103+forge" = _EUyHCmUW;
        "pkg-10.1.105+fabric" = _mhFzbEwE;
        "pkg-10.1.105+forge" = _Sqf2NXVd;
        "pkg-11.1.106+fabric" = _s7VTKfLA;
        "pkg-11.1.106+forge" = _JoLgnJ0G;
        "pkg-12.0.107+fabric" = _YR0cy5Ll;
        "pkg-12.0.108+fabric" = _EuWT3qek;
        "pkg-12.0.109+fabric" = _LnfolBYb;
        "pkg-12.0.109+forge" = _IbAdAuBo;
        "pkg-12.0.110+fabric" = _HvC4UPrB;
        "pkg-12.0.110+forge" = _rMIyh1ac;
        "pkg-12.0.110+neoforge" = _XkFQE0kx;
        "pkg-12.0.111+fabric" = _jvy82BGQ;
        "pkg-12.0.111+forge" = _VmKENDcG;
        "pkg-12.0.111+neoforge" = _x8gS3Jdy;
        "pkg-13.0.112+fabric" = _Q4D6X8wF;
        "pkg-13.0.112+forge" = _gYTUlUKu;
        "pkg-13.0.112+neoforge" = _srGqKdky;
        "pkg-12.0.113+fabric" = _wjYUbvpn;
        "pkg-13.0.114+fabric" = _YFpDLLdu;
        "pkg-12.0.113+forge" = _A4lNtO10;
        "pkg-13.0.114+forge" = _q2CkD3c1;
        "pkg-13.0.114+neoforge" = _KBfIrjbA;
        "pkg-12.0.113+neoforge" = _2FKRnZ92;
        "pkg-11.1.118+fabric" = _J3FLptsi;
        "pkg-11.1.118+forge" = _nr1znv5v;
        "pkg-8.3.115+fabric" = _3Ejdp6VI;
        "pkg-8.3.115+forge" = _o6AGzycg;
        "pkg-10.1.117+fabric" = _4UgNKji6;
        "pkg-10.1.117+forge" = _w2LhUkqZ;
        "pkg-12.0.119+fabric" = _NPcjyMhi;
        "pkg-12.0.119+forge" = _Y51gygcX;
        "pkg-12.0.119+neoforge" = _6GeyuE7Y;
        "pkg-13.0.121+fabric" = _eBZiZ9NS;
        "pkg-13.0.121+forge" = _1MwQkf8u;
        "pkg-13.0.121+neoforge" = _hUXzyFVO;
        "pkg-14.0.122+fabric" = _3TLtSX1e;
        "pkg-14.0.123+fabric" = _JRZSHDFK;
        "pkg-14.0.125+fabric" = _X9ucoGCn;
        "pkg-14.0.126+fabric" = _znhJLkCd;
        "pkg-14.0.126+neoforge" = _PjKtC8lG;
        "pkg-15.0.127+fabric" = _Yc8omJNb;
        "pkg-15.0.127+neoforge" = _HsTzbbnf;
        "pkg-15.0.128+fabric" = _gY9NB5Rj;
        "pkg-15.0.128+neoforge" = _jMyYg8Uv;
        "pkg-14.0.129+fabric" = _JYR3Y30y;
        "pkg-14.0.129+forge" = _KWjX5anR;
        "pkg-14.0.129+neoforge" = _Y9QgGQ59;
        "pkg-15.0.130+fabric" = _7jtvrmVP;
        "pkg-15.0.130+forge" = _yPULtkhh;
        "pkg-15.0.130+neoforge" = _DqgODWcH;
        "pkg-16.0.131+fabric" = _Nf2ezsBW;
        "pkg-8.3.134+fabric" = _ZpV0fKbO;
        "pkg-8.3.134+forge" = _qqCHdFw2;
        "pkg-10.1.135+fabric" = _ZTMfeJij;
        "pkg-10.1.135+forge" = _mwddirHR;
        "pkg-11.1.136+fabric" = _2xQdCMyG;
        "pkg-11.1.136+forge" = _t8TXrZvZ;
        "pkg-14.0.139+fabric" = _g0uTATyM;
        "pkg-14.0.139+forge" = _nUTOGFsJ;
        "pkg-14.0.139+neoforge" = _hradv69C;
        "pkg-12.0.137+fabric" = _9YwAqtuZ;
        "pkg-12.0.137+forge" = _PZKJzxPT;
        "pkg-12.0.137+neoforge" = _mAH9Nl59;
        "pkg-15.0.140+fabric" = _HpMb5wGb;
        "pkg-15.0.140+forge" = _XMYFN6Zc;
        "pkg-15.0.140+neoforge" = _izKINKFg;
        "pkg-13.0.138+fabric" = _2deYQULk;
        "pkg-13.0.138+forge" = _YTNEzkHf;
        "pkg-13.0.138+neoforge" = _gUuDD6aJ;
        "pkg-16.0.141+fabric" = _JbVSQUVw;
        "pkg-16.0.141+neoforge" = _uYoucpky;
        "pkg-17.0.142+fabric" = _c8IkvzeS;
        "pkg-17.0.142+neoforge" = _FyidnRFd;
        "pkg-16.0.143+fabric" = _FgXq8Sfo;
        "pkg-16.0.143+forge" = _wJT939f6;
        "pkg-16.0.143+neoforge" = _h06GalE6;
        "pkg-17.0.144+fabric" = _TJ6o2sr4;
        "pkg-17.0.144+forge" = _i6G5WG2W;
        "pkg-17.0.144+neoforge" = _dWfheG9X;
        "pkg-18.0.145+fabric" = _qA00xo1O;
        "pkg-18.0.145+neoforge" = _jjrPm6iW;
        "pkg-19.0.146+fabric" = _4S1OUeMC;
        "pkg-19.0.146+neoforge" = _R1y82c6O;
        "pkg-19.0.147+fabric" = _cz0b1j8R;
        "pkg-19.0.147+neoforge" = _BYkKAJ0C;
        "pkg-20.0.148+fabric" = _otNNBWZy;
        "pkg-20.0.148+neoforge" = _VyyiGG8k;
        "pkg-20.0.149+fabric" = _qMxkrrmq;
        "pkg-20.0.149+neoforge" = _AzRGxC9j;
        "pkg-21.11.150+fabric" = _EwqYsm4K;
        "pkg-21.11.150+neoforge" = _ZuFcXTYx;
        "pkg-21.11.151+fabric" = _9aTLUrUA;
        "pkg-21.11.151+neoforge" = _Uz30wD1g;
        "pkg-21.11.152+fabric" = _vS4mgacg;
        "pkg-21.11.152+neoforge" = _wuzpi0tu;
        "pkg-21.11.153+fabric" = _xuX40TN5;
        "pkg-21.11.153+neoforge" = _Wsus0EWg;
        "pkg-26.1.154+fabric" = _GFM8zh9J;
