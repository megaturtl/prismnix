...
let
    versions = (let
        ...
        _jC3ukGlB = {
            "id" = "jC3ukGlB";
            "file" = "guild-plugin-1.6.6-snapshot.3.jar";
            "hash" = "sha512-87GoyQTuKcDrcR4kD0qeSUMk5uV6QtCm5pG5MH8lUJ5R53l1TyJVPSHoEEMfqW+AMeeZhPXuMX0mhdxuLXxzvw==";
        };
        _3C4LZTUA = {
            "id" = "3C4LZTUA";
            "file" = "guild-plugin-1.6.6-snapshot.4.jar";
            "hash" = "sha512-/qitJGtT96KbcWamZkgbK6aq3yqc7UlFsleTymz8A3cS9cnvzuGtKV5QO0vx5SOG5enTY3j2tPWYTY/PshLTXA==";
        };
        _P6It0G96 = {
            "id" = "P6It0G96";
            "file" = "guild-plugin-1.6.6-snapshot.5.jar";
            "hash" = "sha512-RhlQvrUCK/8H3yP5skaZswnVcGh3SVDqBYIBnwhxHezsBDbjTf7NMDDLtdb79HZo0SeTj/pyJMC8naaVgRSTTg==";
        };
        _oafqpqQq = {
            "id" = "oafqpqQq";
            "file" = "guild-plugin-1.6.6.jar";
            "hash" = "sha512-PCIGt8ozVmu+B0hObqepgH13e32Uw7p+Pt/pYRjP3G05PndBJNOcjO6i7Ycknr7Cp8yHr66nkAu8R5LqMevRAg==";
        };
        _8TyTrMm1 = {
            "id" = "8TyTrMm1";
            "file" = "guild-bungee-1.6.6.jar";
            "hash" = "sha512-SkjiyQNqLQvQ+DNfz9DviU2Wt0eMaXvzP1wPxkMjpyYdKaiPI6c/6YyJQMZs4IpvLRccPFvebQwPbNaNO+EZkw==";
        };
    in {
        "Bb7sXfOF" = _Bb7sXfOF;
        "XnMdN8Jr" = _XnMdN8Jr;
        ...
        "oafqpqQq" = _oafqpqQq;
        "8TyTrMm1" = _8TyTrMm1;
        "bukkit-1.21" = _oafqpqQq;
        "bukkit-1.21.1" = _oafqpqQq;
        "bukkit-1.21.2" = _oafqpqQq;
        "bukkit-1.21.3" = _oafqpqQq;
        "bukkit-1.21.4" = _oafqpqQq;
        "bukkit-1.21.5" = _oafqpqQq;
        "bukkit-1.21.6" = _oafqpqQq;
        "bukkit-1.21.7" = _oafqpqQq;
        "bukkit-1.21.8" = _oafqpqQq;
        "bukkit-1.21.9" = _oafqpqQq;
        "bukkit-1.21.10" = _oafqpqQq;
        "bukkit-1.21.11" = _oafqpqQq;
        "bukkit-26.1" = _oafqpqQq;
        "bukkit-26.1.1" = _oafqpqQq;
        "bukkit-26.1.2" = _oafqpqQq;
        "bukkit-26.2" = _oafqpqQq;
        "bukkit-1.20" = _oafqpqQq;
        "bukkit-1.20.1" = _oafqpqQq;
        "bukkit-1.20.2" = _oafqpqQq;
        "bukkit-1.20.3" = _oafqpqQq;
        "bukkit-1.20.4" = _oafqpqQq;
        "bukkit-1.20.5" = _oafqpqQq;
        "bukkit-1.20.6" = _oafqpqQq;
        "paper-1.21" = _oafqpqQq;
        "paper-1.21.1" = _oafqpqQq;
        "paper-1.21.2" = _oafqpqQq;
        "paper-1.21.3" = _oafqpqQq;
        "paper-1.21.4" = _oafqpqQq;
        "paper-1.21.5" = _oafqpqQq;
        "paper-1.21.6" = _oafqpqQq;
        "paper-1.21.7" = _oafqpqQq;
        "paper-1.21.8" = _oafqpqQq;
        "paper-1.21.9" = _oafqpqQq;
        "paper-1.21.10" = _oafqpqQq;
        "paper-1.21.11" = _oafqpqQq;
        "paper-26.1" = _oafqpqQq;
        "paper-26.1.1" = _oafqpqQq;
        "paper-26.1.2" = _oafqpqQq;
        "paper-26.2" = _oafqpqQq;
        "paper-1.20" = _oafqpqQq;
        "paper-1.20.1" = _oafqpqQq;
        "paper-1.20.2" = _oafqpqQq;
        "paper-1.20.3" = _oafqpqQq;
        "paper-1.20.4" = _oafqpqQq;
        "paper-1.20.5" = _oafqpqQq;
        "paper-1.20.6" = _oafqpqQq;
        "spigot-1.21" = _oafqpqQq;
        "spigot-1.21.1" = _oafqpqQq;
        "spigot-1.21.2" = _oafqpqQq;
        "spigot-1.21.3" = _oafqpqQq;
        "spigot-1.21.4" = _oafqpqQq;
        "spigot-1.21.5" = _oafqpqQq;
        "spigot-1.21.6" = _oafqpqQq;
        "spigot-1.21.7" = _oafqpqQq;
        "spigot-1.21.8" = _oafqpqQq;
        "spigot-1.21.9" = _oafqpqQq;
        "spigot-1.21.10" = _oafqpqQq;
        "spigot-1.21.11" = _oafqpqQq;
        "spigot-26.1" = _oafqpqQq;
        "spigot-26.1.1" = _oafqpqQq;
        "spigot-26.1.2" = _oafqpqQq;
        "spigot-26.2" = _oafqpqQq;
        "spigot-1.20" = _oafqpqQq;
        "spigot-1.20.1" = _oafqpqQq;
        "spigot-1.20.2" = _oafqpqQq;
        "spigot-1.20.3" = _oafqpqQq;
        "spigot-1.20.4" = _oafqpqQq;
        "spigot-1.20.5" = _oafqpqQq;
        "spigot-1.20.6" = _oafqpqQq;
        "folia-1.21" = _oafqpqQq;
        "folia-1.21.1" = _oafqpqQq;
        "folia-1.21.2" = _oafqpqQq;
        "folia-1.21.3" = _oafqpqQq;
        "folia-1.21.4" = _oafqpqQq;
        "folia-1.21.5" = _oafqpqQq;
        "folia-1.21.6" = _oafqpqQq;
        "folia-1.21.7" = _oafqpqQq;
        "folia-1.21.8" = _oafqpqQq;
        "folia-1.21.9" = _oafqpqQq;
        "folia-1.21.10" = _oafqpqQq;
        "folia-1.21.11" = _oafqpqQq;
        "folia-26.1" = _oafqpqQq;
        "folia-26.1.1" = _oafqpqQq;
        "folia-26.1.2" = _oafqpqQq;
        "folia-26.2" = _oafqpqQq;
        "folia-1.20" = _oafqpqQq;
        "folia-1.20.1" = _oafqpqQq;
        "folia-1.20.2" = _oafqpqQq;
        "folia-1.20.3" = _oafqpqQq;
        "folia-1.20.4" = _oafqpqQq;
        "folia-1.20.5" = _oafqpqQq;
        "folia-1.20.6" = _oafqpqQq;
        "purpur-1.21" = _oafqpqQq;
        "purpur-1.21.1" = _oafqpqQq;
        "purpur-1.21.2" = _oafqpqQq;
        "purpur-1.21.3" = _oafqpqQq;
        "purpur-1.21.4" = _oafqpqQq;
        "purpur-1.21.5" = _oafqpqQq;
        "purpur-1.21.6" = _oafqpqQq;
        "purpur-1.21.7" = _oafqpqQq;
        "purpur-1.21.8" = _oafqpqQq;
        "purpur-1.21.9" = _oafqpqQq;
        "purpur-1.21.10" = _oafqpqQq;
        "purpur-1.21.11" = _oafqpqQq;
        "purpur-26.1" = _oafqpqQq;
        "purpur-26.1.1" = _oafqpqQq;
        "purpur-26.1.2" = _oafqpqQq;
        "purpur-26.2" = _oafqpqQq;
        "purpur-1.20" = _oafqpqQq;
        "purpur-1.20.1" = _oafqpqQq;
        "purpur-1.20.2" = _oafqpqQq;
        "purpur-1.20.3" = _oafqpqQq;
        "purpur-1.20.4" = _oafqpqQq;
        "purpur-1.20.5" = _oafqpqQq;
        "purpur-1.20.6" = _oafqpqQq;
        "bungeecord-1.21" = _8TyTrMm1;
        "bungeecord-1.21.1" = _8TyTrMm1;
        "bungeecord-1.21.2" = _8TyTrMm1;
        "bungeecord-1.21.3" = _8TyTrMm1;
        "bungeecord-1.21.4" = _8TyTrMm1;
        "bungeecord-1.21.5" = _8TyTrMm1;
        "bungeecord-1.21.6" = _8TyTrMm1;
        "bungeecord-1.21.7" = _8TyTrMm1;
        "bungeecord-1.21.8" = _8TyTrMm1;
        "bungeecord-1.21.9" = _8TyTrMm1;
        "bungeecord-1.21.10" = _8TyTrMm1;
        "bungeecord-1.21.11" = _8TyTrMm1;
        "bungeecord-26.1" = _8TyTrMm1;
        "bungeecord-26.1.1" = _8TyTrMm1;
        "bungeecord-26.1.2" = _8TyTrMm1;
        "bungeecord-26.2" = _8TyTrMm1;
        "pkg-1.0.0" = _Bb7sXfOF;
        "pkg-1.1.8" = _XnMdN8Jr;
        "pkg-1.2.3" = _FCndiZOG;
        "pkg-1.2.4" = _pI21Jdo3;
        ...
        "pkg-1.6.4" = _Iky8OWqy;
        "pkg-1.6.5" = _v8WVN83l;
        "pkg-1.6.6-snapshot.1" = _wF0iYVT0;
        "pkg-1.6.6-snapshot.2" = _f6zOnrxk;
        "pkg-1.6.6-snapshot.3" = _jC3ukGlB;
        "pkg-1.6.6-snapshot.4" = _3C4LZTUA;
        "pkg-1.6.6-snapshot.5" = _P6It0G96;
        "pkg-1.6.6" = _8TyTrMm1;
        "default" = _8TyTrMm1;
    });
