...
let
    versions = (let
        ...
        _DWrhXRns = {
            "id" = "DWrhXRns";
            "file" = "EvenMoreFish-2.4.4.jar";
            "hash" = "sha512-KRLBYrQ4466TXvsNmAmhMNCMZftnpZS46L6sAwoain6ocK0WAq9Gfgn1dNm8dfVXUldtHzyJT8QADqt8IhJIaw==";
        };
        _MKln9z8c = {
            "id" = "MKln9z8c";
            "file" = "EvenMoreFish-2.4.5.jar";
            "hash" = "sha512-lsDS8lDER6x/qG1Xxq0k4vE344k0hDwc/AYDZQjYtlDzsdiHfFtpgREUko5UMI+XfHp0075exGyywPejkSNQ2g==";
        };
        _KEn7lPL0 = {
            "id" = "KEn7lPL0";
            "file" = "EvenMoreFish-2.4.6.jar";
            "hash" = "sha512-46nZud00FcHWE3r61B+QVXiQVEAOCXhZ9FcGP2La7Jmotepf9Zvb07g2w4gbS6LYIwK7y5A7w1Bzyg2o/Jc1gQ==";
        };
        _1889nypq = {
            "id" = "1889nypq";
            "file" = "EvenMoreFish-2.4.7.jar";
            "hash" = "sha512-ZhIbVeAAt7X7QnB0uyTB+DocgFITE7YQov6uTWHEzFIIwXpJ/3W25xZQ753m/0QdOZBA7Lwvdc9iMUOB0zkzLg==";
        };
    in {
        "dmZt9Eki" = _dmZt9Eki;
        "pwOsW0uE" = _pwOsW0uE;
        ...
        "paper-1.20.6" = _1889nypq;
        "paper-1.21.1" = _1889nypq;
        "paper-1.20" = _1889nypq;
        "paper-1.20.1" = _1889nypq;
        "paper-1.20.2" = _1889nypq;
        "paper-1.20.3" = _1889nypq;
        "paper-1.20.4" = _1889nypq;
        "paper-1.20.5" = _1889nypq;
        "paper-1.21" = _1889nypq;
        "paper-1.21.2" = _1889nypq;
        "paper-1.21.3" = _1889nypq;
        "paper-1.21.4" = _1889nypq;
        "paper-1.21.5" = _1889nypq;
        "paper-1.21.6" = _1889nypq;
        "paper-1.21.7" = _1889nypq;
        "paper-1.21.8" = _1889nypq;
        "paper-1.21.9" = _1889nypq;
        "paper-1.21.10" = _1889nypq;
        "paper-1.21.11" = _1889nypq;
        "paper-26.1" = _1889nypq;
        "paper-26.1.1" = _1889nypq;
        "paper-26.1.2" = _1889nypq;
        "paper-26.2" = _1889nypq;
        "folia-1.20" = _1889nypq;
        "folia-1.20.1" = _1889nypq;
        "folia-1.20.2" = _1889nypq;
        "folia-1.20.3" = _1889nypq;
        "folia-1.20.4" = _1889nypq;
        "folia-1.20.5" = _1889nypq;
        "folia-1.20.6" = _1889nypq;
        "folia-1.21" = _1889nypq;
        "folia-1.21.1" = _1889nypq;
        "folia-1.21.2" = _1889nypq;
        "folia-1.21.3" = _1889nypq;
        "folia-1.21.4" = _1889nypq;
        "folia-1.21.5" = _1889nypq;
        "folia-1.21.6" = _1889nypq;
        "folia-1.21.7" = _1889nypq;
        "folia-1.21.8" = _1889nypq;
        "folia-1.21.9" = _1889nypq;
        "folia-1.21.10" = _1889nypq;
        "folia-1.21.11" = _1889nypq;
        "folia-26.1" = _1889nypq;
        "folia-26.1.1" = _1889nypq;
        "folia-26.1.2" = _1889nypq;
        "folia-26.2" = _1889nypq;
        "pkg-1.7.3" = _dmZt9Eki;
        "pkg-2.0.0-RC1" = _pwOsW0uE;
        "pkg-2.0.0-RC2" = _OiRAvDU1;
        "pkg-2.0.0-RC3" = _ALfMslnj;
        "pkg-2.0.0-RC4" = _j5zz9bYv;
        "pkg-2.0.0" = _dzaYu3js;
        "pkg-2.0.1" = _mNR8oX0c;
        "pkg-2.0.2" = _jltFpcYM;
        "pkg-2.0.3" = _WYusS4qq;
        ...
        "pkg-2.0.8" = _QI3k0og0;
        "pkg-2.0.9" = _UT7M9OdR;
        "pkg-2.0.10" = _uNBqZ55s;
        "pkg-2.0.11" = _Pwq969tM;
        "pkg-2.0.12-BETA" = _2v0vP4w8;
        "pkg-2.0.12" = _Yn7Mljz9;
        "pkg-2.0.13" = _eRgwh9zG;
        "pkg-2.0.14" = _qSKmvDMg;
        "pkg-2.0.15" = _kcp9ETSB;
        "pkg-2.0.16-1.20" = _HeY2PlxH;
        "pkg-2.0.16-1.21" = _AzDimawd;
        "pkg-2.1.0-1.20" = _qMvbUon8;
        "pkg-2.1.0-1.21" = _953VPov3;
        "pkg-2.1.1-1.20" = _FQi2zthS;
        "pkg-2.1.1-1.21" = _pXPEacwo;
        "pkg-2.1.2-1.20" = _2exhch0X;
        "pkg-2.1.2-1.21" = _3dJZiBP7;
        "pkg-2.1.3-1.20" = _LsYj5lUp;
        "pkg-2.1.3-1.21" = _gY6QpgGV;
        "pkg-2.1.4-1.20" = _HlqlPHEW;
        "pkg-2.1.4-1.21" = _kCWABNIh;
        "pkg-2.1.5-1.20" = _6lyLdoXV;
        "pkg-2.1.5-1.21" = _ThpGn4W8;
        "pkg-2.1.6-1.20" = _PlAk1s9F;
        "pkg-2.1.6-1.21" = _zGVhCHHw;
        "pkg-2.1.7-1.20" = _tq9CmLzb;
        "pkg-2.1.7-1.21" = _CvIti1Dc;
        "pkg-2.1.8-1.20" = _Hc8e4iPu;
        "pkg-2.1.8-1.21" = _Q52VngXi;
        "pkg-2.1.9-1.20" = _nGSIe5Jj;
        "pkg-2.1.9-1.21" = _c7Af9FQf;
        "pkg-2.1.10-1.20" = _Qv0CDPn8;
        "pkg-2.1.10-1.21" = _ltb6ifpb;
        "pkg-2.1.11-1.20" = _Io358mOx;
        "pkg-2.1.11-1.21" = _5bqgCbZm;
        "pkg-2.1.12-1.20" = _ZoNVZo94;
        "pkg-2.1.12-1.21" = _jKtf6GPi;
        "pkg-2.1.13-1.20" = _FETuGxmm;
        "pkg-2.1.13-1.21" = _eCEN7zdE;
        "pkg-2.1.14-1.20" = _v50NOyHb;
        "pkg-2.1.14-1.21" = _ZY6MIJb0;
        "pkg-2.2.0-1.20" = _ZHDaNZTX;
        "pkg-2.2.0-1.21" = _8CF2IF9L;
        "pkg-2.2.0-26.1" = _1FCt7EHt;
        "pkg-2.2.1-1.20" = _vtHXKCgJ;
        "pkg-2.2.1-1.21" = _e63ry6Dk;
        "pkg-2.2.1-26.1" = _bLaQITLQ;
        "pkg-2.2.2-1.20" = _YJDLDvBS;
        "pkg-2.2.2-1.21" = _kqISHLJF;
        "pkg-2.2.2-26.1" = _gAgHL5NF;
        "pkg-2.2.3-1.20" = _ydkXarH9;
        "pkg-2.2.3-1.21" = _NzduK52H;
        "pkg-2.2.3-26.1" = _Kn0iggiF;
        "pkg-2.3.0-1.20" = _QhNah1yl;
        "pkg-2.3.0-1.21" = _eCBIqpd4;
        "pkg-2.3.0-26.1" = _WWsN5mWG;
        "pkg-2.3.1-1.20" = _XJUXoN6t;
        "pkg-2.3.1-1.21" = _uZg7RsFs;
        "pkg-2.3.1-26.1" = _7ODHumF9;
        "pkg-2.3.2-1.20" = _bHx8ULC8;
        "pkg-2.3.2-1.21" = _hVHPKA3G;
        "pkg-2.3.2-26.1" = _wUzS8FnC;
        "pkg-2.3.3-1.20" = _CQVmPDY7;
        "pkg-2.3.3-1.21" = _ii99JLrT;
        "pkg-2.3.3-26.1" = _elEnb0YJ;
        "pkg-2.3.4-1.20" = _sPQYD8WH;
        "pkg-2.3.4-1.21" = _PxQI8TB2;
        "pkg-2.3.4-26.1" = _132NMC5z;
        "pkg-2.3.5-1.20" = _LzWGiTmN;
        "pkg-2.3.5-1.21" = _jrIIRUh4;
        "pkg-2.3.5-26.1" = _KWL5MPDz;
        "pkg-2.3.6-1.20" = _NMh0Avlt;
        "pkg-2.3.6-1.21" = _hdsB2LSJ;
        "pkg-2.3.6-26.1" = _9I521Foc;
        "pkg-2.3.7-1.20" = _pZJHMxyC;
        "pkg-2.3.7-1.21" = _dEB0THhC;
        "pkg-2.3.7-26.1" = _rhwiesLJ;
        "pkg-2.3.7-26.2" = _RivgRBue;
        "pkg-2.4.0" = _zkrhuXyp;
        "pkg-2.4.1" = _F9IBL3L3;
        "pkg-2.4.2" = _Lmn43yBf;
        "pkg-2.4.3" = _uf95yrYv;
