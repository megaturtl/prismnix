...
let
    versions = (let
        ...
        _EaMo8zOI = {
            "id" = "EaMo8zOI";
            "file" = "respiteful-1.4.0.jar";
            "hash" = "sha512-j9WmPmG7OuQWODERUHWhEycT9uYs/vZbC8CkS6cSfls7vVcJALt7/Ml2lAcCvSV43L7ZJidyXHVI2FKMzWMLMQ==";
        };
        _wXBWChUn = {
            "id" = "wXBWChUn";
    ...
    in {
        ...
        "pkg-1.1.1" = _2oXD8dnw;
        "pkg-1.1.2" = _N4AigGlu;
        "pkg-1.1.2.b" = _k26SDye8;
        "pkg-1.1.2.c" = _ckuYCn0m;
        "pkg-1.2.0" = _bdqN5nHs;
        "pkg-1.2.1" = _SpLtls7A;
        "pkg-1.3.0" = _abeMbdkJ;
        "pkg-1.4.0" = _EaMo8zOI;
