...
let
    versions = (let
        ...
        _TUuCQpME = {
            "id" = "TUuCQpME";
            "file" = "defaulted_drops-1.7.0+MC26.3.x.jar";
            "hash" = "sha512-R//OdK90rU1LjX/o713bx9RV7uRNz/gLQ94qdsB3a1sECpxqF/vSVV79mteK3+O5p9ZWOEFDcIi+3mbUmcN/xQ==";
        };
    in {
        "mAl0bvfw" = _mAl0bvfw;
        "euY4DHtv" = _euY4DHtv;
