...
let
    ...
    in {
        ...
        "pkg-1.18.2-1.1.0" = _NRp5IV4N;
        "pkg-1.18.2-1.1.1" = _eomAk6iW;
        "pkg-1.18.2-1.2.0" = _L7y5xMpa;
        "pkg-1.19-2.0.0" = _aTZxqXWi;
        "pkg-1.18.2-1.2.1" = _TUH119Gx;
        "pkg-1.19-2.0.1" = _O2bzNKDN;
        "pkg-1.18.2-1.2.2" = _mfwuCfeo;
        "pkg-1.19-2.0.2" = _pBbuGG94;
        "pkg-1.19-2.0.3" = _acZQwWaA;
        "pkg-1.19.1-2.1.0" = _zdH4KvFK;
        "pkg-1.19.1-2.1.1" = _sEn9Kon4;
        "pkg-1.19.1-2.1.2" = _9TkJdeDl;
        "pkg-1.20.1-3.0.0" = _VVadb99e;
        "pkg-1.19.1-2.1.3" = _rwtIVFnB;
        "pkg-1.19.1-2.1.4" = _RpLa8eup;
        "pkg-1.20.1-3.0.1" = _N8ufbjWi;
        "pkg-1.20.1-3.0.2" = _j5smfNom;
        "pkg-1.20.1-3.0.3" = _UVFy91Ho;
        "pkg-1.20.1-3.0.4" = _AUVk43b2;
        "pkg-1.20.1-3.0.5" = _h9UTpIrF;
        "pkg-1.20.1-3.0.6" = _fj0twEdD;
        "pkg-1.20.1-3.0.7" = _ZoETAJ7T;
        "pkg-1.20.1-3.0.8" = _AkEByLIy;
        "pkg-1.20.1-3.0.9" = _K84rsySD;
        "pkg-1.20.1-3.0.10" = _EIZ0rkAN;
        "pkg-1.20.1-3.0.11" = _6mo2UV9K;
        "pkg-1.20.1-3.0.12" = _h2yHRuAQ;
        "pkg-1.20.1-3.0.13" = _thsl6RTL;
        "pkg-1.20.1-3.0.14" = _ozwH4S2H;
        "pkg-1.20.1-3.0.15" = _uieEarZ3;
        "pkg-1.20.1-3.0.16" = _Lpsr9UqS;
        "pkg-21.1.0" = _R73E5T8q;
        "pkg-21.1.1" = _WLDOICGV;
        "pkg-21.1.2" = _TI0wbcyc;
        "pkg-1.18.2-1.2.3" = _Fh27mGDU;
        "pkg-1.19.1-2.1.5" = _BExYMoKE;
        "pkg-21.1.3" = _c7lwBqVE;
        "pkg-21.1.4" = _RCtxkgKY;
        "pkg-21.1.5" = _IhYwHQtQ;
