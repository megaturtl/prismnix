...
let
    ...
    in {
        ...
        "minecraft-23w33a" = _ihQ2TwXG;
        "minecraft-23w35a" = _ihQ2TwXG;
        "minecraft-1.20.2-pre1" = _ihQ2TwXG;
        "minecraft-1.20.2" = _ihQ2TwXG;
        "minecraft-23w42a" = _ihQ2TwXG;
        "minecraft-23w43a" = _ihQ2TwXG;
        "minecraft-23w43b" = _ihQ2TwXG;
        "minecraft-23w44a" = _ihQ2TwXG;
        "minecraft-23w45a" = _ihQ2TwXG;
        "minecraft-23w46a" = _ihQ2TwXG;
        "minecraft-1.20.3" = _ihQ2TwXG;
        "minecraft-1.20.4" = _ihQ2TwXG;
        "minecraft-24w03a" = _ihQ2TwXG;
        "minecraft-24w03b" = _ihQ2TwXG;
        "minecraft-24w04a" = _ihQ2TwXG;
        "minecraft-24w05a" = _ihQ2TwXG;
        "minecraft-24w05b" = _ihQ2TwXG;
        "minecraft-24w06a" = _ihQ2TwXG;
        "minecraft-24w07a" = _ihQ2TwXG;
        "minecraft-24w09a" = _ihQ2TwXG;
        "minecraft-24w10a" = _ihQ2TwXG;
        "minecraft-24w11a" = _ihQ2TwXG;
        "minecraft-24w12a" = _ihQ2TwXG;
        "minecraft-24w13a" = _ihQ2TwXG;
        "minecraft-24w14potato" = _ihQ2TwXG;
        "minecraft-24w14a" = _ihQ2TwXG;
        "minecraft-1.20.5-pre1" = _ihQ2TwXG;
        "minecraft-1.20.5-pre2" = _ihQ2TwXG;
        "minecraft-1.20.5-pre3" = _ihQ2TwXG;
        "minecraft-1.20.5" = _ihQ2TwXG;
        "minecraft-1.20.6" = _ihQ2TwXG;
        "minecraft-24w18a" = _ihQ2TwXG;
        "minecraft-24w19a" = _ihQ2TwXG;
        "minecraft-24w19b" = _ihQ2TwXG;
        "minecraft-24w20a" = _ihQ2TwXG;
        "minecraft-1.21" = _ihQ2TwXG;
        "pkg-1.0.0" = _UJbd105Y;
        "pkg-1.1.0" = _cSMgwfia;
        "pkg-1.2.0" = _Oe6Zr0rO;
        "pkg-1.3.0" = _AxI6mXj9;
