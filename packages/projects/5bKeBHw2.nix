...
let
    ...
    in {
        ...
        "pkg-2.0.1-beta" = _ZOMZn5r8;
        "pkg-2.0.2-beta" = _WqvS7c4S;
        "pkg-2.0.3-beta" = _YEc4lMKJ;
        "pkg-2.0.4-beta" = _wnhoyBAY;
        "pkg-2.0.5-beta" = _AS9BDXOi;
        "pkg-2.0.6-beta" = _XDrC0EfE;
        "pkg-2.0.7-beta" = _Pg4UpECk;
        "pkg-2.0.8-beta" = _ejeIbpd9;
        "pkg-2.0.9-beta" = _ugCoHkUG;
        "pkg-2.1.0" = _I96cRUUG;
        "pkg-2.1.1" = _Ep5SsLlY;
        "pkg-2.1.3" = _TicDteEA;
        "pkg-2.1.4" = _kskBMTIp;
        ...
        "pkg-2.1.8" = _gEYtVTep;
        "pkg-2.1.9" = _M7YlhBuG;
        "pkg-2.1.10" = _NT78lImW;
        "pkg-2.1.11" = _8i9YGVLv;
        "pkg-2.1.12" = _ff2xqvCt;
        "pkg-2.1.13" = _u29E8VtK;
        "pkg-2.1.14" = _1M80woZn;
        "pkg-2.1.15" = _UZns29eV;
        "pkg-2.1.16" = _AL5ILy6Z;
        "pkg-2.1.17" = _gJiot3h6;
        "pkg-2.1.18" = _3pqbYHWH;
        "pkg-2.1.19" = _tw6j36vR;
        "pkg-2.1.20" = _OwDNu91f;
        "pkg-2.1.21" = _UwgG4DYC;
        "pkg-2.1.22" = _ZXszXbjJ;
        "pkg-2.1.23" = _t7KGvsmo;
        "pkg-2.1.24" = _eaGYPROS;
        "pkg-2.1.25" = _Qz8OzhXv;
        "pkg-2.1.26" = _owVJs9G8;
        "pkg-3.0.0" = _2oLokApt;
        "pkg-3.0.1" = _WMRLvd9Z;
        "pkg-3.0.2" = _ds5IQD8n;
        "pkg-3.0.3" = _eAqHiCOo;
        "pkg-3.0.4" = _xrHcKcvV;
        "pkg-2.1.27" = _lQF2K7o9;
        "pkg-3.0.5" = _60DUZxHI;
        "pkg-3.0.6" = _FDiznDxk;
        "pkg-3.0.7" = _vyHFYDps;
        "pkg-3.0.8" = _gZu9W4QJ;
