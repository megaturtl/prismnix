...
let
    ...
    in {
        ...
        "pkg-1.18.2-0.0.1.0-beta1" = _QY6qaE08;
        "pkg-1.16.5-0.0.1.0-beta2" = _o8Jfvtlc;
        "pkg-1.18.2-0.0.1.0-beta2" = _kcNIomb8;
        "pkg-1.19.2-0.0.1.0-beta2" = _9vZTdyG6;
        "pkg-1.16.5-0.0.1.0-beta3" = _uE5PgHT3;
        "pkg-1.18.2-0.0.1.0-beta3" = _ttXTaWY1;
        "pkg-1.19.2-0.0.1.0-beta3" = _YufoUoEt;
        "pkg-1.16.5-0.0.1.0-beta4" = _IwzC7qJr;
        "pkg-0.0.1.1-beta4" = _OWEF56Eo;
        "pkg-0.0.1.2-beta4" = _AYUM9Hhb;
        "pkg-0.0.1.3-beta4" = _9r3FnhB3;
        "pkg-0.0.1.4-beta4" = _zqvn6V9R;
        "pkg-0.0.2.1-beta4" = _8eJl03l7;
        "pkg-0.0.2.2-beta4" = _E5eQL4Mm;
        "pkg-0.0.2.3-beta4" = _boLwFk4p;
        "pkg-0.0.2.4-beta4" = _JMPUqvXg;
        "pkg-0.0.2.5-beta4" = _dyxm1HD9;
        "pkg-0.0.2.6-beta4" = _7P6wsL9I;
        "pkg-0.0.2.6-beta1" = _2LA4uAGl;
        "pkg-0.0.2.7-beta1" = _eYqa7gg2;
        "pkg-0.0.2.7-beta2" = _UjdPS0uj;
        "pkg-0.0.2.8-beta1" = _y13um8df;
        "pkg-0.0.2.8-beta2" = _7B3noLcd;
        "pkg-0.0.2.9-beta1" = _YaF7Ehuy;
        "pkg-0.0.2.9-beta2" = _SnutYynY;
        "pkg-0.0.2.9-beta3" = _QxOMVwsX;
        "pkg-0.0.3.0-beta1" = _UfGNhTHr;
        "pkg-0.0.2.9-beta4" = _OP04fNAK;
        "pkg-0.0.4.0-beta1" = _PXYcv4ju;
        "pkg-0.0.2.10-alpha1" = _WVrZYA3A;
        "pkg-0.0.2.10-alpha2" = _xpvSS4oW;
        "pkg-0.0.4.0-beta2" = _N82bnGpJ;
        "pkg-0.0.4.0-beta3" = _KjybKcIy;
        "pkg-0.0.4.1-beta1" = _syoHpPAN;
        "pkg-0.0.4.1-beta2" = _xXymtjJo;
        "pkg-0.0.4.1-beta3" = _p8ePTcya;
        "pkg-0.0.4.1-beta4" = _W5QfJ6xE;
        "pkg-0.0.4.1-beta5" = _aqJC9Q23;
        "pkg-0.5.0-beta1" = _P9c6EWVr;
        "pkg-0.5.0-beta2" = _NC0ZhUxS;
        "pkg-0.5.1-beta1" = _KVyw2qO5;
        "pkg-0.5.1-beta2" = _VcAcDGky;
        "pkg-0.5.1-beta3" = _1H6cJnRi;
        "pkg-0.5.1-beta4" = _qFHAEeox;
        "pkg-1.21.4-0.5.2-beta1" = _cvldgPKb;
        "pkg-1.21.1-0.5.2-beta1" = _xcaanqWF;
        "pkg-1.20.1-0.5.2-beta1" = _yMeNHQuE;
        "pkg-1.21.1-0.5.2-beta2" = _3xLViBct;
        "pkg-1.20.1-0.5.2-beta2" = _pWqjZcns;
        "pkg-1.21.4-0.5.2-beta2" = _No177c3Z;
        "pkg-1.20.1-0.5.2-beta3" = _bBIvZmCo;
        "pkg-1.21.4-0.5.2-beta3" = _BlbyOVCO;
        "pkg-1.21.1-0.5.2-beta3" = _7jjMSaOb;
        "pkg-1.20.1-0.5.2-beta4" = _Msw0uVfr;
        "pkg-1.21.1-0.5.2-beta4" = _h7ORu4Or;
        "pkg-1.21.5-0.5.3-beta1" = _Eu9GC48Q;
        "pkg-1.21.5-0.5.3-beta2" = _9Vp3xxcE;
        "pkg-1.21.7-0.5.3-beta2" = _qxnO3irk;
        "pkg-1.21.6-0.6.0-beta1" = _e5yTBKi1;
        "pkg-1.21.7-0.6.0-beta1" = _IQawZtCV;
        "pkg-1.21.1-0.6.0-beta1" = _iA68PLCe;
        "pkg-1.21.4-0.6.0-beta1" = _ZqrcHVQY;
        "pkg-1.21.5-0.6.0-beta1" = _R71Mg7PY;
        "pkg-1.20.1-0.6.0-beta1" = _Mq3DQAMb;
        "pkg-1.21.8-0.6.1-beta1" = _X6zBViFu;
        "pkg-1.21.6-0.6.1-beta1" = _KiyHE5Lg;
        "pkg-1.20.1-0.6.1-beta1" = _wRgPcNik;
        "pkg-1.21.7-0.6.1-beta1" = _3yULZUt5;
        "pkg-1.21.5-0.6.1-beta1" = _TSorjCBH;
        "pkg-1.21.4-0.6.1-beta1" = _whYMg0bM;
        "pkg-1.21.10-0.6.1-beta1" = _VisRp0O3;
        "pkg-1.21.1-0.6.1-beta1" = _wV9N6lM5;
        "pkg-1.21.10-0.6.2-beta1" = _etBkqYGs;
        "pkg-1.20.1-0.6.2-beta1" = _lFZBAkwu;
        "pkg-1.21.6-0.6.2-beta1" = _ROhzxXcr;
        "pkg-1.21.7-0.6.2-beta1" = _86f1XGVu;
        "pkg-1.21.8-0.6.2-beta1" = _Sh4VsTSs;
        "pkg-1.21.4-0.6.2-beta1" = _X5UFBzXZ;
        "pkg-1.21.1-0.6.2-beta1" = _fxp89mBL;
        "pkg-1.21.5-0.6.2-beta1" = _lKG4VxLD;
        "pkg-1.20.1-0.6.3-beta1" = _4HuYF8X5;
        "pkg-1.21.1-0.6.3-beta1" = _co9EBqFq;
        "pkg-1.21.11-0.6.2-beta1" = _qIozZcHS;
        "pkg-26.1.2-0.6.3-beta2" = _FFLRmCnH;
