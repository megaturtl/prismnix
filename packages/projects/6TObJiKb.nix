...
let
    versions = (let
        ...
        _rOhLh9Dl = {
            "id" = "rOhLh9Dl";
            "file" = "CONTRASTpack (26.3).zip";
            "hash" = "sha512-aeRLw9yM5XmakxqoWT/bQ1O18mazwZe2isU8GMn+pdvn6X0kL82anhVZuiRTEH1kxZyXwS+M2j1/Y46RKmGCEA==";
        };
    in {
        "NbV5JLUa" = _NbV5JLUa;
        "ZJmaDTOc" = _ZJmaDTOc;
