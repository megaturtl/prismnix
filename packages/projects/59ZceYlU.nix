...
let
    versions = (let
        ...
        _tY57GRtu = {
            "id" = "tY57GRtu";
            "file" = "Pixelmon-1.21.1-9.4.1-universal.jar";
            "hash" = "sha512-x+U2MBAIV+Oz1I0qvksZZY2GScUNTqjgTOQ97j7IUKLlu4oG91wnKMvQjXzIwNIYhzC0DvRjQfkkQWGX0VRrug==";
        };
    in {
        "IuRVEXF5" = _IuRVEXF5;
        "FtWGuJP5" = _FtWGuJP5;
        ...
        "pkg-9.0.8" = _3QAYSgTy;
        "pkg-9.0.9" = _9SxGr8HD;
        "pkg-9.0.10" = _EwLzUvgz;
        "pkg-9.0.11" = _ER5ce9Pp;
        "pkg-9.1.0" = _Xbwa6BHt;
        "pkg-8.4.3" = _Q8fEBG8j;
        "pkg-9.1.1" = _v5UTCp5W;
        "pkg-9.1.2" = _6CfQVcqh;
        ...
        "pkg-9.1.9" = _DLDpx0OM;
        "pkg-9.2.5" = _CULKMDLL;
        "pkg-9.1.10" = _Ro92Bd6N;
        "pkg-9.2.6" = _3qsyShYH;
        "pkg-9.1.11" = _12zaqOAo;
        "pkg-9.2.7" = _6kPAGdMk;
        "pkg-9.2.8" = _pNvKBLTe;
        "pkg-9.1.12" = _zogGWRSd;
        "pkg-9.2.9" = _BfvnmqXO;
        "pkg-9.1.13" = _CPLYWxEL;
        "pkg-9.2.10" = _KhZuM1q9;
        "pkg-9.3.0" = _oh42evR7;
        "pkg-9.3.1" = _GRvQII5D;
        "pkg-9.3.2" = _axM9kF0u;
        "pkg-9.3.3" = _BaOcLFkA;
        ...
        "pkg-9.3.8" = _CAExLf4o;
        "pkg-9.3.9" = _MXMazOPQ;
        "pkg-9.3.10" = _iID7gear;
        "pkg-9.3.11" = _O6Fnh4cl;
        "pkg-9.3.12" = _XRJV7uOx;
        "pkg-9.3.13" = _mbNh2aQM;
