...
let
    ...
    in {
        ...
        "pkg-1.0.0-mc1.19.2" = _cpkfsUwz;
        "pkg-1.0.1-mc1.19.2" = _9iUwSI2V;
        "pkg-1.0.1-mc1.18.2" = _l1guFcLO;
        "pkg-1.0.2-mc1.19.3" = _uNxNut9V;
        "pkg-1.0.3-mc1.19.3" = _gXPQpzBz;
        "pkg-1.0.4-mc1.19.4" = _99ib4SF1;
        "pkg-1.0.5" = _QyTULmbx;
        "pkg-1.1.0-mc1.20" = _zZ8zem4C;
        "pkg-1.1.0-mc1.19.2" = _OUAuSbR9;
        "pkg-1.1.1-mc1.19.2" = _VBZ13Nzd;
        "pkg-1.1.1-mc1.20" = _BQqFjNdk;
        "pkg-1.1.2-mc1.20.1" = _zgIhFEWk;
        "pkg-1.1.3-mc1.20.1" = _5YVfxpmd;
        "pkg-1.1.4" = _DwZgKHDi;
        "pkg-1.2.0" = _KuGMOcjg;
        "pkg-1.2.0-1.21" = _wQeXjQ0S;
        "pkg-1.2.1" = _sycz1d5K;
        "pkg-1.2.0v2" = _t7bhb4Hh;
        "pkg-1.2.1v2" = _u7NtSedA;
        "pkg-1.3.0" = _51Eru4i8;
        "pkg-2.0.0+1.21.11-fabric" = _znzh5vhg;
        "pkg-2.0.1+1.21.11-fabric" = _8DlhlP50;
        "pkg-2.1.0+1.21.10-neoforge" = _WQ0GF5rm;
        "pkg-2.1.0+1.21.11-neoforge" = _SiCYAAO4;
        "pkg-2.1.0+1.21.5-neoforge" = _VvhW6Cml;
        "pkg-2.1.0+1.21.8-neoforge" = _1Ud00HEh;
        "pkg-2.1.0+1.21.11-fabric" = _ZhBRnTxh;
        "pkg-2.1.0+1.21.10-fabric" = _gUN3lmIP;
        "pkg-2.1.0+1.21.8-fabric" = _YlvHy6eQ;
        "pkg-2.1.0+1.21.5-fabric" = _cSbiUUCM;
        "pkg-2.2.0+1.21.10-fabric" = _WeNN1HDU;
        "pkg-2.2.0+1.21.10-neoforge" = _BQwlFsR4;
        "pkg-2.2.0+1.21.5-neoforge" = _Y0nJZNkV;
        "pkg-2.2.0+1.21.11-fabric" = _Hdgn8NiT;
        "pkg-2.2.0+1.21.11-neoforge" = _snCj5o16;
        "pkg-2.2.0+1.21.5-fabric" = _wYqKt1YY;
        "pkg-2.2.0+1.21.8-neoforge" = _tMXEECqb;
        "pkg-2.2.0+1.21.8-fabric" = _GlOdAEqw;
        "pkg-2.2.0+26.1-fabric" = _QugnlZ83;
        "pkg-2.2.1+26.1-fabric" = _fhaLes1o;
        "pkg-2.2.1+26.1-neoforge" = _kYX8CaH6;
        "pkg-2.3.0+26.1-fabric" = _ETNFQGJP;
