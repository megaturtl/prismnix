...
let
    versions = (let
        ...
        _5Bg6bQXs = {
            "id" = "5Bg6bQXs";
            "file" = "theoriginalwork.zip";
            "hash" = "sha512-zeQO2Usud5IBF+K3bFLOP9ARlgtIR9mWGSVP62jisaZZPQ8wkJmL5F4yJ1htgv0Y2pN0wkq3DVcCuxmEjggeeQ==";
        };
        _HiQYmkUO = {
            "id" = "HiQYmkUO";
            "file" = "theoriginalwork.zip";
            "hash" = "sha512-OX4hi9SDCYZjk7+Fdvf/BFRNB/K8Pv858oGqbFKVRzRNQ/MOgvWzBIHzZPtEO5pINqpSxJFnku/SpuwZkebpeg==";
        };
        _LhEOLa2R = {
            "id" = "LhEOLa2R";
            "file" = "theoriginalwork.zip";
            "hash" = "sha512-8MCfHMUYQgn4nzDOcAmijMABWX0D3ZoT3jQC97LT5kwtURjT2S0BSRqIIg6CO8XlAG8clMCaVCXWjXSbzKtCDA==";
        };
    in {
        "sZe6MRuo" = _sZe6MRuo;
        "qpyiWXrF" = _qpyiWXrF;
        ...
        "HiQYmkUO" = _HiQYmkUO;
        "LhEOLa2R" = _LhEOLa2R;
        "minecraft-1.20" = _LhEOLa2R;
        "minecraft-1.20.1" = _LhEOLa2R;
        "minecraft-1.20.2" = _LhEOLa2R;
        "minecraft-1.20.3" = _LhEOLa2R;
        "minecraft-1.20.4" = _LhEOLa2R;
        "minecraft-1.20.5" = _LhEOLa2R;
        "minecraft-1.20.6" = _LhEOLa2R;
        "minecraft-1.21" = _LhEOLa2R;
        "minecraft-1.21.1" = _LhEOLa2R;
        "minecraft-1.21.2" = _LhEOLa2R;
        "minecraft-1.21.3" = _LhEOLa2R;
        "minecraft-1.21.4" = _LhEOLa2R;
        "minecraft-1.14" = _LhEOLa2R;
        "minecraft-1.14.1" = _LhEOLa2R;
        "minecraft-1.14.2" = _LhEOLa2R;
        "minecraft-1.14.3" = _LhEOLa2R;
        "minecraft-1.14.4" = _LhEOLa2R;
        "minecraft-1.15" = _LhEOLa2R;
        "minecraft-1.15.1" = _LhEOLa2R;
        "minecraft-1.15.2" = _LhEOLa2R;
        "minecraft-1.16" = _LhEOLa2R;
        "minecraft-1.16.1" = _LhEOLa2R;
        "minecraft-1.16.2" = _LhEOLa2R;
        "minecraft-1.16.3" = _LhEOLa2R;
        "minecraft-1.16.4" = _LhEOLa2R;
        "minecraft-1.16.5" = _LhEOLa2R;
        "minecraft-1.17" = _LhEOLa2R;
        "minecraft-1.17.1" = _LhEOLa2R;
        "minecraft-1.18" = _LhEOLa2R;
        "minecraft-1.18.1" = _LhEOLa2R;
        "minecraft-1.18.2" = _LhEOLa2R;
        "minecraft-1.19" = _LhEOLa2R;
        "minecraft-1.19.1" = _LhEOLa2R;
        "minecraft-1.19.2" = _LhEOLa2R;
        "minecraft-1.19.3" = _LhEOLa2R;
        "minecraft-1.19.4" = _LhEOLa2R;
        "minecraft-1.21.5" = _LhEOLa2R;
        "minecraft-1.21.6" = _LhEOLa2R;
        "minecraft-1.21.7" = _LhEOLa2R;
        "minecraft-1.21.8" = _LhEOLa2R;
        "minecraft-1.21.9" = _LhEOLa2R;
        "minecraft-1.21.10" = _LhEOLa2R;
        "minecraft-1.21.11" = _LhEOLa2R;
        "minecraft-1.13" = _5Bg6bQXs;
        "minecraft-1.13.1" = _5Bg6bQXs;
        "minecraft-1.13.2" = _5Bg6bQXs;
        "pkg-1.0" = _EQ4PzBhq;
        "pkg-1.1" = _qpyiWXrF;
        "pkg-1.2" = _Ssn3ayLF;
        "pkg-1.3" = _AswUTbVX;
