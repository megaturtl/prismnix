...
let
    versions = (let
        ...
        _PicG3sNS = {
            "id" = "PicG3sNS";
            "file" = "CraterLib-Fabric-1.18.2-3.1.3.jar";
            "hash" = "sha512-TUhVWDtIC08HPqQb/aII1SupL1A+OVoutNoQrHfEfe5MmDD0ToL3LxtZNhlyxV0asn1SSeCqIeM/q9XcreFfDg==";
        };
        _iS2b9Yvt = {
            "id" = "iS2b9Yvt";
            "file" = "CraterLib-Forge-1.18.2-3.1.3.jar";
            "hash" = "sha512-Mmg3qdqUHN6kLqLsNYhQvR27RoIIMiBjlKLdZipy6h8we2cYJD/K/alNTUe9IoGLsgA5I/SwiagPQag5ApK5iQ==";
        };
        _BYemlMEM = {
            "id" = "BYemlMEM";
            "file" = "CraterLib-Fabric-1.19.2-3.1.3.jar";
            "hash" = "sha512-gsIPp3WbRugC9I5OoC3XpvNW8yKB2Ob3u2MmeUrTjyHoocAaSEV6ItnMk04enZMmldUUYsAZVkvUvKijxLTQzg==";
        };
        _Hc5y2KNL = {
            "id" = "Hc5y2KNL";
            "file" = "CraterLib-Forge-1.19.2-3.1.3.jar";
            "hash" = "sha512-/0FjJdRt8icRRUBXordmnGTbnQlCZWCaErqUhyd2hlePaD0vXvGLg3ydS309CIwjpZSNelr6XajEPhnohvTdVw==";
        };
        _hNb7qBWi = {
            "id" = "hNb7qBWi";
            "file" = "CraterLib-Fabric-1.20-3.1.3.jar";
            "hash" = "sha512-cUyMN702F6mNmbdvzAP+Twc9ouLSDHMGMHK+LM0oSPuCnB/2vjnUoiiMXaeaMLh3+ytcyZ7X4A3JN7wRvye7/w==";
        };
        _186tYWh8 = {
            "id" = "186tYWh8";
            "file" = "CraterLib-Forge-1.20-3.1.3.jar";
            "hash" = "sha512-0YvRQB/LqPKEkxbeChLmVgVHIi9pWC4azQsvn1qOKIYYAiJlFuNBGhBivSll1gxI38ks8EAg6UjqgsBFTPb+nQ==";
        };
        _eFJWjwml = {
            "id" = "eFJWjwml";
            "file" = "CraterLib-Fabric-1.21-3.1.3.jar";
            "hash" = "sha512-1upZmESabfXyrrLgDP+UoAZMbuvtreHetBSle1USF79mBuDdQbDre1a4QrrSJ/UVB6d3CIud027W1g2vWmH35Q==";
        };
        _6Twwi1qt = {
            "id" = "6Twwi1qt";
            "file" = "CraterLib-Forge-1.21-3.1.3.jar";
            "hash" = "sha512-j4u0vZcY9Ovzed/Hv4H/p9odi6wYe2P181Kdp566smxQ77DioIar240mp0LfFX5YVaulZ3SBOvf5fYmoAtx0hA==";
        };
        _e962b1SA = {
            "id" = "e962b1SA";
            "file" = "CraterLib-Neoforge-1.21-3.1.3.jar";
            "hash" = "sha512-0ley2kZU2pxUOZqVIfNSxBXGIhkE+qmQmOecBlDxM6cQpFFamH50F9flTIhTPpZ8vkhYklBogVXsFEXq8XqTNg==";
        };
        _bvC1h52c = {
            "id" = "bvC1h52c";
            "file" = "CraterLib-Fabric-1.21.3-3.1.3.jar";
            "hash" = "sha512-Y675NO6Au+WhUiD4FoJa+P/Nv3b7/g3i+DBJYO0/nP2ocLg9n7ijSx/Pq7CblESaOV5YFxPCb/yJ1hhMoTBfxw==";
        };
        _Iq3aeOFd = {
            "id" = "Iq3aeOFd";
            "file" = "CraterLib-Forge-1.21.3-3.1.3.jar";
            "hash" = "sha512-j+Wsr+z/3ivAAd8sK+cr9WM8usOFp9PGAZmlKmJOPpxtl2TJHct3k9YDnVajJ7LAXO8PCHWSkY/hg2I76r+i3A==";
        };
        _BAm2zTDW = {
            "id" = "BAm2zTDW";
            "file" = "CraterLib-Neoforge-1.21.3-3.1.3.jar";
            "hash" = "sha512-SmQ6k8RayifdPCU4x/O5+MDE+2brnRn28eVOEjbZnaKtBap5vnD1YoJ5cq346JTTxG9XkFBYtJd+AF1QyoAT6g==";
        };
        _l084ubF5 = {
            "id" = "l084ubF5";
            "file" = "CraterLib-Fabric-1.21.5-3.1.3.jar";
            "hash" = "sha512-KksUGYSM+rSpfbzr6SqWFaMv+f/FozGWBFbathNe+jtm2TK80B8RBlj25HAZtDyQQX9oFl+DlIsoABiUCpMpMA==";
        };
        _rl0KMSwg = {
            "id" = "rl0KMSwg";
            "file" = "CraterLib-Forge-1.21.5-3.1.3.jar";
            "hash" = "sha512-VkGZvJDPkAy/r/tpxo/hQRqlwUbimGY4fMiiJlp7dMxcAjBcXQy90YXKaNqNQImVALXwLx+HQ21Toj6gqzloOQ==";
        };
        _yx8vfYXj = {
            "id" = "yx8vfYXj";
            "file" = "CraterLib-Neoforge-1.21.5-3.1.3.jar";
            "hash" = "sha512-BmWs13YvbPZBF/EEiNpUkIA/Z35jtPVVSFiwPJ/uPmQh1s8/esrA+yj4NqUneIgY9EoW5HYfdxdYpblc4SYhog==";
        };
        _EsOxJNaE = {
            "id" = "EsOxJNaE";
            "file" = "CraterLib-Fabric-1.21.6-3.1.3.jar";
            "hash" = "sha512-7e67iqqVH6pjGV5BJljo+xc2+JpMUKYnqS+/LPDiFtHvnxp5QnfBSvxueg8nLpJUxED4XFnB0SK3BMDB9Kqj2w==";
        };
        _niKzm1AR = {
            "id" = "niKzm1AR";
            "file" = "CraterLib-Forge-1.21.6-3.1.3.jar";
            "hash" = "sha512-knb8BcnM2gjmgGm72IWXoX2Czq4rvYzmjdeR85Chg2PaXNuWGagqJvYRgqhnfoytt9jKoWEjF2OB9ZVKiEczNw==";
        };
        _kUfAYyam = {
            "id" = "kUfAYyam";
            "file" = "CraterLib-Neoforge-1.21.6-3.1.3.jar";
            "hash" = "sha512-cMd7jFeczse+csCyj/lA+nXVAjuviiVmtzQjT2RFIWMAxNAsB/y9eoYuBPqGnVNcNCTMDPTR9wSwnQhCL77Gog==";
        };
        _bXdqsdd7 = {
            "id" = "bXdqsdd7";
            "file" = "CraterLib-Fabric-1.21.9-3.1.3.jar";
            "hash" = "sha512-48PmL0xamE+GLahuPnNC22r2V1GYBoFjXcnUvysA+Nc0vObFl6meHP+9NXyW08NqmPOmDz0q/yfP0RoJDZA3mw==";
        };
        _6UZ00bPu = {
            "id" = "6UZ00bPu";
            "file" = "CraterLib-Forge-1.21.9-3.1.3.jar";
            "hash" = "sha512-p9m5NUvHej2lh7auXD8ZZHwtQotdbhmwYgm/cP5dkIZMWi1STxQVI7K1KDQga2LMw28zTNvfHVitPe2ZXr63vQ==";
        };
        _nclVY4Vq = {
            "id" = "nclVY4Vq";
            "file" = "CraterLib-Neoforge-1.21.9-3.1.3.jar";
            "hash" = "sha512-bZerSA3OeFHtHUzc/a9VDPV6XcceXu0Q8N6StcRS0VLZgdWxQzTQnWcKJv6HchE0F5X+Of0m522OG1yoMf8JRw==";
        };
        _14aBVXeR = {
            "id" = "14aBVXeR";
            "file" = "CraterLib-Fabric-1.21.11-3.1.3.jar";
            "hash" = "sha512-V5VlFbBRMHPGHf7uwYhonuBAtkJUNuB07pVls7JiLu+/7aiKQQo30eCCIfdLHVQB14N5cVRaci18RpkL1CLOHw==";
        };
        _LTvKdU5b = {
            "id" = "LTvKdU5b";
            "file" = "CraterLib-Forge-1.21.11-3.1.3.jar";
            "hash" = "sha512-5+hwAkYE/zeJVrmsuWhEgd3aeOM56Q5lq0AaBZPkpGzh0QPBlUWApsWFCFQIn0+2g3/iYbyIA6UYn5+ydWDNKA==";
        };
        _Yd8dM9sY = {
            "id" = "Yd8dM9sY";
            "file" = "CraterLib-Neoforge-1.21.11-3.1.3.jar";
            "hash" = "sha512-w5XAbgbw/s0sz4j36E+gvOp09yaJsovUQNitSsXfZuVghZ7mRlAcs0a3LSlNnEsewi59UqzvZ2U9+gxWEmnJAA==";
        };
        _uIONZ9pV = {
            "id" = "uIONZ9pV";
            "file" = "CraterLib-Fabric-26.1.2-3.1.3.jar";
            "hash" = "sha512-UCwB8ASi0LHLjaqK6P2kG1nMP0kzyOzJOSzS/LWAVa7u5yx36CYBBm5gUbjv3UDkJY9bwQqbnuaiexyB8l2l2A==";
        };
        _VfJtYcCb = {
            "id" = "VfJtYcCb";
            "file" = "CraterLib-Forge-26.1.2-3.1.3.jar";
            "hash" = "sha512-1IQwdDbq9rwoOpLxFnMDk3K34cSNacGNAWyzkUnKsnFkn5FBh9Lj3RTxRiRtkrzwb+43TsfX+fkVNYKPx8kXwg==";
        };
        _mYLFBVQA = {
            "id" = "mYLFBVQA";
            "file" = "CraterLib-Neoforge-26.1.2-3.1.3.jar";
            "hash" = "sha512-I4V6WyMOeJA+XAEAGVq4B+U+IH9vtWMeWuE5qohg39dUhKUMXaZTMNEx7j1MXp9eBe6QYc7xtaOII7byEA68GA==";
        };
        _dHUgonju = {
            "id" = "dHUgonju";
            "file" = "CraterLib-Fabric-26.2-3.1.3.jar";
            "hash" = "sha512-ODD6ZTlkI1IbwCEv9+k7gXiUlDP9DcdHWv8CiZUCD1luiW6bPvidYLlmeoqVuR3eUfwmETFz5AOzKP9tc558TA==";
        };
        _ibDDhTCM = {
            "id" = "ibDDhTCM";
            "file" = "CraterLib-Forge-26.2-3.1.3.jar";
            "hash" = "sha512-P6EZD9KnvhHkqIzEHK6biHpzs1j+GEN8Z8pSlD10g7fECjTiuVoo0z04P9VzMcYkI+yCq8YZK1AfRijwOOAc+A==";
        };
        _sYBvU89b = {
            "id" = "sYBvU89b";
    ...
    in {
        ...
        "fabric-1.18.2" = _PicG3sNS;
        "fabric-1.19.2" = _BYemlMEM;
        "fabric-1.19.3" = _3bzh7auo;
        "fabric-1.19.4" = _yTEoNdwk;
        "fabric-1.20.4" = _vYn8rIRS;
        "fabric-1.21" = _eFJWjwml;
        "fabric-1.21.1" = _eFJWjwml;
        "fabric-1.21.2" = _Fs1SP8Qg;
        "fabric-1.21.3" = _bvC1h52c;
        "fabric-1.21.4" = _bvC1h52c;
        "fabric-1.21.5" = _l084ubF5;
        "fabric-1.21.6" = _EsOxJNaE;
        "fabric-1.21.7" = _EsOxJNaE;
        "fabric-1.21.8" = _EsOxJNaE;
        "fabric-1.21.9" = _bXdqsdd7;
        "fabric-1.21.10" = _bXdqsdd7;
        "fabric-1.21.11" = _14aBVXeR;
        ...
        "quilt-1.18.2" = _PicG3sNS;
        "quilt-1.19.2" = _BYemlMEM;
        "quilt-1.19.3" = _3bzh7auo;
        "quilt-1.19.4" = _yTEoNdwk;
        "quilt-1.20.4" = _vYn8rIRS;
        "quilt-1.21" = _eFJWjwml;
        "quilt-1.21.1" = _eFJWjwml;
        "quilt-1.21.2" = _Fs1SP8Qg;
        "quilt-1.21.3" = _bvC1h52c;
        "quilt-1.21.4" = _bvC1h52c;
        "quilt-1.21.5" = _l084ubF5;
        "quilt-1.21.6" = _EsOxJNaE;
        "quilt-1.21.7" = _EsOxJNaE;
        "quilt-1.21.8" = _EsOxJNaE;
        "quilt-1.21.9" = _bXdqsdd7;
        "quilt-1.21.10" = _bXdqsdd7;
        "quilt-1.21.11" = _14aBVXeR;
        ...
        "forge-1.18.2" = _iS2b9Yvt;
        "forge-1.19.2" = _Hc5y2KNL;
        "forge-1.19.3" = _kfL6uZhe;
        "forge-1.19.4" = _MJzG4fZ2;
        "forge-1.20.4" = _SrzGWptG;
        "forge-1.21" = _6Twwi1qt;
        "forge-1.21.1" = _6Twwi1qt;
        "forge-1.21.3" = _Iq3aeOFd;
        "forge-1.21.4" = _Iq3aeOFd;
        "forge-1.21.5" = _rl0KMSwg;
        "forge-1.21.6" = _niKzm1AR;
        "forge-1.21.7" = _niKzm1AR;
        "forge-1.21.8" = _niKzm1AR;
        "forge-1.21.9" = _6UZ00bPu;
        "forge-1.21.10" = _6UZ00bPu;
        ...
        "neoforge-1.21.3" = _BAm2zTDW;
        "neoforge-1.21.4" = _BAm2zTDW;
        "neoforge-1.21.5" = _yx8vfYXj;
        "neoforge-1.21.6" = _kUfAYyam;
        "neoforge-1.21.7" = _kUfAYyam;
        "neoforge-1.21.8" = _kUfAYyam;
        "neoforge-1.21.9" = _nclVY4Vq;
        "neoforge-1.21.10" = _nclVY4Vq;
        "neoforge-1.21.11" = _Yd8dM9sY;
        ...
        "pkg-1.20.2-1.0.2" = _v6V6V2Zi;
        "pkg-1.18.2-1.0.2" = _PjEc7yDN;
        "pkg-1.19.2-1.0.2" = _E0QBa9as;
        "pkg-1.19.3-1.0.2" = _IzbC9AJC;
        "pkg-1.20.2-1.0.3" = _voBYx7J1;
        "pkg-1.20.2-1.0.4" = _P1sk2Ggb;
        "pkg-1.18.2-1.1.0" = _kGql1QLo;
        "pkg-1.19.2-1.1.0" = _tyrRMLpA;
        "pkg-1.19.3-1.1.0" = _UhfGkSqr;
        "pkg-1.20-1.1.0" = _sym8NBXL;
        "pkg-1.20.2-1.1.0" = _JjMiyjql;
        "pkg-1.20.4-1.1.0" = _e1wvUTZh;
        "pkg-1.18.2-1.1.1" = _5SPSecIh;
        "pkg-1.19.2-1.1.1" = _UkVQnIGI;
        "pkg-1.19.3-1.1.1" = _gH6zhujf;
        "pkg-1.20-1.1.1" = _90lpZF84;
        "pkg-1.18.2-2.0.0" = _XOmHGaFs;
        "pkg-1.19.2-2.0.0" = _DW3AZms2;
        "pkg-1.20-2.0.0" = _c1M2ur5U;
        "pkg-1.20.2-2.0.0" = _pq91Ndsn;
        "pkg-1.20.4-2.0.0" = _2kKrJbxy;
        "pkg-1.21-2.0.0" = _kOBFw6Th;
        "pkg-1.21-2.0.0+hotfix.1" = _NjLn74rH;
        "pkg-1.21-2.0.0+hotfix.2" = _x4VYQOR3;
        "pkg-1.18.2-2.0.1" = _GGF8Fyyq;
        "pkg-1.19.2-2.0.1" = _JDosr8nx;
        "pkg-1.20-2.0.1" = _hpZZfxZl;
        "pkg-1.20.2-2.0.1" = _I32QDXH9;
        "pkg-1.20.4-2.0.1" = _vPLqeXED;
        "pkg-1.21-2.0.1" = _iY5P4um2;
        "pkg-1.18.2-2.0.2" = _oXlH7qnL;
        "pkg-1.19.2-2.0.2" = _CDs3kJxJ;
        "pkg-1.20-2.0.2" = _SXHsUfrI;
        "pkg-1.20.2-2.0.2" = _wqvbzryQ;
        "pkg-1.20.4-2.0.2" = _FALHXDs0;
        "pkg-1.21-2.0.2" = _Bo0sMzOU;
        "pkg-1.18.2-2.0.3" = _B2i5G3Ep;
        "pkg-1.19.2-2.0.3" = _74NzUMh9;
        "pkg-1.19.3-2.0.3" = _kfL6uZhe;
        "pkg-1.20-2.0.3" = _xrXJLMel;
        "pkg-1.20.2-2.0.3" = _T25jDxtR;
        "pkg-1.20.4-2.0.3" = _16cFQZ0P;
        "pkg-1.21-2.0.3" = _zZEWZL6e;
        "pkg-1.20-2.0.3+hotfix.1" = _I3HFsaOZ;
        "pkg-1.18.2-2.1.0" = _qblX25hG;
        "pkg-1.19.2-2.1.0" = _gdHHeUlY;
        "pkg-1.19.4-2.1.0" = _e43zHZQJ;
        "pkg-1.20-2.1.0" = _i40fLjQb;
        "pkg-1.20.2-2.1.0" = _gcWCUSFO;
        "pkg-1.20.4-2.1.0" = _GscAJS0V;
        "pkg-1.21-2.1.0" = _HtD7r8pV;
        "pkg-1.18.2-2.1.0+hotfix.1" = _lJC9ulKd;
        "pkg-1.19.2-2.1.0+hotfix.1" = _lWbwyLxS;
        "pkg-1.18.2-2.1.1" = _donzzbtv;
        "pkg-1.19.2-2.1.1" = _5ckcwtKX;
        "pkg-1.19.4-2.1.1" = _iWifp5eW;
        "pkg-1.20-2.1.1" = _lrhBfLA7;
        "pkg-1.20.2-2.1.1" = _rsZz0XHH;
        "pkg-1.20.4-2.1.1" = _kk5jLAMT;
        "pkg-1.21-2.1.1" = _Zd2w1hRK;
        "pkg-1.21.2-2.1.1" = _zilayLM6;
        "pkg-1.18.2-2.1.2" = _UYcrEJXG;
        "pkg-1.19.2-2.1.2" = _FfU7Ao9H;
        "pkg-1.19.4-2.1.2" = _5fLDGKzU;
        "pkg-1.20-2.1.2" = _8PRu5W3b;
        "pkg-1.20.2-2.1.2" = _p25LzJPU;
        "pkg-1.20.4-2.1.2" = _hwktzV4t;
        "pkg-1.21-2.1.2" = _FYS0J877;
        "pkg-1.21.3-2.1.2" = _kUY1jk2U;
        "pkg-1.19.4-2.1.2+hotfix.1" = _8Xg4z43H;
        "pkg-1.20-2.1.2+hotfix.1" = _YMGr7fuO;
        "pkg-1.20.2-2.1.2+hotfix.1" = _9rnSkEU3;
        "pkg-1.18.2-2.1.3" = _ivJ1gXa7;
        "pkg-1.19.2-2.1.3" = _yN87iwWm;
        "pkg-1.19.4-2.1.3" = _3bYunrpE;
        "pkg-1.20-2.1.3" = _1nFU5ee8;
        "pkg-1.20.2-2.1.3" = _GfulIT2S;
        "pkg-1.20.4-2.1.3" = _BIS92TVu;
        "pkg-1.21-2.1.3" = _JcguohD7;
        "pkg-1.21.3-2.1.3" = _bihR1u6X;
        "pkg-1.18.2-2.1.4" = _OznsuQpT;
        "pkg-1.19.2-2.1.4" = _RSDr9Z6N;
        "pkg-1.19.4-2.1.4" = _Yi2DQesy;
        "pkg-1.20-2.1.4" = _N68PG90I;
        "pkg-1.20.2-2.1.4" = _5SLnB21n;
        "pkg-1.20.4-2.1.4" = _ub1zKz6a;
        "pkg-1.21-2.1.4" = _J8XgEQ6c;
        "pkg-1.21.3-2.1.4" = _xpP7PTS5;
        "pkg-1.21.5-2.1.4" = _lJ2Htsve;
        "pkg-1.18.2-2.1.5" = _qvAANB7Y;
        "pkg-1.19.2-2.1.5" = _gFOwUIc9;
        "pkg-1.19.4-2.1.5" = _MJzG4fZ2;
        "pkg-1.20-2.1.5" = _ONJR7uAd;
        "pkg-1.20.2-2.1.5" = _DdP5Zmyy;
        "pkg-1.20.4-2.1.5" = _v7M6W4ka;
        "pkg-1.21-2.1.5" = _YQQ9nduq;
        "pkg-1.21.3-2.1.5" = _3dW2TvuI;
        "pkg-1.21.5-2.1.5" = _rgPZlLjE;
        "pkg-1.21.6-2.1.5" = _elY7QhBW;
        "pkg-1.21.9-2.1.5" = _aglV7KEr;
        "pkg-1.21.9-2.1.5+hotfix.1" = _rCpJGzLj;
        "pkg-1.18.2-3.0.1" = _X9bSyHEM;
        "pkg-1.19.2-3.0.1" = _UjgtC5kr;
        "pkg-1.20-3.0.1" = _NsbwPQBC;
        "pkg-1.21-3.0.1" = _cBhYL3vy;
        "pkg-1.21.3-3.0.1" = _AwoeybKr;
        "pkg-1.21.5-3.0.1" = _bHPmA6vO;
        "pkg-1.21.6-3.0.1" = _GsfBhHdb;
        "pkg-1.21.9-3.0.1" = _gpc2Q7nJ;
        "pkg-1.21.11-3.0.1" = _dBG5api1;
        "pkg-1.18.2-3.1.0" = _qoE16sJB;
        "pkg-1.19.2-3.1.0" = _yDlrEtQB;
        "pkg-1.20-3.1.0" = _ZENSnjUK;
        "pkg-1.21-3.1.0" = _IDi26FjR;
        "pkg-1.21.3-3.1.0" = _1PrsDLVO;
        "pkg-1.21.5-3.1.0" = _4A36C2LX;
        "pkg-1.21.6-3.1.0" = _SqrKlD5r;
        "pkg-1.21.9-3.1.0" = _X1ZOjrYe;
        "pkg-1.21.11-3.1.0" = _kLDRCuFm;
        "pkg-26.1-3.1.0+experimental.2" = _DBOET0HP;
        "pkg-1.18.2-3.1.1" = _ZjmQQ5LI;
        "pkg-1.19.2-3.1.1" = _ySK5EYPd;
        "pkg-1.20-3.1.1" = _smz4VEFs;
        "pkg-1.21-3.1.1" = _6a63Eny2;
        "pkg-1.21.3-3.1.1" = _YLlDRRFG;
        "pkg-1.21.5-3.1.1" = _sPyn3ziG;
        "pkg-1.21.6-3.1.1" = _Zmq0Dtpj;
        "pkg-1.21.9-3.1.1" = _kco72i81;
        "pkg-1.21.11-3.1.1" = _RGDSPJRW;
        "pkg-26.1.2-3.1.1" = _5w1k1hFH;
        "pkg-26.1.2-3.1.1+hotfix.1" = _ZJlfIYbP;
        "pkg-26.1.2-3.1.1+hotfix.3" = _FAXoEbAb;
        "pkg-1.18.2-3.1.2" = _mXD2zdHn;
        "pkg-1.19.2-3.1.2" = _ene8RKcw;
        "pkg-1.20-3.1.2" = _QNenSECF;
        "pkg-1.21-3.1.2" = _BaPsTnt7;
        "pkg-1.21.3-3.1.2" = _9tH235ab;
        "pkg-1.21.5-3.1.2" = _Xa7ZvlVO;
        "pkg-1.21.6-3.1.2" = _yg71SNrm;
        "pkg-1.21.9-3.1.2" = _zKDrBRr2;
        "pkg-1.21.11-3.1.2" = _EpO2QSTz;
        "pkg-26.1.2-3.1.2" = _9gUhMA6L;
        "pkg-1.18.2-3.1.2+hotfix.1" = _ovI9e7fJ;
        "pkg-1.19.2-3.1.2+hotfix.1" = _IwD7f7z2;
        "pkg-1.20-3.1.2+hotfix.1" = _IJybPfEs;
        "pkg-1.21-3.1.2+hotfix.1" = _7KqKN9Oa;
        "pkg-1.21.3-3.1.2+hotfix.1" = _gGEJ4lOV;
        "pkg-1.21.5-3.1.2+hotfix.1" = _BLZPLECV;
        "pkg-1.21.6-3.1.2+hotfix.1" = _1kRBvgqJ;
        "pkg-1.21.9-3.1.2+hotfix.1" = _uSwwuy0k;
        "pkg-1.21.11-3.1.2+hotfix.1" = _YJ1ZVmVI;
        "pkg-26.1.2-3.1.2+hotfix.1" = _ChFlZsys;
        "pkg-26.2-3.1.2" = _cefBztxv;
        "pkg-1.18.2-3.1.3" = _iS2b9Yvt;
        "pkg-1.19.2-3.1.3" = _Hc5y2KNL;
        "pkg-1.20-3.1.3" = _186tYWh8;
        "pkg-1.21-3.1.3" = _e962b1SA;
        "pkg-1.21.3-3.1.3" = _BAm2zTDW;
        "pkg-1.21.5-3.1.3" = _yx8vfYXj;
        "pkg-1.21.6-3.1.3" = _kUfAYyam;
        "pkg-1.21.9-3.1.3" = _nclVY4Vq;
