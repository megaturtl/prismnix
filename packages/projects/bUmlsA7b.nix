...
let
    versions = (let
        ...
        _8H27PgSA = {
            "id" = "8H27PgSA";
            "file" = "BetterUnpackables_v5.0.0_pre.7_mc26.3pre1-3.zip";
            "hash" = "sha512-Xvj/1blx26mg6QOxezB+DV+U+q5J6abXPuN9CB/cauebhOCGDdemhc1bLK8qb7zt23Tir1R9H0oFx19bdDjSSA==";
        };
        _Bw1AAKEE = {
            "id" = "Bw1AAKEE";
            "file" = "BetterUnpackables_v5.0.0-rc.1_mc26.3pre3-rc1.zip";
            "hash" = "sha512-exXPSFZkL4zsGXvt2f3oSrEX8ORDDojto1ndqkOzM5je0/p0rydb+mqVelrZx7uOy1JRHPT9PGaGtGX0prvPLA==";
        };
        _cGcvIweT = {
            "id" = "cGcvIweT";
            "file" = "BetterUnpackables_v5.0.0_mc26.3.zip";
            "hash" = "sha512-MFY2TkrKCiJhR0qQExJedR1FHwz4qzdwFuceh9dMMn8aj7t9BFi9B9YRFxLrKN17wP7Q56gnQ+oCxZIPCbbPTg==";
        };
        _zHgv5ukG = {
            "id" = "zHgv5ukG";
    ...
    in {
        ...
        "datapack-26.3-pre-1" = _8H27PgSA;
        "datapack-26.3-pre-2" = _8H27PgSA;
        "datapack-26.3-pre-3" = _Bw1AAKEE;
        ...
        "neoforge-26.3" = _zHgv5ukG;
        "pkg-v1.0.0" = _niaxbXcl;
        "pkg-v1.0.0+mod" = _2N9ex882;
        "pkg-v1.1.0" = _PHGs240r;
        "pkg-v1.1.0+mod" = _YWhP6Jvg;
        "pkg-v1.1.1" = _SrM4hCDi;
        "pkg-v1.1.1+mod" = _E7h1FgNX;
        "pkg-v1.2.0-beta1" = _ZkYe3mbC;
        "pkg-v1.1.2" = _DizlA9UQ;
        "pkg-v1.1.2+mod" = _nHjKHgA5;
        "pkg-v1.2.0-beta2" = _dOHNojvZ;
        "pkg-v1.2.0-beta3" = _OSdSMNu9;
        "pkg-v1.2.0-beta4" = _oZxxnsvz;
        "pkg-v1.2.0-beta5" = _pHpkf1QY;
        "pkg-v1.2.0-beta6" = _DZjcph8I;
        "pkg-v1.2.0" = _PZz5iX9P;
        "pkg-v1.2.0+mod" = _wLOuSCkS;
        "pkg-v1.3.0-beta1" = _UgoS8asG;
        "pkg-v1.3.0-beta2" = _yhbECL6o;
        "pkg-v1.3.0-beta3" = _zS8RyjHI;
        "pkg-v1.3.0-beta4" = _PO0N79tD;
        "pkg-v1.3.0-beta5" = _NKTUXM5q;
        "pkg-v1.3.0-beta6" = _9x1cUYS1;
        "pkg-v1.3.0-beta7" = _FwPBmdqW;
        "pkg-v1.3.0-beta8" = _c6cfZqnu;
        "pkg-v1.3.0-beta9" = _JqwnYGIS;
        "pkg-v1.3.0-beta10" = _sEjAv1EJ;
        "pkg-v1.3.0-pre1" = _YO5embtr;
        "pkg-v1.3.0-pre2" = _zPXDv9Cg;
        "pkg-v2.0.0-pre1" = _KTWOXTyA;
        "pkg-v2.0.0" = _wGYOb2z1;
        "pkg-v2.0.0+mod" = _PoVOqVVm;
        "pkg-v2.1.0-beta1" = _iAW27etH;
        "pkg-v2.1.0-beta2" = _J1geGObY;
        "pkg-v2.1.0-beta3" = _Ftz7aSVU;
        "pkg-v2.1.0-beta4" = _Pwxednab;
        "pkg-v2.0.0+forge" = _JsR6uHVb;
        "pkg-v2.1.0-pre1" = _ROtRMPHe;
        "pkg-v2.1.0-pre2" = _NTqqwSHA;
        "pkg-v2.1.0-pre3" = _TAAqD2Cq;
        "pkg-v2.1.0-pre4" = _CE2SVgxE;
        "pkg-v2.1.0-pre5" = _SreAI4S0;
        "pkg-v2.1.0" = _Pz0tWhQV;
        "pkg-v2.1.0+mod" = _NYGo7ZlJ;
        "pkg-v2.2.0-beta1" = _WNmVAynj;
        "pkg-v2.2.0-pre1" = _eqmU9aNS;
        "pkg-v2.2.0" = _1i7oQeAR;
        "pkg-v2.2.0+mod" = _CknmqBXo;
        "pkg-v2.3.0-beta1" = _wlLU5toD;
        "pkg-v2.3.0-beta2" = _cDJlHX0o;
        "pkg-v2.3.0" = _vEzBE3pL;
        "pkg-v2.3.0+mod" = _Jqp2zGNs;
        "pkg-v2.3.1-pre1" = _8L43CvPX;
        "pkg-v2.3.1" = _MnLNPewh;
        "pkg-v2.3.1+mod" = _S9XSifRH;
        "pkg-v2.4.0-beta1" = _DdMXCE5o;
        "pkg-v2.4.0-beta2" = _AF0RNfoC;
        "pkg-v3.0.0-beta1" = _eqd5uYN3;
        "pkg-v3.0.0-beta2" = _7HPhuQ5e;
        "pkg-v3.0.0-beta3" = _EhtweG33;
        "pkg-v3.0.0-pre1" = _WVHVUZse;
        "pkg-v3.0.0-pre2" = _bw2WH5SM;
        "pkg-v3.0.0-pre3" = _khwVq1cv;
        "pkg-v3.0.0-pre4" = _8i8h8gNc;
        "pkg-v3.0.0" = _hFLUhJbr;
        "pkg-v3.0.0+mod" = _OANA9l1O;
        "pkg-v3.0.1+mod" = _WdqM4qUn;
        "pkg-v3.1.0-beta1" = _MBHQoPgn;
        "pkg-v3.1.0-beta2" = _B3ZTbYBQ;
        "pkg-v3.1.0-beta3" = _u6lh8you;
        "pkg-v3.1.0-beta4" = _QzRis10u;
        "pkg-v3.1.0-pre1" = _8BbU5LAJ;
        "pkg-v3.1.0-pre2" = _uJQ4Nx8m;
        "pkg-v3.1.0-pre3" = _Aokzb3Fz;
        "pkg-v3.1.0" = _Hjrr2uai;
        "pkg-v3.1.0+mod" = _cBqZVYKO;
        "pkg-v3.2.0-beta1" = _CR6EfcOc;
        "pkg-v3.2.0-beta2" = _3JGRC9OQ;
        "pkg-v3.2.0-beta3" = _QA8qhekX;
        "pkg-v3.2.0-beta4" = _5gi39zPk;
        "pkg-v3.2.0-beta5" = _cJCHvtRL;
        "pkg-v3.2.0-pre1" = _oaMQ1y7D;
        "pkg-v3.2.0-pre2" = _iMCXbrya;
        "pkg-v3.2.0-pre3" = _OU98Q9Cu;
        "pkg-v3.2.0-pre4" = _ZUGhC1on;
        "pkg-v3.2.0" = _aYtNCueM;
        "pkg-v3.2.0+mod" = _bsD4z6U0;
        "pkg-v4.0.0-pre.1" = _vNmzTu5J;
        "pkg-v4.0.0-pre.1+mod" = _zhrGpAn1;
        "pkg-v4.0.0" = _2x0nCv1G;
        "pkg-v4.0.0+mod" = _ImNGGrJK;
        "pkg-v4.0.1+mod" = _KFuq3PTy;
        "pkg-v4.1.0-beta.1" = _xzE112ug;
        "pkg-v4.1.0-beta.2" = _6JZoJvL2;
        "pkg-v4.1.0-beta.3" = _RI9AyUfu;
        "pkg-v4.1.0-beta.4" = _fwePH6oT;
        "pkg-v4.1.0-beta.5" = _exjnhIcQ;
        "pkg-v4.1.0-pre.1" = _glmkHFSv;
        "pkg-v4.1.0-pre.2" = _S6BEMRRt;
        "pkg-v4.1.0" = _vklTd3uo;
        "pkg-v4.1.0+mod" = _2V37o3Df;
        "pkg-v4.2.0-beta.1" = _RBfJQyMn;
        "pkg-v4.2.0-beta.2" = _WtDfAH6e;
        "pkg-v4.2.0-beta.3" = _97MFPTxR;
        "pkg-v4.2.0-beta.4" = _6Z63f6Qi;
        "pkg-v4.2.0" = _bgaGz46i;
        "pkg-v4.2.0+mod" = _Ng1PHkkA;
        "pkg-v4.3.0-beta.1" = _DoV16iyH;
        "pkg-v4.3.0-beta.2" = _I7HmizA2;
        "pkg-v4.3.0-beta.3" = _NGFqhxpY;
