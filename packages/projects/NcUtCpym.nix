...
let
    ...
    in {
        ...
        "forge-1.12.2" = _H8isxC6e;
        "forge-1.14.4" = _3FwkAdEs;
        "forge-1.15.2" = _6OGNVOoZ;
        "forge-1.16.2" = _AdgNeUH5;
        "forge-1.16.3" = _AdgNeUH5;
        "forge-1.16.4" = _AdgNeUH5;
        "forge-1.16.5" = _aiRtntI7;
        "forge-1.17.1" = _pJR2Fqwm;
        "forge-1.18.2" = _okwKyGYv;
        "forge-1.19.1" = _UYgfmqrN;
        "forge-1.19.2" = _UYgfmqrN;
        "forge-1.19.3" = _5srNwTQr;
        "forge-1.19.4" = _o2x00FuF;
        "forge-1.20" = _3fGuLVo4;
        "forge-1.20.1" = _3fGuLVo4;
        "forge-1.20.2" = _cdp9dUvQ;
        "forge-1.20.3" = _92y7huQU;
        "forge-1.20.4" = _92y7huQU;
        "forge-1.20.6" = _lwdXY9pL;
        "forge-1.20.5" = _lwdXY9pL;
        "forge-1.21" = _ciV21ZrY;
        "forge-1.21.1" = _ciV21ZrY;
        "forge-1.21.3" = _4mEzwP8R;
        "forge-1.21.4" = _dfyy2pBR;
        "forge-1.21.5" = _s6QFR9D3;
        "forge-1.21.7" = _75DL0q3D;
        "forge-1.21.8" = _bGFSItfw;
        "forge-1.21.9" = _bMLq86wD;
        "forge-1.21.10" = _HIlE0duq;
        "forge-1.21.11" = _B2g3fSMS;
        "forge-26.1.2" = _G30AUwkY;
        "forge-26.2" = _uR4BXv9U;
        "fabric-1.16.2" = _3LB40S6g;
        "fabric-1.16.3" = _3LB40S6g;
        "fabric-1.16.4" = _3LB40S6g;
        "fabric-1.16.5" = _ofMgYGde;
        "fabric-1.17" = _X5l3pEeo;
        "fabric-1.17.1" = _X5l3pEeo;
        "fabric-1.18.2" = _R47Dxii8;
        "fabric-1.19.1" = _Q5Q0dWGw;
        "fabric-1.19.2" = _Q5Q0dWGw;
        "fabric-1.19.3" = _p3T8tHy4;
        "fabric-1.19.4" = _Zs1k6oKV;
        "fabric-1.20-rc1" = _oOy5ndJf;
        "fabric-1.20" = _ZLYCiSMO;
        "fabric-1.20.1" = _ZLYCiSMO;
        "fabric-1.20.2" = _qus1H9JU;
        "fabric-1.20.3-rc1" = _4Vb09gB8;
        "fabric-1.20.3" = _vWSUiZND;
        "fabric-1.20.4" = _vWSUiZND;
        "fabric-1.20.5" = _55yE58dQ;
        "fabric-1.20.6" = _EmIpPLsW;
        "fabric-1.21" = _i80CxP4n;
        "fabric-1.21.1" = _i80CxP4n;
        "fabric-1.21.3" = _Q38QtGku;
        "fabric-1.21.4" = _IBcL3f5W;
        "fabric-1.21.5" = _74IEK9p1;
        "fabric-1.21.6" = _g8WcXZg9;
        "fabric-1.21.7" = _3Lv1hpHj;
        "fabric-1.21.8" = _yu5MwZs0;
        "fabric-1.21.9" = _81Qc21E2;
        "fabric-1.21.10" = _J2D6Ac47;
        "fabric-1.21.11" = _4PX8T9We;
        "fabric-26.1.2" = _BzCXHIwa;
        "fabric-26.2" = _Z6wZaeAX;
        "fabric-26.1" = _BzCXHIwa;
        "fabric-26.1.1" = _BzCXHIwa;
        "quilt-1.16.2" = _3LB40S6g;
        "quilt-1.16.3" = _3LB40S6g;
        "quilt-1.16.4" = _3LB40S6g;
        "quilt-1.16.5" = _ofMgYGde;
        "quilt-1.17" = _X5l3pEeo;
        "quilt-1.17.1" = _X5l3pEeo;
        "quilt-1.18.2" = _R47Dxii8;
        "quilt-1.19.1" = _Q5Q0dWGw;
        "quilt-1.19.2" = _Q5Q0dWGw;
        "quilt-1.19.3" = _p3T8tHy4;
        "quilt-1.19.4" = _Zs1k6oKV;
        "quilt-1.20-rc1" = _oOy5ndJf;
        "quilt-1.20" = _ZLYCiSMO;
        "quilt-1.20.1" = _ZLYCiSMO;
        "quilt-1.20.2" = _qus1H9JU;
        "quilt-1.20.3-rc1" = _4Vb09gB8;
        "quilt-1.20.3" = _vWSUiZND;
        "quilt-1.20.4" = _vWSUiZND;
        "quilt-1.20.5" = _55yE58dQ;
        "quilt-1.20.6" = _EmIpPLsW;
        "quilt-1.21" = _i80CxP4n;
        "quilt-1.21.1" = _i80CxP4n;
        "quilt-1.21.3" = _Q38QtGku;
        "quilt-1.21.4" = _IBcL3f5W;
        "quilt-1.21.5" = _74IEK9p1;
        "quilt-1.21.6" = _g8WcXZg9;
        "quilt-1.21.7" = _3Lv1hpHj;
        "quilt-1.21.8" = _yu5MwZs0;
        "quilt-1.21.9" = _81Qc21E2;
        "quilt-1.21.10" = _J2D6Ac47;
        "quilt-1.21.11" = _4PX8T9We;
        "quilt-26.1.2" = _BzCXHIwa;
        "quilt-26.2" = _Z6wZaeAX;
        "quilt-26.1" = _BzCXHIwa;
        "quilt-26.1.1" = _BzCXHIwa;
        ...
        "neoforge-1.20.4" = _ekVa7vhQ;
        "neoforge-1.20.3" = _ekVa7vhQ;
        "neoforge-1.20.5" = _wz5E39j6;
        "neoforge-1.20.6" = _pFqKDLgq;
        "neoforge-1.21" = _fOv9QzLO;
        "neoforge-1.21.1" = _fOv9QzLO;
        "neoforge-1.21.3" = _9jbkQNv5;
        "neoforge-1.21.4" = _88NA1SdH;
        "neoforge-1.21.5" = _83oItj23;
        "neoforge-1.21.6" = _qpxTn9xO;
        "neoforge-1.21.7" = _VbeKJj86;
        "neoforge-1.21.8" = _TgfqTLn0;
        "neoforge-1.21.9" = _z6LXuCTe;
        "neoforge-1.21.10" = _b4z9rd73;
        "neoforge-1.21.11" = _OD3jdfif;
        "neoforge-26.1.2" = _nYkAgzJQ;
        "neoforge-26.2" = _B9sHEUTG;
