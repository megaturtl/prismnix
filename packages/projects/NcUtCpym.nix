...
let
    versions = (let
        ...
        _H8isxC6e = {
            "id" = "H8isxC6e";
            "file" = "xaeroworldmap-forge-1.12.2-1.45.0.jar";
            "hash" = "sha512-FlAiClG4JB0M9nt5NZn6R8pd0oLfZudkTzTo9cpzoUDKNbtJHzdJg228qMEqj0gEV+wRLXGGWI3nNDzG4Uddwg==";
        };
        _aiRtntI7 = {
            "id" = "aiRtntI7";
            "file" = "xaeroworldmap-forge-1.16.5-1.45.0.jar";
            "hash" = "sha512-07hLRmnO9I9ZOLNRy80hbhXsgMf5rixyY5LslcUawMtV4Vy6+26loDU0zD0HAEQ0WxT1d68RnvwHE6FfBV01xw==";
        };
        _ofMgYGde = {
            "id" = "ofMgYGde";
            "file" = "xaeroworldmap-fabric-1.16.5-1.45.0.jar";
            "hash" = "sha512-NWqjEowUyf4gESI670ZHyJ93A9X7q7I4F+bmA8HBj+PC+Mah+dbFKgu4AQ2E2AE8FZFCsTA+BGoVopNZEsoTOg==";
        };
        _R47Dxii8 = {
            "id" = "R47Dxii8";
            "file" = "xaeroworldmap-fabric-1.18.2-1.45.0.jar";
            "hash" = "sha512-cwdVixIAP35H4P7ChUVbOcDqb50LpB4pjTwuiX2f7sJsJXbcEDtR13JwqCCa6x1LugsGhclu+KotAp8/vy24PA==";
        };
        _okwKyGYv = {
            "id" = "okwKyGYv";
            "file" = "xaeroworldmap-forge-1.18.2-1.45.0.jar";
            "hash" = "sha512-hudsqopjo8ZK+QV4B7/rUAB4efGKZ2SArJ0vShirV22P/wdpnCm9Gh8nuG7eYqyp8TriNJ/hYLVIoYZlTpxoQQ==";
        };
        _Q5Q0dWGw = {
            "id" = "Q5Q0dWGw";
            "file" = "xaeroworldmap-fabric-1.19.2-1.45.0.jar";
            "hash" = "sha512-87pkIloYhUVGlnfFKSwBXhOXjgB4y3YtvxvcvTZR+YCW06wdZ9BmA3Nv7jH7NVwCiWd4/e2G6SlzjRdZQYWuSg==";
        };
        _UYgfmqrN = {
            "id" = "UYgfmqrN";
            "file" = "xaeroworldmap-forge-1.19.2-1.45.0.jar";
            "hash" = "sha512-vLDFkH20/PXRjhCOyxZ7n95aL2bUpA+Jd5kXjBubJ6KhfYgXyjH3jwHSlR698sF4TMIjoeqMKigJGmWSFGW4Kg==";
        };
        _ZLYCiSMO = {
            "id" = "ZLYCiSMO";
            "file" = "xaeroworldmap-fabric-1.20.1-1.45.0.jar";
            "hash" = "sha512-iDYiQMJNlXK6kCpSg6ZieWZCSscqJn55lCKboyXXQYkqErKzR5Mm0b98RB6l3eV/9DOrMvVAdj7vOu8Kk6+Jfg==";
        };
        _3fGuLVo4 = {
            "id" = "3fGuLVo4";
            "file" = "xaeroworldmap-forge-1.20.1-1.45.0.jar";
            "hash" = "sha512-yHT4O/yk1N4bQD8HZ0ra+AecB/PkHLeOf5aDAaAiSA0iUUQmfez4x1r/qS6npm1hACY7dzKCm7gGOdO7SZ/Fhw==";
        };
        _ekVa7vhQ = {
            "id" = "ekVa7vhQ";
            "file" = "xaeroworldmap-neoforge-1.20.4-1.45.0.jar";
            "hash" = "sha512-HpCdM3bH+PysAKaYtGqEaqk7KEyXRsLvo4YOz3Y8fgd5WLp2Y/mvztNzYuh+ZMoBa1a+M/T94iivEfoPLwDjEA==";
        };
        _vWSUiZND = {
            "id" = "vWSUiZND";
            "file" = "xaeroworldmap-fabric-1.20.4-1.45.0.jar";
            "hash" = "sha512-sxptvl8xRW7r/2xGDWzo3b65wb+ONhRw61bs+/WtU/ZMQyoWIaU2w1hj6W3fJAN8oYI04+x3O7XIzrkq10+AAQ==";
        };
        _92y7huQU = {
            "id" = "92y7huQU";
            "file" = "xaeroworldmap-forge-1.20.4-1.45.0.jar";
            "hash" = "sha512-jf62l1/1O5JdWMw3BvdyjuNlBSuKytlORe1qKFQxGXOk0aifVW91jxcciHW4lGclB/BH4lpLp2Ytc5NVipPyKg==";
        };
        _fOv9QzLO = {
            "id" = "fOv9QzLO";
            "file" = "xaeroworldmap-neoforge-1.21.1-1.45.0.jar";
            "hash" = "sha512-V6MXXZHCN2grZeG533i+I62M0D8cjKB0/GHhZy0oDfj6czXIihc7RrHheDSvYh5RIbgKwNEs18mro+POs2fR6w==";
        };
        _i80CxP4n = {
            "id" = "i80CxP4n";
            "file" = "xaeroworldmap-fabric-1.21.1-1.45.0.jar";
            "hash" = "sha512-wDsRQkeoWCPpNyTg2dMIyE9EyKnrNor/hOjIbMWhTgwe7MoLr6veS52rjiFS+97c/e0Gu2CzAIqCdIcHpC1bYA==";
        };
        _ciV21ZrY = {
            "id" = "ciV21ZrY";
            "file" = "xaeroworldmap-forge-1.21.1-1.45.0.jar";
            "hash" = "sha512-lO2LTCHqTn3Ev9byNE7tvtZy6nRgXar8ScAL+KJhjcpxlhIfmVzVBfgz80SzOgiygabPXZ4j4sXSczEHg9axXA==";
        };
        _88NA1SdH = {
            "id" = "88NA1SdH";
            "file" = "xaeroworldmap-neoforge-1.21.4-1.45.0.jar";
            "hash" = "sha512-IfNbPzhReLHDIU+XNtDjfceyGQ0eGWXVULADUHPXaQM+2MUkn0KVojlRf2P+0WX0GMM+Aoe4pL0MFxSEu1jFoQ==";
        };
        _dfyy2pBR = {
            "id" = "dfyy2pBR";
            "file" = "xaeroworldmap-forge-1.21.4-1.45.0.jar";
            "hash" = "sha512-BZL7i1TMJjg8HPM+OvJP+uZp/1KXc2IxJ5Ddm5BpExI869k4T1jDdhdZqI1P3feM9SrtreeVsvHJCbPgr0eUig==";
        };
        _IBcL3f5W = {
            "id" = "IBcL3f5W";
            "file" = "xaeroworldmap-fabric-1.21.4-1.45.0.jar";
            "hash" = "sha512-8ufevn1DfuspQvEe2V1SYBLzklVZ9Bw2+tvbwScCdmlY4vrPOUsUxy5n6kMSKer//6Cvu24FWaaqU/zh9BIjxw==";
        };
        _74IEK9p1 = {
            "id" = "74IEK9p1";
            "file" = "xaeroworldmap-fabric-1.21.5-1.45.0.jar";
            "hash" = "sha512-skCPdcnAB0DdCgdxLr44mlBGV/gUEI7PhKqHN2IrSB1GmA7uRlwdIvQfHRV2jszHjwcJMvqI5cOoKgfgfZHEDQ==";
        };
        _83oItj23 = {
            "id" = "83oItj23";
            "file" = "xaeroworldmap-neoforge-1.21.5-1.45.0.jar";
            "hash" = "sha512-kgdVr+OQsKyEWxD6Gg+iqSEY239DSiK7ZV9zMnLHDlGH8RKuMKopo4OyC1XlpYXHAJhXnlHHDGlsMh9GnfX5oQ==";
        };
        _s6QFR9D3 = {
            "id" = "s6QFR9D3";
            "file" = "xaeroworldmap-forge-1.21.5-1.45.0.jar";
            "hash" = "sha512-SSUCPZ+2HPILoavq0uznff/qwsqy7ScA4kevKcL+phhyhzdYm7OI+riudYBLb2JPTGy6YukIrfxmKU4328XRAw==";
        };
        _yu5MwZs0 = {
            "id" = "yu5MwZs0";
            "file" = "xaeroworldmap-fabric-1.21.8-1.45.0.jar";
            "hash" = "sha512-1tnWKanT0ndUhtNtTsjULiw9Lh46z1Tu1HOJDnlZvsN+FATmI1PryfAOCkUTn49kZg1e86yzDODRvvlFUP1i/Q==";
        };
        _TgfqTLn0 = {
            "id" = "TgfqTLn0";
            "file" = "xaeroworldmap-neoforge-1.21.8-1.45.0.jar";
            "hash" = "sha512-Ui1HLwuacd3W99WDbSRgBAXp1KHjzn37tcwVL9jE1vI+mp0NOi5gvhDt7SEdx7ltTLz/VR5bes5Kw5ohR0lnPA==";
        };
        _bGFSItfw = {
            "id" = "bGFSItfw";
            "file" = "xaeroworldmap-forge-1.21.8-1.45.0.jar";
            "hash" = "sha512-ik59GeuKz7jo6baEbPnKHoUlHsuEshAO9N9xpNxYqq7NfP5y2M02TazIJC2ShlwJ8DA3ptgB55w/XlF5R/1exQ==";
        };
        _b4z9rd73 = {
            "id" = "b4z9rd73";
            "file" = "xaeroworldmap-neoforge-1.21.10-1.45.0.jar";
            "hash" = "sha512-69unZOapZR8L0dSIzGICPGRzetvDdR5joDkcNw3asGWHzZr/zo+oAbX/cSl/LskLJslx7DJ9T6R8VxqRuoDbaQ==";
        };
        _J2D6Ac47 = {
            "id" = "J2D6Ac47";
            "file" = "xaeroworldmap-fabric-1.21.10-1.45.0.jar";
            "hash" = "sha512-jfDk1LhsfLKPAhKBXsPJMMiKJvMNychkbrgAGk60DPVd9NmVLBiAPLaxMo8AFcGTo4m9emzuE0z7Kx7ZI5ihwg==";
        };
        _HIlE0duq = {
            "id" = "HIlE0duq";
            "file" = "xaeroworldmap-forge-1.21.10-1.45.0.jar";
            "hash" = "sha512-5SweU+I8+NLi3Q+n36JObs9OMXH4BF8h2AOHitr2XeyiAgJvowSQeEudvOC7Bk22imeihkdYjwT613DUnOpVQw==";
        };
        _4PX8T9We = {
            "id" = "4PX8T9We";
            "file" = "xaeroworldmap-fabric-1.21.11-1.45.0.jar";
            "hash" = "sha512-z0qSes2yLoxsX+vUYeRzSFs66VdBvj8tj7TP+1RKLpn3zlI7jA8Jxb9Le5yRjhpHjrFiwa8vBbl6zVh3dHlP8g==";
        };
        _OD3jdfif = {
            "id" = "OD3jdfif";
            "file" = "xaeroworldmap-neoforge-1.21.11-1.45.0.jar";
            "hash" = "sha512-VYv6o1MwnkO42ZpU2SmRibDpetn1vyqVDTg3EFcs7BrwbwmsyIWa1DffyU6XTFxV7KFDELfLDBu51jOSaTxKQA==";
        };
        _B2g3fSMS = {
            "id" = "B2g3fSMS";
            "file" = "xaeroworldmap-forge-1.21.11-1.45.0.jar";
            "hash" = "sha512-U3PqdUfLCLLALiJssY9QETVsDDmlfjlOqfFgdLbPy5Vpr8GLSCINFYsGpqzCLVRWCtfIwprm44WuuCwXDyePUQ==";
        };
        _BzCXHIwa = {
            "id" = "BzCXHIwa";
            "file" = "xaeroworldmap-fabric-26.1.2-1.45.0.jar";
            "hash" = "sha512-T8Sil6ZcFQj7FHdoKgoWZKFqv8gQZ0Fum9oidRrUgWmbf8W1aOjab7cwv+hhSMUDmYUl0eIPNiIuhCIWtT3Fzw==";
        };
        _nYkAgzJQ = {
            "id" = "nYkAgzJQ";
            "file" = "xaeroworldmap-neoforge-26.1.2-1.45.0.jar";
            "hash" = "sha512-Cz18Gh6DxYlstEY7LUruzXAYg3b3hUKb+BUCsUngaZlu5Du66DvhYQMGaKXq4MOamC7F+2isVw3acH8WgWf++g==";
        };
        _G30AUwkY = {
            "id" = "G30AUwkY";
            "file" = "xaeroworldmap-forge-26.1.2-1.45.0.jar";
            "hash" = "sha512-h/WbEDLieLAUKWjAk6yPImmXCfCIXfDGtRQlqrhFG1R1qRq4heAGdLYbvPpRu8t+SD/03ovlshzA60E8ClxlCw==";
        };
        _B9sHEUTG = {
            "id" = "B9sHEUTG";
            "file" = "xaeroworldmap-neoforge-26.2-1.45.0.jar";
            "hash" = "sha512-d1gCuxBbKPFn4JNslsVmJRBILcAHl0JXesHwQT55DZvW5PzRtJeP/fbhj9AZ4ZomAAElwvBrJpwK6W7FZoBe7w==";
        };
        _uR4BXv9U = {
            "id" = "uR4BXv9U";
            "file" = "xaeroworldmap-forge-26.2-1.45.0.jar";
            "hash" = "sha512-w67BLUJAh3sp6aA+lKfFxOCArvCZ9PqzEsh+Y4YQSwRiQwiWjTYULY7vYqimWZhD+MlQ9YE1cnVsFhCVw74qdQ==";
        };
        _Z6wZaeAX = {
            "id" = "Z6wZaeAX";
            "file" = "xaeroworldmap-fabric-26.2-1.45.0.jar";
            "hash" = "sha512-NmeDO46AVyOYxXtQGldQVHpfvkYoPkt7umw/u6Vw7P4dwx1uQwgowYLYhxo3ggtaJLiJeL/rp9pe6FEHqicdsw==";
        };
        _lqE4pAC2 = {
            "id" = "lqE4pAC2";
            "file" = "xaeroworldmap-forge-1.12.2-1.46.0.jar";
            "hash" = "sha512-Utqoty0TQEHBfKF4OI00Szyu/pKjEU+3l+wJB/4MdvA+5P4ZASJocRCP+tR+yuj6mH4T2pHTTnJKsUW/lOOU7w==";
        };
        _9d9DcRJ2 = {
            "id" = "9d9DcRJ2";
            "file" = "xaeroworldmap-forge-1.16.5-1.46.0.jar";
            "hash" = "sha512-FIbjW/Z84Ve8VtUunL+jBq2EjlH0CX5KZzCmDNlXLsBgZHLZnscTw9NgoJ2Y80oGJItw+BtYpGjuMYhnMU41EQ==";
        };
        _YYtuPXYT = {
            "id" = "YYtuPXYT";
            "file" = "xaeroworldmap-fabric-1.16.5-1.46.0.jar";
            "hash" = "sha512-1rytigRbKUokFg+ZhknM53Dgg9AZ3zNCrl7cWEmYG16th0HsgP6EAwstlUPNxVh03ug/BZ5uOg837iL8JdC9oA==";
        };
        _SeatstUt = {
            "id" = "SeatstUt";
            "file" = "xaeroworldmap-fabric-1.18.2-1.46.0.jar";
            "hash" = "sha512-dx0tak46QC3Ph5XjdY9xb9S0IYYR+WgKCj6Z7fOPyFwa15V03wjLB07OombPuc11WL4xLTvyy8UBEPPytxnAJg==";
        };
        _UEVTfNxx = {
            "id" = "UEVTfNxx";
            "file" = "xaeroworldmap-forge-1.18.2-1.46.0.jar";
            "hash" = "sha512-Y/5W7/S1PjxndBnUpo0cxHh2qwcY6VDBMlwIGTB+xxTsMPhjo45azqyNasD6D4/QZvSzZHrcV64/woUyLG9xCw==";
        };
        _VBW0exoV = {
            "id" = "VBW0exoV";
            "file" = "xaeroworldmap-fabric-1.19.2-1.46.0.jar";
            "hash" = "sha512-fekbC9qg3VBbxme8an1a4HpOnH/Av/k87YVawoB8G/HMjM+cDD+FX8kA5dhsM1PXhMJ9UxYFV4YnKYGKCqTUlg==";
        };
        _ylwy6kh5 = {
            "id" = "ylwy6kh5";
            "file" = "xaeroworldmap-forge-1.19.2-1.46.0.jar";
            "hash" = "sha512-f/SVxDVi5Ibl49/V9P2Ha2odwIjNihSuXttFbUgljZzpVvfZrh11Ih1FjwZWkOeEKqNKPRX/zZzI9c5Em3HcuQ==";
        };
        _X84cZdC3 = {
            "id" = "X84cZdC3";
            "file" = "xaeroworldmap-fabric-1.20.1-1.46.0.jar";
            "hash" = "sha512-RYgUeHPDIGJG11VQ57+ko5XQA4LAmjkwKh82xDkDsBPVPNAmhzmggWosu7HuTEzYTFhSVplXJsu82gyqOK+ozw==";
        };
        _rlPmwaQX = {
            "id" = "rlPmwaQX";
            "file" = "xaeroworldmap-forge-1.20.1-1.46.0.jar";
            "hash" = "sha512-Y09mB91zHS/vk2rbuzvxaBjPUk14rYk00xMmBCdoAFRuZNohENinQd9WXD3kPO4k1pisX6w9WI/5JeukPkbOTA==";
        };
        _S9GHYEYj = {
            "id" = "S9GHYEYj";
            "file" = "xaeroworldmap-fabric-1.20.4-1.46.0.jar";
            "hash" = "sha512-zgHEcusNlAh2yJe03SZxyH3MKb8HBXHUt3qdrCEkgTuFsVTzm/6v8p9iqotTVcrSJTrdHPpiteoLU4YX3nIyWg==";
        };
        _DYWzeQ0C = {
            "id" = "DYWzeQ0C";
            "file" = "xaeroworldmap-neoforge-1.20.4-1.46.0.jar";
            "hash" = "sha512-tuE0+wIuaFKkbIAsrFK5QAxgR+6aPA9+CwdDQUb69KueP5ThU3pB0EgLBQXm+Ds0Q9Yf2vvcSFMfVFjYp+cI6g==";
        };
        _SwN9YJER = {
            "id" = "SwN9YJER";
            "file" = "xaeroworldmap-forge-1.20.4-1.46.0.jar";
            "hash" = "sha512-VQ6n+ULUkL7TS1y5ExinZiEMWW2DNrx1KRJRl0XG+PNgJAcQJqpg2lRl8U08FMKJKyC5zUMnes5+Vo/p98ty9Q==";
        };
        _txl9KURC = {
            "id" = "txl9KURC";
            "file" = "xaeroworldmap-fabric-1.21.1-1.46.0.jar";
            "hash" = "sha512-r8pPLzzjzH4j35REdIb8xE/bH1acRy+w7tn1yZYVQ6wxhKhLIFgxGx111LQHFUflcDu9kCCCCOitJiujCDBKgA==";
        };
        _9Ckiihkz = {
            "id" = "9Ckiihkz";
            "file" = "xaeroworldmap-neoforge-1.21.1-1.46.0.jar";
            "hash" = "sha512-+xTRHWbgpkQZgbGEVMhlNNj1NM0VnKGfphKVBSF4jYWPN/GP4gk7ubQ8oKiK6a9Xjs7V0UD/ZFp2gdfkUuiiaA==";
        };
        _aOqDWHqr = {
            "id" = "aOqDWHqr";
            "file" = "xaeroworldmap-forge-1.21.1-1.46.0.jar";
            "hash" = "sha512-bubn/V9XRYkXV8IVEKHTpzh5K5Uf3DgnVxlV4zSb9xL6EZZkiW5Jd3VQc81KLSjU/Y6df+enCwX90LkbVZYcVA==";
        };
        _IoGJS3fE = {
            "id" = "IoGJS3fE";
            "file" = "xaeroworldmap-fabric-1.21.4-1.46.0.jar";
            "hash" = "sha512-5awx+jZtSNAqziSJSH8Rfato9ZuyS9FTM3oaQOkn8PbbV82XCse4d2mU+DI53fqEg1g6fmnb9OTq2rLyYnFkkA==";
        };
        _VlQLmGAM = {
            "id" = "VlQLmGAM";
            "file" = "xaeroworldmap-neoforge-1.21.4-1.46.0.jar";
            "hash" = "sha512-447aCEvnxVX8bleKAXIvR9E+yl+XxmKT547JmR7Kh4C/X09SF0+ObuSQC1jHymlb+07R/VkFH4hS0ql3j2HVyw==";
        };
        _YoiDAv5R = {
            "id" = "YoiDAv5R";
            "file" = "xaeroworldmap-forge-1.21.4-1.46.0.jar";
            "hash" = "sha512-MDEeWzqvwjPn0btelmK7mRmhpgnHYSfQN2HN81+WKEMty1yc0SJ7kHVPyxNdhKwz7nQyOZ5Enmxc4YdhfN1OEA==";
        };
        _kJhXAZVZ = {
            "id" = "kJhXAZVZ";
            "file" = "xaeroworldmap-fabric-1.21.5-1.46.0.jar";
            "hash" = "sha512-STHETERAh8R9vflXKIms9yNo6uo6JyKs87Lo5vO+KdCs/ZUmCc0HuHGY9T9VN/1TW1qIfSGcTUemX4fuOAOdog==";
        };
        _jRMh44By = {
            "id" = "jRMh44By";
            "file" = "xaeroworldmap-neoforge-1.21.5-1.46.0.jar";
            "hash" = "sha512-yxgNN02OHcjXoK8Cp/02SxSysy9f+wEx5c7ydzhIveKHtA6RyO7B6gcYp51KjgJ7AYQOY6ZdUpm+2FFw7nvavw==";
        };
        _pPFk05ez = {
            "id" = "pPFk05ez";
            "file" = "xaeroworldmap-forge-1.21.5-1.46.0.jar";
            "hash" = "sha512-RECrJ6hnTwoa/fJSQbTEn1SaicGkYiZ4CgXHfWhanlb61MVtNbQnzScc9Mcl+oAwaNjqMZDQcP2L6NZVO3nsvA==";
        };
        _q54JRi33 = {
            "id" = "q54JRi33";
            "file" = "xaeroworldmap-fabric-1.21.8-1.46.0.jar";
            "hash" = "sha512-1bfmS1VvngLOgxNpEzCl0ItbLWHkOxZ7P9QKVGZTq0rrVEAg6/y2ePcTnbFKAKQ07b6hxeExbpF4QeOohNrTHg==";
        };
        _j9wLUl2w = {
            "id" = "j9wLUl2w";
            "file" = "xaeroworldmap-neoforge-1.21.8-1.46.0.jar";
            "hash" = "sha512-ER6fXxw3rf7yuioE6v2t0MBmUnESii/HpN/i4FsytMRGHRMTyBlXh2YsjihpUqcJIO4xApq7mPp17lCyMQCXQg==";
        };
        _Z4pA0icg = {
            "id" = "Z4pA0icg";
            "file" = "xaeroworldmap-forge-1.21.8-1.46.0.jar";
            "hash" = "sha512-+tdDVZ35LbEoV8VnflGDZqUrvhIZnWhe3dUQTCdZsD1psoenpnskcRj4KAl0VGLC6G7VcAKnk5eueg1TR+TlTg==";
        };
        _F8SwXfI6 = {
            "id" = "F8SwXfI6";
            "file" = "xaeroworldmap-fabric-1.21.10-1.46.0.jar";
            "hash" = "sha512-Go8ChJx1tjpii8KWDbl03vkBIj0v9Ix6GHgwGNp44O8pkX53BownNJJJ+W9iSOgw4fwlt4lHDYQIsOWQGTfygw==";
        };
        _eCVBfGW7 = {
            "id" = "eCVBfGW7";
            "file" = "xaeroworldmap-neoforge-1.21.10-1.46.0.jar";
            "hash" = "sha512-LO6rnuc1kdTssIRGM1WszDEdlQFmYrfTPB3e5llxKYfIg6iFrdPJreq7KZCaADLR77GS5yDZ9e2TY8EuzRn/Rg==";
        };
        _jJs05zGE = {
            "id" = "jJs05zGE";
            "file" = "xaeroworldmap-forge-1.21.10-1.46.0.jar";
            "hash" = "sha512-tIUt7rBgxkcvUVoR0dofdkefUnD87HkDNqjIClCitkKRV2nuUxMe/Pk8vetAmKf9wP0WJ8YPEQ7/RX8nz112cA==";
        };
        _Jfe3ZJIB = {
            "id" = "Jfe3ZJIB";
            "file" = "xaeroworldmap-fabric-1.21.11-1.46.0.jar";
            "hash" = "sha512-F6qFTYt7IeQzGopRDtKKsgYXRn57mzAhQ4CkwhvMgRRb9CvFfyauk/vlFXoLnSciNcEjJp51MsjH1UI5xXwhdA==";
        };
        _My5vFbsa = {
            "id" = "My5vFbsa";
            "file" = "xaeroworldmap-neoforge-1.21.11-1.46.0.jar";
            "hash" = "sha512-ksiK06LFyM8PqiHy2sYxJTDt1nNsG+Cnm1wsvDDxma3pKl6u9vvPkLCeyDkoi8HPK6zXiOcySdawoFufVc7yxw==";
        };
        _WPmPusNa = {
            "id" = "WPmPusNa";
            "file" = "xaeroworldmap-forge-1.21.11-1.46.0.jar";
            "hash" = "sha512-87bxQc6rt7OHhbgfkpfuC/QyTXxMzejU6AbmFB28w/w38czKdlVzpyLy9psWH2t6O2SRdfWHAjXG3pKs+k78dw==";
        };
        _IYPINJuw = {
            "id" = "IYPINJuw";
            "file" = "xaeroworldmap-fabric-26.1.2-1.46.0.jar";
            "hash" = "sha512-M130FPGcJnWtmiRfwSBp6mXKs4wJYQ5T/tF5w/jzFKFPkXybZr0X/1AtR2l3Ubog57twVYe0eFAXO/+pqHdrGA==";
        };
        _9x5f2L12 = {
            "id" = "9x5f2L12";
            "file" = "xaeroworldmap-neoforge-26.1.2-1.46.0.jar";
            "hash" = "sha512-6l/ya/8N2Ph9+E9DkBdLvFf2Xb3GSeDpuECHJnMls5/2UyiZJr8a2JH1HQ8X0or9R1NgSUC/arjuqCXCpTwnIQ==";
        };
        _LV5noeKG = {
            "id" = "LV5noeKG";
            "file" = "xaeroworldmap-forge-26.1.2-1.46.0.jar";
            "hash" = "sha512-F2AR1nR17j3IH62jRYs5hNU/OH8xdBJeCPabT0NL2+38Ie670B6Kv2lrD8rWbys5ItjzhOFIaT49aAOFIZw2Ew==";
        };
        _DxU1zijU = {
            "id" = "DxU1zijU";
            "file" = "xaeroworldmap-fabric-26.2-1.46.0.jar";
            "hash" = "sha512-NyhIaO7XuxBTYrod89o46GCg+InlDcrkPdrxZ8M4F7js4ol3D4mxOOMnsUXRWuNqTfhQICdwI2pO79e0ExWEOA==";
        };
        _kusU9lBt = {
            "id" = "kusU9lBt";
            "file" = "xaeroworldmap-neoforge-26.2-1.46.0.jar";
            "hash" = "sha512-DM0Iq0d8KZTJAqWoVsC7br/CqBh7h6Q0RxTIxT7+cpHH8hvsWUJluGrgqRrmPkYcy54S4RVpDZHPebhCGgWYvA==";
        };
        _KpbxehO3 = {
            "id" = "KpbxehO3";
            "file" = "xaeroworldmap-forge-26.2-1.46.0.jar";
            "hash" = "sha512-Ze1KJWyb0EU1CokBVi6UC6mIBYDGQv+9HRiG8yJrTQvYkWnwRWOhY1d3Mg4Ym/Ds1tJJAfqi2gb/G5PjeLWuTQ==";
        };
        _3cyKCC8w = {
            "id" = "3cyKCC8w";
            "file" = "xaeroworldmap-forge-26.2-1.46.1.jar";
            "hash" = "sha512-wWCI0M4ZuEK2mA6Bqd4/X35Q2A/llKhwxmSanu4U/lmuVLBaTlZLG+80Zn6C5c8TYhe/n0NnDtP0ro8WzEjCOw==";
        };
        _jvDo1iio = {
            "id" = "jvDo1iio";
            "file" = "xaeroworldmap-neoforge-26.2-1.46.1.jar";
            "hash" = "sha512-2ruYYmzNxIobPbBx8qhuTPcxIyJBd1RhXwqhZCN27FrdmFVv6PjUNCbuIph9ahfiZdGm6WFp9kXWNiyev66qKA==";
        };
        _q0Wvp46X = {
            "id" = "q0Wvp46X";
            "file" = "xaeroworldmap-fabric-26.2-1.46.1.jar";
            "hash" = "sha512-npdHo6fuStHACUTDySKJUESnf1pdmooS6wEmdtrmbjgARA1/ShYD54i/3CzvikK+dOQt0BmFyU+Qc8gLADCXdQ==";
        };
        _f9XDypdw = {
            "id" = "f9XDypdw";
            "file" = "xaeroworldmap-fabric-26.3-1.46.2.jar";
            "hash" = "sha512-T9olvK8EU43+xau4vReQzUNxcn3sKHUG761bH88mUuwiYMLBi4crboANoW1C3pMaGVvXsiS24fy03gMYCdrRxQ==";
        };
        _wFzCYgM6 = {
            "id" = "wFzCYgM6";
            "file" = "xaeroworldmap-fabric-26.3-1.46.3.jar";
            "hash" = "sha512-BYokWZaveMp0h4ugPFl35hm7Of/xYCUMjfjaRbLO8phYihCZWzzTZhd+vw3HDMvuFto5P3QzK0kUuvd3vDW6VQ==";
        };
        _YEohEAtf = {
            "id" = "YEohEAtf";
            "file" = "xaeroworldmap-neoforge-26.3-1.46.3.jar";
            "hash" = "sha512-1N6/JC233mFhkJ1aq87QMIIy+/+D9UXDslHicbCsEXRbK3+nKzI0APMRKVm7ZnxBO4lE+YPdSBuGPbRLH19KRg==";
        };
    in {
        "sjR1qU6w" = _sjR1qU6w;
        "5uRQHkZl" = _5uRQHkZl;
        ...
        "forge-1.12.2" = _lqE4pAC2;
        "forge-1.14.4" = _3FwkAdEs;
        "forge-1.15.2" = _6OGNVOoZ;
        "forge-1.16.2" = _AdgNeUH5;
        "forge-1.16.3" = _AdgNeUH5;
        "forge-1.16.4" = _AdgNeUH5;
        "forge-1.16.5" = _9d9DcRJ2;
        "forge-1.17.1" = _pJR2Fqwm;
        "forge-1.18.2" = _UEVTfNxx;
        "forge-1.19.1" = _ylwy6kh5;
        "forge-1.19.2" = _ylwy6kh5;
        "forge-1.19.3" = _5srNwTQr;
        "forge-1.19.4" = _o2x00FuF;
        "forge-1.20" = _rlPmwaQX;
        "forge-1.20.1" = _rlPmwaQX;
        "forge-1.20.2" = _cdp9dUvQ;
        "forge-1.20.3" = _SwN9YJER;
        "forge-1.20.4" = _SwN9YJER;
        "forge-1.20.6" = _lwdXY9pL;
        "forge-1.20.5" = _lwdXY9pL;
        "forge-1.21" = _aOqDWHqr;
        "forge-1.21.1" = _aOqDWHqr;
        "forge-1.21.3" = _4mEzwP8R;
        "forge-1.21.4" = _YoiDAv5R;
        "forge-1.21.5" = _pPFk05ez;
        "forge-1.21.7" = _75DL0q3D;
        "forge-1.21.8" = _Z4pA0icg;
        "forge-1.21.9" = _bMLq86wD;
        "forge-1.21.10" = _jJs05zGE;
        "forge-1.21.11" = _WPmPusNa;
        "forge-26.1.2" = _LV5noeKG;
        "forge-26.2" = _3cyKCC8w;
        "fabric-1.16.2" = _3LB40S6g;
        "fabric-1.16.3" = _3LB40S6g;
        "fabric-1.16.4" = _3LB40S6g;
        "fabric-1.16.5" = _YYtuPXYT;
        "fabric-1.17" = _X5l3pEeo;
        "fabric-1.17.1" = _X5l3pEeo;
        "fabric-1.18.2" = _SeatstUt;
        "fabric-1.19.1" = _VBW0exoV;
        "fabric-1.19.2" = _VBW0exoV;
        "fabric-1.19.3" = _p3T8tHy4;
        "fabric-1.19.4" = _Zs1k6oKV;
        "fabric-1.20-rc1" = _oOy5ndJf;
        "fabric-1.20" = _X84cZdC3;
        "fabric-1.20.1" = _X84cZdC3;
        "fabric-1.20.2" = _qus1H9JU;
        "fabric-1.20.3-rc1" = _4Vb09gB8;
        "fabric-1.20.3" = _S9GHYEYj;
        "fabric-1.20.4" = _S9GHYEYj;
        "fabric-1.20.5" = _55yE58dQ;
        "fabric-1.20.6" = _EmIpPLsW;
        "fabric-1.21" = _txl9KURC;
        "fabric-1.21.1" = _txl9KURC;
        "fabric-1.21.3" = _Q38QtGku;
        "fabric-1.21.4" = _IoGJS3fE;
        "fabric-1.21.5" = _kJhXAZVZ;
        "fabric-1.21.6" = _g8WcXZg9;
        "fabric-1.21.7" = _3Lv1hpHj;
        "fabric-1.21.8" = _q54JRi33;
        "fabric-1.21.9" = _81Qc21E2;
        "fabric-1.21.10" = _F8SwXfI6;
        "fabric-1.21.11" = _Jfe3ZJIB;
        "fabric-26.1.2" = _IYPINJuw;
        "fabric-26.2" = _q0Wvp46X;
        "fabric-26.1" = _IYPINJuw;
        "fabric-26.1.1" = _IYPINJuw;
        "fabric-26.3-rc-2" = _f9XDypdw;
        "fabric-26.3-rc-3" = _f9XDypdw;
        "fabric-26.3" = _wFzCYgM6;
        "quilt-1.16.2" = _3LB40S6g;
        "quilt-1.16.3" = _3LB40S6g;
        "quilt-1.16.4" = _3LB40S6g;
        "quilt-1.16.5" = _YYtuPXYT;
        "quilt-1.17" = _X5l3pEeo;
        "quilt-1.17.1" = _X5l3pEeo;
        "quilt-1.18.2" = _SeatstUt;
        "quilt-1.19.1" = _VBW0exoV;
        "quilt-1.19.2" = _VBW0exoV;
        "quilt-1.19.3" = _p3T8tHy4;
        "quilt-1.19.4" = _Zs1k6oKV;
        "quilt-1.20-rc1" = _oOy5ndJf;
        "quilt-1.20" = _X84cZdC3;
        "quilt-1.20.1" = _X84cZdC3;
        "quilt-1.20.2" = _qus1H9JU;
        "quilt-1.20.3-rc1" = _4Vb09gB8;
        "quilt-1.20.3" = _S9GHYEYj;
        "quilt-1.20.4" = _S9GHYEYj;
        "quilt-1.20.5" = _55yE58dQ;
        "quilt-1.20.6" = _EmIpPLsW;
        "quilt-1.21" = _txl9KURC;
        "quilt-1.21.1" = _txl9KURC;
        "quilt-1.21.3" = _Q38QtGku;
        "quilt-1.21.4" = _IoGJS3fE;
        "quilt-1.21.5" = _kJhXAZVZ;
        "quilt-1.21.6" = _g8WcXZg9;
        "quilt-1.21.7" = _3Lv1hpHj;
        "quilt-1.21.8" = _q54JRi33;
        "quilt-1.21.9" = _81Qc21E2;
        "quilt-1.21.10" = _F8SwXfI6;
        "quilt-1.21.11" = _Jfe3ZJIB;
        "quilt-26.1.2" = _IYPINJuw;
        "quilt-26.2" = _q0Wvp46X;
        "quilt-26.1" = _IYPINJuw;
        "quilt-26.1.1" = _IYPINJuw;
        "quilt-26.3-rc-2" = _f9XDypdw;
        "quilt-26.3-rc-3" = _f9XDypdw;
        "quilt-26.3" = _wFzCYgM6;
        ...
        "neoforge-1.20.4" = _DYWzeQ0C;
        "neoforge-1.20.3" = _DYWzeQ0C;
        "neoforge-1.20.5" = _wz5E39j6;
        "neoforge-1.20.6" = _pFqKDLgq;
        "neoforge-1.21" = _9Ckiihkz;
        "neoforge-1.21.1" = _9Ckiihkz;
        "neoforge-1.21.3" = _9jbkQNv5;
        "neoforge-1.21.4" = _VlQLmGAM;
        "neoforge-1.21.5" = _jRMh44By;
        "neoforge-1.21.6" = _qpxTn9xO;
        "neoforge-1.21.7" = _VbeKJj86;
        "neoforge-1.21.8" = _j9wLUl2w;
        "neoforge-1.21.9" = _z6LXuCTe;
        "neoforge-1.21.10" = _eCVBfGW7;
        "neoforge-1.21.11" = _My5vFbsa;
        "neoforge-26.1.2" = _9x5f2L12;
        "neoforge-26.2" = _jvDo1iio;
        "neoforge-26.3" = _YEohEAtf;
        "pkg-1.14.1.23_Forge_1.7.10" = _sjR1qU6w;
        "pkg-1.14.1.23_Forge_1.8.9" = _5uRQHkZl;
        "pkg-1.30.0_Forge_1.12" = _WxlvhTaW;
        "pkg-1.29.6_Forge_1.14.4" = _XVjzdnhG;
        "pkg-1.29.6_Forge_1.15.2" = _rvZ5A3tX;
        "pkg-1.30.0_Fabric_1.16.5" = _8jDTpHjY;
        "pkg-1.30.0_Forge_1.16.5" = _SEkYCdVo;
        "pkg-1.30.0_Fabric_1.17.1" = _XAQBPZpW;
        "pkg-1.30.0_Forge_1.17.1" = _EDmj5NvH;
        "pkg-1.30.0_Fabric_1.18.2" = _wSGK3o4I;
        "pkg-1.30.0_Forge_1.18.2" = _xTm3FQw4;
        "pkg-1.30.0_Fabric_1.19.1" = _gyPsXrJn;
        "pkg-1.30.0_Forge_1.19.1" = _p3dZW7fr;
        "pkg-1.30.0_Fabric_1.19.3" = _zjxfdYdF;
        "pkg-1.30.0_Forge_1.19.3" = _g3VW8AT2;
        "pkg-1.30.0_Fabric_1.19.4" = _PrBF6EyY;
        "pkg-1.30.0_Forge_1.19.4" = _gkVIeUFw;
        "pkg-1.14.1.24_Forge_1.7.10" = _tfnnfyhI;
        "pkg-1.14.1.24_Forge_1.8.9" = _wVJY9O6J;
        "pkg-1.30.1_Forge_1.12" = _j8XCNctd;
        "pkg-1.29.7_Forge_1.14.4" = _WHjpeO1f;
        "pkg-1.29.7_Forge_1.15.2" = _KK99goJD;
        "pkg-1.30.1_Fabric_1.16.5" = _eIXI4OHk;
        "pkg-1.30.1_Forge_1.16.5" = _qYCKTHyZ;
        "pkg-1.30.1_Fabric_1.17.1" = _6YRIXrfW;
        "pkg-1.30.1_Forge_1.17.1" = _iRRYeaXC;
        "pkg-1.30.1_Fabric_1.18.2" = _OWbYG8pN;
        "pkg-1.30.1_Forge_1.18.2" = _vhY17uSv;
        "pkg-1.30.1_Fabric_1.19.1" = _Tfe1ecMx;
        "pkg-1.30.1_Forge_1.19.1" = _Hwoxn6jb;
        "pkg-1.30.1_Fabric_1.19.3" = _YSvtDiDJ;
        "pkg-1.30.1_Forge_1.19.3" = _F5Gr1zAz;
        "pkg-1.30.1_Fabric_1.19.4" = _UsAkUS2z;
        "pkg-1.30.1_Forge_1.19.4" = _nTYOCaJr;
        "pkg-1.30.2_Forge_1.12" = _GnQS252L;
        "pkg-1.29.8_Forge_1.14.4" = _UWmPDmNV;
        "pkg-1.29.8_Forge_1.15.2" = _9eIlzDjA;
        "pkg-1.30.2_Fabric_1.16.5" = _f4lwNpJy;
        "pkg-1.30.2_Forge_1.16.5" = _jugM0Ovw;
        "pkg-1.30.2_Fabric_1.17.1" = _qPxvfkdp;
        "pkg-1.30.2_Forge_1.17.1" = _JPclNzVu;
        "pkg-1.30.2_Fabric_1.18.2" = _tsUJqXDi;
        "pkg-1.30.2_Forge_1.18.2" = _lobkeTkB;
        "pkg-1.30.2_Fabric_1.19.1" = _lSgnePcA;
        "pkg-1.30.2_Forge_1.19.1" = _vaunHDVN;
        "pkg-1.30.2_Fabric_1.19.3" = _yTrargyD;
        "pkg-1.30.2_Forge_1.19.3" = _4tuhFGgl;
        "pkg-1.30.2_Fabric_1.19.4" = _kIscoBGn;
        "pkg-1.30.2_Forge_1.19.4" = _U63RC8MZ;
        "pkg-1.14.1.25_Forge_1.7.10" = _pMIMCf1G;
        "pkg-1.14.1.25_Forge_1.8.9" = _UuHzKSkv;
        "pkg-1.30.3_Forge_1.12" = _maJOw1H4;
        "pkg-1.29.9_Forge_1.14.4" = _zmckWzCk;
        "pkg-1.29.9_Forge_1.15.2" = _tgCUTXi6;
        "pkg-1.30.3_Fabric_1.16.5" = _vhVUuszi;
        "pkg-1.30.3_Forge_1.16.5" = _YuRNFnq7;
        "pkg-1.30.3_Fabric_1.17.1" = _IYdHD4ew;
        "pkg-1.30.3_Forge_1.17.1" = _E41Rgx07;
        "pkg-1.30.3_Fabric_1.18.2" = _2CLZEyLl;
        "pkg-1.30.3_Forge_1.18.2" = _JVLFrAlD;
        "pkg-1.30.3_Fabric_1.19.1" = _xrQzeBh0;
        "pkg-1.30.3_Forge_1.19.1" = _AuVUfdfe;
        "pkg-1.30.3_Fabric_1.19.3" = _LKz8LFts;
        "pkg-1.30.3_Forge_1.19.3" = _pt74IfTL;
        "pkg-1.30.3_Fabric_1.19.4" = _16lBdJRZ;
        "pkg-1.30.3_Forge_1.19.4" = _tpVsp7bd;
        "pkg-1.30.3_Fabric_1.20" = _oOy5ndJf;
        "pkg-1.30.3_Forge_1.20" = _S9UoAZsm;
        "pkg-1.30.4_Fabric_1.20" = _rCAbt1s2;
        "pkg-1.30.4_Forge_1.20" = _uB3mOur8;
        "pkg-1.14.1.26_Forge_1.7.10" = _S8ykUljl;
        "pkg-1.14.1.26_Forge_1.8.9" = _7jQ7gDOY;
        "pkg-1.30.5_Forge_1.12" = _yCMEGaHO;
        "pkg-1.29.10_Forge_1.14.4" = _ulDBKKjw;
        "pkg-1.29.10_Forge_1.15.2" = _owGOq3Vv;
        "pkg-1.30.5_Fabric_1.16.5" = _qSeRup3d;
        "pkg-1.30.5_Forge_1.16.5" = _k2nQBeEG;
        "pkg-1.30.5_Fabric_1.17.1" = _ka6W06WC;
        "pkg-1.30.5_Forge_1.17.1" = _ZmnidKjr;
        "pkg-1.30.5_Fabric_1.18.2" = _9YZGdfjd;
        "pkg-1.30.5_Forge_1.18.2" = _L7CkxPe9;
        "pkg-1.30.5_Fabric_1.19.1" = _wFjQVyYW;
        "pkg-1.30.5_Forge_1.19.1" = _dkhcYs7u;
        "pkg-1.30.5_Fabric_1.19.3" = _SgTgAga6;
        "pkg-1.30.5_Forge_1.19.3" = _L388v7RA;
        "pkg-1.30.5_Fabric_1.19.4" = _KWRX7go3;
        "pkg-1.30.5_Forge_1.19.4" = _tCkajzyq;
        "pkg-1.30.5_Fabric_1.20" = _jZqjpEV5;
        "pkg-1.30.5_Forge_1.20" = _l7jJ8edR;
        "pkg-1.30.6_Fabric_1.18.2" = _3nAnz7eN;
        "pkg-1.30.6_Forge_1.18.2" = _u81MmI6X;
        "pkg-1.30.6_Fabric_1.19.1" = _ZZRvmbyH;
        "pkg-1.30.6_Forge_1.19.1" = _ikX4JmdG;
        "pkg-1.30.6_Fabric_1.19.3" = _mIAzcHM5;
        "pkg-1.30.6_Forge_1.19.3" = _jSmDzqpB;
        "pkg-1.30.6_Fabric_1.19.4" = _tT8MXEmG;
        "pkg-1.30.6_Forge_1.19.4" = _WGbmlzYS;
        "pkg-1.30.6_Fabric_1.20" = _J5hmblFo;
        "pkg-1.30.6_Forge_1.20" = _QWYwBuvt;
        "pkg-1.31.0_Forge_1.12" = _WiGXwduw;
        "pkg-1.31.0_Fabric_1.16.5" = _3fqf56PV;
        "pkg-1.31.0_Forge_1.16.5" = _lKakfRVC;
        "pkg-1.31.0_Fabric_1.17.1" = _rIiXRyJC;
        "pkg-1.31.0_Forge_1.17.1" = _KWSdBt0q;
        "pkg-1.31.0_Fabric_1.18.2" = _bkG41Vbj;
        "pkg-1.31.0_Forge_1.18.2" = _yQ4ly7jG;
        "pkg-1.31.0_Fabric_1.19.1" = _st6Yi8FJ;
        "pkg-1.31.0_Forge_1.19.1" = _TKPBR9FG;
        "pkg-1.31.0_Fabric_1.19.3" = _zWRFHFoD;
        "pkg-1.31.0_Forge_1.19.3" = _8THHR0Ih;
        "pkg-1.31.0_Fabric_1.19.4" = _IbQ6bv6m;
        "pkg-1.31.0_Forge_1.19.4" = _UmvLwPCn;
        "pkg-1.31.0_Fabric_1.20" = _hZzMR1av;
        "pkg-1.31.0_Forge_1.20" = _5VvnuOEf;
        "pkg-1.14.1.27_Forge_1.7.10" = _BEDFycdT;
        "pkg-1.14.1.27_Forge_1.8.9" = _FKfWhnDZ;
        "pkg-1.32.0_Forge_1.12" = _1CrVR9hT;
        "pkg-1.29.11_Forge_1.14.4" = _JGA2cBTv;
        "pkg-1.29.11_Forge_1.15.2" = _ZRTN6l4r;
        "pkg-1.32.0_Fabric_1.16.5" = _4uIcYzMT;
        "pkg-1.32.0_Forge_1.16.5" = _X8DXecL3;
        "pkg-1.32.0_Fabric_1.17.1" = _lxyt26N7;
        "pkg-1.32.0_Forge_1.17.1" = _F8rp5v60;
        "pkg-1.32.0_Fabric_1.18.2" = _svlAeqb1;
        "pkg-1.32.0_Forge_1.18.2" = _DaJpdk7q;
        "pkg-1.32.0_Fabric_1.19.1" = _FX41W6zb;
        "pkg-1.32.0_Forge_1.19.1" = _G0OJfwAN;
        "pkg-1.32.0_Fabric_1.19.3" = _m1xFZhrl;
        "pkg-1.32.0_Forge_1.19.3" = _rdajsfZG;
        "pkg-1.32.0_Fabric_1.19.4" = _d44dMHzw;
        "pkg-1.32.0_Forge_1.19.4" = _YdjlQoKs;
        "pkg-1.32.0_Fabric_1.20" = _RBZYvZJ4;
        "pkg-1.32.0_Forge_1.20" = _zQO1LQVm;
        "pkg-1.14.1.28_Forge_1.7.10" = _h3VxD6Wb;
        "pkg-1.14.1.28_Forge_1.8.9" = _wgv5h06j;
        "pkg-1.33.0_Forge_1.12" = _haB4dNPc;
        "pkg-1.29.12_Forge_1.14.4" = _rxl7TQQN;
        "pkg-1.29.12_Forge_1.15.2" = _VSR9iCm0;
        "pkg-1.33.0_Fabric_1.16.5" = _cHNqHQ7K;
        "pkg-1.33.0_Forge_1.16.5" = _H401c3Kn;
        "pkg-1.33.0_Fabric_1.17.1" = _o5C0YrDg;
        "pkg-1.33.0_Forge_1.17.1" = _vyF7iBYu;
        "pkg-1.33.0_Fabric_1.18.2" = _4qJUjLux;
        "pkg-1.33.0_Forge_1.18.2" = _ky1LwLZC;
        "pkg-1.33.0_Fabric_1.19.1" = _nWD5LilR;
        "pkg-1.33.0_Forge_1.19.1" = _UK6zITLD;
        "pkg-1.33.0_Fabric_1.19.3" = _GnVgI8Tc;
        "pkg-1.33.0_Forge_1.19.3" = _x3Hz1Rw3;
        "pkg-1.33.0_Fabric_1.19.4" = _IO0epD4H;
        "pkg-1.33.0_Forge_1.19.4" = _6fAtl7y7;
        "pkg-1.33.0_Fabric_1.20" = _VTlrn9zn;
        "pkg-1.33.0_Forge_1.20" = _1sOYFhej;
        "pkg-1.14.1.29_Forge_1.7.10" = _LYmDkdJa;
        "pkg-1.14.1.29_Forge_1.8.9" = _9AvZZulC;
        "pkg-1.33.1_Forge_1.12" = _9TpOEnGQ;
        "pkg-1.29.13_Forge_1.14.4" = _RTD3td7Z;
        "pkg-1.29.13_Forge_1.15.2" = _EbUwI0Ci;
        "pkg-1.33.1_Fabric_1.16.5" = _VigDSi15;
        "pkg-1.33.1_Forge_1.16.5" = _MPK4lZDY;
        "pkg-1.33.1_Fabric_1.17.1" = _LRc3Y10v;
        "pkg-1.33.1_Forge_1.17.1" = _hpfgHHVi;
        "pkg-1.33.1_Fabric_1.18.2" = _zf7etcWk;
        "pkg-1.33.1_Forge_1.18.2" = _AY8nPexE;
        "pkg-1.33.1_Fabric_1.19.1" = _UsGIMJ2a;
        "pkg-1.33.1_Forge_1.19.1" = _ya5ZYXkT;
        "pkg-1.33.1_Fabric_1.19.3" = _Ewl9bPOE;
        "pkg-1.33.1_Forge_1.19.3" = _IcOoY3Fd;
        "pkg-1.33.1_Fabric_1.19.4" = _meEp9J6P;
        "pkg-1.33.1_Forge_1.19.4" = _Gt36xu4p;
        "pkg-1.33.1_Fabric_1.20" = _4PJpJJKj;
        "pkg-1.33.1_Forge_1.20" = _9MHP5TQr;
        "pkg-1.34.0_Forge_1.12" = _FdU3tGYq;
        "pkg-1.34.0_Fabric_1.16.5" = _s3sEjbJu;
        "pkg-1.34.0_Forge_1.16.5" = _oaiGf0Cu;
        "pkg-1.34.0_Fabric_1.17.1" = _cADC7mM3;
        "pkg-1.34.0_Forge_1.17.1" = _yR1boAvN;
        "pkg-1.34.0_Fabric_1.18.2" = _sGllzk9n;
        "pkg-1.34.0_Forge_1.18.2" = _KIkNJRts;
        "pkg-1.34.0_Fabric_1.19.1" = _MXSnuNhR;
        "pkg-1.34.0_Forge_1.19.1" = _B7LODzZb;
        "pkg-1.34.0_Fabric_1.19.3" = _BwjsEkNB;
        "pkg-1.34.0_Forge_1.19.3" = _meCK7hiK;
        "pkg-1.34.0_Fabric_1.19.4" = _LAQjDJ8V;
        "pkg-1.34.0_Forge_1.19.4" = _qBDuRkrp;
        "pkg-1.34.0_Fabric_1.20" = _qwwKbodF;
        "pkg-1.34.0_Forge_1.20" = _BiotZhgQ;
        "pkg-1.34.1_Forge_1.12" = _d4huXt8W;
        "pkg-1.29.14_Forge_1.14.4" = _fqMxbyZW;
        "pkg-1.29.14_Forge_1.15.2" = _barq59Fe;
        "pkg-1.34.1_Fabric_1.16.5" = _X7q6wKAa;
        "pkg-1.34.1_Forge_1.16.5" = _LhxmKjwV;
        "pkg-1.34.1_Fabric_1.17.1" = _jd9dVlUv;
        "pkg-1.34.1_Forge_1.17.1" = _bXAJZFnX;
        "pkg-1.34.1_Fabric_1.18.2" = _zspa7tIH;
        "pkg-1.34.1_Forge_1.18.2" = _L8dZ06qE;
        "pkg-1.34.1_Fabric_1.19.1" = _ZXboExuA;
        "pkg-1.34.1_Forge_1.19.1" = _8T5rJSHX;
        "pkg-1.34.1_Fabric_1.19.3" = _brFplhUj;
        "pkg-1.34.1_Forge_1.19.3" = _uUljlh4i;
        "pkg-1.34.1_Fabric_1.19.4" = _hGDx5zLv;
        "pkg-1.34.1_Forge_1.19.4" = _sxZdfXgX;
        "pkg-1.34.1_Fabric_1.20" = _L8OA3xGI;
        "pkg-1.34.1_Forge_1.20" = _KNjZUbV2;
        "pkg-1.34.1_Fabric_1.20.2" = _6SwHv13Z;
        "pkg-1.34.1_Forge_1.20.2" = _uiSJusOM;
        "pkg-1.29.15_Forge_1.14.4" = _VmrZJY6Y;
        "pkg-1.29.15_Forge_1.15.2" = _1osfTlLs;
        "pkg-1.35.0_Forge_1.16.5" = _6xmgf5vv;
        "pkg-1.35.0_Fabric_1.16.5" = _PRpy2It3;
        "pkg-1.35.0_Forge_1.17.1" = _Cay35u2J;
        "pkg-1.35.0_Fabric_1.17.1" = _ltXk1K5K;
        "pkg-1.35.0_Forge_1.18.2" = _StYfRS5U;
        "pkg-1.35.0_Fabric_1.18.2" = _dvJ1c1nB;
        "pkg-1.35.0_Forge_1.19.1" = _3wGicfCz;
        "pkg-1.35.0_Fabric_1.19.1" = _TVqZB00s;
        "pkg-1.35.0_Forge_1.19.3" = _Z4GCDEhd;
        "pkg-1.35.0_Fabric_1.19.3" = _HuhuMQWY;
        "pkg-1.35.0_Forge_1.19.4" = _hs87cQxS;
        "pkg-1.35.0_Fabric_1.19.4" = _oTjgUXpl;
        "pkg-1.35.0_Forge_1.20" = _xq92bHt9;
        "pkg-1.35.0_Fabric_1.20" = _Qdu4Ovks;
        "pkg-1.35.0_Forge_1.20.2" = _IZjA414Z;
        "pkg-1.35.0_Fabric_1.20.2" = _oN97q1bh;
        "pkg-1.35.0_Forge_1.12" = _lfPTckFu;
        "pkg-1.36.0_Forge_1.12" = _QplwCTjy;
        "pkg-1.36.0_Forge_1.16.5" = _aKH41jFn;
        "pkg-1.36.0_Fabric_1.16.5" = _kl5ajjgu;
        "pkg-1.36.0_Forge_1.17.1" = _1hNBoopU;
        "pkg-1.36.0_Fabric_1.17.1" = _6QJf3buJ;
        "pkg-1.36.0_Forge_1.18.2" = _uMnSnV0V;
        "pkg-1.36.0_Fabric_1.18.2" = _l3AnBhDH;
        "pkg-1.36.0_Forge_1.19.1" = _x4c779Gp;
        "pkg-1.36.0_Fabric_1.19.1" = _nzTSf2JK;
        "pkg-1.36.0_Forge_1.19.3" = _40ySYXm7;
        "pkg-1.36.0_Fabric_1.19.3" = _O4jmfApS;
        "pkg-1.36.0_Forge_1.19.4" = _UqlV90K2;
        "pkg-1.36.0_Fabric_1.19.4" = _gwxBAfOC;
        "pkg-1.36.0_Forge_1.20" = _lsh7rZ8c;
        "pkg-1.36.0_Fabric_1.20" = _s974wWCK;
        "pkg-1.36.0_Forge_1.20.2" = _ieGewWWJ;
        "pkg-1.36.0_Fabric_1.20.2" = _IWg1Z5mJ;
        "pkg-1.14.1.30_Forge_1.7.10" = _Iv9NE033;
        "pkg-1.14.1.30_Forge_1.8.9" = _Ddl7ujqW;
        "pkg-1.37.0_Forge_1.12" = _9bIsTbhi;
        "pkg-1.29.16_Forge_1.14.4" = _Gt0oFz5j;
        "pkg-1.29.16_Forge_1.15.2" = _JUuQgvs3;
        "pkg-1.37.0_Forge_1.16.5" = _sa3FXIiF;
        "pkg-1.37.0_Fabric_1.16.5" = _JaxVlPsg;
        "pkg-1.37.0_Forge_1.17.1" = _tvv1p8UB;
        "pkg-1.37.0_Fabric_1.17.1" = _zNVieoBv;
        "pkg-1.37.0_Forge_1.18.2" = _85zESh2n;
        "pkg-1.37.0_Fabric_1.18.2" = _4VrpnEqL;
        "pkg-1.37.0_Forge_1.19.1" = _MoJ7DlPb;
        "pkg-1.37.0_Fabric_1.19.1" = _pdz4XbYo;
        "pkg-1.37.0_Forge_1.19.3" = _euUlUJpL;
        "pkg-1.37.0_Fabric_1.19.3" = _kDPMXqXY;
        "pkg-1.37.0_Forge_1.19.4" = _gqWWu2WE;
        "pkg-1.37.0_Fabric_1.19.4" = _uL35xaJ6;
        "pkg-1.37.0_Forge_1.20" = _5T11KDuL;
        "pkg-1.37.0_Fabric_1.20" = _upEWzPL7;
        "pkg-1.37.0_Forge_1.20.2" = _L1Msjf2g;
        "pkg-1.37.0_Fabric_1.20.2" = _z6UXt0JA;
        "pkg-1.37.1_Forge_1.12" = _hcqJ2uM8;
        "pkg-1.37.1_Forge_1.16.5" = _d0SZkNdX;
        "pkg-1.37.1_Fabric_1.16.5" = _HVD97oSC;
        "pkg-1.37.1_Forge_1.17.1" = _OnC2mDuc;
        "pkg-1.37.1_Fabric_1.17.1" = _87qG0mcP;
        "pkg-1.37.1_Forge_1.18.2" = _yDfrbwvP;
        "pkg-1.37.1_Fabric_1.18.2" = _5IAIDmsq;
        "pkg-1.37.1_Forge_1.19.1" = _1HegG6vB;
        "pkg-1.37.1_Fabric_1.19.1" = _uUqFPVSu;
        "pkg-1.37.1_Forge_1.19.3" = _JTWdwJAT;
        "pkg-1.37.1_Fabric_1.19.3" = _FbRcjoyo;
        "pkg-1.37.1_Forge_1.19.4" = _KzNPPRKZ;
        "pkg-1.37.1_Fabric_1.19.4" = _2OrOlxct;
        "pkg-1.37.1_Forge_1.20" = _QZQIip0l;
        "pkg-1.37.1_Fabric_1.20" = _2xFoqT9G;
        "pkg-1.37.1_Forge_1.20.2" = _8kyPSsV3;
        "pkg-1.37.1_Fabric_1.20.2" = _GjpvNeP5;
        "pkg-1.37.1_Fabric_1.20.3" = _4Vb09gB8;
        "pkg-1.37.2_Forge_1.19.1" = _KS3vBQ5i;
        "pkg-1.37.2_Fabric_1.19.1" = _NPmEADqc;
        "pkg-1.37.2_Forge_1.19.3" = _Psy5QyFF;
        "pkg-1.37.2_Fabric_1.19.3" = _GVhMC0jF;
        "pkg-1.37.2_Forge_1.19.4" = _WcfeRtsW;
        "pkg-1.37.2_Fabric_1.19.4" = _fDOxFLoy;
        "pkg-1.37.2_Forge_1.20" = _5I2xTj1b;
        "pkg-1.37.2_Fabric_1.20" = _EKlLbMF8;
        "pkg-1.37.2_Forge_1.20.2" = _HAWkglLj;
        "pkg-1.37.2_Fabric_1.20.2" = _TiU9A6SF;
        "pkg-1.37.2_Fabric_1.20.3" = _QPu5GIcD;
        "pkg-1.37.3_Forge_1.16.5" = _2DyPoOss;
        "pkg-1.37.3_Fabric_1.16.5" = _SEcAUikr;
        "pkg-1.37.3_Forge_1.17.1" = _HuNUxJTs;
        "pkg-1.37.3_Fabric_1.17.1" = _F61FCdMV;
        "pkg-1.37.3_Forge_1.18.2" = _AJD2gqOd;
        "pkg-1.37.3_Fabric_1.18.2" = _jZxGCO8l;
        "pkg-1.37.4_Forge_1.16.5" = _ICOE9Jsf;
        "pkg-1.37.4_Fabric_1.16.5" = _mWKcgDr7;
        "pkg-1.37.4_Forge_1.17.1" = _HZe0cLXw;
        "pkg-1.37.4_Fabric_1.17.1" = _g3LVdy2b;
        "pkg-1.37.4_Forge_1.20.4" = _hRVLy1VO;
        "pkg-1.37.4_Fabric_1.20.4" = _MCZrzmFk;
        "pkg-1.37.5_Forge_1.20.4" = _Ryqih9p9;
        "pkg-1.37.5_Fabric_1.20.4" = _77dzlHmz;
        "pkg-1.37.6_Forge_1.20.4" = _CFdDfVmy;
        "pkg-1.37.6_Fabric_1.20.4" = _UXPdKH9b;
        "pkg-1.14.1.31_Forge_1.7.10" = _Je9Rk4Cx;
        "pkg-1.14.1.31_Forge_1.8.9" = _HQ3gb7de;
        "pkg-1.37.7_Forge_1.12" = _j5uMM0Wj;
        "pkg-1.29.17_Forge_1.14.4" = _3FwkAdEs;
        "pkg-1.29.17_Forge_1.15.2" = _6OGNVOoZ;
        "pkg-1.37.7_Forge_1.16.5" = _ePZhBAIZ;
        "pkg-1.37.7_Fabric_1.16.5" = _ExJndpW1;
        "pkg-1.37.7_Forge_1.17.1" = _QfdogwsK;
        "pkg-1.37.7_Fabric_1.17.1" = _yvmI3XeP;
        "pkg-1.37.7_Forge_1.18.2" = _npXTx5pr;
        "pkg-1.37.7_Fabric_1.18.2" = _ZjP3Pq4E;
        "pkg-1.37.7_Forge_1.19.1" = _s8cocuZd;
        "pkg-1.37.7_Fabric_1.19.1" = _jJPQdz1d;
        "pkg-1.37.7_Forge_1.19.3" = _WM0TXybx;
        "pkg-1.37.7_Fabric_1.19.3" = _IALYw1J1;
        "pkg-1.37.7_Forge_1.19.4" = _U2fOYiyl;
        "pkg-1.37.7_Fabric_1.19.4" = _dOXO1ekR;
        "pkg-1.37.7_Forge_1.20" = _PPNXdlNm;
        "pkg-1.37.7_Fabric_1.20" = _sldtuPfE;
        "pkg-1.37.7_Forge_1.20.2" = _DuHuZP6A;
        "pkg-1.37.7_Fabric_1.20.2" = _CpzbT4d9;
        "pkg-1.37.7_Forge_1.20.4" = _TlqcsW0P;
        "pkg-1.37.7_Fabric_1.20.4" = _IwNGlfAn;
        "pkg-1.37.8_Forge_1.12" = _H8LUoNB8;
        "pkg-1.37.8_Forge_1.16.5" = _ABCY32pi;
        "pkg-1.37.8_Fabric_1.16.5" = _7jiibugv;
        "pkg-1.37.8_Forge_1.17.1" = _pJR2Fqwm;
        "pkg-1.37.8_Fabric_1.17.1" = _X5l3pEeo;
        "pkg-1.37.8_Forge_1.18.2" = _NmoZgLkN;
        "pkg-1.37.8_Fabric_1.18.2" = _YEqpZsUQ;
        "pkg-1.37.8_Forge_1.19.1" = _Uh6rOrCb;
        "pkg-1.37.8_Fabric_1.19.1" = _MGnsRoAP;
        "pkg-1.37.8_Forge_1.20" = _iIHx8eFi;
        "pkg-1.37.8_Fabric_1.20" = _RR2qcEow;
        "pkg-1.37.8_Forge_1.20.2" = _Q2LjAXwj;
        "pkg-1.37.8_Fabric_1.20.2" = _MtYKhP1z;
        "pkg-1.37.8_Forge_1.20.4" = _BtByX33T;
        "pkg-1.37.8_Fabric_1.20.4" = _Kh1mGgGA;
        "pkg-1.37.8_Forge_1.19.3" = _5srNwTQr;
        "pkg-1.37.8_Fabric_1.19.3" = _p3T8tHy4;
        "pkg-1.37.8_Forge_1.19.4" = _1ikSvyiV;
        "pkg-1.37.8_Fabric_1.19.4" = _4PRqBjBF;
        "pkg-1.38.0_NeoForge_1.20.2" = _iGtiHsDe;
        "pkg-1.38.0_NeoForge_1.20.4" = _JPaMO5d0;
        "pkg-1.38.1_Forge_1.12" = _cBiMvAnH;
        "pkg-1.38.1_Forge_1.16.5" = _GtKdDJ5k;
        "pkg-1.38.1_Fabric_1.16.5" = _Nl5li4IQ;
        "pkg-1.38.1_Forge_1.18.2" = _bmskYajG;
        "pkg-1.38.1_Fabric_1.18.2" = _RWQIMBFG;
        "pkg-1.38.1_Forge_1.19.1" = _WRAhRsV0;
        "pkg-1.38.1_Fabric_1.19.1" = _q81YjdCr;
        "pkg-1.38.1_Forge_1.19.4" = _XjvUIj7a;
        "pkg-1.38.1_Fabric_1.19.4" = _J3gWZ9Y7;
        "pkg-1.38.1_Forge_1.20" = _O8WpvCPU;
        "pkg-1.38.1_Fabric_1.20" = _RtG1V19k;
        "pkg-1.38.1_Forge_1.20.2" = _FfOlqaAa;
        "pkg-1.38.1_NeoForge_1.20.2" = _e4KxqQmi;
        "pkg-1.38.1_Fabric_1.20.2" = _bNTafyGZ;
        "pkg-1.38.1_Forge_1.20.4" = _Us1KN3KZ;
        "pkg-1.38.1_NeoForge_1.20.4" = _EEi7fSTX;
        "pkg-1.38.1_Fabric_1.20.4" = _2lbtkEPK;
        "pkg-1.38.2_NeoForge_1.20.2" = _IhXA8B6k;
        "pkg-1.38.2_NeoForge_1.20.4" = _St8x5BIB;
        "pkg-1.38.3_Forge_1.12" = _pFoenNHf;
        "pkg-1.38.3_Forge_1.16.5" = _qI7epCX8;
        "pkg-1.38.3_Fabric_1.16.5" = _bgYKlna4;
        "pkg-1.38.3_Forge_1.18.2" = _if8HUfC3;
        "pkg-1.38.3_Fabric_1.18.2" = _bQjVTElj;
        "pkg-1.38.3_Forge_1.19.1" = _w2I1xBkt;
        "pkg-1.38.3_Fabric_1.19.1" = _HvnvVG2s;
        "pkg-1.38.3_Forge_1.19.4" = _XAHaH8pE;
        "pkg-1.38.3_Fabric_1.19.4" = _U7wvj4vx;
        "pkg-1.38.3_Forge_1.20" = _zkV9MzSO;
        "pkg-1.38.3_Fabric_1.20" = _1ZFOZLG2;
        "pkg-1.38.3_Forge_1.20.2" = _VyOfCLta;
        "pkg-1.38.3_NeoForge_1.20.2" = _vafIGO2B;
        "pkg-1.38.3_Fabric_1.20.2" = _RVSNzF7P;
        "pkg-1.38.3_Forge_1.20.4" = _iKOa7p2o;
        "pkg-1.38.3_NeoForge_1.20.4" = _dg8z2kP4;
        "pkg-1.38.3_Fabric_1.20.4" = _xoWyMT9q;
        "pkg-1.38.4_Forge_1.12" = _TyOkVRGf;
        "pkg-1.38.4_Forge_1.16.5" = _r6XMA06U;
        "pkg-1.38.4_Fabric_1.16.5" = _mTb5Uwa7;
        "pkg-1.38.4_Forge_1.18.2" = _6SatxhGZ;
        "pkg-1.38.4_Fabric_1.18.2" = _n9H74LC6;
        "pkg-1.38.4_Forge_1.19.1" = _x7A0grqn;
        "pkg-1.38.4_Fabric_1.19.1" = _AFdUAvnz;
        "pkg-1.38.4_Forge_1.19.4" = _RsuHrSG8;
        "pkg-1.38.4_Fabric_1.19.4" = _cWnkuNpP;
        "pkg-1.38.4_Forge_1.20" = _oE23WzAY;
        "pkg-1.38.4_Fabric_1.20" = _GOh0fFoJ;
        "pkg-1.38.4_Forge_1.20.2" = _J9mEyGH5;
        "pkg-1.38.4_NeoForge_1.20.2" = _XkNgPSrY;
        "pkg-1.38.4_Fabric_1.20.2" = _vtaHEcnA;
        "pkg-1.38.4_Forge_1.20.4" = _Hr1YuotO;
        "pkg-1.38.4_NeoForge_1.20.4" = _ExBGHO1W;
        "pkg-1.38.4_Fabric_1.20.4" = _ciwrnpWQ;
        "pkg-1.38.5_NeoForge_1.20.5" = _evqhhzq1;
        "pkg-1.38.5_Fabric_1.20.5" = _Jm03NtYN;
        "pkg-1.38.6_NeoForge_1.20.5" = _4fHhiA9l;
        "pkg-1.38.6_Fabric_1.20.5" = _aWXGiFVe;
        "pkg-1.38.7_Forge_1.20.6" = _s7fGI5DL;
        "pkg-1.38.8_Forge_1.12" = _3vzQ401W;
        "pkg-1.38.8_Forge_1.16.5" = _M8lZ4YIm;
        "pkg-1.38.8_Forge_1.18.2" = _fccjP3vg;
        "pkg-1.38.8_Fabric_1.16.5" = _I7KNlIg7;
        "pkg-1.38.8_Fabric_1.18.2" = _3gmYeL8R;
        "pkg-1.38.8_Forge_1.19.1" = _BAn3pfXW;
        "pkg-1.38.8_Fabric_1.19.1" = _zpobQtXe;
        "pkg-1.38.8_Forge_1.19.4" = _UjH1bY5n;
        "pkg-1.38.8_Fabric_1.19.4" = _bId5K1EM;
        "pkg-1.38.8_Forge_1.20" = _3t3qLyne;
        "pkg-1.38.8_Fabric_1.20" = _szULGs3b;
        "pkg-1.38.8_Forge_1.20.2" = _7GXAUIxr;
        "pkg-1.38.8_NeoForge_1.20.2" = _AbWgvZZP;
        "pkg-1.38.8_Fabric_1.20.2" = _SMSdfLOQ;
        "pkg-1.38.8_Forge_1.20.4" = _5b38pJEY;
        "pkg-1.38.8_NeoForge_1.20.4" = _crPAx75v;
        "pkg-1.38.8_Fabric_1.20.4" = _jEhoJmNF;
        "pkg-1.38.8_Forge_1.20.6" = _YQeKG80h;
        "pkg-1.38.8_NeoForge_1.20.6" = _wz5E39j6;
        "pkg-1.38.8_Fabric_1.20.6" = _o7mEAkNb;
        "pkg-1.38.8_Forge_1.21" = _RQgvSMA6;
        "pkg-1.38.8_NeoForge_1.21" = _8BhyyEg5;
        "pkg-1.38.8_Fabric_1.21" = _ekubtdIk;
        "pkg-1.38.9_NeoForge_1.21" = _lMUs7SBz;
        "pkg-1.14.1.32_Forge_1.7.10" = _1uFpEKws;
        "pkg-1.39.0_Forge_1.12" = _hP5kHldJ;
        "pkg-1.39.0_Forge_1.16.5" = _xbvYzERq;
        "pkg-1.39.0_Fabric_1.16.5" = _Lt7swdr9;
        "pkg-1.39.0_Forge_1.18.2" = _KiIv6hQq;
        "pkg-1.39.0_Fabric_1.18.2" = _HzSRFxAE;
        "pkg-1.39.0_Forge_1.19.1" = _SFDBRBOn;
        "pkg-1.39.0_Fabric_1.19.1" = _BfwRgizH;
        "pkg-1.39.0_Forge_1.19.4" = _iEYShfqE;
        "pkg-1.39.0_Fabric_1.19.4" = _NjWGj3l5;
        "pkg-1.39.0_Forge_1.20" = _zGpACLsy;
        "pkg-1.39.0_Fabric_1.20" = _gJ5N7s4J;
        "pkg-1.39.0_Forge_1.20.2" = _AqvVkOEh;
        "pkg-1.39.0_NeoForge_1.20.2" = _w2c6YQi0;
        "pkg-1.39.0_Fabric_1.20.2" = _2hgwAzK4;
        "pkg-1.39.0_Forge_1.20.4" = _4wpqpTdW;
        "pkg-1.39.0_NeoForge_1.20.4" = _o1GWmvc1;
        "pkg-1.39.0_Fabric_1.20.4" = _WiqHosal;
        "pkg-1.39.0_Forge_1.20.6" = _v64Rs5BB;
        "pkg-1.39.0_NeoForge_1.20.6" = _lJZsx6hC;
        "pkg-1.39.0_Fabric_1.20.6" = _vrwtAna0;
        "pkg-1.39.0_Forge_1.21" = _L4yqkY0L;
        "pkg-1.39.0_NeoForge_1.21" = _DJAg0pKL;
        "pkg-1.39.0_Fabric_1.21" = _373K4YJh;
        "pkg-1.39.1_Forge_1.21.3" = _ZZQufzKO;
        "pkg-1.39.1_NeoForge_1.21.3" = _ucnDKqph;
        "pkg-1.39.1_Fabric_1.21.3" = _c1X0YcPG;
        "pkg-1.39.1_NeoForge_1.21.4" = _ga1rXP6K;
        "pkg-1.39.1_Fabric_1.21.4" = _2KJYmhQu;
        "pkg-1.39.1_Forge_1.21.4" = _1RrcyMuw;
        "pkg-1.14.1.33_Forge_1.7.10" = _p1yJWyyU;
        "pkg-1.39.2_Forge_1.12" = _jdLzoEBa;
        "pkg-1.39.2_Forge_1.16.5" = _R01HDhyJ;
        "pkg-1.39.2_Fabric_1.16.5" = _WrE08iiB;
        "pkg-1.39.2_Forge_1.18.2" = _QJtxhNxE;
        "pkg-1.39.2_Fabric_1.18.2" = _xX4O8Ot5;
        "pkg-1.39.2_Forge_1.19.1" = _miqnnVvu;
        "pkg-1.39.2_Forge_1.19.4" = _GJ6iDee1;
        "pkg-1.39.2_Fabric_1.19.4" = _415wkunH;
        "pkg-1.39.2_Forge_1.20" = _3Wmpi0tR;
        "pkg-1.39.2_Fabric_1.20" = _VXCG8MnU;
        "pkg-1.39.2_Forge_1.20.2" = _GC4tOmEH;
        "pkg-1.39.2_NeoForge_1.20.2" = _KppSm7wq;
        "pkg-1.39.2_Fabric_1.20.2" = _ZRMqHBcD;
        "pkg-1.39.2_Forge_1.20.4" = _K8F9fVXe;
        "pkg-1.39.2_NeoForge_1.20.4" = _oE4hCtyT;
        "pkg-1.39.2_Fabric_1.20.4" = _giiirWF1;
        "pkg-1.39.2_Forge_1.20.6" = _d7DwxPiK;
        "pkg-1.39.2_NeoForge_1.20.6" = _UvmWs8Aa;
        "pkg-1.39.2_Fabric_1.20.6" = _LQFoEfvj;
        "pkg-1.39.2_Forge_1.21" = _fTuEYssZ;
        "pkg-1.39.2_NeoForge_1.21" = _un0ESOFp;
        "pkg-1.39.2_Fabric_1.21" = _2QD9OoBs;
        "pkg-1.39.2_Forge_1.21.3" = _J6vtENAU;
        "pkg-1.39.2_NeoForge_1.21.3" = _ltbaN5Mi;
        "pkg-1.39.2_Fabric_1.21.3" = _qsqkUqNm;
        "pkg-1.39.2_Forge_1.21.4" = _rDnTFAF9;
        "pkg-1.39.2_NeoForge_1.21.4" = _qwwQABCa;
        "pkg-1.39.2_Fabric_1.21.4" = _BnFw7PFl;
        "pkg-1.39.2_Fabric_1.19.1" = _ylzqEmTN;
        "pkg-1.39.3_Forge_1.21.4" = _cjLPw4DJ;
        "pkg-1.39.3_NeoForge_1.21.4" = _M1QczmdG;
        "pkg-1.39.3_Fabric_1.21.4" = _ZCnPlX1N;
        "pkg-1.39.4_Forge_1.12" = _YN85EjnS;
        "pkg-1.39.4_Forge_1.16.5" = _uElnaPYf;
        "pkg-1.39.4_Fabric_1.16.5" = _1IYsXPwJ;
        "pkg-1.39.4_Forge_1.18.2" = _mgRfEP1g;
        "pkg-1.39.4_Fabric_1.18.2" = _x7KG4JWe;
        "pkg-1.39.4_Forge_1.19.1" = _f3Fejr42;
        "pkg-1.39.4_Fabric_1.19.1" = _UIb1VQq8;
        "pkg-1.39.4_Forge_1.19.4" = _A3pXhcaN;
        "pkg-1.39.4_Fabric_1.19.4" = _4mPW6mVd;
        "pkg-1.39.4_Forge_1.20" = _SMViC4Yw;
        "pkg-1.39.4_Fabric_1.20" = _Fwao7ZwU;
        "pkg-1.39.4_Forge_1.20.2" = _tdpW0nbL;
        "pkg-1.39.4_NeoForge_1.20.2" = _nTUoT1Se;
        "pkg-1.39.4_Fabric_1.20.2" = _uyMEo5sR;
        "pkg-1.39.4_Forge_1.20.4" = _mE0XYS8a;
        "pkg-1.39.4_NeoForge_1.20.4" = _Ws01zo7D;
        "pkg-1.39.4_Fabric_1.20.4" = _Gvqo7ln0;
        "pkg-1.39.4_Forge_1.20.6" = _z7r9CUhG;
        "pkg-1.39.4_NeoForge_1.20.6" = _WXUAyjyU;
        "pkg-1.39.4_Fabric_1.20.6" = _55yE58dQ;
        "pkg-1.39.4_Forge_1.21" = _MWhRvFD4;
        "pkg-1.39.4_NeoForge_1.21" = _JlPz5UbU;
        "pkg-1.39.4_Fabric_1.21" = _V6mteZg9;
        "pkg-1.39.4_Forge_1.21.3" = _Bw1yZdvk;
        "pkg-1.39.4_NeoForge_1.21.3" = _V7jkqREe;
        "pkg-1.39.4_Fabric_1.21.3" = _2O7E8f9x;
        "pkg-1.39.4_Forge_1.21.4" = _seaXxazi;
        "pkg-1.39.4_NeoForge_1.21.4" = _8rYFL1jh;
        "pkg-1.39.4_Fabric_1.21.4" = _fh7IHLqi;
        "pkg-1.39.5_Forge_1.21.5" = _njnVJzjU;
        "pkg-1.39.5_NeoForge_1.21.5" = _St7J6Nt7;
        "pkg-1.39.5_Fabric_1.21.5" = _tTwGwMYJ;
        "pkg-1.39.6_Forge_1.21.5" = _3VlgGE9Z;
        "pkg-1.39.6_NeoForge_1.21.5" = _8RE7gn2n;
        "pkg-1.39.6_Fabric_1.21.5" = _sbM533IS;
        "pkg-1.39.7_Forge_1.21.5" = _RIXi9p66;
        "pkg-1.39.7_NeoForge_1.21.5" = _MvHZ0Azj;
        "pkg-1.39.7_Fabric_1.21.5" = _gTFNqHfP;
        "pkg-1.39.8_Forge_1.21.5" = _Te5493bu;
        "pkg-1.39.8_NeoForge_1.21.5" = _4J5T4aOn;
        "pkg-1.39.8_Fabric_1.21.5" = _dh8PNs35;
        "pkg-1.39.9_Forge_1.12" = _nGAfUDXZ;
        "pkg-1.39.9_Forge_1.16.5" = _vzHrHRAP;
        "pkg-1.39.9_Fabric_1.16.5" = _VwGdu25E;
        "pkg-1.39.9_Forge_1.18.2" = _xobmPoCK;
        "pkg-1.39.9_Fabric_1.18.2" = _jha2FPRN;
        "pkg-1.39.9_Forge_1.19.1" = _4bmg6KHj;
        "pkg-1.39.9_Fabric_1.19.1" = _mB0EThxL;
        "pkg-1.39.9_Forge_1.19.4" = _XY2P9nb2;
        "pkg-1.39.9_Fabric_1.19.4" = _wxImC1PV;
        "pkg-1.39.9_Forge_1.20" = _yCVWJ9aK;
        "pkg-1.39.9_Fabric_1.20" = _fQpXYWtL;
        "pkg-1.39.9_Forge_1.20.2" = _ZfnQgx3J;
        "pkg-1.39.9_NeoForge_1.20.2" = _TPZTTqhn;
        "pkg-1.39.9_Fabric_1.20.2" = _Bv4RqLGS;
        "pkg-1.39.9_Forge_1.20.4" = _CVSEe3Ei;
        "pkg-1.39.9_NeoForge_1.20.4" = _RWLd0Hga;
        "pkg-1.39.9_Fabric_1.20.4" = _oWeojQbL;
        "pkg-1.39.9_Forge_1.20.6" = _iqqyJZrS;
        "pkg-1.39.9_NeoForge_1.20.6" = _EE7SEMHo;
        "pkg-1.39.9_Fabric_1.20.6" = _AAf6VHCA;
        "pkg-1.39.9_Forge_1.21" = _mzMqL3nr;
        "pkg-1.39.9_NeoForge_1.21" = _Lt2vbZZU;
        "pkg-1.39.9_Fabric_1.21" = _3XtBvLkH;
        "pkg-1.39.9_Forge_1.21.3" = _i3y3InrS;
        "pkg-1.39.9_NeoForge_1.21.3" = _xVPvNyGI;
        "pkg-1.39.9_Fabric_1.21.3" = _3wr9bSt3;
        "pkg-1.39.9_Forge_1.21.4" = _fuNwI454;
        "pkg-1.39.9_NeoForge_1.21.4" = _PoYsXhFj;
        "pkg-1.39.9_Fabric_1.21.4" = _IwHUiJcm;
        "pkg-1.39.9_Forge_1.21.5" = _CRSRFh38;
        "pkg-1.39.9_NeoForge_1.21.5" = _okSonBNz;
        "pkg-1.39.9_Fabric_1.21.5" = _NFdP28cA;
        "pkg-1.39.10_Forge_1.21.4" = _ZB7YiAnl;
        "pkg-1.39.10_NeoForge_1.21.4" = _1ZZWBkCb;
        "pkg-1.39.10_Fabric_1.21.4" = _jteBEyr4;
        "pkg-1.39.10_Forge_1.21.5" = _K9TYts37;
        "pkg-1.39.10_NeoForge_1.21.5" = _VaCeM4TQ;
        "pkg-1.39.10_Fabric_1.21.5" = _aTmhJVkq;
        "pkg-1.39.10_NeoForge_1.21.6" = _Mkyh5No1;
        "pkg-1.39.10_Fabric_1.21.6" = _g8WcXZg9;
        "pkg-1.39.11_NeoForge_1.21.6" = _qpxTn9xO;
        "pkg-1.39.11_Forge_1.21.7" = _kSu3kNhS;
        "pkg-1.39.11_NeoForge_1.21.7" = _WUK9mk1C;
        "pkg-1.39.12_Forge_1.21.7" = _75DL0q3D;
        "pkg-1.39.12_NeoForge_1.21.7" = _VbeKJj86;
        "pkg-1.39.12_Fabric_1.21.7" = _3Lv1hpHj;
        "pkg-1.39.12_Forge_1.12" = _xDLDu1sT;
        "pkg-1.39.12_Forge_1.16.5" = _yVz7Bzem;
        "pkg-1.39.12_Fabric_1.16.5" = _t4m1Ad1t;
        "pkg-1.39.12_Forge_1.18.2" = _1V4EDBvz;
        "pkg-1.39.12_Fabric_1.18.2" = _QeSQZynU;
        "pkg-1.39.12_Forge_1.19.1" = _v0vH7Baf;
        "pkg-1.39.12_Fabric_1.19.1" = _rqRKVq55;
        "pkg-1.39.12_Forge_1.19.4" = _o2x00FuF;
        "pkg-1.39.12_Fabric_1.19.4" = _Zs1k6oKV;
        "pkg-1.39.12_Forge_1.20" = _ATTRzxT3;
        "pkg-1.39.12_Fabric_1.20" = _XBgSFzXh;
        "pkg-1.39.12_NeoForge_1.20.2" = _md6AR8fT;
        "pkg-1.39.12_Forge_1.20.2" = _cdp9dUvQ;
        "pkg-1.39.12_Fabric_1.20.2" = _qus1H9JU;
        "pkg-1.39.12_NeoForge_1.20.4" = _W72P7nHp;
        "pkg-1.39.12_Forge_1.20.4" = _MRZgMsde;
        "pkg-1.39.12_Fabric_1.20.4" = _3gg1D980;
        "pkg-1.39.12_NeoForge_1.20.6" = _pFqKDLgq;
        "pkg-1.39.12_Fabric_1.20.6" = _EmIpPLsW;
        "pkg-1.39.12_NeoForge_1.21" = _3WghnUq9;
        "pkg-1.39.12_Forge_1.21" = _hDN6KPLA;
        "pkg-1.39.12_Fabric_1.21" = _HXRzzOuL;
        "pkg-1.39.12_NeoForge_1.21.3" = _GCcCujwd;
        "pkg-1.39.12_Forge_1.21.3" = _td5IbMR3;
        "pkg-1.39.12_Fabric_1.21.3" = _3bTfjm0x;
        "pkg-1.39.12_NeoForge_1.21.4" = _OU4FryfL;
        "pkg-1.39.12_Forge_1.21.4" = _NHBjZFoI;
        "pkg-1.39.12_Fabric_1.21.4" = _xF512qxI;
        "pkg-1.39.12_NeoForge_1.21.5" = _jljxH0Q4;
        "pkg-1.39.12_Forge_1.21.5" = _IEARX2p7;
        "pkg-1.39.12_Fabric_1.21.5" = _lqxiZOvq;
        "pkg-1.39.13_Forge_1.21.8" = _EgE2fB7F;
        "pkg-1.39.13_NeoForge_1.21.8" = _mSZmIESF;
        "pkg-1.39.13_Fabric_1.21.8" = _d1Pc1nIN;
        "pkg-1.39.14_NeoForge_1.21.8" = _2ijnq6xW;
        "pkg-1.39.12_Forge_1.20.6" = _lwdXY9pL;
        "pkg-1.39.15_Fabric_1.21.9" = _DiztNV9X;
        "pkg-1.39.16_NeoForge_1.21.9" = _Nm3A673b;
        "pkg-1.39.16_Fabric_1.21.9" = _cEKMweJE;
        "pkg-1.39.17_Forge_1.21.9" = _1rQl25Pe;
        "pkg-1.39.17_NeoForge_1.21.9" = _z6LXuCTe;
        "pkg-1.39.17_Fabric_1.21.9" = _81Qc21E2;
        "pkg-1.39.18_Forge_1.21.9" = _bMLq86wD;
        "pkg-1.40.0_NeoForge_1.21.11" = _GQvrkaMz;
        "pkg-1.40.0_Fabric_1.21.11" = _BUCrGWGz;
        "pkg-1.40.1_NeoForge_1.21.11" = _IslOYak7;
        "pkg-1.40.1_Fabric_1.21.11" = _BUssCfWp;
        "pkg-1.40.2_Forge_1.12" = _q83qIOD8;
        "pkg-1.40.2_Forge_1.16.5" = _fZvO2onr;
        "pkg-1.40.2_Fabric_1.16.5" = _JtVqprLh;
        "pkg-1.40.2_Forge_1.18.2" = _B8yMKjs8;
        "pkg-1.40.2_Fabric_1.18.2" = _3ZqcgeOB;
        "pkg-1.40.2_Forge_1.19.1" = _iyaHbnhs;
        "pkg-1.40.2_Fabric_1.19.1" = _MeUbkNXl;
        "pkg-1.40.2_Forge_1.20" = _U3stuFts;
        "pkg-1.40.2_Fabric_1.20" = _yckp3FUK;
        "pkg-1.40.2_NeoForge_1.20.4" = _1JsV9acA;
        "pkg-1.40.2_Forge_1.20.4" = _UyCY4hyv;
        "pkg-1.40.2_Fabric_1.20.4" = _qW3vBizb;
        "pkg-1.40.2_NeoForge_1.21" = _qZXRCPsg;
        "pkg-1.40.2_Forge_1.21" = _iczB7uaA;
        "pkg-1.40.2_Fabric_1.21" = _yz0BNgrU;
        "pkg-1.40.2_NeoForge_1.21.3" = _6uviDgHR;
        "pkg-1.40.2_Forge_1.21.3" = _xDCXOdK3;
        "pkg-1.40.2_Fabric_1.21.3" = _IQxZ7VdN;
        "pkg-1.40.2_NeoForge_1.21.4" = _YisCojiD;
        "pkg-1.40.2_Forge_1.21.4" = _KvO4GmBK;
        "pkg-1.40.2_Fabric_1.21.4" = _6dgKx4o1;
        "pkg-1.40.2_NeoForge_1.21.5" = _bzJJDQti;
        "pkg-1.40.2_Forge_1.21.5" = _w5T6KnmN;
        "pkg-1.40.2_Fabric_1.21.5" = _ExNL5EaA;
        "pkg-1.40.2_NeoForge_1.21.8" = _3DBTx8jK;
        "pkg-1.40.2_Forge_1.21.8" = _iN4wsqpF;
        "pkg-1.40.2_Fabric_1.21.8" = _b52t6kbY;
        "pkg-1.40.2_NeoForge_1.21.10" = _q1tu0yht;
        "pkg-1.40.2_Forge_1.21.10" = _fvlMQzqc;
        "pkg-1.40.2_Fabric_1.21.10" = _GsFkiGO4;
        "pkg-1.40.2_NeoForge_1.21.11" = _QkMYyZ41;
        "pkg-1.40.2_Fabric_1.21.11" = _3DZ5aNVp;
        "pkg-forge-1.12.2-1.40.5" = _v22BRQLe;
        "pkg-forge-1.16.5-1.40.5" = _2ChIY0d3;
        "pkg-fabric-1.16.5-1.40.5" = _10875HCe;
        "pkg-forge-1.18.2-1.40.4" = _Sk0CNJlB;
        "pkg-fabric-1.18.2-1.40.4" = _x3SuddMI;
        "pkg-forge-1.19.2-1.40.4" = _HIpwuCuJ;
        "pkg-fabric-1.19.2-1.40.4" = _ICkHAvBS;
        "pkg-forge-1.20.1-1.40.4" = _2cJBzazb;
        "pkg-neoforge-1.20.4-1.40.4" = _NKSENDJI;
        "pkg-forge-1.20.4-1.40.4" = _MWKaHgkn;
        "pkg-fabric-1.20.4-1.40.4" = _OUUxTm9e;
        "pkg-neoforge-1.21.1-1.40.4" = _Y3bNNKPI;
        "pkg-forge-1.21.1-1.40.4" = _qoLfIDZI;
        "pkg-fabric-1.21.1-1.40.4" = _c0aUvTvJ;
        "pkg-neoforge-1.21.3-1.40.4" = _w4TSDA8z;
        "pkg-forge-1.21.3-1.40.4" = _YwQdTQdc;
        "pkg-fabric-1.21.3-1.40.4" = _Rwr1zNuM;
        "pkg-neoforge-1.21.4-1.40.4" = _NcUmv6xd;
        "pkg-forge-1.21.4-1.40.4" = _zW4NDKug;
        "pkg-fabric-1.21.4-1.40.4" = _Xad1N8rE;
        "pkg-neoforge-1.21.5-1.40.4" = _gDA9Dn4l;
        "pkg-forge-1.21.5-1.40.4" = _q5ud16op;
        "pkg-fabric-1.21.5-1.40.4" = _mq78ebKa;
        "pkg-neoforge-1.21.8-1.40.4" = _AWLtwJQb;
        "pkg-forge-1.21.8-1.40.4" = _aG8QEurU;
        "pkg-fabric-1.21.8-1.40.4" = _k9Dubdew;
        "pkg-neoforge-1.21.10-1.40.4" = _LxtPmSrm;
        "pkg-forge-1.21.10-1.40.4" = _ikeqpyji;
        "pkg-fabric-1.21.10-1.40.4" = _OPZY24Bc;
        "pkg-neoforge-1.21.11-1.40.4" = _9Abymwth;
        "pkg-fabric-1.21.11-1.40.4" = _E5cY3E7H;
        "pkg-forge-1.12.2-1.40.6" = _Q2SlMdSS;
        "pkg-forge-1.16.5-1.40.6" = _k9qY9zkc;
        "pkg-fabric-1.16.5-1.40.6" = _pLHiMOKu;
        "pkg-forge-1.18.2-1.40.6" = _MMlc74lq;
        "pkg-fabric-1.18.2-1.40.6" = _v5EOunnY;
        "pkg-forge-1.19.2-1.40.6" = _bpprhXbD;
        "pkg-fabric-1.19.2-1.40.6" = _rDQ9QSz3;
        "pkg-forge-1.20.1-1.40.6" = _LYdIykWO;
        "pkg-fabric-1.20.1-1.40.6" = _qNqsa3I3;
        "pkg-neoforge-1.20.4-1.40.6" = _W5ucsKuY;
        "pkg-forge-1.20.4-1.40.6" = _9z5mIl7d;
        "pkg-fabric-1.20.4-1.40.6" = _YwlTyfWy;
        "pkg-neoforge-1.21.1-1.40.6" = _xUpTkg0V;
        "pkg-forge-1.21.1-1.40.6" = _fWPvYpfa;
        "pkg-fabric-1.21.1-1.40.6" = _hT5eHHLt;
        "pkg-neoforge-1.21.3-1.40.6" = _9jbkQNv5;
        "pkg-forge-1.21.3-1.40.6" = _4mEzwP8R;
        "pkg-fabric-1.21.3-1.40.6" = _Q38QtGku;
        "pkg-neoforge-1.21.4-1.40.6" = _YOdxub8L;
        "pkg-forge-1.21.4-1.40.6" = _N3V8YwcM;
        "pkg-fabric-1.21.4-1.40.6" = _L0UpL1lw;
        "pkg-neoforge-1.21.5-1.40.6" = _P8JNWn4E;
        "pkg-forge-1.21.5-1.40.6" = _A9T0CHQe;
        "pkg-fabric-1.21.5-1.40.6" = _nt4y1oi8;
        "pkg-neoforge-1.21.8-1.40.6" = _rFX8iy5j;
        "pkg-forge-1.21.8-1.40.6" = _oOC8msXm;
        "pkg-fabric-1.21.8-1.40.6" = _jhjh8t8E;
        "pkg-neoforge-1.21.10-1.40.6" = _uvHBayWO;
        "pkg-forge-1.21.10-1.40.6" = _7Lz7PuFi;
        "pkg-fabric-1.21.10-1.40.6" = _zrXMNlNx;
        "pkg-neoforge-1.21.11-1.40.6" = _K25cAKZJ;
        "pkg-fabric-1.21.11-1.40.6" = _Ljqxh4kI;
        "pkg-neoforge-1.21.4-1.40.7" = _1q8xceca;
        "pkg-forge-1.12.2-1.40.9" = _O7ngMaOM;
        "pkg-forge-1.16.5-1.40.9" = _F2FReJWg;
        "pkg-forge-1.18.2-1.40.8" = _w4gIWOWm;
        "pkg-fabric-1.18.2-1.40.8" = _MDCXgoB3;
        "pkg-forge-1.19.2-1.40.8" = _guR7rtdI;
        "pkg-fabric-1.19.2-1.40.8" = _bTIxXXfw;
        "pkg-forge-1.20.1-1.40.8" = _QIQV9iK1;
        "pkg-fabric-1.20.1-1.40.8" = _9lt0ikbj;
        "pkg-neoforge-1.20.4-1.40.8" = _cDVNL5lg;
        "pkg-forge-1.20.4-1.40.8" = _5BRu83pP;
        "pkg-fabric-1.20.4-1.40.8" = _PyaCaekR;
        "pkg-neoforge-1.21.1-1.40.8" = _vfsv6jLy;
        "pkg-forge-1.21.1-1.40.8" = _b7CCR9re;
        "pkg-fabric-1.21.1-1.40.8" = _vA8JDnKu;
        "pkg-neoforge-1.21.4-1.40.8" = _755NpzPH;
        "pkg-forge-1.21.4-1.40.8" = _xkmnIP3a;
        "pkg-fabric-1.21.4-1.40.8" = _RMw6ftdC;
        "pkg-neoforge-1.21.5-1.40.8" = _DZYphMxa;
        "pkg-forge-1.21.5-1.40.8" = _MKKrBOIS;
        "pkg-fabric-1.21.5-1.40.8" = _7dWgPbNa;
        "pkg-neoforge-1.21.8-1.40.8" = _NejFwwGO;
        "pkg-forge-1.21.8-1.40.8" = _CLvY6cor;
        "pkg-fabric-1.21.8-1.40.8" = _DUn0rHMp;
        "pkg-neoforge-1.21.10-1.40.8" = _QsyngHl9;
        "pkg-forge-1.21.10-1.40.8" = _Oz64xRej;
        "pkg-fabric-1.21.10-1.40.8" = _bq3Ms030;
        "pkg-neoforge-1.21.11-1.40.8" = _uOuPFozn;
        "pkg-forge-1.21.11-1.40.8" = _s1RABjNe;
        "pkg-fabric-1.21.11-1.40.8" = _qWTWHZMX;
        "pkg-forge-1.12.2-1.40.10" = _kCo479Ag;
        "pkg-forge-1.16.5-1.40.10" = _Lm6qtJJH;
        "pkg-fabric-1.16.5-1.40.10" = _svnESIsn;
        "pkg-forge-1.18.2-1.40.10" = _dwhrIYlJ;
        "pkg-fabric-1.18.2-1.40.10" = _88tN8IqG;
        "pkg-forge-1.19.2-1.40.10" = _x9y9ilpe;
        "pkg-fabric-1.19.2-1.40.10" = _hKPpZCtN;
        "pkg-forge-1.20.1-1.40.10" = _H325YIQU;
        "pkg-fabric-1.20.1-1.40.10" = _erCjxXmK;
        "pkg-neoforge-1.20.4-1.40.10" = _dDQKa0hT;
        "pkg-forge-1.20.4-1.40.10" = _h0oIKldP;
        "pkg-fabric-1.20.4-1.40.10" = _QLJfyyBI;
        "pkg-neoforge-1.21.1-1.40.10" = _JgQEmOJt;
        "pkg-forge-1.21.1-1.40.10" = _iobwcV25;
        "pkg-fabric-1.21.1-1.40.10" = _nNEMIqdv;
        "pkg-neoforge-1.21.4-1.40.10" = _QjefeIth;
        "pkg-forge-1.21.4-1.40.10" = _iLL9a4H9;
        "pkg-fabric-1.21.4-1.40.10" = _8V928Fhi;
        "pkg-neoforge-1.21.5-1.40.10" = _346Mn5zX;
        "pkg-forge-1.21.5-1.40.10" = _Ha5FS0kP;
        "pkg-fabric-1.21.5-1.40.10" = _1ACC2jWR;
        "pkg-neoforge-1.21.8-1.40.10" = _CRrU4mdj;
        "pkg-forge-1.21.8-1.40.10" = _6TOgteLp;
        "pkg-fabric-1.21.8-1.40.10" = _fjGfRtNR;
        "pkg-neoforge-1.21.10-1.40.10" = _vdc3yt6x;
        "pkg-forge-1.21.10-1.40.10" = _3qkNp1yR;
        "pkg-fabric-1.21.10-1.40.10" = _kFdOSKAP;
        "pkg-neoforge-1.21.11-1.40.10" = _K1vmbaSL;
        "pkg-forge-1.21.11-1.40.10" = _f4hWXaWZ;
        "pkg-fabric-1.21.11-1.40.10" = _mcI8PbG2;
        "pkg-forge-1.12.2-1.40.11" = _Nnlz9lPP;
        "pkg-forge-1.16.5-1.40.11" = _cA0Z30zf;
        "pkg-fabric-1.16.5-1.40.11" = _rEkaIefG;
        "pkg-forge-1.18.2-1.40.11" = _RoSRzEW9;
        "pkg-fabric-1.18.2-1.40.11" = _eu5cINK9;
        "pkg-forge-1.19.2-1.40.11" = _xFY0NKUM;
        "pkg-fabric-1.19.2-1.40.11" = _kjlyBkAo;
        "pkg-forge-1.20.1-1.40.11" = _vUbAYOnm;
        "pkg-fabric-1.20.1-1.40.11" = _6WcEeMbU;
        "pkg-neoforge-1.20.4-1.40.11" = _5Gsr2ASF;
        "pkg-forge-1.20.4-1.40.11" = _Y4bOy7MT;
        "pkg-fabric-1.20.4-1.40.11" = _fYGpJyOr;
        "pkg-neoforge-1.21.1-1.40.11" = _arbQPyvf;
        "pkg-forge-1.21.1-1.40.11" = _4Z1dkAAR;
        "pkg-fabric-1.21.1-1.40.11" = _wB9wNHUk;
        "pkg-neoforge-1.21.4-1.40.11" = _Jo9AHiVE;
        "pkg-forge-1.21.4-1.40.11" = _UObDGSxt;
        "pkg-fabric-1.21.4-1.40.11" = _IrtFyFwh;
        "pkg-neoforge-1.21.5-1.40.11" = _yXc1BoiX;
        "pkg-forge-1.21.5-1.40.11" = _RujFtL6o;
        "pkg-fabric-1.21.5-1.40.11" = _5HyiFCC9;
        "pkg-neoforge-1.21.8-1.40.11" = _tbX9IQ0A;
        "pkg-forge-1.21.8-1.40.11" = _iusQ4833;
        "pkg-fabric-1.21.8-1.40.11" = _ilWxCVWq;
        "pkg-neoforge-1.21.10-1.40.11" = _Pxj5En9Q;
        "pkg-forge-1.21.10-1.40.11" = _1vsYhhso;
        "pkg-fabric-1.21.10-1.40.11" = _swwGbE2Y;
        "pkg-neoforge-1.21.11-1.40.11" = _cT8sgXzP;
        "pkg-forge-1.21.11-1.40.11" = _4NLcRVzn;
        "pkg-fabric-1.21.11-1.40.11" = _CkZVhVE0;
        "pkg-neoforge-26.1.2-1.40.14" = _oVi6kkFL;
        "pkg-fabric-26.1.2-1.40.14" = _xyGbYBF5;
        "pkg-neoforge-26.1.2-1.40.15" = _DANWL0SD;
        "pkg-forge-1.12.2-1.40.16" = _M71Sumnm;
        "pkg-forge-1.16.5-1.40.16" = _ovwFQ73w;
        "pkg-fabric-1.16.5-1.40.16" = _BNoiC3Z9;
        "pkg-forge-1.18.2-1.40.16" = _lSi4wkSM;
        "pkg-fabric-1.18.2-1.40.16" = _e57B2Yfa;
        "pkg-forge-1.19.2-1.40.16" = _B6EOtlnt;
        "pkg-fabric-1.19.2-1.40.16" = _Sy3OMciD;
        "pkg-forge-1.20.1-1.40.16" = _5mJcHKn6;
        "pkg-fabric-1.20.1-1.40.16" = _4iL1uj0g;
        "pkg-forge-1.20.4-1.40.16" = _C5vR5Vdl;
        "pkg-fabric-1.20.4-1.40.16" = _hKnwboIw;
        "pkg-neoforge-1.20.4-1.40.16" = _HXOgioE5;
        "pkg-forge-1.21.1-1.40.16" = _3vmG01LZ;
        "pkg-fabric-1.21.1-1.40.16" = _HvYNIyXh;
        "pkg-neoforge-1.21.1-1.40.16" = _XwL25au3;
        "pkg-forge-1.21.4-1.40.16" = _zUzrrmgA;
        "pkg-fabric-1.21.4-1.40.16" = _9oN9nyY1;
        "pkg-neoforge-1.21.4-1.40.16" = _9EIjr7Lx;
        "pkg-forge-1.21.5-1.40.16" = _A9HX560L;
        "pkg-fabric-1.21.5-1.40.16" = _6XVPq0oZ;
        "pkg-neoforge-1.21.5-1.40.16" = _uE1i3eEB;
        "pkg-forge-1.21.8-1.40.16" = _hUKSkLTW;
        "pkg-fabric-1.21.8-1.40.16" = _12z80mcV;
        "pkg-neoforge-1.21.8-1.40.16" = _pepjl8Dz;
        "pkg-forge-1.21.10-1.40.16" = _ZpuNTkR0;
        "pkg-fabric-1.21.10-1.40.16" = _rx0xZzuQ;
        "pkg-neoforge-1.21.10-1.40.16" = _2lNm3euF;
        "pkg-forge-1.21.11-1.40.16" = _GnuG5TPW;
        "pkg-fabric-1.21.11-1.40.16" = _vOQ76ooY;
        "pkg-neoforge-1.21.11-1.40.16" = _azSqgyeZ;
        "pkg-fabric-26.1.2-1.40.16" = _D0plbArp;
        "pkg-neoforge-26.1.2-1.40.16" = _6xdDegko;
        "pkg-fabric-26.1.2-1.40.17" = _ZN1xFDYX;
        "pkg-neoforge-26.1.2-1.40.17" = _xXdbLEkU;
        "pkg-neoforge-1.21.5-1.40.18" = _i3BE8jma;
        "pkg-neoforge-1.21.8-1.40.18" = _m5GPGkX7;
        "pkg-neoforge-1.21.10-1.40.18" = _UQTtKTmo;
        "pkg-neoforge-1.21.11-1.40.18" = _R23xqo13;
        "pkg-fabric-26.1.2-1.40.18" = _nvmFod7S;
        "pkg-neoforge-26.1.2-1.40.18" = _HBqX4YC4;
        "pkg-forge-1.12.2-1.41.0" = _dd14TZIm;
        "pkg-forge-1.16.5-1.41.0" = _N8v1H3qS;
        "pkg-fabric-1.16.5-1.41.0" = _GpX2fqMP;
        "pkg-forge-1.18.2-1.41.0" = _cGekkEfs;
        "pkg-fabric-1.18.2-1.41.0" = _Rx6TRIw3;
        "pkg-forge-1.19.2-1.41.0" = _gvbdvHnu;
        "pkg-fabric-1.19.2-1.41.0" = _FNUEAYcd;
        "pkg-forge-1.20.1-1.41.0" = _2QCjQ4y4;
        "pkg-fabric-1.20.1-1.41.0" = _xZ19HR9r;
        "pkg-forge-1.20.4-1.41.0" = _51GUy5nV;
        "pkg-fabric-1.20.4-1.41.0" = _8GU7Lc8o;
        "pkg-neoforge-1.20.4-1.41.0" = _Bdpl6Gj4;
        "pkg-forge-1.21.1-1.41.0" = _xbuNcwrm;
        "pkg-fabric-1.21.1-1.41.0" = _iZrSElcO;
        "pkg-neoforge-1.21.1-1.41.0" = _EupKCSdU;
        "pkg-forge-1.21.4-1.41.0" = _H8sTLY9q;
        "pkg-fabric-1.21.4-1.41.0" = _9H0p1mmH;
        "pkg-neoforge-1.21.4-1.41.0" = _kExSm1Uq;
        "pkg-forge-1.21.5-1.41.0" = _6jDTfaFU;
        "pkg-fabric-1.21.5-1.41.0" = _SQVGXpz9;
        "pkg-neoforge-1.21.5-1.41.0" = _xH9sS0gV;
        "pkg-forge-1.21.8-1.41.0" = _c303Jrza;
        "pkg-fabric-1.21.8-1.41.0" = _OzheLrx0;
        "pkg-neoforge-1.21.8-1.41.0" = _tOPHsPnk;
        "pkg-forge-1.21.10-1.41.0" = _lPyMogQy;
        "pkg-fabric-1.21.10-1.41.0" = _zy4RnVfw;
        "pkg-neoforge-1.21.10-1.41.0" = _7FmrdNWY;
        "pkg-forge-1.21.11-1.41.0" = _8lLDqepS;
        "pkg-fabric-1.21.11-1.41.0" = _xQ92jpDL;
        "pkg-neoforge-1.21.11-1.41.0" = _l8Icnu83;
        "pkg-fabric-26.1.2-1.41.0" = _ef63oxpn;
        "pkg-neoforge-26.1.2-1.41.0" = _RKCzbO9T;
        "pkg-fabric-26.2-1.41.0" = _SgGo9yEE;
        "pkg-neoforge-26.2-1.41.0" = _wYK7T7sl;
        "pkg-fabric-26.1.2-1.41.1" = _OC65q9Rm;
        "pkg-fabric-26.2-1.41.1" = _6ytpht6o;
        "pkg-forge-1.12.2-1.41.2" = _WVIOtNIy;
        "pkg-forge-1.16.5-1.41.2" = _AdgNeUH5;
        "pkg-fabric-1.16.5-1.41.2" = _3LB40S6g;
        "pkg-forge-1.18.2-1.41.2" = _9AwAETAO;
        "pkg-fabric-1.18.2-1.41.2" = _aDE9jia7;
        "pkg-forge-1.19.2-1.41.2" = _KnWKO6kP;
        "pkg-fabric-1.19.2-1.41.2" = _hpFePs7a;
        "pkg-forge-1.20.1-1.41.2" = _wciL1Yas;
        "pkg-fabric-1.20.1-1.41.2" = _FDp23lAS;
        "pkg-forge-1.20.4-1.41.2" = _Q0euXDYB;
        "pkg-fabric-1.20.4-1.41.2" = _XOfGPofw;
        "pkg-forge-1.21.1-1.41.2" = _uiDdCrvp;
        "pkg-fabric-1.21.1-1.41.2" = _9ts5xgne;
        "pkg-neoforge-1.21.1-1.41.2" = _fHsLkLT4;
        "pkg-forge-1.21.4-1.41.2" = _CAeg9MS8;
        "pkg-fabric-1.21.4-1.41.2" = _HIAsObgT;
        "pkg-neoforge-1.21.4-1.41.2" = _Ka1aCHIb;
        "pkg-forge-1.21.5-1.41.2" = _oRWrA9q6;
        "pkg-fabric-1.21.5-1.41.2" = _cOAwGyC3;
        "pkg-neoforge-1.21.5-1.41.2" = _On2WAUQJ;
        "pkg-forge-1.21.8-1.41.2" = _qe1Y5HgP;
        "pkg-fabric-1.21.8-1.41.2" = _PBlogZtD;
        "pkg-neoforge-1.21.8-1.41.2" = _61QoI0PM;
        "pkg-forge-1.21.10-1.41.2" = _6EV22R8I;
        "pkg-fabric-1.21.10-1.41.2" = _HvDSoIwh;
        "pkg-neoforge-1.21.10-1.41.2" = _FFSMSJIx;
        "pkg-forge-1.21.11-1.41.2" = _BekHWlWZ;
        "pkg-fabric-1.21.11-1.41.2" = _1rgcnGza;
        "pkg-neoforge-1.21.11-1.41.2" = _8yttM3d4;
        "pkg-fabric-26.1.2-1.41.2" = _o71garUJ;
        "pkg-neoforge-26.1.2-1.41.2" = _KHHfxuFh;
        "pkg-fabric-26.2-1.41.2" = _GpLXjdfA;
        "pkg-neoforge-26.2-1.41.2" = _Os9PQSx6;
        "pkg-fabric-26.2-1.41.3" = _5OKukukw;
        "pkg-neoforge-26.2-1.41.3" = _bX12tOtk;
        "pkg-fabric-26.1.2-1.41.3" = _4VkjsFCX;
        "pkg-forge-1.12.2-1.42.0" = _1wJ89W8U;
        "pkg-forge-1.16.5-1.42.0" = _kkmhdMMn;
        "pkg-fabric-1.16.5-1.42.0" = _KyISdoOG;
        "pkg-forge-1.18.2-1.42.0" = _HpyLiaUh;
        "pkg-fabric-1.18.2-1.42.0" = _v6rTrLfy;
        "pkg-forge-1.19.2-1.42.0" = _gE0ctxl8;
        "pkg-fabric-1.20.1-1.42.0" = _aQ2PfUQK;
        "pkg-forge-1.20.1-1.42.0" = _1yUPuPrU;
        "pkg-fabric-1.20.4-1.42.0" = _k7n1luOO;
        "pkg-forge-1.20.4-1.42.0" = _LRePe6va;
        "pkg-neoforge-1.20.4-1.42.0" = _gdQJWzRy;
        "pkg-forge-1.21.1-1.42.0" = _gRtkXULf;
        "pkg-fabric-1.21.1-1.42.0" = _dnHKmImB;
        "pkg-neoforge-1.21.1-1.42.0" = _yECb8StH;
        "pkg-forge-1.21.4-1.42.0" = _8qtf0uDJ;
        "pkg-fabric-1.21.4-1.42.0" = _fbDoKj9G;
        "pkg-neoforge-1.21.4-1.42.0" = _FSQxVgN1;
        "pkg-forge-1.21.5-1.42.0" = _5kY5lG6e;
        "pkg-fabric-1.21.5-1.42.0" = _LXoQrkQn;
        "pkg-neoforge-1.21.5-1.42.0" = _fFBtbRez;
        "pkg-forge-1.21.8-1.42.0" = _5ZE5c7Zh;
        "pkg-fabric-1.21.8-1.42.0" = _wIUynjNe;
        "pkg-neoforge-1.21.8-1.42.0" = _Kdo6cnUi;
        "pkg-forge-1.21.10-1.42.0" = _5P46YYIE;
        "pkg-fabric-1.21.10-1.42.0" = _7nUknR6l;
        "pkg-neoforge-1.21.10-1.42.0" = _HP8J5uHl;
        "pkg-forge-1.21.11-1.42.0" = _qlficGjG;
        "pkg-fabric-1.21.11-1.42.0" = _xpNaeY2J;
        "pkg-neoforge-1.21.11-1.42.0" = _rZ35CXD3;
        "pkg-fabric-26.1.2-1.42.0" = _x1pc3TAj;
        "pkg-neoforge-26.1.2-1.42.0" = _zCMW8vvo;
        "pkg-fabric-26.2-1.42.0" = _JN72jos8;
        "pkg-neoforge-26.2-1.42.0" = _e9ZXcg94;
        "pkg-forge-1.16.5-1.42.1" = _zKF6uDCV;
        "pkg-forge-1.12.2-1.43.0" = _O7XLgmtT;
        "pkg-forge-1.16.5-1.43.0" = _YtL8ByL5;
        "pkg-fabric-1.16.5-1.43.0" = _6BAnmsY8;
        "pkg-fabric-1.18.2-1.43.0" = _h80FF8UM;
        "pkg-forge-1.18.2-1.43.0" = _HlyhWaZV;
        "pkg-fabric-1.19.2-1.43.0" = _Zy1hRNBO;
        "pkg-forge-1.19.2-1.43.0" = _8EdyPFo4;
        "pkg-fabric-1.20.1-1.43.0" = _AGYLiqsq;
        "pkg-forge-1.20.1-1.43.0" = _hHJuquUN;
        "pkg-forge-1.20.4-1.43.0" = _QOWqIT95;
        "pkg-fabric-1.20.4-1.43.0" = _KCCGHvzj;
        "pkg-neoforge-1.20.4-1.43.0" = _qnLN7gWt;
        "pkg-forge-1.21.1-1.43.0" = _JXlVT4sr;
        "pkg-fabric-1.21.1-1.43.0" = _qr5f3QDU;
        "pkg-neoforge-1.21.1-1.43.0" = _Ps7HDlJ2;
        "pkg-forge-1.21.4-1.43.0" = _dGVWX2Wa;
        "pkg-neoforge-1.21.4-1.43.0" = _6RBmadch;
        "pkg-forge-1.21.5-1.43.0" = _o4vOKMUP;
        "pkg-neoforge-1.21.5-1.43.0" = _l0CfToeV;
        "pkg-forge-1.21.8-1.43.0" = _zQvJZfzK;
        "pkg-neoforge-1.21.8-1.43.0" = _EayQwTvm;
        "pkg-forge-1.21.10-1.43.0" = _XvBWcFkX;
        "pkg-neoforge-1.21.10-1.43.0" = _hU9vfHmC;
        "pkg-forge-1.21.11-1.43.0" = _3d8G4y6k;
        "pkg-neoforge-1.21.11-1.43.0" = _nMmlWFNN;
        "pkg-forge-26.1.2-1.43.0" = _LUTrSW8J;
        "pkg-neoforge-26.1.2-1.43.0" = _cZ4i2sPB;
        "pkg-forge-26.2-1.43.0" = _VXEj8Ohx;
        "pkg-neoforge-26.2-1.43.0" = _BPrrzeGL;
        "pkg-fabric-1.21.4-1.43.0" = _yjFKr1ZZ;
        "pkg-fabric-1.21.5-1.43.0" = _cYSYvMyd;
        "pkg-fabric-1.21.8-1.43.0" = _ESY4Ymie;
        "pkg-fabric-1.21.10-1.43.0" = _1SWQTb51;
        "pkg-fabric-1.21.11-1.43.0" = _HEWaAJUl;
        "pkg-fabric-26.1.2-1.43.0" = _2j7d3d3d;
        "pkg-fabric-26.2-1.43.0" = _fXeekKjw;
        "pkg-forge-26.1.2-1.44.0" = _BqY31ptj;
        "pkg-fabric-26.1.2-1.44.0" = _9PkuyDmI;
        "pkg-neoforge-26.1.2-1.44.0" = _l7EK5vcZ;
        "pkg-forge-26.2-1.44.0" = _K7ganDPj;
        "pkg-fabric-26.2-1.44.0" = _lshIyDHq;
        "pkg-neoforge-26.2-1.44.0" = _PgTWq6yP;
        "pkg-forge-1.12.2-1.44.0" = _5XaGr6nF;
        "pkg-forge-1.16.5-1.44.0" = _OVUI6nxU;
        "pkg-fabric-1.16.5-1.44.0" = _3BphgUnx;
        "pkg-fabric-1.18.2-1.44.0" = _W5pbupnh;
        "pkg-forge-1.18.2-1.44.0" = _lZQAhxgk;
        "pkg-forge-1.12.2-1.44.2" = _XImY7uND;
        "pkg-forge-1.16.5-1.44.2" = _PYCCNjeg;
        "pkg-fabric-1.16.5-1.44.2" = _r5fpPfKN;
        "pkg-forge-1.18.2-1.44.2" = _KI9HCYzT;
        "pkg-fabric-1.18.2-1.44.2" = _Hqe4aVWN;
        "pkg-forge-1.19.2-1.44.2" = _MhMeS7Qz;
        "pkg-fabric-1.19.2-1.44.2" = _DlitF0M9;
        "pkg-forge-1.20.1-1.44.2" = _kQ06HixR;
        "pkg-fabric-1.20.1-1.44.2" = _UU5YGsgn;
        "pkg-forge-1.20.4-1.44.2" = _FjJ5Ev1i;
        "pkg-fabric-1.20.4-1.44.2" = _MnQh6YIz;
        "pkg-neoforge-1.20.4-1.44.2" = _MbU8WZb1;
        "pkg-forge-1.21.1-1.44.2" = _xI11enz6;
        "pkg-fabric-1.21.1-1.44.2" = _L2nO7ZYD;
        "pkg-neoforge-1.21.1-1.44.2" = _55gtOc9Y;
        "pkg-forge-1.21.4-1.44.2" = _UVwWmrQ3;
        "pkg-fabric-1.21.4-1.44.2" = _dP0Nv0XF;
        "pkg-neoforge-1.21.4-1.44.2" = _HRGgVISs;
        "pkg-forge-1.21.5-1.44.2" = _vdloGcJL;
        "pkg-fabric-1.21.5-1.44.2" = _EiwSu1fH;
        "pkg-neoforge-1.21.5-1.44.2" = _TSGTt4vl;
        "pkg-forge-1.21.8-1.44.2" = _yN4pKobW;
        "pkg-fabric-1.21.8-1.44.2" = _16jeKzeM;
        "pkg-neoforge-1.21.8-1.44.2" = _iZ8jJOwj;
        "pkg-forge-1.21.10-1.44.2" = _re0ozmxP;
        "pkg-fabric-1.21.10-1.44.2" = _dJSazz1g;
        "pkg-neoforge-1.21.10-1.44.2" = _Jnz9Bs89;
        "pkg-forge-1.21.11-1.44.2" = _L9LCjk6q;
        "pkg-fabric-1.21.11-1.44.2" = _uuPYtgMh;
        "pkg-neoforge-1.21.11-1.44.2" = _73s8U0Yb;
        "pkg-forge-26.1.2-1.44.2" = _4dkO7xv9;
        "pkg-fabric-26.1.2-1.44.2" = _d81YYK5J;
        "pkg-neoforge-26.1.2-1.44.2" = _ltX2ZaPs;
        "pkg-forge-26.2-1.44.2" = _68FE9qja;
        "pkg-fabric-26.2-1.44.2" = _NzjI8AbM;
        "pkg-neoforge-26.2-1.44.2" = _pKatKnls;
        "pkg-forge-26.1.2-1.44.3" = _kMxL3pyy;
        "pkg-forge-26.2-1.44.3" = _j36NbtL6;
        "pkg-forge-1.12.2-1.45.0" = _H8isxC6e;
        "pkg-forge-1.16.5-1.45.0" = _aiRtntI7;
        "pkg-fabric-1.16.5-1.45.0" = _ofMgYGde;
        "pkg-fabric-1.18.2-1.45.0" = _R47Dxii8;
        "pkg-forge-1.18.2-1.45.0" = _okwKyGYv;
        "pkg-fabric-1.19.2-1.45.0" = _Q5Q0dWGw;
        "pkg-forge-1.19.2-1.45.0" = _UYgfmqrN;
        "pkg-fabric-1.20.1-1.45.0" = _ZLYCiSMO;
        "pkg-forge-1.20.1-1.45.0" = _3fGuLVo4;
        "pkg-neoforge-1.20.4-1.45.0" = _ekVa7vhQ;
        "pkg-fabric-1.20.4-1.45.0" = _vWSUiZND;
        "pkg-forge-1.20.4-1.45.0" = _92y7huQU;
        "pkg-neoforge-1.21.1-1.45.0" = _fOv9QzLO;
        "pkg-fabric-1.21.1-1.45.0" = _i80CxP4n;
        "pkg-forge-1.21.1-1.45.0" = _ciV21ZrY;
        "pkg-neoforge-1.21.4-1.45.0" = _88NA1SdH;
        "pkg-forge-1.21.4-1.45.0" = _dfyy2pBR;
        "pkg-fabric-1.21.4-1.45.0" = _IBcL3f5W;
        "pkg-fabric-1.21.5-1.45.0" = _74IEK9p1;
        "pkg-neoforge-1.21.5-1.45.0" = _83oItj23;
        "pkg-forge-1.21.5-1.45.0" = _s6QFR9D3;
        "pkg-fabric-1.21.8-1.45.0" = _yu5MwZs0;
        "pkg-neoforge-1.21.8-1.45.0" = _TgfqTLn0;
        "pkg-forge-1.21.8-1.45.0" = _bGFSItfw;
        "pkg-neoforge-1.21.10-1.45.0" = _b4z9rd73;
        "pkg-fabric-1.21.10-1.45.0" = _J2D6Ac47;
        "pkg-forge-1.21.10-1.45.0" = _HIlE0duq;
        "pkg-fabric-1.21.11-1.45.0" = _4PX8T9We;
        "pkg-neoforge-1.21.11-1.45.0" = _OD3jdfif;
        "pkg-forge-1.21.11-1.45.0" = _B2g3fSMS;
        "pkg-fabric-26.1.2-1.45.0" = _BzCXHIwa;
        "pkg-neoforge-26.1.2-1.45.0" = _nYkAgzJQ;
        "pkg-forge-26.1.2-1.45.0" = _G30AUwkY;
        "pkg-neoforge-26.2-1.45.0" = _B9sHEUTG;
        "pkg-forge-26.2-1.45.0" = _uR4BXv9U;
        "pkg-fabric-26.2-1.45.0" = _Z6wZaeAX;
        "pkg-forge-1.12.2-1.46.0" = _lqE4pAC2;
        "pkg-forge-1.16.5-1.46.0" = _9d9DcRJ2;
        "pkg-fabric-1.16.5-1.46.0" = _YYtuPXYT;
        "pkg-fabric-1.18.2-1.46.0" = _SeatstUt;
        "pkg-forge-1.18.2-1.46.0" = _UEVTfNxx;
        "pkg-fabric-1.19.2-1.46.0" = _VBW0exoV;
        "pkg-forge-1.19.2-1.46.0" = _ylwy6kh5;
        "pkg-fabric-1.20.1-1.46.0" = _X84cZdC3;
        "pkg-forge-1.20.1-1.46.0" = _rlPmwaQX;
        "pkg-fabric-1.20.4-1.46.0" = _S9GHYEYj;
        "pkg-neoforge-1.20.4-1.46.0" = _DYWzeQ0C;
        "pkg-forge-1.20.4-1.46.0" = _SwN9YJER;
        "pkg-fabric-1.21.1-1.46.0" = _txl9KURC;
        "pkg-neoforge-1.21.1-1.46.0" = _9Ckiihkz;
        "pkg-forge-1.21.1-1.46.0" = _aOqDWHqr;
        "pkg-fabric-1.21.4-1.46.0" = _IoGJS3fE;
        "pkg-neoforge-1.21.4-1.46.0" = _VlQLmGAM;
        "pkg-forge-1.21.4-1.46.0" = _YoiDAv5R;
        "pkg-fabric-1.21.5-1.46.0" = _kJhXAZVZ;
        "pkg-neoforge-1.21.5-1.46.0" = _jRMh44By;
        "pkg-forge-1.21.5-1.46.0" = _pPFk05ez;
        "pkg-fabric-1.21.8-1.46.0" = _q54JRi33;
        "pkg-neoforge-1.21.8-1.46.0" = _j9wLUl2w;
        "pkg-forge-1.21.8-1.46.0" = _Z4pA0icg;
        "pkg-fabric-1.21.10-1.46.0" = _F8SwXfI6;
        "pkg-neoforge-1.21.10-1.46.0" = _eCVBfGW7;
        "pkg-forge-1.21.10-1.46.0" = _jJs05zGE;
        "pkg-fabric-1.21.11-1.46.0" = _Jfe3ZJIB;
        "pkg-neoforge-1.21.11-1.46.0" = _My5vFbsa;
        "pkg-forge-1.21.11-1.46.0" = _WPmPusNa;
        "pkg-fabric-26.1.2-1.46.0" = _IYPINJuw;
        "pkg-neoforge-26.1.2-1.46.0" = _9x5f2L12;
        "pkg-forge-26.1.2-1.46.0" = _LV5noeKG;
        "pkg-fabric-26.2-1.46.0" = _DxU1zijU;
        "pkg-neoforge-26.2-1.46.0" = _kusU9lBt;
        "pkg-forge-26.2-1.46.0" = _KpbxehO3;
        "pkg-forge-26.2-1.46.1" = _3cyKCC8w;
        "pkg-neoforge-26.2-1.46.1" = _jvDo1iio;
        "pkg-fabric-26.2-1.46.1" = _q0Wvp46X;
        "pkg-fabric-26.3-1.46.2" = _f9XDypdw;
        "pkg-fabric-26.3-1.46.3" = _wFzCYgM6;
        "pkg-neoforge-26.3-1.46.3" = _YEohEAtf;
        "default" = _YEohEAtf;
    });
