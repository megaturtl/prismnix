...
let
    ...
    in {
        ...
        "pkg-1.21.1-1.0.2" = _MhRdmGsW;
        "pkg-1.21.1-1.0.3" = _TI7GtBPM;
        "pkg-1.21.1-1.0.4" = _3kg6Y1rr;
        "pkg-1.21.1-1.0.4.1" = _ysMjKM8i;
        "pkg-1.21.1-1.0.5" = _EZj5Icff;
        "pkg-1.21.1-1.0.6" = _meyiM45Z;
        "pkg-1.20.1-1.0.0" = _y77vbN8m;
        "pkg-1.20.1-1.0.1" = _lgXubeSl;
        "pkg-1.21.1-1.1.0" = _aDspHpCJ;
        "pkg-1.21.1-1.2.0" = _acS06sVC;
        "pkg-1.20.1-1.1.0" = _WPSq9CvP;
        "pkg-1.21.1-1.2.1" = _xkO4buvU;
        "pkg-1.21.1-1.2.2" = _cxmNFpzB;
        "pkg-1.20.1-1.1.1" = _eR8bWDei;
        "pkg-1.20.1-1.1.2" = _4jmSX8kC;
        "pkg-1.21.1-1.2.3" = _V2nYdizl;
        "pkg-1.21.1-1.3.0" = _N4s1lG0F;
        "pkg-1.21.1-1.3.1" = _WMn1qIKP;
        "pkg-1.20.1-1.2.0" = _K13n2BVw;
