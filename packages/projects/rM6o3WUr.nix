...
let
    versions = (let
        ...
        _fRiBtLyc = {
            "id" = "fRiBtLyc";
            "file" = "CraftableBell.zip";
            "hash" = "sha512-azH8i4JPgeQ5LttCCSgduzGumTpWS4rjYNrSiNTseRa4oUO/GeXlv3vin7iJ6WI9+tyUlYidh+cKZl5ZWqu52w==";
        };
    in {
        "O4gx6gPS" = _O4gx6gPS;
        "LwEPEuk5" = _LwEPEuk5;
        ...
        "datapack-1.18" = _fRiBtLyc;
        "datapack-1.18.1" = _fRiBtLyc;
        "datapack-1.18.2" = _fRiBtLyc;
        "datapack-1.19" = _fRiBtLyc;
        "datapack-1.19.1" = _fRiBtLyc;
        "datapack-1.19.2" = _fRiBtLyc;
        "datapack-1.19.3" = _fRiBtLyc;
        "datapack-1.19.4" = _fRiBtLyc;
        "datapack-1.20" = _fRiBtLyc;
        "datapack-1.20.1" = _fRiBtLyc;
        "datapack-1.20.2" = _fRiBtLyc;
        "datapack-1.20.3" = _fRiBtLyc;
        "datapack-1.20.4" = _fRiBtLyc;
        "datapack-1.21.2" = _fRiBtLyc;
        "datapack-1.21.3" = _fRiBtLyc;
        "datapack-1.21.4" = _fRiBtLyc;
        "datapack-1.21.5" = _fRiBtLyc;
        "datapack-1.21.6" = _fRiBtLyc;
        "datapack-1.21.7" = _fRiBtLyc;
        "datapack-1.21.8" = _fRiBtLyc;
        "datapack-1.20.5" = _fRiBtLyc;
        "datapack-1.20.6" = _fRiBtLyc;
        "datapack-1.21" = _fRiBtLyc;
        "datapack-1.21.1" = _fRiBtLyc;
        "datapack-1.21.9" = _fRiBtLyc;
        "datapack-1.21.10" = _fRiBtLyc;
        "datapack-1.21.11" = _fRiBtLyc;
        "datapack-26.1" = _fRiBtLyc;
        "datapack-26.1.1" = _fRiBtLyc;
        "datapack-26.1.2" = _fRiBtLyc;
        "datapack-26.2" = _fRiBtLyc;
        ...
        "pkg-1.19-0.1" = _T0FPYH0q;
        "pkg-1.19.1-0.1" = _GVIunXWU;
        "pkg-1.19.2-0.1" = _yJCM0YCz;
        "pkg-1.19.3-0.1" = _SsuG245J;
        "pkg-1.19.4-0.1" = _1Q4rReXy;
        "pkg-1.20-0.1" = _BxWH8pzh;
        "pkg-1.20.1-0.1" = _x8LsKrBN;
        "pkg-1.20.2-0.1" = _Jcyn1eZi;
        "pkg-0.1" = _7qTjuvHb;
        "pkg-1.20.3-0.1" = _dXXpR2f5;
        "pkg-1.20.4-0.1" = _V7hIkdmU;
        "pkg-1.20.6-0.1" = _S50ryYOU;
        "pkg-1.20.5-0.1" = _trUY9IJW;
        "pkg-1.21-0.1" = _pCthoQTO;
        "pkg-1.20.6-0.2" = _xMVrSqYw;
        "pkg-1.21.1-0.1" = _dFqteYaX;
        "pkg-1.21-0.2" = _lyT57sxF;
        "pkg-1.21.1-0.2" = _okqLBdFV;
        "pkg-1.21-0.3" = _RgTosgWu;
        "pkg-1.21.3-0.1" = _mVHnZdQA;
        "pkg-1.21.4-0.1" = _H50XHx6D;
        "pkg-1.21.5-0.1" = _4VolSFUf;
        "pkg-1.21.5-0.2" = _lbR9yuSk;
        "pkg-1.21.6-0.1" = _qFfSxxtY;
        "pkg-1.21.7-0.1" = _rsnd01al;
        "pkg-1.21.8-0.1" = _5JeD8ABj;
        "pkg-1.21.9-0.1" = _zzNlF5MI;
        "pkg-1.21.10-0.1" = _encOBnP0;
        "pkg-1.21.11-0.1" = _BocXVR8B;
        "pkg-0.2" = _p3nH2iSq;
        "pkg-26.1-0.1" = _Cvn8ovSC;
        "pkg-26.1.1-0.1" = _nfBDFf4o;
        "pkg-26.1.2-0.1" = _LvyakyiS;
        "pkg-0.3" = _rKiCnEqz;
        "pkg-26.2-0.1" = _qpXV0SSJ;
        "pkg-0.4" = _fRiBtLyc;
        "default" = _fRiBtLyc;
    });
