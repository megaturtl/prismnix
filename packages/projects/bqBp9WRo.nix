...
let
    versions = (let
        ...
        _Mvpt5vIm = {
            "id" = "Mvpt5vIm";
            "file" = "AstralSwords-1.3.0.jar";
            "hash" = "sha512-cwU2madJmzxC2utQcaG21Y7ayY5t8sAOuBQdvEHmw1bz8F1cAGVoJRfT69W+KiFRwhcb0flNfYhN98vSR6uQcA==";
        };
    in {
        "B79WUrH5" = _B79WUrH5;
        "i5sjzFAS" = _i5sjzFAS;
        ...
        "nidXP3Jb" = _nidXP3Jb;
        "Mvpt5vIm" = _Mvpt5vIm;
        "paper-1.21" = _Mvpt5vIm;
        "paper-1.21.1" = _Mvpt5vIm;
        "paper-1.21.2" = _Mvpt5vIm;
        "paper-1.21.3" = _Mvpt5vIm;
        "paper-1.21.4" = _Mvpt5vIm;
        "paper-1.21.5" = _Mvpt5vIm;
        "paper-1.21.6" = _Mvpt5vIm;
        "paper-1.21.7" = _Mvpt5vIm;
        "paper-1.21.8" = _Mvpt5vIm;
        "paper-1.21.9" = _Mvpt5vIm;
        "paper-1.21.10" = _Mvpt5vIm;
        "paper-1.21.11" = _Mvpt5vIm;
        "paper-26.1" = _Mvpt5vIm;
        "paper-26.1.1" = _Mvpt5vIm;
        "paper-26.1.2" = _Mvpt5vIm;
        "paper-26.2" = _Mvpt5vIm;
        "purpur-1.21" = _Mvpt5vIm;
        "purpur-1.21.1" = _Mvpt5vIm;
        "purpur-1.21.2" = _Mvpt5vIm;
        "purpur-1.21.3" = _Mvpt5vIm;
        "purpur-1.21.4" = _Mvpt5vIm;
        "purpur-1.21.5" = _Mvpt5vIm;
        "purpur-1.21.6" = _Mvpt5vIm;
        "purpur-1.21.7" = _Mvpt5vIm;
        "purpur-1.21.8" = _Mvpt5vIm;
        "purpur-1.21.9" = _Mvpt5vIm;
        "purpur-1.21.10" = _Mvpt5vIm;
        "purpur-1.21.11" = _Mvpt5vIm;
        "purpur-26.1" = _Mvpt5vIm;
        "purpur-26.1.1" = _Mvpt5vIm;
        "purpur-26.1.2" = _Mvpt5vIm;
        "purpur-26.2" = _Mvpt5vIm;
        "pkg-1.0.0" = _i5sjzFAS;
        "pkg-1.0.1" = _IktafTr9;
        "pkg-1.0.2" = _TPniVBE3;
        "pkg-1.1.4" = _TuIzcNfB;
