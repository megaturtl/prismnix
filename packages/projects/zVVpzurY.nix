...
let
    ...
    in {
        ...
        "pkg-0.1.2.0+1.21.5" = _gULVCp2Q;
        "pkg-0.1.2.1+1.21.5" = _nGq8Pr6L;
        "pkg-0.1.2.1+1.21.4" = _yrAdRY9L;
        "pkg-0.1.2.1+1.21.1" = _SZW7nRho;
        "pkg-0.1.2.1+1.20.6" = _xgzBqMRc;
        "pkg-0.1.2.1+1.20.4" = _Y2lKCwQD;
        "pkg-0.1.2.1+1.20.1" = _9weKWqON;
        "pkg-0.1.2.2+1.20.4" = _CYQTVRtr;
        "pkg-0.1.2.1+1.21.6-pre1" = _HFbOUrf5;
        "pkg-0.1.2.1+1.21.6" = _dkseNv61;
        "pkg-0.2.0.0+1.21.6" = _cYlltAQr;
        "pkg-0.2.0.0+1.20-1.21.6" = _YkJV1ugf;
        "pkg-0.2.1.0+1.21.6" = _aeDApaPv;
        "pkg-0.2.1.0+1.20-1.21.6" = _t936uFjs;
        "pkg-0.2.1.0+1.21.5" = _hzK5ru2b;
        "pkg-0.2.1.0+1.21.4" = _HbIoTb00;
        "pkg-0.2.1.0+1.21.1" = _QoKZdme7;
        "pkg-0.2.1.0+1.21.7" = _LTg9ifOT;
        "pkg-0.2.1.0+1.20.6" = _GfBpnLTq;
        "pkg-0.2.1.0+1.20.4" = _T7Lg0VPa;
        "pkg-0.2.1.0+1.20.1" = _ilUQLsde;
        "pkg-0.2.2.0+1.21.7" = _HvUT4DIF;
        "pkg-0.2.2.0+1.20-1.21.7" = _FXcbzdv8;
        "pkg-0.2.2.0+1.21.5" = _ay2JBPGs;
        "pkg-0.2.2.0+1.21.4" = _jypR5qeR;
        "pkg-0.2.2.0+1.21.8" = _y94cz6oZ;
        "pkg-0.2.1.1+1.20.4" = _zxtNclPn;
        "pkg-0.2.1.1+1.20.1" = _KGMbD3YU;
        "pkg-0.2.2.0+1.20.6" = _cYzRbR64;
        "pkg-0.2.2.0+1.20.4" = _VAA1Mkjd;
        "pkg-0.2.2.0+1.20.1" = _b0StSPCY;
        "pkg-0.2.2.0+1.21.1" = _lMOoBAw6;
        "pkg-0.2.2.1+1.21.8" = _c1wkXVhH;
        "pkg-0.2.2.1+1.21.9" = _yRuTDvmZ;
        "pkg-0.2.2.1+1.21.10" = _zlJvj7Xn;
        "pkg-0.2.2.1+1.21.11" = _97STrMee;
        "pkg-0.3.0.0+26.1" = _aLCe8TQU;
        "pkg-0.3.0.0+26.1.1" = _DlBRgsTH;
