...
let
    ...
    in {
        ...
        "pkg-0.3.5" = _zqhIfTyD;
        "pkg-0.3.6" = _arulk3lX;
        "pkg-0.0.1-BTA!-7.3_04" = _n1ImQou8;
        "pkg-0.0.2-BTA!-7.3_04" = _cQjycf6F;
        "pkg-0.3.7" = _W2IXTliQ;
        "pkg-0.0.3-BTA!-7.3_04" = _u4K1ORpE;
        "pkg-0.3.8" = _7GlxkRbY;
        "pkg-0.3.9" = _miAgrvNT;
        "pkg-0.0.4-BTA!-7.3_04" = _QeqAJ8iz;
        "pkg-0.4.0" = _Bcoi6HTL;
        "pkg-0.4.1+1.20.1" = _L7Bpd1hB;
        "pkg-0.4.2+1.20.1" = _xtTbobx2;
        "pkg-0.4.3+1.20.1" = _W9welEqr;
        "pkg-0.4.3.1+1.20.1" = _mVqtlEwN;
