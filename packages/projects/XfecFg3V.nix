...
let
    versions = (let
        ...
        _uj3rAPU4 = {
            "id" = "uj3rAPU4";
            "file" = "ironfurnaces-2.0.1+8.0.jar";
            "hash" = "sha512-JtSbxnm5u9TVuB8XEABYYFK7zX6QhGPjp2XAF7BvJ16fzwVvILtbp22SNg08cIl10VZ13dHrFqV9SYjt8ROvmg==";
        };
    in {
        "FVmPOb8g" = _FVmPOb8g;
        "DffW3YX7" = _DffW3YX7;
