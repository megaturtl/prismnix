...
let
    ...
    in {
        ...
        "pkg-3.2.5" = _MnNPfpJb;
        "pkg-1.0.0" = _V0j8o5Ar;
        "pkg-1.21-1.0.1" = _F56EGz66;
        "pkg-3.3.1" = _djg2wdNs;
        "pkg-1.21-1.0.2" = _Xc8Xvitm;
        "pkg-1.21-1.2.0" = _jvjSKvWK;
        "pkg-3.5.0" = _qWE7kjAG;
        "pkg-1.21-2.0.0" = _fqngmYqY;
        "pkg-1.21-2.0.1" = _JibRDSus;
        "pkg-1.21-2.1.0" = _md5jcBMM;
        "pkg-3.6.1" = _TZcDOfdX;
        "pkg-3.7.0" = _jsoelU0Q;
        "pkg-1.21.1-2.3.3" = _vcs8BkyZ;
        "pkg-1.21.1-3.0.0" = _zKubAYDp;
        "pkg-3.8.0" = _SG7tFmLr;
        "pkg-1.21.11-1.0.2" = _JRDtLCoZ;
        "pkg-1.21.11-1.0.5" = _TGsnnmZq;
        "pkg-4.0.0" = _2SePL5aw;
        "pkg-4.0.1" = _MUPpL0kD;
