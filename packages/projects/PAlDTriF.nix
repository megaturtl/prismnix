...
let
    versions = (let
        ...
        _SLdzY2lN = {
            "id" = "SLdzY2lN";
            "file" = "LandClaimPlugin-3.0.0.jar";
            "hash" = "sha512-33L/IQl1tVxvtBQBSK6ikKuwrz2T4bywY8Awlh1zaWeBR1epzympz5wXEpIaYc+HNF68ewolOnVSPcVQNgrWfg==";
        };
        _lEmVEJ5s = {
            "id" = "lEmVEJ5s";
            "file" = "LandClaimPlugin-3.1.0.jar";
            "hash" = "sha512-v1T1kRy/Pw4TEAn48wK9JgJ/IkWY2Vpk78XvDyTzFBU28xrr/BEvyCg5LIKR4zLpPE7CWnyRxYgdFh1Ji6vWZg==";
        };
        _7bZlAxVL = {
            "id" = "7bZlAxVL";
            "file" = "LandClaimPlugin-3.2.0.jar";
            "hash" = "sha512-UDUKwablPDG5ODaCQdA8GmpzLd4o6VyS5aUmMctYeXEr+KzKkhvSfnyVTuhyxbavfVLWtP4nKHpKKYTQRf4J5Q==";
        };
        _lndGv2Ps = {
            "id" = "lndGv2Ps";
            "file" = "LandClaimPlugin-3.2.1.jar";
            "hash" = "sha512-vjXVF4Z2YgFQ50nVIGkux408vbrvWb7fTvh5cF+E/YtVJMOQ3CkBvOUBQ+zL8lyYEWyy0cUr4cQnBKxcJsWLmg==";
        };
    in {
        "fhoBLCp9" = _fhoBLCp9;
        "rOhDwpsI" = _rOhDwpsI;
        ...
        "paper-1.21.6" = _lndGv2Ps;
        "paper-1.21" = _g20s70dq;
        "paper-1.21.1" = _g20s70dq;
        "paper-1.21.2" = _g20s70dq;
        "paper-1.21.7" = _lndGv2Ps;
        "paper-1.21.8" = _lndGv2Ps;
        "paper-1.21.9" = _lndGv2Ps;
        "paper-1.21.10" = _lndGv2Ps;
        "paper-1.21.11" = _lndGv2Ps;
        "paper-26.1" = _lndGv2Ps;
        "paper-26.1.1" = _lndGv2Ps;
        "paper-26.1.2" = _lndGv2Ps;
        "paper-26.2" = _lndGv2Ps;
        ...
        "purpur-1.21.6" = _lndGv2Ps;
        "purpur-1.21.7" = _lndGv2Ps;
        "purpur-1.21.8" = _lndGv2Ps;
        "purpur-1.21.9" = _lndGv2Ps;
        "purpur-1.21.10" = _lndGv2Ps;
        "purpur-1.21.11" = _lndGv2Ps;
        "purpur-26.1" = _lndGv2Ps;
        "purpur-26.1.1" = _lndGv2Ps;
        "purpur-26.1.2" = _lndGv2Ps;
        "purpur-26.2" = _lndGv2Ps;
        "folia-1.21.4" = _lj46MIin;
        "folia-1.21.5" = _lj46MIin;
        "folia-1.21.6" = _lndGv2Ps;
        "folia-1.21.7" = _lndGv2Ps;
        "folia-1.21.8" = _lndGv2Ps;
        "folia-1.21.9" = _lndGv2Ps;
        "folia-1.21.10" = _lndGv2Ps;
        "folia-1.21.11" = _lndGv2Ps;
        "folia-26.1" = _lndGv2Ps;
        "folia-26.1.1" = _lndGv2Ps;
        "folia-26.1.2" = _lndGv2Ps;
        "folia-26.2" = _lndGv2Ps;
        "pkg-1.0" = _fhoBLCp9;
        "pkg-1.1" = _bYhA2WBx;
        "pkg-1.2" = _KCU4sGqB;
        "pkg-1.3" = _3GcOuWD7;
