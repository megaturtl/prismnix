...
let
    ...
    in {
        ...
        "paper-1.21.6" = _lEmVEJ5s;
        "paper-1.21" = _g20s70dq;
        "paper-1.21.1" = _g20s70dq;
        "paper-1.21.2" = _g20s70dq;
        "paper-1.21.7" = _lEmVEJ5s;
        "paper-1.21.8" = _lEmVEJ5s;
        "paper-1.21.9" = _lEmVEJ5s;
        "paper-1.21.10" = _lEmVEJ5s;
        "paper-1.21.11" = _lEmVEJ5s;
        "paper-26.1" = _lEmVEJ5s;
        "paper-26.1.1" = _lEmVEJ5s;
        "paper-26.1.2" = _lEmVEJ5s;
        "paper-26.2" = _lEmVEJ5s;
        ...
        "purpur-1.21.6" = _lEmVEJ5s;
        "purpur-1.21.7" = _lEmVEJ5s;
        "purpur-1.21.8" = _lEmVEJ5s;
        "purpur-1.21.9" = _lEmVEJ5s;
        "purpur-1.21.10" = _lEmVEJ5s;
        "purpur-1.21.11" = _lEmVEJ5s;
        "purpur-26.1" = _lEmVEJ5s;
        "purpur-26.1.1" = _lEmVEJ5s;
        "purpur-26.1.2" = _lEmVEJ5s;
        "purpur-26.2" = _lEmVEJ5s;
        "folia-1.21.4" = _lj46MIin;
        "folia-1.21.5" = _lj46MIin;
        "folia-1.21.6" = _lEmVEJ5s;
        "folia-1.21.7" = _lEmVEJ5s;
        "folia-1.21.8" = _lEmVEJ5s;
        "folia-1.21.9" = _lEmVEJ5s;
        "folia-1.21.10" = _lEmVEJ5s;
        "folia-1.21.11" = _lEmVEJ5s;
        "folia-26.1" = _lEmVEJ5s;
        "folia-26.1.1" = _lEmVEJ5s;
        "folia-26.1.2" = _lEmVEJ5s;
        "folia-26.2" = _lEmVEJ5s;
        "pkg-1.0" = _fhoBLCp9;
        "pkg-1.1" = _bYhA2WBx;
        "pkg-1.2" = _KCU4sGqB;
        "pkg-1.3" = _3GcOuWD7;
