...
let
    ...
    in {
        ...
        "pkg-1.1.8" = _cn8IvNut;
        "pkg-1.1.9" = _gYoCJvR4;
        "pkg-1.1.10" = _KPqfYFx5;
        "pkg-1.1.11" = _shak05FH;
        "pkg-1.1.12" = _T28sCBLL;
        "pkg-1.1.13" = _5Mz7HKkh;
        "pkg-1.1.14" = _4juto3Sz;
        "pkg-1.1.15" = _OBolEEcU;
        "pkg-1.1.16" = _ilILI0t3;
        "pkg-1.1.17" = _iwp4DsJK;
        "pkg-1.1.18" = _id4BMCo1;
        "pkg-1.2.0" = _eJu4F94r;
        "pkg-1.2.1" = _Oqo3qse8;
        "pkg-1.2.2" = _xJypzw2J;
        "pkg-1.2.3" = _5lNQqzCe;
        "pkg-1.2.4" = _U6NpMnyt;
        "pkg-1.2.4.b" = _B6RjP6Ww;
        "pkg-1.2.4.c" = _RdQjidXi;
        "pkg-1.2.5" = _hbqTR0El;
        "pkg-1.2.5.b" = _zrF78WqS;
        "pkg-1.2.5.SNAPSHOT-1" = _rVQZZXxJ;
        "pkg-1.2.5.SNAPSHOT-2" = _IrXDXQa1;
        "pkg-1.2.6" = _Z081rwH7;
        "pkg-1.2.6.SNAPSHOT-2" = _XKDP3gDO;
        "pkg-1.2.6.b" = _phelvkHE;
        "pkg-1.2.6.c" = _4ysEN4n3;
        "pkg-1.2.6.d" = _vK0wgDB5;
        "pkg-1.2.7" = _XwLDXerF;
        "pkg-1.2.7.b" = _j9AhoR9X;
        "pkg-1.2.7.c" = _vabd2DRI;
        "pkg-1.2.7.d" = _WYNHsIUu;
        "pkg-1.2.7.e" = _R1CtJRXy;
        "pkg-1.2.7.f" = _xkPBBnS8;
        "pkg-1.2.7.g" = _CdkZavJO;
        "pkg-1.2.7.h" = _vV6tl9ld;
        "pkg-1.2.8" = _dPchGMdZ;
        "pkg-1.2.9" = _yfo2rIrv;
        "pkg-1.2.9.b" = _ZXLsE2qf;
        "pkg-1.2.9.c" = _cOBvLkAF;
        "pkg-1.2.9.d" = _JFhYaP3a;
        "pkg-1.2.9.e" = _KA5Gf4rg;
        "pkg-1.3.0-preview4" = _y2B40OsL;
        "pkg-1.3.0" = _LkP6R4nT;
        "pkg-1.3.1" = _8eUP1Avr;
        "pkg-1.3.2" = _j4ZxxcbE;
        "pkg-2.0.0" = _P0gWpW7Y;
        ...
        "pkg-2.0.8" = _6veBkaak;
        "pkg-2.0.9" = _tVEC7kDx;
        "pkg-2.0.10" = _YW12m7oK;
        "pkg-2.0.11" = _iaHj6457;
        "pkg-2.0.12" = _6Sm3fbJb;
        "pkg-2.0.13" = _Mrkfh7lW;
        "pkg-2.1.0" = _bpx0xEzC;
        "pkg-2.1.1" = _Cc2WPZ0j;
        "pkg-2.1.2" = _qDJsCymP;
        "pkg-2.1.3" = _f5oaKhrn;
        ...
        "pkg-2.2.0" = _i1D2jIwZ;
        "pkg-2.2.1" = _wn3mPSaU;
        "pkg-2.2.1b" = _pmJFALu2;
        "pkg-2.2.2" = _fq6vaJiG;
        "pkg-2.2.2b" = _xqcOSCRj;
        "pkg-2.2.3" = _MX1kUszH;
        "pkg-2.2.4" = _WIxFZoRd;
        "pkg-2.2.5" = _73AaO9k3;
        "pkg-2.2.5b" = _RhbACzlM;
        "pkg-2.3.0" = _o56ltpU3;
        "pkg-2.3.1" = _zjSKnkVT;
        "pkg-2.4.0" = _1ct4DxaA;
        "pkg-2.4.1" = _QclZk1u6;
