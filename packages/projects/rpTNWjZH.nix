...
let
    ...
    in {
        ...
        "pkg-0.1.5" = _VsXhgGK5;
        "pkg-0.1.6" = _UoPRSHFB;
        "pkg-0.1.6+1.20.1" = _L1Kz8HkN;
        "pkg-0.1.7+1.21.1" = _31Y33mfz;
        "pkg-0.1.8+1.21.1-blanketcon" = _qFRA23Y8;
        "pkg-0.1.8+1.21.1-DEMO-BlanketCon" = _yHelGWhQ;
        "pkg-0.2.0+1.21.1" = _HMRGvV8v;
        "pkg-0.2.1+1.21.1" = _guXgOjc0;
        "pkg-0.2.2+1.21.1-beta" = _bPMDu4h4;
        "pkg-0.2.2+1.21.1-beta.1" = _QTn3biFp;
        "pkg-0.2.2+1.21.1-beta.2" = _PsY1sKfn;
        "pkg-0.2.2+1.21.1-beta.3" = _xATKzQoh;
        "pkg-0.2.2+1.21.1-beta.4" = _JbQ02RDp;
        "pkg-0.2.2+1.21.1-beta.5" = _27Kl59NB;
        "pkg-0.2.2+1.21.1-beta.6" = _R61X44q5;
        "pkg-0.2.2+1.21.1-beta.7" = _o8MVD9Md;
        "pkg-0.2.2+1.21.1-beta.8" = _Prjtb0aW;
        "pkg-0.2.2+1.21.1-beta.9" = _3Grd1SsC;
        "pkg-0.2.2+1.21.1-beta.10" = _vgiP3G0f;
        "pkg-0.2.2+1.21.1-beta.11" = _jn8JlQc2;
        "pkg-0.2.2+1.21.1-beta.12" = _1ojxztw2;
        "pkg-0.2.2+1.21.1-beta.13" = _FSAldXWv;
        "pkg-0.2.2+1.21.1-beta.14" = _9TmpOsxq;
        "pkg-0.2.2+1.21.1-beta.15" = _4n4I9MDK;
        "pkg-0.2.2+1.21.1-beta.16" = _xQLrvzjr;
        "pkg-0.2.2+1.21.1-beta.17" = _xefyHvW7;
        "pkg-0.2.2+1.21.1-beta.18" = _hOf08UL3;
        "pkg-0.3.0+1.21.8" = _kGRJ5A8M;
        "pkg-0.3.1+1.21.8" = _hIe5E1No;
        "pkg-0.3.2+1.21.8" = _c0e599ms;
        "pkg-0.2.2+1.21.1" = _FrVISN0y;
        "pkg-0.3.3+1.21.8" = _K05auwYR;
        "pkg-0.2.3+1.21.1" = _oypXGyQ2;
        "pkg-0.2.4+1.21.1" = _K6a7MWgA;
