...
let
    versions = (let
        ...
        _y3VFeR13 = {
            "id" = "y3VFeR13";
            "file" = "ExtendedHorizons-3.1.9-release.jar";
            "hash" = "sha512-PPacYM02Zl5hK1GDgOhATzZbg0sikC4Nx9YFMet/TOSbGQKT7zrxCm24F3iSQ1fu3bPDxRA0uwCMRJswwJExXQ==";
        };
        _EGwLEH2B = {
            "id" = "EGwLEH2B";
            "file" = "ExtendedHorizons-3.1.10-release.jar";
            "hash" = "sha512-9Nbw177f8bwIOsIZRqEvF5Xng+/EtKDmz8JR23oqfxhcv5TkK6HEcWUwT0ROuUmjrG91mZQr6VdBBdn25xFszg==";
        };
        _pgcgd2Cb = {
            "id" = "pgcgd2Cb";
            "file" = "ExtendedHorizons-3.2.0-release.jar";
            "hash" = "sha512-Sua/rYo9cc6cOB7AID69GbrPmDLbpIVytkl8iEJQ5rD/D/2LG1LcWdRW3rcAnx+O9D89u4yYU8QUzSbm2kPTwQ==";
        };
        _WGl3qgCv = {
            "id" = "WGl3qgCv";
            "file" = "ExtendedHorizons-3.2.1-release.jar";
            "hash" = "sha512-2PA4RsTP1n9JJPDWVmRjlfLO9vZIK98Cw2fWpX1/7zXbrndQ4BWtVqVQRIESlbvMeSdw4j4bbqwQRS8jzZXP6g==";
        };
    in {
        "EzhfPCc0" = _EzhfPCc0;
        "1nrDEarD" = _1nrDEarD;
        ...
        "pgcgd2Cb" = _pgcgd2Cb;
        "WGl3qgCv" = _WGl3qgCv;
        "paper-1.21" = _WGl3qgCv;
        "paper-1.21.1" = _WGl3qgCv;
        "paper-1.21.2" = _WGl3qgCv;
        "paper-1.21.3" = _WGl3qgCv;
        "paper-1.21.4" = _WGl3qgCv;
        "paper-1.21.5" = _WGl3qgCv;
        "paper-1.21.6" = _WGl3qgCv;
        "paper-1.21.7" = _WGl3qgCv;
        "paper-1.21.8" = _WGl3qgCv;
        "paper-1.21.9" = _WGl3qgCv;
        "paper-1.21.10" = _WGl3qgCv;
        "paper-1.21.11" = _WGl3qgCv;
        "paper-1.20" = _y3VFeR13;
        "paper-1.20.1" = _y3VFeR13;
        "paper-1.20.2" = _y3VFeR13;
        "paper-1.20.3" = _y3VFeR13;
        "paper-1.20.4" = _y3VFeR13;
        "paper-1.20.5" = _y3VFeR13;
        "paper-1.20.6" = _y3VFeR13;
        "paper-26.1" = _WGl3qgCv;
        "paper-26.1.1" = _WGl3qgCv;
        "paper-26.1.2" = _WGl3qgCv;
        "paper-26.2" = _WGl3qgCv;
        "folia-1.21" = _WGl3qgCv;
        "folia-1.21.1" = _WGl3qgCv;
        "folia-1.21.2" = _WGl3qgCv;
        "folia-1.21.3" = _WGl3qgCv;
        "folia-1.21.4" = _WGl3qgCv;
        "folia-1.21.5" = _WGl3qgCv;
        "folia-1.21.6" = _WGl3qgCv;
        "folia-1.21.7" = _WGl3qgCv;
        "folia-1.21.8" = _WGl3qgCv;
        "folia-1.21.9" = _WGl3qgCv;
        "folia-1.21.10" = _WGl3qgCv;
        "folia-1.21.11" = _WGl3qgCv;
        "folia-1.20" = _y3VFeR13;
        "folia-1.20.1" = _y3VFeR13;
        "folia-1.20.2" = _y3VFeR13;
        "folia-1.20.3" = _y3VFeR13;
        "folia-1.20.4" = _y3VFeR13;
        "folia-1.20.5" = _y3VFeR13;
        "folia-1.20.6" = _y3VFeR13;
        "folia-26.1" = _WGl3qgCv;
        "folia-26.1.1" = _WGl3qgCv;
        "folia-26.1.2" = _WGl3qgCv;
        "folia-26.2" = _WGl3qgCv;
        "pkg-1.0.2" = _EzhfPCc0;
        "pkg-1.0.3" = _1nrDEarD;
        "pkg-1.1.0" = _43vnn3m6;
        "pkg-1.1.1" = _KOxZqPQL;
        ...
        "pkg-3.1.9-release" = _y3VFeR13;
        "pkg-3.1.10-release" = _EGwLEH2B;
        "pkg-3.2.0-release" = _pgcgd2Cb;
        "pkg-3.2.1-release" = _WGl3qgCv;
        "default" = _WGl3qgCv;
    });
