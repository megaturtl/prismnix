...
let
    ...
    in {
        ...
        "pkg-5.1.6+1.19.2" = _1XKrPvhJ;
        "pkg-5.2.1+1.20.1" = _Xfnu3O9t;
        "pkg-5.2.0+1.20.1-forge" = _HwIgW0JK;
        "pkg-5.1.9.2+1.19.2" = _MQPxtDCt;
        "pkg-6.1.0+1.20.1-forge" = _bOl0KTGi;
        "pkg-6.1.1+1.20.1-forge" = _zXyKQIDw;
        "pkg-6.2.5+1.20.1-forge" = _qJ1ZoSxE;
        "pkg-6.3.0+1.20.1" = _loNXuAzD;
        "pkg-6.3.1+1.20.1" = _BpnrMufG;
        "pkg-6.3.2+1.20.1" = _U7JrmruX;
        "pkg-6.3.3+1.20.1" = _6YfjHP7y;
        "pkg-6.3.4+1.20.1" = _iJ68IVwV;
        "pkg-6.3.5+1.20.1" = _Dm54tiEC;
        "pkg-6.3.6+1.20.1" = _DvWPMcwT;
        "pkg-6.3.7+1.20.1" = _hYyr1DaK;
        "pkg-6.3.8+1.20.1" = _16xfLaoG;
        "pkg-6.3.9+1.20.1" = _Keb7KTFW;
        "pkg-6.3.10+1.20.1" = _ugdhW91o;
        "pkg-6.4.0+1.20.1-forge" = _dnowh7ci;
        "pkg-6.4.0+1.20.1-fabric" = _HbMIM7ns;
        "pkg-6.4.1+1.20.1-forge" = _Dc6D9ZEZ;
        "pkg-6.4.1+1.20.1-fabric" = _UExsKmQm;
        "pkg-6.4.2+1.20.1-forge" = _m764GGOl;
        "pkg-6.4.2+1.20.1-fabric" = _QkPbMC2S;
        "pkg-6.4.3+1.20.1-forge" = _965Zbai1;
        "pkg-6.4.3+1.20.1-fabric" = _IxFl5dv5;
        "pkg-6.4.4+1.20.1-fabric" = _fkhalvVp;
        "pkg-6.4.4+1.20.1-forge" = _wiR6x39F;
        "pkg-6.4.5+1.20.1-forge" = _4X4ROLk5;
        "pkg-6.4.5+1.20.1-fabric" = _goRtT5Tq;
        "pkg-6.4.6+1.20.1-fabric" = _aePGEh48;
        "pkg-6.4.6+1.20.1-forge" = _RqmxQOJO;
        "pkg-6.5.0+1.20.1-forge" = _zgWhagkx;
        "pkg-6.5.0+1.20.1-fabric" = _dA98fWOp;
        "pkg-7.0.0-alpha-1" = _u5LIMrTI;
        "pkg-7.0.0-alpha-2" = _vTvo0T8t;
        "pkg-7.0.0-alpha-3" = _ehWlEkqs;
        "pkg-7.0.0-alpha-4" = _ugLJKDs5;
        "pkg-6.5.1+1.20.1-forge" = _4ynZIbqA;
        "pkg-6.5.1+1.20.1-fabric" = _gENbnHQY;
        "pkg-7.0.0-alpha-5" = _JKSFafwF;
        "pkg-7.0.0-alpha-6" = _hKWjx1oU;
        "pkg-7.0.0-alpha-7" = _BHcCipRY;
        "pkg-7.0.0-alpha-8" = _3Xajhawc;
        "pkg-7.0.0-alpha-9" = _lIjeHdBs;
        "pkg-7.0.1-alpha-1" = _ObE9mmL8;
        "pkg-7.0.1-alpha-2" = _3s1eGGmX;
        "pkg-7.0.1-alpha-3" = _hCK9OzEI;
        "pkg-7.0.1-alpha-4" = _dS73JPbM;
        "pkg-7.0.1-alpha-5" = _m3NGXmka;
        "pkg-7.0.1-alpha-6" = _9eaTOpSi;
        "pkg-7.0.2-alpha-1" = _KvH8hXbd;
        "pkg-7.0.2-alpha-2" = _gvxP983b;
        "pkg-7.0.2-alpha-3" = _fPvemcS5;
        "pkg-6.6.0+1.20.1-forge" = _aAQFR1qG;
        "pkg-6.6.0+1.20.1-fabric" = _yUzRZcHV;
        "pkg-7.0.2-alpha-4" = _kLX8kbbU;
        "pkg-7.0.3-alpha-1" = _PAZhc45X;
        "pkg-7.0.3-alpha-2" = _UfzZSQSf;
        "pkg-7.0.3-alpha-4" = _eeyJZI2B;
        "pkg-7.0.3-alpha-5" = _742MEixD;
        "pkg-7.0.3-alpha-5-alt" = _VXqpdlsT;
        "pkg-7.0.3-alpha-6" = _tohzwHoB;
        "pkg-7.0.3-alpha-7" = _WJ9z48e2;
        "pkg-7.0.3-alpha-8" = _IfI4PIxC;
        "pkg-7.0.3-alpha-9" = _DAWh8eZg;
        "pkg-7.0.4-alpha-1" = _1SdCnscB;
        "pkg-Fabric-6.7.0+1.20.1" = _DcJHKCks;
        "pkg-Forge-6.7.0+1.20.1" = _crIUXD9T;
        "pkg-Fabric-6.7.1+1.20.1" = _5bbJb9iv;
        "pkg-Forge-6.7.1+1.20.1" = _ANzUDs5A;
        "pkg-Fabric-6.7.2+1.20.1" = _mrEFKfAX;
        "pkg-Forge-6.7.2+1.20.1" = _le0RhbFW;
        "pkg-Fabric-6.7.3+1.20.1" = _KUCloeeb;
        "pkg-Forge-6.7.3+1.20.1" = _UKU7wBdp;
        "pkg-Forge-6.7.4+1.20.1" = _IoJdd884;
        "pkg-Fabric-6.7.4+1.20.1" = _H3CJqodI;
        "pkg-Fabric-6.7.5+1.20.1" = _2WIBLWRm;
        "pkg-Forge-6.7.5+1.20.1" = _ukUEMDHJ;
        "pkg-Fabric-6.7.6+1.20.1" = _ftpeQScn;
        "pkg-Forge-6.7.6+1.20.1" = _4RLu87qB;
        "pkg-7.0.4-pre.1" = _AIN8KVLv;
        "pkg-Fabric-6.7.7+1.20.1" = _4OnBLPVl;
        "pkg-Forge-6.7.7+1.20.1" = _37FZDqYp;
        "pkg-7.0.4-pre.2" = _OazQ2H7O;
        "pkg-Fabric-6.7.8+1.20.1" = _R8VKTY4x;
