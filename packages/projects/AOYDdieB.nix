...
let
    ...
    in {
        ...
        "pkg-1.0.1+1.21.1-neoforge" = _Tm3gZCST;
        "pkg-1.0.1+1.20.1-fabric" = _OxRoq1gH;
        "pkg-1.0.2+1.20.1-fabric" = _HdYA7nvE;
        "pkg-1.0.2+1.20.1-forge" = _hv6XQnT3;
        "pkg-1.0.3+1.20.1-fabric" = _V3ApyDtL;
        "pkg-1.0.3+1.20.1-forge" = _OODkgXI3;
        "pkg-1.0.3+1.21.1-fabric" = _ynSweZ8W;
        "pkg-1.0.3+1.21.1-neoforge" = _9NqPFCUW;
        "pkg-1.1.0+1.20.1-fabric" = _UU91vvyV;
        "pkg-1.1.0+1.20.1-forge" = _Yr98s4xJ;
        "pkg-1.1.0+1.21.1-fabric" = _aouCRB0r;
        "pkg-1.1.0+1.21.1-neoforge" = _ovFOq7Em;
        "pkg-1.1.0.fix+1.20.1-fabric" = _to8uEVB5;
        "pkg-1.1.0.fix+1.20.1-forge" = _3e4Lb8pT;
        "pkg-1.2.0+1.20.1-fabric" = _xEKDUXSf;
        "pkg-1.2.0+1.20.1-forge" = _aJ23032U;
        "pkg-1.2.0+1.21.1-fabric" = _4h6qYCVS;
        "pkg-1.2.0+1.21.1-neoforge" = _fEuGgluj;
        "pkg-1.2.1+1.20.1-fabric" = _cNfX5Lk0;
        "pkg-1.2.1+1.20.1-forge" = _2x12vuAf;
        "pkg-1.2.1+1.21.1-fabric" = _p1mBkWNU;
        "pkg-1.2.1+1.21.1-neoforge" = _q9nzEZcw;
        "pkg-1.2.2+1.21.1-neoforge" = _umdgb0MF;
        "pkg-1.2.3+1.20.1" = _obmrkLkK;
        "pkg-1.2.3+1.21.1" = _PxQxAsWr;
        "pkg-1.2.4+1.20.1" = _8NKmcXJn;
        "pkg-1.2.5+1.20.1" = _kCXjJlDd;
        "pkg-1.2.5+1.21.1" = _qyp2bwcd;
        "pkg-1.3.0+1.21.11" = _rHav2JDh;
        "pkg-1.2.6+1.21.1-fabric" = _rC0D1aqg;
        "pkg-1.2.6+1.21.1-neoforge" = _cHbZF6TB;
        "pkg-1.3.1+1.21.11-fabric" = _EArS995P;
        "pkg-1.3.1+1.21.11-neoforge" = _rUnwt6rN;
        "pkg-1.2.6+1.20.1-fabric" = _Zappzk7U;
