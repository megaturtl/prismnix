...
let
    ...
    in {
        ...
        "pkg-0.2.8" = _OIo2wwp5;
        "pkg-0.2.9" = _4F2QOMCH;
        "pkg-0.2.10" = _bpWE1way;
        "pkg-0.2.11" = _jl1FZX9a;
        "pkg-0.2.12" = _CzbAVUK4;
        "pkg-0.2.13" = _vzCwq3Bl;
        "pkg-0.3.0" = _3VrSBVqF;
        "pkg-0.3.1" = _phtEfp7K;
        "pkg-0.3.2" = _abGOOicX;
        "pkg-0.4.0" = _ulu7fSoi;
        ...
        "pkg-1.2.8" = _OXCY0CpU;
        "pkg-1.2.9" = _VNUQL7vw;
        "pkg-1.2.10" = _eQ5Ui917;
        "pkg-1.2.11" = _a7atsqPu;
        "pkg-1.3.0" = _U2zLKDOu;
        "pkg-1.3.1" = _QhIvaRDY;
        "pkg-1.3.2" = _W8p5mkKC;
        "pkg-1.3.0.1" = _osUJ4123;
        "pkg-1.3.3" = _un5RfmiM;
        "pkg-1.3.4" = _OM57bqLA;
        "pkg-1.3.5" = _JefTrk7g;
        "pkg-1.3.6" = _h7hSjQmK;
        "pkg-1.3.7" = _5ycqszHo;
        "pkg-1.3.8" = _MPAoOK19;
        "pkg-1.3.2.1" = _9b3Pn8ey;
        "pkg-1.3.9" = _i9EuD8kI;
        "pkg-1.3.10" = _DLaYixPB;
        "pkg-1.3.11" = _kFn6iXxI;
        "pkg-1.3.12" = _iDmMPfOO;
        "pkg-1.3.13" = _Aq7wC3kv;
        "pkg-1.4.0" = _hW9dk5tW;
        "pkg-1.4.1" = _guJTf88z;
        "pkg-1.4.2" = _cEUoYVjN;
        "pkg-1.4.3" = _Y9zsgkwF;
