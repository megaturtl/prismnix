...
let
    ...
    in {
        ...
        "pkg-v1.2.0+1.20.4+fabric" = _wUIoFsVm;
        "pkg-v1.2.1+1.20.4+fabric" = _ooTDvgKx;
        "pkg-v1.2.1+1.20.4+neoforge" = _Xq9852Cm;
        "pkg-v1.2.2+1.20.4+fabric" = _8e9uUsd4;
        "pkg-v1.2.2+1.20.4+neoforge" = _b1sNoPp1;
        "pkg-v1.3.0+1.20.4+fabric" = _Y7nw1YKo;
        "pkg-v1.3.0+1.20.4+neoforge" = _tmYfTOcs;
        "pkg-v1.3.1+1.20.4+neoforge" = _CGtiVJ6S;
        "pkg-v1.3.1+1.20.4+fabric" = _SDjkZPHy;
        "pkg-v1.3.2+1.20.5+fabric" = _2bjVqIvU;
        "pkg-v1.3.2+1.20.4+1.20.4+neoforge" = _X2RS4ij2;
        "pkg-v1.3.2+1.20.4+1.20.4+fabric" = _rTUlvbKU;
        "pkg-v1.4.0+1.20.5++neoforge" = _Yc1nNeWs;
        "pkg-v1.4.0+1.20.4+1.20.4+fabric" = _1kXqyIrF;
        "pkg-v1.4.0+1.20.5++fabric" = _kYIkcIi9;
        "pkg-v1.4.0+1.20.4+1.20.4+neoforge" = _AMaDp2NR;
        "pkg-v1.4.1+1.20.4+1.20.4+fabric" = _Th1x2hrH;
        "pkg-v1.4.1+1.20.4+1.20.4+neoforge" = _XFkRs9hD;
        "pkg-v1.4.1+1.20.6+neoforge" = _ev6JE3vm;
        "pkg-v1.4.2+1.20.4+neoforge" = _DW4OfaaT;
        "pkg-v1.4.2+1.20.4+fabric" = _BHuCtVcu;
        "pkg-v1.4.2+1.20.6+neoforge" = _hQaOCz4M;
        "pkg-v1.4.2+1.20.6+fabric" = _fKIwLovQ;
        "pkg-v1.4.3+1.20.6+neoforge" = _NMlKquHM;
        "pkg-v1.4.3+1.20.6+fabric" = _mCUQpIiM;
        "pkg-v1.5.0+1.20.6+neoforge" = _L2k1oeIv;
        "pkg-v1.5.0+1.20.6+fabric" = _hzkCcByO;
        "pkg-v1.5.0+1.20.4+neoforge" = _GInNE98g;
        "pkg-v1.5.0+1.20.4+fabric" = _P0mf58si;
        "pkg-v1.5.1+1.20.4+neoforge" = _oX3QIEkm;
        "pkg-v1.5.1+1.20.6+fabric" = _mRL4dVHR;
        "pkg-v1.5.1+1.20.6+neoforge" = _vZm1y33m;
        "pkg-v1.5.1+1.20.4+fabric" = _R1EAUbyv;
        "pkg-v1.5.1+1.21+neoforge" = _J3xATIDx;
        "pkg-v1.5.1+1.21+fabric" = _aZLG5Hfg;
        "pkg-v1.5.2+1.21+neoforge" = _M7xFvD7l;
        "pkg-v1.5.2+1.21+fabric" = _iniBUyzS;
        "pkg-v1.5.2+1.20.4+fabric" = _2KCvR0vt;
        "pkg-v1.5.2+1.20.4+neoforge" = _2AMgZNor;
        "pkg-v1.5.3+1.21+neoforge" = _OdUxOQRn;
        "pkg-v1.5.3+1.21+fabric" = _w9NwHNGf;
        "pkg-v1.5.3+1.20.4+fabric" = _HAAIYVQr;
        "pkg-v1.5.3+1.20.4+neoforge" = _8FFyXSIt;
        "pkg-v1.5.4+1.21+neoforge" = _GeS0s0cN;
        "pkg-v1.5.4+1.21+fabric" = _LaIBTfvN;
        "pkg-v1.5.4+1.20.4+fabric" = _MhQbalgW;
        "pkg-v1.5.4+1.20.4+neoforge" = _cDFVzvmT;
        "pkg-v1.5.5+1.21+fabric" = _cdxE61qA;
        "pkg-v1.5.5+1.21+neoforge" = _gn9K9PHK;
        "pkg-v1.5.5+1.20.4+fabric" = _xJqoKofA;
        "pkg-v1.5.5+1.20.4+neoforge" = _RQ5LVwlh;
        "pkg-v1.5.6+1.21+fabric" = _d58eH8A7;
        "pkg-v1.5.6+1.21+neoforge" = _CzcXHjGb;
        "pkg-v1.5.6+1.20.4+fabric" = _uTBK8AgJ;
        "pkg-v1.5.6+1.20.4+neoforge" = _ZAKTJoQY;
        "pkg-v1.5.7+1.21+fabric" = _1ZwFxnV8;
        "pkg-v1.5.7+1.21+neoforge" = _LY3LE0jv;
        "pkg-v1.5.7+1.20.4+fabric" = _h4D2a79b;
        "pkg-v1.5.7+1.20.4+neoforge" = _Fto5jGAy;
        "pkg-v1.6.0+1.21+fabric" = _IstFwyLa;
        "pkg-v1.6.0+1.21+neoforge" = _XCrObDCC;
        "pkg-v1.6.1+1.21.1+neoforge" = _Bfa5NLn3;
        "pkg-v1.6.1+1.21.1+fabric" = _O7tzhGhw;
        "pkg-v1.6.2+1.21.1+neoforge" = _sg5LMfFo;
        "pkg-v1.6.2+1.21.1+fabric" = _dTCpkMuT;
        "pkg-v1.6.3+1.21.1-fabric" = _9ycBxBUD;
        "pkg-v1.6.3+1.21.1-neoforge" = _XRgp6Osw;
        "pkg-v1.6.4+1.21.1-fabric" = _JMid9Uxj;
        "pkg-v1.6.4+1.21.1-neoforge" = _GRAV55Id;
        "pkg-v1.7.0+1.21.1-fabric" = _mOeEJa9r;
        "pkg-v1.7.0+1.21.1-neoforge" = _k15AlNTT;
        "pkg-v1.7.0+1.21.2-neoforge" = _vsQSi2pG;
        "pkg-v1.7.0+1.21.2-fabric" = _BRu8hQyM;
        "pkg-v1.7.1+1.21.3-neoforge" = _6fkbO785;
        "pkg-v1.7.1+1.21.3-fabric" = _NcoY49LK;
        "pkg-v1.7.1+1.21.1-fabric" = _2bN4Wf3Y;
        "pkg-v1.7.2+1.21.3-neoforge" = _RBdAJVQb;
        "pkg-v1.7.2+1.21.3-fabric" = _7r51NSUr;
        "pkg-v1.7.2+1.21.1-neoforge" = _WTyYfR4M;
        "pkg-v1.7.2+1.21.1-fabric" = _g6aDiF2y;
        "pkg-v1.7.2+1.21.4-neoforge" = _CXXM4QGU;
        "pkg-v1.7.2+1.21.4-fabric" = _DQYEJxjK;
        "pkg-v1.7.3+1.21.1-neoforge" = _bfV6JLt2;
        "pkg-v1.7.3+1.21.4-neoforge" = _90bYE9PX;
        "pkg-v1.7.3+1.21.1-fabric" = _aue9LJKz;
        "pkg-v1.7.3+1.21.4-fabric" = _D81hMble;
        "pkg-v1.7.4+1.21.4-fabric" = _t7yf6sKc;
        "pkg-v1.7.4+1.21.1-neoforge" = _uBf5UecT;
        "pkg-v1.7.4+1.21.1-fabric" = _C7VXxjJm;
        "pkg-v1.7.4+1.21.4-neoforge" = _Afx2KSIa;
        "pkg-v1.7.4+1.21.5-fabric" = _y6Sct6eg;
        "pkg-v1.7.4+1.21.5-neoforge" = _akv3rC8H;
        "pkg-v1.7.5+1.21.5-fabric" = _qfujcbwI;
        "pkg-v1.7.5+1.21.5-neoforge" = _andNiruH;
        "pkg-v1.7.5+1.21.1-neoforge" = _Elj4cwJD;
        "pkg-v1.8.0+1.21.6-neoforge" = _RcpFg61E;
        "pkg-v1.8.0+1.21.6-fabric" = _mutfs5ym;
        "pkg-v1.8.1+1.21.7-fabric" = _3JwugZML;
        "pkg-v1.8.1+1.21.7-neoforge" = _6dgLh0in;
        "pkg-v1.8.2+1.21.8-fabric" = _VdHjfyXH;
        "pkg-v1.8.2+1.21.8-neoforge" = _7eL6zyVp;
        "pkg-v1.8.3+1.21.8-neoforge" = _dMcVW0tH;
        "pkg-v1.8.3+1.21.8-fabric" = _D9ednOrX;
        "pkg-v1.8.4+1.21.10-neoforge" = _Qmte7NU9;
        "pkg-v1.8.4+1.21.10-fabric" = _NiBsIGpM;
        "pkg-v1.7.7+1.21.1-neoforge" = _UPCuOPdg;
        "pkg-v1.7.7+1.21.1-fabric" = _3YVHln9A;
        "pkg-v1.8.5+1.21.10-neoforge" = _a8R9Cdzc;
        "pkg-v1.8.5+1.21.10-fabric" = _3SzipK2P;
        "pkg-v1.8.5+1.21.11-fabric" = _CjpzKeaK;
        "pkg-v1.8.5+1.21.11-neoforge" = _2BMpBrDt;
