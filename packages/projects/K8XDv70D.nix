...
let
    ...
    in {
        ...
        "pkg-0.2.8" = _QQQAdwtk;
        "pkg-0.2.9" = _GuaBGvRF;
        "pkg-0.2.10" = _IbkKmbKC;
        "pkg-0.2.11" = _22gxyBHM;
        "pkg-0.2.12" = _q9HhdAxo;
        "pkg-0.2.13" = _RpLpOIfX;
        "pkg-0.2.14" = _dEAMlWKK;
        "pkg-0.2.15" = _s2DqUeKl;
        "pkg-0.2.16" = _uQht2JIm;
        "pkg-0.2.17" = _HMQnKeUN;
        "pkg-0.2.18" = _q4Eg0pXN;
        "pkg-0.2.19" = _oFsJa6YR;
        "pkg-0.2.20" = _tiBTO1Iy;
        "pkg-0.2.21" = _1SV8c7DJ;
        "pkg-0.2.22" = _fOHb721t;
        "pkg-0.3.0" = _fLhxwvJr;
        "pkg-0.3.1" = _peVlgeq6;
        "pkg-0.3.2" = _rGZPAozz;
        "pkg-0.3.3" = _tRH8FJPw;
        ...
        "pkg-0.3.8" = _nxH8wObn;
        "pkg-0.3.9" = _5oH1jo2a;
        "pkg-0.3.10" = _7HsVL1HU;
        "pkg-0.3.11" = _hvczdreQ;
        "pkg-0.3.12" = _hvqQYzSg;
        "pkg-0.3.13" = _gvBWxycY;
        "pkg-0.3.14" = _tdmRzRtk;
        "pkg-0.3.15" = _yI30FIaI;
        "pkg-0.3.16" = _rKbUs2Rk;
        "pkg-0.3.17" = _cySb8JzY;
