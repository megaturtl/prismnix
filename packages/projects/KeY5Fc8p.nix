...
let
    ...
    in {
        ...
        "fabric-1.20.1" = _chd2u5m4;
        "fabric-26.2" = _IxREy3O7;
        "forge-1.21.1" = _cFioLwZ3;
        "forge-1.20.1" = _6rOnK2dg;
        "neoforge-1.21.1" = _rOjOs77z;
        "neoforge-26.2" = _GJerkb8X;
        "pkg-0.2.0" = _QrEsmAzo;
