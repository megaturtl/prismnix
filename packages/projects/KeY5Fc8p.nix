...
let
    versions = (let
        ...
        _TuT1eHlL = {
            "id" = "TuT1eHlL";
            "file" = "playermob-fabric-0.89.0+1.21.1.jar";
            "hash" = "sha512-ZCOrAAyTA6IhiVMi65xpHmaptfJ7AuWeLosyGPNFyB5WZixcQyVl1AfNaEG95ia0QesxSB4jzO2oiGVNGOIDXw==";
        };
        _oBFad5r5 = {
            "id" = "oBFad5r5";
            "file" = "playermob-fabric-0.89.0+1.20.1.jar";
            "hash" = "sha512-bvhJDrrghhJX1O8VJYjoUq1JYASjVba1/WswciDYloao27yVKIuFOoCh9uF+fpVe0Cpl3gKZ8aIcDbetGQdKSw==";
        };
        _5carC5f5 = {
            "id" = "5carC5f5";
            "file" = "playermob-forge-0.89.0+1.21.1.jar";
            "hash" = "sha512-wAwOBzucxpV9eauVzKFeK9QT3YkfmE7F+rmxtrdCSR5RlPD853+RHm7tdkmWdT/3mpx8X6PE1xkqbiLR2+0zMg==";
        };
        _j20Cgs8l = {
            "id" = "j20Cgs8l";
            "file" = "playermob-forge-0.89.0+1.20.1.jar";
            "hash" = "sha512-62AmpsE8ARqeXqlSLW03q7ehXxfJYVwshbhosCH/MyOsOooHXPJcOevgxapQO1QvmDCvpCxKJCo47/nnzZLrnw==";
        };
        _p5dDdlaE = {
            "id" = "p5dDdlaE";
            "file" = "playermob-neoforge-0.89.0+1.21.1.jar";
            "hash" = "sha512-hkOA5X49N6cQZVKUeMwCCz9PZLvYnRekH7nLAhpMmkNmJKHYoezIpJAzwJuGe8Q4pvvtT9rq+b1eHSSHZyNUlw==";
        };
        _TUz93R0O = {
            "id" = "TUz93R0O";
            "file" = "playermob-fabric-0.89.0+26.2.jar";
            "hash" = "sha512-Bwa/CUGlYqBkhb21rmuTzeTso1Yx6PtzJQ0q/5py7/K8IAFNpJL/ofW4MgSMp2qLVCK1rxd/Y2vXN+NvErcM+Q==";
        };
        _paESdnXr = {
            "id" = "paESdnXr";
            "file" = "playermob-neoforge-0.89.0+26.2.jar";
            "hash" = "sha512-0s6y+5nlJReuuGJATpjH7E4vH2cf5XmP5Lm6z07/wccC2ZbH0sQgq4Z3M/KRKHL9w4qTa/B5Zb4buL06NEqY2w==";
        };
        _UqdQCzmQ = {
            "id" = "UqdQCzmQ";
            "file" = "playermob-fabric-0.92.0+1.21.1.jar";
            "hash" = "sha512-wmiolFRNvJC/hIE+EjLPZhkjJadA6yvqFKsiaWDcAJMgO9X+Ag1PCD/bspE4LILST290KstZ+/bfq9dFTFMrFw==";
        };
        _NjRQatFi = {
            "id" = "NjRQatFi";
            "file" = "playermob-fabric-0.92.0+1.20.1.jar";
            "hash" = "sha512-ghRCp9pCxtJrhPFTJIBic22BAYlZ8Ku6uov4cF3gdHSnPY0KWc/sYIAN53QagpS842VLPi1PXNeOYFKBsOG43Q==";
        };
        _okM7oaCN = {
            "id" = "okM7oaCN";
            "file" = "playermob-forge-0.92.0+1.21.1.jar";
            "hash" = "sha512-U7Y1v3WwUYObbZZ/q3kFaar1MgfblICO9aO8IMO3e4352hP/wJpZvGMvqqeqv/qv8I7f9IQRmDysO41ybiupqA==";
        };
        _VAlFPLxd = {
            "id" = "VAlFPLxd";
            "file" = "playermob-forge-0.92.0+1.20.1.jar";
            "hash" = "sha512-diY7nVqKjRgbC3pD7OKkodLsrihe/LDzpKUxR+IbHqg8jw3g4Gwguy37r+763+n5V9HxBFq0vblMzwFwnoF/Xw==";
        };
        _AlBy1HeM = {
            "id" = "AlBy1HeM";
            "file" = "playermob-neoforge-0.92.0+1.21.1.jar";
            "hash" = "sha512-MYvzOtW7kjI3kIi5A0PxEHo9aNL3ESH0rFbeksxHn19bsl4/JYr+63uxCKYUJkfK+iJo7Wf0VP1KsINaCO3Yqw==";
        };
        _f5ogLjdO = {
            "id" = "f5ogLjdO";
            "file" = "playermob-fabric-0.92.0+26.2.jar";
            "hash" = "sha512-5z4N0PPdSvpbP3s4Pyzj7NYUVGtW6GgPa5TBx84FqrwPOVPc7KxPXGrDzveoOr+yDaAN7weJtEg0P0uYOYlK1w==";
        };
        _peppK289 = {
            "id" = "peppK289";
            "file" = "playermob-neoforge-0.92.0+26.2.jar";
            "hash" = "sha512-cgM5mnU2q6v7Mwz4A4ObLzlRTuQAnVdzbFhc3y1wzbitrywjaUFT30bND7OWwYIUHaoBx+h7RElnILrK5iNLxA==";
        };
        _zoManeQI = {
            "id" = "zoManeQI";
            "file" = "playermob-fabric-0.94.0+1.21.1.jar";
            "hash" = "sha512-7eyAShYrLytgSyu8KP4f/BlOeHy7mnwKSDTWeSmE0PdNg1oQ9+j9xkMpzx+1753UFPwpTVxgmFyNkmV9xwkuyg==";
        };
        _yNAQ2CA9 = {
            "id" = "yNAQ2CA9";
            "file" = "playermob-fabric-0.94.0+1.20.1.jar";
            "hash" = "sha512-WYYFG5QCGRYj+6ctpxMk5mgJslyW6B6UPP0MjIFISBZ70ZLYIpU7AH6UIqTf3eOOqvItNgp60ohN3gSMxkwBtQ==";
        };
        _pE8uZGjR = {
            "id" = "pE8uZGjR";
            "file" = "playermob-forge-0.94.0+1.21.1.jar";
            "hash" = "sha512-mfWjSWJ6uCSXH6MKg+0XvWG6KZUxqw/Dp1Og86kAfpslFKyRL//qP9Pbt1e8C1ZNbraXMSlIurtuLnXF7Zkv0Q==";
        };
        _YkycoHOS = {
            "id" = "YkycoHOS";
            "file" = "playermob-forge-0.94.0+1.20.1.jar";
            "hash" = "sha512-VBXaWqtsSYIrYx6+xM2lIWiYItIxRFOh3I8fJ1RmCBJYPbtGJZRtcQt7TMheY420VkpzeZTRNl3nCO5Au0KGAw==";
        };
        _s0uLmHrV = {
            "id" = "s0uLmHrV";
            "file" = "playermob-neoforge-0.94.0+1.21.1.jar";
            "hash" = "sha512-EgV7Mlpd+muEe8wyAZOYvA7ndKKCiyLQgNTcN88S0mgJDHsuAEybP3on2sM814YPn8wucw92EvQBta0eG8FmRQ==";
        };
        _lNHqLbt1 = {
            "id" = "lNHqLbt1";
            "file" = "playermob-fabric-0.94.0+26.2.jar";
            "hash" = "sha512-HNLVTmmwspAXRTbhNoaletsf01Aw0dp3JdhZJUcxVREaM9f19K75a49pFsndpQbcN1ezLLv3xQuPHDLQOaOCSA==";
        };
        _5S9VZGax = {
            "id" = "5S9VZGax";
            "file" = "playermob-neoforge-0.94.0+26.2.jar";
            "hash" = "sha512-jZJ6uQHpNTfj5oBrpcE9IwudcR6irRWPdzYOR9grlr1iAL9N8WU/eiPmLt9oVDXRcozIEpIZEBxzHSQ69iMOsg==";
        };
        _pRcmWewv = {
            "id" = "pRcmWewv";
            "file" = "playermob-fabric-0.96.0+1.21.1.jar";
            "hash" = "sha512-mhXaobgO4kiJ/WX5ALjVdM2zfPViJd1Wk2l4umME1EsgXiXVPy6yksPXR+iG+x51s9KyG1XD8e2fCaSMi3Z9wQ==";
        };
        _VcLWwiUR = {
            "id" = "VcLWwiUR";
            "file" = "playermob-fabric-0.96.0+1.20.1.jar";
            "hash" = "sha512-ea0qaaYzSRjLSu2UxvcxeXr0+uYZ2Hgy6Y0D1P99QfkfWeuYDiJ31z3csgL3frkG4p94Kh8Q1ZBOxA0k9IdmoA==";
        };
        _LSv6xvfp = {
            "id" = "LSv6xvfp";
            "file" = "playermob-forge-0.96.0+1.21.1.jar";
            "hash" = "sha512-JqG6szsl9Kpf/TISwpYwsETexFwADeu99LmPALbe5110nq6wnodIHSTQbACA8m9Wc09znHmZA05DQFSTZdqLPg==";
        };
        _hVzQmKa4 = {
            "id" = "hVzQmKa4";
            "file" = "playermob-forge-0.96.0+1.20.1.jar";
            "hash" = "sha512-XSsvxuHauA/Fh37btxNnxSjXjVtk5aV3uuIHGM9WUWreMKONrXPUcYbzs2tVv9DSxtaZ+3Fx/L/tcXkt6ztOHQ==";
        };
        _ElPH9pPG = {
            "id" = "ElPH9pPG";
            "file" = "playermob-neoforge-0.96.0+1.21.1.jar";
            "hash" = "sha512-fvoMM4ca6IHBVYAiq0icGvAoL9Z9Ug7XuBwwjajAuGAS4cJqXdheiNu2Ub5fXRAtjpIv8WB9gCwDa1gdgxhYOg==";
        };
        _RbYZ7giI = {
            "id" = "RbYZ7giI";
            "file" = "playermob-fabric-0.96.0+26.2.jar";
            "hash" = "sha512-CwgzVZBqt00So7kc8UZbXrCX3nxVXu1CppEpC/AdvmxROO49H+Lnq6ZRBywjgACuh5zjjrdW7emp+4Utk/HRjw==";
        };
        _ClZvIZ2x = {
            "id" = "ClZvIZ2x";
            "file" = "playermob-neoforge-0.96.0+26.2.jar";
            "hash" = "sha512-/q5EzzAqsjVWguLSQmBM39NTlPMS/W2SV53qiUefX1QsT9m+wUGI4zrNwf91jcd54mBFUSPMuYVeGt/FKVezgA==";
        };
        _ywVuDAfN = {
            "id" = "ywVuDAfN";
            "file" = "playermob-fabric-0.97.0+1.21.1.jar";
            "hash" = "sha512-4kghOg6e9E5C86GR+ICSRWMC7mk1p/joILLPyJpVnZiGJpzLZ/IhVOlo4I5OaowdMa9GsFr9wfsnAGRo+8b9kA==";
        };
        _chd2u5m4 = {
            "id" = "chd2u5m4";
            "file" = "playermob-fabric-0.97.0+1.20.1.jar";
            "hash" = "sha512-4hjwwIO39dOizR6lllJWZNyZan4kOKd8KzKkKv6JYVGklXhrZa86t1WygWKiKJKCXQWC9u3u8tNXO7tHnSTOhg==";
        };
        _cFioLwZ3 = {
            "id" = "cFioLwZ3";
            "file" = "playermob-forge-0.97.0+1.21.1.jar";
            "hash" = "sha512-PnIEfCmJZYrqRb3iF9GVI4weidAF/Wrpi1Yc1rJrczbjvix4qDC5o+W5kZVwnzHH2rHLV+dP6Hm4SoomSb4rhQ==";
        };
        _6rOnK2dg = {
            "id" = "6rOnK2dg";
            "file" = "playermob-forge-0.97.0+1.20.1.jar";
            "hash" = "sha512-Z6EnvRGj04/gZZ+CROvy6qclHZ4PYhq4i7bhZybO1iTFteoYWpBsjc6uXe8TISQ4sI3xFA/ezwghYL0DZBJfPg==";
        };
        _rOjOs77z = {
            "id" = "rOjOs77z";
            "file" = "playermob-neoforge-0.97.0+1.21.1.jar";
            "hash" = "sha512-TjXrj6SPqaygPwdLNHLZkNK1mjP7Pq2EwRDCOFr+x2ZHZaFtp7w4LPNFB7Pxzcivl5gj3sfr5NS9vIiW8NhXFg==";
        };
        _IxREy3O7 = {
            "id" = "IxREy3O7";
            "file" = "playermob-fabric-0.97.0+26.2.jar";
            "hash" = "sha512-MAbiwl6LYC12ONtvWsJ2/UoDN3s+Bntz7U9ThZJi4H4NAnaIs9X3GDhWapp4+G1ORVG52pJWHyUoDfao+7Mpeg==";
        };
        _GJerkb8X = {
            "id" = "GJerkb8X";
            "file" = "playermob-neoforge-0.97.0+26.2.jar";
            "hash" = "sha512-RvQ2cnM4lGDKSm79dhqp7iGHUgmA3G3/DQhwvn0SRJbYk5Xv4cefGsoA3q7iq71SRFYhTeHtz++7v/iSV8b1+w==";
        };
        _cwnWo0QL = {
            "id" = "cwnWo0QL";
            "file" = "playermob-fabric-0.98.0+1.21.1.jar";
            "hash" = "sha512-hmrZsFue2gxfcx1ozv2YsgtEcikaBNQXWLhSyBgqEaan++Bj4W+5tkIzHwTwJCrgOgUo4EDKWLUb+qrO2CKqaQ==";
        };
        _Et0lXa9H = {
            "id" = "Et0lXa9H";
            "file" = "playermob-fabric-0.98.0+1.20.1.jar";
            "hash" = "sha512-XSAYPkyye5DZO+Bm+KVNnjO4+11W1YOVDLZgoT5pdGgbeUIVjLIkZLnNo7IXrRWBC59vFY5Ew2g4r8kp8TjHDQ==";
        };
        _8SNgeMzn = {
            "id" = "8SNgeMzn";
            "file" = "playermob-forge-0.98.0+1.21.1.jar";
            "hash" = "sha512-A9f9czcli5ObKiGiMd6CG49Ou/o0kzG9h8dXG5mC4qbIpjqmc6fA/TX7OjBNkpMrKYSsp0fP3dEqhAYhxkr1iw==";
        };
        _xJggq1Ib = {
            "id" = "xJggq1Ib";
            "file" = "playermob-forge-0.98.0+1.20.1.jar";
            "hash" = "sha512-xWCXtva5oxascUxQuwD86qa9EBXNLW5CLnXTKQ24xqDwq23/W3NX0vuRE33SPUr0Kfew+dFEaCasXrH6IXB0UQ==";
        };
        _rRdAYBNo = {
            "id" = "rRdAYBNo";
            "file" = "playermob-neoforge-0.98.0+1.21.1.jar";
            "hash" = "sha512-UFTrHlE9HT7aPxNqGRXQLEDSAG++YtZtjsIEoyANxLXhv6z5ysPp4qkdvcxcaCi7lzfxqal7/nsJ/h+7gBqcGQ==";
        };
        _5zPM4iJ6 = {
            "id" = "5zPM4iJ6";
            "file" = "playermob-fabric-0.98.0+26.2.jar";
            "hash" = "sha512-XsEdEhT9Xg8UOm/m93Iu4ugrhkjs1hpznIlRCyZz+SfsM0MaqtVM795qPDFHJwwOCuX5sXnw4KcO2n7hoArUoA==";
        };
        _ENq9kR2B = {
            "id" = "ENq9kR2B";
    ...
    in {
        ...
        "pkg-v0.8.0+neoforge" = _XMokSNIO;
        "pkg-v0.9.0+fabric" = _daKlycX9;
        "pkg-v0.9.0+forge" = _dEaaDAQX;
        "pkg-v0.9.0+neoforge" = _NlotHLdw;
        "pkg-v0.10.0+fabric" = _WqnStLZu;
        "pkg-v0.10.0+forge" = _AtZfTFpT;
        "pkg-v0.10.0+neoforge" = _SHsAAEM2;
        "pkg-v0.11.0+fabric" = _7lsLDI0e;
        "pkg-v0.11.0+forge" = _tPGsYj87;
        "pkg-v0.11.0+neoforge" = _uUtLsoC2;
        "pkg-v0.14.0+fabric" = _8192qDBY;
        "pkg-v0.14.0+forge" = _Lmr9EisD;
        "pkg-v0.14.0+neoforge" = _YSiCDUkU;
        "pkg-v0.15.0+fabric" = _31UVIM8f;
        "pkg-v0.15.0+forge" = _vpCZbQk8;
        "pkg-v0.15.0+neoforge" = _UtFfNRmj;
        "pkg-v0.16.0+fabric" = _iF4tHMXS;
        "pkg-v0.16.0+forge" = _IdUqKsvu;
        "pkg-v0.16.0+neoforge" = _3hThgc98;
        "pkg-v0.17.0+fabric" = _nm57NtqA;
        "pkg-v0.17.0+forge" = _hQd1t6Ad;
        "pkg-v0.17.0+neoforge" = _CIWVSnWJ;
        "pkg-v0.19.0+fabric" = _qO9TyDOo;
        "pkg-v0.19.0+forge" = _TcCMVriZ;
        "pkg-v0.19.0+neoforge" = _4IGW2pGt;
        "pkg-v0.21.0+fabric" = _iwG2Ep57;
        "pkg-v0.21.0+forge" = _TURsq8bS;
        "pkg-v0.21.0+neoforge" = _mBuU0an2;
        "pkg-v0.23.0+fabric" = _1RUqqabA;
        "pkg-v0.23.0+forge" = _x8ftU2M4;
        "pkg-v0.23.0+neoforge" = _bv2Qzbtd;
        "pkg-v0.25.0+fabric" = _QU2RaFvn;
        "pkg-v0.25.0+forge" = _AhOUnhAC;
        "pkg-v0.25.0+neoforge" = _UuFJ6jE5;
        "pkg-v0.26.0+fabric" = _Z5mf6boS;
        "pkg-v0.26.0+forge" = _LzN9Zqw0;
        "pkg-v0.26.0+neoforge" = _X2yryQbL;
        "pkg-v0.27.0+fabric" = _judKVErC;
        "pkg-v0.27.0+forge" = _M8XqWD9l;
        "pkg-v0.27.0+neoforge" = _nVD3xfbt;
        "pkg-v0.28.0+fabric" = _nEIds8rB;
        "pkg-v0.28.0+forge" = _AA8EoYZz;
        "pkg-v0.28.0+neoforge" = _icp5yU9J;
        "pkg-v0.29.0+fabric" = _I6CxfweH;
        "pkg-v0.29.0+forge" = _fdbM4jb6;
        "pkg-v0.29.0+neoforge" = _FtYkZVF1;
        "pkg-v0.32.0+fabric" = _qHLm3sl0;
        "pkg-v0.32.0+forge" = _ZcdfzWIY;
        "pkg-v0.32.0+neoforge" = _vr0RvKUi;
        "pkg-v0.33.0+fabric" = _taAC05yX;
        "pkg-v0.33.0+forge" = _Wm5gRiAx;
        "pkg-v0.33.0+neoforge" = _ACRZu929;
        "pkg-v0.34.0+fabric" = _MprWvLq0;
        "pkg-v0.34.0+forge" = _bFxQn2VD;
        "pkg-v0.34.0+neoforge" = _H2ai16RB;
        "pkg-v0.35.0+fabric" = _bNn6Uihx;
        "pkg-v0.35.0+forge" = _dHgeYidJ;
        "pkg-v0.35.0+neoforge" = _nA0TRLhu;
        "pkg-v0.36.0+fabric" = _HjkUsF6h;
        "pkg-v0.36.0+forge" = _xMtEAtPU;
        "pkg-v0.36.0+neoforge" = _spPrTcsZ;
        "pkg-v0.37.0+fabric" = _8j3gi38p;
        "pkg-v0.37.0+forge" = _ydJ86yYZ;
        "pkg-v0.37.0+neoforge" = _UxwqeCdl;
        "pkg-v0.38.0+fabric" = _xlMYxpiM;
        "pkg-v0.38.0+forge" = _Jlca7NVr;
        "pkg-v0.38.0+neoforge" = _W8dEo9tV;
        "pkg-v0.43.0+fabric" = _kdIWfYmp;
        "pkg-v0.43.0+forge" = _FkhOV5fe;
        "pkg-v0.43.0+neoforge" = _kiBWgLLg;
        "pkg-v0.44.0+fabric" = _ncF5fo8F;
        "pkg-v0.44.0+forge" = _uLVuvcoX;
        "pkg-v0.44.0+neoforge" = _h9SsJ4pR;
        "pkg-v0.45.0+fabric" = _rkBGnvrg;
        "pkg-v0.45.0+forge" = _LmFK4lkq;
        "pkg-v0.45.0+neoforge" = _CXr0nX1F;
        "pkg-v0.46.0+fabric" = _NIawl2H7;
        "pkg-v0.46.0+forge" = _2t78CMOg;
        "pkg-v0.46.0+neoforge" = _bbhZQ5KH;
        "pkg-v0.47.0+fabric" = _tbZJZ39A;
        "pkg-v0.47.0+forge" = _ogu5ZvLD;
        "pkg-v0.47.0+neoforge" = _qrLoJTS4;
        "pkg-v0.48.0+fabric-1.21.1" = _MZAKSK9C;
        "pkg-v0.48.0+fabric-1.20.1" = _KOBjFTGC;
        "pkg-v0.48.0+forge-1.21.1" = _XU18YUsZ;
        "pkg-v0.48.0+forge-1.20.1" = _eyn14KOH;
        "pkg-v0.48.0+neoforge-1.21.1" = _TgmbuQXO;
        "pkg-v0.49.0+fabric-1.21.1" = _iIq8rKoX;
        "pkg-v0.49.0+fabric-1.20.1" = _J4O8sOrP;
        "pkg-v0.49.0+forge-1.21.1" = _CyfFObvD;
        "pkg-v0.49.0+forge-1.20.1" = _pi85kHJO;
        "pkg-v0.49.0+neoforge-1.21.1" = _U6MYhGO7;
        "pkg-v0.49.0+fabric-26.2" = _P4mXr1dh;
        "pkg-v0.49.0+neoforge-26.2" = _9lWNBvDg;
        "pkg-v0.50.0+fabric-1.21.1" = _w8T8ykVx;
        "pkg-v0.50.0+fabric-1.20.1" = _mE6hfxr4;
        "pkg-v0.50.0+forge-1.21.1" = _gmE0fyJ7;
        "pkg-v0.50.0+forge-1.20.1" = _w676Jw8S;
        "pkg-v0.50.0+neoforge-1.21.1" = _iqsh0KdR;
        "pkg-v0.50.0+fabric-26.2" = _76GqYKrc;
        "pkg-v0.50.0+neoforge-26.2" = _6Ab1MBx6;
        "pkg-v0.51.0+fabric-1.21.1" = _XAOIEG74;
        "pkg-v0.51.0+fabric-1.20.1" = _8TRoM6oW;
        "pkg-v0.51.0+forge-1.21.1" = _h4iC8KAo;
        "pkg-v0.51.0+forge-1.20.1" = _L5T0q8yV;
        "pkg-v0.51.0+neoforge-1.21.1" = _EDRB6WDX;
        "pkg-v0.51.0+fabric-26.2" = _3mEmd0uQ;
        "pkg-v0.51.0+neoforge-26.2" = _7o5Msot5;
        "pkg-v0.52.0+fabric-1.21.1" = _R5fslHHI;
        "pkg-v0.52.0+fabric-1.20.1" = _SAjBvDXE;
        "pkg-v0.52.0+forge-1.21.1" = _BhgRTsoP;
        "pkg-v0.52.0+forge-1.20.1" = _7kiZVYEC;
        "pkg-v0.52.0+neoforge-1.21.1" = _JG3gjgoC;
        "pkg-v0.52.0+fabric-26.2" = _dJsNVi7c;
        "pkg-v0.52.0+neoforge-26.2" = _HkLktcsL;
        "pkg-v0.53.0+fabric-1.21.1" = _yioU6Ssm;
        "pkg-v0.53.0+fabric-1.20.1" = _63Wo8p0X;
        "pkg-v0.53.0+forge-1.21.1" = _2OyCRTpB;
        "pkg-v0.53.0+forge-1.20.1" = _rnTvSW3y;
        "pkg-v0.53.0+neoforge-1.21.1" = _yIxAkzXq;
        "pkg-v0.53.0+fabric-26.2" = _wG57Yu7c;
        "pkg-v0.53.0+neoforge-26.2" = _NGEd7gQm;
        "pkg-v0.54.0+fabric-1.21.1" = _J2u29CXs;
        "pkg-v0.54.0+fabric-1.20.1" = _o5w2WZJ5;
        "pkg-v0.54.0+forge-1.21.1" = _FbDvXbF2;
        "pkg-v0.54.0+forge-1.20.1" = _y59TFwMj;
        "pkg-v0.54.0+neoforge-1.21.1" = _raQ1EQES;
        "pkg-v0.54.0+fabric-26.2" = _FfxVgke8;
        "pkg-v0.54.0+neoforge-26.2" = _6O4JLvWI;
        "pkg-v0.55.0+fabric-1.21.1" = _F4vdc1Js;
        "pkg-v0.55.0+fabric-1.20.1" = _wvlJRYXd;
        "pkg-v0.55.0+forge-1.21.1" = _wsVInBok;
        "pkg-v0.55.0+forge-1.20.1" = _6ZcqTsz8;
        "pkg-v0.55.0+neoforge-1.21.1" = _nDQoUShl;
        "pkg-v0.55.0+fabric-26.2" = _ojCGGaJK;
        "pkg-v0.55.0+neoforge-26.2" = _32WMXd75;
        "pkg-v0.56.0+fabric-1.21.1" = _TqcC4xHO;
        "pkg-v0.56.0+fabric-1.20.1" = _zBx83Jnr;
        "pkg-v0.56.0+forge-1.21.1" = _brrXQYBg;
        "pkg-v0.56.0+forge-1.20.1" = _xJEHRe49;
        "pkg-v0.56.0+neoforge-1.21.1" = _pyXmYBfz;
        "pkg-v0.56.0+fabric-26.2" = _tAY4qODk;
        "pkg-v0.56.0+neoforge-26.2" = _YTQI7BC7;
        "pkg-v0.57.0+fabric-1.21.1" = _s5MLAXft;
        "pkg-v0.57.0+fabric-1.20.1" = _ikSEQCoN;
        "pkg-v0.57.0+forge-1.21.1" = _vVTR496O;
        "pkg-v0.57.0+forge-1.20.1" = _tO8t5Wu6;
        "pkg-v0.57.0+neoforge-1.21.1" = _GIuEEjxi;
        "pkg-v0.57.0+fabric-26.2" = _4XkgvzRI;
        "pkg-v0.57.0+neoforge-26.2" = _OmdsQMB2;
        "pkg-v0.58.0+fabric-1.21.1" = _u3aO0mBd;
        "pkg-v0.58.0+fabric-1.20.1" = _OAwU7h7E;
        "pkg-v0.58.0+forge-1.21.1" = _FHvGLrH6;
        "pkg-v0.58.0+forge-1.20.1" = _cGlI8rnY;
        "pkg-v0.58.0+neoforge-1.21.1" = _iunKS1Ub;
        "pkg-v0.58.0+fabric-26.2" = _x7uTn0oy;
        "pkg-v0.58.0+neoforge-26.2" = _HjwQfO0D;
        "pkg-v0.59.0+fabric-1.21.1" = _O9O1cjvU;
        "pkg-v0.59.0+fabric-1.20.1" = _DZ42eOyR;
        "pkg-v0.59.0+forge-1.21.1" = _yDn5xjxw;
        "pkg-v0.59.0+forge-1.20.1" = _tmD9cYSH;
        "pkg-v0.59.0+neoforge-1.21.1" = _BaHRDjch;
        "pkg-v0.59.0+fabric-26.2" = _SoJzvS4k;
        "pkg-v0.59.0+neoforge-26.2" = _bEus6gHp;
        "pkg-v0.60.0+fabric-1.21.1" = _jm0HibHf;
        "pkg-v0.60.0+fabric-1.20.1" = _9fsg6jsI;
        "pkg-v0.60.0+forge-1.21.1" = _PmzDKN4B;
        "pkg-v0.60.0+forge-1.20.1" = _scaOkR0a;
        "pkg-v0.60.0+neoforge-1.21.1" = _YnTfZaP2;
        "pkg-v0.60.0+fabric-26.2" = _sm4rOJGA;
        "pkg-v0.60.0+neoforge-26.2" = _67BPIYUQ;
        "pkg-v0.61.0+fabric-1.21.1" = _fQs99BC4;
        "pkg-v0.61.0+fabric-1.20.1" = _RlyD5dnx;
        "pkg-v0.61.0+forge-1.21.1" = _C27Hel2N;
        "pkg-v0.61.0+forge-1.20.1" = _hCuqgNYI;
        "pkg-v0.61.0+neoforge-1.21.1" = _pMWGzq0D;
        "pkg-v0.61.0+fabric-26.2" = _t4yBH25W;
        "pkg-v0.62.0+fabric-1.21.1" = _3Zr2V9ek;
        "pkg-v0.62.0+fabric-1.20.1" = _lUTagwDI;
        "pkg-v0.62.0+forge-1.21.1" = _vFJTY07t;
        "pkg-v0.62.0+forge-1.20.1" = _Ss9F1WNt;
        "pkg-v0.62.0+neoforge-1.21.1" = _OD8tNVhW;
        "pkg-v0.62.0+fabric-26.2" = _ywy1JdVu;
        "pkg-v0.62.0+neoforge-26.2" = _DWHgjosZ;
        "pkg-v0.63.1+fabric-1.21.1" = _dTlEA047;
        "pkg-v0.63.1+fabric-1.20.1" = _pvYWnc6p;
        "pkg-v0.63.1+forge-1.21.1" = _VpU2Zr35;
        "pkg-v0.63.1+forge-1.20.1" = _cKikyHa0;
        "pkg-v0.63.1+neoforge-1.21.1" = _ZEHbCLPu;
        "pkg-v0.63.1+fabric-26.2" = _2HAu3CCF;
        "pkg-v0.63.1+neoforge-26.2" = _4pflUf41;
        "pkg-v0.64.0+fabric-1.21.1" = _XFvPykL7;
        "pkg-v0.64.0+fabric-1.20.1" = _G2B6neAf;
        "pkg-v0.64.0+forge-1.21.1" = _d6crhHlV;
        "pkg-v0.64.0+forge-1.20.1" = _TPRaLQzj;
        "pkg-v0.64.0+neoforge-1.21.1" = _19lKPjj5;
        "pkg-v0.64.0+fabric-26.2" = _aBvZ1xFi;
        "pkg-v0.64.0+neoforge-26.2" = _9HINfzOq;
        "pkg-v0.65.0+fabric-1.21.1" = _fRF5HDXH;
        "pkg-v0.65.0+fabric-1.20.1" = _5vjDZKK7;
        "pkg-v0.65.0+forge-1.21.1" = _Rci333bd;
        "pkg-v0.65.0+forge-1.20.1" = _kCk32o5C;
        "pkg-v0.65.0+neoforge-1.21.1" = _KPAtxQ1Z;
        "pkg-v0.65.0+fabric-26.2" = _k10qIb0o;
        "pkg-v0.65.0+neoforge-26.2" = _kZdXRzaq;
        "pkg-v0.66.0+fabric-1.21.1" = _ynpPisgB;
        "pkg-v0.66.0+fabric-1.20.1" = _eY9L8lSV;
        "pkg-v0.66.0+forge-1.21.1" = _yjyaUtX3;
        "pkg-v0.66.0+forge-1.20.1" = _A9bNvh1S;
        "pkg-v0.66.0+neoforge-1.21.1" = _JKV7g5Kk;
        "pkg-v0.66.0+fabric-26.2" = _sgtcslB9;
        "pkg-v0.66.0+neoforge-26.2" = _eILVXc3D;
        "pkg-v0.67.0+fabric-1.21.1" = _iTq97rpa;
        "pkg-v0.67.0+fabric-1.20.1" = _tmaSfid8;
        "pkg-v0.67.0+forge-1.21.1" = _TfscUwB3;
        "pkg-v0.67.0+forge-1.20.1" = _UNtXAPbU;
        "pkg-v0.67.0+neoforge-1.21.1" = _iH4gaFZN;
        "pkg-v0.67.0+fabric-26.2" = _MAK4z8m4;
        "pkg-v0.67.0+neoforge-26.2" = _tzibCjsF;
        "pkg-v0.69.0+fabric-1.21.1" = _FnCkB20N;
        "pkg-v0.69.0+fabric-1.20.1" = _OxikfZa0;
        "pkg-v0.69.0+forge-1.21.1" = _KFnlGuUY;
        "pkg-v0.69.0+forge-1.20.1" = _pcUeAPmZ;
        "pkg-v0.69.0+neoforge-1.21.1" = _S3rdsyVk;
        "pkg-v0.69.0+fabric-26.2" = _p4AXEbEZ;
        "pkg-v0.69.0+neoforge-26.2" = _hQ71w5iZ;
        "pkg-v0.70.0+fabric-1.21.1" = _C1Zx3faJ;
        "pkg-v0.70.0+fabric-1.20.1" = _WdrX0y2Q;
        "pkg-v0.70.0+forge-1.21.1" = _V6sDr5to;
        "pkg-v0.70.0+forge-1.20.1" = _r9sSXdna;
        "pkg-v0.70.0+neoforge-1.21.1" = _Ugle2RDJ;
        "pkg-v0.70.0+fabric-26.2" = _F7Z2xtB3;
        "pkg-v0.70.0+neoforge-26.2" = _MV0DErm4;
        "pkg-v0.71.0+fabric-1.21.1" = _MynxxIDJ;
        "pkg-v0.71.0+fabric-1.20.1" = _xFuTJ0fs;
        "pkg-v0.71.0+forge-1.21.1" = _KM1AHb9P;
        "pkg-v0.71.0+forge-1.20.1" = _ud4gbc1Y;
        "pkg-v0.71.0+neoforge-1.21.1" = _1gF2jA6h;
        "pkg-v0.71.0+fabric-26.2" = _T6WcjUr9;
        "pkg-v0.71.0+neoforge-26.2" = _Ib51R3gs;
        "pkg-v0.72.0+fabric-1.21.1" = _3OIgFXuN;
        "pkg-v0.72.0+fabric-1.20.1" = _xQJktJC5;
        "pkg-v0.72.0+forge-1.21.1" = _Am52NMgc;
        "pkg-v0.72.0+forge-1.20.1" = _XTfJqDLB;
        "pkg-v0.72.0+neoforge-1.21.1" = _b2SnhiAw;
        "pkg-v0.72.0+fabric-26.2" = _i6msryfN;
        "pkg-v0.72.0+neoforge-26.2" = _tLHXXrsI;
        "pkg-v0.73.0+fabric-1.21.1" = _tHaZR1K3;
        "pkg-v0.73.0+fabric-1.20.1" = _So4MacaV;
        "pkg-v0.73.0+forge-1.21.1" = _Jdve5ujJ;
        "pkg-v0.73.0+forge-1.20.1" = _298wJBu7;
        "pkg-v0.73.0+neoforge-1.21.1" = _2sEQUjJi;
        "pkg-v0.73.0+fabric-26.2" = _s8eyRe1Y;
        "pkg-v0.73.0+neoforge-26.2" = _kG1ST907;
        "pkg-v0.74.0+fabric-1.21.1" = _yOs1qmbQ;
        "pkg-v0.74.0+fabric-1.20.1" = _yOodxuLM;
        "pkg-v0.74.0+forge-1.21.1" = _hunJ84wt;
        "pkg-v0.74.0+forge-1.20.1" = _iI2qjKTl;
        "pkg-v0.74.0+neoforge-1.21.1" = _aVKXTiqF;
        "pkg-v0.74.0+fabric-26.2" = _P39k0rMk;
        "pkg-v0.74.0+neoforge-26.2" = _EzmInbPW;
        "pkg-v0.76.0+fabric-1.21.1" = _pKcEzSlo;
        "pkg-v0.76.0+fabric-1.20.1" = _RylAQAta;
        "pkg-v0.76.0+forge-1.21.1" = _9FImcnHy;
        "pkg-v0.76.0+forge-1.20.1" = _TXiPI30a;
        "pkg-v0.76.0+neoforge-1.21.1" = _Ruxh9uAs;
        "pkg-v0.76.0+fabric-26.2" = _mivbIfMs;
        "pkg-v0.76.0+neoforge-26.2" = _eP36W4fz;
        "pkg-v0.77.0+fabric-1.21.1" = _U37hwf76;
        "pkg-v0.77.0+fabric-1.20.1" = _4i8xU3hU;
        "pkg-v0.77.0+forge-1.21.1" = _eZ75Zo75;
        "pkg-v0.77.0+forge-1.20.1" = _8HRpD2YL;
        "pkg-v0.77.0+neoforge-1.21.1" = _omdwDZDU;
        "pkg-v0.77.0+fabric-26.2" = _NeOPN4hM;
        "pkg-v0.77.0+neoforge-26.2" = _720w6aAP;
        "pkg-v0.78.0+fabric-1.21.1" = _xQEOuFaR;
        "pkg-v0.78.0+fabric-1.20.1" = _7PNghSQk;
        "pkg-v0.78.0+forge-1.21.1" = _VJmjFfOq;
        "pkg-v0.78.0+forge-1.20.1" = _KTCK7EJw;
        "pkg-v0.78.0+neoforge-1.21.1" = _eVLepX5m;
        "pkg-v0.78.0+fabric-26.2" = _aJUlLHjd;
        "pkg-v0.78.0+neoforge-26.2" = _7ky4i84z;
        "pkg-v0.80.0+fabric-1.21.1" = _daOND7qm;
        "pkg-v0.80.0+fabric-1.20.1" = _crvMya5D;
        "pkg-v0.80.0+forge-1.21.1" = _TDQNP4v6;
        "pkg-v0.80.0+forge-1.20.1" = _B0C7fSAU;
        "pkg-v0.80.0+neoforge-1.21.1" = _B4TM3xWz;
        "pkg-v0.80.0+fabric-26.2" = _786DcTU6;
        "pkg-v0.80.0+neoforge-26.2" = _FkKrFIGO;
        "pkg-v0.81.0+fabric-1.21.1" = _oUOhTun7;
        "pkg-v0.81.0+fabric-1.20.1" = _7W6DMmAF;
        "pkg-v0.81.0+forge-1.21.1" = _Gsbjjyt7;
        "pkg-v0.81.0+forge-1.20.1" = _CcoXfmiz;
        "pkg-v0.81.0+neoforge-1.21.1" = _gsr6WGdv;
        "pkg-v0.81.0+fabric-26.2" = _VwxZNjYP;
        "pkg-v0.81.0+neoforge-26.2" = _NkcNXJPj;
        "pkg-v0.82.0+fabric-1.21.1" = _k5FuH0KU;
        "pkg-v0.82.0+fabric-1.20.1" = _K0QHTVhT;
        "pkg-v0.82.0+forge-1.21.1" = _6odLLlqj;
        "pkg-v0.82.0+forge-1.20.1" = _gF4HjAbx;
        "pkg-v0.82.0+neoforge-1.21.1" = _fDaOrkMJ;
        "pkg-v0.82.0+fabric-26.2" = _SiDgm5fN;
        "pkg-v0.82.0+neoforge-26.2" = _HOjfWkXg;
        "pkg-v0.83.0+fabric-1.21.1" = _M1dHXBmK;
        "pkg-v0.83.0+fabric-1.20.1" = _9lI9dExm;
        "pkg-v0.83.0+forge-1.21.1" = _oSjmpJ8X;
        "pkg-v0.83.0+forge-1.20.1" = _9KDD7nJ3;
        "pkg-v0.83.0+neoforge-1.21.1" = _2N1VqyND;
        "pkg-v0.83.0+fabric-26.2" = _6TrFsLEp;
        "pkg-v0.83.0+neoforge-26.2" = _gOZmE3xQ;
        "pkg-v0.85.0+fabric-1.21.1" = _66VpHkLb;
        "pkg-v0.85.0+fabric-1.20.1" = _6nWDhhjC;
        "pkg-v0.85.0+forge-1.21.1" = _CPl0fshB;
        "pkg-v0.85.0+forge-1.20.1" = _pF7TpIDL;
        "pkg-v0.85.0+neoforge-1.21.1" = _MK0tqBjx;
        "pkg-v0.85.0+fabric-26.2" = _KQtvQ725;
        "pkg-v0.85.0+neoforge-26.2" = _x1kOc2WA;
        "pkg-v0.85.1+fabric-1.21.1" = _drI2hDBr;
        "pkg-v0.85.1+fabric-1.20.1" = _RUVdweXE;
        "pkg-v0.85.1+forge-1.21.1" = _VrHILGLW;
        "pkg-v0.85.1+forge-1.20.1" = _7GLfwumh;
        "pkg-v0.85.1+neoforge-1.21.1" = _wbS3pKJQ;
        "pkg-v0.85.1+fabric-26.2" = _TXod9E9j;
        "pkg-v0.85.1+neoforge-26.2" = _MSDduE6w;
        "pkg-v0.86.0+fabric-1.21.1" = _Qg3iRzI1;
        "pkg-v0.86.0+fabric-1.20.1" = _9AEo5Rs4;
        "pkg-v0.86.0+forge-1.21.1" = _XcwKfE54;
        "pkg-v0.86.0+forge-1.20.1" = _yiZllQ3A;
        "pkg-v0.86.0+neoforge-1.21.1" = _uqYt1KFW;
        "pkg-v0.86.0+fabric-26.2" = _TcKQLlQL;
        "pkg-v0.86.0+neoforge-26.2" = _CeVzli4z;
        "pkg-v0.89.0+fabric-1.21.1" = _TuT1eHlL;
        "pkg-v0.89.0+fabric-1.20.1" = _oBFad5r5;
        "pkg-v0.89.0+forge-1.21.1" = _5carC5f5;
        "pkg-v0.89.0+forge-1.20.1" = _j20Cgs8l;
        "pkg-v0.89.0+neoforge-1.21.1" = _p5dDdlaE;
        "pkg-v0.89.0+fabric-26.2" = _TUz93R0O;
        "pkg-v0.89.0+neoforge-26.2" = _paESdnXr;
        "pkg-v0.92.0+fabric-1.21.1" = _UqdQCzmQ;
        "pkg-v0.92.0+fabric-1.20.1" = _NjRQatFi;
        "pkg-v0.92.0+forge-1.21.1" = _okM7oaCN;
        "pkg-v0.92.0+forge-1.20.1" = _VAlFPLxd;
        "pkg-v0.92.0+neoforge-1.21.1" = _AlBy1HeM;
        "pkg-v0.92.0+fabric-26.2" = _f5ogLjdO;
        "pkg-v0.92.0+neoforge-26.2" = _peppK289;
        "pkg-v0.94.0+fabric-1.21.1" = _zoManeQI;
        "pkg-v0.94.0+fabric-1.20.1" = _yNAQ2CA9;
        "pkg-v0.94.0+forge-1.21.1" = _pE8uZGjR;
        "pkg-v0.94.0+forge-1.20.1" = _YkycoHOS;
        "pkg-v0.94.0+neoforge-1.21.1" = _s0uLmHrV;
        "pkg-v0.94.0+fabric-26.2" = _lNHqLbt1;
        "pkg-v0.94.0+neoforge-26.2" = _5S9VZGax;
        "pkg-v0.96.0+fabric-1.21.1" = _pRcmWewv;
        "pkg-v0.96.0+fabric-1.20.1" = _VcLWwiUR;
        "pkg-v0.96.0+forge-1.21.1" = _LSv6xvfp;
        "pkg-v0.96.0+forge-1.20.1" = _hVzQmKa4;
        "pkg-v0.96.0+neoforge-1.21.1" = _ElPH9pPG;
        "pkg-v0.96.0+fabric-26.2" = _RbYZ7giI;
        "pkg-v0.96.0+neoforge-26.2" = _ClZvIZ2x;
        "pkg-v0.97.0+fabric-1.21.1" = _ywVuDAfN;
        "pkg-v0.97.0+fabric-1.20.1" = _chd2u5m4;
        "pkg-v0.97.0+forge-1.21.1" = _cFioLwZ3;
        "pkg-v0.97.0+forge-1.20.1" = _6rOnK2dg;
        "pkg-v0.97.0+neoforge-1.21.1" = _rOjOs77z;
        "pkg-v0.97.0+fabric-26.2" = _IxREy3O7;
        "pkg-v0.97.0+neoforge-26.2" = _GJerkb8X;
        "pkg-v0.98.0+fabric-1.21.1" = _cwnWo0QL;
        "pkg-v0.98.0+fabric-1.20.1" = _Et0lXa9H;
        "pkg-v0.98.0+forge-1.21.1" = _8SNgeMzn;
        "pkg-v0.98.0+forge-1.20.1" = _xJggq1Ib;
