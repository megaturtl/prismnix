...
let
    ...
    in {
        ...
        "pkg-0.1.2" = _80bxH7Dw;
        "pkg-0.1.3" = _GJWsjW9H;
        "pkg-0.2.0-beta.1" = _N9rs4Kja;
        "pkg-0.2.0-beta" = _PKlRwhiY;
        "pkg-0.2.0-beta.2" = _k2EAuqSh;
        "pkg-0.2.0-beta.3" = _6dg8HSqX;
        "pkg-0.2.0-rc1" = _CQd5CQn1;
        "pkg-0.2.0-rc2" = _28jIJIbI;
        "pkg-0.2.0" = _rdoCR2Rt;
        "pkg-0.2.1" = _pV2Q45pL;
        "pkg-0.3.0-beta.1" = _FNjcACrM;
        "pkg-0.3.0-beta.2+1.21.11" = _wzt8KBZk;
        "pkg-0.3.0-beta.3+1.21.11" = _y8g9T0ly;
        "pkg-0.3.0-beta.4+1.21.11" = _NruxVVlw;
        "pkg-0.3.0-beta.5+1.21.11" = _Ayc9FSeg;
        "pkg-0.3.0-rc.1+1.21.11" = _46ytp41F;
        "pkg-0.3.0-rc.1+26.1" = _8EYqPmLM;
        "pkg-0.3.0-rc.2+26.1" = _4BFPW628;
        "pkg-0.3.1+26.1" = _uN2MHtxB;
        "pkg-0.3.1+1.21.11" = _fVaGzibs;
        "pkg-0.3.0+1.21.9" = _iCWsOqfS;
        "pkg-0.3.1+1.21.5" = _rT15apoU;
        "pkg-0.3.1+1.21.3" = _NyFvKw4L;
        "pkg-0.3.1+1.21" = _aYC3kS0y;
        "pkg-0.3.1+1.20.6" = _DxctdO4g;
        "pkg-0.3.1+1.20.1" = _etQEWYp4;
        "pkg-0.3.1+1.20.2" = _eZaLzvoX;
        "pkg-0.3.1+1.21.9" = _RHBnlKOK;
        "pkg-0.4.0-alpha.1+26.1" = _eji1D8Yd;
        "pkg-0.4.0-alpha.2+26.1" = _BCWwygn3;
        "pkg-0.4.0-alpha.2+26.2" = _7InKUnkS;
        "pkg-0.3.2-alpha.1+1.20.1" = _zU3GKBW8;
        "pkg-0.3.2-alpha.2+1.20.1" = _i1aalvND;
        "pkg-0.3.2-alpha.2+1.20.2" = _vK21Nodg;
        "pkg-0.4.0-rc.1+26.2" = _tPSwYtJv;
        "pkg-0.4.0+26.2" = _gz9gaEpa;
        "pkg-0.4.0+26.1" = _Ul4bXFkZ;
        "pkg-0.4.0+1.21.11" = _WOYBUil6;
        "pkg-0.4.0+1.21.9" = _5h4SwiFM;
        "pkg-0.4.0+1.21.3" = _dHagYqg5;
        "pkg-0.4.0+1.21" = _NBfp9OQP;
        "pkg-0.4.0+1.20.1" = _otEubpl6;
        "pkg-0.4.0+1.20.2" = _2cMQ3O7K;
