...
let
    versions = (let
        ...
        _JAIO8dFl = {
            "id" = "JAIO8dFl";
            "file" = "! §7crelay SMP V2.zip";
            "hash" = "sha512-KW2Q/wARqFpHC7f2fIYsA+xxXXwmFIcPNducvBiSgAVLEqf8k4/PqXLRRENaV8ck2tyVhalEmRl8PrugbMbTOA==";
        };
    in {
        "tpH97Mij" = _tpH97Mij;
        "TQJg4QAO" = _TQJg4QAO;
        ...
        "YDFf33Sd" = _YDFf33Sd;
        "JAIO8dFl" = _JAIO8dFl;
        "minecraft-1.21" = _JAIO8dFl;
        "minecraft-1.21.1" = _JAIO8dFl;
        "minecraft-1.21.2" = _JAIO8dFl;
        "minecraft-1.21.3" = _JAIO8dFl;
        "minecraft-1.21.4" = _JAIO8dFl;
        "minecraft-1.21.5" = _JAIO8dFl;
        "minecraft-1.21.6" = _JAIO8dFl;
        "minecraft-1.21.7" = _JAIO8dFl;
        "minecraft-1.21.8" = _JAIO8dFl;
        "minecraft-1.21.9" = _JAIO8dFl;
        "minecraft-1.21.10" = _JAIO8dFl;
        "minecraft-1.21.11" = _JAIO8dFl;
        ...
        "minecraft-1.20" = _JAIO8dFl;
        "minecraft-1.20.1" = _JAIO8dFl;
        "minecraft-23w31a" = _JAIO8dFl;
        "minecraft-23w32a" = _JAIO8dFl;
        "minecraft-23w33a" = _JAIO8dFl;
        "minecraft-23w35a" = _JAIO8dFl;
        "minecraft-1.20.2-pre1" = _JAIO8dFl;
        "minecraft-1.20.2" = _JAIO8dFl;
        "minecraft-23w42a" = _JAIO8dFl;
        "minecraft-23w43a" = _JAIO8dFl;
        "minecraft-23w43b" = _JAIO8dFl;
        "minecraft-23w44a" = _JAIO8dFl;
        "minecraft-23w45a" = _JAIO8dFl;
        "minecraft-23w46a" = _JAIO8dFl;
        "minecraft-1.20.3" = _JAIO8dFl;
        "minecraft-1.20.4" = _JAIO8dFl;
        "minecraft-24w03a" = _JAIO8dFl;
        "minecraft-24w03b" = _JAIO8dFl;
        "minecraft-24w04a" = _JAIO8dFl;
        "minecraft-24w05a" = _JAIO8dFl;
        "minecraft-24w05b" = _JAIO8dFl;
        "minecraft-24w06a" = _JAIO8dFl;
        "minecraft-24w07a" = _JAIO8dFl;
        "minecraft-24w09a" = _JAIO8dFl;
        "minecraft-24w10a" = _JAIO8dFl;
        "minecraft-24w11a" = _JAIO8dFl;
        "minecraft-24w12a" = _JAIO8dFl;
        "minecraft-24w13a" = _JAIO8dFl;
        "minecraft-24w14potato" = _JAIO8dFl;
        "minecraft-24w14a" = _JAIO8dFl;
        "minecraft-1.20.5-pre1" = _JAIO8dFl;
        "minecraft-1.20.5-pre2" = _JAIO8dFl;
        "minecraft-1.20.5-pre3" = _JAIO8dFl;
        "minecraft-1.20.5" = _JAIO8dFl;
        "minecraft-1.20.6" = _JAIO8dFl;
        "minecraft-24w18a" = _JAIO8dFl;
        "minecraft-24w19a" = _JAIO8dFl;
        "minecraft-24w19b" = _JAIO8dFl;
        "minecraft-24w20a" = _JAIO8dFl;
        "minecraft-24w33a" = _JAIO8dFl;
        "minecraft-24w34a" = _JAIO8dFl;
        "minecraft-24w35a" = _JAIO8dFl;
        "minecraft-24w36a" = _JAIO8dFl;
        "minecraft-24w37a" = _JAIO8dFl;
        "minecraft-24w38a" = _JAIO8dFl;
        "minecraft-24w39a" = _JAIO8dFl;
        "minecraft-24w40a" = _JAIO8dFl;
        "minecraft-1.21.2-pre1" = _JAIO8dFl;
        "minecraft-1.21.2-pre2" = _JAIO8dFl;
        "minecraft-24w44a" = _JAIO8dFl;
        "minecraft-24w45a" = _JAIO8dFl;
        "minecraft-24w46a" = _JAIO8dFl;
        ...
        "minecraft-1.19" = _JAIO8dFl;
        "minecraft-1.19.1" = _JAIO8dFl;
        "minecraft-1.19.2" = _JAIO8dFl;
        "minecraft-1.19.3" = _JAIO8dFl;
        "minecraft-1.19.4" = _JAIO8dFl;
        "minecraft-26.2" = _JAIO8dFl;
        ...
        "minecraft-1.16" = _JAIO8dFl;
        "minecraft-1.16.1" = _JAIO8dFl;
        "minecraft-1.16.2" = _JAIO8dFl;
        "minecraft-1.16.3" = _JAIO8dFl;
        "minecraft-1.16.4" = _JAIO8dFl;
        "minecraft-1.16.5" = _JAIO8dFl;
        "minecraft-1.17" = _JAIO8dFl;
        "minecraft-1.17.1" = _JAIO8dFl;
        "minecraft-1.18" = _JAIO8dFl;
        "minecraft-1.18.1" = _JAIO8dFl;
        "minecraft-1.18.2" = _JAIO8dFl;
        "pkg-V2.2" = _tpH97Mij;
        "pkg-V2.3" = _TQJg4QAO;
        "pkg-V2.4" = _g08w5ceS;
        "pkg-V2.5" = _TWMZAy6A;
