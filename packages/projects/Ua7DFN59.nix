...
let
    versions = (let
        ...
        _ai48k2gp = {
            "id" = "ai48k2gp";
            "file" = "YungsApi-26.1.2-Fabric-6.1.1.jar";
            "hash" = "sha512-iym+ur0r5qY/uM9Tb54g0ArNVdkCV51KZoivuS3z+4FRkuuz2DWqPjHWJx8IobKAa/lQ2s5UzPGmRFxLT0toBQ==";
        };
        _cPhocrst = {
            "id" = "cPhocrst";
            "file" = "YungsApi-26.1.2-NeoForge-6.1.1.jar";
            "hash" = "sha512-d4rqng47Ztg1jY9WONeJCpUyZkFTEqUC245nkOfx89yP9Cg0rjpo9BjS5eEWBzXh7KysSpLsf0K36NdMR9wO3Q==";
        };
        _HShROAAi = {
            "id" = "HShROAAi";
            "file" = "YungsApi-26.1.2-NeoForge-6.1.2.jar";
            "hash" = "sha512-NjkSJ2Qn4t/8pgFkrIvHPwONt2G6vDi3eHBFOO2aV0U5rfs5IxXNwJlURDFK9d4Y3wetPW5PO+sKZlOviKQEcA==";
        };
        _puluJ9m2 = {
            "id" = "puluJ9m2";
            "file" = "YungsApi-26.1.2-Fabric-6.1.2.jar";
            "hash" = "sha512-mTB2lfo5lFRLUczcM3o0WWfSjaswMqsPK7AWDsx7ZLo/+MUGUnlFS6Tz9caMuPfM2RwmaloA1LGcVjGAmgVm9A==";
        };
        _aLHldfg8 = {
            "id" = "aLHldfg8";
            "file" = "YungsApi-1.21.1-Forge-5.1.7.jar";
            "hash" = "sha512-vV4vhbqLyBspA6z+NQ7ckIeDymGyg9XH6Pe7vn8xzPElFlrOm20uuWm12FzGNtsxbJdRWEkzNrdBJsXUSzB6zg==";
        };
        _h4ftQoE4 = {
            "id" = "h4ftQoE4";
            "file" = "YungsApi-1.21.1-Fabric-5.1.7.jar";
            "hash" = "sha512-D2Z1EOcDkDa0ToC2gU4Fe0Ouhtv+1E1NsI3YGnGGnKyPncJu2pxzODMa3Bc4ca886pjQphv8jFB0KLe3PU925g==";
        };
        _8Zmd0JGx = {
            "id" = "8Zmd0JGx";
            "file" = "YungsApi-1.21.1-NeoForge-5.1.7.jar";
            "hash" = "sha512-FJsNpGSmX/ooVnpKlLu7dkFR/ZsX0hcDAsFMn3b/f4b0m4R4GGqxBm5MrHwxUJuDoMlSknCGmCeBMLfiWYjlyQ==";
        };
        _okaPlkwI = {
            "id" = "okaPlkwI";
            "file" = "YungsApi-1.21.1-Fabric-5.1.8.jar";
            "hash" = "sha512-dYPQ8JGXeR+u4oGzDsM3CFDXL0AG/vLmPIR4KYIg7yUqEs6ZnnvIk/iB7RCIl/bK/SjTdCIVytupnDuU7vOGOg==";
        };
        _r7MCcdl0 = {
            "id" = "r7MCcdl0";
            "file" = "YungsApi-1.21.1-Forge-5.1.8.jar";
            "hash" = "sha512-mw5O8fGS8wwIQQGJf5E95XfTAPVsMO3odAIYlcqKPdsD7dTZiaWKQI4KADvqKjK7VA8pJqAY72g0mkSHVF4cpQ==";
        };
        _K3Dp2T0P = {
            "id" = "K3Dp2T0P";
            "file" = "YungsApi-1.21.1-NeoForge-5.1.8.jar";
            "hash" = "sha512-g1IOBXqUntbo3O4zmErg7vg8LlfQAf+7ugtRCQF2YI9zeDJ+znczElQ82Mu4AvlRt8JLV/OrbPGdK+ELR68w0A==";
        };
        _lmLenYfY = {
            "id" = "lmLenYfY";
            "file" = "YungsApi-26.1.2-Fabric-6.1.3.jar";
            "hash" = "sha512-p/3i3ol6F6PNsKhLxbmT3lzgFXfolDYK+arEtn04uRAa6f/G66W2nBvWaTFphak5SyhIv3PBYU/JzglsudqTew==";
        };
        _jPWeixDa = {
            "id" = "jPWeixDa";
            "file" = "YungsApi-26.1.2-NeoForge-6.1.3.jar";
            "hash" = "sha512-7RpvYZZn3VQts9NAwqmLgs9p/H5vm11x8Q40aaaDgVypl70fQ8MfjR0MtcIjxeyUpRt4yPed1ravxE0a6SR84w==";
        };
        _9rzwORd6 = {
            "id" = "9rzwORd6";
            "file" = "YungsApi-1.21.1-Fabric-5.1.9.jar";
            "hash" = "sha512-UEMzPUIjbEd/cmnUc17B4LeCzKv4FSrf0u0nZ+vsnSLF0Ft8uQRkk0JB/CI7PRLtTXhqxotLDdRt/lqmkUm0ww==";
        };
        _GKQLlzpD = {
            "id" = "GKQLlzpD";
            "file" = "YungsApi-1.21.1-Forge-5.1.9-all.jar";
            "hash" = "sha512-ejLRMIJ7kjkxIUFeB1DCKMZoz+q1iGqTtgYN+bmjAwkZ4R3BAG/3Ab44IuWy817cd9EcxJUrOU+Swh6gA4fY+A==";
        };
        _2prKITKh = {
            "id" = "2prKITKh";
            "file" = "YungsApi-1.21.1-NeoForge-5.1.9.jar";
            "hash" = "sha512-fjzwtCnoocUdyglMLY6r8SJFu0LLzYtuPlSVn5Mb75MgG4GgjSALQXBZqqQ46OtEXDl4oJVoWXv7WIGZt3dZZw==";
        };
    in {
        "xET3UZBe" = _xET3UZBe;
        "UNVzqGkX" = _UNVzqGkX;
        ...
        "forge-1.21" = _GKQLlzpD;
        "forge-1.21.1" = _GKQLlzpD;
        ...
        "fabric-1.21" = _9rzwORd6;
        "fabric-1.21.1" = _9rzwORd6;
        "fabric-1.21.4" = _U4m2SXEP;
        "fabric-26.1.1" = _lmLenYfY;
        "fabric-26.1.2" = _lmLenYfY;
        "neoforge-1.20.4" = _jLW564iU;
        "neoforge-1.21" = _2prKITKh;
        "neoforge-1.21.1" = _2prKITKh;
        "neoforge-1.21.4" = _FVhw2zf8;
        "neoforge-26.1.1" = _jPWeixDa;
        "neoforge-26.1.2" = _jPWeixDa;
        "pkg-1.19.2-Forge-3.8.2" = _xET3UZBe;
        "pkg-1.19.2-Fabric-3.8.2" = _UNVzqGkX;
        "pkg-1.19.2-Forge-3.8.6" = _82XBGKbQ;
        "pkg-1.19.2-Fabric-3.8.6" = _xvoWCwex;
        "pkg-1.19.2-Fabric-3.8.7" = _LYoQlbQt;
        "pkg-1.19.2-Forge-3.8.7" = _YwHWUw19;
        "pkg-1.19.2-Forge-3.8.8" = _LEuKu3qt;
        "pkg-1.19.2-Fabric-3.8.8" = _Em3G31xp;
        "pkg-1.19.3-Forge-3.9.0" = _dpSzBMP6;
        "pkg-1.19.3-Fabric-3.9.0" = _IOIGqCVr;
        "pkg-1.18.2-Fabric-2.2.9" = _i0Z1vSK9;
        "pkg-1.18.2-Forge-2.2.9" = _YZE1pnbT;
        "pkg-1.19.2-Forge-3.8.9" = _GNNfW5IV;
        "pkg-1.19.2-Fabric-3.8.9" = _IxuGYnWF;
        "pkg-1.19.4-Forge-3.10.1" = _yIFytswN;
        "pkg-1.19.4-Fabric-3.10.1" = _h32n7OPC;
        "pkg-1.20-Forge-4.0.1" = _4Ek11kQV;
        "pkg-1.20-Fabric-4.0.1" = _NmrTF2A5;
        "pkg-1.20-Fabric-4.0.2" = _TT8tnzlH;
        "pkg-1.20-Forge-4.0.2" = _HIRzLg0r;
        "pkg-1.19.2-Fabric-3.8.10" = _pxmQWPn7;
        "pkg-1.19.2-Forge-3.8.10" = _L5GqhLVE;
        "pkg-1.20-Forge-4.0.3" = _QnR5jGmc;
        "pkg-1.20-Fabric-4.0.3" = _hyQxutx9;
        "pkg-1.20.4-Forge-4.4.1" = _rbgh8n1F;
        "pkg-1.20.4-Fabric-4.4.1" = _5Zb55w2q;
        "pkg-1.20-Fabric-4.0.4" = _k1OTLc33;
        "pkg-1.20-Forge-4.0.4" = _sE5QMX20;
        "pkg-1.20.4-Fabric-4.4.2" = _RXxBbRs7;
        "pkg-1.20.4-Forge-4.4.2" = _wddoDji1;
        "pkg-1.20.4-Forge-4.4.3" = _dpTBMhjf;
        "pkg-1.20.4-NeoForge-4.4.3" = _jLW564iU;
        "pkg-1.20.4-Fabric-4.4.3" = _a7qxhSOZ;
        "pkg-1.20-Forge-4.0.5" = _aMs83SRk;
        "pkg-1.20-Fabric-4.0.5" = _zPT7QfIk;
        "pkg-1.21-Fabric-5.0.0" = _Nx7XHO30;
        "pkg-1.21-Forge-5.0.0" = _mBbkZrZ1;
        "pkg-1.21-NeoForge-5.0.0" = _fFD2YR4D;
        "pkg-1.20-Forge-4.0.6" = _PJOYAmAs;
        "pkg-1.20-Fabric-4.0.6" = _lscV1N5k;
        "pkg-1.21.1-Fabric-5.1.1" = _LkDReYww;
        "pkg-1.21.1-Forge-5.1.1" = _tumhJgug;
        "pkg-1.21.1-NeoForge-5.1.1" = _MIGLewpu;
        "pkg-1.21.1-Forge-5.1.2" = _PpGXywDf;
        "pkg-1.21.1-NeoForge-5.1.2" = _ex8YYvxI;
        "pkg-1.21.1-Fabric-5.1.2" = _LMXPKbZf;
        "pkg-1.21.1-Fabric-5.1.3" = _DeaIlZ9A;
        "pkg-1.21.1-Forge-5.1.3" = _97xRZcgc;
        "pkg-1.21.1-NeoForge-5.1.3" = _MoMQNZ94;
        "pkg-1.21.1-Forge-5.1.4" = _fVwzTPig;
        "pkg-1.21.1-NeoForge-5.1.4" = _x20IZIXE;
        "pkg-1.21.1-Fabric-5.1.4" = _kWoI0jki;
        "pkg-1.21.4-Fabric-5.4.0" = _U4m2SXEP;
        "pkg-1.21.4-NeoForge-5.4.0" = _FVhw2zf8;
        "pkg-1.21.1-Fabric-5.1.5" = _CbIBPwz2;
        "pkg-1.21.1-Forge-5.1.5" = _gRJY0EjN;
        "pkg-1.21.1-NeoForge-5.1.5" = _r6h5nMGq;
        "pkg-1.21.1-Fabric-5.1.6" = _9aZPNrZC;
        "pkg-1.21.1-Forge-5.1.6" = _MSfdem3U;
        "pkg-1.21.1-NeoForge-5.1.6" = _ZB22DE9q;
        "pkg-26.1.2-Fabric-6.1.0" = _tg3ifUTK;
        "pkg-26.1.2-NeoForge-6.1.0" = _ZVPSCH63;
        "pkg-26.1.2-Fabric-6.1.1" = _ai48k2gp;
        "pkg-26.1.2-NeoForge-6.1.1" = _cPhocrst;
        "pkg-26.1.2-NeoForge-6.1.2" = _HShROAAi;
        "pkg-26.1.2-Fabric-6.1.2" = _puluJ9m2;
        "pkg-1.21.1-Forge-5.1.7" = _aLHldfg8;
        "pkg-1.21.1-Fabric-5.1.7" = _h4ftQoE4;
        "pkg-1.21.1-NeoForge-5.1.7" = _8Zmd0JGx;
        "pkg-1.21.1-Fabric-5.1.8" = _okaPlkwI;
        "pkg-1.21.1-Forge-5.1.8" = _r7MCcdl0;
        "pkg-1.21.1-NeoForge-5.1.8" = _K3Dp2T0P;
        "pkg-26.1.2-Fabric-6.1.3" = _lmLenYfY;
        "pkg-26.1.2-NeoForge-6.1.3" = _jPWeixDa;
        "pkg-1.21.1-Fabric-5.1.9" = _9rzwORd6;
        "pkg-1.21.1-Forge-5.1.9" = _GKQLlzpD;
        "pkg-1.21.1-NeoForge-5.1.9" = _2prKITKh;
        "default" = _2prKITKh;
    });
