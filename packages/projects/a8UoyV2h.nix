...
let
    ...
    in {
        ...
        "pkg-1.1.2" = _Cmyz4VrU;
        "pkg-1.1.3" = _P8oOsQQe;
        "pkg-1.1.3-fabric" = _Rv8AjmOz;
        "pkg-1.1.4" = _Xz3gacvb;
        "pkg-1.1.5-Legacy" = _N6JjCAdo;
        "pkg-1.1.5-paper" = _Q2gioF2S;
        "pkg-1.1.5-fabric" = _pGhEtOTe;
        "pkg-1.3.0" = _COAsJESS;
        "pkg-1.3.1" = _Yqx1ZsuJ;
        "pkg-1.4.0" = _LdUld0EY;
        "pkg-1.4.1" = _J9v9Fwq5;
        "pkg-1.4.2" = _aEHsaBNc;
        "pkg-1.5.0" = _u3dsZxOj;
        "pkg-1.5.1-paper" = _p3MAdhK9;
        "pkg-1.5.1-fabric" = _yxu1UqLJ;
        "pkg-1.5.1-fabric-2" = _3orBJ3hd;
        "pkg-1.5.1-paper-2" = _nb3Uk48K;
        "pkg-1.5.2-fabric" = _9JAbL9HE;
        "pkg-1.6.0" = _ynDInFhg;
        "pkg-1.6.0-fabric" = _qHSZj1iO;
        "pkg-1.6.1" = _KLNJxTWc;
        "pkg-1.6.2" = _SKmQmOtF;
        "pkg-1.6.2-fabric" = _6t6PNNew;
        "pkg-1.6.3+fabric" = _8DWdvWg3;
        "pkg-1.6.3" = _uzVaOpud;
        "pkg-2.0.0" = _DiWGUCoK;
        "pkg-2.1.0" = _Wva5lSbv;
        "pkg-2.1.1" = _xYCRdR8d;
        "pkg-2.1.2" = _nyEEEEur;
        "pkg-2.1.2+1.21" = _sYNvOidm;
        "pkg-2.1.3" = _EfCkwr7Q;
        "pkg-2.1.4+fabric" = _WENDWkYL;
        "pkg-2.1.4" = _zJfTiXgo;
        "pkg-2.1.5" = _E0XoPfJV;
        "pkg-2.1.6" = _f9Xsttmd;
        "pkg-2.1.7" = _VNXfGX4L;
        "pkg-2.1.8" = _2dYF5SEr;
        "pkg-2.1.9" = _78uTzdwG;
        "pkg-2.1.10" = _rQ0YD1bT;
        "pkg-2.1.11" = _es8eJc4A;
        "pkg-2.1.12" = _jRs3jUlU;
        "pkg-2.1.13" = _HSNjHWkO;
        "pkg-2.1.14" = _ZRiVWoLD;
