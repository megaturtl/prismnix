...
let
    ...
    in {
        ...
        "pkg-1.6.1" = _4G5XTYFP;
        "pkg-1.6.2" = _BS679Tg2;
        "pkg-1.7.0-hotfix1" = _d8ecY5nv;
        "pkg-1.7.0-hotfix2" = _tTCVdGsB;
        "pkg-1.7.1" = _b0PUZyQm;
        "pkg-1.7.2" = _wBD6WpV2;
        "pkg-1.7.3" = _z5fw8cgV;
        "pkg-1.7.5" = _sjgiRYfj;
        ...
        "pkg-1.7.7" = _7GVI8Wmb;
        "pkg-1.7.8" = _96YJOlyp;
        "pkg-2.0.0-alpha0001" = _B5QqEMUC;
        "pkg-2.0.0-alpha0002" = _5aRXPiHh;
        "pkg-2.0.0-alpha0003" = _KQXQjDbT;
        "pkg-2.0.0-alpha0004" = _kyZQ2VJ4;
        "pkg-2.0.0-alpha0005" = _OFYw28bI;
        "pkg-2.0.0-alpha0006" = _k8lUBQZv;
        "pkg-2.0.0-alpha0007" = _E2uksdDf;
        "pkg-2.0.0-beta0001" = _b0jzmok5;
        "pkg-2.0.0-beta0002" = _Kbp7Vgd5;
        "pkg-2.0.0-beta0003" = _FLjvThkf;
        "pkg-2.0.0-beta0004" = _4kizMGl0;
        "pkg-2.0.0" = _l2CWXgSs;
        "pkg-2.0.1" = _kjoFjEnK;
        "pkg-2.0.2-hotfix1" = _vCRbFdLB;
        "pkg-2.1.0" = _c2B3JaB5;
        "pkg-2.2.0" = _8IvtDhaM;
        "pkg-2.2.1" = _iDJ7p3Nj;
        "pkg-2.3.0" = _NqZniBHa;
        ...
        "pkg-2.6.1" = _ijENb81C;
        "pkg-2.6.2" = _LhFtvwSM;
        "pkg-2.7.0-pre01" = _50YcScOZ;
        "pkg-2.7.0-pre03" = _xK7zQyPZ;
        "pkg-2.7.0-pre04" = _R0YAyF89;
        "pkg-2.7.0" = _prSFlNkE;
        "pkg-2.7.1" = _ujRgADcr;
        "pkg-2.7.1-hf01" = _MWupwTZO;
        "pkg-2.7.2" = _nTK7m0sN;
        "pkg-2.7.3" = _auVOjv7u;
        "pkg-2.7.4" = _nfYqdS3W;
        "pkg-2.8.0" = _1eWKemFo;
        "pkg-2.8.1" = _RZYzevO4;
        "pkg-3.0.0-beta0001" = _I6LyFwdH;
        "pkg-3.0.0-beta0002" = _ejPSjZET;
        "pkg-3.0.0-beta0003" = _cmESja7M;
        "pkg-3.0.0-beta0004" = _MCmPn89F;
        "pkg-3.0.0-beta0005" = _e1oIdHeC;
        "pkg-3.0.0-pre1" = _rTBKe0jD;
        "pkg-3.0.0-pre2" = _KeBhkaeJ;
        "pkg-3.0.0" = _8LeK7UOH;
        "pkg-3.0.1" = _eu1wAAtW;
        "pkg-3.1.0" = _7djuz7zI;
        "pkg-3.1.1" = _UCeU6Iuu;
