...
let
    versions = (let
        ...
        _17inyUo0 = {
            "id" = "17inyUo0";
            "file" = "Pegasus (v 0.4).zip";
            "hash" = "sha512-eiIoA8hof1fP3Pv8Hvn/KpRKJnoD5Zpxgmd4dLVyNs9BH+DIzGJ3nPjSSYk6WkPby4YMhypOcUEiqkxtfkX1HQ==";
        };
    in {
        "pTbW9gIi" = _pTbW9gIi;
        "SmEDM15U" = _SmEDM15U;
        ...
        "Iv0aHhDV" = _Iv0aHhDV;
        "17inyUo0" = _17inyUo0;
        "iris-1.19.2" = _17inyUo0;
        "iris-1.19.3" = _17inyUo0;
        "iris-1.19.4" = _17inyUo0;
        "iris-1.20" = _17inyUo0;
        "iris-1.20.1" = _17inyUo0;
        "iris-1.20.2" = _17inyUo0;
        "iris-1.20.3" = _17inyUo0;
        "iris-1.20.4" = _17inyUo0;
        "iris-1.20.5" = _17inyUo0;
        "iris-1.20.6" = _17inyUo0;
        "iris-1.21" = _17inyUo0;
        "iris-1.21.1" = _17inyUo0;
        "iris-1.21.2" = _17inyUo0;
        "iris-1.21.3" = _17inyUo0;
        "iris-1.19.1" = _17inyUo0;
        "iris-1.21.4" = _17inyUo0;
        "iris-1.21.5" = _17inyUo0;
        "iris-1.21.6" = _17inyUo0;
        "iris-1.21.7" = _17inyUo0;
        "iris-1.21.8" = _17inyUo0;
        "iris-1.21.9" = _17inyUo0;
        "iris-1.21.10" = _17inyUo0;
        "iris-1.21.11" = _17inyUo0;
        "iris-1.19" = _17inyUo0;
        "iris-26.1" = _17inyUo0;
        "iris-26.1.1" = _17inyUo0;
        "iris-26.1.2" = _17inyUo0;
        "iris-26.2" = _17inyUo0;
        "iris-26.3-snapshot-1" = _17inyUo0;
        "iris-26.3-snapshot-2" = _17inyUo0;
        "iris-26.3-snapshot-3" = _17inyUo0;
        "iris-26.3-snapshot-4" = _17inyUo0;
        "iris-26.3-snapshot-5" = _17inyUo0;
        "iris-26.3-snapshot-6" = _17inyUo0;
        "iris-26.3-snapshot-7" = _17inyUo0;
        "iris-26.3-snapshot-8" = _17inyUo0;
        "iris-26.3-snapshot-9" = _17inyUo0;
        "pkg-0.0.6" = _pTbW9gIi;
        "pkg-0.0.7" = _SmEDM15U;
        "pkg-0.0.8" = _FthpTaoV;
        "pkg-0.0.9" = _YM94pat4;
