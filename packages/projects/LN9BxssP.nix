...
let
    versions = (let
        ...
        _WAXoeL90 = {
            "id" = "WAXoeL90";
            "file" = "supermartijn642configlib-1.1.8a-neoforge-mc26.2.jar";
            "hash" = "sha512-ZrsEjbjANWUfFrNCf5uegqV3NPsqquHELkAix1hZxlj1kSAo7s84LC/YZkP2nPIxV/5MTkmDzLr1zzRJ/zZQGA==";
        };
        _XokTN39e = {
            "id" = "XokTN39e";
            "file" = "supermartijn642configlib-1.1.8-fabric-mc26.3.jar";
            "hash" = "sha512-lKr9suGI9OjeoV4AMnmEF8UkQddvvUc1D18hGKpMfsF2XyZX78svpWTHvHTNovbERgrJlYtzDG8O6nDURfzzLw==";
        };
        _FWhB6iGJ = {
            "id" = "FWhB6iGJ";
    ...
    in {
        ...
        "neoforge-26.2" = _WAXoeL90;
        "neoforge-26.3" = _FWhB6iGJ;
        ...
        "pkg-1.1.6-forge-mc1.16" = _r2Bpcr3r;
        "pkg-1.1.6-forge-mc1.17" = _S6JbfA2Y;
        "pkg-1.1.6-forge-mc1.18" = _Pzv05CwH;
        "pkg-1.1.6b-forge-mc1.19" = _9pwSswPr;
        "pkg-1.1.6-fabric-mc1.18" = _I11M5JPC;
        "pkg-1.1.6-fabric-mc1.19" = _8bQVl73V;
        "pkg-1.1.6-fabric-mc1.20" = _AnZ97CRs;
        "pkg-1.1.6-forge-mc1.20" = _RWo3uurV;
        "pkg-1.1.7-forge-mc1.12" = _zskhkQ4s;
        "pkg-1.1.7-forge-mc1.14" = _WrqoEGHX;
        "pkg-1.1.7-forge-mc1.15" = _rYkKokOr;
        "pkg-1.1.7-forge-mc1.16" = _NVo5RK6p;
        "pkg-1.1.7-forge-mc1.17" = _LQKdnIjg;
        "pkg-1.1.7-forge-mc1.18" = _k1bfOVIq;
        "pkg-1.1.7-forge-mc1.19" = _6Dhrrj9a;
        "pkg-1.1.7-forge-mc1.20" = _yhDBioNl;
        "pkg-1.1.7-fabric-mc1.18" = _DwnhsnkW;
        "pkg-1.1.7-fabric-mc1.19" = _RFbUW7MX;
        "pkg-1.1.7-fabric-mc1.20" = _baEzAEWx;
        "pkg-1.1.8-forge-mc1.12" = _IJL4TGRd;
        "pkg-1.1.8-forge-mc1.14" = _IW8ghXcn;
        "pkg-1.1.8-forge-mc1.15" = _hzKn7uRC;
        "pkg-1.1.8-forge-mc1.16" = _p1NxjNgs;
        "pkg-1.1.8-forge-mc1.17" = _kfWfTDuz;
        "pkg-1.1.8-forge-mc1.18" = _FbHbhymP;
        "pkg-1.1.8-forge-mc1.19" = _HHm0Di8Y;
        "pkg-1.1.8-forge-mc1.20" = _ZKor79dR;
        "pkg-1.1.8-fabric-mc1.18" = _Ki3pHcJe;
        "pkg-1.1.8-fabric-mc1.19" = _v4UxCV2K;
        "pkg-1.1.8-fabric-mc1.20" = _ppb4lV9X;
        "pkg-1.1.8-fabric-mc1.20.2" = _ty0Urtyn;
        "pkg-1.1.8-forge-mc1.20.2" = _u2uH4N7P;
        "pkg-1.1.8a-fabric-mc1.18" = _YYWuaEEi;
        "pkg-1.1.8a-fabric-mc1.19" = _5MbF108J;
        "pkg-1.1.8a-fabric-mc1.20.1" = _Ur02nrUT;
        "pkg-1.1.8a-fabric-mc1.20.2" = _cp6X3Hrn;
        "pkg-1.1.8-neoforge-mc1.20.4" = _yob2PuR6;
        "pkg-1.1.8a-neoforge-mc1.20.4" = _KDhhdO0q;
        "pkg-1.1.8-forge-mc1.20.6" = _6N6L1qtg;
        "pkg-1.1.8-forge-mc1.21" = _EJ2VXvJl;
        "pkg-1.1.8-fabric-mc1.20.6" = _PuC5srSI;
        "pkg-1.1.8-fabric-mc1.21" = _euSlaAtA;
        "pkg-1.1.8-neoforge-mc1.20.6" = _bsIXRRoe;
        "pkg-1.1.8-neoforge-mc1.21" = _qKL9jM75;
        "pkg-1.1.8-forge-mc1.21.6" = _3iWS6bi8;
        "pkg-1.1.8-neoforge-mc1.21.9" = _OjGIp9mS;
        "pkg-1.1.8-forge-mc1.21.11" = _cuv4JMWL;
        "pkg-1.1.8-fabric-mc1.21.11" = _CwICbJN9;
        "pkg-1.1.8-neoforge-mc1.21.11" = _OZsi8720;
        "pkg-1.1.8-neoforge-mc26.1" = _gD2yQaPN;
        "pkg-1.1.8-neoforge-mc26.2" = _hyLJJjeT;
        "pkg-1.1.8-forge-mc26.1" = _3VqkZuAs;
        "pkg-1.1.8-forge-mc26.2" = _zVO7QByg;
        "pkg-1.1.8-fabric-mc26.1" = _Agu5fI4t;
        "pkg-1.1.8-fabric-mc26.2" = _tg619S8t;
