...
let
    ...
    in {
        ...
        "pkg-1.2.1" = _SRMRIEyL;
        "pkg-1.2.2" = _7HflpyAh;
        "pkg-1.2.2+fabric.1.21.1" = _TVaEjDDp;
        "pkg-1.2.2+fabric.1.21.11" = _JerzvSeM;
        "pkg-1.3.0" = _LRhcqnWB;
        "pkg-1.3.1" = _JERi941K;
        "pkg-1.3.2" = _21NsCLqs;
        "pkg-1.3.3" = _ZhSnYvEO;
        "pkg-1.3.3-patch" = _4ADePFEV;
        "pkg-1.3.3-patch2" = _NoE12OIE;
        "pkg-1.3.4" = _Y5cX5JwP;
        "pkg-1.3.5" = _S3ohrjah;
        "pkg-1.3.5-patch" = _vNtcBUfl;
        "pkg-1.4.0" = _JCsEwE79;
        "pkg-1.4.0-patch" = _V7FcsvgN;
        "pkg-1.4.1" = _yn3LoES5;
        "pkg-1.4.0-patch2" = _7spAa2DE;
        "pkg-1.4.1-patch" = _9MAKm4YU;
        "pkg-1.4.2-pre" = _47rJF2nC;
        "pkg-1.4.2-pre2" = _E8UkgYwg;
        "pkg-1.5.0-preview" = _TxobuFCy;
        "pkg-1.5.0-preview2" = _GW4sLttL;
        "pkg-1.5.0" = _MbRfnBwW;
        "pkg-1.5.1-pre" = _nfFpHtBx;
        "pkg-1.5.1pre2" = _WL2l9JZh;
        "pkg-1.6.0-pre" = _ClXmjVMc;
        "pkg-1.6.0-pre-patch" = _ymYII3Zw;
        "pkg-1.6.0-pre2" = _QiqCRbUm;
        "pkg-1.6.0-pre3" = _WtkJlkkW;
        "pkg-1.6.0" = _moeN7jvB;
        "pkg-1.6.1" = _PWHYqQhS;
        "pkg-1.6.2" = _g9yINAog;
        "pkg-1.6.2-patch" = _fGB9uhPp;
        "pkg-1.7.0-pre" = _kDC1cy05;
        "pkg-1.7.0-pre2" = _3uagynp1;
        "pkg-1.7.0-pre1.5" = _9WItexDG;
        "pkg-1.7.0-pre3" = _sFo7NdIK;
        "pkg-1.7.0-pre3-patch" = _8ga2y4Hc;
        "pkg-1.7.0" = _GKEnWtPg;
        "pkg-1.7.0-hotfix140620261037" = _krObJv5w;
        "pkg-1.7.0-hotfix150620261622" = _uzyuQVzH;
        "pkg-1.7.1" = _ixxEhr1m;
        "pkg-1.7.2" = _Kj4MplKJ;
        "pkg-1.7.3" = _LhhH9cDK;
        "pkg-1.7.4" = _DSRl1pA1;
