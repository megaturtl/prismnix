...
let
    ...
    in {
        ...
        "pkg-0.7.0" = _k3CpB7e0;
        "pkg-mc1.17-v0.7.0" = _EQWaQ6zl;
        "pkg-mc1.17-v0.7.1" = _5OrKmOmR;
        "pkg-mc1.17-v0.8.0" = _S5cQ0EL4;
        "pkg-mc1.17-v0.8.1" = _abs0Intl;
        "pkg-mc1.17.1-v0.8.2" = _UgEtsOWx;
        "pkg-mc1.18-v0.8.3" = _YEm44Y2N;
        "pkg-mc1.19-v0.8.4" = _BsUqrKfP;
        "pkg-mc1.19-v0.8.5" = _mbK45HUf;
        "pkg-mc1.19-v1.0.0" = _MPeqJcKJ;
        "pkg-mc1.19.1-v1.1.0" = _jCuRv8Fh;
        "pkg-mc1.19.2-v1.2.0" = _eXGUTNJu;
        "pkg-mc1.19.3-v1.2.1" = _VS0fsMJl;
        "pkg-mc1.20-v1.3.0" = _wGRavHm8;
        "pkg-mc1.20-v1.3.1" = _cxi4KUXk;
        "pkg-mc1.20.2-v1.3.2" = _BfHDRKtd;
        "pkg-mc1.20.4-v1.3.3" = _f0jwej2l;
        "pkg-1.4.0" = _3dAyYuh4;
        "pkg-1.4.1" = _bYi3gcoj;
        "pkg-1.4.2" = _yrJhnvQh;
        "pkg-1.4.3" = _o2dqzlVk;
