...
let
    versions = (let
        ...
        _iGdDhzsX = {
            "id" = "iGdDhzsX";
            "file" = "skyblock_enhancements-1.2.0+26.2.jar";
            "hash" = "sha512-9qWeNqz2rlGbYzlqmPJm6Re32+V0FZHRFKA7xvCG0pp07AZxFtNm7cqgY9XzU44NjTrDaS9EyNMLN3X2mob+yQ==";
        };
        _ppxYzCbw = {
            "id" = "ppxYzCbw";
            "file" = "skyblock_enhancements-1.2.1+26.2.jar";
            "hash" = "sha512-ENF6D3WWBj77x04fnkMSD2/uShAZdPV2PWBDX0Sgj4SHA8rIaqs1V+ZooLDPe/ERHlRzBneMtDC2Z2SDI07jeg==";
        };
    in {
        "vBLnFN9j" = _vBLnFN9j;
        "xyKNqfrZ" = _xyKNqfrZ;
        ...
        "pkg-0.8.7" = _JOmrec94;
        "pkg-0.9.0" = _NPVvvYQN;
        "pkg-0.10.0" = _lbNiUaiZ;
        "pkg-0.10.1" = _ECtl1LLu;
        "pkg-0.10.2" = _nESdjXrP;
        "pkg-0.11.0" = _rHvTcLTD;
        "pkg-0.11.1" = _UVG5A29a;
        "pkg-0.11.2" = _IxApoAiY;
        "pkg-0.11.3" = _PM50SjEa;
        "pkg-0.11.5" = _L7s95WUB;
        "pkg-0.11.6" = _I4ysQmfo;
        "pkg-0.11.7" = _sQLgzdHI;
        "pkg-0.11.8" = _qu8kvzTa;
        "pkg-0.11.9" = _AtVRYjOO;
        "pkg-1.0.0-beta.1" = _pw9Ihb7T;
        "pkg-1.0.0-beta.2" = _dHLsGd1i;
        "pkg-1.0.0-beta.3" = _ljfL5jvW;
        "pkg-1.0.0-beta.4" = _TLCGAq35;
        "pkg-1.0.0-beta.5" = _YzCa8pHe;
        "pkg-1.0.0-beta.6" = _fErtHAy3;
        "pkg-1.0.0-beta.7" = _Icrv0UBZ;
        "pkg-1.0.0-beta.8" = _Q3J1boAI;
        "pkg-1.0.0-beta.9" = _x5N3ItW8;
        "pkg-1.0.0-beta.10" = _CTWJh8fM;
        "pkg-1.0.0-beta.11" = _nrxDM59m;
        "pkg-1.0.0" = _QCN3ORdw;
        "pkg-1.0.1" = _TGoMudvx;
        "pkg-1.0.2" = _gCCJGVa1;
        "pkg-1.0.3" = _F7t5VMNn;
        ...
        "pkg-1.0.8" = _RNOiQDi6;
        "pkg-1.0.9" = _xj4Bb0y2;
        "pkg-1.0.10" = _GjY4Folj;
        "pkg-1.0.11" = _jR0wHhSq;
        "pkg-1.0.12" = _fqixCzvK;
        "pkg-1.0.13" = _tPGtR6ZS;
        "pkg-v1.1.0-mc26.1.2" = _xWNSykQp;
        "pkg-v1.1.2-mc26.1.2" = _Ax5CQZLt;
        "pkg-v1.1.3-mc26.1.2" = _pzQdde9D;
        "pkg-v1.1.4-mc26.1.2" = _WLZkmW7K;
        "pkg-v1.1.5-mc26.1.2" = _9cJiqyGC;
        "pkg-v1.1.6-mc26.1.2" = _bDMcEQTh;
        "pkg-v1.1.7-mc26.1.2" = _95k0awCg;
        "pkg-v1.1.9-mc26.1.2" = _kPOCWe5A;
        "pkg-v1.1.10-mc26.1.2" = _Ppe7UBMG;
        "pkg-v1.1.11-mc26.1.2" = _Kze2ZaZO;
        "pkg-v1.1.12-mc26.1.2" = _JFr12XBj;
        "pkg-v1.2.0-mc26.2" = _iGdDhzsX;
        "pkg-v1.2.1-mc26.2" = _ppxYzCbw;
        "default" = _ppxYzCbw;
    });
