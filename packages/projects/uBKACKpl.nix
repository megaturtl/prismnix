...
let
    ...
    in {
        ...
        "pkg-1.18.2-0.1.14" = _xgN0NZ8k;
        "pkg-1.20.1-0.1.18" = _NPXvArk1;
        "pkg-1.20.1-0.1.19" = _rWlXIATK;
        "pkg-1.20.1-0.1.20" = _EWjIjPJs;
        "pkg-1.20.1-0.1.21" = _wdqkiy44;
        "pkg-1.20.1-0.1.22" = _cToQAyi1;
        "pkg-1.20.1-0.2.0" = _WSjwpdmm;
