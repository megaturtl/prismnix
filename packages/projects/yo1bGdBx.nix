...
let
    ...
    in {
        ...
        "pkg-1.1" = _8SZEpZ8M;
        "pkg-1.1+mod" = _IgOXXMKN;
        "pkg-1.2" = _smgy2J5T;
        "pkg-1.2+mod" = _N4TWG9qr;
        "pkg-1.3" = _Gytxg4NB;
        "pkg-1.3+mod" = _oa0WMeEv;
        "pkg-1.4" = _pIm0vBNs;
        "pkg-1.4+mod" = _RlieJTl5;
        "pkg-1.5" = _s3jmRgy6;
        "pkg-1.5+mod" = _XjoJXDz9;
        "pkg-1.5.1" = _gbjyrFMF;
        "pkg-1.5.1+mod" = _kDW2EnWD;
        "pkg-1.5.2" = _Ovg9nAYc;
        "pkg-1.5.2+mod" = _WZW8DLfm;
        "pkg-1.5.3" = _yDKPwPkr;
        "pkg-1.5.3+mod" = _xWCZpKMt;
        "pkg-1.6" = _iu2vNkTs;
        "pkg-1.6+mod" = _WAbP6kV9;
        "pkg-1.7" = _pVhnZmh3;
        "pkg-1.7+mod" = _wNvaIBQ4;
        "pkg-1.7.1" = _ewmhRkIU;
        "pkg-1.7.1+mod" = _xrU1X2aK;
        "pkg-1.7.2" = _akWraTG6;
        "pkg-1.7.2+mod" = _bcYlBDQK;
        "pkg-1.8" = _s9vfF3Ge;
        "pkg-1.8+mod" = _T0PYnrbb;
        "pkg-1.9b" = _4CvSr5CL;
        "pkg-1.9b+mod" = _x2ZamiCn;
        "pkg-1.10" = _hBJ09o7B;
        "pkg-1.10+mod" = _rkuN80mq;
        "pkg-1.11" = _Rnga5MJn;
        "pkg-1.11+mod" = _KzaVxyCz;
        "pkg-1.11.1" = _7ucMNQqB;
        "pkg-1.11.1+mod" = _2J8TWuuf;
        "pkg-1.12" = _DnFN713x;
        "pkg-1.12+mod" = _ylIAotjR;
        "pkg-1.13" = _4CDWHEWC;
