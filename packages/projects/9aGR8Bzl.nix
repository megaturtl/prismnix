...
let
    ...
    in {
        ...
        "pkg-5.0.0" = _r0ypICzF;
        "pkg-5.0.1" = _Rr3o9m55;
        "pkg-5.0.2+1.21" = _7oDkgE9V;
        "pkg-6.0.0+1.21.2-pre1" = _WKrjhxlB;
        "pkg-6.0.0+1.21.2" = _VlNqrVwd;
        "pkg-6.0.1+1.21.2" = _ytmy99MG;
        "pkg-1.2.1+1.20" = _lcT1xB0L;
        "pkg-2.1.1+1.20.2" = _nVUtA9dp;
        "pkg-3.1.1+1.20.3" = _Robl9hFD;
        "pkg-4.1.1+1.20.5" = _QHHls68k;
        "pkg-5.0.3+1.21" = _JGk2EEUn;
        "pkg-6.0.2+1.21.2" = _tcJHCuDy;
        "pkg-7.0.0+1.21.4" = _lTKELX6V;
        "pkg-8.0.0+1.21.5" = _UftzwpRG;
        "pkg-9.0.0+1.21.6" = _5Do7WQF3;
        "pkg-10.0.0+1.21.9" = _yEPicXja;
        "pkg-11.0.0+1.21.11" = _VU2dUNTi;
