...
let
    versions = (let
        ...
        _upJ4l054 = {
            "id" = "upJ4l054";
            "file" = "UltraCoinFlip-6.2.0.jar";
            "hash" = "sha512-h20+aWuoO/1cdOr2HEQ3gTjZEpzuKt7WEdx+VOKQf9YdLMFl+saCxSh+4X3XAPHAZb5cpy1iKyGrd3ef2GBepA==";
        };
        _SWe1foLQ = {
            "id" = "SWe1foLQ";
            "file" = "UltraCoinFlip-6.2.1.jar";
            "hash" = "sha512-SEBbG/KyNJYjz+9BfH1WSitgTiIuF3yiDNlk4jiGedobPPgkzPk+7ZqKIAf5w0klcfuuXdTZu4jaj/m86IGD1A==";
        };
        _KOZeVYFP = {
            "id" = "KOZeVYFP";
            "file" = "UltraCoinFlip-6.3.0.jar";
            "hash" = "sha512-K5IZaSlzwiJZmuaFoFW88alxy+R2zNUfa7j87AxtkZmN6oleoKPY5Vx6tCfgaI//YrF8mFGTSvWpf2sva7dlyg==";
        };
        _frtIA9Cc = {
            "id" = "frtIA9Cc";
            "file" = "UltraCoinFlip-6.3.1.jar";
            "hash" = "sha512-lMQfxF9Yw/UnHMqBQ2R5531uHnX3zPymwUopS2hFdcLkJJ9rnOy0vB7g2sA/CEP5IzrpGB1SSN3gxW4Bx3O70g==";
        };
        _1NESeNXQ = {
            "id" = "1NESeNXQ";
            "file" = "UltraCoinFlip-6.3.2.jar";
            "hash" = "sha512-zrTpWSIcdS0sFmPw1btrfW85EQ+6KrBfIs8SUIfqsb3hTxgYcX6UJeUh7+5ldBYNf4yXL+oSlXDAAN36r4kW4Q==";
        };
        _9Hlr6D89 = {
            "id" = "9Hlr6D89";
            "file" = "UltraCoinFlip-6.3.3.jar";
            "hash" = "sha512-VzohBl7K6q2/5dCwjxL7zpipaWkxBr241k9hizuyWhYbacF/z0R6gjJb/cqlqRuJzkv/5+UOkpsY+UU3lpOVbA==";
        };
        _uSxZuwuf = {
            "id" = "uSxZuwuf";
            "file" = "UltraCoinFlip-6.3.4.jar";
            "hash" = "sha512-b97mGaox/fOmH7B9ke5APscAnB7RWcjFzylI9VbmjuIZ3EdP7eD/3/po7mu8tkoCEuinVzuD2xuoxgzfa5T3ig==";
        };
    in {
        "grGTEqE3" = _grGTEqE3;
        "4OBGxIJP" = _4OBGxIJP;
        ...
        "9Hlr6D89" = _9Hlr6D89;
        "uSxZuwuf" = _uSxZuwuf;
        "bukkit-1.20.4" = _uSxZuwuf;
        "bukkit-1.20.5" = _uSxZuwuf;
        "bukkit-1.20.6" = _uSxZuwuf;
        "bukkit-1.21" = _uSxZuwuf;
        "bukkit-1.21.1" = _uSxZuwuf;
        "bukkit-1.21.2" = _uSxZuwuf;
        "bukkit-1.21.3" = _uSxZuwuf;
        "bukkit-1.21.4" = _uSxZuwuf;
        "bukkit-1.21.5" = _uSxZuwuf;
        "bukkit-1.21.6" = _uSxZuwuf;
        "bukkit-1.21.7" = _uSxZuwuf;
        "bukkit-1.21.8" = _uSxZuwuf;
        "bukkit-1.21.9" = _uSxZuwuf;
        "bukkit-1.21.10" = _uSxZuwuf;
        "bukkit-1.8.8" = _uSxZuwuf;
        "bukkit-1.8.9" = _uSxZuwuf;
        "bukkit-1.9" = _uSxZuwuf;
        "bukkit-1.9.1" = _uSxZuwuf;
        "bukkit-1.9.2" = _uSxZuwuf;
        "bukkit-1.9.3" = _uSxZuwuf;
        "bukkit-1.9.4" = _uSxZuwuf;
        "bukkit-1.10" = _uSxZuwuf;
        "bukkit-1.10.1" = _uSxZuwuf;
        "bukkit-1.10.2" = _uSxZuwuf;
        "bukkit-1.11" = _uSxZuwuf;
        "bukkit-1.11.1" = _uSxZuwuf;
        "bukkit-1.11.2" = _uSxZuwuf;
        "bukkit-1.12" = _uSxZuwuf;
        "bukkit-1.12.1" = _uSxZuwuf;
        "bukkit-1.12.2" = _uSxZuwuf;
        "bukkit-1.13" = _uSxZuwuf;
        "bukkit-1.13.1" = _uSxZuwuf;
        "bukkit-1.13.2" = _uSxZuwuf;
        "bukkit-1.14" = _uSxZuwuf;
        "bukkit-1.14.1" = _uSxZuwuf;
        "bukkit-1.14.2" = _uSxZuwuf;
        "bukkit-1.14.3" = _uSxZuwuf;
        "bukkit-1.14.4" = _uSxZuwuf;
        "bukkit-1.15" = _uSxZuwuf;
        "bukkit-1.15.1" = _uSxZuwuf;
        "bukkit-1.15.2" = _uSxZuwuf;
        "bukkit-1.16" = _uSxZuwuf;
        "bukkit-1.16.1" = _uSxZuwuf;
        "bukkit-1.16.2" = _uSxZuwuf;
        "bukkit-1.16.3" = _uSxZuwuf;
        "bukkit-1.16.4" = _uSxZuwuf;
        "bukkit-1.16.5" = _uSxZuwuf;
        "bukkit-1.17" = _uSxZuwuf;
        "bukkit-1.17.1" = _uSxZuwuf;
        "bukkit-1.18" = _uSxZuwuf;
        "bukkit-1.18.1" = _uSxZuwuf;
        "bukkit-1.18.2" = _uSxZuwuf;
        "bukkit-1.19" = _uSxZuwuf;
        "bukkit-1.19.1" = _uSxZuwuf;
        "bukkit-1.19.2" = _uSxZuwuf;
        "bukkit-1.19.3" = _uSxZuwuf;
        "bukkit-1.19.4" = _uSxZuwuf;
        "bukkit-1.20" = _uSxZuwuf;
        "bukkit-1.20.1" = _uSxZuwuf;
        "bukkit-1.20.2" = _uSxZuwuf;
        "bukkit-1.20.3" = _uSxZuwuf;
        "bukkit-1.21.11" = _uSxZuwuf;
        "bukkit-26.1" = _uSxZuwuf;
        "bukkit-26.1.1" = _uSxZuwuf;
        "bukkit-26.1.2" = _uSxZuwuf;
        "bukkit-26.2" = _uSxZuwuf;
        "bukkit-1.8.3" = _upJ4l054;
        "bukkit-1.8.4" = _upJ4l054;
        "bukkit-1.8.5" = _upJ4l054;
        "bukkit-1.8.6" = _upJ4l054;
        "bukkit-1.8.7" = _upJ4l054;
        "paper-1.20.4" = _uSxZuwuf;
        "paper-1.20.5" = _uSxZuwuf;
        "paper-1.20.6" = _uSxZuwuf;
        "paper-1.21" = _uSxZuwuf;
        "paper-1.21.1" = _uSxZuwuf;
        "paper-1.21.2" = _uSxZuwuf;
        "paper-1.21.3" = _uSxZuwuf;
        "paper-1.21.4" = _uSxZuwuf;
        "paper-1.21.5" = _uSxZuwuf;
        "paper-1.21.6" = _uSxZuwuf;
        "paper-1.21.7" = _uSxZuwuf;
        "paper-1.21.8" = _uSxZuwuf;
        "paper-1.21.9" = _uSxZuwuf;
        "paper-1.21.10" = _uSxZuwuf;
        "paper-1.8.8" = _uSxZuwuf;
        "paper-1.8.9" = _uSxZuwuf;
        "paper-1.9" = _uSxZuwuf;
        "paper-1.9.1" = _uSxZuwuf;
        "paper-1.9.2" = _uSxZuwuf;
        "paper-1.9.3" = _uSxZuwuf;
        "paper-1.9.4" = _uSxZuwuf;
        "paper-1.10" = _uSxZuwuf;
        "paper-1.10.1" = _uSxZuwuf;
        "paper-1.10.2" = _uSxZuwuf;
        "paper-1.11" = _uSxZuwuf;
        "paper-1.11.1" = _uSxZuwuf;
        "paper-1.11.2" = _uSxZuwuf;
        "paper-1.12" = _uSxZuwuf;
        "paper-1.12.1" = _uSxZuwuf;
        "paper-1.12.2" = _uSxZuwuf;
        "paper-1.13" = _uSxZuwuf;
        "paper-1.13.1" = _uSxZuwuf;
        "paper-1.13.2" = _uSxZuwuf;
        "paper-1.14" = _uSxZuwuf;
        "paper-1.14.1" = _uSxZuwuf;
        "paper-1.14.2" = _uSxZuwuf;
        "paper-1.14.3" = _uSxZuwuf;
        "paper-1.14.4" = _uSxZuwuf;
        "paper-1.15" = _uSxZuwuf;
        "paper-1.15.1" = _uSxZuwuf;
        "paper-1.15.2" = _uSxZuwuf;
        "paper-1.16" = _uSxZuwuf;
        "paper-1.16.1" = _uSxZuwuf;
        "paper-1.16.2" = _uSxZuwuf;
        "paper-1.16.3" = _uSxZuwuf;
        "paper-1.16.4" = _uSxZuwuf;
        "paper-1.16.5" = _uSxZuwuf;
        "paper-1.17" = _uSxZuwuf;
        "paper-1.17.1" = _uSxZuwuf;
        "paper-1.18" = _uSxZuwuf;
        "paper-1.18.1" = _uSxZuwuf;
        "paper-1.18.2" = _uSxZuwuf;
        "paper-1.19" = _uSxZuwuf;
        "paper-1.19.1" = _uSxZuwuf;
        "paper-1.19.2" = _uSxZuwuf;
        "paper-1.19.3" = _uSxZuwuf;
        "paper-1.19.4" = _uSxZuwuf;
        "paper-1.20" = _uSxZuwuf;
        "paper-1.20.1" = _uSxZuwuf;
        "paper-1.20.2" = _uSxZuwuf;
        "paper-1.20.3" = _uSxZuwuf;
        "paper-1.21.11" = _uSxZuwuf;
        "paper-26.1" = _uSxZuwuf;
        "paper-26.1.1" = _uSxZuwuf;
        "paper-26.1.2" = _uSxZuwuf;
        "paper-26.2" = _uSxZuwuf;
        "paper-1.8.3" = _upJ4l054;
        "paper-1.8.4" = _upJ4l054;
        "paper-1.8.5" = _upJ4l054;
        "paper-1.8.6" = _upJ4l054;
        "paper-1.8.7" = _upJ4l054;
        "spigot-1.20.4" = _uSxZuwuf;
        "spigot-1.20.5" = _uSxZuwuf;
        "spigot-1.20.6" = _uSxZuwuf;
        "spigot-1.21" = _uSxZuwuf;
        "spigot-1.21.1" = _uSxZuwuf;
        "spigot-1.21.2" = _uSxZuwuf;
        "spigot-1.21.3" = _uSxZuwuf;
        "spigot-1.21.4" = _uSxZuwuf;
        "spigot-1.21.5" = _uSxZuwuf;
        "spigot-1.21.6" = _uSxZuwuf;
        "spigot-1.21.7" = _uSxZuwuf;
        "spigot-1.21.8" = _uSxZuwuf;
        "spigot-1.21.9" = _uSxZuwuf;
        "spigot-1.21.10" = _uSxZuwuf;
        "spigot-1.8.8" = _uSxZuwuf;
        "spigot-1.8.9" = _uSxZuwuf;
        "spigot-1.9" = _uSxZuwuf;
        "spigot-1.9.1" = _uSxZuwuf;
        "spigot-1.9.2" = _uSxZuwuf;
        "spigot-1.9.3" = _uSxZuwuf;
        "spigot-1.9.4" = _uSxZuwuf;
        "spigot-1.10" = _uSxZuwuf;
        "spigot-1.10.1" = _uSxZuwuf;
        "spigot-1.10.2" = _uSxZuwuf;
        "spigot-1.11" = _uSxZuwuf;
        "spigot-1.11.1" = _uSxZuwuf;
        "spigot-1.11.2" = _uSxZuwuf;
        "spigot-1.12" = _uSxZuwuf;
        "spigot-1.12.1" = _uSxZuwuf;
        "spigot-1.12.2" = _uSxZuwuf;
        "spigot-1.13" = _uSxZuwuf;
        "spigot-1.13.1" = _uSxZuwuf;
        "spigot-1.13.2" = _uSxZuwuf;
        "spigot-1.14" = _uSxZuwuf;
        "spigot-1.14.1" = _uSxZuwuf;
        "spigot-1.14.2" = _uSxZuwuf;
        "spigot-1.14.3" = _uSxZuwuf;
        "spigot-1.14.4" = _uSxZuwuf;
        "spigot-1.15" = _uSxZuwuf;
        "spigot-1.15.1" = _uSxZuwuf;
        "spigot-1.15.2" = _uSxZuwuf;
        "spigot-1.16" = _uSxZuwuf;
        "spigot-1.16.1" = _uSxZuwuf;
        "spigot-1.16.2" = _uSxZuwuf;
        "spigot-1.16.3" = _uSxZuwuf;
        "spigot-1.16.4" = _uSxZuwuf;
        "spigot-1.16.5" = _uSxZuwuf;
        "spigot-1.17" = _uSxZuwuf;
        "spigot-1.17.1" = _uSxZuwuf;
        "spigot-1.18" = _uSxZuwuf;
        "spigot-1.18.1" = _uSxZuwuf;
        "spigot-1.18.2" = _uSxZuwuf;
        "spigot-1.19" = _uSxZuwuf;
        "spigot-1.19.1" = _uSxZuwuf;
        "spigot-1.19.2" = _uSxZuwuf;
        "spigot-1.19.3" = _uSxZuwuf;
        "spigot-1.19.4" = _uSxZuwuf;
        "spigot-1.20" = _uSxZuwuf;
        "spigot-1.20.1" = _uSxZuwuf;
        "spigot-1.20.2" = _uSxZuwuf;
        "spigot-1.20.3" = _uSxZuwuf;
        "spigot-1.21.11" = _uSxZuwuf;
        "spigot-26.1" = _uSxZuwuf;
        "spigot-26.1.1" = _uSxZuwuf;
        "spigot-26.1.2" = _uSxZuwuf;
        "spigot-26.2" = _uSxZuwuf;
        "spigot-1.8.3" = _upJ4l054;
        "spigot-1.8.4" = _upJ4l054;
        "spigot-1.8.5" = _upJ4l054;
        "spigot-1.8.6" = _upJ4l054;
        "spigot-1.8.7" = _upJ4l054;
        "folia-1.8.8" = _uSxZuwuf;
        "folia-1.8.9" = _uSxZuwuf;
        "folia-1.9" = _uSxZuwuf;
        "folia-1.9.1" = _uSxZuwuf;
        "folia-1.9.2" = _uSxZuwuf;
        "folia-1.9.3" = _uSxZuwuf;
        "folia-1.9.4" = _uSxZuwuf;
        "folia-1.10" = _uSxZuwuf;
        "folia-1.10.1" = _uSxZuwuf;
        "folia-1.10.2" = _uSxZuwuf;
        "folia-1.11" = _uSxZuwuf;
        "folia-1.11.1" = _uSxZuwuf;
        "folia-1.11.2" = _uSxZuwuf;
        "folia-1.12" = _uSxZuwuf;
        "folia-1.12.1" = _uSxZuwuf;
        "folia-1.12.2" = _uSxZuwuf;
        "folia-1.13" = _uSxZuwuf;
        "folia-1.13.1" = _uSxZuwuf;
        "folia-1.13.2" = _uSxZuwuf;
        "folia-1.14" = _uSxZuwuf;
        "folia-1.14.1" = _uSxZuwuf;
        "folia-1.14.2" = _uSxZuwuf;
        "folia-1.14.3" = _uSxZuwuf;
        "folia-1.14.4" = _uSxZuwuf;
        "folia-1.15" = _uSxZuwuf;
        "folia-1.15.1" = _uSxZuwuf;
        "folia-1.15.2" = _uSxZuwuf;
        "folia-1.16" = _uSxZuwuf;
        "folia-1.16.1" = _uSxZuwuf;
        "folia-1.16.2" = _uSxZuwuf;
        "folia-1.16.3" = _uSxZuwuf;
        "folia-1.16.4" = _uSxZuwuf;
        "folia-1.16.5" = _uSxZuwuf;
        "folia-1.17" = _uSxZuwuf;
        "folia-1.17.1" = _uSxZuwuf;
        "folia-1.18" = _uSxZuwuf;
        "folia-1.18.1" = _uSxZuwuf;
        "folia-1.18.2" = _uSxZuwuf;
        "folia-1.19" = _uSxZuwuf;
        "folia-1.19.1" = _uSxZuwuf;
        "folia-1.19.2" = _uSxZuwuf;
        "folia-1.19.3" = _uSxZuwuf;
        "folia-1.19.4" = _uSxZuwuf;
        "folia-1.20" = _uSxZuwuf;
        "folia-1.20.1" = _uSxZuwuf;
        "folia-1.20.2" = _uSxZuwuf;
        "folia-1.20.3" = _uSxZuwuf;
        "folia-1.20.4" = _uSxZuwuf;
        "folia-1.20.5" = _uSxZuwuf;
        "folia-1.20.6" = _uSxZuwuf;
        "folia-1.21" = _uSxZuwuf;
        "folia-1.21.1" = _uSxZuwuf;
        "folia-1.21.2" = _uSxZuwuf;
        "folia-1.21.3" = _uSxZuwuf;
        "folia-1.21.4" = _uSxZuwuf;
        "folia-1.21.5" = _uSxZuwuf;
        "folia-1.21.6" = _uSxZuwuf;
        "folia-1.21.7" = _uSxZuwuf;
        "folia-1.21.8" = _uSxZuwuf;
        "folia-1.21.9" = _uSxZuwuf;
        "folia-1.21.10" = _uSxZuwuf;
        "folia-1.21.11" = _uSxZuwuf;
        "folia-26.1" = _uSxZuwuf;
        "folia-26.1.1" = _uSxZuwuf;
        "folia-26.1.2" = _uSxZuwuf;
        "folia-26.2" = _uSxZuwuf;
        "folia-1.8.3" = _upJ4l054;
        "folia-1.8.4" = _upJ4l054;
        "folia-1.8.5" = _upJ4l054;
        "folia-1.8.6" = _upJ4l054;
        "folia-1.8.7" = _upJ4l054;
        "purpur-1.8.8" = _uSxZuwuf;
        "purpur-1.8.9" = _uSxZuwuf;
        "purpur-1.9" = _uSxZuwuf;
        "purpur-1.9.1" = _uSxZuwuf;
        "purpur-1.9.2" = _uSxZuwuf;
        "purpur-1.9.3" = _uSxZuwuf;
        "purpur-1.9.4" = _uSxZuwuf;
        "purpur-1.10" = _uSxZuwuf;
        "purpur-1.10.1" = _uSxZuwuf;
        "purpur-1.10.2" = _uSxZuwuf;
        "purpur-1.11" = _uSxZuwuf;
        "purpur-1.11.1" = _uSxZuwuf;
        "purpur-1.11.2" = _uSxZuwuf;
        "purpur-1.12" = _uSxZuwuf;
        "purpur-1.12.1" = _uSxZuwuf;
        "purpur-1.12.2" = _uSxZuwuf;
        "purpur-1.13" = _uSxZuwuf;
        "purpur-1.13.1" = _uSxZuwuf;
        "purpur-1.13.2" = _uSxZuwuf;
        "purpur-1.14" = _uSxZuwuf;
        "purpur-1.14.1" = _uSxZuwuf;
        "purpur-1.14.2" = _uSxZuwuf;
        "purpur-1.14.3" = _uSxZuwuf;
        "purpur-1.14.4" = _uSxZuwuf;
        "purpur-1.15" = _uSxZuwuf;
        "purpur-1.15.1" = _uSxZuwuf;
        "purpur-1.15.2" = _uSxZuwuf;
        "purpur-1.16" = _uSxZuwuf;
        "purpur-1.16.1" = _uSxZuwuf;
        "purpur-1.16.2" = _uSxZuwuf;
        "purpur-1.16.3" = _uSxZuwuf;
        "purpur-1.16.4" = _uSxZuwuf;
        "purpur-1.16.5" = _uSxZuwuf;
        "purpur-1.17" = _uSxZuwuf;
        "purpur-1.17.1" = _uSxZuwuf;
        "purpur-1.18" = _uSxZuwuf;
        "purpur-1.18.1" = _uSxZuwuf;
        "purpur-1.18.2" = _uSxZuwuf;
        "purpur-1.19" = _uSxZuwuf;
        "purpur-1.19.1" = _uSxZuwuf;
        "purpur-1.19.2" = _uSxZuwuf;
        "purpur-1.19.3" = _uSxZuwuf;
        "purpur-1.19.4" = _uSxZuwuf;
        "purpur-1.20" = _uSxZuwuf;
        "purpur-1.20.1" = _uSxZuwuf;
        "purpur-1.20.2" = _uSxZuwuf;
        "purpur-1.20.3" = _uSxZuwuf;
        "purpur-1.20.4" = _uSxZuwuf;
        "purpur-1.20.5" = _uSxZuwuf;
        "purpur-1.20.6" = _uSxZuwuf;
        "purpur-1.21" = _uSxZuwuf;
        "purpur-1.21.1" = _uSxZuwuf;
        "purpur-1.21.2" = _uSxZuwuf;
        "purpur-1.21.3" = _uSxZuwuf;
        "purpur-1.21.4" = _uSxZuwuf;
        "purpur-1.21.5" = _uSxZuwuf;
        "purpur-1.21.6" = _uSxZuwuf;
        "purpur-1.21.7" = _uSxZuwuf;
        "purpur-1.21.8" = _uSxZuwuf;
        "purpur-1.21.9" = _uSxZuwuf;
        "purpur-1.21.10" = _uSxZuwuf;
        "purpur-1.21.11" = _uSxZuwuf;
        "purpur-26.1" = _uSxZuwuf;
        "purpur-26.1.1" = _uSxZuwuf;
        "purpur-26.1.2" = _uSxZuwuf;
        "purpur-26.2" = _uSxZuwuf;
        "purpur-1.8.3" = _upJ4l054;
        "purpur-1.8.4" = _upJ4l054;
        "purpur-1.8.5" = _upJ4l054;
        "purpur-1.8.6" = _upJ4l054;
        "purpur-1.8.7" = _upJ4l054;
        "pkg-1.0.0" = _grGTEqE3;
        "pkg-1.1.0" = _4OBGxIJP;
        "pkg-1.1.1" = _CWOCrJiq;
        "pkg-3.0.3" = _yFpBx6pk;
        ...
        "pkg-3.9.1" = _BNK8flkU;
        "pkg-3.9.2" = _tou4CDDQ;
        "pkg-3.10.0" = _Jo21la7p;
        "pkg-3.11.0" = _aOnm7nmL;
        "pkg-3.12.0" = _sHB2aykZ;
        "pkg-3.12.1" = _bEqrHGVv;
        "pkg-3.12.2" = _sYv8FPx7;
        "pkg-3.12.3" = _Sl2x7Vt2;
        "pkg-3.12.4" = _140Mo363;
        "pkg-3.13.0" = _PxEOZ91z;
        "pkg-3.13.1" = _RX4q8mV0;
        "pkg-3.14.0" = _WAEQQY20;
        "pkg-3.14.2" = _QiLpKPic;
        "pkg-3.14.3" = _YS47bnnN;
        "pkg-3.15.0" = _bWQhhu5I;
        "pkg-3.15.1" = _aYTdy1GW;
        "pkg-3.15.2" = _uIELOwTZ;
        "pkg-3.15.3" = _dhL18oZE;
        "pkg-3.16.0" = _mUmdKM7d;
        "pkg-3.16.1" = _qyGxVWjW;
        "pkg-3.17.0" = _DRb9MISq;
        "pkg-3.17.1" = _rV7k8PBg;
        "pkg-3.17.2" = _EgjctVuC;
        "pkg-3.17.3" = _dzMo46nF;
        "pkg-3.17.4" = _W6EddFWT;
        "pkg-3.18.0" = _QCxOJIPN;
        "pkg-3.18.1" = _O3nrN6Pp;
        "pkg-3.18.2" = _8PCfAudD;
        "pkg-3.18.3" = _Nkku58ux;
        "pkg-3.19.0" = _9x0Awnhx;
        "pkg-4.0.0" = _SllPzAe7;
        "pkg-4.0.1" = _nXfq0mbv;
        "pkg-4.1.1" = _f8zK9Zd7;
        "pkg-5.0.0" = _n0IOPAwh;
