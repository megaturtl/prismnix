...
let
    ...
    in {
        ...
        "pkg-1.19.3-Fabric-3.3.0" = _So0mVHEW;
        "pkg-1.19.4-Fabric-3.4.0" = _ndfXFrkZ;
        "pkg-1.19.4-Forge-3.4.0" = _JylvzoB0;
        "pkg-1.20-Forge-4.0.1" = _sZO4lGuf;
        "pkg-1.20-Fabric-4.0.1" = _xraHSR9S;
        "pkg-1.20-Forge-4.0.2" = _cJ2CwZT6;
        "pkg-1.20-Fabric-4.0.2" = _iOEKpSFY;
        "pkg-1.20-Forge-4.0.3" = _yyEN8Zb4;
        "pkg-1.20-Fabric-4.0.3" = _bSSS84Op;
        "pkg-1.20.4-Forge-4.4.0" = _sOx1vdMN;
        "pkg-1.20.4-Fabric-4.4.0" = _4RpKnxDR;
        "pkg-1.20.4-Forge-4.4.1" = _xMqv6c8w;
        "pkg-1.20.4-Fabric-4.4.1" = _8zaPNLL8;
        "pkg-1.20.4-Forge-4.4.2" = _9jmgNEyb;
        "pkg-1.20.4-Fabric-4.4.2" = _y2Ahguul;
        "pkg-1.20-Fabric-4.0.4" = _nidyvq2m;
        "pkg-1.20-Forge-4.0.4" = _kPiQ6v4q;
        "pkg-1.20.4-Forge-4.4.3" = _sSqM7waC;
        "pkg-1.20.4-NeoForge-4.4.3" = _sR9iSOHj;
        "pkg-1.20.4-Fabric-4.4.3" = _60GnmH9u;
        "pkg-1.20.4-Forge-4.4.4" = _5e0sLvAW;
        "pkg-1.20.4-NeoForge-4.4.4" = _emTrSGfp;
        "pkg-1.20.4-Fabric-4.4.4" = _ISvARzqL;
        "pkg-1.21.1-Fabric-5.1.0" = _s6BiLxo6;
        "pkg-1.21.1-Forge-5.1.0" = _fN6Wv16s;
        "pkg-1.21.1-NeoForge-5.1.0" = _ZWDbFefV;
        "pkg-1.21.1-Forge-5.1.1" = _SlahCF5y;
        "pkg-1.21.1-NeoForge-5.1.1" = _zic1ndGE;
        "pkg-1.21.1-Fabric-5.1.1" = _bBWVr9v2;
        "pkg-1.21.1-Forge-5.1.2" = _LoQmT3Ih;
        "pkg-1.21.1-NeoForge-5.1.2" = _65IL2kKI;
        "pkg-1.21.1-Fabric-5.1.2" = _E9LsQ4k7;
        "pkg-1.21.1-Forge-5.1.3" = _eBEFvytl;
        "pkg-1.21.1-NeoForge-5.1.3" = _RqX5d3pv;
        "pkg-1.21.1-Fabric-5.1.3" = _uaoqiHOb;
        "pkg-1.21.1-Forge-5.1.4" = _pzPJomj9;
        "pkg-1.21.1-NeoForge-5.1.4" = _D6aZn0Em;
        "pkg-1.21.1-Fabric-5.1.4" = _fQ7EjDPE;
        "pkg-1.21.4-NeoForge-5.4.0" = _XH5CZtOR;
