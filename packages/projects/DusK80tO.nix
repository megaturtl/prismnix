...
let
    versions = (let
        ...
        _YMdUFPiH = {
            "id" = "YMdUFPiH";
            "file" = "easybrewing-neoforge-26.3-26.3.0.0.jar";
            "hash" = "sha512-E99yojun5owwrM8YYH58EQd1nM/CzW0dB/qk/HGfckuqNt35wxKmJfKmP9/kRsx7ZNXegdbcMi8+1BiMNhgpyg==";
        };
        _EiTK7mLc = {
            "id" = "EiTK7mLc";
            "file" = "easybrewing-fabric-26.3-26.3.0.0.jar";
            "hash" = "sha512-CMDfe6nucvIkEMA+48rJ/ANPWmGMetyM0pgBga85a3abgMoAjVvlFXa7Alss+dRZSfX5e2hw1fd9Tf9u1YyzMA==";
        };
    in {
        "KRW0DZfS" = _KRW0DZfS;
        "TYwgpRlB" = _TYwgpRlB;
        ...
        "fabric-26.3" = _EiTK7mLc;
        "forge-1.21.11" = _gUB10lCP;
        "forge-1.20.1" = _8tGPY95O;
        "pkg-1.0.0+1.21.1-neoforge" = _KRW0DZfS;
        "pkg-1.0.0+1.21.1-fabric" = _TYwgpRlB;
        "pkg-1.0.0+1.21.11-neoforge" = _d1I8RU8u;
        "pkg-1.0.1+1.21.11-neoforge" = _yq3hFjoT;
        "pkg-1.0.0+1.21.11-forge" = _j91RItlt;
        "pkg-1.0.0+1.21.11-fabric" = _UNFk1wXX;
        "pkg-1.0.0+1.20.1-forge" = _TtCJjUjr;
        "pkg-1.0.1+1.20.1-forge" = _92Ctwual;
        "pkg-1.0.0+1.20.1-fabric" = _eHkaATE4;
        "pkg-1.1.0+1.21.11-neoforge" = _hUWkAuC9;
        "pkg-1.1.0+1.21.1-neoforge" = _ZHP3ocLB;
        "pkg-1.1.0+1.20.1-forge" = _OWyAvtBN;
        "pkg-1.1.0+1.21.11-forge" = _mnnpM4yb;
        "pkg-1.1.0+1.21.11-fabric" = _JuY8UD9Z;
        "pkg-1.1.0+1.21.1-fabric" = _gZenmpnB;
        "pkg-1.1.0+1.20.1-fabric" = _WDTy9Nf5;
        "pkg-1.1.1+1.21.1-fabric" = _i9alm5nV;
        "pkg-1.2.0+1.21.1-neoforge" = _w4pv9HpG;
        "pkg-1.2.0+1.20.1-forge" = _QGKeS5vw;
        "pkg-1.2.1+1.21.1-neoforge" = _Uzj6wLE3;
        "pkg-1.2.0+1.21.11-neoforge" = _JrBiNJcw;
        "pkg-1.2.0+1.21.11-forge" = _gUB10lCP;
        "pkg-1.2.0+1.21.11-fabric" = _dQLIJJq2;
        "pkg-1.2.0+1.21.1-fabric" = _c6WPxsXv;
        "pkg-1.2.0+1.20.1-fabric" = _3gYaFPD4;
        "pkg-1.2.0+26.1-snapshot-7-fabric" = _SSVxkFyL;
        "pkg-1.2.0+26.1-fabric" = _YEAdhkot;
        "pkg-1.2.0+26.1-neoforge" = _c620PuHe;
        "pkg-1.2.1+1.21.1-fabric" = _lSFLsNbK;
        "pkg-26.1.2.0" = _MO62iFkr;
        "pkg-1.3.0+1.21.1-neoforge" = _sYSzt657;
        "pkg-1.3.0+1.20.1-forge" = _8tGPY95O;
        "pkg-26.1.2.1" = _MOudHqog;
        "pkg-26.1.2.2" = _FoxIZF4V;
        "pkg-1.3.1+1.21.1-neoforge" = _cWb5uNbt;
        "pkg-26.2.0" = _MnIbAKYi;
        "pkg-26.3.0.0" = _EiTK7mLc;
        "default" = _EiTK7mLc;
    });
