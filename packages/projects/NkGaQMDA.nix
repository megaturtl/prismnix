...
let
    versions = (let
        ...
        _8ONvdVJ2 = {
            "id" = "8ONvdVJ2";
            "file" = "wizards-fabric-3.1.0.111+1.21.1.jar";
            "hash" = "sha512-TH2v5aaAzb9aGtotfgNucuxPbTAEGcuZ4Rh/q6NllQKlzNrWKC8xRAdSFXzPtCHmt9VIzbUDCaAB9Iv4UFWHZQ==";
        };
        _k4iKmldG = {
            "id" = "k4iKmldG";
            "file" = "wizards-neoforge-3.1.0.111+1.21.1.jar";
            "hash" = "sha512-s9Z259sP52y6zkKrbu/vRae7FjF+osteqlwyivxOS8g0oJGXlrn6SZnkwHWIcRIPH7gHv0+2pheuZZlVUPV2sg==";
        };
        _lNwB7WlI = {
            "id" = "lNwB7WlI";
            "file" = "wizards-neoforge-3.1.1+1.21.1.jar";
            "hash" = "sha512-GODTsMu/8uFQqWyE3SCHo/aBl0Mp4j7CxAhJ75tVwJa85Jc45z4l2sSzpBVK6iaj5J+NUCMiISFGIlLDxKgyWQ==";
        };
        _nqeQTdGL = {
            "id" = "nqeQTdGL";
            "file" = "wizards-fabric-3.1.2+1.21.1.jar";
            "hash" = "sha512-bmwLMLBIoI14ZMandJm0bAAdt58ybMUpsfzQO2XrWO55Tj3AX3Vz6ntfiveSBuYpEEHHfk4v5xybF03Yx8EWeQ==";
        };
        _JuuGt2qE = {
            "id" = "JuuGt2qE";
            "file" = "wizards-neoforge-3.1.2+1.21.1.jar";
            "hash" = "sha512-ixWNkBxIn+RVV1ywsssINtPFNm4rSwWuWh3SP1Je6fUP5CNSEZA6yq811OJQWmUhlnjTO7ZhFKTTnsSS0xw/Ng==";
        };
        _rcSrCdPw = {
            "id" = "rcSrCdPw";
            "file" = "wizards-neoforge-3.1.2+26.1.2.jar";
            "hash" = "sha512-HsaXVRfRIOr2BHkiQJLQHdPv1qBm3jhmk7ietsj1nqYbn/C3JEpWCQHeXD66FhqQIkSLU9p8lMipc6kL7w8Hig==";
        };
        _F2MfEMkO = {
            "id" = "F2MfEMkO";
            "file" = "wizards-fabric-3.1.2+26.1.2.jar";
            "hash" = "sha512-Z9p/jFlN9uo4ugLMWBNvsf66HPVu0pO11fRrY+Fv7ITGClGo/4h6QyXf8U0ZLqg/A+FBKeVMoq8s9U5G1ig5JQ==";
        };
        _Dx5XKjXr = {
            "id" = "Dx5XKjXr";
            "file" = "wizards-fabric-3.1.2+26.2.jar";
            "hash" = "sha512-SXJbSKCFZX5IsOdSvDzkUdGL/O0GQCoMUHXMCO99AQrmRnpsURnOqPx/GSvkpr4HT7qcYKyZd+bg2Y1/w8teow==";
        };
        _MFdRp8Ls = {
            "id" = "MFdRp8Ls";
    ...
    in {
        ...
        "pkg-0.9.6+1.19-fabric" = _GJyu1hZI;
        "pkg-0.9.7+1.19-fabric" = _py629JVd;
        "pkg-0.9.8+1.19-fabric" = _ZUJ2f1CP;
        "pkg-0.9.9+1.19-fabric" = _X3gIusnV;
        "pkg-0.9.10+1.19-fabric" = _LpO6bTGZ;
        "pkg-0.9.11+1.19-fabric" = _ZMr4ErRM;
        "pkg-0.9.12+1.19-fabric" = _O2nhdZFf;
        "pkg-0.9.13+1.19-fabric" = _6oPtnMZM;
        "pkg-0.9.14+1.19-fabric" = _oxldoc7d;
        "pkg-0.9.15+1.19-fabric" = _CE01pjnZ;
        "pkg-0.9.16+1.19-fabric" = _1OWAbdJR;
        "pkg-0.9.17+1.19-fabric" = _vdXkMTSU;
        "pkg-0.9.18+1.20.1-fabric" = _Dln1uX6N;
        "pkg-0.9.19+1.20.1-fabric" = _dSP812MG;
        "pkg-0.9.20+1.20.1-fabric" = _q9ntmX5T;
        "pkg-0.9.21+1.20.1-fabric" = _mWPYUhcL;
        "pkg-0.9.22+1.20.1-fabric" = _hBnfelAX;
        "pkg-0.9.23+1.20.1-fabric" = _IftBAnks;
        "pkg-1.0.0+1.20.1" = _nsPh7ijG;
        "pkg-1.0.1+1.20.1" = _Ltzv5JAH;
        "pkg-1.0.2+1.20.1" = _vFBkqvEp;
        "pkg-1.0.3+1.20.1" = _Jwz4XtL1;
        "pkg-1.0.4+1.20.1" = _hO8TYUf6;
        "pkg-1.0.5+1.20.1" = _TN07TW2k;
        "pkg-1.1.0+1.20.1" = _CPqGQOCr;
        "pkg-1.1.1+1.20.1" = _WMcQHozP;
        "pkg-1.2.0+1.20.1" = _DJR0YHdi;
        "pkg-1.2.1+1.20.1" = _9HCWJvum;
        "pkg-1.2.2+1.20.1" = _2iD8SPHt;
        "pkg-1.3.0+1.20.1" = _hMGphtUf;
        "pkg-2.0.0+1.21.1" = _A4b26c1A;
        "pkg-2.0.1+1.21.1" = _UxWMlM0b;
        "pkg-2.0.2+1.21.1" = _ATwwlT2I;
        "pkg-2.1.0+1.21.1" = _kCvuj9ae;
        "pkg-2.2.0+1.21.1" = _te2JaYhE;
        "pkg-2.2.1+1.21.1" = _uctGcXgU;
        "pkg-2.2.2+1.21.1" = _wTF56VKW;
        "pkg-2.2.3+1.21.1" = _5QH1cPp0;
        "pkg-2.2.4+1.21.1" = _NW2aHW53;
        "pkg-2.2.5+1.21.1" = _WRzLaEcT;
        "pkg-1.4.0+1.20.1" = _ckR9YQwq;
        "pkg-1.4.1+1.20.1" = _QPbAhJE1;
        "pkg-2.3.0+1.21.1" = _xgXuazC6;
        "pkg-2.3.1+1.21.1" = _EXm5jaRD;
        "pkg-2.3.2+1.21.1" = _swYGzrZV;
        "pkg-2.3.3+1.21.1" = _JxsKHyFM;
        "pkg-2.4.0+1.21.1" = _ItIiDsny;
        "pkg-2.4.1+1.21.1" = _kfqReQYe;
        "pkg-2.4.2+1.21.1" = _3ffstldR;
        "pkg-2.4.3+1.21.1" = _A1md0qM8;
        "pkg-2.4.4+1.21.1" = _ePzFhxmr;
        "pkg-2.4.5+1.21.1" = _5Bu6edM7;
        "pkg-2.4.6+1.21.1" = _O1k0fMop;
        "pkg-2.4.7+1.21.1" = _QZPL22uq;
        "pkg-2.4.8+1.21.1" = _JcgbUxyK;
        "pkg-2.4.9+1.21.1" = _4lxFj4E3;
        "pkg-2.4.10+1.21.1" = _T5ZjU5eB;
        "pkg-2.4.11+1.21.1" = _YK4LGH6Q;
        "pkg-2.4.12+1.21.1" = _mXYUsTRB;
        "pkg-2.5.0+1.21.1" = _fKnCOTA1;
        "pkg-2.5.1+1.21.1" = _uN53VgMl;
        "pkg-2.5.2+1.21.1" = _jYKkgcXb;
        "pkg-2.6.0+1.21.1-fabric" = _ZC9aeEwt;
        "pkg-2.6.0+1.21.1-neoforge" = _66yIYxR3;
        "pkg-2.6.1+1.21.1-fabric" = _SYECVV1E;
        "pkg-2.6.1+1.21.1-neoforge" = _joIQjjo9;
        "pkg-2.6.2+1.21.1-fabric" = _K9nbdarZ;
        "pkg-2.6.2+1.21.1-neoforge" = _8YkJByat;
        "pkg-2.6.3+1.21.1-fabric" = _oMVWJ2en;
        "pkg-2.6.3+1.21.1-neoforge" = _ACGJpK9i;
        "pkg-2.6.4+1.21.1-fabric" = _J2eSs8Hb;
        "pkg-2.6.4+1.21.1-neoforge" = _T9MiJOnz;
        "pkg-2.6.5+1.21.1-neoforge" = _24Ypkfrp;
        "pkg-2.6.5+1.21.1-fabric" = _dgQ9h3nd;
        "pkg-2.7.0+1.21.1-fabric" = _9JhmFwLE;
        "pkg-2.7.0+1.21.1-neoforge" = _ZvBfJyQR;
        "pkg-2.7.1+1.21.1-neoforge" = _5QJEqWD3;
        "pkg-2.7.1+1.21.1-fabric" = _NDvXbz5j;
        "pkg-3.0.0+1.21.1-fabric" = _pw7TVYDm;
        "pkg-3.0.0+1.21.1-neoforge" = _5iIuX7KL;
        "pkg-3.0.1+1.21.1-fabric" = _bzVmvziy;
        "pkg-3.0.1+1.21.1-neoforge" = _ruXnvbGl;
        "pkg-3.0.2+1.21.1-fabric" = _WpWWugcW;
        "pkg-3.0.2+1.21.1-neoforge" = _b4AWFgGr;
        "pkg-3.0.3+1.21.1-fabric" = _yXPWWNnB;
        "pkg-3.0.3+1.21.1-neoforge" = _ID85gIba;
        "pkg-3.0.4+1.21.1-neoforge" = _W76xF87G;
        "pkg-3.0.4+1.21.1-fabric" = _IhFI6pgc;
        "pkg-3.1.0.111+1.21.1-fabric" = _8ONvdVJ2;
        "pkg-3.1.0.111+1.21.1-neoforge" = _k4iKmldG;
        "pkg-3.1.1+1.21.1-neoforge" = _lNwB7WlI;
        "pkg-3.1.2+1.21.1-fabric" = _nqeQTdGL;
        "pkg-3.1.2+1.21.1-neoforge" = _JuuGt2qE;
        "pkg-3.1.2+26.1.2-neoforge" = _rcSrCdPw;
