...
let
    versions = (let
        ...
        _jFGh5onX = {
            "id" = "jFGh5onX";
            "file" = "potatologistics-1.3.1+8.0.1.jar";
            "hash" = "sha512-7CHOmaqALxXuEyGEHQe0Yf7PrT8b/tZ4/ZSAXfvO17D9I+67v55jBZHEq5IV+JMZ5XiB9ct6KIOkjg5jMffF4g==";
        };
    in {
        "rDhioosx" = _rDhioosx;
        "BLUJarZ6" = _BLUJarZ6;
        ...
        "pkg-1.0.4" = _Z6a659zX;
        "pkg-1.0.5" = _SQ04V1Ez;
        "pkg-1.0.5b" = _dhc5FVwY;
        "pkg-1.0.5c" = _g96luMgQ;
        "pkg-1.0.5d" = _pkBZ07N5;
        "pkg-1.0.6" = _CKX8BfOX;
        "pkg-1.0.7" = _toXNbpLz;
        "pkg-1.0.8" = _iYsizfJY;
        "pkg-1.1.0" = _CoKuNQUI;
