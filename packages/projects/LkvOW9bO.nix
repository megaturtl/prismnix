...
let
    versions = (let
        ...
        _ZdeLeIGR = {
            "id" = "ZdeLeIGR";
            "file" = "Gravel GUI 1.2.4.zip";
            "hash" = "sha512-POcb+bUGGG+V/x2YaM2YvO12ruh2Rom85MoFGbdQ6NnzJPm4W+HdnYsVpZi60DO2lK+zfwrhQgN569yxl5MeAg==";
        };
    in {
        "3zZkuvTe" = _3zZkuvTe;
        "wHTtnJfo" = _wHTtnJfo;
        ...
        "fGcTlaGW" = _fGcTlaGW;
        "ZdeLeIGR" = _ZdeLeIGR;
        "minecraft-1.21" = _ZdeLeIGR;
        "minecraft-1.21.2" = _ZdeLeIGR;
        "minecraft-1.21.3" = _ZdeLeIGR;
        "minecraft-1.21.4" = _ZdeLeIGR;
        "minecraft-1.21.5" = _ZdeLeIGR;
        "minecraft-1.20.2" = _ZdeLeIGR;
        "minecraft-1.20.3" = _ZdeLeIGR;
        "minecraft-1.20.4" = _ZdeLeIGR;
        "minecraft-1.20.5" = _ZdeLeIGR;
        "minecraft-1.20.6" = _ZdeLeIGR;
        "minecraft-1.21.1" = _ZdeLeIGR;
        "minecraft-1.21.6" = _ZdeLeIGR;
        "minecraft-1.21.7" = _ZdeLeIGR;
        "minecraft-1.21.8" = _ZdeLeIGR;
        "minecraft-1.21.9" = _ZdeLeIGR;
        "minecraft-1.21.10" = _ZdeLeIGR;
        "minecraft-1.21.11" = _ZdeLeIGR;
        "minecraft-26.1" = _ZdeLeIGR;
        "minecraft-26.1.1" = _ZdeLeIGR;
        "minecraft-26.1.2" = _ZdeLeIGR;
        "minecraft-26.2" = _ZdeLeIGR;
        "minecraft-26.3" = _ZdeLeIGR;
        "pkg-1.0" = _3zZkuvTe;
        "pkg-1.1" = _wHTtnJfo;
        "pkg-1.1.1" = _x90CnfYB;
        "pkg-1.1.2" = _KfxFPPT9;
